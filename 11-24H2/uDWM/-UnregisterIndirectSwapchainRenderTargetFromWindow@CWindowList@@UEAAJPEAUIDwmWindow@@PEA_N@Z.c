/*
 * XREFs of ?UnregisterIndirectSwapchainRenderTargetFromWindow@CWindowList@@UEAAJPEAUIDwmWindow@@PEA_N@Z @ 0x1800F3900
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a3)
{
  ...
  *a3 = 0;
  ...
  if ( v10 && (v6 = (CTopLevelWindow *)*((_QWORD *)v10 + 55)) != 0LL )
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x19F1u, 0LL);
  }
  else
  {
    v8 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0x19EEu, 0LL);
  }
