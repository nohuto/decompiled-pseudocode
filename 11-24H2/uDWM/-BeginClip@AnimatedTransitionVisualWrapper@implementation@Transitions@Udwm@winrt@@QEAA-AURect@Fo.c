/*
 * XREFs of ?BeginClip@AnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@QEAA?AURect@Foundation@Windows@5@XZ @ 0x1800DE768
 * Callers:
 ...
 *     ?GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z @ 0x1800A4A00 (-GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z.c)
 */
