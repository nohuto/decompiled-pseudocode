/*
 * XREFs of dllmain_crt_process_attach @ 0x18009D208
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x18009B838 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18009B8D8 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x18009C200 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18009D5DC (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18009D604 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18009D628 (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x18009D638 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18009D6BD (_initterm_0.c)
 *     _initterm_e_0 @ 0x18009D6C9 (_initterm_e_0.c)
