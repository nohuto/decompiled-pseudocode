/*
 * XREFs of ?GetThumbnailVisual@CDCompThumbnailData@@UEAAPEAVCVisual@@XZ @ 0x18007BE90
 * Callers:
 *     <none>
 * Callees:
 *     ?GetThumbnailVisual@CThumbnailData@@UEAAPEAVCVisual@@XZ @ 0x18007BED0 (-GetThumbnailVisual@CThumbnailData@@UEAAPEAVCVisual@@XZ.c)
 */
