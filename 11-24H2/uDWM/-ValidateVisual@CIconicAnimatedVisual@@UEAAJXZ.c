/*
 * XREFs of ?ValidateVisual@CIconicAnimatedVisual@@UEAAJXZ @ 0x1800C53D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CIconicAnimatedVisual::ValidateVisual(CSecondaryWindowRepresentation **this)
{
  ...
  if ( ((_DWORD)this[4] & 0x100) != 0 )
  {
    ...
    if ( v2 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0xDDu, 0LL);
      return v3;
    }
    v4 = CSecondaryWindowRepresentation::Validate(this[31]);
    v3 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0xDEu, 0LL);
      return v3;
    }
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0xDFu, 0LL);
      return v3;
    }
    v6 = CIconicAnimatedVisual::UpdateDestinationRect(this);
    v3 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0xE0u, 0LL);
      return v3;
    }
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0xE1u, 0LL);
      return v3;
    }
  ...
  v3 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0xE6u, 0LL);
  return v3;
}
