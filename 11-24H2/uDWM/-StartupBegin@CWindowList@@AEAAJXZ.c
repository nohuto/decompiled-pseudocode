/*
 * XREFs of ?StartupBegin@CWindowList@@AEAAJXZ @ 0x18006FAF0
 * Callers:
...
__int64 __fastcall CWindowList::StartupBegin(CWindowList *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x1C2Eu, 0LL);
  }
  else
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x1C31u, 0LL);
    }
    else
    {
