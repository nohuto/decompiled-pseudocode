/*
 * XREFs of ?OnWindowCloakChange@CWindowPropertyTracker@@QEAAJPEBVCStoryboard@@PEBVCWindowData@@_N2@Z @ 0x1800521A8
 * Callers:
...
__int64 __fastcall CWindowPropertyTracker::OnWindowCloakChange(
        ...
        CWindowBackgroundTreatmentVisual ***a3,
        char a4,
        bool a5)
{
  int v9; // eax
  ...
  __int64 v11; // r8
  CWindowBackgroundTreatmentVisual **v12; // rcx
  int v14; // [rsp+30h] [rbp-18h] BYREF
  struct _RTL_CRITICAL_SECTION *v15; // [rsp+38h] [rbp-10h]
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0xEu, 0LL);
  }
  else
  {
