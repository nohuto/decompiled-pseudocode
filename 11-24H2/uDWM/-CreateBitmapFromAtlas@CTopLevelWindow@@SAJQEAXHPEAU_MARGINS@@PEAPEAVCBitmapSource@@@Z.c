/*
 * XREFs of ?CreateBitmapFromAtlas@CTopLevelWindow@@SAJQEAXHPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x18000D3F8
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, ThemeMargins, 0x255u, 0LL);
  }
  else
  {
    rc = 0LL;
    ...
    if ( ThemeRect < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, ThemeRect, 0x259u, 0LL);
    }
    else
    {
      InflateRect(&rc, -1, -1);
      ...
      v9 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, v11, 0x261u, 0LL);
    }
  }
  return v9;
}
