/*
 * XREFs of ?SetHolographic@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x1800F2E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::SetHolographic(CWindowList *this, struct IDwmWindow *a2, char a3)
{
  ...
  if ( v12 )
  {
    *((_BYTE *)v12 + 741) = (2 * a3) | *((_BYTE *)v12 + 741) & 0xFD;
    ...
    if ( v8 )
    {
      ...
      v6 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0xB63u, 0LL);
    }
  }
