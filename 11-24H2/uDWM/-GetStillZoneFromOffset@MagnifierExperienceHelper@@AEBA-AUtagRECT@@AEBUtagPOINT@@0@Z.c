/*
 * XREFs of ?GetStillZoneFromOffset@MagnifierExperienceHelper@@AEBA?AUtagRECT@@AEBUtagPOINT@@0@Z @ 0x1800C950C
 * Callers:
 ...
 *     ?IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z @ 0x1800C9880 (-IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z.c)
 */
  ...
  *retstr = 0LL;
  ...
  if ( IsEmptyRegionOnVirtualDesktop )
    *(_QWORD *)&v28 = COERCE_UNSIGNED_INT64((double)(lprc[3].top - lprc->top) / v15) & _xmm;
    ...
    v28 = 0.0;
  if ( v14 )
    *(_QWORD *)&v23 = COERCE_UNSIGNED_INT64((double)(lprc[3].bottom - lprc->bottom) / v15) & _xmm;
  retstr->left = (int)((v21 - left) / *(double *)&lprc[1].left * v22 + v25 + v21 + 0.5);
  retstr->top = (int)((v24 - top) / *(double *)&lprc[1].right * v20 + v28 + v24 + 0.5);
  v29 = (int)o_ceilf_0(v17 + v21 - (((double)right - (v17 + v21)) / *(double *)&lprc[1].left * v22 - v27));
  bottom = (double)lprc->bottom;
  retstr->right = v29;
  retstr->bottom = (int)o_ceilf_0(v16 + v24 - ((bottom - (v16 + v24)) / *(double *)&lprc[1].right * v20 - v23));
  return retstr;
}
