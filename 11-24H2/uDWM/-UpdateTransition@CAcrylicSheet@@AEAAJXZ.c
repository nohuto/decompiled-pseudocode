/*
 * XREFs of ?UpdateTransition@CAcrylicSheet@@AEAAJXZ @ 0x18006821C
 * Callers:
 ...
 *     ?ClampValue@CAcrylicSheet@@AEAAJJJJ@Z @ 0x180068480 (-ClampValue@CAcrylicSheet@@AEAAJJJJ@Z.c)
 ...
 *     ?OnAlphaUpdated@CAcrylicSheet@@AEAAXM@Z @ 0x1800A2248 (-OnAlphaUpdated@CAcrylicSheet@@AEAAXM@Z.c)
 */
