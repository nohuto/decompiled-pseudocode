/*
 * XREFs of ??1CAPTURE_DISPLAY_MAP_ENTRY@CCaptureManager@@QEAA@XZ @ 0x1800AD024
 * Callers:
 ...
 *     _CCaptureManager::_AddDisplayCaptureEntry_::_1_::dtor$2 @ 0x1800F83C9 (_CCaptureManager--_AddDisplayCaptureEntry_--_1_--dtor$2.c)
 * Callees:
