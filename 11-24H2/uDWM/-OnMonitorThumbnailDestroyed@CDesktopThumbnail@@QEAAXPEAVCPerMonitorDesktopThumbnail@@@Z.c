/*
 * XREFs of ?OnMonitorThumbnailDestroyed@CDesktopThumbnail@@QEAAXPEAVCPerMonitorDesktopThumbnail@@@Z @ 0x1800BC3F0
 * Callers:
        ...
        struct CPerMonitorDesktopThumbnail *a2)
{
  ...
  {
    if ( a2 == *(struct CPerMonitorDesktopThumbnail **)(i + 8 * v3) )
      break;
  }
