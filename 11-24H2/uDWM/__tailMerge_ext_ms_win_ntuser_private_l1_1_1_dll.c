/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_1_dll @ 0x18009CB6E
 * Callers:
 *     __imp_load_GetWindowBand @ 0x18009CBED (__imp_load_GetWindowBand.c)
 *     __imp_load_CreateWindowInBand @ 0x18009CBFF (__imp_load_CreateWindowInBand.c)
 * Callees:
