/*
 * XREFs of ?CreateSnapshotVisual@?$produce@UTransitionState@implementation@Transitions@Udwm@winrt@@UITransitionState@345@@impl@winrt@@UEAAHPEAXPEAPEAX@Z @ 0x18004BCC0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  try
  {
    SnapshotVisual = (__int64 *)winrt::Udwm::Transitions::implementation::TransitionState::CreateSnapshotVisual();
