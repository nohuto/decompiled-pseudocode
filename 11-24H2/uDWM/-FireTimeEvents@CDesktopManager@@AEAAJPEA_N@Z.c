/*
 * XREFs of ?FireTimeEvents@CDesktopManager@@AEAAJPEA_N@Z @ 0x180026DD0
 * Callers:
...
LABEL_10:
    if ( *((_BYTE *)this + 24) )
    {
      ...
      v3 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x7BAu, 0LL);
    }
    return v3;
  }
  ...
  *v4 = 1;
  ...
  else
  {
    if ( v6 <= v16 )
    {
      memcpy_0((void *)(v15[0] + 8LL * v17), *((const void **)this + 66), 8 * v5);
      v17 = v6;
      goto LABEL_5;
    }
    v10 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v15, 8, v5, *((_QWORD *)this + 66));
    v3 = v10;
    v11 = v10;
    if ( v10 >= 0 )
    {
LABEL_5:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x7B4u, 0LL);
      DynArrayImpl<0>::~DynArrayImpl<0>(v15);
      return v3;
    }
    v12 = v10;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x7B0u, 0LL);
  DynArrayImpl<0>::~DynArrayImpl<0>(v15);
  return v11;
}
