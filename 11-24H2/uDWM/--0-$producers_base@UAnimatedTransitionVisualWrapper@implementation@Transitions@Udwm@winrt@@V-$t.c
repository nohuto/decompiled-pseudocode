/*
 * XREFs of ??0?$producers_base@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@V?$tuple@UAnimatedTransitionVisualWrapper@Transitions@Udwm@winrt@@UITransitionAnimationVisualNative@@@std@@@impl@winrt@@QEAA@XZ @ 0x18004CB5C
 * Callers:
 ...
 * Callees:
 *     ??0?$producer_convert@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1345@X@impl@winrt@@QEAA@XZ @ 0x18004CEA0 (--0-$producer_convert@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1.c)
 */
