/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x180080644
 * Callers:
 ...
 * Callees:
 *     ?EnsureStackCaptureRegisteredWithWER@@YAXXZ @ 0x180080794 (-EnsureStackCaptureRegisteredWithWER@@YAXXZ.c)
 ...
 *     ??$__std_find_trivial@PEAXPEAX@@YAPEAPEAXPEAPEAX0QEAX@Z @ 0x18009ACD0 (--$__std_find_trivial@PEAXPEAX@@YAPEAPEAXPEAPEAX0QEAX@Z.c)
