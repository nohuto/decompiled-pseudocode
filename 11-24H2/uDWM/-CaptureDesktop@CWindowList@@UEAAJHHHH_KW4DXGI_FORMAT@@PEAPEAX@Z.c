...
LABEL_8:
  if ( (int)v8 > 0 && (int)a5 > 0 && v11 )
  {
    ...
    {
      v14 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x197Eu, 0LL);
    }
    else
    {
      ...
      if ( dwMaximumSizeLow <= 0xFFFFFFFF )
      {
        ...
        {
          v14 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x198Cu, 0LL);
        ...
        else
        {
          ...
          if ( v18 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x1998u, 0LL);
      ...
      {
        v14 = -2147024362;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x1982u, 0LL);
      }
    }
  }
  else
  {
    v14 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x199Du, 0LL);
  }
