/*
 * XREFs of ?SnapshotWindow@CWindowData@@QEAAJXZ @ 0x180006F48
 * Callers:
 ...
 *     ?GetIdealWindowRepresentationType@CWindowData@@QEBA?AW4WindowRepresentationType@@XZ @ 0x18001E950 (-GetIdealWindowRepresentationType@CWindowData@@QEBA-AW4WindowRepresentationType@@XZ.c)
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800270B4 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 */

__int64 __fastcall CWindowData::SnapshotWindow(struct CWindowSnapshot **this, __int64 a2, bool a3)
{
  unsigned int v3; // edi
  CWindowData *v5; // rsi
...
LABEL_4:
      if ( v5 )
      {
        ...
        else
        {
          ...
          if ( v14 )
          {
            ...
            if ( v15 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x61Au, 0LL);
              return v3;
            }
    ...
    if ( (v7 & 8) != 0 )
    {
      if ( this[60] && CWindowData::AllowSnapshot(v5) )
      {
        ...
        v3 = v13;
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x624u, 0LL);
      }
      else
      {
        *((_BYTE *)this + 740) = v7 | 0x10;
      }
    }
    else
    {
      for ( j = 0LL; (unsigned int)j < *((_DWORD *)this + 158); j = (unsigned int)(j + 1) )
      {
          ...
          && (unsigned int)CWindowData::GetIdealWindowRepresentationType(*((_QWORD *)v9 + j)) == 1 )
        {
          ...
          if ( v18 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x637u, 0LL);
            return v3;
          }
        }
      }
