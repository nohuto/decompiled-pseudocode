/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x18002E81C
 * Callers:
    ...
    *(_QWORD *)&v15.left = 0LL;
    ...
    if ( v9 )
    {
      ...
      if ( !CombineRgn(a2, a2, v9, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v2, 0x13AAu, 0LL);
      }
      DeleteObject(v9);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v2, 0x13A8u, 0LL);
    }
  }
