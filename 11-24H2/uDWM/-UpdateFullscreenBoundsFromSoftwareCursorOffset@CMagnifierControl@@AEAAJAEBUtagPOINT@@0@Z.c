/*
 * XREFs of ?UpdateFullscreenBoundsFromSoftwareCursorOffset@CMagnifierControl@@AEAAJAEBUtagPOINT@@0@Z @ 0x1800C8FB8
 * Callers:
 *     ?OnSoftwareCursorOffsetUpdated@CMagnifierControl@@UEAAJPEAVCVisual@@AEBUtagPOINT@@@Z @ 0x1800C8DF0 (-OnSoftwareCursorOffsetUpdated@CMagnifierControl@@UEAAJPEAVCVisual@@AEBUtagPOINT@@@Z.c)
 * Callees:
 ...
 *     ?GetPoint@CFullScreenMagnifier@@QEAA?AUtagPOINT@@XZ @ 0x1800C328C (-GetPoint@CFullScreenMagnifier@@QEAA-AUtagPOINT@@XZ.c)
