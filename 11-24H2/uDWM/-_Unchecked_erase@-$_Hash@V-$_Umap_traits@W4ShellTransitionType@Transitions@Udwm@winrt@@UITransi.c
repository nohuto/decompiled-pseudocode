        ...
        __int64 a3)
{
  ...
  if ( a2 != a3 )
  {
    ...
    v21 = v6;
    v22 = a2;
    v8 = std::_Hash_representation<enum winrt::Udwm::Transitions::ShellTransitionType>(a2 + 16);
    ...
    {
      v14 = v9 == v12;
      std::_Hash<std::_Umap_traits<HWND__ *,winrt::Udwm::Transitions::ITransition,std::_Uhash_compare<HWND__ *,std::hash<HWND__ *>,std::equal_to<HWND__ *>>,std::allocator<std::pair<HWND__ * const,winrt::Udwm::Transitions::ITransition>>,0>>::_Range_eraser::_Bump_erased(&v20);
      if ( v14 )
        break;
      v9 = v22;
      v12 = v24;
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v5 + 8 * v11 + 8) = v6; ; *(_QWORD *)(v5 + 8 * v11 + 8) = v7 )
    {
      ...
      if ( v22 == a3 )
        break;
      v17 = std::_Hash_representation<enum winrt::Udwm::Transitions::ShellTransitionType>(v22 + 16);
      v11 = 2 * (a1[6] & v17);
