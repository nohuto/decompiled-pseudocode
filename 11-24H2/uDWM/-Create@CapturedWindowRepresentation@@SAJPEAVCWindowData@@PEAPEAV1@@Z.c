/*
 * XREFs of ?Create@CapturedWindowRepresentation@@SAJPEAVCWindowData@@PEAPEAV1@@Z @ 0x1800A897C
 * Callers:
        ...
        struct CapturedWindowRepresentation **a2)
{
  ...
  v4 = (CBaseObject *)operator new[](0x60uLL, (const struct std::nothrow_t *)a2);
  v5 = v4;
  v18 = v4;
  if ( v4 )
  {
...
LABEL_10:
        ...
        v9 = *(struct CVisualProxy **)(*((_QWORD *)a1 + 55) + 16LL);
        v20 = 0LL;
