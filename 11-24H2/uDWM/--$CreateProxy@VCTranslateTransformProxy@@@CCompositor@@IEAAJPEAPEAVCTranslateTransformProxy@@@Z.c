/*
 * XREFs of ??$CreateProxy@VCTranslateTransformProxy@@@CCompositor@@IEAAJPEAPEAVCTranslateTransformProxy@@@Z @ 0x18006E6E0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CTranslateTransformProxy>(__int64 a1, CBaseTransformProxy **a2)
{
  CBaseTransformProxy *v4; // rbx
  CTranslateTransformProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CTranslateTransformProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v4;
