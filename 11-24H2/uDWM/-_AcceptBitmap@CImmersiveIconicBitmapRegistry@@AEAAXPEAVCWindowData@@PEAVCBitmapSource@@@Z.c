/*
 * XREFs of ?_AcceptBitmap@CImmersiveIconicBitmapRegistry@@AEAAXPEAVCWindowData@@PEAVCBitmapSource@@@Z @ 0x1800C624C
 * Callers:
 ...
 *     ?GetWindow@CIconicAnimatedVisual@@QEAAPEAUHWND__@@XZ @ 0x18009AFDC (-GetWindow@CIconicAnimatedVisual@@QEAAPEAUHWND__@@XZ.c)
