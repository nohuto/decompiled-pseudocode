/*
 * XREFs of ?WindowMaximizeSnapPostTransition@TransitionManager@Transitions@Udwm@winrt@@QEAAXXZ @ 0x18004B154
 * Callers:
        ...
        winrt::Udwm::Transitions::TransitionManager *this)
{
  ...
  winrt::Udwm::Transitions::TransitionManager::GetHandler(this, &v1, 2LL);
  if ( v1 )
