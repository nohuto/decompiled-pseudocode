/*
 * XREFs of ??$find_iid@UTransitionState@implementation@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUTransitionState@implementation@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x1800899EC
 * Callers:
 *     ?find_interface@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@@UITransitionStateNativePrivate@@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x1800E79F0 (-find_interface@-$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITra.c)
 * Callees:
