/*
 * XREFs of ?RegisterSharedThumbnailVisual@CWindowList@@UEAAJPEAUHWND__@@0HHAEBU_DWM_THUMBNAIL_PROPERTIES@@T_LARGE_INTEGER@@PEAX@Z @ 0x1800F1CD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  *((_DWORD *)v19 + 30) = a4 != 0;
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1375u, 0LL);
    v12 = v52;
    goto LABEL_5;
  }
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x1376u, 0LL);
    v12 = v52;
    v13 = v54;
    goto LABEL_5;
  }
  ...
  if ( v23 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x1377u, 0LL);
    goto LABEL_5;
  }
...
LABEL_29:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0x137Fu, 0LL);
    goto LABEL_5;
  }
