/*
 * XREFs of ?make_weak_ref@?$root_implements@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIBitmapManager@@@impl@winrt@@AEAAPEAUIWeakReferenceSource@23@XZ @ 0x18008F5FC
 * Callers:
 ...
 *     ?compare_exchange_weak@?$atomic@_K@std@@QEAA_NAEA_K_KW4memory_order@2@2@Z @ 0x18004E1F0 (-compare_exchange_weak@-$atomic@_K@std@@QEAA_NAEA_K_KW4memory_order@2@2@Z.c)
 *     ??_U@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x180095474 (--_U@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     ??$detach_abi@I$0A@@winrt@@YA?A_P$$QEAI@Z @ 0x180095AFC (--$detach_abi@I$0A@@winrt@@YA-A_P$$QEAI@Z.c)
...
void *__fastcall winrt::impl::root_implements<winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition,winrt::Udwm::Transitions::Private::WindowJointResizeTransition,IBitmapManager>::make_weak_ref(
        __int64 a1)
{
  __int64 v1; // rdi
  __int64 v3; // rdx
  ...
  if ( v3 >= 0 )
  {
    result = operator new[](0x20uLL, (const struct std::nothrow_t *)v3);
    ...
    if ( result )
    {
      ...
      v15 = v6;
      *(_QWORD *)(v6 + 8) = &winrt::impl::weak_source<1,1>::`vftable';
      *(_QWORD *)v6 = &winrt::impl::weak_ref<1,1>::`vftable';
      *(_DWORD *)(v6 + 24) = v14;
      v7 = (v6 >> 1) | 0x8000000000000000uLL;
      *(_QWORD *)(v6 + 16) = v8;
      *(_DWORD *)(v6 + 28) = 1;
      while ( !std::atomic<unsigned __int64>::compare_exchange_weak(v1, (__int64)&v14, v7) )
      {
        if ( v14 < 0 )
        {
          _InterlockedIncrement((volatile signed __int32 *)winrt::to_abi<ITransitionAnimationVisualNative,winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper>(2 * v14 + 24));
          v12 = 2 * v11 + 8;
          winrt::com_ptr<winrt::impl::weak_ref<1,1>>::unconditional_release_ref(&v15);
          return (void *)v12;
        }
        v13 = v14;
        winrt::detach_abi<unsigned int,0>(&v13);
        v9 = (volatile __int32 *)winrt::to_abi<ITransitionAnimationVisualNative,winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper>(v6 + 24);
        _InterlockedExchange(v9, v10);
      }
      _InterlockedIncrement((volatile signed __int32 *)winrt::to_abi<ITransitionAnimationVisualNative,winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper>(v6 + 24));
      winrt::impl::detach_from<winrt::Udwm::Transitions::AnimatedTransitionVisualWrapper>((__int64 *)&v15);
      if ( v15 )
        winrt::com_ptr<winrt::impl::weak_ref<1,1>>::unconditional_release_ref(&v15);
      return (void *)(v6 + 8);
    }
