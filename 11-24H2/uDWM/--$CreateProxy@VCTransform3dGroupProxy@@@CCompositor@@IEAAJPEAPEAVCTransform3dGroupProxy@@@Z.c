/*
 * XREFs of ??$CreateProxy@VCTransform3dGroupProxy@@@CCompositor@@IEAAJPEAPEAVCTransform3dGroupProxy@@@Z @ 0x1800B5C10
 * Callers:
 *     ?CreateTransform3dGroupProxy@CCompositor@@QEAAJPEAPEAVCTransform3dGroupProxy@@@Z @ 0x1800B6210 (-CreateTransform3dGroupProxy@CCompositor@@QEAAJPEAPEAVCTransform3dGroupProxy@@@Z.c)
 * Callees:
...
__int64 __fastcall CCompositor::CreateProxy<CTransform3dGroupProxy>(__int64 a1, CBaseObject **a2)
{
  CBaseObject *v4; // rbx
  CTransform3dGroupProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CTransform3dGroupProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 < 0 )
    {
