/*
 * XREFs of ?Create@CDisplayDuplicateAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800C0E74
 * Callers:
...
__int64 __fastcall CDisplayDuplicateAnimatedVisual::Create(struct CDisplayDuplicateAnimatedVisual **a1)
{
  ...
  struct CDisplayDuplicateAnimatedVisual *v4; // rbx

  if ( a1 )
  {
    v3 = (CDisplayDuplicateAnimatedVisual *)DefaultHeap::AllocClear(0x1C0uLL);
    if ( v3 )
