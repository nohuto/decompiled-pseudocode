/*
 * XREFs of ?CreateDrawMesh2DInstruction@CTouchDragVisual@@AEAAJPEBUMesh2D@@PEAPEAVCGeometry2dGroupProxy@@PEAPEAVCMeshGeometry2dProxy@@@Z @ 0x1800117E8
 * Callers:
        ...
        struct CMeshGeometry2dProxy **a4)
{
  ...
  if ( MeshGeometry2dProxy < 0 )
  {
    v10 = 256;
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, MeshGeometry2dProxy, v10, 0LL);
    if ( *a4 )
    {
