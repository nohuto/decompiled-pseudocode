/*
 * XREFs of ?_WindowEnumCallback@CFlyoutPopup@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180051730
 * Callers:
...
LABEL_12:
  ...
  if ( v13 >= 0 )
  {
    v15 = (CAnimatedTransitionVisual **)v31[0];
    v28 = 0;
    ...
    if ( (int)CWindowPropertyTracker::GetWindowEndCloak(WPT, *(HWND *)(a2 + 40), &v28) >= 0 )
    {
      ...
      v22 = *(_DWORD *)(a2 + 744);
      if ( (v22 & 0x1000000) != 0 )
        rc = *(struct tagRECT *)(a2 + 764);
      if ( (v22 & 0x800000) != 0 )
        v32 = *(struct tagRECT *)(a2 + 796);
      CAnimatedTransitionVisual::SetBeginRect(v15[5], &rc);
      CAnimatedTransitionVisual::SetEndRect(v15[5], &v32);
      v23 = v15[5];
      if ( v18 )
      {
      ...
      CAnimatedTransitionVisual::SetEndAlpha(v15[5], v24);
    }
    goto LABEL_43;
  }
