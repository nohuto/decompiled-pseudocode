/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCWindowData@@@?$vector@PEAVCWindowData@@V?$allocator@PEAVCWindowData@@@std@@@std@@AEAAPEAPEAVCWindowData@@QEAPEAV2@AEBQEAV2@@Z @ 0x18004D430
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v15 = *a3;
  ...
  if ( a2 == *(_QWORD *)(a1 + 8) )
  {
    std::_Copy_memmove<tagRECT *,tagRECT *>(v16);
  }
  else
  {
    std::_Uninitialized_move<CDWMDisplay const * *>(v16, a2, v14);
    std::_Uninitialized_move<CDWMDisplay const * *>(a2, *(_QWORD *)(a1 + 8), v15 + 8);
  }
  std::vector<HWND__ *>::_Change_array(a1, v14, v9, v3);
  return v15;
}
