/*
 * XREFs of ?_SetUnifiedCenter@CGroupingStoryboard@@IEAAXPEAVCAnimationComponent@@@Z @ 0x1800D5450
 * Callers:
 ...
 *     ?SetOverrideRotationCenter@CAnimatedTransitionVisual@@QEAAXPEAUD2D_POINT_3F@@W4RotationCenterReference3D@@@Z @ 0x1800A4EA0 (-SetOverrideRotationCenter@CAnimatedTransitionVisual@@QEAAXPEAUD2D_POINT_3F@@W4RotationCenterRef.c)
 *     ?SetOverrideScalingCenter@CAnimatedTransitionVisual@@QEAAXPEAUD2D_POINT_3F@@@Z @ 0x1800A4ED0 (-SetOverrideScalingCenter@CAnimatedTransitionVisual@@QEAAXPEAUD2D_POINT_3F@@@Z.c)
 *     ?MapPointIntoRectangle@@YAXAEBUD2D_POINT_2F@@AEBUtagRECT@@PEAUD2D_POINT_3F@@@Z @ 0x1800D2C04 (-MapPointIntoRectangle@@YAXAEBUD2D_POINT_2F@@AEBUtagRECT@@PEAUD2D_POINT_3F@@@Z.c)
