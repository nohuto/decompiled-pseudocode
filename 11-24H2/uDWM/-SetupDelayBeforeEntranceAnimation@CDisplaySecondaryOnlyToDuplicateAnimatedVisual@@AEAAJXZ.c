/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800C1EFC
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800C1DD0 (-OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
        ...
        CTimelineBase **this)
{
  ...
  if ( v2 )
    v2 = (CBaseObject *)CTimeline<float>::CTimeline<float>(v2, 1.0, 0.0, 1.0, 0);
