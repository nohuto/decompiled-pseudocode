/*
 * XREFs of ?UpdateHolographicLockState@CAnalogCompositorManager@@AEAAJXZ @ 0x18007ACB0
 * Callers:
 ...
 *     ?ToggleLockBackstopImpl@CAnalogCompositorManager@@AEAAJ_N@Z @ 0x1800985E8 (-ToggleLockBackstopImpl@CAnalogCompositorManager@@AEAAJ_N@Z.c)
 * Callees:
