/*
 * XREFs of ?GetCaptionButtonBounds@CWindowList@@AEAAJPEAUHWND__@@_NPEAUtagRECT@@@Z @ 0x180064EFC
 * Callers:
 ...
 *     ?GetMetricsForCaptionBarEx@CWindowData@@QEBAHH_N@Z @ 0x18006F214 (-GetMetricsForCaptionBarEx@CWindowData@@QEBAHH_N@Z.c)
