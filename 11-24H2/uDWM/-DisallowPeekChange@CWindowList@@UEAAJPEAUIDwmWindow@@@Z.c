/*
 * XREFs of ?DisallowPeekChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800EF3A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::DisallowPeekChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  v4 = v6;
  if ( v6 )
    *((_BYTE *)v4 + 739) = ((*(unsigned __int8 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 264LL))(a2) << 7) | *((_BYTE *)v4 + 739) & 0x7F;
