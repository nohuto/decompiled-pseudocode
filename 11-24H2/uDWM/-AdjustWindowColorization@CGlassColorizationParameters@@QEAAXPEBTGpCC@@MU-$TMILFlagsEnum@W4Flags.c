/*
 * XREFs of ?AdjustWindowColorization@CGlassColorizationParameters@@QEAAXPEBTGpCC@@MU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@@Z @ 0x18002C1C0
 * Callers:
...
LABEL_13:
    ...
    if ( v33 )
    {
      ...
      {
        v34 = dword_18010C244[v32];
        goto LABEL_20;
      }
      v38 = dword_18010D57C[v32];
      if ( v38 != 31 )
        goto LABEL_49;
      v34 = 0;
    }
    else
    {
      if ( !IsHighContrastMode )
      {
        v34 = dword_18010C210[v9];
        goto LABEL_20;
      }
      v38 = dword_18010D548[v9];
      if ( v38 != 31 )
      {
LABEL_49:
        v34 = GetSysColor(v38);
