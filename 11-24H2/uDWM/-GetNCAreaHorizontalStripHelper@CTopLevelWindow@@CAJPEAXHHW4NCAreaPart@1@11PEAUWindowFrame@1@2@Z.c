/*
 * XREFs of ?GetNCAreaHorizontalStripHelper@CTopLevelWindow@@CAJPEAXHHW4NCAreaPart@1@11PEAUWindowFrame@1@2@Z @ 0x18000CEC8
 * Callers:
...
LABEL_7:
      if ( v15 < 2 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, v20, 0x598u, 0LL);
        return ThemeRect;
      }
      v11 = a4;
    }
