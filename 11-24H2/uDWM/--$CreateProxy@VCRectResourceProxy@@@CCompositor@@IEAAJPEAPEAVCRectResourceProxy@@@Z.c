/*
 * XREFs of ??$CreateProxy@VCRectResourceProxy@@@CCompositor@@IEAAJPEAPEAVCRectResourceProxy@@@Z @ 0x180073700
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRectResourceProxy>(__int64 a1, CResourceProxy **a2)
{
  CResourceProxy *v4; // rbx
  CRectResourceProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CRectResourceProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 < 0 )
    {
