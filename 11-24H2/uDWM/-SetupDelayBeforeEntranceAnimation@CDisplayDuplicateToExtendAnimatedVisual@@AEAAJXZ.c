/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayDuplicateToExtendAnimatedVisual@@AEAAJXZ @ 0x1800BEDA4
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayDuplicateToExtendAnimatedVisual@@EEAAJI@Z @ 0x1800BE8C0 (-OnAnimationCompleteImpl@CDisplayDuplicateToExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayDuplicateToExtendAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  CBaseObject *v2; // rax
  _QWORD *v3; // r10
  int v4; // ebx
  ...
  if ( v2 )
    v2 = (CBaseObject *)CTimeline<float>::CTimeline<float>(v2, 0.3330000042915344, 0.0, 1.0, 0);
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 57, v2);
  if ( !*v3 )
  {
    v4 = -2147024882;
    v5 = 332LL;
