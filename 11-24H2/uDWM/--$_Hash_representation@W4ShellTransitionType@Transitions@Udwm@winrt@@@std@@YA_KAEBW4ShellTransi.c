 ...
 *     ?_Forced_rehash@?$_Hash@V?$_Umap_traits@W4ShellTransitionType@Transitions@Udwm@winrt@@UITransition@234@V?$_Uhash_compare@W4ShellTransitionType@Transitions@Udwm@winrt@@U?$hash@W4ShellTransitionType@Transitions@Udwm@winrt@@@std@@U?$equal_to@W4ShellTransitionType@Transitions@Udwm@winrt@@@6@@std@@V?$allocator@U?$pair@$$CBW4ShellTransitionType@Transitions@Udwm@winrt@@UITransition@234@@std@@@7@$0A@@std@@@std@@IEAAX_K@Z @ 0x1800E75C8 (-_Forced_rehash@-$_Hash@V-$_Umap_traits@W4ShellTransitionType@Transitions@Udwm@winrt@@UITransiti.c)
...
__int64 __fastcall std::_Hash_representation<enum winrt::Udwm::Transitions::ShellTransitionType>(__int64 a1)
{
  return std::_Fnv1a_append_value<enum winrt::Udwm::Transitions::ShellTransitionType>(a1, a1);
}
