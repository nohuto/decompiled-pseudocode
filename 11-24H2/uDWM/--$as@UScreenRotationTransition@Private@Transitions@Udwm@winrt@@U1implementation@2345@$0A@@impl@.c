/*
 * XREFs of ??$as@UScreenRotationTransition@Private@Transitions@Udwm@winrt@@U1implementation@2345@$0A@@impl@winrt@@YA?AUScreenRotationTransition@Private@Transitions@Udwm@1@PEAU2implementation@3451@@Z @ 0x1800DF7F8
 * Callers:
