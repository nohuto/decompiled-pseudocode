/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x18006AD70
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierApiMessage(unsigned __int64 a1, int a2, __int64 a3, char a4)
{
  ...
  if ( a2 <= 1073741937 )
  {
      ...
      if ( v11 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( v13 )
          {
            ...
            if ( v14 )
            {
              if ( v14 == 1 )
              {
                ...
                if ( v18 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v18, 0xE4u, 0LL);
                }
                else
                {
                  ...
                  v8 = v19;
                  if ( v19 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v19, 0xE8u, 0LL);
                }
              }
            }
            else
            {
              ...
              if ( v15 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v15, 0xD6u, 0LL);
              }
              else
              {
                ...
                v8 = v16;
                if ( v16 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v16, 0xDAu, 0LL);
              }
            }
          }
          else
          {
            ...
            if ( v20 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v20, 0xCAu, 0LL);
            }
            else
            {
              ...
              v8 = v21;
              if ( v21 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v21, 0xCCu, 0LL);
            }
          }
        }
        else
        {
          *(_BYTE *)(a1 + 128) = 0;
          ...
          v8 = v22;
          if ( v22 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v22, 0xC0u, 0LL);
        }
      }
      else
      {
        ...
        v8 = v23;
        if ( v23 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v23, 0xB5u, 0LL);
      }
      goto LABEL_10;
    }
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v24, 0xF0u, 0LL);
      goto LABEL_10;
    }
    goto LABEL_61;
  }
  ...
  if ( !v26 )
  {
    ...
    if ( *(_BYTE *)(a1 + 128) )
    {
      ...
      *(double *)(a1 + 152) = *v42;
      ...
      if ( v43 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v43, 0x117u, 0LL);
        goto LABEL_10;
      }
    }
    else
    {
      ...
      if ( v44 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v44, 0x11Fu, 0LL);
        goto LABEL_10;
      }
    }
    goto LABEL_61;
  ...
  if ( !v27 )
  {
    ...
    if ( v40 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v40, 0x12Cu, 0LL);
    }
    else
    {
      ...
      v8 = v41;
      if ( v41 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v41, 0x12Eu, 0LL);
    }
    goto LABEL_10;
  }
  v28 = v27 - 1;
  if ( !v28 )
  {
    ...
    if ( v39 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v39, 0x136u, 0LL);
      goto LABEL_10;
    }
    goto LABEL_61;
  }
  ...
  if ( !v29 )
  {
    ...
    if ( v38 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v38, 0x140u, 0LL);
      goto LABEL_10;
    }
LABEL_61:
    ...
    v8 = v45;
    if ( v45 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v45, 0x166u, 0LL);
    goto LABEL_10;
  }
  if ( v29 != 1 )
    goto LABEL_10;
  ...
  *(_QWORD *)(a1 + 160) = v33;
  ...
  if ( v30 )
  {
    ...
    if ( v37 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, v37, 0x158u, 0LL);
      goto LABEL_10;
    }
  }
  else
