/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2601@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800B94A8
 * Callers:
