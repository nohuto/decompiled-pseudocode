/*
 * XREFs of ?AddProjectedShadowCaster@CWindowList@@QEAAJPEAUHWND__@@PEAX1@Z @ 0x1800EDDD8
 * Callers:
...
LABEL_8:
      ...
      {
        v8 = -2147019873;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147019873, 0x6CAu, 0LL);
      }
      Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease(&v13);
      goto LABEL_10;
    }
