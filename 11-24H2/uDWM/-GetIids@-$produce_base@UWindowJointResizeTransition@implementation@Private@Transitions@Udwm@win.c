/*
 * XREFs of ?GetIids@?$produce_base@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@X@impl@winrt@@UEAAHPEAIPEAPEAUguid@3@@Z @ 0x1800DEA60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
