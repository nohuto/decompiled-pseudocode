/*
 * XREFs of ?UpdateColor@CSolidRectangleVisual@@QEAAXAEBU_D3DCOLORVALUE@@@Z @ 0x1800D0D98
 * Callers:
...
void __fastcall CSolidRectangleVisual::UpdateColor(struct _D3DCOLORVALUE *this, const struct _D3DCOLORVALUE *a2)
{
    ...
    || COERCE_FLOAT(COERCE_UNSIGNED_INT(0.0 - this[16].b) & _xmm) > 0.0000011920929 )
  {
    ...
    *(struct _D3DCOLORVALUE *)&this[16].r = *(const struct _D3DCOLORVALUE *)&stru_18010B348.r;
    v2(this, 0x4000LL);
  }
}
