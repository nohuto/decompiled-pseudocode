/*
 * XREFs of ?Release@?$produce_base@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@UIAnimatedTransitionVisualWrapper@345@X@impl@winrt@@UEAAIXZ @ 0x180086000
 * Callers:
 *     <none>
 * Callees:
 *     <none>
