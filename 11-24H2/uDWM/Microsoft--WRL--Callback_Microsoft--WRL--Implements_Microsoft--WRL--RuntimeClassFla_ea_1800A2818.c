/*
 * XREFs of Microsoft::WRL::Callback_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::Foundation::ITypedEventHandler_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::DisplayManagerEnabledEventArgs____Microsoft::WRL::FtmBase___lambda_77212a9e6487372bbfeab6a574df83fb___ @ 0x1800A2818
 * Callers:
 *     wil::MakeAgileCallbackNoThrow_Windows::Foundation::ITypedEventHandler_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::DisplayManagerEnabledEventArgs_____lambda_77212a9e6487372bbfeab6a574df83fb___ @ 0x1800A2C18 (wil--MakeAgileCallbackNoThrow_Windows--Foundation--ITypedEventHandler_Windows--Devi_ea_1800A2C18.c)
 * Callees:
...
_QWORD *__fastcall Microsoft::WRL::Callback_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::Foundation::ITypedEventHandler_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::DisplayManagerEnabledEventArgs____Microsoft::WRL::FtmBase___lambda_77212a9e6487372bbfeab6a574df83fb___(
        _QWORD *a1,
        __int64 a2)
{
  __int64 *v3; // rax
