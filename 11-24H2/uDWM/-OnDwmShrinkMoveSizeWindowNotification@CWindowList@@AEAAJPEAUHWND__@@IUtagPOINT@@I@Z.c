/*
 * XREFs of ?OnDwmShrinkMoveSizeWindowNotification@CWindowList@@AEAAJPEAUHWND__@@IUtagPOINT@@I@Z @ 0x1800F12D8
 * Callers:
...
LABEL_10:
  ...
  if ( v13 < 0 )
    v13 = 0;
  v14 = *((_BYTE *)WindowDataByHwnd + 742);
  v15 = v14 & 1;
  if ( a3 )
  {
    v17 = *((_BYTE *)WindowDataByHwnd + 742);
  ...
  else
  {
    if ( v15 )
    {
      *((_BYTE *)WindowDataByHwnd + 742) = v14 & 0xFE;
...
LABEL_9:
  ...
  if ( v15 != (v17 & 1) )
  {
    ...
    if ( v18 )
      CTopLevelWindow::OnIsInWindowMove(v18, (*((_BYTE *)v9 + 741) & 0x10) != 0, (const struct tagRECT *)v9 + 3);
  }
  v10 = 0;
LABEL_23:
