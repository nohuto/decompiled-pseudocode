/*
 * XREFs of McTemplateU0qd_EtwEventWriteTransfer @ 0x1800D9234
 * Callers:
...
__int64 __fastcall McTemplateU0qd_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4)
{
