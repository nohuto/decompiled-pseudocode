/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x18006B21C
 * Callers:
        ...
        const struct MAGN_FILTERLIST *a2)
{
  ...
  if ( v3 && (*(_DWORD *)a2 != 1 || this[7] != *((struct CVisualGroupProxy **)a2 + 1)) )
  {
    ...
    while ( (unsigned int)i < v3 && (unsigned int)i < 0x19 )
    {
      if ( this[7] != *((struct CVisualGroupProxy **)a2 + i + 1) )
      {
        ...
        {
          v11 = -2147023728;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, -2147023728, 0x113u, 0LL);
          return v11;
        }
  ...
  if ( VisualGroupProxy < 0 )
  {
    v16 = 228;
LABEL_22:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1LL, VisualGroupProxy, v16, 0LL);
  }
  return v11;
}
