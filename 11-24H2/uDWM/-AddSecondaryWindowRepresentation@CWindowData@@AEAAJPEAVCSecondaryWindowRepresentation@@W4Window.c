/*
 * XREFs of ?AddSecondaryWindowRepresentation@CWindowData@@AEAAJPEAVCSecondaryWindowRepresentation@@W4WindowRepresentationType@@_N@Z @ 0x18003DB18
 * Callers:
...
LABEL_19:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x34Bu, 0LL);
      return v4;
    }
    v18 = 0;
...
LABEL_29:
      ...
      {
        v4 = -2147418113;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147418113, 0x37Au, 0LL);
      }
    }
  }
