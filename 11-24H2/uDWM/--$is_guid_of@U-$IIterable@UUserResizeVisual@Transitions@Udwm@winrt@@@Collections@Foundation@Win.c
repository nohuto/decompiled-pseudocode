        ...
        _QWORD *a1)
{
  ...
  if ( *a1 == winrt::impl::guid_v<winrt::Windows::Foundation::Collections::IIterable<winrt::Udwm::Transitions::UserResizeVisual>> )
    v1 = a1[1] + 0x2886D6EC73D6673LL;
  return v1 == 0;
}
