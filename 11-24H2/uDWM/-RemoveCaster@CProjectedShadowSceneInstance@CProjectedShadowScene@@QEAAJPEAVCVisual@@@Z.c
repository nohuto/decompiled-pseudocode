/*
 * XREFs of ?RemoveCaster@CProjectedShadowSceneInstance@CProjectedShadowScene@@QEAAJPEAVCVisual@@@Z @ 0x180054A50
 * Callers:
 ...
 *     ?FindElement@?$CGenericTableMap@PEAVCVisual@@UVISUAL_RESOURCE_MAP_ENTRY_CASTER@CProjectedShadowSceneInstance@CProjectedShadowScene@@@@QEAAPEAUVISUAL_RESOURCE_MAP_ENTRY_CASTER@CProjectedShadowSceneInstance@CProjectedShadowScene@@PEAVCVisual@@@Z @ 0x180099AC0 (-FindElement@-$CGenericTableMap@PEAVCVisual@@UVISUAL_RESOURCE_MAP_ENTRY_CASTER@CProjectedShadowS.c)
        ...
        struct CVisual *a2)
{
  ...
  Element = (_QWORD *)CGenericTableMap<CVisual *,CProjectedShadowScene::CProjectedShadowSceneInstance::VISUAL_RESOURCE_MAP_ENTRY_CASTER>::FindElement(
                        (char *)this + 16,
                        a2);
  if ( Element )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v16 + 88LL))(v16, Element[1]);
    v8 = v11;
    if ( v11 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    RtlDeleteElementGenericTable(v3, Element);
    v13 = v16;
    if ( v16 )
    {
      v16 = 0LL;
