/*
 * XREFs of ?UpdateProperties@CThumbnailVisual@@QEAAJK@Z @ 0x180061124
 * Callers:
 ...
 *     ?AreAllMarginsZero@@YA_NAEBU_MARGINS@@@Z @ 0x180061F18 (-AreAllMarginsZero@@YA_NAEBU_MARGINS@@@Z.c)
 *     ?IsShellManaged@CWindowData@@QEBA_NXZ @ 0x1800641F4 (-IsShellManaged@CWindowData@@QEBA_NXZ.c)
