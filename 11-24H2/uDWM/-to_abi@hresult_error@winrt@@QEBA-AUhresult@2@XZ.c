/*
 * XREFs of ?to_abi@hresult_error@winrt@@QEBA?AUhresult@2@XZ @ 0x1800A0C24
 * Callers:
 ...
 *     _winrt::to_hresult_::_1_::catch$13 @ 0x1800F8743 (_winrt--to_hresult_--_1_--catch$13.c)
 ...
 *     SetErrorInfo_0 @ 0x18009D6ED (SetErrorInfo_0.c)
