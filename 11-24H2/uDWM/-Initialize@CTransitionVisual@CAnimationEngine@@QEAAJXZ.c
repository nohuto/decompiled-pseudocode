/*
 * XREFs of ?Initialize@CTransitionVisual@CAnimationEngine@@QEAAJXZ @ 0x18004665C
 * Callers:
 ...
 *     ??0CTransitionVariable@CAnimationEngine@@QEAA@XZ @ 0x180046710 (--0CTransitionVariable@CAnimationEngine@@QEAA@XZ.c)
