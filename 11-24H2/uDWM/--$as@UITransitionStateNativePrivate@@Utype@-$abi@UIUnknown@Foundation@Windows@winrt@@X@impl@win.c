/*
 * XREFs of ??$as@UITransitionStateNativePrivate@@Utype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@impl@winrt@@$0A@@impl@winrt@@YA?AU?$com_ptr@UITransitionStateNativePrivate@@@1@PEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@01@@Z @ 0x1800E6B10
 * Callers:
        ...
        __int64 (__fastcall ***a2)(_QWORD, __int64 *, __int64 *))
{
  ...
  if ( a2 )
  {
    ...
    v3 = *a2;
    v7 = 0LL;
    v4 = (*v3)(a2, &winrt::impl::guid_v<ITransitionStateNativePrivate>, &v9);
