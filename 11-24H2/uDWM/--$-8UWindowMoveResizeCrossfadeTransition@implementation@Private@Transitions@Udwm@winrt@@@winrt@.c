/*
 * XREFs of ??$?8UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@@winrt@@YA_NAEBU?$com_ptr@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@@0@$$T@Z @ 0x18009ADEC
 * Callers:
...
bool __fastcall winrt::operator==<winrt::Udwm::Transitions::Private::implementation::WindowMoveResizeCrossfadeTransition>(
        __int64 a1)
{
  return std::_Atomic_reinterpret_as<__int64,unsigned __int64>(a1) == 0;
}
