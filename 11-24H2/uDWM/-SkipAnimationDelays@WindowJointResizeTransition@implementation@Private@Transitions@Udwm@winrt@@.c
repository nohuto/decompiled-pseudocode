/*
 * XREFs of ?SkipAnimationDelays@WindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800E5780
 * Callers:
 *     ?SkipAnimationDelays@?$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHXZ @ 0x1800E5770 (-SkipAnimationDelays@-$produce@UWindowJointResizeTransition@implementation@Private@Transitions@U.c)
 * Callees:
