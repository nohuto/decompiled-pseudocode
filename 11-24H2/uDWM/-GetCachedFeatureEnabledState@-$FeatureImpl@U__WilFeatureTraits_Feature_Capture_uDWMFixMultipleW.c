/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Capture_uDWMFixMultipleWindowCaptures@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800CBC80
 * Callers:
