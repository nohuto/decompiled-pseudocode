/*
 * XREFs of ??$construct@UUserResizeVisual@Transitions@Udwm@winrt@@AEBU1234@@?$_Default_allocator_traits@V?$allocator@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@@std@@SAXAEAV?$allocator@UUserResizeVisual@Transitions@Udwm@winrt@@@1@QEAUUserResizeVisual@Transitions@Udwm@winrt@@AEBU3456@@Z @ 0x1800E7FF4
 * Callers:
