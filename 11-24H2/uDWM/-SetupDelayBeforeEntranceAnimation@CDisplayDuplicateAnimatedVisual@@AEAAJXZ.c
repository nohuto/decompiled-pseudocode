/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800BE184
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800BE130 (-OnAnimationCompleteImpl@CDisplayDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayDuplicateAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  ...
  if ( v2 )
    v2 = (CBaseObject *)CTimeline<float>::CTimeline<float>(v2, 0.06700000166893005, 0.0, 1.0, 0);
