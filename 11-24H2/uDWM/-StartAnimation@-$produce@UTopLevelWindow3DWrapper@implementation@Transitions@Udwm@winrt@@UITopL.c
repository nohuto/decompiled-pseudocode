/*
 * XREFs of ?StartAnimation@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHHURect@Foundation@Windows@3@@Z @ 0x1800803C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct winrt::Windows::Foundation::Rect *a3)
{
  ...
  try
  {
    winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper::StartAnimation(
      v3,
      (const enum winrt::Udwm::Transitions::ShellTransitionType *)&v6,
      a3);
    result = 0LL;
  }
  catch ( ... )
