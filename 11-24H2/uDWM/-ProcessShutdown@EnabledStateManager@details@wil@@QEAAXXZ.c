/*
 * XREFs of ?ProcessShutdown@EnabledStateManager@details@wil@@QEAAXXZ @ 0x18009F3B8
 * Callers:
 *     ??1EnabledStateManager@details@wil@@QEAA@XZ @ 0x180099618 (--1EnabledStateManager@details@wil@@QEAA@XZ.c)
 *     wil::details::_dynamic_atexit_destructor_for__g_enabledStateManager__ @ 0x1800F92C0 (wil--details--_dynamic_atexit_destructor_for__g_enabledStateManager__.c)
 * Callees:
