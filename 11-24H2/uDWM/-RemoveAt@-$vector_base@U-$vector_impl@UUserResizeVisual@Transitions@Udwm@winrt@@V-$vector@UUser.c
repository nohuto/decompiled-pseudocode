 ...
 *     ??$assign@AEAUUserResizeVisual@Transitions@Udwm@winrt@@@?$removed_value@UUserResizeVisual@Transitions@Udwm@winrt@@X@impl@winrt@@QEAAXAEAUUserResizeVisual@Transitions@Udwm@2@@Z @ 0x1800E7FB4 (--$assign@AEAUUserResizeVisual@Transitions@Udwm@winrt@@@-$removed_value@UUserResizeVisual@Transi.c)
 ...
 *     ??1?$_Optional_destruct_base@UUserResizeVisual@Transitions@Udwm@winrt@@$0A@@std@@QEAA@XZ @ 0x1800E8854 (--1-$_Optional_destruct_base@UUserResizeVisual@Transitions@Udwm@winrt@@$0A@@std@@QEAA@XZ.c)
