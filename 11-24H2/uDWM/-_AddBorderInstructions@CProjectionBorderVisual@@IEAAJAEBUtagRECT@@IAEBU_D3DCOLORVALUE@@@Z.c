/*
 * XREFs of ?_AddBorderInstructions@CProjectionBorderVisual@@IEAAJAEBUtagRECT@@IAEBU_D3DCOLORVALUE@@@Z @ 0x1800D0414
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a4)
{
  ...
  if ( !IsRectEmpty(lprc) )
  {
    ...
    {
LABEL_13:
      v19 = CProjectionBorderVisual::_AddRectInstruction((CProjectionBorderVisual *)this, this + 15, a4);
      v8 = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x4Bu, 0LL);
    }
    else
    {
      v21.top = top;
      ...
      v24 = right;
      v25 = bottom;
      v16 = (double)a3 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 52);
      v26 = left;
      v32 = right;
      v23 = bottom - (int)v16;
      v29 = v23;
      v33 = v23;
      v21.bottom = top + (int)v16;
      v28 = left + (int)v16;
      v17 = &v21;
      v27 = v21.bottom;
      v31 = v21.bottom;
      v30 = right - (int)v16;
      while ( v17 != (struct tagRECT *)&v34 )
      {
        v18 = CProjectionBorderVisual::_AddRectInstruction((CProjectionBorderVisual *)this, v17, a4);
        v8 = v18;
        if ( v18 < 0 )
        {
