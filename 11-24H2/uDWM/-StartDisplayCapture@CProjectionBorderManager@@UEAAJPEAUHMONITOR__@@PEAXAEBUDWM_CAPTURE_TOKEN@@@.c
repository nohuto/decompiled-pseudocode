/*
 * XREFs of ?StartDisplayCapture@CProjectionBorderManager@@UEAAJPEAUHMONITOR__@@PEAXAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800CC650
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct DWM_CAPTURE_TOKEN *a4)
{
  ...
  __int64 v22[42]; // [rsp+60h] [rbp-A0h] BYREF
...
LABEL_3:
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x212u, 0LL);
    goto LABEL_13;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopRootVisual, 0x214u, 0LL);
LABEL_13:
    v7 = v16;
    goto LABEL_14;
  }
...
LABEL_14:
  ...
  wil::ActivityBase<WindowFrameLogging,1,35184372088832,5,0,_TlgReflectorTag_Param0IsProviderType>::Stop(v22, v8);
