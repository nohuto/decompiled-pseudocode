/*
 * XREFs of ?ProcessAnimationTick@CDesktopManager@@CAJPEAT_LARGE_INTEGER@@0PEA_N@Z @ 0x180026830
 * Callers:
...
__int64 __fastcall CDesktopManager::ProcessAnimationTick(union _LARGE_INTEGER *a1, union _LARGE_INTEGER *a2, bool *a3)
{
  ...
  if ( CDesktopManager::s_pDesktopManagerInstance )
  {
    ...
    if ( QueryPerformanceCounter(&PerformanceCount) )
    {
      ...
      v6 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x7F5u, 0LL);
      else
        *a1 = PerformanceCount;
    }
    else
    {
      ...
      if ( v6 >= 0 )
        v6 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x7EBu, 0LL);
    }
  }
