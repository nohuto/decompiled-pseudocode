/*
 * XREFs of ??$_Destroy_range@V?$allocator@UCAPTURE_FILTERED_WINDOW@CCaptureManager@@@std@@@std@@YAXPEAUCAPTURE_FILTERED_WINDOW@CCaptureManager@@QEAU12@AEAV?$allocator@UCAPTURE_FILTERED_WINDOW@CCaptureManager@@@0@@Z @ 0x1800ABD0C
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      result = Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease((CBaseObject **)(v3 + 8));
      v3 += 16LL;
    }
    while ( v3 != a2 );
  }
