/*
 * XREFs of ?InitializeVisualTreeClone@CTopLevelWindow@@AEAAJPEAV1@W4CloneOptions@@@Z @ 0x180031104
 * Callers:
...
LABEL_54:
  ...
  *(_QWORD *)(a2 + 248) = **((_QWORD **)v16 + 19);
  ...
  if ( v27 && (*(_BYTE *)(v27 + 36) & 8) == 0 )
  {
    ...
    if ( v46 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v46, 0x15CCu, 0LL);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v47, 0x15CDu, 0LL);
    }
    Microsoft::WRL::ComPtr<IDCompositionTarget>::InternalRelease(&v49);
    goto LABEL_31;
  }
LABEL_29:
  ...
  *(_QWORD *)(a2 + 672) = v29;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x15DEu, 0LL);
  }
LABEL_31:
  *(_BYTE *)(a1 + 200) &= ~0x10u;
  return v6;
