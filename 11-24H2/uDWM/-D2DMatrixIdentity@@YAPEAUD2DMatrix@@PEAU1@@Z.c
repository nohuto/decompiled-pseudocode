/*
 * XREFs of ?D2DMatrixIdentity@@YAPEAUD2DMatrix@@PEAU1@@Z @ 0x180019394
 * Callers:
 ...
 *     ?GetMirrorTransform@CVisual@@MEAAXPEAUD2DMatrix@@@Z @ 0x18007F0A0 (-GetMirrorTransform@CVisual@@MEAAXPEAUD2DMatrix@@@Z.c)
 * Callees:
 *     <none>
 */
