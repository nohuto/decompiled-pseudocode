/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800B7EA0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x1800B7C10 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( v7 < 1.0 )
  {
    ...
    if ( a4 )
    {
      ...
      do
      {
        a3[v16] = (float)(1.0 - v14) * *(double *)(*((_QWORD *)this + 2) + v16 * 8)
                + v14 * *(double *)(v16 * 8 + *((_QWORD *)this + 3));
        ++v16;
        --v15;
      }
      while ( v15 );
