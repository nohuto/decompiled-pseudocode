/*
 * XREFs of ??0?$producers_base@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@V?$tuple@UTopLevelWindow3DWrapper@Transitions@Udwm@winrt@@UITransitionAnimationVisualNative@@@std@@@impl@winrt@@QEAA@XZ @ 0x180096D1C
 * Callers:
 ...
 * Callees:
 *     ??0?$producer_convert@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@X@impl@winrt@@QEAA@XZ @ 0x180084E48 (--0-$producer_convert@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@X@im.c)
 */
