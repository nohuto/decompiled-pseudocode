/*
 * XREFs of ?Create@CDisplayExtendToDuplicateAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800C10D8
 * Callers:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::Create(struct CDisplayExtendToDuplicateAnimatedVisual **a1)
{
  ...
  struct CDisplayExtendToDuplicateAnimatedVisual *v4; // rbx

  if ( a1 )
  {
    v3 = (CDisplayExtendToDuplicateAnimatedVisual *)DefaultHeap::AllocClear(0x1C0uLL);
    if ( v3 )
