/*
 * XREFs of ??$find@U?$find_iid_traits@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@@@?$interface_list@UAnimatedTransitionVisualWrapper@Transitions@Udwm@winrt@@UITransitionAnimationVisualNative@@@impl@winrt@@SA?A_PAEBU?$find_iid_traits@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@@12@@Z @ 0x180098CD8
 * Callers:
 *     ??$find_iid@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x180098CB4 (--$find_iid@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@.c)
 * Callees:
 ...
 *     ??$is_guid_of@UIAnimatedTransitionVisualWrapper@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x18009A8B4 (--$is_guid_of@UIAnimatedTransitionVisualWrapper@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@@.c)
 */
