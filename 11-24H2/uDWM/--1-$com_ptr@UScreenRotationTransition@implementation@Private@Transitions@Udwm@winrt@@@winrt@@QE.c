/*
 * XREFs of ??1?$com_ptr@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@winrt@@QEAA@XZ @ 0x18009AFC0
 * Callers:
 *     _winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition::DelayNextAnimation_::_1_::dtor$0 @ 0x1800F8999 (_winrt--Udwm--Transitions--Private--implementation--ScreenRotationTransition--DelayNextAnimation.c)
 * Callees:
