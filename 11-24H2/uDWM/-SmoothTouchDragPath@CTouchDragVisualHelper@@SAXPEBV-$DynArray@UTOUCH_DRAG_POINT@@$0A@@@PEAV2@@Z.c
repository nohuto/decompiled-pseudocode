/*
 * XREFs of ?SmoothTouchDragPath@CTouchDragVisualHelper@@SAXPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEAV2@@Z @ 0x18000FE58
 * Callers:
 ...
 *     ?GetMidPoint@CTouchDragVisualHelper@@CA?AUTOUCH_DRAG_POINT@@PEBU2@0@Z @ 0x1800107B8 (-GetMidPoint@CTouchDragVisualHelper@@CA-AUTOUCH_DRAG_POINT@@PEBU2@0@Z.c)
...
void __fastcall CTouchDragVisualHelper::SmoothTouchDragPath(__int64 *a1, __int64 *a2)
{
  ...
  v2 = *((_DWORD *)a1 + 6);
  *((_DWORD *)a2 + 6) = 0;
  DynArrayImpl<0>::ShrinkToSize(a2, 28LL);
  for ( i = 0; i < v2; i += 2 )
  {
    v6 = *a1;
    if ( i + 4 > v2 )
    ...
    do
    {
      ...
      *(__int64 *)((char *)v98.m128i_i64 + 4) = v36;
      ...
      else if ( v52 > *((_DWORD *)a2 + 5) )
      {
        v74 = DynArrayImpl<0>::AddMultipleAndSet(a2, 28LL, 1LL, &v98);
        if ( v74 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v74, 0xBEu, 0LL);
      }
      else
      {
        v53 = *a2;
