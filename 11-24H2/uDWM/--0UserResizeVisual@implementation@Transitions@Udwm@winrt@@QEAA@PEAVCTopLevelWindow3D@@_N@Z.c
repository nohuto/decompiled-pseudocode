/*
 * XREFs of ??0UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAA@PEAVCTopLevelWindow3D@@_N@Z @ 0x1800EB158
 * Callers:
 *     ??$create_and_initialize@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@AEAPEAVCTopLevelWindow3D@@_N@impl@winrt@@YAPEAUUserResizeVisual@implementation@Transitions@Udwm@1@AEAPEAVCTopLevelWindow3D@@$$QEA_N@Z @ 0x1800E80AC (--$create_and_initialize@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@AEAPEAVCTopLev.c)
 * Callees:
  ...
  *v5 = 0LL;
  ...
  if ( v8 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v12);
  v9 = *((_QWORD *)this + 9);
  *((_DWORD *)this + 22) = *(_DWORD *)(*(_QWORD *)(v9 + 288) + 744LL) & 0xFFF;
