/*
 * XREFs of ?GetWindowRestoreRect@CWindowData@@QEAAJPEAUtagRECT@@_N@Z @ 0x1800039BC
 * Callers:
...
__int64 __fastcall CWindowData::GetWindowRestoreRect(CWindowData *this, struct tagRECT *a2, char a3)
{
  ...
  tagMONITORINFO mi; // [rsp+68h] [rbp-1h] BYREF
  ...
  if ( !GetWindowPlacement(*((HWND *)this + 5), &wndpl) )
  {
    ...
    if ( (v3 & 0x80000000) == 0 )
      v3 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x672u, 0LL);
    return v3;
  }
  ...
  if ( !v15 )
  {
    ...
    if ( (v3 & 0x80000000) == 0 )
      v3 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x68Du, 0LL);
    return v3;
  }
  if ( (wndpl.flags & 2) == 0 )
  {
...
LABEL_35:
  ...
  if ( (v3 & 0x80000000) == 0 )
    v3 = -2003304445;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x693u, 0LL);
  return v3;
}
