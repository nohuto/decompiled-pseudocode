/*
 * XREFs of ?_SetupWindowPreview@CLivePreview@@AEAAJPEAVCWindowData@@PEAUHWND__@@_NW4Enum@LivePreviewWindowState@@PEAVCVisual@@2@Z @ 0x180002DB0
 * Callers:
        ...
        char a7)
{
  ...
  if ( LivePreviewVisual < 0 )
  {
    v14 = 402;
LABEL_5:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, v14, 0LL);
    if ( v13 )
  ...
  if ( a7 )
  {
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x1B3u, 0LL);
      goto LABEL_7;
    }
  }
  else
  {
    v19 = CContainerVisual::InsertChildAfter(v16, v12, a6);
    v7 = v19;
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x1B7u, 0LL);
      goto LABEL_7;
    }
  }
  ...
  v7 = v20;
  if ( v20 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x1BAu, 0LL);
LABEL_7:
  if ( v12 )
