/*
 * XREFs of ?Create@CCompositionEffectCache@@SAJPEAPEAV1@@Z @ 0x180084BBC
 * Callers:
 *     ?Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z @ 0x18007FA54 (-Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z.c)
 * Callees:
 *     ??$make_unique@VCCompositionEffectCache@@$$V$0A@@std@@YA?AV?$unique_ptr@VCCompositionEffectCache@@U?$default_delete@VCCompositionEffectCache@@@std@@@0@XZ @ 0x180084C38 (--$make_unique@VCCompositionEffectCache@@$$V$0A@@std@@YA-AV-$unique_ptr@VCCompositionEffectCache.c)
