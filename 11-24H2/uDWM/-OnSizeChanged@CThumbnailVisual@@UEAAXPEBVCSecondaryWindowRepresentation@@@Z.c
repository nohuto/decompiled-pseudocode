/*
 * XREFs of ?OnSizeChanged@CThumbnailVisual@@UEAAXPEBVCSecondaryWindowRepresentation@@@Z @ 0x180067B20
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSecondaryWindowRepresentation *a2)
{
  ...
  CThumbnailVisual::SetDirtyFlags((CThumbnailVisual *)((char *)this - 320), 0x4000u);
  v3 = *((_QWORD *)this + 1);
