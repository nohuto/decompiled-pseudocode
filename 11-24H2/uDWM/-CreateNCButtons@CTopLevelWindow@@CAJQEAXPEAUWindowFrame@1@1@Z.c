/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x18000D118
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( v7 < 0xC )
  {
    ...
    if ( v8 != -1 )
    {
      v10 = CTopLevelWindow::CreateBitmapsFromAtlasImageStrip(a1, v8, 4u, &v16, *(&v18 + 2 * v7));
      v3 = v10;
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x437u, 0LL);
        return v3;
      }
      ...
      if ( ThemeMargins < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeMargins, 0x438u, 0LL);
        return v3;
      }
      if ( *(_DWORD *)(v9 + 24) )
      {
