/*
 * XREFs of ??0?$producers_base@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@V?$tuple@UScreenRotationTransition@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@2345@@std@@@impl@winrt@@QEAA@XZ @ 0x180095508
 * Callers:
 ...
 * Callees:
 *     ??0?$producer_convert@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@3456@X@impl@winrt@@QEAA@XZ @ 0x18009552C (--0-$producer_convert@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U.c)
 *     ??0?$producer_convert@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@X@impl@winrt@@QEAA@XZ @ 0x18009555C (--0-$producer_convert@UScreenRotationTransition@implementation@Private@Transitions@_ea_18009555C.c)
 */
