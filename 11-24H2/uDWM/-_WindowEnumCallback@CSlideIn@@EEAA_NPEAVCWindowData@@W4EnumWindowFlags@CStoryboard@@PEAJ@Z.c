/*
 * XREFs of ?_WindowEnumCallback@CSlideIn@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800D8350
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z @ 0x1800A4DFC (-SetChopPosition@CAnimatedTransitionVisual@@QEAAXPEBN0I@Z.c)
