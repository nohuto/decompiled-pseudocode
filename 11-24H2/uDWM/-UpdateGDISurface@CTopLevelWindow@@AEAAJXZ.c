/*
 * XREFs of ?UpdateGDISurface@CTopLevelWindow@@AEAAJXZ @ 0x18006B854
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateGDISurface(CTopLevelWindow *this)
{
  ...
  if ( (*(_BYTE *)(v1 + 737) & 0x20) != 0 )
  {
    if ( *((_QWORD *)this + 60) )
    {
      ...
      v2 = v3;
      if ( v3 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x1520u, 0LL);
    }
  }
  return v2;
}
