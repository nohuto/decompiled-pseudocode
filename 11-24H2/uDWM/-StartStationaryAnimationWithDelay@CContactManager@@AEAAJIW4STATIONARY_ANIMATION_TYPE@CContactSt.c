/*
 * XREFs of ?StartStationaryAnimationWithDelay@CContactManager@@AEAAJIW4STATIONARY_ANIMATION_TYPE@CContactStationaryVisual@@PEBUtagPOINT@@PEBUtagRECT@@_K_N@Z @ 0x1800126CC
 * Callers:
        ...
        char a7)
{
  ...
  *(_QWORD *)((char *)&v22 + 4) = v7;
  ...
  if ( (int)CContactManager::AddToTouchNode(v12, a6, v23) < 0 )
  {
LABEL_12:
    if ( v13 >= 0 )
  ...
  if ( v15 >= 0 )
  {
    ...
    {
      v20 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 120, 24LL, 1LL, &v22);
      if ( v20 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0xBEu, 0LL);
    }
    else
    {
...
LABEL_5:
  if ( v23 )
  {
    CContactManager::RemoveFromTouchNode(v14, a6, v23);
    if ( v23 )
