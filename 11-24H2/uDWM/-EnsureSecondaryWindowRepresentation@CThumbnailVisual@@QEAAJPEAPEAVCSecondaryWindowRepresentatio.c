/*
 * XREFs of ?EnsureSecondaryWindowRepresentation@CThumbnailVisual@@QEAAJPEAPEAVCSecondaryWindowRepresentation@@@Z @ 0x18001F550
 * Callers:
 ...
 *     ?_GetDestWidth@CThumbnailVisual@@AEAAHXZ @ 0x18007AFCC (-_GetDestWidth@CThumbnailVisual@@AEAAHXZ.c)
 */
...
LABEL_2:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x216u, 0LL);
  }
  return v2;
}
