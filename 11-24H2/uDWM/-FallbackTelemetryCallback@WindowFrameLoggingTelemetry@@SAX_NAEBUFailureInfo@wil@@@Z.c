/*
 * XREFs of ?FallbackTelemetryCallback@WindowFrameLoggingTelemetry@@SAX_NAEBUFailureInfo@wil@@@Z @ 0x1800C9CA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall WindowFrameLoggingTelemetry::FallbackTelemetryCallback(__int64 a1, const struct wil::FailureInfo *a2)
{
  char v3; // di
