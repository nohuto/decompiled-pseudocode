/*
 * XREFs of ?StartHideAnimation@?$consume_Udwm_Transitions_IUserResizeVisual@UIUserResizeVisual@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@AEBUUnloadDelegate@Transitions@Udwm@3@@Z @ 0x1800E57A4
 * Callers:
