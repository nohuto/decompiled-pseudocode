/*
 * XREFs of ?_StageCloneWithOwnedWindows@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCContainerVisual@@HW4StagedBackgroundPolicy@1@@Z @ 0x18008BAFC
 * Callers:
    ...
    else
    {
      ...
      if ( !v11 )
      {
        ...
        if ( v21 >= 0 )
          v19 = v21;
        v22 = 0;
        v23 = v12[47].top - bottom;
        if ( v23 >= 0 )
          v22 = v12[47].top - bottom;
        if ( v22 > v19 )
        {
          v24 = 0;
          if ( v23 >= 0 )
            v24 = v12[47].top - bottom;
          rc.right = v20 + v24;
        }
        v25 = 0;
        left = v12[47].left;
        ...
        v27 = 0;
        v28 = v12[47].right - left;
        if ( v28 >= 0 )
          v27 = v12[47].right - left;
        if ( v27 > v25 )
        {
          v29 = 0;
          if ( v28 >= 0 )
            v29 = v12[47].right - left;
      ...
      {
        v30 = 0;
        v31 = v12[49].top - v12[48].bottom;
        if ( v31 >= 0 )
          v30 = v12[49].top - v12[48].bottom;
        v32 = 0;
        ...
        if ( v30 > v32 )
        {
          v33 = 0;
          if ( v31 >= 0 )
            v33 = v12[49].top - v12[48].bottom;
          rc.right = rc.left + v33;
        }
        v34 = 0;
        v35 = v12[49].right - v12[49].left;
        if ( rc.bottom - rc.top >= 0 )
          v34 = rc.bottom - rc.top;
        v36 = 0;
        if ( v35 >= 0 )
          v36 = v12[49].right - v12[49].left;
        if ( v36 > v34 )
        {
          v37 = 0;
          if ( v35 >= 0 )
            v37 = v12[49].right - v12[49].left;
