/*
 * XREFs of ?_UpdateTabGroupMap@CProjectionBorderManager@@AEAAJPEAUHWND__@@PEAVCapturedWindowRepresentation@@AEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800D0080
 * Callers:
...
LABEL_5:
  ...
  v10 = CCaptureManager::_SetScreenCaptureForWindow(v7, *v9, 0);
  if ( v10 < 0 )
  {
    v11 = 1831LL;
    goto LABEL_5;
  ...
  v14 = *v9;
  v20 = 0LL;
  ProxyWindowHandle = CCaptureManager::_GetProxyWindowHandle(v13, v14, &v20);
...
LABEL_10:
  ...
  if ( v20 )
  {
    ...
    ProxyWindowHandle = CCaptureManager::_SetScreenCaptureForWindow(v15, v18, 0);
    if ( ProxyWindowHandle < 0 )
    {
      v17 = 1843LL;
      goto LABEL_10;
