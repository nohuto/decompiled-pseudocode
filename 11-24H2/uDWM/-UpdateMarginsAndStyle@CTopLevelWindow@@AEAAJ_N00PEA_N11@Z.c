/*
 * XREFs of ?UpdateMarginsAndStyle@CTopLevelWindow@@AEAAJ_N00PEA_N11@Z @ 0x180029060
 * Callers:
 ...
 *     ?UpdateStyle@CTopLevelWindow@@AEAA_NXZ @ 0x18002B8E0 (-UpdateStyle@CTopLevelWindow@@AEAA_NXZ.c)
        ...
        bool *a7)
{
  ...
  if ( a3 || v19 || v24 || (_BYTE)v15 || v18 || a4 )
  {
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1194u, 0LL);
      goto LABEL_31;
    }
    v17 = (struct CWindowData **)((char *)this + 712);
  }
