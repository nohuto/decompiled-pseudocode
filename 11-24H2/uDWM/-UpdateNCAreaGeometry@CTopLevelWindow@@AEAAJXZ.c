/*
 * XREFs of ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x18002DB50
 * Callers:
 ...
 *     ?EdgeBorderMustBeOpaque@CTopLevelWindow@@AEAAHXZ @ 0x18005ABF0 (-EdgeBorderMustBeOpaque@CTopLevelWindow@@AEAAHXZ.c)
...
__int64 __fastcall CTopLevelWindow::UpdateNCAreaGeometry(CLegacyNonClientBackground **this)
{
  ...
  v51 = v6;
  v48 = (int)((double)dword_1801269B8 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 52));
  if ( !CDesktopManager::IsHighContrastMode() )
  {
    v10 = this[89];
    if ( (*((_DWORD *)v10 + 24) || *((_DWORD *)v10 + 25) || *((_DWORD *)v10 + 27)) && (*((_BYTE *)v10 + 737) & 4) == 0 )
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v15, 0x1410u, 0LL);
  ...
  if ( v33 )
  {
    ...
    if ( v38 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v38, 0x13FDu, 0LL);
LABEL_18:
      DeleteObject(v2);
LABEL_19:
      if ( v3 )
    ...
    if ( v39 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v39, 0x1403u, 0LL);
      goto LABEL_23;
    }
    SetLastError(0);
    v4 = hrgnDst;
...
LABEL_6:
    ...
    if ( v14 >= 0 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v16, 0x1427u, 0LL);
LABEL_23:
      v4 = hrgnDst;
      goto LABEL_15;
    }
...
LABEL_28:
    v18 = v14;
LABEL_29:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v18, v46, 0LL);
LABEL_15:
    if ( v4 )
      DeleteObject(v4);
    if ( !v2 )
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180106140, 10LL, v15, 0x13FBu, 0LL);
  return (unsigned int)v15;
}
