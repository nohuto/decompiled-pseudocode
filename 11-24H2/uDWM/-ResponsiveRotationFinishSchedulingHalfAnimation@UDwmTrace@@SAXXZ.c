/*
 * XREFs of ?ResponsiveRotationFinishSchedulingHalfAnimation@UDwmTrace@@SAXXZ @ 0x1800E1528
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationFinishSchedulingHalfAnimation(__int64 a1)
{
