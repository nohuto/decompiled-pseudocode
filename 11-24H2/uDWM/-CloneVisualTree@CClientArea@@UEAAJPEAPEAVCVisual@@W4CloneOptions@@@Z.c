/*
 * XREFs of ?CloneVisualTree@CClientArea@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x18003E7F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  {
    v9 = CVisual::InitializeVisualTreeClone(a1, v50);
    if ( v9 >= 0 )
    {
      v10 = v50;
      v50 = 0LL;
