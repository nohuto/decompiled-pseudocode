/*
 * XREFs of ?UpdateColorTransform@CFullScreenMagnifier@@AEAAJXZ @ 0x1800C344C
 * Callers:
...
__int64 __fastcall CFullScreenMagnifier::UpdateColorTransform(CFullScreenMagnifier *this)
{
  ...
  v117 = (CVisualProxy **)*((_QWORD *)this + 2);
  ...
  if ( v118 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v118, 0x128u, 0LL);
  }
  else
  {
    v120 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 48LL))(*((_QWORD *)this + 2));
    v119 = v120;
    if ( v120 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v120, 0x12Du, 0LL);
  }
  return v119;
}
