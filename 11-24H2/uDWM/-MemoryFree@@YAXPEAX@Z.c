/*
 * XREFs of ?MemoryFree@@YAXPEAX@Z @ 0x180098F70
 * Callers:
 ...
 *     ?SetBuffer@RawUsageIndex@details_abi@wil@@QEAAXPEAX_K1@Z @ 0x18007147C (-SetBuffer@RawUsageIndex@details_abi@wil@@QEAAXPEAX_K1@Z.c)
 *     ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x180073AC4 (--1UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 *     ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x180080F1C (--1RawUsageIndex@details_abi@wil@@QEAA@XZ.c)
 *     ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x180089C78 (--1FeatureStateManager@details@wil@@QEAA@XZ.c)
 *     ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800984C4 (--1SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x1800A02AC (-Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z.c)
 * Callees:
 *     <none>
 */
