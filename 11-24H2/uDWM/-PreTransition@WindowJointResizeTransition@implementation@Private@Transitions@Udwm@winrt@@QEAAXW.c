/*
 * XREFs of ?PreTransition@WindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXW4ShellTransitionType@456@AEBUTransitionState@456@@Z @ 0x1800E53C8
 * Callers:
 *     ?PreTransition@?$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHHPEAX@Z @ 0x1800E5390 (-PreTransition@-$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@wi.c)
 * Callees:
...
void __fastcall winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::PreTransition(
        __int64 a1,
        __int64 a2,
        winrt::Windows::Foundation::IUnknown *a3)
{
  ...
  _QWORD *v11; // rsi
  __int64 v12; // rax
  __int64 (__fastcall ***v13)(_QWORD, __int64 *, __int64 *); // [rsp+20h] [rbp-60h] BYREF
  __int64 *v14; // [rsp+28h] [rbp-58h] BYREF
  __int64 v15; // [rsp+30h] [rbp-50h] BYREF
  _BYTE v16[8]; // [rsp+38h] [rbp-48h] BYREF
  int v17; // [rsp+40h] [rbp-40h]
  _BYTE v18[8]; // [rsp+48h] [rbp-38h] BYREF
  int v19; // [rsp+50h] [rbp-30h]
  _BYTE v20[16]; // [rsp+58h] [rbp-28h] BYREF
  _QWORD *v21; // [rsp+68h] [rbp-18h] BYREF
  char v22; // [rsp+70h] [rbp-10h]

  winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::Cancel((winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition *)a1);
  winrt::Windows::Foundation::IUnknown::operator=((winrt::Windows::Foundation::IUnknown *)(a1 + 32), a3);
  ...
  winrt::Udwm::Transitions::AnimationCompletedHandler::~AnimationCompletedHandler((winrt::Udwm::Transitions::AnimationCompletedHandler *)&v14);
  if ( (unsigned int)winrt::impl::consume_Windows_Foundation_Collections_IVector<winrt::Windows::Foundation::Collections::IVector<winrt::Udwm::Transitions::UserResizeVisual>,winrt::Udwm::Transitions::UserResizeVisual>::Size(a1 + 40) )
  {
    ...
    for ( i = v17; i != v19; v17 = i )
    {
      ...
      winrt::impl::as<IUserResizeVisualNative,winrt::impl::abi<winrt::Windows::Foundation::IUnknown,void>::type,0>(
        ...
        v13);
      v9 = v14;
      v15 = (*(__int64 (__fastcall **)(__int64 *))(*v14 + 64))(v14);
      v10 = std::_Hash<std::_Umap_traits<HWND__ *,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>,std::_Uhash_compare<HWND__ *,std::hash<HWND__ *>,std::equal_to<HWND__ *>>,std::allocator<std::pair<HWND__ * const,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>>>,0>>::_Extract<HWND__ *>(
              (_QWORD *)(a1 + 48),
              (__int64)&v15);
      if ( v10 )
      {
      ...
      if ( v11 )
      {
        (*(void (__fastcall **)(__int64 *, _QWORD))(v12 + 56))(v9, v11[3]);
      }
      else
      {
        v15 = (*(__int64 (__fastcall **)(__int64 *))(v12 + 64))(v9);
      ...
      if ( v11 )
      {
        std::pair<HWND__ * const,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>>::`scalar deleting destructor'((__int64)(v11 + 2));
        std::_Deallocate<16,0>(v11, (const struct std::nothrow_t *)0x20);
        v21 = 0LL;
      }
      winrt::impl::consume_Udwm_Transitions_IUserResizeVisual<winrt::Udwm::Transitions::IUserResizeVisual>::StartShowAnimation((__int64 *)&v13);
      if ( v9 )
        winrt::com_ptr<IBitmapManager>::unconditional_release_ref((__int64 *)&v14);
  ...
  {
    winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::Cleanup((winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition *)a1);
  }
}
