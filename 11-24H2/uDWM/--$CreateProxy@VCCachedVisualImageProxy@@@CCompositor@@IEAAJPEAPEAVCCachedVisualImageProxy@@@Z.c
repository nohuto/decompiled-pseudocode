/*
 * XREFs of ??$CreateProxy@VCCachedVisualImageProxy@@@CCompositor@@IEAAJPEAPEAVCCachedVisualImageProxy@@@Z @ 0x18006A868
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CCachedVisualImageProxy>(__int64 a1, CBaseTransformProxy **a2)
{
  CBaseTransformProxy *v4; // rbx
  CCachedVisualImageProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CCachedVisualImageProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 < 0 )
    {
