/*
 * XREFs of ?CreateBitmapsFromAtlasImageStrip@CTopLevelWindow@@SAJQEAXHIPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x180025354
 * Callers:
        ...
        struct _MARGINS *a4)
{
  ...
  if ( ThemeRect < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, ThemeRect, 0x3CEu, 0LL);
  }
  else if ( a4
         && (ThemeMargins = GetThemeMargins(a1, 0LL, iPartId, 0, 3601, 0LL, a4), v9 = ThemeMargins, ThemeMargins < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, ThemeMargins, 0x3D2u, 0LL);
  }
  else
  {
    v10 = 0;
    ...
    while ( v12 < a3 )
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180105630, 1u, v17, 0x3E9u, 0LL);
        return v9;
      }
      top = pRect.top;
      ++v12;
