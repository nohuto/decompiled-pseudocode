/*
 * XREFs of ?_EnumerateWindows@CStoryboard@@IEAAJW4EnumWindowFlags@1@@Z @ 0x1800694E0
 * Callers:
 ...
 *     ?GetStoredSnapshotNoRefByIndex@CTransitionVisualController@@QEAAJHPEAPEAVCTransitionWindowSnapshot@@@Z @ 0x180069780 (-GetStoredSnapshotNoRefByIndex@CTransitionVisualController@@QEAAJHPEAPEAVCTransitionWindowSnapsh.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1800FA010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

__int64 __fastcall CStoryboard::_EnumerateWindows(__m128i *a1, unsigned int a2)
{
  __int64 v4; // rax
  char v5; // di
  ...
  if ( (unsigned int)GetDesktopID(1LL, &v14) )
  {
    ...
    if ( (v4 == -1 || v4 == v14) && *(_DWORD *)((*(__int64 (__fastcall **)(__m128i *))(a1->m128i_i64[0] + 16))(a1) + 4) )
    {
      v5 = 1;
