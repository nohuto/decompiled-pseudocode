/*
 * XREFs of ?GetCVIFromCache@CDesktopManager@@SAJHHPEAPEAVCCachedVisualImageProxy@@@Z @ 0x180004314
 * Callers:
...
__int64 __fastcall CDesktopManager::GetCVIFromCache(int a1, int a2, struct CCachedVisualImageProxy **a3)
{
  ...
  {
    v6 = (unsigned int)i;
    if ( *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + i + 155) )
    {
      if ( CDesktopManager::_IsSameAsTargetCachedCVI(a1, a2) )
      {
        v8 = CDesktopManager::s_pDesktopManagerInstance;
        *a3 = (struct CCachedVisualImageProxy *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + v6 + 155);
        *((_QWORD *)v8 + v6 + 155) = 0LL;
        return 0;
      }
      return v4;
    }
