/*
 * XREFs of ?UpdateDesktopAndMonitorTopologyInformation@MagnifierExperienceHelper@@QEAAXXZ @ 0x180084DC4
 * Callers:
...
void __fastcall MagnifierExperienceHelper::UpdateDesktopAndMonitorTopologyInformation(MagnifierExperienceHelper *this)
{
  ...
  v1 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 380);
  v2 = _mm_srli_si128(*(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 380), 8).m128i_u64[0];
  *(_DWORD *)this = v1;
  *((_OWORD *)this + 3) = 0LL;
  v3 = v2 + v1;
  v1 >>= 32;
