/*
 * XREFs of ?ResponsiveRotationPreRotationVisualsCaptured@UDwmTrace@@SAXXZ @ 0x1800E15C8
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationPreRotationVisualsCaptured(__int64 a1)
{
