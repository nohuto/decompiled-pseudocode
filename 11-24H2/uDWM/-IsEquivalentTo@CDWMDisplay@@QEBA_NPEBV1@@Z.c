/*
 * XREFs of ?IsEquivalentTo@CDWMDisplay@@QEBA_NPEBV1@@Z @ 0x1800C2B58
 * Callers:
 ...
 *     ?IsInfinite@?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@QEBA_NXZ @ 0x1800C2CEC (-IsInfinite@-$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@QEBA_NXZ.c)
