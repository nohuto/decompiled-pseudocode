/*
 * XREFs of ?get_unknown@?$implements@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@U1345@UIUserResizeVisualNative@@@winrt@@EEBAPEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@impl@2@XZ @ 0x1800DF120
 * Callers:
 *     <none>
 * Callees:
 *     <none>
