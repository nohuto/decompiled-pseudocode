/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Tree_node@PEAVCWindowData@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800BCB74
 * Callers:
 ...
 *     _std::_Tree_temp_node_std::allocator_std::_Tree_node_CWindowData___void_______::_Tree_temp_node_std::allocator_std::_Tree_node_CWindowData___void________CWindowData___&__::_1_::dtor$1 @ 0x1800F855B (_std--_Tree_temp_node_std--allocator_std--_Tree_node_CWindowData___void_______--_Tree_temp_node_.c)
 * Callees:
