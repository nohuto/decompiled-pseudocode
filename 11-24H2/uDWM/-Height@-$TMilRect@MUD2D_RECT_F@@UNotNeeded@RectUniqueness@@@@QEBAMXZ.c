/*
 * XREFs of ?Height@?$TMilRect@MUD2D_RECT_F@@UNotNeeded@RectUniqueness@@@@QEBAMXZ @ 0x18003B8E0
 * Callers:
...
// attributes: thunk
float __fastcall TMilRect<float,D2D_RECT_F,RectUniqueness::NotNeeded>::Height(__int64 a1)
{
  return TMilRect<float,D2D_RECT_F,RectUniqueness::NotNeeded>::Height<float>(a1);
}
