/*
 * XREFs of ?ForceConnectClientNode@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800EF5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceConnectClientNode(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( v10 )
  {
    *((_BYTE *)v5 + 740) ^= (*((_BYTE *)v5 + 740) ^ (32
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x1A93u, 0LL);
    }
    else
    {
      ...
      if ( v7 )
      {
        ...
        v4 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1A97u, 0LL);
      }
    }
  }
