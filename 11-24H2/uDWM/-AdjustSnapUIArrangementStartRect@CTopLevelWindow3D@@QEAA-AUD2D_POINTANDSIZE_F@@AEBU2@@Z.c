/*
 * XREFs of ?AdjustSnapUIArrangementStartRect@CTopLevelWindow3D@@QEAA?AUD2D_POINTANDSIZE_F@@AEBU2@@Z @ 0x1800DB8B4
 * Callers:
 *     ?AdjustSnapUIArrangementStartRect@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAA?AURect@Foundation@Windows@5@AEBU6785@@Z @ 0x1800E642C (-AdjustSnapUIArrangementStartRect@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@.c)
 * Callees:
 ...
 *     _o_roundf_0 @ 0x18009C48C (_o_roundf_0.c)
 */
