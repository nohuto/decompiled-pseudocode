/*
 * XREFs of ?OnRootVisualChanged@CThumbnailVisual@@UEAAXPEBVCSecondaryWindowRepresentation@@@Z @ 0x18007A170
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSecondaryWindowRepresentation *a2)
{
  ...
  CThumbnailVisual::SetDirtyFlags((CThumbnailVisual *)((char *)this - 320), 0x2000);
}
