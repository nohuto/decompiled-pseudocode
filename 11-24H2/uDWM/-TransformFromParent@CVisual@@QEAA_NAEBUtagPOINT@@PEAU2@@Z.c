/*
 * XREFs of ?TransformFromParent@CVisual@@QEAA_NAEBUtagPOINT@@PEAU2@@Z @ 0x180021040
 * Callers:
 ...
 *     ?D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z @ 0x180069A68 (-D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z.c)
...
bool __fastcall CVisual::TransformFromParent(CVisual *this, const struct tagPOINT *a2, struct tagPOINT *a3)
{
  ...
  *a3 = *a2;
  ...
  {
    CVisual::GetCurrentTransform(this, (struct D2DMatrix *)v11, (__int64)a3);
