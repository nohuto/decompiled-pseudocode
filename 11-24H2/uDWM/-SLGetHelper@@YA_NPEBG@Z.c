/*
 * XREFs of ?SLGetHelper@@YA_NPEBG@Z @ 0x18005ACF0
 * Callers:
 ...
 * Callees:
 *     ?MemoryAlloc@@YAPEAX_K@Z @ 0x1800605CC (-MemoryAlloc@@YAPEAX_K@Z.c)
 *     StringLengthWorkerW @ 0x180060600 (StringLengthWorkerW.c)
 *     RtlULongLongAdd @ 0x180075BF0 (RtlULongLongAdd.c)
 *     RtlUIntAdd @ 0x18007D4B0 (RtlUIntAdd.c)
...
bool __fastcall SLGetHelper(const unsigned __int16 *a1)
{
  ...
  *v4 = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[0];
  v4[1] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[1];
  v4[2] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[2];
  v4[3] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[3];
  v4[4] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[4];
  v4[5] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[5];
  v4[6] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[6];
  v4[7] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[7];
  v4[8] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[8];
  v7 = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[9];
  LODWORD(Size) = 160;
  v4[9] = v7;
  LODWORD(v644) = 160;
  v8 = GetProcessHeap();
  ...
  *v9 = `WarbirdUmGetDecryptionKey'::`2'::nDecryptionKey;
  LODWORD(v637) = 8;
  v640 = __rdtsc();
  v2 = v9;
  LODWORD(Size) = Size + 4;
  ...
  if ( v416 )
  {
    ...
    *(_DWORD *)v634 = (_DWORD)Src;
          ...
          (v423 = HeapAlloc(v422, 8u, 0xA0uLL)) != 0LL) )
    {
      ...
      v424 = (_OWORD *)v419[3];
      LODWORD(v641) = v638;
      *v424 = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[0];
      v424[1] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[1];
      v424[2] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[2];
      v424[3] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[3];
      v424[4] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[4];
      v424[5] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[5];
      v424[6] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[6];
      v424[7] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[7];
      v424[8] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[8];
      v424[9] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[9];
      *((_DWORD *)v419 + 8) = 8;
      v425 = GetProcessHeap();
      ...
      if ( v426 )
      {
        ...
        v418 = 0;
        **((_QWORD **)v634 + 5) = `WarbirdUmGetEncryptionKey'::`2'::nEncryptionKey;
        v428 = v427;
LABEL_571:
        psz = 0LL;
        goto LABEL_572;
...
LABEL_82:
  ...
  if ( v662 )
  {
    ...
    *(_OWORD *)v659 = 0LL;
    ...
    LODWORD(Size) = 160;
    *v19 = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[0];
    v19[1] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[1];
    v19[2] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[2];
    v19[3] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[3];
    v19[4] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[4];
    v19[5] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[5];
    v19[6] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[6];
    v19[7] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[7];
    v19[8] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[8];
    v19[9] = `WarbirdUmGetDecryptionCipher'::`2'::DecryptionCipher[9];
    v20 = GetProcessHeap();
    ...
    *v21 = `WarbirdUmGetDecryptionKey'::`2'::nDecryptionKey;
    LODWORD(v637) = 8;
    v629 = __rdtsc();
    v17 = v22;
    LODWORD(v647) = 164;
            ...
            *(_DWORD *)v99 = dwBytes;
            ...
            if ( v103 )
            {
              ...
              *((_DWORD *)v99 + 4) = 160;
              ...
              {
                v99[3] = v105;
                *v105 = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[0];
                v105[1] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[1];
                v105[2] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[2];
                v105[3] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[3];
                v105[4] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[4];
                v105[5] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[5];
                v105[6] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[6];
                v105[7] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[7];
                v105[8] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[8];
                v105[9] = `WarbirdUmGetEncryptionCipher'::`2'::EncryptionCipher[9];
                *((_DWORD *)v99 + 8) = 8;
                v106 = GetProcessHeap();
                ...
                if ( v107 )
                {
                  v99[5] = v107;
                  v100 = 0;
                  *v107 = `WarbirdUmGetEncryptionKey'::`2'::nEncryptionKey;
