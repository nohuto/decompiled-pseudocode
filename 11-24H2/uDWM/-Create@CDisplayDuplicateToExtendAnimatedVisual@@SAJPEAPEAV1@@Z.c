/*
 * XREFs of ?Create@CDisplayDuplicateToExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800C0F40
 * Callers:
...
__int64 __fastcall CDisplayDuplicateToExtendAnimatedVisual::Create(struct CDisplayDuplicateToExtendAnimatedVisual **a1)
{
  ...
  struct CDisplayDuplicateToExtendAnimatedVisual *v4; // rbx

  if ( a1 )
  {
    v3 = (CDisplayDuplicateToExtendAnimatedVisual *)DefaultHeap::AllocClear(0x1F0uLL);
    if ( v3 )
