/*
 * XREFs of ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x1800389BC
 * Callers:
 ...
 *     ??1CCachedBorderBrush@CWindowBorder@@QEAA@XZ @ 0x180039B34 (--1CCachedBorderBrush@CWindowBorder@@QEAA@XZ.c)
