/*
 * XREFs of ?OnCreateAnimationClock@CAnimationClockCoordinator@@QEAAJU_GUID@@K@Z @ 0x180058C14
 * Callers:
 ...
 *     ?SetEventCallback@CAnimationClock@@QEAAJPEAUIAnimationClockEventListener@@@Z @ 0x1800590C0 (-SetEventCallback@CAnimationClock@@QEAAJPEAUIAnimationClockEventListener@@@Z.c)
 *     ?_IsKnownClockId@CAnimationClockCoordinator@@AEAA_NU_GUID@@@Z @ 0x180059138 (-_IsKnownClockId@CAnimationClockCoordinator@@AEAA_NU_GUID@@@Z.c)
        ...
        if ( AnimationClock >= 0 )
        {
          ...
          if ( v14 )
          {
            ...
            if ( AnimationClock < 0 )
            {
              ...
              if ( (unsigned int)DynArray<CStoryboard const *,0>::Remove((__int64 *)this + 7, (__int64 *)v18) )
