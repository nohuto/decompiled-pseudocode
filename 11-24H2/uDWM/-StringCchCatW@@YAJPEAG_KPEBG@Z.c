/*
 * XREFs of ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18005AA9C
 * Callers:
 ...
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x1800B67A8 (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
 * Callees:
 *     StringCopyWorkerW @ 0x18005AB30 (StringCopyWorkerW.c)
 */
