/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x180057000
 * Callers:
...
__int64 __fastcall CDWMDXGIEnumeration::InitDXGI(CDWMDXGIEnumeration *this)
{
  ...
  if ( v3 < 0 )
  {
    v15 = 262;
LABEL_18:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801068A0, 1LL, v3, v15, 0LL);
    goto LABEL_19;
  }
  v3 = (**(__int64 (__fastcall ***)(void *, GUID *, __int64 *))ppFactory)(
         ppFactory,
...
LABEL_48:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801068A0, 1LL, v7, 0x11Du, 0LL);
      goto LABEL_19;
    }
    v7 = 0;
  ...
  {
    v4 = -2003304291;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801068A0, 1LL, -2003304291, 0x12Au, 0LL);
  }
LABEL_19:
  if ( ppFactory )
