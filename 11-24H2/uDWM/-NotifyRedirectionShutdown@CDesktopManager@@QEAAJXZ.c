/*
 * XREFs of ?NotifyRedirectionShutdown@CDesktopManager@@QEAAJXZ @ 0x1800BA7D4
 * Callers:
...
__int64 __fastcall CDesktopManager::NotifyRedirectionShutdown(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 20) = 1;
  ...
  v4 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x23Bu, 0LL);
  ...
  if ( *((_QWORD *)this + 142) )
  {
    ...
    if ( PostThreadMessageW(*((_DWORD *)this + 282), 0x12u, 0LL, 0LL) )
    {
      if ( v4 >= 0 )
      {
        ...
        if ( WaitForSingleObject(*((HANDLE *)this + 142), 0xFFFFFFFF) )
        {
          ...
          if ( v3 >= 0 )
            v3 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x24Fu, 0LL);
        }
        else
        {
          v3 = v4;
    ...
    else
    {
      ...
      if ( v3 >= 0 )
        v3 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x247u, 0LL);
    }
    *((_DWORD *)this + 282) = 0;
