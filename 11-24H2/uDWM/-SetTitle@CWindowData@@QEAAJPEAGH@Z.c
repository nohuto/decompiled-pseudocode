/*
 * XREFs of ?SetTitle@CWindowData@@QEAAJPEAGH@Z @ 0x1800553D0
 * Callers:
...
__int64 __fastcall CWindowData::SetTitle(CWindowData *this, unsigned __int16 *a2, int a3)
{
  ...
  if ( v3 == (CWindowData *)((char *)this + 868) )
  {
    if ( v5 > 26 )
    {
      ...
      *((_QWORD *)this + 2) = v3;
      ...
      {
        v9 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x64Cu, 0LL);
        return v9;
      }
    }
  }
  else
  {
    ...
    if ( v5 > 26 )
    {
      ...
      *((_QWORD *)this + 2) = v3;
      ...
      {
        v9 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x65Bu, 0LL);
        return v9;
      }
    }
    else
  ...
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x65Fu, 0LL);
  return v9;
}
