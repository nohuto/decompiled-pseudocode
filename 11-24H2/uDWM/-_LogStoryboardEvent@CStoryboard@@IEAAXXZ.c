/*
 * XREFs of ?_LogStoryboardEvent@CStoryboard@@IEAAXXZ @ 0x180043DF4
 * Callers:
  ...
  if ( this[1].m128i_i32[3] != -1 )
  {
    ...
    if ( (unsigned int)(v3 - 3) <= 1 )
    {
      ...
      if ( v4 )
      {
        ...
        if ( v3 == 3 )
        {
          wil::com_ptr_t<IDCompositionAnimationStats,wil::err_returncode_policy>::reset(this[5].m128i_i64);
