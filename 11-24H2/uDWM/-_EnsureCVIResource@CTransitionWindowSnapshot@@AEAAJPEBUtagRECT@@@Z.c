/*
 * XREFs of ?_EnsureCVIResource@CTransitionWindowSnapshot@@AEAAJPEBUtagRECT@@@Z @ 0x180002968
 * Callers:
        ...
        const struct tagRECT *a2)
{
  ...
  float v5; // xmm1_4
  unsigned int v6; // eax
  CCachedVisualImageProxy **v7; // r14
  int v8; // eax
  unsigned int v9; // ebx
  int v10; // ecx
  float v11; // xmm1_4
  ...
  *(_QWORD *)&v30.left = 0LL;
  ...
  v7 = (CCachedVisualImageProxy **)((char *)this + 248);
  if ( *((_QWORD *)this + 31) )
    goto LABEL_5;
  v21 = 0;
  if ( a2->bottom - a2->top >= 0 )
  ...
  {
LABEL_5:
    v8 = CCachedVisualImageProxy::Update(*v7, &v31, &v30, 0LL, 0LL, *(_QWORD *)(*((_QWORD *)this + 34) + 16LL), 0);
    v9 = v8;
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x112u, 0LL);
    }
    else
    {
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x121u, 0LL);
      }
      else
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x125u, 0LL);
        }
        else
        {
          ...
          if ( v19 >= 0 )
            return v9;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x129u, 0LL);
        }
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CachedVisualImageProxy, 0x108u, 0LL);
  }
