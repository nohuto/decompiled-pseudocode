/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@ULivePreviewWindow@@$0A@@@QEAAJPEFBULivePreviewWindow@@I@Z @ 0x180003158
 * Callers:
...
__int64 __fastcall DynArray<LivePreviewWindow,0>::AddMultipleAndSet(__int64 *a1, _OWORD *a2)
{
  ...
  else
  {
    ...
    {
      v6 = DynArrayImpl<0>::AddMultipleAndSet(a1, 48LL, 1LL, a2);
      v5 = v6;
      if ( v6 < 0 )
