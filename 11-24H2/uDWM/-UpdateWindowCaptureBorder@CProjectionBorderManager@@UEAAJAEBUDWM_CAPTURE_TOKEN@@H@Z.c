/*
 * XREFs of ?UpdateWindowCaptureBorder@CProjectionBorderManager@@UEAAJAEBUDWM_CAPTURE_TOKEN@@H@Z @ 0x1800CDFE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
      ...
      v18 = 0LL;
      ProxyWindowHandle = CCaptureManager::_GetProxyWindowHandle(v11, v7[2], &v18);
      v12 = ProxyWindowHandle;
      if ( ProxyWindowHandle < 0 )
      {
        v13 = 837LL;
