/*
 * XREFs of ?UpdateAnimatedResources@CTopLevelWindow3D@@AEAAJXZ @ 0x180019BA8
 * Callers:
  ...
  if ( *((_BYTE *)this + 568) )
  {
    ...
    *(_QWORD *)&v54.m11 = LODWORD(v8);
    ...
    if ( (v41 == 2 || v41 == 12) && DpiAdjustedFloatCornerRadius > 0.0 )
    {
      ...
      if ( v47 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v47, 0x436u, 0LL);
        v48 = v49;
        if ( !v49 )
          return v18;
        goto LABEL_67;
    ...
    else
    {
      ...
      if ( v42 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v42, 0x43Au, 0LL);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v44, 0x43Du, 0LL);
    if ( !v43 )
      return v18;
    v48 = v43;
LABEL_67:
...
LABEL_23:
  ...
  v18 = v17;
  if ( v17 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x451u, 0LL);
  return v18;
}
