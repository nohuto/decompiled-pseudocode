/*
 * XREFs of ??$CreateTouchVisual@VCTouchDragVisual@@@@YAJ_KPEAPEAVCTouchDragVisual@@@Z @ 0x18000DE08
 * Callers:
...
__int64 __fastcall CreateTouchVisual<CTouchDragVisual>(unsigned __int64 a1, CBaseObject **a2)
{
  ...
  v5 = (struct CBitmapSource **)CTouchDragVisual::CTouchDragVisual(v4, a1);
  v6 = (CBaseObject *)v5;
  if ( !v5 )
  {
LABEL_7:
