/*
 * XREFs of ?get_local_iids@?$implements@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800E4220
 * Callers:
 *     <none>
 * Callees:
 *     <none>
