/*
 * XREFs of ??_GTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UEAAPEAXI@Z @ 0x18004AB30
 * Callers:
 *     ??_ETopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@WBA@EAAPEAXI@Z @ 0x1800E63D0 (--_ETopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@WBA@EAAPEAXI@Z.c)
 * Callees:
