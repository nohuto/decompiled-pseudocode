/*
 * XREFs of ?ScreenDuplicationDisabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800CC458
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationDisabled(__int64 a1)
{
