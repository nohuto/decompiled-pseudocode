/*
 * XREFs of ?UpdateVisual@CTouchDragVisual@@AEAAJXZ @ 0x180010A00
 * Callers:
...
__int64 __fastcall CTouchDragVisual::UpdateVisual(CTouchDragVisual *this)
{
  ...
  _BYTE v21[32]; // [rsp+38h] [rbp-D0h] BYREF
  ...
  _BYTE v27[40]; // [rsp+E8h] [rbp-20h] BYREF
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0xD2u, 0LL);
  }
  else if ( *((_DWORD *)this + 84) > 1u )
  {
    DynArrayImpl<0>::DynArrayImpl<0>(v21, 0LL, 0LL);
    DynArrayImpl<0>::DynArrayImpl<0>(v22, v7, v8);
    DynArrayImpl<0>::DynArrayImpl<0>(v23, v9, v10);
    v24 &= v11;
    Mesh2D::Reset((Mesh2D *)v21);
    DynArrayImpl<0>::DynArrayImpl<0>(v25, 0LL, 0LL);
    DynArrayImpl<0>::DynArrayImpl<0>(v26, v12, v13);
    DynArrayImpl<0>::DynArrayImpl<0>(v27, v14, v15);
    v28 &= v16;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0xE1u, 0LL);
    }
    else
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DrawMesh2DInstruction, 0xE4u, 0LL);
