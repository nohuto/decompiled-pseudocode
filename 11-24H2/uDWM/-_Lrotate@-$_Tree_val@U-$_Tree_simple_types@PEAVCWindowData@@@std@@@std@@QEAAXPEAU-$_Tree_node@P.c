/*
 * XREFs of ?_Lrotate@?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAXPEAU?$_Tree_node@PEAVCWindowData@@PEAX@2@@Z @ 0x1800BDAF8
 * Callers:
...
_QWORD *__fastcall std::_Tree_val<std::_Tree_simple_types<CWindowData *>>::_Lrotate(__int64 a1, __int64 a2)
{
  _QWORD *v2; // r8
  _QWORD *result; // rax
