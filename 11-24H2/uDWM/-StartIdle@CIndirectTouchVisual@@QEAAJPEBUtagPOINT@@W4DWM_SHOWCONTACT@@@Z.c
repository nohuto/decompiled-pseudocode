/*
 * XREFs of ?StartIdle@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800C7410
 * Callers:
...
LABEL_17:
  ...
  if ( *(float *)(a1 + 292) == 0.0 )
  {
    ...
    if ( v9 )
      v9 = (CBaseObject *)CTimeline<float>::CTimeline<float>(v9, *v5, *(float *)(a1 + 300), 0.0, 0);
    *(_QWORD *)(a1 + 328) = v9;
    if ( !v9 )
    {
      v7 = -2147024882;
  ...
  {
    v10 = (CBaseObject *)DefaultHeap::AllocClear(0x78uLL);
    if ( v10 )
      v10 = (CBaseObject *)CTimeline<float>::CTimeline<float>(
                             v10,
                             (float)(*v5 * *(float *)(a1 + 292)),
                             *(float *)(a1 + 300),
                             *(float *)(a1 + 300),
                             0);
    *(_QWORD *)(a1 + 320) = v10;
