/*
 * XREFs of ?OnGraphicsDeviceLost@CWindowList@@QEAAXXZ @ 0x1800F1448
 * Callers:
 *     ?OnGraphicsDeviceLost@CDesktopManager@@SAXXZ @ 0x1800BA9F4 (-OnGraphicsDeviceLost@CDesktopManager@@SAXXZ.c)
 * Callees:
 *     ??$_Free_non_head@V?$allocator@U?$_List_node@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@PEAX@std@@@std@@@?$_List_node@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@PEAX@std@@@1@PEAU01@@Z @ 0x180095B8C (--$_Free_non_head@V-$allocator@U-$_List_node@V-$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std.c)
