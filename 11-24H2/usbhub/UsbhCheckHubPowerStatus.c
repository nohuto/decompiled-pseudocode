/*
 * XREFs of UsbhCheckHubPowerStatus @ 0x1400495EC
 * Callers:
...
LABEL_6:
  ...
  if ( Usb_Disconnected(v5) )
  {
    ...
    UsbhException(a1, 0LL, 112LL, v8, 0, v4, 0, usbfile_fdopwr_c, 3876, 0);
  }
  else if ( (v4 & 0xC0000000) == 0xC0000000 )
  {
    Log(a1, 16, 1347899937, 0LL, v4);
    UsbhException(a1, 0LL, (unsigned int)((_DWORD)v9 + 110), v9, 0, v4, 0, usbfile_fdopwr_c, 3896, 0);
  }
  else if ( (int)v4 < 0 || (v14 & 1) != 0 )
  {
    ...
    if ( (v4 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v4) )
      UsbhException(a1, 0LL, (unsigned int)((_DWORD)v11 + 109), v11, 0, v4, 0, usbfile_fdopwr_c, 3930, 0);
  }
  else
  {
    LODWORD(v4) = -1073741823;
    Log(a1, 16, 1699764050, 0LL, -1073741823LL);
    UsbhException(a1, 0LL, (unsigned int)((_DWORD)v10 + 111), v10, 0, -1073741823, 0, usbfile_fdopwr_c, 3912, 0);
  }
LABEL_19:
