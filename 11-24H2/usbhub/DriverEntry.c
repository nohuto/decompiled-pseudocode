/*
 * XREFs of DriverEntry @ 0x14004E588
 * Callers:
 *     GsDriverEntry @ 0x140078010 (GsDriverEntry.c)
 * Callees:
 *     USBHUB_InitBugCheck @ 0x14004E874 (USBHUB_InitBugCheck.c)
 *     UsbhInitGlobal @ 0x140050618 (UsbhInitGlobal.c)
 *     UsbhModuleDispatch @ 0x14005084C (UsbhModuleDispatch.c)
 *     UsbhInitializeHighResTimer @ 0x14005FAF8 (UsbhInitializeHighResTimer.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( (unsigned int)dword_14006F5C8 > 1 )
  {
    do
    {
      if ( v2 > 0x10 )
