/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x14007793C
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x140077920 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x14005169C (wil_details_FeatureDescriptors_SkipPadding.c)
 *     __security_check_cookie @ 0x140060F40 (__security_check_cookie.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x140077690 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
