/*
 * XREFs of UsbhGetBillboardInfo @ 0x1400465D8
 * Callers:
...
__int64 __fastcall UsbhGetBillboardInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_DWORD)v11 != -1073741824 )
  {
    ...
    {
      UsbhException(a1, *((unsigned __int16 *)v6 + 714), 38LL, Pool2, v13, v9, v19, usbfile_bus_c, 7758, 0);
      v12 = 4678195;
      goto LABEL_16;
    }
LABEL_8:
    for ( i = 0; i < *(_BYTE *)(a3 + 4); ++i )
    {
      if ( *(_BYTE *)(a3 + 4LL * i + 47) )
      {
        ...
        {
          UsbhException(a1, *((unsigned __int16 *)v20 + 714), 141LL, Pool2, v21, v15, v19, usbfile_bus_c, 7783, 0);
          v12 = 4678196;
          goto LABEL_16;
        }
        v16 = v21;
        ...
        {
          UsbhException(a1, *((unsigned __int16 *)v20 + 714), 38LL, Pool2, v16, v9, v19, usbfile_bus_c, 7795, 0);
          v12 = 4678197;
          goto LABEL_16;
        }
      }
  ...
  UsbhException(a1, *((unsigned __int16 *)v6 + 714), 140LL, Pool2, v21, StringFromDevice, v19, usbfile_bus_c, 7746, 0);
  v12 = 4678194;
LABEL_16:
  Log(a1, 4, v12, 0LL, v9);
LABEL_17:
