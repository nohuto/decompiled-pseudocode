/*
 * XREFs of Usbh_BS_BusPause @ 0x140020324
 * Callers:
...
__int64 __fastcall Usbh_BS_BusPause(struct _DEVICE_OBJECT *a1, __int64 a2, int a3)
{
  __int64 v3; // rbx
    ...
    if ( v17 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( v22 )
        {
          ...
          {
            v23 = v6;
            return (unsigned int)UsbhReleaseBusStateLock(a1, v21, v23);
          }
