/*
 * XREFs of Usbh_HubInitialize20Hub @ 0x14003D884
 * Callers:
...
__int64 __fastcall Usbh_HubInitialize20Hub(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (v6[642] & 2) != 0 )
  {
    v10 = (void (__fastcall *)(_QWORD, __int64))v8[565];
    if ( v10 )
      v10(v8[529], a2);
  }
  v11 = (__int64 (__fastcall *)(_QWORD, __int64, _QWORD))v8[544];
  if ( v11 )
    return v11(v8[529], a2, a3);
  else
    return 3221225474LL;
}
