/*
 * XREFs of UsbhCreateDevice @ 0x140017858
 * Callers:
...
LABEL_9:
    if ( *((_QWORD *)v9 + 532) )
    {
      ...
      if ( (v13 & 0xC0000000) == 0xC0000000 )
      {
        ...
        UsbhException(a1, (unsigned __int16)v7, 4LL, v29, 0x54u, v13, -1, usbfile_bus_c, 6536, 0);
  ...
  if ( (v9[640] & 0x40) == 0 )
  {
    ...
    {
      UsbhException(a1, (unsigned __int16)v7, 104LL, 0LL, 0, TtDeviceHandle, -1, usbfile_bus_c, 6435, 0);
  ...
  if ( DeviceHandle )
    goto LABEL_9;
  v13 = -1073741823;
  UsbhException(a1, (unsigned __int16)v7, 5LL, 0LL, 0, -1073741823, -1, usbfile_bus_c, 6416, 0);
  return (unsigned int)v13;
}
