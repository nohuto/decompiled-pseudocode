/*
 * XREFs of UsbhPdoDevicePowerState @ 0x140014968
 * Callers:
...
LABEL_21:
    ...
    *((_QWORD *)v6 + 319) = MEMORY[0xFFFFF78000000014];
    ...
    if ( v57 )
    {
      ...
      v58 = GET_FDO_POWER_STATE(v7) - 201;
