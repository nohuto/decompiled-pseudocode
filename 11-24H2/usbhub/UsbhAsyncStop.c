/*
 * XREFs of UsbhAsyncStop @ 0x14004F168
 * Callers:
...
void __fastcall UsbhAsyncStop(__int64 a1, int a2)
{
  ...
  v9 = UsbhWaitEventWithTimeoutEx(*(_QWORD *)(a1 + 8), v4 + 644, 5000, 1667394391, (unsigned int)v8 & Timeout, v8 & v15);
  ...
  if ( v10 == 258 )
  {
    ...
    if ( a2 == 5 )
    {
      ...
      Usbh_SSH_Event(*(_QWORD *)(a1 + 8), 6LL, a1, v13);
