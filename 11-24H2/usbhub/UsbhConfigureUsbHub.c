/*
 * XREFs of UsbhConfigureUsbHub @ 0x14003A328
 * Callers:
...
__int64 __fastcall UsbhConfigureUsbHub(__int64 a1)
{
  ...
  {
    UsbhException(a1, 0LL, 34LL, v6, v6[1], -1073741823, v22, usbfile_hub_c, 4345, 0);
...
LABEL_38:
    if ( !v11 )
    {
      UsbhException(a1, 0LL, 18LL, v6, v6[1], -1073741823, 0, usbfile_hub_c, 4478, 0);
