/*
 * XREFs of UsbhPdoPnp_StartDevice @ 0x14001D150
 * Callers:
...
LABEL_19:
  ...
  *(_DWORD *)((char *)v14 + v15 + 536) = 101;
  ...
  if ( DeviceProperty < 0 )
  {
    UsbhException(*v8, *((unsigned __int16 *)v4 + 714), 103LL, 0LL, 0, DeviceProperty, 0, usbfile_pdo_c, 1564, 0);
  }
  else if ( (v4[355] & 1) != 0 )
  {
    UsbhException(*v8, *((unsigned __int16 *)v4 + 714), 42LL, 0LL, 0, DeviceProperty, 0, usbfile_pdo_c, 1548, 0);
  }
LABEL_36:
