/*
 * XREFs of UsbhWaitEventWithTimeoutEx @ 0x140010ED0
 * Callers:
...
__int64 __fastcall UsbhWaitEventWithTimeoutEx(__int64 a1, void *a2, int a3, int a4, unsigned int a5, __int64 a6)
{
  ...
  __int64 v32; // rdx
  BOOLEAN v34; // r9
  union _LARGE_INTEGER v35; // [rsp+40h] [rbp-40h] BYREF
  union _LARGE_INTEGER v36; // [rsp+48h] [rbp-38h] BYREF
  _QWORD *v37; // [rsp+50h] [rbp-30h]
  __int64 v38; // [rsp+58h] [rbp-28h]
  PVOID v39; // [rsp+60h] [rbp-20h] BYREF
  __int64 v40; // [rsp+68h] [rbp-18h]
  PVOID Object; // [rsp+70h] [rbp-10h] BYREF
  __int64 v42; // [rsp+78h] [rbp-8h]
  int v44; // [rsp+D0h] [rbp+50h]
  ...
  if ( a6 )
  {
    v37 = (_QWORD *)UsbhIncHubBusy(a1, a6 + 24, a6, 1465152371, 0);
    v40 = a6 + 496;
    v39 = a2;
    while ( 1 )
    {
      v21 = KeWaitForMultipleObjects(2u, &v39, WaitAny, Executive, 0, 0, &v35, 0LL);
      v19 = v21;
      if ( !v21 )
        break;
      if ( v21 == 1 )
      {
        ...
        v40 = a6 + 2464;
        v23 = KeWaitForMultipleObjects(2u, &v39, WaitAny, Executive, 0, 0, &v35, 0LL);
        v19 = v23;
        switch ( v23 )
        {
          case 0:
