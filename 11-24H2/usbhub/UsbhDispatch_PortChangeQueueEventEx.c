/*
 * XREFs of UsbhDispatch_PortChangeQueueEventEx @ 0x140008E90
 * Callers:
 *     UsbhDispatch_PortChangeQueueNullEventEx @ 0x140007230 (UsbhDispatch_PortChangeQueueNullEventEx.c)
...
_QWORD *__fastcall UsbhDispatch_PortChangeQueueEventEx(
        __int64 a1,
        __int64 a2,
        int a3,
        __int64 a4,
    ...
    default:
      switch ( (int)v9 )
      {
        ...
        case 18:
          ...
          break;
        case 19:
          Usbh_PCE_psPAUSED_Action(a1, a2, a4, a4);
          break;
        case 20:
