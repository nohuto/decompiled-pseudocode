/*
 * XREFs of UsbhQueueDriverOvercurrent @ 0x14003F320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhQueueDriverOvercurrent(__int64 a1, __int64 a2)
{
  ...
  PortData = UsbhGetPortData(a1, *(unsigned __int16 *)(a2 + 20), v5, v6);
  v9 = PortData;
  if ( !PortData )
    return Usbh_OvercurrentDerefHubBusy(a1, 0LL, 0LL);
  v10 = PortData + 200;
  UsbhPCE_Disable(a1, *(unsigned __int16 *)(a2 + 20), PortData + 200, v8);
  ...
  {
    Usbh_OvercurrentDerefHubBusy(a1, v9, 0LL);
    v12 = FdoExt(a1);
