/*
 * XREFs of UsbhIoctlGetPortConnectorProperties @ 0x14004D424
 * Callers:
...
__int64 __fastcall UsbhIoctlGetPortConnectorProperties(__int64 a1, IRP *a2, __int64 a3)
{
    ...
    if ( (v10 & 0xC0000000) != 0xC0000000 )
    {
      ...
      *(_DWORD *)(&MasterIrp->Size + 1) = 18;
      if ( UsbhGetPortData(a1, (unsigned __int16)Type, v12, v13) )
      {
        ...
        if ( (*(_DWORD *)(v16 + 2560) & 1) != 0 )
        {
          v18 = *(__int64 (__fastcall **)(_QWORD))(v15 + 304);
          if ( v18 )
            v17 = v18(*(_QWORD *)(v15 + 8));
          else
            v17 = 0;
        }
        else
  ...
  if ( (v10 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v10) )
    UsbhException(a1, 0LL, 91LL, &v22, 4u, v10, 0, usbfile_ioctl_c, 913, 0);
  if ( v21 )
