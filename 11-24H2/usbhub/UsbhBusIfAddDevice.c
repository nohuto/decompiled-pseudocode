/*
 * XREFs of UsbhBusIfAddDevice @ 0x1400567D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhBusIfAddDevice(PDEVICE_OBJECT DeviceObject)
{
  ...
  while ( 1 )
  {
    ...
    UsbhException((__int64)DeviceObject, 0LL, 26LL, 0LL, 0, BusInterface, 0, usbfile_busif_c, 243, 0);
    if ( v5 == 9 )
    {
      v4 = 312;
      v5 = 8;
  ...
  while ( 1 )
  {
    ...
    UsbhException((__int64)DeviceObject, 0LL, 27LL, 0LL, 0, v11, 0, usbfile_busif_c, 281, 0);
    if ( v9 == 3 )
    {
      v8 = 80;
      v9 = 2;
