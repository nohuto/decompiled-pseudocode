/*
 * XREFs of UsbhPdoPnp_QueryCapabilities @ 0x1400338C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryCapabilities(__int64 a1, IRP *a2)
{
  ...
  HIDWORD(SecurityContext->SecurityQos) = (v9 & 0xFFFFFFBF ^ (v3[355] >> 3) & 0x40) & 0xFFFFFDFF;
  ...
  *(_SECURITY_QUALITY_OF_SERVICE **)((char *)&SecurityContext[2].SecurityQos + 4) = 0LL;
  ...
  if ( (v13 & 0x100) != 0 )
  {
    ...
    do
    {
      v20 = v19++ > (signed int)SecurityContext[1].FullCreateOptions;
      LODWORD(v12->SecurityQos) = v20 + 3;
