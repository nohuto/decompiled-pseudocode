/*
 * XREFs of UsbhQueryHubState @ 0x140047294
 * Callers:
    ...
    *((_BYTE *)P + 8) = 0;
    ...
    if ( v11 < 0 || *((_WORD *)P + 2) == 4 )
    {
      if ( (v11 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v11) )
      {
        ...
        UsbhException(a1, 0LL, 8LL, &P, 0xAu, v11, v10, usbfile_bus_c, 1758, 0);
        v12 = (unsigned __int16 *)P;
      }
      if ( v11 >= 0 )
      {
    ...
    else
    {
      ...
      UsbhException(a1, 0LL, 9LL, &P, 0xAu, v11, v10, usbfile_bus_c, 1745, 0);
      if ( a3 )
        *a3 = v10;
      if ( P )
