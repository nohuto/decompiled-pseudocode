/*
 * XREFs of UsbhPdoPowerWorkerInternal @ 0x140033EE4
 * Callers:
 *     UsbhPdoPower @ 0x140033E60 (UsbhPdoPower.c)
 *     UsbhPdoPowerWorker @ 0x14004AE30 (UsbhPdoPowerWorker.c)
 * Callees:
...
LABEL_12:
  ...
  *((_BYTE *)v6 + v9 + 928) = QuadPart;
  ...
  return (unsigned int)funcs_140033F77[2 * v10](BugCheckParameter3, (ULONG_PTR)BugCheckParameter4);
}
