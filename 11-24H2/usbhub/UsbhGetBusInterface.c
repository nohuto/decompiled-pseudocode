/*
 * XREFs of UsbhGetBusInterface @ 0x140057024
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  PIRP Irp; // rax
  IRP *v12; // rsi
  $0D2D7D2AE6BFD640AE0BDAACBE538F0B *v13; // rdi
  ...
  if ( IoSetCompletionRoutineEx(DeviceObject, v12, (PIO_COMPLETION_ROUTINE)UsbhDeferIrpCompletion, &Event, 1u, 1u, 1u) < 0 )
  {
  ...
  *(_WORD *)&v15[-1].MajorFunction = 2075;
  ...
  if ( Status >= 0 )
  {
    ...
    {
      Status = -1073741811;
      UsbhException((__int64)DeviceObject, 0LL, 25LL, Pool2, 0x20u, -1073741811, 0, usbfile_busif_c, 162, 0);
  ...
  IoFreeIrp(v12);
  ExFreePoolWithTag(Pool2, 0);
  Log((__int64)DeviceObject, 8, 1197634409, 0LL, Status);
