...
void __fastcall UsbhCheckHubErrata(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v6 & 0x80u) != 0LL )
  {
    UsbhException(*v5, 0LL, 133LL, v3, 0x12u, 0, 6, usbfile_dq_c, 2730, 0);
    UsbhApplyHubFix((_DWORD *)a1, 6);
  }
  if ( (v6 & 0x100) != 0 )
  {
    UsbhException(*v5, 0LL, 133LL, v3, 0x12u, 0, 8, usbfile_dq_c, 2738, 0);
    UsbhApplyHubFix((_DWORD *)a1, 8);
  }
  if ( (v6 & 0x200) != 0 )
  {
    UsbhException(*v5, 0LL, 133LL, v3, 0x12u, 0, 9, usbfile_dq_c, 2747, 0);
    UsbhApplyHubFix((_DWORD *)a1, 9);
  }
  if ( (v6 & 0x400000000LL) != 0 )
  {
    UsbhException(*v5, 0LL, 133LL, v3, 0x12u, 0, 13, usbfile_dq_c, 2755, 0);
