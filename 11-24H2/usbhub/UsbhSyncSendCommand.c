/*
 * XREFs of UsbhSyncSendCommand @ 0x14000A470
 * Callers:
...
__int64 __fastcall UsbhSyncSendCommand(__int64 a1, unsigned __int8 *a2, __int64 a3, _WORD *a4, __int64 a5, _DWORD *a6)
{
  ...
  struct _IO_STATUS_BLOCK v37; // [rsp+88h] [rbp-51h] BYREF
  PDEVICE_OBJECT v38; // [rsp+98h] [rbp-41h]
  __int64 v39; // [rsp+A0h] [rbp-39h]
  ...
  else
  {
    ...
    if ( Pool2 )
    {
      ...
      v24 = IoBuildDeviceIoControlRequest(0x220003u, *(PDEVICE_OBJECT *)(v9 + 1208), 0LL, 0, 0LL, 0, 1u, &Object, &v37);
      if ( (UsbhLogMask & 8) != 0 )
      {
        if ( a1 )
        {
