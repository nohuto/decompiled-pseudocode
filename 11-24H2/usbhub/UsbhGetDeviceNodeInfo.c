/*
 * XREFs of UsbhGetDeviceNodeInfo @ 0x1400547A8
 * Callers:
...
__int64 __fastcall UsbhGetDeviceNodeInfo(__int64 a1, _DWORD *a2, unsigned int a3, unsigned int *a4, __int64 a5)
{
  ...
  DeviceInformation = UsbhGetDeviceInformationEx(v10, &v24, a5);
  ...
  if ( v24 >= 0 )
  {
    ...
    *(_WORD *)((char *)a2 + 153) = *((_WORD *)v13 + 17);
    PortData = UsbhGetPortData(v10, *((unsigned __int16 *)v9 + 714), v15, v16);
    if ( PortData )
    {
    ...
    *(_DWORD *)((char *)a2 + 1187) = v13[12];
    if ( v13[12] )
    {
      do
      {
        v18 = v8++;
        v19 = 11 * (v18 + 97);
        *(_DWORD *)((char *)a2 + v19 + 124) = v13[3 * v18 + 13];
        *(_WORD *)((char *)a2 + v19 + 128) = v13[3 * v18 + 14];
        *((_BYTE *)a2 + v19 + 130) = BYTE2(v13[3 * v18 + 14]);
        *(_DWORD *)((char *)a2 + 11 * v18 + 1198) = v13[3 * v18 + 15];
      }
      while ( v8 < v13[12] );
    }
    ...
    if ( v20 > 0x100 )
      v20 = 256;
    memmove((char *)a2 + 163, *((const void **)v9 + 263), v20);
    v21 = v9[529];
    if ( v21 > 0x100 )
      v21 = 256;
    memmove((char *)a2 + 419, *((const void **)v9 + 265), v21);
    v22 = v9[533];
    if ( v22 > 0x100 )
      v22 = 256;
    memmove((char *)a2 + 675, *((const void **)v9 + 267), v22);
    v23 = v9[553];
    if ( v23 > 0x100 )
      v23 = 256;
    memmove((char *)a2 + 931, *((const void **)v9 + 277), v23);
    result = 0LL;
    *a4 = v14;
  }
  else
