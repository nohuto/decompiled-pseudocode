/*
 * XREFs of UsbhPCE_Resume @ 0x140020DB0
 * Callers:
...
__int64 __fastcall UsbhPCE_Resume(__int64 a1, int a2, unsigned __int16 a3)
{
  __int64 v3; // rdi
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  if ( (_WORD)v3 )
  {
    ...
    if ( (unsigned __int16)v3 <= *(unsigned __int8 *)(result + 2938) )
    {
      ...
      if ( v12 )
      {
        ...
        if ( v13 )
          return UsbhDispatch_PortChangeQueueNullEvent(a1, v13, 3, a2);
      }
    }
  }
  return result;
