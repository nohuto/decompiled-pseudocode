/*
 * XREFs of UsbhHubSyncSuspendPortEvent @ 0x140042C7C
 * Callers:
...
__int64 __fastcall UsbhHubSyncSuspendPortEvent(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v8 = *(_DWORD *)(a3 + 400);
  if ( (UsbhQueryPortState(a1, *(unsigned __int16 *)(a3 + 4), (__int64)&v16, &v18) & 0xC0000000) != 0xC0000000
    && (v16 & 1) != 0 )
  {
    ...
    v15 = v16;
    *(_WORD *)(a3 + 420) = v16;
    Usbh_PcLogEntry(a1, a3, v9, 0x10000000LL, 0, v15, v4, 0);
    if ( v9 )
