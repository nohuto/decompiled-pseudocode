/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x14004DF0C
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x14004DE88 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x14004DD08 (wil_details_FeatureReporting_RecordUsageInCache.c)
