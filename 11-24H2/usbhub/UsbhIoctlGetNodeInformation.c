/*
 * XREFs of UsbhIoctlGetNodeInformation @ 0x140021A20
 * Callers:
...
__int64 __fastcall UsbhIoctlGetNodeInformation(__int64 a1, IRP *a2, __int64 a3)
{
  ...
  if ( v37 )
  {
    ...
    *(_DWORD *)((char *)v18 + v20 + 40) = -267583482;
    ...
    {
      if ( (_DWORD)v21 == 6 )
        Log(a1, 32, 1095774563, 0, 4027383814LL);
      v22 = -1073741810;
    }
    if ( (UsbhLogMask & 0x20) != 0 )
    {
    ...
    {
      v22 = UsbhIoctlValidateParameters(a1, 258, (__int64)a2, a3, 0, 0x4Cu);
      if ( (v22 & 0xC0000000) != 0xC0000000 )
      {
...
LABEL_29:
  ...
  if ( !Usb_Disconnected(v22) )
    UsbhException(a1, 0LL, 91LL, &v39, 4u, v22, 0, usbfile_ioctl_c, 2833, 0);
  if ( v6 )
    goto LABEL_29;
LABEL_34:
  if ( (UsbhLogMask & 0x20) != 0 )
