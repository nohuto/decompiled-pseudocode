 ...
 *     UsbhWmiDriverEntry @ 0x140055630 (UsbhWmiDriverEntry.c)
 *     UsbhGetBusInterface @ 0x140057024 (UsbhGetBusInterface.c)
 *     UsbhCopyPnpString @ 0x14005E984 (UsbhCopyPnpString.c)
 *     UsbhGetUxdLoadKeySettings @ 0x14005EEC0 (UsbhGetUxdLoadKeySettings.c)
 *     UsbhQueryUxdDevice @ 0x14005F4E0 (UsbhQueryUxdDevice.c)
 *     MyRegQueryString @ 0x140060B30 (MyRegQueryString.c)
 *     WppTraceCallback @ 0x1400773B0 (WppTraceCallback.c)
 *     KsPropertyHandleDrmSetContentId @ 0x140077B00 (KsPropertyHandleDrmSetContentId.c)
 * Callees:
 *     <none>
 */
