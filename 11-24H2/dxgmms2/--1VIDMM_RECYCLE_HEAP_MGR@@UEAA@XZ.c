/*
 * XREFs of ??1VIDMM_RECYCLE_HEAP_MGR@@UEAA@XZ @ 0x1400FD8B8
 * Callers:
 ...
 *     ??1VIDMM_RECYCLE_HEAP@@QEAA@XZ @ 0x1400F6B20 (--1VIDMM_RECYCLE_HEAP@@QEAA@XZ.c)
 */
...
void __fastcall VIDMM_RECYCLE_HEAP_MGR::~VIDMM_RECYCLE_HEAP_MGR(VIDMM_RECYCLE_HEAP_MGR *this)
{
  ...
  *(_QWORD *)this = &VIDMM_RECYCLE_HEAP_MGR::`vftable';
  ...
  while ( 1 )
  {
    ...
    if ( (_QWORD *)*v10 == v10 )
      break;
    v11 = (VIDMM_RECYCLE_RANGE *)(v12 - 13);
    VIDMM_RECYCLE_HEAP_MGR::RemoveFromDebounce(v7, (struct VIDMM_RECYCLE_RANGE *)(v12 - 13));
    v20 = 0;
    VIDMM_RECYCLE_RANGE::DebouncedDecommit(v11, (enum VIDMM_RECYCLE_BLOCK_SHRINK_RESULT *)&v20);
    if ( !v20 )
    {
      v7 = (VIDMM_RECYCLE_HEAP_MGR *)*((_QWORD *)v11 + 17);
      if ( v7 )
        VIDMM_RECYCLE_MULTIRANGE::MergeSubrangesWherePossible(v7);
    }
  }
