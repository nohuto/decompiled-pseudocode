/*
 * XREFs of McTemplateK0xxdtxi_EtwWriteTransfer @ 0x14004F640
 * Callers:
...
NTSTATUS McTemplateK0xxdtxi_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventVidSchiUpdateFlipManagerStats, a3, 7u, &v4);
}
