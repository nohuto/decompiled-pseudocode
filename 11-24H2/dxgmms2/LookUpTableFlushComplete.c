/*
 * XREFs of LookUpTableFlushComplete @ 0x14010476C
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x14010C520 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
 ...
 *     UpdateInternalStatsOnFlush @ 0x1400A83F0 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 288) )
    {
      if ( (unsigned int)dword_140081080 > 5 && tlgKeywordOn((__int64)&dword_140081080, 0x200000000000LL) )
      {
        v11 = 4;
        v37 = 42;
        v34 = L"SummaryCount";
