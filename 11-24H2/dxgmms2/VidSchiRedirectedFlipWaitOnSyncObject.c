/*
 * XREFs of VidSchiRedirectedFlipWaitOnSyncObject @ 0x14001EFE0
 * Callers:
...
LABEL_17:
    ...
    VidSchiSubmitPresentHistoryToken((unsigned int)&v31, 0, (_DWORD)Src, 0, (__int64)a1);
    goto LABEL_23;
  }
  if ( *(_QWORD *)*v14 >= v12 )
    goto LABEL_17;
LABEL_11:
  if ( *(_DWORD *)(a3 + 36) == 0x7FFFFFFF )
  {
    ...
    WdLogGlobalForLineNumber = 13762;
    v27(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
  ...
  if ( !v15 )
  {
    ...
    v26(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Failed to allocate VIDSCH_SYNCOBJ_PHT_DATA", 13774LL, 0LL, 0LL, 0LL, 0LL);
    v24 = -1073741801;
    goto LABEL_24;
  }
  v15[1] = a3;
