/*
 * XREFs of McTemplateK0pqqtttt_EtwWriteTransfer @ 0x140049930
 * Callers:
...
NTSTATUS McTemplateK0pqqtttt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventChangePriority, a3, 8u, &v4);
}
