/*
 * XREFs of ?MarkResourcesForEviction@VIDMM_SEGMENT@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400CDD2C
 * Callers:
...
LABEL_38:
  ...
  *(_QWORD *)(v28 + 120) -= v21;
  ...
  if ( ((_DWORD)this[13] & 0x1001) != 0 )
  {
    ...
    if ( (!v30 || _InterlockedExchangeAdd((volatile signed __int32 *)(v30 + 44), 0xFFFFFFFF) == 1)
      && (unsigned __int64)_InterlockedExchangeAdd64(
                             (volatile signed __int64 *)(**((_QWORD **)a2 + 44) + 56LL),
  ...
  v31 = (struct VIDMM_GLOBAL_ALLOC *)((char *)a2 + 264);
  v32 = (struct VIDMM_GLOBAL_ALLOC **)*((_QWORD *)a2 + 33);
  if ( v32[1] != (struct VIDMM_GLOBAL_ALLOC *)((char *)a2 + 264) )
    goto LABEL_35;
  v33 = (VIDMM_SEGMENT **)*((_QWORD *)a2 + 34);
  if ( *v33 != v31 )
    goto LABEL_35;
