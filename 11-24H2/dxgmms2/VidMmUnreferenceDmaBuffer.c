/*
 * XREFs of VidMmUnreferenceDmaBuffer @ 0x140039780
 * Callers:
 ...
 * Callees:
 *     RemoveDMAReferences @ 0x14003988C (RemoveDMAReferences.c)
 *     VidSchUnreferenceDmaBuffer @ 0x1400909F0 (VidSchUnreferenceDmaBuffer.c)
 */
...
__int64 __fastcall VidMmUnreferenceDmaBuffer(__int64 a1, char a2)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    *(_QWORD *)(result + 24) = a1;
    WdLogGlobalForLineNumber = 30364;
  }
  ...
  if ( v6 )
  {
    result = *(unsigned int *)(v6 + 172);
    if ( (int)result >= 1 )
    {
      _InterlockedDecrement((volatile signed __int32 *)(v6 + 172));
    }
    else
    {
      v7 = *(int *)(v6 + 172);
