/*
 * XREFs of ?InitializeAdapterPowerManagement@VIDMM_GLOBAL@@QEAAXPEBU_DXGMMS_INIT_POWER_MANAGEMENT@@@Z @ 0x140094E04
 * Callers:
 *     VidMmInitializeAdapterPowerManagement @ 0x14004BD60 (VidMmInitializeAdapterPowerManagement.c)
 * Callees:
 *     <none>
 */
