/*
 * XREFs of ?OfferAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_OFFER_FLAGS@@@Z @ 0x1400FCBD4
 * Callers:
 *     VidMmOfferAllocation @ 0x14003C250 (VidMmOfferAllocation.c)
 * Callees:
