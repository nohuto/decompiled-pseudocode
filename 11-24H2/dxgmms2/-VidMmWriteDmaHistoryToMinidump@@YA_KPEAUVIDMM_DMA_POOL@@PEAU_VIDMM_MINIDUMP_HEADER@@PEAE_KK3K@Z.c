/*
 * XREFs of ?VidMmWriteDmaHistoryToMinidump@@YA_KPEAUVIDMM_DMA_POOL@@PEAU_VIDMM_MINIDUMP_HEADER@@PEAE_KK3K@Z @ 0x140110E70
 * Callers:
 ...
 *     CheckIfDmaInformationPresent @ 0x14009745C (CheckIfDmaInformationPresent.c)
 *     SearchDmaBufferInAllPool @ 0x140097524 (SearchDmaBufferInAllPool.c)
