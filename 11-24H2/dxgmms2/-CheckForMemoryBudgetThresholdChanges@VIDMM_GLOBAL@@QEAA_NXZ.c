/*
 * XREFs of ?CheckForMemoryBudgetThresholdChanges@VIDMM_GLOBAL@@QEAA_NXZ @ 0x1400DE9A0
 * Callers:
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 1736); i = (unsigned int)(i + 1) )
  {
    ...
    if ( (*(_BYTE *)(v4 + 552) & 1) != 0 )
    {
      ...
      while ( j )
      {
        ...
        v8 = *(_QWORD *)(v7 + 16);
        if ( v8 )
          v9 = (__int64)(100 - 100LL * *(_QWORD *)(v7 + 120) / v8) < (unsigned int)dword_140081560;
        else
          v9 = 0;
        if ( v9 != *(_BYTE *)(v7 + 136) )
        {
    ...
    else
    {
      v12 = *(_QWORD *)(v4 + 600);
      if ( v12 )
        v13 = (__int64)(100 - 100LL * *(_QWORD *)(v4 + 704) / v12) < (unsigned int)dword_140081560;
      else
        v13 = 0;
      if ( v13 != *(_BYTE *)(v4 + 720) )
      {
    ...
    if ( (*(_BYTE *)(v14 + 576) & 1) != 0 )
    {
      ...
      while ( k )
      {
        ...
        v21 = *(_QWORD *)(v20 + 16);
        if ( v21 )
          v22 = (__int64)(100 - 100LL * *(_QWORD *)(v20 + 120) / v21) < (unsigned int)dword_140081560;
        else
          v22 = 0;
    ...
    else
    {
      v15 = *(_QWORD *)(v14 + 944);
      if ( v15 )
        v16 = (__int64)(100 - 100LL * *(_QWORD *)(v14 + 1048) / v15) < (unsigned int)dword_140081560;
      else
        v16 = 0;
