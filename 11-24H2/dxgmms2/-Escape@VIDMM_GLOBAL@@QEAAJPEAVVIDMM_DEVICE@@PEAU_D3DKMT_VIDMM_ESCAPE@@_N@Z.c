/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@_N@Z @ 0x140093560
 * Callers:
 *     VidMmEscape @ 0x14004BC60 (VidMmEscape.c)
 * Callees:
...
LABEL_32:
      ...
      switch ( a3->Type )
      {
        case D3DKMT_VIDMMESCAPETYPE_GET_VAD_INFO:
          ...
          if ( Command == D3DKMT_VAD_ESCAPE_GET_SEGMENT_CAPS )
          {
            ...
            if ( (unsigned int)Value >= *((_DWORD *)this + 1736) )
            {
              ...
              WdLogGlobalForLineNumber = 18194;
              goto LABEL_69;
            }
            v41 = 0LL;
          ...
          else
          {
            ...
            if ( a3->SetFault.Value >= *((_DWORD *)this + 1736) )
            {
              a3->GetVads.Status = -1073741811;
              WdLogSingleEntry0(3LL);
              WdLogGlobalForLineNumber = 18221;
              goto LABEL_69;
            }
        ...
        default:
          WdLogSingleEntry0(3LL);
          WdLogGlobalForLineNumber = 18298;
LABEL_69:
    ...
    if ( v21 )
    {
      ...
      v23 = qword_140081678 / 10000000;
      qword_140081678 = 10000000 * a3->EvictByNtHandle.NtHandle;
  ...
  if ( Type == D3DKMT_VIDMMESCAPETYPE_SET_TRIM_INTERVALS )
  {
    ...
    v18 = dword_140081538;
    v19 = dword_140081530;
    dword_14008153C = a3->Wake.bFlush;
    dword_140081538 = a3->Evict.AllocationHandle;
    dword_140081530 = a3->SuspendProcess.bAllowWakeOnSubmission;
  ...
  if ( Type == D3DKMT_VIDMMESCAPETYPE_SETFAULT )
  {
    ...
    WdLogGlobalForLineNumber = 18052;
