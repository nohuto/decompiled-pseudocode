/*
 * XREFs of VidSchQueryProcessNodeStatistics @ 0x1400EF460
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  *(_DWORD *)(a5 + 8) = v17;
  do
  {
    *v16 = *(_DWORD *)((char *)v16 + (_QWORD)v18);
    ++v16;
    --v14;
  }
  while ( v14 );
  ...
  do
  {
    *v19 = *(_DWORD *)&v18[(_QWORD)v19];
    v19[1] = *(_DWORD *)((char *)v19 + (_QWORD)v18 + 4);
    v19 += 2;
    --v20;
  }
  while ( v20 );
  ...
  do
  {
    *v21 = *(_DWORD *)((char *)v21 + (_QWORD)v18 + 8);
    v21[1] = *(_DWORD *)((char *)v21 + (_QWORD)v18 + 12);
    v21[3] = *(_DWORD *)((char *)v21 + (_QWORD)v18 + 20);
    v21[2] = *(_DWORD *)((char *)v21 + (_QWORD)v18 + 16);
    v21 += 4;
    --v15;
  }
  while ( v15 );
