/*
 * XREFs of ?InitPhysicalHeap@VIDMM_GLOBAL@@CAXXZ @ 0x140094C64
 * Callers:
...
void VIDMM_GLOBAL::InitPhysicalHeap(void)
{
  ...
  VIDMM_GLOBAL::m_PhysicalBlockSize = qword_140081660;
  VIDMM_GLOBAL::m_PhysicalBlockLowestAddress.QuadPart = qword_140081668;
  VIDMM_GLOBAL::m_PhysicalBlockHighestAddress.QuadPart = qword_140081670;
    ...
    if ( VIDMM_GLOBAL::m_PhysicalBlock )
    {
      ...
      if ( v2 )
      {
        ...
        if ( v3 )
        {
          ...
          WdLogGlobalForLineNumber = 29952;
          goto LABEL_11;
        }
      }
      else
