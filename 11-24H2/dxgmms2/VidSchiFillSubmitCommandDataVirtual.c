/*
 * XREFs of VidSchiFillSubmitCommandDataVirtual @ 0x140018280
 * Callers:
...
__int64 __fastcall VidSchiFillSubmitCommandDataVirtual(__int64 a1, __int64 a2)
{
  ...
  else
  {
    *(_QWORD *)a2 = *(_QWORD *)(v2 + 64);
    if ( (*(_DWORD *)(a1 + 92) & 0x10) != 0 )
    {
      v10 |= 0x30u;
      *(_DWORD *)(a2 + 52) = v10;
      *(_DWORD *)(a2 + 48) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 876LL);
      *(_DWORD *)(a2 + 44) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 168LL);
    }
    v11 = v10 | (*(_DWORD *)(a1 + 92) >> 7) & 2;
    *(_DWORD *)(a2 + 52) = v11;
    *(_DWORD *)(a2 + 52) = v11 | (*(_DWORD *)(a1 + 92) >> 1) & 4;
  }
  ...
  *(_DWORD *)(a2 + 56) = *(unsigned __int16 *)(*(_QWORD *)v13 + 6LL);
  ...
  v15 = *(__int64 **)(v5 + 688);
  if ( (unsigned int)v14 < *(_DWORD *)(v5 + 760) )
    v15 += v14;
  result = *v15;
