/*
 * XREFs of ?VidSchiUpdateFlipContextStatus@@YAHPEAU_VIDSCH_CONTEXT@@@Z @ 0x140018F34
 * Callers:
          ...
          else
          {
            if ( (*((_DWORD *)a1 + 46) & 8) == 0 )
            {
              ...
              if ( (v3 & 1) == 0 && (*((_DWORD *)a1 + 46) & 0x100) == 0 )
              {
                ...
                return (unsigned int)VidSchiUpdateContextStatus(a1, 5LL, 23599LL) != 0;
              }
              return v4;
            }
            v9 = 2LL;
          }
          VidSchiUpdateContextStatus(a1, v9, 23599LL);
          return 0;
        }
        v7 = 1LL;
        v8 = 25434LL;
