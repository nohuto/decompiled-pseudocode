/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1400EFCEC
 * Callers:
 ...
 *     ?GetProcessStatus@VIDMM_COMMIT_TELEMETRY@@AEAAPEBDPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x14009BC88 (-GetProcessStatus@VIDMM_COMMIT_TELEMETRY@@AEAAPEBDPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z.c)
