/*
 * XREFs of ?UnlockRange@VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW@@QEAAJ_K0@Z @ 0x1400C5DB0
 * Callers:
 ...
 *     ?InsertBetween@VIDMM_MDL_RANGE@@QEAAXPEAV1@0@Z @ 0x1400C49D8 (-InsertBetween@VIDMM_MDL_RANGE@@QEAAXPEAV1@0@Z.c)
  ...
  while ( 2 )
  {
    while ( 1 )
    {
      ...
      if ( (int)v7 >= 0 )
        break;
      v5 = (char *)v3 - 24;
      if ( *((_QWORD *)v3 - 1) > (unsigned __int64)a2 )
        v7 = *((_QWORD *)v3 - 2) >= (unsigned __int64)a3;
      else
        v7 = 0xFFFFFFFFLL;
...
LABEL_2:
  ...
  v9 = v5;
  v10 = *((_QWORD *)v5 + 1);
  if ( *((_QWORD *)v5 + 2) < (unsigned __int64)a3 )
  {
    do
    {
      v33 = *((_QWORD *)v9 + 3);
    ...
    while ( *((_QWORD *)v9 + 2) < (unsigned __int64)a3 );
    this = (VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW **)v89;
  }
  v11 = *((_QWORD *)v9 + 2);
  if ( v10 < (unsigned __int64)a2 || v11 > (unsigned __int64)a3 )
  {
    v17 = *this;
    v18 = 0LL;
    v91 = 0;
    ...
    {
      CurrentProcess = PsGetCurrentProcess(v20, v17, a3, v7);
    ...
    if ( v73 < 0 )
    {
      ...
      MappedBase = 0LL;
      _InterlockedIncrement(&dword_1400817C0);
      WdLogSingleEntry4(6LL, v11 - v10, *((_QWORD *)v5 + 1));
...
LABEL_30:
    if ( v10 < (unsigned __int64)a2 )
    {
      if ( v11 <= (unsigned __int64)a3 )
      {
        v37 = VIDMM_MDL_RANGE::LockUnlock((PMDL *)v5, v21, *((struct _MDL **)v5 + 1), a2);
        v15 = v37;
        Sectionb = v37;
        if ( v37 < 0 )
        {
...
LABEL_73:
        ...
        if ( (unsigned int)(v62 - 3) <= 3 && (unsigned int)(v62 - 5) > 1 )
        {
          if ( !v91 )
          {
            v63 = PsGetCurrentProcess(v61, v62, v89, v28);
            v60 = v89;
            v29 = (struct _EPROCESS *)v63;
          }
          v64 = dword_140081504;
    ...
    else if ( v11 > (unsigned __int64)a3 )
    {
      v27 = VIDMM_MDL_RANGE::LockUnlock(
              (PMDL *)v9,
              &v21[(_QWORD)a3 - *((_QWORD *)v5 + 1)],
              a3,
              *((struct _MDL **)v9 + 2));
      v15 = v27;
      Sectiona = v27;
    ...
    *((_QWORD *)v48 + 4) = 0LL;
    ...
    {
      Sectionc = VIDMM_MDL_RANGE::Lock(v50, &v21[v90 - *((_QWORD *)v5 + 1)], v52, 0LL, 0LL);
      if ( Sectionc >= 0 )
      {
        v53 = *((_QWORD *)v5 + 4);
        v8 = v53 == *((_QWORD *)v5 + 5) + 8LL;
        v54 = (struct VIDMM_MDL_RANGE *)(v53 - 24);
        v55 = *((_QWORD *)v9 + 3);
        if ( v8 )
          v54 = 0LL;
        v56 = (struct VIDMM_MDL_RANGE *)(v55 - 24);
        if ( v55 == *((_QWORD *)v9 + 5) + 8LL )
          v56 = 0LL;
        v57 = 0;
        v88 = v56;
        do
