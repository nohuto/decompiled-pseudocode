/*
 * XREFs of ?ProcessPendingOfferList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1400EB160
 * Callers:
  ...
  if ( qword_140081470 )
  {
    ...
    else
    {
      ...
      if ( (*((_DWORD *)this + 1746) & 0x8000) != 0
        || (v5 = *((_QWORD *)this + 570) - *((_QWORD *)this + 881), v5 >= qword_140081470) )
      {
