/*
 * XREFs of McTemplateK0pxuuii_EtwWriteTransfer @ 0x14004E94C
 * Callers:
...
NTSTATUS McTemplateK0pxuuii_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventDeselectTask, a3, 7u, &v4);
}
