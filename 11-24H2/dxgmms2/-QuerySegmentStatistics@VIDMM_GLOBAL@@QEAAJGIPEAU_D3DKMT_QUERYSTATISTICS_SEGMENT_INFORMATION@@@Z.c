/*
 * XREFs of ?QuerySegmentStatistics@VIDMM_GLOBAL@@QEAAJGIPEAU_D3DKMT_QUERYSTATISTICS_SEGMENT_INFORMATION@@@Z @ 0x1400FE9FC
 * Callers:
 *     VidMmQuerySegmentStatistics @ 0x140040310 (VidMmQuerySegmentStatistics.c)
 * Callees:
 *     <none>
 */
