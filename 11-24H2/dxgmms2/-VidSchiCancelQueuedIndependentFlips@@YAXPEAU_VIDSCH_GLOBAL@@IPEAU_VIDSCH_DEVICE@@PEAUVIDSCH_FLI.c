/*
 * XREFs of ?VidSchiCancelQueuedIndependentFlips@@YAXPEAU_VIDSCH_GLOBAL@@IPEAU_VIDSCH_DEVICE@@PEAUVIDSCH_FLIP_QUEUE@@_KAEAI444@Z @ 0x14003F754
 * Callers:
 ...
 *     ?VidSchiAbortSoftwarePacket@@YA_NPEAU_VIDSCH_QUEUE_PACKET@@_K@Z @ 0x14003FA24 (-VidSchiAbortSoftwarePacket@@YA_NPEAU_VIDSCH_QUEUE_PACKET@@_K@Z.c)
    ...
    *a8 = -1;
    ...
    else
    {
      ...
      if ( *v19 != -1 )
      {
        ...
        v48 = 0;
        *a9 = v42;
        VidSchiCancelIndependentFlips((unsigned int)&v43, (_DWORD)a1, a2, (_DWORD)a4, (__int64)&v48, v29, v42);
        *a6 = *((_DWORD *)a4 + 16);
        if ( !v46 )
        {
          if ( v47 )
