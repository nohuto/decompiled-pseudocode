/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x140106A2C
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v28;
  v5 = 10000 * v26;
  dword_14008153C = 10000 * v28;
  dword_140081530 = 10000 * v3;
  dword_140081538 = 10000 * v26;
  dword_140081534 = 10000 * v1;
  if ( 10000 * v26 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
