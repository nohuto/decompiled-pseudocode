/*
 * XREFs of ?CreatePageDirectory@@YAPEAVVIDMM_PAGE_DIRECTORY@@PEAVCVirtualAddressAllocator@@II@Z @ 0x1400DA9AC
 * Callers:
 ...
 *     ??0VIDMM_PAGE_DIRECTORY@@QEAA@III@Z @ 0x1400DAAE4 (--0VIDMM_PAGE_DIRECTORY@@QEAA@III@Z.c)
