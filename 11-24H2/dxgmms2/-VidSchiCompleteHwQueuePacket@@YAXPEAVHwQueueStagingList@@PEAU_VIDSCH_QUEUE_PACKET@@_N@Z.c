/*
 * XREFs of ?VidSchiCompleteHwQueuePacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@_N@Z @ 0x140028980
 * Callers:
...
LABEL_97:
            if ( (*((_DWORD *)v5 + 18) & 0x40080) != 0 && *((_QWORD *)v5 + 19) && *((_QWORD *)v5 + 20) && v13 )
              VidSchiSubmitPresentHistoryToken((struct HwQueueStagingList *)a1, v5, 0LL, 0LL, 0LL);
            if ( v87 )
            {
    ...
    while ( v38 )
    {
      ...
      if ( (int)v43 > -1 )
      {
        ...
        if ( *(_DWORD *)(160 * v43 + v44 + 112) == 1 && (_DWORD)v41 != -1 )
        {
          ...
          {
            VidSchiFlushPendingTokenList((struct HwQueueStagingList *)a1, (struct _VIDSCH_GLOBAL *)v10, v41, v40);
          }
        }
      }
      v46 = 1 << v40;
...
LABEL_37:
  if ( v87 )
  {
    ...
    VidSchiSignalRegisteredEvent(v10, (struct _KEVENT **)(v10 + 1928));
...
LABEL_178:
      ...
      KeLowerIrql(v77);
      *(_QWORD *)(v7 + 376) = MEMORY[0xFFFFF78000000320];
      KeSetEvent((PRKEVENT)(v7 + 344), 0, 0);
