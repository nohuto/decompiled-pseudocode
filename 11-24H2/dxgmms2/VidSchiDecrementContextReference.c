/*
 * XREFs of VidSchiDecrementContextReference @ 0x140020D30
 * Callers:
 ...
 *     VidSchiTerminateNode @ 0x14010E9D0 (VidSchiTerminateNode.c)
 * Callees:
        ...
        if ( *(struct _VIDSCH_CONTEXT **)(v8 + 8) == (struct _VIDSCH_CONTEXT *)((char *)a1 + 24) )
        {
          ...
          if ( *v9 == (struct _VIDSCH_CONTEXT *)((char *)a1 + 24) )
          {
            ...
            *(_QWORD *)(v8 + 8) = v9;
            while ( 1 )
            {
              v10 = VidSchiInterlockedRemoveHeadListIfExist(v4 + 1992, (char *)a1 + 712, (char *)a1 + 728);
              if ( !v10 )
                break;
            ...
            if ( (*((_DWORD *)a1 + 28) & 0x100) != 0 )
            {
              while ( 1 )
              {
                v15 = VidSchiInterlockedRemoveHeadListIfExist(v4 + 1992, (char *)a1 + 736, (char *)a1 + 752);
                if ( !v15 )
                  break;
