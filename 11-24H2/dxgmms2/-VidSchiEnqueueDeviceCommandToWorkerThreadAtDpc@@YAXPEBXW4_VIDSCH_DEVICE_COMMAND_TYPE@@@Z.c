/*
 * XREFs of ?VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc@@YAXPEBXW4_VIDSCH_DEVICE_COMMAND_TYPE@@@Z @ 0x1400460B8
 * Callers:
...
LONG __fastcall VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc(__int128 *a1, int a2)
{
  ...
  *((_QWORD *)PacketFromGuaranteedPacketPool + 11) = v6;
  ...
  v9 = v14[1];
  v15 = 0;
  *((_OWORD *)PacketFromGuaranteedPacketPool + 47) = v14[0];
  *((_QWORD *)PacketFromGuaranteedPacketPool + 13) = CurrentThread;
  v10 = v14[2];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 48) = v9;
  v11 = v14[3];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 49) = v10;
  v12 = v14[4];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 50) = v11;
  *((_OWORD *)PacketFromGuaranteedPacketPool + 51) = v12;
  result = VidSchiUpdatePriorityTables(v4, (__int64)PacketFromGuaranteedPacketPool, &v15);
  ++*(_DWORD *)(v6 + 808);
  if ( v15 )
  {
