/*
 * XREFs of ?MapInVideoMemory@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAUVIDMM_ALLOC@@_NPEA_N@Z @ 0x1400D95D8
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( (_DWORD)result || (*((_BYTE *)v8 + 36) & 1) == 0 )
  {
    ...
    if ( (*(_DWORD *)(*((_QWORD *)this + 6) + 6984LL) & 0x20) != 0
      ...
      || (v11 = *(unsigned int *)v8[49], (v11 & 4) != 0) && !*(_BYTE *)(v13 + 514)
...
LABEL_16:
    if ( a3 )
    {
      ...
      v8[42] = 0LL;
      ExReleasePushLockExclusiveEx(v8 + 41, 0LL);
      KeLeaveCriticalRegion();
      if ( (*((_DWORD *)a2 + 7) & 3) == 2 )
      {
        *a4 = 1;
        VidMmSuspendAccessToAllocation(**((VIDMM_GLOBAL ****)this + 6), (struct VIDMM_GLOBAL_ALLOC *)v8);
      }
      VIDMM_GLOBAL::EvictOneAllocation(*((VIDMM_GLOBAL **)this + 6), (__int64 **)a2, 0);
      KeEnterCriticalRegion();
      ExAcquirePushLockExclusiveEx(v8 + 41, 0LL);
      v8[42] = (__int64)KeGetCurrentThread();
      return 0;
    }
    return v12;
  }
