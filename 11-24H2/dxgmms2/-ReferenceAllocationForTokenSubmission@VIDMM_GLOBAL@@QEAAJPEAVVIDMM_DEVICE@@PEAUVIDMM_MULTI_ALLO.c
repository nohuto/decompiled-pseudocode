/*
 * XREFs of ?ReferenceAllocationForTokenSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAUVIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1400F8140
 * Callers:
 *     VidMmReferenceAllocationForTokenSubmission @ 0x14003AAE0 (VidMmReferenceAllocationForTokenSubmission.c)
 * Callees:
        ...
        __int64 ***a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v5 = *(unsigned int *)(*(_QWORD *)(v4 + 392) + 16LL);
    if ( (_DWORD)v5 )
    {
      if ( a2 && a3[1] != (__int64 *)a2 )
      {
        WdLogSingleEntry3(1LL, a2, a3, a3[1]);
        WdLogGlobalForLineNumber = 8942;
