/*
 * XREFs of ?UnlockInternal@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@_N@Z @ 0x1400E9320
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::UnlockInternal(VIDMM_GLOBAL *this, __int64 ***a2, unsigned __int8 a3)
{
  ...
  ExAcquirePushLockExclusiveEx(v7 + 41, 0LL);
  v7[42] = (__int64)KeGetCurrentThread();
  if ( !*((_DWORD *)v3 + 17) )
  {
    ...
    v7[42] = 0LL;
LABEL_7:
    ExReleasePushLockExclusiveEx(v7 + 41, 0LL);
    ...
    else
    {
      ...
      else
      {
        ...
        if ( (v19 & 0x40000) != 0 )
        {
          ...
          {
            (*(void (__fastcall **)(_QWORD, _QWORD, __int64 *))(**(_QWORD **)(v18 + 240) + 80LL))(
              *(_QWORD *)(v18 + 240),
              *(_QWORD *)(v18 + 248),
              v3[2]);
          }
