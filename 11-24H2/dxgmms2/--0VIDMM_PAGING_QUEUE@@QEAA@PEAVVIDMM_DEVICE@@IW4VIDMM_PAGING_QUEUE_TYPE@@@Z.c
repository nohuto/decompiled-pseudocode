/*
 * XREFs of ??0VIDMM_PAGING_QUEUE@@QEAA@PEAVVIDMM_DEVICE@@IW4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1400F878C
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::VIDMM_PAGING_QUEUE(__int64 a1, __int64 *a2, __int64 a3, char a4)
{
  ...
  *(_DWORD *)(a1 + 112) = v7 ^ ((unsigned __int8)v7 ^ (unsigned __int8)(8 * a4)) & 0x18;
  ...
  v13 = *(_QWORD *)(v11 + 24);
  if ( (*(_DWORD *)(*(_QWORD *)(v11 + 8) + 96LL) & 2) == 0 || v13 && (*(_BYTE *)(v13 + 1917) & 0x10) != 0 )
    v12 = 0;
