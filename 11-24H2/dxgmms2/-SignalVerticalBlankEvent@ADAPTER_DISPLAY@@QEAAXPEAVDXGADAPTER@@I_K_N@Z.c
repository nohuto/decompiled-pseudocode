/*
 * XREFs of ?SignalVerticalBlankEvent@ADAPTER_DISPLAY@@QEAAXPEAVDXGADAPTER@@I_K_N@Z @ 0x140036C4C
 * Callers:
 ...
 *     ?NumberOfVSyncWaiter@DXGADAPTER@@QEAAKI@Z @ 0x140036EC4 (-NumberOfVSyncWaiter@DXGADAPTER@@QEAAKI@Z.c)
 */
