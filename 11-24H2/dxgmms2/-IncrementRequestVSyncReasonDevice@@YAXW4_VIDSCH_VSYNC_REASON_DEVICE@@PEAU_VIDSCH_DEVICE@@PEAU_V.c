/*
 * XREFs of ?IncrementRequestVSyncReasonDevice@@YAXW4_VIDSCH_VSYNC_REASON_DEVICE@@PEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_GLOBAL@@I@Z @ 0x140042670
 * Callers:
...
__int64 __fastcall IncrementRequestVSyncReasonDevice(unsigned int a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  if ( a1 < 4 )
  {
    ...
    if ( *(_BYTE *)(a3 + 2468) )
    {
      ...
      {
        ++*(_DWORD *)(a2 + 4 * (a1 + 4LL * a4) + 1392);
      }
    }
    else
    {
      ++*(_DWORD *)(a2 + 4LL * a1 + 1392);
    }
  }
  return result;
}
