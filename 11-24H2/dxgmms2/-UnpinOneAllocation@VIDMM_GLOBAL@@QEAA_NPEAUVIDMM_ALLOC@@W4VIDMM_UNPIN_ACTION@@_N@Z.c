/*
 * XREFs of ?UnpinOneAllocation@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_ALLOC@@W4VIDMM_UNPIN_ACTION@@_N@Z @ 0x1400BE8F8
 * Callers:
...
bool __fastcall VIDMM_GLOBAL::UnpinOneAllocation(VIDMM_GLOBAL *a1, __int64 a2, int a3, char a4)
{
  ...
  v5 = a3;
  if ( (**(_DWORD **)(**(_QWORD **)a2 + 392LL) & 0x40000000) != 0 )
  {
  ...
  else
  {
    ...
    if ( (v5 & 2) != 0 && v8 )
    {
      ...
      if ( !VIDMM_ALLOC::HasAnyResidencyReferences((VIDMM_ALLOC *)a2) )
      {
        ...
        {
          _InterlockedIncrement((volatile signed __int32 *)(a2 + 180));
