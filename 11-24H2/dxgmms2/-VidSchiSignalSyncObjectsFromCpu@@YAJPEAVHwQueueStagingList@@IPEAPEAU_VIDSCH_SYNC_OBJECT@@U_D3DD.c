/*
 * XREFs of ?VidSchiSignalSyncObjectsFromCpu@@YAJPEAVHwQueueStagingList@@IPEAPEAU_VIDSCH_SYNC_OBJECT@@U_D3DDDICB_SIGNALFLAGS@@PEB_KPEAPEAUVIDSCH_HW_QUEUE@@@Z @ 0x14000EF50
 * Callers:
...
LABEL_82:
        ...
        WdLogGlobalForLineNumber = 11556;
        v42(
          0LL,
          0x40000LL,
          0xFFFFFFFFLL,
