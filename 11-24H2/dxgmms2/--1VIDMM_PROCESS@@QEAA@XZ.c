/*
 * XREFs of ??1VIDMM_PROCESS@@QEAA@XZ @ 0x1400BBDF4
 * Callers:
 ...
 *     ?GetTotalGlobalSharedFence@VIDMM_PROCESS_FENCE_STORAGE@@SAI_N@Z @ 0x1400439E8 (-GetTotalGlobalSharedFence@VIDMM_PROCESS_FENCE_STORAGE@@SAI_N@Z.c)
