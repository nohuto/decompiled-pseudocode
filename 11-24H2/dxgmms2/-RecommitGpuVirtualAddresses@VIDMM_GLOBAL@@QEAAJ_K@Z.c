/*
 * XREFs of ?RecommitGpuVirtualAddresses@VIDMM_GLOBAL@@QEAAJ_K@Z @ 0x1400D2258
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::RecommitGpuVirtualAddresses(VIDMM_GLOBAL *this, unsigned __int64 a2)
{
  ...
  v14 = &v13;
  v3 = (volatile signed __int32 *)((char *)this + 41080);
  v13 = (CVirtualAddressAllocator *)&v13;
  v5 = 0;
  DXGPUSHLOCK::AcquireShared((VIDMM_GLOBAL *)((char *)this + 41080));
  v6 = (_QWORD *)*((_QWORD *)this + 5141);
  if ( v6 != (_QWORD *)((char *)this + 41128) )
  {
    v7 = (CVirtualAddressAllocator ***)v14;
    do
    {
      v8 = (CVirtualAddressAllocator ***)v6[20];
    ...
    while ( v6 != (_QWORD *)((char *)this + 41128) );
  }
