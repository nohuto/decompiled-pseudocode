/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14004CB60
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14004CCCC (wil_details_GetCurrentFeatureEnabledState.c)
