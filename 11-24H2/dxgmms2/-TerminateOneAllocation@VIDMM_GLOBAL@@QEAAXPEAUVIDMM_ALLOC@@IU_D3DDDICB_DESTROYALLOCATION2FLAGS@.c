/*
 * XREFs of ?TerminateOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1400FDCAC
 * Callers:
        ...
        struct DXGTERMINATIONTRACKER *a5)
{
  ...
  *((_DWORD *)a2 + 8) |= 1u;
  ...
  v20[6] = v18;
  LODWORD(v20[0]) = (v6 & 1) == 0 || (*(_DWORD *)v8[49] & 0x4000) != 0;
  v16 = (_QWORD *)a2[1][4];
