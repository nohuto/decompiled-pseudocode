/*
 * XREFs of ?ReserveVPRResource@VIDMM_SEGMENT@@QEAAJPEAUVIDMM_PHYSICAL_ALLOC@@EE@Z @ 0x1400CF1C8
 * Callers:
  ...
  if ( v9 < 0 )
  {
    ...
    if ( v9 < 0 )
    {
      ...
      if ( v25 + *((_QWORD *)this + 60) < *((_QWORD *)this + 59)
                                        * (unsigned __int64)(unsigned int)dword_1400815F4
                                        / (unsigned int)dword_1400815F8 )
      {
        v16 = v6;
