/*
 * XREFs of ?VidMmMapContextAllocationCb@VIDMM_GLOBAL@@QEAA_KPEBU_DXGKARGCB_MAPCONTEXTALLOCATION@@@Z @ 0x1400F4E64
 * Callers:
 *     VidMmMapContextAllocation @ 0x140042270 (VidMmMapContextAllocation.c)
 * Callees:
        ...
        const struct _DXGKARGCB_MAPCONTEXTALLOCATION *a2)
{
  ...
  WdLogGlobalForLineNumber = 22800;
