/*
 * XREFs of ?FillAllocationInternal@VIDMM_GLOBAL@@QEAAXKPEAUVIDMM_GLOBAL_ALLOC@@_KIPEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@@Z @ 0x1400AE828
 * Callers:
  ...
  else
  {
    ...
    if ( g_IsInternalReleaseOrDbg )
    {
      *(_QWORD *)(WdLogNewEntry5_WdTrace(v12) + 24) = a3;
      WdLogGlobalForLineNumber = 14808;
      v17 = WdLogNewEntry5_WdTrace(v16);
      *(_QWORD *)(v17 + 32) = 0LL;
      *(_QWORD *)(v17 + 24) = a4;
      WdLogGlobalForLineNumber = 14810;
      v19 = (_QWORD *)WdLogNewEntry5_WdTrace(v18);
      v19[3] = v15;
      v19[4] = v14->HighPart;
      v19[5] = v14->LowPart;
      WdLogGlobalForLineNumber = 14812;
    }
