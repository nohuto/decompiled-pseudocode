/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_PHYSICAL_ADAPTER@@QEAAXPEAUVIDMM_PHYSICAL_ALLOC@@_N@Z @ 0x1400E08B0
 * Callers:
 *     ?ReclaimAllocationForVPRCallback@@YA_NPEAX0@Z @ 0x14009E860 (-ReclaimAllocationForVPRCallback@@YA_NPEAX0@Z.c)
 *     NotifyAllocationReclaimed @ 0x1400E0770 (NotifyAllocationReclaimed.c)
