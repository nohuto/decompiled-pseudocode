/*
 * XREFs of ?ReadPhysicalAdapterConfiguration@VIDMM_GLOBAL@@QEAAXI@Z @ 0x1400985C4
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReadPhysicalAdapterConfiguration(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  PCUNICODE_STRING Source; // [rsp+60h] [rbp-A0h]
...
LABEL_12:
  ...
  *(_BYTE *)(v2 + 36) = v13 & 0xFE | v14;
  ...
  PagedPoolArray<unsigned short,128>::~PagedPoolArray<unsigned short,128>((void **)&v29);
}
