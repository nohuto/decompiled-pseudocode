/*
 * XREFs of ?OpenLocalAllocation@VIDMM_GLOBAL@@QEAAPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@PEAVVIDMM_PROCESS@@PEAXPEAE@Z @ 0x1400D7E60
 * Callers:
...
LABEL_27:
  ...
  while ( 1 )
  {
    if ( v10 == (struct VIDMM_GLOBAL_ALLOC *)((char *)a2 + 112) )
    {
      ...
      if ( !v12 )
      {
        _InterlockedIncrement(&dword_1400816B0);
...
LABEL_12:
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v11) + 24) = v13;
    WdLogGlobalForLineNumber = 12637;
  }
LABEL_22:
  ++*((_DWORD *)v13 + 7);
...
LABEL_51:
  ...
  WdLogGlobalForLineNumber = 12743;
