/*
 * XREFs of VidSchTerminateContext @ 0x1400FFEA0
 * Callers:
 ...
 *     ?VidSchiRemoveContextFromSyncPoints@@YAXPEAU_VIDSCH_CONTEXT@@@Z @ 0x14003FB74 (-VidSchiRemoveContextFromSyncPoints@@YAXPEAU_VIDSCH_CONTEXT@@@Z.c)
