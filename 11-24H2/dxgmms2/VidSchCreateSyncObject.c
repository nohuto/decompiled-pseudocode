/*
 * XREFs of VidSchCreateSyncObject @ 0x1400F8AD0
 * Callers:
 ...
 *     VidSchiAddSyncObjectToAdapterList @ 0x140042FF8 (VidSchiAddSyncObjectToAdapterList.c)
 *     VidSchiAddSyncObjectToCrossAdapterInfo @ 0x140043718 (VidSchiAddSyncObjectToCrossAdapterInfo.c)
...
LABEL_58:
  ...
  if ( !a9 )
  {
    v37 = -1073741811;
    WdLogSingleEntry1(1LL, -1073741811LL);
    WdLogGlobalForLineNumber = 10622;
    goto LABEL_58;
  }
LABEL_3:
  v15 = (int *)(a9 + 16);
      ...
      else
      {
        ...
        *(_QWORD *)(v18 + 64) = Object;
        ...
        if ( v46 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 10768;
LABEL_51:
