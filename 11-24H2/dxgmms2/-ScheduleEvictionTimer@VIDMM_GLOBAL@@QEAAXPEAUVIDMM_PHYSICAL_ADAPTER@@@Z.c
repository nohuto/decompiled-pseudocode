/*
 * XREFs of ?ScheduleEvictionTimer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@@Z @ 0x1400D7ACC
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ScheduleEvictionTimer(VIDMM_GLOBAL *this, struct VIDMM_PHYSICAL_ADAPTER *a2)
{
  ...
  {
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 76304) || (v4 = *((_QWORD *)a2 + 3), v4 == 9000000000LL) )
    {
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 76304) != 1 || (v4 = *((_QWORD *)a2 + 2), v4 == 9000000000LL) )
        v4 = qword_140081678;
    }
