/*
 * XREFs of ?UncommitVirtualAddressRange@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@_K2@Z @ 0x1400CD6C0
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  const struct COMMIT_VA_STATE *v6; // rbp
