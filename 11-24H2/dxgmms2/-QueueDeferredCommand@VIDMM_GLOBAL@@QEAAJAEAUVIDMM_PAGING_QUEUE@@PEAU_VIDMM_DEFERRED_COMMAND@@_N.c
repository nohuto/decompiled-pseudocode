/*
 * XREFs of ?QueueDeferredCommand@VIDMM_GLOBAL@@QEAAJAEAUVIDMM_PAGING_QUEUE@@PEAU_VIDMM_DEFERRED_COMMAND@@_NPEA_K@Z @ 0x1400DB060
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  struct VIDMM_WORKER_THREAD *v7; // r13
  struct VIDMM_PAGING_QUEUE **v10; // r14
