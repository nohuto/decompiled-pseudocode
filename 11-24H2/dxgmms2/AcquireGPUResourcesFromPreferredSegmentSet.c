/*
 * XREFs of AcquireGPUResourcesFromPreferredSegmentSet @ 0x1400E7674
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v10 = (((_DWORD)a3 - 3) & 0xFFFFFFFA) == 0
     && (_DWORD)a3 != 8
     && ((v24 = **(_DWORD **)(v5 + 392), (v24 & 0x20000000) == 0) || v24 >= 0)
     && (v24 & 0x80000) == 0;
  v30 = v10;
...
LABEL_25:
        ...
        if ( ((v20 & 0x10) != 0 || (v20 & 2) != 0) && (v21[26] & 1) != 0 && (**(_DWORD **)(v5 + 392) & 0x8000) == 0 )
        {
