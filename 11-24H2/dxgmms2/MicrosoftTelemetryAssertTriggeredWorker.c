/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x140055668
 * Callers:
 ...
 *     TakeTelemetryAssertsLock @ 0x140055B68 (TakeTelemetryAssertsLock.c)
...
LABEL_36:
    ...
    if ( (unsigned int)dword_14008E040 > 5 && tlgKeywordOn((__int64)&dword_14008E040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14008E040, byte_140075D2A, 0LL, 0LL, 0xBu, &v59);
    }
    if ( dword_14008E078 && !v19 && !KeGetCurrentIrql() )
    {
      ...
      if ( (unsigned int)dword_14008E040 > 5 )
      {
        ...
        if ( v25 )
        {
          ...
          v42 = v23;
          v58 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14008E040, byte_140075E3D, v26, 0LL, v27, &v43);
        }
      }
