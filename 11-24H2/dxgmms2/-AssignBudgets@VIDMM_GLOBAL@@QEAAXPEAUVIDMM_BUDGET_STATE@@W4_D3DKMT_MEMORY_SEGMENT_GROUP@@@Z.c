/*
 * XREFs of ?AssignBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1400DFCC8
 * Callers:
 *     ?RecalculateBudget@VIDMM_GLOBAL@@QEAAXPEA_N@Z @ 0x1400DF728 (-RecalculateBudget@VIDMM_GLOBAL@@QEAAXPEA_N@Z.c)
 * Callees:
 *     ?BucketizeBudgetStateProcesses@VIDMM_GLOBAL@@QEAAXKW4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1400DFDC8 (-BucketizeBudgetStateProcesses@VIDMM_GLOBAL@@QEAAXKW4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z.c)
