/*
 * XREFs of ?VidSchiUnreferenceDisplayingAllocations@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@G@Z @ 0x14002C91C
 * Callers:
        ...
        __int16 a4)
{
  ...
  __int64 v40; // rdx
  __int64 v41; // rcx
  __int16 v42; // [rsp+50h] [rbp-68h]
  __int64 v43; // [rsp+68h] [rbp-50h]
  struct _VIDSCH_SYNC_OBJECT *v44; // [rsp+70h] [rbp-48h] BYREF
  ...
  if ( a4 )
  {
    do
    {
            ...
            if ( *v35 )
            {
                          ...
                          0LL) < 0 )
              {
                WdLogSingleEntry2(
                  ...
                  *v35);
                v38 = *(_QWORD *)((char *)a3 + v16 + 3344);
                WdLogGlobalForLineNumber = 30456;
                DxgkLogInternalTriageEvent(*(_QWORD *)(v38 + 32), 0x40000LL);
              }
              v36 = *(_QWORD *)(*(_QWORD *)((char *)a3 + v16 + 3344) + 32LL);
              v37 = 2LL * *(unsigned int *)(v36 + 32);
              *(_OWORD *)(v36 + 8 * v37 + 40) = 0LL;
              *(_DWORD *)(v36 + 32) = ((unsigned __int8)*(_DWORD *)(v36 + 32) + 1) & 7;
              *(_DWORD *)(v36 + 8 * v37 + 40) = 2;
              *(_QWORD *)(v36 + 8 * v37 + 48) = *v35;
            }
          }
          else
          {
      ...
      {
        v39 = (char *)a3 + v20 + 3392;
        v44 = *(struct _VIDSCH_SYNC_OBJECT **)((char *)a3 + v20 + 3384);
        if ( (int)VidSchiSignalSyncObjectsFromCpu(v8, 1u, &v44, 0, v39, 0LL) < 0 )
        {
          WdLogSingleEntry2(1LL, *(_QWORD *)((char *)a3 + v20 + 3384), *(_QWORD *)v39);
          WdLogGlobalForLineNumber = 9902;
          DxgkLogInternalTriageEvent(v41, 0x40000LL);
        }
        VidSchiReleaseSyncObjectReference(*(char **)((char *)a3 + v20 + 3384), v40);
