/*
 * XREFs of WorkerThreadRun @ 0x1400A1504
 * Callers:
 *     ?VidMmWorkerThreadProc2@@YAXPEAX@Z @ 0x1400A1460 (-VidMmWorkerThreadProc2@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     QueryCurrentTimePrecise @ 0x1400A118C (QueryCurrentTimePrecise.c)
