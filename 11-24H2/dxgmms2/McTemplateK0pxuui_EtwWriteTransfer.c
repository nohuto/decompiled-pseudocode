/*
 * XREFs of McTemplateK0pxuui_EtwWriteTransfer @ 0x14004E89C
 * Callers:
...
NTSTATUS McTemplateK0pxuui_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventSelectTask, a3, 6u, &v4);
}
