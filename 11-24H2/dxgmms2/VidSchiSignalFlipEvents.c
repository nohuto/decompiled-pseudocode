/*
 * XREFs of VidSchiSignalFlipEvents @ 0x14002C6E8
 * Callers:
...
void __fastcall VidSchiSignalFlipEvents(__int64 a1, int a2, __int16 a3)
{
  ...
  if ( v3 )
  {
    ...
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v7 + 1928));
    ...
    *(_QWORD *)(v7 + 1872) = MEMORY[0xFFFFF78000000320];
    ...
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v7 + 1944));
