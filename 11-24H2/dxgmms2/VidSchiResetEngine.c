/*
 * XREFs of VidSchiResetEngine @ 0x140047318
 * Callers:
...
char __fastcall VidSchiResetEngine(struct _VIDSCH_NODE *a1, __int64 a2)
{
  ...
  UINT LastAbortedFenceId; // [rsp+A0h] [rbp-68h] BYREF
  ...
  struct _DXGKARG_RESETENGINE v102; // [rsp+1B0h] [rbp+A8h] BYREF
  ...
  *(_OWORD *)&v6[2].LowPart = v81;
  ...
  if ( v83.LowPart == v83.HighPart && !*((_DWORD *)a1 + 537) )
  {
    ...
    *((_QWORD *)&v82 + 1) = v81;
    ...
    v10 = v4 + 3256;
    WdLogGlobalForLineNumber = 18257;
    goto LABEL_45;
  }
  v10 = v4 + 3256;
    ...
    if ( RecoveryContext )
    {
      ...
      *((_QWORD *)v7 + 13) = DXGADAPTER::GetDbgOwnerTag(*((DXGADAPTER **)v7 + 4));
      if ( *((_DWORD *)v7 + 4) == 6 )
      {
        ...
        TdrCollectDbgInfoStage1(*(struct _TDR_RECOVERY_CONTEXT **)(v4 + 3248), 1, 0x28u, v100);
        v14 = *((unsigned int *)a1 + 394);
        v15 = *((_QWORD *)a1 + v14 + 198);
        if ( v15 )
        {
          if ( *(_BYTE *)(v15 + 910) )
          {
            VidSchiDecrementContextReference(*((struct _VIDSCH_CONTEXT **)a1 + v14 + 198), 1);
            *(_BYTE *)(v15 + 910) = 0;
          }
          else
          {
            WdLogSingleEntry1(3LL, *((_QWORD *)a1 + v14 + 198));
            WdLogGlobalForLineNumber = 18168;
          }
        }
      }
      else
      {
        ...
        TdrCollectDbgInfoStage1(*(struct _TDR_RECOVERY_CONTEXT **)(v4 + 3248), 1, 0, 0LL);
      }
    }
  }
  v16 = *((unsigned __int16 *)a1 + 2);
  v17 = *((_DWORD *)a1 + 127) + 1;
  v102.LastAbortedFenceId = 0;
  *((_DWORD *)a1 + 127) = v17;
  v18 = *(_QWORD *)(v4 + 688);
  v19 = v18 + 8 * v16;
  ...
  if ( (unsigned int)v16 >= *(_DWORD *)(v4 + 760) )
    v19 = *(_QWORD *)(v4 + 688);
  v102.EngineOrdinal = *(unsigned __int16 *)(*(_QWORD *)v19 + 6LL);
  if ( v20 )
    v18 += 8 * v16;
  v102.NodeOrdinal = *(unsigned __int16 *)(*(_QWORD *)v18 + 8LL);
  ...
  v25 = ADAPTER_RENDER::DdiResetEngine(*(ADAPTER_RENDER **)(v4 + 8), &v102);
  if ( v25 )
  {
    v9 = 0;
  }
  ...
  if ( (unsigned int)dword_140081048 > 5 && tlgKeywordOn((__int64)&dword_140081048, 0x400000000010LL) )
  {
    v28 = *(_QWORD *)(v4 + 16);
    v72 = *((_DWORD *)a1 + 127);
    LastAbortedFenceId = v102.LastAbortedFenceId;
    v73 = v25;
    v89 = v7;
    ...
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapBuffer<_UNICODE_STRING>,_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      ...
      &v90,
      (__int64)&v89,
      (__int64)&LastAbortedFenceId,
      (__int64)&v73,
      (__int64)&v72);
  }
  v29 = v102.LastAbortedFenceId;
  v6[5].QuadPart = v102.LastAbortedFenceId;
