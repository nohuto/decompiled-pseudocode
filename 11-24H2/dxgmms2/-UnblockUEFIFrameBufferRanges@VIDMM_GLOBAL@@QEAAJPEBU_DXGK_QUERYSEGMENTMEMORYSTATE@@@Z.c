/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1400964EC
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x14004C050 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
        ...
        const struct _DXGK_QUERYSEGMENTMEMORYSTATE *a2)
{
  ...
  if ( KeGetCurrentThread() == *(struct _KTHREAD **)(*(_QWORD *)this + 8LL) )
  {
    ...
    WdLogGlobalForLineNumber = 29430;
  }
  ...
  if ( NumInvalidMemoryRanges == 1 )
  {
    ...
    WdLogGlobalForLineNumber = 29446;
  }
  else
  {
    WdLogSingleEntry1(1LL, NumInvalidMemoryRanges);
    WdLogGlobalForLineNumber = 29436;
  }
