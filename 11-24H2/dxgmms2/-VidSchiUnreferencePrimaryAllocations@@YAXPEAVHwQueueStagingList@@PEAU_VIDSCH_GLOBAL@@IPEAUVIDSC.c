/*
 * XREFs of ?VidSchiUnreferencePrimaryAllocations@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@@II_N3@Z @ 0x1400272E8
 * Callers:
      ...
      if ( (v8 & 1) != 0 )
      {
        if ( (v12 & 1) != 0 )
        {
          ...
          while ( v15 || v16 )
          {
            ...
            VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::operator++(v44);
            v25 = v49;
            v16 = v46;
            v15 = v45;
            v23 = v48;
