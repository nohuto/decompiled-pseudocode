/*
 * XREFs of VidMmInitDmaPool @ 0x1400B87A0
 * Callers:
...
LABEL_11:
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)++v8 >= 2 )
      {
        ...
        v13 = (_QWORD *)qword_140081938;
        v14 = (_QWORD *)(a1 + 96);
        if ( *(__int64 **)qword_140081938 != &qword_140081930 )
          __fastfail(3u);
        *v14 = &qword_140081930;
        *(_QWORD *)(a1 + 104) = v13;
        *v13 = v14;
        qword_140081938 = a1 + 96;
        _InterlockedIncrement(&dword_140081A08);
