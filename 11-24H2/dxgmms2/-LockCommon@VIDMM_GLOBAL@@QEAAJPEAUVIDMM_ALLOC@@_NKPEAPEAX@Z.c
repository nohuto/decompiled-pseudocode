/*
 * XREFs of ?LockCommon@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@_NKPEAPEAX@Z @ 0x1400EE09C
 * Callers:
        ...
        void **a5)
{
  ...
  *(_QWORD *)(v12 + 8) = KeGetCurrentThread();
  ...
  if ( v13 && v6 != (*((_BYTE *)v11 + 40) != 0) )
  {
    ...
    WdLogGlobalForLineNumber = 22030;
LABEL_5:
...
LABEL_12:
  ...
  if ( v11[31] )
  {
    ...
    (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)v11[30] + 144LL))(v11[30], v11[31]);
