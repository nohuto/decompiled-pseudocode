/*
 * XREFs of ?QueryProcessAdapterStatistics@VIDMM_GLOBAL@@QEAAJGPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x140099098
 * Callers:
 *     VidMmQueryProcessAdapterStatistics @ 0x14004BF20 (VidMmQueryProcessAdapterStatistics.c)
 * Callees:
