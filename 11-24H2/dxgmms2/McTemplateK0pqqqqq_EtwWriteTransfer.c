/*
 * XREFs of McTemplateK0pqqqqq_EtwWriteTransfer @ 0x140054D54
 * Callers:
...
NTSTATUS McTemplateK0pqqqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventCancelAndRequeueFlips, a3, 7u, &v4);
}
