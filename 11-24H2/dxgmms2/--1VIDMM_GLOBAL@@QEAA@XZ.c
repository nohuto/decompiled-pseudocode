/*
 * XREFs of ??1VIDMM_GLOBAL@@QEAA@XZ @ 0x140092720
 * Callers:
 ...
 *     ?VidMmiClosePerfCounters@@YAXPEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x14009CADC (-VidMmiClosePerfCounters@@YAXPEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z.c)
