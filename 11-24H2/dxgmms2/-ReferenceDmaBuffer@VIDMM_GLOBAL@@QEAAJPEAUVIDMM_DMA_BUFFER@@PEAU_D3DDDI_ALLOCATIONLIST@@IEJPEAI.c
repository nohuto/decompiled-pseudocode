/*
 * XREFs of ?ReferenceDmaBuffer@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_DMA_BUFFER@@PEAU_D3DDDI_ALLOCATIONLIST@@IEJPEAIPEAT_LARGE_INTEGER@@PEA_KPEAPEAUVIDMM_ALLOC@@PEAUVIDMM_PRIMARIES_REFERENCES@@PEAPEAVDXGALLOCATION@@@Z @ 0x140111D60
 * Callers:
 *     VidMmReferenceDmaBuffer @ 0x140038DB0 (VidMmReferenceDmaBuffer.c)
 * Callees:
 ...
 *     AddDMAReferences @ 0x140039D60 (AddDMAReferences.c)
...
LABEL_141:
      ...
      if ( *(_BYTE *)(v27 + 41) )
      {
        if ( g_IsInternalReleaseOrDbg )
        {
          ...
          WdLogGlobalForLineNumber = 8304;
          v35 = WdLogNewEntry5_WdTrace(v34);
          *(_QWORD *)(v35 + 24) = a2;
          *(_QWORD *)(v35 + 32) = v26;
          WdLogGlobalForLineNumber = 8305;
        }
        v32 = -1071775482;
        v78 = -1071775482;
        v33 = p_QuadPart;
      ...
      *v23 = *(union _LARGE_INTEGER *)(*((_QWORD *)v26 + 2) + 32LL);
      ...
      v41 = v91;
      v42 = v87;
      if ( (LowPart & 1) != 0 && (**((_DWORD **)v91 + 49) & 0x200000) != 0 )
        *((_DWORD *)v87 + 34) |= 1u;
      ...
      else
      {
        ...
        if ( v45 )
        {
          ...
          if ( (*(_DWORD *)(v52.QuadPart + 28) & 0x20) != 0 )
            AllocGpuVirtualAddress = *((_QWORD *)v26 + 20);
          else
        ...
        && ((*((_BYTE *)this + 40936) & 0x20) == 0 || (*(_DWORD *)(*((_QWORD *)this + 3) + 444LL) & 0x10) == 0) )
      {
        ...
        *(_QWORD *)v75 = 0LL;
        ...
        v32 = -1073741823;
        v78 = -1073741823;
        VidSchMarkDeviceAsError(*(_QWORD *)(v47[1] + 32), 16LL);
        v33 = p_QuadPart;
        if ( !p_QuadPart )
