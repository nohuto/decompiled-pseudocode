/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEBVDXGADAPTER@@PEBVDXGDEVICE@@PEBUVIDMM_GLOBAL_ALLOC@@PEBVDXGSHAREDRESOURCE@@@Z @ 0x1400F4BC8
 * Callers:
 ...
 *     VidMmReportMultiGlobalAlloc @ 0x1400F4BA0 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
