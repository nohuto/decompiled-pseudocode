/*
 * XREFs of ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1400DA968
 * Callers:
 *     VidMmPinAllocation @ 0x140040F20 (VidMmPinAllocation.c)
 * Callees:
