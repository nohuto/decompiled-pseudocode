/*
 * XREFs of ?VerifyIntegrity@VIDMM_LINEAR_POOL@@QEAAJH@Z @ 0x1400A04C8
 * Callers:
 *     ?VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ @ 0x14009F930 (-VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ.c)
 * Callees:
      ...
      if ( v9 )
      {
        ...
        if ( v10 )
        {
          ...
          if ( ActiveVprStart != ActiveVprEnd )
          {
            ...
            {
              if ( (**(_DWORD **)(*(_QWORD *)v14 + 392LL) & 0x20000) != 0 )
                v5 = -1073741823;
            }
            else
            {
