/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1400A20E8
 * Callers:
        ...
        char a6)
{
  ...
  *a5 = 0LL;
  ...
  v47 = 0LL;
  v11 = 0LL;
  if ( v7 <= (unsigned int)dword_14008145C )
    v7 = (unsigned int)dword_14008145C;
...
LABEL_33:
  ...
  {
    _InterlockedIncrement(&dword_14008170C);
    WdLogSingleEntry0(6LL);
    v30 = 2060LL;
    goto LABEL_56;
  }
  ...
  if ( v25 < 0 )
  {
    _InterlockedIncrement(&dword_140081710);
