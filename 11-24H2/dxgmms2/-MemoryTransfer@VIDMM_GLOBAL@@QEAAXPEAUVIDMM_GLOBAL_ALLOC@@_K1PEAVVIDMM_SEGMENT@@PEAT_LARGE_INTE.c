/*
 * XREFs of ?MemoryTransfer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@PEAU_MDL@@234U_DXGK_TRANSFERFLAGS@@@Z @ 0x1400E5E04
 * Callers:
        ...
        struct _DXGK_TRANSFERFLAGS a11)
{
  ...
  if ( a2 )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)a2 + 16LL) > (unsigned __int64)(qword_1400815D0 - *(_QWORD *)(v14 + 488)) )
