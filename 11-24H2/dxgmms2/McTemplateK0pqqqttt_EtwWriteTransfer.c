/*
 * XREFs of McTemplateK0pqqqttt_EtwWriteTransfer @ 0x14005201C
 * Callers:
 *     VidSchiUpdateDdiHwContextPriority @ 0x140101C64 (VidSchiUpdateDdiHwContextPriority.c)
 *     VidSchReportHwContext @ 0x14010CA50 (VidSchReportHwContext.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14000DC70 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140055E20 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqqqttt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &ChangeHwContextPriority, a3, 8u, &v4);
}
