 ...
 *     ?VidMmGetCurrentPagingQueueFenceId@@YA_KPEBUVIDMM_PAGING_QUEUE@@@Z @ 0x140100C44 (-VidMmGetCurrentPagingQueueFenceId@@YA_KPEBUVIDMM_PAGING_QUEUE@@@Z.c)
 */
...
LABEL_59:
      if ( KdRefreshDebuggerNotPresent() )
      {
        ...
        v38 = *(_QWORD *)(v4 + 88);
        WdLogGlobalForLineNumber = 11167;
        DxgkLogInternalTriageEvent(
          v39,
          0x40000,
          v40,
