/*
 * XREFs of VidMmSelectPagingOperation @ 0x1400E7AF0
 * Callers:
 *     VidMmWorkerThreadProc @ 0x1400EE3E0 (VidMmWorkerThreadProc.c)
 * Callees:
 *     VidMmSelectReadyQueue @ 0x1400E8710 (VidMmSelectReadyQueue.c)
...
LABEL_6:
    ...
    else
    {
      ...
      if ( !ready )
      {
        ...
        if ( v4 && *(_QWORD *)(*(_QWORD *)a1 + 4560LL) - *(_QWORD *)(a1 + 120) >= qword_140081588
