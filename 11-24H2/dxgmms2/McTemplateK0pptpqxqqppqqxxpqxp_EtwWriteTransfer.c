/*
 * XREFs of McTemplateK0pptpqxqqppqqxxpqxp_EtwWriteTransfer @ 0x14003A82C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pptpqxqqppqqxxpqxp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a21)
{
  ...
  v56 = 8LL;
  v58 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpUpdatePageTable, a3, 0x13u, &v22);
}
