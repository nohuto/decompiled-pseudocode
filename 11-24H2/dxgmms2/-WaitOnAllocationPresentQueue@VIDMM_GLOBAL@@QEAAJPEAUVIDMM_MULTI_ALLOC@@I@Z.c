/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@I@Z @ 0x1401040E4
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x14004C100 (VidMmWaitOnAllocationPresentQueue.c)
...
__int64 __fastcall VIDMM_GLOBAL::WaitOnAllocationPresentQueue(VIDMM_GLOBAL *this, struct VIDMM_MULTI_ALLOC *a2)
{
  ...
  if ( *(_BYTE *)(v5 + 204) || _InterlockedCompareExchange((volatile signed __int32 *)(v5 + 200), 0, 0) )
  {
    ...
    WdLogGlobalForLineNumber = 22997;
  }
  else
  {
    ...
    WdLogGlobalForLineNumber = 23046;
