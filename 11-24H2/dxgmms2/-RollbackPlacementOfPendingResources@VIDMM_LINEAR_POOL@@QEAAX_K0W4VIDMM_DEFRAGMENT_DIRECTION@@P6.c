/*
 * XREFs of ?RollbackPlacementOfPendingResources@VIDMM_LINEAR_POOL@@QEAAX_K0W4VIDMM_DEFRAGMENT_DIRECTION@@P6A_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z@Z @ 0x1400A0364
 * Callers:
 ...
 * Callees:
 *     ?RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z @ 0x14009E8DC (-RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z.c)
