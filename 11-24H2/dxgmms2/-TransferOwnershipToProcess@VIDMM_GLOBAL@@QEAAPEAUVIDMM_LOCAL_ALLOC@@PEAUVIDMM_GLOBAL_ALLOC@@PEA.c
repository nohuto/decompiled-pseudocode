/*
 * XREFs of ?TransferOwnershipToProcess@VIDMM_GLOBAL@@QEAAPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@PEAU2@1@Z @ 0x1400D9BB4
 * Callers:
        ...
        struct VIDMM_LOCAL_ALLOC *a4)
{
        ...
        (int)v12 < 0) )
  {
    ...
    WdLogGlobalForLineNumber = 29218;
    ...
    if ( v14 != (struct VIDMM_GLOBAL_ALLOC *)(a2 + 14) )
    {
      do
      {
        ...
        if ( (struct VIDMM_GLOBAL_ALLOC *)((char *)v14 - 48) != a3 )
        {
          ...
          {
            v18 = *(_QWORD *)(*(i - 4) + 32LL);
            VidSchMarkDeviceAsError(v18, 13LL);
