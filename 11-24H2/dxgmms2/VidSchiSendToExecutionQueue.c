/*
 * XREFs of VidSchiSendToExecutionQueue @ 0x140017660
 * Callers:
 ...
 *     VidSchiFillSubmitCommandDataVirtual @ 0x140018280 (VidSchiFillSubmitCommandDataVirtual.c)
    ...
    *(LARGE_INTEGER *)(v18 + 8) = PerformanceCounter;
    ...
    if ( _InterlockedIncrement((volatile signed __int32 *)(v2 + 788)) == 1 )
    {
      if ( v75 == *(_QWORD *)(v6 + 256) )
        VidSchiUpdateContextStatus(v2, 1LL, 6841LL);
      *(_DWORD *)(v2 + 184) |= 2u;
...
LABEL_99:
  ...
  for ( j = *(_DWORD *)(v5 + 1576); j != *(_DWORD *)(v5 + 1568); j = ((_BYTE)j + 1) & 0xF )
  {
    ...
    {
      VidSchiUpdateContextStatus(v58, 2LL, 6902LL);
