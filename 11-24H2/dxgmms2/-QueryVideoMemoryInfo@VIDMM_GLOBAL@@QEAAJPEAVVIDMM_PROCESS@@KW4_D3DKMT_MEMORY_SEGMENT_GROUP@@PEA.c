/*
 * XREFs of ?QueryVideoMemoryInfo@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEA_K222@Z @ 0x1400F9EB8
 * Callers:
 *     VidMmQueryVideoMemoryInfo @ 0x14003C130 (VidMmQueryVideoMemoryInfo.c)
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  char v16[8]; // [rsp+60h] [rbp-28h] BYREF
  struct _KTHREAD **v17; // [rsp+68h] [rbp-20h]
  ...
  else
  {
    ...
    result = 3221225485LL;
    WdLogGlobalForLineNumber = 26263;
  }
  return result;
}
