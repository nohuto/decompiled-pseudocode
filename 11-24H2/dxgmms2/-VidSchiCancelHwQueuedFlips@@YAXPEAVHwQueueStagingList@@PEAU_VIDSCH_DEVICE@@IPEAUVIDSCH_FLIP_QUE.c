/*
 * XREFs of ?VidSchiCancelHwQueuedFlips@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_DEVICE@@IPEAUVIDSCH_FLIP_QUEUE@@I@Z @ 0x140053C74
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v33 = *((_QWORD *)v6 + a3 + 429);
  if ( v9 > 0xC || (v10 = 4673, !_bittest(&v10, v9)) )
  {
    if ( v9 == 5 || v9 == 15 )
    {
      v11 = *(_DWORD *)((char *)a4 + v7 + 1272);
      if ( (v11 & 0x2000) != 0 )
      {
        if ( (v11 & 0x10) != 0 )
          v12 = ((unsigned __int16)**(_DWORD **)((char *)a4 + v7 + 1312) | (unsigned __int16)(**(_DWORD **)((char *)a4 + v7 + 1312) >> 10)) & 0x3FF;
        else
        ...
        if ( v12 )
        {
          do
          {
            ...
            if ( v19 )
            {
              ...
              v8 = v32;
              if ( v31 >= *(_QWORD *)(v29 + v18 + 24) && v31 <= *(_QWORD *)(304LL * v14 + v33 + 392) )
                v13 |= 1 << v14;
            }
            LODWORD(v31) = 0;
            v20 = v14;
