/*
 * XREFs of ?Commit@VIDMM_RECYCLE_RANGE@@QEAAJEPEAE@Z @ 0x1400C794C
 * Callers:
...
__int64 __fastcall VIDMM_RECYCLE_RANGE::Commit(VIDMM_RECYCLE_RANGE *this, __int64 a2, unsigned __int8 *a3)
{
  ...
  __int64 v37; // r8
  __int64 v38; // rcx
  __int64 v39; // [rsp+90h] [rbp+8h] BYREF
    ...
    if ( (_DWORD)v5 == 4 )
    {
      ...
      if ( (VIDMM_RECYCLE_RANGE *)v10[1] == (VIDMM_RECYCLE_RANGE *)((char *)this + 104) )
      {
        ...
        if ( *v11 == v4 )
        {
          ...
          *((_QWORD *)this + 12) = *(_QWORD *)(v9 + 1576) + (unsigned int)dword_1400814EC;
          v13 = v9 + 1544;
          v14 = *(__int64 ***)(v9 + 1552);
...
LABEL_45:
    ...
    if ( !dword_140081500 || *((_DWORD *)this + 20) || !g_IsInternalRelease )
    {
      LODWORD(v3) = 1;
...
LABEL_23:
    if ( !dword_140081500 || *((_DWORD *)this + 20) > (unsigned int)v3 )
    {
LABEL_25:
...
LABEL_57:
      ...
      if ( v32 )
      {
        ...
        *(_DWORD *)v37 = 2;
        *(_QWORD *)(v37 + 8) = this;
        RtlCaptureStackBackTrace(v3, 0x10u, (PVOID *)(v37 + 16), 0LL);
...
LABEL_28:
    ...
    v34 = *((_QWORD *)this + 9);
    v35 = *(_QWORD *)(v34 + 32);
    if ( (unsigned int)(*(_DWORD *)v35 - 3) <= 3 )
    {
      v36 = *(_QWORD *)(v34 + 56);
LABEL_66:
      McTemplateK0qxxx_EtwWriteTransfer(
        ...
        v35,
        *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v35 + 8) + 8LL) + 8LL),
        (char)this,
        v39,
        v36);
      goto LABEL_57;
...
LABEL_79:
  ...
  v15 = *((_QWORD *)this + 9);
  v3 = 1LL;
  v39 = *((_QWORD *)this + 5) - *((_QWORD *)this + 4);
  v16 = **(_DWORD **)(v15 + 32);
  ...
  {
    if ( !dword_140081500 || !*((_DWORD *)this + 20) )
      goto LABEL_56;
    goto LABEL_77;
  }
