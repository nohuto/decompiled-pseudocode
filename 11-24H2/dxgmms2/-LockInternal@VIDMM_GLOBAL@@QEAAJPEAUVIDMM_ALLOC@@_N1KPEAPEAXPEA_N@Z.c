/*
 * XREFs of ?LockInternal@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@_N1KPEAPEAXPEA_N@Z @ 0x1400D9100
 * Callers:
        ...
        bool *a7)
{
  ...
  if ( *(_BYTE *)(*((_QWORD *)this + 3) + 3053LL) || *(_BYTE *)(*((_QWORD *)this + 2) + 1025LL) )
  {
    ...
    result = 3221226166LL;
    WdLogGlobalForLineNumber = 22480;
  }
  else
  {
    v11 = *a2;
    ...
    if ( !*((_DWORD *)v12 + 46) )
    {
      ...
      if ( (*(_DWORD *)(v13 + 56) & 0x10) == 0 )
      {
        ...
        {
          WdLogSingleEntry1(3LL, a2);
          WdLogGlobalForLineNumber = 22521;
