/*
 * XREFs of ?TrimAllMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAXXZ @ 0x140110258
 * Callers:
...
void __fastcall VIDMM_SEGMENT::TrimAllMarkedForEvictionAllocations(VIDMM_PHYSICAL_ADAPTER **this)
{
  ...
  for ( i = this + 27;
        (_QWORD *)*i != i;
        VIDMM_PHYSICAL_ADAPTER::EvictResources(this[4], *(struct VIDMM_PHYSICAL_ALLOC **)(*i - 264LL), 1, 0, 0, 0LL) )
  {
    ;
  }
}
