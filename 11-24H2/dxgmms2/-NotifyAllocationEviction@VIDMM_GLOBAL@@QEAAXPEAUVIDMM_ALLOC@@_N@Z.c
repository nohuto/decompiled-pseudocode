/*
 * XREFs of ?NotifyAllocationEviction@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@_N@Z @ 0x1400AC484
 * Callers:
...
void __fastcall VIDMM_GLOBAL::NotifyAllocationEviction(VIDMM_GLOBAL *this, VIDMM_DEVICE **a2, bool a3)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this) + 24) = a2;
    WdLogGlobalForLineNumber = 13010;
  }
  VIDMM_DEVICE::RemoveCommitment(a2[1], (struct VIDMM_ALLOC *)a2, a3);
  if ( !*((_DWORD *)v6 + 19)
    && !_bittest((const signed __int32 *)v6[49], 0x1Eu)
    && !*(_DWORD *)(v6[49] + 16)
    && (*(_DWORD *)v6[49] & 0x20000) == 0
