/*
 * XREFs of ?VidMmReferenceDisplayingAllocation@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_DISPLAYING_ALLOCATION@@_K2@Z @ 0x140039134
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    if ( a3 && (int)VidSchiSignalSyncObjectsFromCpu(a1, 1u, v7, 0, (char *)&v13, 0LL) < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 30418;
