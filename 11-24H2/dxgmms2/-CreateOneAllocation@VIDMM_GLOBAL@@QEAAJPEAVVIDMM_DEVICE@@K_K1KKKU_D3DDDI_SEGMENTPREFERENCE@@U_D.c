/*
 * XREFs of ?CreateOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@K_K1KKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@U_DXGK_ALLOCATIONINFOFLAGS2@@PEBVDXGADAPTERALLOCATION@@PEAX6KE6PEAVVIDMM_PAGE_TABLE_BASE@@PEAPEAUVIDMM_CROSSADAPTER_ALLOC@@PEAPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400DCBA4
 * Callers:
 ...
 *     ??0VIDMM_GLOBAL_ALLOC@@QEAA@XZ @ 0x140037E10 (--0VIDMM_GLOBAL_ALLOC@@QEAA@XZ.c)
 ...
 *     ?VerifySegmentSetAtLeastOneInMask@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z @ 0x1400F10D0 (-VerifySegmentSetAtLeastOneInMask@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z.c)
 *     ?VerifySegmentSetAny@VIDMM_GLOBAL@@QEAAEKKK@Z @ 0x1400F1274 (-VerifySegmentSetAny@VIDMM_GLOBAL@@QEAAEKKK@Z.c)
 ...
 *     ?CheckForCpuVisibleMemorySegment@VIDMM_GLOBAL@@QEAAEKK@Z @ 0x1400F5AF0 (-CheckForCpuVisibleMemorySegment@VIDMM_GLOBAL@@QEAAEKK@Z.c)
 *     ?AddAllocation@VIDMM_TELEMETRY_PROCESS_ALLOCATED_CONTENT@@QEAAX_K@Z @ 0x1400F6E88 (-AddAllocation@VIDMM_TELEMETRY_PROCESS_ALLOCATED_CONTENT@@QEAAX_K@Z.c)
...
LABEL_165:
  ...
  {
    v64 = (VIDMM_GLOBAL_ALLOC *)operator new(400LL, 0x31306956u, 256LL);
    if ( !v64 )
      goto LABEL_367;
...
LABEL_228:
  ...
  *((_QWORD *)v62 + 49) = v65;
  if ( !v65 )
  {
    _InterlockedAdd(&dword_1400817CC, 1u);
...
LABEL_259:
    ...
    if ( v83 )
    {
      if ( *(_QWORD *)(v83 + 32) )
      {
        ...
        {
          v85 = *(struct _VIDSCH_SYNC_OBJECT **)(i + *(_QWORD *)(*((_QWORD *)v62 + 49) + 32LL));
          if ( v85 )
            VidSchDestroySyncObject(v85, v68);
        }
        operator delete(*(void **)(*((_QWORD *)v62 + 49) + 32LL));
      }
      v86 = *(int **)(*((_QWORD *)v62 + 49) + 24LL);
      if ( v86 )
        VIDMM_FLIP_QUEUE_REFERENCES::ReleaseReference(v86);
      operator delete(*((void **)v62 + 49));
    }
    v87 = (KSPIN_LOCK *)*((_QWORD *)v62 + 45);
    if ( !v87 )
      goto LABEL_276;
    VIDMM_GLOBAL::FreeCrossAdapterDataDpc((VIDMM_GLOBAL *)v69, v87, v62);
    v69 = (struct VIDMM_CROSSADAPTER_ALLOC **)(unsigned int)_InterlockedDecrement(*((volatile signed __int32 **)v62 + 45));
    if ( !(_DWORD)v69 )
    {
      v88 = *(struct _VIDMM_POOL_BLOCK **)(*((_QWORD *)v62 + 45) + 48LL);
      if ( v88 )
        VIDMM_GLOBAL::FreePhysical(v88);
      VIDMM_GLOBAL::DestroyCrossAdapterAllocation(v88, *((struct VIDMM_CROSSADAPTER_ALLOC **)v62 + 45));
      v69 = a19;
      *a19 = 0LL;
      goto LABEL_276;
    }
...
LABEL_276:
    ...
    v143 = (int *)*((_QWORD *)v62 + 45);
    v144 = *v143;
    g_DxgMmsBugcheckExportIndex = 1;
    WdLogSingleEntry5(0LL, 270LL, 66LL, v143, v144, 0LL);
    WdLogGlobalForLineNumber = 195;
LABEL_367:
    _InterlockedAdd(&dword_1400816B4, 1u);
    WdLogSingleEntry0(6LL);
    WdLogGlobalForLineNumber = 3212;
    DxgkLogInternalTriageEvent(0LL, 262145LL);
    return 3221225495LL;
  }
  if ( !*(_BYTE *)(*(_QWORD *)(*((_QWORD *)v25 + 2) + 744LL) + 57LL) || (Value & 0x80000) != 0 )
  {
    *(_QWORD *)(*((_QWORD *)v62 + 49) + 24LL) = operator new[](12LL, 0x33306956u, 64LL);
    v77 = *(volatile signed __int32 **)(*((_QWORD *)v62 + 49) + 24LL);
    if ( !v77 )
    {
      _InterlockedAdd(&dword_1400816AC, 1u);
      WdLogSingleEntry0(6LL);
      v67 = 3294;
      goto LABEL_230;
    }
    ...
    Value = v153.Value;
    v43 = v160;
    *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v62 + 49) + 24LL) + 4LL) = -((v153.Value & 0x100000) == 0);
  }
  else if ( (Value & 0x40000000) != 0 || (Value & 0x80000000) != 0 )
  {
    *(_QWORD *)(*((_QWORD *)v62 + 49) + 32LL) = operator new(168LL, 0x33306956u, 64LL);
    if ( !*(_QWORD *)(*((_QWORD *)v62 + 49) + 32LL) )
    {
      _InterlockedAdd(&dword_1400816AC, 1u);
      WdLogSingleEntry0(6LL);
      v67 = 3242;
...
LABEL_257:
  ...
  *((_DWORD *)v62 + 7) = v98;
  if ( v94 )
    *((_QWORD *)v62 + 50) = VIDMM_PROCESS::GetVmwpProcess(*(VIDMM_PROCESS **)(a2 + 8));
  v99 = 0;
  v178 = 0;
  if ( (Value & 1) != 0 )
  {
  ...
  *(_QWORD *)v62 = PhysicalAllocation;
  ...
  {
    if ( !dword_1400815E4 && (*(_BYTE *)(v108 + 36) & 1) == 0 )
      goto LABEL_328;
    v110 = *((_QWORD *)a1 + 3);
    v157 = (VIDMM_PHYSICAL_ADAPTER **)v62;
    ...
    {
      v157 = (VIDMM_PHYSICAL_ADAPTER **)v62;
      if ( dword_1400815E4 != 2 )
        goto LABEL_328;
    }
    if ( ((v112 = *((_QWORD *)v106 + 2), !(_WORD)v112) || v112 > (unsigned int)dword_1400815E8) && !v178 )
      v113 = 256;
    else
LABEL_328:
      v113 = 0;
  ...
  *((_DWORD *)v62 + 6) = v120 & 0xFFFFFEFF | (a18 != 0 ? 0x100 : 0);
  ...
  v129 = v166;
  *((_QWORD *)v62 + 44) = *(_QWORD *)(v166 + 40) + 384LL * v128;
  _InterlockedAdd((volatile signed __int32 *)(v129 + 36), 1u);
  if ( *(_DWORD *)(v129 + 32)
    || (v130 = **((_DWORD **)v62 + 49), (v130 & 0x2003A) != 0)
