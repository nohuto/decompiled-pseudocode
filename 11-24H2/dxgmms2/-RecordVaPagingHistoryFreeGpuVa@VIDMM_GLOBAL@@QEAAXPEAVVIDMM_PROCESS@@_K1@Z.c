/*
 * XREFs of ?RecordVaPagingHistoryFreeGpuVa@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1@Z @ 0x1400FC268
 * Callers:
  ...
  if ( VIDMM_GLOBAL::GpuVaPagingHistoryFreEnabled || *((_QWORD *)this + 5124) )
  {
    ...
    *((_QWORD *)v8 + 1) = KeGetCurrentThread();
    ...
    if ( v9 )
      ...
      VaPagingHistoryEntry = operator new(32, (VIDMM_GLOBAL *)((char *)this + 41032), 0xFu, 0);
