/*
 * XREFs of ?QueryProcessStatistics@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_INFORMATION@@@Z @ 0x140102858
 * Callers:
 *     VidMmQueryProcessStatistics @ 0x1400421F0 (VidMmQueryProcessStatistics.c)
 * Callees:
 *     <none>
 */
