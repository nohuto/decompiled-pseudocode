/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXUVIDMM_PURGE_FLAGS@@PEBVVIDMM_PROCESS@@@Z @ 0x1400BC934
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1400410B0 (VidMmPurgeAllSegments.c)
 * Callees:
