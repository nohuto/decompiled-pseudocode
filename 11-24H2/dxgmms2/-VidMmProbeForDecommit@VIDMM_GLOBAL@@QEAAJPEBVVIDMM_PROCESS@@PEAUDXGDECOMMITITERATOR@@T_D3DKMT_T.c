/*
 * XREFs of ?VidMmProbeForDecommit@VIDMM_GLOBAL@@QEAAJPEBVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@@Z @ 0x140110464
 * Callers:
 *     VidMmProbeForDecommit @ 0x140044940 (VidMmProbeForDecommit.c)
 * Callees:
...
LABEL_9:
      ...
      while ( !VIDMM_GLOBAL::IsAllocationDecommitCandidate(
                 (VIDMM_GLOBAL *)this,
                 (struct VIDMM_GLOBAL_ALLOC *)(v12 - 296),
                 v13) )
      {
