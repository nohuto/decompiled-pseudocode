/*
 * XREFs of ?Init@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1400FD520
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  else
  {
    ...
    *((_DWORD *)this + 405) = 4;
    ...
    v15 = (_QWORD *)qword_140081A90;
    v16 = (_QWORD *)((char *)this + 1600);
    if ( *(struct _LIST_ENTRY **)qword_140081A90 != &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead )
      __fastfail(3u);
    *v16 = &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    v16[1] = v15;
    *v15 = v16;
    qword_140081A90 = (__int64)v16;
