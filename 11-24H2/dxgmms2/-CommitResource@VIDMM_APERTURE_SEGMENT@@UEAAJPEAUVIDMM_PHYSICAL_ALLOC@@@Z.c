/*
 * XREFs of ?CommitResource@VIDMM_APERTURE_SEGMENT@@UEAAJPEAUVIDMM_PHYSICAL_ALLOC@@@Z @ 0x1400C0B80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
      ...
      if ( *((_BYTE *)this[3] + 40107) )
      {
        ...
        if ( v19 < 0 )
        {
          _InterlockedIncrement(&dword_14008182C);
    ...
    *((_QWORD *)a2 + 8) = v11;
    *((_QWORD *)a2 + 9) = v12;
    *(_WORD *)(*(_QWORD *)(v2 + 392) + 10LL) = VIDMM_SEGMENT::DriverId(v11);
    *(_QWORD *)(*(_QWORD *)(v2 + 392) + 40LL) = *((_QWORD *)a2 + 9) + *(_QWORD *)(*((_QWORD *)a2 + 8) + 48LL);
    *((_QWORD *)a2 + 13) = 0LL;
    *((_QWORD *)a2 + 12) = 0LL;
    *(_DWORD *)(v2 + 32) &= ~8u;
    v13 = *(_QWORD *)(v2 + 48);
