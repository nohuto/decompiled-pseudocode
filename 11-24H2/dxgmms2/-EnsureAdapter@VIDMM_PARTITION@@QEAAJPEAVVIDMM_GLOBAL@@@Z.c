/*
 * XREFs of ?EnsureAdapter@VIDMM_PARTITION@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x14009C6B0
 * Callers:
 ...
 *     ?CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x14009C5A4 (-CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_AD.c)
 */
...
__int64 __fastcall VIDMM_PARTITION::EnsureAdapter(VIDMM_PARTITION *this, unsigned int **a2)
{
  ...
  else
  {
    ...
    {
LABEL_8:
      _InterlockedAdd(&dword_140081808, 1u);
