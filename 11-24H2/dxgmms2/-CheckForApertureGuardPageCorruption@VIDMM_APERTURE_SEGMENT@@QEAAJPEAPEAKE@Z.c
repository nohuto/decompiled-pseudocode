/*
 * XREFs of ?CheckForApertureGuardPageCorruption@VIDMM_APERTURE_SEGMENT@@QEAAJPEAPEAKE@Z @ 0x14004428C
 * Callers:
        ...
        char a3)
{
  ...
  v3 = (unsigned int *)*((_QWORD *)this + 70);
  v5 = v3;
  if ( !a3 || !dword_1400812E4 )
  {
    for ( i = 0; i < 0x400; ++i )
    {
      if ( *v5 != 1685217607 )
  ...
  if ( *v3 == 1685217607 )
  {
    ...
    if ( v3[1023] == 1685217607 )
    {
      ...
      if ( v3[512] == 1685217607 )
      {
        ...
        if ( !v9 )
          v9 = *((_QWORD *)v8 + 1) - qword_1400810E8;
        if ( v9 )
        {
          ...
          dword_1400812E4 = 0;
          v11 = (_DWORD *)*((_QWORD *)this + 70);
          for ( j = 1024LL; j; --j )
            *v11++ = 1685217607;
        }
        else
        {
          *((_QWORD *)this + 72) = v7 + 16;
