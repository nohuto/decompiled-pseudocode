/*
 * XREFs of ?UpdateWorkingSets@VIDMM_PHYSICAL_ADAPTER@@QEAAXJ@Z @ 0x1400BA830
 * Callers:
...
void __fastcall VIDMM_PHYSICAL_ADAPTER::UpdateWorkingSets(VIDMM_PHYSICAL_ADAPTER *this, unsigned int a2)
{
  ...
  for ( i = 0; (unsigned int)i < *((_DWORD *)this + 16); ++i )
  {
    ...
    {
      v4 = v3[9] - v3[12];
      v3[20] = v4 * (unsigned __int64)(unsigned int)dword_140081420 / 0x64 / a2;
      v3[21] = v4 * (unsigned __int64)(unsigned int)dword_140081424 / 0x64 / a2;
    }
  }
}
