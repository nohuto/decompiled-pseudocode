/*
 * XREFs of VidMmDestroyPagingQueue_0 @ 0x1400FE5C0
 * Callers:
 ...
 *     ?RemovePagingQueueList@VIDMM_DEVICE@@QEAAXPEAU_LIST_ENTRY@@@Z @ 0x14003DED8 (-RemovePagingQueueList@VIDMM_DEVICE@@QEAAXPEAU_LIST_ENTRY@@@Z.c)
...
void __fastcall VidMmDestroyPagingQueue_0(struct VIDMM_PAGING_QUEUE *a1)
{
  ...
  struct VIDMM_WORKER_THREAD *v3; // rbx
  unsigned int v4; // ecx
