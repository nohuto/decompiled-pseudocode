/*
 * XREFs of ?TransferDirtyContentForLiveMigration@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DIRTY_BITPLANE@@W4_DXGK_GPUP_MIGRATIONTYPE@@PEAVVIDMM_TRANSPORT_BUFFER@@PEA_K@Z @ 0x1400961EC
 * Callers:
 *     VidMmTransferDirtyContentForLiveMigration @ 0x14004C030 (VidMmTransferDirtyContentForLiveMigration.c)
 * Callees:
