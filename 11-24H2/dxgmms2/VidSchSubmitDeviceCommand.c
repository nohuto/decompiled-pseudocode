/*
 * XREFs of VidSchSubmitDeviceCommand @ 0x140033344
 * Callers:
...
__int64 __fastcall VidSchSubmitDeviceCommand(_QWORD *a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a2 + 40) )
  {
    ...
    if ( *(_DWORD *)(a2 + 40) == 3 )
    {
      ...
      if ( v30 )
      {
        if ( *(_QWORD **)(v30 + 8) != v29 || (v34 = (_QWORD *)v28[30], (_QWORD *)*v34 != v29) )
LABEL_18:
          __fastfail(3u);
        *v34 = v30;
        *(_QWORD *)(v30 + 8) = v34;
...
LABEL_50:
  ...
  *(_BYTE *)v7 = 1;
  ...
  if ( !*(_DWORD *)a2 )
  {
    if ( !*(_DWORD *)(v8 + 172) && !*(_DWORD *)(v8 + 104) )
      v2 = (*(_BYTE *)(v8 + 25) & 1) == 0
