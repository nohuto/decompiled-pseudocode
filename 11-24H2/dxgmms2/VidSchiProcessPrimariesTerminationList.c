/*
 * XREFs of VidSchiProcessPrimariesTerminationList @ 0x140033250
 * Callers:
...
void __fastcall VidSchiProcessPrimariesTerminationList(__int64 a1)
{
  ...
  if ( *v3 != v3 )
  {
    ...
    {
      v5 = (_QWORD *)*v4;
      if ( (unsigned int)VidSchiCheckConditionDeviceCommand(v2, v4 - 27) )
      {
        v7 = *v6;
        ...
        *v8 = v7;
        *(_QWORD *)(v7 + 8) = v8;
        VidMmAddPendingTermination((struct VIDMM_ALLOC *)(v6 - 27));
      }
      v4 = v5;
    }
    while ( v5 != v3 );
