/*
 * XREFs of ?PurgeSegments@VIDMM_PHYSICAL_ADAPTER@@QEAAXPEAVVIDMM_GLOBAL@@PEAU1@UVIDMM_PURGE_FLAGS@@PEAUVIDMM_PURGE_STATISTICS@@PEBVVIDMM_PROCESS@@@Z @ 0x1400D644C
 * Callers:
 ...
 *     ?ValidateFrameBufferRotation@VIDMM_MEMORY_SEGMENT@@QEAAXXZ @ 0x140102704 (-ValidateFrameBufferRotation@VIDMM_MEMORY_SEGMENT@@QEAAXXZ.c)
    ...
    else
    {
      ...
      if ( *((_DWORD *)v10 + 10048) == -1 )
      {
        v15 = (_DWORD *)((char *)v10 + 40192);
             ...
             || (v15 = (_DWORD *)((char *)v10 + 40192), *(_QWORD *)(v14 + 272) <= (unsigned __int64)qword_1400815D8) )
      {
        v15 = (_DWORD *)((char *)v10 + 40192);
        if ( !v13 )
        {
          v17 = 0;
LABEL_46:
          if ( *v16 != -1 && *(_QWORD *)(v14 + 272) <= (unsigned __int64)qword_1400815D8 )
          {
            v18 = 0;
            if ( !v13 )
              goto LABEL_6;
...
LABEL_6:
    ...
    if ( (v20 & 0x1001) == 0
      ...
      && *((_DWORD *)v10 + 10048) != -1
      && (a4 & 0x80u) == 0
      && *(_QWORD *)(v19 + 272) > (unsigned __int64)qword_1400815D8
      && !v13
      && (v20 & 0x80u) != 0
      && (a4 & 0x20) != 0 )
    {
