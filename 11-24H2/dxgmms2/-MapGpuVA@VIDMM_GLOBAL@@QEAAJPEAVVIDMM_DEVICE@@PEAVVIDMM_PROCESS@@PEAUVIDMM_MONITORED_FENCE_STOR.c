/*
 * XREFs of ?MapGpuVA@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@PEA_KI_N@Z @ 0x1400F94DC
 * Callers:
 *     VidMmMapGpuVA @ 0x14003E580 (VidMmMapGpuVA.c)
 *     VidMmMapPagingProcessGpuVA @ 0x140041720 (VidMmMapPagingProcessGpuVA.c)
