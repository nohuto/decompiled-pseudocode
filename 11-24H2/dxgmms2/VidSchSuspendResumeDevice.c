/*
 * XREFs of VidSchSuspendResumeDevice @ 0x140020380
 * Callers:
...
void __fastcall VidSchSuspendResumeDevice(__int64 a1, char a2, char a3, int a4)
{
  __int64 v4; // rsi
    ...
    if ( !a2 )
    {
      if ( (v16 & 0x100) != 0 && (!a3 || (v15[23] & 0x800) != 0) )
      {
        ...
        *((_DWORD *)v15 + 46) &= ~0x800u;
        v12 = VidSchiUnwaitContext((__int64)(v13 - 3), 0x10B0u) | v20;
        v20 = v12;
      }
      goto LABEL_34;
    }
...
LABEL_21:
            ...
            {
              VidSchiUpdateContextStatus(v19, 9, 4223LL);
...
LABEL_28:
            ...
            VidSchiUpdateContextStatus(v19, 10, 4232LL);
