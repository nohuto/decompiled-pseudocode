/*
 * XREFs of ?VidSchiSubmitDisablePlanesFlip@@YAJPEAU_VIDSCH_DEVICE@@I@Z @ 0x14001C74C
 * Callers:
...
__int64 __fastcall VidSchiSubmitDisablePlanesFlip(struct _VIDSCH_DEVICE *a1, unsigned int a2)
{
  ...
  if ( Entry )
  {
    ...
    *v10 ^= (*v10 ^ (((1 << *(_DWORD *)(v2 + 152)) - 1) << 10)) & 0xFFC00;
    ...
    v18 = *(_DWORD *)(v17 + 1272) | 0x10;
    *(_QWORD *)(v17 + 1160) = a1;
    *(_DWORD *)(v17 + 1272) = v18;
    *(_DWORD *)(v17 + 1176) = *((_DWORD *)a1 + v5 + 127);
    *(_DWORD *)(v17 + 1272) = v18 | 0x180;
    v19 = *(void **)(v17 + 1312);
    *(_DWORD *)(v17 + 1192) = 0;
    memmove(v19, Src, Src[3]);
    v20 = v36;
    *(_DWORD *)(v7 + 56) = ((_BYTE)v36 + 1) & 0x3F;
    ...
    *(_DWORD *)(v17 + 1172) = 4;
    ...
    v33 = 0;
    v35 = 0;
    v22 = VidSchiExecuteMmIoFlip(&v27, v2, v34, v7, v20, &v35, &v33);
    if ( v33 )
      v22 = VidSchiExecuteMmIoFlip(&v27, v2, v21, v7, v20, &v35, &v33);
    if ( !v29 )
    {
      if ( v30 )
  ...
  {
    _InterlockedAdd(&dword_140081910, 1u);
    WdLogSingleEntry1(6LL, 23099LL);
    WdLogGlobalForLineNumber = 23099;
