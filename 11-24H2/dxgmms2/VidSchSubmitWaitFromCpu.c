/*
 * XREFs of VidSchSubmitWaitFromCpu @ 0x14000DF30
 * Callers:
 ...
 * Callees:
 *     ??_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z @ 0x14000CF34 (--_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z.c)
...
LABEL_48:
    ...
    WdLogGlobalForLineNumber = 11700;
LABEL_43:
    v31 = P;
    if ( P == v56 )
      return 3221225495LL;
  ...
  if ( !v14 )
  {
    WdLogSingleEntry0(3LL);
    v31 = P;
    WdLogGlobalForLineNumber = 11711;
    if ( P == v56 )
      return 3221225495LL;
LABEL_40:
    if ( v31 )
