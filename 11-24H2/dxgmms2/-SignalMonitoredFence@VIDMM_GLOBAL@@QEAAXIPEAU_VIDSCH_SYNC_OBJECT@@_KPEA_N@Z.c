/*
 * XREFs of ?SignalMonitoredFence@VIDMM_GLOBAL@@QEAAXIPEAU_VIDSCH_SYNC_OBJECT@@_KPEA_N@Z @ 0x140110C24
 * Callers:
 ...
 *     VidSchGetDriverPagingHwQueue @ 0x1400510E4 (VidSchGetDriverPagingHwQueue.c)
        ...
        bool *a5)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 2) + 744LL) + 55LL)
    && !*((_BYTE *)this + 7016)
    && *((_QWORD *)this + a2 + 143)
    && (*(_DWORD *)(*((_QWORD *)this + a2 + 79) + 28LL) & 4) != 0
    && *((_QWORD *)this + a2 + 804) )
  {
    if ( *((struct _VIDSCH_SYNC_OBJECT **)this + a2 + 740) == a3 )
    {
      v8 = 1;
      if ( *((_BYTE *)this + a2 + 4569) )
      {
        *a5 = 1;
        return;
      }
      *((_BYTE *)this + a2 + 4569) = 1;
    }
    else
    {
      v8 = 0;
