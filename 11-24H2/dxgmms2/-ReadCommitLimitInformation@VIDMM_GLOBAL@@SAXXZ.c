/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@SAXXZ @ 0x140108F10
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_140081628 = v1;
  dword_14008162C = v6 << 20;
  dword_140081630 = v2;
  dword_140081634 = v3;
  if ( !v0 )
    qword_140081310 = (unsigned __int64)qword_1400812F8 >> 3;
}
