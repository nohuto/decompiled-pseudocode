/*
 * XREFs of McTemplateK0pqqpxpp_EtwWriteTransfer @ 0x14003C174
 * Callers:
...
NTSTATUS McTemplateK0pqqpxpp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventWaitQueueSubmit2, a3, 8u, &v4);
}
