/*
 * XREFs of ?VidSchiSelectContextFromThisPriority@@YAPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_NODE@@K_N@Z @ 0x140017290
 * Callers:
 ...
 *     VidSchiIsQuantumLeft @ 0x140036658 (VidSchiIsQuantumLeft.c)
