/*
 * XREFs of ?TrimOfferCommitmentInternal@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@_KPEA_K@Z @ 0x14010A030
 * Callers:
 ...
 *     ?IsAllocationDecommitCandidate@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_GLOBAL_ALLOC@@_N@Z @ 0x140106140 (-IsAllocationDecommitCandidate@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_GLOBAL_ALLOC@@_N@Z.c)
 */
        ...
        unsigned __int64 *a6)
{
  ...
  WdLogGlobalForLineNumber = 26996;
  if ( (v6 & 1) != 0 )
  {
    v7 = (unsigned int)(dword_1400815F0 << 20);
    if ( a5 < v7 )
      v7 = a5;
  }
  ...
  if ( v12 && *(_QWORD *)(v12 + 200) == *(_QWORD *)a3 )
  {
    ...
    if ( v14 != v13 )
    {
      ...
      do
      {
        v21 = (struct VIDMM_GLOBAL_ALLOC *)(v14 - 37);
        *((_QWORD *)a3 + 3) = *v14;
        v16 = 0;
        if ( VIDMM_GLOBAL::IsAllocationDecommitCandidate(
               (VIDMM_GLOBAL *)this,
               (struct VIDMM_GLOBAL_ALLOC *)(v14 - 37),
               v15) )
        {
          this[5598] = (struct _KTHREAD *)(v14 - 37);
          v17 = *v14;
    ...
    *a6 = v11;
    ...
    WdLogGlobalForLineNumber = 27079;
  }
