/*
 * XREFs of VidSchiSubmitMmIoFlipCommand @ 0x1400124E0
 * Callers:
...
LABEL_26:
  ...
  *((_DWORD *)v26 + 319) = v63;
  ...
  if ( v131 )
  {
    *((_DWORD *)v26 + 293) = 7;
LABEL_110:
    VidSchiUpdateFlipQueueHistory(0LL, v6, v120, v9, v121);
LABEL_91:
    *((_DWORD *)v2 + 16) |= 2u;
    if ( v148 )
  ...
  while ( 1 )
  {
    ...
    *((_DWORD *)v74 + 263) = 2;
    ...
    if ( v121 == v85 )
    {
      if ( *(_BYTE *)(v6 + 156) && VidSchiCheckPendingFlipsForThisEntry((struct _VIDSCH_GLOBAL *)v6, v1, v124, v9) )
      {
        if ( !*(_BYTE *)(v6 + 59) )
      ...
      *((_DWORD *)v124 + 263) = 4;
      VidSchiUpdateFlipQueueHistory(0LL, v6, v120, v9, v121);
      VidSchiExecuteMmIoFlip(&v126, v6, v120, v9, v121, &v148, &v149);
      if ( (_BYTE)v149 )
      {
        v111 = &v149;
LABEL_197:
        VidSchiExecuteMmIoFlip(&v126, v6, v120, v9, v121, &v148, v111);
      }
    }
LABEL_123:
...
LABEL_90:
  ...
  if ( v121 == v85 || *((_BYTE *)v124 + 1076) )
  {
    if ( !*(_BYTE *)(v6 + 59) )
      *((_QWORD *)v124 + 138) = MEMORY[0xFFFFF78000000320];
    if ( VidSchiCheckPendingFlipsForThisEntry((struct _VIDSCH_GLOBAL *)v6, v1, v124, v9) )
      goto LABEL_123;
    v86 = v124;
    if ( *((_BYTE *)v124 + 1076) )
    {
    ...
    *((_DWORD *)v86 + 263) = 4;
    ...
    v84 = 0;
    VidSchiUpdateFlipQueueHistory(0LL, v6, v120, v9, v121);
    VidSchiExecuteMmIoFlip(&v126, v6, v120, v9, v121, &v148, &v150);
    if ( v150 )
    {
...
LABEL_178:
  ...
  VidSchiUpdateContextStatus(v1, 3LL, 3363LL);
  HwQueueStagingList::ProcessHwQueues((HwQueueStagingList *)&v126, 0LL);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  KeLowerIrql((KIRQL)v9);
  if ( v8 != -1 )
