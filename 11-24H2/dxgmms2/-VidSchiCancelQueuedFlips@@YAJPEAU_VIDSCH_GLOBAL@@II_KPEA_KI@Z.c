/*
 * XREFs of ?VidSchiCancelQueuedFlips@@YAJPEAU_VIDSCH_GLOBAL@@II_KPEA_KI@Z @ 0x140053EB4
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (byte_140081244 & 4) != 0 )
    McTemplateK0pqqqQR3XR3XR3XR3q_EtwWriteTransfer(a6, v11 + v12 + 416, v11 + v12 + 408, *((_QWORD *)a1 + 2), v7, v10);
  return v10;
}
