/*
 * XREFs of InitializePhysicalAdapterSegments @ 0x14010BB70
 * Callers:
 ...
 *     ??0VIDMM_SEGMENT@@QEAA@PEAUVIDMM_PHYSICAL_ADAPTER@@GGPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z @ 0x14009D730 (--0VIDMM_SEGMENT@@QEAA@PEAUVIDMM_PHYSICAL_ADAPTER@@GGPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z.c)
    ...
    if ( v12 >= a6 )
    {
      ...
      for ( i = 0; ; ++i )
      {
        ...
        *(_QWORD *)(v40 + 72) = v42;
        ...
        if ( v47 < 0 )
        {
          _InterlockedAdd(&dword_140081760, 1u);
...
LABEL_44:
  if ( (v18 & 0x1000) != 0 )
  {
    _InterlockedAdd(dword_140081764, 1u);
    WdLogSingleEntry2(6LL, a5, v20);
    WdLogGlobalForLineNumber = 415;
  }
  else if ( (v18 & 1) != 0 )
  {
    _InterlockedAdd(&dword_14008175C, 1u);
    WdLogSingleEntry2(6LL, a5, v20);
    WdLogGlobalForLineNumber = 422;
  }
  else
  {
    _InterlockedAdd(&dword_140081738, 1u);
    WdLogSingleEntry2(6LL, a5, v20);
