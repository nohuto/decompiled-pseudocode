/*
 * XREFs of ?UncommitLocalBackingStore@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_LOCAL_ALLOC@@_N@Z @ 0x1400D8E2C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::UncommitLocalBackingStore(VIDMM_GLOBAL *this, struct VIDMM_LOCAL_ALLOC *a2, char a3)
{
  ...
  if ( (v10 & 0x4000) == 0
    ...
    && (v10 & 0x800) == 0
    && ((v10 & 0x80000) != 0 || (**(_DWORD **)(v5 + 392) & 0x40000) != 0) )
  {
    if ( a3 )
    {
      v17 = *((_QWORD *)a2 + 2);
  ...
  if ( (v11 & 0x80000) != 0 )
  {
    if ( (v12 & 0x400000) == 0 && *((_QWORD *)a2 + 11) )
    {
      ...
      v16 = *((_QWORD *)a2 + 11);
      WdLogGlobalForLineNumber = 28299;
  ...
  else if ( (v12 & 8) == 0 && (v12 & 0x20000) == 0 && (v12 & 0x10) == 0 && (v12 & 0x20) == 0 )
  {
    ...
    if ( v13 )
    {
      if ( a3 )
      {
        ...
        {
          v21 = (*(__int64 (__fastcall **)(_QWORD, VIDMM_GLOBAL *, __int64, __int64, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD))(**(_QWORD **)(v5 + 240) + 48LL))(
                  *(_QWORD *)(v5 + 240),
                  this,
                  v13,
                  3LL,
        ...
        (*(void (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(v5 + 240) + 24LL))(
          *(_QWORD *)(v5 + 240),
          *(_QWORD *)(v5 + 248));
        *(_QWORD *)(v5 + 248) = 0LL;
      }
