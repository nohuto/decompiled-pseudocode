/*
 * XREFs of VidMmUnreferencePrimaryAllocation @ 0x14004C070
 * Callers:
 *     <none>
 * Callees:
 *     ?DecrementPresentReferences@VIDMM_GLOBAL_ALLOC_NONPAGED@@QEAAXXZ @ 0x14003C230 (-DecrementPresentReferences@VIDMM_GLOBAL_ALLOC_NONPAGED@@QEAAXXZ.c)
 */
