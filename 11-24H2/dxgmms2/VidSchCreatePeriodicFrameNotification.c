...
LABEL_9:
    ...
    *(_QWORD *)(Pool2 + 16) = v23;
    ...
    {
      DWORD2(v38) = *(_DWORD *)(4024 * v7 + *(_QWORD *)(*(_QWORD *)(v22 + 3120) + 128LL) + 1072);
    ...
    if ( v27 == 2 )
    {
      ...
      v10 = 1;
      WdLogGlobalForLineNumber = 14553;
      v13 = -1073741822;
      goto LABEL_35;
    }
    if ( v27 != 1 )
    {
      WdLogSingleEntry1(3LL, v13);
      WdLogGlobalForLineNumber = 14560;
    ...
    *(_QWORD *)(Pool2 + 40) = Timer;
    if ( !Timer )
    {
      ...
      WdLogGlobalForLineNumber = 14575;
      DxgkLogInternalTriageEvent(
        v32,
        0x40000,
        v33,
