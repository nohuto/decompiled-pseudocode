/*
 * XREFs of ?BuildMdlFromRange@VIDMM_CPU_HOST_APERTURE@@QEBAPEAU_MDL@@PEAXPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@_K2@Z @ 0x1400C00E0
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  {
    _InterlockedIncrement(dword_140081790);
