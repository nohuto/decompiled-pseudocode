/*
 * XREFs of ?ProcessDeferredCommand@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_DEFERRED_COMMAND@@PEA_N_N_KPEAU_VIDSCH_SYNC_OBJECT@@2PEAPEAUVIDMM_ALLOC@@@Z @ 0x1400E11C8
 * Callers:
 ...
 *     ?DecrementPagingPacketReferenceCount@VIDMM_ALLOC@@QEAAXXZ @ 0x1400372DC (-DecrementPagingPacketReferenceCount@VIDMM_ALLOC@@QEAAXXZ.c)
 *     ?DecrementBudgetCounter@@YAXPEAXPEA_K_K@Z @ 0x140038328 (-DecrementBudgetCounter@@YAXPEAXPEA_K_K@Z.c)
 *     NeedsApertureForLock @ 0x140038618 (NeedsApertureForLock.c)
 ...
 *     ?TransferAllocationDecommit@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@PEAUVIDMM_LOCAL_ALLOC@@1@Z @ 0x1400D7D8C (-TransferAllocationDecommit@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@PEAUVIDMM_LOCAL_ALLOC@@1@.c)
 ...
 *     ?FindNewAllocOwner@VIDMM_GLOBAL@@QEAAPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400D9844 (-FindNewAllocOwner@VIDMM_GLOBAL@@QEAAPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@@Z.c)
        ...
        struct VIDMM_ALLOC **a8)
{
  ...
  __int64 v92; // r8
  _QWORD *v93; // r12
  union _LARGE_INTEGER v94; // r15
  _QWORD *v95; // rdi
  __int64 v96; // rcx
  __int64 v97; // rcx
  VIDMM_SEGMENT *v98; // rcx
  ...
  struct _VIDSCH_SYNC_OBJECT *v109; // rcx
  ...
  struct VIDMM_LOCAL_ALLOC *v126; // [rsp+90h] [rbp-70h]
  ...
  *a8 = 0LL;
  ...
  v132 = a2;
  v136 = a6;
  v126 = (struct VIDMM_LOCAL_ALLOC *)a8;
  v135 = v12;
  v124 = 0LL;
  ...
  if ( (int)v24 > 209 )
  {
    switch ( (_DWORD)v24 )
    {
      case 0xD2:
        ...
        if ( v110 < 2u )
        {
          v112 = VIDMM_GLOBAL::PageInOneAllocation((__int64)v9, (_DWORD *)v12, 0, a7, a3, a8, v111, -1LL);
          *(_DWORD *)(v11 + 28) &= ~0x40u;
          v16 = v112;
        }
        goto LABEL_222;
      case 0xD3:
        v104 = (_QWORD **)(*((_QWORD *)v10 + 4) + 112LL);
        ...
        goto LABEL_221;
      case 0xD4:
        VIDMM_GLOBAL::UpdateAllocationPriority(v9, (struct _KTHREAD ****)v12, *((_DWORD *)v10 + 8));
        goto LABEL_221;
      case 0xD5:
        ...
        if ( !v15[23] )
        {
          v102 = (struct _KTHREAD **)(*v15 + 11138);
          v119 = 1;
          DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v137, v102);
        ...
        if ( v12 )
        {
          if ( (*(_DWORD *)(v12 + 28) & 3) == 2 )
            VIDMM_GLOBAL::FaultOneAllocation((VIDMM_GLOBAL *)*v15, (VIDMM_DEVICE **)v12);
        }
        else
        {
        ...
        if ( v101 )
        {
          ...
          VIDMM_GLOBAL::RemoveFromPenaltyBoxByListEntry(v103, (struct _LIST_ENTRY *)(v15 + 23));
          DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v137);
        }
        goto LABEL_221;
    }
    ...
    if ( (_BYTE)v63 )
    {
      ...
      {
        VidMmSuspendAccessToAllocation(*(VIDMM_GLOBAL ***)v9, (struct VIDMM_GLOBAL_ALLOC *)v11);
...
LABEL_174:
      ...
      if ( v79 != v81 )
      {
                ...
                v125) )
        {
          ...
          VidSchMarkDeviceAsError(*(_QWORD *)(*(_QWORD *)(v12 + 8) + 32LL), 21LL);
        }
        v119 = v123;
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 11397;
        ...
        || (((unsigned __int8)v82 ^ (unsigned __int8)(v80 >> 13)) & 0xF) != 0 )
      {
        ...
        if ( v86 != (VIDMM_PHYSICAL_ADAPTER *)(v11 + 112) )
        {
          do
          {
            ...
            v93 = (_QWORD *)*((_QWORD *)v86 - 2);
            if ( v93 != (_QWORD *)((char *)v86 - 16) )
            {
              v94 = Interval;
              v95 = (_QWORD *)((char *)v86 - 16);
              do
              {
                if ( VIDMM_ALLOC::HasAnyResidencyReferences((VIDMM_ALLOC *)(v93 - 5)) )
                {
                  if ( (((unsigned __int8)v82 ^ (unsigned __int8)(*(_DWORD *)(v11 + 24) >> 13)) & 0xF) != 0 )
                  {
                    DecrementBudgetCounter(
                      ...
                      *(_QWORD *)(v94.QuadPart + 16));
                    v96 = (*(_DWORD *)(v11 + 24) >> 13) & 0xF;
                    *((_QWORD *)v90 + v96 + 17) += *(_QWORD *)(v94.QuadPart + 16);
                  }
                  if ( (unsigned __int8)v82 >> 4 != ((*(_DWORD *)(v11 + 24) >> 17) & 0xF) )
                  {
                    DecrementBudgetCounter(
                      ...
                      *(_QWORD *)(v94.QuadPart + 16));
                    v97 = (*(_DWORD *)(v11 + 24) >> 17) & 0xF;
                    *((_QWORD *)v90 + v97 + 9) += *(_QWORD *)(v94.QuadPart + 16);
                  }
                }
                v93 = (_QWORD *)*v93;
              }
            ...
            VIDMM_PROCESS_ADAPTER_INFO::CommitMemoryUsageChange(v131, v91, v92);
      ...
      *((_DWORD *)v10 + 12) &= 0xFFFFFFF0;
      if ( (_BYTE)v130 )
      {
        v98 = *(VIDMM_SEGMENT **)(Interval.QuadPart + 64);
        if ( v98 )
        {
          v99 = VIDMM_SEGMENT::DriverId(v98);
      ...
      if ( !VIDMM_ALLOC::HasAnyResidencyReferences((VIDMM_ALLOC *)v12) )
        goto LABEL_221;
      v26 = a3;
      if ( *(_WORD *)(*(_QWORD *)(v11 + 392) + 8LL) >= 2u )
        goto LABEL_222;
      inited = VIDMM_GLOBAL::PageInOneAllocation((__int64)v9, (_DWORD *)v12, 0, a7, a3, v126, 0, -1LL);
      goto LABEL_44;
    }
...
LABEL_171:
      ...
      if ( *(_DWORD *)(v59.QuadPart + 44) != v61.0 )
      {
        ...
        if ( v77 )
        {
          ...
          {
            v115 = 1;
            VidMmRecordAlloc((__int64)v9, v11, v77, v76, *(_QWORD *)(v59.QuadPart + 16), 1);
            goto LABEL_171;
          }
        }
      }
...
LABEL_172:
  ...
  switch ( (_DWORD)v24 )
  {
    case 0xD1:
      v26 = a3;
      inited = VIDMM_GLOBAL::InitContextAllocation(v9, (struct VIDMM_ALLOC *)v12, 1, a3, a8);
      goto LABEL_44;
    case 0x71:
...
LABEL_120:
    ...
    case 0xC8:
      ...
      if ( !*(_DWORD *)(v12 + 104) && !*(_DWORD *)(v12 + 172) )
      {
        if ( (*(_BYTE *)(v12 + 25) & 1) != 0 )
...
LABEL_100:
            ...
            if ( v114 )
            {
              ...
              if ( *(_QWORD *)(v11 + 296) )
              {
                ...
                if ( v126 )
                {
                  v49 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v126 + 1) + 16LL)
                                  + 8LL * *(unsigned int *)(*((_QWORD *)v9 + 3) + 240LL));
                  v50 = *(_QWORD **)(v49 + 112);
                  v51 = v49 + 104;
                  if ( *v50 != v51 )
            ...
            if ( v116 && !v123 )
            {
              if ( *(_QWORD *)(Interval.QuadPart + 64) )
              {
                if ( g_IsInternalReleaseOrDbg )
                {
                  ...
                  WdLogGlobalForLineNumber = 10932;
                }
            ...
            *(_DWORD *)(v12 + 28) |= 4u;
            ...
            if ( v53 && _InterlockedExchangeAdd((volatile signed __int32 *)(v53 + 32), 0xFFFFFFFF) == 1 )
              ADAPTER_RENDER::NotifyDeferredDestructionComplete(
                *((ADAPTER_RENDER **)v9 + 2),
                *(struct DXGTERMINATIONTRACKER **)(v12 + 208));
            goto LABEL_221;
          }
          WdLogSingleEntry2(4LL, v11, v12);
          *((_BYTE *)v122 + 24) |= 1u;
          WdLogGlobalForLineNumber = 10825;
          NewAllocOwner = VIDMM_GLOBAL::FindNewAllocOwner(v9, (struct VIDMM_GLOBAL_ALLOC *)v11);
          v126 = NewAllocOwner;
          VIDMM_GLOBAL::EvictTemporaryResourceForCleanup(v9, (struct VIDMM_PHYSICAL_ALLOC *)Interval.QuadPart, v122);
          v116 = !VIDMM_GLOBAL::TransferAllocationOwnership(v9, (struct VIDMM_GLOBAL_ALLOC ***)v12, v122, NewAllocOwner);
          ...
          WdLogGlobalForLineNumber = 10851;
          v114 = 1;
        }
        else
        {
  ...
  if ( (_DWORD)v24 != 203 )
  {
    if ( (_DWORD)v24 != 206 )
    {
      if ( (_DWORD)v24 == 207 )
      {
        if ( !*(_DWORD *)(v12 + 168) && (*(_BYTE *)(v12 + 25) & 1) == 0 )
          VIDMM_GLOBAL::EvictOneAllocation(v9, (__int64 **)v12, *((_BYTE *)v10 + 32) & 1);
        _InterlockedDecrement((volatile signed __int32 *)(v12 + 180));
        goto LABEL_221;
      }
      if ( (_DWORD)v24 == 208 )
      {
        ...
        DXGAUTOPUSHLOCKFASTEXCLUSIVE::DXGAUTOPUSHLOCKFASTEXCLUSIVE(
          ...
          (struct DXGPUSHLOCKFAST *)(v11 + 328),
          1);
        if ( !*((_BYTE *)v10 + 45) )
        {
        ...
        if ( *((_BYTE *)v10 + 45) )
        {
          ...
          v26 = a3;
          v16 = VIDMM_GLOBAL::PageInOneAllocation((__int64)v9, (_DWORD *)v12, 2u, 0, a3, v126, 0, -1LL);
...
LABEL_133:
    ...
    if ( *(_WORD *)(*(_QWORD *)(v11 + 392) + 8LL) >= 2u )
      goto LABEL_222;
    inited = VIDMM_GLOBAL::PageInOneAllocation((__int64)v9, (_DWORD *)v12, 0, a7, a3, a8, v28, -1LL);
LABEL_44:
    v16 = inited;
    goto LABEL_222;
  }
  if ( g_IsInternalReleaseOrDbg != (_BYTE)v20 )
  {
    ...
    v20 = 0LL;
    *(_QWORD *)(v30 + 24) = v12;
    WdLogGlobalForLineNumber = 10992;
  }
  ...
  v31 = *(unsigned int *)(*(_QWORD *)(v11 + 392) + 16LL);
  if ( !(_DWORD)v31 && !_bittest(*(const signed __int32 **)(v11 + 392), 0x11u) )
  {
    if ( g_IsInternalReleaseOrDbg != (_BYTE)v20 )
    {
    ...
    if ( *(_QWORD *)(Interval.QuadPart + 64) != v20 )
    {
      ...
      if ( (v32 & 0x40000000) == 0 && ((v32 & 0x20000000) == 0 || v32 >= 0) && (v32 & 0x80000) == 0 )
      {
        ...
        if ( g_IsInternalReleaseOrDbg != (_BYTE)v20 )
        {
          ...
          WdLogGlobalForLineNumber = 11030;
        }
        VidMmSuspendAccessToAllocation(*(VIDMM_GLOBAL ***)v9, (struct VIDMM_GLOBAL_ALLOC *)v11);
        VIDMM_GLOBAL::EvictAllocation(v9, (struct VIDMM_GLOBAL_ALLOC *)v11);
  ...
  v26 = a3;
  v37 = VIDMM_GLOBAL::PageInOneAllocation(
          (__int64)v9,
          (_DWORD *)v12,
          v35,
          a7,
  ...
  *(_DWORD *)(v11 + 28) &= ~0x1000u;
  v16 = v37;
  if ( v37 >= 0 )
    _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v11 + 392) + 16LL));
...
LABEL_222:
  ...
  {
    v107 = (unsigned int *)*((_QWORD *)v10 + 3);
    if ( v107 )
      *v107 = v16;
    v109 = v136;
  }
  LOBYTE(v17) = v120;
  VIDMM_GLOBAL::EndPreparation(v9, 0xFFFFFFFF, 0LL, v17, a5, v109);
  if ( *(_DWORD *)v10 == 200 )
  {
