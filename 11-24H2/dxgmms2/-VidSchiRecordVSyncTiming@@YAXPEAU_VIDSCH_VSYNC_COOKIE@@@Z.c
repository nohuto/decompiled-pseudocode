/*
 * XREFs of ?VidSchiRecordVSyncTiming@@YAXPEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x14000A8F8
 * Callers:
 ...
 * Callees:
 *     ?Compute_b0_b1@?$LinearFitT@$0BAA@@@QEAAXXZ @ 0x14000AF24 (-Compute_b0_b1@-$LinearFitT@$0BAA@@@QEAAXXZ.c)
 *     ?Reset@?$LinearFitT@$0BAA@@@QEAAXXZ @ 0x14000C844 (-Reset@-$LinearFitT@$0BAA@@@QEAAXXZ.c)
 *     ?RebaseSums@?$LinearFitT@$0BAA@@@QEAA_NXZ @ 0x1400378C0 (-RebaseSums@-$LinearFitT@$0BAA@@@QEAA_NXZ.c)
