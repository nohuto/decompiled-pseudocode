/*
 * XREFs of ?QuerySegmentUsageStatistics@VIDMM_GLOBAL@@QEAAJGIPEAU_D3DKMT_QUERYSTATISTICS_MEMORY_USAGE@@@Z @ 0x140099494
 * Callers:
 *     VidMmQuerySegmentUsageStatistics @ 0x14004BFA0 (VidMmQuerySegmentUsageStatistics.c)
 * Callees:
 *     <none>
 */
