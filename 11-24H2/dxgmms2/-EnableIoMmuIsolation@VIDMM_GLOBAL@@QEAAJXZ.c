/*
 * XREFs of ?EnableIoMmuIsolation@VIDMM_GLOBAL@@QEAAJXZ @ 0x1400931C0
 * Callers:
 *     VidMmEnableIoMmuIsolation @ 0x14004BC40 (VidMmEnableIoMmuIsolation.c)
  ...
  if ( ((_BYTE)this[5117] & 0xC) == 0 )
  {
    ...
    for ( i = 0; (unsigned int)i < *((_DWORD *)this + 1736); ++i )
    {
      ...
      if ( v4 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 29668;
        return v5;
      }
    }
    ...
    for ( k = this[466]; k != (__int64 **)(this + 466); k = (__int64 **)*k )
    {
      ...
      if ( v10 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 29724;
LABEL_16:
...
LABEL_27:
    ...
    for ( m = this[468]; m != (__int64 **)(this + 468); m = (__int64 **)*m )
    {
      ...
      if ( v15 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 29741;
        goto LABEL_16;
      }
    }
    *((_BYTE *)this + 40109) = 1;
    ...
    for ( n = this[5014]; n != (__int64 **)(this + 5014); n = (__int64 **)*n )
    {
      ...
      if ( v19 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 29767;
        goto LABEL_27;
      }
    }
    *((_BYTE *)this + 40152) = 1;
