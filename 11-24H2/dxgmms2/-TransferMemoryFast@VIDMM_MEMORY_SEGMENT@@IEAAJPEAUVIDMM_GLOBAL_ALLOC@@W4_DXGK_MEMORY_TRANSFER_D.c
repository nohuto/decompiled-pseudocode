/*
 * XREFs of ?TransferMemoryFast@VIDMM_MEMORY_SEGMENT@@IEAAJPEAUVIDMM_GLOBAL_ALLOC@@W4_DXGK_MEMORY_TRANSFER_DIRECTION@@PEAVVIDMM_SEGMENT@@T_LARGE_INTEGER@@PEA_N@Z @ 0x1400E58C4
 * Callers:
 ...
 *     ?AddPendingTemporaryResource@VIDMM_PHYSICAL_ADAPTER@@QEAAXPEAUVIDMM_TEMPORARY_RESOURCE@@@Z @ 0x1400E6484 (-AddPendingTemporaryResource@VIDMM_PHYSICAL_ADAPTER@@QEAAXPEAUVIDMM_TEMPORARY_RESOURCE@@@Z.c)
 */
