/*
 * XREFs of ?FreeTransportBuffer@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_TRANSPORT_BUFFER@@@Z @ 0x140093F48
 * Callers:
 *     VidMmFreeTransportBuffer @ 0x14004BD00 (VidMmFreeTransportBuffer.c)
 * Callees:
