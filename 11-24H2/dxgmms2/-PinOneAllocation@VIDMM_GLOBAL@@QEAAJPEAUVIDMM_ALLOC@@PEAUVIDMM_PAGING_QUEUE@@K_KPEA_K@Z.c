/*
 * XREFs of ?PinOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@K_KPEA_K@Z @ 0x1400DADBC
 * Callers:
 *     ?PinAllocationAt@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@K_K@Z @ 0x1400960B8 (-PinAllocationAt@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@K_K@Z.c)
 *     ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1400DA968 (-PinAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_.c)
        ...
        unsigned __int64 *a6)
{
  ...
  if ( (int)result >= 0 && !v18 )
  {
    ...
    v13 = *v12;
    v14 = 0;
    LODWORD(v17[4]) = (**(_DWORD **)(*v12 + 392) & 0x20000) != 0 ? 5 : 0;
    if ( !a3 )
    {
      v14 = 1;
