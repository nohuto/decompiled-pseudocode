/*
 * XREFs of ?SetToAlwaysSignaled@_VIDSCH_SYNC_OBJECT@@QEAAXPEAVHwQueueStagingList@@_N@Z @ 0x14003B954
 * Callers:
 ...
 *     VidSchiSignalRegisteredSyncObjects @ 0x14003B848 (VidSchiSignalRegisteredSyncObjects.c)
 * Callees:
