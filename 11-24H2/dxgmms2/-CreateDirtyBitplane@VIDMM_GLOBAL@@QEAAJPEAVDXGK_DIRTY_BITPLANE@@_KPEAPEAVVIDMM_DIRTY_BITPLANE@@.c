/*
 * XREFs of ?CreateDirtyBitplane@VIDMM_GLOBAL@@QEAAJPEAVDXGK_DIRTY_BITPLANE@@_KPEAPEAVVIDMM_DIRTY_BITPLANE@@@Z @ 0x140092ED4
 * Callers:
 *     VidMmCreateDirtyBitplane @ 0x14004BBB0 (VidMmCreateDirtyBitplane.c)
 * Callees:
