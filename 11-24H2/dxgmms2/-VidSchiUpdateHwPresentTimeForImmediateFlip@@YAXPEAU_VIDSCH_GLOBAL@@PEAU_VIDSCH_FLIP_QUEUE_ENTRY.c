/*
 * XREFs of ?VidSchiUpdateHwPresentTimeForImmediateFlip@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@I@Z @ 0x140039FC4
 * Callers:
  ...
  *(_OWORD *)v28 = 0LL;
  ...
  while ( v10 || v12 )
  {
    if ( v17 < v18 )
      v18 = v17;
    v19 = 304LL * v18;
    v20 = *(_QWORD *)(v13 * ((8 * *(_DWORD *)(*((_QWORD *)a2 + 149) + 8LL) + 231) & 0xFFFFFFF8)
                    + *((_QWORD *)a2 + 149)
                    + 24LL);
    if ( v20 )
    {
      ...
      if ( *(_QWORD *)(v19 + v8 + 400) == v20 )
        *((_QWORD *)a2 + 165) = *(_QWORD *)(*(_QWORD *)(v19 + v8 + 448)
                                          + 16LL
