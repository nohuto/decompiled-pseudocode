/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x1401088B8
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  v1 = v0;
LABEL_6:
  qword_140081568 = 10000LL * v3;
  qword_140081570 = 10000LL * v4;
  qword_140081578 = 10000LL * v5;
  qword_140081580 = 10000LL * v6;
  qword_1400815A0 = v35;
  dword_1400815A8 = v9;
  qword_140081588 = 10000LL * v0;
  qword_140081590 = (unsigned int)(10000 * v7);
  qword_1400815D0 = (unsigned __int64)v10 << 20;
  dword_1400814DC = v11;
  dword_1400815B0 = v12;
  dword_1400815B4 = v13;
  dword_140081638 = v14;
  dword_14008163C = v15;
  qword_140081598 = (unsigned int)(10000 * v8);
  if ( (unsigned int)Feature_Servicing_GraphicsKernel_PromotionRegistryKey__private_IsEnabledDeviceUsageNoInline() )
    byte_1400815AC = v16 != 0;
}
