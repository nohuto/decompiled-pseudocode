/*
 * XREFs of ?VidMmMapGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_PAGING_QUEUE@@PEAUVIDMM_MULTI_ALLOC@@PEAUD3DDDI_MAPGPUVIRTUALADDRESS@@_NI@Z @ 0x1400F4F90
 * Callers:
 *     VidMmMapGpuVirtualAddress @ 0x140039D00 (VidMmMapGpuVirtualAddress.c)
        ...
        unsigned int a6)
{
  ...
  if ( (*(_BYTE *)&Value & 8) != 0 && (*(_BYTE *)&Value & 7) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 19676;
    return 3221225485LL;
  }
  if ( (*(_BYTE *)&Value & 0xC) != 0 )
  {
    ...
    {
      WdLogSingleEntry0(3LL);
      WdLogGlobalForLineNumber = 19684;
      return 3221225485LL;
    }
  }
  else if ( !a3 )
  {
    WdLogSingleEntry0(3LL);
    WdLogGlobalForLineNumber = 19690;
    return 3221225485LL;
  }
  ...
  if ( a6 == -1 )
  {
    for ( i = 0; i < *((_DWORD *)this + 1736); ++i )
    {
      ...
      if ( v11 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 19716;
        goto LABEL_21;
      }
  ...
  else
  {
    ...
    if ( v11 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 19728;
LABEL_21:
