/*
 * XREFs of ?GetBackingAddress@VIDMM_RECYCLE_HEAP_MGR@@UEAA_KPEAUVIDMM_HEAP_ALLOC@@@Z @ 0x1400FF6B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_RECYCLE_HEAP_MGR::GetBackingAddress(VIDMM_RECYCLE_HEAP_MGR *this, struct VIDMM_HEAP_ALLOC *a2)
{
  __int64 v3; // rcx
  __int64 BackingAddress; // rbx
