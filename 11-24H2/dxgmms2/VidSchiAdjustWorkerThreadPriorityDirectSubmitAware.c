/*
 * XREFs of VidSchiAdjustWorkerThreadPriorityDirectSubmitAware @ 0x14004A7CC
 * Callers:
 *     VidSchiAdjustWorkerThreadPriority @ 0x140032E60 (VidSchiAdjustWorkerThreadPriority.c)
 * Callees:
 *     VidSchiComputeWorkerThreadPriority @ 0x1400364A8 (VidSchiComputeWorkerThreadPriority.c)
 */
