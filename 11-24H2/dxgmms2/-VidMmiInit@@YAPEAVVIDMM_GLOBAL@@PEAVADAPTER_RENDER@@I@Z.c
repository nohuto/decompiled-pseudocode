/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@I@Z @ 0x14009829C
 * Callers:
 *     VidMmInitializeAdapter @ 0x14004BD40 (VidMmInitializeAdapter.c)
 * Callees:
...
LABEL_13:
  ...
  {
    _InterlockedIncrement(&dword_1400816FC);
  ...
  _InterlockedIncrement(&dword_140081700);
