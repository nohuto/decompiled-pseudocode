/*
 * XREFs of ?QuerySegmentGroupUsageStatistics@VIDMM_GLOBAL@@QEAAJGW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_MEMORY_USAGE@@@Z @ 0x140099404
 * Callers:
 *     VidMmQuerySegmentGroupUsageStatistics @ 0x14004BF80 (VidMmQuerySegmentGroupUsageStatistics.c)
 * Callees:
        ...
        struct _D3DKMT_QUERYSTATISTICS_MEMORY_USAGE *a5)
{
  ...
  if ( (unsigned int)a3 > D3DKMT_MEMORY_SEGMENT_GROUP_NON_LOCAL )
    return 3221225485LL;
  SegmentGroupState = VIDMM_GLOBAL::GetSegmentGroupState(this, a2, a3, a4[37]);
