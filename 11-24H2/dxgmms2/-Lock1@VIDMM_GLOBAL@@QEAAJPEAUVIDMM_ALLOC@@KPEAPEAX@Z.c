/*
 * XREFs of ?Lock1@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@KPEAPEAX@Z @ 0x140111AAC
 * Callers:
 *     VidMmBeginCPUAccess @ 0x14003F490 (VidMmBeginCPUAccess.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::Lock1(VIDMM_GLOBAL *this, __int64 **a2, unsigned int a3, void **a4)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    *(_QWORD *)(v11 + 24) = a2;
    *(_QWORD *)(v11 + 32) = v6;
    WdLogGlobalForLineNumber = 22175;
  }
  *a4 = 0LL;
...
LABEL_8:
    ...
    if ( ((unsigned int)v15 & v13) != 0 )
    {
      ...
      WdLogGlobalForLineNumber = 22210;
      goto LABEL_8;
    }
    if ( (v13 & 0x82) != 0 )
    {
      if ( (*(_DWORD *)(v10 + 24) & 0x40) == 0 && (*(_DWORD *)(v10 + 28) & 0x200000) == 0 )
      {
        ...
        WdLogGlobalForLineNumber = 22233;
        goto LABEL_8;
      }
      if ( !*((_BYTE *)this + 7017) )
      {
        v15 = **(unsigned int **)(v10 + 392);
        if ( (v15 & 4) != 0 )
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 22243;
          goto LABEL_8;
        }
      }
    }
    if ( (v13 & 0x81) != 0 )
    {
      if ( (v13 & 0x100) != 0 )
      {
        ...
        result = 3223191812LL;
        WdLogGlobalForLineNumber = 22279;
        return result;
      }
