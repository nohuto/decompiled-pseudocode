/*
 * XREFs of VidSchHasReadyPackets @ 0x14001F6C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall VidSchHasReadyPackets(__int64 a1)
{
  ...
  if ( (unsigned __int8)RtlAreBitsClearEx(a1 + 496, 0LL, *(unsigned int *)(a1 + 84)) )
  {
    v2 = (_QWORD **)(a1 + 352);
    for ( i = *v2; i != v2; i = (_QWORD *)*i )
    {
      ...
      {
        v5 = j[80];
        if ( (_QWORD *)v5 != j + 80 && (*(_DWORD *)(v5 + 16) != 4 || (*(_DWORD *)(v5 + 720) & 1) != 0) )
          goto LABEL_18;
      }
      for ( k = (_QWORD *)*(i - 2); k != i - 2; k = (_QWORD *)*k )
      {
        for ( m = (__int64 *)k[4]; m != k + 4; m = (__int64 *)*m )
        {
          if ( *((_DWORD *)m + 36) )
            goto LABEL_18;
          v8 = m[19];
          if ( (__int64 *)v8 != m + 19 && (*(_DWORD *)(v8 + 16) != 4 || (*(_DWORD *)(v8 + 720) & 1) != 0) )
            goto LABEL_18;
        }
      }
    }
