/*
 * XREFs of ?Execute@VIDMM_TASK_IDLE@@UEAAJPEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK_CONTEXT@@@Z @ 0x1400A0680
 * Callers:
 *     <none>
 * Callees:
        ...
        struct VIDMM_TASK_CONTEXT *a3)
{
  ...
  if ( *((_DWORD *)a2 + 1374) )
  {
    DXGAUTOPUSHLOCKFASTEXCLUSIVE::DXGAUTOPUSHLOCKFASTEXCLUSIVE(
      ...
      (struct VIDMM_WORKER_THREAD2 *)((char *)a2 + 5392),
      1);
    v5 = (_QWORD *)*((_QWORD *)a2 + 688);
    v6 = 0LL;
    while ( v5 )
    {
      v6 = v5;
