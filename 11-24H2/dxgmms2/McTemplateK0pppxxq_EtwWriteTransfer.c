/*
 * XREFs of McTemplateK0pppxxq_EtwWriteTransfer @ 0x1400401A8
 * Callers:
...
NTSTATUS McTemplateK0pppxxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, (const EVENT_DESCRIPTOR *)"2", a3, 7u, &v4);
}
