/*
 * XREFs of ?Defragment@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x14008FF64
 * Callers:
...
void __fastcall VIDMM_GLOBAL::Defragment(VIDMM_GLOBAL *this, struct VIDMM_SEGMENT *a2)
{
  ...
  *((_QWORD *)a2 + 68) = *(_QWORD *)(*(_QWORD *)this + 112LL);
  if ( (*((_DWORD *)this + 1746) & 0x4000) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 26645;
  }
  else
  {
    ...
    {
      WdLogSingleEntry1(4LL, a2);
      WdLogGlobalForLineNumber = 26676;
    ...
    {
      WdLogSingleEntry1(4LL, a2);
      WdLogGlobalForLineNumber = 26703;
