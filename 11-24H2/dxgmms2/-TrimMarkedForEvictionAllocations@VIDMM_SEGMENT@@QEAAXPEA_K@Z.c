/*
 * XREFs of ?TrimMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAXPEA_K@Z @ 0x140090F78
 * Callers:
...
void __fastcall VIDMM_SEGMENT::TrimMarkedForEvictionAllocations(VIDMM_PHYSICAL_ADAPTER **this, unsigned __int64 *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( (_QWORD *)*v3 == v3 )
      break;
    VIDMM_PHYSICAL_ADAPTER::EvictResources(this[4], (struct VIDMM_PHYSICAL_ALLOC *)*(v5 - 33), 1u, 0, 0, 0LL);
    v6 = *(_QWORD *)(*(v5 - 33) + 16LL);
    if ( v6 >= *a2 )
    {
      *a2 = 0LL;
      return;
