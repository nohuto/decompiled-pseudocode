/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_CONTEXT_ALLOC@@@Z @ 0x1400A9994
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1400417A0 (VidMmDestroyContextAllocation.c)
 * Callees:
