/*
 * XREFs of ?ProcessVerifierOption@VIDMM_GLOBAL@@QEAAJPEAVDXGPROCESS@@W4_D3DKMT_VERIFIER_OPTION_MODE@@W4_D3DKMT_PROCESS_VERIFIER_OPTION_TYPE@@PEAT_D3DKMT_PROCESS_VERIFIER_OPTION_DATA@@@Z @ 0x140098544
 * Callers:
 *     VidMmProcessVerifierOption @ 0x14004BEE0 (VidMmProcessVerifierOption.c)
 * Callees:
 *     <none>
 */
