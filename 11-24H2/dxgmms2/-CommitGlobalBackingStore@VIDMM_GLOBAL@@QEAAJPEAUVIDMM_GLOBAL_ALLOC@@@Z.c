/*
 * XREFs of ?CommitGlobalBackingStore@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400C5100
 * Callers:
      ...
      *((_DWORD *)a2 + 8) |= 0x20u;
      ...
      if ( (v17 & 0x800000) != 0 )
      {
        ...
        if ( v27 )
        {
          if ( (v17 & 0x1000000) == 0 )
          {
            v29[0] = *(_QWORD *)(*((_QWORD *)a2 + 49) + 48LL);
...
LABEL_19:
    ...
    if ( (*v8 & 0x400000) != 0 )
    {
      ObfReferenceObject(*((PVOID *)a2 + 28));
    }
    else
    {
      v9 = *(_QWORD *)(v2 + 16);
      ...
      v11 = (PVOID *)((char *)a2 + 224);
      CurrentPartitionHandle = VIDMM_PROCESS::GetCurrentPartitionHandle();
      v5 = MmCreateSection((char *)a2 + 224, 0LL, 0LL, &v31, 4, v10, CurrentPartitionHandle, 0LL);
      if ( v5 < 0 )
      {
        _InterlockedIncrement(&dword_140081824);
        WdLogSingleEntry4(6LL, a2, v31);
        WdLogGlobalForLineNumber = 27524;
      ...
      if ( (**v7 & 0x20000000) != 0 && *v11 )
      {
        ...
        if ( inserted < 0 )
        {
          ...
          v22 = 0x40000LL;
          WdLogGlobalForLineNumber = 27560;
          goto LABEL_27;
        }
    ...
    if ( (v15 & 0x8000) != 0 )
    {
      v5 = VIDMM_PROCESS::MapHostVirtualAddressToGuest(
             ...
             *(_QWORD *)(v2 + 16),
             ...
             4u,
             (void **)a2 + 53,
             (unsigned __int64 *)a2 + 54,
             (void **)a2 + 51);
      if ( v5 < 0 )
      {
        _InterlockedIncrement(&dword_140081828);
        WdLogSingleEntry4(6LL, a2, *((_QWORD *)a2 + 28));
        WdLogGlobalForLineNumber = 27596;
LABEL_26:
        v22 = 262145LL;
LABEL_27:
    ...
    else
    {
      ...
      {
LABEL_31:
        v24 = (void *)*((_QWORD *)a2 + 28);
        ViewSize = *(_QWORD *)(v2 + 16);
        v25 = MmMapViewInSystemSpace(v24, (PVOID *)a2 + 29, &ViewSize);
        v5 = v25;
        if ( v25 >= 0 )
        {
        ...
        _InterlockedIncrement(&dword_140081828);
        WdLogSingleEntry3(6LL, a2, *((_QWORD *)a2 + 28), v25);
        WdLogGlobalForLineNumber = 27624;
        goto LABEL_26;
      }
      v16 = (v15 & 0x800000) == 0;
    }
  ...
  if ( *((_QWORD *)a2 + 51)
    || (PagesForMdl = MmAllocatePagesForMdlEx(
                        ...
                        0LL,
                        *(_QWORD *)(v2 + 16),
                        (MEMORY_CACHING_TYPE)(2 - ((**((_DWORD **)a2 + 49) & 4) != 0)),
                        4u),
        (*((_QWORD *)a2 + 51) = PagesForMdl) != 0LL) )
  {
    *((_DWORD *)a2 + 8) |= 0x20u;
    goto LABEL_18;
  }
  WdLogSingleEntry0(1LL);
  WdLogGlobalForLineNumber = 27459;
