/*
 * XREFs of AcpiParseLpiObject @ 0x14002B610
 * Callers:
 *     AcpiEval_LPI @ 0x1400295F0 (AcpiEval_LPI.c)
 *     AcpiParseProcessorContainer @ 0x14002BFEC (AcpiParseProcessorContainer.c)
 * Callees:
...
LABEL_102:
    ...
    v37 = &v25[v34 + 12];
    if ( *v37 != 127 )
      AcpiTranslateAccessSize(v37, v35);
    v38 = &v25[v34 + 15];
    if ( *v38 != 127 )
      AcpiTranslateAccessSize(v38, v35);
    v39 = &v25[v34 + 18];
    if ( *v39 != 127 )
      AcpiTranslateAccessSize(v39, v35);
    v40 = *((_WORD *)v30 + 1);
    v26 = 4LL;
    if ( v40 >= 4u )
      v26 = *((unsigned __int16 *)v30 + 1);
