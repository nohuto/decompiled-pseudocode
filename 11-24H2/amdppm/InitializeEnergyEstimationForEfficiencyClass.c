/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x14003B770
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  InitializeEnumerationContext((__int64)&qword_140015618, 32, (__int64)v14);
  ...
  *(__int64 *)((char *)&Globals[255] + v1) = 0LL;
  v5 = 0LL;
  *(__int64 *)((char *)&Globals[254] + v1) = 0LL;
  v6 = 0LL;
  v7 = *(_DWORD *)((char *)&Globals[229] + v1);
  if ( v7 )
  {
    v8 = *(_DWORD *)((char *)&Globals[229] + v1);
    do
    {
      result = 3 * v6;
      v7 = v8;
      if ( (*(_DWORD *)((_BYTE *)&Globals[230] + 12 * v6 + v1) & 1) == 0 )
      {
        if ( (_DWORD)v6 != (_DWORD)v5 )
        {
          v9 = v1 + 12 * v6;
          v10 = v1 + 12 * v5;
          *(__int64 *)((char *)&Globals[229] + v10 + 4) = *(__int64 *)((char *)&Globals[229] + v9 + 4);
          result = *(unsigned int *)((char *)&Globals[230] + v9 + 4);
          *(_DWORD *)((char *)&Globals[230] + v10 + 4) = result;
          v7 = *(_DWORD *)((char *)&Globals[229] + v1);
        }
  ...
  if ( v7 != (_DWORD)v5 )
  {
    result = (__int64)memset((char *)&unk_140015CEC + 12 * v5 + v1, 0, 12LL * (v7 - (unsigned int)v5));
    *(_DWORD *)((char *)&Globals[229] + v1) = v5;
  }
  if ( !(_DWORD)v5 )
    goto LABEL_38;
  ResetEnumerationContext((__int64 *)v14);
  ...
  if ( v11 < 0 || !*(__int64 *)((char *)&Globals[254] + v1) )
  {
    InitializeEnumerationContext((__int64)&qword_140015618, 32, (__int64)v14);
    ResetEnumerationContext((__int64 *)v14);
    while ( 1 )
    ...
    *(__int64 *)((char *)&Globals[254] + v1) = 0LL;
LABEL_38:
    if ( !*(__int64 *)((char *)&Globals[254] + v1) )
    {
      result = (__int64)ComputeProcessorEnergy;
      *(__int64 *)((char *)&Globals[254] + v1) = (__int64)ComputeProcessorEnergy;
    }
  }
  return result;
}
