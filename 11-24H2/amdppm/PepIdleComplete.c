/*
 * XREFs of PepIdleComplete @ 0x14000BF70
 * Callers:
 *     PepIdleCompleteV2 @ 0x14000BFF0 (PepIdleCompleteV2.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall PepIdleComplete(__int64 *BugCheckParameter4, int a2, int a3, int a4, __int64 a5)
{
  ...
  if ( (int)result < 0 )
    KeBugCheckEx((ULONG)323, 1uLL, 6uLL, 0LL, (ULONG_PTR)BugCheckParameter4);
  return result;
}
