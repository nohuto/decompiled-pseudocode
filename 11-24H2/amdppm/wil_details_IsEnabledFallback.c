/*
 * XREFs of wil_details_IsEnabledFallback @ 0x140005058
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x140004DCC (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
