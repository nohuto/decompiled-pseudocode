/*
 * XREFs of InitPerfStatesInternal @ 0x140034D84
 * Callers:
 *     RegisterHvPerfStatesCounters @ 0x140027B70 (RegisterHvPerfStatesCounters.c)
 *     RegisterKernelPerfStates @ 0x140036FF0 (RegisterKernelPerfStates.c)
 * Callees:
...
__int64 __fastcall InitPerfStatesInternal(__int64 a1, int (__fastcall *a2)(__int64))
{
    ...
    && (inited = AllocateAndInitKernelPerfStatesRegistration(a1, PerfDomain, 1)) != 0 )
  {
    ...
    *(_BYTE *)(inited + 52) = 0;
    v47 = v12;
    if ( dword_140015EE0 == 1 || v12 == 252 || (v13 = v12 == 1, v14 = PerfControlPTStatesHidden, v13) )
