/*
 * XREFs of DeregisterKernelIdleDomains @ 0x140032DE8
 * Callers:
 ...
 *     DeregisterIdleDomain @ 0x140032CD4 (DeregisterIdleDomain.c)
...
__int64 __fastcall DeregisterKernelIdleDomains(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( v10 )
    {
      ...
      do
      {
        *(_QWORD *)(88 * v11 + *(_QWORD *)(a1 + 712) + 120) = 0LL;
