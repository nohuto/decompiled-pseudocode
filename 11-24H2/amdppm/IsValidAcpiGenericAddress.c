/*
 * XREFs of IsValidAcpiGenericAddress @ 0x140030164
 * Callers:
 *     InitAcpi1CStates @ 0x140025AEC (InitAcpi1CStates.c)
 *     ValidateAcpiCStates @ 0x140030668 (ValidateAcpiCStates.c)
 *     ValidateLpiState @ 0x1400319E8 (ValidateLpiState.c)
 *     InitAcpi1ThrottleStates @ 0x140038210 (InitAcpi1ThrottleStates.c)
 * Callees:
 *     <none>
 */
