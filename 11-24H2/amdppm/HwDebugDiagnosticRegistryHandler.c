/*
 * XREFs of HwDebugDiagnosticRegistryHandler @ 0x14000C800
 * Callers:
 *     HwDebugRegistryHandlerWrapper @ 0x14000CB00 (HwDebugRegistryHandlerWrapper.c)
 * Callees:
...
__int64 HwDebugDiagnosticRegistryHandler()
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1400155F0,
    0LL);
  KeInitializeEnumerationContext(&v14, &unk_140015A00);
  ...
  {
    v4 = P;
    if ( *(__int64 **)P != &qword_140015608 || (v5 = (PVOID *)*((_QWORD *)P + 1), *v5 != P) )
      __fastfail(3u);
    P = (PVOID)*((_QWORD *)P + 1);
    *v5 = &qword_140015608;
  ...
  if ( byte_140015F00 )
  {
    ...
    do
    {
      v7 = (PVOID *)qword_140015F08;
      v8 = 0;
      v9 = (char *)qword_140015F08 + 40 * v6;
      if ( v9[16] )
      {
        do
    ...
    while ( (unsigned int)v6 < (unsigned __int8)byte_140015F00 );
    ExFreePoolWithTag(qword_140015F08, (ULONG)1919119952);
    byte_140015F00 = 0;
  }
