/*
 * XREFs of ProcLibGlobalInit @ 0x140044504
 * Callers:
 ...
 *     GetHiddenProcessorPresence @ 0x140026B58 (GetHiddenProcessorPresence.c)
 ...
 *     InitializeHvProcessorInfo @ 0x1400434A8 (InitializeHvProcessorInfo.c)
...
__int64 __fastcall ProcLibGlobalInit(PDEVICE_OBJECT DeviceObject)
{
  ...
  v42 = 0LL;
  v43 = 0LL;
  v2 = ZwPowerInformation(ProcessorStateHandler, 0LL, (ULONG)0, &dword_1400158E8, (ULONG)280);
  v4 = v2;
  if ( v2 < 0 )
  {
...
LABEL_126:
  ...
  qword_140015C28 = (__int64)&qword_140015C20;
  qword_140015C20 = (__int64)&qword_140015C20;
  qword_140015F20 = (__int64)&qword_140015F18;
  qword_140015F18 = (__int64)&qword_140015F18;
  v11 = &unk_1400155F8;
  qword_140015F10 = 0LL;
  do
  {
  ...
  GetRegistryDwordValue(
    ...
    (__int64)L"Overrides",
    &dword_1400155D0);
  GetRegistryQwordValue(v13, v12, &qword_1400155C8);
  GetRegistryDwordValue(
    (__int64)L"\\Registry\\Machine\\System\\CurrentControlSet\\Control\\Processor",
  ...
  GetRegistryDwordValue(
    ...
    &v40);
  qword_140015B08 = (__int64)RegisterKernelIdleStates;
  word_140015EE9 = 0;
  qword_140015B50 = (__int64)RegisterHiddenIdleStates;
  byte_140015B58 = v40 == 0;
  dword_140015B5C = 0;
  qword_140015B10 = (__int64)RegisterKernelPerfStates;
  qword_140015B20 = (__int64)RegisterKernelPerfFeedback;
  qword_140015B28 = (__int64)RegisterKernelLegacyPcc;
  qword_140015B18 = (__int64)RegisterKernelCap;
  qword_140015B30 = (__int64)RegisterKernelCpc;
  qword_140015B38 = (__int64)RegisterKernelPepPerf;
  qword_140015B40 = (__int64)GetNtProcessorNumber;
  qword_140015B48 = (__int64)RegisterKernelPackage;
  v38 = 0;
  ...
  if ( HviIsAnyHypervisorPresent() )
  {
    ...
    if ( (InputBuffer & 0x100000000000LL) != 0 && (v46 & 0x1000) == 0 )
    {
      ...
      if ( v35 )
      {
        ...
        if ( (v4 & 0x80000000) != 0 )
          return v4;
        dword_140015B5C = 1;
        qword_140015B10 = (__int64)RegisterHvPerfStatesCounters;
        qword_140015B50 = (__int64)RegisterHvIdleStates;
        qword_140015B20 = (__int64)RegisterHvPerfFeedbackCounters;
        qword_140015B28 = (__int64)RegisterHvLegacyPccCounters;
        qword_140015B30 = (__int64)RegisterHvCpcCounters;
        if ( v36[0] )
          word_140015EE9 = 256;
        else
          qword_140015B08 = (__int64)RegisterHvIdleStates;
        byte_140015F28 = 1;
        qword_140015B40 = (__int64)GetLpIndex;
        qword_140015B48 = (__int64)RegisterHvPackage;
      }
      dword_140015EE0 = GetHiddenProcessorPresence();
      goto LABEL_58;
    }
    v15 = 1;
    qword_140015B08 = (__int64)RegisterGuestIdleStates;
    if ( (v46 & 0x1000) != 0 )
    {
      GetHvPpmCapabilities(&v35, 0LL, v36);
      if ( v35 )
    ...
    if ( !v38 )
    {
      qword_140015B10 = (__int64)RegisterNoop;
      qword_140015B28 = (__int64)RegisterNoop;
      qword_140015B18 = (__int64)RegisterNoop;
      ...
      {
        qword_140015B20 = (__int64)RegisterNoop;
  ...
  if ( (int)HalPrivateDispatchTable[143]((__int64)&v42) >= 0 )
  {
    ...
    qword_1400159A0 = *((_QWORD *)&v42 + 1);
    xmmword_1400159A8 = v43;
    qword_1400159B8 = v44;
  }
  dword_140015EE4 = dword_1400155D4 + HalPrivateDispatchTable[145](0xFFFFFFFFLL);
  dword_140015EE0 = 2;
LABEL_58:
      ...
      *(_QWORD *)&InputBuffer = ProcessSystemSleepStateNotify;
      ...
      if ( v2 >= 0 )
      {
        ...
        if ( v2 >= 0 )
        {
          ...
          qword_1400155C8 = v20 | (unsigned __int64)qword_1400155C8;
          dword_140015B74 = v20;
          dword_140015770 = 1;
          dword_140015774 = 376;
          if ( v41 )
          ...
          *(_QWORD *)&v46 = 0LL;
          ...
          inited = InitDriver((__int64)&dword_140015770, &v46);
          v4 = inited;
          if ( inited >= 0 )
          {
            v28 = Globals[0] | v46;
          ...
          else
          {
            ...
            memset(&dword_140015770, 0, 0x178uLL);
          }
        }
