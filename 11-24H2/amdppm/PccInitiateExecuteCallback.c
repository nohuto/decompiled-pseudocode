/*
 * XREFs of PccInitiateExecuteCallback @ 0x14000DCE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    if ( v4 )
    {
      LOBYTE(word_140015C4C) = 1;
      if ( !HIBYTE(word_140015C4C) )
      {
        HIBYTE(word_140015C4C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_140015C38);
    if ( v11 )
      IoQueueWorkItem(qword_140015C40, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
