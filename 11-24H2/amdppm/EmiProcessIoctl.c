/*
 * XREFs of EmiProcessIoctl @ 0x14003E020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EmiProcessIoctl(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  switch ( a5 )
  {
    case 2244620:
      ...
      v12 = (char *)v30;
      v7 = v10;
      ((void (__fastcall *)(__int64, __int64))qword_140015888)(v9, 0x800000000000LL);
      v13 = 0;
      if ( !*(_WORD *)(v9 + 1256) )
        return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, _QWORD))(WdfFunctions_01015 + 2120))(
                 WdfDriverGlobals,
      ...
      do
      {
        v15 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_140015890)(v9, v13, 0x800000000000LL);
        v16 = (unsigned __int64 *)&v12[16 * v5];
        v11 = ((__int64 (__fastcall *)(__int64, _QWORD, unsigned __int64 *, unsigned __int64 *))qword_140015898)(
                v9,
                v15,
                v16,
                v16 + 1);
      ...
      if ( v11 >= 0 )
      {
        ...
        *((_WORD *)v19 + 33) = *(_WORD *)(v9 + 1256);
        if ( *(_WORD *)(v9 + 1256) )
        {
          ...
          do
          {
            v24 = (unsigned int)((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_140015890)(
                                  v9,
                                  v21,
                                  0x800000000000LL);
            ((void (__fastcall *)(__int64, __int64 *, __int64 *, int *))qword_1400158A0)(v24, &v32, &v31, &v28);
            if ( v28 == 1 )
            {
