/*
 * XREFs of RegisterKernelIdleStates @ 0x140035DD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelIdleStates(__int64 a1)
{
  ...
  v1 = 0LL;
  if ( *(_DWORD *)(a1 + 80) )
    return (unsigned int)((__int64 (*)(void))qword_140015B50)();
...
LABEL_30:
    ...
    v23 = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_140015908)(v11);
