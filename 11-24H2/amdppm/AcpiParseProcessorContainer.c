/*
 * XREFs of AcpiParseProcessorContainer @ 0x14002BFEC
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x14002ACC8 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1400056F4 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x140007C44 (RtlUnicodeStringCopyString.c)
      ...
      if ( v15 )
      {
        ...
        *(_QWORD *)(a3 + 32) = v16;
        ...
        while ( v17 < a1[2 * v5 + 6] )
        {
          ...
          {
            if ( dword_140015EE4 <= (unsigned int)dword_1400155D4 )
              return -1073741275;
