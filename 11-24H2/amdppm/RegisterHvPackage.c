/*
 * XREFs of RegisterHvPackage @ 0x1400278D0
 * Callers:
 *     <none>
 * Callees:
 *     GetHvProcessorInfo @ 0x140007224 (GetHvProcessorInfo.c)
 *     InitializeHvPhysicalCores @ 0x140007260 (InitializeHvPhysicalCores.c)
...
LABEL_18:
      ...
      *v10 = v10;
      if ( dword_140015B70 )
      {
        v11 = (unsigned int)dword_140015B70;
        v12 = (_DWORD *)(qword_140015B68 + 8);
        do
        {
          v13 = v4 == *v12;
          v14 = v9 + 1;
