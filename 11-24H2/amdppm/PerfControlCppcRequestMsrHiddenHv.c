/*
 * XREFs of PerfControlCppcRequestMsrHiddenHv @ 0x140004480
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PerfControlCppcRequestMsrHiddenHv(__int64 *a1, _QWORD *a2, char a3, char a4)
{
  ...
  if ( a3 || a4 )
  {
    if ( !*((_BYTE *)a1 + 137) || a4 )
    {
      ((void (__fastcall *)(_QWORD, _QWORD, _QWORD *))qword_1400159A0)(
        *(unsigned int *)(*a1 + 84),
        *((unsigned int *)a1 + 39),
        v9);
      v6 = v9[0];
    ...
    ((void (__fastcall *)(_QWORD, __int64))qword_1400159A8)(*(unsigned int *)(v8 + 84), v7);
    a1[22] = v9[0];
  }
}
