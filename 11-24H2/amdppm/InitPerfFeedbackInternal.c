/*
 * XREFs of InitPerfFeedbackInternal @ 0x140034A5C
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x140027B50 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x140036FD0 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
        ...
        (v4 = (_QWORD *)inited) != 0LL) )
  {
    ...
    *(_WORD *)(inited + 6) = 1;
    *(_BYTE *)(inited + 52) = 2;
    *(_BYTE *)(inited + 14) = byte_140015B60;
