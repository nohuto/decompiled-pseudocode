/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedVariantState @ 0x140004CC4
 * Callers:
        ...
        __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    v9 = _InterlockedCompareExchange64(&Feature_QosHysteresisExperiment__private_featureState, v7, a2);
    if ( a2 == v9 )
      break;
    a2 = v9;
  }
