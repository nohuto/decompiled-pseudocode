/*
 * XREFs of PepParkMask @ 0x140003080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  {
    result = (unsigned int)dword_140015C48;
    if ( dword_140015C48 >= (unsigned int)dword_1400155D4 )
    {
      memset(&PepParkLists, 0, (unsigned int)(16 * dword_1400155D4));
      v5 = 0;
      KeInitializeEnumerationContext(&v11, &unk_140015A00);
      ...
      if ( !(_DWORD)result )
      {
        ...
        if ( v5 )
        {
          ...
          v8[0] = v5;
          v10 = &PepParkLists;
          result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_140015968)(*(_QWORD *)(v6 + 1120), v8);
          if ( (int)result < 0 )
          {
