/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x14003BA58
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x14003B570 (GetProcessorEfficiencyClass.c)
 */
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  {
LABEL_2:
    InitializeEnumerationContext((__int64)&qword_140015618, 32, (__int64)v6);
