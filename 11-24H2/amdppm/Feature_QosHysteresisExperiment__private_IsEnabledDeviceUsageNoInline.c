/*
 * XREFs of Feature_QosHysteresisExperiment__private_IsEnabledDeviceUsageNoInline @ 0x140004288
 * Callers:
 *     GetCppcRequestMsrPerfControlHandler @ 0x140023BB0 (GetCppcRequestMsrPerfControlHandler.c)
 * Callees:
 *     Feature_QosHysteresisExperiment__private_IsEnabledFallback @ 0x1400042C0 (Feature_QosHysteresisExperiment__private_IsEnabledFallback.c)
 */
