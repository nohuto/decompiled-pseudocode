/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x14003DADC
 * Callers:
...
__int64 __fastcall LpiTranslateCoordinatedIdleStates(__int64 a1, _DWORD *a2, unsigned int **a3, PVOID *a4, _QWORD *a5)
{
  ...
  v45 = 0LL;
  v43 = 0LL;
  v6 = ValidateCoordinatedLpiStates((_DWORD *)qword_140015CA0, 0LL);
  if ( v6 < 0 )
      ...
      while ( (unsigned int)v22 < *(_DWORD *)(v21 + 16) )
      {
        ...
        *(_QWORD *)(v25 + 280) = *(_QWORD *)(v21 + 8);
        ...
        if ( v6 < 0 )
          goto LABEL_18;
        v28 = (char *)(v41 + 304);
        if ( (unsigned int)KeIsEqualAffinityEx(v41, &unk_140015A00) )
          *v28 = 1;
        v29 = v44;
        v24[48] = *v28;
        v30 = (char *)(v21 + v29 + 48);
