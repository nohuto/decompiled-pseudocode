/*
 * XREFs of RegisterKernelPepPerf @ 0x140036A50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v42 )
  {
    ...
    while ( !(unsigned int)EnumerateNextDevice((__int64 *)v45, &v43) )
    {
      ...
      *(_QWORD *)v11 = *(_QWORD *)(v12 + 1184);
      ...
      v14 = *((_DWORD *)v11 + 6);
      v15 = *(_DWORD *)(v4 + 8);
      if ( v14 > v15 || v14 < *(_DWORD *)(v4 + 16) )
      {
        v7 = -1073741811;
        goto LABEL_68;
      }
      *((_DWORD *)v11 + 7) = 100 * v14 / v15;
      v11 += 72;
    }
    v17 = v49;
    ...
    if ( inited )
    {
      ...
      *(_BYTE *)(v5 + 15) = v28;
      v7 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qword_1400158F0)(v5, v34, v33, v32);
      if ( v7 >= 0 )
      {
        ResetEnumerationContext((__int64 *)v45);
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v45, &v43) )
