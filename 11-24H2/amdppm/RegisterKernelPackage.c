/*
 * XREFs of RegisterKernelPackage @ 0x140036530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1400159C0)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_140015638;
...
LABEL_8:
    ...
    *(_DWORD *)(Pool2 + 32) = v3;
    *(_DWORD *)(Pool2 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1400159C8)(v3);
