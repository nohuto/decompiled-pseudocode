/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport3DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1402A9E88
 * Callers:
...
LABEL_57:
    ...
    v15 = (struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 *)ExAllocatePool2(256LL, 104 * v9, 1265072196LL);
    v51 = v15;
  }
  else
  {
  ...
  if ( (_DWORD)v12 )
  {
    Elements = PagedPoolZeroedArray<_DXGK_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE,1>::AllocateElements(
                 (__int64 *)&v48,
                 v12);
  ...
  if ( (_DWORD)v12 )
  {
    ...
    do
    {
      *(struct _D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE **)((char *)v30 + (char *)v16 - (char *)a5) = (struct _D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE *)Elements;
      Elements += 44LL;
      v33 = (__int64)*v30++;
