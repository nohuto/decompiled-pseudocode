/*
 * XREFs of DpQueryFeatureSupport @ 0x1402350B0
 * Callers:
 *     DpIsFeatureEnabled @ 0x140235010 (DpIsFeatureEnabled.c)
 * Callees:
...
LABEL_48:
        ...
        v3[1462] = v7;
        v8 = v7;
        if ( byte_140160D3D && (v7 & 0x6000000) == 0x2000000 )
        {
...
LABEL_47:
      ...
      v3[1462] = v11;
      v12 = v11;
      if ( byte_140160D3D && (v11 & 0xC0000) == 0x40000 )
      {
...
LABEL_34:
    ...
    v3[1462] = v15;
    v16 = v15;
    if ( byte_140160D3D && (v15 & 0x18000) == 0x8000 )
    {
