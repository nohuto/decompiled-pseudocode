/*
 * XREFs of ?OnInitialized@MonitorColorState@DxgMonitor@@QEAAXXZ @ 0x14027BF50
 * Callers:
...
void __fastcall DxgMonitor::MonitorColorState::OnInitialized(DxgMonitor::MonitorColorState *this)
{
  ...
  *((_BYTE *)this + 468) = v11;
  if ( (unsigned int)Feature_ExternalBrightness__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    *((_BYTE *)this + 519) = v14;
    *((_BYTE *)this + 518) = v13;
    *((_DWORD *)this + 131) = (*(__int64 (__fastcall **)(__int64, __int64, const wchar_t *, __int64))(*(_QWORD *)v15 + 40LL))(
                                v15,
                                2LL,
                                L"HdrBrightnessMode",
                                2LL);
  ...
  if ( (unsigned int)Feature_HdrBrightnessPolicy__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    *((_DWORD *)this + 134) = v18;
    LOBYTE(v20) = 1;
    *((_BYTE *)this + 528) = (*(__int64 (__fastcall **)(__int64, __int64, const wchar_t *, __int64))(*(_QWORD *)v19 + 56LL))(
                               v19,
                               8LL,
