/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x14007A200
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_140160C40 )
    {
      v4 = (unsigned int)(dword_140160C30 - 1);
      if ( dword_140160C30 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_140160C40) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_140160BD8;
      ReasonSpecificData[4] = qword_140160C40;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_140160BD8;
      if ( v9 )
      {
