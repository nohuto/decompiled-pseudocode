/*
 * XREFs of ?SmmBuildAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADL@@II@Z @ 0x140060B9C
 * Callers:
 ...
 *     SmmBuildAdlFromAddress @ 0x140060C34 (SmmBuildAdlFromAddress.c)
 *     SmmBuildAdlFromMdl @ 0x1400950B8 (SmmBuildAdlFromMdl.c)
 */
