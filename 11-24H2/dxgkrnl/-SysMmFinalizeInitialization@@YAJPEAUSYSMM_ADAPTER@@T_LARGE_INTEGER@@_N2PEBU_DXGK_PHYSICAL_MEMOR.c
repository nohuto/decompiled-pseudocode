/*
 * XREFs of ?SysMmFinalizeInitialization@@YAJPEAUSYSMM_ADAPTER@@T_LARGE_INTEGER@@_N2PEBU_DXGK_PHYSICAL_MEMORY_RANGE@@IW4SYSMM_LEGACY_IOMMU_FLAGS_MODE@@PEATSYSMM_IOMMU_STATE@@@Z @ 0x1402862F0
 * Callers:
        ...
        union SYSMM_IOMMU_STATE *a8)
{
  ...
  v12 = 0;
  *(_DWORD *)a8 = 0;
  if ( !*(_QWORD *)(a1 + 400) && a5 && (dword_140161610 & 0x400) == 0 )
  {
