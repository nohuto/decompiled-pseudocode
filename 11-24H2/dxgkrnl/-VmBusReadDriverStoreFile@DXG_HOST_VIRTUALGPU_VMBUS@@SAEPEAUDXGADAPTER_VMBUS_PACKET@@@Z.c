/*
 * XREFs of ?VmBusReadDriverStoreFile@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140227230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReadCurrentFile@CDriverStoreCopy@@QEAAJPEAX_KK@Z @ 0x1401CE6FC (-ReadCurrentFile@CDriverStoreCopy@@QEAAJPEAX_KK@Z.c)
