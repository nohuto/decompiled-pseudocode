/*
 * XREFs of ?SmmTelemetryDisableIommu@@YAXPEBUSYSMM_ADAPTER@@II@Z @ 0x140287E20
 * Callers:
...
void __fastcall SmmTelemetryDisableIommu(const struct SYSMM_ADAPTER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_14015E650, 0x400000800000LL) )
    {
      v5 = *v4;
      v7 = v2;
      v8 = v3;
      v6 = (unsigned __int16 *)(*(_QWORD *)(v5 + 64) + 2848LL);
      v11 = 0;
      v9 = v6;
      v10[0] = 0x1000000LL;
