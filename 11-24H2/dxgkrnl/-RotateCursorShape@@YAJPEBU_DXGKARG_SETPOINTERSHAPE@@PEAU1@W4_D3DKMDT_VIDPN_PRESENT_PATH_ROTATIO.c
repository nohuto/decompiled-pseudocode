/*
 * XREFs of ?RotateCursorShape@@YAJPEBU_DXGKARG_SETPOINTERSHAPE@@PEAU1@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@PEBU_DXGK_DRIVERCAPS@@@Z @ 0x140339AF0
 * Callers:
...
LABEL_29:
      DxgkLogInternalTriageEvent(
        ...
        262146LL,
        0xFFFFFFFFLL,
        L"Invalid rotation (0x%I64x) specified",
        v4,
        0LL,
        0LL,
        0LL,
