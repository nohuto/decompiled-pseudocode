/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x1401CC36C
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x1401CC350 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1400709CC (wil_details_FeatureDescriptors_SkipPadding.c)
 *     __security_check_cookie @ 0x1400A1BC0 (__security_check_cookie.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1401CC0B4 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
