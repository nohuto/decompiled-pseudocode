/*
 * XREFs of ?CreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IAEBU_D3DKMT_DISPLAYMODE@@PEAVCOREDEVICEACCESS@@@Z @ 0x140197118
 * Callers:
...
LABEL_26:
    ...
    if ( *((_QWORD *)a2 + 237) == v24 || (*((_BYTE *)a2 + 1917) & 1) != 0 )
    {
      v64 = 1;
      v25 = 0;
    }
...
LABEL_58:
    ...
    if ( v64 )
    {
      ...
      if ( v45 >= 0 )
      {
        *(D3DDDI_MULTISAMPLINGMETHOD *)(4024LL * (unsigned int)v6 + v46 + 1036) = v73.MultisampleMethod;
        *(_DWORD *)(v41 + *((_QWORD *)this + 16) + 1044) = v73.PrivateDriverFormatAttribute;
      }
      else
      {
        WdLogSingleEntry4(3LL, a2, *(_QWORD *)(4024LL * (unsigned int)v6 + v46 + 88), (unsigned int)v6, v45);
        v47 = *((_QWORD *)this + 16);
    ...
    if ( v65 )
    {
      ...
      *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 616) = *((_QWORD *)&v68 + 1);
      *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 600) = *(_QWORD *)(4024LL * (unsigned int)v6
      ...
      if ( !v67 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"0 != DoDShadowPitch", 1207LL, 0LL, 0LL, 0LL, 0LL);
      }
      *(_DWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 608) = v67;
      goto LABEL_107;
    }
    v78 = 0;
    if ( *((_BYTE *)this + 289) || ((v8->DisplayOrientation - 2) & 0xFFFFFFFD) != 0 )
    ...
    v57 = v71;
    *(_DWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 608) = v56;
    v58 = HIDWORD(v75[6]);
...
LABEL_92:
            ...
            KeLeaveCriticalRegion();
            *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 600) = v62;
            ...
            *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 616) = 0LL;
            if ( v66 )
            {
              if ( (_DWORD)v68 && *((_QWORD *)&v68 + 1) )
              {
                *(_DWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 612) = v68;
                *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 616) = *((_QWORD *)&v68 + 1);
              }
              *(_QWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 88) = *(_QWORD *)(4024LL
                                                                                               * (unsigned int)v6
                                                                                               + *((_QWORD *)this + 16)
                                                                                               + 600);
              if ( !v51 )
              ...
              *(_DWORD *)(4024LL * (unsigned int)v6 + *((_QWORD *)this + 16) + 608) = v51;
            }
LABEL_107:
