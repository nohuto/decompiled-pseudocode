/*
 * XREFs of ?WaitForSynchronizationObjectFromGpu@@YAJIPEBIPEB_K_KIPEAVDXGPROCESS@@_N4444@Z @ 0x14029F130
 * Callers:
...
LABEL_6:
  if ( !Pool2 )
    return 3221225495LL;
  v132 = 0LL;
  DXGCONTEXTBYHANDLE::DXGCONTEXTBYHANDLE((DXGCONTEXTBYHANDLE *)&v133, a5, (struct _KTHREAD **)a6, &v132, a8, 1);
  if ( !v132 )
  {
...
LABEL_17:
      ...
      if ( v168 )
      {
        ...
        if ( *((_DWORD *)v71 + 50) != 1 )
        {
          v165 = 0;
          if ( KeGetCurrentThread() != *((struct _KTHREAD **)v164 + 23) )
            DXGADAPTER::ReleaseCoreResource(v164, 0LL);
          v166 = 0LL;
          goto LABEL_167;
        }
      }
...
LABEL_115:
  ...
  if ( (unsigned int)v11 > 4 )
  {
    ...
    {
      v40 = (_BYTE *)ExAllocatePool2(64LL, 8 * v11, 1265072196LL);
      v155 = v40;
      goto LABEL_64;
    }
  }
