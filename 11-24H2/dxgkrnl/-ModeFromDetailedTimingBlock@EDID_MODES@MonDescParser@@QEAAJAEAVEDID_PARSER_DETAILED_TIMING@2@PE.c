/*
 * XREFs of ?ModeFromDetailedTimingBlock@EDID_MODES@MonDescParser@@QEAAJAEAVEDID_PARSER_DETAILED_TIMING@2@PEAU_VideoModeDescriptor@@@Z @ 0x14005AA80
 * Callers:
...
LABEL_14:
        v17 = v4 / i;
        a3->VerticalRefreshRateNumerator = v4 / i;
        v18 = v15;
        v19 = v4;
        v20 = v18 / i;
        v21 = v13;
