/*
 * XREFs of ?FlushScheduler@DXGDEVICE@@QEAAXW4DXGDEVICE_FLUSHSCHEDULER_REASON@@I_N@Z @ 0x140376424
 * Callers:
...
LABEL_20:
                ...
                DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, v17, v16, 0LL, 0LL, 0LL, 0LL);
                goto LABEL_21;
              }
              LODWORD(v18) = 7;
            }
