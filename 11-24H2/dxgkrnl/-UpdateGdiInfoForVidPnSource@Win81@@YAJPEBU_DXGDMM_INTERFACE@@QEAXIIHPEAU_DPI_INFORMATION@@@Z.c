/*
 * XREFs of ?UpdateGdiInfoForVidPnSource@Win81@@YAJPEBU_DXGDMM_INTERFACE@@QEAXIIHPEAU_DPI_INFORMATION@@@Z @ 0x1401DBDB8
 * Callers:
 ...
 *     ?FillDpiInfo@Win81@@YAXAEBUtagSIZE@@0IIHPEAU_DPI_INFORMATION@@@Z @ 0x1401DB964 (-FillDpiInfo@Win81@@YAXAEBUtagSIZE@@0IIHPEAU_DPI_INFORMATION@@@Z.c)
        ...
        __m128i *a6)
{
  ...
  if ( !Current || !DXGPROCESS::IsRemoteConnection(Current) )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      v65 = v7;
LABEL_13:
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v19, (__int64)v65, v68, (__int64)v70, 0LL, 0LL);
      if ( v93 )
        v95(v96, v15);
...
LABEL_77:
      ...
      if ( !v71 )
        goto LABEL_77;
      v48 = 100 * v44;
      v49 = (struct _DPI_INFORMATION *)&unk_140100760;
      v50 = 100 * v45;
      do
      {
        v51 = *(_DWORD *)v49;
        ...
        v114 = v111;
        if ( Win81::operator>=(&v114, dword_1400A8248) )
          break;
        v49 = (struct _DPI_INFORMATION *)((char *)v49 - 4);
        --v53;
      }
      while ( v53 );
      v116[0].m128i_i32[3] = PairedScaleFactorsArray_Win81[v53];
