/*
 * XREFs of ?SetModeBehavior@DXGADAPTER@@AEAAXEE@Z @ 0x140195B8C
 * Callers:
  ...
  *(_QWORD *)&v9.Request.0 = 0LL;
  ...
  if ( a3 )
  {
    ...
    *(_QWORD *)&v7.Length = 1310738LL;
    ...
    if ( ReadRegistryDwordKeyValue(&v8, &v7, &v6) >= 0 )
  ...
  if ( (int)(v4 + 0x80000000) >= 0 && v4 != -1073741637 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000LL,
      0xFFFFFFFFLL,
      L"Unexpected error 0x%I64x from DdiControlModeBehavior",
      v5,
      0LL,
      0LL,
      0LL,
