/*
 * XREFs of ?SetLastCddIntegerVSync@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x140031638
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::SetLastCddIntegerVSync(ADAPTER_DISPLAY *this, unsigned int a2, int a3)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 6596LL, 0LL, 0LL, 0LL, 0LL);
  }
