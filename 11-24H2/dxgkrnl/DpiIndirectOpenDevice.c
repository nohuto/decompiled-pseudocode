/*
 * XREFs of DpiIndirectOpenDevice @ 0x14024FB34
 * Callers:
 *     DpiFdoOpenDeviceFileObjectIfNeeded @ 0x1402443B4 (DpiFdoOpenDeviceFileObjectIfNeeded.c)
 * Callees:
 *     ?DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x14024F388 (-DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z.c)
 */
