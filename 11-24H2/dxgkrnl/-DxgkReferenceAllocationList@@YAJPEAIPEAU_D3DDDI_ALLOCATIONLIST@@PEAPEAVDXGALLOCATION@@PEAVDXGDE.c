/*
 * XREFs of ?DxgkReferenceAllocationList@@YAJPEAIPEAU_D3DDDI_ALLOCATIONLIST@@PEAPEAVDXGALLOCATION@@PEAVDXGDEVICE@@@Z @ 0x140334A74
 * Callers:
...
LABEL_10:
    if ( !v14 )
    {
      ...
      WdLogGlobalForLineNumber = 14253;
      v8 = -1071775468;
      break;
    }
    ...
    {
      WdLogSingleEntry1(3LL, hAllocation);
      WdLogGlobalForLineNumber = 14275;
      v8 = -1071775467;
      break;
    }
