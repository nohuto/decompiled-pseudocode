/*
 * XREFs of ?VmBusSendBlt@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGCONTEXT@@PEAVDXGHWQUEUE@@IIPEAUtagRECT@@3IPEBU5@IPEAE@Z @ 0x140227920
 * Callers:
...
LABEL_3:
  ...
  *(_OWORD *)v25 = 0LL;
  ...
  if ( v25[0] )
  {
    ...
    *((_DWORD *)v17 + 19) = Size;
    ...
    if ( v19 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 11490;
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"VmBusSendBlt failed: 0x%I64x", v20, 0LL, 0LL, 0LL, 0LL);
    }
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 11444;
