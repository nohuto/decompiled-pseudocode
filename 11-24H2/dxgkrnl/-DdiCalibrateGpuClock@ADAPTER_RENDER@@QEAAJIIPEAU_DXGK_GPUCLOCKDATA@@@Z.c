/*
 * XREFs of ?DdiCalibrateGpuClock@ADAPTER_RENDER@@QEAAJIIPEAU_DXGK_GPUCLOCKDATA@@@Z @ 0x140015728
 * Callers:
 *     ?PerformClockCalibration@ADAPTER_RENDER@@QEAAXXZ @ 0x140013EBC (-PerformClockCalibration@ADAPTER_RENDER@@QEAAXXZ.c)
 *     ADAPTER_RENDER_DdiCalibrateGpuClock @ 0x14006BBA0 (ADAPTER_RENDER_DdiCalibrateGpuClock.c)
