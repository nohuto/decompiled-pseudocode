/*
 * XREFs of ?LidStateReliabilityChangeCallback@DisplayDiagnostics@@CAJPEBU_GUID@@PEAXK1@Z @ 0x14006F1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *Context)
{
  ...
  if ( ValueLength < 4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"ValueLength >= sizeof(LONG)", 68LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *Value > 1u )
  {
    WdLogSingleEntry0(1LL);
