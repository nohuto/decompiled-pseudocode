/*
 * XREFs of ?TdrCollectBugcheckSecondaryDumpData@@YAKPEAXK_N1@Z @ 0x140071BE0
 * Callers:
 *     _DxgDbgBugcheckCallback @ 0x14007A200 (_DxgDbgBugcheckCallback.c)
...
__int64 __fastcall TdrCollectBugcheckSecondaryDumpData(char *a1, unsigned int a2, char a3, unsigned __int8 a4)
{
  ...
  if ( a4 )
  {
    ...
    v39[0] = *((_QWORD *)Global + 120);
    v39[1] = *((_QWORD *)Global + 121);
    v31 = 2LL;
    do
    {
      v32 = *v30;
