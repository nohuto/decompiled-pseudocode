/*
 * XREFs of ?Stop@DXGADAPTER@@QEAAXEE@Z @ 0x140195E9C
 * Callers:
...
void __fastcall DXGADAPTER::Stop(DXGADAPTER *this, unsigned __int8 a2, unsigned __int8 a3)
{
  ...
  *((_QWORD *)this + 18) = 0LL;
  ...
  REMOTEMONITORMAPPING::Clear((struct DXGGLOBAL *)((char *)v20 + 305256), &v40);
  v21 = DXGGLOBAL::GetGlobal();
  HOSTVMMONITORMAPPING::RemoveMapping((struct DXGGLOBAL *)((char *)v21 + 305312), v7);
  WdLogSingleEntry1(4LL, this);
