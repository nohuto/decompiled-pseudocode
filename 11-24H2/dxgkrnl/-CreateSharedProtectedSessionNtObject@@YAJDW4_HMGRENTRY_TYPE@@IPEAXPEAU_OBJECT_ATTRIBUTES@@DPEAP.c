/*
 * XREFs of ?CreateSharedProtectedSessionNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1401E0B10
 * Callers:
  ...
  if ( v16 )
  {
    ...
    else
    {
      if ( Object )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pObject == NULL", 553LL, 0LL, 0LL, 0LL, 0LL);
      }
