/*
 * XREFs of ?SetupPresentParameters@BLTENTRY@@QEAAJPEAVBLTQUEUE@@PEAVDXGCONTEXT@@PEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@E@Z @ 0x1402F8EB4
 * Callers:
        ...
        unsigned __int8 a7)
{
  ...
  NTSTATUS v24; // eax
  int v25; // ebx
  DXGALLOCATIONREFERENCE *v26; // rcx
  __int64 v27; // rdx
...
LABEL_9:
  ...
  if ( *((_BYTE *)a3 + 434) )
  {
    ...
    v26 = (DXGALLOCATIONREFERENCE *)v10;
  }
  else
  {
    ...
    if ( !v36[8] )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Primary pitch invalid", 180LL, 0LL, 0LL, 0LL, 0LL);
      return 3221225485LL;
    }
    v20 = *((_QWORD *)a3 + 7);
    v37 = 0LL;
    ...
    if ( *(_DWORD *)v20 != -791674878 || (v21 = *(void **)(v20 + 16)) == 0LL || !*(_QWORD *)(v20 + 24) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid Dod esacpe", 194LL, 0LL, 0LL, 0LL, 0LL);
      return 3221225485LL;
    }
    Object = 0LL;
