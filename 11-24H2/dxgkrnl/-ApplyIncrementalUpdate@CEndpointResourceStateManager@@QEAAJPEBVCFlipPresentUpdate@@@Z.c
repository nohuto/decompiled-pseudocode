/*
 * XREFs of ?ApplyIncrementalUpdate@CEndpointResourceStateManager@@QEAAJPEBVCFlipPresentUpdate@@@Z @ 0x14001972C
 * Callers:
...
LABEL_16:
      ...
      *((_QWORD *)v11 + 7) = *((_QWORD *)v2 + 4);
      ...
      if ( v12 )
      {
        ...
        {
          CCompositionSurface::UpdatePresentRate((CCompositionSurface *)(v12 + 40));
