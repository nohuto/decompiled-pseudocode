/*
 * XREFs of ?DestroySyncContextForFlipManager@CAdapterCollection@@QEAAXAEAU_LUID@@PEAUFlipManagerObject@@PEA_N@Z @ 0x14009A6BC
 * Callers:
 *     ?DestroySyncContextForFlipManager@CTokenManager@@UEAAXAEAU_LUID@@PEAUFlipManagerObject@@@Z @ 0x14009A2F0 (-DestroySyncContextForFlipManager@CTokenManager@@UEAAXAEAU_LUID@@PEAUFlipManagerObject@@@Z.c)
 * Callees:
