/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1400800A0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v12 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          ...
          if ( *(char **)(*(_QWORD *)Context + 8LL) != Context
            ...
            || (*v18 = v17,
                v17[1] = v18,
                v19 = (char **)qword_1401611D8,
                *(__int64 **)qword_1401611D8 != &qword_1401611D0) )
          {
            __fastfail(3u);
          }
          *(_QWORD *)Context = &qword_1401611D0;
          *((_QWORD *)Context + 1) = v19;
          *v19 = Context;
          qword_1401611D8 = (__int64)Context;
