...
__int64 __fastcall VIDSCH_EXPORT::VidSchCreateSyncObject(
        ...
        __int64 a11)
{
  return (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64, _QWORD, __int64, __int64, __int64, __int64))(*(_QWORD *)(a1 + 8) + 616LL))(
           a2,
           a3,
           a4,
           a5,
