/*
 * XREFs of ?_FindTopologySetIdDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x14031C570
 * Callers:
 ...
 *     ?GetTimestamp@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAAEBT_LARGE_INTEGER@@XZ @ 0x14031D4D4 (-GetTimestamp@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAAEBT_LARGE_INTEGER@@XZ.c)
 ...
 *     ?_ResolveTopologySetId@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCCD_TOPOLOGY@@_N@Z @ 0x14033DDB0 (-_ResolveTopologySetId@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCCD_TOPOLOGY@@_N@Z.c)
 *     ?IsEnabledSetEqual@CCD_SET_STRING_ID@@QEBA_NAEBV1@@Z @ 0x14033E340 (-IsEnabledSetEqual@CCD_SET_STRING_ID@@QEBA_NAEBV1@@Z.c)
...
LABEL_4:
  ...
  if ( v10 )
  {
    if ( !CCD_SET_STRING_ID::IsSubsetOf((CCD_SET_STRING_ID *)v6, v10) )
      return 0LL;
    OverflowTopology = CCD_RECENT_TOPOLOGY_RETRIEVER::_GetOverflowTopology(a2, v9);
    v12 = OverflowTopology;
    if ( !OverflowTopology )
    {
    ...
    CCD_TOPOLOGY::SetModalitySetId(OverflowTopology, (const struct CCD_SET_STRING_ID *)v6);
    ...
    if ( v14 )
    {
      IsSimilarTopology = CCD_SET_STRING_ID::IsSimilarTopology(v14, (const struct CCD_SET_STRING_ID *)v6);
LABEL_19:
    ...
    {
      IsSimilarTopology = CCD_SET_STRING_ID::IsEnabledSetEqual(
                            RecentTopologySetId,
                            (const struct CCD_SET_STRING_ID *)v6);
      goto LABEL_19;
    }
