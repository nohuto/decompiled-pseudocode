/*
 * XREFs of ?VmBusWnfNotification@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1402318F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusWnfNotification(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( RtlCompareMemory((const void *)(v1 + 24), &WNF_DX_VIDMM_TRIM_NOTIFICATION, 8uLL) == 8
    && *(_DWORD *)v3 == *((_DWORD *)DXGGLOBAL::GetGlobal() + 252)
    && *(_DWORD *)(v1 + 48) == *((_DWORD *)DXGGLOBAL::GetGlobal() + 253) )
  {
    *v3 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 127);
