/*
 * XREFs of ?Initialize@OUTPUTDUPL_SESSION_MGR@@QEAAJXZ @ 0x1401E52D4
 * Callers:
...
LABEL_6:
    DxgkLogInternalTriageEvent(0LL, 262145LL, 0xFFFFFFFFLL, v8, *((unsigned int *)this + 1), v7, 0LL, 0LL, 0LL);
    return 3221225495LL;
  }
  if ( !*v5 )
  {
