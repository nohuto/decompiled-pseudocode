/*
 * XREFs of ?DdiNotifyWorkSubmission@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_NOTIFYWORKSUBMISSION@@@Z @ 0x1401A68EC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiNotifyWorkSubmission(
        ADAPTER_RENDER *this,
        struct _DXGKARG_NOTIFYWORKSUBMISSION *a2,
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5166);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5166);
  ...
  v10 = (*(int (__fastcall **)(struct _DXGKARG_NOTIFYWORKSUBMISSION *))(*((_QWORD *)this + 2) + 1560LL))(a2);
