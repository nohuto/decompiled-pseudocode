/*
 * XREFs of ?DdiGetRootPageTableSize@ADAPTER_RENDER@@QEAA_KPEAU_DXGKARG_GETROOTPAGETABLESIZE@@@Z @ 0x1403D7984
 * Callers:
 *     ADAPTER_RENDER_DdiGetRootPageTableSize @ 0x140058E10 (ADAPTER_RENDER_DdiGetRootPageTableSize.c)
 * Callees:
