/*
 * XREFs of ??1DXGHWQUEUE@@IEAA@XZ @ 0x140406D50
 * Callers:
...
void __fastcall DXGHWQUEUE::~DXGHWQUEUE(DXGHWQUEUE *this)
{
  ...
  if ( !*((_BYTE *)this + 112) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"_DestroyedCoreState", 32LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_QWORD *)this + 18) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 33;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"_Doorbell == nullptr", 33LL, 0LL, 0LL, 0LL, 0LL);
  }
