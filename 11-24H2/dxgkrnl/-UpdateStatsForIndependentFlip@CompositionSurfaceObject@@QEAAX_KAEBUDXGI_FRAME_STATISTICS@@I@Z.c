/*
 * XREFs of ?UpdateStatsForIndependentFlip@CompositionSurfaceObject@@QEAAX_KAEBUDXGI_FRAME_STATISTICS@@I@Z @ 0x14003779C
 * Callers:
        ...
        int a4)
{
  ...
  *((_QWORD *)v5 + 1) = PsGetCurrentThreadId();
  if ( *((_DWORD *)this + 44) )
  {
    for ( i = (__int64 *)*((_QWORD *)this + 20); i != (__int64 *)((char *)this + 160); i = (__int64 *)*i )
    {
      if ( *(i - 1) == a2 )
      {
        v10 = *(_OWORD *)a3;
