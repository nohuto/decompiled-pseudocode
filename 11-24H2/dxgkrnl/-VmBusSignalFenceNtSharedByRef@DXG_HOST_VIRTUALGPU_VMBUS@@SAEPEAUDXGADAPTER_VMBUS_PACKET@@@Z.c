/*
 * XREFs of ?VmBusSignalFenceNtSharedByRef@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1403E7B90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusSignalFenceNtSharedByRef(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(v1 + 155) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Presentation is disabled", 4151LL, 0LL, 0LL, 0LL, 0LL);
    return 0;
  }
    ...
    if ( v7 < *(_DWORD *)(v6 + 296) )
    {
        ...
        && (*(_DWORD *)(v8 + 16LL * v7 + 8) & 0x2000) == 0 )
      {
        ...
        if ( v9 )
        {
          if ( v9 == 13 )
          {
            v10 = *(DXGSHAREDVMOBJECT **)(v8 + 16LL * v7);
