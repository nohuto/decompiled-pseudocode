/*
 * XREFs of ?UpdateOverlay@DXGOVERLAY@@QEAAJPEAU_D3DKMT_UPDATEOVERLAY@@@Z @ 0x1401E8134
 * Callers:
...
__int64 __fastcall DXGOVERLAY::UpdateOverlay(DXGOVERLAY *this, struct _D3DKMT_UPDATEOVERLAY *a2)
{
  ...
  __int64 v17[2]; // [rsp+50h] [rbp-78h] BYREF
  ...
  {
    v8 = *((_QWORD *)this + 2);
    if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v17[0] + 8) + 16LL) + 16LL) == *(_QWORD *)(*(_QWORD *)(v8 + 16) + 16LL) )
    {
      v9 = *(_QWORD *)(v17[0] + 48);
      if ( (*(_DWORD *)(v9 + 4) & 8) == 0 || (*(_DWORD *)(v17[0] + 72) & 0x800) == 0 )
      {
      ...
      VIDMM_EXPORT::VidMmGetPinnedAllocationInfo(
        ...
        *(struct VIDMM_MULTI_GLOBAL_ALLOC **)(*(_QWORD *)(v17[0] + 48) + 8LL),
      ...
      if ( PrivateDriverDataSize && a2->OverlayInfo.pPrivateDriverData )
      {
        ...
        {
          updated = -1073741801;
          WdLogSingleEntry3(3LL, this, v18.OverlayInfo.PrivateDriverDataSize, -1073741801LL);
          WdLogGlobalForLineNumber = 352;
          goto LABEL_30;
        }
        v13 = v18.OverlayInfo.PrivateDriverDataSize;
        pPrivateDriverData = a2->OverlayInfo.pPrivateDriverData;
        v15 = (ULONG64)pPrivateDriverData + v18.OverlayInfo.PrivateDriverDataSize;
      ...
      if ( updated >= 0 )
        *((_QWORD *)this + 6) = v17[0];
      DXGQUOTAALLOCATOR<256,1835156294>::operator delete(v18.OverlayInfo.pPrivateDriverData);
      goto LABEL_30;
    }
    updated = -1073741811;
    WdLogSingleEntry3(2LL, *((_QWORD *)this + 2), v17[0], -1073741811LL);
