/*
 * XREFs of ?IommuFreeGpuVa@ADAPTER_RENDER@@CAJPEAUSYSMM_ADAPTER@@_KPEAX@Z @ 0x14019F5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::IommuFreeGpuVa(struct SYSMM_ADAPTER *a1, D3DGPU_VIRTUAL_ADDRESS a2, _QWORD *a3)
{
  ...
  *(_QWORD *)&v7.hAdapter = 0LL;
  ...
  return VIDMM_EXPORT::VidMmFreeGpuVirtualAddress(v4, v3, *((struct DXGPROCESS **)Global + 171), &v7);
}
