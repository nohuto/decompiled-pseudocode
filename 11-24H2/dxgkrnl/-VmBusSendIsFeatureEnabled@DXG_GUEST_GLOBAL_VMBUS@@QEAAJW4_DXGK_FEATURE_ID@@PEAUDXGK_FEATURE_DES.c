/*
 * XREFs of ?VmBusSendIsFeatureEnabled@DXG_GUEST_GLOBAL_VMBUS@@QEAAJW4_DXGK_FEATURE_ID@@PEAUDXGK_FEATURE_DESC@@PEAU_DXGK_ISFEATUREENABLED_RESULT@@@Z @ 0x14022C584
 * Callers:
  ...
  if ( v14[0] )
  {
    ...
    *((_DWORD *)v8 + 6) = a2;
    ...
    if ( v10 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 14294;
    }
    else
    {
      v9 = -1073741823;
