/*
 * XREFs of DxgkDdiPrepareLiveMigration @ 0x140210518
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  if ( *a6 >= 2 )
  {
    ...
    if ( bTracingEnabled )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        196619LL,
        0xFFFFFFFFLL,
        L"PrepareLiveMigration called on vf index %1, with status %2",
        (unsigned int)a6,
        v11,
        0LL,
        0LL,
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000LL,
      0xFFFFFFFFLL,
      L"PrepareLiveMigration: pLiveMigrationBuffersInfo is not large enough. LiveMigrationBufferCount: %d",
      Format,
      0LL,
      0LL,
      0LL,
