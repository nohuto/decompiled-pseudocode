/*
 * XREFs of ?ApplyCoreSyncAction@DXGADAPTER@@QEAAXW4DXGADAPTERCORESYNC_ACTION@@@Z @ 0x1402C801C
 * Callers:
...
void __fastcall DXGADAPTER::ApplyCoreSyncAction(__int64 a1, int a2)
{
  ...
  WdLogSingleEntry3(9LL, a1, v2, *((unsigned __int8 *)Global + 304368));
        ...
        if ( *(_BYTE *)(a1 + 3053) )
        {
          ...
          *((_QWORD *)g_TdrRecoveryInProgress + 363) = KeGetCurrentThread();
          ...
          if ( *(_BYTE *)(a1 + 3053) )
          {
            ...
            DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"!IsTdrPending()", 3888LL, 0LL, 0LL, 0LL, 0LL);
          }
        }
      }
    }
