/*
 * XREFs of ??1DXGPROCESS@@MEAA@XZ @ 0x1403787F0
 * Callers:
...
void __fastcall DXGPROCESS::~DXGPROCESS(DXGPROCESS *this)
{
  ...
  *(_QWORD *)this = &DXGPROCESS::`vftable';
  if ( *((_QWORD *)this + 55) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_DecommittableBytes == 0", 1272LL, 0LL, 0LL, 0LL, 0LL);
  }
  v11[0] = 0;
  ActivityId = 0LL;
  ...
  if ( *((_QWORD *)this + 72) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"nullptr == m_pVailObjectRef", 1294LL, 0LL, 0LL, 0LL, 0LL);
  }
  v4 = *((_QWORD *)this + 8);
  if ( v4 )
  {
