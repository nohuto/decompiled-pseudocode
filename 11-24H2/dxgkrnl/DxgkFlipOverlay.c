/*
 * XREFs of DxgkFlipOverlay @ 0x1401E9130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlipOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v20; // [rsp+50h] [rbp-E8h] BYREF
  __int64 v21; // [rsp+58h] [rbp-E0h]
  char v22; // [rsp+60h] [rbp-D8h]
  _BYTE v23[8]; // [rsp+68h] [rbp-D0h] BYREF
  DXGDEVICE *v24; // [rsp+70h] [rbp-C8h] BYREF
  _BYTE v25[16]; // [rsp+78h] [rbp-C0h] BYREF
  _D3DKMT_FLIPOVERLAY v26; // [rsp+88h] [rbp-B0h] BYREF
  _BYTE v27[16]; // [rsp+A8h] [rbp-90h] BYREF
  _BYTE v28[24]; // [rsp+B8h] [rbp-80h] BYREF
  _BYTE v29[80]; // [rsp+D0h] [rbp-68h] BYREF
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(a1, (__int64)&EventProfilerEnter, a3, 2024);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 2024);
...
LABEL_26:
  ...
  RtlCopyVolatileMemory(&v26, v3, 0x20uLL);
  v24 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v23, v26.hDevice, (struct _KTHREAD **)Current, &v24);
...
LABEL_25:
  ...
  hOverlay = v26.hOverlay;
  v8 = (v26.hOverlay >> 6) & 0xFFFFFF;
  if ( v8 >= *((_DWORD *)Current + 74) )
    goto LABEL_17;
  v9 = *((_QWORD *)Current + 35);
  if ( ((v26.hOverlay >> 25) & 0x60) != (*(_BYTE *)(v9 + 16LL * v8 + 8) & 0x60) )
    goto LABEL_17;
...
LABEL_24:
  ...
  {
    v5 = -1073741811;
    WdLogSingleEntry3(3LL, hOverlay, v26.hDevice, -1073741811LL);
  ...
  if ( v16 >= 0 )
  {
    if ( !DXGDEVICE::IsSupportOverlay((DXGDEVICE *)v6) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDevice->IsSupportOverlay()", 877LL, 0LL, 0LL, 0LL, 0LL);
    }
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)v27, v6[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v27);
    v5 = DXGOVERLAY::FlipOverlay(v11, &v26);
