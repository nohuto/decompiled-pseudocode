/*
 * XREFs of _lambda_fde23358e365dc4fa0dbed7c255181d0_::operator() @ 0x14018D710
 * Callers:
...
char __fastcall lambda_fde23358e365dc4fa0dbed7c255181d0_::operator()(__int64 a1)
{
  unsigned int *v1; // rsi
  char *v2; // rbx
  int *v3; // rdi
  ...
  {
    LOBYTE(CurrentProcessSessionId) = tlgKeywordOn((__int64)&dword_14015E650, 0x400000000000LL);
