/*
 * XREFs of ?CalculatePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAXI@Z @ 0x140077278
 * Callers:
 *     ?RecordVSync@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1400777C0 (-RecordVSync@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 * Callees:
 *     ?CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z @ 0x1400771F0 (-CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z.c)
        ...
        unsigned int a2)
{
  ...
  v2 = *(_DWORD **)this;
  v4 = *((_DWORD *)this + 14);
  if ( a2 <= *(_DWORD *)(*(_QWORD *)this + 4640LL) )
  {
    if ( a2 > v2[1161] && v4 )
  ...
  if ( a2 < v2[1162] && v4 < **((_DWORD **)this + 2) - 1 )
  {
    v6 = *((_DWORD *)this + 20);
    v7 = *((_DWORD *)this + 21) + 1;
    *((_DWORD *)this + 21) = v7;
