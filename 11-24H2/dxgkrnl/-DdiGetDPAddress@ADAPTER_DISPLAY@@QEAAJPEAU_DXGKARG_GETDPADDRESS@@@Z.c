/*
 * XREFs of ?DdiGetDPAddress@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1401A5B60
 * Callers:
 *     NtDxgkDisplayPortOperation @ 0x14006E190 (NtDxgkDisplayPortOperation.c)
 *     ?GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x14027DB30 (-GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z.c)
 * Callees:
