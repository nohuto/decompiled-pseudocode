/*
 * XREFs of DpiGetDriverStorePath @ 0x1403EE46C
 * Callers:
 ...
 *     wcsstr_0 @ 0x140064F33 (wcsstr_0.c)
 */
...
__int64 __fastcall DpiGetDriverStorePath(__int64 a1, char *a2, int *a3)
{
  ...
  {
    RtlStringCbCopyW(a2, (unsigned __int16)v14, *((char **)&v14 + 1));
    *(_WORD *)&a2[2 * ((unsigned __int64)(unsigned __int16)v14 >> 1)] = 0;
    v7 = wcsstr_0((const wchar_t *)a2, L"FileRepository");
    if ( !v7 )
    {
      v6 = -1073741811;
      goto LABEL_19;
