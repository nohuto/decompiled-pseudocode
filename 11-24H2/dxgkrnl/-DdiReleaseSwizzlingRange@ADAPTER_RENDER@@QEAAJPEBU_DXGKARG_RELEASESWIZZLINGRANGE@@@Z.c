/*
 * XREFs of ?DdiReleaseSwizzlingRange@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RELEASESWIZZLINGRANGE@@@Z @ 0x1403E3618
 * Callers:
 *     ADAPTER_RENDER_DdiReleaseSwizzlingRange @ 0x14005B0B0 (ADAPTER_RENDER_DdiReleaseSwizzlingRange.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5007);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 5007);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))(*((_QWORD *)this + 2) + 512LL))(
