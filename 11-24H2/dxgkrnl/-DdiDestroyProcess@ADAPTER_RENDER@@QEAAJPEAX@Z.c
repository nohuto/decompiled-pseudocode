/*
 * XREFs of ?DdiDestroyProcess@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1403C0508
 * Callers:
 *     ADAPTER_RENDER_DdiDestroyProcess @ 0x14006BCC0 (ADAPTER_RENDER_DdiDestroyProcess.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyProcess(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5065);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5065);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 984LL))(
