/*
 * XREFs of ?DdiCancelFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELFLIPS@@@Z @ 0x140068480
 * Callers:
 *     ADAPTER_DISPLAY_DdiCancelFlips @ 0x14006BAE0 (ADAPTER_DISPLAY_DdiCancelFlips.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiCancelFlips(ADAPTER_DISPLAY *this, struct _DXGKARG_CANCELFLIPS *a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5160);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5160);
  ...
  v10 = *((_QWORD *)this + 2);
  v11 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CANCELFLIPS *))(v10 + 1488);
  if ( v11 )
