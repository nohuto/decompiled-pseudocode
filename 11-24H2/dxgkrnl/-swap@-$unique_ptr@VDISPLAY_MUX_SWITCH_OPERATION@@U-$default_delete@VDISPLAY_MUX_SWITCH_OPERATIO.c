/*
 * XREFs of ?swap@?$unique_ptr@VDISPLAY_MUX_SWITCH_OPERATION@@U?$default_delete@VDISPLAY_MUX_SWITCH_OPERATION@@@wistd@@@wistd@@QEAAXAEAV12@@Z @ 0x1400889E8
 * Callers:
 ...
 * Callees:
 *     ?swap@?$__compressed_pair@PEAVDISPLAY_MUX_PAIRING@@U?$default_delete@VDISPLAY_MUX_PAIRING@@@wistd@@@wistd@@QEAAXAEAV12@@Z @ 0x1400889D4 (-swap@-$__compressed_pair@PEAVDISPLAY_MUX_PAIRING@@U-$default_delete@VDISPLAY_MUX_PAIRING@@@wist.c)
 */
