/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1400729C8
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4 && tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000020LL) )
  {
