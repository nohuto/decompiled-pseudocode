/*
 * XREFs of ?CreateMonitorSetId@DpiPersistence@@YAJAEBU_LUID@@IPEAU_UNICODE_STRING@@PEA_N@Z @ 0x14033CEB0
 * Callers:
...
LABEL_3:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v12, v13, psz, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
    ...
    *(_QWORD *)v48 = PrimaryDisplaySource;
    if ( PrimaryDisplaySource )
    {
      ...
      if ( !v22 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 276LL, 0LL, 0LL, 0LL, 0LL);
      }
      if ( !*(_QWORD *)(v22 + 3120) )
      {
        WdLogSingleEntry0(1LL);
