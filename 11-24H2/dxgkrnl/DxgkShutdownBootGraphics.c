/*
 * XREFs of DxgkShutdownBootGraphics @ 0x1402C9DC0
 * Callers:
...
__int64 __fastcall DxgkShutdownBootGraphics(struct DXGDEVICE *a1, unsigned int a2)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v11, (struct DXGGLOBAL *)((char *)Global + 1600), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v11);
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 397) != 4 && *((_DWORD *)DXGGLOBAL::GetGlobal() + 397) )
    InbvNotifyDisplayOwnershipChange(0LL, 0LL);
  v5 = (void *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 185);
  if ( v5 )
  {
    ExFreePoolWithTag(v5, 0x4B677844u);
    *((_QWORD *)DXGGLOBAL::GetGlobal() + 185) = 0LL;
  }
  v6 = (void *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 199);
  if ( v6 )
  {
    ExFreePoolWithTag(v6, 0x4B677844u);
    *((_QWORD *)DXGGLOBAL::GetGlobal() + 199) = 0LL;
  }
  v15 = 0LL;
  if ( a1 )
  {
  ...
  if ( v8 )
  {
    ...
    if ( v9 )
    {
      ...
      v8 = v15;
      if ( *(_DWORD *)(v9 + 200) == 1 && *((_BYTE *)v15 + 1952) )
      {
...
LABEL_8:
  *((_DWORD *)DXGGLOBAL::GetGlobal() + 397) = 4;
