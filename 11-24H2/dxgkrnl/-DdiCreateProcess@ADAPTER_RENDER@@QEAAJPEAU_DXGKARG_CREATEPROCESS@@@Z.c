/*
 * XREFs of ?DdiCreateProcess@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEPROCESS@@@Z @ 0x1403AD0A8
 * Callers:
 *     ADAPTER_RENDER_DdiCreateProcess @ 0x14006BC40 (ADAPTER_RENDER_DdiCreateProcess.c)
