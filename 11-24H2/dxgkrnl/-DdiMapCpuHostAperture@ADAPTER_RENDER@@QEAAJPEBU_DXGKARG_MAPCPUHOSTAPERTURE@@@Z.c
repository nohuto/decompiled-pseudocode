/*
 * XREFs of ?DdiMapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_MAPCPUHOSTAPERTURE@@@Z @ 0x14032CD30
 * Callers:
 *     ADAPTER_RENDER_DdiMapCpuHostAperture @ 0x14003B810 (ADAPTER_RENDER_DdiMapCpuHostAperture.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5061);
  }
  else
  {
    v17 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5061);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_MAPCPUHOSTAPERTURE *))(*((_QWORD *)this + 2) + 960LL))(
