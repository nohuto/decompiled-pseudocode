/*
 * XREFs of ?VmBusOpenSyncObject@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140225AD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
                DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v14, v15, 0LL, 0LL, 0LL, 0LL);
                v81[1] = -1073741811;
                DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v80);
LABEL_77:
    ...
    v28 = (struct _KTHREAD **)*((_QWORD *)a1 + 11);
    v71 = 0LL;
