/*
 * XREFs of ?Initialize@DXGPROCESS_RENDER_ADAPTER_INFO@@QEAAJPEAVDXGPROCESS@@PEAVADAPTER_RENDER@@@Z @ 0x1403ACC00
 * Callers:
...
LABEL_27:
    ...
    {
      ProcessID = DXGPROCESS::GetProcessID(a2);
      for ( i = 0; i < *((_DWORD *)this + 4); *(_DWORD *)(*((_QWORD *)this + 3) + 4 * v20) = ProcessID )
        v20 = i++;
      goto LABEL_7;
    }
...
LABEL_36:
      ...
      LODWORD(v6) = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD))qword_140161530)(3LL, 0LL, 0LL);
      if ( (int)v6 < 0 )
        goto LABEL_35;
    }
