/*
 * XREFs of ?PrepareStagingBuffer@DXGPRESENT@@QEAAJPEAVDXGDEVICE@@IPEAVCOREDEVICEACCESS@@PEAI@Z @ 0x1403BB8C4
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( !ADAPTER_RENDER::IsCoreResourceSharedOwner(a2[2]) )
  {
    ...
    WdLogGlobalForLineNumber = 11565;
            ...
            if ( v19 )
            {
              if ( *(_QWORD *)(*(_QWORD *)(v19[1].Count + 16) + 16LL) == *((_QWORD *)a2[2] + 2) )
              {
                ...
                if ( v10 >= 0 )
                {
                  ...
                  {
                    WdLogSingleEntry0(1LL);
                    WdLogGlobalForLineNumber = 11614;
                    DxgkLogInternalTriageEvent(
                      0LL,
                      262146LL,
                      0xFFFFFFFFLL,
              ...
              else
              {
                ...
                WdLogGlobalForLineNumber = 11594;
                DxgkLogInternalTriageEvent(
                  0LL,
                  0x40000LL,
                  0xFFFFFFFFLL,
