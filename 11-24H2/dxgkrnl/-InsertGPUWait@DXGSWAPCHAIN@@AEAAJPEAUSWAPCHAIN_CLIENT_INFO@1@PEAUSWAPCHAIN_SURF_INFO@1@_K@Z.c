/*
 * XREFs of ?InsertGPUWait@DXGSWAPCHAIN@@AEAAJPEAUSWAPCHAIN_CLIENT_INFO@1@PEAUSWAPCHAIN_SURF_INFO@1@_K@Z @ 0x1401FF0A8
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( !*((_QWORD *)a2 + 1) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pClientInfo->pTempDevice", 3991LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid process context", 4001LL, 0LL, 0LL, 0LL, 0LL);
