/*
 * XREFs of _pGetAdditionalTiming @ 0x1402E3210
 * Callers:
 ...
 *     _pGetAdditionalModeEntry @ 0x1402E3AD0 (_pGetAdditionalModeEntry.c)
 */
...
__int64 __fastcall pGetAdditionalTiming(int a1, char a2, _DWORD *a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    ExAcquirePushLockSharedEx(&qword_1401606C0, 0LL);
    LOBYTE(v9) = a2;
    AdditionalModeEntry = pGetAdditionalModeEntry((unsigned int)v5, v9);
    if ( !AdditionalModeEntry )
    {
      ExReleasePushLockEx(&qword_1401606C0, 0LL);
      ExAcquirePushLockExclusiveEx(&qword_1401606C0, 0LL);
      LOBYTE(v11) = a2;
