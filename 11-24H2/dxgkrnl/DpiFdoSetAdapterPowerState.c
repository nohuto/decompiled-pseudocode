/*
 * XREFs of DpiFdoSetAdapterPowerState @ 0x1404032B8
 * Callers:
 ...
 *     DpiCorrectPowerAction @ 0x14004E868 (DpiCorrectPowerAction.c)
 ...
 *     ?UpdateMuxPosition@DISPLAY_MUX_MGR@@QEAAXXZ @ 0x140088748 (-UpdateMuxPosition@DISPLAY_MUX_MGR@@QEAAXXZ.c)
        ...
        unsigned int a5)
{
  ...
  if ( State.SystemState > *((_DWORD *)DeviceExtension + 71) )
  {
    ...
    if ( !byte_140160D19 && *((_DWORD *)DeviceExtension + 59) == 2 )
    {
  ...
  if ( v17 && *((_DWORD *)DeviceExtension + 5) == 2 )
  {
    ...
    if ( DpiFdoIsPostDevice((__int64)DeviceObject) )
    {
      if ( byte_140161130 )
      {
        DpiAcquirePostDisplayInfoFromBgfx((__int64)&xmmword_140160FC8, 1, 0);
        byte_140161130 = 0;
        dword_14016115C = 1;
      ...
      if ( a4 == 5 )
      {
        ...
        if ( (!v23 || *(int *)(v23 + 3004) <= 1105) && byte_140160D15 )
        {
          v40 = -1;
          v41 = 0LL;
          ...
          xmmword_140160FD8 = 0LL;
          DWORD2(xmmword_140160FD8) = -1;
          xmmword_140160FC8 = 0LL;
          memset(&unk_140160FE8, 0, 0x80uLL);
    ...
    if ( *((_DWORD *)DeviceExtension + 59) == 2 )
    {
      if ( DpiFdoIsPostDevice(*((_QWORD *)DeviceExtension + 3)) )
      {
        ...
        qword_140161120 = (__int64)v39;
      }
      if ( *((_DWORD *)DeviceExtension + 1508) == 1 && DeviceExtension[6393] )
      {
        v36[0] = 0;
        if ( a4 == 5 )
          DISPLAY_MUX_MGR::UpdateMuxPosition((DISPLAY_MUX_PAIRING **)qword_140161380);
      ...
      DpiDxgkDdiSetPowerState(
        ...
        *((_QWORD *)DeviceExtension + 6),
        ...
        v38);
      ++*((_DWORD *)DeviceExtension + 1109);
      if ( (struct _KTHREAD *)qword_140161118 == KeGetCurrentThread() )
      {
        qword_140161120 = 0LL;
        qword_140161118 = 0LL;
      }
      if ( DpiFdoIsPostDevice((__int64)DeviceObject) && (PDEVICE_OBJECT)qword_140160FB8 != DeviceObject )
      {
        xmmword_140160FD8 = 0LL;
        DWORD2(xmmword_140160FD8) = -1;
        xmmword_140160FC8 = 0LL;
      ...
      if ( DpiIsPowerRuntimeDStateTransition((__int64)DeviceExtension) )
      {
        ...
        else
        {
          ...
          else
          {
            ...
            WdLogGlobalForLineNumber = 13039;
          }
        }
      }
      else
