/*
 * XREFs of Feature_PanelBufferControl__private_IsEnabledFallback @ 0x14006E118
 * Callers:
...
__int64 __fastcall Feature_PanelBufferControl__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
