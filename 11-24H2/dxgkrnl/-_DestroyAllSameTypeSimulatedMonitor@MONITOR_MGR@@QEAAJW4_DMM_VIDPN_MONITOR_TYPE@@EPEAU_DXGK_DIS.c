/*
 * XREFs of ?_DestroyAllSameTypeSimulatedMonitor@MONITOR_MGR@@QEAAJW4_DMM_VIDPN_MONITOR_TYPE@@EPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1402E2560
 * Callers:
...
__int64 __fastcall MONITOR_MGR::_DestroyAllSameTypeSimulatedMonitor(__int64 a1, int a2, char a3, GUID *a4)
{
  __int64 v7; // r14
  __int64 v8; // r15
  __int64 v9; // rax
  ...
  char v33[8]; // [rsp+38h] [rbp-48h] BYREF
  char v34[8]; // [rsp+40h] [rbp-40h] BYREF
...
LABEL_47:
  ...
  {
    v27 = *((_DWORD *)v12 + 45);
    MONITOR_MGR::_IssueMonitorEvent(a1 + 8, v27, 0, 2LL, *((_DWORD *)v12 + 70), v13);
