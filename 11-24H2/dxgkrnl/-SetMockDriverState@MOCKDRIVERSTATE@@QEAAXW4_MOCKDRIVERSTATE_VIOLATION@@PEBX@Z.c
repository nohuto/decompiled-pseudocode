/*
 * XREFs of ?SetMockDriverState@MOCKDRIVERSTATE@@QEAAXW4_MOCKDRIVERSTATE_VIOLATION@@PEBX@Z @ 0x1400767F0
 * Callers:
 *     DXGADAPTER_SetMockDriverState @ 0x14006BFA0 (DXGADAPTER_SetMockDriverState.c)
 * Callees:
