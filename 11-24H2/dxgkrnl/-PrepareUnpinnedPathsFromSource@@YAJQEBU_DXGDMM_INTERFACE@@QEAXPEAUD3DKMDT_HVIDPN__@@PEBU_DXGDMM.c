/*
 * XREFs of ?PrepareUnpinnedPathsFromSource@@YAJQEBU_DXGDMM_INTERFACE@@QEAXPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@IEEEQEA_KPEAY0BA@IPEAE@Z @ 0x1403601A4
 * Callers:
        ...
        unsigned __int8 *a13)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"i_pDxgDmmInterface != NULL", 4461LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !v15 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4462;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"i_hDxgAdapter != NULL", 4462LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a3 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4463;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"i_hVidPn != NULL", 4463LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4464;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"i_pDmmVidPnInterface != NULL", 4464LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a5 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4465;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"i_hVidPnTopology != NULL", 4465LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a6 )
  {
    WdLogSingleEntry0(1LL);
  ...
  *a11 = 0LL;
  ...
  if ( v18 == -1071774919 )
  {
    if ( v41 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"sztNumPathsFromSource == 0", 4499LL, 0LL, 0LL, 0LL, 0LL);
    }
    v20 = 1;
    v39 = 1;
    v21 = a7;
...
LABEL_38:
  ...
  if ( !v31 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"sztNumPathsFromSource > 0", 4665LL, 0LL, 0LL, 0LL, 0LL);
    v31 = v41;
  }
  if ( a9 )
  {
