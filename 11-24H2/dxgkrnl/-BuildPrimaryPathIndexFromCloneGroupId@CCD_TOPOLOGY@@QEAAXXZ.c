/*
 * XREFs of ?BuildPrimaryPathIndexFromCloneGroupId@CCD_TOPOLOGY@@QEAAXXZ @ 0x140349AE4
 * Callers:
...
void __fastcall CCD_TOPOLOGY::BuildPrimaryPathIndexFromCloneGroupId(CCD_TOPOLOGY *this)
{
  ...
  for ( j = 0; ; ++j )
  {
    ...
    if ( (*(_QWORD *)(v8 + v5 + 56) & 0x4000000000000LL) == 0 )
    {
      ...
      {
        v5 = *((_QWORD *)this + 8);
        v11 = v5 ? *(_WORD *)(v5 + 20) : 0;
        if ( k >= v11 )
          break;
        v12 = 296LL * k;
        if ( *(_DWORD *)(v12 + v5 + 240) == v9 )
        {
          *(_DWORD *)(v12 + v5 + 324) = j;
          *(_QWORD *)(*((_QWORD *)this + 8) + v12 + 56) |= 0x4000000000000uLL;
        }
      }
    }
  }
