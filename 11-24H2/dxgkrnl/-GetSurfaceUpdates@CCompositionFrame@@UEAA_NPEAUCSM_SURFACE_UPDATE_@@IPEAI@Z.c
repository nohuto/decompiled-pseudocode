/*
 * XREFs of ?GetSurfaceUpdates@CCompositionFrame@@UEAA_NPEAUCSM_SURFACE_UPDATE_@@IPEAI@Z @ 0x14002C920
 * Callers:
 *     <none>
 * Callees:
...
LABEL_70:
        ...
        else
        {
          ...
          if ( v53 )
          {
            ...
            (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304952LL) + 88LL))(
              v38,
              v53[30]);
          }
