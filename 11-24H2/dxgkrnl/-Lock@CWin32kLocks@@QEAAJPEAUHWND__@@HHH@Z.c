/*
 * XREFs of ?Lock@CWin32kLocks@@QEAAJPEAUHWND__@@HHH@Z @ 0x140037A18
 * Callers:
  ...
  if ( v11 )
  {
    ...
    *((_DWORD *)this + 12) = a3;
    if ( *((_DWORD *)this + 13) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"bSpriteLockTaken == NULL", 477LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( v13 )
    {
      if ( v12 )
