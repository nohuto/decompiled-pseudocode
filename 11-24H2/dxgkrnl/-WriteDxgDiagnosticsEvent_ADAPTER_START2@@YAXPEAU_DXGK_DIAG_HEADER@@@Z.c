/*
 * XREFs of ?WriteDxgDiagnosticsEvent_ADAPTER_START2@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140072310
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_ADAPTER_START2(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000001000LL) && tlgKeywordOn((__int64)&dword_14015E5E0, v2) )
    {
      v14 = *((_WORD *)a1 + 2);
      v15 = *((_DWORD *)a1 + 10);
      v13 = a1;
    ...
    if ( (unsigned int)v3 > 4 && tlgKeywordOn((__int64)&dword_14015E5E0, 0x400000001000LL) && *((int *)a1 + 12) < 0 )
    {
