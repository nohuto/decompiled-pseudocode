/*
 * XREFs of DxgkpAddTriageAdapterData @ 0x1400627F8
 * Callers:
 *     DxgDbgTriageDumpCallback @ 0x14007A1A0 (DxgDbgTriageDumpCallback.c)
 * Callees:
 *     ?GetGlobal@DXGGLOBAL@@SAPEAV1@XZ @ 0x140009940 (-GetGlobal@DXGGLOBAL@@SAPEAV1@XZ.c)
 *     DpiAddTriageAdapterData @ 0x140062C40 (DpiAddTriageAdapterData.c)
 */
...
char __fastcall DxgkpAddTriageAdapterData(__int64 a1, __int64 a2, __int64 a3, SIZE_T a4)
{
  ...
  if ( Global )
  {
    ...
    if ( (_BYTE)Global )
    {
      v10 = KeAddTriageDumpDataBlock(v4, (ULONG)v8, (PVOID)0x4AB10, v9);
      if ( v10 < 0 )
      {
        WdLogSingleEntry3(3LL, v8, 305936LL, v10);
        WdLogGlobalForLineNumber = 3176;
      }
      v11 = 4;
      Global = DXGGLOBAL::GetGlobal();
      v12 = (_QWORD *)((char *)Global + 800);
      for ( i = (_QWORD *)*((_QWORD *)Global + 100); i != v12 && i; i = (_QWORD *)*i )
      {
          ...
          && ((unsigned __int8)Global & 0x20) == 0 )
        {
          ...
          if ( v18 )
          {
            LODWORD(Global) = KeAddTriageDumpDataBlock(v4, i[390], (PVOID)0x410, v16);
            if ( (int)Global < 0 )
            {
