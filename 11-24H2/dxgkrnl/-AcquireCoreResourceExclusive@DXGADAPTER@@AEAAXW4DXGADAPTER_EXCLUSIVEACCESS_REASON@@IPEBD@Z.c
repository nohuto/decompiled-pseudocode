/*
 * XREFs of ?AcquireCoreResourceExclusive@DXGADAPTER@@AEAAXW4DXGADAPTER_EXCLUSIVEACCESS_REASON@@IPEBD@Z @ 0x1402CACD4
 * Callers:
  ...
  if ( a2 == 3 )
  {
    ...
    if ( v22 )
    {
      if ( !Current )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pProcess", 4234LL, 0LL, 0LL, 0LL, 0LL);
      }
      KeEnterCriticalRegion();
