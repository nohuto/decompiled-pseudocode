/*
 * XREFs of ?ProcessMuxDeviceArrival@DISPLAY_MUX_MGR@@AEAAJPEAU_UNICODE_STRING@@@Z @ 0x140086F00
 * Callers:
 ...
 *     _DXGKCALLONEXIT__lambda_995b1012b958866616d8e16870c72d2c____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT @ 0x14008294C (_DXGKCALLONEXIT__lambda_995b1012b958866616d8e16870c72d2c____--_2_--DXGKCALLONEXIT--_DXGKCALLONEX.c)
...
__int64 __fastcall DISPLAY_MUX_MGR::ProcessMuxDeviceArrival(DISPLAY_MUX_MGR *this, struct _UNICODE_STRING *a2)
{
  ...
  v11 = a2;
  v10 = -1073741823;
  v7 = *(_OWORD *)lambda_995b1012b958866616d8e16870c72d2c_::_lambda_995b1012b958866616d8e16870c72d2c_(
                    &v8,
                    (__int64)&v10,
                    (__int64)&v11);
  DXGKCALLONEXIT__lambda_995b1012b958866616d8e16870c72d2c_((__int64)v9, &v7);
  ++*((_DWORD *)this + 27);
  if ( *((_DWORD *)this + 20) == 1 )
  {
    v3 = 0;
...
LABEL_11:
  ...
  v10 = -1073741762;
LABEL_12:
  DXGKCALLONEXIT__lambda_995b1012b958866616d8e16870c72d2c____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT((__int64)v9);
  return v3;
}
