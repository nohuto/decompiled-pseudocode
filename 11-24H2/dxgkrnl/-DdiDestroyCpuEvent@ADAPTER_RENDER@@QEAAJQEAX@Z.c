/*
 * XREFs of ?DdiDestroyCpuEvent@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401A3D88
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyCpuEvent(ADAPTER_RENDER *this, void *const a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5159);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5159);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1480LL))(
