/*
 * XREFs of ?ForTopology@CCD_STORE@@SAJAEBVCCD_SET_STRING_ID@@P6AJPEAVTOPOLOGY_SET_DESCRIPTOR@1@PEAX@Z2_N@Z @ 0x14033E89C
 * Callers:
 ...
 * Callees:
 *     ?GetTopologySetStr@CCD_SET_STRING_ID@@QEBAAEBU_STRING@@XZ @ 0x14033E8E4 (-GetTopologySetStr@CCD_SET_STRING_ID@@QEBAAEBU_STRING@@XZ.c)
