/*
 * XREFs of ?OnInitializeSimulatedMonitor@MonitorDescriptorState@DxgMonitor@@QEAAJXZ @ 0x1403E4800
 * Callers:
 ...
 *     ?ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@@Z @ 0x1400587BC (-ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_.c)
...
LABEL_14:
  ...
  if ( (int)EDIDV1_IsEDIDBaseBlock((const unsigned __int8 *)v3 + 24) < 0 )
  {
    WdLogSingleEntry0(2LL);
  ...
  *((_DWORD *)v3 + 3) = 1;
  wistd::unique_ptr<DxgMonitor::WmiMonitorDescriptor,wistd::default_delete<DxgMonitor::WmiMonitorDescriptor>>::reset(
    (void **)v3,
    0LL);
  DxgMonitor::EdidMonitorDescriptor::CreateFromDescriptors(&v17, (char *)this + 128);
  v14 = v17;
