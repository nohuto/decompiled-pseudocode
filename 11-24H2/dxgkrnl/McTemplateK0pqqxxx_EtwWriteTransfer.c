/*
 * XREFs of McTemplateK0pqqxxx_EtwWriteTransfer @ 0x14001401C
 * Callers:
...
NTSTATUS McTemplateK0pqqxxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventCalibrateGpuClock, a3, 7u, &v4);
}
