/*
 * XREFs of ?DdiNotifyContextPriorityChange@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_NOTIFYCONTEXTPRIORITYCHANGE@@@Z @ 0x1401A6698
 * Callers:
 *     ADAPTER_RENDER_DdiNotifyContextPriorityChange @ 0x14006BD00 (ADAPTER_RENDER_DdiNotifyContextPriorityChange.c)
 * Callees:
