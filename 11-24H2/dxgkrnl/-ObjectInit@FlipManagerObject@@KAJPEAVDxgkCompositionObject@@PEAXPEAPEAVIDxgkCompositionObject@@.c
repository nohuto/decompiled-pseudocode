/*
 * XREFs of ?ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x14005B250
 * Callers:
 *     <none>
 * Callees:
 *     ?Initialize@CFlipManager@@IEAAJPEAX@Z @ 0x14005B280 (-Initialize@CFlipManager@@IEAAJPEAX@Z.c)
 *     ??0FlipManagerObject@@IEAA@XZ @ 0x14009E84C (--0FlipManagerObject@@IEAA@XZ.c)
 */
