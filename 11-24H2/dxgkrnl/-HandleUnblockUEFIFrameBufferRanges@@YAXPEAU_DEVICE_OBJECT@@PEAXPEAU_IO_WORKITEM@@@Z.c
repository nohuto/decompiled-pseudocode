/*
 * XREFs of ?HandleUnblockUEFIFrameBufferRanges@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x14018F970
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HandleUnblockUEFIFrameBufferRanges(PVOID IoObject, struct _LUID *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  if ( v6 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      (*(void (__fastcall **)(_QWORD, struct _LUID *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v11 + 391) + 760LL) + 8LL)
                                                     + 1112LL))(
        *(_QWORD *)(*((_QWORD *)v11 + 391) + 768LL),
        Context + 1);
    }
    else
    {
