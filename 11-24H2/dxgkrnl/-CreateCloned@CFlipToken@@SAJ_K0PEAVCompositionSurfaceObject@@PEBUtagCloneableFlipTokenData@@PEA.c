/*
 * XREFs of ?CreateCloned@CFlipToken@@SAJ_K0PEAVCompositionSurfaceObject@@PEBUtagCloneableFlipTokenData@@PEAPEAV1@@Z @ 0x14009BC6C
 * Callers:
 ...
 *     ??0CFlipToken@@IEAA@_KPEAVCompositionSurfaceObject@@@Z @ 0x140031084 (--0CFlipToken@@IEAA@_KPEAVCompositionSurfaceObject@@@Z.c)
        ...
        struct CFlipToken **a5)
{
  ...
  *a5 = 0LL;
  v9 = (CFlipToken *)operator new(0x268uLL, 0x6F744D54u, 256LL);
