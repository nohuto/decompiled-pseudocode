/*
 * XREFs of ?DdiSetAllocationBackingStore@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETALLOCATIONBACKINGSTORE@@@Z @ 0x1401A7CE4
 * Callers:
 *     ADAPTER_RENDER_DdiSetAllocationBackingStore @ 0x14006BDC0 (ADAPTER_RENDER_DdiSetAllocationBackingStore.c)
 * Callees:
