/*
 * XREFs of ?VmBusSendGetInternalAdapterInfo19h1@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAUDXGKVMB_COMMAND_GETINTERNALADAPTERINFO_RETURN1@@@Z @ 0x14022B82C
 * Callers:
        ...
        struct DXGKVMB_COMMAND_GETINTERNALADAPTERINFO_RETURN1 *a2)
{
  ...
  *(_QWORD *)(v5 + 16) = 36LL;
  ...
  if ( v6 < 0 || (v6 = -1073741823, v9[0] < 0x18) )
  {
    ...
    WdLogGlobalForLineNumber = 10026;
