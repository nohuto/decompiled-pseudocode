/*
 * XREFs of ?CreatePresentUpdateForProducer@CFlipManager@@QEAAJ_N_K0PEAVCFlipPropertySet@@PEAPEAVCFlipPresentUpdate@@PEAPEAUFlipManagerTokenIFlipInfo@@@Z @ 0x14001A590
 * Callers:
 ...
 *     ??2?$DXGQUOTAALLOCATOR@$0BAA@$0HFHAEDEG@@@SAPEAX_K@Z @ 0x14001A564 (--2-$DXGQUOTAALLOCATOR@$0BAA@$0HFHAEDEG@@@SAPEAX_K@Z.c)
        ...
        struct FlipManagerTokenIFlipInfo **a7)
{
  ...
  v8 = a4;
  v11 = -1073741823;
  if ( *((_QWORD *)this + 6) == 1LL && *((_QWORD *)this + 29) > 0xFFFFFFFFuLL )
