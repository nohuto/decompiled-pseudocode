/*
 * XREFs of ?DmmNeedDisplayModeResetDueToHdrPowerPolicy@@YA_NPEAVDXGADAPTER@@@Z @ 0x140398964
 * Callers:
...
char __fastcall DmmNeedDisplayModeResetDueToHdrPowerPolicy(struct DXGADAPTER *a1)
{
  ...
  if ( !a1 )
  {
    ...
    WdLogGlobalForLineNumber = 15672;
    return 0;
  }
  v3 = *((_QWORD *)a1 + 390);
  if ( !v3 )
  {
    ...
    WdLogGlobalForLineNumber = 15686;
    return 0;
  }
  v4 = *(VIDPN_MGR **)(v3 + 104);
  if ( !v4 )
  {
    WdLogSingleEntry1(2LL, a1);
    WdLogGlobalForLineNumber = 15699;
    return 0;
  }
  ...
  {
    WdLogSingleEntry1(2LL, a1);
    WdLogGlobalForLineNumber = 15716;
    goto LABEL_32;
  }
  v6 = v20 + 120;
  v7 = *(_QWORD *)(v20 + 120);
