/*
 * XREFs of ?DmmGetCurrentIntegerVSyncFromClientVidPnSource@@YAJPEAXIPEAIPEAW4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@@Z @ 0x1403CAA64
 * Callers:
        ...
        enum _D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING *a4)
{
  ...
  if ( v9 )
  {
    ...
    Path = DMMVIDPNTOPOLOGY::FindPath(
             ...
             v4,
             *(_DWORD *)(4024 * v4 + *((_QWORD *)a1[390] + 16) + 1072));
    if ( !Path )
    {
