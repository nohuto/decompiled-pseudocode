/*
 * XREFs of ?PickWireFormatWithPreference@@YAJW4BML_WIREFORMAT_PREFERENCE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@11@Z @ 0x1403B90CC
 * Callers:
...
LABEL_6:
  for ( i = 0; ; ++i )
  {
    if ( i >= 0x12 )
      return 3221225473LL;
    v10 = v8[2 * i];
    if ( (v10 & *a2) != 0 && (!LOBYTE(v8[2 * i + 1]) || (v10 & *a3) != 0) )
      break;
  }
  *a4 = v10;
  if ( ((v10 - 1) & v10) != 0 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146LL,
      0xFFFFFFFFLL,
      L"(pPickedWireFormat->Value & (pPickedWireFormat->Value - 1)) == 0",
      5858LL,
      0LL,
      0LL,
      0LL,
