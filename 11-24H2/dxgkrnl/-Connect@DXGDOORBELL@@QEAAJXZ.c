/*
 * XREFs of ?Connect@DXGDOORBELL@@QEAAJXZ @ 0x1401D7B90
 * Callers:
...
LABEL_17:
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v16, (__int64)this, v7, 0LL, 0LL, 0LL);
      goto LABEL_27;
    }
    if ( *((_QWORD *)this + 9) )
    {
...
LABEL_11:
  DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v8, (__int64)this, v7, 0LL, 0LL, 0LL);
  return (unsigned int)v7;
}
