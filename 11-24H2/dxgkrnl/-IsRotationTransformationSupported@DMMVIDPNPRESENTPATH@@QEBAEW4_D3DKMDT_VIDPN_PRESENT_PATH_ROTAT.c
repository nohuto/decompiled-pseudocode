/*
 * XREFs of ?IsRotationTransformationSupported@DMMVIDPNPRESENTPATH@@QEBAEW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@@Z @ 0x140039B08
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a2)
{
  ...
  if ( (v6 & 1) == 0 )
    return 0;
LABEL_4:
  if ( !DMMVIDPNPRESENTPATH::IsOffsetRotationTransformationSupported(
          (DMMVIDPNPRESENTPATH *)v4,
          (enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v5) )
    return 0;
  return v2;
}
