/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1401A5104
 * Callers:
 *     ?DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z @ 0x14027DA40 (-DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z.c)
 * Callees:
