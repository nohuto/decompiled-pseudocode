/*
 * XREFs of ?DdiQueryDiagnosticTypesSupport@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT@@@Z @ 0x1401A72A0
 * Callers:
        ...
        __int64 a3)
{
  ...
  _BYTE v25[56]; // [rsp+80h] [rbp-9h] BYREF
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5128);
  }
  else
  {
    v23 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v21, 5128);
  ...
  v11 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT *))this + 166))(
          *((_QWORD *)this + 36),
          a2);
  ...
  v17[5] = a2->DiagnosticCategory.Value;
  v17[6] = a2->NoninvasiveTypes.Notifications.Value;
  v17[7] = a2->InvasiveTypes.Notifications.Value;
