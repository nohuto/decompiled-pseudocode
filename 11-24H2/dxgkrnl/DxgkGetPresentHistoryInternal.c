 ...
 *     ?RetirePresentHistory@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJI@Z @ 0x1400328D0 (-RetirePresentHistory@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJI@Z.c)
...
LABEL_131:
  ...
  v123 = 0LL;
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)&v119, v130[0], (struct _KTHREAD **)v10, &v123, 1);
  v15 = v123;
  if ( !v123 )
  {
  ...
  if ( !v117 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pRenderAdapter != NULL", 287LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_128:
  ...
  if ( (int)DXGPRESENTHISTORYTOKENQUEUE::ReadPresentHistory((KSPIN_LOCK *)v29, v34, &v113, v37, v38) < 0 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"NT_SUCCESS(Status)", 367LL, 0LL, 0LL, 0LL, 0LL);
  }
  v106 = 0;
  v109 = 0;
  v41 = v113;
...
LABEL_93:
    ...
    if ( !v64 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"TokenSize > 0", 377LL, 0LL, 0LL, 0LL, 0LL);
      v64 = 0;
    }
    if ( v64 > v40 )
      break;
