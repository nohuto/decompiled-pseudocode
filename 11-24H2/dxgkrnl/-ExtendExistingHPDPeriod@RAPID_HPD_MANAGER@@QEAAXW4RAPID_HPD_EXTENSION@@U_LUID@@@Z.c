/*
 * XREFs of ?ExtendExistingHPDPeriod@RAPID_HPD_MANAGER@@QEAAXW4RAPID_HPD_EXTENSION@@U_LUID@@@Z @ 0x1400602F4
 * Callers:
...
void __fastcall RAPID_HPD_MANAGER::ExtendExistingHPDPeriod(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  {
LABEL_18:
    if ( (unsigned int)dword_14015E5E0 > 5 && tlgKeywordOn((__int64)&dword_14015E5E0, 0x400000000002LL) )
    {
      v29 = a3;
      v24 = a2;
      v25 = 1;
  ...
  else if ( (unsigned int)dword_14015E5E0 > 5 )
  {
    v27 = a3;
    v19 = a2;
    v34 = *(_DWORD *)(a1 + 80);
