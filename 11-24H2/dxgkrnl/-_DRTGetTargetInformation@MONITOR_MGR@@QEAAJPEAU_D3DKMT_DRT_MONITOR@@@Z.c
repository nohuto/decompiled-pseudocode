/*
 * XREFs of ?_DRTGetTargetInformation@MONITOR_MGR@@QEAAJPEAU_D3DKMT_DRT_MONITOR@@@Z @ 0x1402737B8
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( (unsigned int)v6 > *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 16LL) + 1860LL) )
  {
