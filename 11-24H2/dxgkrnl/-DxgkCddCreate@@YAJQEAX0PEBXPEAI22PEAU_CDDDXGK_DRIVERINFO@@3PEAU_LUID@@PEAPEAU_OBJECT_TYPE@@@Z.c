/*
 * XREFs of ?DxgkCddCreate@@YAJQEAX0PEBXPEAI22PEAU_CDDDXGK_DRIVERINFO@@3PEAU_LUID@@PEAPEAU_OBJECT_TYPE@@@Z @ 0x14034C300
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  if ( _InterlockedExchangeAdd64((volatile signed __int64 *)v55 + 4, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v42 + 16) + 16LL) + 200LL) != 4 )
      DXGDEVICE::DestroyContext((DXGDEVICE *)v42, (struct DXGCONTEXT ***)v55, (struct COREDEVICEACCESS *)v68);
