/*
 * XREFs of ?TdrCompleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N1@Z @ 0x1401CF8E0
 * Callers:
...
void __fastcall TdrCompleteRecoveryContext(struct _TDR_RECOVERY_CONTEXT *a1, struct _LUID *a2, bool a3)
{
  ...
  if ( a1 )
  {
    ...
    v6 = (char)a2;
    if ( v4 )
      (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 3128LL) + 736LL)
                                                          + 8LL)
                                              + 480LL))(
        v4,
        0LL);
    ...
    if ( v7 != 6 && v7 != 12 )
    {
      ...
      v8 = 5LL * (((unsigned __int8)_InterlockedExchangeAdd(dword_14015F824, 1u) + 1) & 0x3F);
