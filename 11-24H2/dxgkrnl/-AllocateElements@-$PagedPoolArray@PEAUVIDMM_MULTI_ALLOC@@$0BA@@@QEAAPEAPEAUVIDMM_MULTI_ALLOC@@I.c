/*
 * XREFs of ?AllocateElements@?$PagedPoolArray@PEAUVIDMM_MULTI_ALLOC@@$0BA@@@QEAAPEAPEAUVIDMM_MULTI_ALLOC@@I@Z @ 0x14018A424
 * Callers:
...
__int64 __fastcall PagedPoolArray<VIDMM_MULTI_ALLOC *,16>::AllocateElements(__int64 *a1, __int64 a2)
{
  int v2; // edi
  __int64 result; // rax
