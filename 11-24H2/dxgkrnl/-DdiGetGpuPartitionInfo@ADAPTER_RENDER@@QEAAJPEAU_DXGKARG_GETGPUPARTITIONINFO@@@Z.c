/*
 * XREFs of ?DdiGetGpuPartitionInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETGPUPARTITIONINFO@@@Z @ 0x140212200
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5097);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5097);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETGPUPARTITIONINFO *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                             + 32LL))(
