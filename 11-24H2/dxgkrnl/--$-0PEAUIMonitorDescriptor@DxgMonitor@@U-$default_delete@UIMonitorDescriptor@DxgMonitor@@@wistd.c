...
_QWORD *__fastcall wistd::__compressed_pair<DxgMonitor::IMonitorDescriptor *,wistd::default_delete<DxgMonitor::IMonitorDescriptor>>::__compressed_pair<DxgMonitor::IMonitorDescriptor *,wistd::default_delete<DxgMonitor::IMonitorDescriptor>>(
        _QWORD *a1,
        _QWORD *a2)
{
  *a1 = *a2;
