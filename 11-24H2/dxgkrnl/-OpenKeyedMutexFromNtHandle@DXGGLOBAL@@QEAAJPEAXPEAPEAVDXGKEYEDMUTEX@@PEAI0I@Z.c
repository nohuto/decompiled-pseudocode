/*
 * XREFs of ?OpenKeyedMutexFromNtHandle@DXGGLOBAL@@QEAAJPEAXPEAPEAVDXGKEYEDMUTEX@@PEAI0I@Z @ 0x1401F4C90
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( !a3 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"ppKeyedMutex", 5129LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 5130;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"phKeyedMutex", 5130LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a3 = 0LL;
  *a4 = 0;
  ...
  else if ( v9 >= 0 )
  {
    ...
    if ( !Object )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pSharedKeyedMutexObject", 5165LL, 0LL, 0LL, 0LL, 0LL);
    }
    v13 = *v12;
