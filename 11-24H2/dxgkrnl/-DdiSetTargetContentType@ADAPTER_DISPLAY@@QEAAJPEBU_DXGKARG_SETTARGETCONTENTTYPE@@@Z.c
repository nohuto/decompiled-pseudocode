/*
 * XREFs of ?DdiSetTargetContentType@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETCONTENTTYPE@@@Z @ 0x1401A8D48
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5078);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5078);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETCONTENTTYPE *))(*((_QWORD *)this + 2) + 1176LL))(
  ...
  WdLogSingleEntry2(4LL, v10, a2->TargetId);
