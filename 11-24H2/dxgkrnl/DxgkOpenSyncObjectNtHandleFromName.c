/*
 * XREFs of DxgkOpenSyncObjectNtHandleFromName @ 0x1401E3AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenSyncObjectNtHandleFromName(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(a1, (__int64)&EventProfilerEnter, a3, 2204);
  }
  else
  {
    v13 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v11, 2204);
  v14 = 0LL;
  v15 = 0LL;
  v4 = (const void *)a1;
  ...
  Src = 0LL;
  LOBYTE(v5) = 1;
  v6 = ObOpenObjectByName(*((_QWORD *)&v14 + 1), g_pDxgkSharedSyncObjectType, v5, 0LL, v14, 0LL, &Src);
  if ( v6 >= 0 )
  {
    v7 = (void *)(a1 + 16);
