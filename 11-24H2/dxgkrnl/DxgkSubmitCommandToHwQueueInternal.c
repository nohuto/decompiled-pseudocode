/*
 * XREFs of DxgkSubmitCommandToHwQueueInternal @ 0x1402C5A10
 * Callers:
 ...
 *     DxgkSubmitCommandToHwQueue @ 0x1402C59F0 (DxgkSubmitCommandToHwQueue.c)
 * Callees:
...
__int64 __fastcall DxgkSubmitCommandToHwQueueInternal(struct _D3DKMT_SUBMITCOMMANDTOHWQUEUE *a1, bool a2, __int64 a3)
{
  ...
  struct DXGHWQUEUE *v45; // [rsp+68h] [rbp-140h] BYREF
  DXGHWQUEUE *v46; // [rsp+70h] [rbp-138h] BYREF
  char v47; // [rsp+78h] [rbp-130h]
  struct _KTHREAD **v48; // [rsp+80h] [rbp-128h]
  ...
  if ( Current )
  {
    v10 = (struct _KTHREAD **)*((_QWORD *)Current + 3);
    if ( !v10 )
      goto LABEL_5;
  }
  else
  {
    ...
    v10 = (struct _KTHREAD **)DXGGLOBAL::SearchDxgThreadList(Global, CurrentThread);
    if ( !v10 )
    {
