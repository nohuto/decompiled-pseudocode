/*
 * XREFs of ColorSpaceTransformInitIdentityTransform @ 0x140098F7C
 * Callers:
 ...
 * Callees:
 *     ?InitializeIdentityLut@@YAJPEAUD3DDDI_DXGI_RGB@@IMM@Z @ 0x14003E610 (-InitializeIdentityLut@@YAJPEAUD3DDDI_DXGI_RGB@@IMM@Z.c)
 *     ?InitializeIdentityMatrix@@YAJPEAMII@Z @ 0x14005C3D8 (-InitializeIdentityMatrix@@YAJPEAMII@Z.c)
 *     ?InitializeIdentityLut_RGB256x3x16@@YAJPEAU_D3DDDI_GAMMA_RAMP_RGB256x3x16@@@Z @ 0x140098F34 (-InitializeIdentityLut_RGB256x3x16@@YAJPEAU_D3DDDI_GAMMA_RAMP_RGB256x3x16@@@Z.c)
 */
