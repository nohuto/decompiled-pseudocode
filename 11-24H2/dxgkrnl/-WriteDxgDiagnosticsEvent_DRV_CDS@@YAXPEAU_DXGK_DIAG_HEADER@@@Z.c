/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DRV_CDS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140072708
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DRV_CDS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4 && tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000008LL) )
  {
