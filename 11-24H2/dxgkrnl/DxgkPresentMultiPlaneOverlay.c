/*
 * XREFs of DxgkPresentMultiPlaneOverlay @ 0x1401DF180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay(struct D3DKMT_PRESENT_MULTIPLANE_OVERLAY *a1)
{
  ...
  struct D3DKMT_MULTIPLANE_OVERLAY *v57[2]; // [rsp+90h] [rbp-78h] BYREF
  ...
  D3DKMT_PRESENT_MULTIPLANE_OVERLAY v68; // [rsp+168h] [rbp+60h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)v54, 2092);
  ...
  *(_OWORD *)v57 = 0LL;
  v53 = CapturePresentMultiPlaneOverlayArgs(a1, &v68, v57, (struct tagRECT **)&v57[1]);
  if ( v53 < 0 )
  {
...
LABEL_43:
  ...
  if ( v53 >= 0 )
  {
    ...
    {
      v53 = DXGCONTEXT::PresentMultiPlaneOverlay(
              (DXGCONTEXT *)v17,
              &v68,
