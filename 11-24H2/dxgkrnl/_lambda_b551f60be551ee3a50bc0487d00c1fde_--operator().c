/*
 * XREFs of _lambda_b551f60be551ee3a50bc0487d00c1fde_::operator() @ 0x1401BD7CC
 * Callers:
...
__int64 __fastcall lambda_b551f60be551ee3a50bc0487d00c1fde_::operator()(__int64 **a1, unsigned int a2, int *a3)
{
  __int64 v3; // rsi
  int v5; // eax
  char v7; // r8
