/*
 * XREFs of ?GetTrackedWorkloadUserStatistics@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAU_D3DKMT_GETTRACKEDWORKLOADSTATISTICS@@@Z @ 0x140203334
 * Callers:
 *     NtDxgkGetTrackedWorkloadStatistics @ 0x140204CA0 (NtDxgkGetTrackedWorkloadStatistics.c)
 * Callees:
 *     ?GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z @ 0x1400A0A84 (-GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z.c)
 *     ?IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ @ 0x1400A0D08 (-IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ.c)
