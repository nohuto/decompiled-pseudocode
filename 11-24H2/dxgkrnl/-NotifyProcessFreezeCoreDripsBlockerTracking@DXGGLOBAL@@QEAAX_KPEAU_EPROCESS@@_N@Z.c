/*
 * XREFs of ?NotifyProcessFreezeCoreDripsBlockerTracking@DXGGLOBAL@@QEAAX_KPEAU_EPROCESS@@_N@Z @ 0x1402E6A98
 * Callers:
        ...
        bool a4)
{
  ...
  {
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v9, (struct DXGFASTMUTEX *const)(v8 + 2096), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v9);
    DripsBlockerTrackingHelper::NotifyProcessFreeze((DXGGLOBAL *)((char *)this + 2264), a2, a3, a4);
