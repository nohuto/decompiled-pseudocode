/*
 * XREFs of ?RtlStringCbCatA@@YAJPEAD_KPEBD@Z @ 0x14006F90C
 * Callers:
 ...
 * Callees:
 *     RtlStringCopyWorkerA @ 0x1400421A0 (RtlStringCopyWorkerA.c)
 *     RtlStringLengthWorkerA @ 0x1400434A0 (RtlStringLengthWorkerA.c)
 */
