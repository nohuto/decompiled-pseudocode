/*
 * XREFs of DpiFdoHandleQueryFlexibleIovInterface @ 0x14024E290
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a3 == 1 )
    {
      if ( a2 >= 0x78u )
      {
        ...
        if ( *(_BYTE *)(v5 + 5336) )
        {
          ...
          if ( *(_QWORD *)(v5 + 5376) )
          {
            qword_14015E2A8 = (__int64)&DpiIovGetBackingResource;
            qword_14015E2B0 = (__int64)DpiIovGetMmioRangeCount;
            qword_14015E2B8 = (__int64)DpiIovGetMmioRanges;
          }
          else if ( *(_BYTE *)(v5 + 2716) )
          {
            qword_14015E2A8 = (__int64)&DpiIovGetBackingResource;
          }
          memmove(a4, &unk_14015E270, 0x78uLL);
