/*
 * XREFs of ?RemoveVidPnOwnership@DXGDEVICE@@QEAAXI@Z @ 0x1403E89A4
 * Callers:
...
void __fastcall DXGDEVICE::RemoveVidPnOwnership(DXGDEVICE *this, unsigned int a2)
{
  ...
  if ( a2 > v2 )
  {
    ...
    v4 = 0;
    WdLogGlobalForLineNumber = 11879;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
      L"Trying to adjust VidPn ownership count down by %d but only %d to remove",
      v5,
      v6,
      0LL,
      0LL,
