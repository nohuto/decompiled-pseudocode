/*
 * XREFs of ?UpdateDodFrontBuffer@DXGDEVICE@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1401DD13C
 * Callers:
...
LABEL_32:
          ...
          v6 = ADAPTER_DISPLAY::PresentDisplayOnlyCdd(*((ADAPTER_DISPLAY **)this[237] + 390), &v24);
