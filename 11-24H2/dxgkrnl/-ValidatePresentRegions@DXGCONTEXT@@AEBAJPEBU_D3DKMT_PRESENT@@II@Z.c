/*
 * XREFs of ?ValidatePresentRegions@DXGCONTEXT@@AEBAJPEBU_D3DKMT_PRESENT@@II@Z @ 0x140387C88
 * Callers:
...
LABEL_17:
  DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v17, -1073741811LL, left, top, v18, bottom);
  return 3221225485LL;
}
