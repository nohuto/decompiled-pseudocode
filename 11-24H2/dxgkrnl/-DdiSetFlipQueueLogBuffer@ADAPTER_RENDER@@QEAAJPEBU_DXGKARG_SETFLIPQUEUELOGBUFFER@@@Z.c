/*
 * XREFs of ?DdiSetFlipQueueLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1401A7F68
 * Callers:
 *     ADAPTER_RENDER_DdiSetFlipQueueLogBuffer @ 0x14006BDE0 (ADAPTER_RENDER_DdiSetFlipQueueLogBuffer.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5154);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5154);
  ...
  v10 = *((_QWORD *)this + 2);
  v11 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *))(v10 + 1408);
  if ( v11 )
