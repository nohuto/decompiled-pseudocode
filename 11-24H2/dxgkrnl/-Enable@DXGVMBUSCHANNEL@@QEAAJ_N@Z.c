/*
 * XREFs of ?Enable@DXGVMBUSCHANNEL@@QEAAJ_N@Z @ 0x140206DBC
 * Callers:
...
LABEL_7:
      ...
      *((_BYTE *)this + 24) = 1;
      *v5 = 1;
      v10 = ((__int64 (__fastcall *)(__int64))qword_140160380)(v9);
      v4 = v10;
      if ( v10 < 0 )
      {
        WdLogSingleEntry5(
        ...
        DxgkLogInternalTriageEvent(
          ...
          0x40000LL,
          0xFFFFFFFFLL,
          L"VmbChannelEnable failed. Returning 0x%I64x",
          v4,
          (__int64)this,
          v16,
          v18,
      ...
      {
        ((void (__fastcall *)(_QWORD))qword_140160430)(*((_QWORD *)this + 2));
      }
    }
  }
        ...
        *((_QWORD *)this + 5) = 0LL;
        ...
        if ( v14 )
        {
          ...
          DxgkLogInternalTriageEvent(
            ...
            262146LL,
            0xFFFFFFFFLL,
            L"Failed on waiting for VM bus channel to start: 0x%I64x",
            v4,
            (__int64)this,
            v17,
            v19,
