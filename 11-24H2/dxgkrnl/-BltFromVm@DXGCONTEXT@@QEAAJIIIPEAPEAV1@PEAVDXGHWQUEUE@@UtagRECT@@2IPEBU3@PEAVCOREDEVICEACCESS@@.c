/*
 * XREFs of ?BltFromVm@DXGCONTEXT@@QEAAJIIIPEAPEAV1@PEAVDXGHWQUEUE@@UtagRECT@@2IPEBU3@PEAVCOREDEVICEACCESS@@@Z @ 0x1401EA67C
 * Callers:
...
LABEL_31:
  ...
  {
    WdLogSingleEntry0(2LL);
    WdLogGlobalForLineNumber = 7796;
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid source rect", 7796LL, 0LL, 0LL, 0LL, 0LL);
    DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE((DXGALLOCATIONREFERENCE *)&v63);
    goto LABEL_88;
  }
  left = a8->left;
    ...
    || v40 > (int)v73.Height )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid destination rect", 7806LL, 0LL, 0LL, 0LL, 0LL);
    goto LABEL_85;
  }
  for ( i = 0; i < a9; ++i )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid subrect", 7819LL, 0LL, 0LL, 0LL, 0LL);
    goto LABEL_85;
  }
  v46 = *((_QWORD *)this + 46);
  v66 = 0LL;
...
LABEL_69:
  ...
  *(_DWORD *)v53 = v54 | 0x120;
  ...
  if ( v58 < 0 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"SubmitPresent failed 0x%I64x", v59, 0LL, 0LL, 0LL, 0LL);
  }
  CVidSchSubmitData::~CVidSchSubmitData((CVidSchSubmitData *)v68);
  DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE((DXGALLOCATIONREFERENCE *)&v63);
  DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE((DXGALLOCATIONREFERENCE *)&v64);
