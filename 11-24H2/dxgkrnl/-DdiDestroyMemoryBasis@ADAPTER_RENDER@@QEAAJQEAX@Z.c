/*
 * XREFs of ?DdiDestroyMemoryBasis@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401A422C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyMemoryBasis(ADAPTER_RENDER *this, void *const a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5177);
  }
  else
  {
    v17 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5177);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1576LL))(
  ...
  if ( (_DWORD)v10 )
  {
    ...
    if ( (int)v10 < 0 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000LL,
        0xFFFFFFFFLL,
        L"The driver failed DxgkDdiDestroyMemoryBasis. Status: 0x%I64x",
        v10,
        0LL,
        0LL,
        0LL,
