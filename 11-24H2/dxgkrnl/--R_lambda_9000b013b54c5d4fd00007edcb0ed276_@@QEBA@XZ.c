/*
 * XREFs of ??R_lambda_9000b013b54c5d4fd00007edcb0ed276_@@QEBA@XZ @ 0x140082C14
 * Callers:
...
char __fastcall _lambda_9000b013b54c5d4fd00007edcb0ed276_::operator()(__int64 a1)
{
  ...
  if ( !**(_BYTE **)a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"bFailureCase", 185LL, 0LL, 0LL, 0LL, 0LL);
  }
  v3 = *(_QWORD *)(a1 + 16);
  ...
  *(_OWORD *)(v3 + 16) = 0LL;
  ...
  {
    LOBYTE(v2) = tlgKeywordOn((__int64)&dword_14015E5A8, 512LL);
    if ( (_BYTE)v2 )
    {
      v6 = *(_DWORD **)(a1 + 16);
      v12 = (v6[14] & 0x10) != 0;
