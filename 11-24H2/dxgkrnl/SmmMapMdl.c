/*
 * XREFs of SmmMapMdl @ 0x14004499C
 * Callers:
        ...
        __int64 *a9)
{
  ...
  if ( a3 != 1 )
  {
    ...
    if ( *(_DWORD *)(a1 + 48) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pBaseAddress != nullptr", 343LL, 0LL, 0LL, 0LL, 0LL);
    }
    else
    {
...
LABEL_10:
  if ( v13 < 0 )
  {
    _InterlockedAdd(&dword_140161670, 1u);
