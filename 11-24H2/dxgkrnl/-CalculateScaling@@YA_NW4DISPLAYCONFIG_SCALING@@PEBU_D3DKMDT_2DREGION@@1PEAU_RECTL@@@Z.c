/*
 * XREFs of ?CalculateScaling@@YA_NW4DISPLAYCONFIG_SCALING@@PEBU_D3DKMDT_2DREGION@@1PEAU_RECTL@@@Z @ 0x140061A20
 * Callers:
...
LABEL_18:
  ...
  if ( a1 != 5 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"Unknown scaling type 0x%lx", v7, 0LL, 0LL, 0LL, 0LL);
  }
  return 0;
}
