/*
 * XREFs of ?DdiUpdateNativeFenceLogs@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATENATIVEFENCELOGS@@@Z @ 0x14006A4E4
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateNativeFenceLogs @ 0x14006BEE0 (ADAPTER_RENDER_DdiUpdateNativeFenceLogs.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  int v9; // ebp
  __int64 (__fastcall *v10)(struct _DXGKARG_UPDATENATIVEFENCELOGS *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  __int64 v14; // rcx
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5175);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5175);
  ...
  v10 = *(__int64 (__fastcall **)(struct _DXGKARG_UPDATENATIVEFENCELOGS *))(*((_QWORD *)this + 2) + 1704LL);
  if ( v10 )
    v11 = v10(a2);
  else
    v11 = -1073741822;
