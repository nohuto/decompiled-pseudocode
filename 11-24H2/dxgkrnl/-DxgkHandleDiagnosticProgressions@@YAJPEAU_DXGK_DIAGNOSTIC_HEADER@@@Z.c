/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x140071620
 * Callers:
...
LABEL_3:
  ...
  if ( (unsigned int)dword_14015E538 > 4 && tlgKeywordOn((__int64)&dword_14015E538, 1LL) )
  {
    if ( (v8 & 1) != 0 )
    {
    ...
    if ( tlgKeywordOn((__int64)&dword_14015E538, v7) )
    {
      LOBYTE(v11) = v11 & 1;
      v12 = &unk_14013CD5F;
      v14 = v11;
