/*
 * XREFs of ?CreateMiniportBlackboxLiveDump@DISPLAYDIAGNOSTICADAPTERDATA@@QEAAJXZ @ 0x1401C027C
 * Callers:
...
__int64 __fastcall DISPLAYDIAGNOSTICADAPTERDATA::CreateMiniportBlackboxLiveDump(DISPLAYDIAGNOSTICADAPTERDATA *this)
{
  ...
  if ( !*(_QWORD *)this )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 1447LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_BYTE *)this + 3488) )
  {
