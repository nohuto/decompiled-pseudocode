/*
 * XREFs of ?GetUsedEntryCount@HMGRTABLE@@QEAAIXZ @ 0x14007A8A0
 * Callers:
...
__int64 __fastcall HMGRTABLE::GetUsedEntryCount(HMGRTABLE *this)
{
  if ( *((_DWORD *)this + 4) < *((_DWORD *)this + 5) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_TableSize >= m_FreeCount", 159LL, 0LL, 0LL, 0LL, 0LL);
  }
