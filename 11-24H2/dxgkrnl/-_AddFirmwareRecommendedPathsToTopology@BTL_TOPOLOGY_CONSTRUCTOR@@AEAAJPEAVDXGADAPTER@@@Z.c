/*
 * XREFs of ?_AddFirmwareRecommendedPathsToTopology@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJPEAVDXGADAPTER@@@Z @ 0x14026B1A0
 * Callers:
        ...
        struct DXGADAPTER *a2)
{
  ...
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v25, v4);
  v5 = *(_QWORD *)(v4 + 320);
  v24 = 0LL;
  if ( v5 )
