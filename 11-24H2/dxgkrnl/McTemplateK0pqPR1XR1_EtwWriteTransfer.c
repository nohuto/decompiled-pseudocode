/*
 * XREFs of McTemplateK0pqPR1XR1_EtwWriteTransfer @ 0x1400113D0
 * Callers:
...
__int64 McTemplateK0pqPR1XR1_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 8 * v17;
  v13 = 8 * v17;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, 0LL, 5LL, v4);
}
