/*
 * XREFs of DxgkUpdateOverlay @ 0x1401E9BD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  ...
  v24 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v23, v28.hDevice, (struct _KTHREAD **)Current, &v24);
...
LABEL_24:
  ...
  if ( v16 >= 0 )
  {
    if ( !DXGDEVICE::IsSupportOverlay((DXGDEVICE *)v6) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDevice->IsSupportOverlay()", 773LL, 0LL, 0LL, 0LL, 0LL);
    }
