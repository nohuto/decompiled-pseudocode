/*
 * XREFs of ?GetCurrentContentResolution@@YAJQEAXIPEAPEBUtagRECT@@PEAU1@PEAK@Z @ 0x1403E389C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  v9 = *(_QWORD *)(*((_QWORD *)a1 + 390) + 128LL) + 4024 * v6;
  if ( !v9 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 992;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDisplaySource != NULL", 992LL, 0LL, 0LL, 0LL, 0LL);
  }
  v10 = *(_QWORD *)(v9 + 48);
  if ( v10 )
  {
