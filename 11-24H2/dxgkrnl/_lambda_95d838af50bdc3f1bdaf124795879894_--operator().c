/*
 * XREFs of _lambda_95d838af50bdc3f1bdaf124795879894_::operator() @ 0x140277708
 * Callers:
...
void __fastcall lambda_95d838af50bdc3f1bdaf124795879894_::operator()(__int64 a1)
{
  __int128 **v1; // rax
  __int64 v3; // r9
  __int64 v4; // rcx
