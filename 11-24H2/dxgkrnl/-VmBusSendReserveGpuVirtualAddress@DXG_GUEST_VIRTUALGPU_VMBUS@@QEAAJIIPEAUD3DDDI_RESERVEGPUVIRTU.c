/*
 * XREFs of ?VmBusSendReserveGpuVirtualAddress@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIPEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x140185444
 * Callers:
  ...
  if ( P[0] )
  {
    ...
    *((_DWORD *)v8 + 6) = a3;
    ...
    if ( v11 < 0 || (v11 = -1073741823, v12[0] < 0x10) )
    {
      ...
      WdLogGlobalForLineNumber = 12746;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000LL,
        0xFFFFFFFFLL,
        L"VmBusSendReserveGpuVirtualAddress failed: 0x%I64x",
        v11,
        0LL,
        0LL,
        0LL,
