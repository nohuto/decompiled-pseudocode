/*
 * XREFs of DxgkConvertPathsModalityToDisplayConfig @ 0x1403D8D10
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a4)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)a1, (__int64)&EventProfilerEnter, a3, 2177);
  }
  else
  {
    v15 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 2177);
  if ( a4 )
    *a4 = 0;
  v8 = *a2;
  v19 = 0;
