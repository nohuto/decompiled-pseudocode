/*
 * XREFs of ?SysMmCreateAdl@@YAJPEAUSYSMM_ADAPTER_OBJECT@@_K1IPEAPEAU_DXGK_ADL@@@Z @ 0x14003A6E0
 * Callers:
 ...
 *     SmmValidateParameters @ 0x14003A8E8 (SmmValidateParameters.c)
 *     SmmAllocateAdl @ 0x14003AA38 (SmmAllocateAdl.c)
 *     SmmDetermineAdlType @ 0x14003AC04 (SmmDetermineAdlType.c)
