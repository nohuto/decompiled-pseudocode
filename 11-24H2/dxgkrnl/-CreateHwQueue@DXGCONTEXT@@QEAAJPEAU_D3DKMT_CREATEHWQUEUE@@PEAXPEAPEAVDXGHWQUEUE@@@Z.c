/*
 * XREFs of ?CreateHwQueue@DXGCONTEXT@@QEAAJPEAU_D3DKMT_CREATEHWQUEUE@@PEAXPEAPEAVDXGHWQUEUE@@@Z @ 0x1402BB7A8
 * Callers:
        ...
        struct DXGHWQUEUE **a4)
{
  ...
  if ( !a4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"HwQueue != NULL", 671LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( v9 )
  {
    ...
    *a4 = (struct DXGHWQUEUE *)v9;
    ...
    {
      v11 = *a4;
      v12 = (DXGHWQUEUE **)((char *)this + 400);
      v13 = *((_QWORD *)this + 50);
      if ( *(DXGCONTEXT **)(v13 + 8) != (DXGCONTEXT *)((char *)this + 400) )
        __fastfail(3u);
      *(_QWORD *)v11 = v13;
      *((_QWORD *)v11 + 1) = v12;
      *(_QWORD *)(v13 + 8) = v11;
