/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140057F34
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4
    && (qword_14015E5F0 & 0x200000000040LL) != 0
    && (qword_14015E5F8 & 0x200000000040LL) == qword_14015E5F8 )
  {
    if ( tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000040LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
