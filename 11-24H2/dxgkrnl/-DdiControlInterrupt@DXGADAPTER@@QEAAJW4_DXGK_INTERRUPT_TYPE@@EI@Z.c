/*
 * XREFs of ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@EI@Z @ 0x14037B8E0
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt @ 0x140045690 (DXGADAPTER_DdiControlInterrupt.c)
        ...
        unsigned int a4)
{
  ...
  v7 = a2;
  if ( *((int *)this + 751) >= 1300 && *((_QWORD *)this + 112) )
  {
  ...
  else
  {
    ...
    if ( (qword_14015E4B0 & 2) != 0 )
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
        McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5038);
    }
    else
    {
      v26 = 0;
    }
    DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v24, 5038);
    ...
    LOBYTE(v12) = v5;
    v13 = (*((int (__fastcall **)(_QWORD, _QWORD, __int64))this + 87))(*((_QWORD *)this + 36), (unsigned int)v7, v12);
    if ( v27[0] )
      KeUnstackDetachProcess(&ApcState);
    if ( CurrentIrql != KeGetCurrentIrql() )
    {
      v21 = KeGetCurrentIrql();
      WdLogSingleEntry5(0LL, 275LL, 16LL, this, CurrentIrql, v21);
    ...
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
        McTemplateK0q_EtwWriteTransfer(v19, (__int64)&EventProfilerExit, v20, v24);
    }
