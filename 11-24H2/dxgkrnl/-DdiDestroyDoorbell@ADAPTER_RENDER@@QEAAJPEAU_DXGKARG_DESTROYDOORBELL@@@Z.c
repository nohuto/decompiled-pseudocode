/*
 * XREFs of ?DdiDestroyDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYDOORBELL@@@Z @ 0x1401A3FD8
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5165);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5165);
  ...
  v11 = (*(int (__fastcall **)(struct _DXGKARG_DESTROYDOORBELL *))(*((_QWORD *)this + 2) + 1552LL))(a2);
  ...
  if ( (_DWORD)v11 != -1073741822 && (_DWORD)v11 )
  {
