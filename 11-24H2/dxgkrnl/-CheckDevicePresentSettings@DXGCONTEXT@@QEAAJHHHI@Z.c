/*
 * XREFs of ?CheckDevicePresentSettings@DXGCONTEXT@@QEAAJHHHI@Z @ 0x140183270
 * Callers:
...
__int64 __fastcall DXGCONTEXT::CheckDevicePresentSettings(DXGDEVICE **this, int a2, int a3, int a4, unsigned int a5)
{
  ...
  if ( ADAPTER_DISPLAY::IsVidPnSourceOwner(*(ADAPTER_DISPLAY **)(*((_QWORD *)this[2] + 237) + 3120LL), this[2], a5) )
  {
  ...
  if ( (*(_DWORD *)(*((_QWORD *)v9 + 5) + 408LL) & 4) != 0
    && (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(ADAPTER_DISPLAY **)(*((_QWORD *)v9 + 237) + 3120LL), a5) == 1 )
  {
    v10 = *(ADAPTER_DISPLAY **)(*((_QWORD *)this[2] + 237) + 3120LL);
    if ( (*(_DWORD *)(*(_QWORD *)(4024LL * a5 + *((_QWORD *)v10 + 16) + 752) + 408LL) & 4) != 0 )
    {
      ...
      v13 = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(ADAPTER_DISPLAY **)(*((_QWORD *)v12 + 237) + 3120LL), a5);
