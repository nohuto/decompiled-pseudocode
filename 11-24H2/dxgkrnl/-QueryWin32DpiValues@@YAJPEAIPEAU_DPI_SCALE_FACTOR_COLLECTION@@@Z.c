/*
 * XREFs of ?QueryWin32DpiValues@@YAJPEAIPEAU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x1403D3160
 * Callers:
...
__int64 __fastcall QueryWin32DpiValues(unsigned int *a1, struct _DPI_SCALE_FACTOR_COLLECTION *a2)
{
  ...
  if ( Current )
  {
    ...
    if ( v6 )
    {
      v7 = *(__int64 (__fastcall **)(int *))(v6 + 368);
      if ( v7 )
      {
        ...
        else
        {
          ...
          v8 = *(__int64 (__fastcall **)(int *))(v6 + 368);
          v11 = 1;
          v12 = 32;
          v13 = (unsigned int *)a2;
          v4 = v8(&v11);
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"NT_SUCCESS(Status)", v10, 0LL, 0LL, 0LL, 0LL);
      }
    }
  }
  return (unsigned int)v4;
