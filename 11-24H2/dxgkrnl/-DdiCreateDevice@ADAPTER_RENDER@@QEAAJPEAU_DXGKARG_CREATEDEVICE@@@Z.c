/*
 * XREFs of ?DdiCreateDevice@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEDEVICE@@@Z @ 0x1403AC540
 * Callers:
 *     ADAPTER_RENDER_DdiCreateDevice @ 0x14006BC00 (ADAPTER_RENDER_DdiCreateDevice.c)
