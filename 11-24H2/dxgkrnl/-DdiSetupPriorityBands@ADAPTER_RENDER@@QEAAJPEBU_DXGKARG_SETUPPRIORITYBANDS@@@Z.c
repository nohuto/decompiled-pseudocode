/*
 * XREFs of ?DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1401A94C8
 * Callers:
 *     ADAPTER_RENDER_DdiSetupPriorityBands @ 0x14006BE60 (ADAPTER_RENDER_DdiSetupPriorityBands.c)
 * Callees:
