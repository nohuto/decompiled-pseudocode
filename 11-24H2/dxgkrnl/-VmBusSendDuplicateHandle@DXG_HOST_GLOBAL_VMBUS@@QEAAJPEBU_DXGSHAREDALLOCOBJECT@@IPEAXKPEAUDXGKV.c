/*
 * XREFs of ?VmBusSendDuplicateHandle@DXG_HOST_GLOBAL_VMBUS@@QEAAJPEBU_DXGSHAREDALLOCOBJECT@@IPEAXKPEAUDXGKVMB_GUEST_TRANSACTION@@@Z @ 0x14022A9D0
 * Callers:
        ...
        struct DXGKVMB_GUEST_TRANSACTION *a6)
{
  ...
  *v27 = *(_DWORD *)(v7 + 12);
  ...
  while ( v31 != v11 )
  {
    ...
    *((_QWORD *)v28 + 1) = *(v31 - 4);
    ADAPTER_RENDER::DdiDescribeAllocation(v20, (struct _DXGKARG_DESCRIBEALLOCATION *)(v28 + 8));
    *((_QWORD *)v28 + 1) = 0LL;
    v32 = v28 + 56;
