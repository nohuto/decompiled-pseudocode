/*
 * XREFs of DxgkSetVidPnSourceHwProtection @ 0x1401AFF60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetVidPnSourceHwProtection(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid process context", 11435LL, 0LL, 0LL, 0LL, 0LL);
LABEL_37:
  ...
  *(_QWORD *)v30 = 0LL;
  ...
  if ( !v29 )
  {
    ...
    WdLogGlobalForLineNumber = 11459;
...
LABEL_36:
  ...
  if ( !*((_QWORD *)v29 + 390) )
  {
    ...
    WdLogGlobalForLineNumber = 11468;
    goto LABEL_36;
  }
      ...
      *(_BYTE *)(4024LL * v30[1] + *(_QWORD *)(*((_QWORD *)v5 + 390) + 128LL) + 1160) = v31 != 0;
      ...
      else
      {
        *(_BYTE *)(v17 + 476) = 0;
        ...
        {
          if ( *(_BYTE *)(4024LL * v18 + *(_QWORD *)(v19 + 128) + 1160) )
          {
            *(_BYTE *)(v19 + 476) = 1;
            break;
          }
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 11479;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
