/*
 * XREFs of DxgkQueryConnectionChanges @ 0x140027BD0
 * Callers:
...
__int64 __fastcall DxgkQueryConnectionChanges(__int64 a1, char a2, unsigned __int8 a3, char a4, char a5, char a6)
{
  ...
  if ( !v6 || *(_DWORD *)(v6 + 16) != 1953656900 || *(_DWORD *)(v6 + 20) != 2 )
  {
    ...
    result = 3221225485LL;
    WdLogGlobalForLineNumber = 19226;
    return result;
  }
  if ( DISPLAY_MUX_MGR::GetDisableQueryConnectionDdiStatus(qword_140161380, *(struct _LUID *)(v6 + 2696)) )
  {
    WdLogSingleEntry1(3LL, 0LL);
    v36 = *(_QWORD *)(v6 + 5888);
    WdLogGlobalForLineNumber = 19235;
    v79 = 0LL;
    v85 = *(_QWORD *)(v6 + 2696);
    v82 = 0LL;
    v78[0] = 30;
  ...
  if ( (unsigned int)(*(_DWORD *)(v6 + 236) - 1) > 1 || *(_DWORD *)(v6 + 4120) == 1 || *(_DWORD *)(v6 + 284) != 1 )
  {
    ...
    WdLogGlobalForLineNumber = 19277;
    goto LABEL_64;
  }
  if ( (*(_BYTE *)(v6 + 4040) & 1) != 0 )
  {
    if ( !(unsigned __int8)DxgkIsAdapterCoreSyncAcquired(*(_QWORD *)(v6 + 4032), 2LL) )
    {
      ...
      if ( v12 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 19302;
        goto LABEL_64;
      }
      v60 = 1;
    }
    ...
    while ( v16 != (_QWORD *)(v6 + 3600) )
    {
      ...
      if ( v17[4] == 1 )
      {
        ...
        if ( v38 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 19364;
        }
      }
    }
    if ( v69[0] )
    ...
    do
    {
      while ( 1 )
      {
        ...
        *(_DWORD *)(v6 + 3652) = 2;
        ...
        if ( v20 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 19393;
          goto LABEL_52;
        }
        if ( v20 == 255 )
          goto LABEL_52;
        ...
        || (HIBYTE(*(_DWORD *)&v76[8]) & 0xF) == 6 )
      {
        ...
        if ( v45 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 19441;
        }
        goto LABEL_49;
      }
      if ( (HIBYTE(*(_DWORD *)&v76[8]) & 0xF) != 8 && (HIBYTE(*(_DWORD *)&v76[8]) & 0xF) != 0xA )
      {
        if ( (HIBYTE(*(_DWORD *)&v76[8]) & 0xF) != 0xC && (HIBYTE(*(_DWORD *)&v76[8]) & 0xFu) - 13 >= 2 )
        {
          ...
          WdLogGlobalForLineNumber = 19595;
...
LABEL_100:
        ...
        if ( updated < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 19586;
        }
        goto LABEL_49;
      }
      if ( *(_BYTE *)(v6 + 6393) )
      ...
      if ( !ChildDescriptor )
      {
        ...
        WdLogGlobalForLineNumber = 19468;
        goto LABEL_49;
      }
      ...
      if ( (v25 & 0xF000000) == 0xA000000 && (v76[16] & 1) != 0 )
      {
        ...
        {
          if ( (unsigned int)dword_14015E5A8 > 5 && (unsigned __int8)tlgKeywordOn(&dword_14015E5A8, 0x400000002000LL) )
          {
            v62 = *(_DWORD *)&v76[28];
            v43 = v42 & 0xFFFFFF;
            v63 = *(_DWORD *)&v76[24];
          ...
          WdLogSingleEntry1(2LL, v13);
          LODWORD(v25) = *(_DWORD *)&v76[8];
          WdLogGlobalForLineNumber = 19522;
        }
      }
      v28 = v76[60] || v19 == 3;
      v29 = v25 & 0xF000000;
      ...
      if ( v30 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 19543;
      }
      v18 = (KSPIN_LOCK *)(v6 + 3656);
LABEL_46:
      if ( *v26 == 1 )
...
LABEL_52:
    ...
    while ( 1 )
    {
      ...
      if ( MonitorQuerySkippedRemovalState(*(void **)(v6 + 4032), v49, &v58) >= 0 && v58 )
      {
        ...
        if ( v50 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 19677;
          break;
        }
        v90 = 0LL;
        v87 = 0LL;
  ...
  if ( v59 )
  {
    ...
    if ( v35 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 19713;
    }
  }
  if ( (*(_BYTE *)(v6 + 4040) & 1) != 0 )
