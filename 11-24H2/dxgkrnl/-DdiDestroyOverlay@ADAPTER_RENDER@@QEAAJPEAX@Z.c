/*
 * XREFs of ?DdiDestroyOverlay@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1401A4720
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyOverlay(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5035);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5035);
  ...
  v10 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 768LL))(a2);
