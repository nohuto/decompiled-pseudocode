/*
 * XREFs of ?DdiFormatHistoryBuffer@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_FORMATHISTORYBUFFER@@@Z @ 0x1400688F8
 * Callers:
 *     ADAPTER_RENDER_DdiFormatHistoryBuffer @ 0x14006BCE0 (ADAPTER_RENDER_DdiFormatHistoryBuffer.c)
 * Callees:
