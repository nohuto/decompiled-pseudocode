/*
 * XREFs of ?ReadEdidFromRegistry@EDIDCACHE@DxgMonitor@@CAJIPEAEPEAW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x14027042C
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN *a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( !v11 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"InternalMonEdidHandle", 209LL, 0LL, 0LL, 0LL, 0LL);
      v8 = v11;
    }
    v13 = 0LL;
    v20 = 0LL;
