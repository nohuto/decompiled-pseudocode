/*
 * XREFs of ?ObtainSupportedFrequencyRanges@EDID_MODES@MonDescParser@@QEAAJPEAGPEAU_FrequencyRangeDescriptor@@@Z @ 0x140098B04
 * Callers:
 ...
 * Callees:
 *     ?Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x140048C64 (-Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 */
        ...
        struct _FrequencyRangeDescriptor *a3)
{
  ...
  for ( i = 0; ; i = v6 + 1 )
  {
    if ( i >= 4u )
      return 3221226021LL;
    if ( MonDescParser::EDID_PARSER::Is18ByteDispDesc(*this, i) && *(_BYTE *)(*v5 + 18LL * v6 + 57) == 0xFD )
      break;
  }
  if ( *v7 )
  {
