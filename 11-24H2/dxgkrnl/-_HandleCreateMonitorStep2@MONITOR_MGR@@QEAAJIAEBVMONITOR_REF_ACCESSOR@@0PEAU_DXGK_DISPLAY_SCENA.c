/*
 * XREFs of ?_HandleCreateMonitorStep2@MONITOR_MGR@@QEAAJIAEBVMONITOR_REF_ACCESSOR@@0PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x14028E704
 * Callers:
        ...
        GUID *a5)
{
  ...
  if ( *((_QWORD *)a4 + 1) )
  {
    ...
    if ( MONITOR_MGR::_GetMonitorInstance(
           this,
