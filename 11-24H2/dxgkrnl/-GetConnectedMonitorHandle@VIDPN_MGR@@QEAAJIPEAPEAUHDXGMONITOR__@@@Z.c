/*
 * XREFs of ?GetConnectedMonitorHandle@VIDPN_MGR@@QEAAJIPEAPEAUHDXGMONITOR__@@@Z @ 0x1402DF70C
 * Callers:
...
__int64 __fastcall VIDPN_MGR::GetConnectedMonitorHandle(VIDPN_MGR *this, unsigned int a2, struct HDXGMONITOR__ **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(v6, v3) )
  {
    ...
    MonitorHandle = MonitorGetMonitorHandle(ContainingAdapter, v3, 0, (void *)0x4E506456, a3);
    if ( v6 )
