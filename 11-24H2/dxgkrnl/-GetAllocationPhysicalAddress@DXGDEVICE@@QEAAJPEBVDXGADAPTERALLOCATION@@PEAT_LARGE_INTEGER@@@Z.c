/*
 * XREFs of ?GetAllocationPhysicalAddress@DXGDEVICE@@QEAAJPEBVDXGADAPTERALLOCATION@@PEAT_LARGE_INTEGER@@@Z @ 0x1401BAC10
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  if ( !ExIsResourceAcquiredSharedLite(*((PERESOURCE *)this + 17)) )
  {
    ...
    WdLogGlobalForLineNumber = 11997;
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"IsDeviceLockSharedOwner()", 11997LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 12010;
  }
  return v7;
}
