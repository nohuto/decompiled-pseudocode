/*
 * XREFs of ?DdiUpdateMonitorLinkInfo@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x1401A9C88
 * Callers:
 *     ?UpdateMonitorLinkInfo@KernelDriver@@UEAAJAEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x14027DDB0 (-UpdateMonitorLinkInfo@KernelDriver@@UEAAJAEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5072);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 5072);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_UPDATEMONITORLINKINFO *))(*((_QWORD *)this + 2) + 1088LL))(
  ...
  v16[6] = a2->MonitorLinkInfo.UsageHints.Value;
  v16[7] = a2->MonitorLinkInfo.Capabilities.Value;
