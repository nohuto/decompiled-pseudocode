/*
 * XREFs of ?DdiRecommendFunctionalVidPn@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDFUNCTIONALVIDPN@@@Z @ 0x1403D38B4
 * Callers:
        ...
        __int64 a3)
{
  ...
  KIRQL v13; // al
  __int64 v14; // rcx
  D3DDDI_VIDEO_PRESENT_TARGET_ID v15; // ecx
  __int64 v16; // rcx
  __int64 v17; // r8
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5024);
  }
  else
  {
    v21 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v19, 5024);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDFUNCTIONALVIDPN *))(*((_QWORD *)this + 2) + 624LL))(
  ...
  if ( a2->NumberOfVidPnTargets )
    v15 = *a2->pVidPnTargetPrioritizationVector;
  else
    v15 = 0;
  WdLogSingleEntry5(
    4LL,
  ...
  if ( (_DWORD)v12 != -1073741801
    && (_DWORD)v12 != -1071774941
  ...
  if ( v21 && (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
    McTemplateK0q_EtwWriteTransfer(v16, (__int64)&EventProfilerExit, v17, v19);
