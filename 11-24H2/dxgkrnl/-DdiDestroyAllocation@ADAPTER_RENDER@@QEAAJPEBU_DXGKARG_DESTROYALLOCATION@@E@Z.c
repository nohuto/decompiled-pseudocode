/*
 * XREFs of ?DdiDestroyAllocation@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_DESTROYALLOCATION@@E@Z @ 0x140325C3C
 * Callers:
...
LABEL_15:
  v56 = 0;
  v55 = (DXGPUSHLOCK *)(((unsigned __int64)v12 + 152) & ((unsigned __int128)-(__int128)(unsigned __int64)v12 >> 64));
  if ( v55
