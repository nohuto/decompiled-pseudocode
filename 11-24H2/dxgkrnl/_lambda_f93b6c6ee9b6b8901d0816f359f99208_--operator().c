/*
 * XREFs of _lambda_f93b6c6ee9b6b8901d0816f359f99208_::operator() @ 0x14021AEC4
 * Callers:
...
__int64 __fastcall lambda_f93b6c6ee9b6b8901d0816f359f99208_::operator()(__int64 **a1)
{
  __int64 v2; // rcx
  __int64 *v4; // rax
  ...
  if ( *(_DWORD *)(v2 + 392) >= 0x23u )
  {
      ...
      if ( *(_DWORD *)(*v4 + 36) < 0x10u )
      {
        if ( *(_DWORD *)(*v4 + 40) < 2u )
        {
          ...
          if ( (v8[5].LowPart & 1) != 0 )
          {
            ...
            v15 = *(_DWORD *)(v10 + 392);
            return HOSTVMMONITORMAPPING::AddMapping((KSPIN_LOCK *)v7 + 38164, &v11);
          }
          else
          {
            return HOSTVMMONITORMAPPING::RemoveMapping(
                     (struct DXGGLOBAL *)((char *)v7 + 305312),
    ...
    {
      WdLogSingleEntry0(2LL);
      WdLogGlobalForLineNumber = 8568;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000LL,
        0xFFFFFFFFLL,
        L"Shared page is not enabled",
        8568LL,
        0LL,
        0LL,
        0LL,
