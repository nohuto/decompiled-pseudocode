/*
 * XREFs of ?VmBusSignalGuestEventPassive@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140230EB0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusSignalGuestEventPassive(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( (unsigned __int64)(v4 - 1) > 0xFFFFFFFFFFFFFFFDuLL )
    {
      ...
      WdLogGlobalForLineNumber = 14337;
    }
    else
    {
  ...
  else
  {
    ...
    Object = *(PVOID **)(v1 + 32);
    WdLogGlobalForLineNumber = 14328;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
      L"Unable to reference EPROCESS from process handle 0x%I64x Status: 0xI64x",
      (__int64)Object,
      v3,
      0LL,
      0LL,
