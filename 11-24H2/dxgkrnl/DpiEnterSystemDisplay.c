/*
 * XREFs of DpiEnterSystemDisplay @ 0x14007DE70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_38:
                    ...
                    {
                      v15 = v27;
                      if ( !v27 && qword_140160FB8 && v3 == *(_QWORD *)(qword_140160FB8 + 64) )
                        *(_DWORD *)(a2 + 16) = 1;
                      else
                        *(_DWORD *)(a2 + 16) = 5;
                      v16 = v19;
...
LABEL_37:
      ...
      v10 = *(_QWORD *)v10;
      if ( *(_QWORD *)v10 == qword_140160D48 )
        goto LABEL_49;
    }
  }
  if ( qword_140160FC0 )
  {
    v17 = *(_QWORD *)(qword_140160FC0 + 64);
    if ( *(_DWORD *)(v17 + 236) == 2 )
