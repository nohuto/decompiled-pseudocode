/*
 * XREFs of ?DestroyStagingSurface@DXGDEVICE@@QEAAXIIPEAVCOREDEVICEACCESS@@@Z @ 0x1401B9A4C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pProcess != NULL", 9196LL, 0LL, 0LL, 0LL, 0LL);
  }
  v26 = 0LL;
  v7 = 0LL;
...
LABEL_14:
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pResource != NULL", 9207LL, 0LL, 0LL, 0LL, 0LL);
LABEL_15:
...
LABEL_28:
  ...
  if ( !v21 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pAllocation != NULL", 9213LL, 0LL, 0LL, 0LL, 0LL);
  }
