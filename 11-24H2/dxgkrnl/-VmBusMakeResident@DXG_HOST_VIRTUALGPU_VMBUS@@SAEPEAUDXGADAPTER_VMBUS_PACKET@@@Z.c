/*
 * XREFs of ?VmBusMakeResident@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140425E60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusMakeResident(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _BYTE v37[160]; // [rsp+118h] [rbp+10h] BYREF
...
LABEL_23:
                ...
                if ( v23 )
                {
                  ...
                  WdLogSingleEntry3(2LL, v18, v23, -1073741811LL);
...
LABEL_26:
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid packet size 0x%I64x", v22, 0LL, 0LL, 0LL, 0LL);
      LODWORD(v34) = -1073741811;
    }
LABEL_36:
    if ( (int)v34 >= 0 )
