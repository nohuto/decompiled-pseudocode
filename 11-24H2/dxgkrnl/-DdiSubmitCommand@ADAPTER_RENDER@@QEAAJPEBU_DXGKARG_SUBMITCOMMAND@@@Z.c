/*
 * XREFs of ?DdiSubmitCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUBMITCOMMAND@@@Z @ 0x140014B98
 * Callers:
 *     ADAPTER_RENDER_DdiSubmitCommand @ 0x140014B80 (ADAPTER_RENDER_DdiSubmitCommand.c)
 * Callees:
