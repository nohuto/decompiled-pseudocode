/*
 * XREFs of ??0?$DoublyLinkedList@VDMMVIDPNSOURCE@@U?$DoubleLinkedListElementDeleter@VDMMVIDPNSOURCE@@@@@@QEAA@AEBV0@@Z @ 0x14000BEAC
 * Callers:
...
LABEL_16:
    ...
    v6 = (const struct DMMVIDPNSOURCE *)(v13 - 1);
    if ( v13 == v4 )
      v6 = 0LL;
  }
