/*
 * XREFs of ?SysMmUnmapLogicalAddressRange@@YAJPEAUSYSMM_ADAPTER@@PEAU_IOMMU_DMA_DOMAIN@@_K2@Z @ 0x140286770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SysMmUnmapLogicalAddressRange(struct SYSMM_ADAPTER *a1, struct _IOMMU_DMA_DOMAIN *a2)
{
  ...
  return ((__int64 (__fastcall *)(__int64, __int64, unsigned __int64))qword_140161570)(v5, v6, v4 >> 12);
}
