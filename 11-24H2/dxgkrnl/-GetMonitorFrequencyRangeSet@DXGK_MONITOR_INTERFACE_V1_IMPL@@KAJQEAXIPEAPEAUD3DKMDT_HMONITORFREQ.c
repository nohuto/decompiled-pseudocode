/*
 * XREFs of ?GetMonitorFrequencyRangeSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@PEAPEBU_DXGK_MONITORFREQUENCYRANGESET_INTERFACE@@@Z @ 0x140271C80
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORFREQUENCYRANGESET_INTERFACE **a4)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(a1, (__int64)&EventProfilerEnter, (__int64)a3, 7054);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 7054);
...
LABEL_19:
  ...
  else if ( MonitorHandle >= 0 )
  {
    ...
    *a3 = (struct D3DKMDT_HMONITORFREQUENCYRANGESET__ *)v27;
