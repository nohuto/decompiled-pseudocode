/*
 * XREFs of DpiPdoDispatchPnp @ 0x1403B44D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiPdoEnableDisableConnectSound @ 0x140254F40 (DpiPdoEnableDisableConnectSound.c)
...
__int64 __fastcall DpiPdoDispatchPnp(struct _DEVICE_OBJECT *a1, IRP *Tag)
{
  ...
  __int64 v8; // r13
  __int64 (__fastcall *v9)(struct _DEVICE_OBJECT *); // rax
  int v11; // ecx
  __int64 v12; // rdi
  int v13; // ecx
  int v14; // ecx
  ...
  {
    v9 = *(__int64 (__fastcall **)(struct _DEVICE_OBJECT *))&DeviceExtension[8 * MinorFunction + 288];
    if ( v9 )
    {
      Status = v9(a1);
      goto LABEL_4;
  ...
  if ( (unsigned int)MinorFunction <= 8 )
  {
    if ( (_DWORD)MinorFunction == 8 )
    {
      ...
      v34 = 0;
      v38 = 0;
      if ( !*(_QWORD *)(v12 + 256) || (int)DpiAcquireCoreSyncAccessSafe((__int64)a1, 1) < 0 )
        goto LABEL_13;
    ...
    if ( !v18 )
    {
      if ( *((_DWORD *)DeviceExtension + 60) == 2 )
        DpiPdoHandleStopDevice((__int64)a1);
...
LABEL_13:
  ...
  Status = DpiAcquireCoreSyncAccessSafe((__int64)a1, 1);
  if ( Status < 0 )
    goto LABEL_4;
  v28 = *(DXGADAPTER **)(v8 + 4032);
  Data = 0;
  if ( DXGADAPTER::IsAdapterSessionized(v28, v27, &Data, 0LL) )
    IoSetDevicePropertyData(a1, &DEVPKEY_Device_SessionId, 0, v29, 7u, 4u, &Data);
  MonitorNotifyDeviceNodeReady(*(PERESOURCE **)(v8 + 4032), *((_DWORD *)DeviceExtension + 126), a1);
  DeviceExtension[944] = 1;
  DpiReleaseCoreSyncAccessSafe((__int64)a1, 1);
  if ( IsInternalVideoOutput(*(enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY *)(*((_QWORD *)DeviceExtension + 117) + 4LL)) )
    DpiPdoEnableDisableConnectSound(a1, v30);
LABEL_5:
