/*
 * XREFs of _EnforceDriverModelScalingPolicy @ 0x1403E5DC0
 * Callers:
...
void __fastcall EnforceDriverModelScalingPolicy(__int64 a1, enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING *a2)
{
  ...
  {
    v5 = *a2;
    if ( *(int *)(*(_QWORD *)(v4 + 16) + 3004LL) < 1105 )
    {
    ...
    AdapterDefaultScaling = VIDPN_MGR::GetAdapterDefaultScaling(*(VIDPN_MGR **)(*(_QWORD *)(a1 + 3120) + 104LL));
