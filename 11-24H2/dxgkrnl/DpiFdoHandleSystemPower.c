/*
 * XREFs of DpiFdoHandleSystemPower @ 0x1403B9E38
 * Callers:
...
NTSTATUS __fastcall DpiFdoHandleSystemPower(PDEVICE_OBJECT DeviceObject, IRP *Context)
{
  ...
  if ( CurrentStackLocation->Parameters.Read.ByteOffset.LowPart != 6 || v4 || !HIBYTE(word_1401612B8) )
  {
LABEL_4:
    if ( v7 == -1073741637 )
    {
      ...
      if ( !DeviceExtension[1158] )
      {
        if ( DeviceExtension[480] )
        {
            ...
            && CurrentStackLocation->MinorFunction == 2 )
          {
            ...
            v20 = (unsigned int)(dword_140161110 - 4) <= 1;
            v29 = v20;
            if ( v19 == 1 )
            {
            ...
            if ( DeviceExtension[1153] && v19 < *((_DWORD *)DeviceExtension + 71) )
            {
              ...
              else if ( byte_140161130 )
              {
                LOBYTE(v18) = 1;
                DpiAcquirePostDisplayInfoFromBgfx(&xmmword_140160FC8, v18);
                if ( v29 )
                {
                  ...
                  *((_OWORD *)&DpGlobals + 64) = *(_OWORD *)((char *)&DpGlobals + 856);
                  ...
                  qword_140161120 = (__int64)DeviceObject;
                }
              }
            }
...
LABEL_71:
  ...
  if ( DpiFdoIsMsBddAnchoredDevice((__int64)DeviceObject) && (unsigned int)(dword_140161110 - 1) <= 1 )
