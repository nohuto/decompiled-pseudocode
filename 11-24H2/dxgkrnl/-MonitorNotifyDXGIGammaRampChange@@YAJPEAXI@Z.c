/*
 * XREFs of ?MonitorNotifyDXGIGammaRampChange@@YAJPEAXI@Z @ 0x1402DFBB8
 * Callers:
...
__int64 __fastcall MonitorNotifyDXGIGammaRampChange(DXGADAPTER *a1, unsigned int a2)
{
  ...
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v4, v2, 1u, (struct MONITOR_REF_ACCESSOR *)&v7);
