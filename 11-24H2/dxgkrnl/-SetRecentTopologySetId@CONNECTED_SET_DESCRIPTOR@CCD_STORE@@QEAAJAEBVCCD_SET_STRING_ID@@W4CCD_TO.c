/*
 * XREFs of ?SetRecentTopologySetId@CONNECTED_SET_DESCRIPTOR@CCD_STORE@@QEAAJAEBVCCD_SET_STRING_ID@@W4CCD_TOPOLOGY_CLASS@@@Z @ 0x1403420BC
 * Callers:
 ...
 *     ?_GetValueNameByTopologyClass@CONNECTED_SET_DESCRIPTOR@CCD_STORE@@CAXW4CCD_TOPOLOGY_CLASS@@PEAU_UNICODE_STRING@@@Z @ 0x140341190 (-_GetValueNameByTopologyClass@CONNECTED_SET_DESCRIPTOR@CCD_STORE@@CAXW4CCD_TOPOLOGY_CLASS@@PEAU_.c)
...
__int64 __fastcall CCD_STORE::CONNECTED_SET_DESCRIPTOR::SetRecentTopologySetId(__int64 a1, __int64 a2, signed int a3)
{
  ...
  if ( (unsigned int)a3 <= 8 && (v6 = 278, _bittest(&v6, a3)) )
  {
    v7 = *(void **)(a1 + 96);
    v15.Buffer = L"Recent";
    *(_QWORD *)&v15.Length = 917516LL;
    v8 = CcdWriteStrValueToRegistry(v7, &v15, (PCANSI_STRING)(a2 + 8));
    v9 = v8;
    if ( v8 >= 0 )
    {
      if ( !*(_QWORD *)(a1 + 88) )
