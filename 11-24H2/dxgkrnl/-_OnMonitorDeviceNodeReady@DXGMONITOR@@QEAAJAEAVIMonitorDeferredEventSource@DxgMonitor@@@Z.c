/*
 * XREFs of ?_OnMonitorDeviceNodeReady@DXGMONITOR@@QEAAJAEAVIMonitorDeferredEventSource@DxgMonitor@@@Z @ 0x14028C2B0
 * Callers:
 ...
 * Callees:
 *     ?OnDeviceNodeReady@MonitorUsb4State@DxgMonitor@@QEAAXAEAVMonitorPnpState@2@@Z @ 0x14018B7BC (-OnDeviceNodeReady@MonitorUsb4State@DxgMonitor@@QEAAXAEAVMonitorPnpState@2@@Z.c)
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = this;
  ...
  if ( !*(_BYTE *)(v6 + 16) )
  {
    ...
    *((_BYTE *)v7 + 16) = 1;
    ...
    DxgMonitor::MonitorModes::RetrieveMonitorFrequencyRangeFromRegistry(*((PERESOURCE *)this + 29), v9);
