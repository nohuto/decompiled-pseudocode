/*
 * XREFs of DxgkQueryVideoMemoryInfo @ 0x14034FC90
 * Callers:
...
__int64 __fastcall DxgkQueryVideoMemoryInfo(_DWORD *a1)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(qword_14015E4B0, (__int64)&EventProfilerEnter, v2, 2119);
  }
  else
  {
    v39 = 0;
  ...
  if ( Current )
  {
    ...
    if ( *v5 )
    {
      ...
      if ( v31 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 14380;
LABEL_53:
...
LABEL_19:
          ...
          if ( v14 >= 0 )
          {
            ...
            WdLogGlobalForLineNumber = 14460;
            COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v47);
            goto LABEL_42;
          }
          WdLogSingleEntry1(3LL, v15);
          WdLogGlobalForLineNumber = 14421;
          COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v47);
          if ( v41 )
            DXGADAPTER::ReleaseReference(v41);
          goto LABEL_53;
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 14362;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
