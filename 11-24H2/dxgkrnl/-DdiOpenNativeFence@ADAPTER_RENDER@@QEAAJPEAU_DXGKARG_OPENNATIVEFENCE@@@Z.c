/*
 * XREFs of ?DdiOpenNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_OPENNATIVEFENCE@@@Z @ 0x1401A6B34
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiOpenNativeFence(
        ADAPTER_RENDER *this,
        struct _DXGKARG_OPENNATIVEFENCE *a2,
        __int64 a3)
{
  ...
  int v9; // ebp
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(_QWORD, struct _DXGKARG_OPENNATIVEFENCE *); // rax
  int v12; // edi
  KIRQL v13; // al
  __int64 v14; // rcx
  __int64 v15; // rcx
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5169);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5169);
  ...
  v10 = *((_QWORD *)this + 2);
  v11 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_OPENNATIVEFENCE *))(v10 + 1680);
  if ( v11 )
