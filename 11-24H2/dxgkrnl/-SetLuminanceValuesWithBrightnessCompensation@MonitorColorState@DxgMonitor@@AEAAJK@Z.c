/*
 * XREFs of ?SetLuminanceValuesWithBrightnessCompensation@MonitorColorState@DxgMonitor@@AEAAJK@Z @ 0x140186290
 * Callers:
 ...
 *     ?TriggerExternalMonitorSdrWhiteLevelChangedWnf@MonitorColorState@DxgMonitor@@AEAAJK@Z @ 0x14027C5C8 (-TriggerExternalMonitorSdrWhiteLevelChangedWnf@MonitorColorState@DxgMonitor@@AEAAJK@Z.c)
        ...
        unsigned int a2)
{
  ...
  if ( (unsigned int)Feature_HdrBrightnessPolicy__private_IsEnabledDeviceUsageNoInline() && !*((_DWORD *)this + 131) )
  {
    v5 = *((_DWORD *)this + 118);
    v6 = (DxgMonitor::MonitorColorState *)*((unsigned int *)this + 119);
    if ( (unsigned int)v5 < 0x13880 && *((_BYTE *)this + 528) )
      v7 = 1000;
    else
  ...
  if ( v9 )
  {
    ...
    if ( (unsigned int)Feature_HdrBrightnessPolicy__private_IsEnabledDeviceUsageNoInline() )
    {
      if ( !*((_DWORD *)this + 131) )
      {
        v14 = (float)((float)*((int *)this + 134) / 1000.0) * (float)((float)*((int *)this + 92) / 10000.0);
        v13 = fminf(v14, v13);
        v12 = fminf(v14, v12);
      }
    }
