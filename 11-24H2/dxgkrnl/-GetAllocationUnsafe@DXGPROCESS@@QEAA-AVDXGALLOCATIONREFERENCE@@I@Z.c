/*
 * XREFs of ?GetAllocationUnsafe@DXGPROCESS@@QEAA?AVDXGALLOCATIONREFERENCE@@I@Z @ 0x140034428
 * Callers:
    ...
    && (v6 = *(_DWORD *)(v5 + 16LL * v4 + 8) & 0x1F) != 0 )
  {
    ...
    else
    {
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x200000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(318LL, v9, v10, 0LL, 0, -1, L"Handle type mismatch", 62, 0, 0, 0, 0);
    }
  }
  else
  {
