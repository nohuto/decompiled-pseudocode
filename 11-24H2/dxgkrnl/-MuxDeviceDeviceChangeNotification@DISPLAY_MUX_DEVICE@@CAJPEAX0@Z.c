/*
 * XREFs of ?MuxDeviceDeviceChangeNotification@DISPLAY_MUX_DEVICE@@CAJPEAX0@Z @ 0x140085BA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  if ( (unsigned int)dword_14015E5A8 > 5 && tlgKeywordOn((__int64)&dword_14015E5A8, 512LL) )
  {
    ...
    v18 = v2;
    v19 = 16;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015E5A8, byte_14013F714, 0LL, 0LL, 5u, &v11);
  }
  return v3;
}
