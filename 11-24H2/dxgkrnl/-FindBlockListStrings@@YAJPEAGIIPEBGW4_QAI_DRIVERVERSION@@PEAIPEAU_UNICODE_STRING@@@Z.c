/*
 * XREFs of ?FindBlockListStrings@@YAJPEAGIIPEBGW4_QAI_DRIVERVERSION@@PEAIPEAU_UNICODE_STRING@@@Z @ 0x1402383BC
 * Callers:
                  ...
                  if ( *a6 < 0x14 )
                  {
                    ...
                    if ( v8 >= 0 )
                    {
                      ...
                      if ( (v30 || v20)
                        ...
                        && tlgKeywordOn((__int64)&dword_14015E650, 0x400000000200LL) )
                      {
                      ...
                      if ( v31 != (_BYTE)v21 && (unsigned int)dword_14015E650 > 5 )
                      {
                        if ( tlgKeywordOn((__int64)&dword_14015E650, 0x400000001000LL) )
                        {
                          v44 = v43;
                          v35 = v32;
                          v34 = v33;
