/*
 * XREFs of ?SetSyncLockGroup@ADAPTER_DISPLAY@@QEAAXIKIW4_DXGK_SYNC_LOCK_STYLE@@K@Z @ 0x1400564F4
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::SetSyncLockGroup(__int64 a1, unsigned int a2, int a3, int a4, int a5, unsigned int a6)
{
  ...
  v7 = 10LL * a2;
  *(_DWORD *)(a1 + 80 * (a2 + 11LL)) = a3;
  *(_DWORD *)(a1 + 8 * v7 + 888) = a5;
  *(_DWORD *)(a1 + 8 * v7 + 884) = a4;
  *(_DWORD *)(a1 + 8 * v7 + 920) = a6 >> 1;
  if ( a3 )
  {
    v8 = 0LL;
    if ( *(_QWORD *)(a1 + 80LL * a2 + 944) || (v8 = operator new[](0xF90uLL, 0x4B677844u, 64LL)) != 0 )
    {
      ...
      if ( v8 )
      {
        ...
        *(_QWORD *)(a1 + 8 * v7 + 908) = 0LL;
        *(_DWORD *)(a1 + 8 * v7 + 916) = 0;
        *(_QWORD *)(a1 + 8 * v7 + 928) = 0LL;
        *(_QWORD *)(a1 + 8 * v7 + 936) = 0LL;
        *(_DWORD *)(a1 + 744) = 0;
        *(_DWORD *)(a1 + 748) = MEMORY[0xFFFFF78000000008] / 0x989680uLL;
        *(_QWORD *)(a1 + 8 * v7 + 944) = v8;
        *(_QWORD *)(a1 + 8 * v7 + 952) = v8 + 384;
        KeSetTimerEx((PKTIMER)(a1 + 752), (LARGE_INTEGER)-40000000LL, 4000, (PKDPC)(a1 + 816));
      }
      *(_BYTE *)(a1 + 8 * v7 + 896) = 1;
