        ...
        __int64 a30)
{
  ...
  int v54; // eax
  _WORD *v55; // r8
  _BYTE v57[32]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v61 = 4LL;
  v59 = 16LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015E650, a2, a3, 0LL, 28, v57);
}
