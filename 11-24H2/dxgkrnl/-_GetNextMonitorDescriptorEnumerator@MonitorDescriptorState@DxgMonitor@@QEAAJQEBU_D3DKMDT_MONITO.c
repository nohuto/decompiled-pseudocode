/*
 * XREFs of ?_GetNextMonitorDescriptorEnumerator@MonitorDescriptorState@DxgMonitor@@QEAAJQEBU_D3DKMDT_MONITOR_DESCRIPTOR@@PEAPEBU3@@Z @ 0x1403DBF6C
 * Callers:
...
LABEL_15:
    ...
    v18 = operator new(0x30uLL, 0x4D677844u, 256LL);
