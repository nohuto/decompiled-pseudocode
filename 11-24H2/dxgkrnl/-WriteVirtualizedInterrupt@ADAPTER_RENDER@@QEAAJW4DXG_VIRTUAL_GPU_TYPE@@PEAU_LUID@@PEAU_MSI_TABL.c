/*
 * XREFs of ?WriteVirtualizedInterrupt@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@PEAU_MSI_TABLE_ENTRY@@PEAU_DXGKARG_GPUP_WRITE_VIRTUALIZED_MSIX@@@Z @ 0x14020F898
 * Callers:
