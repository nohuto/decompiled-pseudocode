/*
 * XREFs of ?DisplayID_GetNativeLuminance@@YAJPEBUDisplayIDObj@@PEAK11PEAI@Z @ 0x140097C48
 * Callers:
 ...
 *     ?GetHdrLuminance@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAK00@Z @ 0x140280E00 (-GetHdrLuminance@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAK00@Z.c)
 * Callees:
 ...
 *     ?ConvertHalfToFloat@@YAMG@Z @ 0x1400979B8 (-ConvertHalfToFloat@@YAMG@Z.c)
 *     ?IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ @ 0x140097D8C (-IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ.c)
 */
