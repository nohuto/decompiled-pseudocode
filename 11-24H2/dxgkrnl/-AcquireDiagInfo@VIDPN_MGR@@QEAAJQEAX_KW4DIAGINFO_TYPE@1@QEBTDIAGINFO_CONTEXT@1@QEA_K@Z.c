/*
 * XREFs of ?AcquireDiagInfo@VIDPN_MGR@@QEAAJQEAX_KW4DIAGINFO_TYPE@1@QEBTDIAGINFO_CONTEXT@1@QEA_K@Z @ 0x140256108
 * Callers:
...
__int64 __fastcall VIDPN_MGR::AcquireDiagInfo(VIDPN_MGR *a1, void *a2, size_t a3, int a4, int *a5, size_t *a6)
{
  ...
  struct _DMM_MONITORPRESENCEEVENTSET_SERIALIZATION *v62; // rdi
  struct DXGADAPTER *v63; // rax
  struct DXGADAPTER *v64; // rax
  int v65; // eax
  struct DXGADAPTER *v66; // rax
  DMMVIDPN *v67; // [rsp+58h] [rbp-49h] BYREF
  __int64 v68; // [rsp+60h] [rbp-41h] BYREF
  __int64 v69; // [rsp+68h] [rbp-39h] BYREF
  __int64 v70; // [rsp+70h] [rbp-31h] BYREF
  __int64 v71; // [rsp+78h] [rbp-29h] BYREF
  __int128 v72; // [rsp+80h] [rbp-21h]
  void **v73; // [rsp+90h] [rbp-11h]
  void *Src; // [rsp+98h] [rbp-9h]
  unsigned __int64 v75; // [rsp+A0h] [rbp-1h]
  __int64 v76; // [rsp+A8h] [rbp+7h]
  unsigned __int64 v77; // [rsp+B0h] [rbp+Fh] BYREF
  __int64 v78; // [rsp+B8h] [rbp+17h] BYREF
  void *v79; // [rsp+100h] [rbp+5Fh] BYREF
...
LABEL_7:
  ...
  if ( a6 )
    *a6 = 0LL;
  Src = 0LL;
  v71 = (__int64)&DMM::AutoBuffer<_DMM_MONITORPRESENCEEVENTSET_SERIALIZATION>::`vftable'{for `SetElement'};
  ...
  if ( (int)v6 > 8 )
  {
    if ( (_DWORD)v6 == 9 )
    {
      ...
      v59 = MonitorSerializeMonitorPresentEvents(ContainingAdapter, &v77, 0LL);
      v17 = v59;
      if ( (int)(v59 + 0x80000000) >= 0 && v59 != -1073741789 )
      {
        v60 = VIDPN_MGR::GetContainingAdapter(a1);
        WdLogSingleEntry2(2LL, v60, v17);
      ...
      DMM::AutoBuffer<_DMM_DISPMODECHANGEREQUESTSET_SERIALIZATION>::Initialize(&v71, v61);
      v62 = (struct _DMM_MONITORPRESENCEEVENTSET_SERIALIZATION *)Src;
      if ( !Src )
      {
        v63 = VIDPN_MGR::GetContainingAdapter(a1);
        WdLogSingleEntry2(2LL, v61, v63);
        WdLogGlobalForLineNumber = 5097;
        LODWORD(v17) = -1073741801;
        goto LABEL_119;
      }
      v64 = VIDPN_MGR::GetContainingAdapter(a1);
      v65 = MonitorSerializeMonitorPresentEvents(v64, &v77, v62);
      v17 = v65;
      if ( v65 < 0 )
      {
        v66 = VIDPN_MGR::GetContainingAdapter(a1);
        WdLogSingleEntry2(2LL, v66, v17);
    ...
    if ( (_DWORD)v6 != 10 && (_DWORD)v6 != 11 )
    {
      ...
      if ( (_DWORD)v6 == 13 )
      {
        ...
        v40 = DMM::AutoBuffer<unsigned char>::Initialize(&v71, 2uLL, 0LL, 256LL);
        v17 = v40;
        if ( v40 < 0 )
        {
      ...
      LODWORD(v79) = 0x8000;
      v36 = DMM::AutoBuffer<unsigned char>::Initialize(&v71, 0x8000uLL, 0LL, 256LL);
      LODWORD(v17) = v36;
      if ( v36 >= 0 )
      {
        ...
        LODWORD(v17) = DXGDIAGNOSTICS::ReadDiagnostics(v38, v37, (unsigned int *)&v79, -1);
        if ( (int)v17 >= 0 )
        {
          v39 = (unsigned int)v79;
          if ( (unsigned int)v79 > v75 )
          {
            WdLogSingleEntry0(1LL);
...
LABEL_50:
    ...
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v68, (__int64)a1);
    v67 = 0LL;
    ...
    v48 = a5;
    v49 = (unsigned int)*a5;
    if ( !DMMVIDPNTOPOLOGY::IsSourceInTopology((DMMVIDPN *)((char *)v67 + 96), *a5) )
    {
    ...
    v51 = VIDPN_MGR::UnpinPathModalityFromSource(a1, (DMMVIDPN *)((char *)v67 + 96), v49);
    v52 = v51;
    if ( v51 < 0 )
    {
...
LABEL_100:
    ...
    if ( (_DWORD)v6 == 10 )
    {
      v56 = VIDPN_MGR::_SerializeVidPnSourceModeSet(a1, v67, v49);
      v52 = v56;
      if ( v56 < 0 )
      {
  ...
  switch ( (_DWORD)v6 )
  {
    case 8:
      ...
      EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v78, (__int64)a1);
      v30 = DMMVIDPN::SerializeVidPns((char *)a1 + 256, &v71);
      v17 = v30;
      if ( v30 < 0 )
      {
...
LABEL_53:
    ...
    case 2:
      ...
      v21 = *((_QWORD *)a1 + 14);
      v26 = DMMVIDEOPRESENTSOURCESET::Serialize(v21, &v71);
      v17 = v26;
      if ( v26 >= 0 )
        goto LABEL_40;
...
LABEL_87:
      ...
      auto_rc<DMMVIDPN const>::reset(&v69, (__int64)ClientCommittedVidPnRef);
      v43 = v69;
      if ( !v69 )
      {
      ...
      v45 = DMMVIDPN::Serialize(v69, &v71);
      v17 = v45;
      if ( v45 < 0 )
      {
    ...
    case 5:
      ...
      _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)a1 + 15) + 72LL));
      v21 = *((_QWORD *)a1 + 15);
      v22 = DMMVIDEOPRESENTTARGETSET::SerializeConnectedMonitors(v21, &v71);
      v17 = v22;
      if ( v22 < 0 )
      {
...
LABEL_40:
    ...
    case 6:
      ...
      v19 = VIDPN_MGR::COMMITVIDPNREQUEST::SerializeCommitVidPnRequests((char *)a1 + 192, &v71);
      v17 = v19;
      if ( v19 < 0 )
      {
...
LABEL_67:
  ...
  v12 = VIDPN_MGR::DISPMODECHANGEREQUEST::SerializeModeChangeRequests((char *)a1 + 328, &v71);
  v17 = v12;
  if ( v12 >= 0 )
    goto LABEL_52;
