/*
 * XREFs of IsFeatureEnabledUncached @ 0x140289024
 * Callers:
...
__int64 __fastcall IsFeatureEnabledUncached(__int64 a1, signed int a2, __int64 a3)
{
  ...
  v6 = a2 & 0xFFFFFFF;
  v7 = 0;
  if ( (a2 & 0xFFFFFFFu) >= dword_1400A8DA8[4 * v28] )
    v8 = 0LL;
  else
  ...
  *(struct _D3DDDI_SYNCHRONIZATIONOBJECT_FLAGS *)a3 = DXGDEVICE::DestroyFlagsDefault;
  ...
  {
    *(_WORD *)(a3 + 2) |= 2u;
    if ( (*(_BYTE *)(v8 + 4) & 0x10) == 0 && (*(_DWORD *)(a1 + 912) & 1) != 0 )
    {
    ...
    v10 = *(_QWORD *)(a1 + 8 * v28 + 720) + 6 * v6;
    if ( (*(_BYTE *)(v8 + 4) & 0x10) != 0 && DxgkIsVmConnectedToHost() || (*(_DWORD *)(a1 + 912) & 2) != 0 )
    {
      v11 = *(_WORD *)(v8 + 4) & 0xE;
      if ( v11 == 4 )
      {
    ...
    {
      v26[0] = 0;
      if ( ((unsigned int)v3 & 0xFFFFFFF) >= dword_1400A8EA8[4 * ((unsigned __int64)(unsigned int)v3 >> 28)] )
        v12 = 0LL;
      else
      ...
      LODWORD(v28) = v3;
      LOBYTE(v29) = v16;
      if ( (*(int (__fastcall **)(__int64, unsigned __int64 *))(a1 + 888))(v15, &v28) >= 0 )
      {
        if ( BYTE1(v29) )
          v18 = 4;
        else
...
LABEL_43:
  ...
  if ( DxgkIsVmConnectedToHost() || (*(_DWORD *)(a1 + 912) & 2) != 0 )
