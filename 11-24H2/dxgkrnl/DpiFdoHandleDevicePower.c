/*
 * XREFs of DpiFdoHandleDevicePower @ 0x1403B9530
 * Callers:
 *     DpiFdoDispatchPower @ 0x1403B94F0 (DpiFdoDispatchPower.c)
 * Callees:
 ...
 *     DxgkReportDeviceDirectedPowerDown @ 0x140068450 (DxgkReportDeviceDirectedPowerDown.c)
 ...
 *     DpiFdoRebootForSurpriseRemoval @ 0x140245028 (DpiFdoRebootForSurpriseRemoval.c)
 ...
 *     DpiLdaPowerDownAllAdaptersInChain @ 0x140403104 (DpiLdaPowerDownAllAdaptersInChain.c)
        ...
        if ( Status == -1073741810 )
        {
          ...
          if ( DpiFdoIsPostDevice((__int64)DeviceObject) )
          {
            if ( v18 )
            {
              ...
              {
                LOBYTE(v33) = 1;
                DpiAcquirePostDisplayInfoFromBgfx(&xmmword_140160FC8, v33);
                byte_140161130 = 0;
                dword_14016115C = 1;
              }
            }
