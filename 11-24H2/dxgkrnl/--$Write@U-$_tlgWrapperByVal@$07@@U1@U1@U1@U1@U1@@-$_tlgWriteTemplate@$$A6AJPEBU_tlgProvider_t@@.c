/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@33333@Z @ 0x14003EBA0
 * Callers:
        ...
        __int64 a10)
{
  ...
  v15 = 8LL;
  v13 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015E650, a2, 0LL, 0LL, 8, v11);
}
