/*
 * XREFs of ?SwitchCanceled@DISPLAY_MUX_SWTICH_DDI_TRACKING@@QEAAX_N@Z @ 0x140087EB8
 * Callers:
 *     ??1DISPLAY_MUX_SWITCH_OPERATION@@QEAA@XZ @ 0x140082764 (--1DISPLAY_MUX_SWITCH_OPERATION@@QEAA@XZ.c)
 *     _DXGKCALLONEXIT__lambda_3df126e43ef527cc1a2970c1b44a89a0____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT @ 0x140082818 (_DXGKCALLONEXIT__lambda_3df126e43ef527cc1a2970c1b44a89a0____--_2_--DXGKCALLONEXIT--_DXGKCALLONEX.c)
 ...
 *     ??$DXGKCALLONEXIT@V_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@@YA?A_PV_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@Z @ 0x14006A778 (--$DXGKCALLONEXIT@V_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@@YA-A_PV_lambda_9000b013b54c5d4fd.c)
 *     ??0_lambda_9000b013b54c5d4fd00007edcb0ed276_@@QEAA@AEA_N0AEAU_DXGK_DIAG_DISPLAYMUX_SWITCH_CANCEL_PACKET@@AEAE0@Z @ 0x1400824D8 (--0_lambda_9000b013b54c5d4fd00007edcb0ed276_@@QEAA@AEA_N0AEAU_DXGK_DIAG_DISPLAYMUX_SWITCH_CANCEL.c)
 *     ??1DXGKCALLONEXIT@?1???$DXGKCALLONEXIT@V_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@@YA?A_PV_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@Z@QEAA@XZ @ 0x140082914 (--1DXGKCALLONEXIT@-1---$DXGKCALLONEXIT@V_lambda_9000b013b54c5d4fd00007edcb0ed276_@@@@YA-A_PV_lam.c)
...
void __fastcall DISPLAY_MUX_SWTICH_DDI_TRACKING::SwitchCanceled(DISPLAY_MUX_SWTICH_DDI_TRACKING *this, bool a2)
{
  ...
  if ( *((_DWORD *)this + 1) == 2 || *(_DWORD *)this == 2 )
  {
    ...
    v26 = 1;
    IsTargetPartOfMux = DISPLAY_MUX_MGR::IsTargetPartOfMux(qword_140161380, v8, v7, &v24, 0LL);
