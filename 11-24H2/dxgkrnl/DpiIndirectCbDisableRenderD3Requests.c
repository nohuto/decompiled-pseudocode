/*
 * XREFs of DpiIndirectCbDisableRenderD3Requests @ 0x14024F5B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiIndirectCbDisableRenderD3Requests(PDEVICE_OBJECT DeviceObject, int a2, __int64 a3)
{
  ...
  *v7 = 0LL;
  v7[1] = 0LL;
  AUTO_MUTEX_LOCK::AUTO_MUTEX_LOCK((AUTO_MUTEX_LOCK *)v13, &stru_1401612D8);
  if ( !byte_1401612D0 )
  {
  ...
  *(_QWORD *)((char *)v8 + 20) = a3;
  v10 = (_QWORD *)qword_140161318;
  if ( *(void ***)qword_140161318 != &qword_140161310 )
    __fastfail(3u);
  v11 = v13[0] == 0;
  *v8 = &qword_140161310;
  v8[1] = v10;
  *v10 = v8;
  qword_140161318 = (__int64)v8;
  if ( !v11 )
    KeReleaseMutex(Mutex, 0);
  return 0LL;
}
