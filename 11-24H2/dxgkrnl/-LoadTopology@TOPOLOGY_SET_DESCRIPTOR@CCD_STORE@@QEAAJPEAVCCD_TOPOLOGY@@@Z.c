/*
 * XREFs of ?LoadTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEAVCCD_TOPOLOGY@@@Z @ 0x1402D8188
 * Callers:
        ...
        struct CCD_TOPOLOGY *a2)
{
  ...
  while ( 1 )
  {
    ...
    RegistryValues = CcdReadRegistryValues(Handle, 0LL, &unk_14015EA60, 8LL, v24);
    if ( RegistryValues < 0 )
    {
...
LABEL_40:
    ...
    *((_QWORD *)v24 + 13) = *((_QWORD *)v24 + 12);
    v26 = CcdReadRegistryValues(Handle, 0LL, &unk_14015EF00, 2LL, &v48);
    if ( v26 == -1073741772 )
    {
      v48 = 0;
    }
...
LABEL_24:
    ...
    {
      v30 = CcdReadRegistryValues(Handle, &v56, &unk_14015E830, 4LL, v24);
      if ( v30 < 0 )
      {
