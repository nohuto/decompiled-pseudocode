/*
 * XREFs of McTemplateK0iiiiii_EtwWriteTransfer @ 0x14009445C
 * Callers:
...
NTSTATUS McTemplateK0iiiiii_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
