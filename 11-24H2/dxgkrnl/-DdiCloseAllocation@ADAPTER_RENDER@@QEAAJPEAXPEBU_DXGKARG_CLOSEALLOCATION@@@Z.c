/*
 * XREFs of ?DdiCloseAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_CLOSEALLOCATION@@@Z @ 0x14032578C
 * Callers:
...
LABEL_13:
  v34 = 0;
  v33 = (DXGPUSHLOCK *)(((unsigned __int64)v11 + 152) & ((unsigned __int128)-(__int128)(unsigned __int64)v11 >> 64));
  if ( v33
    && *(struct _KTHREAD **)((((unsigned __int64)v11 + 152) & ((unsigned __int128)-(__int128)(unsigned __int64)v11 >> 64))
