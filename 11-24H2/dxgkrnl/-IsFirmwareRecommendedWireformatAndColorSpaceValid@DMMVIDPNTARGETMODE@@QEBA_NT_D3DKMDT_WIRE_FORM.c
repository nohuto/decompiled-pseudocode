/*
 * XREFs of ?IsFirmwareRecommendedWireformatAndColorSpaceValid@DMMVIDPNTARGETMODE@@QEBA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@W4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x14008EE60
 * Callers:
        ...
        enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE a3)
{
  ...
  if ( a3
    ...
    && (!*((_BYTE *)DXGGLOBAL::GetGlobal() + 304880) || a3 != D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G22_P2020)
