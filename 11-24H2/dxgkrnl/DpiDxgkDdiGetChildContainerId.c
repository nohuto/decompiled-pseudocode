/*
 * XREFs of DpiDxgkDdiGetChildContainerId @ 0x140254698
 * Callers:
...
__int64 __fastcall DpiDxgkDdiGetChildContainerId(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
  {
    v19 = 0;
    v17 = a3;
    McTemplateK0pqq_EtwWriteTransfer(a1, (__int64)&EventEnterDdiGetChildContainerId, a3, a2, v17, v19);
  }
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
  {
    LODWORD(v18) = v8;
    LODWORD(v16) = v5;
    McTemplateK0pqq_EtwWriteTransfer(v10, (__int64)&EventExitDdiGetChildContainerId, v11, a2, v16, v18);
  }
