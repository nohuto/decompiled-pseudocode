/*
 * XREFs of ?IsFeatureEnabled@DXGADAPTER@@QEAA?AU_DXGK_ISFEATUREENABLED_RESULT@@W4_DXGK_FEATURE_ID@@@Z @ 0x140193068
 * Callers:
 *     DXGADAPTER_IsFeatureEnabled @ 0x14006BF60 (DXGADAPTER_IsFeatureEnabled.c)
