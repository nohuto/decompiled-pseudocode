/*
 * XREFs of SmmMapSection @ 0x1402874AC
 * Callers:
...
LABEL_13:
    _InterlockedIncrement(&dword_140161674);
    ...
    DxgkLogInternalTriageEvent(
      ...
      262145LL,
      0xFFFFFFFFLL,
      L"Failed to map section object. Offset=0x%.16I64x, Size=%I64u, AccessMode=%u, CacheType=%u",
      a3,
      a4,
      v9,
      a5,
  ...
  if ( a5 != 1 )
  {
    if ( a5 )
    {
      ...
      else
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"0", 98LL, 0LL, 0LL, 0LL, 0LL);
      }
    }
    else
    {
  ...
  v13 = MmMapViewOfSection(a1, CurrentProcess, &MappedBase, 0LL, a4, &v19, &ViewSize, 2, 0, v14);
  if ( v13 < 0 )
    goto LABEL_13;
  v8 = a3 - v19;
LABEL_14:
