/*
 * XREFs of DxgkSetIndirectDisplayRenderAdapter @ 0x1401AF7FC
 * Callers:
 ...
 *     _lambda_25828e919f6f014123ebe7d58fe0bd3b_::_lambda_25828e919f6f014123ebe7d58fe0bd3b_ @ 0x1401AA834 (_lambda_25828e919f6f014123ebe7d58fe0bd3b_--_lambda_25828e919f6f014123ebe7d58fe0bd3b_.c)
...
__int64 __fastcall DxgkSetIndirectDisplayRenderAdapter(struct DXGADAPTER *a1, struct _LUID *a2, _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  v6 = lambda_25828e919f6f014123ebe7d58fe0bd3b_::_lambda_25828e919f6f014123ebe7d58fe0bd3b_(
         v29,
         (__int64)a2,
...
LABEL_35:
    DXGKCALLONEXIT__lambda_25828e919f6f014123ebe7d58fe0bd3b____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT((__int64)v28);
    return v10;
  }
  v11 = 0LL;
  v18[0] = 0LL;
...
LABEL_34:
  ...
  *(_QWORD *)(v13 + 56) = KeGetCurrentThread();
  ...
  if ( *((_DWORD *)a1 + 50) != 1 || *((_BYTE *)a1 + 3017) )
  {
    ...
    WdLogGlobalForLineNumber = 12568;
    IndirectDisplayPairedAdapter = -1073741130;
