/*
 * XREFs of ?EnsureVmBusInterface@DXGGLOBAL@@QEAAJXZ @ 0x1401D3EF8
 * Callers:
...
LABEL_5:
    ...
    *((_QWORD *)this + 214) = MappedSystemVa;
    if ( !MappedSystemVa )
    {
      WdLogSingleEntry0(2LL);
      v8 = 5948LL;
  ...
  v12 = DXG_GUEST_GLOBAL_VMBUS::EnsureVmBusChannel(*((DXG_GUEST_GLOBAL_VMBUS **)this + 210));
  v10 = v12;
  if ( v12 >= 0 )
  {
    if ( *((_DWORD *)this + 427) )
    ...
    GpadlFromMdl = DXG_GUEST_GLOBAL_VMBUS::CreateGpadlFromMdl(
                     *((DXG_GUEST_GLOBAL_VMBUS **)this + 210),
                     *v7,
                     (unsigned int *)this + 427);
    v10 = GpadlFromMdl;
    if ( GpadlFromMdl >= 0 )
      goto LABEL_23;
    v13 = GpadlFromMdl;
