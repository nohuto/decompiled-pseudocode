/*
 * XREFs of ?Clear@?$DoublyLinkedList@UCOMMITVIDPNREQUEST@VIDPN_MGR@@U?$DoubleLinkedListElementDeleter@UCOMMITVIDPNREQUEST@VIDPN_MGR@@@@@@QEAAXXZ @ 0x140061014
 * Callers:
 ...
 *     ?Clear@?$Queue@UCOMMITVIDPNREQUEST@VIDPN_MGR@@@@UEAAXXZ @ 0x14008EC80 (-Clear@-$Queue@UCOMMITVIDPNREQUEST@VIDPN_MGR@@@@UEAAXXZ.c)
 * Callees:
