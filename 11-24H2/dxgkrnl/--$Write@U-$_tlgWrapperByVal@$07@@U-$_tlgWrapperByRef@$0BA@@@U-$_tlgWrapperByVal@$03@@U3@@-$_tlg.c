...
{
  __int64 v8; // rcx
  _BYTE v10[32]; // [rsp+30h] [rbp-39h] BYREF
  ...
  v13 = v8;
  v12 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015E5A8, a2, a3, 0LL, 6, v10);
}
