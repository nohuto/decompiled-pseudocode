/*
 * XREFs of DxgkIsVidPnSourceOwnerExclusive @ 0x1403D08F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DxgkIsVidPnSourceOwnerExclusive(ADAPTER_DISPLAY **a1, unsigned int a2, _BYTE *a3)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"NULL != pDisplayAdapter", 8693LL, 0LL, 0LL, 0LL, 0LL);
  }
