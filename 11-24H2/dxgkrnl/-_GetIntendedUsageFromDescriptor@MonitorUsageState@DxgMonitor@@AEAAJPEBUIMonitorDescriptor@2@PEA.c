/*
 * XREFs of ?_GetIntendedUsageFromDescriptor@MonitorUsageState@DxgMonitor@@AEAAJPEBUIMonitorDescriptor@2@PEAW4_DXGK_DISPLAY_USAGE@@PEA_N2@Z @ 0x1403F17A0
 * Callers:
        ...
        bool *a5)
{
  ...
  *v5 = 1;
  ...
  v11 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v10 + 64LL))(v10, &v13);
  if ( v11 >= 0 )
  {
    v6 = v13;
    goto LABEL_16;
