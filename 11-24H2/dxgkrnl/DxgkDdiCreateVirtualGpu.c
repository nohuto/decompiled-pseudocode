/*
 * XREFs of DxgkDdiCreateVirtualGpu @ 0x14020FA0C
 * Callers:
        ...
        __int64 a7)
{
  ...
  v10 = 0LL;
  VirtualGpu = (int)ADAPTER_RENDER::CreateVirtualGpu(a1[391], a2, a6, a3, a4, a5, a7);
  if ( bTracingEnabled )
  {
    LODWORD(v20) = *a6;
    ...
    DxgkLogInternalTriageEvent(
      ...
      196608LL,
      *a6,
      L"Creating vGPU with VFLUID %1, having %2 segments and %3 engines, Flags: %5 returns %4",
      a6[30] + ((__int64)(int)a6[31] << 32),
      a6[32],
      a6[418],
      VirtualGpu,
      v13);
    ...
    do
    {
      DxgkLogInternalTriageEvent(
        ...
        196608LL,
        *a6,
        L"vGPU creation requested profile on capability %1 have min %2, max %3, and optimal %4",
        v14++,
        *(v15 - 1),
        *v15,
        v15[1],
    ...
    if ( a6[418] )
    {
      ...
      do
      {
        DxgkLogInternalTriageEvent(
          ...
          196608LL,
          *a6,
          L"vGPU creation returns engine %1 with min %2 partition units and max %3 partition units",
          v17[2],
          *v17,
          v17[1],
          0LL,
    ...
    if ( a6[32] )
    {
      ...
      do
      {
        DxgkLogInternalTriageEvent(
          ...
          196608LL,
          *a6,
          L"vGPU creation requests framebuffer on segment %1 with size %2, alignment %3, from offset %4 to %5",
          *((unsigned int *)v18 - 6),
          *(v18 - 2),
          *((unsigned int *)v18 - 2),
          *v18,
