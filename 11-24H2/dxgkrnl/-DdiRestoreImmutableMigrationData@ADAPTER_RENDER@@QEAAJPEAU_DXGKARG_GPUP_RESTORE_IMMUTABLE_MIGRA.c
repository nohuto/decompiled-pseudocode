/*
 * XREFs of ?DdiRestoreImmutableMigrationData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA@@@Z @ 0x140213F80
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRestoreImmutableMigrationData(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5184);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5184);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA *))(*((_QWORD *)this + 2)
                                                                                               + 1640LL))(
  ...
  if ( (_DWORD)v10 != -1073741823 && (_DWORD)v10 != -1073741811 && (_DWORD)v10 )
  {
