/*
 * XREFs of ?UpdateOneCddPrimaryPrivateDriverData@ADAPTER_DISPLAY@@QEAAXIPEAVDXGADAPTER@@@Z @ 0x14019B4C4
 * Callers:
...
LABEL_9:
        DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v10, v8, 0LL, 0LL, 0LL, 0LL);
        goto LABEL_3;
      }
      v11 = *((_QWORD *)this + 16);
