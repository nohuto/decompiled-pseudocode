/*
 * XREFs of ?CompleteTransaction@DXGVIRTUALMACHINE@@QEAAJ_KJPEAXI@Z @ 0x140232A04
 * Callers:
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = a2;
  ...
  if ( v13 > a5 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000LL,
      0xFFFFFFFFLL,
      L"Transaction result from guest exceeds the buffer size provided by the transaction object. Cannot copy result.",
      80LL,
      0LL,
      0LL,
      0LL,
