/*
 * XREFs of ?_IsBetterAnchorTarget@_ANCHOR_INFO@BTL_TOPOLOGY_CONSTRUCTOR@@QEAA_NAEBVDXGADAPTER@@AEBVDMMVIDEOPRESENTTARGET@@W4_DMM_VIDPN_MONITOR_TYPE@@@Z @ 0x1403A95F4
 * Callers:
 ...
 *     ?_GetVmtPreference@BTL_TOPOLOGY_CONSTRUCTOR@@CA?AW4_VMT_PREFERENCE@1@W4_DMM_VIDPN_MONITOR_TYPE@@@Z @ 0x1403A97B0 (-_GetVmtPreference@BTL_TOPOLOGY_CONSTRUCTOR@@CA-AW4_VMT_PREFERENCE@1@W4_DMM_VIDPN_MONITOR_TYPE@@.c)
...
LABEL_5:
  v16 = *v11;
  v17 = *(_DWORD *)(a2 + 412);
  if ( *v11 != v17 || v11[1] != *(_DWORD *)(a2 + 416) || (v18 = *(_DWORD *)(v8 + 124), v18 == v11[7]) )
  {
    LOBYTE(v9) = 1;
