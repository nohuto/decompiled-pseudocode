/*
 * XREFs of ?CreateBundleObjectCallback@DXG_HOST_REMOTEOBJECTCHANNEL@@IEAAJKPEAIPEAPEAX0@Z @ 0x1403F5B18
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  BundleObjectInternal = DxgkCreateBundleObjectInternal(0, 0, v9, 0, (__int64)v28, (__int64)a4);
