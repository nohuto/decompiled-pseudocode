/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1400536D0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_MGR(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304880) )
  {
    if ( (unsigned int)dword_14015E5E0 > 1
      && tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000020LL)
      && tlgKeywordOn((__int64)&dword_14015E5E0, v6) )
    {
      v5 = &unk_14013D654;
      goto LABEL_8;
    }
