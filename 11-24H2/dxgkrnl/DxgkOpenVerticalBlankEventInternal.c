/*
 * XREFs of DxgkOpenVerticalBlankEventInternal @ 0x1401AEE90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_37:
    ...
    if ( (unsigned int)DxgIsRemoteSessionUsingXddmMonitors() )
    {
      ...
      {
        v16 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal() + 1080);
      }
      else
      {
        v16 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal() + 1024);
      }
