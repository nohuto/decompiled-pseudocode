/*
 * XREFs of ?QueryDisplayConfigInternal@@YAJ_NIIIPEAIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x14031CFA0
 * Callers:
...
LABEL_17:
  ...
  if ( RequestedPathsModality >= 0 )
  {
    ...
    v26 = QDC_CACHE::AddToCache(*((QDC_CACHE **)Global + 183), v35, v24, v7, *v13, Src, v11);
    if ( v26 < 0 )
    {
