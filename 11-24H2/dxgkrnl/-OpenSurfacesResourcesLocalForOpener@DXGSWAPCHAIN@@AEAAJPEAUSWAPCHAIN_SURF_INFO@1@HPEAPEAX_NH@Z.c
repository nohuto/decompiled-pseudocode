/*
 * XREFs of ?OpenSurfacesResourcesLocalForOpener@DXGSWAPCHAIN@@AEAAJPEAUSWAPCHAIN_SURF_INFO@1@HPEAPEAX_NH@Z @ 0x1401FFBD8
 * Callers:
        ...
        unsigned __int8 a6)
{
  ...
  if ( this[3] != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_SwapChainLock.IsOwner()", 2503LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_13:
  DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v26, v25, v17, 0LL, 0LL, 0LL);
  return (unsigned int)v17;
}
