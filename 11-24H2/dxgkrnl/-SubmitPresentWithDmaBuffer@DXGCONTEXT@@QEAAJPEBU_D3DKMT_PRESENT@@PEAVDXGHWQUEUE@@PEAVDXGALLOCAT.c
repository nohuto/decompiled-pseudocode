/*
 * XREFs of ?SubmitPresentWithDmaBuffer@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT@@PEAVDXGHWQUEUE@@PEAVDXGALLOCATION@@2PEAU_DXGKARG_PRESENT@@PEAUVIDMM_DMA_BUFFER@@PEAUVIDSCH_SUBMIT_DATA_BASE@@PEAVCOREDEVICEACCESS@@@Z @ 0x14034A950
 * Callers:
        ...
        struct COREDEVICEACCESS *a9)
{
  ...
  int v82; // eax
  char *v83; // rsi
  struct VIDMM_ALLOC **v84; // rbx
  __int64 v85; // rax
  union _LARGE_INTEGER *v86; // rcx
  struct DXGALLOCATION *v87; // rbx
  char v88; // dl
  __int64 v89; // rcx
  __int64 v90; // rcx
  char *v91; // rcx
  ...
  while ( 1 )
  {
    if ( !v9 )
    {
      ...
      if ( !v100 )
      {
        ...
        WdLogGlobalForLineNumber = 9050;
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pVidMmDmaBuffer", 9050LL, 0LL, 0LL, 0LL, 0LL);
        v9 = v100;
      }
      v11 = v106;
      a4 = v101;
    ...
    *(_DWORD *)a8 ^= (*(_DWORD *)a8 ^ (*((unsigned __int8 *)this + 430) << 27)) & 0x8000000;
    if ( v98 )
    {
      ...
      if ( *((_BYTE *)this + 430) )
      {
        ...
        v39 = (*(__int64 (__fastcall **)(struct VIDMM_DMA_BUFFER *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v38 + 16)
                                                                                           + 760LL)
                                                                               + 8LL)
                                                                   + 520LL))(v100);
        v40 = v101;
        ...
        else if ( v106 )
        {
          ...
          v125[8] = v46;
          LOBYTE(v40) = !v47;
          v125[9] = (*(__int64 (__fastcall **)(_QWORD, struct DXGALLOCATION *, __int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 760LL) + 8LL)
                                                                                       + 224LL))(
                      *((_QWORD *)v106 + 3),
                      v40,
                      v48);
...
LABEL_77:
              ...
              DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, v59, v58, 0LL, 0LL, 0LL, 0LL);
            }
          }
...
LABEL_85:
    ...
    *((_DWORD *)a8 + 18) = 0;
    ...
    if ( v47 )
    {
      ...
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 9535;
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pSrcAllocation", 9535LL, 0LL, 0LL, 0LL, 0LL);
      }
      if ( (*(_DWORD *)a8 & 0x40) != 0 )
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 9536;
        DxgkLogInternalTriageEvent(
          0LL,
          262146LL,
          0xFFFFFFFFLL,
      ...
      *(_DWORD *)v83 = *(_DWORD *)v83 & 0xFFFFFC00 | 1;
                  ...
                  v84) < 0 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"NT_SUCCESS(RefStatus)", 9555LL, 0LL, 0LL, 0LL, 0LL);
      }
      v85 = *((_QWORD *)this + 2);
      v102 = 0;
      if ( *((_BYTE *)a8 + 356) )
