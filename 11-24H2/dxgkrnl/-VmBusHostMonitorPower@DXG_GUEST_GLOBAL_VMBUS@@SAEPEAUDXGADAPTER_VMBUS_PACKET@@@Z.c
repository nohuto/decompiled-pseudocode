/*
 * XREFs of ?VmBusHostMonitorPower@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140224090
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusHostMonitorPower(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  *(_OWORD *)&v15[0].LowPart = 0LL;
              ...
              (struct REMOTEMONITORMAPPING::PATH_IDENTIFIER_GUEST *)v15) >= 0 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v9 >= 0 )
      {
        if ( !*((_QWORD *)v6 + 391) )
        {
          v11 = *(DXGDODPRESENT **)(*((_QWORD *)v6 + 390) + 464LL);
          if ( v11 )
      ...
      else
      {
        ...
        WdLogGlobalForLineNumber = 15004;
    ...
    else
    {
      v7 = v15[0].HighPart;
      WdLogSingleEntry2(2LL, v15[0].HighPart, LowPart);
      WdLogGlobalForLineNumber = 14993;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000LL,
        0xFFFFFFFFLL,
  ...
  else
  {
    ...
    v13 = *(int *)(v1 + 28);
    WdLogGlobalForLineNumber = 14983;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
