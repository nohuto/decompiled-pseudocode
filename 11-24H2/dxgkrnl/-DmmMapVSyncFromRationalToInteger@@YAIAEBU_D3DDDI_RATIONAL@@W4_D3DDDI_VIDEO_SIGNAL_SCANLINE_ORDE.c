/*
 * XREFs of ?DmmMapVSyncFromRationalToInteger@@YAIAEBU_D3DDDI_RATIONAL@@W4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@PEAE@Z @ 0x140361E0C
 * Callers:
 ...
 *     DxgkUpdateCddDevmodeExtraData @ 0x1403FEE20 (DxgkUpdateCddDevmodeExtraData.c)
 * Callees:
 *     <none>
 */
        ...
        unsigned __int8 *a3)
{
  ...
  for ( i = 0LL; (unsigned int)i < 6; i = (unsigned int)(i + 1) )
  {
    ...
    {
      v9 = dword_1400B6ED8[2 * i + 1];
      if ( (_DWORD)v9 )
      {
        v10 = dword_1400B6ED8[2 * i];
