/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CODE_POINT@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003F550
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CODE_POINT(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( !(unsigned int)IsCodePointTypeNoisy(*((unsigned int *)a1 + 12)) )
  {
    if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304880) )
    {
      if ( (unsigned int)dword_14015E5E0 <= 1
        || !(unsigned __int8)tlgKeywordOn(&dword_14015E5E0, 0x200000000010LL)
        || !(unsigned __int8)tlgKeywordOn(&dword_14015E5E0, v10) )
      {
        goto LABEL_4;
      }
      v8 = &unk_14013DB1C;
    ...
    else
    {
      if ( (unsigned int)dword_14015E5E0 <= 4 )
        return;
      if ( (qword_14015E5F0 & 0x200000000010LL) == 0 || (qword_14015E5F8 & 0x200000000010LL) != qword_14015E5F8 )
        goto LABEL_4;
      v8 = &unk_14013D8C0;
    }
    v22 = *((_WORD *)a1 + 2);
  ...
  if ( (unsigned int)dword_14015E5E0 <= 4 )
    return;
  if ( (qword_14015E5F0 & 0x10) != 0
    && (qword_14015E5F8 & 0x10) == qword_14015E5F8
    && (unsigned __int8)tlgKeywordOn(&dword_14015E5E0, 16LL) )
  {
    v8 = &unk_14013D9CB;
    v22 = *((_WORD *)a1 + 2);
    v23 = *((_DWORD *)a1 + 15);
...
LABEL_4:
  if ( (unsigned int)dword_14015E5E0 <= 4
    || (qword_14015E5F0 & 0x400000000010LL) == 0
    || (qword_14015E5F8 & 0x400000000010LL) != qword_14015E5F8 )
  {
    return;
  }
  if ( *((_DWORD *)a1 + 12) != 88 )
