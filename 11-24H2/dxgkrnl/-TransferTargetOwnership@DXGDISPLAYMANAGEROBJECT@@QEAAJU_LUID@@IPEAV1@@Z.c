/*
 * XREFs of ?TransferTargetOwnership@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@IPEAV1@@Z @ 0x1401C75BC
 * Callers:
...
LABEL_5:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v10, v5, v9, v4, 0LL, 0LL);
    v8 = -1073741275;
    goto LABEL_13;
  }
