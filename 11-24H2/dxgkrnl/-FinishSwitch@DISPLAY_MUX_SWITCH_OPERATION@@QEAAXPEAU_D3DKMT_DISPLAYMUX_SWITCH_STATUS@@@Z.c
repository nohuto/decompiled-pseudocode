/*
 * XREFs of ?FinishSwitch@DISPLAY_MUX_SWITCH_OPERATION@@QEAAXPEAU_D3DKMT_DISPLAYMUX_SWITCH_STATUS@@@Z @ 0x140084918
 * Callers:
        ...
        struct _D3DKMT_DISPLAYMUX_SWITCH_STATUS *a2)
{
  ...
  if ( !CheckFailed(AdapterAndAcquire, 1283, (__int64)this + 92, 0x45Eu) )
  {
    v11 = 0LL;
    v12 = 0;
    v4 = AUTO_REMOVE_LOCK::FindAdapterAndAcquire((AUTO_REMOVE_LOCK *)&v11, (struct _LUID *)this + 10);
    if ( !CheckFailed(v4, 1281, (__int64)this + 92, 0x466u) )
    {
      CInterfaceCallContext::CInterfaceCallContext(v15, v11);
      if ( !CheckFailed(v17, 1285, (__int64)this + 92, 0x46Eu)
        && !CheckForMdmFaultOrDelayInjection(16, 1282, (__int64)this + 92) )
      {
        ...
        if ( v6 >= 0 )
          *((_DWORD *)this + 1) = 3;
        if ( !CheckFailed(v6, 1282, (__int64)this + 92, 0x47Cu) )
        {
          if ( !v8[0] )
          {
            *((_DWORD *)this + 76) |= 4u;
