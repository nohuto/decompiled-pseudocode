/*
 * XREFs of ?SysMmCreateContiguousMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KT_LARGE_INTEGER@@22W4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@PEAPEAX@Z @ 0x14001F82C
 * Callers:
 ...
 *     SysMmTestCreateContiguousMemoryPhysicalObject @ 0x140095C90 (SysMmTestCreateContiguousMemoryPhysicalObject.c)
 * Callees:
...
LABEL_7:
    ...
    {
      _InterlockedIncrement(&dword_140161658);
