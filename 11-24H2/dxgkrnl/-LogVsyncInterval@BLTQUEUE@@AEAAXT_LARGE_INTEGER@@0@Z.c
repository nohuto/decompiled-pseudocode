/*
 * XREFs of ?LogVsyncInterval@BLTQUEUE@@AEAAXT_LARGE_INTEGER@@0@Z @ 0x1400389A0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v4 && *((_DWORD *)this + 34) == 3 )
  {
    ...
    if ( v8 > 0x64 )
      v8 = 100;
    if ( *(_QWORD *)this )
      v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 88LL) + 16LL) + 412LL);
    v9 = dword_14015E5A8;
    v10 = qword_14015E5C0;
    if ( (unsigned int)dword_14015E5A8 > 5 )
    {
      v11 = 0x400000000800LL;
      if ( (qword_14015E5B8 & 0x400000000800LL) != 0 && (qword_14015E5C0 & 0x400000000800LL) == qword_14015E5C0 )
      {
        v15 = *((_DWORD *)this + 65);
        v12 = v5;
        v16 = v8;
      ...
      if ( v9 > 5 && (qword_14015E5B8 & 0x800) != 0 && (v10 & 0x800) == v10 )
      {
        v15 = *((_DWORD *)this + 65);
        v14[0] = v5;
        v16 = v8;
