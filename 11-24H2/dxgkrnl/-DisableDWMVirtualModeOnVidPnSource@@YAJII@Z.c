/*
 * XREFs of ?DisableDWMVirtualModeOnVidPnSource@@YAJII@Z @ 0x1401B9E28
 * Callers:
...
__int64 __fastcall DisableDWMVirtualModeOnVidPnSource(unsigned int a1, unsigned int a2)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid process context", 3537LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
  v23 = 0LL;
...
LABEL_14:
        DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v12, v5, 0LL, 0LL, 0LL, 0LL);
      }
