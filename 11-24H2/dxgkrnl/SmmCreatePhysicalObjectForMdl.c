/*
 * XREFs of SmmCreatePhysicalObjectForMdl @ 0x140020778
 * Callers:
 ...
 *     SysMmTestCreatePhysicalObjectForExistingMdl @ 0x140095DC0 (SysMmTestCreatePhysicalObjectForExistingMdl.c)
 * Callees:
