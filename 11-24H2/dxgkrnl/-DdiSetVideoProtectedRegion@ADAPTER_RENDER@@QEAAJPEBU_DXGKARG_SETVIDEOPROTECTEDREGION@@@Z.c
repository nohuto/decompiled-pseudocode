/*
 * XREFs of ?DdiSetVideoProtectedRegion@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x1403F2EB0
 * Callers:
 *     ADAPTER_RENDER_DdiSetVideoProtectedRegion @ 0x14006BE40 (ADAPTER_RENDER_DdiSetVideoProtectedRegion.c)
 * Callees:
