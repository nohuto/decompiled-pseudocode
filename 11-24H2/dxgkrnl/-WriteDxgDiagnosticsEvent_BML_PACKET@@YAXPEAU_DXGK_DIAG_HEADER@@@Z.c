/*
 * XREFs of ?WriteDxgDiagnosticsEvent_BML_PACKET@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003ED30
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_BML_PACKET(struct _DXGK_DIAG_HEADER *a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4
    && (qword_14015E5F0 & 0x200000000080LL) != 0
    && (qword_14015E5F8 & 0x200000000080LL) == qword_14015E5F8 )
  {
    v5 = *((_WORD *)a1 + 2);
    v6 = *((_DWORD *)a1 + 10);
    v4 = a1;
