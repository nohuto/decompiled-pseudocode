        ...
        __int64 a42)
{
  ...
  int v66; // eax
  _WORD *v67; // r8
  _BYTE v69[32]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v73 = 4LL;
  v71 = 16LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015E650, a2, a3, 0LL, 40, v69);
}
