/*
 * XREFs of ?LogMonitorObjectOnOffState@DXGMONITOR@@QEAAXAEBU_GUID@@IW4Enum@MONITOR_ON_OFF_CALLER_ORIGIN@@@Z @ 0x1403C3B90
 * Callers:
...
__int64 __fastcall DXGMONITOR::LogMonitorObjectOnOffState(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( (_BYTE)a4 == 1 )
  {
    if ( (unsigned int)dword_14015E5A8 > 5 && (qword_14015E5B8 & 0x400000000010LL) != 0 )
    {
      result = qword_14015E5C0 & 0x400000000010LL;
      if ( (qword_14015E5C0 & 0x400000000010LL) == qword_14015E5C0 )
      {
        v12 = (unsigned int)dword_1401614C8;
        v22 = *v4;
        v19 = *(_QWORD *)(a1 + 352);
        v16 = *(_DWORD *)(a1 + 180);
        ++dword_1401614C8;
  ...
  else if ( (unsigned int)dword_14015E5A8 > 5 && (qword_14015E5B8 & 0x10) != 0 )
  {
    result = qword_14015E5C0 & 0x10;
    if ( result == qword_14015E5C0 )
    {
      v11 = (unsigned int)dword_1401614C8;
      v22 = *v7;
      v21 = *(_QWORD *)(a1 + 352);
      v17 = *(_DWORD *)(a1 + 180);
      v19 = v18;
