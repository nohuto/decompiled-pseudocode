/*
 * XREFs of ?_IssueMonitorEvent@MONITOR_MGR@@UEAAJIW4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x14028DD10
 * Callers:
...
__int64 __fastcall MONITOR_MGR::_IssueMonitorEvent(__int64 a1, unsigned int a2, int a3, __int64 a4, int a5, GUID *a6)
{
  ...
  RAPID_HPD_MANAGER::GetCurrenRapidHPDState(
    ...
    &v38,
    0LL);
  if ( (unsigned int)dword_14015E650 > 5 && tlgKeywordOn((__int64)&dword_14015E650, 0x400000000080LL) )
  {
    v31 = &v38;
    v32 = v30;
    if ( a6 )
