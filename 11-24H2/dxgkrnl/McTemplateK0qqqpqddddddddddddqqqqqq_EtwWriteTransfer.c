/*
 * XREFs of McTemplateK0qqqpqddddddddddddqqqqqq_EtwWriteTransfer @ 0x140011154
 * Callers:
...
__int64 __fastcall McTemplateK0qqqpqddddddddddddqqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a26)
{
  ...
  v72 = 4LL;
  v74 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &FlipMultiPlaneOverlay, a3, 24LL, v28);
}
