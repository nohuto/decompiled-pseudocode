/*
 * XREFs of McTemplateK0qqxxqq_EtwWriteTransfer @ 0x1400106AC
 * Callers:
...
__int64 __fastcall McTemplateK0qqxxqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &PresentRedirected, a3, 7LL, v10);
}
