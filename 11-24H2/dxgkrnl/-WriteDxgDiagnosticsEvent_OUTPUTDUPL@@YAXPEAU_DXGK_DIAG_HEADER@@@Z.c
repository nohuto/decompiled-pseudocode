/*
 * XREFs of ?WriteDxgDiagnosticsEvent_OUTPUTDUPL@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003EABC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_OUTPUTDUPL(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  v1 = a1;
  if ( (unsigned int)dword_14015E5E0 > 4 && (qword_14015E5F0 & 0x200000000200LL) != 0 )
  {
    v2 = qword_14015E5F8;
    if ( (qword_14015E5F8 & 0x200000000200LL) == qword_14015E5F8 )
    {
      v3 = *((_DWORD *)a1 + 12);
      if ( v3 )
      {
        ...
        if ( v4 )
        {
          if ( v4 == 10 && (qword_14015E5F8 & 0x200000000200LL) == qword_14015E5F8 )
          {
            v5 = &unk_14013D479;
LABEL_10:
            v7 = *((_WORD *)v1 + 2);
        ...
        else if ( (unsigned __int8)tlgKeywordOn(&dword_14015E5E0, 0x200000000200LL) )
        {
          v5 = &unk_14013D3C8;
          goto LABEL_10;
        }
