/*
 * XREFs of ?DdiUpdateFlipQueueLog@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEFLIPQUEUELOG@@@Z @ 0x140013C58
 * Callers:
 *     ADAPTER_DISPLAY_DdiUpdateFlipQueueLog @ 0x140013C40 (ADAPTER_DISPLAY_DdiUpdateFlipQueueLog.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5161);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry(&v16, 5161LL);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_UPDATEFLIPQUEUELOG *))(*((_QWORD *)this + 2) + 1416LL))(
  ...
  if ( v7 )
  {
    ...
    if ( (_DWORD)v15 != v8 )
    {
      WdLogSingleEntry5(0LL, 275LL, 38LL, v15, v8, 0LL);
