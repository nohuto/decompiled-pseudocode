/*
 * XREFs of ?VmBusDestroyContext@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140221FA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyContext(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _D3DKMT_DESTROYCONTEXT v8; // [rsp+80h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) )
  {
    ...
    if ( v4 )
    {
      v8.hContext = *(_DWORD *)(v4 + 24);
      v5 = DxgkDestroyContextImpl(&v8, 0);
