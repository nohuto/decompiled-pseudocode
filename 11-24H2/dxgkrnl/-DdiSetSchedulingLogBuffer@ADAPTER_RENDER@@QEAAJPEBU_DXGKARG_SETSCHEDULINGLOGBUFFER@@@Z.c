/*
 * XREFs of ?DdiSetSchedulingLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1401A868C
 * Callers:
 *     ADAPTER_RENDER_DdiSetSchedulingLogBuffer @ 0x14006BE20 (ADAPTER_RENDER_DdiSetSchedulingLogBuffer.c)
 * Callees:
