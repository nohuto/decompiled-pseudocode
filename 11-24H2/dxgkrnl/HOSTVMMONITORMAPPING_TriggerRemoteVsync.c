/*
 * XREFs of HOSTVMMONITORMAPPING_TriggerRemoteVsync @ 0x1400357A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HOSTVMMONITORMAPPING_TriggerRemoteVsync(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  if ( !*(_QWORD *)&DXGGLOBAL::m_pGlobal )
  {
    ...
    if ( bTracingEnabled )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(2605LL, v8, v9, 0LL, 2, -1, L"m_pGlobal != NULL", 45, 0, 0, 0, 0);
    }
  }
  v20 = a1;
  v10 = *(_QWORD *)&DXGGLOBAL::m_pGlobal + 305312LL;
  v23 = a4;
  v22 = a3;
  v21 = a2;
  v11 = *(_QWORD *)&DXGGLOBAL::m_pGlobal + 305328LL;
  v19 = 0;
  v17 = *(_QWORD *)&DXGGLOBAL::m_pGlobal + 305328LL;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 305328LL), &LockHandle);
  *(_QWORD *)(v11 + 8) = KeGetCurrentThread();
  ...
  if ( v12 )
  {
    ...
    while ( (unsigned __int8)lambda_0064cf26da968ceea20d1ab240e27164_::operator()(v15, v14) );
  }
