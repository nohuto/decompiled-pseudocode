/*
 * XREFs of ?DdiSetNativeFenceLogBuffer@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETNATIVEFENCELOGBUFFER@@@Z @ 0x140069B40
 * Callers:
 *     ADAPTER_RENDER_DdiSetNativeFenceLogBuffer @ 0x14006BE00 (ADAPTER_RENDER_DdiSetNativeFenceLogBuffer.c)
 * Callees:
