/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x140066170
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x14004C8D8 (RtlUnicodeStringValidateDestWorker.c)
 */
