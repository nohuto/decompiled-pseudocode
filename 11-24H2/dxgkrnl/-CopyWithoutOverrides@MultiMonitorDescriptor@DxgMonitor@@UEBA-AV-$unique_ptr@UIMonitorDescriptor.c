/*
 * XREFs of ?CopyWithoutOverrides@MultiMonitorDescriptor@DxgMonitor@@UEBA?AV?$unique_ptr@UIMonitorDescriptor@DxgMonitor@@U?$default_delete@UIMonitorDescriptor@DxgMonitor@@@wistd@@@wistd@@XZ @ 0x140091D30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0MultiMonitorDescriptor@DxgMonitor@@QEAA@$$QEAV?$unique_ptr@UIMonitorDescriptor@DxgMonitor@@U?$default_delete@UIMonitorDescriptor@DxgMonitor@@@wistd@@@wistd@@0@Z @ 0x140091B0C (--0MultiMonitorDescriptor@DxgMonitor@@QEAA@$$QEAV-$unique_ptr@UIMonitorDescriptor@DxgMonitor@@U-.c)
 *     _guard_dispatch_icall @ 0x1400A1CA0 (_guard_dispatch_icall.c)
 */

__int64 *__fastcall DxgMonitor::MultiMonitorDescriptor::CopyWithoutOverrides(__int64 a1, __int64 *a2)
{
  char v2; // bl
  _QWORD *v5; // rsi
  _QWORD *v6; // rbx
  ...
  if ( v5 )
  {
    v6 = (_QWORD *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 16) + 24LL))(
                     *(_QWORD *)(a1 + 16),
                     &v11);
    v7 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 8) + 24LL))(
                      *(_QWORD *)(a1 + 8),
                      &v10);
