/*
 * XREFs of ?AcquireTokenManagerLock@CTokenManager@@AEAAXXZ @ 0x14001D238
 * Callers:
 ...
 *     ?Lock@CTokenManager@@UEAAXXZ @ 0x14001C360 (-Lock@CTokenManager@@UEAAXXZ.c)
 ...
 *     ?LockIfNotTokenThread@CTokenManager@@UEAAXXZ @ 0x1400589C0 (-LockIfNotTokenThread@CTokenManager@@UEAAXXZ.c)
 ...
 *     ?EnsureLocked@CTokenManager@@UEAA_NXZ @ 0x14009A330 (-EnsureLocked@CTokenManager@@UEAA_NXZ.c)
