/*
 * XREFs of ?DdiGetMmioRangeCount@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z @ 0x14021247C
 * Callers:
 *     ?GetMmioRangeCount@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z @ 0x140218EF0 (-GetMmioRangeCount@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetMmioRangeCount(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5138);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5138);
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETMMIORANGECOUNT *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                           + 1072LL)
                                                                               + 40LL))(
