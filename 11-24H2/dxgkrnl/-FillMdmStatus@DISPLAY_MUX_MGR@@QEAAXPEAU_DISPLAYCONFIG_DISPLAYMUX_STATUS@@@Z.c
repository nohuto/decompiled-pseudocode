/*
 * XREFs of ?FillMdmStatus@DISPLAY_MUX_MGR@@QEAAXPEAU_DISPLAYCONFIG_DISPLAYMUX_STATUS@@@Z @ 0x1400273BC
 * Callers:
 ...
 *     ?DoesSystemSupportDynamicMdmNow@DISPLAY_MUX_MGR@@QEBAEXZ @ 0x140063C7C (-DoesSystemSupportDynamicMdmNow@DISPLAY_MUX_MGR@@QEBAEXZ.c)
