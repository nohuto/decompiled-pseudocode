/*
 * XREFs of ?SmmIommuCreateDevice@@YAJPEAUSYSMM_ADAPTER@@PEAU_DEVICE_OBJECT@@IIPEAPEAU_IOMMU_DMA_DEVICE@@@Z @ 0x1402845D4
 * Callers:
        ...
        struct _IOMMU_DMA_DEVICE **a5)
{
  ...
  if ( SmmUseIommuV3Interface() )
  {
    ...
    v10 = &v13;
    return ((__int64 (__fastcall *)(__int64, __int128 **, struct _IOMMU_DMA_DEVICE **))qword_1401615D0)(v7, v10, a5);
  }
