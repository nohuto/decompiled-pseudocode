/*
 * XREFs of ?VmBusOpenKeyedMutex@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1403E5760
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusOpenKeyedMutex(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *((_DWORD *)a1 + 36) < v4 )
  {
    ...
    WdLogGlobalForLineNumber = 7969;
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Invalid packet size (%u < %u)", v10, v8, 0LL, 0LL, 0LL);
    return 0;
  }
  v11 = 0LL;
