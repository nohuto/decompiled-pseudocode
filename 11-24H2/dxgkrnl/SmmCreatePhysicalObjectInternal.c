/*
 * XREFs of SmmCreatePhysicalObjectInternal @ 0x140020D00
 * Callers:
        ...
        char a7)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(v13 + 48) = 0;
    ...
    _InterlockedAdd64(&qword_140161618, *(_QWORD *)v13);
    v19 = (volatile signed __int64 *)&unk_140161628;
    if ( (*(_DWORD *)(v13 + 44) & 1) == 0 )
      v19 = (volatile signed __int64 *)&unk_140161620;
