/*
 * XREFs of ?_ResolveCloneGroupOnAdapter@CCD_BTL_CLONE_GROUP_RESOLVER@@AEAAJPEAVDXGADAPTER@@IPEAVDMMVIDPN@@@Z @ 0x1403B18BC
 * Callers:
 ...
 *     ?QueryMonitorUniqueness@CCD_SET_STRING_ID@@QEBAJIPEAI@Z @ 0x1403DEAD4 (-QueryMonitorUniqueness@CCD_SET_STRING_ID@@QEBAJIPEAI@Z.c)
 */
