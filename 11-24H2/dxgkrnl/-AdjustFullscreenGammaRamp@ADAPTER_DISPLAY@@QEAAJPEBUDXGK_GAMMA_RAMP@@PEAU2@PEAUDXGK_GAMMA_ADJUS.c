/*
 * XREFs of ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x140196D9C
 * Callers:
 ...
 * Callees:
 *     ?ScaleAndOffset@@YAGGMM@Z @ 0x14019AE34 (-ScaleAndOffset@@YAGGMM@Z.c)
 *     ?ScaleAndOffset@@YAMMMMMM@Z @ 0x14019AE78 (-ScaleAndOffset@@YAMMMMMM@Z.c)
 */
