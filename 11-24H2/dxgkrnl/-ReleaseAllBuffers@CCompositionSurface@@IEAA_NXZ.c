/*
 * XREFs of ?ReleaseAllBuffers@CCompositionSurface@@IEAA_NXZ @ 0x140016F88
 * Callers:
...
char __fastcall CCompositionSurface::ReleaseAllBuffers(CCompositionSurface *this)
{
  ...
  if ( *((_DWORD *)this + 34) )
  {
    v3 = (CCompositionSurface **)((char *)this + 120);
    v4 = (CCompositionSurface **)*((_QWORD *)this + 15);
    if ( v4[1] != (CCompositionSurface *)((char *)this + 120) )
      goto LABEL_13;
    v5 = *v4;
