/*
 * XREFs of ?VmBusSendDdiGetNodeMetadata@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIPEAU_DXGK_NODEMETADATA@@@Z @ 0x140229F8C
 * Callers:
  ...
  if ( (_QWORD)v14 )
  {
    ...
    *(_DWORD *)(v6 + 24) = a2;
    ...
    if ( v7 < 0 || (v7 = -1073741823, v13[0] < 0x50) || (v7 = v19, v19 < 0) )
    {
      ...
      WdLogGlobalForLineNumber = 8761;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000LL,
        0xFFFFFFFFLL,
        L"VmBusSendDdiGetNodeMetadata failed: 0x%I64x",
        v7,
        0LL,
        0LL,
        0LL,
