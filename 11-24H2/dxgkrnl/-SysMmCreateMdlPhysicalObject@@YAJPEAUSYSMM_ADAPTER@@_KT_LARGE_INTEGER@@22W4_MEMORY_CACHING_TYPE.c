/*
 * XREFs of ?SysMmCreateMdlPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KT_LARGE_INTEGER@@22W4_MEMORY_CACHING_TYPE@@IQEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@_NPEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@PEAPEAU_MDL@@@Z @ 0x1400209DC
 * Callers:
 ...
 *     SysMmTestCreateMdlPhysicalObject @ 0x140095D40 (SysMmTestCreateMdlPhysicalObject.c)
 * Callees:
    ...
    if ( PagesForMdl )
    {
      ...
      if ( PhysicalObject )
      {
        ...
        *(_DWORD *)(PhysicalObject + 48) = 0;
        ...
        _InterlockedAdd64(&qword_140161618, *(_QWORD *)v20);
        v24 = (volatile signed __int64 *)&unk_140161628;
        if ( (*(_DWORD *)(v20 + 44) & 1) == 0 )
          v24 = (volatile signed __int64 *)&unk_140161620;
...
LABEL_13:
    ...
    {
      _InterlockedIncrement(&dword_140161654);
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x200000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(
          ...
          1,
          -1,
          L"Failed to allocate MDL from MmAllocatePagesForMdlEx, Size=%I64u, CacheType=%u",
          a2,
          CacheType,
          0,
          0,
