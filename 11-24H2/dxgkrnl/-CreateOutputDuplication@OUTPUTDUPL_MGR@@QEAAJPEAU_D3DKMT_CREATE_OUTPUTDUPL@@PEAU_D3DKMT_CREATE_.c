/*
 * XREFs of ?CreateOutputDuplication@OUTPUTDUPL_MGR@@QEAAJPEAU_D3DKMT_CREATE_OUTPUTDUPL@@PEAU_D3DKMT_CREATE_OUTPUTDUPL_FLAGS@@@Z @ 0x1403D1DF8
 * Callers:
        ...
        struct _D3DKMT_CREATE_OUTPUTDUPL_FLAGS *a3)
{
  ...
  if ( OUTPUTDUPL_MGR::FindContextForProcess(this, (struct _KTHREAD **)v15, CurrentProcess, &v42[14]) )
  {
  ...
  ContextForProcess = OUTPUTDUPL_MGR::FindContextForProcess(this, (struct _KTHREAD **)v15, 0LL, &v39);
  v11 = v39;
...
LABEL_18:
  ...
  v37 = (DXGDIAGNOSTICS *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 121);
  if ( v37 )
