/*
 * XREFs of ?EmitSleepStudyBlockerTelemetry@DripsBlockerTrackingHelper@@IEAAX_KAEB_KPEAU_UNICODE_STRING@@I@Z @ 0x140401B84
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_14015E650, 0x400000002000LL) )
    {
      v10 = 4720LL * a5;
      v11 = 50331648LL;
      v22 = v7;
