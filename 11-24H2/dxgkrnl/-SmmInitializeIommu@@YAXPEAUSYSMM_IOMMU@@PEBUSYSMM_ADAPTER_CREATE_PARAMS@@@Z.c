/*
 * XREFs of ?SmmInitializeIommu@@YAXPEAUSYSMM_IOMMU@@PEBUSYSMM_ADAPTER_CREATE_PARAMS@@@Z @ 0x140284460
 * Callers:
...
void __fastcall SmmInitializeIommu(struct SYSMM_IOMMU *a1, const struct SYSMM_ADAPTER_CREATE_PARAMS *a2)
{
  ...
  *((_DWORD *)a1 + 8) = 0;
  *((_OWORD *)a1 + 16) = xmmword_1401335F0;
  *((_DWORD *)a1 + 6) = v4;
  v5 = *(_DWORD *)(v3 + 12);
  *((_QWORD *)a1 + 6) = 0LL;
  *((_DWORD *)a1 + 10) = 1;
  *((_QWORD *)a1 + 38) = 0LL;
  *((_OWORD *)a1 + 17) = xmmword_140133600;
  *((_OWORD *)a1 + 18) = xmmword_140133610;
  if ( (v5 & 1) == 0 )
  {
    *((_QWORD *)a1 + 8) = 0LL;
    ...
    *((_QWORD *)a1 + 22) = Mdl;
    if ( !Mdl )
    {
      _InterlockedIncrement(&dword_140161640);
