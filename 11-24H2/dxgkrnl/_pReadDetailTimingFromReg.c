/*
 * XREFs of _pReadDetailTimingFromReg @ 0x1402754E4
 * Callers:
 *     _pLoadAdditinalMode @ 0x1402E3480 (_pLoadAdditinalMode.c)
 * Callees:
 *     ?IsValidVideoStandardType@@YAJW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@@Z @ 0x140091A80 (-IsValidVideoStandardType@@YAJW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@@Z.c)
 *     __security_check_cookie @ 0x1400A1BC0 (__security_check_cookie.c)
 *     _pVerifyDetailTiming @ 0x140275650 (_pVerifyDetailTiming.c)
 */
...
__int64 __fastcall pReadDetailTimingFromReg(HANDLE KeyHandle, int a2, unsigned int a3, unsigned int *a4)
{
  ...
  while ( (unsigned int)v5 < 6 )
  {
    v9 = ZwQueryValueKey(
           KeyHandle,
           (PUNICODE_STRING)&unk_1400A8280 + (unsigned int)v5,
