/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS_EX@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140057298
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS_EX(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000020LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
