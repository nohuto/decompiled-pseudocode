/*
 * XREFs of ?TerminateAllocations@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@HPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x140336F2C
 * Callers:
        ...
        struct _D3DDDICB_DESTROYALLOCATION2FLAGS a6)
{
  ...
  struct DXGTERMINATIONTRACKER *v23; // rsi
  void *v24; // rcx
