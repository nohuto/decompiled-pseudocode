/*
 * XREFs of DpiSharedPowerRegister @ 0x140249110
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  if ( v10 && (v11 = *(void (**)(void *, void *))(a3 + 24)) != 0LL )
  {
    if ( a6 == 32 && a5 )
    {
      ...
      v17 = DXGGLOBAL::RegisterSharedPowerComponent(Global, v15, v10, v14, v11, v12, v13);
      v9 = v17;
      if ( v17 >= 0 )
      {
        *(_QWORD *)a5 = *(_QWORD *)(v20 + 4032);
