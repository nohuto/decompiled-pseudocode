/*
 * XREFs of ?EDID_V1_GetDolbyVisionCapsUpdated@@YAJKPEBEPEAUDISPLAY_DVLL_CAPS@@@Z @ 0x14009694C
 * Callers:
...
LABEL_41:
  ...
  if ( (unsigned __int8)v31 == 2 )
  {
    ...
    *(_BYTE *)a3 = 1;
    *((double *)a3 + 1) = dword_1401358B0[v19];
    *((double *)a3 + 2) = dword_140135930[(unsigned __int64)v17 >> 3];
  ...
  if ( (BYTE1(v31) & 3) == 1 )
  {
    v6 = dword_1401359B0[((unsigned __int64)BYTE3(v31) >> 4) | (unsigned __int16)(16 * BYTE4(v31))];
    v7 = dword_1401359B0[BYTE3(v31) & 0xF | (unsigned __int64)(unsigned __int16)(16 * BYTE5(v31))];
