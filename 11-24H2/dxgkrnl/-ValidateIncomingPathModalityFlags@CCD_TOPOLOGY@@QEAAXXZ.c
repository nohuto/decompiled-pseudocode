/*
 * XREFs of ?ValidateIncomingPathModalityFlags@CCD_TOPOLOGY@@QEAAXXZ @ 0x140320AB0
 * Callers:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( _bittest64(PathDescriptor, 0x34u) )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        262146LL,
        0xFFFFFFFFLL,
        L"(PathDescriptor->Flags & D3DKMT_PATHMODALITY_DESCRIPTOR_PATH_SMI_TMI_FORCED_FIXED) == 0",
        1243LL,
        0LL,
        0LL,
        0LL,
    ...
    if ( (*PathDescriptor & 0x800000) != 0 )
    {
      if ( (*PathDescriptor & 0x100) == 0 )
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          262146LL,
          0xFFFFFFFFLL,
          L"PathDescriptor->Flags & D3DKMT_PATHMODALITY_DESCRIPTOR_SMI_VALID",
          1250LL,
          0LL,
          0LL,
          0LL,
      ...
      if ( (*(_DWORD *)PathDescriptor & 0x20000) == 0 )
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          262146LL,
          0xFFFFFFFFLL,
          L"PathDescriptor->Flags & D3DKMT_PATHMODALITY_DESCRIPTOR_CONTENT_SIZE_VALID",
          1251LL,
          0LL,
          0LL,
          0LL,
