/*
 * XREFs of DpiDispatchPower @ 0x140398E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchPower(__int64 a1, IRP *a2)
{
  ...
  v11 = *(__int64 (__fastcall **)(__int64, IRP *))(v8 + 136);
  v2 = 1;
  if ( !v11 )
  {
    v10 = 0;
    if ( *(_QWORD *)(v8 + 160) )
    {
      ...
      v12 = PoCallDriver(*(PDEVICE_OBJECT *)(v8 + 160), a2);
      goto LABEL_7;
    }
LABEL_14:
    PoStartNextPowerIrp(a2);
...
LABEL_9:
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
  {
    ...
    McTemplateK0pt_EtwWriteTransfer(
      ...
      (__int64)&EventExitDpiDispatchPower,
      v13,
      a1,
      RemlockSize);
  }
