/*
 * XREFs of ?VidSchCancelPresentAtFlips@VIDSCH_EXPORT@@QEAAJPEAU_VIDSCH_DEVICE@@U_LUID@@_K2W4D3DKMT_CANCEL_PRESENTS_OPERATION@@U_D3DKMT_CANCEL_PRESENTS_FLAGS@@PEAX@Z @ 0x140077928
 * Callers:
