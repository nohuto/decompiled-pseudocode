/*
 * XREFs of ?SerializeModesToBuffer@MonitorModes@DxgMonitor@@QEBAXPEAU_DMM_MONITORSOURCEMODESET_SERIALIZATION@@I@Z @ 0x14027A404
 * Callers:
        ...
        unsigned int a3)
{
  ...
  struct _ERESOURCE *v11; // [rsp+48h] [rbp+20h] BYREF

  RESOURCE_LOCK<DxgMonitor::MonitorModes const>::RESOURCE_LOCK<DxgMonitor::MonitorModes const>(&v11, this);
