/*
 * XREFs of DxgkGetCddDeviceAndContextForCurrentSession @ 0x140346DD8
 * Callers:
        ...
        char a5)
{
  ...
  if ( !SessionData )
  {
    ...
    HighPart = v16;
LABEL_8:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v17, HighPart, LowPart, v20, 0LL, 0LL);
    return 3221225485LL;
  }
