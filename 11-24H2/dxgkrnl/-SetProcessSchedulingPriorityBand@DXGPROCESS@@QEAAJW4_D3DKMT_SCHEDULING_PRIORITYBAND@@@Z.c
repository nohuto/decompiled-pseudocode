/*
 * XREFs of ?SetProcessSchedulingPriorityBand@DXGPROCESS@@QEAAJW4_D3DKMT_SCHEDULING_PRIORITYBAND@@@Z @ 0x1401ED9EC
 * Callers:
...
__int64 __fastcall DXGPROCESS::SetProcessSchedulingPriorityBand(__int64 a1, int a2)
{
  ...
  if ( *(struct _KTHREAD **)(a1 + 128) != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"IsMutexOwner()", 4571LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  *(_QWORD *)(a1 + 224) = KeGetCurrentThread();
  if ( (_DWORD)v3 == 1 )
  {
    *((_QWORD *)DXGGLOBAL::GetGlobal() + 209) = a1;
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 415, 1, 0);
    *(_DWORD *)(a1 + 416) = 1;
  }
  else
  {
  ...
  *(_QWORD *)&v10 = a1 + 320;
  ...
  v10 = 0LL;
  if ( !(_DWORD)v3 && a1 == *((_QWORD *)DXGGLOBAL::GetGlobal() + 209) )
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 415, 0, 1);
  *(_QWORD *)(a1 + 224) = 0LL;
  ExReleasePushLockExclusiveEx(a1 + 216, 0LL);
  KeLeaveCriticalRegion();
  return 0LL;
