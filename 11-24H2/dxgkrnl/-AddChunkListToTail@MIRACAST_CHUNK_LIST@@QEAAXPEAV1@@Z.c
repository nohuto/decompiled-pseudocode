/*
 * XREFs of ?AddChunkListToTail@MIRACAST_CHUNK_LIST@@QEAAXPEAV1@@Z @ 0x140064294
 * Callers:
 *     ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x1400641A0 (-MiracastProcessPendingDPCChunks@@YAEPEAX@Z.c)
 *     DpiMiracastMoveChunkList @ 0x14007F880 (DpiMiracastMoveChunkList.c)
 * Callees:
 *     <none>
 */
