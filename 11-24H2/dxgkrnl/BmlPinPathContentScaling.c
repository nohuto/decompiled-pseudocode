/*
 * XREFs of BmlPinPathContentScaling @ 0x14038B9E0
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1401616E8 & 1) == 0 )
      {
        v12 = *(VIDPN_MGR **)(a2 + 48);
        dword_1401616E8 |= 1u;
        dword_140161480[0] = VIDPN_MGR::GetAdapterDefaultScaling(v12);
        dword_140161484 = 3;
        dword_140161488 = 4;
        dword_14016148C = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v13 >= 4 )
          break;
        v14 = (unsigned int)dword_140161480[v13];
