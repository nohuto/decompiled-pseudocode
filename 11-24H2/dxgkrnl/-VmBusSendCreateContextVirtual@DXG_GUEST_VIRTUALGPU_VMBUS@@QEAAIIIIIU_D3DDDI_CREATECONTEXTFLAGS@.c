/*
 * XREFs of ?VmBusSendCreateContextVirtual@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAIIIIIU_D3DDDI_CREATECONTEXTFLAGS@@W4_D3DKMT_CLIENTHINT@@IPEAX@Z @ 0x140229218
 * Callers:
    ...
    *(_OWORD *)v17 = 0LL;
    ...
    if ( v17[0] )
    {
      ...
      *(_QWORD *)&v14[4].0 = 6LL;
      ...
      if ( Size )
      {
        if ( *(_DWORD *)(*((_QWORD *)this + 9) + 2280LL) >= 0x7008u )
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        262145LL,
        0xFFFFFFFFLL,
        L"Failed to allocate memory for DXGKVMB_COMMAND_CREATECONTEXTVIRTUAL",
        8951LL,
        0LL,
        0LL,
        0LL,
