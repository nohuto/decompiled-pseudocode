/*
 * XREFs of ?ConvertVideoSignalInfo@@YAJPEBU_VideoModeDescriptor@@PEAU_D3DKMDT_VIDEO_SIGNAL_INFO@@@Z @ 0x14006460C
 * Callers:
 ...
 *     ConvertVideoStandardType @ 0x14005B744 (ConvertVideoStandardType.c)
 */
