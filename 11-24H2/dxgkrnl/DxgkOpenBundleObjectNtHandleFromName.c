/*
 * XREFs of DxgkOpenBundleObjectNtHandleFromName @ 0x1401E2E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenBundleObjectNtHandleFromName(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(a1, (__int64)&EventProfilerEnter, a3, 2205);
  }
  else
  {
    v13 = 0;
  ...
  Src = 0LL;
  LOBYTE(v5) = 1;
  v6 = ObOpenObjectByName(*((_QWORD *)&v14 + 1), g_pDxgkSharedBundleObjectType, v5, 0LL, v14, 0LL, &Src);
  if ( v6 >= 0 )
  {
    v7 = (void *)(a1 + 16);
