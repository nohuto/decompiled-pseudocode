/*
 * XREFs of DpiFdoStopDeviceAndReleasePostDisplayOwnership @ 0x1402487C8
 * Callers:
...
__int64 __fastcall DpiFdoStopDeviceAndReleasePostDisplayOwnership(__int64 a1, int a2)
{
  ...
  v9 = &xmmword_140160FC8;
  if ( !IsPostDevice )
    v9 = &xmmword_140161070;
  if ( g_OSTestSigningEnabled && *(_BYTE *)(v2 + 2716) && !IsPostDevice && DpiFdoIsMsBddAnchoredDevice(v7) )
  {
    ...
    {
      *(_DWORD *)v9 = 1024;
      *(_QWORD *)((char *)&xmmword_140161070 + 4) = 0x100000000300LL;
      HIDWORD(xmmword_140161070) = 22;
      *(PHYSICAL_ADDRESS *)&xmmword_140161080 = MmGetPhysicalAddress(ContiguousMemory);
      DWORD2(xmmword_140161080) = dword_140161114;
    ...
    if ( (v13 & 4) != 0 )
    {
      *(_BYTE *)(v2 + 4040) = v13 & 0xFB;
      if ( *(_DWORD *)(v6 + 136) >= 0x3003u )
      {
        if ( *(_QWORD *)(v6 + 736) )
        {
          v14 = (char *)&xmmword_140160FD8 + 12;
          if ( !IsPostDevice )
            v14 = (char *)&xmmword_140161080 + 12;
          *(_DWORD *)v14 = 0;
          v15 = DpiDxgkDdiStopDeviceAndReleasePostDisplayOwnership(
                  v6,
                  *(_QWORD *)(v2 + 48),
                  (unsigned int)dword_140161114,
                  v9);
          v5 = v15;
          if ( v15 < 0 )
          {
            ...
            v11 = (char *)&xmmword_140160FD8 + 8;
            if ( !IsPostDevice )
              v11 = (char *)&xmmword_140161080 + 8;
            goto LABEL_13;
          }
          if ( *(_DWORD *)v9 )
          {
          ...
          else
          {
            ...
            v11 = (char *)&xmmword_140160FD8 + 8;
            v16 = (char *)&xmmword_140160FD8 + 8;
            if ( !IsPostDevice )
              v16 = (char *)&xmmword_140161080 + 8;
            *(_DWORD *)v16 = -3;
            dword_14016115C = 0;
          }
          if ( !IsPostDevice )
...
LABEL_13:
    *v9 = 0LL;
    v9[1] = 0LL;
    *(_DWORD *)v11 = -1;
    v12 = (__int128 *)&unk_140160FE8;
    if ( !IsPostDevice )
      v12 = &xmmword_140161090;
...
LABEL_32:
  if ( *(_DWORD *)v11 != dword_140161114 )
  {
    v17 = (__int128 *)&unk_140160FE8;
    if ( !IsPostDevice )
      v17 = &xmmword_140161090;
    memset(v17, 0, 0x80uLL);
  }
LABEL_38:
  if ( DpiFdoIsPostDevice(qword_140161068) )
  {
