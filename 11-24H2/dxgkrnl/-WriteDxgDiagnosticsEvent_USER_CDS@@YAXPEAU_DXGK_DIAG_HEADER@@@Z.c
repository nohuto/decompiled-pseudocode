/*
 * XREFs of ?WriteDxgDiagnosticsEvent_USER_CDS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14005AE18
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_USER_CDS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4
    && (qword_14015E5F0 & 0x200000000008LL) != 0
    && (qword_14015E5F8 & 0x200000000008LL) == qword_14015E5F8 )
  {
    if ( tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000008LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
