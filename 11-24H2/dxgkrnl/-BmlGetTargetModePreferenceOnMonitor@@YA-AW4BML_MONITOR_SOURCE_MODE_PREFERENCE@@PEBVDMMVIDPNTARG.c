/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1402DFD98
 * Callers:
 ...
 *     BmlIsEDIDCapableOutputTechonology @ 0x1402DFF98 (BmlIsEDIDCapableOutputTechonology.c)
