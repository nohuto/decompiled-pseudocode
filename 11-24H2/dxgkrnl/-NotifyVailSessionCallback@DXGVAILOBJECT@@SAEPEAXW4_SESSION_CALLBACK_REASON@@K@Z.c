/*
 * XREFs of ?NotifyVailSessionCallback@DXGVAILOBJECT@@SAEPEAXW4_SESSION_CALLBACK_REASON@@K@Z @ 0x140207380
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXGVAILOBJECT::NotifyVailSessionCallback(__int64 a1, int a2, unsigned int a3)
{
              ...
              (struct _KPROCESS **)&Object) >= 0 )
  {
    ...
    SessionData = DXGSESSIONMGR::GetSessionData(*((DXGSESSIONMGR **)v7 + 122));
    LOBYTE(v3) = a1 != 0;
