/*
 * XREFs of ?DdiGetVirtualGpuInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x140212AE8
 * Callers:
 *     ?GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x140218F70 (-GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z.c)
 * Callees:
