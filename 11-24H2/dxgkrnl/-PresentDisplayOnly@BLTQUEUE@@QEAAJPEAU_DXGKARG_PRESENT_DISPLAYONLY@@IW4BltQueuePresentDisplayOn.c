/*
 * XREFs of ?PresentDisplayOnly@BLTQUEUE@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@IW4BltQueuePresentDisplayOnlySource@1@@Z @ 0x1403A2F5C
 * Callers:
 ...
 *     ?TdrIsDodPresentTimeoutForcedFlip@@YA_NXZ @ 0x1401D01B8 (-TdrIsDodPresentTimeoutForcedFlip@@YA_NXZ.c)
...
LABEL_6:
  ...
  v14 = 258;
  v17 = 10000000LL * (unsigned int)dword_140160A10;
  v22.QuadPart = -10000000LL * (unsigned int)dword_140160A10;
  while ( 1 )
  {
