/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@IPEAPEAVDXGKEYEDMUTEX@@@Z @ 0x1403BC45C
 * Callers:
        ...
        struct DXGKEYEDMUTEX **a5)
{
  ...
  if ( !a5 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"ppKeyedMutex != NULL", 4927LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a5 = 0LL;
