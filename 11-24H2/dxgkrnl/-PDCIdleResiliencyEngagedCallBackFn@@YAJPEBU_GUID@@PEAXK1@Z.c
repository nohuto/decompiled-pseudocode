/*
 * XREFs of ?PDCIdleResiliencyEngagedCallBackFn@@YAJPEBU_GUID@@PEAXK1@Z @ 0x1402E5B40
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Context)
{
  ...
  v4 = *Value;
  if ( *((unsigned __int8 *)DXGGLOBAL::GetGlobal() + 304344) != v4 )
  {
    ...
    if ( v4 )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x20000) != 0 )
        McTemplateK0_EtwWriteTransfer(v6, (__int64)&CSAccountingInProgress_Start, v8);
      v9 = 1;
    }
    else if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x20000) != 0 )
    {
      McTemplateK0_EtwWriteTransfer(v6, (__int64)&CSAccountingInProgress_Stop, v8);
    }
