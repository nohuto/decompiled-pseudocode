/*
 * XREFs of ??0OUTPUTDUPL_SESSION_MGR@@QEAA@XZ @ 0x1403EDCC0
 * Callers:
 *     ??0DXGSESSIONDATA@@QEAA@K@Z @ 0x1403DABE8 (--0DXGSESSIONDATA@@QEAA@K@Z.c)
 * Callees:
 *     ?InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ @ 0x1403EDD30 (-InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ.c)
 */
