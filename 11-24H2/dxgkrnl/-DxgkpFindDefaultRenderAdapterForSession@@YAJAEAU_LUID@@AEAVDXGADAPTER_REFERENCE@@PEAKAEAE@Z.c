/*
 * XREFs of ?DxgkpFindDefaultRenderAdapterForSession@@YAJAEAU_LUID@@AEAVDXGADAPTER_REFERENCE@@PEAKAEAE@Z @ 0x1401D39A4
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( a3 )
  {
    v9 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 122);
    if ( !v9 )
    {
  ...
  *a4 = v8 == 0;
  ...
  if ( !*(_QWORD *)a2 )
  {
    ...
    if ( IsCurrentConsoleSession() )
      v18 = (struct DXGADAPTER *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 125);
    else
      v18 = (struct DXGADAPTER *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 123);
