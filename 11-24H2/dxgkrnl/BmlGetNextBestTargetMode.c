/*
 * XREFs of BmlGetNextBestTargetMode @ 0x14038BDB4
 * Callers:
          ...
          if ( (v43 & 1) != 0 )
          {
            ...
            *a8 = PresentationVSync;
            if ( DMMVIDPNTARGETMODE::SupportVirtualRefreshRate((DMMVIDPNTARGETMODE *)v21)
              && (unsigned int)BmlDetermineBoostMultiplier(v21, (unsigned int *)&qword_14015F350) )
            {
              ...
              if ( v46 > 1 && __PAIR64__(v48, v45.Numerator) == qword_14015F350 )
              {
                v52.Denominator = v46 * v45.Denominator;
                *a8 = v52;
                *a9 = v46;
              }
              else if ( v45.Numerator * (unsigned __int64)(unsigned int)dword_14015F35C < (unsigned int)dword_14015F358
                                                                                        * (unsigned __int64)(v48 + v45.Denominator) )
              {
                if ( v46 > 1 )
                {
                  if ( v45.Numerator * (unsigned __int64)HIDWORD(qword_14015F348) < (unsigned int)qword_14015F348
                                                                                  * (unsigned __int64)v48
                    || __PAIR64__(v48, v45.Numerator) == qword_14015F348 )
                  {
                    *a9 = v46;
                    v52.Denominator = v46 * v45.Denominator;
                    *a8 = v52;
