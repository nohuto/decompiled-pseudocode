/*
 * XREFs of ?InitializeCompleted@CFlipToken@@IEAAJAEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@_N@Z @ 0x14001DAE0
 * Callers:
  ...
  if ( !*(_QWORD *)&DXGGLOBAL::m_pGlobal )
  {
    ...
    if ( bTracingEnabled )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(v36, v35, v37, 0LL, 2, -1, L"m_pGlobal != NULL", 45, 0, 0, 0, 0);
    }
  }
  v64 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304952LL) + 40LL))((char *)this + 96);
  v6 = *(_QWORD *)this;
  if ( v64 < 0 )
  {
  ...
  if ( v12 )
  {
    ...
    if ( *(_DWORD *)(v13 + 176) )
    {
      ...
      for ( i = *v16; i != v16; i = (_QWORD *)*i )
      {
        if ( *(i - 1) == v14 )
        {
          v18 = (*(__int64 (__fastcall **)(_QWORD *))(*(i - 3) + 40LL))(i - 3);
          goto LABEL_24;
        }
      }
    }
...
LABEL_24:
  ...
  if ( !*(_QWORD *)&DXGGLOBAL::m_pGlobal )
  {
    ...
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(v33, v32, v34, 0LL, 2, -1, L"m_pGlobal != NULL", 45, 0, 0, 0, 0);
    }
  }
  v19 = *((_QWORD *)this + 7);
  v20 = *((_BYTE *)this + 582);
  ...
  v22 = *((_DWORD *)this + 6);
  v23 = *((_QWORD *)this + 13);
  v24 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, int, int, bool, __int64, __int64, int))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304952LL) + 432LL);
  ...
  if ( v64 >= 0 )
  {
    ...
    *(_QWORD *)(v28 + 56) = PsGetCurrentThreadId();
    v29 = 0;
    CCompositionSurface::UpdatePresentRate((CCompositionSurface *)(v28 + 40));
    if ( *(_QWORD *)(v28 + 200) )
    {
      v40 = 0LL;
      v29 = -1073741275;
      if ( *(_DWORD *)(v28 + 176) )
      {
        for ( j = *(_QWORD **)(v28 + 160); j != (_QWORD *)(v28 + 160); j = (_QWORD *)*j )
        {
          if ( *(j - 1) == *((_QWORD *)this + 7) )
          {
            v40 = (struct CCompositionBuffer *)(j - 3);
            v29 = 0;
            break;
          }
        }
      ...
      if ( v29 >= 0 )
      {
        ...
        if ( inserted >= 0
          ...
          && (CFlipExBuffer::DisableCascadedSignaling(v42),
              LOBYTE(v44) = 1,
              v29 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v28 + 200) + 32LL))(
                      *(_QWORD *)(v28 + 200),
                      v44),
              v29 >= 0)
          ...
          && (v29 = CFlipExBuffer::InsertCascadedTokenWait(v42, &v67, &v66), v29 >= 0) )
        {
          if ( (*(unsigned __int8 (__fastcall **)(CFlipToken *))(*(_QWORD *)this + 168LL))(this) )
          {
            ...
            *((_OWORD *)v47 + 3) = v61;
            *((_QWORD *)v47 + 8) = v62;
            v29 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64, unsigned __int64, _BYTE *))(**(_QWORD **)(v28 + 200)
                                                                                                 + 40LL))(
                    *(_QWORD *)(v28 + 200),
                    v58,
                    v59,
