/*
 * XREFs of DpiFdoDispatchPnp @ 0x14023F8E0
 * Callers:
 *     <none>
 * Callees:
  ...
  switch ( MinorFunction )
  {
    ...
    case 1u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_140160D11 && (struct _DEVICE_OBJECT *)qword_140160FC0 == a1 || *(_BYTE *)(DeviceExtension + 480) )
      {
        v4 = 1;
        Status = -1073741823;
        WdLogSingleEntry3(2LL, a1, (unsigned __int8)byte_140160D11, *(unsigned __int8 *)(DeviceExtension + 480));
    ...
    case 5u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_140160D11 && !*(_BYTE *)(DeviceExtension + 481) || *(_BYTE *)(DeviceExtension + 480) )
      {
        v4 = 1;
        Status = -1073741823;
      }
