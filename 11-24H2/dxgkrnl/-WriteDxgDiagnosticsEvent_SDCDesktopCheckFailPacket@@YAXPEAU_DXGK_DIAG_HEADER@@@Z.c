/*
 * XREFs of ?WriteDxgDiagnosticsEvent_SDCDesktopCheckFailPacket@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140072A58
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_SDCDesktopCheckFailPacket(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015E5E0 > 4 && tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000800LL) )
  {
    if ( tlgKeywordOn((__int64)&dword_14015E5E0, 0x200000000001LL) )
    {
      v3 = v2 + 80;
      v4 = 32;
      v5 = v2 + 48;
