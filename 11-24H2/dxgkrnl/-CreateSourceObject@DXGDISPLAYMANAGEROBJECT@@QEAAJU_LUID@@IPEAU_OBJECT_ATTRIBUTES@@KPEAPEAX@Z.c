/*
 * XREFs of ?CreateSourceObject@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@IPEAU_OBJECT_ATTRIBUTES@@KPEAPEAX@Z @ 0x1401C6EB8
 * Callers:
...
LABEL_11:
    ...
    DxgkLogInternalTriageEvent(
      ...
      262145LL,
      0xFFFFFFFFLL,
      L"Failed to allocate DXGDISPLAYMANAGERSOURCEOBJECT",
      352LL,
      0LL,
      0LL,
      0LL,
  ...
  LOBYTE(v11) = 1;
  Object = 0LL;
  v14 = ObCreateObject(v11, g_pDxgkDisplayManagerObjectType, a4, v12, 0LL, 16, 136, 0, &Object);
  v15 = v14;
  if ( v14 >= 0 )
  {
    *(_OWORD *)Object = 0LL;
    ...
    if ( *(_QWORD *)(v13 + 24) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_Object == nullptr", 745LL, 0LL, 0LL, 0LL, 0LL);
    }
    *(_QWORD *)(v13 + 24) = v17;
    v20 = 0LL;
    *((_QWORD *)Object + 1) = v13;
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000LL,
        0xFFFFFFFFLL,
        L"Failed to create NT handle for display manager source object (0x%I64x)",
        v19,
        0LL,
        0LL,
        0LL,
