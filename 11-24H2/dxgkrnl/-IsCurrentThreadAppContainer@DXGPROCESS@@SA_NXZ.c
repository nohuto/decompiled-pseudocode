/*
 * XREFs of ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x140185B90
 * Callers:
 ...
 * Callees:
 *     ?OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z @ 0x140185C1C (-OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z.c)
 */
