/*
 * XREFs of DpiQueryDisplayIDDescriptor @ 0x1402559CC
 * Callers:
 *     ?GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z @ 0x14027DAE0 (-GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z.c)
 * Callees:
