/*
 * XREFs of ?MapFrameBufferPointer@DXGADAPTER@@QEAAJI_KPEA_KPEAPEAX@Z @ 0x14019309C
 * Callers:
        ...
        void **a5)
{
  ...
  if ( a2 >= *((_DWORD *)this + 74) )
  {
    ...
    WdLogGlobalForLineNumber = 11675;
  ...
  if ( (a3 & 0xFFF) != 0 )
  {
    ...
    v14 = 0LL;
    v13 = 0LL;
    WdLogGlobalForLineNumber = 11681;
LABEL_11:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v8, v16, v13, v14, 0LL, 0LL);
    return 3221225485LL;
  }
  ...
  if ( v6 + a3 > v10 || v6 + a3 < v6 )
  {
    ...
    v14 = *(_QWORD *)(v9 + 56);
    v13 = v6;
    WdLogGlobalForLineNumber = 11693;
    goto LABEL_11;
  }
  v15 = 0LL;
  v17 = v6;
