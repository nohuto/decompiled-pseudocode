/*
 * XREFs of DpiAcpiPrepareDisplayMuxSupport @ 0x1402520FC
 * Callers:
 ...
 *     ?DpiAcpiDoesDepContainMux@@YAEPEAU_FDO_CONTEXT@@PEAU_ACPI_EVAL_OUTPUT_BUFFER_V1@@@Z @ 0x14008BA10 (-DpiAcpiDoesDepContainMux@@YAEPEAU_FDO_CONTEXT@@PEAU_ACPI_EVAL_OUTPUT_BUFFER_V1@@@Z.c)
