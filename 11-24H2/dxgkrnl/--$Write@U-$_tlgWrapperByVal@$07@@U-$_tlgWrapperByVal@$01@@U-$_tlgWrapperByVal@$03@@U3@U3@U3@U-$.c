 ...
 *     ??$_tlgCreate1Sz@G@@YAXPEAU_EVENT_DATA_DESCRIPTOR@@PEBG@Z @ 0x1400566C4 (--$_tlgCreate1Sz@G@@YAXPEAU_EVENT_DATA_DESCRIPTOR@@PEBG@Z.c)
        ...
        __int64 a63)
{
  ...
  int v72; // ecx
  char v74[32]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v105 = 4LL;
  v103 = 8LL;
  _tlgCreate1Sz<unsigned short>(v101, v70);
  v99 = a16;
  v97 = a15;
  v100 = 2LL;
  v98 = 4LL;
  ...
  v78 = 2LL;
  v76 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015E618, a2, a3, 0LL, 80, v74);
}
