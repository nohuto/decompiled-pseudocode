/*
 * XREFs of DpiFdoQueryAdapterInfoIntegratedDisplay @ 0x140244460
 * Callers:
...
__int64 __fastcall DpiFdoQueryAdapterInfoIntegratedDisplay(__int64 a1, __int64 a2)
{
  ...
  *(_WORD *)(a2 + 94) = v8;
  ...
  if ( Pool2 )
  {
    ...
    v14 = DpiAcquireCoreSyncAccessSafe(a1, 0LL);
    LODWORD(v13) = v14;
    if ( v14 >= 0 )
    {
      *(_QWORD *)&v19.Type = 0LL;
      ...
      *(_OWORD *)&v19.OutputDataSize = 0LL;
      v19.OutputDataSize = v15;
      v19.InputDataSize = 4;
      v19.pOutputData = v12;
      v16 = *(DXGADAPTER **)(v3 + 4032);
      v20 = 0LL;
      v21 = 0LL;
      v22 = 0LL;
      v13 = (int)DXGADAPTER::DdiQueryAdapterInfo(v16, &v19);
