/*
 * XREFs of ?DisablePrimaryOnDevice@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@IE@Z @ 0x14028FFE0
 * Callers:
        ...
        unsigned __int8 a4)
{
  ...
  if ( *((DXGADAPTER **)a2 + 237) == v10 )
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(v13 + 200) == 1 )
      {
        ...
        {
          ADAPTER_RENDER::FlushScheduler(*((_QWORD *)a2 + 2), 8LL, a3);
        }
        else
        {
          v14 = 0;
  ...
  else if ( (unsigned int)Feature_CleanUpDisplayedPrimaryInSetTimings__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    DXGDEVICE::SetDisplayedPrimary((struct _KTHREAD **)a2, a3, 0LL, 0, 1u);
  }
}
