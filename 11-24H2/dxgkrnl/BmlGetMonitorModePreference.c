/*
 * XREFs of BmlGetMonitorModePreference @ 0x1402DFFEC
 * Callers:
 ...
 *     BmlGetMonitorModeVSyncPreference @ 0x1402DFCF4 (BmlGetMonitorModeVSyncPreference.c)
 *     BmlIsLowResAnalogTvOutput @ 0x1402DFD6C (BmlIsLowResAnalogTvOutput.c)
