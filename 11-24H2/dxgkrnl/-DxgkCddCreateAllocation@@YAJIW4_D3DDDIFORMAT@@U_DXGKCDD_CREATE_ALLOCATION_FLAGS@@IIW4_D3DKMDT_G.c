/*
 * XREFs of ?DxgkCddCreateAllocation@@YAJIW4_D3DDDIFORMAT@@U_DXGKCDD_CREATE_ALLOCATION_FLAGS@@IIW4_D3DKMDT_GDISURFACETYPE@@P6APEAXPEBXI@ZPEAX5IPEAI6PEAPEAX6@Z @ 0x14040CC00
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a14)
{
  ...
  Current = (struct _KTHREAD **)DXGPROCESS::GetCurrent(v19);
  v22 = (__int64)Current;
  if ( !Current )
  {
