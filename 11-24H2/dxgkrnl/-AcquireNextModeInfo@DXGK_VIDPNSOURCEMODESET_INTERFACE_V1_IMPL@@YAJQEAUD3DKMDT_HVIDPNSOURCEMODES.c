/*
 * XREFs of ?AcquireNextModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@PEAPEBU3@@Z @ 0x14039E7D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ContainsByReference@?$DoublyLinkedList@VDMMVIDPNSOURCEMODE@@U?$DoubleLinkedListElementDeleter@VDMMVIDPNSOURCEMODE@@@@@@QEAAEQEBVDMMVIDPNSOURCEMODE@@@Z @ 0x1400236F0 (-ContainsByReference@-$DoublyLinkedList@VDMMVIDPNSOURCEMODE@@U-$DoubleLinkedListElementDeleter@V.c)
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a4)
{
  ...
  _InterlockedAdd((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 27, 1u);
  v39 = -1;
  v40 = 0LL;
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer(v7, (__int64)&EventProfilerEnter, v8, 7002);
  }
  else
  {
    v41 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v39, 7002);
  ...
  {
    *(_QWORD *)&a3->Id = 0LL;
    v14 = ExposedViaHandle<DMMVIDPNSOURCEMODESET,D3DKMDT_HVIDPNSOURCEMODESET__ *>::GetFromHandle((__int64)this);
    if ( v14 )
    {
      v15 = (_DWORD *)((unsigned __int64)(a2 - 4) & -(__int64)(a2 != 0LL));
      if ( v15 && *v15 == 305419896 )
      {
        v16 = *(_QWORD *)(((unsigned __int64)(a2 - 4) & -(__int64)(a2 != 0LL)) + 8);
        if ( !v16 )
        {
               ...
               v16) )
        {
          ...
          *(_QWORD *)&v42 = DMMVIDPNSOURCEMODESET::GetNextMode;
          ...
          v46 = 0LL;
          v45 = v16;
          v17 = DMMVIDPNSOURCEMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::binder2nd<KM_STL::mem_fun1_t<DMMVIDPNSOURCEMODE *,DMMVIDPNSOURCEMODESET,DMMVIDPNSOURCEMODE const *>>>(
                  v14,
                  &v44,
                  &v46);
          v22 = v17;
