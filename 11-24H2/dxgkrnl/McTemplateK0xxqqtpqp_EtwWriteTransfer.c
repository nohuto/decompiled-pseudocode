/*
 * XREFs of McTemplateK0xxqqtpqp_EtwWriteTransfer @ 0x14006075C
 * Callers:
...
NTSTATUS McTemplateK0xxqqtpqp_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(SysMmControlGuid_Context, a2, a3, 9u, &v4);
}
