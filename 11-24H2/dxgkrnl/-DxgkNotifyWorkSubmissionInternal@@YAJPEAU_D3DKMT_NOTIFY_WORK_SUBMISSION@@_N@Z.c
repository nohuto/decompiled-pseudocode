/*
 * XREFs of ?DxgkNotifyWorkSubmissionInternal@@YAJPEAU_D3DKMT_NOTIFY_WORK_SUBMISSION@@_N@Z @ 0x1401D98CC
 * Callers:
 *     NtDxgkNotifyWorkSubmission @ 0x1401DB340 (NtDxgkNotifyWorkSubmission.c)
 * Callees:
