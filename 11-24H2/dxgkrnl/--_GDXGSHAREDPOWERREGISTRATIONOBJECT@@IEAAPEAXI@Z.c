/*
 * XREFs of ??_GDXGSHAREDPOWERREGISTRATIONOBJECT@@IEAAPEAXI@Z @ 0x140073238
 * Callers:
 ...
 *     ??1DXGSHAREDPOWERINUSELISTOBJECT@@IEAA@XZ @ 0x1401D314C (--1DXGSHAREDPOWERINUSELISTOBJECT@@IEAA@XZ.c)
 */
