/*
 * XREFs of ?GetActiveVidPnBasedDisplayModeList@@YAJQEAXEPEAU_D3DKMT_GETDISPLAYMODELIST@@1@Z @ 0x140343FDC
 * Callers:
        ...
        D3DKMT_DISPLAYMODE **a4)
{
  ...
  __int64 v14; // rbx
  int v15; // eax
  void (__fastcall *v16)(DXGADAPTER *, struct D3DKMDT_HVIDPN__ *); // r13
  ...
  D3DKMT_DISPLAYMODE **p_pModeList; // [rsp+A0h] [rbp-60h]
  ...
  v71 = 0LL;
  v80 = 0LL;
  v83 = (struct _DXGDMM_INTERFACE *)v81;
  v15 = (*(__int64 (__fastcall **)(DXGADAPTER *, struct D3DKMDT_HVIDPN__ **, struct _DXGDMM_VIDPN_INTERFACE **))(v81 + 48))(
          v5,
          &v80,
          &v71);
  v12 = v15;
  ...
  v16 = *(void (__fastcall **)(DXGADAPTER *, struct D3DKMDT_HVIDPN__ *))(v14 + 64);
  v17 = v80;
  v73 = v16;
  v18 = v80 != 0LL;
  v77 = 0LL;
  v78 = 0LL;
  v68 = v80 != 0LL;
  v19 = (*(__int64 (__fastcall **)(struct D3DKMDT_HVIDPN__ *, struct D3DKMDT_HVIDPNTOPOLOGY__ **, struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE **))v71)(
          v80,
          &v77,
          &v78);
  *(_DWORD *)&v69[7] = v19;
  if ( v19 < 0 )
  {
    v20 = VidPnSourceId;
    v21 = v19;
    WdLogSingleEntry5(2LL, v19, v17, v5, v20, v71);
  ...
  v22 = (ADAPTER_DISPLAY *)*((_QWORD *)v5 + 390);
  v23 = 0LL;
  v69[2] = 0;
  v75 = 0LL;
  ...
  *(_QWORD *)&v69[7] = v26 + 48;
  do
  {
                ...
                0LL) < 0 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"NT_SUCCESS(Status)", 5059LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( v23 )
    {
      if ( v28 != v69[0] )
        goto LABEL_29;
      if ( v23 >= *(unsigned int *)(*((_QWORD *)v5 + 390) + 96LL) )
      {
        WdLogSingleEntry0(1LL);
      ...
      v111[v23++] = *((_DWORD *)PrimaryDisplaySource + 4);
    }
    else
    {
      v23 = 1LL;
    ...
    v75 = v23;
LABEL_29:
    v30 = *((_QWORD *)PrimaryDisplaySource + 7);
    PrimaryDisplaySource = 0LL;
    if ( v30 != *(_QWORD *)&v69[7] )
      PrimaryDisplaySource = (struct DISPLAY_SOURCE *)(v30 - 56);
  }
  ...
  {
    v32 = 1;
    v33 = DmmConvertDWMCloneToUnpinnedHardwareCloneOnSource(v5, v111, v23, v17, v112);
    if ( v33 < 0 )
    {
      v34 = v33;
      WdLogSingleEntry4(2LL, VidPnSourceId, v5, v33, -1071775483LL);
...
LABEL_51:
    ...
    *(_QWORD *)&v69[7] = &v82->ModeCount;
    p_pModeList = &v82->pModeList;
    v41 = (int)OBTAIN_MODES_ON_SOURCE::operator()(
                 (OBTAIN_MODES_ON_SOURCE *)v94,
                 &v82->pModeList,
                 &v82->ModeCount,
                 v39,
                 v40);
      ...
      if ( v32 )
      {
        ...
        if ( v23 )
        {
          ...
          do
          {
            ...
            v89 = 0LL;
            v92 = 1;
            v46 = (int)OBTAIN_PREFERRED_MODES_ON_PATH::operator()(&v85, &v79, &v72);
            MODE_UNION_LIST::~MODE_UNION_LIST((void **)&v89);
            if ( (int)v46 >= 0 )
            {
              if ( v79 )
              {
                v47 = (int)CombineModeList(v42, (const void **)p_pModeList, v72, (unsigned int *)v79, 0);
    ...
    {
      WdLogSingleEntry5(3LL, v41, v17, v5, VidPnSourceId, v23);
...
LABEL_41:
  ...
  WdLogSingleEntry3(2LL, VidPnSourceId, v5, v35);
