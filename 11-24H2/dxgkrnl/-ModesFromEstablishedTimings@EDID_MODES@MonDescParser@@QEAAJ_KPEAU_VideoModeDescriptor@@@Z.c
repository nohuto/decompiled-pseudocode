/*
 * XREFs of ?ModesFromEstablishedTimings@EDID_MODES@MonDescParser@@QEAAJ_KPEAU_VideoModeDescriptor@@@Z @ 0x14005C124
 * Callers:
...
LABEL_6:
  ...
  while ( v4 < a2 )
  {
    if ( (v11 & 1) != 0 )
    {
      ...
      v13 = 56LL * v7;
      ++v4;
      v14 = *(_OWORD *)((char *)&unk_1400BF290 + v13 + 16);
      *(_OWORD *)&a3[v12].PixelClockRate = *(_OWORD *)((char *)&unk_1400BF290 + v13);
      v15 = *(_OWORD *)((char *)&unk_1400BF290 + v13 + 32);
      *(_OWORD *)&a3[v12].HorizontalRefreshRateDenominator = v14;
      *(_QWORD *)&v14 = *(_QWORD *)((char *)&unk_1400BF290 + v13 + 48);
