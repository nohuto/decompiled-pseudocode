/*
 * XREFs of ?IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z @ 0x1401BB40C
 * Callers:
 *     DXGDEVICE_IsDisplayingOnVidPnSource @ 0x14006BFE0 (DXGDEVICE_IsDisplayingOnVidPnSource.c)
 * Callees:
