/*
 * XREFs of ?VmBusSendCddGdiCommand@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGCONTEXT@@PEBU_D3DKMT_RENDER@@@Z @ 0x1404023F0
 * Callers:
...
LABEL_19:
      ...
      if ( v24 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 11543;
