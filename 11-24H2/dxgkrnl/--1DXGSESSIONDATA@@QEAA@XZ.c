/*
 * XREFs of ??1DXGSESSIONDATA@@QEAA@XZ @ 0x1401F96AC
 * Callers:
 ...
 *     ?CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z @ 0x14007A3E8 (-CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z.c)
...
void __fastcall DXGSESSIONDATA::~DXGSESSIONDATA(DXGSESSIONDATA *this)
{
  ...
  *((_QWORD *)this + 2318) = 0LL;
  if ( *((_DWORD *)this + 4742) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"0 == m_cVailGuestReference", 3614LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_QWORD *)this + 2372) )
  {
    WdLogSingleEntry0(1LL);
  ...
  if ( *((_WORD *)this + 9321) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_NumDeviceInBatch == 0", 3628LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  *((_QWORD *)this + 2333) = 0LL;
  ...
  if ( *((_QWORD *)this + 2340) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"m_DwmProcess == nullptr", 3639LL, 0LL, 0LL, 0LL, 0LL);
  }
  Global = DXGGLOBAL::GetGlobal();
  DXGVALIDATION::CleanupForSession((struct DXGGLOBAL *)((char *)Global + 1652), this);
