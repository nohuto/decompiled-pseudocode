/*
 * XREFs of ?CreateSyncObject@DXGGLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAVDXGDEVICE@@IPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@_NPEAVDXGPAGINGQUEUE@@PEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEAIPEAPEAVDXGADAPTERSYNCOBJECT@@PEAU_D3DDDI_NATIVEFENCEINFO@@PEAE@Z @ 0x1402FA1CC
 * Callers:
 ...
 *     ??0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@PEAU_D3DDDI_NATIVEFENCEINFO@@@Z @ 0x1402FA680 (--0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJE.c)
 ...
 *     ??0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z @ 0x1403AC80C (--0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z.c)
 */
...
LABEL_5:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v17, -1073741811LL, 0LL, 0LL, 0LL, 0LL);
    return v16;
  }
  if ( a9 )
    *a9 = 0LL;
  ...
  if ( (v19 & 4) != 0 )
  {
    v20 = operator new(0x1C0uLL, 0x4B677844u, 64LL);
    v21 = v20;
    if ( v20 )
    {
  ...
  {
    v30 = operator new(0x218uLL, 0x4B677844u, 64LL);
    v21 = v30;
    if ( !v30 )
    {
LABEL_21:
  ...
  *(_DWORD *)(v21 + 412) = v23;
  ...
  if ( v25 >= 0 )
  {
    ...
    {
      DXGSYNCOBJECT::AddReference((DXGSYNCOBJECT *)v21);
      goto LABEL_32;
    }
    v26 = *(_DWORD *)(v21 + 404);
    if ( v26 == 7 )
