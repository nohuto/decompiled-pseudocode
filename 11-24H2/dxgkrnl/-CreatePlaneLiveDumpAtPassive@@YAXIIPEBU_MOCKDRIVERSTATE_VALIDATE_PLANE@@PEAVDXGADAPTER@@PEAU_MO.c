/*
 * XREFs of ?CreatePlaneLiveDumpAtPassive@@YAXIIPEBU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1401DDAF8
 * Callers:
        ...
        struct _MOCKDRIVERSTATE_PLANE *a5)
{
  ...
  *((_QWORD *)v9 + 328) = *((_QWORD *)a3 + 6);
  ...
  if ( (unsigned int)dword_14015E650 > 5 && tlgKeywordOn((__int64)&dword_14015E650, 0x400000020000LL) )
  {
    LOBYTE(v10) = 1;
