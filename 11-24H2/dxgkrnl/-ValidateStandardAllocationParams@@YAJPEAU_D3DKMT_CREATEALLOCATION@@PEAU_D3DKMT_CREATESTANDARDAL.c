/*
 * XREFs of ?ValidateStandardAllocationParams@@YAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DKMT_CREATESTANDARDALLOCATION@@_N@Z @ 0x1401B1FAC
 * Callers:
...
LABEL_3:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v5, -1073741811LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
  if ( a1->NumAllocations != 1 )
  {
    WdLogSingleEntry1(2LL, -1073741811LL);
    WdLogGlobalForLineNumber = 8890;
  ...
  else
  {
    if ( a2->Type != 2 )
    {
      ...
      WdLogGlobalForLineNumber = 8944;
      return -1073741811LL;
    }
    if ( (*(_DWORD *)&a1->Flags & 0x20020) != 0 )
    {
      WdLogSingleEntry1(3LL, -1073741811LL);
      WdLogGlobalForLineNumber = 8937;
      return 3221225485LL;
    }
  }
  if ( a2->Flags.Value )
