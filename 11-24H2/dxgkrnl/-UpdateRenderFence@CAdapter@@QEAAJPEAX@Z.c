/*
 * XREFs of ?UpdateRenderFence@CAdapter@@QEAAJPEAX@Z @ 0x14002EE88
 * Callers:
 ...
 *     DxgkDestroyDeviceInternal @ 0x1401BD028 (DxgkDestroyDeviceInternal.c)
...
__int64 __fastcall CAdapter::UpdateRenderFence(CAdapter *this, void *a2)
{
  ...
  _D3DKMT_DESTROYSYNCHRONIZATIONOBJECT v16; // [rsp+C8h] [rbp+6Fh] BYREF
