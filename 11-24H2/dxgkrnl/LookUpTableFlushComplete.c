/*
 * XREFs of LookUpTableFlushComplete @ 0x1403DA31C
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1403F70D0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
 ...
 *     FlushLookUpTableBucket @ 0x140099524 (FlushLookUpTableBucket.c)
 *     __security_check_cookie @ 0x1400A1BC0 (__security_check_cookie.c)
 *     UpdateInternalStatsOnFlush @ 0x1402899FC (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 288) )
    {
      if ( (unsigned int)dword_14015F068 > 5 && tlgKeywordOn((__int64)&dword_14015F068, 0x200000000000LL) )
      {
        v11 = 4;
        v37 = 42;
        v34 = L"SummaryCount";
