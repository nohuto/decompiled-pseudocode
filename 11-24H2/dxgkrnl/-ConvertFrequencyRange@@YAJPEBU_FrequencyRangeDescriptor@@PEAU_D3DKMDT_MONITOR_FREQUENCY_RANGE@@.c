/*
 * XREFs of ?ConvertFrequencyRange@@YAJPEBU_FrequencyRangeDescriptor@@PEAU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x140057148
 * Callers:
 ...
 *     ConvertMonitorFrequencyRangeType @ 0x140063BC0 (ConvertMonitorFrequencyRangeType.c)
