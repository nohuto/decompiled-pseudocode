/*
 * XREFs of DxgkUseAdapterViewInCurrentSession @ 0x140345CB0
 * Callers:
...
LABEL_16:
        ...
        if ( v11 )
        {
          ...
          else
          {
            ...
            {
              v15 = (struct DISPLAY_SOURCE *)(*(_QWORD *)(v14 + 128) + 4024 * v5);
              if ( v32 )
              {
                ...
                if ( v16 >= 0 )
                {
                  KeSetEvent(*(PRKEVENT *)(*((_QWORD *)v11 + 390) + 672LL), 0, 0);
LABEL_14:
            ...
            DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v21, v5, a1->HighPart, a1->LowPart, v29, 0LL);
          }
          COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v35);
        }
        else
