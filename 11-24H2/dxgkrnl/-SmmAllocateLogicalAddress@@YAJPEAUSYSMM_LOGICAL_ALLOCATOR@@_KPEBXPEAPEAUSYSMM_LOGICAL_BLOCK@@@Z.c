/*
 * XREFs of ?SmmAllocateLogicalAddress@@YAJPEAUSYSMM_LOGICAL_ALLOCATOR@@_KPEBXPEAPEAUSYSMM_LOGICAL_BLOCK@@@Z @ 0x140095148
 * Callers:
 ...
 *     ?SysMmAllocateLogicalMemory@@YAJPEAUSYSMM_ADAPTER@@_KPEBXPEAPEAX@Z @ 0x1403704A0 (-SysMmAllocateLogicalMemory@@YAJPEAUSYSMM_ADAPTER@@_KPEBXPEAPEAX@Z.c)
 * Callees:
        ...
        struct SYSMM_LOGICAL_BLOCK **a4)
{
  ...
  v4 = (char *)a1 + 1320;
  ExAcquirePushLockExclusiveEx((char *)a1 + 1320, 0LL);
  v10 = 0;
  v11 = (a2 + 4095) >> 12;
  if ( v11 < 2 )
  {
  ...
  if ( 4096LL << v14 < a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"BlockSize >= Size", 1304LL, 0LL, 0LL, 0LL, 0LL);
  }
  LOBYTE(v9) = v14;
