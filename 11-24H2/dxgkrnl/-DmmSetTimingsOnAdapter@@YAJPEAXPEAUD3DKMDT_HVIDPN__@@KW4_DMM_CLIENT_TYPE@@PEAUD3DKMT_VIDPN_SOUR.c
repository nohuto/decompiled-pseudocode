/*
 * XREFs of ?DmmSetTimingsOnAdapter@@YAJPEAXPEAUD3DKMDT_HVIDPN__@@KW4_DMM_CLIENT_TYPE@@PEAUD3DKMT_VIDPN_SOURCE_MASKS@@PEAU_DMM_SET_TIMING_RESULT@@PEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@@Z @ 0x14037C4BC
 * Callers:
        ...
        __int64 a8)
{
  ...
  v12 = a7;
  if ( a7 && (*(_DWORD *)(a7 + 464) != 2 || *(_QWORD *)(a7 + 1896) != a1) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4044;
  }
  ++*(_DWORD *)(*(_QWORD *)(a1 + 3120) + 424LL);
  v13 = *(VIDPN_MGR **)(*(_QWORD *)(a1 + 3120) + 104LL);
