/*
 * XREFs of ?DdiStartDirtyTracking@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401A9730
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiStartDirtyTracking(ADAPTER_RENDER *this, void *const a2, __int64 a3)
{
  ...
  if ( (qword_14015E4B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5178);
  }
  else
  {
    v17 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5178);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1584LL))(
  ...
  {
    WdLogSingleEntry1(2LL, v10);
    WdLogGlobalForLineNumber = 5294;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiStartDirtyTracking. Status: 0x%I64x",
      v10,
      0LL,
      0LL,
      0LL,
