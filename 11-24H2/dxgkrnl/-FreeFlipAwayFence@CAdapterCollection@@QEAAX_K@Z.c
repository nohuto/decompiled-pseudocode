/*
 * XREFs of ?FreeFlipAwayFence@CAdapterCollection@@QEAAX_K@Z @ 0x14009A7B0
 * Callers:
 *     ?ConfirmFrame@CTokenManager@@UEAAXAEBUtagCOMPOSITION_CONFIRM_FRAME_INFO@@@Z @ 0x14009A1E0 (-ConfirmFrame@CTokenManager@@UEAAXAEBUtagCOMPOSITION_CONFIRM_FRAME_INFO@@@Z.c)
 * Callees:
