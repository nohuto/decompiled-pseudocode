/*
 * XREFs of DxgkHandleVideoParameters @ 0x1402324E0
 * Callers:
 *     DpiGdoHandleVideoParameters @ 0x140256068 (DpiGdoHandleVideoParameters.c)
 * Callees:
...
__int64 __fastcall DxgkHandleVideoParameters(DXGADAPTER ***a1, unsigned int a2, char *Source1)
{
  ...
  if ( Current )
  {
    ...
    if ( !a1 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDxgAdapter != NULL", 65LL, 0LL, 0LL, 0LL, 0LL);
    }
