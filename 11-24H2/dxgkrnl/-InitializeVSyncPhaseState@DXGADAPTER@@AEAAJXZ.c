/*
 * XREFs of ?InitializeVSyncPhaseState@DXGADAPTER@@AEAAJXZ @ 0x140192D58
 * Callers:
...
__int64 __fastcall DXGADAPTER::InitializeVSyncPhaseState(DXGADAPTER *this)
{
  ...
  if ( !is_mul_ok(v2, 4uLL) )
    v3 = -1LL;
  *((_QWORD *)this + 538) = operator new[](v3, 0x4B677844u, 64LL);
  v4 = (unsigned __int64)v2 << 6;
  if ( !is_mul_ok(v2, 0x40uLL) )
    v4 = -1LL;
  *((_QWORD *)this + 539) = operator new[](v4, 0x4B677844u, 64LL);
  v5 = (unsigned __int64)v2 << 6;
  if ( !is_mul_ok(v2, 0x40uLL) )
    v5 = -1LL;
  *((_QWORD *)this + 540) = operator new[](v5, 0x4B677844u, 64LL);
  v6 = 32LL * v2;
  if ( !is_mul_ok(v2, 0x20uLL) )
    v6 = -1LL;
  *((_QWORD *)this + 541) = operator new[](v6, 0x4B677844u, 64LL);
  v7 = 16LL * v2;
  if ( !is_mul_ok(v2, 0x10uLL) )
    v7 = -1LL;
  *((_QWORD *)this + 542) = operator new[](v7, 0x4B677844u, 64LL);
  v8 = 4LL * v2;
  if ( !is_mul_ok(v2, 4uLL) )
    v8 = -1LL;
  *((_QWORD *)this + 543) = operator new[](v8, 0x4B677844u, 64LL);
  v9 = 8LL * v2;
  if ( !is_mul_ok(v2, 8uLL) )
    v9 = -1LL;
  *((_QWORD *)this + 550) = operator new[](v9, 0x4B677844u, 64LL);
  v10 = 8LL * v2;
  if ( !is_mul_ok(v2, 8uLL) )
    v10 = -1LL;
  *((_QWORD *)this + 549) = operator new[](v10, 0x4B677844u, 64LL);
  v11 = 112LL * v2;
  ...
  *((_QWORD *)this + 551) = v14;
  ...
  if ( v2 )
  {
    ...
    do
    {
      *(_DWORD *)(v17 + *((_QWORD *)this + 538)) = 0;
      KeInitializeTimer((PKTIMER)(v13 + *((_QWORD *)this + 539)));
      *(_QWORD *)(v19 + *((_QWORD *)this + 542)) = this;
      *(_DWORD *)(*((_QWORD *)this + 542) + v19 + 8) = v15;
      KeInitializeDpc(
        (PRKDPC)(v13 + *((_QWORD *)this + 540)),
        (PKDEFERRED_ROUTINE)DxgkpVSyncPhaseTimerDpc,
        (PVOID)(v20 + *((_QWORD *)this + 542)));
      v21 = *((_QWORD *)this + 541);
      v19 += 16LL;
      v22 = v20 + *((_QWORD *)this + 542);
      ++v15;
      v13 += 64LL;
      v20 += 16LL;
      *(_QWORD *)(v18 + v21) = 0LL;
      ...
      *(_QWORD *)(v18 + v21 + 24) = v22;
      ...
      v17 = v24 + 4;
      v24 += 4LL;
      *(LARGE_INTEGER *)(v25 + *((_QWORD *)this + 551)) = PerformanceCounter;
      v25 += 112LL;
    }
    while ( v15 < v2 );
  }
