/*
 * XREFs of ?DdiControlInterrupt2@DXGADAPTER@@QEAAJU_DXGKARG_CONTROLINTERRUPT2@@EI@Z @ 0x1400301E8
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt2 @ 0x14006BF00 (DXGADAPTER_DdiControlInterrupt2.c)
 ...
 *     ?VSyncStateChange@VSYNC_TIME_STATS@@QEAAXW4_DXGK_CRTC_VSYNC_STATE@@0@Z @ 0x140036B38 (-VSyncStateChange@VSYNC_TIME_STATS@@QEAAXW4_DXGK_CRTC_VSYNC_STATE@@0@Z.c)
...
LABEL_96:
  ...
  if ( a2.InterruptType == DXGK_INTERRUPT_CRTC_VSYNC )
  {
    if ( (int)v41 >= 0 )
    {
      ...
      v71 = *((_QWORD *)this + 390);
      if ( v71 && !(_DWORD)HighPart && *(_QWORD *)(v71 + 1032) )
        *(_BYTE *)(v71 + 976) = 1;
