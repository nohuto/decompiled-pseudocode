/*
 * XREFs of McTemplateK0xqttt_EtwWriteTransfer @ 0x140094A0C
 * Callers:
...
NTSTATUS McTemplateK0xqttt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventBltQueueWakeReason, a3, 6u, &v4);
}
