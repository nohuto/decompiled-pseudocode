/*
 * XREFs of DxgkAcquireAdapterStopResetSync @ 0x1401893B8
 * Callers:
...
__int64 __fastcall DxgkAcquireAdapterStopResetSync(__int64 a1, int a2)
{
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"No hAdapter specified", 267LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
}
