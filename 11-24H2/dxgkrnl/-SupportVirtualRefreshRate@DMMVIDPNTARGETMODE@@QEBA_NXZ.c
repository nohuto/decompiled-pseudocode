/*
 * XREFs of ?SupportVirtualRefreshRate@DMMVIDPNTARGETMODE@@QEBA_NXZ @ 0x1402DBB50
 * Callers:
 ...
 *     ?IsVirtualRefreshRateEnabledOnExternalMonitor@ADAPTER_DISPLAY@@QEBA_NXZ @ 0x1402DBC18 (-IsVirtualRefreshRateEnabledOnExternalMonitor@ADAPTER_DISPLAY@@QEBA_NXZ.c)
 */
