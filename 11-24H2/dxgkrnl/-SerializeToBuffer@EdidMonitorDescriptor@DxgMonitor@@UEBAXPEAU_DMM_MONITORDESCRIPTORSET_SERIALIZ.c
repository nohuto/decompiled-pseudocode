/*
 * XREFs of ?SerializeToBuffer@EdidMonitorDescriptor@DxgMonitor@@UEBAXPEAU_DMM_MONITORDESCRIPTORSET_SERIALIZATION@@I@Z @ 0x1402802C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ @ 0x140280140 (-GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ.c)
 */
