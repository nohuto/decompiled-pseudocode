/*
 * XREFs of ?DxgkNotifyMemorySegmentHasData@@YAJQEAXIE@Z @ 0x140010610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkNotifyMemorySegmentHasData(void *const a1, unsigned int a2, char a3)
{
  __int64 v4; // rdi
  ...
  if ( *(_QWORD *)(DxgAdapter + 3232) )
  {
    v8 = 0;
    v9 = (unsigned int *)(*(_QWORD *)(DxgAdapter + 3224) + 520 * v4);
    if ( v9[2] > 1 )
    {
      v10 = v9[86];
      if ( a3 )
