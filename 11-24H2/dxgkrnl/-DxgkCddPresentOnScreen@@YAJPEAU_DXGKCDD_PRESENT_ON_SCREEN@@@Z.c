/*
 * XREFs of ?DxgkCddPresentOnScreen@@YAJPEAU_DXGKCDD_PRESENT_ON_SCREEN@@@Z @ 0x14040F280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddPresentOnScreen(struct _DXGKCDD_PRESENT_ON_SCREEN *a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( !v136 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 1033LL, 0LL, 0LL, 0LL, 0LL);
    }
...
LABEL_141:
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v24, v3, 0LL, 0LL, 0LL, 0LL);
LABEL_142:
    ...
    if ( (unsigned int)v37 > 4 )
    {
      ...
      if ( !is_mul_ok(*((unsigned int *)a1 + 19), 0x10uLL) )
        v45 = -1LL;
      v127 = (struct tagRECT *)operator new[](v45, 0x4B677844u, 256LL);
      if ( !v127 )
      {
...
LABEL_134:
    ...
    while ( 1 )
    {
      ...
      if ( !v40 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 1131LL, 0LL, 0LL, 0LL, 0LL);
      }
      if ( !*(_QWORD *)(v40 + 3120) )
      {
        WdLogSingleEntry0(1LL);
      ...
      v42 = ExAllocateFromLookasideListEx((PLOOKASIDE_LIST_EX)((char *)v41 + 1232));
...
LABEL_108:
    ...
    v137 = v50;
    v156 = *(struct tagRECT *)(4024LL * v50 + *((_QWORD *)v128 + 16) + 688);
    ...
    else
    {
      if ( !*(_QWORD *)(v40 + 3128) )
      {
        ...
        v117 = v100;
LABEL_106:
        DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v99, v40, (__int64)v117, v118, 0LL, 0LL);
        goto LABEL_108;
      }
      DxgkpConvertRects(
        *((_DWORD *)a1 + 8),
