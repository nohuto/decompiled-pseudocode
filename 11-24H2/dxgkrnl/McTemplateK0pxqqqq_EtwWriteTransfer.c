/*
 * XREFs of McTemplateK0pxqqqq_EtwWriteTransfer @ 0x14008D670
 * Callers:
...
NTSTATUS McTemplateK0pxqqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventEnterDdiI2CIoctl, a3, 7u, &v4);
}
