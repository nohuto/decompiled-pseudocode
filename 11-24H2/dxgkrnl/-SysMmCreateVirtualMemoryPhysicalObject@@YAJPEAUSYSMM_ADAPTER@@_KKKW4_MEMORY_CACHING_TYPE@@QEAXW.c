/*
 * XREFs of ?SysMmCreateVirtualMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKKW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x140286A08
 * Callers:
 *     SysMmTestCreateVirtualMemoryPhysicalObject @ 0x140095EC0 (SysMmTestCreateVirtualMemoryPhysicalObject.c)
 * Callees:
        ...
        _QWORD *a9)
{
  ...
  {
    _InterlockedIncrement(&dword_140161650);
