/*
 * XREFs of ?SetVirtualGpuVmBus@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x140216BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGKARG_SETVIRTUALGPUVMBUS *a2)
{
  ...
  if ( !v7 )
  {
    ...
    if ( g_VgpuDisableVaBackedVm
      || (int)((__int64 (__fastcall *)(__int64, struct _EPROCESS **))qword_1401605E8)(v8, &v38) < 0 )
    {
      v10 = 0LL;
      v11 = 0LL;
    }
...
LABEL_40:
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"VMWP process failed to reset", 426LL, 0LL, 0LL, 0LL, 0LL);
