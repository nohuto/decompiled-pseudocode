/*
 * XREFs of ?ReleaseFrame@OUTPUTDUPL_CONTEXT@@QEAAJPEAU_D3DKMT_OUTPUTDUPL_RELEASE_FRAME@@@Z @ 0x1402B39EC
 * Callers:
    ...
    *((_DWORD *)this + 71) = 0;
    if ( (v20[5] || v20[10]) && v20[4] != 1 )
    {
      ...
      if ( v22 == 258 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"Status != STATUS_TIMEOUT", 2385LL, 0LL, 0LL, 0LL, 0LL);
      }
      else if ( v22 < 0 )
      {
