/*
 * XREFs of ?QueryMitigatedRangeCount@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_QUERYMITIGATEDRANGECOUNT@@@Z @ 0x14020E5F8
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::QueryMitigatedRangeCount(__int64 a1, __int64 a2, unsigned int *a3)
{
  unsigned int v4; // ebx
  ...
  {
    v9 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 128LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
