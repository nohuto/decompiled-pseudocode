/*
 * XREFs of ?Init@DISPLAY_MUX_DEVICE@@QEAAJPEBU_UNICODE_STRING@@@Z @ 0x140084D78
 * Callers:
 ...
 *     Feature_DisplayMux_ForceMuxFullSupport__private_IsEnabledDeviceUsageNoInline @ 0x140089D18 (Feature_DisplayMux_ForceMuxFullSupport__private_IsEnabledDeviceUsageNoInline.c)
...
LABEL_26:
  ...
  v12 = 2;
LABEL_27:
  DXGKCALLONEXIT__lambda_90ed363b99280d3fe97ccba0f2c3e6a8____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT((__int64)v10);
  return v5;
}
