/*
 * XREFs of ?DestroyCoreAllocations@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@PEAVDXGALLOCATION@@@Z @ 0x1403252DC
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( v12 )
      {
        v20 = *(_DWORD *)(v12 + 4);
        if ( (v20 & 0x200B) != 0 )
          DXGDEVICE::TestAndSetDisplayedPrimary(this, (v20 >> 6) & 0xF, v8, v6);
      }
      v13 = *((_QWORD *)v10 + 6);
      if ( v13 )
      {
  ...
  if ( a2 )
  {
    if ( (*((_DWORD *)a2 + 1) & 1) != 0 )
    {
      ...
      if ( v29 )
      {
        if ( *(struct _KTHREAD ***)(v29 + 80) == this && (*(_DWORD *)(v29 + 72))-- == 1 )
        {
...
LABEL_58:
        if ( !a2 )
        {
          ...
          DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pResource", 748LL, 0LL, 0LL, 0LL, 0LL);
        }
        if ( (*((_DWORD *)a2 + 1) & 1) == 0 )
        {
          WdLogSingleEntry0(1LL);
