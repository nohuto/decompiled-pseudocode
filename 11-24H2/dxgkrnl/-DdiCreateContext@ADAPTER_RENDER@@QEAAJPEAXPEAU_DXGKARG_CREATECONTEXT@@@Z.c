/*
 * XREFs of ?DdiCreateContext@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_CREATECONTEXT@@@Z @ 0x1403A1FF4
 * Callers:
 *     ADAPTER_RENDER_DdiCreateContext @ 0x14006BBE0 (ADAPTER_RENDER_DdiCreateContext.c)
