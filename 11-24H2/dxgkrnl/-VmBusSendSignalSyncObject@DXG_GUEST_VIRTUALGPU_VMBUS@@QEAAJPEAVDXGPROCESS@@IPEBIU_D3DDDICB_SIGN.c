/*
 * XREFs of ?VmBusSendSignalSyncObject@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IPEBIU_D3DDDICB_SIGNALFLAGS@@K1PEB_K_KPEBQEAX_N6PEAVDXGDEVICE@@@Z @ 0x14022E4C8
 * Callers:
...
LABEL_93:
  ...
  if ( !(_QWORD)v71 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, L"Failed to allocate memory", 9279LL, 0LL, 0LL, 0LL, 0LL);
...
LABEL_39:
    DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v33, v32, 0LL, 0LL, 0LL, 0LL);
    v26 = -1073741811;
    goto LABEL_40;
  }
LABEL_22:
