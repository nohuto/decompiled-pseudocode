/*
 * XREFs of ?DxgkpBlitA8R8R8G8@@YAJPEAEJJJW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@0JPEBUtagRECT@@PEAU2@3@Z @ 0x140379D94
 * Callers:
 ...
 *     ?DxgkpGetBilinearLineFromSource@@YAXPEAEJJPEAU_PIXEL@@PEAU_UFIXPOINT_PIXEL@@JJJ@Z @ 0x14037ABA0 (-DxgkpGetBilinearLineFromSource@@YAXPEAEJJPEAU_PIXEL@@PEAU_UFIXPOINT_PIXEL@@JJJ@Z.c)
 */
...
LABEL_8:
  ...
  if ( !is_mul_ok(2 * v32 + 2, 0x10uLL) )
    v33 = -1LL;
  v34 = operator new[](v33, 0x4B677844u, 256LL);
  v35 = 0;
