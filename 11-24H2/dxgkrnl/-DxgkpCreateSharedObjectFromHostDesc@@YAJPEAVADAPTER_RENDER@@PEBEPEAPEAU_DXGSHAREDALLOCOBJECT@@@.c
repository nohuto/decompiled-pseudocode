/*
 * XREFs of ?DxgkpCreateSharedObjectFromHostDesc@@YAJPEAVADAPTER_RENDER@@PEBEPEAPEAU_DXGSHAREDALLOCOBJECT@@@Z @ 0x14021C218
 * Callers:
        ...
        struct _LIST_ENTRY **a3)
{
  ...
  if ( !SharedResource )
  {
    ...
    WdLogGlobalForLineNumber = 14592;
...
LABEL_41:
  ...
  if ( v11 > 1 )
  {
    ...
    if ( !is_mul_ok(v15, 8uLL) )
      v14 = -1LL;
    v16 = operator new[](v14, 0x4B677844u, 256LL);
    if ( !v16 )
    {
...
LABEL_12:
      ...
      DxgkLogInternalTriageEvent(0LL, 262145LL, 0xFFFFFFFFLL, v20, v19, 0LL, 0LL, 0LL, 0LL);
      v4 = v44;
      v6 = -1073741801;
      goto LABEL_41;
    }
...
LABEL_34:
    if ( *((_DWORD *)v5 + 15) )
    {
      ...
      if ( v40 < 0 )
      {
        ...
        v4 = v45;
        WdLogGlobalForLineNumber = 14734;
        goto LABEL_41;
      }
      v4 = v45;
    }
    ...
    WdLogGlobalForLineNumber = 14764;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
  ...
  v38 = v46;
  v4 = v44;
  WdLogGlobalForLineNumber = 14705;
LABEL_42:
  if ( v43 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 14784;
    DxgkLogInternalTriageEvent(
      0LL,
      262146LL,
      0xFFFFFFFFLL,
      L"pSharedAllocObject == nullptr",
      14784LL,
      0LL,
      0LL,
      0LL,
  ...
  if ( v38 )
  {
    v41 = (PERESOURCE *)DXGGLOBAL::GetGlobal();
    DXGGLOBAL::DestroySyncObject(v41, v38, 0, 0);
  }
LABEL_51:
  *a3 = v43;
