/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x14026CF14
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x140268C70 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 ...
 *     ?QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z @ 0x1403C3E14 (-QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z.c)
 *     ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1403DDC78 (-TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ.c)
  ...
  *(_QWORD *)&v36[1] = this;
  ...
  while ( v7 < v6[16] )
  {
    ...
    if ( (*(_QWORD *)v16 & 0x800000000000LL) != 0
      ...
      && (v27 & 0x200) != 0 )
    {
      *((_DWORD *)DXGGLOBAL::GetGlobal() + 339) = *(_DWORD *)(v16 + 132);
    }
    ++v7;
  }
  if ( Handle )
