/*
 * XREFs of ?CompleteFlipManagerToken@CTokenManager@@IEAAXPEAUFlipManagerTokenObject@@PEA_N@Z @ 0x14005E9A4
 * Callers:
...
LABEL_21:
      ...
      PreviousState = 0LL;
      v29 = 0LL;
      FlipManagerConsumerImmediateTokenCompleted(v6, &PreviousState, &v29);
      if ( !PreviousState )
        goto LABEL_21;
      v15 = (struct CToken *)((char *)PreviousState + 8);
      v16 = (CTokenManager **)*((_QWORD *)this + 39);
      if ( *v16 == (CTokenManager *)((char *)this + 304) )
      {
        *(_QWORD *)v15 = (char *)this + 304;
        *((_QWORD *)v15 + 1) = v16;
        *v16 = v15;
        *((_QWORD *)this + 39) = v15;
        v17 = v29 ? (char *)v29 + 8 : 0LL;
        v18 = (char **)*((_QWORD *)this + 41);
        if ( *v18 == (char *)this + 320 )
        {
          *((_QWORD *)v17 + 1) = v18;
          *(_QWORD *)v17 = (char *)this + 320;
          *v18 = v17;
          *((_QWORD *)this + 41) = v17;
