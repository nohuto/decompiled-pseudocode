/*
 * XREFs of ?CreateFlipToken@CToken@@CAJ_KPEAVCompositionSurfaceObject@@AEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@PEAPEAV1@@Z @ 0x14001D79C
 * Callers:
        ...
        struct CToken **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v4 == 0x2000 )
  {
    ...
    if ( *((_DWORD *)this + 44) )
    {
      for ( i = (struct CompositionSurfaceObject *)*((_QWORD *)this + 20);
            i != (struct CompositionSurfaceObject *)((char *)this + 160);
...
LABEL_7:
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(v14 + 581) = 256;
    ...
    if ( *(_DWORD *)(v16 + 176) )
    {
      for ( j = *(__int64 **)(v16 + 160); j != (__int64 *)(v16 + 160); j = (__int64 *)*j )
      {
        if ( *(j - 1) == v22 )
        {
          v19 = *((_BYTE *)j + 17);
