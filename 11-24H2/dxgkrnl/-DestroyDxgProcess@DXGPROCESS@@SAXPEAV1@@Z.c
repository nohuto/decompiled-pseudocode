/*
 * XREFs of ?DestroyDxgProcess@DXGPROCESS@@SAXPEAV1@@Z @ 0x14034D1D8
 * Callers:
 ...
 *     ?RemoveProcess@DXGGLOBAL@@QEAAXPEAVDXGPROCESS@@@Z @ 0x140048CA8 (-RemoveProcess@DXGGLOBAL@@QEAAXPEAVDXGPROCESS@@@Z.c)
