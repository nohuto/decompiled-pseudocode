/*
 * XREFs of ?DestroyAllDeviceState@DXGDEVICE@@QEAAXPEAVCOREDEVICEACCESS@@@Z @ 0x1403A7C64
 * Callers:
...
void __fastcall DXGDEVICE::DestroyAllDeviceState(DXGDEVICE *this, PERESOURCE **a2)
{
  ...
  *((_QWORD *)this + 55) = 0LL;
  ...
  {
    OutputDuplProcessDestroyDevice(*((struct DXGADAPTER **)this + 237), this);
    DXGDEVICE::FlushDeferredDestruction(this, 0LL, 1u, 0);
    if ( *((_QWORD *)this + 100) )
    {
  ...
  v11 = (DXGADAPTER *)*((_QWORD *)this + 237);
  if ( v11 )
  {
