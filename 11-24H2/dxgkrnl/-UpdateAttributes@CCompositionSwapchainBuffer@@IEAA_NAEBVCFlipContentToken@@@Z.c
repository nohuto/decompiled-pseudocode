/*
 * XREFs of ?UpdateAttributes@CCompositionSwapchainBuffer@@IEAA_NAEBVCFlipContentToken@@@Z @ 0x140031E3C
 * Callers:
 ...
 *     ?HasMargins@LetterboxingMargins@PresentedContentUpdateInfo@@QEBA_NXZ @ 0x14003215C (-HasMargins@LetterboxingMargins@PresentedContentUpdateInfo@@QEBA_NXZ.c)
 */
