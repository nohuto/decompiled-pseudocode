/*
 * XREFs of ?_CheckResolvedTopologyForVirtualModeConsistency@CCD_TOPOLOGY@@AEAAJXZ @ 0x1403CF51C
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  const struct D3DKMT_PATHMODALITY_DESCRIPTOR *v12; // r14
  __int64 v13; // rbp
  unsigned int j; // edi
  __int64 v15; // rax
  ...
  for ( k = 0; ; ++k )
  {
    ...
    if ( !*((_BYTE *)v9 + 129) )
    {
      ...
      {
        if ( (a2 & 0x200) == 0 || ((*((_DWORD *)v9 + 33) - 2) & 0xFFFFFFFD) != 0 )
        {
          v21 = *((_DWORD *)v9 + 38);
          if ( *((_DWORD *)v9 + 24) != v21 || *((_DWORD *)v9 + 25) != *((_DWORD *)v9 + 39) )
          {
            v22 = *((_DWORD *)v9 + 39);
        ...
        {
          v19 = *((_DWORD *)v9 + 39);
          if ( *((_DWORD *)v9 + 24) != v19 || *((_DWORD *)v9 + 25) != *((_DWORD *)v9 + 38) )
          {
            v20 = *((_DWORD *)v9 + 38);
            *((_QWORD *)v10 + 1) &= 0xFFFFFFFFFF7DFF78uLL;
