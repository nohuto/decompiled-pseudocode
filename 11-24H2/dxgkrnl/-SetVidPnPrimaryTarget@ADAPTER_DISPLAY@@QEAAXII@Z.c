/*
 * XREFs of ?SetVidPnPrimaryTarget@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x140051E78
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::SetVidPnPrimaryTarget(ADAPTER_DISPLAY *this, unsigned int a2, int a3)
{
  ...
  *(_DWORD *)(v4 + v5 + 1072) = a3;
  if ( a3 == -1 )
  {
    ...
    v10 = v8;
    v9[1] = &v11;
    HOSTVMMONITORMAPPING::RemoveMappingInternal__lambda_96e157b43079a313af61cac4d916eb85___((char *)Global + 305312, v9);
  }
}
