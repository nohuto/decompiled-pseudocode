/*
 * XREFs of DpiGetMonitorDescriptor @ 0x1403E5EA8
 * Callers:
 *     ?GetMonitorDescriptor@KernelDriver@@UEBAJKKPEAX@Z @ 0x1403E5E60 (-GetMonitorDescriptor@KernelDriver@@UEBAJKKPEAX@Z.c)
 * Callees:
