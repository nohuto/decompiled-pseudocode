/*
 * XREFs of ?VidSchSetMonitorPowerState@VIDSCH_EXPORT@@QEAAJPEAU_VIDSCH_GLOBAL@@IEQEBU_DXGK_DISPLAYMODE_INFO@@PEAT_DXGK_MONITORLINKINFO_CAPABILITIES@@@Z @ 0x140054E24
 * Callers:
