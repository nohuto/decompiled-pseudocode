/*
 * XREFs of ?CreatePeriodicFrameNotification@DXGSYNCOBJECT@@QEAAJPEAVDXGADAPTER@@00_KI@Z @ 0x1403E31A4
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (*((_DWORD *)a4 + 111) & 0x100) != 0 )
  {
    if ( !a2 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"pSyncAdapter != nullptr", 2172LL, 0LL, 0LL, 0LL, 0LL);
    }
