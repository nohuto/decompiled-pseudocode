/*
 * XREFs of ?DxgkCddOpenResource@@YAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x140353EC0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( (unsigned int)v19 < *((_DWORD *)v11 + 74) )
    {
        ...
        && (v21 & 0x1F) != 0 )
      {
        ...
        {
          v22 = *((_QWORD *)v20 + 2 * (((unsigned __int64)hAllocation >> 6) & 0xFFFFFF));
          goto LABEL_14;
        }
