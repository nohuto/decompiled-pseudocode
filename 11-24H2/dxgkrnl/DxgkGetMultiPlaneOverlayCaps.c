/*
 * XREFs of DxgkGetMultiPlaneOverlayCaps @ 0x1403728C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetMultiPlaneOverlayCaps(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)&v38[0].0 = 0LL;
  ...
  if ( Current )
  {
    ...
    if ( v33 )
    {
      ...
      if ( PairingAdapters < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12067;
      ...
      else
      {
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 12075;
          DxgkLogInternalTriageEvent(
            0LL,
            262146LL,
            0xFFFFFFFFLL,
        ...
        if ( v11 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 12095;
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 12025;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
