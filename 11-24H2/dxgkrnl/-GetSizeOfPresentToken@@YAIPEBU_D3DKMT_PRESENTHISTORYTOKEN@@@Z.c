/*
 * XREFs of ?GetSizeOfPresentToken@@YAIPEBU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x140336D50
 * Callers:
...
__int64 __fastcall GetSizeOfPresentToken(const struct _D3DKMT_PRESENTHISTORYTOKEN *a1)
{
  ...
  if ( a1->Model == D3DKMT_PM_REDIRECTED_FLIP )
  {
    ...
    if ( PlaneIndex > 0x10 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"FALSE", 63LL, 0LL, 0LL, 0LL, 0LL);
      return 0LL;
    }
    else
    {
    ...
    switch ( a1->Model )
    {
      case D3DKMT_PM_REDIRECTED_GDI:
        ...
        if ( (unsigned int)FlipInterval > 0x10 )
        {
          ...
          DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"FALSE", 53LL, 0LL, 0LL, 0LL, 0LL);
          return 0LL;
        }
      ...
      case D3DKMT_PM_REDIRECTED_BLT:
        ...
        if ( VidPnSourceId > 0x10 )
        {
          ...
          DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"FALSE", 73LL, 0LL, 0LL, 0LL, 0LL);
          return 0LL;
        }
