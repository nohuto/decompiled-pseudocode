/*
 * XREFs of ?FindByValue@?$Set@VDXGTARGETENTRY@@@@QEBAPEAVDXGTARGETENTRY@@QEBV2@@Z @ 0x1400504B4
 * Callers:
 ...
 * Callees:
 *     ??9DXGTARGETENTRY@@QEBA_NAEBV0@@Z @ 0x1403C04E0 (--9DXGTARGETENTRY@@QEBA_NAEBV0@@Z.c)
 */
