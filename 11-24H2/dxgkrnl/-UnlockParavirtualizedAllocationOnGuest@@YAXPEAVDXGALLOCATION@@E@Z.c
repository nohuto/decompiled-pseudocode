/*
 * XREFs of ?UnlockParavirtualizedAllocationOnGuest@@YAXPEAVDXGALLOCATION@@E@Z @ 0x1401B1E58
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( a2 )
    {
      if ( *((_DWORD *)a1 + 31) )
      {
        ...
        DXG_GUEST_GLOBAL_VMBUS::DeleteGpadl(*((DXG_GUEST_GLOBAL_VMBUS **)Global + 210), *((_DWORD *)a1 + 31));
        *((_DWORD *)a1 + 31) = 0;
      }
      v8 = *((_BYTE *)a1 + 128);
      if ( (v8 & 1) != 0 )
