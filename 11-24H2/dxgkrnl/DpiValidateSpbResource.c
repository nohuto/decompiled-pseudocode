/*
 * XREFs of DpiValidateSpbResource @ 0x140253424
 * Callers:
 *     DpSpbResourceIoControl @ 0x14018CD90 (DpSpbResourceIoControl.c)
 *     DpCloseSpbResource @ 0x140252FF0 (DpCloseSpbResource.c)
 *     DpReadSpbResource @ 0x140253050 (DpReadSpbResource.c)
 *     DpWriteSpbResource @ 0x140253200 (DpWriteSpbResource.c)
 * Callees:
 *     <none>
 */
