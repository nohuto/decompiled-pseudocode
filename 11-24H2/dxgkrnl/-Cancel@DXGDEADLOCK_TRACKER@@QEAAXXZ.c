/*
 * XREFs of ?Cancel@DXGDEADLOCK_TRACKER@@QEAAXXZ @ 0x1403B0C10
 * Callers:
 *     ??1DXGDEADLOCK_TRACKER@@QEAA@XZ @ 0x1402AC388 (--1DXGDEADLOCK_TRACKER@@QEAA@XZ.c)
 *     ?StopDeadlockTrackers@DXGADAPTER@@QEAAXXZ @ 0x1403A9AF4 (-StopDeadlockTrackers@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
...
void __fastcall DXGDEADLOCK_TRACKER::Cancel(DXGDEADLOCK_TRACKER *this)
{
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)this + 9, 0, 1) == 1 )
  {
    ...
    v24 = *(_QWORD *)(*((_QWORD *)this + 3) + 412LL);
    ...
    if ( (*((_BYTE *)this + 32) || *((_BYTE *)this + 33)) && (unsigned int)dword_14015E650 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_14015E650, 0x400000004000LL) )
      {
        ...
        v10 = *(_DWORD *)(v6 + 3216);
        v11 = *(unsigned __int8 *)(v6 + 3053);
        v12 = *((unsigned __int8 *)this + 33);
        v13 = *(_DWORD *)(v6 + 4920);
        v14 = *(_DWORD *)(v6 + 4916);
        v25 = v7;
        v15 = *(unsigned __int8 *)(v6 + 209);
        v16 = *(unsigned __int8 *)(v6 + 2948);
        v17 = *(unsigned __int8 *)(v6 + 2943);
        v18 = *(_DWORD *)(v6 + 296);
        v31 = *(_WORD *)(v6 + 3004);
        v26 = *(_QWORD *)(v6 + 2008);
        v27 = *(void **)(v6 + 2000);
