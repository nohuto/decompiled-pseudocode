/*
 * XREFs of ?Serialize@DMMVIDPNTARGETMODESET@@QEBAJQEAV?$AutoBuffer@U_DMM_VIDPNTARGETMODESET_SERIALIZATION@@@DMM@@@Z @ 0x140266DA0
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_BYTE *)a2[4] = *((_BYTE *)this + 64);
      v10 = (DMMVIDPNTARGETMODESET *)*((_QWORD *)this + 6);
      if ( v10 != (DMMVIDPNTARGETMODESET *)((char *)this + 48) )
      {
        for ( i = (DMMVIDPNTARGETMODESET *)((char *)v10 - 8); i; i = DMMVIDPNTARGETMODESET::GetNextMode(this, i) )
        {
          v12 = a2[4];
          v13 = 10LL * v9;
