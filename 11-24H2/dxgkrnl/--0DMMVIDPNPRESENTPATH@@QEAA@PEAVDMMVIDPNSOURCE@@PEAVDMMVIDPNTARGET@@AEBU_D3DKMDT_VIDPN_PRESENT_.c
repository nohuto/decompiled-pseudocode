/*
 * XREFs of ??0DMMVIDPNPRESENTPATH@@QEAA@PEAVDMMVIDPNSOURCE@@PEAVDMMVIDPNTARGET@@AEBU_D3DKMDT_VIDPN_PRESENT_PATH@@@Z @ 0x14008FA54
 * Callers:
 ...
 *     ?SetImportanceOrdinal@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z @ 0x140048C18 (-SetImportanceOrdinal@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z.c)
 *     ?SetCopyProtectionScheme@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_TYPE@@@Z @ 0x14005BB3C (-SetCopyProtectionScheme@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_.c)
 *     ?SetContentType@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_CONTENT@@@Z @ 0x14008F120 (-SetContentType@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_CONTENT@@@Z.c)
        ...
        const struct _D3DKMDT_VIDPN_PRESENT_PATH *a4)
{
  ...
  *(D3DKMDT_COLOR_COEFF_DYNAMIC_RANGES *)((char *)this + 148) = a4->VidPnTargetColorCoeffDynamicRanges;
  if ( IsValidGammaRamp(&a4->GammaRamp) && a4->GammaRamp.Type != D3DDDI_GAMMARAMP_DEFAULT )
  {
    ...
    *(_QWORD *)(v8 + 24) = 0LL;
    *(_QWORD *)(v8 + 32) = 0LL;
    *(_QWORD *)v8 = &rc_buffer<DispBroker::AlpcRequest<7>>::`vftable';
    ...
    *((_DWORD *)this + 44) = a4->CopyProtection.APSTriggerBits;
    ...
    if ( v19 >= 0 )
    {
      ...
      if ( Scaling == D3DKMDT_VPPS_UNPINNED
        || (v26 = DMMVIDPNPRESENTPATH::PinContentScaling(this, Scaling), v18 = v26, v26 >= 0) )
      {
        Rotation = a4->ContentTransformation.Rotation;
        if ( Rotation == D3DKMDT_VPPR_UNPINNED
          || (v33 = DMMVIDPNPRESENTPATH::PinContentRotation(this, Rotation), v18 = v33, v33 >= 0) )
        {
          v39 = DMMVIDPNPRESENTPATH::SetImportanceOrdinal(this, a4->ImportanceOrdinal);
          v18 = v39;
          if ( v39 >= 0 )
          {
          ...
          v44[3] = a4->ImportanceOrdinal;
          v44[4] = *((unsigned int *)a2 + 6);
          v44[5] = *((unsigned int *)a3 + 6);
          v44[6] = v18;
        ...
        else
        {
          ...
          v38[3] = a4->ContentTransformation.Rotation;
          v38[4] = *((unsigned int *)a2 + 6);
          v38[5] = *((unsigned int *)a3 + 6);
          v38[6] = v18;
      ...
      else
      {
        ...
        v31[3] = a4->ContentTransformation.Scaling;
        v31[4] = *((unsigned int *)a2 + 6);
        v31[5] = *((unsigned int *)a3 + 6);
        v31[6] = v18;
