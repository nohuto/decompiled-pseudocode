/*
 * XREFs of ?ReportMuxGpuChild@DISPLAY_MUX_PAIRING@@QEAAJPEBU_DISPLAYCONFIG_DISPLAYMUX_ADAPTER_SUPPORT@@W4MUX_GPU_TYPE@@@Z @ 0x140087884
 * Callers:
...
LABEL_12:
  ...
  *((_DWORD *)v18 + 24) = *((_DWORD *)a2 + 24);
  v20 = DISPLAY_MUX_PAIRING::CheckForNewMuxPairing((DISPLAY_MUX_PAIRING *)a1);
  v8 = v20;
  if ( v20 >= 0 )
  {
