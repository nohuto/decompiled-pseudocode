/*
 * XREFs of ?CapturePresentMultiPlaneOverlayArgs@@YAJPEBUD3DKMT_PRESENT_MULTIPLANE_OVERLAY@@PEAU1@PEAPEAUD3DKMT_MULTIPLANE_OVERLAY@@PEAPEAUtagRECT@@@Z @ 0x1401DE7C4
 * Callers:
        ...
        struct tagRECT **a4)
{
  ...
  if ( (unsigned int)(LODWORD(v24[35]) - 1) > 6 )
  {
    CurrentProcess = PsGetCurrentProcess(LODWORD(v24[35]));
    v16 = -1073741811;
    WdLogSingleEntry3(2LL, LODWORD(v24[35]), -1073741811LL, CurrentProcess);
  ...
  v23[1] = 0LL;
  v12 = 120LL * LODWORD(v24[35]);
  if ( !is_mul_ok(LODWORD(v24[35]), 0x78uLL) )
    v12 = -1LL;
  v14 = (struct D3DKMT_MULTIPLANE_OVERLAY *)operator new[](v12, 0x4B677844u, 256LL);
  v23[0] = v14;
  if ( !v14 )
  {
  ...
  do
  {
    *(_OWORD *)&a2->hDevice = *(_OWORD *)v18;
    *(_OWORD *)&a2->BroadcastContext[2] = *((_OWORD *)v18 + 1);
    *(_OWORD *)&a2->BroadcastContext[6] = *((_OWORD *)v18 + 2);
    *(_OWORD *)&a2->BroadcastContext[10] = *((_OWORD *)v18 + 3);
    *(_OWORD *)&a2->BroadcastContext[14] = *((_OWORD *)v18 + 4);
    *(_OWORD *)&a2->BroadcastContext[18] = *((_OWORD *)v18 + 5);
    *(_OWORD *)&a2->BroadcastContext[22] = *((_OWORD *)v18 + 6);
