/*
 * XREFs of DxgkUpdateCddDevmodeExtraData @ 0x1403FEE20
 * Callers:
 *     <none>
 * Callees:
 *     ?GetD3dFormatFromGdiBitsPerPixel@@YA?AW4_D3DDDIFORMAT@@K@Z @ 0x14025A9E0 (-GetD3dFormatFromGdiBitsPerPixel@@YA-AW4_D3DDDIFORMAT@@K@Z.c)
