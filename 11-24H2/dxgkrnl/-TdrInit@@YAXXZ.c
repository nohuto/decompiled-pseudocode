/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1401CFC24
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_140160A0C != v8 )
  {
    WdLogSingleEntry2(3LL, v8, (unsigned int)dword_140160A0C);
  ...
  if ( dword_140160A10 != v9 )
  {
    WdLogSingleEntry2(3LL, v9, (unsigned int)dword_140160A10);
  ...
  if ( dword_140160A14 != v10 )
  {
    WdLogSingleEntry2(3LL, v10, (unsigned int)dword_140160A14);
  ...
  if ( dword_140160A18 != v11 )
  {
    WdLogSingleEntry2(3LL, v11, (unsigned int)dword_140160A18);
  ...
  if ( dword_140160A20 != v14 )
  {
    WdLogSingleEntry2(3LL, v14, (unsigned int)dword_140160A20);
  ...
  {
    dword_140160A24 = 3600;
  }
  if ( dword_140160A24 != v15 )
  {
    WdLogSingleEntry2(3LL, v15, (unsigned int)dword_140160A24);
    WdLogGlobalForLineNumber = 2412;
  }
  LOBYTE(v7) = 1;
  byte_140160A1C = (unsigned __int8)WdIsDebuggerPresent(v7) != 0;
  if ( v12 < 2 || v12 - 2 < 2 )
    g_TdrDebugMode = v12;
  else
    g_TdrDebugMode = 2;
