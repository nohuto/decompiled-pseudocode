/*
 * XREFs of ?PresentMultiPlaneOverlay3@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEAVCOREDEVICEACCESS@@PEAPEAV1@@Z @ 0x1402C0D9C
 * Callers:
 ...
 *     ?ConvertMPOThunkToLegacyPresentThunk@@YAXAEAU_D3DKMT_PRESENT@@AEAU_D3DKMT_PRESENT_RGNS@@PEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEBU_D3DKMT_MULTIPLANE_OVERLAY3@@@Z @ 0x1403F2768 (-ConvertMPOThunkToLegacyPresentThunk@@YAXAEAU_D3DKMT_PRESENT@@AEAU_D3DKMT_PRESENT_RGNS@@PEBU_D3D.c)
 *     InverseXformMPORect3 @ 0x1403FDB08 (InverseXformMPORect3.c)
        ...
        struct DXGCONTEXT **a4)
{
  ...
  struct _DXGKARG_PRESENT v202; // [rsp+230h] [rbp+E0h] BYREF
...
LABEL_185:
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v110, v109, 0LL, 0LL, 0LL, 0LL);
      return -1073741811LL;
    }
    if ( (*(_BYTE *)&Value & 6) == 6 )
    {
...
LABEL_200:
            ...
            DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v120, v119, 0LL, 0LL, 0LL, 0LL);
...
LABEL_37:
  ...
  v28 = *((_QWORD *)this + 2);
  v194 = *(_QWORD *)v200[0];
  ADAPTER_DISPLAY::GetDDIEnabledPlanes(*(ADAPTER_DISPLAY **)(*(_QWORD *)(v28 + 1896) + 3120LL), VidPnSourceId, v207);
  v206 = 0LL;
  v29 = *((_QWORD *)this + 2);
  *(_OWORD *)v204 = 0LL;
  v205 = 0LL;
...
LABEL_305:
      ...
      *((_DWORD *)v38 + 30) = 5;
      ...
      v52 = *((_QWORD *)this + 2);
      if ( *((_BYTE *)Global + 304880)
        || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v52 + 1896) + 3120LL) + 24LL) & 0x10) != 0 )
      {
        if ( ADAPTER_DISPLAY::IsHdrEnabled(*(ADAPTER_DISPLAY **)(*(_QWORD *)(v52 + 1896) + 3120LL), v174) )
        {
            ...
            if ( HDRMetaDataType )
            {
              ...
              if ( v145 )
              {
                ...
                else
                {
                  ...
                  DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"FALSE", 4010LL, 0LL, 0LL, 0LL, 0LL);
      ...
      if ( v54 != *(_QWORD *)(*(_QWORD *)(v53 + 16) + 16LL) )
      {
        ...
        v25 = 0;
        v26 = 0;
        v27 = *(struct ADAPTER_DISPLAY **)(*(_QWORD *)(*((_QWORD *)this + 2) + 1896LL) + 3120LL);
        goto LABEL_26;
      }
      v20 = *(_DWORD *)(v53 + 4LL * v174 + 1832);
...
LABEL_18:
        ...
        if ( v21 >= 0 )
        {
          ...
          if ( v23 >= 0 )
          {
            ...
            if ( (int)v18 < 0 )
              goto LABEL_27;
            if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 1896LL) + 3120LL) + 128LL)
                           + 4024LL * v174
                           + 1072) == -1 )
            {
              WdLogSingleEntry0(1LL);
            ...
            v25 = v168;
            v26 = v159;
            *(_DWORD *)(*((_QWORD *)this + 2) + 4LL * v174 + 1832) = *((_DWORD *)v38 + 30);
            v27 = *(struct ADAPTER_DISPLAY **)(*(_QWORD *)(*((_QWORD *)this + 2) + 1896LL) + 3120LL);
LABEL_26:
...
LABEL_102:
    ...
    v74 = ADAPTER_RENDER::DdiDescribeAllocation(*(ADAPTER_RENDER **)(v73 + 16), &v198);
    v18 = v74;
    if ( v74 < 0 )
    {
      _mm_lfence();
...
LABEL_136:
    if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 2) + 1896LL) + 3018LL) )
    {
...
LABEL_174:
          ...
          v151 = i;
LABEL_167:
          DxgkLogInternalTriageEvent(0LL, 0x40000LL, 0xFFFFFFFFLL, v106, v18, (__int64)this, v151, v152, v153);
          goto LABEL_31;
        }
    ...
    if ( !v161 )
    {
      ...
      if ( (pPlaneAttributes->DstRect.right - pPlaneAttributes->DstRect.left != v93
        ...
        && *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 2) + 1896LL) + 2970LL) )
      {
