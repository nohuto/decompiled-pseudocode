/*
 * XREFs of ?WriteVirtualFunctionConfig@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIG@@@Z @ 0x14020F6F8
 * Callers:
 *     DxgkDdiWriteVirtualFunctionConfig @ 0x140211278 (DxgkDdiWriteVirtualFunctionConfig.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfig(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v4; // ebx
  ...
  {
    v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)VirtualGpuByIndex + 56LL))(VirtualGpuByIndex, a3);
  }
  else
  {
