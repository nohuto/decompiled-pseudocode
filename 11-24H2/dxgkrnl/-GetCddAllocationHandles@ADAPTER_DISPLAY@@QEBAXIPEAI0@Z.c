/*
 * XREFs of ?GetCddAllocationHandles@ADAPTER_DISPLAY@@QEBAXIPEAI0@Z @ 0x140199078
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146LL, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 1513LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( ADAPTER_DISPLAY::IsCddPrimaryStale(this, v5)
    || (v9 = *((_QWORD *)this + 16), (v10 = *(_QWORD *)(4024 * v5 + v9 + 88)) == 0)
  ...
  {
    v4 = *(_DWORD *)(*(_QWORD *)(4024 * v5 + v9 + 600) + 16LL);
    v11 = *(_DWORD *)(v10 + 16);
  }
  *a3 = v11;
  *a4 = v4;
