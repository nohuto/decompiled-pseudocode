/*
 * XREFs of DxgkDisplayOnOff @ 0x140345280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkDisplayOnOff(struct _LUID *a1, unsigned int a2, char a3, unsigned __int8 a4)
{
  ...
  DXGSESSIONDATA **v64; // [rsp+90h] [rbp-70h]
  ...
  if ( !SessionData )
  {
    ...
    WdLogGlobalForLineNumber = 10716;
...
LABEL_34:
  ...
  if ( v21 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 10759;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000LL,
      0xFFFFFFFFLL,
  ...
  while ( 1 )
  {
    ...
    if ( CddDeviceAndContextForCurrentSession < 0 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0LL,
        0LL);
      v38 = (DXGSESSIONDATA **)*((_QWORD *)PrimaryDisplaySource + 7);
      v27 = v64;
      PrimaryDisplaySource = 0LL;
      if ( v38 != v64 + 6 )
        PrimaryDisplaySource = (struct DISPLAY_SOURCE *)(v38 - 7);
      goto LABEL_65;
    }
...
LABEL_61:
  ...
  v46 = (DXGSESSIONDATA **)*((_QWORD *)PrimaryDisplaySource + 7);
  if ( v46 != v27 + 6 )
  {
