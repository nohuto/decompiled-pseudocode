/*
 * XREFs of CommonBuffer_WdfEvtCleanupCallback @ 0x14003F390
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_q @ 0x14002C6F8 (WPP_RECORDER_SF_q.c)
 *     XilCoreCommonBuffer_Cleanup @ 0x1400563B4 (XilCoreCommonBuffer_Cleanup.c)
...
__int64 __fastcall CommonBuffer_WdfEvtCleanupCallback(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 5;
    WPP_RECORDER_SF_q(*(_QWORD *)(*v3 + 72LL), v2, 8, 13, (__int64)&WPP_6a5376b16cbf3dbdeb6b8133660a6549_Traceguids, v1);
  }
