/*
 * XREFs of WPP_RECORDER_SF_qDD @ 0x140018934
 * Callers:
 *     XilCoreCommonBuffer_AcquireBuffersWithSegmenter @ 0x140016B14 (XilCoreCommonBuffer_AcquireBuffersWithSegmenter.c)
  ...
  if ( _bittest(&v10, ((_BYTE)a3 - 1) & 0x1F) && *((_BYTE *)&WPP_GLOBAL_Control->Timer + 80 * v7 + 1) >= a2 )
    ((void (__fastcall *)(_QWORD, __int64, __int64, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      *((_QWORD *)&WPP_GLOBAL_Control->AttachedDevice + 10 * v7),
      ...
      0LL);
  LOWORD(v12) = a4;
  return WppAutoLogTrace(a1, v8, a3, a5, v12, (__int64 *)va, 8LL, (__int64 *)va1, 4LL, va2, 4LL, 0LL);
}
