/*
 * XREFs of DriverEntry @ 0x14007A810
 * Callers:
 *     FxDriverEntryWorker @ 0x140055B64 (FxDriverEntryWorker.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1400467EC (McGenEventRegister_EtwRegister.c)
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x140056BA0 (InitializeTelemetryAssertsKMByDriverObject.c)
 ...
 *     Counter_Register @ 0x14007F23C (Counter_Register.c)
