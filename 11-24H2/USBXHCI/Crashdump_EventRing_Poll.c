/*
 * XREFs of Crashdump_EventRing_Poll @ 0x140052254
 * Callers:
 ...
 *     Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x14005346C (Crashdump_Endpoint_SendTransferAndPollForCompletion.c)
 * Callees:
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x14005274C (Crashdump_EventRing_UpdateDequeuePointer.c)
