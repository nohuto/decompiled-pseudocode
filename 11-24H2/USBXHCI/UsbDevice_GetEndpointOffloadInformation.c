/*
 * XREFs of UsbDevice_GetEndpointOffloadInformation @ 0x14003A27C
 * Callers:
...
__int64 __fastcall UsbDevice_GetEndpointOffloadInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1036LL) == 1 )
    {
      ...
      {
        if ( *(_DWORD *)(*(_QWORD *)result + 1036LL) == 2 )
          Debug_FreAssertMsg(
    ...
    DeviceContextBufferVA = XilCoreUsbDevice_GetDeviceContextBufferVA(a1 + (*(_BYTE *)(a1 + 665) != 0 ? 624LL : 616LL));
    v14 = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1036LL);
    *(_DWORD *)(a3 + 10) = v14;
    ...
    *(_BYTE *)(a3 + 19) = *(_BYTE *)(a1 + 143);
    v16 = *(_DWORD *)(a3 + 18) ^ (*(_DWORD *)(a3 + 18) ^ (*(_DWORD *)DeviceContextBufferVA >> 9)) & 0x10000;
    *(_DWORD *)(a3 + 18) = v16;
    result = v16 ^ (v16 ^ (*(unsigned __int8 *)(a1 + 145) << 17)) & 0x20000u;
    *(_DWORD *)(a3 + 18) = result;
    if ( v14 == 1 )
    {
