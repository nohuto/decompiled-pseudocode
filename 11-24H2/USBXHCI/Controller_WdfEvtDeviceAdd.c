/*
 * XREFs of Controller_WdfEvtDeviceAdd @ 0x140079620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceAdd(__int64 a1, __int64 a2)
{
  ...
  v4 = ((__int64 (__fastcall *)(__int64, __int64))qword_14006BE08)(UcxDriverGlobals, a2);
  if ( v4 < 0 )
  {
...
LABEL_4:
        LOBYTE(v3) = 2;
        WPP_RECORDER_SF_d(v16, v3, 4, v5, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v4);
        goto LABEL_5;
      }
      goto LABEL_5;
    }
