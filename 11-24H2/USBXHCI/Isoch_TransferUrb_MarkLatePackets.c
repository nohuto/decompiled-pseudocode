/*
 * XREFs of Isoch_TransferUrb_MarkLatePackets @ 0x140023420
 * Callers:
...
__int64 __fastcall Isoch_TransferUrb_MarkLatePackets(__int64 a1, __int64 a2)
{
  ...
  {
    LOBYTE(v15) = 5;
    WPP_RECORDER_SF_d(*(_QWORD *)(v5 + 72), v15, 4, 185, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v14);
  }
  v16 = *(_DWORD *)(a1 + 364);
