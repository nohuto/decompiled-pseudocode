/*
 * XREFs of WerKernelSubmitReport @ 0x140057BDC
 * Callers:
 *     TelemetryData_SubmitReport @ 0x14007FA88 (TelemetryData_SubmitReport.c)
 * Callees:
 *     RtlStringCchCopyNW @ 0x14005789C (RtlStringCchCopyNW.c)
 *     WerStartSystemErrorHandler @ 0x14005817C (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1400582B4 (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x140058388 (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1400585E4 (WerpFreeMem.c)
 *     WerpGetRegistryKey @ 0x140058608 (WerpGetRegistryKey.c)
 *     WerpParseKeyName @ 0x140058724 (WerpParseKeyName.c)
