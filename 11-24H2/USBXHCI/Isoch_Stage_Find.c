/*
 * XREFs of Isoch_Stage_Find @ 0x140011B00
 * Callers:
...
__int64 __fastcall Isoch_Stage_Find(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  for ( i = *(__int64 **)(a1 + 392); ; i = (__int64 *)*i )
  {
    if ( v4 == i )
    {
      ...
      {
        v20 = *(_DWORD *)(a2 + 12);
        LODWORD(v23) = HIDWORD(*(_QWORD *)a3);
        LODWORD(v22) = HIWORD(v20) & 0x1F;
        LODWORD(v21) = HIBYTE(v20);
      ...
      if ( !v3 || v3 > *(_DWORD *)(v15 + 48) - 1 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          {
            ...
            LODWORD(v22) = HIWORD(*(_DWORD *)(a2 + 12)) & 0x1F;
            LODWORD(v21) = HIBYTE(*(_DWORD *)(a2 + 12));
            WPP_RECORDER_SF_DDDD(
              *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
              5u,
              0xEu,
