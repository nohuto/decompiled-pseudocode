/*
 * XREFs of Crashdump_Cleanup @ 0x14004FB90
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_SaveStateForHybridSleep @ 0x140051B8C (Crashdump_Register_SaveStateForHybridSleep.c)
 *     Crashdump_Register_StopController @ 0x140051D74 (Crashdump_Register_StopController.c)
 *     Crashdump_Command_Stop @ 0x140052A74 (Crashdump_Command_Stop.c)
 ...
 *     Crashdump_UsbDevice_SuspendPort @ 0x140054E60 (Crashdump_UsbDevice_SuspendPort.c)
 */
...
__int64 __fastcall Crashdump_Cleanup(__int64 a1)
{
  ...
  *v10 = *v10 & 0xE00C200 | 0x60;
  ...
  if ( v13 >= 0 && *(_BYTE *)(a1 + 625) )
  {
    ...
    *(_QWORD *)(v14 + 152) = *(_QWORD *)(a1 + 272);
    *(_DWORD *)(v14 + 128) = *(_DWORD *)(a1 + 280);
    *(_DWORD *)(v14 + 132) = *(_DWORD *)(a1 + 284);
    *(_DWORD *)(v14 + 136) = *(_DWORD *)(a1 + 288);
    *(_DWORD *)(v14 + 140) = *(_DWORD *)(a1 + 292);
    *(_DWORD *)(v14 + 144) = *(_DWORD *)(a1 + 296);
    *(_QWORD *)(v14 + 160) = *(_QWORD *)(a1 + 304);
    *(_OWORD *)(v14 + 176) = *(_OWORD *)(a1 + 312);
