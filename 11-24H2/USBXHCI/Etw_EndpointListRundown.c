/*
 * XREFs of Etw_EndpointListRundown @ 0x14000A880
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( v6 >= *(_DWORD *)(a2 + 120) )
      {
        ...
        if ( v10 != (_QWORD *)*v10 )
        {
          do
          {
            (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD), __int64, const char *))(WdfFunctions_01033 + 1640))(
              WdfDriverGlobals,
              *(_QWORD *)(v12 + 24),
            ...
            if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc & 1) != 0 )
              McTemplateK0pppnnn_EtwWriteTransfer(
                ...
                *v17,
                ...
                v20,
                (__int64)v16 + 117);
            (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD), __int64, const char *))(WdfFunctions_01033 + 1648))(
              WdfDriverGlobals,
              *v17,
              Etw_EndpointListRundown,
              940LL,
