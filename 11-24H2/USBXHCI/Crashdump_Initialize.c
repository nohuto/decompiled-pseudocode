/*
 * XREFs of Crashdump_Initialize @ 0x1400500E0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_InitializeWithControllerReset @ 0x140050604 (Crashdump_InitializeWithControllerReset.c)
 *     Crashdump_InitializeWithoutControllerReset @ 0x140050820 (Crashdump_InitializeWithoutControllerReset.c)
 *     Crashdump_Register_BiosHandoff @ 0x1400514C0 (Crashdump_Register_BiosHandoff.c)
