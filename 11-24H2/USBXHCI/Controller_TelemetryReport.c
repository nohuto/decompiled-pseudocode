/*
 * XREFs of Controller_TelemetryReport @ 0x14004231C
 * Callers:
 ...
 *     TelemetryData_InsertTriageDataBlock @ 0x1400569D8 (TelemetryData_InsertTriageDataBlock.c)
...
void __fastcall Controller_TelemetryReport(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, unsigned int a5)
{
  ...
  if ( (unsigned __int8)Controller_TelemetryOkToGenerateReport(a1, a2, v6) )
  {
    ...
    *(_QWORD *)v25 = 0LL;
    ...
    {
      LOBYTE(v14) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v14, 4, 238, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids);
    }
  }
}
