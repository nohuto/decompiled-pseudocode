/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x14007AC58
 * Callers:
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x140056CA4 (InitializeTelemetryAssertsKMWorkerInternal.c)
