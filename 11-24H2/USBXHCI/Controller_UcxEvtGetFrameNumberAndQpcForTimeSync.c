/*
 * XREFs of Controller_UcxEvtGetFrameNumberAndQpcForTimeSync @ 0x140013E00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
      ...
      if ( !v15 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, unsigned __int64))(WdfFunctions_01033 + 2120))(
                   ...
                   a3);
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_d(v9[9].QuadPart, v16, 4, 324, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, 120);
        goto LABEL_33;
      }
    ...
    else
    {
      ...
      if ( !(unsigned __int8)Controller_IsHandlePresentInCollection(v9, *v21) )
      {
        ...
        {
          LOBYTE(v10) = 2;
          WPP_RECORDER_SF_q(v9[9].QuadPart, v10, 4, 326, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v8);
        }
        goto LABEL_9;
      }
    }
