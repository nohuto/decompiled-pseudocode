/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x140056DBC
 * Callers:
 ...
 *     GetImageTuple @ 0x140056B50 (GetImageTuple.c)
...
LABEL_53:
  ...
  if ( v58 )
  {
    if ( (unsigned int)dword_140073040 > 5 && tlgKeywordOn((__int64)&dword_140073040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140073040, byte_14006435D, v30, v31, 0xEu, v62);
    }
  }
  else if ( (unsigned int)dword_140073040 > 5 && tlgKeywordOn((__int64)&dword_140073040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)dword_1400644AD,
      v37,
      v38,
      0xBu,
      v62);
  ...
  if ( dword_140073078 && !v54 && !KeGetCurrentIrql() )
  {
    ...
    if ( v58 )
    {
      if ( (unsigned int)dword_140073040 > 5 && tlgKeywordOn((__int64)&dword_140073040, 0x400000000000LL) )
      {
        ...
        v80 = 4LL;
        v82 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140073040, byte_140064407, v40, v41, 0xDu, v62);
      }
    }
    else if ( (unsigned int)dword_140073040 > 5 && tlgKeywordOn((__int64)&dword_140073040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140073040,
        (unsigned __int8 *)dword_14006451A,
        v42,
        v43,
        0xAu,
        v62);
