/*
 * XREFs of McTemplateK0pppqqQ6qqqqntttuuuqttttU32U32_EtwWriteTransfer @ 0x140008F9C
 * Callers:
...
__int64 __fastcall McTemplateK0pppqqQ6qqqqntttuuuqttttU32U32_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a28)
{
  ...
  v75 = 32LL;
  v77 = 32LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, a3, 25LL, v29);
}
