/*
 * XREFs of Register_ControllerReset @ 0x14001C654
 * Callers:
...
__int64 __fastcall Register_ControllerReset(__int64 a1, char a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(*v4 + 72), 4, 6, 61, (__int64)&WPP_746555d3cffb313de7d261611ff307b4_Traceguids);
...
LABEL_34:
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v18 + 72), v7, 6, v19, (__int64)&WPP_746555d3cffb313de7d261611ff307b4_Traceguids, v22);
    return v8;
  }
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(*v4 + 72), 2, 6, 63, (__int64)&WPP_746555d3cffb313de7d261611ff307b4_Traceguids);
  return (unsigned int)-1073741823;
}
