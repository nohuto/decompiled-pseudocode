/*
 * XREFs of UsbDevice_GetXhciEndpointDequeuePointer @ 0x140008180
 * Callers:
...
__int64 __fastcall UsbDevice_GetXhciEndpointDequeuePointer(__int64 a1, int a2)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)(v2 + 136) + 80LL)
    && (*(_BYTE *)(a1 + 664) && *(_DWORD *)(v3 + 1008) == 2 || *(_DWORD *)(v3 + 1008) == 1) )
  {
  ...
  else
  {
    ...
    {
      DeviceContextBufferVA = XilCoreUsbDevice_GetDeviceContextBufferVA(a1 + (v4 != 0 ? 624LL : 616LL));
      v7 = (v9 << 6) + 72;
    }
    else
    {
