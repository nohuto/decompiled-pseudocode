/*
 * XREFs of Controller_CreateWdfDevice @ 0x140075BC4
 * Callers:
...
LABEL_54:
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_d(a2, v10, 4, v13, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v32);
      goto LABEL_55;
    }
    goto LABEL_55;
  }
...
LABEL_60:
  ...
  *(_QWORD *)(v17 + 88) = *a3;
  ...
  if ( v22 >= 0 )
  {
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_S(a2, 4u, v25, 0x2Cu, (int)v31, v40.Buffer);
      v26 = *a3;
      ...
      if ( v22 >= 0 )
      {
        ...
        *(_QWORD *)((char *)&v65 + 4) = 0xFFFFFFFF00000002uLL;
        ...
        if ( v29 < 0 )
        {
          ...
          {
            LOBYTE(v30) = 2;
            WPP_RECORDER_SF_d(a2, v30, 4, 46, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v29);
          }
          v12 = 0;
        }
        goto LABEL_56;
...
LABEL_66:
    LOBYTE(v23) = 2;
    WPP_RECORDER_SF_d(a2, v23, 4, v24, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v22);
    goto LABEL_56;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
