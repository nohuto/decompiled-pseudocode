/*
 * XREFs of Controller_Create @ 0x140074C78
 * Callers:
 ...
 *     RtlStringCchCopyA @ 0x14003C63C (RtlStringCchCopyA.c)
 *     Controller_AllocateIrqlTrackingArray @ 0x14003F8D4 (Controller_AllocateIrqlTrackingArray.c)
 *     Controller_QuerySupportedDSMs @ 0x140041CB8 (Controller_QuerySupportedDSMs.c)
 *     Controller_ReferenceTrustletProcess @ 0x140041D34 (Controller_ReferenceTrustletProcess.c)
 *     Device_IsSecureDevice @ 0x1400439D8 (Device_IsSecureDevice.c)
 *     RtlStringCopyWorkerA @ 0x1400443DC (RtlStringCopyWorkerA.c)
...
LABEL_13:
        LOBYTE(v16) = 2;
LABEL_14:
        WPP_RECORDER_SF_d(a2, v16, 4, v18, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, AcpiData);
...
LABEL_27:
  ...
  if ( IsSecureDevice )
    v22 = v19;
  DWORD2(v34) = v22;
  AcpiData = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, __int128 *, __int64 *))qword_14006BD68)(
               UcxDriverGlobals,
               a1,
               v52,
               &v33,
  ...
  *(_QWORD *)v29 = v29;
  ...
  AcpiData = DynamicLock_Create(v37, a2, IsSecureDevice, (__int64 *)(v23 + 1072));
  if ( AcpiData < 0 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return (unsigned int)AcpiData;
  ...
  *(_BYTE *)(v23 + 1120) = 0;
  *(_QWORD *)(v23 + 1104) = v23 + 1096;
  *(_QWORD *)(v23 + 1096) = v23 + 1096;
  *(_BYTE *)(v23 + 1064) = 0;
  KeQueryPerformanceCounter((PLARGE_INTEGER)(v23 + 1184));
  *(_QWORD *)(v23 + 1192) = 0LL;
  *(_QWORD *)(v23 + 1200) = 0LL;
  *(_DWORD *)(v23 + 1208) = 0;
  *(_DWORD *)(v23 + 1080) = 0;
  ...
  *(_DWORD *)(v23 + 1008) = v30;
  *(_QWORD *)(v23 + 1036) = 0LL;
  AcpiData = DynamicLock_Create(v37, a2, 0, (__int64 *)(v23 + 1048));
  if ( AcpiData >= 0 )
