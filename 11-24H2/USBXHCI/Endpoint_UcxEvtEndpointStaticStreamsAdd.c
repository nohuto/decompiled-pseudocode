/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsAdd @ 0x140047DE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStaticStreamsAdd(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( !*(_BYTE *)(v5 + 37) )
  {
    ...
    {
      LODWORD(v19) = *v6;
      LODWORD(v18) = *(unsigned __int8 *)(*(_QWORD *)v7 + 143LL);
      WPP_RECORDER_SF_dD(*v8, 2u, 0xDu, 0x68u, (__int64)&WPP_d3be1904650e34f1a39197b3dd99b0d4_Traceguids, v18, v19);
    }
  ...
  if ( *(_BYTE *)(v5 + 1352) )
    v10 = 2;
  v29 = v10;
  v11 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, int *, __int64 *))qword_14006BE00)(
          UcxDriverGlobals,
          a1,
          &v34,
          &v25,
  ...
  if ( v11 >= 0 )
  {
    ...
    *(_DWORD *)(v12 + 8) = v4;
    ...
    for ( i = v12 + 48; ; i += 104LL )
    {
      ...
      *(_QWORD *)&v22 = 24LL;
      v23 = v35;
      ((void (__fastcall *)(__int64, __int64, __int128 *))qword_14006BDF8)(UcxDriverGlobals, v21, &v22);
      if ( v9 >= (unsigned int)v4 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LODWORD(v20) = v4;
          LODWORD(v19) = *(_DWORD *)(v5 + 152);
          LODWORD(v18) = *(unsigned __int8 *)(*(_QWORD *)(v5 + 16) + 143LL);
          WPP_RECORDER_SF_ddL(
            *(_QWORD *)(v5 + 80),
            4u,
            0xDu,
