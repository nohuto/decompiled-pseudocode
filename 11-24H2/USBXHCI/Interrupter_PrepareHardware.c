/*
 * XREFs of Interrupter_PrepareHardware @ 0x14007C5D0
 * Callers:
...
LABEL_4:
  ...
  if ( *(_DWORD *)(v3 + 1036) == 1 )
  {
    ...
    v15 = 1;
    v9 = v34;
    v16 = v34 <= g_ReservedMessageForOffloadMode;
        ...
        if ( (_DWORD)v6 )
        {
          ...
          else
          {
            ...
            v26 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01033 + 2440))(
                    ...
                    v35,
                    i);
            v10 = Interrupter_CreateInterrupter(*(_QWORD *)a1, v3, v6, v26, v25, &v36, 0LL);
            if ( (v10 & 0x80000000) != 0 )
            {
              if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                return v10;
              v30 = 23;
LABEL_53:
              WPP_RECORDER_SF_Dd(*(_QWORD *)(v3 + 72), v27, v28, v30, v33, v6, v10);
              return v10;
            }
            v29 = v36;
            LOBYTE(v28) = 1;
            v10 = Interrupter_PrepareInterrupter(a1, v36, v28);
            if ( (v10 & 0x80000000) != 0 )
            {
              if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                return v10;
            ...
            *(_QWORD *)(*(_QWORD *)(a1 + 32) + 8LL * (unsigned int)v6) = v29;
          }
          LODWORD(v6) = v6 + 1;
        }
        else
...
LABEL_66:
  ...
  v10 = Interrupter_CreateInterrupter(*(_QWORD *)a1, v3, *(_DWORD *)(a1 + 64), 0LL, 0LL, &v36, 0LL);
  if ( (v10 & 0x80000000) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
