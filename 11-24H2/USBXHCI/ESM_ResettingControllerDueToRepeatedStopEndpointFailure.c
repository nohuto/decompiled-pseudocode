/*
 * XREFs of ESM_ResettingControllerDueToRepeatedStopEndpointFailure @ 0x1400553D0
 * Callers:
 *     <none>
 * Callees:
...
{
  Endpoint_SM_RequestControllerResetDueToRepeatedStopEndpointFailure(*(__int64 **)(a1 + 960));
  return 29LL;
}
