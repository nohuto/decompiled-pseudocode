/*
 * XREFs of Controller_RetrieveAcpiData @ 0x140077E20
 * Callers:
...
__int64 __fastcall Controller_RetrieveAcpiData(__int64 a1, int a2, char *a3)
{
  ...
  v18 = v21;
  v19 = 32;
  v6 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, __int64, _QWORD, int *, _QWORD, _QWORD))(WdfFunctions_01033 + 1488))(
         WdfDriverGlobals,
         v5,
         0LL,
         3325992LL,
  ...
  if ( v6 == -2147483643 )
  {
    ...
    if ( Pool2 )
    {
      ...
      v18 = (_OWORD *)Pool2;
      v19 = v9;
      v13 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, __int64, _QWORD, int *, _QWORD, _QWORD))(WdfFunctions_01033 + 1488))(
              WdfDriverGlobals,
              v5,
              0LL,
              3325992LL,
