/*
 * XREFs of Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x140047B58
 * Callers:
 ...
 *     ESM_WaitingForControllerResetCompletion @ 0x140055580 (ESM_WaitingForControllerResetCompletion.c)
 * Callees:
