/*
 * XREFs of XilCoreDeviceSlot_SetDeviceContext @ 0x14000144C
 * Callers:
        ...
        __int64 DeviceContextBufferLA)
{
  ...
  v5 = a3;
  DeviceContextBufferVA = (void *)XilCoreUsbDevice_GetDeviceContextBufferVA(a2 + (*(_BYTE *)(a2 + 665) != 0
                                                                                ? 624LL
                                                                                : 616LL));
