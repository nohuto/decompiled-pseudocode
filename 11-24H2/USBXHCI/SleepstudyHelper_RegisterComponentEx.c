/*
 * XREFs of SleepstudyHelper_RegisterComponentEx @ 0x1400805F4
 * Callers:
...
__int64 __fastcall SleepstudyHelper_RegisterComponentEx(void *a1, __int128 *a2, __int128 *a3, __int64 a4, _QWORD *a5)
{
  ...
  if ( (unsigned int)Feature_SPR_HardenInClient__private_IsEnabledDeviceUsageNoInline() )
  {
    if ( qword_14006BCF0 )
    {
      ...
      v12 = *a3;
      v13 = v9;
      return qword_14006BCF0(a1, &v13, &v12, a4, a5);
    }
    else
    {
      return 3221225659LL;
         ...
         || (!qword_14006BCF0
           ? (result = 3221225659LL)
           : (v11 = *a2, v13 = *a3, v12 = v11, result = qword_14006BCF0(a1, &v12, &v13, a4, a5)),
