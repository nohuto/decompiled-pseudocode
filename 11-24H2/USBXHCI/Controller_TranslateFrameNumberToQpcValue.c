/*
 * XREFs of Controller_TranslateFrameNumberToQpcValue @ 0x140013B50
 * Callers:
 ...
 *     Controller_GetQpcValueForFrameMicroFrameBoundary @ 0x140040124 (Controller_GetQpcValueForFrameMicroFrameBoundary.c)
