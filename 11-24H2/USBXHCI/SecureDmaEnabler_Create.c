/*
 * XREFs of SecureDmaEnabler_Create @ 0x14007F5E4
 * Callers:
...
__int64 __fastcall SecureDmaEnabler_Create(__int64 a1, _QWORD *a2)
{
  ...
  v17 = off_14006B1C8;
  v15 = *(_QWORD *)(a1 + 8);
  v4 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, int *, __int64 *))(WdfFunctions_01033 + 1656))(
         WdfDriverGlobals,
         &v10,
         &v18);
  SecureObject = v4;
  if ( v4 < 0 )
  {
    ...
    {
      LOBYTE(v5) = 2;
      WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 72), v5, 18, 10, (__int64)&WPP_8d19556b374b3e85e4187adf480561f2_Traceguids, v4);
    }
    goto LABEL_9;
  }
...
LABEL_9:
  ...
  {
    LOBYTE(v9) = 4;
    WPP_RECORDER_SF_q(*(_QWORD *)(a1 + 72), v9, 18, 11, (__int64)&WPP_8d19556b374b3e85e4187adf480561f2_Traceguids, v18);
  }
  *a2 = v8;
  return (unsigned int)SecureObject;
}
