/*
 * XREFs of Controller_RetrieveUrsData @ 0x1400782D0
 * Callers:
...
LABEL_4:
  ...
  v15 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01033 + 336))(WdfDriverGlobals, a1);
  v23 = 1LL;
  v25 = 336LL;
  v24 = Pool2;
  v14 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, __int64, _QWORD, __int64 *, _QWORD, _QWORD))(WdfFunctions_01033 + 1504))(
          WdfDriverGlobals,
          v15,
          0LL,
          2752516LL,
  ...
  {
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_d(a2, v16, 4, 145, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v14);
  }
  ExFreePoolWithTag(Pool2, 0x49434858u);
