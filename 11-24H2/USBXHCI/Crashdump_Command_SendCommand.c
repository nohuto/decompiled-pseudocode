/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1400528DC
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x140052C4C (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1400535AC (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x140053678 (Crashdump_Endpoint_StopEndpoint.c)
 ...
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x140054C24 (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x140054CE0 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 * Callees:
