/*
 * XREFs of Controller_IsRegKeySetToDisableS0Idle @ 0x140040C2C
 * Callers:
...
bool __fastcall Controller_IsRegKeySetToDisableS0Idle(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = 3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 72), v3, 4, 21, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v2);
  }
  if ( v6 )
