/*
 * XREFs of Bulk_FindStage @ 0x140003CBC
 * Callers:
 ...
 *     Bulk_DoesStageContainDequeuePointer @ 0x1400137B4 (Bulk_DoesStageContainDequeuePointer.c)
...
LABEL_16:
  if ( (__int64 *)(a1 + 376) != v12 )
  {
    ...
    *((_BYTE *)v12 + 134) = *((_BYTE *)v12 + 130);
    while ( 1 )
    {
      NextStage = StageQueue_ForwardScanGetNextStage(v12 + 16);
      v8 = NextStage;
      if ( !NextStage )
      {
        v12 = (__int64 *)*v12;
