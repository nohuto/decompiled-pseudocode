/*
 * XREFs of Endpoint_UcxEvtEndpointReset @ 0x140004D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointReset(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_ddl(*(_QWORD *)(v4 + 80), *(_DWORD *)(v4 + 1368) == 2, v5, v6);
  ...
  if ( (v11 & 0x80u) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_ddqd(*(_QWORD *)(v7 + 80), v9, v10, 61);
  ...
  else
  {
    ...
    *(_QWORD *)(v7 + 288) = a3;
    *(_DWORD *)(v7 + 296) = 259;
    return ESM_AddEvent((PVOID)(v7 + 304));
  }
}
