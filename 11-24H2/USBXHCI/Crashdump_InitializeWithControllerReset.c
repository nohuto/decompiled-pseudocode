/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x140050604
 * Callers:
 *     Crashdump_Initialize @ 0x1400500E0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x140051618 (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1400517F0 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1400518C0 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x140051CA8 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x140051E3C (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_Command_TestCommandRingOperation @ 0x140052C4C (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1400542F4 (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x140054550 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1400547A4 (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x140054DD0 (Crashdump_UsbDevice_SetPortPower.c)
 */
