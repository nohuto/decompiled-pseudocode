/*
 * XREFs of RootHub_UcxEvtClearPortFeature @ 0x1400277B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_199:
      ...
      LOBYTE(v64) = 4;
      WPP_RECORDER_SF_d(v68, (_DWORD)v64, 11, v67, (__int64)&WPP_ae3f3dc960bf3cde3d0f419b97453dd4_Traceguids, v66);
      goto LABEL_111;
    }
    if ( v19 != 3 )
    {
