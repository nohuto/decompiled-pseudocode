/*
 * XREFs of Controller_PopulatePciDeviceInformation @ 0x14007799C
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v17 = a4;
    v15 = a3;
    WPP_RECORDER_SF_ddL(a1, 4u, 4u, 0x89u, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, a2, v15, v17);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v18) = *((unsigned __int8 *)a6 + 8);
      LODWORD(v16) = a6[1];
      LODWORD(v14) = *a6;
      WPP_RECORDER_SF_ddL(a1, 4u, 4u, 0x8Au, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v14, v16, v18);
    }
  }
  if ( *a6 == 4358 )
