/*
 * XREFs of Controller_EvtIoInternalDeviceControl @ 0x14003FF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_EvtIoInternalDeviceControl(__int64 a1, IRP *a2)
{
  ...
  if ( LowPart == 2232247 )
  {
    ...
    {
      LOBYTE(v5) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v6 + 72), v5, 4, 220, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids);
    }
    v7 = 0;
