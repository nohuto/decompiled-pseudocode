/*
 * XREFs of Controller_D0ExitSaveState @ 0x1400366C4
 * Callers:
...
LABEL_11:
  ...
  for ( i = 20; ; --i )
  {
    ...
    if ( (v15 & 0x400) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LOBYTE(v18) = 2;
        WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v18, v17, 134, v24, (v16 - UnbiasedInterruptTime) / 0x2710);
      }
    ...
    if ( !i )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LOBYTE(v21) = 2;
        WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v21, v10, 136, v24, (v20 - UnbiasedInterruptTime) / 0x2710);
      }
      goto LABEL_28;
    }
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v23) = 4;
    WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v23, v10, 135, v24, (v22 - UnbiasedInterruptTime) / 0xA);
  }
LABEL_29:
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc & 8) != 0 )
  {
