/*
 * XREFs of Controller_CheckHealth @ 0x14000CDC4
 * Callers:
...
char __fastcall Controller_CheckHealth(__int64 a1, char a2)
{
  ...
  if ( (Ulong & 4) != 0 )
  {
    ...
    v6 = 0;
    Controller_HwVerifierBreakIfEnabled(a1, 0, 0, 2LL, "Controller reported Host System Error", 0LL, 0LL);
    v8 = 4097;
    goto LABEL_14;
  }
  if ( (Ulong & 0x1000) != 0 )
  {
    ...
    v6 = 0;
    Controller_HwVerifierBreakIfEnabled(a1, 0, 0, 4LL, "Controller reported Host Controller Error", 0LL, 0LL);
    v8 = 4098;
LABEL_14:
