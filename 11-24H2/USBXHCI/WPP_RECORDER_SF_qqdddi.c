/*
 * XREFs of WPP_RECORDER_SF_qqdddi @ 0x140019950
 * Callers:
...
__int64 WPP_RECORDER_SF_qqdddi(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_7655ebd4b6a53902724aa02c679740e3_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
