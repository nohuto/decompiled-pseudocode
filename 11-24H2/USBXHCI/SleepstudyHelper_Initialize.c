/*
 * XREFs of SleepstudyHelper_Initialize @ 0x140080558
 * Callers:
...
__int64 __fastcall SleepstudyHelper_Initialize(_QWORD *a1, __int64 a2)
{
  ...
  {
    if ( v4 < 0 || (v5 = (unsigned int (__fastcall *)(_QWORD *, __int64))qword_14006BCC0) == 0LL )
    {
      v4 = 0;
  ...
  if ( v4 >= 0 )
  {
    v5 = (unsigned int (__fastcall *)(_QWORD *, __int64))qword_14006BCC0;
    if ( !qword_14006BCC0 )
