/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x140050820
 * Callers:
 *     Crashdump_Initialize @ 0x1400500E0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x140051764 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x140052650 (Crashdump_EventRing_PrepareForHibernate.c)
