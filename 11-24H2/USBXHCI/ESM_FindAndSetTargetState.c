...
LABEL_7:
  ...
  if ( v10 == 1002 )
  {
    ESM_LogUnhandledEvent(a1, a2, v13, a3);
    return 0;
  }
  if ( v4 < v20 )
  {
  ...
  *(_DWORD *)(a1 + 12LL * *(unsigned __int8 *)(a1 + 832)) = v5;
