/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x14005346C
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x140052F78 (Crashdump_Endpoint_SendBulkTransfer.c)
