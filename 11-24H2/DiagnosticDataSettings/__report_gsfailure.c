/*
 * XREFs of __report_gsfailure @ 0x180001B50
 * Callers:
 *     __security_check_cookie @ 0x180001460 (__security_check_cookie.c)
 * Callees:
 *     __raise_securityfailure @ 0x180001B08 (__raise_securityfailure.c)
 *     capture_previous_context @ 0x180001C28 (capture_previous_context.c)
 */
