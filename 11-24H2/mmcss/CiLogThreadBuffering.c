/*
 * XREFs of CiLogThreadBuffering @ 0x1400010E0
 * Callers:
 *     CiSchedulerRemoveThread @ 0x140001010 (CiSchedulerRemoveThread.c)
 *     CiSystemUpdateThreadTag @ 0x140001600 (CiSystemUpdateThreadTag.c)
