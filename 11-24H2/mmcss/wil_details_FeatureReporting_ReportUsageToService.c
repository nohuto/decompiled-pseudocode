/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToService @ 0x1400051E4
 * Callers:
 ...
 *     wil_details_MapReportingKind @ 0x1400056A0 (wil_details_MapReportingKind.c)
        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    {
      v8 = 0;
      return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))g_wil_details_pfnFeatureLoggingHook(58473965LL, &Feature_3448537402_logged_traits, 0LL, v3, &v9, 0LL, v8, 1LL);
    }
  }
  return result;
}
