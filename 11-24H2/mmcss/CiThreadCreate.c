/*
 * XREFs of CiThreadCreate @ 0x14000ECB0
 * Callers:
 ...
 *     CiThreadInsertInTree @ 0x140003BF0 (CiThreadInsertInTree.c)
 *     CiTaskIndexDereference @ 0x140003CB0 (CiTaskIndexDereference.c)
 *     CiTryIncrementTotalThreadCount @ 0x140003E60 (CiTryIncrementTotalThreadCount.c)
 *     CiDecrementTotalThreadCount @ 0x140003E90 (CiDecrementTotalThreadCount.c)
 *     CiSchedulerPoke @ 0x140003F10 (CiSchedulerPoke.c)
 ...
 *     CiProcessAddThread @ 0x14000F450 (CiProcessAddThread.c)
  ...
  *(_BYTE *)(v11 + 104) = *(_BYTE *)v3;
  ...
  if ( v21 != v18 )
  {
    ...
    if ( InformationThread < 0 )
    {
      ...
      if ( InformationThread != -1073741811 || (~qword_14000A310 & v21) != 0 )
        goto LABEL_19;
    }
  }
