/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14000534C
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1400054B0 (wil_details_GetCurrentFeatureEnabledState.c)
