/*
 * XREFs of CiConfigQueryValue @ 0x140010EC0
 * Callers:
 *     CiConfigQueryTaskFromRegistry @ 0x140010DF0 (CiConfigQueryTaskFromRegistry.c)
 * Callees:
 *     __report_rangecheckfailure @ 0x140004670 (__report_rangecheckfailure.c)
