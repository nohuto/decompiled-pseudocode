/*
 * XREFs of ?erase@?$vector@VDeviceInfo@CDeviceManager@@V?$allocator@VDeviceInfo@CDeviceManager@@@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@VDeviceInfo@CDeviceManager@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@VDeviceInfo@CDeviceManager@@@std@@@std@@@2@@Z @ 0x1800F3EA4
 * Callers:
