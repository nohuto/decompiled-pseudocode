/*
 * XREFs of ?ConvertInnerToOuterBounds@CVisual@@IEAAJPEBVCVisualTree@@PEAV1@_N@Z @ 0x1800ABE30
 * Callers:
 ...
 *     ?GetBounds@CTreeEffect@@QEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@PEAV2@@Z @ 0x1800A703C (-GetBounds@CTreeEffect@@QEAAJAEBV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNo.c)
        ...
        char a4)
{
  ...
  __int64 v75; // rax
  __int128 *v76; // r12
  __int64 (__fastcall *v77)(float *, _OWORD *, __int128 *); // rax
  _DWORD *v78; // r8
  ...
  int v97; // r12d
  __int64 (__fastcall *v98)(CPolygonShape *, struct D2D_RECT_F *, CMILMatrix *); // rax
  ...
  __m128 v129; // xmm13
  int TightBounds; // eax
  void (__fastcall *v131)(CRectanglesShape *, __int64); // rax
  float v132; // xmm2_4
  float v133; // xmm0_4
  float v134; // xmm5_4
  FLOAT top; // xmm1_4
  ...
  __int64 v169; // r12
  bool v170; // [rsp+38h] [rbp-D0h] BYREF
  __m128 v171; // [rsp+48h] [rbp-C0h] BYREF
  __m256i v172; // [rsp+58h] [rbp-B0h]
  _BYTE v173[20]; // [rsp+78h] [rbp-90h]
  ...
  _OWORD v186[4]; // [rsp+118h] [rbp+10h] BYREF
  int v187; // [rsp+158h] [rbp+50h]
  struct D2D_RECT_F v188; // [rsp+168h] [rbp+60h] BYREF
  __int128 v189; // [rsp+178h] [rbp+70h] BYREF
  struct tagRECT v190; // [rsp+188h] [rbp+80h] BYREF
  __int64 v191; // [rsp+198h] [rbp+90h]

  v4 = *(_QWORD *)this;
  v185 = a2;
  v7 = a2;
  v8 = *(bool (__fastcall **)(__int64, int))(v4 + 64);
  v10 = 0;
  if ( (char *)v8 == (char *)CSpriteVisual::IsOfType )
  {
    if ( !CVisual::IsOfType((__int64)this, 93) )
      goto LABEL_9;
  }
  else
  {
    if ( v8 == CVisual::IsOfType )
    {
      v12 = CVisual::IsOfType((__int64)this, 93);
    }
    else if ( v8 == CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType )
    {
      v12 = CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType((__int64)this, 93);
    }
    else
    {
      v12 = ((__int64 (__fastcall *)(CVisual *, __int64, bool (__fastcall *)(__int64, int)))v8)(
              this,
              93LL,
  ...
  if ( (*((_QWORD *)this + 86) || *((_QWORD *)this + 85)) && !*((_BYTE *)this + 704) )
  {
...
LABEL_9:
  ...
  if ( (*v13 & 0x800000) != 0 )
  {
    ...
    if ( v73 == CEffectGroupGeneratedT<CEffectGroup,CEffect>::IsOfType
      || ((char *)v73 != (char *)CMatrixTransform3D::IsOfType
        ? (v160 = ((__int64 (__fastcall *)(float *, __int64))v73)(v72, 58LL))
        : (v160 = CMatrixTransform3D::IsOfType((__int64)v72, 58)),
          v160) )
    {
      v14 = v72[20];
    }
  ...
  v181 = 0;
  v18 = *(bool (__fastcall **)(__int64, int))(v16 + 64);
  ...
  {
    if ( v18 == CVisual::IsOfType )
    {
      v74 = CVisual::IsOfType((__int64)this, 93);
    }
    else if ( v18 == CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType )
    {
      v74 = CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType((__int64)this, 93);
    }
    else
    {
      v74 = ((__int64 (__fastcall *)(CVisual *, __int64, _DWORD *, __int64))v18)(this, 93LL, v13, 1LL);
    }
    if ( !v74 )
      goto LABEL_100;
  }
  if ( *((_QWORD *)this + 86) || *((_QWORD *)this + 85) )
    v181 = CLayerVisual::IsAutomaticBoundsToLocalSpaceEnabled(this) != 0;
LABEL_100:
  v75 = *(_QWORD *)this;
  v76 = (__int128 *)((char *)this + 176);
  v189 = 0LL;
  v77 = *(__int64 (__fastcall **)(float *, _OWORD *, __int128 *))(v75 + 320);
  if ( v77 != CVisual::GetBoundsWithEffects )
  {
    v77((float *)this, (_OWORD *)this + 11, &v189);
...
LABEL_108:
    if ( v86 )
    {
      ...
      v179 = 0.0;
      v180 = 0.0;
      if ( (CVisual::GetEffectiveSize(this, &v179, &v180) || v170)
        && (v162 = *(_QWORD *)this,
            *(float *)v184 = v179,
            v163 = *(__int64 (__fastcall **)(CVisual *))(v162 + 224),
            *(float *)&v184[1] = v180,
            v164 = (_QWORD *)v163(this),
            Bounds = CTreeEffect::GetBounds(v164, (__int64)v76, (__int64)v184, (__int64)&v189),
            Bounds < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, Bounds, 0x18C4u, 0LL);
      }
      else if ( TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsInfinite((float *)&v189) )
      {
        v189 = *v76;
      }
    }
  ...
  {
    if ( !CEffectGeneratedT<CEffect,CPropertyChangeResource>::IsOfType(v85, 61) )
      goto LABEL_109;
  }
  else if ( !((unsigned __int8 (__fastcall *)(__int64, __int64))v102)(v85, 61LL) )
  {
    goto LABEL_109;
  }
  v103 = CFilterEffect::GetBounds(v85, (char *)this + 176, &v189);
  if ( v103 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v103, 0x18B0u, 0LL);
LABEL_109:
  v87 = DWORD1(v189);
  v88 = DWORD2(v189);
  v89 = HIDWORD(v189);
  ...
  *((_DWORD *)this + 43) = v91;
  ...
  {
    if ( CEffectGeneratedT<CEffect,CPropertyChangeResource>::IsOfType((__int64)v109, 175) )
    {
LABEL_139:
      v92 = v109;
      goto LABEL_110;
  ...
  else if ( ((unsigned __int8 (__fastcall *)(CTransform3D *, __int64))v110)(v109, 175LL) )
  {
    goto LABEL_139;
  }
  v168 = *(__int64 (__fastcall **)())(*(_QWORD *)v109 + 64LL);
  if ( v168 == CEffectGroupGeneratedT<CEffectGroup,CEffect>::IsOfType
    || ((unsigned __int8 (__fastcall *)(CTransform3D *, __int64))v168)(v109, 58LL) )
  {
...
LABEL_110:
  if ( v92 )
  {
    ...
    v171 = *(__m128 *)Matrix;
    v172 = *(__m256i *)((char *)Matrix + 16);
    *(_OWORD *)v173 = *((_OWORD *)Matrix + 3);
    *(_DWORD *)&v173[16] = *((_DWORD *)Matrix + 16);
    if ( v181 || !*((_DWORD *)this + 28) )
    {
      v174 = _xmm;
      v175 = _xmm;
      ...
      v176 = 0LL;
      v178 = 10657;
      CMILMatrix::Multiply((CMILMatrix *)&v171, (const struct CMILMatrix *)&v174);
    }
    CMILMatrix::Transform3DBoundsHelper<0>((__int64)&v171, (float *)this + 38, (float *)this + 38);
  }
...
LABEL_113:
  ...
  if ( ShapeData >= 0 )
  {
    ...
    if ( v182 )
    {
      v98 = *(__int64 (__fastcall **)(CPolygonShape *, struct D2D_RECT_F *, CMILMatrix *))(*(_QWORD *)v182 + 48LL);
      ...
      if ( (char *)v98 == (char *)CRegionShape::GetTightBounds )
      {
        v190 = 0LL;
        if ( FastRegion::CRegion::GetBoundingRect((CRectanglesShape *)((char *)v182 + 16), &v190) )
        {
          v188.left = (float)v190.left;
          v188.top = (float)v190.top;
          v188.right = (float)v190.right;
          v188.bottom = (float)v190.bottom;
        }
        v96 = v182;
        v10 = 0;
        goto LABEL_165;
      }
      if ( v98 == CRoundedRectangleShape::GetTightBounds )
        TightBounds = CRoundedRectangleShape::GetTightBounds(v182, &v188, 0LL);
      else
        TightBounds = v98(v182, &v188, 0LL);
      v97 = TightBounds;
      v10 = TightBounds;
      if ( TightBounds < 0 )
      {
...
LABEL_160:
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v97, 0x63u, 0LL);
        goto LABEL_161;
      }
      v96 = v182;
    }
...
LABEL_163:
  ...
  {
    LODWORD(v188.left) = _xmm;
    LODWORD(v188.bottom) = _mm_shuffle_ps((__m128)_xmm, (__m128)_xmm, 255).m128_u32[0];
    LODWORD(v188.top) = _mm_shuffle_ps((__m128)_xmm, (__m128)_xmm, 85).m128_u32[0];
    LODWORD(v188.right) = _mm_shuffle_ps((__m128)_xmm, (__m128)_xmm, 170).m128_u32[0];
LABEL_122:
    v10 = 0;
  }
LABEL_165:
  if ( v183 && v96 )
  {
    v131 = **(void (__fastcall ***)(CRectanglesShape *, __int64))v96;
    if ( (char *)v131 == (char *)CRectanglesShape::`scalar deleting destructor' )
    {
      CRectanglesShape::~CRectanglesShape(v96);
      CThreadLocalObjectCache<CRectanglesShape,CRectanglesShape>::Free(v96);
    }
    else if ( (char *)v131 == (char *)CRoundedRectangleShape::`vector deleting destructor' )
    {
    ...
    else if ( (char *)v131 == (char *)CPolygonShape::`scalar deleting destructor' )
    {
      CPolygonShape::`scalar deleting destructor'(v96, 1);
    }
    else
    {
      v131(v96, 1LL);
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x613u, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x578u, 0LL);
  ...
  if ( v188.top > v134 )
  {
    *((_DWORD *)this + 39) = LODWORD(v188.top);
    v134 = top;
  }
  v136 = *((float *)this + 40);
  right = v188.right;
  if ( v136 > v188.right )
  {
    *((_DWORD *)this + 40) = LODWORD(v188.right);
    v136 = right;
  }
  v138 = *((float *)this + 41);
  bottom = v188.bottom;
  if ( v138 > v188.bottom )
  {
    *((_DWORD *)this + 41) = LODWORD(v188.bottom);
    v138 = bottom;
  }
  v15 = 1LL;
  v140 = (v133 <= v132) + 1;
...
LABEL_64:
      ...
      {
        if ( v30 )
          CMILMatrix::Transform3DBoundsHelper<0>((__int64)&v174, (float *)this + 38, (float *)this + 38);
        goto LABEL_67;
      }
      v153 = *(_QWORD *)v7;
      ...
      *(_DWORD *)&v173[16] = 0;
      if ( (*(unsigned __int8 (__fastcall **)(const struct CVisualTree *, unsigned __int64, _DWORD *, __int64))(v153 + 184))(
             ...
             v15) )
      {
        v155 = (CVisual *)((char *)v154 + 328);
LABEL_216:
        if ( v155 )
        {
          v170 = 0;
          CVisual::EnsureWorldTransform(v154, v7, v155);
          CTreeData::GetWorldTransform(v155, (struct CMILMatrix *)&v171, &v170, 0LL);
          goto LABEL_218;
        }
      }
      else
...
LABEL_218:
      v157 = Windows::Foundation::Numerics::invert(
               (Windows::Foundation::Numerics *)&v171,
               (const struct Windows::Foundation::Numerics::float4x4 *)&v171,
               v156);
      v173[16] &= 3u;
      v173[17] &= 0xC0u;
      if ( v157 )
      {
        ...
        v159 = (CTreeData *)TreeData;
        if ( TreeData )
        {
          v170 = 0;
          CVisual::EnsureWorldTransform(a3, v7, (struct CTreeData *)TreeData);
          CTreeData::GetWorldTransform(v159, (struct CMILMatrix *)v186, &v170, 0LL);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x6AAu, 0LL);
        ...
        if ( v30 )
          CMILMatrix::Multiply(
            (const struct CMILMatrix *)&v174,
            (const struct CMILMatrix *)v186,
            (struct CMILMatrix *)v186);
        v191 = 0LL;
        v190 = 0LL;
        CMILMatrix::Transform3DBoundsHelper<0>((__int64)v186, (float *)this + 38, (float *)&v190.left);
        CMILMatrix::Transform3DBoundsHelper<0>((__int64)&v171, (float *)&v190.left, (float *)this + 38);
        goto LABEL_67;
      }
      goto LABEL_71;
    }
    ...
    v38 = *(__m128 *)(v32 + 96);
    v171 = v37;
    *(__m128 *)v172.m256i_i8 = v38;
    *(_DWORD *)&v173[16] = v36;
    v39 = *(__m128 *)(v32 + 112);
    v40 = *(struct tagRECT *)(v32 + 128);
    *(__m128 *)&v172.m256i_u64[2] = v39;
    *(struct tagRECT *)v173 = v40;
    ...
    else
    {
      if ( (char)((_BYTE)v36 << 6) >> 6 < 0
        || (v41 = CMILMatrix::IsTranslate<1>(&v171),
            v42 = FLOAT_0_000081380211,
            v43 = *(float *)&v173[8],
            v44 = *(float *)&v173[4],
            v190 = (struct tagRECT)*(unsigned int *)v173,
            v41)
        && COERCE_FLOAT(COERCE_UNSIGNED_INT(*(float *)v173 - 0.0) & _xmm) < 0.000081380211
        && COERCE_FLOAT(COERCE_UNSIGNED_INT(*(float *)&v173[4] - 0.0) & _xmm) < 0.000081380211
        && COERCE_FLOAT(COERCE_UNSIGNED_INT(*(float *)&v173[8] - 0.0) & _xmm) < 0.000081380211 )
      {
        v37 = (__m128)v174;
        v38 = (__m128)v175;
        v39 = (__m128)v176;
      ...
      v40 = *(struct tagRECT *)v173;
      v39 = *(__m128 *)&v172.m256i_u64[2];
      v38 = *(__m128 *)v172.m256i_i8;
      v37 = v171;
      v173[16] = v173[16] & 0xFC | 1;
    }
...
LABEL_63:
    ...
    {
      if ( !(unsigned __int8)CMILMatrix::IsTranslate<1>(&v171) )
      {
        if ( !(unsigned __int8)CMILMatrix::IsTranslateAndScale<1>(&v174) )
        {
          if ( (unsigned __int8)CMILMatrix::IsPure2DUniformZ<1>(&v171)
            && (unsigned __int8)CMILMatrix::IsPure2DUniformZ<1>(&v174) )
          {
            *(_QWORD *)&v173[12] = 0x28083F800000LL;
            *(_OWORD *)&v172.m256i_u64[1] = 0uLL;
            v172.m256i_i32[7] = 0;
            v122 = *(__m128 *)v173;
            v123 = *(__m128 *)v172.m256i_i8;
            v123.m128_f32[0] = (float)(*(float *)&v175 * *(float *)&v172.m256i_i32[1])
                             + (float)(*(float *)&v174 * *(float *)v172.m256i_i32);
            v124 = (__m128)v171.m128_u64[0];
            v124.m128_f32[0] = (float)(*(float *)&v175 * v171.m128_f32[1]) + (float)(*(float *)&v174 * v171.m128_f32[0]);
            v125 = _mm_shuffle_ps(*(__m128 *)&v172.m256i_u64[2], *(__m128 *)&v172.m256i_u64[2], 210);
            v126 = _mm_shuffle_ps(v123, v123, 225);
            v125.m128_f32[0] = *(float *)&v172.m256i_i32[6] * *((float *)&v176 + 2);
            v127 = _mm_shuffle_ps(v124, v124, 225);
            v126.m128_f32[0] = (float)(*((float *)&v175 + 1) * *(float *)&v172.m256i_i32[1])
                             + (float)(*((float *)&v174 + 1) * *(float *)v172.m256i_i32);
            v122.m128_f32[0] = (float)((float)(*(float *)&v175 * *(float *)&v173[4])
                                     + (float)(*(float *)&v174 * *(float *)v173))
                             + *(float *)&v177.left;
            v39 = _mm_shuffle_ps(v125, v125, 201);
            v128 = _mm_shuffle_ps(v122, v122, 225);
            v127.m128_f32[0] = (float)(*((float *)&v175 + 1) * v171.m128_f32[1])
                             + (float)(*((float *)&v174 + 1) * v171.m128_f32[0]);
            v128.m128_f32[0] = (float)((float)(*((float *)&v175 + 1) * *(float *)&v173[4])
                                     + (float)(*((float *)&v174 + 1) * *(float *)v173))
                             + *(float *)&v177.top;
            v38 = _mm_shuffle_ps(v126, v126, 225);
            v129 = _mm_shuffle_ps(v128, v128, 198);
            v129.m128_f32[0] = (float)(*((float *)&v176 + 2) * *(float *)&v173[8]) + *(float *)&v177.right;
          ...
          {
            v47 = *(__m128 *)&v172.m256i_u64[2];
            v48 = *(struct tagRECT *)v173;
            v186[0] = v174;
            v186[1] = v175;
            v186[2] = v176;
            v49.m128_u64[1] = v171.m128_u64[1];
            v186[3] = v177;
            v50 = *(__m128 *)v172.m256i_i8;
        ...
        {
          v111 = v171.m128_f32[0] * *(float *)&v174;
          v112 = *(float *)v172.m256i_i32 * *(float *)&v174;
          v113 = *(float *)&v172.m256i_i32[4] * *(float *)&v174;
          v114 = *(float *)v173 * *(float *)&v174;
          v115 = v171.m128_f32[1] * *((float *)&v175 + 1);
          v116 = *(float *)&v172.m256i_i32[1] * *((float *)&v175 + 1);
          v117 = *(float *)&v172.m256i_i32[5] * *((float *)&v175 + 1);
          v118 = *(float *)&v173[4] * *((float *)&v175 + 1);
          v171.m128_f32[0] = v171.m128_f32[0] * *(float *)&v174;
          *(float *)v172.m256i_i32 = *(float *)v172.m256i_i32 * *(float *)&v174;
          *(float *)&v172.m256i_i32[4] = *(float *)&v172.m256i_i32[4] * *(float *)&v174;
          *(float *)v173 = *(float *)v173 * *(float *)&v174;
          v171.m128_f32[1] = v171.m128_f32[1] * *((float *)&v175 + 1);
          *(float *)&v172.m256i_i32[1] = *(float *)&v172.m256i_i32[1] * *((float *)&v175 + 1);
          *(float *)&v172.m256i_i32[5] = *(float *)&v172.m256i_i32[5] * *((float *)&v175 + 1);
          *(float *)&v173[4] = *(float *)&v173[4] * *((float *)&v175 + 1);
          if ( v42 <= COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)&v176 + 2) - 1.0) & _xmm) )
          {
            v171.m128_f32[2] = v171.m128_f32[2] * *((float *)&v176 + 2);
            *(float *)&v172.m256i_i32[2] = *(float *)&v172.m256i_i32[2] * *((float *)&v176 + 2);
            *(float *)&v172.m256i_i32[6] = *(float *)&v172.m256i_i32[6] * *((float *)&v176 + 2);
            *(float *)&v173[8] = *(float *)&v173[8] * *((float *)&v176 + 2);
          }
          v119 = v173[16] & 0xCC;
          v173[16] &= 0xCCu;
        }
        else
        {
          ...
          v118 = *(float *)&v173[4];
          v114 = *(float *)v173;
          v117 = *(float *)&v172.m256i_i32[5];
          v113 = *(float *)&v172.m256i_i32[4];
          v116 = *(float *)&v172.m256i_i32[1];
          v112 = *(float *)v172.m256i_i32;
          v115 = v171.m128_f32[1];
          v111 = v171.m128_f32[0];
        }
        ...
        v11 = v173[17];
        if ( (char)(4 * v173[17]) >> 6 != 1 )
        {
          if ( (char)(4 * v173[17]) >> 6 >= 0 )
          {
            if ( v42 <= COERCE_FLOAT(COERCE_UNSIGNED_INT(
                                       (float)((float)((float)(COERCE_FLOAT(v172.m256i_i32[3] & _xmm) * 61440.0)
                                                     + (float)(COERCE_FLOAT(v171.m128_i32[3] & _xmm) * 61440.0))
                                             + COERCE_FLOAT(*(_DWORD *)&v173[12] & _xmm))
                                     - 1.0) & _xmm) )
            {
              LOBYTE(v11) = v173[17] & 0xCF | 0x10;
            }
            else
            {
              LOBYTE(v11) = v173[17] | 0x30;
              v173[17] |= 0x30u;
              if ( v42 > COERCE_FLOAT(COERCE_UNSIGNED_INT((float)(COERCE_FLOAT(v172.m256i_i32[7] & _xmm) * 61440.0) - 0.0) & _xmm) )
              {
                v51 = *(float *)&v177.right;
LABEL_60:
                v52 = *(float *)&v173[8] + v51;
LABEL_61:
                *(float *)&v173[8] = v52;
                v173[16] = v119 & 0xFC;
                *(float *)&v173[4] = v118 + v121;
                *(float *)v173 = v114 + v120;
LABEL_62:
                v40 = *(struct tagRECT *)v173;
                v39 = *(__m128 *)&v172.m256i_u64[2];
                v38 = *(__m128 *)v172.m256i_i8;
          ...
          else if ( v42 > COERCE_FLOAT(COERCE_UNSIGNED_INT((float)(COERCE_FLOAT(v172.m256i_i32[7] & _xmm) * 61440.0) - 0.0) & _xmm) )
          {
            goto LABEL_60;
          }
        }
        LOBYTE(v11) = v11 & 0xF3;
        v173[17] = v11;
        v171.m128_f32[0] = v111 + (float)(*(float *)&v177.left * v171.m128_f32[3]);
        v171.m128_f32[1] = v115 + (float)(*(float *)&v177.top * v171.m128_f32[3]);
        v171.m128_f32[2] = v171.m128_f32[2] + (float)(*(float *)&v177.right * v171.m128_f32[3]);
        *(float *)v172.m256i_i32 = v112 + (float)(*(float *)&v177.left * *(float *)&v172.m256i_i32[3]);
        v120 = *(float *)&v177.left * *(float *)&v173[12];
        *(float *)&v172.m256i_i32[2] = *(float *)&v172.m256i_i32[2]
                                     + (float)(*(float *)&v177.right * *(float *)&v172.m256i_i32[3]);
        *(float *)&v172.m256i_i32[1] = v116 + (float)(*(float *)&v177.top * *(float *)&v172.m256i_i32[3]);
        v121 = *(float *)&v177.top * *(float *)&v173[12];
        *(float *)&v172.m256i_i32[4] = v113 + (float)(*(float *)&v177.left * *(float *)&v172.m256i_i32[7]);
        v52 = *(float *)&v173[8] + (float)(*(float *)&v177.right * *(float *)&v173[12]);
        *(float *)&v172.m256i_i32[5] = v117 + (float)(*(float *)&v177.top * *(float *)&v172.m256i_i32[7]);
        *(float *)&v172.m256i_i32[6] = *(float *)&v172.m256i_i32[6]
                                     + (float)(*(float *)&v177.right * *(float *)&v172.m256i_i32[7]);
        goto LABEL_61;
      }
      v60 = *(float *)v173;
      v40 = v177;
      v61 = *(float *)&v173[4];
      LODWORD(v62) = *(_DWORD *)v173 & _xmm;
      *(_DWORD *)&v173[16] = v178;
      v63 = *(float *)&v173[8];
      v37 = (__m128)v174;
      v38 = (__m128)v175;
      v39 = (__m128)v176;
      *(struct tagRECT *)v173 = v177;
      ...
      *(float *)v173 = (float)((float)((float)(*(float *)&v175 * v61) + (float)(*(float *)&v174 * v60))
                             + (float)(*(float *)&v176 * v63))
                     + *(float *)&v177.left;
      *(float *)&v173[4] = *(float *)&v173[4]
...
LABEL_90:
      *(_DWORD *)&v173[16] = 0;
      v67 = _mm_shuffle_ps(*(__m128 *)v173, *(__m128 *)v173, 147);
      v67.m128_f32[0] = *(float *)&v173[12]
...
LABEL_190:
      ...
      *(float *)v173 = *(float *)&v190.left + *(float *)&v177.left;
      goto LABEL_191;
    }
    if ( v42 <= COERCE_FLOAT(COERCE_UNSIGNED_INT(
...
LABEL_187:
    v173[17] = v55 & 0xF3;
    v142 = v171;
    v143 = v44 + (float)(*(float *)&v177.top * *(float *)&v173[12]);
    v144 = *(__m128 *)&v172.m256i_u64[2];
    v142.m128_f32[0] = v171.m128_f32[0] + (float)(*(float *)&v177.left * v57);
    v145 = v43 + (float)(*(float *)&v177.right * *(float *)&v173[12]);
    v146 = _mm_shuffle_ps(v142, v142, 225);
    v147 = *(__m128 *)v172.m256i_i8;
    v144.m128_f32[0] = *(float *)&v172.m256i_i32[4] + (float)(*(float *)&v177.left * v58);
    v147.m128_f32[0] = *(float *)v172.m256i_i32 + (float)(*(float *)&v177.left * v56);
    v148 = _mm_shuffle_ps(v144, v144, 225);
    v149 = _mm_shuffle_ps(v147, v147, 225);
    v148.m128_f32[0] = *(float *)&v172.m256i_i32[5] + (float)(*(float *)&v177.top * v58);
    v149.m128_f32[0] = *(float *)&v172.m256i_i32[1] + (float)(*(float *)&v177.top * v56);
    v150 = _mm_shuffle_ps(v148, v148, 198);
    v146.m128_f32[0] = v171.m128_f32[1] + (float)(*(float *)&v177.top * v57);
    v151 = _mm_shuffle_ps(v149, v149, 198);
    v152 = _mm_shuffle_ps(v146, v146, 198);
    v150.m128_f32[0] = *(float *)&v172.m256i_i32[6] + (float)(*(float *)&v177.right * v58);
    v151.m128_f32[0] = *(float *)&v172.m256i_i32[2] + (float)(*(float *)&v177.right * v56);
    v39 = _mm_shuffle_ps(v150, v150, 201);
    v152.m128_f32[0] = v171.m128_f32[2] + (float)(*(float *)&v177.right * v57);
    v38 = _mm_shuffle_ps(v151, v151, 201);
    v37 = _mm_shuffle_ps(v152, v152, 201);
    *(__m128 *)&v172.m256i_u64[2] = v39;
    *(__m128 *)v172.m256i_i8 = v38;
    v171 = v37;
    *(float *)v173 = *(float *)&v190.left + (float)(*(float *)&v177.left * *(float *)&v173[12]);
LABEL_191:
    *(float *)&v173[8] = v145;
    *(float *)&v173[4] = v143;
    v40 = *(struct tagRECT *)v173;
