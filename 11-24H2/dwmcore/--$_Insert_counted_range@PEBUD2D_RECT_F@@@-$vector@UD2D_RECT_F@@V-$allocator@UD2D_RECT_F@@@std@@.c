/*
 * XREFs of ??$_Insert_counted_range@PEBUD2D_RECT_F@@@?$vector@UD2D_RECT_F@@V?$allocator@UD2D_RECT_F@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UD2D_RECT_F@@@std@@@std@@@1@PEBUD2D_RECT_F@@_K@Z @ 0x180026D40
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( a4 > (v6 - (__int64)v4) >> 4 )
    {
      ...
      std::vector<tagRECT>::_Change_array(a1, v19, v24, v13);
    }
    else
    {
      v11 = 16 * a4;
