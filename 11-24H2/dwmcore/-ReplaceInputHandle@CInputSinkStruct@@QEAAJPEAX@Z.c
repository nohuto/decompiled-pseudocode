/*
 * XREFs of ?ReplaceInputHandle@CInputSinkStruct@@QEAAJPEAX@Z @ 0x180095CC4
 * Callers:
 ...
 *     ?InitializeQueues@CInputSinkStruct@@AEAAXXZ @ 0x180096438 (-InitializeQueues@CInputSinkStruct@@AEAAXXZ.c)
...
__int64 __fastcall CInputSinkStruct::ReplaceInputHandle(CInputSinkStruct *this, void *a2)
{
  ...
  *((_QWORD *)this + 11) = v6;
  if ( v5 )
  {
    CompositionInputSink = NtQueryCompositionInputSink(v5, v12);
    if ( CompositionInputSink < 0 )
    {
      v3 = CompositionInputSink | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, CompositionInputSink | 0x10000000, 0x34u, 0LL);
    }
    else
    {
      v9 = *((_QWORD *)this + 8);
      ...
      *((_QWORD *)this + 11) = v10;
      ...
      if ( CompositionInputSinkLuid < 0 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, CompositionInputSinkLuid | 0x10000000, 0x37u, 0LL);
      }
      else
      {
