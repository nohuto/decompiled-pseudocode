/*
 * XREFs of ?ComputeLocalToSourceTransform@CSurfaceDrawListBrush@@QEBAXPEAVMatrix3x3@@@Z @ 0x1801B2824
 * Callers:
 ...
 *     ?TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z @ 0x1801B28D0 (-TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z.c)
 */
