/*
 * XREFs of ?GetBits@CaptureBitsResponse@@IEAAJXZ @ 0x180060C58
 * Callers:
...
__int64 __fastcall CaptureBitsResponse::GetBits(CaptureBitsResponse *this, __int64 a2, __int64 a3)
{
  ...
  ULONG v32; // [rsp+68h] [rbp+Fh]
  signed int v33; // [rsp+6Ch] [rbp+13h]
  unsigned __int128 v34; // [rsp+70h] [rbp+17h] BYREF
...
LABEL_30:
        ...
        {
          v22 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int128 *, _QWORD, _QWORD, int))(**((_QWORD **)this + 8)
                                                                                            + 128LL))(
                  *((_QWORD *)this + 8),
                  &v34,
                  *((_QWORD *)this + 246),
