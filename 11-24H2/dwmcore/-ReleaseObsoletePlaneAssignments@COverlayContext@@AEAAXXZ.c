/*
 * XREFs of ?ReleaseObsoletePlaneAssignments@COverlayContext@@AEAAXXZ @ 0x18005FF10
 * Callers:
...
void __fastcall COverlayContext::ReleaseObsoletePlaneAssignments(COverlayContext *this)
{
  ...
  __int64 (__fastcall *v8)(CGlobalCompositionSurfaceInfo *__hidden, unsigned __int64); // rax
  ...
  while ( v3 != v5 )
  {
    ...
    {
      v7 = *(_QWORD *)(v3 + 24);
      v8 = *(__int64 (__fastcall **)(CGlobalCompositionSurfaceInfo *__hidden, unsigned __int64))(*(_QWORD *)v6 + 288LL);
      ...
      COverlayContext::OverlayPlaneInfo::GetLocalClipRect(v3, v9, (char *)v4 + 120);
