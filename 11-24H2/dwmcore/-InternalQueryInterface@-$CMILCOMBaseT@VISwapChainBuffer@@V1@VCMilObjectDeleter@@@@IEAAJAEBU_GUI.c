/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VISwapChainBuffer@@V1@VCMilObjectDeleter@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C4594
 * Callers:
 *     ?QueryInterface@CLegacySwapChainBuffer@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C5280 (-QueryInterface@CLegacySwapChainBuffer@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
