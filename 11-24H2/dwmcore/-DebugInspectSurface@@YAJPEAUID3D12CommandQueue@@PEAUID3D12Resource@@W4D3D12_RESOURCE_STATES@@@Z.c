/*
 * XREFs of ?DebugInspectSurface@@YAJPEAUID3D12CommandQueue@@PEAUID3D12Resource@@W4D3D12_RESOURCE_STATES@@@Z @ 0x1802AE200
 * Callers:
        ...
        enum D3D12_RESOURCE_STATES a3)
{
  ...
  void *v26; // [rsp+78h] [rbp-88h] BYREF
  ...
  unsigned int v45[4]; // [rsp+140h] [rbp+40h]
  int v46; // [rsp+150h] [rbp+50h] BYREF
  __int128 v47; // [rsp+154h] [rbp+54h]
      ...
      if ( v18 >= 0 )
      {
        ...
        if ( v18 >= 0 )
        {
          ...
          if ( v18 >= 0 )
          {
            ...
            if ( v18 >= 0 )
            {
              DebugInspectSysMemSurface(v26, v51, v52, v53, v45[2]);
              v48 = 0LL;
              (*(void (__fastcall **)(__int64, _QWORD, __int128 *))(*(_QWORD *)v22 + 72LL))(v22, 0LL, &v48);
