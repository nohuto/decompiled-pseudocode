/*
 * XREFs of ?GetProperty@CCompositionAmbientLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180219CB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValue *a3)
{
  ...
  v4 = (void **)&CCompositionAmbientLight::k_rgAnimDef;
  v5 = 0;
  while ( 1 )
  {
    if ( v4 == &CRectResource::`vftable' )
      goto LABEL_3;
