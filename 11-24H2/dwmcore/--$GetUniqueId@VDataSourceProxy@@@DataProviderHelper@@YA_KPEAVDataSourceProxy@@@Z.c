/*
 * XREFs of ??$GetUniqueId@VDataSourceProxy@@@DataProviderHelper@@YA_KPEAVDataSourceProxy@@@Z @ 0x18025E7B4
 * Callers:
 ...
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x180271D80 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
