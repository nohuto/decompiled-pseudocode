/*
 * XREFs of ??1?$unique_ptr@$$BY0A@U?$aligned_storage_for@URampPair@CoordMap@@@detail@@U?$default_delete@$$BY0A@U?$aligned_storage_for@URampPair@CoordMap@@@detail@@@std@@@std@@QEAA@XZ @ 0x180224070
 * Callers:
