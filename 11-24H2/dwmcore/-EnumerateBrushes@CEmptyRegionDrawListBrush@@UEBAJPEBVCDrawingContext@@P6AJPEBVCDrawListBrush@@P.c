/*
 * XREFs of ?EnumerateBrushes@CEmptyRegionDrawListBrush@@UEBAJPEBVCDrawingContext@@P6AJPEBVCDrawListBrush@@PEAX@Z2@Z @ 0x1801F52C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEmptyRegionDrawListBrush::EnumerateBrushes(
        ...
        __int64 (__fastcall *a3)(__int64 **a1, unsigned int *a2, __int64 a3),
        unsigned int *a4)
{
  __int64 v4; // rax
  __int64 v8; // rax
...
LABEL_8:
    while ( v16 < v27 )
    {
      ...
      *(_OWORD *)(v18 + 32) = v25;
      v21 = ((__int64 (__fastcall *)(_QWORD, unsigned int *))a3)(*((_QWORD *)this + 10), a4);
      v11 = v21;
      if ( v21 < 0 )
      {
  ...
  *(_QWORD *)(v8 + 24) = *((_QWORD *)this + 3);
  ...
  if ( a3 == lambda_6f49ef1c5e266dfff6ad3ca7d4dec8df_::_lambda_invoker_cdecl_ )
    v10 = lambda_6f49ef1c5e266dfff6ad3ca7d4dec8df_::_lambda_invoker_cdecl_(v9, a4, (__int64)a3);
  else
    v10 = ((__int64 (__fastcall *)(__int64 **, unsigned int *))a3)(v9, a4);
  v11 = v10;
  if ( v10 < 0 )
