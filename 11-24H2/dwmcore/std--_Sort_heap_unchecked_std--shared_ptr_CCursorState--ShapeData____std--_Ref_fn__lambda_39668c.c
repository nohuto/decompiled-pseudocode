/*
 * XREFs of std::_Sort_heap_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_39668c2dc6e40fe158f11373301c566a_____ @ 0x1802B12FC
 * Callers:
...
signed __int64 __fastcall std::_Sort_heap_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_39668c2dc6e40fe158f11373301c566a_____(
        __int64 *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  if ( result >= 32 )
  {
    ...
    do
    {
      ...
      *v6 = 0LL;
      ...
      std::_Pop_heap_hole_by_index_std::shared_ptr_CCursorState::ShapeData____std::shared_ptr_CCursorState::ShapeData__std::_Ref_fn__lambda_39668c2dc6e40fe158f11373301c566a_____(
        (__int64)a1,
        0LL,
        ((__int64)v6 + v7 + 8) >> 4,
        &v11,
