/*
 * XREFs of ?NotifyOnChanged@CProjectedShadowCaster@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18021DC60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CProjectedShadowCaster::NotifyOnChanged(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdx
