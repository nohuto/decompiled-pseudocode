/*
 * XREFs of ?Initialize@CConversionSwapChain@@MEAAJXZ @ 0x1802CB610
 * Callers:
...
__int64 __fastcall CConversionSwapChain::Initialize(CConversionSwapChain *this)
{
  ...
  {
    v6 = CConversionSwapChain::EnsureTargetBitmap(this, v3, v4);
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x5Fu, 0LL);
  }
  return v5;
}
