/*
 * XREFs of ?NotifyInvalidResource@CDxHandleYUVBitmapRealization@@UEAAXPEBVIDeviceResource@@@Z @ 0x1802D9350
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct IDeviceResource *a2)
{
  ...
  CGlobalDrawingContext *v6; // [rsp+30h] [rbp+8h] BYREF

  v2 = (CDxHandleYUVBitmapRealization *)((char *)this - 16);
  v6 = (CDxHandleYUVBitmapRealization *)((char *)this - 16);
