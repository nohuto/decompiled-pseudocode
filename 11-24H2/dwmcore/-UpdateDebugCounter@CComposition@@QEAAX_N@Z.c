/*
 * XREFs of ?UpdateDebugCounter@CComposition@@QEAAX_N@Z @ 0x18025C628
 * Callers:
 *     ?CloseChannel@CComposition@@IEAAJI@Z @ 0x18019E1F4 (-CloseChannel@CComposition@@IEAAJI@Z.c)
 *     ?SetIsDebugCounterEnabled@?$CChannelGeneratedT@VCChannelContext@@V?$CMILRefCountBaseT@UIMILRefCount@@VCMilObjectDeleter@@@@@@QEAAJ_N@Z @ 0x180278AAC (-SetIsDebugCounterEnabled@-$CChannelGeneratedT@VCChannelContext@@V-$CMILRefCountBaseT@UIMILRefCo.c)
 * Callees:
