/*
 * XREFs of ?NotifyRenderedRect@CDDisplayRenderTarget@@IEAAXPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@_N@Z @ 0x1801EC14C
 * Callers:
...
int __fastcall CDDisplayRenderTarget::NotifyRenderedRect(__int64 a1, struct D2D_RECT_F *a2, char a3)
{
  ...
  if ( a2 )
  {
    if ( !a3 )
    {
      v5 = *(_BYTE *)(a1 + 19313) != 0;
      v11 = 0LL;
      CMILMatrix::Transform2DBoundsHelper<0>(a1 + (v5 ? 30700LL : 30564LL), a2, (float *)&v11);
