/*
 * XREFs of ?CreateDeviceBitmap@CGdiSpriteBitmap@@AEAAJPEAXU_LUID@@II@Z @ 0x18002699C
 * Callers:
 ...
 *     ?RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ @ 0x18020826C (-RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ.c)
...
LABEL_10:
  ...
  if ( v20 >= 0 && *((_QWORD *)this + 56) )
  {
    ...
    v15 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x7Au, 0LL);
  }
  else
  {
