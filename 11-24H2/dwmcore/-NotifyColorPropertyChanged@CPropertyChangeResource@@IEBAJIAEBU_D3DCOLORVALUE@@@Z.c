/*
 * XREFs of ?NotifyColorPropertyChanged@CPropertyChangeResource@@IEBAJIAEBU_D3DCOLORVALUE@@@Z @ 0x180292564
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
         ...
         11LL) )
  {
    ...
    v14 = v9;
    v11 = CoreUICallSend(v10, v13, 2LL, 11LL, 5, &unk_18032BF84, a2, &v14, ChannelCallbackId);
    if ( v11 != -2018375675 )
      v6 = v11;
    if ( v6 < 0 )
