/*
 * XREFs of ?CollectAdditionalDirtyRects@CVisual@@MEAAJPEBVCVisualTree@@PEAVCTreeDirty@@AEBVCMILMatrix@@PEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180039D50
 * Callers:
 ...
 *     ?GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ @ 0x18003A248 (-GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ.c)
 ...
 *     ?Reset@CMergedDirtyRect@@QEAAXXZ @ 0x1801DC32C (-Reset@CMergedDirtyRect@@QEAAXXZ.c)
          ...
          if ( (unsigned __int8)CVisual::AdjustContentWorldBounds(a1) )
          {
            ...
            if ( v32 > v27 && v35 > v29 )
            {
              if ( !*((_BYTE *)a3 + 2324) )
              {
                if ( v32 <= v27 || v35 <= v29 )
                {
                  if ( !(unsigned __int8)TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsWellOrdered(&v45) )
                  {
...
LABEL_86:
                    wil::details::in1diag3::Return_Hr(
                      ...
                      (const char *)v41);
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xE5Cu, 0LL);
                    return v6;
                  }
                }
...
LABEL_85:
  wil::details::in1diag3::Return_Hr(
    ...
    (int)"onecoreuap\\windows\\dwm\\dwmcore\\engine\\treedirty.cpp",
    (const char *)v39);
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xE42u, 0LL);
  return v6;
}
