/*
 * XREFs of ?DispatchBatches@CKernelTransport@@UEAAJPEAVCComposition@@_K@Z @ 0x18007C1A0
 * Callers:
 ...
 *     ?Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x1801FEFF4 (-Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z.c)
 *     ?MilUnexpectedError@@YAXJPEBG@Z @ 0x180249408 (-MilUnexpectedError@@YAXJPEBG@Z.c)
 *     ?Log_Hr@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x180249CC0 (-Log_Hr@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z.c)
 *     ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x18024EB9C (-GetStackCaptureRootFailureAddress@@YAPEAXJ@Z.c)
...
__int64 __fastcall CKernelTransport::DispatchBatches(CKernelTransport *this, struct CComposition *a2, __int64 a3)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v44; // [rsp+80h] [rbp-39h] BYREF
  int *v45; // [rsp+90h] [rbp-29h]
  __int64 v46; // [rsp+98h] [rbp-21h]
  unsigned int *v47; // [rsp+A0h] [rbp-19h]
  __int64 v48; // [rsp+A8h] [rbp-11h]
  struct _EVENT_DATA_DESCRIPTOR v49; // [rsp+B0h] [rbp-9h] BYREF
  ...
  while ( v8 )
  {
    ...
    switch ( *(_DWORD *)v8 )
    {
      case 7:
        ...
        {
          v27 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x6B6u, 0LL);
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x1DFu, 0LL);
          v10 = -2147024809;
LABEL_42:
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x1C1u, 0LL);
LABEL_43:
          wil::details::in1diag3::Return_Hr(
            retaddr,
            (void *)0xF2,
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x22Au, 0LL);
LABEL_48:
        if ( !IsOOM(v27) )
        {
        ...
        if ( v27 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x1E3u, 0LL);
LABEL_35:
      ...
      case 6:
        ...
        if ( v28 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x1C6u, 0LL);
          goto LABEL_43;
        }
        break;
      default:
