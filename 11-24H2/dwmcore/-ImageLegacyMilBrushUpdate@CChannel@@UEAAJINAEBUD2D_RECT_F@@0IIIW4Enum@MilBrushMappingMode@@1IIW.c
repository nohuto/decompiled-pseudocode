/*
 * XREFs of ?ImageLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUD2D_RECT_F@@0IIIW4Enum@MilBrushMappingMode@@1IIW43MilStretch@@W43MilTileMode@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@I@Z @ 0x18012E520
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a17)
{
  ...
  CChannel::CheckOptionalHandle(a1, a6, 62LL);
  CChannel::CheckOptionalHandle(a1, a7, 174LL);
  CChannel::CheckOptionalHandle(a1, a8, 174LL);
  CChannel::CheckOptionalHandle(a1, a11, 128LL);
  CChannel::CheckOptionalHandle(a1, a12, 128LL);
  CChannel::CheckOptionalHandle(a1, a17, 85LL);
  v27 = 551;
  v20 = a3;
  *(_DWORD *)v28 = a2;
  *(float *)&v28[4] = v20;
