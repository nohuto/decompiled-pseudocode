/*
 * XREFs of ??0CInteractionContextWrapper@@QEAA@XZ @ 0x1800EEA64
 * Callers:
 ...
 *     ??0?$CQueue@PEAVCBufferedInteractionOutput@@@@QEAA@XZ @ 0x1800EEC64 (--0-$CQueue@PEAVCBufferedInteractionOutput@@@@QEAA@XZ.c)
 *     ??0CInteractionContextTransformHelper@@QEAA@XZ @ 0x1800EEC9C (--0CInteractionContextTransformHelper@@QEAA@XZ.c)
 */
