/*
 * XREFs of ?NotifyBooleanPropertyChanged@CPropertyChangeResource@@IEBAJI_N@Z @ 0x180292470
 * Callers:
        ...
        unsigned __int8 a3)
{
         ...
         11LL) )
  {
    ...
    v10 = CoreUICallSend(v9, v13, 2LL, 11LL, 1, &unk_18032BF6E, a2, v12, ChannelCallbackId);
    if ( v10 != -2018375675 )
      v6 = v10;
    if ( v6 < 0 )
