/*
 * XREFs of ?OnRegisterError@BamoDataProviderRegistrarStubImpl@BamoImpl@@QEAAJI@Z @ 0x18027097C
 * Callers:
 *     ?CallOnRegisterErrorOnStub@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@I@Z @ 0x1802706E4 (-CallOnRegisterErrorOnStub@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@.c)
...
LABEL_7:
  ...
  v10[1] = v13;
  return CoreUICallSend(v14, v10, 2LL, 3LL, 0, &unk_180383D65, a2, v9, v12);
}
