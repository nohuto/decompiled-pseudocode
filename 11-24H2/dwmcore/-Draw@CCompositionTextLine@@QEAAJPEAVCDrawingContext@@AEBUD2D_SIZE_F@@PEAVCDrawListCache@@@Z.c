/*
 * XREFs of ?Draw@CCompositionTextLine@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18029897C
 * Callers:
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( !*((_QWORD *)this + 11) )
    return 0LL;
  v4 = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext *, const struct D2D_SIZE_F *, struct CDrawListCache *))(**((_QWORD **)this + 14) + 200LL))(
         *((_QWORD *)this + 14),
         a2,
         a3,
         a4);
