/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CadBugs@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18024FAC8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_CadBugs@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18024DC2C (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_CadBugs@@@details@wil@@QEAAX_NW4Reporting.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CadBugs@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18024FBF4 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_CadBugs@@@details@wil@@.c)
 */
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_CadBugs>::GetCurrentFeatureEnabledState(v7, &v17, &v16);
