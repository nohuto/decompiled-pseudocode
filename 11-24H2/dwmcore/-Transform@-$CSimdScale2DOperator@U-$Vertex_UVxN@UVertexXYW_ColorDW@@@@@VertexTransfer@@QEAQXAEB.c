/*
 * XREFs of ?Transform@?$CSimdScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@T__m128@@2IPEAU3@@Z @ 0x180163BB0
 * Callers:
        ...
        __m128 *a7)
{
  ...
  v10 = a1[1];
  v11 = _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v9, v9, 85), v10), _mm_mul_ps(_mm_shuffle_ps(v9, v9, 0), *a1));
  ...
  if ( (_BYTE)result != 3 )
  {
    ...
    v12 = _mm_mul_ps(_mm_shuffle_ps(v12, v12, 0), _mm_shuffle_ps(v8, v8, 170));
  }
  v15 = _mm_or_ps(
          _mm_andnot_ps(
  ...
  v16 = (__m128)(unsigned int)`CVisual::SetOpacityInternal'::`2'::sc_defaultValue;
  *a7 = _mm_shuffle_ps(
          _mm_add_ps(
            _mm_add_ps(
              _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v8, v8, 85), v10), a1[2]),
  ...
  if ( a6 )
  {
    ...
    do
    {
      *(__m128 *)((char *)result + (_QWORD)v18) = _mm_add_ps(
                                                    _mm_mul_ps(
                                                      _mm_sub_ps(*result, *(__m128 *)((char *)result + (_QWORD)v17)),
                                                      v20),
