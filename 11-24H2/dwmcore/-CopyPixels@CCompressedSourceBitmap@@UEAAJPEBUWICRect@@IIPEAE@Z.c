/*
 * XREFs of ?CopyPixels@CCompressedSourceBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x1802556F0
 * Callers:
 *     ?CopyPixels@CCompressedSourceBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z @ 0x1802557A0 (-CopyPixels@CCompressedSourceBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
