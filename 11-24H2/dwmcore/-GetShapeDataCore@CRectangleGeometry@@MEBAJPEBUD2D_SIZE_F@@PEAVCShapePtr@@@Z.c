/*
 * XREFs of ?GetShapeDataCore@CRectangleGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x1800C50B0
 * Callers:
        ...
        CRectanglesShape **a3)
{
  ...
  void (__fastcall *v20)(CRoundedRectangleShape *, _QWORD); // rax
  char v22; // al
  bool v23; // cl
  _DWORD *v24; // rbx
  int v25; // ecx
    ...
    *((_QWORD *)&v65 + 1) = __PAIR64__(LODWORD(v14), LODWORD(v13));
    if ( !((v29 - (__int64)v27) >> 4) )
    {
      if ( v30 + 1 < v30 )
      {
        ...
        __debugbreak();
LABEL_69:
        if ( (char *)v20 == (char *)CRoundedRectangleShape::`vector deleting destructor' )
        {
...
LABEL_13:
  if ( *((_BYTE *)a3 + 8) )
  {
    ...
    if ( *a3 )
    {
      v20 = **(void (__fastcall ***)(CRoundedRectangleShape *, _QWORD))v19;
