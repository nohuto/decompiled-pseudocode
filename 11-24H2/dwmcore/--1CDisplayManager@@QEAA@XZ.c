/*
 * XREFs of ??1CDisplayManager@@QEAA@XZ @ 0x18024BFD8
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DisplayManager__ @ 0x1802DFCE0 (_dynamic_atexit_destructor_for__g_DisplayManager__.c)
 * Callees:
