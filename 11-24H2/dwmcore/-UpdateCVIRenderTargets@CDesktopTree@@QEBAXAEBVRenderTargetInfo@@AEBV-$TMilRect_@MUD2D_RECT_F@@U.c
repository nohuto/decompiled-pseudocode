/*
 * XREFs of ?UpdateCVIRenderTargets@CDesktopTree@@QEBAXAEBVRenderTargetInfo@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800D5570
 * Callers:
...
void __fastcall CDesktopTree::UpdateCVIRenderTargets(struct CVisualTree *a1, __int64 a2, struct D2D_RECT_F *a3)
{
  ...
  CVisual **v8; // rax
  CVisual *v9; // rbx
  bool (__fastcall *i)(CDeviceTextureTarget *); // rcx
  _QWORD *v11; // r10
  ...
  __int64 v31; // rax
  __int64 v32; // rdx
  bool (__fastcall *v33)(CDeviceTextureTarget *); // rdx
  char v34; // al
  ...
  void **v62; // rbx
  void **v63; // rax
  bool (__fastcall **TreeDataListHead)(CDeviceTextureTarget *); // rax
  char IsProtected; // al
  __int64 *v66; // rcx
  __int64 v67; // rax
  ...
  struct _EVENT_DATA_DESCRIPTOR *v97; // [rsp+D8h] [rbp-28h]
  ...
  struct _EVENT_DATA_DESCRIPTOR v112; // [rsp+160h] [rbp+60h] BYREF
    ...
    *((_DWORD *)a1 + 1052) = 0x7FFFFFFF;
    ...
    while ( 1 )
    {
      if ( v7 == v8 )
      {
        ...
        while ( v37 != v38 )
        {
          if ( (int)CThreadContext::RegisterGraphWalkRoot(*(unsigned __int64 **)v37) >= 0 )
          {
            if ( !*(_BYTE *)(v37 + 32)
      ...
      lpMem = &v98;
      *(_QWORD *)&v85 = 0LL;
      v97 = (struct _EVENT_DATA_DESCRIPTOR *)&v100;
      v96 = &v99;
      *((_QWORD *)&v85 + 1) = a1;
      v98 = v85;
...
LABEL_10:
      ...
      while ( 1 )
      {
        ...
        i = *(bool (__fastcall **)(CDeviceTextureTarget *))&(*v12)[130].left;
        v15 = *(_QWORD *)&(*v12)[129].right;
        a3 = (struct D2D_RECT_F *)((char *)i - v15);
        if ( (bool (__fastcall *)(CDeviceTextureTarget *))((char *)i - v15) == (bool (__fastcall *)(CDeviceTextureTarget *))(v96 - (_BYTE *)lpMem) )
          break;
LABEL_124:
        ++v12;
      }
      ...
      a3 = *v12;
      i = *(bool (__fastcall **)(CDeviceTextureTarget *))(v11[31] + 24LL);
...
LABEL_49:
              ...
              {
                v33 = *(bool (__fastcall **)(CDeviceTextureTarget *))(v32 + 176);
            ...
            if ( v51 > v52 && v42 > v21.left && v50 > v44 && v41 > v52 && v51 > v43 )
            {
              ...
              if ( right > v81->left )
              {
                  ...
                  && v51 > v81->top )
                {
                  ...
                  v57 = *(__m128 *)(v18 + 96);
                  v58 = _mm_shuffle_ps(v57, v57, 170).m128_f32[0];
                  v100 = v57;
                  if ( v58 > v57.m128_f32[0] )
                  {
                    v59 = _mm_shuffle_ps(v57, v57, 255).m128_f32[0];
                    v60 = _mm_shuffle_ps(v57, v57, 85).m128_f32[0];
                    if ( v59 > v60 )
                    {
                      if ( !v55 )
                        goto LABEL_92;
                      ...
                      if ( v20 )
                      {
                        LODWORD(v90.left) = v57.m128_i32[0];
                        v90.top = v60;
                        v90.right = v58;
                        v90.bottom = v59;
                      }
                      ...
                      {
                        COcclusionContext::PageInPixelsRectToDeviceRect((char *)a1 + 2648, &v100, &v90, v56);
                      }
                      if ( !(unsigned __int8)CArrayBasedCoverageSet::IsCovered((char *)a1 + 3264, &v90) )
                      {
LABEL_92:
                        v61 = *(_QWORD *)(v18 + 80);
                        *(_QWORD *)&v90.left = 0LL;
                        if ( (*(int (__fastcall **)(__int64, __int64, struct D2D_RECT_F *))(v61 + 96))(
                               ...
                               &v90) >= 0 )
                        {
                          v62 = (void **)DwmDbg::DbgString::DbgString(&v88, word_18032AF78);
...
LABEL_56:
    ...
    TreeDataListHead = (bool (__fastcall **)(CDeviceTextureTarget *))CVisual::GetTreeDataListHead(v9);
    if ( TreeDataListHead )
    {
      for ( i = *TreeDataListHead;
            (char *)i != (char *)TreeDataListHead;
            i = *(bool (__fastcall **)(CDeviceTextureTarget *))i )
      {
        v11 = (_QWORD *)((char *)i - 352);
