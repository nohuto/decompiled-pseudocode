/*
 * XREFs of ?SendMaterializeProxy@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180270ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v10 = CoreUICallSend(a2, &v18, 2LL, 7LL, 2, &unk_180383D65, ItemId, v16, v18);
  if ( v10 < 0 )
  ...
  v18 = *(unsigned int *)(v3 + 36);
  v19 = *(unsigned int *)(v3 + 40);
  v13 = CoreUICallSend(a2, &v18, 2LL, 7LL, 5, &unk_180383D65, v12, v17, v18);
  if ( v13 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x2E29,
