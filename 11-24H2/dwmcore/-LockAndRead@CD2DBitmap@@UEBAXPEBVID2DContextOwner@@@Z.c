/*
 * XREFs of ?LockAndRead@CD2DBitmap@@UEBAXPEBVID2DContextOwner@@@Z @ 0x1802CD5F0
 * Callers:
 *     ?LockAndRead@?$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@UEBAXPEBVID2DContextOwner@@@Z @ 0x1802CDC70 (-LockAndRead@-$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@UEBAXPEBVID2DContext.c)
 * Callees:
