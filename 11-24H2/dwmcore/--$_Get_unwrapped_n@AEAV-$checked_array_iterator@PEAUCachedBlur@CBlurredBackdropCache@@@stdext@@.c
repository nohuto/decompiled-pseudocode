/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@stdext@@_J@Z @ 0x180220398
 * Callers:
