/*
 * XREFs of ?EtwLogCurrentState@CDrawingContext@@QEBAXXZ @ 0x1801C3E00
 * Callers:
 ...
 *     ?GetOwningProcessId@CWindowNode@@UEBAKXZ @ 0x1801C4280 (-GetOwningProcessId@CWindowNode@@UEBAKXZ.c)
