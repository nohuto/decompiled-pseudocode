/*
 * XREFs of ?EnsureOverlaySwapChainWeakRef@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJPEAVIOverlaySwapChain@@@Z @ 0x1801DF404
 * Callers:
        ...
        struct IOverlaySwapChain *a2)
{
  ...
  if ( !*((_QWORD *)this + 24) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x784u, 0LL);
    }
    else
    {
      v8 = v12;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x786u, 0LL);
