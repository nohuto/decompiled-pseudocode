/*
 * XREFs of ?DispatchScribbles@CComputeScribbleFramebuffer@@QEAAJPEAUID3D12CommandQueue@@PEAVCComputeScribbleStopwatch@@_KPEAUIDCompositionDirectInkSuperWetRenderer@@PEAUComputeScribbleLatencyData@@@Z @ 0x1801C6470
 * Callers:
        ...
        struct ComputeScribbleLatencyData *a6)
{
  ...
  CComputeScribbleFramebuffer::LockForDraw(this, &v27);
  v10 = 0;
  if ( !this[11] )
    goto LABEL_6;
  v11 = a6;
