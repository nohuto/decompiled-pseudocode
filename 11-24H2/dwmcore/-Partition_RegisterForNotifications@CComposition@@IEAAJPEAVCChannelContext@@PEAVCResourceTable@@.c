/*
 * XREFs of ?Partition_RegisterForNotifications@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_REGISTERFORNOTIFICATIONS@@@Z @ 0x18022B67C
 * Callers:
...
LABEL_14:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x40Fu, 0LL);
        return 0LL;
      }
      if ( v10 > *((_DWORD *)v4 + 5) )
      {
