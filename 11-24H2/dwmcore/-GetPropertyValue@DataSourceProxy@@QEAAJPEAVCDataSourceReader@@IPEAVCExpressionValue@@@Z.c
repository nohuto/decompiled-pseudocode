/*
 * XREFs of ?GetPropertyValue@DataSourceProxy@@QEAAJPEAVCDataSourceReader@@IPEAVCExpressionValue@@@Z @ 0x1801A7FC4
 * Callers:
 ...
 *     ?GetEffectiveCompositionFrameId@CComposition@@QEBA_KXZ @ 0x1801A88D0 (-GetEffectiveCompositionFrameId@CComposition@@QEBA_KXZ.c)
