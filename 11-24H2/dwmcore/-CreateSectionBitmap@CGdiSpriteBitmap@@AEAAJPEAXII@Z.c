/*
 * XREFs of ?CreateSectionBitmap@CGdiSpriteBitmap@@AEAAJPEAXII@Z @ 0x1800266BC
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::CreateSectionBitmap(CGdiSpriteBitmap *this, void *a2, UINT32 a3, UINT32 a4)
{
  ...
  if ( v10 > 0xFFFFFFFF )
  {
    ...
    v16 = 282;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, v16, 0LL);
    if ( a2 )
      CloseHandle(a2);
    goto LABEL_18;
  }
  ...
  if ( v19 >= 0 )
  {
    wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset((char *)this + 448);
    v20 = v24;
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x140u, 0LL);
