/*
 * XREFs of ?GetShaderResourceView@CDrawListBitmap@@QEBAJAEBVRenderTargetInfo@@PEAPEAUID3D11ShaderResourceView@@PEAUPixelFormatInfo@@@Z @ 0x18010C510
 * Callers:
        ...
        struct PixelFormatInfo *a4)
{
  ...
  v23[0] = 0LL;
  wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset(v23, (__int64)a2, (__int64)a3);
