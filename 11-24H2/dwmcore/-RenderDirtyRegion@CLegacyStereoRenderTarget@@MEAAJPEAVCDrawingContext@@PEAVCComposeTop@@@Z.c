/*
 * XREFs of ?RenderDirtyRegion@CLegacyStereoRenderTarget@@MEAAJPEAVCDrawingContext@@PEAVCComposeTop@@@Z @ 0x1802844F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetClearMode@CLegacyStereoRenderTarget@@MEBA?AW4Enum@ClearMode@@XZ @ 0x180276540 (-GetClearMode@CLegacyStereoRenderTarget@@MEBA-AW4Enum@ClearMode@@XZ.c)
 */
        ...
        struct CComposeTop *a3)
{
  ...
  else if ( *((_DWORD *)this + 7696) && (!*((_BYTE *)this + 33528) || *(_DWORD *)(*((_QWORD *)this + 3) + 832LL)) )
  {
    v8 = CDrawingContext::PushRenderTarget(
           a2,
           (struct IDeviceTarget *)((*(_QWORD *)(*((_QWORD *)this + 4190) + 512LL) + 16LL) & -(__int64)(*(_QWORD *)(*((_QWORD *)this + 4190) + 512LL) != 0LL)));
    v7 = v8;
    if ( v8 < 0 )
    {
    ...
    {
      OcclusionContext = CMonitorDirty::GetOcclusionContext((CLegacyStereoRenderTarget *)((char *)this + 30768), v9, v3);
      ...
      CMergedRectBase<8>::GetRects((unsigned int *)this + 7696, &v23);
      v14 = (_QWORD *)(v24 + 16 * v23);
      for ( i = (_QWORD *)(v24 + 8); i - 1 != v14; i += 2 )
      {
        v16 = *((_DWORD *)i - 2);
        v17 = *((_DWORD *)i - 1);
        v18 = (struct CVisualTree *)*((_QWORD *)this + 14);
        v25 = 0;
        v26 = 0;
        v23 = __PAIR64__(v17, v16);
        v24 = *i;
        v19 = CDrawingContext::DrawVisualTree(a2, v18, (float *)&v23, OcclusionContext, ClearMode, v12, 0LL);
        v7 = v19;
        if ( v19 < 0 )
        {
