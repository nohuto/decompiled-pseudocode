/*
 * XREFs of ?ProcessSetViewBox@CShapeVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SHAPEVISUAL_SETVIEWBOX@@@Z @ 0x1802A6170
 * Callers:
        ...
        const struct tagMILCMD_SHAPEVISUAL_SETVIEWBOX *a3)
{
  ...
  CVectorShape *v10; // [rsp+50h] [rbp+18h] BYREF
