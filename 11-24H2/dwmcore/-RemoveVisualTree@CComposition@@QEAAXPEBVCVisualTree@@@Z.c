/*
 * XREFs of ?RemoveVisualTree@CComposition@@QEAAXPEBVCVisualTree@@@Z @ 0x18008D168
 * Callers:
...
void __fastcall CComposition::RemoveVisualTree(CComposition *this, const struct CVisualTree *a2)
{
  ...
  for ( i = (const struct CVisualTree **)*((_QWORD *)this + 50); i != *((const struct CVisualTree ***)this + 51); ++i )
  {
    if ( *i == a2 )
    {
      if ( *((_BYTE *)this + 5664) )
      {
        v6 = detail::vector_facade<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>,detail::buffer_impl<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>,4,1,detail::liberal_expansion_policy>>::reserve_region(
               (__int64 **)this + 69,
