/*
 * XREFs of ?PopCpuClipFromScope@CScopedClipStack@@QEAAXPEAVCDrawingContext@@PEA_N@Z @ 0x180077F10
 * Callers:
 ...
 *     ??Y?$checked_array_iterator@PEAUCpuClipStackState@CScopedClipStack@@@stdext@@QEAAAEAV01@_J@Z @ 0x1801CB1B0 (--Y-$checked_array_iterator@PEAUCpuClipStackState@CScopedClipStack@@@stdext@@QEAAAEAV01@_J@Z.c)
...
void __fastcall CScopedClipStack::PopCpuClipFromScope(CScopedClipStack *this, struct CDrawingContext *a2, bool *a3)
{
  ...
  _BYTE *v40; // rdx
  __int64 v41; // r8
  struct CDrawingContext *v42; // rsi
  __int64 v43; // rbx
  int v44; // eax
  int v45; // eax
  _QWORD **v46; // rcx
    ...
    if ( v109[1] )
    {
      if ( CCommonRegistryData::CpuClipAASinkEnableIntermediates )
      {
        ...
        *((float *)&v112 + 1) = FLOAT_3_4028235e38;
        ...
        {
          v33 = (__m128i)v30[7];
          if ( *(float *)v33.m128i_i32 <= v28 || v29 <= *((float *)v30 + 6) )
          {
            if ( v27 > 1 )
            {
...
LABEL_68:
        ...
        else
        {
          v42 = v116;
          v43 = v113;
          v44 = CCpuClipAntialiasSinkContext::ProcessRenderCommands_OffscreenRenderPass(v113, v116, v9, v109, v124);
          if ( v44 < 0 )
          {
      ...
      v45 = CCpuClipAntialiasSinkContext::ProcessRenderCommands_RenderPass(v43, v42, v9, v109);
      if ( v45 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
          retaddr,
