/*
 * XREFs of ?ProcessSetPrimitives@CAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATION_SETPRIMITIVES@@@Z @ 0x1801E593C
 * Callers:
        ...
        const struct tagMILCMD_ANIMATION_SETPRIMITIVES *a3)
{
  ...
  if ( HANDLE_TABLE::ValidEntry((struct CResourceTable *)((char *)a2 + 16), *((_DWORD *)a3 + 2))
    ...
    && ((v9 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v8 + 64LL), v9 == CKeyframeAnimation::IsOfType)
      ? (v10 = CKeyframeAnimation::IsOfType(v8, 157))
      : v9 != CVisual::IsOfType
      ? (v9 != CSharedSection::IsOfType
       ? (v10 = v9(v8, 157))
       : (v10 = CSharedSection::IsOfType(v8, 157)))
      : (v10 = CVisual::IsOfType(v8, 157)),
        v10) )
  {
