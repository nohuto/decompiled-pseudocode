/*
 * XREFs of ?ConvertSingleDesktopPlane@CConversionSwapChain@@IEAAJXZ @ 0x180064EEC
 * Callers:
...
__int64 __fastcall CConversionSwapChain::ConvertSingleDesktopPlane(CConversionSwapChain *this)
{
  ...
  _BYTE v24[16]; // [rsp+A0h] [rbp+2Fh] BYREF
  ...
  if ( **((_DWORD **)this + 100) )
  {
    ...
    else
    {
      ...
      while ( (unsigned __int64)v21 < v20 )
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x291u, 0LL);
          break;
        }
