/*
 * XREFs of McTemplateU0qttttt_EventWriteTransfer @ 0x180223FAC
 * Callers:
...
ULONG __fastcall McTemplateU0qttttt_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v19 = 4LL;
  v21 = 4LL;
  return McGenEventWrite_EventWriteTransfer(Microsoft_Windows_Dwm_Compositor_Context, &WaitForWork_Stop, a3, 7u, &v9);
}
