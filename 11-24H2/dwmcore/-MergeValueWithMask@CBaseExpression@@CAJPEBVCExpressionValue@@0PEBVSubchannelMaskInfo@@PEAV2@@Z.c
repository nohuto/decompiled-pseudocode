/*
 * XREFs of ?MergeValueWithMask@CBaseExpression@@CAJPEBVCExpressionValue@@0PEBVSubchannelMaskInfo@@PEAV2@@Z @ 0x18000EB50
 * Callers:
        ...
        struct CExpressionValue *a4)
{
  ...
  if ( !v9 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x78Du, 0LL);
    return 2147942487LL;
  }
  if ( v9 == 1 )
  {
...
LABEL_22:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x7C7u, 0LL);
      return 2147500037LL;
    }
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x796u, 0LL);
    return 2147942487LL;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x7A0u, 0LL);
  return 2147500037LL;
}
