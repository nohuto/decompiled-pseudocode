/*
 * XREFs of ?ListenForSurfaceNotifications@CBitmapRenderStrategy@@UEBA_NPEBVCResource@@@Z @ 0x1801D2C60
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CResource *a2)
{
  ...
  v3 = v2 == CCompositionSurfaceBitmap::IsOfType || v2((__int64)a2, 42);
  return v3 == 0;
}
