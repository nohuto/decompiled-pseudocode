/*
 * XREFs of ?Free@?$CThreadLocalObjectCache@VCDrawListEntry@@V1@@@SAXPEAX@Z @ 0x18011058C
 * Callers:
...
int __fastcall CThreadLocalObjectCache<CDrawListEntry,CDrawListEntry>::Free(_QWORD *lpMem)
{
  _DWORD *Value; // rbx
  __int64 v3; // rax
  ...
  LODWORD(v3) = Value[36];
  if ( Value[37] < (unsigned int)v3 )
  {
    v3 = *((_QWORD *)Value + 19);
    *lpMem = v3;
    ++Value[37];
    *((_QWORD *)Value + 19) = lpMem;
  }
  else if ( lpMem )
  {
