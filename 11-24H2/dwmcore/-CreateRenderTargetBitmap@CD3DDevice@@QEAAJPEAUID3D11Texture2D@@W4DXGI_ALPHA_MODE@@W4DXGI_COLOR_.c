/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x180159EB4
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( (v30 & 0x20) != 0 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v19, 0x45Bu, 0LL);
      v9 = v21[0];
    }
    else
    {
      ...
      v14 = v20;
      if ( v20 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v20, 0x45Fu, 0LL);
    }
  }
  else
  {
    v14 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, -2147024809, 0x444u, 0LL);
  }
