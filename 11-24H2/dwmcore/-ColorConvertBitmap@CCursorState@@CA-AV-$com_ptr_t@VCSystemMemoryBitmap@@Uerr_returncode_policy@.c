/*
 * XREFs of ?ColorConvertBitmap@CCursorState@@CA?AV?$com_ptr_t@VCSystemMemoryBitmap@@Uerr_returncode_policy@wil@@@wil@@PEAVCSystemMemoryBitmap@@@Z @ 0x1802B2438
 * Callers:
...
void ***__fastcall CCursorState::ColorConvertBitmap(void ***a1, __int64 a2)
{
  ...
  _DWORD v28[4]; // [rsp+60h] [rbp+17h] BYREF
  ...
  v28[0] = 87;
  v28[1] = 1;
  v6 = CSystemMemoryBitmap::HrInit(v5, v22, v23, (const struct PixelFormatInfo *)v28, 0);
  if ( v6 < 0 )
