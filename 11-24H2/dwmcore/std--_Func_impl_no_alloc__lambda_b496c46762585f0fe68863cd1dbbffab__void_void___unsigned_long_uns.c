/*
 * XREFs of std::_Func_impl_no_alloc__lambda_b496c46762585f0fe68863cd1dbbffab__void_void___unsigned_long_unsigned___int64_unsigned_short_const___enum_ProcessAttributionFlags_ProcessAttributionResourceCounters_const_&_::_Do_call @ 0x18012D740
 * Callers:
        ...
        ...)
{
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
  {
    ...
    if ( (v3 & 1) != 0 )
    {
      ...
      if ( v6 == (_DWORD *)v5[2] )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(v5, v6, (__int64 *)va);
    ...
    if ( (v3 & 2) != 0 )
    {
      ...
      if ( v7 == (_DWORD *)v5[5] )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(v5 + 3, v7, (__int64 *)va);
        result = (unsigned int)v11;
      }
      else
      {
    ...
    if ( (v3 & 4) != 0 )
    {
      ...
      if ( v8 == (_DWORD *)v5[8] )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(v5 + 6, v8, (__int64 *)va);
        result = (unsigned int)v11;
      }
      else
      {
    ...
    if ( (v3 & 8) != 0 )
    {
      ...
      if ( v9 == (_DWORD *)v5[11] )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(v5 + 9, v9, (__int64 *)va);
        result = (unsigned int)v11;
      }
      else
      {
    ...
    if ( (v3 & 0x10) != 0 )
    {
      ...
      if ( v10 == (_DWORD *)v5[14] )
      {
        return std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(v5 + 12, v10, (__int64 *)va);
      }
      else
      {
        *v10 = result;
