/*
 * XREFs of ?SetTemporaryConfiguration@CInteraction@@UEAAJW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x180094620
 * Callers:
 *     <none>
 * Callees:
 *     ?InternalRelease@?$ComPtr@UIUnknown@@@WRL@Microsoft@@IEAAKXZ @ 0x180061E70 (-InternalRelease@-$ComPtr@UIUnknown@@@WRL@Microsoft@@IEAAKXZ.c)
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800822D0 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?WakeMTForMidmanipulationUpdateIfNecessary@CManipulationManager@@QEAAXXZ @ 0x1800948B8 (-WakeMTForMidmanipulationUpdateIfNecessary@CManipulationManager@@QEAAXXZ.c)
...
__int64 __fastcall CInteraction::SetTemporaryConfiguration(__int64 a1, int a2, int a3, unsigned __int8 a4, void *a5)
{
  ...
  if ( v10 && ((*(void (__fastcall **)(__int64))(*(_QWORD *)v10 + 8LL))(v10), (v12 = *(_QWORD *)(v5 + 640)) != 0) )
  {
    ...
    {
      if ( (unsigned int)dword_1803F8D18 > 4 && (byte_1803F8D28 & 2) != 0 )
      {
        v16 = (CManipulationManager *)(qword_1803F8D30 & 2);
        if ( v16 == (CManipulationManager *)qword_1803F8D30 )
        {
          LODWORD(v25) = v14;
          v21 = v7;
          v22 = a3;
