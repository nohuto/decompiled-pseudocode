/*
 * XREFs of ?CalcDeviceTransformDelta@CExternalLayer@@MEAAJPEAVCDrawingContext@@PEAVCMILMatrix@@@Z @ 0x1800FE5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILMatrix *a3)
{
  ...
  v5 = AlignRectFToPointAndSizeL(&v17, &v14);
  v6 = v5;
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xE49u, 0LL);
