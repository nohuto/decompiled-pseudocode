/*
 * XREFs of ?RemoveFromSurfaceMap@CCompositionSurfaceManager@@MEAA_NU_LUID@@@Z @ 0x1801EB040
 * Callers:
 *     <none>
 * Callees:
 *     ?FindElement@?$CGenericTableMap@VCLuid@@VCCompositionSurfaceMap@CCompositionSurfaceManager@@@@QEAAPEAVCCompositionSurfaceMap@CCompositionSurfaceManager@@VCLuid@@@Z @ 0x1801EB084 (-FindElement@-$CGenericTableMap@VCLuid@@VCCompositionSurfaceMap@CCompositionSurfaceManager@@@@QE.c)
