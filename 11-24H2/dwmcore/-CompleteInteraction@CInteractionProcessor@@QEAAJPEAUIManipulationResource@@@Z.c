/*
 * XREFs of ?CompleteInteraction@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@@Z @ 0x18020E188
 * Callers:
 *     ?CompleteInteraction@CInteraction@@UEAAJXZ @ 0x18021EFB0 (-CompleteInteraction@CInteraction@@UEAAJXZ.c)
 *     ?CompleteInteraction@CInteractionRoot@@UEAAJXZ @ 0x1802576F0 (-CompleteInteraction@CInteractionRoot@@UEAAJXZ.c)
 * Callees:
