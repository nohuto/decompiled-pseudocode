/*
 * XREFs of ?PushTarget@CD2DContext@@UEAAJPEAVID2DContextOwner@@PEAVIDeviceTarget@@@Z @ 0x180055080
 * Callers:
...
LABEL_40:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v13, 0LL, &v56) )
  {
    ...
    v13 = v50;
    if ( v50 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v50, 0xB31u, 0LL);
  }
