/*
 * XREFs of ?Matrix4x4FromPerspective@CExpressionValueStack@@QEAAJXZ @ 0x18024D564
 * Callers:
 ...
 *     ?D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z @ 0x1802B5364 (-D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z.c)
 */
    ...
    if ( *((_DWORD *)v3 + 18) == 18 )
    {
      if ( *((_DWORD *)v4 + 18) == 18 )
      {
        if ( *((_DWORD *)v5 + 18) == 18 )
        {
          if ( *((_DWORD *)v6 + 18) == 18 )
          {
            if ( D2DMatrixPerspectiveRH((struct D2DMatrix *)v9, *(float *)v3, *(float *)v4, *(float *)v5, *(float *)v6) )
            {
              *((_DWORD *)v3 + 18) = 265;
              *(_OWORD *)v3 = v9[0];
              *((_OWORD *)v3 + 1) = v9[1];
