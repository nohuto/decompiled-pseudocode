/*
 * XREFs of ?TryRegisterWithExpressionManager@CBaseExpression@@IEAAJXZ @ 0x180015A70
 * Callers:
 ...
 *     ?IsReadyForEvaluation@CKeyframeAnimation@@UEBA_NXZ @ 0x180016130 (-IsReadyForEvaluation@CKeyframeAnimation@@UEBA_NXZ.c)
...
LABEL_18:
            ...
            if ( v1 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v1, 0xEDu, 0LL);
