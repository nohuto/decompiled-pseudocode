/*
 * XREFs of ?SetBlendMode@CD3DBatchExecutionContext@@EEAAXW4Enum@BlendMode@@@Z @ 0x180188300
 * Callers:
...
__int64 __fastcall CD3DBatchExecutionContext::SetBlendMode(__int64 a1, int a2)
{
  ...
  if ( a2 != (_DWORD)result )
  {
    ...
    *(_DWORD *)(a1 + 32) |= v5;
    ...
    if ( *(_QWORD *)(v7 + 40) )
    {
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(v7 + 16) + 560LL) + 120LL))(
        *(_QWORD *)(*(_QWORD *)(v7 + 16) + 560LL),
        *(_QWORD *)(v7 + 24),
        0LL);
      *(_QWORD *)(v7 + 40) = 0LL;
      *(_DWORD *)(v7 + 48) = 0;
      ...
      {
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(v7 + 64) + 560LL) + 120LL))(
          *(_QWORD *)(*(_QWORD *)(v7 + 64) + 560LL),
          *(_QWORD *)(v7 + 72),
          0LL);
        *(_QWORD *)(v7 + 88) = 0LL;
        *(_DWORD *)(v7 + 96) = 0;
