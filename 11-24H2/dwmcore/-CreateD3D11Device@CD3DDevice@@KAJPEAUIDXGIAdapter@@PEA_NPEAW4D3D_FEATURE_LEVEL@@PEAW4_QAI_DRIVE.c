/*
 * XREFs of ?CreateD3D11Device@CD3DDevice@@KAJPEAUIDXGIAdapter@@PEA_NPEAW4D3D_FEATURE_LEVEL@@PEAW4_QAI_DRIVERVERSION@@PEAT_LARGE_INTEGER@@PEAPEAUID3D11Device1@@@Z @ 0x1801DEB7C
 * Callers:
 ...
 *     ?CurrentProcessHasIncreasedPriorityPrivileges@@YA_NXZ @ 0x18021C38C (-CurrentProcessHasIncreasedPriorityPrivileges@@YA_NXZ.c)
        ...
        struct ID3D11Device1 **a6)
{
  ...
  *(__m128i *)v27 = _mm_load_si128((const __m128i *)&_xmm);
  ...
  if ( AdapterInfo < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, AdapterInfo, 0xD6u, 0LL);
  }
  else
  {
    pFeatureLevels = v27;
    FeatureLevels = 9;
    v13 = CurrentProcessHasIncreasedPriorityPrivileges() << 12;
    v14 = v27;
    v15 = 0LL;
...
LABEL_7:
    ...
    if ( v21 < 0 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0x149u, 0LL);
    }
    else
    {
      v21 = ((__int64 (__fastcall *)(ID3D11Device *, GUID *, struct ID3D11Device1 **))ppDevice->lpVtbl->QueryInterface)(
              ...
              a6);
      if ( v21 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x13Fu, 0LL);
      else
        *a3 = pFeatureLevel;
    }
  }
