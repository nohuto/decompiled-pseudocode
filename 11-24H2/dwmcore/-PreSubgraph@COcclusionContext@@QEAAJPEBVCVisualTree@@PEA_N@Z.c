/*
 * XREFs of ?PreSubgraph@COcclusionContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x1800A2710
 * Callers:
...
__int64 __fastcall COcclusionContext::PreSubgraph(COcclusionContext *this, const struct CVisualTree *a2, bool *a3)
{
  ...
  OcclusionInfo = CTreeData::GetOcclusionInfo((CTreeData *)TreeData, *((_DWORD *)this + 384), 1);
  v10 = g_pComposition;
  v11 = OcclusionInfo;
...
LABEL_6:
  ...
  if ( (*v22 & 0x800000) != 0 )
  {
    ...
    v27 = *v26;
    if ( (*(unsigned __int8 (__fastcall **)(CFilterEffect *, __int64))(*(_QWORD *)v27 + 64LL))(v27, 61LL)
  ...
  if ( CVisual::SkipInvalidTransformParentSubtree((CVisual *)v3, v6)
    ...
    || *(char *)(v3 + 106) < 0 && *((_BYTE *)g_pComposition + 6466)
...
LABEL_83:
  ...
  v51 = 0;
  LOBYTE(v53) = 0;
  CVisual::GetWorldTransform(v30, v6, 2LL, v48, &v53, v29);
  if ( LOBYTE(v53) )
  {
  ...
  if ( v33 )
  {
    ...
    v44 = 490;
LABEL_73:
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v34, v44, 0LL);
LABEL_84:
    v47 = 0;
    goto LABEL_85;
  }
