/*
 * XREFs of ?SetAxisY@?$CRotateTransform3DGeneratedT@VCRotateTransform3D@@VCTransform3D@@@@QEAAJM@Z @ 0x180225040
 * Callers:
...
__int64 __fastcall CRotateTransform3DGeneratedT<CRotateTransform3D,CTransform3D>::SetAxisY(float *a1, float a2)
{
  if ( a2 != a1[42] )
  {
    a1[42] = a2;
