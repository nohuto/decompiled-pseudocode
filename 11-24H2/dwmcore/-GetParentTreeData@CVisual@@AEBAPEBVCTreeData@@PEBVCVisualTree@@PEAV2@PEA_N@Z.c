/*
 * XREFs of ?GetParentTreeData@CVisual@@AEBAPEBVCTreeData@@PEBVCVisualTree@@PEAV2@PEA_N@Z @ 0x1800B0B20
 * Callers:
...
LABEL_17:
    ...
    if ( (*(unsigned __int8 (__fastcall **)(const struct CVisualTree *))(*(_QWORD *)a2 + 184LL))(a2) )
    {
      v4 = (const struct CTreeData *)(v21 + 328);
    }
    else
    {
      v30 = *(_QWORD *)(v21 + 232);
      if ( *(int *)v30 < 0 )
      {
        ...
        if ( v35 )
        {
          for ( n = *v35; n != (__int64 **)v35; n = (__int64 **)*n )
          {
            if ( n[4] == (__int64 *)a2 )
            {
              v4 = (const struct CTreeData *)(n - 44);
              goto LABEL_19;
            }
          }
        }
  ...
  else
  {
    ...
    if ( TreeDataListHead )
    {
      for ( ii = TreeDataListHead->Flink; ii != TreeDataListHead; ii = ii->Flink )
      {
        ...
        {
          v4 = (const struct CTreeData *)&ii[-22];
          break;
        }
      }
    }
