/*
 * XREFs of ?CreateSectionBitmapSubRects@CGdiSpriteBitmap@@AEAAJII@Z @ 0x1801D8754
 * Callers:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( *((_BYTE *)this + 155) )
      {
        ...
        wil::com_ptr_t<IBitmapRealization,wil::err_returncode_policy>::operator=((__int64 *)&v23, (__int64 *)&v24);
        wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v24);
      }
      else
      {
