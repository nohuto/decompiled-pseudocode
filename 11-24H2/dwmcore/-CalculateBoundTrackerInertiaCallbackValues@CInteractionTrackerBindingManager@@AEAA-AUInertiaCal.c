/*
 * XREFs of ?CalculateBoundTrackerInertiaCallbackValues@CInteractionTrackerBindingManager@@AEAA?AUInertiaCallbackValues@@PEAVCInteractionTracker@@0W4InteractionTrackerBindingModeFlags@@@Z @ 0x1800DEFC4
 * Callers:
        ...
        char a5)
{
  ...
  *(_QWORD *)(a2 + 48) = 0LL;
  ...
  v12 = v9[2];
  v36 = v9[3].m128_u64[0];
  CurrentValue = CInteractionTracker::GetCurrentValue(a3, 0LL);
