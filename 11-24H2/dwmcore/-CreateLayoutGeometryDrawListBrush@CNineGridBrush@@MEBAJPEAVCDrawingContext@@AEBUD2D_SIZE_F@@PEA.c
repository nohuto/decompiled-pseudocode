/*
 * XREFs of ?CreateLayoutGeometryDrawListBrush@CNineGridBrush@@MEBAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAPEAVCDrawListBrush@@@Z @ 0x18006BD80
 * Callers:
        ...
        struct CDrawListBrush **a4)
{
  ...
  _DWORD *v16; // rax
  FLOAT height; // xmm0_4
  struct CDrawListBrush **v18; // rcx
  struct CDrawListBrush *v19; // rdx
  ...
  struct CDrawListBrush **v24; // [rsp+60h] [rbp-20h]
  struct CDrawListBrush *v25; // [rsp+68h] [rbp-18h] BYREF
  ...
  if ( *((_BYTE *)this + 96) && *((_BYTE *)this + 168) )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *((_OWORD *)v16 + 2) = *(_OWORD *)v21;
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x206u, 0LL);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1FDu, 0LL);
    }
    if ( lpMem )
  ...
  else
  {
    ...
    if ( LayoutGeometryDrawListBrush < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, LayoutGeometryDrawListBrush, 0x20Cu, 0LL);
  }
  return (unsigned int)v8;
}
