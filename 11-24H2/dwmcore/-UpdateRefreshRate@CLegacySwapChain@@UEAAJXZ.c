/*
 * XREFs of ?UpdateRefreshRate@CLegacySwapChain@@UEAAJXZ @ 0x180240B20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Update@RefreshRateInfo@@QEAA_NAEBV1@@Z @ 0x180213494 (-Update@RefreshRateInfo@@QEAA_NAEBV1@@Z.c)
