/*
 * XREFs of ?SetIndependentFlipDuration@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJI@Z @ 0x180291634
 * Callers:
        ...
        unsigned int a2)
{
  ...
  if ( a2 != *((_DWORD *)this + 54) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x571u, 0LL);
    }
    else
    {
      v8 = *(_QWORD *)this;
      ...
      {
        v5 = v10 | 0x10000000;
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10 | 0x10000000, 0x57Bu, 0LL);
      }
    }
