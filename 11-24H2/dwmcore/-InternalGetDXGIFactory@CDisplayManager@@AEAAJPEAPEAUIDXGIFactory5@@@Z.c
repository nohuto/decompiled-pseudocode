/*
 * XREFs of ?InternalGetDXGIFactory@CDisplayManager@@AEAAJPEAPEAUIDXGIFactory5@@@Z @ 0x180154DCC
 * Callers:
...
__int64 __fastcall CDisplayManager::InternalGetDXGIFactory(CDisplayManager *this, struct IDXGIFactory5 **a2)
{
  ...
  if ( !IsCompositionThread() )
  {
    ...
    if ( qword_1803FAB38 )
    {
      v6 = (struct IDXGIFactory5 *)qword_1803FAB38;
      (*(void (__fastcall **)(CDisplayManager *))(*(_QWORD *)qword_1803FAB38 + 8LL))(qword_1803FAB38);
    }
  ...
  v3 = qword_1803FAB38;
  if ( qword_1803FAB38
    && (*(unsigned int (__fastcall **)(CDisplayManager *))(*(_QWORD *)qword_1803FAB38 + 104LL))(qword_1803FAB38)
    || (updated = CDisplayManager::UpdateDXGIFactory(v3), v8 = updated, updated >= 0) )
  {
    v4 = qword_1803FAB38;
    *a2 = (struct IDXGIFactory5 *)qword_1803FAB38;
