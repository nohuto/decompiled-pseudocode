/*
 * XREFs of ?CreateChannel@CInternalMilCmdConnection@@QEAAJPEAUIDwmChannelProvider@@PEAPEAVCChannel@@@Z @ 0x180217E20
 * Callers:
  ...
  *(_QWORD *)v14 = this + 16;
  ...
  else
  {
    ...
    if ( v10 < 0 )
    {
      ...
      CChannel::Release(v9);
      CWriteGuard<CReadWriteLock>::~CWriteGuard<CReadWriteLock>((__int64 *)v14);
      return v11;
    }
    else
    {
