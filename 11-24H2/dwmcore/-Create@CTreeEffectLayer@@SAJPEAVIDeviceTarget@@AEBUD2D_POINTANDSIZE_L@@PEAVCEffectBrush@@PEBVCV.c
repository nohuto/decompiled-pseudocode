/*
 * XREFs of ?Create@CTreeEffectLayer@@SAJPEAVIDeviceTarget@@AEBUD2D_POINTANDSIZE_L@@PEAVCEffectBrush@@PEBVCVisual@@AEBUD2D_POINTANDSIZE_F@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAPEAV1@@Z @ 0x1800A8898
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  __int64 v29; // rax
  __int64 v30; // rcx
  __int64 v32[2]; // [rsp+48h] [rbp-71h] BYREF
  ...
  *(float *)v20.m128i_i32 = *(float *)v20.m128i_i32 * v9;
  ...
  {
    *(float *)v32 = *(float *)v20.m128i_i32 + 6291456.25;
  ...
  *(float *)v22.m128i_i32 = *(float *)v22.m128i_i32 * v9;
  ...
  {
    *(float *)v32 = *(float *)v22.m128i_i32 + 6291456.25;
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)a4 + 64LL))(a4, 93LL) )
  {
    v26 = -2147024809;
  ...
  v24 = (CDeviceTextureTarget *)(*(__int64 (__fastcall **)(_QWORD *, _BYTE *))(*a1 + 120LL))(a1, v36);
  v35 = 44;
  v34 = "DWM Scratch Rendertarget (tree effect layer)";
  v25 = CExternalLayer::CreateBitmap((struct CResourceTag *)&v34, &v33, (struct PixelFormatInfo *)v37, v24, 1, v32);
  v26 = v25;
  if ( v25 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v25, 0x6Eu, 0LL);
    v30 = v32[0];
    if ( !v32[0] )
      return v26;
    v29 = *(_QWORD *)v32[0];
  ...
  v28 = (__int64 *)v32[0];
  if ( v27 )
    v27 = (_QWORD *)CTreeEffectLayer::CTreeEffectLayer(v27, &v33, a5, v32[0], a3, a6, LODWORD(v9));
  *a7 = v27;
  v27[32] = a4;
  if ( v28 )
  {
    ...
    v30 = (__int64)v28;
LABEL_20:
    (*(void (__fastcall **)(__int64))(v29 + 16))(v30);
  }
  return v26;
}
