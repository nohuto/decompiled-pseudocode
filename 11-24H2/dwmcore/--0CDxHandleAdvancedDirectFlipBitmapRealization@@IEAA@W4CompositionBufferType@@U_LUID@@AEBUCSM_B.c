/*
 * XREFs of ??0CDxHandleAdvancedDirectFlipBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@@Z @ 0x1802D78A4
 * Callers:
...
__int64 __fastcall CDxHandleAdvancedDirectFlipBitmapRealization::CDxHandleAdvancedDirectFlipBitmapRealization(
        ...
        __int64 a6)
{
  CDxHandleBitmapRealization::CDxHandleBitmapRealization(a1, a2, a3, a4, a5, 1, 1, a6);
