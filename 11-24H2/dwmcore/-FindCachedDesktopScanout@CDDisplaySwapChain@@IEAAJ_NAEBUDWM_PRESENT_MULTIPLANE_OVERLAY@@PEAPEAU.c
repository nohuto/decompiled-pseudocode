/*
 * XREFs of ?FindCachedDesktopScanout@CDDisplaySwapChain@@IEAAJ_NAEBUDWM_PRESENT_MULTIPLANE_OVERLAY@@PEAPEAUIDisplayScanout@Core@Display@Devices@Windows@@@Z @ 0x1800675D8
 * Callers:
...
LABEL_6:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x52Fu, 0LL);
  v20 = v28;
LABEL_11:
  if ( v20 )
