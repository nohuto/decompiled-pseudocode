/*
 * XREFs of ?Free@?$CThreadLocalObjectCache@VCD2DLayer@@V1@@@SAXPEAX@Z @ 0x1800FA3DC
 * Callers:
...
int __fastcall CThreadLocalObjectCache<CD2DLayer,CD2DLayer>::Free(_QWORD *lpMem)
{
  _DWORD *Value; // rbx
  __int64 v3; // rax
  ...
  LODWORD(v3) = Value[108];
  if ( Value[109] < (unsigned int)v3 )
  {
    v3 = *((_QWORD *)Value + 55);
    *lpMem = v3;
    ++Value[109];
    *((_QWORD *)Value + 55) = lpMem;
  }
  else if ( lpMem )
  {
