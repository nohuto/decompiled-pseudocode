/*
 * XREFs of ?SetClipPoints@ClipPlaneIterator@@AEAAJPEBUD2D_POINT_2F@@IPEBW4D2D1_POLYGON_EDGE_FLAG@@AEBUD2D_MATRIX_3X2_F@@@Z @ 0x18006CE5C
 * Callers:
 ...
 *     ?TransformPoints@MILMatrix3x2@@QEBAXPEBUD2D_POINT_2F@@PEAU2@I@Z @ 0x1801E65C0 (-TransformPoints@MILMatrix3x2@@QEBAXPEBUD2D_POINT_2F@@PEAU2@I@Z.c)
        ...
        const struct D2D_MATRIX_3X2_F *a5)
{
  ...
  if ( a3 >= 3 )
  {
    ...
    while ( 1 )
    {
      ...
      *((_QWORD *)&v60 + 1) = __PAIR64__(y_low.m128_u32[0], x_low.m128_u32[0]);
      ...
      else if ( v17 > *((_DWORD *)this + 11) )
      {
        ...
        if ( v21 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0xC0u, 0LL);
      }
      else
      {
      ...
      if ( a4 )
      {
        ...
        else if ( v19 > *((_DWORD *)this + 19) )
        {
          ...
          if ( v20 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0xC0u, 0LL);
        }
        else
        {
    ...
    for ( i = v22; v23 < v22; i = v22 )
    {
      ...
      {
        DynArray<CComposition::RoudTripRequestTracker,0>::RemoveAt((char *)this + 24, v23);
        if ( a4 )
              ...
              for ( j = 1; j < v35; ++j )
              {
                ...
                if ( (*(_BYTE *)(v46 + 4LL * j) & 1) != 0 && (*(_BYTE *)(v46 + 4LL * (j - 1)) & 1) != 0 )
                {
                  ...
                  *(_DWORD *)(v47 + 8 * v48 + 12) = v49;
                  DynArray<CComposition::RoudTripRequestTracker,0>::RemoveAt((char *)this + 24, j);
                ...
                if ( (*(_BYTE *)(*((_QWORD *)this + 7) + 4LL * v54) & 1) != 0 )
                {
                  ...
                  if ( v55 + 1 >= v55 )
                  {
                    if ( v56 > *((_DWORD *)this + 27) )
                    {
                      ...
                      if ( v57 < 0 )
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v57, 0xC0u, 0LL);
                    }
                    else
                    {
          ...
          else
          {
            ...
            if ( v35 )
            {
              do
              {
                ...
                {
                  DynArray<CComposition::RoudTripRequestTracker,0>::RemoveAt((char *)this + 24, (unsigned int)v42);
