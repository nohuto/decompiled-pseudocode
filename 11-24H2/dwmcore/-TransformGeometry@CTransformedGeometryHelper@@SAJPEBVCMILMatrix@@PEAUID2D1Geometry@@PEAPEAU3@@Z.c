/*
 * XREFs of ?TransformGeometry@CTransformedGeometryHelper@@SAJPEBVCMILMatrix@@PEAUID2D1Geometry@@PEAPEAU3@@Z @ 0x180123E40
 * Callers:
...
LABEL_4:
  ...
  {
    v24 = v6;
    wil::com_ptr_t<IHolographicFrameProcessor,wil::err_returncode_policy>::~com_ptr_t<IHolographicFrameProcessor,wil::err_returncode_policy>((__int64 *)&v24);
    v13 = *((_DWORD *)a1 + 1);
    ...
    *(_QWORD *)((char *)&v28 + 4) = __PAIR64__(*((_DWORD *)a1 + 4), v13);
    ...
    if ( v15(v6, &GUID_2cd906bb_12e2_11dc_9fed_001143a055f9, &v23) >= 0 )
    {
      ...
      v30 = _xmm;
      v31 = 0LL;
      (*(void (__fastcall **)(__int64, __int128 *))(*(_QWORD *)v23 + 144LL))(v23, &v30);
    ...
    if ( v19 >= 0 )
    {
      Microsoft::WRL::ComPtr<CManipulation>::Attach(&v22, v25);
      v20 = v23;
      if ( v23 )
      {
        v23 = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v19, 0x2Eu, 0LL);
    v21 = v23;
    if ( v23 )
    {
      v23 = 0LL;
