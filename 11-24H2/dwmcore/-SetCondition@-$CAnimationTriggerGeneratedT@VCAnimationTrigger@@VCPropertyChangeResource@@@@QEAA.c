/*
 * XREFs of ?SetCondition@?$CAnimationTriggerGeneratedT@VCAnimationTrigger@@VCPropertyChangeResource@@@@QEAAJPEAVCBaseExpression@@@Z @ 0x18022767C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[12] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xB35u, 0LL);
    }
    else
    {
