/*
 * XREFs of ?SetOrAppendUVMappings@CSceneMeshRendererComponent@@QEAAJAEBV?$span@$$CBUSceneMeshMaterialAttributeData@@$0?0@gsl@@_N@Z @ 0x1802A4650
 * Callers:
 ...
 *     ??$_Try_emplace@AEBW4Enum@SceneMaterialInputType@@$$V@?$map@W4Enum@SceneMaterialInputType@@IU?$less@W4Enum@SceneMaterialInputType@@@std@@V?$allocator@U?$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@@4@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@PEAX@std@@_N@1@AEBW4Enum@SceneMaterialInputType@@@Z @ 0x1802A3DF4 (--$_Try_emplace@AEBW4Enum@SceneMaterialInputType@@$$V@-$map@W4Enum@SceneMaterialInputType@@IU-$l.c)
...
__int64 __fastcall CSceneMeshRendererComponent::SetOrAppendUVMappings(__int64 a1, __int64 *a2, char a3)
{
  ...
  unsigned __int64 v17[2]; // [rsp+30h] [rbp-38h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( v7 != v11 || v10 != v12 )
LABEL_13:
      ((void (__fastcall *)(__int64, __int64))`gsl::details::get_terminate_handler'::`2'::handler)(v11, v12);
    if ( v9 == v12 )
      break;
    v19 = *(_DWORD *)gsl::details::span_iterator<SceneMeshMaterialAttributeData const>::operator->(v17);
    v13 = *(_DWORD *)(gsl::details::span_iterator<SceneMeshMaterialAttributeData const>::operator->(v17) + 4);
