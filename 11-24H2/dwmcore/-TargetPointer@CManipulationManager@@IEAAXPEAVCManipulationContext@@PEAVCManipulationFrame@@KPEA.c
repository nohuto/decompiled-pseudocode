/*
 * XREFs of ?TargetPointer@CManipulationManager@@IEAAXPEAVCManipulationContext@@PEAVCManipulationFrame@@KPEAPEAX@Z @ 0x18012B890
 * Callers:
 ...
 *     ?GetHoverTarget@CManipulationContext@@QEBAPEAVCInteraction@@I@Z @ 0x18020F380 (-GetHoverTarget@CManipulationContext@@QEBAPEAVCInteraction@@I@Z.c)
