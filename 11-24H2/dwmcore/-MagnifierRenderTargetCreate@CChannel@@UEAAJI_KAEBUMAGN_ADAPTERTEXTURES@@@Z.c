/*
 * XREFs of ?MagnifierRenderTargetCreate@CChannel@@UEAAJI_KAEBUMAGN_ADAPTERTEXTURES@@@Z @ 0x180262300
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct MAGN_ADAPTERTEXTURES *a4)
{
  ...
  v38 = v18;
  v39 = v19;
  v20 = CChannel::SendCommand((struct CCommandBatch **)this, &v24, 0xE0u);
