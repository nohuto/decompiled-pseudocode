/*
 * XREFs of ?OnInput@CManipulationManager@@IEAAXXZ @ 0x18018FF90
 * Callers:
 *     _lambda_19664e0b56b7920f045ba8c67b2f55c3_::_lambda_invoker_cdecl_ @ 0x18018F670 (_lambda_19664e0b56b7920f045ba8c67b2f55c3_--_lambda_invoker_cdecl_.c)
...
void __fastcall CManipulationManager::OnInput(CManipulationManager *this)
{
  ...
  do
  {
    ...
    *(_QWORD *)(v7 + 8) = &CManipulationManager::s_InputQueue;
    ...
    if ( v5 )
      (*(void (__fastcall **)(int *))(*(_QWORD *)v5 + 8LL))(v5);
    v3 = 0LL;
    if ( v4 )
    {
