/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VID2DBitmapCacheSource@@VCMilObjectDeleter@@@@IEAAKXZ @ 0x18018B8F0
 * Callers:
 ...
 *     ?Release@CSecondarySysmemBitmap@@UEAAKXZ @ 0x1802004D0 (-Release@CSecondarySysmemBitmap@@UEAAKXZ.c)
 * Callees:
