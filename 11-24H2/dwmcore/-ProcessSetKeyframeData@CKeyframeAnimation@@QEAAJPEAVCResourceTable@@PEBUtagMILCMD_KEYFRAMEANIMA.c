/*
 * XREFs of ?ProcessSetKeyframeData@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETKEYFRAMEDATA@@@Z @ 0x18023D924
 * Callers:
...
LABEL_49:
  ...
  Resource = (CSharedSectionBase *)CResourceTable::GetResource((__int64)a2, v7, 0x9Du);
  if ( !Resource )
  {
    v34 = 238;
    goto LABEL_5;
  ...
  if ( *((_DWORD *)a3 + 14) )
  {
    ...
    if ( *((_QWORD *)this + 42) || *((_QWORD *)this + 43) )
      wil::details::in1diag3::Log_Hr(
        ...
        v33);
    v14 = (CSharedSectionBase *)CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 12), 0x9Du);
    if ( v14 )
    {
