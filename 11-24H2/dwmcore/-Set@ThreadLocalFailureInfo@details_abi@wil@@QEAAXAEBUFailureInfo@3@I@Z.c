/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x1802549C4
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x18025496C (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x180254998 (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
        ...
        int a3)
{
  ...
  *((_QWORD *)this + 7) = 0LL;
  ...
  if ( v16 )
  {
    ...
    {
      memcpy_s_1(v22, v17 - v22, v24, v23);
      if ( v4 )
        *v4 = v22;
      v22 += v25;
    }
