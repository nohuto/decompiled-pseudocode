/*
 * XREFs of ?ImmediateUnpinResources@CD3DDevice@@QEAAXV?$span@PEAVISwapChainRealization@@$0?0@gsl@@@Z @ 0x1802BA38C
 * Callers:
...
void __fastcall CD3DDevice::ImmediateUnpinResources(__int64 a1, _QWORD *a2)
{
  ...
  if ( (_QWORD)v12 != *((_QWORD *)&v12 + 1) )
  {
    ...
    v10 = v9;
    if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 2) != 0 )
      McTemplateU0t_EventWriteTransfer(Microsoft_Windows_Dwm_Compositor_Context, &UnPinning_Stop, v9);
    if ( v10 < 0 )
