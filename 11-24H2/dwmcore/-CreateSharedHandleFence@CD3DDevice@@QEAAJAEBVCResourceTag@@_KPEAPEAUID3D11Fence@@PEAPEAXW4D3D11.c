/*
 * XREFs of ?CreateSharedHandleFence@CD3DDevice@@QEAAJAEBVCResourceTag@@_KPEAPEAUID3D11Fence@@PEAPEAXW4D3D11_FENCE_FLAG@@@Z @ 0x180216BF8
 * Callers:
        ...
        enum D3D11_FENCE_FLAG a6)
{
  ...
  *a5 = 0LL;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x772u, 0LL);
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x777u, 0LL);
  }
  v16 = v18;
LABEL_4:
  if ( v16 )
