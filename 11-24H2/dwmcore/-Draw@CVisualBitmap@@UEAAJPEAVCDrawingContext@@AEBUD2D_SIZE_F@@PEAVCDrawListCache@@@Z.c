/*
 * XREFs of ?Draw@CVisualBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800F60E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( this[9] )
  {
    if ( CVisualBitmap::CanUseCVI((CVisualBitmap *)this, a2) )
    {
      ...
      if ( v13 >= 0 )
        return v4;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x85u, 0LL);
    }
    v4 = 0;
    ...
    if ( (v4 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x8Du, 0LL);
    }
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x91u, 0LL);
