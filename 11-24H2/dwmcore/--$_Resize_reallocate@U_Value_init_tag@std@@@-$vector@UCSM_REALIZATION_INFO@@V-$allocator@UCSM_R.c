/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UCSM_REALIZATION_INFO@@V?$allocator@UCSM_REALIZATION_INFO@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801A5F80
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  std::_Uninitialized_value_construct_n<std::allocator<CSM_REALIZATION_INFO>>(&v10[40 * v7], a2 - v7);
  memmove_0(v10, *(const void **)a1, *(_QWORD *)(a1 + 8) - *(_QWORD *)a1);
  return std::vector<CSM_REALIZATION_INFO>::_Change_array(a1, v10, a2, v2);
}
