/*
 * XREFs of ?AdvanceInertiaToTimeInertiaModifier@CMotion@@AEAAMPEAVCExpressionValueStack@@_K@Z @ 0x1800E7184
 * Callers:
        ...
        __int64 a3)
{
  ...
  v8 = (*(double (__fastcall **)(_QWORD, __int64, struct CExpressionValueStack *, __int64))(**((_QWORD **)this + 3)
         ...
         *((_QWORD *)this + 3),
         ...
         a2,
         a3);
  if ( (unsigned int)dword_1803F8D18 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803F8D18, 2LL) )
  {
