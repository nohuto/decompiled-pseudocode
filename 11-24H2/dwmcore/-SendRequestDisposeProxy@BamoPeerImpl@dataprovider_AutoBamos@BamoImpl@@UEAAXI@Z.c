/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18026F9E0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v7, 2LL, 7LL, 7, &unk_180383D65, a2, v6, v7[0]);
  if ( v4 < 0 )
