/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VILegacyRemotingSwapChain@@VIDeviceResource@@VCMilObjectDeleter@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C7074
 * Callers:
 *     ?QueryInterface@CLegacyRemotingSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C73D0 (-QueryInterface@CLegacyRemotingSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
