/*
 * XREFs of ?GetTargetId@?$IRenderTargetMethodsT@VCRenderTarget@@VIMonitorTarget@@VICapabilitiesContributorTarget@@@@WFA@EBAAEBUtagCOMPOSITION_TARGET_ID@@XZ @ 0x180277080
 * Callers:
 *     <none>
 * Callees:
 *     <none>
