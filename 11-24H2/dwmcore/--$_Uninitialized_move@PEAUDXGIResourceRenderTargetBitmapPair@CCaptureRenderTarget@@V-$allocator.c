        ...
        CCaptureRenderTarget::DXGIResourceRenderTargetBitmapPair *a3)
{
  ...
  std::_Destroy_range<std::allocator<CCaptureRenderTarget::DXGIResourceRenderTargetBitmapPair>>(a3);
  return a3;
}
