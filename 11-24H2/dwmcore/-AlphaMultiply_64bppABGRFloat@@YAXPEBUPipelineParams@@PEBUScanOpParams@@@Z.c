/*
 * XREFs of ?AlphaMultiply_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1802DEB20
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x1802DAE70 (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaMultiply_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != *(float *)CFloat16::operator float((unsigned __int16 *)&word_1803F9884).m128i_i32 )
      {
        v5 = *(float *)CFloat16::operator float(v3).m128i_i32;
        if ( v5 != *(float *)CFloat16::operator float(word_1803FAA34).m128i_i32 )
        {
