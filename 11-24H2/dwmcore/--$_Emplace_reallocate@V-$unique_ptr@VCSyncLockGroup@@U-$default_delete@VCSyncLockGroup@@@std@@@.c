 ...
 *     ?_Calculate_growth@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEBA_K_K@Z @ 0x180267380 (-_Calculate_growth@-$vector@V-$unique_ptr@VCSyncLockGroup@@U-$default_delete@VCSyncLockGroup@@@s.c)
        ...
        __int64 *a3)
{
  ...
  v6 = ((__int64)xmmword_1803FA8E0 - CSyncLockGroup::g_syncLockGroups) >> 3;
  ...
  *v14 = v11;
  v15 = xmmword_1803FA8E0;
  v16 = CSyncLockGroup::g_syncLockGroups;
  if ( a2 != (_QWORD)xmmword_1803FA8E0 )
  {
