/*
 * XREFs of ?ExecutePresent@CDDisplaySwapChain@@IEAAJPEAUIDisplayScanout@Core@Display@Devices@Windows@@PEBUDWM_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x1802BEBD4
 * Callers:
 ...
 *     ?GetRequestedVBlankDurationHns@RefreshRateInfo@@QEBAIXZ @ 0x18020F034 (-GetRequestedVBlankDurationHns@RefreshRateInfo@@QEBAIXZ.c)
