/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InkScanoutBuffer2@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18028838C
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_InkScanoutBuffer2>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v4 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_InkScanoutBuffer2>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v8);
    v11 = v4;
  }
