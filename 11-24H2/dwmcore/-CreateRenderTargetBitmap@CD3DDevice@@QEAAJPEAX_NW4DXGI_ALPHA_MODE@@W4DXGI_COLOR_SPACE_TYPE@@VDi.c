/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x1802BC800
 * Callers:
        ...
        struct IRenderTargetBitmap **a8)
{
  ...
  *a8 = 0LL;
  if ( !*(_DWORD *)(a1 + 1112) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, RenderTargetBitmap, v15, 0LL);
    goto LABEL_8;
  }
  v11 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, -2003304307, 0x47Bu, 0LL);
LABEL_8:
