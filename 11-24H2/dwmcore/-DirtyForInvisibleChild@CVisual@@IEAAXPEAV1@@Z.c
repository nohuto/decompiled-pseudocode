/*
 * XREFs of ?DirtyForInvisibleChild@CVisual@@IEAAXPEAV1@@Z @ 0x1800BDF3C
 * Callers:
...
void __fastcall CVisual::DirtyForInvisibleChild(CVisual *this, struct CVisual *a2)
{
  ...
  const struct D2D_RECT_F *v5; // rcx
  CComposition *v6; // rbx
  ...
  void (__fastcall *v32)(unsigned __int64, _QWORD, _QWORD *); // rax
  ...
  {
    v5 = (const struct D2D_RECT_F *)((char *)a2 + 152);
    if ( !*((_DWORD *)a2 + 28) || (unsigned __int8)IsPure2DRect(v5) )
    {
      CVisual::AddAdditionalDirtyRect((__int64)this, v5, 0);
    }
    else
    {
      v2 = 21;
  ...
  if ( (*((_BYTE *)v3 + 105) & 0x20) != 0 )
  {
    ...
    if ( ManipulationManager >= 0 )
      CManipulationManager::QueueMidManipulationUpdate((__int64)v41, 3u, (__int64)v3);
    if ( v8 )
  ...
  if ( !*(_BYTE *)(v9 + 6474) )
  {
    ...
    {
LABEL_61:
      if ( *(_QWORD *)(v9 + 6504) == *(_QWORD *)(v9 + 6512) )
      {
  ...
  if ( (_DWORD)v17 )
  {
    ...
    do
    {
      ...
      {
        _mm_lfence();
        v37 = *(_QWORD *)((*((_QWORD *)this + 4) & 0xFFFFFFFFFFFFFFFCuLL) + v35);
      }
      if ( v37 != *((_QWORD *)this + 11) )
      {
  ...
  v18 = *(struct CProcessAttribution *(__fastcall **)(CResource *__hidden))(*(_QWORD *)this + 160LL);
  if ( v18 == CResource::GetProcessAttributionNoRef )
    ProcessAttributionNoRef = CResource::GetProcessAttributionNoRef(this);
  else
    ProcessAttributionNoRef = (struct CProcessAttribution *)((__int64 (__fastcall *)(CVisual *, _QWORD, _QWORD))v18)(
                                                              this,
      ...
      *((_BYTE *)v21 + 96) |= v2;
      ...
      if ( (_DWORD)v22 )
      {
        ...
        do
        {
          ...
          {
            _mm_lfence();
            v31 = *(_QWORD *)((v21[4] & 0xFFFFFFFFFFFFFFFCuLL) + v28);
          }
          if ( v31 != v21[11] )
          {
            v32 = *(void (__fastcall **)(unsigned __int64, _QWORD, _QWORD *))(*(_QWORD *)v31 + 80LL);
      ...
      v23 = *(struct CProcessAttribution *(__fastcall **)(CWindowNode *__hidden))(*v21 + 160LL);
      if ( v23 == CResource::GetProcessAttributionNoRef )
      {
        v24 = CResource::GetProcessAttributionNoRef((CResource *)v21);
      }
      else if ( v23 == CWindowNode::GetProcessAttributionNoRef )
      {
        v24 = CWindowNode::GetProcessAttributionNoRef((CWindowNode *)v21);
      }
      else
      {
        v24 = v23((CWindowNode *)v21);
      }
      if ( v24 && v20 != v24 )
      {
        if ( (v2 & 0x80u) != 0 )
