/*
 * XREFs of ?GetSwapChainOverlayColor@CDrawingContext@@AEBA?AU_D3DCOLORVALUE@@PEAVISwapChainRealization@@PEBVIBitmapResource@@@Z @ 0x1801FC6B8
 * Callers:
...
LABEL_13:
    ...
    {
      v11 = *(_BYTE *)(*((_QWORD *)this + 6) + 19577LL);
      retstr->a = 0.5;
      if ( v11 )
      {
        retstr->r = 1.0;
