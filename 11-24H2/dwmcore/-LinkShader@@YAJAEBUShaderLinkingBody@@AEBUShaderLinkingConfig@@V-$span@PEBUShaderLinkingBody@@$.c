/*
 * XREFs of ?LinkShader@@YAJAEBUShaderLinkingBody@@AEBUShaderLinkingConfig@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAUVertexShaderDesc@@PEAPEAUID3D10Blob@@@Z @ 0x1801C0E50
 * Callers:
 ...
 *     ?DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z @ 0x1801C2250 (-DoesSamplerRequireConstantBufferData@@YA_NAEBUShaderLinkingSamplerDesc@@@Z.c)
...
LABEL_61:
    ...
    else
    {
      ...
      v37 = LoadShaderBody((unsigned int)&ppLinker, v59, v36, v33, (__int64)word_18032AF78, (__int64)v58);
      v29 = v37;
      if ( v37 < 0 )
      {
...
LABEL_55:
      ...
      v9 = v58[0];
      v38 = AppendShaderBody((__int64)&ppLinker, 0xAu, v35, a2, (__int64)word_18032AF78, v58[0], v31, &v70);
      v29 = v38;
      if ( v38 < 0 )
      {
