        ...
        _QWORD *a3)
{
  ...
  std::_Destroy_range<std::allocator<wil::com_ptr_t<CDDisplaySwapChainBuffer,wil::err_returncode_policy>>>(a3, a3);
  return a3;
}
