/*
 * XREFs of ?_lambda_invoker_cdecl_@_lambda_a8e7baa2fca040c17c3e795f3590cb07_@@CA@XZ @ 0x180256510
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _lambda_a8e7baa2fca040c17c3e795f3590cb07_::_lambda_invoker_cdecl_()
{
  ...
  v1 = 0LL;
  v0 = 0;
  if ( InitOnceBeginInitialize(&`InputTraceLogging::Instance'::`2'::wrapper, 1u, &v0, &v1) )
  {
    if ( !v0 )
