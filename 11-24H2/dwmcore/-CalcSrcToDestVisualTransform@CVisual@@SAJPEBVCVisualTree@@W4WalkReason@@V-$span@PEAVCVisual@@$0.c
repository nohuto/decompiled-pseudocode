/*
 * XREFs of ?CalcSrcToDestVisualTransform@CVisual@@SAJPEBVCVisualTree@@W4WalkReason@@V?$span@PEAVCVisual@@$0?0@gsl@@PEAV1@V?$span@PEAVCMILMatrix@@$0?0@5@@Z @ 0x180164598
 * Callers:
...
LABEL_8:
    v33 = (int)v7;
    WorldTransform = CVisual::GetWorldTransform(v13, a1, 3, (__int64)v32, v7, (struct CMILMatrix *)v7);
    v9 = WorldTransform;
    if ( WorldTransform < 0 )
    {
      v24 = 1070;
