/*
 * XREFs of ?PartitionPrimitive@CDrawListEntryBuilder@@AEAAJIAEBUD2D_RECT_F@@PEAV?$vector_facade@UPrimitiveSubRect@CDrawListEntryBuilder@@V?$buffer_impl@UPrimitiveSubRect@CDrawListEntryBuilder@@$08$00Vliberal_expansion_policy@detail@@@detail@@@detail@@@Z @ 0x1800702F0
 * Callers:
...
LABEL_25:
    if ( CShapePtr::IsAxisAlignedRectangle((CShapePtr *)(v12 + 2)) )
      return 0LL;
LABEL_17:
    v15 = *(_QWORD *)(a1 + 16);
    v16 = 0;
