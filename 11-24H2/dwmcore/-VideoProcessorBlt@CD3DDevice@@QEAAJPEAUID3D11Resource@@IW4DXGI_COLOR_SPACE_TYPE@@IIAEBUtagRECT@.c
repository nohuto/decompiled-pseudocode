/*
 * XREFs of ?VideoProcessorBlt@CD3DDevice@@QEAAJPEAUID3D11Resource@@IW4DXGI_COLOR_SPACE_TYPE@@IIAEBUtagRECT@@W4_D3DDDI_ROTATION@@PEAUDXGI_HDR_METADATA_HDR10@@0II2@Z @ 0x1801D0344
 * Callers:
...
LABEL_14:
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x85Bu, 0LL);
  }
  else
  {
...
LABEL_6:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v28, 0x885u, 0LL);
    wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>(&v30);
  }
LABEL_7:
  if ( v31 )
