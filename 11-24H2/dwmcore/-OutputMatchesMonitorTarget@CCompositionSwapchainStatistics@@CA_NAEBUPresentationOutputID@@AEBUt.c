/*
 * XREFs of ?OutputMatchesMonitorTarget@CCompositionSwapchainStatistics@@CA_NAEBUPresentationOutputID@@AEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x18020BA48
 * Callers:
 ...
 *     ?ConfirmRecordedStatistics@CCompositionSwapchainStatistics@@UEAAXAEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x18020BA10 (-ConfirmRecordedStatistics@CCompositionSwapchainStatistics@@UEAAXAEBUtagCOMPOSITION_TARGET_ID@@@.c)
 * Callees:
 *     <none>
 */
