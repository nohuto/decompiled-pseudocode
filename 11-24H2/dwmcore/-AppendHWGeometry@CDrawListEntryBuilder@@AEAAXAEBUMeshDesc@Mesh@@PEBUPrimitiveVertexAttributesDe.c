/*
 * XREFs of ?AppendHWGeometry@CDrawListEntryBuilder@@AEAAXAEBUMeshDesc@Mesh@@PEBUPrimitiveVertexAttributesDesc@@@Z @ 0x180177F20
 * Callers:
 ...
 *     ?CalcGeometryCounts@Mesh@@SAXAEBUMeshDesc@1@PEA_K1@Z @ 0x180179360 (-CalcGeometryCounts@Mesh@@SAXAEBUMeshDesc@1@PEA_K1@Z.c)
 ...
 *     ??Y?$checked_array_iterator@PEAUAlign16Chunk@CDrawListEntryBuilder@@@stdext@@QEAAAEAV01@_J@Z @ 0x1801BD060 (--Y-$checked_array_iterator@PEAUAlign16Chunk@CDrawListEntryBuilder@@@stdext@@QEAAAEAV01@_J@Z.c)
 ...
 *     ??Y?$checked_array_iterator@PEAG@stdext@@QEAAAEAV01@_J@Z @ 0x1801CE380 (--Y-$checked_array_iterator@PEAG@stdext@@QEAAAEAV01@_J@Z.c)
...
LABEL_113:
    ...
    if ( v168 + v173 <= v11 )
    {
      ...
      if ( v13 + v139 != v11 )
      {
        ...
        *(_QWORD *)&v160 = v5;
        *((_QWORD *)&v160 + 1) = v11;
        ((void (__fastcall *)(__int128 *, unsigned __int64, __int64, __int128 *))std::move<std::move_iterator<unsigned short *>,stdext::checked_array_iterator<unsigned short *>>)(
          &v164,
          v5 + 2 * (v13 + v139),
          v31,
          &v160);
...
LABEL_159:
    ...
    if ( v13 + v140 != v11 )
    {
      ...
      v164 = *(_OWORD *)v162;
      v165 = v163;
      ((void (__fastcall *)(__int128 *, unsigned __int64, unsigned __int64, __int128 *))std::move<std::move_iterator<unsigned short *>,stdext::checked_array_iterator<unsigned short *>>)(
        &v160,
        v5 + 2 * v141,
        v5 + 2 * v11,
        &v164);
