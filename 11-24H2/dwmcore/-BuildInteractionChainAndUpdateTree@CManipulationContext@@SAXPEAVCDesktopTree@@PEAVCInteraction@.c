/*
 * XREFs of ?BuildInteractionChainAndUpdateTree@CManipulationContext@@SAXPEAVCDesktopTree@@PEAVCInteraction@@IW4InputType@@_NPEAVCInteractionChain@@PEA_N@Z @ 0x1801937D4
 * Callers:
...
LABEL_13:
           ...
           0LL) )
    {
      if ( !v8 )
      {
        v14 = (unsigned int)CInteraction::GetTotalNumContacts(v12) == 0;
        v37 = *((_BYTE *)v12 + 200);
        v38 = v14 ? v37 >> 4 : v37 >> 5;
        if ( (v38 & 1) != 0 )
        {
...
LABEL_30:
  Microsoft::WRL::ComPtr<CVisual>::operator=(a6, (__int64)v19);
  return Microsoft::WRL::ComPtr<CVisual>::operator=(a6 + 1, (__int64)v9);
}
