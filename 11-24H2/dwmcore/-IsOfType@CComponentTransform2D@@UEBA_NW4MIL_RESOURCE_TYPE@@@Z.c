/*
 * XREFs of ?IsOfType@CComponentTransform2D@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1801EAF80
 * Callers:
 *     ?IsOfType@CViewBox@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180277A10 (-IsOfType@CViewBox@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z.c)
 * Callees:
