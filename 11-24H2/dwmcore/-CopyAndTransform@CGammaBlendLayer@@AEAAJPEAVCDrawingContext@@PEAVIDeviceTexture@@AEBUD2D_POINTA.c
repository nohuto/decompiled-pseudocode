/*
 * XREFs of ?CopyAndTransform@CGammaBlendLayer@@AEAAJPEAVCDrawingContext@@PEAVIDeviceTexture@@AEBUD2D_POINTANDSIZE_L@@2W4SurfaceShaderType@@@Z @ 0x18027BCE4
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v9 = *(CSurfaceShaderComposer **)((*(__int64 (__fastcall **)(__int64 *))(*a3 + 40))(a3) + 1536);
  v10 = 0LL;
  v67 = 0LL;
  v26 = 256;
  v27 = 1;
  ...
  *((float *)&v31 + 3) = _mm_cvtepi32_ps(v13).m128_f32[0] / (float)v29;
  ...
  v18 = (*(__int64 (__fastcall **)(_QWORD *))(*((_QWORD *)a2 + 3) + 16LL))((_QWORD *)a2 + 3);
