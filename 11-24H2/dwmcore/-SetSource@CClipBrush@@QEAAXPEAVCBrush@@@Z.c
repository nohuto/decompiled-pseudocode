/*
 * XREFs of ?SetSource@CClipBrush@@QEAAXPEAVCBrush@@@Z @ 0x18029434C
 * Callers:
 *     ?OnBrushChanged@CCompositionTextLine@@UEAAXXZ @ 0x180298BA0 (-OnBrushChanged@CCompositionTextLine@@UEAAXXZ.c)
 * Callees:
...
void __fastcall CClipBrush::SetSource(struct CResource **this, struct CBrush *a2)
{
  ...
  if ( a2 != this[13] )
  {
    ...
    this[13] = a2;
    if ( a2
      && ((*(unsigned __int8 (__fastcall **)(struct CBrush *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 57LL)
       || (*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)this[13] + 64LL))(this[13], 126LL)) )
    {
      v4 = 1;
    }
    v6 = *this;
