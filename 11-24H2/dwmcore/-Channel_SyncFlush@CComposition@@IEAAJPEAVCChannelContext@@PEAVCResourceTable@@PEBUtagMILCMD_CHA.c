/*
 * XREFs of ?Channel_SyncFlush@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_SYNCFLUSH@@@Z @ 0x1801AAB48
 * Callers:
...
LABEL_7:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x55Eu, 0LL);
