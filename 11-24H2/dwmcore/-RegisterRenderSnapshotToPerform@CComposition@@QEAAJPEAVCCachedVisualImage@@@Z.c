/*
 * XREFs of ?RegisterRenderSnapshotToPerform@CComposition@@QEAAJPEAVCCachedVisualImage@@@Z @ 0x180214474
 * Callers:
...
LABEL_11:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x7AEu, 0LL);
    return v3;
  }
  *(_QWORD *)(v4 + 8 * v6) = a2;
  *((_DWORD *)v2 + 6) = v8;
