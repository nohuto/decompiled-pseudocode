/*
 * XREFs of ?GetScaledLetterboxingMargins@CDxHandleBitmapRealization@@UEBA_NPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18005E290
 * Callers:
...
char __fastcall CDxHandleBitmapRealization::GetScaledLetterboxingMargins(__int64 a1, __int64 a2)
{
  float v4; // xmm1_4
  float v5; // xmm0_4
  float v6; // xmm6_4
