/*
 * XREFs of ?CreateStereoRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIStereoRenderTargetBitmap@@@Z @ 0x1802BD054
 * Callers:
        ...
        struct IStereoRenderTargetBitmap **a7)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, DeviceTextureTarget, 0x61Cu, 0LL);
  }
  else
  {
    ...
    v12 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x61Fu, 0LL);
  }
