/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x180024010
 * Callers:
 ...
 *     ?CopyPixels@CBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z @ 0x180255A10 (-CopyPixels@CBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  if ( !a2 )
  {
    if ( this[2].LockCount > 0x7FFFFFFFu )
    {
      DWORD2(v31) = -1;
      v11 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0xABu, 0LL);
      goto LABEL_18;
    }
...
LABEL_22:
  v22 = v11;
LABEL_23:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, v23, 0LL);
LABEL_18:
  ReleaseInterfaceNoNULL<IHolographicExclusivePresentData>(v27);
  if ( v5 )
