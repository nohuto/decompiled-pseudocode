/*
 * XREFs of ?GenerateEffectInput@CBackdropVisualImage@@QEAA?AUEffectInput@@XZ @ 0x18004AD84
 * Callers:
...
__int64 __fastcall CBackdropVisualImage::GenerateEffectInput(__int64 a1, __int64 a2)
{
  ...
  float v17[14]; // [rsp+38h] [rbp-60h] BYREF
  ...
  *(_BYTE *)(a2 + 44) = 1;
  ...
  v8 = Matrix3x3::operator*((float *)(a1 + 2172), v17, v16);
  *(_OWORD *)(a2 + 48) = *(_OWORD *)v8;
  *(_OWORD *)(a2 + 64) = *((_OWORD *)v8 + 1);
  *(float *)(a2 + 80) = v8[8];
