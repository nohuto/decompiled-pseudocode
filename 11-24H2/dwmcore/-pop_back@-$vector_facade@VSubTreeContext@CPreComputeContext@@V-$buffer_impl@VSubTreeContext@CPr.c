/*
 * XREFs of ?pop_back@?$vector_facade@VSubTreeContext@CPreComputeContext@@V?$buffer_impl@VSubTreeContext@CPreComputeContext@@$02$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXXZ @ 0x180175554
 * Callers:
        ...
        __int64 *a1)
{
  ...
  if ( v5 != v4 )
  {
    ...
    while ( v7 != v6 )
    {
      CPreComputeContext::SubTreeContext::operator=((char *)v7 + v8);
