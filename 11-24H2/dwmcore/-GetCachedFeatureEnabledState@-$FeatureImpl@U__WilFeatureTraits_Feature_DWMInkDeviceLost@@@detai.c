/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DWMInkDeviceLost@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180245F50
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DWMInkDeviceLost@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180245EC8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_DWMInkDeviceLost@@@details@wil@@QEAAX_NW4.c)
 * Callees:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DWMInkDeviceLost>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_DWMInkDeviceLost>::GetCurrentFeatureEnabledState(
      v7,
      &v17,
      &v16);
