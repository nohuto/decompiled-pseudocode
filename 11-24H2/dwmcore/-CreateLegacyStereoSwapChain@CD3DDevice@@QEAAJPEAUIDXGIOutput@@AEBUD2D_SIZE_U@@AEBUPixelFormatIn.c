/*
 * XREFs of ?CreateLegacyStereoSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVCLegacyStereoSwapChain@@@Z @ 0x1802B9C2C
 * Callers:
...
LABEL_20:
    ...
    v20 = v17;
LABEL_30:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803BD6F8, v20, v12, v23, 0LL);
  }
