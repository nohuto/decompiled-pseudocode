/*
 * XREFs of ?GetBoundsWithEffects@CVisual@@UEBAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x180038220
 * Callers:
  ...
  *a3 = *a2;
  ...
  if ( (*v7 & 0x800000) != 0 )
  {
    ...
    if ( v12 )
    {
      ...
      {
        if ( !CEffectGeneratedT<CEffect,CPropertyChangeResource>::IsOfType(v12, 61) )
          return Bounds;
      }
      else if ( !((unsigned __int8 (__fastcall *)(__int64, __int64))v15)(v12, 61LL) )
      {
        return Bounds;
      }
      ...
      if ( (int)result < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, result, 0x18B0u, 0LL);
        return v16;
      }
      return result;
    }
  ...
  if ( !v13 )
    return Bounds;
  v17 = a1[37];
  if ( a1[36] != 0.0 && v17 != 0.0 || *((_BYTE *)a1 + 704) )
  {
    v19 = *(_QWORD *)a1;
    v21 = *((_DWORD *)a1 + 36);
    v22 = v17;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Bounds, 0x18C4u, 0LL);
      return Bounds;
    }
  }
