/*
 * XREFs of ?ProcessKernelTokens@CGlobalSurfaceManager@@AEAAJXZ @ 0x180156CE4
 * Callers:
 *     ?s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z @ 0x18022D870 (-s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z.c)
 * Callees:
