/*
 * XREFs of ?Alloc@?$CThreadLocalObjectCache@VCCpuClipAntialiasDrawListEntry@@V1@@@SAPEAX_K@Z @ 0x18019C0DC
 * Callers:
...
_QWORD *CThreadLocalObjectCache<CCpuClipAntialiasDrawListEntry,CCpuClipAntialiasDrawListEntry>::Alloc()
{
  _DWORD *Value; // rbx
  int v1; // edx
  _QWORD *v2; // rcx
  ...
  if ( !v2 )
  {
    ...
    return HeapAlloc(ProcessHeap, 0, 0x70uLL);
  }
  return v2;
}
