/*
 * XREFs of ?GetInflationScale@CMonitorTransform@@QEBAM_N@Z @ 0x180212A80
 * Callers:
 *     ?GetInflationScale@CLegacyRenderTarget@@UEBAMXZ @ 0x18003DB30 (-GetInflationScale@CLegacyRenderTarget@@UEBAMXZ.c)
 *     ?GetInflationScale@CDDisplayRenderTarget@@UEBAMXZ @ 0x1802275D0 (-GetInflationScale@CDDisplayRenderTarget@@UEBAMXZ.c)
 * Callees:
 *     <none>
 */
