/*
 * XREFs of ?reset@?$com_ptr_t@VCBlurRenderingGraph@@Uerr_returncode_policy@wil@@@wil@@QEAAXXZ @ 0x1802116A0
 * Callers:
...
__int64 __fastcall wil::com_ptr_t<CBlurRenderingGraph,wil::err_returncode_policy>::reset(__int64 *a1)
{
  __int64 v1; // rdx
  __int64 result; // rax
