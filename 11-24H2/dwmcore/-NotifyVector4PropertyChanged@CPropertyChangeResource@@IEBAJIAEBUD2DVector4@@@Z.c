/*
 * XREFs of ?NotifyVector4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector4@@@Z @ 0x180182EDC
 * Callers:
        ...
        const struct D2DVector4 *a3)
{
         ...
         11LL) )
  {
    ...
    v14 = v10;
    v12 = CoreUICallSend(v11, v13, 2LL, 11LL, 4, &unk_18032BF7E, a2, &v14, ChannelCallbackId);
    if ( v12 != -2018375675 )
      v6 = v12;
    if ( v6 < 0 )
