/*
 * XREFs of ?SetClip@CVisual@@QEAAJPEAVCGeometry@@@Z @ 0x180133470
 * Callers:
...
__int64 __fastcall CVisual::SetClip(CVisual *this, struct CGeometry *a2)
{
  ...
  char (__fastcall *v6)(CRegionGeometry *, const struct CGeometry *); // rax
  ...
  if ( a2 != v4 )
  {
    if ( a2 )
    {
      v6 = *(char (__fastcall **)(CRegionGeometry *, const struct CGeometry *))(*(_QWORD *)a2 + 200LL);
      if ( (char *)v6 == (char *)CRectangleGeometry::IsSameGeometry )
      {
      ...
      if ( v11 < 0 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0xA99u, 0LL);
        return v3;
      }
