/*
 * XREFs of ?ProcessSetDesktopTree@CLegacyRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LEGACYRENDERTARGET_SETDESKTOPTREE@@@Z @ 0x18027EA48
 * Callers:
        ...
        const struct tagMILCMD_LEGACYRENDERTARGET_SETDESKTOPTREE *a3)
{
  ...
  {
    wil::com_ptr_t<CDesktopTree,wil::err_returncode_policy>::operator=(this + 23, (__int64)Resource, (__int64)a3);
