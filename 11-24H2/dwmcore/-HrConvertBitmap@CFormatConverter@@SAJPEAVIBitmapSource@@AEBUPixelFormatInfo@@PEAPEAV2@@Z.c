/*
 * XREFs of ?HrConvertBitmap@CFormatConverter@@SAJPEAVIBitmapSource@@AEBUPixelFormatInfo@@PEAPEAV2@@Z @ 0x1802DCBF4
 * Callers:
 ...
 *     ??0CFormatConverter@@QEAA@XZ @ 0x1802DC34C (--0CFormatConverter@@QEAA@XZ.c)
