/*
 * XREFs of ?SetOcclusionInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x180278E90
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[18] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x1169u, 0LL);
    }
    else
    {
