/*
 * XREFs of ?Thunk_MarkProxyReadyOnPropertiesRefreshed_5@?$IBamoPeer_dataprovider_AutoBamos_Receive@VBamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18026FF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IBamoPeer_dataprovider_AutoBamos_Receive<BamoImpl::dataprovider_AutoBamos::BamoPeerImpl>::Thunk_MarkProxyReadyOnPropertiesRefreshed_5(
        __int64 a1,
        unsigned int **a2)
{
