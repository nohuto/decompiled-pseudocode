/*
 * XREFs of ?AdvanceInertiaToTimeDefault@CMotion@@MEAAMXZ @ 0x18021CDA0
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ @ 0x180216E60 (-AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ.c)
