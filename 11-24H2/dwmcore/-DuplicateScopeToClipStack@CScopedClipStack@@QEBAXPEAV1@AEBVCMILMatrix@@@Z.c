/*
 * XREFs of ?DuplicateScopeToClipStack@CScopedClipStack@@QEBAXPEAV1@AEBVCMILMatrix@@@Z @ 0x1800F6CF8
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  __int64 v16; // rsi
  __int64 v17; // r14
  CRectanglesShape *v18; // [rsp+30h] [rbp-48h] BYREF
  ...
  *(_QWORD *)(v5 - 160) = *(_QWORD *)(v6 - 160);
  v9 = 0xCCCCCCCCCCCCCCCDuLL * ((__int64)(*((_QWORD *)this + 244) - *((_QWORD *)this + 243)) >> 3);
  v10 = v9 - *(_DWORD *)(v6 - 176);
  v11 = v10;
  if ( v10 < v9 )
  {
    v14 = *((_QWORD *)this + 243);
    do
    {
      ...
      detail::vector_facade<CScopedClipStack::CpuClipStackState,detail::buffer_impl<CScopedClipStack::CpuClipStackState,10,1,detail::liberal_expansion_policy>>::emplace_back<>((_QWORD *)a2 + 243);
      v17 = *((_QWORD *)a2 + 244);
      CShapePtr::~CShapePtr((CRectanglesShape **)(v17 - 40));
      *(_QWORD *)(v17 - 40) = v16;
      *(_BYTE *)(v17 - 32) = 0;
      v18 = 0LL;
      v19 = 0;
