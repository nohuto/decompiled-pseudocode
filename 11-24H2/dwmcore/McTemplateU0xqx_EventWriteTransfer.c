/*
 * XREFs of McTemplateU0xqx_EventWriteTransfer @ 0x1802D852C
 * Callers:
 *     ?NotifyUnPinned@CDxHandleBitmapRealization@@UEAAXXZ @ 0x1802D80B0 (-NotifyUnPinned@CDxHandleBitmapRealization@@UEAAXXZ.c)
 *     ?NotifyUnPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ @ 0x1802D9470 (-NotifyUnPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ.c)
 * Callees:
