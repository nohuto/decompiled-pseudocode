/*
 * XREFs of ?Create@CCpuClipAntialiasDrawListEntry@@SAJAEBUCpuClipAntialiasEntryParams@@$$QEAV?$unique_ptr@VUVData@CCpuClipAntialiasSink@@U?$default_delete@VUVData@CCpuClipAntialiasSink@@@std@@@std@@PEAPEAV1@@Z @ 0x180170420
 * Callers:
...
__int64 __fastcall CCpuClipAntialiasDrawListEntry::Create(__int64 a1, __int64 *a2, _QWORD *a3)
{
  ...
  float v69[4]; // [rsp+38h] [rbp-69h] BYREF
  __int128 v70; // [rsp+48h] [rbp-59h]
  __int64 v71; // [rsp+58h] [rbp-49h] BYREF
  int v72; // [rsp+60h] [rbp-41h]
  int v73; // [rsp+64h] [rbp-3Dh]
  void *retaddr; // [rsp+100h] [rbp+5Fh]
  float Y; // [rsp+108h] [rbp+67h] BYREF
  float v76; // [rsp+120h] [rbp+7Fh] BYREF
  ...
  if ( v4 < v8 )
  {
    ...
    if ( v16 > 0.000081380211 )
    {
      ...
      while ( (unsigned int)v17 < v13 )
      {
        ...
        *(float *)&v70 = v21;
        v18 = fmaxf(v18, v67);
        *(_QWORD *)((char *)&v70 + 4) = __PAIR64__(LODWORD(v19), LODWORD(v20));
        *((float *)&v70 + 3) = v18;
...
LABEL_15:
    ...
    do
    {
      ...
      v17 = (unsigned int)(v17 + 1);
      *(_QWORD *)&v70 = __PAIR64__(LODWORD(v20), LODWORD(v21));
      *((_QWORD *)&v70 + 1) = __PAIR64__(LODWORD(v18), LODWORD(v19));
    }
...
LABEL_20:
  ...
  v72 = *(_DWORD *)(a1 + 72);
  v32 = *(_BYTE *)(v31 + 80);
  v33 = PrimitiveStorage::Alloc_16_((unsigned int *)&v71);
  v34 = v33;
  if ( v33 )
  {
    v35 = v70;
    ...
    *((_QWORD *)v33 + 9) = *(_QWORD *)(v31 + 72);
    ...
    else
    {
      ...
      (**(void (__fastcall ***)(char *, __int64))v34)(v34, 1LL);
      return 2147942414LL;
    }
  }
  else
