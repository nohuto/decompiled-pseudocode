/*
 * XREFs of ?ResetBackBuffer@CCompSwapChain@@IEAAJXZ @ 0x1802C8080
 * Callers:
...
__int64 __fastcall CCompSwapChain::ResetBackBuffer(CCompSwapChain *this)
{
  ...
  if ( v5 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v7, 0x181u, 0LL);
    }
    else
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v9, 0x183u, 0LL);
      }
      else
      {
        v10 = *((_QWORD *)this + 7);
        ...
        if ( DeviceTextureTarget < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, DeviceTextureTarget, 0x18Bu, 0LL);
        else
  ...
  {
    v8 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, -2003304307, 0x191u, 0LL);
  }
  return v8;
}
