/*
 * XREFs of ?Pop@CDrawingContext@@UEAAJXZ @ 0x180082B30
 * Callers:
...
__int64 __fastcall CDrawingContext::Pop(CDrawingContext *this)
{
  ...
  {
    v6 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147467259, 0x12BFu, 0LL);
  }
      ...
      switch ( v7 )
      {
        case 1:
          ...
          *((_BYTE *)this + 8049) = 1;
          return v6;
        case 2:
          CDrawingContext::PopCpuClip((CDrawingContext *)((char *)this - 16), (__int64)&_ImageBase);
          return v6;
        case 3:
          v34 = *((_DWORD *)this + 64);
          if ( v34 )
...
LABEL_33:
        ...
        case 7:
          ...
          v6 = v55;
          if ( v55 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v55, 0x12D3u, 0LL);
          return v6;
        case 8:
          v53 = *((_DWORD *)this + 64);
          if ( v53 )
        ...
        case 10:
          ...
          v6 = v58;
          if ( v58 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v58, 0x12E7u, 0LL);
          return v6;
        case 11:
          v25 = *((_DWORD *)this + 64);
          if ( v25 )
