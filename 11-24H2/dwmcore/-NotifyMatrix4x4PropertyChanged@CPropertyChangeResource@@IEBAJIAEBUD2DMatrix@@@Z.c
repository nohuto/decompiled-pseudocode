/*
 * XREFs of ?NotifyMatrix4x4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DMatrix@@@Z @ 0x180182078
 * Callers:
      ...
      if ( *((_DWORD *)this + 18) )
      {
        ...
        if ( _bittest(&v9, a2) )
        {
          ...
          if ( v10 )
          {
            ...
            v19[2] = v15;
            v19[3] = v16;
            v17 = CoreUICallSend(v10, v18, 2LL, 11LL, 8, &unk_18032BF96, a2, v19, v12);
            if ( v17 != -2018375675 )
              v4 = v17;
            if ( v4 < 0 )
