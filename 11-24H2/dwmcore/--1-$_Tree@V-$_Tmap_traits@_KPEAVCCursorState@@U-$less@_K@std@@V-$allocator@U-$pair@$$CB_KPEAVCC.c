/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@_KPEAVCCursorState@@U?$less@_K@std@@V?$allocator@U?$pair@$$CB_KPEAVCCursorState@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x180151D70
 * Callers:
 ...
 *     ??1CCursorManager@@QEAA@XZ @ 0x18024D738 (--1CCursorManager@@QEAA@XZ.c)
 *     ??1BufferingMessageCallHost@BamoImpl@Microsoft@@UEAA@XZ @ 0x18026DBB8 (--1BufferingMessageCallHost@BamoImpl@Microsoft@@UEAA@XZ.c)
 *     ??1CSceneComponent@@MEAA@XZ @ 0x1802ACBD8 (--1CSceneComponent@@MEAA@XZ.c)
 * Callees:
