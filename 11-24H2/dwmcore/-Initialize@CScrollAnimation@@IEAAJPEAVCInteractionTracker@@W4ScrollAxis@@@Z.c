/*
 * XREFs of ?Initialize@CScrollAnimation@@IEAAJPEAVCInteractionTracker@@W4ScrollAxis@@@Z @ 0x1801E0FE8
 * Callers:
 ...
 *     ?InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z @ 0x1802B65EC (-InsertMaskElement@VectorSubchannelMaskInfo@@QEAAJE@Z.c)
 */
...
__int64 __fastcall CScrollAnimation::Initialize(__int64 a1, int *a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 324) = a3;
  ...
  v10 = CInteractionTracker::RegisterIndirectTargetsForBoundTrackers((__int64)a2, a1, v9);
  if ( v10 < 0 )
  {
    v14 = 115;
LABEL_17:
