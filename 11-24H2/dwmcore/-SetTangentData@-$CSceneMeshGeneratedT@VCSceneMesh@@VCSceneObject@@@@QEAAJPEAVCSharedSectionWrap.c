/*
 * XREFs of ?SetTangentData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180279FE4
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[19] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xE78u, 0LL);
    }
    else
    {
