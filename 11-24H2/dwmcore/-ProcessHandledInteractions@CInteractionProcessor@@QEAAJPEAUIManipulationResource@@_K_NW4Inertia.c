/*
 * XREFs of ?ProcessHandledInteractions@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@_K_NW4InertiaFrameType@@AEBUManipulationThreadTelemetryData@@PEAVIDCompositionInteractionStats@@PEAW4PointerResult@@@Z @ 0x18008C7FC
 * Callers:
 ...
 *     ?IsManipulationCaptured@CManipulation@@UEAA_NXZ @ 0x18008CC10 (-IsManipulationCaptured@CManipulation@@UEAA_NXZ.c)
 *     ?GetCaptureSettings@CManipulation@@UEAA?AW4SystemManipulationMode@@XZ @ 0x18008CC30 (-GetCaptureSettings@CManipulation@@UEAA-AW4SystemManipulationMode@@XZ.c)
    ...
    || *(_DWORD *)(a1 + 788) == 6 )
  {
    ...
    if ( (v17 & 0x10) == 0 )
    {
      *(_BYTE *)(a1 + 808) = (16 * a4) | v17 & 0xEF;
      ...
      CInteractionProcessor::GetInteractionContext(a1, *(unsigned int *)(a1 + 788), &v28);
      v19 = v28;
      if ( v28 )
      {
        v35 = 0LL;
