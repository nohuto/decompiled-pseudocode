/*
 * XREFs of ?Compute@StepInterpolation@@UEAAXMW4DCOMPOSITION_EXPRESSION_TYPE@@PEAVCExpressionValue@@11@Z @ 0x1801B4C10
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v11 != 4 )
  {
    switch ( v11 )
    {
      ...
      case 1:
        ...
        return;
      case 2:
        KeyframeInterpolation::InterpolateHsl(v12, (__int64)&_ImageBase, &a4->r, &a5->r, (__int64)a6);
        return;
      case 3:
