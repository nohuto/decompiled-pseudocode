/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_DesktopDWMCursor@@@details@wil@@QEAA_NXZ @ 0x180240E28
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x18009AAD0 (wil_details_FeatureReporting_RecordUsageInCache.c)
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DesktopDWMCursor@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1802410BC (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_DesktopDWMCursor@@@detai.c)
...
unsigned __int8 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DesktopDWMCursor>::__private_IsEnabled(
        volatile signed __int32 *a1)
{
    ...
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v4
        ...
        || (v20.m128i_i64[0] = 3LL,
            ...
            !wil::details_abi::heap_buffer::push_back((void **)&unk_1803F9818, &v20, 0x10uLL)) )
      {
  ...
  if ( (*a1 & 4) == 0 )
  {
    v23 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_DesktopDWMCursor>::GetCachedFeatureEnabledState(
                       a1,
                       &v24);
    LOWORD(v8) = v23;
  }
  ...
  if ( (v8 & 0x400) != 0 )
  {
    ...
    wil::details::WilApi_RecordFeatureUsage((wil::details *)0x1A8A411, v16, 0LL);
  }
  if ( !v15 )
  {
    ...
    {
      LOBYTE(v14) = 1;
      g_wil_details_realtimeFeatureUsageHook(27829265LL, v10, v14);
    }
    if ( g_wil_details_pfnFeatureLoggingHook )
    {
      ...
      if ( (char *)g_wil_details_pfnFeatureLoggingHook == (char *)wil::details::FeatureLoggingHook )
        ...
        g_wil_details_pfnFeatureLoggingHook(27829265LL, &v25, 0LL, v9, &v24, 0LL, 0, 1LL);
    }
  }
  return v9;
}
