/*
 * XREFs of ?AddOp_Binary@ScanPipelineBuilder@@QEAAJP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZPEAUOpSpecificData@@W4Subpipe@1@@Z @ 0x1802DD3C8
 * Callers:
 ...
 *     ?PingPongBuffer@ScanPipelineBuilder@@IEAAXW4Subpipe@1@@Z @ 0x1802DDABC (-PingPongBuffer@ScanPipelineBuilder@@IEAAXW4Subpipe@1@@Z.c)
 */
