/*
 * XREFs of InitializeShaderLinkingInput @ 0x1801C1680
 * Callers:
 ...
 *     GetHlslNameAndSemantic @ 0x1801C1840 (GetHlslNameAndSemantic.c)
 *     ?ResolveKey@VertexShaderDesc@@QEBAIXZ @ 0x1801C2334 (-ResolveKey@VertexShaderDesc@@QEBAIXZ.c)
...
__int64 __fastcall InitializeShaderLinkingInput(struct ID3D11Linker **ppLinker, char a2, VertexShaderDesc *a3)
{
  ...
  v17 = *((_OWORD *)&unk_1802FC510 + VertexShaderDesc::ResolveKey(a3));
  v6 = v17;
  for ( i = v17; i; i = v8 )
  {
    v8 = i - 1;
