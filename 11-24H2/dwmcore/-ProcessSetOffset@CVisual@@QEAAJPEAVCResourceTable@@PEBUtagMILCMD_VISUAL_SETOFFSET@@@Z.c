/*
 * XREFs of ?ProcessSetOffset@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETOFFSET@@@Z @ 0x1800BE380
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETOFFSET *a3)
{
  ...
  _QWORD *v16; // rsi
  __int64 v17; // rax
  struct CProcessAttribution *(__fastcall *v18)(CWindowNode *__hidden); // rax
    ...
    if ( (*((_BYTE *)v4 + 106) & 0x40) != 0 )
    {
      do
      {
        ...
        *((_BYTE *)v16 + 96) |= 0x91u;
        ...
        v18 = *(struct CProcessAttribution *(__fastcall **)(CWindowNode *__hidden))(*v16 + 160LL);
    ...
    if ( v21 )
    {
      if ( *(_DWORD *)(v21 + 108) )
      {
        if ( *((_DWORD *)v4 + 18) )
        {
          ...
          {
            v42 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)v4 + 3) + 6392LL) + 72LL))(
                    *(_QWORD *)(*((_QWORD *)v4 + 3) + 6392LL),
                    11LL);
            if ( v42 )
            {
              v43 = *((_QWORD *)v4 + 7);
              ...
              v45 = CoreUICallSend(v42, v52, 2LL, 11LL, 3, &unk_18032BF78, 28, &v50, (_DWORD)v49);
              v46 = 0;
              if ( v45 != -2018375675 )
                v46 = v45;
              if ( v46 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v46, 0x155u, 0LL);
            }
          }
        }
      }
