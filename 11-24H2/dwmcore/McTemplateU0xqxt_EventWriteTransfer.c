/*
 * XREFs of McTemplateU0xqxt_EventWriteTransfer @ 0x1802D85BC
 * Callers:
 *     ?NotifyPinned@CDxHandleBitmapRealization@@UEAAXXZ @ 0x1802D8050 (-NotifyPinned@CDxHandleBitmapRealization@@UEAAXXZ.c)
 *     ?NotifyPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ @ 0x1802D9410 (-NotifyPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ.c)
 * Callees:
