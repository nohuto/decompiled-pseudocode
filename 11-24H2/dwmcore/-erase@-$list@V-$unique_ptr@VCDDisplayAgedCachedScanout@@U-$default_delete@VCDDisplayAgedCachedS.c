 ...
 *     ?NotifyRealizationBitmapReleased@CDDisplaySwapChain@@UEAAXPEAUIDisplaySurface@Core@Display@Devices@Windows@@@Z @ 0x180215030 (-NotifyRealizationBitmapReleased@CDDisplaySwapChain@@UEAAXPEAUIDisplaySurface@Core@Display@Devic.c)
 * Callees:
...
_QWORD *__fastcall std::list<std::unique_ptr<CDDisplayAgedCachedScanout>>::erase(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  __int64 v4; // rbx
