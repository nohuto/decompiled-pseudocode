/*
 * XREFs of ?CalculatePlane@D2DVectorHelper@@YA?AUD2D_VECTOR_4F@@AEBU2@00@Z @ 0x180167744
 * Callers:
        ...
        const struct D2D_VECTOR_4F *a4)
{
  ...
  v11 = z - retstr->z;
  v12 = a4->x - a3->x;
  v13 = (float)(v8 * v10) - (float)(v11 * v7);
  v14 = a3->x - retstr->x;
  v15 = (float)(v14 * v7) - (float)(v8 * v12);
  v16 = (float)(v11 * v12) - (float)(v14 * v10);
  v17 = sqrtf_0((float)((float)(v16 * v16) + (float)(v13 * v13)) + (float)(v15 * v15));
  if ( COERCE_FLOAT(LODWORD(v17) & _xmm) < 0.0000011920929 )
    v17 = *(float *)&`CVisual::SetOpacityInternal'::`2'::sc_defaultValue;
  v18 = v16;
  result = this;
  v20 = (float)(v16 * retstr->y) + (float)(v13 * retstr->x);
  this->x = v13 / v17;
