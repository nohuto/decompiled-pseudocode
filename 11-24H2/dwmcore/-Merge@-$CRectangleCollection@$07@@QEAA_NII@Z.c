/*
 * XREFs of ?Merge@?$CRectangleCollection@$07@@QEAA_NII@Z @ 0x180241D74
 * Callers:
 ...
 *     ?MoveOverhead@?$CRectangleCollection@$07@@AEAAXII@Z @ 0x18024215C (-MoveOverhead@-$CRectangleCollection@$07@@AEAAXII@Z.c)
 */
