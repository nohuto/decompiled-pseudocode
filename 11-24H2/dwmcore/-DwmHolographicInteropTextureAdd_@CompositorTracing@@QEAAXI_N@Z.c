/*
 * XREFs of ?DwmHolographicInteropTextureAdd_@CompositorTracing@@QEAAXI_N@Z @ 0x1802CEF30
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicInteropTextureAdd_(CompositorTracing *this, int a2, char a3)
{
  ...
  if ( *v5 > 4u && tlgKeywordOn((__int64)v5, 0x400000000000LL) )
  {
    ...
    v9 = a2;
    v15 = 1;
    tlgWriteTransfer_EventWriteTransfer(v6, byte_1803D0123, 0LL, 0LL, v7, &v10);
  }
}
