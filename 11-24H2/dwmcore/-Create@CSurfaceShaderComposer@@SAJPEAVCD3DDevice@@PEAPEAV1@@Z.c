/*
 * XREFs of ?Create@CSurfaceShaderComposer@@SAJPEAVCD3DDevice@@PEAPEAV1@@Z @ 0x180186F5C
 * Callers:
...
__int64 __fastcall CSurfaceShaderComposer::Create(struct CD3DDevice *a1, struct CSurfaceShaderComposer **a2)
{
  ...
  v7 = v6(v2, &unk_18032DAB0, 832LL, 0LL, &v25);
  v8 = v7;
  if ( v7 < 0 )
  {
    v21 = 134;
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
    McTemplateU0t_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_D3DSHADER_CREATE_Stop, 0LL);
  ...
  v7 = v9(v2, &v32, 3LL, &unk_18032DAB0, 832LL, &v24);
  v8 = v7;
  if ( v7 < 0 )
  {
    v21 = 143;
