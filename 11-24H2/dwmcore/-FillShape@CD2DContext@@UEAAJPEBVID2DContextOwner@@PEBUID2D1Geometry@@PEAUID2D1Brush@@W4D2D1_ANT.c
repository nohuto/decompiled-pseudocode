/*
 * XREFs of ?FillShape@CD2DContext@@UEAAJPEBVID2DContextOwner@@PEBUID2D1Geometry@@PEAUID2D1Brush@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x1800CE290
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_PRIMITIVE_BLEND a6)
{
  ...
  __int64 (__fastcall *v14)(CDrawingContext *__hidden); // rax
  float v15; // eax
  __int64 v16; // r8
  __int64 v17; // rax
  int v18; // eax
  __int64 v19; // r8
  __int64 (__fastcall *v20)(CDrawingContext *__hidden); // rax
  float v21; // eax
  __int64 v22; // r8
  ...
  {
    v14 = *(__int64 (__fastcall **)(CDrawingContext *__hidden))(*(_QWORD *)a2 + 8LL);
  ...
  if ( EventEnabled(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_DRAWEVENT) )
  {
    ...
    *(_OWORD *)&v28.m11 = 0LL;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0x410u, 0LL);
      return v10;
    }
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
    {
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
  {
    v20 = *(__int64 (__fastcall **)(CDrawingContext *__hidden))(*(_QWORD *)a2 + 8LL);
