/*
 * XREFs of ?GetBounds@CMaskBrush@@UEBAJAEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18014D400
 * Callers:
...
__int64 __fastcall CMaskBrush::GetBounds(__int64 a1, struct D2D_SIZE_F *a2, float *a3, __int64 a4)
{
  ...
  if ( v6 )
  {
    ...
    if ( Bounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, Bounds, 0xAEu, 0LL);
    }
    else
    {
      ...
      if ( v11 )
      {
        ...
        if ( v13 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0xB3u, 0LL);
        }
        else
        {
          v14 = *a3;
