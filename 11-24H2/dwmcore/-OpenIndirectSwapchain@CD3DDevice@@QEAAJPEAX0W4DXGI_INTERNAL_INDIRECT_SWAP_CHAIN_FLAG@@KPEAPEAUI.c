/*
 * XREFs of ?OpenIndirectSwapchain@CD3DDevice@@QEAAJPEAX0W4DXGI_INTERNAL_INDIRECT_SWAP_CHAIN_FLAG@@KPEAPEAUIDXGIIndirectSwapChain@@@Z @ 0x1802BA834
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  *a6 = 0LL;
  ...
  v9 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304307, 0x326u, 0LL);
LABEL_12:
