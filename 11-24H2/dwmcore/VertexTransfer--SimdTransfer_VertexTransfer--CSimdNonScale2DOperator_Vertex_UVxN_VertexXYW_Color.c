/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x18015C18C
 * Callers:
        ...
        __int64 a4)
{
  ...
  __int64 v42; // r11
  __int128 v44; // [rsp+30h] [rbp-98h] BYREF
  ...
  if ( a3 && a4 )
  {
    LOWORD(v4) = CalculateTBNFrameFrom3Vertices((__int64)&v44, v6, (__int64 *)v5);
    v11 = v44;
  }
  v13 = 0;
  v14 = *(_DWORD *)(a1 + 20);
  ...
  if ( v14 )
  {
    do
    {
      ...
      *(_WORD *)(v40 + 28) = v39;
      LOWORD(v4) = DirectX::PackedVector::XMConvertFloatToHalf(v41, v35.m128_f32[0]);
      v13 += 2;
      *(_WORD *)(v42 + 30) = (_WORD)v4;
    }
    while ( v13 < v14 );
  }
  return (__int16)v4;
