/*
 * XREFs of ?RenderRevealBorder@CWindowNode@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEBVCShape@@@Z @ 0x1800693EC
 * Callers:
...
__int64 __fastcall CWindowNode::RenderRevealBorder(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  int v5; // ebx
  ...
  if ( (unsigned int)CCompositionSurfaceBitmap::GetSizePreference(CurrentFlip) == 1
    && (*(_DWORD *)(a1 + 704) - *(_DWORD *)(a1 + 696) > a3[2] - *a3
     || (int)(HIDWORD(*(_QWORD *)(a1 + 704)) - HIDWORD(*(_QWORD *)(a1 + 696))) > a3[3] - a3[1]) )
  {
    ...
    *(_OWORD *)v23 = v13;
    ...
    v24 = 1;
    v5 = CShape::Combine(v28, v14, v25, 0LL, 2, &v23[1]);
    wil::details::out_param_t<std::unique_ptr<CShape>>::~out_param_t<std::unique_ptr<CShape>>(v23);
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x42Fu, 0LL);
    }
    else if ( a4 )
    {
      v20 = v23;
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x438u, 0LL);
      }
      else
      {
        ...
        v5 = v16;
        if ( v16 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x43Bu, 0LL);
      }
    ...
    else
    {
      ...
      v5 = v17;
      if ( v17 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x43Fu, 0LL);
    }
