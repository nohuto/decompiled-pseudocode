/*
 * XREFs of ?GetCasterShadowInputBrush@CProjectedShadow@@AEBAJPEAVCDrawingContext@@PEAPEAVCDrawListBrush@@@Z @ 0x18006C274
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F **a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( v7 )
    {
      ...
      {
        v10 = -2147418113;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147418113, 0x1EFu, 0LL);
        goto LABEL_23;
      }
  ...
  *(_QWORD *)&v27.left = 0LL;
  ...
  v29 = 0LL;
  v30 = 1;
  v10 = CSurfaceDrawListBrush::CreateWithContentRect(&v31, &v33, v9, &v29);
  if ( v30 )
  {
    v11 = *(_QWORD *)&v28->left;
    *(_QWORD *)&v28->left = v29;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x1FAu, 0LL);
    if ( *(_QWORD *)&v27.left )
      std::default_delete<CSurfaceDrawListBrush>::operator()();
  ...
  else
  {
    v12 = *(_QWORD *)&v27.left;
    *(_QWORD *)&v27.left = 0LL;
    std::unique_ptr<CDrawListBrush>::reset(&v34, v12);
    if ( *(_QWORD *)&v27.left )
      std::default_delete<CSurfaceDrawListBrush>::operator()();
    CDrawListBitmap::~CDrawListBitmap((CDrawListBitmap *)&v31);
    if ( *((_DWORD *)this + 63) )
    ...
    TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::Inflate(&v27);
    v31 = 0LL;
    v32 = 0LL;
    ...
    *((float *)&v29 + 1) = v17 * 0.5;
    ...
    if ( v10 >= 0 )
    {
      v20 = v33;
      v33 = 0LL;
      std::unique_ptr<CDrawListBrush>::reset(&v34, v20);
      if ( v33 )
...
LABEL_20:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x22Bu, 0LL);
    if ( v33 )
