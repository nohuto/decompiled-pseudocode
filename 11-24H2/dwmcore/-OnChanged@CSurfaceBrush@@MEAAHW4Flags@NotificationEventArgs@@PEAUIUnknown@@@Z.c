/*
 * XREFs of ?OnChanged@CSurfaceBrush@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1801C8960
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall CSurfaceBrush::OnChanged(_QWORD *a1, int a2)
{
  ...
  {
    if ( *(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)v2 + 64LL) == CCompositionSurfaceBitmap::IsOfType )
      v4 = 1;
    else
      v4 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 64LL))(v2, 42LL);
    v5 = v4 == 0;
  }
  else
  {
