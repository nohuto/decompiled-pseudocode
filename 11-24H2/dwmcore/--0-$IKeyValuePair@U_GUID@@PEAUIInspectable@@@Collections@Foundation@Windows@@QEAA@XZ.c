/*
 * XREFs of ??0?$IKeyValuePair@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1802C0CF4
 * Callers:
 ...
 * Callees:
 *     ??0?$IKeyValuePair_impl@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1802C0D18 (--0-$IKeyValuePair_impl@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
