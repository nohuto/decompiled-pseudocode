/*
 * XREFs of ?GetPlaneResourceDesc@CDDisplaySwapChainBuffer@@UEBAJPEAUDWM_PLANE_RESOURCE_DESC@@@Z @ 0x1801FB6F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DWM_PLANE_RESOURCE_DESC *a2)
{
  ...
  v3 = (_QWORD *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 27) + 120LL))(*((_QWORD *)this + 27));
  v4 = v3;
  if ( !v3 )
    return 2291662854LL;
  v5 = *v3;
