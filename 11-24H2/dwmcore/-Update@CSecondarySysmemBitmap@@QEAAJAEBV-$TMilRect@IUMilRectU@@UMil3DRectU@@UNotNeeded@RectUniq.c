/*
 * XREFs of ?Update@CSecondarySysmemBitmap@@QEAAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@@Z @ 0x180022C7C
 * Callers:
...
__int64 __fastcall CSecondarySysmemBitmap::Update(__int64 a1, _DWORD *a2, __int64 a3)
{
  ...
  {
    v16 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xAAu, 0LL);
  }
  else
  {
    ...
    if ( *v9 == v10 )
    {
      ...
      *(_QWORD *)v18 = *(_QWORD *)(a1 + 136) + a2[1] * (int)v12 + *a2 * (PixelFormatSize >> 3);
      ...
      v16 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0xBCu, 0LL);
      else
    ...
    {
      v16 = -2003292288;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292288, 0xAFu, 0LL);
    }
  }
  return v16;
}
