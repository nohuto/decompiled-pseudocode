/*
 * XREFs of ?Present@CLegacySwapChain@@UEAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I@Z @ 0x1801C7300
 * Callers:
...
__int64 __fastcall CLegacySwapChain::Present(__int64 a1, unsigned int a2, int a3, __int64 *a4, int a5)
{
  ...
  int v19; // ecx
  int v20; // r9d
  unsigned int v21[2]; // [rsp+20h] [rbp-78h]
  ...
  else
  {
    *(_QWORD *)v21 = v6;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x369u, 0LL);
    }
    else
    {
      v15 = 0LL;
...
LABEL_30:
  ...
  v18 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(v9 + 552) + 312LL))(*(_QWORD *)(v9 + 552));
  v19 = *(_DWORD *)(v9 + 1112);
  if ( v18 == -2005270480 )
  {
    if ( !v19 )
...
LABEL_15:
  v23 = 0;
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v14, 1, &v23) )
  {
    v20 = v23;
    if ( v23 == -2003304307 )
    {
    ...
    v14 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0xB31u, 0LL);
  }
  v10 = v14;
  if ( v14 < 0 )
    goto LABEL_23;
  ...
  CLegacySwapChain::PostPresent((CLegacySwapChain *)(a1 - 24), v7, v14 == 142213121);
  return v10;
}
