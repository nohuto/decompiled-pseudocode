/*
 * XREFs of ?Grow@?$CWatermarkStack@W4Enum@MilBackfaceVisibility@@$0EA@$01$09@@AEAAJ_KIIPEAPEAX@Z @ 0x180195C60
 * Callers:
...
__int64 __fastcall CWatermarkStack<enum MilBackfaceVisibility::Enum,64,2,10>::Grow(
        __int64 a1,
        void *a2,
        __int64 a3,
        __int64 a4,
