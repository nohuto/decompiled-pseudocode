/*
 * XREFs of ?RemoveAt@?$DynArray@PEAVCChannelContext@@$00@@QEAAJI@Z @ 0x18019EBB0
 * Callers:
...
__int64 __fastcall DynArray<CChannelContext *,1>::RemoveAt(__int64 *a1, unsigned int a2)
{
  unsigned int v2; // r8d
  unsigned int v3; // ebx
  unsigned int v4; // r9d
