/*
 * XREFs of ?Add@?$CMap@IV?$ComPtr@VCManipulationContext@@@WRL@Microsoft@@V?$CMapEqualHelper@IV?$ComPtr@VCManipulationContext@@@WRL@Microsoft@@@@@@QEAAHAEBIAEBV?$ComPtr@VCManipulationContext@@@WRL@Microsoft@@@Z @ 0x1801940D4
 * Callers:
        ...
        __int64 a3)
{
  ...
  v8 = *(void **)(a1 + 8);
  *(_QWORD *)a1 = v6;
  v9 = DefaultHeap::Realloc(v8, 8LL * (*(_DWORD *)(a1 + 16) + 1));
  if ( !v9 )
    return 0LL;
