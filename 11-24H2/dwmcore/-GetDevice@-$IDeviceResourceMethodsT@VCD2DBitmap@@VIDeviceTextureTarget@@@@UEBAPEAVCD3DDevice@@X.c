/*
 * XREFs of ?GetDevice@?$IDeviceResourceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@UEBAPEAVCD3DDevice@@XZ @ 0x1801C25D0
 * Callers:
 *     ?GetDevice@?$IDeviceResourceMethodsT@VCD2DResource@@VID2DBitmap@@@@WEI@EBAPEAVCD3DDevice@@XZ @ 0x1802CD4F0 (-GetDevice@-$IDeviceResourceMethodsT@VCD2DResource@@VID2DBitmap@@@@WEI@EBAPEAVCD3DDevice@@XZ.c)
