/*
 * XREFs of ?Unlock@CBitmapLock@@IEAAXXZ @ 0x18018B7AC
 * Callers:
 ...
 *     ?UnlockState@CBitmap@@UEAAJW4WICBitmapLockFlags@@@Z @ 0x18018B880 (-UnlockState@CBitmap@@UEAAJW4WICBitmapLockFlags@@@Z.c)
