/*
 * XREFs of ??$_Emplace_reallocate@AEA_K@?$vector@_KV?$allocator@_K@std@@@std@@AEAAPEA_KQEA_KAEA_K@Z @ 0x1801FFAEC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v12 = *a3;
  ...
  std::vector<CVectorShape *>::_Change_array((__int64)a1, (__int64)v11, v8, v9);
