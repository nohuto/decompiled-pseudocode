/*
 * XREFs of ??Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ @ 0x18017E3B8
 * Callers:
 ...
 *     ?IsEmpty@CPathSegmentsShape@@UEBA_NXZ @ 0x18017E240 (-IsEmpty@CPathSegmentsShape@@UEBA_NXZ.c)
 * Callees:
