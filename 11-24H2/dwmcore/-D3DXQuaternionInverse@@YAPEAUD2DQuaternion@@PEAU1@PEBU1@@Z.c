/*
 * XREFs of ?D3DXQuaternionInverse@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@@Z @ 0x1802B5558
 * Callers:
 *     ?Divide@CExpressionValueStack@@QEAAJXZ @ 0x1801CE150 (-Divide@CExpressionValueStack@@QEAAJXZ.c)
 * Callees:
 *     WithinEpsilon_0 @ 0x1801F6834 (WithinEpsilon_0.c)
 */
...
__m128 *__fastcall D3DXQuaternionInverse(__m128 *a1, const struct D2DQuaternion *a2)
{
  ...
  else
  {
    ...
    v7 = (__m128)(unsigned int)`CVisual::SetOpacityInternal'::`2'::sc_defaultValue;
