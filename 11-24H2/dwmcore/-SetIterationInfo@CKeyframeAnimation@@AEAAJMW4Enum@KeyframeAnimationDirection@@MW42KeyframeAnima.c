/*
 * XREFs of ?SetIterationInfo@CKeyframeAnimation@@AEAAJMW4Enum@KeyframeAnimationDirection@@MW42KeyframeAnimationStopBehavior@@@Z @ 0x1801DB35C
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::SetIterationInfo(__int64 a1, float a2, int a3, double a4, int a5)
{
  ...
  {
    v13 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147418113, 0x3EFu, 0LL);
    return v13;
  }
  if ( a2 != 1.0 )
  {
  ...
  if ( a3 )
  {
    switch ( a3 )
    {
      ...
      default:
        v13 = -2147024809;
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x432u, 0LL);
        return v13;
    }
    v8 = 1;
  }
LABEL_4:
  ...
  {
    v13 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x445u, 0LL);
  }
  else
  {
    *(_DWORD *)(a1 + 500) = v7;
