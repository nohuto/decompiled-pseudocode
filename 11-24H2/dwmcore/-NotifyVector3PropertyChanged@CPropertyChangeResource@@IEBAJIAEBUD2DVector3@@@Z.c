/*
 * XREFs of ?NotifyVector3PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector3@@@Z @ 0x180181F44
 * Callers:
      ...
      if ( *((_DWORD *)this + 18) )
      {
        ...
        if ( _bittest(&v9, a2) )
        {
          ...
          if ( v10 )
          {
            ...
            v14 = CoreUICallSend(v10, v17, 2LL, 11LL, 3, &unk_18032BF78, a2, &v15, v13);
            if ( v14 != -2018375675 )
              v4 = v14;
            if ( v4 < 0 )
