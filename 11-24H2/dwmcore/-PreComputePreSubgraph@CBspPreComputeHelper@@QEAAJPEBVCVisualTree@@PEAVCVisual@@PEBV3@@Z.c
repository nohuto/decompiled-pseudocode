/*
 * XREFs of ?PreComputePreSubgraph@CBspPreComputeHelper@@QEAAJPEBVCVisualTree@@PEAVCVisual@@PEBV3@@Z @ 0x18008F500
 * Callers:
        ...
        const struct CVisual *a4)
{
  ...
  _DWORD *v23; // rcx
  bool v24; // bl
  struct CTreeEffect *(__fastcall *v25)(CLayerVisual *__hidden); // rax
  __int64 v26; // rax
  char v27; // al
  __int64 v28; // rax
  ...
  {
    v24 = a4 && *v10 == 1;
    v25 = *(struct CTreeEffect *(__fastcall **)(CLayerVisual *__hidden))(*(_QWORD *)a3 + 224LL);
    ...
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*v33 + 64LL))(*v33, 61LL) )
LABEL_32:
      v27 = 1;
    else
LABEL_50:
