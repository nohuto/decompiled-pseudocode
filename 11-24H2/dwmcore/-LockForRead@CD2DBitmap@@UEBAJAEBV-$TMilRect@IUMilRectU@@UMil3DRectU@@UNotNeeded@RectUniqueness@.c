/*
 * XREFs of ?LockForRead@CD2DBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x180195500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DBitmap::LockForRead(__int64 a1, int *a2, CBitmapLock **a3)
{
  ...
  else
  {
    ...
    {
      v29 = 0LL;
      v22 = (const struct PixelFormatInfo *)(*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 - 8) + 24LL))(
                                              a1 - 8,
                                              v35);
