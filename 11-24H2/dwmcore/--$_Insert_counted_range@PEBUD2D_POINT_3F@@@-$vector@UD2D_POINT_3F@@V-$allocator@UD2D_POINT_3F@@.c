/*
 * XREFs of ??$_Insert_counted_range@PEBUD2D_POINT_3F@@@?$vector@UD2D_POINT_3F@@V?$allocator@UD2D_POINT_3F@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UD2D_POINT_3F@@@std@@@std@@@1@PEBUD2D_POINT_3F@@_K@Z @ 0x1801F5AB4
 * Callers:
