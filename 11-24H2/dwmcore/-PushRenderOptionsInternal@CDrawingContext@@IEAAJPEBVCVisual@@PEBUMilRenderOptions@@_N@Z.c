/*
 * XREFs of ?PushRenderOptionsInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBUMilRenderOptions@@_N@Z @ 0x1800F5410
 * Callers:
...
LABEL_27:
        ...
        wil::details::in1diag3::Return_Hr(
          ...
          (int)"onecoreuap\\windows\\DWM\\dwmcore\\common\\WatermarkStack.inl",
          (const char *)v12);
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x1233u, 0LL);
        return v12;
      }
      v19 = 101LL;
    }
...
LABEL_39:
  ...
  wil::details::in1diag3::Return_Hr(
    ...
    (int)"onecoreuap\\windows\\DWM\\dwmcore\\common\\WatermarkStack.inl",
    (const char *)v12);
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x1241u, 0LL);
  if ( !a4 )
  {
LABEL_10:
    if ( (*(_BYTE *)a3 & 2) != 0 )
