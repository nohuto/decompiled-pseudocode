/*
 * XREFs of _lambda_6f49ef1c5e266dfff6ad3ca7d4dec8df_::_lambda_invoker_cdecl_ @ 0x18016CC00
 * Callers:
        ...
        __int64 a3)
{
  ...
  v5 = (bool (__fastcall *)(__int64, int))(*a1)[1];
  if ( v5 != CSurfaceDrawListBrush::IsOfType
    && ((char *)v5 != (char *)CGeometryOnlyDrawListBrush::IsOfType
      ? ((char *)v5 != (char *)CNineGridDrawListBrush::IsOfType
       ? (v22 = v5((__int64)a1, 3))
       : (v22 = CNineGridDrawListBrush::IsOfType(a1, 3LL)))
      : (v22 = CGeometryOnlyDrawListBrush::IsOfType(a1, 3LL)),
        v22)
    || (v6 = *(CCommonRenderingEffect **)(*((_QWORD *)a2 + 1) + 80LL)) == 0LL
    || a2[46] >= a2[45] )
  {
LABEL_24:
  ...
  v25 = 0;
  v24 = 0LL;
  v9 = (bool (__fastcall *)(__int64, int))v7[1];
  if ( v9 == CSurfaceDrawListBrush::IsOfType || v9((__int64)a1, 2) )
  {
    v10 = a1[7];
    *(_QWORD *)&v24 = v10;
    if ( v10 )
  ...
  v18 = CDrawListEntryBuilder::End(*((CDrawListEntryBuilder **)a2 + 1));
  v19 = v18;
  if ( v18 >= 0 )
  {
LABEL_19:
