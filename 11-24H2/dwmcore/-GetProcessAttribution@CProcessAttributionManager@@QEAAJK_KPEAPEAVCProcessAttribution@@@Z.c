/*
 * XREFs of ?GetProcessAttribution@CProcessAttributionManager@@QEAAJK_KPEAPEAVCProcessAttribution@@@Z @ 0x1801E70C0
 * Callers:
        ...
        struct CProcessAttribution **a4)
{
  ...
  if ( v4 == this[1] || (v12 = *v4, *(_QWORD *)*v4 != a3) )
  {
...
LABEL_15:
    ...
    else
    {
      *v19 = *(v19 - 1);
      ++this[1];
      memmove_0(v4 + 1, v4, (char *)v19 - (char *)v4 - 8);
      *v4 = v17;
    }
...
LABEL_26:
  ...
  if ( !v13 )
  {
    ProcessAttribution = CProcessAttributionManager::CreateProcessAttribution(
                           (CProcessAttributionManager *)this,
                           v9,
                           (const struct CProcessAttributionManager::ProcessAttributionRecord *)v12,
                           1,
                           a4);
    v5 = ProcessAttribution;
    if ( ProcessAttribution >= 0 )
