/*
 * XREFs of ?OnEdgyDetected@CManipulation@@QEAAXPEBUEdgyDetectedParams@@@Z @ 0x18028A7BC
 * Callers:
...
void __fastcall CManipulation::OnEdgyDetected(CManipulation *this, const struct EdgyDetectedParams *a2)
{
  ...
  (*(void (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6392LL) + 72LL))(
  ...
  if ( CNotificationResource::ShouldNotify(this) )
  {
    if ( v5 )
    {
      ...
      *(_QWORD *)&v8 = *((_QWORD *)a2 + 6);
      v14[2] = v9;
      v15 = v8;
      CoreUICallSend(v11, v13, 2LL, 10LL, v10, &unk_18032BF65, (unsigned int)v14, v12, ChannelCallbackId);
    }
  }
}
