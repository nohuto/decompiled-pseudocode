/*
 * XREFs of ??$?4U?$default_delete@VCBetterCheckMPOCache@@@std@@$0A@@?$unique_ptr@VCBetterCheckMPOCache@@U?$default_delete@VCBetterCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1802B8064
 * Callers:
 *     std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_std::unique_ptr_CBetterCheckMPOCache_std::default_delete_CBetterCheckMPOCache___________lambda_fe304b6b2b6f0e67e1f1dd6983e4971f___ @ 0x1802B876C (std--remove_if_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_std--unique_ptr_CBetter.c)
