/*
 * XREFs of ?CalcTimeoutTimeMs@CClockBase@@IEBAIXZ @ 0x1800EE058
 * Callers:
 *     ?WaitForNextTick@CClockBase@@UEAA?AW4WaitResult@ICompositorClock@@PEAX@Z @ 0x1800EDA40 (-WaitForNextTick@CClockBase@@UEAA-AW4WaitResult@ICompositorClock@@PEAX@Z.c)
