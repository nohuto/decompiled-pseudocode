/*
 * XREFs of ?ProcessRemoveChild@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_REMOVECHILD@@@Z @ 0x180036610
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_REMOVECHILD *a3)
{
  ...
  __int64 (__fastcall *v24)(CCachedVisualImage *); // rax
  ...
  if ( !v3
    ...
    || ((v10 = *(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 64LL), v10 == CKeyframeAnimation::IsOfType)
      ? (v11 = CKeyframeAnimation::IsOfType(v9, 184LL))
      : v10 != CVisual::IsOfType
      ? (v10 != CSharedSection::IsOfType
       ? (v11 = v10(v9, 184LL))
       : (v11 = CSharedSection::IsOfType(v9, 184LL)))
      : (v11 = CVisual::IsOfType(v9, 184LL)),
        !v11 || (v12 = *(_QWORD *)(v8 + 8)) == 0) )
  {
    v6 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0xC14u, 0LL);
    return v6;
  }
  v13 = *((_QWORD *)this + 10);
  if ( (v13 & 2) != 0 )
...
LABEL_34:
  ...
  {
    CVisual::DirtyForInvisibleChild(this, (struct CVisual *)v12);
  ...
  v23 = *(_QWORD *)v12;
  *(_QWORD *)(v12 + 88) = 0LL;
  v24 = *(__int64 (__fastcall **)(CCachedVisualImage *))(v23 + 16);
  if ( v24 == CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease )
    CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease((CCachedVisualImage *)v12);
  else
    v24((CCachedVisualImage *)v12);
  return 0;
}
