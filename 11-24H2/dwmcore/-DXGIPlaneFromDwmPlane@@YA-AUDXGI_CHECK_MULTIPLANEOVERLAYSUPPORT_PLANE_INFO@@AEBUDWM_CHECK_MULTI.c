/*
 * XREFs of ?DXGIPlaneFromDwmPlane@@YA?AUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@AEBUDWM_CHECK_MULTIPLANE_OVERLAY_SUPPORT_PLANE_INFO@@@Z @ 0x18006724C
 * Callers:
 ...
 *     ?GetDXGIResource@CLegacySwapChainBuffer@@UEAAPEAUIDXGIResource@@PEAI@Z @ 0x180067390 (-GetDXGIResource@CLegacySwapChainBuffer@@UEAAPEAUIDXGIResource@@PEAI@Z.c)
