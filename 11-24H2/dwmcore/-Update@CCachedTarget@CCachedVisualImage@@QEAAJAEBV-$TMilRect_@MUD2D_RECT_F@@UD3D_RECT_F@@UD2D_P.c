/*
 * XREFs of ?Update@CCachedTarget@CCachedVisualImage@@QEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@W4Enum@MilStretch@@AEBVRenderTargetInfo@@@Z @ 0x18000B988
 * Callers:
 ...
 *     ?FlushCurrentTargetOnPopForDImage@CD2DContext@@QEAAXXZ @ 0x1801F1FA0 (-FlushCurrentTargetOnPopForDImage@CD2DContext@@QEAAXXZ.c)
...
LABEL_58:
    ...
    v95 = 0;
    v93 = v92;
    v56 = (struct CVisualTree *)(*(__int64 (__fastcall **)(__int64 *))(*v55 + 216))(v55);
...
LABEL_12:
  if ( dword_1803F8D50 && (*(unsigned __int8 (__fastcall **)(__int64 *))(**this + 208))(*this) && v6 < 0 )
  {
    v69 = (__int64)*this;
    v70 = (void **)DwmDbg::DbgString::DbgString((char **)&v74, word_18032AF78);
    switch ( v6 )
    {
      case -2147467263:
