/*
 * XREFs of ?ProcessSetTransform@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTRANSFORM@@@Z @ 0x1801327D8
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETTRANSFORM *a3)
{
  ...
  if ( !v3
    ...
    && ((v13 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v12 + 64LL), v13 == CKeyframeAnimation::IsOfType)
      ? (v8 = CKeyframeAnimation::IsOfType(v12, 175))
      : v13 != CVisual::IsOfType
      ? (v13 != CSharedSection::IsOfType
       ? (v8 = v13(v12, 175))
       : (v8 = CSharedSection::IsOfType(v12, 175)))
      : (v8 = CVisual::IsOfType(v12, 175)),
        v8 && (v4 = *(struct CTransform3D **)(v11 + 8)) != 0LL) )
  {
    v9 = CVisual::SetTransform(this, v4);
    v7 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x9A6u, 0LL);
  }
  else
  {
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0x9A2u, 0LL);
  }
  return v7;
}
