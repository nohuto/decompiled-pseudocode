        ...
        __int128 *a15)
{
  ...
  D2D_POINT_2F v36[2]; // [rsp+80h] [rbp-80h] BYREF
  ...
  v21 = *(_DWORD *)(a1 + 616);
  v22 = *(_QWORD *)(a1 + 1536);
  v36[1] = (D2D_POINT_2F)&v44;
  v36[0] = (D2D_POINT_2F)2LL;
  ...
  if ( CompositingPixelShaderNoRef >= 0 )
  {
    ...
    *((float *)&v42 + 3) = (float)v29;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x9A7u, 0LL);
    }
    else
    {
      v32 = *(_QWORD *)(a1 + 1536);
      v36[1] = (D2D_POINT_2F)&v34;
      v36[0] = (D2D_POINT_2F)1LL;
      ...
      v24 = v33;
      if ( v33 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x9B4u, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CompositingPixelShaderNoRef, 0x9A1u, 0LL);
  }
  return v24;
}
