/*
 * XREFs of ?GetSyncLockCount@CDDisplayRenderTarget@@UEBAI_KI@Z @ 0x18027F320
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( v7 || *((_DWORD *)this + 8256) != 1 )
  {
    OutstandingPresents = CTargetStats::GetOutstandingPresents((CDDisplayRenderTarget *)((char *)this + 32984), a2);
    if ( a3 > OutstandingPresents
      && (v7
       || CTreeDirty::DoesIntersect(*((_QWORD *)this + 4) + 112LL, (const struct D2D_RECT_F *)((char *)this + 30360))) )
    {
