/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderProxyImpl@BamoImpl@@QEAAJXZ @ 0x180273030
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v9, &v11, 2LL, 0LL, 2, &unk_180383D63, v14, v15, savedregs[0]);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
