/*
 * XREFs of ?Push2DVisualTransformToRenderThread@CInteraction@@UEAAJXZ @ 0x1800EC500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteraction::Push2DVisualTransformToRenderThread(CInteraction *this)
{
  ...
  struct _D3DMATRIX v13; // [rsp+80h] [rbp-9h] BYREF
...
LABEL_4:
    ...
    v16 = v9;
    v12 = *D3DMatrix;
    v11 = CoreUICallSend(v14, &v16, 1LL, 9LL, 3, &unk_18032BF55, (unsigned int)&v15, &v12, LODWORD(v12._11));
    v6 = v11;
    if ( v11 < 0 )
