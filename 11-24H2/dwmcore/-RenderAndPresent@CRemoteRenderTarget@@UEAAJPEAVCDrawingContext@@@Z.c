/*
 * XREFs of ?RenderAndPresent@CRemoteRenderTarget@@UEAAJPEAVCDrawingContext@@@Z @ 0x180278340
 * Callers:
 *     ?RenderAndPresent@CRemoteRenderTarget@@WEI@EAAJPEAVCDrawingContext@@@Z @ 0x1802783A0 (-RenderAndPresent@CRemoteRenderTarget@@WEI@EAAJPEAVCDrawingContext@@@Z.c)
 *     ?RenderAndPresent@CRemoteRenderTarget@@WFA@EAAJPEAVCDrawingContext@@@Z @ 0x1802783B0 (-RenderAndPresent@CRemoteRenderTarget@@WFA@EAAJPEAVCDrawingContext@@@Z.c)
 * Callees:
