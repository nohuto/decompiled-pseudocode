/*
 * XREFs of ?ProcessSetFlipManager@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURERENDERTARGET_SETFLIPMANAGER@@@Z @ 0x1801583A8
 * Callers:
        ...
        void **a3)
{
  ...
  v5 = OpenFlipProducer(a3[1], (char *)this + 3024, (char *)this + 3040);
  if ( v5 >= 0 )
  {
    v7 = *((_QWORD *)this + 378);
