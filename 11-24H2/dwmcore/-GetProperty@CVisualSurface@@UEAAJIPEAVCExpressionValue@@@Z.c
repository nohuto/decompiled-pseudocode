/*
 * XREFs of ?GetProperty@CVisualSurface@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18028E6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisualSurface::GetProperty(CVisualSurface *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, v5, -2147024809, 0x34u, (void *)(v5 & v9));
  }
  return v3;
}
