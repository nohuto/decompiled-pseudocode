/*
 * XREFs of ?HrFindInterface@CD3DSurface@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C8A50
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802B7F70 (-HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
