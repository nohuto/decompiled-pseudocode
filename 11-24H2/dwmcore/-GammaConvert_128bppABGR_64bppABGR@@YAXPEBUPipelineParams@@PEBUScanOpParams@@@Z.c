/*
 * XREFs of ?GammaConvert_128bppABGR_64bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1802DE1A0
 * Callers:
 *     <none>
 * Callees:
 *     ?Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z @ 0x1802B4EF8 (-Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z.c)
 */
