/*
 * XREFs of ?AddMaskBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCMaskBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x1801FE5EC
 * Callers:
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  if ( *((_BYTE *)v4 + 96) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x163u, 0LL);
      goto LABEL_19;
    }
    v5 = 0;
  }
  if ( v6 )
  {
    ...
    {
      v5 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x169u, 0LL);
      goto LABEL_19;
    }
    v14 = v18;
    if ( v18 )
    ...
    if ( *((_BYTE *)v6 + 96) )
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x17Du, 0LL);
