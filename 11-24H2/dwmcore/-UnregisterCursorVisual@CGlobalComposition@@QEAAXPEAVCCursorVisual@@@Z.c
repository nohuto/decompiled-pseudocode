/*
 * XREFs of ?UnregisterCursorVisual@CGlobalComposition@@QEAAXPEAVCCursorVisual@@@Z @ 0x1802636C0
 * Callers:
...
void __fastcall CGlobalComposition::UnregisterCursorVisual(CGlobalComposition *this, struct CCursorVisual *a2)
{
  ...
  v2 = (struct CCursorVisual **)*((_QWORD *)this + 817);
  v3 = (char *)this + 6528;
  for ( i = (struct CCursorVisual **)*((_QWORD *)this + 816); i != v2 && *i != a2; ++i )
    ;
  if ( i != v2 )
  {
    for ( j = i + 1; j != v2; ++j )
