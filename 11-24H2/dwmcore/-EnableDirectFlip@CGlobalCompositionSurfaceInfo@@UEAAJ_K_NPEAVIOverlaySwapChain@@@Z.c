/*
 * XREFs of ?EnableDirectFlip@CGlobalCompositionSurfaceInfo@@UEAAJ_K_NPEAVIOverlaySwapChain@@@Z @ 0x1802294E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IOverlaySwapChain *a4)
{
  ...
  {
    v5 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x14Cu, 0LL);
  }
  else
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x148u, 0LL);
  }
  return v5;
}
