/*
 * XREFs of ?SetState@CHolographicDisplay@@UEAAJJ@Z @ 0x1802D1570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHolographicDisplay::SetState(CHolographicDisplay *this, int a2)
{
  ...
  {
    if ( (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this - 7) + 6392LL) + 72LL))(
           *(_QWORD *)(*((_QWORD *)this - 7) + 6392LL),
           7LL) )
    {
      ...
      v6 = CoreUICallSend(v5, v10, 2LL, 7LL, 0, &unk_18032BF21, a2, v9, ChannelCallbackId);
