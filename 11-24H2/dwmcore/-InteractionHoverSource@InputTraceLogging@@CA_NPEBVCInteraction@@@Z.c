/*
 * XREFs of ?InteractionHoverSource@InputTraceLogging@@CA_NPEBVCInteraction@@@Z @ 0x1801B8EB4
 * Callers:
...
bool __fastcall InputTraceLogging::InteractionHoverSource(const struct CInteraction *a1)
{
  bool result; // al

  result = 0;
  if ( a1 )
    return *((_QWORD *)a1 + 36) != 0LL;
  return result;
}
