/*
 * XREFs of ?GetPlaneOfVisual@ShadowHelpers@@YA?AUD2D_VECTOR_4F@@PEAVCVisual@@@Z @ 0x180163E88
 * Callers:
        ...
        struct CVisual *a3)
{
  float x; // xmm2_4
  float y; // xmm1_4
  D2D_VECTOR_4F v7; // [rsp+20h] [rbp-40h] BYREF
  ...
  v8.z = 0.0;
  v9.z = 0.0;
  *(_QWORD *)&v7.z = *(_QWORD *)&_xmm.b;
  v8.w = 1.0;
  v8.y = y;
  v9.x = x;
  v9.y = y;
  v9.w = 1.0;
  D2DVectorHelper::CalculatePlane(this, &v7, &v8, &v9, *(const struct D2D_VECTOR_4F **)&_xmm.r);
