/*
 * XREFs of ?AddEdgeFlags@CPolygonMapStrategy@CEdgeFlagsMap@@QEAAXAEBUD2D_RECT_F@@W4D2D1_EDGE_FLAGS@@PEBVMatrix3x3@@M@Z @ 0x180151948
 * Callers:
 ...
 *     ?TransformHomogeneousPoint@Matrix3x3@@QEBA?AUD2D_POINT_2F@@U2@@Z @ 0x1801520B0 (-TransformHomogeneousPoint@Matrix3x3@@QEBA-AUD2D_POINT_2F@@U2@@Z.c)
  ...
  else
  {
    do
    {
      ...
      result = CConvexPolygonEdgeMap<unsigned int>::TryAddEdge(
                 a1,
                 (unsigned int)&unk_18032D960 + 32 * v11,
