/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VIUnknownWeakRefSource@@VCResourceDeleter@@@@IEAAKXZ @ 0x18004E540
 * Callers:
...
__int64 __fastcall CMILRefCountBaseT<IUnknownWeakRefSource,CResourceDeleter>::InternalRelease(CCachedVisualImage *this)
{
  int v2; // ebx
  ...
  if ( !v2 )
  {
    if ( _InterlockedAdd((volatile signed __int32 *)this + 2, 1u) <= 0 )
      wil::details::in1diag3::Log_Hr(
        ...
        (const char *)0x8007029CLL,
        v5);
    v4 = *(void (__fastcall **)(CVisual *__hidden))(*(_QWORD *)this + 40LL);
    if ( v4 == CVisual::FinalRelease )
    {
      CVisual::FinalRelease(this);
    }
    else if ( v4 == CCachedVisualImage::FinalRelease )
    {
      CCachedVisualImage::FinalRelease(this);
    }
    else
    {
      v4(this);
