/*
 * XREFs of ?OnAddBinding@CAnimation@@MEAAJPEAUAnimationBinding@CBaseAnimation@@@Z @ 0x18020EE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAnimation::OnAddBinding(CAnimation *this, struct CBaseAnimation::AnimationBinding *a2)
{
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      ...
      {
        CAnimationInterpolator::GetInterpolatedValue((CAnimation *)((char *)this + 248), *(_QWORD *)(v5 + 8), &v11, 0LL);
