/*
 * XREFs of ?GetBounds@CEffectBrush@@QEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@PEAV2@@Z @ 0x1800A705C
 * Callers:
  ...
  *a4 = *a2;
  if ( *(_QWORD *)(a1 + 128) )
  {
    ...
    if ( SourceInputBounds < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, SourceInputBounds, 0x2C6u, 0LL);
    else
