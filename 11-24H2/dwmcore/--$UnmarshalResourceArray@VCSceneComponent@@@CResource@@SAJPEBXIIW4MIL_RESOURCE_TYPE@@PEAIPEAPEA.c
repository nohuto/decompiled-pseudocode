/*
 * XREFs of ??$UnmarshalResourceArray@VCSceneComponent@@@CResource@@SAJPEBXIIW4MIL_RESOURCE_TYPE@@PEAIPEAPEAPEAVCSceneComponent@@PEAVCResourceTable@@_N@Z @ 0x180273F50
 * Callers:
        ...
        __int64 a7)
{
  ...
  v8 = 0LL;
  result = CResource::UnmarshalResourceArray(a1, a2, a3, 0x8Eu, a5, &v8, a7, 0);
  *a6 = v8;
  return result;
}
