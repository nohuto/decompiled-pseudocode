/*
 * XREFs of ?TryDrawSuperWetLocal@CSuperWetInkManager@@AEAAJPEAVCSuperWetSource@@PEAVCDrawingContext@@_NPEA_N@Z @ 0x18018E754
 * Callers:
        ...
        bool *a5)
{
  ...
  *(_OWORD *)v27 = 0LL;
  ...
  if ( TreeData && (v14 = (const __m128i *)TreeData[34]) != 0LL )
  ...
  {
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x100000) != 0 )
      McTemplateU0x_EventWriteTransfer(v16, &EVTDESC_COMPUTESCRIBBLE_DRAWSKIPPED, (__int64)a2);
    *a5 = 1;
    return 0LL;
  }
