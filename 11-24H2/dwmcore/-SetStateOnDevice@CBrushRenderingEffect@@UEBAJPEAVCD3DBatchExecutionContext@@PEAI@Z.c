/*
 * XREFs of ?SetStateOnDevice@CBrushRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x18010C8E0
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  struct CLinkedShader *v137; // rax
  int v138; // r12d
  int v139; // r12d
  void *(__fastcall *v140)(CDrawListEntry *__hidden, unsigned int); // rax
  _BYTE *v141; // rsi
  _BYTE *v142; // rbx
  ...
  struct CLinkedShader *v177; // [rsp+58h] [rbp-A8h] BYREF
  ...
  v187 = v4;
  v6 = this;
  v7 = (struct CLinkedShader *)*((_QWORD *)a2 + 3);
  v188 = a3;
  memset(v225, 0, 32);
  v183 = a2;
  v176 = this;
  ...
  while ( v11 < v13 )
  {
    ...
    if ( v16 == CCachedVisualImage::GetDeviceTexture )
    {
      ...
      wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset(
        &v181,
        (__int64)CCachedImageProducer::GetDeviceTexture,
        (__int64)CDxHandleBitmapRealization::GetDeviceTexture);
...
LABEL_17:
    *((_QWORD *)v224 + v11) = ShaderResourceView;
    ...
    while ( v28 != (_DWORD *)&unk_18032FDD8 );
    v29 = 0;
    if ( v28 != (_DWORD *)&unk_18032FDD8 )
      v29 = v10;
    v10 = v29;
LABEL_27:
    v3 = (float *)v175;
      ...
      else
      {
        ...
        if ( v136 && _InterlockedAdd(v136 + 2, 1u) <= 0 )
          wil::details::in1diag3::Log_Hr(
            ...
            v172);
        v137 = (struct CLinkedShader *)v136;
        if ( v136 )
        {
            ...
            if ( !v139 )
            {
              if ( _InterlockedDecrement(v136 + 2) < -1 )
                wil::details::in1diag3::Log_Hr(
                  ...
                  (const char *)0x8007029CLL,
                  v172);
              v140 = *(void *(__fastcall **)(CDrawListEntry *__hidden, unsigned int))(*(_QWORD *)v136 + 16LL);
...
LABEL_222:
              ...
              v178 = 0LL;
              wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset((volatile signed __int32 **)&v178);
              ...
              {
                v170 = (CRenderingTechnique *)v98[1];
                v175 = 0LL;
...
LABEL_317:
              v150 = v175;
              v177 = (struct CLinkedShader *)(v136 + 8);
              std::vector<IDeviceResourceNotify *>::_Emplace_one_at_back<IDeviceResourceNotify * const &>(
                (char **)v175 + 6,
                &v177);
          ...
          {
            v174 = 0LL;
            wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset((volatile signed __int32 **)&v174);
...
LABEL_220:
      ...
      v136 = (volatile signed __int32 *)v177;
      goto LABEL_299;
    }
...
LABEL_45:
      ...
      *((_QWORD *)v225 + (unsigned int)v35) = *((_QWORD *)v41 + 221);
      ...
      while ( v42 != (_DWORD *)&unk_18032FDD8 );
...
LABEL_78:
              ...
              *((_BYTE *)&v200 + 32 * (unsigned int)v178 + 8) = v63;
              v64 = v42 != (_DWORD *)&unk_18032FDD8 && v30;
