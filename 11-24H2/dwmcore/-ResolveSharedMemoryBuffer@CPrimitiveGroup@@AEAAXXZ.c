/*
 * XREFs of ?ResolveSharedMemoryBuffer@CPrimitiveGroup@@AEAAXXZ @ 0x180038F2C
 * Callers:
 ...
 *     ?ClearPrimitiveContent@CPrimitiveGroup@@AEAAXXZ @ 0x1802A1A6C (-ClearPrimitiveContent@CPrimitiveGroup@@AEAAXXZ.c)
...
void __fastcall CPrimitiveGroup::ResolveSharedMemoryBuffer(CPrimitiveGroup *this)
{
  ...
  v2 = (CCachedVisualImage *)*((_QWORD *)this + 11);
  if ( v2 )
  {
  ...
  v4 = (CCachedVisualImage *)*((_QWORD *)this + 12);
  if ( v4 )
  {
