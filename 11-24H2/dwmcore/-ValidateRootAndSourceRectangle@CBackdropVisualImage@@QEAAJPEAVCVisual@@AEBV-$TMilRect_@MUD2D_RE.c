/*
 * XREFs of ?ValidateRootAndSourceRectangle@CBackdropVisualImage@@QEAAJPEAVCVisual@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@_NPEA_N@Z @ 0x18000ACA0
 * Callers:
...
LABEL_5:
  ...
  if ( *((_QWORD *)this + 17) != a2
    ...
    || v13 )
  {
    v29 = CBackdropVisualImage::SetRootAndSourceRectangle((struct D2D_RECT_F *)this);
    v30 = v29;
    if ( v29 < 0 )
    {
...
LABEL_30:
  ...
  if ( v18 )
  {
    v37 = (void **)DwmDbg::DbgString::DbgString((char **)v48.m[2], word_18032AF78);
    v38 = "BVI-RealizationIsDirty-Updated";
    if ( !v16 )
      v38 = "BVI-RealizationIsDirty-NotUpdated";
    v39 = (void **)DwmDbg::DbgString::DbgString((char **)&v48, v38);
    CBackdropVisualImage::LogEtwEvent((__int64)this, v39, v37);
  }
  return 0LL;
}
