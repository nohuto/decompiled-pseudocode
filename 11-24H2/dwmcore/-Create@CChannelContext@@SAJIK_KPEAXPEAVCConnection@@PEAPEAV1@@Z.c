/*
 * XREFs of ?Create@CChannelContext@@SAJIK_KPEAXPEAVCConnection@@PEAPEAV1@@Z @ 0x1801E6B1C
 * Callers:
        ...
        struct CChannelContext **a6)
{
  ...
  v8 = 0;
  v19 = 0LL;
  ProcessAttribution = CProcessAttributionManager::GetProcessAttribution(qword_1803FAFC0, a2, a3, &v19);
