/*
 * XREFs of ?BetterIsHigherProprity@COverlayContext@@CA_NAEBVOverlayPlaneInfo@1@0@Z @ 0x180268904
 * Callers:
        ...
        const struct COverlayContext::OverlayPlaneInfo *a2)
{
  ...
  char v26; // al
  _BYTE v27[16]; // [rsp+20h] [rbp-28h] BYREF
...
LABEL_18:
  ...
  v16 = (enum DXGI_FORMAT *)(*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v15 + 24LL))(v15, v27);
  ColorChannelDepth = GetColorChannelDepth(*v16);
  v18 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)a2 + 2) + 48LL))(*((_QWORD *)a2 + 2));
  v19 = (enum DXGI_FORMAT *)(*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v18 + 24LL))(v18, v27);
