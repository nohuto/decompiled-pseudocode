/*
 * XREFs of ?PrepareIndexBuffer@CD3DBatchExecutionContext@@AEAAJI@Z @ 0x180106520
 * Callers:
...
LABEL_2:
    ...
    else
    {
      ...
      v15 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x9F1u, 0LL);
    }
    if ( !*(_DWORD *)(v11 + 1112)
...
LABEL_20:
        ...
        if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v15, 0LL, &v21) )
        {
          ...
          v15 = v18;
          if ( v18 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0xB31u, 0LL);
        }
        v12 = v15;
        if ( v15 >= 0 )
        {
