/*
 * XREFs of ??1CDDisplayCachedScanout@@QEAA@XZ @ 0x1800683C8
 * Callers:
...
void __fastcall CDDisplayCachedScanout::~CDDisplayCachedScanout(CDDisplayCachedScanout *this)
{
  ...
  if ( *(_QWORD *)this )
  {
    ...
    std::_Deallocate<16,0>(*(_QWORD **)this, 8 * ((__int64)(*((_QWORD *)this + 2) - *(_QWORD *)this) >> 3));
    *(_QWORD *)this = 0LL;
    *((_QWORD *)this + 1) = 0LL;
    *((_QWORD *)this + 2) = 0LL;
  }
