/*
 * XREFs of ?GetZ@CVisual@@QEBAHPEBVCVisualTree@@I@Z @ 0x18009F0C0
 * Callers:
...
__int64 __fastcall CVisual::GetZ(CVisual *this, const struct CVisualTree *a2, unsigned int a3)
{
  ...
  CMultiPrimitiveDrawListBrush *(__fastcall ***v51)(CMultiPrimitiveDrawListBrush *, char, __int64); // rcx
  CMultiPrimitiveDrawListBrush *(__fastcall *v52)(CMultiPrimitiveDrawListBrush *, char, __int64); // rax
  ...
  CMultiPrimitiveDrawListBrush *(__fastcall ***v60)(CMultiPrimitiveDrawListBrush *, char, __int64); // rcx
  CMultiPrimitiveDrawListBrush *(__fastcall *v61)(CMultiPrimitiveDrawListBrush *, char, __int64); // rax
...
LABEL_95:
              ...
              *(_QWORD *)((char *)v43 + v46) = v47;
              ...
              {
                CSurfaceDrawListBrush::`vector deleting destructor'(v48, 1, v19);
                v7 = 0LL;
              ...
              else
              {
                ...
                CMultiPrimitiveDrawListBrush::`vector deleting destructor'(v48, 1, v19);
                v7 = 0LL;
                v43 = (const struct CVisualTree *)((char *)v43 + 8);
              }
            }
...
LABEL_106:
          ...
          do
          {
            v51 = *(CMultiPrimitiveDrawListBrush *(__fastcall ****)(CMultiPrimitiveDrawListBrush *, char, __int64))v50;
            if ( *(_QWORD *)v50 )
            {
              v52 = **v51;
              ...
              {
                CSurfaceDrawListBrush::`vector deleting destructor'((CSurfaceDrawListBrush *)v51, 1, v19);
              }
              else if ( v52 == CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
              {
                CMultiPrimitiveDrawListBrush::`vector deleting destructor'((CMultiPrimitiveDrawListBrush *)v51, 1, v19);
              }
              else
              {
                ((void (__fastcall *)(CMultiPrimitiveDrawListBrush *(__fastcall ***)(CMultiPrimitiveDrawListBrush *, char, __int64), __int64, __int64, CVisual *))v52)(
                  v51,
                  1LL,
                  v19,
                  v7);
...
LABEL_129:
                    ...
                    *(_QWORD *)((char *)v53 + v56) = v57;
                    ...
                    {
                      CSurfaceDrawListBrush::`vector deleting destructor'(v58, 1, v24);
                      v7 = 0LL;
                    ...
                    else
                    {
                      ...
                      CMultiPrimitiveDrawListBrush::`vector deleting destructor'(v58, 1, v24);
                      v7 = 0LL;
                      v53 = (const struct CVisualTree *)((char *)v53 + 8);
                    }
                  }
...
LABEL_140:
                ...
                do
                {
                  v60 = *(CMultiPrimitiveDrawListBrush *(__fastcall ****)(CMultiPrimitiveDrawListBrush *, char, __int64))v9;
                  if ( *(_QWORD *)v9 )
                  {
                    v61 = **v60;
                    ...
                    {
                      CSurfaceDrawListBrush::`vector deleting destructor'((CSurfaceDrawListBrush *)v60, 1, v24);
                    }
                    else if ( v61 == CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
                    {
                      CMultiPrimitiveDrawListBrush::`vector deleting destructor'(
                        (CMultiPrimitiveDrawListBrush *)v60,
                        1,
                        v24);
                    }
                    else
                    {
                      ((void (__fastcall *)(CMultiPrimitiveDrawListBrush *(__fastcall ***)(CMultiPrimitiveDrawListBrush *, char, __int64), __int64, __int64, CVisual *))v61)(
                        v60,
                        1LL,
                        v24,
                        v7);
...
LABEL_21:
    ...
    if ( (char *)v13 == (char *)CWindowOcclusionInfo::UpdateZFromValidParent )
    {
