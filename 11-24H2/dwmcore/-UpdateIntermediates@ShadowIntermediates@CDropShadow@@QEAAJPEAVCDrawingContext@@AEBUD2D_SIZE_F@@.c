/*
 * XREFs of ?UpdateIntermediates@ShadowIntermediates@CDropShadow@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@M@Z @ 0x180136C8C
 * Callers:
        ...
        float a4)
{
  ...
  *((_WORD *)this + 34) = 0;
  ...
  if ( *((_QWORD *)this + 7) )
  {
    v24 = (struct D2D_RECT_F *)((char *)this + 8);
    if ( (v11 != *((float *)this + 2)
       || v12 != *((float *)this + 3)
       || v13 != *((float *)this + 4)
       || v14 != *((float *)this + 5))
      ...
      && ((v11 > -3.4028235e38 || v13 < 3.4028235e38) && (v12 > -3.4028235e38 || v14 < 3.4028235e38)
       || !TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsInfinite(&v24->left)) )
    {
  ...
  *(_OWORD *)((char *)this + 8) = *(_OWORD *)v29;
  if ( CDropShadow::ShadowIntermediates::IsRectangularShadow(this) && (float)(fminf(a3->width, a3->height) * 0.5) >= a4 )
  {
    if ( !ShadowHelpers::s_cpFastShadowBlur )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, FastShadowBitmap, 0x308u, 0LL);
        return v22;
      }
    }
    wil::com_ptr_t<IBitmapResource,wil::err_returncode_policy>::operator=(
      (CEffectIntermediateProducer **)this + 7,
  ...
  else if ( !*v15 )
  {
    ...
    *(_QWORD *)v29 = "DWM DropShadow Blur";
    ...
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v27, 0x31Du, 0LL);
      return v22;
    }
  }
  v18 = *((_QWORD *)this + 6);
