/*
 * XREFs of ?SetProperty@CCompositionAmbientLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180294F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionAmbientLight::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  v9[0] = 2LL;
  v9[1] = &CCompositionAmbientLight::k_rgAnimDef;
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x74u, 0LL);
  }
  return v7;
}
