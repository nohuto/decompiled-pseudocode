/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x1801A7690
 * Callers:
...
__int64 __fastcall Microsoft::BamoImpl::BaseBamoConnectionImpl::Join(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4)
{
  ...
  *(_QWORD *)v29 = *(_QWORD *)L"_BAMO";
  ...
  if ( v12 )
  {
    v14 = StringCchCopyW(v12, v11, (size_t *)L"System\\CompositionEngineDataProvider");
    if ( v14 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x184,
