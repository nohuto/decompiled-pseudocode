/*
 * XREFs of ?NotifyCurrentPropertyValues@CVisual@@MEBAJI@Z @ 0x180182CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisual::NotifyCurrentPropertyValues(CVisual *this, int a2)
{
  ...
  if ( v7
    && (v11 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 0x1Cu, (const struct D2DVector3 *)&v18),
        ...
        v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x196Au, 0LL);
  }
  else
  {
LABEL_30:
      ...
      || (v15 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 0x1Au, OpacityInternal), v2 = v15, v15 >= 0) )
    {
      if ( (a2 & 0x20000000) != 0
        ...
        && (v9 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 0x1Du, (const struct D2DVector2 *)&v17),
            ...
            v9 < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x197Cu, 0LL);
      }
      else
      {
        if ( (a2 & 0x40000000) == 0 )
        ...
        if ( v13
          && (v16 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 0x1Eu, (const struct D2DVector3 *)&v18),
              ...
              v16 < 0) )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0x1989u, 0LL);
        }
        else
        {
LABEL_31:
          if ( a2 < 0 )
          {
            CVisual::GetRelativeLayoutSizeInternal(this, &v18);
            *(_QWORD *)&v17.x = *(_QWORD *)&v18.x;
            if ( *(_QWORD *)&v18.x != CVisual::sc_defaultRelativeSize )
            {
              ...
              v2 = v14;
              if ( v14 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x1993u, 0LL);
            }
          }
        }
      }
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0x1973u, 0LL);
    }
  }
  return v2;
}
