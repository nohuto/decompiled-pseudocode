/*
 * XREFs of ?AlphaDivide_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1802DE4B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AlphaDivide_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( *((_DWORD *)a1 + 2) )
  {
    ...
    do
    {
      ...
      if ( v3 != *(float *)CFloat16::operator float((unsigned __int16 *)&word_1803F9884).m128i_i32 )
      {
