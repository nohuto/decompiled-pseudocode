/*
 * XREFs of ?SetRecentlyComposed@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAXXZ @ 0x180243568
 * Callers:
 ...
 *     ?SetRecentlyComposed@CGlobalCompositionSurfaceInfo@@UEAAXXZ @ 0x18024A4B0 (-SetRecentlyComposed@CGlobalCompositionSurfaceInfo@@UEAAXXZ.c)
 * Callees:
