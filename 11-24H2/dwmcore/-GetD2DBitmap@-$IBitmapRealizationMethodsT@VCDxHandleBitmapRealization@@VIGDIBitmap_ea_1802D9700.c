/*
 * XREFs of ?GetD2DBitmap@?$IBitmapRealizationMethodsT@VCDxHandleBitmapRealization@@VIGDIBitmapRealization@@@@WBEA@EAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802D9700
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        char a4)
{
  return IBitmapRealizationMethodsT<CDxHandleBitmapRealization,IGDIBitmapRealization>::GetD2DBitmap(
           (CDxHandleBitmapRealization *)(a1 - 320),
           a2,
           a3,
           a4);
}
