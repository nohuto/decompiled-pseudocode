/*
 * XREFs of ?OpenDxBltEvent@@YAJ_KPEAPEAX@Z @ 0x1800F3B80
 * Callers:
...
__int64 __fastcall OpenDxBltEvent(__int64 a1, void **a2)
{
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    {
      v6 = v13 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032CA20, 3u, v6, 0x84u, 0LL);
      goto LABEL_8;
    }
    v8 = DirectoryHandle;
LABEL_4:
...
LABEL_17:
  v11 = v5;
LABEL_7:
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032CA20, 3u, v11, RestartScan, 0LL);
LABEL_8:
  if ( DirectoryHandle )
