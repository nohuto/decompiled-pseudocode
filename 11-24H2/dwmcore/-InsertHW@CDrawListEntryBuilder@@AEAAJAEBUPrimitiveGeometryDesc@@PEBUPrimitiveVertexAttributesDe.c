/*
 * XREFs of ?InsertHW@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@PEBV?$vector_facade@UPrimitiveSubRect@CDrawListEntryBuilder@@V?$buffer_impl@UPrimitiveSubRect@CDrawListEntryBuilder@@$08$00Vliberal_expansion_policy@detail@@@detail@@@detail@@_N@Z @ 0x180072340
 * Callers:
        ...
        char a5)
{
  ...
  a2 = *(struct PrimitiveGeometryDesc **)&a3[1].b;
  v10 = *(struct CPrimitiveColor **)&a3[1].r;
  v55 = v10;
  if ( !a2 )
  {
LABEL_3:
    if ( !*((_BYTE *)this + 4493) )
      goto LABEL_4;
    BuiltHWPrimitiveEntry = CDrawListEntryBuilder::ExtractBuiltHWPrimitiveEntry(this, (unsigned int)a2, 0LL, 0LL);
...
LABEL_61:
    if ( CShapePtr::IsAxisAlignedRectangle((CShapePtr *)(v17 + 2)) )
      goto LABEL_16;
    goto LABEL_42;
  }
  if ( v17[2] )
...
LABEL_19:
  ...
  if ( !v10 && (*((_DWORD *)this + 6) & 0x800) == 0 )
    return (unsigned int)BuiltHWPrimitiveEntry;
  result = CDrawListEntryBuilder::ExtractBuiltHWPrimitiveEntry(this, (unsigned int)a2, v10, a3);
  v49 = result;
  if ( (int)result < 0 )
  {
