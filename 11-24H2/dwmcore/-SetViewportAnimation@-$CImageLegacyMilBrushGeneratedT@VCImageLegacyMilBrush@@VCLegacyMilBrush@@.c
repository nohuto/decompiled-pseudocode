/*
 * XREFs of ?SetViewportAnimation@?$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@QEAAJPEAVCRectResource@@@Z @ 0x180204648
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[22] )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x7C4u, 0LL);
    }
    else
    {
