/*
 * XREFs of __tailMerge_ext_ms_win_compositor_hosting_l1_2_1_dll @ 0x180251FFE
 * Callers:
 *     __imp_load_NotifyInputSinkRemoved @ 0x18025207D (__imp_load_NotifyInputSinkRemoved.c)
 *     __imp_load_NotifyInputSinkParented @ 0x18025208F (__imp_load_NotifyInputSinkParented.c)
 * Callees:
