/*
 * XREFs of ?Integrate@CScalarForceEvaluator@@AEAA?AUIntegrationState@@AEAU2@PEAUIAccelerator@@MM@Z @ 0x18012B060
 * Callers:
 ...
 * Callees:
 *     ?Accelerate@CSpringAccelerator@@UEAAMPEAUIntegrationState@@M@Z @ 0x18012B3B0 (-Accelerate@CSpringAccelerator@@UEAAMPEAUIntegrationState@@M@Z.c)
