/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJAEBUPixelFormatInfo@@0IE@Z @ 0x1802DCFD0
 * Callers:
 ...
 *     ?ResetPipeline@CScanPipeline@@MEAAXXZ @ 0x1802DCF80 (-ResetPipeline@CScanPipeline@@MEAAXXZ.c)
