        ...
        int a5)
{
  ...
  v7 = (__int64)(*a3 - *a1) >> 4;
  v9 = (__int64 *)detail::vector_facade<CVisualSurface::SourceCVI,detail::buffer_impl<CVisualSurface::SourceCVI,4,1,detail::liberal_expansion_policy>>::reserve_region(
                    a1,
                    v7);
  v10 = *a4;
  *a4 = 0LL;
