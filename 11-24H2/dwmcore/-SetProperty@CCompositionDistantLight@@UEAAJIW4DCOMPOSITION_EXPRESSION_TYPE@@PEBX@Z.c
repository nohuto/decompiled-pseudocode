/*
 * XREFs of ?SetProperty@CCompositionDistantLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180295420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionDistantLight::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  v9[0] = 3LL;
  v9[1] = &CCompositionDistantLight::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v7 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x95u, 0LL);
  }
  else
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x99u, 0LL);
  }
  return v7;
}
