/*
 * XREFs of ?OnUnregisterError@BamoDataProviderRegistrarStubImpl@BamoImpl@@QEAAJI@Z @ 0x180270ABC
 * Callers:
 *     ?CallOnUnregisterErrorOnStub@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@I@Z @ 0x180270734 (-CallOnUnregisterErrorOnStub@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImp.c)
...
LABEL_7:
  ...
  v10[1] = v13;
  return CoreUICallSend(v14, v10, 2LL, 3LL, 1, &unk_180383D65, a2, v9, v12);
}
