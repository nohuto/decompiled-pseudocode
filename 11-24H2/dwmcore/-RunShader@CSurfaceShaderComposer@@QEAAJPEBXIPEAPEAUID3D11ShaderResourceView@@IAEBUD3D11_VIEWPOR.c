/*
 * XREFs of ?RunShader@CSurfaceShaderComposer@@QEAAJPEBXIPEAPEAUID3D11ShaderResourceView@@IAEBUD3D11_VIEWPORT@@W4Enum@BlendMode@@AEBV?$span@USamplerMode@@$0?0@gsl@@_NPEAUID3D11RenderTargetView@@PEAUID3D11PixelShader@@PEBUtagRECT@@5@Z @ 0x180064500
 * Callers:
        ...
        char a13)
{
  ...
  if ( v15 )
  {
    ...
    std::vector<CVectorShape *>::_Change_array(&v49, v20, 0LL, v15);
    v16 = v50;
  }
  v21 = a8[1];
  ...
  while ( v21 != v23 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D3DSamplerStateNoRef, 0xFCu, 0LL);
      goto LABEL_16;
    }
    if ( v22 == v16 )
    {
  ...
  if ( v29 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x120u, 0LL);
  }
  else
  {
    v31 = (_OWORD *)v56;
