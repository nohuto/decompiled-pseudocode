/*
 * XREFs of ?Initialize@CCpuClip@@QEAAXPEBVCShape@@PEBVCMILMatrix@@W4D2D1_ANTIALIAS_MODE@@IPEBVCCpuClipAntialiasSinkContext@@@Z @ 0x1801ADBC0
 * Callers:
        ...
        const struct CCpuClipAntialiasSinkContext *a6)
{
  ...
  void (__fastcall *v11)(CRectanglesShape *, __int64); // rax
  ...
  if ( *((_BYTE *)this + 24) )
  {
    ...
    if ( v10 )
    {
      v11 = **(void (__fastcall ***)(CRectanglesShape *, __int64))v10;
      if ( (char *)v11 == (char *)CRectanglesShape::`scalar deleting destructor' )
      {
        CRectanglesShape::~CRectanglesShape(v10);
        CThreadLocalObjectCache<CRectanglesShape,CRectanglesShape>::Free(v10);
      }
      else if ( (char *)v11 == (char *)CRoundedRectangleShape::`vector deleting destructor' )
      {
      ...
      else if ( (char *)v11 == (char *)CPolygonShape::`scalar deleting destructor' )
      {
