/*
 * XREFs of ?AddVisual@CVisualGroup@@IEAAJPEAVCVisual@@@Z @ 0x18028DA18
 * Callers:
 ...
 *     ??1?$out_param_t@V?$unique_ptr@VCExcludeVisualReference@@U?$default_delete@VCExcludeVisualReference@@@std@@@std@@@details@wil@@QEAA@XZ @ 0x1802130C8 (--1-$out_param_t@V-$unique_ptr@VCExcludeVisualReference@@U-$default_delete@VCExcludeVisualRefere.c)
