/*
 * XREFs of ?UpdateHDRMetaData@COverlayContext@@AEAAPEBXXZ @ 0x1801D3A00
 * Callers:
 ...
 * Callees:
 *     ?GetHDR10MetaData@CGlobalCompositionSurfaceInfo@@UEBA_NPEAUDXGI_HDR_METADATA_HDR10@@@Z @ 0x1801D3BC0 (-GetHDR10MetaData@CGlobalCompositionSurfaceInfo@@UEBA_NPEAUDXGI_HDR_METADATA_HDR10@@@Z.c)
...
const void *__fastcall COverlayContext::UpdateHDRMetaData(COverlayContext *this)
{
  ...
  {
    v6 = *((_QWORD *)this + 1585);
    if ( v5 >= (unsigned __int64)(0x7D6343EB1A1F58D1LL * ((*((_QWORD *)this + 1586) - v6) >> 3)) )
      break;
    v8 = *(CGlobalCompositionSurfaceInfo **)(392LL * v5 + v6 + 16);
