/*
 * XREFs of ?RevalidateMCTree@CManipulationContext@@AEAAXPEAUMCCollections@@@Z @ 0x1801B94F8
 * Callers:
...
void __fastcall CManipulationContext::RevalidateMCTree(CManipulationContext *this, struct MCCollections *a2)
{
  ...
  CCachedVisualImage *v65; // [rsp+68h] [rbp-31h] BYREF
...
LABEL_15:
        ...
        if ( ClosestInteractionAncestor )
        {
          while ( 1 )
          {
            ...
            v36 = *v35;
            v65 = 0LL;
            (*(void (__fastcall **)(__int64 *, unsigned __int64, CCachedVisualImage **))(v36 + 64))(v35, v67, &v65);
            v37 = v65;
            if ( v65 )
            {
...
LABEL_70:
            ...
            *((_BYTE *)v40 + 201) &= ~1u;
            if ( v65 )
              CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease(v65, v43, v44);
            v11 = v63;
            if ( !ClosestInteractionAncestor )
            {
              v22 = v72;
          ...
          v46 = *((_QWORD *)v40 + 29);
          if ( v46 )
            *(_QWORD *)(v46 + 240) = *((_QWORD *)v40 + 30);
          v47 = *((_QWORD *)v40 + 30);
          if ( v47 )
            *(_QWORD *)(v47 + 232) = *((_QWORD *)v40 + 29);
          v48 = *((_QWORD *)v40 + 28);
          if ( v48 && *(struct CInteraction **)(v48 + 248) == v40 )
            *(_QWORD *)(v48 + 248) = *((_QWORD *)v40 + 29);
          *((_QWORD *)v40 + 30) = 0LL;
          v49 = v39;
          v50 = v75;
          *((_QWORD *)v40 + 29) = 0LL;
          *((_QWORD *)v40 + 28) = 0LL;
          CManipulationContext::CleanStaleFork(this, v50, v49);
          if ( !ClosestInteractionAncestor )
            goto LABEL_70;
          *((_QWORD *)v40 + 29) = *((_QWORD *)ClosestInteractionAncestor + 31);
          v51 = *((_QWORD *)ClosestInteractionAncestor + 31);
          if ( v51 )
            *(_QWORD *)(v51 + 240) = v40;
