/*
 * XREFs of ??1CCursorVisual@@MEAA@XZ @ 0x18028FA30
 * Callers:
...
void __fastcall CCursorVisual::~CCursorVisual(CCursorVisual *this)
{
  ...
  v2 = (__int64 *)((char *)this + 704);
  *(_QWORD *)this = &CCursorVisual::`vftable';
  v3 = (CCursorState *)*((_QWORD *)this + 88);
  if ( v3 )
  {
    CCursorState::ClearVisual(v3);
    CGlobalComposition::UnregisterCursorVisual(*((CGlobalComposition **)this + 3), this);
  }
  v4 = (_QWORD *)*((_QWORD *)this + 90);
  if ( v4 )
  {
    std::_Deallocate<16,0>(v4, 8 * ((__int64)(*((_QWORD *)this + 92) - (_QWORD)v4) >> 3));
    *((_QWORD *)this + 90) = 0LL;
    *((_QWORD *)this + 91) = 0LL;
    *((_QWORD *)this + 92) = 0LL;
  }
