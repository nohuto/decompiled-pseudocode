/*
 * XREFs of ??$_Uninitialized_value_construct_n@V?$allocator@VCDDisplayCachedScanout@@@std@@@std@@YAPEAVCDDisplayCachedScanout@@PEAV1@_KAEAV?$allocator@VCDDisplayCachedScanout@@@0@@Z @ 0x1802BE0E4
 * Callers:
...
CDDisplayCachedScanout *__fastcall std::_Uninitialized_value_construct_n<std::allocator<CDDisplayCachedScanout>>(
        ...
        __int64 a2)
{
  for ( ; a2; --a2 )
  {
    ...
    *((_QWORD *)this + 3) = 0LL;
    *((_QWORD *)this + 4) = 1LL;
    this = (CDDisplayCachedScanout *)((char *)this + 40);
  }
  std::_Destroy_range<std::allocator<CDDisplayCachedScanout>>(this, this);
  return this;
}
