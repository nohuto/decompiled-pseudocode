/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAUCpuClipStackState@CScopedClipStack@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAUCpuClipStackState@CScopedClipStack@@@stdext@@_J@Z @ 0x1801B4658
 * Callers:
