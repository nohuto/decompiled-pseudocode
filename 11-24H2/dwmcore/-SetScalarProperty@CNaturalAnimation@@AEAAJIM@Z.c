/*
 * XREFs of ?SetScalarProperty@CNaturalAnimation@@AEAAJIM@Z @ 0x180217908
 * Callers:
...
LABEL_19:
  ...
  v3 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x402u, 0LL);
  return v3;
}
