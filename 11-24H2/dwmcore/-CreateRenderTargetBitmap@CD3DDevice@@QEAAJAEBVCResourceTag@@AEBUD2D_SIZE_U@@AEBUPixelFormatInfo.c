/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@W4Enum@CacheMode@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180059724
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  float v11; // xmm6_4
  int v12; // edi
  struct CScratchRenderTargetBitmap *v13; // rsi
  UINT32 width; // edx
  UINT32 height; // r12d
  char v16; // al
  int v17; // r13d
  ...
  struct CScratchRenderTargetBitmap *v73; // rcx
  int v75; // eax
  struct CScratchRenderTargetBitmap *v76; // rbx
  int v77; // eax
  int v78; // eax
  int v79; // ecx
  int v80; // r9d
  ...
  struct CScratchRenderTargetBitmap *v84; // [rsp+48h] [rbp-B1h] BYREF
...
LABEL_36:
        if ( v13 )
        {
          ...
          {
            if ( v13 == *(struct CScratchRenderTargetBitmap **)(v39 + 8 * i) )
              break;
          }
...
LABEL_68:
        ...
        if ( v12 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v12, 0x417u, 0LL);
LABEL_86:
        v9 = -2003304307;
        goto LABEL_88;
      }
      ...
      {
        IsValid = (char *)v22 == (char *)IDeviceResourceMethodsT<CD2DBitmap,IDeviceTextureTarget>::IsValid
                ? IDeviceResourceMethodsT<CD2DBitmap,IDeviceTextureTarget>::IsValid(v21)
                : v22();
      }
      if ( IsValid < 0 )
        break;
      ...
      if ( BYTE1(v83[0]) )
      {
        ...
        {
          v13 = (struct CScratchRenderTargetBitmap *)v20;
          v10 = (__int64 *)(a1 + 464);
          goto LABEL_36;
        }
      }
...
LABEL_98:
  ...
  v84 = 0LL;
  v75 = CD3DDevice::CreateDeviceTextureTarget((CD3DDevice *)a1, a2, a3, a4, a5, &v84);
  v12 = v75;
  if ( v75 >= 0 )
  {
    v76 = v84;
    ...
    if ( v77 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v77, 0x423u, 0LL);
      wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v84);
    }
    else if ( v76 )
    {
      (*(void (__fastcall **)(struct CScratchRenderTargetBitmap *))(*(_QWORD *)v76 + 16LL))(v76);
    }
    goto LABEL_86;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v75, 0x420u, 0LL);
  if ( v84 )
    (*(void (__fastcall **)(struct CScratchRenderTargetBitmap *))(*(_QWORD *)v84 + 16LL))(v84);
LABEL_88:
  if ( !*(_DWORD *)(a1 + 1112)
...
LABEL_93:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v12, 0LL, &v83[1]) )
  {
    ...
    v12 = v80;
    if ( v80 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v80, 0xB31u, 0LL);
  }
