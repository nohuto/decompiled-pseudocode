/*
 * XREFs of ?ProcessAppend@CGeometryGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GEOMETRYGROUP@@PEBXI@Z @ 0x180294510
 * Callers:
        ...
        unsigned int a5)
{
  ...
  LODWORD(v18) = 0;
  Src = 0LL;
  v7 = CResource::UnmarshalResourceArray(a4, a5, v5, 0x43u, (unsigned int *)&v18, &Src, (__int64)a2, 0);
  v8 = Src;
  v9 = v7;
  if ( v7 < 0 )
  {
