/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x18022CBAC
 * Callers:
 ...
 *     ?Transform@?$CNonScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@IAEBVCMILMatrix@@PEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x180287274 (-Transform@-$CNonScale2DOperator@U-$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTr.c)
 */
        ...
        __int64 a4)
{
  ...
  v8 = *(_DWORD *)(a1 + 20);
  v13[0] = *(const struct _D3DCOLORVALUE *)&_xmm.r;
  if ( a3 && a4 )
  {
    result = (_OWORD *)CalculateTBNFrameFrom3Vertices((__int64)v13, (__int64)v6, (__int64 *)(a1 + 8));
    v13[0] = *result;
  }
  if ( v8 )
  {
