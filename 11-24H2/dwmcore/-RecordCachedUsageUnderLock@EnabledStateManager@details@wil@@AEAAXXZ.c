/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x180220600
 * Callers:
 *     ??1EnabledStateManager@details@wil@@QEAA@XZ @ 0x18022052C (--1EnabledStateManager@details@wil@@QEAA@XZ.c)
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1802205A4 (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 ...
 *     wil_details_RecordCachedUsage @ 0x18025554C (wil_details_RecordCachedUsage.c)
 */
