/*
 * XREFs of ?Create@CAtlasBitmapResource@@SAJPEAVIAtlasEntryOwner@@PEAVCD3DDevice@@PEAPEAV1@@Z @ 0x180063224
 * Callers:
 ...
 *     ??0CAtlasBitmapResource@@IEAA@PEAVIAtlasEntryOwner@@@Z @ 0x180063300 (--0CAtlasBitmapResource@@IEAA@PEAVIAtlasEntryOwner@@@Z.c)
        ...
        struct CAtlasBitmapResource **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v6 && (v7 = CAtlasBitmapResource::CAtlasBitmapResource(v6, a1), (v8 = v7) != 0LL) )
  {
    ...
    if ( GradientStrip < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, GradientStrip, 0x19u, 0LL);
