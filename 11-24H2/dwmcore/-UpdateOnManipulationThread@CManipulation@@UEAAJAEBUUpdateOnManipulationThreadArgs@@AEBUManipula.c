/*
 * XREFs of ?UpdateOnManipulationThread@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadArgs@@AEBUManipulationThreadTelemetryData@@PEAVIDCompositionInteractionStats@@@Z @ 0x1800EA4D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::StoreIfChanged_D2DVector3_ @ 0x1800EA868 (_anonymous_namespace_--StoreIfChanged_D2DVector3_.c)
 *     ?_UpdateCaptureState@CManipulation@@AEAAX_N@Z @ 0x1800EA8A0 (-_UpdateCaptureState@CManipulation@@AEAAX_N@Z.c)
 *     _anonymous_namespace_::StoreIfChanged_float_ @ 0x1800EA8BC (_anonymous_namespace_--StoreIfChanged_float_.c)
