/*
 * XREFs of ?push_back@?$vector_facade@UD2D_POINT_2F@@V?$buffer_impl@UD2D_POINT_2F@@$0CI@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXAEBUD2D_POINT_2F@@@Z @ 0x1800416AC
 * Callers:
 ...
 *     ?AddLine@CPolygonBuilder@@EEAAXUD2D_POINT_2F@@@Z @ 0x1802593F0 (-AddLine@CPolygonBuilder@@EEAAXUD2D_POINT_2F@@@Z.c)
 * Callees:
