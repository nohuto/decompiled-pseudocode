/*
 * XREFs of ?ProcessSetEffect@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETEFFECT@@@Z @ 0x1800391DC
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETEFFECT *a3)
{
  ...
  if ( !v3
    ...
    && ((v13 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v12 + 64LL), v13 == CKeyframeAnimation::IsOfType)
      ? (v8 = CKeyframeAnimation::IsOfType(v12, 56))
      : v13 != CVisual::IsOfType
      ? (v13 != CSharedSection::IsOfType
       ? (v8 = v13(v12, 56))
       : (v8 = CSharedSection::IsOfType(v12, 56)))
      : (v8 = CVisual::IsOfType(v12, 56)),
        v8 && (v4 = *(struct CEffect **)(v11 + 8)) != 0LL) )
  {
    v9 = CVisual::SetEffect(this, v4);
    v7 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0xA13u, 0LL);
  }
  else
  {
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0xA0Fu, 0LL);
  }
  return v7;
}
