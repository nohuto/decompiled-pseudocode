/*
 * XREFs of ?Initialize@CSubDrawingContext@@AEAAJXZ @ 0x1800F6434
 * Callers:
 ...
 *     ?HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x1800F6540 (-HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
