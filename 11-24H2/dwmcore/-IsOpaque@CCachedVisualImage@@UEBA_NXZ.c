/*
 * XREFs of ?IsOpaque@CCachedVisualImage@@UEBA_NXZ @ 0x1801CC1C0
 * Callers:
 *     <none>
 * Callees:
 *     ?ColorSpaceToDXGIColorSpace@@YA?AW4DXGI_COLOR_SPACE_TYPE@@W4ColorSpace@@@Z @ 0x1801CC248 (-ColorSpaceToDXGIColorSpace@@YA-AW4DXGI_COLOR_SPACE_TYPE@@W4ColorSpace@@@Z.c)
