/*
 * XREFs of ?GetD2DEffectNoRef@CFilterEffect@@QEAAJPEAVCDrawingContext@@PEAUID2D1Bitmap1@@PEAPEAUID2D1Effect@@@Z @ 0x18021925C
 * Callers:
...
LABEL_3:
  ...
  D2DEffectNoRef = (*(__int64 (__fastcall **)(CFilterEffect *, ID2D1Effect *))(*(_QWORD *)this + 208LL))(this, v9);
  v10 = D2DEffectNoRef;
  if ( D2DEffectNoRef < 0 )
  {
    v23 = 33;
...
LABEL_28:
  ...
  if ( (_DWORD)v14 )
  {
    ...
    for ( i = 0LL; i < v14; ++i )
    {
      v16 = *(_QWORD *)(*((_QWORD *)this + 18) + 8 * i);
      v17 = *(_QWORD *)(v16 + 24);
      v18 = *(_DWORD *)(*((_QWORD *)this + 17) + 4 * i);
      if ( v17 )
      {
        v19 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v17 + 64LL))(v17, 61LL);
        ...
        {
          if ( !(*(unsigned __int8 (__fastcall **)(CFilterEffect *, __int64))(*(_QWORD *)v20 + 64LL))(v20, 42LL) )
          {
            v10 = -2147467263;
            v23 = 82;
            goto LABEL_3;
          ...
          ReleaseInterface<IDXGIFactory7>((__int64 *)&v27);
        }
      }
      else
      {
