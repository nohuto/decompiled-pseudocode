/*
 * XREFs of ?ReadyWakeupFence@CComputeScribbleScheduler@@AEAAJ_K@Z @ 0x1801C634C
 * Callers:
...
__int64 __fastcall CComputeScribbleScheduler::ReadyWakeupFence(CComputeScribbleScheduler *this, __int64 a2)
{
  ...
  if ( *((_QWORD *)this + 15) )
  {
    wil::com_ptr_t<IBitmapRealization,wil::err_returncode_policy>::operator=((__int64 *)this + 14, (__int64 *)this + 15);
