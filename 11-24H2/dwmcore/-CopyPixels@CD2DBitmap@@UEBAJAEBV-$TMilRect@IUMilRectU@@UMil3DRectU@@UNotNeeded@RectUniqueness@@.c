/*
 * XREFs of ?CopyPixels@CD2DBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x180022DF0
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  {
    v16 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xC3u, 0LL);
  }
  else
  {
    ...
    {
      v16 = -2147024891;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024891, 0xC9u, v13);
      return v16;
    }
    ...
    if ( CD2DBitmap::TryFastWarpLock((CD2DBitmap *)(a1 - 88), v32, (unsigned int *)&v29, v30, &v31) )
    {
      ...
      v16 = v28;
      if ( v28 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0xE7u, 0LL);
      goto LABEL_14;
    }
    v29 = 0LL;
...
LABEL_13:
    ...
    else
    {
      ...
      *(_QWORD *)v30 = 0LL;
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0xF6u, 0LL);
      }
      else
      {
        v19 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 88) + 40LL))(a1 - 88);
        v20 = *(_QWORD *)v30;
        v21 = (*(__int64 (__fastcall **)(__int64, unsigned __int8 **))(*(_QWORD *)(a1 - 8) + 24LL))(a1 - 8, &v33);
        v22 = CD3DDevice::CopyTexture2D(v19, *(_QWORD *)(a1 + 16), *(unsigned int *)(a1 + 144), v21, a2, v20, 0, 0);
        v16 = v22;
        if ( v22 >= 0 )
        {
          if ( *(_QWORD *)v30 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0xFDu, 0LL);
      }
