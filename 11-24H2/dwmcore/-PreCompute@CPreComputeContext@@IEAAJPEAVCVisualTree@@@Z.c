/*
 * XREFs of ?PreCompute@CPreComputeContext@@IEAAJPEAVCVisualTree@@@Z @ 0x18003EBA0
 * Callers:
 ...
 *     ?clear_region@?$vector_facade@VSubTreeContext@CPreComputeContext@@V?$buffer_impl@VSubTreeContext@CPreComputeContext@@$02$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x180175380 (-clear_region@-$vector_facade@VSubTreeContext@CPreComputeContext@@V-$buffer_impl@VSubTreeContext.c)
 ...
 *     ??0CVisualTreePath@@QEAA@PEBVCVisualTree@@@Z @ 0x1801CBAC0 (--0CVisualTreePath@@QEAA@PEBVCVisualTree@@@Z.c)
...
__int64 __fastcall CPreComputeContext::PreCompute(CPreComputeContext *this, struct CVisualTree *a2)
{
  ...
  __int64 v67; // r15
  int v68; // eax
  DwmDbg::DbgString *v69; // rdi
  CVisualTreePath *v70; // rbx
  DwmDbg::DbgString *v71; // rax
  void *v72; // [rsp+38h] [rbp-49h] BYREF
  char *v73; // [rsp+40h] [rbp-41h] BYREF
  int v74; // [rsp+48h] [rbp-39h]
  int v75; // [rsp+4Ch] [rbp-35h]
  _BYTE v76[16]; // [rsp+50h] [rbp-31h] BYREF
  char **v77; // [rsp+60h] [rbp-21h]
  __int64 v78; // [rsp+68h] [rbp-19h]
  void **v79; // [rsp+70h] [rbp-11h]
  __int64 v80; // [rsp+78h] [rbp-9h]
  wil::details::in1diag3 *retaddr; // [rsp+E0h] [rbp+5Fh]

  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 4) != 0 )
  {
    LODWORD(v72) = (*(unsigned __int8 (__fastcall **)(struct CVisualTree *))(*(_QWORD *)a2 + 184LL))(a2);
    v73 = (char *)a2;
    v77 = &v73;
    v78 = 8LL;
    v79 = &v72;
    ...
    || (v56 = CWatermarkStack<enum MilDepthMode::Enum,64,2,10>::Grow((char *)this + 1080), v17 = v56, v56 >= 0) )
  {
    ...
    *((_BYTE *)this + 1568) = 0;
    if ( dword_1803F8D50 )
    {
      ...
      {
        v69 = DwmDbg::DbgString::DbgString(&v73, word_18032AF78);
        v70 = CVisualTreePath::CVisualTreePath((CVisualTreePath *)v76, a2);
        v71 = DwmDbg::DbgString::DbgString((char **)&v72, "PreCompute-StartWalk");
        DwmDbg::Backdrops::LogTreeWalkEtwEvent(v71, v67, a2, v70, v69);
        detail::vector_facade<CVisualTreePath::VisualTreePathUnit,detail::buffer_impl<CVisualTreePath::VisualTreePathUnit,2,1,detail::liberal_expansion_policy>>::~vector_facade<CVisualTreePath::VisualTreePathUnit,detail::buffer_impl<CVisualTreePath::VisualTreePathUnit,2,1,detail::liberal_expansion_policy>>((__int64)v76);
      }
    }
    v15 = *((_QWORD *)a2 + 9);
    *((_QWORD *)this + 194) = a2;
...
LABEL_50:
              ...
              v72 = 0LL;
              v68 = HrMalloc(4uLL, (unsigned int)v49, &v72);
              if ( v68 >= 0 )
              {
  ...
  *((_BYTE *)this + 1568) = 0;
         ...
         v22) )
  {
    ...
    if ( *((_DWORD *)this + 364) )
    {
      ...
      v74 = *(_DWORD *)(v38 + 8);
      v75 = 0;
      UpdateWindowInputSinkHints(&v73);
    }
