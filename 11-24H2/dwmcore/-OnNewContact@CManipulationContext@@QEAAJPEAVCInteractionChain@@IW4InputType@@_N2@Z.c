/*
 * XREFs of ?OnNewContact@CManipulationContext@@QEAAJPEAVCInteractionChain@@IW4InputType@@_N2@Z @ 0x18019415C
 * Callers:
        ...
        char a6)
{
  ...
  if ( v14 )
  {
    ...
    if ( !*(_QWORD *)(a1 + 48) )
      Microsoft::WRL::ComPtr<CVisual>::operator=((__int64 *)(a1 + 48), *(_QWORD *)a2);
