/*
 * XREFs of ?CalcTransform@CVisual@@QEBAXPEBVCVisualTree@@PEBVCMILMatrix@@PEA_NPEAV3@3@Z @ 0x180034E40
 * Callers:
 ...
 * Callees:
 *     ?RoundOffsets@CMILMatrix@@QEAAXXZ @ 0x1800360F4 (-RoundOffsets@CMILMatrix@@QEAAXXZ.c)
 ...
 *     ?GetInteraction@CVisual@@QEBAPEAVCInteraction@@XZ @ 0x1801BCF30 (-GetInteraction@CVisual@@QEBAPEAVCInteraction@@XZ.c)
        ...
        struct CMILMatrix *a6)
{
  ...
  if ( (*v8 & 0x800000) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)CEffectGeneratedT<CEffect,CPropertyChangeResource>::IsOfType(v39, 175LL) )
      {
LABEL_61:
        v12 = v128;
        goto LABEL_2;
    ...
    else if ( ((unsigned __int8 (__fastcall *)(CTransform3D *, __int64))v40)(v39, 175LL) )
    {
      goto LABEL_61;
    }
    v106 = v128;
    ...
    {
      if ( !((unsigned __int8 (__fastcall *)(CTransform3D *, __int64))v107)(v128, 58LL) )
        goto LABEL_2;
      v106 = v128;
    }
      ...
      if ( v15 )
      {
        ...
        if ( v9 )
        {
          ...
          if ( v43 )
          {
            ...
            if ( (char *)v45 == (char *)CComponentTransform3D::GetRealization )
            {
        ...
        else
        {
          ...
          if ( v71 )
          {
            ...
            if ( (char *)v73 == (char *)CComponentTransform3D::GetRealization )
            {
...
LABEL_9:
  ...
  if ( v16 && *(_DWORD *)(v16 + 112) == 1 )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*v70 + 64LL))(*v70, 61LL) )
      v59 = 1;
    else
LABEL_83:
      v59 = 0;
...
LABEL_89:
    ...
    *v13 = 1;
    if ( v12 )
    {
      Matrix = CTransform3D::GetMatrix(v12, (const struct D2D_SIZE_F *)this + 18);
...
LABEL_15:
  if ( (*((_BYTE *)this + 107) & 8) != 0 )
  {
    ...
    if ( a3 && v74 > 4 && (byte_1803F8D28 & 2) != 0 && (v75 & 2) == v75 )
    {
      v91 = *((_DWORD *)a3 + 14);
