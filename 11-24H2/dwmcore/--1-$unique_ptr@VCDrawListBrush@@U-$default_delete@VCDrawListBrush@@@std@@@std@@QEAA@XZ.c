/*
 * XREFs of ??1?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@QEAA@XZ @ 0x18016BE30
 * Callers:
...
void __fastcall std::unique_ptr<CDrawListBrush>::~unique_ptr<CDrawListBrush>(
        CMultiPrimitiveDrawListBrush **a1,
        __int64 a2,
        __int64 a3)
{
  CMultiPrimitiveDrawListBrush *v3; // rcx
  void (__fastcall *v4)(CMultiPrimitiveDrawListBrush *, __int64); // rax

  v3 = *a1;
  if ( v3 )
  {
    v4 = **(void (__fastcall ***)(CMultiPrimitiveDrawListBrush *, __int64))v3;
    if ( (char *)v4 == (char *)CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
    {
      CMultiPrimitiveDrawListBrush::`vector deleting destructor'(v3, 1, a3);
    }
    else if ( (char *)v4 == (char *)CSurfaceDrawListBrush::`vector deleting destructor' )
    {
      CSurfaceDrawListBrush::`vector deleting destructor'(v3, 1, a3);
    }
    else if ( (char *)v4 == (char *)CDrawListPrimitive0::`scalar deleting destructor' )
    {
      CDrawListPrimitive0::`scalar deleting destructor'(v3, 1);
    }
    else
    {
      v4(v3, 1LL);
