/*
 * XREFs of ?NotifyMatrix3x2PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801829C4
 * Callers:
      ...
      if ( *((_DWORD *)this + 18) )
      {
        ...
        if ( _bittest(&v9, a2) )
        {
                 ...
                 11LL) )
          {
            ...
            v16 = v11;
            v17 = v12;
            v14 = CoreUICallSend(v13, v15, 2LL, 11LL, 7, &unk_18032BF90, a2, &v16, ChannelCallbackId);
            if ( v14 != -2018375675 )
              v4 = v14;
            if ( v4 < 0 )
