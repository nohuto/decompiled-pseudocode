/*
 * XREFs of ?SetStateOnDevice@CCommonRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x18010A6B0
 * Callers:
 ...
 *     ?GetShaderResourceView@CD2DBitmap@@UEAAPEAUID3D11ShaderResourceView@@XZ @ 0x18010E600 (-GetShaderResourceView@CD2DBitmap@@UEAAPEAUID3D11ShaderResourceView@@XZ.c)
        ...
        unsigned int *a3)
{
  ...
  enum DXGI_FORMAT v105[4]; // [rsp+F8h] [rbp-8h]
  ...
  *(_QWORD *)v105 = *(_QWORD *)v26;
  ...
  if ( v89[154] >= v72 )
  {
    ...
    if ( (unsigned __int8)v92 == 2 || (_BYTE)v92 )
      ...
      v73 = 0;
    v114[0] = v73;
    v74 = ExtendMode::ToD3D11TextureAddressMode(SHIBYTE(v92));
    v76 = *(_BYTE *)(v14 + v75 + 66);
    v114[1] = v74;
