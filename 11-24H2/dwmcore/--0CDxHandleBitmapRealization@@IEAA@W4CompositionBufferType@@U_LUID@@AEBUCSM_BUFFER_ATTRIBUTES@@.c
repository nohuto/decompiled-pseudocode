/*
 * XREFs of ??0CDxHandleBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@_N4PEAVCDecodeBitmap@@@Z @ 0x1801A69DC
 * Callers:
 ...
 * Callees:
 *     ??0ISwapChainRealization@@QEAA@XZ @ 0x1801A6AE0 (--0ISwapChainRealization@@QEAA@XZ.c)
        ...
        __int64 a8)
{
  ...
  CBitmapRealization::CBitmapRealization(a1, a2, a3, a4, a5, a8);
  ...
  *v10 = &CGDIBitmapRealization::`vftable'{for `IDeviceResource'};
