/*
 * XREFs of ?GetSubtreeZ@CVisual@@QEBAHPEBVCVisualTree@@I@Z @ 0x18009FA70
 * Callers:
...
__int64 __fastcall CVisual::GetSubtreeZ(CVisual *this, const struct CVisualTree *a2, int a3)
{
  ...
  _QWORD **v50; // rcx
  void (__fastcall *v51)(_QWORD **, __int64, __int64, __int64); // rax
    ...
    if ( (unsigned __int64)((v6[23] - v8) >> 3) > 1 )
    {
      while ( v8 != v6[23] )
      {
        ...
        else
        {
          ...
          v42 = (__int64 *)(v29 + 8 * v31);
          if ( v30 + 1 != v31 )
          {
            if ( v30 && (!v29 || v30 < 0 || v31 < v30) )
              goto LABEL_86;
            v43 = (__int64 *)(v29 + 8 * (v30 + 1));
            v44 = v42 - v43;
            v45 = v44 <= 0;
            if ( v44 < 0 )
            {
...
LABEL_91:
              ...
              *(__int64 *)((char *)v43 + v46) = v47;
              ...
              {
                CSurfaceDrawListBrush::`vector deleting destructor'(v48, 1, v29);
                v7 = 0LL;
                ++v43;
              }
              else
              {
                ...
                CMultiPrimitiveDrawListBrush::`vector deleting destructor'(v48, 1, v29);
                v7 = 0LL;
                ++v43;
              }
            }
...
LABEL_102:
          ...
          do
          {
            ...
            if ( *v3 )
            {
              v51 = (void (__fastcall *)(_QWORD **, __int64, __int64, __int64))**v50;
              if ( (char *)v51 == (char *)CWindowOcclusionInfo::`vector deleting destructor' )
              {
                operator delete(v50, 0x38uLL);
              }
              else if ( (char *)v51 == (char *)CSurfaceDrawListBrush::`vector deleting destructor' )
              {
                CSurfaceDrawListBrush::`vector deleting destructor'((CSurfaceDrawListBrush *)v50, 1, v29);
              }
              else if ( (char *)v51 == (char *)CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
              {
                CMultiPrimitiveDrawListBrush::`vector deleting destructor'((CMultiPrimitiveDrawListBrush *)v50, 1, v29);
              }
              else
              {
                v51(v50, 1LL, v29, v7);
