/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18025B49C
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18025C4A4 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@QEAAX_NW4Reporti.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18025BCFC (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil.c)
 */
