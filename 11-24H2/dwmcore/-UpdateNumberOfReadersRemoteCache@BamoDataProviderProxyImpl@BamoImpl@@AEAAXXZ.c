/*
 * XREFs of ?UpdateNumberOfReadersRemoteCache@BamoDataProviderProxyImpl@BamoImpl@@AEAAXXZ @ 0x180273A24
 * Callers:
 *     ?SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z @ 0x1802739D0 (-SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z.c)
 *     ?PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ @ 0x18027D2D0 (-PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ.c)
 * Callees:
        ...
        BamoImpl::BamoDataProviderProxyImpl *this)
{
  ...
  if ( !Microsoft::BamoImpl::BamoProxyImpl::IsDisconnected(this) )
  {
    ...
    v13[1] = v7;
    v10 = CoreUICallSend(v9, v13, 2LL, 0LL, 6, &unk_180383D65, v6, v12, v8);
