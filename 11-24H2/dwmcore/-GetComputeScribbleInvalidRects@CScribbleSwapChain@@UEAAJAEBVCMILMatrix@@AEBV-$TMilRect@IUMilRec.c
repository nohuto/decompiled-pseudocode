/*
 * XREFs of ?GetComputeScribbleInvalidRects@CScribbleSwapChain@@UEAAJAEBVCMILMatrix@@AEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVCMergedRect@@@Z @ 0x1801C52D0
 * Callers:
...
__int64 __fastcall CScribbleSwapChain::GetComputeScribbleInvalidRects(__int64 a1, __int64 a2, int *a3, __int64 a4)
{
  ...
  *(_QWORD *)&v45 = a2;
  ...
  v9 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 200LL))(v8);
  v10 = *(_QWORD *)v8;
  *(_QWORD *)&v36.left = v9;
  (*(void (__fastcall **)(__int64))(v10 + 184))(v8);
  v11 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 200LL))(v4);
  v12 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v11 + 200LL))(v11);
...
LABEL_2:
  ...
  if ( v12 )
  {
    ...
    if ( *(_BYTE *)(v12 + 168) )
    {
      ...
      if ( *(_BYTE *)(v12 + 168) )
      {
        HasActiveInk = 1;
        if ( *v43 )
          (*(void (__fastcall **)(__int64, int **))(*(_QWORD *)v11 + 176LL))(v11, &v43);
      }
    }
    FastRegion::CRegion::FreeMemory((FastRegion::CRegion **)&v43);
    if ( v12 != -80 )
  ...
  if ( **(_DWORD **)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v11 + 168LL))(v11) )
  {
    v44[0] = 0;
    v43 = v44;
    v26 = (FastRegion::CRegion **)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v11 + 168LL))(v11);
