/*
 * XREFs of ?RetrieveCurrentLightBufferForContextNoRef@CLightStack@@QEAAJPEAVCDrawingContext@@PEBVCMILMatrix@@PEAPEAVCHwLightCollectionBuffer@@@Z @ 0x18014AFB0
 * Callers:
 ...
 *     ?IsBlackLight@CCompositionAmbientLight@@UEBA_NXZ @ 0x18014B710 (-IsBlackLight@CCompositionAmbientLight@@UEBA_NXZ.c)
...
LABEL_58:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v24, 0x11Au, 0LL);
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v24, 0x8Bu, 0LL);
        DynArrayImpl<0>::~DynArrayImpl<0>((__int64)Buf2);
        return (unsigned int)v24;
      }
      if ( v10 > (unsigned int)v32 )
      {
        v24 = DynArrayImpl<0>::AddMultipleAndSet((__int64)Buf2, 8, 1, &v27);
        if ( v24 < 0 )
        {
          v25 = 192;
          goto LABEL_58;
  ...
  else
  {
    ...
    *(_QWORD *)v36 = 3LL;
    while ( (unsigned int)v22 < v10 )
    {
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0xA0u, 0LL);
LABEL_54:
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0xA2u, 0LL);
        goto LABEL_54;
      }
      v10 = HIDWORD(v32);
    ...
    if ( (int)v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0xAAu, 0LL);
    }
    else
    {
      ...
      *((_DWORD *)this + 56) = *((_DWORD *)a3 + 16);
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0xADu, 0LL);
    }
    DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v34);
  }
  DynArrayImpl<0>::~DynArrayImpl<0>((__int64)Buf2);
