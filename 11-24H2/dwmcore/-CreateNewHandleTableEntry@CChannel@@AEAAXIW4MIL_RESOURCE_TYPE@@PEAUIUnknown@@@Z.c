/*
 * XREFs of ?CreateNewHandleTableEntry@CChannel@@AEAAXIW4MIL_RESOURCE_TYPE@@PEAUIUnknown@@@Z @ 0x1801CFB60
 * Callers:
...
__int64 __fastcall CChannel::CreateNewHandleTableEntry(_QWORD *a1, unsigned int a2, int a3, const char *a4)
{
  ...
  if ( v11 > v12 )
  {
    if ( v11 > (v6[2] - v7) >> 4 )
    {
      std::vector<CChannel::HandleTableEntry>::_Resize_reallocate<std::_Value_init_tag>(v6, v11);
    }
    else
    {
      for ( i = v11 - v12; i; --i )
