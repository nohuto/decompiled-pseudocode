/*
 * XREFs of ?SetTransform3D@?$CEffectGroupGeneratedT@VCEffectGroup@@VCEffect@@@@QEAAJPEAVCTransform3D@@@Z @ 0x1802014A4
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[11] )
  {
    ...
    else
    {
      ...
      this[11] = a2;
      CResource::NotifyOnChanged(this, 2LL, (__int64)a2);
    }
  }
  return v2;
}
