/*
 * XREFs of ?AddVisualTree@CComposition@@QEAAXPEAVCVisualTree@@@Z @ 0x18008D6A0
 * Callers:
 *     ?Initialize@CVisualTree@@MEAAJXZ @ 0x18008D660 (-Initialize@CVisualTree@@MEAAJXZ.c)
 * Callees:
 *     ?reserve_region@?$vector_facade@PEAVCVisualTree@@V?$buffer_impl@PEAVCVisualTree@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAPEAVCVisualTree@@_K0@Z @ 0x18008CEE8 (-reserve_region@-$vector_facade@PEAVCVisualTree@@V-$buffer_impl@PEAVCVisualTree@@$0BA@$00Vlibera.c)
...
void __fastcall CComposition::AddVisualTree(CComposition *this, struct CVisualTree *a2)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CVisualTree *))(*(_QWORD *)a2 + 184LL))(a2) )
    ...
    v6 = (__int64)(*((_QWORD *)this + 51) - *((_QWORD *)this + 50)) >> 3;
