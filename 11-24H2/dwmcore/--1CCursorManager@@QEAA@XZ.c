/*
 * XREFs of ??1CCursorManager@@QEAA@XZ @ 0x18024D738
 * Callers:
 *     _dynamic_atexit_destructor_for__g_CursorManager__ @ 0x1802DFC60 (_dynamic_atexit_destructor_for__g_CursorManager__.c)
 * Callees:
