/*
 * XREFs of ?InternalRelease@?$ComPtr@VCDrawListCache@@@WRL@Microsoft@@IEAAKXZ @ 0x180110800
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<CDrawListCache>::InternalRelease(volatile signed __int32 **a1)
{
  ...
  int v2; // edi
  void *(__fastcall *v3)(CDrawListEntry *__hidden, unsigned int); // rax
      ...
      if ( !v2 )
      {
        if ( _InterlockedDecrement(v1 + 2) < -1 )
          wil::details::in1diag3::Log_Hr(
            ...
            (const char *)0x8007029CLL,
            v5);
        v3 = *(void *(__fastcall **)(CDrawListEntry *__hidden, unsigned int))(*(_QWORD *)v1 + 16LL);
