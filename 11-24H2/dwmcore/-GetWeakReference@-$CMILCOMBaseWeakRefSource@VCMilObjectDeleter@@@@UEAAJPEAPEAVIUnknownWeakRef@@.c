/*
 * XREFs of ?GetWeakReference@?$CMILCOMBaseWeakRefSource@VCMilObjectDeleter@@@@UEAAJPEAPEAVIUnknownWeakRef@@@Z @ 0x1801F0370
 * Callers:
 *     <none>
 * Callees:
 *     MIDL_user_allocate @ 0x18001C2F0 (MIDL_user_allocate.c)
 *     ??0CMILCOMWeakRef@@QEAA@PEAUIUnknown@@@Z @ 0x1801F0410 (--0CMILCOMWeakRef@@QEAA@PEAUIUnknown@@@Z.c)
