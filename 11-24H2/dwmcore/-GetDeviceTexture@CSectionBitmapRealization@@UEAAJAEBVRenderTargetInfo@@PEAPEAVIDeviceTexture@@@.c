/*
 * XREFs of ?GetDeviceTexture@CSectionBitmapRealization@@UEAAJAEBVRenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x1801974E0
 * Callers:
 *     ?GetDeviceTexture@?$IBitmapRealizationMethodsT@VCSectionBitmapRealization@@VIGDIBitmapRealization@@@@WBDI@EAAJAEBVRenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x1802D6C20 (-GetDeviceTexture@-$IBitmapRealizationMethodsT@VCSectionBitmapRealization@@VIGDIBitmapRealizatio.c)
 * Callees:
        ...
        struct IDeviceTexture **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032BB90, 2u, v9, 0x32u, 0LL);
  }
  else if ( *((_QWORD *)this + 33) )
  {
    *a3 = 0LL;
    ...
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032BB90, 2u, v11, 0x36u, 0LL);
  }
  else
  {
