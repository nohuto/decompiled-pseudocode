/*
 * XREFs of ?GetDirtyRegionFromAccum@CRedirectedGDISurface@@QEAAJAEAVCRegion@@@Z @ 0x1800281B4
 * Callers:
...
__int64 __fastcall CRedirectedGDISurface::GetDirtyRegionFromAccum(CRedirectedGDISurface *this, struct CRegion *a2)
{
  ...
  if ( !(unsigned int)DwmHLSurfGetDirtyRgn(*((_QWORD *)this + 3), 0LL, 0LL, &ho, 0LL, 0LL, 0LL, 0LL, 0LL) )
  {
    ...
    if ( v3 >= 0 )
      v3 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1803C6568, 4u, v3, 0xD6u, 0LL);
  }
  if ( ho )
  {
