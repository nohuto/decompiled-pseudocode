/*
 * XREFs of ?DirectFlipEarlyWakeupReady@COverlayContext@@QEBA_NXZ @ 0x1800996D8
 * Callers:
...
bool __fastcall COverlayContext::DirectFlipEarlyWakeupReady(COverlayContext *this)
{
  ...
  return CDirectFlipInfo::UseSyncIntervalAndAllowTearing(*((CDirectFlipInfo **)this + 2439), v4);
}
