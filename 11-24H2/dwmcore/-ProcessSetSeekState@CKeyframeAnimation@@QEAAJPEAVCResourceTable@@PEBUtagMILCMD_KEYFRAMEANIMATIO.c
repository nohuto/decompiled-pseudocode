/*
 * XREFs of ?ProcessSetSeekState@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETSEEKSTATE@@@Z @ 0x1800F1E64
 * Callers:
        ...
        const struct tagMILCMD_KEYFRAMEANIMATION_SETSEEKSTATE *a3)
{
  ...
  else if ( (unsigned int)dword_1803F8D18 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803F8D18, 4LL) )
  {
    v10 = (__int64)this[7];
    if ( v10 )
    {
