/*
 * XREFs of ?FillRectangleWithSolidColor@CD2DContext@@UEAAJPEBVID2DContextOwner@@AEBUD2D_RECT_F@@AEBU_D3DCOLORVALUE@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x1802BBCC0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_PRIMITIVE_BLEND a6)
{
  ...
  *(_OWORD *)&v21.m[1][0] = 0LL;
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
  {
    ...
    McTemplateU0qq_EventWriteTransfer((__int64)&Microsoft_Windows_Dwm_Core_Provider_Context, (__int64)"1", 2, v13);
  }
