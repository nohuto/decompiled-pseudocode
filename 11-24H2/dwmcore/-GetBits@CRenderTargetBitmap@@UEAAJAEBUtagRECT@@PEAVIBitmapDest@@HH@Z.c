/*
 * XREFs of ?GetBits@CRenderTargetBitmap@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x180201020
 * Callers:
 *     <none>
 * Callees:
        ...
        INT a5)
{
  ...
  int v26[4]; // [rsp+50h] [rbp-11h] BYREF
  ...
  if ( v14 >= 0 )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(CRenderTargetBitmap *))(*(_QWORD *)this + 56LL))(this) )
    {
      ...
      else
      {
        ...
        v20 = (struct ID3D11Texture2D *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v24 + 120LL))(v24);
        v14 = CD3DDevice::CopyTexture2D(v18, v20, 0, v19, v26, a3, a4, a5);
        v15 = v14;
        if ( v14 >= 0 )
          goto LABEL_9;
        v23 = 342;
