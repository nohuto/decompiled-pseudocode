/*
 * XREFs of ??0DDisplayTargetResources@@QEAA@XZ @ 0x18023FE94
 * Callers:
...
DDisplayTargetResources *__fastcall DDisplayTargetResources::DDisplayTargetResources(DDisplayTargetResources *this)
{
  *(_QWORD *)this = 0LL;
  *((_QWORD *)this + 1) = 0LL;
  *((_QWORD *)this + 2) = 0LL;
