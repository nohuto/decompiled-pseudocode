/*
 * XREFs of ?TrimToStartAt@CTrimPathOperation@@AEAAXAEBUSegment@Path@@M@Z @ 0x18017CD1C
 * Callers:
...
void __fastcall CTrimPathOperation::TrimToStartAt(CTrimPathOperation *this, const struct Path::Segment *a2, float a3)
{
  int v4; // edx
  float *v6; // r14
  bool v7; // al
