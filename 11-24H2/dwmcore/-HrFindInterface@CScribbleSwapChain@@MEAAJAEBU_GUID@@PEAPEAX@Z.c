/*
 * XREFs of ?HrFindInterface@CScribbleSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A0390
 * Callers:
 *     ?HrFindInterface@CConversionSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180223E40 (-HrFindInterface@CConversionSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
