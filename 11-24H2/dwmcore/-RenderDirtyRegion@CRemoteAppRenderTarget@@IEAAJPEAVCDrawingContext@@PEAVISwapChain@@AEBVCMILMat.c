/*
 * XREFs of ?RenderDirtyRegion@CRemoteAppRenderTarget@@IEAAJPEAVCDrawingContext@@PEAVISwapChain@@AEBVCMILMatrix@@PEAW4ProtectionMode@1@@Z @ 0x180281850
 * Callers:
  ...
  if ( *((_DWORD *)this + 74) )
  {
    ...
    else
    {
      ...
      while ( v14 != (const struct D2D_RECT_F *)v15 )
      {
        ...
        v26 = 0;
        v24 = v16;
        v18 = CDrawingContext::DrawVisualTree(a2, v17, &v24.left, v13, 2, 0, 0LL);
        v10 = v18;
        if ( v18 < 0 )
        {
