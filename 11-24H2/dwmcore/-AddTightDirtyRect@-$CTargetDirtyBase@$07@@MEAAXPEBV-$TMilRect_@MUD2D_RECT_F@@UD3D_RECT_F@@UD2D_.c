/*
 * XREFs of ?AddTightDirtyRect@?$CTargetDirtyBase@$07@@MEAAXPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180172990
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CTargetDirtyBase<8>::AddTightDirtyRect(__int64 a1, const struct D2D_RECT_F *a2)
{
  ...
  int v15[4]; // [rsp+38h] [rbp-38h] BYREF
  ...
  if ( a2 )
  {
    ...
    *(_QWORD *)&v8 = DWORD1(v14);
    ...
    {
      v11 = (const struct tagRECT *)PixelAlign(v15, (unsigned int *)&v14, v8);
      CRegion::AddRectangle(*(const struct FastRegion::Internal::CRgnData ***)(a1 + 464), v11);
    }
  }
  else
  {
