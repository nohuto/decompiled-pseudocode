/*
 * XREFs of ?ProcessSetDirtyRect@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PRIMITIVEGROUP_SETDIRTYRECT@@PEBXI@Z @ 0x180175DD8
 * Callers:
        ...
        unsigned int a5)
{
  unsigned int v6; // r8d
  char v7; // di
  __int64 (__fastcall *v8)(CPrimitiveGroup *, __int64, __int64); // rax
  ...
  if ( v6 && a5 == 16LL * v6 )
  {
    ...
    *((_QWORD *)this + 69) = v10;
    v8 = *(__int64 (__fastcall **)(CPrimitiveGroup *, __int64, __int64))(*(_QWORD *)this + 80LL);
    if ( (char *)v8 == (char *)CResource::NotifyOnChanged )
      CResource::NotifyOnChanged(this, 1LL, (__int64)this);
    else
      v8(this, 1LL, (__int64)this);
    v7 = 0;
  }
  else
  {
