/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180282674
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180282AE8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil@@QEAAX_NW4Report.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180282878 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wi.c)
 */
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_ID52435335>::GetCurrentFeatureEnabledState(v7, &v17, &v16);
    if ( !v6 )
      v16 = 0;
