/*
 * XREFs of ?GetSize@CD2DBitmap@@UEBA?AUD2D_SIZE_U@@XZ @ 0x1801D3450
 * Callers:
 *     ?GetSize@CD2DBitmap@@WBA@EBA?AUD2D_SIZE_U@@XZ @ 0x1802CD540 (-GetSize@CD2DBitmap@@WBA@EBA-AUD2D_SIZE_U@@XZ.c)
