/*
 * XREFs of ?EnsureSharedRenderTargets@CMagnifierRenderTarget@@AEAAJXZ @ 0x180283A6C
 * Callers:
...
__int64 __fastcall CMagnifierRenderTarget::EnsureSharedRenderTargets(CMagnifierRenderTarget *this)
{
  ...
  if ( *((_DWORD *)this + 684) )
  {
    for ( i = 0; i < *((_DWORD *)this + 684); ++i )
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v5, 0x16Eu, 0LL);
        v2 = v1;
        goto LABEL_15;
      }
      v6 = *((_DWORD *)this + 666);
...
LABEL_12:
          ...
          v12 = v1;
          MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v2, 0x171u, 0LL);
          goto LABEL_15;
        }
      }
      else
