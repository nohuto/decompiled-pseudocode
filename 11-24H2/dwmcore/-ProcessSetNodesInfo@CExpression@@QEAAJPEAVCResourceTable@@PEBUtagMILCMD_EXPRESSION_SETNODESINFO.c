/*
 * XREFs of ?ProcessSetNodesInfo@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETNODESINFO@@@Z @ 0x18023D230
 * Callers:
        ...
        const struct tagMILCMD_EXPRESSION_SETNODESINFO *a3)
{
  ...
  Resource = (CSharedSectionBase *)CResourceTable::GetResource((__int64)a2, v8, 0x9Du);
...
LABEL_26:
  if ( (*(_DWORD *)(*((_QWORD *)this + 39) + 4LL) & 0x40000000) != 0
    ...
    && tlgKeywordOn((__int64)&dword_1803F8D18, 1LL) )
  {
    v29 = v7;
