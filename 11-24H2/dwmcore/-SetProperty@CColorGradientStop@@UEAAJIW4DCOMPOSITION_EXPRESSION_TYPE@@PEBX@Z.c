/*
 * XREFs of ?SetProperty@CColorGradientStop@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180200E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorGradientStop::SetProperty(CResource *a1, int a2, int a3, const void *a4)
{
  ...
  for ( i = (void **)&CColorGradientStop::k_rgAnimDef; ; ++i )
  {
    if ( i == &CPathData::`vftable' )
      goto LABEL_3;
