/*
 * XREFs of ?Create@CSecondaryD2DBitmap@@SAJPEAVCD2DResourceManager@@UD2D_SIZE_U@@PEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@PEAPEAV1@@Z @ 0x18005C778
 * Callers:
        ...
        __int64 *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v12 && (v13 = CSecondaryD2DBitmap::CSecondaryD2DBitmap(v12, a1, a2, a3, a4, a5, a6, a7), (v14 = v13) != 0) )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x24u, 0LL);
