/*
 * XREFs of ?MilWerRegisterMemoryBlock@@YAXPEBXI@Z @ 0x18024F754
 * Callers:
 *     ?CaptureDxgkRingBuffer@CFailFastInScope@@AEAAXXZ @ 0x1801D7168 (-CaptureDxgkRingBuffer@CFailFastInScope@@AEAAXXZ.c)
 *     ?EnsureStackCaptureRegisteredWithWER@@YAXXZ @ 0x1801F181C (-EnsureStackCaptureRegisteredWithWER@@YAXXZ.c)
 * Callees:
