/*
 * XREFs of ??0CRenderTargetBitmap@@IEAA@_N@Z @ 0x18005BC84
 * Callers:
 ...
 * Callees:
 *     ??$?0$$V@?$CDeviceResourceT@VIRenderTargetBitmap@@@@IEAA@XZ @ 0x18005BCFC (--$-0$$V@-$CDeviceResourceT@VIRenderTargetBitmap@@@@IEAA@XZ.c)
 */
