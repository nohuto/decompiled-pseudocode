/*
 * XREFs of ?GenerateDrawList@CPrimitiveGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180171130
 * Callers:
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( this[59] )
  {
    ...
    if ( v7 < 0 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x85u, 0LL);
    ...
    if ( DrawList < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, DrawList, 0x88u, 0LL);
      return (unsigned int)v7;
    }
  }
  return 0;
