/*
 * XREFs of ?Create@CCpuClipAntialiasSink@@SAJGPEBV?$CConvexPolygonEdgeMap@USinkRoutingInfo@CCpuClipAntialiasSink@@@@PEBVCShape@@AEBVCMILMatrix@@PEAPEAV1@@Z @ 0x180204F00
 * Callers:
 ...
 *     ??0CCpuClipAntialiasSink@@AEAA@XZ @ 0x180205004 (--0CCpuClipAntialiasSink@@AEAA@XZ.c)
