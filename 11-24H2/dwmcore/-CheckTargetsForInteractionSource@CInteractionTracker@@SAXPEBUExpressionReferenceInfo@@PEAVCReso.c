/*
 * XREFs of ?CheckTargetsForInteractionSource@CInteractionTracker@@SAXPEBUExpressionReferenceInfo@@PEAVCResource@@1@Z @ 0x18029D4C4
 * Callers:
        ...
        struct CResource *a3)
{
  ...
  __int64 v13; // rcx
  CVisual *v14; // r10
  CVisual *v15[4]; // [rsp+40h] [rbp-30h] BYREF
  CCachedVisualImage *v16; // [rsp+60h] [rbp-10h] BYREF
  ...
  if ( (unsigned int)dword_1803F8D18 > 4
    ...
    && (*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 184LL)
    && (*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)a3 + 64LL))(a3, 90LL) )
  {
      ...
      if ( CVisual::HasInteraction(v8) )
      {
          ...
          && tlgKeywordOn((__int64)&dword_1803F8D18, 2LL) )
        {
          ...
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>>(
            v13,
            (__int64)&unk_1803CDFF3);
        }
      }
    }
    wil::com_ptr_t<CInteractionTracker,wil::err_returncode_policy>::~com_ptr_t<CInteractionTracker,wil::err_returncode_policy>(
      &v16,
      v9,
      v10);
