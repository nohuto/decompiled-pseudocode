/*
 * XREFs of ?DestroyResources@CAtlasTexture@@AEAAXXZ @ 0x1802006B4
 * Callers:
 *     ??1CAtlasTexture@@QEAA@XZ @ 0x18020067C (--1CAtlasTexture@@QEAA@XZ.c)
 *     ?NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z @ 0x1802C9060 (-NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
