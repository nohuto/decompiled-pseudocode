/*
 * XREFs of ?PullNewPerFrameData@CSynchronousSuperWetInk@@AEAAXIPEA_N@Z @ 0x1801A2CAC
 * Callers:
 ...
 *     ?GetLatestLookupId@CSynchronousSuperWetInk@@AEBA_KXZ @ 0x1801A3360 (-GetLatestLookupId@CSynchronousSuperWetInk@@AEBA_KXZ.c)
...
LABEL_34:
    ...
    if ( v15 )
    {
      ...
      std::shared_ptr<CRegion>::operator=((char *)this + 248, v29);
    }
    else
    {
