/*
 * XREFs of ?DirtyActiveInk@CSuperWetInkManager@@QEAAXXZ @ 0x1801A2A70
 * Callers:
...
void __fastcall CSuperWetInkManager::DirtyActiveInk(CSuperWetInkManager *this)
{
  ...
  CVisual **i; // rbx
  _DWORD *v7; // rcx
  __int64 (__fastcall *v8)(_DWORD *, __int64, __int64); // rax
  ...
  do
  {
    ...
    {
      v7 = (_DWORD *)*v3;
      v8 = *(__int64 (__fastcall **)(_DWORD *, __int64, __int64))(*(_QWORD *)*v3 + 80LL);
      if ( v8 == CResource::NotifyOnChanged )
        CResource::NotifyOnChanged(v7, 0LL, 0LL);
      else
        v8(v7, 0LL, 0LL);
      v2 = 1;
    }
