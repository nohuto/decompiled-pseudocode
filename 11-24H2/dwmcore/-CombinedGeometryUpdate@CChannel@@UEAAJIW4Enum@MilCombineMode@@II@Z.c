/*
 * XREFs of ?CombinedGeometryUpdate@CChannel@@UEAAJIW4Enum@MilCombineMode@@II@Z @ 0x180210210
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  CChannel::CheckOptionalHandle(a1, a4, 67);
  CChannel::CheckOptionalHandle(a1, a5, 67);
  v12[0] = 452;
  v12[1] = a2;
  v12[2] = a3;
  v12[3] = a4;
