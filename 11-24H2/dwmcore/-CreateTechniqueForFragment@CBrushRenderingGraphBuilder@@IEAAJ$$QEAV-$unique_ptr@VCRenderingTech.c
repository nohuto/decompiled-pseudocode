/*
 * XREFs of ?CreateTechniqueForFragment@CBrushRenderingGraphBuilder@@IEAAJ$$QEAV?$unique_ptr@VCRenderingTechniqueFragment@@U?$default_delete@VCRenderingTechniqueFragment@@@std@@@std@@PEAI@Z @ 0x180044004
 * Callers:
 ...
 *     ?CollectStateFromFragment@CRenderingTechnique@@AEAAXPEAVCRenderingTechniqueFragment@@@Z @ 0x18004420C (-CollectStateFromFragment@CRenderingTechnique@@AEAAXPEAVCRenderingTechniqueFragment@@@Z.c)
...
__int64 __fastcall CBrushRenderingGraphBuilder::CreateTechniqueForFragment(_QWORD *a1, __int64 *a2, _DWORD *a3)
{
  ...
  {
    v14 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x24Du, 0LL);
    return v14;
  }
  *v6 = *a1;
  v8 = v6;
  ...
  *((_BYTE *)v7 + 276) = 0;
  ...
  {
    v22 = &v19;
    v16 = DynArrayImpl<0>::Grow(v11, 8u, 1, 0, (unsigned __int64 *)&v22);
    if ( v16 >= 0 )
    {
...
LABEL_15:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x250u, 0LL);
