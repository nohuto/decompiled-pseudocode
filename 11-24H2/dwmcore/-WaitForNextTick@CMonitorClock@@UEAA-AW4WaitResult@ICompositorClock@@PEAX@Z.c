/*
 * XREFs of ?WaitForNextTick@CMonitorClock@@UEAA?AW4WaitResult@ICompositorClock@@PEAX@Z @ 0x1800EDAB0
 * Callers:
 ...
 *     ?TranslateWaitResult@CMonitorClock@@IEAA?AW4WaitResult@ICompositorClock@@K@Z @ 0x1800EDE44 (-TranslateWaitResult@CMonitorClock@@IEAA-AW4WaitResult@ICompositorClock@@K@Z.c)
 ...
 *     ?CalcTimeoutTimeMs@CClockBase@@IEBAIXZ @ 0x1800EE058 (-CalcTimeoutTimeMs@CClockBase@@IEBAIXZ.c)
...
__int64 __fastcall CMonitorClock::WaitForNextTick(__int64 a1, void *a2)
{
  ...
  bool (__fastcall *v8)(CLegacyRenderTarget *__hidden, struct MonitorTime *, struct MonitorTime *, bool); // rax
  ...
  *(_DWORD *)(a1 + 64) = *((_DWORD *)TargetId + 6);
  ...
  v7 = *(CLegacyRenderTarget **)(a1 + 80);
  Handles = 0LL;
  v35 = 0LL;
  v36 = 0;
  v8 = *(bool (__fastcall **)(CLegacyRenderTarget *__hidden, struct MonitorTime *, struct MonitorTime *, bool))(*(_QWORD *)v7 + 216LL);
  if ( v8 == CLegacyRenderTarget::GetLastMonitorTime )
  {
    LastMonitorTime = CTargetStats::GetLastMonitorTime(
                        (CLegacyRenderTarget *)((char *)v7 + 32968),
  ...
  else
  {
    ...
    if ( v8 == CDDisplayRenderTarget::GetLastMonitorTime )
      LastMonitorTime = CTargetStats::GetLastMonitorTime(
                          (CLegacyRenderTarget *)((char *)v7 + 32984),
                          v18,
                          (struct MonitorTime *)&Handles,
                          0);
    else
...
LABEL_20:
  if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 1) != 0 )
    McTemplateU0t_EventWriteTransfer(Microsoft_Windows_Dwm_Compositor_Context, &WaitForVerticalBlank_Stop, v17);
  return v17;
}
