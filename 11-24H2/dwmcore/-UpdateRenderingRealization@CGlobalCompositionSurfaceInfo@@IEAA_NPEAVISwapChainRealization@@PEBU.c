/*
 * XREFs of ?UpdateRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAA_NPEAVISwapChainRealization@@PEBUCSM_BUFFER_ATTRIBUTES@@PEBUCSM_RGNDATA_@@PEBUScrollOptimization@@@Z @ 0x180028BD0
 * Callers:
        ...
        const struct ScrollOptimization *a5)
{
  ...
  __int64 (__fastcall *v62)(CCachedVisualImage *); // rax
  _QWORD *v63; // rsi
  __int64 v64; // rax
  __int64 v65; // rdi
  char *v66; // rdx
  ...
  __int64 (__fastcall *v91)(CCachedVisualImage *); // rax
  char *v92; // rcx
  char *v93; // rcx
  _DWORD *v94; // rdx
  int v95; // r9d
  ...
  {
    CDxHandleBitmapRealization::GetSize(v42, &v101);
  }
        ...
        if ( v6 )
        {
          do
          {
            ...
            if ( v59 )
            {
              ...
              v62 = *(__int64 (__fastcall **)(CCachedVisualImage *))(*(_QWORD *)v59 + 16LL);
        ...
        else
        {
          do
          {
            ...
            if ( v88 )
            {
              ...
              v91 = *(__int64 (__fastcall **)(CCachedVisualImage *))(*(_QWORD *)v88 + 16LL);
