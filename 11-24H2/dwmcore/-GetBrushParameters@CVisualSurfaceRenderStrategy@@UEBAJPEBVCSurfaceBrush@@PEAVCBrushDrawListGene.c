/*
 * XREFs of ?GetBrushParameters@CVisualSurfaceRenderStrategy@@UEBAJPEBVCSurfaceBrush@@PEAVCBrushDrawListGenerator@@@Z @ 0x18006EA40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetVisualTree@CCachedVisualImage@@MEBAPEAVCVisualTree@@XZ @ 0x18006F2F0 (-GetVisualTree@CCachedVisualImage@@MEBAPEAVCVisualTree@@XZ.c)
        ...
        struct CBrushDrawListGenerator *a3)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x5C7u, 0LL);
    goto LABEL_14;
  }
  if ( v58 )
  {
    ...
    if ( CVIForRealizationSize >= 0 )
      goto LABEL_7;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CVIForRealizationSize, 0x5E8u, 0LL);
LABEL_20:
  ...
  *(_OWORD *)&v42[0].x = *(_OWORD *)&v44[1];
  ...
  if ( v27 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x61Eu, 0LL);
    goto LABEL_20;
  }
...
LABEL_7:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BrushParametersWorker, 0x640u, 0LL);
  }
