/*
 * XREFs of ?RenderSpriteBitmap@CWindowNode@@AEAAJPEAVCDrawingContext@@PEBVCVisualTree@@PEAVCWindowOcclusionInfo@@@Z @ 0x1802929EC
 * Callers:
 ...
 *     ?GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z @ 0x1801E1DB8 (-GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z.c)
        ...
        struct CWindowOcclusionInfo *a4)
{
  ...
  if ( (*((_BYTE *)this + 896) & 8) != 0 && !*((_BYTE *)this + 753) )
  {
    SpriteBitmapZ = 0;
    v8 = __A__CPtrArray___CBX__QEBAPEBX_K_Z((__int64 *)this + 104, 0LL);
    if ( v10 )
