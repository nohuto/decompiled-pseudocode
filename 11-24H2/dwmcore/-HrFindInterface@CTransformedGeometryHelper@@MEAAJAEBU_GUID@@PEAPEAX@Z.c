/*
 * XREFs of ?HrFindInterface@CTransformedGeometryHelper@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180259310
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147467262, 0xE6u, 0LL);
  }
  else
  {
    *a3 = this;
