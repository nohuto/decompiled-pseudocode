/*
 * XREFs of ??$WalkSubtree@VCHitTestContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@0PEAVCHitTestContext@@W4WalkReason@@@Z @ 0x1800C0AF0
 * Callers:
 ...
 *     ?GotoSibling@?$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@@Z @ 0x18017BC40 (-GotoSibling@-$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@@Z.c)
        ...
        ...)
{
  ...
  __int64 v65; // rax
  void **v66; // rax
  void (__fastcall *v67)(CVisualTreeData *, struct CVisualTree *, struct CVisual *); // rax
...
LABEL_103:
      wil::details::in1diag3::Return_Hr(
        ...
        (const char *)v70);
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0x3Eu, 0LL);
      v4 = v15;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0xD6u, 0LL);
      return v4;
    }
  }
  v16 = (__int64 **)(a1 + 8);
...
LABEL_114:
          ...
          v77 = (CTreeData *)HeapAlloc(ProcessHeap, 0, 0x188uLL);
          if ( !v77 )
        ...
        v67 = (void (__fastcall *)(CVisualTreeData *, struct CVisualTree *, struct CVisual *))v66[1];
...
LABEL_14:
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0xF1u, 0LL);
LABEL_46:
      v40 = -2147024882;
      goto LABEL_47;
    }
...
LABEL_128:
        wil::details::in1diag3::Return_Hr(
          ...
          (int)"onecoreuap\\windows\\DWM\\dwmcore\\common\\WatermarkStack.inl",
          (const char *)v4);
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x87u, 0LL);
...
LABEL_36:
    ...
    if ( !v34 || v17 == v7 )
    {
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v49, 0x11Cu, 0LL);
        goto LABEL_46;
      }
      v35 = v95;
    }
    ...
    if ( v35 )
    {
      ...
      if ( v89 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v89, 0x125u, 0LL);
        goto LABEL_46;
      }
      v17 = v93;
      if ( v93 )
...
LABEL_101:
  ...
  {
LABEL_110:
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v40, 0x11Eu, 0LL);
    goto LABEL_101;
  }
  v87 = *(void **)(a1 + 32);
  if ( v87 )
