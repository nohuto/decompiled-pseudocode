/*
 * XREFs of ?Present@CCompSwapChain@@QEAAJII@Z @ 0x1802C7EE0
 * Callers:
...
__int64 __fastcall CCompSwapChain::Present(CCompSwapChain *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803BD758, 2u, v2, 0x13Bu, 0LL);
  }
  else
  {
    if ( **((_DWORD **)this + 19) )
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803BD758, 2u, v6, 0x14Au, 0LL);
    }
    else
    {
      if ( *((_DWORD *)this + 36) == 3 )
