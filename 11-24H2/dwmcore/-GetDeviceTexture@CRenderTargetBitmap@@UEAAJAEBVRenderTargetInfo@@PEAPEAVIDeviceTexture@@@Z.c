/*
 * XREFs of ?GetDeviceTexture@CRenderTargetBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x18010BFE0
 * Callers:
 ...
 *     ?GetDeviceTexture@CDecodeBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x180213020 (-GetDeviceTexture@CDecodeBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z.c)
 * Callees:
...
LABEL_3:
  ...
  if ( (char *)v7 == (char *)CDeviceTextureTarget::IsProtected )
    ...
    IsProtected = v7();
  if ( IsProtected && *((_BYTE *)g_pComposition + 6466) )
  {
