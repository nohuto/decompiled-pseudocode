/*
 * XREFs of ?CalcOcclusion@CCachedVisualImage@@MEAAPEAVCOcclusionContext@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@M@Z @ 0x1800F7740
 * Callers:
...
char *__fastcall CCachedVisualImage::CalcOcclusion(CBackdropVisualImage *this, __int64 a2)
{
  ...
  gsl::details *v7; // rcx
  __int64 v8; // rax
  __int64 (__fastcall *v9)(struct CVisualTree *); // rax
  char *v10; // rbx
  int v11; // eax
  ...
  v13[0] = 1LL;
  v13[1] = a2;
  v9 = *(__int64 (__fastcall **)(struct CVisualTree *))(v8 + 200);
  if ( !a2 )
  {
  ...
  else if ( v9 == CVisualTree::CalcOcclusion )
  {
    v11 = CVisualTree::CalcOcclusion(v7);
  }
  else
  {
    v11 = ((__int64 (__fastcall *)(gsl::details *, _QWORD *, char *))v9)(v7, v13, v10);
  }
  if ( v11 >= 0 )
    return v10;
  return 0LL;
