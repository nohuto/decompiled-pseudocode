/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x18025EB48
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x180273150 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
