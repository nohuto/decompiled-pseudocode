/*
 * XREFs of ?MergeAtlases@CAtlasManager@@AEAAXPEA_N@Z @ 0x1801CCA14
 * Callers:
...
void __fastcall CAtlasManager::MergeAtlases(CAtlasManager *this, bool *a2)
{
  ...
  *(_QWORD *)v2 = 0LL;
  ...
  while ( v10 != v11 )
  {
    ...
    *(v10 - 1) = v12;
    if ( v13 )
      ((void (*)(void))std::default_delete<CAtlasTexture>::operator())();
    ++v10;
  }
  std::unique_ptr<CAtlasTexture>::~unique_ptr<CAtlasTexture>(*((_QWORD *)this + 1) - 8LL);
  v14 = *((_QWORD *)this + 1) - 8LL;
  *((_QWORD *)this + 1) = v14;
  v15 = v9[6];
  if ( (_DWORD)v15 != v9[7] )
  {
    v16 = *(CAtlasTexture ***)this;
    v17 = v15 + 1;
    v18 = 1;
    if ( v16 != (CAtlasTexture **)v14 )
    {
      v5 = 1;
      do
      {
