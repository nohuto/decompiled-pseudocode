/*
 * XREFs of ?HitTest@CCompositionMagnifierBrush@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x180296DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionMagnifierBrush::HitTest(
