/*
 * XREFs of ?IsOpaqueRect@CColorBrush@@UEBA_NAEBUD2D_SIZE_F@@PEAUD2D_RECT_F@@@Z @ 0x18004B520
 * Callers:
...
bool __fastcall CColorBrush::IsOpaqueRect(CColorBrush *this, const struct D2D_SIZE_F *a2, struct D2D_RECT_F *a3)
{
  ...
  if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)this + 29) - 1.0) & _xmm) >= 0.0000011920929 )
    return 0;
  width = a2->width;
  result = 1;
  height = a2->height;
