/*
 * XREFs of ?ProcessUpdate@CLinearTransferEffect@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LINEARTRANSFEREFFECT@@@Z @ 0x180294A1C
 * Callers:
        ...
        const struct tagMILCMD_LINEARTRANSFEREFFECT *a3)
{
  ...
  *((_BYTE *)this + 221) = *((_BYTE *)a3 + 53);
  (*(void (__fastcall **)(CLinearTransferEffect *, _QWORD, _QWORD))(*(_QWORD *)this + 80LL))(this, 0LL, 0LL);
  return 0LL;
}
