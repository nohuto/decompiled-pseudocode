/*
 * XREFs of ?AddNamedInputToFragment@CBrushRenderingGraphBuilder@@IEAAXPEAVCRenderingTechniqueFragment@@AEBUGraphInputParameters@CBrushRenderingGraph@@@Z @ 0x1801FE80C
 * Callers:
...
LABEL_9:
      ...
      v13 = DynArrayImpl<0>::AddMultipleAndSet(v3 + 16, 24, 1, a3);
      v15 = v13;
      if ( v13 >= 0 )
        goto LABEL_9;
      v14 = 192;
    }
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, v14, 0LL);
