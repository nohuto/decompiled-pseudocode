/*
 * XREFs of ?ReportInertiaStart@CInteraction@@QEAAJW4InputType@@MM@Z @ 0x1802163DC
 * Callers:
...
__int64 __fastcall CInteraction::ReportInertiaStart(__int64 a1, int a2)
{
  ...
  v4 = 0;
  if ( v3 )
    (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v3 + 224LL))(v3, *((_QWORD *)g_pComposition + 111));
  v6 = *(_QWORD *)(a1 + 120);
  v7 = 0LL;
  v13 = 0LL;
  if ( v6 )
  {
    ...
    v7 = v13;
    if ( v8 >= 0 && !(unsigned int)ReportInertiaStartHelper(*(_DWORD *)(a1 + 1720), a2, v9, v10, v13 + 176, a1 + 296) )
    {
