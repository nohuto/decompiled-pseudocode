/*
 * XREFs of ?RenderTargetDirty@COffScreenRenderTarget@@MEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x180097480
 * Callers:
        ...
        bool *a3)
{
  ...
  int v52; // [rsp+BCh] [rbp+3h]
  int v53; // [rsp+C0h] [rbp+7h]
  int v54; // [rsp+C4h] [rbp+Bh]
  int v55; // [rsp+C8h] [rbp+Fh]
  int v56; // [rsp+CCh] [rbp+13h]
  ...
  *a3 = 0;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x14Fu, 0LL);
    v15 = (char *)this + 336;
  ...
  else
  {
    ...
    *(_BYTE *)(*((_QWORD *)this + 3) + 6466LL) = 1;
    ...
    if ( *((_DWORD *)this + 84) )
    {
      v44 = (**((__int64 (__fastcall ***)(char *))this + 40))((char *)this + 320);
      ...
      *(_DWORD *)(v17 + 96) = v16 & 0xFD0FFFFF | 0x2100000;
      ...
      for ( i = 0LL; ; i = (unsigned int)(v40 + 1) )
      {
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0x182u, 0LL);
LABEL_22:
          v15 = (char *)this + 336;
          v13 = (CComposition **)((char *)this + 24);
          break;
        ...
        if ( v23 )
        {
          ...
          if ( v35 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v35, 0x18Cu, 0LL);
        ...
        for ( j = (char *)this + 348; ; j = (char *)(v42 + 4) )
        {
          ...
          v27 = (struct CVisualTree *)*((_QWORD *)this + 14);
          v28 = *(_DWORD *)v43;
          v55 = 0;
          v56 = 0;
          v51 = v28;
          ...
          v54 = v42[1];
          v53 = v29;
          v30 = CDrawingContext::DrawVisualTree(v38, v27, v26, 0, 0LL);
          v12 = v30;
          if ( v30 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v30, 0x199u, 0LL);
LABEL_21:
            CDrawingContext::EndFrame((CD3DDevice **)v38);
            goto LABEL_22;
          }
        }
        v31 = (CD3DDevice **)v38;
        *((_BYTE *)this + 2728) = *((_BYTE *)v38 + 7982);
        ...
        {
          v37 = 0;
          v34 = CDrawingContext::PopLayerInternal(v31);
          v12 = v34;
          if ( v34 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v34, 0x1A5u, 0LL);
            goto LABEL_21;
          }
          v31 = (CD3DDevice **)v38;
        }
  ...
  *((_WORD *)this + 1316) = 0;
  if ( v37 )
    CDrawingContext::PopLayerInternal(v38);
  if ( v6 )
  {
    v32 = ResampleMode;
