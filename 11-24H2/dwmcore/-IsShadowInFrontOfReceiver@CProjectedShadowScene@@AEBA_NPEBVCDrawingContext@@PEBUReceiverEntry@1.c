/*
 * XREFs of ?IsShadowInFrontOfReceiver@CProjectedShadowScene@@AEBA_NPEBVCDrawingContext@@PEBUReceiverEntry@1@@Z @ 0x18016400C
 * Callers:
        ...
        __m128 *a3)
{
  ...
  if ( LightPosition >= 0 )
  {
    ...
    v18 = v22.m128_f32[2];
    if ( (float)((float)((float)(v22.m128_f32[0] * v15) + (float)(v22.m128_f32[1] * v16))
