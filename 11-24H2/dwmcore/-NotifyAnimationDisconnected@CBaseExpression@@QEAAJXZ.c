/*
 * XREFs of ?NotifyAnimationDisconnected@CBaseExpression@@QEAAJXZ @ 0x1801537A8
 * Callers:
...
LABEL_12:
        v13 = *(__int64 (__fastcall **)(CMILRefCountImpl *))(*(_QWORD *)this + 8LL);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v35, v36, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v34, 0x27Bu, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v37, 0x586u, 0LL);
    goto LABEL_39;
  }
LABEL_14:
  v7 = 0;
