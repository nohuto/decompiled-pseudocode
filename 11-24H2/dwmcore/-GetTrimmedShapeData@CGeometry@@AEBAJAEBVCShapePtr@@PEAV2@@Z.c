/*
 * XREFs of ?GetTrimmedShapeData@CGeometry@@AEBAJAEBVCShapePtr@@PEAV2@@Z @ 0x18017D04C
 * Callers:
...
__int64 __fastcall CGeometry::GetTrimmedShapeData(CGeometry *this, CShape **a2, CRectanglesShape **a3)
{
  CPathData *v4; // rdi
  CPathData *v5; // rbx
  ...
  if ( v9 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, SimplifiedPathData, 0x120u, 0LL);
      v4 = v18;
    }
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x121u, 0LL);
      }
      else
      {
        v12 = (__int64 *)MIDL_user_allocate(0x18uLL);
        v13 = (CRectanglesShape *)v12;
        if ( v12 )
        {
          v12[1] = 0LL;
          v5 = v17;
          *v12 = (__int64)&CPathSegmentsShape::`vftable';
          v12[2] = (__int64)v5;
        ...
        v8 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x124u, 0LL);
      }
      v5 = v17;
    }
  }
