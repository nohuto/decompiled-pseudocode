/*
 * XREFs of ?reserve_region@?$vector_facade@DV?$buffer_impl@D$0DA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAD_K0@Z @ 0x1801BED10
 * Callers:
 ...
 *     ??$move_backward_uninitialized@V?$basic_iterator@D@detail@@V?$checked_array_iterator@PEAD@stdext@@@detail@@YAXV?$basic_iterator@D@0@0V?$checked_array_iterator@PEAD@stdext@@@Z @ 0x1801BEE54 (--$move_backward_uninitialized@V-$basic_iterator@D@detail@@V-$checked_array_iterator@PEAD@stdext.c)
