/*
 * XREFs of ?Render@CDrawListEntryBatch@@UEAAJXZ @ 0x180108FE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasImageLightingEffect@CBrushRenderingEffect@@QEBA_NXZ @ 0x180108730 (-HasImageLightingEffect@CBrushRenderingEffect@@QEBA_NXZ.c)
 ...
 *     ?SetLights@CBatchOptimizer@@EEAAXPEAVCHwLightCollectionBuffer@@@Z @ 0x180188510 (-SetLights@CBatchOptimizer@@EEAAXPEAVCHwLightCollectionBuffer@@@Z.c)
...
LABEL_81:
  ...
  v56 = *((_DWORD *)this + 11);
  if ( v55 != v56 )
    dword_1803FA72C += v56 - v55;
  dword_1803FA84C += *((_DWORD *)this + 40);
  while ( 1 )
  {
    v57 = *((_QWORD *)this + 20);
    if ( !v57 )
