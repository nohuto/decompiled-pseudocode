/*
 * XREFs of ?FindMonitorData@CCursorState@@AEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@VMonitorData@CCursorState@@@std@@@std@@@std@@U_LUID@@I@Z @ 0x1802B2E40
 * Callers:
...
_QWORD *__fastcall CCursorState::FindMonitorData(__int64 a1, _QWORD *a2, __int64 a3, unsigned int a4)
{
  ...
  v4 = *(_QWORD *)(a1 + 88);
  for ( i = *(_QWORD *)(a1 + 96); v4 != i; v4 += 160LL )
  {
