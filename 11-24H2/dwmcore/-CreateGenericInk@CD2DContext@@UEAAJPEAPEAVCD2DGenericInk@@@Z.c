/*
 * XREFs of ?CreateGenericInk@CD2DContext@@UEAAJPEAPEAVCD2DGenericInk@@@Z @ 0x1801A14B0
 * Callers:
...
__int64 __fastcall CD2DContext::CreateGenericInk(struct CD2DResourceManager **this, struct CD2DGenericInk **a2)
{
  ...
  if ( inited < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, inited, 0x167u, 0LL);
  }
  else
  {
    v6 = this[40];
    ...
    else
    {
      ...
      v5 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x169u, 0LL);
    }
  }
  v10 = v12;
  if ( v12 )
