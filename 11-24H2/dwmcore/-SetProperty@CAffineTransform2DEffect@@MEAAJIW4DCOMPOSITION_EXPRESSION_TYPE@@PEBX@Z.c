/*
 * XREFs of ?SetProperty@CAffineTransform2DEffect@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1802A99B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  if ( *v11 != v4 )
  {
    v12 = *a1;
    *v11 = v4;
    (*(void (__fastcall **)(__int64 *, _QWORD, _QWORD))(v12 + 80))(a1, 0LL, 0LL);
  }
