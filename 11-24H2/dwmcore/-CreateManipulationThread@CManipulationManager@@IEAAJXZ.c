/*
 * XREFs of ?CreateManipulationThread@CManipulationManager@@IEAAJXZ @ 0x1800ECC20
 * Callers:
...
__int64 __fastcall CManipulationManager::CreateManipulationThread(CManipulationManager *this)
{
  ...
  if ( *((_BYTE *)this + 152) )
  {
    ...
    dwCreationFlags = 918;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032CA30, 3u, v3, dwCreationFlags, 0LL);
    return v3;
  }
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032CA30, 3u, v2, 0x399u, 0LL);
    return v3;
  }
  ThreadId = 0;
