/*
 * XREFs of ?GetD2DGeometry@CRegionShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x18014CF00
 * Callers:
...
__int64 __fastcall CRegionShape::GetD2DGeometry(int **this, const struct CMILMatrix *a2, struct ID2D1Geometry **a3)
{
  ...
  if ( !a2 )
  {
    ...
    if ( v8 )
      (*(void (__fastcall **)(int *))(*(_QWORD *)v8 + 8LL))(this[11]);
    goto LABEL_5;
  }
  v16 = 0LL;
  v17 = 0LL;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0xDBu, 0LL);
    goto LABEL_19;
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0xDDu, 0LL);
    goto LABEL_19;
  }
  FastRegion::CRegion::BeginIterator(this + 2, (__int64)v19);
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0xECu, 0LL);
LABEL_19:
