/*
 * XREFs of ?IsReadyToDraw@CDropShadow@@AEBA_NPEAVCDrawingContext@@PEA_N@Z @ 0x180138D3C
 * Callers:
...
char __fastcall CDropShadow::IsReadyToDraw(CDropShadow *this, struct CDrawingContext *a2, bool *a3)
{
  ...
  __int64 v10; // rcx
  char (__fastcall *v11)(CSurfaceBrush *, struct CDrawingContext *, bool *); // rax
  char v12; // al
  bool (__fastcall *v13)(__int64, unsigned __int64); // rax
  CNineGridBrush *v15; // rcx
  char (__fastcall *v16)(CNineGridBrush *, struct CDrawingContext *, bool *); // rax
  ...
  else
  {
    ...
    if ( *((_DWORD *)this + 31) == 1 )
    {
      if ( a2 )
      {
        ...
        if ( !v10 )
          return 0;
        v13 = *(bool (__fastcall **)(__int64, unsigned __int64))(*(_QWORD *)v10 + 64LL);
        if ( !(v13 == CColorBrush::IsOfType ? CColorBrush::IsOfType(v10, 0x11uLL) : v13(v10, 17uLL)) )
          return 0;
        v15 = (CNineGridBrush *)*((_QWORD *)CurrentVisual + 32);
        if ( !v15 )
          return 0;
        v16 = *(char (__fastcall **)(CNineGridBrush *, struct CDrawingContext *, bool *))(*(_QWORD *)v15 + 312LL);
    ...
    else
    {
      ...
      if ( !v7 )
        return 1;
      v11 = *(char (__fastcall **)(CSurfaceBrush *, struct CDrawingContext *, bool *))(*(_QWORD *)v7 + 312LL);
