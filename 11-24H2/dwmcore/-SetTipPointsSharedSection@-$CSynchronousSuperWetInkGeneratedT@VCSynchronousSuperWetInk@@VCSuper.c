/*
 * XREFs of ?SetTipPointsSharedSection@?$CSynchronousSuperWetInkGeneratedT@VCSynchronousSuperWetInk@@VCSuperWetSource@@@@QEAAJPEAVCSharedSectionBase@@@Z @ 0x18027A298
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[24] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x1420u, 0LL);
    }
    else
    {
