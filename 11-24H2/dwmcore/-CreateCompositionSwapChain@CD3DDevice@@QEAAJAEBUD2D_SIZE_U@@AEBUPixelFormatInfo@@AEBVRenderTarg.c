/*
 * XREFs of ?CreateCompositionSwapChain@CD3DDevice@@QEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVCCompSwapChain@@@Z @ 0x1802BC5AC
 * Callers:
        ...
        struct CCompSwapChain **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( !*((_DWORD *)this + 278) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, DXGIFactory, v15, 0LL);
    goto LABEL_16;
  }
  v9 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, -2003304307, 0x38Fu, 0LL);
LABEL_16:
