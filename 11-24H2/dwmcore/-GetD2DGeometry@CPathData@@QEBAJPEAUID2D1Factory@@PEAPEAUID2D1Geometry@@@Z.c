/*
 * XREFs of ?GetD2DGeometry@CPathData@@QEBAJPEAUID2D1Factory@@PEAPEAUID2D1Geometry@@@Z @ 0x1801ACCD0
 * Callers:
...
__int64 __fastcall CPathData::GetD2DGeometry(CPathData *this, struct ID2D1Factory *a2, struct ID2D1Geometry **a3)
{
  ...
  unsigned int v6; // edi
  __int64 v7; // rax
  __int64 (__fastcall *v9)(CCachedVisualImage *, __int64, __int64); // r8
  ...
  __int64 v16; // rax
  __int64 (__fastcall *v17)(__int64 *, CCachedVisualImage **); // rbx
  int v18; // eax
  CCachedVisualImage *v19; // rbx
  __int64 (__fastcall *v20)(CCachedVisualImage *, struct ID2D1GeometrySink **); // rdi
  int v21; // eax
  int v22; // eax
  int v23; // eax
  struct ID2D1GeometrySink *v24; // rcx
  CCachedVisualImage *v25; // [rsp+70h] [rbp+28h] BYREF
  ...
  {
    v10 = (CCachedVisualImage *)*((_QWORD *)this + 7);
    if ( v25 == v10 )
      goto LABEL_12;
    if ( v10 )
    {
      (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(struct CMILPoolResource *), __int64 (__fastcall *)(CCachedVisualImage *, __int64, __int64)))(*(_QWORD *)v10 + 8LL))(
        *((_QWORD *)this + 7),
    ...
    if ( (char *)v12 == (char *)CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease )
    {
      CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease(
        v11,
        (__int64)CMILRefCountBaseT<IDeviceResource,CMilObjectDeleter>::InternalRelease,
...
LABEL_31:
    ((void (__fastcall *)(CCachedVisualImage *, __int64 (__fastcall *)(struct CMILPoolResource *), __int64 (__fastcall *)(CCachedVisualImage *, __int64, __int64)))v12)(
      v11,
      v3,
      v9);
    goto LABEL_12;
  ...
  v16 = *v4;
  v26 = 0LL;
  v17 = *(__int64 (__fastcall **)(__int64 *, CCachedVisualImage **))(v16 + 80);
  ...
  {
    v19 = v25;
    v20 = *(__int64 (__fastcall **)(CCachedVisualImage *, struct ID2D1GeometrySink **))(*(_QWORD *)v25 + 136LL);
...
LABEL_13:
  ...
  {
    ((void (__fastcall *)(CCachedVisualImage *, __int64 (__fastcall *)(struct CMILPoolResource *), __int64 (__fastcall *)(CCachedVisualImage *, __int64, __int64)))v14)(
      v13,
      CMILRefCountBaseT<IDeviceResource,CMilObjectDeleter>::InternalRelease,
      v9);
    return v6;
