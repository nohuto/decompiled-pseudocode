/*
 * XREFs of ?EnsureDDisplayManager@CDDisplayManager@@QEAAJXZ @ 0x180210444
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAUHSTRING__@@P6AJPEAU1@@Z$1?WindowsDeleteString@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1802C1598 (--1-$unique_storage@U-$resource_policy@PEAUHSTRING__@@P6AJPEAU1@@Z$1-WindowsDeleteString@@YAJ0@Z.c)
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            v12 = RoGetActivationFactory(v17, &GUID_e60e4cfb_36c9_56dd_8fa1_6ff8c4e0ff07, &qword_1803FAB88);
            v1 = v12;
            if ( v12 < 0 )
            {
            ...
            else
            {
              ...
              else
              {
                ...
                v15 = RoGetActivationFactory(v16, &GUID_028d1ebd_933a_5cba_97d8_fe808844d45d, &qword_1803FAB90);
                v1 = v15;
                if ( v15 < 0 )
