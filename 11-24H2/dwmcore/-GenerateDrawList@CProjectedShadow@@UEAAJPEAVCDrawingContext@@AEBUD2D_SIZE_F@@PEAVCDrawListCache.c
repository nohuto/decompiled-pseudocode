/*
 * XREFs of ?GenerateDrawList@CProjectedShadow@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18006B870
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  struct CGeometryOnlyDrawListBrush *v53; // [rsp+F0h] [rbp-10h] BYREF
  float v54; // [rsp+F8h] [rbp-8h]
  float v55; // [rsp+FCh] [rbp-4h]
  _BYTE v56[8]; // [rsp+100h] [rbp+0h] BYREF
  _BYTE v57[8]; // [rsp+108h] [rbp+8h] BYREF
  _BYTE v58[24]; // [rsp+110h] [rbp+10h] BYREF
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CasterShadowInputBrush, 0x177u, 0LL);
    ...
    *((_OWORD *)v13 + 2) = v39;
    ...
    if ( v15 )
    {
      v35 = CBrushRenderingGraph::RenderSubgraphs(
              v15,
              a2,
              (struct D2D_SIZE_F *)(*(_QWORD *)(*((_QWORD *)this + 11) + 72LL) + 144LL),
              v38,
              0,
              a4);
      CasterShadowInputBrush = v35;
      if ( v35 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x18Du, 0LL);
    }
    else
    {
      v41 = 0;
      *(_QWORD *)&v39 = &CProjectedShadowRenderingEffectFactory::`vftable';
      ...
      if ( CasterShadowInputBrush < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CasterShadowInputBrush, 0x19Bu, 0LL);
      }
      else
      {
        ...
        if ( CasterShadowInputBrush < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CasterShadowInputBrush, 0x19Fu, 0LL);
        }
        else
        {
          ...
          else
          {
            ...
            v53 = (struct CGeometryOnlyDrawListBrush *)__PAIR64__(LODWORD(v30), LODWORD(v29));
            v54 = v31;
            v55 = v32;
          ...
          std::unique_ptr<CDrawListBrush>::operator=<std::default_delete<CDrawListBrush>,0>(v57, &lpMem);
          v22 = v59;
          if ( v59 <= 1 )
            v22 = 1;
          v59 = v22;
          ...
          if ( DrawList < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DrawList, 0x1C6u, 0LL);
          else
