/*
 * XREFs of ?RenderContentWorker@CVisual@@KAJPEAV1@PEAVCContent@@IIPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x1801109C0
 * Callers:
 ...
 *     ??$?8VCBrushRenderingGraph@@@WRL@Microsoft@@YA_NAEBV?$ComPtr@VCBrushRenderingGraph@@@01@$$T@Z @ 0x1801FAF60 (--$-8VCBrushRenderingGraph@@@WRL@Microsoft@@YA_NAEBV-$ComPtr@VCBrushRenderingGraph@@@01@$$T@Z.c)
        ...
        const struct D2D_SIZE_F *a6)
{
  ...
  void *(__fastcall *v28)(CDrawListEntry *__hidden, unsigned int); // rax
  ...
  int v41; // edi
  int v42; // edi
  void *(__fastcall *v43)(CDrawListEntry *__hidden, unsigned int); // rax
  ...
  char v61; // [rsp+58h] [rbp-28h] BYREF
  ...
  {
    v13 = (struct _LIST_ENTRY *)((char *)this + 328);
  }
  else
  {
  ...
  if ( !v13 )
    goto LABEL_76;
  v14 = (struct CDrawingContext *)&v13[1];
  v11 = 0;
  Flink = v13[1].Flink;
  ...
  v59 = v17;
  v18 = 0LL;
  while ( Flink != (struct _LIST_ENTRY *)v17 )
  {
    if ( LODWORD(Flink->Flink) != v63 || HIDWORD(Flink->Flink) )
      goto LABEL_103;
    v12 = v58;
    Blink = (CDrawListEntry *)Flink->Blink;
    v57 = Blink;
...
LABEL_12:
    ...
    {
      v18 = (volatile signed __int32 *)Flink->Blink;
      break;
    }
LABEL_103:
    v17 = v59;
...
LABEL_120:
    ...
    if ( !v25 )
    {
      if ( _InterlockedAdd((volatile signed __int32 *)v24 + 2, 1u) <= 0 )
        wil::details::in1diag3::Log_Hr(
          ...
          (const char *)0x8007029CLL,
          v55);
      (*(void (__fastcall **)(CDrawListEntry *, CGlobalComposition *, struct CD3DDevice *(__fastcall *)(CD2DResource *__hidden), __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD)))(*(_QWORD *)v57 + 24LL))(
        v57,
        v12,
        a3,
        v16);
      ...
      if ( !v26 )
      {
        if ( _InterlockedDecrement((volatile signed __int32 *)v24 + 2) < -1 )
          wil::details::in1diag3::Log_Hr(
            ...
            v55);
        v27 = v57;
        v28 = *(void *(__fastcall **)(CDrawListEntry *__hidden, unsigned int))(*(_QWORD *)v57 + 16LL);
  ...
  if ( v11 < 0 )
  {
    ...
    v40 = v11;
LABEL_77:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AF58, 3u, v11, 0x1050u, 0LL);
  }
  else
  {
LABEL_76:
...
LABEL_51:
      ...
      if ( *((_BYTE *)a2 + 96) && (unsigned __int8)Microsoft::WRL::operator==<CBrushRenderingGraph>(a2 + 10, 0LL, a3) )
      {
        ...
        if ( v46 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AF58, 3u, v46, 0x7Au, 0LL);
          goto LABEL_56;
        }
      }
      v39 = CContent::Draw((CContent *)a2, v9, v31, (struct CDrawListCache *)v6);
      v40 = v39;
      if ( v39 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AF58, 3u, v39, 0x7Du, 0LL);
      else
LABEL_55:
        v40 = 0;
    }
...
LABEL_56:
    if ( v40 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AF58, 3u, v40, 0x1055u, 0LL);
  }
  if ( v6 )
  {
      ...
      if ( !v42 )
      {
        if ( _InterlockedDecrement(v6 + 2) < -1 )
          wil::details::in1diag3::Log_Hr(
            ...
            (const char *)0x8007029CLL,
            v55);
        v43 = *(void *(__fastcall **)(CDrawListEntry *__hidden, unsigned int))(*(_QWORD *)v6 + 16LL);
