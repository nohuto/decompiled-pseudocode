/*
 * XREFs of ?CreateRenderTargetView@CD3DDevice@@QEAAJPEAUID3D11Resource@@PEBUD3D11_RENDER_TARGET_VIEW_DESC@@PEAPEAUID3D11RenderTargetView@@@Z @ 0x1801FA7DC
 * Callers:
        ...
        struct ID3D11RenderTargetView **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304307, 0x6C3u, 0LL);
  }
  else
  {
    ...
    v6 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x6C7u, 0LL);
  }
