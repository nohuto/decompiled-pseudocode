/*
 * XREFs of ?ProcessSetCallbackId@CNotificationResource@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_NOTIFICATIONRESOURCE_SETCALLBACKID@@@Z @ 0x180111330
 * Callers:
  ...
  if ( (unsigned int)v3 < 0x10000 && (unsigned int)v3 < *(_DWORD *)(v5 + 864) )
  {
    ...
    if ( v7 )
    {
      ...
      if ( *(_DWORD *)(v8 + 108) && (v9 = (_DWORD *)((char *)this + 72), *((_DWORD *)this + 18)) )
      {
        ...
        v14 = (unsigned int)*v9;
        v15 = *(_QWORD ***)(*((_QWORD *)this + 3) + 6392LL);
        ...
        if ( v16 == CMessageConversationHost::FlushCallbackId )
          ...
          v16(*(CMessageConversationHost **)(*((_QWORD *)this + 3) + 6392LL), v13, v14);
      }
      else
      {
LABEL_7:
