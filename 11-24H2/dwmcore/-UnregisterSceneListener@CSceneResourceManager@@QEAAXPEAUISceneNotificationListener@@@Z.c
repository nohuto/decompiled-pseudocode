/*
 * XREFs of ?UnregisterSceneListener@CSceneResourceManager@@QEAAXPEAUISceneNotificationListener@@@Z @ 0x18025F910
 * Callers:
 ...
 *     ??1CSceneMaterial@@MEAA@XZ @ 0x1802A49AC (--1CSceneMaterial@@MEAA@XZ.c)
