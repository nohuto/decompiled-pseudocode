/*
 * XREFs of ?TryDrawCommandAsDrawList@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListCache@@PEAVCDrawListEntryBuilder@@IV?$span@$$CBE$0?0@gsl@@PEA_N@Z @ 0x18013BB14
 * Callers:
 ...
 *     ?IsRoundedRectangleGeometry@CRectangleGeometry@@QEBA_NXZ @ 0x1801B1C60 (-IsRoundedRectangleGeometry@CRectangleGeometry@@QEBA_NXZ.c)
 ...
 *     ?GetRealizedColor@CSolidColorLegacyMilBrush@@QEBAJPEAU_D3DCOLORVALUE@@@Z @ 0x1801FA948 (-GetRealizedColor@CSolidColorLegacyMilBrush@@QEBAJPEAU_D3DCOLORVALUE@@@Z.c)
        ...
        _BYTE *a7)
{
  ...
  __int64 *v32; // rdi
  __int64 v33; // rdx
  CCommonRenderingEffectFactory *v34; // rcx
  __int64 v35; // rax
  ...
  *a7 = 0;
  ...
  switch ( a5 )
  {
      ...
      if ( v68 )
      {
               ...
               85LL) )
        {
          if ( !*(_QWORD *)(a3 + 24) )
          {
            ...
            if ( v69 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v69, 0x27Du, 0LL);
              return v11;
            }
          }
        }
    ...
    case 429:
      ...
      v47 = *(CGeometry **)(v45 + 8LL * *(unsigned int *)(v44 + 8));
      if ( !v46 || !v47 )
        goto LABEL_45;
              ...
              164LL) )
      {
        if ( (*(unsigned __int8 (__fastcall **)(CSolidColorLegacyMilBrush *, __int64))(*(_QWORD *)v46 + 64LL))(
               ...
               84LL) )
        {
          if ( (*(unsigned __int8 (__fastcall **)(CGeometry *, __int64))(*(_QWORD *)v47 + 64LL))(v47, 127LL) )
          {
            *(_QWORD *)&v73.left = *((_QWORD *)v46 + 24);
            if ( !CRectangleGeometry::IsRoundedRectangleGeometry(v47) && !*(_QWORD *)(a3 + 24) && v60 )
            {
              *(struct _D3DCOLORVALUE *)&v76.r = 0LL;
              BoundsSafe = CGeometry::GetBoundsSafe(v47, 0LL, (__int64)&v76);
              v11 = BoundsSafe;
              if ( BoundsSafe < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, BoundsSafe, 0x2DAu, 0LL);
                return v11;
              }
              ...
              if ( v65 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v65, 0x2F8u, 0LL);
                return v11;
              }
            }
          }
      ...
      *(struct _D3DCOLORVALUE *)&v76.r = 0LL;
      ...
      if ( RealizedColor < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, RealizedColor, 0x292u, 0LL);
        return v11;
      }
      if ( (*(unsigned __int8 (__fastcall **)(CGeometry *, __int64))(*(_QWORD *)v47 + 64LL))(v47, 130LL) )
      {
        if ( *(_QWORD *)(a3 + 24) )
          goto LABEL_45;
        v49 = *((_QWORD *)v47 + 17);
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v53, 0x29Eu, 0LL);
        return v11;
      }
      if ( (*(unsigned __int8 (__fastcall **)(CGeometry *, __int64))(*(_QWORD *)v47 + 64LL))(v47, 127LL) )
      {
        ...
        {
          v73 = 0LL;
          v54 = CGeometry::GetBoundsSafe(v47, 0LL, (__int64)&v73);
          v11 = v54;
          if ( v54 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v54, 0x2ABu, 0LL);
            return v11;
          }
          ...
          if ( v55 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v55, 0x2ACu, 0LL);
            return v11;
          }
        }
        goto LABEL_45;
      }
      if ( !(*(unsigned __int8 (__fastcall **)(CGeometry *, __int64))(*(_QWORD *)v47 + 64LL))(v47, 27LL) )
      {
LABEL_45:
        *a7 = 1;
        return v11;
      ...
      *(_QWORD *)&v73.left = 0LL;
      LOBYTE(v73.right) = 0;
      v70[0] = 0;
      ShapeData = CGeometry::GetShapeData(v47, 0LL, (CRectanglesShape **)&v73);
      v11 = ShapeData;
      if ( ShapeData < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, ShapeData, 0x2B6u, 0LL);
LABEL_95:
        CShapePtr::~CShapePtr((CRectanglesShape **)&v73);
        return v11;
      }
      if ( *(_QWORD *)&v73.left
        ...
        && !*(_QWORD *)(a3 + 24) )
      {
        ...
        {
          v11 = -2003304309;
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304309, 0x2C3u, 0LL);
LABEL_84:
          if ( *(_QWORD *)&v74.left )
          {
        ...
        v57 = *(struct D2D_RECT_F **)&v74.left;
        v58 = *(struct D2D_RECT_F **)&v74.right;
        if ( *(_QWORD *)&v74.left != *(_QWORD *)&v74.right )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v59, 0x2C8u, 0LL);
          goto LABEL_84;
        }
LABEL_90:
        if ( v57 )
      ...
      if ( v42 )
      {
               ...
               a1) )
        {
          if ( !*(_QWORD *)(a3 + 24) )
          {
            ...
            if ( v43 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v43, 0x265u, 0LL);
              return v11;
            }
          }
        }
    ...
    case 432:
      ...
      if ( *(_QWORD *)&v74.right )
      {
        ...
        *(struct _D3DCOLORVALUE *)&v76.r = 0LL;
        v72 = 1;
        v11 = CCommonRenderingEffectFactory::CreateRenderingEffect(
                v34,
                (__int64)&v74,
                (__int16 *)v70,
                (__int64)&v76,
                &v71,
                (struct CRenderingEffect **)&v73);
...
LABEL_48:
        ...
        *(_QWORD *)&v76.r = a4;
        ...
        if ( (v11 & 0x80000000) != 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x32Bu, 0LL);
          goto LABEL_48;
        }
        wil::com_ptr_t<IHolographicFrameProcessor,wil::err_returncode_policy>::~com_ptr_t<IHolographicFrameProcessor,wil::err_returncode_policy>((__int64 *)&v73);
      }
               ...
               a1) )
        {
          if ( !*(_QWORD *)(a3 + 24) )
          {
            *(struct _D3DCOLORVALUE *)&v76.r = 0LL;
            ...
            if ( v22 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0x202u, 0LL);
              return v11;
            }
            ...
            if ( v23 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0x206u, 0LL);
              return v11;
            }
          }
        }
        else if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v21 + 64LL))(v21, 100LL) )
        {
          if ( !*(_QWORD *)(a3 + 24) )
          {
            ...
            if ( v24 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v24, 0x212u, 0LL);
              return v11;
            }
          }
        }
        else if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v21 + 64LL))(v21, 84LL) )
        {
          ...
          if ( *(_QWORD *)&v73.left )
          {
            if ( CImageLegacyMilBrush::ReducesToFillImage((CImageLegacyMilBrush *)v21) && !*(_QWORD *)(a3 + 24) )
            {
              ...
              *(struct _D3DCOLORVALUE *)&v76.r = *(struct _D3DCOLORVALUE *)&v26.r;
              ...
              if ( v29 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v29, 0x225u, 0LL);
                return v11;
              }
            }
          }
    ...
    case 434:
      if ( !*(_QWORD *)(a3 + 24) )
      {
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x237u, 0LL);
          return v11;
        }
      }
      goto LABEL_45;
      ...
      if ( v15 )
      {
               ...
               a1) )
        {
          if ( !*(_QWORD *)(a3 + 24) )
          {
            ...
            if ( v16 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0x24Eu, 0LL);
              return v11;
            }
          }
        }
