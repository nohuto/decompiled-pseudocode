/*
 * XREFs of ?GetProperty@CSurfaceBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1802A67F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSurfaceBrush::GetProperty(CSurfaceBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, v5, -2147024809, 0x86u, (void *)(v5 & v9));
  }
  return v3;
}
