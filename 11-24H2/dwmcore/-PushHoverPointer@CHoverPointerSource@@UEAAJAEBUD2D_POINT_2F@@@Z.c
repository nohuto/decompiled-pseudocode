/*
 * XREFs of ?PushHoverPointer@CHoverPointerSource@@UEAAJAEBUD2D_POINT_2F@@@Z @ 0x180094DD0
 * Callers:
...
LABEL_4:
  ...
  if ( v4 )
  {
    v5 = *(unsigned int (__fastcall **)(CMILRefCountImpl *__hidden))(*(_QWORD *)v4 + 8LL);
    ...
    else
    {
      ...
      if ( v9 )
      {
        ...
        v13 = this;
        v14 = v9;
        v2 = CoreUICallSend(v4, &v14, 1LL, 9LL, 4, &unk_18032BF5D, (unsigned int)&v13, &v12, savedregs);
        if ( v2 < 0 )
