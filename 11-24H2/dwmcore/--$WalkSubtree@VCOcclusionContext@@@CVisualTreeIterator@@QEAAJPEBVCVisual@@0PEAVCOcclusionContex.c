/*
 * XREFs of ??$WalkSubtree@VCOcclusionContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@0PEAVCOcclusionContext@@W4WalkReason@@@Z @ 0x1800A0FC0
 * Callers:
        ...
        bool a5)
{
  ...
  __int64 v70; // rax
  void **v71; // rax
  void (__fastcall *v72)(CVisualTreeData *, struct CVisualTree *, struct CVisual *); // rax
  HANDLE v73; // rax
...
LABEL_95:
          ...
          v75 = (CTreeData *)HeapAlloc(ProcessHeap, 0, 0x188uLL);
          if ( !v75 )
        ...
        v72 = (void (__fastcall *)(CVisualTreeData *, struct CVisualTree *, struct CVisual *))v71[1];
...
LABEL_16:
      ...
      while ( 2 )
      {
        ...
        if ( !v26 || v18 == v8 )
        {
          ...
          if ( v28 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v28, 0x11Cu, 0LL);
            goto LABEL_94;
          }
          v27 = a5;
        }
...
LABEL_109:
  ...
  if ( !v83 )
  {
    v5 = v42;
LABEL_126:
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v34, 0x11Eu, 0LL);
    goto LABEL_109;
  }
  v94 = *(void **)(a1 + 32);
  if ( v94 )
