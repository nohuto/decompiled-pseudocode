/*
 * XREFs of ?GetActiveLightCount@CLightStack@@QEBAIPEAVCVisual@@PEBVCVisualTree@@_N@Z @ 0x1802005FC
 * Callers:
 ...
 *     ?GetActiveLightCount@CDrawingContext@@QEBAIXZ @ 0x180265618 (-GetActiveLightCount@CDrawingContext@@QEBAIXZ.c)
 * Callees:
