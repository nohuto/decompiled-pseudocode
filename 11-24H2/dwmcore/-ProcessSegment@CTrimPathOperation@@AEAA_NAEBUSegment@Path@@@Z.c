/*
 * XREFs of ?ProcessSegment@CTrimPathOperation@@AEAA_NAEBUSegment@Path@@@Z @ 0x18017D288
 * Callers:
...
LABEL_13:
    LOBYTE(v5) = *(_BYTE *)a2;
    if ( a2 > (const struct Path::Segment *)((char *)a2 + (unsigned int)Path::Segment::GetSize(v5)) )
      ((void (*)(void))`gsl::details::get_terminate_handler'::`2'::handler)();
    std::vector<unsigned char>::_Insert_counted_range<unsigned char const *>(this, *((_QWORD *)this + 1), a2);
    goto LABEL_7;
  }
  if ( *((_BYTE *)this + 396) )
    goto LABEL_13;
