/*
 * XREFs of ??1?$com_ptr_t@VCD3DDevice@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1801F5158
 * Callers:
...
__int64 __fastcall wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::~com_ptr_t<CD3DDevice,wil::err_returncode_policy>(
        CD3DDevice **a1)
{
  CD3DDevice *v1; // rcx
  __int64 result; // rax
