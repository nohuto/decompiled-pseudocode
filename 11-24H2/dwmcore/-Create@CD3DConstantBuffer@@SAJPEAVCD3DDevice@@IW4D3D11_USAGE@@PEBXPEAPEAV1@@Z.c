/*
 * XREFs of ?Create@CD3DConstantBuffer@@SAJPEAVCD3DDevice@@IW4D3D11_USAGE@@PEBXPEAPEAV1@@Z @ 0x18004523C
 * Callers:
        ...
        struct CD3DConstantBuffer **a5)
{
  ...
  if ( v8 )
  {
    ...
    *((_DWORD *)v9 + 32) = 0;
    ...
    {
      v11 = -2003304307;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304307, 0x67Fu, 0LL);
    }
    else
    {
      ...
      v11 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x683u, 0LL);
    }
