/*
 * XREFs of ?Start@CKstBase@@AEAAJPEBG@Z @ 0x1800ED884
 * Callers:
...
__int64 __fastcall CKstBase::Start(CKstBase *this, const unsigned __int16 *a2)
{
  ...
  v12 = HIDWORD(a2);
  lpThreadId = 0;
  v3 = (char *)CreateThread(0LL, 0LL, CKstBase::RunKernelThreadStatic, this, 4u, &lpThreadId);
  ...
  if ( *v4 )
  {
    ...
    {
      ResumeThread(*v4);
      _wait___event_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEBA_NKH_Z(v6);
