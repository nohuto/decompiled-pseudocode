/*
 * XREFs of ?clear_region@?$vector_facade@USinkEntry@CCpuClipAntialiasSinkContext@@V?$buffer_impl@USinkEntry@CCpuClipAntialiasSinkContext@@$01$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800796A4
 * Callers:
...
LABEL_3:
  ...
  for ( i = &v3[-54 * a3]; i != v3; i += 54 )
    CCpuClipAntialiasSinkContext::SinkEntry::~SinkEntry(i, a2, a3);
  a1[1] -= v11;
}
