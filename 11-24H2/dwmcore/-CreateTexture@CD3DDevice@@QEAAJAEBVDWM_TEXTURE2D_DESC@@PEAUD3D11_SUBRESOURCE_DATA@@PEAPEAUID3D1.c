/*
 * XREFs of ?CreateTexture@CD3DDevice@@QEAAJAEBVDWM_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAPEAUID3D11Texture2D@@@Z @ 0x18005AEE0
 * Callers:
        ...
        struct ID3D11Texture2D **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v8 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, -2003304307, 0x6E3u, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v7, 0x6E7u, 0LL);
    }
    else
    {
