/*
 * XREFs of ?OnOcclusionStrengthChanged@CScenePbrMaterial@@QEAAXXZ @ 0x1802A53A4
 * Callers:
 *     ?SetOcclusionStrength@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z @ 0x180278F14 (-SetOcclusionStrength@-$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJ.c)
