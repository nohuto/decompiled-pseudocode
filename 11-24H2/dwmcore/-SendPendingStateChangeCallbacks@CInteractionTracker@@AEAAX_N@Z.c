/*
 * XREFs of ?SendPendingStateChangeCallbacks@CInteractionTracker@@AEAAX_N@Z @ 0x180156810
 * Callers:
...
void __fastcall CInteractionTracker::SendPendingStateChangeCallbacks(CInteractionTracker *this, char a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6392LL) + 72LL))(
  ...
  while ( (unsigned int)v10 < (unsigned int)v9 )
  {
    ...
    else if ( v15 )
    {
      ...
      else
      {
        ...
        {
          v34 = CInteractionTracker::CalculateInertiaCallbackValues((__int64)this, (__int64)v59);
          v35 = *(__m128 *)v34;
          v36 = *(_QWORD *)(v34 + 48);
        }
        else
