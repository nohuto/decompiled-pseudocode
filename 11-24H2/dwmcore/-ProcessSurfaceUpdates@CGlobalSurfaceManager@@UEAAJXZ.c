/*
 * XREFs of ?ProcessSurfaceUpdates@CGlobalSurfaceManager@@UEAAJXZ @ 0x18007CC40
 * Callers:
...
__int64 __fastcall CGlobalSurfaceManager::ProcessSurfaceUpdates(CGlobalSurfaceManager *this, __int64 a2, __int64 a3)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR Buffer; // [rsp+60h] [rbp-19h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v31; // [rsp+70h] [rbp-9h] BYREF
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032BA18, 3u, FrameSurfaceUpdates | 0x10000000, 0x91u, 0LL);
  if ( v11 >= 0 )
  {
    while ( 1 )
    {
LABEL_9:
      ...
      if ( v20 < 0 )
      {
        v11 = v20 | 0x10000000;
        v24 = v20 | 0x10000000;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032BA18, 3u, v20 | 0x10000000, 0x91u, 0LL);
        if ( v11 < 0 )
          break;
      }
      else
