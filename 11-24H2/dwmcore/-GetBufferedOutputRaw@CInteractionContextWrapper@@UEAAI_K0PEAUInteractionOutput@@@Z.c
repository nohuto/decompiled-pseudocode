/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x1802B6CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1801F7F68 (_anonymous_namespace_--ResetInteractionOutput.c)
