/*
 * XREFs of ?HasPendingScribble@CScribbleSwapChain@@UEBA_NXZ @ 0x1801BD2B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetBufferCount@CDDisplaySwapChain@@UEBAIXZ @ 0x1801BD3F0 (-GetBufferCount@CDDisplaySwapChain@@UEBAIXZ.c)
...
char __fastcall CScribbleSwapChain::HasPendingScribble(CScribbleSwapChain *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
    {
      v8 = *(__int64 (**)(void))(*(_QWORD *)v7 + 160LL);
