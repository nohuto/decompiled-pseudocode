/*
 * XREFs of ?UpdateFeatureLevels@CDeviceManager@@SAXAEBV?$span@U_LUID@@$0?0@gsl@@_N@Z @ 0x18021AD90
 * Callers:
...
void __fastcall CDeviceManager::UpdateFeatureLevels(_QWORD *a1, unsigned __int8 a2)
{
  ...
  {
    v14 = 0LL;
    wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset((volatile signed __int32 **)&v14);
