/*
 * XREFs of ?EmitWarpFastPathGeometry@CRenderingBatchCommand@@AEBAXPEAVCD3DBatchExecutionContext@@@Z @ 0x18006238C
 * Callers:
 ...
 *     ?ToD2D1InterpolationMode@InterpolationMode@@YA?AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z @ 0x180063968 (-ToD2D1InterpolationMode@InterpolationMode@@YA-AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z.c)
...
LABEL_50:
  ...
  if ( *(_DWORD *)v3 == 4 )
  {
    FastRegion::CRegion::BeginIterator((char *)v3 + 96, &v90);
      ...
      *(_QWORD *)&v81.m[2][0] = __PAIR64__(LODWORD(v55), LODWORD(v54));
      if ( v82 > v54 && v53 > v55 )
      {
        v56 = (*(__int64 (__fastcall **)(__int64, FLOAT *, struct _D3DCOLORVALUE *, _QWORD, _DWORD))(*(_QWORD *)v7 + 56LL))(
                ...
                0);
        if ( v56 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v56, 0x1EBu, 0LL);
        ++v45;
      }
  ...
  else
  {
    ...
    if ( v81.m21 > v81.m11 && v48 > v47 )
    {
      v49 = (*(__int64 (__fastcall **)(__int64, struct D2D_MATRIX_3X2_F *, struct _D3DCOLORVALUE *, _QWORD, _DWORD))(*(_QWORD *)v7 + 56LL))(
              ...
              0);
      if ( v49 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v49, 0x1F7u, 0LL);
      v45 = 1;
    }
  }
  dword_1803FA858 += v45;
