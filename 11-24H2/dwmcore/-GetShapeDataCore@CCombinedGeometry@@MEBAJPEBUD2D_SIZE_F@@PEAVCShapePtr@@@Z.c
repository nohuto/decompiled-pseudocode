/*
 * XREFs of ?GetShapeDataCore@CCombinedGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x18020E990
 * Callers:
 *     <none>
 * Callees:
        ...
        CRectanglesShape **a3)
{
  ...
  CRectanglesShape *v19; // [rsp+70h] [rbp+20h] BYREF
  ...
  *((_DWORD *)this + 10) = v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6;
  if ( (((unsigned __int8)v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6) & 6) == 2 )
  {
    ...
    if ( v8 && (v14 = CGeometry::GetShapeData(v8, a2, &v17), v4 = v14, v14 < 0) )
    {
    ...
    else
    {
      ...
      if ( v9 && (ShapeData = CGeometry::GetShapeData(v9, a2, &v15), v4 = ShapeData, ShapeData < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, ShapeData, 0x44u, 0LL);
      }
      else
      {
        v10 = CShape::Combine((__int64)v17, (__int64)a2, (__int64)v15, 0LL, *((_DWORD *)this + 40), &v19);
        v4 = v10;
        if ( v10 < 0 )
        {
  ...
  if ( v19 )
    (**(void (__fastcall ***)(CRectanglesShape *, __int64))v19)(v19, 1LL);
