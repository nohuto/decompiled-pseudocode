/*
 * XREFs of ?UpdateDrawListCache@CBrushRenderingGraph@@IEBAJPEAVCDrawingContext@@PEBVCDrawListBrush@@PEAUEffectStage@@IPEAVCDrawListCache@@@Z @ 0x18006C70C
 * Callers:
        ...
        struct CDrawListCache *a6)
{
  ...
  const struct CDrawListBrush *v40; // [rsp+48h] [rbp-B8h] BYREF
  ...
  _BYTE v50[40]; // [rsp+F0h] [rbp-10h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( v9 >= v12 )
    {
      ...
      v56 = 1065353216;
      v52 = a5;
      v47 = &CBrushRenderingEffectFactory::`vftable';
      v48 = v11;
      if ( v12 )
      {
        v13 = &v49;
      ...
      if ( DrawList < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DrawList, 0x4E5u, 0LL);
      }
      else
      {
    ...
    if ( !v22[52] )
    {
      ...
      v38 = *((_QWORD *)v22 + 8);
      std::unique_ptr<CDrawListBrush>::operator=<std::default_delete<CDrawListBrush>,0>(&v50[8 * v9 + 8], &v38);
      v28 = v51;
      if ( v51 <= ++v9 )
        v28 = v9;
      v51 = v28;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x491u, 0LL);
    ...
    if ( *((_QWORD *)v41 + 26) )
    {
      if ( v22[113] )
      {
        ...
        if ( !*((_BYTE *)v42 + 86) && !v22[116] )
        {
          ...
          if ( v34 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x4B3u, 0LL);
            v35 = v39;
            if ( v39 )
...
LABEL_26:
  ...
  if ( v18 >= 0 )
  {
    v38 = v37;
    v37 = 0LL;
    CBrushDrawListGenerator::AttachInput(v50, v9, &v38);
    std::unique_ptr<CDrawListBrush>::~unique_ptr<CDrawListBrush>(&v38);
    std::unique_ptr<CColorDrawListBrush>::~unique_ptr<CColorDrawListBrush>(&v37);
    ++v9;
    goto LABEL_26;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x4BBu, 0LL);
  if ( v37 )
    std::default_delete<CColorDrawListBrush>::operator()();
LABEL_10:
  v19 = v51;
