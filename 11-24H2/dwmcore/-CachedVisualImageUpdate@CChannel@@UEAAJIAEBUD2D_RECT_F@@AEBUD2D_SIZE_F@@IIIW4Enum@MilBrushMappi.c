/*
 * XREFs of ?CachedVisualImageUpdate@CChannel@@UEAAJIAEBUD2D_RECT_F@@AEBUD2D_SIZE_F@@IIIW4Enum@MilBrushMappingMode@@W44MilStretch@@@Z @ 0x18012E2A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a9)
{
  ...
  CChannel::CheckOptionalHandle(a1, a5, 128LL);
  CChannel::CheckOptionalHandle(a1, a6, 160LL);
  CChannel::CheckOptionalHandle(a1, a7, 184LL);
  v13 = *a4;
  v17 = 23;
