/*
 * XREFs of ?GetProperty@CSpriteVectorShape@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801AD6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::GetProperty(CSpriteVectorShape *this, int a2, struct CExpressionValue *a3)
{
  ...
  v4 = (void **)&CSpriteVectorShape::k_rgAnimDef;
  v5 = 0;
  while ( 1 )
  {
    if ( v4 == &CCachedWindowBackgroundTreatment::`vftable' )
      goto LABEL_3;
    v7 = *v4;
    if ( a2 == *(_DWORD *)*v4 )
      break;
