/*
 * XREFs of ?AddRealization@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAXPEAVISwapChainRealization@@@Z @ 0x1801A5C5C
 * Callers:
        ...
        struct ISwapChainRealization *a2)
{
  ...
  v4 = *(_QWORD *)a2;
  v7 = a2;
  v5 = *(__int64 (__fastcall **)(CMILRefCountImpl *))(v4 + 8);
