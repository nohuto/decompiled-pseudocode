/*
 * XREFs of ??4CpuClipStackState@CScopedClipStack@@QEAAAEAU01@$$QEAU01@@Z @ 0x180263FB8
 * Callers:
...
__int64 __fastcall CScopedClipStack::CpuClipStackState::operator=(__int64 a1, __int64 *a2)
{
  ...
  v2 = *((_BYTE *)a2 + 8);
  v4 = *a2;
  CShapePtr::~CShapePtr((CRectanglesShape **)a1);
  *(_QWORD *)a1 = v4;
  *(_BYTE *)(a1 + 8) = v2;
  *a2 = 0LL;
  *((_BYTE *)a2 + 8) = 0;
