/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1801BDD54
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(const unsigned __int16 *a1, unsigned __int16 a2)
{
  ...
  else
  {
    ...
    {
      v2 = (struct CCommonRegistryData::GpuId *)&unk_180330240;
      LODWORD(CCommonRegistryData::m_cShaderLinkingBlacklistedGpuIds) = 0;
      CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_180330240;
      v6 = 0;
    }
  }
  while ( 1 )
