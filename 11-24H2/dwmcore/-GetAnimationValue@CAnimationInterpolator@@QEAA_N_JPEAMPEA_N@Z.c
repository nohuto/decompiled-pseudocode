/*
 * XREFs of ?GetAnimationValue@CAnimationInterpolator@@QEAA_N_JPEAMPEA_N@Z @ 0x18007E6D0
 * Callers:
 ...
 *     ?GetAnimationTime@CAnimation@@AEBA_J_K_N_J0@Z @ 0x1801CD2F0 (-GetAnimationTime@CAnimation@@AEBA_J_K_N_J0@Z.c)
