/*
 * XREFs of ?Add@?$CArray@PEAVCInteraction@@V?$CArrayEqualHelper@PEAVCInteraction@@@@@@QEAAHAEBQEAVCInteraction@@@Z @ 0x180096958
 * Callers:
...
__int64 __fastcall CArray<CInteraction *,CArrayEqualHelper<CInteraction *>>::Add(__int64 a1, _QWORD *a2)
{
  ...
  v2 = dword_1803FA900;
  v4 = 1;
  v5 = dword_1803FA900 + 1;
  if ( dword_1803FA900 + 1 <= 0 )
    return 0;
  if ( dword_1803FA900 == dword_1803FA904 )
  {
    if ( dword_1803FA900 <= 0x3FFFFFFF && (unsigned __int64)dword_1803FA900 <= 0xFFFFFFFFFFFFFFFLL )
    {
      v6 = 2;
      if ( dword_1803FA904 >= 2 )
        v6 = dword_1803FA900 + (dword_1803FA900 >> 1);
      v7 = (char *)(dword_1803FA900
