/*
 * XREFs of ?ResetBuffers@CLegacyStereoSwapChain@@MEAAJXZ @ 0x1802CAC30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLegacyStereoSwapChain::ResetBuffers(CLegacyStereoSwapChain *this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v3, 0xD4u, 0LL);
  }
  else
  {
    v5 = *((_QWORD *)this + 37);
    if ( v5 )
    {
      ...
      v4 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v8, 0xDDu, 0LL);
      else
