/*
 * XREFs of ?GetOutline@CShape@@UEBAJPEAUID2D1GeometrySink@@@Z @ 0x1801D38E0
 * Callers:
...
__int64 __fastcall CShape::GetOutline(CShape *this, struct ID2D1GeometrySink *a2)
{
  ...
  __int64 v5; // r9
  __int64 (__fastcall *v6)(CRoundedRectangleShape *, const struct CMILMatrix *, struct ID2D1Geometry **); // rax
  int D2DGeometry; // eax
  __int64 v8; // r8
  unsigned int v9; // ebx
  int v10; // eax
  ...
  {
    v6 = *(__int64 (__fastcall **)(CRoundedRectangleShape *, const struct CMILMatrix *, struct ID2D1Geometry **))(v5 + 24);
    v16[0] = 0LL;
    if ( v6 == CRoundedRectangleShape::GetD2DGeometry )
      D2DGeometry = CRoundedRectangleShape::GetD2DGeometry(this, 0LL, v16);
    else
      D2DGeometry = v6(this, 0LL, v16);
    v9 = D2DGeometry;
    if ( D2DGeometry < 0 )
    {
