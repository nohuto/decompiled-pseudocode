/*
 * XREFs of ?DbgSaveOverlayStateInfoAfter@COverlayContext@@AEAAXXZ @ 0x18009877C
 * Callers:
...
void __fastcall COverlayContext::DbgSaveOverlayStateInfoAfter(COverlayContext *this)
{
  ...
  v1 = *((_QWORD *)this + 1585);
  v2 = 0;
  for ( i = (char *)this + 1776 * *((int *)this + 7570);
        v2 < 438261969 * (unsigned int)((*((_QWORD *)this + 1586) - v1) >> 3);
        v1 = *((_QWORD *)this + 1585) )
  {
    if ( v2 >= 2 )
      break;
    ...
    while ( v9 );
    *(_QWORD *)v7 = *(_QWORD *)v8;
    *(_QWORD *)&i[v5 + 20424] = &i[v5 + 20024];
    v11 = *(__int64 (**)(void))(**(_QWORD **)(v6 + *((_QWORD *)this + 1585) + 16) + 368LL);
    v12 = v11 == CGlobalCompositionSurfaceInfo::GetLastIndependentFlipState
        ? CGlobalCompositionSurfaceInfo::GetLastIndependentFlipState()
        : v11();
    *(_DWORD *)&i[v5 + 20436] = v12;
    ++v2;
  }
}
