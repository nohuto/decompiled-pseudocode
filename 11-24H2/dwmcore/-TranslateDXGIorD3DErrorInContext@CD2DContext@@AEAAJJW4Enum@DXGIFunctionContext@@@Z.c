/*
 * XREFs of ?TranslateDXGIorD3DErrorInContext@CD2DContext@@AEAAJJW4Enum@DXGIFunctionContext@@@Z @ 0x1800F58F4
 * Callers:
...
LABEL_8:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v4, 0LL, &v14) )
  {
    ...
    v4 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0xB31u, 0LL);
  }
