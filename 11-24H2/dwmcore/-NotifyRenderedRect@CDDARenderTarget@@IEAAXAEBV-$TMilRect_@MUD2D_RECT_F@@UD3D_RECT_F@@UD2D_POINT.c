/*
 * XREFs of ?NotifyRenderedRect@CDDARenderTarget@@IEAAXAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800983E4
 * Callers:
...
void __fastcall CDDARenderTarget::NotifyRenderedRect(__int64 a1, __int64 a2, double a3)
{
  __int64 v4; // rdi
  __int64 v5; // rcx
  ...
  v8 = 0LL;
  CMILMatrix::Transform2DBoundsHelper<0>(a1 + 268, a2, &v8);
