/*
 * XREFs of ?HasSubtreeSurface@CVisual@@QEBA_NXZ @ 0x1801361FC
 * Callers:
 ...
 * Callees:
 *     ?GetTreeEffect@CLayerVisual@@UEBAPEAVCTreeEffect@@XZ @ 0x180136240 (-GetTreeEffect@CLayerVisual@@UEBAPEAVCTreeEffect@@XZ.c)
