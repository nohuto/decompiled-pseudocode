/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x180253370
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1801A71E8 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 ...
 *     ?create@?$semaphore_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEAAJJJPEBGKPEAU_SECURITY_ATTRIBUTES@@PEA_N@Z @ 0x180255234 (-create@-$semaphore_t@V-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@_E$1-CloseHandle@details.c)
 */
        ...
        unsigned __int64 a4)
{
  ...
  StringCchCopyW(v13, 0x104uLL, a2);
