/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1802716C8
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(__int64 a1, int a2, __m128i *a3)
{
  __int64 v5; // rbx
  __int64 v6; // rcx
  int v7; // ebx
  ...
  if ( v14 == *(_QWORD *)(a1 + 8) )
  {
    v7 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(v6, 69, a3, &v16);
    if ( v7 < 0 )
    {
      v8 = 37LL;
LABEL_4:
  ...
  {
    v10 = *(_DWORD *)(v14 + 20);
    if ( (unsigned int)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::GetDataType(v6, v10) != 69 )
    {
      v7 = -2147024809;
      v8 = 48LL;
      goto LABEL_4;
