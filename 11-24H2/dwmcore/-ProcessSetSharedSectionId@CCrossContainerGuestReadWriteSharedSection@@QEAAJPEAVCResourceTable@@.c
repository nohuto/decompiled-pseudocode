/*
 * XREFs of ?ProcessSetSharedSectionId@CCrossContainerGuestReadWriteSharedSection@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CROSSCONTAINERGUESTREADWRITESHAREDSECTION_SETSHAREDSECTIONID@@@Z @ 0x180298F3C
 * Callers:
