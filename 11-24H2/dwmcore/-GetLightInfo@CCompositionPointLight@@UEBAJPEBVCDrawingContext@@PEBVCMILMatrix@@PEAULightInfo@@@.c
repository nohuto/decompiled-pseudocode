/*
 * XREFs of ?GetLightInfo@CCompositionPointLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x1802980A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 2;
  ...
  {
    *((_OWORD *)a4 + 5) = *(_OWORD *)CCompositionLight::CalcEyePointOrVector(v10, (__int64)v14, *((_QWORD *)this + 32));
