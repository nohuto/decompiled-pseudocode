/*
 * XREFs of ??$move_backward_uninitialized@V?$basic_iterator@D@detail@@V?$checked_array_iterator@PEAD@stdext@@@detail@@YAXV?$basic_iterator@D@0@0V?$checked_array_iterator@PEAD@stdext@@@Z @ 0x1801BEE54
 * Callers:
