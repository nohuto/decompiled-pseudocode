/*
 * XREFs of ?GetProperty@CRadialGradientBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1802A30A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRadialGradientBrush::GetProperty(CRadialGradientBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, v5, -2147024809, 0x21u, (void *)(v5 & v9));
  }
  return v3;
}
