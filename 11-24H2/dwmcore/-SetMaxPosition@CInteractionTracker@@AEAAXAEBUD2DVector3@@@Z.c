/*
 * XREFs of ?SetMaxPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x1800E36A8
 * Callers:
 ...
 *     ?ProcessSetMaxPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMAXPOSITION@@@Z @ 0x18029DA1C (-ProcessSetMaxPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTR.c)
 * Callees:
...
void __fastcall CInteractionTracker::SetMaxPosition(CInteractionTracker *this, const struct D2DVector3 *a2)
{
  ...
  v4 = *((_QWORD *)this + 14) - *(_QWORD *)a2;
  if ( !v4 )
    v4 = *((unsigned int *)this + 30) - (unsigned __int64)*((unsigned int *)a2 + 2);
  if ( v4 )
  {
    LODWORD(v5) = COERCE_UNSIGNED_INT(*((float *)this + 28) - *(float *)a2) & _xmm;
    v6 = v5 > 0.0000011920929;
    v7 = 0.0000011920929 == v5;
    v8 = *((float *)this + 29) - *((float *)a2 + 1);
    v9 = (v6 || v7) + 4;
    if ( COERCE_FLOAT(LODWORD(v8) & _xmm) >= 0.0000011920929 )
      v9 |= 2u;
    v7 = (*((_BYTE *)this + 541) & 8) == 0;
    *((_QWORD *)this + 14) = *(_QWORD *)a2;
    *((_DWORD *)this + 30) = *((_DWORD *)a2 + 2);
    if ( v7 )
      CInteractionTracker::EnsurePositionIsLessThanOrEqualToMax((__int64)this, v9);
    v10 = fminf(*((float *)this + 26), *((float *)this + 29));
    v12[0] = fminf(*((float *)this + 25), *((float *)this + 28));
    v11 = fminf(*((float *)this + 27), *((float *)this + 30));
    *(float *)&v12[1] = v10;
    *(float *)&v12[2] = v11;
