/*
 * XREFs of ?_Change_array@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEAAXQEAV?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@2@_K1@Z @ 0x1802673C0
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)&xmmword_1803FA8E0 = a2 + 8 * a3;
  result = a2 + 8 * a4;
  *((_QWORD *)&xmmword_1803FA8E0 + 1) = result;
  return result;
}
