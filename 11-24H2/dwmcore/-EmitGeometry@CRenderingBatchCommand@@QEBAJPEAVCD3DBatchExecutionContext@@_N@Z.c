/*
 * XREFs of ?EmitGeometry@CRenderingBatchCommand@@QEBAJPEAVCD3DBatchExecutionContext@@_N@Z @ 0x1801072D0
 * Callers:
...
LABEL_15:
      ...
      else
      {
        ...
        v67 = v66;
        if ( v66 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v66, 0x9F1u, 0LL);
      }
      if ( !*(_DWORD *)(v63 + 1112)
...
LABEL_53:
          ...
          if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v67, 0, &v174) )
          {
            ...
            v67 = v107;
            if ( v107 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v107, 0xB31u, 0LL);
          }
          v18 = v67;
          v68 = v67;
          if ( v67 >= 0 )
...
LABEL_119:
    ...
    else
    {
      ...
      v99 = v98;
      if ( v98 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v98, 0x9F1u, 0LL);
    }
    if ( !*(_DWORD *)(v95 + 1112)
...
LABEL_95:
        ...
        if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v99, 0, &v174) )
        {
          ...
          if ( v108 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v108, 0xB31u, v100);
            v100 = 0LL;
          }
        }
        v68 = v99;
