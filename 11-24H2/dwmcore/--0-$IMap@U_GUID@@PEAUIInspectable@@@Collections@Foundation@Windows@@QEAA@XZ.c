/*
 * XREFs of ??0?$IMap@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1802C0D30
 * Callers:
 ...
 * Callees:
 *     ??0?$IMap_impl@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1802C0D90 (--0-$IMap_impl@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
