/*
 * XREFs of ?IntersectWithRect@CRectanglesShape@@QEBAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAPEAVCShape@@@Z @ 0x1801730FC
 * Callers:
...
__int64 __fastcall CRectanglesShape::IntersectWithRect(__int64 a1, float *a2, CRectanglesShape **a3)
{
  ...
  v5 = 0;
  *a3 = 0LL;
  v8 = (CRectanglesShape *)CThreadLocalObjectCache<CRectanglesShape,CRectanglesShape>::Alloc(a1, a2);
  v9 = v8;
  if ( v8 )
  {
    *((_QWORD *)v8 + 1) = 0LL;
