/*
 * XREFs of ??0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z @ 0x1801BE7E0
 * Callers:
 ...
 *     ?Reset@CBatchOptimizer@@AEAAXXZ @ 0x1801BE870 (-Reset@CBatchOptimizer@@AEAAXXZ.c)
 *     ??0SharedStateLayer@@QEAA@XZ @ 0x18020ADA0 (--0SharedStateLayer@@QEAA@XZ.c)
 */
