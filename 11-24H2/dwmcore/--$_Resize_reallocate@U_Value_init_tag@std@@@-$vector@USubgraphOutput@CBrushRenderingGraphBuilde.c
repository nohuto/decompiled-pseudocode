/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@USubgraphOutput@CBrushRenderingGraphBuilder@@V?$allocator@USubgraphOutput@CBrushRenderingGraphBuilder@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x180201658
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  return std::vector<CBrushRenderingGraphBuilder::SubgraphOutput>::_Change_array(a1, v10, a2, v2);
}
