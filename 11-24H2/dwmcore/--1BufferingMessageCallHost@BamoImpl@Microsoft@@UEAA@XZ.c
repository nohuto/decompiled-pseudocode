/*
 * XREFs of ??1BufferingMessageCallHost@BamoImpl@Microsoft@@UEAA@XZ @ 0x18026DBB8
 * Callers:
 ...
 *     ?_Tidy@?$vector@UItemIdParameterIndex@BamoImpl@Microsoft@@V?$allocator@UItemIdParameterIndex@BamoImpl@Microsoft@@@std@@@std@@AEAAXXZ @ 0x180270314 (-_Tidy@-$vector@UItemIdParameterIndex@BamoImpl@Microsoft@@V-$allocator@UItemIdParameterIndex@Bam.c)
 */
