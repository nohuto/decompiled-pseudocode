/*
 * XREFs of ?DisableDirectFlip@CGlobalCompositionSurfaceInfo@@UEAAJ_K_N@Z @ 0x180291440
 * Callers:
 *     <none>
 * Callees:
        ...
        char a3)
{
  ...
  {
    v3 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x160u, 0LL);
  }
  return v3;
}
