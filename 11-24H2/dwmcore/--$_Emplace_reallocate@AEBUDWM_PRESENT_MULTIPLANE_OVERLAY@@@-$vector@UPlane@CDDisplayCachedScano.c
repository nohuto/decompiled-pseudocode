/*
 * XREFs of ??$_Emplace_reallocate@AEBUDWM_PRESENT_MULTIPLANE_OVERLAY@@@?$vector@UPlane@CDDisplayCachedScanout@@V?$allocator@UPlane@CDDisplayCachedScanout@@@std@@@std@@AEAAPEAUPlane@CDDisplayCachedScanout@@QEAU23@AEBUDWM_PRESENT_MULTIPLANE_OVERLAY@@@Z @ 0x180068690
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0FI@@std@@YA_K_K@Z @ 0x1802461AC (--$_Get_size_of_n@$0FI@@std@@YA_K_K@Z.c)
 */
