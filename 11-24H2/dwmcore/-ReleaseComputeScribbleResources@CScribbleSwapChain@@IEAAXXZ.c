/*
 * XREFs of ?ReleaseComputeScribbleResources@CScribbleSwapChain@@IEAAXXZ @ 0x18020F1AC
 * Callers:
 ...
 *     ?CleanupComputeScribble@CDDisplaySwapChain@@UEAAX_N@Z @ 0x1802BE980 (-CleanupComputeScribble@CDDisplaySwapChain@@UEAAX_N@Z.c)
 *     ??1CLegacySwapChain@@MEAA@XZ @ 0x1802C99D8 (--1CLegacySwapChain@@MEAA@XZ.c)
 *     ?CleanupComputeScribble@CLegacySwapChain@@UEAAX_N@Z @ 0x1802C9BD0 (-CleanupComputeScribble@CLegacySwapChain@@UEAAX_N@Z.c)
