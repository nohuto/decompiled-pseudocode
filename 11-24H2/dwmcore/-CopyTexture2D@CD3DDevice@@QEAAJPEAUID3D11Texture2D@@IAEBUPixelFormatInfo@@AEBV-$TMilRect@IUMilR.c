/*
 * XREFs of ?CopyTexture2D@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@IAEBUPixelFormatInfo@@AEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVIBitmapDest@@HH@Z @ 0x1800238F4
 * Callers:
 ...
 * Callees:
 *     ?GetPixelFormatInfo@CBitmapLock@@UEBA?AUPixelFormatInfo@@XZ @ 0x180023810 (-GetPixelFormatInfo@CBitmapLock@@UEBA-AUPixelFormatInfo@@XZ.c)
...
LABEL_35:
    v37 = v19;
LABEL_36:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v37, v44, 0LL);
    goto LABEL_27;
  }
    ...
    else
    {
      ...
      *(_OWORD *)v55 = 0LL;
      ...
      if ( v18 >= 0 )
      {
        ...
        if ( v25 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v25, 0xA96u, 0LL);
          v10 = v45;
LABEL_26:
...
LABEL_7:
        ...
        if ( v27 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v27, 0xAB6u, 0LL);
        }
        else
        {
          ...
          {
            v48 = 0LL;
            wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset(&v48);
            v10 = v45;
            v42 = CFormatConverter::HrConvertBitmap(v45, (const struct PixelFormatInfo *)v58, &v48);
            v19 = v42;
            if ( v42 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v42, 0xAC1u, 0LL);
          ...
          if ( DataPointer < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, DataPointer, 0xAC8u, 0LL);
          }
          else
          {
            v47 = 0;
            ...
            if ( Stride >= 0 )
            {
              ...
              v19 = v34;
              if ( v34 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v34, 0xADAu, 0LL);
LABEL_25:
              if ( !(_BYTE)v52 )
                goto LABEL_27;
              goto LABEL_26;
            }
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, Stride, 0xACBu, 0LL);
          }
        }
        v10 = v45;
        goto LABEL_25;
  ...
  if ( v38 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v38, 0xA9Eu, 0LL);
    if ( v51 )
  ...
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032B080, 0xAu, v41, 0xAB0u, 0LL);
...
LABEL_27:
  v35 = CD3DDevice::TranslateDXGIorD3DErrorInContext(a1, v19, 0LL);
  if ( v49 )
    (*(void (__fastcall **)(struct IBitmapLock *))(*(_QWORD *)v49 + 16LL))(v49);
  if ( v50 )
