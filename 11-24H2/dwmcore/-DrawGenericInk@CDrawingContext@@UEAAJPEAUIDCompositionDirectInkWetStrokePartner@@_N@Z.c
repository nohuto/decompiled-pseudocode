/*
 * XREFs of ?DrawGenericInk@CDrawingContext@@UEAAJPEAUIDCompositionDirectInkWetStrokePartner@@_N@Z @ 0x18020D310
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( CScopedClipStack::HasDeferredD2DLayers((CDrawingContext *)((char *)this + 728)) )
  {
    ...
    v21 = 0;
    v19 = v18;
    v7 = CDrawingContext::CTryIgnoreCpuClippingScope::Enter(&v17, (__int64)v3, (__int64)&v19);
    v8 = v7;
    if ( v7 < 0 )
    {
      v16 = 793;
