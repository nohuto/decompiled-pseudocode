...
__int64 __fastcall std::move_backward<std::move_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy> *>,stdext::checked_array_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy> *>>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        _QWORD *a4)
{
  ...
  while ( a2 != v7 )
  {
    v8 -= 8LL;
    v7 -= 8LL;
    wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy>::operator=(v8, v7);
  }
  result = a1;
  a4[2] = (v8 - *a4) >> 3;
  v10 = a4[2];
