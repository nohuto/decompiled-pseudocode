/*
 * XREFs of ?ConvertGlobalMotionToLocalMotion@CInteractionProcessor@@AEAA?AUD2DVector3@@AEBUInteractionMotion@@AEBUD2DMatrix@@PEAU4@2@Z @ 0x180128888
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U1@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3333AEBU?$_tlgWrapperByVal@$03@@444444444444444444444444@Z @ 0x180126FB0 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U1@U1@U1@U-$_tlgWrapperByVal@$03@@U2@U2@U2@U2@_ea_180126FB0.c)
        ...
        struct D2DMatrix *a6)
{
  ...
  v7 = xmmword_1803F9850;
  v9 = xmmword_1803F9860;
  v10 = xmmword_1803F9870;
  *a5 = CMILMatrix::Identity;
  a5[1] = v7;
  a5[2] = v9;
  a5[3] = v10;
  v11 = xmmword_1803F9860;
  v12 = xmmword_1803F9870;
  v13 = xmmword_1803F9850;
  ...
  *(float *)(a2 + 8) = (float)(1.0 / v15) - 1.0;
  ...
  HIDWORD(v29) = HIDWORD(xmmword_1803F9850);
  *(_OWORD *)((char *)&v30.m256i_u64[1] + 4) = *(__int128 *)((char *)&xmmword_1803F9860 + 12);
  v30.m256i_i32[7] = HIDWORD(xmmword_1803F9870);
