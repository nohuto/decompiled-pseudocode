/*
 * XREFs of ?CalculateCasterBounds@CProjectedShadowCaster@@QEBA?AV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEBVCVisualTree@@PEA_N@Z @ 0x180033910
 * Callers:
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  while ( v16 )
  {
    ...
    if ( v16 != *((CVisual **)a3 + 9) )
    {
      ...
      {
        v22 = (struct _LIST_ENTRY *)((char *)v16 + 328);
LABEL_11:
        if ( v22 && BYTE4(v22->Blink) && v5 )
          break;
      }
      else
      {
