/*
 * XREFs of ?UnTransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUInteractionOutput@@K_NPEAU2@@Z @ 0x180126ECC
 * Callers:
 ...
 * Callees:
 *     TransformTranslateDelta @ 0x18012541C (TransformTranslateDelta.c)
