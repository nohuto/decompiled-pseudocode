/*
 * XREFs of ?CalculatePositionAnimationDuration@CInteractionTracker@@AEAAMAEBUD2DVector3@@@Z @ 0x1800E6A50
 * Callers:
        ...
        const struct D2DVector3 *a2)
{
  ...
  *(float *)&v15 = sqrtf_0(
                     (float)((float)((float)(*(float *)&v15 - *((float *)this + 23))
                                   * (float)(*(float *)&v15 - *((float *)this + 23)))
                           + (float)(v13 * v13))
                   + (float)((float)(*(float *)(v16 + 8) - *((float *)this + 24))
                           * (float)(*(float *)(v16 + 8) - *((float *)this + 24))));
  return fmaxf(
           *(float *)&v15
