/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VILegacyRemotingSwapChain@@VCMilObjectDeleter@@@@IEAAKXZ @ 0x1802C70F4
 * Callers:
 ...
 *     ?Release@CLegacyRemotingSwapChain@@UEAAKXZ @ 0x1802C73F0 (-Release@CLegacyRemotingSwapChain@@UEAAKXZ.c)
 * Callees:
