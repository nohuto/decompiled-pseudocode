/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x180264314
 * Callers:
 ...
 *     ?CurrentRedrawRegionColor@CComposition@@QEAA?AU_D3DCOLORVALUE@@XZ @ 0x18025A97C (-CurrentRedrawRegionColor@CComposition@@QEAA-AU_D3DCOLORVALUE@@XZ.c)
...
__int64 __fastcall CDrawingContext::DrawDirtyRegionVisualizationForCurrentNode(__m128 *this)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(unsigned __int64))(*(_QWORD *)this[496].m128_u64[1] + 184LL))(this[496].m128_u64[1]) )
  {
    ...
    *((float *)&X + 3) = v16;
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x192Au, 0LL);
    ...
    else
    {
            ...
            for ( i = 0; (unsigned __int64)i < v24[4]; ++i )
            {
              ...
              *(__m128i *)&v34[1] = _mm_loadu_si128((const __m128i *)(*(_QWORD *)(v26 + 24) + 104LL));
              if ( _mm_shuffle_ps(*(__m128 *)&v34[1], *(__m128 *)&v34[1], 255).m128_f32[0] > 0.0 )
              {
                ...
                if ( v28 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v28, 0x195Fu, 0LL);
      ...
      else
      {
        ...
        *((_QWORD *)&X + 1) = v31;
        ...
        v2 = v20;
        if ( v20 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0x1936u, 0LL);
      }
LABEL_37:
      DynArrayImpl<0>::~DynArrayImpl<0>((__int64)&v31);
