/*
 * XREFs of ?SetD2DEffectProperties@CShadowEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1802AA400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CShadowEffect::SetD2DEffectProperties(CShadowEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x13u, 0LL);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x18u, 0LL);
    }
    else
    {
      ...
      v5 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x1Du, 0LL);
    }
  }
  return v5;
}
