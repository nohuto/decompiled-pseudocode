/*
 * XREFs of ?SetStateOnDevice@CProjectedShadowRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x1801B4E10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetShaderLinkingBody@ProjectedShadowRenderingShaderBody@@YA?AUShaderLinkingBody@@W4Enum@CommonRenderingShaderBody@@W4D3DShaderProfileVersion@@@Z @ 0x18024A88C (-GetShaderLinkingBody@ProjectedShadowRenderingShaderBody@@YA-AUShaderLinkingBody@@W4Enum@CommonR.c)
  ...
  *(_QWORD *)v36 = this;
  ...
  while ( 1 )
  {
    ...
    if ( *((_QWORD *)v18 + 1) )
    {
      ...
      ShaderResourceView = CD3DDevice::GetD3DSamplerStateNoRef(
                             (__int64)v5,
                             (unsigned __int8 *)v36,
                             (_QWORD *)&v43[-1] + v16);
      v20 = ShaderResourceView;
