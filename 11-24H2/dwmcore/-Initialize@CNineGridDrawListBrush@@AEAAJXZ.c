/*
 * XREFs of ?Initialize@CNineGridDrawListBrush@@AEAAJXZ @ 0x180150034
 * Callers:
 ...
 *     ?IsEmpty@CoordMap@@QEBA_NXZ @ 0x1801510A4 (-IsEmpty@CoordMap@@QEBA_NXZ.c)
...
__int64 __fastcall CNineGridDrawListBrush::Initialize(CNineGridDrawListBrush *this)
{
  ...
  *((_BYTE *)this + 52) = v3;
  ...
  v4 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v2 + 8LL);
  if ( v4 == CSurfaceDrawListBrush::IsOfType )
    v5 = CSurfaceDrawListBrush::IsOfType(v2, 2);
  else
    v5 = v4(v2, 2);
  v7 = *((_QWORD *)this + 9);
  if ( v5 )
