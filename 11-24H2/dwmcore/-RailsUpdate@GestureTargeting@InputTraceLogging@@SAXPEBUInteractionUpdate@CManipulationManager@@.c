/*
 * XREFs of ?RailsUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1801B74B0
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  void *InputHandle; // [rsp+B0h] [rbp+17h] BYREF
  ...
  __int64 updated; // [rsp+E8h] [rbp+4Fh] BYREF
