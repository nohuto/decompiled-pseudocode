/*
 * XREFs of ?EnsureShapeRectAndTransform@CCursorState@@AEAAX_N@Z @ 0x1802B2BB8
 * Callers:
...
void __fastcall CCursorState::EnsureShapeRectAndTransform(CCursorState *this, char a2)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  int *v5; // rcx
