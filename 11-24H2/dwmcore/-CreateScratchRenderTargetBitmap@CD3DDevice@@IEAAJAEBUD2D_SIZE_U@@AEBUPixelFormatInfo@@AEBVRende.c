/*
 * XREFs of ?CreateScratchRenderTargetBitmap@CD3DDevice@@IEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x18005AC84
 * Callers:
        ...
        struct CScratchRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  ...
  {
    v13 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, -2003304307, 0x639u, 0LL);
  }
  else
  {
    v33 = *a2;
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v12, 0x648u, 0LL);
      v9 = v24;
    }
    else
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v18, 0x659u, 0LL);
        v10 = v23;
      }
      else
      {
        ...
        v13 = v19;
        if ( v19 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18032AFF8, 2u, v19, 0x65Du, 0LL);
      }
    }
  }
