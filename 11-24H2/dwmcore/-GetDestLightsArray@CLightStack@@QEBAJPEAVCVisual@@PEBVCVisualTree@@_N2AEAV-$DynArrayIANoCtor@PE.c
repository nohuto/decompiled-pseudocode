/*
 * XREFs of ?GetDestLightsArray@CLightStack@@QEBAJPEAVCVisual@@PEBVCVisualTree@@_N2AEAV?$DynArrayIANoCtor@PEAVCCompositionLight@@$02$0A@@@PEA_N@Z @ 0x18014B4AC
 * Callers:
...
LABEL_41:
          ...
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v28, 0x11Au, 0LL);
          return v24;
        }
        if ( v23 > *(_DWORD *)(v11 + 20) )
        {
          v28 = DynArrayImpl<0>::AddMultipleAndSet(v11, 8, 1, &v30);
          if ( v28 < 0 )
          {
            v29 = 192;
            goto LABEL_41;
