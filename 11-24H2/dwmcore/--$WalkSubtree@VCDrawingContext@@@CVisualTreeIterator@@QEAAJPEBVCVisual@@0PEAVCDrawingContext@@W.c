/*
 * XREFs of ??$WalkSubtree@VCDrawingContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@0PEAVCDrawingContext@@W4WalkReason@@@Z @ 0x1800831A0
 * Callers:
...
LABEL_132:
          ...
          v88 = (CTreeData *)HeapAlloc(ProcessHeap, 0, 0x188uLL);
          if ( !v88 )
