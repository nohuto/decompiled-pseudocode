        ...
        void **a3)
{
  ...
  v13 = (void **)std::_Allocate<16,std::_Default_allocate_traits,0>(size_of);
  v14 = v13;
  v15 = &v13[v5];
  *v15 = *a3;
  *a3 = 0LL;
