/*
 * XREFs of ?PopRenderTargetInternal@CDrawingContext@@AEAAJ_N@Z @ 0x180056180
 * Callers:
...
__int64 __fastcall CDrawingContext::PopRenderTargetInternal(CDrawingContext *this, __int64 a2, __int64 a3)
{
  ...
  _BYTE *v17; // rcx
  bool (__fastcall *v18)(CDeviceTextureTarget *__hidden); // rax
  char v19; // al
  int v20; // eax
  int v21; // esi
  __int64 v22; // rcx
  ...
  *(_DWORD *)(v4 + 352) = v11;
  ...
  else
  {
    if ( *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 32LL) - *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 24LL) == 8LL
      && ((v17 = *(_BYTE **)(v10 + 24),
           v18 = *(bool (__fastcall **)(CDeviceTextureTarget *__hidden))(*(_QWORD *)v17 + 128LL),
