/*
 * XREFs of ?CanDiscardCornerRect@COcclusionContext@@AEBA_NAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@H_N@Z @ 0x18027AC94
 * Callers:
 *     ?OptimizeCornerRects@COcclusionContext@@QEBAXPEAVCCornerRects@@H@Z @ 0x18027B004 (-OptimizeCornerRects@COcclusionContext@@QEBAXPEAVCCornerRects@@H@Z.c)
 * Callees:
