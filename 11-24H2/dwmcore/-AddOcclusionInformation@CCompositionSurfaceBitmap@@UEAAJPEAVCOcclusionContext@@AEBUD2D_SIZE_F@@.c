/*
 * XREFs of ?AddOcclusionInformation@CCompositionSurfaceBitmap@@UEAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@@Z @ 0x180236BA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D2D_SIZE_F *a3)
{
         ...
         && (*(unsigned __int8 (__fastcall **)(char *))(*((_QWORD *)this + 9) + 32LL))((char *)this + 72) )
  {
    ...
    if ( *((_BYTE *)a2 + 1565) )
    {
      if ( *((_QWORD *)a2 + 226) != *((_QWORD *)a2 + 225) && CCompositionSurfaceBitmap::IsSwapChain(this) )
      {
        v10 = *((_QWORD *)this + 9);
        v16 = 0LL;
        v19 = 0;
