/*
 * XREFs of ?HDRConvert@CD3DDevice@@QEAAJPEAUID3D11ShaderResourceView@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@3PEAUID3D11RenderTargetView@@1W4DXGI_COLOR_SPACE_TYPE@@M_NPEAUtagRECT@@@Z @ 0x180065B20
 * Callers:
        ...
        __int128 *a13)
{
  ...
  if ( CompositingPixelShaderNoRef >= 0 )
  {
    ...
    *((float *)&v39 + 3) = (float)v25;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x941u, 0LL);
    }
    else
    {
      v28 = *(_QWORD *)(a1 + 1536);
      ...
      v20 = v29;
      if ( v29 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x94Eu, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CompositingPixelShaderNoRef, 0x93Bu, 0LL);
  }
  return v20;
}
