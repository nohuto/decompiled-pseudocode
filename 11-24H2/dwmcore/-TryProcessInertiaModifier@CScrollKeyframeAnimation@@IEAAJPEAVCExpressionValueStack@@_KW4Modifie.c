/*
 * XREFs of ?TryProcessInertiaModifier@CScrollKeyframeAnimation@@IEAAJPEAVCExpressionValueStack@@_KW4ModifierType@1@W4ScrollAxis@@PEAVCExpressionValue@@@Z @ 0x180223834
 * Callers:
  ...
  if ( (_DWORD)a4 )
  {
    if ( (_DWORD)a4 != 1 )
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        a4);
    v6 = *(CConditionalExpression **)(*(_QWORD *)(a1 + 544) + 8LL * a5 + 368);
  }
  else
  {
    v6 = *(CConditionalExpression **)(*(_QWORD *)(a1 + 544) + 8LL * a5 + 384);
  }
  LOBYTE(v13) = 0;
  if ( v6 )
  {
