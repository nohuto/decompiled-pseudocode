/*
 * XREFs of ?InteractionConfigurationUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x18008EAA8
 * Callers:
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
  ...
  __int64 v26; // [rsp+B8h] [rbp+Fh] BYREF
  ...
  __int64 v32[3]; // [rsp+E8h] [rbp+3Fh] BYREF
  ...
  switch ( *((_DWORD *)a1 + 11) )
  {
    ...
    default:
      ...
      if ( *(_DWORD *)v2 > 4u && (unsigned __int8)tlgKeywordOn(v2, 2048LL) )
      {
        ...
        v35 = v4;
        updated = InputTraceLogging::InteractionConfigurationUpdateTypeToString(v5, v3, 0LL);
        ...
        v30 = v18;
        v31 = v18;
        v32[0] = InputTraceLogging::MidManipulationUpdateTypeToString(v17);
