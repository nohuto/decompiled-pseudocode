/*
 * XREFs of ?ApplyRenderTarget@CExternalLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x1800FC014
 * Callers:
...
__int64 __fastcall CExternalLayer::ApplyRenderTarget(CExternalLayer *this, struct CDrawingContext *a2)
{
  ...
  __int64 v8; // rbx
  __int64 v9; // r14
  __int64 (__fastcall *v10)(CMILRefCountImpl *); // rax
  ...
  if ( v8 )
  {
    v10 = *(__int64 (__fastcall **)(CMILRefCountImpl *))(*(_QWORD *)v8 + 8LL);
  ...
  if ( IsValid < 0 )
  {
    ...
    v19 = (volatile signed __int32 **)((char *)a2 + 40);
LABEL_44:
    wil::com_ptr_t<CCompositionEnvironmentLight,wil::err_returncode_policy>::operator=((__int64 *)a2 + 4, v8);
    if ( *(_QWORD *)v7 )
  ...
  *(_QWORD *)v7 = v9;
  ...
  if ( !*((_QWORD *)a2 + 5) )
  {
    ...
    if ( (char *)v20 == (char *)IDeviceResourceMethodsT<CD2DBitmap,IDeviceTextureTarget>::GetDevice )
      ...
      Device = v20(v9);
    v22 = *v19;
    *v19 = (volatile signed __int32 *)Device;
    if ( Device )
      CMILRefCountImpl::AddReference((CMILRefCountImpl *)(Device + 8));
    if ( v22 )
      CD3DDevice::Release((CD3DDevice *)v22);
  }
  v23 = *(_QWORD *)v7;
  ...
  *((_QWORD *)a2 + 9) = *(_QWORD *)(RenderTargetInfo + 16);
  ...
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v28, 0x85u, 0LL);
    goto LABEL_44;
  }
  *((_DWORD *)a2 + 1995) = 0;
  *((_BYTE *)a2 + 7984) = 0;
  ...
  v30 = *(_QWORD *)v7;
  detail::vector_facade<CScopedClipStack::ClippingScopeState,detail::buffer_impl<CScopedClipStack::ClippingScopeState,10,1,detail::liberal_expansion_policy>>::emplace_back<>((_QWORD *)a2 + 93);
  v31 = *((_QWORD *)a2 + 94);
  *(_QWORD *)(v31 - 192) = v30;
  v17 = 0;
  *(_BYTE *)(v31 - 8) = 0;
...
LABEL_24:
  ...
  if ( (v17 & 0x80000000) != 0 )
  {
    ...
    v45 = 100;
LABEL_40:
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v42, v45, 0LL);
    return v17;
  }
  ...
  *((float *)&v47 + 3) = (float)v46[1];
  ...
  if ( v37 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v37, 0x7Au, 0LL);
