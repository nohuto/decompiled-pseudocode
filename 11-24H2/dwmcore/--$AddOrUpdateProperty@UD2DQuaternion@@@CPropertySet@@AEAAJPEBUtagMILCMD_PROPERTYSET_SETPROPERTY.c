/*
 * XREFs of ??$AddOrUpdateProperty@UD2DQuaternion@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DQuaternion@@@Z @ 0x1801854B0
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DQuaternion>(CPropertySet *a1, __int64 a2, _OWORD *a3)
{
  ...
  if ( *(_BYTE *)(a2 + 20) )
  {
    updated = CPropertySet::AddProperty<D2DQuaternion>(
                a1,
                *(_DWORD *)(a2 + 8),
                *(_DWORD *)(a2 + 12),
                *(_DWORD *)(a2 + 16),
