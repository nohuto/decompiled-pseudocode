/*
 * XREFs of ?SetProperty@CRadialGradientBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1802A3220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRadialGradientBrush::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  v9[0] = 3LL;
  v9[1] = &CRadialGradientBrush::k_rgAnimDef;
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x3Au, 0LL);
  }
  return v7;
}
