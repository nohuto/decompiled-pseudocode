/*
 * XREFs of ??Y?$checked_array_iterator@PEAG@stdext@@QEAAAEAV01@_J@Z @ 0x1801CE380
 * Callers:
...
_QWORD *__fastcall stdext::checked_array_iterator<unsigned short *>::operator+=(_QWORD *a1, __int64 a2)
{
  _QWORD *v2; // r8
