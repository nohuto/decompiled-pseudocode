/*
 * XREFs of ?CreateDeviceTextureTarget@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@M_NPEAPEAVIDeviceTextureTarget@@@Z @ 0x1801B6E54
 * Callers:
        ...
        unsigned __int64 *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( *(_DWORD *)(a1 + 1112) )
  {
    ...
    v17 = 1246;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v12, v17, 0LL);
    return v12;
  }
  ...
  v12 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032AFF8, 2u, v16, 0x4F9u, 0LL);
  return v12;
}
