/*
 * XREFs of ?SortMonitorTargets@CRenderTargetManager@@AEAAXPEAV?$vector_facade@VCSortedMonitorTarget@CRenderTargetManager@@V?$buffer_impl@VCSortedMonitorTarget@CRenderTargetManager@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@@Z @ 0x180104410
 * Callers:
...
LABEL_23:
        ...
        *(_QWORD *)(v11 + 8 * v34) = v10;
        ...
        {
          if ( CTargetStats::IsOccluded((CDDisplayRenderTarget *)((char *)v10 + 32968)) )
            TargetTime = 0LL;
          else
            TargetTime = CTargetStats::GetTargetTime((CDDisplayRenderTarget *)((char *)v10 + 32968), v67, QuadPart);
        }
