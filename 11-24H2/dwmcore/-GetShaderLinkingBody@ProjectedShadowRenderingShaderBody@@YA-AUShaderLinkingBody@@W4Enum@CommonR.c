/*
 * XREFs of ?GetShaderLinkingBody@ProjectedShadowRenderingShaderBody@@YA?AUShaderLinkingBody@@W4Enum@CommonRenderingShaderBody@@W4D3DShaderProfileVersion@@@Z @ 0x18024A88C
 * Callers:
 ...
 * Callees:
 *     ?GetInputs@CommonRenderingShaderBody@@YA?AV?$span@$$CBW4ShaderLinkingArgument@@$0?0@gsl@@W4Enum@1@@Z @ 0x18021D41C (-GetInputs@CommonRenderingShaderBody@@YA-AV-$span@$$CBW4ShaderLinkingArgument@@$0-0@gsl@@W4Enum@.c)
 */
