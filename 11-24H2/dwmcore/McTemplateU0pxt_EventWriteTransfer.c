/*
 * XREFs of McTemplateU0pxt_EventWriteTransfer @ 0x18024A764
 * Callers:
...
ULONG McTemplateU0pxt_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  return McGenEventWrite_EventWriteTransfer(
           ...
           &EVTDESC_COMPUTESCRIBBLE_SOURCEUPDATE,
           v11,
           4u,
           &v3);
}
