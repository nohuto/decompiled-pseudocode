/*
 * XREFs of ??1CAnimationController@@UEAA@XZ @ 0x1801D670C
 * Callers:
 *     ??_GCAnimationController@@UEAAPEAXI@Z @ 0x1801D66C0 (--_GCAnimationController@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?UnRegisterBatchProcessingCompleteListener@CExpressionManager@@QEAAXPEAVIBatchProcessingCompleteListener@@@Z @ 0x1801D675C (-UnRegisterBatchProcessingCompleteListener@CExpressionManager@@QEAAXPEAVIBatchProcessingComplete.c)
 */
