/*
 * XREFs of ?FinalRelease@CVisualTree@@MEAAXXZ @ 0x18008CD20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVisualTree::FinalRelease(CVisualTree *this)
{
  ...
  for ( i = *(CVisualTree ***)(v1 + 400); i != *(CVisualTree ***)(v1 + 408); ++i )
  {
    if ( *i == this )
    {
      if ( *(_BYTE *)(v1 + 5664) )
      {
        v4 = detail::vector_facade<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>,detail::buffer_impl<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>,4,1,detail::liberal_expansion_policy>>::reserve_region(
               (__int64 **)(v1 + 552),
