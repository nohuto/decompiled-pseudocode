/*
 * XREFs of ?WaitForWork@CScheduler@@QEAAXPEAUIMessageLoopExtensions@@@Z @ 0x180157830
 * Callers:
...
void __fastcall CScheduler::WaitForWork(CScheduler *this, struct IMessageLoopExtensions *a2)
{
  ...
  *((_QWORD *)this + 6) = qword_1803FAB48;
  v3 = qword_1803FAB50;
  if ( (unsigned __int64)(qword_1803FAB50 - 1) > 0xFFFFFFFFFFFFFFFDuLL )
  {
    if ( qword_1803FAB38 )
    {
      if ( byte_1803FAB62 )
      ...
      else
      {
        ...
        {
          if ( (*(int (__fastcall **)(CDisplayManager *, char *, char *))(*(_QWORD *)qword_1803FAB38 + 176LL))(
                 qword_1803FAB38,
                 EventW,
                 (char *)&qword_1803FAB58 + 4) >= 0 )
          {
            wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::reset(
              (void **)&qword_1803FAB50,
              EventW);
