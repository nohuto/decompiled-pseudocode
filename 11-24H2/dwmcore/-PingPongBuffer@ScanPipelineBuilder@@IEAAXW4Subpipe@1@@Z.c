/*
 * XREFs of ?PingPongBuffer@ScanPipelineBuilder@@IEAAXW4Subpipe@1@@Z @ 0x1802DDABC
 * Callers:
 ...
 * Callees:
 *     ?GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA?AW4BufferLocation@@XZ @ 0x1802DDA94 (-GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA-AW4BufferLocation@@XZ.c)
 */
