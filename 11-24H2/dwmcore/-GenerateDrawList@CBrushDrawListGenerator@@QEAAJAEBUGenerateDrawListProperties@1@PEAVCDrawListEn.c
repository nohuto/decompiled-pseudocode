/*
 * XREFs of ?GenerateDrawList@CBrushDrawListGenerator@@QEAAJAEBUGenerateDrawListProperties@1@PEAVCDrawListEntryBuilder@@@Z @ 0x18016C070
 * Callers:
        ...
        struct CDrawListEntryBuilder *a3)
{
  ...
  void (__fastcall *v49)(CRectanglesShape *, __int64, struct CDrawListEntryBuilder *, CRectanglesShape *(__fastcall *)(CRectanglesShape *, char, __int64)); // rax
  __m128 v50; // xmm0
  __int128 v51; // xmm1
  __int128 v52; // xmm0
  __m128 v53; // xmm1
    ...
    if ( *(_BYTE *)(v12 - 8) )
    {
      ...
      if ( v12 != *((_QWORD *)v11 + 93) && *(_QWORD *)(v12 - 176) )
      {
        ...
        if ( *((_DWORD *)v11 + 74) == v15 )
        {
          ...
          if ( ((unsigned __int8 (__fastcall *)(struct _LIST_ENTRY *, __int64, struct CDrawListEntryBuilder *, CRectanglesShape *(__fastcall *)(CRectanglesShape *, char, __int64)))v16->Flink[11].Blink)(
                 v16,
                 v8,
                 a3,
                 CRectanglesShape::`scalar deleting destructor') )
          {
            v13 = (__m128 *)((char *)v3 + 328);
          }
          else
          {
        ...
        else
        {
          ...
          *(_OWORD *)&v90.m256i_u64[2] = v52;
          v91 = v53;
          v54 = Windows::Foundation::Numerics::invert((Windows::Foundation::Numerics *)&v89, &v89, a3);
          LOWORD(v92) = v92 & 0xC003;
          if ( !v54 )
          {
            if ( COERCE_FLOAT(*(_DWORD *)(v55 + 40) & _xmm) >= 0.000081380211 )
              goto LABEL_24;
            if ( !CMILMatrix::IsPure2DUniformZ<1>(v55) )
              goto LABEL_24;
            v61 = v60[12];
            v62 = v60[13];
            ...
            *(__m128 *)v82.m256i_i8 = _mm_shuffle_ps(v66, v66, 225);
            ...
            v91 = v83;
            v69 = Windows::Foundation::Numerics::invert((Windows::Foundation::Numerics *)&v89, &v89, v59);
            LOWORD(v92) = v92 & 0xC003;
            if ( !v69 )
              goto LABEL_24;
          }
          CMILMatrix::Multiply(v56, (const struct CMILMatrix *)&v89, (struct CMILMatrix *)&v84);
          if ( !CMILMatrix::ProducesUniformZ<1>((__int64)&v84) )
            goto LABEL_24;
          if ( COERCE_FLOAT(v87.m128_i32[2] & _xmm) >= 0.000081380211 )
          {
            if ( !CMILMatrix::ProducesUniformZ<1>(*((_QWORD *)v11 + 94) - 84LL) )
              goto LABEL_24;
            *(_OWORD *)&v82.m256i_u64[1] = 0LL;
            v81.m128_u64[1] = 0LL;
            v75 = v81;
      ...
      if ( (_BYTE)a3 && v7 )
      {
        v49 = **(void (__fastcall ***)(CRectanglesShape *, __int64, struct CDrawListEntryBuilder *, CRectanglesShape *(__fastcall *)(CRectanglesShape *, char, __int64)))v7;
        if ( (char *)v49 == (char *)CRectanglesShape::`scalar deleting destructor' )
        {
          CRectanglesShape::~CRectanglesShape(v7);
          CThreadLocalObjectCache<CRectanglesShape,CRectanglesShape>::Free(v7);
        }
        else if ( (char *)v49 == (char *)CRoundedRectangleShape::`vector deleting destructor' )
        {
        ...
        else if ( (char *)v49 == (char *)CPolygonShape::`scalar deleting destructor' )
        {
          CPolygonShape::`scalar deleting destructor'(v7, 1);
        }
        else
        {
          v49(v7, 1LL, a3, CRectanglesShape::`scalar deleting destructor');
        }
      }
      v95 = v119;
      ...
      if ( v13 )
      {
        ...
        *(__m128 *)&v99[32] = v13[2];
        *(__m128 *)&v99[48] = v13[3];
        *(_DWORD *)&v99[64] = v13[4].m128_i32[0];
      }
      else
      {
        *(struct _D3DCOLORVALUE *)&v99[8] = *(const struct _D3DCOLORVALUE *)&_xmm.r;
...
LABEL_36:
  ...
  if ( DrawListWorker < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, DrawListWorker, 0x137u, 0LL);
  }
  else if ( *((_QWORD *)v5 + 10) )
  {
    ...
    *((_QWORD *)v5 + 13) = 0LL;
    ...
    if ( (v40 & 0x80000000) != 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v40, 0x13Cu, 0LL);
  }
  if ( !v98 )
    return v40;
  v46 = v97;
  if ( !v97 )
    return v40;
  v47 = **(CRectanglesShape *(__fastcall ***)(CRectanglesShape *, char, __int64))v97;
  ...
  else
  {
    ...
    {
      ((void (__fastcall *)(CRectanglesShape *, __int64))v47)(v97, 1LL);
      return v40;
    }
    CPolygonShape::`scalar deleting destructor'(v97, 1);
    return v40;
  }
}
