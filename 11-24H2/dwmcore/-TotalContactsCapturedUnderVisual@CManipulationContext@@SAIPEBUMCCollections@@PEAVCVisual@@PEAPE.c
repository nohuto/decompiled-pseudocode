/*
 * XREFs of ?TotalContactsCapturedUnderVisual@CManipulationContext@@SAIPEBUMCCollections@@PEAVCVisual@@PEAPEAVCInteraction@@@Z @ 0x180195050
 * Callers:
        ...
        struct CInteraction **a3)
{
  ...
  if ( CVisual::GetInteractionInternal(a2) )
  {
    ...
    Microsoft::WRL::ComPtr<CVisual>::operator=((__int64 *)&v18, *((_QWORD *)InteractionInternal + 28));
  ...
  else
  {
    ...
    Microsoft::WRL::ComPtr<CVisual>::operator=((__int64 *)&v18, (__int64)ClosestInteractionAncestor);
    v11 = v18;
    if ( v18 )
    {
