/*
 * XREFs of ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@IVCDDisplayFlipAwayFence@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIVCDDisplayFlipAwayFence@@@std@@@3@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@$$CBIVCDDisplayFlipAwayFence@@@std@@PEAX@2@PEAU32@QEAU32@@Z @ 0x1802BFDD8
 * Callers:
