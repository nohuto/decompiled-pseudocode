/*
 * XREFs of ?SetViewboxAnimation@?$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@QEAAJPEAVCRectResource@@@Z @ 0x180205E24
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[23] )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x80Bu, 0LL);
    }
    else
    {
