/*
 * XREFs of ?AddEntry@CoordMap@@AEAAJAEAV?$vector_facade@URampEntry@CoordMap@@V?$buffer_impl@URampEntry@CoordMap@@$09$00Vliberal_expansion_policy@detail@@@detail@@@detail@@HAEBURampPair@1@W4RampMergeMode@1@@Z @ 0x180150BC0
 * Callers:
 ...
 *     ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAURampEntry@CoordMap@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAURampEntry@CoordMap@@@stdext@@_J@Z @ 0x1801514E4 (--$_Get_unwrapped_n@AEAV-$checked_array_iterator@PEAURampEntry@CoordMap@@@stdext@@_J@std@@YA-A_T.c)
