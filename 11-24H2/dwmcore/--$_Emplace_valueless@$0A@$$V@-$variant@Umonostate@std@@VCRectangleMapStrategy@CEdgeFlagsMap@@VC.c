/*
 * XREFs of ??$_Emplace_valueless@$0A@$$V@?$variant@Umonostate@std@@VCRectangleMapStrategy@CEdgeFlagsMap@@VCPolygonMapStrategy@4@@std@@AEAAAEAUmonostate@1@XZ @ 0x180250554
 * Callers:
