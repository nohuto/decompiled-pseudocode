/*
 * XREFs of ?Init@CD3DTexture@@IEAAJPEAVCD3DResourceManager@@PEAUID3D11Texture2D@@I@Z @ 0x18005D224
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *((_DWORD *)this + 44) = (unsigned int)HasAlphaChannel(*((_DWORD *)this + 36)) != 0 ? 1 : 3;
  ...
  if ( PixelFormatColorSpace < 0 )
  {
    v13 = 75;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, PixelFormatColorSpace, v13, 0LL);
    return v10;
  }
  v11 = *((_DWORD *)this + 34);
  *((_DWORD *)this + 46) = v11;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x50u, 0LL);
    return v10;
  }
  *((_DWORD *)this + 43) = a4;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x56u, 0LL);
    return v10;
  }
