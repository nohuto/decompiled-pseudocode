/*
 * XREFs of ??$make_unique@VCVisualOcclusionInfo@@PEAVCVisual@@AEAI$0A@@std@@YA?AV?$unique_ptr@VCVisualOcclusionInfo@@U?$default_delete@VCVisualOcclusionInfo@@@std@@@0@$$QEAPEAVCVisual@@AEAI@Z @ 0x18009E390
 * Callers:
