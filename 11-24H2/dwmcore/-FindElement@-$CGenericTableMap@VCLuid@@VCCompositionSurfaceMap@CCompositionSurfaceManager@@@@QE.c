/*
 * XREFs of ?FindElement@?$CGenericTableMap@VCLuid@@VCCompositionSurfaceMap@CCompositionSurfaceManager@@@@QEAAPEAVCCompositionSurfaceMap@CCompositionSurfaceManager@@VCLuid@@@Z @ 0x1801EB084
 * Callers:
