/*
 * XREFs of ?SetOffset@CVisual@@QEAAXMMM@Z @ 0x1801CB59C
 * Callers:
...
void __fastcall CVisual::SetOffset(CVisual *this, double a2, double a3, float a4)
{
  ...
  __int64 v7; // rax
  unsigned int v8; // edi
  __int64 (__fastcall *v9)(__int64, __int64, __int64); // r8
  ...
  _QWORD *v14; // rsi
  __int64 v15; // rax
  struct CProcessAttribution *(__fastcall *v16)(CWindowNode *); // rax
  ...
  int v42; // eax
  int v43; // r9d
  __int64 (__fastcall *v44)(__int64, __int64, __int64); // rax
  __int64 v45; // rax
  ...
  if ( v4 != *(float *)&a2 || *((float *)this + 30) != *(float *)&a3 || *((float *)this + 31) != a4 )
  {
    ...
    *((float *)this + 31) = a4;
    ...
    if ( (v7 & 2) != 0 )
      ...
      LODWORD(v7) = v7 & 1;
    v8 = 0;
    v9 = (__int64 (__fastcall *)(__int64, __int64, __int64))CCachedVisualImage::NotifyOnChanged;
    ...
    if ( (_DWORD)v7 )
    {
      ...
      do
      {
        ...
        if ( v38 != *((_DWORD **)v5 + 11) )
        {
          v44 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v38 + 80LL);
          if ( v44 == v9 )
          {
          ...
          {
            CVisualSurface::NotifyOnChanged((__int64)v38, 0LL, (__int64)v5);
          }
          else
          {
            v44((__int64)v38, 0LL, (__int64)v5);
          }
          v10 = CVisualSurface::NotifyOnChanged;
          v9 = (__int64 (__fastcall *)(__int64, __int64, __int64))CCachedVisualImage::NotifyOnChanged;
        }
    ...
    if ( (*((_BYTE *)v5 + 106) & 0x40) != 0 )
    {
      do
      {
        ...
        *((_BYTE *)v14 + 96) |= 0x91u;
        ...
        if ( (_DWORD)v15 )
        {
          ...
          do
          {
            ...
            if ( v31 != (_DWORD *)v14[11] )
            {
              ...
              {
                CVisualSurface::NotifyOnChanged((__int64)v31, 0LL, (__int64)v14);
              }
              else
              {
                v32(v31, 0LL, v14);
        ...
        v16 = *(struct CProcessAttribution *(__fastcall **)(CWindowNode *))(*v14 + 160LL);
    ...
    if ( v19 )
    {
      if ( *(_DWORD *)(v19 + 108) )
      {
        if ( *((_DWORD *)v5 + 18) )
        {
          ...
          {
            v39 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)v5 + 3) + 6392LL) + 72LL))(
                    *(_QWORD *)(*((_QWORD *)v5 + 3) + 6392LL),
                    11LL);
            if ( v39 )
            {
              v40 = *((_QWORD *)v5 + 7);
              ...
              v42 = CoreUICallSend(v39, v49, 2LL, 11LL, 3, &unk_18032BF78, 28, &v47, (_DWORD)v46);
              v43 = 0;
              if ( v42 != -2018375675 )
                v43 = v42;
              if ( v43 < 0 )
