/*
 * XREFs of ?EnumerateBrushes@CMultiPrimitiveDrawListBrush@@UEBAJPEBVCDrawingContext@@P6AJPEBVCDrawListBrush@@PEAX@Z2@Z @ 0x18016BF90
 * Callers:
        ...
        void *a4)
{
  ...
  while ( v5 != v10 )
  {
    ...
    *(_OWORD *)(v11 + 32) = v12;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x47u, 0LL);
      return v4;
    }
    ++v5;
  }
