/*
 * XREFs of ?ProcessSetShowCursor@CCompositionMagnifierBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPOSITIONMAGNIFIERBRUSH_SETSHOWCURSOR@@@Z @ 0x1802972D4
 * Callers:
...
__int64 __fastcall CCompositionMagnifierBrush::ProcessSetShowCursor(
        CCompositionMagnifierBrush *this,
        struct CResourceTable *a2,
        const struct tagMILCMD_COMPOSITIONMAGNIFIERBRUSH_SETSHOWCURSOR *a3)
{
  char v3; // al

  v3 = *((_BYTE *)a3 + 8);
  if ( *((_BYTE *)this + 205) != v3 )
  {
    *((_BYTE *)this + 205) = v3;
