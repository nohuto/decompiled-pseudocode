/*
 * XREFs of ?ProcessSetCallbackId@CAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATION_SETCALLBACKID@@@Z @ 0x180292F90
 * Callers:
        ...
        const struct tagMILCMD_ANIMATION_SETCALLBACKID *a3)
{
  ...
  if ( CAnimation::ShouldNotify(this) )
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)v7 + 6392LL) + 88LL))(
      *(_QWORD *)(*(_QWORD *)v7 + 6392LL),
      (unsigned int)*v5,
      (unsigned int)*v3);
  v8 = *(CComposition **)v7;
  *v3 = *((_DWORD *)a3 + 2);
