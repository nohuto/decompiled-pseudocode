/*
 * XREFs of CDebugFrameCounter::RenderGlobalFrameCounter__lambda_586b8124a7a66c0b83ac918785996de3___ @ 0x180097998
 * Callers:
        ...
        ...)
{
  ...
  if ( g_pComposition != (CGlobalComposition *)-1008LL && *((_BYTE *)g_pComposition + 1016) )
  {
    ...
    if ( v5 != (char *)-4632LL )
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0x96u, 0LL);
        return v3;
      }
      v10 = v20;
      v9 = v19;
