/*
 * XREFs of ?ProcessDisableOutputPrediction@CInteraction@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTION_DISABLEOUTPUTPREDICTION@@@Z @ 0x18028A5A4
 * Callers:
        ...
        const struct tagMILCMD_INTERACTION_DISABLEOUTPUTPREDICTION *a3)
{
  ...
  v3 = *((_BYTE *)a3 + 8);
  *((_BYTE *)this + 201) = *((_BYTE *)this + 201) & 0xFD | (v3 != 0 ? 2 : 0);
  if ( v3 )
