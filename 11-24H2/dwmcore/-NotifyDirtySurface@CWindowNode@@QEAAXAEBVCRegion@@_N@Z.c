/*
 * XREFs of ?NotifyDirtySurface@CWindowNode@@QEAAXAEBVCRegion@@_N@Z @ 0x180031108
 * Callers:
...
void __fastcall CWindowNode::NotifyDirtySurface(CWindowNode *this, int **a2, char a3)
{
  ...
  else if ( (!*((_BYTE *)this + 752) || !a3) && (*((_BYTE *)this + 96) & 4) == 0 )
  {
    v5 = *a2;
    v6 = (float)*((int *)this + 182);
    v7 = (float)(int)HIDWORD(*((_QWORD *)this + 91));
    v8 = **a2;
    if ( v8 )
    {
      v9 = v5[4];
...
LABEL_9:
    while ( v10 < v13 )
    {
      ...
      v20 = (float)(v17 + *(_DWORD *)&v11[8 * v12 + 4]);
      v21 = (float)(int)(HIDWORD(*((_QWORD *)this + 89)) + *v10);
      v22 = (float)(int)(HIDWORD(*((_QWORD *)this + 89)) + v10[2]);
      if ( v19 <= -3.4028235e38 )
  ...
  if ( !CWindowNode::ProcessReadyGdiSpriteBitmaps(this) )
  {
    ...
    if ( *((_BYTE *)this + 752) && v3 )
    {
      *((_BYTE *)this + 896) &= ~1u;
      v28 = 5LL;
LABEL_44:
      CVisual::PropagateFlags(this, v28);
    }
  }
}
