/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x1800F5000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorTransformLayer::RenderLayer(CColorTransformLayer *this, struct CDrawingContext *a2)
{
  ...
  _DWORD v33[4]; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_22:
  ...
  if ( *(_DWORD *)((*(__int64 (__fastcall **)(__int64, _DWORD *))(*(_QWORD *)v10 + 24LL))(v10, v33) + 4) == 3 )
  {
    v35 = 0;
    v39 = 1065353216;
  }
  v17 = v27;
  v18 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _DWORD *, int))(*(_QWORD *)v27 + 72LL))(
          v27,
          0LL,
          0LL,
          v34,
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0x6Eu, 0LL);
  }
  else
  {
    LODWORD(v27) = 2;
    v19 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64 *, int))(*(_QWORD *)v17 + 72LL))(
            v17,
            1LL,
            0LL,
            &v27,
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v19, 0x71u, 0LL);
    }
    else
    {
      (*(void (__fastcall **)(__int64, _QWORD, __int64, __int64))(*(_QWORD *)v17 + 112LL))(v17, 0LL, v28, 1LL);
      ...
      v33[0] = 0;
      v33[1] = 0;
      v33[2] = _mm_cvtepi32_ps(v20).m128_u32[0];
      v22 = _mm_cvtsi32_si128(*((_DWORD *)this + 4));
      v33[3] = _mm_cvtepi32_ps(v21).m128_u32[0];
      *(float *)v21.m128i_i32 = (float)*((int *)this + 5);
      LODWORD(v27) = _mm_cvtepi32_ps(v22).m128_u32[0];
      HIDWORD(v27) = v21.m128i_i32[0];
      v23 = CDrawingContext::FillEffect(a2, 1);
      v7 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0x8Bu, 0LL);
      (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v17 + 112LL))(v17, 0LL, 0LL, 1LL);
    }
  }
