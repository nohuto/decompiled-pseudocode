/*
 * XREFs of ?GetValue@CConditionalExpression@@QEAAJPEAVCExpressionValueStack@@_KPEAM@Z @ 0x1800E62CC
 * Callers:
 ...
 *     ?Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z @ 0x1802AF950 (-Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z.c)
 * Callees:
        ...
        float *a4)
{
  ...
  *a4 = 0.0;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x1F7u, 0LL);
  }
  else if ( v7 != 1 )
  {
    v9 = (float *)CExpressionValueStack::PeekStackValue(a2, 0);
    --*((_DWORD *)a2 + 2);
    *a4 = *v9;
  }
  return v8;
