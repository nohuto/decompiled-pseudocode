        ...
        unsigned __int64 *a2)
{
  ...
  if ( !*(_BYTE *)(v6 + 25) )
  {
    ...
    do
    {
      if ( *(_QWORD *)(v7 + 32) >= v10 )
      {
        if ( *(_BYTE *)(v5 + 25) && v10 < *(_QWORD *)(v7 + 32) )
          v5 = v7;
        v2 = v7;
        v7 = *(_QWORD *)v7;
      }
