/*
 * XREFs of ?RenderMask@CTreeEffectLayer@@AEAAJAEBUD2D_SIZE_F@@PEAVCDrawingContext@@PEAVIRenderTargetBitmap@@@Z @ 0x180210574
 * Callers:
        ...
        struct IRenderTargetBitmap *a4)
{
  ...
  *(float *)&v25[5] = 0.0 - v18 * 0.0;
  ...
  if ( v20 < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x34Au, 0LL);
  }
  else
  {
    return 0;
