/*
 * XREFs of ?clear_region@?$vector_facade@VSubTreeContext@CPreComputeContext@@V?$buffer_impl@VSubTreeContext@CPreComputeContext@@$02$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x180175380
 * Callers:
...
LABEL_9:
  ...
  while ( v11 != v3 )
  {
    CPreComputeContext::SubTreeContext::operator=((char *)v11 + v13);
