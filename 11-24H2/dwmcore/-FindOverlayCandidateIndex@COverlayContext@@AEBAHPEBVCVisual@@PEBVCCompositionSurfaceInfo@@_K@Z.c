/*
 * XREFs of ?FindOverlayCandidateIndex@COverlayContext@@AEBAHPEBVCVisual@@PEBVCCompositionSurfaceInfo@@_K@Z @ 0x1800609CC
 * Callers:
        ...
        __int64 a4)
{
  ...
  v8 = *((_QWORD *)this + 11);
  for ( i = 0; i < 438261969 * (unsigned int)((*((_QWORD *)this + 12) - v8) >> 3); ++i )
  {
    v11 = 392LL * i;
