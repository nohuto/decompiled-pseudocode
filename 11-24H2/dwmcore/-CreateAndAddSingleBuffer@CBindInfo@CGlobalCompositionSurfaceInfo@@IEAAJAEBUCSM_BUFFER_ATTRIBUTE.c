/*
 * XREFs of ?CreateAndAddSingleBuffer@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SINGLE_BUFFER_INFO@@@Z @ 0x180291358
 * Callers:
        ...
        const struct CSM_SINGLE_BUFFER_INFO *a3)
{
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18032FBA8, 3u, v4, 0x624u, 0LL);
  else
