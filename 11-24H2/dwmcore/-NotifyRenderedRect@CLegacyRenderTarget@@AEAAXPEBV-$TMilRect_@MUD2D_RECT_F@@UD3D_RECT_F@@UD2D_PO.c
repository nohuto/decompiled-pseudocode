/*
 * XREFs of ?NotifyRenderedRect@CLegacyRenderTarget@@AEAAXPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@_N@Z @ 0x1800D3FE0
 * Callers:
...
{
  __m128 v3; // xmm2
  const struct CMILMatrix *(__fastcall *v6)(CLegacyRenderTarget *); // rax
  ...
  if ( !a3 )
  {
    v6 = *(const struct CMILMatrix *(__fastcall **)(CLegacyRenderTarget *))(*(_QWORD *)(a1 + 88) + 64LL);
    if ( v6 == CLegacyRenderTarget::GetDeviceTransform )
      Transform = CMonitorTransform::GetTransform((CMonitorTransform *)(a1 + 30504), *(_BYTE *)(a1 + 19305));
    else
...
LABEL_8:
  ...
  v41 = *(_OWORD *)PixelAlign((int *)v42, (unsigned int *)a2, *(double *)v3.m128_u64);
LABEL_25:
  v24 = *(_QWORD *)(a1 + 200);
  v25 = &v41;
LABEL_26:
