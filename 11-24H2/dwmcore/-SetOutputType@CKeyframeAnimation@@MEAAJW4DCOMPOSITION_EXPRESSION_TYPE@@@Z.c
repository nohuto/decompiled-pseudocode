/*
 * XREFs of ?SetOutputType@CKeyframeAnimation@@MEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801EF950
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::SetOutputType(__int64 a1, int a2)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0xA1u, 0LL);
  }
  return v4;
}
