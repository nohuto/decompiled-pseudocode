/*
 * XREFs of ?SetCompositionMode@CCompositionSurfaceBitmap@@UEAAX_NW4BufferCompositionMode@@AEBVCMILMatrix@@W4DXGI_COLOR_SPACE_TYPE@@PEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x1800F0380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RecentlyComposed@CBindInfo@CGlobalCompositionSurfaceInfo@@QEBA_NXZ @ 0x1800F0530 (-RecentlyComposed@CBindInfo@CGlobalCompositionSurfaceInfo@@QEBA_NXZ.c)
