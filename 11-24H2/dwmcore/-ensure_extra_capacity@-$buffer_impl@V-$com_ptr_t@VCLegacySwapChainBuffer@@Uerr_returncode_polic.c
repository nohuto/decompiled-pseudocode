/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@V?$com_ptr_t@VCLegacySwapChainBuffer@@Uerr_returncode_policy@wil@@@wil@@$02$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x1801B69D4
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( v3 - v4 < a2 )
  {
    ...
    v7 = detail::liberal_expansion_policy::expand((detail::liberal_expansion_policy *)(v3 - *a1), v3 - *a1, v6);
