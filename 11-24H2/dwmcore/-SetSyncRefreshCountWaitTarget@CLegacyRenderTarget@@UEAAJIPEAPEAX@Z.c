/*
 * XREFs of ?SetSyncRefreshCountWaitTarget@CLegacyRenderTarget@@UEAAJIPEAPEAX@Z @ 0x1800EDE80
 * Callers:
        ...
        void **a3)
{
  ...
  if ( v5 )
  {
    v7 = (void **)((char *)this + 33256);
    if ( (unsigned __int64)(*((_QWORD *)this + 4157) - 1LL) <= 0xFFFFFFFFFFFFFFFDuLL )
      goto LABEL_6;
    v8 = *v5;
    v12 = 0LL;
    v13 = 1;
    v9 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v8 + 72))(v5, &v12);
    if ( v13 )
    {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x352u, 0LL);
...
LABEL_6:
      ...
      if ( (int)result < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, result, 0x355u, 0LL);
        return v11;
      }
      else
      {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304442, 0x35Bu, 0LL);
    return 2291662854LL;
  }
  return result;
}
