/*
 * XREFs of ?CleanStaleFork@CManipulationContext@@AEAAXW4InputType@@PEAVCInteraction@@@Z @ 0x180257550
 * Callers:
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( (unsigned int)dword_1803F8D18 > 4 && tlgKeywordOn((__int64)&dword_1803F8D18, 2LL) )
      {
        ...
        v20 = 8;
        v17 = 8;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1803F8D18, byte_1803CB478, 0LL, 0LL, 6u, &v15);
      }
