/*
 * XREFs of ?PreRender@CComputeScribbleRenderer@@QEAAJXZ @ 0x1801C5790
 * Callers:
 ...
 *     ?SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z @ 0x180288414 (-SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z.c)
...
__int64 __fastcall CComputeScribbleRenderer::PreRender(CComputeScribbleRenderer *this)
{
  ...
  if ( !OverlaySwapChain )
    return 2291662854LL;
  ++*((_QWORD *)this + 3);
  v4 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)OverlaySwapChain + 192LL))(OverlaySwapChain);
  ...
  v9 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)v3 + 96LL))(v3);
  *(_OWORD *)v14 = 0LL;
  v10 = v9;
  v15 = 0LL;
  v11 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *, unsigned int *))(*(_QWORD *)v3 + 136LL))(v3, v14);
  v12 = v11;
  if ( v11 >= 0 )
  {
    ...
    if ( !v7 )
    {
      v13 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)v3 + 88LL))(v3);
