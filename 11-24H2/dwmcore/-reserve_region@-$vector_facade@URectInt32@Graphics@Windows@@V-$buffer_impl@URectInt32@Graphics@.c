/*
 * XREFs of ?reserve_region@?$vector_facade@URectInt32@Graphics@Windows@@V?$buffer_impl@URectInt32@Graphics@Windows@@$07$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAURectInt32@Graphics@Windows@@_K0@Z @ 0x18024386C
 * Callers:
