/*
 * XREFs of ?SendDisposeProxy@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x18026F850
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  LODWORD(v7) = a3;
  v5 = CoreUICallSend(v4, v8, 2LL, 7LL, 8, &unk_180383D71, a2, v7, v8[0]);
  if ( v5 < 0 )
