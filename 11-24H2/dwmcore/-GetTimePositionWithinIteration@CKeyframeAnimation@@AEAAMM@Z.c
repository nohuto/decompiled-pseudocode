/*
 * XREFs of ?GetTimePositionWithinIteration@CKeyframeAnimation@@AEAAMM@Z @ 0x1801B2730
 * Callers:
...
float __fastcall CKeyframeAnimation::GetTimePositionWithinIteration(CKeyframeAnimation *this, float a2, double a3)
{
  ...
  {
    v4 = 0LL;
    *(float *)v4.m128i_i32 = (float)*(int *)(*(_QWORD *)(v3 + 104) + 24LL * (unsigned int)(v5 - 1)) / 1000.0;
  }
