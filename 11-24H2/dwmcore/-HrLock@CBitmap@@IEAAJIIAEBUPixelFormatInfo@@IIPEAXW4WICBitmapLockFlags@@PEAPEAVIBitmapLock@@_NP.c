/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x180024E7C
 * Callers:
        ...
        struct IUnknown *a11)
{
  ...
  if ( !v14 )
  {
    ...
    v35 = 419;
LABEL_33:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, v35, 0LL);
    return v17;
  }
  if ( (a8 & 1) == 0 )
  {
