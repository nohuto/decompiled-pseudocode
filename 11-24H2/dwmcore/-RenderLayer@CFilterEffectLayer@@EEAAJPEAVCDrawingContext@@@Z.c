/*
 * XREFs of ?RenderLayer@CFilterEffectLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x180219030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CFilterEffectLayer::RenderLayer(CFilterEffectLayer *this, struct CDrawingContext *a2)
{
  ...
  if ( v20 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v22.m128_i32[0] = *((_DWORD *)this + 32);
      v22.m128_i32[1] = v16;
      v7 = CDrawingContext::FillEffect(a2, v20, &v23, (const struct D2D_POINT_2F *)&v22, 1);
