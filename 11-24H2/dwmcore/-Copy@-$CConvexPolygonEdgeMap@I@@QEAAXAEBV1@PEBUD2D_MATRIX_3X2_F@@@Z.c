/*
 * XREFs of ?Copy@?$CConvexPolygonEdgeMap@I@@QEAAXAEBV1@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x180288F0C
 * Callers:
 ...
 *     ?clear@?$_Tree@V?$_Tmap_traits@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@UCompareEdgeDirection@3@V?$allocator@U?$pair@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@@std@@@std@@$0A@@std@@@std@@QEAAXXZ @ 0x1802890BC (-clear@-$_Tree@V-$_Tmap_traits@$$CBUD2D_VECTOR_2F@@UEdgeData@-$CConvexPolygonEdgeMap@I@@UCompare.c)
 */
...
void __fastcall CConvexPolygonEdgeMap<unsigned int>::Copy(__int64 *a1, __int64 *a2, float *a3)
{
  ...
  __int64 v18; // rax
  __int64 v19; // rdx
  _BYTE v20[32]; // [rsp+20h] [rbp-40h] BYREF
  __int64 v21; // [rsp+40h] [rbp-20h]
  float v22[4]; // [rsp+48h] [rbp-18h] BYREF
  ...
  if ( !a3 || D2D1::Matrix3x2F::IsIdentity((D2D1::Matrix3x2F *)a3) )
  {
    if ( a1 != a2 )
    {
      ...
      *(_QWORD *)(*a1 + 8) = std::_Tree<std::_Tmap_traits<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData,CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection,std::allocator<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>,0>>::_Copy_nodes<0>(
                               a1,
                               *(_QWORD *)(*a2 + 8),
                               *a1);
      v14 = (_QWORD *)*a1;
      ...
      else
      {
        ...
        *v17 = v16;
        v18 = std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<CCpuClipAntialiasSink::SinkRoutingInfo>::EdgeData>>>::_Max(*(_QWORD *)(*a1 + 8));
        *(_QWORD *)(v19 + 16) = v18;
      }
    }
  }
  else
  {
    ...
    *(_OWORD *)&v20[16] = 0LL;
    D2DMatrixHelper::DecomposeMatrixIntoScaleAndRemaining(
      v6,
      (const struct D2D_MATRIX_3X2_F *)v20,
      (float *)&v20[8],
      (float *)&v20[16]);
    v7 = *a2;
    *(_QWORD *)v20 = *a2;
    while ( v7 != *(_QWORD *)*a2 )
    {
      v8 = std::reverse_iterator<std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>>>>::operator->((__int64 *)v20);
      v9 = (float)((float)(*(float *)(v8 + 12) * a3[3]) + (float)(*(float *)(v8 + 8) * a3[1])) + a3[5];
      v22[0] = (float)((float)(*(float *)(v8 + 12) * a3[2]) + (float)(*(float *)(v8 + 8) * *a3)) + a3[4];
      v22[1] = v9;
      v22[2] = *(float *)(std::reverse_iterator<std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>>>>::operator->((__int64 *)v20)
                        + 16);
      v10 = (float *)std::reverse_iterator<std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>>>>::operator->((__int64 *)v20);
      v11 = *a1;
      v12 = (__m128)*(unsigned int *)v10;
      v13 = v12;
      v13.m128_f32[0] = (float)(v12.m128_f32[0] * *(float *)&v20[16]) + (float)(v10[1] * *(float *)&v20[24]);
      v12.m128_f32[0] = (float)(v12.m128_f32[0] * *(float *)&v20[20]) + (float)(v10[1] * *(float *)&v20[28]);
      *(_QWORD *)&v20[8] = _mm_unpacklo_ps(v13, v12).m128_u64[0];
      std::_Tree<std::_Tmap_traits<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData,CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection,std::allocator<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>,0>>::_Emplace_hint<D2D_VECTOR_2F,CConvexPolygonEdgeMap<unsigned int>::EdgeData &>(
        ...
        &v20[8],
        (__int64)v22);
      std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>>,std::_Iterator_base0>::operator--((__int64 *)v20);
      v7 = *(_QWORD *)v20;
    }
  }
}
