/*
 * XREFs of ?SetIndependentFlipNotify@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_N@Z @ 0x1802374B8
 * Callers:
        ...
        unsigned __int8 a2)
{
  ...
  if ( a2 != *((_BYTE *)this + 181) )
  {
    ...
    {
      v3 = v7 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7 | 0x10000000, 0x54Bu, 0LL);
    }
  }
  return v3;
}
