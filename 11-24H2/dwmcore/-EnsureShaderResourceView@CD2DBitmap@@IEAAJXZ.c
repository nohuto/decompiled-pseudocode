/*
 * XREFs of ?EnsureShaderResourceView@CD2DBitmap@@IEAAJXZ @ 0x18010C7A8
 * Callers:
 ...
 *     ?GetShaderResourceView@CDeviceTextureTarget@@UEAAPEAUID3D11ShaderResourceView@@XZ @ 0x1801D2150 (-GetShaderResourceView@CDeviceTextureTarget@@UEAAPEAUID3D11ShaderResourceView@@XZ.c)
 * Callees:
