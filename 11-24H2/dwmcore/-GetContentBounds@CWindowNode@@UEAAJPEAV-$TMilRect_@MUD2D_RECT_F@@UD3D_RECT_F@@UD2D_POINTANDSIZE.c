/*
 * XREFs of ?GetContentBounds@CWindowNode@@UEAAJPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180016810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowNode::GetContentBounds(CWindowNode *this, __int64 a2)
{
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  if ( v6 )
  {
    ...
    v8 = *(__int64 (__fastcall **)())(*(_QWORD *)v6 + 184LL);
    if ( v8 == CBrush::GetBounds )
    {
      *(FLOAT *)(a2 + 8) = v7->width;
    ...
    {
      if ( (char *)v8 == (char *)CSurfaceBrush::GetBounds )
      {
      ...
      if ( Bounds < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Bounds, 0xE70u, 0LL);
    }
  }
  v10 = 1;
  ...
  {
    if ( *((_BYTE *)this + 753) || !*((_QWORD *)this + 100) )
      goto LABEL_10;
  }
  else if ( !v11(this) )
  {
...
LABEL_10:
  ...
  if ( !*((_BYTE *)this + 753) )
  {
    ...
    if ( !v12 )
    {
      ...
      v36 = 0.0;
      EffectiveBounds = 0;
      v37 = (__int64 *)*((_QWORD *)this + 111);
      v38 = HIDWORD(*((_QWORD *)this + 91));
      *(_QWORD *)&v75 = 0LL;
      v71 = v35;
      *((FLOAT *)&v75 + 2) = v35;
      HIDWORD(v75) = v38;
      if ( v37 )
      {
        v39 = *v37;
        v77 = 0LL;
        v40 = *(__int64 (__fastcall **)())(v39 + 48);
        if ( v40 == CRegionShape::GetTightBounds )
        {
          v76 = 0LL;
          if ( FastRegion::CRegion::GetBoundingRect((FastRegion::CRegion *)(v37 + 2), &v76) )
          {
        ...
        {
          v67 = ((__int64 (__fastcall *)(__int64 *, __int128 *, _QWORD))v40)(v37, &v77, 0LL);
          EffectiveBounds = v67;
          if ( v67 < 0 )
          {
...
LABEL_164:
    ...
    {
      Flip = (_QWORD *)CWindowNode::GetFlipExSurfaceClipShape(this, &v76);
      EffectiveBounds = CWindowNode::GetEffectiveBounds(this, *Flip, &v75, 0LL);
  ...
  if ( !*((_BYTE *)this + 753) && *((_QWORD *)this + 100) )
  {
    ...
    if ( !v13 )
    {
      left = (float)(int)*((_QWORD *)this + 89);
      top = (float)(int)HIDWORD(*((_QWORD *)this + 89));
      right = (float)(int)*((_QWORD *)this + 90);
      bottom = (float)(int)HIDWORD(*((_QWORD *)this + 90));
      *(float *)&v75 = left;
      *((float *)&v75 + 3) = bottom;
      *((float *)&v75 + 1) = top;
      *((float *)&v75 + 2) = right;
...
LABEL_20:
    ...
    v21 = *(_QWORD *)&v76.left;
    v72 = 0LL;
    v18 = CShape::TryOptimizedCombinePaths(*(_QWORD *)&v76.left, 0LL, v79, 0LL, 1, &v72);
    EffectiveBounds = v18;
    if ( v18 < 0 )
    {
      v64 = 456;
...
LABEL_25:
        ...
        if ( !v23 )
          goto LABEL_66;
        v26 = *(__int64 (__fastcall **)())(*(_QWORD *)v23 + 48LL);
        ...
        if ( v26 == CRegionShape::GetTightBounds )
        {
          v76 = 0LL;
          if ( FastRegion::CRegion::GetBoundingRect((CRectanglesShape *)((char *)v23 + 16), &v76) )
          {
            left = (float)v76.left;
            top = (float)v76.top;
...
LABEL_68:
        ...
        v65 = (char *)v26 == (char *)CRoundedRectangleShape::GetTightBounds
            ...
            : ((__int64 (__fastcall *)(CRectanglesShape *, unsigned __int128 *, _QWORD))v26)(v23, &v75, 0LL);
        v25 = v65;
        EffectiveBounds = v65;
        if ( v65 < 0 )
        {
...
LABEL_66:
      ...
      v18 = CShape::D2DCombine(v21, v22, v79, 0LL, 1, &v72);
      EffectiveBounds = v18;
      if ( v18 >= 0 )
      {
        v23 = v72;
