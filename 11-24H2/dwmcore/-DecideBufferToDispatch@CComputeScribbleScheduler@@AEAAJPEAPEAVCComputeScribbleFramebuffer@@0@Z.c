/*
 * XREFs of ?DecideBufferToDispatch@CComputeScribbleScheduler@@AEAAJPEAPEAVCComputeScribbleFramebuffer@@0@Z @ 0x1801C5F60
 * Callers:
        ...
        struct CComputeScribbleFramebuffer **a3)
{
  ...
  int v28; // r9d
  int v29; // ecx
  float v30; // [rsp+30h] [rbp-51h]
  float v31; // [rsp+38h] [rbp-49h]
...
LABEL_14:
  ...
  if ( v11 )
  {
    ...
    else
    {
      v35 = 0LL;
      v36 = 0LL;
      v18 = (*(__int64 (__fastcall **)(__int64, __int128 *))(*(_QWORD *)v12 + 136LL))(v12, &v35);
      v10 = v18;
      if ( v18 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
      ...
      v20 = (PerformanceCount.QuadPart - (__int64)v36) / (qword_1803FAA70 / 0xF4240uLL);
