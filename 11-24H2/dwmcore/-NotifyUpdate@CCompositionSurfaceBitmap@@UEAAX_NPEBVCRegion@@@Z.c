/*
 * XREFs of ?NotifyUpdate@CCompositionSurfaceBitmap@@UEAAX_NPEBVCRegion@@@Z @ 0x1801E53F0
 * Callers:
 *     <none>
 * Callees:
...
{
  _DWORD *v4; // rcx
  __int64 (__fastcall *v5)(_DWORD *, __int64, __int64); // rax

  v4 = (_DWORD *)((char *)this - 80);
  v5 = *(__int64 (__fastcall **)(_DWORD *, __int64, __int64))(*(_QWORD *)v4 + 80LL);
  if ( a2 )
  {
    v5(v4, 0LL, (__int64)v4);
  }
  else
  {
    *((_QWORD *)this + 3) = a3;
    if ( v5 == CResource::NotifyOnChanged )
      CResource::NotifyOnChanged(v4, 1LL, (__int64)v4);
    else
      v5(v4, 1LL, (__int64)v4);
    *((_QWORD *)this + 3) = 0LL;
  }
}
