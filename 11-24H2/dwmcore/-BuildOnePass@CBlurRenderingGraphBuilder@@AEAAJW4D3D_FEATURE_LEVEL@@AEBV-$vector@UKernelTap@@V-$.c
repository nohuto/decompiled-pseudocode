/*
 * XREFs of ?BuildOnePass@CBlurRenderingGraphBuilder@@AEAAJW4D3D_FEATURE_LEVEL@@AEBV?$vector@UKernelTap@@V?$allocator@UKernelTap@@@std@@@std@@W4SeparableKernelPass@@@Z @ 0x180045700
 * Callers:
...
__int64 __fastcall CBlurRenderingGraphBuilder::BuildOnePass(_QWORD *a1, int a2, _QWORD *a3, char a4)
{
  ...
  else
  {
    ...
    BYTE1(v35) = v10 > *((float *)&unk_18032AED8 + 5 * v11);
    v41 = off_1802F76C0;
    LOWORD(v42) = v35;
    v43 = &v41;
