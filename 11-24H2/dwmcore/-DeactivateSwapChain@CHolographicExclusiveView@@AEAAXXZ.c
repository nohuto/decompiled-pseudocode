/*
 * XREFs of ?DeactivateSwapChain@CHolographicExclusiveView@@AEAAXXZ @ 0x1802D1DA8
 * Callers:
 ...
 * Callees:
 *     ?CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ @ 0x1802D1D3C (-CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ.c)
