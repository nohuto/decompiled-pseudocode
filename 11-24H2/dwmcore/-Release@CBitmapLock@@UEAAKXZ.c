/*
 * XREFs of ?Release@CBitmapLock@@UEAAKXZ @ 0x18004AF70
 * Callers:
 ...
 *     ?Release@?$CMILCOMBaseT@VICompositionSurfaceStatistics@@V1@VCMilObjectDeleter@@@@UEAAKXZ @ 0x18020C420 (-Release@-$CMILCOMBaseT@VICompositionSurfaceStatistics@@V1@VCMilObjectDeleter@@@@UEAAKXZ.c)
 ...
 *     ?Release@CBitmapLock@@WBA@EAAKXZ @ 0x180255FD0 (-Release@CBitmapLock@@WBA@EAAKXZ.c)
