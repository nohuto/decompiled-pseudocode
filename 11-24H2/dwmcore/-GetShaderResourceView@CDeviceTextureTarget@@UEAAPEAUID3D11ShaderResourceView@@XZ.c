/*
 * XREFs of ?GetShaderResourceView@CDeviceTextureTarget@@UEAAPEAUID3D11ShaderResourceView@@XZ @ 0x1801D2150
 * Callers:
 *     ?GetShaderResourceView@CDeviceTextureTarget@@WKI@EAAPEAUID3D11ShaderResourceView@@XZ @ 0x1802CDAA0 (-GetShaderResourceView@CDeviceTextureTarget@@WKI@EAAPEAUID3D11ShaderResourceView@@XZ.c)
 * Callees:
