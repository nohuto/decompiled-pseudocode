/*
 * XREFs of ?UpdateAnimateValues@CAnimation@@UEAA_NXZ @ 0x18007D840
 * Callers:
      ...
      if ( (unsigned int)v93 < *((_DWORD *)v2 + 26) )
      {
        ...
        do
        {
          if ( *(_QWORD *)(*((_QWORD *)v2 + 10) + 16 * v93) > v44 )
            break;
          v94 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)v2 - 6) + 6392LL) + 72LL))(
                  *(_QWORD *)(*((_QWORD *)v2 - 6) + 6392LL),
                  1LL);
          if ( v94 )
          {
            v99 = *((_QWORD *)v2 + 10);
            ...
            CoreUICallSend(v94, v110, 2LL, 1LL, 0, &unk_18032BF0C, *(_DWORD *)(v99 + 8 * v100 + 8), v101, v102);
          }
