/*
 * XREFs of ?ReleaseResources@?$CDeviceResourceTable@VCD2DGenericInk@@VCGenericInk@@@@AEAAXXZ @ 0x18024B0A0
 * Callers:
...
char *__fastcall CDeviceResourceTable<CD2DGenericInk,CGenericInk>::ReleaseResources(__int64 a1)
{
  __int64 *v1; // rdi
  __int64 *v3; // rbx
  __int64 *v4; // rbp
  ...
  v6 = (v1[1] - *v1) >> 3;
  if ( v6 )
    return (char *)detail::vector_facade<wil::com_ptr_t<CD2DGenericInk,wil::err_returncode_policy>,detail::buffer_impl<wil::com_ptr_t<CD2DGenericInk,wil::err_returncode_policy>,2,1,detail::liberal_expansion_policy>>::clear_region(
                     v1,
                     0LL,
                     v6);
  return result;
