/*
 * XREFs of ??0CKernelTransport@@AEAA@XZ @ 0x180263108
 * Callers:
 ...
 *     ?FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18026323C (-FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
