...
_QWORD *__fastcall std::vector<std::unique_ptr<CCheckMPOCache>>::_Emplace_reallocate<std::unique_ptr<CCheckMPOCache>>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *v17 = v14;
  ...
  std::_Uninitialized_move<std::unique_ptr<CCheckMPOCache> *,std::allocator<std::unique_ptr<CCheckMPOCache>>>(
    ...
    v18,
    v16);
  std::vector<std::unique_ptr<CCheckMPOCache>>::_Change_array(a1, v15, v9, v3);
  return v17;
}
