/*
 * XREFs of ?ComputeCursorToDeviceTransform@CCaptureRenderTarget@@IEAA_NPEAVCVisual@@0PEAVCVisualTree@@PEAVCMILMatrix@@@Z @ 0x1802822C4
 * Callers:
        ...
        struct CMILMatrix *a5)
{
  ...
  if ( WorldTransform < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, WorldTransform, 0x504u, 0LL);
  }
  else
  {
    v27[0] = v20;
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x509u, 0LL);
    }
    else
    {
      v20 = v25[0];
