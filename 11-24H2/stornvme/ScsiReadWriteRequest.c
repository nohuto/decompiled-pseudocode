/*
 * XREFs of ScsiReadWriteRequest @ 0x140003760
 * Callers:
...
__int64 __fastcall ScsiReadWriteRequest(__int64 a1, __int64 a2, unsigned __int8 *a3, int a4, bool *a5)
{
  char v6; // dl
  __int64 v7; // r11
  __int64 v8; // rdi
  ...
  __int128 Src; // [rsp+78h] [rbp-19h] BYREF
...
LABEL_40:
    ...
    *(_QWORD *)&Src = 0x1400000002LL;
    StorPortExtendedFunction(15LL, v7, a2, &Src);
    v31 = WORD4(Src);
    ...
    else
    {
      ...
      else
      {
        ...
        if ( v34 )
        {
          ...
          {
            ProcessorToDedicatedIoSqMapping(a1, v33, v31);
            v7 = a1;
          }
        ...
        else
        {
          ...
          {
            ProcessorToIoSqMappingBase(a1, v33, v31, 0LL);
            v7 = a1;
          }
      ...
      if ( !v45 || v45 == 96 )
      {
        *(_BYTE *)(v8 + 4096) = 1;
        if ( (*(_BYTE *)(v7 + 3728) & 3) == 3 && *(_BYTE *)(v7 + 3729) == v41 && *(_WORD *)(v7 + 3732) )
        {
          ...
          LOWORD(Src) = 1;
          v103 = 0LL;
          v87 = StorPortExtendedFunction(28LL, v7, a2, &Src);
          v7 = a1;
          if ( !v87
            && (WORD4(Src) & 0x100) != 0
            && (unsigned int)(HIDWORD(Src) - 1) <= 0xFFFE
            && HIDWORD(Src) <= *(unsigned __int16 *)(a1 + 3732) )
          {
            v42 = a3;
            if ( WORD6(Src) )
            {
              v77 = *(_DWORD *)(v8 + 4144) & 0xFF1FFFFF;
              *(_WORD *)(v8 + 4150) = WORD6(Src);
