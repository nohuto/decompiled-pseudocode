/*
 * XREFs of NVMeReenumerateReissueGetLogNamespaceChangeListCompletion @ 0x14002B320
 * Callers:
 *     <none>
 * Callees:
 *     GetSrbExtension @ 0x140005060 (GetSrbExtension.c)
 *     NVMeFreeDmaBuffer @ 0x14000CF60 (NVMeFreeDmaBuffer.c)
 *     NVMeReenumerateMergeNamespaceChangeList @ 0x14002A0C8 (NVMeReenumerateMergeNamespaceChangeList.c)
 *     NVMeReenumerateNameSpaceStart @ 0x14002AEE0 (NVMeReenumerateNameSpaceStart.c)
 */

void __fastcall NVMeReenumerateReissueGetLogNamespaceChangeListCompletion(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __int64 v4; // r8
  unsigned int v5; // r9d
  ...
  {
    v3 = *(_QWORD *)(GetSrbExtension(a2) + 4200);
  }
  else if ( a2 == a1 + 1016 )
  {
    v3 = a1 + 1008;
...
LABEL_21:
    ...
    || (v16 = v3 + 96, v13 = *(_QWORD *)(v3 + 96), *(_BYTE *)(v13 + 4136) != 4) )
  {
    ...
    v19 = (_QWORD *)(SrbExtension + 4160);
    v18 = v3 + 96;
    goto LABEL_37;
  }
  v17 = (_QWORD *)(SrbExtension + 4160);
  v18 = v3 + 96;
  v19 = (_QWORD *)(SrbExtension + 4160);
  ...
  if ( v15 == 1 )
  {
    ...
    NVMeReenumerateMergeNamespaceChangeList(v14, v20);
    if ( *v20 )
    {
