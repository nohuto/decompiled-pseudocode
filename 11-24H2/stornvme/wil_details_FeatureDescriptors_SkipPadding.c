/*
 * XREFs of wil_details_FeatureDescriptors_SkipPadding @ 0x140030C34
 * Callers:
 *     wil_details_EvaluateFeatureDependencies @ 0x140044070 (wil_details_EvaluateFeatureDependencies.c)
 *     wil_details_OnFeatureUsageProviderFlushNotification @ 0x140044230 (wil_details_OnFeatureUsageProviderFlushNotification.c)
