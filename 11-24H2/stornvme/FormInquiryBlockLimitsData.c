/*
 * XREFs of FormInquiryBlockLimitsData @ 0x140001040
 * Callers:
...
__int64 __fastcall FormInquiryBlockLimitsData(__int64 a1, __int64 a2)
{
  ...
  if ( *v6 >= 0x40u )
  {
    ...
    *(_BYTE *)(v5 + 6) = (unsigned __int16)(v12 / v11) >> 8;
    v13 = (unsigned int)GetControllerMaxTransferSize(a1, v12 % v11) / v11;
    v14[11] = v13;
    v14[10] = BYTE1(v13);
    v14[9] = BYTE2(v13);
    v14[8] = HIBYTE(v13);
    ...
    v14[13] = BYTE2(v15);
    v14[12] = HIBYTE(v15);
    if ( (unsigned __int8)IsDeallocateSupported(v17, v16) )
    {
      v21 = *(unsigned __int8 *)(v19 + 4075);
      if ( !(_BYTE)v21 )
        v21 = 256;
      v22 = *(_QWORD *)(v19 + 4080);
      if ( v22 )
