/*
 * XREFs of GetRegistrySettingsForSpecificKey @ 0x14002FAF0
 * Callers:
 *     NVMeControllerValidateFirmwareActivateCapability @ 0x140022420 (NVMeControllerValidateFirmwareActivateCapability.c)
 * Callees:
 *     ReadMultiSzRegistryValueAndCompareId @ 0x14002FDAC (ReadMultiSzRegistryValueAndCompareId.c)
 *     UlongToHex @ 0x1400301C4 (UlongToHex.c)
