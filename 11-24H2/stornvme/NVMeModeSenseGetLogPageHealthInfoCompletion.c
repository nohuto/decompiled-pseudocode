/*
 * XREFs of NVMeModeSenseGetLogPageHealthInfoCompletion @ 0x1400047E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
        ...
        *v23 = v24 & 0x40 | 8;
        v2 = a1;
        result = ProcessNvmeHealthInfoLog(a1, a2, v9, 14LL);
        goto LABEL_24;
      }
  ...
  *(_QWORD *)(v7 + 4200) = 0LL;
  if ( *(_BYTE *)(a2 + 3) == 1 )
  {
    if ( (*(_BYTE *)(v13 + 525) & 1) != 0 )
    {
      ...
      *(_BYTE *)(v7 + 4096) = 10;
      *(_BYTE *)(v7 + 4136) = 6;
      *(_QWORD *)(v7 + 4192) = NVMeGetFeaturesCurrentCacheValueCompletion;
      return ProcessCommand(v2, a2);
    }
