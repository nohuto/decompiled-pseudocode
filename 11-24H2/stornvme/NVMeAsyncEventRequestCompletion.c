/*
 * XREFs of NVMeAsyncEventRequestCompletion @ 0x140012380
 * Callers:
 *     <none>
 * Callees:
...
__int16 __fastcall NVMeAsyncEventRequestCompletion(__int64 a1, __int64 a2, __int64 a3)
{
  char v5; // cl
  bool v6; // r14
  __int64 v7; // rbp
    ...
    switch ( (_DWORD)v9 )
    {
      case 0:
        ...
        if ( v21 )
        {
          ...
          {
            *((_QWORD *)&v39 + 1) = 2LL;
            NVMeControllerAsyncReset(a1, 0LL, 0LL, 0LL);
          }
          else
          {
            if ( v21 != 2 )
            {
              ...
              if ( IsNVMeControllerOnFatalError(a1) )
              {
                if ( *(_QWORD *)(a1 + 3936) )
                {
                  NVMeQueueWorkItem(a1, NVMeControllerPanicResetActionWorkItem, 0LL);
                  *(_QWORD *)&v39 = 64LL;
                  goto LABEL_52;
                }
                NVMeControllerAsyncReset(a1, 0LL, 0LL, 0LL);
...
LABEL_52:
        v40 = v39;
        ((void (__fastcall *)(__int64, __int128 *, _QWORD, _QWORD, int, const wchar_t *, __int64, int, int, __int64, const wchar_t *, __int64, const wchar_t *, __int64, const wchar_t *, __int64, const wchar_t *, __int64, _QWORD, _QWORD))SendNVMeEventNotification)(
          a1,
          &v40,
          0LL,
          0LL,
...
LABEL_93:
        ...
        goto LABEL_94;
      case 7:
        if ( *(_QWORD *)(a1 + 3936) && (_BYTE)v20 == 1 )
        {
          if ( (*(_BYTE *)(a1 + 21) & 2) != 0 )
            StorPortExtendedFunction(86LL, a1, 0LL, 1LL);
          LOWORD(v9) = NVMeQueueWorkItem(a1, NVMeControllerPanicResetActionWorkItem, 0LL);
          break;
        }
        ...
        {
LABEL_94:
          LOWORD(v9) = NVMeAllocateDmaBuffer(a1, v19);
          break;
        }
        goto LABEL_92;
    }
LABEL_101:
    if ( v12 )
    {
      ...
      {
        *v12 = 0;
        LOWORD(v9) = NVMeIssueAsyncEventCommand(a1, (__int64)v12);
      }
    }
    return v9;
  }
