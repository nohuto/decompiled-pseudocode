/*
 * XREFs of NVMeHwUnitControl @ 0x14000EC10
 * Callers:
 *     <none>
 * Callees:
 *     NVMeCopyFirmwareRevision @ 0x140001B10 (NVMeCopyFirmwareRevision.c)
...
__int64 __fastcall NVMeHwUnitControl(__int64 a1, int a2, __int64 a3)
{
  ...
  _OWORD Buf2[4]; // [rsp+90h] [rbp-88h] BYREF
    ...
    case 10:
      ...
      *(_DWORD *)(v10 + 20) |= 4u;
      ...
      do
      {
        ...
        NVMeCompletePendingForwardIoRequests(a1, v15, v12, 0, 0, 8);
        v11 = v47 + 1;
        v47 = v11;
      }
...
LABEL_75:
      if ( *(_QWORD *)(a1 + 368) )
      {
        ...
        NVMeCompletePendingForwardIoRequests(a1, a1 + 336, v12, 0, 0, 8);
      }
      return v7;
    case 11:
      v40 = *(_QWORD *)(a1 + 1560);
...
LABEL_131:
          NVMeCopyFirmwareRevision(v40, a3 + 90, 0x10u);
          LOBYTE(v7) = 0;
          return v7;
        }
LABEL_110:
      ...
      if ( v42 )
      {
        ...
        *(_DWORD *)(a3 + 4) = 120;
        ...
        if ( !memcmp((const void *)(v42 + 168), Buf2, 0x40uLL) )
        {
          *(_OWORD *)(a3 + 25) = *(_OWORD *)(v40 + 24);
          *(_OWORD *)(a3 + 41) = *(_OWORD *)(v40 + 40);
          *(_QWORD *)(a3 + 57) = *(_QWORD *)(v40 + 56);
