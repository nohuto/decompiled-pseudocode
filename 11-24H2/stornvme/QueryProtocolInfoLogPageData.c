/*
 * XREFs of QueryProtocolInfoLogPageData @ 0x140011650
 * Callers:
 ...
 *     CopyCachedLogPage @ 0x14001F198 (CopyCachedLogPage.c)
...
LABEL_54:
      ...
      switch ( v25 )
      {
        case 0:
          v23 = v14;
          return CopyCachedLogPage(v13, v23, v16, a2);
        case 5:
          v23 = *(_QWORD *)(a1 + 3712);
          return CopyCachedLogPage(v13, v23, v16, a2);
        case 18:
