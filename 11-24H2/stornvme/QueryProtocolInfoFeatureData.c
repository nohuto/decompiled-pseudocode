/*
 * XREFs of QueryProtocolInfoFeatureData @ 0x140025744
 * Callers:
...
LABEL_5:
  ...
  {
    if ( (*(_DWORD *)(a1 + 12) & 1) != 0 && !v9 && SrbDataBuffer[12] )
      goto LABEL_52;
...
LABEL_102:
  if ( v15 )
  {
    ...
    {
      memset(v32, 0, 4LL * (v15 >> 2));
    }
  }
  *(_BYTE *)(SrbExtension + 4225) = *(_BYTE *)(SrbExtension + 4225) & 0xFD | (v15 != 0 ? 2 : 0) | 1;
  SrbAssignQueueId(a1, a2);
  v28 = v7[12];
  v29 = v7[11];
  *(_QWORD *)(SrbExtension + 4120) = 0LL;
  *(_BYTE *)(SrbExtension + 4096) = 10;
  *(_DWORD *)(SrbExtension + 4100) = v5;
  *(_DWORD *)(SrbExtension + 4136) = v29;
  *(_DWORD *)(SrbExtension + 4140) = v28;
  if ( v9 )
  {
    *(_DWORD *)(SrbExtension + 4136) = v9[4];
    *(_DWORD *)(SrbExtension + 4140) = v9[5];
    *(_DWORD *)(SrbExtension + 4144) = v9[9];
    *(_DWORD *)(SrbExtension + 4148) = v9[10];
    *(_DWORD *)(SrbExtension + 4152) = v9[11];
    *(_DWORD *)(SrbExtension + 4156) = v9[12];
  }
  v30 = *(_BYTE *)(SrbExtension + 4225) & 0xFB | (v15 != 0 ? 4 : 0);
  *(_QWORD *)(SrbExtension + 4192) = QueryProtocolInfoCompletion;
  *(_BYTE *)(SrbExtension + 4225) = v30;
  *(_QWORD *)(SrbExtension + 4160) = v32;
  *(_QWORD *)(SrbExtension + 4168) = 0LL;
  result = 0LL;
  *(_DWORD *)(SrbExtension + 4208) = v15;
  return result;
}
