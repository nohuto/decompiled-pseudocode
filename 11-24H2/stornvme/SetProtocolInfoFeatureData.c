/*
 * XREFs of SetProtocolInfoFeatureData @ 0x14002672C
 * Callers:
...
__int64 __fastcall SetProtocolInfoFeatureData(__int64 a1, __int64 a2)
{
  ...
  v5 = 0;
  SrbDataBuffer = GetSrbDataBuffer(a2, v39);
  v8 = (_DWORD *)(SrbDataBuffer + 28);
  v9 = *(_DWORD *)(SrbDataBuffer + 44);
  if ( (v9 & 0x7FFFFF00) != 0 )
    goto LABEL_8;
...
LABEL_73:
  if ( v18 )
  {
    NVMeAllocateDmaBuffer(a1, v18);
    *(_BYTE *)(a2 + 3) = 4;
    return 3238002691LL;
  }
  else
  {
    *(_BYTE *)(SrbExtension + 4225) = *(_BYTE *)(SrbExtension + 4225) & 0xFD | (v18 != 0 ? 2 : 0) | 1;
    ...
    *(_DWORD *)(SrbExtension + 4136) = v33;
    *(_BYTE *)(SrbExtension + 4096) = 9;
    *(_DWORD *)(SrbExtension + 4100) = v5;
    *(_DWORD *)(SrbExtension + 4140) = v38;
    *(_DWORD *)(SrbExtension + 4144) = v37;
    *(_DWORD *)(SrbExtension + 4148) = v36;
    *(_DWORD *)(SrbExtension + 4152) = v35;
    *(_DWORD *)(SrbExtension + 4156) = v34;
    LOBYTE(v33) = *(_BYTE *)(SrbExtension + 4225) & 0xFB | (v18 != 0 ? 4 : 0);
    *(_QWORD *)(SrbExtension + 4192) = SetProtocolInfoCompletion;
    *(_BYTE *)(SrbExtension + 4225) = v33;
