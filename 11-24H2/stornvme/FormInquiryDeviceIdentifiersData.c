/*
 * XREFs of FormInquiryDeviceIdentifiersData @ 0x1400012F0
 * Callers:
...
LABEL_18:
  ...
  *((_BYTE *)v6 + 7) = v16 - 8;
  ...
  else
  {
    ...
    *((_BYTE *)v6 + 10) = `HexFromUchar'::`2'::hexDigits[(unsigned __int8)v21 >> 4];
    *((_BYTE *)v6 + 9) = `HexFromUchar'::`2'::hexDigits[((unsigned int)v21 >> 8) & 0xF];
    *v20 = `HexFromUchar'::`2'::hexDigits[v21 >> 12];
    ...
    *(_QWORD *)(v6 + 22) = *((_QWORD *)v2 + 7);
    if ( (unsigned int)v9 < *(_DWORD *)(a1 + 224) && (v22 = *(_QWORD *)(a1 + 8 * v9 + 1672)) != 0 )
      ...
      LOWORD(v23) = 0;
    *((_BYTE *)v6 + 55) = `HexFromUchar'::`2'::hexDigits[v23 & 0xF];
    *((_BYTE *)v6 + 54) = `HexFromUchar'::`2'::hexDigits[((unsigned __int64)(unsigned __int16)v23 >> 4) & 0xF];
    v24 = `HexFromUchar'::`2'::hexDigits[((unsigned __int64)(unsigned __int16)v23 >> 8) & 0xF];
    *((_BYTE *)v6 + 52) = `HexFromUchar'::`2'::hexDigits[(unsigned __int64)(unsigned __int16)v23 >> 12];
    *((_BYTE *)v6 + 53) = v24;
