/*
 * XREFs of ControllerReset @ 0x14000F830
 * Callers:
...
__int64 __fastcall ControllerReset(__int64 a1, char a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  ...
  if ( (v11 & 1) != 0 && (v13 & 1) == 0 )
  {
    ...
    if ( v10 )
    {
      while ( (v13 & 1) == 0 )
      {
        ...
        if ( CheckDpcWatchdogTimerExpireSoon(a1, 0, a3, a4) )
        {
          v6 = 1;
          goto LABEL_8;
        }
...
LABEL_29:
  ...
  if ( (_BYTE)v30 )
  {
    ...
    *(_QWORD *)&v32 = v32 | 0x400;
    v33 = v32;
    ((void (__fastcall *)(__int64, __int128 *, _QWORD, _QWORD, int, const wchar_t *, __int64, _DWORD, int, __int64 *, char *, __int64, __int64, __int64, _QWORD, _QWORD))SendNVMeEventNotification)(
      a1,
      &v33,
      0LL,
      0LL,
