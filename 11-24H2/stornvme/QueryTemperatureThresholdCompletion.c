/*
 * XREFs of QueryTemperatureThresholdCompletion @ 0x140026060
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BuildGetFeaturesTemperatureThresholdCommand @ 0x14000D690 (BuildGetFeaturesTemperatureThresholdCommand.c)
...
LABEL_13:
  ...
  if ( v13 )
  {
    ...
    *(_BYTE *)(v6 + 4225) &= ~4u;
    *(_QWORD *)(v6 + 4192) = QueryTemperatureThresholdCompletion;
