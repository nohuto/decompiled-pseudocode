/*
 * XREFs of NVMeSetNonOperationalPowerStatePermissiveMode3 @ 0x14002C4AC
 * Callers:
...
__int64 __fastcall NVMeSetNonOperationalPowerStatePermissiveMode3(__int64 a1, unsigned __int8 a2)
{
  __int64 result; // rax
  int v5; // ecx
  __int64 v6; // r8
