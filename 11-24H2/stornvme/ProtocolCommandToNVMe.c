/*
 * XREFs of ProtocolCommandToNVMe @ 0x1400062C0
 * Callers:
 ...
 *     NVMeValidateProtocolCommandRequest @ 0x140016BA0 (NVMeValidateProtocolCommandRequest.c)
...
__int64 __fastcall ProtocolCommandToNVMe(__int64 a1, __int64 a2)
{
  ...
  if ( v7 )
    ...
    v8 = *(_QWORD *)(v5 + 24);
  v10 = NVMeValidateProtocolCommandRequest(a1);
  if ( v10 )
    goto LABEL_31;
  if ( *(_DWORD *)(v8 + 36) )
  {
...
LABEL_21:
      ...
      *(_BYTE *)(SrbExtension + 4096) = *(_BYTE *)(v8 + 80);
      v19 = *(_DWORD *)(SrbExtension + 4096);
      v20 = *(_DWORD *)(v8 + 80) ^ v19;
      *(_DWORD *)(SrbExtension + 4100) = v16;
      *(_DWORD *)(SrbExtension + 4096) = v19 ^ v20 & 0x300;
  ...
  if ( (unsigned __int8)FillClippedSGL(ScatterGatherList, v22, v12, (unsigned int)v23, &v22) )
  {
