/*
 * XREFs of SmpConfigureObjectDirectories @ 0x140013F20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *a3 )
  {
    do
    {
      ...
      if ( v5 >= 0 )
        ...
        SmpLogFailureString((__int64)"SmpConfigureObjectDirectories", 0x1CEEu, (__int64)DestinationString.Buffer, v5);
      while ( *v3++ )
        ;
    }
    while ( *v3 );
