/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x14000E8C0
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140032B48 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140032B48
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140032B48 - 1)
                                                   + 8256LL);
