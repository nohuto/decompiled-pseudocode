...
LABEL_18:
        ...
        *(_QWORD *)(v10 + 8) = Buffer;
        ...
        {
          v14 = (struct _UNICODE_STRING **)qword_140032AE8;
          if ( *(__int64 **)qword_140032AE8 != &SmpSubSystemsToDefer )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsToDefer;
          v9->Buffer = (PWSTR)v14;
          *v14 = v9;
          qword_140032AE8 = (__int64)v9;
        }
        else
        {
          v13 = (struct _UNICODE_STRING **)qword_140032AD8;
          if ( *(__int64 **)qword_140032AD8 != &SmpSubSystemsRequired )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsRequired;
          v9->Buffer = (PWSTR)v13;
          *v13 = v9;
          qword_140032AD8 = (__int64)v9;
          *(_DWORD *)a6 += 2;
