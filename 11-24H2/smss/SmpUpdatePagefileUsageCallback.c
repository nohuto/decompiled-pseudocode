...
char SmpUpdatePagefileUsageCallback()
{
  ...
  j = 0LL;
  ReturnLength = 0;
  v1 = SmpMemorySize / (unsigned __int64)(unsigned int)dword_140032B48;
  ...
  if ( (int)Heap >= 0 )
  {
    ...
    if ( *((_QWORD *)&v34 + 1) > (unsigned __int64)qword_140032C68 )
    {
      qword_140032C68 = *((_QWORD *)&v34 + 1);
      v3 = *((_QWORD *)&v34 + 1);
    }
    ...
    if ( (int)Heap >= 0 )
    {
      for ( i = 256; ; i = ReturnLength )
      {
        ...
        if ( v6 >= 0 )
        {
          ...
          v9 = j + v40;
          v10 = 0x400000000uLL / (unsigned int)dword_140032B48 + v3;
          if ( 10 * v3 / 9uLL <= v10 )
            v10 = 10 * v3 / 9uLL;
          if ( v10 > v1 )
          {
          ...
          if ( v9 > 0xFFFFFFFF )
            LODWORD(v9) = -1;
          dword_140032C74[(unsigned int)NumOfElements % 0xF0] = v9;
