/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14001A338
 * Callers:
 *     wil_details_AreDependenciesEnabled @ 0x140019E28 (wil_details_AreDependenciesEnabled.c)
 *     wil_details_IsEnabledFallback @ 0x14001A5C0 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14001A4AC (wil_details_GetCurrentFeatureEnabledState.c)
