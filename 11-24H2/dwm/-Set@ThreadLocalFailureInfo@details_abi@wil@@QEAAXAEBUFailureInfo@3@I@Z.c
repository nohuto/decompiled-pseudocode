/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x14000A4F0
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x14000A348 (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x14000A374 (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
