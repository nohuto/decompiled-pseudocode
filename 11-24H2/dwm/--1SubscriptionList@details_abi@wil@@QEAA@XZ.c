/*
 * XREFs of ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1400045B8
 * Callers:
 *     ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x140004114 (--1FeatureStateManager@details@wil@@QEAA@XZ.c)
 *     ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x140006C38 (--1FeatureStateData@details_abi@wil@@QEAA@XZ.c)
 * Callees:
