 ...
 *     __scrt_get_dyn_tls_init_callback @ 0x140004F40 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_get_dyn_tls_dtor_callback @ 0x140004F50 (__scrt_get_dyn_tls_dtor_callback.c)
 *     __scrt_fastfail @ 0x140004F70 (__scrt_fastfail.c)
 *     __scrt_get_show_window_mode @ 0x1400050D8 (__scrt_get_show_window_mode.c)
 *     __scrt_is_managed_app @ 0x140005124 (__scrt_is_managed_app.c)
 *     _initterm_0 @ 0x1400056CC (_initterm_0.c)
 *     _initterm_e_0 @ 0x1400056D8 (_initterm_e_0.c)
 *     _c_exit_0 @ 0x1400056E4 (_c_exit_0.c)
 *     _register_thread_local_exe_atexit_callback_0 @ 0x1400056F0 (_register_thread_local_exe_atexit_callback_0.c)
 *     _o__cexit_0 @ 0x140005738 (_o__cexit_0.c)
 *     _o__exit_0 @ 0x140005768 (_o__exit_0.c)
 *     _o__get_wide_winmain_command_line_0 @ 0x140005774 (_o__get_wide_winmain_command_line_0.c)
 *     _seh_filter_exe @ 0x1400057C8 (_seh_filter_exe.c)
 *     _o_exit_0 @ 0x1400057F8 (_o_exit_0.c)
