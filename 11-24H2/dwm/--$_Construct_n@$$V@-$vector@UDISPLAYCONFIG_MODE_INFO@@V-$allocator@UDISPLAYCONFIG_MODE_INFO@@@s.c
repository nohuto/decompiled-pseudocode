/*
 * XREFs of ??$_Construct_n@$$V@?$vector@UDISPLAYCONFIG_MODE_INFO@@V?$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@AEAAX_K@Z @ 0x14000D2D0
 * Callers:
 ...
 *     ??1?$_Tidy_guard@V?$vector@UDISPLAYCONFIG_MODE_INFO@@V?$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@@std@@QEAA@XZ @ 0x14000D61C (--1-$_Tidy_guard@V-$vector@UDISPLAYCONFIG_MODE_INFO@@V-$allocator@UDISPLAYCONFIG_MODE_INFO@@@std.c)
 */
...
void __fastcall std::vector<DISPLAYCONFIG_MODE_INFO>::_Construct_n<>(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    v8 = a2;
    v4 = std::_Allocate_at_least_helper<std::allocator<DISPLAYCONFIG_MODE_INFO>>((__int64)a1, &v8);
    *a1 = v4;
    v5 = v4;
    a1[2] = &v4[8 * v2];
    v6 = v4;
