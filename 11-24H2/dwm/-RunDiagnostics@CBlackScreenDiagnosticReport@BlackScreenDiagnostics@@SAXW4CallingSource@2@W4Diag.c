/*
 * XREFs of ?RunDiagnostics@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@SAXW4CallingSource@2@W4DiagnosticFlags@2@AEBU_GUID@@@Z @ 0x14000E394
 * Callers:
 ...
 *     ?RunDiagnosticsFromLongPowerButtonHold@BlackScreenDiagnostics@@YAXAEBU_GUID@@@Z @ 0x14000E5C0 (-RunDiagnosticsFromLongPowerButtonHold@BlackScreenDiagnostics@@YAXAEBU_GUID@@@Z.c)
 * Callees:
  ...
  if ( TryAcquireSRWLockExclusive(&BlackScreenDiagnostics::CBlackScreenDiagnosticReport::s_srwLock) )
  {
    ...
    if ( (unsigned int)dword_1400180D8 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1400180D8, 0x800000000000LL) )
      {
        ...
        v16 = 16;
        v13 = 8;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1400180D8, byte_140013CE8, 0LL, 0LL, 6u, &v11);
      }
    }
