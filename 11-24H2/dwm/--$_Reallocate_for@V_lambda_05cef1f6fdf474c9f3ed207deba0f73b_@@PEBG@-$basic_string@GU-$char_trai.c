/*
 * XREFs of ??$_Reallocate_for@V_lambda_05cef1f6fdf474c9f3ed207deba0f73b_@@PEBG@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEAAAEAV01@_KV_lambda_05cef1f6fdf474c9f3ed207deba0f73b_@@PEBG@Z @ 0x14000D4A8
 * Callers:
 ...
 *     ?_Calculate_growth@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEBA_K_K@Z @ 0x14000E674 (-_Calculate_growth@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@AEBA_K_K@Z.c)
 *     ?_Throw_bad_array_new_length@std@@YAXXZ @ 0x14000E708 (-_Throw_bad_array_new_length@std@@YAXXZ.c)
 *     ?_Xlen_string@std@@YAXXZ @ 0x14000E83C (-_Xlen_string@std@@YAXXZ.c)
        ...
        const void *a4)
{
  ...
  *(_WORD *)((char *)v11 + v10) = 0;
  if ( v7 > 7 )
    std::_Deallocate<16,0>(*(char **)a1, 2 * v7 + 2);
  *(_QWORD *)a1 = v11;
  return a1;
}
