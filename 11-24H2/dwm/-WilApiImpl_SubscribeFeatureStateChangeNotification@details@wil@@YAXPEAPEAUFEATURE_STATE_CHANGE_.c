/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x14000B0F0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_14001C3B8);
      v8 = &stru_14001C3B8;
      if ( qword_14001C428
        || (qword_14001C428 = 0LL,
                             ...
                             &qword_14001C428)) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_14001C3E0,
          this,
          (void (*)(void *))a2,
          a3);
      }
