/*
 * XREFs of ??$_Allocate_at_least_helper@V?$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@YAPEAUDISPLAYCONFIG_MODE_INFO@@AEAV?$allocator@UDISPLAYCONFIG_MODE_INFO@@@0@AEA_K@Z @ 0x14000D0FC
 * Callers:
...
_QWORD *__fastcall std::_Allocate_at_least_helper<std::allocator<DISPLAYCONFIG_MODE_INFO>>(__int64 a1, _QWORD *a2)
{
