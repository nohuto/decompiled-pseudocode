/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x140009D24
 * Callers:
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  while ( 1 )
  {
    ...
    v23 = 0;
    v22 = 4096;
    WnfStateData = wil_details_NtQueryWnfStateData((_DWORD)v7, v8, v9, (unsigned int)&v23, (__int64)v39, (__int64)&v22);
    ...
    *((_QWORD *)&v26 + 1) = &v25;
    ...
    if ( !v32 )
      goto LABEL_11;
    updated = wil_details_NtUpdateWnfStateData((_DWORD)v7, v29, v30 - (int)v29, v15, v20, v23, 1);
    if ( updated != -1073741823 )
    {
      if ( updated )
        wil_details_NtUpdateWnfStateData((_DWORD)v7, v29, v30 - v29, v17, v21, 0, 0);
LABEL_11:
