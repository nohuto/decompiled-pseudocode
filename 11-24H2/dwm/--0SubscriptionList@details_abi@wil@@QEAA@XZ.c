/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x140004404
 * Callers:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x140003D48 (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
