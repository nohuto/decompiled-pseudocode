/*
 * XREFs of ?s_LpcCommandHandler@CDwmAppHost@@CAJPEAUIPortMessage@@PEBUPORT_CONTEXT@@PEAH2@Z @ 0x140002280
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  if ( (*(unsigned __int16 *)(v8 + 4) & 0xFFFF00FF) == 1 )
  {
    ...
    {
      case 0x20000001:
        if ( *(_DWORD *)(v8 + 8) == (_DWORD)qword_14001C4D0 )
        {
      ...
      case 0x20000003:
        if ( *(_DWORD *)(v8 + 8) == (_DWORD)qword_14001C4D0 )
        {
          CSettingsManager::Cleanup((CSettingsManager *)qword_14001C4E8);
    ...
    if ( *(_DWORD *)(v8 + 40) == 536870914 )
    {
      if ( *(_DWORD *)(v8 + 8) == (_DWORD)qword_14001C4D0 )
        CSettingsManager::PropagateUserLogon(
          (CSettingsManager *)qword_14001C4E8,
          *(HKEY *)(v8 + 52),
          *(HKEY *)(v8 + 60),
          *(HKEY *)(v8 + 68),
          *(_DWORD *)(v8 + 76) != 0);
...
LABEL_6:
        ...
        if ( (_BYTE)v9 )
        {
          *a3 = 0;
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x21Du, 0LL);
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x1BCu, 0LL);
          }
          return v13;
        }
      }
