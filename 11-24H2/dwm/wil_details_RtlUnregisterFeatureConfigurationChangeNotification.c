/*
 * XREFs of wil_details_RtlUnregisterFeatureConfigurationChangeNotification @ 0x14000BDC8
 * Callers:
 ...
 * Callees:
 *     ?wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z @ 0x14000B94C (-wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z.c)
