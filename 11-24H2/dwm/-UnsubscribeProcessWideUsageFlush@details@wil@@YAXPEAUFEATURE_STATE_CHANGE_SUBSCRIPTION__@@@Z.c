/*
 * XREFs of ?UnsubscribeProcessWideUsageFlush@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x14000B000
 * Callers:
  ...
  if ( this )
  {
    if ( qword_14001C3B0 )
      wil::details_abi::SubscriptionList::Unsubscribe(
        (struct _RTL_CRITICAL_SECTION *)qword_14001C3B0 + 5,
        (RTL_SRWLOCK *)qword_14001C3B0,
        this);
  }
}
