/*
 * XREFs of ?GetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGPEAK@Z @ 0x14000285C
 * Callers:
 *     ?ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z @ 0x140002660 (-ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z.c)
 ...
 *     ?GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x140003C20 (-GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 *     ?GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x14000CA40 (-GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 * Callees:
 *     <none>
 */
