/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x18000ED5C
 * Callers:
 ...
 * Callees:
 *     __std_find_trivial_8 @ 0x180002050 (__std_find_trivial_8.c)
 ...
 *     memmove_0 @ 0x18001155C (memmove_0.c)
 */
...
void __fastcall DoStackCapture(int a1, int a2, unsigned __int64 a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_18001AE54, 1, 0) )
  {
