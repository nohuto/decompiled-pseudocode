/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x18000CA54
 * Callers:
        ...
        _unnamed_type_gDwmInitTelemetryAggregator_ *this)
{
  ...
  if ( (gDwmInitTelemetryAggregator
     || (_DWORD)qword_18001AE44
     || __PAIR64__(HIDWORD(qword_18001AE44), 0) != (unsigned int)qword_18001AE4C)
    ...
    && (qword_18001A018 & 0x400000000000LL) == qword_18001A018 )
  {
    ...
    v10 = 16LL;
    v8 = 8LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_18001A000, byte_1800159D6, 0LL, 0LL, 9u, &v6);
  }
}
