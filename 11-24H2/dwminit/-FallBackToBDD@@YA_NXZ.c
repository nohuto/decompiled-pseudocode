/*
 * XREFs of ?FallBackToBDD@@YA_NXZ @ 0x18000B618
 * Callers:
...
bool FallBackToBDD(void)
{
  ...
  if ( LibraryW )
  {
    ...
    if ( ProcAddress )
    {
      ...
      if ( v0 >= 0 )
      {
        LODWORD(qword_18001AE44) = qword_18001AE44 + 1;
        v6 = (unsigned int)(HIDWORD(qword_18001AE4C) + 1);
        HIDWORD(qword_18001AE4C) = v6;
        if ( (int)v6 > 10 )
        {
