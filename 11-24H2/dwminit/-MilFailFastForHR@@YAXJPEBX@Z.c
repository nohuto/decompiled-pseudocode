/*
 * XREFs of ?MilFailFastForHR@@YAXJPEBX@Z @ 0x18000EEF8
 * Callers:
 *     ModuleFailFastForHRESULT @ 0x18000EA58 (ModuleFailFastForHRESULT.c)
 *     ?WilFailFastHook@@YA_NAEBUFailureInfo@wil@@@Z @ 0x18000F190 (-WilFailFastHook@@YA_NAEBUFailureInfo@wil@@@Z.c)
 * Callees:
