/*
 * XREFs of ?ShouldRestartSession@@YA_NU_FILETIME@@@Z @ 0x18000CF9C
 * Callers:
...
char __fastcall ShouldRestartSession(struct _FILETIME a1)
{
  ...
  if ( pvData != 1 )
  {
    ...
    if ( !byte_18001AD20 )
      goto LABEL_13;
    if ( (unsigned __int64)(*(_QWORD *)&a1 - qword_18001AE28) >= 0x23C34600 )
    {
      v3 = 0;
      byte_18001AD20 = 0;
    }
...
LABEL_13:
      byte_18001AD20 = 1;
      v4 = 0;
      qword_18001AE28 = (__int64)a1;
    }
    v2 = 0;
    goto LABEL_15;
  }
  if ( FallBackToBDD() || byte_18001AD60 )
  {
    v2 = 0;
    byte_18001AD60 = 1;
  }
