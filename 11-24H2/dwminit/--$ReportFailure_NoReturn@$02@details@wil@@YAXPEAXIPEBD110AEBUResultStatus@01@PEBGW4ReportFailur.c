/*
 * XREFs of ??$ReportFailure_NoReturn@$02@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x1800040D4
 * Callers:
 ...
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180007970 (-RecordFailFast@details@wil@@YAHJ@Z.c)
