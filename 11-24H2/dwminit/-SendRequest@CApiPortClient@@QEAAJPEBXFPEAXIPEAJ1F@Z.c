/*
 * XREFs of ?SendRequest@CApiPortClient@@QEAAJPEBXFPEAXIPEAJ1F@Z @ 0x18000FB24
 * Callers:
 ...
 *     ?SendComplexSyncRequest@CPortClient@@QEAAJKPEBXFPEAXI1FPEAJ@Z @ 0x18000FEC4 (-SendComplexSyncRequest@CPortClient@@QEAAJKPEBXFPEAXI1FPEAJ@Z.c)
        ...
        int *a6)
{
  ...
  if ( !byte_18001AE08 )
  {
    ...
    {
      v10 = (volatile signed __int32 *)qword_18001ADD8;
      if ( qword_18001ADD8 )
