/*
 * XREFs of __tailMerge_ext_ms_win_rtcore_ntuser_sysparams_l1_1_0_dll @ 0x18000342A
 * Callers:
 *     __imp_load_EnumDisplayDevicesW @ 0x1800034A9 (__imp_load_EnumDisplayDevicesW.c)
 * Callees:
