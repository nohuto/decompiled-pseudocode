/*
 * XREFs of ?TraceLoggingWriteEtw@@YAXW4DwmInitEtwType@@JI@Z @ 0x18000D0FC
 * Callers:
...
ULONG __fastcall TraceLoggingWriteEtw(int a1, int a2, int a3)
{
  ...
  if ( (unsigned int)dword_18001A000 > 4 )
  {
    ...
    v20 = 16LL;
    v12 = 16LL;
    return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_18001A000, byte_180015AA2, 0LL, 0LL, 8u, &v8);
  }
  return result;
}
