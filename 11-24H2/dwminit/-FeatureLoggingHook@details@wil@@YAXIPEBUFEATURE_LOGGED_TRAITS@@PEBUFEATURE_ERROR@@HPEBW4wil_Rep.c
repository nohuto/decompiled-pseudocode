/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x180010E30
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v12 && *v12 )
  {
    ...
    else if ( a6 )
    {
        ...
        && (*(_QWORD *)(v21 + 24) & 4LL) == *(_QWORD *)(v21 + 24) )
      {
        ...
        v59 = 1;
        v56 = 2;
        tlgWriteTransfer_EventWriteTransfer(v21, byte_180015E80, 0LL, 0LL, 0xAu, &v45);
      }
    }
    else if ( a3 )
    {
