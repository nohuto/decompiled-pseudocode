/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_LogonUIAlwaysHangCaptured@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18000B968
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_LogonUIAlwaysHangCaptured>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *a2 = 0LL;
  v3 = *(_DWORD *)Feature_LogonUIAlwaysHangCaptured__descriptor;
  *(_DWORD *)a2 = *(_DWORD *)Feature_LogonUIAlwaysHangCaptured__descriptor;
  if ( (v3 & 6) != 6 )
  {
    v4 = wil::details::EnsureSubscribedToFeatureConfigurationChanges(a1);
    v13 = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_LogonUIAlwaysHangCaptured>::GetCurrentFeatureEnabledState(
      v6,
      &v14,
      &v13);
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_LogonUIAlwaysHangCaptured__descriptor, v9, i);
      if ( i == v11 )
        break;
    }
    if ( (i & 4) == 0 )
      wil::details::SubscribeFeatureStateCacheToConfigurationChanges(
        (volatile signed __int32 *)Feature_LogonUIAlwaysHangCaptured__descriptor,
        3,
        v5);
    if ( (*(_DWORD *)a2 & 2) == 0 )
