/*
 * XREFs of ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18000EF88
 * Callers:
 ...
 *     ?WilResultLoggingCallback_MaybeFailFast@@YAXAEBUFailureInfo@wil@@@Z @ 0x18000F1C0 (-WilResultLoggingCallback_MaybeFailFast@@YAXAEBUFailureInfo@wil@@@Z.c)
...
LABEL_22:
  ...
  else
  {
    ...
    {
      v12 = 0;
      a2 = (const int *const)&unk_180014DF8;
      a3 = 10;
    }
    while ( a4 != *a2 )
    {
