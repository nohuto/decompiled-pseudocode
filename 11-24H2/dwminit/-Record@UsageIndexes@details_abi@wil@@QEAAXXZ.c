/*
 * XREFs of ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18000768C
 * Callers:
 *     ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x180004BEC (--1FeatureStateData@details_abi@wil@@QEAA@XZ.c)
