/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x18000AC58
 * Callers:
 ...
 *     ?ShouldRestartSession@@YA_NU_FILETIME@@@Z @ 0x18000CF9C (-ShouldRestartSession@@YA_NU_FILETIME@@@Z.c)
...
__int64 CleanupOldDwmProcess(void)
{
  ...
  if ( v0 < 0 )
  {
    DoStackCaptureDirect(v0, 0x46Eu);
LABEL_27:
    DwmpSignalSessionShutdown();
    v1 = -2147467259;
    ++HIDWORD(qword_18001AE44);
