/*
 * XREFs of ??$ReportFailure_Return@$00@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x18000434C
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x180007AEC (-RecordReturn@details@wil@@YAHJ@Z.c)
