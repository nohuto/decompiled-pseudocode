/*
 * XREFs of ??1?$out_param_t@V?$unique_ptr@UAUDIO_VOLUME_NOTIFICATION_DATA2@@U?$default_delete@UAUDIO_VOLUME_NOTIFICATION_DATA2@@@std@@@std@@@details@wil@@QEAA@XZ @ 0x14005862C
 * Callers:
