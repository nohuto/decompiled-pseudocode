/*
 * XREFs of _GetCompositeModuleInfo_::_1_::catch$32 @ 0x140094E1D
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GetCompositeModuleInfo_::_1_::catch_32(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
