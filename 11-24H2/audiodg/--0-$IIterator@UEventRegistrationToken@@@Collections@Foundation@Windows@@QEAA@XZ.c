/*
 * XREFs of ??0?$IIterator@UEventRegistrationToken@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x140076420
 * Callers:
 *     ??0?$ImplementsHelper@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$0A@U?$IIterator@UEventRegistrationToken@@@Collections@Foundation@Windows@@UIWeakReferenceSource@@@Details@WRL@Microsoft@@QEAA@XZ @ 0x140076494 (--0-$ImplementsHelper@U-$RuntimeClassFlags@$00@WRL@Microsoft@@$0A@U-$IIterator@UEventRegistratio.c)
 ...
 * Callees:
 *     ??0?$IVectorView_impl@UEventRegistrationToken@@$0A@@Collections@Foundation@Windows@@QEAA@XZ @ 0x140076444 (--0-$IVectorView_impl@UEventRegistrationToken@@$0A@@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
