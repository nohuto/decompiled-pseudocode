/*
 * XREFs of ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140042B78
 * Callers:
 *     ??_EHandleSendReceiveServer@@UEAAPEAXI@Z @ 0x140042B40 (--_EHandleSendReceiveServer@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14009111C (-SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ.c)
 */
