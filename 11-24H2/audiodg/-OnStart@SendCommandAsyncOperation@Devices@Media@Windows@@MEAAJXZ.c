/*
 * XREFs of ?OnStart@SendCommandAsyncOperation@Devices@Media@Windows@@MEAAJXZ @ 0x14007AD60
 * Callers:
 *     <none>
 * Callees:
        ...
        Windows::Media::Devices::SendCommandAsyncOperation *this)
{
  ...
  v16 = 0LL;
  v15 = 0LL;
  wil::com_ptr_t<ISubmix,wil::err_returncode_policy>::operator=(&v16, *(_QWORD *)(*((_QWORD *)this + 22) + 96LL));
  v2 = v16;
  if ( v16 )
  {
    ...
    v8 = v6(v2, *((_QWORD *)this + 22), *((_QWORD *)this + 23), &v15);
    v3 = v8;
    if ( v8 >= 0 )
    {
      v9 = v15;
