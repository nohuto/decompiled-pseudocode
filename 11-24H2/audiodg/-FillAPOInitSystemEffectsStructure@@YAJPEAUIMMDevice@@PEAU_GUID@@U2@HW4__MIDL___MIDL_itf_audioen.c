/*
 * XREFs of ?FillAPOInitSystemEffectsStructure@@YAJPEAUIMMDevice@@PEAU_GUID@@U2@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@AEAUAPOInitSystemEffects2@@@Z @ 0x140033DF0
 * Callers:
...
LABEL_28:
    ...
    if ( v23 >= 0 )
    {
      ...
      if ( v25 >= 0 )
      {
        ...
        v52 = 0LL;
        v53 = 1;
        v12 = (*(__int64 (__fastcall **)(LPVOID, void *, _QWORD, _QWORD, struct KSDATAFORMAT_WAVEFORMATEX **))(v26 + 304))(
                v44,
                v43,
                v22,
                0LL,
