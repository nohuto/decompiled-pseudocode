/*
 * XREFs of ?LoadStringW@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAHPEAUHINSTANCE__@@I@Z @ 0x14006B6C0
 * Callers:
 ...
 *     _o_wmemcpy_s_0 @ 0x14005A0A8 (_o_wmemcpy_s_0.c)
