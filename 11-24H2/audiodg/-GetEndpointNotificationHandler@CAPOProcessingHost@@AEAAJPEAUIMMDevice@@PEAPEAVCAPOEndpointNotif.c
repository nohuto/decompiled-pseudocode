/*
 * XREFs of ?GetEndpointNotificationHandler@CAPOProcessingHost@@AEAAJPEAUIMMDevice@@PEAPEAVCAPOEndpointNotificationsHandler@@@Z @ 0x140017CC8
 * Callers:
        ...
        struct CAPOEndpointNotificationsHandler **a3)
{
  ...
  __int64 v9; // r8
  const char *v10; // r9
  struct CAPOEndpointNotificationsHandler *v11; // rcx
  __int64 result; // rax
  int v13; // eax
  unsigned int v14; // edi
  LPVOID pv; // [rsp+20h] [rbp-78h] BYREF
  struct IMMDevice *v16; // [rsp+28h] [rbp-70h] BYREF
  ...
  try
  {
    ...
    else
    {
      ...
      do
        ++v9;
      while ( *((_WORD *)pv + v9) );
      std::wstring::_Construct<1,unsigned short const *>(&v19, pv);
      ...
      if ( *((_QWORD *)&v20 + 1) > 7uLL )
        std::_Deallocate<16,0>(v19, 2LL * *((_QWORD *)&v20 + 1) + 2);
      if ( v18[0] == *((_QWORD *)this + 11) )
      {
        v13 = Microsoft::WRL::Details::MakeAndInitialize<CAPOEndpointNotificationsHandler,CAPOEndpointNotificationsHandler,IMMDevice * &>(
                a3,
                &v16);
        v14 = v13;
        if ( v13 < 0 )
      ...
      {
        v11 = *(struct CAPOEndpointNotificationsHandler **)(v18[0] + 48LL);
        if ( v11 )
        {
          *a3 = v11;
          (*(void (__fastcall **)(struct CAPOEndpointNotificationsHandler *))(*(_QWORD *)v11 + 8LL))(v11);
        }
        else
        {
          *a3 = 0LL;
