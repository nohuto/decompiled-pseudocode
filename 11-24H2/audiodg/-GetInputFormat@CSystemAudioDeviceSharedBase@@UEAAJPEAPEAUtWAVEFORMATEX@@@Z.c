/*
 * XREFs of ?GetInputFormat@CSystemAudioDeviceSharedBase@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x140043260
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, struct tWAVEFORMATEX **))(*(_QWORD *)v5 + 56LL))(v5, a2);
  if ( v8 )
