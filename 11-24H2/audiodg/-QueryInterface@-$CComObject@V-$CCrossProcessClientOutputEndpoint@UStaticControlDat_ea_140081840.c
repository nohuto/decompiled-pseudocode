/*
 * XREFs of ?QueryInterface@?$CComObject@V?$CCrossProcessClientOutputEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@@ATL@@WBPA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x140081840
 * Callers:
 *     <none>
 * Callees:
 *     <none>
