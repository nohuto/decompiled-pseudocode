/*
 * XREFs of ??$_Emplace_reallocate@AEA_JAEAVWeakRef@WRL@Microsoft@@@?$vector@UBridgeEndpointRecord@@V?$allocator@UBridgeEndpointRecord@@@std@@@std@@AEAAPEAUBridgeEndpointRecord@@QEAU2@AEA_JAEAVWeakRef@WRL@Microsoft@@@Z @ 0x140066E88
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  v7 = ((__int64)xmmword_1400C46D8 - g_bridgeEndpointRegistry) >> 4;
  v8 = 0xFFFFFFFFFFFFFFFLL;
  if ( v7 == 0xFFFFFFFFFFFFFFFLL )
    std::_Xlength_error("vector too long");
  v9 = v7 + 1;
  v10 = (*((_QWORD *)&xmmword_1400C46D8 + 1) - g_bridgeEndpointRegistry) >> 4;
  v11 = v10 >> 1;
  ...
  try
  {
    ...
    *((_QWORD *)v15 + 1) = *a4;
    ...
    v21 = (__int64)v15;
    v16 = xmmword_1400C46D8;
    v17 = (_QWORD *)v14;
    v18 = g_bridgeEndpointRegistry;
    if ( a2 != (_QWORD)xmmword_1400C46D8 )
    {
    ...
    *(_QWORD *)&xmmword_1400C46D8 = v14 + 16 * v9;
    *((_QWORD *)&xmmword_1400C46D8 + 1) = v14 + 16 * v8;
    result = v15;
  }
  catch ( ... )
  {
