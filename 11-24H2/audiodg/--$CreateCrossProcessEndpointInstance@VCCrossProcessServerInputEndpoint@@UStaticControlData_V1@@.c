/*
 * XREFs of ??$CreateCrossProcessEndpointInstance@VCCrossProcessServerInputEndpoint@@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@YAJU_GUID@@AEBU0@PEAPEAX@Z @ 0x140053520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateCrossProcessEndpointInstance<CCrossProcessServerInputEndpoint,StaticControlData_V1,VolatileControlData_V0,ControlData_V1>(
        _OWORD *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  v8 = AERTAllocate(0x2D8uLL, v6, v7);
  v14 = v8;
  if ( v8 )
    v9 = (_OWORD *)ATL::CComObject<CCrossProcessServerInputEndpoint<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>>::CComObject<CCrossProcessServerInputEndpoint<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>>(v8);
  else
    v9 = 0LL;
  v14 = v9;
  if ( v9 )
