/*
 * XREFs of ?GetCurrentPadding@?$CCrossProcessBaseEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@UEAAXPEA_JPEAUAE_CURRENT_POSITION@@@Z @ 0x140051820
 * Callers:
...
__int64 __fastcall CCrossProcessBaseEndpoint<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>::GetCurrentPadding(
        __int64 a1,
        _QWORD *a2)
{
  ...
  result = CCrossProcessBaseEndpoint<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>::IsValidOffset(
             a1 - 8,
             v4);
  if ( (_BYTE)result
    && (result = CCrossProcessBaseEndpoint<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>::IsValidOffset(
