/*
 * XREFs of ?WinMain@?$CAtlExeModuleT@VCAudioDGModule@@@ATL@@QEAAHH@Z @ 0x14001D344
 * Callers:
 *     wWinMain @ 0x14004AAF4 (wWinMain.c)
 * Callees:
 *     ?ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z @ 0x14001D038 (-ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z.c)
