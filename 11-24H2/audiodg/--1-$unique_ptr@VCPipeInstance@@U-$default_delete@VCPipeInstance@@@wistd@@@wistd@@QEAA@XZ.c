/*
 * XREFs of ??1?$unique_ptr@VCPipeInstance@@U?$default_delete@VCPipeInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x14004952C
 * Callers:
 *     _CAudioDeviceGraph::Initialize_::_1_::dtor$6 @ 0x140095ACD (_CAudioDeviceGraph--Initialize_--_1_--dtor$6.c)
 * Callees:
 *     <none>
 */
