/*
 * XREFs of ?SetAudioFormat@CAudioMediaType@@IEAAJPEBUtWAVEFORMATEX@@IH@Z @ 0x14005AF50
 * Callers:
 ...
 *     ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14005B094 (-ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z.c)
