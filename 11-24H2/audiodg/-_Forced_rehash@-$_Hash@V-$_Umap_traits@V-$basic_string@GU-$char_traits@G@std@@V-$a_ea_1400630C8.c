        ...
        unsigned __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 48) = v6 - 1;
  ...
  while ( v8 != (_QWORD *)v4 )
  {
    ...
    appended = std::_Fnv1a_append_bytes((__int64)v7, v11, 2LL * v8[4]);
    v14 = *(_QWORD *)(a1 + 24);
    v15 = 2 * (*(_QWORD *)(a1 + 48) & appended);
    if ( *(_QWORD *)(v14 + 16 * (*(_QWORD *)(a1 + 48) & appended)) == v4 )
    {
      *(_QWORD *)(v14 + 16 * (*(_QWORD *)(a1 + 48) & appended)) = v13;
LABEL_9:
    ...
    if ( !std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>::operator()<std::wstring,std::wstring>(
            (__int64)v7,
            v10,
            (_QWORD *)(*(_QWORD *)(v14 + 16 * (*(_QWORD *)(a1 + 48) & appended) + 8) + 16LL)) )
    {
      v17 = *v16;
      if ( *v16 != v13 )
      {
