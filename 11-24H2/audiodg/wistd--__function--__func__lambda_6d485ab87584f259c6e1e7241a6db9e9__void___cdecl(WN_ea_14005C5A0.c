/*
 * XREFs of wistd::__function::__func__lambda_6d485ab87584f259c6e1e7241a6db9e9__void___cdecl(WNF_AUDIO_ORIENTATION_STATE_const_&)_::_scalar_deleting_destructor_ @ 0x14005C5A0
 * Callers:
 *     <none>
 * Callees:
