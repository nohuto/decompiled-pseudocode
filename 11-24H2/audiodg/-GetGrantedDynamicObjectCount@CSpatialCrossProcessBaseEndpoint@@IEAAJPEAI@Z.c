/*
 * XREFs of ?GetGrantedDynamicObjectCount@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14008E07C
 * Callers:
 ...
 *     ?GetGrantedDynamicObjectCount@CSpatialCrossProcessClientEndpoint@@UEAAJPEAI@Z @ 0x14008F660 (-GetGrantedDynamicObjectCount@CSpatialCrossProcessClientEndpoint@@UEAAJPEAI@Z.c)
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  *a2 = 0;
  ...
  if ( (v4 & 0x80000000) == 0 )
  {
    while ( 1 )
    {
      v6 = _InterlockedCompareExchange((volatile signed __int32 *)this[163] + 5, 0, 0);
      if ( v6 > *((_DWORD *)this + 73) )
        break;
      if ( (_InterlockedCompareExchange((volatile signed __int32 *)this[163] + 16, 0, 0) & 0x40) != 0 )
      {
        *a2 = v6;
      }
      else
      {
        v7 = _InterlockedCompareExchange64((volatile signed __int64 *)this[163] + 7, 0LL, 0LL);
        v8 = v7 + HIDWORD(v7);
        if ( v6 < (int)v7 + HIDWORD(v7) )
          v8 = v6;
        *a2 = v8;
      }
      if ( v6 == _InterlockedCompareExchange((volatile signed __int32 *)this[163] + 5, 0, 0) )
        return v4;
    }
    v4 = -2005139387;
  }
