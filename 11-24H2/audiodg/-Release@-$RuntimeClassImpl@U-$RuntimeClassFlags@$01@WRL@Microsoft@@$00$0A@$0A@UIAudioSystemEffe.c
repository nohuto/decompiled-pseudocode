/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIAudioSystemEffectsPropertyChangeNotificationClient@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x1400222B0
 * Callers:
 *     ??1?$com_ptr_t@VCCpuMemoryBufferFactory@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x14002239C (--1-$com_ptr_t@VCCpuMemoryBufferFactory@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
 ...
 *     ??1?$ComPtr@VCCpuMemoryBufferFactory@@@WRL@Microsoft@@QEAA@XZ @ 0x14004AD3C (--1-$ComPtr@VCCpuMemoryBufferFactory@@@WRL@Microsoft@@QEAA@XZ.c)
 * Callees:
