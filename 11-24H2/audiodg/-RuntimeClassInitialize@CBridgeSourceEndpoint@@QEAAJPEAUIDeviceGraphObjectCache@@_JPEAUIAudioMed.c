/*
 * XREFs of ?RuntimeClassInitialize@CBridgeSourceEndpoint@@QEAAJPEAUIDeviceGraphObjectCache@@_JPEAUIAudioMediaType@@I@Z @ 0x140067900
 * Callers:
...
LABEL_3:
  ...
  if ( v16 >= 0 )
  {
    ...
    v18 = xmmword_1400C46D8;
    if ( (_QWORD)xmmword_1400C46D8 == *((_QWORD *)&xmmword_1400C46D8 + 1) )
    {
    ...
    else
    {
      ...
      *(_QWORD *)&xmmword_1400C46D8 = xmmword_1400C46D8 + 16;
    }
