/*
 * XREFs of ?GetModuleInfo@@YAXPEBGW4APO_TYPE@@AEBU_GUID@@PEAUIComCatalog@@PEAPEAG44PEA_NPEAUIPropertyStore@@@Z @ 0x140016478
 * Callers:
 ...
 *     ?IsSafeToCoCreateForCapabilityChecks@@YA_NPEBG0@Z @ 0x140065D50 (-IsSafeToCoCreateForCapabilityChecks@@YA_NPEBG0@Z.c)
 */
