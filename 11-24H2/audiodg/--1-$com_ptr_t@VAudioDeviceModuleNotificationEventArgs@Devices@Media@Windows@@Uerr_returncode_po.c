/*
 * XREFs of ??1?$com_ptr_t@VAudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x140058738
 * Callers:
 ...
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$8 @ 0x14009503D (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$8.c)
 * Callees:
