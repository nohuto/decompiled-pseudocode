/*
 * XREFs of ?put_Completed@SendCommandAsyncOperation@Devices@Media@Windows@@UEAAJPEAU?$IAsyncOperationCompletedHandler@PEAVModuleCommandResult@Devices@Media@Windows@@@Foundation@4@@Z @ 0x14007EA30
 * Callers:
 *     <none>
 * Callees:
