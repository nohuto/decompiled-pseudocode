/*
 * XREFs of ?ZeroOutObject@CSpatialCrossProcessBaseEndpoint@@IEAAJII@Z @ 0x14008F0C0
 * Callers:
 ...
 *     ?ZeroOutObject@SpatialBlock@@QEAAJII@Z @ 0x14008F0FC (-ZeroOutObject@SpatialBlock@@QEAAJII@Z.c)
 */
