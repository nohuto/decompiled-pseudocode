/*
 * XREFs of ?MakeAndInitialize@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@CAJPEBG$$QEAV?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@3@PEAPEAV123@@Z @ 0x14007AA08
 * Callers:
 ...
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x14004B234 (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ?ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z @ 0x14005D630 (-ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z.c)
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x14005E7A0 (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x140076B48 (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 */
  ...
  if ( v6 )
  {
    *(_OWORD *)v18 = 0LL;
    ...
    if ( v11 >= 0 )
    {
      ...
      *a3 = v9;
      wil::details_abi::SemaphoreValue::~SemaphoreValue((wil::details_abi::SemaphoreValue *)v18, v17);
      return 0LL;
    }
    else
    {
