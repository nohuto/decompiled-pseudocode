/*
 * XREFs of ??$make_unique@VSpatialBlock@@$$V$0A@@std@@YA?AV?$unique_ptr@VSpatialBlock@@U?$default_delete@VSpatialBlock@@@std@@@0@XZ @ 0x14008D8A4
 * Callers:
 ...
 *     ??0_unnamed_type__changeSet_@SpatialBlock@@QEAA@XZ @ 0x14008D920 (--0_unnamed_type__changeSet_@SpatialBlock@@QEAA@XZ.c)
 */
