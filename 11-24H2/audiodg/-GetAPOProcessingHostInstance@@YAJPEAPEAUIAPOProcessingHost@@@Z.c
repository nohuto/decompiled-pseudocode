/*
 * XREFs of ?GetAPOProcessingHostInstance@@YAJPEAPEAUIAPOProcessingHost@@@Z @ 0x140034410
 * Callers:
...
__int64 __fastcall GetAPOProcessingHostInstance(struct IAPOProcessingHost **a1)
{
  ...
  if ( dword_1400C57D8 > *(_DWORD *)(*(_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + 4LL) )
  {
    Init_thread_header(&dword_1400C57D8);
    if ( dword_1400C57D8 == -1 )
    {
      ...
      *v3 = 0LL;
      ...
      Init_thread_footer(&dword_1400C57D8);
    }
  }
  if ( qword_1400C57E0 )
  {
    *a1 = (struct IAPOProcessingHost *)qword_1400C57E0;
    (*(void (__fastcall **)(__int64))(*(_QWORD *)qword_1400C57E0 + 8LL))(qword_1400C57E0);
    return 0LL;
  }
  else
  {
