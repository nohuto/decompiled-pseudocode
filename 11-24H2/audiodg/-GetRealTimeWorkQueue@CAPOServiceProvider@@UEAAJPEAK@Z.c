/*
 * XREFs of ?GetRealTimeWorkQueue@CAPOServiceProvider@@UEAAJPEAK@Z @ 0x140044A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAPOServiceProvider::GetRealTimeWorkQueue(CAPOServiceProvider *this, unsigned int *a2)
{
  ...
  if ( a2 )
  {
    if ( dword_1400C57E8 > *(_DWORD *)(*(_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + 4LL) )
    {
      Init_thread_header(&dword_1400C57E8);
      if ( dword_1400C57E8 == -1 )
      {
        dword_1400C57EC = CAPOServiceProvider::GetApoWorkQueueId((CAPOServiceProvider *)((char *)this - 16));
        Init_thread_footer(&dword_1400C57E8);
      }
    }
    *a2 = dword_1400C57EC;
    return 0LL;
