/*
 * XREFs of ?make_cotaskmem_string_nothrow@wil@@YA@PEBG_K@Z @ 0x14004BB94
 * Callers:
...
wil *__fastcall wil::make_cotaskmem_string_nothrow(wil *this, char *a2, __int64 a3, const char *a4)
{
