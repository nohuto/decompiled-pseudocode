/*
 * XREFs of ?GetObjectMetadata@CSpatialCrossProcessBaseEndpoint@@IEAAJIIPEAPEAXPEAI@Z @ 0x14003750C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( a3 >= *(_DWORD *)(v5 + 8) || a2 >= 2 )
  {
    v6 = -2147024809;
LABEL_11:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetObjectMetadata", 0x375u, v6);
    return v6;
  }
  v8 = *(_DWORD *)(v5 + 16);
  if ( v8 )
