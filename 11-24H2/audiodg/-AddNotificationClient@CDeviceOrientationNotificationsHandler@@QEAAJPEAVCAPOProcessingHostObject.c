/*
 * XREFs of ?AddNotificationClient@CDeviceOrientationNotificationsHandler@@QEAAJPEAVCAPOProcessingHostObject@@@Z @ 0x140056E18
 * Callers:
        ...
        struct CAPOProcessingHostObject *a2)
{
  ...
  try
  {
    v7 = CDeviceOrientationNotificationsHandler::RegisterDeviceOrientationNotification((CDeviceOrientationNotificationsHandler *)this);
    if ( v7 < 0 )
  ...
  catch ( ... )
  {
    return (unsigned int)wil::details::in1diag3::Return_CaughtException(
                           retaddr,
                           (void *)0x2C,
                           (unsigned int)"avcore\\audiocore\\server\\audiodg\\exe\\apodevicenotificationshandler.cpp",
                           v8);
  }
  return result;
}
