/*
 * XREFs of ?Return_HrMsg@in1diag3@details@wil@@YAXPEAXIPEBDJ1ZZ @ 0x14005853C
 * Callers:
 ...
 *     _lambda_3b3601bdb13de8ff4c7b45429a3c26db_::operator() @ 0x140053374 (_lambda_3b3601bdb13de8ff4c7b45429a3c26db_--operator().c)
 * Callees:
