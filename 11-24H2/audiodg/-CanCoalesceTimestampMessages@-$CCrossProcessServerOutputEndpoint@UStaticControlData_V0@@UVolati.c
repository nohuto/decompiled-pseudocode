/*
 * XREFs of ?CanCoalesceTimestampMessages@?$CCrossProcessServerOutputEndpoint@UStaticControlData_V0@@UVolatileControlData_V0@@UControlData_V0@@@@IEAAIIW4EndpointMessageID@@IPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@@Z @ 0x14005328C
 * Callers:
...
__int64 __fastcall CCrossProcessServerOutputEndpoint<StaticControlData_V0,VolatileControlData_V0,ControlData_V0>::CanCoalesceTimestampMessages(
        __int64 a1,
        unsigned int a2,
        int a3,
        int a4,
