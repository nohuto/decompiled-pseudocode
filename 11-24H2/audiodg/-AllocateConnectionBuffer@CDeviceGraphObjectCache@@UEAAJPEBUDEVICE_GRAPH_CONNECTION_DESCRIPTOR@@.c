/*
 * XREFs of ?AllocateConnectionBuffer@CDeviceGraphObjectCache@@UEAAJPEBUDEVICE_GRAPH_CONNECTION_DESCRIPTOR@@PEAPEAUIDeviceGraphConnectionBuffer@@@Z @ 0x140010540
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x14000AC24 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?GetAudioFormat@@YAXPEAUIAudioMediaType@@PEAU_UNCOMPRESSEDAUDIOFORMAT@@@Z @ 0x14000EED4 (-GetAudioFormat@@YAXPEAUIAudioMediaType@@PEAU_UNCOMPRESSEDAUDIOFORMAT@@@Z.c)
 *     ??0CDeviceGraphConnectionBuffer@@QEAA@PEAUIDeviceGraphBuffer@@_K@Z @ 0x140011630 (--0CDeviceGraphConnectionBuffer@@QEAA@PEAUIDeviceGraphBuffer@@_K@Z.c)
