/*
 * XREFs of ??1CSerialWorkQueue@@QEAA@XZ @ 0x140043580
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCSerialWorkQueue@@@std@@EEAAXXZ @ 0x14004ACF0 (-_Destroy@-$_Ref_count_obj2@VCSerialWorkQueue@@@std@@EEAAXXZ.c)
 * Callees:
 *     <none>
 */
