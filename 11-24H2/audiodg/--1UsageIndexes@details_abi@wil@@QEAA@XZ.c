/*
 * XREFs of ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x140077014
 * Callers:
 ...
 *     _wil::details_abi::FeatureStateData::RecordUsage_::_1_::dtor$0 @ 0x140096B2B (_wil--details_abi--FeatureStateData--RecordUsage_--_1_--dtor$0.c)
 * Callees:
