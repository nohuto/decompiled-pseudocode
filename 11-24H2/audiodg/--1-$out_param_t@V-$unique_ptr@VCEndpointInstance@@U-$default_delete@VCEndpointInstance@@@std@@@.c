/*
 * XREFs of ??1?$out_param_t@V?$unique_ptr@VCEndpointInstance@@U?$default_delete@VCEndpointInstance@@@std@@@std@@@details@wil@@QEAA@XZ @ 0x1400585FC
 * Callers:
 ...
 *     _CBridgeToAPOProcessNode::CreateBridgeToApo_::_1_::dtor$1 @ 0x140094C1B (_CBridgeToAPOProcessNode--CreateBridgeToApo_--_1_--dtor$1.c)
 *     _CBridgeSourceProcessNode::CreateStreamInstance_::_1_::dtor$1 @ 0x14009643A (_CBridgeSourceProcessNode--CreateStreamInstance_--_1_--dtor$1.c)
 * Callees:
