/*
 * XREFs of ??$MakeAndInitialize@VAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@UIAudioDeviceBrokerDevice@2345@AEAPEAX@Details@WRL@Microsoft@@YAJPEAPEAUIAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@AEAPEAX@Z @ 0x14001B6EC
 * Callers:
 ...
 * Callees:
 *     ??0AudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@QEAA@XZ @ 0x14001B78C (--0AudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@QEAA@XZ.c)
