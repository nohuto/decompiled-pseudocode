/*
 * XREFs of ?GetPreferredInputFormat@CAPOWrapperSrv@@UEAAJPEAUtWAVEFORMATEX@@PEAPEAU2@@Z @ 0x140063DD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( v11 )
    {
      ...
      if ( v18 )
      {
        v12 = (*(__int64 (__fastcall **)(__int64, struct IAudioMediaType *, __int64 *))(*(_QWORD *)v18 + 24LL))(
                v18,
                v16,
                &v17);
        v8 = v12;
