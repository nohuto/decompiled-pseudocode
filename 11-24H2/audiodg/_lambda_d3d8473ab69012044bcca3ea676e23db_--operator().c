/*
 * XREFs of _lambda_d3d8473ab69012044bcca3ea676e23db_::operator() @ 0x140032254
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_d3d8473ab69012044bcca3ea676e23db__void_::_Do_call @ 0x140042DB0 (std--_Func_impl_no_alloc__lambda_d3d8473ab69012044bcca3ea676e23db__void_--_Do_call.c)
 * Callees:
 *     ??$query_dispatch@UIAudioProcessingObjectNotifications@@@weak_query_policy@details@wil@@CAJPEAUIWeakReference@@U?$integral_constant@_N$0A@@wistd@@PEAPEAUIAudioProcessingObjectNotifications@@@Z @ 0x1400322EC (--$query_dispatch@UIAudioProcessingObjectNotifications@@@weak_query_policy@details@wil@@CAJPEAUI.c)
