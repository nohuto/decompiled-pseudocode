/*
 * XREFs of wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x140002B20
 * Callers:
 *     <none>
 * Callees:
 *     ??0EnabledStateManager@details@wil@@QEAA@XZ @ 0x140058574 (--0EnabledStateManager@details@wil@@QEAA@XZ.c)
 */
