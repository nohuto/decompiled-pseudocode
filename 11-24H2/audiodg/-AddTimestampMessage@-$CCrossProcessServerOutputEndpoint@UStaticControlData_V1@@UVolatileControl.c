/*
 * XREFs of ?AddTimestampMessage@?$CCrossProcessServerOutputEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@MEAAJW4EndpointMessageID@@IIPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@W4AddTimestampMessageOptions@1@@Z @ 0x1400523D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CanCoalesceTimestampMessages@?$CCrossProcessServerOutputEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@IEAAIIW4EndpointMessageID@@IPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@@Z @ 0x1400528E8 (-CanCoalesceTimestampMessages@-$CCrossProcessServerOutputEndpoint@UStaticControlData_V1@@UVolati.c)
...
LABEL_27:
  ...
  {
LABEL_2:
    AudCPTraceLoggingErrorHelper("IsValidQueueIndex", 0x73Du, -2147467259);
LABEL_44:
    v8 = -2005139387;
LABEL_45:
