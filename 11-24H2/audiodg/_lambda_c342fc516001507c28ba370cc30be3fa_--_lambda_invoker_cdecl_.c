/*
 * XREFs of _lambda_c342fc516001507c28ba370cc30be3fa_::_lambda_invoker_cdecl_ @ 0x1400414D0
 * Callers:
 *     <none>
 * Callees:
 *     ?_Decref@_Ref_count_base@std@@QEAAXXZ @ 0x1400089AC (-_Decref@_Ref_count_base@std@@QEAAXXZ.c)
 *     ?Shutdown@CSerialWorkQueue@@QEAAXXZ @ 0x140041508 (-Shutdown@CSerialWorkQueue@@QEAAXXZ.c)
 */
