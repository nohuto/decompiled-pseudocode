/*
 * XREFs of McTemplateU0pqpqqqqqq_EventWriteTransfer @ 0x14000EDDC
 * Callers:
 ...
 *     ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x1400346CC (-AERTCreateHeap@@YAPEAX_K00@Z.c)
 ...
 *     ?AERTMemoryShutdown@@YAJXZ @ 0x1400746B0 (-AERTMemoryShutdown@@YAJXZ.c)
 *     ?AERTUnlockZoneHeap@@YAJPEAX@Z @ 0x14007473C (-AERTUnlockZoneHeap@@YAJPEAX@Z.c)
 * Callees:
