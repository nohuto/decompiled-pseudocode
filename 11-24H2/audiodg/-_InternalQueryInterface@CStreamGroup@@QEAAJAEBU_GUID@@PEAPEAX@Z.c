/*
 * XREFs of ?_InternalQueryInterface@CStreamGroup@@QEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002D184
 * Callers:
 *     ?QueryInterface@?$CComObject@VCStreamGroup@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140044AF0 (-QueryInterface@-$CComObject@VCStreamGroup@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
