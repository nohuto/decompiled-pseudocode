 ...
 *     WppInitUm @ 0x14004AC68 (WppInitUm.c)
 *     WppCleanupUm @ 0x140057D5C (WppCleanupUm.c)
 *     McGenEventRegister_EtwEventRegister @ 0x140058434 (McGenEventRegister_EtwEventRegister.c)
 *     WPP_SF_D @ 0x1400659FC (WPP_SF_D.c)
 *     WPP_SF_S @ 0x140065A40 (WPP_SF_S.c)
