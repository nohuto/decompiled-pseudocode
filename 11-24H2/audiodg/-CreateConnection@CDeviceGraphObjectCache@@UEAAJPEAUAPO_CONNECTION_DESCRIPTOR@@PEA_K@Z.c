/*
 * XREFs of ?CreateConnection@CDeviceGraphObjectCache@@UEAAJPEAUAPO_CONNECTION_DESCRIPTOR@@PEA_K@Z @ 0x14000D260
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x14000AC24 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??2CConnectionNode@@SAPEAX_K@Z @ 0x14000CCD0 (--2CConnectionNode@@SAPEAX_K@Z.c)
 *     ?ValidateUncompressedFrameFormat@@YAJPEAUIAudioMediaType@@@Z @ 0x14000D4F4 (-ValidateUncompressedFrameFormat@@YAJPEAUIAudioMediaType@@@Z.c)
 ...
 *     ?GetFreeNode@?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATL@@AEAAXXZ @ 0x14000EFCC (-GetFreeNode@-$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATL@@AEAAXXZ.c)
