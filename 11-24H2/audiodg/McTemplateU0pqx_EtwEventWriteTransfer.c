/*
 * XREFs of McTemplateU0pqx_EtwEventWriteTransfer @ 0x140066974
 * Callers:
...
__int64 __fastcall McTemplateU0pqx_EtwEventWriteTransfer(int a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v10 = 4LL;
  v12 = 8LL;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (unsigned int)&AudioCore_AEControl, a3, 4, (__int64)v6);
}
