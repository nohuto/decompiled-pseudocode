/*
 * XREFs of McTemplateU0pqxxxxx_EventWriteTransfer @ 0x14000F258
 * Callers:
...
__int64 __fastcall McTemplateU0pqxxxxx_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a9)
{
  ...
  v23 = 8LL;
  v25 = 8LL;
  return McGenEventWrite_EventWriteTransfer(a1, &AudioCore_AETimestamp, a3, 8LL, v11);
}
