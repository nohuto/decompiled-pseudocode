/*
 * XREFs of ?RemoveAt@?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@@2@@ATL@@QEAAHH@Z @ 0x140029EE0
 * Callers:
        ...
        int a2)
{
  ...
  v3 = dword_1400C4758;
  if ( (_DWORD)v2 != dword_1400C4758 - 1 )
  {
    v7 = memmove_s(
           (char *)SadMap + 8 * v2,
           8LL * (dword_1400C4758 - (int)v2),
           (char *)SadMap + 8 * v2 + 8,
           8LL * (dword_1400C4758 - (int)v2 - 1));
  ...
  if ( v4 || dword_1400C4758 == 1 )
    SadMap = v4;
  v5 = (void *)_o__recalloc(Block, dword_1400C4758 - 1, 8LL);
  if ( v5 || dword_1400C4758 == 1 )
    Block = v5;
  result = 1LL;
  --dword_1400C4758;
  return result;
