/*
 * XREFs of ??1?$function@$$A6AXAEBUWNF_AUDIO_ORIENTATION_STATE@@@Z@wistd@@QEAA@XZ @ 0x14005C1C0
 * Callers:
 ...
 *     _wil::details_abi::RawUsageIndex::Iterate_::_1_::dtor$0 @ 0x140096B19 (_wil--details_abi--RawUsageIndex--Iterate_--_1_--dtor$0.c)
 * Callees:
