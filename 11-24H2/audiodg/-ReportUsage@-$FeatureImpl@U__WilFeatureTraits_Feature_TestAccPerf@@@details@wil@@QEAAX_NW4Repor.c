/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TestAccPerf@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x140084D74
 * Callers:
        ...
        __int64 a4)
{
  ...
  v9 = 3;
  v8 = 0;
  return wil::details::ReportUsageToService((char *)a1 + 8, 57048237LL, (v5 >> 10) & 1, (v5 >> 11) & 1, &v8, 1, 0);
}
