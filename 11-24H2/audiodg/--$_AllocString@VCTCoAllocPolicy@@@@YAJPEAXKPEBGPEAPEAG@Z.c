/*
 * XREFs of ??$_AllocString@VCTCoAllocPolicy@@@@YAJPEAXKPEBGPEAPEAG@Z @ 0x140026760
 * Callers:
 ...
 * Callees:
 *     StringCopyWorkerW_0 @ 0x140064374 (StringCopyWorkerW_0.c)
 *     StringExHandleFillBehindNullW @ 0x1400643F0 (StringExHandleFillBehindNullW.c)
 *     StringExValidateDestW @ 0x140064418 (StringExValidateDestW.c)
 *     StringExValidateSrcW @ 0x14006443C (StringExValidateSrcW.c)
 */
