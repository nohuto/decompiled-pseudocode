/*
 * XREFs of ?GetLatency@CAPOWrapperSrv@@UEAAJPEA_J@Z @ 0x140063D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAPOWrapperSrv::GetLatency(CAPOWrapperSrv *this, __int64 *a2)
{
  ...
  CPerfTracker::CPerfTracker(&PerformanceCount, v4, "SrvSystemEffect_GetLatency", (const char *const)this + 132);
  v5 = *((_QWORD *)this + 11);
  if ( v5 )
