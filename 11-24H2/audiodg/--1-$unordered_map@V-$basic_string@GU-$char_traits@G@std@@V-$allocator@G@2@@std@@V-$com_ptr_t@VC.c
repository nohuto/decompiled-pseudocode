/*
 * XREFs of ??1?$unordered_map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$com_ptr_t@VCMicBoostNotificationsHandler@@Uerr_returncode_policy@wil@@@wil@@U?$hash@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@U?$equal_to@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$com_ptr_t@VCMicBoostNotificationsHandler@@Uerr_returncode_policy@wil@@@wil@@@std@@@2@@std@@QEAA@XZ @ 0x140061A5C
 * Callers:
 *     _CAPOProcessingHost::CAPOProcessingHost_::_1_::dtor$3 @ 0x140093967 (_CAPOProcessingHost--CAPOProcessingHost_--_1_--dtor$3.c)
 *     _CAPOProcessingHost::CAPOProcessingHost_::_1_::dtor$10 @ 0x140093A13 (_CAPOProcessingHost--CAPOProcessingHost_--_1_--dtor$10.c)
 * Callees:
 *     <none>
 */
