/*
 * XREFs of ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIDeviceGraphObjectCacheManager@@UIAudioLogging@@@WRL@Microsoft@@QEAA@XZ @ 0x140038CFC
 * Callers:
 *     ??0CDeviceGraphObjectCacheManager@@QEAA@XZ @ 0x140038904 (--0CDeviceGraphObjectCacheManager@@QEAA@XZ.c)
 * Callees:
