/*
 * XREFs of ?GetNextDataPointer@?$CCPAudioHistoryReader@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@UEAA_KPEAIPEAUAE_CURRENT_POSITION@@PEAW4APO_BUFFER_FLAGS@@@Z @ 0x14007FD80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCPAudioHistoryReader<StaticControlData_V1,VolatileControlData_V0,ControlData_V1>::GetNextDataPointer(
        __int64 a1,
        _DWORD *a2,
        __int64 a3,
        _DWORD *a4)
