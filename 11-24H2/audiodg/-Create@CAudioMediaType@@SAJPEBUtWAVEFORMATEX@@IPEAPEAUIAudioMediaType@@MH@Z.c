/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x14005A904
 * Callers:
 ...
 *     ?QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14005AEA0 (-QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
