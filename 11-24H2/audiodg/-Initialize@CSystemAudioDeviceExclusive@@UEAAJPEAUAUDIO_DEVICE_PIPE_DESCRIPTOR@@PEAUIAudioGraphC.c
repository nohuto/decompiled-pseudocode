/*
 * XREFs of ?Initialize@CSystemAudioDeviceExclusive@@UEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAUIAudioGraphCallback@@K@Z @ 0x14006FD00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v8 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceExclusive::Initialize", 129, v8);
  }
