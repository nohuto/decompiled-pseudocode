/*
 * XREFs of ??$com_copy_to_nothrow@UIMMDevice@@AEAPEAU1@@wil@@YAJAEAPEAUIMMDevice@@PEAPEAU1@@Z @ 0x1400494FC
 * Callers:
...
__int64 __fastcall wil::com_copy_to_nothrow<IMMDevice,IMMDevice * &>(__int64 *a1, _QWORD *a2)
{
  __int64 v2; // rcx
