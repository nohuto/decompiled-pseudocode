/*
 * XREFs of ?FillArrayWithIid@?$ImplementsHelper@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$0A@UIModuleCommandResult@Devices@Media@Windows@@UIWeakReferenceSource@@VFtmBase@23@@Details@WRL@Microsoft@@IEAAXPEAKPEAU_GUID@@@Z @ 0x140078408
 * Callers:
 *     ?GetIids@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x140079320 (-GetIids@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
