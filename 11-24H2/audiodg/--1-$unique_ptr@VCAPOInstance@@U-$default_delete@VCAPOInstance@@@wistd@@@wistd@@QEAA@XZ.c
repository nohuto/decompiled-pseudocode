/*
 * XREFs of ??1?$unique_ptr@VCAPOInstance@@U?$default_delete@VCAPOInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x1400580A8
 * Callers:
 *     _CAPOProcessNode::CreateAPOProcessNode_::_1_::dtor$5 @ 0x140092CAC (_CAPOProcessNode--CreateAPOProcessNode_--_1_--dtor$5.c)
 * Callees:
