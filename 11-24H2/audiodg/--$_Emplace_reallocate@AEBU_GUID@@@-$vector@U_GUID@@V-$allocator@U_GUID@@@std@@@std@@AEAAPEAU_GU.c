/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@@?$vector@U_GUID@@V?$allocator@U_GUID@@@std@@@std@@AEAAPEAU_GUID@@QEAU2@AEBU2@@Z @ 0x140065BA8
 * Callers:
...
char *__fastcall std::vector<_GUID>::_Emplace_reallocate<_GUID const &>(__int64 a1, char *a2, _OWORD *a3)
{
