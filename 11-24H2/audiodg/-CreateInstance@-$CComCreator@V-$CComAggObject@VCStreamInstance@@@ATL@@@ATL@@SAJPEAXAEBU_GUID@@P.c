/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCStreamInstance@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14005CC84
 * Callers:
 *     ?CreateInstance@?$CComCreator2@V?$CComCreator@V?$CComObject@VCStreamInstance@@@ATL@@@ATL@@V?$CComCreator@V?$CComAggObject@VCStreamInstance@@@ATL@@@2@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14003AB50 (-CreateInstance@-$CComCreator2@V-$CComCreator@V-$CComObject@VCStreamInstance@@@ATL@@@ATL@@V-$CCo.c)
 * Callees:
 *     ?Init@CComSafeDeleteCriticalSection@ATL@@QEAAJXZ @ 0x140005C78 (-Init@CComSafeDeleteCriticalSection@ATL@@QEAAJXZ.c)
 *     ??0CStreamInstance@@QEAA@XZ @ 0x14003AC80 (--0CStreamInstance@@QEAA@XZ.c)
