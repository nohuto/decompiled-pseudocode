/*
 * XREFs of ?StartSendingNotifications@CAPOProcessingHostObject@@QEAAJXZ @ 0x140015B70
 * Callers:
 ...
 *     ??$make_shared@VCSerialWorkQueue@@$$V@std@@YA?AV?$shared_ptr@VCSerialWorkQueue@@@0@XZ @ 0x140015C64 (--$make_shared@VCSerialWorkQueue@@$$V@std@@YA-AV-$shared_ptr@VCSerialWorkQueue@@@0@XZ.c)
