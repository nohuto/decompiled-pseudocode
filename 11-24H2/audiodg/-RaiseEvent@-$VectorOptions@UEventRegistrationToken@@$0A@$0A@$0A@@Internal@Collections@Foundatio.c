/*
 * XREFs of ?RaiseEvent@?$VectorOptions@UEventRegistrationToken@@$0A@$0A@$0A@@Internal@Collections@Foundation@Windows@@SAJZZ @ 0x14004D3B4
 * Callers:
...
__int64 Windows::Foundation::Collections::Internal::VectorOptions<EventRegistrationToken,0,0,0>::RaiseEvent()
{
  return 0LL;
}
