/*
 * XREFs of ?SetCurrentTimestamp@?$CCrossProcessServerInputEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@UEAAJPEAUAE_CURRENT_POSITION@@@Z @ 0x140086660
 * Callers:
 *     <none>
 * Callees:
