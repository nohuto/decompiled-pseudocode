/*
 * XREFs of ??$make_shared@VCSerialWorkQueue@@$$V@std@@YA?AV?$shared_ptr@VCSerialWorkQueue@@@0@XZ @ 0x140015C64
 * Callers:
 ...
 * Callees:
 *     ??$_Construct_in_place@VCSerialWorkQueue@@$$V@std@@YAXAEAVCSerialWorkQueue@@@Z @ 0x140015CD0 (--$_Construct_in_place@VCSerialWorkQueue@@$$V@std@@YAXAEAVCSerialWorkQueue@@@Z.c)
