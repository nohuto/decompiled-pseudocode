/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Flist_node@V?$com_ptr_t@VCAPOProcessingHostObject@@Uerr_returncode_policy@wil@@@wil@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x14004BD80
 * Callers:
 *     _std::forward_list_wil::com_ptr_t_CAPOProcessingHostObject_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CAPOProcessingHostObject_wil::err_returncode_policy_____::emplace_front_CAPOProcessingHostObject___&__::_1_::dtor$0 @ 0x140092A84 (_std--forward_list_wil--com_ptr_t_CAPOProcessingHostObject_wil--err_returncode_policy__std--allo.c)
 * Callees:
 *     <none>
 */
