/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEAUIMMDevice@@W4APO_TYPE@@J_NAEBU_GUID@@M@Z @ 0x140036540
 * Callers:
 ...
 *     IsSkipAPOFailureCheck @ 0x14003692C (IsSkipAPOFailureCheck.c)
...
__int64 __fastcall TrackSystemEffectBehavior(__int64 a1, int a2, int a3, unsigned __int8 a4, __int64 a5, float a6)
{
  ...
  *(_OWORD *)v22 = 0LL;
  ...
  if ( dword_1400C5808 > *(_DWORD *)(*ThreadLocalStoragePointer + 4) )
  {
    Init_thread_header(&dword_1400C5808);
    if ( dword_1400C5808 == -1 )
    {
      xmmword_1400C5674 = PKEY_Endpoint_LFX_FailCount;
      dword_1400C5684 = 9;
      xmmword_1400C5688 = PKEY_Endpoint_GFX_FailCount;
      dword_1400C5698 = 8;
      xmmword_1400C569C = PKEY_Endpoint_EFX_FailCount;
      dword_1400C56AC = 31;
      Init_thread_footer(&dword_1400C5808);
    }
  }
  if ( dword_1400C5804 > *(_DWORD *)(v11 + 4) )
  {
    Init_thread_header(&dword_1400C5804);
    if ( dword_1400C5804 == -1 )
    {
      xmmword_1400C5624 = PKEY_Endpoint_LFX_ExceptionCount;
      dword_1400C5634 = 33;
      xmmword_1400C5638 = PKEY_Endpoint_GFX_ExceptionCount;
      dword_1400C5648 = 34;
      xmmword_1400C564C = PKEY_Endpoint_EFX_ExceptionCount;
      dword_1400C565C = 35;
      Init_thread_footer(&dword_1400C5804);
    }
  }
