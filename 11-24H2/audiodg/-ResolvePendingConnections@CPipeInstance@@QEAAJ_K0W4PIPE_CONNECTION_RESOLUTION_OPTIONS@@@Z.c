/*
 * XREFs of ?ResolvePendingConnections@CPipeInstance@@QEAAJ_K0W4PIPE_CONNECTION_RESOLUTION_OPTIONS@@@Z @ 0x14002F4C8
 * Callers:
 ...
 *     ?SetHandle@CConnectionInstance@@QEAAJ_K@Z @ 0x14002F63C (-SetHandle@CConnectionInstance@@QEAAJ_K@Z.c)
 */
