/*
 * XREFs of ?CreateBridgeSinkProcessNode@CBridgeSinkProcessNode@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAPEAVCStreamProcessNode@@@Z @ 0x14006C45C
 * Callers:
 ...
 *     ??4?$CComPtr@UIAudioMediaType@@@ATL@@QEAAPEAUIAudioMediaType@@AEBV01@@Z @ 0x1400399F4 (--4-$CComPtr@UIAudioMediaType@@@ATL@@QEAAPEAUIAudioMediaType@@AEBV01@@Z.c)
...
__int64 __fastcall CBridgeSinkProcessNode::CreateBridgeSinkProcessNode(const WAVEFORMATEX **a1, IAudioMediaType ***a2)
{
  ...
  if ( v4 )
  {
    ...
    *((_DWORD *)v4 + 14) = 0;
    v4[8] = 0LL;
    *v4 = (IAudioMediaType *)&CBridgeSinkProcessNode::`vftable';
