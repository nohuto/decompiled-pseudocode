/*
 * XREFs of _CAudioProcessor::AddAPOOutputConnection_::_1_::dtor$0 @ 0x14009188D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioProcessor::AddAPOOutputConnection_::_1_::dtor_0(__int64 a1, __int64 a2)
{
