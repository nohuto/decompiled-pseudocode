/*
 * XREFs of McTemplateU0pqqxxxx_EventWriteTransfer @ 0x14000F3BC
 * Callers:
 *     ?SetCurrentTimeStamp@?$CCrossProcessBaseEndpoint@UStaticControlData_V0@@UVolatileControlData_V0@@UControlData_V0@@@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x140052270 (-SetCurrentTimeStamp@-$CCrossProcessBaseEndpoint@UStaticControlData_V0@@UVolatileControlData_V0@.c)
 * Callees:
