/*
 * XREFs of ?SignalAndWaitForThread@CAudioPump@@AEAAXXZ @ 0x14001DD24
 * Callers:
 ...
 * Callees:
 *     ?reset@?$com_ptr_t@UIAudioStreamingResourceRegistration@@Uerr_returncode_policy@wil@@@wil@@QEAAXXZ @ 0x14001DDE0 (-reset@-$com_ptr_t@UIAudioStreamingResourceRegistration@@Uerr_returncode_policy@wil@@@wil@@QEAAX.c)
