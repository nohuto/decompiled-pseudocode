/*
 * XREFs of ?GetFormat@CSystemAudioDeviceExclusive@@UEAAJ_KPEAPEAUtWAVEFORMATEX@@@Z @ 0x14006F970
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceExclusive::GetFormat", 423, v6);
  }
