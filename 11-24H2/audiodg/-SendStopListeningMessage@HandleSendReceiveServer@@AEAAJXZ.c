/*
 * XREFs of ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14009111C
 * Callers:
 *     ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140042B78 (--1HandleSendReceiveServer@@UEAA@XZ.c)
 * Callees:
 *     <none>
 */
