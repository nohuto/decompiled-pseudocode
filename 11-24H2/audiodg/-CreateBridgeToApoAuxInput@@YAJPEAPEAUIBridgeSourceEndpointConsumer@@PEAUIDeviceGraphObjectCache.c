/*
 * XREFs of ?CreateBridgeToApoAuxInput@@YAJPEAPEAUIBridgeSourceEndpointConsumer@@PEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioMediaType@@IPEAUIAudioProcessingObject@@@Z @ 0x14004A2C8
 * Callers:
