/*
 * XREFs of ??1_Init_once_completer@std@@QEAA@XZ @ 0x140061D68
 * Callers:
 ...
 * Callees:
 *     __std_init_once_link_alternate_names_and_abort @ 0x1400589A8 (__std_init_once_link_alternate_names_and_abort.c)
 */
