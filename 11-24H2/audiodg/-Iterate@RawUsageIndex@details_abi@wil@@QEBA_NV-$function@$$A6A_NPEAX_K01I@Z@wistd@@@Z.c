/*
 * XREFs of ?Iterate@RawUsageIndex@details_abi@wil@@QEBA_NV?$function@$$A6A_NPEAX_K01I@Z@wistd@@@Z @ 0x14007A750
 * Callers:
            ...
            *(unsigned __int8 **)(a1 + 32)) )
  {
              ...
              *(unsigned __int8 **)(a1 + 32)) )
    {
      ...
      if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64 *, __int64 *, __int64 *, __int64 *, int *))(*(_QWORD *)v8 + 32LL))(
              ...
              &v23) )
      {
        wistd::function<void (WNF_AUDIO_ORIENTATION_STATE const &)>::~function<void (WNF_AUDIO_ORIENTATION_STATE const &)>(a2);
        return 0;
      }
      ++v6;
    }
