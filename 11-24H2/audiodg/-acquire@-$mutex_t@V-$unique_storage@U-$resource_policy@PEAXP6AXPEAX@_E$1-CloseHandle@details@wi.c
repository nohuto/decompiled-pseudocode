 ...
 * Callees:
 *     ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x14005CDDC (-FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
        ...
        _QWORD *a2)
{
  ...
  {
    wil::details::in1diag3::FailFast_Unexpected(retaddr, 3127LL, v5, v6);
  }
  *a2 = v2;
  return a2;
}
