/*
 * XREFs of ?RetrieveUsageUnderLock@FeatureStateData@details_abi@wil@@AEAAXAEAUUsageIndexes@23@@Z @ 0x14007CC1C
 * Callers:
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x14007AFC8 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
