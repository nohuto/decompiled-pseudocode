 ...
 *     ?OnAudioPacket@CBridgeToApoAuxInput@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x140035620 (-OnAudioPacket@CBridgeToApoAuxInput@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@.c)
 *     ?Initialize@HandleSendReceiveServer@@QEAAJPEAPEAG@Z @ 0x140038494 (-Initialize@HandleSendReceiveServer@@QEAAJPEAPEAG@Z.c)
 *     McGenControlCallbackV2 @ 0x14003B880 (McGenControlCallbackV2.c)
 ...
 *     ?ResourceRemoved@CpuManager@@EEAAXXZ @ 0x140058770 (-ResourceRemoved@CpuManager@@EEAAXXZ.c)
 ...
 *     AudioDGChallenge @ 0x14006D5E0 (AudioDGChallenge.c)
