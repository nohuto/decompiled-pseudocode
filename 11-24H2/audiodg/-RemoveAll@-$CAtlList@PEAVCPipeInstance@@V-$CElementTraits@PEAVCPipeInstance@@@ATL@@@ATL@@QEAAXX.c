/*
 * XREFs of ?RemoveAll@?$CAtlList@PEAVCPipeInstance@@V?$CElementTraits@PEAVCPipeInstance@@@ATL@@@ATL@@QEAAXXZ @ 0x14000B8BC
 * Callers:
 ...
 *     ??1?$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEAA@XZ @ 0x14004AF64 (--1-$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEAA@XZ.c)
