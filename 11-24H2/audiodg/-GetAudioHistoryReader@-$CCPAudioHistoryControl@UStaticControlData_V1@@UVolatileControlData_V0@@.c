/*
 * XREFs of ?GetAudioHistoryReader@?$CCPAudioHistoryControl@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@UEAAJ_K0HPEAPEAUICPAudioHistoryReader@@@Z @ 0x14007FD00
 * Callers:
 *     <none>
 * Callees:
