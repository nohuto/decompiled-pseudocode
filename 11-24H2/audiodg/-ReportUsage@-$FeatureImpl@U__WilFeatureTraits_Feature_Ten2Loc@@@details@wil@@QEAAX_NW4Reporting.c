/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Ten2Loc@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x140084CF0
 * Callers:
...
__int64 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Ten2Loc>::ReportUsage(
        wil::details *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v9 = 3;
  v8 = 0;
  return wil::details::ReportUsageToService((char *)a1 + 8, 58989002LL, (v5 >> 10) & 1, (v5 >> 11) & 1, &v8, 1, 0);
}
