/*
 * XREFs of ?Remove@?$EventSource@U?$ITypedEventHandler@PEAVAudioDeviceBroker@Internal@Devices@Media@Windows@@PEAVAudioDeviceBrokerChangedEventArgs@2345@@Foundation@Windows@@U?$InvokeModeOptions@$0?1@WRL@Microsoft@@@WRL@Microsoft@@QEAAJUEventRegistrationToken@@@Z @ 0x140043394
 * Callers:
        ...
        struct IUnknown *a2)
{
  ...
  __int64 v12; // r13
  __int64 v13; // rcx
  Microsoft::WRL::Details::EventTargetArray *v14; // rax
  int v16; // ebx
  ...
  v16 = Microsoft::WRL::Details::MakeAndInitialize<Microsoft::WRL::Details::EventTargetArray,Microsoft::WRL::Details::EventTargetArray,unsigned __int64 &>(
          &v20,
          (unsigned __int64 *)&v21);
  if ( v16 >= 0 )
  {
    v9 = v20;
    v17 = (struct IUnknown **)*((_QWORD *)a1->Ptr + 2);
    if ( v17 == *((struct IUnknown ***)a1->Ptr + 3) )
    {
LABEL_11:
      if ( v9 )
    ...
    do
    {
      if ( v10 || a2 != *v17 )
      {
        if ( !v12 )
          break;
        Microsoft::WRL::Details::EventTargetArray::AddTail(v9, *v17, *v18++);
        --v12;
      }
      else
      {
    ...
    while ( v17 != *((struct IUnknown ***)a1->Ptr + 3) );
    v2 = a1 + 2;
LABEL_4:
    if ( v10 )
    {
      ...
      a1->Ptr = v14;
      if ( v13 )
        Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IUnknown>::Release(v13, v6);
