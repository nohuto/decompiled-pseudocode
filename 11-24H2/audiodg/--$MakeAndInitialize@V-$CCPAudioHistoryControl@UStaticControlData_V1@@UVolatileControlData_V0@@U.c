/*
 * XREFs of ??$MakeAndInitialize@V?$CCPAudioHistoryControl@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@UICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Details@WRL@Microsoft@@YAJPEAPEAUICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Z @ 0x14007F940
 * Callers:
 *     ??$CreateAudioHistoryControlHelper@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@YAJPEAPEAUICPAudioHistoryControl@@PEAUICrossProcessMemory@@@Z @ 0x14007F920 (--$CreateAudioHistoryControlHelper@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_.c)
 * Callees:
