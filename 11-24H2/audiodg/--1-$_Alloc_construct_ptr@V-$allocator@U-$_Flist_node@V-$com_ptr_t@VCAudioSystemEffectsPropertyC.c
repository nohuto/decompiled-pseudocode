/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Flist_node@V?$com_ptr_t@VCAudioSystemEffectsPropertyChangeNotificationsHandler@@Uerr_returncode_policy@wil@@@wil@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x14004B284
 * Callers:
 *     _std::forward_list_wil::com_ptr_t_CAudioSystemEffectsPropertyChangeNotificationsHandler_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CAudioSystemEffectsPropertyChangeNotificationsHandler_wil::err_returncode_policy_____::emplace_front_CAudioSystemEffectsPropertyChangeNotificationsHandler___&__::_1_::dtor$0 @ 0x140095130 (_std--forward_list_wil--com_ptr_t_CAudioSystemEffectsPropertyChangeNotificationsHandler_wil--err.c)
 * Callees:
