/*
 * XREFs of ??$AttachObject@VBamoDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@PEAVBamoDragManagerClientProxy@@@Z @ 0x18005FDBC
 * Callers:
...
void __fastcall InputSite::AttachObject<BamoDragManagerClientProxy>(__int64 a1, __int64 a2, __int64 a3)
{
