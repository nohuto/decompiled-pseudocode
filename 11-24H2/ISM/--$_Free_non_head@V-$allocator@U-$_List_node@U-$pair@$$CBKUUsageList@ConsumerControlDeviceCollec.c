 ...
 *     ??1?$list@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@V?$allocator@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@@2@@std@@QEAA@XZ @ 0x180099AA0 (--1-$list@U-$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@V-$allocator@U-$p.c)
