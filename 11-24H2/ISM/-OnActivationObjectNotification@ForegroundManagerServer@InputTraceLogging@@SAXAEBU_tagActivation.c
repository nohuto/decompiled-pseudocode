/*
 * XREFs of ?OnActivationObjectNotification@ForegroundManagerServer@InputTraceLogging@@SAXAEBU_tagActivationObjectNotification@@@Z @ 0x180023198
 * Callers:
 ...
 *     ?ActivationNotificationActionToString@InputTraceLogging@@CAPEBDAEBW4ACTIVATION_OBJECT_NOTIFICATION_ACTION@@@Z @ 0x1800AC96C (-ActivationNotificationActionToString@InputTraceLogging@@CAPEBDAEBW4ACTIVATION_OBJECT_NOTIFICATI.c)
 */
