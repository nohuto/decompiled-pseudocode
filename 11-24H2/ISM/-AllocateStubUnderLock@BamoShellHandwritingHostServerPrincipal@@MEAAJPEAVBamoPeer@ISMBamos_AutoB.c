/*
 * XREFs of ?AllocateStubUnderLock@BamoShellHandwritingHostServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoShellHandwritingHostServerStub@@@Z @ 0x18007FA50
 * Callers:
 *     <none>
 * Callees:
