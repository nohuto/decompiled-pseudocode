/*
 * XREFs of ??1?$vector@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIActivationListenerInputObjectProxy@@@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x180052FD4
 * Callers:
 *     _ActivationListenerWindowIdAdapter::SetActiveWindowId_::_1_::dtor$1 @ 0x1801D0AF8 (_ActivationListenerWindowIdAdapter--SetActiveWindowId_--_1_--dtor$1.c)
 * Callees:
