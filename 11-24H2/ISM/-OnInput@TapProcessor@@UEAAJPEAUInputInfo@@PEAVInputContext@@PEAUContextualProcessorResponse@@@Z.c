/*
 * XREFs of ?OnInput@TapProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801B1E60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ @ 0x1801B2060 (-ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ.c)
 */
