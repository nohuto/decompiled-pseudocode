/*
 * XREFs of ?OnCursorMessage@CursorManager@@IEAAJPEAUCursorMessage@@@Z @ 0x18015F808
 * Callers:
 *     ?OnCoreMessageStatic@CursorManager@@SAJPEAX0H@Z @ 0x18015F7F0 (-OnCoreMessageStatic@CursorManager@@SAJPEAX0H@Z.c)
 * Callees:
