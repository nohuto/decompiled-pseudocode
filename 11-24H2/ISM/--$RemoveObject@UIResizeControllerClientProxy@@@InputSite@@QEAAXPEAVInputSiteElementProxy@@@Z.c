/*
 * XREFs of ??$RemoveObject@UIResizeControllerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005ECF8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IResizeControllerClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_617b5d65_289b_4c69_246f_c27f8ae6d5de, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
