/*
 * XREFs of ?OnInputForwardAreaInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005E8E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIInputForwardAreaInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E958 (--$RemoveObject@UIInputForwardAreaInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@.c)
