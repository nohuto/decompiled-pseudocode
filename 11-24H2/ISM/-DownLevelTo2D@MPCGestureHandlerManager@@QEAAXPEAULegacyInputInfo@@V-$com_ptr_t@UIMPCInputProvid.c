/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandlerManager@@QEAAXPEAULegacyInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800B1DFC
 * Callers:
 ...
 *     ?find@?$_Tree@V?$_Tmap_traits@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@U?$less@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@$$CBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@@std@@@5@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@@std@@@std@@@std@@@2@AEBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x18006930C (-find@-$_Tree@V-$_Tmap_traits@V-$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@w.c)
        ...
        const char *a4)
{
  _QWORD *v7; // r8
  __int64 v8; // rax
  MPCGestureHandler *v9; // rbx
  MPCGestureHandler *v10; // rcx
  unsigned int v11; // ebx
  __int64 v12; // rax
  __int64 v13; // rdx
  __int64 v14; // rax
  MPCGestureHandler *v16; // [rsp+20h] [rbp-30h] BYREF
  __int64 v17; // [rsp+28h] [rbp-28h] BYREF
  _BYTE v18[16]; // [rsp+30h] [rbp-20h] BYREF
  ...
  if ( *std::_Tree<std::_Tmap_traits<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>,std::less<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>>,std::allocator<std::pair<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>>,0>>::find(
          (__int64 *)this + 3,
          (__int64)&v21,
          (__int64)a3) == *((_QWORD *)this + 3) )
    goto LABEL_10;
  v8 = std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
         (__int64 *)this + 3,
         (__int64)v18,
         v7);
  wil::com_ptr_t<Windows::Perception::IPerceptionTimestamp,wil::err_exception_policy>::operator=(
    (__int64 *)&v16,
    (__int64 *)(*(_QWORD *)v8 + 40LL));
  v9 = v16;
  if ( !v16 )
    goto LABEL_10;
  wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v21, *a3);
  if ( !(unsigned __int8)MPCGestureHandler::IsInjecting(v9, &v21) && *((_DWORD *)v9 + 228) != *((_DWORD *)a2 + 224) )
  {
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v21, *a3);
    MPCGestureHandlerManager::DetachProvider(this, &v21);
    v10 = v9;
    v9 = 0LL;
    v16 = 0LL;
    if ( v10 )
      (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v10 + 16LL))(v10);
  }
  if ( !v9 )
  {
LABEL_10:
    ...
    if ( *(_QWORD *)std::_Tree<std::_Tmap_traits<unsigned int,wil::com_ptr_t<BamoDockDevicePrincipal,wil::err_returncode_policy>,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,wil::com_ptr_t<BamoDockDevicePrincipal,wil::err_returncode_policy>>>,0>>::find(
                      ...
                      v18,
                      &v21) == *((_QWORD *)this + 1) )
      MPCGestureHandlerManager::MapGestureHandlerToWorkspace(this, v11);
    v12 = std::map<unsigned long,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<unsigned long const &,>(
            (__int64 *)this + 1,
            (__int64)v19,
            &v21);
    ...
    v13 = v17;
    v17 = 0LL;
    wil::com_ptr_t<PenInterface,wil::err_exception_policy>::attach((__int64 *)&v16, v13);
    ...
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v21, *a3);
    v9 = v16;
    MPCGestureHandler::AttachProvider(v16, &v21);
    v14 = std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
            (__int64 *)this + 3,
            (__int64)v19,
            a3);
    wil::com_ptr_t<Windows::Perception::IPerceptionTimestamp,wil::err_exception_policy>::operator=(
      (__int64 *)(*(_QWORD *)v14 + 40LL),
      (__int64 *)&v16);
  }
  wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v21, *a3);
  MPCGestureHandler::DownLevelTo2D(v9, a2);
