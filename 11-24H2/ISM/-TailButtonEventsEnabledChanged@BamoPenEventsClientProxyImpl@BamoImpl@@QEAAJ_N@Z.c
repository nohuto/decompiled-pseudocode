/*
 * XREFs of ?TailButtonEventsEnabledChanged@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1800819F0
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonEventsEnabledChanged(this, a2);
    v19[1] = v12;
    v19[0] = v15;
