/*
 * XREFs of ?LogOnUIAHitTestChanging@BamoInputSystemProxy@@AEAAXPEAVBamoUIAHitTestProxy@@@Z @ 0x18011A6BC
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnUIAHitTestChanging(
        BamoInputSystemProxy *this,
        struct BamoUIAHitTestProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
