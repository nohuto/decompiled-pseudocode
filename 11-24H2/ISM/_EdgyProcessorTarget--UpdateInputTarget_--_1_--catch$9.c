/*
 * XREFs of _EdgyProcessorTarget::UpdateInputTarget_::_1_::catch$9 @ 0x1801D92AE
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EdgyProcessorTarget::UpdateInputTarget_::_1_::catch_9(__int64 a1, __int64 a2)
{
  const char *v2; // r9
