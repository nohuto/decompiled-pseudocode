/*
 * XREFs of ?QueryInterface@BamoSimpleHapticsControllerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186450
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186490 (-QueryInterface@BamoSimpleHapticsControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     Microsoft::BamoImpl::Util::FindInterface_BamoSimpleHapticsControllerStub_ISimpleHapticsControllerStub_ @ 0x18018454C (Microsoft--BamoImpl--Util--FindInterface_BamoSimpleHapticsControllerStub_ISimpleHapticsControlle.c)
