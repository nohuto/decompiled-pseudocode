/*
 * XREFs of ?_Tidy@?$vector@VNotificationData@@V?$allocator@VNotificationData@@@std@@@std@@AEAAXXZ @ 0x180053B54
 * Callers:
 *     _InputSiteHierarchyManager::UpdateHierarchyFromInputSinkDataCache_::_1_::dtor$0 @ 0x1801D04B0 (_InputSiteHierarchyManager--UpdateHierarchyFromInputSinkDataCache_--_1_--dtor$0.c)
