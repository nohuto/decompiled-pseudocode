/*
 * XREFs of ?LogSetOcclusionRects@BamoSystemContextEndpointProxyImpl@BamoImpl@@AEAAXPEAVBamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x180140B48
 * Callers:
...
void __fastcall BamoImpl::BamoSystemContextEndpointProxyImpl::LogSetOcclusionRects(
