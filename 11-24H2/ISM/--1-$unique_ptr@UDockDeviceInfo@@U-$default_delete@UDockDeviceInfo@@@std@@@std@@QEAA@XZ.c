/*
 * XREFs of ??1?$unique_ptr@UDockDeviceInfo@@U?$default_delete@UDockDeviceInfo@@@std@@@std@@QEAA@XZ @ 0x1800DD164
 * Callers:
 ...
 *     _DockDeviceCollection::OnDeviceAttach_::_1_::dtor$0 @ 0x1801D5B41 (_DockDeviceCollection--OnDeviceAttach_--_1_--dtor$0.c)
 * Callees:
