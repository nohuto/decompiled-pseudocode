/*
 * XREFs of ?LogOnInputObserverManagerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoInputObserverManagerProxy@@@Z @ 0x180118D0C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputObserverManagerChanging(
        BamoInputSystemProxy *this,
        struct BamoInputObserverManagerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
