/*
 * XREFs of ?UpdateTouchpadSupportedGestures@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJ_NW4TouchpadGlobalGestureKinds@Input@Internal@UI@Windows@@@Z @ 0x18015B3B4
 * Callers:
 *     ?Thunk_UpdateTouchpadSupportedGestures_16@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015B190 (-Thunk_UpdateTouchpadSupportedGestures_16@-$IShellGesturesClientProxy_Receive@VBamoShellGestures.c)
