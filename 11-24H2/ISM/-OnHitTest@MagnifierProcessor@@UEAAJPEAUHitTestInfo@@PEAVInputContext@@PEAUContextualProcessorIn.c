/*
 * XREFs of ?OnHitTest@MagnifierProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801AD720
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$As@UIMagnifierControllerProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIMagnifierControllerProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800389FC (--$As@UIMagnifierControllerProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComP.c)
 ...
 *     ?Active@MagnifierRecognizer@@QEAA_NXZ @ 0x1801AE198 (-Active@MagnifierRecognizer@@QEAA_NXZ.c)
