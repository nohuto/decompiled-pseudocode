/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@QEAA_NXZ @ 0x18015A7C4
 * Callers:
        ...
        wil::details *a1)
{
  ...
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoPenEdgy>::GetCachedFeatureEnabledState(a1, &v6);
  v2 = v6 & 1;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoPenEdgy>::ReportUsage((__int64)a1, v6 & 1, v3, v4);
  return v2;
}
