/*
 * XREFs of ?Materialize_BamoEdgyNotificationSourceClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011D6E8
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyNotificationSourceClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126140 (-Thunk_Materialize_BamoEdgyNotificationSourceClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
