/*
 * XREFs of ?LogOnTypeChanging@BamoDropTargetClientProxy@@AEAAXAEBU_GUID@@@Z @ 0x18011A414
 * Callers:
...
void __fastcall BamoDropTargetClientProxy::LogOnTypeChanging(BamoDropTargetClientProxy *this, const struct _GUID *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
