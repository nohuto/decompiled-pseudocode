/*
 * XREFs of ?ProcessFeatureReport@DockableDeviceCollection@@AEAAJAEBUGetFeatureReportResult@1@@Z @ 0x1800DEDF4
 * Callers:
        ...
        const struct DockableDeviceCollection::GetFeatureReportResult *a2)
{
  ...
  __int64 v22; // rax
  const char *ValueCapsLength; // [rsp+30h] [rbp-71h]
  ULONG v24; // [rsp+58h] [rbp-49h] BYREF
  CHAR UsageValue[8]; // [rsp+60h] [rbp-41h] BYREF
  USHORT v26[8]; // [rsp+68h] [rbp-39h] BYREF
