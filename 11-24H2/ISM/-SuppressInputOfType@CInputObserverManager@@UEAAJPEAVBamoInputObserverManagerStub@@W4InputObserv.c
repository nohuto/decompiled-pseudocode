/*
 * XREFs of ?SuppressInputOfType@CInputObserverManager@@UEAAJPEAVBamoInputObserverManagerStub@@W4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x180138D20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
