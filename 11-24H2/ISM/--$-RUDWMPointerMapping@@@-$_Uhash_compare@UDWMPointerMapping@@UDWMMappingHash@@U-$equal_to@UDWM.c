/*
 * XREFs of ??$?RUDWMPointerMapping@@@?$_Uhash_compare@UDWMPointerMapping@@UDWMMappingHash@@U?$equal_to@UDWMPointerMapping@@@std@@@std@@QEBA_KAEBUDWMPointerMapping@@@Z @ 0x180048C3C
 * Callers:
