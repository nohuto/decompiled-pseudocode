/*
 * XREFs of ?LogOnInterfacePathChanged@BamoDockableDeviceProxy@@AEAAXXZ @ 0x180118FA4
 * Callers:
...
void __fastcall BamoDockableDeviceProxy::LogOnInterfacePathChanged(BamoDockableDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
