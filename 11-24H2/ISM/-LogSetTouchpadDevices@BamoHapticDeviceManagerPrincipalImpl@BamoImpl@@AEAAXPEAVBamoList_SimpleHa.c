/*
 * XREFs of ?LogSetTouchpadDevices@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoList_SimpleHapticsControllerPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x18018BC08
 * Callers:
...
void __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::LogSetTouchpadDevices(
