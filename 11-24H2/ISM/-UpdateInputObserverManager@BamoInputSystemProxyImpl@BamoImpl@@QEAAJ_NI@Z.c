/*
 * XREFs of ?UpdateInputObserverManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012A024
 * Callers:
 *     ?Thunk_UpdateInputObserverManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126960 (-Thunk_UpdateInputObserverManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
        ...
        __int64 a3)
{
  ...
  struct BamoInputObserverManagerProxy *v7; // rsi
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnInputObserverManagerChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct BamoInputObserverManagerProxy *))(*((_QWORD *)this - 2) + 216LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
  ...
  *((_QWORD *)this + 11) = v7;
  if ( v7 )
    (**(void (__fastcall ***)(struct BamoInputObserverManagerProxy *))v7)(v7);
  if ( v13 )
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnInputObserverManagerChanged((BamoImpl::BamoInputSystemProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 224LL))((char *)this - 16);
    if ( v14 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x4132,
