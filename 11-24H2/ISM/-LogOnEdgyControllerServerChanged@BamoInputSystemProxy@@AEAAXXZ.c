/*
 * XREFs of ?LogOnEdgyControllerServerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180117D54
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnEdgyControllerServerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
