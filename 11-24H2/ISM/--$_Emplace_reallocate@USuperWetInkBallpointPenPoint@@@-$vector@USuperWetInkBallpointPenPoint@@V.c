/*
 * XREFs of ??$_Emplace_reallocate@USuperWetInkBallpointPenPoint@@@?$vector@USuperWetInkBallpointPenPoint@@V?$allocator@USuperWetInkBallpointPenPoint@@@std@@@std@@AEAAPEAUSuperWetInkBallpointPenPoint@@QEAU2@$$QEAU2@@Z @ 0x1800ABC84
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0DI@@std@@YA_K_K@Z @ 0x18009A88C (--$_Get_size_of_n@$0DI@@std@@YA_K_K@Z.c)
 *     ?_Calculate_growth@?$vector@USuperWetInkBallpointPenPoint@@V?$allocator@USuperWetInkBallpointPenPoint@@@std@@@std@@AEBA_K_K@Z @ 0x1800ABFC8 (-_Calculate_growth@-$vector@USuperWetInkBallpointPenPoint@@V-$allocator@USuperWetInkBallpointPen.c)
 *     ?_Change_array@?$vector@USuperWetInkBallpointPenPoint@@V?$allocator@USuperWetInkBallpointPenPoint@@@std@@@std@@AEAAXQEAUSuperWetInkBallpointPenPoint@@_K1@Z @ 0x1800AC010 (-_Change_array@-$vector@USuperWetInkBallpointPenPoint@@V-$allocator@USuperWetInkBallpointPenPoin.c)
