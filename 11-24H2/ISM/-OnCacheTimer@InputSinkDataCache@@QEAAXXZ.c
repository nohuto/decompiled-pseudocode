/*
 * XREFs of ?OnCacheTimer@InputSinkDataCache@@QEAAXXZ @ 0x18005D638
 * Callers:
 *     ?Initialize@OneCoreUAPInputHost@@IEAAJPEAX@Z @ 0x18005C36C (-Initialize@OneCoreUAPInputHost@@IEAAJPEAX@Z.c)
 *     ?OnCacheTimerStatic@InputSinkDataCache@@SAJPEAX@Z @ 0x18005D620 (-OnCacheTimerStatic@InputSinkDataCache@@SAJPEAX@Z.c)
 * Callees:
