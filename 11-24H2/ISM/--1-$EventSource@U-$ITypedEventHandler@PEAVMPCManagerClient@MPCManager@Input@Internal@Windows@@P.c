/*
 * XREFs of ??1?$EventSource@U?$ITypedEventHandler@PEAVMPCManagerClient@MPCManager@Input@Internal@Windows@@PEAVHomeGestureReadyChangedEventArgs@2345@@Foundation@Windows@@U?$InvokeModeOptions@$0?1@WRL@Microsoft@@@WRL@Microsoft@@QEAA@XZ @ 0x1801611A8
 * Callers:
 ...
 *     _Microsoft::WRL::InvokeTraits__2_::InvokeDelegates__lambda_2994a7a20cb592567dc6818203d49b13__Windows::Foundation::ITypedEventHandler_Windows::Internal::Input::MPCManager::MPCConstantManagerClient___Windows::Internal::Input::MPCManager::ConstantChangedEventArgs______::_1_::dtor$0 @ 0x1801D7FD4 (_Microsoft--WRL--InvokeTraits__2_--InvokeDelegates__lambda_2994a7a20cb592567dc6818203d49b13__Win.c)
 * Callees:
