/*
 * XREFs of ?LogOnTailButtonLongPressedEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x1801952D0
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonLongPressedEventsRequiredChanged(
