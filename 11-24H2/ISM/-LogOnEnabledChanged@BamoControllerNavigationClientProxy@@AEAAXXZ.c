/*
 * XREFs of ?LogOnEnabledChanged@BamoControllerNavigationClientProxy@@AEAAXXZ @ 0x18017726C
 * Callers:
...
void __fastcall BamoControllerNavigationClientProxy::LogOnEnabledChanged(BamoControllerNavigationClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
