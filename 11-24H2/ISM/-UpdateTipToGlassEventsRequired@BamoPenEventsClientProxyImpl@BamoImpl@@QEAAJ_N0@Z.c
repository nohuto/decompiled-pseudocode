/*
 * XREFs of ?UpdateTipToGlassEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1800982DC
 * Callers:
 *     ?Thunk_UpdateTipToGlassEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800908A0 (-Thunk_UpdateTipToGlassEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientPro.c)
