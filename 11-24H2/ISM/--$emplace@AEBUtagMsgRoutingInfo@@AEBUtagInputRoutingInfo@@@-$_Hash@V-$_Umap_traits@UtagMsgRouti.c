 ...
 *     ??$_Find_last@UtagMsgRoutingInfo@@@?$_Hash@V?$_Umap_traits@UtagMsgRoutingInfo@@UtagInputRoutingInfo@@V?$_Uhash_compare@UtagMsgRoutingInfo@@U?$hash@UtagMsgRoutingInfo@@@std@@U?$equal_to@UtagMsgRoutingInfo@@@3@@std@@V?$allocator@U?$pair@$$CBUtagMsgRoutingInfo@@UtagInputRoutingInfo@@@std@@@4@$0A@@std@@@std@@IEBA?AU?$_Hash_find_last_result@PEAU?$_List_node@U?$pair@$$CBUtagMsgRoutingInfo@@UtagInputRoutingInfo@@@std@@PEAX@std@@@1@AEBUtagMsgRoutingInfo@@_K@Z @ 0x18003B0E8 (--$_Find_last@UtagMsgRoutingInfo@@@-$_Hash@V-$_Umap_traits@UtagMsgRoutingInfo@@UtagInputRoutingI.c)
 *     ?_Forced_rehash@?$_Hash@V?$_Umap_traits@UtagMsgRoutingInfo@@UtagInputRoutingInfo@@V?$_Uhash_compare@UtagMsgRoutingInfo@@U?$hash@UtagMsgRoutingInfo@@@std@@U?$equal_to@UtagMsgRoutingInfo@@@3@@std@@V?$allocator@U?$pair@$$CBUtagMsgRoutingInfo@@UtagInputRoutingInfo@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x180052968 (-_Forced_rehash@-$_Hash@V-$_Umap_traits@UtagMsgRoutingInfo@@UtagInputRoutingInfo@@V-$_Uhash_comp.c)
        ...
        _OWORD *a4)
{
  ...
  else
  {
    ...
    v18 = a1 + 2;
    v19 &= *((_QWORD *)&v17 + 1);
    v9 = operator new((unsigned int)(DWORD2(v17) + 104));
    v19 = (unsigned __int64)v9;
    v9[1] = *(_OWORD *)a3;
    v9[2] = *((_OWORD *)a3 + 1);
    *((_QWORD *)v9 + 6) = *((_QWORD *)a3 + 4);
    *(_OWORD *)((char *)v9 + 56) = *a4;
    *(_OWORD *)((char *)v9 + 72) = a4[1];
    *(_OWORD *)((char *)v9 + 88) = a4[2];
    v10 = *((_QWORD *)a1 + 2) + 1LL;
    if ( v10 < 0 )
