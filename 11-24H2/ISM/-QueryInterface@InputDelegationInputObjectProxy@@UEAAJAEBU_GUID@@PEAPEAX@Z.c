/*
 * XREFs of ?QueryInterface@InputDelegationInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005A260
 * Callers:
 *     ?QueryInterface@InputDelegationInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133FD0 (-QueryInterface@InputDelegationInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@InputDelegationInputObjectProxy@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133FE0 (-QueryInterface@InputDelegationInputObjectProxy@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@InputDelegationInputObjectProxy@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133FF0 (-QueryInterface@InputDelegationInputObjectProxy@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@InputDelegationInputObjectProxy@@WEI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180134000 (-QueryInterface@InputDelegationInputObjectProxy@@WEI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
