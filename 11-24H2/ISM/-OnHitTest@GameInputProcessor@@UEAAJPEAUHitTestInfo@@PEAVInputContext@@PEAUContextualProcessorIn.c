/*
 * XREFs of ?OnHitTest@GameInputProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180048480
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GameInputServerGet @ 0x180099A3C (GameInputServerGet.c)
