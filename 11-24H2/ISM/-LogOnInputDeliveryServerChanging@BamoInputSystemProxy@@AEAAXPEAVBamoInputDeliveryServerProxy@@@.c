/*
 * XREFs of ?LogOnInputDeliveryServerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoInputDeliveryServerProxy@@@Z @ 0x180118C4C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputDeliveryServerChanging(
