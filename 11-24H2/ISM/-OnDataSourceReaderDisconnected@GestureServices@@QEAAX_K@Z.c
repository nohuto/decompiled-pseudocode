/*
 * XREFs of ?OnDataSourceReaderDisconnected@GestureServices@@QEAAX_K@Z @ 0x180094240
 * Callers:
 *     ?OnReaderDisconnected@DataProviderPrincipal@@UEAAJPEAVBamoDataProviderStub@@_K@Z @ 0x180094200 (-OnReaderDisconnected@DataProviderPrincipal@@UEAAJPEAVBamoDataProviderStub@@_K@Z.c)
 * Callees:
