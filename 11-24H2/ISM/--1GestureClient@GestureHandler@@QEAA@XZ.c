/*
 * XREFs of ??1GestureClient@GestureHandler@@QEAA@XZ @ 0x180141BA0
 * Callers:
 ...
 *     _GestureHandler::AddGestureClient_::_1_::dtor$3 @ 0x1801D758C (_GestureHandler--AddGestureClient_--_1_--dtor$3.c)
 * Callees:
