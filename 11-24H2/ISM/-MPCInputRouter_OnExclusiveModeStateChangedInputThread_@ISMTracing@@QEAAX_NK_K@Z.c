/*
 * XREFs of ?MPCInputRouter_OnExclusiveModeStateChangedInputThread_@ISMTracing@@QEAAX_NK_K@Z @ 0x1800FDEC4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( ISMTracing::IsEnabled() )
  {
    ...
    if ( *(_DWORD *)v7 > 4u && tlgKeywordOn((__int64)v7, 1LL) )
    {
      ...
      v21 = 8;
      v18 = 4;
      tlgWriteTransfer_EventWriteTransfer(v9, byte_180214E7C, 0LL, 0LL, 5u, &v13);
    }
  }
}
