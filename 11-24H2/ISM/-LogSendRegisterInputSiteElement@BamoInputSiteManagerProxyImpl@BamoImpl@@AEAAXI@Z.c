/*
 * XREFs of ?LogSendRegisterInputSiteElement@BamoInputSiteManagerProxyImpl@BamoImpl@@AEAAXI@Z @ 0x18011B634
 * Callers:
...
void __fastcall BamoImpl::BamoInputSiteManagerProxyImpl::LogSendRegisterInputSiteElement(
