/*
 * XREFs of ?SendMaterializeProxy@BamoInputProcessPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800CC9D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoInputProcessPrincipalImpl::SendMaterializeProxy(
