/*
 * XREFs of ??$RemoveObject@UIMagnifierControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180038AC8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IMagnifierControllerProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_b5135dce_13f2_00ca_8db4_0bd6f94fc834, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
