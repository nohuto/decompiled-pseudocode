/*
 * XREFs of ?LogOnControllerNavigationManagerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoControllerNavigationManagerProxy@@@Z @ 0x1801178B8
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnControllerNavigationManagerChanging(
        BamoInputSystemProxy *this,
        struct BamoControllerNavigationManagerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
