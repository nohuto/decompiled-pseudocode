/*
 * XREFs of ?LogOnEnabledChanging@BamoControllerNavigationClientProxy@@AEAAX_N@Z @ 0x1801772BC
 * Callers:
...
void __fastcall BamoControllerNavigationClientProxy::LogOnEnabledChanging(BamoControllerNavigationClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
