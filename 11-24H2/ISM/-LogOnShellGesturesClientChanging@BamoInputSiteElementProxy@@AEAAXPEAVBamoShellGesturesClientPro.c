/*
 * XREFs of ?LogOnShellGesturesClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoShellGesturesClientProxy@@@Z @ 0x18008C684
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnShellGesturesClientChanging(
