/*
 * XREFs of ?UpdateGestureDirection@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NPEBUVector2@Numerics@Foundation@Windows@@@Z @ 0x180128BF0
 * Callers:
 *     ?Thunk_UpdateGestureDirection_185@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801267B0 (-Thunk_UpdateGestureDirection_185@-$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyG.c)
