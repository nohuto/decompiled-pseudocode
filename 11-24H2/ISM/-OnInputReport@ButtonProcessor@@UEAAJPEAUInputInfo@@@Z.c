/*
 * XREFs of ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180035150
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z @ 0x1801B7870 (-ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z.c)
...
LABEL_17:
  ...
  if ( v11 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v21);
  v12 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 3) + 72LL))(*((_QWORD *)this + 3));
  v13 = v12;
  if ( !v12 )
  {
    v16 = -2147418113;
