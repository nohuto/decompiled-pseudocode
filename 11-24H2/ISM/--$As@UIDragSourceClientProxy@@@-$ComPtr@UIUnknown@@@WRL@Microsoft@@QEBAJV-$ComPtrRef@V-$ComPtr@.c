/*
 * XREFs of ??$As@UIDragSourceClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDragSourceClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005EA5C
 * Callers:
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_48b7db2e_8d7c_d06b_2343_86cab6a9c078, a2);
}
