/*
 * XREFs of ?LogOnHWNDChanging@BamoActivationListenerInputObjectProxy@@AEAAX_K@Z @ 0x180094DC4
 * Callers:
...
void __fastcall BamoActivationListenerInputObjectProxy::LogOnHWNDChanging(BamoActivationListenerInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
