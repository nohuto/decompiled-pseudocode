/*
 * XREFs of ?RuntimeClassInitialize@SpatialRimDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAVHIDDevice@@PEAX@Z @ 0x1800D2A88
 * Callers:
        ...
        void *a3)
{
  ...
  v23 = 0LL;
  *((_DWORD *)this + 12) = v3;
  HIDCapabilities = HIDDevice::GetHIDCapabilities(a2, &v23);
