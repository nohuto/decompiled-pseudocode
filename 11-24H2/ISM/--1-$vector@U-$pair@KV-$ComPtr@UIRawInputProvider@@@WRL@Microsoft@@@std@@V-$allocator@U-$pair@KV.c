/*
 * XREFs of ??1?$vector@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x1800991E4
 * Callers:
 *     _InputStateManager::SendDeviceCommand_::_1_::dtor$0 @ 0x1801D330F (_InputStateManager--SendDeviceCommand_--_1_--dtor$0.c)
 * Callees:
