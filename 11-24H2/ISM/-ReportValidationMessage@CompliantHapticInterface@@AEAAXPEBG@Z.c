/*
 * XREFs of ?ReportValidationMessage@CompliantHapticInterface@@AEAAXPEBG@Z @ 0x18019ABA4
 * Callers:
...
void __fastcall CompliantHapticInterface::ReportValidationMessage(
        CompliantHapticInterface *this,
        const unsigned __int16 *a2)
{
  if ( *((_QWORD *)this + 65) )
    std::_Func_class<void,bool,unsigned short const *>::operator()((__int64)this + 464, 0, (__int64)a2);
}
