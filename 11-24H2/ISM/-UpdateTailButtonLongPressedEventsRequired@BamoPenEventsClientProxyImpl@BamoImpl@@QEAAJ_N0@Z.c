/*
 * XREFs of ?UpdateTailButtonLongPressedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18007A404
 * Callers:
 *     ?Thunk_UpdateTailButtonLongPressedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800942C0 (-Thunk_UpdateTailButtonLongPressedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEven.c)
