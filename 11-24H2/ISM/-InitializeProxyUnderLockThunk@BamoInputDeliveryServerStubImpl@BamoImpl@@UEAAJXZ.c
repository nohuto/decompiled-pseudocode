/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoInputDeliveryServerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800755F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputDeliveryServerStubImpl::InitializeProxyUnderLockThunk(
