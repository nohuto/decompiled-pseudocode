/*
 * XREFs of ?UpdateGestureDirection@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x180156FE0
 * Callers:
 *     ?Thunk_UpdateGestureDirection_176@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180156F50 (-Thunk_UpdateGestureDirection_176@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClient.c)
