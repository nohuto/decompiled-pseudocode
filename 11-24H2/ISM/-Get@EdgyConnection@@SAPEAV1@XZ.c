/*
 * XREFs of ?Get@EdgyConnection@@SAPEAV1@XZ @ 0x1800828A0
 * Callers:
 ...
 *     ??4?$ComPtr@VEdgyConnection@@@WRL@Microsoft@@QEAAAEAV012@PEAVEdgyConnection@@@Z @ 0x18009536C (--4-$ComPtr@VEdgyConnection@@@WRL@Microsoft@@QEAAAEAV012@PEAVEdgyConnection@@@Z.c)
 */
