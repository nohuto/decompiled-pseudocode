/*
 * XREFs of ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_HAPTIC_NOTIFICATION_MESSAGE@@@@CAJPEAX0H@Z @ 0x1800F2FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KernelInputConnection<_MIT_HAPTIC_NOTIFICATION_MESSAGE>::s_OnKernelInputEventStatic(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        const char *a4)
