/*
 * XREFs of ?Thunk_SetCursorShellMagnification_390@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8170
 * Callers:
 *     <none>
 * Callees:
 *     <none>
