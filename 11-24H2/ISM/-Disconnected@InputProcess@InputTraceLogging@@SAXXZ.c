/*
 * XREFs of ?Disconnected@InputProcess@InputTraceLogging@@SAXXZ @ 0x1800CC3D0
 * Callers:
 *     ?OnStubDisconnected@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@@Z @ 0x1800CC7E0 (-OnStubDisconnected@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@.c)
 * Callees:
