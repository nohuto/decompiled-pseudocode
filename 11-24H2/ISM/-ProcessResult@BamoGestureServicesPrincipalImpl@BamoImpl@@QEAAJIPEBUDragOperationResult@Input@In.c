/*
 * XREFs of ?ProcessResult@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJIPEBUDragOperationResult@Input@Internal@UI@Windows@@I@Z @ 0x180142EE0
 * Callers:
 *     ?Thunk_ProcessResult_218@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143C20 (-Thunk_ProcessResult_218@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@B.c)
 * Callees:
