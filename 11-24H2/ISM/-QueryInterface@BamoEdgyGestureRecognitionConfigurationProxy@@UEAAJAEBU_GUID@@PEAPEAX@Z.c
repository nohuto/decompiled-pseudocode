/*
 * XREFs of ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121B60
 * Callers:
 *     ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121BF0 (-QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
