/*
 * XREFs of ?LogSetPanelId@BamoDockDevicePrincipalImpl@BamoImpl@@AEAAXPEBG@Z @ 0x18017FAC8
 * Callers:
...
void __fastcall BamoImpl::BamoDockDevicePrincipalImpl::LogSetPanelId(
