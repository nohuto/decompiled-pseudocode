/*
 * XREFs of ?QueryInterface@BamoShellHandwritingHostClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B7B0
 * Callers:
 *     ?QueryInterface@BamoShellHandwritingHostClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B840 (-QueryInterface@BamoShellHandwritingHostClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
