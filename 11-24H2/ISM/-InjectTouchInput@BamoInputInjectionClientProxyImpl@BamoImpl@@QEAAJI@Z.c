/*
 * XREFs of ?InjectTouchInput@BamoInputInjectionClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18019D454
 * Callers:
 *     ?Thunk_InjectTouchInput_8@?$IInputInjectionClientProxy_Receive@VBamoInputInjectionClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18019D9B0 (-Thunk_InjectTouchInput_8@-$IInputInjectionClientProxy_Receive@VBamoInputInjectionClientProxyImp.c)
 * Callees:
