/*
 * XREFs of ?AllocateStubUnderLock@BamoEdgyControllerServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoEdgyControllerServerStub@@@Z @ 0x1800744B0
 * Callers:
 *     <none>
 * Callees:
