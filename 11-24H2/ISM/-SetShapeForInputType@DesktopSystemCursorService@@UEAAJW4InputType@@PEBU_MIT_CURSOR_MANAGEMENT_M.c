/*
 * XREFs of ?SetShapeForInputType@DesktopSystemCursorService@@UEAAJW4InputType@@PEBU_MIT_CURSOR_MANAGEMENT_MESSAGE@@@Z @ 0x180077720
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ClearShape@HardwareCursorVisual@SystemCursors@@QEAAJXZ @ 0x1800FBF08 (-ClearShape@HardwareCursorVisual@SystemCursors@@QEAAJXZ.c)
