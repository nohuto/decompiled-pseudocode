/*
 * XREFs of ?OnDragManagerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005FC40
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005FCB8 (--$RemoveObject@UIDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
