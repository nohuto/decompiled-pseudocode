/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801272D8
 * Callers:
 *     ?Thunk_UpdateActivationWatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126580 (-Thunk_UpdateActivationWatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
