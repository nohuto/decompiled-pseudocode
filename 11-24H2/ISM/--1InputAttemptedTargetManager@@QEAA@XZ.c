/*
 * XREFs of ??1InputAttemptedTargetManager@@QEAA@XZ @ 0x18015D4F4
 * Callers:
 *     _InputDeliveryServer::InputDeliveryServer_::_1_::dtor$2 @ 0x1801CFA48 (_InputDeliveryServer--InputDeliveryServer_--_1_--dtor$2.c)
 * Callees:
