/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_52580392@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x18017D938
 * Callers:
...
char __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_52580392>::__private_IsEnabled(wil::details *a1)
{
  ...
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_52580392>::GetCachedFeatureEnabledState(a1, &v6);
  v2 = v6 & 1;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_52580392>::ReportUsage((__int64)a1, v6 & 1, v3, v4);
  return v2;
}
