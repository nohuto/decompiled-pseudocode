/*
 * XREFs of ?OnInputReport@AugmentedInputDeviceCollection@@MEAAJKPEAXK@Z @ 0x1800D3B10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v24 = PreparsedData;
  Device = HIDDevice::GetHIDCapabilities(*(PHIDP_PREPARSED_DATA **)UsageLength, &v20);
  if ( Device < 0 )
  {
    v9 = 183LL;
    goto LABEL_3;
