/*
 * XREFs of ?LogReceiveRegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoControllerNavigationOverrideProxy@@@Z @ 0x180175B0C
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationManagerPrincipalImpl::LogReceiveRegisterOverride(
