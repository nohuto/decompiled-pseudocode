/*
 * XREFs of ??0MPCHeadMovementDetector@@QEAA@XZ @ 0x1800D0E94
 * Callers:
 ...
 *     ?ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x180080970 (-ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
 ...
 *     ??4?$com_ptr_t@UIPerceptionTimestampHelperStaticsInternal@Internal@Perception@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800C1B30 (--4-$com_ptr_t@UIPerceptionTimestampHelperStaticsInternal@Internal@Perception@Windows@@Uerr_exce.c)
