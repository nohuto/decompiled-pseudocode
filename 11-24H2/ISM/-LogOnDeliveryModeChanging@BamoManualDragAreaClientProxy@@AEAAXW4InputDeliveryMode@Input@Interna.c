/*
 * XREFs of ?LogOnDeliveryModeChanging@BamoManualDragAreaClientProxy@@AEAAXW4InputDeliveryMode@Input@Internal@UI@Windows@@@Z @ 0x1801483B8
 * Callers:
