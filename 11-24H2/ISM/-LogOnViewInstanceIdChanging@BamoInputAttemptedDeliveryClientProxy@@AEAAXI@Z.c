/*
 * XREFs of ?LogOnViewInstanceIdChanging@BamoInputAttemptedDeliveryClientProxy@@AEAAXI@Z @ 0x18015D11C
 * Callers:
...
void __fastcall BamoInputAttemptedDeliveryClientProxy::LogOnViewInstanceIdChanging(
