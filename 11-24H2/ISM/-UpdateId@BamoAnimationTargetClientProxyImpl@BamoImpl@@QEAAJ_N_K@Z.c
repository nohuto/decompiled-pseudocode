/*
 * XREFs of ?UpdateId@BamoAnimationTargetClientProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18009894C
 * Callers:
 *     ?Thunk_UpdateId_0@?$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180090840 (-Thunk_UpdateId_0@-$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@Bamo.c)
