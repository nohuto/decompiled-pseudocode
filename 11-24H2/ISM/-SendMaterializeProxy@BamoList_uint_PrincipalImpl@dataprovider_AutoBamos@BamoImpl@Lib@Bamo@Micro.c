/*
 * XREFs of ?SendMaterializeProxy@BamoList_uint_PrincipalImpl@dataprovider_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@36@@Z @ 0x180104430
 * Callers:
 *     <none>
 * Callees:
