/*
 * XREFs of ?QueryInterface@BamoDragAreaClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801218D0
 * Callers:
 *     ?QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121960 (-QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
