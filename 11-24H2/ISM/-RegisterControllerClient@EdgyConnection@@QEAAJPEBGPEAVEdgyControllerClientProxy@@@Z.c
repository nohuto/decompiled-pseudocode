/*
 * XREFs of ?RegisterControllerClient@EdgyConnection@@QEAAJPEBGPEAVEdgyControllerClientProxy@@@Z @ 0x1801A83EC
 * Callers:
 ...
 *     ?GetType@BamoDragSourceClientProxy@@UEAAAEBU_GUID@@XZ @ 0x18009C450 (-GetType@BamoDragSourceClientProxy@@UEAAAEBU_GUID@@XZ.c)
