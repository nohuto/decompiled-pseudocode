/*
 * XREFs of ?UpdateEnabled@BamoDelegatedInkCanvasInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012888C
 * Callers:
 *     ?Thunk_UpdateEnabled_11@?$IDelegatedInkCanvasInputObjectProxy_Receive@VBamoDelegatedInkCanvasInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126760 (-Thunk_UpdateEnabled_11@-$IDelegatedInkCanvasInputObjectProxy_Receive@VBamoDelegatedInkCanvasInp.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDelegatedInkCanvasInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012C140 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDelegatedInkCanvasInputObjectProxyImpl@BamoImpl@.c)
 * Callees:
