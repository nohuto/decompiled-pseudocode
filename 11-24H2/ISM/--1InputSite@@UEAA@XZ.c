/*
 * XREFs of ??1InputSite@@UEAA@XZ @ 0x180037CEC
 * Callers:
 *     ??_EInputSite@@UEAAPEAXI@Z @ 0x180037CB0 (--_EInputSite@@UEAAPEAXI@Z.c)
 * Callees:
 *     ??$_Deallocate@$0BA@$0A@@std@@YAXPEAX_K@Z @ 0x18001B0D0 (--$_Deallocate@$0BA@$0A@@std@@YAXPEAX_K@Z.c)
 *     ??1?$_Optional_destruct_base@VLegacyInputSinkData@@$0A@@std@@QEAA@XZ @ 0x180037DC8 (--1-$_Optional_destruct_base@VLegacyInputSinkData@@$0A@@std@@QEAA@XZ.c)
