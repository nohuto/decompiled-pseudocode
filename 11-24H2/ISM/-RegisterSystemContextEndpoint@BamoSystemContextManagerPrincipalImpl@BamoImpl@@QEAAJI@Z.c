/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013EBD0
 * Callers:
 *     ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801408A0 (-Thunk_RegisterSystemContextEndpoint_8@-$ISystemContextManagerPrincipal_Receive@VBamoSystemConte.c)
 * Callees:
