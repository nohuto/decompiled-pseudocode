/*
 * XREFs of ?LogOnIsIntensitySupportedChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x18011910C
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsIntensitySupportedChanged(
