/*
 * XREFs of ?LogOnInterfacePathChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x180118FF4
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnInterfacePathChanged(BamoSimpleHapticsControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
