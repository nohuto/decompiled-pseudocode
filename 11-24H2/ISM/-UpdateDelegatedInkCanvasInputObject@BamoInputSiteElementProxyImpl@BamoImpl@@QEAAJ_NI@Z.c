/*
 * XREFs of ?UpdateDelegatedInkCanvasInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003F0B0
 * Callers:
 *     ?Thunk_UpdateDelegatedInkCanvasInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071E90 (-Thunk_UpdateDelegatedInkCanvasInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
