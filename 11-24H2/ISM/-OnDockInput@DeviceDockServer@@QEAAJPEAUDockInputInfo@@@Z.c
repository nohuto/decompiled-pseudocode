/*
 * XREFs of ?OnDockInput@DeviceDockServer@@QEAAJPEAUDockInputInfo@@@Z @ 0x18017FFF4
 * Callers:
 ...
 *     ??$_Eqrange@UDockInputIdentity@@@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UtagRECT@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UtagRECT@@@std@@@4@$0A@@std@@@std@@IEBA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UtagRECT@@@std@@PEAX@std@@PEAU12@@1@AEBUDockInputIdentity@@@Z @ 0x18017EC5C (--$_Eqrange@UDockInputIdentity@@@-$_Tree@V-$_Tmap_traits@UDockInputIdentity@@UtagRECT@@U-$less@U.c)
 ...
 *     ??0?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAA@AEBV01@@Z @ 0x18017F090 (--0-$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAA@AEBV01@@Z.c)
 ...
 *     ?_Erase@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UtagRECT@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UtagRECT@@@std@@@4@$0A@@std@@@std@@AEAA_KU?$pair@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UtagRECT@@@std@@PEAX@std@@PEAU12@@2@@Z @ 0x1801827BC (-_Erase@-$_Tree@V-$_Tmap_traits@UDockInputIdentity@@UtagRECT@@U-$less@UDockInputIdentity@@@std@@.c)
...
__int64 __fastcall DeviceDockServer::OnDockInput(DeviceDockServer *this, struct DockInputInfo *a2)
{
  ...
  volatile signed __int32 *v39; // [rsp+30h] [rbp-D8h] BYREF
  volatile signed __int32 *v40; // [rsp+38h] [rbp-D0h] BYREF
  volatile signed __int32 *v41; // [rsp+40h] [rbp-C8h] BYREF
  __int64 v42; // [rsp+48h] [rbp-C0h] BYREF
  __int64 v43; // [rsp+50h] [rbp-B8h] BYREF
  DeviceDockServer *v44; // [rsp+58h] [rbp-B0h]
  _QWORD v45[3]; // [rsp+60h] [rbp-A8h] BYREF
  _BYTE v46[16]; // [rsp+78h] [rbp-90h] BYREF
  _QWORD v47[3]; // [rsp+88h] [rbp-80h] BYREF
  _QWORD v48[3]; // [rsp+A0h] [rbp-68h] BYREF
  _BYTE v49[24]; // [rsp+B8h] [rbp-50h] BYREF
  _OWORD v50[2]; // [rsp+D0h] [rbp-38h] BYREF
  unsigned __int16 v51[60]; // [rsp+F0h] [rbp-18h] BYREF
  ...
  wil::com_ptr_t<BamoDockDevicePrincipal,wil::err_returncode_policy>::com_ptr_t<BamoDockDevicePrincipal,wil::err_returncode_policy>(
    &v42,
    (void (__fastcall ****)(_QWORD))(v43 + 40));
  v5 = v42 + 8;
  if ( !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(v42 + 8) + 40LL))(v42 + 8) )
    goto LABEL_41;
  v6 = (_OWORD *)((char *)a2 + 68);
  v7 = *((_DWORD *)a2 + 19) - *((_DWORD *)a2 + 17);
  v8 = *((_DWORD *)a2 + 20) - *((_DWORD *)a2 + 18);
  v9 = (__int64 *)((char *)this + 136);
    ...
    || v11 == (_DWORD *)*v9 )
  {
    ...
    v50[0] = *v6;
    v50[1] = *(_OWORD *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v5 + 56LL))(v5);
    v20 = (char *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v5 + 24LL))(v5);
    v21 = StringCchCopyW((char *)v51, 57LL, v20);
    if ( v21 < 0 )
    ...
    v23 = DisplayOcclusionContextProvider::OnOcclusionRectAdded(
            (DisplayOcclusionContextProvider *)Instance,
            (struct DockInputInfo *)((char *)a2 + 32),
            (const struct DisplayOcclusionRect *)v49);
    v15 = v23;
    if ( v23 < 0 )
    {
  ...
  if ( v7 > 0 && v8 > 0 && v12 )
  {
    *(_OWORD *)(v11 + 14) = *v6;
    ...
    if ( v14 < 0 )
    {
      ...
      v16 = (__int64 *)&v39;
LABEL_38:
      wil::com_ptr_t<KernelContextProvider,wil::err_exception_policy>::~com_ptr_t<KernelContextProvider,wil::err_exception_policy>(v16);
      wil::com_ptr_t<AsyncHRESULTPrincipal,wil::err_exception_policy>::~com_ptr_t<AsyncHRESULTPrincipal,wil::err_exception_policy>(&v42);
      return v15;
    }
    wil::com_ptr_t<KernelContextProvider,wil::err_exception_policy>::~com_ptr_t<KernelContextProvider,wil::err_exception_policy>((__int64 *)&v39);
  }
  if ( !*((_BYTE *)a2 + 64) || !v7 || !v8 )
  {
LABEL_24:
    *(_OWORD *)&v45[1] = *(_OWORD *)std::_Tree<std::_Tmap_traits<DockInputIdentity,tagRECT,std::less<DockInputIdentity>,std::allocator<std::pair<DockInputIdentity const,tagRECT>>,0>>::_Eqrange<DockInputIdentity>(
                                      v9,
                                      v48,
                                      (unsigned int *)a2 + 8);
    std::_Tree<std::_Tmap_traits<DockInputIdentity,tagRECT,std::less<DockInputIdentity>,std::allocator<std::pair<DockInputIdentity const,tagRECT>>,0>>::_Erase(
      v9,
      &v45[1]);
    v17 = (volatile signed __int32 *)DisplayOcclusionContextProvider::GetInstance();
    v40 = v17;
    if ( v17 )
    {
    ...
    v18 = DisplayOcclusionContextProvider::OnOcclusionRectRemoved(
            (DisplayOcclusionContextProvider *)v17,
            (struct DockInputInfo *)((char *)a2 + 32));
    v15 = v18;
    if ( v18 < 0 )
    {
    ...
    v19 = (__int64 *)&v40;
LABEL_40:
    wil::com_ptr_t<KernelContextProvider,wil::err_exception_policy>::~com_ptr_t<KernelContextProvider,wil::err_exception_policy>(v19);
  }
LABEL_41:
  v25 = *(_OWORD *)a2;
  v26 = *((_OWORD *)a2 + 1);
  ...
  v30 = *((_QWORD *)a2 + 10);
  v31 = v44;
  v32 = *(_QWORD *)std::map<DockInputIdentity,DockInputInfo>::_Try_emplace<DockInputIdentity const &,>(
                     (_QWORD *)v44 + 15,
                     (__int64)v46,
                     (unsigned int *)a2 + 8);
  *(_OWORD *)(v32 + 56) = v25;
  ...
  *(_QWORD *)(v32 + 136) = v30;
  ...
  if ( v33 )
  {
    v37 = (*(__int64 (__fastcall **)(__int64, _QWORD, struct DockInputInfo *))(*(_QWORD *)(v33 + 8) + 40LL))(
            v33 + 8,
            *((unsigned int *)a2 + 1),
            a2);
    if ( v37 < 0 )
  ...
  {
    v34 = *((_QWORD *)v31 + 8);
    for ( i = *((_QWORD *)v31 + 7); i != v34; i += 8LL )
    {
      v36 = (*(__int64 (__fastcall **)(__int64, _QWORD, struct DockInputInfo *))(*(_QWORD *)(*(_QWORD *)i + 8LL) + 40LL))(
              *(_QWORD *)i + 8LL,
              *((unsigned int *)a2 + 1),
              a2);
      if ( v36 < 0 )
