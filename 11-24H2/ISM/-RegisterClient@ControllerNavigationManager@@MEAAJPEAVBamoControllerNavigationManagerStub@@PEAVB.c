/*
 * XREFs of ?RegisterClient@ControllerNavigationManager@@MEAAJPEAVBamoControllerNavigationManagerStub@@PEAVBamoControllerNavigationClientProxy@@@Z @ 0x180176460
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoControllerNavigationClientProxy *a3)
{
  ...
  v13 = v7;
  InputETW::ControllerNavigationManager::RegisterClient(ProcessId, &v13, *v8);
  v15 = ProcessId;
