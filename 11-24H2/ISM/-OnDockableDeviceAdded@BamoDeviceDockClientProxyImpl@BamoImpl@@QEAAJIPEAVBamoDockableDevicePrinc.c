/*
 * XREFs of ?OnDockableDeviceAdded@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockableDevicePrincipal@@@Z @ 0x180183290
 * Callers:
        ...
        struct BamoDockableDevicePrincipal *a3)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockableDeviceAdded(this);
