/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x1800EF808
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$42 @ 0x1801D6520 (_Win32kInterop--Win32kInterop_--_1_--dtor$42.c)
 *     _MagnifierProcessor::MagnifierProcessor_::_1_::dtor$4 @ 0x1801D939E (_MagnifierProcessor--MagnifierProcessor_--_1_--dtor$4.c)
 * Callees:
