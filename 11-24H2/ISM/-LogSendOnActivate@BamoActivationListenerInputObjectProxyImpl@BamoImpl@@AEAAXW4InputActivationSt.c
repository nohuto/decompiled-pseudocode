/*
 * XREFs of ?LogSendOnActivate@BamoActivationListenerInputObjectProxyImpl@BamoImpl@@AEAAXW4InputActivationState@Input@UI@Windows@@@Z @ 0x18008B5A0
 * Callers:
