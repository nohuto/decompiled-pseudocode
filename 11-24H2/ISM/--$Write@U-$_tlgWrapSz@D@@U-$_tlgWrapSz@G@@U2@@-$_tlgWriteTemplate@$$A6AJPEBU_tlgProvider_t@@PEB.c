/*
 * XREFs of ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapSz@G@@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapSz@G@@4@Z @ 0x1800043CC
 * Callers:
        ...
        const WCHAR **a7)
{
  ...
  v20 = v16;
  v21 = 0;
  return tlgWriteTransfer_EventWriteTransfer(&dword_18024E248, a2, 0LL, 0LL, 5, v18);
}
