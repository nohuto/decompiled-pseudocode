/*
 * XREFs of ?OnInput@DelegatedInkCanvasProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1800ABE20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SuperWetPointFromPointerInfo@DelegatedInkCanvasProcessor@@AEBA?AUSuperWetInkBallpointPenPoint@@AEBUtagPOINTER_INFO@@@Z @ 0x1800ABF6C (-SuperWetPointFromPointerInfo@DelegatedInkCanvasProcessor@@AEBA-AUSuperWetInkBallpointPenPoint@@.c)
 */
