/*
 * XREFs of ?QueryInterface@ShellGesturesClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180063A20
 * Callers:
 *     ?QueryInterface@ShellGesturesClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B090 (-QueryInterface@ShellGesturesClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@ShellGesturesClientProxy@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B0A0 (-QueryInterface@ShellGesturesClientProxy@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@ShellGesturesClientProxy@@WIA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B0B0 (-QueryInterface@ShellGesturesClientProxy@@WIA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@ShellGesturesClientProxy@@WII@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015B0D0 (-QueryInterface@ShellGesturesClientProxy@@WII@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
