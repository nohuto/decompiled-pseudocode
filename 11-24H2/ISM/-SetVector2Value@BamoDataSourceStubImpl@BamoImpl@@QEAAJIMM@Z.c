/*
 * XREFs of ?SetVector2Value@BamoDataSourceStubImpl@BamoImpl@@QEAAJIMM@Z @ 0x18010547C
 * Callers:
 *     ?CallSetVector2ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@IMM@Z @ 0x180102338 (-CallSetVector2ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@.c)
        ...
        float a4)
{
  ...
  struct IMessageCallSendHost *v10; // [rsp+60h] [rbp+1Fh] BYREF
  _QWORD v11[6]; // [rsp+68h] [rbp+27h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+A0h] [rbp+5Fh]
  unsigned int v13; // [rsp+A8h] [rbp+67h] BYREF
