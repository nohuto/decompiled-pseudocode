/*
 * XREFs of ?OnInvalidateInput@MobileButtonDeviceCollection@@UEAAJPEAX@Z @ 0x1800DACE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace_reallocate@AEBG@?$vector@GV?$allocator@G@std@@@std@@AEAAPEAGQEAGAEBG@Z @ 0x1800D9958 (--$_Emplace_reallocate@AEBG@-$vector@GV-$allocator@G@std@@@std@@AEAAPEAGQEAGAEBG@Z.c)
