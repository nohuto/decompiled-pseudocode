/*
 * XREFs of ?LogSendOnGamepadInput@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@AEAAXG_N@Z @ 0x1801335DC
 * Callers:
        ...
        BamoImpl::BamoInputDelegationInputObjectProxyImpl *this)
{
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    v14 = v1 + 3;
    v20 = 2;
    tlgWriteTransfer_EventWriteTransfer(v4, byte_18021CD7E, 0LL, 0LL, 6u, &v12);
  }
}
