/*
 * XREFs of ?LogOnInputForwardTargetInputObjectChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoInputForwardTargetInputObjectProxy@@@Z @ 0x18008C0D4
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnInputForwardTargetInputObjectChanging(
