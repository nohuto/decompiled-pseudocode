/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UexTest7@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800C8CEC
 * Callers:
  ...
  if ( (v3 & 6) != 6 )
  {
    ...
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_UexTest7__descriptor, v9, i);
      if ( i == v11 )
        break;
    }
