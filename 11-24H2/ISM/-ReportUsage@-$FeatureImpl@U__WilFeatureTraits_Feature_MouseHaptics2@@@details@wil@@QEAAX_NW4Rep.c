/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_MouseHaptics2@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800C9F6C
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MouseHaptics2>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v10 = a4;
  v5 = a2;
  LODWORD(v6) = *(_DWORD *)Feature_MouseHaptics2__descriptor;
  if ( (*(_DWORD *)Feature_MouseHaptics2__descriptor & 4) == 0 )
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_MouseHaptics2>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v7);
    v10 = v6;
  }
