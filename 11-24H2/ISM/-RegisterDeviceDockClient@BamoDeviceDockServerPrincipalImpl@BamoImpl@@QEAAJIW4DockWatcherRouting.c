/*
 * XREFs of ?RegisterDeviceDockClient@BamoDeviceDockServerPrincipalImpl@BamoImpl@@QEAAJIW4DockWatcherRoutingPolicy@Input@Internal@UI@Windows@@@Z @ 0x180180FAC
 * Callers:
 *     ?Thunk_RegisterDeviceDockClient_68@?$IDeviceDockServerPrincipal_Receive@VBamoDeviceDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180181ED0 (-Thunk_RegisterDeviceDockClient_68@-$IDeviceDockServerPrincipal_Receive@VBamoDeviceDockServerPri.c)
 * Callees:
