/*
 * XREFs of ?LogSetTopLevelActivatedEntity@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800AF8D8
 * Callers:
...
void __fastcall BamoImpl::BamoActivationWatcherPrincipalImpl::LogSetTopLevelActivatedEntity(
