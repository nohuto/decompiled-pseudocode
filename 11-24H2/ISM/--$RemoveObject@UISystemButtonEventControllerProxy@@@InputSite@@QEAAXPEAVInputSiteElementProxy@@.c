/*
 * XREFs of ??$RemoveObject@UISystemButtonEventControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800372A8
 * Callers:
...
void __fastcall InputSite::RemoveObject<ISystemButtonEventControllerProxy>(__int64 a1, __int64 a2)
{
  __int64 v4; // r15
  __int64 *v5; // r14
  __int64 *v6; // r12
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_3abcaa47_97ef_219f_1cd4_34fcffef35a7, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
