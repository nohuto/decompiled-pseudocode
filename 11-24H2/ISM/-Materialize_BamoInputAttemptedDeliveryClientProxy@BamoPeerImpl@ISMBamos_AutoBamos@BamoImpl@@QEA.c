/*
 * XREFs of ?Materialize_BamoInputAttemptedDeliveryClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011D8B4
 * Callers:
 *     ?Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801261B0 (-Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoInputAttemptedDeliveryClientProxy *v15; // [rsp+60h] [rbp+8h] BYREF
  ...
  v6 = CreateInputAttemptedDeliveryClientProxy(v4, &v15);
  if ( v6 < 0 )
  ...
  if ( !v15 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v7);
  v8 = (*(__int64 (__fastcall **)(struct BamoInputAttemptedDeliveryClientProxy *))(*(_QWORD *)v15 + 56LL))(v15);
