/*
 * XREFs of ?AllocateStubUnderLock@BamoControllerNavigationManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoControllerNavigationManagerStub@@@Z @ 0x180075000
 * Callers:
 *     <none>
 * Callees:
