/*
 * XREFs of ?OnConstantChanged@BamoMPCConstantManagerClientCallbacksProxyImpl@BamoImpl@@QEAAJW4InputType@@PEBGAEBUtagPROPVARIANT@@2@Z @ 0x1801638B8
 * Callers:
        ...
        __int128 *a5)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      v21 = v15;
      v22 = v16;
      return CoreUICallSend(v11, v18, 2LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
