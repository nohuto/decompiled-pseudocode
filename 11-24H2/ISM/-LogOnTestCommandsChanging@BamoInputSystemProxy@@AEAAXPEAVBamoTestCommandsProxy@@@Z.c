/*
 * XREFs of ?LogOnTestCommandsChanging@BamoInputSystemProxy@@AEAAXPEAVBamoTestCommandsProxy@@@Z @ 0x18011A05C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnTestCommandsChanging(
        BamoInputSystemProxy *this,
        struct BamoTestCommandsProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
