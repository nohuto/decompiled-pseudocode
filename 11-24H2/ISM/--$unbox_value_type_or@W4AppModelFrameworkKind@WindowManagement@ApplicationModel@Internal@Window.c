        ...
        __int64 a3)
{
  ...
  if ( v6
    || ((winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindow::~IWindow((winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindow *)&v11),
         (v7 = *a2) != 0LL)
      ? (v10 = 0LL,
         (**v7)(v7, &winrt::impl::guid_v<winrt::Windows::Foundation::IReference<int>>, &v10),
         v8 = v10,
         v11 = v10)
      : (v11 = 0LL, v8 = 0LL),
        v8) )
  {
    *(_DWORD *)a1 = winrt::impl::consume_Windows_Foundation_IReference<winrt::Windows::Foundation::IReference<enum winrt::Windows::Internal::ApplicationModel::WindowManagement::AppModelFrameworkKind>,enum winrt::Windows::Internal::ApplicationModel::WindowManagement::AppModelFrameworkKind>::Value(&v11);
    *(_BYTE *)(a1 + 4) = 1;
    winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindow::~IWindow((winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindow *)&v11);
  }
  else
