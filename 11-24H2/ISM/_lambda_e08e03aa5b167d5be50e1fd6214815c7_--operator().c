/*
 * XREFs of _lambda_e08e03aa5b167d5be50e1fd6214815c7_::operator() @ 0x1800A8CC4
 * Callers:
 ...
 * Callees:
 *     ?AreWindowsInSameCompositeApp@CUIHierarchy@@AEAA_N_K0@Z @ 0x1800A8F8C (-AreWindowsInSameCompositeApp@CUIHierarchy@@AEAA_N_K0@Z.c)
 *     ?PropagateActivationState@CUIHierarchy@@AEAA_NPEAUCUIWindow@@0_N@Z @ 0x1800A9CC0 (-PropagateActivationState@CUIHierarchy@@AEAA_NPEAUCUIWindow@@0_N@Z.c)
 */
...
__int64 __fastcall lambda_e08e03aa5b167d5be50e1fd6214815c7_::operator()(__int64 a1, struct CUIWindow **a2)
{
  ...
  return Microsoft::WRL::ComPtr<Windows::Foundation::Collections::IVector<HSTRING__ *>>::InternalRelease((__int64 *)a2);
}
