/*
 * XREFs of ??0RotationWatcher@@AEAA@XZ @ 0x18010B394
 * Callers:
...
RotationWatcher *__fastcall RotationWatcher::RotationWatcher(RotationWatcher *this)
{
  ...
  return (RotationWatcher *)&qword_180251E88;
}
