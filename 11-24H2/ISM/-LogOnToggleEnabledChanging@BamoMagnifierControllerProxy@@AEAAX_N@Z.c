/*
 * XREFs of ?LogOnToggleEnabledChanging@BamoMagnifierControllerProxy@@AEAAX_N@Z @ 0x180157D64
 * Callers:
...
void __fastcall BamoMagnifierControllerProxy::LogOnToggleEnabledChanging(BamoMagnifierControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
