/*
 * XREFs of ?ProcessDeviceRemoval@Win32kInterop@@AEAAXPEBU_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@Z @ 0x18004CA4C
 * Callers:
...
LABEL_9:
    ...
    if ( v10 == *((__int64 **)this + 9) )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v26);
    v12 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 7) + 64LL))(*((_QWORD *)this + 7), v10[3]);
    if ( v12 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x262,
