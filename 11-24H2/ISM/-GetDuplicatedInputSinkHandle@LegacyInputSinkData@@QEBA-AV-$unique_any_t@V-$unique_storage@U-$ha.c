/*
 * XREFs of ?GetDuplicatedInputSinkHandle@LegacyInputSinkData@@QEBA?AV?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@XZ @ 0x18013036C
 * Callers:
 ...
 *     ExceptionSafeDuplicateHandle @ 0x1801302D4 (ExceptionSafeDuplicateHandle.c)
