/*
 * XREFs of ?AllocateStubUnderLock@BamoAsyncResult_PROPVARIANT_Principal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncResult_PROPVARIANT_Stub@@@Z @ 0x1801732F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoAsyncResult_PROPVARIANT_Principal::AllocateStubUnderLock(
