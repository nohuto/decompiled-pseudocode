/*
 * XREFs of ??1?$_List_node_insert_op2@V?$allocator@U?$_List_node@V?$shared_ptr@UHotKeyInfo@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1801CA104
 * Callers:
 ...
 *     _std::list_std::shared_ptr_HotKeyInfo__std::allocator_std::shared_ptr_HotKeyInfo_____::_Assign_unchecked_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo______std::_Iterator_base0__std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo______std::_Iterator_base0____::_1_::dtor$0 @ 0x1801D9B04 (_std--list_std--shared_ptr_HotKeyInfo__std--allocator_std--shared_ptr_HotKeyInfo_____--_Assign_u.c)
 *     _std::list_std::shared_ptr_HotKeyInfo__std::allocator_std::shared_ptr_HotKeyInfo_____::_Construct_range_unchecked_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo______std::_Iterator_base0__std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo______std::_Iterator_base0____::_1_::dtor$0 @ 0x1801D9B16 (_std--list_std--shared_ptr_HotKeyInfo__std--allocator_std--shared_ptr_HotKeyInfo_____--_Construc.c)
 * Callees:
