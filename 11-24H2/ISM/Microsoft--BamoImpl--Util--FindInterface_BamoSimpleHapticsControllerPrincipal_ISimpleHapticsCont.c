/*
 * XREFs of Microsoft::BamoImpl::Util::FindInterface_BamoSimpleHapticsControllerPrincipal_ISimpleHapticsControllerPrincipal_ @ 0x1801844FC
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186400 (-QueryInterface@BamoSimpleHapticsControllerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
