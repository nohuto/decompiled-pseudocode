/*
 * XREFs of ?OnMouseSnappedToGaze@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1801688C4
 * Callers:
 *     ?Thunk_OnMouseSnappedToGaze_41@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180168DF0 (-Thunk_OnMouseSnappedToGaze_41@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincip.c)
 * Callees:
