/*
 * XREFs of ?OnTargetAnimationDataChange@GestureServices@@QEAAXPEAVAnimationTargetClientProxy@@_K1@Z @ 0x180142E0C
 * Callers:
 *     ?OnDisconnected@AnimationTargetClientProxy@@MEAAJXZ @ 0x18007CA00 (-OnDisconnected@AnimationTargetClientProxy@@MEAAJXZ.c)
 *     ?OnConnected@AnimationTargetClientProxy@@MEAAJXZ @ 0x18007FC10 (-OnConnected@AnimationTargetClientProxy@@MEAAJXZ.c)
