/*
 * XREFs of ?GetTargetWithFocus@MPCInputRouter@@MEAAJPEAUDeviceInfo@@PEAVInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x180017710
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IInputTarget **a5)
{
  ...
  v9 = 0;
  if ( (unsigned __int8)std::_Atomic_storage<bool,1>::load((char *)this + 720) && v11 )
    return (***((__int64 (__fastcall ****)(_QWORD, GUID *, struct IInputTarget **))this + 81))(
             *((_QWORD *)this + 81),
