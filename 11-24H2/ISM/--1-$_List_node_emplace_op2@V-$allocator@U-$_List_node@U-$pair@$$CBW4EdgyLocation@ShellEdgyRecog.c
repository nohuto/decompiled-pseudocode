/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBW4EdgyLocation@ShellEdgyRecognizer@@V?$vector@UGestureRegistration@ShellGesturesProcessor@@V?$allocator@UGestureRegistration@ShellGesturesProcessor@@@std@@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18009BA20
 * Callers:
 *     _std::_Hash_std::_Umap_traits_enum_ShellEdgyRecognizer::EdgyLocation_std::vector_ShellGesturesProcessor::GestureRegistration_std::allocator_ShellGesturesProcessor::GestureRegistration____std::_Uhash_compare_enum_ShellEdgyRecognizer::EdgyLocation_std::hash_enum_ShellEdgyRecognizer::EdgyLocation__std::equal_to_enum_ShellEdgyRecognizer::EdgyLocation____std::allocator_std::pair_enum_ShellEdgyRecognizer::EdgyLocation_const__std::vector_ShellGesturesProcessor::GestureRegistration_std::allocator_ShellGesturesProcessor::GestureRegistration________0___::_Try_emplace_enum_ShellEdgyRecognizer::EdgyLocation_const_&__::_1_::dtor$0 @ 0x1801D0D64 (_std--_Hash_std--_Umap_traits_enum_ShellEdgyRecognizer--EdgyLocation_std--vector_ShellGesturesPr.c)
 * Callees:
