/*
 * XREFs of ?SetConstant@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEBGAEBUtagPROPVARIANT@@PEAVBamoAsyncHRESULTPrincipal@@@Z @ 0x1801664E8
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a5)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 31) )
      {
        v11 = (struct IMessageCallSendHost *)((char *)v15[0] - 16);
        if ( !v15[0] )
          v11 = 0LL;
        *((_BYTE *)v11 + 72) = 1;
