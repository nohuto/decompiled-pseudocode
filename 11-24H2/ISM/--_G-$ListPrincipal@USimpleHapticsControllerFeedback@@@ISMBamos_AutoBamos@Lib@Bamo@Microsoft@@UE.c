/*
 * XREFs of ??_G?$ListPrincipal@USimpleHapticsControllerFeedback@@@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAPEAXI@Z @ 0x180184B60
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009D758 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1?$ListPrincipalCommon@VBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@USimpleHapticsControllerFeedback@@@Bamo@Microsoft@@UEAA@XZ @ 0x18018490C (--1-$ListPrincipalCommon@VBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@.c)
 */
