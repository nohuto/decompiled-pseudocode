/*
 * XREFs of ?LogSendEdgyRecognized@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@AEAAXAEBUPoint@Foundation@Windows@@@Z @ 0x18011AEE0
 * Callers:
