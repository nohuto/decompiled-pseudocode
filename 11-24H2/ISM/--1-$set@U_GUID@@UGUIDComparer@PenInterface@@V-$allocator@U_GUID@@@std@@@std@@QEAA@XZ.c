/*
 * XREFs of ??1?$set@U_GUID@@UGUIDComparer@PenInterface@@V?$allocator@U_GUID@@@std@@@std@@QEAA@XZ @ 0x18018FE30
 * Callers:
 *     _PenInterface::PenInterface_::_1_::dtor$6 @ 0x1801D89F3 (_PenInterface--PenInterface_--_1_--dtor$6.c)
 * Callees:
 *     <none>
 */
