/*
 * XREFs of ?LogOnPrimaryClickZoneChanging@BamoVirtualTouchpadControllerProxy@@AEAAXAEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x1801356C8
 * Callers:
