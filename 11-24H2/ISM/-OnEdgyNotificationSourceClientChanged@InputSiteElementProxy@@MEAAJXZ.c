/*
 * XREFs of ?OnEdgyNotificationSourceClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005BE70
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  while ( v6 != v7 )
  {
    ...
    v11 = v10(v9, &GUID_2066a149_dd02_cdd2_a948_2c520fd9e943, &v17) >= 0;
    if ( v8 == this && v11 )
      break;
    v6 += 16LL;
  }
  ...
  v13 = *((_QWORD *)this + 42);
  v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 176LL))((char *)this + 8);
  InputSite::AttachObject<BamoEdgyNotificationSourceClientProxy>(v13, this, v14);
  return 0LL;
}
