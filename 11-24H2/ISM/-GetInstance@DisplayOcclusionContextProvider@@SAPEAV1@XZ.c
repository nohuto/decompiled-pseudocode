/*
 * XREFs of ?GetInstance@DisplayOcclusionContextProvider@@SAPEAV1@XZ @ 0x1801A1DC0
 * Callers:
...
struct DisplayOcclusionContextProvider *DisplayOcclusionContextProvider::GetInstance(void)
{
  ...
  v1 = 32LL;
  if ( dword_180251F18 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 32LL) )
  {
    Init_thread_header(&dword_180251F18);
    if ( dword_180251F18 == -1 )
    {
      atexit(DisplayOcclusionContextProvider::GetInstance_::_2_::_dynamic_atexit_destructor_for__s_instance__);
      Init_thread_footer(&dword_180251F18);
    }
  }
  v6 = 0;
