/*
 * XREFs of std::call_once__lambda_a860493e5708769190ef41fba30dc41a___ @ 0x18007333C
 * Callers:
 ...
 *     ??0MPCHeadUpdateListener@@QEAA@XZ @ 0x1800D16AC (--0MPCHeadUpdateListener@@QEAA@XZ.c)
