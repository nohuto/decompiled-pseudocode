/*
 * XREFs of ?GetNextSpectrumId@MPCInputInfoHelper@@SAIXZ @ 0x1800CEACC
 * Callers:
 ...
 *     ?GetNewInputSourceId@SpatialRimDeviceCollection@@UEAAKXZ @ 0x1800D6810 (-GetNewInputSourceId@SpatialRimDeviceCollection@@UEAAKXZ.c)
 * Callees:
