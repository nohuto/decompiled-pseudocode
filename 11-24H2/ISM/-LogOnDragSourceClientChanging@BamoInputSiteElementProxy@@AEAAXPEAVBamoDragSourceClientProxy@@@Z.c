/*
 * XREFs of ?LogOnDragSourceClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoDragSourceClientProxy@@@Z @ 0x18008BBF4
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnDragSourceClientChanging(
        BamoInputSiteElementProxy *this,
        struct BamoDragSourceClientProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
