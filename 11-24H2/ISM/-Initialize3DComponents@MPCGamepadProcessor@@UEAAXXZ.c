/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801BECE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(signed __int64 this)
{
  ...
  v3 = std::make_unique<MPCButtonHoldHelper,float,0>(&v18, flt_18020CC28);
  ...
  v4 = std::make_unique<MPCButtonHoldHelper,float,0>(&v18, flt_18020CC28);
