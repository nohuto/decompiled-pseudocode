/*
 * XREFs of ?LogOnIdChanged@BamoDropTargetClientProxy@@AEAAXXZ @ 0x180118A30
 * Callers:
...
void __fastcall BamoDropTargetClientProxy::LogOnIdChanged(BamoDropTargetClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
