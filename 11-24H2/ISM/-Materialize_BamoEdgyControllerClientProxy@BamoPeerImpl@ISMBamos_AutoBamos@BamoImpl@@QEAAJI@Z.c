/*
 * XREFs of ?Materialize_BamoEdgyControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011D358
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyControllerClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126100 (-Thunk_Materialize_BamoEdgyControllerClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoEdgyControllerClientProxy *v15; // [rsp+60h] [rbp+8h] BYREF
  ...
  v6 = CreateEdgyControllerClientProxy(v4, &v15);
  if ( v6 < 0 )
  ...
  if ( !v15 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v7);
  v8 = (*(__int64 (__fastcall **)(struct BamoEdgyControllerClientProxy *))(*(_QWORD *)v15 + 56LL))(v15);
