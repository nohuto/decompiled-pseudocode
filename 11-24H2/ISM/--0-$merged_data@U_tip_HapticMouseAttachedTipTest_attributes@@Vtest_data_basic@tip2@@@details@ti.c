/*
 * XREFs of ??0?$merged_data@U_tip_HapticMouseAttachedTipTest_attributes@@Vtest_data_basic@tip2@@@details@tip2@@QEAA@XZ @ 0x1801897BC
 * Callers:
...
__int64 __fastcall tip2::details::merged_data<_tip_HapticMouseAttachedTipTest_attributes,tip2::test_data_basic>::merged_data<_tip_HapticMouseAttachedTipTest_attributes,tip2::test_data_basic>(
        __int64 a1)
{
  __int64 result; // rax
