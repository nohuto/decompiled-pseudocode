/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoInputProcessPrincipal@@@Z @ 0x180123400
 * Callers:
...
__int64 __fastcall BamoImpl::BamoInputProcessManagerProxyImpl::RegisterInputProcess(
        BamoImpl::BamoInputProcessManagerProxyImpl *this,
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoInputProcessManagerProxyImpl::LogSendRegisterInputProcess(this);
      v12[0] = v14;
      v12[1] = v15;
