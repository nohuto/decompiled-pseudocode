/*
 * XREFs of ?CreateWatcher@?$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewStatics@UIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@QEBA@XZ @ 0x180093AE0
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_bde3f744bf3d16209662d38da0fd875b_@@CA@AEBUIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@Z @ 0x180093A40 (-_lambda_invoker_cdecl_@_lambda_bde3f744bf3d16209662d38da0fd875b_@@CA@AEBUIAppViewStatics@Window.c)
