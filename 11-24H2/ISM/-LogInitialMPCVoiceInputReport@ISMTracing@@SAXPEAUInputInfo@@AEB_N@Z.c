/*
 * XREFs of ?LogInitialMPCVoiceInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x1800C54A8
 * Callers:
...
void __fastcall ISMTracing::LogInitialMPCVoiceInputReport(struct InputInfo *a1, const bool *a2)
{
