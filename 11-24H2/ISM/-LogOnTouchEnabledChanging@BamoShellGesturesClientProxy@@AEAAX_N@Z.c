/*
 * XREFs of ?LogOnTouchEnabledChanging@BamoShellGesturesClientProxy@@AEAAX_N@Z @ 0x180090C44
 * Callers:
...
void __fastcall BamoShellGesturesClientProxy::LogOnTouchEnabledChanging(BamoShellGesturesClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
