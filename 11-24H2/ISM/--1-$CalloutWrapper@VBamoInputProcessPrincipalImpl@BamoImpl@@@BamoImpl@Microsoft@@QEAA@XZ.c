/*
 * XREFs of ??1?$CalloutWrapper@VBamoInputProcessPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x1800CC0AC
 * Callers:
 *     ?OnDisconnectedThunk@BamoInputProcessStubImpl@BamoImpl@@UEAAJXZ @ 0x1800CC660 (-OnDisconnectedThunk@BamoInputProcessStubImpl@BamoImpl@@UEAAJXZ.c)
 *     ?OnPropertiesRefreshedThunk@BamoInputProcessStubImpl@BamoImpl@@UEAAJXZ @ 0x1800CC770 (-OnPropertiesRefreshedThunk@BamoInputProcessStubImpl@BamoImpl@@UEAAJXZ.c)
 ...
 *     _BamoImpl::BamoInputProcessPrincipalImpl::StopProcess_::_1_::dtor$0 @ 0x1801D52EA (_BamoImpl--BamoInputProcessPrincipalImpl--StopProcess_--_1_--dtor$0.c)
 * Callees:
