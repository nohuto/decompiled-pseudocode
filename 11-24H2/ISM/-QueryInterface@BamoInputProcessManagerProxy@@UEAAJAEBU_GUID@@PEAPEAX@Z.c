/*
 * XREFs of ?QueryInterface@BamoInputProcessManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121FC0
 * Callers:
 *     ?QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180122050 (-QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
