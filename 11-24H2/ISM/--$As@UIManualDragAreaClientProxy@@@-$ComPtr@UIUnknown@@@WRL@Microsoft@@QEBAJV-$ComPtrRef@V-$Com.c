/*
 * XREFs of ??$As@UIManualDragAreaClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIManualDragAreaClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005DF88
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<IUnknown>::As<IManualDragAreaClientProxy>(
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_17ebe106_acd3_7a3b_0c10_a99cf7dc20b0, a2);
}
