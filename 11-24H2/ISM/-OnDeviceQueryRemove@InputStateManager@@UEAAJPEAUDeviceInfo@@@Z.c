/*
 * XREFs of ?OnDeviceQueryRemove@InputStateManager@@UEAAJPEAUDeviceInfo@@@Z @ 0x1800CD2F0
 * Callers:
 *     ?OnDeviceQueryRemove@InputStateManager@@W7EAAJPEAUDeviceInfo@@@Z @ 0x1800CD3F0 (-OnDeviceQueryRemove@InputStateManager@@W7EAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
 ...
 *     ??4?$ComPtr@UIInputProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIInputProcessor@@@Z @ 0x1800CD15C (--4-$ComPtr@UIInputProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIInputProcessor@@@Z.c)
