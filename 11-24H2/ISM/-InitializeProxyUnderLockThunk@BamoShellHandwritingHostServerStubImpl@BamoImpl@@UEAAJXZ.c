/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoShellHandwritingHostServerStubImpl@BamoImpl@@UEAAJXZ @ 0x18015B920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoShellHandwritingHostServerStubImpl::InitializeProxyUnderLockThunk(
