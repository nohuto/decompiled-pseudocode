/*
 * XREFs of ?OnAttachableInputObjectSampleChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180038F80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180038FF4 (--$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@.c)
