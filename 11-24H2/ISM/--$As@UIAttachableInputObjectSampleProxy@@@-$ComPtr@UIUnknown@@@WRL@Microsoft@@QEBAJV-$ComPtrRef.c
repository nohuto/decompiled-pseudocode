/*
 * XREFs of ??$As@UIAttachableInputObjectSampleProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIAttachableInputObjectSampleProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x180038F24
 * Callers:
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_0d0ff390_1722_d77a_3592_c63ca2dc2e3a, a2);
}
