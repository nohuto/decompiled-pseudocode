/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180176090
 * Callers:
 *     <none>
 * Callees:
