/*
 * XREFs of ?OnInputProviderChanged@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJPEBULegacyDeviceInfo@@W4MPCSourceKind@@@Z @ 0x180168590
 * Callers:
 *     ?Thunk_OnInputProviderChanged_47@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180168DB0 (-Thunk_OnInputProviderChanged_47@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrinc.c)
 * Callees:
