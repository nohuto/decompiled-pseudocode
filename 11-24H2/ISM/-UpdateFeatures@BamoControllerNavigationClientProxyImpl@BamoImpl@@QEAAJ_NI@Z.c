/*
 * XREFs of ?UpdateFeatures@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801780D4
 * Callers:
 *     ?Thunk_UpdateFeatures_8@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180177CB0 (-Thunk_UpdateFeatures_8@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
...
__int64 __fastcall BamoImpl::BamoControllerNavigationClientProxyImpl::UpdateFeatures(
        ...
        __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoControllerNavigationClientProxy::LogOnFeaturesChanging((BamoImpl::BamoControllerNavigationClientProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      1);
    v7 = (*(__int64 (__fastcall **)(BamoControllerNavigationClientProxy *, _QWORD))(*(_QWORD *)v6 + 120LL))(v6, v3);
    if ( v7 < 0 )
  ...
  *((_DWORD *)this + 9) = v3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoControllerNavigationClientProxy::LogOnFeaturesChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoControllerNavigationClientProxy *))(*(_QWORD *)v6 + 128LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x9930,
