/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_KM@Z @ 0x1800F7CC0
 * Callers:
 *     ?Thunk_SetCursorShellMagnification_390@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8170 (-Thunk_SetCursorShellMagnification_390@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
