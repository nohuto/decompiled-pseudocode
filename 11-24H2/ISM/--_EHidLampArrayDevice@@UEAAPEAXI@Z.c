/*
 * XREFs of ??_EHidLampArrayDevice@@UEAAPEAXI@Z @ 0x1800E9A10
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall HidLampArrayDevice::`vector deleting destructor'(
        void **this,
  ...
  if ( (v4 & 1) != 0 )
  {
    if ( (v4 & 4) != 0 )
      BamoImpl::BamoMPCConstantManagerClientProxyImpl::UpdateStateOfProxyOnPlaceholderProxyHookUp(
        ...
        (struct Microsoft::BamoImpl::BamoProxyImpl *)0x288);
    else
      free(this);
  }
  return this;
