/*
 * XREFs of ?_Alloc_sentinel_and_proxy@?$_Tree@V?$_Tmap_traits@GU_HIDP_VALUE_CAPS@@U?$less@G@std@@V?$allocator@U?$pair@$$CBGU_HIDP_VALUE_CAPS@@@std@@@3@$0A@@std@@@std@@IEAAXXZ @ 0x18019AEC8
 * Callers:
 ...
 *     ??0HapticsTrigger@@QEAA@XZ @ 0x180199B18 (--0HapticsTrigger@@QEAA@XZ.c)
 * Callees:
