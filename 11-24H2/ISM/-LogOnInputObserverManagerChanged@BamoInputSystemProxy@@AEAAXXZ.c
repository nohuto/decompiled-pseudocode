/*
 * XREFs of ?LogOnInputObserverManagerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180118CBC
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputObserverManagerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
