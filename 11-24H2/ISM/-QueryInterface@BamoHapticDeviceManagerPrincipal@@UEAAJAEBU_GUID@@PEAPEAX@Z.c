/*
 * XREFs of ?QueryInterface@BamoHapticDeviceManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018C2B0
 * Callers:
 *     ?QueryInterface@BamoHapticDeviceManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018C330 (-QueryInterface@BamoHapticDeviceManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
