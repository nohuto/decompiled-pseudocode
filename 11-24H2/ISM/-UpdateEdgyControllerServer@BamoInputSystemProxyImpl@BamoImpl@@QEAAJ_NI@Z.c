/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180128480
 * Callers:
 *     ?Thunk_UpdateEdgyControllerServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126700 (-Thunk_UpdateEdgyControllerServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
