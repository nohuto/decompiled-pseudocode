/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180138B90
 * Callers:
 *     ?Thunk_SuppressInputOfType_264@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180138D70 (-Thunk_SuppressInputOfType_264@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
