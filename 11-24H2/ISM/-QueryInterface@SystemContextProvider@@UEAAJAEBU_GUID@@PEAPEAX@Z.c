/*
 * XREFs of ?QueryInterface@SystemContextProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010AB10
 * Callers:
 *     ?QueryInterface@SystemContextProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010A5C0 (-QueryInterface@SystemContextProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
