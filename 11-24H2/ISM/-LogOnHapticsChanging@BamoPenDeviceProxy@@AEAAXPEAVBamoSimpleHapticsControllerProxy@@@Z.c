/*
 * XREFs of ?LogOnHapticsChanging@BamoPenDeviceProxy@@AEAAXPEAVBamoSimpleHapticsControllerProxy@@@Z @ 0x180118748
 * Callers:
...
void __fastcall BamoPenDeviceProxy::LogOnHapticsChanging(
        BamoPenDeviceProxy *this,
        struct BamoSimpleHapticsControllerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
