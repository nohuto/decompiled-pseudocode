/*
 * XREFs of ??0ShellGesturesClientProxy@@QEAA@XZ @ 0x180090D54
 * Callers:
 ...
 * Callees:
 *     ??0BamoShellGesturesClientProxyImpl@BamoImpl@@QEAA@XZ @ 0x180090DD4 (--0BamoShellGesturesClientProxyImpl@BamoImpl@@QEAA@XZ.c)
 */
