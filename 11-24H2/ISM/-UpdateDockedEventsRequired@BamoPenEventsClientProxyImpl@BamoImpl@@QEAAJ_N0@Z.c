/*
 * XREFs of ?UpdateDockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180098458
 * Callers:
 *     ?Thunk_UpdateDockedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180090880 (-Thunk_UpdateDockedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyIm.c)
