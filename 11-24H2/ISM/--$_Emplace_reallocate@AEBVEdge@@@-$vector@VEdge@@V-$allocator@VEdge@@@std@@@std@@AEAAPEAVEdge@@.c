/*
 * XREFs of ??$_Emplace_reallocate@AEBVEdge@@@?$vector@VEdge@@V?$allocator@VEdge@@@std@@@std@@AEAAPEAVEdge@@QEAV2@AEBV2@@Z @ 0x1801A90E8
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0IA@@std@@YA_K_K@Z @ 0x18009BC80 (--$_Get_size_of_n@$0IA@@std@@YA_K_K@Z.c)
