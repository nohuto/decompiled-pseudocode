/*
 * XREFs of ??$RemoveObject@UICUIComponentInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005EED4
 * Callers:
...
void __fastcall InputSite::RemoveObject<ICUIComponentInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_ef2daa6b_70a1_714f_af3c_a61437d80866, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
