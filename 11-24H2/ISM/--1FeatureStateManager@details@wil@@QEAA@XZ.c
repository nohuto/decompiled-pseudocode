/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x180082E54
 * Callers:
 ...
 *     ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x18008FAC4 (--1SubscriptionList@details_abi@wil@@QEAA@XZ.c)
