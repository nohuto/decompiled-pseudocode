/*
 * XREFs of ?GetConstantsForInputType@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEAVBamoAsyncResult_string_Proxy@@@Z @ 0x1800B40A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCConstantManager::GetConstantsForInputType(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( !MPCConstantManager::CheckTypeExistence(a1, a3) )
    return (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 32LL))(v5, 2147942487LL);
  MPCConstantManager::GetConstantNamesString(v6, (__int64)v10, a3);
  v8 = v10;
  if ( v10[3] > 7uLL )
    v8 = (_QWORD *)v10[0];
  v9 = (*(__int64 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v5 + 24LL))(v5, v8);
