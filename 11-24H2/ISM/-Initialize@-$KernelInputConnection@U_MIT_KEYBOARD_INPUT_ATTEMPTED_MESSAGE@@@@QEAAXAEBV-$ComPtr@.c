/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@Z@std@@@Z @ 0x18000FA10
 * Callers:
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v21 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v25);
    v22 = NtMITCoreMsgKOpenConnectionTo(3LL, a1 + 3);
    if ( v22 < 0 )
