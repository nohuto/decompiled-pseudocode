/*
 * XREFs of ?LogSendManualResizeEnded@BamoManualResizeAreaClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x18014E910
 * Callers:
...
void __fastcall BamoImpl::BamoManualResizeAreaClientProxyImpl::LogSendManualResizeEnded(
