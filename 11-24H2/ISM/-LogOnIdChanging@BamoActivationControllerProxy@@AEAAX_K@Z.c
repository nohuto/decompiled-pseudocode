/*
 * XREFs of ?LogOnIdChanging@BamoActivationControllerProxy@@AEAAX_K@Z @ 0x1800B0254
 * Callers:
...
void __fastcall BamoActivationControllerProxy::LogOnIdChanging(BamoActivationControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
