/*
 * XREFs of ?UpdateDeviceAmbientProcess@LampArrayRawInputProvider@@AEAAXXZ @ 0x1800E41A0
 * Callers:
 *     ?AmbientUpdateAPC@LampArrayRawInputProvider@@CAX_K@Z @ 0x1800E3470 (-AmbientUpdateAPC@LampArrayRawInputProvider@@CAX_K@Z.c)
 * Callees:
...
void __fastcall LampArrayRawInputProvider::UpdateDeviceAmbientProcess(LampArrayRawInputProvider *this)
{
  ...
  const char *v24; // [rsp+58h] [rbp-19h] BYREF
  RTL_SRWLOCK *v25[2]; // [rsp+60h] [rbp-11h] BYREF
  char v26[16]; // [rsp+70h] [rbp-1h] BYREF
  char v27[32]; // [rsp+80h] [rbp+Fh] BYREF
...
LABEL_25:
  ...
  while ( 1 )
  {
    ...
    *v3 = v5;
    ...
    v16 = (WCHAR *)StringRawBuffer;
    if ( (unsigned int)dword_18024E248 > 5 )
    {
      v23 = StringRawBuffer;
      v24 = "Adding ambient PIDs to pending list";
    ...
    std::wstring::wstring((__int64)v27, v16);
