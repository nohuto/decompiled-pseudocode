/*
 * XREFs of ?LogOnIdChanging@BamoDragSourceClientProxy@@AEAAX_K@Z @ 0x180118AD0
 * Callers:
...
void __fastcall BamoDragSourceClientProxy::LogOnIdChanging(BamoDragSourceClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
