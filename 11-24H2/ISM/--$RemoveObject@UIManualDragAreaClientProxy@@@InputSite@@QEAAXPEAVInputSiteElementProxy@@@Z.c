/*
 * XREFs of ??$RemoveObject@UIManualDragAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E058
 * Callers:
...
void __fastcall InputSite::RemoveObject<IManualDragAreaClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_17ebe106_acd3_7a3b_0c10_a99cf7dc20b0, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
