/*
 * XREFs of ?OnInputReport@MouseProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801980B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x18008F754 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _lambda_cc14c4b3090cc7c63243ed8c77095553_::operator() @ 0x1801978F0 (_lambda_cc14c4b3090cc7c63243ed8c77095553_--operator().c)
...
LABEL_3:
  ...
  *((_BYTE *)this + 92) = v7;
  ...
  {
    v2 = (*(__int64 (__fastcall **)(__int64, _DWORD *, struct InputInfo *))(*(_QWORD *)(v12 - 16) + 24LL))(
           v12 - 16,
           v5,
           v16);
    if ( v2 < 0 )
