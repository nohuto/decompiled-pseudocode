/*
 * XREFs of ??_GContextualProcessorBuffer@@MEAAPEAXI@Z @ 0x18002C0EC
 * Callers:
 *     ??_EContextualProcessorBuffer@@OBI@EAAPEAXI@Z @ 0x1801A2DE0 (--_EContextualProcessorBuffer@@OBI@EAAPEAXI@Z.c)
 * Callees:
