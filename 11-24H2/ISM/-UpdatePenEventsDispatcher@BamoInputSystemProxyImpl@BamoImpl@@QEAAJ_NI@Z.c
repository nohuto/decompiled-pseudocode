/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012B220
 * Callers:
 *     ?Thunk_UpdatePenEventsDispatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126AC0 (-Thunk_UpdatePenEventsDispatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
