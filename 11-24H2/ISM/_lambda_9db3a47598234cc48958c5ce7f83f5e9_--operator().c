/*
 * XREFs of _lambda_9db3a47598234cc48958c5ce7f83f5e9_::operator() @ 0x1801B96E0
 * Callers:
        ...
        const char *a4)
{
  ...
  MPCConstantManager::AddAndPopulateInputType(
    ...
    (__int64)v7);
  std::_Tree<std::_Tmap_traits<std::wstring,unsigned long,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,unsigned long>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,unsigned long,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,unsigned long>>,0>>(v7);
