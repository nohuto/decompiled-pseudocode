/*
 * XREFs of ?LogOnInputSiteManagerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180118E3C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputSiteManagerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
