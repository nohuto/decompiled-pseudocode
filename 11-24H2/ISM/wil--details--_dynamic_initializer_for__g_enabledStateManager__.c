/*
 * XREFs of wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x18000A3F0
 * Callers:
 *     <none>
 * Callees:
 *     ??0EnabledStateManager@details@wil@@QEAA@XZ @ 0x180085FF8 (--0EnabledStateManager@details@wil@@QEAA@XZ.c)
 */
