/*
 * XREFs of ?LogOnSystemCursorControllerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoSystemCursorControllerProxy@@@Z @ 0x180119F9C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnSystemCursorControllerChanging(
        BamoInputSystemProxy *this,
        struct BamoSystemCursorControllerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
