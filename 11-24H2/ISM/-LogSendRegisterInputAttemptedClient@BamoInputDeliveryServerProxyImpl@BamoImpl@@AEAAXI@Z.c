/*
 * XREFs of ?LogSendRegisterInputAttemptedClient@BamoInputDeliveryServerProxyImpl@BamoImpl@@AEAAXI@Z @ 0x18011B544
 * Callers:
...
void __fastcall BamoImpl::BamoInputDeliveryServerProxyImpl::LogSendRegisterInputAttemptedClient(
