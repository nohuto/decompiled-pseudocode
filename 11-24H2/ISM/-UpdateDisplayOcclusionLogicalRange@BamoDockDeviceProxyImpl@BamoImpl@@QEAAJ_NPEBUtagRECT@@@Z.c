/*
 * XREFs of ?UpdateDisplayOcclusionLogicalRange@BamoDockDeviceProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x180128234
 * Callers:
 *     ?Thunk_UpdateDisplayOcclusionLogicalRange_57@?$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801266D0 (-Thunk_UpdateDisplayOcclusionLogicalRange_57@-$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl.c)
