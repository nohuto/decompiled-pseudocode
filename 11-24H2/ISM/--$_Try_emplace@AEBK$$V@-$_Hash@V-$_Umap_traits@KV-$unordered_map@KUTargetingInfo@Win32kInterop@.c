...
LABEL_12:
    ...
    v20 = v12;
    v12[4] = *a3;
    std::unordered_map<unsigned long,Win32kInterop::TargetingInfo>::unordered_map<unsigned long,Win32kInterop::TargetingInfo>(v12 + 6);
    v13 = *((_QWORD *)a1 + 2) + 1LL;
    if ( v13 < 0 )
