/*
 * XREFs of ?LogSendOnDockDeviceRemoved@BamoDeviceDockClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180182A0C
 * Callers:
...
void __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockDeviceRemoved(
