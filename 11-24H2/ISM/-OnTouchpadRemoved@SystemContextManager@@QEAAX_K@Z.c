/*
 * XREFs of ?OnTouchpadRemoved@SystemContextManager@@QEAAX_K@Z @ 0x18013E400
 * Callers:
 ...
 *     ?GetItemAt@?$ListPrincipalDetails@UVirtualTouchpadRect@@VBamoList_VirtualTouchpadRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@3@VBamoList_VirtualTouchpadRect_Stub@3456@$0A@$00$0A@@Bamo@Microsoft@@QEAAAEBUVirtualTouchpadRect@@I@Z @ 0x18013D104 (-GetItemAt@-$ListPrincipalDetails@UVirtualTouchpadRect@@VBamoList_VirtualTouchpadRect_Principal@.c)
  ...
  while ( v3 != v4 )
  {
    ...
    while ( v6 < -1431655765 * (unsigned int)((__int64)(*(_QWORD *)(v7 + 64) - *(_QWORD *)(v7 + 56)) >> 3) )
    {
      if ( *(_QWORD *)Microsoft::Bamo::ListPrincipalDetails<VirtualTouchpadRect,Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Principal,ISMBamos_AutoBamos::BamoConnection,Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Stub,0,1,0>::GetItemAt(
                        ...
                        v6) == a2 )
      {
        v8 = Microsoft::Bamo::ListPrincipalCommon<Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Principal,ISMBamos_AutoBamos::BamoConnection,VirtualTouchpadRect>::RemoveAt(
               v7,
               v6);
        if ( v8 < 0 )
