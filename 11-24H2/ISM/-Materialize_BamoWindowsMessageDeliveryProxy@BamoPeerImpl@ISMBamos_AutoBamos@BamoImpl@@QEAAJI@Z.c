/*
 * XREFs of ?Materialize_BamoWindowsMessageDeliveryProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002F0C0
 * Callers:
 *     ?Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007BF20 (-Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
