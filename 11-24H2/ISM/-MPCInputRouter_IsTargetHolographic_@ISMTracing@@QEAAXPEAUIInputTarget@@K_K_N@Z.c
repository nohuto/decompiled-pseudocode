/*
 * XREFs of ?MPCInputRouter_IsTargetHolographic_@ISMTracing@@QEAAXPEAUIInputTarget@@K_K_N@Z @ 0x1800FDDAC
 * Callers:
        ...
        bool a5)
{
  ...
  if ( ISMTracing::IsEnabled() )
  {
    ...
    if ( *(_DWORD *)v8 > 5u && tlgKeywordOn((__int64)v8, 1LL) )
    {
      ...
      v22 = 8;
      v16 = 1;
      tlgWriteTransfer_EventWriteTransfer(v9, byte_180214D2D, 0LL, 0LL, 6u, &v14);
    }
  }
}
