/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoPenEventsDispatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x180074720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherStubImpl::OnConnectedUnderLockThunk(
