        ...
        __int64 a1)
{
  ...
  do
    v1 = *(_DWORD *)(a1 + 160);
  while ( v1 > 0 && v1 != _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 160), v1 + 1, v1) );
  return v1 > 0;
}
