/*
 * XREFs of ?LogSendTailButtonClicked@BamoPenEventsClientProxyImpl@BamoImpl@@AEAAX_N@Z @ 0x18019566C
 * Callers:
...
void __fastcall BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonClicked(
