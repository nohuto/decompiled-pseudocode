/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x1800A0EFC
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$5 @ 0x1801D5D3D (_wil--details--ResultFromCaughtException_CppWinRt_--_1_--catch$5.c)
 * Callees:
