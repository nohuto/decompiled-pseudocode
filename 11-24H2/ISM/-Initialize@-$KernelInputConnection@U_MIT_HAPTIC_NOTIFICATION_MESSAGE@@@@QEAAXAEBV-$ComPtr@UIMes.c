/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_HAPTIC_NOTIFICATION_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_HAPTIC_NOTIFICATION_MESSAGE@@@Z@std@@@Z @ 0x1800F05BC
 * Callers:
