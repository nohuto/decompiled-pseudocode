/*
 * XREFs of ??_GHidLampMultiUpdateReportParser@@UEAAPEAXI@Z @ 0x1800EDB90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1HidLampMultiUpdateReportParser@@UEAA@XZ @ 0x1800EDA04 (--1HidLampMultiUpdateReportParser@@UEAA@XZ.c)
 */
