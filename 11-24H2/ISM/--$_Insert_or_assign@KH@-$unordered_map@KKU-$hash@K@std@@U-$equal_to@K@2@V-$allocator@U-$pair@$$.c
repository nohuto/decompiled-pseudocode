/*
 * XREFs of ??$_Insert_or_assign@KH@?$unordered_map@KKU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKK@std@@@2@@std@@AEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKK@std@@@std@@@std@@@std@@_N@1@$$QEAK$$QEAH@Z @ 0x18005A370
 * Callers:
 *     ?Initialize@KeyboardModifierState@@AEAAJXZ @ 0x1800966A8 (-Initialize@KeyboardModifierState@@AEAAJXZ.c)
 * Callees:
        ...
        _DWORD *a4)
{
  ...
  else
  {
    ...
    v20 = a1 + 2;
    v21 = 0LL;
    v11 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x18uLL);
    v21 = v11;
    v11[4] = *a3;
    v11[5] = *a4;
    v12 = *((_QWORD *)a1 + 2) + 1LL;
