/*
 * XREFs of ?OnInputDisabledStateChanged@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1801329F0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCUIComponentInputObjectProxyImpl::OnInputDisabledStateChanged(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogSendOnInputDisabledStateChanged(this);
      v11[0] = v13;
      v11[1] = v14;
