/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMII@Z @ 0x180186AF8
 * Callers:
 *     ?Thunk_SendHapticFeedbackForPlayCount_371@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801875C0 (-Thunk_SendHapticFeedbackForPlayCount_371@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpl.c)
 * Callees:
