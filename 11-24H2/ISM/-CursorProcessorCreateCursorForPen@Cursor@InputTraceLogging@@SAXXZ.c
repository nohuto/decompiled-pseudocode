/*
 * XREFs of ?CursorProcessorCreateCursorForPen@Cursor@InputTraceLogging@@SAXXZ @ 0x180147A30
 * Callers:
 *     ?EnsureCursorForPen@CursorProcessor@@AEAAXXZ @ 0x180147C9C (-EnsureCursorForPen@CursorProcessor@@AEAAXXZ.c)
 * Callees:
...
void InputTraceLogging::Cursor::CursorProcessorCreateCursorForPen(void)
{
  const struct _tlgProvider_t *v0; // rcx
  __int64 v1; // rcx

  v0 = InputTraceLogging::Provider();
  if ( *(_DWORD *)v0 > 4u && tlgKeywordOn((__int64)v0, 8LL) )
