/*
 * XREFs of ?UpdateWinKeyScenarioStatusAndLogLatency@WinKeyScenarioTelemetry@@CA_NXZ @ 0x180024E10
 * Callers:
 ...
 *     ?GetTimeElapsedSec@WinKeyScenarioTelemetry@@CA_KXZ @ 0x18010BA58 (-GetTimeElapsedSec@WinKeyScenarioTelemetry@@CA_KXZ.c)
  ...
  if ( WinKeyScenarioTelemetry::s_winKeyScenarioStarted )
  {
    ...
    if ( TimeElapsedSec >= 5 )
    {
      if ( (unsigned int)dword_18024E2B8 > 5
        && (unsigned __int8)tlgKeywordOn(&dword_18024E2B8, 0x400000000000LL, TimeElapsedSec) )
      {
