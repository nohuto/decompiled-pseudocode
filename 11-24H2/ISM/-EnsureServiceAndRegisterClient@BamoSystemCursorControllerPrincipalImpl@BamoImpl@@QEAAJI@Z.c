/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800F7140
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_8@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8160 (-Thunk_EnsureServiceAndRegisterClient_8@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCu.c)
 * Callees:
