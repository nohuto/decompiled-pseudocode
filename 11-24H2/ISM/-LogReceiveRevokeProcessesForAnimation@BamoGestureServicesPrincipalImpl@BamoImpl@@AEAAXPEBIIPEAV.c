/*
 * XREFs of ?LogReceiveRevokeProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAXPEBIIPEAVBamoDragManagerClientProxy@@@Z @ 0x180142B7C
 * Callers:
...
void __fastcall BamoImpl::BamoGestureServicesPrincipalImpl::LogReceiveRevokeProcessesForAnimation(
