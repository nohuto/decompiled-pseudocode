/*
 * XREFs of ??1?$list@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@V?$allocator@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18002F8FC
 * Callers:
 *     _Win32kInterop::DeliverInputToAllTargets_::_1_::dtor$4 @ 0x1801D1432 (_Win32kInterop--DeliverInputToAllTargets_--_1_--dtor$4.c)
 * Callees:
