/*
 * XREFs of ?Materialize_BamoUIAHitTestInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011EFD4
 * Callers:
 *     ?Thunk_Materialize_BamoUIAHitTestInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801263C0 (-Thunk_Materialize_BamoUIAHitTestInputObjectProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
