/*
 * XREFs of ?OnLightDismissClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005D000
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UILightDismissClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D078 (--$RemoveObject@UILightDismissClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<ILightDismissClientProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 216LL))((char *)this + 8);
