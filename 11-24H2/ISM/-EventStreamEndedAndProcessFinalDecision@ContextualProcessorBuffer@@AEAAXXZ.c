/*
 * XREFs of ?EventStreamEndedAndProcessFinalDecision@ContextualProcessorBuffer@@AEAAXXZ @ 0x1800224D0
 * Callers:
 ...
 *     ??4?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@QEAAAEAV01@AEBV01@@Z @ 0x18002143C (--4-$_Hash@V-$_Umap_traits@KW4ContextualProcessorDecision@@V-$_Uhash_compare@KU-$hash@K@std@@U-$.c)
  ...
  for ( i = *((_QWORD *)this + 6); v2 != i; v2 += 224LL )
  {
    if ( *(_BYTE *)(v2 + 216) )
    {
      ...
      if ( v6(v5, &GUID_7fa430a3_9305_4154_a5ee_11987d0ffb6f, &v18) >= 0 )
      {
        *(_QWORD *)v11 = 0LL;
        v12 = 0LL;
        std::unordered_map<unsigned long,enum ContextualProcessorDecision>::unordered_map<unsigned long,enum ContextualProcessorDecision>(v13);
        v14 = 0LL;
        ...
        std::unordered_set<unsigned long>::unordered_set<unsigned long>(v16);
        v8 = *(_QWORD *)(v2 + 208);
        v9 = *(_QWORD *)v11;
        if ( *(_QWORD *)v11 != v8 )
        {
