/*
 * XREFs of ?CreateChildInputProcessor@@YAJW4InputType@@PEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180033E8C
 * Callers:
 ...
 * Callees:
 *     ?IsSingleBit@@YAHJ@Z @ 0x180034050 (-IsSingleBit@@YAHJ@Z.c)
...
LABEL_22:
  ...
  for ( i = 0; ; ++i )
  {
    if ( (unsigned __int64)i >= 0x13 )
      goto LABEL_23;
    v9 = 48LL * i;
    v10 = *(_QWORD *)v15 - *(_QWORD *)((char *)&unk_18024E360 + v9);
    if ( *(_QWORD *)v15 == *(_QWORD *)((char *)&unk_18024E360 + v9) )
      v10 = *(_QWORD *)&v15[2] - *(_QWORD *)((char *)&unk_18024E360 + v9 + 8);
    if ( !v10 )
      break;
  }
  if ( i < 0 )
LABEL_23:
  ...
  if ( *(_DWORD *)((char *)&unk_18024E360 + v9 + 16) != a1 )
    v11 = 0LL;
