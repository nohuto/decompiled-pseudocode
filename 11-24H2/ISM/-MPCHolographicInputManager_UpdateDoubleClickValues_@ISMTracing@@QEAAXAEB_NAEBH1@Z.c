/*
 * XREFs of ?MPCHolographicInputManager_UpdateDoubleClickValues_@ISMTracing@@QEAAXAEB_NAEBH1@Z @ 0x1800BAF00
 * Callers:
        ...
        int *a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u && tlgKeywordOn((__int64)v7, 1LL) )
  {
    ...
    v18 = v10;
    v16 = v8;
    tlgWriteTransfer_EventWriteTransfer(v9, byte_1802103F4, 0LL, 0LL, 5u, &v14);
  }
}
