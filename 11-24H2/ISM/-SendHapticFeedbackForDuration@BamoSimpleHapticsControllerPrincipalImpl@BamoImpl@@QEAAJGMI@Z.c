/*
 * XREFs of ?SendHapticFeedbackForDuration@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMI@Z @ 0x180186900
 * Callers:
 *     ?Thunk_SendHapticFeedbackForDuration_366@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801875A0 (-Thunk_SendHapticFeedbackForDuration_366@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimple.c)
 * Callees:
