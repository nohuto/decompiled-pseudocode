/*
 * XREFs of ?LogSetEdgyControllerServer@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoEdgyControllerServerPrincipal@@@Z @ 0x1800918E8
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetEdgyControllerServer(
