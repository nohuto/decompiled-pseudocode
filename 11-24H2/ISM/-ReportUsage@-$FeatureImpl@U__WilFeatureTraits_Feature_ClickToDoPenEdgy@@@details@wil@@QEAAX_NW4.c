/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180159E80
 * Callers:
        ...
        __int64 a4)
{
  ...
  v10 = a4;
  v5 = a2;
  LODWORD(v6) = *(_DWORD *)Feature_ClickToDoPenEdgy__descriptor;
  if ( (*(_DWORD *)Feature_ClickToDoPenEdgy__descriptor & 4) == 0 )
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoPenEdgy>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v7);
    v10 = v6;
  }
