/*
 * XREFs of ?LogReceiveStartManualDrag@BamoManualDragAreaClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x1801484D0
 * Callers:
...
void __fastcall BamoImpl::BamoManualDragAreaClientProxyImpl::LogReceiveStartManualDrag(
