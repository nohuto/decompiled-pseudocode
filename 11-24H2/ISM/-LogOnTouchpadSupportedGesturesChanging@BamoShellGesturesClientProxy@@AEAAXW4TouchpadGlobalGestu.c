/*
 * XREFs of ?LogOnTouchpadSupportedGesturesChanging@BamoShellGesturesClientProxy@@AEAAXW4TouchpadGlobalGestureKinds@Input@Internal@UI@Windows@@@Z @ 0x18015AFD4
 * Callers:
