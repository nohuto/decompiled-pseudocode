/*
 * XREFs of ?LogOnActivationWatcherChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x18011737C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnActivationWatcherChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
