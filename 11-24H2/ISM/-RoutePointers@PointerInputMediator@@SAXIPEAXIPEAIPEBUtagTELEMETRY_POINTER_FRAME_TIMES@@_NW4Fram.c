/*
 * XREFs of ?RoutePointers@PointerInputMediator@@SAXIPEAXIPEAIPEBUtagTELEMETRY_POINTER_FRAME_TIMES@@_NW4FrameRoutingSource@@@Z @ 0x18008A7BC
 * Callers:
 ...
 *     ?SetManipulationInputTarget@@YAHIPEAXIPEAIPEAUtagTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x18006CEC0 (-SetManipulationInputTarget@@YAHIPEAXIPEAIPEAUtagTELEMETRY_POINTER_FRAME_TIMES@@@Z.c)
 * Callees:
 ...
 *     ??1?$unique_lock@Vmutex@std@@@std@@QEAA@XZ @ 0x1800707AC (--1-$unique_lock@Vmutex@std@@@std@@QEAA@XZ.c)
 *     MicrosoftTelemetryAssertTriggeredArgs @ 0x18008B160 (MicrosoftTelemetryAssertTriggeredArgs.c)
 *     std::find_if_std::_Deque_iterator_std::_Deque_val_std::_Deque_simple_types_PointerInputMediator::PointerFrame_______lambda_b7bb5d1243db4af2adae27fbd398c724___ @ 0x18008B234 (std--find_if_std--_Deque_iterator_std--_Deque_val_std--_Deque_simple_types_PointerInputMediator-.c)
        ...
        int a7)
{
  ...
  if ( PointerInputMediator::s_frameQueue )
    ...
    v12 = 0LL;
  for ( i = qword_180250E40; i != qword_180250E40 + qword_180250E48; ++i )
  {
...
LABEL_9:
  ...
  {
    v17 = v9 & (qword_180250E38 - 1);
    v18 = *(_QWORD *)(qword_180250E30 + 8 * v17);
    if ( *(_DWORD *)v18 == v102 )
      break;
...
LABEL_67:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      for ( ii = qword_180250E40;
            ii != qword_180250E40 + qword_180250E48
         && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v49 + 8) + 8 * (ii & (*(_QWORD *)(v49 + 16) - 1LL))) + 152LL) != v92;
            ++ii )
      {
        ;
      }
      if ( ii == qword_180250E40 + qword_180250E48 )
        break;
      ...
      v89 = 1;
      v62 = qword_180250E00;
      if ( (unsigned __int64)qword_180250E00 >= 0x40 )
      {
        v28 = 0;
      }
      else
      {
        v63 = qword_180250DF0;
        if ( qword_180250DF0 <= (unsigned __int64)(qword_180250E00 + 1) )
        {
        ...
        v64 = v63 - 1;
        qword_180250DF8 &= v64;
        v65 = (v62 + qword_180250DF8) & v64;
        v66 = qword_180250DE8;
        v28 = 0;
        if ( !*(_QWORD *)(qword_180250DE8 + 8 * v65) )
        {
          *(_QWORD *)(qword_180250DE8 + 8 * v65) = operator new(0x110uLL);
          v66 = qword_180250DE8;
        }
