/*
 * XREFs of ?Materialize_BamoAsyncHRESULTProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B71A4
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncHRESULTProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B8E90 (-Thunk_Materialize_BamoAsyncHRESULTProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPe.c)
 * Callees:
