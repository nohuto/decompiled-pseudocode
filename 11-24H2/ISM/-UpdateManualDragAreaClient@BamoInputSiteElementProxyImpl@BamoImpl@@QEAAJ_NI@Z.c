/*
 * XREFs of ?UpdateManualDragAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003F2B0
 * Callers:
 *     ?Thunk_UpdateManualDragAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071EB0 (-Thunk_UpdateManualDragAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
