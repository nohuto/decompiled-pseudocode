/*
 * XREFs of ?UpdateId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18007B664
 * Callers:
 *     ?Thunk_UpdateId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007DAF0 (-Thunk_UpdateId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoIm.c)
