/*
 * XREFs of ?Thunk_Materialize_BamoHeatGripServiceProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126170
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn IBamoPeer_ISMBamos_AutoBamos_Receive<BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl>::Thunk_Materialize_BamoHeatGripServiceProxy_5(
        __int64 a1)
{
