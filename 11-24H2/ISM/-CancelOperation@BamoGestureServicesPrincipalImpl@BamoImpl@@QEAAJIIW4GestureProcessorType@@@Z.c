/*
 * XREFs of ?CancelOperation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJIIW4GestureProcessorType@@@Z @ 0x180141F98
 * Callers:
 *     ?Thunk_CancelOperation_206@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143C00 (-Thunk_CancelOperation_206@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl.c)
 * Callees:
