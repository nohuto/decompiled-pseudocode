/*
 * XREFs of ?UpdateEdgyDragSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180040CDC
 * Callers:
 *     ?Thunk_UpdateEdgyDragSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071C50 (-Thunk_UpdateEdgyDragSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
        ...
        __int64 a3)
{
  ...
  struct BamoEdgyDragSourceClientProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
  int v11; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnEdgyDragSourceClientChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        1LL);
      v11 = (*(__int64 (__fastcall **)(char *, struct BamoEdgyDragSourceClientProxy *))(*((_QWORD *)this - 2) + 392LL))(
              (char *)this - 16,
              v7);
      if ( v11 < 0 )
    ...
    *((_QWORD *)this + 22) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoEdgyDragSourceClientProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnEdgyDragSourceClientChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 400LL))((char *)this - 16);
      if ( v10 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2BA0,
