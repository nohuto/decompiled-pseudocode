/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x180177D64
 * Callers:
 *     ?Thunk_UpdateBounds_57@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180177C70 (-Thunk_UpdateBounds_57@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClien.c)
        ...
        const struct tagRECT *a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoControllerNavigationClientProxy::LogOnBoundsChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v7 = (*(__int64 (__fastcall **)(BamoControllerNavigationClientProxy *, const struct tagRECT *))(*(_QWORD *)v6 + 136LL))(
           v6,
           a3);
    if ( v7 < 0 )
  ...
  *(struct tagRECT *)((char *)this + 40) = *a3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoControllerNavigationClientProxy::LogOnBoundsChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoControllerNavigationClientProxy *))(*(_QWORD *)v6 + 144LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x995D,
