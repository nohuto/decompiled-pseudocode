/*
 * XREFs of ?UpdateAutoForwardId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x180098824
 * Callers:
 *     ?Thunk_UpdateAutoForwardId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007FEC0 (-Thunk_UpdateAutoForwardId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxy.c)
...
__int64 __fastcall BamoImpl::BamoActivationControllerProxyImpl::UpdateAutoForwardId(
        ...
        unsigned __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoActivationControllerProxy::LogOnAutoForwardIdChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v7 = (*(__int64 (__fastcall **)(BamoActivationControllerProxy *, unsigned __int64))(*(_QWORD *)v6 + 136LL))(v6, a3);
    if ( v7 < 0 )
  ...
  *((_QWORD *)this + 7) = a3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoActivationControllerProxy::LogOnAutoForwardIdChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoActivationControllerProxy *))(*(_QWORD *)v6 + 144LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x726B,
