/*
 * XREFs of ?QueryInterface@BamoInputObserverManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180138940
 * Callers:
 *     ?QueryInterface@BamoInputObserverManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801389D0 (-QueryInterface@BamoInputObserverManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
