/*
 * XREFs of ?Thunk_UpdateTouchpadSupportedGestures_16@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015B190
 * Callers:
 *     <none>
 * Callees:
 *     <none>
