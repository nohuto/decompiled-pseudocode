/*
 * XREFs of ??$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180038FF4
 * Callers:
...
void __fastcall InputSite::RemoveObject<IAttachableInputObjectSampleProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_0d0ff390_1722_d77a_3592_c63ca2dc2e3a, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
