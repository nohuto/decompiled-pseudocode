/*
 * XREFs of ?SetHeatGripService@BamoInputSystemPrincipal@@UEAAXPEAVBamoHeatGripServicePrincipal@@@Z @ 0x180091640
 * Callers:
        ...
        struct BamoHeatGripServicePrincipal *a2)
{
  ...
  BamoImpl::BamoInputSystemPrincipalImpl::SetHeatGripService((BamoImpl::BamoInputSystemPrincipalImpl *)(this + 1), a2);
