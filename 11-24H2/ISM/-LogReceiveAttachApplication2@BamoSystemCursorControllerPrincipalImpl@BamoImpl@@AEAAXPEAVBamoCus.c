/*
 * XREFs of ?LogReceiveAttachApplication2@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x1800F7550
 * Callers:
...
void __fastcall BamoImpl::BamoSystemCursorControllerPrincipalImpl::LogReceiveAttachApplication2(
        BamoImpl::BamoSystemCursorControllerPrincipalImpl *this,
        struct BamoCustomCursorControllerClient2Proxy *a2)
{
  __int64 v2; // rbx
  int v3; // r8d
  __int64 v4; // r9
