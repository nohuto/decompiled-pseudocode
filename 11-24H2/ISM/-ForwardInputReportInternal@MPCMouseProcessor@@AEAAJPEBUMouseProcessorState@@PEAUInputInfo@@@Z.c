/*
 * XREFs of ?ForwardInputReportInternal@MPCMouseProcessor@@AEAAJPEBUMouseProcessorState@@PEAUInputInfo@@@Z @ 0x1801C19E8
 * Callers:
        ...
        struct InputInfo *a3)
{
  ...
  struct IMPCTarget *v38[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  *((_DWORD *)this + 1323) = v6;
  ...
  if ( MPCInputProviderBase::IsPrimary((unsigned __int64)this + 40) )
  {
    ...
    v15 = MPCHolographicInputManager::Process3DInput(Instance, (struct LegacyInputInfo *)v39, v7, v38);
    v17 = v15;
    v18 = retaddr;
    if ( v15 >= 0 )
    {
...
LABEL_31:
  ...
  if ( (*((_BYTE *)this + 5300) & 0x70) != 0
    || (v12 = *((_DWORD *)this + 1322),
        ...
        v38[0] = (struct IMPCTarget *)L"ActivationDelta",
        v38[1] = (struct IMPCTarget *)15,
        v12 > (unsigned int)MPCConstantManager::GetConstant<unsigned long>((__int64)v13, (__int64)v7, (__int128 *)v38)) )
  {
