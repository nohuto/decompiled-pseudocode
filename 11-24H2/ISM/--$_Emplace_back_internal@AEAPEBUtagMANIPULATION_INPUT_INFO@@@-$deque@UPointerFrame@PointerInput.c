/*
 * XREFs of ??$_Emplace_back_internal@AEAPEBUtagMANIPULATION_INPUT_INFO@@@?$deque@UPointerFrame@PointerInputMediator@@V?$allocator@UPointerFrame@PointerInputMediator@@@std@@@std@@AEAAXAEAPEBUtagMANIPULATION_INPUT_INFO@@@Z @ 0x1800841BC
 * Callers:
        ...
        const struct tagMANIPULATION_INPUT_INFO **a2)
{
  ...
  v5 = v4 - 1;
  qword_180250E40 &= v5;
  v6 = v5 & (qword_180250E40 + v2);
  v7 = qword_180250E30;
  if ( !*(_QWORD *)(qword_180250E30 + 8 * v6) )
  {
    *(_QWORD *)(qword_180250E30 + 8 * v6) = operator new(0x110uLL);
    v7 = qword_180250E30;
  }
