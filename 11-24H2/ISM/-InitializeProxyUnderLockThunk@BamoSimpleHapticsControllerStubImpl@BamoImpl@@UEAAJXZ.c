/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoSimpleHapticsControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180185820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerStubImpl::InitializeProxyUnderLockThunk(
