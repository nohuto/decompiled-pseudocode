/*
 * XREFs of ??$MakeAndInitialize@VAnimationDataProvider@@UIAnimationDataProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIAnimationDataProvider@@@Z @ 0x18000D750
 * Callers:
 ...
 *     ??0AnimationDataProvider@@QEAA@XZ @ 0x180100818 (--0AnimationDataProvider@@QEAA@XZ.c)
