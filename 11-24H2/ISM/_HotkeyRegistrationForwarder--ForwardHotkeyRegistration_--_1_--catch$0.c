/*
 * XREFs of _HotkeyRegistrationForwarder::ForwardHotkeyRegistration_::_1_::catch$0 @ 0x1801D33DD
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HotkeyRegistrationForwarder::ForwardHotkeyRegistration_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
