/*
 * XREFs of ??1TargetingInfo@KeyboardProcessor@@QEAA@XZ @ 0x18002CB04
 * Callers:
 ...
 *     _KeyboardProcessor::OnInputReport_::_1_::dtor$5 @ 0x1801D116E (_KeyboardProcessor--OnInputReport_--_1_--dtor$5.c)
 * Callees:
