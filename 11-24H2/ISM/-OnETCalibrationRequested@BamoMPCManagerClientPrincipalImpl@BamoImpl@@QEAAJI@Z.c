/*
 * XREFs of ?OnETCalibrationRequested@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180167F90
 * Callers:
 *     ?Thunk_OnETCalibrationRequested_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180168CF0 (-Thunk_OnETCalibrationRequested_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPri.c)
 * Callees:
