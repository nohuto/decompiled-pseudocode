/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoResizeContextualProcessorStubImpl@BamoImpl@@UEAAJXZ @ 0x180072AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorStubImpl::OnConnectedUnderLockThunk(
