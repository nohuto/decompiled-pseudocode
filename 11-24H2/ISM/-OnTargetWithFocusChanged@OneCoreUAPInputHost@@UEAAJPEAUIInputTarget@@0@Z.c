/*
 * XREFs of ?OnTargetWithFocusChanged@OneCoreUAPInputHost@@UEAAJPEAUIInputTarget@@0@Z @ 0x180023D70
 * Callers:
 *     <none>
 * Callees:
 *     ?InternalRelease@?$ComPtr@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@WRL@Microsoft@@IEAAKXZ @ 0x18000F254 (-InternalRelease@-$ComPtr@U-$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@WRL@Micros.c)
 *     ?OnTargetWithFocusChanged@InputProviderManager@@QEAAXPEAUIInputTarget@@0@Z @ 0x180023E74 (-OnTargetWithFocusChanged@InputProviderManager@@QEAAXPEAUIInputTarget@@0@Z.c)
