/*
 * XREFs of ?HapticDeviceRemoved@Haptics@InputTraceLogging@@SAXW4tagINPUT_MESSAGE_DEVICE_TYPE@@PEBG@Z @ 0x18018B264
 * Callers:
...
void __fastcall InputTraceLogging::Haptics::HapticDeviceRemoved(
