/*
 * XREFs of ?Materialize_BamoDeviceDockClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011CE0C
 * Callers:
 *     ?Thunk_Materialize_BamoDeviceDockClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801260A0 (-Thunk_Materialize_BamoDeviceDockClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoDeviceDockClientProxy *v15; // [rsp+60h] [rbp+8h] BYREF
  ...
  v6 = CreateDeviceDockClientProxy(v4, &v15);
  if ( v6 < 0 )
  ...
  if ( !v15 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v7);
  v8 = (*(__int64 (__fastcall **)(struct BamoDeviceDockClientProxy *))(*(_QWORD *)v15 + 56LL))(v15);
