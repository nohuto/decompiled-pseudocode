/*
 * XREFs of ?QueryInterface@BamoMPCManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B80C0
 * Callers:
 *     ?QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B8150 (-QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
