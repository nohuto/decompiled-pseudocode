/*
 * XREFs of ?LogSendOnActivationStateChange@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@AEAAXW4CUIActivationState@Input@Internal@UI@Windows@@_K@Z @ 0x1801323D4
 * Callers:
...
void BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogSendOnActivationStateChange()
{
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    v13 = v0 + 3;
    v22 = 8;
    tlgWriteTransfer_EventWriteTransfer(v3, byte_18021CC11, 0LL, 0LL, 6u, &v11);
  }
}
