/*
 * XREFs of ??_EBamoPenDevicePrincipal@@MEAAPEAXI@Z @ 0x180190BD0
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009D758 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1BamoPenDevicePrincipalImpl@BamoImpl@@UEAA@XZ @ 0x180190B44 (--1BamoPenDevicePrincipalImpl@BamoImpl@@UEAA@XZ.c)
 */
