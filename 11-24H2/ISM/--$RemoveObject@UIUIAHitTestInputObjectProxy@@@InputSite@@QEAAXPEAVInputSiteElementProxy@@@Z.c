/*
 * XREFs of ??$RemoveObject@UIUIAHitTestInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800388F8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IUIAHitTestInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_a8b60ac5_1c61_143e_9764_a6fbf67d91ce, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
