/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x180174794
 * Callers:
 *     ?Thunk_SetOutcome_0@?$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180174890 (-Thunk_SetOutcome_0@-$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@.c)
 * Callees:
