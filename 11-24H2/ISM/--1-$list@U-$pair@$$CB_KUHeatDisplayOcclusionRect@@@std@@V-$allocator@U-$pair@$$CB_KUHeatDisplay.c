/*
 * XREFs of ??1?$list@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@V?$allocator@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@@2@@std@@QEAA@XZ @ 0x1801930B4
 * Callers:
 *     _ISMHeatFrameworkHost::BroadcastContextMessage_::_1_::dtor$13 @ 0x1801D8C69 (_ISMHeatFrameworkHost--BroadcastContextMessage_--_1_--dtor$13.c)
 * Callees:
