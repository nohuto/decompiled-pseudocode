/*
 * XREFs of ?UnregisterSystemContextEndpoint@SystemContextManager@@QEAAJPEAVBamoSystemContextEndpointProxy@@@Z @ 0x1801408B0
 * Callers:
 *     ?OnDisconnected@SystemContextEndpointProxy@@MEAAJXZ @ 0x180140C60 (-OnDisconnected@SystemContextEndpointProxy@@MEAAJXZ.c)
 * Callees:
