/*
 * XREFs of ?InvokeSendHapticFeedbackForPlayCount@HapticProcessor@@CAJPEAVBamoSimpleHapticsControllerPrincipal@@W4tagINPUT_MESSAGE_DEVICE_TYPE@@GAEBUtagINPUT_HAPTIC_SETTINGS@@II@Z @ 0x1800C9650
 * Callers:
...
int __fastcall HapticProcessor::InvokeSendHapticFeedbackForPlayCount(
