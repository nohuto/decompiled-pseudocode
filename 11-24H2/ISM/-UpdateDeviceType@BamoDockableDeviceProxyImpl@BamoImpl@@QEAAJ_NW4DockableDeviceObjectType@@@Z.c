/*
 * XREFs of ?UpdateDeviceType@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NW4DockableDeviceObjectType@@@Z @ 0x180127FEC
 * Callers:
 *     ?Thunk_UpdateDeviceType_16@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126690 (-Thunk_UpdateDeviceType_16@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@.c)
