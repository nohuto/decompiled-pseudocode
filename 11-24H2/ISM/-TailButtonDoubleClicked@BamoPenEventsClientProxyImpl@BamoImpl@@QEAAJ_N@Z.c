/*
 * XREFs of ?TailButtonDoubleClicked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1801966D0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsClientProxyImpl::TailButtonDoubleClicked(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonDoubleClicked(this);
      v11[0] = v13;
      v11[1] = v14;
