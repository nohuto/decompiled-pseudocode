/*
 * XREFs of ?QueryInterface@EdgyLegacyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A8C40
 * Callers:
 *     ?QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A8D00 (-QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
