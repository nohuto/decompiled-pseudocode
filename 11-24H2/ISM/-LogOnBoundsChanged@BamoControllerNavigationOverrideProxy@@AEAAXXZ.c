/*
 * XREFs of ?LogOnBoundsChanged@BamoControllerNavigationOverrideProxy@@AEAAXXZ @ 0x18017716C
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnBoundsChanged(BamoControllerNavigationOverrideProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
