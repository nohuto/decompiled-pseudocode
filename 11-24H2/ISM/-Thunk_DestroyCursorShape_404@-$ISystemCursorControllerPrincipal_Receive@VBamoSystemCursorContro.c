/*
 * XREFs of ?Thunk_DestroyCursorShape_404@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8140
 * Callers:
 *     <none>
 * Callees:
 *     <none>
