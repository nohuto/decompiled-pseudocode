 ...
 *     ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Tree_node@U?$pair@$$CBKU?$pair@PEAUDeviceInfo@@V?$ComPtr@UICursor@@@WRL@Microsoft@@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18007DE10 (--1-$_Alloc_construct_ptr@V-$allocator@U-$_Tree_node@U-$pair@$$CBKU-$pair@PEAUDeviceInfo@@V-$Com.c)
        ...
        _OWORD *a4)
{
  ...
  v19 = a1 + 2;
  v8 = (char *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x38uLL);
  v20 = v8;
  *((_DWORD *)v8 + 4) = *a3;
  *(_OWORD *)(v8 + 24) = *a4;
  *(_OWORD *)(v8 + 40) = a4[1];
  ...
  std::_Alloc_construct_ptr<std::allocator<std::_Tree_node<std::pair<unsigned long const,std::pair<DeviceInfo *,Microsoft::WRL::ComPtr<ICursor>>>,void *>>>::~_Alloc_construct_ptr<std::allocator<std::_Tree_node<std::pair<unsigned long const,std::pair<DeviceInfo *,Microsoft::WRL::ComPtr<ICursor>>>,void *>>>((__int64)&v19);
  return a2;
}
