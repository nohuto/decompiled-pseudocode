        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_180250EC8 + 16 * (a4 & qword_180250EE0) + 8);
  if ( v4 == (_QWORD *)qword_180250EB8 )
  {
    *a2 = qword_180250EB8;
LABEL_3:
    a2[1] = 0LL;
  ...
  else
  {
    while ( *a3 != v4[2] )
    {
      if ( v4 == *(_QWORD **)(qword_180250EC8 + 16 * (a4 & qword_180250EE0)) )
      {
        *a2 = v4;
        goto LABEL_3;
      }
