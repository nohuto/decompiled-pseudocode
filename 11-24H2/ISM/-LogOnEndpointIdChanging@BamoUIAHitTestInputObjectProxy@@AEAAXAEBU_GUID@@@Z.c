/*
 * XREFs of ?LogOnEndpointIdChanging@BamoUIAHitTestInputObjectProxy@@AEAAXAEBU_GUID@@@Z @ 0x180118080
 * Callers:
...
void __fastcall BamoUIAHitTestInputObjectProxy::LogOnEndpointIdChanging(
