/*
 * XREFs of ??$_Emplace_reallocate@AEBV?$shared_ptr@ULegacyDeviceInfo@@@std@@@?$vector@V?$shared_ptr@ULegacyDeviceInfo@@@std@@V?$allocator@V?$shared_ptr@ULegacyDeviceInfo@@@std@@@2@@std@@AEAAPEAV?$shared_ptr@ULegacyDeviceInfo@@@1@QEAV21@AEBV21@@Z @ 0x1800CEEAC
 * Callers:
        ...
        __int64 a3)
{
  ...
  catch ( ... )
  {
    ...
    std::_Deallocate<16,0>(v19, (const struct std::nothrow_t *)(16 * v9));
    throw;
  }
  return result;
}
