/*
 * XREFs of ??_GInputAttemptedDeliveryClientProxy@@UEAAPEAXI@Z @ 0x18015CF20
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009D758 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1InputAttemptedDeliveryClientProxy@@UEAA@XZ @ 0x18015CEF0 (--1InputAttemptedDeliveryClientProxy@@UEAA@XZ.c)
 */
