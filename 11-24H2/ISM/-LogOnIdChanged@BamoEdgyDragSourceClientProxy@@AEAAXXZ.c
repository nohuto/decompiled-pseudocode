/*
 * XREFs of ?LogOnIdChanged@BamoEdgyDragSourceClientProxy@@AEAAXXZ @ 0x180118A80
 * Callers:
...
void __fastcall BamoEdgyDragSourceClientProxy::LogOnIdChanged(BamoEdgyDragSourceClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
