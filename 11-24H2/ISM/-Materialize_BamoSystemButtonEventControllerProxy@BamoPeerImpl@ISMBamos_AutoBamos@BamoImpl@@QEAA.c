/*
 * XREFs of ?Materialize_BamoSystemButtonEventControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002DE3C
 * Callers:
 *     ?Thunk_Materialize_BamoSystemButtonEventControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180085D60 (-Thunk_Materialize_BamoSystemButtonEventControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive.c)
 * Callees:
