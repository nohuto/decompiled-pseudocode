/*
 * XREFs of ?CreateInputSink@MPCFocusTarget@@IEAAXXZ @ 0x1800FF4B0
 * Callers:
 ...
 *     ?OnFrameworkViewTypeUpdated@MPCFocusTarget@@MEAAXXZ @ 0x1800FF8A0 (-OnFrameworkViewTypeUpdated@MPCFocusTarget@@MEAAXXZ.c)
 * Callees:
 ...
 *     ?_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z @ 0x1800FF8E0 (-_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z.c)
...
void __fastcall MPCFocusTarget::CreateInputSink(MPCFocusTarget *this)
{
  ...
  v8 = 0LL;
  (***((void (__fastcall ****)(_QWORD, GUID *, __int64 *))this + 11))(
    *((_QWORD *)this + 11),
