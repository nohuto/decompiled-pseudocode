/*
 * XREFs of ?s_OnKernelInputEventStatic@?$KernelInputConnection@UMIT_INPUTSTREAM_ENDED_MESSAGE@@@@CAJPEAX0H@Z @ 0x18006A520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KernelInputConnection<MIT_INPUTSTREAM_ENDED_MESSAGE>::s_OnKernelInputEventStatic(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        const char *a4)
