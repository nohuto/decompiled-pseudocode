/*
 * XREFs of ?LogOnTypeChanging@BamoInputForwardTargetInputObjectProxy@@AEAAXAEBU_GUID@@@Z @ 0x18011A540
 * Callers:
...
void __fastcall BamoInputForwardTargetInputObjectProxy::LogOnTypeChanging(
