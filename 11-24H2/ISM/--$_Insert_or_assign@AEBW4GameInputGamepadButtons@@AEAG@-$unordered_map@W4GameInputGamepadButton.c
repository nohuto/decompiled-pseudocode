 ...
 *     ?_Forced_rehash@?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAAX_K@Z @ 0x18017D48C (-_Forced_rehash@-$_Hash@V-$_Umap_traits@W4GameInputGamepadButtons@@GV-$_Uhash_compare@W4GameInpu.c)
 *     ?_Insert_new_node_before@?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAAPEAU?$_List_node@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@PEAX@2@_KQEAU32@1@Z @ 0x18017D624 (-_Insert_new_node_before@-$_Hash@V-$_Umap_traits@W4GameInputGamepadButtons@@GV-$_Uhash_compare@W.c)
 */
        ...
        _WORD *a4)
{
  ...
  v7 = *(_QWORD *)(qword_180250F48 + 16 * (v5 & qword_180250F60) + 8);
  v8 = qword_180250F38;
  ...
  while ( 1 )
  {
    ...
    if ( v7 == *(_QWORD *)(qword_180250F48 + 16 * (v5 & qword_180250F60)) )
      break;
    v7 = *(_QWORD *)(v7 + 8);
  }
  v8 = v7;
...
LABEL_6:
  ...
  {
LABEL_12:
    if ( qword_180250F40 == 0xAAAAAAAAAAAAAAALL )
    ...
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<enum GameInputGamepadButtons const,unsigned short>,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<enum GameInputGamepadButtons const,unsigned short>,void *>>>(
      ...
      a3,
      a4);
    v10 = qword_180250F40 + 1;
    if ( qword_180250F40 + 1 < 0 )
      v11 = (float)(int)(v10 & 1 | (v10 >> 1)) + (float)(int)(v10 & 1 | (v10 >> 1));
    else
      v11 = (float)(int)v10;
    v12 = qword_180250F68;
    if ( qword_180250F68 < 0 )
    {
      v12 = qword_180250F68 & 1;
      v13 = (float)(int)(v12 | ((unsigned __int64)qword_180250F68 >> 1))
          + (float)(int)(v12 | ((unsigned __int64)qword_180250F68 >> 1));
    }
    else
    {
      v13 = (float)(int)qword_180250F68;
    }
