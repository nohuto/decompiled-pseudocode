/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1801594EC
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180159E80 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@QEAAX_NW4.c)
  ...
  if ( (v3 & 6) != 6 )
  {
    ...
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_ClickToDoPenEdgy__descriptor, v9, i);
      if ( i == v11 )
        break;
    }
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (v13[1] = 0,
            v13[0] = 3,
            v14 = Feature_ClickToDoPenEdgy__descriptor,
