/*
 * XREFs of ?Invoke@?$delegate@U?$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UWindowChangedEventArgs@23456@@Foundation@Windows@winrt@@V_lambda_66ed2df52651243ff863a12d97446406_@@@impl@winrt@@UEAAHPEAX0@Z @ 0x180075D50
 * Callers:
 *     <none>
 * Callees:
 *     ??$?RAEBUAppViewWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEBUAppViewChangedEventArgs@12345@@_lambda_e811ed625de1c9f36d6dae6db721db2b_@@QEBA?A_PAEBUAppViewWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEBUAppViewChangedEventArgs@23456@@Z @ 0x180075D84 (--$-RAEBUAppViewWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEBUAppViewCha.c)
 */
