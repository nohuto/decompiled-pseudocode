/*
 * XREFs of ?UnregisterGestureSource@ShellGesturesProcessor@@QEAAX_KPEAVDragManagerClientProxy@@@Z @ 0x1800285F8
 * Callers:
 ...
 * Callees:
 *     std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_ShellGesturesProcessor::GestureRegistration_______lambda_28cbbaafa351dff69488e6a008c133d8___ @ 0x1800286B4 (std--remove_if_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_ShellGesturesProcessor-.c)
 ...
 *     ??$_Move_unchecked@PEAUGestureRegistration@ShellGesturesProcessor@@PEAU12@@std@@YAPEAUGestureRegistration@ShellGesturesProcessor@@PEAU12@00@Z @ 0x1800289DC (--$_Move_unchecked@PEAUGestureRegistration@ShellGesturesProcessor@@PEAU12@@std@@YAPEAUGestureReg.c)
