/*
 * XREFs of ?LogReceiveRegisterShellHandwritingHostClient@BamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoShellHandwritingHostClientProxy@@@Z @ 0x18015B9B8
 * Callers:
