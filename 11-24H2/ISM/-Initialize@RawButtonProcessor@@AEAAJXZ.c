/*
 * XREFs of ?Initialize@RawButtonProcessor@@AEAAJXZ @ 0x1801B27E4
 * Callers:
 ...
 *     ?Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z @ 0x1801B2730 (-Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z.c)
 */
