/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012C864
 * Callers:
 *     ?Thunk_UpdateSupportedFeedback_8@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126C00 (-Thunk_UpdateSupportedFeedback_8@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsContr.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Proxy *))(*((_QWORD *)this - 2) + 136LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
