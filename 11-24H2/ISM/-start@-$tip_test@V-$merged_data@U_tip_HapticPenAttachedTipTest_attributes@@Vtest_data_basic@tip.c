/*
 * XREFs of ?start@?$tip_test@V?$merged_data@U_tip_HapticPenAttachedTipTest_attributes@@Vtest_data_basic@tip2@@@details@tip2@@@tip2@@QEAA?AU_GUID@@XZ @ 0x18018E248
 * Callers:
...
_OWORD *__fastcall tip2::tip_test<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>>::start(
        __int64 *a1,
        _OWORD *a2)
{
  ...
  if ( !*a1 )
  {
    ...
    v7 = tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>((__int64)v5);
