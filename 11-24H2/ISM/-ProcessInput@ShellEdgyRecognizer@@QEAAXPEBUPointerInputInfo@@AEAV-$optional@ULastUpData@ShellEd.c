/*
 * XREFs of ?ProcessInput@ShellEdgyRecognizer@@QEAAXPEBUPointerInputInfo@@AEAV?$optional@ULastUpData@ShellEdgyRecognizer@@@std@@@Z @ 0x180057A1C
 * Callers:
 ...
 *     _o_atan2_0 @ 0x18009D4A8 (_o_atan2_0.c)
 *     ?EdgyLocationToString@ShellEdgyRecognizer@@AEAAPEBGXZ @ 0x18015B4D8 (-EdgyLocationToString@ShellEdgyRecognizer@@AEAAPEBGXZ.c)
 *     ?FailureReasonToString@ShellEdgyRecognizer@@AEAAPEBGXZ @ 0x18015B524 (-FailureReasonToString@ShellEdgyRecognizer@@AEAAPEBGXZ.c)
 */
...
LABEL_21:
  ...
  *(_DWORD *)this = v8;
  if ( ((v8 - 1) & 0xFFFFFFFD) == 0 )
  {
    ...
    {
      LOBYTE(v8) = tlgKeywordOn((__int64)&dword_18024E248, 0x200000000000LL);
      if ( (_BYTE)v8 )
      {
        v21 = HIDWORD(v22);
        v27 = v15;
