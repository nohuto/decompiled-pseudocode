/*
 * XREFs of ?TryFindPenHapticControllerForMessage@HapticProcessor@@CAJPEBUtagMSG@@PEAPEAVBamoSimpleHapticsControllerPrincipal@@@Z @ 0x1800CA7CC
 * Callers:
        ...
        __int64 a4)
{
  ...
  message = a1->message;
  LOBYTE(a4) = 1;
  if ( (unsigned int)(message - 581) <= 0x12 || (v7 = 0, (unsigned int)(message - 577) <= 3) )
    v7 = 1;
