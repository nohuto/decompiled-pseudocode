/*
 * XREFs of ?QueryInterface@ComboButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A4E00
 * Callers:
 *     ?QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A4EC0 (-QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
