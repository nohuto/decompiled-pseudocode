/*
 * XREFs of ?Provider@FeatureLogging@details@wil@@SAPEBU_tlgProvider_t@@XZ @ 0x1800A0DD8
 * Callers:
...
{
  return (const struct _tlgProvider_t *)*((_QWORD *)wil::details::static_lazy<wil::details::FeatureLogging>::get(
                                                      a1,
