/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersTelemetry@@@details@wil@@QEAAPEAVRawInputProvidersTelemetry@@P6AXXZ@Z @ 0x180085738
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<RawInputProvidersTelemetry>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && v6 )
  {
    ...
    dword_180251E3C = 0;
    v8 = &qword_180251E28;
    qword_180251E28 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    v4 = &`RawInputProvidersTelemetry::Instance'::`2'::wrapper;
    byte_180251E38 = 0;
    qword_180251E40 = (__int64)&`RawInputProvidersTelemetry::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
