/*
 * XREFs of ?_lambda_invoker_cdecl_@_lambda_ae55d4909240e1fdeaaab3ab1260b561_@@CA@AEBUIWindowStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@Z @ 0x1800A6A40
 * Callers:
 *     <none>
 * Callees:
...
const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics *__fastcall _lambda_ae55d4909240e1fdeaaab3ab1260b561_::_lambda_invoker_cdecl_(
        const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics *a1,
        __int64 **a2)
{
