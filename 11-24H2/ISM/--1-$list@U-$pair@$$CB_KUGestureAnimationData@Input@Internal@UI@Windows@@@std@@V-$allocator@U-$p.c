/*
 * XREFs of ??1?$list@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@V?$allocator@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@@2@@std@@QEAA@XZ @ 0x180099AA0
 * Callers:
 *     _DragManagerClientProxy::DragManagerClientProxy_::_1_::dtor$3 @ 0x1801D13A8 (_DragManagerClientProxy--DragManagerClientProxy_--_1_--dtor$3.c)
 *     _EdgyProcessor::EdgyProcessor_::_1_::dtor$12 @ 0x1801D19B6 (_EdgyProcessor--EdgyProcessor_--_1_--dtor$12.c)
 *     _ConsumerControlDeviceCollection::ConsumerControlDeviceCollection_::_1_::dtor$3 @ 0x1801D5A8D (_ConsumerControlDeviceCollection--ConsumerControlDeviceCollection_--_1_--dtor$3.c)
 *     _std::variant_std::monostate_HeatInputConfigContextMessage_HeatLowPowerStateContextMessage_HeatHingeAngleContextMessage_HeatDisplayOcclusionContextMessage_HeatVirtualTouchpadContextMessage_HeatTouchpadEnabledContextMessage_HeatTouchpadHapticConfigContextMessage_HeatTouchpadClickForceSensitivityContextMessage_::emplace_HeatVirtualTouchpadContextMessage_5_0__::_1_::dtor$3 @ 0x1801D8BA2 (_std--variant_std--monostate_HeatInputConfigContextMessage_HeatLowPowerStateContextMessage_HeatH.c)
 * Callees:
