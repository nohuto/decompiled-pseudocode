/*
 * XREFs of ?AllocateStubUnderLock@BamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_DisplayOcclusionRect_Stub@2345@@Z @ 0x18013C0F0
 * Callers:
 *     <none>
 * Callees:
