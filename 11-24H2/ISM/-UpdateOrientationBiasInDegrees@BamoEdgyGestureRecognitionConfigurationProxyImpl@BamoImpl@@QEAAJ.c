/*
 * XREFs of ?UpdateOrientationBiasInDegrees@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NM@Z @ 0x18012AE58
 * Callers:
 *     ?Thunk_UpdateOrientationBiasInDegrees_190@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126A70 (-Thunk_UpdateOrientationBiasInDegrees_190@-$IEdgyGestureRecognitionConfigurationProxy_Receive@VB.c)
