/*
 * XREFs of ?SetDockRoutingPolicy@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x180125610
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoPenEventsDispatcherProxyImpl::LogSendSetDockRoutingPolicy();
      v11[0] = v13;
      v11[1] = v14;
