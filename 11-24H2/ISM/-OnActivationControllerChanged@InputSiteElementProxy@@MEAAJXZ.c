/*
 * XREFs of ?OnActivationControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180057050
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800570C4 (--$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
