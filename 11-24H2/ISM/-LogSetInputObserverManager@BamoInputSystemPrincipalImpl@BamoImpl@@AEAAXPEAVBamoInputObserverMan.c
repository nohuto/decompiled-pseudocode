/*
 * XREFs of ?LogSetInputObserverManager@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputObserverManagerPrincipal@@@Z @ 0x1800929F4
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetInputObserverManager(
