/*
 * XREFs of ?Thunk_OnInputConfigChanged_382@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800AB6C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
