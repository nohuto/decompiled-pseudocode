/*
 * XREFs of ?GetDesktopUniqueName@@YAXPEB_WPEA_WK@Z @ 0x18004EEA8
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEA_W_KPEB_W@Z @ 0x18004F1B4 (-StringCchCopyW@@YAJPEA_W_KPEB_W@Z.c)
 *     ?GetSessionID@@YAKXZ @ 0x180098E6C (-GetSessionID@@YAKXZ.c)
