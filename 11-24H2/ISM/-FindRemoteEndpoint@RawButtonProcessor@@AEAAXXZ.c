/*
 * XREFs of ?FindRemoteEndpoint@RawButtonProcessor@@AEAAXXZ @ 0x1801B2600
 * Callers:
 *     ?Initialize@RawButtonProcessor@@AEAAJXZ @ 0x1801B27E4 (-Initialize@RawButtonProcessor@@AEAAJXZ.c)
 *     ?OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801B2870 (-OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAVInputContext@@PEAUContextualProcess.c)
