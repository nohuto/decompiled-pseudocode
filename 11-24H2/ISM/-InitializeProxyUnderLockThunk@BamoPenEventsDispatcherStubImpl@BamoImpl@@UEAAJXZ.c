/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoPenEventsDispatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x180072D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherStubImpl::InitializeProxyUnderLockThunk(
