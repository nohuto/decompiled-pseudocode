/*
 * XREFs of ?MPCPerfCounter_ReportPerf_@ISMTracing@@QEAAXKIM@Z @ 0x1800C7950
 * Callers:
 ...
 *     ?GetProviderType@ISMTracing@@SAPEBGI@Z @ 0x1800B9F84 (-GetProviderType@ISMTracing@@SAPEBGI@Z.c)
 */
