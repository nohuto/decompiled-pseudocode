/*
 * XREFs of ?LogOnHeatGripServiceChanging@BamoInputSystemProxy@@AEAAXPEAVBamoHeatGripServiceProxy@@@Z @ 0x180118808
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnHeatGripServiceChanging(
        BamoInputSystemProxy *this,
        struct BamoHeatGripServiceProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
