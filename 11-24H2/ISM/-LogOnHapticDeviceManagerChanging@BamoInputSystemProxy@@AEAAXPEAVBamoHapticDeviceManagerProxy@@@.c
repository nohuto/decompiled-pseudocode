/*
 * XREFs of ?LogOnHapticDeviceManagerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoHapticDeviceManagerProxy@@@Z @ 0x180118688
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnHapticDeviceManagerChanging(
        BamoInputSystemProxy *this,
        struct BamoHapticDeviceManagerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
