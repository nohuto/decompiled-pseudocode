/*
 * XREFs of ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKUContactState@MagnifierRecognizer@@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x180184B08
 * Callers:
 ...
 *     ?CheckForTwoFingerTap@MagnifierRecognizer@@AEAAXXZ @ 0x1801AE3C8 (-CheckForTwoFingerTap@MagnifierRecognizer@@AEAAXXZ.c)
 * Callees:
 *     <none>
 */
