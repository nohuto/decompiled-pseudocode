/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180092D38
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__MPC3DStateHelper::s_isInstanceCreatedEvent__ @ 0x1801DA070 (_dynamic_atexit_destructor_for__MPC3DStateHelper--s_isInstanceCreatedEvent__.c)
 * Callees:
