/*
 * XREFs of ?UpdateGestureServicesRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180046360
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  {
    v3 = (struct Microsoft::Bamo::BamoPrincipal *)*((_QWORD *)this + 9);
    if ( v3 )
