/*
 * XREFs of _lambda_ee4fb4173948ca8af83f1cabbba8acb3_::operator() @ 0x1800EFB64
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_ee4fb4173948ca8af83f1cabbba8acb3__void__MIT_VPTP_INTEROP_MESSAGE_const___::_Do_call @ 0x1800F2790 (std--_Func_impl_no_alloc__lambda_ee4fb4173948ca8af83f1cabbba8acb3__void__MIT_VPTP_I_ea_1800F2790.c)
 * Callees:
...
void __fastcall lambda_ee4fb4173948ca8af83f1cabbba8acb3_::operator()(__int64 a1, _DWORD *a2)
{
  ...
  for ( i = *(__int64 **)qword_180250EB8; i != (__int64 *)qword_180250EB8; i = (__int64 *)*i )
  {
    if ( *((_DWORD *)i + 6) == *a2 )
    {
