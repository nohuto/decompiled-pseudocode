/*
 * XREFs of ??$?RV?$nvp@AEAF@tson@@@input_archive@tson@@QEAAAEAV01@$$QEAV?$nvp@AEAF@1@@Z @ 0x180106834
 * Callers:
...
__int64 __fastcall tson::input_archive::operator()<tson::nvp<short &>>(__int64 a1, __int64 a2)
{
  char v2; // r8
  _WORD *v4; // rdi
  ...
  *(_BYTE *)(a1 + 24) = v2;
  ...
  if ( tson::input_archive::search((tson::input_archive *)a1) )
  {
    ...
    tson::read_buffer::consume_n(*(tson::read_buffer **)a1, v4, 2uLL);
  }
  else
  {
    *v4 = 0;
