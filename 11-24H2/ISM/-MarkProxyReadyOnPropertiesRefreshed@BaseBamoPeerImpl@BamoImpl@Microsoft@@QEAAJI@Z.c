/*
 * XREFs of ?MarkProxyReadyOnPropertiesRefreshed@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAJI@Z @ 0x1800B711C
 * Callers:
 *     ?Thunk_MarkProxyReadyOnPropertiesRefreshed_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B8E80 (-Thunk_MarkProxyReadyOnPropertiesRefreshed_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamo.c)
 * Callees:
