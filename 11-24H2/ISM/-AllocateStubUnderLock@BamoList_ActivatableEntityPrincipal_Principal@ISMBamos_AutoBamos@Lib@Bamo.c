/*
 * XREFs of ?AllocateStubUnderLock@BamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_ActivatableEntityPrincipal_Stub@2345@@Z @ 0x180073410
 * Callers:
 *     <none>
 * Callees:
