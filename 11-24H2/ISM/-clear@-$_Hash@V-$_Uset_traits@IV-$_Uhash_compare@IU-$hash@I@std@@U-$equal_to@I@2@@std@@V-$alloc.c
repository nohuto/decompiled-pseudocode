/*
 * XREFs of ?clear@?$_Hash@V?$_Uset_traits@IV?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@I@2@$0A@@std@@@std@@QEAAXXZ @ 0x1800281A0
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( a1[7] >> 3 <= v2 )
    {
      std::_List_node<enum _Button,void *>::_Free_non_head<std::allocator<std::_List_node<enum _Button,void *>>>(v2, v3);
      *(_QWORD *)a1[1] = a1[1];
