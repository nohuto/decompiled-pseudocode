/*
 * XREFs of ?QueryInterface@BamoList_SimpleHapticsControllerPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018C470
 * Callers:
 *     ?QueryInterface@BamoList_SimpleHapticsControllerPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018C4F0 (-QueryInterface@BamoList_SimpleHapticsControllerPrincipal_Principal@ISMBamos_AutoBa_ea_18018C4F0.c)
 * Callees:
