/*
 * XREFs of ??_ETapProcessor@@EEAAPEAXI@Z @ 0x1801B1BD0
 * Callers:
 *     ??_ETapProcessor@@GBA@EAAPEAXI@Z @ 0x1801B1BC0 (--_ETapProcessor@@GBA@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1TapProcessor@@EEAA@XZ @ 0x1801B1B24 (--1TapProcessor@@EEAA@XZ.c)
 */
