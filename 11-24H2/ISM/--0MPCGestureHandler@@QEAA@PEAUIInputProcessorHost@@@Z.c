/*
 * XREFs of ??0MPCGestureHandler@@QEAA@PEAUIInputProcessorHost@@@Z @ 0x1800BCC58
 * Callers:
 *     ??$Make@VMPCGestureHandler@@PEAUIInputProcessorHost@@@Details@WRL@Microsoft@@YA?AV?$ComPtr@VMPCGestureHandler@@@12@$$QEAPEAUIInputProcessorHost@@@Z @ 0x1800B1938 (--$Make@VMPCGestureHandler@@PEAUIInputProcessorHost@@@Details@WRL@Microsoft@@YA-AV-$ComPtr@VMPCG.c)
 * Callees:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIRawInputProvider@@VFtmBase@23@@WRL@Microsoft@@QEAA@XZ @ 0x1800BCB3C (--0-$RuntimeClass@U-$RuntimeClassFlags@$02@WRL@Microsoft@@UIRawInputProvider@@VFtmBase@23@@WRL@M.c)
 ...
 *     ?SetZoomDecreasingThresholds@ManipulationInjector@@QEAAXJJ@Z @ 0x180112868 (-SetZoomDecreasingThresholds@ManipulationInjector@@QEAAXJJ@Z.c)
        ...
        struct IInputProcessorHost *a2)
{
  ...
  *((_DWORD *)this + 244) = 100;
  ...
  Microsoft::WRL::ComPtr<DWMCursorBroker>::operator=((__int64 *)this + 112, (__int64)a2);
  if ( !*((_QWORD *)this + 112) )
