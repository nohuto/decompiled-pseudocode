/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TouchpadPublicApis3@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180159620
 * Callers:
  ...
  if ( (v3 & 6) != 6 )
  {
    ...
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_TouchpadPublicApis3__descriptor, v9, i);
      if ( i == v11 )
        break;
    }
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (v13[1] = 0,
            v13[0] = 3,
            v14 = Feature_TouchpadPublicApis3__descriptor,
