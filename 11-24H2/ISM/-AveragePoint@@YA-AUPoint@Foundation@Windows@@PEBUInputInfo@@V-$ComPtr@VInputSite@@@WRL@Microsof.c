/*
 * XREFs of ?AveragePoint@@YA?AUPoint@Foundation@Windows@@PEBUInputInfo@@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@Z @ 0x1801AE724
 * Callers:
 ...
 *     ?DeliverInput@MagnifierToggleTarget@@UEAAJPEAUInputInfo@@@Z @ 0x1801AEA00 (-DeliverInput@MagnifierToggleTarget@@UEAAJPEAUInputInfo@@@Z.c)
 * Callees:
 ...
 *     ??$?4UPoint@Foundation@Windows@@_N$0A@@?$tuple@AEAUPoint@Foundation@Windows@@AEBU_Ignore@std@@@std@@QEAAAEAV01@$$QEAV?$tuple@UPoint@Foundation@Windows@@_N@1@@Z @ 0x1801AE70C (--$-4UPoint@Foundation@Windows@@_N$0A@@-$tuple@AEAUPoint@Foundation@Windows@@AEBU_Ignore@std@@@s.c)
