/*
 * XREFs of ?Add@FlickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1801B3AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x1801B3D24 (-CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z.c)
