/*
 * XREFs of ?LogSendUnregisterGestureDragClient@BamoGestureServicesProxyImpl@BamoImpl@@AEAAX_KI@Z @ 0x18011C25C
 * Callers:
...
void __fastcall BamoImpl::BamoGestureServicesProxyImpl::LogSendUnregisterGestureDragClient(
