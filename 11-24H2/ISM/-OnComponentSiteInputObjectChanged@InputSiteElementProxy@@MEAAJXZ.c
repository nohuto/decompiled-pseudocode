/*
 * XREFs of ?OnComponentSiteInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005D8D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIComponentSiteInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D944 (--$RemoveObject@UIComponentSiteInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
