 ...
 *     ??1?$list@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@V?$allocator@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@@2@@std@@QEAA@XZ @ 0x180139400 (--1-$list@U-$pair@$$CB_KUInputObserverClient@-$CBaseInputObserverServer@$0L@@@@std@@V-$allocator.c)
 * Callees:
