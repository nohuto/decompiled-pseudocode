/*
 * XREFs of ?LogOnDockedEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x180195000
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnDockedEventsRequiredChanged(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
