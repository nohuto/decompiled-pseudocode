/*
 * XREFs of ?LogSendManualDragEnded@BamoManualDragAreaClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x1801485C0
 * Callers:
...
void __fastcall BamoImpl::BamoManualDragAreaClientProxyImpl::LogSendManualDragEnded(
