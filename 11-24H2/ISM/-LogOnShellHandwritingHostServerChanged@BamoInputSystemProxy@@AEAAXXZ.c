/*
 * XREFs of ?LogOnShellHandwritingHostServerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180119C58
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnShellHandwritingHostServerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
