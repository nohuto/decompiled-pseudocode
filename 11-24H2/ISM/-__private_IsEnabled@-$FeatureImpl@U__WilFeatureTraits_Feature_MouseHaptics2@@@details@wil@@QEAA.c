/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_MouseHaptics2@@@details@wil@@QEAA_NXZ @ 0x1800CB118
 * Callers:
 ...
 *     ?OnDeviceQueryRemove@MouseProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x180198040 (-OnDeviceQueryRemove@MouseProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
        ...
        wil::details *a1)
{
  ...
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_MouseHaptics2>::GetCachedFeatureEnabledState(a1, &v6);
  v2 = v6 & 1;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_MouseHaptics2>::ReportUsage((__int64)a1, v6 & 1, v3, v4);
  return v2;
}
