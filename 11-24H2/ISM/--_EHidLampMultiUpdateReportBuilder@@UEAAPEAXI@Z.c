/*
 * XREFs of ??_EHidLampMultiUpdateReportBuilder@@UEAAPEAXI@Z @ 0x1800356D0
 * Callers:
 *     <none>
 * Callees:
 *     ??1HidLampMultiUpdateReportBuilder@@UEAA@XZ @ 0x180035810 (--1HidLampMultiUpdateReportBuilder@@UEAA@XZ.c)
