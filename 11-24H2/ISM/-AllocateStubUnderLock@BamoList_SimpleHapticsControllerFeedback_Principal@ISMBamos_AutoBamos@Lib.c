/*
 * XREFs of ?AllocateStubUnderLock@BamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_SimpleHapticsControllerFeedback_Stub@2345@@Z @ 0x180184CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Principal::AllocateStubUnderLock(
