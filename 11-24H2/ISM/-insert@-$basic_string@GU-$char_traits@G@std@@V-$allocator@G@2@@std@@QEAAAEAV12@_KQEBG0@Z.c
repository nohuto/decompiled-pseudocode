/*
 * XREFs of ?insert@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAAEAV12@_KQEBG0@Z @ 0x1800B5974
 * Callers:
...
void **__fastcall std::wstring::insert(void **Src, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( !v7 )
    v8 = (char *)*Src;
  if ( &asc_180201DC0[a4] <= (wchar_t *)v8 || L"," > (wchar_t *)&v8[2 * v4] )
  {
    v9 = a4;
  }
  else if ( v8 > (char *)L"," )
  ...
  memcpy_0(v8, L",", 2 * v9);
  memcpy_0(&v8[2 * v9], &asc_180201DC0[v9 + a4], 2 * (a4 - v9));
  return Src;
}
