/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801032E0
 * Callers:
 *     ?Thunk_OnSetPropertyValueError_5@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105A40 (-Thunk_OnSetPropertyValueError_5@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@Bam.c)
 * Callees:
