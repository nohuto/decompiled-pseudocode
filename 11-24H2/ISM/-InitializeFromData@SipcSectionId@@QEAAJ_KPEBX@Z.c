/*
 * XREFs of ?InitializeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x18010F64C
 * Callers:
 *     ?CreateSection@AlpcPort@@UEAAJ_K0PEBXPEAPEAX@Z @ 0x18010E860 (-CreateSection@AlpcPort@@UEAAJ_K0PEBXPEAPEAX@Z.c)
 * Callees:
 *     ?IsInitialized@SipcSectionId@@QEBA_NXZ @ 0x18010F7E8 (-IsInitialized@SipcSectionId@@QEBA_NXZ.c)
