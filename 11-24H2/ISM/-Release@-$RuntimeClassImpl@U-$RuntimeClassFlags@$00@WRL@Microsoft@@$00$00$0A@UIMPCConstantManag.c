/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIMPCConstantManagerClient@MPCManager@Input@Internal@Windows@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x1801658B0
 * Callers:
 *     ??1MPCManagerClient@@UEAA@XZ @ 0x1801612FC (--1MPCManagerClient@@UEAA@XZ.c)
 *     ?Release@MPCConstantManagerClient@@UEAAKXZ @ 0x180165B80 (-Release@MPCConstantManagerClient@@UEAAKXZ.c)
 ...
 *     ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIMPCConstantManagerClient@MPCManager@Input@Internal@Windows@@@Details@WRL@Microsoft@@W7EAAKXZ @ 0x180170C00 (-Release@-$RuntimeClassImpl@U-$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIMPC_ea_180170C00.c)
