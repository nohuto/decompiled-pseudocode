/*
 * XREFs of ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010C430
 * Callers:
 *     ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010C520 (-QueryInterface@-$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_GUID@@P.c)
 *     ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010C530 (-QueryInterface@-$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEBU_GUID@.c)
 * Callees:
