/*
 * XREFs of ?UnregisterSpatialEventHandlers@MPCSpatialGestureRecognizerHandler@@AEAAXXZ @ 0x1800C4614
 * Callers:
 *     ??1MPCSpatialGestureRecognizerHandler@@UEAA@XZ @ 0x1800C26CC (--1MPCSpatialGestureRecognizerHandler@@UEAA@XZ.c)
 * Callees:
