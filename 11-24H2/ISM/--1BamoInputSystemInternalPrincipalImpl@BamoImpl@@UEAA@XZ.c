/*
 * XREFs of ??1BamoInputSystemInternalPrincipalImpl@BamoImpl@@UEAA@XZ @ 0x18012EFB0
 * Callers:
 *     ??1BamoInputSystemInternalPrincipal@@MEAA@XZ @ 0x18012EFA0 (--1BamoInputSystemInternalPrincipal@@MEAA@XZ.c)
