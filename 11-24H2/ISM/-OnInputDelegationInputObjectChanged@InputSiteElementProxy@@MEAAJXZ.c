/*
 * XREFs of ?OnInputDelegationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180056920
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIInputDelegationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180056998 (--$RemoveObject@UIInputDelegationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@.c)
