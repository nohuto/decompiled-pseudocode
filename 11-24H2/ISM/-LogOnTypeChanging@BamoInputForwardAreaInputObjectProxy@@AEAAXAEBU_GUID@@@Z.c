/*
 * XREFs of ?LogOnTypeChanging@BamoInputForwardAreaInputObjectProxy@@AEAAXAEBU_GUID@@@Z @ 0x18011A4DC
 * Callers:
...
void __fastcall BamoInputForwardAreaInputObjectProxy::LogOnTypeChanging(
