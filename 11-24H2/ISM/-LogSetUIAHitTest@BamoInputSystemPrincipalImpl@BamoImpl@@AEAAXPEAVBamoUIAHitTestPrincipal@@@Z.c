/*
 * XREFs of ?LogSetUIAHitTest@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoUIAHitTestPrincipal@@@Z @ 0x18012E45C
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetUIAHitTest(
