/*
 * XREFs of ?LogOnDeviceTypeChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x180117AE0
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnDeviceTypeChanged(BamoSimpleHapticsControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
