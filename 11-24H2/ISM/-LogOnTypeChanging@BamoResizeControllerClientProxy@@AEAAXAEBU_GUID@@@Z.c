/*
 * XREFs of ?LogOnTypeChanging@BamoResizeControllerClientProxy@@AEAAXAEBU_GUID@@@Z @ 0x18011A608
 * Callers:
...
void __fastcall BamoResizeControllerClientProxy::LogOnTypeChanging(
