/*
 * XREFs of ?LogReceiveProcessResult@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAXIAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x180142AD0
 * Callers:
