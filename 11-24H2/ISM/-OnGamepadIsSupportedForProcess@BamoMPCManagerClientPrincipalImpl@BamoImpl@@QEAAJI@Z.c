/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801681E0
 * Callers:
 *     ?Thunk_OnGamepadIsSupportedForProcess_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180168D10 (-Thunk_OnGamepadIsSupportedForProcess_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerCli.c)
 * Callees:
