/*
 * XREFs of ?Create@DockDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800DD270
 * Callers:
 ...
 *     ??0_Mutex_base@std@@QEAA@H@Z @ 0x180080084 (--0_Mutex_base@std@@QEAA@H@Z.c)
