/*
 * XREFs of ?InputSinkRemoved@InputSinkDataCache@@QEAAX_K@Z @ 0x18004C0E0
 * Callers:
 ...
 *     ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@_K_KV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_K_K@std@@@2@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@$$CB_K_K@std@@PEAX@2@PEAU32@@Z @ 0x18004C1F0 (-_Unchecked_erase@-$_Hash@V-$_Umap_traits@_K_KV-$_Uhash_compare@_KU-$hash@_K@std@@U-$equal_to@_K.c)
 */
