/*
 * XREFs of std::_Func_impl_no_alloc__lambda_0b6054e39151cfdafdb4d4e01b2e9a55__void_InputContext___::_Do_call @ 0x1800F2540
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  v4 = (__int64 *)(*a2 + 16LL);
  if ( !*v4 )
    Microsoft::WRL::ComPtr<IMPCFocusTarget>::operator=(v4, *(_QWORD **)(a1 + 8));
