/*
 * XREFs of ?OnDeviceAttach@GazeDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x1800DCC90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPreparsedData@HIDDevice@@QEAAJPEAPEAXPEAK@Z @ 0x1800D338C (-GetPreparsedData@HIDDevice@@QEAAJPEAPEAXPEAK@Z.c)
