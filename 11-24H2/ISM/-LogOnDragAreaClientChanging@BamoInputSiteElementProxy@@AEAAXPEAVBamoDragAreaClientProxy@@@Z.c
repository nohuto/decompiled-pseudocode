/*
 * XREFs of ?LogOnDragAreaClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoDragAreaClientProxy@@@Z @ 0x18008F844
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnDragAreaClientChanging(
