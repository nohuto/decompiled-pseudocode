/*
 * XREFs of ?AllocateStubUnderLock@BamoInputSystemPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputSystemStub@@@Z @ 0x1800722D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputSystemPrincipal::AllocateStubUnderLock(
