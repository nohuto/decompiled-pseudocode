/*
 * XREFs of ?Materialize_BamoVirtualTouchpadControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011F0A8
 * Callers:
 *     ?Thunk_Materialize_BamoVirtualTouchpadControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126410 (-Thunk_Materialize_BamoVirtualTouchpadControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@V.c)
 * Callees:
