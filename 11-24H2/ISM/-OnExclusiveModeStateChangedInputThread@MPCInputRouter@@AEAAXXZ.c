/*
 * XREFs of ?OnExclusiveModeStateChangedInputThread@MPCInputRouter@@AEAAXXZ @ 0x1800FE340
 * Callers:
 *     _lambda_ec705bf725d52d27b1686ede0253a48a_::_lambda_invoker_cdecl_ @ 0x1800FC290 (_lambda_ec705bf725d52d27b1686ede0253a48a_--_lambda_invoker_cdecl_.c)
...
void __fastcall MPCInputRouter::OnExclusiveModeStateChangedInputThread(MPCInputRouter *this)
{
  ...
  v2 = 0;
  if ( *((_BYTE *)this + 744) != std::_Atomic_storage<bool,1>::load((__int64)this + 728)
    || *((_DWORD *)this + 187) != (unsigned int)std::_Atomic_storage<enum GestureOperationState,4>::load((unsigned int *)this + 183)
    || *((_QWORD *)this + 94) != std::_Atomic_storage<unsigned __int64,8>::load((__int64)this + 736) )
  {
    *((_BYTE *)this + 744) = std::_Atomic_storage<bool,1>::load(v3);
    *((_DWORD *)this + 187) = std::_Atomic_storage<enum GestureOperationState,4>::load((unsigned int *)this + 183);
    *((_QWORD *)this + 94) = std::_Atomic_storage<unsigned __int64,8>::load((__int64)this + 736);
    ...
    if ( *((_BYTE *)this + 744) )
    {
      v4 = (char *)this + 648;
      if ( *((_QWORD *)this + 81)
        && (v5 = std::_Atomic_storage<unsigned __int64,8>::load((__int64)this + 736),
            v5 == (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v6 + 56LL))(v6))
        || (v4 = (char *)this + 656, *((_QWORD *)this + 82))
        && (v7 = std::_Atomic_storage<unsigned __int64,8>::load((__int64)this + 736),
      ...
      else
      {
        ...
        v12 = DWMInputRouter::CreateAndRegisterTarget(this, *((_DWORD *)this + 187), 0, ViewIdFromWindowId, v9, &v24);
        if ( v12 < 0 )
