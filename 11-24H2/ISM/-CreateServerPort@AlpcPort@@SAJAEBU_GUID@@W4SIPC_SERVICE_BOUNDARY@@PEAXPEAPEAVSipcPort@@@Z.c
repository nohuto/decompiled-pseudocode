/*
 * XREFs of ?CreateServerPort@AlpcPort@@SAJAEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@PEAXPEAPEAVSipcPort@@@Z @ 0x180078A8C
 * Callers:
...
LABEL_24:
  ...
  AlpcPortString::AlpcPortString(v18, &xmmword_1801FE718, 1LL);
