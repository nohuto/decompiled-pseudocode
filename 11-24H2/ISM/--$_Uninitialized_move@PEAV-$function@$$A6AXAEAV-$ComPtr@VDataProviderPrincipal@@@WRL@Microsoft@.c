      ...
      if ( v6 )
      {
        if ( v6 == v5 + v3 )
        {
          *(_QWORD *)(v3 + 56) = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 8LL))(v6, v3);
          std::_Func_class<void,>::~_Func_class<void,>(v5 + v3, v7);
        }
        else
        {
          *(_QWORD *)(v3 + 56) = v6;
