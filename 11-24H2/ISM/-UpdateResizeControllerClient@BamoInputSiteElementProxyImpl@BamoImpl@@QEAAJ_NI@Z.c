/*
 * XREFs of ?UpdateResizeControllerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003E8B0
 * Callers:
 *     ?Thunk_UpdateResizeControllerClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072A80 (-Thunk_UpdateResizeControllerClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
