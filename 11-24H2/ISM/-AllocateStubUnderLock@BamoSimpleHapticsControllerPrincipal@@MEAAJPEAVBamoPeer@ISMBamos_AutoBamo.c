/*
 * XREFs of ?AllocateStubUnderLock@BamoSimpleHapticsControllerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSimpleHapticsControllerStub@@@Z @ 0x180184D70
 * Callers:
 *     <none>
 * Callees:
