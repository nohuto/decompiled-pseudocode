/*
 * XREFs of ?LogOnTestCommandsChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x18011A00C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnTestCommandsChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
