/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180077160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoControllerNavigationManagerStubImpl::InitializeProxyUnderLockThunk(
