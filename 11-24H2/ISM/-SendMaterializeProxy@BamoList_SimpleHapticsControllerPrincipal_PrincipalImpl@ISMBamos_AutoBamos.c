/*
 * XREFs of ?SendMaterializeProxy@BamoList_SimpleHapticsControllerPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@36@@Z @ 0x18018D7B0
 * Callers:
 *     <none>
 * Callees:
