/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800A2520
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_18024E710);
      v9 = &stru_18024E710;
      if ( qword_18024E780
        || ((qword_18024E780 = 0LL,
            ...
            !v8) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_18024E738,
          this,
          (void (*)(void *))a2,
          a3);
      }
