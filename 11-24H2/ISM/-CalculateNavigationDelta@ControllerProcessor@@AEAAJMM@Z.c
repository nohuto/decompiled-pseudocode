/*
 * XREFs of ?CalculateNavigationDelta@ControllerProcessor@@AEAAJMM@Z @ 0x180179C2C
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculateNavigationDelta(ControllerProcessor *this, double a2, double a3)
{
  ...
  v17 = _mm_shuffle_ps((__m128)*((unsigned int *)this + 1947), (__m128)*((unsigned int *)this + 1947), 0);
