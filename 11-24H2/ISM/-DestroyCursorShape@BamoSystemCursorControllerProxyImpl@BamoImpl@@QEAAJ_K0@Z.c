/*
 * XREFs of ?DestroyCursorShape@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1801165D0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerProxyImpl::DestroyCursorShape(
        ...
        unsigned __int64 a3)
{
  ...
  else
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      BamoImpl::BamoSystemCursorControllerProxyImpl::LogSendDestroyCursorShape(this, a2, a3);
