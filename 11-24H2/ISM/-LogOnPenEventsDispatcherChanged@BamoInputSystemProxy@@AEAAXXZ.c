/*
 * XREFs of ?LogOnPenEventsDispatcherChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x1801195F4
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnPenEventsDispatcherChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
