/*
 * XREFs of ?EndWinKeyScenario@WinKeyScenarioTelemetry@@SAXXZ @ 0x1800246D4
 * Callers:
...
void WinKeyScenarioTelemetry::EndWinKeyScenario(void)
{
  ...
  {
    if ( (unsigned int)dword_18024E2B8 > 5 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_18024E2B8, 0x400000000000LL, v0) )
      {
        LowPart = WinKeyScenarioTelemetry::s_startTime.LowPart;
        v5 = 0x2000000LL;
        _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>>(
          v1,
          (__int64)&unk_180215365,
          v2,
          v3,
          (__int64)&v5,
          (__int64)&LowPart);
