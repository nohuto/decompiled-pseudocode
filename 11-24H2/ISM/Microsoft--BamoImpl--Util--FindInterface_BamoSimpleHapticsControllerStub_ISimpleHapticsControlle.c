/*
 * XREFs of Microsoft::BamoImpl::Util::FindInterface_BamoSimpleHapticsControllerStub_ISimpleHapticsControllerStub_ @ 0x18018454C
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186450 (-QueryInterface@BamoSimpleHapticsControllerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
