/*
 * XREFs of ?TelemetryDdiDevice_Added_@RawInputProvidersTracing@@QEAAXKW4InputType@@QEBG@Z @ 0x1800D94FC
 * Callers:
 ...
 *     ??1SpatialInputTelemetryProperties@RawInputProvidersTracing@@QEAA@XZ @ 0x1800D5458 (--1SpatialInputTelemetryProperties@RawInputProvidersTracing@@QEAA@XZ.c)
 */
