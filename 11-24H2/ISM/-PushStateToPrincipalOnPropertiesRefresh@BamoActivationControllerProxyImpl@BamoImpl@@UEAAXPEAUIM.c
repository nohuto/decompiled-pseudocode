/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x1800B04B0
 * Callers:
 *     <none>
 * Callees:
