/*
 * XREFs of ?RemoteReplace@BamoList_DisplayOcclusionRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x18013F9D0
 * Callers:
 *     ?CallRemoteReplaceOnStub@BamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@IAEBUDisplayOcclusionRect@@@Z @ 0x18013D038 (-CallRemoteReplaceOnStub@BamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl.c)
        ...
        const char *a4)
{
  ...
  unsigned int v35; // [rsp+130h] [rbp+30h] BYREF
  unsigned int v36; // [rsp+148h] [rbp+48h] BYREF
  ...
  if ( *((_BYTE *)this + 56) )
  {
    ...
    if ( v9 >= 0 )
    {
      Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_DisplayOcclusionRect_StubImpl::LogSendRemoteReplace(
        this,
        a2,
        v10);
      v12 = *((_OWORD *)a3 + 1);
