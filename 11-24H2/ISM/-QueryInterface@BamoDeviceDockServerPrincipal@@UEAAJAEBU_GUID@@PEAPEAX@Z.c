/*
 * XREFs of ?QueryInterface@BamoDeviceDockServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180180B60
 * Callers:
 *     ?QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180180BF0 (-QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
