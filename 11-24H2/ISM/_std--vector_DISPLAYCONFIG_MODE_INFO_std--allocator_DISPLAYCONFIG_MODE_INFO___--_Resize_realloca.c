/*
 * XREFs of _std::vector_DISPLAYCONFIG_MODE_INFO_std::allocator_DISPLAYCONFIG_MODE_INFO___::_Resize_reallocate_std::_Value_init_tag__::_1_::catch$0 @ 0x1801D703C
 * Callers:
 *     <none>
 * Callees:
