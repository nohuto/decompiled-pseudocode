/*
 * XREFs of ?AllocateStubUnderLock@BamoDataSourcePrincipal@@MEAAJPEAVBamoPeer@dataprovider_AutoBamos@@PEAPEAVBamoDataSourceStub@@@Z @ 0x180100D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourcePrincipal::AllocateStubUnderLock(
