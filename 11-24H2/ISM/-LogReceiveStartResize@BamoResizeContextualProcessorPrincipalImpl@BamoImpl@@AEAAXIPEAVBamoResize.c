/*
 * XREFs of ?LogReceiveStartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014F3F4
 * Callers:
