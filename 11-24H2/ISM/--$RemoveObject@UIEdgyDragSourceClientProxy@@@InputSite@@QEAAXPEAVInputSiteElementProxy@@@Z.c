/*
 * XREFs of ??$RemoveObject@UIEdgyDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005DB18
 * Callers:
...
void __fastcall InputSite::RemoveObject<IEdgyDragSourceClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_16f035d0_c76e_c74b_17e4_659414948133, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
