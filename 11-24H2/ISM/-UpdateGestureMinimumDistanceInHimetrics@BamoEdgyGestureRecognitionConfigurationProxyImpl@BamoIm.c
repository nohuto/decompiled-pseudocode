/*
 * XREFs of ?UpdateGestureMinimumDistanceInHimetrics@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180128D14
 * Callers:
 *     ?Thunk_UpdateGestureMinimumDistanceInHimetrics_8@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801267C0 (-Thunk_UpdateGestureMinimumDistanceInHimetrics_8@-$IEdgyGestureRecognitionConfigurationProxy_Rec.c)
