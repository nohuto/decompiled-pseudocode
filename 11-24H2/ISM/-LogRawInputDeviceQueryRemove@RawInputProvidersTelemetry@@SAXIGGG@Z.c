/*
 * XREFs of ?LogRawInputDeviceQueryRemove@RawInputProvidersTelemetry@@SAXIGGG@Z @ 0x1800E0038
 * Callers:
 *     ?OnDeviceQueryRemove@HIDDeviceCollection@@MEAAJK@Z @ 0x1800E0190 (-OnDeviceQueryRemove@HIDDeviceCollection@@MEAAJK@Z.c)
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$01@@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$01@@44@Z @ 0x180004338 (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapperByVal@$01@@U2@U2@@-$_tlgWriteTemplate@$$A6AJPEBU.c)
 *     _tlgKeywordOn @ 0x180031A40 (_tlgKeywordOn.c)
 *     ?Provider@RawInputProvidersTelemetry@@SAPEBU_tlgProvider_t@@XZ @ 0x1800E0290 (-Provider@RawInputProvidersTelemetry@@SAPEBU_tlgProvider_t@@XZ.c)
 */
