/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoDockableDeviceStubImpl@BamoImpl@@UEAAJXZ @ 0x18017FCC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDockableDeviceStubImpl::OnConnectedUnderLockThunk(
