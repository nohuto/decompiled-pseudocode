/*
 * XREFs of ?ResetState@SystemCursor2@@QEAAJXZ @ 0x1800FAC84
 * Callers:
 ...
 *     ?GetEffectiveVisibiltyState@SystemCursor2@@AEBA_NXZ @ 0x1800FA360 (-GetEffectiveVisibiltyState@SystemCursor2@@AEBA_NXZ.c)
