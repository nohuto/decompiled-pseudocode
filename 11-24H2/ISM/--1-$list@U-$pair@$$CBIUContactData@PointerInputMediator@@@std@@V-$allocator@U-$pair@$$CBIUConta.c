/*
 * XREFs of ??1?$list@U?$pair@$$CBIUContactData@PointerInputMediator@@@std@@V?$allocator@U?$pair@$$CBIUContactData@PointerInputMediator@@@std@@@2@@std@@QEAA@XZ @ 0x180065C8C
 * Callers:
 *     _PointerInputMediator::PointerFrame::PointerFrame_::_1_::dtor$4 @ 0x1801CFDC4 (_PointerInputMediator--PointerFrame--PointerFrame_--_1_--dtor$4.c)
 *     _PointerInputMediator::PointerFrame::PointerFrame_::_1_::dtor$4_0 @ 0x1801D39A0 (_PointerInputMediator--PointerFrame--PointerFrame_--_1_--dtor$4_0.c)
 * Callees:
