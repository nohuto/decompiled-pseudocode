/*
 * XREFs of ?LogSetPrimaryUsagePage@BamoDockableDevicePrincipalImpl@BamoImpl@@AEAAXG@Z @ 0x18017FBAC
 * Callers:
...
void __fastcall BamoImpl::BamoDockableDevicePrincipalImpl::LogSetPrimaryUsagePage(
