/*
 * XREFs of ?LogSetDisplayOcclusionLogicalRange@BamoDockDevicePrincipalImpl@BamoImpl@@AEAAXAEBUtagRECT@@@Z @ 0x18017F984
 * Callers:
...
void __fastcall BamoImpl::BamoDockDevicePrincipalImpl::LogSetDisplayOcclusionLogicalRange(
        ...
        const struct tagRECT *a2)
{
  ...
  __int64 v4; // r8
  __int64 v5; // r9
  const struct tagRECT *v6; // [rsp+48h] [rbp+10h] BYREF
