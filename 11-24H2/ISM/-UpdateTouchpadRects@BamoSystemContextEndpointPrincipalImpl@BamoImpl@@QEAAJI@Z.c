/*
 * XREFs of ?UpdateTouchpadRects@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800AB8D4
 * Callers:
 *     ?Thunk_UpdateTouchpadRects_8@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800AB6F0 (-Thunk_UpdateTouchpadRects_8@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpoin.c)
 * Callees:
        ...
        BamoImpl::BamoSystemContextEndpointPrincipalImpl *this)
{
  ...
  struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Proxy *v8; // r14
  ...
  {
    BamoSystemContextEndpointPrincipal::LogOnTouchpadRectsChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*((_QWORD *)this + 2) + 32LL),
      ...
      1);
    v13 = (*(__int64 (__fastcall **)(char *, __int64, struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Proxy *))(*((_QWORD *)this - 2) + 88LL))(
            (char *)this - 16,
            (__int64)v5 - 16,
            v8);
    if ( v13 < 0 )
  ...
  *((_QWORD *)v5 + 9) = v8;
  if ( v8 )
    (**(void (__fastcall ***)(struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Proxy *))v8)(v8);
  if ( v14 )
  ...
  if ( *((_BYTE *)v5 + 57) && *((int *)this + 2) > 0 )
  {
    BamoSystemContextEndpointPrincipal::LogOnTouchpadRectsChanged(
      (struct Microsoft::BamoImpl::ConnectionIndirector **)this - 2,
      (struct Microsoft::BamoImpl::BamoStubImpl *)((char *)v5 - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      (__int64)v16,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*((_QWORD *)this + 2) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v15 = (*(__int64 (__fastcall **)(char *, __int64))(*((_QWORD *)this - 2) + 96LL))(
            (char *)this - 16,
            (__int64)v5 - 16);
    if ( v15 < 0 )
      wil::details::in1diag3::FailFast_Hr(
