/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011EAD0
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126360 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
 ...
 *     ??0BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAA@XZ @ 0x18011426C (--0BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAA@XZ.c)
