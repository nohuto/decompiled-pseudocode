/*
 * XREFs of ?LogSendUIAHitTestResponse@BamoUIAHitTestStubImpl@BamoImpl@@AEAAXAEBU_GUID@@@Z @ 0x1801B7124
 * Callers:
        ...
        const struct _GUID *a2)
{
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    v15 = a2;
    v16 = 16;
    tlgWriteTransfer_EventWriteTransfer(v2, byte_180226CC4, 0LL, 0LL, 5u, &v8);
  }
}
