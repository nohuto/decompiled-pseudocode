/*
 * XREFs of ?push_back@?$vector@UAttachedInputObjectEntry@InputSite@@V?$allocator@UAttachedInputObjectEntry@InputSite@@@std@@@std@@QEAAX$$QEAUAttachedInputObjectEntry@InputSite@@@Z @ 0x180037E54
 * Callers:
