/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_MenuFix@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18017B900
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_MenuFix>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v10 = a4;
  v5 = a2;
  LODWORD(v6) = *(_DWORD *)Feature_Input_DesktopNavigationGamepad_MenuFix__descriptor;
  if ( (*(_DWORD *)Feature_Input_DesktopNavigationGamepad_MenuFix__descriptor & 4) == 0 )
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_MenuFix>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v7);
    v10 = v6;
  }
