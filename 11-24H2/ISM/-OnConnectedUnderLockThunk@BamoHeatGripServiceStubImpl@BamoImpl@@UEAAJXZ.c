/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoHeatGripServiceStubImpl@BamoImpl@@UEAAJXZ @ 0x18006E380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHeatGripServiceStubImpl::OnConnectedUnderLockThunk(
