/*
 * XREFs of ??4?$ComPtr@VBamoDragManagerClientProxy@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z @ 0x18014A934
 * Callers:
        ...
        _QWORD *a2))(_QWORD)
{
  ...
  if ( *a1 != (__int64 (__fastcall ***)(_QWORD))*a2 )
  {
    ...
    v5 = *a1;
    *a1 = v2;
    Microsoft::WRL::ComPtr<DataProviderRegistrarProxy>::InternalRelease((__int64 *)&v5);
  }
  return a1;
}
