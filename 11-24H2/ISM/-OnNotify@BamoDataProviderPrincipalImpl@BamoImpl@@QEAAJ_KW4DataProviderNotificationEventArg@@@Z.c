/*
 * XREFs of ?OnNotify@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x180102EBC
 * Callers:
 *     ?Thunk_OnNotify_8@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105960 (-Thunk_OnNotify_8@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SA.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataProviderPrincipalImpl::OnNotify(int *a1, __int64 a2, unsigned int a3)
{
  int v6; // edi
  ...
  if ( a1[2] > 0 )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(int *, __int64, __int64, _QWORD))(*((_QWORD *)a1 - 2) + 136LL))(a1 - 4, v8, a2, a3);
    v6 = v11;
    if ( v11 == -2018375668 )
    {
