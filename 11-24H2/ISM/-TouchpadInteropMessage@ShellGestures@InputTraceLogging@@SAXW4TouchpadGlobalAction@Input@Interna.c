/*
 * XREFs of ?TouchpadInteropMessage@ShellGestures@InputTraceLogging@@SAXW4TouchpadGlobalAction@Input@Internal@UI@Windows@@@Z @ 0x18015A564
 * Callers:
              ...
              if ( v7 )
              {
                ...
                if ( v8 )
                {
                  ...
                  if ( v9 )
                  {
                    ...
                    {
                      if ( v10 == 1 )
                        v11 = "FiveFingerRelease";
                      else
                        v11 = "UNKNOWN";
                    }
                    else
                    {
                      v11 = "FourFingerRelease";
                    }
                  }
                  else
                  {
                    v11 = "ThreeFingerRelease";
                  }
                }
                else
                {
