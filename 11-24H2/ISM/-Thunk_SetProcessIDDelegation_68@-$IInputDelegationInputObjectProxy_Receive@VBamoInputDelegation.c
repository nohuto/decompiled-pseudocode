/*
 * XREFs of ?Thunk_SetProcessIDDelegation_68@?$IInputDelegationInputObjectProxy_Receive@VBamoInputDelegationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801342F0
 * Callers:
 *     <none>
 * Callees:
