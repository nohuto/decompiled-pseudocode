/*
 * XREFs of ?LogSendOnInputDelegated@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@AEAAXII_N@Z @ 0x180133738
 * Callers:
        ...
        int a2)
{
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    v20 = v3 + 3;
    v17 = v3 + 3;
    tlgWriteTransfer_EventWriteTransfer(v6, byte_18021CFA6, 0LL, 0LL, 7u, &v15);
  }
}
