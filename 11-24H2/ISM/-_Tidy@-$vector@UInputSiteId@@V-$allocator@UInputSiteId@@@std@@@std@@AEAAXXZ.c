/*
 * XREFs of ?_Tidy@?$vector@UInputSiteId@@V?$allocator@UInputSiteId@@@std@@@std@@AEAAXXZ @ 0x180037DE8
 * Callers:
...
void __fastcall std::vector<InputSiteId>::_Tidy(__int64 a1)
{
  char *v2; // rcx
