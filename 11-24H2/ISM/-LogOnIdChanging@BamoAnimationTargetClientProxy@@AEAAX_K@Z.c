/*
 * XREFs of ?LogOnIdChanging@BamoAnimationTargetClientProxy@@AEAAX_K@Z @ 0x1801460B0
 * Callers:
...
void __fastcall BamoAnimationTargetClientProxy::LogOnIdChanging(BamoAnimationTargetClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
