/*
 * XREFs of ?LogOnDisplayOcclusionSupportedChanged@BamoDockDeviceProxy@@AEAAXXZ @ 0x180117CA0
 * Callers:
...
void __fastcall BamoDockDeviceProxy::LogOnDisplayOcclusionSupportedChanged(BamoDockDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
