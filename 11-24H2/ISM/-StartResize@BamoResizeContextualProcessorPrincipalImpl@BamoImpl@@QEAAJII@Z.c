/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x18014F834
 * Callers:
 *     ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014FA30 (-Thunk_StartResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcess.c)
 * Callees:
