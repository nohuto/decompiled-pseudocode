/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKUTargetingInfo@Win32kInterop@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18001C450
 * Callers:
 *     _std::unordered_map_unsigned_long_Win32kInterop::TargetingInfo_std::hash_unsigned_long__std::equal_to_unsigned_long__std::allocator_std::pair_unsigned_long_const__Win32kInterop::TargetingInfo_____::try_emplace___::_1_::dtor$0 @ 0x1801D1490 (_std--unordered_map_unsigned_long_Win32kInterop--TargetingInfo_std--hash_unsigned_long__std--equ.c)
 *     _Win32kInterop::DoConvergedHitTestCallback_::_1_::dtor$1 @ 0x1801D1850 (_Win32kInterop--DoConvergedHitTestCallback_--_1_--dtor$1.c)
 * Callees:
