/*
 * XREFs of ?UpdateEnabled@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180177FB4
 * Callers:
 *     ?Thunk_UpdateEnabled_11@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180177C90 (-Thunk_UpdateEnabled_11@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
