/*
 * XREFs of ?UpdateIsIntensitySupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012A9B8
 * Callers:
 *     ?Thunk_UpdateIsIntensitySupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801269F0 (-Thunk_UpdateIsIntensitySupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsC.c)
