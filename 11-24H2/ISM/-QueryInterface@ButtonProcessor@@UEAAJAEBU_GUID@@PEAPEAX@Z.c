/*
 * XREFs of ?QueryInterface@ButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CCF0
 * Callers:
 *     ?QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B7B40 (-QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
