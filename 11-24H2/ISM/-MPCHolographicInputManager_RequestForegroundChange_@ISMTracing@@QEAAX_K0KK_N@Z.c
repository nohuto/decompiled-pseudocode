/*
 * XREFs of ?MPCHolographicInputManager_RequestForegroundChange_@ISMTracing@@QEAAX_K0KK_N@Z @ 0x1800BAD28
 * Callers:
        ...
        bool a6)
{
  ...
  if ( ISMTracing::IsEnabled() )
  {
    ...
    if ( *(_DWORD *)v9 > 4u && tlgKeywordOn((__int64)v9, 1LL) )
    {
      ...
      v16 = a3;
      v17 = a2;
      tlgWriteTransfer_EventWriteTransfer(v12, byte_180210588, 0LL, 0LL, 7u, &v18);
    }
  }
}
