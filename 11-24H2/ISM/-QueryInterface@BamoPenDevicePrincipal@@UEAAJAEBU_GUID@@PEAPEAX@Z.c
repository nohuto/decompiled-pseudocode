/*
 * XREFs of ?QueryInterface@BamoPenDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180191110
 * Callers:
 *     ?QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801911A0 (-QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
