/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Standalone_25_05_NonSec@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800C9FFC
 * Callers:
        ...
        __int64 a4)
{
  ...
  v9 = a4;
  v5 = *(_DWORD *)Feature_Standalone_25_05_NonSec__descriptor;
