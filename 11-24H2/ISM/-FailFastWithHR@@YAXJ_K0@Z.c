/*
 * XREFs of ?FailFastWithHR@@YAXJ_K0@Z @ 0x1801CB61C
 * Callers:
 ...
 *     ?OnProxyCreated@TextInputStateAdapter@@UEAAJPEAUIMessageProxy@@@Z @ 0x1801CDE00 (-OnProxyCreated@TextInputStateAdapter@@UEAAJPEAUIMessageProxy@@@Z.c)
