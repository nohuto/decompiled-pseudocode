/*
 * XREFs of ?StartAnimationReceived@InputGesture@InputETW@@SAXPEBGK@Z @ 0x18014384C
 * Callers:
...
void __fastcall InputETW::InputGesture::StartAnimationReceived(const unsigned __int16 *a1, unsigned int a2)
{
  __int64 v2; // rbx
