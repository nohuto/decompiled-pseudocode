/*
 * XREFs of ?CreateAndInitializeOutputBuffer@HidLampRangeUpdateReportParser@@QEAAJPEBULampRangeUpdateDeviceReport@@AEAV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@PEAI@Z @ 0x180062B40
 * Callers:
 ...
 *     ?InsertValue@HidChannelValueInfo@@QEAAJE_KPEAE@Z @ 0x180062D7C (-InsertValue@HidChannelValueInfo@@QEAAJE_KPEAE@Z.c)
 ...
 *     ?ValidateReportData@HidLampRangeUpdateReportParser@@AEAAJPEBULampRangeUpdateDeviceReport@@@Z @ 0x1800EEA88 (-ValidateReportData@HidLampRangeUpdateReportParser@@AEAAJPEBULampRangeUpdateDeviceReport@@@Z.c)
 */
