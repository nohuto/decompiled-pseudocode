/*
 * XREFs of ?Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_VirtualTouchpadRect_Proxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011F2C4
 * Callers:
 *     ?Thunk_Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_VirtualTouchpadRect_Proxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126570 (-Thunk_Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_VirtualTouchpadRect_Proxy_5@-$.c)
 * Callees:
