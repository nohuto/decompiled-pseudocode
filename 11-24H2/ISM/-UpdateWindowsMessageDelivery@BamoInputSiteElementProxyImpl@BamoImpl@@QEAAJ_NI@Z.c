/*
 * XREFs of ?UpdateWindowsMessageDelivery@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003EEAC
 * Callers:
 *     ?Thunk_UpdateWindowsMessageDelivery_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072550 (-Thunk_UpdateWindowsMessageDelivery_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
