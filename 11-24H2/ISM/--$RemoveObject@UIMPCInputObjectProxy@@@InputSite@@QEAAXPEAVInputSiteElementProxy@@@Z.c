/*
 * XREFs of ??$RemoveObject@UIMPCInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005F9D8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IMPCInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_9a5daf6a_38f8_287c_c758_186a8416bbfc, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
