/*
 * XREFs of ?QueryInterface@LightDismissProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067EB0
 * Callers:
 *     ?QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015CED0 (-QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
