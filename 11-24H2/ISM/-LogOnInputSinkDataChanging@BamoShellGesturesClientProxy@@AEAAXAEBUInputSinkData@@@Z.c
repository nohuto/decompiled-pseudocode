/*
 * XREFs of ?LogOnInputSinkDataChanging@BamoShellGesturesClientProxy@@AEAAXAEBUInputSinkData@@@Z @ 0x18015ADB4
 * Callers:
...
void __fastcall BamoShellGesturesClientProxy::LogOnInputSinkDataChanging(
