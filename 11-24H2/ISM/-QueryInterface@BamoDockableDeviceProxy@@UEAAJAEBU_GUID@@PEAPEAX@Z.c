/*
 * XREFs of ?QueryInterface@BamoDockableDeviceProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121830
 * Callers:
 *     ?QueryInterface@BamoDockableDeviceProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801218C0 (-QueryInterface@BamoDockableDeviceProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
