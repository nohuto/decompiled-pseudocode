/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoEdgyControllerServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180074B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoEdgyControllerServerStubImpl::OnConnectedUnderLockThunk(
