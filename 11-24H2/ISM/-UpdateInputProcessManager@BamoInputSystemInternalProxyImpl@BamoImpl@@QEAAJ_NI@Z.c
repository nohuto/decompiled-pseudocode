/*
 * XREFs of ?UpdateInputProcessManager@BamoInputSystemInternalProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012A1F0
 * Callers:
 *     ?Thunk_UpdateInputProcessManager_8@?$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126980 (-Thunk_UpdateInputProcessManager_8@-$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalP.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSystemInternalProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012C480 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSystemInternalProxyImpl@BamoImpl@@UEAAXPEAV.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  struct BamoInputProcessManagerProxy *v7; // rsi
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemInternalProxy::LogOnInputProcessManagerChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct BamoInputProcessManagerProxy *))(*((_QWORD *)this - 2) + 104LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
  ...
  *((_QWORD *)this + 4) = v7;
  if ( v7 )
    (**(void (__fastcall ***)(struct BamoInputProcessManagerProxy *))v7)(v7);
  if ( v13 )
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemInternalProxy::LogOnInputProcessManagerChanged((BamoImpl::BamoInputSystemInternalProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
