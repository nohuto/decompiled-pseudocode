/*
 * XREFs of ??1?$ListPrincipalCommon@VBamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@V?$com_ptr_t@VBamoActivatableEntityPrincipal@@Uerr_returncode_policy@wil@@@wil@@@Bamo@Microsoft@@UEAA@XZ @ 0x1800AC620
 * Callers:
        ...
        const char *a4)
{
  ...
  if ( v5 )
  {
    ...
    std::_Deallocate<16,0>(
      *(char **)(a1 + 56),
      (const struct std::nothrow_t *)((*(_QWORD *)(a1 + 72) - *(_QWORD *)(a1 + 56)) & 0xFFFFFFFFFFFFFFF8uLL));
    *(_QWORD *)(a1 + 56) = 0LL;
    *(_QWORD *)(a1 + 64) = 0LL;
    *(_QWORD *)(a1 + 72) = 0LL;
  }
