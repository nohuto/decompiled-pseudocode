/*
 * XREFs of ?LogOnInputSiteIdChanging@BamoInputSiteElementProxy@@AEAAX_K@Z @ 0x18013049C
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnInputSiteIdChanging(BamoInputSiteElementProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
