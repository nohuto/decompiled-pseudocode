/*
 * XREFs of ?UpdateContactState@MagnifierRecognizer@@AEAAXPEBUPointerInputInfo@@@Z @ 0x1801AE580
 * Callers:
    ...
    if ( (*((_BYTE *)a2 + 144 * i + 332) & 4) != 0 )
    {
      ...
      if ( *(_BYTE *)(v20 + 25) || v6 < *(_DWORD *)(v20 + 32) || v20 == *((_QWORD *)this + 2) )
      {
        ...
        *((_QWORD *)&v21 + 1) = 0LL;
        ...
        LODWORD(v21) = *v7;
        DWORD1(v21) = *v8;
        v10 = *MagnifierRecognizer::TimeFromPerfCount((__int64)this, &v24, v9);
      ...
      *(_DWORD *)(v15 + 48) = *v7;
      *(_DWORD *)(v15 + 52) = *v8;
      *(_QWORD *)(v15 + 64) = *MagnifierRecognizer::TimeFromPerfCount((__int64)this, &v25, *((_QWORD *)a2 + 2));
    }
  }
  v16 = *((_DWORD *)this + 2);
