/*
 * XREFs of ??1?$unique_lock@Vmutex@std@@@std@@QEAA@XZ @ 0x1800707AC
 * Callers:
 ...
 *     _PointerInputMediator::RoutePointers_::_1_::dtor$0 @ 0x1801D2CCD (_PointerInputMediator--RoutePointers_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
