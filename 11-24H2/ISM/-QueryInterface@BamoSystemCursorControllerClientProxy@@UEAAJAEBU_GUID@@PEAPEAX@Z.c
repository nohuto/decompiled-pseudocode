/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801227E0
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180122870 (-QueryInterface@BamoSystemCursorControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
