/*
 * XREFs of ?OnDisconnectedThunk@BamoSystemContextEndpointStubImpl@BamoImpl@@UEAAJXZ @ 0x1800AAFD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextEndpointStubImpl::OnDisconnectedThunk(
  ...
  if ( *(int *)(v3 + 8) > 0 )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
      v3);
    v2 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v4 + 128LL))(v4, (char *)this - 16);
