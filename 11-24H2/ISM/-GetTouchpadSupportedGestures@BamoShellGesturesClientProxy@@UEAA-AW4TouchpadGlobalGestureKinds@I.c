/*
 * XREFs of ?GetTouchpadSupportedGestures@BamoShellGesturesClientProxy@@UEAA?AW4TouchpadGlobalGestureKinds@Input@Internal@UI@Windows@@XZ @ 0x180159970
 * Callers:
...
__int64 __fastcall BamoShellGesturesClientProxy::GetTouchpadSupportedGestures(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rdx
  __int64 v3; // r8
