/*
 * XREFs of ?OnResizeControllerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005EC80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIResizeControllerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005ECF8 (--$RemoveObject@UIResizeControllerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
