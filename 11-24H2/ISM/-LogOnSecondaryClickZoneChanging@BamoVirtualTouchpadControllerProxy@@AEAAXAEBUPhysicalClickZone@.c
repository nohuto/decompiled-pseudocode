/*
 * XREFs of ?LogOnSecondaryClickZoneChanging@BamoVirtualTouchpadControllerProxy@@AEAAXAEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x180135770
 * Callers:
...
void __fastcall BamoVirtualTouchpadControllerProxy::LogOnSecondaryClickZoneChanging(
