/*
 * XREFs of ??_GControllerProcessor@@MEAAPEAXI@Z @ 0x1801791B0
 * Callers:
 *     ??_EControllerProcessor@@OBA@EAAPEAXI@Z @ 0x1801791A0 (--_EControllerProcessor@@OBA@EAAPEAXI@Z.c)
 * Callees:
  ...
  if ( (a2 & 1) != 0 )
  {
    if ( (a2 & 4) != 0 )
      BamoImpl::BamoMPCConstantManagerClientProxyImpl::UpdateStateOfProxyOnPlaceholderProxyHookUp(
        this,
        (struct Microsoft::BamoImpl::BamoProxyImpl *)0x1E88);
    else
      free(this);
  }
  return this;
