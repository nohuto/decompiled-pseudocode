/*
 * XREFs of ?LogOnGestureServicesChanging@BamoInputSystemProxy@@AEAAXPEAVBamoGestureServicesProxy@@@Z @ 0x1801184C4
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnGestureServicesChanging(
        BamoInputSystemProxy *this,
        struct BamoGestureServicesProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
