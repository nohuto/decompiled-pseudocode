/*
 * XREFs of ?ManualResizeCancelled@BamoManualResizeAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18014E9E0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoManualResizeAreaClientProxyImpl::ManualResizeCancelled(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      BamoImpl::BamoManualResizeAreaClientProxyImpl::LogSendManualResizeCancelled(this);
      v11[0] = v13;
      v11[1] = v14;
