/*
 * XREFs of ??1?$ListPrincipalCommon@VBamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@UDisplayOcclusionRect@@@Bamo@Microsoft@@UEAA@XZ @ 0x18013BDA4
 * Callers:
        ...
        __int64 a1)
{
  ...
  std::vector<DisplayOcclusionRect>::_Tidy(a1 + 56);
