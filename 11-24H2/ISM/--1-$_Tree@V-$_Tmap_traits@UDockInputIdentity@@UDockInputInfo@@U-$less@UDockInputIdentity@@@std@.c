/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UDockInputInfo@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UDockInputInfo@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x18017F0F0
 * Callers:
 *     ??1?$map@UDockInputIdentity@@UDockInputInfo@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UDockInputInfo@@@std@@@4@@std@@QEAA@XZ @ 0x18017F18C (--1-$map@UDockInputIdentity@@UDockInputInfo@@U-$less@UDockInputIdentity@@@std@@V-$allocator@U-$p.c)
