/*
 * XREFs of ?LogOnTypeChanging@BamoEdgyDragSourceClientProxy@@AEAAXAEBU_GUID@@@Z @ 0x18011A478
 * Callers:
...
void __fastcall BamoEdgyDragSourceClientProxy::LogOnTypeChanging(
