/*
 * XREFs of ?CheckForShellGesture@ShellGesturesRecognizer@@AEAAXAEAURecognitionState@1@_N@Z @ 0x18006624C
 * Callers:
      ...
      if ( *((_DWORD *)this + 24) == 1 )
      {
        if ( a3 )
        {
          ...
          if ( (int)((v21[4] - v22) * (v21[4] - v22)
                   + (HIDWORD(v21[4]) - HIDWORD(v22)) * (HIDWORD(v21[4]) - HIDWORD(v22))) >= (unsigned __int64)(unsigned int)(dword_1802500F8 * dword_1802500F8) )
          {
            *((_DWORD *)a2 + 1) = 2;
LABEL_46:
            *(_DWORD *)a2 = 1;
      ...
      else if ( *((_DWORD *)this + 24) == 2 )
      {
        if ( a3 )
        {
          ...
          for ( k = (_QWORD *)*v17; k != v17; k = (_QWORD *)*k )
          {
            ...
            if ( *((_BYTE *)this + 216) )
            {
              if ( v19 >= 1000000 * qword_180250108 )
                goto LABEL_29;
            }
            else if ( v19 >= 1000000 * qword_180250100 )
            {
              *((_DWORD *)a2 + 1) = 3;
              goto LABEL_46;
            }
            v20 = k[3];
            if ( (int)((k[4] - v20) * (k[4] - v20) + (HIDWORD(k[4]) - HIDWORD(v20)) * (HIDWORD(k[4]) - HIDWORD(v20))) >= (unsigned __int64)(unsigned int)(dword_180250110 * dword_180250110) )
            {
              *((_DWORD *)a2 + 1) = 4;
              goto LABEL_46;
            }
...
LABEL_29:
    ...
    if ( (unsigned int)dword_18024E248 > 5 && tlgKeywordOn((__int64)&dword_18024E248, 0x200000000000LL) )
    {
      v28 = *((_DWORD *)this + 24);
      if ( v24 )
      {
