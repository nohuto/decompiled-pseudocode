/*
 * XREFs of ?SetTouchpadDevices@BamoHapticDeviceManagerPrincipal@@UEAAXPEAVBamoList_SimpleHapticsControllerPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x18018DB10
 * Callers:
...
void __fastcall BamoHapticDeviceManagerPrincipal::SetTouchpadDevices(
        ...
        struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerPrincipal_Principal *a2)
{
  ...
  BamoImpl::BamoHapticDeviceManagerPrincipalImpl::LogSetTouchpadDevices(
  ...
  for ( i = v3[4]; ; i = *(_QWORD *)(i + 40) )
  {
    ...
    if ( *(_BYTE *)(i + 56) )
    {
      updated = BamoImpl::BamoHapticDeviceManagerPrincipalImpl::UpdateTouchpadDevicesRemoteCacheStatic(
