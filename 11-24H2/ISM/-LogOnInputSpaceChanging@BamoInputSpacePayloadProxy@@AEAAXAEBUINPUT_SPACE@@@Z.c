/*
 * XREFs of ?LogOnInputSpaceChanging@BamoInputSpacePayloadProxy@@AEAAXAEBUINPUT_SPACE@@@Z @ 0x180118F4C
 * Callers:
...
void __fastcall BamoInputSpacePayloadProxy::LogOnInputSpaceChanging(
        ...
        const struct INPUT_SPACE *a2)
{
  ...
  __int64 v3; // r8
  __int64 v4; // r9
  const struct INPUT_SPACE *v5; // [rsp+48h] [rbp+10h] BYREF
