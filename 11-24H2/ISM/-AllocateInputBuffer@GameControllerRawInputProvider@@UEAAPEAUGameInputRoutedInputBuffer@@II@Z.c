/*
 * XREFs of ?AllocateInputBuffer@GameControllerRawInputProvider@@UEAAPEAUGameInputRoutedInputBuffer@@II@Z @ 0x180060E70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  {
    wil::details::in1diag3::_Log_NullAlloc(retaddr, (void *)0x13A, v7, v8);
    return 0LL;
  }
}
