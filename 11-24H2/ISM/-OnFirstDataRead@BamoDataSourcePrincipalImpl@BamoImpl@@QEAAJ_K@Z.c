/*
 * XREFs of ?OnFirstDataRead@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180096B84
 * Callers:
 *     ?Thunk_OnFirstDataRead_0@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105940 (-Thunk_OnFirstDataRead_0@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@.c)
 * Callees:
