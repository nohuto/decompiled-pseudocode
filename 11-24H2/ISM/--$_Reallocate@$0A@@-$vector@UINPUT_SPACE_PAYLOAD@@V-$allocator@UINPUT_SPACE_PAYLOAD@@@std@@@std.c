/*
 * XREFs of ??$_Reallocate@$0A@@?$vector@UINPUT_SPACE_PAYLOAD@@V?$allocator@UINPUT_SPACE_PAYLOAD@@@std@@@std@@AEAAXAEA_K@Z @ 0x1800AA728
 * Callers:
...
__int64 __fastcall std::vector<INPUT_SPACE_PAYLOAD>::_Reallocate<0>(__int64 a1, unsigned __int64 *a2)
{
  ...
  {
    std::_Deallocate<16,0>(v13, (const struct std::nothrow_t *)(24 * *a2));
    throw;
  }
