/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801410A0
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180141130 (-QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
