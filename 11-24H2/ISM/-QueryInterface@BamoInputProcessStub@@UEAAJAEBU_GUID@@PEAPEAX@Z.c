/*
 * XREFs of ?QueryInterface@BamoInputProcessStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC920
 * Callers:
 *     ?QueryInterface@BamoInputProcessStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC9B0 (-QueryInterface@BamoInputProcessStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
