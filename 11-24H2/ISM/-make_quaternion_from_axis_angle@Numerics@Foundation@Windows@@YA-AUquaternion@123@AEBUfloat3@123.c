/*
 * XREFs of ?make_quaternion_from_axis_angle@Numerics@Foundation@Windows@@YA?AUquaternion@123@AEBUfloat3@123@M@Z @ 0x1800C7890
 * Callers:
 ...
 * Callees:
 *     cosf @ 0x18009D4CC (cosf.c)
 *     _o_sinf_0 @ 0x18009D514 (_o_sinf_0.c)
 */
