/*
 * XREFs of ??4PointerFrame@PointerInputMediator@@QEAAAEAU01@$$QEAU01@@Z @ 0x180015BF8
 * Callers:
 ...
 * Callees:
 *     ??4?$vector@IV?$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x180098404 (--4-$vector@IV-$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z.c)
