/*
 * XREFs of ?DestroyCursorShape@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800F6D90
 * Callers:
 *     ?Thunk_DestroyCursorShape_404@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F8140 (-Thunk_DestroyCursorShape_404@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorContro.c)
 * Callees:
        ...
        unsigned __int64 a3)
{
  ...
  BamoImpl::BamoSystemCursorControllerPrincipalImpl::LogReceiveDestroyCursorShape(this, a2, a3);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v9,
      (__int64)this);
    v10 = (*(__int64 (__fastcall **)(char *, __int64, unsigned __int64, unsigned __int64))(*((_QWORD *)this - 2) + 160LL))(
            (char *)this - 16,
            v8,
            a2,
            a3);
