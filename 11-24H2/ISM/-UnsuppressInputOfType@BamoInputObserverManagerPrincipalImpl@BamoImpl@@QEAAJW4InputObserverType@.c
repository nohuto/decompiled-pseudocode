/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180138F80
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_264@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180138DB0 (-Thunk_UnsuppressInputOfType_264@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
