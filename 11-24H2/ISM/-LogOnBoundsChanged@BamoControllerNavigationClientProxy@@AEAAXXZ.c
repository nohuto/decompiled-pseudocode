/*
 * XREFs of ?LogOnBoundsChanged@BamoControllerNavigationClientProxy@@AEAAXXZ @ 0x18017711C
 * Callers:
...
void __fastcall BamoControllerNavigationClientProxy::LogOnBoundsChanged(BamoControllerNavigationClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
