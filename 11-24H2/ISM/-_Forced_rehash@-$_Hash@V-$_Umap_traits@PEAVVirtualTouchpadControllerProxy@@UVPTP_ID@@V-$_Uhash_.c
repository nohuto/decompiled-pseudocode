 ...
 *     ??1_Clear_guard@?$_Hash@V?$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V?$_Uhash_compare@PEAVVirtualTouchpadControllerProxy@@U?$hash@PEAVVirtualTouchpadControllerProxy@@@std@@U?$equal_to@PEAVVirtualTouchpadControllerProxy@@@3@@std@@V?$allocator@U?$pair@QEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x180134CC8 (--1_Clear_guard@-$_Hash@V-$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V-$_Uhash_.c)
 */
        ...
        unsigned __int64 a2)
{
  ...
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,ResizeProcessor::MessageInfo>>>>>>::_Assign_grow(
    (__int64)&qword_180250EC8,
    2 * v5,
    qword_180250EB8);
  v7 = v5 - 1;
  qword_180250EE8 = v5;
  qword_180250EE0 = v5 - 1;
  v8 = *(const unsigned __int8 **)qword_180250EB8;
  v9 = *(const unsigned __int8 **)qword_180250EB8;
  while ( v8 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_180250EC8;
    v14 = 2 * (v7 & appended);
    if ( *(_QWORD *)(qword_180250EC8 + 16 * (v7 & appended)) == v3 )
    {
      *(_QWORD *)(qword_180250EC8 + 16 * (v7 & appended)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    v15 = *(__int64 **)(qword_180250EC8 + 16 * (v7 & appended) + 8);
    v6 = *v11;
    ...
    {
      v19 = (__int64 **)(v15 + 1);
      if ( *(__int64 **)(qword_180250EC8 + 8 * v14) == v15 )
        break;
      v15 = *v19;
      if ( v6 == (__int64 **)(*v19)[2] )
      {
