/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F7C20
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F7CB0 (-QueryInterface@BamoSystemCursorControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
