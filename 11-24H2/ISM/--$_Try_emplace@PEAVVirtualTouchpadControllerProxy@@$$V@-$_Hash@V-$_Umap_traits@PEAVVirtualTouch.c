        ...
        unsigned __int8 *a3)
{
  ...
  {
    if ( qword_180250EC0 == 0x7FFFFFFFFFFFFFFLL )
      std::_Xlength_error("unordered_map/set too long");
    v16[0] = &qword_180250EB8;
    v7 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x20uLL);
    v16[1] = v7;
    v7[2] = *(_QWORD *)a3;
    *((_DWORD *)v7 + 6) = 0;
    v8 = qword_180250EC0 + 1;
    if ( qword_180250EC0 + 1 < 0 )
      v9 = (float)(int)(v8 & 1 | (v8 >> 1)) + (float)(int)(v8 & 1 | (v8 >> 1));
    else
      v9 = (float)(int)v8;
    v10 = qword_180250EE8;
    if ( qword_180250EE8 < 0 )
    {
      v10 = qword_180250EE8 & 1;
      v11 = (float)(int)(v10 | ((unsigned __int64)qword_180250EE8 >> 1))
          + (float)(int)(v10 | ((unsigned __int64)qword_180250EE8 >> 1));
    }
    else
    {
      v11 = (float)(int)qword_180250EE8;
    }
