/*
 * XREFs of ?ManualResizeEnded@BamoManualResizeAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18014EB70
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoManualResizeAreaClientProxyImpl::LogSendManualResizeEnded(this);
      v11[0] = v13;
      v11[1] = v14;
