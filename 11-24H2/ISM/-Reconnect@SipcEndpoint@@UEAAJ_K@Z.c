/*
 * XREFs of ?Reconnect@SipcEndpoint@@UEAAJ_K@Z @ 0x18010FF30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1SipcPrivateNamespace@@QEAA@XZ @ 0x18010CE40 (--1SipcPrivateNamespace@@QEAA@XZ.c)
 ...
 *     ?DisableSectionEvents@SipcPort@@QEAAXXZ @ 0x18010EAD0 (-DisableSectionEvents@SipcPort@@QEAAXXZ.c)
 *     ?IncreaseSectionEventCount@SipcPort@@AEAAXI@Z @ 0x18010F4C0 (-IncreaseSectionEventCount@SipcPort@@AEAAXI@Z.c)
 *     ?PopFront@?$NtList@VSipcSection@@@@QEAAPEAVSipcSection@@XZ @ 0x18010FBC0 (-PopFront@-$NtList@VSipcSection@@@@QEAAPEAVSipcSection@@XZ.c)
 *     ?PushBack@?$NtList@VSipcSection@@@@QEAAXPEAVSipcSection@@@Z @ 0x18010FD20 (-PushBack@-$NtList@VSipcSection@@@@QEAAXPEAVSipcSection@@@Z.c)
...
LABEL_12:
  ...
  ProxyEvents = AlpcPort::CreateClientPort(
                  (LARGE_INTEGER)(*((_QWORD *)this + 5) + 8LL),
