/*
 * XREFs of ?LogOnHWNDChanged@BamoActivationListenerInputObjectProxy@@AEAAXXZ @ 0x1801185E8
 * Callers:
...
void __fastcall BamoActivationListenerInputObjectProxy::LogOnHWNDChanged(BamoActivationListenerInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
