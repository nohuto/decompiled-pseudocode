/*
 * XREFs of ?QueryInterface@BamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AD9F0
 * Callers:
 *     ?QueryInterface@BamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800ADA80 (-QueryInterface@BamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Li_ea_1800ADA80.c)
 * Callees:
