/*
 * XREFs of ?GetDesktop@DragManagerClientProxy@@AEAAJXZ @ 0x18002F26C
 * Callers:
 *     ?OnConnected@DragManagerClientProxy@@MEAAJXZ @ 0x18002E880 (-OnConnected@DragManagerClientProxy@@MEAAJXZ.c)
 * Callees:
