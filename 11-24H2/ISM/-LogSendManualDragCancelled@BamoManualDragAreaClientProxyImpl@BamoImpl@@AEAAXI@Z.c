/*
 * XREFs of ?LogSendManualDragCancelled@BamoManualDragAreaClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180148548
 * Callers:
...
void __fastcall BamoImpl::BamoManualDragAreaClientProxyImpl::LogSendManualDragCancelled(
