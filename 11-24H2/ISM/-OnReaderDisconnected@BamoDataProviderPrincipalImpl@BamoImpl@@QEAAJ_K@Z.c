/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1801030FC
 * Callers:
 *     ?Thunk_OnReaderDisconnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801059A0 (-Thunk_OnReaderDisconnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@Ba.c)
 * Callees:
