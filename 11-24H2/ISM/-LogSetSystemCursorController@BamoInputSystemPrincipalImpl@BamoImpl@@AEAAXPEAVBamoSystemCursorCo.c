/*
 * XREFs of ?LogSetSystemCursorController@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemCursorControllerPrincipal@@@Z @ 0x180090F30
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetSystemCursorController(
