/*
 * XREFs of ?QueryInterface@BamoActivationListenerInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005B8E0
 * Callers:
 *     ?QueryInterface@BamoActivationListenerInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121270 (-QueryInterface@BamoActivationListenerInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
