/*
 * XREFs of ?StartInteractionHelper@ControllerProcessor@@AEAAXW4INTERACTION_TYPE@@@Z @ 0x18017C398
 * Callers:
 ...
 *     ?SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z @ 0x1801128A8 (-SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z.c)
 ...
 *     ?GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ @ 0x18017AA58 (-GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ.c)
 */
