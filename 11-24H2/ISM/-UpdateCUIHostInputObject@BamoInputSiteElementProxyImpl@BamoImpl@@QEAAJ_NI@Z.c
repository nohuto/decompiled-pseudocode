/*
 * XREFs of ?UpdateCUIHostInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003ECB4
 * Callers:
 *     ?Thunk_UpdateCUIHostInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072440 (-Thunk_UpdateCUIHostInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImp.c)
