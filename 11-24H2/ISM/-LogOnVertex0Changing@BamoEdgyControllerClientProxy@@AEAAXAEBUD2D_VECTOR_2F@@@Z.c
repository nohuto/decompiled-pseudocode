/*
 * XREFs of ?LogOnVertex0Changing@BamoEdgyControllerClientProxy@@AEAAXAEBUD2D_VECTOR_2F@@@Z @ 0x180156A34
 * Callers:
...
void __fastcall BamoEdgyControllerClientProxy::LogOnVertex0Changing(
