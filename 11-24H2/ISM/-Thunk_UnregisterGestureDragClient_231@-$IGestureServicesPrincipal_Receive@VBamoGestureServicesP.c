/*
 * XREFs of ?Thunk_UnregisterGestureDragClient_231@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143D30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
