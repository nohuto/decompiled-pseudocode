/*
 * XREFs of ?UpdateEdgyNotificationSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003F8DC
 * Callers:
 *     ?Thunk_UpdateEdgyNotificationSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071B70 (-Thunk_UpdateEdgyNotificationSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteEleme.c)
