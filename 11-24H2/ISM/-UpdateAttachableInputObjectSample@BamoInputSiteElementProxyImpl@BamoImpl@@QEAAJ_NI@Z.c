/*
 * XREFs of ?UpdateAttachableInputObjectSample@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003F4B4
 * Callers:
 *     ?Thunk_UpdateAttachableInputObjectSample_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072590 (-Thunk_UpdateAttachableInputObjectSample_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElemen.c)
