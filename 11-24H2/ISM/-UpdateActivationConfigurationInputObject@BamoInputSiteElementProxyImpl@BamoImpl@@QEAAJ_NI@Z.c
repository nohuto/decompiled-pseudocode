/*
 * XREFs of ?UpdateActivationConfigurationInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003FCE0
 * Callers:
 *     ?Thunk_UpdateActivationConfigurationInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072460 (-Thunk_UpdateActivationConfigurationInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSit.c)
