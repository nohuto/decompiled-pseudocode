/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_UexTest7@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CA31C
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_UexTest7>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v7);
    v10 = v6;
  }
