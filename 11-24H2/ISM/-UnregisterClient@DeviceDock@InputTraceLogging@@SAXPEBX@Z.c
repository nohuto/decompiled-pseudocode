/*
 * XREFs of ?UnregisterClient@DeviceDock@InputTraceLogging@@SAXPEBX@Z @ 0x180181EE8
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::UnregisterClient(const void *a1)
{
