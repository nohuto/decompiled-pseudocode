/*
 * XREFs of ??$MakeAndInitialize@VMagnifierProcessor@@UIContextualProcessor@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIContextualProcessor@@@Z @ 0x1801ACD38
 * Callers:
 ...
 *     ??0MagnifierProcessor@@QEAA@XZ @ 0x1801AD19C (--0MagnifierProcessor@@QEAA@XZ.c)
