/*
 * XREFs of ?MarkPrincipalReadyOnPropertiesRefreshed@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAJI@Z @ 0x1800B7080
 * Callers:
 *     ?Thunk_MarkPrincipalReadyOnPropertiesRefreshed_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B8E70 (-Thunk_MarkPrincipalReadyOnPropertiesRefreshed_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
