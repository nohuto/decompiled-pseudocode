/*
 * XREFs of ?UpdateCalledGetDetectedSourcesAtTimestampRecently@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801274A0
 * Callers:
 *     ?Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801265A0 (-Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@-$IMPCInputObjectProxy_Receive@VBamo.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoMPCInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012C670 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoMPCInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoP.c)
 * Callees:
