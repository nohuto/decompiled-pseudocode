/*
 * XREFs of ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x180112524
 * Callers:
 ...
 *     ?TransitionZoomTypes@ManipulationInjector@@AEAAXXZ @ 0x180112C60 (-TransitionZoomTypes@ManipulationInjector@@AEAAXXZ.c)
 *     ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x180112E38 (-UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z.c)
 *     ?UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z @ 0x180112EC4 (-UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z.c)
 */
...
LABEL_11:
  ...
  if ( *(_DWORD *)this == 2 )
  {
    v24 = *(struct tagRECT *)((char *)this + 760);
