/*
 * XREFs of ??_GEdgyProcessorTarget@@UEAAPEAXI@Z @ 0x1801AADB0
 * Callers:
 *     ??_EEdgyProcessorTarget@@WBA@EAAPEAXI@Z @ 0x1801AADA0 (--_EEdgyProcessorTarget@@WBA@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1EdgyProcessorTarget@@UEAA@XZ @ 0x1801AACE8 (--1EdgyProcessorTarget@@UEAA@XZ.c)
 */
