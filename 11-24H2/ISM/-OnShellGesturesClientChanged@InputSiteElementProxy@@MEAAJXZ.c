/*
 * XREFs of ?OnShellGesturesClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x1800370A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIShellGesturesClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180037118 (--$RemoveObject@UIShellGesturesClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IShellGesturesClientProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 272LL))((char *)this + 8);
