/*
 * XREFs of ?UpdateTouchEnabled@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180082C20
 * Callers:
 *     ?Thunk_UpdateTouchEnabled_11@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180081BF0 (-Thunk_UpdateTouchEnabled_11@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyIm.c)
