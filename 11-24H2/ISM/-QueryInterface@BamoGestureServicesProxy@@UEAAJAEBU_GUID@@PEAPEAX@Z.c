/*
 * XREFs of ?QueryInterface@BamoGestureServicesProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121CA0
 * Callers:
 *     ?QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180121D30 (-QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
