/*
 * XREFs of ?GetCandidateEdgyDetectedInfo@EdgyConnection@@QEAA_NPEBUCandidateIdentity@@PEAUCandidateEdgyDetectedInfo@@@Z @ 0x1801A7DC0
 * Callers:
        ...
        struct CandidateEdgyDetectedInfo *a3)
{
  ...
  v5 = (_QWORD *)((char *)a3 + 16);
  v6 = (EdgyConnection *)((char *)this + 72);
  v8 = 0;
