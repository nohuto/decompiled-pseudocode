/*
 * XREFs of ??$_Try_emplace@AEBI$$V@?$map@IV?$function@$$A6AX_N@Z@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@PEAX@std@@_N@1@AEBI@Z @ 0x18004DFEC
 * Callers:
 ...
 *     ?RegisterFor3DHitTestingAvailabilityChanged@MPC3DStateHelper@@QEAAXV?$function@$$A6AX_N@Z@std@@PEAI@Z @ 0x1800922F4 (-RegisterFor3DHitTestingAvailabilityChanged@MPC3DStateHelper@@QEAAXV-$function@$$A6AX_N@Z@std@@P.c)
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  if ( *((_BYTE *)v6 + 25) || *a3 < *((_DWORD *)v6 + 8) )
  {
    ...
    *(_QWORD *)(v9 + 8) = 0LL;
    if ( v14 )
    {
      std::_Func_class<void,>::~_Func_class<void,>((__int64)(v14 + 40), v10);
      if ( v14 )
        std::_Deallocate<16,0>(v14, (const struct std::nothrow_t *)0x68);
    }
