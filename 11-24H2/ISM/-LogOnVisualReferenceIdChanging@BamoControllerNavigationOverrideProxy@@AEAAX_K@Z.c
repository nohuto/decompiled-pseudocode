/*
 * XREFs of ?LogOnVisualReferenceIdChanging@BamoControllerNavigationOverrideProxy@@AEAAX_K@Z @ 0x180177790
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnVisualReferenceIdChanging(
