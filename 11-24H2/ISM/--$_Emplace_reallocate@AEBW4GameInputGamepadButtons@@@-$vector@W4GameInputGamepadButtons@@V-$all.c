/*
 * XREFs of ??$_Emplace_reallocate@AEBW4GameInputGamepadButtons@@@?$vector@W4GameInputGamepadButtons@@V?$allocator@W4GameInputGamepadButtons@@@std@@@std@@AEAAPEAW4GameInputGamepadButtons@@QEAW42@AEBW42@@Z @ 0x18017DBCC
 * Callers:
        ...
        _DWORD *a3)
{
  ...
  try
  {
    ...
    *(_QWORD *)a1 = v14;
    *(_QWORD *)(a1 + 8) = &v14[4 * v9];
    *(_QWORD *)(a1 + 16) = &v14[4 * v8];
    result = v15;
  }
  catch ( ... )
  {
    std::_Deallocate<16,0>(v21, (const struct std::nothrow_t *)(4 * v8));
    throw;
  }
  return result;
}
