/*
 * XREFs of ?GetNearestSupportedFixedColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x1800656BC
 * Callers:
 ...
 * Callees:
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x18006C8F0 (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
