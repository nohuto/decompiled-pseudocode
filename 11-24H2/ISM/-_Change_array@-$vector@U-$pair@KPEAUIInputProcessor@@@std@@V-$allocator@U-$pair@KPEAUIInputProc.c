/*
 * XREFs of ?_Change_array@?$vector@U?$pair@KPEAUIInputProcessor@@@std@@V?$allocator@U?$pair@KPEAUIInputProcessor@@@std@@@2@@std@@AEAAXQEAU?$pair@KPEAUIInputProcessor@@@2@_K1@Z @ 0x180079894
 * Callers:
...
void __fastcall std::vector<std::pair<unsigned long,IInputProcessor *>>::_Change_array(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
