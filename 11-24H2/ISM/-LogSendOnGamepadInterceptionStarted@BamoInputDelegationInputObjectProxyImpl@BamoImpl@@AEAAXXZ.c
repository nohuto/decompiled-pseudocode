/*
 * XREFs of ?LogSendOnGamepadInterceptionStarted@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@AEAAXXZ @ 0x1801336D0
 * Callers:
...
void __fastcall BamoImpl::BamoInputDelegationInputObjectProxyImpl::LogSendOnGamepadInterceptionStarted(
