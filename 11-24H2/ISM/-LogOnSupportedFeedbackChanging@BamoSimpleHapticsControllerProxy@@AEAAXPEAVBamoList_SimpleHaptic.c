/*
 * XREFs of ?LogOnSupportedFeedbackChanging@BamoSimpleHapticsControllerProxy@@AEAAXPEAVBamoList_SimpleHapticsControllerFeedback_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x180119D68
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnSupportedFeedbackChanging(
        BamoSimpleHapticsControllerProxy *this,
        struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Proxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
