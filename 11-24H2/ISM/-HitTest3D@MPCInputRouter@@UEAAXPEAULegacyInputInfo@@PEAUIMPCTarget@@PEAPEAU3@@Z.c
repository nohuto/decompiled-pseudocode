/*
 * XREFs of ?HitTest3D@MPCInputRouter@@UEAAXPEAULegacyInputInfo@@PEAUIMPCTarget@@PEAPEAU3@@Z @ 0x1800FD420
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$CopyTo@UIMPCTarget@@@?$ComPtr@UIMPCFocusTarget@@@WRL@Microsoft@@QEBAJPEAPEAUIMPCTarget@@@Z @ 0x18009AB9C (--$CopyTo@UIMPCTarget@@@-$ComPtr@UIMPCFocusTarget@@@WRL@Microsoft@@QEBAJPEAPEAUIMPCTarget@@@Z.c)
...
LABEL_36:
  ...
  else
  {
    ...
    MPCInputRouter::GetMPCTarget((MPCInputRouter *)((char *)this - 624), *v21, *((_DWORD *)a2 + 72), a4);
  }
LABEL_44:
