/*
 * XREFs of ??$_Freenode@V?$allocator@U?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@@std@@@?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@@1@PEAU01@@Z @ 0x180130BDC
 * Callers:
        ...
        char *a2)
{
  ...
  std::_Deallocate<16,0>(a2, (const struct std::nothrow_t *)0x78);
}
