/*
 * XREFs of ?Materialize_BamoMPCConstantManagerClientCallbacksProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B7474
 * Callers:
 *     ?Thunk_Materialize_BamoMPCConstantManagerClientCallbacksProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B8EC0 (-Thunk_Materialize_BamoMPCConstantManagerClientCallbacksProxy_11@-$IBamoPeer_MPCManagerBamo_Auto.c)
 * Callees:
...
__int64 __fastcall BamoImpl::MPCManagerBamo_AutoBamos::BamoPeerImpl::Materialize_BamoMPCConstantManagerClientCallbacksProxy(
        ...
        unsigned int a2)
{
  ...
  *v11 = &BamoMPCConstantManagerClientCallbacksProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v11[1] = &BamoMPCConstantManagerClientCallbacksProxy::`vftable'{for `IMPCConstantManagerClientCallbacksProxy'};
  *((_DWORD *)v11 + 6) = 0;
  v11[4] = 0LL;
  *((_DWORD *)v11 + 10) = 0;
  *((_DWORD *)v11 + 11) = 0;
  v11[2] = &BamoImpl::BamoMPCConstantManagerClientCallbacksProxyImpl::`vftable';
