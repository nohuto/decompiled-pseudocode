/*
 * XREFs of ?PrivateRelease@?$SipcObjectBase@UISIPCServer@@@@QEAAXXZ @ 0x18010FC4C
 * Callers:
 *     ?OnDisposePublic@SipcServer@@EEAAXXZ @ 0x18010F850 (-OnDisposePublic@SipcServer@@EEAAXXZ.c)
 *     ?ReleasePrivateReference@SipcServer@@UEAAXXZ @ 0x180110340 (-ReleasePrivateReference@SipcServer@@UEAAXXZ.c)
 * Callees:
