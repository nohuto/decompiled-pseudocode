/*
 * XREFs of ??$_Emplace_hint@AEBU?$pair@$$CBGI@std@@@?$_Tree@V?$_Tmap_traits@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@$0A@@std@@@std@@IEAAPEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@QEAU21@AEBU?$pair@$$CBGI@1@@Z @ 0x180070A40
 * Callers:
 *     ??0?$map@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@@std@@QEAA@V?$initializer_list@U?$pair@$$CBGI@std@@@1@@Z @ 0x18007099C (--0-$map@GIU-$less@G@std@@V-$allocator@U-$pair@$$CBGI@std@@@2@@std@@QEAA@V-$initializer_list@U-$.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( (_BYTE)v10 )
    return v5;
  if ( qword_180250DD8 == 0x666666666666666LL )
    std::_Throw_tree_length_error();
  v6 = qword_180250DD0;
  *(_QWORD *)&v9 = &qword_180250DD0;
  *((_QWORD *)&v9 + 1) = 0LL;
