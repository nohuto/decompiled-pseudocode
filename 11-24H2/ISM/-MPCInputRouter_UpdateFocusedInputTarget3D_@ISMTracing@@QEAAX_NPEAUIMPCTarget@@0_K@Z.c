/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget3D_@ISMTracing@@QEAAX_NPEAUIMPCTarget@@0_K@Z @ 0x1800FE158
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( ISMTracing::IsEnabled() )
  {
    ...
    if ( *(_DWORD *)v8 > 4u && tlgKeywordOn((__int64)v8, 1LL) )
    {
      ...
      v23 = 1;
      v17 = 1;
      tlgWriteTransfer_EventWriteTransfer(v9, byte_180214F87, 0LL, 0LL, 7u, &v15);
    }
  }
}
