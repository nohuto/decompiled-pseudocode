/*
 * XREFs of ?QueryInterface@BamoActivationControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005A1E0
 * Callers:
 *     ?QueryInterface@BamoActivationControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B05D0 (-QueryInterface@BamoActivationControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
