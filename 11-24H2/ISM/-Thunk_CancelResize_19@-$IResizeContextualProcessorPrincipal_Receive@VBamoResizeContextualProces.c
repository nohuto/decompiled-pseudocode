/*
 * XREFs of ?Thunk_CancelResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014F9F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
