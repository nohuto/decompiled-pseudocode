/*
 * XREFs of ?IsMobile0DButtonDevice@MobileButtonDeviceCollection@@AEAAJPEAVHIDDevice@@PEA_N@Z @ 0x1800DA3E4
 * Callers:
        ...
        bool *a3)
{
  ...
  v20 = v3;
  v4 = 0;
  HIDCapabilities = HIDDevice::GetHIDCapabilities((PHIDP_PREPARSED_DATA *)a2, &v19);
  v6 = HIDCapabilities;
