/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesResponseReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800ED42C
 * Callers:
 ...
 *     ??0HidLampAttributesResponseReportParser@@AEAA@XZ @ 0x1800ECF60 (--0HidLampAttributesResponseReportParser@@AEAA@XZ.c)
