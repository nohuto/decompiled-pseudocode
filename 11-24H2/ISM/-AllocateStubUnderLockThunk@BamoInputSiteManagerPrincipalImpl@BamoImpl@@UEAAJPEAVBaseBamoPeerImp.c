/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoInputSiteManagerPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18006D1B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerPrincipalImpl::AllocateStubUnderLockThunk(
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v5 = (*(__int64 (__fastcall **)(BamoImpl::BamoInputSiteManagerPrincipalImpl *))(*(_QWORD *)this + 56LL))(this);
  v14 = 0LL;
  v6 = v5;
  v7 = *((_QWORD *)a2 + 2);
