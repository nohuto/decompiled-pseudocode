/*
 * XREFs of ?LogOnIdChanged@BamoActivationControllerProxy@@AEAAXXZ @ 0x1800B0204
 * Callers:
...
void __fastcall BamoActivationControllerProxy::LogOnIdChanged(BamoActivationControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
