/*
 * XREFs of ?ResetForNewShellInstance@DesktopSystemCursorService@@UEAAJK@Z @ 0x1800FBD80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn DesktopSystemCursorService::ResetForNewShellInstance(DesktopSystemCursorService *this)
{
