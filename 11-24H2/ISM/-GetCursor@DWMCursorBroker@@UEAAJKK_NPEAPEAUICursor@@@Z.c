/*
 * XREFs of ?GetCursor@DWMCursorBroker@@UEAAJKK_NPEAPEAUICursor@@@Z @ 0x180015090
 * Callers:
 *     <none>
 * Callees:
 *     ?GetCursorWorker@DWMCursorBroker@@AEAAJKKPEAPEAUICursor@@@Z @ 0x180014F34 (-GetCursorWorker@DWMCursorBroker@@AEAAJKKPEAPEAUICursor@@@Z.c)
