/*
 * XREFs of ?RegisterShellHandwritingHostClient@ShellHandwritingHostServer@@UEAAJPEAVBamoShellHandwritingHostServerStub@@PEAVBamoShellHandwritingHostClientProxy@@@Z @ 0x18015BE10
 * Callers:
 *     <none>
 * Callees:
