/*
 * XREFs of ?OnCursorTargetChanged@CursorManager@@IEAAJPEAUCursorMessage@@@Z @ 0x18015F9C4
 * Callers:
 ...
 *     ?GetCursorDefaultState@@YAJW4InputType@@PEAUCursorState@@@Z @ 0x18009BDC0 (-GetCursorDefaultState@@YAJW4InputType@@PEAUCursorState@@@Z.c)
