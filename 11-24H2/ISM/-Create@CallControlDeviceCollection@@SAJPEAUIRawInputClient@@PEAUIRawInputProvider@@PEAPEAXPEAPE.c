/*
 * XREFs of ?Create@CallControlDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x180049740
 * Callers:
 ...
 *     ??0HIDDeviceCollection@@QEAA@PEAUIRawInputClient@@@Z @ 0x18004A5A4 (--0HIDDeviceCollection@@QEAA@PEAUIRawInputClient@@@Z.c)
