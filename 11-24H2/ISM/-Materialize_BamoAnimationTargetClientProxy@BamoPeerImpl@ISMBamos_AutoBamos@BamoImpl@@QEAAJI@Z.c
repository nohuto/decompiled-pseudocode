/*
 * XREFs of ?Materialize_BamoAnimationTargetClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002DB14
 * Callers:
 *     ?Thunk_Materialize_BamoAnimationTargetClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180096A90 (-Thunk_Materialize_BamoAnimationTargetClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
