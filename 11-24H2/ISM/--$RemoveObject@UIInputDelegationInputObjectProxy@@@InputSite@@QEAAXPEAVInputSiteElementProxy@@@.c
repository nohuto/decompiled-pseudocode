/*
 * XREFs of ??$RemoveObject@UIInputDelegationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180056998
 * Callers:
...
void __fastcall InputSite::RemoveObject<IInputDelegationInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_1452f669_12e6_cbad_dfcf_7322d5e6f2bf, &v14) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
