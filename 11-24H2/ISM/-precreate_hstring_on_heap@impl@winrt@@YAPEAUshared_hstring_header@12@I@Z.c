/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x1800A7E50
 * Callers:
 ...
 *     WINRT_IMPL_HeapAlloc @ 0x18009DE39 (WINRT_IMPL_HeapAlloc.c)
 *     WINRT_IMPL_GetProcessHeap @ 0x18009DE51 (WINRT_IMPL_GetProcessHeap.c)
 *     ??0exception@std@@QEAA@QEBD@Z @ 0x1800A6DE8 (--0exception@std@@QEAA@QEBD@Z.c)
 */
