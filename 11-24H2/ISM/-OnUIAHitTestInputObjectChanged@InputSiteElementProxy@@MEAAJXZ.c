/*
 * XREFs of ?OnUIAHitTestInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180038880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIUIAHitTestInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800388F8 (--$RemoveObject@UIUIAHitTestInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
