/*
 * XREFs of ?AccumulateYawVelocity@MPCHeadMovementDetector@@AEAA_NXZ @ 0x180076924
 * Callers:
 ...
 *     ?XMScalarACos@DirectX@@YAMM@Z @ 0x1800D1244 (-XMScalarACos@DirectX@@YAMM@Z.c)
...
bool __fastcall MPCHeadMovementDetector::AccumulateYawVelocity(__int64 **this, float a2)
{
  ...
  float v33[4]; // [rsp+68h] [rbp-9h] BYREF
  __int128 v34; // [rsp+78h] [rbp+7h] BYREF
  __m128 v35; // [rsp+88h] [rbp+17h] BYREF
  __int128 v36; // [rsp+98h] [rbp+27h] BYREF
  ...
  if ( result )
  {
    ...
    {
      v36 = 0LL;
      v16 = (*(__int64 (__fastcall **)(__int64, __int128 *))(*(_QWORD *)v27 + 56LL))(v27, &v36);
      if ( v16 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xE4,
      ...
      v31 = 0;
      Windows::Foundation::Numerics::transform(v33, (float *)&v30, (float *)&v34);
      v17 = (*(__int64 (__fastcall **)(__int64, __m128 *))(*(_QWORD *)v27 + 80LL))(v27, &v35);
      if ( v17 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xE9,
      ...
      v30 = v25.m128_u64[0];
      *((float *)this + 26) = (float)((float)((float)(_mm_shuffle_ps(v25, v25, 170).m128_f32[0] * v33[2])
                                            + (float)((float)(v33[0] * v25.m128_f32[0])
                                                    + (float)(v33[1] * v25.m128_f32[1])))
                                    * (float)(v19 + v19))
                            + *((float *)this + 26);
      ++*((_DWORD *)this + 27);
      v15 = v27;
