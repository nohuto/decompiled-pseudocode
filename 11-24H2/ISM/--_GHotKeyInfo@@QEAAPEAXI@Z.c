/*
 * XREFs of ??_GHotKeyInfo@@QEAAPEAXI@Z @ 0x1801CA97C
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ @ 0x1801CD100 (-_Destroy@-$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ.c)
 * Callees:
