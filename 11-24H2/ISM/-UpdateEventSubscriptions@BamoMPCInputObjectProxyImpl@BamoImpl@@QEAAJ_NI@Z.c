/*
 * XREFs of ?UpdateEventSubscriptions@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180128AD0
 * Callers:
 *     ?Thunk_UpdateEventSubscriptions_8@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126790 (-Thunk_UpdateEventSubscriptions_8@-$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@Ba.c)
