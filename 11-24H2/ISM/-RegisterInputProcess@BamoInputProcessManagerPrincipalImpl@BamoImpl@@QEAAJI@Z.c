/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18019BAE0
 * Callers:
 *     ?Thunk_RegisterInputProcess_8@?$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18019C2B0 (-Thunk_RegisterInputProcess_8@-$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPr.c)
 * Callees:
