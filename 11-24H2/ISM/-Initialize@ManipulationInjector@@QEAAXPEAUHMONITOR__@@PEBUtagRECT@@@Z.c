/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x1801112C4
 * Callers:
  ...
  *((_DWORD *)this + 184) = v9;
  ...
  switch ( *(_DWORD *)this )
  {
    ...
    case 2:
      ...
      dword_18024FFAC = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 194)) + 0.5);
      dword_18024FFCC = (int)v14;
      v29.x = *((_DWORD *)this + 5);
