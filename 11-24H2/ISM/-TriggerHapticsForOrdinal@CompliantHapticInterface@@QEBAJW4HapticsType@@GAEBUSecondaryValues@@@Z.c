/*
 * XREFs of ?TriggerHapticsForOrdinal@CompliantHapticInterface@@QEBAJW4HapticsType@@GAEBUSecondaryValues@@@Z @ 0x18019ABD0
 * Callers:
 ...
 *     ??$_Find_lower_bound@G@?$_Tree@V?$_Tmap_traits@GUHapticsWaveform@@U?$less@G@std@@V?$allocator@U?$pair@$$CBGUHapticsWaveform@@@std@@@3@$0A@@std@@@std@@IEBA?AU?$_Tree_find_result@PEAU?$_Tree_node@U?$pair@$$CBGUHapticsWaveform@@@std@@PEAX@std@@@1@AEBG@Z @ 0x1801996B8 (--$_Find_lower_bound@G@-$_Tree@V-$_Tmap_traits@GUHapticsWaveform@@U-$less@G@std@@V-$allocator@U-.c)
 */
...
LABEL_37:
    std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned long const,MagnifierRecognizer::ContactState>>>,std::_Iterator_base0>::operator++(&v33);
    v16 = v33;
  }
  v25 = *(void **)a1;
