/*
 * XREFs of ?LogOnIsReplayPauseIntervalSupportedChanging@BamoSimpleHapticsControllerProxy@@AEAAX_N@Z @ 0x180119378
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsReplayPauseIntervalSupportedChanging(
