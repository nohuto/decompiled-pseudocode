/*
 * XREFs of ?LogOnLuidChanged@BamoActivationControllerProxy@@AEAAXXZ @ 0x1800B02B8
 * Callers:
...
void __fastcall BamoActivationControllerProxy::LogOnLuidChanged(BamoActivationControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
