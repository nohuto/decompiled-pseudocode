/*
 * XREFs of ?_Change_array@?$vector@UDisplayOcclusionRect@@V?$allocator@UDisplayOcclusionRect@@@std@@@std@@AEAAXQEAUDisplayOcclusionRect@@_K1@Z @ 0x18013AE2C
 * Callers:
...
__int64 __fastcall std::vector<DisplayOcclusionRect>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v6 )
    std::_Deallocate<16,0>(
      v6,
      (const struct std::nothrow_t *)(16 * ((__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v6) >> 4)));
  *(_QWORD *)a1 = a2;
