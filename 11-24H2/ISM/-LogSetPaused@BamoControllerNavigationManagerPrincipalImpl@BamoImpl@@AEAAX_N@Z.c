/*
 * XREFs of ?LogSetPaused@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@AEAAX_N@Z @ 0x180175BA4
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationManagerPrincipalImpl::LogSetPaused(
