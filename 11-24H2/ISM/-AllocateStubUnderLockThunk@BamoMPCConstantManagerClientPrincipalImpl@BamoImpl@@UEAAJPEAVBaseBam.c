/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800B3710
 * Callers:
 *     <none>
 * Callees:
