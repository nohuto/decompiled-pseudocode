/*
 * XREFs of ?UpdateSuppressionRegions@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@I@Z @ 0x180145B20
 * Callers:
 *     ?Thunk_UpdateSuppressionRegions_150@?$IDragManagerClientProxy_Receive@VBamoDragManagerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180145AC0 (-Thunk_UpdateSuppressionRegions_150@-$IDragManagerClientProxy_Receive@VBamoDragManagerClientProx.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDragManagerClientProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180145AE0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDragManagerClientProxyImpl@BamoImpl@@UEAAXPEAVBa.c)
 * Callees:
