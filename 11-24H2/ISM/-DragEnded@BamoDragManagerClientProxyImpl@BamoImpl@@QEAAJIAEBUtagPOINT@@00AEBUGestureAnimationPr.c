/*
 * XREFs of ?DragEnded@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@00AEBUGestureAnimationProperties@@_KW4VirtualKeyModifiers@System@Windows@@2@Z @ 0x18014496C
 * Callers:
...
LABEL_7:
  ...
  BamoImpl::BamoDragManagerClientProxyImpl::LogSendDragEnded(a1, a2);
  v15 = *((_QWORD *)a6 + 2);
  v20 = *a6;
  v21 = v15;
  v16 = *a5;
