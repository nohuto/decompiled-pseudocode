/*
 * XREFs of ?Unregister@InputAttemptedTargetManager@@QEAAXAEBV?$ComPtr@VBamoInputAttemptedDeliveryClientProxy@@@WRL@Microsoft@@@Z @ 0x18015E518
 * Callers:
 *     ?OnDisconnected@InputAttemptedDeliveryClientProxy@@UEAAJXZ @ 0x18015D1F0 (-OnDisconnected@InputAttemptedDeliveryClientProxy@@UEAAJXZ.c)
 * Callees:
