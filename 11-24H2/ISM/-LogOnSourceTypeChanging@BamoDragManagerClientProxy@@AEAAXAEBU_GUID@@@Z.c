/*
 * XREFs of ?LogOnSourceTypeChanging@BamoDragManagerClientProxy@@AEAAXAEBU_GUID@@@Z @ 0x1801453A8
 * Callers:
...
void __fastcall BamoDragManagerClientProxy::LogOnSourceTypeChanging(
