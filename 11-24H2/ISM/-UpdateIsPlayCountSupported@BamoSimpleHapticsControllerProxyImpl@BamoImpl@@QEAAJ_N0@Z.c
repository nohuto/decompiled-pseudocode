/*
 * XREFs of ?UpdateIsPlayCountSupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012AAE0
 * Callers:
 *     ?Thunk_UpdateIsPlayCountSupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126A10 (-Thunk_UpdateIsPlayCountSupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsC.c)
        ...
        __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoSimpleHapticsControllerProxy::LogOnIsPlayCountSupportedChanging((BamoImpl::BamoSimpleHapticsControllerProxyImpl *)((char *)this - 16));
  ...
  *((_BYTE *)this + 57) = v3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoSimpleHapticsControllerProxy::LogOnIsPlayCountSupportedChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v11,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
