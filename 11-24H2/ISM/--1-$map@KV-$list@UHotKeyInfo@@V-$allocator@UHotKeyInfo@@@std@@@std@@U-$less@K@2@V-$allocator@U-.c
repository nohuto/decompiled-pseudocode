/*
 * XREFs of ??1?$map@KV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@U?$less@K@2@V?$allocator@U?$pair@$$CBKV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801CA378
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$8 @ 0x1801D9C22 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$8.c)
 * Callees:
 *     <none>
 */
