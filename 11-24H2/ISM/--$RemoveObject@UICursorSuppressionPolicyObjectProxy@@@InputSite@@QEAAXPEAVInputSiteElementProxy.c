/*
 * XREFs of ??$RemoveObject@UICursorSuppressionPolicyObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180038C94
 * Callers:
...
void __fastcall InputSite::RemoveObject<ICursorSuppressionPolicyObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_c1d339b0_71a2_9a06_32b0_40ee403cfafd, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
