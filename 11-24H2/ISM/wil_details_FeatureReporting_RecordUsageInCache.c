/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x1800C185C
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x18009552C (wil_details_FeatureReporting_IncrementUsageInCache.c)
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1800C1778 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
 */
