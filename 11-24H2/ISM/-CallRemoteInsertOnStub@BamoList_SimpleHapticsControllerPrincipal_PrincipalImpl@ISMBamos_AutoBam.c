/*
 * XREFs of ?CallRemoteInsertOnStub@BamoList_SimpleHapticsControllerPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@IPEAVBamoSimpleHapticsControllerPrincipal@@@Z @ 0x18018ADD0
 * Callers:
