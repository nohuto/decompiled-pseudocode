/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SuppressSwitcherInjectionOnChordPress@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18017A464
 * Callers:
  ...
  if ( (v3 & 6) != 6 )
  {
    ...
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (v13[1] = 0,
            v13[0] = 3,
            v14 = Feature_SuppressSwitcherInjectionOnChordPress__descriptor,
