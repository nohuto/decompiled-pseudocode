/*
 * XREFs of ?LogOnPrimaryUsagePageChanging@BamoDockableDeviceProxy@@AEAAXG@Z @ 0x1801197B8
 * Callers:
...
void __fastcall BamoDockableDeviceProxy::LogOnPrimaryUsagePageChanging(BamoDockableDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
