/*
 * XREFs of ??$ReportFailure_Hr@$01@details@wil@@YAXPEAXIPEBD110J@Z @ 0x18007CFAC
 * Callers:
 ...
 *     ?winrt_throw_hresult@wil@@YAXIPEBD0PEAXUhresult@winrt@@@Z @ 0x1800DF510 (-winrt_throw_hresult@wil@@YAXIPEBD0PEAXUhresult@winrt@@@Z.c)
 * Callees:
