/*
 * XREFs of ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z @ 0x18009B06C
 * Callers:
 ...
 * Callees:
 *     ?InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z @ 0x1800818C8 (-InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z.c)
 */
