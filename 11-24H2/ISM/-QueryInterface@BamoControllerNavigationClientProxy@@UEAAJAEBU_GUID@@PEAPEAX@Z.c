/*
 * XREFs of ?QueryInterface@BamoControllerNavigationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180177B30
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180177BC0 (-QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
