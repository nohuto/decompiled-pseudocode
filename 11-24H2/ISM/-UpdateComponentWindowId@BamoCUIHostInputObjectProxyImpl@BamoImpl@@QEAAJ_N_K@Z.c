/*
 * XREFs of ?UpdateComponentWindowId@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x180131F5C
 * Callers:
 *     ?Thunk_UpdateComponentWindowId_0@?$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180131E40 (-Thunk_UpdateComponentWindowId_0@-$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxy.c)
