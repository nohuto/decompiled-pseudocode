/*
 * XREFs of ?AllocateStubUnderLock@BamoInputProcessPrincipalOwner@@UEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputProcessStub@@@Z @ 0x1800CC250
 * Callers:
 *     <none>
 * Callees:
