/*
 * XREFs of ?RevokeProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJPEBIII@Z @ 0x18003C838
 * Callers:
 *     ?Thunk_RevokeProcessesForAnimation_235@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143C80 (-Thunk_RevokeProcessesForAnimation_235@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesP.c)
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      this);
    v19 = (int)v13;
    v18 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned int *, _QWORD))(*((_QWORD *)this - 2) + 168LL))(
            (char *)this - 16,
            v20,
            a2,
            a3);
