/*
 * XREFs of ?LogOnCalledGetDetectedSourcesAtTimestampRecentlyChanging@BamoMPCInputObjectProxy@@AEAAX_N@Z @ 0x18011748C
 * Callers:
...
void __fastcall BamoMPCInputObjectProxy::LogOnCalledGetDetectedSourcesAtTimestampRecentlyChanging(
