/*
 * XREFs of _PTPProcessor::CheckForHapticTouchpadArrival_::_1_::dtor$0 @ 0x1801D9A21
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall PTPProcessor::CheckForHapticTouchpadArrival_::_1_::dtor_0(__int64 a1, __int64 a2)
{
