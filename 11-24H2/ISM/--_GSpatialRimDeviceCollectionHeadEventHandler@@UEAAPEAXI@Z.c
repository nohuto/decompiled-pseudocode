/*
 * XREFs of ??_GSpatialRimDeviceCollectionHeadEventHandler@@UEAAPEAXI@Z @ 0x1800D5850
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009D758 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1SpatialRimDeviceCollectionHeadEventHandler@@UEAA@XZ @ 0x1800D5644 (--1SpatialRimDeviceCollectionHeadEventHandler@@UEAA@XZ.c)
 */
