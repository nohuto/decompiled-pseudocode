/*
 * XREFs of ?Materialize_BamoContainerInfoInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011C894
 * Callers:
 *     ?Thunk_Materialize_BamoContainerInfoInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126030 (-Thunk_Materialize_BamoContainerInfoInputObjectProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
