/*
 * XREFs of ?CancelDrag@DragNDropProcessor@@QEAAJKPEAVBamoDragManagerClientProxy@@@Z @ 0x18014AB20
 * Callers:
 ...
 *     ?OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z @ 0x180148964 (-OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z.c)
