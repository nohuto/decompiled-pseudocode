/*
 * XREFs of ?Thunk_Materialize_BamoInputProcessProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126230
 * Callers:
 *     <none>
 * Callees:
 *     <none>
