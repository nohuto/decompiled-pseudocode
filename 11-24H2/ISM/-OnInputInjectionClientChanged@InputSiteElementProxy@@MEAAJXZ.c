/*
 * XREFs of ?OnInputInjectionClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005E1B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIInputInjectionClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E228 (--$RemoveObject@UIInputInjectionClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
