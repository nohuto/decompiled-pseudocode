...
void __fastcall ShellGesturesProcessor::UnregisterClient(struct ShellGesturesClientProxy *a1)
{
  ...
  v4 = 0LL;
  v7 = 0LL;
  v5 = qword_180250F08 + qword_180250F10;
  v8 = qword_180250F08;
