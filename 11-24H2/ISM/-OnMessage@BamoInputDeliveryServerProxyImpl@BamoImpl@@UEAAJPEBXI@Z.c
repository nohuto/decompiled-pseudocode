/*
 * XREFs of ?OnMessage@BamoInputDeliveryServerProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x1801201D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputDeliveryServerProxyImpl::OnMessage(
