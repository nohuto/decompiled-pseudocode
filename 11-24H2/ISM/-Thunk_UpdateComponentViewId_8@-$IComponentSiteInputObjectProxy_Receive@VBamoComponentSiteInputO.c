/*
 * XREFs of ?Thunk_UpdateComponentViewId_8@?$IComponentSiteInputObjectProxy_Receive@VBamoComponentSiteInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801265C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
