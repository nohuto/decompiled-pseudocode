/*
 * XREFs of ?QueryInterface@RawButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B2AB0
 * Callers:
 *     ?QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B2B70 (-QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(RawButtonProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (RawButtonProcessor *)(((unsigned __int64)v4 + 8) & -(__int64)(v4 != 0LL));
    goto LABEL_11;
  }
  return 2147500034LL;
}
