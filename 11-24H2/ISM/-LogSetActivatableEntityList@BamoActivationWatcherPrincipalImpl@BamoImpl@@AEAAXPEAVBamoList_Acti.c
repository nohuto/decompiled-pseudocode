/*
 * XREFs of ?LogSetActivatableEntityList@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x1800AF7C0
 * Callers:
