/*
 * XREFs of ?OnSystemContextNotification@GestureServices@@UEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@std@@@Z @ 0x180070CF0
 * Callers:
...
LABEL_9:
        ...
        v6 = std::_Uninitialized_value_construct_n<std::allocator<INPUT_SPACE_REGION>>(*(_QWORD *)(v2 + 8), v5 - v4);
      }
      *(_QWORD *)(v2 + 8) = v6;
      goto LABEL_9;
    }
    if ( *(_QWORD *)(a1 + 56) != *(_QWORD *)(a1 + 64) )
      *(_QWORD *)(a1 + 64) = *(_QWORD *)v2;
  }
  return 0LL;
}
