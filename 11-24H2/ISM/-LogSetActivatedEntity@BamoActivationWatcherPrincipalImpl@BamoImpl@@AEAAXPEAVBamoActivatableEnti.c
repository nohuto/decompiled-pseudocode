/*
 * XREFs of ?LogSetActivatedEntity@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800AF84C
 * Callers:
...
void __fastcall BamoImpl::BamoActivationWatcherPrincipalImpl::LogSetActivatedEntity(
