/*
 * XREFs of ?QueryInterface@BamoResizeContextualProcessorPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014F540
 * Callers:
 *     ?QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014F5D0 (-QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
