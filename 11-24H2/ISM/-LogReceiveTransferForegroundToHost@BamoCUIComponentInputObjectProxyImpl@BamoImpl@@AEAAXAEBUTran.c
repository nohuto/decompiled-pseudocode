/*
 * XREFs of ?LogReceiveTransferForegroundToHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@AEAAXAEBUTransferForegroundInfo@@@Z @ 0x180132358
 * Callers:
...
void __fastcall BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogReceiveTransferForegroundToHost(
