/*
 * XREFs of ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x180112158
 * Callers:
 ...
 *     ?CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ @ 0x180110E18 (-CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ.c)
 ...
 *     ?ComputeSafeDelta@ManipulationInjector@@AEAA?AUtagPOINT@@IU2@UtagRECT@@@Z @ 0x180110F20 (-ComputeSafeDelta@ManipulationInjector@@AEAA-AUtagPOINT@@IU2@UtagRECT@@@Z.c)
 ...
 *     ?RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z @ 0x180112770 (-RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z.c)
