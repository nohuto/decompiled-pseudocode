/*
 * XREFs of ?UpdateTailButtonDoubleClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18007E0C8
 * Callers:
 *     ?Thunk_UpdateTailButtonDoubleClickedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180097C40 (-Thunk_UpdateTailButtonDoubleClickedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEv.c)
