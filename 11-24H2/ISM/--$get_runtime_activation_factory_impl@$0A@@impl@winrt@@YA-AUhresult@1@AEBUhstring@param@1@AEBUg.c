/*
 * XREFs of ??$get_runtime_activation_factory_impl@$0A@@impl@winrt@@YA?AUhresult@1@AEBUhstring@param@1@AEBUguid@1@PEAPEAX@Z @ 0x180080D3C
 * Callers:
 ...
 *     ??$get_activation_factory@UIThreadPoolStatics@Threading@System@Windows@winrt@@@winrt@@YA?AUIThreadPoolStatics@Threading@System@Windows@0@AEBUhstring@param@0@@Z @ 0x1800DE060 (--$get_activation_factory@UIThreadPoolStatics@Threading@System@Windows@winrt@@@winrt@@YA-AUIThre.c)
 ...
 *     WINRT_IMPL_GetProcAddress @ 0x18009DE45 (WINRT_IMPL_GetProcAddress.c)
 *     WINRT_IMPL_FreeLibrary @ 0x18009E0B9 (WINRT_IMPL_FreeLibrary.c)
 *     RoGetActivationFactory_0 @ 0x18009E0C5 (RoGetActivationFactory_0.c)
 *     LoadLibraryExW_0 @ 0x18009EB69 (LoadLibraryExW_0.c)
 *     GetErrorInfo_0 @ 0x18009F2E5 (GetErrorInfo_0.c)
 *     SetErrorInfo_0 @ 0x18009F2FD (SetErrorInfo_0.c)
 *     ??$_Traits_rfind_ch@U?$char_traits@G@std@@@std@@YA_KQEBG_K1G@Z @ 0x1800A6C6C (--$_Traits_rfind_ch@U-$char_traits@G@std@@@std@@YA_KQEBG_K1G@Z.c)
