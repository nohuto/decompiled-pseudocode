/*
 * XREFs of ?QueryInterface@ResizeProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180151B20
 * Callers:
 *     ?QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180151BE0 (-QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(ResizeProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (ResizeProcessor *)(((unsigned __int64)v4 + 8) & -(__int64)(v4 != 0LL));
    goto LABEL_11;
  }
  return 2147500034LL;
}
