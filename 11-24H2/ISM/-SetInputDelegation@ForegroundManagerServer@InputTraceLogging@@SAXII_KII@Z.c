/*
 * XREFs of ?SetInputDelegation@ForegroundManagerServer@InputTraceLogging@@SAXII_KII@Z @ 0x1800AE800
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( *(_DWORD *)v9 > 4u && tlgKeywordOn((__int64)v9, 512LL) )
  {
    ...
    v15 = a1;
    v23 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v11, byte_18020F42A, 0LL, 0LL, 7u, &v17);
  }
}
