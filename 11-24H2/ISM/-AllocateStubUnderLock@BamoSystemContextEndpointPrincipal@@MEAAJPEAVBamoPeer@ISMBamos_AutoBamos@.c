/*
 * XREFs of ?AllocateStubUnderLock@BamoSystemContextEndpointPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSystemContextEndpointStub@@@Z @ 0x1800AA910
 * Callers:
 *     <none>
 * Callees:
