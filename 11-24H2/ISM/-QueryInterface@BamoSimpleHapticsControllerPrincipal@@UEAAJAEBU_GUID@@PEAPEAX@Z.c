/*
 * XREFs of ?QueryInterface@BamoSimpleHapticsControllerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186400
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180186440 (-QueryInterface@BamoSimpleHapticsControllerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     Microsoft::BamoImpl::Util::FindInterface_BamoSimpleHapticsControllerPrincipal_ISimpleHapticsControllerPrincipal_ @ 0x1801844FC (Microsoft--BamoImpl--Util--FindInterface_BamoSimpleHapticsControllerPrincipal_ISimpleHapticsCont.c)
