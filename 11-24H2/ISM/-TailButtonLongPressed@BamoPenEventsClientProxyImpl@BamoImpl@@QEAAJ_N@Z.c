/*
 * XREFs of ?TailButtonLongPressed@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180196870
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonLongPressed(this);
      v11[0] = v13;
      v11[1] = v14;
