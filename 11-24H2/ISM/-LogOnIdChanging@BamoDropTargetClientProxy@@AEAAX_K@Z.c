/*
 * XREFs of ?LogOnIdChanging@BamoDropTargetClientProxy@@AEAAX_K@Z @ 0x180118B34
 * Callers:
...
void __fastcall BamoDropTargetClientProxy::LogOnIdChanging(BamoDropTargetClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
