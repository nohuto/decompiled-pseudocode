/*
 * XREFs of ?LogSetControllerNavigationManager@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoControllerNavigationManagerPrincipal@@@Z @ 0x18009A6B0
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetControllerNavigationManager(
