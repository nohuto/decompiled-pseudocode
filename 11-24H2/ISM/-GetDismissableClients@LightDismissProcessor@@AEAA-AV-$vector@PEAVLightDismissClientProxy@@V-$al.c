/*
 * XREFs of ?GetDismissableClients@LightDismissProcessor@@AEAA?AV?$vector@PEAVLightDismissClientProxy@@V?$allocator@PEAVLightDismissClientProxy@@@std@@@std@@PEAUHitTestResult@@@Z @ 0x180057710
 * Callers:
 *     ?OnHitTest@LightDismissProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1800576A0 (-OnHitTest@LightDismissProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcesso.c)
 * Callees:
 ...
 *     ?_Buy_nonzero@?$vector@PEAVLightDismissClientProxy@@V?$allocator@PEAVLightDismissClientProxy@@@std@@@std@@AEAAX_K@Z @ 0x180094D4C (-_Buy_nonzero@-$vector@PEAVLightDismissClientProxy@@V-$allocator@PEAVLightDismissClientProxy@@@s.c)
 ...
 *     ??1?$_Tidy_guard@V?$vector@PEAVLightDismissClientProxy@@V?$allocator@PEAVLightDismissClientProxy@@@std@@@std@@@std@@QEAA@XZ @ 0x18015CE48 (--1-$_Tidy_guard@V-$vector@PEAVLightDismissClientProxy@@V-$allocator@PEAVLightDismissClientProxy.c)
...
_QWORD *__fastcall LightDismissProcessor::GetDismissableClients(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  *(_OWORD *)v16 = 0LL;
  v17 = 0LL;
  if ( (qword_180250F20 - (__int64)LightDismissProcessor::s_clients) >> 3 )
  {
    std::vector<LightDismissClientProxy *>::_Buy_nonzero(v16);
    v9 = (char *)v16[0];
    v10 = qword_180250F20 - (_QWORD)LightDismissProcessor::s_clients;
    memmove_0(v16[0], LightDismissProcessor::s_clients, qword_180250F20 - (_QWORD)LightDismissProcessor::s_clients);
    v16[1] = &v9[8 * (v10 >> 3)];
    v18 = 0LL;
