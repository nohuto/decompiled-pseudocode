/*
 * XREFs of ??$RemoveObject@UIDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005EB28
 * Callers:
...
void __fastcall InputSite::RemoveObject<IDragSourceClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_48b7db2e_8d7c_d06b_2343_86cab6a9c078, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
