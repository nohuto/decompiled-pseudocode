/*
 * XREFs of ??1?$unique_ptr@UDockableDeviceInfo@@U?$default_delete@UDockableDeviceInfo@@@std@@@std@@QEAA@XZ @ 0x1800DE1A0
 * Callers:
 ...
 *     _DockableDeviceCollection::OnDeviceAttach_::_1_::dtor$0 @ 0x1801D5B89 (_DockableDeviceCollection--OnDeviceAttach_--_1_--dtor$0.c)
 * Callees:
