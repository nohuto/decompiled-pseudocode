/*
 * XREFs of ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x180060FC0
 * Callers:
...
unsigned __int64 __fastcall QpcTimeConverter::GetCurrentMicroSecTime(QpcTimeConverter *this)
{
  ...
  if ( QueryPerformanceCounter(&PerformanceCount) && GameControllerRawInputProvider::s_qpcTime )
    return qword_180250DC8 * (PerformanceCount.QuadPart / (unsigned __int64)GameControllerRawInputProvider::s_qpcTime)
         + qword_180250DC8
