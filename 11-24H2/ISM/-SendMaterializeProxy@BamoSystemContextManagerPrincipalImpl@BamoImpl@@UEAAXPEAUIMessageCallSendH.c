/*
 * XREFs of ?SendMaterializeProxy@BamoSystemContextManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801404F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoSystemContextManagerPrincipalImpl::SendMaterializeProxy(
