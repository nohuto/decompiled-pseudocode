/*
 * XREFs of ?RegisterInputSiteElementWithHint@BamoInputSiteManagerPrincipalImpl@BamoImpl@@QEAAJIPEBUInputSiteId@@@Z @ 0x18003D640
 * Callers:
 *     ?Thunk_RegisterInputSiteElementWithHint_268@?$IInputSiteManagerPrincipal_Receive@VBamoInputSiteManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180130220 (-Thunk_RegisterInputSiteElementWithHint_268@-$IInputSiteManagerPrincipal_Receive@VBamoInputSiteM.c)
 * Callees:
