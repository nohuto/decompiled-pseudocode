/*
 * XREFs of ?RegisterProcess@InputProcessManager@InputTraceLogging@@SAXPEBX@Z @ 0x18019BD2C
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::RegisterProcess(const void *a1)
{
