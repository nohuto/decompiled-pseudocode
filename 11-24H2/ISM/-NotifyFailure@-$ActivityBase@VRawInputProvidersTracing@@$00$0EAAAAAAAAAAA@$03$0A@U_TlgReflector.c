/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VRawInputProvidersTracing@@$00$0EAAAAAAAAAAA@$03$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800D7070
 * Callers:
 *     <none>
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapSz@D@@U2@U3@U2@U?$_tlgWrapSz@G@@U2@U3@U2@U3@U4@U2@U3@U4@U2@U2@U3@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapSz@D@@454AEBU?$_tlgWrapSz@G@@45456456445@Z @ 0x180001AEC (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapperByVal@$03@@U-$_tlgWrapSz@D@@U2@U3@U2@U-$_tlgWrap.c)
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapSz@D@@U2@U3@U2@U?$_tlgWrapSz@G@@U2@U3@U2@U3@U4@U2@U3@U4@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapSz@D@@454AEBU?$_tlgWrapSz@G@@45456456@Z @ 0x180003F78 (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapperByVal@$03@@U-$_tlgWrapSz@D@@U2@U3@U_ea_180003F78.c)
        ...
        int *a2)
{
  ...
  const WCHAR *v19; // [rsp+C0h] [rbp-70h] BYREF
  const WCHAR *v20; // [rsp+C8h] [rbp-68h] BYREF
  const unsigned __int16 *v21; // [rsp+D0h] [rbp-60h] BYREF
  const unsigned __int16 *v22; // [rsp+D8h] [rbp-58h] BYREF
  const WCHAR *v23; // [rsp+E0h] [rbp-50h] BYREF
  const unsigned __int16 *v24; // [rsp+E8h] [rbp-48h] BYREF
  const unsigned __int16 *v25; // [rsp+F0h] [rbp-40h] BYREF
  ...
  if ( (a2[1] & 2) == 0 )
  {
    ...
    {
      v9 = RawInputProvidersTracing::Provider(v4);
      if ( *(_DWORD *)v9 > 2u && tlgKeywordOn((__int64)v9, 0x400000000000LL) )
      {
    ...
    {
      v5 = RawInputProvidersTracing::Provider(v4);
      if ( *(_DWORD *)v5 > 2u && tlgKeywordOn((__int64)v5, 0x600000000000LL) )
      {
        v7 = (const WCHAR *)*((_QWORD *)a2 + 15);
        v8 = a1[34];
        LODWORD(v30) = a2[26];
        v20 = (const WCHAR *)*((_QWORD *)a2 + 12);
        v21 = (const unsigned __int16 *)*((_QWORD *)a2 + 11);
        v31 = a2[20];
        v22 = (const unsigned __int16 *)*((_QWORD *)a2 + 9);
        v32 = a2[8];
        v23 = (const WCHAR *)*((_QWORD *)a2 + 3);
        v33 = *a2;
