/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015D870
 * Callers:
 *     ?Thunk_RegisterInputAttemptedClient_8@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015DA60 (-Thunk_RegisterInputAttemptedClient_8@-$IInputDeliveryServerPrincipal_Receive@VBamoInputDelivery.c)
 * Callees:
