/*
 * XREFs of ?UpdateResizeContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012B8F4
 * Callers:
 *     ?Thunk_UpdateResizeContextualProcessor_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126B60 (-Thunk_UpdateResizeContextualProcessor_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@B.c)
