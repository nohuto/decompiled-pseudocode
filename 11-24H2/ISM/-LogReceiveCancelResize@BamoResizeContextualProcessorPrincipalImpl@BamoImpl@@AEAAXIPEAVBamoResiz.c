/*
 * XREFs of ?LogReceiveCancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014F2A4
 * Callers:
