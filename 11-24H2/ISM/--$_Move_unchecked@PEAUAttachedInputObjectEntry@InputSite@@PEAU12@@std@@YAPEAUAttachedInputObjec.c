/*
 * XREFs of ??$_Move_unchecked@PEAUAttachedInputObjectEntry@InputSite@@PEAU12@@std@@YAPEAUAttachedInputObjectEntry@InputSite@@PEAU12@00@Z @ 0x18003827C
 * Callers:
 ...
 *     ??$RemoveObject@UIDropTargetClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D4D8 (--$RemoveObject@UIDropTargetClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
 *     ??$RemoveObject@UIActivationListenerInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E574 (--$RemoveObject@UIActivationListenerInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy.c)
 * Callees:
