/*
 * XREFs of ?UpdateSizeValid@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801372C8
 * Callers:
 *     ?Thunk_UpdateSizeValid_11@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180136CB0 (-Thunk_UpdateSizeValid_11@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControll.c)
