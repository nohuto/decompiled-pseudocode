/*
 * XREFs of ?OnLampArrayAdded@LampArrayRawInputProvider@@QEAAJPEAVPnpDevice@@@Z @ 0x1800E398C
 * Callers:
...
__int64 __fastcall LampArrayRawInputProvider::OnLampArrayAdded(LampArrayRawInputProvider *this, HSTRING *a2)
{
  ...
  RTL_SRWLOCK *v25; // [rsp+30h] [rbp-39h] BYREF
  HSTRING string; // [rsp+38h] [rbp-31h] BYREF
  ConsumerControlManager::ConsumerControlNexusDeviceListEntry *v27; // [rsp+40h] [rbp-29h] BYREF
  __int64 *v28; // [rsp+48h] [rbp-21h] BYREF
  __int64 v29; // [rsp+58h] [rbp-11h]
  _QWORD v30[4]; // [rsp+60h] [rbp-9h] BYREF
  ...
  if ( *((_DWORD *)a2 + 30) == 65625 )
  {
    ...
    if ( v5 )
    {
      ...
      *((_QWORD *)v5 + 1) = 0LL;
      *((_QWORD *)v5 + 2) = 0LL;
      v27 = (ConsumerControlManager::ConsumerControlNexusDeviceListEntry *)v5;
...
LABEL_12:
        ...
        std::wstring::wstring((__int64)v30, StringRawBuffer);
        ...
        if ( v16 != *v15 )
        {
          ...
          v20 = std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned long const,unsigned int>>>::_Extract(
                  (_QWORD *)this + 46,
                  v16,
                  v18,
                  v19);
...
LABEL_23:
    ...
    return v4;
         ...
         && (v23 = ConsumerControlManager::QueueAddRemoveDevice(
