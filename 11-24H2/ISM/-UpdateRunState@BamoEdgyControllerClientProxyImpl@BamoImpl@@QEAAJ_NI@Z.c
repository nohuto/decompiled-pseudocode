/*
 * XREFs of ?UpdateRunState@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180157350
 * Callers:
 *     ?Thunk_UpdateRunState_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180156FA0 (-Thunk_UpdateRunState_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@.c)
