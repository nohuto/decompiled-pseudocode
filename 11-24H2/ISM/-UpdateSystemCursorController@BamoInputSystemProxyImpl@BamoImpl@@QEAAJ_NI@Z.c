/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012CD18
 * Callers:
 *     ?Thunk_UpdateSystemCursorController_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126C60 (-Thunk_UpdateSystemCursorController_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bamo.c)
