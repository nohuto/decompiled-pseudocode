/*
 * XREFs of ??1?$unique_ptr@U_EVENT_TRACE_PROPERTIES@@U?$default_delete@U_EVENT_TRACE_PROPERTIES@@@std@@@std@@QEAA@XZ @ 0x1800D53B8
 * Callers:
 ...
 *     _TracingSessionHelper::StartOrStop_::_1_::dtor$1 @ 0x1801D5A11 (_TracingSessionHelper--StartOrStop_--_1_--dtor$1.c)
 * Callees:
