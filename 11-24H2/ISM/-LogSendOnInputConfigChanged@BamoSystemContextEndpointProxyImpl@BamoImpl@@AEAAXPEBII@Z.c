/*
 * XREFs of ?LogSendOnInputConfigChanged@BamoSystemContextEndpointProxyImpl@BamoImpl@@AEAAXPEBII@Z @ 0x180140ACC
 * Callers:
...
void __fastcall BamoImpl::BamoSystemContextEndpointProxyImpl::LogSendOnInputConfigChanged(
        ...
        const unsigned int *a2)
{
  ...
  const unsigned int *v8; // [rsp+68h] [rbp+10h] BYREF
