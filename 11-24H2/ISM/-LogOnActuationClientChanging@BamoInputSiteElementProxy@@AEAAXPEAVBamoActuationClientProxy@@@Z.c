/*
 * XREFs of ?LogOnActuationClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoActuationClientProxy@@@Z @ 0x18008BDBC
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnActuationClientChanging(
        BamoInputSiteElementProxy *this,
        struct BamoActuationClientProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
