/*
 * XREFs of ?UnregisterDeviceDockClient@DeviceDockServer@@QEAAJPEAVBamoDeviceDockClientProxy@@@Z @ 0x180181F34
 * Callers:
 *     ?OnDisconnected@DeviceDockClientProxy@@MEAAJXZ @ 0x180182C70 (-OnDisconnected@DeviceDockClientProxy@@MEAAJXZ.c)
 * Callees:
