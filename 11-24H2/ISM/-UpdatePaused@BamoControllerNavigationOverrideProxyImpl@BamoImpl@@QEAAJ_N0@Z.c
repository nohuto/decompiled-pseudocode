/*
 * XREFs of ?UpdatePaused@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18017831C
 * Callers:
 *     ?Thunk_UpdatePaused_11@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180177CF0 (-Thunk_UpdatePaused_11@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
