/*
 * XREFs of ?QueryDescriptor@InputSecurityDescriptor@@QEAAJW4TransientObject_Type@@PEBG@Z @ 0x18000F8A0
 * Callers:
 ...
 *     ?CreateEndpointToReceiveMessages@TestCommandHost@@AEAAXXZ @ 0x180092D70 (-CreateEndpointToReceiveMessages@TestCommandHost@@AEAAXXZ.c)
