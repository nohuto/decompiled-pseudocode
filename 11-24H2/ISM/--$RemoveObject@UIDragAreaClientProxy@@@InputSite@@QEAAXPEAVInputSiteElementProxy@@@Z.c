/*
 * XREFs of ??$RemoveObject@UIDragAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E788
 * Callers:
...
void __fastcall InputSite::RemoveObject<IDragAreaClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_e718b12a_faef_306d_9346_9fccb7899886, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
