/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoDockableDeviceStubImpl@BamoImpl@@UEAAJXZ @ 0x18017F770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDockableDeviceStubImpl::InitializeProxyUnderLockThunk(
