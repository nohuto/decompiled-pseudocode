/*
 * XREFs of ?GestureCancelled@InputGesture@InputETW@@SAXPEBGKPEAUtagPOINT@@11_KW4VirtualKeyModifiers@System@Windows@@2@Z @ 0x180098138
 * Callers:
 *     ?EventGestureCancelled@GestureHandler@@SAXKPEBGPEAVDragManagerClientProxy@@@Z @ 0x18008434C (-EventGestureCancelled@GestureHandler@@SAXKPEBGPEAVDragManagerClientProxy@@@Z.c)
