/*
 * XREFs of ?LogSetParentId@BamoActivatableEntityPrincipalImpl@BamoImpl@@AEAAX_K@Z @ 0x1800B0998
 * Callers:
...
void __fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::LogSetParentId(
