/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB480
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB510 (-QueryInterface@BamoSystemContextEndpointStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
