/*
 * XREFs of ?OnMouseSnappedToGaze@MPCManager@@QEAAXXZ @ 0x1800B7B14
 * Callers:
 ...
 *     ?MPCManager_OnMouseSnappedToGaze_@ISMTracing@@QEAAXXZ @ 0x1800B6D90 (-MPCManager_OnMouseSnappedToGaze_@ISMTracing@@QEAAXXZ.c)
