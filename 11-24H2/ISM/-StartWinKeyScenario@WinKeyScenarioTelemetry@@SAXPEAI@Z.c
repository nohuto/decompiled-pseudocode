/*
 * XREFs of ?StartWinKeyScenario@WinKeyScenarioTelemetry@@SAXPEAI@Z @ 0x18010BCC4
 * Callers:
 ...
 *     ?SetWinKeyScenarioStarted@WinKeyScenarioTelemetry@@CAX_N@Z @ 0x18010BC94 (-SetWinKeyScenarioStarted@WinKeyScenarioTelemetry@@CAX_N@Z.c)
 */
