/*
 * XREFs of ?UpdateActivationListenerInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180041A18
 * Callers:
 *     ?Thunk_UpdateActivationListenerInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072660 (-Thunk_UpdateActivationListenerInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
