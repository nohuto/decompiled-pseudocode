/*
 * XREFs of ?QueryInterface@BamoEdgyControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180156EB0
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180156F40 (-QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
