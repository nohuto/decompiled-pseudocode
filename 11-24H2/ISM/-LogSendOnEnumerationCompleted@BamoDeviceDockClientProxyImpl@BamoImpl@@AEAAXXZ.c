/*
 * XREFs of ?LogSendOnEnumerationCompleted@BamoDeviceDockClientProxyImpl@BamoImpl@@AEAAXXZ @ 0x180182C00
 * Callers:
...
void __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnEnumerationCompleted(
