/*
 * XREFs of ?Thunk_UpdateSecondaryClickZone_418@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180136CA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
