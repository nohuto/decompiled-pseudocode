/*
 * XREFs of ?LogOnIsPlayCountSupportedChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x1801191C0
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsPlayCountSupportedChanged(
