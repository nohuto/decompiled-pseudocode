/*
 * XREFs of ??$RemoveObject@UIContainerInfoInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005F804
 * Callers:
...
void __fastcall InputSite::RemoveObject<IContainerInfoInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_8ddffe9c_458e_6d51_c227_1374408f672c, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
