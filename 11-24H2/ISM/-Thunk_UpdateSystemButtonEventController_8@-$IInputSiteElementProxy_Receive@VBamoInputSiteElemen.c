/*
 * XREFs of ?Thunk_UpdateSystemButtonEventController_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072E30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
