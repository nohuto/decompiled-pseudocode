/*
 * XREFs of ?QueryInterface@BamoInputProcessPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC880
 * Callers:
 *     ?QueryInterface@BamoInputProcessPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC910 (-QueryInterface@BamoInputProcessPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
