/*
 * XREFs of ??$RemoveObject@UICUIHostInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005DE84
 * Callers:
...
void __fastcall InputSite::RemoveObject<ICUIHostInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_eec18fb6_8f64_46d4_277e_b7822e25ead1, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
