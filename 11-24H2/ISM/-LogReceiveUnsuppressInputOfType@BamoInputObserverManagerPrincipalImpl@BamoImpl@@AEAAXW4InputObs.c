/*
 * XREFs of ?LogReceiveUnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@AEAAXW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x180138754
 * Callers:
...
void BamoImpl::BamoInputObserverManagerPrincipalImpl::LogReceiveUnsuppressInputOfType()
{
  __int64 v0; // rbx
  __int64 v1; // r8
  int v2; // r9d
