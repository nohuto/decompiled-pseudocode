/*
 * XREFs of ?UpdateTestCommands@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012CEEC
 * Callers:
 *     ?Thunk_UpdateTestCommands_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180126C80 (-Thunk_UpdateTestCommands_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SA.c)
