/*
 * XREFs of ?RegisterShellHandwritingHostClient@BamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015BCA0
 * Callers:
 *     ?Thunk_RegisterShellHandwritingHostClient_8@?$IShellHandwritingHostServerPrincipal_Receive@VBamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015BE40 (-Thunk_RegisterShellHandwritingHostClient_8@-$IShellHandwritingHostServerPrincipal_Receive@VBamo.c)
 * Callees:
 ...
 *     ??1?$CalloutWrapper@VBamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x180075968 (--1-$CalloutWrapper@VBamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@.c)
        ...
        unsigned int a2)
{
  ...
  struct BamoShellHandwritingHostClientProxy *v10; // rbp
  ...
  BamoImpl::BamoShellHandwritingHostServerPrincipalImpl::LogReceiveRegisterShellHandwritingHostClient(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoShellHandwritingHostClientProxy *))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v6,
            v10);
    v4 = v17;
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellHandwritingHostServerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoShellHandwritingHostServerPrincipalImpl>((__int64)v18);
  }
  if ( v9 )
