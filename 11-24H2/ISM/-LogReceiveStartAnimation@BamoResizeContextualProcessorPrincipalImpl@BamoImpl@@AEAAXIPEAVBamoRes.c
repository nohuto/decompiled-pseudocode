/*
 * XREFs of ?LogReceiveStartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014F34C
 * Callers:
...
void __fastcall BamoImpl::BamoResizeContextualProcessorPrincipalImpl::LogReceiveStartAnimation(
