/*
 * XREFs of _DockDeviceCollection::Create_::_1_::dtor$4 @ 0x1801D5B28
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DockDeviceCollection::Create_::_1_::dtor_4(__int64 a1, _QWORD *a2)
{
