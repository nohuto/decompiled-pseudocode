        ...
        _QWORD *a4)
{
  ...
  else
  {
    ...
    v13 = a1 + 1;
    v11 = (char *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x20uLL);
    v14 = v11;
    *((_DWORD *)v11 + 4) = *a3;
    *(_QWORD *)(v11 + 20) = *a4;
