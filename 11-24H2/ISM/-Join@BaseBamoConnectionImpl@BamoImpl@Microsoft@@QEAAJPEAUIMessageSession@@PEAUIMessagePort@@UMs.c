/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x18000C550
 * Callers:
 ...
 * Callees:
 *     ??1?$RefPtr@UICoreUIClient@@@@QEAA@XZ @ 0x18000C14C (--1-$RefPtr@UICoreUIClient@@@@QEAA@XZ.c)
 *     StringLengthWorkerW @ 0x18000C978 (StringLengthWorkerW.c)
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x18000C9C0 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18000CA34 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
