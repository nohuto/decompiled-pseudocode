/*
 * XREFs of ?LogSendOnComponentWindowActivated@BamoCUIHostInputObjectProxyImpl@BamoImpl@@AEAAX_N@Z @ 0x1801317C0
 * Callers:
...
void __fastcall BamoImpl::BamoCUIHostInputObjectProxyImpl::LogSendOnComponentWindowActivated(
