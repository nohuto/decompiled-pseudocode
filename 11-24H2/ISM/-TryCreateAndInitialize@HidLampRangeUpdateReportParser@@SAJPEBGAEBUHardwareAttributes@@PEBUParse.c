/*
 * XREFs of ?TryCreateAndInitialize@HidLampRangeUpdateReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800EE69C
 * Callers:
 ...
 *     ??0HidLampRangeUpdateReportParser@@AEAA@XZ @ 0x1800EE250 (--0HidLampRangeUpdateReportParser@@AEAA@XZ.c)
