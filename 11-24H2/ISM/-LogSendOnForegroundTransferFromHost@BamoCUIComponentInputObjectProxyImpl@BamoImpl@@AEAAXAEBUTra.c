/*
 * XREFs of ?LogSendOnForegroundTransferFromHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@AEAAXAEBUTransferForegroundInfo@@@Z @ 0x1801324C4
 * Callers:
