/*
 * XREFs of ?EmitSetDefaultSDRBoostCommand@CCaptureControllerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022613C
 * Callers:
...
char __fastcall DirectComposition::CCaptureControllerMarshaler::EmitSetDefaultSDRBoostCommand(
