/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qi @ 0x1401204E0
 * Callers:
        ...
        ...)
{
  ...
  {
    LOWORD(v11) = a7;
    return WppAutoLogTrace(a4, 4LL, 1LL, &WPP_8b3d8589f9583a031a0fbbc3118bab56_Traceguids, v11, (__int64 *)va, 8LL, va1);
  }
  return result;
}
