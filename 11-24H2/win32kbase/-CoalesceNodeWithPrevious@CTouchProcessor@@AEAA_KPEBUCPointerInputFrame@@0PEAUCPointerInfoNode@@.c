/*
 * XREFs of ?CoalesceNodeWithPrevious@CTouchProcessor@@AEAA_KPEBUCPointerInputFrame@@0PEAUCPointerInfoNode@@KH@Z @ 0x1401F84B4
 * Callers:
 ...
 *     EtwTracePointerCoalesce @ 0x140104E80 (EtwTracePointerCoalesce.c)
