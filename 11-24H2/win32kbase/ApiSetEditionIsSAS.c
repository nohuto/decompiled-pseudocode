/*
 * XREFs of ApiSetEditionIsSAS @ 0x1401107FC
 * Callers:
...
__int64 __fastcall ApiSetEditionIsSAS(__int64 a1, __int64 a2)
{
  ...
  v3 = a1;
  v4 = 0;
  v5 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5648LL);
  if ( v5 )
  {
    if ( v5() >= 0 )
    {
      v8 = *(_QWORD *)(W32GetWin32kBaseApiSetTable(v7, v6) + 48);
      v9 = *(unsigned int (__fastcall **)(__int64, __int64))(v8 + 5656);
      if ( v9 )
      {
        LOBYTE(v8) = v3;
        return v9(v8, a2);
