/*
 * XREFs of ?TraceLoggingPTPUsageDetailsEvent@@YAXPEBUtagTPTELEMSTATE@@_J@Z @ 0x14013DAA4
 * Callers:
...
void __fastcall TraceLoggingPTPUsageDetailsEvent(const struct tagTPTELEMSTATE *a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned int)dword_14029AE68 > 5
    && (qword_14029AE78 & 0x200000000000LL) != 0
    && (qword_14029AE80 & 0x200000000000LL) == qword_14029AE80 )
  {
    v13 = *((_DWORD *)a1 + 37);
    v14 = *((_DWORD *)a1 + 36);
    v4 = *((_DWORD *)a1 + 35);
