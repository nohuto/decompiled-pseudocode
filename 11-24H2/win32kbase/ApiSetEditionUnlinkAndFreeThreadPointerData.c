/*
 * XREFs of ApiSetEditionUnlinkAndFreeThreadPointerData @ 0x140193500
 * Callers:
...
__int64 (*__fastcall ApiSetEditionUnlinkAndFreeThreadPointerData(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6448LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 6456LL);
      if ( result )
