/*
 * XREFs of ?Free@?$CTypeIsolation@$0NOAAA@$0NOA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14003DDAC
 * Callers:
 ...
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0NOAAA@$0NOA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14003DF34 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0NOAAA@$0NOA@@NSInstrumentation@@QEAA-AW4Alloc.c)
