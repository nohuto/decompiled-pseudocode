/*
 * XREFs of ConvertUserToKernelEventHandle @ 0x1401A74D0
 * Callers:
...
__int64 __fastcall ConvertUserToKernelEventHandle(void *a1, void **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v5 < 0 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 760);
    ObfDereferenceObject(v4);
  }
  else
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 748);
  }
