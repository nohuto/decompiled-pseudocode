/*
 * XREFs of ?Create@CEvent@DirectComposition@@SAJW4_EVENT_TYPE@@HPEAPEAV12@@Z @ 0x14006E2A4
 * Callers:
        ...
        struct DirectComposition::CEvent **a3)
{
  ...
  v4 = (struct DirectComposition::CEvent *)DirectComposition::Memory::AllocateAndClear_0(0x10uLL, 0x76654344u, a2 != 0);
  if ( v4 )
  {
    EventHandle = 0LL;
