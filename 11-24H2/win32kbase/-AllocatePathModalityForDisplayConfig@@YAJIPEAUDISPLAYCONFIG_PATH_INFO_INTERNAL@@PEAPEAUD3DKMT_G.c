/*
 * XREFs of ?AllocatePathModalityForDisplayConfig@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x14019C6B0
 * Callers:
  ...
  if ( v3 )
  {
    ...
    *a3 = v9;
    ...
    else
    {
      ...
      result = 3221225495LL;
      WdLogGlobalForLineNumber = 13769;
    }
  }
  else
  {
