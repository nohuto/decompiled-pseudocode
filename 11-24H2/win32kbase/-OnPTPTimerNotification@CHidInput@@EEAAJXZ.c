/*
 * XREFs of ?OnPTPTimerNotification@CHidInput@@EEAAJXZ @ 0x14012E3E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPTimerNotification(CHidInput *this)
{
  ...
  InputTraceLogging::ThreadLockedPerfRegion::ThreadLockedPerfRegion(&v12, "OnPTPTimerNotification", 0LL);
  ...
  if ( v7 )
  {
    ...
    {
      v11 = 0;
      PTPEngineTraceProducer::OnEvent(*((PTPEngineTraceProducer **)Processor + 69), (struct PTPEngineEvent *)&v11);
    }
  }
