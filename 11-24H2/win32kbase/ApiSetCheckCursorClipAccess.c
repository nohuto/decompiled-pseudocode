/*
 * XREFs of ApiSetCheckCursorClipAccess @ 0x140047744
 * Callers:
...
__int64 __fastcall ApiSetCheckCursorClipAccess(unsigned int a1, unsigned int a2)
{
  ...
  v4 = 0;
  v5 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable() + 48) + 7280LL);
  if ( v5 )
  {
    if ( v5() >= 0 )
    {
      v6 = *(unsigned int (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable() + 48) + 7288LL);
      if ( v6 )
        return v6(a1, a2);
    }
  }
