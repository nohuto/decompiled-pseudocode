/*
 * XREFs of ?UpdateStateIndicator@CTouchProcessor@@QEAAXPEAUCInputPointerNode@@I_KUtagPOINT@@@Z @ 0x14020A134
 * Callers:
...
LABEL_54:
  ...
  else if ( (a3 & 0x40004) != 0 )
  {
    ...
    if ( (_BYTE)y || v11 )
    {
      v14 = &WPP_61ce117451293dedbe606f30fcdcf8fb_Traceguids;
      v17 = 65;
      goto LABEL_54;
    }
  }
