/*
 * XREFs of ?DelegateChainingResetAndCoalescePointerMessage@CTouchProcessor@@QEAAH_KHHHI@Z @ 0x1401F9BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  PERESOURCE *v22[8]; // [rsp+20h] [rbp-68h] BYREF
  ...
  if ( *((_DWORD *)v13 + 8) >= *(_DWORD *)(v14 + 48) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6064);
  v16 = *(_QWORD *)(v15 + 240) + 480LL * *((unsigned int *)v13 + 8);
  if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v16) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6066);
  if ( *(_WORD *)(v16 + 172) != *((_WORD *)v13 + 8) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6067);
  if ( !a5 )
  {
    if ( a4 )
      goto LABEL_11;
