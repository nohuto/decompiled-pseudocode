/*
 * XREFs of ??_GCLinearGradientLegacyMilBrushMarshaler@DirectComposition@@UEAAPEAXI@Z @ 0x14022CF00
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall DirectComposition::CLinearGradientLegacyMilBrushMarshaler::`scalar deleting destructor'(
        ...
        char a2)
{
  DirectComposition::CResourceMarshalerArray<DirectComposition::CResourceMarshaler,184,32,659,660>::~CResourceMarshalerArray<DirectComposition::CResourceMarshaler,184,32,659,660>((DirectComposition::CMarshaledArrayBase *)(Buffer + 104));
  if ( (a2 & 1) != 0 )
