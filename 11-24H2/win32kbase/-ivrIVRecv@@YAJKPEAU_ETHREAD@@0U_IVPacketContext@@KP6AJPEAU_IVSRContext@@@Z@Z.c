/*
 * XREFs of ?ivrIVRecv@@YAJKPEAU_ETHREAD@@0U_IVPacketContext@@KP6AJPEAU_IVSRContext@@@Z@Z @ 0x14021777C
 * Callers:
...
__int64 __fastcall ivrIVRecv(__int64 a1, __int64 a2, __int64 a3, __int128 *a4, int a5, __int64 a6)
{
  ...
  v9 = a1;
  v10 = *(__int64 (__fastcall **)(_QWORD, __int64, __int64, __int128 *, int, __int64))(W32GetUserSessionState(a1) + 19632);
  if ( !v10 )
    return 3221225659LL;
  v11 = *((_QWORD *)a4 + 2);
  v13 = *a4;
