/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1400FE490
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  v4 = qword_14029AE80;
  v6 = dword_14029AE68;
  if ( (unsigned int)dword_14029AE68 > 5 && (qword_14029AE78 & 5) != 0 && (qword_14029AE80 & 5) == qword_14029AE80 )
  {
    v10 = a2;
    v11 = 20;
    v13 = *((_QWORD *)this + 23);
  ...
  if ( *((_DWORD *)a2 + 4) && v6 > 5 && (qword_14029AE78 & 5) != 0 && (v4 & 5) == v4 )
  {
    v8 = *((_WORD *)a2 + 8);
