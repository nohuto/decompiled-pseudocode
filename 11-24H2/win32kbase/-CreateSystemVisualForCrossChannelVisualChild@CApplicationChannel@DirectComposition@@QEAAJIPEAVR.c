/*
 * XREFs of ?CreateSystemVisualForCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIPEAVResourceHandle@@@Z @ 0x14004C1C8
 * Callers:
        ...
        struct ResourceHandle *a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      v7 = (DirectComposition::CVisualMarshaler *)DirectComposition::Memory::AllocateAndClear(0x188uLL, 0x63784344u, 1);
      v8 = v7;
      if ( v7 )
      {
        ...
        *((_QWORD *)v8 + 47) = (char *)v8 + 376;
              ...
              SystemResource >= 0) )
        {
          ...
          *v11 = v12;
          ...
          v13 = *(_QWORD *)v8;
          v14 = 0;
          SystemResource = (*(__int64 (__fastcall **)(DirectComposition::CVisualMarshaler *, DirectComposition::CConnection **, __int64, _QWORD, _QWORD, char *))(v13 + 328))(
                             v8,
                             this,
                             v6,
                             0LL,
