/*
 * XREFs of ?AllocateSharedSection@@YAJKPEAPEAX00@Z @ 0x1401C2ACC
 * Callers:
...
__int64 __fastcall AllocateSharedSection(unsigned int a1, void **a2, void **a3, void **a4)
{
  ...
  v13 = 0LL;
  v16 = 0LL;
  if ( !Gre::MapViewOfSectionObj::Map((__int64)&v14, v12, 1LL, v4, &v13) )
  {
...
LABEL_2:
  ...
  v13 = 0LL;
  v21 = 0LL;
  if ( Gre::MapViewOfSectionObj::Map((__int64)&v19, (__int64)v9, 2LL, v4, &v13) )
  {
    v11 = (void *)v21;
    *a4 = (void *)v16;
    *a3 = v11;
