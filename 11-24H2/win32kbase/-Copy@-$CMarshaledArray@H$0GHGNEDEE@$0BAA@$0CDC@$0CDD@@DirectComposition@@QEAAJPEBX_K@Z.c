/*
 * XREFs of ?Copy@?$CMarshaledArray@H$0GHGNEDEE@$0BAA@$0CDC@$0CDD@@DirectComposition@@QEAAJPEBX_K@Z @ 0x1402257E8
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<int,1735213892,256,562,563>::Copy(
        DirectComposition::CMarshaledArrayBase *a1,
        const void *a2,
        unsigned __int64 a3)
{
  return DirectComposition::CMarshaledArrayBase::Copy(a1, a2, a3, 4uLL, 0x676D4344u);
}
