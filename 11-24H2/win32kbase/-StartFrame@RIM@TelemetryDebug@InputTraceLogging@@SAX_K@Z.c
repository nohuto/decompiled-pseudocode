/*
 * XREFs of ?StartFrame@RIM@TelemetryDebug@InputTraceLogging@@SAX_K@Z @ 0x1400FFE00
 * Callers:
...
void __fastcall InputTraceLogging::TelemetryDebug::RIM::StartFrame()
{
  ...
  if ( (unsigned int)dword_14029AE30 > 7 && tlgKeywordOn((__int64)&dword_14029AE30, 0x10000LL) )
  {
    v2 = v0;
