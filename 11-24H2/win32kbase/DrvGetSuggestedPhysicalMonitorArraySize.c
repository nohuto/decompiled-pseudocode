/*
 * XREFs of DrvGetSuggestedPhysicalMonitorArraySize @ 0x14008DF80
 * Callers:
...
__int64 __fastcall DrvGetSuggestedPhysicalMonitorArraySize(struct _UNICODE_STRING *a1, __int64 a2, _DWORD *a3)
{
  __int64 result; // rax
  int v5; // ebx
  unsigned int i; // r14d
