/*
 * XREFs of ?CommitFramePointer@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@@Z @ 0x1400E2AF8
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a3)
{
  ...
  if ( (unsigned int)(v3 - 1) > 3 )
  {
    ...
    else if ( (unsigned int)dword_14029AE30 > 4 && tlgKeywordOn((__int64)&dword_14029AE30, 32LL) )
    {
