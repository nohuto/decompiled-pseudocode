/*
 * XREFs of ?HandleCapture_BreakHasMouseOwner@CMouseProcessor@@AEAA?AVCInputDest@@AEBV2@AEBVCButtonEvent@1@@Z @ 0x14021D0E8
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 3904), 1, 1) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4443);
  if ( *(_DWORD *)(a4 + 32) != 2 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4444);
  CInputDest::CInputDest(a2, (const struct CInputDest *)(a1 + 3784));
  CInputDest::GetThreadInfo((CInputDest *)(a1 + 3784));
  ...
  if ( ThreadInfo || !CInputDest::operator==((int *)(a1 + 3784), (__int64)a3) )
  {
LABEL_10:
    PtiFromInputDest = anonymous_namespace_::GetPtiFromInputDest(a3, 2);
    if ( PtiFromInputDest )
...
LABEL_13:
  if ( (*(_DWORD *)(*(_QWORD *)(a4 + 8) + 120LL) & 2) != 0 )
  {
    ...
    CBaseProcessor::PostQEventWork(v14, WindowHandle, 0, 0, 0LL, 0LL);
  }
  v15 = ~(unsigned int)CMouseProcessor::CButtonEvent::GetHardwareButton(a4);
  v16 = (v15 & *(_DWORD *)(a1 + 3780)) == 0;
  *(_DWORD *)(a1 + 3780) &= v15;
  if ( v16 )
    CMouseProcessor::MouseOwner::Clear((CMouseProcessor::MouseOwner *)(a1 + 3784));
  return a2;
}
