/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qqDqq @ 0x14019C388
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_qqDqq(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  __int64 result; // rax
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_2eef1cb2cf433bc9240e3b515d9d6f93_Traceguids,
               12LL,
               (__int64 *)va,
               8LL,
               (__int64 *)va1,
