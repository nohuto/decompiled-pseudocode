/*
 * XREFs of ?AllocateSessionGlobalsArea@Base@Gre@@YA_NXZ @ 0x14014236C
 * Callers:
...
bool __fastcall Gre::Base::AllocateSessionGlobalsArea(Gre::Base *this)
{
  ...
  v2 = (_OWORD *)PALLOCMEM(5760LL, 0x31474747u);
  *(_QWORD *)(SessionState + 88) = v2;
  if ( v2 )
  {
    ...
    *(_DWORD *)(v7 + 1248) = 1;
    *(_DWORD *)(v7 + 1252) = 1;
    *(_OWORD *)(v7 + 3676) = xmmword_1402656B0;
    *(_OWORD *)(v7 + 3692) = xmmword_1402656C0;
    *(_OWORD *)(v7 + 3708) = xmmword_1402656D0;
    *(_OWORD *)(v7 + 3724) = xmmword_1402656E0;
    *(_OWORD *)(v7 + 3740) = xmmword_1402656F0;
    ...
    *(_OWORD *)(v7 + 5712) = xmmword_140265690;
    *(_DWORD *)(v7 + 4256) = 0;
    *(_QWORD *)(v7 + 4232) = v7 + 4168;
    *(_OWORD *)(v7 + 5728) = xmmword_1402656A0;
    *(_DWORD *)(v7 + 4244) = 4096;
    *(_QWORD *)(v7 + 5744) = 0LL;
    *(_DWORD *)(v7 + 5752) = 0;
  }
