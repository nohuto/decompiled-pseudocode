/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x14010D16C
 * Callers:
 ...
 *     ValidateKbdNLSTable @ 0x14015A188 (ValidateKbdNLSTable.c)
 *     strcmp_0 @ 0x14023F37A (strcmp_0.c)
...
struct tagKbdLayer *__fastcall ReadLayoutFile(struct tagKBDFILE *a1, void *a2, unsigned int a3, unsigned int a4)
{
  ...
  v7 = 0;
  v9 = a1;
  v10 = *(HANDLE *)(W32GetUserSessionState(a1) + 63584);
  v173 = v10;
