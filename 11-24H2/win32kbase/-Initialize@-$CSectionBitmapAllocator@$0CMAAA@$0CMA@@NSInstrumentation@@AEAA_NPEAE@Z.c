/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x14023E73C
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<180224,704>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v9 = (struct _RTL_BITMAP *)ExAllocatePool2(258LL, 44LL, 1869834581LL);
  v10 = v9;
  if ( !v9 )
    return 0;
  RtlInitializeBitMap(v9, &v9[1].SizeOfBitMap, 0xDCu);
  RtlClearAllBits(v10);
  result = 1;
  v12 = a2 ^ a1[2];
