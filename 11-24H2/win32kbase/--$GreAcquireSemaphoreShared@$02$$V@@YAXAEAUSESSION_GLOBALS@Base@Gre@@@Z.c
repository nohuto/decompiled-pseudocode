/*
 * XREFs of ??$GreAcquireSemaphoreShared@$02$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x14002115C
 * Callers:
...
__int64 __fastcall GreAcquireSemaphoreShared<3,>(_QWORD *a1, __int64 a2, int a3)
{
  ...
  EtwTraceGreLockAcquireSemaphoreShared((__int64)L"DCVisRgn", *a1 + 728, a3);
  ...
  if ( v9 )
  {
    if ( (*v9 & 0xFFFFFFFFFFFFFFF8uLL) != 0 && (*v9 & 8) == 0 )
    {
      v7 = 0LL;
      v13 = 37;
      do
    ...
    LOBYTE(v7) = *(_BYTE *)(((v5 + 8) & -(__int64)(v5 != 0)) + 0xB);
    result = (unsigned int)(v7 + 1);
    *(_BYTE *)(((v5 + 8) & -(__int64)(v5 != 0)) + 0xB) = v7 + 1;
    if ( !(_BYTE)v7 )
      *v9 |= 8uLL;
  }
  return result;
