/*
 * XREFs of ?SetReferenceProperty@CCompositionSpotLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x140071AC0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  else if ( v5 == *((struct DirectComposition::CResourceMarshaler **)this + 14)
