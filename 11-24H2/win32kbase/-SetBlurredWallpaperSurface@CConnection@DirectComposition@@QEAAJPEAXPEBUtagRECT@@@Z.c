/*
 * XREFs of ?SetBlurredWallpaperSurface@CConnection@DirectComposition@@QEAAJPEAXPEBUtagRECT@@@Z @ 0x140070C10
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  *((_BYTE *)v3 + 8) = 1;
  if ( !*((_QWORD *)this + 38) || *((_QWORD *)this + 38) == PsGetCurrentProcess(v8, v7, v9, v10) )
