/*
 * XREFs of ?InputApc@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBU_IO_STATUS_BLOCK@@@Z @ 0x1400AF394
 * Callers:
      ...
      else
      {
          ...
          && (qword_14029AE48 & 0x100) == qword_14029AE48 )
        {
          ...
          *(_DWORD *)&EventDescriptor.Id = 184549376;
          ...
          EtwWriteTransfer(qword_14029AE50, &EventDescriptor, 0LL, 0LL, 9u, &UserData);
        }
      }
    }
