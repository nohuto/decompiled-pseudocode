/*
 * XREFs of ?RemoveVisualChild@CApplicationChannel@DirectComposition@@QEAAJII@Z @ 0x14008093C
 * Callers:
        ...
        int a3)
{
  ...
  if ( v6 )
  {
       ...
       && (v5 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v16 + 192LL))(v16)) != 0) )
    {
      v10 = *(_QWORD *)v7;
      if ( v5 )
        v11 = (*(__int64 (__fastcall **)(__int64, DirectComposition::CApplicationChannel *, __int64, char *))(v10 + 336))(
                v7,
                this,
                v5,
                &v17);
      else
        v11 = (*(__int64 (__fastcall **)(__int64, DirectComposition::CApplicationChannel *, char *))(v10 + 344))(
                v7,
                this,
                &v17);
      v8 = v11;
      if ( v11 >= 0 )
      {
        if ( v17 )
        {
          ...
          if ( (v12 & 2) == 0 )
          {
            ...
            {
              v13 = *(_DWORD *)(v7 + 36);
              for ( i = v13; (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
              {
                if ( (_DWORD)i == 158 )
                {
                  v15 = 456LL;
