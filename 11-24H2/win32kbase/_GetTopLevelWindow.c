/*
 * XREFs of _GetTopLevelWindow @ 0x14012BDFC
 * Callers:
...
__int64 (__fastcall *__fastcall GetTopLevelWindow(__int64 a1, __int64 a2))(__int64)
{
  __int64 (__fastcall *result)(__int64); // rax

  result = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 3560LL);
  if ( result )
