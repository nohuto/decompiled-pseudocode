/*
 * XREFs of ?UploadForFloodFill@RGNCOREOBJ@@QEAAJPEBJKPEAJK@Z @ 0x1400647D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vMerge@RGNCOREOBJ@@CAXPEBU_INDEX_LONG@@KPEBU_SPAN@@KPEAJJ@Z @ 0x1401CF190 (-vMerge@RGNCOREOBJ@@CAXPEBU_INDEX_LONG@@KPEBU_SPAN@@KPEAJJ@Z.c)
