/*
 * XREFs of EditionIsPointerQueuedMessageCoalescable @ 0x1401292EC
 * Callers:
        ...
        int a6))(_OWORD *, __int64, _QWORD, _QWORD, __int64, int)
{
  ...
  result = *(__int64 (__fastcall **)(_OWORD *, __int64, _QWORD, _QWORD, __int64, int))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(
                                                                                                     a1,
                                                                                                     a2)
                                                                                                 + 48)
                                                                                     + 6600LL);
