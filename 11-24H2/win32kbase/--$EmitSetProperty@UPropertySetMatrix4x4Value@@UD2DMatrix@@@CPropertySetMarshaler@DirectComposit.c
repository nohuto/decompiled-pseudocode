/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix4x4Value@@UD2DMatrix@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x14007B118
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v12 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x5CuLL, &v12);
  v8 = (char *)v12;
  *(_DWORD *)v12 = 92;
  *(_OWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 20) = 0LL;
