/*
 * XREFs of ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick @ 0x1401918D8
 * Callers:
...
__int64 (*__fastcall ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick(__int64 a1, __int64 a2))(void)
{
  ...
  v2 = a2;
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6768LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 6776LL);
      if ( result )
