/*
 * XREFs of ?Initialize@CBufferCollectionResource@DirectComposition@@IEAAJPEAPEAX_KU_LUID@@@Z @ 0x14022558C
 * Callers:
 *     ?ObjectInit@BufferCollectionObject@DirectComposition@@KAJPEAUCompositionObject@@PEAXPEAPEAVICompositionObject@@@Z @ 0x1402245D0 (-ObjectInit@BufferCollectionObject@DirectComposition@@KAJPEAUCompositionObject@@PEAXPEAPEAVIComp.c)
 * Callees:
