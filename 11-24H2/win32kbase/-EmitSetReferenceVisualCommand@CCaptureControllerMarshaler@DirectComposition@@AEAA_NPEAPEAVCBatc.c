/*
 * XREFs of ?EmitSetReferenceVisualCommand@CCaptureControllerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140226858
 * Callers:
...
char __fastcall DirectComposition::CCaptureControllerMarshaler::EmitSetReferenceVisualCommand(
