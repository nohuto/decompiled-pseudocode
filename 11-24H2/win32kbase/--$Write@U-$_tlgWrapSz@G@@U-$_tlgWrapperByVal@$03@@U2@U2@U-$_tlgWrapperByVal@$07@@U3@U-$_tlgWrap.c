        ...
        __int64 a11)
{
  ...
  const WCHAR *v16; // [rsp+50h] [rbp-61h]
  ...
  v16 = v11;
  v18 = 0;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14029ADF8, a2, a3, 0LL, 9, v15);
}
