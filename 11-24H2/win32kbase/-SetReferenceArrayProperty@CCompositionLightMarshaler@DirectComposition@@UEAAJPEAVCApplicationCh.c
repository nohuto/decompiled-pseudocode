/*
 * XREFs of ?SetReferenceArrayProperty@CCompositionLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x140104A50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  if ( v10 < a5 )
  {
    ...
    if ( v11 )
    {
      for ( i = *((unsigned int *)v11 + 9); (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
      {
        if ( (_DWORD)i == 184 )
        {
          ++v10;
