/*
 * XREFs of ?SetPointerInfoNodeTargetInt@CTouchProcessor@@AEAAXPEAUCPointerInfoNode@@AEBVCInputDest@@HPEBUtagPOINT@@HHHH@Z @ 0x1400C4B28
 * Callers:
        ...
        int a9)
{
  ...
  {
    v17 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 12017LL);
  }
  *((_DWORD *)a2 + 1) &= ~0x100u;
  ...
  *(_DWORD *)a2 = v14;
  ...
  {
    if ( a9 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 12057LL);
    *(_DWORD *)a2 &= ~0x200u;
    v14 = *(_DWORD *)a2;
  }
  if ( a7 )
