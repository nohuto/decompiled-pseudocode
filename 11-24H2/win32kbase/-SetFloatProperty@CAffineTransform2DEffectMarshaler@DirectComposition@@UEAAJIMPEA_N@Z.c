/*
 * XREFs of ?SetFloatProperty@CAffineTransform2DEffectMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1402309A0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( (unsigned int)(a2 - 8) <= 5 )
  {
    v6 = 1;
    v7 = (a2 & 1) + 2 * ((unsigned __int64)(unsigned int)(a2 - 8) >> 1);
