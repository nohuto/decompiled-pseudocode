/*
 * XREFs of RIMGetDeviceButtons @ 0x1401E05C8
 * Callers:
 ...
 *     RIMPbuttonToCursor @ 0x140148574 (RIMPbuttonToCursor.c)
...
LABEL_44:
      ...
      *(_QWORD *)(a2 + 1032) = v24;
      if ( v24 )
      {
        ...
        {
          LODWORD(v41) = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3018);
        }
        if ( v36 )
        {
