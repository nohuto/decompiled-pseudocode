/*
 * XREFs of ?IsPropertyAnimatable@CHueRotationEffectMarshaler@DirectComposition@@UEAA_NIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x14022DA40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CHueRotationEffectMarshaler::IsPropertyAnimatable(__int64 a1, __int64 a2, int a3)
{
  if ( (_DWORD)a2 == 4 )
    return a3 == 18;
  else
