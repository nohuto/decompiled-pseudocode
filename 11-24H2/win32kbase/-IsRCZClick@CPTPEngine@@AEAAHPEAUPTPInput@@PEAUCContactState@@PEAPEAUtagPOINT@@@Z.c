/*
 * XREFs of ?IsRCZClick@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@PEAPEAUtagPOINT@@@Z @ 0x1400DC9D0
 * Callers:
        ...
        struct tagPOINT **a4)
{
  ...
  if ( v9 )
  {
    ...
    do
    {
      if ( (*((_DWORD *)v8 + 82 * (v11[-5].y % v10) + 204) & 0x20000000) != 0 )
      {
        v16 = (unsigned int)((__int64 (__fastcall *)(_QWORD, _QWORD))PtInRect)((char *)v8 + 3008, *v11)
           && (unsigned int)PtInRect(v13, *((_QWORD *)v15 + 4));
        if ( (v14 & 1) != 0 )
          v16 = v16 && (v14 & 0x40) == 0 && (v14 & 0x10000000) == 0;
        v17 = *((_QWORD *)v15 + 9);
