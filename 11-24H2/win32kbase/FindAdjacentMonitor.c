/*
 * XREFs of FindAdjacentMonitor @ 0x140110194
 * Callers:
 ...
 *     ?ComputeAdjacencyOverlap@@YAJPEBUtagRECT@@0@Z @ 0x140110234 (-ComputeAdjacencyOverlap@@YAJPEBUtagRECT@@0@Z.c)
 */
...
__int64 __fastcall FindAdjacentMonitor(struct tagRECT *a1, unsigned int a2)
{
  ...
  v4 = 0LL;
  v5 = 0;
  v6 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(a1) + 57008) + 112LL);
  while ( v6 )
  {
    v7 = v5;
