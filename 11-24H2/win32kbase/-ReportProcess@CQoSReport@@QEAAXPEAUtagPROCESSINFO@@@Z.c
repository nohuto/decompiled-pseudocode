/*
 * XREFs of ?ReportProcess@CQoSReport@@QEAAXPEAUtagPROCESSINFO@@@Z @ 0x1401A56D0
 * Callers:
...
void __fastcall CQoSReport::ReportProcess(CQoSReport *this, struct tagPROCESSINFO *a2)
{
  ...
  {
    PsProcessWindowState = tagPROCESSINFO::GetPsProcessWindowState((__int64)a2, 0);
  ...
  if ( !(unsigned int)Feature_AgenticSessionCapQoSPolicy__private_IsEnabledDeviceUsageNoInline() )
    return;
  v11 = tagPROCESSINFO::GetPsProcessWindowState((__int64)a2, 1);
  v12 = (_QWORD *)((char *)a2 + 1144);
  v13 = (_QWORD *)*((_QWORD *)a2 + 143);
  if ( v13 == (_QWORD *)((char *)a2 + 1144) )
  {
    if ( !v11 )
      return;
...
LABEL_19:
  ...
  if ( !v11 )
  {
    if ( (_QWORD *)v13[1] == v12 )
    {
      v16 = (_QWORD *)*((_QWORD *)a2 + 144);
      if ( (_QWORD *)*v16 == v12 )
      {
        *v16 = v13;
        v13[1] = v16;
        *((_QWORD *)a2 + 144) = (char *)a2 + 1144;
        *v12 = v12;
        return;
      }
    }
