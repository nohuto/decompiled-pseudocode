/*
 * XREFs of ?DoTPDiscreteButtonProcessing@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1400CBE50
 * Callers:
  ...
  if ( v4 )
  {
      ...
      if ( __CFSHR__(v8, 17) )
      {
        if ( (v8 & 0x10) != 0 && (v8 & 0x40) != 0 && (v8 & 0x100) == 0 )
        {
          *((_QWORD *)this + 380) = *(_QWORD *)a2;
          CPTPEngine::SendMouseUpAtPoint(this, 0x10u, *(struct tagPOINT *)((char *)a2 + 28));
        }
        *((_DWORD *)this + 768) &= ~0x40u;
      }
      else
      {
        ...
        {
          *((_QWORD *)this + 380) = *(_QWORD *)a2;
          CPTPEngine::SendMouseUpAtPoint(this, 4u, *(struct tagPOINT *)((char *)a2 + 28));
        }
        *((_DWORD *)this + 768) &= ~0x20u;
      }
      goto LABEL_6;
    }
    v12 = *((_DWORD *)this + 697);
    if ( __CFSHR__(v8, 17) )
    {
      ...
      *((_DWORD *)this + 768) = v13;
      ...
      if ( (v13 & 0x10) != 0 )
        goto LABEL_6;
      CBasePTPEngine::SendLastActionTelemetry(this, 6LL);
      v14 = 8;
    }
    else
    {
      ...
      *((_DWORD *)this + 768) = v15;
      ...
      if ( (v15 & 8) != 0 )
        goto LABEL_6;
      CBasePTPEngine::SendLastActionTelemetry(this, 5LL);
      v14 = 2;
    }
...
LABEL_6:
  ...
  if ( !v10 )
  {
    if ( __CFSHR__(*((_DWORD *)this + 768), 17) )
    {
