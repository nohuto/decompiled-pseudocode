/*
 * XREFs of ?DrvChangeDisplayFallback@@YAJPEAXEEPEAU_MDEV@@PEAPEAU1@PEAW4_DXGK_DIAG_SDC_STAGE@@PEAEPEAJ@Z @ 0x1401522D8
 * Callers:
        ...
        int *a8)
{
  ...
  if ( *(_DWORD *)(v12 + 1128) )
  {
    ...
    WdLogGlobalForLineNumber = 15102;
  }
  if ( a3 )
    *(_DWORD *)(v12 + 1128) = 1;
  if ( *(_DWORD *)(v12 + 1132) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 15117;
  }
  *(_DWORD *)(v12 + 1132) = 1;
