/*
 * XREFs of ?RedirectMouseToHwnd@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAUHWND__@@PEBUtagMsgRoutingInfo@@KK@Z @ 0x1400FFF64
 * Callers:
 ...
 *     ?SetMouseConfigHelper@DirectComposition@@YAXU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMousePrimitiveType@@@@00PEAU2@@Z @ 0x140233808 (-SetMouseConfigHelper@DirectComposition@@YAXU-$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMouse.c)
