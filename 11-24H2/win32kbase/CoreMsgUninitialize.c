/*
 * XREFs of CoreMsgUninitialize @ 0x1400FC290
 * Callers:
 *     ?Win32KBaseDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x140164AC0 (-Win32KBaseDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 * Callees:
 *     ?Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ @ 0x1400FBCF4 (-Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ.c)
 *     ?Free@Runtime@CoreMessagingK@@SAXPEAXW4PoolTag@2@@Z @ 0x1400FC5B8 (-Free@Runtime@CoreMessagingK@@SAXPEAXW4PoolTag@2@@Z.c)
 *     ?Uninitialize@Log@CoreMessagingK@@SAXXZ @ 0x14019E7FC (-Uninitialize@Log@CoreMessagingK@@SAXXZ.c)
