/*
 * XREFs of ?Free@?$CTypeIsolation@$0BEAAA@$0BEA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14003FF38
 * Callers:
 ...
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14003FCE4 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<81920,320>::Free(__int64 *a1, void *a2)
{
  ...
  NSInstrumentation::CSectionBitmapAllocator<81920,320>::Free((__int64)v6, a2);
  if ( i == (__int64 *)*a1 )
    goto LABEL_8;
