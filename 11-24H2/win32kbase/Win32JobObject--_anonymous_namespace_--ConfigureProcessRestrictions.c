/*
 * XREFs of Win32JobObject::_anonymous_namespace_::ConfigureProcessRestrictions @ 0x1401A9B8C
 * Callers:
        ...
        int a2))(__int64)
{
  ...
  if ( !(_DWORD)result )
    *(_QWORD *)(a1 + 816) |= 0x4000000uLL;
  if ( (a2 & 0x100) != 0 )
  {
    result = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v8, v7) + 48) + 640LL);
    if ( result )
