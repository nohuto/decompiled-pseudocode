/*
 * XREFs of ?TPAAPShouldAllowNow@CPTPEngine@@AEAAHPEAUPTPInput@@KH@Z @ 0x1400EF2C8
 * Callers:
...
__int64 __fastcall CPTPEngine::TPAAPShouldAllowNow(CPTPEngine *this, struct PTPInput *a2)
{
  ...
  {
    v14 = v10 & 2;
    if ( v14 && (*(_DWORD *)(v9 + 3072) & 0x8000) != 0 )
    {
      v4 = 1;
    }
    else
    {
      ...
      if ( (v13 & 0x6C) != 0 )
      {
        if ( v15 == 32 )
        {
          v16 = *(_DWORD *)(v12 + 4LL * SensitivityLevel + 3308);
        }
        else
        {
          v16 = *(_DWORD *)(v12 + 4LL * SensitivityLevel + 3288);
          if ( v15 == 64 )
            v16 = *(_DWORD *)(v12 + 4LL * SensitivityLevel + 3328);
        }
        v5 = *(_QWORD *)(v8 + 8);
        v6 = *(_QWORD *)(v8 + 16);
        if ( v5 > 0 )
