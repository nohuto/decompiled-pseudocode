/*
 * XREFs of CitModerncoreProcessForegroundChange @ 0x14023CE08
 * Callers:
...
void __fastcall CitModerncoreProcessForegroundChange(int a1, int a2)
{
  ...
  CitpProcessForegroundChange(v2, 0LL, v4);
}
