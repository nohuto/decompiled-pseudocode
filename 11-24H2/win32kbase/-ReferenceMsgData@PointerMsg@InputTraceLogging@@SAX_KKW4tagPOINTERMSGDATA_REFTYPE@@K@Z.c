/*
 * XREFs of ?ReferenceMsgData@PointerMsg@InputTraceLogging@@SAX_KKW4tagPOINTERMSGDATA_REFTYPE@@K@Z @ 0x1400F3E30
 * Callers:
 ...
 *     ?PointerMsgRefTypeToString@InputTraceLogging@@CAPEBDW4tagPOINTERMSGDATA_REFTYPE@@@Z @ 0x14020222C (-PointerMsgRefTypeToString@InputTraceLogging@@CAPEBDW4tagPOINTERMSGDATA_REFTYPE@@@Z.c)
 */
...
void __fastcall InputTraceLogging::PointerMsg::ReferenceMsgData(__int64 a1, __int64 a2, unsigned int a3, int a4)
{
  ...
  if ( (unsigned int)dword_14029AE30 > 6
    && (qword_14029AE40 & 0x20000) != 0
    && (qword_14029AE48 & 0x20000) == qword_14029AE48 )
  {
    v8 = a4;
