/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x140124FC4
 * Callers:
...
LABEL_22:
        ...
        {
          if ( (unsigned int)dword_14029AEA0 > 5
            && (qword_14029AEB0 & 0x400000000000LL) != 0
            && (qword_14029AEB8 & 0x400000000000LL) == qword_14029AEB8 )
          {
            v15 = -1LL;
            do
              ++v15;
            ...
            *(_DWORD *)&EventDescriptor.Level = 5;
            UserData.Ptr = (ULONGLONG)off_14029AEA8;
            v26 = (char *)this + 12;
            v28 = 0;
            *(_DWORD *)&EventDescriptor.Id = 184549376;
            UserData.Size = *(unsigned __int16 *)off_14029AEA8;
            v23 = &unk_14027A599;
            UserData.Reserved = 2;
            v24 = 37;
            v25 = 1;
            EtwWriteTransfer(qword_14029AEC0, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
          }
          v16 = 1;
          v17 = 1;
          v2 = 0LL;
...
LABEL_18:
        ...
        if ( v6 >= *((_DWORD *)this + 1) )
        {
          if ( v2 )
          {
            if ( (unsigned int)dword_14029AEA0 > 5 && tlgKeywordOn((__int64)&dword_14029AEA0, 0x400000000000LL) )
            {
              v20 = (char *)this + 12;
              _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
                (__int64)&dword_14029AEA0,
                (unsigned __int8 *)&unk_14027A58E,
                0LL,
                0LL,
                &v20);
            }
