/*
 * XREFs of ApiSetIsProcessForeground @ 0x1402224D8
 * Callers:
...
__int64 __fastcall ApiSetIsProcessForeground(__int64 a1, __int64 a2)
{
  ...
  v2 = a1;
  v3 = 0;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5248LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 5256LL);
      if ( v7 )
        return v7(v2);
    }
  }
