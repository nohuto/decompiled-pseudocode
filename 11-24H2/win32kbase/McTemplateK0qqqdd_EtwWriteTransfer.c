/*
 * XREFs of McTemplateK0qqqdd_EtwWriteTransfer @ 0x1401B5914
 * Callers:
 *     EtwTracePointerDeviceContactIds @ 0x1401B4BF0 (EtwTracePointerDeviceContactIds.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x140033530 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x14023F3B0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qqqdd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &PointerDeviceContactIds, &W32kControlGuid, 6u, &v9);
}
