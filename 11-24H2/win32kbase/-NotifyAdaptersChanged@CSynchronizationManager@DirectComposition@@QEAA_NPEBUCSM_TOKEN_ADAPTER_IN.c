/*
 * XREFs of ?NotifyAdaptersChanged@CSynchronizationManager@DirectComposition@@QEAA_NPEBUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x140126674
 * Callers:
 *     DCompositionNotifyAdaptersChanged @ 0x140126620 (DCompositionNotifyAdaptersChanged.c)
 * Callees:
