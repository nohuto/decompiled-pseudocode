/*
 * XREFs of ?CanCoalesceNodeWithPrevious@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEBUCPointerInfoNode@@PEAUtagQMSG@@PEAUCPointerQFrame@@PEAW4CPointerCoalesce@@@Z @ 0x1400DF354
 * Callers:
        ...
        enum CPointerCoalesce *a6)
{
  ...
  struct CPointerInfoNode *v26; // rsi
  char v27; // di
  bool v28; // si
  __int64 v29; // rax
  int v30; // r8d
  ...
  if ( (v19 & 8) != 0 || (v19 & 0x10) != 0 || (v19 & 0x40) != 0 || (v19 & 0x20) != 0 )
  {
    *(_DWORD *)a6 = 16;
    ...
    {
      v100 = W32GetUserSessionState(WPP_GLOBAL_Control);
      LOBYTE(v101) = v99;
      LOBYTE(v102) = v98;
      WPP_RECORDER_AND_TRACE_SF_(
        *((_QWORD *)WPP_GLOBAL_Control + 3),
...
LABEL_296:
  ...
  if ( (*(_DWORD *)v6 & 0x800000) != 0
    ...
    || v44 < 0
    || (*((_DWORD *)v6 + 1) & 8) != 0
    || (v10 = *(_DWORD *)v26, (*(_DWORD *)v26 & 0x800000) != 0)
    || (v10 & 0x8000000) != 0
    || v10 < 0
    || (*((_DWORD *)v26 + 1) & 8) != 0 )
  {
    *(_DWORD *)a6 = 16;
    ...
    {
      v95 = W32GetUserSessionState(WPP_GLOBAL_Control);
      LOBYTE(v96) = v94;
      LOBYTE(v97) = v93;
      WPP_RECORDER_AND_TRACE_SF_(
        *((_QWORD *)WPP_GLOBAL_Control + 3),
  ...
  Queue = CPointerInfoNode::GetQueue(v26, &v105);
  v62 = 0;
  if ( !Queue || (IsEqualByQ = CInputDest::IsEqualByQ(Queue, (const struct CInputDest *)v108), v62 = 0, !IsEqualByQ) )
  {
    *(_DWORD *)a6 = 4;
    ...
    {
      v90 = W32GetUserSessionState(WPP_GLOBAL_Control);
      LOBYTE(v91) = v89;
      LOBYTE(v92) = v88;
      WPP_RECORDER_AND_TRACE_SF_(
        *((_QWORD *)WPP_GLOBAL_Control + 3),
