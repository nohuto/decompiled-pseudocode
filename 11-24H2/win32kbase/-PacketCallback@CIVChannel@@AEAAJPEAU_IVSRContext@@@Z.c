/*
 * XREFs of ?PacketCallback@CIVChannel@@AEAAJPEAU_IVSRContext@@@Z @ 0x14021B2B0
 * Callers:
 *     ?sPacketCallback@CIVChannel@@CAJPEAU_IVSRContext@@@Z @ 0x14021B640 (-sPacketCallback@CIVChannel@@CAJPEAU_IVSRContext@@@Z.c)
 * Callees:
