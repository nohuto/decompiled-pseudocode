/*
 * XREFs of ?CreateRegionFromRect@@YAJAEBUtagRECT@@PEAPEAUIRegion@@@Z @ 0x140129980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateRegionFromRect(const struct tagRECT *a1, struct IRegion **a2)
{
  __int64 result; // rax
