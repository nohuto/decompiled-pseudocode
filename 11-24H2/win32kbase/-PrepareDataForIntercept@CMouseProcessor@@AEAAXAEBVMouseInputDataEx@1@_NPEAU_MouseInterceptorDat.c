/*
 * XREFs of ?PrepareDataForIntercept@CMouseProcessor@@AEAAXAEBVMouseInputDataEx@1@_NPEAU_MouseInterceptorData@@@Z @ 0x14021E2F0
 * Callers:
        ...
        struct _MouseInterceptorData *a4)
{
  ...
  *(_QWORD *)a4 = v8;
  ...
  {
    LODWORD(v15) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6200);
  }
  ...
  *((_QWORD *)a4 + 2) = *((_QWORD *)a2 + 7);
  ...
  else
  {
    ...
    *((_DWORD *)a4 + 9) = *((_DWORD *)a2 + 4);
    ...
    {
      v13 = *((_WORD *)a2 + 1);
      UserSessionState = (struct tagPOINT *)W32GetUserSessionState(this);
      CMouseProcessor::ApplyAccelerationToDelta(
        this,
        *((_DWORD *)a4 + 8),
        *((_DWORD *)a4 + 9),
        UserSessionState[2405],
