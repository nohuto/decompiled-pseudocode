/*
 * XREFs of ?GenerateMessage@CTouchProcessor@@AEAAHPEBUCPointerInfoNode@@_KPEBUCPointerInputFrame@@IKHHVCInputDest@@@Z @ 0x140184868
 * Callers:
 ...
 *     EtwTraceEndPointerMessageGeneration @ 0x140108000 (EtwTraceEndPointerMessageGeneration.c)
 *     EtwTraceBeginPointerMessageGeneration @ 0x140108030 (EtwTraceBeginPointerMessageGeneration.c)
 *     ?PointerFlagsToMessage@CTouchProcessor@@AEAAII@Z @ 0x140109624 (-PointerFlagsToMessage@CTouchProcessor@@AEAAII@Z.c)
 *     ?GenerateMessage@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@G_KIPEAUHWND__@@@Z @ 0x14010FFC0 (-GenerateMessage@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@G_KIPEAUHWND__@@@Z.c)
...
LABEL_63:
    if ( *((_DWORD *)a9 + 23) )
    {
      ...
      if ( (_BYTE)v41 || v12 )
      {
        v42 = &WPP_61ce117451293dedbe606f30fcdcf8fb_Traceguids;
        LOBYTE(v42) = v12;
        WPP_RECORDER_AND_TRACE_SF_(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
          v41,
