/*
 * XREFs of EditionCommitMousePosAndMove @ 0x1400E1DA8
 * Callers:
        ...
        __int64 a8))(__int64, __int64, __int64, __int64, int, __int64, int, __int64)
{
  ...
  result = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, __int64, int, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6872LL);
  if ( result )
