/*
 * XREFs of ?InvokeMarshaledInterceptRequest@MouseInterceptState@CMouseProcessor@@QEAAXXZ @ 0x14021D894
 * Callers:
        ...
        CMouseProcessor::MouseInterceptState *this)
{
  ...
  if ( CMouseProcessor::MouseInterceptState::IsCurrentInputDesktopInterceptable(this) )
  {
    if ( *((_DWORD *)this + 6) != (unsigned int)PsGetCurrentThreadId() )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8505);
    v2 = *((_OWORD *)this + 3);
    ...
    {
      if ( v4 > 1 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8521);
      *(_DWORD *)v8 = v5;
      memset(&v8[4], 0, 20);
    }
    v6 = *(_QWORD *)&v8[16];
  ...
  if ( v7 )
  {
    if ( KeReadStateEvent(v7) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8758);
