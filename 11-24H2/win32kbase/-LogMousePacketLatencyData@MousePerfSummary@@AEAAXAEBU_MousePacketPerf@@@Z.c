/*
 * XREFs of ?LogMousePacketLatencyData@MousePerfSummary@@AEAAXAEBU_MousePacketPerf@@@Z @ 0x1400BDE80
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_14029AE68 > 5 && (qword_14029AE78 & 0x10) != 0 && (qword_14029AE80 & 0x10) == qword_14029AE80 )
  {
    v16 = *((_QWORD *)a2 + 5);
    v4 = *((_QWORD *)a2 + 4);
    v5 = *((_QWORD *)a2 + 3);
