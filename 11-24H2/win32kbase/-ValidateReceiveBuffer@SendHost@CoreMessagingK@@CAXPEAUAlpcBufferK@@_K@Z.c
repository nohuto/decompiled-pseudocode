/*
 * XREFs of ?ValidateReceiveBuffer@SendHost@CoreMessagingK@@CAXPEAUAlpcBufferK@@_K@Z @ 0x14004B318
 * Callers:
 ...
 * Callees:
 *     ?GetReceiveBufferMaxSize@RegistrarClient@CoreMessagingK@@SAGXZ @ 0x14004BA04 (-GetReceiveBufferMaxSize@RegistrarClient@CoreMessagingK@@SAGXZ.c)
