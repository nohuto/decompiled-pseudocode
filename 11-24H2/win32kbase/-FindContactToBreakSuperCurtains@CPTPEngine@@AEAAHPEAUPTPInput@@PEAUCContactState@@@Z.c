/*
 * XREFs of ?FindContactToBreakSuperCurtains@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@@Z @ 0x140146C34
 * Callers:
        ...
        struct CContactState *a3)
{
  ...
  for ( i = 0; i < v3; ++i )
  {
    ...
    if ( a3 != v9 && (*(_DWORD *)v9 & 0x20000000) != 0 && ((*(_DWORD *)v9 & 1) != 0 || *((_DWORD *)v9 + 57) == 1) )
    {
      v10 = HIDWORD(*((_QWORD *)v9 + 4)) - HIDWORD(*((_QWORD *)a3 + 4));
      v11 = *((_QWORD *)v9 + 4) - *((_QWORD *)a3 + 4);
      v12 = v10 * v10 + v11 * v11;
      if ( (v12 <= *((unsigned int *)this + 801) || v12 <= *((unsigned int *)this + 802))
