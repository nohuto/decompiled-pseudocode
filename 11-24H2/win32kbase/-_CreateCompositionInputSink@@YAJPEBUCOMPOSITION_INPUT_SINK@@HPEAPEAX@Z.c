/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x14011481C
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1401147E0 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x140114800 (NtCreateCompositionInputSink.c)
 * Callees:
