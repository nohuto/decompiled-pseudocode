/*
 * XREFs of ?ReleaseAllReferences@CInteractionTrackerMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x140196900
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  do
  {
    if ( *v4 )
    {
      DirectComposition::CApplicationChannel::ReleaseWeakReference((struct _RTL_GENERIC_TABLE *)a2, *v4);
      *v4 = 0LL;
    }
    ++v4;
    --v5;
  ...
  if ( v9 )
  {
    DirectComposition::CApplicationChannel::ReleaseWeakReference((struct _RTL_GENERIC_TABLE *)a2, v9);
    *((_QWORD *)this + 27) = 0LL;
  }
  v10 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 28);
  if ( v10 )
  {
    DirectComposition::CApplicationChannel::ReleaseWeakReference((struct _RTL_GENERIC_TABLE *)a2, v10);
    *((_QWORD *)this + 28) = 0LL;
  }
