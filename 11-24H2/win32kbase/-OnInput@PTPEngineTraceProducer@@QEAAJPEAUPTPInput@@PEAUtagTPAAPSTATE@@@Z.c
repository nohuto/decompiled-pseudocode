/*
 * XREFs of ?OnInput@PTPEngineTraceProducer@@QEAAJPEAUPTPInput@@PEAUtagTPAAPSTATE@@@Z @ 0x1400E791C
 * Callers:
 *     ?ProcessInput@CPTPProcessor@@QEAAXPEAX0KHHPEA_N@Z @ 0x140188294 (-ProcessInput@CPTPProcessor@@QEAAXPEAX0KHHPEA_N@Z.c)
 *     ?OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z @ 0x140221B50 (-OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z.c)
 * Callees:
        ...
        struct tagTPAAPSTATE *a3)
{
  ...
  v5 = dword_14029AE68;
  v7 = qword_14029AE80;
  if ( (unsigned int)dword_14029AE68 > 5 && (qword_14029AE78 & 3) != 0 && (qword_14029AE80 & 3) == qword_14029AE80 )
  {
    v12 = v4;
    v11 = -v4;
    v14 = a2;
  ...
  if ( *((_DWORD *)a2 + 12) && v5 > 5 && (qword_14029AE78 & 3) != 0 && (v7 & 3) == v7 )
  {
    v9 = *((_WORD *)a2 + 24);
