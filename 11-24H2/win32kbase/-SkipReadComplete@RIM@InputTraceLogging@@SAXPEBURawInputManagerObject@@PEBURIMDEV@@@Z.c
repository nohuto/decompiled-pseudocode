/*
 * XREFs of ?SkipReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x14019CA54
 * Callers:
        ...
        const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    else if ( v2 == 1 && (unsigned int)dword_14029AE30 > 4 && tlgKeywordOn((__int64)&dword_14029AE30, 256LL) )
    {
      v5 = (unsigned __int8 *)&unk_1402797D9;
      goto LABEL_17;
    }
  }
  else if ( (unsigned int)dword_14029AE30 > 4 && tlgKeywordOn((__int64)&dword_14029AE30, 256LL) )
  {
    v5 = (unsigned __int8 *)&unk_14027975B;
LABEL_17:
    v18 = v3;
