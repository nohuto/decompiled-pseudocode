/*
 * XREFs of McTemplateK0qxxxi_EtwWriteTransfer @ 0x140112BB4
 * Callers:
 *     EtwTraceFlipManagerPresentPosted @ 0x140112A10 (EtwTraceFlipManagerPresentPosted.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x140033530 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x14023F3B0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qxxxi_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
