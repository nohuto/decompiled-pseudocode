/*
 * XREFs of SetManipulationInputTargetTransform @ 0x14011BDC4
 * Callers:
        ...
        int a5))(_OWORD *, __int64, __int64, __int64, int)
{
  ...
  result = *(__int64 (__fastcall **)(_OWORD *, __int64, __int64, __int64, int))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(
                                                                                              a1,
                                                                                              a2)
                                                                                          + 48)
                                                                              + 6344LL);
