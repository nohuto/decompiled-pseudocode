/*
 * XREFs of ?EmitUpdateCommands@CCompositionMipmapSurfaceMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x140238CB0
 * Callers:
 *     <none>
 * Callees:
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_4b33d776916e3f95ce38671429c7c8f2___ @ 0x140238A88 (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_4b33d776916e3f95ce38671429c7c8f.c)
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CCompositionMipmapSurfaceMarshaler::EmitSurfaces(
         this,
         (struct DirectComposition::CBatch ***)a2) )
  {
    return 1;
