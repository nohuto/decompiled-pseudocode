/*
 * XREFs of ?EmitSetContentRelativeWindowRectCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400F4E80
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetContentRelativeWindowRectCommand(
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v3 + 12) = *(_OWORD *)((char *)this + 404);
    *((_DWORD *)this + 92) &= ~4u;
    return 1;
  }
  return 0;
