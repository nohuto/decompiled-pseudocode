/*
 * XREFs of NtGdiConfigureOPMProtectedOutput @ 0x14008A6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiConfigureOPMProtectedOutput(void *a1, const void *a2, unsigned int a3, char *a4)
{
  size_t v5; // r15
  unsigned int v7; // edi
  void *v8; // r14
  ...
  if ( Pool2 && ((v12 = v5, !(_DWORD)v5) || (v8 = (void *)ExAllocatePool2(258LL, v5, 1297108807LL)) != 0LL) )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      v11 = COPM::ConfigureProtectedOutput(*(COPM **)(v15 + 3648), a1, Pool2, v5, (unsigned __int8 *)v8);
    }
  }
  else
  {
