/*
 * XREFs of ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCResourceMarshaler@DirectComposition@@$0A@@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400FEC80
 * Callers:
 *     <none>
 * Callees:
