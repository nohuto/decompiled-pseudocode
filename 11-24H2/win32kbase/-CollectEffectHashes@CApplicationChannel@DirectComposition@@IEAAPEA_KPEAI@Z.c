/*
 * XREFs of ?CollectEffectHashes@CApplicationChannel@DirectComposition@@IEAAPEA_KPEAI@Z @ 0x140224CD8
 * Callers:
        ...
        char a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( v15 <= 0xFFFFFFFF )
    {
      v5 = (unsigned __int64 *)DirectComposition::Memory::Allocate((unsigned int)v15, 0x66624344u, a3, a4);
      if ( v5 )
      {
