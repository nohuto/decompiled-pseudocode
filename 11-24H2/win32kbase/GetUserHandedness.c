/*
 * XREFs of GetUserHandedness @ 0x140152738
 * Callers:
...
__int64 (*__fastcall GetUserHandedness(__int64 a1, __int64 a2))(void)
{
  __int64 (*result)(void); // rax

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 4600LL);
  if ( result )
