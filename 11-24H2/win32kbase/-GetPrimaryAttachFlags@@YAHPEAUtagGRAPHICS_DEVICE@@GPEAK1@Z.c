/*
 * XREFs of ?GetPrimaryAttachFlags@@YAHPEAUtagGRAPHICS_DEVICE@@GPEAK1@Z @ 0x140116CF0
 * Callers:
...
__int64 __fastcall GetPrimaryAttachFlags(struct tagGRAPHICS_DEVICE *a1, __int16 a2, unsigned int *a3, unsigned int *a4)
{
  ...
  *a4 = 0;
  v24 = v17;
  WdLogGlobalForLineNumber = 21524;
  *a3 = 0;
  ...
  else
  {
    ...
    if ( v14 )
    {
      ...
      if ( v16 < 0 )
      {
        ...
        *a4 = 0;
        *a3 = 0;
        WdLogGlobalForLineNumber = 21587;
      }
    }
    else
    {
      WdLogSingleEntry0(5LL);
      WdLogGlobalForLineNumber = 21593;
    }
  }
  v11 = *((_DWORD *)a1 + 40);
  if ( a2 )
...
LABEL_6:
  ...
  result = 1LL;
  WdLogGlobalForLineNumber = 21636;
  return result;
}
