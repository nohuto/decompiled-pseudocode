/*
 * XREFs of ?bInitGdiInfo@@YAHPEAU_devicemodeW@@PEAU_GDIINFO@@@Z @ 0x140157590
 * Callers:
...
LABEL_7:
  ...
  {
    v5 = *((__int16 *)&unk_14026DEC0 + 2 * v4);
    dmPelsHeight = *((__int16 *)&unk_14026DEC0 + 2 * v4 + 1);
