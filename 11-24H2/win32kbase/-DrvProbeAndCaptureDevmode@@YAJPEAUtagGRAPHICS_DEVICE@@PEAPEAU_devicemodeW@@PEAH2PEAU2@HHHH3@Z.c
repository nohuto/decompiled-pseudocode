/*
 * XREFs of ?DrvProbeAndCaptureDevmode@@YAJPEAUtagGRAPHICS_DEVICE@@PEAPEAU_devicemodeW@@PEAH2PEAU2@HHHH3@Z @ 0x1401170F8
 * Callers:
 ...
 *     ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x140134AA8 (-GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z.c)
        ...
        struct _devicemodeW *a10)
{
  ...
  *a3 = 0;
  ...
  if ( !Src )
    return 0;
  v15 = PALLOCNOZ(65755LL, 0x76656447u);
  if ( v15 )
  {
    v16 = *((_DWORD *)a1 + 40);
    v17 = a10;
    ...
    v21 = (struct _devicemodeW *)PALLOCNOZ(dmSize + dmDriverExtra, 0x76656447u);
    v13 = v21;
    if ( !v21 )
      goto LABEL_37;
    memmove(v21, Src, v20);
    ...
    Buffer = (_OWORD *)PALLOCNOZ(220LL, 0x76656447u);
    if ( !Buffer )
      goto LABEL_37;
    ...
    *(_WORD *)(v15 + 68) = -8739;
    ...
    v37 = PALLOCMEM(v54 + 220, 0x76656447u);
    if ( !v37 )
      goto LABEL_36;
    if ( !Size )
    {
...
LABEL_52:
      ...
      if ( !*(_DWORD *)(v15 + 168) && !*(_DWORD *)(v15 + 172) && !*(_DWORD *)(v15 + 176) && !*(_DWORD *)(v15 + 84) )
      {
        ...
        *(_DWORD *)(v15 + 168) = 0;
        ...
        if ( v38 )
        {
          v68 = (_DWORD *)((char *)&unk_14026DBC8 + v66 + 4);
          do
          {
...
LABEL_180:
        ...
        {
          *(_DWORD *)(v15 + 172) = *(_DWORD *)((char *)&unk_14026DBC8 + v66);
          *(_DWORD *)(v15 + 176) = *(_DWORD *)((char *)&unk_14026DBC8 + v66 + 4);
        }
        v48 = a1;
LABEL_182:
        v40 = v85;
