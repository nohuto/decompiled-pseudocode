/*
 * XREFs of ?EmitReleaseCommand@CRemoteAppRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x140233B30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( result )
    return DirectComposition::CResourceMarshaler::EmitReleaseCommand(this, (struct DirectComposition::CBatch ***)a2);
  return result;
}
