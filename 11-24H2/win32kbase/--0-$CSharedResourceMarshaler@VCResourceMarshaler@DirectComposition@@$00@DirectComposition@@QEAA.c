/*
 * XREFs of ??0?$CSharedResourceMarshaler@VCResourceMarshaler@DirectComposition@@$00@DirectComposition@@QEAA@PEBVCSharedSystemResource@1@W4MIL_RESOURCE_TYPE@@@Z @ 0x140073094
 * Callers:
        ...
        __int64 a1)
{
  ...
  DirectComposition::CResourceMarshaler::CResourceMarshaler(a1, 135LL);
  v1[7] = v2;
