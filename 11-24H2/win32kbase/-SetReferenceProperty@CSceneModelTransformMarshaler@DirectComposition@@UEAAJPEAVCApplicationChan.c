/*
 * XREFs of ?SetReferenceProperty@CSceneModelTransformMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x14022B4D0
 * Callers:
 *     <none>
 * Callees:
