/*
 * XREFs of McTemplateK0ppqqq_EtwWriteTransfer @ 0x140016BBC
 * Callers:
...
__int64 McTemplateK0ppqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  _BYTE v4[16]; // [rsp+30h] [rbp-39h] BYREF
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &GdiTransformHandle, &W32kControlGuid, 6LL, v4);
}
