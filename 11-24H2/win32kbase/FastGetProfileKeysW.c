/*
 * XREFs of FastGetProfileKeysW @ 0x1401A8400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FastGetProfileKeysW(const UNICODE_STRING *a1, __int64 a2, void *a3, _QWORD *a4)
{
  _WORD *v5; // rbp
  char *v6; // rsi
  _WORD *v7; // rbx
  ...
  v9 = 0;
  Length = 512;
  v12 = OpenCacheKeyEx(a1, a2, 131097LL, 0LL);
  if ( !v12 )
  {
LABEL_19:
    v20 = -1LL;
