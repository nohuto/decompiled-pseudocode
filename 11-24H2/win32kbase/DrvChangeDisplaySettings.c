/*
 * XREFs of DrvChangeDisplaySettings @ 0x140137250
 * Callers:
  ...
  *a7 = 0LL;
  ...
  if ( !(_DWORD)v28 )
  {
    if ( *(_DWORD *)(v11 + 1132) )
    {
      ...
      WdLogGlobalForLineNumber = 27221;
    }
    v18 = a4;
    v19 = v29;
    v20 = v29;
  ...
  if ( a3 )
  {
    ...
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 27257;
    }
    *(_QWORD *)&v31 = v19;
    *(_QWORD *)&v32 = a3;
    HIDWORD(v31) = v14;
  ...
  if ( v26 < 0 )
  {
    ...
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 27335;
  }
  else
  {
    if ( (int)v33 < 0 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 27325;
    }
    if ( (_BYTE)v42 )
    {
      if ( __CFSHR__(v14, 4) )
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 27329;
      }
      v22 = 2;
    }
  }
