/*
 * XREFs of ?ReplacePreferredScaling@@YAJPEBUD3DKMT_GETPATHSMODALITY@@PEAU1@@Z @ 0x1401C90B4
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( (*((_DWORD *)v5 + 14) & 0x10000) == 0 )
    {
      ...
      WdLogGlobalForLineNumber = 13853;
    }
    if ( *((_DWORD *)v5 + 48) == 253 )
      break;
LABEL_22:
  ...
  else
  {
    ...
    for ( j = 0; j < *((unsigned __int16 *)a1 + 10); ++j )
    {
        ...
        && *((_DWORD *)v8 + 5) == *((_DWORD *)v5 + 19) )
      {
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 13878;
        }
        if ( (*(_DWORD *)v8 & 0x10000) == 0 )
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 13879;
        }
  ...
  result = 3221225473LL;
  WdLogGlobalForLineNumber = 13874;
  return result;
}
