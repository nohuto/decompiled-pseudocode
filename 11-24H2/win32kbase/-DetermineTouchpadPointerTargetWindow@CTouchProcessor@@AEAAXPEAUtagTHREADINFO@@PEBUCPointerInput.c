/*
 * XREFs of ?DetermineTouchpadPointerTargetWindow@CTouchProcessor@@AEAAXPEAUtagTHREADINFO@@PEBUCPointerInputFrame@@PEAUCPointerInfoNode@@PEAUtagQ@@KHPEAHPEAUtagPOINT@@PEAVCInputDest@@@Z @ 0x1401FA77C
 * Callers:
        ...
        struct CInputDest *a10)
{
  ...
  else
  {
    ...
    else if ( *((_DWORD *)a5 + 124) )
    {
      ...
      *v25 = 0;
      *v39 = 0LL;
      v40 = (struct tagWND *)HMValidateHandleNoSecure(*((_QWORD *)a5 + 63), 1);
      if ( v40 )
      {
        v41 = *((_QWORD *)v40 + 5);
        ...
        {
          *v25 = *((_DWORD *)a5 + 128);
          *v39 = *(struct tagPOINT *)((char *)a5 + 516);
    ...
    else
    {
      ...
      if ( *(_DWORD *)a10 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 12456);
    }
  }
}
