/*
 * XREFs of ??$GreReleaseSemaphoreExclusive@$06$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x1400235B4
 * Callers:
...
void __fastcall GreReleaseSemaphoreExclusive<7,>(struct _ERESOURCE **a1, __int64 a2, int a3)
{
  ...
  v3 = *a1;
  EtwTraceGreLockReleaseSemaphore((__int64)L"DwmState", (unsigned int)*a1 + 520, a3);
