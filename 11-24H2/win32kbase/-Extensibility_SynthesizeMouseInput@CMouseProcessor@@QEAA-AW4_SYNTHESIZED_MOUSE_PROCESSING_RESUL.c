/*
 * XREFs of ?Extensibility_SynthesizeMouseInput@CMouseProcessor@@QEAA?AW4_SYNTHESIZED_MOUSE_PROCESSING_RESULT@@PEAU_ExtensibilityMouseInputData@@W4_MOUSEPROCESSOR_PROCESSING_OPTIONS@@PEAU_SYNTHESIZE_MOUSE_EXTRA_PAYLOAD@@@Z @ 0x14021CA78
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  __int64 v20; // rbx
  _BYTE v22[4]; // [rsp+38h] [rbp-D0h] BYREF
  ...
  _BYTE v30[96]; // [rsp+A8h] [rbp-60h] BYREF

  if ( !IsInputThread((__int64)a1) )
  {
    v23 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2012);
  }
  v8 = *(_DWORD *)(a2 + 32);
  v27 = 0LL;
  v9 = 256;
  ...
  v19 = *(_DWORD *)(a2 + 8);
  v20 = *(_QWORD *)(a2 + 16);
  *((_QWORD *)&v24 + 1) = *(_QWORD *)a2;
  *(_QWORD *)&v24 = 1LL;
  v28 = v24;
  v29 = 0LL;
  *(_QWORD *)&v24 = UpconvertTime(v19);
  *((_QWORD *)&v24 + 1) = v20;
  v25 = v20;
  CMouseProcessor::MouseInputDataEx::MouseInputDataEx((__int64)v30, (__int64)&v26, &v24, v18 | 0x40, (__int64)&v28, a4);
  LeaveEnterCrit::LeaveEnterCrit((LeaveEnterCrit *)v22, 1);
  CMouseProcessor::SynthesizeMouse(a1, (struct CMouseProcessor::MouseInputDataEx *)v30, 0LL);
  LeaveEnterCrit::~LeaveEnterCrit((LeaveEnterCrit *)v22);
  if ( CMouseProcessor::MouseInputDataEx::TestCommitMouseAndCursorPositionResult((__int64)v30, 4) )
    return 2LL;
  else
    return (unsigned int)CMouseProcessor::MouseInputDataEx::TestCommitMouseAndCursorPositionResult((__int64)v30, 2) + 1;
}
