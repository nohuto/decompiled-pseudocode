/*
 * XREFs of pProcessDfbSurfacesInternal @ 0x1400846A0
 * Callers:
...
struct _BASEOBJECT *__fastcall pProcessDfbSurfacesInternal(struct SURFACE *this)
{
  ...
  int v10; // eax
  int v11; // eax
  struct _BASEOBJECT *v12; // [rsp+60h] [rbp-A0h] BYREF
  ...
  v1 = (struct _BASEOBJECT *)*((_QWORD *)this + 70);
  v2 = 0LL;
