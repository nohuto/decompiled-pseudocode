/*
 * XREFs of McTemplateK0qqqzzzzqx_EtwWriteTransfer @ 0x14011E258
 * Callers:
        ...
        char a12)
{
  ...
  if ( !a10 )
    v13 = L"NULL";
  v41 = v13;
  return McGenEventWrite_EtwWriteTransfer(v22, &ImmersiveInputProcessDelayEvent, &W32kControlGuid, 0xAu, &v25);
}
