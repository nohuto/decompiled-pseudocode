/*
 * XREFs of ?ForwardPnpNotificationToISM@CBaseInput@@CAXW4_KnownRIMDeviceKind@@PEBUDEVICEINFO@@QEAXK@Z @ 0x14020C158
 * Callers:
...
__int64 __fastcall CBaseInput::ForwardPnpNotificationToISM(int a1, __int64 a2, int a3, int a4)
{
  ...
  if ( v13 )
  {
    ...
    if ( v14 <= 0x104u )
      ...
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2109);
  ...
  return SendMessageTo(12LL, v23, 572LL);
}
