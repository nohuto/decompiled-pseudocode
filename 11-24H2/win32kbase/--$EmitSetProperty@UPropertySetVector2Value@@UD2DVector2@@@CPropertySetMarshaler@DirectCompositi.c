/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector2Value@@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x140144C1C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v15 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x24uLL, &v15);
  v8 = (char *)v15;
  *(_DWORD *)v15 = 36;
  *(_OWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 20) = 0LL;
