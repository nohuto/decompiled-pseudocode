/*
 * XREFs of RIMIDE_InitializePointerDeviceInjection @ 0x1401E864C
 * Callers:
        ...
        __int64 *a10)
{
  ...
  if ( a10 )
    *a10 = 0LL;
  memmove(v27, &unk_14026EDC0, 0xA0uLL);
  switch ( a1 )
  {
    case 2:
      v15 = (char *)&unk_14026EB80;
      v16 = 7;
      v17 = 4;
      v18 = 10;
      v19 = 12;
  ...
  if ( (unsigned int)BuildReportDescriptor(0xDu, v17, (struct tagUSAGE_PROPERTIES *)v27, v19, v18, &DeviceDescription) )
  {
    ...
    return RIMIDECreatePseudoHIDDevice(13, v17, a2, a4, a3, &v25, a7, a5, v24, 0LL, a10);
  }
  return 3221225485LL;
}
