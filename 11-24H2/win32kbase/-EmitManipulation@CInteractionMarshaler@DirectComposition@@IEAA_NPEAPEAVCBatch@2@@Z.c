/*
 * XREFs of ?EmitManipulation@CInteractionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x14006F484
 * Callers:
...
char __fastcall DirectComposition::CInteractionMarshaler::EmitManipulation(
