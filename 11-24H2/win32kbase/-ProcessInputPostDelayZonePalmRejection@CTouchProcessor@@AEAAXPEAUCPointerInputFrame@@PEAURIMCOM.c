/*
 * XREFs of ?ProcessInputPostDelayZonePalmRejection@CTouchProcessor@@AEAAXPEAUCPointerInputFrame@@PEAURIMCOMPLETEFRAME@@@Z @ 0x140204168
 * Callers:
  ...
  *((_DWORD *)v4 + 57) |= 0x200u;
  ...
  if ( v10 )
  {
    ...
    for ( i = 0; i < *((_DWORD *)v3 + 6); ++i )
    {
      ...
      if ( *(_QWORD *)(W32GetUserSessionState(v20) + 3112) )
      {
        v25[0] = 0LL;
        v25[1] = v21;
    ...
    if ( (_BYTE)v11 || v6 )
    {
      v18 = &WPP_61ce117451293dedbe606f30fcdcf8fb_Traceguids;
      v24 = 36;
      goto LABEL_45;
    }
  }
