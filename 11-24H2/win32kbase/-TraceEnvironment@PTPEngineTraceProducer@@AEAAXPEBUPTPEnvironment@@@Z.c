/*
 * XREFs of ?TraceEnvironment@PTPEngineTraceProducer@@AEAAXPEBUPTPEnvironment@@@Z @ 0x140053F38
 * Callers:
...
void __fastcall PTPEngineTraceProducer::TraceEnvironment(PTPEngineTraceProducer *this, const struct PTPEnvironment *a2)
{
  ...
  v2 = (unsigned int)dword_14029AE68;
  v4 = qword_14029AE80;
  if ( (unsigned int)dword_14029AE68 > 5 )
  {
    if ( (qword_14029AE78 & 3) != 0 && (qword_14029AE80 & 3) == qword_14029AE80 )
    {
      v6 = a2;
      v7 = 140;
      v9 = *((_QWORD *)this + 25);
    ...
    if ( (unsigned int)v2 > 5 && (qword_14029AE78 & 3) != 0 && (v4 & 3) == v4 )
    {
      v8 = 2;
