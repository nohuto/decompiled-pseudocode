/*
 * XREFs of ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x140232110
 * Callers:
 *     <none>
 * Callees:
 *     DCompositionIsVailContainer @ 0x140222A9C (DCompositionIsVailContainer.c)
 *     CreateVmSharedMemorySection @ 0x14023E9E4 (CreateVmSharedMemorySection.c)
 */
