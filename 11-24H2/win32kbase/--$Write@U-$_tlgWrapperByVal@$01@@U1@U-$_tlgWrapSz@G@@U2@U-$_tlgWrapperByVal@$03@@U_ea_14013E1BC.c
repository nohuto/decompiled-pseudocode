        ...
        __int64 a37)
{
  ...
  const WCHAR *v101; // [rsp+180h] [rbp+80h]
  ...
  _DWORD *v112; // [rsp+1D0h] [rbp+D0h]
  __int64 v113; // [rsp+1D8h] [rbp+D8h]
  __int64 v114; // [rsp+1E0h] [rbp+E0h]
  _DWORD v115[2]; // [rsp+1E8h] [rbp+E8h] BYREF
  const WCHAR *v116; // [rsp+1F0h] [rbp+F0h]
  int v117; // [rsp+1F8h] [rbp+F8h]
  int v118; // [rsp+1FCh] [rbp+FCh]
  const WCHAR *v119; // [rsp+200h] [rbp+100h]
  int v120; // [rsp+208h] [rbp+108h]
  int v121; // [rsp+20Ch] [rbp+10Ch]
  ...
  v61 = 2LL;
  v66 = 0;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029AE68, a2, 0LL, 0LL, 0x25u, &v59);
}
