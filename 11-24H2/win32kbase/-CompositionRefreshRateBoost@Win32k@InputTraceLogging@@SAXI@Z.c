/*
 * XREFs of ?CompositionRefreshRateBoost@Win32k@InputTraceLogging@@SAXI@Z @ 0x140116448
 * Callers:
...
void __fastcall InputTraceLogging::Win32k::CompositionRefreshRateBoost(int a1)
{
    ...
    && (qword_14029AE48 & 0x200) == qword_14029AE48 )
  {
    ...
    v1 = a1;
    v4 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029AE30, byte_14027F191, 0LL, 0LL, 3u, &v2);
  }
}
