/*
 * XREFs of ?RemoveGaps@@YAHPEAUtagRECT@@I@Z @ 0x14000BA7C
 * Callers:
 *     AlignRects @ 0x14000B5E8 (AlignRects.c)
 * Callees:
 *     ?AddNextContiguousRectangle@@YAPEAPEAUtagRECT@@PEAPEAU1@0I@Z @ 0x14000BC14 (-AddNextContiguousRectangle@@YAPEAPEAUtagRECT@@PEAPEAU1@0I@Z.c)
...
__int64 __fastcall RemoveGaps(struct tagRECT *a1, unsigned int a2)
{
  ...
  if ( (unsigned int)v2 <= 0x10
    || (result = (__int64)Win32AllocPoolZInitImpl(0x100uLL, (unsigned int)(8 * v2), 0x74727355u),
