/*
 * XREFs of ?HmgpAcquireHandleIndex@@YA_NAEAUSESSION_GLOBALS@Base@Gre@@PEAU_GRETHREAD@@PEAI@Z @ 0x14007AA44
 * Callers:
...
LABEL_64:
            ...
            v39 = Win32AllocPoolImpl(0x100uLL, 0x40000uLL, 0x636D6847u);
            *(_QWORD *)(v23 + 24) = v39;
            if ( v39 )
            {
...
LABEL_50:
    ...
    {
      v38 = Win32AllocPoolImpl(0x100uLL, 0x40000uLL, 0x636D6847u);
      *(_QWORD *)(v6 + 24) = v38;
      if ( v38 )
      {
