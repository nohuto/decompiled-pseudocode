/*
 * XREFs of ?Initialize@CCompositionSpotLightMarshaler@DirectComposition@@UEAAJXZ @ 0x14013FDF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        DirectComposition::CCompositionSpotLightMarshaler *this)
{
  ...
  *((_DWORD *)this + 47) = 1065353216;
  result = 0LL;
  *(_OWORD *)((char *)this + 152) = xmmword_1402651B8;
  *((_BYTE *)this + 88) = 1;
  *((_DWORD *)this + 36) = 1057360530;
  *((_DWORD *)this + 37) = 1070141403;
  *(_OWORD *)((char *)this + 168) = xmmword_1402651B8;
  return result;
}
