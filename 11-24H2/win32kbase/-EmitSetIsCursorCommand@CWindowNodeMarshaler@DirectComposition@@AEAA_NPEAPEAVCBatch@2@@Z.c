/*
 * XREFs of ?EmitSetIsCursorCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1402263A0
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetIsCursorCommand(
