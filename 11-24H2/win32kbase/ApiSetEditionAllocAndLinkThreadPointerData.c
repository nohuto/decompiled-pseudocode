/*
 * XREFs of ApiSetEditionAllocAndLinkThreadPointerData @ 0x140191300
 * Callers:
...
__int64 __fastcall ApiSetEditionAllocAndLinkThreadPointerData(__int64 a1, __int64 a2)
{
  ...
  v3 = 0LL;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6416LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 6424LL);
      if ( v7 )
        return v7(a1);
    }
  }
