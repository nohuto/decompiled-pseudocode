/*
 * XREFs of ?EnsureWriteableInteraction@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@_N1PEBGPEAPEAVCInteractionMarshaler@2@@Z @ 0x14004AA6C
 * Callers:
        ...
        struct DirectComposition::CInteractionMarshaler **a6)
{
  ...
  {
    v14 = (struct DirectComposition::CResourceMarshaler *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 152LL))(v8);
    v11 = v14;
    if ( v14 )
    {
LABEL_10:
  ...
  v15 = 0;
  v9 = DirectComposition::CApplicationChannel::CreateInternalPrivateResource(a2, 0x59u, &v14);
  if ( v9 >= 0 )
  {
    v11 = v14;
    if ( !a3 || (v9 = DirectComposition::CInteractionMarshaler::SetDefaultConfiguration(v14), v9 >= 0) )
    {
      v9 = (*(__int64 (__fastcall **)(DirectComposition::CVisualMarshaler *, struct DirectComposition::CApplicationChannel *, __int64, struct DirectComposition::CResourceMarshaler *, char *))(*(_QWORD *)this + 288LL))(
             this,
             a2,
             23LL,
             v11,
