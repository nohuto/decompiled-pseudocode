/*
 * XREFs of ?FreeMsgData@CTouchProcessor@@AEAAX_K@Z @ 0x1401FC120
 * Callers:
...
void __fastcall CTouchProcessor::FreeMsgData(PERESOURCE *this, unsigned __int64 a2)
{
  ...
  if ( !tagDomLock::IsLockedShared(this + 4) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11589);
  if ( *((_DWORD *)NonConstMsgData + 6) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11591);
  ...
  *(_QWORD *)NonConstMsgData = NonConstMsgData;
  ...
  if ( (*((_DWORD *)NonConstMsgData + 9) & 0x80u) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 131073, 11568);
  ...
  if ( *(char **)v7 == v7 )
  {
    v13 = v7 - 256;
    if ( *((_WORD *)v7 - 112) != v8 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11635);
    if ( *(char **)v7 != v7 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11636);
    if ( *((char **)v13 + 30) != v13 + 240 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11637);
