/*
 * XREFs of ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14003FCE4
 * Callers:
  ...
  if ( (a2 & 0xFFF) == 320 * v3 )
    return 2
         - (unsigned int)(RtlTestBit(
                            ...
                            v3 + 12 * ((unsigned int)(a2 - (*((_DWORD *)a1 + 4) ^ *((_DWORD *)a1 + 2))) >> 12)) != 0);
  else
    return 3LL;
}
