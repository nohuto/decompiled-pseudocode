/*
 * XREFs of ?OnTelemetryOutput@CPTPProcessor@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1401880E0
 * Callers:
 *     <none>
 * Callees:
 *     EtwTraceTouchPadAAP @ 0x140107D10 (EtwTraceTouchPadAAP.c)
 ...
 *     ?OnNewSession@Usage@PTPTelemetry@@SAX_J@Z @ 0x140128B3C (-OnNewSession@Usage@PTPTelemetry@@SAX_J@Z.c)
 *     ?OnNewContact@Usage@PTPTelemetry@@SAX_J@Z @ 0x14012BAB8 (-OnNewContact@Usage@PTPTelemetry@@SAX_J@Z.c)
 *     ?IncrementTotalTime@Usage@PTPTelemetry@@SAXW4tagPTP_TELEM_TOTALTIME@@_K@Z @ 0x14012D174 (-IncrementTotalTime@Usage@PTPTelemetry@@SAXW4tagPTP_TELEM_TOTALTIME@@_K@Z.c)
  ...
  else if ( *(_DWORD *)a2 == 2 )
  {
    ...
    if ( v3 )
    {
      ...
      if ( v4 )
      {
              ...
              if ( v8 )
              {
                ...
                if ( (_DWORD)v9 )
                {
                  ...
                  else
                  {
                    ...
                    v14 = *((_DWORD *)a2 + 2);
                    v15 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v10, a2) + 48) + 7176LL);
                    if ( v15 && v15() >= 0 )
                ...
                else
                {
                  ...
                  {
                    if ( v17 == 1 )
                      *(_QWORD *)(UserSessionState + 12224) = v16;
                  }
                  else
                  {
        ...
        {
          PTPTelemetry::Usage::HandlePTPTelemetry(v5);
        }
      }
      else
      {
    ...
    {
      PTPTelemetry::Usage::OnNewSession(*(LARGE_INTEGER *)((char *)a2 + 8));
    }
  }
}
