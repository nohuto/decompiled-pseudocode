/*
 * XREFs of ?EmitCreationCommand@CResourceMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x14007F0C0
 * Callers:
 *     ?EmitCreationCommand@CInteractionMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x140118520 (-EmitCreationCommand@CInteractionMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
...
bool __fastcall DirectComposition::CResourceMarshaler::EmitCreationCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (unsigned __int64)(4096 - v6) >= 0x10
    && (v7 = *((_QWORD *)v5 + 7), *((_QWORD *)v5 + 5) = v6 + 16, (v8 = v6 + v7) != 0) )
  {
    v2[19] = (struct DirectComposition::CBatch *)((char *)v2[19] + 16);
  }
  else
  {
    v9 = *a2;
    ...
    *a2 = (struct DirectComposition::CBatch **)BatchFragment;
    ...
    if ( (unsigned __int64)(4096 - v12) < 0x10
      || (v13 = *(_QWORD *)(v11 + 56), *(_QWORD *)(v11 + 40) = v12 + 16, (v8 = v12 + v13) == 0) )
    {
