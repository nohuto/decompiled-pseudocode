/*
 * XREFs of ?CheckAndSendFindMyPenWnf@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@@Z @ 0x1401F7680
 * Callers:
        ...
        if ( v5 )
        {
          ...
          if ( this[15].QuadPart + 5000 * gliQpcFreq.QuadPart / 0x3E8uLL < PerformanceCounter.QuadPart )
          {
            ...
            if ( (int)ZwUpdateWnfStateData(
              ...
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 17507);
          }
        }
      }
    }
