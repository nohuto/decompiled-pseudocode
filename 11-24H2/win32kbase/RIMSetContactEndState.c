/*
 * XREFs of RIMSetContactEndState @ 0x140180688
 * Callers:
...
int __fastcall RIMSetContactEndState(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  v5 = a2 + 2368;
  if ( !*(_QWORD *)(a1 + 792) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2003LL);
  if ( (*(_DWORD *)(a2 + 32) & 2) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2005LL);
