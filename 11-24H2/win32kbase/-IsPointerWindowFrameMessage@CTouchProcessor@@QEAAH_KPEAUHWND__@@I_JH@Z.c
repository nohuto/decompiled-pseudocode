/*
 * XREFs of ?IsPointerWindowFrameMessage@CTouchProcessor@@QEAAH_KPEAUHWND__@@I_JH@Z @ 0x140201830
 * Callers:
 *     <none>
 * Callees:
        ...
        int a6)
{
  ...
  if ( !v18 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13767);
...
LABEL_11:
  ...
  if ( *((_DWORD *)v18 + 8) >= *(_DWORD *)(v17 + 48) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13774);
