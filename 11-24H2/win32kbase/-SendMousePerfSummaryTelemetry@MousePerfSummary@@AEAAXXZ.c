/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x14005188C
 * Callers:
 ...
 * Callees:
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x140052CB8 (-Reset@MousePerfSummary@@AEAAXXZ.c)
