/*
 * XREFs of ?MapVisualRelativePoint@InputSink@InputTraceLogging@@SAXPEAX0AEBUtagINPUT_TRANSFORM@@1UVisualPoint@@2@Z @ 0x1401AB138
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( (unsigned int)dword_14029AE30 > 5 && tlgKeywordOn((__int64)&dword_14029AE30, 4LL) )
  {
    v10 = v7[15];
    v11 = v7[14];
    v12 = v7[13];
