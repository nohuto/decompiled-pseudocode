/*
 * XREFs of write_char @ 0x1401A1558
 * Callers:
 *     _woutput_l @ 0x1401A0C4C (_woutput_l.c)
 *     write_multi_char @ 0x1401A15AC (write_multi_char.c)
 *     write_string @ 0x1401A1604 (write_string.c)
 * Callees:
 *     _fputwc_nolock @ 0x1401A202C (_fputwc_nolock.c)
 */
