/*
 * XREFs of ApiSetEditionSystemGenerateMove @ 0x1401934A0
 * Callers:
...
__int64 (*__fastcall ApiSetEditionSystemGenerateMove(__int64 a1, __int64 a2))(void)
{
  ...
  v2 = a1;
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7112LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 7120LL);
      if ( result )
