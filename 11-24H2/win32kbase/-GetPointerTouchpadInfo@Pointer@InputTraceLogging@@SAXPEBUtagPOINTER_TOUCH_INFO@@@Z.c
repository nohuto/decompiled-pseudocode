/*
 * XREFs of ?GetPointerTouchpadInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_TOUCH_INFO@@@Z @ 0x140200490
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerTouchpadInfo(const struct tagPOINTER_TOUCH_INFO *a1)
{
  ...
  if ( (unsigned int)dword_14029AE30 > 5 && tlgKeywordOn((__int64)&dword_14029AE30, 32LL) )
  {
    v2 = v1[22];
    v40 = v1[35];
    v41 = v1[34];
