/*
 * XREFs of ?OnCallback@CoreMsgObject@CoreMessagingK@@SAJW4_WIN32_CALLOUTS_OPERATION@@PEAX@Z @ 0x1400FCE34
 * Callers:
 *     CoreMsgObjectCallout @ 0x1400FCD24 (CoreMsgObjectCallout.c)
 * Callees:
 *     ?Open@CoreMsgObject@CoreMessagingK@@CAJPEAU_WIN32_OPENMETHOD_PARAMETERS@@@Z @ 0x1400FE144 (-Open@CoreMsgObject@CoreMessagingK@@CAJPEAU_WIN32_OPENMETHOD_PARAMETERS@@@Z.c)
