/*
 * XREFs of ?MulEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEBGKPEAPEAUHSURF__@@KPEAU_GDIINFO@@KPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x14012FFF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     bIntersect @ 0x140130810 (bIntersect.c)
 *     vSpEnableMultiMon @ 0x14019CFB8 (vSpEnableMultiMon.c)
 *     ?pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ @ 0x1401CEEA8 (-pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ.c)
  ...
  *((_DWORD *)v10 + 426) = *((_DWORD *)v13 + 21) - *((_DWORD *)v13 + 19);
  ...
  do
  {
    ...
    if ( !(unsigned int)PDEVOBJ::bRenderLddmDriver((PDEVOBJ *)&v80) && *(_DWORD *)(v67 + 2604) != 5 )
    {
      ...
      do
        v73 = *((_DWORD *)v10 + 10);
      while ( v73 != _InterlockedCompareExchange((volatile signed __int32 *)v10 + 10, v73 | 0x8000000, v73) );
      v67 = v80;
    }
    if ( ((_DWORD)v10[10] & 0x4000000) == 0 && ((*(_DWORD *)(v67 + 2112) & 0x8000) == 0 || !*(_QWORD *)(v67 + 2760)) )
    {
      if ( !v87 || (v74 = PDEVOBJ::pRenderAdapter((PDEVOBJ *)&v80), v74 == (void *)v72) )
      {
    ...
    if ( ((_DWORD)v10[10] & 0x40000000) == 0 && !PDEVOBJ::bAllowShareAccess((PDEVOBJ *)&v80, v72) )
    {
      _m_prefetchw(v10 + 10);
      do
        v76 = *((_DWORD *)v10 + 10);
