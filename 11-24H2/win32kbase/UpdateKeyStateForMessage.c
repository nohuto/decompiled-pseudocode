/*
 * XREFs of UpdateKeyStateForMessage @ 0x1400C18C0
 * Callers:
 *     HandleDeferredInput @ 0x1400C06B0 (HandleDeferredInput.c)
 * Callees:
 *     _anonymous_namespace_::ApplyKeyStateToQueue @ 0x1400C1A9C (_anonymous_namespace_--ApplyKeyStateToQueue.c)
...
LABEL_9:
  ...
  if ( v6
    || (result = (unsigned __int64)v11 >> 2,
        ((unsigned __int8)(1 << (2 * (v11 & 3))) & *(_BYTE *)(result + v9 + 280)) == 0) )
  {
    LOBYTE(a2) = v4;
    v10 = v9;
    goto LABEL_9;
