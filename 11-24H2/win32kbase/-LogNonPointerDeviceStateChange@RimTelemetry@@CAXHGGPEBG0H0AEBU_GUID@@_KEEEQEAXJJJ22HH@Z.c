/*
 * XREFs of ?LogNonPointerDeviceStateChange@RimTelemetry@@CAXHGGPEBG0H0AEBU_GUID@@_KEEEQEAXJJJ22HH@Z @ 0x140115140
 * Callers:
        ...
        int a20)
{
  ...
  else if ( (unsigned int)dword_14029AE68 > 5 )
  {
    v29 = a20;
    v28 = a19;
    v37 = a18;
