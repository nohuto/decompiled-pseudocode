/*
 * XREFs of ?EmitUpdateCommands@CHolographicExclusiveViewMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x140234640
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CHolographicExclusiveViewMarshaler::EmitCreate(this, a2) )
  {
    ...
    if ( DirectComposition::CHolographicExclusiveViewMarshaler::EmitViewData(this, a2) )
      return 1;
  }
  return v4;
}
