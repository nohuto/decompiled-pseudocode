/*
 * XREFs of ?bInside@RGNCOREOBJ@@QEBAHPEAU_RECTL@@@Z @ 0x1400DC4A0
 * Callers:
 *     CddEngRectInRgn @ 0x1401CF510 (CddEngRectInRgn.c)
 * Callees:
...
__int64 __fastcall RGNCOREOBJ::bInside(Win32kRS **this, struct _RECTL *a2)
{
  ...
  if ( WPP_MAIN_CB.Dpc.SystemArgument1 )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(Win32kRS *, struct _RECTL *))(*(_QWORD *)SystemArgument1 + 120LL))(v4, a2);
  ...
  else
  {
      ...
      && a2->bottom > *((_DWORD *)v4 + 8) )
    {
      v6 = WPP_MAIN_CB.Dpc.SystemArgument1
         ? Win32kRS::RegionCore_get_pScan_mut(*this, (struct REGION_CORE *)a2)
         : *(struct SCAN **)v4;
      v9 = *((_DWORD *)*this + 6);
      if ( v9 )
      {
