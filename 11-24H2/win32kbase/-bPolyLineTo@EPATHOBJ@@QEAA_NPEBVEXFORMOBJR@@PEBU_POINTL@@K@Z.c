/*
 * XREFs of ?bPolyLineTo@EPATHOBJ@@QEAA_NPEBVEXFORMOBJR@@PEBU_POINTL@@K@Z @ 0x140069D64
 * Callers:
 ...
 *     EPATHOBJ_bPolyLineTo @ 0x140069A30 (EPATHOBJ_bPolyLineTo.c)
 *     PATHOBJ_bPolyLineTo @ 0x14006AD80 (PATHOBJ_bPolyLineTo.c)
