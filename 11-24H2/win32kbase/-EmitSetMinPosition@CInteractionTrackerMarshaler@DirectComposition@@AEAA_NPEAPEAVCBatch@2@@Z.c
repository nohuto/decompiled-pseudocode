/*
 * XREFs of ?EmitSetMinPosition@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140102A44
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x2000) == 0 )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 3) = *((_DWORD *)this + 26);
      *((_DWORD *)v5 + 4) = *((_DWORD *)this + 27);
