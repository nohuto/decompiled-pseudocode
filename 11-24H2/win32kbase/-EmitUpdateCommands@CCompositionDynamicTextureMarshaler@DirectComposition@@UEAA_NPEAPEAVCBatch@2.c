/*
 * XREFs of ?EmitUpdateCommands@CCompositionDynamicTextureMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x140227140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EmitSetTextureCommand@CCompositionDynamicTextureMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140226BA8 (-EmitSetTextureCommand@CCompositionDynamicTextureMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatc.c)
 */
