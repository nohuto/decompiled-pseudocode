/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x140141094
 * Callers:
 ...
 *     _tlgCreate1Sz_char @ 0x14013DF24 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x140142CC4 (TakeTelemetryAssertsLock.c)
 *     GetImageTuple @ 0x14014A6FC (GetImageTuple.c)
...
LABEL_55:
    ...
    v23 = "<unknown>";
    if ( !a3 )
      a3 = (_BYTE *)g_ModuleName;
    v78 = a3;
    if ( v42 )
    {
      if ( (unsigned int)dword_1402C2040 > 5 && tlgKeywordOn((__int64)&dword_1402C2040, 0x400000000000LL) )
      {
        v44 = v25;
        v117 = &v44;
        v26 = "<unknown>";
        ...
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C2040, byte_140281013, 0LL, 0LL, 0xEu, &v116);
      }
    }
    else if ( (unsigned int)dword_1402C2040 > 5 && tlgKeywordOn((__int64)&dword_1402C2040, 0x400000000000LL) )
    {
      v53 = v31;
      v142 = &v53;
      v32 = "<unknown>";
      ...
      if ( v30 )
        v32 = v30;
      tlgCreate1Sz_char((__int64)v150, v32);
      v151 = &v57;
      v58 = v39;
      v153 = (int *)&v58;
      v57 = v41;
      ...
      if ( !v77 )
        v34 = "<unknown>";
      tlgCreate1Sz_char((__int64)v158, v34);
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C2040, byte_1402810BD, 0LL, 0LL, 0xBu, &v141);
    }
    if ( dword_1402C2078 && !v60 && !KeGetCurrentIrql() )
    {
      v35 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v21, g_ModuleName, v40, v19, 0LL, 0LL, 0);
      if ( v42 )
      {
        if ( (unsigned int)dword_1402C2040 > 5 && tlgKeywordOn((__int64)&dword_1402C2040, 0x400000000000LL) )
        {
          ...
          v86 = &v64;
          if ( g_ModuleName )
            v23 = (char *)g_ModuleName;
          tlgCreate1Sz_char((__int64)v88, v23);
          v65 = v41;
          v89 = &v65;
          v66 = v39;
          v91 = (int *)&v66;
          ...
          v97 = 4LL;
          v99 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C2040, byte_14028112A, v36, 0LL, 0xDu, &v79);
        }
      }
      else if ( (unsigned int)dword_1402C2040 > 5 && tlgKeywordOn((__int64)&dword_1402C2040, 0x400000000000LL) )
      {
        ...
        if ( g_ModuleName )
          v23 = (char *)g_ModuleName;
        tlgCreate1Sz_char((__int64)v109, v23);
        v74 = v41;
        v110 = &v74;
        v75 = v39;
        v112 = (int *)&v75;
        ...
        v76 = v35;
        v115 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C2040, byte_1402811D0, v37, 0LL, 0xAu, &v100);
      }
