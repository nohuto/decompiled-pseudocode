/*
 * XREFs of ?Free@?$CTypeIsolation@$0CMAAA@$0CMA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14003E6F0
 * Callers:
 *     ??$_lambda_invoker_cdecl_@PEAXPEAU_LOOKASIDE_LIST_EX@@@_lambda_2_@?1??Initialize@?$CLookAsideTypeIsolation@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA_NXZ@SA?A_PPEAXPEAU_LOOKASIDE_LIST_EX@@@Z @ 0x14003E6D0 (--$_lambda_invoker_cdecl_@PEAXPEAU_LOOKASIDE_LIST_EX@@@_lambda_2_@-1--Initialize@-$CLookAsideTyp.c)
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14003E86C (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<180224,704>::Free(__int64 *a1, void *a2)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    ...
    v6 = i[4];
    v7 = NSInstrumentation::CSectionBitmapAllocator<180224,704>::CheckAllocationStatus(v6, a2);
    if ( !v7 )
      continue;
    v8 = v7 - 1;
    if ( !v8 )
