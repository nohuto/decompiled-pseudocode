/*
 * XREFs of ?GenerateFrameMessages@Pointer@TelemetryDebug@InputTraceLogging@@SAXAEBUTELEMETRY_POINTER_FRAME_TIMES@@_N@Z @ 0x140052770
 * Callers:
        ...
        char a2)
{
  ...
  else if ( (unsigned int)dword_14029AE30 > 7 )
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_14029AE30, 0x10000LL) )
    {
      v26 = *((_QWORD *)a1 + 7);
      v8 = *((_QWORD *)a1 + 6);
      v9 = *((_QWORD *)a1 + 5);
