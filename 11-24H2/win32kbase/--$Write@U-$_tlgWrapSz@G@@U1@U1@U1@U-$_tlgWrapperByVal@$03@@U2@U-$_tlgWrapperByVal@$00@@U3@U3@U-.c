        ...
        __int64 a62)
{
  ...
  int v74; // eax
  const WCHAR *v75; // r8
  _BYTE v77[32]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v79 = v63;
  v80 = 0;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14029AF48, a2, 0LL, 0LL, 61, v77);
}
