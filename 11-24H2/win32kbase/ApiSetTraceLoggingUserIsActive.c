/*
 * XREFs of ApiSetTraceLoggingUserIsActive @ 0x140193FD8
 * Callers:
...
__int64 (*__fastcall ApiSetTraceLoggingUserIsActive(__int64 a1, __int64 a2))(void)
{
  ...
  v3 = a1;
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7264LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 7272LL);
      if ( result )
