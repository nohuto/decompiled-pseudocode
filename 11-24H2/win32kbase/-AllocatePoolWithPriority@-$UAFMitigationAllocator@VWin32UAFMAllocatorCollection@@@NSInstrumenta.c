/*
 * XREFs of ?AllocatePoolWithPriority@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@SAPEAX_K0IW4_EX_POOL_PRIORITY@@PEAI@Z @ 0x1401BF37C
 * Callers:
 *     Win32UAFMAllocPoolWithPriority @ 0x1401BEDA0 (Win32UAFMAllocPoolWithPriority.c)
 * Callees:
