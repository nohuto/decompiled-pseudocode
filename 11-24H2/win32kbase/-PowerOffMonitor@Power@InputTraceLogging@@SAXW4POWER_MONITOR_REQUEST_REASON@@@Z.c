/*
 * XREFs of ?PowerOffMonitor@Power@InputTraceLogging@@SAXW4POWER_MONITOR_REQUEST_REASON@@@Z @ 0x14019EE74
 * Callers:
...
void __fastcall InputTraceLogging::Power::PowerOffMonitor(enum POWER_MONITOR_REQUEST_REASON a1)
{
  enum POWER_MONITOR_REQUEST_REASON v1; // r8d
