/*
 * XREFs of ?SetBufferProperty@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x140075AB0
 * Callers:
 *     ?SetBufferProperty@CWindowNodeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1400F9D70 (-SetBufferProperty@CWindowNodeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_.c)
 *     ?SetBufferProperty@CCursorVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x14022A3C0 (-SetBufferProperty@CCursorVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEB.c)
 * Callees:
 ...
 *     ?SetHeatMapColorHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_KPEA_N@Z @ 0x14022CAB4 (-SetHeatMapColorHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_K.c)
        ...
        bool *a6)
{
  ...
  if ( !v10 )
  {
    ...
    if ( v27 )
    {
      ...
      {
LABEL_35:
        v31 = *(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, struct DirectComposition::CApplicationChannel *, __int64, unsigned int *, unsigned __int64, _BYTE *))(*(_QWORD *)v19 + 280LL);
        v43[0] = 0;
        ...
        if ( v22 >= 0 )
        {
          if ( v43[0] )
          {
            ...
            if ( (v32 & 2) == 0 )
            {
              ...
              {
                v33 = *((_DWORD *)v19 + 9);
                for ( i = v33; (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
                {
                  if ( (_DWORD)i == 158 )
                  {
                    v35 = 456LL;
...
LABEL_34:
    v29 = 1;
    v30 = DirectComposition::CApplicationChannel::CreateInternalPrivateResource(a2, 0x6Eu, &v44);
    v19 = v44;
    v22 = v30;
    if ( v30 < 0 )
      goto LABEL_70;
...
LABEL_21:
    v20 = 1;
    v21 = DirectComposition::CApplicationChannel::CreateInternalPrivateResource(a2, 0x7Fu, &v44);
    v19 = v44;
    v22 = v21;
    if ( v21 >= 0 )
    {
LABEL_22:
      v23 = *(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, struct DirectComposition::CApplicationChannel *, __int64, unsigned int *, unsigned __int64, _BYTE *))(*(_QWORD *)v19 + 280LL);
      v43[0] = 0;
      ...
      if ( v22 >= 0 )
      {
        if ( v43[0] )
        {
          ...
          if ( (v24 & 2) == 0 )
          {
            ...
            {
              v25 = *((_DWORD *)v19 + 9);
              for ( j = v25; (unsigned int)j < 0xC2; LODWORD(j) = dword_140270F80[j] )
              {
                if ( (_DWORD)j == 158 )
                {
                  v15 = 456LL;
...
LABEL_12:
      ...
      if ( !v20 )
        return (unsigned int)v22;
      if ( v22 >= 0 )
        (*(void (__fastcall **)(DirectComposition::CVisualMarshaler *, struct DirectComposition::CApplicationChannel *, __int64, struct DirectComposition::CResourceMarshaler *, bool *))(*(_QWORD *)this + 288LL))(
          this,
          a2,
          7LL,
          v19,
