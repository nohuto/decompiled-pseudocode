/*
 * XREFs of ?SetResourceReferenceProperty@CApplicationChannel@DirectComposition@@QEAAJPEAVCResourceMarshaler@2@I0@Z @ 0x140072ACC
 * Callers:
        ...
        struct DirectComposition::CResourceMarshaler *a4)
{
  ...
  v4 = *(_QWORD *)a2;
  v13 = 0;
  v7 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, __int64, struct DirectComposition::CResourceMarshaler *, char *))(v4 + 288))(
         a2,
         this,
         a3,
         a4,
  ...
  if ( v7 >= 0 )
  {
    if ( v13 )
    {
      ...
      if ( (v8 & 2) == 0 )
      {
        ...
        {
          v9 = *((_DWORD *)a2 + 9);
          for ( i = v9; (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
          {
            if ( (_DWORD)i == 158 )
            {
              v11 = 456LL;
