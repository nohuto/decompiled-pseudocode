/*
 * XREFs of ?CSTPop@@YAHPEAIPEAPEAX@Z @ 0x140134A3C
 * Callers:
 *     ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x140165460 (-Win32kNtUserCleanupInternal@@YAXXZ.c)
 *     HandleSystemThreadCreationFailure @ 0x1401AD760 (HandleSystemThreadCreationFailure.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall CSTPop(unsigned int *a1, void **a2)
{
  ...
  v4 = W32GetUserSessionState(a1) + 71552;
