/*
 * XREFs of ??$GreReleaseSemaphoreShared@$01$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x1400BC294
 * Callers:
...
void __fastcall GreReleaseSemaphoreShared<2,>(struct _ERESOURCE **a1, __int64 a2, int a3)
{
  ...
  v3 = *a1;
  EtwTraceGreLockReleaseSemaphore((__int64)L"GreLock", (unsigned int)*a1 + 1144, a3);
