/*
 * XREFs of ?LoadKeyboardLayoutFile@@YAPEAUtagKBDFILE@@PEAXIIPEBGPEAGKK@Z @ 0x14010D000
 * Callers:
        ...
        unsigned int a7)
{
  ...
  v10 = Str2;
  for ( i = *(struct tagKBDFILE **)(W32GetUserSessionState(a1) + 14192); i; i = (struct tagKBDFILE *)*((_QWORD *)i + 2) )
  {
...
LABEL_18:
    ...
    if ( LayoutFile )
    {
      v18 = *(_QWORD *)(W32GetUserSessionState(v17) + 14192);
      *((_QWORD *)i + 2) = v18;
      *(_QWORD *)(W32GetUserSessionState(v18) + 14192) = i;
      return i;
    }
    goto LABEL_18;
  }
