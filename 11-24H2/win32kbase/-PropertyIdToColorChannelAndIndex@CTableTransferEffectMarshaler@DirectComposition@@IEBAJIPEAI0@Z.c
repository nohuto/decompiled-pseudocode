/*
 * XREFs of ?PropertyIdToColorChannelAndIndex@CTableTransferEffectMarshaler@DirectComposition@@IEBAJIPEAI0@Z @ 0x14022F908
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v4 = 0;
  if ( (a2 & 0xF) == 0xD && a2 >> 6 < *((_DWORD *)this + 4 * ((a2 >> 4) & 3) + 30) )
  {
    *a4 = a2 >> 6;
    *a3 = (a2 >> 4) & 3;
  }
