/*
 * XREFs of ?InsertInternal@CPointerHashTable@NSInstrumentation@@AEAA?AW4EInsertResult@12@PEBX0@Z @ 0x1401D1148
 * Callers:
 ...
 * Callees:
 *     ?InsertWithHash@CPointerHashTable@NSInstrumentation@@AEAAX_KPEBX1@Z @ 0x140158F2C (-InsertWithHash@CPointerHashTable@NSInstrumentation@@AEAAX_KPEBX1@Z.c)
 */
...
LABEL_3:
    NSInstrumentation::CPointerHashTable::InsertWithHash(
      ...
      0x9E3779B97F34A803uLL * ((unsigned __int64)a2 >> 4),
      a2,
      a3);
    return v4;
  }
