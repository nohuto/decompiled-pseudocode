/*
 * XREFs of ?LogHanging@KeyboardInputTelemetry@@CAXPEAUtagTHREADINFO@@_K@Z @ 0x1401BFAC8
 * Callers:
...
void __fastcall KeyboardInputTelemetry::LogHanging(struct tagTHREADINFO *a1, __int64 a2)
{
  ...
  char v14[32]; // [rsp+50h] [rbp-38h] BYREF

  if ( (unsigned int)KeyboardInputTelemetry::GetKeyboardInputLatency(a2) > 0x2710 )
  {
    v3 = *((_QWORD *)a1 + 58);
    v4 = v3 ? (char *)(v3 + 984) : (char *)L"Unknown";
    RtlStringCchCopyW(v14, 16LL, v4);
