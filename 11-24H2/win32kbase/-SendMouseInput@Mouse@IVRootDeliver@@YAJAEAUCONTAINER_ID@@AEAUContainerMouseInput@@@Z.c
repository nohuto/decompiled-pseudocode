/*
 * XREFs of ?SendMouseInput@Mouse@IVRootDeliver@@YAJAEAUCONTAINER_ID@@AEAUContainerMouseInput@@@Z @ 0x14021A6AC
 * Callers:
        ...
        struct ContainerMouseInput *a3)
{
  ...
  if ( CIVChannel::ContainerConnected(*(_DWORD *)(*(_QWORD *)(UserSessionState + 3104) + 1272LL)) )
  {
    v7 = *(_QWORD *)a2;
    v8 = 1;
    v9 = *((_DWORD *)a2 + 2);
