/*
 * XREFs of ?ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x140146660
 * Callers:
  ...
  if ( (*(_BYTE *)a1 & 8) != 0 )
  {
    ...
    if ( (_DWORD)v10 )
    {
      switch ( (_DWORD)v10 )
      {
        ...
        default:
          ...
          WdLogGlobalForLineNumber = 13994;
          return 3221225485LL;
      }
    }
    else
    ...
    *((_DWORD *)a2 + 51) = v11;
    ...
    if ( (_DWORD)v12 && (_DWORD)v12 != 12 && (_DWORD)v12 != 30 && (_DWORD)v12 != 31 && (unsigned int)(v12 - 32) >= 2 )
    {
      ...
      WdLogGlobalForLineNumber = 14009;
      return 3221225485LL;
    }
    *((_DWORD *)a2 + 52) = v12;
  }
