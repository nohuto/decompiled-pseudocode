/*
 * XREFs of McTemplateK0qxxxxxi_EtwWriteTransfer @ 0x14012E2A4
 * Callers:
 *     EtwTraceFlipManagerPresentProcessed @ 0x14012E0A0 (EtwTraceFlipManagerPresentProcessed.c)
 *     EtwTraceFlipManagerPresentSkipped @ 0x14014DCD0 (EtwTraceFlipManagerPresentSkipped.c)
 *     EtwTraceFlipManagerPresentCanceled @ 0x1401B46D0 (EtwTraceFlipManagerPresentCanceled.c)
 *     EtwTraceFlipManagerPresentDeferred @ 0x1401B48C0 (EtwTraceFlipManagerPresentDeferred.c)
 * Callees:
