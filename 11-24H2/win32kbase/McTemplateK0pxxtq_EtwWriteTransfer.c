/*
 * XREFs of McTemplateK0pxxtq_EtwWriteTransfer @ 0x1401B5864
 * Callers:
 *     EtwTraceFlipManagerContentRebind @ 0x140151C60 (EtwTraceFlipManagerContentRebind.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x140033530 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x14023F3B0 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pxxtq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerContentRebind, &W32kControlGuid, 6u, &v4);
}
