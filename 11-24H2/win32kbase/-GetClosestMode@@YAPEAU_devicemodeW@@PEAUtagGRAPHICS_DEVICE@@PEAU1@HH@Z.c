/*
 * XREFs of ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x140134AA8
 * Callers:
...
LABEL_49:
    ...
    while ( 1 )
    {
      ...
      if ( !a4 || ((LOBYTE(a2->dmDisplayFlags) ^ *(_BYTE *)(v20 + 180)) & 2) == 0 )
      {
        ...
        v22 = v12 < dword_1402649D0[v21];
        v23 = v12 <= dword_1402649D0[v21];
        v18 = v59;
        if ( !v22 )
          break;
      }
...
LABEL_67:
    ...
    v43 = a2->dmPelsWidth;
    v44 = v43 - v42;
    v58 = dword_1402649D0[4 * *(unsigned int *)(v20 + 84) + a2->dmDisplayOrientation];
    v45 = v42 - v43;
    v22 = v43 < v42;
    v46 = *(_DWORD *)(v20 + 176);
    v47 = a2->dmPelsHeight;
