/*
 * XREFs of ?IsAnyMessageNonDelegated@CPointerInfoNode@@QEBAHXZ @ 0x14020111C
 * Callers:
 ...
 *     ?IsMessageNonDelegated@CPointerInfoNode@@QEBAHHHH@Z @ 0x14013C070 (-IsMessageNonDelegated@CPointerInfoNode@@QEBAHHHH@Z.c)
