/*
 * XREFs of McTemplateK0cdqq_EtwWriteTransfer @ 0x1400333FC
 * Callers:
...
__int64 __fastcall McTemplateK0cdqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite_EtwWriteTransfer(a1, &BeginAppMessageProcessing, &W32kControlGuid, 5LL, v8);
}
