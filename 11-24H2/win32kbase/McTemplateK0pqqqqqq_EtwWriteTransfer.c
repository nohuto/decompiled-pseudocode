/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1400FA13C
 * Callers:
 *     EtwDevLockEndTightUpdate @ 0x1400FA080 (EtwDevLockEndTightUpdate.c)
 *     EtwDevLockEndUpdate @ 0x1400FA0E0 (EtwDevLockEndUpdate.c)
 * Callees:
