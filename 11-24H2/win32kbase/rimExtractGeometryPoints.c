/*
 * XREFs of rimExtractGeometryPoints @ 0x1401EDEF8
 * Callers:
...
void __fastcall rimExtractGeometryPoints(__int16 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3284);
    v7 = a4;
  }
  if ( a5 <= 0x20 )
  {
...
LABEL_11:
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3285);
  }
  v7 = a4;
  while ( v9 < 4 )
  {
