/*
 * XREFs of rimSetContactKeepAliveState @ 0x1401EE648
 * Callers:
...
__int64 __fastcall rimSetContactKeepAliveState(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( (*(_DWORD *)(a2 + 32) & 2) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1866);
  if ( (*(_DWORD *)(a2 + 32) & 4) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1867);
