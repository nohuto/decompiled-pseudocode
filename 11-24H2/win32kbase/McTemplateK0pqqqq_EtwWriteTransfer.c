/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1400BF448
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1400BF370 (EtwDirtyRectUpdate.c)
 *     EtwTraceInternalSetTimer @ 0x1400BF3B0 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1400BF400 (EtwTraceTimerProc.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1401CD800 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1401CD840 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1401CDB70 (EtwTranslationUpdate.c)
 * Callees:
