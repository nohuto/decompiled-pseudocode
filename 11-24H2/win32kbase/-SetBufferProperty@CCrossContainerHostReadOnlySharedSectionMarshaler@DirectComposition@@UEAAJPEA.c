/*
 * XREFs of ?SetBufferProperty@CCrossContainerHostReadOnlySharedSectionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1402323C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DirectComposition::SetGuidProperty @ 0x14023241C (DirectComposition--SetGuidProperty.c)
 */
