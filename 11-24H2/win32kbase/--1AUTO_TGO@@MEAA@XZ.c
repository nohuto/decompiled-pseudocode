/*
 * XREFs of ??1AUTO_TGO@@MEAA@XZ @ 0x14008D914
 * Callers:
 ...
 *     _DrvChangeDisplaySettings_::_2_::AUTO_KM::_scalar_deleting_destructor_ @ 0x1401C66A0 (_DrvChangeDisplaySettings_--_2_--AUTO_KM--_scalar_deleting_destructor_.c)
 *     ??_GAUTO_TGO@@MEAAPEAXI@Z @ 0x1401C66F0 (--_GAUTO_TGO@@MEAAPEAXI@Z.c)
 * Callees:
