/*
 * XREFs of ?GetAdjustedHimetric@@YAHUtagPOINT@@00PEAU1@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1400DD250
 * Callers:
 *     GetAdjustedPointerLocations @ 0x1400DD110 (GetAdjustedPointerLocations.c)
 * Callees:
