/*
 * XREFs of CreateVmSharedMemorySection @ 0x14023E9E4
 * Callers:
 *     ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x140232110 (-CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEA.c)
 * Callees:
 *     StringFromGuid @ 0x14023EBEC (StringFromGuid.c)
 */
