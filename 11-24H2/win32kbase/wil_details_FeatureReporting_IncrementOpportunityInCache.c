/*
 * XREFs of wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1401A2454
 * Callers:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x140136298 (wil_details_FeatureReporting_RecordUsageInCache.c)
 * Callees:
 *     <none>
 */
