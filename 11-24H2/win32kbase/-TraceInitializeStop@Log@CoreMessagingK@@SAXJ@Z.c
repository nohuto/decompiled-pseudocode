/*
 * XREFs of ?TraceInitializeStop@Log@CoreMessagingK@@SAXJ@Z @ 0x1400FBDD0
 * Callers:
...
void __fastcall CoreMessagingK::Log::TraceInitializeStop(int a1, __int64 a2, __int64 a3, __int64 a4)
{
