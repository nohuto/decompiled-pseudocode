/*
 * XREFs of ?ConvertDisplayConfigPathIntoExistingPathModalityAtIdx@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@II_N11PEAUD3DKMT_GETPATHSMODALITY@@PEA_N@Z @ 0x14008D04C
 * Callers:
 ...
 *     ?ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x140146660 (-ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@P.c)
 */
        ...
        bool *a8)
{
  ...
  for ( i = *(_QWORD *)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 1096LL); ; i = *(_QWORD *)(i + 128) )
  {
    if ( !i )
    {
      ...
      WdLogGlobalForLineNumber = 14058;
      return 3221225485LL;
    }
  ...
  *((_QWORD *)v14 + 8) = *((_QWORD *)a1 + 1);
  ...
  {
    WdLogSingleEntry1(2LL, v15);
    WdLogGlobalForLineNumber = 14079;
    return 3221225485LL;
  }
  v16 = *((_QWORD *)a1 + 1);
  if ( (v16 & 0xFFFFFE7FFE7DF470uLL) != 0 || (v15 & v16) != v16 )
  {
    ...
    WdLogGlobalForLineNumber = 14087;
    return 3221225485LL;
  }
  ...
  if ( TargetVirtualization < 0 )
  {
    ...
    result = v18;
    WdLogGlobalForLineNumber = 14102;
    return result;
  }
  v19 = v34;
  ...
  *((_DWORD *)v14 + 60) = v22;
  ...
  if ( (*(_QWORD *)a1 & 0x8000000000000LL) != 0 && v23 != *((_BYTE *)a1 + 101) )
  {
    ...
    WdLogGlobalForLineNumber = 14129;
    return 3221225485LL;
  }
  *((_QWORD *)v14 + 38) = 0LL;
  if ( (*(_BYTE *)a1 & 0x87) != 0 )
  ...
  {
    WdLogSingleEntry1(2LL, v9);
    WdLogGlobalForLineNumber = 14146;
    return 3221225485LL;
  }
  if ( (*(_DWORD *)a1 & 0x1000000) != 0 )
  {
    ...
    {
      WdLogSingleEntry1(2LL, v9);
      WdLogGlobalForLineNumber = 14160;
      return 3221225485LL;
    }
    if ( !*((_DWORD *)a1 + 50) )
    {
      WdLogSingleEntry1(2LL, v9);
      WdLogGlobalForLineNumber = 14166;
      return 3221225485LL;
    }
