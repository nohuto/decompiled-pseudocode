/*
 * XREFs of _PopulatePropertyUsageValues @ 0x1401DE448
 * Callers:
        ...
        PHIDP_PREPARSED_DATA a9)
{
  ...
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3631);
  }
  if ( !a1 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3632);
  }
  ValueCaps = a6;
  if ( !a6 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3633);
  }
  if ( !a2 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3634);
  }
  if ( !v10 )
  {
    LODWORD(a8) = 0x20000;
  ...
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3636);
  }
  a8 = *(_QWORD *)(a1 + 16);
  if ( !a8 )
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3639);
  }
  if ( !v10 || !v16 )
    return 0LL;
  v17 = *a2;
  ...
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3645);
  }
