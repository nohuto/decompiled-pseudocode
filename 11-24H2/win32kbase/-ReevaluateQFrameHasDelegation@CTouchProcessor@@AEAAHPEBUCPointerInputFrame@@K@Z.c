/*
 * XREFs of ?ReevaluateQFrameHasDelegation@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@K@Z @ 0x140205358
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( *v6 != a3 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15385);
  v7 = *((_DWORD *)a2 + 12);
  for ( i = 0; i < v7; ++i )
  {
