/*
 * XREFs of ?LogPointerDeviceCreated@RimTelemetry@@CAXGGPEBG0H0AEBU_GUID@@_KEEEQEAXJJJ22HH0KHQEAU_UNICODE_STRING@@400AEBUtagRECT@@5@Z @ 0x140114E54
 * Callers:
        ...
        const struct tagRECT *a28)
{
  ...
  const unsigned __int16 *v48; // [rsp+178h] [rbp-38h] BYREF
  const unsigned __int16 *v49; // [rsp+180h] [rbp-30h] BYREF
  struct _UNICODE_STRING *v50; // [rsp+188h] [rbp-28h] BYREF
  struct _UNICODE_STRING *v51; // [rsp+190h] [rbp-20h] BYREF
  const unsigned __int16 *v52; // [rsp+198h] [rbp-18h] BYREF
  ...
  const unsigned __int16 *v58; // [rsp+1C8h] [rbp+18h] BYREF
  const unsigned __int16 *v59; // [rsp+1D0h] [rbp+20h] BYREF
  const unsigned __int16 *v60; // [rsp+1D8h] [rbp+28h] BYREF

  if ( (unsigned int)dword_14029AE68 > 5
    && (qword_14029AE78 & 0x800000000000LL) != 0
    && (qword_14029AE80 & 0x800000000000LL) == qword_14029AE80 )
  {
    v47 = 2048LL;
    v59 = a4;
    v60 = a3;
