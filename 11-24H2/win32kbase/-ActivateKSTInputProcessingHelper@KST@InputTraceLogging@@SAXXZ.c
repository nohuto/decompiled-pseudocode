/*
 * XREFs of ?ActivateKSTInputProcessingHelper@KST@InputTraceLogging@@SAXXZ @ 0x14019F484
 * Callers:
...
void InputTraceLogging::KST::ActivateKSTInputProcessingHelper(void)
{
