/*
 * XREFs of ?Free@?$CTypeIsolation@$0BKAAA@$0BKA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14003EB28
 * Callers:
 *     ?HMFreeUserOrIsolatedType@@YAXGEPEAX@Z @ 0x14001B87C (-HMFreeUserOrIsolatedType@@YAXGEPEAX@Z.c)
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14003ECA0 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<106496,416>::Free(__int64 *a1, void *a2)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    ...
    v6 = i[4];
    v7 = NSInstrumentation::CSectionBitmapAllocator<106496,416>::CheckAllocationStatus(v6, a2);
    if ( !v7 )
      continue;
    v8 = v7 - 1;
    if ( !v8 )
