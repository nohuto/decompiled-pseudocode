/*
 * XREFs of ?EmitBuffers@CCaptureRenderTargetMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1401969FC
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  while ( (*((_DWORD *)this + 4) & 0x100) != 0 || *v5 < *v3 )
  {
    ...
    v19 = 0LL;
    DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)v2, 8 * v7 + 16, &v19);
    v8 = (char *)v19;
    *(_DWORD *)v19 = 8 * v7 + 16;
    *(_QWORD *)(v8 + 4) = 0LL;
    *((_DWORD *)v8 + 3) = 0;
