/*
 * XREFs of ?InitializeSortedVector@CLeakTrackingAllocator@NSInstrumentation@@AEAAXPEAPEAV?$CSortedVector@PEAXPEAX@2@@Z @ 0x1401D035C
 * Callers:
 ...
 * Callees:
 *     ?Create@?$CSortedVector@PEAXPEAX@NSInstrumentation@@SAPEAV12@XZ @ 0x1401CFEBC (-Create@-$CSortedVector@PEAXPEAX@NSInstrumentation@@SAPEAV12@XZ.c)
