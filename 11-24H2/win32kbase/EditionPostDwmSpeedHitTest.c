/*
 * XREFs of EditionPostDwmSpeedHitTest @ 0x1400E16D4
 * Callers:
        ...
        __int64 a6))(__int64, __int64, __int64, __int64, __int64, __int64)
{
  ...
  result = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48)
                                                                                          + 6040LL);
  if ( result )
