/*
 * XREFs of ?SetReferenceProperty@CSpriteShapeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x140072330
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( a3 == 1 )
  {
    ...
    {
      if ( v5 == *((struct DirectComposition::CResourceMarshaler **)this + 9)
  ...
  if ( v5 != *((struct DirectComposition::CResourceMarshaler **)this + 10) )
  {
    v9 = DirectComposition::CApplicationChannel::ReplaceResource<DirectComposition::CResourceMarshaler>(a2);
    if ( v9 < 0 )
      return (unsigned int)v9;
