/*
 * XREFs of ?Map@MapViewOfSectionObj@Gre@@QEAA_NPEAXW4MapKind@12@_KPEAT_LARGE_INTEGER@@@Z @ 0x14010A1F0
 * Callers:
...
char __fastcall Gre::MapViewOfSectionObj::Map(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  int v6; // esi
  _QWORD *v9; // r14
  ...
  __int64 v29; // [rsp+90h] [rbp+20h] BYREF
  ...
  switch ( (_DWORD)a3 )
  {
    case 0:
      ...
      goto LABEL_5;
    case 1:
      CurrentProcess = PsGetCurrentProcess(a1, (unsigned int)(a3 - 1), a3, a4);
      v26 = 4;
LABEL_5:
      *(_QWORD *)(a1 + 24) = CurrentProcess;
      v11 = MmMapViewOfSection(a2, CurrentProcess, a1 + 16, 0LL, a4, &v27, &v29, 2, 0x400000, v26);
LABEL_6:
      v12 = v11;
      break;
    case 2:
      CurrentThread = GreGetCurrentThread(a1);
      v25 = UMPDGetThreadClientPID(CurrentThread);
      Process = 0LL;
      if ( PsLookupProcessByProcessId((HANDLE)v25, &Process) < 0 )
        return 0;
      v12 = MmMapViewOfSection(a2, Process, a1 + 16, 0LL, a4, &v27, &v29, 2, 0x400000, 4);
      ObfDereferenceObject(Process);
      break;
    case 3:
      v11 = MmMapViewInSessionSpaceEx(a2, a1 + 16, &v29, a5, 0LL);
      goto LABEL_6;
    case 4:
      ...
      if ( v23 )
      {
        v11 = v23(a2, a1 + 16, 0LL, 0LL, &v27, &v29, 2, 0x400000, 2, a1);
        goto LABEL_6;
      }
      v12 = -1073741637;
      break;
