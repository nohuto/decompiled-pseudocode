/*
 * XREFs of ?PutResourceOnUpdatedList@CApplicationChannel@DirectComposition@@QEAAXPEAVCResourceMarshaler@2@@Z @ 0x14004AFA4
 * Callers:
        ...
        struct DirectComposition::CResourceMarshaler *a2)
{
  ...
  if ( (v2 & 2) == 0 )
  {
    ...
    {
      v4 = *((_DWORD *)a2 + 9);
      for ( i = v4; (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
      {
        if ( (_DWORD)i == 158 )
        {
          v6 = 456LL;
