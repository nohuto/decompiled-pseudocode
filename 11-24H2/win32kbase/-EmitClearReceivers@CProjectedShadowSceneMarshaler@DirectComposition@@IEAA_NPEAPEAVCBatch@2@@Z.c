/*
 * XREFs of ?EmitClearReceivers@CProjectedShadowSceneMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x14012E894
 * Callers:
...
char __fastcall DirectComposition::CProjectedShadowSceneMarshaler::EmitClearReceivers(
