/*
 * XREFs of ?vDynamicSwitchPalettes@@YAXPEAVSURFACE@@PEAVPDEV@@1@Z @ 0x1401C5D14
 * Callers:
    ...
    *((_DWORD *)a1 + 28) |= 0x20000000u;
    if ( (*((_DWORD *)a2 + 539) & 0x100) != 0 )
    {
        ...
        && *((_QWORD *)v13 + 9) )
      {
        ...
        v20 = 0;
        v19 = 0LL;
        if ( (unsigned int)PALMEMOBJ::bCreatePalette((PALMEMOBJ *)&v19, 1, 0x100u, v14, 0, 0, 0, 0x400u, 1) )
        {
          v15 = v19;
          v16 = v19;
          v12 = 1;
