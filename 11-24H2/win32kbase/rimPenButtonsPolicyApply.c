/*
 * XREFs of rimPenButtonsPolicyApply @ 0x1401EE4A0
 * Callers:
...
__int64 __fastcall rimPenButtonsPolicyApply(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)(*(_DWORD *)(a1 + 24) - 5) > 1 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1323);
  *(_DWORD *)(a2 + 2528) &= 0xFFFFFFF9;
  result = *(unsigned int *)(a2 + 32);
  if ( (result & 0x20) != 0 )
  {
    if ( *(_DWORD *)(a1 + 1044) <= 1u )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1331);
