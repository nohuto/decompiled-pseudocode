/*
 * XREFs of ?PrepareMakePointerMessage@CTouchProcessor@@QEAAPEBUtagPOINTER_INFO@@_KPEAUtagPOINT@@PEAH22@Z @ 0x140203690
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a6)
{
        ...
        (v14 = FrameById) != 0LL) )
  {
    if ( *((_DWORD *)v12 + 8) >= *((_DWORD *)FrameById + 12) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13667);
    v15 = (_DWORD *)(v14[30] + 480LL * *((unsigned int *)v12 + 8));
    v16 = v15 + 42;
    if ( v15[43] != *((unsigned __int16 *)v12 + 8) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13672);
