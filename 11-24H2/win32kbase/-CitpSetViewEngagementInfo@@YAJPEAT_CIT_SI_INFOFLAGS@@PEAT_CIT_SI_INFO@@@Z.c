/*
 * XREFs of ?CitpSetViewEngagementInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1400B577C
 * Callers:
  ...
  if ( (unsigned int)Feature_ResponsiblePid__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    if ( v14 >= 0 )
    {
      ...
      if ( ProcessInfo )
      {
        ...
        {
          v6 = CitpInteractionSummaryEnsure(v3, *((struct tagPROCESSINFO ***)v5 + 115), 1);
          if ( v6 )
            *((_QWORD *)v6 + 2) |= v12;
          **((_QWORD **)v5 + 115) = v12;
        }
  ...
  else
  {
    ...
    if ( PsLookupProcessByProcessId((HANDLE)SDWORD2(v12), &Process) >= 0 )
    {
      ...
      if ( ProcessSessionId == (unsigned int)W32GetCurrentWin32kSessionId() )
      {
        ...
        {
          v10 = CitpInteractionSummaryEnsure(v3, v9[115], 1);
          if ( v10 )
            *((_QWORD *)v10 + 2) |= v12;
          *v9[115] = (struct tagPROCESSINFO *)v12;
        }
      }
