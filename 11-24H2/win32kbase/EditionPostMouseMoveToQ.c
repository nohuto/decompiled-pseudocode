/*
 * XREFs of EditionPostMouseMoveToQ @ 0x1400E66C4
 * Callers:
        ...
        __int64 a7))(__int64, __int64, _QWORD, __int64, __int64, __int64, __int64)
{
  ...
  result = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, __int64, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48)
                                                                                                  + 4872LL);
  if ( result )
