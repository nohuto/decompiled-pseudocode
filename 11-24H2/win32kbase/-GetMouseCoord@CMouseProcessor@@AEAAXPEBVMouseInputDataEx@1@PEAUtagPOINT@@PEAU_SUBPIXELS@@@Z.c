/*
 * XREFs of ?GetMouseCoord@CMouseProcessor@@AEAAXPEBVMouseInputDataEx@1@PEAUtagPOINT@@PEAU_SUBPIXELS@@@Z @ 0x14018CABC
 * Callers:
        ...
        struct _SUBPIXELS *a4)
{
  ...
  *(_QWORD *)a4 = 0LL;
  v6 = *((_WORD *)a2 + 1);
  v10 = CMouseProcessor::MouseInputDataEx::TestProcessingOption((__int64)a2, 16);
  v11 = v10 | 2;
  if ( (v6 & 0x80u) == 0 )
    v11 = v10;
  if ( (v11 & 1) == 0 && (W32GetCurrentThreadDpiAwarenessContext(v9) & 0xF) != 2 )
  ...
  v16 = *((_QWORD *)a2 + 6);
  if ( (v6 & 1) != 0 )
    CMouseProcessor::GetMouseCoordinateAbsolute((__int64)this, v14, v13, v6, a3, a4, v16, v15, v11);
  else
    CMouseProcessor::GetMouseCoordinateRelative(this, v14, v13, a3, a4, v16, v15, v11);
}
