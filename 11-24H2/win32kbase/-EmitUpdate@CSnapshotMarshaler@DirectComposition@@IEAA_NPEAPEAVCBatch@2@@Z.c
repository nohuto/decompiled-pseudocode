/*
 * XREFs of ?EmitUpdate@CSnapshotMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140232B50
 * Callers:
 *     ?EmitUpdateCommands@CSnapshotMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x140232C10 (-EmitUpdateCommands@CSnapshotMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  *((_DWORD *)v4 + 5) = *((_DWORD *)this + 17);
  ...
  if ( v6 )
  {
    ...
    *((_QWORD *)this + 7) = 0LL;
    DirectComposition::CApplicationChannel::NotifyCommitMustBeLastForFrame(v7, 0);
  }
  return 1;
}
