/*
 * XREFs of ?GrepRestoreDCOBJ@@YAHAEAVXDCOBJ@@H@Z @ 0x1401211B0
 * Callers:
 ...
 *     ?vCalcFillOrigin@DC@@QEAAXXZ @ 0x1400D6440 (-vCalcFillOrigin@DC@@QEAAXXZ.c)
...
__int64 __fastcall GrepRestoreDCOBJ(struct XDCOBJ *a1, int a2)
{
  ...
  __int64 v15; // rcx
  int v16; // ebx
  void (__fastcall *v17)(struct XDCOBJ *, _QWORD); // rax
  SURFACE *v18; // rcx
  int v19; // eax
  DC *v20; // rcx
  struct _ERESOURCE *v21; // rdx
  __int64 v22; // rax
  int v23; // r8d
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( v13 )
      {
        if ( v13() >= 0 )
        {
          v16 = *(_DWORD *)(*(_QWORD *)a1 + 104LL);
          v17 = *(void (__fastcall **)(struct XDCOBJ *, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v15, v14) + 24)
                                                               + 824LL);
          if ( v17 )
            v17(a1, (unsigned int)(v16 - 1));
        }
      }
      v18 = *(SURFACE **)(*(_QWORD *)a1 + 496LL);
      if ( v18 )
      {
        if ( *(_DWORD *)(*(_QWORD *)a1 + 32LL) == 1 )
        {
          GrepSelectBitmap((__int64)v39, a1, *(_QWORD *)(*(_QWORD *)(v2 + 3008) + 168LL), 5);
        }
        else
        {
          v19 = *((_DWORD *)v18 + 28);
          ...
          {
            SURFACE::vDec_cRef(v18);
          }
        }
      }
      SEMOBJ<13>::SEMOBJ<13>((struct _ERESOURCE **)&v43, (struct _ERESOURCE **)v2);
      v20 = v40[0];
      v21 = (struct _ERESOURCE *)*((_QWORD *)v40[0] + 10);
      if ( *(struct _ERESOURCE **)(*(_QWORD *)a1 + 80LL) != v21 )
      {
        GrepSelectPalette(a1, v21, 1);
        v20 = v40[0];
      }
      if ( *(_QWORD *)(*(_QWORD *)a1 + 88LL) != *((_QWORD *)v20 + 11) )
      {
      ...
      v22 = *((_QWORD *)v20 + 11);
      if ( v22 != *(_QWORD *)(v2 + 3768) )
      {
        _InterlockedDecrement((volatile signed __int32 *)(v22 + 56));
        v20 = v40[0];
      }
      DC::vCopyTo(v20, a1);
      XDCOBJ::vDeleteCore(v40);
      v24 = (struct _ERESOURCE *)v43;
      if ( v43 )
      {
        EtwTraceGreLockReleaseSemaphore((__int64)L"Palette", (int)v43, v23);
...
LABEL_40:
    ...
    v28 = *(struct OBJECT **)a1;
    *((_DWORD *)v28 + 9) |= 0x10u;
    EntryFromObject = GdiHandleManager::GetEntryFromObject(*(GdiHandleManager **)(v2 + 5672), v28);
