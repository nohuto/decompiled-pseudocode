/*
 * XREFs of ?ConvertDisplayConfigToPathModality@@YAJIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_GETPATHSMODALITY@@PEA_N@Z @ 0x14019B890
 * Callers:
  ...
  for ( i = 0; i < a1; ++i )
  {
    if ( *(__int64 *)a2 < 0 )
    {
      if ( v4 >= *((unsigned __int16 *)a3 + 11) )
      {
        ...
        result = 3221225507LL;
        WdLogGlobalForLineNumber = 14295;
        return result;
      }
