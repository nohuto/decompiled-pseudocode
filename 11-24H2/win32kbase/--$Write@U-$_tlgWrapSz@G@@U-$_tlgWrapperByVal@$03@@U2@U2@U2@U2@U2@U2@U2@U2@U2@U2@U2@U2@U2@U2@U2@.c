        ...
        __int64 a42)
{
  ...
  const WCHAR *v47; // [rsp+50h] [rbp-B0h]
  ...
  v47 = v42;
  v49 = 0;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029AF48, a2, 0LL, 0LL, 0x28u, &v46);
}
