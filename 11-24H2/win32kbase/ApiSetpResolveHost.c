/*
 * XREFs of ApiSetpResolveHost @ 0x14023BA3C
 * Callers:
 *     ApiSetResolveToHost @ 0x14010F9CC (ApiSetResolveToHost.c)
 * Callees:
 *     ApiSetpGetContractKeyInfo @ 0x14023BCF8 (ApiSetpGetContractKeyInfo.c)
 *     ApiSetpGetSearchKeyHash @ 0x14023BF58 (ApiSetpGetSearchKeyHash.c)
