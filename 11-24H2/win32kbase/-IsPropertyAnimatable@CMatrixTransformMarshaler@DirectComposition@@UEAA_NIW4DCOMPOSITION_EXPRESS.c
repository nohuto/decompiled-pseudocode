/*
 * XREFs of ?IsPropertyAnimatable@CMatrixTransformMarshaler@DirectComposition@@UEAA_NIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x140230BF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CMatrixTransformMarshaler::IsPropertyAnimatable(__int64 a1, __int64 a2, int a3)
{
