/*
 * XREFs of ApiSetEditionIsCompositionInputWindow @ 0x14009492C
 * Callers:
...
__int64 __fastcall ApiSetEditionIsCompositionInputWindow(__int64 a1, __int64 a2)
{
  ...
  v3 = 0;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5312LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(unsigned int (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 5320LL);
      if ( v7 )
        return v7(a1);
    }
  }
