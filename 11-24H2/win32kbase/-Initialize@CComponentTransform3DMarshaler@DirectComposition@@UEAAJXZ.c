/*
 * XREFs of ?Initialize@CComponentTransform3DMarshaler@DirectComposition@@UEAAJXZ @ 0x14010E5E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DirectComposition::CComponentTransform3DMarshaler::Initialize(
