/*
 * XREFs of ??$GreAcquireSemaphore@$0BE@$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x14001FDC0
 * Callers:
 *     ?GreAcquireHmgrSemaphore@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x1401C2FF0 (-GreAcquireHmgrSemaphore@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z.c)
 * Callees:
