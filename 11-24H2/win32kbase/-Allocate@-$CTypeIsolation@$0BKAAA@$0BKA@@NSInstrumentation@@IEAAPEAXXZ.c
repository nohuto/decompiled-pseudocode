/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BKAAA@$0BKA@@NSInstrumentation@@IEAAPEAXXZ @ 0x140110F64
 * Callers:
...
PVOID __fastcall NSInstrumentation::CTypeIsolation<106496,416>::Allocate(__int64 *a1)
{
  __int64 v2; // rbp
  __int64 *i; // rsi
  __int64 v4; // r14
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v5 = NSInstrumentation::CSectionEntry<106496,416>::Create();
      v6 = (_QWORD *)v5;
      if ( v5 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<106496,416>::Allocate(*(_QWORD *)(v5 + 32));
        if ( v2 )
        {
    ...
    v4 = NSInstrumentation::CSectionBitmapAllocator<106496,416>::Allocate(i[4]);
    if ( v4 )
      break;
  }
  if ( i == (__int64 *)*a1 )
