/*
 * XREFs of ?CalculateUniformSpaceMapping@@YAXPEAU_MDEV@@@Z @ 0x14013A9A8
 * Callers:
 ...
 *     ?MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z @ 0x1401C8FE4 (-MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z.c)
 */
...
void __fastcall CalculateUniformSpaceMapping(struct _MDEV *a1)
{
  ...
  {
    v3 = (char *)PALLOCNOZ((unsigned int)(4 * *((_DWORD *)a1 + 5)), 0x73726447u);
    if ( v3 )
    {
      v4 = *((_DWORD *)a1 + 5);
