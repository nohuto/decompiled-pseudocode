/*
 * XREFs of ?ReleaseAllReferences@CProjectedShadowCasterMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1402383B0
 * Callers:
 *     ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCProjectedShadowCasterMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x14022D350 (-ReleaseAllReferences@-$CSharedResourceMarshaler@VCProjectedShadowCasterMarshaler@DirectComposit.c)
 * Callees:
