/*
 * XREFs of ??0CIVChannel@@QEAA@PEAXKP6AXPEBXUCONTAINER_ID@@@ZP6A_N1KK00@ZP6APEAX1@Z@Z @ 0x14014E104
 * Callers:
        ...
        void *(*a6)(const void *))
{
  ...
  *((_QWORD *)this + 2) = a4;
  *((_BYTE *)this + 44) = 0;
  *(_QWORD *)(W32GetUserSessionState(this) + 8LL * *((unsigned int *)this + 2) + 19512) = this;
  return this;
}
