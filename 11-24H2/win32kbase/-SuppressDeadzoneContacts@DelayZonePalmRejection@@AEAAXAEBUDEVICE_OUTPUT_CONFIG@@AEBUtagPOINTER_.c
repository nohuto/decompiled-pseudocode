/*
 * XREFs of ?SuppressDeadzoneContacts@DelayZonePalmRejection@@AEAAXAEBUDEVICE_OUTPUT_CONFIG@@AEBUtagPOINTER_INFO@@@Z @ 0x140211B48
 * Callers:
        ...
        const struct tagPOINTER_INFO *a3)
{
  ...
  if ( Next )
  {
    while ( 1 )
    {
      v13 = *(CTouchProcessor **)(W32GetUserSessionState(v7) + 3264);
      if ( Next == v5 )
        break;
