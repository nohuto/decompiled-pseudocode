/*
 * XREFs of McTemplateK0qm_EtwWriteTransfer @ 0x1401323C0
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x140132390 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1401B5410 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
