/*
 * XREFs of ?GetPointerOffset@CTouchProcessor@@AEAAHGPEAUtagPOINT@@@Z @ 0x14020032C
 * Callers:
...
__int64 __fastcall CTouchProcessor::GetPointerOffset(PERESOURCE *this, unsigned __int16 a2, struct tagPOINT *a3)
{
  __int64 result; // rax
  ...
  {
    if ( !a3 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11940);
    *a3 = v5[25];
    return 1LL;
  }
  return result;
