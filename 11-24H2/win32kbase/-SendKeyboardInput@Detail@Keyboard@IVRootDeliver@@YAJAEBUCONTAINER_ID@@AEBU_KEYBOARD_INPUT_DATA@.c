/*
 * XREFs of ?SendKeyboardInput@Detail@Keyboard@IVRootDeliver@@YAJAEBUCONTAINER_ID@@AEBU_KEYBOARD_INPUT_DATA@@PEAX@Z @ 0x14021A5B8
 * Callers:
        ...
        void *a4)
{
  ...
  v13 = 0LL;
  v11 = 0LL;
  v7 = HMValidateHandleNoSecure((__int64)a3, 19);
  if ( v7 )
  {
