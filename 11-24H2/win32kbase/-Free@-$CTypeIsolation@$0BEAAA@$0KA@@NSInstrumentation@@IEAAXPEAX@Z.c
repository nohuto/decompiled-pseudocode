/*
 * XREFs of ?Free@?$CTypeIsolation@$0BEAAA@$0KA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1400411E0
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BEAAA@$0KA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14004060C (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BEAAA@$0KA@@NSInstrumentation@@QEAA-AW4Alloca.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<81920,160>::Free(__int64 *a1, void *a2)
{
  ...
  NSInstrumentation::CSectionBitmapAllocator<40960,160>::Free((__int64)v6, a2);
  if ( i == (__int64 *)*a1 )
  {
    W32ReleasePushLockShared(v4);
  }
