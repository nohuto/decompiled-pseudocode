/*
 * XREFs of ?SetProcessType@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@PEAU_PS_PKG_CLAIM@@@Z @ 0x1401A3830
 * Callers:
...
unsigned __int64 __fastcall SetProcessType(__int64 a1, __int64 a2, int a3, _DWORD *a4)
{
  ...
  v5 = 0LL;
  if ( a3 >= 3 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3989);
  *(_QWORD *)(a1 + 816) = (16 * v4) ^ (*(_QWORD *)(a1 + 816) ^ (16 * v4)) & 0xFFFFFFFFFFFFFFCFuLL;
  if ( (unsigned int)Feature_Win32ProcessCapabilities__private_IsEnabledDeviceUsageNoInline() && (*a4 & 0x1000) != 0 )
    *(_QWORD *)(a1 + 816) |= 0x18000000000uLL;
  if ( (_DWORD)v4 == 1 )
  {
    if ( (unsigned __int8)ExQueryFastCacheDevLicense() && (unsigned int)(unsigned __int8)a4[1] - 4 <= 1 )
      v5 = 512LL;
    *(_QWORD *)(a1 + 816) = v5 | *(_QWORD *)(a1 + 816) & 0xFFFFFFFFFFFFFDFFuLL | 0xC;
  ...
  result = ((unsigned __int64)v9 << 13) ^ (*(_QWORD *)(a1 + 816) ^ ((unsigned __int64)v9 << 13)) & 0xFFFFFFFFFFFFDFFFuLL;
