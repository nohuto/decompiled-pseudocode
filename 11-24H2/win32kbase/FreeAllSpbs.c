/*
 * XREFs of FreeAllSpbs @ 0x14014EAD8
 * Callers:
...
__int64 (*__fastcall FreeAllSpbs(__int64 a1, __int64 a2))(void)
{
  __int64 (*result)(void); // rax

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 3864LL);
  if ( result )
