/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector3Value@@UD2DVector3@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x140079E14
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v12 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x28uLL, &v12);
  v8 = (char *)v12;
  *(_DWORD *)v12 = 40;
  *(_OWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 20) = 0LL;
