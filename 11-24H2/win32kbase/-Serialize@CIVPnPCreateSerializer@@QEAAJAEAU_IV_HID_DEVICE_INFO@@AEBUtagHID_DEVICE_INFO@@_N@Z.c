/*
 * XREFs of ?Serialize@CIVPnPCreateSerializer@@QEAAJAEAU_IV_HID_DEVICE_INFO@@AEBUtagHID_DEVICE_INFO@@_N@Z @ 0x1402212B4
 * Callers:
 ...
 * Callees:
 *     ?Serialize@CIVPnPCreateSerializer@@AEAAJAEAU_IV_HIDP_CAPS@@AEBU_HIDP_CAPS@@_N@Z @ 0x140220918 (-Serialize@CIVPnPCreateSerializer@@AEAAJAEAU_IV_HIDP_CAPS@@AEBU_HIDP_CAPS@@_N@Z.c)
 *     ?Serialize@CIVPnPCreateSerializer@@AEAAJAEAU_IV_HID_POINTER_DEVICE_INFO@@AEBUtagHID_POINTER_DEVICE_INFO@@_N@Z @ 0x1402209CC (-Serialize@CIVPnPCreateSerializer@@AEAAJAEAU_IV_HID_POINTER_DEVICE_INFO@@AEBUtagHID_POINTER_DEVI.c)
