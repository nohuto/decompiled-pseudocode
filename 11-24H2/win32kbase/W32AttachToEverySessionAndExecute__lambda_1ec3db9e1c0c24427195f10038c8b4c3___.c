/*
 * XREFs of W32AttachToEverySessionAndExecute__lambda_1ec3db9e1c0c24427195f10038c8b4c3___ @ 0x140111FC0
 * Callers:
...
__int64 __fastcall W32AttachToEverySessionAndExecute__lambda_1ec3db9e1c0c24427195f10038c8b4c3_(__int64 a1)
{
  ...
  v4 = lambda_e8f2675e78c62a600627e1f585dad9bf_::operator()(v3, 0LL, CurrentWin32kSessionId, a1);
  v5 = 1;
  MaxSessionCount = W32GetMaxSessionCount();
  if ( MaxSessionCount > 1 )
  {
    do
      lambda_e8f2675e78c62a600627e1f585dad9bf_::operator()(v6, v5++, (unsigned int)CurrentWin32kSessionId, a1);
