/*
 * XREFs of ?HandleSensorDispatcherSignal@IOCPDispatcher@@AEAAXI@Z @ 0x140060938
 * Callers:
 ...
 *     ?Cleanup@SensorIOCPWCP@IOCPDispatcher@@QEAAXXZ @ 0x140092AC4 (-Cleanup@SensorIOCPWCP@IOCPDispatcher@@QEAAXXZ.c)
