/*
 * XREFs of ?CheckForCycle@CBrushMarshaler@DirectComposition@@AEAA_NPEAV12@@Z @ 0x1400E3E7C
 * Callers:
  ...
  *((_DWORD *)a2 + 16) = 0;
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v9 = 0LL;
      if ( v5
        || !(*(unsigned __int8 (__fastcall **)(unsigned int *, __int64, __int64 *))(*(_QWORD *)v4 + 328LL))(v4, v6, &v9) )
      {
        break;
      }
      ++v4[16];
