/*
 * XREFs of ?UpdateScantime@RIM@InputTraceLogging@@SAXPEBUtagHPD_FRAME_SCAN_TIME@@_NK@Z @ 0x1400E6F64
 * Callers:
        ...
        int a3)
{
    ...
    && (qword_14029AE48 & 0x100) == qword_14029AE48 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 5;
    ...
    EtwWriteTransfer(qword_14029AE50, &EventDescriptor, 0LL, 0LL, 0xFu, &UserData);
  }
}
