/*
 * XREFs of ?HandleResultFromUserMode@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@PEAX_NPEAUCInputPointerNode@@AEBVCInputDest@@@Z @ 0x1400935F0
 * Callers:
        ...
        const struct CInputDest *a6)
{
  ...
  const WCHAR *v28; // [rsp+D8h] [rbp-50h] BYREF
  HWND WindowHandle; // [rsp+E0h] [rbp-48h] BYREF
  const char *v30; // [rsp+E8h] [rbp-40h] BYREF
  struct CInputPointerNode *v31; // [rsp+F0h] [rbp-38h] BYREF
  void *v32; // [rsp+F8h] [rbp-30h] BYREF
