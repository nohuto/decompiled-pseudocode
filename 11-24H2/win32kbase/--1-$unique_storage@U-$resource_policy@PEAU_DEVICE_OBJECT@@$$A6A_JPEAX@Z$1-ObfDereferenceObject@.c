/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAU_DEVICE_OBJECT@@$$A6A_JPEAX@Z$1?ObfDereferenceObject@@YA_J0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x140017C34
 * Callers:
        ...
        __int64 *a1)
{
  ...
  if ( *a1 )
  {
    ...
    return wistd::invoke<__int64 (*)(void *),_FILE_OBJECT * &>(&v3, &v2);
  }
  return result;
}
