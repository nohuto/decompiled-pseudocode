/*
 * XREFs of ProcessUpdateKeyStateEvent @ 0x140095890
 * Callers:
...
void __fastcall ProcessUpdateKeyStateEvent(__int64 a1, char *a2, _BYTE *a3)
{
  ...
  for ( i = 0; i < 32; ++i )
  {
    if ( *v6 )
    {
      ...
      {
        v10 = v8 + v9;
        if ( ((unsigned __int8)(1 << ((v8 + v9) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v8 + v9) >> 3]) != 0 )
        {
          v11 = (unsigned __int64)(unsigned __int8)(v8 + v9) >> 2;
          v12 = 2 * (v10 & 3);
          v13 = v11 + v5;
          v14 = *(unsigned __int8 *)(v11 + v5 + 280);
          if ( ((unsigned __int8)(1 << v12) & (unsigned __int8)a2[v11]) != 0 )
            v15 = v14 | (1 << v12);
          else
            v15 = v14 & ~(1 << v12);
          v16 = 2 * (v10 & 3) + 1;
          *(_BYTE *)(v13 + 280) = v15;
          if ( ((unsigned __int8)(1 << v16) & (unsigned __int8)a2[v11]) != 0 )
            v17 = (unsigned __int8)v15 | (1 << v16);
          else
            v17 = (unsigned __int8)v15 & ~(1 << v16);
          *(_BYTE *)(v13 + 280) = v17;
        }
        if ( ((unsigned __int8)(1 << ((v10 + 1) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v10 + 1) >> 3]) != 0 )
        {
        ...
        if ( ((unsigned __int8)(1 << ((v10 + 2) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v10 + 2) >> 3]) != 0 )
        {
        ...
        v36 = v10 + 3;
        a1 = v36 & 7;
        if ( ((unsigned __int8)(1 << a1) & a3[(unsigned __int64)v36 >> 3]) != 0 )
        {
          ...
          v45 = 2 * v38 + 1;
          *(_BYTE *)(v41 + 280) = v44;
          a1 = (unsigned int)(2 * v38 + 1);
          if ( ((unsigned __int8)(1 << v45) & (unsigned __int8)*v39) != 0 )
            v46 = v44 | (1 << v45);
          else
            v46 = v44 & ~(1 << v45);
          *(_BYTE *)(v41 + 280) = v46;
  ...
  v47 = *(_QWORD *)(W32GetUserSessionState(a1) + 19928);
  ++*(_DWORD *)(v47 + 6984);
  if ( a2 != (char *)(W32GetUserSessionState(v47) + 14336) )
