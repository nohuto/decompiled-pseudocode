/*
 * XREFs of EditionPostKeyboardInputMessage @ 0x14023B078
 * Callers:
        ...
        __int64 a10)
{
  ...
  v11 = a2;
  v12 = a1;
  v14 = *(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int16, __int16, __int16, int, __int16, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7400LL);
  if ( !v14 )
    return 3221225659LL;
  LOBYTE(v13) = v11;
