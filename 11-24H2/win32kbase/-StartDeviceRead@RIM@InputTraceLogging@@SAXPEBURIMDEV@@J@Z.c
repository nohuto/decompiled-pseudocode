/*
 * XREFs of ?StartDeviceRead@RIM@InputTraceLogging@@SAXPEBURIMDEV@@J@Z @ 0x1400D0F60
 * Callers:
...
void __fastcall InputTraceLogging::RIM::StartDeviceRead(const struct RIMDEV *a1, int a2)
{
    ...
    && (qword_14029AE48 & 0x100) == qword_14029AE48 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EtwWriteTransfer(qword_14029AE50, &EventDescriptor, 0LL, 0LL, 5u, &UserData);
  }
}
