/*
 * XREFs of ??$FreeIsolatedType@V?$CTypeIsolation@$0HAAA@$0HA@@NSInstrumentation@@@@YAXPEAX@Z @ 0x140040A9C
 * Callers:
...
void __fastcall FreeIsolatedType<NSInstrumentation::CTypeIsolation<28672,112>>(void *a1)
{
  ...
  v2 = *(__int64 **)(*(_QWORD *)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 4272LL) + 56LL);
  if ( v2 && a1 )
  {
    if ( *((_BYTE *)v2 + 36) )
    {
