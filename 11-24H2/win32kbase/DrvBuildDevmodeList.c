/*
 * XREFs of DrvBuildDevmodeList @ 0x1401180B8
 * Callers:
...
void __fastcall DrvBuildDevmodeList(struct tagGRAPHICS_DEVICE *a1, int a2, int a3)
{
  ...
  Src = 0LL;
  if ( v4 || *(_DWORD *)(W32GetUserSessionState(a1) + 68960) )
  {
    if ( (*((_DWORD *)a1 + 40) & 0x800000) == 0 || !*((_DWORD *)a1 + 46) || !*((_QWORD *)a1 + 22) || a3 && !a2 )
      goto LABEL_12;
    a2 = 0;
    v37 = 0LL;
...
LABEL_12:
  ...
  *((_DWORD *)a1 + 47) = 0;
  ...
  if ( DisplayDriverNames )
  {
    ...
    if ( *(_DWORD *)DisplayDriverNames )
    {
      do
      {
        ...
        if ( DriverModes )
        {
          v19 = (char *)PALLOCNOZ(DriverModes + *v10, 0x73726447u);
          if ( v19 )
          {
            if ( *v10 )
            {
  ...
  v22 = PALLOCMEM((unsigned int)(16 * v20), 0x73726447u);
  *((_QWORD *)a1 + 24) = v22;
  if ( !v22 )
  {
    v23 = (char *)*v11;
...
LABEL_52:
  ...
  if ( v29 )
  {
    ...
    {
      v29 = v31;
      v33 = *(_QWORD *)(*((_QWORD *)a1 + 24) + 16LL * v32 + 8);
      if ( *(_DWORD *)(v33 + 184) == 1 )
      {
        v34 = 1;
        if ( v31 )
        {
          ...
          if ( v31 > v30 )
            memmove((void *)(v35 + 16LL * v32), (const void *)(v35 + 16LL * v30), 16LL * (v31 - v30));
          --*v12;
          --v30;
          v29 = *v12;
          --v32;
...
LABEL_65:
  ...
  if ( (*((_DWORD *)a1 + 40) & 0x6000008) == 0 )
    v25 = PruneModesByDisplayDeviceCaps(a1, v29, *((_QWORD *)a1 + 24));
  if ( !v25 )
LABEL_69:
