/*
 * XREFs of ApiSetRemoveMagnificationOutputTransform @ 0x140193E94
 * Callers:
...
__int64 (*__fastcall ApiSetRemoveMagnificationOutputTransform(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5456LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 5464LL);
      if ( result )
