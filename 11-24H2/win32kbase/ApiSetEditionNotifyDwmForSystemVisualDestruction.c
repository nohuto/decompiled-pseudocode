/*
 * XREFs of ApiSetEditionNotifyDwmForSystemVisualDestruction @ 0x14011363C
 * Callers:
...
__int64 __fastcall ApiSetEditionNotifyDwmForSystemVisualDestruction(__int64 a1, __int64 a2)
{
  ...
  v2 = a2;
  v4 = 0;
  v5 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7424LL);
  if ( !v5 || v5() < 0 )
    return 0LL;
  v8 = *(unsigned int (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v7, v6) + 48) + 7432LL);
  if ( v8 )
    return v8(a1, v2);
  return v4;
}
