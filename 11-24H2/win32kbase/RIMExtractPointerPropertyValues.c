/*
 * XREFs of RIMExtractPointerPropertyValues @ 0x1401DFFB0
 * Callers:
 ...
 *     SignExtendLong @ 0x14011FDAC (SignExtendLong.c)
        ...
        __int64 a7)
{
  ...
  {
    UsageValue = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3902);
  }
  if ( a1 )
  {
    if ( a5 <= *(_DWORD *)(a1 + 392) )
