/*
 * XREFs of LookUpTableFlushComplete @ 0x1402C398C
 * Callers:
 *     TlgAggregateFlush @ 0x1401536A4 (TlgAggregateFlush.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1402C3680 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1402C44D0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
 ...
 *     FlushLookUpTableBucket @ 0x1401569EC (FlushLookUpTableBucket.c)
 *     __security_check_cookie @ 0x14023F3B0 (__security_check_cookie.c)
 *     UpdateInternalStatsOnFlush @ 0x1402C3D38 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( (_DWORD)v2 )
  {
    ...
    if ( v7 )
    {
      if ( (unsigned int)dword_14029B178 > 5
        && (qword_14029B188 & 0x200000000000LL) != 0
        && (qword_14029B190 & 0x200000000000LL) == qword_14029B190 )
      {
        v11 = 4;
        v34 = L"SummaryCount";
        v35 = 24;
        v24 = *(unsigned int *)(v5 + 324);
