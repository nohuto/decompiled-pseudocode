/*
 * XREFs of ?HandleHotkey@Keyboard@InputTraceLogging@@SAXXZ @ 0x1401568A0
 * Callers:
...
{
  if ( (unsigned int)dword_14029AE30 > 4 && tlgKeywordOn((__int64)&dword_14029AE30, 0x4000LL) )
