/*
 * XREFs of ?RegisterExternalResource@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IIW4RegistrationReason@12@@Z @ 0x140075778
 * Callers:
  ...
  if ( a3 > v14 )
  {
    ...
    if ( !is_mul_ok(v14, v20)
      || ((v9 = 0, *(_BYTE *)(a1 + 72))
        ...
        : (v17 = (char *)Win32AllocPoolImpl(0x100uLL, v19, 0x746C4344u)),
          (v18 = v17) == 0LL) )
    {
LABEL_19:
      v9 = -1073741801;
