/*
 * XREFs of ?EmitSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140103B8C
 * Callers:
 ...
 *     ?NeedsSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEBA_NXZ @ 0x140103D10 (-NeedsSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEBA_NXZ.c)
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, v10, &v17) )
      break;
    v11 = (char *)v17;
    *(_DWORD *)v17 = v10;
    v12 = *((_DWORD *)this + 37);
