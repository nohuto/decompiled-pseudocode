/*
 * XREFs of ?bAppend@PATH_CORE@@QEAA_NAEBV1@PEBU_POINTFIX@@@Z @ 0x140069A50
 * Callers:
 *     ?bAppend@EPATHOBJ@@QEAA_NPEBV1@PEBU_POINTFIX@@@Z @ 0x14006AA00 (-bAppend@EPATHOBJ@@QEAA_NPEBV1@PEBU_POINTFIX@@@Z.c)
 * Callees:
