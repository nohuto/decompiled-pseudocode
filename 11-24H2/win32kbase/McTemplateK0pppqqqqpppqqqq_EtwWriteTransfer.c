/*
 * XREFs of McTemplateK0pppqqqqpppqqqq_EtwWriteTransfer @ 0x140198478
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x140135040 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1401CDC30 (EtwWindowRendering.c)
 * Callees:
