/*
 * XREFs of ?RemoveCapabilityFromDescriptor@@YAHPEAXK0@Z @ 0x14019B4A8
 * Callers:
 ...
 * Callees:
 *     ?FindAceIndex@@YAHPEAU_ACL@@EEKPEAXPEAK@Z @ 0x1401AD40C (-FindAceIndex@@YAHPEAU_ACL@@EEKPEAXPEAK@Z.c)
 */
