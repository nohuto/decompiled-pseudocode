/*
 * XREFs of ?GetPointerPenInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_PEN_INFO@@@Z @ 0x14012F8DC
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerPenInfo(const struct tagPOINTER_PEN_INFO *a1)
{
  ...
  const char *v28; // [rsp+148h] [rbp-38h] BYREF
  __int64 v29; // [rsp+150h] [rbp-30h] BYREF
  __int64 v30; // [rsp+158h] [rbp-28h] BYREF
  __int64 v31; // [rsp+160h] [rbp-20h] BYREF
  const char *v32; // [rsp+168h] [rbp-18h] BYREF
  __int64 v33; // [rsp+170h] [rbp-10h] BYREF
  int v34; // [rsp+198h] [rbp+18h] BYREF
  int v35; // [rsp+1A0h] [rbp+20h] BYREF
  int v36; // [rsp+1A8h] [rbp+28h] BYREF
  ...
  if ( (unsigned int)dword_14029AE30 > 5 && (qword_14029AE40 & 0x20) != 0 && (qword_14029AE48 & 0x20) == qword_14029AE48 )
  {
    ...
    v25 = *(_DWORD *)(v4 + 12);
    v29 = v5;
    v32 = InputTraceLogging::PointerTypeToString(v6);
    v26 = *(_DWORD *)(v7 + 8);
    v27 = *(_DWORD *)(v7 + 4);
    v33 = v8;
