/*
 * XREFs of ?CitpSetSpeechRecognitionInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1401993EC
 * Callers:
...
__int64 __fastcall CitpSetSpeechRecognitionInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  v5 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(a1) + 18968) + 32LL);
  if ( (unsigned int)dword_14029B0D4 < MEMORY[0xFFFFF7800000037C] )
    EtwTelemetryCoverageReport(&off_14029B0C8);
