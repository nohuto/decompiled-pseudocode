/*
 * XREFs of GreCreatePolyPolygonRgnInternal @ 0x14006AC5C
 * Callers:
        ...
        int a5)
{
  ...
  ULONG_PTR v12[2]; // [rsp+30h] [rbp-98h] BYREF
  ...
  if ( a4 - 1 <= 1 )
  {
    ...
    if ( v14 )
    {
      if ( (unsigned int)bPolyPolygon((EPATHOBJ *)v13, (struct EXFORMOBJR *)&off_1402439F0, a1, a2, a3, a5) )
      {
        RGNMEMOBJ::RGNMEMOBJ((RGNMEMOBJ *)v12, (struct EPATHOBJ *)v13, a4, v10);
        if ( v12[0] )
        {
          v5 = RGNOBJ::hrgnAssociate((RGNOBJ *)v12);
          if ( !v5 )
