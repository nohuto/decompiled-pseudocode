/*
 * XREFs of ?Create@InputSink@InputTraceLogging@@SAXPEAXPEBUCOMPOSITION_INPUT_SINK_V2@@@Z @ 0x14006B850
 * Callers:
 ...
 *     ?CompositionInputQueueTypeToString@InputTraceLogging@@CAPEBDW4CompositionInputQueueType@@@Z @ 0x14023A0A8 (-CompositionInputQueueTypeToString@InputTraceLogging@@CAPEBDW4CompositionInputQueueType@@@Z.c)
 */
...
void __fastcall InputTraceLogging::InputSink::Create(void *a1, const struct COMPOSITION_INPUT_SINK_V2 *a2)
{
  ...
  __int64 v50; // [rsp+238h] [rbp+58h] BYREF
  ...
  if ( dword_14029AE30 )
  {
    if ( (qword_14029AE40 & 4) != 0 && (qword_14029AE48 & 4) == qword_14029AE48 )
    {
      Object = 0LL;
      if ( (int)CompositionInputObject::ResolveHandle(a1, 1u, 1, (struct CompositionInputObject **)&Object) >= 0 )
      {
        v4 = Object;
        if ( (unsigned int)dword_14029AE30 > 5 && (unsigned __int8)tlgKeywordOn(&dword_14029AE30, 4LL) )
        {
          v5 = *((_DWORD *)a2 + 72);
          ...
          v58 = *((_DWORD *)a2 + 62);
          v33 = *((_QWORD *)a2 + 30);
          v10 = (void *)InputTraceLogging::CompositionInputQueueTypeToString(v8);
          ...
          v20 = *((_DWORD *)a2 + 48);
          v38 = *((_QWORD *)a2 + 23);
          v12 = (void *)InputTraceLogging::CompositionInputQueueTypeToString(v11);
          ...
          v22 = *((_DWORD *)a2 + 34);
          v43 = *((_QWORD *)a2 + 16);
          v14 = (void *)InputTraceLogging::CompositionInputQueueTypeToString(v13);
