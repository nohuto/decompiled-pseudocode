/*
 * XREFs of ?SetPointerOffset@CTouchProcessor@@AEAAHGPEBUtagPOINT@@@Z @ 0x140207ADC
 * Callers:
...
__int64 __fastcall CTouchProcessor::SetPointerOffset(PERESOURCE *this, unsigned __int16 a2, const struct tagPOINT *a3)
{
  __int64 result; // rax
  ...
  {
    if ( !a3 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11918);
    v5[25] = *a3;
    return 1LL;
  }
  return result;
