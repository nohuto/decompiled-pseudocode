/*
 * XREFs of ?InitializeAndRegisterInternalResource@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@@Z @ 0x140076564
 * Callers:
...
LABEL_23:
      ...
      if ( is_mul_ok(v14, v20) )
      {
        ...
        v15 = (char *)(*((_BYTE *)this + 128)
                     ...
                     : Win32AllocPoolImpl(0x100uLL, v19, 0x746C4344u));
        v16 = v15;
        if ( v15 )
        {
          v21 = *((_QWORD *)this + 18);
