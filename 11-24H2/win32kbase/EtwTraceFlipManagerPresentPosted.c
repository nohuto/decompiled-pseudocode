/*
 * XREFs of EtwTraceFlipManagerPresentPosted @ 0x140112A10
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwTraceFlipManagerPresentPosted(int a1, char a2, __int64 a3)
{
  ...
  {
    LOBYTE(v3) = byte_14029ADC8 - 1;
    if ( (unsigned __int8)(byte_14029ADC8 - 1) > 2u && (qword_14029ADB0 & 0x8000000000001000uLL) != 0 )
    {
      LOBYTE(v3) = 0;
      if ( (qword_14029ADB8 & 0x8000000000001000uLL) == qword_14029ADB8 )
      {
        if ( a3 < 0 )
