/*
 * XREFs of ?iCombine@RGNOBJ@@QEAAJAEAV1@0J@Z @ 0x1400262A0
 * Callers:
...
__int64 __fastcall RGNOBJ::iCombine(RGNOBJ *this, struct RGNOBJ *a2, struct RGNOBJ *a3, int a4)
{
  ...
  v4 = a4;
  if ( *(_QWORD *)this != *(_QWORD *)(*(_QWORD *)(W32GetSessionState(this) + 88) + 4160LL) )
  {
    ...
    if ( WPP_MAIN_CB.Dpc.SystemArgument1 )
    {
      ...
      v13 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD))(*(_QWORD *)SystemArgument1 + 192LL))(
              v11,
...
LABEL_20:
    v24 = RGNOBJ::bMerge(this, a2, a3, byte_140259E24[v4]);
    goto LABEL_21;
  }
