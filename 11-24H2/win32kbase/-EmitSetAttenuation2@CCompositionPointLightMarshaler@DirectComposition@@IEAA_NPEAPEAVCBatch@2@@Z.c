/*
 * XREFs of ?EmitSetAttenuation2@CCompositionPointLightMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1402363A0
 * Callers:
...
char __fastcall DirectComposition::CCompositionPointLightMarshaler::EmitSetAttenuation2(
