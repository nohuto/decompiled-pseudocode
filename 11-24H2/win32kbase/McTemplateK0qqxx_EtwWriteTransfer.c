/*
 * XREFs of McTemplateK0qqxx_EtwWriteTransfer @ 0x1400F2F08
 * Callers:
 *     EtwGdiSysMemToken @ 0x1400F2E90 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1400F2ED0 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
