/*
 * XREFs of ?TelemetrySetApplicationId@CApplicationChannel@DirectComposition@@QEAAJPEBG@Z @ 0x14004A7E0
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  v8 = (unsigned __int16 *)DirectComposition::Memory::Allocate(2 * v6 + 2, 1717715780LL);
  *((_QWORD *)this + 340) = v8;
  if ( !v8 )
    return 3221225495LL;
