/*
 * XREFs of McTemplateK0qhhqppmqqqxqmxzqpqqpq_EtwWriteTransfer @ 0x14009BF0C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qhhqppmqqqxqmxzqpqqpq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a24)
{
  ...
  v69 = 8LL;
  v71 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v24, &AuditApiRegisterRawInputDevices, &W32kControlGuid, 0x16u, &v28);
}
