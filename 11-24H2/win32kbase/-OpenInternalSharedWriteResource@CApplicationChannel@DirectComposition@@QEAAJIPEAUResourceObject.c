/*
 * XREFs of ?OpenInternalSharedWriteResource@CApplicationChannel@DirectComposition@@QEAAJIPEAUResourceObject@2@PEAPEAVCResourceMarshaler@2@@Z @ 0x1400756A8
 * Callers:
...
LABEL_10:
  ...
  v10 = (DirectComposition::CHostVisualMarshaler *)DirectComposition::Memory::AllocateAndClear(0x178uLL, 0x76684344u, 1);
  if ( !v10
