/*
 * XREFs of ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCManipulationTransformMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400FEC40
 * Callers:
 *     <none>
 * Callees:
