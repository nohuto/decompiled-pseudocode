/*
 * XREFs of ?AddMapping@InputObjectMap@@SAJAEBU_LUID@@PEBUCompositionInputObject@@@Z @ 0x14023A124
 * Callers:
 ...
 *     ?AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z @ 0x14023A500 (-AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z.c)
