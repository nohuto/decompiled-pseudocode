/*
 * XREFs of McTemplateK0qxxq_EtwWriteTransfer @ 0x1401B5DAC
 * Callers:
 *     EtwTraceFlipManagerWaitForFrameFlipAway @ 0x1401B4AE0 (EtwTraceFlipManagerWaitForFrameFlipAway.c)
 *     EtwTraceFlipManagerWaitForFrameRenderingComplete @ 0x1401B4B20 (EtwTraceFlipManagerWaitForFrameRenderingComplete.c)
 * Callees:
