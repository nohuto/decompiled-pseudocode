/*
 * XREFs of NtGdiExtCreateRegion @ 0x140066C50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ProbeAndConvertXFORM@@YAHPEAU_XFORML@@0@Z @ 0x140068A70 (-ProbeAndConvertXFORM@@YAHPEAU_XFORML@@0@Z.c)
