/*
 * XREFs of ?SetBufferProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x140071860
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 != 31 )
  {
    ...
    switch ( a5 )
    {
      case 0xCuLL:
        if ( a4->LowPart != 1 )
          return (unsigned int)-1073741811;
        v11 = (LARGE_INTEGER *)Win32AllocPoolWithQuotaImpl((unsigned __int64)this, 0xCuLL, 0x6D654344u);
        if ( v11 )
        {
          this[11].QuadPart = (LONGLONG)v11;
          *v11 = *a4;
          v11[1].LowPart = a4[1].LowPart;
LABEL_16:
      ...
      case 0x10uLL:
        if ( a4->LowPart != 2 )
          return (unsigned int)-1073741811;
        v19 = Win32AllocPoolWithQuotaImpl((unsigned __int64)this, 0x10uLL, 0x6D654344u);
        if ( v19 )
        {
