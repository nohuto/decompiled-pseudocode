/*
 * XREFs of ?CitpProgDataEnsure@@YAPEAU_CIT_PROG_DATA@@PEAU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x14023C5A8
 * Callers:
 ...
 *     ?CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x14023C888 (-CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z.c)
...
struct _CIT_PROG_DATA *__fastcall CitpProgDataEnsure(struct _CIT_IMPACT_CONTEXT *a1, const struct _CIT_PROGRAM_ID *a2)
{
  ...
  if ( !v4 )
  {
    if ( (int)CitpProgramIdCopy((struct _CIT_PROGRAM_ID *)&v23, a2) < 0 )
    {
LABEL_3:
      v4 = 0LL;
      goto LABEL_4;
    ...
    if ( v7 == (struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 8) )
    {
      ...
      *(_QWORD *)v9 = v9;
      v9[18] = 0;
      v26 = *((_QWORD *)v9 - 1) & (-1LL << (*((_DWORD *)a1 + 19) & 0x1F));
      for ( i = (struct _CIT_PROG_DATA *)(*((_QWORD *)a1 + 10)
                                        ...
                                        * ((37
                                          * (BYTE6(v26)
                                          ...
                                          + HIBYTE(v26)) & (unsigned int)((*((_DWORD *)a1 + 19) >> 5) - 1)));
            (*(_QWORD *)i & 1) == 0;
