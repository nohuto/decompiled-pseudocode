/*
 * XREFs of ?UpdateISODState@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1400C1418
 * Callers:
        ...
        __int64 a4)
{
  ...
  v4 = *((_DWORD *)a1 + 6);
  v5 = a1;
  if ( (v4 - 256 <= 9 || InputTraceLogging::IsMouseInputMessage(v4))
    && (unsigned int)dword_14029AE30 > 4
    && (qword_14029AE40 & 0x10) != 0
    && (qword_14029AE48 & 0x10) == qword_14029AE48 )
  {
    v6 = *((_DWORD *)v5 + 25);
    v7 = v4;
    v9 = -__CFSHR__(v6, 16);
