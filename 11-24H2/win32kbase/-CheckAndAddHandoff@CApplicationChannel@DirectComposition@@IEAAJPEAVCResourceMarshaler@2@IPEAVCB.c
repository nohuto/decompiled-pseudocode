/*
 * XREFs of ?CheckAndAddHandoff@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@PEAVCAnimationBinding@2@@Z @ 0x140111444
 * Callers:
 ...
 *     ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x14022D760 (-GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z.c)
        ...
        struct DirectComposition::CAnimationBinding *a5)
{
  ...
  if ( v10 && *(_DWORD *)(v10 + 156) )
  {
    ...
    {
      (*(void (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, _DWORD *))(*(_QWORD *)a2 + 320LL))(
        a2,
        a3,
        v18);
      if ( !v13 )
