/*
 * XREFs of ?SetBufferProperty@CExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x140196240
 * Callers:
 *     <none>
 * Callees:
  ...
  *a6 = 0;
  ...
  if ( (_DWORD)v9 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v16 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v16 + 9), 157) )
        break;
      *(_QWORD *)(v15 - 3) = v17;
      *(v15 - 1) = *(v13 - 1);
      *v15 = *v13;
