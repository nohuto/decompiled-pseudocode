/*
 * XREFs of ?EmitCreationCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@PEAPEAVCResourceMarshaler@2@@Z @ 0x1400B8B20
 * Callers:
  ...
  if ( *a3 )
  {
    do
    {
      ...
      *((_DWORD *)v3 + 4) |= 1u;
      ...
      {
        v8 = *((_DWORD *)v3 + 9);
        for ( i = v8; (unsigned int)i < 0xC2; LODWORD(i) = dword_140270F80[i] )
        {
          if ( (_DWORD)i == 158 )
          {
            v10 = 456LL;
