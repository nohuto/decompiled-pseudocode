/*
 * XREFs of ?StartFrameFromContainer@RIM@InputTraceLogging@@SAXQEAURIMDEV@@PEBURIMCOMPLETEFRAME@@@Z @ 0x1401EB974
 * Callers:
        ...
        const struct RIMCOMPLETEFRAME *a2)
{
  ...
  {
    v2 = tlgKeywordOn((__int64)&dword_14029AE30, 256LL);
    v5 = 0LL;
    if ( v2 )
    {
      if ( v3 )
