/*
 * XREFs of _output_l @ 0x1401A1678
 * Callers:
 ...
 *     _get_printf_count_output @ 0x1401A200C (_get_printf_count_output.c)
 *     wctomb_s @ 0x1401A217C (wctomb_s.c)
...
LABEL_116:
                  ...
                  if ( v53 && SizeConverted > 0 )
                  {
                    ...
                    while ( 1 )
                    {
                      v39 = *v38++;
                      --v37;
                      if ( wctomb_s(&v60, v62, 6uLL, v39) || !v60 )
                        break;
                      write_string_0(v62, (unsigned int)v60, v59, &v50);
                      if ( !v37 )
                        goto LABEL_130;
                    }
                    v12 = -1;
                  ...
                  {
                    write_string_0(v8, (unsigned int)SizeConverted, v36, &v50);
LABEL_130:
                    v12 = v50;
                  }
                  if ( v12 >= 0 && (v5 & 4) != 0 )
...
LABEL_91:
            ...
            v7 = v28;
            v31 = (unsigned int)&MbCh[144] + 367 - i;
            v8 = (char *)(i + 1);
            SizeConverted = v31;
            if ( (v5 & 0x200) != 0 )
            {
