/*
 * XREFs of ?QueryStats@CConnection@DirectComposition@@QEAA_N_KPEAUtagCOMPOSITION_FRAME_STATS@@IPEAUtagCOMPOSITION_TARGET_ID@@PEAI@Z @ 0x140073E24
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v6 = (DirectComposition::CConnection *)((char *)this + 376);
  v11 = 0;
  ExAcquirePushLockSharedEx((char *)this + 376, 0LL);
  *((_BYTE *)v6 + 8) = 0;
  v12 = 528 * (a2 % 0x12C);
  if ( *(_QWORD *)((char *)this + v12 + 432) == a2 )
  {
    *(_OWORD *)a3 = *(_OWORD *)((char *)this + v12 + 440);
    *((_QWORD *)a3 + 2) = *(_QWORD *)((char *)this + v12 + 456);
    v13 = *(_DWORD *)((char *)this + v12 + 428);
    if ( a4 < v13 )
      v13 = a4;
    if ( v13 )
    {
      ...
      do
      {
        v17 = *(_QWORD *)((char *)this + v12 + 464);
        v18 = *(_OWORD *)(v15 + v17);
        v15 += 120LL;
        *(_OWORD *)v14 = v18;
        v14 = (struct tagCOMPOSITION_TARGET_ID *)((char *)v14 + 28);
        *(_QWORD *)((char *)v14 - 12) = *(_QWORD *)(v15 + v17 - 104);
        *((_DWORD *)v14 - 1) = *(_DWORD *)(v15 + v17 - 96);
        --v16;
      }
      while ( v16 );
    }
