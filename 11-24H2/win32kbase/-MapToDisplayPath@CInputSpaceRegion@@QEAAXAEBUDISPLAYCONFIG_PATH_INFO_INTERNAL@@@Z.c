/*
 * XREFs of ?MapToDisplayPath@CInputSpaceRegion@@QEAAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1401F3E98
 * Callers:
        ...
        const struct DISPLAYCONFIG_PATH_INFO_INTERNAL *a2)
{
  ...
  *(_OWORD *)v6 = 0LL;
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 40);
    *v4 = *v3;
  }
}
