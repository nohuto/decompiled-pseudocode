/*
 * XREFs of ApiSetHasInputTransform @ 0x140193B14
 * Callers:
...
__int64 __fastcall ApiSetHasInputTransform(__int64 a1, __int64 a2)
{
  ...
  v3 = 0;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6208LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(unsigned int (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 6216LL);
      if ( v7 )
        return v7(a1);
    }
  }
