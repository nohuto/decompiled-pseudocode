/*
 * XREFs of MouseToggleWaitWake @ 0x1C0005A08
 * Callers:
 *     MouseClassWaitWakeComplete @ 0x1C0004AB0 (MouseClassWaitWakeComplete.c)
 *     MouseClassSetWmiDataBlock @ 0x1C000EB40 (MouseClassSetWmiDataBlock.c)
 *     MouseClassSetWmiDataItem @ 0x1C000EBE0 (MouseClassSetWmiDataItem.c)
 * Callees:
 *     MouseToggleWaitWakeWorker @ 0x1C0005B50 (MouseToggleWaitWakeWorker.c)
 */
