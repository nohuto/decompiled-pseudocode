/*
 * XREFs of MouseClassPlugPlayNotification @ 0x1C000EA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseClassPlugPlayNotification(char *NotificationStructure, volatile __int64 *Context)
{
  __int64 result; // rax
  __int64 v5; // rdx
  char v6; // dl
...
LABEL_4:
    v6 = 0;
    return MouseClassEnableGlobalPort((__int64)Context, v6);
  }
  ...
  if ( !v7 )
  {
    v8 = (void *)_InterlockedExchange64(Context + 39, 0LL);
    if ( !v8 )
      return result;
  ...
  if ( !v9 )
  {
    v10 = (void *)_InterlockedExchange64(Context + 39, 0LL);
    if ( v10 )
    {
