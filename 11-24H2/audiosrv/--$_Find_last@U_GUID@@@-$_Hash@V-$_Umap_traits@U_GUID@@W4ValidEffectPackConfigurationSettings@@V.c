        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_1801DCF58 + 16 * (a4 & qword_1801DCF70) + 8);
  if ( v4 == (_QWORD *)qword_1801DCF48 )
  {
    *a2 = qword_1801DCF48;
LABEL_3:
    a2[1] = 0LL;
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( !v5 )
        break;
      if ( v4 == *(_QWORD **)(qword_1801DCF58 + 16 * (a4 & qword_1801DCF70)) )
      {
        *a2 = v4;
        goto LABEL_3;
      }
