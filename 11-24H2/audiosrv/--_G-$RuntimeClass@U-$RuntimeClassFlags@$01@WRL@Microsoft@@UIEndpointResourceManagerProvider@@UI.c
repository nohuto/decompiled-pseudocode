/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIEndpointResourceManagerProvider@@UIBluetoothResourceArbitrator@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800CBE00
 * Callers:
 *     <none>
 * Callees:
