/*
 * XREFs of ?IsMuteAPORequired@CBluetoothMuteInterceptor@BluetoothControls@@UEBA_NXZ @ 0x1800D53A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall BluetoothControls::CBluetoothMuteInterceptor::IsMuteAPORequired(
