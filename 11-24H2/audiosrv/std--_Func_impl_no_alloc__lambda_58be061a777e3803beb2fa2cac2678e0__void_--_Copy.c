/*
 * XREFs of std::_Func_impl_no_alloc__lambda_58be061a777e3803beb2fa2cac2678e0__void_::_Copy @ 0x1800BFB80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc__lambda_58be061a777e3803beb2fa2cac2678e0__void_::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r9
