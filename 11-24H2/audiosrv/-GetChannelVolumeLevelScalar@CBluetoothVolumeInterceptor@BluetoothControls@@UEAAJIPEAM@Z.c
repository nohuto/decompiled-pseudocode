/*
 * XREFs of ?GetChannelVolumeLevelScalar@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAJIPEAM@Z @ 0x1800D3F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::GetChannelVolumeLevelScalar(
        ...
        float *a3)
{
  ...
  if ( Owner >= 0 )
  {
    ...
    if ( TargetedVolumeControl >= 0 )
      v6 = (*(__int64 (__fastcall **)(__int64, _QWORD, float *))(*(_QWORD *)v11 + 168LL))(v11, a2, a3);
    else
