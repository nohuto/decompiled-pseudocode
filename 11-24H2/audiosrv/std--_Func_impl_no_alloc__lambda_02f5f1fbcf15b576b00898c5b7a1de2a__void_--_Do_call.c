/*
 * XREFs of std::_Func_impl_no_alloc__lambda_02f5f1fbcf15b576b00898c5b7a1de2a__void_::_Do_call @ 0x1800BFDF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc__lambda_02f5f1fbcf15b576b00898c5b7a1de2a__void_::_Do_call(__int64 a1)
{
  ...
  v1 = (const unsigned __int16 *)std::wstring::c_str(*(_QWORD *)(a1 + 16), a1);
  v5 = v2[2];
