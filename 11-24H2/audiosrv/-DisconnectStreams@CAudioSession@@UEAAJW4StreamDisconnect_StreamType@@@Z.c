/*
 * XREFs of ?DisconnectStreams@CAudioSession@@UEAAJW4StreamDisconnect_StreamType@@@Z @ 0x1800C14B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::DisconnectStreams(__int64 a1, int a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Au, (__int64)&WPP_ea93f1868512325b454513e390c361b8_Traceguids, 0LL);
  }
  v11[0] = &v14;
  v11[1] = a1 - 8;
  v4 = *(__int64 **)(a1 + 112);
