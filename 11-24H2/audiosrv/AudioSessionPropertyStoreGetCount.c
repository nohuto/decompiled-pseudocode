/*
 * XREFs of AudioSessionPropertyStoreGetCount @ 0x1800C4900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionPropertyStoreGetCount(__int64 *a1, __int64 a2)
{
    ...
    if ( v4 )
    {
      ...
      v4 = CWatchdogTimer<1>::CWatchdogTimer<1>(
             ...
             *((struct _TP_TIMER **)v8 + 1),
             v7,
             (struct _TP_TIMER *)L"AudioSessionPropertyStoreGetCount",
             pftDueTime);
    }
  ...
  v14 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v3 + 72) + 368LL))(*(_QWORD *)(v3 + 72), a2);
  v15 = v14;
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionPropertyStoreGetCount", 2414, v14);
