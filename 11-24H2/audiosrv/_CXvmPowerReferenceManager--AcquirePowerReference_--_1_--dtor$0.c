/*
 * XREFs of _CXvmPowerReferenceManager::AcquirePowerReference_::_1_::dtor$0 @ 0x1801706CD
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CXvmPowerReferenceManager::AcquirePowerReference_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  __int64 result; // rax
