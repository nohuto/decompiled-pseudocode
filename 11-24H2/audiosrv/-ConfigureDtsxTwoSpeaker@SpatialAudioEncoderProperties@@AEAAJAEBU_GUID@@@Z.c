/*
 * XREFs of ?ConfigureDtsxTwoSpeaker@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x18012A288
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  *(_OWORD *)((char *)this + 726) = xmmword_18019BCF0;
  *(_OWORD *)((char *)this + 742) = xmmword_18019BD00;
  *(_OWORD *)((char *)this + 758) = xmmword_18019BD10;
  *(_OWORD *)((char *)this + 774) = xmmword_18019BD20;
  *(_OWORD *)((char *)this + 790) = xmmword_18019BD30;
  *(_OWORD *)((char *)this + 806) = xmmword_18019BD40;
  *(_OWORD *)((char *)this + 822) = xmmword_18019BD50;
  ...
  *((_WORD *)this + 362) = GetOverrideMaxDynamicObjectCount(a2, MaxDynamicObjectCountPC);
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v17 = 0;
    v16 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_TWOSPEAKER_SPATIAL_ENCODER, &v17, &v16) >= 0 )
    {
      *((_DWORD *)this + 179) = v17;
      *((_WORD *)this + 362) = v16;
    }
