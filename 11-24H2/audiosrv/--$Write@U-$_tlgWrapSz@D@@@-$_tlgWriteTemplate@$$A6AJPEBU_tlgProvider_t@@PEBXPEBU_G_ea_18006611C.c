/*
 * XREFs of ??$Write@U?$_tlgWrapSz@D@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@@Z @ 0x18006611C
 * Callers:
        ...
        const CHAR **a5)
{
  ...
  unsigned __int16 *v12; // [rsp+48h] [rbp-38h]
  ...
  v17 = 1;
  v14 = 2;
  return EtwEventWriteTransfer(*(_QWORD *)(a1 + 32), v10, 0LL, 0LL);
}
