/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x180075240
 * Callers:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const CHAR *v10; // [rsp+B8h] [rbp+Fh] BYREF
  const WCHAR *v11; // [rsp+C0h] [rbp+17h] BYREF
  const CHAR *v12; // [rsp+C8h] [rbp+1Fh] BYREF
  const CHAR *v13; // [rsp+D0h] [rbp+27h] BYREF
  const WCHAR *v14; // [rsp+D8h] [rbp+2Fh] BYREF
  const CHAR *v15; // [rsp+E0h] [rbp+37h] BYREF
  const CHAR *v16; // [rsp+E8h] [rbp+3Fh] BYREF
  ...
  {
    v9 = *(const WCHAR **)(v4 + 120);
    v10 = *(const CHAR **)(v4 + 112);
    v19 = *(_DWORD *)(v4 + 104);
    v11 = *(const WCHAR **)(v4 + 96);
    v12 = *(const CHAR **)(v4 + 88);
    v20 = *(_DWORD *)(v4 + 80);
    v13 = *(const CHAR **)(v4 + 72);
    v21 = *(_DWORD *)(v4 + 32);
    v14 = *(const WCHAR **)(v4 + 24);
    v6 = *(_DWORD *)v4;
