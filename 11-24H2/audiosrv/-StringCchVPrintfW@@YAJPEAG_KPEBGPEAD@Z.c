/*
 * XREFs of ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x1800A2E5C
 * Callers:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x1800A937C (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
