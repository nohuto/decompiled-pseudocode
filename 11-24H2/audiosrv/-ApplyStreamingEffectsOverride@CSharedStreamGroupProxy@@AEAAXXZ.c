/*
 * XREFs of ?ApplyStreamingEffectsOverride@CSharedStreamGroupProxy@@AEAAXXZ @ 0x180046654
 * Callers:
...
void __fastcall CSharedStreamGroupProxy::ApplyStreamingEffectsOverride(CSharedStreamGroupProxy *this)
{
  ...
  v2 = (unsigned __int64 *)*((_QWORD *)this + 31);
  v3 = (unsigned __int64 *)*((_QWORD *)this + 32);
  v4 = (__int128 **)((char *)this + 272);
  while ( v2 != v3 )
  {
    v5 = *v2;
    v16 = v5;
