/*
 * XREFs of ?GetChannelCount@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAJPEAI@Z @ 0x1800D3CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::GetChannelCount(
        ...
        unsigned int *a2)
{
  ...
  if ( Owner >= 0 )
  {
    ...
    if ( TargetedVolumeControl >= 0 )
      v4 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v8 + 104LL))(v8, a2);
    else
