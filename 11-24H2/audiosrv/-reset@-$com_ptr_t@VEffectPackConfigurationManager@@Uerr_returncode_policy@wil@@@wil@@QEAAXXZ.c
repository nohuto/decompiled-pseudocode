/*
 * XREFs of ?reset@?$com_ptr_t@VEffectPackConfigurationManager@@Uerr_returncode_policy@wil@@@wil@@QEAAXXZ @ 0x1800D0EBC
 * Callers:
 ...
 *     ?Shutdown@CEndpointCharacteristicsCache@@UEAAXXZ @ 0x180138810 (-Shutdown@CEndpointCharacteristicsCache@@UEAAXXZ.c)
