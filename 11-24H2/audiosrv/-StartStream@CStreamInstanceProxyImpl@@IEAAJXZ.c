/*
 * XREFs of ?StartStream@CStreamInstanceProxyImpl@@IEAAJXZ @ 0x180022388
 * Callers:
 *     ?StartStream@CStreamInstanceProxy@@UEAAJXZ @ 0x18006DE60 (-StartStream@CStreamInstanceProxy@@UEAAJXZ.c)
 * Callees:
