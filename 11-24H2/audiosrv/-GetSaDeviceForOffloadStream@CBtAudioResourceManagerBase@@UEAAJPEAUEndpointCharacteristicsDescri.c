/*
 * XREFs of ?GetSaDeviceForOffloadStream@CBtAudioResourceManagerBase@@UEAAJPEAUEndpointCharacteristicsDescriptor@@PEAUSaDeviceParams@@KW4_AUDCLNT_SHAREMODE@@AEAUSaDeviceResourceParams@@AEBV?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@PEBU_GUID@@5PEAPEAUISaDeviceProxy@@@Z @ 0x1800DE560
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a10)
{
  ...
  struct CEndpointStore *v27; // [rsp+50h] [rbp-58h] BYREF
  struct _RTL_CRITICAL_SECTION *v28; // [rsp+58h] [rbp-50h] BYREF
  struct _RTL_CRITICAL_SECTION *v29; // [rsp+60h] [rbp-48h] BYREF
  struct _RTL_CRITICAL_SECTION *v30; // [rsp+68h] [rbp-40h] BYREF
  ...
  v35 = 0LL;
  v14 = *(__int64 (**)(void))(**(_QWORD **)(a1 + 72) + 24LL);
  ...
  try
  {
    ...
    if ( v32 == v33 )
      ...
      wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>(
        v32++,
        v35);
    if ( CompareStringOrdinal(*(LPCWCH *)(a1 + 56), -1, *(LPCWCH *)(*(_QWORD *)a2 + 48LL), -1, 1) != 2 )
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0xF3,
      ...
      std::vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>::~vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>((__int64)&v31);
      wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>(&v35);
      return 2147549183LL;
    }
    v28 = 0LL;
    v19 = *(const unsigned __int16 **)(a1 + 64);
    if ( v19 )
    {
      v27 = 0LL;
      EndpointStore = CEndpointStoreCache::GetEndpointStore(v18, v19, &v27);
      v21 = EndpointStore;
      if ( EndpointStore < 0 )
      {
        wil::details::in1diag3::Return_Hr(
      ...
      v22 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(_QWORD, struct _RTL_CRITICAL_SECTION **))(**((_QWORD **)v27 + 13) + 128LL))(
                                               *((_QWORD *)v27 + 13),
                                               &v30);
    ...
    v27 = 0LL;
    v23 = CEndpointStoreCache::GetEndpointStore(v18, *(const unsigned __int16 **)(a1 + 56), &v27);
    v24 = v23;
    if ( v23 >= 0 )
    {
      (*(void (__fastcall **)(_QWORD, struct _RTL_CRITICAL_SECTION **))(**((_QWORD **)v27 + 13) + 128LL))(
        *((_QWORD *)v27 + 13),
        &v29);
