/*
 * XREFs of ?IsVolumeAPORequired@CBluetoothVolumeInterceptor@BluetoothControls@@UEBA_NXZ @ 0x1800D5460
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall BluetoothControls::CBluetoothVolumeInterceptor::IsVolumeAPORequired(
