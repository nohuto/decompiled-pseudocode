        ...
        __int64 a3)
{
  ...
  else
  {
    ...
    *(_QWORD *)&v13 = a1;
    ...
    std::_Default_allocator_traits<std::allocator<std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *>>>::construct<std::pair<std::wstring const,std::wstring>,std::piecewise_construct_t const &,std::tuple<std::wstring &&>,std::tuple<>>(
      v10,
      v9 + 4,
      v11,
      &v16);
