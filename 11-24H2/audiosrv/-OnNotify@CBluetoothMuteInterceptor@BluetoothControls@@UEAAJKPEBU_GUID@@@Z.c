/*
 * XREFs of ?OnNotify@CBluetoothMuteInterceptor@BluetoothControls@@UEAAJKPEBU_GUID@@@Z @ 0x1800D5C80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothMuteInterceptor::OnNotify(
        ...
        const struct _GUID *a3)
{
  ...
  v9 = 0LL;
  Owner = BluetoothControls::CBluetoothMuteInterceptor::TryGetOwner(this, &v9);
  v6 = Owner;
  if ( Owner >= 0 )
