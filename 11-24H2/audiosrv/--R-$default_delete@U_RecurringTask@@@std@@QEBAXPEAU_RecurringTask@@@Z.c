/*
 * XREFs of ??R?$default_delete@U_RecurringTask@@@std@@QEBAXPEAU_RecurringTask@@@Z @ 0x180047230
 * Callers:
 ...
 *     ??1?$unique_ptr@U_RecurringTask@@U?$default_delete@U_RecurringTask@@@std@@@std@@QEAA@XZ @ 0x18006D240 (--1-$unique_ptr@U_RecurringTask@@U-$default_delete@U_RecurringTask@@@std@@@std@@QEAA@XZ.c)
 ...
 *     _dynamic_atexit_destructor_for__g_PoTimerCookie___0 @ 0x1801736F0 (_dynamic_atexit_destructor_for__g_PoTimerCookie___0.c)
 * Callees:
