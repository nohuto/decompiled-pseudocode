/*
 * XREFs of ?ClearMixFormatCache@@YAJPEAUIPropertyStore@@_N1@Z @ 0x1800375E8
 * Callers:
  ...
  for ( i = 0; i < 0xA; ++i )
  {
    if ( a2 )
    {
      ...
      for ( j = 0; ; ++j )
      {
        ...
        v9 = *(_QWORD *)&xmmword_18018FED0[j] - v38;
        if ( !v9 )
          v9 = *((_QWORD *)&xmmword_18018FED0[j] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v9 )
          break;
      }
      ...
      {
        v6 = 2LL * k;
        v13 = *(_QWORD *)&xmmword_18018FED0[k] - v38;
        if ( !v13 )
          v13 = *((_QWORD *)&xmmword_18018FED0[k] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v13 )
        {
    ...
    if ( a3 )
    {
      ...
      for ( m = 0; ; ++m )
      {
        ...
        v15 = *(_QWORD *)&xmmword_18018FED0[m] - v38;
        if ( !v15 )
          v15 = *((_QWORD *)&xmmword_18018FED0[m] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v15 )
          break;
      }
      ...
      {
        v6 = 2LL * n;
        v18 = *(_QWORD *)&xmmword_18018FED0[n] - v38;
        if ( !v18 )
          v18 = *((_QWORD *)&xmmword_18018FED0[n] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v18 )
        {
  ...
  for ( ii = 0; ii < 0xA; ++ii )
  {
    if ( a2 )
    {
      ...
      for ( jj = 0; ; ++jj )
      {
        ...
        v21 = *(_QWORD *)&xmmword_18018FED0[jj] - v38;
        if ( !v21 )
          v21 = *((_QWORD *)&xmmword_18018FED0[jj] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v21 )
          break;
      }
    ...
    if ( a3 )
    {
      ...
      for ( kk = 0; ; ++kk )
      {
        ...
        v24 = *(_QWORD *)&xmmword_18018FED0[kk] - v38;
        if ( !v24 )
          v24 = *((_QWORD *)&xmmword_18018FED0[kk] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v24 )
          break;
      }
...
LABEL_111:
        ...
        v28 = *(_QWORD *)&xmmword_18018FED0[nn] - v38;
        if ( !v28 )
          v28 = *((_QWORD *)&xmmword_18018FED0[nn] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v28 )
          break;
      }
    ...
    if ( a3 )
    {
      ...
      for ( i1 = 0; ; ++i1 )
      {
        ...
        v31 = *(_QWORD *)&xmmword_18018FED0[i1] - v38;
        if ( !v31 )
          v31 = *((_QWORD *)&xmmword_18018FED0[i1] + 1) - *((_QWORD *)&v38 + 1);
        if ( !v31 )
          break;
      }
  ...
  if ( v37[0] )
    (*(void (__fastcall **)(__int64, __int64, _OWORD *))(*(_QWORD *)v37[0] + 16LL))(v37[0], v6, xmmword_18018FED0);
  return 0LL;
}
