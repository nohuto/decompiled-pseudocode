/*
 * XREFs of _dynamic_initializer_for__g_SarmTelemetryProviderRegistration__ @ 0x180008450
 * Callers:
 *     <none>
 * Callees:
...
{
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1801D82B0);
