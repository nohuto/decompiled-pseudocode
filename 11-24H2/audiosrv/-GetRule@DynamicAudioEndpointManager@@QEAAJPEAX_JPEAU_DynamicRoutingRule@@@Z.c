/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x180125C44
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x180107A20 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
