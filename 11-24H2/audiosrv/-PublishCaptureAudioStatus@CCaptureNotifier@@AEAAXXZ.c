/*
 * XREFs of ?PublishCaptureAudioStatus@CCaptureNotifier@@AEAAXXZ @ 0x180065858
 * Callers:
 ...
 *     ?SerializeEventHeaderFromApplicationMap@CCaptureNotifier@@AEAAXPEAEK@Z @ 0x18006591C (-SerializeEventHeaderFromApplicationMap@CCaptureNotifier@@AEAAXPEAEK@Z.c)
