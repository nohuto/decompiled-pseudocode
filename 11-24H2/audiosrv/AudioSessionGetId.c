/*
 * XREFs of AudioSessionGetId @ 0x180078710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetId(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 112LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetId", 1502, v10);
