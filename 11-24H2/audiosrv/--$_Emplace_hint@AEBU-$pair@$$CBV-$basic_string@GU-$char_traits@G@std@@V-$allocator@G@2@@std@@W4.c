 ...
 *     ?_Check_grow_by_1@?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@@std@@@2@$0A@@std@@@std@@IEAAXXZ @ 0x1800F8CC4 (-_Check_grow_by_1@-$_Tree@V-$_Tmap_traits@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall std::_Tree<std::_Tmap_traits<std::wstring,enum AEC_LOOPBACK_SELECTION_MODE,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>>,0>>::_Emplace_hint<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE> const &>(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  v4 = std::_Tree<std::_Tmap_traits<std::wstring,enum AEC_LOOPBACK_SELECTION_MODE,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>>,0>>::_Find_hint<std::wstring>(
         a1,
         &v12,
         a2,
         a3);
  ...
  if ( (_BYTE)v13 )
    return v5;
  std::_Tree<std::_Tmap_traits<std::wstring,enum AEC_LOOPBACK_SELECTION_MODE,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>>,0>>::_Check_grow_by_1();
  v7 = qword_1801DB6B8;
  std::_Tree_temp_node_alloc<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>::_Tree_temp_node_alloc<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>(
    v10,
    &qword_1801DB6B8);
  std::_Default_allocator_traits<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>::construct<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE> const &>(
    v8,
    v11 + 32,
    a3);
  *(_QWORD *)v11 = v7;
  ...
  *(_BYTE *)(v11 + 25) = 0;
  v9 = v11;
  v11 = 0LL;
  std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>(v10);
  v12 = v5;
  return std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned long const,APPLICATION_REF_DATA>>>::_Insert_node(
           &qword_1801DB6B8,
           (__int64)&v12,
           v9);
}
