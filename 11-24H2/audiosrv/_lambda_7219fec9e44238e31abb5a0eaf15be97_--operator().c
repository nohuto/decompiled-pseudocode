/*
 * XREFs of _lambda_7219fec9e44238e31abb5a0eaf15be97_::operator() @ 0x18013115C
 * Callers:
...
__int64 __fastcall lambda_7219fec9e44238e31abb5a0eaf15be97_::operator()(__int64 a1)
{
...
LABEL_21:
  ...
  {
LABEL_38:
    v22 = CEndpointCharacteristics::SetCurrentEffectPackInternal((struct _RTL_CRITICAL_SECTION *)v2, v20);
    if ( v22 < 0 )
      wil::details::in1diag3::_Log_Hr(
        retaddr,
        1903LL,
