/*
 * XREFs of ?GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z @ 0x18001EAB8
 * Callers:
 ...
 *     ??1CSid@ATL@@UEAA@XZ @ 0x1800A02A4 (--1CSid@ATL@@UEAA@XZ.c)
...
__int64 __fastcall CAudioDGProcess::GetADGProcessSD(void **a1)
{
  ...
  _BYTE v22[8]; // [rsp+118h] [rbp-50h] BYREF
  _BYTE v23[8]; // [rsp+120h] [rbp-48h] BYREF
  _BYTE v24[8]; // [rsp+128h] [rbp-40h] BYREF
  _BYTE v25[16]; // [rsp+130h] [rbp-38h] BYREF
  ...
  try
  {
    ...
    *(_WORD *)&v20.Value[4] = 1280;
    ...
    if ( v3 )
    {
      ATL::CSid::CSid((ATL::CSid *)v21, (struct _SID_IDENTIFIER_AUTHORITY *)&ATL::Sids::SecurityNTAuthority, 1u);
