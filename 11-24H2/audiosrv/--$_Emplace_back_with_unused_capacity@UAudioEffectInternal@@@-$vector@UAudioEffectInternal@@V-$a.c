/*
 * XREFs of ??$_Emplace_back_with_unused_capacity@UAudioEffectInternal@@@?$vector@UAudioEffectInternal@@V?$allocator@UAudioEffectInternal@@@std@@@std@@AEAAAEAUAudioEffectInternal@@$$QEAU2@@Z @ 0x1800B4B88
 * Callers:
 ...
 * Callees:
 *     ??$_Construct_in_place@UAudioEffectInternal@@AEBU1@@std@@YAXAEAUAudioEffectInternal@@AEBU1@@Z @ 0x1800B4B70 (--$_Construct_in_place@UAudioEffectInternal@@AEBU1@@std@@YAXAEAUAudioEffectInternal@@AEBU1@@Z.c)
 */
