/*
 * XREFs of ?reset@?$unique_storage@U?$resource_policy@PEAUwnf_subscription_state_base@details@wil@@P6AXPEAU123@@Z$1?delete_wnf_subscription_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUwnf_subscription_state_base@23@@Z @ 0x180063DE4
 * Callers:
 ...
 *     ?Shutdown@BluetoothBroadcastProvider@@UEAAXXZ @ 0x1800E7780 (-Shutdown@BluetoothBroadcastProvider@@UEAAXXZ.c)
