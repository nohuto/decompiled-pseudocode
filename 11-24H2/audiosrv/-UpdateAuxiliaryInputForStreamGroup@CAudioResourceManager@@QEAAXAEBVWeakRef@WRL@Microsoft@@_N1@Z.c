/*
 * XREFs of ?UpdateAuxiliaryInputForStreamGroup@CAudioResourceManager@@QEAAXAEBVWeakRef@WRL@Microsoft@@_N1@Z @ 0x1800BF97C
 * Callers:
        ...
        char a4)
{
  ...
  v18[14] = &v21;
  v18[15] = &v6;
  v19 = lambda_27af74114ee4e9d8e8865818d8d3377d_::operator()((__int64)v18);
  v15 = 0;
  lambda_c5e3eb1e956db9e9fcdee8260c344452_::operator()((__int64)v14);
