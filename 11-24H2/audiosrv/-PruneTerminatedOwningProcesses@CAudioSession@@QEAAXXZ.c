/*
 * XREFs of ?PruneTerminatedOwningProcesses@CAudioSession@@QEAAXXZ @ 0x180018F34
 * Callers:
...
void __fastcall CAudioSession::PruneTerminatedOwningProcesses(CAudioSession *this)
{
  ...
  *(_OWORD *)v12 = 0LL;
  ...
  try
  {
    v4 = (_QWORD *)std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy_________lambda_2ac988fab4ee0f8d2b50863fb7bcec65___();
    if ( *v4 != v3 )
    {
