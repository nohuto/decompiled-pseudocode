/*
 * XREFs of ?GetChannelVolumeLevelScalar@BluetoothVolume@BluetoothControls@@UEAAJIPEAM@Z @ 0x1800D3EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)this,
                      &v7);
  LODWORD(a3) = (*(__int64 (__fastcall **)(__int64, _QWORD, float *))(*(_QWORD *)*TargetedControl + 168LL))(
                  *TargetedControl,
                  a2,
                  a3);
