/*
 * XREFs of ??1?$com_ptr_t@VCVADServer@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800A2670
 * Callers:
 ...
 *     _AudioServerInitialize_Internal_::_1_::dtor$7 @ 0x18016BEBA (_AudioServerInitialize_Internal_--_1_--dtor$7.c)
 * Callees:
