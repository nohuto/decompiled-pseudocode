/*
 * XREFs of ?AcquireReference@CPlaybackNotifier@@QEAA?AV?$shared_ptr@VCPlaybackReference@@@std@@PEBG@Z @ 0x180011694
 * Callers:
 ...
 * Callees:
 *     ??$_Construct_in_place@VCPlaybackReference@@PEAVCPlaybackNotifier@@AEAPEBG@std@@YAXAEAVCPlaybackReference@@$$QEAPEAVCPlaybackNotifier@@AEAPEBG@Z @ 0x1800102C0 (--$_Construct_in_place@VCPlaybackReference@@PEAVCPlaybackNotifier@@AEAPEBG@std@@YAXAEAVCPlayback.c)
