/*
 * XREFs of AudioVolumeSetMute @ 0x1800891E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeSetMute(_QWORD *a1, __int128 *a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    if ( v9 )
    {
      ...
      v8 = CWatchdogTimer<1>::CWatchdogTimer<1>(v9, pftDueTime);
    }
    std::unique_ptr<CWatchdogTimer<1>>::reset(&v16, v8);
  }
  else
  {
    ...
    if ( v11 )
    {
      ...
      AudioSrvTelemetryProvider::Instance();
      v8 = CWatchdogTimer_Old<1>::CWatchdogTimer_Old<1>(v11, v12);
    }
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v15, v8);
  }
  v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64))(*(_QWORD *)*a1 + 144LL))(*a1, a3, a4, a5);
