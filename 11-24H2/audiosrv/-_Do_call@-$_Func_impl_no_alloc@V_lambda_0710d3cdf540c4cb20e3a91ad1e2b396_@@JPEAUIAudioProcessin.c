/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_0710d3cdf540c4cb20e3a91ad1e2b396_@@JPEAUIAudioProcessingObject@@U_GUID@@I@std@@EEAAJ$$QEAPEAUIAudioProcessingObject@@$$QEAU_GUID@@$$QEAI@Z @ 0x180057E50
 * Callers:
 *     <none>
 * Callees:
        ...
        ...)
{
  ...
  {
    v7 = 0LL;
    v5 = (**v4)(v4, &GUID_25385759_3236_4101_a943_25693dfb5d2d, (__int64 *)va) >= 0;
  }
  **(_BYTE **)(a1 + 8) = v5;
  if ( v7 )
