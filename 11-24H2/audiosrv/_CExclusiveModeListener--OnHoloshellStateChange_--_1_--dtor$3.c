/*
 * XREFs of _CExclusiveModeListener::OnHoloshellStateChange_::_1_::dtor$3 @ 0x18017238B
 * Callers:
 *     <none>
 * Callees:
 *     ??1HStringReference@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x1800A3354 (--1HStringReference@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
 */
