 ...
 * Callees:
 *     ??$?RV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V01@@?$_Uhash_compare@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@Ucase_insensitive_hash@@Ucase_insensitive_equality@@@std@@QEBA_NAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@0@Z @ 0x18000D8B0 (--$-RV-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V01@@-$_Uhash_compare@V-$basi.c)
 ...
 *     ??1_Clear_guard@?$_Hash@V?$_Umap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$unique_ptr@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@U?$default_delete@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@@wistd@@@wistd@@V?$_Uhash_compare@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@Ucase_insensitive_hash@@Ucase_insensitive_equality@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$unique_ptr@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@U?$default_delete@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@@wistd@@@wistd@@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x18014FE0C (--1_Clear_guard@-$_Hash@V-$_Umap_traits@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@.c)
 */
        ...
        unsigned __int64 a2)
{
  ...
  {
    v10 = (_QWORD *)*v10;
    v11 = case_insensitive_hash::operator()((__int64)v8, (__int64)(v9 + 2));
    v12 = 2 * (v11 & v2[6]);
    v13 = *v7;
    if ( *(_QWORD *)(v13 + 16 * (v11 & v2[6])) == v6 )
    {
      *(_QWORD *)(v13 + 16 * (v11 & v2[6])) = v9;
      *(_QWORD *)(v13 + 8 * v12 + 8) = v9;
    }
    else
    {
      v14 = *(_QWORD **)(v13 + 16 * (v11 & v2[6]) + 8);
      if ( std::_Uhash_compare<std::wstring,case_insensitive_hash,case_insensitive_equality>::operator()<std::wstring,std::wstring>(
             (__int64)v8,
             (__int64)(v9 + 2),
             (__int64)(v14 + 2)) )
      {
        v18 = v14;
        while ( *(_QWORD **)(v13 + 8 * v12) != v18 )
        {
          v14 = (_QWORD *)v14[1];
          v18 = v14;
          if ( !std::_Uhash_compare<std::wstring,case_insensitive_hash,case_insensitive_equality>::operator()<std::wstring,std::wstring>(
