/*
 * XREFs of ?IsDtsxSpeakersEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180057218
 * Callers:
 *     ?GetTechnologyLicenseResult@CSpatialAudioDtsxStereo@@UEBAJPEBG@Z @ 0x18006EAE0 (-GetTechnologyLicenseResult@CSpatialAudioDtsxStereo@@UEBAJPEBG@Z.c)
 * Callees:
