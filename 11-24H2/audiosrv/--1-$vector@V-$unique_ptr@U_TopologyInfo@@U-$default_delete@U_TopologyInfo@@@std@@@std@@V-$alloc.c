/*
 * XREFs of ??1?$vector@V?$unique_ptr@U_TopologyInfo@@U?$default_delete@U_TopologyInfo@@@std@@@std@@V?$allocator@V?$unique_ptr@U_TopologyInfo@@U?$default_delete@U_TopologyInfo@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800EAA74
 * Callers:
 *     _EndpointInfo::EndpointInfo_::_1_::dtor$3 @ 0x18016F821 (_EndpointInfo--EndpointInfo_--_1_--dtor$3.c)
 *     _EndpointInfo::EndpointInfo_::_1_::dtor$3_0 @ 0x180172CBE (_EndpointInfo--EndpointInfo_--_1_--dtor$3_0.c)
 * Callees:
