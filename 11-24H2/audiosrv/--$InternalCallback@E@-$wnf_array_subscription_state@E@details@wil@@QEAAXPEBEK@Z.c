/*
 * XREFs of ??$InternalCallback@E@?$wnf_array_subscription_state@E@details@wil@@QEAAXPEBEK@Z @ 0x18014B1F8
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_aefdc4d25f99d355ae0f211589b2486e_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x18014B1A0 (-_lambda_invoker_cdecl_@_lambda_aefdc4d25f99d355ae0f211589b2486e_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
