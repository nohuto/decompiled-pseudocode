/*
 * XREFs of ?GetModeEffect@EffectPack@@QEAAJU_GUID@@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x180033CA0
 * Callers:
        ...
        struct IAudioSystemEffects2 **a7)
{
  ...
  {
    if ( a3 || (v16[0] = *v17, (unsigned int)EffectPack::IsAPOModeSupported(v9, 0LL, v16, v8)) )
    {
      v16[0] = *v17;
      if ( (_DWORD)v8
