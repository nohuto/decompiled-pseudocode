/*
 * XREFs of s_apmDoesPlatformSupportVolumeGroups @ 0x18007DA90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmDoesPlatformSupportVolumeGroups(__int64 a1, __int64 a2)
{
  ...
  v9 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64))(*(_QWORD *)g_PolicyManager + 408LL))(
         g_PolicyManager,
         a1,
         a2);
