/*
 * XREFs of _dynamic_atexit_destructor_for__AECLoopbackSelectionModeStringValues__ @ 0x180173130
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall dynamic_atexit_destructor_for__AECLoopbackSelectionModeStringValues__()
{
  std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>(
    (__int64)&qword_1801DB6B8,
    (__int64)&qword_1801DB6B8,
    *(char **)(qword_1801DB6B8 + 8));
  std::_Deallocate<16,0>((char *)qword_1801DB6B8, (const struct std::nothrow_t *)0x48);
}
