/*
 * XREFs of ??0?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@AEBV01@@Z @ 0x1800DACA8
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEAAX_K@Z @ 0x1800A2244 (-_Buy_raw@-$vector@V-$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$com.c)
 ...
 *     ??1?$_Tidy_guard@V?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@std@@QEAA@XZ @ 0x1800DAD80 (--1-$_Tidy_guard@V-$vector@V-$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V-$allocato.c)
 */
  ...
  if ( v4 )
  {
    ...
    while ( v7 != v6 )
      std::_Default_allocator_traits<std::allocator<std::_List_node<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,void *>>>::construct<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy> const &>(
        ...
        v8++,
        v7++);
    std::_Destroy_range<std::allocator<wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>>>(v8, v8);
    v10 = 0LL;
    a1[1] = (__int64)v8;
    std::_Tidy_guard<std::vector<wil::com_ptr_t<IUnknown,wil::err_returncode_policy>>>::~_Tidy_guard<std::vector<wil::com_ptr_t<IUnknown,wil::err_returncode_policy>>>(&v10);
  }
  return a1;
}
