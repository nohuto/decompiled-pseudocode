/*
 * XREFs of ?UpdateMasterVolumeLevel@CVolumeSoftware@@MEAAJ_N@Z @ 0x1801157C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeSoftware::UpdateMasterVolumeLevel(CVolumeSoftware *this, unsigned __int8 a2)
{
  ...
  if ( *((_QWORD *)this + 31) )
  {
    ...
    if ( !Block )
    {
      ...
      free(0LL);
LABEL_12:
      AudSrvTraceLoggingErrorHelper("CVolumeSoftware::UpdateMasterVolumeLevel", 2187, v4);
      goto LABEL_20;
    }
    v7 = 0LL;
  ...
  v16[1] = this;
  v16[7] = v16;
  v14 = CSerialWorkQueue::QueueRecurringItem((__int64)SerialWorkQueue, 0x3E8u, v13, v16, (char *)this + 312);
  if ( v14 < 0 )
