/*
 * XREFs of ?GetAppSubmixClientContextHelper@CProcessSubmixManager@@AEAAJKW4ProcessSubmixCapture@@PEBGPEAUIAudioProcess@@PEAPEAVCAppSubmixClient@@@Z @ 0x1800ADE70
 * Callers:
 *     ?GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJKW4ProcessSubmixCapture@@PEAUIAudioProcess@@PEAPEAVCAppSubmixClient@@@Z @ 0x1800ADE00 (-GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJKW4ProcessSubmixCapture@@PEAUIAudioProces.c)
 *     ?GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJPEBGPEAUIAudioProcess@@PEAPEAVCAppSubmixClient@@@Z @ 0x1800ADE40 (-GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJPEBGPEAUIAudioProcess@@PEAPEAVCAppSubmixC.c)
 * Callees:
        ...
        __int64 **a6)
{
  ...
  __int64 v44; // r8
  __int64 v45; // r9
  int v46; // [rsp+20h] [rbp-158h]
  unsigned int v47; // [rsp+50h] [rbp-128h] BYREF
  __int64 *v48; // [rsp+58h] [rbp-120h] BYREF
  unsigned int v49; // [rsp+60h] [rbp-118h] BYREF
  __int64 v50; // [rsp+68h] [rbp-110h] BYREF
  __int16 v51; // [rsp+70h] [rbp-108h] BYREF
  unsigned int v52; // [rsp+78h] [rbp-100h] BYREF
  unsigned int v53; // [rsp+80h] [rbp-F8h] BYREF
  __int64 *v54; // [rsp+88h] [rbp-F0h] BYREF
  struct _RTL_CRITICAL_SECTION *v55; // [rsp+90h] [rbp-E8h] BYREF
  const WCHAR *v56; // [rsp+98h] [rbp-E0h] BYREF
  const WCHAR *v57; // [rsp+A0h] [rbp-D8h] BYREF
  char v58[8]; // [rsp+B0h] [rbp-C8h] BYREF
  _QWORD *v59; // [rsp+B8h] [rbp-C0h]
  int v60[2]; // [rsp+F0h] [rbp-88h] BYREF
  const WCHAR **v61; // [rsp+F8h] [rbp-80h]
  __int64 *v62; // [rsp+100h] [rbp-78h]
  unsigned int *v63; // [rsp+108h] [rbp-70h]
  int *v64; // [rsp+128h] [rbp-50h]
  ...
  *(_QWORD *)v60 = &v52;
  ...
  if ( i == *(LPCWCH ***)(a1 + 64) )
  {
    v10 = (unsigned int *)operator new(0x70uLL);
    v11 = v10;
    *(_QWORD *)v60 = v10;
    if ( v10 )
    {
      ...
      *((_QWORD *)v11 + 1) = 0LL;
      v11[4] = 0;
      std::unordered_set<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>::unordered_set<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>((__int64)(v11 + 6));
      *((_QWORD *)v11 + 11) = 0LL;
      *((_QWORD *)v11 + 12) = 0LL;
      *((_QWORD *)v11 + 13) = 0LL;
    }
    ...
    wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
      (void **)v11,
      0LL);
    v14 = _AllocString<CTCoAllocPolicy>(v13, v12, v56, v11);
    v15 = v14;
    if ( v14 < 0 )
    {
      ...
      std::unique_ptr<CAppSubmixClientContext>::~unique_ptr<CAppSubmixClientContext>(&v48);
      wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>(&v55);
      return v15;
    }
    v11[2] = v53;
    v11[3] = v52;
    v11[4] = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v50 + 48LL))(v50);
    std::unordered_set<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>::unordered_set<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>((__int64)v58);
    if ( v52 == 4 )
    {
      SubmixesForApplication = DeviceGraphStore::GetSubmixesForApplication(v56, v11[4], v58);
      v18 = SubmixesForApplication;
    ...
    {
      FilteredSubmixes = DeviceGraphStore::GetFilteredSubmixes(v53, v52, v11[4], v58);
      v20 = FilteredSubmixes;
    ...
    std::_Hash<std::_Uset_traits<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::_Uhash_compare<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::hash<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,std::equal_to<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>>,std::allocator<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,0>>::clear(v11 + 6);
    v21 = v59;
    for ( j = (_QWORD *)*v59; j != v21; j = (_QWORD *)*j )
    {
      if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(*(_QWORD *)j[2] + 144LL))(j[2]) )
    ...
    *(_QWORD *)v60 = v11;
    std::make_unique<CAppSubmixClient,IAudioProcess * &,CAppSubmixClientContext *,0>(&v54, &v50, (__int64 *)v60);
    v27 = v54;
    v28 = (__int64 ***)(v11 + 22);
    ...
    v34 = (_DWORD *)*((_QWORD *)v32 + 1);
    if ( *v34 > 4u && tlgKeywordOn(*((_QWORD *)v32 + 1), 512LL) )
    {
      v47 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v50 + 48LL))(v50);
      v49 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v50 + 40LL))(v50);
      *(_QWORD *)v60 = v48;
    ...
    *(_QWORD *)v60 = off_18017A918;
    v61 = (const WCHAR **)a1;
    v64 = v60;
    v37 = CAudioResourceManager::DisconnectOffloadStreams(v33, v60);
    if ( v37 < 0 )
      wil::details::in1diag3::_Log_Hr(
        ...
        v46);
    std::_Func_class<void,>::_Tidy((__int64)v60, v38);
    *a6 = v27;
    std::unique_ptr<CAppSubmixClient>::~unique_ptr<CAppSubmixClient>(&v54);
    std::_Hash<std::_Uset_traits<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::_Uhash_compare<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::hash<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,std::equal_to<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>>,std::allocator<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,0>>::~_Hash<std::_Uset_traits<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::_Uhash_compare<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>,std::hash<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,std::equal_to<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>>,std::allocator<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>,0>>((__int64)v58);
    std::unique_ptr<CAppSubmixClientContext>::~unique_ptr<CAppSubmixClientContext>(&v48);
  }
  else
  {
    *(_QWORD *)v60 = *i;
    std::make_unique<CAppSubmixClient,IAudioProcess * &,CAppSubmixClientContext *,0>(&v48, &v50, (__int64 *)v60);
    v39 = v48;
    v40 = (__int64 ***)(*i + 11);
    v41 = (char *)(*i)[12];
    if ( v41 == (char *)(*i)[13] )
    ...
    if ( *v43 > 4u && tlgKeywordOn(*((_QWORD *)v42 + 1), 512LL) )
    {
      v47 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v50 + 48LL))(v50);
      v49 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v50 + 40LL))(v50);
      *(_QWORD *)v60 = *i;
    ...
    *a6 = v39;
    std::unique_ptr<CAppSubmixClient>::~unique_ptr<CAppSubmixClient>(&v48);
  }
  wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>(&v55);
  return 0LL;
}
