/*
 * XREFs of ?GetCompatibleMulticastProvider@CMulticastSessionManager@@AEAAJAEAV?$vector@V?$com_ptr_t@VCEndpointCharacteristics@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCEndpointCharacteristics@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@PEAPEAUIMulticastProvider@@@Z @ 0x1800FFE04
 * Callers:
 ...
 *     _lambda_29cbe834aaff6b3962c1372fb6672b17_::operator() @ 0x1800FFAF8 (_lambda_29cbe834aaff6b3962c1372fb6672b17_--operator().c)
        ...
        struct IMulticastProvider **a3)
{
  ...
  struct IMulticastProvider **v28; // [rsp+70h] [rbp-58h]
  ...
  while ( 1 )
  {
    ...
    if ( pvar.vt == 4127 )
    {
      ...
      for ( i = 0; i < pvar.lVal; ++i )
      {
        ...
        {
          std::vector<_GUID>::_Emplace_reallocate<_GUID const &>(
            (__int64)&v23,
            (char *)v23.m128i_i64[1],
            (__int64)&pclsid);
        }
        else
        {
  ...
  {
    v22 = 0LL;
    MulticastProvider = CMulticastSessionManager::GetMulticastProvider(this, v7, &v22);
    ...
    if ( MulticastProvider >= 0 )
    {
      ...
      if ( (*(unsigned __int8 (__fastcall **)(struct IMulticastProvider *))(*(_QWORD *)v22 + 24LL))(v22) )
      {
        v22 = 0LL;
        *v28 = v21;
        wil::com_ptr_t<IMulticastProvider,wil::err_returncode_policy>::~com_ptr_t<IMulticastProvider,wil::err_returncode_policy>((__int64 *)&v22);
        std::vector<std::_Loop_vals_t>::~vector<std::_Loop_vals_t>((__int64)&v25);
        return 0LL;
      }
      else
