/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDtsxStereo@@UEBA_NPEAUIAudioEndpointInfo@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x180141F60
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall CSpatialAudioDtsxStereo::IsTechnologySupported(
        ...
        struct WAVEFORMATEXTENSIBLE *a8)
{
  ...
  *a6 = 0;
  *v10 = 0;
  if ( *((_QWORD *)this + 1) || !byte_1801DA2FA )
  {
