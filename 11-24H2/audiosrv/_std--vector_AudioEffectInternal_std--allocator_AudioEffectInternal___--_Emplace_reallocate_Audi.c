/*
 * XREFs of _std::vector_AudioEffectInternal_std::allocator_AudioEffectInternal___::_Emplace_reallocate_AudioEffectInternal_const_&__::_1_::catch$0 @ 0x18016B75F
 * Callers:
 *     <none>
 * Callees:
