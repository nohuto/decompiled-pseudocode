/*
 * XREFs of _CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch$15 @ 0x18016C6B1
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch_15(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
