/*
 * XREFs of ?DoHandlePropertyValueChanged@CMonitorManager@@AEAAXPEBGU_tagpropertykey@@@Z @ 0x180009A9C
 * Callers:
        ...
        struct _tagpropertykey *a3)
{
  ...
  if ( *((_DWORD *)this + 14) == 1 )
  {
    for ( i = 0LL; i < 0x50; i += 16LL )
    {
      ...
      if ( !v8 )
        (*(void (__fastcall **)(CMonitorManager *__hidden, const unsigned __int16 *, const struct _tagpropertykey *))((char *)&off_1801D8008 + i))(
          this,
          a2,
          a3);
    }
