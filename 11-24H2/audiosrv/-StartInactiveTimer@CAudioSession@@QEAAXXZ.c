/*
 * XREFs of ?StartInactiveTimer@CAudioSession@@QEAAXXZ @ 0x180026DC8
 * Callers:
 ...
 * Callees:
 *     ??$?4U?$default_delete@U_RecurringTask@@@std@@$0A@@?$unique_ptr@U_RecurringTask@@U?$default_delete@U_RecurringTask@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x18002786C (--$-4U-$default_delete@U_RecurringTask@@@std@@$0A@@-$unique_ptr@U_RecurringTask@@U-$default_dele.c)
...
void __fastcall CAudioSession::StartInactiveTimer(CAudioSession *this)
{
  ...
  _FILETIME pftDueTime; // [rsp+E8h] [rbp+6Fh] BYREF
