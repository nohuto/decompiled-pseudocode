/*
 * XREFs of ??0?$basic_stringstream@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@H@Z @ 0x18015FD4C
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_DWORD *)((char *)a1 + *(int *)(*a1 + 4LL) - 4) = *(_DWORD *)(*a1 + 4LL) - 152;
  ...
  v5 = std::wstring::c_str(a2, v4);
  std::basic_stringbuf<unsigned short>::_Init(a1 + 3, v5, *(_QWORD *)(a2 + 16), 0LL);
  return a1;
}
