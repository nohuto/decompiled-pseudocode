/*
 * XREFs of ?RetrieveBroadcastSession@BluetoothBroadcastProvider@@AEAAAEAUBluetoothBroadcastSession@@AEBU_GUID@@W4RBS_OPTION@1@@Z @ 0x1800E7170
 * Callers:
...
_QWORD *__fastcall BluetoothBroadcastProvider::RetrieveBroadcastSession(__int64 a1, _QWORD *a2)
{
  ...
  if ( i == *(_QWORD **)(a1 + 72) )
  {
    memset(&v9[1], 0, 32);
    v9[0] = *(_OWORD *)a2;
    std::vector<BluetoothBroadcastSession>::push_back(a1 + 64, v9);
    v6 = *(_QWORD *)(a1 + 72);
    BluetoothBroadcastSession::~BluetoothBroadcastSession((void **)v9);
