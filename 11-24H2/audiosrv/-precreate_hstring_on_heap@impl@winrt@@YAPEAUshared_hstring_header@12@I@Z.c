/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x1800E85A4
 * Callers:
 ...
 * Callees:
 *     WINRT_IMPL_HeapAlloc @ 0x1800A51EE (WINRT_IMPL_HeapAlloc.c)
 ...
 *     ??0invalid_argument@std@@QEAA@PEBD@Z @ 0x1800E3EA8 (--0invalid_argument@std@@QEAA@PEBD@Z.c)
