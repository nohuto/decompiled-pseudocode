/*
 * XREFs of ??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@AEBV01@@Z @ 0x18000D870
 * Callers:
...
__int64 __fastcall std::wstring::wstring(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  *(_QWORD *)(a1 + 24) = 0LL;
  v4 = std::wstring::c_str(a2, a2, a3);
  std::wstring::_Construct<2,unsigned short const *>(a1, v4, *(_QWORD *)(v5 + 16));
  return a1;
}
