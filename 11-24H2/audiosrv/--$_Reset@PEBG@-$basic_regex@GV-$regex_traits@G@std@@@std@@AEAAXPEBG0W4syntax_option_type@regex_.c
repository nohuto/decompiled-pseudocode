/*
 * XREFs of ??$_Reset@PEBG@?$basic_regex@GV?$regex_traits@G@std@@@std@@AEAAXPEBG0W4syntax_option_type@regex_constants@1@@Z @ 0x1801433D8
 * Callers:
 ...
 *     ?_Reset@?$basic_regex@GV?$regex_traits@G@std@@@std@@AEAAXPEAV_Root_node@2@@Z @ 0x180148E38 (-_Reset@-$basic_regex@GV-$regex_traits@G@std@@@std@@AEAAXPEAV_Root_node@2@@Z.c)
 */
