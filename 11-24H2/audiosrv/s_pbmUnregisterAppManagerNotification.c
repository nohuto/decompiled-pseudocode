/*
 * XREFs of s_pbmUnregisterAppManagerNotification @ 0x18007EAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmUnregisterAppManagerNotification(__int64 a1)
{
  ...
  {
    v1 = PbmUnregisterAppManagerNotification(a1);
  }
  else if ( g_PolicyManager )
  {
    ...
    v1 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64 *))(*(_QWORD *)g_PolicyManager + 32LL))(
           ...
           &v10);
    if ( v1 >= 0 )
      v1 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64))(*(_QWORD *)g_PolicyManager + 104LL))(
             g_PolicyManager,
             v10);
