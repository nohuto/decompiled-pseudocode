/*
 * XREFs of std::function_long___cdecl(wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&)_::function_long___cdecl(wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&)___lambda_0d142282e693a5da8305741b2fcbdc74__0_ @ 0x1800F9020
 * Callers:
...
__int64 __fastcall std::function_long___cdecl_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy_____::function_long___cdecl_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy_______lambda_0d142282e693a5da8305741b2fcbdc74__0_(
        __int64 a1,
        _OWORD *a2)
{
  __int64 result; // rax
