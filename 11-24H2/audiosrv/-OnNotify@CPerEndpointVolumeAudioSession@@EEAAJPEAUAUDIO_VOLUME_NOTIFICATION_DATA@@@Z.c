/*
 * XREFs of ?OnNotify@CPerEndpointVolumeAudioSession@@EEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x180020D60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_q_guid__guid_ @ 0x1800C3608 (WPP_SF_q_guid__guid_.c)
 *     WPP_SF_qdd @ 0x1800C36CC (WPP_SF_qdd.c)
 *     WPP_SF_qdgg @ 0x1800C372C (WPP_SF_qdgg.c)
 *     WPP_SF_qgg_HEX__HEX_ @ 0x1800C3798 (WPP_SF_qgg_HEX__HEX_.c)
 */
        ...
        struct AUDIO_VOLUME_NOTIFICATION_DATA *a2)
{
  ...
  if ( v8 )
  {
    ...
    if ( v5 || v37 || v4 )
    {
      if ( v11 != &WPP_GLOBAL_Control && (*((_BYTE *)v11 + 28) & 0x40) != 0 && *((_BYTE *)v11 + 25) >= 4u )
      {
        WPP_SF_(v11[2], 77LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids);
        v11 = WPP_GLOBAL_Control;
      }
      if ( v4 )
      {
        ...
        v23 = 0;
        if ( v11 != &WPP_GLOBAL_Control && (*((_BYTE *)v11 + 28) & 0x40) != 0 && *((_BYTE *)v11 + 25) >= 4u )
          WPP_SF_(v11[2], 78LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids);
      ...
      {
        if ( v11 != &WPP_GLOBAL_Control && (*((_BYTE *)v11 + 28) & 0x40) != 0 && *((_BYTE *)v11 + 25) >= 4u )
          WPP_SF_(v11[2], 79LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids);
        EnterCriticalSection(v9);
        *((float *)this - 36) = *p_fMasterVolume;
        ...
        v39 = 0;
        v29 = lambda_9219152d4e141db21e4330029f5108f8_::_lambda_9219152d4e141db21e4330029f5108f8_(
                (unsigned int)&v36,
                (int)this - 920,
                ...
                (__int64)&v39,
                (__int64)&v38);
        lambda_9219152d4e141db21e4330029f5108f8_::operator()(v29);
      }
    }
    operator delete(v40);
  }
  ...
  {
    WPP_SF_q(v6[2], 72LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids, (char *)this - 920);
  }
  return 0LL;
}
