/*
 * XREFs of ??$AsWeak@UIProcessSubmixProxy@@@WRL@Microsoft@@YAJPEAUIProcessSubmixProxy@@PEAVWeakRef@01@@Z @ 0x180061C78
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<IProcessSubmixProxy>(
