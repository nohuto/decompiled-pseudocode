/*
 * XREFs of AudioSessionPropertyStoreGetAt @ 0x1800C47C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionPropertyStoreGetAt(__int64 *a1, unsigned int a2, __int64 a3)
{
    ...
    if ( v6 )
    {
      ...
      v6 = CWatchdogTimer<1>::CWatchdogTimer<1>(
             ...
             *((struct _TP_TIMER **)v10 + 1),
             v9,
             (struct _TP_TIMER *)L"AudioSessionPropertyStoreGetAt",
             pftDueTime);
    }
  ...
  v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(v5 + 72) + 376LL))(
          *(_QWORD *)(v5 + 72),
          a2,
          a3);
  v17 = v16;
  if ( v16 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionPropertyStoreGetAt", 2433, v16);
