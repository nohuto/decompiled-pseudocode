/*
 * XREFs of ?AddEndpointToCompatibleList@BluetoothBroadcastProvider@@AEAAJPEBGPEA_N@Z @ 0x1800E52B0
 * Callers:
...
__int64 __fastcall BluetoothBroadcastProvider::AddEndpointToCompatibleList(
