/*
 * XREFs of AudioSessionPropertyStoreSetValue @ 0x1800C4B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionPropertyStoreSetValue(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  v16 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(**(_QWORD **)(v5 + 72) + 392LL))(
          *(_QWORD *)(v5 + 72),
          a2,
          a3);
  v17 = v16;
  if ( v16 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionPropertyStoreSetValue", 2471, v16);
