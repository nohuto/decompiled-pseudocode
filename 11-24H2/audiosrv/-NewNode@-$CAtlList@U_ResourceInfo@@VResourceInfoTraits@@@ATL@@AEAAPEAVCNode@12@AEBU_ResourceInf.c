/*
 * XREFs of ?NewNode@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_ResourceInfo@@PEAV312@1@Z @ 0x180161F14
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<_ResourceInfo,ResourceInfoTraits>::NewNode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !*(_QWORD *)(a1 + 32) )
  {
    v6 = ATL::CAtlPlex::Create((struct ATL::CAtlPlex **)(a1 + 24), *(unsigned int *)(a1 + 40), 0x230uLL);
    if ( !v6 )
