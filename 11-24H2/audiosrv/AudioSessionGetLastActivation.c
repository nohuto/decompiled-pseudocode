/*
 * XREFs of AudioSessionGetLastActivation @ 0x1800C4300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetLastActivation(__int64 *a1, __int64 a2)
{
  ...
  v14 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 152LL))(v3, a2);
  v15 = v14;
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetLastActivation", 1691, v14);
