/*
 * XREFs of ?Continue@CMonitorManager@@QEAAXXZ @ 0x180117C50
 * Callers:
 *     ?ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18011B5A0 (-ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
