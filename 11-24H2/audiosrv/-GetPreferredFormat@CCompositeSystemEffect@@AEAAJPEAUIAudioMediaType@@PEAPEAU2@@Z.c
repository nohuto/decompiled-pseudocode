/*
 * XREFs of ?GetPreferredFormat@CCompositeSystemEffect@@AEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z @ 0x18014A6D4
 * Callers:
 *     ?GetPreferredOutputFormat@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z @ 0x18014A930 (-GetPreferredOutputFormat@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z.c)
 * Callees:
