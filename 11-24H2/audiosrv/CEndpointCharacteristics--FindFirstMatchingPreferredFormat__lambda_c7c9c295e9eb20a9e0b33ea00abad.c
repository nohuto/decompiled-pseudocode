/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_c7c9c295e9eb20a9e0b33ea00abada77___ @ 0x18012DEAC
 * Callers:
    ...
    else
    {
      ...
      else
      {
        *(_OWORD *)pvar = 0LL;
        ...
        v6 = (char *)&unk_18019CA00;
        if ( !v12 )
          v6 = (char *)&unk_18019C9A0;
      }
      v7 = 8LL;
    }
  }
