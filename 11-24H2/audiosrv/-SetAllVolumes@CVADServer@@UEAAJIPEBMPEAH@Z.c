/*
 * XREFs of ?SetAllVolumes@CVADServer@@UEAAJIPEBMPEAH@Z @ 0x180020C60
 * Callers:
        ...
        int *a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_74ab4d28651a3ef962dcd31efa958cf9_Traceguids, this);
  }
  v8 = this + 5;
