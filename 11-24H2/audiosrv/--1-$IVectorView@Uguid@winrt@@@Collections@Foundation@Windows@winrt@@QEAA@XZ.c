/*
 * XREFs of ??1?$IVectorView@Uguid@winrt@@@Collections@Foundation@Windows@winrt@@QEAA@XZ @ 0x1800E3FE4
 * Callers:
 ...
 *     ??1?$vector_view@Uguid@winrt@@@param@winrt@@QEAA@XZ @ 0x1800E4040 (--1-$vector_view@Uguid@winrt@@@param@winrt@@QEAA@XZ.c)
 *     ??1BluetoothAudioSharingParameters@Internal@Interface@Audio@Bluetooth@Microsoft@winrt@@QEAA@XZ @ 0x1800E4064 (--1BluetoothAudioSharingParameters@Internal@Interface@Audio@Bluetooth@Microsoft@winrt@@QEAA@XZ.c)
