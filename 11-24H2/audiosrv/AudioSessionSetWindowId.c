/*
 * XREFs of AudioSessionSetWindowId @ 0x1800C50A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetWindowId(__int64 *a1, unsigned int a2)
{
  ...
  v14 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(v3 + 72) + 408LL))(*(_QWORD *)(v3 + 72), a2);
  v15 = v14;
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionSetWindowId", 2567, v14);
