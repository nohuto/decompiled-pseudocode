/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionary@@QEAAJAEBU_GUID@@GPEBGPEAEI@Z @ 0x18012CF30
 * Callers:
        ...
        size_t Size)
{
  ...
  else
  {
    ...
    if ( Dictionary < 0 )
    {
      ...
      v12 = (unsigned __int8 *)&unk_1801AED6A;
      LODWORD(v25) = 147;
LABEL_19:
