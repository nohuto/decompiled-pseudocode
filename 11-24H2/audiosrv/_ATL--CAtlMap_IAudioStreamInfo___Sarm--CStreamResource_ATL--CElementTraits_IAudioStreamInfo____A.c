/*
 * XREFs of _ATL::CAtlMap_IAudioStreamInfo___Sarm::CStreamResource_ATL::CElementTraits_IAudioStreamInfo____ATL::CElementTraits_Sarm::CStreamResource___::NewNode_::_1_::catch$1 @ 0x1801712E5
 * Callers:
 *     <none>
 * Callees:
