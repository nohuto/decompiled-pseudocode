/*
 * XREFs of AudioSessionGetDisplayName @ 0x180078260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetDisplayName(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 184LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetDisplayName", 1838, v10);
