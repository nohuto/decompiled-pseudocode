/*
 * XREFs of ?append@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAAEAV12@_KG@Z @ 0x1800E7BAC
 * Callers:
...
char **__fastcall std::wstring::append(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a2 > *(_QWORD *)(a1 + 24) - v2 )
    return std::wstring::_Reallocate_grow_by<_lambda_b70241e9b5ebaad244db3e52d52cab17_,unsigned __int64,unsigned short>(
             ...
             a2);
  *(_QWORD *)(a1 + 16) = v2 + a2;
  v6 = std::_String_val<std::_Simple_types<unsigned short>>::_Myptr(a1, a2);
  v7 = (_WORD *)(v6 + 2 * v2);
  if ( v3 )
  {
    for ( i = v3; i; --i )
