/*
 * XREFs of _CAudioSession::AddStream_::_1_::catch$9 @ 0x180169EC4
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::AddStream_::_1_::catch_9(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
