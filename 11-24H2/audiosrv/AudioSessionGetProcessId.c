/*
 * XREFs of AudioSessionGetProcessId @ 0x180078AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetProcessId(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 136LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetProcessId", 1618, v10);
