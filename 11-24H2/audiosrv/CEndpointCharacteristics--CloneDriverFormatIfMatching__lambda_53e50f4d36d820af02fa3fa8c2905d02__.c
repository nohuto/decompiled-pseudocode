/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_53e50f4d36d820af02fa3fa8c2905d02___ @ 0x18012DBDC
 * Callers:
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            if ( v10 >= (unsigned __int64)v12->cbSize + 18
              && lambda_53e50f4d36d820af02fa3fa8c2905d02_::operator()(a2, v12) )
            {
