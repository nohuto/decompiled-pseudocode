/*
 * XREFs of ?_Copy@?$_Func_impl_no_alloc@V_lambda_0a995b81b0906751d8a46178506a57bb_@@X$$V@std@@EEBAPEAV?$_Func_base@X$$V@2@PEAX@Z @ 0x1800D8A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_0a995b81b0906751d8a46178506a57bb_,void,>::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r8
