/*
 * XREFs of ?GetMixFormat@EffectPack@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@@Z @ 0x18002DFA0
 * Callers:
        ...
        struct tWAVEFORMATEX **a4)
{
  ...
  *a4 = 0LL;
  ...
  else
  {
    v28 = (__int128)*a3;
    v10 = 0;
    while ( xmmword_18018FED0[v10] != v28 )
    {
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  ReadFormatProperty(*(_QWORD *)(*((_QWORD *)this + 198) + 72LL), (__int64)&v29, pvar);
  if ( LOWORD(pvar[0]) == 65 )
...
LABEL_44:
  ...
  *(_QWORD *)&v28 = v17;
  FormatProperty = ReadFormatProperty(*(_QWORD *)(*((_QWORD *)this + 198) + 72LL), (__int64)&v29, pvar);
  v19 = FormatProperty;
  if ( FormatProperty < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      ...
      (void *)0x1B44,
      (int)"avcore\\audiocore\\server\\lib\\audioserviceutil\\endpointcharacteristics.cpp",
      (const char *)(unsigned int)FormatProperty);
    if ( v17 )
