/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x18011AF00
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18011AFC0 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
