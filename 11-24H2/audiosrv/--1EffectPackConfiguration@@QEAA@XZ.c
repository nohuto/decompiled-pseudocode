/*
 * XREFs of ??1EffectPackConfiguration@@QEAA@XZ @ 0x180144340
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@UEffectPackConfiguration@@@std@@EEAAXXZ @ 0x1800A1A00 (-_Destroy@-$_Ref_count_obj2@UEffectPackConfiguration@@@std@@EEAAXXZ.c)
 * Callees:
