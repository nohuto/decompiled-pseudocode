/*
 * XREFs of ?Create@?$OutOfProcModuleBase@VSvcHostModule@Internal@Windows@@@Details@WRL@Microsoft@@SAAEAVSvcHostModule@Internal@Windows@@XZ @ 0x18009E010
 * Callers:
 *     _dynamic_initializer_for__Microsoft::WRL::Module_1_Windows::Internal::SvcHostModule_::isInitialized__ @ 0x1800084B0 (_dynamic_initializer_for__Microsoft--WRL--Module_1_Windows--Internal--SvcHostModule_--isInitiali.c)
