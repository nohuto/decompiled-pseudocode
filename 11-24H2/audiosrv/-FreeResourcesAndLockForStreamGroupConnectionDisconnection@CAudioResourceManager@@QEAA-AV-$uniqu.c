        ...
        __int64 a3)
{
  ...
  while ( v7 != v6 )
  {
    ...
    else
    {
      v12 = (_QWORD *)wistd::unique_ptr<void,wil::process_heap_deleter>::unique_ptr<void,wil::process_heap_deleter>(
                        &v25,
                        v7);
      std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_8e7bd4bc8c985177ba327620cf03e9b8___(
        &v26,
        v18,
        *((_QWORD *)&v18 + 1),
        *v12);
    ...
    if ( (_QWORD)v18 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v18, *((__int64 *)&v18 + 1));
  ...
  if ( (_QWORD)v20 )
  {
    std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v20, *((__int64 *)&v20 + 1));
