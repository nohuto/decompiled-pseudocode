/*
 * XREFs of s_apmClearAllPersistedApplicationDefaultEndpoints @ 0x1800FC9F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmClearAllPersistedApplicationDefaultEndpoints(__int64 a1)
{
  ...
  if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    std::unique_ptr<CWatchdogTimer<1>>::reset(&v14, v1);
  }
  else
  {
    ...
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v13, v1);
  }
  v11 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64))(*(_QWORD *)g_PolicyManager + 128LL))(
          g_PolicyManager,
          a1);
