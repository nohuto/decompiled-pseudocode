/*
 * XREFs of ??_D?$basic_stringstream@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAXXZ @ 0x180160190
 * Callers:
 ...
 *     _EndpointInfo::AddExtendedTopologyInfo_::_1_::dtor$3 @ 0x1801728E8 (_EndpointInfo--AddExtendedTopologyInfo_--_1_--dtor$3.c)
 * Callees:
