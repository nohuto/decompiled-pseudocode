/*
 * XREFs of ?SwitchStreamGroupsToNewSaDevice@CAudioResourceManager@@IEAAJPEAUEndpointCharacteristicsDescriptor@@PEAUIDeviceGraphObjectsStore@@PEAUtWAVEFORMATEX@@2_JAEAV?$ComPtr@UISaDeviceProxy@@@WRL@Microsoft@@@Z @ 0x1800BF408
 * Callers:
...
LABEL_3:
  ...
  {
    WPP_SF_P(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, v10, (__int64)(*((_QWORD *)&v24 + 1) - v24) >> 3);
  }
  v13 = v24;
...
LABEL_13:
    ...
    *(_QWORD *)&v31.Data1 = *a7;
    ...
    std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_00a51d6cc5fb17ac86a61babffbe3838___(
      (__int64 *)&v32,
      (_QWORD *)v24,
      *((_QWORD **)&v24 + 1),
      (__int64 *)&v31);
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 30LL, &WPP_98fe4f38b3823383e11c83435e5ea7e3_Traceguids);
    }
...
LABEL_18:
    ...
    *(_DWORD *)v44 = *((_DWORD *)v23 + 2);
    ...
    if ( v21 < 0 )
    {
      ...
      v38 = &v33;
      v39 = &v24;
      lambda_598bf403e3c92612e01cf389e2f05c9b_::operator()((__int64)&v35);
    ...
    *(_QWORD *)&v31.Data1 = v28;
    Microsoft::WRL::ComPtr<IInspectable>::InternalAddRef((__int64 *)&v31);
    std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_381c2507d6c69225d8eae05a4e54a69a___(
      (__int64 *)&v32,
      v24,
      *((__int64 *)&v24 + 1),
      (__int64 *)&v31);
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL, &WPP_98fe4f38b3823383e11c83435e5ea7e3_Traceguids);
    }
    Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(&v28);
    std::vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>::~vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>((__int64)&v33);
    wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>((void **)&v29);
