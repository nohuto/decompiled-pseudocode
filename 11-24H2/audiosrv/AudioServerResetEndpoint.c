/*
 * XREFs of AudioServerResetEndpoint @ 0x180084F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerResetEndpoint(CVADServer *a1, unsigned __int64 a2)
{
  void *v4; // rax
  void *v5; // rsi
  ...
  v10 = CVADServer::ResetEndpoint(a1, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerResetEndpoint", 3105, v10);
