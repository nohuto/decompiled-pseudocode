/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@U_GUID@@W4ValidEffectPackConfigurationSettings@@V?$_Uhash_compare@U_GUID@@U?$hash@U_GUID@@@std@@U?$equal_to@U_GUID@@@3@@std@@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x18009D8A8
 * Callers:
 *     __dynamic_initializer_for__s_validSettingsForSchema___::_1_::dtor$0 @ 0x180172019 (__dynamic_initializer_for__s_validSettingsForSchema___--_1_--dtor$0.c)
 *     _dynamic_atexit_destructor_for__s_validSettingsForSchema__ @ 0x180173460 (_dynamic_atexit_destructor_for__s_validSettingsForSchema__.c)
 * Callees:
