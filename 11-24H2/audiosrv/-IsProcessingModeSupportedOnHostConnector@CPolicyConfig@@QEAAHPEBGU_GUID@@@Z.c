/*
 * XREFs of ?IsProcessingModeSupportedOnHostConnector@CPolicyConfig@@QEAAHPEBGU_GUID@@@Z @ 0x1801064B8
 * Callers:
 *     s_IsProcessingModeSupportedOnHostConnector @ 0x180109140 (s_IsProcessingModeSupportedOnHostConnector.c)
 * Callees:
