/*
 * XREFs of ??0?$wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@details@wil@@QEAA@$$QEAV?$function@$$A6AXAEBW4_PO_STANDBY_AUDIO_POLICY@@@Z@wistd@@@Z @ 0x1800B64EC
 * Callers:
...
_QWORD *__fastcall wil::details::wnf_subscription_state<enum _PO_STANDBY_AUDIO_POLICY>::wnf_subscription_state<enum _PO_STANDBY_AUDIO_POLICY>(
        _QWORD *a1,
        __int64 a2)
{
  a1[1] = 0LL;
