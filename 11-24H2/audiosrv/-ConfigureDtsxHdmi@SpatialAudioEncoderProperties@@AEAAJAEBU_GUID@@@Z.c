/*
 * XREFs of ?ConfigureDtsxHdmi@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180129F8C
 * Callers:
...
__int64 __fastcall SpatialAudioEncoderProperties::ConfigureDtsxHdmi(
        ...
        struct _GUID *a2)
{
  ...
  *(_DWORD *)((char *)this + 838) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v16 = 0;
    v15 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_HDMI_SPATIAL_ENCODER, &v16, &v15) >= 0 )
    {
      *((_DWORD *)this + 179) = v16;
      *((_WORD *)this + 362) = v15;
    }
