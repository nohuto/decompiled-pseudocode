/*
 * XREFs of ?DoSecondaryProfileRenderStreamGroupsExist@CBtAudioResourceManagerBase@@IEAA_NPEAVCEndpointStore@@@Z @ 0x1800DC870
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    for ( i = (_QWORD *)v14; i != v7; ++i )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        {
          v11 = *(unsigned __int8 (__fastcall **)(CBtAudioResourceManagerBase *, __int128 *))(*(_QWORD *)this + 152LL);
      ...
      if ( (_QWORD)v12 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v12, *((__int64 *)&v12 + 1));
        std::_Deallocate<16,0>((char *)v12, (const struct std::nothrow_t *)((v13 - v12) & 0xFFFFFFFFFFFFFFF8uLL));
      }
    }
  }
