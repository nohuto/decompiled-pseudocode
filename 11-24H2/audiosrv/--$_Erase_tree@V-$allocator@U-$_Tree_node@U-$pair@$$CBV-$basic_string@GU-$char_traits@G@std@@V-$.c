 ...
 *     _dynamic_atexit_destructor_for__AECLoopbackSelectionModeStringValues__ @ 0x180173130 (_dynamic_atexit_destructor_for__AECLoopbackSelectionModeStringValues__.c)
 * Callees:
...
void __fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>(
        __int64 a1,
        __int64 a2,
        char *a3)
{
  ...
  while ( !v3[25] )
  {
    ...
    v6 = v3;
    v3 = *(char **)v3;
    std::wstring::_Tidy_deallocate((__int64)(v6 + 32), v7);
