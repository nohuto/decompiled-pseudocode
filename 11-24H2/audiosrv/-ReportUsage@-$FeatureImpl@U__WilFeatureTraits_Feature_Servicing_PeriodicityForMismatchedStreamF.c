/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_PeriodicityForMismatchedStreamFormats@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800BEF40
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_PeriodicityForMismatchedStreamFormats>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v11 = a4;
  v5 = a2;
  LODWORD(v6) = *(_DWORD *)Feature_Servicing_PeriodicityForMismatchedStreamFormats__descriptor;
  if ( (*(_DWORD *)Feature_Servicing_PeriodicityForMismatchedStreamFormats__descriptor & 4) == 0 )
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_PeriodicityForMismatchedStreamFormats>::GetCachedFeatureEnabledState(
            a1,
            v8);
    v11 = v6;
  }
