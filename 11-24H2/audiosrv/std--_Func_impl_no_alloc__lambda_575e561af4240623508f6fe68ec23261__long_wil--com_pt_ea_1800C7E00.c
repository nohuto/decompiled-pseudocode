/*
 * XREFs of std::_Func_impl_no_alloc__lambda_575e561af4240623508f6fe68ec23261__long_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&_::_Do_call @ 0x1800C7E00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  CAudioSessionManager::Disconnect(*(struct _RTL_CRITICAL_SECTION **)(*(_QWORD *)a2 + 96LL), 1LL, 1);
