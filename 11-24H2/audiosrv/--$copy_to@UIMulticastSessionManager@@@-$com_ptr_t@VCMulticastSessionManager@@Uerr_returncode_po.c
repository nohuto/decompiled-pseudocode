/*
 * XREFs of ??$copy_to@UIMulticastSessionManager@@@?$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAUIMulticastSessionManager@@@Z @ 0x1800FF798
 * Callers:
