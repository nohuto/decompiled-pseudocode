/*
 * XREFs of std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_d9d84050caa5b53617dd5fa562414e1b___ @ 0x1800B60B4
 * Callers:
...
_QWORD *__fastcall std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_d9d84050caa5b53617dd5fa562414e1b___(
        _QWORD *a1,
        _QWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
  ...
  for ( i = a2; i != a3; ++i )
  {
    ...
    if ( v10 < 0 )
      AudSrvTraceLoggingErrorHelper(
        "CAudioResourceManager::GetSaDeviceForSharedStream::<lambda_d9d84050caa5b53617dd5fa562414e1b>::operator ()",
        2368,
        v10);
  }
  result = a1;
