/*
 * XREFs of ?LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z @ 0x18001EE5C
 * Callers:
 ...
 *     StringCopyWorkerW @ 0x18006B00C (StringCopyWorkerW.c)
 ...
 *     StringLengthWorkerW_0 @ 0x1800A3100 (StringLengthWorkerW_0.c)
