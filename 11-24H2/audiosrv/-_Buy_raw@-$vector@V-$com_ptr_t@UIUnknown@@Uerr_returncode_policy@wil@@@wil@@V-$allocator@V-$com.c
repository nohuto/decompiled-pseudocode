/*
 * XREFs of ?_Buy_raw@?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEAAX_K@Z @ 0x1800A2244
 * Callers:
...
__int64 __fastcall std::vector<wil::com_ptr_t<IUnknown,wil::err_returncode_policy>>::_Buy_raw(__int64 *a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 result; // rax
  ...
  v6 = a2;
  v4 = std::_Allocate_at_least_helper<std::allocator<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>>(a1, &v6);
  *a1 = v4;
  a1[1] = v4;
  result = v4 + 8 * a2;
  a1[2] = result;
