/*
 * XREFs of ?CreateStreamGroup@CDeviceGraphManager@@UEAAJPEAUEndpointCharacteristicsDescriptor@@PEAUIDeviceGraphObjectsStore@@PEAUStreamGroupParams@@KPEAUMODE_PARAMS@@PEAPEAUIStreamGroupProxy@@@Z @ 0x180058DA0
 * Callers:
        ...
        struct IStreamGroupProxy **a7)
{
  ...
  const struct StreamGroupParams *v42; // [rsp+120h] [rbp+67h] BYREF
    ...
    *((_DWORD *)v14 + 20) = *((_BYTE *)a4 + 49) != 0 ? 3 : 0;
    ...
    else
    {
      ...
      v21 = Microsoft::WRL::Details::MakeAndInitialize<CSharedStreamGroupProxy,IStreamGroupProxy,EndpointCharacteristicsDescriptor * &,StreamGroupParams * &,ATL::CComHeapPtr<STREAM_GROUP_DESCRIPTOR> &,unsigned long &,IAudioModeEffectsWatcher *>(
              ...
              &v40,
              &v42,
              (struct STREAM_GROUP_DESCRIPTOR **)&a7,
              &a5,
              &a6);
    }
    v15 = v21;
    ...
    if ( v15 >= 0 )
    {
      ...
      v26 = Microsoft::WRL::Details::ComPtrRef<Microsoft::WRL::WeakRef>::operator Microsoft::WRL::WeakRef *(&a6);
