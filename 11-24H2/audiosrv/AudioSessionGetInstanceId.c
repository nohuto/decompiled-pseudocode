/*
 * XREFs of AudioSessionGetInstanceId @ 0x1800C41D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetInstanceId(__int64 *a1, __int64 a2)
{
  ...
  v14 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 120LL))(v3, a2);
  v15 = v14;
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetInstanceId", 1540, v14);
