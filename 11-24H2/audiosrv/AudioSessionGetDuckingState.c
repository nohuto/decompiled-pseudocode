/*
 * XREFs of AudioSessionGetDuckingState @ 0x1800C40A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetDuckingState(__int64 *a1, __int64 a2)
{
    ...
    if ( v4 )
    {
      ...
      v4 = CWatchdogTimer<1>::CWatchdogTimer<1>(
             ...
             *((struct _TP_TIMER **)v8 + 1),
             v7,
             (struct _TP_TIMER *)L"AudioSessionGetDuckingState",
             pftDueTime);
    }
  ...
  v14 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 264LL))(v3, a2);
  v15 = v14;
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetDuckingState", 2529, v14);
