/*
 * XREFs of ??$_Construct_in_place@VCCaptureReference@@PEAVCCaptureNotifier@@AEAKAEA_NAEA_N@std@@YAXAEAVCCaptureReference@@$$QEAPEAVCCaptureNotifier@@AEAKAEA_N3@Z @ 0x1800A031C
 * Callers:
