/*
 * XREFs of ?InitializeRegistryWatcher@CMonitorManager@@AEAAJXZ @ 0x18011A2AC
 * Callers:
...
__int64 __fastcall CMonitorManager::InitializeRegistryWatcher(CMonitorManager *this)
{
  ...
  *phkResult = 0LL;
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids, 0);
    }
    if ( v6 > 0 )
  ...
  else
  {
    ...
    if ( !*((_QWORD *)this + 45) )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids);
      }
