/*
 * XREFs of ?_Xran@?$_String_val@U?$_Simple_types@G@std@@@std@@SAXXZ @ 0x1800EFB80
 * Callers:
...
void std::_String_val<std::_Simple_types<unsigned short>>::_Xran()
{
  std::_Xout_of_range("invalid string position");
  __debugbreak();
  JUMPOUT(0x1800EFB98LL);
}
