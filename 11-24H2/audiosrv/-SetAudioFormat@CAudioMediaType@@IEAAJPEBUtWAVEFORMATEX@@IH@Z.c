/*
 * XREFs of ?SetAudioFormat@CAudioMediaType@@IEAAJPEBUtWAVEFORMATEX@@IH@Z @ 0x1800A6BC0
 * Callers:
 ...
 *     ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1800A6D04 (-ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z.c)
