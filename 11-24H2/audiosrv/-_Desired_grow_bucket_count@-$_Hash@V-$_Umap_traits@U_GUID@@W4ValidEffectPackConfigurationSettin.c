/*
 * XREFs of ?_Desired_grow_bucket_count@?$_Hash@V?$_Umap_traits@U_GUID@@W4ValidEffectPackConfigurationSettings@@V?$_Uhash_compare@U_GUID@@U?$hash@U_GUID@@@std@@U?$equal_to@U_GUID@@@3@@std@@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@4@$0A@@std@@@std@@IEBA_K_K@Z @ 0x180148038
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( a2 < 0 )
    ...
    v2 = (float)(int)a2;
  v3 = o_ceilf_0(v2 / *(float *)&dword_1801DCF40);
  v4 = 0LL;
  if ( v3 >= 9.223372e18 )
  {
    v3 = v3 - 9.223372e18;
  ...
  if ( v5 > 8 )
    v6 = v5;
  result = qword_1801DCF78;
  if ( qword_1801DCF78 < v6 )
  {
    if ( (unsigned __int64)qword_1801DCF78 < 0x200 && 8 * qword_1801DCF78 >= v6 )
      return 8 * qword_1801DCF78;
    return v6;
  }
  return result;
}
