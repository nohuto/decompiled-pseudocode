/*
 * XREFs of ?GetActiveRenderEndpointWithFallbackToDefault@@YAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEAPEAGPEA_N@Z @ 0x1800F6200
 * Callers:
...
__int64 __fastcall GetActiveRenderEndpointWithFallbackToDefault(unsigned int a1, unsigned __int16 **a2, bool *a3)
{
  ...
  WCHAR v29[2044]; // [rsp+68h] [rbp-98h] BYREF
...
LABEL_22:
    ...
    if ( v28 )
    {
      while ( CompareStringOrdinal(lpString1, -1, &v29[56 * v18], -1, 1) != 2 )
      {
        if ( ++v18 >= v28 )
          goto LABEL_18;
      }
      v20 = (unsigned __int16 *)lpString1;
      lpString1 = 0LL;
      *a2 = v20;
    }
    else
    {
LABEL_18:
      v19 = _AllocString<CTCoAllocPolicy>(v17, v16, v29, a2);
      v11 = v19;
      if ( v19 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
