/*
 * XREFs of ??$_Construct_in_place@VCPlaybackReference@@PEAVCPlaybackNotifier@@AEAPEBG@std@@YAXAEAVCPlaybackReference@@$$QEAPEAVCPlaybackNotifier@@AEAPEBG@Z @ 0x1800102C0
 * Callers:
