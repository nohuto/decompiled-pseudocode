/*
 * XREFs of ?AddStreamGroup@CDeviceGraphObjectsStore@@UEAAJAEAVWeakRef@WRL@Microsoft@@@Z @ 0x180059540
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::WRL::WeakRef *a2)
{
  ...
  {
    std::_Construct_in_place<Microsoft::WRL::WeakRef,Microsoft::WRL::WeakRef const &>(*((_QWORD *)v6 + 1), a2);
    *((_QWORD *)v6 + 1) += 8LL;
  }
  else
  {
