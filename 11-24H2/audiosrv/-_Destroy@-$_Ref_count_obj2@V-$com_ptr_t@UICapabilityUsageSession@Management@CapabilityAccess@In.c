/*
 * XREFs of ?_Destroy@?$_Ref_count_obj2@V?$com_ptr_t@UICapabilityUsageSession@Management@CapabilityAccess@Internal@Windows@@Uerr_returncode_policy@wil@@@wil@@@std@@EEAAXXZ @ 0x18010A3F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
