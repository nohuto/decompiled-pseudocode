/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_56664216@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CF148
 * Callers:
        ...
        __int64 a4)
{
  ...
  v5 = a3;
  v6 = a2;
  v7 = *(_DWORD *)Feature_56664216__descriptor;
  if ( (*(_DWORD *)Feature_56664216__descriptor & 4) == 0 )
  {
    v12 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_56664216>::GetCachedFeatureEnabledState(a1, v9);
    v7 = v12;
  }
  v10 = 0;
  v11 = 2;
