/*
 * XREFs of ?VolumeStepDown@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAJPEBU_GUID@@PEAH@Z @ 0x1800D87E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::VolumeStepDown(
        ...
        int *a3)
{
  ...
  v9[0] = 0LL;
  Owner = BluetoothControls::CBluetoothVolumeInterceptor::TryGetOwner((__int64)this, v9);
  v6 = Owner;
  if ( Owner >= 0 )
  {
    v11 = 0LL;
    TargetedVolumeControl = BluetoothControls::BluetoothVolumeAndMute::TryGetTargetedVolumeControl((__int64)v9[0], &v11);
    v6 = TargetedVolumeControl;
    if ( TargetedVolumeControl >= 0 )
      v6 = (*(__int64 (__fastcall **)(__int64, const struct _GUID *, int *))(*(_QWORD *)v11 + 200LL))(v11, a2, a3);
    else
