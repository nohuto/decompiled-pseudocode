/*
 * XREFs of ?SetChannelVolumeLevelScalar@CVolumeControlBase@@UEAAJIMPEBU_GUID@@PEAH@Z @ 0x1801152A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  *(_QWORD *)v20 = v8;
  if ( (unsigned int)v6 < *((_DWORD *)this + 29) )
  {
    ...
    if ( v15 >= 0 )
    {
      v16 = (*(__int64 (__fastcall **)(CVolumeControlBase *, _QWORD))(*(_QWORD *)this + 248LL))(this, (unsigned int)v6);
      v9 = v16;
      if ( v16 >= 0 )
      {
