/*
 * XREFs of AudioSessionGetChannelVolume @ 0x180078120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetChannelVolume(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  v12 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v5 + 336LL))(v5, a2, a3);
  v13 = v12;
  if ( v12 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetChannelVolume", 2227, v12);
