/*
 * XREFs of ?InitializeSpatialAudioFormatSubtypeInfoArray@@YAJPEAUSpatialAudioFormatSubtypeInfo@@H_N@Z @ 0x180049AF0
 * Callers:
 ...
 *     ?make_cotaskmem_string_nothrow@wil@@YA@PEBG_K@Z @ 0x180019DA0 (-make_cotaskmem_string_nothrow@wil@@YA@PEBG_K@Z.c)
 ...
 *     ??$?0$0CO@@StringReference@Internal@Windows@@QEAA@AEAY0CO@$$CBG@Z @ 0x18009FFEC (--$-0$0CO@@StringReference@Internal@Windows@@QEAA@AEAY0CO@$$CBG@Z.c)
        ...
        const unsigned __int16 *a2)
{
  ...
  else
  {
    ...
    if ( (struct SpatialAudioFormatSubtypeInfo *)((char *)a1 + 64) != cotaskmem_string_nothrow )
    {
