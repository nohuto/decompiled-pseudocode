/*
 * XREFs of ??1?$vector@V?$function@$$A6AX_N@Z@std@@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@QEAA@XZ @ 0x1800DAF24
 * Callers:
 *     _CBtAudioResourceManagerBase::NotifyStreamChange_::_1_::dtor$0 @ 0x18016E98C (_CBtAudioResourceManagerBase--NotifyStreamChange_--_1_--dtor$0.c)
 * Callees:
