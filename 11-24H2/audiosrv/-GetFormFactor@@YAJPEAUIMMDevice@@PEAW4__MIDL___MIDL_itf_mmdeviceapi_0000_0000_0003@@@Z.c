/*
 * XREFs of ?GetFormFactor@@YAJPEAUIMMDevice@@PEAW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@@Z @ 0x1801132F8
 * Callers:
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( v3 < 0
    || (v3 = (*(__int64 (__fastcall **)(__int64, const PROPERTYKEY *, PROPVARIANT *))(*(_QWORD *)v7 + 40LL))(
        ...
        v3 < 0) )
  {
    AudSrvTraceLoggingErrorHelper("GetFormFactor", 57, v3);
    v3 = 0;
  }
  else
  {
