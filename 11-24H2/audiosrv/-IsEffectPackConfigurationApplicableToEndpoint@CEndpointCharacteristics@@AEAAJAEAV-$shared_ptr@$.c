/*
 * XREFs of ?IsEffectPackConfigurationApplicableToEndpoint@CEndpointCharacteristics@@AEAAJAEAV?$shared_ptr@$$CBUEffectPackConfiguration@@@std@@PEA_N@Z @ 0x180135350
 * Callers:
 ...
 *     _lambda_d93e4fa3a19ba608bff96419e5445341_::operator() @ 0x180132948 (_lambda_d93e4fa3a19ba608bff96419e5445341_--operator().c)
...
LABEL_52:
    v27 = 0;
    lambda_d93e4fa3a19ba608bff96419e5445341_::operator()((__int64)v26);
    return 0LL;
  }
  v7 = -2147418113;
