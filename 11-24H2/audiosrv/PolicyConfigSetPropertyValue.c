/*
 * XREFs of PolicyConfigSetPropertyValue @ 0x18007F410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigSetPropertyValue(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    if ( v9 )
    {
      ...
      v5 = CWatchdogTimer<1>::CWatchdogTimer<1>(v9, pftDueTime);
    }
  ...
  else
  {
    ...
    if ( v11 )
    {
      ...
      AudioSrvTelemetryProvider::Instance();
      v5 = CWatchdogTimer_Old<1>::CWatchdogTimer_Old<1>(v11, v12);
    }
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v15, v5);
  }
  v13 = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64, _QWORD, __int64, __int64))(*(_QWORD *)g_PolicyConfig + 96LL))(
          g_PolicyConfig,
          a2,
          a3,
          a4,
