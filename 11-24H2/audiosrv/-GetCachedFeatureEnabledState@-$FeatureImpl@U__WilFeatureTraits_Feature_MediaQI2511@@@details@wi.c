/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2511@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800AE5E8
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)Feature_MediaQI2511__descriptor;
  if ( (v3 & 6) != 6 )
  {
    ...
    v15 = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2511>::GetCurrentFeatureEnabledState(v6, &v16, &v15);
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i | 0x40000;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_MediaQI2511__descriptor, v10, i);
      if ( i == v11 )
        break;
    }
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (Source[1] = 0,
            Source[0] = 3,
            v14 = Feature_MediaQI2511__descriptor,
            !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_1801DA6A8, Source)) )
      {
        _InterlockedAnd((volatile signed __int32 *)Feature_MediaQI2511__descriptor, 0xFFFFFFFB);
      }
