/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x1800A7F2E
 * Callers:
 *     __imp_load_GetStagedPackageOrigin @ 0x1800A7FAD (__imp_load_GetStagedPackageOrigin.c)
 * Callees:
