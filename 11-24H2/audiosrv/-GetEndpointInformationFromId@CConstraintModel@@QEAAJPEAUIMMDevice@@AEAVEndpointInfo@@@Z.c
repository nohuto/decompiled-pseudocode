/*
 * XREFs of ?GetEndpointInformationFromId@CConstraintModel@@QEAAJPEAUIMMDevice@@AEAVEndpointInfo@@@Z @ 0x180160D34
 * Callers:
...
LABEL_45:
  ...
  while ( 1 )
  {
    ...
    v24 = EndpointInfo::AddExtendedTopologyInfo((__int64 *)a3, (__int64)v41, v39, v37);
    if ( v24 < 0 )
    {
      v26 = 724LL;
      goto LABEL_52;
