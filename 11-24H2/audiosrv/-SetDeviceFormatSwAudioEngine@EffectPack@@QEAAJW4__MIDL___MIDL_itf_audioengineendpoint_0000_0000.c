/*
 * XREFs of ?SetDeviceFormatSwAudioEngine@EffectPack@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@@Z @ 0x18003681C
 * Callers:
 ...
 *     ?DeviceInUse@AEError@@YA_NJ@Z @ 0x180036DA8 (-DeviceInUse@AEError@@YA_NJ@Z.c)
        ...
        const struct tWAVEFORMATEX *a3)
{
  ...
  if ( a3 )
  {
    ...
    *(_QWORD *)v29.Data4 = 0LL;
    ...
    v23 = lambda_82c9212e29ceb5f8e3f8d325d4b387fa_::_lambda_82c9212e29ceb5f8e3f8d325d4b387fa_(v33, this, &v37, &pv);
    wil::scope_exit__lambda_82c9212e29ceb5f8e3f8d325d4b387fa___(v34, v23);
    ...
    if ( v24 < 0 )
    {
      ...
      wil::details::lambda_call__lambda_7b68068f878ba9e113ab760fd9bf92b1___::_lambda_call__lambda_7b68068f878ba9e113ab760fd9bf92b1___(v34);
      wistd::unique_ptr<KSMULTIPLE_ITEM,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>::reset(
        &pv,
        0LL);
      CEndpointCharacteristics::ClearMixFormatCache(this[198], 0LL);
