/*
 * XREFs of ?_Tidy@?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@AEAAXXZ @ 0x180017248
 * Callers:
 *     ??1CBaseStreamGroupProxy@@MEAA@XZ @ 0x180016A5C (--1CBaseStreamGroupProxy@@MEAA@XZ.c)
 *     ??1?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x1800742B0 (--1-$vector@VWeakRef@WRL@Microsoft@@V-$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@QEAA@XZ.c)
 ...
 *     ??1CPolicyConfig@@UEAA@XZ @ 0x1800CBAE4 (--1CPolicyConfig@@UEAA@XZ.c)
