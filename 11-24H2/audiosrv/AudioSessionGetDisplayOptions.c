/*
 * XREFs of AudioSessionGetDisplayOptions @ 0x180078390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetDisplayOptions(__int64 *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    if ( v5 )
    {
      ...
      v3 = CWatchdogTimer<1>::CWatchdogTimer<1>(v5, pftDueTime);
    }
  ...
  else
  {
    ...
    if ( v7 )
    {
      ...
      AudioSrvTelemetryProvider::Instance();
      v3 = CWatchdogTimer_Old<1>::CWatchdogTimer_Old<1>(v7, v8);
    }
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v11, v3);
  }
  v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 176LL))(v2, a2);
