/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIUnknown@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x18000F870
 * Callers:
 ...
 *     ??1?$ComPtr@VCEndpointStore@@@WRL@Microsoft@@QEAA@XZ @ 0x1800D24CC (--1-$ComPtr@VCEndpointStore@@@WRL@Microsoft@@QEAA@XZ.c)
