/*
 * XREFs of ?AllowOffloadStreamCreation@CBtAudioResourceManagerBase@@UEAA_NXZ @ 0x1800DB1E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CBtAudioResourceManagerBase::AllowOffloadStreamCreation(struct _RTL_CRITICAL_SECTION *this)
{
  ...
  CBtAudioResourceManagerBase *v8; // rcx
  const unsigned __int16 *OwningThread; // rdx
  struct CEndpointStore *v11; // rbx
  struct CEndpointStore *v12; // [rsp+50h] [rbp+28h] BYREF
  struct _RTL_CRITICAL_SECTION *v13; // [rsp+58h] [rbp+30h] BYREF
  struct _RTL_CRITICAL_SECTION *v14; // [rsp+60h] [rbp+38h] BYREF
  struct _RTL_CRITICAL_SECTION *v15; // [rsp+68h] [rbp+40h] BYREF
  ...
  {
    v12 = 0LL;
    if ( (int)CEndpointStoreCache::GetEndpointStore(v3, LockSemaphore, &v12) >= 0 )
    {
      v6 = v12;
      v7 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(_QWORD, struct _RTL_CRITICAL_SECTION **))(**((_QWORD **)v12 + 13) + 128LL))(
                                              *((_QWORD *)v12 + 13),
                                              &v14);
      ...
      if ( CBtAudioResourceManagerBase::DoMicrophoneSaDevicesExist(v8, v6) )
      {
  ...
  v12 = 0LL;
  if ( (int)CEndpointStoreCache::GetEndpointStore(v3, OwningThread, &v12) < 0 )
    goto LABEL_10;
  v11 = v12;
