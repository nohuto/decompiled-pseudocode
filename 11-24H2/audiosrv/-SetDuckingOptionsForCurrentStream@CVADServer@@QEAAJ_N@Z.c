/*
 * XREFs of ?SetDuckingOptionsForCurrentStream@CVADServer@@QEAAJ_N@Z @ 0x18010E1C4
 * Callers:
...
__int64 __fastcall CVADServer::SetDuckingOptionsForCurrentStream(struct _RTL_CRITICAL_SECTION *this, char a2)
{
  ...
  const WCHAR *v23; // [rsp+50h] [rbp-10h] BYREF
...
LABEL_5:
  ...
  if ( v8(OwningThread + 1, &v28) >= 0 )
  {
    ...
    if ( *v10 > 4u && tlgKeywordOn(*((_QWORD *)v9 + 1), 2LL) )
    {
      ...
      v23 = (const WCHAR *)(*(__int64 (__fastcall **)(__int64))(*((_QWORD *)this[3].LockSemaphore + 1) + 64LL))((__int64)this[3].LockSemaphore + 8);
