/*
 * XREFs of _lambda_73ada75428367bd29c5c2dda60bd7903_::operator() @ 0x1800B72B0
 * Callers:
...
__int64 __fastcall lambda_73ada75428367bd29c5c2dda60bd7903_::operator()(__int64 a1)
{
  unsigned int v2; // edi
