/*
 * XREFs of _CAudioSession::ParseStreamSwitchId_::_1_::dtor$1 @ 0x18016C1F6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSession::ParseStreamSwitchId_::_1_::dtor_1(__int64 a1, __int64 a2)
{
