/*
 * XREFs of ??1?$CAtlList@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEAA@XZ @ 0x18006F394
 * Callers:
 *     _DynamicAudioEndpointManager::GetDefaultAudioEndpoint_::_1_::dtor$0_0 @ 0x1801714F1 (_DynamicAudioEndpointManager--GetDefaultAudioEndpoint_--_1_--dtor$0_0.c)
 * Callees:
 *     <none>
 */
