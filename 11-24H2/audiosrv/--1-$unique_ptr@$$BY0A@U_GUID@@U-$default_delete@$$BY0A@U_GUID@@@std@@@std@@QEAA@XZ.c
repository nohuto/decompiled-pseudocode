/*
 * XREFs of ??1?$unique_ptr@$$BY0A@U_GUID@@U?$default_delete@$$BY0A@U_GUID@@@std@@@std@@QEAA@XZ @ 0x1800A31D8
 * Callers:
 ...
 *     _CAudioStream::GetDiscoveredEffects_::_1_::dtor$0 @ 0x18016C6ED (_CAudioStream--GetDiscoveredEffects_--_1_--dtor$0.c)
 * Callees:
