/*
 * XREFs of ?OnDisplayNameChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@PEBGPEBU_GUID@@@Z @ 0x180073A50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v7 )
  {
    ...
    if ( v13 )
    {
      ...
      *(GUID *)(v14 + 7) = v16;
      v14[12] = v11;
      v14[13] = v10 + 72;
      StringCbCopyW((char *)v14 + 72, v10, *(char **)(*((_QWORD *)this + 9) + 656LL));
      StringCbCopyW((char *)v14 + v14[13], v11, a3);
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_qd(*((_QWORD *)WPP_GLOBAL_Control + 2), 19LL, &WPP_ab1375f163c73c4b99e57586ff560771_Traceguids, v14);
      }
      MediaEvent = GenerateMediaEvent(v14, *((unsigned int *)this + 20), v17);
      operator delete(v14);
      if ( MediaEvent < 0 )
