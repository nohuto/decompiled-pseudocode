/*
 * XREFs of AudioSessionSetDisplayName @ 0x180079560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetDisplayName(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  v12 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v5 + 192LL))(v5, a2, a3);
  v13 = v12;
  if ( v12 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionSetDisplayName", 1857, v12);
