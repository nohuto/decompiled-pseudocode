/*
 * XREFs of AudioSessionGetIsComms @ 0x180078840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetIsComms(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 272LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetIsComms", 2548, v10);
