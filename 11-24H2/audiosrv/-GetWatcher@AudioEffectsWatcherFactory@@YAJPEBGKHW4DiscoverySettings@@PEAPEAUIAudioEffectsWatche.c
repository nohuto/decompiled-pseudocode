/*
 * XREFs of ?GetWatcher@AudioEffectsWatcherFactory@@YAJPEBGKHW4DiscoverySettings@@PEAPEAUIAudioEffectsWatcher@@@Z @ 0x1800B3388
 * Callers:
...
LABEL_12:
  ...
  v16 = a5;
  a5 = 0LL;
  wil::com_ptr_t<IVolumeStrip,wil::err_returncode_policy>::attach((__int64 *)&v19, (__int64)v16);
  Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(&v20);
  Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease((__int64 *)&a5);
LABEL_16:
