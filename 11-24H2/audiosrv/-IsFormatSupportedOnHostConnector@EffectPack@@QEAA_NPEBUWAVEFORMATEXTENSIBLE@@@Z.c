/*
 * XREFs of ?IsFormatSupportedOnHostConnector@EffectPack@@QEAA_NPEBUWAVEFORMATEXTENSIBLE@@@Z @ 0x18002C520
 * Callers:
 *     ?IsFormatSupportedOnHostConnector@AudioEndpointInfo@@UEAA_NPEBUWAVEFORMATEXTENSIBLE@@@Z @ 0x18013DDC0 (-IsFormatSupportedOnHostConnector@AudioEndpointInfo@@UEAA_NPEBUWAVEFORMATEXTENSIBLE@@@Z.c)
 * Callees:
