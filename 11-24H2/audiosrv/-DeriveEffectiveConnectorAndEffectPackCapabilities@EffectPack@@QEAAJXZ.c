/*
 * XREFs of ?DeriveEffectiveConnectorAndEffectPackCapabilities@EffectPack@@QEAAJXZ @ 0x1800A0DA4
 * Callers:
 ...
 *     ?MarkDescriptorsAsInitialized@EffectPack@@QEAAXXZ @ 0x1800356F4 (-MarkDescriptorsAsInitialized@EffectPack@@QEAAXXZ.c)
