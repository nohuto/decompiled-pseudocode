/*
 * XREFs of ?FindPreferredStreamGroup@CDeviceGraphObjectsStore@@UEAAJPEBUStreamGroupParams@@PEAPEAUIStreamGroupProxy@@@Z @ 0x1800F9BB0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( StreamGroups >= 0 )
    {
      ...
      for ( i = 1LL; i < (__int64)(*(_QWORD *)&v22[2] - (_QWORD)v13) >> 3; ++i )
      {
        ...
        if ( 0xCCCCCCCCCCCCCCCDuLL * ((__int64)(v18[1] - *v18) >> 2) < v16 )
        {
          ...
          v20 = (_QWORD *)(*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)&v13[8 * i] + 416LL))(*(_QWORD *)&v13[8 * i]);
      ...
      *a3 = v14;
      ...
      if ( v13 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
          (__int64)v13,
          *(__int64 *)&v22[2]);
        std::_Deallocate<16,0>(v13, (const struct std::nothrow_t *)((v23 - (_QWORD)v13) & 0xFFFFFFFFFFFFFFF8uLL));
      }
