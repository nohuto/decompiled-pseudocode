/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_0d7505061d5fe897f28fc80eab3d553f_@@X_N@std@@EEAAX$$QEA_N@Z @ 0x1800D8CF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc<_lambda_0d7505061d5fe897f28fc80eab3d553f_,void,bool>::_Do_call(
        __int64 a1,
        char *a2)
{
  char v3; // di
