/*
 * XREFs of ??$_Destroy_range@V?$allocator@ULockedListEntry@?$CLockedList_UniqueValuesOnly@V?$CComPtr@UISessionInternalEvents@@@ATL@@$0A@@@@std@@@std@@YAXPEAULockedListEntry@?$CLockedList_UniqueValuesOnly@V?$CComPtr@UISessionInternalEvents@@@ATL@@$0A@@@QEAU12@AEAV?$allocator@ULockedListEntry@?$CLockedList_UniqueValuesOnly@V?$CComPtr@UISessionInternalEvents@@@ATL@@$0A@@@@0@@Z @ 0x180025924
 * Callers:
 ...
 *     _std::vector_CLockedList_UniqueValuesOnly_ATL::CComPtr_ISessionInternalEvents__0_::LockedListEntry_std::allocator_CLockedList_UniqueValuesOnly_ATL::CComPtr_ISessionInternalEvents__0_::LockedListEntry___::_Emplace_reallocate_ATL::CComPtr_ISessionInternalEvents__&_int__::_1_::catch$0 @ 0x18016B016 (_std--vector_CLockedList_UniqueValuesOnly_ATL--CComPtr_ISessionInternalEvents__0_--LockedListEnt.c)
 * Callees:
