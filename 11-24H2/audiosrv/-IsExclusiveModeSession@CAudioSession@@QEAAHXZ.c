/*
 * XREFs of ?IsExclusiveModeSession@CAudioSession@@QEAAHXZ @ 0x1800C21BC
 * Callers:
...
__int64 __fastcall CAudioSession::IsExclusiveModeSession(CAudioSession *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x59u, (__int64)&WPP_ea93f1868512325b454513e390c361b8_Traceguids, 0LL);
  }
