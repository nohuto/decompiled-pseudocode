 ...
 *     ??0hstring@param@winrt@@QEAA@AEBV?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x1800E3DF8 (--0hstring@param@winrt@@QEAA@AEBV-$basic_string_view@GU-$char_traits@G@std@@@std@@@Z.c)
 *     ??1?$IVectorView@Uguid@winrt@@@Collections@Foundation@Windows@winrt@@QEAA@XZ @ 0x1800E3FE4 (--1-$IVectorView@Uguid@winrt@@@Collections@Foundation@Windows@winrt@@QEAA@XZ.c)
        ...
        void (__fastcall **a3)(__int64, __int64 *))
{
  ...
  v14 = a1;
  v10[0] = L"Microsoft.Bluetooth.Audio.Interface.Internal.BluetoothAudioSharingParameters";
  v10[1] = 76LL;
  ...
  if ( v7 && (v8 = 0LL, (**v7)(v7, &winrt::impl::guid_v<winrt::impl::IAgileObject>, &v8), (v9 = v8) != 0) )
  {
    ...
    v10[2] = &qword_1801DBBE8;
    _InterlockedIncrement64(&qword_1801DBBE8);
    ...
    {
      v6 = 0LL;
      WINRT_IMPL_InterlockedPushEntrySList(&`winrt::impl::get_factory_cache'::`2'::cache, &stru_1801DBBF0);
    }
    (*a3)(
      a2,
      &winrt::impl::factory_cache_entry_v<winrt::Microsoft::Bluetooth::Audio::Interface::Internal::BluetoothAudioSharingParameters,winrt::Microsoft::Bluetooth::Audio::Interface::Internal::IBluetoothAudioSharingParametersStatics>);
    _InterlockedDecrement64(&qword_1801DBBE8);
  }
  else
  {
    (*a3)(a2, (__int64 *)&v6);
