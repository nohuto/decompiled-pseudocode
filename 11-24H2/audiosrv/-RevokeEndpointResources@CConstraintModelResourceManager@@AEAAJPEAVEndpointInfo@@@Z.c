/*
 * XREFs of ?RevokeEndpointResources@CConstraintModelResourceManager@@AEAAJPEAVEndpointInfo@@@Z @ 0x1800EF23C
 * Callers:
        ...
        struct EndpointInfo *a2)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    PrintableId = (unsigned int)EndpointInfo::GetPrintableId(v5, (__int64)v5);
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xDu, (__int64)&WPP_a5774a8bafb0327b6b857065801df2a8_Traceguids, v4);
  }
  return 0LL;
}
