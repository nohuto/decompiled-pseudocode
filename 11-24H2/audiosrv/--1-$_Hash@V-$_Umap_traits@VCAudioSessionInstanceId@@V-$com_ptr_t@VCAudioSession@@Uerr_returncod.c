        ...
        __int64 *a1)
{
  ...
  if ( v2 )
  {
    std::_Deallocate<16,0>(v2, (a1[5] - v2) & 0xFFFFFFFFFFFFFFF8uLL);
    a1[3] = 0LL;
    a1[4] = 0LL;
    a1[5] = 0LL;
  }
  ...
  **(_QWORD **)(v3 + 8) = 0LL;
  ...
  operator delete((void *)a1[1], (const struct std::nothrow_t *)0x68);
}
