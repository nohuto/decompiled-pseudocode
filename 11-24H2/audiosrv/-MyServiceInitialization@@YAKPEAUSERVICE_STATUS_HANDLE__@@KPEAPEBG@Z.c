/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x18014E08C
 * Callers:
 ...
 *     McGenEventRegister_EtwEventRegister @ 0x18014E564 (McGenEventRegister_EtwEventRegister.c)
