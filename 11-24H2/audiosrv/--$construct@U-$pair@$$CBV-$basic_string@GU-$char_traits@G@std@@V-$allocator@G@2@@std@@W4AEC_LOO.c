...
__int64 __fastcall std::_Default_allocator_traits<std::allocator<std::_Tree_node<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,void *>>>::construct<std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>,std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE> const &>(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
