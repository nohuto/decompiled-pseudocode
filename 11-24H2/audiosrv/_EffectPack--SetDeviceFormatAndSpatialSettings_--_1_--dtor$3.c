/*
 * XREFs of _EffectPack::SetDeviceFormatAndSpatialSettings_::_1_::dtor$3 @ 0x18016E83C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EffectPack::SetDeviceFormatAndSpatialSettings_::_1_::dtor_3(__int64 a1, __int64 a2)
{
