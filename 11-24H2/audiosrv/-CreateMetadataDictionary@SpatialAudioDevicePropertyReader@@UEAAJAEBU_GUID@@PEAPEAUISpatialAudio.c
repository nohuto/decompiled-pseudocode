/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x180128050
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    if ( PropertyIndexForMetadataFormatID < 0 )
    {
      ...
      *(_DWORD *)v18 = 571;
      v11 = (unsigned __int8 *)&unk_1801AED6A;
      goto LABEL_7;
    }
