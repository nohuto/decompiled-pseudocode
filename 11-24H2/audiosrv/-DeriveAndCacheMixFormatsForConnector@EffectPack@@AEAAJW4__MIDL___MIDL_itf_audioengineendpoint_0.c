/*
 * XREFs of ?DeriveAndCacheMixFormatsForConnector@EffectPack@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x1800357B0
 * Callers:
 ...
 *     ?GetConnectorProcessingModeCount@EffectPack@@QEAAIW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18006D26C (-GetConnectorProcessingModeCount@EffectPack@@QEAAIW4__MIDL___MIDL_itf_audioengineendpoint_0000_0.c)
 ...
 *     wil::details::lambda_call__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___::_lambda_call__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___ @ 0x180130828 (wil--details--lambda_call__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___--_lambda_call__lambda_d0c0.c)
        ...
        enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 a2)
{
  ...
  lambda_a8a3ec141be49a0429a3d190c13e56dc_::_lambda_a8a3ec141be49a0429a3d190c13e56dc_(v77, this, v61);
  v79 = this;
  v80 = v61;
  v5 = 1;
  v81 = 1;
  ...
  for ( i = 0; i < ConnectorProcessingModeCount; ++i )
  {
    ...
    if ( i >= *(_DWORD *)(SupportedConnectorModesInternal + 8) )
      ...
      v10 = *(GUID *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                       ...
                       i);
    v82 = v10;
    v11 = lambda_82c9212e29ceb5f8e3f8d325d4b387fa_::_lambda_82c9212e29ceb5f8e3f8d325d4b387fa_(&v75, this, &v82, v61);
    wil::scope_exit__lambda_82c9212e29ceb5f8e3f8d325d4b387fa___(&v73, v11);
    pAudioFormat = 0LL;
    ...
    *(GUID *)Block = v10;
    ...
    if ( (ConnectorFormatForProcessingMode & 0x80000000) != 0 )
    {
      ...
      wistd::unique_ptr<KSMULTIPLE_ITEM,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>::reset(
        (void **)&pAudioFormat,
        0LL);
      wil::details::lambda_call__lambda_82c9212e29ceb5f8e3f8d325d4b387fa___::_lambda_call__lambda_82c9212e29ceb5f8e3f8d325d4b387fa___(&v73);
...
LABEL_27:
    ...
    *(GUID *)Block = v82;
    *(GUID *)v72 = v82;
    lambda_8bdb8404337a2458e15ecbdbb65afac5_::operator()(v77, v72, Block, v32);
    v74 = 0;
    if ( v70 )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v70 + 16LL))(v70);
    if ( v68 )
  ...
  if ( (unsigned int)EffectPack::CanBuildProcessingModesOnRawConnector((__int64)this, (unsigned int)v61[0], 0) )
  {
    ...
    Block[1] = 0LL;
    v37 = v61[0];
    v38 = (__int64 *)gsl::span<SystemEffectDescriptor,-1>::operator[]((unsigned __int64 *)this + 182, v61[0]);
    ...
    while ( v41 < SLODWORD(Block[1]) )
    {
      ...
      {
        v43 = lambda_d0c0e66dca171ee6ed71d206afa3ba5f_::_lambda_d0c0e66dca171ee6ed71d206afa3ba5f_(
                (unsigned int)&v75,
                (_DWORD)this,
                (unsigned int)Block,
                (unsigned int)&v64,
                (__int64)v61);
        wil::scope_exit__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___(v78, v43);
        v72[0] = 0LL;
        v69 = 0LL;
...
LABEL_145:
        ...
        if ( v45 < 0 )
        {
          ...
          wil::details::lambda_call__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___::_lambda_call__lambda_d0c0e66dca171ee6ed71d206afa3ba5f___(v78);
          ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::RemoveAll(Block);
          wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>((__int64 *)&v63);
          v34 = 2LL;
          if ( v61[0] != eKeywordDetectorConnector )
        ...
        v75 = GUID_9e90ea20_b493_4fd1_a1a8_7e1361a956cf;
        v73 = (struct _GUID)*((_OWORD *)Block[0] + v64);
        lambda_8bdb8404337a2458e15ecbdbb65afac5_::operator()(v77, &v73, &v75, v58);
        v78[32] = 0;
        if ( v69 )
