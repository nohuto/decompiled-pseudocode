/*
 * XREFs of __tailMerge_ext_ms_onecore_appmodel_staterepository_internal_l1_1_3_dll @ 0x1800A8056
 * Callers:
 *     __imp_load_SRDictionaryToPropertySet @ 0x1800A80D5 (__imp_load_SRDictionaryToPropertySet.c)
 * Callees:
