/*
 * XREFs of ??1?$CWatchdogTimer_Old@$00@@QEAA@XZ @ 0x1800AD7E4
 * Callers:
...
char __fastcall CWatchdogTimer_Old<1>::~CWatchdogTimer_Old<1>(__int64 a1)
{
  ...
  if ( v3 >= 3 )
  {
    ...
    if ( *v4 > 2u )
    {
      LOBYTE(v3) = tlgKeywordOn((__int64)v4, 0x400000000001LL);
      if ( (_BYTE)v3 )
      {
        v9 = *(_DWORD *)(a1 + 16);
