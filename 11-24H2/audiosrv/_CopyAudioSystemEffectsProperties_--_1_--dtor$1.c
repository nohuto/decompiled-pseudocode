/*
 * XREFs of _CopyAudioSystemEffectsProperties_::_1_::dtor$1 @ 0x180168B40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CopyAudioSystemEffectsProperties_::_1_::dtor_1(__int64 a1, __int64 a2)
{
