/*
 * XREFs of ?CChannels@CBluetoothVolumeInterceptor@BluetoothControls@@UEBAIXZ @ 0x1800D2F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::CChannels(
        BluetoothControls::CBluetoothVolumeInterceptor *this)
{
  ...
  if ( (int)BluetoothControls::CBluetoothVolumeInterceptor::TryGetOwner(this, &v3) >= 0 )
  {
    ...
    if ( (int)BluetoothControls::BluetoothVolumeAndMute::TryGetTargetedVolumeControl(v3, &v4) >= 0 )
      v1 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 40LL))(v4);
