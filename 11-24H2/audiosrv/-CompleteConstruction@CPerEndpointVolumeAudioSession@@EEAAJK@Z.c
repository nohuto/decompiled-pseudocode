/*
 * XREFs of ?CompleteConstruction@CPerEndpointVolumeAudioSession@@EEAAJK@Z @ 0x1800C1270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPerEndpointVolumeAudioSession::CompleteConstruction(CPerEndpointVolumeAudioSession *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 36LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids);
  }
  *(_OWORD *)v6 = 0LL;
  v7 = 0LL;
