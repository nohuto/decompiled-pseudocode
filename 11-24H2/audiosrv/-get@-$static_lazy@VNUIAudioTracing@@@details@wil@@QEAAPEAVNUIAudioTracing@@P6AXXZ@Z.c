/*
 * XREFs of ?get@?$static_lazy@VNUIAudioTracing@@@details@wil@@QEAAPEAVNUIAudioTracing@@P6AXXZ@Z @ 0x18014EB38
 * Callers:
 ...
 *     ??1Completer@?$static_lazy@VNUIAudioTracing@@@details@wil@@QEAA@XZ @ 0x18014E9FC (--1Completer@-$static_lazy@VNUIAudioTracing@@@details@wil@@QEAA@XZ.c)
 */
...
__int64 *__fastcall wil::details::static_lazy<NUIAudioTracing>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`NUIAudioTracing::Instance'::`2'::wrapper, 0, &v6, (LPVOID *)&v8) && v6 )
  {
    ...
    dword_1801DCF9C = 0;
    v8 = &qword_1801DCF88;
    qword_1801DCF88 = (__int64)&NUIAudioTracing::`vftable';
    v4 = &`NUIAudioTracing::Instance'::`2'::wrapper;
    byte_1801DCF98 = 0;
    qword_1801DCFA0 = (__int64)&`NUIAudioTracing::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
