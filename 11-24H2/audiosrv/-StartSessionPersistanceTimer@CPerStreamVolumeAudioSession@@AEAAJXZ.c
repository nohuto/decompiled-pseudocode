/*
 * XREFs of ?StartSessionPersistanceTimer@CPerStreamVolumeAudioSession@@AEAAJXZ @ 0x180027D5C
 * Callers:
 ...
 *     std::function_void___cdecl(void)_::function_void___cdecl(void)___lambda_7899aca099ee8f1bcaa9f2c8ca02d853__0_ @ 0x1800C0444 (std--function_void___cdecl(void)_--function_void___cdecl(void)___lambda_7899aca099ee8f1bcaa9f2c8.c)
 */
...
__int64 __fastcall CPerStreamVolumeAudioSession::StartSessionPersistanceTimer(CPerStreamVolumeAudioSession *this)
{
  ...
  if ( *((_QWORD *)this + 123)
    || (GetSerialWorkQueue(),
        ...
        v4 = std::function_void___cdecl_void__::function_void___cdecl_void____lambda_7899aca099ee8f1bcaa9f2c8ca02d853__0_(
               v9,
               v3),
