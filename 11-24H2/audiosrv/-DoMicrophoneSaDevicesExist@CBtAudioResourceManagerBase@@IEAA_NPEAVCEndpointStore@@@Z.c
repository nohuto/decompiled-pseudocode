/*
 * XREFs of ?DoMicrophoneSaDevicesExist@CBtAudioResourceManagerBase@@IEAA_NPEAVCEndpointStore@@@Z @ 0x1800DC7B8
 * Callers:
        ...
        struct CEndpointStore *a2)
{
  ...
  *(_OWORD *)v5 = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( *(_QWORD *)v5 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(*(__int64 *)v5, *(__int64 *)&v5[2]);
      std::_Deallocate<16,0>(
        *(char **)v5,
        (const struct std::nothrow_t *)((v6 - *(_QWORD *)v5) & 0xFFFFFFFFFFFFFFF8uLL));
    }
    return v4;
  }
  else
