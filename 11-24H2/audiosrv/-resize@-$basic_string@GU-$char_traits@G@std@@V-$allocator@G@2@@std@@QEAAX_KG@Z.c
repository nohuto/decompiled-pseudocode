/*
 * XREFs of ?resize@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAX_KG@Z @ 0x1800E8840
 * Callers:
...
char **__fastcall std::wstring::resize(__int64 a1, unsigned __int64 a2)
{
  ...
  result = (char **)std::_String_val<std::_Simple_types<unsigned short>>::_Myptr(a1, a2);
  *(_QWORD *)(v4 + 16) = v3;
  *((_WORD *)result + v3) = 0;
  return result;
}
