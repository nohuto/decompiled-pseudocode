/*
 * XREFs of ?QueryInterface@PersistedEndpointPolicyRule@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126300
 * Callers:
 *     ?QueryInterface@PersistedEndpointPolicyRule@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126370 (-QueryInterface@PersistedEndpointPolicyRule@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
