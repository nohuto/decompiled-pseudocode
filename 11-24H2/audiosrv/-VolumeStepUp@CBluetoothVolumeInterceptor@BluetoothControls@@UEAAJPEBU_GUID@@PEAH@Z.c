/*
 * XREFs of ?VolumeStepUp@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAJPEBU_GUID@@PEAH@Z @ 0x1800D8930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::VolumeStepUp(
        ...
        int *a3)
{
  ...
  if ( Owner >= 0 )
  {
    ...
    if ( TargetedVolumeControl >= 0 )
      v6 = (*(__int64 (__fastcall **)(__int64, const struct _GUID *, int *))(*(_QWORD *)v11 + 192LL))(v11, a2, a3);
    else
