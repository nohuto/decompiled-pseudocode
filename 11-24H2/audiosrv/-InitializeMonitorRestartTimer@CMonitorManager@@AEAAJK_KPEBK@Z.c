/*
 * XREFs of ?InitializeMonitorRestartTimer@CMonitorManager@@AEAAJK_KPEBK@Z @ 0x18011A184
 * Callers:
        ...
        const unsigned int *a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x37u, (__int64)&WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids, pv);
  }
