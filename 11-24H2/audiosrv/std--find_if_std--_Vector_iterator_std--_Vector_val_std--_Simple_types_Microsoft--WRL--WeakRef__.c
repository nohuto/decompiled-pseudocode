/*
 * XREFs of std::find_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::WeakRef_______lambda_3640aac1012d9f944c7183fa6cd164a8___ @ 0x1800C5A44
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( a2 != a3 )
  {
    ...
    {
      v11 = 0LL;
      if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(v6, (__int64 *)&v11) >= 0 && v11 )
      {
        v10 = 0LL;
