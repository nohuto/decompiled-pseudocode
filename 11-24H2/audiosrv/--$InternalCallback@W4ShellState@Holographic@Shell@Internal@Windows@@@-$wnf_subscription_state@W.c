/*
 * XREFs of ??$InternalCallback@W4ShellState@Holographic@Shell@Internal@Windows@@@?$wnf_subscription_state@W4ShellState@Holographic@Shell@Internal@Windows@@@details@wil@@QEAAXPEBW4ShellState@Holographic@Shell@Internal@Windows@@K@Z @ 0x18014B23C
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_c38bfd10498b2e9fce262131177562b7_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x18014B1D0 (-_lambda_invoker_cdecl_@_lambda_c38bfd10498b2e9fce262131177562b7_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
