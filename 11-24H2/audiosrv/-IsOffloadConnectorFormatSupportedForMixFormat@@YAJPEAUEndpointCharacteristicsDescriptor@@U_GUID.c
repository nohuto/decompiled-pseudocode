/*
 * XREFs of ?IsOffloadConnectorFormatSupportedForMixFormat@@YAJPEAUEndpointCharacteristicsDescriptor@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@3@Z @ 0x18003E81C
 * Callers:
        ...
        const struct tWAVEFORMATEX *Src)
{
  ...
  *(struct _GUID *)pAudioFormat = *a2;
  ModeEffect = EffectPack::GetModeEffect(*((_QWORD *)a1 + 1), (struct _GUID *)pAudioFormat, 0, 1, 0LL, &v21, 0LL);
  v8 = v21;
  if ( ModeEffect >= 0 )
  {
    if ( !v21 )
