/*
 * XREFs of ??1CAppAudioSessionId@@QEAA@XZ @ 0x18004AB58
 * Callers:
 *     _CAudioSessionInstanceId::CAudioSessionInstanceId_::_1_::dtor$1 @ 0x1801682A2 (_CAudioSessionInstanceId--CAudioSessionInstanceId_--_1_--dtor$1.c)
 *     _CAudioSessionManager::OnSessionStateChanged_::_1_::dtor$14 @ 0x180168402 (_CAudioSessionManager--OnSessionStateChanged_--_1_--dtor$14.c)
 * Callees:
