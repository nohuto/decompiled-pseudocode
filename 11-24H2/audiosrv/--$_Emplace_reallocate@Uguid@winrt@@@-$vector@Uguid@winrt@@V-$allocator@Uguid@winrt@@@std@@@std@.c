/*
 * XREFs of ??$_Emplace_reallocate@Uguid@winrt@@@?$vector@Uguid@winrt@@V?$allocator@Uguid@winrt@@@std@@@std@@AEAAPEAUguid@winrt@@QEAU23@$$QEAU23@@Z @ 0x1800E29E0
 * Callers:
 ...
 *     ?_Change_array@?$vector@Uguid@winrt@@V?$allocator@Uguid@winrt@@@std@@@std@@AEAAXQEAUguid@winrt@@_K1@Z @ 0x1800E786C (-_Change_array@-$vector@Uguid@winrt@@V-$allocator@Uguid@winrt@@@std@@@std@@AEAAXQEAUguid@winrt@@.c)
 *     memmove_0 @ 0x180167F48 (memmove_0.c)
 */

char *__fastcall std::vector<winrt::guid>::_Emplace_reallocate<winrt::guid>(const void **a1, _BYTE *a2, _OWORD *a3)
{
  ...
  try
  {
    ...
    *(_OWORD *)v15 = *a3;
    ...
    std::vector<winrt::guid>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
