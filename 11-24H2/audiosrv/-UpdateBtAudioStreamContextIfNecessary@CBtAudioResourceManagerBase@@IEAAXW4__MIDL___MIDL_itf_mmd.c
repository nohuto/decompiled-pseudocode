/*
 * XREFs of ?UpdateBtAudioStreamContextIfNecessary@CBtAudioResourceManagerBase@@IEAAXW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x1800E1C98
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_bb5d36055978aeacbacf48ca24f21936__void_::_Do_call @ 0x1800E2080 (std--_Func_impl_no_alloc__lambda_bb5d36055978aeacbacf48ca24f21936__void_--_Do_call.c)
 * Callees:
        ...
        int a2)
{
  ...
  if ( BTAudio_StreamContextFromStreamCounts != *((_DWORD *)this + v2 + 127) && *((_BYTE *)this + 516) )
  {
