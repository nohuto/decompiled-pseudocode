/*
 * XREFs of ?RtlDllShutdownInProgress@details@wil@@YAEXZ @ 0x1800A9B00
 * Callers:
 *     <none>
 * Callees:
 *     ?wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z @ 0x1800AA88C (-wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z.c)
