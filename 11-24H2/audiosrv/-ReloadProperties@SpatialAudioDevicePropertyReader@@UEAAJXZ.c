/*
 * XREFs of ?ReloadProperties@SpatialAudioDevicePropertyReader@@UEAAJXZ @ 0x1800382C0
 * Callers:
 *     <none>
 * Callees:
 *     ?CleanUp@SpatialAudioDevicePropertyReader@@AEAAXXZ @ 0x180038508 (-CleanUp@SpatialAudioDevicePropertyReader@@AEAAXXZ.c)
...
__int64 __fastcall SpatialAudioDevicePropertyReader::ReloadProperties(SpatialAudioDevicePropertyReader *this)
{
  ...
  if ( DeviceSettings < 0 && (unsigned int)dword_1801D82E8 > 2 )
  {
    LODWORD(v26) = 293;
LABEL_10:
    v25 = DeviceSettings;
...
LABEL_11:
  if ( v24 )
  {
    ...
    *((_DWORD *)this + 31) = SpatialAudio::GetStaticMaskPC((SpatialAudioDevicePropertyReader *)((char *)this + 108), v3);
    MaxDynamicObjectCountPC = SpatialAudio::GetMaxDynamicObjectCountPC(
                                ...
                                v7);
    *((_DWORD *)this + 32) = 0;
    *(_OWORD *)((char *)this + 134) = xmmword_18018F7E0;
    *((_WORD *)this + 66) = MaxDynamicObjectCountPC;
    *(_OWORD *)((char *)this + 150) = xmmword_18018F7F0;
    *(_OWORD *)((char *)this + 166) = xmmword_18018F800;
    *(_OWORD *)((char *)this + 182) = xmmword_18018F810;
    *(_OWORD *)((char *)this + 198) = xmmword_18018F820;
    *(_OWORD *)((char *)this + 214) = xmmword_18018F830;
    *(_OWORD *)((char *)this + 230) = xmmword_18018F840;
  ...
  v21 = PositionTable;
  if ( PositionTable < 0 && (unsigned int)dword_1801D82E8 > 2 )
  {
    v24 = PositionTable;
    v25 = 311;
