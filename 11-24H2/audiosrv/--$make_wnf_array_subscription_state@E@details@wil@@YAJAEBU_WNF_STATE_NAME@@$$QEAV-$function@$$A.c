/*
 * XREFs of ??$make_wnf_array_subscription_state@E@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXPEBE_K@Z@wistd@@KPEAPEAU?$wnf_array_subscription_state@E@01@@Z @ 0x18014B5EC
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *v6 = &wil::details::wnf_subscription_state<enum Microsoft::Bluetooth::Audio::Internal::BluetoothLEAudioSupportedState>::`vftable';
    ...
    {
      LODWORD(v17) = 0;
      v9 = NtQueryWnfStateData(&WNF_SHEL_APPLICATION_SPATIAL_INFO_UPDATE, 0LL, 0LL, &v18, 0LL, &v17) | 0x10000000;
