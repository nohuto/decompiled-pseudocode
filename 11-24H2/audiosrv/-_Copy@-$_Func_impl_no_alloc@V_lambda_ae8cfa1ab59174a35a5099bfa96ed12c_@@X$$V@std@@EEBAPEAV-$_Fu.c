/*
 * XREFs of ?_Copy@?$_Func_impl_no_alloc@V_lambda_ae8cfa1ab59174a35a5099bfa96ed12c_@@X$$V@std@@EEBAPEAV?$_Func_base@X$$V@2@PEAX@Z @ 0x1800D8AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_ae8cfa1ab59174a35a5099bfa96ed12c_,void,>::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r8
