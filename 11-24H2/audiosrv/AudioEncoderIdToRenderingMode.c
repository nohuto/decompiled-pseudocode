/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x18012BFD0
 * Callers:
 ...
 *     ?GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x180129210 (-GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z.c)
 * Callees:
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 )
                {
                  ...
                  if ( v13 && (unsigned int)dword_1801D82E8 > 2 )
                  {
                    v15 = -2147418113;
