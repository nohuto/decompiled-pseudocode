/*
 * XREFs of ?SignalChange@SpatialAudioDevicePropertyWriter@@AEAAJW4SignalingKeySource@@@Z @ 0x18012BDB4
 * Callers:
 *     ?ResetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJXZ @ 0x18012B440 (-ResetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJXZ.c)
 *     ?SetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioDeviceProperties@@@Z @ 0x18012B930 (-SetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioDeviceProperties@@@Z.c)
 ...
 *     ?SignalChange@SpatialAudioDevicePropertyWriter@@UEAAJXZ @ 0x18012BF70 (-SignalChange@SpatialAudioDevicePropertyWriter@@UEAAJXZ.c)
 * Callees:
...
__int64 __fastcall SpatialAudioDevicePropertyWriter::SignalChange(__int64 a1, char a2)
{
  ...
  *(_BYTE *)(a1 + 101) = BYTE1(v15) + 1;
  ...
  v18.vt = 2;
  v18.iVal = v15;
  if ( (unsigned int)dword_1801D82E8 > 5 )
  {
    v5 = *(_BYTE *)(a1 + 101);
    v32 = 0;
    v29 = 0;
    ...
    v25 = 1;
    v22 = 2;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801D82E8, byte_1801AEDE6, 0LL, 0LL, 6u, &v20);
  }
