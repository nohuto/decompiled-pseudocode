/*
 * XREFs of ??$query_to@U?$IMap@PEAUHSTRING__@@PEAUIInspectable@@@Collections@Foundation@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAU?$IMap@PEAUHSTRING__@@PEAUIInspectable@@@Collections@Foundation@Windows@@@Z @ 0x1800A32DC
 * Callers:
