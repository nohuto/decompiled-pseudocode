/*
 * XREFs of ?AddStream@CAudioSession@@UEAAJPEAVCAudioStream@@@Z @ 0x180021B50
 * Callers:
...
__int64 __fastcall CAudioSession::AddStream(CAudioSession *this, struct CAudioStream *a2)
{
  ...
  struct _RTL_CRITICAL_SECTION *v13[8]; // [rsp+28h] [rbp-40h] BYREF
  ...
  try
  {
    ...
    *(_QWORD *)v12 = (char *)this + 64;
    ATL::CComPtrBase<CMonitorManager::CaptureMonitor>::CComPtrBase<CMonitorManager::CaptureMonitor>(&v16, a2);
    ...
    wil::com_ptr_t<IAudioProcess,wil::err_returncode_policy>::reset(&v15);
    v7((char *)a2 + 8, &v15);
    if ( !(*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v15 + 96LL))(v15) && *((_DWORD *)a2 + 106) == 3 )
      *((_DWORD *)this + 102) = 1;
    if ( g_DuckingManager
    ...
    v13[1] = (struct _RTL_CRITICAL_SECTION *)&CAudioStreamCreate::`vftable';
    v13[2] = (struct _RTL_CRITICAL_SECTION *)this;
    v13[3] = (struct _RTL_CRITICAL_SECTION *)a2;
