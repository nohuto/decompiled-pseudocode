/*
 * XREFs of ?VAD_AudiosrvServiceStop@CAudioSrv@@AEAAJXZ @ 0x1800D092C
 * Callers:
...
__int64 __fastcall CAudioSrv::VAD_AudiosrvServiceStop(CAudioSrv *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 38LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
    v2 = WPP_GLOBAL_Control;
  }
  if ( *((_DWORD *)this + 26) )
  {
  ...
  if ( *((_DWORD *)this + 25) )
  {
    if ( v2 != &WPP_GLOBAL_Control && (*((_BYTE *)v2 + 28) & 4) != 0 && *((_BYTE *)v2 + 25) >= 4u )
      WPP_SF_(v2[2], 39LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
    v7 = RpcServerUnregisterIfEx(&unk_180183FB0, 0LL, 1);
    if ( v7
  ...
  {
    CAudioHealthMonitor::~CAudioHealthMonitor(*(CAudioHealthMonitor **)&g_AudioHealthMonitor);
