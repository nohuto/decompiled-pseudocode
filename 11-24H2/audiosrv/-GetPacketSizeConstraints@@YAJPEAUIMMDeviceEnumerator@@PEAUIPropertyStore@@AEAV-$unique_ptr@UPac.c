/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIMMDeviceEnumerator@@PEAUIPropertyStore@@AEAV?$unique_ptr@UPacketSizeConstraints@@U?$default_delete@UPacketSizeConstraints@@@std@@@std@@@Z @ 0x180167504
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(__int64 a1, __int64 a2, void ***a3)
{
  ...
  if ( dword_1801DCFA8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801DCFA8);
    if ( dword_1801DCFA8 == -1 )
    {
      xmmword_1801DCB50 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_1801DCB60 = 2;
      xmmword_1801DCB64 = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_1801DCB74 = 2;
      Init_thread_footer(&dword_1801DCFA8);
    }
  }
  v28 = 0LL;
  v6 = &xmmword_1801DCB50;
  v7 = 1;
  while ( 1 )
  {
    *(_OWORD *)Size = 0LL;
...
LABEL_16:
    ...
    if ( v6 == (__int128 *)&`wil::Feature<__WilFeatureTraits_Feature_Servicing_ForEachStream_Crash>::GetImpl'::`2'::impl )
      goto LABEL_17;
  }
