/*
 * XREFs of ?DoSecondaryProfileSharedModeRenderSaDevicesExist@CBtAudioResourceManagerBase@@IEAA_NPEAVCEndpointStore@@PEAPEAUISaDeviceProxy@@@Z @ 0x1800DCA5C
 * Callers:
        ...
        struct ISaDeviceProxy **a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    {
      v9 = *(unsigned __int8 (__fastcall **)(CBtAudioResourceManagerBase *, __int128 *))(*(_QWORD *)this + 152LL);
      ...
      if ( v9(this, &v13) )
      {
        ...
        if ( (_QWORD)v11 )
        {
          std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v11, *((__int64 *)&v11 + 1));
