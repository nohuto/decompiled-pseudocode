/*
 * XREFs of ?SetChannelVolumeLevel@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAJIMPEBU_GUID@@PEAH@Z @ 0x1800D7970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothControls::CBluetoothVolumeInterceptor::SetChannelVolumeLevel(
        ...
        int *a5)
{
  ...
  if ( Owner >= 0 )
  {
    ...
    if ( TargetedVolumeControl >= 0 )
      v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, const struct _GUID *, int *))(*(_QWORD *)v12 + 144LL))(
             v12,
             a2,
             v10,
             a4,
