        ...
        __int64 a3)
{
  ...
  v20 = v8;
  v10 = std::_Allocate_at_least_helper<std::allocator<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>>(
          v9,
          &v20);
  v12 = (__int64 *)v10;
  v18 = (char *)v10;
