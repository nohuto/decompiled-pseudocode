/*
 * XREFs of ?RuntimeClassInitialize@AudioEffectsWatcher@@QEAAJPEBGKHW4DiscoverySettings@@@Z @ 0x18001E254
 * Callers:
...
LABEL_12:
    ...
    *(_BYTE *)(a1 + 88) = 1;
    if ( (unsigned int)EffectPack::EndpointConnectorSupportsProcessingModes(v29[1], eHostProcessConnector) )
    {
      ...
      v36[1] = a1;
      v36[7] = v36;
      v24 = CSerialWorkQueue::QueueRecurringWaitItem(SerialWorkQueue, *v18);
      v11 = v24;
      if ( v24 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
    ...
    {
      v15 = RtlPublishWnfStateData(*(_QWORD *)(a1 + 92), 0LL, &unk_180193608, 16LL, 0LL);
      if ( v15 < 0 )
      {
        v16 = 156LL;
        goto LABEL_12;
