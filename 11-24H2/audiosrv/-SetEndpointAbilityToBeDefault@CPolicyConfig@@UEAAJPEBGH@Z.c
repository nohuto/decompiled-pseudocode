/*
 * XREFs of ?SetEndpointAbilityToBeDefault@CPolicyConfig@@UEAAJPEBGH@Z @ 0x180106AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  if ( !a2 )
  {
    v5 = -2147467261;
LABEL_16:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetEndpointAbilityToBeDefault", 1694, v5);
    goto LABEL_17;
  }
  v5 = CoCreateInstance(
