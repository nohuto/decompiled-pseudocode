/*
 * XREFs of ?OnMulticastChildSessionDescriptorKeyChanged@BluetoothBroadcastProvider@@AEAAJPEBG@Z @ 0x1800E6768
 * Callers:
        ...
        unsigned __int16 *a2)
{
  ...
  try
  {
    ...
    *(_OWORD *)pvar = 0LL;
    v23 = 0LL;
    v9 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))v20->lpVtbl->GetValue)(
           v20,
