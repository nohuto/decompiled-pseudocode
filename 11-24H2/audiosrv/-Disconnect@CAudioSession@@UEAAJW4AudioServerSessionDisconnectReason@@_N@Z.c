/*
 * XREFs of ?Disconnect@CAudioSession@@UEAAJW4AudioServerSessionDisconnectReason@@_N@Z @ 0x18001DA80
 * Callers:
...
LABEL_4:
        ...
        v25 = &CAudioSessionDisconnected::`vftable';
        v26 = a1;
        v27 = a2;
        CLockedList_UniqueValuesOnly<ATL::CComPtr<ISessionInternalEvents>,0>::ForEachEntry((LPCRITICAL_SECTION)(a1 + 432));
        if ( !v31 )
          goto LABEL_15;
        if ( !a2 )
        {
