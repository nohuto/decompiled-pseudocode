/*
 * XREFs of _InitializeStreamAndModeDescriptors_::_1_::dtor$3 @ 0x18016DA31
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall InitializeStreamAndModeDescriptors_::_1_::dtor_3(__int64 a1, __int64 a2)
{
