/*
 * XREFs of ?Term@CAtlComModule@ATL@@QEAAXXZ @ 0x180075C8C
 * Callers:
 *     ??1?$CAtlExeModuleT@VCAudioServiceModule@@@ATL@@UEAA@XZ @ 0x1800CB758 (--1-$CAtlExeModuleT@VCAudioServiceModule@@@ATL@@UEAA@XZ.c)
 *     ATL::_dynamic_atexit_destructor_for___AtlComModule__ @ 0x1801731A0 (ATL--_dynamic_atexit_destructor_for___AtlComModule__.c)
 * Callees:
