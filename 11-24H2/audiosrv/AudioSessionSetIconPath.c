/*
 * XREFs of AudioSessionSetIconPath @ 0x1800797D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetIconPath(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    if ( v7 )
    {
      ...
      v4 = CWatchdogTimer<1>::CWatchdogTimer<1>(v7, pftDueTime);
    }
  ...
  else
  {
    ...
    if ( v9 )
    {
      ...
      AudioSrvTelemetryProvider::Instance();
      v4 = CWatchdogTimer_Old<1>::CWatchdogTimer_Old<1>(v9, v10);
    }
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v13, v4);
  }
  v11 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v3 + 208LL))(v3, a2, a3);
