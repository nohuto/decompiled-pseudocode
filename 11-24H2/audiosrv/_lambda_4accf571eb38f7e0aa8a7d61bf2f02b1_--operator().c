...
__int64 __fastcall lambda_4accf571eb38f7e0aa8a7d61bf2f02b1_::operator()(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rcx
  _BYTE *v5; // rcx
