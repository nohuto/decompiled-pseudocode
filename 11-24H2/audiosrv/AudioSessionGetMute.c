/*
 * XREFs of AudioSessionGetMute @ 0x180078970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetMute(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 304LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetMute", 2089, v10);
