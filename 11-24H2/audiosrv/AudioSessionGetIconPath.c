/*
 * XREFs of AudioSessionGetIconPath @ 0x1800785E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetIconPath(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 200LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetIconPath", 1906, v10);
