/*
 * XREFs of ?DeleteSessionNotification@CAudioSession@@UEAAJPEAUISessionInternalEvents@@@Z @ 0x1800430E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::DeleteSessionNotification(CAudioSession *this, struct ISessionInternalEvents *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 69LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids, a2);
  }
  v16 = a2;
  if ( a2 )
