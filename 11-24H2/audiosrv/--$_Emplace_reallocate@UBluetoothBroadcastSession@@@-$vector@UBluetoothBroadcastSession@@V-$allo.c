/*
 * XREFs of ??$_Emplace_reallocate@UBluetoothBroadcastSession@@@?$vector@UBluetoothBroadcastSession@@V?$allocator@UBluetoothBroadcastSession@@@std@@@std@@AEAAPEAUBluetoothBroadcastSession@@QEAU2@$$QEAU2@@Z @ 0x1800E2874
 * Callers:
 *     ?push_back@?$vector@UBluetoothBroadcastSession@@V?$allocator@UBluetoothBroadcastSession@@@std@@@std@@QEAAX$$QEAUBluetoothBroadcastSession@@@Z @ 0x1800E8650 (-push_back@-$vector@UBluetoothBroadcastSession@@V-$allocator@UBluetoothBroadcastSession@@@std@@@.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  SIZE_T size_of; // rax
  BluetoothBroadcastSession *v13; // rax
  BluetoothBroadcastSession *v14; // rdi
  char *v15; // r14
  __int64 v16; // rdx
  __int64 v17; // rcx
  __int64 v18; // rax
  __int64 v19; // rdx
  BluetoothBroadcastSession *v20; // r8
  __int64 v21; // rcx
  char *result; // rax
  __int64 v23; // rcx
  BluetoothBroadcastSession *v24; // [rsp+20h] [rbp-48h]
  __int64 v25; // [rsp+20h] [rbp-48h]
  BluetoothBroadcastSession *v26; // [rsp+70h] [rbp+8h]
  ...
  v13 = (BluetoothBroadcastSession *)std::_Allocate<16,std::_Default_allocate_traits,0>(size_of);
  v14 = v13;
  v24 = v13;
  v15 = (char *)v13 + 48 * v6;
  try
  {
    ...
    *((_QWORD *)v15 + 4) = v17;
    *((_QWORD *)v15 + 5) = v16;
    v26 = (BluetoothBroadcastSession *)v15;
    v19 = a1[1];
    v20 = v14;
    v21 = *a1;
    if ( a2 != v19 )
    {
      ...
      v26 = v14;
      v20 = (BluetoothBroadcastSession *)(v15 + 48);
      v19 = a1[1];
      v21 = a2;
    }
    std::_Uninitialized_move<BluetoothBroadcastSession *>(v21, v19, v20);
    std::vector<BluetoothBroadcastSession>::_Change_array(a1, v14, v9, v8, v24);
    result = v15;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<BluetoothBroadcastSession>>(v26, (BluetoothBroadcastSession *)(v15 + 48));
    std::allocator<BluetoothBroadcastSession>::deallocate(v23, v25, v8);
    throw;
  }
  return result;
}
