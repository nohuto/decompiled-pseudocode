/*
 * XREFs of ??1CSleepStudyPowerReference@@QEAA@XZ @ 0x1800685C4
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCSleepStudyPowerReference@@@std@@EEAAXXZ @ 0x18006DD00 (-_Destroy@-$_Ref_count_obj2@VCSleepStudyPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
 *     <none>
 */
