/*
 * XREFs of ?UnregisterStreamVolumeNotifications@CAudioStream@@UEAAJPEAUIAudioStreamVolumeCallback@@@Z @ 0x1800CA630
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamVolumeCallback *a2)
{
  ...
  if ( a2 )
  {
    ...
    v6 = (__int64 *)*((_QWORD *)this + 38);
    v11 = v5;
    for ( i = (__int64 *)*((_QWORD *)this + 37); i != v6 && (struct IAudioStreamVolumeCallback *)*i != a2; ++i )
      ;
    if ( i != v6 )
    {
      for ( j = i + 1; j != v6; ++j )
