/*
 * XREFs of ?AddMetadataFormat@SpatialAudioDevicePropertyWriter@@UEAAJPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x18012AF70
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v10 >= 0 )
          {
            ...
            *(_OWORD *)&v23[1] = 0LL;
            ...
            if ( v10 >= 0 )
            {
              ...
              v10 = SpatialAudioDevicePropertyWriter::SetPropertyValue(this, &v24, (struct tagPROPVARIANT *)&v23[1]);
              v9 = v10;
              if ( v10 >= 0 || (unsigned int)dword_1801D82E8 <= 2 )
                goto LABEL_38;
              v19 = 344;
              v14 = (unsigned __int8 *)&unk_1801AED6A;
            }
