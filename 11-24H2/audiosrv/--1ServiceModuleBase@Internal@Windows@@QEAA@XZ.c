/*
 * XREFs of ??1ServiceModuleBase@Internal@Windows@@QEAA@XZ @ 0x1800CBBB4
 * Callers:
 *     ??1ServiceModule@Internal@Windows@@UEAA@XZ @ 0x1800CBB8C (--1ServiceModule@Internal@Windows@@UEAA@XZ.c)
