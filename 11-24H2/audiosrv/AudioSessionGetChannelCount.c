/*
 * XREFs of AudioSessionGetChannelCount @ 0x180077FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetChannelCount(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 320LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetChannelCount", 2148, v10);
