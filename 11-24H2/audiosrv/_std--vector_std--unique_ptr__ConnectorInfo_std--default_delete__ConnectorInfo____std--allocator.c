/*
 * XREFs of _std::vector_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo____std::allocator_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo_______::_Emplace_reallocate_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo______::_1_::catch$0 @ 0x18016F705
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo____std::allocator_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo_______::_Emplace_reallocate_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo______::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
  __int64 v3; // rcx

  std::_Destroy_range<std::allocator<std::unique_ptr<_ConnectorInfo>>>(*(_QWORD *)(a2 + 112), *(_QWORD *)(a2 + 136));
