/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIApplicationTracker@@UIHostedApplicationTracker@@UIFastRundown@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800B21A0
 * Callers:
 *     <none>
 * Callees:
