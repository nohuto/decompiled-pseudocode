/*
 * XREFs of AudioSessionGetVolume @ 0x180078F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetVolume(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 288LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetVolume", 2033, v10);
