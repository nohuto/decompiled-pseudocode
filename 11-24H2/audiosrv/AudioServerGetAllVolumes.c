/*
 * XREFs of AudioServerGetAllVolumes @ 0x180081FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetAllVolumes(struct _RTL_CRITICAL_SECTION *this, unsigned int a2, float *a3)
{
  void *v6; // rax
  void *v7; // rsi
  ...
  v13 = AllVolumes;
  if ( AllVolumes < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetAllVolumes", 3425, AllVolumes);
