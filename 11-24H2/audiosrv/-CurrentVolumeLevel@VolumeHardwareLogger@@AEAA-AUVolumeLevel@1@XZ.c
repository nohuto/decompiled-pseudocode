/*
 * XREFs of ?CurrentVolumeLevel@VolumeHardwareLogger@@AEAA?AUVolumeLevel@1@XZ @ 0x18006E3B0
 * Callers:
...
float *__fastcall VolumeHardwareLogger::CurrentVolumeLevel(__int64 a1, float *a2)
{
  ...
  *a2 = 0.0;
  ...
  {
    (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v4 + 128LL))(v4, a2);
    (*(void (__fastcall **)(_QWORD, _DWORD *))(**(_QWORD **)(a1 + 64) + 136LL))(*(_QWORD *)(a1 + 64), (_DWORD *)a2 + 1);
