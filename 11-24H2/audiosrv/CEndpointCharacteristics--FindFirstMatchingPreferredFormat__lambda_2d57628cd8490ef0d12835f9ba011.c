/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_2d57628cd8490ef0d12835f9ba011710___ @ 0x18006A968
 * Callers:
    ...
    else
    {
      ...
      else
      {
        *(_OWORD *)pvar = 0LL;
        ...
        v7 = (char *)&unk_18019CA00;
        if ( !v13 )
          v7 = (char *)&unk_18019C9A0;
      }
      v8 = 8LL;
    }
  }
