/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x180126FA8
 * Callers:
 *     PolicyConfigUpdateDynamicRoutingRule @ 0x180108FE0 (PolicyConfigUpdateDynamicRoutingRule.c)
 * Callees:
