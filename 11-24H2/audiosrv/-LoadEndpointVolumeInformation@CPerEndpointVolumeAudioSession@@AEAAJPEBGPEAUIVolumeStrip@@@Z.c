/*
 * XREFs of ?LoadEndpointVolumeInformation@CPerEndpointVolumeAudioSession@@AEAAJPEBGPEAUIVolumeStrip@@@Z @ 0x18001D484
 * Callers:
        ...
        struct IVolumeStrip *a3)
{
  ...
  char *v32; // [rsp+48h] [rbp+18h] BYREF
...
LABEL_47:
    ...
    wistd::unique_ptr<float,wil::function_deleter<void (*)(void *),&void _freea(void *)>>::reset(&v31, 0LL);
    return 2147942414LL;
  }
  for ( i = 0; i < v28; ++i )
  {
...
LABEL_45:
  ...
  *((_DWORD *)this + 194) = v30;
  ...
  {
    WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 37LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids);
  }
  v17 = v28;
  *((_DWORD *)this + 222) = v28;
  v19 = v17;
