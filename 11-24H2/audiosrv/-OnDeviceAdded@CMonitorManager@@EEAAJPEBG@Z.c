/*
 * XREFs of ?OnDeviceAdded@CMonitorManager@@EEAAJPEBG@Z @ 0x18011AA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitorManager::OnDeviceAdded(struct _RTL_CRITICAL_SECTION *pv, const unsigned __int16 *a2)
{
