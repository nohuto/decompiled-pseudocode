/*
 * XREFs of ??0hresult_illegal_delegate_assignment@winrt@@QEAA@Utake_ownership_from_abi_t@1@AEBUslim_source_location@impl@1@@Z @ 0x1800E3C68
 * Callers:
...
__int64 __fastcall winrt::hresult_illegal_delegate_assignment::hresult_illegal_delegate_assignment(__int64 a1)
{
  winrt::hresult_error::hresult_error(a1, winrt::impl::error_illegal_delegate_assignment);
  return a1;
}
