/*
 * XREFs of ??$MakeAndInitialize@V?$CCrossProcessClientMemory@UControlData_V0@@@@UICrossProcessMemory@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUICrossProcessMemory@@@Z @ 0x180165790
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<CCrossProcessClientMemory<ControlData_V0>,ICrossProcessMemory,>(
        _QWORD *a1)
{
  _QWORD *v2; // rax
  _QWORD *v3; // rbx
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    *v3 = &CCrossProcessClientMemory<ControlData_V0>::`vftable';
    v6 = 0LL;
    v4 = ((__int64 (__fastcall *)(_QWORD *, GUID *, _QWORD *))CCrossProcessClientMemory<ControlData_V0>::`vftable')(
           v3,
