/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIAudioSessionEvents@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x1800B00D0
 * Callers:
 *     ??1?$CComPtrBase@VCMonitorNotification@CMonitor@@@ATL@@QEAA@XZ @ 0x180117360 (--1-$CComPtrBase@VCMonitorNotification@CMonitor@@@ATL@@QEAA@XZ.c)
