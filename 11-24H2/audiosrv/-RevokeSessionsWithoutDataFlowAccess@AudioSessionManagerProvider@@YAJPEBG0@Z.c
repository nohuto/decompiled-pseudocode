/*
 * XREFs of ?RevokeSessionsWithoutDataFlowAccess@AudioSessionManagerProvider@@YAJPEBG0@Z @ 0x1800C7B40
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  v11 = a2;
  v10 = this;
  v3 = lambda_a8a3ec141be49a0429a3d190c13e56dc_::_lambda_a8a3ec141be49a0429a3d190c13e56dc_(
         &v7,
         (__int64)&v10,
         (__int64)&v11);
