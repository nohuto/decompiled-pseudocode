/*
 * XREFs of ??$_Compare@PEBGPEBGV?$regex_traits@G@std@@@std@@YAPEBGPEBG000AEBV?$regex_traits@G@0@W4syntax_option_type@regex_constants@0@@Z @ 0x18012E710
 * Callers:
 ...
 *     ??$_Cmp_chrange@PEBGPEBGU?$_Cmp_icase@V?$regex_traits@G@std@@@std@@@std@@YAPEBGPEBG000U?$_Cmp_icase@V?$regex_traits@G@std@@@0@@Z @ 0x18012E660 (--$_Cmp_chrange@PEBGPEBGU-$_Cmp_icase@V-$regex_traits@G@std@@@std@@@std@@YAPEBGPEBG000U-$_Cmp_ic.c)
 */
