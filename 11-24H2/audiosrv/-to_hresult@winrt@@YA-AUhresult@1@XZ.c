/*
 * XREFs of ?to_hresult@winrt@@YA?AUhresult@1@XZ @ 0x1800E8B64
 * Callers:
 *     _winrt::impl::produce_winrt::impl::scoped_input_vector_view_winrt::guid_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_winrt::guid________winrt::Windows::Foundation::Collections::IVectorView_winrt::guid___::get_Size_::_1_::catch$0 @ 0x18016EE30 (_winrt--impl--produce_winrt--impl--scoped_input_vector_view_winrt--guid_std--_Vector_const_itera.c)
 *     _winrt::impl::produce_winrt::iterable_base_winrt::impl::scoped_input_vector_view_winrt::guid_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_winrt::guid________winrt::guid_winrt::impl::no_collection_version_::iterator_winrt::Windows::Foundation::Collections::IIterator_winrt::guid___::get_Current_::_1_::catch$0 @ 0x18016EE62 (_winrt--impl--produce_winrt--iterable_base_winrt--impl--scoped_input_vector_view_winrt--guid_std.c)
 *     _winrt::impl::produce_winrt::impl::scoped_input_vector_view_winrt::guid_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_winrt::guid________winrt::Windows::Foundation::Collections::IVectorView_winrt::guid___::GetMany_::_1_::catch$0 @ 0x18016EE9A (_winrt--impl--produce_winrt--impl--scoped_input_vector_view_winrt--guid_std--_Vecto_ea_18016EE9A.c)
 *     _winrt::impl::produce_winrt::impl::scoped_input_vector_view_winrt::guid_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_winrt::guid________winrt::Windows::Foundation::Collections::IVectorView_winrt::guid___::IndexOf_::_1_::catch$0 @ 0x18016EECC (_winrt--impl--produce_winrt--impl--scoped_input_vector_view_winrt--guid_std--_Vecto_ea_18016EECC.c)
 *     _winrt::impl::root_implements_winrt::iterable_base_winrt::impl::scoped_input_vector_view_winrt::guid_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_winrt::guid________winrt::guid_winrt::impl::no_collection_version_::iterator_winrt::Windows::Foundation::Collections::IIterator_winrt::guid___::NonDelegatingGetTrustLevel_::_1_::catch$0 @ 0x18016EEFE (_winrt--impl--root_implements_winrt--iterable_base_winrt--impl--scoped_input_vector_view_winrt--.c)
 * Callees:
