/*
 * XREFs of _lambda_0d142282e693a5da8305741b2fcbdc74_::operator() @ 0x1800F92C4
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_0d142282e693a5da8305741b2fcbdc74__long_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&_::_Do_call @ 0x1800FABB0 (std--_Func_impl_no_alloc__lambda_0d142282e693a5da8305741b2fcbdc74__long_wil--com_pt_ea_1800FABB0.c)
 * Callees:
...
__int64 __fastcall lambda_0d142282e693a5da8305741b2fcbdc74_::operator()(_QWORD *a1, __int64 a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  _QWORD *i; // rsi
  ...
  if ( v4 >= 0 )
  {
    for ( i = (_QWORD *)v16; i != *((_QWORD **)&v16 + 1); ++i )
    {
      ...
      if ( v8 < 0 )
      {
        ...
        if ( (_QWORD)v14 )
        {
          std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v14, *((__int64 *)&v14 + 1));
...
LABEL_27:
    ...
    if ( (_QWORD)v16 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v16, *((__int64 *)&v16 + 1));
      std::_Deallocate<16,0>((char *)v16, (const struct std::nothrow_t *)((v17 - v16) & 0xFFFFFFFFFFFFFFF8uLL));
    }
    return 0LL;
  }
