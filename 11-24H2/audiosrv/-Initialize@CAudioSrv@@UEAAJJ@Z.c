/*
 * XREFs of ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x1800CDFF0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !a2 )
  {
    ...
    *((_QWORD *)this + 11) = v5;
    if ( !v5 )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
      a2 = -2147024882;
    }
  }
  ...
  if ( !a2 )
  {
    ...
    else
    {
      ...
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 15LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
    }
  }
  ppv = 0LL;
    ...
    if ( !v13 )
    {
      ...
      *(_QWORD *)&EventAttributes.bInheritHandle = 0LL;
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
             ...
             0LL) )
      {
        if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
        }
      ...
      if ( v17 < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioSrv::Initialize", 630, v17);
