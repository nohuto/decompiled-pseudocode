/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_58116118@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CF1E4
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_58116118>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v11 = a4;
  v5 = a2;
  LODWORD(v6) = *(_DWORD *)Feature_58116118__descriptor;
  if ( (*(_DWORD *)Feature_58116118__descriptor & 4) == 0 )
  {
    v6 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_58116118>::GetCachedFeatureEnabledState(a1, v8);
    v11 = v6;
  }
  v9 = 0;
  v10 = 2;
