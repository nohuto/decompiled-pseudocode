/*
 * XREFs of ?Initialize@CMonitor@@QEAAJPEAUIMMDevice@@0AEA_N@Z @ 0x1800697D0
 * Callers:
...
LABEL_54:
        if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
        {
          WPP_SF_qd(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_755387bd23fa3df5d8dd9259737f5712_Traceguids, this);
        }
        *((_BYTE *)this + 76) = 1;
