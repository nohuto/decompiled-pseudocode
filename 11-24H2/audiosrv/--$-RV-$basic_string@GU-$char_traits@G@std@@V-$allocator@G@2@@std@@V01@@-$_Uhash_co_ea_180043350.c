        ...
        __int64 a3)
{
  ...
  std::_String_val<std::_Simple_types<unsigned short>>::_Large_mode_engaged(a3, a2);
  if ( (unsigned __int8)std::_String_val<std::_Simple_types<unsigned short>>::_Large_mode_engaged(v3, v3) )
    v4 = *(char **)v4;
  if ( v6 != v7 )
    return 1;
  v8 = v4 - v5;
