/*
 * XREFs of ?RefreshStreamsOnDevice@CBtAudioResourceManagerBase@@IEAAJW4ReconnectSaDeviceOptions@1@@Z @ 0x1800DF8B8
 * Callers:
...
__int64 __fastcall CBtAudioResourceManagerBase::RefreshStreamsOnDevice(__int64 a1, int a2)
{
  struct CEndpointStore *v3; // rcx
  struct _RTL_CRITICAL_SECTION **v4; // rax
  HANDLE *CurrentEffectPack; // rax
  struct CEndpointStore *v6; // rdx
  _QWORD *v7; // rcx
  ...
  struct _RTL_CRITICAL_SECTION *v22; // [rsp+48h] [rbp-C0h] BYREF
  __int64 v23; // [rsp+50h] [rbp-B8h] BYREF
  __int64 v24; // [rsp+58h] [rbp-B0h] BYREF
  struct _RTL_CRITICAL_SECTION *v25; // [rsp+60h] [rbp-A8h] BYREF
  double TimeSec; // [rsp+68h] [rbp-A0h] BYREF
  ...
  const WCHAR *v32; // [rsp+A8h] [rbp-60h] BYREF
  __int64 v33; // [rsp+B0h] [rbp-58h] BYREF
  LARGE_INTEGER v34; // [rsp+B8h] [rbp-50h] BYREF
  LARGE_INTEGER PerformanceCount; // [rsp+C0h] [rbp-48h] BYREF
  LARGE_INTEGER v36[3]; // [rsp+C8h] [rbp-40h] BYREF
  char v37; // [rsp+E0h] [rbp-28h]
  wil::details::in1diag3 *retaddr; // [rsp+108h] [rbp+0h]
  struct CEndpointStore *v39; // [rsp+110h] [rbp+8h] BYREF
  int v40; // [rsp+118h] [rbp+10h]
  struct CEndpointStore *v41; // [rsp+120h] [rbp+18h] BYREF
  __int64 v42; // [rsp+128h] [rbp+20h] BYREF
  ...
  try
  {
    ...
    {
      v21 = 0LL;
      if ( (int)wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>::query_to<IInspectable>(
                  (_QWORD *)(a1 + 88),
                  &v21) >= 0 )
      {
        v3 = v41;
        ...
        if ( (int)CEndpointStoreCache::GetEndpointStore(v3, *(const unsigned __int16 **)(a1 + 64), &v41) >= 0 )
        {
          v4 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(_QWORD, struct _RTL_CRITICAL_SECTION **))(**((_QWORD **)v41 + 13) + 128LL))(
                                                  *((_QWORD *)v41 + 13),
                                                  &v22);
        ...
        wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>::operator=((__int64 *)&v29, v21);
        CurrentEffectPack = CEndpointCharacteristics::GetCurrentEffectPack((struct _RTL_CRITICAL_SECTION *)v29);
        std::shared_ptr<EffectPack>::operator=((_QWORD *)&v29 + 1, CurrentEffectPack);
      }
    }
    v22 = 0LL;
    v6 = 0LL;
    ...
    {
      v42 = 0LL;
      if ( (int)wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>::query_to<IInspectable>(v7, &v42) >= 0 )
      {
        v8 = v39;
        v39 = 0LL;
        if ( v8 )
        ...
        if ( (int)CEndpointStoreCache::GetEndpointStore(v8, *(const unsigned __int16 **)(a1 + 56), &v39) >= 0 )
        {
          v9 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(_QWORD, double *))(**((_QWORD **)v39 + 13)
                                                                                            + 128LL))(
                                                  *((_QWORD *)v39 + 13),
                                                  &TimeSec);
          wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::operator=(
            &v22,
            v9);
          wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>((struct _RTL_CRITICAL_SECTION **)&TimeSec);
        }
        wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>::operator=((__int64 *)&v27, v42);
        v10 = CEndpointCharacteristics::GetCurrentEffectPack((struct _RTL_CRITICAL_SECTION *)v27);
        std::shared_ptr<EffectPack>::operator=((_QWORD *)&v27 + 1, v10);
      }
      v6 = v39;
    }
    v36[1].QuadPart = (LONGLONG)&v41;
    v36[2].QuadPart = (LONGLONG)&v39;
    v37 = 1;
    v23 = 0LL;
    if ( v6 )
    {
      v11 = CBtAudioResourceManagerBase::ReleaseSaDevices(v7, v6, &v23);
      v12 = v11;
      if ( v11 < 0 )
      {
        ...
        std::forward_list<DisplacedStreamGroup>::clear(&v23);
        if ( v41 )
          CAudioSessionManager::Disconnect(*((struct _RTL_CRITICAL_SECTION **)v41 + 12), 0LL, 1);
        if ( v39 )
          CAudioSessionManager::Disconnect(*((struct _RTL_CRITICAL_SECTION **)v39 + 12), 0LL, 1);
LABEL_44:
    ...
    if ( v41 )
    {
      v13 = CBtAudioResourceManagerBase::ReleaseSaDevices(v7, v41, &v24);
      v12 = v13;
      if ( v13 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
        ...
        std::forward_list<DisplacedStreamGroup>::clear(&v24);
        std::forward_list<DisplacedStreamGroup>::clear(&v23);
        if ( v41 )
          CAudioSessionManager::Disconnect(*((struct _RTL_CRITICAL_SECTION **)v41 + 12), 0LL, 1);
        if ( v39 )
    ...
    if ( (_QWORD)v29 )
    {
      v14 = CBtAudioResourceManagerBase::ReconnectStreamGroupsToNewSaDevices(a1, &v29, &v24);
      v12 = v14;
      if ( v14 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
    ...
    if ( (_QWORD)v27 )
    {
      v15 = CBtAudioResourceManagerBase::ReconnectStreamGroupsToNewSaDevices(a1, &v27, &v23);
      v12 = v15;
      if ( v15 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
    ...
    if ( **((_DWORD **)v18 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v18 + 1), 0x400000004000LL) )
    {
      TimeSec = CQPCStopWatch::GetTimeSec((CQPCStopWatch *)&v34);
      v31 = *(const WCHAR **)(a1 + 64);
      v32 = *(const WCHAR **)(a1 + 56);
      v33 = 0x1000000LL;
