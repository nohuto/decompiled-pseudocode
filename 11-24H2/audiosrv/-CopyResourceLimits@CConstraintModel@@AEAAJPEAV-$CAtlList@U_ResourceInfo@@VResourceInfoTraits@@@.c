/*
 * XREFs of ?CopyResourceLimits@CConstraintModel@@AEAAJPEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@0@Z @ 0x180160AF0
 * Callers:
 ...
 *     ?FindIndex@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEBAPEAU__POSITION@@_K@Z @ 0x180160C24 (-FindIndex@-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEBAPEAU__POSITION@@_K@Z.c)
 */
...
__int64 __fastcall CConstraintModel::CopyResourceLimits(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( i >= v6 || v5 < 0 )
      break;
    Index = ATL::CAtlList<_ResourceInfo,ResourceInfoTraits>::FindIndex(v4, i, a3);
    if ( !Index )
