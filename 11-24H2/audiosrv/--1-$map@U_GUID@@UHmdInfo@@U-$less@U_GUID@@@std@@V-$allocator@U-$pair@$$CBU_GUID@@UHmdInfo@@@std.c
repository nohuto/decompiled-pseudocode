/*
 * XREFs of ??1?$map@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@@std@@QEAA@XZ @ 0x18013B340
 * Callers:
 *     _CExclusiveModeListener::CExclusiveModeListener_::_1_::dtor$3 @ 0x180171BBC (_CExclusiveModeListener--CExclusiveModeListener_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
