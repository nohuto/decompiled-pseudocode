/*
 * XREFs of ??$ReportFailure_CaughtException@$00@details@wil@@YAJPEAXIPEBD110W4SupportedExceptions@1@@Z @ 0x1800ACCF0
 * Callers:
 ...
 *     ?winrt_to_hresult@wil@@YAHPEAX@Z @ 0x1800E8CF0 (-winrt_to_hresult@wil@@YAHPEAX@Z.c)
 * Callees:
