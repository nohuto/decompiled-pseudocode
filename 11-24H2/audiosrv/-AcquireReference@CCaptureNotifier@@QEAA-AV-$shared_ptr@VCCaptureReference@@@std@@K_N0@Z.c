/*
 * XREFs of ?AcquireReference@CCaptureNotifier@@QEAA?AV?$shared_ptr@VCCaptureReference@@@std@@K_N0@Z @ 0x180065554
 * Callers:
 ...
 *     ??$_Construct_in_place@VCCaptureReference@@PEAVCCaptureNotifier@@AEAKAEA_NAEA_N@std@@YAXAEAVCCaptureReference@@$$QEAPEAVCCaptureNotifier@@AEAKAEA_N3@Z @ 0x1800A031C (--$_Construct_in_place@VCCaptureReference@@PEAVCCaptureNotifier@@AEAKAEA_NAEA_N@std@@YAXAEAVCCap.c)
 */
