/*
 * XREFs of _lambda_8bdb8404337a2458e15ecbdbb65afac5_::operator() @ 0x180131A44
 * Callers:
...
char __fastcall lambda_8bdb8404337a2458e15ecbdbb65afac5_::operator()(__int64 *a1, __int64 a2, __int64 a3, _WORD *a4)
{
  ...
  const WCHAR *v28; // [rsp+98h] [rbp-1h] BYREF
  const WCHAR *v29; // [rsp+A0h] [rbp+7h] BYREF
  ...
  else
  {
    ...
    if ( **(_DWORD **)(v4 + 2120) > 4u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v35 = v20;
        v24 = *v21;
        v28 = *(const WCHAR **)(*(_QWORD *)(v17 + 1584) + 48LL);
