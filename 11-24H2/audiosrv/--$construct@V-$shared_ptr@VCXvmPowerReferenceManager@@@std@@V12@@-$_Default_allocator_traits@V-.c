/*
 * XREFs of ??$construct@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@V12@@?$_Default_allocator_traits@V?$allocator@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@@std@@@std@@SAXAEAV?$allocator@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@@1@QEAV?$shared_ptr@VCXvmPowerReferenceManager@@@1@$$QEAV31@@Z @ 0x1800A30D8
 * Callers:
