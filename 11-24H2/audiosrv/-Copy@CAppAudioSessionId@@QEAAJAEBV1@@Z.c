/*
 * XREFs of ?Copy@CAppAudioSessionId@@QEAAJAEBV1@@Z @ 0x18001C160
 * Callers:
...
__int64 __fastcall CAppAudioSessionId::Copy(CAppAudioSessionId *this, const struct CAppAudioSessionId *a2)
{
  ...
  try
  {
    ...
    *((_OWORD *)this + 1) = *((_OWORD *)a2 + 1);
    ATL::CSimpleStringT<unsigned short,0>::operator=((__int64 *)this, (const void **)a2);
  }
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::operator=((__int64 *)v4 + 1, (const void **)v5 + 1);
  }
...
LABEL_3:
  ...
  *((_DWORD *)v4 + 10) = *((_DWORD *)v5 + 10);
  v2 = 0;
  ATL::CSimpleStringT<unsigned short,0>::operator=((__int64 *)v4 + 4, (const void **)v5 + 4);
  return v2;
}
