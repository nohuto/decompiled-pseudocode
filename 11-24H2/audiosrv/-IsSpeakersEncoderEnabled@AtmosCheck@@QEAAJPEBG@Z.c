/*
 * XREFs of ?IsSpeakersEncoderEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180057350
 * Callers:
 *     ?GetTechnologyLicenseResult@CSpatialAudioDolbySpeakers@@UEBAJPEBG@Z @ 0x180141BA0 (-GetTechnologyLicenseResult@CSpatialAudioDolbySpeakers@@UEBAJPEBG@Z.c)
 * Callees:
