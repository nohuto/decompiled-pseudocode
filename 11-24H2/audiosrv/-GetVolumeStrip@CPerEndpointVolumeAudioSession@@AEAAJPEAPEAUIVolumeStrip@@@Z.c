/*
 * XREFs of ?GetVolumeStrip@CPerEndpointVolumeAudioSession@@AEAAJPEAPEAUIVolumeStrip@@@Z @ 0x18001D230
 * Callers:
 ...
 *     ?Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ @ 0x1800759C0 (-Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ.c)
        ...
        struct IVolumeStrip **a2)
{
  ...
  if ( !*((_QWORD *)this + 121) )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 32LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids, this);
    }
...
LABEL_19:
      AudSrvTraceLoggingErrorHelper("CPerEndpointVolumeAudioSession::GetVolumeStrip", 1679, EndpointVolumeInformation);
      goto LABEL_31;
    }
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x200000) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids, this);
    }
