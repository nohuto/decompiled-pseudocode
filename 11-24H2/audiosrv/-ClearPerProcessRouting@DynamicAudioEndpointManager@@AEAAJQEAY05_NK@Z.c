/*
 * XREFs of ?ClearPerProcessRouting@DynamicAudioEndpointManager@@AEAAJQEAY05_NK@Z @ 0x180125934
 * Callers:
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( 2 )
    {
      ...
      do
      {
        if ( *v9 )
        {
          v10 = PublishChangeNotification((unsigned int)v7, (unsigned int)v8, &LocaleName, a3);
          v11 = v10;
          if ( v10 < 0 )
          {
