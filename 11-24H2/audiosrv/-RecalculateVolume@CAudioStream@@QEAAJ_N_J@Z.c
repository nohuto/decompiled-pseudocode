/*
 * XREFs of ?RecalculateVolume@CAudioStream@@QEAAJ_N_J@Z @ 0x180021574
 * Callers:
          ...
          if ( v18 != ((_BYTE)v14 != 0) )
          {
            ...
            if ( v19 >= 0 )
            {
              if ( *((_QWORD *)this + 8) )
              {
                ...
                if ( *v22 > 4u && (unsigned __int8)tlgKeywordOn(*((_QWORD *)v21 + 1), 0x400000000002LL) )
                {
...
LABEL_26:
      if ( g_StreamVolumeChangeAsTelemetryCounter <= 0 || *((_DWORD *)this + 107) )
      {
        ...
        if ( *v33 > 4u && (unsigned __int8)tlgKeywordOn(*((_QWORD *)v32 + 1), 2LL) )
        {
          v50 = v44;
          v49 = v57;
          v58 = *((_DWORD *)this + 26);
      ...
      else
      {
        ...
        if ( *v26 > 4u && (unsigned __int8)tlgKeywordOn(*((_QWORD *)v25 + 1), 0x400000000002LL) )
        {
          v46 = v44;
          v45 = v57;
          v58 = *((_DWORD *)this + 26);
