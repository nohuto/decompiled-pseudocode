/*
 * XREFs of ?ServiceMain@@YAXKQEAPEAG@Z @ 0x18014DA80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WppInitUm @ 0x18014DEE8 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  if ( !hEventShutdown )
  {
    dword_1801DB608 = GetLastError();
    v6 = (unsigned int)dword_1801DB608;
LABEL_6:
    ReportStatusToSCMgr(1LL, v6, 0LL, v5);
    return;
  }
  dword_1801DB608 = (*((__int64 (__fastcall **)(HANDLE *, LPCWSTR, HANDLE, void (__fastcall *)(void *), _QWORD, int))gpSvchostSharedGlobals
                     + 24))(
                      &hEventShutdownWait,
                      *a2,
                      hEventShutdown,
...
LABEL_19:
  ...
  for ( i = 0; i < (unsigned int)v2; ++i )
  {
    ...
    *(_QWORD *)(*((_QWORD *)v7 + 2) + 8LL * i) = HeapAlloc(hHeap, 8u, v13);
  ...
  {
    dword_1801DB608 = GetLastError();
    v15 = (unsigned int)dword_1801DB608;
LABEL_20:
