/*
 * XREFs of ?DestroyVolumeStrip@CPerEndpointVolumeAudioSession@@AEAAXXZ @ 0x180072C58
 * Callers:
...
void __fastcall CPerEndpointVolumeAudioSession::DestroyVolumeStrip(CPerEndpointVolumeAudioSession *this)
{
  ...
  {
    WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 35LL, &WPP_ea93f1868512325b454513e390c361b8_Traceguids, this);
  }
