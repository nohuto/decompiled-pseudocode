/*
 * XREFs of ?FillLevelsInDB@CBluetoothVolumeInterceptor@BluetoothControls@@UEAAXIPEAM@Z @ 0x1800D3620
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BluetoothControls::CBluetoothVolumeInterceptor::FillLevelsInDB(
        ...
        float *a3)
{
  ...
  if ( (int)BluetoothControls::CBluetoothVolumeInterceptor::TryGetOwner(this, v5) >= 0 )
  {
    ...
    if ( (int)BluetoothControls::BluetoothVolumeAndMute::TryGetTargetedVolumeControl(v5[0], &v6) >= 0 )
      (*(void (__fastcall **)(__int64, _QWORD, float *))(*(_QWORD *)v6 + 56LL))(v6, a2, a3);
