/*
 * XREFs of ?_Erase@?$_Tree@V?$_Tmap_traits@_KV?$function@$$A6AXXZ@std@@U?$less@_K@2@V?$allocator@U?$pair@$$CB_KV?$function@$$A6AXXZ@std@@@std@@@2@$0A@@std@@@std@@AEAA_KU?$pair@PEAU?$_Tree_node@U?$pair@$$CB_KV?$function@$$A6AXXZ@std@@@std@@PEAX@std@@PEAU12@@2@@Z @ 0x1800E20B0
 * Callers:
...
__int64 __fastcall std::_Tree<std::_Tmap_traits<unsigned __int64,std::function<void (void)>,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,std::function<void (void)>>>,0>>::_Erase(
        __int64 *a1,
        __int64 *a2)
{
  __int64 v2; // r9
  ...
  else
  {
    while ( v2 != v4 )
    {
      ...
      v11 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,wil::com_ptr_t<BluetoothControls::BluetoothVolumeAndMute,wil::err_exception_policy>>>>::_Extract(
              a1,
              v10);
