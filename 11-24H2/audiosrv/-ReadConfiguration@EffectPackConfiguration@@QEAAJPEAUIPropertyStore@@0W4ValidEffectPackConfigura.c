/*
 * XREFs of ?ReadConfiguration@EffectPackConfiguration@@QEAAJPEAUIPropertyStore@@0W4ValidEffectPackConfigurationSettings@@@Z @ 0x180145224
 * Callers:
        ...
        int a4)
{
  ...
  _QWORD *v71; // rdx
  __int64 v72; // rdx
  PROPVARIANT pvar[2]; // [rsp+30h] [rbp-128h] BYREF
  __int64 v74; // [rsp+40h] [rbp-118h]
  _QWORD v75[5]; // [rsp+50h] [rbp-108h] BYREF
  _QWORD v76[5]; // [rsp+78h] [rbp-E0h] BYREF
  _QWORD v77[5]; // [rsp+A0h] [rbp-B8h] BYREF
  __int128 v78; // [rsp+C8h] [rbp-90h] BYREF
  char v79; // [rsp+D8h] [rbp-80h]
  struct _tagpropertykey pclsid; // [rsp+F0h] [rbp-68h] BYREF
  ...
  if ( (a4 & 1) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    ...
    if ( LOWORD(pvar[0]) == 31 )
    {
      v12 = StringCchCopyW((char *)(a1 + 32), 128LL, (char *)pvar[1]);
      v13 = v12;
      if ( v12 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 2) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v14 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)a2 + 40LL))(a2, &PKEY_FX_Author, pvar);
    v15 = v14;
    if ( v14 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    if ( LOWORD(pvar[0]) == 31 )
    {
      v16 = StringCchCopyW((char *)(a1 + 1056), 128LL, (char *)pvar[1]);
      v17 = v16;
      if ( v16 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 4) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v18 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)a2 + 40LL))(
            a2,
    ...
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v20 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)a2 + 40LL))(
            a2,
  ...
  if ( (a4 & 8) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v22 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)a2 + 40LL))(
            a2,
    ...
    if ( LOWORD(pvar[0]) == 31 )
    {
      v24 = StringCchCopyW((char *)(a1 + 288), 128LL, (char *)pvar[1]);
      v25 = v24;
      if ( v24 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x10) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v26 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)a2 + 40LL))(
            a2,
  ...
  if ( (a4 & 0x20) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    ...
    if ( LOWORD(pvar[0]) == 4127 )
    {
      ...
      {
        pclsid.fmtid = 0LL;
        v32 = CLSIDFromString(*(LPCOLESTR *)(v74 + 8LL * i), &pclsid.fmtid);
        v33 = v32;
        if ( v32 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
        ...
        if ( v34 == *(char **)(a1 + 1840) )
        {
          std::vector<_GUID>::_Emplace_reallocate<_GUID const &>(a1 + 1824, v34, (__int64)&pclsid);
        }
        else
        {
          *(GUID *)v34 = pclsid.fmtid;
          *(_QWORD *)(a1 + 1832) += 16LL;
        }
      }
    }
  ...
  if ( (a4 & 0x1000) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v35 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
    ...
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v37 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
            &PKEY_FX_ApplyToUsb,
            pvar);
    v38 = v37;
  ...
  if ( (a4 & 0x2000) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v39 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
    ...
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v41 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
    ...
    if ( LOWORD(pvar[0]) == 4127 )
    {
      for ( j = 0; j < LODWORD(pvar[1]); ++j )
      {
        ...
        if ( *(_QWORD *)&pclsid.fmtid.Data1 )
        {
          ...
          {
            *(_QWORD *)v47 = *(_QWORD *)&pclsid.fmtid.Data1;
  ...
  if ( (a4 & 0x4000) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v48 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
  ...
  if ( (a4 & 0x8000) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v50 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
  ...
  if ( (a4 & 0x40) != 0 )
  {
    v78 = (unsigned __int64)(a1 + 1800);
    v79 = 1;
    memset(&pclsid, 0, sizeof(pclsid));
    *(GUID *)pvar = PKEY_FX_PreMixEffectClsid.fmtid;
    LODWORD(v74) = PKEY_FX_PreMixEffectClsid.pid;
    GetFxClsidsFromPropertyStore(
      a3,
      (struct _tagpropertykey *)pvar,
      &pclsid,
      0LL,
      (unsigned int *)(a1 + 1792),
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1816);
    v79 = 1;
    *(_OWORD *)pvar = xmmword_18019D3C8;
    LODWORD(v74) = 0;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _tagpropertykey *)pvar,
      0LL,
      (unsigned int *)(a1 + 1808),
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
  }
  v53 = (const unsigned __int16 *)((a1 + 544) & -(__int64)(*(_WORD *)(a1 + 544) != 0));
  if ( (a4 & 0x80u) != 0 )
  {
    v78 = (unsigned __int64)(a1 + 1320);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_StreamEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_StreamEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1336);
    v79 = 1;
    *(GUID *)pvar = PKEY_SFX_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_SFX_ProcessingModes_Supported_For_Streaming.pid;
    ProcessingModes = GetProcessingModes(
                        a3,
                        (struct _tagpropertykey *)pvar,
                        (unsigned int *)(a1 + 1328),
                        (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    ...
    v78 = (unsigned __int64)(a1 + 1352);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_ModeEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_ModeEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1368);
    v79 = 1;
    *(GUID *)pvar = PKEY_MFX_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_MFX_ProcessingModes_Supported_For_Streaming.pid;
    v55 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1360), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v55 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x100) != 0 )
  {
    v78 = (unsigned __int64)(a1 + 1384);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_EndpointEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_EndpointEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1400);
    v79 = 1;
    *(GUID *)pvar = PKEY_EFX_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_EFX_ProcessingModes_Supported_For_Streaming.pid;
    v56 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1392), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v56 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x200) != 0 )
  {
    v78 = (unsigned __int64)(a1 + 1416);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_Offload_StreamEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_Offload_StreamEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1432);
    v79 = 1;
    *(GUID *)pvar = PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_SFX_Offload_ProcessingModes_Supported_For_Streaming.pid;
    v57 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1424), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v57 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    v78 = (unsigned __int64)(a1 + 1448);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_Offload_ModeEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_Offload_ModeEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1464);
    v79 = 1;
    *(GUID *)pvar = PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_MFX_Offload_ProcessingModes_Supported_For_Streaming.pid;
    v58 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1456), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v58 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x400) != 0 )
  {
    v78 = (unsigned __int64)(a1 + 1608);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_KeywordDetector_StreamEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_KeywordDetector_StreamEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1624);
    v79 = 1;
    *(GUID *)pvar = PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_SFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.pid;
    v59 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1616), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v59 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    v78 = (unsigned __int64)(a1 + 1640);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_KeywordDetector_ModeEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_KeywordDetector_ModeEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1656);
    v79 = 1;
    *(GUID *)pvar = PKEY_MFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_MFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.pid;
    v60 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1648), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v60 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    v78 = (unsigned __int64)(a1 + 1672);
    v79 = 1;
    *(GUID *)pvar = PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid.fmtid;
    LODWORD(v74) = PKEY_CompositeFX_KeywordDetector_EndpointEffectClsid.pid;
    ...
    GetFxClsidsFromPropertyStore(
      ...
      (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    v78 = (unsigned __int64)(a1 + 1688);
    v79 = 1;
    *(GUID *)pvar = PKEY_EFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.fmtid;
    LODWORD(v74) = PKEY_EFX_KeywordDetector_ProcessingModes_Supported_For_Streaming.pid;
    v61 = GetProcessingModes(a3, (struct _tagpropertykey *)pvar, (unsigned int *)(a1 + 1680), (struct _GUID **)&v78 + 1);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v78);
    if ( v61 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x10000) != 0 )
  {
    ...
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v62 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
    ...
    if ( LOWORD(pvar[0]) == 31 )
    {
      v64 = CLSIDFromString((LPCOLESTR)pvar[1], &pclsid.fmtid);
      v65 = v64;
      if ( v64 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
  ...
  if ( (a4 & 0x20000) != 0 )
  {
    *(_OWORD *)pvar = 0LL;
    v74 = 0LL;
    v66 = ((__int64 (__fastcall *)(struct IPropertyStore *, void *, PROPVARIANT *))a3->lpVtbl->GetValue)(
            a3,
    ...
    if ( LOWORD(pvar[0]) == 4127 )
    {
      while ( v10 < LODWORD(pvar[1]) )
      {
        ...
        std::regex_replace<std::regex_traits<unsigned short>,unsigned short>(
          ...
          *(_QWORD *)(v74 + 8LL * v10),
          (__int64)v77);
        v68 = std::regex_replace<std::regex_traits<unsigned short>,unsigned short,std::char_traits<unsigned short>,std::allocator<unsigned short>>(
                (__int64)&pclsid,
                (__int64)&v78,
                (__int64)v76);
        std::wstring::operator=(&v78, v68);
        std::wstring::_Tidy_deallocate((__int64)&pclsid, v69);
        std::wstring::insert(&v78);
        std::basic_regex<unsigned short,std::regex_traits<unsigned short>>::basic_regex<unsigned short,std::regex_traits<unsigned short>>(
          v75,
          (__int64)&v78);
        v71 = *(_QWORD **)(a1 + 1896);
        if ( v71 == *(_QWORD **)(a1 + 1904) )
        {
        ...
        std::basic_regex<unsigned short,std::regex_traits<unsigned short>>::~basic_regex<unsigned short,std::regex_traits<unsigned short>>((__int64)v75);
        std::wstring::_Tidy_deallocate((__int64)&v78, v72);
        std::basic_regex<unsigned short,std::regex_traits<unsigned short>>::~basic_regex<unsigned short,std::regex_traits<unsigned short>>((__int64)v76);
        std::basic_regex<unsigned short,std::regex_traits<unsigned short>>::~basic_regex<unsigned short,std::regex_traits<unsigned short>>((__int64)v77);
        ++v10;
      }
    }
    PropVariantClear(pvar);
