/*
 * XREFs of ?AddEffectPackConfigurationIfApplicable@CEndpointCharacteristics@@QEAAJAEAV?$shared_ptr@$$CBUEffectPackConfiguration@@@std@@PEA_N@Z @ 0x180132AD4
 * Callers:
 ...
 *     std::_Func_impl_no_alloc__lambda_9c91384c0692fbb0a23d5e4f7048f590__long_std::shared_ptr_EffectPackConfiguration_const___&_::_Do_call @ 0x1801398F0 (std--_Func_impl_no_alloc__lambda_9c91384c0692fbb0a23d5e4f7048f590__long_std--shared_ea_1801398F0.c)
 * Callees:
        ...
        _BYTE *a3)
{
  ...
  v4 = IsEffectPackConfigurationApplicableToEndpoint;
