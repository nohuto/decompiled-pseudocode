/*
 * XREFs of ?PruneStaleProcessSubmixes@CBaseStreamGroupProxy@@IEAAXXZ @ 0x180018084
 * Callers:
...
void __fastcall CBaseStreamGroupProxy::PruneStaleProcessSubmixes(CBaseStreamGroupProxy *this)
{
  ...
  if ( v5 != v3 )
  {
    while ( ++v5 != v3 )
    {
      if ( !(unsigned __int8)lambda_92c40f897d3a9c7e927f302002ea2ff3_::operator()(v4, v5) )
      {
        v12 = 0LL;
        if ( v14 != v5 )
        {
