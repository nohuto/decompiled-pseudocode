/*
 * XREFs of ?MakeAndInitializeVolume@BluetoothControls@@YAJPEAPEAVIVolumeControlHandler@@PEAUIMMDevice@@PEBGPEAUIControlChangeNotify@@@Z @ 0x1800D561C
 * Callers:
...
__int64 __fastcall BluetoothControls::MakeAndInitializeVolume(
...
LABEL_4:
    ...
    *(_QWORD *)this = 0LL;
    ...
    if ( v13 )
    {
      ...
      {
        v15 = v14;
        v11 = Microsoft::WRL::Details::MakeAndInitialize<BluetoothControls::CBluetoothVolumeInterceptor,IVolumeControlHandler,BluetoothControls::BluetoothVolumeAndMute *>(
                this,
                &v15);
      }
      else
  ...
  return Microsoft::WRL::Details::MakeAndInitialize<BluetoothControls::BluetoothVolume,IVolumeControlHandler,IMMDevice * &,unsigned short const * &,IControlChangeNotify * &>(
           this,
           &v17,
           &v18);
}
