/*
 * XREFs of ??$_Uninitialized_move@PEAV?$shared_ptr@VEffectPack@@@std@@V?$allocator@V?$shared_ptr@VEffectPack@@@std@@@2@@std@@YAPEAV?$shared_ptr@VEffectPack@@@0@QEAV10@0PEAV10@AEAV?$allocator@V?$shared_ptr@VEffectPack@@@std@@@0@@Z @ 0x18003F204
 * Callers:
 ...
 *     ??$construct@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@V12@@?$_Default_allocator_traits@V?$allocator@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@@std@@@std@@SAXAEAV?$allocator@V?$shared_ptr@VCXvmPowerReferenceManager@@@std@@@1@QEAV?$shared_ptr@VCXvmPowerReferenceManager@@@1@$$QEAV31@@Z @ 0x1800A30D8 (--$construct@V-$shared_ptr@VCXvmPowerReferenceManager@@@std@@V12@@-$_Default_allocator_traits@V-.c)
 */
        ...
        __int64 a3)
{
  ...
  std::_Destroy_range<std::allocator<std::shared_ptr<EffectPack>>>(a3, a3);
  return a3;
}
