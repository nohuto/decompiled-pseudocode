/*
 * XREFs of ?_Skip@?$_Matcher@PEBGGV?$regex_traits@G@std@@PEBG@std@@QEAAPEBGPEBG0PEAV_Node_base@2@@Z @ 0x180148E6C
 * Callers:
 ...
 * Callees:
 *     __std_find_trivial_2 @ 0x1800A3760 (__std_find_trivial_2.c)
 *     ??$_Compare@PEBGPEBGV?$regex_traits@G@std@@@std@@YAPEBGPEBG000AEBV?$regex_traits@G@0@W4syntax_option_type@regex_constants@0@@Z @ 0x18012E710 (--$_Compare@PEBGPEBGV-$regex_traits@G@std@@@std@@YAPEBGPEBG000AEBV-$regex_traits@G@0@W4syntax_op.c)
 *     ??$_Lookup_coll@PEBGG@std@@YAPEBGPEBG0PEBU?$_Sequence@G@0@@Z @ 0x18012EEB8 (--$_Lookup_coll@PEBGG@std@@YAPEBGPEBG0PEBU-$_Sequence@G@0@@Z.c)
 ...
 *     ??$_Lookup_range@G@std@@YA_NIPEBU?$_Buf@G@0@@Z @ 0x18012F0A8 (--$_Lookup_range@G@std@@YA_NIPEBU-$_Buf@G@0@@Z.c)
 *     ?isctype@?$_Regex_traits@G@std@@QEBA_NGF@Z @ 0x18013AC1C (-isctype@-$_Regex_traits@G@std@@QEBA_NGF@Z.c)
