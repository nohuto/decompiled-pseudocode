/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_56664216@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800CD7FC
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v8;
  ...
  v10 = (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestLoc02>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_TestLoc02>::GetImpl'::`2'::impl)
