/*
 * XREFs of ?ForEachInitializedApoInterface@CCompositeSystemEffect@@UEAAJ$$QEAV?$function@$$A6AJPEAUIAudioProcessingObject@@U_GUID@@I@Z@std@@@Z @ 0x18004D9B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
      ATL::_AtlRaiseException(0xC000008C, a2);
      JUMPOUT(0x18004DAA4LL);
    }
    v12 = (*(__int64 (__fastcall **)(__int64, __int64 *, _OWORD *, int *))(*(_QWORD *)v11 + 16LL))(v11, &v17, v14, &v16);
    v13 = v12;
    if ( v12 < 0 )
      break;
    ++v2;
