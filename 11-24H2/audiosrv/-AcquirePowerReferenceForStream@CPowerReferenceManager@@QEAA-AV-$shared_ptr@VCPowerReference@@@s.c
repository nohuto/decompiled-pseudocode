/*
 * XREFs of ?AcquirePowerReferenceForStream@CPowerReferenceManager@@QEAA?AV?$shared_ptr@VCPowerReference@@@std@@PEAVCVADServer@@@Z @ 0x180010DC4
 * Callers:
 ...
 *     ?QueryState@CVADServer@@QEAAJPEAH00@Z @ 0x18006DE70 (-QueryState@CVADServer@@QEAAJPEAH00@Z.c)
 ...
 *     std::find_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_std::shared_ptr_CXvmPowerReferenceManager_________lambda_99dc9de587906d6f38e02b4d1e0ae12d___ @ 0x180109700 (std--find_if_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_std--shared_ptr_CXvmPower.c)
