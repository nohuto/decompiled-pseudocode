/*
 * XREFs of _CMulticastSessionManager::RuntimeClassInitialize_::_1_::catch$3 @ 0x180170573
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMulticastSessionManager::RuntimeClassInitialize_::_1_::catch_3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
