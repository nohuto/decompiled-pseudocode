/*
 * XREFs of ??1?$unique_ptr@UAUDIO_DEVICE_MODE_DESCRIPTOR@@U?$default_delete@UAUDIO_DEVICE_MODE_DESCRIPTOR@@@std@@@std@@QEAA@XZ @ 0x18001A144
 * Callers:
 ...
 *     _InitializeStreamAndModeDescriptors_::_1_::dtor$18 @ 0x18016DA8B (_InitializeStreamAndModeDescriptors_--_1_--dtor$18.c)
 * Callees:
