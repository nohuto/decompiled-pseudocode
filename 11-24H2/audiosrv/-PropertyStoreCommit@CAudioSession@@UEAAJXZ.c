/*
 * XREFs of ?PropertyStoreCommit@CAudioSession@@UEAAJXZ @ 0x1800C2560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::PropertyStoreCommit(CAudioSession *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x58u, (__int64)&WPP_ea93f1868512325b454513e390c361b8_Traceguids, 0LL);
  }
