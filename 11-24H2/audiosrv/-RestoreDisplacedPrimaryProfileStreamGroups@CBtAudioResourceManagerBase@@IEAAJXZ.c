/*
 * XREFs of ?RestoreDisplacedPrimaryProfileStreamGroups@CBtAudioResourceManagerBase@@IEAAJXZ @ 0x1800E0B04
 * Callers:
 *     wil::details::lambda_call__lambda_4794dd8919ededed270e66c32cba0f6f___::_lambda_call__lambda_4794dd8919ededed270e66c32cba0f6f___ @ 0x1800DAE28 (wil--details--lambda_call__lambda_4794dd8919ededed270e66c32cba0f6f___--_lambda_call__lambda_4794.c)
...
LABEL_39:
  ...
  while ( (*(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)*v14 + 96LL))(*v14) == 1 )
  {
LABEL_37:
    if ( ++v14 == (_QWORD *)v15 )
    {
  ...
  v67 = 0LL;
  v68 = 0LL;
  v17 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int128 *))(**((_QWORD **)v6 + 13) + 120LL))(
          *((_QWORD *)v6 + 13),
          *v14,
          &v67);
  if ( v17 < 0 )
...
LABEL_34:
  ...
  while ( 1 )
  {
    ...
    if ( !v20 )
      break;
    (*(void (__fastcall **)(_QWORD, __int64 (__fastcall ***)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)*v14 + 72LL))(
      *v14,
      v20);
    v79 = 0LL;
    v80 = 0LL;
    v21 = (*(__int64 (__fastcall **)(_QWORD, __int128 *))(*(_QWORD *)*v14 + 240LL))(*v14, &v79);
    v22 = v21;
    if ( v21 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
      ...
      if ( (_QWORD)v67 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v67, *((__int64 *)&v67 + 1));
        std::_Deallocate<16,0>((char *)v67, (const struct std::nothrow_t *)((v68 - v67) & 0xFFFFFFFFFFFFFFF8uLL));
        v67 = 0LL;
        v68 = 0LL;
      }
      if ( (_QWORD)v69 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v69, *((__int64 *)&v69 + 1));
        std::_Deallocate<16,0>((char *)v69, (const struct std::nothrow_t *)((v70 - v69) & 0xFFFFFFFFFFFFFFF8uLL));
        v69 = 0LL;
        v70 = 0LL;
      }
    ...
    v23 = (*(__int64 (__fastcall **)(struct IDeviceGraphManager *, _QWORD, _QWORD))(*(_QWORD *)g_DeviceGraphManager
                                                                                  + 40LL))(
            g_DeviceGraphManager,
            *v18,
            *v14);
