/*
 * XREFs of ?_Copy@?$_Func_impl_no_alloc@V_lambda_1d5316dfea7a7918102eba328e746dc2_@@X$$V@std@@EEBAPEAV?$_Func_base@X$$V@2@PEAX@Z @ 0x1800D8A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_1d5316dfea7a7918102eba328e746dc2_,void,>::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r8
