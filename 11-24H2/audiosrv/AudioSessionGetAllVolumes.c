/*
 * XREFs of AudioSessionGetAllVolumes @ 0x180077EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetAllVolumes(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  v12 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v5 + 352LL))(v5, a2, a3);
  v13 = v12;
  if ( v12 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetAllVolumes", 2306, v12);
