/*
 * XREFs of ?SerializeMulticastSessionsForRpc@BluetoothBroadcastProvider@@UEAAJAEAV?$unique_ptr@$$BY0A@U_MulticastSessionConfiguration@@U?$function_deleter@P6AXPEAX@Z$1?MIDL_user_free@@YAX0@Z@wil@@@wistd@@PEAI@Z @ 0x1800E74C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothBroadcastProvider::SerializeMulticastSessionsForRpc(__int64 a1, void **a2, _DWORD *a3)
{
...
LABEL_24:
              ...
              v28 = 0;
              lambda_9d62ddb24c480631ca4fb973be46ca08_::operator()(v27);
              goto LABEL_27;
            }
            v17 = *(_QWORD **)(v8 + 24);
            v18 = *(_QWORD **)(v8 + 32);
