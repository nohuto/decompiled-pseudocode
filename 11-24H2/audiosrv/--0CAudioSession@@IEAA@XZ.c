/*
 * XREFs of ??0CAudioSession@@IEAA@XZ @ 0x18000AFE8
 * Callers:
...
CAudioSession *__fastcall CAudioSession::CAudioSession(CAudioSession *this)
{
  ...
  *((_DWORD *)this + 84) = 0;
  ...
  std::forward_list<Microsoft::WRL::ComPtr<ISaDeviceProxy>>::forward_list<Microsoft::WRL::ComPtr<ISaDeviceProxy>>((char *)this + 400);
  *((_DWORD *)this + 102) = 0;
  *((_BYTE *)this + 412) = 0;
  *((_QWORD *)this + 52) = 0LL;
  *((_QWORD *)this + 53) = 0LL;
