/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_d59dcad96ba54600a1284eacbd3c7034_@@X_N@std@@EEAAX$$QEA_N@Z @ 0x1800D8D40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc<_lambda_d59dcad96ba54600a1284eacbd3c7034_,void,bool>::_Do_call(
        __int64 a1,
        char *a2)
{
  char v3; // di
