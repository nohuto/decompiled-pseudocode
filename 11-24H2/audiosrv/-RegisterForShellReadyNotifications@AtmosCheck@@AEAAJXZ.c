/*
 * XREFs of ?RegisterForShellReadyNotifications@AtmosCheck@@AEAAJXZ @ 0x1801521A4
 * Callers:
...
LABEL_5:
  ...
  if ( !this[30] )
  {
    lambda_4accf571eb38f7e0aa8a7d61bf2f02b1_::_lambda_4accf571eb38f7e0aa8a7d61bf2f02b1_(&v12, &v10, (__int64)this);
    wistd::function_void___cdecl_void__::function_void___cdecl_void____lambda_383ae521043a10c2e2d9282b6295b11b__void_((__int64)v14);
