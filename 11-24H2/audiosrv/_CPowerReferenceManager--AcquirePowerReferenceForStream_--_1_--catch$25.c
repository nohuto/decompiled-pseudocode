/*
 * XREFs of _CPowerReferenceManager::AcquirePowerReferenceForStream_::_1_::catch$25 @ 0x18016896C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPowerReferenceManager::AcquirePowerReferenceForStream_::_1_::catch_25(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
