        ...
        __int64 a8)
{
  ...
  try
  {
    ...
    if ( v12 )
    {
      v23 = *a1;
      v30 = *(_OWORD *)(a3 + 48);
      if ( !(*((unsigned __int8 (__fastcall **)(const unsigned __int16 **, __int128 *))v23 + 19))(a1, &v30) )
      {
        wil::details::in1diag3::Return_Hr(
          retaddr,
          (void *)0x3FF,
