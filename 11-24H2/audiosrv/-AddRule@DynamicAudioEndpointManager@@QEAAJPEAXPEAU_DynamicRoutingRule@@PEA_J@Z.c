/*
 * XREFs of ?AddRule@DynamicAudioEndpointManager@@QEAAJPEAXPEAU_DynamicRoutingRule@@PEA_J@Z @ 0x1801256F4
 * Callers:
 *     PolicyConfigAddDynamicRoutingRule @ 0x180107410 (PolicyConfigAddDynamicRoutingRule.c)
 * Callees:
