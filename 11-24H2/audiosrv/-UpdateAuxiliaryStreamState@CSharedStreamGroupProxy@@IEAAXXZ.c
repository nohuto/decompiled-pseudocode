/*
 * XREFs of ?UpdateAuxiliaryStreamState@CSharedStreamGroupProxy@@IEAAXXZ @ 0x1800A047C
 * Callers:
 ...
 *     ?OnProcessSubmixStarted@CSharedStreamGroupProxy@@UEAAJPEAUIProcessSubmixProxy@@@Z @ 0x180068310 (-OnProcessSubmixStarted@CSharedStreamGroupProxy@@UEAAJPEAUIProcessSubmixProxy@@@Z.c)
 *     ?OnProcessSubmixStopped@CSharedStreamGroupProxy@@UEAAJPEAUIProcessSubmixProxy@@@Z @ 0x18006A050 (-OnProcessSubmixStopped@CSharedStreamGroupProxy@@UEAAJPEAUIProcessSubmixProxy@@@Z.c)
  ...
  if ( *((_DWORD *)this + 92) )
  {
    ...
    *((_BYTE *)this + 416) = 1;
    ...
    if ( *v3 <= 4u || !tlgKeywordOn((__int64)v3, 512LL) )
      goto LABEL_12;
    v7 = (unsigned __int8 *)&unk_1801ACDAA;
  }
  else
  {
    if ( !*((_BYTE *)this + 416) )
    ...
    *((_BYTE *)this + 416) = 0;
    ...
    if ( *v8 <= 4u || !tlgKeywordOn((__int64)v8, 512LL) )
      goto LABEL_12;
    v7 = (unsigned __int8 *)&unk_1801ACD7D;
  }
