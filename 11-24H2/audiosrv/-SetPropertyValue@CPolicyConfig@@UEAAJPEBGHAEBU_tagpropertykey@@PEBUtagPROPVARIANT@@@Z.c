/*
 * XREFs of ?SetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEBUtagPROPVARIANT@@@Z @ 0x180059100
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPROPVARIANT *a5)
{
  ...
  if ( !a2 || !a5 )
  {
    v7 = -2147467261;
LABEL_4:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyValue", 1475, v7);
    goto LABEL_5;
  }
