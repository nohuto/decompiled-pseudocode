/*
 * XREFs of ?DoExclusiveModePrimaryProfileSaDevicesExist@CBtAudioResourceManagerBase@@IEAA_NPEAVCEndpointStore@@@Z @ 0x1800DC66C
 * Callers:
        ...
        struct CEndpointStore *a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    {
      v6 = *(unsigned __int8 (__fastcall **)(CBtAudioResourceManagerBase *, __int128 *))(*(_QWORD *)this + 144LL);
      v9 = *(_OWORD *)(*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**(_QWORD **)i + 40LL))(*(_QWORD *)i, v10);
      if ( v6(this, &v9) )
      {
        if ( (_QWORD)v7 )
        {
          std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v7, *((__int64 *)&v7 + 1));
