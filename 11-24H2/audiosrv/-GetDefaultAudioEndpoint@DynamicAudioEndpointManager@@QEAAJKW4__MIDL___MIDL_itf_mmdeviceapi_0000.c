/*
 * XREFs of ?GetDefaultAudioEndpoint@DynamicAudioEndpointManager@@QEAAJKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@PEA_NPEAPEAUIMMDevice@@@Z @ 0x180089A34
 * Callers:
 ...
 *     ?Find@?$CAtlList@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEBAPEAU__POSITION@@PEBGPEAU3@@Z @ 0x18005A210 (-Find@-$CAtlList@V-$CStringT@GV-$StrTraitATL@GV-$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V-$CElementTrait.c)
        ...
        struct IMMDevice **a6)
{
  ...
  __int64 v11; // rdi
  __int64 v12; // rax
  int (__fastcall *v13)(__int64, _QWORD, _QWORD, _QWORD, _BYTE *, __int64 *); // rbx
  __int64 v14; // rdi
  int (__fastcall *v15)(__int64, _QWORD, _QWORD, _QWORD, _BYTE *, __int64 *); // rbx
  int DeviceFromDeviceId; // ebx
  __int64 v17; // rdx
  unsigned __int16 *v19; // [rsp+48h] [rbp-29h] BYREF
  __int64 v20; // [rsp+50h] [rbp-21h] BYREF
  __int64 v21; // [rsp+58h] [rbp-19h] BYREF
  unsigned __int16 *v22; // [rsp+60h] [rbp-11h] BYREF
  __int128 v23; // [rsp+68h] [rbp-9h] BYREF
  __int64 v24; // [rsp+78h] [rbp+7h]
  __int128 v25; // [rsp+80h] [rbp+Fh]
...
LABEL_27:
  ...
  v10 = *(unsigned __int16 **)(a1 + 48 * ((int)a4 + 6LL * (int)a3) + 24);
  v22 = v10;
  while ( v22 )
  {
    v21 = 0LL;
    v11 = *ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::GetNext((__int64)v10, (_QWORD **)&v22);
    v20 = 0LL;
    if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v11 + 32LL))(v11, &v21) < 0 )
    {
      v13 = *(int (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, _BYTE *, __int64 *))(*(_QWORD *)v11 + 24LL);
      wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
        (void **)&v20,
        0LL);
      if ( v13(v11, a2, a3, a4, a5, &v20) >= 0
        && v20
              ...
              v20) )
      {
        ...
        if ( !v19 )
          break;
LABEL_24:
        DeviceFromDeviceId = DynamicAudioEndpointManager::GetDeviceFromDeviceId(v10, a6);
        goto LABEL_28;
      }
    }
    else
    {
      v12 = ATL::CAtlList<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>>::NewNode(
              &v23,
              v21,
              *((_QWORD *)&v23 + 1));
      if ( *((_QWORD *)&v23 + 1) )
  ...
  v22 = *(unsigned __int16 **)(a1 + 600);
  if ( v22 )
  {
    while ( 1 )
    {
      v14 = *ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::GetNext((__int64)v10, (_QWORD **)&v22);
      v20 = 0LL;
      v15 = *(int (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, _BYTE *, __int64 *))(*(_QWORD *)v14 + 24LL);
      wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
        (void **)&v20,
        0LL);
      if ( v15(v14, a2, a3, a4, a5, &v20) >= 0
        && v20
        && !ATL::CAtlList<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>>::Find(
              &v23,
              v20) )
...
LABEL_20:
  DeviceFromDeviceId = CDefaultDeviceManager::GetDefaultEndpoint((_DWORD)v10, a3, a4, (unsigned int)&v23, (__int64)a6);
  if ( DeviceFromDeviceId >= 0 && a5 )
    *a5 = 0;
LABEL_28:
  wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>((void **)&v19);
  ATL::CAtlList<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>>::RemoveAll((__int64)&v23);
