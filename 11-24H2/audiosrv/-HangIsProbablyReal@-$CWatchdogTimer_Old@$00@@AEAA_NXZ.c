/*
 * XREFs of ?HangIsProbablyReal@?$CWatchdogTimer_Old@$00@@AEAA_NXZ @ 0x1800AF6D8
 * Callers:
...
char __fastcall CWatchdogTimer_Old<1>::HangIsProbablyReal(__int64 a1)
{
  _DWORD *v2; // rcx
  int v3; // ecx
  _DWORD *v4; // rcx
  ...
  v12 = 0;
  if ( (int)CWatchdogTimer_Old<1>::ProcessHasBeenRunningLongEnough(a1, &v12) < 0 )
    return 0;
  if ( !v12 )
  {
