/*
 * XREFs of s_pbmRegisterPlaybackManagerNotifications @ 0x180104C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmRegisterPlaybackManagerNotifications(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  {
    v3 = PbmRegisterPlaybackManagerNotifications(a1, a2, a3);
  }
  else if ( !a2 && g_PolicyManager )
  {
    ...
    v3 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64 *))(*(_QWORD *)g_PolicyManager + 32LL))(
           ...
           &v20);
    if ( v3 >= 0 )
      v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v20 + 328LL))(v20);
