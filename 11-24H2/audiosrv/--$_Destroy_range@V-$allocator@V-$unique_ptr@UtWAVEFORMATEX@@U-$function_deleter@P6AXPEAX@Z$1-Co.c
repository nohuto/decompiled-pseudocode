 ...
 *     _std::vector_wistd::unique_ptr_tWAVEFORMATEX_wil::function_deleter_void_(__cdecl_)(void__)_&CoTaskMemFree____std::allocator_wistd::unique_ptr_tWAVEFORMATEX_wil::function_deleter_void_(__cdecl_)(void__)_&CoTaskMemFree_______::_Emplace_reallocate_wistd::unique_ptr_tWAVEFORMATEX_wil::function_deleter_void_(__cdecl_)(void__)_&CoTaskMemFree______::_1_::catch$0 @ 0x18016C5B1 (_std--vector_wistd--unique_ptr_tWAVEFORMATEX_wil--function_deleter_void_(__cdecl_)(void__)_-CoTa.c)
 * Callees:
