/*
 * XREFs of ?GetInstance@CStreamConnectionManagerImpl@@SA?AV?$shared_ptr@VCStreamConnectionManager@@@std@@XZ @ 0x180118DE0
 * Callers:
...
RTL_SRWLOCK *__fastcall CStreamConnectionManagerImpl::GetInstance(RTL_SRWLOCK *a1)
{
  ...
  *(_OWORD *)v16 = 0LL;
  ...
  else
  {
    ...
    if ( v9 && (int)CMonitorManager::Initialize(v9, 0x12u, 9uLL, &dword_18019A8E0) >= 0 )
    {
      if ( v7 )
      {
