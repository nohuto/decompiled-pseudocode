/*
 * XREFs of AudioSessionMeterGetPeakValue @ 0x1800792D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetPeakValue(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 232LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetPeakValue", 2335, v10);
