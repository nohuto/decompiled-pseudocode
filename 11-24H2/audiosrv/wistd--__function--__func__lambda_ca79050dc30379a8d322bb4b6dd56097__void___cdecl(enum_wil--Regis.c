/*
 * XREFs of wistd::__function::__func__lambda_ca79050dc30379a8d322bb4b6dd56097__void___cdecl(enum_wil::RegistryChangeKind)_::operator() @ 0x180117740
 * Callers:
 *     <none>
 * Callees:
 *     ?OnAudioMirrorEnabledChange@CMonitorManager@@AEAAXXZ @ 0x18011A6F4 (-OnAudioMirrorEnabledChange@CMonitorManager@@AEAAXXZ.c)
 *     ?UpdateAudioMirroringEnabled@CMonitorManager@@AEAAJPEA_N@Z @ 0x18011BB80 (-UpdateAudioMirroringEnabled@CMonitorManager@@AEAAJPEA_N@Z.c)
