/*
 * XREFs of ??$make_wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBW4_PO_STANDBY_AUDIO_POLICY@@@Z@wistd@@KPEAPEAU?$wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@01@@Z @ 0x1800CB278
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( !v6
    || (v7 = wil::details::wnf_subscription_state<enum _PO_STANDBY_AUDIO_POLICY>::wnf_subscription_state<enum _PO_STANDBY_AUDIO_POLICY>(
               v6,
               a2)) == 0LL )
  {
    v9 = -2147024882;
  ...
  if ( v12 != -1 )
    goto LABEL_9;
  v17 = 0;
  v9 = NtQueryWnfStateData(&WNF_PO_STANDBY_AUDIO_POLICY, 0LL, 0LL, &v12, 0LL, &v17) | 0x10000000;
