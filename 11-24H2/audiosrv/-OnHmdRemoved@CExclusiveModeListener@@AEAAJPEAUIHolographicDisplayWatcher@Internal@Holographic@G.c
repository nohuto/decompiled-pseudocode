/*
 * XREFs of ?OnHmdRemoved@CExclusiveModeListener@@AEAAJPEAUIHolographicDisplayWatcher@Internal@Holographic@Graphics@Windows@@PEAUIHolographicDisplay@456@@Z @ 0x18014C3C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( *v9 > 4u )
  {
    ...
    v27 = 16;
    v28 = 0;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v9, byte_1801B2890, 0LL, 0LL, 4, (__int64)v25);
  }
