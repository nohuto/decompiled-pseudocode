/*
 * XREFs of asm_GetApplicationSubmixes$catch$7 @ 0x18016D220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_GetApplicationSubmixes_catch_7(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
