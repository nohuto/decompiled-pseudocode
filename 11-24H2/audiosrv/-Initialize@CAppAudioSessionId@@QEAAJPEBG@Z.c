/*
 * XREFs of ?Initialize@CAppAudioSessionId@@QEAAJPEBG@Z @ 0x18001A5F8
 * Callers:
 ...
 *     ??$AtlConvAllocMemory@G@ATL@@YAXPEAPEAGHPEAGH@Z @ 0x18001C208 (--$AtlConvAllocMemory@G@ATL@@YAXPEAPEAGHPEAGH@Z.c)
...
__int64 __fastcall CAppAudioSessionId::Initialize(CAppAudioSessionId *this, unsigned __int16 *a2)
{
  ...
  _BYTE v51[8]; // [rsp+68h] [rbp-170h] BYREF
...
LABEL_28:
  ...
  if ( v18 - 24 != (char *)v20 )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((__int64 *)&v47, v18, *((_DWORD *)v18 - 4));
    }
  }
  v22 = (_QWORD *)(v50 - 24);
