/*
 * XREFs of _lambda_c90e8a76b02d1fc01a85dd002f968322_::operator() @ 0x180109C40
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_c90e8a76b02d1fc01a85dd002f968322__void_::_Do_call @ 0x18010A500 (std--_Func_impl_no_alloc__lambda_c90e8a76b02d1fc01a85dd002f968322__void_--_Do_call.c)
 * Callees:
...
char __fastcall lambda_c90e8a76b02d1fc01a85dd002f968322_::operator()(unsigned int *a1)
{
  ...
  if ( result )
  {
    ...
    v8 = (struct _RTL_CRITICAL_SECTION *)(*((_QWORD *)a1 + 3) + 384LL);
    EnterCriticalSection(v8);
    v11 = v8;
    wil::com_ptr_t<IMMDevice,wil::err_returncode_policy>::reset((__int64 *)(*((_QWORD *)a1 + 3) + 424LL));
