/*
 * XREFs of ??1?$com_ptr_t@VBluetoothBroadcastProvider@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800E4000
 * Callers:
 ...
 *     _BluetoothBroadcastProvider::OnEndpointPropertyChanged_::_1_::dtor$1 @ 0x18016EF6C (_BluetoothBroadcastProvider--OnEndpointPropertyChanged_--_1_--dtor$1.c)
 *     _BluetoothBroadcastProvider::OnEndpointStateChanged_::_1_::dtor$1 @ 0x18016EFCD (_BluetoothBroadcastProvider--OnEndpointStateChanged_--_1_--dtor$1.c)
 * Callees:
