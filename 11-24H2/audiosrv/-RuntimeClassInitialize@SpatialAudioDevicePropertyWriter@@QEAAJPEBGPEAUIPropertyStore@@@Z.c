/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyWriter@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x18012B5A0
 * Callers:
    ...
    if ( Instance >= 0 )
    {
      ...
      if ( Instance >= 0 )
      {
        ...
        Instance = CoCreateInstance(
                     ...
                     (LPVOID *)this + 13);
        v6 = Instance;
        if ( Instance >= 0 || (unsigned int)dword_1801D82E8 <= 2 )
          goto LABEL_28;
        v29 = 165;
        goto LABEL_27;
      }
