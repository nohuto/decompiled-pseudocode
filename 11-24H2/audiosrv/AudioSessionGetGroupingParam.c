/*
 * XREFs of AudioSessionGetGroupingParam @ 0x1800784B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetGroupingParam(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 216LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetGroupingParam", 1958, v10);
