/*
 * XREFs of ?StateCheckExpiredCallback@CAudioSession@@AEAAXXZ @ 0x180018CF8
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_c25bfbbe3eff8159fd381be65f1c93f0__void_::_Do_call @ 0x180061BF0 (std--_Func_impl_no_alloc__lambda_c25bfbbe3eff8159fd381be65f1c93f0__void_--_Do_call.c)
 * Callees:
...
void __fastcall CAudioSession::StateCheckExpiredCallback(CAudioSession *this)
{
  ...
  unsigned __int16 *v12; // [rsp+68h] [rbp-9h]
    ...
    && (*(_QWORD *)(v3 + 24) & 0x200LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    EtwEventWriteTransfer(*(_QWORD *)(v3 + 32), &v10, 0LL, 0LL);
  }
