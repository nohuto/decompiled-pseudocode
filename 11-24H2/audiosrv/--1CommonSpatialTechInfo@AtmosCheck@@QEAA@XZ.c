/*
 * XREFs of ??1CommonSpatialTechInfo@AtmosCheck@@QEAA@XZ @ 0x18014FD80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AtmosCheck::CommonSpatialTechInfo::~CommonSpatialTechInfo(AtmosCheck::CommonSpatialTechInfo *this)
{
  ...
  v2 = (SpatialAudioAppDetails *)*((_QWORD *)this + 6);
  if ( v2 )
  {
    std::_Destroy_range<std::allocator<SpatialAudioAppDetails>>(v2, *((SpatialAudioAppDetails **)this + 7));
    std::_Deallocate<16,0>(
      *((char **)this + 6),
      (const struct std::nothrow_t *)((*((_QWORD *)this + 8) - *((_QWORD *)this + 6)) & 0xFFFFFFFFFFFFFFF0uLL));
    *((_QWORD *)this + 6) = 0LL;
    *((_QWORD *)this + 7) = 0LL;
    *((_QWORD *)this + 8) = 0LL;
  }
  ...
  wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>((void **)this + 4);
