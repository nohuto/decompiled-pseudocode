/*
 * XREFs of ?ProcessHasBeenRunningLongEnough@?$CWatchdogTimer_Old@$00@@AEAAJPEA_N@Z @ 0x1800AFE34
 * Callers:
...
__int64 __fastcall CWatchdogTimer_Old<1>::ProcessHasBeenRunningLongEnough(__int64 a1, bool *a2)
{
