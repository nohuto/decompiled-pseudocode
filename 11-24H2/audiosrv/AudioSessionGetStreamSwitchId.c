/*
 * XREFs of AudioSessionGetStreamSwitchId @ 0x180078E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetStreamSwitchId(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 128LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetStreamSwitchId", 1579, v10);
