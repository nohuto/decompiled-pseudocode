/*
 * XREFs of ?VolumeStepUp@BluetoothVolume@BluetoothControls@@UEAAJPEBU_GUID@@PEAH@Z @ 0x1800D88B0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a3)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)v5,
                      &v8);
  LODWORD(v5) = (*(__int64 (__fastcall **)(__int64, const struct _GUID *, int *))(*(_QWORD *)*TargetedControl + 192LL))(
                  *TargetedControl,
                  a2,
                  a3);
