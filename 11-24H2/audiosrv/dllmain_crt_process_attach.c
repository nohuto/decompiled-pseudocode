/*
 * XREFs of dllmain_crt_process_attach @ 0x1800A3A78
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x1800A403C (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800A4110 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800A41B0 (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800A4A80 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800A4AA8 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800A4ACC (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x1800A4AEC (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x1800A4C54 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800A4D16 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800A4D22 (_initterm_e_0.c)
