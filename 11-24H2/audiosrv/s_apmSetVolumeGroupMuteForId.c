/*
 * XREFs of s_apmSetVolumeGroupMuteForId @ 0x180104070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmSetVolumeGroupMuteForId(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_Servicing_EnableLKDForAudio>::GetImpl'::`2'::impl) )
  {
    ...
    std::unique_ptr<CWatchdogTimer<1>>::reset(v23, v7);
  }
  else
  {
    ...
    std::unique_ptr<CWatchdogTimer_Old<1>>::reset(&v22, v12);
  }
  ...
  {
    LOBYTE(v17) = a4 != 0;
    v18 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)v21 + 56LL))(v21, a2, a3, v17);
    v19 = v18;
    if ( v18 < 0 )
