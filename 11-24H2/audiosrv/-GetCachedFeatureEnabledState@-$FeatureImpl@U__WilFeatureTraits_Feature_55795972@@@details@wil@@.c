/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800CCB70
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CF0BC (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@QEAAX_NW4Reportin.c)
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800D0CE8 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@QEAA_NW4R.c)
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)Feature_55795972__descriptor;
  if ( (v3 & 6) != 6 )
  {
    ...
    v15 = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_55795972>::GetCurrentFeatureEnabledState(v6, &v16, &v15);
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i | 0x40000;
      ...
      v11 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_55795972__descriptor, v10, i);
      if ( i == v11 )
        break;
    }
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (Source[1] = 0,
            Source[0] = 3,
            v14 = Feature_55795972__descriptor,
            !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_1801DA6A8, Source)) )
      {
        _InterlockedAnd((volatile signed __int32 *)Feature_55795972__descriptor, 0xFFFFFFFB);
      }
