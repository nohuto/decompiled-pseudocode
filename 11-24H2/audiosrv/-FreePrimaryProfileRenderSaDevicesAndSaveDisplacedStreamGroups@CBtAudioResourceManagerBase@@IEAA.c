/*
 * XREFs of ?FreePrimaryProfileRenderSaDevicesAndSaveDisplacedStreamGroups@CBtAudioResourceManagerBase@@IEAAJPEAVCEndpointStore@@PEA_N@Z @ 0x1800DCBA0
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( *(_QWORD *)v50 != *(_QWORD *)&v50[2] )
    {
      do
      {
        ...
        v55 = *(_OWORD *)(*(__int64 (__fastcall **)(_QWORD, __int64 *))(*(_QWORD *)*v15 + 40LL))(*v15, v62);
        if ( !v16(this, &v55) )
        {
          if ( (*(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)*v15 + 96LL))(*v15) == 1 )
    ...
    if ( v15 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>((__int64)v15, v14);
      std::_Deallocate<16,0>(
        *(char **)v50,
        (const struct std::nothrow_t *)((v51 - *(_QWORD *)v50) & 0xFFFFFFFFFFFFFFF8uLL));
    }
      ...
      if ( v18 < 0 )
      {
        ...
        if ( v24 )
        {
          do
          {
            ...
            std::_Deallocate<16,0>((char *)v24, (const struct std::nothrow_t *)0x10);
            v24 = v25;
          }
          while ( v25 );
        }
        ...
        if ( v26 )
        {
          do
          {
            ...
            std::_Deallocate<16,0>((char *)v26, (const struct std::nothrow_t *)0x10);
            v26 = v27;
          }
          while ( v27 );
        }
        ...
        if ( (v9 & 0x80000000) != 0 )
        {
          ...
          if ( v42 )
          {
            do
            {
              ...
              std::_Deallocate<16,0>((char *)v42, (const struct std::nothrow_t *)0x10);
              v42 = v43;
            }
            while ( v43 );
          }
          ...
          if ( v44 )
          {
            do
            {
              ...
              std::_Deallocate<16,0>((char *)v44, (const struct std::nothrow_t *)0x10);
              v44 = v45;
            }
            while ( v45 );
          }
        ...
        if ( v35 < 0 )
        {
          ...
          if ( v38 )
          {
            do
            {
              ...
              std::_Deallocate<16,0>((char *)v38, (const struct std::nothrow_t *)0x10);
              v38 = v39;
            }
            while ( v39 );
          }
          ...
          if ( v40 )
          {
            do
            {
              ...
              std::_Deallocate<16,0>((char *)v40, (const struct std::nothrow_t *)0x10);
              v40 = v41;
            }
            while ( v41 );
          }
    ...
    if ( v46 )
    {
      do
      {
        ...
        std::_Deallocate<16,0>((char *)v46, (const struct std::nothrow_t *)0x10);
        v46 = v47;
      }
      while ( v47 );
    }
  ...
  else
  {
    ...
    if ( v10 )
    {
      do
      {
        ...
        std::_Deallocate<16,0>((char *)v10, (const struct std::nothrow_t *)0x10);
        v10 = v6;
      }
      while ( v6 );
    }
    ...
    if ( v11 )
    {
      do
      {
        ...
        std::_Deallocate<16,0>((char *)v11, (const struct std::nothrow_t *)0x10);
        v11 = v12;
      }
      while ( v12 );
    }
