/*
 * XREFs of ?GetDevicePipeFormat@EffectPack@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@@Z @ 0x18002C1E0
 * Callers:
 ...
 *     ?reset@?$unique_struct@UtagPROPVARIANT@@P6AJPEAU1@@Z$1?PropVariantClear@@YAJ0@ZP6AX0@Z$1?PropVariantInit@@YAX0@Z@wil@@QEAAXXZ @ 0x1800720C4 (-reset@-$unique_struct@UtagPROPVARIANT@@P6AJPEAU1@@Z$1-PropVariantClear@@YAJ0@ZP6AX0@Z$1-PropVar.c)
        ...
        struct tWAVEFORMATEX **a4)
{
  ...
  int v23; // eax
  struct _RTL_CRITICAL_SECTION *v24; // [rsp+20h] [rbp-50h] BYREF
  ...
  *a4 = 0LL;
  ...
  for ( i = 0; i < 0xA; ++i )
  {
    v8 = (_QWORD *)((char *)&unk_18018FED0 + 16 * i);
    v9 = *v8 - v26;
    if ( *v8 == (_QWORD)v26 )
      v9 = v8[1] - *((_QWORD *)&v26 + 1);
    if ( !v9 )
    {
      ...
      *(_QWORD *)&v26 = v11;
      ReadFormatProperty(*(_QWORD *)(*((_QWORD *)this + 198) + 72LL), (__int64)&v27, (PROPVARIANT *)&pvar);
      if ( v11 )
