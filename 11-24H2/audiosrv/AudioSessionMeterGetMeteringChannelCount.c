/*
 * XREFs of AudioSessionMeterGetMeteringChannelCount @ 0x1800791A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetMeteringChannelCount(__int64 *a1, __int64 a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 240LL))(v3, a2);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetMeteringChannelCount", 2364, v10);
