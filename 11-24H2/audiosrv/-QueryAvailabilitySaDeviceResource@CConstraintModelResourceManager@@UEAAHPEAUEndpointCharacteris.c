/*
 * XREFs of ?QueryAvailabilitySaDeviceResource@CConstraintModelResourceManager@@UEAAHPEAUEndpointCharacteristicsDescriptor@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@K@Z @ 0x1800EE800
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  v6 = 0;
  if ( !CConstraintModelResourceManager::EndpointResourceValidity(this, *a2) )
    return v6 >= 0;
  ...
  v41 = *a3;
  v13 = EffectPack::TranslateDeviceConnectorModeToStreamingConnectorMode(v11, &v42, a4, &v41);
  v14 = v39;
  v41 = *v13;
...
LABEL_7:
  ...
  if ( v36 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v29 = (unsigned __int8 *)&unk_1801ABCCD;
    }
    else
    {
      ...
      if ( **((_DWORD **)v25 + 1) <= 4u || !tlgKeywordOn(*((_QWORD *)v25 + 1), 512LL) )
        goto LABEL_27;
      v28 = *a2;
      v29 = (unsigned __int8 *)&unk_1801ABDBB;
      LODWORD(v37) = v6;
      v36 = a5;
