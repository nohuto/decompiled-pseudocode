/*
 * XREFs of ?UMPDDrvStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x140335050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    v56 = a5;
    v22 = 0;
    if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 80), &v52, v14) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 96), &v53, v15) )
      {
        if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 112), &v54, v16) )
        {
                  ...
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v59, 0x10u) )
                  {
                    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v60, 0x10u) )
                    {
                      if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v61, 8u) )
                      {
                        ...
                        {
                          LODWORD(Size) = 4;
                          if ( (unsigned int)UMPDOBJ::Thunk(v18, v50, 0x80u, &v25, Size) != -1 )
                            v22 = v25 != 0;
                        }
                      }
                    }
