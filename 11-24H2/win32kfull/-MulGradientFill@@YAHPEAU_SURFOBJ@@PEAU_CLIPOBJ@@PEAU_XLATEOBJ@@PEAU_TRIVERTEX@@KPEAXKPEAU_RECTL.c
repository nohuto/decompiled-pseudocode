/*
 * XREFs of ?MulGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1401DE1F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulMode)
{
  ...
  _BYTE v40[88]; // [rsp+E0h] [rbp-20h] BYREF
  ...
  {
    MULTISURF::MULTISURF((MULTISURF *)v40, a1, a8);
