/*
 * XREFs of ?xxxMouseActivate@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@PEBUtagQMSG@@H@Z @ 0x140237020
 * Callers:
...
__int64 __fastcall xxxMouseActivate(struct tagTHREADINFO *a1, struct tagWND *a2, const struct tagQMSG *a3, int a4)
{
  ...
  LOBYTE(v19) = !v21;
  if ( v9
    || (v20 = (struct tagWND *)*(unsigned int *)(W32GetUserSessionState(v20, v18) + 67060),
        ((unsigned __int8)v20 & 1) == 0)
    || (v18 = 512LL, (_DWORD)v7 != 512) )
  {
    if ( !v19 && (*(_DWORD *)(*((_QWORD *)a1 + 59) + 436LL) & 0x8000) == 0
...
LABEL_38:
        ...
        if ( (v16 != *((struct tagWND **)v20 + 16) || (*((_DWORD *)v20 + 109) & 0x8000) != 0)
        ...
        active = 0;
LABEL_54:
        if ( (*(_DWORD *)(W32GetUserSessionState(v20, v18) + 67060) & 1) != 0
