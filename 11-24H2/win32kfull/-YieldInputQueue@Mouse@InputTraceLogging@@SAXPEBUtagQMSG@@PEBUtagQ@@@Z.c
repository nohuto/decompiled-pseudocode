/*
 * XREFs of ?YieldInputQueue@Mouse@InputTraceLogging@@SAXPEBUtagQMSG@@PEBUtagQ@@@Z @ 0x14027A948
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::YieldInputQueue(const struct tagQMSG *a1, const struct tagQ *a2)
{
  ...
  if ( (unsigned int)dword_140398B80 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_140398B80, 64LL) )
    {
      ...
      v14 = v4;
      v12 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140398B80, byte_140365639, 0LL, 0LL, 7u, &v10);
    }
  }
}
