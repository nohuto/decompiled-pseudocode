/*
 * XREFs of xxxEndScroll @ 0x1402E6AC0
 * Callers:
...
LABEL_27:
            ...
            if ( v11 == *((_QWORD *)result + 94) )
            {
                    ...
                    v11 == *((_QWORD *)result + 94)) )
              {
                ...
                if ( !*(_QWORD *)(W32GetUserSessionState(v23, v22) + 18944)
                  || (v27 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 18944), !*(_QWORD *)(v27 + 120))
                  || (v28 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 18944),
                      v28 != *((_QWORD *)PtiCurrent(v30, v29) + 59))
                  || (v33 = W32GetUserSessionState(v32, v31),
                      xxxWindowEvent(0x80000005, *(struct tagWND **)(*(_QWORD *)(v33 + 18944) + 120LL), 0, 3u, 33),
                      result = (struct tagTHREADINFO *)*((_QWORD *)a1 + 2),
                      v11 == *((_QWORD *)result + 94)) )
                {
