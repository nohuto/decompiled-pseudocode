/*
 * XREFs of SetIconMetrics @ 0x140112D38
 * Callers:
 ...
 *     ?GetTWIPSMetricById@@YAHPEAU_UNICODE_STRING@@IH@Z @ 0x1401132DC (-GetTWIPSMetricById@@YAHPEAU_UNICODE_STRING@@IH@Z.c)
...
__int64 __fastcall SetIconMetrics(struct _UNICODE_STRING *a1, struct tagICONMETRICSW *a2)
{
  ...
  v11 = *(_QWORD *)(W32GetUserSessionState(v5, v4) + 19928);
  v12 = *((_DWORD *)a2 + 1);
  if ( v12 <= *(_DWORD *)(v11 + 2304) )
  {
    v11 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19928);
    v12 = *(_DWORD *)(v11 + 2304);
  }
  *((_DWORD *)a2 + 1) = v12;
  v14 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19928);
  v15 = *((_DWORD *)a2 + 2);
  if ( v15 <= *(_DWORD *)(v14 + 2308) )
    v15 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 19928) + 2308LL);
  ...
  *((_DWORD *)a2 + 2) = v15;
  ...
  v23 = EngMulDiv(*(_DWORD *)(*(_QWORD *)(UserSessionState + 19928) + 2356LL), 96, v20);
  v26 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 19928);
  *(_DWORD *)(v26 + 2476) = v23;
  v28 = *(_QWORD *)(W32GetUserSessionState(v26, v27) + 19928);
  v29 = *(unsigned __int16 *)(v28 + 6998);
  v31 = W32GetUserSessionState(v28, v30);
  v32 = EngMulDiv(*(_DWORD *)(*(_QWORD *)(v31 + 19928) + 2360LL), 96, v29);
  v36 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 19928);
  *(_DWORD *)(v36 + 2480) = v32;
  if ( *((_DWORD *)a2 + 3) )
  {
    v37 = W32GetUserSessionState(v36, v35);
    *(_DWORD *)(v37 + 67056) |= 0x200000u;
  }
  else
  {
    v39 = W32GetUserSessionState(v36, v35);
    *(_DWORD *)(v39 + 67056) &= ~0x200000u;
  }
  return 1LL;
}
