/*
 * XREFs of ?bMapFileRetainHandle@@YAHPEBGPEAUFILEVIEW@@KW4GreFileKind@@@Z @ 0x140304C50
 * Callers:
 ...
 *     ?Reset@FileObj@Gre@@QEAAXPEAX@Z @ 0x1401C7B10 (-Reset@FileObj@Gre@@QEAAXPEAX@Z.c)
