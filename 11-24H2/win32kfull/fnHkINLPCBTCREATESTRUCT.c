/*
 * XREFs of fnHkINLPCBTCREATESTRUCT @ 0x1401A0964
 * Callers:
    ...
    *((_OWORD *)v11 + 8) = v27[4];
    ...
    else
    {
      ...
      else
      {
        ...
        if ( a5 )
        {
          v33 = CaptureAnsiCallbackData((struct _CAPTUREBUF *)v11, (PCWCH)v28, (PCWCH)((v32 >> 1) + 1), v29, 0);
          goto LABEL_45;
        }
        v31 = v32 + 2;
      }
...
LABEL_57:
    ...
    else
    {
      if ( a5 )
      {
        v38 = CaptureAnsiCallbackData((struct _CAPTUREBUF *)v11, (PCWCH)v37, (PCWCH)((v36 >> 1) + 1), v35, 0);
        goto LABEL_57;
      }
      v39 = v36 + 2;
    }
