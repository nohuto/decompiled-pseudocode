/*
 * XREFs of EditionPostRawMouseInputMessage @ 0x140230980
 * Callers:
 ...
 *     ?SkipBackgroundListener@RawInput@InputTraceLogging@@SAXPEBUtagPROCESS_HID_TABLE@@PEAXW4WhyBgInputSkipped@12@@Z @ 0x1401A2018 (-SkipBackgroundListener@RawInput@InputTraceLogging@@SAXPEBUtagPROCESS_HID_TABLE@@PEAXW4WhyBgInpu.c)
        ...
        struct tagRAWMOUSE *a5)
{
  ...
  {
    if ( *(_QWORD *)(W32GetUserSessionState(v10, v9) + 18960) )
    {
      UserSessionState = W32GetUserSessionState(v14, v13);
      if ( (unsigned __int8)IsSpatialDelegationEnabledForThread(*(_QWORD *)(UserSessionState + 18960)) )
        return 0LL;
    }
    v12 = *(struct tagQ **)(W32GetUserSessionState(v14, v13) + 18944);
  }
  if ( *(_DWORD *)a4 == 2 )
    v16 = *(void **)(a4 + 8);
  else
  ...
  if ( v12 )
  {
    v9 = *(_QWORD *)(PtiMouseFromQ((__int64)v12) + 464);
    v10 = *(_QWORD *)(v9 + 832);
    if ( v10 )
    {
      if ( (*(_DWORD *)(v10 + 100) & 1) != 0 )
      {
        FlushThrottledRawMouseInput((struct tagPROCESS_HID_TABLE *)v10, a3);
        v18 = PtiMouseFromQ((__int64)v12);
        HidData = AllocateHidData(
                    v16,
                    0LL,
                    24LL,
                    0LL,
                    *(__int64 **)(*(_QWORD *)(*(_QWORD *)(v18 + 464) + 832LL) + 64LL));
        v17 = 0;
        v20 = HidData;
        if ( HidData )
        {
          v21 = *(_QWORD *)(HidData + 24);
          v12 = *(struct tagQ **)(*(_QWORD *)(v21 + 16) + 472LL);
          InputTraceLogging::Mouse::DeliverRawInput(a2, *(HWND *)v21, (struct tagHIDDATA *const)HidData, a5, 0);
          *(_OWORD *)(v20 + 80) = *(_OWORD *)a5;
          *(_QWORD *)(v20 + 96) = *((_QWORD *)a5 + 2);
...
LABEL_19:
  if ( !*(_DWORD *)(W32GetUserSessionState(v10, v9) + 16852) )
    return 1LL;
  v24 = 0LL;
  v26 = (__int64 *)(W32GetUserSessionState(v23, v22) + 224);
  v47 = 0LL;
  v48 = 0;
  if ( v12 )
  {
    v28 = PtiMouseFromQ((__int64)v12);
    v29 = *((_DWORD *)v12 + 118);
    v24 = *(_QWORD *)(v28 + 464);
    HIDWORD(v47) = *((_DWORD *)v12 + 119);
    LODWORD(v47) = v29;
  }
  for ( i = *v26; (__int64 *)i != v26; i = *(_QWORD *)i )
  {
    ...
    v33 = *(_QWORD *)(*(_QWORD *)(v31 + 16) + 472LL);
    v34 = *(_QWORD *)(W32GetUserSessionState(v32, v25) + 19200);
    v36 = *(_QWORD *)(i + 64);
...
LABEL_40:
    ...
    if ( !UIPrivilegeIsolation::CheckAccess(
            (UIPrivilegeIsolation *)(*(_QWORD *)(*(_QWORD *)(v36 + 16) + 464LL) + 872LL),
            (const struct tagUIPI_INFO *)&v47,
            v35) )
    {
      v38 = *(_QWORD *)(*(_QWORD *)(i + 64) + 16LL);
      if ( *(int *)(*(_QWORD *)(v38 + 464) + 12LL) >= 0 )
      {
        v45 = v47;
        v46 = v48;
    ...
    if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(i + 64) + 16LL) + 464LL) == v24 )
      continue;
    ...
    v37 = 4;
LABEL_41:
    InputTraceLogging::RawInput::SkipBackgroundListener(v41, v40, v37, v27);
  }
  if ( (unsigned __int8)RawMouseThrottlingTimerActive() )
  {
    for ( j = *v26; (__int64 *)j != v26; j = *(_QWORD *)j )
    {
