/*
 * XREFs of ?MulTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x140054F70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z @ 0x140055364 (--0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z.c)
    ...
    do
    {
      ...
      *p_rclBkGround = v19;
      if ( (*(_DWORD *)(v22 + 88) & 8) != 0 )
        ...
        v23 = EngTextOut;
      v15 &= OffTextOut(v23, v35, v22, pstro, v21, v34, prclExtra, prclOpaque, pboFore, pboOpaque, pptlOrg, mix);
