/*
 * XREFs of ?ValidateParents@@YAHPEAUtagWND@@H@Z @ 0x140032AA8
 * Callers:
...
__int64 __fastcall ValidateParents(struct tagWND *a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v5 )
    {
      ...
      if ( !(unsigned int)IntersectWithParents(a1, &v26) )
        return 1LL;
      UserSessionState = W32GetUserSessionState(v11, v10);
      SetRectRgnIndirect(*(_QWORD *)(UserSessionState + 63408), &v26);
      v15 = *(_QWORD *)(*((_QWORD *)a1 + 5) + 168LL);
      if ( v15 )
      {
        v21 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 63408);
        v24 = W32GetUserSessionState(v23, v22);
        if ( !(unsigned int)GreCombineRgn(*(_QWORD *)(v24 + 63408), v21, v15, 1LL) )
          return 1LL;
      }
    }
    v27 = *(struct tagRECT *)(*((_QWORD *)v7 + 5) + 88LL);
    if ( !(unsigned int)IntersectWithParents(v7, &v27) )
      return 1LL;
    v25 = *(HRGN *)(W32GetUserSessionState(v17, v16) + 63408);
    v18 = LogicalToPhysicalInPlaceRgnWorker(a1, &v25, 0LL);
    v19 = v25;
    v20 = v18;
