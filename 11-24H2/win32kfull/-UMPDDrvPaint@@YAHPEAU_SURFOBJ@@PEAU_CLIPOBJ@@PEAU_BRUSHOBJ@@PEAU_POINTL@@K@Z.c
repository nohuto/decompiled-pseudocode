/*
 * XREFs of ?UMPDDrvPaint@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x140333DE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  if ( v18 )
  {
    ...
    if ( v12 )
    {
      ...
      v30 = a5;
      v26 = a1;
      if ( (unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 80), &v26, v8) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v10, (UMPDOBJ *)((char *)v10 + 128), (const void **)&v27, 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v10, (UMPDOBJ *)((char *)v10 + 160), (const void **)&v28, 0x18u, 0LL) )
          {
            ...
            {
              LODWORD(Size) = 4;
              if ( (unsigned int)UMPDOBJ::Thunk(v10, v24, 0x60u, &v15, Size) != -1 )
                v13 = v15 != 0;
            }
          }
        }
