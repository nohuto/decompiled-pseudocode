/*
 * XREFs of zzzUpdateShadowAlpha @ 0x14015DFA4
 * Callers:
    ...
    if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 26LL) & 8) != 0 )
    {
      if ( (GetRedirectionFlags((__int64)a1, v5) & 1) != 0 )
      {
        ...
        if ( (unsigned int)GreGetSpriteAttributes(
                             *(Gre::Base **)(*(_QWORD *)(UserSessionState + 57008) + 48LL),
                             v9,
                             v14,
                             &v19,
                             &v23,
                             ...
                             v10) )
        {
          if ( (v24 & 2) != 0 )
          {
            ...
            Win32HMThreadLockBase<tagWND,1,0>::Win32HMThreadLockBase<tagWND,1,0>(
              BugCheckParameter3,
              *((_QWORD *)v4 + 1));
            zzzUpdateLayeredWindow(*((struct tagWND **)v4 + 1), 0LL, 0LL, 0LL, 0LL, 0LL, 0, (__int64)&v22, 2u, 0LL);
