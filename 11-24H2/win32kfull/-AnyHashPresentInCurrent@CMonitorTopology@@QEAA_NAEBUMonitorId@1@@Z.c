/*
 * XREFs of ?AnyHashPresentInCurrent@CMonitorTopology@@QEAA_NAEBUMonitorId@1@@Z @ 0x1401CC9BC
 * Callers:
        ...
        const struct CMonitorTopology::MonitorId *a2)
{
  ...
  for ( i = 0LL; ; i = (unsigned int)(i + 1) )
  {
    ...
    v5 = 0LL;
LABEL_4:
    v6 = *(_QWORD *)(UserSessionState + 71480);
  ...
  for ( j = 0LL; ; j = (unsigned int)(j + 1) )
  {
    ...
    if ( AreHashesEqual((const void *)(*(_QWORD *)(v6 + 72 * v5 + 64) + 20 * j), (const void *)(*(_QWORD *)a2 + 20 * i)) )
      break;
  }
  return 1;
}
