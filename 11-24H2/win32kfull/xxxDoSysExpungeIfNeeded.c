/*
 * XREFs of xxxDoSysExpungeIfNeeded @ 0x140065040
 * Callers:
...
void __fastcall xxxDoSysExpungeIfNeeded(__int64 a1)
{
  ...
  v16 = 0;
  v5 = &v14;
  v15 = W32GetUserSessionState(v4, v3) + 42424;
  v17 = 0LL;
  v7 = 0;
  v18 = 0;
  do
  ...
  while ( !v7 );
  v18 = 1;
  v10 = *(unsigned int *)(W32GetUserSessionState(v8, v6) + 41380);
  if ( *(_DWORD *)(*(_QWORD *)(a1 + 464) + 392LL) != (_DWORD)v10 )
  {
    v11 = *(unsigned int *)(W32GetUserSessionState(v10, v9) + 41380);
    *(_DWORD *)(*(_QWORD *)(a1 + 464) + 392LL) = v11;
    if ( (*(_DWORD *)(W32GetUserSessionState(v12, v11) + 41376) & *(_DWORD *)(*(_QWORD *)(a1 + 464) + 396LL)) != 0 )
      xxxDoSysExpunge(a1);
  }
