/*
 * XREFs of EditionGetPointerDeviceConfigurationKey @ 0x14024DC60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( v11 )
  {
    ...
    if ( v12 )
    {
      if ( v12 == 1 )
      {
        v4 = L"\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Windows\\EnhancedPenSupport";
        v5 = 146;
      }
    }
    else
...
LABEL_22:
  LOBYTE(v2) = a2 == 131078;
  OpenDeviceCfgKey(v5, v4, a2, &v14, v2);
  return v14;
}
