/*
 * XREFs of ?DrawBottomSide@@YAXPEAXJHJ@Z @ 0x1402C8708
 * Callers:
...
void __fastcall DrawBottomSide(char *a1, int a2, int a3, int a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( (__int64)v10 < (__int64)&unk_140354CC4 );
  }
  else
  {
    v14 = a2 - v6;
    v15 = &xmmword_140354CB0;
    v16 = v14;
    do
    {
      if ( v16 > 10 )
    ...
    while ( (__int64)v15 < (__int64)&unk_140354CC4 );
  }
}
