/*
 * XREFs of xxxMNEndMenuStateInternal @ 0x14009AEB0
 * Callers:
...
void __fastcall xxxMNEndMenuStateInternal(__int64 a1, __int64 a2)
{
  ...
  if ( a2 == v9 + 65928 )
  {
    v10 = W32GetUserSessionState(v9 + 65928, v8);
    *(_DWORD *)(v10 + 67056) &= ~0x2000000u;
    GreCleanDCAndSetOwnerEx(*(_QWORD *)(v9 + 66064), 2147483666LL, 0LL, 1LL);
  }
  else
  {
    v14 = *(_QWORD *)(a2 + 136);
