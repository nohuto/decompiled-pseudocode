/*
 * XREFs of ?bComputeWidenedBounds@pathwide@@YA_NAEAU_RECTFX@@AEBU2@AEBVEXFORMOBJ@@AEBU_LINEATTRS@@@Z @ 0x1400E45B8
 * Callers:
        ...
        const struct EXFORMOBJ *a4)
{
  ...
  v48 = v5;
  v49 = -(int)v5;
  if ( !EXFORMOBJ::bXform((EXFORMOBJ *)a3, (const struct _VECTORL *)&v46, (struct _VECTORFX *)&v46, 2uLL, 0) )
    return 0;
  v12 = v46;
  v13 = v46;
  if ( v46 < 0 )
