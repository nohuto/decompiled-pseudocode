/*
 * XREFs of ?NtGdiSTROBJ_bEnumInternal@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@H@Z @ 0x1400AB66C
 * Callers:
 *     NtGdiSTROBJ_bEnumPositionsOnly @ 0x1400AA4E0 (NtGdiSTROBJ_bEnumPositionsOnly.c)
 *     NtGdiSTROBJ_bEnum @ 0x1400AA720 (NtGdiSTROBJ_bEnum.c)
 * Callees:
