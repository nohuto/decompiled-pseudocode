/*
 * XREFs of ?CheckTopmost@@YAHPEAUtagCVR@@@Z @ 0x14022AA20
 * Callers:
...
__int64 __fastcall CheckTopmost(struct tagCVR *a1)
{
  ...
  switch ( v8 )
  {
    ...
    case -2LL:
      ...
      WindowWorker = GetWindowWorker(v9, 3LL);
      if ( WindowWorker )
        v6 = *(_QWORD *)WindowWorker;
      *((_QWORD *)a1 + 1) = v6;
      return 2LL;
    case -1LL:
      if ( *(_QWORD *)(W32GetUserSessionState(v4, v3) + 19136) )
      {
    ...
    case 0LL:
      if ( (*(_BYTE *)(*(_QWORD *)(v7 + 40) + 24LL) & 8) == 0 )
      {
        v15 = CalcForegroundInsertAfter(v7, v3);
        if ( v15 )
          v6 = *(_QWORD *)v15;
        *((_QWORD *)a1 + 1) = v6;
        return 0LL;
