/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x140028238
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x140028220 (NtGdiBeginGdiRendering.c)
 * Callees:
 ...
 *     ?bReset@DC@@QEAAHXZ @ 0x1401BB80C (-bReset@DC@@QEAAHXZ.c)
