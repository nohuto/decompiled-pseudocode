/*
 * XREFs of MagSetLensContextInformation @ 0x1401AD0BC
 * Callers:
 ...
 *     ?MagpFindLensContext@@YAPEAU_MAG_LENS_CONTEXT@@PEAU_MAG_THREAD_CONTEXT@@PEAUtagWND@@@Z @ 0x1401ADE80 (-MagpFindLensContext@@YAPEAU_MAG_LENS_CONTEXT@@PEAU_MAG_THREAD_CONTEXT@@PEAUtagWND@@@Z.c)
    ...
    if ( v11 != 5 )
    {
      if ( v11 )
      {
        ...
        if ( v25 )
        {
          ...
          if ( v26 )
          {
            ...
            if ( a3 == (struct tagWND *)-1LL )
            {
              if ( v52 != *((double *)Buf1 + 1) )
                return v6;
              v53 = memcmp(Buf1, &xmmword_140351350, 0x20uLL) != 0;
            ...
            else
            {
              ...
              *((_QWORD *)v49 + 8) = *((_QWORD *)Buf1 + 3);
              ...
              {
                v65 = *(_QWORD *)(W32GetUserSessionState(v63, v50) + 19928);
                if ( *(_WORD *)(v65 + 6998) > 0x60u )
                {
                  v66 = *(_QWORD *)(W32GetUserSessionState(v65, v64) + 19928);
                  *((double *)v51 + 7) = (double)*(unsigned __int16 *)(v66 + 6998) * *((double *)v51 + 7) / 96.0;
                  v68 = *(_QWORD *)(W32GetUserSessionState(v66, v67) + 19928);
          ...
          if ( (v30 & 0xF) != 0
            || (v74 = *(_QWORD *)(W32GetUserSessionState(v30, v29) + 19928), *(_WORD *)(v74 + 6998) <= 0x60u) )
          {
            v31 = *Buf1;
          ...
          else
          {
            ...
            if ( (*((_DWORD *)v28 + 4) & 2) == 0 )
            {
              ...
              *((_DWORD *)v28 + 8) = -EngMulDiv(
              ...
              v33 = EngMulDiv(Buf1[1], *(unsigned __int16 *)(*(_QWORD *)(v78 + 19928) + 6998LL), 96);
              goto LABEL_30;
            }
...
LABEL_98:
    ...
    if ( a3 == (struct tagWND *)-1LL )
    {
      v53 = memcmp(Buf1, &xmmword_140357E70, 0x64uLL) != 0;
