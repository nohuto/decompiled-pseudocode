/*
 * XREFs of ?xxxSetSPIMetrics@@YAHPEAU_UNICODE_STRING@@KPEAXHPEAH@Z @ 0x140214460
 * Callers:
 ...
 *     ?xxxSPISetMinMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagMINIMIZEDMETRICS@@H@Z @ 0x140214600 (-xxxSPISetMinMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagMINIMIZEDMETRICS@@H@Z.c)
...
LABEL_10:
    ...
    if ( v8 )
      *(_DWORD *)(UserSessionState + 67056) |= 0x10000u;
    else
      *(_DWORD *)(UserSessionState + 67056) &= ~0x10000u;
    goto LABEL_26;
  }
