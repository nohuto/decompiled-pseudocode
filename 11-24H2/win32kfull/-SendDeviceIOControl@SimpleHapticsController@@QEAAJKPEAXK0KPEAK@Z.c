/*
 * XREFs of ?SendDeviceIOControl@SimpleHapticsController@@QEAAJKPEAXK0KPEAK@Z @ 0x1402EFD74
 * Callers:
...
LABEL_13:
    if ( (unsigned int)dword_140398C60 > 2 )
    {
      ...
      v25 = "SimpleHapticsController::SendDeviceIOControl failed.";
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
        (__int64)&dword_140398C60,
  ...
  LeaveEnterUserCritIfAcquired::LeaveEnterUserCritIfAcquired(
    (LeaveEnterUserCritIfAcquired *)&OutputBuffer,
    v18,
    (__int64)a3);
  v20 = IofCallDriver(v15, v19);
