/*
 * XREFs of ?bBitBltScreenToScreen@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x140053DDC
 * Callers:
 ...
 *     ??1MULTISORTBLTORDER@@QEAA@XZ @ 0x140210650 (--1MULTISORTBLTORDER@@QEAA@XZ.c)
        ...
        unsigned int a10)
{
  ...
  struct _POINTL *v72; // [rsp+100h] [rbp+0h]
  struct _BRUSHOBJ *v73; // [rsp+108h] [rbp+8h]
  struct _POINTL *v74; // [rsp+110h] [rbp+10h]
  struct _SURFOBJ *v75; // [rsp+118h] [rbp+18h]
  ...
  if ( !v78[0] )
  {
    MULTISORTBLTORDER::~MULTISORTBLTORDER((MULTISORTBLTORDER *)v76);
    return 0LL;
  }
  if ( a3 )
            ...
            if ( v28 )
            {
              ...
              *(_QWORD *)&v80.left = 0LL;
              ...
              if ( (*(_DWORD *)(v30 + 112) & 0x400) != 0 )
                v31 = *(int (**)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(v24 + 2832);
              else
                v31 = EngCopyBits;
...
LABEL_18:
            if ( v22 )
            {
              ...
              if ( !v36 && !*(_DWORD *)(v18 + 24) )
                goto LABEL_32;
              v37 = *(_QWORD *)(*(_QWORD *)(v18 + 56) + 2544LL);
              v38 = *(_QWORD *)(v17 + 56);
              v71 = (struct _SURFOBJ *)*((_QWORD *)v70 + 471);
              v59 = v71;
              v39 = *(_QWORD *)(v38 + 2544);
              v65 = v39;
              if ( v36 && ((_DWORD)v34[539] & 0x100) != 0 )
              {
                v40 = DrvRealizeHalftonePalette(v34, 0);
                v33 = v64;
                pulXlate = 0LL;
                v59 = (struct _SURFOBJ *)v40;
                v39 = v65;
              }
              v41 = 32 * (*(_DWORD *)(*(_QWORD *)(v18 + 56) + 2156LL) & 0x100);
              if ( v33 )
              {
                ...
                if ( !a3 || bIntersect(&rclBounds, &v79, &a3->rclBounds) )
                {
                  if ( a10 == 52428 )
                  {
                    ...
                    if ( (*(_DWORD *)(*((_QWORD *)v34 + 318) + 112LL) & 0x400) != 0 )
                      v47 = (int (*)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))*((_QWORD *)v34 + 354);
                    else
                      v47 = EngCopyBits;
                  ...
                  else
                  {
                    ...
                    if ( (*(_DWORD *)(*((_QWORD *)v34 + 318) + 112LL) & 1) != 0 )
                      v48 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))*((_QWORD *)v34 + 353);
                    else
                      v48 = EngBitBlt;
                    v19 &= OffBitBlt(
                             (_DWORD)v48,
