/*
 * XREFs of ?OffsetInContact@@YAHUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@0@Z @ 0x1402A34C0
 * Callers:
 ...
 * Callees:
 *     TouchTargetingIntersectSegment @ 0x1402F231C (TouchTargetingIntersectSegment.c)
 */
