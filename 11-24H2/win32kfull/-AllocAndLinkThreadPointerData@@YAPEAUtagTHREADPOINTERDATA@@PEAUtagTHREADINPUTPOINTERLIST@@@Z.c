/*
 * XREFs of ?AllocAndLinkThreadPointerData@@YAPEAUtagTHREADPOINTERDATA@@PEAUtagTHREADINPUTPOINTERLIST@@@Z @ 0x1401E4268
 * Callers:
 *     EditionAllocAndLinkThreadPointerData @ 0x1401E4250 (EditionAllocAndLinkThreadPointerData.c)
 * Callees:
 *     <none>
 */
