/*
 * XREFs of DwmAsyncNotifyWindowMoveSizeIntercepted @ 0x1403239F4
 * Callers:
...
__int64 __fastcall DwmAsyncNotifyWindowMoveSizeIntercepted(PVOID Object, __int64 a2, int a3, __int64 a4)
{
  unsigned int v8; // edi
