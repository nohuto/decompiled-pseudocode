/*
 * XREFs of ?STROBJ_bEnumPositionsOnlyLinked@@YAHPEAVESTROBJ@@PEAKPEAPEAU_GLYPHPOS@@@Z @ 0x1400AA0D0
 * Callers:
 *     STROBJ_bEnumPositionsOnly @ 0x1400AA0A0 (STROBJ_bEnumPositionsOnly.c)
