/*
 * XREFs of ?_NtUserGetSendMessageReceiver@@YAPEAUHWND__@@K@Z @ 0x140291C68
 * Callers:
...
__int64 __fastcall _NtUserGetSendMessageReceiver(unsigned int a1)
{
  ...
  if ( !UIPrivilegeIsolation::CheckAccess(
          (UIPrivilegeIsolation *)(*(_QWORD *)(v3 + 464) + 872LL),
          (const struct tagUIPI_INFO *)(*(_QWORD *)(v5 + 464) + 872LL),
          v6) )
  {
