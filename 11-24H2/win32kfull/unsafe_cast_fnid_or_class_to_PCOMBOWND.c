/*
 * XREFs of unsafe_cast_fnid_or_class_to_PCOMBOWND @ 0x140282EFC
 * Callers:
...
__int64 __fastcall unsafe_cast_fnid_or_class_to_PCOMBOWND(_QWORD *a1)
{
  ...
  if ( _bittest16((const signed __int16 *)(a1[5] + 42LL), 0xCu) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000, 909);
  v2 = a1[5];
  v3 = *(_WORD *)(v2 + 42);
  if ( (v3 & 0x1000) != 0 )
    return 0LL;
  ...
  v6 = *v5;
  if ( v6 != *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v5, 674LL) + 19928) + 878LL) )
    return 0LL;
  v2 = a1[5];
LABEL_6:
  if ( *(_DWORD *)(v2 + 248) )
