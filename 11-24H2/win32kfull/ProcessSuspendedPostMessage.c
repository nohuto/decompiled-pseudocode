/*
 * XREFs of ProcessSuspendedPostMessage @ 0x1401957E8
 * Callers:
 ...
 * Callees:
 *     ?FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z @ 0x1401958AC (-FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z.c)
 *     ?ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z @ 0x1401959E4 (-ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z.c)
 */
