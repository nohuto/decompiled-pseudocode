/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_LqLL @ 0x14028C290
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_LqLL(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  __int64 result; // rax
