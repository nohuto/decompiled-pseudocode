/*
 * XREFs of xxxSetProcessWindowStation @ 0x1402011B0
 * Callers:
 *     EditionSetProcessWindowStationEntryPoint @ 0x1402010E0 (EditionSetProcessWindowStationEntryPoint.c)
 * Callees:
...
LABEL_32:
  ...
  LockObjectAssignment(v10 + 656, v14);
