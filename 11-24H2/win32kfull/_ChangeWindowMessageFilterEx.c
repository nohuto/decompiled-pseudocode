/*
 * XREFs of _ChangeWindowMessageFilterEx @ 0x14024ED84
 * Callers:
 *     NtUserChangeWindowMessageFilterEx @ 0x1401998D0 (NtUserChangeWindowMessageFilterEx.c)
 * Callees:
 *     ?GetWindowMessageFilter@@YAPEAPEAXPEAUtagWND@@@Z @ 0x140171D40 (-GetWindowMessageFilter@@YAPEAPEAXPEAUtagWND@@@Z.c)
 *     ?IsMessageAlwaysAllowedAcrossIL@@YAHI@Z @ 0x14017CF18 (-IsMessageAlwaysAllowedAcrossIL@@YAHI@Z.c)
 *     ?IsMessageAllowedByFilterEx@@YAHPEBQEAXIPEAPEAPEAX1@Z @ 0x140180750 (-IsMessageAllowedByFilterEx@@YAHPEBQEAXIPEAPEAPEAX1@Z.c)
...
__int64 __fastcall ChangeWindowMessageFilterEx(struct tagWND *a1, unsigned int a2, int a3, __int64 a4)
{
  ...
  *(_DWORD *)(a4 + 4) = 0;
  if ( !(unsigned int)Feature_UIPIAlwaysOn2__private_IsEnabledDeviceUsageNoInline(v10)
  ...
  if ( (_DWORD)result )
  {
    ...
    else
    {
      ...
      if ( v4 )
      {
        if ( (unsigned int)IsMessageAllowedByFilterEx(v11[106], a2, 0LL, 0LL)
    ...
    if ( v17 != v21[0] )
    {
      v20 = (struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 464LL) + 856LL);
      if ( v21[0] )
