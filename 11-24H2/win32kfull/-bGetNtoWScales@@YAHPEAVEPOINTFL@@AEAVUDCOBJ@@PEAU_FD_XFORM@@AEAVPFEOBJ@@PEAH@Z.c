/*
 * XREFs of ?bGetNtoWScales@@YAHPEAVEPOINTFL@@AEAVUDCOBJ@@PEAU_FD_XFORM@@AEAVPFEOBJ@@PEAH@Z @ 0x1400C19C4
 * Callers:
  ...
  if ( v26 )
  {
    *a5 = 0;
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 976LL) + 208LL) == 1
      && ((unsigned int)EFLOAT::bIsZero((EFLOAT *)(*(_QWORD *)a2 + 452LL))
       || (unsigned int)EFLOAT::bIsZero((EFLOAT *)(v18 + 456)))
      && (*(_DWORD *)(v11 + 48) & 4) == 0 )
    {
      v19 = v21 * *(float *)v17;
      v22 = v22 * *(float *)v17;
