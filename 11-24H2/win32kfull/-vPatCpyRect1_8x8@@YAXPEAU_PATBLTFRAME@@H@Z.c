/*
 * XREFs of ?vPatCpyRect1_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1403148A0
 * Callers:
 *     <none>
 * Callees:
 *     ?vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z @ 0x140315BB8 (-vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z.c)
...
void __fastcall vPatCpyRect1_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  do
  {
    left = v3->left;
    right = v3->right;
    v6 = *((_DWORD *)&aulMsk + (v3->left & 0x1F));
    v7 = ~v6;
    v8 = *((_DWORD *)&aulMsk + (right & 0x1F));
    if ( v8 == -1 )
      v8 = 0;
    ...
    else
    {
      ...
      if ( !v22 )
      {
        if ( *((_DWORD *)&aulMsk + (v3->left & 0x1F)) != -1 && v8 )
        {
          v10 = 8;
          goto LABEL_22;
        }
