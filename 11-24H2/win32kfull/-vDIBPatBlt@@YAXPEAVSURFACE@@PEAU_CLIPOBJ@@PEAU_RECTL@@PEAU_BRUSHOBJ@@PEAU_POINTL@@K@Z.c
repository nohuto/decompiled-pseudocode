/*
 * XREFs of ?vDIBPatBlt@@YAXPEAVSURFACE@@PEAU_CLIPOBJ@@PEAU_RECTL@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x1401A8634
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v12 = (void (__fastcall *)(_QWORD))qword_14034BA90[3 * v11 + a6];
  v37 = v12;
  v13 = dword_140361B00[v11];
  v34 = v13;
  if ( a2 )
  {
