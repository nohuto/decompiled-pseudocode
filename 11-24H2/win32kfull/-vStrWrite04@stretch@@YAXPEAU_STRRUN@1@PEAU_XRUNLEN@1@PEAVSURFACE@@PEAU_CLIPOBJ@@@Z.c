/*
 * XREFs of ?vStrWrite04@stretch@@YAXPEAU_STRRUN@1@PEAU_XRUNLEN@1@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1400A0C70
 * Callers:
 *     <none>
 * Callees:
            ...
            do
            {
              ...
              if ( v40 < v41 )
              {
                ...
                do
                {
                  ...
                  if ( v40 >= si128.left && v40 < si128.right )
                    v45 = v45 & ~dword_140361A58[v47] | dword_140361A58[v47] & (*v46 << dword_140361A38[v47]);
                  ++v47;
                  ++v46;
                  ++v42;
                  v64 = v47;
      ...
      for ( i = v8; v5 != (int *)a2; v62 = (char *)v5 )
      {
        ...
        if ( *v5 < *v5 + v5[1] )
        {
          ...
          if ( (unsigned __int64)v10 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v17 = dword_140361A58[v15];
              ++v12;
              v18 = *v14;
              ++v9;
              v19 = dword_140361A38[v15];
              ++v14;
              ++v15;
