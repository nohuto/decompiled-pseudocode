/*
 * XREFs of ?GdiDeleteSpriteDelayDelete@@YAHPEAUHDEV__@@PEAUHWND__@@PEAX@Z @ 0x140328D2C
 * Callers:
...
__int64 __fastcall GdiDeleteSpriteDelayDelete(HDEV a1, HWND a2, _DWORD *a3)
{
  unsigned int v5; // edi
  HDEV v6; // rbp
