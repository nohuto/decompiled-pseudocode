/*
 * XREFs of ?IsMetaRedirectionBitmap@@YAHPEAU_SURFOBJ@@@Z @ 0x140054F4C
 * Callers:
 ...
 *     MulProcessChildRedirectionDfbSurfaces2 @ 0x140332160 (MulProcessChildRedirectionDfbSurfaces2.c)
 * Callees:
 *     <none>
 */
