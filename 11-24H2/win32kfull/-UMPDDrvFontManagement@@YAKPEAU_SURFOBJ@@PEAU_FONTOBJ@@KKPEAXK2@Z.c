/*
 * XREFs of ?UMPDDrvFontManagement@@YAKPEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK2@Z @ 0x140333150
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a7)
{
  ...
  _DWORD v35[4]; // [rsp+90h] [rbp-61h] BYREF
...
LABEL_11:
    ...
    if ( (!v16 || (v43 = UMPDOBJ::_AllocUserMem(v12, Size, 1)) != 0LL)
      && (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 80), v37, v11)
      ...
      && (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v41, a4) )
    {
      ...
      LODWORD(v23) = 4;
      v19 = UMPDOBJ::Thunk(v12, v35, 0x50u, &v26, v23);
      v10 = v26;
      if ( v19 == -1 )
        v10 = -1;
