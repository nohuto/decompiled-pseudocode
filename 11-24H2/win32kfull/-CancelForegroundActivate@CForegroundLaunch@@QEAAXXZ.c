/*
 * XREFs of ?CancelForegroundActivate@CForegroundLaunch@@QEAAXXZ @ 0x1401D5AE8
 * Callers:
...
void __fastcall CForegroundLaunch::CancelForegroundActivate(CForegroundLaunch *this)
{
  ...
  if ( (*(_DWORD *)(W32GetUserSessionState(v3, v2) + 67056) & 0x8000000) != 0 )
  {
    v6 = 1;
