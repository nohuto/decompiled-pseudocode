/*
 * XREFs of ?DisconnectPlaySound@CUserPlaySound@@SAJXZ @ 0x140204704
 * Callers:
 *     NtUserDoSoundDisconnect @ 0x140204510 (NtUserDoSoundDisconnect.c)
...
__int64 __fastcall CUserPlaySound::DisconnectPlaySound(__int64 a1, __int64 a2)
{
  ...
  return CUserPlaySound::Disconnect(*(CUserPlaySound **)(UserSessionState + 70800));
}
