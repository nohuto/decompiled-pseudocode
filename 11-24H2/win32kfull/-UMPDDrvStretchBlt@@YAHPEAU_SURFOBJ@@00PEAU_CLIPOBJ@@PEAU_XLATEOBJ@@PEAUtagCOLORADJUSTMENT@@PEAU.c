/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1401C0AF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  v53 = a5;
  v18 = 0;
  if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 80), &v49, v12) )
  {
    if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 96), &v50, v13) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 112), &v51, v14) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v16, (UMPDOBJ *)((char *)v16 + 128), (const void **)&v52, 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v16, &v53) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v54, 0x18u) )
            {
              ...
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v56, 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v57, 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( (unsigned int)UMPDOBJ::Thunk(v16, v47, 0x80u, &v23, Size) != -1 )
                      {
                        if ( v23 )
                          v18 = 1;
                      }
