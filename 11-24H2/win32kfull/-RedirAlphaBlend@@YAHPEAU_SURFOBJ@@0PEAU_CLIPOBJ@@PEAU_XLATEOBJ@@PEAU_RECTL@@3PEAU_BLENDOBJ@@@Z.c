/*
 * XREFs of ?RedirAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1402FCAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        BLENDOBJ *a7)
{
  ...
  _BYTE v19[8]; // [rsp+50h] [rbp-89h] BYREF
  struct SURFACE *v20; // [rsp+58h] [rbp-81h] BYREF
  struct SURFACE *v21; // [rsp+60h] [rbp-79h] BYREF
  HDC v22[18]; // [rsp+68h] [rbp-71h] BYREF
  __int64 HDEV; // [rsp+128h] [rbp+4Fh] BYREF
