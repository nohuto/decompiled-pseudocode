/*
 * XREFs of NtUserBroadcastThemeChangeEvent @ 0x140117520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserBroadcastThemeChangeEvent(unsigned __int64 a1, __int64 a2)
{
  ...
  for ( i = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 36424); i; i = *(_QWORD *)(i + 368) )
  {
    for ( j = *(_QWORD *)(i + 328); j; j = *(_QWORD *)(j + 704) )
    {
      if ( *(_DWORD *)(j + 944) )
      {
        PostEventMessageEx((struct tagTHREADINFO *)j, *(struct tagQ **)(j + 472), 0x19u, 0LL, 0, a1, a2, 0LL);
        v4 = 1;
      }
    }
  }
