/*
 * XREFs of ?xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z @ 0x140278658
 * Callers:
...
void __fastcall xxxSendToTouchStack(struct DEVICEINFO *a1, unsigned int a2, struct tagPOINTER_TOUCH_INFO *a3, int a4)
{
  ...
  *((_DWORD *)a1 + 60) = 0;
  ...
  for ( *((_QWORD *)a1 + 31) = *(unsigned __int16 *)(v4 + 44); v9 < a2; v9 += 4 )
  {
    ...
    v14 = *(_QWORD *)(*(_QWORD *)(CurrentProcessWin32Process + 888) + 88LL);
