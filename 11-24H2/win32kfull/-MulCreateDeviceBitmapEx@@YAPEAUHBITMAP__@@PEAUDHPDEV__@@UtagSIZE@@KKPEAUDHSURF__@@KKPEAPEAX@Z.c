/*
 * XREFs of ?MulCreateDeviceBitmapEx@@YAPEAUHBITMAP__@@PEAUDHPDEV__@@UtagSIZE@@KKPEAUDHSURF__@@KKPEAPEAX@Z @ 0x14017D1A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreDwmUseDeviceBitmapsForMultiAdapter @ 0x14017D718 (GreDwmUseDeviceBitmapsForMultiAdapter.c)
