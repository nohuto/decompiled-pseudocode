/*
 * XREFs of SfnSHELLWINDOWMANAGEMENTNOTIFY @ 0x1401C7640
 * Callers:
...
ULONG_PTR __fastcall SfnSHELLWINDOWMANAGEMENTNOTIFY(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        __int128 *a4,
        ...
        __int64 a6)
{
  ...
  _DWORD v20[6]; // [rsp+30h] [rbp-138h] BYREF
  void *Src; // [rsp+48h] [rbp-120h] BYREF
  ULONG_PTR v22[2]; // [rsp+50h] [rbp-118h] BYREF
  _BYTE v23[8]; // [rsp+60h] [rbp-108h] BYREF
  __int128 v24; // [rsp+68h] [rbp-100h]
  __int64 v25; // [rsp+78h] [rbp-F0h]
  ULONG_PTR BugCheckParameter3[6]; // [rsp+80h] [rbp-E8h] BYREF
  __int64 v27; // [rsp+B0h] [rbp-B8h] BYREF
  int v28; // [rsp+B8h] [rbp-B0h]
  __int64 v29; // [rsp+C0h] [rbp-A8h]
  __int128 v30; // [rsp+C8h] [rbp-A0h]
  __int128 v31; // [rsp+D8h] [rbp-90h]
  __int128 v32; // [rsp+E8h] [rbp-80h]
  __int128 v33; // [rsp+F8h] [rbp-70h]
  __int128 v34; // [rsp+108h] [rbp-60h]
  __int64 v35; // [rsp+118h] [rbp-50h]
  __int64 v36; // [rsp+120h] [rbp-48h]
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 65) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(54LL, &v27, 120LL, &Src, v20);
