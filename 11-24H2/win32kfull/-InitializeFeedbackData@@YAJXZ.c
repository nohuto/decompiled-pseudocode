/*
 * XREFs of ?InitializeFeedbackData@@YAJXZ @ 0x1402A3C48
 * Callers:
...
__int64 InitializeFeedbackData(void)
{
  ...
  if ( v0 )
  {
    ...
    v2[7] = (char *)v2 + 20;
    v2[8] = v2 + 4;
    *(_QWORD *)(W32GetUserSessionState(v4, v3) + 36368) = v2;
    v7 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 36368);
    *(_QWORD *)(v7 + 72) = CreateKernelEvent(1LL, 0LL);
    if ( !*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v9, v8) + 36368) + 72LL) )
