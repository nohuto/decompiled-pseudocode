/*
 * XREFs of NtGdiGetETM @ 0x140310070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetETM(HDC a1, void *a2)
{
  ...
  __int64 v12; // r9
  unsigned int v14; // [rsp+20h] [rbp-208h]
  unsigned int v15; // [rsp+28h] [rbp-200h]
  unsigned int v16; // [rsp+38h] [rbp-1F0h]
  void *v17; // [rsp+40h] [rbp-1E8h]
  struct _FONTOBJ *v18; // [rsp+50h] [rbp-1D8h] BYREF
  HDEV pvProducer; // [rsp+58h] [rbp-1D0h] BYREF
  _QWORD v20[2]; // [rsp+60h] [rbp-1C8h] BYREF
  _QWORD v21[10]; // [rsp+70h] [rbp-1B8h] BYREF
  _BYTE v22[64]; // [rsp+C0h] [rbp-168h] BYREF
  _BYTE v23[32]; // [rsp+100h] [rbp-128h] BYREF
  __int64 v24; // [rsp+120h] [rbp-108h]
  _OWORD v25[3]; // [rsp+170h] [rbp-B8h] BYREF
  int v26; // [rsp+1A0h] [rbp-88h]
  _BYTE v27[96]; // [rsp+1B0h] [rbp-78h] BYREF
