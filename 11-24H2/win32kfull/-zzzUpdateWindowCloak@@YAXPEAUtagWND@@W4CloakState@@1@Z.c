/*
 * XREFs of ?zzzUpdateWindowCloak@@YAXPEAUtagWND@@W4CloakState@@1@Z @ 0x1400943FC
 * Callers:
...
void __fastcall zzzUpdateWindowCloak(__int64 a1, __int64 a2, int a3)
{
  ...
  v5 = (_DWORD)a2 != 0;
  v6 = a3 != 0;
  v7 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19200) + 48LL) & 0x400;
  if ( v5 != v6 || (v8 = 0, v7) )
    v8 = 1;
  ...
  if ( v5 != v6 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      v16 = *(_DWORD *)(v15 + 1020) + 1;
      *(_DWORD *)(v15 + 1020) = v16;
      if ( *(_DWORD *)(v15 + 1016) <= v16 )
      {
        v17 = 1LL;
LABEL_20:
    ...
    else
    {
      ...
      if ( *(_DWORD *)(v15 + 1016) > *(_DWORD *)(v15 + 1020) )
      {
        v17 = 0LL;
        goto LABEL_20;
      }
