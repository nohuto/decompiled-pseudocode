/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x140160DD8
 * Callers:
 *     DoPrediction @ 0x140160A80 (DoPrediction.c)
 * Callees:
 ...
 *     ?FastMul64by64@@YA_J_J0@Z @ 0x140161FD4 (-FastMul64by64@@YA_J_J0@Z.c)
 *     ?Div128by64@@YA_J_J_K0AEA_J@Z @ 0x140162868 (-Div128by64@@YA_J_J_K0AEA_J@Z.c)
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x140162BE8 (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 */
        ...
        struct tagPOINT *a6)
{
  ...
  if ( *(_DWORD *)(((__int64 (__fastcall *)(_QWORD, _QWORD))W32GetUserSessionState)(a1, a2) + 18992) != 1 || !v7 )
  {
    v7 = *(_DWORD *)(W32GetUserSessionState(v10, v9) + 18988);
    if ( !v7 )
    {
      *a5 = a2;
      *a6 = a3;
  ...
  v17 = a4;
  v111 = 0;
  v113 = (__int64)*(int *)(UserSessionState + 18984) << 32;
