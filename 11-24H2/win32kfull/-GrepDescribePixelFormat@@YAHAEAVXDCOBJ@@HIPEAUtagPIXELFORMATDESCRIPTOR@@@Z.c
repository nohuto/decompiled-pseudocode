/*
 * XREFs of ?GrepDescribePixelFormat@@YAHAEAVXDCOBJ@@HIPEAUtagPIXELFORMATDESCRIPTOR@@@Z @ 0x14033C804
 * Callers:
        ...
        struct tagPIXELFORMATDESCRIPTOR *a4)
{
  ...
  struct _RECTL v15; // [rsp+30h] [rbp-B8h] BYREF
  HDC v16[18]; // [rsp+40h] [rbp-A8h] BYREF
