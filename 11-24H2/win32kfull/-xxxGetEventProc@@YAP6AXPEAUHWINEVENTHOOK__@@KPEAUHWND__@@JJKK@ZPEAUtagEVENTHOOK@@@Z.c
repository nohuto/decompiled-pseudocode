/*
 * XREFs of ?xxxGetEventProc@@YAP6AXPEAUHWINEVENTHOOK__@@KPEAUHWND__@@JJKK@ZPEAUtagEVENTHOOK@@@Z @ 0x140082B90
 * Callers:
        ...
        __int64 a2))(HWINEVENTHOOK, unsigned int, HWND, int, int, unsigned int, unsigned int)
{
  ...
  if ( *((_DWORD *)a1 + 18) != -1 )
  {
    ...
    if ( !(unsigned int)PsIsProtectedProcess(CurrentProcess) )
    {
      ...
      v25 = 1;
      v26 = W32GetUserSessionState(v11, v10) + 42424;
      v27 = 0;
      v28 = 0LL;
      if ( DomainLockRef )
      {
...
LABEL_20:
  ...
  v20 = *((int *)a1 + 18);
  v21 = *(_QWORD *)(v7 + 464);
  v22 = *((_QWORD *)a1 + 8) + *(_QWORD *)(v21 + 8 * v20 + 400);
  if ( (_DWORD)v20 != -1 )
    MakeExportSuppressedPfnValid(*((_QWORD *)a1 + 8) + *(_QWORD *)(v21 + 8 * v20 + 400));
