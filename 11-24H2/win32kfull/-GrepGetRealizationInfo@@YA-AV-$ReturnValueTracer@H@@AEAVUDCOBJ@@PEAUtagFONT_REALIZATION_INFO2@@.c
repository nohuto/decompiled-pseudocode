/*
 * XREFs of ?GrepGetRealizationInfo@@YA?AV?$ReturnValueTracer@H@@AEAVUDCOBJ@@PEAUtagFONT_REALIZATION_INFO2@@W4EntryPoint@RFONTOBJ@@@Z @ 0x140165A6C
 * Callers:
...
_DWORD *__fastcall GrepGetRealizationInfo(_DWORD *a1, struct UDCOBJ *a2, __int64 a3, int a4)
{
  ...
  v9 = 0LL;
  if ( (unsigned int)RFONTOBJ::bInit((RFONTOBJ *)&v9, a2, 0LL, 2u, (const struct RFONTOBJ::Tag *)&v10) )
