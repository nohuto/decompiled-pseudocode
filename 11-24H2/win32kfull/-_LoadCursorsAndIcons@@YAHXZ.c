/*
 * XREFs of ?_LoadCursorsAndIcons@@YAHXZ @ 0x14028246C
 * Callers:
 *     NtUserLoadCursorsAndIcons @ 0x14021A940 (NtUserLoadCursorsAndIcons.c)
 * Callees:
...
__int64 __fastcall _LoadCursorsAndIcons(__int64 a1)
{
  ...
  if ( PsGetCurrentProcess(v2) == v1 )
  {
    ...
    v6 = 0LL;
    for ( i = *(_QWORD *)(W32GetUserSessionState(v5, v4) + 36336); i; i = *(_QWORD *)(i + 32) )
    {
      ...
      if ( *(_WORD *)(i + 74) == 1 )
      {
        if ( *(_QWORD *)(i + 48) == i )
        {
          ...
          if ( (unsigned int)(v16 - 100) > 0x12 || *(_QWORD *)(W32GetUserSessionState(v8, v7) + 552 * v16 - 33264) )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 552);
      ...
      else if ( *(_WORD *)(i + 74) == 3 )
      {
        ...
        v12 = *(unsigned __int16 *)(W32GetUserSessionState(v8, v7) + v10 + 32416);
        v13 = *(_DWORD *)(i + 80);
        *(_QWORD *)(i + 64) = v12;
        if ( (v13 & 4) != 0 )
        {
          ...
          v20[1] = i;
          v20[0] = v10 + UserSessionState + 32424;
          HMAssignmentLock(v20, 0LL);
        }
        else
        {
          v15 = *(_QWORD *)i;
          v8 = *(_QWORD *)(W32GetUserSessionState(v12, v11) + 19928);
          *(_QWORD *)(v8 + 6968) = v15;
        }
      }
    }
    if ( *(_QWORD *)(W32GetUserSessionState(v8, v7) + 35184) )
    {
      v18 = *(__int64 **)(W32GetUserSessionState(v18, v17) + 35184);
      v6 = *v18;
    }
    *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v18, v17) + 19928) + 6976LL) = v6;
  }
  return 1LL;
}
