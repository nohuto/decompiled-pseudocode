/*
 * XREFs of NtUserGetDwmCursorShape @ 0x140295E40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FreeTelemetryInfoBitmaps@CursorApiRouter@@QEAAXPEAUCursorTelemetryInfo@@@Z @ 0x1402D9ED8 (-FreeTelemetryInfoBitmaps@CursorApiRouter@@QEAAXPEAUCursorTelemetryInfo@@@Z.c)
...
LABEL_4:
  ...
  if ( (unsigned __int8)IsInputThread(v9, v8, v10) )
  {
    ...
    *v20 = *v20;
    ...
    DwmCursorShape = CursorApiRouter::UserGetDwmCursorShape(
                       *(CursorApiRouter **)(UserSessionState + 36360),
                       v6,
                       a2,
                       v4,
                       a4);
  ...
  else
  {
    ...
    if ( (unsigned int)v4 >= 0xE8 )
    {
      ...
      CursorApiRouter::GetTelemetryInfo(*(CursorApiRouter **)(v15 + 36360), (struct CursorTelemetryInfo *)Src);
