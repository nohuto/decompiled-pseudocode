/*
 * XREFs of wil_details_FeatureReporting_ReportVariantUsageToService @ 0x1401A5368
 * Callers:
 *     Feature_HSHELL_IAM_Delivery__private_GetVariant @ 0x1401A531C (Feature_HSHELL_IAM_Delivery__private_GetVariant.c)
 * Callees:
        ...
        __int64 a2))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( g_wil_details_pfnFeatureLoggingHook )
      return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))g_wil_details_pfnFeatureLoggingHook(39786106LL, &Feature_ValLabTest_logged_traits, 0LL, v3 & 1, 0LL, &v5, v2, 1LL);
  }
  return result;
}
