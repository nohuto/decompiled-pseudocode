/*
 * XREFs of ?DdcciGetVCPFeature@CMonitorAPI@@QEAAJPEAXKPEAW4_MC_VCP_CODE_TYPE@@PEAK2@Z @ 0x1401EC9D8
 * Callers:
 *     NtGdiDDCCIGetVCPFeature @ 0x1401EC8C0 (NtGdiDDCCIGetVCPFeature.c)
 * Callees:
