 ...
 * Callees:
 *     FractionToMantissa @ 0x14013F214 (FractionToMantissa.c)
...
__int64 __fastcall Log(__int64 a1)
{
  ...
  v2 = (int)a1 / 1000000;
  v3 = *(_DWORD *)&aWerlivekernelr_3[4 * ((int)a1 / 1000000) + 16];
  v4 = (unsigned int)((int)a1 % 1000000);
  if ( (_DWORD)v4 )
    v3 += FractionToMantissa(v4, (unsigned int)dword_14035E9F0[v2]);
