/*
 * XREFs of ?SpDdCreateFullscreenSprite@@YAJAEAVXDCOBJ@@KPEAPEAXPEAPEAUHDC__@@@Z @ 0x140320C58
 * Callers:
 *     NtGdiDdCreateFullscreenSprite @ 0x140325750 (NtGdiDdCreateFullscreenSprite.c)
 * Callees:
...
__int64 __fastcall SpDdCreateFullscreenSprite(struct XDCOBJ *a1, unsigned int a2, void **a3, HDC *a4)
{
  ...
  HDC v37[18]; // [rsp+140h] [rbp-F8h] BYREF
