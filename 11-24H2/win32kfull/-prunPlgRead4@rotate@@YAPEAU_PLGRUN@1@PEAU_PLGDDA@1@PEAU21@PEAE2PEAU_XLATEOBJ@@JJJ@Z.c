/*
 * XREFs of ?prunPlgRead4@rotate@@YAPEAU_PLGRUN@1@PEAU_PLGDDA@1@PEAU21@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x14031DA10
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v23 & dword_140352C90[v25]) != 0 )
        {
          v26 = ((unsigned int)v12 & dword_140361A58[v24]) >> dword_140361A38[v24];
          if ( a5 )
  ...
  else if ( v8 < a7 )
  {
    ...
    while ( 1 )
    {
      v14 = ((unsigned int)v12 & dword_140361A58[v13]) >> dword_140361A38[v13];
      if ( a5 )
