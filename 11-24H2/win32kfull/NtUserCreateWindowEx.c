/*
 * XREFs of NtUserCreateWindowEx @ 0x14004AF20
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a17)
{
  ...
  struct tagWND *v54; // [rsp+A0h] [rbp-E8h]
  __int64 v55[2]; // [rsp+A8h] [rbp-E0h] BYREF
  __int64 v56; // [rsp+B8h] [rbp-D0h]
  __m128i v57; // [rsp+C8h] [rbp-C0h] BYREF
  __m128i v58; // [rsp+D8h] [rbp-B0h] BYREF
  ULONG_PTR BugCheckParameter2[2]; // [rsp+E8h] [rbp-A0h] BYREF
  void (*v60)(void *); // [rsp+F8h] [rbp-90h]
  ULONG_PTR BugCheckParameter3[2]; // [rsp+108h] [rbp-80h] BYREF
  ULONG_PTR v62[3]; // [rsp+118h] [rbp-70h] BYREF
  _BYTE v63[88]; // [rsp+130h] [rbp-58h] BYREF
  unsigned int v67; // [rsp+1D8h] [rbp+50h]
  ...
  *(_OWORD *)Size = 0LL;
  ...
  v58 = 0LL;
  EnterCrit(0LL, 0LL);
  Win32HMOptionalThreadLockAlways<tagMENU>::Win32HMOptionalThreadLockAlways<tagMENU>(v62);
  tagTLBLOCK::_unnamed_type_list_::_unnamed_type_list_((tagTLBLOCK::_unnamed_type_list_ *)BugCheckParameter2);
  SmartObjStackRef<tagMENU>::SmartObjStackRef<tagMENU>(v55);
  v22 = a10;
  v23 = 0LL;
  if ( a10 == -3 )
  {
  ...
  {
    v54 = (struct tagWND *)ValidateHwnd(a10);
    if ( !v54 )
      goto LABEL_75;
  }
  else
...
LABEL_86:
  ...
  BugCheckParameter3[0] = (ULONG_PTR)v26;
  if ( (a5 & 0xC0000000) == 0x40000000 || !a11 )
  {
    v27 = SmartObjStackRef<tagMENU>::SmartObjStackRef<tagMENU>(v63, a11);
    v56 = *(_QWORD *)(v27 + 16);
    v28 = **(_QWORD **)v27;
    if ( v28 != *(_QWORD *)v55[0] )
    {
      SmartObjStackRefBase<tagMENU>::DecrementCountAndTryFree(v55);
      if ( v28 )
      {
        v55[0] = *(_QWORD *)(v28 + 152);
        ++*(_DWORD *)(v55[0] + 8);
      }
      else
      {
        v55[0] = gSmartObjNullRef;
      }
    }
    SmartObjStackRef<tagMENU>::~SmartObjStackRef<tagMENU>(v63);
    v17 = a4;
    v18 = a3;
    v19 = a2;
  }
  ...
  {
    ValidateHmenu(a11, 1LL);
    v56 = 0LL;
    SmartObjStackRefBase<tagMENU>::operator=(v55);
    if ( (unsigned __int8)SmartObjStackRef<tagMENU>::operator==(v55) )
      goto LABEL_75;
    v52 = v56;
    if ( !v56 )
    {
    ...
    Win32HM_LockIntoThread<0>(v26, v52, v62);
  }
  ...
  if ( ((unsigned __int64)v18 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    if ( v18 >= *v33 )
      v18 = *v33;
    v57 = *v18;
    v36 = _mm_srli_si128(v57, 8).m128i_u64[0];
    if ( v36 )
    {
      if ( v57.m128i_i32[0] > (v57.m128i_i32[1] & 0x7FFFFFFFu) )
        ExRaiseAccessViolation();
      if ( v57.m128i_i32[1] < 0 )
      {
        v39 = v36 + v57.m128i_u32[0] + 1LL;
  ...
  if ( v17 )
  {
    if ( v17 >= *v33 )
      v17 = *v33;
    v58 = *v17;
    v34 = _mm_srli_si128(v58, 8).m128i_u64[0];
    if ( v34 )
    {
...
LABEL_75:
  ...
  Win32HMOptionalThreadLockAlways<tagMENU>::~Win32HMOptionalThreadLockAlways<tagMENU>((ULONG_PTR)v62);
