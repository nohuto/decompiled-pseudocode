/*
 * XREFs of ?_CheckAllowForeground2@CForegroundLaunch@@AEBA_NPEBUtagPROCESSINFO@@@Z @ 0x14028DBDC
 * Callers:
...
LABEL_133:
    ...
    if ( !v5
      && ((unsigned int)IsShellProcess((__int64)ProcessWin32Process)
       || (v23 = *(_QWORD *)(v22 + 656)) != 0 && (*(_DWORD *)(v23 + 64) & 4) != 0) )
    {
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
        || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 2) == 0
...
LABEL_57:
  ...
  v80 = *(CInputGlobals **)(W32GetUserSessionState(v74, v18) + 3064);
...
LABEL_59:
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v51, v49) + 18960)
    && (v58 = *(_QWORD *)(W32GetUserSessionState(v57, v49) + 18960), *(_DWORD *)(v58 + 672) <= 0x400u)
