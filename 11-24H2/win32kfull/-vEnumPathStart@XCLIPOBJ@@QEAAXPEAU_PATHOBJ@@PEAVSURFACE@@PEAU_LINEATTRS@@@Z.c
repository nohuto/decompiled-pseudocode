/*
 * XREFs of ?vEnumPathStart@XCLIPOBJ@@QEAAXPEAU_PATHOBJ@@PEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1401C34DC
 * Callers:
 ...
 *     PATHOBJ_vEnumStartClipLines @ 0x140311280 (PATHOBJ_vEnumStartClipLines.c)
 * Callees:
