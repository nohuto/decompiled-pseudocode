/*
 * XREFs of ?xxxResolveArrangePosition@@YA_NPEAUtagWND@@PEBVCMonitorTopology@@PEAU_WINDOW_ACTION@@@Z @ 0x1402D1294
 * Callers:
        ...
        struct _WINDOW_ACTION *a3)
{
  ...
  if ( v10 || v11 )
  {
    ...
    LOBYTE(v14) = v11;
    LOBYTE(v15) = v10;
    v16 = *(_QWORD *)(UserSessionState + 69416);
    v17 = "minimized";
    if ( !v8 )
      v17 = (const char *)&unk_14034ED21;
