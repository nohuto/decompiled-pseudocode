/*
 * XREFs of NtGdiPolyTextOutW @ 0x140261230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiPolyTextOutW(HDC a1, char *a2, unsigned int a3, unsigned int a4)
{
  ...
  char *v33; // [rsp+50h] [rbp-108h]
  _BYTE v34[64]; // [rsp+70h] [rbp-E8h] BYREF
  DC *v35[21]; // [rsp+B0h] [rbp-A8h] BYREF
...
LABEL_64:
      if ( v6 )
      {
        ...
        if ( EUDCCountRegion::IsReady((EUDCCountRegion *)v34) )
        {
          ...
          if ( v35[0] )
          {
            v6 = GrepPolyTextOutW(v35, (__int64)v8, a3, a4);
          }
          else
          {
            EngSetLastError(6u);
