/*
 * XREFs of xxxSetScrollBar @ 0x140032F08
 * Callers:
...
__int64 __fastcall xxxSetScrollBar(struct tagWND *a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( v10 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    ...
    GetScrollbarTypeString(v68, v14, v15, *(_QWORD *)(UserSessionState + 69416));
    LOBYTE(v16) = v63;
    LOBYTE(v17) = v62;
  ...
  SetOrClrWF(0LL, v7, v20, 1LL);
  v43 = (int)v67;
  if ( (_DWORD)v67 )
  {
    SetOrClrWF(1LL, v7, v20, 1LL);
  }
