/*
 * XREFs of EngComputeGlyphSet @ 0x140179CD0
 * Callers:
 ...
 *     cUnicodeRangesSupported @ 0x140179D9C (cUnicodeRangesSupported.c)
 *     cComputeGlyphSet @ 0x14017A064 (cComputeGlyphSet.c)
 */
...
FD_GLYPHSET *__stdcall EngComputeGlyphSet(INT nCodePage, INT nFirstChar, INT cChars)
{
  ...
  {
    v6 = PALLOCMEM(3 * cChars, 1936484167LL);
    v7 = (void *)v6;
    if ( v6 )
    {
      v8 = v6 + 2 * v3;
