/*
 * XREFs of ?CursorTypeUsage@GreCursor@InputTraceLogging@@SAXW4_TRACING_CURSOR_USAGE_TYPE@@@Z @ 0x140029D1C
 * Callers:
...
__int64 __fastcall InputTraceLogging::GreCursor::CursorTypeUsage(int a1, __int64 a2, __int64 a3, int a4)
{
  ...
  {
    v4 = "Hardware";
    v5 = (const char *)&unk_14034ED21;
  }
  if ( (unsigned int)dword_140398B80 > 4 && (qword_140398B90 & 0x20) != 0 )
  {
    result = qword_140398B98 & 0x20;
    if ( result == qword_140398B98 )
    {
      v11 = v4;
      v10 = v5;
