/*
 * XREFs of LogicalToPhysicalInPlaceRgnWorker @ 0x14019E0E8
 * Callers:
 ...
 *     ?TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z @ 0x14019E1F4 (-TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z.c)
 *     __security_check_cookie @ 0x140340250 (__security_check_cookie.c)
 */

__int64 __fastcall LogicalToPhysicalInPlaceRgnWorker(const struct tagWND *a1, HRGN *a2, __int64 a3)
{
  unsigned int v3; // ebx
