/*
 * XREFs of xxxPerformTargetingWithinPwnd @ 0x1401B45C0
 * Callers:
 *     PerformTargetingWithinPwnd @ 0x1401B3FD0 (PerformTargetingWithinPwnd.c)
 * Callees:
...
__int64 __fastcall xxxPerformTargetingWithinPwnd(struct tagTHREADINFO **a1, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  result = GetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 41412), 1u);
  if ( (result & 0xFFFD) != 0 )
  {
    ...
    if ( (_DWORD)result )
    {
      ...
      if ( v25 )
      {
        if ( v26 )
        {
          ...
          v17 = v22[1];
          v18 = v22[0];
          v11 = xxxSendTransformableMessageTimeout(a1, 589LL, 0LL, (struct tagDRAWITEMSTRUCT *)&v15, 0, 0, 0LL, 1, 0);
          result = 4093LL;
