/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x14033FE28
 * Callers:
 *     InitializeWin32kFullTelemetryAsserts @ 0x140282C90 (InitializeWin32kFullTelemetryAsserts.c)
 * Callees:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
        ...
        (g_ModuleName = v4) != 0LL) )
  {
    ...
    qword_140399488 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1403CF040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1403CF008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1403CF078);
