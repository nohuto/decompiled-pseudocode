/*
 * XREFs of ??$AllocAndCopyRegistryEntries@U_FONTMAPPERFAMILYFALLBACK@@$0EGEGENEH@@@YAJPEAKPEAPEAU_FONTMAPPERFAMILYFALLBACK@@0PEBU0@@Z @ 0x14031F388
 * Callers:
        ...
        _OWORD *a4)
{
  ...
  v10 = (v6 + 32) << 7;
  if ( *a2 )
    v11 = (__int64)PREALLOCMEM2(*a2, v6 << 7, v10, 0x46464D47u);
  else
