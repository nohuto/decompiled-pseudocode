/*
 * XREFs of NtGdiEnumObjects @ 0x140211130
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
      ...
      else
      {
        ...
        if ( v12 )
        {
          if ( v12 == 1 )
          {
            for ( i = (char *)&unk_1403618F0; i < v11; i += 4 )
            {
              v22 = 0LL;
              LODWORD(v22) = 0;
              DWORD1(v22) = *(_DWORD *)i;
            ...
            for ( j = (unsigned int *)&unk_1403618B8; j < dword_1403618D0; ++j )
            {
              for ( k = (char *)&unk_1403618F0; k < v11; k += 4 )
              {
                v21 = 0LL;
                LODWORD(v21) = 2;
                DWORD1(v21) = *(_DWORD *)k;
        ...
        {
          for ( m = dword_1403618D0; m < dword_1403618E4; ++m )
          {
            for ( n = (char *)&unk_1403618F0; n < v11; n += 4 )
            {
              LODWORD(v23) = *m;
