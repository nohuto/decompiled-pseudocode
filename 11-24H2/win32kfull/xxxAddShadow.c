/*
 * XREFs of xxxAddShadow @ 0x14015CF84
 * Callers:
...
__int64 __fastcall xxxAddShadow(struct tagWND *a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(W32GetUserSessionState(a1, a2) + 43304) )
    return 0LL;
  if ( *(_DWORD *)(W32GetUserSessionState(v4, v3) + 63456) )
    return 0LL;
  if ( (*(_DWORD *)(W32GetUserSessionState(v6, v5) + 67060) & 0x80040000) != 0x80040000 )
    return 0LL;
...
LABEL_9:
  ...
  v19 = *(unsigned __int16 *)(W32GetUserSessionState(v18, v17) + 41390);
  UserSessionState = W32GetUserSessionState(v21, v20);
  Window = (struct tagWND *)xxxCreateWindowEx(
                              v12,
                              (wchar_t *)*(unsigned __int16 *)(UserSessionState + 41390),
                              v19,
                              0LL,
                              0x80000000,
                              0,
...
LABEL_22:
  ...
  v31 = *(_QWORD *)(W32GetUserSessionState(v30, v29) + 63424);
  *(_QWORD *)(v9 + 16) = v31;
  v47 = v9;
  v48 = a1;
  *(_QWORD *)(W32GetUserSessionState(v31, v32) + 63424) = v9;
