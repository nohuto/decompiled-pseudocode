/*
 * XREFs of NtUserValidateTimerCallback @ 0x1401531D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserValidateTimerCallback(__int64 a1)
{
  ...
  if ( *(_DWORD *)(v8 + 672) > 0x501u
    ...
    || (v12 = *(HANDLE *)(W32GetUserSessionState(v7, v6) + 63584), PsGetProcessId(**(PEPROCESS **)(v8 + 464)) == v12) )
  {
    v9 = (_QWORD **)(W32GetUserSessionState(v7, v6) + 57584);
