/*
 * XREFs of ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x140302080
 * Callers:
...
void __fastcall vDitherColor4bpp(unsigned int *a1, struct _VERTEX_DATA *a2, struct _VERTEX_DATA *a3, unsigned int a4)
{
  ...
  if ( a4 > 2 )
  {
    ...
    *((_DWORD *)v10 + 1) = 255;
    ...
    v52 = v38;
    v53 = v38;
    v13 = (unsigned int *)&unk_140360B30;
...
LABEL_21:
  ...
  if ( (unsigned int)v19 < v21 )
  {
    ...
    v21 = *(_DWORD *)a2;
    v20 = (char *)a2 + 4;
    v22 = dword_140360DB0[v24];
    v23 = (unsigned int *)&unk_140360B30;
  }
  else
  {
    v22 = dword_140360DB0[*v18];
    v23 = (unsigned int *)((char *)&unk_140360B30 + 4 * v19);
  }
  v25 = *v20;
  v38 = v22;
  v39 = v22;
