/*
 * XREFs of HT_Get8BPPMaskPalette @ 0x1401267A0
 * Callers:
  ...
  if ( pPaletteEntry )
  {
    ...
    if ( v8 )
    {
      ...
      do
      {
        if ( v18 )
        {
          v14 = 255 * DivFD6(v17, v10);
          v38 = (255500000 - v14) / 1000000;
        }
        else
        {
          LOBYTE(v38) = 0;
        ...
        {
          if ( v20 )
            v14 = (int)(255500000 - 255 * DivFD6(v19, v9)) / 1000000;
          else
            LOBYTE(v14) = 0;
          v21 = v38;
          v22 = 0;
