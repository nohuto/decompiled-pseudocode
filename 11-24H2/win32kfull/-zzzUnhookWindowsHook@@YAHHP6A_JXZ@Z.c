/*
 * XREFs of ?zzzUnhookWindowsHook@@YAHHP6A_JXZ@Z @ 0x1402847C4
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)(Valid + 68) == -1 )
        ...
        v12 = (__int64 (*)(void))(*(_QWORD *)(Valid + 56)
                                + *(_QWORD *)(*((_QWORD *)PtiCurrent(v9, v8) + 58) + 8LL * *(int *)(Valid + 68) + 400));
      if ( v12 == a2 )
      {
        if ( *(struct tagTHREADINFO **)(v11 + 16) == v6 )
        {
          v10 = zzzUnhookWindowsHookEx((struct tagHOOK *)v11);
        }
        else
        {
          UserSetLastError(5);
