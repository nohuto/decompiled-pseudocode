/*
 * XREFs of xxxTrackMouseMove @ 0x140255AC4
 * Callers:
 ...
 *     Feature_TouchpadHapticsFollowUps__private_IsEnabledDeviceUsageNoInline @ 0x1402DB8B0 (Feature_TouchpadHapticsFollowUps__private_IsEnabledDeviceUsageNoInline.c)
 */
...
__int64 __fastcall xxxTrackMouseMove(struct tagWND *a1, __int64 a2, int a3, __int64 a4)
{
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  if ( a3 == 512 )
  {
    v10 = *(unsigned int *)(W32GetUserSessionState(v10, v9) + 67060);
    if ( (v10 & 1) != 0 )
    {
  ...
  if ( v5 != 1 && a3 == 512 && (*(_DWORD *)(W32GetUserSessionState(v21, v20) + 67060) & 0x80000080) == 0x80000080 )
  {
...
LABEL_45:
  if ( v13 != v6 )
  {
    ...
    if ( a3 == 512 && (*(_DWORD *)(W32GetUserSessionState(v28, v27) + 67060) & 1) != 0 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)(*((_QWORD *)v33 + 59) + 436LL) |= 0x200000u;
      }
    }
  }
LABEL_52:
