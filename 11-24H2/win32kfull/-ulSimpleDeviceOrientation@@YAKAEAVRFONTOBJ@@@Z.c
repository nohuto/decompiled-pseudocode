/*
 * XREFs of ?ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z @ 0x14020A674
 * Callers:
...
__int64 __fastcall ulSimpleDeviceOrientation(struct RFONTOBJ *a1)
{
  ...
  v1 = (*(float *)(*(_QWORD *)a1 + 392LL) > 0.0) - (*(float *)(*(_QWORD *)a1 + 392LL) < 0.0);
  v2 = (__PAIR64__(*(float *)(*(_QWORD *)a1 + 396LL) > 0.0, *(_DWORD *)(*(_QWORD *)a1 + 396LL))
