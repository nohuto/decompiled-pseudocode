/*
 * XREFs of ?xxxHandleHealthyThread@@YAXPEAUtagTHREADINFO@@@Z @ 0x14017CB7C
 * Callers:
...
void __fastcall xxxHandleHealthyThread(struct tagTHREADINFO *a1, __int64 a2)
{
        ...
        i = _InterlockedCompareExchange((volatile signed __int32 *)a1 + 132, 0, 0) )
  {
    ...
    do
    {
      v5 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19944) + 32LL * v4;
      v9 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 19888);
      if ( *(_BYTE *)(v5 + 24) == 1 )
      {
    ...
    while ( v4 <= *(_DWORD *)(W32GetUserSessionState(v9, v8) + 19872) );
  }
}
