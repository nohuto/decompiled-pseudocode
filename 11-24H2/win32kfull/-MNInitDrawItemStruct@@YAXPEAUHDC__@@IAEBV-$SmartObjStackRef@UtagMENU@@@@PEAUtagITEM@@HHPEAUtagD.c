/*
 * XREFs of ?MNInitDrawItemStruct@@YAXPEAUHDC__@@IAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z @ 0x14006B4C8
 * Callers:
...
__int64 __fastcall MNInitDrawItemStruct(__int64 a1, int a2, __int64 ***a3, __int64 *a4, int a5, int a6, __int64 a7)
{
  ...
  *(_DWORD *)(a7 + 8) = v10;
  v11 = *(_DWORD *)(*a4 + 4);
  *(_DWORD *)(a7 + 16) = v11 & 8 | ((unsigned int)MNDrawHilite(a3, a4) != 0) | (8 * (*(_DWORD *)((**a3)[5] + 40) & 0x10)) | (2 * (v11 & 1)) | ((v11 & 3) != 0 ? 4 : 0) | ~(*(_DWORD *)((**a3)[5] + 40) << 6) & 0x100 | ((v11 & 0x100 | (v11 >> 5) & 0x80) >> 2);
