/*
 * XREFs of pDCIAdjClr @ 0x14013CA6C
 * Callers:
 ...
 *     CompareMemory @ 0x14019E578 (CompareMemory.c)
 *     GenCMYMaskXlate @ 0x1402F4570 (GenCMYMaskXlate.c)
 *     TintAngle @ 0x1402F47A4 (TintAngle.c)
