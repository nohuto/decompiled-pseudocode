/*
 * XREFs of vRemoveAllInactiveRFONTs @ 0x14021F5CC
 * Callers:
...
void __fastcall vRemoveAllInactiveRFONTs(__int64 a1)
{
  ...
  HSEMAPHORE *v19; // rdi
  _QWORD *v20; // rsi
  HSEMAPHORE v21; // [rsp+28h] [rbp-E0h] BYREF
  _BYTE v22[40]; // [rsp+30h] [rbp-D8h] BYREF
  _QWORD v23[130]; // [rsp+58h] [rbp-B0h] BYREF

  v2 = 0;
  LODWORD(v21) = 0;
  memset_0(v23, 0, 0x408uLL);
  v3 = 0LL;
  v6 = *(_QWORD *)(W32GetSessionState(v5, v4) + 96);
  SEMOBJ<17>::SEMOBJ<17>((HSEMAPHORE *)v22, v6 + 4872);
  SEMOBJ<18>::SEMOBJ<18>(&v21, v6 + 4872);
  ...
  SEMOBJ<17>::vUnlock((HSEMAPHORE *)v22);
  v23[v3] = 0LL;
  v18 = (unsigned int)v3;
  if ( (_DWORD)v3 )
  {
    ...
    do
    {
      v21 = *v19;
      memset(&v22[8], 0, 32);
      PushThreadGuardedObject(&v22[8], v20, vRestartRemoveAllInactiveRFONTs);
      RFONTOBJ::vDeleteRFONT((RFONTOBJ *)&v21, 0LL, 0LL, 1);
      PopThreadGuardedObject(&v22[8]);
      v21 = 0LL;
