/*
 * XREFs of zzzStartFade @ 0x1401E29B8
 * Callers:
...
__int64 __fastcall zzzStartFade(__int64 a1, __int64 a2)
{
  ...
  GreSetBitmapOwner(*(_QWORD *)(UserSessionState + 43040), 0LL);
  zzzShowFade();
  v3 = (40 * *(_DWORD *)(UserSessionState + 43064) + 255) / 0xFFu;
  v4 = (unsigned int)((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24)
     - (unsigned int)v3;
  v5 = -(*(_DWORD *)(UserSessionState + 43072) & 0x80);
  *(_DWORD *)(UserSessionState + 43068) = v4;
  v6 = v5 != 0 ? 0x28 : 0;
  result = W32GetUserSessionState(v4, v3);
  v8 = *(_QWORD *)(result + 68728);
  if ( v8 )
  {
    result = _HMPheFromObject(*(_QWORD *)(result + 68728));
