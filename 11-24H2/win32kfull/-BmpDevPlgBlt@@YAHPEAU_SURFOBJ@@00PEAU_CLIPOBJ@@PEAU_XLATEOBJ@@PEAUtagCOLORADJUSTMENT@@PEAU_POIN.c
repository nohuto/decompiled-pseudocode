/*
 * XREFs of ?BmpDevPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1402FB7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v18 )
        {
          do
          {
              ...
              && *(_QWORD *)(*(_QWORD *)(v19 + 1776) + 632LL) )
            {
              ...
              (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _POINTFIX *, struct _RECTL *, struct _POINTL *, unsigned int))(*(_QWORD *)(v19 + 1776) + 632LL))(
                v21,
                v22,
                DevBitmap,
                a4,
