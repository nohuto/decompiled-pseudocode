/*
 * XREFs of WindowMargins::CWindowMarginProp::CalculateWindowMargins @ 0x14014C388
 * Callers:
 ...
 *     WindowMargins::CWindowMarginProp::GetOverrideMargins @ 0x1402BF4A8 (WindowMargins--CWindowMarginProp--GetOverrideMargins.c)
...
LABEL_162:
    ...
    if ( IsWindowNCRenderingEnabled((__m128i **)v6) )
    {
      if ( (*(_BYTE *)(W32GetUserSessionState(v29, v28) + 21100) & 1) == 0 )
        goto LABEL_28;
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
        || !_bittest((const signed __int32 *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL), 0x14u)
