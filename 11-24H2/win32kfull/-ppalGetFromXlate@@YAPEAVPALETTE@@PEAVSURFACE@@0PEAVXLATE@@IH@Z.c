/*
 * XREFs of ?ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z @ 0x1401C285C
 * Callers:
...
struct PALETTE *__fastcall ppalGetFromXlate(struct SURFACE *a1, struct SURFACE *a2, struct XLATE *a3, int a4, int a5)
{
  ...
  {
    v7 = *((_QWORD *)a1 + 6);
    if ( v7 && (*(_DWORD *)(v7 + 2156) & 0x100) != 0 )
    {
      v8 = *((_DWORD *)a1 + 24) == *(_DWORD *)(v7 + 2092);
      goto LABEL_14;
    }
  }
  else
  {
    ...
    if ( v7 && (*(_DWORD *)(v7 + 2156) & 0x100) == 0 )
    {
      v8 = *((_DWORD *)a2 + 24) == *(_DWORD *)(v7 + 2092);
LABEL_14:
      if ( v8 )
      {
        v5 = *(_QWORD *)(v7 + 1792);
