/*
 * XREFs of ?FreeMoveSizeData@MOVESIZEDATA@@SAXPEAPEAU1@@Z @ 0x140220B14
 * Callers:
 ...
 *     EditionFreeMoveSizeDataOnThreadDestroy @ 0x1402AA850 (EditionFreeMoveSizeDataOnThreadDestroy.c)
 * Callees:
