/*
 * XREFs of ?ConvertToAndFromWideChar@@YAHIPEAGHPEADHH@Z @ 0x14017A1B8
 * Callers:
 ...
 *     EngMultiByteToWideChar @ 0x140179BF0 (EngMultiByteToWideChar.c)
 ...
 *     EngWideCharToMultiByte @ 0x14026CC80 (EngWideCharToMultiByte.c)
 * Callees:
 *     PALLOCMEM @ 0x1400FEC9C (PALLOCMEM.c)
 *     ?GetNlsTablePath@@YAHIPEAG@Z @ 0x140220984 (-GetNlsTablePath@@YAHIPEAG@Z.c)
 *     ?ConvertToAndFromWideCharSymCP@@YAHPEAGHPEADHH@Z @ 0x14026BF04 (-ConvertToAndFromWideCharSymCP@@YAHPEAGHPEADHH@Z.c)
