/*
 * XREFs of ?IsWindowEligibleForRecalc@CRecalcProp@@CA_NPEBUtagWND@@@Z @ 0x14019A800
 * Callers:
...
char __fastcall CRecalcProp::IsWindowEligibleForRecalc(const struct tagWND *a1)
{
  ...
  if ( !IsTopLevelWindow((__int64)a1) )
  {
    ...
    if ( !v9 && !v7 )
      return 0;
    v14 = *(_QWORD *)a1;
    v12 = *(_QWORD *)(W32GetUserSessionState(v3, *(_QWORD *)&WPP_GLOBAL_Control) + 69416);
    v13 = 73;
    goto LABEL_24;
  }
  if ( *(char *)(*((_QWORD *)a1 + 5) + 24LL) < 0 )
  {
    ...
    if ( !v9 && !v7 )
      return 0;
    v14 = *(_QWORD *)a1;
    v12 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v2) + 69416);
    v13 = 74;
    goto LABEL_24;
  }
  ...
  v5 = *v4;
  v7 = 1;
  if ( v5 != *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v4, v2) + 19928) + 898LL)
  ...
  {
    v14 = *(_QWORD *)a1;
    v12 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v6) + 69416);
    v13 = 75;
LABEL_24:
    LOBYTE(v11) = v7;
    LOBYTE(v10) = v9;
