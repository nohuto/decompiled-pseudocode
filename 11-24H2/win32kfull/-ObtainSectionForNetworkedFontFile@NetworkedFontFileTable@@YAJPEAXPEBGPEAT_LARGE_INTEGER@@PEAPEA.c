/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@NetworkedFontFileTable@@YAJPEAXPEBGPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUNETWORKED_FONT_FILE_NODE@@@Z @ 0x1403041D8
 * Callers:
        ...
        void **a5)
{
  ...
  if ( v14 )
  {
    ...
    W32AcquirePushLockShared((struct W32_PUSH_LOCK *)(v15 + 8));
    W32ReleasePushLockShared((struct W32_PUSH_LOCK *)(v15 + 8));
    if ( !*(_QWORD *)v15 )
      goto LABEL_6;
    v25 = *(void **)v15;
    Gre::SectionObj::SectionObj(&v23, &v25, 1LL, 0LL);
    v17 = v23;
    if ( v23 )
    {
      v23 = 0LL;
...
LABEL_10:
  ...
  *((_QWORD *)inserted + 1) = 0LL;
  W32AcquirePushLockExclusive((struct W32_PUSH_LOCK *)(inserted + 8));
  SEMOBJ<26>::vUnlock(&v26);
  ...
  W32ReleasePushLockExclusive((struct W32_PUSH_LOCK *)(v15 + 8));
  if ( v9 < 0 )
  {
    a4->QuadPart = 0LL;
    *(_QWORD *)v15 = 0LL;
