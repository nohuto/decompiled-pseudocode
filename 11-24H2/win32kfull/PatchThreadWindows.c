/*
 * XREFs of PatchThreadWindows @ 0x1402B4D00
 * Callers:
 *     <none>
 * Callees:
...
LONG_PTR __fastcall PatchThreadWindows(struct tagTHREADINFO *a1)
{
  ...
  v13 = *(struct tagWND ***)(result + 19888);
  if ( v12 <= v8 )
  {
    while ( 1 )
    {
...
LABEL_13:
    ...
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000, 5659);
LABEL_8:
    v16 = *(_QWORD *)v15;
    ...
    if ( (unsigned __int16)(v17 - 666) > 6u || (_WORD)v17 == 666 )
      ...
      *(_QWORD *)(*(_QWORD *)v15 + 120LL) = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v16, v17) + 19928)
