/*
 * XREFs of _DelegateCapturePointers @ 0x1400A6408
 * Callers:
 *     ?DelegateCapturePointersMitOn@@YAHIPEAI0@Z @ 0x1400A5FD8 (-DelegateCapturePointersMitOn@@YAHIPEAI0@Z.c)
 *     EditionDelegateCapturePointers @ 0x14028BE80 (EditionDelegateCapturePointers.c)
 * Callees:
    ...
    do
    {
      if ( *(_DWORD *)(v5 + 116) )
      {
        ...
        else
        {
          ...
          CTouchProcessor::SetPointerInfoNodeFlagFromEdition(*(CTouchProcessor **)(v26 + 3264), v25, v24, 0x200000u);
        }
