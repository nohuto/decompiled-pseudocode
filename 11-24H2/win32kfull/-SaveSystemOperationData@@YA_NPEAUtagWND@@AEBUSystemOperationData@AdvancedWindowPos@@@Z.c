/*
 * XREFs of ?SaveSystemOperationData@@YA_NPEAUtagWND@@AEBUSystemOperationData@AdvancedWindowPos@@@Z @ 0x1402CAEEC
 * Callers:
...
char __fastcall SaveSystemOperationData(struct tagWND *a1, const struct AdvancedWindowPos::SystemOperationData *a2)
{
  ...
  if ( v10 )
  {
    if ( *((_DWORD *)v10 + 12) >= 0xAu )
    {
      ...
      v21 = *(_QWORD *)a1;
      v20 = 21;
      v16 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v11) + 69416);
      v19 = 3;
LABEL_28:
      LOBYTE(v15) = v13;
      LOBYTE(v14) = v12;
    ...
    if ( CInterceptWindowProp::SaveData(v10, a2) )
    {
      ...
      if ( !v12 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        return 1;
      v21 = *(_QWORD *)a1;
      v16 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v17) + 69416);
      v20 = 22;
      v19 = 4;
      goto LABEL_28;
    }
