/*
 * XREFs of NtUserShutdownBlockReasonCreate @ 0x14012B7F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  v18 = (void *)InternalRemoveProp(v6, *(unsigned __int16 *)(UserSessionState + 41416), 1u);
  if ( v18 )
    Win32FreePool(v18);
  v21 = W32GetUserSessionState(v20, v19);
  if ( (unsigned int)InternalSetProp(v6, *(unsigned __int16 *)(v21 + 41416), (__int64)v13, 1u) )
  {
    v15 = 0;
    if ( *(_QWORD *)(W32GetUserSessionState(v5, v22) + 69296) )
