/*
 * XREFs of SfnOUTLPRECT @ 0x1401D1D30
 * Callers:
        ...
        __int64 a8)
{
  ...
  __int64 v24; // rcx
  void *v25; // rdx
  _DWORD v27[6]; // [rsp+30h] [rbp-E8h] BYREF
  void *Src; // [rsp+48h] [rbp-D0h] BYREF
  __int64 v29; // [rsp+50h] [rbp-C8h] BYREF
  _BYTE v30[8]; // [rsp+60h] [rbp-B8h] BYREF
  __int128 v31; // [rsp+68h] [rbp-B0h]
  __int64 v32; // [rsp+78h] [rbp-A0h]
  __int128 v33; // [rsp+80h] [rbp-98h] BYREF
  ULONG_PTR BugCheckParameter3[2]; // [rsp+90h] [rbp-88h] BYREF
  __int64 v35; // [rsp+A0h] [rbp-78h] BYREF
  int v36; // [rsp+A8h] [rbp-70h]
  int v37; // [rsp+ACh] [rbp-6Ch]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 65) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(34LL, &v35, 40LL, &Src, v27);
