/*
 * XREFs of NtUserGetDCEx @ 0x140242280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetDCEx(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a2 && !(unsigned int)GreIsValidRegion(a2)
    || a2 == *(_QWORD *)(W32GetUserSessionState(v7, v6) + 43104)
    || (a3 & 0xFFDAF800) != 0 )
  {
    v20 = 87;
    goto LABEL_22;
  ...
  if ( !a1 )
  {
    ...
    else
    {
      ...
      if ( (_InterlockedCompareExchange((volatile signed __int32 *)v18 + 132, 0, 0) & 0x20000000) == 0 )
        goto LABEL_17;
      HasUILimit = *(_BYTE *)(*(_QWORD *)(*((_QWORD *)PtiCurrent((__int64)v18, v17) + 58) + 760LL) + 32LL) & 1;
    }
    if ( !HasUILimit )
      goto LABEL_17;
    v19 = 0LL;
