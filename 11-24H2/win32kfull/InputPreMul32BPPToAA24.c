/*
 * XREFs of InputPreMul32BPPToAA24 @ 0x1402F82F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
_BYTE *__fastcall InputPreMul32BPPToAA24(char *a1, _BYTE *a2)
{
  ...
  if ( (*a1 & 4) != 0 )
  {
    ...
    do
    {
      ...
      v12 = *v8;
      v8 += 4;
      *v2++ = (unsigned __int16)(*(_WORD *)(v9 + 4 * ((unsigned __int64)(unsigned int)(v10 * v12 + 0x800000) >> 24))
                               + v11) >> 8;
    }
    while ( v2 < v6 );
  }
  else if ( (v26 & 4) != 0 )
  {
    do
    {
      ...
      v14 = *v8;
      v8 += 4;
      *v2 = (unsigned int)(v13 * v14 + 0x800000) >> 24;
      v2[1] = (v13 * (unsigned int)*(v8 - 3) + 0x800000) >> 24;
      v2[2] = (v13 * (unsigned int)*(v8 - 2) + 0x800000) >> 24;
      v2 += 3;
    }
    while ( v2 < v6 );
  }
  else if ( (v26 & 8) != 0 )
  {
    do
    {
      ...
      v16 = *v8;
      v8 += 4;
      v2[2] = (unsigned int)(v15 * v16 + 0x800000) >> 24;
      v2[1] = (v15 * (unsigned int)*(v8 - 3) + 0x800000) >> 24;
      *v2 = (v15 * (unsigned int)*(v8 - 2) + 0x800000) >> 24;
      v2 += 3;
    }
    while ( v2 < v6 );
  }
  else
  {
    ...
    do
    {
      ...
      v21 = *v17;
      v17 += 4;
      *v2 = (unsigned int)(v20 * v21 + 0x800000) >> 24;
      v2[1] = (unsigned int)(v20 * v18 + 0x800000) >> 24;
      v2[2] = (unsigned int)(v20 * v19 + 0x800000) >> 24;
      v2 += 3;
    }
    while ( v2 < v6 );
  }
