/*
 * XREFs of ?xxxSetForegroundForWindowAction@AdvancedWindowPos@@YAXPEAUtagWND@@PEAUWindowAction@1@@Z @ 0x1402D7D40
 * Callers:
        ...
        struct AdvancedWindowPos::WindowAction *a3)
{
  ...
  v4 = this;
  if ( *(_QWORD *)(W32GetUserSessionState(this, a2) + 18944) == *(_QWORD *)(*((_QWORD *)this + 2) + 472LL) )
  {
    v6 = 1;
