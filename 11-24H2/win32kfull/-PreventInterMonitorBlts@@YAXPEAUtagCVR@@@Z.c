/*
 * XREFs of ?PreventInterMonitorBlts@@YAXPEAUtagCVR@@@Z @ 0x14026F7E0
 * Callers:
...
void __fastcall PreventInterMonitorBlts(struct tagCVR *a1)
{
  ...
  if ( !IsRectEmptyInl((const struct tagRECT *)((char *)a1 + 56)) )
  {
    ...
    for ( i = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v2, v3) + 57008) + 112LL); i; i = *(_QWORD *)(i + 56) )
    {
      ...
      if ( (*(_DWORD *)(v6 + 24) & 1) != 0 && (unsigned int)IntersectRect(&v41, (int *)&v39, (int *)&v35) )
      {
        ...
        if ( v17 )
        {
          ...
          GreSetRectRgn(*(_QWORD *)(UserSessionState + 63416), v11, v10, v12, HIDWORD(v37));
          v22 = W32GetUserSessionState(v21, v20);
          GreSetRectRgn(*(_QWORD *)(v22 + 43104), (unsigned int)v38, DWORD1(v38), DWORD2(v38), HIDWORD(v38));
          v25 = *(_QWORD *)(W32GetUserSessionState(v24, v23) + 43104);
          v28 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 63416);
          v31 = W32GetUserSessionState(v30, v29);
          GreCombineRgn(*(_QWORD *)(v31 + 63416), v28, v25, 4LL);
          v34 = W32GetUserSessionState(v33, v32);
          GreCombineRgn(*((_QWORD *)a1 + 15), *((_QWORD *)a1 + 15), *(_QWORD *)(v34 + 63416), 2LL);
        }
        else
        {
          v18 = v9 - v39;
