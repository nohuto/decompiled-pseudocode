/*
 * XREFs of PlaySoundConnect @ 0x1403D14FC
 * Callers:
 *     ?Connect@CUserPlaySound@@AEAAJPEAX@Z @ 0x14020466C (-Connect@CUserPlaySound@@AEAAJPEAX@Z.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1401F6428 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
...
__int64 __fastcall PlaySoundConnect(unsigned int a1, __int64 a2, RPC_BINDING_HANDLE *a3)
{
  ...
  unsigned __int16 v10[56]; // [rsp+D0h] [rbp-88h] BYREF
  ...
  *(_QWORD *)&Template.ProtocolSequence = 3LL;
         ...
         0LL) >= 0 )
  {
    ...
    if ( !v4 )
      v4 = RpcBindingBind(0LL, *a3, &unk_14034A800);
    if ( v4 && *a3 )
    {
      RpcBindingFree(a3);
      *a3 = 0LL;
