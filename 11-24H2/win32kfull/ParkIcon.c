...
__int64 __fastcall ParkIcon(_QWORD *a1, int *a2)
{
  ...
  v38 = 0LL;
  v37 = 0LL;
  v4 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 2084LL);
  v45 = v4;
  v7 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v6, v5) + 19928) + 2088LL);
  v41 = v7;
  if ( !IsTrayWindow(a1, 1LL) )
  {
    v47 = a1[13];
    InternalGetRealClientRect(v47, (__int64)&v37, 1, 0LL, 1);
    v11 = *(_QWORD *)(W32GetUserSessionState(v9, v8) + 19928);
    ...
    else
    {
      ...
      v51 = v4;
      v11 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 19928);
      v15 = v37 + *(_DWORD *)(v12 + 2084) - *(_DWORD *)(v11 + 2124);
    }
    LODWORD(v38) = v15;
    v16 = v15;
    v42 = v15;
    v18 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19928);
    if ( (*(_DWORD *)(v18 + 2120) & 2) != 0 )
    {
      v32 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 19928);
      v35 = v7;
      v18 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 19928);
    ...
    v43 = v19;
    HIDWORD(v38) = v19;
    v21 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 19928);
    ...
    while ( 1 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          result = GetProp(v25, *(unsigned __int16 *)(UserSessionState + 41398), 1u);
          if ( !result )
            goto LABEL_13;
