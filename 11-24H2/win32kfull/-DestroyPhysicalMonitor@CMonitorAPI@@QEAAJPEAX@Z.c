/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x1402650D8
 * Callers:
 *     DestroyPhysicalMonitor @ 0x1402650A0 (DestroyPhysicalMonitor.c)
 *     NtGdiDestroyPhysicalMonitor @ 0x140322800 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
