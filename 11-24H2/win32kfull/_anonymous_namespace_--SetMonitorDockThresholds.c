/*
 * XREFs of _anonymous_namespace_::SetMonitorDockThresholds @ 0x140149D44
 * Callers:
        ...
        unsigned __int8 (__fastcall *a3)(__int64, _QWORD))
{
  ...
  v12 = (char *)&unk_140352D80;
  v13 = v5;
  for ( i = (char *)&unk_140352D80; i != " (fullscreen)"; i += 4 )
  {
    v15 = *(_DWORD *)i;
    LOBYTE(v6) = v13;
    if ( !a3(v6, *(unsigned int *)i) )
    {
  ...
  do
  {
    v16 = *(int *)v12;
    v12 += 4;
    *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v6, a2) + 63488) + v16 + 4 * v3) = v5;
    v5 >>= 8;
  }
  while ( v12 != " (fullscreen)" );
