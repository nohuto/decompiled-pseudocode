/*
 * XREFs of _anonymous_namespace_::GetWindowBarrelVisualizationSetting @ 0x14018F114
 * Callers:
...
__int64 __fastcall anonymous_namespace_::GetWindowBarrelVisualizationSetting(__int64 a1, __int64 a2)
{
    ...
    || (*(_DWORD *)(a1 + 12) & 0x10000) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      {
        v11 = 1;
        if ( (unsigned int)FeedbackGetWindowSetting(v10, 2LL, 1LL, &v11) )
          v4 = v11;
      }
    }
