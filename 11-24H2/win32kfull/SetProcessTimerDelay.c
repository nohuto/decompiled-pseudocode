/*
 * XREFs of SetProcessTimerDelay @ 0x140289D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SetProcessTimerDelay(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  *(_DWORD *)(a1 + 1036) = v9;
  ...
  {
    v11 = (__int64 *)(a1 + 1048);
    v12 = W32GetUserSessionState(v8, v7) + 57600;
    v8 = *(__int64 ***)(v12 + 8);
    if ( *v8 == (__int64 *)v12 )
    {
      *v11 = v12;
...
LABEL_11:
  if ( !*(_BYTE *)(W32GetUserSessionState(v8, v7) + 62760) )
  {
    v15 = CRitTimerScanWakeSystem::SignalRitTimerScanWakeEvent(v14, v13);
    *(_BYTE *)(W32GetUserSessionState(v17, v16) + 18720) = v15;
    if ( *(_BYTE *)(W32GetUserSessionState(v19, v18) + 18720) != 1 )
