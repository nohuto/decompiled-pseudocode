/*
 * XREFs of ?vCharPos_G1@ESTROBJ@@QEAAXAEAVUDCOBJ@@AEAVRFONTOBJ@@JJPEBJPEAJ@Z @ 0x1400ABF7C
 * Callers:
        ...
        int *a7)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a3 + 648LL) )
  {
    ...
    if ( (unsigned int)RFONTOBJ::bGetGlyphMetricsPlus(a3, v20, v12, v19, v61, a2, this) )
    {
      ...
      while ( 1 )
      {
        ...
        *(float *)v33.m128i_i32 = *(float *)v33.m128i_i32 * v14;
        ...
        if ( !--v24 )
          break;
        v39 = v15;
        v40 = (__m128i)COERCE_UNSIGNED_INT((float)(int)v18);
        p_pgdf += 3;
        *(float *)v39.m128i_i32 = *(float *)v15.m128i_i32 * *(float *)v40.m128i_i32;
        v41 = _mm_cvtsi128_si32(v39);
        ...
        *(float *)v40.m128i_i32 = *(float *)v40.m128i_i32 * v17;
        *((_DWORD *)p_pgdf + 2) = v38 + a4;
        LODWORD(v38) = 0;
        v45 = _mm_cvtsi128_si32(v40);
        v46 = (unsigned __int8)(v45 >> 23);
        if ( v46 <= 0x9E )
        {
          v47 = v45 & 0x7FFFFF | 0x800000LL;
          if ( v46 < 0x76 )
            v48 = v47 >> (118 - (unsigned __int8)v46);
          else
      ...
      if ( (int)v18 > v16 )
        v16 = v18;
      v49 = (__m128i)COERCE_UNSIGNED_INT((float)(int)v18);
      *(float *)v15.m128i_i32 = *(float *)v15.m128i_i32 * *(float *)v49.m128i_i32;
      ...
      *(float *)v49.m128i_i32 = *(float *)v49.m128i_i32 * v17;
      *((_DWORD *)this + 20) = v38;
      v54 = _mm_cvtsi128_si32(v49);
