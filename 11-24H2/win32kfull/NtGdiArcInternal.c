/*
 * XREFs of NtGdiArcInternal @ 0x1400E5070
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vCosSin@@YAXVEFLOAT@@PEAV1@1@Z @ 0x1400ED078 (-vCosSin@@YAXVEFLOAT@@PEAV1@1@Z.c)
 *     ?ptfxGetCurrent@EPATHOBJ@@QEBA?AU_POINTFIX@@XZ @ 0x140195D10 (-ptfxGetCurrent@EPATHOBJ@@QEBA-AU_POINTFIX@@XZ.c)
 *     ?vCosSinPrecise@@YAXVEFLOAT@@PEAV1@1@Z @ 0x14030EF18 (-vCosSinPrecise@@YAXVEFLOAT@@PEAV1@1@Z.c)
        ...
        int a10)
{
  ...
  _BYTE v41[4]; // [rsp+6Ch] [rbp-9Ch] BYREF
  ...
  unsigned int v52; // [rsp+16Ch] [rbp+64h]
  ...
  else
  {
    if ( a1 <= 3 )
    {
      ...
      if ( v55[1] )
      {
        ...
        LODWORD(v15) = efHalfDiff(v52, (unsigned int)-v54);
        v16 = 0;
        v42 = 0;
        v17 = 0;
        v40 = 0;
        LODWORD(v22) = efHalfDiff(v51, (unsigned int)-v53);
        v39 = 0;
        v38 = 0;
        if ( v18 == v21 || v20 == v19 )
        {
        ...
        {
          v25 = COERCE_FLOAT(efHalfDiff(v21, v18));
          v26 = COERCE_FLOAT(efHalfDiff(v24, v23));
          vArctan(
            COERCE_UNSIGNED_INT((float)((float)a7 - v22) / v25),
            COERCE_UNSIGNED_INT((float)((float)a8 - v15) / v26),
            &v39,
            &v42);
          v37 = (float)((float)a10 - v15) / v26;
          v36 = (float)((float)a9 - v22) / v25;
        ...
        {
          vCosSin((unsigned int)_mm_cvtsi128_si32(v27), &v40, v41);
        ...
        if ( v16 != v17 || (v30 = 0, *(float *)v28.m128i_i32 <= *(float *)v27.m128i_i32) )
          v30 = 1;
        if ( !(unsigned int)bPartialArc((unsigned int)(a1 == 1) + 1, v55, v49, &v40, v16, &v39, &v36, v17, &v38, v30) )
          goto LABEL_30;
        switch ( a1 )
        {
          case 1u:
