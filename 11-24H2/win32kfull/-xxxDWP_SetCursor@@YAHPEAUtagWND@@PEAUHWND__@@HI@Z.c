/*
 * XREFs of ?xxxDWP_SetCursor@@YAHPEAUtagWND@@PEAUHWND__@@HI@Z @ 0x140252880
 * Callers:
...
__int64 __fastcall xxxDWP_SetCursor(struct tagWND *a1, __int64 a2, int a3, int a4)
{
  ...
  if ( a4 )
  {
    if ( a3 == 10 || a3 == 11 )
    {
      v9 = *(struct tagCURSOR **)(W32GetUserSessionState(a1, a2) + 25800);
      goto LABEL_15;
    }
    if ( a3 != 12 )
    {
      ...
      {
LABEL_12:
        v9 = *(struct tagCURSOR **)(W32GetUserSessionState(a1, a2) + 24696);
        goto LABEL_15;
      }
      if ( a3 == 14 )
      {
LABEL_11:
        v9 = *(struct tagCURSOR **)(W32GetUserSessionState(a1, a2) + 25248);
LABEL_15:
        LOBYTE(v8) = 1;
    ...
    v9 = *(struct tagCURSOR **)(W32GetUserSessionState(a1, a2) + 26352);
    goto LABEL_15;
  }
LABEL_10:
  ...
  if ( a3 == -2 )
  {
    ...
    if ( !v23 )
    {
      v18 = *(unsigned int *)(W32GetUserSessionState(v18, v17) + 67060);
      if ( (v18 & 1) != 0 )
  ...
  {
LABEL_43:
    v22 = *(struct tagCURSOR **)(W32GetUserSessionState(v18, v17) + 21936);
LABEL_44:
