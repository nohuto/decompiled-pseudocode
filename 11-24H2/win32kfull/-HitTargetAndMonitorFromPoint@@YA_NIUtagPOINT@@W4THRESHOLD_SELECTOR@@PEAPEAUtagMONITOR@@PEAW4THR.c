/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YA_NIUtagPOINT@@W4THRESHOLD_SELECTOR@@PEAPEAUtagMONITOR@@PEAW4THRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1402A5B7C
 * Callers:
 *     ?ComputeSizeOutcome@@YA?AW4_MOUSE_SIZE_OUTCOME@@QEBUMOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4THRESHOLD_MARGIN_DIRECTION@@@Z @ 0x14020B9B4 (-ComputeSizeOutcome@@YA-AW4_MOUSE_SIZE_OUTCOME@@QEBUMOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4THRESH.c)
...
char __fastcall HitTargetAndMonitorFromPoint(int a1, __int64 a2, int a3, __int64 *a4, _DWORD *a5)
{
  ...
  *a4 = v9;
  ...
  v12 = v6;
  v13 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 63488);
  v14 = *(unsigned __int8 *)(v13 + 4 * v6 + 1);
  v16 = *(_QWORD *)(W32GetUserSessionState(v13, v15) + 63488);
  v17 = *(unsigned __int8 *)(v16 + 4 * v6 + 2);
  v19 = *(_QWORD *)(W32GetUserSessionState(v16, v18) + 63488);
  v20 = *(unsigned __int8 *)(v19 + 4 * v12);
  v22 = *(unsigned __int8 *)(*(_QWORD *)(W32GetUserSessionState(v19, v21) + 63488) + 4 * v12 + 3);
  if ( v8 )
  {
    if ( v5 < v14 + (int)v36 )
    {
    ...
    if ( v5 >= DWORD2(v36) - v17 )
    {
      *a5 = 2;
      ...
      if ( !v23 && !v24 )
        return 1;
LABEL_12:
      v25 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v22) + 69416);
      LOBYTE(v26) = v24;
      LOBYTE(v27) = v23;
LABEL_47:
