/*
 * XREFs of ?ApplyForegroundPolicy@CForegroundLaunch@@QEAAXPEAUtagPROCESSINFO@@@Z @ 0x1401D1314
 * Callers:
 *     EditionApplyForegroundPolicyStartingApp @ 0x1401D12E0 (EditionApplyForegroundPolicyStartingApp.c)
 * Callees:
...
LABEL_18:
    ...
    if ( (*(_DWORD *)(W32GetUserSessionState(v16, v15) + 67056) & 0x8000000) == 0 )
    {
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
        || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 2) == 0
        || *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) < 4u )
    ...
    if ( (unsigned int)IsImmersiveAppRestricted(a2) )
    {
      ...
      if ( !v11 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_108;
      v25 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v21) + 69416);
      v55 = ProcessId;
      v54 = 23;
LABEL_107:
      LOBYTE(v24) = v22;
