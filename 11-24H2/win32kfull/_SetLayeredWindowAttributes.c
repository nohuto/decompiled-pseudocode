/*
 * XREFs of _SetLayeredWindowAttributes @ 0x14015DCB4
 * Callers:
...
__int64 __fastcall SetLayeredWindowAttributes(struct tagWND *a1, unsigned int a2, BYTE a3, int a4)
{
  ...
  *(_WORD *)&v32.BlendOp = 0;
  ...
  if ( RedirectionBitmap )
  {
    ...
    v17 = GreSelectBitmap(*(_QWORD *)(UserSessionState + 43288), RedirectionBitmap);
    v18 = (_DWORD *)*((_QWORD *)a1 + 5);
    v19 = v17;
    v33.cx = v18[24] - v18[22];
    v33.cy = v18[25] - v18[23];
    v21 = *(HDC *)(W32GetUserSessionState(v20, (unsigned int)v33.cy) + 43288);
    v24 = W32GetUserSessionState(v23, v22);
    updated = UpdateSprite(
                *(HDEV *)(*(_QWORD *)(v24 + 57008) + 48LL),
                a1,
                v25,
                0LL,
                0LL,
    ...
    GreSelectBitmap(*(_QWORD *)(v29 + 43288), v19);
  }
  else
  {
    v30 = W32GetUserSessionState(1LL, v14);
    updated = UpdateSprite(
                *(HDEV *)(*(_QWORD *)(v30 + 57008) + 48LL),
                a1,
                v31,
                0LL,
                0LL,
