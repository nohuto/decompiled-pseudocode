/*
 * XREFs of GreGetRandomRgn @ 0x140038FA0
 * Callers:
 ...
 *     NtGdiGetRandomRgn @ 0x140038F20 (NtGdiGetRandomRgn.c)
 ...
 *     _GreGetRandomRgn_::_2_::_lambda_1_::operator() @ 0x14030D6AC (_GreGetRandomRgn_--_2_--_lambda_1_--operator().c)
 */
...
__int64 __fastcall GreGetRandomRgn(HDC a1, HRGN a2, int a3)
{
  ...
  HDC v22[18]; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_3:
  ...
  if ( a3 == 4 )
  {
    if ( (*((_DWORD *)v21[0] + 9) & 0x4000) != 0 )
    {
      ...
      v23 = 0LL;
      if ( (unsigned int)UserGetRedirectedWindowOrigin(a1, &v23) && RGNOBJ::bOffset((RGNOBJ *)v20, &v23) )
      {
        v10 = 1;
LABEL_32:
