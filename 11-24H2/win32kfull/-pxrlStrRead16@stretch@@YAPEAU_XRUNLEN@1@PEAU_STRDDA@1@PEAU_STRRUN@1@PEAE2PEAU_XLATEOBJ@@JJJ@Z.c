/*
 * XREFs of ?pxrlStrRead16@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x14010D5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  v10 = 0;
  v11 = *(_DWORD *)this;
  v12 = (unsigned __int16 *)((char *)a3 + 2 * (int)a6);
  if ( a4 )
  {
    v26 = a8 & 0x1F;
