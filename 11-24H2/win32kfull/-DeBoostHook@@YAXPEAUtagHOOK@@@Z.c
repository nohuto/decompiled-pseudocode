/*
 * XREFs of ?DeBoostHook@@YAXPEAUtagHOOK@@@Z @ 0x1402836F0
 * Callers:
...
void __fastcall DeBoostHook(struct tagHOOK *a1)
{
  ...
  {
    if ( (v1 & 0x2000) != 0 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1561);
  }
  else
  {
    if ( (v1 & 0x2000) == 0 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1565);
    v3 = *((_QWORD *)a1 + 2);
    v4 = 1;
    --*((_BYTE *)a1 + 96);
