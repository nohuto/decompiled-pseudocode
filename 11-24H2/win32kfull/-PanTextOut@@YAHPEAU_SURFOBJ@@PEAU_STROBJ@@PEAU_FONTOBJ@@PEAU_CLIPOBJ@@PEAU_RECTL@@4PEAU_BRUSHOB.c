/*
 * XREFs of ?PanTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x14030A4E0
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX mix)
{
  ...
  v25 = *p_rclBkGround;
  PANSURFLOCK::PANSURFLOCK((PANSURFLOCK *)v26, dhpdev, &pso, (__m128i *)&v25, &v19, a4);
