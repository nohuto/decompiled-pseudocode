/*
 * XREFs of ?GetImeHotKey@@YAHKPEAI0PEAPEAUHKL__@@@Z @ 0x1401F9CB0
 * Callers:
...
__int64 __fastcall GetImeHotKey(int a1, unsigned int *a2, unsigned int *a3, HKL *a4)
{
    ...
    && (unsigned int)((_DWORD)v5 - 67175425) <= 0xFBFDFBFF )
  {
    ...
    ImeHotKeyByHkl = FindImeHotKeyByHkl(*(const struct _tagIMEHOTKEYOBJ **)(UserSessionState + 12944), v5);
  }
  else
  {
    v12 = W32GetUserSessionState(v9, v8);
    ImeHotKeyByHkl = FindImeHotKeyByID(*(const struct _tagIMEHOTKEYOBJ **)(v12 + 12944), (int)v5);
  }
  if ( !ImeHotKeyByHkl )
  {
    v13 = 1419;
