/*
 * XREFs of ?bNearMatch@MAPPER@@QEAAHAEAVPFEOBJ@@PEAEH@Z @ 0x1400FBF10
 * Callers:
 ...
 * Callees:
 *     ?pGetLinkedFontList@PFEOBJ@@QEAAPEAU_LIST_ENTRY@@XZ @ 0x1400FD4B0 (-pGetLinkedFontList@PFEOBJ@@QEAAPEAU_LIST_ENTRY@@XZ.c)
 *     ?pvSimBold@IFIOBJ@@QEAAPEAXXZ @ 0x1400FD4E8 (-pvSimBold@IFIOBJ@@QEAAPEAXXZ.c)
 *     ?bCalcOrientation@MAPPER@@QEAAHXZ @ 0x1400FD5D8 (-bCalcOrientation@MAPPER@@QEAAHXZ.c)
 *     ?bSimItalic@IFIOBJ@@QEAAHXZ @ 0x1400FD7CC (-bSimItalic@IFIOBJ@@QEAAHXZ.c)
 *     ?lfOutPrecision@IFIOBJ@@QEBAEXZ @ 0x1400FD7F4 (-lfOutPrecision@IFIOBJ@@QEBAEXZ.c)
 *     ?bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z @ 0x1400FE04C (-bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z.c)
 *     ?bCalculateWishCell@MAPPER@@AEAAHXZ @ 0x1401A277C (-bCalculateWishCell@MAPPER@@AEAAHXZ.c)
