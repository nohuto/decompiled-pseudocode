/*
 * XREFs of ?TestSequence@WindowArrangementSequence@@YAXQEBUtagHOTKEY@@IIIH@Z @ 0x1401BBD94
 * Callers:
...
LABEL_12:
  ...
  else if ( a3 == 8 && *(_DWORD *)(W32GetUserSessionState(0LL, a2) + 63472) )
  {
    v10 = 2LL;
LABEL_9:
