/*
 * XREFs of ?DelegateDiscardMessages@@YAXPEAUtagQ@@HPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1400A6748
 * Callers:
 ...
 *     ?GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z @ 0x14028BE04 (-GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z.c)
...
LABEL_10:
      ...
      if ( v12 )
      {
        ...
        {
          v59 = *(_QWORD *)v12;
          if ( (unsigned int)IsPointerInputMessage(*(unsigned int *)(v12 + 24)) )
          {
            if ( (*(_DWORD *)(v12 + 100) & 0x40) != 0 )
            {
              ...
              if ( *(_WORD *)(v12 + 32) == *(_WORD *)a3 )
              {
                if ( (_DWORD)v15 == 582 )
                {
                  ...
                  if ( CTouchProcessor::GetFrameIdFromPointerMsgId(*(CTouchProcessor **)(v18 + 3264), v17) != *((_DWORD *)a3 + 1) )
                  {
                    if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
                      || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 0x200) == 0
                ...
                if ( *(_DWORD *)(v12 + 24) == 581 && (*(_BYTE *)(v12 + 34) & 4) == 0 )
                {
                  ...
                  {
                    v54 = 28;
                    v25 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v14) + 69416);
                    goto LABEL_84;
                  }
                  return;
                }
    ...
    else
    {
      while ( v12 )
      {
        if ( (*(_DWORD *)(v12 + 100) & 0x40) != 0 )
        {
          ...
          if ( (v20 == 582 || v20 == 585) && *(_WORD *)(v12 + 32) == *(_WORD *)a3 )
          {
            ...
            if ( CTouchProcessor::GetFrameIdFromPointerMsgId(*(CTouchProcessor **)(v21 + 3264), *(_QWORD *)(v12 + 40)) == *((_DWORD *)a3 + 1) )
              goto LABEL_10;
          }
        }
        v12 = *(_QWORD *)v12;
      ...
      if ( v6 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      {
        v25 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, a2) + 69416);
        v54 = 26;
LABEL_84:
        LOBYTE(v24) = v22;
        LOBYTE(v23) = v6;
