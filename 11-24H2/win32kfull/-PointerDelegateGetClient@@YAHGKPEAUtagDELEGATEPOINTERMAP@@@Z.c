/*
 * XREFs of ?PointerDelegateGetClient@@YAHGKPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1400A6FE0
 * Callers:
...
__int64 __fastcall PointerDelegateGetClient(__int64 a1, __int64 a2, struct tagDELEGATEPOINTERMAP *a3)
{
  ...
  CTouchProcessor::DelegateCapture(*(_QWORD *)(UserSessionState + 3264), v17, v5, v4, 0);
  if ( HIDWORD(v18) != 2 )
    return 0LL;
  v9 = v18;
