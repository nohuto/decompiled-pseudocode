/*
 * XREFs of EditionxxxComputeInputSinkInfo @ 0x1401BEA40
 * Callers:
...
int __fastcall EditionxxxComputeInputSinkInfo(__int64 a1, __int64 a2)
{
  ...
  v2 = W32GetUserSessionState(a1, a2) + 19016;
  ...
  if ( *(_BYTE *)(UserSessionState + 18844) )
  {
    v18 = W32GetUserSessionState(v17, v16);
    LODWORD(UserSessionState) = KeSetEvent(*(PRKEVENT *)(v18 + 18856), 1, 0);
  }
