/*
 * XREFs of EditionAllowProcessLaunchForegroundPolicy @ 0x14028F3A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a1 != 1 )
    {
      if ( a1 == 2 )
      {
        ...
        if ( !v9 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          return 1LL;
        v13 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v2) + 69416);
        v20 = 85;
        goto LABEL_29;
      }
      if ( a1 != 3 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1513);
      ...
      if ( v15 )
      {
        ...
        if ( !v9 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          return 1LL;
        v13 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v16) + 69416);
        v20 = 86;
        goto LABEL_29;
      }
      if ( !CanForceForeground(v14[58], v16) )
      {
        ...
        if ( !v4 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          return 0LL;
        v8 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v18) + 69416);
        v19 = 88;
        goto LABEL_46;
      }
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
      ...
      if ( v9 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      {
        v13 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v18) + 69416);
        v20 = 87;
LABEL_29:
        LOBYTE(v12) = v10;
        LOBYTE(v11) = v9;
  ...
  if ( !v4 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
    return 0LL;
  v8 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v2) + 69416);
  v19 = 84;
LABEL_46:
  LOBYTE(v7) = v5;
  LOBYTE(v6) = v4;
