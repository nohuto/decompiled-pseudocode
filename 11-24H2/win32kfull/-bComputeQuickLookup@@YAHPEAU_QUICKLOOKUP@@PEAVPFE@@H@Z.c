/*
 * XREFs of ?bComputeQuickLookup@@YAHPEAU_QUICKLOOKUP@@PEAVPFE@@H@Z @ 0x140152C44
 * Callers:
 ...
 *     ?pql@PFEOBJ@@QEAAPEAU_QUICKLOOKUP@@XZ @ 0x140152C04 (-pql@PFEOBJ@@QEAAPEAU_QUICKLOOKUP@@XZ.c)
