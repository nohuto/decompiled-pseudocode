/*
 * XREFs of FindNCHit @ 0x14006C5C4
 * Callers:
...
__int64 __fastcall FindNCHit(__int64 a1, int a2)
{
  ...
  v7 = (__int16)a2;
  v45 = SHIWORD(a2);
  if ( !(unsigned int)PtInRect(v2 + 88) )
    return 0LL;
  v11 = 2;
  ...
  if ( (*(_BYTE *)(v9 + 16) & 2) != 0 )
  {
    ...
    {
      v41 -= GetDpiDependentMetric(0LL, WindowDpiLastNotify);
      v46.m128i_i32[0] = v41;
    }
    else
    {
      v43 += GetDpiDependentMetric(0LL, WindowDpiLastNotify);
      v46.m128i_i32[2] = v43;
    }
  }
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 40) + 16LL) & 4) != 0 )
  {
    v18 += GetDpiDependentMetric(1LL, WindowDpiLastNotify);
    v46.m128i_i32[3] = v18;
  }
  v52 = *(_QWORD *)(a1 + 40);
  if ( (unsigned int)PtInRect(&v46) )
  {
    if ( (*(_BYTE *)(v21 + 25) & 2) != 0 )
    {
    ...
    v38 = *(_BYTE *)(v21 + 16);
    if ( (v38 & 4) == 0 || v45 < v53.m128i_i32[3] )
      return 7LL;
    if ( (v38 & 2) != 0 )
    {
      v39 = SizeBoxHwnd(a1);
...
LABEL_50:
      ...
      if ( v10 >= v20 )
      {
        ...
        if ( v45 >= v32 && (*(_BYTE *)(*(_QWORD *)(v49 + 40) + 16LL) & 1) != 0 )
          return 5LL;
        if ( v7 >= v42 && v7 < v19 && v45 < v32 )
        {
          v34 = *(char **)(v49 + 40);
          v35 = v34[30];
          if ( (v35 & 8) != 0 )
  ...
  {
    v26 = GetDpiDependentMetric(24LL, WindowDpiLastNotify);
    v27 = 23LL;
  }
  v28 = -v26;
