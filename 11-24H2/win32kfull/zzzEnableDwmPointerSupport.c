/*
 * XREFs of zzzEnableDwmPointerSupport @ 0x1401320A8
 * Callers:
...
void __fastcall zzzEnableDwmPointerSupport(__int64 a1, __int64 a2)
{
  ...
  GreLockPointer(*(_QWORD *)(*(_QWORD *)(v10 + 57008) + 48LL));
  v13 = W32GetUserSessionState(v12, v11);
  GreLockSprite(*(_QWORD *)(*(_QWORD *)(v13 + 57008) + 48LL));
  v16 = W32GetUserSessionState(v15, v14);
  HasSoftwareCursor = GreDwmHasSoftwareCursor(*(_QWORD *)(*(_QWORD *)(v16 + 57008) + 48LL), 0LL);
  if ( !v2 || HasSoftwareCursor || v3 )
  {
    ...
    else
    {
      ...
      v22 = 1;
      *(_DWORD *)(W32GetUserSessionState(v21, v20) + 36348) = 0;
    }
    v23 = W32GetUserSessionState(v19, v18);
    GreDwmEnableSoftwareCursorRendering(*(_QWORD *)(*(_QWORD *)(v23 + 57008) + 48LL), v3);
    if ( v22 )
    {
      v24 = *(_DWORD *)(W32GetUserSessionState(v19, v18) + 36344) > 0;
      v27 = W32GetUserSessionState(v26, v25);
      LOBYTE(v28) = 1;
      *(_DWORD *)(v27 + 36348) = v24;
      SetPointerInternal(v28, 6LL);
      if ( !v2 )
      {
        v36 = *(_QWORD *)(W32GetUserSessionState(v19, v18) + 19928);
        v37 = *(_DWORD *)(v36 + 4964);
        v39 = W32GetUserSessionState(v36, v38);
        zzzInternalSetCursorPos(*(unsigned int *)(*(_QWORD *)(v39 + 19928) + 4960LL), v37, 2, 0);
      }
    }
  }
  v29 = W32GetUserSessionState(v19, v18);
  GreUnlockSprite(*(_QWORD *)(*(_QWORD *)(v29 + 57008) + 48LL));
  v32 = W32GetUserSessionState(v31, v30);
  GreUnlockPointer(*(_QWORD *)(*(_QWORD *)(v32 + 57008) + 48LL));
