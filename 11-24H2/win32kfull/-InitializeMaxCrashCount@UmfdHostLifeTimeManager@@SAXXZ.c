/*
 * XREFs of ?InitializeMaxCrashCount@UmfdHostLifeTimeManager@@SAXXZ @ 0x14021DFE4
 * Callers:
 *     ?SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ @ 0x14026A6A8 (-SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ.c)
 * Callees:
