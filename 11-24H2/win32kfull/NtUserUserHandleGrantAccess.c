/*
 * XREFs of NtUserUserHandleGrantAccess @ 0x140247B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserUserHandleGrantAccess(void *a1, void *a2, int a3)
{
  ...
  if ( (unsigned int)Feature_UserJobImprovement__private_IsEnabledDeviceUsageNoInline() )
    return (int)NtUserHandleGrantAccess(a2, a1, a3 != 0);
  Object = 0LL;
  v8 = ObReferenceObjectByHandle(a2, 2u, (POBJECT_TYPE)PsJobType, 1, &Object, 0LL);
  v9 = Object;
  v28 = Object;
  if ( v8 < 0 )
  {
  ...
  {
    for ( i = *(__int64 **)(W32GetUserSessionState(v12, v11) + 69352); i && (PVOID)i[1] != v9; i = (__int64 *)*i )
      ;
    if ( i )
    {
      LOBYTE(v13) = -1;
      ...
      {
        v29 = *(_QWORD *)(W32GetUserSessionState(v16, v15) + 19944) + 32LL * (unsigned __int16)a1;
        *(_BYTE *)(v29 + 25) |= 0x20u;
        v17 = i[8];
        v27 = v17;
        if ( a3 )
