/*
 * XREFs of ?MulTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x140050610
 * Callers:
 *     <none>
 * Callees:
...
LABEL_46:
      ...
      if ( v21 != v14 )
      {
        v41 = ulIndexToRGB(v14[1].hdev, *((_QWORD *)v46 + 471), iTransColor);
