/*
 * XREFs of ?bCalculateAndDrawTriangle@@YAHPEAVSURFACE@@PEAU_TRIVERTEX@@11PEAU_TRIANGLEDATA@@P6AX02@Z@Z @ 0x1401A6088
 * Callers:
 ...
 *     ?bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1401A65F0 (-bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
 *     ?lCalculateTriangleArea@@YAJPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1401A6798 (-lCalculateTriangleArea@@YAJPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
        ...
        void (*a6)(struct SURFACE *, struct _TRIANGLEDATA *))
{
  ...
  if ( v11 < 0 )
  {
    ...
    v10 = v6;
    v6 = v21;
    if ( (int)lCalculateTriangleArea(v9, v10, v21, v12) <= 0 )
      return 0LL;
  }
  y = v9->y;
  if ( y <= *((_DWORD *)a5 + 1) )
  ...
  *((_DWORD *)a5 + 29) = v15;
  ...
  if ( !(unsigned int)bUMPDSecurityGateEx(v19, v18)
    || *((_QWORD *)a5 + 19)
