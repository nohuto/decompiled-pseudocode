/*
 * XREFs of ?ResetForegroundQueue@@YAXW4SetFgQueueOption@@@Z @ 0x140276340
 * Callers:
 *     ClearForegroundQueue @ 0x1401FA4C0 (ClearForegroundQueue.c)
...
__int64 __fastcall ResetForegroundQueue(__int64 a1, __int64 a2)
{
  ...
  if ( (v2 & 1) != 0 )
    *(_QWORD *)(W32GetUserSessionState(v6, v3) + 18952) = v4;
  *(_QWORD *)(W32GetUserSessionState(v6, v3) + 18944) = 0LL;
