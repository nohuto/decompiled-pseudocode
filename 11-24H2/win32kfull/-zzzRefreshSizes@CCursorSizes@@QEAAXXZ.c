/*
 * XREFs of ?zzzRefreshSizes@CCursorSizes@@QEAAXXZ @ 0x14007AA08
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x14018F9C8 (xxxSystemParametersInfoWorker.c)
 *     ??0CCursorSizes@@QEAA@XZ @ 0x140207174 (--0CCursorSizes@@QEAA@XZ.c)
 *     xxxUpdatePerUserSystemParameters @ 0x14020C860 (xxxUpdatePerUserSystemParameters.c)
 *     EditionzzzUpdateCursorSizes @ 0x14021A7E0 (EditionzzzUpdateCursorSizes.c)
 * Callees:
 ...
 *     ?DeferMonitorIcoCurCreation@@YAXXZ @ 0x140224BD0 (-DeferMonitorIcoCurCreation@@YAXXZ.c)
...
void __fastcall CCursorSizes::zzzRefreshSizes(CCursorSizes *this)
{
  ...
  *((_DWORD *)this + 1) = v3;
  ...
  while ( v4 < 5 );
  for ( i = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 57008) + 112LL); i; i = *(_QWORD *)(v14 + 56) )
    *((_DWORD *)this
  ...
  *(_OWORD *)v28 = *(_OWORD *)((char *)this + 24);
  ...
  CCursorSizes::zzzUpdateGlobalCursorSize(
    this,
    (const struct tagPOINT *)(*(_QWORD *)(UserSessionState + 19928) + 4960LL),
    1);
}
