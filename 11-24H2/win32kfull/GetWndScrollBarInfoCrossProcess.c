/*
 * XREFs of GetWndScrollBarInfoCrossProcess @ 0x1402149C4
 * Callers:
...
LABEL_27:
        ...
        else
        {
          ...
          if ( (_BYTE)v24 || v28 )
          {
            v29 = W32GetUserSessionState(*(unsigned int *)(*(_QWORD *)(v4 + 40) + 104LL), v24);
          ...
          {
            v32 = *(_DWORD *)(v31 + 96) - *(_DWORD *)(v31 + 88);
            v30 = (unsigned int)v107;
            LODWORD(v107) = v32 - DWORD2(v107);
            DWORD2(v107) = v32 - v30;
          }
          if ( v19 )
          {
            LOBYTE(v30) = *(_BYTE *)(v31 + 16) & 2;
            if ( (*(_BYTE *)(v31 + 25) & 0x40) != 0 )
            {
              v33 = v107;
              v34 = v107;
              if ( (_BYTE)v30 )
          ...
          *(_QWORD *)&v107 = v41;
          if ( v19 )
          {
            ...
            v103 = v34;
            v101 = v33;
            v43 = GetDpiForSystem((__int64)&v115 + 4);
          ...
          else
          {
            ...
            v103 = v38;
            v101 = v37;
            v46 = GetDpiForSystem((__int64)&v115 + 4);
