/*
 * XREFs of GrePolyPolyline @ 0x1401BACF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GrePolyPolyline(
        HDC a1,
        ...
        unsigned int a5)
{
  ...
  if ( v14[0] )
  {
      ...
      && !(unsigned int)DWMSCREENREADMODIFYWRITEASSIST::bInPathBracket((DWMSCREENREADMODIFYWRITEASSIST *)v15) )
    {
      ...
      if ( (unsigned int)GrepPolyPolyline((struct XDCOBJ *)v14, a2, a3, a4, a5) )
    ...
    v11 = GrepPolyPolyline((struct XDCOBJ *)v14, a2, a3, a4, a5);
    if ( v9 )
    {
