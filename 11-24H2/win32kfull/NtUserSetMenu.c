/*
 * XREFs of NtUserSetMenu @ 0x1401F5330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetMenu(__int64 a1, __int64 a2)
{
  ...
  __int64 v20; // rdx
  __int64 v21; // rdx
  ULONG_PTR v22[2]; // [rsp+20h] [rbp-40h] BYREF
  ...
  if ( v5 )
  {
    ...
    {
      Win32HM_LockIntoThread<0>(v4, v5, v22);
...
LABEL_5:
          ...
          Win32HM_UnlockFromThread<0>((ULONG_PTR)v14, v22);
          goto LABEL_6;
        }
      }
      else
...
LABEL_11:
            v16 = *(_QWORD *)v24[0];
LABEL_12:
            Win32HM_LockIntoThread<1>(v4, v16, (__int64 *)BugCheckParameter3);
            v7 = xxxSetMenu(v8);
...
LABEL_13:
          if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v24[0] + 40LL) + 40LL) & 1) != 0 )
          {
            ...
            Win32HMThreadLockAlways<tagWND>::~Win32HMThreadLockAlways<tagWND>((ULONG_PTR)v22, v21);
            goto LABEL_6;
          }
          v16 = v25;
          if ( v25 )
