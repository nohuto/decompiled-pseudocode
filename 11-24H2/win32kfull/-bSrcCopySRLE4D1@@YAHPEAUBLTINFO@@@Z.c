/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1403185D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE4D1(struct BLTINFO *a1)
{
  ...
  v15 = byte_140361B60[v2 & 7];
  v57 = (unsigned int)(v7 - 1) >> 3;
  v67 = ~byte_140361B60[v7 & 7];
  if ( v5 >= v12 )
    goto LABEL_10;
  if ( v9 >= v2 )
  {
    if ( v9 < v7 )
    {
      v14 = byte_140361B60[v9 & 7] & *(_BYTE *)((unsigned int)(v9 >> 3) + v4);
      goto LABEL_10;
    }
    goto LABEL_8;
  }
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v5 < v19 && v9 < v7 )
        {
          if ( (int)(v22 + v9) > v2 )
          {
            ...
            v53 = v46;
            v45 = byte_140361B70[2 * v46 + 12 + v54];
            LOBYTE(v46) = v9 & 7;
            v70 = v45;
            v68 = v9 & 7;
            ...
            if ( (int)v47 < (int)v50 )
            {
              *(_BYTE *)(v24 + v4) = v14 | ((unsigned __int8)(v45 & byte_140361B60[v47 + 1]) >> v68);
              LODWORD(v46) = v62;
              if ( (v62 & 1) == 0 )
              {
                v45 *= 2;
      ...
      if ( (_DWORD)v25 == 1 )
      {
        ...
        {
          *(_BYTE *)(v24 + v4) = v14 | *(_BYTE *)(v24 + v4) & ~byte_140361B60[v9 & 7];
          return 0LL;
        }
      ...
      if ( (_DWORD)v25 != 2 )
      {
        ...
        if ( v26 <= v52 )
        {
          ...
          else
          {
            if ( v9 >= v2 )
            {
              v29 = byte_140361B70[(unsigned __int8)(7 - (v9 & 7))];
            }
            else
            {
              v28 = v2 - v9;
              ...
              v24 = (unsigned int)(v2 >> 3);
              v9 = v2;
              v29 = byte_140361B70[(unsigned __int8)(7 - (v2 & 7))];
              if ( (v28 & 1) != 0 )
              {
                v30 = *v3;
                v31 = v14 | v29;
...
LABEL_42:
      ...
      else
      {
        ...
        {
          *(_BYTE *)((unsigned int)v24 + v4) = v14 | *(_BYTE *)((unsigned int)v24 + v4) & ~byte_140361B60[v9 & 7];
          v19 = v58;
LABEL_55:
          v41 = v57;
          goto LABEL_56;
