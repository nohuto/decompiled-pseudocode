/*
 * XREFs of ?xxxMigrateWindowHandler@CallShell@@YA_NPEAUtagWND@@W4_SHELL_MIGRATE_WINDOW_REASON@@AEBUtagRECT@@2GU4@PEBUtagMONITOR@@PEAU4@PEAW4State@AdvancedWindowPos@@PEAK@Z @ 0x14014A0D8
 * Callers:
        ...
        int *a10)
{
  ...
  __m128i v120; // [rsp+118h] [rbp+10h] BYREF
  ...
  *(_QWORD *)&v119 = a9;
  *(_QWORD *)&v106 = a10;
  v14 = *(__m128i *)WindowMargins::ReduceRect((WindowMargins *)&v121, a1, a6, (const struct tagRECT *)a5, v103);
  v15 = *(_QWORD *)&a1[2].right;
  v120 = v14;
  v16 = (*(_DWORD *)(v15 + 288) >> 8) & 0x1FF;
  if ( v16 )
  {
    ScaleDPIRect(&v120, &v120, a5, v16, *a3, *a4);
    v14 = v120;
  }
