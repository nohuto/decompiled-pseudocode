/*
 * XREFs of ?UMPDDrvTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KI@Z @ 0x1403354C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a8)
{
  ...
  _DWORD v34[4]; // [rsp+F0h] [rbp-20h] BYREF
...
LABEL_9:
    ...
    v37 = v15;
    v39 = a4;
    if ( (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 80), &v36, v11) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 96), &v37, v12) )
      {
