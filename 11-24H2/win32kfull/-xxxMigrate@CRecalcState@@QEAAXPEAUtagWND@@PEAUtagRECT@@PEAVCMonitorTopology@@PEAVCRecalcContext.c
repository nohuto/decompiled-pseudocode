/*
 * XREFs of ?xxxMigrate@CRecalcState@@QEAAXPEAUtagWND@@PEAUtagRECT@@PEAVCMonitorTopology@@PEAVCRecalcContext@@@Z @ 0x1402C6544
 * Callers:
        ...
        struct CRecalcContext *a5)
{
  ...
  if ( MigrateMonitor )
  {
    v19 = *((_QWORD *)this + 2);
    v20 = v16;
    if ( (*(_DWORD *)(W32GetUserSessionState(v18, v17) + 67056) & 0x10000) != 0
      && !*((_DWORD *)this + 16)
      && !*((_DWORD *)a5 + 8) )
    {
