/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0DKAAA@$0DKA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x14020176C
 * Callers:
 ...
 * Callees:
 *     ??R_lambda_1_@?1??Initialize@?$CSectionBitmapAllocator@$0DKAAA@$0DKA@@NSInstrumentation@@AEAA_NPEAE@Z@QEBAPEAU_RTL_BITMAP@@I@Z @ 0x140201838 (--R_lambda_1_@-1--Initialize@-$CSectionBitmapAllocator@$0DKAAA@$0DKA@@NSInstrumentation@@AEAA_NP.c)
 */
