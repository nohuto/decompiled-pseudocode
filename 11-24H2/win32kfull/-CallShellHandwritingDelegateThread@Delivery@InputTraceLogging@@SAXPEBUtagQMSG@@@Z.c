/*
 * XREFs of ?CallShellHandwritingDelegateThread@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1401DB85C
 * Callers:
...
{
  if ( (unsigned int)dword_140398B80 > 4 && (qword_140398B90 & 0x10) != 0 && (qword_140398B98 & 0x10) == qword_140398B98 )
