/*
 * XREFs of FinalUserInit @ 0x1401CD2B4
 * Callers:
...
__int64 __fastcall FinalUserInit(__int64 a1)
{
  ...
  *(_DWORD *)(SessionDpiServerInfo + 32) = GetCharDimensions(*(HDC *)(*(_QWORD *)(UserSessionState + 57008) + 72LL));
  v5 = Get96DpiServerInfo();
  v6 = *(HFONT *)(v5 + 24);
  v9 = W32GetUserSessionState(v8, v7);
  v10 = GreSelectFont(*(HDC *)(*(_QWORD *)(v9 + 57008) + 72LL), v6);
  v13 = W32GetUserSessionState(v12, v11);
  *(_DWORD *)(v5 + 32) = GetCharDimensions(*(HDC *)(*(_QWORD *)(v13 + 57008) + 72LL));
  v16 = W32GetUserSessionState(v15, v14);
  GreSelectFont(*(HDC *)(*(_QWORD *)(v16 + 57008) + 72LL), v10);
  v19 = W32GetUserSessionState(v18, v17);
  CompatibleDC = GreCreateCompatibleDC(*(_QWORD *)(*(_QWORD *)(v19 + 57008) + 64LL));
  v23 = *(_QWORD *)(W32GetUserSessionState(v22, v21) + 57008);
  *(_QWORD *)(v23 + 80) = CompatibleDC;
  v26 = *(_QWORD *)(W32GetUserSessionState(v23, v24) + 57008);
  if ( !*(_QWORD *)(v26 + 80) )
    return 0LL;
  v27 = *(HFONT *)(SessionDpiServerInfo + 24);
  v28 = W32GetUserSessionState(v26, v25);
  GreSelectFont(*(HDC *)(*(_QWORD *)(v28 + 57008) + 80LL), v27);
  v31 = W32GetUserSessionState(v30, v29);
  GreSetDCOwnerEx(*(_QWORD *)(*(_QWORD *)(v31 + 57008) + 80LL), 0LL, 0LL, 0LL);
  LODWORD(v27) = 40 * *(_DWORD *)(SessionDpiServerInfo + 32);
  v34 = *(_QWORD *)(W32GetUserSessionState(v33, v32) + 57008);
  *(_DWORD *)(v34 + 96) = (_DWORD)v27;
  LODWORD(v27) = *(_DWORD *)(SessionDpiServerInfo + 36) + 2;
  v36 = *(_QWORD *)(W32GetUserSessionState(v34, v35) + 57008);
  *(_DWORD *)(v36 + 100) = (_DWORD)v27;
  v38 = *(_QWORD *)(W32GetUserSessionState(v36, v37) + 57008);
  LODWORD(v27) = *(_DWORD *)(v38 + 100);
  v40 = W32GetUserSessionState(v38, v39);
  Bitmap = GreCreateBitmap(*(unsigned int *)(*(_QWORD *)(v40 + 57008) + 96LL), (unsigned int)v27, 1LL);
  v44 = *(_QWORD *)(W32GetUserSessionState(v43, v42) + 57008);
  *(_QWORD *)(v44 + 88) = Bitmap;
  v47 = *(_QWORD *)(W32GetUserSessionState(v44, v45) + 57008);
  if ( !*(_QWORD *)(v47 + 88) )
    return 0LL;
  v48 = W32GetUserSessionState(v47, v46);
  GreSetBitmapOwner(*(_QWORD *)(*(_QWORD *)(v48 + 57008) + 88LL), 0LL);
  v51 = *(_QWORD *)(W32GetUserSessionState(v50, v49) + 57008);
  v52 = *(_QWORD *)(v51 + 88);
  v54 = W32GetUserSessionState(v51, v53);
  GreSelectBitmap(*(_QWORD *)(*(_QWORD *)(v54 + 57008) + 80LL), v52);
  v57 = W32GetUserSessionState(v56, v55);
  GreSetTextColor(*(HDC *)(*(_QWORD *)(v57 + 57008) + 80LL), 0);
  v60 = *(_QWORD *)(W32GetUserSessionState(v59, v58) + 19928);
  v61 = *(_QWORD *)(v60 + 4944);
  v63 = W32GetUserSessionState(v60, v62);
  GreSelectBrush(*(_QWORD *)(*(_QWORD *)(v63 + 57008) + 80LL), v61, v64);
  v67 = W32GetUserSessionState(v66, v65);
  GreSetBkMode(*(HDC *)(*(_QWORD *)(v67 + 57008) + 80LL), 2);
  v70 = W32GetUserSessionState(v69, v68);
  GreSetBkColor(*(HDC *)(*(_QWORD *)(v70 + 57008) + 80LL), 0xFFFFFF);
  v73 = W32GetUserSessionState(v72, v71);
  MNSetupAnimationDC(v73 + 65928);
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v74);
  if ( CurrentProcessWin32Process )
  {
    v76 = -*(_QWORD *)CurrentProcessWin32Process;
    CurrentProcessWin32Process &= -(__int64)(*(_QWORD *)CurrentProcessWin32Process != 0LL);
  }
  for ( i = (struct _CALLPROCDATA ***)(CurrentProcessWin32Process + 360);
        *i && (*((_DWORD *)(*i)[1] + 2) & 0x4000) == 0;
        DestroyClass((struct tagPROCESSINFO *)v78, i) )
  {
    v78 = PsGetCurrentProcessWin32Process(v76);
    if ( v78 )
      v78 &= -(__int64)(*(_QWORD *)v78 != 0LL);
  }
  return 1LL;
}
