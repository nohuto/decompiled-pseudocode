/*
 * XREFs of ?cptAddRound@WIDEPENOBJ@pathwide@@QEAAKAEAVWIDENER@2@AEAVLINEDATA@2@1HHH@Z @ 0x1400E7D50
 * Callers:
 *     ?vAddRoundJoin@WIDENER@pathwide@@IEAAXH@Z @ 0x1400E9224 (-vAddRoundJoin@WIDENER@pathwide@@IEAAXH@Z.c)
 * Callees:
 *     ?vAddLeftNice@WIDENER@pathwide@@IEAAXPEAVEVECTORFX@@H@Z @ 0x1400E6274 (-vAddLeftNice@WIDENER@pathwide@@IEAAXPEAVEVECTORFX@@H@Z.c)
  ...
  if ( a5 )
  {
    ...
    for ( i = v7 + 1; ; i = v13 + 4 )
    {
      ...
      if ( (unsigned __int64)i < v18 )
      {
        ...
        {
          v26 = i++;
          pathwide::vAddNice(v25, v24, v26, (struct EVECTORFX *)v14);
        }
