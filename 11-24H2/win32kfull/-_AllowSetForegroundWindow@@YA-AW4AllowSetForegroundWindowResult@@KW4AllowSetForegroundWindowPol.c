/*
 * XREFs of ?_AllowSetForegroundWindow@@YA?AW4AllowSetForegroundWindowResult@@KW4AllowSetForegroundWindowPolicy@@@Z @ 0x1400F5C38
 * Callers:
    ...
    else
    {
      ...
      if ( ProcessInfo )
      {
        ...
        if ( *((_QWORD *)ProcessInfo + 41) )
        {
          ...
          LOBYTE(v56) = v54;
          LastWokenThread::Set(*((_QWORD *)ProcessInfo + 41), 1LL, v56);
          v13 = 1;
        }
        else
        {
