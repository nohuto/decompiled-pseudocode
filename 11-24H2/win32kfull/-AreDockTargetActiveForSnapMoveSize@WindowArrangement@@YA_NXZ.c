/*
 * XREFs of ?AreDockTargetActiveForSnapMoveSize@WindowArrangement@@YA_NXZ @ 0x140210A0C
 * Callers:
...
char __fastcall WindowArrangement::AreDockTargetActiveForSnapMoveSize(WindowArrangement *this, __int64 a2)
{
  ...
  v2 = 0;
  v4 = *(_QWORD *)(W32GetUserSessionState(this, a2) + 63488);
  if ( *(_BYTE *)(v4 + 1) )
    return *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v4, v3) + 63488) + 5LL) != 0;
  return v2;
}
