/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1402EA830
 * Callers:
 ...
 *     ?OnDeviceOpened@RimBackedDeviceBase@@UEAAXXZ @ 0x1402EDAF0 (-OnDeviceOpened@RimBackedDeviceBase@@UEAAXXZ.c)
 */
