/*
 * XREFs of ?pSpConvertSpriteFromMeta@@YAPEAVSPRITE@@PEAUHDEV__@@0PEAU_METASPRITE@@@Z @ 0x140208B88
 * Callers:
...
struct SPRITE *__fastcall pSpConvertSpriteFromMeta(HDEV a1, _QWORD *a2, struct _METASPRITE *a3)
{
  ...
  if ( *(_QWORD *)a3 )
  {
    ...
    if ( v8 )
    {
      ...
      do
      {
        if ( *(_QWORD *)v11 && v10 < *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v11 + 16LL) + 2092LL) )
        {
          v9 = *(_QWORD *)v11;
          v10 = *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v11 + 16LL) + 2092LL);
        }
        v11 += 8;
        --v12;
      }
      ...
      if ( v9 )
      {
        ...
        if ( Sprite )
        {
          ...
          *(_QWORD *)(v9 + 192) = 0LL;
          v16 = *v15;
          v21.x = *(_DWORD *)(v9 + 112) + *(_DWORD *)(v16 + 2576);
          v21.y = *(_DWORD *)(v9 + 116) + *(_DWORD *)(v16 + 2580);
