/*
 * XREFs of ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1402E07F4
 * Callers:
 ...
 *     ?NNDeleteAdjustIndex@@YAXPEAII@Z @ 0x1402E087C (-NNDeleteAdjustIndex@@YAXPEAII@Z.c)
 */
