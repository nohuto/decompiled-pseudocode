/*
 * XREFs of ?DoSuperWetInkStop@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_STOP_DATA@@@Z @ 0x1402ED628
 * Callers:
 ...
 *     ?TerminateActiveCommand@InkDevice@@EEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z @ 0x1402EE310 (-TerminateActiveCommand@InkDevice@@EEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z.c)
 * Callees:
...
__int64 __fastcall InkDevice::DoSuperWetInkStop(__int64 this, const struct IFC_SUPERWET_INK_STOP_DATA *a2)
{
  ...
  if ( v4 >= 0 && (unsigned int)dword_140398C98 > 4 )
  {
    v6 = *(_DWORD *)a2;
    v9 = *(void **)(this + 80);
