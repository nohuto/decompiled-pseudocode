/*
 * XREFs of NtUserGetUpdateRect @ 0x140033A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetUpdateRect(__int64 a1, _OWORD *a2, unsigned int a3)
{
  ...
  if ( v7 )
  {
    ...
    UpdateRect = xxxGetUpdateRect(
                   v8,
                   (unsigned __int64)&v13 & ((unsigned __int128)-(__int128)(unsigned __int64)a2 >> 64),
                   a3);
    if ( a2 )
    {
      CurrentThreadDpiAwarenessContext = W32GetCurrentThreadDpiAwarenessContext();
      if ( (unsigned __int8)ShouldVirtualizeWindowRect(v8, CurrentThreadDpiAwarenessContext) )
        TransformRectBetweenCoordinateSpaces(&v13, &v13, 0LL, v8);
