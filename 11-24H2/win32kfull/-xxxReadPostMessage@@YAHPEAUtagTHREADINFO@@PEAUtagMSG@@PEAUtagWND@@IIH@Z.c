/*
 * XREFs of ?xxxReadPostMessage@@YAHPEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIH@Z @ 0x14023D790
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( QMsg )
  {
    v19 = (unsigned int)Feature_TouchpadPublicApis3__private_IsEnabledDeviceUsageNoInline(v14, v13, v16, v17) == 0;
    ...
    *((_QWORD *)a1 + 77) = QMsg;
    *(_QWORD *)(*((_QWORD *)a1 + 59) + 448LL) = QMsg[9];
