/*
 * XREFs of ?GetLogFontFromUserProfile@@YA?AUtagLOGFONTW@@PEAU_UNICODE_STRING@@I@Z @ 0x1401CD9B8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  retstr->lfHeight = (retstr->lfHeight
                    * *(unsigned __int16 *)(*(_QWORD *)(W32GetUserSessionState(v9, v8) + 19928) + 6998LL)
                    + 36)
                   / -72;
LABEL_5:
  ...
  *(_WORD *)&retstr->lfOutPrecision = 0;
  ...
  if ( !(unsigned int)ValidateExternalLogFont(retstr) )
  {
    ...
    retstr->lfHeight = 8;
    retstr->lfHeight = (8
                      * *(unsigned __int16 *)(*(_QWORD *)(W32GetUserSessionState(aMsShellDlg[12], v15) + 19928) + 6998LL)
                      + 36)
                     / -72;
    if ( a3 != 139 )
      v11 = 400;
