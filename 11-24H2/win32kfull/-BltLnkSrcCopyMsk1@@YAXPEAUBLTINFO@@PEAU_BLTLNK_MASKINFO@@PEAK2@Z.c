/*
 * XREFs of ?BltLnkSrcCopyMsk1@@YAXPEAUBLTINFO@@PEAU_BLTLNK_MASKINFO@@PEAK2@Z @ 0x14031FEB0
 * Callers:
 *     <none>
 * Callees:
 *     ?BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z @ 0x1401D9D80 (-BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z.c)
 */
        ...
        unsigned __int8 *a4)
{
  ...
  while ( v8 )
  {
    ...
    BltLnkReadPat1(a3, v15, v11, *((_DWORD *)a2 + 6), v16, v12);
    if ( *((_BYTE *)a2 + 36) )
    {
      v25 = v33;
      *a3 |= -1 << (8 - v18);
      a3[(unsigned __int64)(unsigned int)(v12 + v18) >> 3] |= 255 >> ((v12 + v33) & 7);
      if ( v12 <= 0 )
        goto LABEL_26;
      v26 = (char *)(a3 - v17);
      while ( 2 )
      {
        ...
        if ( v27 != -1 )
        {
          v29 = *v17 & v27 | *v14 & ~v17[(_QWORD)v26];
LABEL_22:
          *v17 = v29;
        }
        ++v14;
