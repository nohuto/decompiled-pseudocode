/*
 * XREFs of _SetWinEventHook @ 0x140084C1C
 * Callers:
 ...
 *     CategoryMaskFromEventRange @ 0x140084E9C (CategoryMaskFromEventRange.c)
...
LABEL_16:
  ...
  *(_QWORD *)(v18 + 64) = a5 - a3;
  v22 = *(_QWORD *)(W32GetUserSessionState(v20, v21) + 70848);
  *(_QWORD *)(v18 + 24) = v22;
  *(_QWORD *)(W32GetUserSessionState(v22, v23) + 70848) = v18;
