/*
 * XREFs of ?xxxEnsureAllDpiCursors@@YAXXZ @ 0x140132C48
 * Callers:
...
void __fastcall xxxEnsureAllDpiCursors(__int64 a1, __int64 a2)
{
  ...
  *((_QWORD *)v2 + 57) = BugCheckParameter3;
  ...
  do
  {
    v5 = *(ULONG_PTR **)(W32GetUserSessionState(v5, v3) + v6 + 21936);
    if ( v5 )
    {
  ...
  while ( v4 < 0x13 );
  v7 = *(__int64 **)(W32GetUserSessionState(v5, v3) + 19888);
  UserSessionState = W32GetUserSessionState(v9, v8);
  v11 = *(_QWORD *)(UserSessionState + 19944);
  for ( i = v11 + 32LL * *(unsigned int *)(W32GetUserSessionState(v13, v12) + 19872);
        v11 <= i;
        i = v16 + 32LL * *(unsigned int *)(W32GetUserSessionState(i, v14) + 19872) )
  {
    if ( *(_BYTE *)(v11 + 24) == 3 )
    {
