/*
 * XREFs of ?UpdateDesktopMonitorNavigationOrder@@YAXXZ @ 0x140110CA0
 * Callers:
...
void __fastcall UpdateDesktopMonitorNavigationOrder(__int64 a1, __int64 a2)
{
  ...
  v2 = 0LL;
  v3 = 255;
  v4 = 8LL * ***(unsigned int ***)(W32GetUserSessionState(a1, a2) + 57008);
  if ( v4 <= 0xFFFFFFFF )
  {
    v7 = (_QWORD *)Win32AllocPoolZInit((unsigned int)v4, 1835101525LL);
    if ( v7 )
    {
      for ( i = *(_QWORD **)(*(_QWORD *)(W32GetUserSessionState(v6, v5) + 57008) + 112LL); i; i = (_QWORD *)i[7] )
      {
        v10 = i[5];
        if ( (*(_DWORD *)(v10 + 24) & 1) != 0
          && (unsigned int)v2 < ***(_DWORD ***)(W32GetUserSessionState(v10, v8) + 57008) )
        {
          v7[v2] = i;
          i[12] = 0LL;
          i[13] = 0LL;
      ...
      v13 = 0LL;
      v15 = (_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 57008) + 152LL);
      v15[1] = v15;
      *v15 = v15;
      if ( !(_DWORD)v2 )
        goto LABEL_11;
      do
      {
        ...
        v15 = (_QWORD *)(*(_QWORD *)(UserSessionState + 57008) + 152LL);
        v24 = *(_QWORD **)(*(_QWORD *)(UserSessionState + 57008) + 160LL);
        if ( (_QWORD *)*v24 != v15 )
          __fastfail(3u);
        *v17 = v15;
      ...
      if ( v3 == -1 )
        *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v15, v14) + 57008) + 144LL) = 0;
      else
LABEL_11:
        *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v15, v14) + 57008) + 144LL) = v3;
      Win32FreePool(v7);
    }
  }
}
