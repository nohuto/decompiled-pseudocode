/*
 * XREFs of LinkWindow @ 0x1402B47A8
 * Callers:
 ...
 *     ?LockPointer@@YA?AU_LOCKASSIGNPAIR@@PEAV?$SharedUserObjPointerFieldspwndPrev@UtagWND@@@tagWND@@PEAU_HEAD@@@Z @ 0x1401A2AB0 (-LockPointer@@YA-AU_LOCKASSIGNPAIR@@PEAV-$SharedUserObjPointerFieldspwndPrev@UtagWND@@@tagWND@@P.c)
 *     ?LockPointer@@YA?AU_LOCKASSIGNPAIR@@PEAV?$SharedUserObjPointerFieldspwndNext@UtagWND@@@tagWND@@PEAU_HEAD@@@Z @ 0x1401A605C (-LockPointer@@YA-AU_LOCKASSIGNPAIR@@PEAV-$SharedUserObjPointerFieldspwndNext@UtagWND@@@tagWND@@P.c)
 *     ?LockPointer@@YA?AU_LOCKASSIGNPAIR@@PEAV?$SharedUserObjPointerFieldspwndChild@UtagWND@@@tagWND@@PEAU_HEAD@@@Z @ 0x1401B8674 (-LockPointer@@YA-AU_LOCKASSIGNPAIR@@PEAV-$SharedUserObjPointerFieldspwndChild@UtagWND@@@tagWND@@.c)
...
void __fastcall LinkWindow(struct tagWND *a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( *(char *)(*((_QWORD *)a1 + 5) + 19LL) < 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3145);
  if ( *(__int16 *)(*((_QWORD *)a1 + 5) + 42LL) < 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3146);
...
LABEL_27:
        if ( *(char *)(LastTopMostWindow[5] + 19LL) < 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3344);
        if ( (*(_BYTE *)(_HMPheFromObject(a1) + 25) & 1) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3345);
  ...
  if ( (*((_DWORD *)a1 + 95) & 0x2000000) != 0 )
  {
    if ( (unsigned int)IsWindowDesktopComposed(a1) )
    {
      ...
      if ( !v28 )
      {
        ...
        if ( !v30 && a3 != *(__int64 **)(W32GetUserSessionState(v32, v31) + 68728) )
        {
