/*
 * XREFs of ?UmfdSessionInitialize@@YAJXZ @ 0x140102270
 * Callers:
 ...
 *     ?Create@?$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ @ 0x14010238C (-Create@-$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ.c)
 *     ?AllocateSessionGlobalsArea@Umfd@Gre@@YA_NXZ @ 0x140102420 (-AllocateSessionGlobalsArea@Umfd@Gre@@YA_NXZ.c)
 *     ?Create@?$CSortedVector@KUSFontReliabilityInfo@UmfdReliabilityManager@@@NSInstrumentation@@SAPEAV12@XZ @ 0x140265FC8 (-Create@-$CSortedVector@KUSFontReliabilityInfo@UmfdReliabilityManager@@@NSInstrumentation@@SAPEA.c)
