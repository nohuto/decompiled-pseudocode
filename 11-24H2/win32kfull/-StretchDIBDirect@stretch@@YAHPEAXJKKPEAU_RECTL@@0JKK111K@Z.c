/*
 * XREFs of ?StretchDIBDirect@stretch@@YAHPEAXJKKPEAU_RECTL@@0JKK111K@Z @ 0x1401389C8
 * Callers:
 ...
 * Callees:
 *     ?vDirectStretch32@stretch@@YAXPEAU_STR_BLT@@@Z @ 0x1400F8850 (-vDirectStretch32@stretch@@YAXPEAU_STR_BLT@@@Z.c)
 *     vDirectStretch8 @ 0x14018C8E0 (vDirectStretch8.c)
 *     ?vSrcCopyDummy@@YAXPEAUBLTINFO@@@Z @ 0x1401A4910 (-vSrcCopyDummy@@YAXPEAUBLTINFO@@@Z.c)
 *     ?vDirectStretch8Narrow@stretch@@YAXPEAU_STR_BLT@@@Z @ 0x1401FCA40 (-vDirectStretch8Narrow@stretch@@YAXPEAU_STR_BLT@@@Z.c)
 *     ?vDirectStretch16@stretch@@YAXPEAU_STR_BLT@@@Z @ 0x1402160A0 (-vDirectStretch16@stretch@@YAXPEAU_STR_BLT@@@Z.c)
...
LABEL_25:
      ...
      if ( bottom > top )
      {
        ...
        if ( right - left < 7 )
          v21 = 8LL;
        funcs_140138D65[(unsigned int)a13 | (unsigned __int64)v21]((struct BLTINFO *)&v63);
        a11->left = left;
        a11->right = right;
        a11->top = top;
        a11->bottom = bottom;
