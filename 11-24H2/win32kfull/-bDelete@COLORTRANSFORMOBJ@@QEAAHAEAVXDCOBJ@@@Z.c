/*
 * XREFs of ?bDelete@COLORTRANSFORMOBJ@@QEAAHAEAVXDCOBJ@@@Z @ 0x14032F758
 * Callers:
 ...
 *     ?bAllowDDICall@PDEVOBJ@@QEBAHXZ @ 0x1401C3DA8 (-bAllowDDICall@PDEVOBJ@@QEBAHXZ.c)
...
__int64 __fastcall COLORTRANSFORMOBJ::bDelete(COLORTRANSFORMOBJ *this, struct XDCOBJ *a2)
{
  ...
  HDC v16[18]; // [rsp+30h] [rbp-A8h] BYREF
