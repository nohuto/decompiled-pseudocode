/*
 * XREFs of _UserTestForWinStaAccess @ 0x140105354
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( v8 == -1073741789 )
    {
      ...
      if ( v10 )
      {
        ...
        {
          v8 = -1073741790;
          if ( *(_QWORD *)(W32GetUserSessionState(v12, v11) + 63560) )
          {
            UserSessionState = W32GetUserSessionState(v14, v13);
            v17 = v10[2];
            v18 = *(_QWORD *)(UserSessionState + 63560);
            v19 = *(_DWORD *)(v18 + 184);
            if ( a2 )
            {
              if ( v17 == v19 && v10[3] == *(_DWORD *)(v18 + 188)
            ...
            else if ( v17 == v19 && v10[3] == *(_DWORD *)(v18 + 188) )
            {
              v8 = 0;
            }
          }
