/*
 * XREFs of ?FindShellFrameAppThreadsAssociation@@YAPEAU_THREADSASSOCIATION@@PEAUtagTHREADINFO@@@Z @ 0x14018E358
 * Callers:
...
struct _THREADSASSOCIATION *__fastcall FindShellFrameAppThreadsAssociation(struct tagTHREADINFO *a1, __int64 a2)
{
  ...
  v3 = (struct _THREADSASSOCIATION *)(W32GetUserSessionState(a1, a2) + 19160);
