/*
 * XREFs of _lambda_23cd897c47050bff0d2fbbbc5d471d8f_::operator() @ 0x140217428
 * Callers:
 ...
 *     _lambda_23cd897c47050bff0d2fbbbc5d471d8f_::_lambda_invoker_cdecl_ @ 0x1402DC830 (_lambda_23cd897c47050bff0d2fbbbc5d471d8f_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     <none>
 */
  ...
  if ( v4 <= *(_DWORD *)(v6 + 144) )
  {
    ...
    if ( (unsigned __int8)v4 <= *(_BYTE *)(v3 + v8 + 4) )
    {
      ...
      if ( (unsigned __int8)v4 <= *(_BYTE *)(v3 + v10 + 8)
        && (unsigned __int8)v4 <= *(_BYTE *)(v3 + *(_QWORD *)(W32GetUserSessionState(v10, v9) + 63488) + 16) )
      {
        return 1;
      }
    }
