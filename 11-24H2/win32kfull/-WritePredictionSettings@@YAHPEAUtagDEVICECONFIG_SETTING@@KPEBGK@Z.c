/*
 * XREFs of ?WritePredictionSettings@@YAHPEAUtagDEVICECONFIG_SETTING@@KPEBGK@Z @ 0x1402ACA90
 * Callers:
 *     WritePointerDeviceSettingsFull @ 0x1402ACC7C (WritePointerDeviceSettingsFull.c)
 * Callees:
 *     ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x140153B88 (-RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z.c)
 ...
 *     ?WritePointerDeviceCfgSetting@@YAJPEAXPEBGIPEAEI@Z @ 0x1402ACA20 (-WritePointerDeviceCfgSetting@@YAJPEAXPEBGIPEAEI@Z.c)
