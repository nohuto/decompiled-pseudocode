/*
 * XREFs of ?UMPDDrvGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x140333450
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  UMPDOBJ *v32; // [rsp+50h] [rbp-B0h] BYREF
  struct _SURFOBJ *v33; // [rsp+58h] [rbp-A8h]
...
LABEL_33:
  ...
  v23 = v33;
  v29 = v22 + v21;
  v24 = UMPDOBJ::bThunkLargeBitmap(v32, v33, &v35, &v34, &v31, &v30, &v29);
  v14 = v30;
  v25 = v24;
  v29 = v24;
  v26 = v24;
...
LABEL_18:
    v25 = 0;
    if ( (unsigned int)UMPDOBJ::pso(v15, (UMPDOBJ *)((char *)v15 + 80), &v40, v14) )
    {
      if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v15, (UMPDOBJ *)((char *)v15 + 128), (const void **)&v41, 0x18u, 0LL) )
      {
        if ( (unsigned int)UMPDOBJ::pxlo(v15, &v42) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v15, (const void **)&v43, 16 * a5) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v15, (const void **)&v45, v17) )
            {
  ...
  if ( v31 )
  {
    UMPDOBJ::RestoreBitmap(v15, v23, v35, v34, Size, v14);
    v25 = v26;
  }
  XUMPDOBJ::~XUMPDOBJ(&v32);
  return v25;
