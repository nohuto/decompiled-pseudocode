/*
 * XREFs of SfnINWPARAMCHAR @ 0x1401E9660
 * Callers:
...
__int64 __fastcall SfnINWPARAMCHAR(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  ...
  __int64 v33; // [rsp+100h] [rbp+18h] BYREF
  void *Src; // [rsp+108h] [rbp+20h] BYREF
  ...
  if ( (a7 & 1) != 0 )
  {
    if ( v8 == 47 || v8 == 288 )
    {
      ...
      RtlWCSMessageWParamCharToMB(v8, (unsigned __int16 *)&v31);
      v33 = (WORD1(v33) << 16) | (unsigned __int16)v31;
    }
    else
    {
      RtlWCSMessageWParamCharToMB(v8, (unsigned __int16 *)&v33);
    }
  }
  v26 = v33;
  v27 = a4;
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 65) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(2LL, &v23, 48LL, &Src, &v32);
