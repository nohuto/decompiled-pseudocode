/*
 * XREFs of ?RunForAllProviders@InkFeedbackServer@@AEAAJW4INK_FEEDBACK_COMMAND@@PEBXIP6AJPEAVInkFeedbackProviderBase@@01I@Z@Z @ 0x1401E2338
 * Callers:
        ...
        int (__fastcall *a5)(_QWORD *, _QWORD, __int64, _QWORD))
{
  ...
  if ( a2 == 4 || a2 == 2 )
    return 0LL;
  if ( (unsigned int)dword_140398C98 > 2 )
  {
