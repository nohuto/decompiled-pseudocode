/*
 * XREFs of NtUserAutoRotateScreen @ 0x1402408F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
    ...
    else
    {
      ...
      if ( (_InterlockedCompareExchange((volatile signed __int32 *)(v13 + 528), 0, 0) & 0x20000000) == 0 )
        goto LABEL_8;
      v13 = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)PtiCurrent(v13, v12) + 58) + 760LL) + 32LL);
      v11 = (v13 & 0x10) == 0;
    }
    if ( !v11 )
      goto LABEL_3;
LABEL_8:
    ...
    v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(UserSessionState + 66112) + 56LL))(
