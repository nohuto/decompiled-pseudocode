/*
 * XREFs of ?bEnumStartLine@XCLIPOBJ@@QEAAHK@Z @ 0x140008508
 * Callers:
 *     ?bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z @ 0x1400096F4 (-bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z.c)
 * Callees:
 *     ?vUpdateStyleState@XCLIPOBJ@@QEAAXXZ @ 0x140007560 (-vUpdateStyleState@XCLIPOBJ@@QEAAXXZ.c)
 *     ?bInit@DDA_CLIPLINE@@QEAAHPEBU_POINTFIX@@0@Z @ 0x140008664 (-bInit@DDA_CLIPLINE@@QEAAHPEBU_POINTFIX@@0@Z.c)
 */
