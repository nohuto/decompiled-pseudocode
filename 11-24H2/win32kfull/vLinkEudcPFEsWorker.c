/*
 * XREFs of vLinkEudcPFEsWorker @ 0x1401FB840
 * Callers:
 *     vLinkEudcPFEs @ 0x1401FB78C (vLinkEudcPFEs.c)
 * Callees:
 *     ?bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z @ 0x1400B7060 (-bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z.c)
 *     ?FindBaseFontEntry@@YAPEAU_FLENTRY@@PEBG@Z @ 0x1400B93D0 (-FindBaseFontEntry@@YAPEAU_FLENTRY@@PEBG@Z.c)
 *     ?pwszFamilyNameAlias@PFEOBJ@@QEAAPEAGPEAH@Z @ 0x14019BBA8 (-pwszFamilyNameAlias@PFEOBJ@@QEAAPEAGPEAH@Z.c)
