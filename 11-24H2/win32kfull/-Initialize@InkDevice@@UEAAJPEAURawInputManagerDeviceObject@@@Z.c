/*
 * XREFs of ?Initialize@InkDevice@@UEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1402ED810
 * Callers:
 ...
 *     ?GetDeviceCaps@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAUUsageValueInfo@@1PEAVCapabilities@InkDevice@@@Z @ 0x1402EAAB4 (-GetDeviceCaps@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAUUsageValueInfo@@1PEAVCapabiliti.c)
 ...
 *     ?Initialize@RimBackedDeviceBase@@UEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1402EDA70 (-Initialize@RimBackedDeviceBase@@UEAAJPEAURawInputManagerDeviceObject@@@Z.c)
