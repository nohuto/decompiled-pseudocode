/*
 * XREFs of ?SetTopologyId@CMonitorTopology@@QEAAXXZ @ 0x1402AB6EC
 * Callers:
...
void __fastcall CMonitorTopology::SetTopologyId(CMonitorTopology *this, __int64 a2)
{
  ...
  v4 = *(_QWORD *)(W32GetUserSessionState(this, a2) + 19928);
  v5 = *(_DWORD *)(v4 + 7500);
  v6 = v5 == -1;
  v7 = v5 + 1;
  *((_DWORD *)this + 3) = v7;
  ...
  *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v4, v3) + 19928) + 7500LL) = v7;
}
