/*
 * XREFs of ?vFillGRectDIB4@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x14026D310
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v5 < v50 )
    {
      ...
      do
      {
        ...
        v22 = v16;
        v23 = *((int *)v2 + 44);
        v45 = (char *)&unk_140361E70 + 16 * (((_BYTE)v5 + (_BYTE)v18) & 0xFu);
        v24 = v17;
        if ( (_DWORD)v23 )
        {
          v21 = v15 + v19 * v23;
        ...
        if ( v25 < v51 )
        {
          ...
          do
          {
            ...
            v30 = *v26;
            v31 = v12[Xlate555[((unsigned __int64)byte_140362130[v29 + BYTE6(v24)] >> 3) | (4
                                                                                          * (byte_140362130[v29 + BYTE6(v22)] & 0xF8 | (32LL * (byte_140362130[v29 + BYTE6(v21)] & 0xF8))))]];
            if ( (v25 & 1) != 0 )
            {
              ++v26;
              v32 = v31 | v30 & 0xF0;
