/*
 * XREFs of ?prunPlgRead24@rotate@@YAPEAU_PLGRUN@1@PEAU_PLGDDA@1@PEAU21@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x14011D020
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( (_DWORD)v9 != a7 )
    {
      ...
      if ( pxlo )
      {
        v25 = (struct rotate::_PLGDDA *)dword_140352C90;
        do
        {
          v26 = v16 + 4;
          if ( v18 >= 32 )
      ...
      else
      {
        do
        {
          ...
          v16 = v20;
          if ( ((unsigned int)v17 & dword_140352C90[v21]) != 0 )
          {
            LOWORD(iColor) = *(_WORD *)v11;
            BYTE2(iColor) = v11[2];
            *(_DWORD *)a2 = iColor;
