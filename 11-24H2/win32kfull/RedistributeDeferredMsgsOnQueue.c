/*
 * XREFs of RedistributeDeferredMsgsOnQueue @ 0x140090D70
 * Callers:
 ...
 * Callees:
 *     ?DeferMessage@@YAXPEAUtagMLIST@@PEAUtagQMSG@@@Z @ 0x140154938 (-DeferMessage@@YAXPEAUtagMLIST@@PEAUtagQMSG@@@Z.c)
