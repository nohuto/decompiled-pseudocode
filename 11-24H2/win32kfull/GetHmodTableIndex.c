/*
 * XREFs of GetHmodTableIndex @ 0x140083C34
 * Callers:
...
__int64 __fastcall GetHmodTableIndex(__int64 a1)
{
  ...
  v7 = UserAddAtomToAtomTableEx(*(_QWORD *)(UserSessionState + 41448), a1, 0LL, 2LL);
  if ( v7 )
  {
    v9 = 0;
    if ( *(int *)(W32GetUserSessionState(v6, v5) + 41456) > 0 )
    {
      v12 = 0LL;
      do
      {
        if ( *(_WORD *)(W32GetUserSessionState(v11, v10) + v12 + 41460) == v7 )
          break;
        ++v9;
        v12 += 2LL;
      }
      while ( v9 < *(_DWORD *)(W32GetUserSessionState(v11, v10) + 41456) );
    }
    if ( v9 != *(_DWORD *)(W32GetUserSessionState(v11, v10) + 41456) )
    {
      v15 = W32GetUserSessionState(v14, v13);
      UserDeleteAtomFromAtomTable(*(_QWORD *)(v15 + 41448), v7);
LABEL_8:
      DomainShared<>::DomainExclusive<DLT_HOOK>::ObjectLock<>::~ObjectLock<>(v29, v16, v17);
      return (unsigned int)v9;
    }
    v9 = 0;
    if ( *(int *)(W32GetUserSessionState(v14, v13) + 41456) > 0 )
    {
      v21 = 0LL;
      do
      {
        if ( !*(_WORD *)(W32GetUserSessionState(v20, v19) + v21 + 41460) )
          break;
        ++v9;
        v21 += 2LL;
      }
      while ( v9 < *(_DWORD *)(W32GetUserSessionState(v20, v19) + 41456) );
    }
    if ( v9 != *(_DWORD *)(W32GetUserSessionState(v20, v19) + 41456) )
    {
LABEL_14:
      *(_WORD *)(W32GetUserSessionState(v23, v22) + 2LL * v9 + 41460) = v7;
      *(_DWORD *)(W32GetUserSessionState(v25, v24) + 4LL * v9 + 41524) = 0;
      *(_DWORD *)(W32GetUserSessionState(v27, v26) + 4LL * v9 + 41652) = 0;
      goto LABEL_8;
    }
    ...
    UserDeleteAtomFromAtomTable(*(_QWORD *)(v28 + 41448), v7);
    UserSetLastError(8);
  }
