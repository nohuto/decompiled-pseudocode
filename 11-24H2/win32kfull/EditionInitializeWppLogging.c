/*
 * XREFs of EditionInitializeWppLogging @ 0x14020F9A0
 * Callers:
 *     <none>
 * Callees:
 *     W32GetCurrentWin32kSessionId @ 0x1400A428C (W32GetCurrentWin32kSessionId.c)
 *     IsCurrentSessionHostServiceSession @ 0x1401F63F0 (IsCurrentSessionHostServiceSession.c)
 *     RtlStringCopyWorkerA @ 0x1402ADA74 (RtlStringCopyWorkerA.c)
 *     WPP_INIT_CONTROL_ARRAY @ 0x1402ADB30 (WPP_INIT_CONTROL_ARRAY.c)
...
__int64 __fastcall EditionInitializeWppLogging(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&v18 = (unsigned int)W32GetCurrentWin32kSessionId();
  ...
  v12 = imp_WppRecorderLogCreate(*(_QWORD *)&WPP_GLOBAL_Control, &v16, UserSessionState + 69416);
  if ( v12 < 0 )
    *(_QWORD *)(W32GetUserSessionState(v11, v10) + 69416) = 0LL;
