/*
 * XREFs of InitClipFormatExceptionList @ 0x1401F3C50
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v2 == -1073741789 || v2 == -2147483643 )
    {
      ...
      if ( v0 )
      {
        if ( ZwQueryKey(KeyHandle, KeyFullInformation, v0, Length, &Length) >= 0 )
        {
          ...
          if ( v10 )
          {
            *(_DWORD *)(W32GetUserSessionState(v9, v3) + 21920) = v10;
            if ( *(_DWORD *)(W32GetUserSessionState(v12, v11) + 21920) <= 0x1FFFu )
            {
              UserSessionState = W32GetUserSessionState(v13, v3);
              v15 = Win32AllocPoolZInit(4LL * *(unsigned int *)(UserSessionState + 21920), 1650684757LL);
              *(_QWORD *)(W32GetUserSessionState(v17, v16) + 21912) = v15;
              if ( *(_QWORD *)(W32GetUserSessionState(v19, v18) + 21912) )
              {
                ...
                if ( (unsigned int)v20 < 0xFFFFFFF0 )
                {
                  ...
                  if ( v22 )
                  {
                    for ( i = 0; ; ++i )
                    {
                      if ( i >= *(_DWORD *)(W32GetUserSessionState(v21, v3) + 21920) )
                      {
LABEL_30:
                        Win32FreePool(v22);
                        goto LABEL_11;
                      ...
                      if ( v24 == 1 )
                      {
                        *((_WORD *)v22 + (unsigned int)v22[2] + 6) = 0;
                        ...
                        {
LABEL_29:
                          *(_DWORD *)(W32GetUserSessionState(v21, v3) + 21920) = i;
                          goto LABEL_30;
                        }
                        v25 = v27;
                        goto LABEL_27;
...
LABEL_27:
                    ...
                    v21 = i;
                    *(_DWORD *)(*(_QWORD *)(v26 + 21912) + 4LL * i) = v25;
                    goto LABEL_28;
                  }
                }
              }
    ...
    if ( *(_QWORD *)(W32GetUserSessionState(v4, v3) + 21912) )
    {
      v31 = W32GetUserSessionState(v8, v7);
      Win32FreePool(*(void **)(v31 + 21912));
      *(_QWORD *)(W32GetUserSessionState(v33, v32) + 21912) = 0LL;
    }
    *(_DWORD *)(W32GetUserSessionState(v8, v7) + 21920) = 0;
LABEL_11:
    if ( v0 )
      Win32FreePool(v0);
