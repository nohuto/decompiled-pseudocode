/*
 * XREFs of xxxSendMessageCallback @ 0x140119C04
 * Callers:
        ...
        int a9)
{
  ...
  *(_OWORD *)v49 = 0LL;
  ...
  if ( a1 != (struct tagWND *)-1LL )
  {
    ...
    v18 = *(_QWORD *)(W32GetUserSessionState(a6, a2) + 19928);
    v48 = v16;
    if ( v16 >= *(_QWORD *)(v18 + 8)
      || (UserSessionState = W32GetUserSessionState(v18, v17),
          v22 = (unsigned int)(*(_DWORD *)(W32GetUserSessionState(v21, v20) + 19952) * v16),
          v14 = v22 + *(_QWORD *)(UserSessionState + 19944),
          *(struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(v22, v23) + 19888) + 40 * v48) != a1)
      || *(_BYTE *)(v14 + 24) != 1 )
    {
