/*
 * XREFs of ?psSetupDstSurface@@YAPEAVSURFACE@@PEAV1@PEAU_RECTL@@AEAVSURFMEM@@HH@Z @ 0x1401203BC
 * Callers:
    ...
    if ( !a5
      || ((v17[0] = a2->left, v17[1] = a2->top, v15 = Gre::Base::Globals(v14), (*((_DWORD *)v9 + 28) & 0x400) == 0)
        ? (v16 = ((__int64 (__fastcall *)(__int64, char *, _QWORD, char *, struct _RECTL *, _DWORD *))EngCopyBits)(
                   ...
                   &v22,
                   v17))
        : (v16 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, __int64, struct _RECTL *, _DWORD *))v12[354])(
                   (*(_QWORD *)a3 + 24LL) & -(__int64)(*(_QWORD *)a3 != 0LL),
                   (__int64)v9 + 24,
                   0LL,
                   (__int64)v15 + 4552,
