/*
 * XREFs of ?UmfdDispatchWinLogonEscape@@YAXPEAUtagUMFD_WINLOGON_ESCAPE_ARGUMENT@@@Z @ 0x140226FCC
 * Callers:
 ...
 *     ??1ExclusiveWinlognRequestLock@@QEAA@XZ @ 0x14020FD10 (--1ExclusiveWinlognRequestLock@@QEAA@XZ.c)
 *     ??0ExclusiveWinlognRequestLock@@QEAA@XZ @ 0x140228018 (--0ExclusiveWinlognRequestLock@@QEAA@XZ.c)
