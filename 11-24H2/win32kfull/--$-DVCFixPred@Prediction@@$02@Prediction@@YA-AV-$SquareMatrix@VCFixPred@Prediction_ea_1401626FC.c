/*
 * XREFs of ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AV?$SquareMatrix@VCFixPred@Prediction@@$02@0@AEBV10@0@Z @ 0x1401626FC
 * Callers:
  ...
  do
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v20 = (char *)a2 + (_QWORD)v6 + (unsigned __int64)v7;
    ...
    while ( v25 );
    v5 = a3;
    a2 = (Prediction::CFixPred *)((char *)a2 + 24);
    --v26;
  }
  while ( v26 );
  return a1;
