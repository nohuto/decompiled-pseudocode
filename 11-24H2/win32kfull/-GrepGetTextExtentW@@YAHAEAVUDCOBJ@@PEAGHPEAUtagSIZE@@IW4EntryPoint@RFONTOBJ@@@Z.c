/*
 * XREFs of ?GrepGetTextExtentW@@YAHAEAVUDCOBJ@@PEAGHPEAUtagSIZE@@IW4EntryPoint@RFONTOBJ@@@Z @ 0x1400C0454
 * Callers:
 ...
 *     ?bToPOINTL@EPOINTFL@@QEAAHAEAU_POINTL@@@Z @ 0x1400E8BC4 (-bToPOINTL@EPOINTFL@@QEAAHAEAU_POINTL@@@Z.c)
 ...
 *     ?bTextExtent@ESTROBJ@@QEAAHAEAVRFONTOBJ@@JPEAUtagSIZE@@@Z @ 0x140174EEC (-bTextExtent@ESTROBJ@@QEAAHAEAVRFONTOBJ@@JPEAUtagSIZE@@@Z.c)
 *     ??1ESTROBJ@@QEAA@XZ @ 0x14017A908 (--1ESTROBJ@@QEAA@XZ.c)
 *     ?vAbs@EFLOAT@@QEAAXXZ @ 0x1401BD7B4 (-vAbs@EFLOAT@@QEAAXXZ.c)
    ...
    if ( v25 )
    {
      ...
      if ( v19 == v11[97] || v11[52] == 1 && (v11[181] & 4) == 0 )
      {
        ...
        if ( v10
          ...
          && ((unsigned int)EFLOAT::bIsZero((EFLOAT *)(*(_QWORD *)a1 + 452LL))
           || (unsigned int)EFLOAT::bIsZero((EFLOAT *)(v21 + 456)))
          && (*(_DWORD *)(v25 + 724) & 4) != 0 )
        {
          cy = (float)a4->cy;
          cx = (float)a4->cx;
