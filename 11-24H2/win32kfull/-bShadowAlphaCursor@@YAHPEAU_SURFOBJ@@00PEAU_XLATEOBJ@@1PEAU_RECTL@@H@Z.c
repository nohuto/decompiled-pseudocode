/*
 * XREFs of ?bShadowAlphaCursor@@YAHPEAU_SURFOBJ@@00PEAU_XLATEOBJ@@1PEAU_RECTL@@H@Z @ 0x14018D8A0
 * Callers:
  ...
  *(_QWORD *)&v34.iSrcType = 0LL;
  ...
  if ( (unsigned int)bBlurCursorShadow(a1) && (unsigned int)bBlurCursorShadow(a1) )
  {
    ...
    if ( a7 )
    {
      ...
      v38 = (char *)v19 + 4552;
      v39 = (char *)v19 + 4552;
      EngAlphaBlend(a1, v10, 0LL, (XLATEOBJ *)((char *)v19 + 4552), &prclDest, &prclSrc, &pBlendObj);
    }
    else
    {
      v31 = 0xFFFFFFFF00000000uLL;
