/*
 * XREFs of _anonymous_namespace_::DeferPointerCursorOperation @ 0x14018EF24
 * Callers:
...
int __fastcall anonymous_namespace_::DeferPointerCursorOperation(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    v5 = *(_QWORD *)(UserSessionState + 36368);
  ...
  *(_QWORD *)v9 = *(_QWORD *)a2;
  *(_DWORD *)(v9 + 8) = v10;
  v12 = *(volatile __int64 **)(W32GetUserSessionState(v5, v4) + 36368);
  v13 = _InterlockedExchange64(v12, v9);
  if ( v13 )
  {
    v15 = v13 - *(_QWORD *)(W32GetUserSessionState(v12, v11) + 36368) - 8;
    v16 = v15 / 0xC;
  ...
  LODWORD(UserSessionState) = KeSetEvent(*(PRKEVENT *)(*(_QWORD *)(v14 + 36368) + 72LL), 1, 0);
  return UserSessionState;
}
