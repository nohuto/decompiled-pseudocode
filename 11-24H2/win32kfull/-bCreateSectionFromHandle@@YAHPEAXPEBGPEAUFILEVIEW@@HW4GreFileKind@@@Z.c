/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAUFILEVIEW@@HW4GreFileKind@@@Z @ 0x1403048A4
 * Callers:
 ...
 *     ?CreateSection@FileObj@Gre@@QEAA_NPEAT_LARGE_INTEGER@@_NPEAPEAX@Z @ 0x1401C6ED0 (-CreateSection@FileObj@Gre@@QEAA_NPEAT_LARGE_INTEGER@@_NPEAPEAX@Z.c)
 ...
 *     ?QueryDeviceRemoteBit@FileQueryObj@Gre@@QEBA_NPEA_N@Z @ 0x1401E08D4 (-QueryDeviceRemoteBit@FileQueryObj@Gre@@QEBA_NPEA_N@Z.c)
