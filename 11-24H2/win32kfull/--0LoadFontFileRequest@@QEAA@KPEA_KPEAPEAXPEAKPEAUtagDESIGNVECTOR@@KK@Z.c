/*
 * XREFs of ??0LoadFontFileRequest@@QEAA@KPEA_KPEAPEAXPEAKPEAUtagDESIGNVECTOR@@KK@Z @ 0x1401001F8
 * Callers:
 ...
 *     ?HashPath@CPathNameHashTable@UmfdReliabilityManager@@SA_NQEAGPEAK@Z @ 0x1401002C8 (-HashPath@CPathNameHashTable@UmfdReliabilityManager@@SA_NQEAGPEAK@Z.c)
