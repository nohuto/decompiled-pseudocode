/*
 * XREFs of RtlWCSMessageWParamCharToMB @ 0x1401E8330
 * Callers:
...
__int64 __fastcall RtlWCSMessageWParamCharToMB(int a1, unsigned __int16 *a2)
{
  ...
  v12 = THREAD_CODEPAGE();
  MultiByteString = 0;
  BytesInUnicodeString = (**(_DWORD **)(W32GetUserSessionState(v14, v13) + 19928) & 2) != 0 ? 2 : 4;
...
LABEL_18:
  ...
  if ( RtlUnicodeToMultiByteN((PCHAR)&MultiByteString, 4u, 0LL, a2, BytesInUnicodeString) < 0 )
    goto LABEL_18;
LABEL_14:
  if ( (**(_DWORD **)(W32GetUserSessionState(v17, v16) + 19928) & 2) != 0 )
  {
