/*
 * XREFs of CtxDisplayIOCtl @ 0x1402B6DAC
 * Callers:
...
__int64 __fastcall CtxDisplayIOCtl(char a1, __int64 a2, unsigned int a3)
{
  ...
  if ( *(_DWORD *)(W32GetUserSessionState(v7, v6) + 69020) )
  {
    RemoteHDEV = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 69064);
  }
  else
  {
    v17 = *(_QWORD *)(RemoteContext + 40);
    v18 = W32GetUserSessionState(v15, v14);
    RemoteHDEV = GetRemoteHDEV(*(unsigned __int16 *)(v18 + 69008), v17);
  }
