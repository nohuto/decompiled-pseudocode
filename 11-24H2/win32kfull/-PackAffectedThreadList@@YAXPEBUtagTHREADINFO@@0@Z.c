/*
 * XREFs of ?PackAffectedThreadList@@YAXPEBUtagTHREADINFO@@0@Z @ 0x140156700
 * Callers:
...
void __fastcall PackAffectedThreadList(const struct tagTHREADINFO *a1, const struct tagTHREADINFO *a2)
{
  ...
  for ( i = *v2; i != v2; i = (_QWORD *)*i )
  {
    ...
    if ( *(i - 38) == *((_QWORD *)a1 + 59)
      || (v13 = *(_QWORD *)(W32GetUserSessionState(v8, v7) + 18944), *((_QWORD *)v12 + 59) == v13)
      || (v14 = *(_QWORD *)(W32GetUserSessionState(v13, v7) + 18952), v15 = *((_QWORD *)v12 + 59), v15 == v14) )
    {
      v8 = 0LL;
    }
    else
