/*
 * XREFs of ?TraceChildWindowDpiTelemetry@@YAXPEAUtagWND@@0W4_CHILD_WINDOW_DPI_TELEMETRY@@@Z @ 0x1401F4C58
 * Callers:
...
char __fastcall TraceChildWindowDpiTelemetry(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    LOBYTE(ProcessImageFilename) = tlgKeywordOn((__int64)&dword_140398BB8, 0x400000000000LL);
