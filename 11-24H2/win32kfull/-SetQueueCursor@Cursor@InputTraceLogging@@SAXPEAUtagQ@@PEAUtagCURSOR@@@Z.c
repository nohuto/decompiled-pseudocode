/*
 * XREFs of ?SetQueueCursor@Cursor@InputTraceLogging@@SAXPEAUtagQ@@PEAUtagCURSOR@@@Z @ 0x1401B2498
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::SetQueueCursor(struct tagQ *a1, struct tagCURSOR *a2)
{
  ...
  if ( (unsigned int)dword_140398B80 > 5 && (qword_140398B90 & 8) != 0 && (qword_140398B98 & 8) == qword_140398B98 )
  {
    v5 = a1;
    v6 = a2;
