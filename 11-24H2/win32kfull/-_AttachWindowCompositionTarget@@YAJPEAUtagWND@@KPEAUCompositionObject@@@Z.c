/*
 * XREFs of ?_AttachWindowCompositionTarget@@YAJPEAUtagWND@@KPEAUCompositionObject@@@Z @ 0x1401AC828
 * Callers:
 ...
 *     ??$CreateWindowProp@VCHwndTargetProp@@@CWindowProp@@SAJPEAPEAVCHwndTargetProp@@@Z @ 0x1401AC950 (--$CreateWindowProp@VCHwndTargetProp@@@CWindowProp@@SAJPEAPEAVCHwndTargetProp@@@Z.c)
...
__int64 __fastcall _AttachWindowCompositionTarget(struct tagWND *a1, __int64 a2, struct CompositionObject *a3)
{
  ...
  v7 = 1;
  Prop = (CWindowProp *)GetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 42306), 1u);
  v13 = Prop;
  v9 = Prop;
  if ( Prop )
  {
