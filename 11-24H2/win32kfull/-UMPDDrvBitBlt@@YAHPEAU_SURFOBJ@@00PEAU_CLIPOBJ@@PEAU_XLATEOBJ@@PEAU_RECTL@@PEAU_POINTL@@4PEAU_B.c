/*
 * XREFs of ?UMPDDrvBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1400D7950
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  _BYTE v85[4]; // [rsp+130h] [rbp+30h] BYREF
...
LABEL_13:
    ...
    if ( !v32
      ...
      || (LODWORD(Size) = 4, v34 = UMPDOBJ::Thunk(v17, v85, 0x70u, &v68, Size), LOBYTE(v19) = 0, v34 == -1)
      || (v22 = 1, !v68) )
    {
LABEL_30:
      v22 = 0;
