/*
 * XREFs of ?SpDdNotifyFullscreenSpriteUpdate@@YAJAEAVXDCOBJ@@PEAX@Z @ 0x1403212B0
 * Callers:
 *     NtGdiDdNotifyFullscreenSpriteUpdate @ 0x140325A20 (NtGdiDdNotifyFullscreenSpriteUpdate.c)
 * Callees:
 ...
 *     ?bShouldUseSfmTokenArray@@YAEU_LOGSURF_FLAGS@@@Z @ 0x1401ACE98 (-bShouldUseSfmTokenArray@@YAEU_LOGSURF_FLAGS@@@Z.c)
