/*
 * XREFs of ?xxxSendInput@@YAIIPEAUtagINPUT@@@Z @ 0x140274038
 * Callers:
...
unsigned int __fastcall xxxSendInput(unsigned int a1, struct tagINPUT *a2)
{
  ...
  if ( (unsigned int)Feature_EliminateMitRitHandoff2__private_IsEnabledDeviceUsageNoInline() )
    v10 = *(_DWORD *)(W32GetUserSessionState(v9, v8) + 18800);
  else
  ...
  if ( a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_DWORD)v14 )
      {
        ...
        v22 = *(_DWORD **)(W32GetUserSessionState(v15, 1LL) + 19928);
        if ( (*v22 & 0x2000) == 0 )
        {
          if ( v6 )
          {
          ...
          if ( (v28 & 4) == 0 || *((_WORD *)v13 - 8) || (v28 & 0xFFFFFFF9) != 0 )
          {
                    ...
                    *v13) )
            {
              ...
              {
                v34 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v35) + 69416);
                v45 = v7 >= 0x501u;
                v44 = v11;
                v42 = 41;
                goto LABEL_74;
          ...
          else
          {
                    ...
                    *v13) )
            {
              ...
              if ( v30 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
              {
                v34 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v29) + 69416);
                v45 = v7 >= 0x501u;
                v44 = v11;
                v42 = 40;
                goto LABEL_74;
...
LABEL_28:
      ...
      {
        v37 = *(_DWORD **)(W32GetUserSessionState(v14, 1LL) + 19928);
        if ( (*v37 & 0x2000) == 0 )
        {
                                ...
                                v12) )
          {
            ...
            if ( v30 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            {
              v34 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v39) + 69416);
              v45 = v7 >= 0x501u;
              v44 = v11;
              v42 = 38;
LABEL_74:
