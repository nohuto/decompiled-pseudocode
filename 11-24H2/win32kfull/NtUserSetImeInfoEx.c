/*
 * XREFs of NtUserSetImeInfoEx @ 0x14029DA50
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x14005FE74 (UserSetLastError.c)
 *     _GetProcessWindowStation @ 0x1401038C0 (_GetProcessWindowStation.c)
 *     ?SetImeInfoEx@@YAHPEAUtagWINDOWSTATION@@PEAUtagIMEINFOEX@@@Z @ 0x14021C128 (-SetImeInfoEx@@YAHPEAUtagWINDOWSTATION@@PEAUtagIMEINFOEX@@@Z.c)
 */
...
__int64 __fastcall NtUserSetImeInfoEx(_OWORD *a1)
{
  ...
  EnterCrit(0LL, 0LL);
  if ( (**(_DWORD **)(W32GetUserSessionState(v2, v1) + 19928) & 4) != 0 )
  {
    v5 = a1;
    v6 = v10;
    v7 = 2LL;
