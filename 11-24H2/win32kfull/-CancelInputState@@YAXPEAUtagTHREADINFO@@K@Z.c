/*
 * XREFs of ?CancelInputState@@YAXPEAUtagTHREADINFO@@K@Z @ 0x14027A098
 * Callers:
...
void __fastcall CancelInputState(struct tagTHREADINFO *a1, __int64 a2)
{
  ...
  if ( !v6 )
  {
    ...
    if ( (**(_DWORD **)(W32GetUserSessionState(v13, v12) + 19928) & 4) != 0 )
    ...
    if ( v11 == *((struct tagWND **)v14 + 15) )
    {
      ...
      if ( v11 )
      {
        if ( *((_QWORD *)a1 + 59) == *(_QWORD *)(W32GetUserSessionState(v15, v8) + 18944) )
  ...
  if ( v6 == 1 )
  {
    *(_DWORD *)(*((_QWORD *)a1 + 59) + 436LL) &= ~0x100000u;
