/*
 * XREFs of vMirrorIncludeNotifyWrap @ 0x140162C40
 * Callers:
 *     <none>
 * Callees:
 *     ?bIsDefault@SURFACE@@QEBA_NXZ @ 0x1402FC8DC (-bIsDefault@SURFACE@@QEBA_NXZ.c)
 *     ?bStockSurface@SURFACE@@QEAAHXZ @ 0x1402FC908 (-bStockSurface@SURFACE@@QEAAHXZ.c)
