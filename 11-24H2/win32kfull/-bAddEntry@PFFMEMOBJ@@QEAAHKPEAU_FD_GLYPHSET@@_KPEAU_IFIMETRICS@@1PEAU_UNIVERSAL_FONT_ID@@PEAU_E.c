/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1400FEE08
 * Callers:
 ...
 *     ?IsCHSBaseFont@@YAHPEBGI@Z @ 0x1401E4408 (-IsCHSBaseFont@@YAHPEBGI@Z.c)
 */
