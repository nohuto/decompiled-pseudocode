/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAU_tagOEMBITMAPSET@@I@Z @ 0x14018B06C
 * Callers:
 ...
 *     ?ArrangeFrameControls@@YAFHHPEAU_tagOEMBITMAPSET@@@Z @ 0x14018B370 (-ArrangeFrameControls@@YAFHHPEAU_tagOEMBITMAPSET@@@Z.c)
 */
