/*
 * XREFs of ?OnDaemonTimerRateChanged@CForegroundLaunch@@QEAAX_N@Z @ 0x1401C2970
 * Callers:
 *     ?OnDaemonTimerRateChanged@ForegroundLaunch@@YAX_N@Z @ 0x1401C2940 (-OnDaemonTimerRateChanged@ForegroundLaunch@@YAX_N@Z.c)
 * Callees:
