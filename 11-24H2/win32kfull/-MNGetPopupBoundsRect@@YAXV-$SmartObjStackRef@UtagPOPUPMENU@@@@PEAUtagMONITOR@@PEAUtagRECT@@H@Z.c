/*
 * XREFs of ?MNGetPopupBoundsRect@@YAXV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagMONITOR@@PEAUtagRECT@@H@Z @ 0x1400987D8
 * Callers:
...
_QWORD *__fastcall MNGetPopupBoundsRect(__int64 a1, __int64 a2, struct tagRECT *a3, int a4)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)*v14 + 2) + 40LL) + 288LL) & 0xF) == 2
    || (v15 = ValidateHmonitorNoRip(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(**(_QWORD **)a1 + 16LL) + 40LL) + 256LL)),
        (v21[0] = v15) == 0LL)
    || v15 == a2 )
  {
    if ( a4 )
