/*
 * XREFs of xxxRemoteConsoleShadowStart @ 0x1402B71F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreConsoleShadowStart @ 0x14033CFD4 (GreConsoleShadowStart.c)
...
__int64 __fastcall xxxRemoteConsoleShadowStart(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&SourceString = a2;
  ...
  if ( *(unsigned int **)&WPP_GLOBAL_Control != &WPP_GLOBAL_Control )
  {
    ...
    if ( (v8 & 4) != 0 && *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) >= 4u )
      v12 = 1;
  }
  v13 = *(_QWORD *)&WPP_RECORDER_INITIALIZED != (_QWORD)&WPP_RECORDER_INITIALIZED;
  if ( v12 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    v14 = W32GetUserSessionState(v8, *(_QWORD *)&WPP_GLOBAL_Control);
    LOBYTE(v15) = v13;
    LOBYTE(v16) = v12;
  ...
  if ( *(_DWORD *)(UserSessionState + 69012) && !IsRemoteConnection(v8, v10) )
  {
    *(_DWORD *)(UserSessionState + 69020) = 0;
    *(_QWORD *)(UserSessionState + 69064) = 0LL;
    *(_QWORD *)(UserSessionState + 69024) = *(_QWORD *)(a1 + 32);
    *(_QWORD *)(UserSessionState + 69032) = *(_QWORD *)(a1 + 40);
    *(_QWORD *)(UserSessionState + 69048) = *(_QWORD *)(a1 + 56);
    *(_QWORD *)(UserSessionState + 69056) = *(_QWORD *)(a1 + 64);
    *(_QWORD *)(UserSessionState + 69096) = *(_QWORD *)(a1 + 268);
    *(_DWORD *)(UserSessionState + 69104) = *(_DWORD *)(a1 + 276);
    v19 = *(_DWORD *)(a1 + 240);
    *(_DWORD *)(W32GetUserSessionState(v18, v17) + 16272) = v19;
    v20 = *(_DWORD *)(a1 + 244);
    Object = 0LL;
    *(_DWORD *)(W32GetUserSessionState(v22, v21) + 14036) = v20;
    MirrorDriver = ObReferenceObjectByHandle(*(HANDLE *)(a1 + 72), 2u, (POBJECT_TYPE)ExEventObjectType, 0, &Object, 0LL);
    *(_QWORD *)(UserSessionState + 69072) = Object;
    if ( MirrorDriver < 0 )
      goto LABEL_24;
    v24 = *(void **)(UserSessionState + 69024);
    Object = 0LL;
    MirrorDriver = ObReferenceObjectByHandle(v24, 0, 0LL, 0, &Object, 0LL);
    if ( MirrorDriver < 0 )
      goto LABEL_24;
    v25 = (struct _FILE_OBJECT *)Object;
    *(_QWORD *)(UserSessionState + 69080) = Object;
    IoGetRelatedDeviceObject(v25);
    v26 = *(void **)(UserSessionState + 69056);
    Object = 0LL;
    MirrorDriver = ObReferenceObjectByHandle(v26, 0, 0LL, 0, &Object, 0LL);
    v27 = Object;
    *(_QWORD *)(UserSessionState + 69088) = Object;
    if ( MirrorDriver < 0 )
      goto LABEL_24;
    if ( (unsigned int)GreConsoleShadowStart(
                         RemoteContext,
                         *(_QWORD *)(UserSessionState + 69056),
                         (int)UserSessionState + 69208,
                         *(_QWORD *)(UserSessionState + 69080),
                         (__int64)v27) )
    {
      v28 = *(void **)(UserSessionState + 69032);
      Object = 0LL;
      MirrorDriver = ObReferenceObjectByHandle(v28, 0, 0LL, 0, &Object, 0LL);
      *(_QWORD *)(UserSessionState + 69040) = Object;
      if ( MirrorDriver < 0 )
      {
LABEL_24:
        v35 = *(void **)(UserSessionState + 69080);
        if ( v35 )
        {
          ObfDereferenceObject(v35);
          *(_QWORD *)(UserSessionState + 69080) = 0LL;
        }
        v36 = *(void **)(UserSessionState + 69088);
        if ( v36 )
        {
          ObfDereferenceObject(v36);
          *(_QWORD *)(UserSessionState + 69088) = 0LL;
        }
        v37 = *(void **)(UserSessionState + 69040);
        if ( v37 )
        {
          ObfDereferenceObject(v37);
          *(_QWORD *)(UserSessionState + 69040) = 0LL;
        }
        v38 = *(void **)(UserSessionState + 69072);
        if ( v38 )
        {
      ...
      if ( MirrorDriver < 0 )
      {
        ...
        if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
          || (v30 = (unsigned int *)*(unsigned int *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL),
              ((unsigned __int8)v30 & 4) == 0)
        ...
        && !(unsigned int)xxxUserChangeDisplaySettings(0LL, 0LL, 0LL, 0LL, 0LL, 0, a3) )
      {
        ...
        *(_QWORD *)(UserSessionState + 69064) = HDEV;
        if ( HDEV )
        {
          v45 = *(_QWORD *)(UserSessionState + 69088);
          v46 = *(_QWORD *)(UserSessionState + 69056);
          *(_DWORD *)(UserSessionState + 69020) = 1;
          if ( (unsigned int)bDrvReconnect(HDEV, v46, v45, 0) )
          {
            HDXDrvEscape(*(_QWORD *)(UserSessionState + 69064), 2LL, *(_QWORD *)(UserSessionState + 69200), 8LL);
            return (unsigned int)MirrorDriver;
          }
        }
      }
