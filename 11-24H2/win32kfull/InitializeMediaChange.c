/*
 * XREFs of InitializeMediaChange @ 0x140208420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitializeMediaChange(HANDLE Handle, __int64 a2)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( ZwOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes) >= 0 )
  {
    ...
    if ( ZwQueryValueKey(
      ...
      && v18 == 4 )
    {
      *(_DWORD *)(UserSessionState + 70200) = v19;
    }
    ZwClose(KeyHandle);
  }
  v6 = *(_DWORD *)(UserSessionState + 70200);
  *(_DWORD *)(W32GetUserSessionState(v5, v4) + 320) = v6;
  ...
  {
    Object = 0LL;
    *(_QWORD *)(UserSessionState + 70152) = UserSessionState + 70144;
    *(_QWORD *)(UserSessionState + 70144) = UserSessionState + 70144;
    *(_QWORD *)(UserSessionState + 70168) = UserSessionState + 70160;
    *(_QWORD *)(UserSessionState + 70160) = UserSessionState + 70160;
    v9 = ObReferenceObjectByHandle(Handle, 0x1F0003u, (POBJECT_TYPE)ExEventObjectType, 0, &Object, 0LL);
    *(_QWORD *)(UserSessionState + 70192) = Object;
    if ( v9 >= 0 )
    {
      v10 = Win32AllocPoolNonPagedZInit(56LL, 1886417749LL);
      *(_QWORD *)(UserSessionState + 70184) = v10;
      if ( v10 )
      {
        *(_QWORD *)(v10 + 8) = 0LL;
        *(_DWORD *)(v10 + 16) = 0;
