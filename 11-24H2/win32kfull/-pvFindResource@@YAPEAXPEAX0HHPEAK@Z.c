/*
 * XREFs of ?pvFindResource@@YAPEAXPEAX0HHPEAK@Z @ 0x1401D3838
 * Callers:
 *     ?LOADSTRING@@YAHPEAXIPEAGH@Z @ 0x1401D3774 (-LOADSTRING@@YAHPEAXIPEAGH@Z.c)
 *     cParseFontResources @ 0x1401FD82C (cParseFontResources.c)
 *     EngFindResource @ 0x140300090 (EngFindResource.c)
 * Callees:
 *     <none>
 */
