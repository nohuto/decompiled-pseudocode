/*
 * XREFs of NtUserFindExistingCursorIcon @ 0x140294EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserFindExistingCursorIcon(int *a1, ULONG64 a2, ULONG64 a3)
{
  ...
  *((_QWORD *)&v25 + 1) = v10;
  ...
  {
LABEL_34:
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 7997);
LABEL_35:
    ExRaiseAccessViolation();
  }
  ...
  *(_DWORD *)&v22.Length = *(_DWORD *)a2;
  ...
  if ( ((unsigned __int64)v13 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    {
      if ( (v12 & 1) != 0 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8000);
      ExRaiseAccessViolation();
    }
  }
