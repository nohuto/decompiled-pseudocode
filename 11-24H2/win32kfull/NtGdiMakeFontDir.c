/*
 * XREFs of NtGdiMakeFontDir @ 0x14021BEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiMakeFontDir(unsigned int a1, _OWORD *a2, unsigned int a3, char *a4, size_t Size)
{
  ...
  unsigned __int16 v19[264]; // [rsp+140h] [rbp-258h] BYREF

  memset_0(v15, 0, 0xFBuLL);
  FontDir = 0;
  if ( (unsigned int)Size <= 0x20A && a3 >= 0xFB )
  {
    ...
    v19[v11] = 0;
    FontDir = GreMakeFontDir(a1, (unsigned __int8 *)v15, v19);
    if ( FontDir )
    {
