/*
 * XREFs of ?xxxSetAndDrawMinMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagMINIMIZEDMETRICS@@@Z @ 0x14011127C
 * Callers:
...
__int64 __fastcall xxxSetAndDrawMinMetrics(struct _UNICODE_STRING *a1, struct tagMINIMIZEDMETRICS *a2)
{
  ...
  v2 = a1;
  v3 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 2124LL);
  v6 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v5, v4) + 19928) + 2128LL);
  SetMinMetrics(v2);
  v9 = *(_QWORD *)(W32GetUserSessionState(v8, v7) + 19928);
  LODWORD(v2) = *(_DWORD *)(v9 + 2124);
  v11 = 0LL;
  v13 = *(_QWORD *)(W32GetUserSessionState(v9, v10) + 19928);
