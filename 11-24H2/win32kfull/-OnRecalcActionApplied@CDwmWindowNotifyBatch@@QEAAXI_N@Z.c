/*
 * XREFs of ?OnRecalcActionApplied@CDwmWindowNotifyBatch@@QEAAXI_N@Z @ 0x1402D1E6C
 * Callers:
 ...
 *     DwmAsyncApplyRecalcActionFailed @ 0x14032317C (DwmAsyncApplyRecalcActionFailed.c)
 */
