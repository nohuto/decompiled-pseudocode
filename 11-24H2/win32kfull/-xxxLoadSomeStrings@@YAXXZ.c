/*
 * XREFs of ?xxxLoadSomeStrings@@YAXXZ @ 0x140112BF8
 * Callers:
  ...
  do
  {
    ...
    *(_DWORD *)(v6 + v3 + 964) = v2 + 1;
    ...
    xxxClientLoadStringW(
      (unsigned int)(v2 + 800),
      *(_QWORD *)(UserSessionState + 19928) + 40LL * (unsigned int)v2 + 932,
      15LL);
    v3 += 40LL;
    ++v2;
  }
  while ( v2 < 11 );
  v9 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 7088LL;
