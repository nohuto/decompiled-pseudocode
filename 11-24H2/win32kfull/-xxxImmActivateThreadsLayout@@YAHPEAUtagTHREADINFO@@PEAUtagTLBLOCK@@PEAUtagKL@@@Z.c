/*
 * XREFs of ?xxxImmActivateThreadsLayout@@YAHPEAUtagTHREADINFO@@PEAUtagTLBLOCK@@PEAUtagKL@@@Z @ 0x140280010
 * Callers:
 ...
 *     EditionImmActivateThreadsLayout @ 0x1402A4F90 (EditionImmActivateThreadsLayout.c)
 * Callees:
