/*
 * XREFs of ?UserGetDwmCursorShape@Api@Cursor@InputTraceLogging@@SAXW4UserGetDwmCursorShapeResult@123@KK@Z @ 0x1402DB038
 * Callers:
...
char InputTraceLogging::Cursor::Api::UserGetDwmCursorShape()
{
  ...
  if ( result )
  {
    ...
    {
      result = tlgKeywordOn((__int64)&dword_140398B80, v1);
      if ( result )
      {
        if ( (_DWORD)v3 )
        {
