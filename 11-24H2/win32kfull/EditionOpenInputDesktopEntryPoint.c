/*
 * XREFs of EditionOpenInputDesktopEntryPoint @ 0x1401952E0
 * Callers:
 *     <none>
 * Callees:
...
HANDLE __fastcall EditionOpenInputDesktopEntryPoint(unsigned int a1, int a2, int a3)
{
  ...
  v15 = *(_DWORD *)(W32GetUserSessionState(v13, v12) + 62872)
      ? *(void **)(UserSessionState + 19208)
      : *(void **)(UserSessionState + 19200);
  if ( !v15 )
  {
LABEL_17:
    v22 = 110;
