/*
 * XREFs of NtUserAcquireIAMKey @ 0x14021CCD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SetIAMThreadInfo @ 0x14022011C (SetIAMThreadInfo.c)
 */
...
__int64 __fastcall NtUserAcquireIAMKey(_QWORD *Address)
{
  ...
  if ( !v7 || !*(_QWORD *)(v6 + 168) )
  {
    ...
    if ( !v9 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      goto LABEL_40;
    v13 = *(_QWORD *)(W32GetUserSessionState(&WPP_RECORDER_INITIALIZED, v6) + 69416);
    v16 = 44;
    goto LABEL_39;
  }
  if ( *((_QWORD *)v4 + 58) != v7 )
