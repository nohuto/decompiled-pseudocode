/*
 * XREFs of ?vStrWrite01@stretch@@YAXPEAU_STRRUN@1@PEAU_XRUNLEN@1@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1400A2950
 * Callers:
 *     <none>
 * Callees:
...
LABEL_76:
                ...
                if ( v48 )
                  *v46 = v47;
                v8 = (struct stretch::_STRRUN *)&v89[4 * *((int *)v89 + 1) + 8];
                v89 = (char *)v8;
              }
              while ( v8 != v39 );
              v30 = v91;
