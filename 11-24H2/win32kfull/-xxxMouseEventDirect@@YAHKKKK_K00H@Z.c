/*
 * XREFs of ?xxxMouseEventDirect@@YAHKKKK_K00H@Z @ 0x14022FDC8
 * Callers:
        ...
        int a8)
{
  ...
  {
    if ( *((_QWORD *)v12 + 62) != *(_QWORD *)(W32GetUserSessionState(v14, v13) + 19200) )
    {
...
LABEL_19:
    ...
    if ( !(unsigned int)CheckGrantedAccess(*((_DWORD *)v12 + 234), 0x20u) )
    {
      ...
      if ( PsGetCurrentProcess(v24) != v23 )
      {
        ...
        if ( !v15 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          return 0LL;
        v20 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v25) + 69416);
        v76 = 25;
        goto LABEL_19;
      }
      v11 = a;
    }
    if ( *(_QWORD *)(W32GetUserSessionState(v22, v21) + 19000)
      && *(struct tagTHREADINFO **)(W32GetUserSessionState(v27, v26) + 19000) != v12 )
    {
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
        || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 0x80000) == 0
      ...
      if ( !v28 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        return 1LL;
      v32 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v26) + 69416);
      v77 = 26;
      goto LABEL_38;
    }
    if ( !(unsigned int)IsGpqForegroundAccessibleCurrent(1LL, v26) )
    {
      ...
      if ( !v28 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        return 1LL;
      v32 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v35) + 69416);
      v77 = 27;
LABEL_38:
      LOBYTE(v31) = v29;
      LOBYTE(v30) = v28;
  ...
  v38 = *((_QWORD *)v12 + 58);
  *(_QWORD *)(W32GetUserSessionState(v40, v39) + 18888) = v38;
  ...
  if ( (a4 & 0xC001) != 0xC001
    ...
    || ***(_DWORD ***)(W32GetUserSessionState(v57, v56) + 57008) <= 1u )
  {
    v69 = a;
  }
  else
  ...
  if ( !(unsigned int)Feature_UIPIAlwaysOn2__private_IsEnabledDeviceUsageNoInline(v71) )
  ...
  if ( (*(_DWORD *)(W32GetUserSessionState(v74, v73) + 67056) & 0x100) != 0 )
