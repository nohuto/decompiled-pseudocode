/*
 * XREFs of TouchTargetingCreateContact @ 0x1401B4948
 * Callers:
...
__int64 __fastcall TouchTargetingCreateContact(__int64 a1, int *a2, __int64 a3, int *a4)
{
  ...
  *(_OWORD *)a4 = *(_OWORD *)(a1 + 28);
  ...
  _TTAdjustContactSide(*(_DWORD *)(a1 + 4), v4, a4 + 6, v10);
  _TTAdjustContactSide(*(_DWORD *)(a1 + 4), a4, a4 + 2, *v5);
  _TTAdjustContactSide(*(_DWORD *)(a1 + 8), a4 + 5, a4 + 7, *v9);
  ...
  v16 = *v34;
  v17 = v15 - *v34;
  if ( v17 < 4 || (v18 = a4[5], a4[7] - v18 < 4) )
  {
    v33 = a4[5];
    result = (unsigned int)a4[7];
    a4[11] = 4;
    a4[12] = v16;
    a4[13] = v33;
    a4[14] = v16;
