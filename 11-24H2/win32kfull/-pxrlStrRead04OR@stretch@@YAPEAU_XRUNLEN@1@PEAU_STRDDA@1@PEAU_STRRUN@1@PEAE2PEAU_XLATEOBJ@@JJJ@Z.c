/*
 * XREFs of ?pxrlStrRead04OR@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140312A50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *((_DWORD *)a2 + 3) = *((_DWORD *)this + 2) - v11;
  if ( (int)a6 < a7 )
  {
    ...
    if ( a5 )
    {
      ...
      while ( 1 )
      {
        v28 = *(_DWORD *)(*((_QWORD *)a5 + 2)
                        + 4 * ((unsigned __int64)(v15 & (unsigned int)dword_140361A58[v27]) >> dword_140361A38[v27]));
    ...
    else
    {
      ...
      while ( 1 )
      {
        v19 = (v15 & (unsigned int)dword_140361A58[v17]) >> dword_140361A38[v17];
        v20 = *v18++;
        if ( (_DWORD)v20 )
        {
          v13 += v20;
