/*
 * XREFs of DxgkEngDetectGDIPath @ 0x1403252A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StateFlags@PDEVOBJ@@QEBAKXZ @ 0x1403250B4 (-StateFlags@PDEVOBJ@@QEBAKXZ.c)
 */
  ...
  if ( ((_DWORD)a2[10] & 0x20000) != 0 )
  {
    ...
    for ( i = 0LL; ; i = v14 )
    {
      ...
      if ( *(HDEV *)(v13 + 24) == a2 && (*(_DWORD *)(v13 + 40) & 0x20400) == 0 && !v9 )
      {
        ...
        {
          if ( *(_QWORD *)(*((_QWORD *)v14 + 321) + 232LL) == a1 && *((_DWORD *)v14 + 536) > 8u )
