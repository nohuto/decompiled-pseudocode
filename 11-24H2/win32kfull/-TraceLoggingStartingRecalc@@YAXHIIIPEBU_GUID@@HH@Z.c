/*
 * XREFs of ?TraceLoggingStartingRecalc@@YAXHIIIPEBU_GUID@@HH@Z @ 0x1401CB878
 * Callers:
        ...
        int a7)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 63464) )
    v15 = DWORD2(v14) - *(_DWORD *)(UserSessionState + 63464);
  else
    v15 = 0;
  *(_QWORD *)(UserSessionState + 63464) = *((_QWORD *)&v14 + 1);
