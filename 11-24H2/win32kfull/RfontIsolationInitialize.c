/*
 * XREFs of RfontIsolationInitialize @ 0x140332360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Destroy@?$CTypeIsolation@$0DKAAA@$0DKA@@NSInstrumentation@@SAXPEAV12@@Z @ 0x140332330 (-Destroy@-$CTypeIsolation@$0DKAAA@$0DKA@@NSInstrumentation@@SAXPEAV12@@Z.c)
 */
...
LABEL_4:
  ...
  *(_QWORD *)(*((_QWORD *)v1 + 534) + 40LL) = v4;
  LOBYTE(v3) = *(_QWORD *)(*((_QWORD *)v1 + 534) + 40LL) != 0LL;
  return v3;
}
