/*
 * XREFs of ?xxxDisplayChangedHandler@CallShell@@YA_NPEAU_SYNC_DISPLAY_CHANGE_DATA@@@Z @ 0x14020B418
 * Callers:
...
bool __fastcall CallShell::xxxDisplayChangedHandler(CallShell *this, struct _SYNC_DISPLAY_CHANGE_DATA *a2)
{
  ...
  v3 = 0;
  v35 = 0;
  for ( i = *(_QWORD **)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(this, a2) + 19200) + 40LL) + 16LL);
        ;
        i = (_QWORD *)i[4] )
  {
    if ( !i )
