/*
 * XREFs of ?RestorePendingDisplayChangeInfo@CInterceptWindowProp@@SA_NPEAUtagWND@@_NIPEAVCWindowAction@AdvancedWindowPos@@PEAW4ApplyWindowActionError@4@@Z @ 0x1402CAB58
 * Callers:
        ...
        enum AdvancedWindowPos::ApplyWindowActionError *a5)
{
  ...
  if ( !a2 )
  {
    ...
    v16 = *(_DWORD *)(*(_QWORD *)(UserSessionState + 19928) + 7500LL);
    *(_DWORD *)a4 |= 0x200u;
LABEL_12:
    *v17 |= 0x10000u;
    goto LABEL_13;
