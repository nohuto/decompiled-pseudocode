/*
 * XREFs of ?bSrcCopySRLE8D1@@YAHPEAUBLTINFO@@@Z @ 0x1403176F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE8D1(struct BLTINFO *a1)
{
  ...
  if ( v8 < v2 )
  {
    if ( v8 < v6 )
    {
      v10 = byte_140361B60[v2 & 7] & *(_BYTE *)(((unsigned int)v2 >> 3) + v4);
      goto LABEL_10;
    }
    goto LABEL_8;
  }
...
LABEL_8:
  ...
  v10 = byte_140361B60[v8 & 7] & *(_BYTE *)((unsigned int)(v8 >> 3) + v4);
LABEL_10:
  v12 = 1;
  for ( i = 1LL; i < 256; ++i )
  {
...
LABEL_94:
      ...
      if ( v7 < v14 && (v8 & 7) != 0 )
      {
        ...
        {
          v2 = v49;
          *(_BYTE *)(v17 + v4) = v10 | *(_BYTE *)(v17 + v4) & ~byte_140361B60[v8 & 7];
LABEL_63:
          v14 = v61;
          goto LABEL_64;
        }
