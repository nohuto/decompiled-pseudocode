/*
 * XREFs of ?bWiden@WIDENER@pathwide@@IEAAHXZ @ 0x1400EA4E0
 * Callers:
 ...
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@pathwide@@QEAAXXZ @ 0x1400EBEA8 (-vPrependBeforeFigure@WIDEPATHOBJ@pathwide@@QEAAXXZ.c)
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@pathwide@@QEAAXXZ @ 0x1402251CC (-vPrependBeforeSubpath@WIDEPATHOBJ@pathwide@@QEAAXXZ.c)
 */
