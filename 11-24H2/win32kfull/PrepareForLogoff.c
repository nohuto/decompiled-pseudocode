/*
 * XREFs of PrepareForLogoff @ 0x14020FBCC
 * Callers:
 *     NtUserPrepareForLogoff @ 0x14020FB90 (NtUserPrepareForLogoff.c)
 * Callees:
 *     ?PtiCurrent@@YAPEAUtagTHREADINFO@@XZ @ 0x140048610 (-PtiCurrent@@YAPEAUtagTHREADINFO@@XZ.c)
 *     PopAndFreeAlwaysW32ThreadLock @ 0x14011349C (PopAndFreeAlwaysW32ThreadLock.c)
 *     RegisterPerUserKeyboardIndicators @ 0x140218B14 (RegisterPerUserKeyboardIndicators.c)
...
__int64 __fastcall PrepareForLogoff(__int64 a1, __int64 a2)
{
  ...
  if ( tagPROCESSINFO::HasUILimit(*((tagPROCESSINFO **)v2 + 58), 0x80u) )
    return 0LL;
LABEL_3:
  v5 = *(HANDLE *)(W32GetUserSessionState(v4, v3) + 63584);
  if ( PsGetThreadProcessId(*(PETHREAD *)v2) == v5 && !*(_WORD *)(W32GetUserSessionState(v7, v6) + 69008) )
  {
    v8 = *(_QWORD *)(*((_QWORD *)v2 + 58) + 656LL);
    if ( v8 )
    {
