/*
 * XREFs of ?FixupCursorForMonitor@@YAPEAUtagCURSOR@@PEAU1@@Z @ 0x140076A4C
 * Callers:
...
struct tagCURSOR *__fastcall FixupCursorForMonitor(struct tagCURSOR *a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    CurrentCursorSize = CCursorSizes::GetCurrentCursorSize(*(CCursorSizes **)(UserSessionState + 36400));
    v7 = *((_QWORD *)v2 + 6);
