/*
 * XREFs of ?SecondaryHitTest@Mouse@InputTraceLogging@@SAXPEBUtagQMSG@@AEBUtagPOINT@@PEAUtagWND@@@Z @ 0x140176A2C
 * Callers:
        ...
        struct tagWND *a3)
{
  ...
  if ( dword_140398B80 )
  {
    if ( (qword_140398B90 & 0x40) != 0 && (qword_140398B98 & 0x40) == qword_140398B98 )
    {
      WindowDetails = InputTraceLogging::GetWindowDetails((__int64)v26, (__int64)a3);
