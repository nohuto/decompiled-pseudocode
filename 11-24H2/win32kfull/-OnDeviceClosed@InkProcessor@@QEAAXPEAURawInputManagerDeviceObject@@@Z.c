/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1402EA77C
 * Callers:
 ...
 *     ?OnDeviceClosed@RimBackedDeviceBase@@UEAAXXZ @ 0x1402EDAB0 (-OnDeviceClosed@RimBackedDeviceBase@@UEAAXXZ.c)
 */
