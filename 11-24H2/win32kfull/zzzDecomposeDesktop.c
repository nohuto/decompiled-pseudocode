/*
 * XREFs of zzzDecomposeDesktop @ 0x140131E78
 * Callers:
...
__int64 __fastcall zzzDecomposeDesktop(struct tagDESKTOP *a1, int a2)
{
  ...
  if ( (*(_DWORD *)(**((_QWORD **)a1 + 1) + 64LL) & 1) != 0 )
  {
    ...
    MagpDecomposeDesktop(UserSessionState + 66080, a1);
    v6 = 0LL;
    W32GetUserSessionState(v8, v7);
    do
    {
      v11 = *(_QWORD *)(W32GetUserSessionState(v10, v9) + 19944) + 32LL * (unsigned int)v6;
      v15 = *(_QWORD *)(W32GetUserSessionState(v13, v12) + 19888);
      if ( *(_BYTE *)(v11 + 24) == 1 )
      {
