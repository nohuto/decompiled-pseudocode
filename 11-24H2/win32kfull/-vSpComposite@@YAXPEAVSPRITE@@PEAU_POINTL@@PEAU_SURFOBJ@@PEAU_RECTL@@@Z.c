/*
 * XREFs of ?vSpComposite@@YAXPEAVSPRITE@@PEAU_POINTL@@PEAU_SURFOBJ@@PEAU_RECTL@@@Z @ 0x14004F4C0
 * Callers:
...
LABEL_26:
        ...
        {
          if ( !(unsigned int)EXLATEOBJ::bInitXlateObj((Gre::Base *)&v65, 0LL, 0, v18, v24, v21, v21, 0, 0, 0, 0) )
            goto LABEL_148;
          v23 = v65;
...
LABEL_148:
        ...
        *(_OWORD *)v73 = 0LL;
        ...
        v70 = 0LL;
        v69 = 0LL;
        if ( !(unsigned int)EXLATEOBJ::bInitXlateObj((Gre::Base *)&v64, 0LL, 0, v18, v22, v21, v21, 0, 0, 0, 0)
          || !(unsigned int)EXLATEOBJ::bInitXlateObj((Gre::Base *)&v70, 0LL, 0, v24, v22, v21, v21, 0, 0, 0, 0)
          || !(unsigned int)EXLATEOBJ::bInitXlateObj((Gre::Base *)&v69, 0LL, 0, v22, v24, v21, v21, 0, 0, 0, 0) )
        {
LABEL_147:
