/*
 * XREFs of SfnSHELLWINDOWMANAGEMENTCALLOUT @ 0x1401E62E0
 * Callers:
...
ULONG_PTR __fastcall SfnSHELLWINDOWMANAGEMENTCALLOUT(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        __int128 *a4,
        ...
        __int64 a8)
{
  ...
  __int64 v24; // rcx
  void *v25; // rbx
  int v27[6]; // [rsp+30h] [rbp-1B8h] BYREF
  void *Src; // [rsp+48h] [rbp-1A0h] BYREF
  ULONG_PTR v29[2]; // [rsp+50h] [rbp-198h] BYREF
  char v30[8]; // [rsp+60h] [rbp-188h] BYREF
  __int128 v31; // [rsp+68h] [rbp-180h]
  __int64 v32; // [rsp+78h] [rbp-170h]
  ULONG_PTR BugCheckParameter3[7]; // [rsp+80h] [rbp-168h] BYREF
  _OWORD v34[6]; // [rsp+B8h] [rbp-130h] BYREF
  __int64 v35; // [rsp+118h] [rbp-D0h]
  __int64 v36; // [rsp+120h] [rbp-C8h] BYREF
  int v37; // [rsp+128h] [rbp-C0h]
  __int64 v38; // [rsp+130h] [rbp-B8h]
  __int128 v39; // [rsp+138h] [rbp-B0h]
  __int128 v40; // [rsp+148h] [rbp-A0h]
  __int128 v41; // [rsp+158h] [rbp-90h]
  __int128 v42; // [rsp+168h] [rbp-80h]
  __int128 v43; // [rsp+178h] [rbp-70h]
  __int128 v44; // [rsp+188h] [rbp-60h]
  __int64 v45; // [rsp+198h] [rbp-50h]
  __int64 v46; // [rsp+1A0h] [rbp-48h]
  __int64 v47; // [rsp+1A8h] [rbp-40h]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 65) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(53LL, &v36, 144LL, &Src, v27);
  ...
  *(_QWORD *)(v20 + 80) = v32;
  if ( v18 >= 0 && v27[0] == 24 )
  {
    ...
    if ( !v24 || (*(_DWORD *)(v24 + 84) & 1) == 0 || *(__int128 **)(v24 + 96) != a4 )
    {
      ...
      RtlCopyFromUser(v34, v25, 0x68uLL);
      *a4 = v34[0];
      a4[1] = v34[1];
      a4[2] = v34[2];
      a4[3] = v34[3];
