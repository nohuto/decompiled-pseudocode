/*
 * XREFs of ?bSetPreviewRectContent@@YAHPEAU_SPRITESTATE@@PEBU_RECTL@@@Z @ 0x140329B5C
 * Callers:
...
__int64 __fastcall bSetPreviewRectContent(struct _SPRITESTATE *a1, const struct _RECTL *a2)
{
  ...
  CompatibleDC = GreCreateCompatibleDC(*(_QWORD *)(*(_QWORD *)(UserSessionState + 57008) + 64LL));
  v8 = (HDC)CompatibleDC;
  if ( CompatibleDC )
  {
