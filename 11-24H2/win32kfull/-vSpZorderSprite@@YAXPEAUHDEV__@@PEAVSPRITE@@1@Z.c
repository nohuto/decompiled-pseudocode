/*
 * XREFs of ?vSpZorderSprite@@YAXPEAUHDEV__@@PEAVSPRITE@@1@Z @ 0x14016D018
 * Callers:
 ...
 *     ?vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z @ 0x14016D268 (-vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z.c)
...
void __fastcall vSpZorderSprite(HDEV a1, struct SPRITE *a2, struct SPRITE *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // rcx
  struct _SPRITESTATE *v14[24]; // [rsp+20h] [rbp-D8h] BYREF
  ...
  SPRITEDDIACCESS::~SPRITEDDIACCESS(v14, v8);
}
