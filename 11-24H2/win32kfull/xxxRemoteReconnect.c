/*
 * XREFs of xxxRemoteReconnect @ 0x14024FFF8
 * Callers:
 *     NtUserRemoteReconnect @ 0x14029BAF0 (NtUserRemoteReconnect.c)
 * Callees:
 ...
 *     GreMultiUserSetDisplayDriverName @ 0x1402039CC (GreMultiUserSetDisplayDriverName.c)
 ...
 *     DrvOpenLocalGraphicsDevices @ 0x14021ED7C (DrvOpenLocalGraphicsDevices.c)
 *     InitKeyboard @ 0x14021F0C0 (InitKeyboard.c)
 *     ?DrvGetRemoteDeviceCount@@YAIXZ @ 0x140225110 (-DrvGetRemoteDeviceCount@@YAIXZ.c)
...
__int64 __fastcall xxxRemoteReconnect(_DWORD *Src)
{
  ...
  v8 = UserSessionState + 68696;
  v142 = *(_WORD *)(UserSessionState + 69008);
...
LABEL_16:
  ...
  *(_OWORD *)(v35 + 64160) = v161;
  *(_OWORD *)(v35 + 64176) = v162;
  *(_OWORD *)(v35 + 64192) = v163;
  *(_OWORD *)(v35 + 64208) = v164;
  *(_OWORD *)(v35 + 63600) = v166;
  *(_WORD *)(v35 + 63616) = v167;
  *(_OWORD *)(v35 + 63620) = v168;
  *(_DWORD *)(v35 + 63636) = v169;
  v36 = wcschr((const wchar_t *)(v35 + 64160), 0x23u);
  if ( v36 )
    *v36 = 0;
  if ( !IsRemoteConnection(v38, v37) || (FastGetProfileIntW(0LL, 39LL, L"CursorBlinkEnable", 0LL, &v140, 0), v140) )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(v43 + 19928) + 2236LL) |= 4u;
  }
  else
  {
    v41 = W32GetUserSessionState(v40, v39);
    *(_DWORD *)(*(_QWORD *)(v41 + 19928) + 2236LL) &= ~4u;
  }
...
LABEL_29:
    ...
    if ( v27 < 0 )
      goto LABEL_86;
    if ( *(_DWORD *)(W32GetUserSessionState(v58, v42) + 69160) )
    ...
    if ( !v138 || (unsigned int)GreMultiUserSetDisplayDriverName(RemoteContext, v178.Data1 - 1, v138) )
    {
      ...
      v27 = xxxRemoteSetDisconnectDisplayMode(*(struct tagDESKTOP **)(v63 + 19200), v62, v148);
      if ( v27 < 0 )
        goto LABEL_86;
      if ( v153[72] )
...
LABEL_54:
        ...
        if ( !*(_WORD *)(W32GetUserSessionState(v65, v64) + 69008) )
        ...
        else
        {
          v69 = 1;
          v139 = 1;
          if ( !*(_WORD *)(W32GetUserSessionState(v67, v66) + 69008) )
          {
        ...
        if ( v70 )
        {
          ...
          v27 = 0;
          if ( (unsigned int)DrvIsNotUsingGraphicsDevice(*(_QWORD *)(*(_QWORD *)(v75 + 57008) + 16LL)) )
          {
          ...
          {
            v83 = *(_QWORD *)(W32GetUserSessionState(v78, v77) + 19208);
            if ( v176 || (v92 = *(_WORD *)(W32GetUserSessionState(v82, v81) + 69008) == 0, v84 = 2191, v92) )
              v84 = 2447;
            LOBYTE(HandleInformation) = 0;
...
LABEL_133:
            ...
            RemoteRedrawScreen((void **)(v107 + 19208), v108);
            InitKeyboard(v110, v109);
            UpdateKeyLights(0LL);
            SetPointer(1LL);
            *(_DWORD *)(W32GetUserSessionState(v112, v111) + 36396) = 9;
            TransitionCursorSuppressionState(10LL, 0LL);
            if ( *(_DWORD *)(W32GetUserSessionState(v114, v113) + 36396) == 1
              || *(_DWORD *)(W32GetUserSessionState(v116, v115) + 36396) == 5 )
            {
              v104 = *(_DWORD *)(W32GetUserSessionState(v116, v115) + 36396);
            }
            ...
            v123 = *(_WORD *)(W32GetUserSessionState(v122, v121) + 69008);
            ...
            LOBYTE(v134) = *(_WORD *)(W32GetUserSessionState(v133, v132) + 69008) == 0;
            LOBYTE(v135) = 1;
        ...
        if ( *(_DWORD *)(v8 + 464) )
        {
          ...
          RemoteRedrawScreen((void **)(v73 + 19208), v74);
        }
      }
    }
    v27 = -1073741823;
...
LABEL_87:
  ...
  if ( v92 && !*(_WORD *)(W32GetUserSessionState(v91, v90) + 69008) )
  {
    CurrentWin32kSessionId = W32GetCurrentWin32kSessionId();
    RtlSetActiveConsoleId(CurrentWin32kSessionId);
  }
  if ( !*(_WORD *)(W32GetUserSessionState(v91, v90) + 69008) )
