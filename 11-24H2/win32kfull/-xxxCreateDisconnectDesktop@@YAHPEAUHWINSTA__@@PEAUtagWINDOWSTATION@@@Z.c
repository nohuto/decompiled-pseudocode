/*
 * XREFs of ?xxxCreateDisconnectDesktop@@YAHPEAUHWINSTA__@@PEAUtagWINDOWSTATION@@@Z @ 0x140163C44
 * Callers:
...
__int64 __fastcall xxxCreateDisconnectDesktop(HWINSTA a1, struct tagWINDOWSTATION *a2)
{
  ...
  if ( (int)SetDisconnectDesktopSecurity((HDESK)Handle) < 0
    || (UserSessionState = W32GetUserSessionState(v6, v5),
        ...
        v13 = Object,
        *(_QWORD *)(UserSessionState + 63024) = Object,
        v11 < 0) )
  {
    GreDeleteObject(EmptyRgnPublic);
    CloseDesktop(Handle);
    *(_QWORD *)(W32GetUserSessionState(v8, v7) + 63024) = 0LL;
    return 0LL;
  }
  v14 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v13, v12) + 63024) + 8LL) + 24LL);
  *(_QWORD *)(*(_QWORD *)(v14 + 40) + 168LL) = EmptyRgnPublic;
  ...
  v18 = (void **)(W32GetUserSessionState(v17, v16) + 69144);
  v21 = W32GetUserSessionState(v20, v19);
  v24 = ObOpenObjectByPointer(*(PVOID *)(v21 + 63024), 0x200u, 0LL, 0x1F0003u, 0LL, 0, v18);
  if ( v24 >= 0 )
  {
    v27 = W32GetUserSessionState(v23, v22);
    v24 = ObOpenObjectByPointer(a2, 0, 0LL, 0x1F0003u, 0LL, 0, (PHANDLE)(v27 + 69152));
  }
  KeDetachProcess();
  if ( v24 < 0 )
  {
    v28 = W32GetUserSessionState(v26, v25);
    tagWND::ClearClipRgnOrMaxClip(*(tagWND **)(*(_QWORD *)(*(_QWORD *)(v28 + 63024) + 8LL) + 24LL));
    if ( *v18 )
    {
      ObCloseHandle(*v18, 0);
      *v18 = 0LL;
