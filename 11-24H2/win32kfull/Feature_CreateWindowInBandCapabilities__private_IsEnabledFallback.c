/*
 * XREFs of Feature_CreateWindowInBandCapabilities__private_IsEnabledFallback @ 0x1402B4738
 * Callers:
 *     Feature_CreateWindowInBandCapabilities__private_IsEnabledDeviceUsageNoInline @ 0x1402B4700 (Feature_CreateWindowInBandCapabilities__private_IsEnabledDeviceUsageNoInline.c)
 * Callees:
