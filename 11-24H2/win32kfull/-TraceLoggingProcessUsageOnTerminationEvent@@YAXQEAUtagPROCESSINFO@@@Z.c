/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1401C1790
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1401C1760 (DestroyProcessInfoEditionRundown.c)
 * Callees:
