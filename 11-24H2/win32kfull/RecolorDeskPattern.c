/*
 * XREFs of RecolorDeskPattern @ 0x1402055C0
 * Callers:
...
__int64 __fastcall RecolorDeskPattern(__int64 a1, __int64 a2)
{
  ...
  __int64 v63; // rax
  __int64 v64; // rax
  unsigned int v66[3]; // [rsp+78h] [rbp+7h] BYREF
  ...
  v2 = 0;
  if ( *(_QWORD *)(W32GetUserSessionState(a1, a2) + 62840) )
  {
    v5 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 62840);
    UserSessionState = W32GetUserSessionState(v7, v6);
    v9 = GreSelectBitmap(*(_QWORD *)(UserSessionState + 43288), v5);
    v13 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19928);
    if ( *(_DWORD *)(v13 + 2220) )
    {
      v30 = W32GetUserSessionState(v13, v12);
      CompatibleBitmap = (__int64)GreCreateCompatibleBitmapEx(
                                    *(HDC *)(*(_QWORD *)(v30 + 57008) + 72LL),
                                    8,
                                    8,
                                    0,
                                    0LL,
    ...
    else
    {
      ...
      v75 = *(_BYTE *)(v20 + 4602);
      v22 = *(_QWORD *)(W32GetUserSessionState(v20, v21) + 19928);
    ...
    if ( CompatibleBitmap )
    {
      ...
      v33 = GreSelectBitmap(*(_QWORD *)(v32 + 43296), v31);
      v36 = *(_QWORD *)(W32GetUserSessionState(v35, v34) + 19928);
      v37 = *(_DWORD *)(v36 + 4572);
      v39 = W32GetUserSessionState(v36, v38);
      GreSetTextColor(*(HDC *)(v39 + 43296), v37);
      v42 = *(_QWORD *)(W32GetUserSessionState(v41, v40) + 19928);
      v43 = *(_DWORD *)(v42 + 4600);
      v45 = W32GetUserSessionState(v42, v44);
      GreSetBkColor(*(HDC *)(v45 + 43296), v43);
      v48 = *(HDC *)(W32GetUserSessionState(v47, v46) + 43288);
      v51 = W32GetUserSessionState(v50, v49);
      GreBitBltInternal(*(HDC *)(v51 + 43296), 0, 0, 8, 8, v48, 0, 0, 0xCC0020u, 0, 0);
      PatternBrush = GreCreatePatternBrush(v31);
      if ( PatternBrush )
      {
        v56 = *(_QWORD *)(W32GetUserSessionState(v53, v52) + 19928);
        if ( *(_QWORD *)(v56 + 4704) )
        {
          v57 = W32GetUserSessionState(v56, v55);
          GreMarkDeletableBrush(*(HBRUSH *)(*(_QWORD *)(v57 + 19928) + 4704LL));
          v60 = W32GetUserSessionState(v59, v58);
          GreDeleteObject(*(_QWORD *)(*(_QWORD *)(v60 + 19928) + 4704LL));
        }
        GreMarkUndeletableBrush(PatternBrush);
        GreSetBrushOwner(PatternBrush, 0LL);
        v2 = 1;
        v53 = *(_QWORD *)(W32GetUserSessionState(v62, v61) + 19928);
        *(_QWORD *)(v53 + 4704) = PatternBrush;
      }
      v63 = W32GetUserSessionState(v53, v52);
      GreSelectBitmap(*(_QWORD *)(v63 + 43296), v33);
      GreDeleteObject(v31);
    }
    v64 = W32GetUserSessionState(v29, v28);
    GreSelectBitmap(*(_QWORD *)(v64 + 43288), v9);
  }
  return v2;
}
