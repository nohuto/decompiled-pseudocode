/*
 * XREFs of ?LoadElement@MULTIBRUSH@@QEAAXPEAU_DISPSURF@@PEAVSURFACE@@@Z @ 0x140054C64
 * Callers:
        ...
        || (v14 = (unsigned int)v13[7], (_DWORD)v14 == -1) )
      {
        ...
        else
        {
          ...
          if ( v16 && (v17 & 0x3000000) == 0 && (*(_DWORD *)(v11 + 2156) & 0x100) != 0 )
            NearestIndexFromColorref = XEPALOBJ::ulDispatchGFPEFunction(&v20, *(unsigned int *)(v16 + 96), v17);
          else
