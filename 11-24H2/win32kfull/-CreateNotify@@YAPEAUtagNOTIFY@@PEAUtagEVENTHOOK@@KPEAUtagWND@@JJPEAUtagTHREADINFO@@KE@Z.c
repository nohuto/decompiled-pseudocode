/*
 * XREFs of ?CreateNotify@@YAPEAUtagNOTIFY@@PEAUtagEVENTHOOK@@KPEAUtagWND@@JJPEAUtagTHREADINFO@@KE@Z @ 0x140154E0C
 * Callers:
        ...
        unsigned __int8 a8)
{
  ...
  {
    *(_DWORD *)(v15 + 70952) = 1;
    v18 = (struct tagNOTIFY *)(v15 + 70880);
  }
  *((_QWORD *)v18 + 2) = 0LL;
  if ( !a8 )
  {
  ...
  *((_QWORD *)v18 + 8) = 0LL;
  ...
  v24 = *(struct tagNOTIFY ***)(v16 + 70872);
  if ( *v24 != (struct tagNOTIFY *)(v16 + 70864) )
    __fastfail(3u);
  *(_QWORD *)v18 = v16 + 70864;
  *((_QWORD *)v18 + 1) = v24;
  *v24 = v18;
  *(_QWORD *)(v16 + 70872) = v18;
  return v18;
}
