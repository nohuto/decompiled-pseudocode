/*
 * XREFs of ?DiscardPointerMessage@@YA?AW4tagINPUTMESSAGE_RETRIEVE_RETVAL@@PEAUtagTHREADINFO@@PEAUtagQMSG@@PEAUtagWND@@PEAUtagMSG@@@Z @ 0x1401B9B24
 * Callers:
...
__int64 __fastcall DiscardPointerMessage(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)(v13 + 88) == a2 )
    *(_QWORD *)(v13 + 88) = 0LL;
  DelQEntry(*(_QWORD *)(a1 + 472) + 24LL, (__int64 *)a2, 1);
  return v11;
}
