/*
 * XREFs of ?vSrcCopyS24D8@@YAXPEAUBLTINFO@@@Z @ 0x14010BDC0
 * Callers:
 ...
 * Callees:
 *     ?XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z @ 0x14010C070 (-XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z.c)
 *     ?XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z @ 0x14010C974 (-XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z.c)
 */
  ...
  if ( Xlate555 )
  {
    while ( 1 )
    {
      ...
      if ( v9 )
      {
        ...
        do
        {
          v13 = XLATEOBJ_RGB32ToPalSurf(v24, Xlate555, v11[2] | ((v11[1] | (*v11 << 8)) << 8));
          v14 = XLATEOBJ_RGB32ToPalSurf(v24, Xlate555, v11[5] | ((v11[4] | (v11[3] << 8)) << 8));
          v15 = XLATEOBJ_RGB32ToPalSurf(v24, Xlate555, v11[8] | ((v11[7] | (v11[6] << 8)) << 8));
          v16 = v11[10];
          v17 = v11[9];
          v18 = v11[11];
          v11 += 12;
