/*
 * XREFs of ?xxxApplyActionAsync@WindowActions@@YAXPEAUtagWND@@PEAVCMonitorTopology@@U_WINDOW_ACTION@@@Z @ 0x1402CC99C
 * Callers:
...
void __fastcall WindowActions::xxxApplyActionAsync(struct tagWND *a1, unsigned int *a2, struct _WINDOW_ACTION *a3)
{
  ...
  v13 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 19200) + 48LL) & 0x400;
  v14 = *(_DWORD *)a3 & 0x400;
