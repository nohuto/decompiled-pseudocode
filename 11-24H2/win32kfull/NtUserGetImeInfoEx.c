/*
 * XREFs of NtUserGetImeInfoEx @ 0x140103660
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x14005FE74 (UserSetLastError.c)
 *     _GetProcessWindowStation @ 0x1401038C0 (_GetProcessWindowStation.c)
 *     ?GetImeInfoEx@@YAHPEAUtagWINDOWSTATION@@PEAUtagIMEINFOEX@@W4_IMEINFOEXCLASS@@@Z @ 0x14010390C (-GetImeInfoEx@@YAHPEAUtagWINDOWSTATION@@PEAUtagIMEINFOEX@@W4_IMEINFOEXCLASS@@@Z.c)
...
__int64 __fastcall NtUserGetImeInfoEx(ULONG64 a1, unsigned int a2)
{
  ...
  if ( (**(_DWORD **)(W32GetUserSessionState(v4, v3) + 19928) & 4) != 0 )
  {
    v5 = (_BYTE *)a1;
