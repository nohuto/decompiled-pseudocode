/*
 * XREFs of ?xxxDiscardPointerWindowFrameMessages@@YAHPEAUtagTHREADINFO@@_K@Z @ 0x1400A98DC
 * Callers:
...
__int64 __fastcall xxxDiscardPointerWindowFrameMessages(struct tagTHREADINFO *a1, unsigned __int64 a2)
{
  ...
  HwndReference = CTouchProcessor::GetHwndReference(*(CTouchProcessor **)(UserSessionState + 3264), a2, &v66, &v58);
