/*
 * XREFs of xxxSnapWindow @ 0x1402641A0
 * Callers:
...
__int64 __fastcall xxxSnapWindow(__int64 a1, __int64 a2)
{
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  if ( v7 == *(_QWORD *)(W32GetUserSessionState(v9, v8) + 63016) )
  {
LABEL_6:
    if ( v45 != -1 )
...
LABEL_44:
    ...
    if ( DCEx
      ...
      && ((v33 = *(_QWORD *)(W32GetUserSessionState(v29, v31) + 19928), !*(_DWORD *)(v33 + 2220))
        ? (W32GetUserSessionState(v33, v32), Bitmap = (HBITMAP)GreCreateBitmap(v22, v23, 1LL))
        : (Bitmap = GreCreateCompatibleBitmapEx(v30, v22, v23, 0, 0LL, 0LL)),
          (v35 = (char *)Bitmap) != 0LL || (v35 = (char *)GreCreateBitmap(v22, v23, 1LL)) != 0LL) )
    {
      v43[0] = GreSelectBitmap(CompatibleDC, v35);
      if ( !v49
        && (v36 = *((_QWORD *)v51 + 62), v37 = *(_QWORD *)(v36 + 8), v3 == *(_QWORD **)(v37 + 24))
        && (unsigned int)UserIsCurrentProcessImmersiveAppContainer(v36, v37) )
      {
        LOBYTE(v50) = 1;
      ...
      if ( v18 )
      {
        SetClipboardData(2u, v35, 0, 1);
        if ( (*(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v41, v40) + 19928) + 7004LL) & 1) != 0 )
        {
          v51 = 0LL;
          v50 = 0LL;
