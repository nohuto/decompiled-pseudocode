/*
 * XREFs of ?OnApplyWindowActionReRunRequest@CRecalcProp@@QEAA_NPEAUtagWND@@@Z @ 0x1402C3074
 * Callers:
...
char __fastcall CRecalcProp::OnApplyWindowActionReRunRequest(CRecalcProp *this, struct tagWND *a2)
{
  ...
  if ( *((_DWORD *)this + 6) != 1 )
  {
    ...
    if ( !v2 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v16 = *(_QWORD *)a2;
    v7 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, a2) + 69416);
    v15 = 90;
LABEL_17:
    LOBYTE(v6) = v4;
    LOBYTE(v5) = v2;
