/*
 * XREFs of ?DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z @ 0x14007E6B8
 * Callers:
 ...
 * Callees:
 *     ?DT_GetLongChar@@YAKPEBGHH@Z @ 0x1402083AC (-DT_GetLongChar@@YAKPEBGHH@Z.c)
 *     Feature_Servicing_ComponentServicesFreeze__private_IsEnabledDeviceUsageNoInline @ 0x1402F27FC (Feature_Servicing_ComponentServicesFreeze__private_IsEnabledDeviceUsageNoInline.c)
 */
