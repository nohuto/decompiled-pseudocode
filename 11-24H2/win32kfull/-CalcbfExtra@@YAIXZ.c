/*
 * XREFs of ?CalcbfExtra@@YAIXZ @ 0x1402184E8
 * Callers:
...
__int64 __fastcall CalcbfExtra(__int64 a1, __int64 a2)
{
  ...
  v2 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928);
  v3 = *(_DWORD *)(v2 + 4648);
  v6 = *(_QWORD *)(W32GetUserSessionState(v2, v4) + 19928);
  if ( v3 != *(_DWORD *)(v6 + 4584) )
    return 0LL;
  v7 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 19928);
  v8 = *(_DWORD *)(v7 + 4632);
  v10 = *(_QWORD *)(W32GetUserSessionState(v7, v9) + 19928);
  result = 0LL;
