/*
 * XREFs of ?CaptureUsermodeParameters@QueryFontRequest@@UEAAXPEAX@Z @ 0x1401014D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z @ 0x140101624 (-ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z.c)
