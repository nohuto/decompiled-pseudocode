/*
 * XREFs of ?xxxSetProcessInitState@@YAJPEAU_EPROCESS@@W4PROCESS_INIT_HINT@@@Z @ 0x1401897BC
 * Callers:
...
__int64 __fastcall xxxSetProcessInitState(__int64 a1, int a2)
{
  ...
  if ( *(_DWORD *)(W32GetUserSessionState(v5, v4) + 70856) && !AtomicExecutionCheck::GetCount() )
  {
    v31 = 0x20000;
