/*
 * XREFs of NtUserSBGetParms @ 0x140245070
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 )
  {
    if ( a2 == 2 )
    {
      ...
      if ( v6 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      {
        ...
        ScrollbarTypeString = GetScrollbarTypeString(2LL, v13, v14, *(_QWORD *)(UserSessionState + 69416));
        LOBYTE(v16) = v11;
        LOBYTE(v17) = v6;
           ...
           && (v19 = *(__int64 **)(*(_QWORD *)(v9 + 16) + 464LL), v20 = *v19, PsGetCurrentProcess(v19) == v20) )
    {
      ...
      if ( v6 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      {
        ...
        v26 = GetScrollbarTypeString(a2, v24, v25, *(_QWORD *)(v23 + 69416));
        LOBYTE(v27) = v22;
        LOBYTE(v28) = v6;
