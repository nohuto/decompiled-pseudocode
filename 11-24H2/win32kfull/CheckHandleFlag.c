/*
 * XREFs of CheckHandleFlag @ 0x1401826E8
 * Callers:
 *     _GetUserObjectInformation @ 0x1401063F8 (_GetUserObjectInformation.c)
 *     OkayToCloseWindowStation @ 0x140182660 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x14023C400 (OkayToCloseDesktop.c)
