/*
 * XREFs of ?xxxSetIMEShowStatus@@YAHHHPEAH@Z @ 0x140212F50
 * Callers:
...
LABEL_11:
    *(_DWORD *)(W32GetUserSessionState(v7, v6) + 14304) = v5;
    v13 = *(_DWORD **)(W32GetUserSessionState(v11, v10) + 19928);
    if ( (*v13 & 4) != 0 )
    {
      if ( *(_QWORD *)(W32GetUserSessionState(v13, v12) + 18944) )
      {
        v17 = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 18944);
        if ( *(_QWORD *)(v17 + 120) )
        {
          v18 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v17, v16) + 18944) + 120LL) + 16LL);
          if ( *(_QWORD *)(v18 + 824) )
          {
