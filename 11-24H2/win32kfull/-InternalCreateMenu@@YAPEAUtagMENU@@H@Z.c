/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1401744B4
 * Callers:
 ...
 *     NtUserCreatePopupMenu @ 0x140174360 (NtUserCreatePopupMenu.c)
 *     NtUserCreateMenu @ 0x140174470 (NtUserCreateMenu.c)
 * Callees:
 *     ?PtiCurrent@@YAPEAUtagTHREADINFO@@XZ @ 0x140048610 (-PtiCurrent@@YAPEAUtagTHREADINFO@@XZ.c)
 *     CheckGrantedAccess @ 0x140174598 (CheckGrantedAccess.c)
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1401745CC (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
 */
