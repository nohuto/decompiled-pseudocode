/*
 * XREFs of xxxSoundSentry @ 0x14010312C
 * Callers:
 *     xxxMessageBeep @ 0x140103034 (xxxMessageBeep.c)
 *     NtUserSoundSentry @ 0x1401030F0 (NtUserSoundSentry.c)
...
__int64 __fastcall xxxSoundSentry(__int64 a1, __int64 a2)
{
  ...
  struct tagPOINT v36[2]; // [rsp+48h] [rbp-28h] BYREF

  *(_OWORD *)&v36[0].x = 0LL;
  UserSessionState = W32GetUserSessionState(a1, a2);
  v6 = *(unsigned int *)(W32GetUserSessionState(v4, v3) + 21004);
  if ( (v6 & 1) == 0 )
  {
    v7 = 50;
LABEL_3:
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v6, v5) + 18944) )
  {
    v12 = *(struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(v10, v9) + 18944) + 128LL);
    if ( v12 )
    {
      if ( !*(_QWORD *)(UserSessionState + 21064) )
      {
        v13 = (unsigned int)(*(_DWORD *)(UserSessionState + 21032) - 1);
        if ( *(_DWORD *)(UserSessionState + 21032) == 1
          || (v13 = (unsigned int)(*(_DWORD *)(UserSessionState + 21032) - 2), (unsigned int)v13 <= 1) )
        {
          v15 = *(_QWORD *)(W32GetUserSessionState(v13, v11) + 19928);
          if ( *(int *)(v15 + 4984) >= 1 )
          {
            v15 = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 19928);
            v16 = *(_DWORD *)(v15 + 4984);
          }
          else
          {
          ...
          v17 = *(_DWORD *)(UserSessionState + 21032);
          *(_DWORD *)(W32GetUserSessionState(v15, v14) + 21072) = v17;
          v18 = *(_QWORD *)v12;
          *(_QWORD *)(W32GetUserSessionState(v20, v19) + 21056) = v18;
          v21 = InternalSetTimer(0LL, 0LL, v16, (__int64)xxxSoundSentryTimer, 0, 20);
          *(_QWORD *)(UserSessionState + 21064) = v21;
          if ( !v21 )
          {
            v7 = 170;
            goto LABEL_3;
        ...
        switch ( *(_DWORD *)(UserSessionState + 21032) )
        {
          case 1:
          ...
          case 2:
            ...
            {
              *(_OWORD *)&v36[0].x = *(_OWORD *)(*((_QWORD *)v12 + 5) + 88LL);
              LogicalToPhysicalDPIRect(v36, v36, *(unsigned int *)(*((_QWORD *)v12 + 5) + 288LL), 0LL, v32, v33);
              v24 = *(_OWORD *)&v36[0].x;
              *(_OWORD *)(W32GetUserSessionState(v26, v25) + 21076) = v24;
              DesktopWindow = GetDesktopWindow((__int64)v12);
              DCEx = (HDC)_GetDCEx(DesktopWindow, 0LL, 3LL);
              GreEnableAppContainerRestriction(0LL);
              LeaveEnterCrit::LeaveEnterCrit((LeaveEnterCrit *)v34, 1);
              GrePatBlt(DCEx, v36[0].x, v36[0].y, v36[1].x - v36[0].x, v36[1].y - v36[0].y, 5570569);
              goto LABEL_21;
            }
            ...
            if ( (*(_WORD *)(v29 + 42) & 0x2FFF) == 0x29D )
              ...
              v30 = *(_OWORD *)(v29 + 88);
            v36[1].x = DWORD2(v30) - v30;
            v36[1].y = HIDWORD(v30) - DWORD1(v30);
            v36[0].y = 0;
            v36[0].x = 0;
            GreDPtoLP(DCEx, v36);
            GreEnableAppContainerRestriction(0LL);
LABEL_27:
          ...
          case 3:
            ...
            *(__m128i *)&v36[0].x = *GetScreenRectForDpi(&BugCheckParameter3, 0);
            GreEnableAppContainerRestriction(0LL);
            if ( (unsigned int)IsWindowDesktopComposed(v12) )
            {
              LeaveEnterCrit::LeaveEnterCrit((LeaveEnterCrit *)v34, 1);
              GrePatBlt(DCEx, v36[0].x, v36[0].y, v36[1].x - v36[0].x, v36[1].y - v36[0].y, 5570569);
LABEL_21:
              LeaveEnterCrit::~LeaveEnterCrit((LeaveEnterCrit *)v34);
LABEL_22:
