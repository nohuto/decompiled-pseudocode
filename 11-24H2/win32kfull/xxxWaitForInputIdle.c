/*
 * XREFs of xxxWaitForInputIdle @ 0x1401F488C
 * Callers:
 ...
 *     WaitOnPseudoEvent @ 0x1401F3B48 (WaitOnPseudoEvent.c)
...
__int64 __fastcall xxxWaitForInputIdle(HANDLE a1, __int64 a2)
{
  ...
  if ( PsGetThreadProcessId(*(PETHREAD *)v4) == a1 && v4 == *(struct tagTHREADINFO **)(*((_QWORD *)v4 + 58) + 336LL) )
    return 0xFFFFFFFFLL;
      ...
      if ( ProcessWin32Process )
      {
        if ( *(_QWORD *)ProcessWin32Process )
        {
          ...
          if ( (v20 & 0x21) == 0x20 )
          {
            ...
            *v19 &= ~0x20000u;
            for ( j = *(_QWORD *)(v18 + 328); j; j = *(_QWORD *)(j + 704) )
  ...
  if ( v29 >= 0 )
  {
    ...
    if ( ProcessInfo && (v9 = *((_DWORD *)ProcessInfo + 3), (v9 & 0x21) == 0x20) )
    {
      *((_DWORD *)v8 + 3) = v9 | 0x20000;
      for ( k = *((_QWORD *)v8 + 41); k; k = *(_QWORD *)(k + 704) )
            ...
            (v8 = CLockProcessByPid::GetProcessInfo((CLockProcessByPid *)v28)) != 0LL) )
      {
        *((_DWORD *)v8 + 3) &= ~0x20000u;
        for ( m = *((_QWORD *)v8 + 41); m; m = *(_QWORD *)(m + 704) )
