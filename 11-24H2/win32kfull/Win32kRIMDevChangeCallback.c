/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x1401EE990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InkProcessorOnInkDeviceAttached@@YAJPEAURawInputManagerDeviceObject@@@Z @ 0x14026BC38 (-InkProcessorOnInkDeviceAttached@@YAJPEAURawInputManagerDeviceObject@@@Z.c)
 *     IsPublicPointerDevice @ 0x14028B868 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x14028B890 (UpdatePointerDeviceCount.c)
...
LABEL_34:
    ...
    case 3:
      if ( (*(_DWORD *)(((v1 + 72) & -(__int64)(v1 != 0)) + 0xA8) & 0x2000) != 0 )
      {
        ...
        PostDeviceNotification(0LL, v4, v10, 2LL, v6 + 1, 0);
      }
      else
      {
        ...
        PostDeviceNotification(0LL, v4, v11, 2LL, v5, 0);
      }
      if ( (*(_DWORD *)(v1 + 256) & 0x200) != 0 )
