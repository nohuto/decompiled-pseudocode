/*
 * XREFs of ?StartScreenSaver@@YAXH@Z @ 0x14026A80C
 * Callers:
...
void __fastcall StartScreenSaver(__int64 a1, __int64 a2)
{
  ...
  v2 = (int)a1;
  if ( !*(_QWORD *)(W32GetUserSessionState(a1, a2) + 62864) )
  {
    v5 = *(unsigned int *)(W32GetUserSessionState(v4, v3) + 2968);
    if ( (v5 & 1) == 0 )
    {
      v7 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 3064);
      v10 = *(CInputGlobals **)(W32GetUserSessionState(v9, v8) + 3064);
      GlobalTickCount = CInputGlobals::GetGlobalTickCount(v7, 1LL);
      if ( GlobalTickCount != CInputGlobals::GetLastInputTime(v10) )
      {
        if ( !*(_WORD *)(W32GetUserSessionState(v13, v12) + 69008)
          && !*(_DWORD *)(W32GetUserSessionState(v15, v14) + 2756) )
        {
          v16 = 2LL;
          goto LABEL_10;
        }
        if ( !(_DWORD)v2 || (**(_DWORD **)(W32GetUserSessionState(v15, v14) + 19928) & 0x200) != 0 )
        {
          v16 = v2;
LABEL_10:
          if ( (int)PostWinlogonMessage(1024LL, v16) >= 0 )
          {
            ...
            CInputGlobals::UpdateGlobalTickCount(*(_QWORD *)(UserSessionState + 3064), 1LL);
