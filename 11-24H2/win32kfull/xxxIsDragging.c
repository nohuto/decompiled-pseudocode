/*
 * XREFs of xxxIsDragging @ 0x140109A1C
 * Callers:
...
__int64 __fastcall xxxIsDragging(struct tagWND *a1, __int64 a2)
{
  ...
  v21 = a2;
  v22 = a2;
  v8 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 19928);
  v9 = *(_DWORD *)(v8 + 2172);
  HIDWORD(v21) = HIDWORD(a2) - v9;
  HIDWORD(v22) = v9 + HIDWORD(a2);
  v11 = 1;
  v12 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v8, v10) + 19928) + 2168LL);
  LODWORD(v21) = a2 - v12;
  LODWORD(v22) = a2 + v12;
  v13 = 0;
...
LABEL_8:
  ...
  while ( (unsigned int)xxxSleepThread2(7LL, 500LL, 1, 0, (enum SLEEP_STATUS *)&v20) && !v20 );
LABEL_13:
  v13 = 1;
LABEL_14:
  v15 = *((_QWORD *)v4 + 59);
