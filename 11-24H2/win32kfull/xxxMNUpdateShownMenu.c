/*
 * XREFs of xxxMNUpdateShownMenu @ 0x1402E0898
 * Callers:
...
_QWORD *__fastcall xxxMNUpdateShownMenu(__int64 *a1, __int64 *a2, char a3)
{
  ...
  *(_OWORD *)v34 = 0LL;
  ...
  GetClientRect((__int64)v6, (__m128i *)v34);
...
LABEL_26:
  ...
  if ( (*(_DWORD *)(*(_QWORD *)v30[0] + 124LL) & 3) != 0 )
  {
    ...
    GetClientRect((__int64)v6, (__m128i *)&v35);
  }
  if ( v31 )
    v18 = v31;
  else
  ...
  if ( v35.top >= 0 )
  {
    ...
    {
      xxxScrollWindowEx(v6, 0LL, HIDWORD(v34[1]) - v9, &v35, (__int64)v34, 0LL, 0LL, 6);
      if ( v31 )
        v22 = v31;
      else
        v22 = *(_QWORD *)v30[0];
