/*
 * XREFs of ?PanEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1403098E0
 * Callers:
 *     <none>
 * Callees:
 *     ?bCreateSemaphores@@YAHPEAU_PANDEV@@@Z @ 0x14030A90C (-bCreateSemaphores@@YAHPEAU_PANDEV@@@Z.c)
 *     ?vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z @ 0x14030ACD4 (-vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z.c)
