/*
 * XREFs of ?WantImeWindow@@YAHPEAUtagWND@@0@Z @ 0x1401AA75C
 * Callers:
...
__int64 __fastcall WantImeWindow(struct tagWND *a1, struct tagWND *a2)
{
  ...
  v6 = *v5;
  if ( v6 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v5, v4) + 19928) + 898LL) )
    return 0LL;
  ...
  if ( v3 )
  {
    while ( v3 && v8 == *((_QWORD *)v3 + 3) )
    {
      ...
      v11 = *v10;
      if ( v11 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v10, v7) + 19928) + 898LL)
