/*
 * XREFs of ?bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z @ 0x140126114
 * Callers:
 ...
 *     ?vFlushCache@RFONTOBJ@@QEAAXXZ @ 0x14031D4E8 (-vFlushCache@RFONTOBJ@@QEAAXXZ.c)
 */
