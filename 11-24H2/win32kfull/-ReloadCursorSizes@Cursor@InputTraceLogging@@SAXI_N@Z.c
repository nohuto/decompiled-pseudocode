/*
 * XREFs of ?ReloadCursorSizes@Cursor@InputTraceLogging@@SAXI_N@Z @ 0x140271488
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::ReloadCursorSizes(__int64 a1, char a2)
{
  ...
  if ( a2 )
  {
    if ( (unsigned int)dword_140398B80 > 5 && tlgKeywordOn((__int64)&dword_140398B80, 8LL) )
    {
      v4 = (unsigned __int8 *)&unk_140364206;
LABEL_8:
      v5 = v3;
  ...
  else if ( (unsigned int)dword_140398B80 > 5 && tlgKeywordOn((__int64)&dword_140398B80, 8LL) )
  {
    v4 = (unsigned __int8 *)&unk_1403641CE;
    goto LABEL_8;
  }
}
