/*
 * XREFs of ?PerformLegacyDpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1401FABA4
 * Callers:
...
__int64 __fastcall PerformLegacyDpiUpgrade(struct _UNICODE_STRING *a1, unsigned int a2)
{
  ...
  if ( v15 == 4096 )
  {
    if ( HIDWORD(v17) )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(UserSessionState + 19928) + 2236LL) |= 0x20u;
    }
    else
    {
      v9 = W32GetUserSessionState(v6, v5);
      *(_DWORD *)(*(_QWORD *)(v9 + 19928) + 2236LL) &= ~0x20u;
    }
    return 0LL;
  }
...
LABEL_19:
  if ( v12 )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(v13 + 19928) + 2236LL) |= 0x20u;
  }
  else
  {
    v14 = W32GetUserSessionState(v10, v11);
    *(_DWORD *)(*(_QWORD *)(v14 + 19928) + 2236LL) &= ~0x20u;
  }
  v15 = 4096;
