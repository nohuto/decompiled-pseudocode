/*
 * XREFs of DwmAsyncCreateDCompositionHwndTarget @ 0x1401CDFB8
 * Callers:
 *     ?ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z @ 0x1401695E8 (-ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z.c)
 *     EditionNotifyDwmForSystemVisualCreation @ 0x1401CDF20 (EditionNotifyDwmForSystemVisualCreation.c)
 * Callees:
