/*
 * XREFs of ?CoalescableDueTime@@YAKPEBUtagTIMER@@@Z @ 0x1400F8790
 * Callers:
...
__int64 __fastcall CoalescableDueTime(const struct tagTIMER *a1, __int64 a2)
{
  ...
  if ( (unsigned int)v5 <= *(_DWORD *)(UserSessionState + 62780) )
    LODWORD(v5) = *(_DWORD *)(W32GetUserSessionState(v5, v4) + 62780);
  ...
  else
  {
    ...
    if ( (unsigned int)v9 <= *(_DWORD *)(v7 + 62780) )
      LODWORD(v9) = *(_DWORD *)(W32GetUserSessionState(v9, v8) + 62780);
    v10 = v9 + *((_DWORD *)a1 + 13);
  }
  v11 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 464LL) + 1032LL);
  if ( v11 )
  {
    v13 = v11 + v10;
    v10 = 0x7FFFFFFF;
