/*
 * XREFs of CreatePseudoDigitizerDevice @ 0x140279418
 * Callers:
 ...
 *     ?_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z @ 0x1402790C0 (-_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z.c)
...
struct DEVICEINFO *__fastcall CreatePseudoDigitizerDevice(int a1, int a2, __int64 a3)
{
  ...
  if ( (int)CHidInput::GetKernelHandleToRimObj(*(CHidInput **)(UserSessionState + 16840), (void **)(a3 + 88)) >= 0 )
  {
    ...
    v34 = *(_QWORD *)(CurrentProcessWin32Process + 872);
    v35 = *(_DWORD *)(CurrentProcessWin32Process + 880);
