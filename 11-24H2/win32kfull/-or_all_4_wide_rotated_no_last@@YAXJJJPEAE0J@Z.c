/*
 * XREFs of ?or_all_4_wide_rotated_no_last@@YAXJJJPEAE0J@Z @ 0x1401B97E0
 * Callers:
...
void __fastcall or_all_4_wide_rotated_no_last(int a1, char a2, int a3, unsigned __int8 *a4, unsigned __int8 *a5)
{
