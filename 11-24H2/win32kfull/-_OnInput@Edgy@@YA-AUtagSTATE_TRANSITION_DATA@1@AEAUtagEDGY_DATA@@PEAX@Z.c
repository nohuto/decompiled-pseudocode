/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1401F57C0
 * Callers:
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2)
{
  ...
  v5 = *(int *)(a2 + 16);
  v6 = 4LL;
  v7 = dword_14035A500[v5];
  v8 = *(_OWORD *)(ArcData + 16);
  v9 = dword_14035A504[v5];
  ...
  *(_QWORD *)&v8 = *(_QWORD *)(ArcData + 48);
  ...
  while ( v7 < v9 )
  {
    if ( (DWORD2(v12[0]) & dword_14035A388[4 * v7]) == dword_14035A38C[4 * v7] )
    {
      v6 = (unsigned int)dword_14035A384[4 * v7];
      break;
    }
    ++v7;
  }
