/*
 * XREFs of ?EngStretchBltOld@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAH@Z @ 0x1402252C4
 * Callers:
...
LABEL_214:
                ...
                ((void (__fastcall *)(stretch *))funcs_1400126D4[v64 - 1])(v60);
              }
            }
            else
            {
