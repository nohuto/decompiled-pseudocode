/*
 * XREFs of ?CreateEdgePalmRejectionZones@PalmRejection@@YAHPEAX@Z @ 0x1402A3E3C
 * Callers:
 *     EditionCreateEdgePalmRejectionZones @ 0x1402A40F0 (EditionCreateEdgePalmRejectionZones.c)
 * Callees:
