/*
 * XREFs of ?xxxRedrawHungWindow@@YAXPEAUtagWND@@PEAUHRGN__@@@Z @ 0x1402BCCD0
 * Callers:
...
LABEL_15:
    ...
    if ( !IsInsideUserApiHook(v12, v11) )
    {
      ...
      if ( (*(_BYTE *)(v15 + 16) & 0x40) == 0
        || (UserSessionState = W32GetUserSessionState(v15, v14),
            v18 = 8193,
            *(_QWORD *)(*((_QWORD *)a1 + 2) + 472LL) != *(_QWORD *)(UserSessionState + 18944)) )
      {
        v18 = 0x2000;
      }
    ...
    SetRectRgnIndirect(*(_QWORD *)(v21 + 63416), &v56);
    if ( EmptyRgn > 1 )
    {
      v24 = W32GetUserSessionState(v23, v22);
      v25 = GreCombineRgn(EmptyRgn, EmptyRgn, *(_QWORD *)(v24 + 63416), 1LL);
      if ( v25 )
      {
        if ( v25 == 1 )
        {
...
LABEL_43:
          ...
          if ( v41 )
          {
            if ( (unsigned __int64)v41 <= 0x1F )
              v41 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v40, v39) + 19928) + 8LL * (_QWORD)v41 + 4688);
          }
          else if ( (*(_BYTE *)(v35 + 18) & 1) != 0 )
          {
            v41 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v40, v39) + 19928) + 4816LL);
          }
          else
          {
            v41 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v40, v39) + 19928) + 4736LL);
          }
          ...
          if ( ObjectOwner && ObjectOwner != (unsigned int)PsGetCurrentProcessId() )
          {
            ...
            if ( BrushColor == -1 )
            {
              ...
              BrushColor = GreGetBrushColor(*(_QWORD *)(*(_QWORD *)(v46 + 19928) + 4736LL));
            }
            v47 = W32GetUserSessionState(v44, v43);
            GreSetSolidBrush(*(_QWORD *)(v47 + 43080), BrushColor);
            v41 = *(HBRUSH *)(W32GetUserSessionState(v49, v48) + 43080);
          }
