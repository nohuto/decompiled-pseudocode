/*
 * XREFs of ?HandleRawInput@@YA?AW4RAW_INPUT_PROCESSING_RESULT@@PEAXPEAU_KEYBOARD_INPUT_DATA@@PEBURAW_INPUT_SUPPLEMENTAL_INFO@@@Z @ 0x140171ED8
 * Callers:
...
LABEL_20:
    if ( *(_DWORD *)(a3 + 16)
      ...
      && (v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 464) + 832LL) + 100LL), (v14 & 0x20) != 0)
