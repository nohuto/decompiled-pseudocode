/*
 * XREFs of ?MmMapViewOfSection@UmfdHostLifeTimeManager@@SAJPEAXPEAPEAX_K2PEAT_LARGE_INTEGER@@PEA_KW4_SECTION_INHERIT@@KK4@Z @ 0x1401AA9A0
 * Callers:
 *     UmfdHostLifeTimeManager_MmMapViewOfSection @ 0x1401AA940 (UmfdHostLifeTimeManager_MmMapViewOfSection.c)
 * Callees:
 *     <none>
 */
