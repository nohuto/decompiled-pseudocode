/*
 * XREFs of ??0?$UnlockObjectLock@$$V@?$UnlockDomainExclusive@VDLT_WINEVENT@@@?$UnlockDomainShared@$$V@@QEAA@XZ @ 0x14016FB10
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_BYTE *)(a1 + 8) = 1;
  *(_QWORD *)(a1 + 16) = W32GetUserSessionState(v4, v3) + 42424;
  *(_BYTE *)(a1 + 24) = 0;
  *(_QWORD *)(a1 + 32) = 0LL;
  *(_BYTE *)(a1 + 40) = 0;
  v5 = *(tagDomLock **)a1;
