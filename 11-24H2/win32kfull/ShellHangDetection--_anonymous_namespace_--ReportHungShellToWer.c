/*
 * XREFs of ShellHangDetection::_anonymous_namespace_::ReportHungShellToWer @ 0x140269D10
 * Callers:
...
void __fastcall ShellHangDetection::_anonymous_namespace_::ReportHungShellToWer(__int64 a1)
{
  ...
  if ( !(unsigned int)IsShellProcess(*(_QWORD *)(a1 + 464)) )
  {
    ...
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2380LL);
  }
