/*
 * XREFs of xxxDWP_UpdateUIState @ 0x1401C43F4
 * Callers:
...
__int64 __fastcall xxxDWP_UpdateUIState(struct tagWND **a1, unsigned __int64 a2, __int64 a3)
{
  ...
  if ( (_WORD)a2 == 3 )
  {
    v29 = *(_DWORD **)(W32GetUserSessionState(a1, a2) + 19928);
    if ( (*v29 & 0x80u) != 0 )
      return 0LL;
    v31 = *(_QWORD *)(W32GetUserSessionState(v29, v28) + 19928);
    if ( (*(_DWORD *)(v31 + 7004) & 0x20) != 0
      || *(int *)(*(_QWORD *)(W32GetUserSessionState(v31, v30) + 19928) + 7004LL) >= 0
      || (GetAppCompatFlags2(1024LL, v32) & 2) != 0 )
    {
      return 0LL;
    }
    LOBYTE(v4) = 3;
    v6 = (unsigned __int16)(((**(_DWORD **)(W32GetUserSessionState(v34, v33) + 19928) & 0x40) != 0) + 1);
    v3 = v6 | 0x30000;
LABEL_10:
    ...
    else
    {
      ...
      if ( (unsigned __int16)v6 != 2 )
      {
        ...
        {
          v35 = **(_DWORD **)(W32GetUserSessionState(v10, v7) + 19928) & 0x40;
...
LABEL_16:
        if ( a1[14] )
        {
          ...
          if ( PtiCurrent(v14, v13) == *(struct tagTHREADINFO **)(UserSessionState + 68736)
            || (v17 = 0LL, PtiCurrent(v16, v15) == *(struct tagTHREADINFO **)(UserSessionState + 68808)) )
          {
            v17 = 1LL;
          }
  ...
  v8 = *(_DWORD **)(W32GetUserSessionState(a1, a2) + 19928);
  if ( (*v8 & 0x80u) != 0
    || (v9 = *(_QWORD *)(W32GetUserSessionState(v8, v7) + 19928), (*(_DWORD *)(v9 + 7004) & 0x20) != 0)
    || *(int *)(*(_QWORD *)(W32GetUserSessionState(v9, v7) + 19928) + 7004LL) >= 0
