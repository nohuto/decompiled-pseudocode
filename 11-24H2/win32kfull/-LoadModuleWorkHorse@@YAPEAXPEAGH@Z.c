/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x1403030C8
 * Callers:
 *     EngLoadModule @ 0x1403033A0 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x1403033C0 (EngLoadModuleForWrite.c)
 * Callees:
