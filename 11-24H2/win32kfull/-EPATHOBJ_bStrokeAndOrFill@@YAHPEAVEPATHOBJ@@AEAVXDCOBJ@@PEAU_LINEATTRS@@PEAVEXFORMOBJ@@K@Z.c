/*
 * XREFs of ?EPATHOBJ_bStrokeAndOrFill@@YAHPEAVEPATHOBJ@@AEAVXDCOBJ@@PEAU_LINEATTRS@@PEAVEXFORMOBJ@@K@Z @ 0x1400D3F84
 * Callers:
...
LABEL_25:
  ...
  *(_QWORD *)(*((_QWORD *)v65 + 1) + 80LL) = 0LL;
  ...
  {
    if ( *((_DWORD *)v24 + 531) == 1
      || (v13 = a5, v10 = 2827, a3 = (LINEATTRS *)&v66, v66 = glaSimpleStroke, v68 = 0LL, v67 = xmmword_1403560E8, !a5) )
    {
      v37 = v55;
      v38 = 1;
      goto LABEL_32;
  ...
  if ( v36 )
  {
    ...
    {
      v37 = v55;
      v38 = *(_DWORD *)EPATHOBJ_bSimpleFill(v60, v34, (unsigned int)(*this)[9].x, v24, v55);
      goto LABEL_32;
    }
    if ( v41 == 1 )
    {
