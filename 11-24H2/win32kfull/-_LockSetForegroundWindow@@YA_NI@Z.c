/*
 * XREFs of ?_LockSetForegroundWindow@@YA_NI@Z @ 0x140189E70
 * Callers:
 *     NtUserLockSetForegroundWindow @ 0x140189E30 (NtUserLockSetForegroundWindow.c)
 * Callees:
...
char __fastcall _LockSetForegroundWindow(__int64 a1)
{
  ...
  {
    if ( *(_QWORD *)(W32GetUserSessionState(v4, *(_QWORD *)&WPP_GLOBAL_Control) + 18896) )
      v11 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 18896);
  ...
  if ( v15 )
  {
    if ( v15 == 1 && v3 == *(const struct tagPROCESSINFO **)(W32GetUserSessionState(v4, v6) + 18896) )
    {
      *(_QWORD *)(W32GetUserSessionState(v16, v6) + 18896) = 0LL;
  ...
  else if ( !*(_QWORD *)(W32GetUserSessionState(v4, v6) + 18896) && !v5 && CanForceForeground(v3, v6) )
  {
    *(_QWORD *)(W32GetUserSessionState(v23, v6) + 18896) = v3;
