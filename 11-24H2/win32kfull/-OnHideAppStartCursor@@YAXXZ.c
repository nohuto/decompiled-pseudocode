/*
 * XREFs of ?OnHideAppStartCursor@@YAXXZ @ 0x1402713D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall OnHideAppStartCursor(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)v2 >= *(_DWORD *)(W32GetUserSessionState(0xFFFFF78000000004uLL, a2) + 36304) )
  {
    v5 = PtiCurrent(v4, v3);
    if ( v5 != *(struct tagTHREADINFO **)(W32GetUserSessionState(v7, v6) + 18704) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2653);
    v9[0] = 0;
    v10 = 0LL;
