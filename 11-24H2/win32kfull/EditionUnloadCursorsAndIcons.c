/*
 * XREFs of EditionUnloadCursorsAndIcons @ 0x1401F9710
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_AND_TRACE_SF_ @ 0x1400A5B18 (WPP_RECORDER_AND_TRACE_SF_.c)
 *     ?CleanupGlobalCursorSizes@@YAXXZ @ 0x1401F98D4 (-CleanupGlobalCursorSizes@@YAXXZ.c)
 */
...
void __fastcall EditionUnloadCursorsAndIcons(__int64 a1, __int64 a2)
{
  ...
  do
  {
    v11 = *(_QWORD *)(W32GetUserSessionState(v2, a2) + v8 + 32424);
    if ( v11 )
    {
      ...
      *(_QWORD *)(v11 + 24) = CurrentProcessWin32Process;
      ...
      HMAssignmentUnlock(v9 + v23 + 32424);
    }
    v9 += 552LL;
    v8 += 552LL;
    --v10;
  ...
  do
  {
    v15 = *(_QWORD *)(W32GetUserSessionState(v2, a2) + v12 + 21936);
    if ( v15 )
    {
      ...
      *(_QWORD *)(v15 + 24) = v16;
      ...
      HMAssignmentUnlock(v13 + v19 + 21936);
    }
    v13 += 552LL;
    v12 += 552LL;
    --v14;
