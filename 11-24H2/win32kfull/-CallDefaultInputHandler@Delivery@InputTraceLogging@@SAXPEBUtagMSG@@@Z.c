/*
 * XREFs of ?CallDefaultInputHandler@Delivery@InputTraceLogging@@SAXPEBUtagMSG@@@Z @ 0x140090074
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CallDefaultInputHandler(const struct tagMSG *a1)
{
  ...
  if ( (unsigned int)IsPointerInputMessage(*((unsigned int *)a1 + 2)) )
  {
    if ( *(_WORD *)(v3 + 16) == 1 )
    {
