/*
 * XREFs of ?WakeSomeone@@YAXPEAUtagQ@@PEAUtagTHREADINFO@@IPEAUtagQMSG@@@Z @ 0x14008FB9C
 * Callers:
 ...
 *     EditionWakeThreadForInput @ 0x14008FB70 (EditionWakeThreadForInput.c)
 *     EditionWakeSomeone @ 0x140090360 (EditionWakeSomeone.c)
 ...
 *     ?ShouldAddPointerWakeFlag@@YAHPEBUtagTHREADINFO@@PEBUtagQMSG@@@Z @ 0x140177D5C (-ShouldAddPointerWakeFlag@@YAHPEBUtagTHREADINFO@@PEBUtagQMSG@@@Z.c)
 *     ?CancelForegroundActivate@ForegroundLaunch@@YAXXZ @ 0x1401D5AC0 (-CancelForegroundActivate@ForegroundLaunch@@YAXXZ.c)
