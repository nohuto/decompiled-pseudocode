/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x14020F454
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x14020F3D0 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x14005FE74 (UserSetLastError.c)
 *     SetLastNtError @ 0x1401067E0 (SetLastNtError.c)
 *     ?IsKeyboardDevice@@YAHGG@Z @ 0x14020508C (-IsKeyboardDevice@@YAHGG@Z.c)
 *     ?IsMouseDevice@@YAHGG@Z @ 0x140210510 (-IsMouseDevice@@YAHGG@Z.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1402721EC (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
    ...
    if ( (_DWORD)v13 )
    {
      ...
      if ( v14 )
      {
        if ( (unsigned int)v13 >= v3 )
        {
          ...
          v40 = *(__int64 **)(v36 + 48);
          while ( v40 != (__int64 *)(*(_QWORD *)(v5 + 832) + 48LL) && v16 < v43 )
          {
            HIDWORD(v46) = 16;
