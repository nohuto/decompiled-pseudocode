/*
 * XREFs of ?OnTimer@CRapidHpdInfo@@SAXXZ @ 0x1401AA4D8
 * Callers:
 *     ?OnDaemonTimer@DesktopRecalc@@YAXXZ @ 0x1401AA4C0 (-OnDaemonTimer@DesktopRecalc@@YAXXZ.c)
 * Callees:
...
void __fastcall CRapidHpdInfo::OnTimer(__int64 a1, __int64 a2)
{
  ...
  v4 = *(_DWORD **)(UserSessionState + 71504);
  if ( v4 )
  {
    v5 = ((((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
         * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64)
       - *v4;
    if ( v5 >= *(_DWORD *)(UserSessionState + 71496) )
    {
      ...
      {
        v10 = *(_DWORD *)(*(_QWORD *)(UserSessionState + 71504) + 20LL);
      ...
      DesktopRecalc::OnRapidHpdTimeout(
        *(DesktopRecalc **)(*(_QWORD *)(UserSessionState + 71504) + 40LL),
        (struct CMonitorTopology *)(*(_QWORD *)(UserSessionState + 71504) + 24LL),
        v7);
      LOBYTE(v2) = (unsigned int)CMonitorTopology::CompareToCurrent(
                                   *(_QWORD *)(*(_QWORD *)(UserSessionState + 71504) + 40LL),
                                   0LL) != 0;
