/*
 * XREFs of ?xxxUpdateInputHangInfo@@YAXPEAUtagWND@@W4INPUTHANGTIME@@@Z @ 0x140064910
 * Callers:
 ...
 *     ?AddInputHangInfo@@YAHPEAUtagINPUTHANGINFO@@PEAUtagWND@@K@Z @ 0x1402103A0 (-AddInputHangInfo@@YAHPEAUtagINPUTHANGINFO@@PEAUtagWND@@K@Z.c)
  ...
  if ( a1 )
  {
    for ( i = *(__int64 **)(v8 + 1288); i; i = (__int64 *)*i )
    {
      if ( (struct tagWND *)i[1] != a1 )
      {
        if ( !*((_DWORD *)i + 4) )
          continue;
        LODWORD(v7) = *(_DWORD *)(W32GetUserSessionState(v7, v6) + 69368);
...
LABEL_15:
    ...
    v13 = *v12;
    if ( v13 != *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v6) + 19928) + 900LL)
