/*
 * XREFs of ?zzzSetCursorPos@@YA_NHH@Z @ 0x1400928F0
 * Callers:
...
char __fastcall zzzSetCursorPos(unsigned int a1, unsigned int a2)
{
    ...
    && !(unsigned int)IsImmersiveAppRestricted(*((_QWORD *)CurrentLogicalCursorThread + 58)) )
  {
    ...
    if ( !v8 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v47 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v5) + 69416);
    v55 = 10;
LABEL_32:
    LOBYTE(v46) = v44;
    LOBYTE(v45) = v8;
  ...
  if ( *((_QWORD *)CurrentLogicalCursorThread + 62)
    && *((_QWORD *)CurrentLogicalCursorThread + 62) != *(_QWORD *)(W32GetUserSessionState(v6, v5) + 19200) )
  {
    v8 = *(unsigned int **)&WPP_GLOBAL_Control != &WPP_GLOBAL_Control
      && (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 0x80000) != 0
      && *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) >= 2u;
    ...
    if ( !v8 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v47 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v7) + 69416);
    v55 = 11;
    goto LABEL_32;
  }
  v8 = 1;
  if ( !(unsigned int)IsGpqForegroundAccessibleForPti(CurrentLogicalCursorThread, 1) )
  {
    ...
    if ( !v8 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v47 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v48) + 69416);
    v55 = 12;
    goto LABEL_32;
  }
  ...
  else
  {
    ...
    *(_DWORD *)(v21 + 8 * v24 + 14728) = v20;
    ...
    v26 = *(unsigned __int16 *)(v17 + 19244) | ((unsigned __int16)v25 << 16);
