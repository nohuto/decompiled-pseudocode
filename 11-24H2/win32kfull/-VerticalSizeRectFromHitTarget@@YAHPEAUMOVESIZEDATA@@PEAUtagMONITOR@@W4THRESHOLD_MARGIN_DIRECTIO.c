/*
 * XREFs of ?VerticalSizeRectFromHitTarget@@YAHPEAUMOVESIZEDATA@@PEAUtagMONITOR@@W4THRESHOLD_MARGIN_DIRECTION@@1HH@Z @ 0x1402A6F48
 * Callers:
...
__int64 __fastcall VerticalSizeRectFromHitTarget(__int64 a1, __int64 a2, int a3, __int64 a4, LONG a5)
{
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      v19 = *(_QWORD *)(v16 + 96);
      v21 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 57008) + 152LL;
      if ( v19 == v21 )
        v19 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v21, v20) + 57008) + 152LL);
      v16 = v19 - 96;
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      v39 = *(_QWORD *)(v36 + 96);
      v41 = *(_QWORD *)(W32GetUserSessionState(v38, v37) + 57008) + 152LL;
      if ( v39 == v41 )
        v39 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v41, v40) + 57008) + 152LL);
      v36 = v39 - 96;
