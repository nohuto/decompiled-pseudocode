/*
 * XREFs of UmfdLoadFontFileView @ 0x1400B76D4
 * Callers:
 ...
 *     _UmfdLoadFontFileView_::_2_::_lambda_1_::operator() @ 0x1401B22E8 (_UmfdLoadFontFileView_--_2_--_lambda_1_--operator().c)
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1401D07F8 (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
 ...
 *     ?FNTCacheValidateFntFileInfo@@YA?AW4FntFileInfoValidationResult@@PEAPEAUFONTFILEVIEW@@K@Z @ 0x140302750 (-FNTCacheValidateFntFileInfo@@YA-AW4FntFileInfoValidationResult@@PEAPEAUFONTFILEVIEW@@K@Z.c)
        ...
        int *a13)
{
  ...
  v53 = a3;
  v13 = a2;
  result = UmfdHostLifeTimeManager::EnsureUmfdHost((__int64)a1, a2, (__int64)a3);
  v16 = 0;
  *a9 = 0LL;
  *a10 = 0LL;
  if ( result )
  {
    ...
    v49 = 0;
    v48 = 0;
    v18 = LookUpFNTCacheTable(v13, a1, a11, a11 + 1, &v51, &v47, a12, &v48, &v49, v53, v54, a7, a8);
    v22 = v48;
    v23 = v18;
    result = (char)a13;
    if ( a13 )
