/*
 * XREFs of ?Win32ProbeForRead@@YAXPEAX_KK@Z @ 0x1401A17B4
 * Callers:
 *     ?CaptureUsermodeParameters@GetTrueTypeFileRequest@@UEAAXPEAX@Z @ 0x1401A1690 (-CaptureUsermodeParameters@GetTrueTypeFileRequest@@UEAAXPEAX@Z.c)
