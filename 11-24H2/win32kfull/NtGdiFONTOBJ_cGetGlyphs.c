/*
 * XREFs of NtGdiFONTOBJ_cGetGlyphs @ 0x1400D71F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     FONTOBJ_cGetGlyphs @ 0x1400D6FC0 (FONTOBJ_cGetGlyphs.c)
...
__int64 __fastcall NtGdiFONTOBJ_cGetGlyphs(__int64 a1, __int64 a2, __int64 a3, int *a4, ULONG64 a5)
{
  ...
  struct UMPDOBJ *v21; // [rsp+50h] [rbp-A8h]
  _BYTE v22[32]; // [rsp+60h] [rbp-98h] BYREF
  struct UMPDOBJ *v23; // [rsp+80h] [rbp-78h]
  ...
  v10 = v23;
  v21 = v23;
  if ( v23 && (v11 = (struct PFT *)UMPDOBJ::GetDDIOBJ<_FONTOBJ>(v23, a1)) != 0LL && (unsigned int)(v8 - 1) <= 1 )
  {
    if ( a4 )
    {
