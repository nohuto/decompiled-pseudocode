/*
 * XREFs of UmfdSessionUninitialize @ 0x140102050
 * Callers:
 *     <none>
 * Callees:
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x140102108 (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
 *     ?UmfdCallSessionUninitialize@@YAXXZ @ 0x1401021B0 (-UmfdCallSessionUninitialize@@YAXXZ.c)
 *     ?Uninitialize@UmfdReliabilityManager@@YAXXZ @ 0x14010220C (-Uninitialize@UmfdReliabilityManager@@YAXXZ.c)
