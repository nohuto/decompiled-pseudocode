/*
 * XREFs of ?RemoveComponentInternal@CoreWindowProp@@KAJPEAUtagWND@@0@Z @ 0x1402C85D0
 * Callers:
 *     ?Delete@CoreWindowProp@@UEAAXXZ @ 0x1402C8400 (-Delete@CoreWindowProp@@UEAAXXZ.c)
...
__int64 __fastcall CoreWindowProp::RemoveComponentInternal(struct tagWND *a1, struct tagWND *a2)
{
  ...
  v9 = 0LL;
  v4 = -1073741275;
  if ( (unsigned int)CWindowProp::GetProp<CoreWindowProp>((__int64)a1, (__int64 *)&v9) )
  {
    v8 = 0LL;
