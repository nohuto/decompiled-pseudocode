/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x140279D9C
 * Callers:
 *     NtUserGetDeviceChangeInfo @ 0x140295C70 (NtUserGetDeviceChangeInfo.c)
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 70160) == UserSessionState + 70160 )
  {
    LeaveMediaCrit(v10, v9);
    return 0LL;
  }
  v11 = W32GetUserSessionState(v10, v9) + 70160;
  v13 = *(_QWORD *)(v11 + 8);
