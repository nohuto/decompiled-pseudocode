/*
 * XREFs of ?SessionCleanup@CTopologyManager@@SAXXZ @ 0x1401F2DDC
 * Callers:
...
void __fastcall CTopologyManager::SessionCleanup(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 71480) )
  {
    ...
    CMonitorTopology::Release(*(CMonitorTopology **)(UserSessionState + 71480));
    *(_QWORD *)(UserSessionState + 71480) = 0LL;
  }
}
