/*
 * XREFs of ?Free@?$CTypeIsolation@$0DKAAA@$0DKA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1400B6C54
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0DKAAA@$0DKA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1401C0088 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0DKAAA@$0DKA@@NSInstrumentation@@QEAA-AW4Alloc.c)
