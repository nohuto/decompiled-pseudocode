/*
 * XREFs of ?vStrMirror01@stretch@@YAXPEAVSURFACE@@@Z @ 0x140178E70
 * Callers:
    ...
    do
    {
      ...
      if ( v5 > 0 )
      {
        ...
        do
        {
          if ( v9 == v8 )
          {
            v19 = dword_140352C90[v14];
            v20 = dword_140361A80[v14];
            v21 = v7 & ~v19 | ((v7 & dword_140352C90[v15]) >> dword_140361A80[v15] << v20);
            v22 = (v7 & v19) >> v20;
            v13 = v26;
            v7 = (v22 << dword_140361A80[v15]) | ~dword_140352C90[v15] & v21;
          }
          else
          {
            v16 = dword_140361A80[v14];
            v17 = dword_140352C90[v15];
            v18 = (v7 & dword_140352C90[v14]) >> v16 << dword_140361A80[v15];
            v7 = v7 & ~dword_140352C90[v14] | ((v26 & (unsigned int)v17) >> dword_140361A80[v15] << v16);
            v13 = v18 | v26 & ~v17;
            v26 = v13;
          }
          ++v14;
