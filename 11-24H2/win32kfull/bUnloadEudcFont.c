/*
 * XREFs of bUnloadEudcFont @ 0x1400FE308
 * Callers:
...
__int64 __fastcall bUnloadEudcFont(struct PFE **a1)
{
  ...
  *v13 = 0;
  ...
  v15 = 0;
  if ( (*(_DWORD *)(v10 + 13520) & 0x10) != 0 || !*(_DWORD *)(v10 + 19568) )
    goto LABEL_14;
  v20 = 7LL;
  v19 = v10 + 14420;
  do
...
LABEL_14:
    *(_DWORD *)(v7 + 12) &= ~0x200u;
    ...
    v21.Blink = &v21;
    v21.Flink = &v21;
    prfntDeactivateEudcRFONTs(a1, &v21, v10);
    vKillEudcRFONTs(&v21);
  }
  if ( !PFTOBJ::bUnloadEUDCFont((PFTOBJ *)v19, v5) )
  {
LABEL_32:
