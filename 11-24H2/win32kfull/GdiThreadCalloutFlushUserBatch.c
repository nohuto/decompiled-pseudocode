/*
 * XREFs of GdiThreadCalloutFlushUserBatch @ 0x1401A7400
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned __int64 __fastcall GdiThreadCalloutFlushUserBatch(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)result <= 0x134 )
  {
    do
    {
      ...
      {
        HIDWORD(v10) = *(unsigned __int16 *)p_ArbitraryUserPointer;
        NtGdiDeleteObjectApp(
          p_ArbitraryUserPointer[1],
          1LL,
          a3,
          a4,
          v10,
          *((unsigned __int16 *)p_ArbitraryUserPointer + 1));
      }
      LODWORD(v10) = --StackLimit;
