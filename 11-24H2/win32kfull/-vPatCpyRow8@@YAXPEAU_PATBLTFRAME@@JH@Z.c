/*
 * XREFs of ?vPatCpyRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x140314FC0
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndCopy @ 0x1401666F4 (vFetchAndCopy.c)
 *     vFetchShiftAndCopy @ 0x140166B5C (vFetchShiftAndCopy.c)
 */
  ...
  *((_QWORD *)&v27 + 1) = v11;
  if ( a3 )
  {
    do
    {
      ...
      v19 = v14 & 0xFFFFFFFC;
      v20 = v19 - *((_DWORD *)a1 + 8);
      v21 = dword_1403534D8[v18];
      v22 = ~dword_1403534D8[v17];
      v23 = *((_DWORD *)a1 + 10);
      if ( v20 >= 0 )
        v24 = v20 % v23;
      else
      ...
      else
      {
        ...
        if ( (unsigned int)(v16 - v19) >= 4 )
        {
          ...
          *(_QWORD *)&v28 = __PAIR64__(v25, v24);
          ...
          {
            vFetchShiftAndCopy((__int64)&v27);
          }
          else
          {
            HIDWORD(v28) = v25 >> 2;
            vFetchAndCopy((__int64)&v27);
          }
          v3 = v30;
          v11 = *((_QWORD *)&v27 + 1);
        }
