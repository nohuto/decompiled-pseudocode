/*
 * XREFs of NtUserShellSetWindowPos @ 0x1402A01F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v14 )
  {
    if ( (a5 & 0xFFFFFFC0) != 0 )
    {
      ...
      if ( !v10 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_21;
      v26 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v15) + 69416);
      v87 = a5;
      v82 = 61;
      goto LABEL_20;
    }
...
LABEL_97:
    ...
    if ( (a5 & 0xC) != 0 )
    {
      ...
      if ( !v10 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_21;
      v26 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v61) + 69416);
      v87 = a5;
      v82 = 75;
LABEL_20:
      LOBYTE(v25) = v23;
