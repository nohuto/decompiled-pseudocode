/*
 * XREFs of ?vSrcOpaqCopyS1D8@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1403067C0
 * Callers:
        ...
        unsigned int a10)
{
  ...
  {
    v41 = dword_1403612E0[2 * (v10 & 3)] & dword_140361360[2 * (v11 & 3)];
  ...
  {
    v47 = &v46[v17];
    v48 = dword_140361360[2 * (v11 & 7)] & dword_1403612E0[2 * v38];
    v49 = dword_140361364[2 * (v11 & 7)] & dword_1403612E4[2 * v38];
    v50 = ~(dword_140361360[2 * v37] & dword_1403612E0[2 * v38]);
    do
    {
      v51 = *v40;
      v40 += v12;
