/*
 * XREFs of NtUserSetCursorIconDataEx @ 0x14029D140
 * Callers:
 *     NtUserSetCursorIconData @ 0x14029D120 (NtUserSetCursorIconData.c)
 * Callees:
...
__int64 __fastcall NtUserSetCursorIconDataEx(__int64 a1, ULONG64 a2, ULONG64 a3, ULONG64 a4, unsigned int a5)
{
  ...
  *(_DWORD *)&v23.Length = *(_DWORD *)a3;
  ...
  {
LABEL_36:
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8094);
LABEL_37:
    ExRaiseAccessViolation();
  }
  if ( ((unsigned __int64)v14 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    {
      if ( (v13 & 1) != 0 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8095);
      ExRaiseAccessViolation();
    }
  }
