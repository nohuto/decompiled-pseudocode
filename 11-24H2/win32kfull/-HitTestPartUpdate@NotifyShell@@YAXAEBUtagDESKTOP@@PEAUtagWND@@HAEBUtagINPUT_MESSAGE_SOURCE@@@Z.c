/*
 * XREFs of ?HitTestPartUpdate@NotifyShell@@YAXAEBUtagDESKTOP@@PEAUtagWND@@HAEBUtagINPUT_MESSAGE_SOURCE@@@Z @ 0x140252128
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::NotifyPartExit @ 0x140148800 (_anonymous_namespace_--NotifyPartExit.c)
