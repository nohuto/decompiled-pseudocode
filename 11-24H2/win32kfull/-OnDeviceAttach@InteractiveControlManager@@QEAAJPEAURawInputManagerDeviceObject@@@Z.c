/*
 * XREFs of ?OnDeviceAttach@InteractiveControlManager@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1402DEDC4
 * Callers:
            ...
            *((_QWORD *)this + i + 5) = v11;
            ...
            if ( !*((_DWORD *)this + 2) )
            {
              Device = InteractiveControlDevice::SetComponentResolution(
                         ...
                         *((_DWORD *)this + 7),
                         (_DWORD *)this + 8);
              if ( Device < 0 && (unsigned int)dword_140398C28 > 2 )
              {
                v20 = "Function failed.";
