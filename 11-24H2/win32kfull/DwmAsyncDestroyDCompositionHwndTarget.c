/*
 * XREFs of DwmAsyncDestroyDCompositionHwndTarget @ 0x1401D1B94
 * Callers:
 *     EditionNotifyDwmForSystemVisualDestruction @ 0x1401D1B30 (EditionNotifyDwmForSystemVisualDestruction.c)
 * Callees:
 *     <none>
 */
