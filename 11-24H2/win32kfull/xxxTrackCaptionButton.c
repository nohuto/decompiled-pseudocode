/*
 * XREFs of xxxTrackCaptionButton @ 0x14010B9EC
 * Callers:
...
__int64 __fastcall xxxTrackCaptionButton(struct tagWND *a1, __int64 a2)
{
  ...
  v11 = xxxCalcCaptionButton((__int64)a1, v10, v23, &v30, (int *)&v25, 0);
  v13 = v23[0];
  v26 = SHIWORD(v11);
  v27 = (__int16)v11;
  if ( v23[0] )
  {
    ...
    BitBltSysBmp(DCEx, v27, v26, v25 + 1, 1);
    _ReleaseDC(DCEx);
    v24 = 1;
    v15 = 1;
  ...
  while ( !v28 )
  {
      ...
      else if ( DWORD2(v31[0]) == 512 )
      {
        if ( v13 )
        {
          ...
          if ( v15 != v17 )
          {
            ...
            BitBltSysBmp(v18, v27, v26, v25 + (unsigned __int16)v24, 1);
            _ReleaseDC(v18);
    ...
    else
    {
      ...
      else if ( !(unsigned int)xxxSleepThread(4102LL, 0LL, 1, 0) )
      {
        break;
      }
    }
  ...
  if ( v13 )
  {
    if ( (_WORD)v24 && v13 != 0xF180 )
    {
      ...
      BitBltSysBmp(v20, v27, v26, v25, 1);
      _ReleaseDC(v20);
