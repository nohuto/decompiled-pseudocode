/*
 * XREFs of ?xxxTrackBox@@YAXPEAUtagWND@@I_K_JPEAUtagSBCALC@@@Z @ 0x1402E2820
 * Callers:
...
void __fastcall xxxTrackBox(struct tagWND *a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v8 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v11) = v9;
    LOBYTE(v12) = v8;
    WPP_RECORDER_AND_TRACE_SF_qsDdd(*(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 24LL), v12, v11, v13);
  }
  else
  {
    v10 = a4 >> 16;
  ...
  if ( v7 && (!v5 || BYTE1(v5) == 2) )
  {
    ...
    if ( v14 == (v17 & 1)
      || (zzzDrawInvertScrollArea(a1, (struct tagSBTRACK *)v7, v14, *(_DWORD *)(v7 + 56)),
          ...
          v7 == *(_QWORD *)(v16 + 752)) )
    {
      v20 = *(_QWORD *)(W32GetUserSessionState(v16, v15) + 19928);
      ...
      if ( v22 )
      {
        ...
        if ( v23 )
        {
          if ( v23 == 1 )
            xxxEndScroll(a1);
LABEL_26:
          if ( v7 == *(_QWORD *)(*((_QWORD *)a1 + 2) + 752LL) )
            *(_DWORD *)v7 ^= (v18 ^ (unsigned __int8)*(_DWORD *)v7) & 1;
          return;
        }
        *(_QWORD *)(v7 + 64) = 0LL;
        v21 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v20, v19) + 19928) + 4976LL);
      }
      if ( v18 )
      {
        if ( v18 != (*(_DWORD *)v7 & 1) )
        {
          ...
          v25 = *(struct tagTHREADINFO ***)(v7 + 24);
          *(_QWORD *)(v7 + 64) = v24;
          if ( v25 )
            xxxDoScroll(
              *(struct tagDRAWITEMSTRUCT ***)(v7 + 16),
              v25,
              *(_DWORD *)(v7 + 56),
              0,
              (*(_DWORD *)v7 >> 1) & 1);
