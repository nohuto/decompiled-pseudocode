/*
 * XREFs of ?CheckAndEmitRequiredHaptic@MoveSizeHaptic@@QEAAXXZ @ 0x1402DC1F4
 * Callers:
 *     ?xxxTM_MoveDragRect@@YAXPEAUMOVESIZEDATA@@_J@Z @ 0x14024C350 (-xxxTM_MoveDragRect@@YAXPEAUMOVESIZEDATA@@_J@Z.c)
 * Callees:
 *     ?CheckIfScreenBoundaryLimitHapticNeeded@MoveSizeHaptic@@AEAA_NXZ @ 0x1402DC31C (-CheckIfScreenBoundaryLimitHapticNeeded@MoveSizeHaptic@@AEAA_NXZ.c)
