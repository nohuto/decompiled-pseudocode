/*
 * XREFs of ?xxxPointerWindowHitTest@@YAPEAUHWND__@@PEAUtagTHREADINFO@@PEAUtagWND@@I_K_JUtagPOINT@@PEAHW4WindowHitTestOption@@PEBUtagPOINTEREVENTINT@@2PEAU4@@Z @ 0x1401B4188
 * Callers:
        ...
        struct tagPOINT *a11)
{
  ...
  if ( !(unsigned int)TouchTargetingEnabledForInput(a6, a9 + 8) )
  {
    v14 = xxxWindowHitTestWithoutTargeting(a1, (__int64)a2, a3, a4, a5, a6, (__int64)a7, a8);
LABEL_3:
  ...
  if ( v16 )
  {
    ...
    if ( v19 )
    {
      ...
      *(_QWORD *)&v38 = v28;
      ...
      xxxWindowHitTestWithTargeting(a2, a6, v19, &v39, 0);
      if ( *(_DWORD *)(v19 + 180) )
      {
        v14 = xxxWindowHitTestWithoutTargeting(v26, (__int64)a2, a3, a4, a5, a6, (__int64)a7, a8);
      }
      else
      {
        *a7 = *(_DWORD *)(v19 + 32);
