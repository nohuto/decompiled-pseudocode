/*
 * XREFs of ?xxxCapture@@YAXPEAUtagTHREADINFO@@PEAUtagWND@@I@Z @ 0x140089FBC
 * Callers:
...
void __fastcall xxxCapture(struct tagTHREADINFO *a1, struct tagWND *a2, int a3)
{
  ...
  if ( a3 == 6 )
  {
    ...
    InputTraceLogging::Mouse::SetCapture(*v3, v5, 1u);
    v7 = 2LL;
    v8 = 2;
  }
  else
  ...
  if ( v5 )
  {
    ...
    {
LABEL_38:
      if ( !*(_DWORD *)(W32GetUserSessionState(v19, v18) + 70856) )
        v20 = 1;
