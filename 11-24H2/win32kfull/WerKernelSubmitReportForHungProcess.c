/*
 * XREFs of WerKernelSubmitReportForHungProcess @ 0x1402F2A24
 * Callers:
 *     _lambda_ee4856d16542b31eb6609ee4cd7f16f7_::_lambda_invoker_cdecl_ @ 0x1402BFE70 (_lambda_ee4856d16542b31eb6609ee4cd7f16f7_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     WerStartSystemErrorHandler @ 0x1402F2D94 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1402F2ECC (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x1402F2FA0 (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1402F30C4 (WerpFreeMem.c)
