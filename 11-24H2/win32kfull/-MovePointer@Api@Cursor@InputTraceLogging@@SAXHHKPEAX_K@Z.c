/*
 * XREFs of ?MovePointer@Api@Cursor@InputTraceLogging@@SAXHHKPEAX_K@Z @ 0x140093E40
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  bool v17[3]; // [rsp+61h] [rbp-1Fh] BYREF
  ...
  if ( dword_140398B80 )
  {
    ...
    {
      v9 = IS_USERCRIT_OWNED_AT_ALL(a1, a2, a3);
      v13 = IS_USERCRIT_OWNED_EXCLUSIVE(v11, v10, v12);
