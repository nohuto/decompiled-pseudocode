/*
 * XREFs of xxxDestroyThreadDDEObject @ 0x14015FCB0
 * Callers:
...
__int64 __fastcall xxxDestroyThreadDDEObject(__int64 a1, _QWORD *a2)
{
  ...
  if ( a2 == *(_QWORD **)(W32GetUserSessionState(v5, v4) + 66936) )
  {
    v8 = a2[3];
    *(_QWORD *)(W32GetUserSessionState(v7, v6) + 66936) = v8;
  }
  else
  {
    v9 = *(_QWORD **)(W32GetUserSessionState(v7, v6) + 66936);
