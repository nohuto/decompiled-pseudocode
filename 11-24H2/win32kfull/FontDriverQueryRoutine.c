/*
 * XREFs of FontDriverQueryRoutine @ 0x1403E9810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FontDriverQueryRoutine(__int64 a1, int a2, const wchar_t *a3, int a4)
{
  ...
  HDEV v9[2]; // [rsp+60h] [rbp-238h] BYREF
  wchar_t Dst[264]; // [rsp+70h] [rbp-228h] BYREF
  ...
  if ( !Driver )
    return 0LL;
  PDEVOBJ::PDEVOBJ((PDEVOBJ *)v9, Driver, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL, 0, 0, 0);
  if ( !v9[0] )
    return 0LL;
  *((_DWORD *)v9[0] + 10) |= 0x2000u;
  FntCacheHDEV(v9[0], 0LL);
  return 1LL;
}
