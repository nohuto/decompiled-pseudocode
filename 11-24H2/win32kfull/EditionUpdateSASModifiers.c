/*
 * XREFs of EditionUpdateSASModifiers @ 0x140131C20
 * Callers:
 *     <none>
 * Callees:
 *     ?PtiCurrent@@YAPEAUtagTHREADINFO@@XZ @ 0x140048610 (-PtiCurrent@@YAPEAUtagTHREADINFO@@XZ.c)
 *     ?VKTOMODIFIERS@@YAIE@Z @ 0x140131CB8 (-VKTOMODIFIERS@@YAIE@Z.c)
...
void __fastcall EditionUpdateSASModifiers(int a1, unsigned __int8 a2, __int16 a3, int a4)
{
  ...
  if ( !a1
    ...
    && (v13 = PtiCurrent(v12, v11), v13 == *(struct tagTHREADINFO **)(W32GetUserSessionState(v15, v14) + 18704)) )
  {
    if ( (a3 & 0x200) == 0 )
    {
      v7 = VKTOMODIFIERS(a2);
