/*
 * XREFs of ?CheckImeHotKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAUtagQ@@I_J@Z @ 0x14019FF30
 * Callers:
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(struct tagQ *a1, __int64 a2, int a3)
{
  ...
  v7 = *((_BYTE *)a1 + 320);
  v8 = ((v7 & 0x10) != 0 ? 0x8002 : 0) | ((v7 & 0x40) != 0 ? 0x4002 : 0) | ((*((_BYTE *)a1 + 321) & 1) != 0 ? 0x8001 : 0) | ((*((_BYTE *)a1 + 321) & 4) != 0 ? 0x4001 : 0);
  v9 = (v7 & 4) != 0 ? 0x4004 : 0;
  LOBYTE(a2) = -(v7 & 1);
