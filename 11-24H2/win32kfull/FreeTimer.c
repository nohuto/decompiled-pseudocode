/*
 * XREFs of FreeTimer @ 0x14023EC30
 * Callers:
...
struct tagTIMER *__fastcall FreeTimer(struct tagTIMER *a1)
{
  ...
  if ( (unsigned int)Feature_Servicing_win32k_timers_resilience__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    *((_DWORD *)a1 + 12) |= 0x1000u;
    ...
    {
      v3 = (struct tagTIMER *)*((_QWORD *)a1 + 9);
LABEL_21:
    ...
    if ( !*((_QWORD *)a1 + 13) )
      _bittestandreset((signed __int32 *)(W32GetUserSessionState(v5, v4) + 57628), *((_DWORD *)a1 + 28) - 256);
    ...
    {
      v28 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000LL, 4606LL);
    }
    v9 = *(_QWORD *)v6;
        ...
        *(_QWORD *)v6 = v6;
        ...
        if ( *(char **)(*(_QWORD *)v11 + 8LL) == v11 )
        {
          ...
          if ( *(char **)*v12 == v11 )
          {
            ...
            *(_QWORD *)v11 = v11;
            v15 = *((_QWORD *)a1 + 11);
            if ( *(struct tagTIMER **)(v15 + 8) == (struct tagTIMER *)((char *)a1 + 88) )
            {
              v16 = (struct tagTIMER **)*((_QWORD *)a1 + 12);
              if ( *v16 == (struct tagTIMER *)((char *)a1 + 88) )
              {
...
LABEL_35:
  ...
  if ( (unsigned int)HMMarkObjectDestroy(a1) )
  {
    ...
    *(_QWORD *)(v21 + 8) = v22;
    v23 = *((_QWORD *)a1 + 11);
    if ( *(struct tagTIMER **)(v23 + 8) != (struct tagTIMER *)((char *)a1 + 88) )
      goto LABEL_35;
    v24 = (struct tagTIMER **)*((_QWORD *)a1 + 12);
    if ( *v24 != (struct tagTIMER *)((char *)a1 + 88) )
      goto LABEL_35;
    *v24 = (struct tagTIMER *)v23;
    *(_QWORD *)(v23 + 8) = v24;
    if ( !*((_QWORD *)a1 + 13) )
      _bittestandreset((signed __int32 *)(W32GetUserSessionState(v24, v23) + 57628), *((_DWORD *)a1 + 28) - 256);
    EtwTraceKillTimer(a1);
    HMAssignmentUnlock((char *)a1 + 104);
    HMFreeObject(a1);
    AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)v25);
