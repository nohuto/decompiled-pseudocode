/*
 * XREFs of NtUserSetImeOwnerWindow @ 0x140246430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetImeOwnerWindow(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    if ( (**(_DWORD **)(W32GetUserSessionState(v6, v5) + 19928) & 4) == 0 )
    {
...
LABEL_18:
    ...
    v15 = *v14;
    if ( v15 != *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v12) + 19928) + 898LL)
