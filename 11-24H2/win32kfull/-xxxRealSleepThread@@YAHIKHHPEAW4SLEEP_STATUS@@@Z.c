/*
 * XREFs of ?xxxRealSleepThread@@YAHIKHHPEAW4SLEEP_STATUS@@@Z @ 0x140063D90
 * Callers:
...
LABEL_10:
    ...
    if ( !v7 && (INTERLOCKEDINT::operator int(*(_QWORD *)v12 + 8LL) & 0x40) != 0 )
    {
      ...
      _InterlockedOr(
        ...
        *(_WORD *)(v11 + 920) & (unsigned __int16)INTERLOCKEDINT::operator int(*(_QWORD *)v12 + 8LL));
      *(_WORD *)(v11 + 920) = 0;
    }
...
LABEL_75:
    ...
    if ( (v24 & v22) != 0 )
      continue;
    if ( v11 == *(_QWORD *)(W32GetUserSessionState(v23, 0xFFFFF78000000320uLL) + 68736) && (v9 & 0x200) != 0 && !Timeout )
      break;
    v27 = v59;
    if ( v59 )
    {
      ...
      *(_QWORD *)(*(_QWORD *)(v11 + 520) + 8LL) = 0LL;
      if ( v27 )
      {
        if ( v11 == *(_QWORD *)(W32GetUserSessionState(v26, v25) + 18960)
    ...
    {
      v31 = 1;
      Object[1] = *(PVOID *)(W32GetUserSessionState(v30, v29) + 18816);
      v28 = 2;
      LODWORD(a5) = 2;
    }
    else
    ...
    if ( v31 )
      *(_DWORD *)(W32GetUserSessionState(v32, v29) + 64232) = 1;
    v51 = 0;
    while ( 1 )
    {
...
LABEL_77:
    ...
    if ( v35 > Timeout->QuadPart )
    {
      ...
      *(_DWORD *)(W32GetUserSessionState(v35, Timeout) + 64236) = 0;
...
LABEL_44:
    if ( v31 )
    {
      *(_DWORD *)(W32GetUserSessionState(v35, v34) + 64232) = 0;
      if ( *(_DWORD *)(W32GetUserSessionState(v45, v44) + 64236) )
      {
        WakeMIT(2LL);
        if ( !v37 )
        {
          UserSessionState = W32GetUserSessionState(v35, v46);
          KeClearEvent(*(PRKEVENT *)(UserSessionState + 18816));
        }
      }
    }
    v6 = 0;
    ...
    if ( !*(_QWORD *)(v39 + 336) )
      *(_QWORD *)(v39 + 336) = v11;
    v7 = v48;
    if ( *(_QWORD *)(*(_QWORD *)(v11 + 464) + 336LL) == v11 )
    {
