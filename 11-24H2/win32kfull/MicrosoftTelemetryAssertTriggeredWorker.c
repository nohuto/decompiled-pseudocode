/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1401FDA0C
 * Callers:
 ...
 *     _tlgCreate1Sz_char @ 0x1402093B8 (_tlgCreate1Sz_char.c)
...
LABEL_57:
    ...
    if ( a2 )
    {
      if ( (unsigned int)dword_1403CF040 > 5 && tlgKeywordOn((__int64)&dword_1403CF040, 0x400000000000LL) )
      {
        v72 = 10;
        v117 = &v72;
        v118 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403CF040, byte_14036A526, 0LL, 0LL, 0xEu, &v116);
      }
    }
    else if ( (unsigned int)dword_1403CF040 > 5 && tlgKeywordOn((__int64)&dword_1403CF040, 0x400000000000LL) )
    {
      v53 = 10;
      v142 = &v53;
      v143 = 4LL;
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403CF040, byte_14036A5D0, 0LL, 0LL, 0xBu, &v141);
    }
    if ( dword_1403CF078 && !v60 && !KeGetCurrentIrql() )
    {
      ...
      if ( a2 )
      {
        if ( (unsigned int)dword_1403CF040 > 5 && tlgKeywordOn((__int64)&dword_1403CF040, 0x400000000000LL) )
        {
          ...
          v97 = 4LL;
          v99 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403CF040, byte_14036A63D, 0LL, v36, 0xDu, &v79);
        }
      }
      else if ( (unsigned int)dword_1403CF040 > 5 && tlgKeywordOn((__int64)&dword_1403CF040, 0x400000000000LL) )
      {
        ...
        v76 = v35;
        v115 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403CF040, byte_14036A6E3, 0LL, v37, v38, &v100);
      }
