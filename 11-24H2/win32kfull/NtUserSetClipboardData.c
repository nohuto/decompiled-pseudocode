/*
 * XREFs of NtUserSetClipboardData @ 0x1402459F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetClipboardData(unsigned int a1, char *a2, ULONG64 a3)
{
  ...
  v8 = (const wchar_t *)(*((_QWORD *)PtiCurrent(v7, v6) + 58) + 984LL);
  v53 = (__int64)v8;
  ...
  else
  {
    ...
    if ( (_InterlockedCompareExchange((volatile signed __int32 *)v20 + 132, 0, 0) & 0x20000000) != 0 )
      v18 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)PtiCurrent((__int64)v20, v19) + 58) + 760LL) + 32LL) & 4;
    else
      v18 = 0LL;
  ...
  if ( *(_DWORD *)(CurrentProcessWin32Process + 876) )
  {
    ...
    v33 = *((_QWORD *)v32 + 62);
    v34 = *(_QWORD *)(v33 + 40);
    if ( (!*(_QWORD *)(W32GetUserSessionState(v33, v35) + 18944) || !(unsigned int)ForegroundInputOwnerMatch(v32, 1LL))
...
LABEL_15:
  ...
  if ( !v27 )
  {
    ...
    if ( v44 > 0 )
      v45 = 1;
    if ( v45 && (unsigned int)dword_140398BB8 > 5 && tlgKeywordOn((__int64)&dword_140398BB8, 1LL) )
    {
      v58 = v8;
