/*
 * XREFs of ??0?$ObjectLock@UtagObjLock@@U1@@?$DomainExclusive@$$V@?$DomainShared@VDLT_THREADINFO@@VDLT_QUEUE@@@@QEAA@AEAUtagObjLock@@0@Z @ 0x140102A34
 * Callers:
 ...
 * Callees:
 *     vDLOrderDispositionCompare @ 0x140102E90 (vDLOrderDispositionCompare.c)
 *     vOLOrderCompare @ 0x140102EC0 (vOLOrderCompare.c)
 *     ??$ClearCObjLock@PEAUtagObjLock@@@@YAXAEAPEAUtagObjLock@@@Z @ 0x140271B78 (--$ClearCObjLock@PEAUtagObjLock@@@@YAXAEAPEAUtagObjLock@@@Z.c)
 */
        ...
        tagObjLock *a3)
{
  ...
  *((_QWORD *)Base + 4) = UserSessionState + 42424;
  *((_OWORD *)Base + 3) = 0LL;
  *((_QWORD *)Base + 8) = 0LL;
  Base[72] = 0;
