/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@1111@Z @ 0x14018D3F4
 * Callers:
 ...
 *     ?IsLastTopMostWindow@@YAHPEBUtagWND@@@Z @ 0x1402088CC (-IsLastTopMostWindow@@YAHPEBUtagWND@@@Z.c)
        ...
        struct tagWND *a6)
{
  ...
  if ( a3 )
  {
    if ( *((_QWORD *)a2 + 2) != *(_QWORD *)(W32GetUserSessionState(a1, a2) + 18960) )
    {
      ...
      if ( (v13 & 0xFFFFFFFC) != 0 && (*(_BYTE *)(*((_QWORD *)a2 + 5) + 24LL) & 8) == 0 )
      {
        if ( (unsigned int)Feature_ApplyWindowActionConvergence__private_IsEnabledDeviceUsageNoInline(v13, v11, v12)
          || !LastTopMostWindow )
        {
          LastTopMostWindow = CalcForegroundInsertAfter((__int64)a2, v14);
          if ( !LastTopMostWindow )
            goto LABEL_18;
        }
        if ( !a6
          || *(_QWORD *)(*((_QWORD *)a2 + 2) + 472LL) != *(_QWORD *)(W32GetUserSessionState(v15, v14) + 18944)
          || !(unsigned int)IsLastTopMostWindow(LastTopMostWindow) )
        {
          if ( (unsigned int)IsLastTopMostWindow(LastTopMostWindow)
            ...
            || (v20 = *(_QWORD *)(W32GetUserSessionState(v17, v16) + 18944), *(_QWORD *)(v18 + 472) != v20)
            || a5 != *(struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(v20, v19) + 18944) + 128LL)
