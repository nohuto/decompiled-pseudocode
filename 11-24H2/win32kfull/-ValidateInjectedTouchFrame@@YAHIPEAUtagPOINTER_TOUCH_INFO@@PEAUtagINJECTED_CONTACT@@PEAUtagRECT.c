/*
 * XREFs of ?ValidateInjectedTouchFrame@@YAHIPEAUtagPOINTER_TOUCH_INFO@@PEAUtagINJECTED_CONTACT@@PEAUtagRECT@@I@Z @ 0x14027802C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  while ( (unsigned int)v5 < a1 )
  {
    ...
    if ( !PtInRect(a4, v10) )
    {
      ...
      {
        v15 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, k) + 69416);
      ...
      for ( j = 0LL; ; j = (unsigned int)(j + 1) )
      {
        ...
        if ( ((v25 - 131074) & 0xFFFDFFFF) != 0 )
        {
          ...
          if ( v9 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
          {
            ...
            v15 = *(_QWORD *)(W32GetUserSessionState(18 * j, k) + 69416);
            v31 = 15;
            goto LABEL_80;
          }
          return 0LL;
