/*
 * XREFs of CoreWindowProp::ForEachDescendantInComponentHierarchy__lambda_bb5024e92f2af5f128f82535936e29d6___ @ 0x1400F6490
 * Callers:
    ...
    if ( (unsigned int)CoreWindowProp::IsHost(a1) )
    {
      ...
      if ( NextComponentWindow )
      {
        ...
        do
        {
          ...
          if ( *v6 == 1 )
            v7 = -2LL;
          lambda_febfd44819ec4f1448c7d434538d8b97_::operator()(v5, NextComponentWindow, (_QWORD *)v7);
