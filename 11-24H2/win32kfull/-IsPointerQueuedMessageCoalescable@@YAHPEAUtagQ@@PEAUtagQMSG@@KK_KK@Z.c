/*
 * XREFs of ?IsPointerQueuedMessageCoalescable@@YAHPEAUtagQ@@PEAUtagQMSG@@KK_KK@Z @ 0x1401506F8
 * Callers:
 *     EditionIsPointerQueuedMessageCoalescable @ 0x1401506C0 (EditionIsPointerQueuedMessageCoalescable.c)
 * Callees:
