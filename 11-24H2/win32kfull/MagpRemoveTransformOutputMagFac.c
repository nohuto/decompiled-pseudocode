/*
 * XREFs of MagpRemoveTransformOutputMagFac @ 0x1401104D8
 * Callers:
 *     ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x14010FE84 (-OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z.c)
 *     RemoveMagnificationOutputTransform @ 0x1401104C0 (RemoveMagnificationOutputTransform.c)
 * Callees:
...
int __fastcall MagpRemoveTransformOutputMagFac(float *a1, __int64 a2)
{
  ...
  v4 = *(_QWORD *)(*(_QWORD *)(UserSessionState + 19200) + 232LL);
  if ( v4 )
  {
    LODWORD(UserSessionState) = *(_DWORD *)(v4 + 16);
    if ( (UserSessionState & 2) != 0 )
    {
      LODWORD(UserSessionState) = memcmp((const void *)(v4 + 88), &xmmword_140351350, 0x20uLL);
