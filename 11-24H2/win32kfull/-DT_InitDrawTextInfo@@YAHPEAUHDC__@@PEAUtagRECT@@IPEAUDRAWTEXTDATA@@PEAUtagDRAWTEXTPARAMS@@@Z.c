/*
 * XREFs of ?DT_InitDrawTextInfo@@YAHPEAUHDC__@@PEAUtagRECT@@IPEAUDRAWTEXTDATA@@PEAUtagDRAWTEXTPARAMS@@@Z @ 0x14007DB7C
 * Callers:
        ...
        struct tagDRAWTEXTPARAMS *a5)
{
  ...
  *((_DWORD *)a4 + 6) = (((v31.y ^ v30.y) >> 31) & 0xFFFFFFFE) + 1;
  if ( (a3 & 0x1000) != 0 || (unsigned int)IsSysFontAndDefaultMode(a1) )
  {
    ...
    GreGetTextCharsetInfo(*(HDC *)(*(_QWORD *)(UserSessionState + 57008) + 64LL));
  }
  else
  {
  ...
  *((_DWORD *)a4 + 7) = v20;
  ...
  if ( v21 == *(struct tagTHREADINFO **)(W32GetUserSessionState(v23, v22) + 18704) )
  {
    v25 = 0;
  }
  else
  {
    ...
    v25 = *(_DWORD *)(CurrentProcessWin32Process + 752) & 4;
  }
  *((_DWORD *)a4 + 15) = v25;
  if ( !v25 )
