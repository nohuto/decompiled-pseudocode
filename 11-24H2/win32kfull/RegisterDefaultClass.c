/*
 * XREFs of RegisterDefaultClass @ 0x140239260
 * Callers:
...
__int64 __fastcall RegisterDefaultClass(wchar_t *Str1)
{
  ...
  for ( i = gDefaultServerClasses; ; i += 12 )
  {
    if ( !v5 || (*i & 1) != 0 )
    {
      v10 = (unsigned int)(*(_DWORD *)(*((_QWORD *)v4 + 58) + 840LL) >> v8);
      if ( (v10 & 1) == 0 )
      {
        v6 = 0;
        if ( IntegerAtom )
        {
          ...
          v13 = v35 == *(_WORD *)(*(_QWORD *)(UserSessionState + 19928) + 2LL * (((unsigned int)*i >> 3) & 0x1F) + 868);
        }
        else
        {
...
LABEL_13:
  ...
  {
    if ( *(_QWORD *)(W32GetUserSessionState(hModuleWin, v12) + 21936) )
      v27 = **(_QWORD **)(W32GetUserSessionState(v16, v15) + 21936);
    else
      v27 = 0LL;
  }
  else
  ...
  if ( result )
  {
    *(_DWORD *)(*((_QWORD *)v4 + 58) + 840LL) |= 1 << v8;
    return 1LL;
  }
  return result;
}
