/*
 * XREFs of ?UnselectRedirectionBitmapsInDCEs@@YAXQEAUtagWND@@@Z @ 0x140285424
 * Callers:
 ...
 *     ?WindowMatchesDCE@@YAHQEAUtagWND@@PEBUtagDCE@@@Z @ 0x1401716F0 (-WindowMatchesDCE@@YAHQEAUtagWND@@PEBUtagDCE@@@Z.c)
 */
...
void __fastcall UnselectRedirectionBitmapsInDCEs(struct tagWND *const a1, __int64 a2)
{
  ...
  v9 = *(_QWORD *)(W32GetUserSessionState(v8, v6) + 57008) + 24LL;
  if ( v7 != (struct tagWND *)v9 )
  {
    do
    {
      ...
      v7 = *(struct tagWND **)v7;
      v10 = *(_QWORD *)(W32GetUserSessionState(v11, v9) + 57008) + 24LL;
    }
