/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVSURFMEM@@K@Z @ 0x140305B58
 * Callers:
 ...
 *     ?vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z @ 0x14026A020 (-vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z.c)
...
__int64 __fastcall BLTRECORD::bRotate(BLTRECORD *this, struct SURFMEM *a2, ULONG a3)
{
  ...
  SURFMEM::bCreateDIB(a2, (struct _DEVBITMAPINFO *)v19, 0LL, 0LL, 0, 0LL, 0LL, 0, v8, 0, 0);
  v9 = *(_QWORD *)a2;
  if ( !*(_QWORD *)a2 )
    return 0LL;
  v10 = 16 * v6;
