/*
 * XREFs of xxxSysCommand @ 0x1402B5464
 * Callers:
...
LABEL_85:
                ...
                xxxShowWindowEx(
                  a1,
                  v26 | *(_DWORD *)(UserSessionState + 67056) & 0x10000u,
                  v26 & 0x10000 | *(_DWORD *)(UserSessionState + 67056) & 0x10000);
                return;
              }
...
LABEL_88:
          ...
          case 0xF120u:
            ...
            goto LABEL_85;
          case 0xF130u:
            v42 = *(_QWORD *)(W32GetUserSessionState(v13, v14) + 19928);
          ...
          case 0xF160u:
LABEL_63:
            if ( *(_QWORD *)(*((_QWORD *)a1 + 2) + 472LL) != *(_QWORD *)(W32GetUserSessionState(v13, v14) + 18944) )
              return;
            ...
            **(_DWORD **)v36 |= 0x80000000;
            ...
            LOBYTE(v4) = v6 == 61792;
            xxxMNLoop((unsigned int ***)&BugCheckParameter3, v36, v7, v4);
            goto LABEL_88;
          case 0xF170u:
            if ( v7 == -1 )
            {
