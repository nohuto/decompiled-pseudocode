/*
 * XREFs of _anonymous_namespace_::CheckCanonicalForegroundAccess @ 0x14018817C
 * Callers:
...
char __fastcall anonymous_namespace_::CheckCanonicalForegroundAccess(__int64 a1, __int64 a2)
{
  ...
  if ( !(unsigned int)IsForegroundLocked()
    || (v38 = *(const struct tagPROCESSINFO **)(W32GetUserSessionState(v6, v5) + 18888), *v4 == v38) )
  {
    v7 = 1;
    ...
    if ( !tagTHREADINFO::ComputeAndTestForegroundActivate(v3) )
    {
      ...
      if ( *(_QWORD *)(W32GetUserSessionState(v19, v18) + 18960) )
      {
        v28 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 18960);
