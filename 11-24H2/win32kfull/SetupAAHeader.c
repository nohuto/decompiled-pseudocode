/*
 * XREFs of SetupAAHeader @ 0x14013A8BC
 * Callers:
 *     AAHalftoneBitmap @ 0x14013A0D8 (AAHalftoneBitmap.c)
 * Callees:
 *     CheckBMPNeedFixup @ 0x140139BA0 (CheckBMPNeedFixup.c)
 *     ComputeInputColorInfo @ 0x14013B774 (ComputeInputColorInfo.c)
 *     ComputeAABBP @ 0x14013B984 (ComputeAABBP.c)
 *     ComputeByteOffset @ 0x14013C620 (ComputeByteOffset.c)
 *     _ALIGN_MEM @ 0x1401AA1D8 (_ALIGN_MEM.c)
