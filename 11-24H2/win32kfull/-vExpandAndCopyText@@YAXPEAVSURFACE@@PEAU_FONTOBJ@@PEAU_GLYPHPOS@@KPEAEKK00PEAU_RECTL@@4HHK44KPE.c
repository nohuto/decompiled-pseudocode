/*
 * XREFs of ?vExpandAndCopyText@@YAXPEAVSURFACE@@PEAU_FONTOBJ@@PEAU_GLYPHPOS@@KPEAEKK00PEAU_RECTL@@4HHK44KPEAU_BRUSHOBJ@@PEAU_POINTL@@@Z @ 0x140121B88
 * Callers:
 ...
 *     ?draw_clrt_nf_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x140122540 (-draw_clrt_nf_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z.c)
 ...
 *     ?vSrcOpaqCopyS1D1@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x140184590 (-vSrcOpaqCopyS1D1@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
 ...
 *     ?vSrcOpaqCopyS1D16@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x140306250 (-vSrcOpaqCopyS1D16@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
 *     ?vSrcOpaqCopyS1D4@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x140306420 (-vSrcOpaqCopyS1D4@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
        ...
        struct _POINTL *a19)
{
  ...
  if ( (a14 & 1) != 0 || a4 <= 1 || (unsigned int)(a3->ptl.x - a3[a4 - 1].ptl.x + 0x8000000) <= 0x10000000 )
  {
    ...
    {
      funcs_140122136[a14 & 0xFFFFFF4F](a3, a4, a5, v28, a6, a7, top);
      v29 = a8;
      v30 = a10;
    }
    if ( a16 )
...
LABEL_28:
    ...
    else
    {
      ...
      v32 = (void (__fastcall *)(const unsigned __int8 *, int, int, unsigned __int8 *, int, int, int, int, unsigned int, unsigned int, struct SURFACE *))funcs_140122088[v31];
    }
    p_top = (LONG *)v32;
    for ( i = (LONG *)v64; ; i += 4 )
    {
