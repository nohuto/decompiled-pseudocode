/*
 * XREFs of PsW32ScreenSaver_Show @ 0x1402B5170
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PsW32ScreenSaver_Show(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(a1, a2) + 18944)
    && (v4 = *(_QWORD *)(W32GetUserSessionState(v3, v2) + 18944), *(_QWORD *)(v4 + 128))
    && (v5 = W32GetUserSessionState(v4, v2),
        !IsHungWindow(*(const struct tagTHREADINFO ***)(*(_QWORD *)(v5 + 18944) + 128LL))) )
  {
    v8 = *(_DWORD **)(W32GetUserSessionState(v6, v2) + 19928);
    if ( (*v8 & 0x200) != 0 )
      StartScreenSaver(1LL, v7);
    v9 = *(unsigned int **)(W32GetUserSessionState(v8, v7) + 19928);
    v10 = *v9;
    UserSessionState = W32GetUserSessionState(v9, v11);
    PostMessage(*(_QWORD *)(*(_QWORD *)(UserSessionState + 18944) + 128LL), 274, 61760, (v10 >> 9) & 1);
  }
  else
  {
