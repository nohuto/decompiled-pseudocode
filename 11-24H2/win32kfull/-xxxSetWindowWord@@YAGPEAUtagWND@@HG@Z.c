/*
 * XREFs of ?xxxSetWindowWord@@YAGPEAUtagWND@@HG@Z @ 0x1402DCBD8
 * Callers:
          ...
          if ( (unsigned __int64)(unsigned int)v4 + 2 <= v37 )
          {
            ...
            if ( _bittest16(v38 + 3, 8u) )
            {
              ...
              while ( 1 )
              {
                ...
                if ( (_WORD)v37 == *(_WORD *)(*(_QWORD *)(UserSessionState + 19928)
...
LABEL_72:
  ...
  if ( (v4 & 0x80000000) != 0LL )
    goto LABEL_42;
  v28 = *(_QWORD *)(W32GetUserSessionState(v27, v8) + 19928);
  v29 = *((unsigned __int16 *)a1[5] + 21);
  if ( (int)v4 >= *(unsigned __int16 *)(v28 + 2LL * ((v29 & 0xFFFF2FFF) - 666) + 328)
                - *(unsigned __int16 *)(W32GetUserSessionState(v31, v30) + 71436) )
    goto LABEL_54;
  v32 = a1[5];
