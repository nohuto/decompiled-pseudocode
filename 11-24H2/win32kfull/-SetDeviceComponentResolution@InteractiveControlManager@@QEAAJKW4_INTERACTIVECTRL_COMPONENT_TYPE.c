/*
 * XREFs of ?SetDeviceComponentResolution@InteractiveControlManager@@QEAAJKW4_INTERACTIVECTRL_COMPONENT_TYPE@@JPEAW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1402DF3B8
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  __int64 v11; // r12
  __int64 v12; // rcx
  const char *v14; // [rsp+48h] [rbp-8h] BYREF
  ...
  {
    v14 = "InteractiveControlManager::SetDeviceComponentResolution entry";
  ...
  do
  {
    ...
    {
      v5 = InteractiveControlDevice::SetComponentResolution(v12, v7, v6, a5);
      if ( v5 < 0 && (unsigned int)dword_140398C28 > 2 )
      {
        v14 = "Function failed.";
  ...
  if ( (unsigned int)dword_140398C28 > 4 )
  {
    v14 = "InteractiveControlManager::SetDeviceComponentResolution exit";
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
      (__int64)&dword_140398C28,
