/*
 * XREFs of ?_CheckAllowForeground@CForegroundLaunch@@AEBA_NPEBUtagPROCESSINFO@@@Z @ 0x14028E6F0
 * Callers:
 ...
 *     LockProcessByClientIdEx @ 0x1401B0E60 (LockProcessByClientIdEx.c)
...
char __fastcall CForegroundLaunch::_CheckAllowForeground(CForegroundLaunch *this, const struct tagPROCESSINFO *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v107 != (unsigned int)W32GetCurrentWin32kSessionId() )
    {
      ...
      v70 = *(CInputGlobals **)(W32GetUserSessionState(v64, v18) + 3064);
...
LABEL_102:
    ...
    if ( !v24 )
    {
      v26 = (tagTHREADINFO *)*((_QWORD *)v21 + 41);
...
LABEL_122:
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v83, v52) + 18960)
    && (v90 = *(_QWORD *)(W32GetUserSessionState(v89, v52) + 18960), *(_DWORD *)(v90 + 672) <= 0x400u)
