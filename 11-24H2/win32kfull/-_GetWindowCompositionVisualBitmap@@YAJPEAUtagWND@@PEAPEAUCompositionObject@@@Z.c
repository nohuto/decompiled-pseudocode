/*
 * XREFs of ?_GetWindowCompositionVisualBitmap@@YAJPEAUtagWND@@PEAPEAUCompositionObject@@@Z @ 0x140168E9C
 * Callers:
 ...
 *     ?Initialize@CHwndBitmapProp@@QEAAJXZ @ 0x14020E7E8 (-Initialize@CHwndBitmapProp@@QEAAJXZ.c)
