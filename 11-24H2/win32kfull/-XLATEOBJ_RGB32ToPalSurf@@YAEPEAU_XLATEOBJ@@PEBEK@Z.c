/*
 * XREFs of ?XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z @ 0x14010C070
 * Callers:
...
unsigned __int8 __fastcall XLATEOBJ_RGB32ToPalSurf(struct _XLATEOBJ *a1, const unsigned __int8 *a2, unsigned int a3)
{
  ...
  v7 = a2[((unsigned __int64)BYTE2(a3) >> 3) | (4 * ((32 * (a3 & 0xF8)) | (a3 >> 8) & 0xF8))];
  ...
  if ( (flXlate & 0x800) != 0 )
  {
    ...
    if ( v10 == *((_QWORD *)v6 + 471) )
    {
      ...
      if ( (unsigned __int8)v7 < 0xAu )
        v11 = a2[((unsigned __int64)BYTE2(a3) >> 3) | (4 * ((32 * (a3 & 0xF8)) | (a3 >> 8) & 0xF8))];
      LOBYTE(v7) = v11;
    }
    else
    {
