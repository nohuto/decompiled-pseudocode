/*
 * XREFs of InitializeClientPfnArrays @ 0x1402828A8
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x140298AC0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, __int128 *a2, __int128 *a3, __int64 a4)
{
  ...
  if ( !*(_DWORD *)(UserSessionState + 71168) && a1 )
  {
    ...
    v60 = v16[2];
    v62 = v16[3];
    v17 = (_OWORD *)(*(_QWORD *)(W32GetUserSessionState(v13, v12) + 19928) + 392LL);
    *v17 = v33;
    v17[1] = v36;
    v17[2] = v39;
    v17[3] = v42;
    ...
    *v17 = v55;
    ...
    v61 = v19[2];
    v63 = v19[3];
    v21 = (_OWORD *)(*(_QWORD *)(W32GetUserSessionState(v17, v20) + 19928) + 584LL);
    *v21 = v34;
    v21[1] = v37;
    v21[2] = v40;
    v21[3] = v43;
    ...
    *v21 = v56;
    ...
    v32 = a3[4];
    v27 = *((_QWORD *)a3 + 10);
    v23 = *(_QWORD *)(W32GetUserSessionState(v21, v22) + 19928);
    *(_OWORD *)(v23 + 776) = v28;
    *(_OWORD *)(v23 + 792) = v29;
    *(_OWORD *)(v23 + 808) = v30;
    *(_OWORD *)(v23 + 824) = v31;
    ...
    *(_QWORD *)(v23 + 856) = v27;
    ...
    v54 = a3[7];
    v57 = a3[8];
    v25 = (_OWORD *)(*(_QWORD *)(W32GetUserSessionState(v23, v24) + 19928) + 7504LL);
    *v25 = v35;
    v25[1] = v38;
    v25[2] = v41;
    v25[3] = v44;
    ...
    v25[7] = v54;
    v25[8] = v57;
    *(_QWORD *)(W32GetUserSessionState(v25, v26) + 20512) = a4;
    *(_DWORD *)(UserSessionState + 71168) = 1;
  }
  return 0LL;
}
