/*
 * XREFs of ?xxxUserReinitializeAutoRotation@CRotationMgr@@UEAAXXZ @ 0x140270D60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CRotationMgr::xxxUserReinitializeAutoRotation(CRotationMgr *this)
{
  ...
  *((_DWORD *)this + 2) = QueryAutoRotationRegistrySetting(
  ...
  if ( (unsigned int)dword_140398BB8 > 5 && tlgKeywordOn((__int64)&dword_140398BB8, 0x400000000001LL) )
  {
    v6 = 1;
    v7 = v3;
