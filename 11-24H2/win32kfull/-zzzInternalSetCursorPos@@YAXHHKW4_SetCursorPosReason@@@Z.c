/*
 * XREFs of ?zzzInternalSetCursorPos@@YAXHHKW4_SetCursorPosReason@@@Z @ 0x140093938
 * Callers:
 *     ?zzzSetCursorPos@@YA_NHH@Z @ 0x1400928F0 (-zzzSetCursorPos@@YA_NHH@Z.c)
 *     EditionInternalSetCursorPos @ 0x140093920 (EditionInternalSetCursorPos.c)
...
__int64 __fastcall zzzInternalSetCursorPos(__int64 a1, __int64 a2, int a3, char a4)
{
  ...
  v5 = v39;
  *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19240) = v5;
  v8 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 36296);
  v11 = W32GetUserSessionState(v10, v9) + 19240;
  UserSessionState = W32GetUserSessionState(v13, v12);
  CCursorClip::BoundPoint(v8, v40, *(_QWORD *)(UserSessionState + 19240), 0LL, 1, v11);
  v17 = *(_QWORD *)(W32GetUserSessionState(v16, v15) + 19240);
  v20 = *(_QWORD *)(W32GetUserSessionState(v19, v18) + 19928);
  *(_QWORD *)(v20 + 4960) = v17;
  v22 = *(_QWORD *)(W32GetUserSessionState(v20, v21) + 36360);
  v25 = *(_QWORD *)(W32GetUserSessionState(v24, v23) + 19928);
  v26 = *(_DWORD *)(v25 + 4964);
  v28 = *(_QWORD *)(W32GetUserSessionState(v25, v27) + 19928);
  LODWORD(v8) = *(_DWORD *)(v28 + 4960);
  v30 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v28, v29) + 57008) + 48LL);
  ...
  v33 = *(CCursorSizes **)(W32GetUserSessionState(v32, v31) + 36400);
  v36 = (const struct tagPOINT *)W32GetUserSessionState(v35, v34);
  CCursorSizes::zzzUpdateGlobalCursorSize(v33, v36 + 2405, 0);
