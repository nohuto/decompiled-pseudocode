/*
 * XREFs of ?DrawGrip@@YAHPEAUHDC__@@PEAUtagRECT@@I@Z @ 0x14007BF14
 * Callers:
...
__int64 __fastcall DrawGrip(HDC a1, struct tagRECT *a2, __int16 a3)
{
  ...
  v7 = a2->right - v4;
  v8 = a2->bottom - v4;
  v10 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928);
  if ( (a3 & 0xC000) != 0 )
  {
    v11 = *(_QWORD *)(v10 + 4736);
    v22 = *(_QWORD *)(W32GetUserSessionState(v10, v9) + 19928);
    v13 = *(_DWORD *)(v22 + 4592);
    v15 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v22, v23) + 19928) + 4592LL);
  }
  else
  {
    v11 = *(_QWORD *)(v10 + 4816);
    ...
    v13 = *(_DWORD *)(v12 + 4648);
    v15 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v14) + 19928) + 4632LL);
  }
  left = a2->left;
  top = a2->top;
