/*
 * XREFs of ?SetSystemCursor@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@KPEAU_UNICODE_STRING@@W4InputTracing_SetSystemCursorReason@@PEAGI@Z @ 0x1401DBDF0
 * Callers:
 ...
 *     ?GetCursorOrFrame@InputTraceLogging@@CAPEAUtagCURSOR@@PEAU2@@Z @ 0x140271258 (-GetCursorOrFrame@InputTraceLogging@@CAPEAUtagCURSOR@@PEAU2@@Z.c)
 *     ?SwapReasonToString@InputTraceLogging@@CAPEBDW4InputTracing_SetSystemCursorReason@@@Z @ 0x140271508 (-SwapReasonToString@InputTraceLogging@@CAPEBDW4InputTracing_SetSystemCursorReason@@@Z.c)
 */
        ...
        unsigned int a6)
{
  ...
  if ( (unsigned int)dword_140398B80 > 5 && (qword_140398B90 & 8) != 0 && (qword_140398B98 & 8) == qword_140398B98 )
  {
    if ( a3 )
    {
      ...
      if ( ((unsigned __int64)v10 & 0xFFFFFFFFFFFF0000uLL) == 0 )
      {
        ...
        v10 = a5;
        RtlStringCchPrintfW(a5, 260LL, L"ResourceID %i", v11);
      }
    }
    else
    {
  ...
  if ( result && a1 )
  {
    for ( i = *(_QWORD *)(a1 + 40); i; i = *(_QWORD *)(i + 40) )
    {
      ...
      {
        result = tlgKeywordOn((__int64)&dword_140398B80, 8LL);
        if ( result )
        {
