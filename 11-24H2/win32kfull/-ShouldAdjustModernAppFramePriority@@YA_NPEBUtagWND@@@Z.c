/*
 * XREFs of ?ShouldAdjustModernAppFramePriority@@YA_NPEBUtagWND@@@Z @ 0x14021E260
 * Callers:
  ...
  if ( (v4 & 0x40000) != 0 && (v4 & 0x80000) == 0 && (v4 & 0x100000) == 0 )
  {
    if ( *(_QWORD *)(v2 + 1592) )
    {
      if ( *(const struct tagWND **)(v2 + 1584) == a1 )
      {
        ...
        {
          v8 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 18960);
          if ( *(_QWORD *)(v2 + 472) == *(_QWORD *)(v8 + 472) )
            return *(_QWORD *)(v2 + 464) != *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v8, v7) + 18960) + 464LL);
        }
      }
    }
  }
