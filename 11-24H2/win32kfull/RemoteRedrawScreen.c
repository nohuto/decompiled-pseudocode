/*
 * XREFs of RemoteRedrawScreen @ 0x1401E03FC
 * Callers:
 ...
 *     NtUserRemoteRedrawScreen @ 0x14029BBE0 (NtUserRemoteRedrawScreen.c)
...
__int64 __fastcall RemoteRedrawScreen(void **a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(W32GetUserSessionState(v3, a2) + 69116) )
  {
    v22 = 0;
    ...
    if ( (unsigned int)UserRemoteConnectedSessionUsingWddm() )
    {
      ...
      DrvSetMonitorPowerState(*(_QWORD *)(*(_QWORD *)(v15 + 57008) + 16LL), 1LL, 0LL, v12);
    ...
    else
    {
      ...
      KeSetEvent(*(PRKEVENT *)(v18 + 68696), 1, 0);
    }
    if ( *a1 )
    {
      *(_DWORD *)(W32GetUserSessionState(v17, v16) + 62872) = 0;
      v19 = *((_QWORD *)*a1 + 5);
      if ( (*((_DWORD *)*a1 + 12) & 8) == 0 )
      {
