/*
 * XREFs of ?vSrcTranCopyS8D24Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1400F28D4
 * Callers:
        ...
        else
        {
          ...
          else
          {
            ...
            v32 = v43 & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v31
                                                                          + ((dword_14034F860[*(unsigned __int8 *)(v30 + 4 * v29)]
                                                                            * (v46 - v31)
                                                                            + 0x80000) >> 20))
                                                           + v50) << v38) >> v37);
            ...
            a9 = v45 & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v34
                                                                         + ((dword_14034F860[*(unsigned __int8 *)(v30 + 4 * v29 + 2)]
                                                                           * (v48 - v34)
                                                                           + 0x80000) >> 20))
                                                          + v50) << v42) >> v41) | v44 & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v33 + ((dword_14034F860[*(unsigned __int8 *)(v30 + 4 * v29 + 1)] * (v47 - v33) + 0x80000) >> 20)) + v50) << v40) >> v39) | v32;
            v27 = &a9;
            v25 = v52;
            v19 = v53;
          }
