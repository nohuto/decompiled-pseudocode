/*
 * XREFs of ?xxxProcessMousePromotionQueue@@YAXXZ @ 0x1400A83D8
 * Callers:
 ...
 *     ?DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z @ 0x14024E698 (-DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z.c)
    ...
    if ( *(_QWORD *)v6 )
    {
      ...
      *(_QWORD *)(UserSessionState + 16672) = v10;
      if ( (unsigned int)Feature_EliminateMitRitHandoff2__private_IsEnabledDeviceUsageNoInline() )
        v13 = *(_DWORD *)(W32GetUserSessionState(v12, v11) + 18800) == 0;
      else
      ...
      if ( (unsigned int)Feature_EliminateMitRitHandoff2__private_IsEnabledDeviceUsageNoInline() )
      {
        if ( !v14 )
          goto LABEL_20;
        if ( !*(_DWORD *)(W32GetUserSessionState(v28, v27) + 18800) )
          goto LABEL_30;
