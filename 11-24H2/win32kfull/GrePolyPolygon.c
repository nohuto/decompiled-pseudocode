/*
 * XREFs of GrePolyPolygon @ 0x1401A19F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GrePolyPolygon(HDC a1, struct tagPOINT *a2, int *a3, int a4, unsigned int a5)
{
  unsigned int v6; // ebx
  int v9; // esi
  __int64 v10; // rcx
  ...
  if ( v14[0] )
  {
      ...
      && !(unsigned int)DWMSCREENREADMODIFYWRITEASSIST::bInPathBracket((DWMSCREENREADMODIFYWRITEASSIST *)v15) )
    {
      ...
      if ( (unsigned int)GrepPolyPolygon((struct XDCOBJ *)v14, a2, a3, a4, a5) )
    ...
    v11 = GrepPolyPolygon((struct XDCOBJ *)v14, a2, a3, a4, a5);
    if ( v9 )
    {
