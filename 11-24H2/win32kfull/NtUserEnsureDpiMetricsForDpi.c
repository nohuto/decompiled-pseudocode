/*
 * XREFs of NtUserEnsureDpiMetricsForDpi @ 0x1402947F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserEnsureDpiMetricsForDpi(unsigned __int16 a1)
{
  unsigned int v1; // edi
  __int64 v2; // rbx
  __int64 v3; // rdx
  ...
  {
    LOBYTE(v2) = GetDpiMetricsForDpi((unsigned __int16)v1) != 0;
  }
