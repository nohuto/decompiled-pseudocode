/*
 * XREFs of SetAppImeCompatFlags @ 0x14024EF10
 * Callers:
...
__int64 __fastcall SetAppImeCompatFlags(__int64 a1, const UNICODE_STRING *a2)
{
  ...
  for ( i = 0LL; i < 1; ++i )
  {
    if ( v2 )
      break;
    v13 = 0;
    if ( *(int *)(W32GetUserSessionState(v10, v9) + 68688) > 0 )
    {
      v14 = String1[i];
      while ( 1 )
      {
        UserSessionState = W32GetUserSessionState(v10, v9);
        if ( !RtlCompareUnicodeString(v14, (PCUNICODE_STRING)(*(_QWORD *)(UserSessionState + 68680) + 16LL * v13), 1u) )
          break;
        if ( ++v13 >= *(_DWORD *)(W32GetUserSessionState(v10, v9) + 68688) )
          goto LABEL_19;
      }
      v2 = 1;
    }
