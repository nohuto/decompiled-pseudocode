/*
 * XREFs of ?vArctan@@YAXVEFLOAT@@0AEAV1@AEAJ@Z @ 0x1400ECA58
 * Callers:
 ...
 * Callees:
 *     eFraction @ 0x1400ED234 (eFraction.c)
 */
...
__int64 __fastcall vArctan(unsigned int a1, unsigned int a2, _DWORD *a3, int *a4)
{
  ...
  if ( *(float *)v7.m128i_i32 < 0.0 )
    v7 = (__m128i)_mm_xor_ps((__m128)v7, (__m128)(unsigned int)_xmm);
  if ( *(float *)v7.m128i_i32 > v4.m128_f32[0] )
  {
    v8 = (__m128i)v4;
    v4.m128_i32[0] = v7.m128i_i32[0];
    v7 = v8;
  }
  if ( v4.m128_f32[0] != 0.0 )
  {
    *(float *)v7.m128i_i32 = (float)(*(float *)v7.m128i_i32 * FP_ARCTAN_TABLE_SIZE) / v4.m128_f32[0];
    v12 = _mm_cvtsi128_si32(v7);
