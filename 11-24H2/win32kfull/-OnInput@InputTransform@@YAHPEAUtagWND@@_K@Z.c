/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x14010FE84
 * Callers:
 *     SetManipulationInputTargetTransform @ 0x14010F7D0 (SetManipulationInputTargetTransform.c)
 *     InputTransformOnInput @ 0x14010F820 (InputTransformOnInput.c)
 ...
 *     MagpRemoveTransformOutputMagFac @ 0x1401104D8 (MagpRemoveTransformOutputMagFac.c)
...
__int64 __fastcall InputTransform::OnInput(InputTransform *this, struct tagWND *a2)
{
  ...
  if ( ((unsigned __int8)IsInputThread()
     || (v14 = PtiCurrent(v5, v4), v14 == *(struct tagTHREADINFO **)(W32GetUserSessionState(v16, v15) + 18880)))
...
LABEL_9:
    ...
    W32ReleasePushLockExclusiveEx((struct W32_PUSH_LOCK *)v10, 0LL);
  }
  else
  {
    EtwTraceOnInputXformUpdate(*(_QWORD *)this, a2, 0LL);
