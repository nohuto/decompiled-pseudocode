/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x140153B88
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x140153C30 (RtlUnicodeStringValidateWorker_0.c)
 */
