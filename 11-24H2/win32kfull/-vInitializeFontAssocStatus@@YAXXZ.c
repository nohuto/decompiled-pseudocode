/*
 * XREFs of ?vInitializeFontAssocStatus@@YAXXZ @ 0x14015212C
 * Callers:
          ...
          if ( v11 )
          {
            ...
            if ( v13 )
            {
              *(_QWORD *)(v4 + 9224) = 0LL;
              ...
              if ( (unsigned int)bComputeQuickLookup((struct _QUICKLOOKUP *)(v4 + 9216), *v8, 0) )
                goto LABEL_16;
              v14 = 0;
              v19 = *(_QWORD *)*v8;
              ...
              if ( v21 == *(_DWORD *)(v20[0] + 36LL) )
                v14 = (unsigned int)bComputeQuickLookup((struct _QUICKLOOKUP *)(v4 + 9216), *v8, 0) != 0;
