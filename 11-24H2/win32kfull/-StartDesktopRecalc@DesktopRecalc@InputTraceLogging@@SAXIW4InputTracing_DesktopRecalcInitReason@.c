/*
 * XREFs of ?StartDesktopRecalc@DesktopRecalc@InputTraceLogging@@SAXIW4InputTracing_DesktopRecalcInitReason@@@Z @ 0x1401CB6DC
 * Callers:
...
void InputTraceLogging::DesktopRecalc::StartDesktopRecalc()
{
  ...
  if ( (unsigned int)dword_140398B80 > 4 && tlgKeywordOn((__int64)&dword_140398B80, 0x80000LL) )
  {
    if ( (_DWORD)v1 )
    {
      if ( (_DWORD)v1 == 1 )
