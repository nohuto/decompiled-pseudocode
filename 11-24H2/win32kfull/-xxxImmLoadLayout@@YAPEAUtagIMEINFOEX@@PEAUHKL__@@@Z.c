/*
 * XREFs of ?xxxImmLoadLayout@@YAPEAUtagIMEINFOEX@@PEAUHKL__@@@Z @ 0x1402802C8
 * Callers:
 *     EditionResetIMELayout @ 0x1402A4FB0 (EditionResetIMELayout.c)
 * Callees:
...
struct tagIMEINFOEX *__fastcall xxxImmLoadLayout(__int64 a1, __int64 a2)
{
  ...
  if ( (**(_DWORD **)(W32GetUserSessionState(a1, a2) + 19928) & 4) == 0 && (WORD1(a1) & 0xF000) != 0xE000 )
    return 0LL;
  v3 = 0LL;
