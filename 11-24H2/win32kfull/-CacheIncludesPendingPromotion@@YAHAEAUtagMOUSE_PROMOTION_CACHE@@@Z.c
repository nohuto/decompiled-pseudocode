/*
 * XREFs of ?CacheIncludesPendingPromotion@@YAHAEAUtagMOUSE_PROMOTION_CACHE@@@Z @ 0x1400A9780
 * Callers:
...
__int64 __fastcall CacheIncludesPendingPromotion(struct tagMOUSE_PROMOTION_CACHE *a1, __int64 a2)
{
  ...
  if ( HasPendingPromotion(v5, v4) && *(_WORD *)a1 == *(_WORD *)(UserSessionState + 16640) )
  {
    for ( i = (__int64 *)*((_QWORD *)a1 + 1); i && i != *((__int64 **)a1 + 2); i = (__int64 *)*i )
    {
      if ( *((_DWORD *)i + 8) == *(_DWORD *)(UserSessionState + 16644) )
        return 1LL;
    }
  }
  return 0LL;
