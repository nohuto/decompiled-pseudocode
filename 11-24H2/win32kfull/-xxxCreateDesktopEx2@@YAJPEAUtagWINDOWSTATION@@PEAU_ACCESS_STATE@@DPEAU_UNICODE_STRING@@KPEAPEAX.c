/*
 * XREFs of ?xxxCreateDesktopEx2@@YAJPEAUtagWINDOWSTATION@@PEAU_ACCESS_STATE@@DPEAU_UNICODE_STRING@@KPEAPEAX@Z @ 0x1401E4EC8
 * Callers:
 ...
 *     GetDesktopHeapSize @ 0x1401E54A0 (GetDesktopHeapSize.c)
 */
        ...
        void **a6)
{
  ...
  if ( (v14 & 2) != 0 )
  {
    v47 = *(HANDLE *)(W32GetUserSessionState(v14, v13) + 63584);
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      if ( *(_QWORD *)(W32GetUserSessionState(v18, v17) + 63024) )
      {
        v18 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 63024);
        if ( *((_QWORD *)a1 + 2) == v18 )
          v10 = 1;
      }
      else
    ...
    *((_QWORD *)Object + 16) = DesktopHeap;
        ...
        *((_QWORD *)v28 + 170) &= ~0x40uLL;
        ...
        if ( v29 )
        {
          ...
          *v33 = v33;
          ...
          if ( ++*(_QWORD *)(UserSessionState + 62992) == 0xFFFFFFFFLL )
            *(_QWORD *)(UserSessionState + 62992) = 1LL;
          v38 = W32GetUserSessionState(v36, v35);
          ***((_QWORD ***)Object + 1) = *(unsigned int *)(UserSessionState + 62992) | ((v34 ^ *(_QWORD *)(v38 + 42608)) << 32);
          ...
          *((_QWORD *)Object + 3) = v39 + DesktopHeapSize;
          ...
          if ( !*((_QWORD *)a1 + 2) )
          {
            if ( (*((_DWORD *)a1 + 16) & 4) == 0 )
            {
              ...
              LockObjectAssignment(v50 + 63016, v49);
            }
          ...
          *a6 = Object;
          if ( v10 )
          {
            ...
            LockObjectAssignment(v51 + 62880, v46);
          }
          return 0LL;
        }
    ...
    {
      v26 = *(_DWORD **)(W32GetUserSessionState(v24, v22) + 19928);
      if ( (*v26 & 0x100) != 0 )
      {
        _InterlockedAnd(*(volatile signed __int32 **)(W32GetUserSessionState(v26, v25) + 19928), 0xFFFFFEFF);
