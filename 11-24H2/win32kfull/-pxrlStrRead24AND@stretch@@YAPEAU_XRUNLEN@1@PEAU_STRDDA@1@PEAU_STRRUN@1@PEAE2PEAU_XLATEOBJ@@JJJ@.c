/*
 * XREFs of ?pxrlStrRead24AND@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1401A4B30
 * Callers:
 *     <none>
 * Callees:
...
struct stretch::_XRUNLEN *__fastcall stretch::pxrlStrRead24AND(
        stretch *this,
