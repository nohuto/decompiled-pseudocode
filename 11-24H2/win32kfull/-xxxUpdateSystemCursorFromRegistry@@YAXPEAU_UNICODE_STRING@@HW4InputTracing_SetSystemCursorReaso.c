/*
 * XREFs of ?xxxUpdateSystemCursorFromRegistry@@YAXPEAU_UNICODE_STRING@@HW4InputTracing_SetSystemCursorReason@@@Z @ 0x140133688
 * Callers:
...
__int64 __fastcall xxxUpdateSystemCursorFromRegistry(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  FastGetProfileStringFromIDW(
    a1,
    1LL,
    *(unsigned __int16 *)(UserSessionState + 552 * v3 + 21930),
    &pszFormat,
    SourceString,
    260,
    0);
