/*
 * XREFs of ?CreateForTopologyChange@CRecalcProp@@SA_NPEAUHWND__@@PEAVCMonitorTopology@@W4StartRecalcReason@@@Z @ 0x1401CC36C
 * Callers:
...
char __fastcall CRecalcProp::CreateForTopologyChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v11 == 1 )
  {
    if ( CRecalcProp::HasRestorableState(v10) && !*((_QWORD *)v10 + 6) )
    {
      ...
      LOBYTE(v42) = v6;
      v18 = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 69416);
      v40 = 77;
      goto LABEL_69;
    }
    if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
    ...
    if ( v19 || v4 )
    {
      ...
      LOBYTE(v43) = v6;
      v24 = *(_QWORD *)(W32GetUserSessionState(v21, v20) + 69416);
      v41 = 78;
LABEL_47:
      LOBYTE(v23) = v4;
      LOBYTE(v22) = v19;
  ...
  if ( (*(_DWORD *)(v8 + 380) & 0x10) != 0 )
  {
    ...
    v45 = (unsigned __int8)PsGetThreadId(**(PETHREAD **)(v8 + 16));
    v43 = *(_QWORD *)v8;
    v24 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 69416);
    v41 = 80;
    goto LABEL_47;
  }
  if ( v46 == 1 )
  {
    ...
    ThreadId = (unsigned __int8)PsGetThreadId(**(PETHREAD **)(v8 + 16));
    v42 = *(_QWORD *)v8;
    v18 = *(_QWORD *)(W32GetUserSessionState(v39, v38) + 69416);
    v40 = 81;
LABEL_69:
    LOBYTE(v17) = v13;
    LOBYTE(v16) = v12;
