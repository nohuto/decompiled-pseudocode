/*
 * XREFs of ?DrawDiagonalLine@@YAKPEAUHDC__@@PEAUtagRECT@@HHI@Z @ 0x14022492C
 * Callers:
...
LABEL_29:
        if ( v8 )
          GrePolyPatBlt(v35, 15728673, (struct _POLYPATBLT *)v37, v8);
...
LABEL_25:
      ...
      *(_DWORD *)v19 -= v17;
      if ( v24 == 8 )
      {
        GrePolyPatBlt(v35, 15728673, (struct _POLYPATBLT *)v37, 8);
        v8 = 0;
        v24 = 0LL;
      }
