/*
 * XREFs of ?SetWindowCompositionPassiveUpdateMode@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1402AE4A4
 * Callers:
...
__int64 __fastcall SetWindowCompositionPassiveUpdateMode(
        struct tagWND *a1,
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    v5 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v7[0], 16) == v5 )
    {
      return 0;
    }
    else
    {
      LODWORD(v7[0]) = v7[0] & 0xFFFF7FFF | (v5 << 15);
