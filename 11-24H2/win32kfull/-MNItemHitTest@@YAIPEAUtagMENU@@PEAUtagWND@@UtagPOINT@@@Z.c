/*
 * XREFs of ?MNItemHitTest@@YAIPEAUtagMENU@@PEAUtagWND@@UtagPOINT@@@Z @ 0x1401801B8
 * Callers:
...
LABEL_12:
    if ( (*((_DWORD *)a1 + 31) & 3) != 0 )
    {
      ...
      if ( v13 )
      {
        ...
        while ( v14 < v5 && v20 < *(_DWORD *)(v18 + 68) )
        {
          ...
          if ( v16 >= 0 && v16 < *(_DWORD *)(*(_QWORD *)v13 + 72LL) && v15 >= v20 && v15 < v21 )
            return v14;
          ++v14;
          v20 = v21;
          v19 += 96LL;
    ...
    else
    {
      ...
      while ( v3 < v5 )
      {
        ...
        if ( v7 < v10 + *(_DWORD *)(*(_QWORD *)v9 + 72LL)
          && v8 >= v11
          && v7 >= v10
          && v8 < v11 + *(_DWORD *)(*(_QWORD *)v9 + 76LL) )
        {
          return v3;
        }
        ++v3;
