/*
 * XREFs of xxxInitSendValidateMinMaxInfoEx @ 0x140073DDC
 * Callers:
...
__int64 __fastcall xxxInitSendValidateMinMaxInfoEx(struct tagWND *a1, __int64 a2, struct tagMONITOR *a3)
{
  ...
  __int64 v86; // rax
  __int64 v87; // rax
  __int64 v88; // [rsp+20h] [rbp-60h]
  ULONG_PTR v89; // [rsp+28h] [rbp-58h]
  __m128i v90; // [rsp+30h] [rbp-50h] BYREF
  __int128 v91; // [rsp+40h] [rbp-40h]
  ULONG_PTR v92[2]; // [rsp+50h] [rbp-30h] BYREF
  ULONG_PTR BugCheckParameter3[2]; // [rsp+60h] [rbp-20h] BYREF
  struct tagTHREADINFO *v94; // [rsp+C8h] [rbp+48h]
  __int32 v95; // [rsp+D8h] [rbp+58h]

  v90 = 0LL;
  v94 = PtiCurrent((__int64)a1, a2);
  v8 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 19928);
  *(_DWORD *)a2 = *(_DWORD *)(v8 + 2124);
  *(_DWORD *)(a2 + 4) = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v8, v9) + 19928) + 2128LL);
  v89 = *(_QWORD *)(GetDispInfo() + 104);
  WindowCompositedDpiContext = GetWindowCompositedDpiContext(a1);
  GetMonitorRectForDpi((__m128i *)v92, v11, (WindowCompositedDpiContext >> 8) & 0x1FF);
  v12 = *((_QWORD *)a1 + 3);
  v13 = 0LL;
  v91 = *(_OWORD *)v92;
  if ( v12 )
  ...
  v20 = v90.m128i_i32[0] - WindowBordersWithDpiAwareness;
  v90.m128i_i32[0] = v20;
  v21 = (unsigned int)(WindowBordersWithDpiAwareness - v20 + v90.m128i_i32[2]);
  v90.m128i_i32[1] -= WindowBordersWithDpiAwareness;
  v95 = v90.m128i_i32[1];
  *(_DWORD *)(a2 + 8) = v21;
  v22 = (unsigned int)(WindowBordersWithDpiAwareness - v95);
  *(_DWORD *)(a2 + 12) = v22 + v90.m128i_i32[3];
  ...
  *(_QWORD *)(a2 + 32) = GetMaxTrackSizeForWindow(a1);
  Win32HM_LockIntoThread<1>(v94, v16, BugCheckParameter3);
  v92[0] = *((_QWORD *)v94 + 57);
  *((_QWORD *)v94 + 57) = v92;
  v92[1] = v89;
  HMLockObject(v89);
  xxxSendMessage(a1, 0x24u);
  v37 = *(_QWORD *)(W32GetUserSessionState(v36, v35) + 19928);
  *(_DWORD *)a2 = *(_DWORD *)(v37 + 2124);
  v40 = *(_QWORD *)(W32GetUserSessionState(v37, v38) + 19928);
  *(_DWORD *)(a2 + 4) = *(_DWORD *)(v40 + 2128);
  if ( v17 )
  {
    ...
    GetMonitorRectForDpi(&v90, (__int64)v16, (v51 >> 8) & 0x1FF);
    ...
    else
    {
      ...
      v57 = GetProp((__int64)a1, *(unsigned __int16 *)(v56 + 41398), 1u);
      if ( v57 )
      {
        v74 = *(_DWORD *)(v57 + 16);
      ...
      if ( (int)(v59 + GetDpiDependentMetric(2LL, v61)) <= v53 && *(_DWORD *)(a2 + 12) + *(_DWORD *)(a2 + 20) >= v52 )
        v90 = *(__m128i *)GetMonitorRectForWindow((__int64)&v90, v88, a1);
      v39 = v90.m128i_i64[0];
      v62 = HIDWORD(v90.m128i_i64[1]);
      *(_DWORD *)(a2 + 8) += v91 + v90.m128i_i32[2] - v90.m128i_i32[0] - DWORD2(v91);
      v40 = (unsigned int)(v53 + v62 - HIDWORD(v39) - v52);
      *(_DWORD *)(a2 + 12) += v40;
    }
    *(_DWORD *)(a2 + 16) += v39;
    *(_DWORD *)(a2 + 20) += v90.m128i_i32[1];
  }
  v41 = PtiCurrent(v40, v39);
  Win32HM_UnlockFromThread<0>((ULONG_PTR)v41, v92);
  ...
  if ( (*(_BYTE *)(v45 + 16) & 8) != 0 )
  {
    ...
    else
    {
      ...
      v26 += 4 * *(_DWORD *)(GetDpiServerInfoForCurrentThread() + 16) + 4;
    }
  }
  else
  {
