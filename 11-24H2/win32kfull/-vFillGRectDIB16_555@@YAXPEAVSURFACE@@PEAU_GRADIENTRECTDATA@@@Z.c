/*
 * XREFs of ?vFillGRectDIB16_555@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x140319DF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    do
    {
      ...
      if ( v19 < &v19[*((int *)v2 + 10)] )
      {
        ...
        do
        {
          ...
          v26 = HIDWORD(v15);
          v15 += v31;
          v27 = byte_1403620F0[(unsigned __int64)(v23 + ((unsigned int)v26 >> 3)) >> 16] | (unsigned __int16)(32 * v25);
          v28 = HIDWORD(v17);
          v17 += v32;
