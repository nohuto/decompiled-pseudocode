/*
 * XREFs of ?CreateCaretTimer@@YAXPEAUtagWND@@PEAUtagQ@@@Z @ 0x1400946FC
 * Callers:
...
void __fastcall CreateCaretTimer(struct tagWND *a1, struct tagQ *a2)
{
  ...
  v3 = (int)a1;
  if ( !*((_QWORD *)a2 + 49) && *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 4984LL) != -1 )
  {
    if ( *(_DWORD *)UPDWORDPointer(8226LL) )
    {
      ...
      if ( (*(_DWORD *)(v7 + 2236) & 4) != 0 || !(unsigned int)IsRemoteConnection() )
      {
        ...
        *((_QWORD *)a2 + 49) = SetSystemTimer(
                                 v3,
                                 0xFFFF,
                                 *(_DWORD *)(*(_QWORD *)(UserSessionState + 19928) + 4984LL),
                                 (unsigned int)CaretBlinkProc,
                                 0);
        if ( *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v10, v9) + 19928) + 4984LL) )
        {
          v11 = *(_DWORD *)UPDWORDPointer(8226LL);
          *((_DWORD *)a2 + 90) = v11 / *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v13, v12) + 19928) + 4984LL) + 1;
        }
        else
        {
          *((_DWORD *)a2 + 90) = -1;
