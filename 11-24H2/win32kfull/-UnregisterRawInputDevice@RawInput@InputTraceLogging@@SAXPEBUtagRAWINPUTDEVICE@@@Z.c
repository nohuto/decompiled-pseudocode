/*
 * XREFs of ?UnregisterRawInputDevice@RawInput@InputTraceLogging@@SAXPEBUtagRAWINPUTDEVICE@@@Z @ 0x14012DB50
 * Callers:
...
void __fastcall InputTraceLogging::RawInput::UnregisterRawInputDevice(
