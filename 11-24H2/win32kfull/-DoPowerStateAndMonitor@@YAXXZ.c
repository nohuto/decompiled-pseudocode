/*
 * XREFs of ?DoPowerStateAndMonitor@@YAXXZ @ 0x14018B970
 * Callers:
...
void __fastcall DoPowerStateAndMonitor(__int64 a1, __int64 a2)
{
  ...
  v5 = *(unsigned int *)(UserSessionState + 2968);
  if ( (v5 & 1) != 0
  ...
  EtwTraceIdleStatus();
  if ( *(_DWORD *)(W32GetUserSessionState(v15, v14) + 66136) )
  {
    v18 = *(_DWORD *)(W32GetUserSessionState(v17, v16) + 2680) - 5000;
    if ( v18 > 0 )
    {
      v19 = W32GetUserSessionState(v17, v16);
      if ( CInputGlobals::IsTimeFromLastInputEvent(*(CInputGlobals **)(v19 + 3064), v18) )
      {
        v20 = *(_QWORD *)(W32GetUserSessionState(v17, v16) + 3064);
        v23 = *(CInputGlobals **)(W32GetUserSessionState(v22, v21) + 3064);
        GlobalTickCount = CInputGlobals::GetGlobalTickCount(v20, 1LL);
        if ( GlobalTickCount != CInputGlobals::GetLastInputTime(v23)
          && (!(unsigned int)PowerIsDisplayRequired() || *(_DWORD *)(W32GetUserSessionState(v26, v25) + 19128))
          && (int)PostWinlogonMessage(1024LL, 3LL) >= 0 )
        {
          EtwTraceIdleActionExpiration(6LL, (unsigned int)v18);
          v29 = W32GetUserSessionState(v28, v27);
          CInputGlobals::UpdateGlobalTickCount(*(_QWORD *)(v29 + 3064), 1LL);
          *(_DWORD *)(W32GetUserSessionState(v31, v30) + 3048) = v18;
        }
      }
    }
  }
  if ( *(int *)(W32GetUserSessionState(v17, v16) + 3048) <= 0
    || (v34 = *(CInputGlobals **)(W32GetUserSessionState(v33, v32) + 3064),
        v37 = W32GetUserSessionState(v36, v35),
        !CInputGlobals::IsTimeFromLastInputEvent(v34, *(_DWORD *)(v37 + 3048)))
    || (v38 = *(CInputGlobals **)(W32GetUserSessionState(v33, v32) + 3064),
        v41 = W32GetUserSessionState(v40, v39),
        CInputGlobals::IsTimeFromLastInputEvent(v38, *(_DWORD *)(v41 + 3048) + 10000)) )
  {
    v42 = 0;
    *(_DWORD *)(W32GetUserSessionState(v33, v32) + 3048) = 0;
  }
  else
  {
    v42 = 1;
  ...
  {
    v45 = *(CInputGlobals **)(W32GetUserSessionState(v44, v43) + 3064);
    ...
    if ( CInputGlobals::IsTimeFromLastInputEvent(v45, *(_DWORD *)(v48 + 2680)) && !v42 )
    {
      ...
      if ( (unsigned __int8)CInputGlobals::UpdateGlobalTickCount(*(_QWORD *)(v49 + 3064), 3LL) )
      {
  ...
  if ( (v4[597] || v4[602] || v4[603]) && !v42 )
  {
    if ( (unsigned int)PowerIsDisplayIdleExpired(0LL, &v105) )
    {
      v51 = v105;
      if ( !*(_QWORD *)(W32GetUserSessionState(v44, v43) + 18944)
        || (v55 = *(_QWORD *)(W32GetUserSessionState(v53, v52) + 18944), !*(_QWORD *)(v55 + 128)) )
      {
        *((_QWORD *)&v102 + 1) = v51;
LABEL_39:
        v101 = 0uLL;
    ...
    {
      if ( v4[602] || !(unsigned int)PowerIsDisplayIdleExpired(5000LL, 0LL) )
        goto LABEL_40;
      if ( !*(_QWORD *)(W32GetUserSessionState(v44, v43) + 18944)
        || (v55 = *(_QWORD *)(W32GetUserSessionState(v57, v56) + 18944), !*(_QWORD *)(v55 + 128)) )
      {
        *((_QWORD *)&v102 + 1) = 17LL;
        goto LABEL_39;
      }
    ...
    PostTransformableMessage(*(struct tagWND **)(*(_QWORD *)(v58 + 18944) + 128LL), 0x112u, 0xF170uLL, 2LL, 0);
  }
LABEL_40:
  if ( *(int *)(W32GetUserSessionState(v44, v43) + 2684) > 0 )
  {
    v61 = *(CInputGlobals **)(W32GetUserSessionState(v60, v59) + 3064);
    ...
    if ( CInputGlobals::IsTimeFromLastInputEvent(v61, *(_DWORD *)(v64 + 2684)) )
    {
      ...
      if ( (unsigned __int8)CInputGlobals::UpdateGlobalTickCount(*(_QWORD *)(v65 + 3064), 4LL) )
      {
  ...
  if ( *(int *)(W32GetUserSessionState(v60, v59) + 62856) > 0 )
  {
    v71 = *(CInputGlobals **)(W32GetUserSessionState(v70, v69) + 3064);
    v74 = W32GetUserSessionState(v73, v72);
    if ( CInputGlobals::IsTimeFromLastInputEvent(v71, *(_DWORD *)(v74 + 62856)) )
    {
      if ( *(_DWORD *)(W32GetUserSessionState(v70, v69) + 66140) )
      {
        v77 = *(_QWORD *)(W32GetUserSessionState(v76, v75) + 3064);
        v80 = *(CInputGlobals **)(W32GetUserSessionState(v79, v78) + 3064);
        v81 = CInputGlobals::GetGlobalTickCount(v77, 1LL);
        if ( v81 != CInputGlobals::GetLastInputTime(v80) )
        {
          v82 = W32GetUserSessionState(v70, v69);
          EtwTraceIdleActionExpiration(3LL, *(unsigned int *)(v82 + 62856));
          if ( !(unsigned int)PowerIsDisplayRequired() || *(_DWORD *)(W32GetUserSessionState(v84, v83) + 19128) )
            PostWinlogonMessage(1027LL, 0LL);
        }
      }
      else
      {
        v85 = *(_QWORD *)(W32GetUserSessionState(v76, v75) + 3064);
        v88 = *(CInputGlobals **)(W32GetUserSessionState(v87, v86) + 3064);
  ...
  if ( *(int *)(W32GetUserSessionState(v70, v69) + 2688) > 0 )
  {
       ...
       || v94 < *(_DWORD *)(W32GetUserSessionState(v96, v95) + 2680)) )
    {
      ...
      if ( CInputGlobals::IsTimeFromLastInputEvent(*(CInputGlobals **)(v97 + 3064), v94) )
      {
        v100 = W32GetUserSessionState(v99, v98);
        if ( (unsigned __int8)CInputGlobals::UpdateGlobalTickCount(*(_QWORD *)(v100 + 3064), 5LL) )
          EtwTraceIdleActionExpiration(4LL, (unsigned int)v94);
        if ( !(unsigned int)PowerIsDisplayRequired() && v4[632] == 1 && !(unsigned int)PowerIsDisplayBurstActive(0LL) )
        {
          v102 = 0LL;
          LODWORD(v102) = 7;
          v101 = 0LL;
