/*
 * XREFs of ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x140311348
 * Callers:
 *     STROBJ_bGetAdvanceWidths @ 0x1400AA1E0 (STROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     <none>
 */
