/*
 * XREFs of NtUserSetActiveProcessForMonitor @ 0x140245820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetActiveProcessForMonitor(int a1, __int64 a2)
{
  ...
  _BYTE v21[8]; // [rsp+38h] [rbp-9h] BYREF
  __int64 v22; // [rsp+40h] [rbp-1h]
  _BYTE v23[24]; // [rsp+48h] [rbp+7h] BYREF
...
LABEL_7:
  ...
  {
    CLockProcessByPid::CLockProcessByPid(v23, (unsigned int)v3, 0x2000LL);
    if ( !v24 )
    {
      v12 = 0;
      UserSetLastError(87);
      CLockProcessByPid::~CLockProcessByPid((CLockProcessByPid *)v23, v14);
      goto LABEL_23;
    }
    ...
    if ( !ProcessInfo )
    {
      v12 = 0;
      UserSetLastError(87);
      CLockProcessByPid::~CLockProcessByPid((CLockProcessByPid *)v23, v17);
      goto LABEL_21;
    }
    CLockProcessByPid::~CLockProcessByPid((CLockProcessByPid *)v23, v15);
  }
  else
  {
  ...
  if ( (unsigned int)Feature_ResponsiblePid__private_IsEnabledDeviceUsageNoInline(v18) )
  {
    v22 = 0LL;
    v21[0] = 0;
    AtomicExecutionCheck::Arm((AtomicExecutionCheck *)v21);
