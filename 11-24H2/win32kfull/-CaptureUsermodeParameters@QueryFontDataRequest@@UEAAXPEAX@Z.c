/*
 * XREFs of ?CaptureUsermodeParameters@QueryFontDataRequest@@UEAAXPEAX@Z @ 0x140125F00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateGlyphBitsBuffer@@YA_NKJJKK@Z @ 0x1401ACE48 (-ValidateGlyphBitsBuffer@@YA_NKJJKK@Z.c)
