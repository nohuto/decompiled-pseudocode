/*
 * XREFs of ?vSrcTranCopyS4D24@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1401F09E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( (a5 & 3) == 1 )
    {
      ...
      if ( v208 )
      {
        ...
        else
        {
          ...
          v223 = v215 + v22;
          LOBYTE(v22) = v241;
          v209 = v238 & (HIWORD(v223) << v253) | v240 & ((v220 + v218) >> 16 << v239) | v21 & (((v219 << 16) + v222) >> 16 << v241);
        }
        *v27 = v209;
        v224 = v209 >> 8;
        v27[2] = BYTE2(v209);
        ...
        do
        {
          ...
          if ( v122 )
          {
            ...
            else
            {
              ...
              LOBYTE(v20) = v239;
              v123 = v31 + 7;
              v125 = v240 & (HIWORD(v139) << v239) | v238 & ((v130 + v132) >> 16 << v253) | v21 & (((v136 << 16) + v138) >> 16 << v241);
            }
            v31[6] = v125;
            *v124 = BYTE2(v125);
            *v123 = BYTE1(v125);
      ...
      if ( v250 )
      {
        ...
        if ( v159 )
        {
          ...
          else
          {
            ...
            if ( (int)(v244 - v171) >= 0 )
              v172 = &unk_140353420;
            v173 = v238 & ((v165 + v167) >> 16 << v253) | v21 & (((v171 << 16) + v172[v162] * (v244 - v171)) >> 16 << v241);
            v174 = v170 + v20;
            LOBYTE(v20) = v239;
            v158 = v250;
            v160 = v240 & (HIWORD(v174) << v239) | v173;
          }
          *v31 = v160;
          v31[2] = BYTE2(v160);
          v31[1] = BYTE1(v160);
          ...
          if ( v175 != 1 )
          {
            ...
            if ( v192 )
            {
              ...
              else
              {
                ...
                if ( (int)(v244 - v204) >= 0 )
                  v205 = &unk_140353420;
                v206 = v238 & ((v200 + v198) >> 16 << v253) | v21 & (((v204 << 16) + v205[v195] * (v244 - v204)) >> 16 << v241);
                v207 = v203 + v20;
                LOBYTE(v20) = v239;
                v193 = v240 & (HIWORD(v207) << v239) | v206;
              }
              v31[6] = v193;
              v31[8] = BYTE2(v193);
              v31[7] = BYTE1(v193);
