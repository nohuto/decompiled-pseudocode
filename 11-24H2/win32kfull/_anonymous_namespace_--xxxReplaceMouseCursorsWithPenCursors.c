/*
 * XREFs of _anonymous_namespace_::xxxReplaceMouseCursorsWithPenCursors @ 0x140133280
 * Callers:
...
__int64 __fastcall anonymous_namespace_::xxxReplaceMouseCursorsWithPenCursors(__int64 a1, __int64 a2)
{
  ...
  v10[1] = 0;
  v2 = (char *)&unk_140352C30;
  v3 = 4LL;
  v5 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 2056LL);
  do
  {
    v6 = v2 - 4;
    if ( !v5 )
  ...
  *(_DWORD *)(*(_QWORD *)(result + 36368) + 88LL) = 1;
  return result;
}
