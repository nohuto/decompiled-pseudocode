/*
 * XREFs of xxxTimersProc_Old @ 0x140289ED0
 * Callers:
...
void __fastcall xxxTimersProc_Old(__int64 a1, __int64 a2)
{
  ...
  *(_BYTE *)(W32GetUserSessionState(v3, v2) + 18720) = 0;
  while ( 1 )
  {
    *(_BYTE *)(W32GetUserSessionState(v5, v4) + 18721) = 0;
    v6 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v9 = v6 - *(_DWORD *)(W32GetUserSessionState(v8, v7) + 57624);
    v12 = 0x7FFFFFFF;
    v13 = 0x7FFFFFFF;
    *(_DWORD *)(W32GetUserSessionState(v11, v10) + 57624) = v6;
    v16 = W32GetUserSessionState(v15, v14) + 57584;
    v17 = *(_QWORD **)v16;
    ...
    if ( !*(_BYTE *)(W32GetUserSessionState(v29, v28) + 18721) )
      break;
  ...
  if ( v32 != (_QWORD *)(v16 + 16) )
  {
    ...
    if ( *(_QWORD *)(v16 + 16) != v16 + 16 )
    {
      ...
      while ( v44 != (_QWORD *)v16 )
      {
        ...
        if ( (v45 & 0x20) == 0 )
        {
          v47 = *(_DWORD *)(*(_QWORD *)(v46[3] + 464LL) + 1036LL);
          if ( v47 )
          {
            if ( (v45 & 0x1000) != 0 )
            {
...
LABEL_68:
  *(_DWORD *)(W32GetUserSessionState(v31, v32) + 62776) = v12;
  *(_DWORD *)(W32GetUserSessionState(v57, v56) + 62784) = v13;
  SetDelayableTimer(v12, v13);
  *(_BYTE *)(W32GetUserSessionState(v59, v58) + 62760) = 0;
