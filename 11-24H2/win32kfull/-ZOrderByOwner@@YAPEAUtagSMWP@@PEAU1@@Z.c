/*
 * XREFs of ?ZOrderByOwner@@YAPEAUtagSMWP@@PEAU1@@Z @ 0x14022AC48
 * Callers:
 ...
 *     ?TrackZorder@@YAPEAUtagWND@@PEAUtagWINDOWPOS@@PEAU1@11PEAPEAUHWND__@@2@Z @ 0x14018D304 (-TrackZorder@@YAPEAUtagWND@@PEAUtagWINDOWPOS@@PEAU1@11PEAPEAUHWND__@@2@Z.c)
        ...
        if ( v10 )
        {
          ...
          if ( v10 == 2 )
          {
            ...
            if ( (*(_BYTE *)(*((_QWORD *)v20 + 5) + 24LL) & 8) != 0 && v44 == (HWND)-2LL )
            {
              ...
              {
                WindowWorker = GetWindowWorker(v20, 3LL);
                if ( WindowWorker )
