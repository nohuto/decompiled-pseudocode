/*
 * XREFs of ?DeInitialize@SimpleHapticsController@@QEAAJXZ @ 0x1402EF008
 * Callers:
 ...
 *     ?CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z @ 0x1402EEEE4 (-CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z.c)
 */
