/*
 * XREFs of ?RedirStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1402FE3D0
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX a8)
{
  ...
  HDC v23[18]; // [rsp+70h] [rbp-B8h] BYREF
