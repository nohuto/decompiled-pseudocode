/*
 * XREFs of xxxLoadUserApiHook @ 0x1401D111C
 * Callers:
 *     xxxCreateWindowEx @ 0x14004B6FC (xxxCreateWindowEx.c)
 *     xxxDefWindowProc @ 0x14007E7C0 (xxxDefWindowProc.c)
 *     NtUserLoadUserApiHook @ 0x1401D10E0 (NtUserLoadUserApiHook.c)
...
__int64 __fastcall xxxLoadUserApiHook(__int64 a1, __int64 a2)
{
  ...
  if ( (v9 & 0x80u) == 0LL )
    v11 = *(unsigned int *)(W32GetUserSessionState(v8, v9) + 64256);
  else
    v11 = *(unsigned int *)(W32GetUserSessionState(v8, v9) + 64780);
