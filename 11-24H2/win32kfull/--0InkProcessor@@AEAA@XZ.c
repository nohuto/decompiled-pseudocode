/*
 * XREFs of ??0InkProcessor@@AEAA@XZ @ 0x1402EA548
 * Callers:
 ...
 *     ?AddInkFeedbackProvider@InkFeedbackServer@@QEAAJPEAVInkFeedbackProviderBase@@@Z @ 0x140224644 (-AddInkFeedbackProvider@InkFeedbackServer@@QEAAJPEAVInkFeedbackProviderBase@@@Z.c)
...
InkProcessor *__fastcall InkProcessor::InkProcessor(InkProcessor *this)
{
  ...
  *((_QWORD *)this + 12) = (char *)this + 96;
  if ( IsCurrentSessionHostServiceSession() )
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140398C98);
  *(_QWORD *)this = 0LL;
