/*
 * XREFs of SfnINOUTLPPOINT5 @ 0x14019F860
 * Callers:
        ...
        __int64 a8)
{
  ...
  __int64 v38; // [rsp+E0h] [rbp-88h] BYREF
  int v39; // [rsp+E8h] [rbp-80h]
  __int64 v40; // [rsp+F0h] [rbp-78h]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 65) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(18LL, &v38, 80LL, &Src, v27);
  ...
  *(_QWORD *)(v20 + 80) = v32;
  if ( v18 >= 0 && v27[0] == 24 )
  {
    ...
    if ( !v24 || (*(_DWORD *)(v24 + 84) & 1) == 0 || *(__int128 **)(v24 + 96) != a4 )
    {
      ...
      v35 = 0LL;
      v36 = 0LL;
      RtlCopyFromUser(&v34, v25, 0x28uLL);
      *a4 = v34;
      a4[1] = v35;
      *((_QWORD *)a4 + 4) = v36;
      return v23;
