/*
 * XREFs of ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x140331FD8
 * Callers:
 *     ??0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z @ 0x14026709C (--0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z.c)
 * Callees:
 *     ?isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z @ 0x140331D88 (-isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z.c)
 */
