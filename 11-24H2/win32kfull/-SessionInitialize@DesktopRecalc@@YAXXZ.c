/*
 * XREFs of ?SessionInitialize@DesktopRecalc@@YAXXZ @ 0x140216540
 * Callers:
 *     EditionUserInitialize @ 0x140216510 (EditionUserInitialize.c)
 * Callees:
...
void __fastcall DesktopRecalc::SessionInitialize(DesktopRecalc *this)
{
  ...
  *(_BYTE *)(UserSessionState + 71536) = v11 != 0;
  ...
  *(_QWORD *)(UserSessionState + 71528) = 0LL;
  *(_DWORD *)(UserSessionState + 71496) = 5000;
}
