/*
 * XREFs of ?vApplyMoveData@METAREGION@@AEAAHPEAU_RECTL@@PEAU_POINTL@@PEAVREGION@@@Z @ 0x1401DB914
 * Callers:
 ...
 *     ?vDeleteMoveRegionHelper@METAREGION@@AEAAXXZ @ 0x14033E4C8 (-vDeleteMoveRegionHelper@METAREGION@@AEAAXXZ.c)
 */
