/*
 * XREFs of ?RemoveMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@PEBUtagQ@@@Z @ 0x140171400
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::RemoveMessage(const struct tagQMSG *a1, const struct tagQ *a2)
{
  ...
  if ( (unsigned int)dword_140398B80 > 5 && (qword_140398B90 & 0x10) != 0 && (qword_140398B98 & 0x10) == qword_140398B98 )
  {
    v6 = *((_QWORD *)v3 + 18);
    v5 = a2;
    v4 = v2;
