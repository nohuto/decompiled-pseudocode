/*
 * XREFs of ?vAddJoin@WIDENER@pathwide@@IEAAXH@Z @ 0x1400E8E9C
 * Callers:
 ...
 *     ?bMiterInLimit@WIDENER@pathwide@@IEAAHVEVECTORFX@@@Z @ 0x1400E8E30 (-bMiterInLimit@WIDENER@pathwide@@IEAAHVEVECTORFX@@@Z.c)
 ...
 *     ?bComputeIntersect@pathwide@@YAHPEAVEVECTORFX@@0000@Z @ 0x1400E96CC (-bComputeIntersect@pathwide@@YAHPEAVEVECTORFX@@0000@Z.c)
 *     ?vecInPerp@WIDENER@pathwide@@IEAA?AVEVECTORFX@@XZ @ 0x1400E9F24 (-vecInPerp@WIDENER@pathwide@@IEAA-AVEVECTORFX@@XZ.c)
 *     ?vecOutPerp@WIDENER@pathwide@@IEAA?AVEVECTORFX@@XZ @ 0x1400E9F6C (-vecOutPerp@WIDENER@pathwide@@IEAA-AVEVECTORFX@@XZ.c)
