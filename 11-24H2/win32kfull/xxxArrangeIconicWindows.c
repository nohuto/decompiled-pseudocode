/*
 * XREFs of xxxArrangeIconicWindows @ 0x1402E9D44
 * Callers:
...
__int64 __fastcall xxxArrangeIconicWindows(__int64 a1)
{
  ...
  *(_OWORD *)BugCheckParameter3 = 0LL;
  ...
  v6 = *(_QWORD *)(W32GetUserSessionState(v5, v4) + 19928);
  v7 = *(_DWORD *)(v6 + 2084);
  v9 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v6, v8) + 19928) + 2088LL);
...
LABEL_119:
  ...
  do
  {
    ...
    Prop = (_DWORD *)GetProp(v16, *(unsigned __int16 *)(UserSessionState + 41398), 1u);
    v19 = Prop;
    if ( !Prop )
      goto LABEL_9;
    v20 = Prop[4];
...
LABEL_10:
    ...
    *Prop = *(_DWORD *)(*(_QWORD *)(v16 + 40) + 88LL);
    ...
    v15 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 19928);
...
LABEL_11:
  ...
  v27 = *(_QWORD *)(W32GetUserSessionState(v15, v10) + 19928);
  ...
  {
    v28 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 19928);
    v97 = v7;
    v27 = *(_QWORD *)(W32GetUserSessionState(v30, v29) + 19928);
  ...
  v33 = 2LL;
  if ( (*(_DWORD *)(*(_QWORD *)(v31 + 19928) + 2120LL) & 2) != 0 )
  {
    v34 = *(_QWORD *)(W32GetUserSessionState(2LL, v32) + 19928);
    v85 = v9;
    v33 = *(_QWORD *)(W32GetUserSessionState(v36, v35) + 19928);
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v33, v32) + 19928) + 2120LL) & 4) != 0 )
  {
  ...
  if ( v41 != 1 )
  {
    while ( 1 )
    {
      ...
      v45 = *(_QWORD *)GetProp((__int64)v43, *(unsigned __int16 *)(v44 + 41398), 1u);
      ...
      do
      {
        ...
        v51 = *(_QWORD *)GetProp(v49, *(unsigned __int16 *)(v50 + 41398), 1u);
  ...
  while ( 2 )
  {
    if ( v62 )
    {
      ...
      if ( v66 )
      {
        ...
        v68 = GetProp(v66, *(unsigned __int16 *)(v67 + 41398), 1u);
        if ( v68 )
        {
          *(_DWORD *)(v68 + 16) |= 0x10u;
          *(_QWORD *)v68 = v84;
      ...
      while ( 1 )
      {
        if ( v71 )
        {
          ...
          if ( v73 )
          {
            ...
            v75 = (int *)GetProp(v73, *(unsigned __int16 *)(v74 + 41398), 1u);
            Win32HMThreadLockBase<tagWND,0,0>::Win32HMThreadLockBase<tagWND,0,0>(BugCheckParameter3, v73);
            v78 = *(_QWORD *)(W32GetUserSessionState(v77, v76) + 19928);
            v79 = *(_DWORD *)(v78 + 2128);
            ...
            v70 = (struct tagSMWP *)_DeferWindowPos(
                                      ...
                                      *v75,
                                      v75[1],
                                      *(_DWORD *)(*(_QWORD *)(v81 + 19928) + 2124LL),
                                      v79,
                                      276,
                                      0);
