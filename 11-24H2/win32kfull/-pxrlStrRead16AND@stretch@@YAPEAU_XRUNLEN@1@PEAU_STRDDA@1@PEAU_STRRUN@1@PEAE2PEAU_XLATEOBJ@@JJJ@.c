/*
 * XREFs of ?pxrlStrRead16AND@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140312D20
 * Callers:
 *     <none>
 * Callees:
...
struct stretch::_XRUNLEN *__fastcall stretch::pxrlStrRead16AND(
        stretch *this,
