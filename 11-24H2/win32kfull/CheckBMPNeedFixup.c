/*
 * XREFs of CheckBMPNeedFixup @ 0x140139BA0
 * Callers:
 *     SetupAAHeader @ 0x14013A8BC (SetupAAHeader.c)
 * Callees:
 *     IntersectRECTL @ 0x140139B10 (IntersectRECTL.c)
 *     ComputeByteOffset @ 0x14013C620 (ComputeByteOffset.c)
 *     _local_unwind_0 @ 0x140340210 (_local_unwind_0.c)
...
LABEL_3:
      ...
      *((_QWORD *)&v43 + 1) = *(_QWORD *)(a3 + 12);
      ...
      {
        local_unwind_0(v42, &loc_14013A0CE);
        goto LABEL_55;
      }
      v50 = *(__m128i *)(a2 + 8);
      v51 = *(_OWORD *)(a2 + 24);
...
LABEL_48:
      v9 |= 0x240u;
      *(_DWORD *)v4 = v9;
      v14 = local_unwind_0(v42, &loc_14013A0BB);
LABEL_49:
      v34 = v14;
      v30 = 3 * v14;
      v48 = 3 * v14;
      if ( 3 * v14 <= v15 )
      {
        ...
        if ( v30 + 8 >= v30 )
        {
          ...
          while ( 1 )
          {
            v9 &= ~0x40u;
            *v38 = v9;
            v28 = local_unwind_0(v42, &loc_14013A0CA);
LABEL_40:
            v29 = 4 * v28;
            v49 = v29;
...
LABEL_58:
        local_unwind_0(v42, &loc_14013A0C2);
        goto LABEL_59;
      }
LABEL_5:
      v34 = v15;
  ...
  {
    v31 = local_unwind_0(v42, &loc_14013A0C6);
  }
  switch ( v31 )
  {
    case 0:
