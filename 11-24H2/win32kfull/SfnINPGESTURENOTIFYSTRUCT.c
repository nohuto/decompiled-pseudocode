/*
 * XREFs of SfnINPGESTURENOTIFYSTRUCT @ 0x1402BA2C0
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v14 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned int *)a4, v42, 1, 0x200uLL);
  v18 = result;
  ...
  if ( result )
  {
    ...
    *((_QWORD *)v18 + 2) = 0LL;
    v27 = KeUserModeCallback(114LL, v18, *(unsigned int *)v18, &Src, &v32);
