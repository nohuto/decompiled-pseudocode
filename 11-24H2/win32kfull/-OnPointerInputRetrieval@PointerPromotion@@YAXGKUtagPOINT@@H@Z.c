/*
 * XREFs of ?OnPointerInputRetrieval@PointerPromotion@@YAXGKUtagPOINT@@H@Z @ 0x1400A7748
 * Callers:
 *     PointerPromotionOnPointerInputRetrieval @ 0x1400A7730 (PointerPromotionOnPointerInputRetrieval.c)
 * Callees:
