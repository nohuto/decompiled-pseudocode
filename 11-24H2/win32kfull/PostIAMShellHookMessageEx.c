/*
 * XREFs of PostIAMShellHookMessageEx @ 0x140087650
 * Callers:
...
char __fastcall PostIAMShellHookMessageEx(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(UserSessionState) = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19928) + 2120LL);
            ...
            (_BYTE)UserSessionState) )
      {
        ...
        if ( (_DWORD)v3 != 35 )
        {
          ...
          else
          {
            ...
            if ( *(struct tagWND **)(*(_QWORD *)(UserSessionState + 18944) + 128LL) != CompositeAppFrameWindowOrSelf )
              return UserSessionState;
