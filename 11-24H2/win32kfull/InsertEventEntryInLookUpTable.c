/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x14003DBFC
 * Callers:
 *     _tlgWriteAgg @ 0x14003DA88 (_tlgWriteAgg.c)
 * Callees:
 *     CreateNewEventEntry @ 0x14003CA7C (CreateNewEventEntry.c)
 *     ComputeEventEntryHash @ 0x14003DF3C (ComputeEventEntryHash.c)
 *     CompareEventEntry @ 0x14003DFD4 (CompareEventEntry.c)
 *     DestroyEventEntry @ 0x140226F00 (DestroyEventEntry.c)
 *     AggregateField @ 0x1402F12FC (AggregateField.c)
