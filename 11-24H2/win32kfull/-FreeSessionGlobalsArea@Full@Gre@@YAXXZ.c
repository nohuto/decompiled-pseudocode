/*
 * XREFs of ?FreeSessionGlobalsArea@Full@Gre@@YAXXZ @ 0x1402FA590
 * Callers:
 *     FreeEditionSessionGlobalsArea @ 0x1402FA670 (FreeEditionSessionGlobalsArea.c)
 * Callees:
 *     ?Destroy@CPointerHashTable@NSInstrumentation@@SAXPEAV12@@Z @ 0x14033EC24 (-Destroy@CPointerHashTable@NSInstrumentation@@SAXPEAV12@@Z.c)
 */
