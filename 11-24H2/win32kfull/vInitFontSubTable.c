/*
 * XREFs of vInitFontSubTable @ 0x1403EAAEC
 * Callers:
...
LABEL_4:
  ...
  if ( v6 )
  {
    *(_OWORD *)v6 = xmmword_140356600;
    *(_OWORD *)(v6 + 16) = xmmword_140356610;
    *(_DWORD *)(v6 + 32) = 6684777;
    *(_WORD *)(v6 + 36) = 0;
    v7 = *(_QWORD *)(v3 + 19680);
    *(_OWORD *)(v7 + 64) = xmmword_140356648;
    *(_OWORD *)(v7 + 80) = xmmword_140356658;
    *(_DWORD *)(v7 + 96) = 4587593;
    *(_WORD *)(v7 + 100) = 0;
    v8 = *(_QWORD *)(v3 + 19680);
    *(_OWORD *)(v8 + 130) = xmmword_140356628;
