/*
 * XREFs of ?s_xxxOnWindowRestoreFromMinimizedOld@CRecalcProp@@SA_NPEAUtagWND@@_NPEA_NPEAKPEAUtagRECT@@@Z @ 0x1402C52E0
 * Callers:
        ...
        struct tagRECT *a5)
{
  ...
  int v35; // [rsp+58h] [rbp-39h] BYREF
  unsigned int v36; // [rsp+5Ch] [rbp-35h]
  char v37; // [rsp+60h] [rbp-31h]
  __int64 v38; // [rsp+64h] [rbp-2Dh]
  __int64 v39; // [rsp+70h] [rbp-21h]
  int v40; // [rsp+78h] [rbp-19h]
  __int128 v41; // [rsp+80h] [rbp-11h] BYREF
  __int128 v42; // [rsp+90h] [rbp-1h] BYREF
  ...
  *a5 = 0LL;
  ...
  if ( v37 )
  {
    ...
    *a4 = v36;
    ...
    Prop = GetProp((__int64)a1, *(unsigned __int16 *)(v31 + 41398), 1u);
    if ( Prop )
    {
