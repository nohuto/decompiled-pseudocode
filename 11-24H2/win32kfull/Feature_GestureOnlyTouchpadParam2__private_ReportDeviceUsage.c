/*
 * XREFs of Feature_GestureOnlyTouchpadParam2__private_ReportDeviceUsage @ 0x1402ADD94
 * Callers:
 *     InitializeTouchPadSysParams @ 0x1402ADE00 (InitializeTouchPadSysParams.c)
 * Callees:
