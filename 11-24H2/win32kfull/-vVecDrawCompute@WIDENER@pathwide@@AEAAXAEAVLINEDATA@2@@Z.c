/*
 * XREFs of ?vVecDrawCompute@WIDENER@pathwide@@AEAAXAEAVLINEDATA@2@@Z @ 0x1400EB4FC
 * Callers:
 ...
 * Callees:
 *     ?vDetermineDrawVertex@WIDEPENOBJ@pathwide@@QEAAXAEAVEVECTORFX@@AEAVLINEDATA@2@@Z @ 0x1400EB56C (-vDetermineDrawVertex@WIDEPENOBJ@pathwide@@QEAAXAEAVEVECTORFX@@AEAVLINEDATA@2@@Z.c)
 */
