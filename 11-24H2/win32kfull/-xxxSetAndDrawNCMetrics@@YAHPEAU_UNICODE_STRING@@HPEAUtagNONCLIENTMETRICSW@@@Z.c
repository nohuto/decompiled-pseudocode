/*
 * XREFs of ?xxxSetAndDrawNCMetrics@@YAHPEAU_UNICODE_STRING@@HPEAUtagNONCLIENTMETRICSW@@@Z @ 0x1402900A4
 * Callers:
 ...
 *     MenuRecalc @ 0x140216248 (MenuRecalc.c)
...
__int64 __fastcall xxxSetAndDrawNCMetrics(struct _UNICODE_STRING *a1, int a2, struct tagNONCLIENTMETRICSW *a3)
{
  ...
  v43 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v8, v7) + 19928) + 2124LL);
  v44 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v10, v9) + 19928) + 2128LL);
  v13 = 0LL;
  v15 = *(_QWORD *)(W32GetUserSessionState(v12, v11) + 19928);
  v16 = *(_DWORD *)(v15 + 2400);
  if ( a3 )
  {
    v20 = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 19928);
    v19 = *((_DWORD *)a3 + 5) - *(_DWORD *)(v20 + 2336);
    v18 = *((_DWORD *)a3 + 55) - *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v20, v21) + 19928) + 2388LL);
  }
  else
  {
    if ( a2 == v6 )
  ...
  MenuRecalc(v23, v22);
  v27 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 19928);
  v28 = *(_DWORD *)(SessionDpiServerInfo + 4) + *(_DWORD *)(v27 + 2400) - v6 - v16;
  if ( v16 > 0 )
    goto LABEL_25;
  v27 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 19928);
  if ( *(int *)(v27 + 2400) <= 0 )
  {
    v29 = 0;
    goto LABEL_14;
  ...
  {
LABEL_25:
    if ( *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v27, v26) + 19928) + 2400LL) )
      v29 = v28;
    else
      v29 = -(v6 + v16);
    goto LABEL_14;
  ...
  v29 = *(_DWORD *)(SessionDpiServerInfo + 4)
      + *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v27, v26) + 19928) + 2400LL);
LABEL_14:
  if ( v28 || (v30 = 2LL, v29) )
    v30 = 3LL;
  xxxMetricsRecalc(v30, 0LL, 0, v19, v18, v28, v29);
  v33 = *(_QWORD *)(W32GetUserSessionState(v32, v31) + 19928);
  v34 = *(_DWORD *)(v33 + 2124);
  v37 = *(_QWORD *)(W32GetUserSessionState(v33, v35) + 19928);
