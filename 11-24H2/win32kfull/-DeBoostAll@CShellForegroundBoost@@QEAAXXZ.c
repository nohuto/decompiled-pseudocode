/*
 * XREFs of ?DeBoostAll@CShellForegroundBoost@@QEAAXXZ @ 0x14021EB84
 * Callers:
 *     ?OnDaemonTimerRateChanged@ShellForegroundBoost@@YAX_N@Z @ 0x1401D2090 (-OnDaemonTimerRateChanged@ShellForegroundBoost@@YAX_N@Z.c)
 * Callees:
