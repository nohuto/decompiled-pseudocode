/*
 * XREFs of WPP_RECORDER_SF_q @ 0x14001DE04
 * Callers:
 ...
 *     HUBMISC_GetGenericErrorResponseOnDescriptorFailure @ 0x14002E19C (HUBMISC_GetGenericErrorResponseOnDescriptorFailure.c)
