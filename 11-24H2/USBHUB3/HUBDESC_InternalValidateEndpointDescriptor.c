/*
 * XREFs of HUBDESC_InternalValidateEndpointDescriptor @ 0x1400376D8
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = *a1;
  ...
  v11 = 1;
  v12 = &WPP_a44667569f5231a010562af7f2d218c1_Traceguids;
  if ( *v5 == 1 )
  {
LABEL_85:
    if ( !*v5 )
...
LABEL_19:
    ...
    if ( *a3 > v10 )
    {
      ...
      {
        LODWORD(v50) = v9;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x23u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50);
      }
      v15 = 83LL;
LABEL_31:
    ...
    if ( (*(_DWORD *)(a2 + 256) & 1) == 0 )
    {
      ...
      {
        LODWORD(v50) = v9;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x24u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50);
      }
      v15 = 85LL;
      goto LABEL_31;
    }
    ...
    else
    {
      ...
      {
        LODWORD(v50) = v9;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x25u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50);
      }
      v16 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v17 = (_QWORD *)(a2 + 40);
    ...
    if ( (a1[2] & 0x70) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v51) = a1[2];
        LODWORD(v50) = v9;
        WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x26u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
      }
      (*v16)(*v17, 84LL);
      v16 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v17 = (_QWORD *)(a2 + 40);
    ...
    if ( (a1[3] & 0xC0) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v51) = v9;
        LODWORD(v50) = a1[3];
        WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x27u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
      }
      v16 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v17 = (_QWORD *)(a2 + 40);
...
LABEL_76:
            ...
            ++*(_BYTE *)(a2 + 185);
            *(_QWORD *)(a2 + 192) = a1;
            *(_DWORD *)(a2 + 256) = v25 & 0xFFFFFFDB | 4;
            goto LABEL_85;
          }
          v21 = *(_DWORD *)(a2 + 4);
          if ( v21 )
        ...
        if ( (v18 & 0xFFFFFFFC) != 0 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v51) = v9;
            LODWORD(v50) = a1[3];
            WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x39u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
          }
        ...
        if ( !v31 )
        {
          *v5 = 2;
          ...
          {
            LODWORD(v50) = v9;
            WPP_RECORDER_SF_d(a5, 2u, 5u, 0x3Au, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50);
          }
          v24 = 30LL;
          goto LABEL_74;
        }
...
LABEL_168:
          LODWORD(v51) = v9;
          LODWORD(v50) = *((unsigned __int16 *)a1 + 2);
          WPP_RECORDER_SF_dD(a5, 2u, 5u, v34, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
LABEL_169:
          v24 = 32LL;
LABEL_74:
...
LABEL_289:
      ...
      if ( !*(_BYTE *)(a2 + 81) && v20 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LODWORD(v50) = v9;
          WPP_RECORDER_SF_dD(a5, 3u, 5u, 0x3Eu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
        }
      ...
      if ( v38 )
      {
        ...
        if ( v39 )
        {
          ...
          if ( v40 )
          {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v51) = v9;
              LODWORD(v50) = a1[6];
              WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x47u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
            }
          }
          else
          {
            ...
            if ( (v20 & 0x7FFu) <= 0x400 )
            {
              if ( (unsigned int)Feature_EUSB2__private_IsEnabledDeviceUsageNoInline() && (v20 & 0x7FF) == 0 )
                *(_DWORD *)(a2 + 256) |= 0x10u;
            }
            else
            {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v51) = v9;
              LODWORD(v50) = a1[6];
              WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x45u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
            }
          }
        ...
        if ( *((_WORD *)a1 + 2) > 0x3FFu )
        {
          *v5 = 2;
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v51) = v9;
            LODWORD(v50) = *((unsigned __int16 *)a1 + 2);
            WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x40u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
          }
          v16 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
          v17 = (_QWORD *)(a2 + 40);
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LODWORD(v51) = v9;
          LODWORD(v50) = a1[6];
          WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x41u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
        }
        v41 = 112LL;
      }
      else
      {
        *v5 = 2;
        ...
        {
          LODWORD(v50) = v9;
          WPP_RECORDER_SF_d(a5, 2u, 5u, 0x3Fu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50);
        }
        v41 = 111LL;
      }
LABEL_246:
    ...
    if ( (v18 & 0xFFFFFFFC) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v51) = v9;
        LODWORD(v50) = a1[3];
        WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x28u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
        v17 = v57;
        v16 = v42;
      }
    ...
    if ( v43 )
    {
      ...
      if ( !v44 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LODWORD(v51) = v9;
          LODWORD(v50) = *((unsigned __int16 *)a1 + 2);
          WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x2Au, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
        }
        v24 = 68LL;
        goto LABEL_74;
      }
    ...
    LODWORD(v51) = v9;
    LODWORD(v50) = *((unsigned __int16 *)a1 + 2);
    WPP_RECORDER_SF_dD(a5, 2u, 5u, v46, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v50, v51);
LABEL_267:
    v41 = 68LL;
    goto LABEL_246;
  }
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(a5, 2u, 7LL, 0x20u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, *a1, v9, 7);
    goto LABEL_85;
  }
LABEL_86:
  v11 = 0;
  ...
  {
    LOBYTE(v12) = 2;
    WPP_RECORDER_SF_(a5, (_DWORD)v12, 5, 73, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v11;
}
