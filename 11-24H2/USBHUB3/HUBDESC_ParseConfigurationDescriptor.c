/*
 * XREFs of HUBDESC_ParseConfigurationDescriptor @ 0x14003CA10
 * Callers:
...
LABEL_13:
        if ( v17 )
        {
          ...
          else
          {
            ...
            {
              LOBYTE(v15) = 2;
              WPP_RECORDER_SF_(a9, v15, 5, 12, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
            }
          }
        }
      }
...
LABEL_21:
        LOBYTE(v15) = 2;
        WPP_RECORDER_SF_(a9, v15, 5, v19, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
LABEL_22:
        v17 = 0LL;
      }
LABEL_40:
