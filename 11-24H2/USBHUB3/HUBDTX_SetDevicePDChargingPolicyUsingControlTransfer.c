/*
 * XREFs of HUBDTX_SetDevicePDChargingPolicyUsingControlTransfer @ 0x14002C11C
 * Callers:
 *     HUBDSM_SettingDevicePDChargingPolicy @ 0x1400246F0 (HUBDSM_SettingDevicePDChargingPolicy.c)
 * Callees:
