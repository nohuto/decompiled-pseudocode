/*
 * XREFs of wil_details_RecordCachedUsage @ 0x140002778
 * Callers:
 *     wil_details_OnFeatureUsageProviderFlushNotification @ 0x140079660 (wil_details_OnFeatureUsageProviderFlushNotification.c)
 * Callees:
