/*
 * XREFs of HUBDESC_InternalValidateIADescriptor @ 0x1400390C0
 * Callers:
        ...
        __int64 a5)
{
  ...
  LODWORD(v9) = *a1;
  *a3 = v9;
  v15 = &WPP_a44667569f5231a010562af7f2d218c1_Traceguids;
...
LABEL_14:
    ...
    if ( *a3 <= v14 )
    {
      ...
      {
        LODWORD(v21) = v11;
        WPP_RECORDER_SF_d(v13, 2u, 5u, 0x85u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v21);
      }
      v17 = 96LL;
    }
    else
    {
      ...
      {
        LODWORD(v21) = v11;
        WPP_RECORDER_SF_d(v13, 2u, 5u, 0x81u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v21);
      }
      v17 = 94LL;
    }
...
LABEL_65:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v13, 2u, v16, 0x7Fu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v11, *a1, 8);
    goto LABEL_65;
  }
LABEL_66:
  v18 = 0;
  ...
  {
    LOBYTE(v12) = 2;
    WPP_RECORDER_SF_(v13, v12, 5, 134, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v18;
}
