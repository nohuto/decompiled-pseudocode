/*
 * XREFs of HUBMISC_ParseAndWriteCustomPropertiesInRegistry @ 0x140085E24
 * Callers:
 *     HUBDSM_WritingCustomPropertiesInRegistry @ 0x1400261A0 (HUBDSM_WritingCustomPropertiesInRegistry.c)
 * Callees:
