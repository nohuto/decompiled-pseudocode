/*
 * XREFs of HUBDESC_InternalValidateInterfaceDescriptor @ 0x140039500
 * Callers:
...
LABEL_19:
        ...
        if ( v20 )
        {
          if ( _bittest64(*(const signed __int64 **)(a2 + 216), v18) )
          {
            ...
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v26) = v18;
              LODWORD(v25) = v12;
              WPP_RECORDER_SF_dD(a5, 2u, 5u, 0x78u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25, v26);
            }
    ...
    else
    {
      ...
      {
        LODWORD(v25) = v12;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x77u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      }
...
LABEL_85:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(a5, 2u, v15, 0x74u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, *a1, v12, 9);
    goto LABEL_85;
  }
LABEL_86:
  v11 = 0;
  ...
  {
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_(a5, v16, 5, 125, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v11;
}
