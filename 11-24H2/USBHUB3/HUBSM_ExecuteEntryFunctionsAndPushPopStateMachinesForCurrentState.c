      ...
      if ( v20 <= 0xFC7 )
      {
        if ( v20 != 4039 )
        {
          ...
          if ( !v30 )
          {
            ...
            {
              if ( (*(_DWORD *)(*(_QWORD *)(v40 + 1328) + 1644LL) & 0x400) != 0 )
              {
                if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                {
                  LOBYTE(v29) = 4;
                ...
                _InterlockedAnd((volatile signed __int32 *)(*(_QWORD *)(v40 + 1328) + 1644LL), 0xFFFFFBFF);
              }
            }
            else
            {
...
LABEL_54:
      ...
      {
        v34 = *(_QWORD *)(a1 + 960);
        if ( (*(_DWORD *)(v34 + 1644) & 0x80u) != 0 )
        {
          v36 = a1 + 1012;
          *(_OWORD *)(a1 + 1012) = *(_OWORD *)(v34 + 2184);
LABEL_56:
          if ( g_IoSetActivityIdIrp )
          {
            g_IoSetActivityIdIrp(*(_QWORD *)(v34 + 272), v36);
            if ( g_IoSetActivityIdIrp )
              g_IoSetActivityIdIrp(*(_QWORD *)(v34 + 432), v36);
          }
          _InterlockedOr((volatile signed __int32 *)(v34 + 1644), 0x40u);
        }
      }
LABEL_60:
      v15 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 840));
