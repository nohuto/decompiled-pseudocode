/*
 * XREFs of HUBID_BuildContainerID @ 0x14001E8DC
 * Callers:
 ...
 *     RtlUnicodeStringCbCatStringN @ 0x14001F6D0 (RtlUnicodeStringCbCatStringN.c)
...
LABEL_33:
        ...
        {
          Property = RtlStringFromGUID((const GUID *const)(a1 + 2072), &GuidString);
          if ( Property >= 0 )
