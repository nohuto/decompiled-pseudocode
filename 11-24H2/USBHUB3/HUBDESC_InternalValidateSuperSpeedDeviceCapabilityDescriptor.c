/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedDeviceCapabilityDescriptor @ 0x14003A9A4
 * Callers:
...
LABEL_16:
    ...
    if ( *v32 > v17 )
    {
      ...
      {
        LODWORD(v28) = v15;
        WPP_RECORDER_SF_d(v14, 2u, 5u, 0xCFu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
      }
      v21 = 140LL;
      goto LABEL_30;
    }
    if ( (a1[3] & 0xFD) != 0 )
    {
      ...
      {
        LODWORD(v28) = a1[3];
        WPP_RECORDER_SF_d(v14, 2u, 5u, 0xD0u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
      }
    ...
    if ( (*((_WORD *)a1 + 2) & 0xFFF0) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(v14, 2u, 5u, 0xD1u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
      }
    ...
    if ( !*((_WORD *)a1 + 2) )
    {
      *v9 = 2;
      ...
      {
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_(v14, v16, 5, 210, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      }
...
LABEL_63:
        ...
        if ( (unsigned __int8)v25 < 0xBu )
        {
          if ( a5 )
          {
            *a5 = v25;
            ...
            {
              LODWORD(v28) = a1[7];
              WPP_RECORDER_SF_d(v14, 4u, 5u, 0xD6u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
            }
          }
        }
        else
        {
          ...
          {
            LODWORD(v28) = a1[7];
            WPP_RECORDER_SF_d(v14, 2u, 5u, 0xD5u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
          }
          ...
          if ( a6 )
          {
            *a6 = v26;
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              ...
              WPP_RECORDER_SF_d(v14, 4u, 5u, 0xD8u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
            }
          }
          goto LABEL_83;
        }
        ...
        {
          LODWORD(v28) = *((unsigned __int16 *)a1 + 4);
          WPP_RECORDER_SF_d(v14, 2u, 5u, 0xD7u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
        }
        v21 = 139LL;
LABEL_30:
...
LABEL_84:
      ...
      *v9 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LODWORD(v28) = a1[6];
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0xD4u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28, v29);
      }
      v23 = 141LL;
    }
    else
    {
      ...
      {
        LODWORD(v28) = a1[6];
        WPP_RECORDER_SF_d(v14, 2u, 5u, 0xD3u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v28);
      }
      v23 = 142LL;
    }
  ...
  *v9 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v14, 2u, v18, 0xCDu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v15, *a1, 10);
    goto LABEL_84;
  }
LABEL_85:
  v22 = 0;
  ...
  {
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_(v14, v16, 5, 217, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v22;
}
