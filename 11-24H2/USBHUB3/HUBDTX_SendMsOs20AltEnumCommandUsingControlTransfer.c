/*
 * XREFs of HUBDTX_SendMsOs20AltEnumCommandUsingControlTransfer @ 0x14002BE5C
 * Callers:
 *     HUBDSM_SendingMsOs20AltEnumCmdOnReenum @ 0x140024050 (HUBDSM_SendingMsOs20AltEnumCmdOnReenum.c)
 * Callees:
