/*
 * XREFs of HUBACPI_GetAcpiPortAttributes @ 0x14008DA24
 * Callers:
...
__int64 __fastcall HUBACPI_GetAcpiPortAttributes(__int64 a1)
{
  ...
  if ( v9 == -1073741637 )
  {
    ...
    {
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2536), v10, 3, 43, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
    }
    goto LABEL_4;
  }
  if ( v9 != -2147483643 )
  ...
  {
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2536), v10, 3, 44, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
  }
...
LABEL_23:
    ...
    v12 = 45;
LABEL_22:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2536), 2, 3, v12, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
    goto LABEL_23;
  }
