/*
 * XREFs of HUBMISC_CheckIfU2ShouldBeSetForEnumeratedDevice @ 0x14002E754
 * Callers:
 *     HUBDSM_ComputingLPMTimeoutValuesInUnconfigured @ 0x1400214E0 (HUBDSM_ComputingLPMTimeoutValuesInUnconfigured.c)
