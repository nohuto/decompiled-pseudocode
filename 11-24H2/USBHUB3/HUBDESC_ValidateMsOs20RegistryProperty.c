/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x14003FAA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20RegistryProperty(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( *a3 >= 0xDu )
  {
    ...
    if ( v8 >= v7 + 11 )
    {
      ...
      else
      {
        ...
        if ( v8 >= (unsigned __int64)a3[3] + v9 + 10 )
        {
          if ( (_WORD)v9 )
          {
  ...
  {
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v10, 5, 351, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v5;
}
