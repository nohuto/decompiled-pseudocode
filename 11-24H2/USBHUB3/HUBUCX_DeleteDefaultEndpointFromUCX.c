/*
 * XREFs of HUBUCX_DeleteDefaultEndpointFromUCX @ 0x140026BAC
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30 @ 0x140021B70 (HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30.c)
 * Callees:
