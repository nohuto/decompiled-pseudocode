/*
 * XREFs of HUBUCX_StartDeviceIoUsingUCXIoctl @ 0x140028BAC
 * Callers:
 *     HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake @ 0x140024D30 (HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake.c)
 * Callees:
...
__int64 __fastcall HUBUCX_StartDeviceIoUsingUCXIoctl(_QWORD *a1)
{
  ...
  *(_QWORD *)(v2 + 16) = a1[3];
  result = HUBUCX_SubmitUcxIoctl(a1, 4788275LL);
