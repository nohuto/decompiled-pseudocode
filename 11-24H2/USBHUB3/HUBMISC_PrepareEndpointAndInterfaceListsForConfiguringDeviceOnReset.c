/*
 * XREFs of HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnReset @ 0x140031444
 * Callers:
 *     HUBDSM_PreparingEndpointAndInterfaceListsOnClientReset @ 0x140023550 (HUBDSM_PreparingEndpointAndInterfaceListsOnClientReset.c)
 * Callees:
 *     <none>
 */
  ...
  *(_DWORD *)(a1 + 128) = 0;
  ...
  if ( v4 != (_QWORD *)*v4 )
  {
    do
    {
      ...
      {
        v7 = *(_QWORD *)(v5 + 80 * i + 40);
        if ( (*(_DWORD *)(v5 + 80 * i + 52) & 1) != 0 )
        {
          *(_DWORD *)(v5 + 80 * i + 48) = 6;
