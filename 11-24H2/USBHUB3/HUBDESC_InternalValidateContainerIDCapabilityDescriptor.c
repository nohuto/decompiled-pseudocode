/*
 * XREFs of HUBDESC_InternalValidateContainerIDCapabilityDescriptor @ 0x140036EB0
 * Callers:
...
LABEL_9:
    if ( *a1 > 0x14u )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LODWORD(v19) = *a1;
        LODWORD(v18) = v10;
        WPP_RECORDER_SF_DDD(v8, 2u, v14, 0x8Cu, v16, v18, v19, v20);
      }
    ...
    if ( *v22 <= v11 )
    {
      if ( a1[3] )
      {
        ...
        {
          LODWORD(v18) = a1[3];
          WPP_RECORDER_SF_d(v8, 2u, 5u, 0x8Eu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v18);
        }
        (*(void (__fastcall **)(_QWORD, __int64))(v6 + 24))(*(_QWORD *)(v6 + 40), 66LL);
      }
      if ( *(_QWORD *)(a1 + 4) == *(_QWORD *)&GUID_NULL.Data1 && *(_QWORD *)(a1 + 12) == *(_QWORD *)GUID_NULL.Data4 )
      {
        *(_BYTE *)(*(_QWORD *)(v6 + 80) + 41LL) = 1;
        ...
        {
          LOBYTE(a2) = 2;
          WPP_RECORDER_SF_(v8, a2, 5, 143, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
        }
        (*(void (__fastcall **)(_QWORD, __int64))(v6 + 32))(*(_QWORD *)(v6 + 40), 153LL);
      }
    }
    else
    {
      ...
      {
        LODWORD(v18) = v10;
        WPP_RECORDER_SF_d(v8, 2u, 5u, 0x8Du, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v18);
      }
      (*(void (__fastcall **)(_QWORD, __int64))(v6 + 24))(*(_QWORD *)(v6 + 40), 65LL);
    }
LABEL_35:
    if ( !*v5 )
      return v9;
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v8, 2u, v12, 0x8Bu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v10, *a1, 20);
    goto LABEL_35;
  }
LABEL_36:
  v9 = 0;
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(v8, a2, 5, 144, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v9;
}
