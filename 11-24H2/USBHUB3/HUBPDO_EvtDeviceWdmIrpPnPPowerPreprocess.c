/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpPnPPowerPreprocess @ 0x1400166A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceWdmIrpPnPPowerPreprocess(__int64 a1, IRP *a2)
{
  ...
  if ( CurrentStackLocation->MajorFunction == 22 )
  {
    ...
    v3 = *(_QWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
                       ...
                       off_14006C0F8)
                   + 24);
    if ( CurrentStackLocation->Parameters.Read.ByteOffset.LowPart == 4 && *(_DWORD *)(v3 + 2468) == 3 )
    {
    ...
    if ( LowPart > 1 )
      *(_DWORD *)(v3 + 2716) = LowPart;
    *(_DWORD *)(v3 + 2468) = CurrentStackLocation->Parameters.Read.ByteOffset.LowPart;
LABEL_51:
...
LABEL_52:
  ...
  if ( MinorFunction > 0xC )
  {
    ...
    if ( !v14 )
    {
      HUBPDO_DispatchWdmPnpPowerIrpSynchronously(a1, (__int64)a2);
