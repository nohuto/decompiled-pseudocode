/*
 * XREFs of HUBDESC_ValidateConfigurationDescriptorSet @ 0x14003DA10
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  *(_QWORD *)&v21[3] = v10;
  ...
  if ( !a1 )
  {
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_(a4, (_DWORD)v12, 5, 135, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
    v13 = 60LL;
LABEL_7:
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x88u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v5, 9);
    v13 = 56LL;
    goto LABEL_7;
  }
...
LABEL_49:
  ...
  {
    LOBYTE(v14) = 2;
    WPP_RECORDER_SF_(a4, v14, 5, 137, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v15;
}
