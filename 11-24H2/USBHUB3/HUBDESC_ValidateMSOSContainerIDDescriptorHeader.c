/*
 * XREFs of HUBDESC_ValidateMSOSContainerIDDescriptorHeader @ 0x14003E3B4
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSContainerIDDescriptorHeader(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 == 8 )
  {
    ...
    if ( *(_WORD *)(a1 + 6) != 6 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x113u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v12, v13);
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v13) = 24;
      LODWORD(v12) = *v10;
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x114u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v12, v13);
      v8 = v14;
      v9 = v15;
    }
    (*v8)(*v9, 118LL);
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a4, 2u, 5u, 0x111u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, a2);
...
LABEL_20:
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_(a4, v7, 5, 277, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v6;
}
