/*
 * XREFs of HUBPDO_RegisterPortPLDRCapability @ 0x140083D50
 * Callers:
...
__int64 __fastcall HUBPDO_RegisterPortPLDRCapability(__int16 *a1)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a1 + 40LL) & 0x40000) != 0 && (*((_DWORD *)a1 + 410) & 0x20) != 0 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( DeviceResetInterface >= 0 )
      {
                             ...
                             1LL) )
        {
          ...
          {
            v17 = (unsigned __int16)a1[1003];
            v13 = (unsigned __int16)a1[1002];
            WPP_RECORDER_SF_dD(
          ...
          if ( (unsigned int)dword_14006C1F8 > 2 )
          {
            ...
            if ( v2 )
            {
              ...
              v34 = 2LL;
              v36 = 12LL;
              tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_1400675D9, 0LL, 0LL, 7u, v26);
            }
          }
          v6 = -1073741762;
        }
        else
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            v18 = (unsigned __int16)a1[1003];
            v14 = (unsigned __int16)a1[1002];
            WPP_RECORDER_SF_dD(
              *(_QWORD *)(*((_QWORD *)a1 + 1) + 1432LL),
              4u,
              5u,
          ...
          if ( (unsigned int)dword_14006C1F8 > 4 )
          {
            ...
            if ( v2 )
            {
              ...
              v34 = 2LL;
              v36 = 12LL;
              tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067511, 0LL, 0LL, 7u, v26);
            }
          }
        }
      }
      else
      {
        ...
        if ( (unsigned int)dword_14006C1F8 > 2 )
        {
          ...
          if ( v2 )
          {
            ...
            v38 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067EC9, 0LL, 0LL, 8u, v26);
          }
        }
        v6 = -1073741808;
      }
    ...
    else
    {
      ...
      if ( (unsigned int)dword_14006C1F8 > 2 )
      {
        ...
        if ( v2 )
        {
          ...
          v34 = 2LL;
          v36 = 12LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067575, 0LL, 0LL, 7u, v26);
        }
      }
      v6 = -1073741810;
    }
  ...
  else
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v19 = (unsigned __int16)a1[1003];
      v15 = (unsigned __int16)a1[1002];
      WPP_RECORDER_SF_dD(
        *(_QWORD *)(*((_QWORD *)a1 + 1) + 1432LL),
        2u,
        5u,
      ...
      && (qword_14006C210 & 0x400000000001LL) == qword_14006C210 )
    {
      ...
      v34 = 2LL;
      v36 = 12LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067B5F, 0LL, 0LL, 7u, v26);
    }
