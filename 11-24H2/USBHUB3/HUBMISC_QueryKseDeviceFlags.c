/*
 * XREFs of HUBMISC_QueryKseDeviceFlags @ 0x140033198
 * Callers:
 ...
 *     RtlStringCbPrintfW @ 0x14001D2D4 (RtlStringCbPrintfW.c)
...
LABEL_12:
        LODWORD(v33) = result;
        result = WPP_RECORDER_SF_d(a16, 2u, 5u, v23, (__int64)&WPP_dde998bf8bb3310d95d4227a99ba80b7_Traceguids, v33);
        goto LABEL_59;
      }
      goto LABEL_59;
    }
