/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x1400101FC
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x1400100D4 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x14000FDE0 (wil_details_FeatureReporting_RecordUsageInCache.c)
