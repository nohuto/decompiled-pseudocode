...
__int64 __fastcall HUBHSM_QueueingPortStatusChangeEvents(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 960);
  v2 = 0;
  v3 = RtlNumberOfSetBits((PRTL_BITMAP)(v1 + 1152));
  if ( !v3 )
  {
    *(_BYTE *)(v1 + 1128) = 1;
LABEL_10:
  ...
  *(_DWORD *)(v1 + 2344) = v3;
  for ( i = *(_QWORD *)(v1 + 2376); ; i = *(_QWORD *)(v5 + 248) )
  {
    v5 = i - 248;
    if ( v1 + 2376 == i )
      break;
  ...
  if ( v3 > v2 && _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 2344), v2 - v3) == v3 - v2 )
    goto LABEL_10;
  return 2053LL;
}
