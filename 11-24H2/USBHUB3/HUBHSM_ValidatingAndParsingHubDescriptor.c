...
__int64 __fastcall HUBHSM_ValidatingAndParsingHubDescriptor(__int64 a1, __int64 a2)
{
  ...
  if ( !v4 || (v5 = v4 - 1) == 0 )
  {
    if ( (unsigned __int8)HUBDESC_Validate20HubDescriptor(v2 + 1196, a2, v12, *(_QWORD *)(v2 + 2536)) )
    {
      v10 = *(unsigned __int8 *)(v2 + 1198);
      v7 = 2053;
      *(_WORD *)(v2 + 48) = v10;
      *(_WORD *)(v2 + 144) = v10;
...
LABEL_16:
  ...
  if ( v5 != 1 || !(unsigned __int8)HUBDESC_Validate30HubDescriptor(v2 + 1196, a2, v12, *(_QWORD *)(v2 + 2536)) )
    goto LABEL_16;
