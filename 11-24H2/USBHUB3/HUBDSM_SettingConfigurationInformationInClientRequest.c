/*
 * XREFs of HUBDSM_SettingConfigurationInformationInClientRequest @ 0x140024510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_SettingConfigurationInformationInClientRequest(__int64 a1)
{
  ...
  for ( i = (_QWORD *)*v4; ; i = (_QWORD *)v10[1] )
  {
    ...
    if ( *((_DWORD *)v10 + 6) )
    {
      do
      {
        v8 = (*(__int64 (__fastcall **)(_QWORD))(v1 + 480))(v10[10 * v6 + 5]);
        ...
        v9 = (*(__int64 (__fastcall **)(_QWORD))(v1 + 488))(v10[10 * v6 + 5]);
        v10[10 * v6 + 7] = v8;
        *(_QWORD *)&v3[12 * v6 + 16] = v8;
