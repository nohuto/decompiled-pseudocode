/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x14002C940
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x140025120 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheBOSDescriptorHeader(__int64 a1)
{
  ...
  *(_QWORD *)&v13[3] = 0LL;
  v7 = *(_DWORD *)(v4 + 4);
  LODWORD(v13[0]) = *(unsigned __int16 *)(a1 + 1998);
