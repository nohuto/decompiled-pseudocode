/*
 * XREFs of WPP_RECORDER_SF_DZd @ 0x14000FA2C
 * Callers:
...
LABEL_8:
  ...
  pfnWppTraceMessage(
    ...
    43LL,
    &WPP_ca13ed422d4834673d018685416879c0_Traceguids,
    37LL,
    (__int64 *)va,
    4LL,
    v9,
...
LABEL_11:
  ...
  if ( v10 )
    v5 = L"\b";
  LOWORD(v12) = 37;
  return WppAutoLogTrace(a1, 2LL, 3LL, &WPP_ca13ed422d4834673d018685416879c0_Traceguids, v12, (__int64 *)va, 4LL, v5);
}
