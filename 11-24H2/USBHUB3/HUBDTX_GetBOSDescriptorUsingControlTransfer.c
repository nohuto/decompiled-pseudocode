/*
 * XREFs of HUBDTX_GetBOSDescriptorUsingControlTransfer @ 0x14002B284
 * Callers:
 *     HUBDSM_GettingAlternateBOSDescriptor @ 0x1400226F0 (HUBDSM_GettingAlternateBOSDescriptor.c)
 * Callees:
