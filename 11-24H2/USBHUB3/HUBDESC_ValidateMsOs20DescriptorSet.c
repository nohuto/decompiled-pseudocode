/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x14003EFC0
 * Callers:
...
LABEL_42:
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v5 + 96), a2, 5, v12, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    goto LABEL_43;
  }
  if ( (_WORD)a2 != 10 )
  {
...
LABEL_45:
  ...
  *(_DWORD *)v5 = 0;
  ...
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v5 + 96), v11, 5, 377, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v7;
}
