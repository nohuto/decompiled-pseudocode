/*
 * XREFs of HUBUCX_UCXIoctlComplete @ 0x140028E60
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall HUBUCX_UCXIoctlComplete(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  v5 = *(_DWORD *)(a3 + 8);
  v6 = &WPP_6f1e94dad5dd3d9188df346061fdcafd_Traceguids;
  v8 = 0;
  if ( v5 < 0 )
  {
    v9 = (_DWORD *)(a4 + 448);
    ...
    {
      WPP_RECORDER_SF_Ld((*v10)[179], a2, 5, 11, (__int64)&WPP_6f1e94dad5dd3d9188df346061fdcafd_Traceguids, *v9, v5);
      v6 = &WPP_6f1e94dad5dd3d9188df346061fdcafd_Traceguids;
    }
    ...
    if ( (unsigned int)i > 0x38 || (v11 = 0x100000001000001LL, !_bittest64(&v11, i)) )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        WPP_RECORDER_SF_Ld((*v10)[179], *v9, 5, 12, (__int64)&WPP_6f1e94dad5dd3d9188df346061fdcafd_Traceguids, *v9, v5);
        v9 = (_DWORD *)(a4 + 448);
      }
      i = **v10;
      v12 = *(unsigned int *)(i + 2608);
      if ( (v12 & 0x80) != 0 )
  ...
  if ( *(_DWORD *)(a4 + 448) != 4788247 )
  {
    switch ( *(_DWORD *)(a4 + 448) )
    {
      ...
      case 0x49101F:
        ...
        i = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 1552))(
              ...
              *(_QWORD *)(a4 + 440),
              0LL);
        v50 = _bittest((const signed __int32 *)(a4 + 1644), 0x10u);
    ...
    if ( v14 )
    {
      ...
      if ( v16 != (_QWORD *)*v16 )
      {
        do
        {
          ...
          {
            if ( *(_DWORD *)(v17 + 80LL * k + 48) == 5 )
              *(_DWORD *)(v17 + 80LL * k + 48) = 6;
          }
          v19 = *(_QWORD **)(v17 + 8);
          v17 = (__int64)(v19 - 1);
        }
    ...
    if ( v20 )
    {
      ...
      for ( m = *(_QWORD **)(v20 + 16); ; m = (_QWORD *)*m )
      {
        ...
        {
          if ( LODWORD(v24[10 * n + 6]) == 5 )
            LODWORD(v24[10 * n + 6]) = 6;
        }
      }
    }
    v25 = *(_QWORD *)(a4 + 72);
    if ( v25 )
    {
      for ( ii = 0; ii < *(_DWORD *)(v25 + 24); *(_DWORD *)(v25 + 80 * v27 + 48) = 6 )
        v27 = ii++;
    }
    v28 = *(_DWORD *)(v15 + 76);
    if ( !v28 )
...
LABEL_119:
          LODWORD(i) = HUBSM_AddEvent(a4 + 512, v33);
          return i;
        }
      ...
      if ( v36 )
      {
        ...
        for ( i = *(_QWORD *)(v36 + 16); ; i = *(_QWORD *)i )
        {
          ...
          {
            if ( *(_DWORD *)(v39 + 80LL * jj + 48) == 3 )
              *(_DWORD *)(v39 + 80LL * jj + 48) = ((v5 >> 31) & 2) + 4;
          }
        }
      }
      *(_DWORD *)(a4 + 128) = 0;
...
LABEL_111:
    ...
    if ( (*(_DWORD *)(v15 + 72) & 4) == 0 )
    {
      if ( v5 >= 0 )
      {
        v34 = v28 + *(unsigned __int16 *)(a4 + 2216);
        *(_DWORD *)(a4 + 2592) = v34;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LODWORD(v58) = v34;
          LODWORD(v57) = *(_DWORD *)(v15 + 76);
          WPP_RECORDER_SF_dD(
            *(_QWORD *)(*(_QWORD *)(a4 + 8) + 1432LL),
            4u,
            5u,
