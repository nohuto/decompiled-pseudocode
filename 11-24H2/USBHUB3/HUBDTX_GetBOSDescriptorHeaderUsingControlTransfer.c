/*
 * XREFs of HUBDTX_GetBOSDescriptorHeaderUsingControlTransfer @ 0x14002B180
 * Callers:
 *     HUBDSM_GettingBOSDescriptorHeader @ 0x140022720 (HUBDSM_GettingBOSDescriptorHeader.c)
 * Callees:
