/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x14007CC8C
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionAttributes(__int64 a1, __int64 a2, size_t a3, int a4)
{
  ...
  if ( v10 >= 0 )
  {
    v10 = HUBFDO_IoctlValidateParameters((_DWORD)v9, 4, a4, (_DWORD)v20, 12LL, a3);
    if ( v10 >= 0 )
    {
...
LABEL_9:
  ...
  {
    v19 = v10;
    WPP_RECORDER_SF_d(v9[317], 2u, 3u, 0x42u, (__int64)&WPP_ca13ed422d4834673d018685416879c0_Traceguids, v19);
  }
LABEL_10:
