/*
 * XREFs of HUBMISC_LogDeviceReEnumeration @ 0x140031034
 * Callers:
 *     HUBDSM_InitializingEnumRetryCountInReEnumDuringResetInUnConfigured @ 0x1400231C0 (HUBDSM_InitializingEnumRetryCountInReEnumDuringResetInUnConfigured.c)
 * Callees:
...
NTSTATUS __fastcall HUBMISC_LogDeviceReEnumeration(__int64 a1)
{
  ...
  if ( (result & 0x40) != 0 )
    result = HUBMISC_VerifierDbgBreak("DeviceHwVerifierBusRenumeration", a1 + 512);
