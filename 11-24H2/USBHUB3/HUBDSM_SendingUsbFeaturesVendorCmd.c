/*
 * XREFs of HUBDSM_SendingUsbFeaturesVendorCmd @ 0x1400242E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_SendingUsbFeaturesVendorCmd(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 960);
  *(_BYTE *)(v1 + 408) = 64;
  *(_BYTE *)(v1 + 409) = *(_BYTE *)(v1 + 2681);
  *(_WORD *)(v1 + 410) = *(_WORD *)(v1 + 2673);
  *(_WORD *)(v1 + 412) = *(_WORD *)(v1 + 2675);
  *(_WORD *)(v1 + 414) = 0;
  ...
  if ( v2 >= 0 )
  {
    _InterlockedOr((volatile signed __int32 *)(v1 + 1644), 0x40000u);
  }
  else
  {
