/*
 * XREFs of McTemplateK0ppqq_EtwWriteTransfer @ 0x14001CCE0
 * Callers:
 *     HUBMISC_LogDescriptorValidationErrorForDevice @ 0x140030E60 (HUBMISC_LogDescriptorValidationErrorForDevice.c)
 *     HUBMISC_LogDescriptorValidationErrorForHub @ 0x140030F00 (HUBMISC_LogDescriptorValidationErrorForHub.c)
 *     HUBMISC_LogDescriptorValidationWarningForDevice @ 0x140030F50 (HUBMISC_LogDescriptorValidationWarningForDevice.c)
 *     HUBMISC_LogDescriptorValidationWarningForHub @ 0x140030FF0 (HUBMISC_LogDescriptorValidationWarningForHub.c)
