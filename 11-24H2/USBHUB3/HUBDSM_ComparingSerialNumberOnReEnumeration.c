/*
 * XREFs of HUBDSM_ComparingSerialNumberOnReEnumeration @ 0x140021180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ComparingSerialNumberOnReEnumeration(__int64 a1)
{
  ...
  v4 = *(_QWORD *)(v1 + 2160);
  v5 = (const void *)(v4 + 12);
  v6 = (*(_DWORD *)(v1 + 1644) & 0x800) != 0 ? 14 : 2;
  v7 = *(_DWORD *)(v1 + 2156) - v6;
  if ( (*(_DWORD *)(v1 + 1644) & 0x800) == 0 )
    v5 = *(const void **)(v1 + 2160);
  v8 = *(_DWORD *)(v1 + 264) - 2;
  if ( v7 == v8 )
  {
    v2 = v1 + 1740;
    LODWORD(v4) = RtlCompareMemory((const void *)(v1 + 1742), v5, v8);
    if ( (_DWORD)v4 == v8 )
      return v3;
  ...
  {
    McTemplateK0psqzq_EtwWriteTransfer(v6, v4, v1 + 1524, *(_QWORD *)(*(_QWORD *)v1 + 248LL), (__int64)v5, v7, 0LL, 0);
  }
  return v3;
}
