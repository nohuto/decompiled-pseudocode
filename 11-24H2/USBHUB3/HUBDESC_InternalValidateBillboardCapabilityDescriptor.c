/*
 * XREFs of HUBDESC_InternalValidateBillboardCapabilityDescriptor @ 0x1400365AC
 * Callers:
        ...
        __int64 a5)
{
  ...
  v9 = &WPP_a44667569f5231a010562af7f2d218c1_Traceguids;
  v10 = a5;
  ...
  if ( v12 >= 0x30 )
  {
    ...
    if ( *a3 <= v12 )
    {
      ...
      if ( result )
      {
        if ( result <= 0x80u )
        {
          ...
          *v5 = 1;
          ...
          {
            LODWORD(v19) = a1[5];
            WPP_RECORDER_SF_d(v10, 2u, 5u, 0xACu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v19);
          }
          v18 = 241LL;
        }
        else
        {
          *v5 = 1;
          ...
          {
            LODWORD(v19) = a1[4];
            WPP_RECORDER_SF_d(v10, 2u, 5u, 0xABu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v19);
          }
          v18 = 239LL;
        }
      }
      else
      {
        *v5 = 1;
        ...
        {
          LOBYTE(v15) = 2;
          WPP_RECORDER_SF_(v10, v15, 5, 170, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
        }
        v18 = 238LL;
      }
    }
    else
    {
      ...
      {
        LODWORD(v19) = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0xA9u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v19);
      }
      v18 = 237LL;
    }
...
LABEL_37:
  if ( *v5 )
  {
    ...
    {
      LOBYTE(v15) = 2;
      return WPP_RECORDER_SF_(v10, v15, 5, 176, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
  }
  return result;
}
