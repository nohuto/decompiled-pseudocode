/*
 * XREFs of HUBFDO_IoctlGetDescriptorFromNodeConnection @ 0x14007BFEC
 * Callers:
...
LABEL_48:
    ...
    if ( v19 == 3 )
    {
      ...
      if ( v22 )
      {
        if ( v22 == *(_BYTE *)(v17 + 2012) && v18[4] == 1033 )
        {
          if ( (*(_DWORD *)(v17 + 1640) & 0x40) == 0 )
          {
            v11 = -1073741823;
LABEL_50:
          ...
          v24 = *(unsigned __int16 *)(v17 + 2156);
          v23 = (*(_DWORD *)(v17 + 1644) & 0x800) != 0 ? 0xC : 0;
          LOWORD(v24) = v24 - v23;
          ...
          if ( v25 <= v18[5] )
          {
            ...
            if ( (unsigned __int8)v25 > 2u )
              memmove(
                v26 + 7,
                (const void *)(*(_QWORD *)(v17 + 2160) + 2 * ((unsigned __int64)v23 >> 1)),
