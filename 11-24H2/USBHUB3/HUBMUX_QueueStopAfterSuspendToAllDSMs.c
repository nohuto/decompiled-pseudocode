/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x140011A74
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1400099D0 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
