/*
 * XREFs of HUBPDO_ValidateConfigurationDescriptor @ 0x14001BE54
 * Callers:
...
__int64 __fastcall HUBPDO_ValidateConfigurationDescriptor(__int64 a1, unsigned __int8 *a2, int a3)
{
  ...
  *(_WORD *)((char *)&v19 + 5) = (v10 & 0x20) != 0;
  ...
  if ( !*((_WORD *)a2 + 1) )
  {
    ...
    {
      LOBYTE(v15) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(v12 + 1432), v15, 5, 26, (__int64)&WPP_8beb7df92ba934db5f6899fb45b5938a_Traceguids);
    }
    return (unsigned int)-1073737984;
  }
