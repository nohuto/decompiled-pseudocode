/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x14007E0E8
 * Callers:
...
LABEL_9:
    ...
    else
    {
      ...
      if ( *((_WORD *)v31 + 6) <= 1u )
      {
        ...
        if ( CompanionPort )
        {
          v22 = (unsigned __int16 *)(*(_QWORD *)CompanionPort + 2560LL);
...
LABEL_33:
  ...
  {
    v30 = v10;
    WPP_RECORDER_SF_d(v9[317], 2u, 3u, 0x4Au, (__int64)&WPP_ca13ed422d4834673d018685416879c0_Traceguids, v30);
  }
LABEL_11:
