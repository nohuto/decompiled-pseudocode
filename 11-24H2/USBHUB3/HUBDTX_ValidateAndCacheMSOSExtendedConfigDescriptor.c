/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptor @ 0x14002D674
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedConfigDescriptor @ 0x1400259C0 (HUBDSM_ValidatingMSOSExtendedConfigDescriptor.c)
 * Callees:
