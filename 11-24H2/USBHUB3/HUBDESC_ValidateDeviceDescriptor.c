/*
 * XREFs of HUBDESC_ValidateDeviceDescriptor @ 0x14003DE2C
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( !a1 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(a5, a2, 5, 259, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
    v8 = 79LL;
LABEL_5:
  ...
  if ( a2 < 2 )
  {
    v7 = a5;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x104u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, a2);
    v8 = 71LL;
    goto LABEL_5;
  }
  v7 = a5;
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x105u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, *a1);
    v12 = (void (__fastcall **)(_QWORD, __int64))(a3 + 24);
  ...
  if ( a1[1] != 1 )
  {
    ...
    {
      LODWORD(v25) = a1[1];
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x106u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
  ...
  if ( v29 < 8 )
  {
    ...
    {
      LODWORD(v25) = v29;
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x107u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      v13 = v26;
      v12 = v27;
    }
    (*v12)(*v13, 71LL);
    ...
    || (v15 & 0xFu) > 9 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x108u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      v14 = (_QWORD *)(a3 + 40);
    }
  ...
  else
  {
    ...
    if ( (unsigned __int16)(*((_WORD *)a1 + 1) - 513) > 0xFEu )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x109u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      }
  ...
  if ( !v17 )
  {
    if ( a1[7] != 8 )
    {
      ...
      {
        LODWORD(v25) = a1[7];
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x10Au, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      }
...
LABEL_68:
          LODWORD(v25) = v9;
          WPP_RECORDER_SF_d(a5, 2u, 5u, v20, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
          goto LABEL_69;
        }
        goto LABEL_69;
      }
...
LABEL_69:
  ...
  if ( v17 != 2 )
  {
    if ( v17 == 3 && a1[7] != 9 )
    {
      ...
      {
        LODWORD(v25) = a1[7];
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0x10Fu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      }
      (*(void (__fastcall **)(_QWORD, __int64, _QWORD *))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL, v14);
...
LABEL_75:
  ...
  {
    LODWORD(v25) = a1[7];
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0x10Du, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
  }
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD *))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL, v14);
...
LABEL_6:
  ...
  {
    LOBYTE(v9) = 2;
    WPP_RECORDER_SF_(v7, v9, 5, 272, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v10;
}
