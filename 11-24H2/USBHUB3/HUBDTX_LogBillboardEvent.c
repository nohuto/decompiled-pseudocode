/*
 * XREFs of HUBDTX_LogBillboardEvent @ 0x14002BD48
 * Callers:
 *     HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried @ 0x140020300 (HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried.c)
