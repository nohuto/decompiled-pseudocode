/*
 * XREFs of HUBDESC_ValidateMSOSExtendedConfigDescriptor @ 0x14003E5B0
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSExtendedConfigDescriptor(_DWORD *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != *a1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x119u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, a2, *a1);
  ...
  do
  {
    if ( *v8 )
    {
      if ( (_BYTE)a3 || (v11 = *v8 - 48, v11 > 0x2Fu) || !_bittest64(&v10, v11) )
      {
        ...
        {
          LOBYTE(v9) = 2;
          WPP_RECORDER_SF_(v4, v9, 5, 283, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
        }
        v15 = 123LL;
LABEL_29:
  ...
  for ( i = 0; i < 8; ++i )
  {
    if ( *v12 )
    {
      if ( (_BYTE)a3 || (v14 = *v12 - 48, v14 > 0x2Fu) || !_bittest64(&v10, v14) )
      {
        ...
        {
          LOBYTE(i) = 2;
          WPP_RECORDER_SF_(v4, i, 5, 284, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
        }
        v15 = 124LL;
        goto LABEL_29;
      }
...
LABEL_30:
  ...
  {
    LOBYTE(i) = 2;
    WPP_RECORDER_SF_(v4, i, 5, 285, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
  return v7;
}
