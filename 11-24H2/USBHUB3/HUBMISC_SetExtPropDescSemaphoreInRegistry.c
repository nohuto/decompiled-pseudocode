/*
 * XREFs of HUBMISC_SetExtPropDescSemaphoreInRegistry @ 0x14008635C
 * Callers:
 *     HUBDSM_SettingExtPropDescSemaphoreForMsOs2 @ 0x140024790 (HUBDSM_SettingExtPropDescSemaphoreForMsOs2.c)
 * Callees:
