/*
 * XREFs of HUBPDO_UnregisterPortPLDRCapability @ 0x140084550
 * Callers:
  ...
  if ( (unsigned __int8)HUBREG_IsPortPLDRCapable(*a1, *(unsigned __int16 *)(a1[1] + 200LL)) )
  {
    if ( (*(_DWORD *)(*a1 + 40LL) & 0x40000) != 0 && (a1[205] & 0x20) != 0 )
    {
      if ( (unsigned int)HUBREG_SetPortPLDRCapabilityValue(*a1, *(unsigned __int16 *)(a1[1] + 200LL), 0LL) )
      {
        ...
        {
          v10 = *((unsigned __int16 *)a1 + 1003);
          v7 = *((unsigned __int16 *)a1 + 1002);
          WPP_RECORDER_SF_dD(
            *(_QWORD *)(a1[1] + 1432LL),
            2u,
            5u,
        ...
        if ( (unsigned int)dword_14006C1F8 > 2 )
        {
          ...
          if ( v3 )
          {
            ...
            v25 = 2LL;
            v27 = 12LL;
            tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_1400677D7, 0LL, 0LL, 7u, v17);
          }
        }
      ...
      else
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v11 = *((unsigned __int16 *)a1 + 1003);
          v8 = *((unsigned __int16 *)a1 + 1002);
          WPP_RECORDER_SF_dD(
            *(_QWORD *)(a1[1] + 1432LL),
            4u,
            5u,
        ...
        if ( (unsigned int)dword_14006C1F8 > 4 )
        {
          ...
          if ( v4 )
          {
            ...
            v25 = 2LL;
            v27 = 12LL;
            tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067643, 0LL, 0LL, 7u, v17);
          }
        }
      }
    }
    else
    {
      ...
      if ( (unsigned int)dword_14006C1F8 > 2 )
      {
        ...
        if ( v5 )
        {
          ...
          v25 = 2LL;
          v27 = 12LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14006C1F8, byte_140067D94, 0LL, 0LL, 7u, v17);
        }
      }
