/*
 * XREFs of WMI_QueryInstanceDeviceNodeInfo @ 0x140041080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WMI_QueryInstanceDeviceNodeInfo(__int64 a1, unsigned int a2, _DWORD *a3, unsigned int *a4)
{
  ...
  *a4 = 1202;
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)(v10 + 40), v11);
  *(_OWORD *)((char *)a3 + 130) = *(_OWORD *)(v10 + 1996);
  *((_WORD *)a3 + 73) = *(_WORD *)(v10 + 2012);
  ...
  *a3 = 1431519822;
  ...
  a3[22] = 0;
  v22 = *(_QWORD *)(v32 + 16);
  *(_OWORD *)(a3 + 23) = *(_OWORD *)(v22 + 312);
  *(_OWORD *)(a3 + 27) = *(_OWORD *)(v22 + 328);
  v23 = *(_WORD *)(v32 + 48);
