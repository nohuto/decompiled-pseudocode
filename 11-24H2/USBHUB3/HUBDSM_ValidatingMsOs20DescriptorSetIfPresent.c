/*
 * XREFs of HUBDSM_ValidatingMsOs20DescriptorSetIfPresent @ 0x140025C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ValidatingMsOs20DescriptorSetIfPresent(__int64 a1)
{
  ...
  v2 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(WdfFunctions_01015 + 1616))(
         ...
         off_14006C1E8);
  LODWORD(v9) = *(unsigned __int16 *)(v1 + 1998);
  v3 = *(_DWORD *)(v1 + 172);
  v10 = 0LL;
  HIDWORD(v9) = v3;
  v4 = *(_QWORD *)(v1 + 8);
  ...
  *(_DWORD *)(v1 + 2484) = *(_DWORD *)(v1 + 264);
  v15 = v1;
  *(_QWORD *)(v1 + 2568) = *(_QWORD *)(v4 + 1432);
  v7 = HUBDESC_ValidateMsOs20DescriptorSet(&v9, v1 + 2472);
  if ( v7 )
  {
    if ( (*(_DWORD *)(v1 + 2472) & 0x200) != 0 )
      _InterlockedOr((volatile signed __int32 *)(v1 + 1640), 4u);
  }
  else
  {
    *(_DWORD *)(v1 + 2440) = 1073807389;
