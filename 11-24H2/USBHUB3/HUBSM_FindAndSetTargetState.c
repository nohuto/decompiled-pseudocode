  ...
  if ( v11 > 0x3EE )
  {
    switch ( v11 )
    {
      ...
      case 0x3F0u:
        ...
        break;
      case 0x3F1u:
        v15 = (struct _KEVENT *)(*(_QWORD *)(a1 + 960) + 1616LL);
        goto LABEL_19;
      case 0x3F2u:
        v15 = (struct _KEVENT *)(*(_QWORD *)(a1 + 960) + 1592LL);
        goto LABEL_19;
      case 0x3F3u:
        v16 = 3027LL;
LABEL_21:
  ...
  switch ( v11 )
  {
    case 0x3EEu:
      ...
      *(_DWORD *)(v19 + 48) = -1073741823;
      HUBFDO_CompleteGetDescriptorRequest(*v18, *(unsigned __int16 *)(v18[1] + 200LL), v18[63], -1073741823, 0);
    ...
    case 0x3EBu:
      ...
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64))(WdfFunctions_01015 + 2104))(
        ...
        *(_QWORD *)(v17 + 464),
        3221225473LL);
      if ( (*(_DWORD *)(v17 + 1644) & 0x40) != 0 )
      {
        *(_OWORD *)(a1 + 1012) = 0LL;
        _InterlockedAnd((volatile signed __int32 *)(v17 + 1644), 0xFFFFFFBF);
      }
      return 0;
    case 0x3ECu:
      v16 = 3011LL;
      goto LABEL_21;
    case 0x3EDu:
      v15 = (struct _KEVENT *)(*(_QWORD *)(a1 + 960) + 480LL);
LABEL_19:
      KeSetEvent(v15, 0, 0);
      return 0;
  }
