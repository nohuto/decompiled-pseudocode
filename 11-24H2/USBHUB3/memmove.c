 ...
 *     HUBID_AppendStringToIDString @ 0x14001E214 (HUBID_AppendStringToIDString.c)
 ...
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x140042E9C (InitializeTelemetryAssertsKMWorkerInternal.c)
 *     USBDInternal_BuildServicePath @ 0x14004376C (USBDInternal_BuildServicePath.c)
 *     MyRegQueryString @ 0x1400454AC (MyRegQueryString.c)
 ...
 *     KsPropertyHandleDrmSetContentId @ 0x140092BBC (KsPropertyHandleDrmSetContentId.c)
