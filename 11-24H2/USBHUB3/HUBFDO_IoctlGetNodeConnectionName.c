/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionName @ 0x14007D658
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionName(__int64 a1, __int64 a2, size_t a3, int a4)
{
  ...
  {
    DeviceInterfacePath = HUBFDO_IoctlValidateParameters((_DWORD)v10, 4, a4, (_DWORD)v25, 10LL, a3);
    if ( DeviceInterfacePath < 0 )
      goto LABEL_18;
...
LABEL_17:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(v10[317], 2u, 3u, 0x45u, (__int64)&WPP_ca13ed422d4834673d018685416879c0_Traceguids, v24);
  }
LABEL_18:
