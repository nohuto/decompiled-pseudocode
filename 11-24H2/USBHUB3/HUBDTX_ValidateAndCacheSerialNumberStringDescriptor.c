/*
 * XREFs of HUBDTX_ValidateAndCacheSerialNumberStringDescriptor @ 0x14002D9F8
 * Callers:
 *     HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice @ 0x140025E60 (HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheSerialNumberStringDescriptor(__int64 a1)
{
  ...
  *(_WORD *)((char *)&v30 + 5) = (v4 & 0x20) != 0;
  ...
  v40 = v26;
  v37 = 0;
  v12 = HUBDESC_InternalValidateStringDescriptor((int)a1 + 1740, v26, (unsigned int)&v37, v9, v8, (__int64)v28);
  if ( !v12 )
    goto LABEL_13;
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v11 - 32) > 0x5Fu || (_DWORD)v11 == 44 )
    {
      ...
      {
        LODWORD(v25) = *v16;
        WPP_RECORDER_SF_d(v27, 2u, 5u, 0x124u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v25);
      }
...
LABEL_13:
  ...
  {
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_(v8, v10, 5, 293, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
  }
