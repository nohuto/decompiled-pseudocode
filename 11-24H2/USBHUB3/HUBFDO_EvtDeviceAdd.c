/*
 * XREFs of HUBFDO_EvtDeviceAdd @ 0x140079BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDeviceAdd(__int64 a1, __int64 a2)
{
  ...
  _QWORD v55[12]; // [rsp+118h] [rbp+10h] BYREF
  _QWORD v56[18]; // [rsp+178h] [rbp+70h] BYREF
  __int128 v57; // [rsp+208h] [rbp+100h] BYREF
  __int128 v58; // [rsp+218h] [rbp+110h]
  char pszDest[16]; // [rsp+228h] [rbp+120h] BYREF
  __int64 v60; // [rsp+238h] [rbp+130h]
  _OWORD v61[2]; // [rsp+240h] [rbp+138h] BYREF
  __int128 v62; // [rsp+260h] [rbp+158h]
  GUID v63; // [rsp+270h] [rbp+168h] BYREF
  __int64 v64; // [rsp+280h] [rbp+178h]
  ...
  *(_OWORD *)&v45[1] = 0LL;
  ...
  v56[1] = HUBFDO_EvtDeviceD0Entry;
  LODWORD(v56[0]) = 144;
  v56[3] = HUBFDO_EvtDeviceD0Exit;
  v56[5] = HUBFDO_EvtDevicePrepareHardware;
  v56[6] = HUBFDO_EvtDeviceReleaseHardware;
  v56[12] = HUBFDO_EvtDeviceSurpriseRemoval;
  v56[15] = HUBFDO_EvtDeviceUsageNotification;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *))(WdfFunctions_01015 + 440))(WdfDriverGlobals, v2, v56);
  LOBYTE(v5) = 16;
...
LABEL_21:
  ...
  *(_QWORD *)&v58 = v4;
  BYTE8(v58) = 1;
  *((_QWORD *)&v57 + 1) = 0x20000000400LL;
  RtlStringCchPrintfA(pszDest, 0x10uLL, "hub%d", *(_DWORD *)(v4 + 96));
  v16 = (__int64 *)(v4 + 2536);
  if ( (int)imp_WppRecorderLogCreate(WPP_GLOBAL_Control, &v57, v4 + 2536) < 0 )
...
LABEL_39:
    ...
    {
      memset(v55, 0, sizeof(v55));
      v55[5] = HUBFDO_EvtIoDeviceControl;
      LODWORD(v55[0]) = 96;
      v55[6] = HUBFDO_EvtIoInternalDeviceControlFromPDO;
      *(_QWORD *)&v48 = 0LL;
      BYTE5(v55[1]) = 1;
      *(_QWORD *)((char *)v55 + 4) = 1LL;
      v50 = off_14006C290;
      v47 = 0LL;
      LODWORD(v47) = 56;
      v49 = 0LL;
