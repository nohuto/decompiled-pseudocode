...
LABEL_7:
    ...
    if ( (unsigned __int8)HUBDESC_ValidateConfigurationDescriptorSet(
                            ...
                            *(_QWORD *)(a1 + 2536),
                            0LL) )
    {
      if ( *(_WORD *)(*(_QWORD *)(a1 + 1272) + 2LL) == *(_WORD *)(a1 + 2620) )
      {
        v8 = 0;
        goto LABEL_16;
      }
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_dD(
          ...
          *(unsigned __int16 *)(*(_QWORD *)(a1 + 1272) + 2LL),
          *(unsigned __int16 *)(a1 + 2620));
  ...
  *(_QWORD *)(a1 + 1272) = Pool2;
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2536), v7, 3, 21, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids);
  }
  v8 = -1073741670;
LABEL_16:
  if ( v4 )
