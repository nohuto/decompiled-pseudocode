/*
 * XREFs of HUBMUX_CreateChildPSMs @ 0x140010954
 * Callers:
  ...
  *(_DWORD *)(a1 + 146) = 0xFFFF;
  ...
  while ( v2 )
  {
    ...
    if ( *v1 )
    {
      ...
      v9 = ++v4 & 7;
      if ( ((unsigned __int8)(1 << v9) & *(_BYTE *)(v8 + a1 + 1203)) != 0 )
      {
        _InterlockedAnd((volatile signed __int32 *)&v32 + 1, 0xFFFFFFFE);
        v6 = v32;
      }
      BYTE2(v32) = *(_BYTE *)(a1 + 2506);
    }
    else
    {
  ...
  if ( *(_WORD *)(a1 + 150) )
  {
    while ( 1 )
    {
      ...
      if ( *v1 )
      {
        ...
        *((_QWORD *)&v33 + 1) = *(_QWORD *)(a1 + 2520);
        LODWORD(v34) = *(_DWORD *)(a1 + 2528);
        BYTE2(v32) = *(_BYTE *)(a1 + 2506);
      }
      else
      {
