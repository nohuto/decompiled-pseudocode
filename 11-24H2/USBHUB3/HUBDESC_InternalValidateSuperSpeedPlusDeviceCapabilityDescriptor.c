/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusDeviceCapabilityDescriptor @ 0x14003B9A8
 * Callers:
...
LABEL_9:
    ...
    if ( *a1 != 4LL * v29 + 16 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_DDD(v9, 2u, 0LL, 0xBBu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    ...
    if ( *a3 <= v11 )
    {
      if ( *((_DWORD *)a1 + 1) >= 0x200u )
      {
        if ( *(_BYTE *)(a2 + 15) )
          *v6 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v9, 2u, 5u, 0xBDu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      ...
      if ( (a1[8] & 0xF0) != 0 )
      {
        if ( *(_BYTE *)(a2 + 15) )
          *v6 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v9, 2u, 5u, 0xBEu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      ...
      if ( a1[3] )
      {
        if ( *(_BYTE *)(a2 + 15) )
          *v6 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v9, 2u, 5u, 0xBFu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      ...
      if ( *((_WORD *)a1 + 5) )
      {
        if ( *(_BYTE *)(a2 + 15) )
          *v6 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v9, 2u, 5u, 0xC0u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      ...
      while ( (unsigned __int64)&a1[4 * v19 + 16] <= *(_QWORD *)(a2 + 64) )
      {
        ...
        if ( (v14 & 0x80u) != 0 )
        {
          ...
          {
            LODWORD(v26) = v19;
            WPP_RECORDER_SF_d(v9, 2u, 5u, 0xC2u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v26);
          }
          v15 = 220LL;
          goto LABEL_104;
        }
        ...
        if ( _bittest(&v17, v20) )
        {
          if ( *(_WORD *)a2 > 0x200u || *(_BYTE *)(a2 + 12) )
            *v6 = 2;
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_dD(v9, 2u, 5u, 0xC4u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
        ...
        if ( (v21 & 0x80u) == 0 )
        {
          ...
          {
            LODWORD(v26) = v19 + 1;
            WPP_RECORDER_SF_d(v9, 2u, 5u, 0xC6u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v26);
          }
          v15 = 221LL;
          goto LABEL_104;
        }
...
LABEL_117:
        LODWORD(v26) = v19;
        WPP_RECORDER_SF_d(v9, 2u, 5u, v24, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v26);
LABEL_118:
        v16 = 0LL;
      }
LABEL_90:
      ...
      if ( !v30 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_d(v9, 2u, 5u, 0xCAu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v26);
        }
        v15 = 228LL;
        goto LABEL_104;
      }
    ...
    else
    {
      if ( *(_WORD *)a2 > 0x200u || *(_BYTE *)(a2 + 12) )
        *v6 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v9, 2u, 5u, 0xBCu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v10);
      v15 = 217LL;
LABEL_104:
  ...
  if ( v11 >= 0x10 )
  {
    ...
    *a3 = 16;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDDD(v9, 2u, 5u, 0xB9u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    goto LABEL_9;
  }
  *v6 = 1;
  if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
...
LABEL_105:
  if ( *v6 )
  {
    ...
    {
      LOBYTE(v14) = 2;
      return WPP_RECORDER_SF_(v9, v14, 5, 203, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
  }
  return result;
}
