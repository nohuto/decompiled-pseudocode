/*
 * XREFs of HUBDESC_InternalValidateBOSDescriptor @ 0x14003615C
 * Callers:
...
char __fastcall HUBDESC_InternalValidateBOSDescriptor(unsigned __int8 *a1, __int64 a2, _DWORD *a3, int *a4, __int64 a5)
{
  ...
  if ( a1 )
  {
    ...
    else
    {
      *v5 = 1;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_dD(v11, 2u, 5u, 0xECu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      v12 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v28 = (_QWORD *)(a2 + 40);
      v13 = *(_QWORD *)(a2 + 40);
    ...
    if ( a1[1] != 15 )
    {
      *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_dD(v11, 2u, 5u, 0xEDu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      v12 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v28 = (_QWORD *)(a2 + 40);
      v15 = *(_QWORD *)(a2 + 40);
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0xF0u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    ...
    if ( !a1[4] )
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_(v11, v9, 5, 242, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
      }
      if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
        *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  ...
  else
  {
    ...
    *v5 = 1;
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(a5, v9, 5, 235, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
  ...
  if ( *v5 )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(v11, v9, 5, 244, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
  }
  return v10;
}
