/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x140018A84
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x140022FD0 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
