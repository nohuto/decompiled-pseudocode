/*
 * XREFs of HUBDSM_ValidatingAndLoggingAlternateModeStringDescriptor @ 0x140025180
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_WORD *)((char *)&v13 + 5) = (v6 & 0x20) != 0;
  ...
  if ( (unsigned __int8)HUBDESC_InternalValidateStringDescriptor(
                          ...
                          *(_QWORD *)(v5 + 1432),
                          (__int64)v11) )
  {
    HUBDTX_LogAlternateMode(v1, v1 + 1740);
  }
  else
  {
    *(_DWORD *)(v1 + 2440) = 1073807392;
    v2 = 4065;
