/*
 * XREFs of HUBDESC_InternalValidateCommonDescriptorHeader @ 0x140036864
 * Callers:
  ...
  if ( v11 < 2 )
  {
    *v5 = 1;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xDu, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v11, 2);
    v12 = 90LL;
LABEL_31:
  ...
  *a3 = v13;
  ...
  if ( !*a1 )
  {
    ...
    {
      LODWORD(v15) = v8;
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0x11u, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids, v15);
    }
    v12 = 91LL;
    goto LABEL_31;
  }
LABEL_32:
  if ( *v5 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(a5, a2, 5, 18, (__int64)&WPP_a44667569f5231a010562af7f2d218c1_Traceguids);
    }
    return 0;
  }
  return v10;
