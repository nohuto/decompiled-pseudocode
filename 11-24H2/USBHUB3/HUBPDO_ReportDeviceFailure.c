/*
 * XREFs of HUBPDO_ReportDeviceFailure @ 0x14001A940
 * Callers:
 *     HUBDSM_MarkingUnknownDeviceAsFailed @ 0x1400234C0 (HUBDSM_MarkingUnknownDeviceAsFailed.c)
 * Callees:
...
__int64 __fastcall HUBPDO_ReportDeviceFailure(__int64 *a1)
{
  ...
  if ( *(_BYTE *)(*a1 + 240) )
  {
    v27 = RtlStringCchPrintfA(pszDest, 5uLL, "%04X", *(unsigned __int16 *)(v20 + 2480));
    ...
    v28 = RtlStringCchPrintfA(v137, 5uLL, "%04X", *(unsigned __int16 *)(*a1 + 2482));
    ...
    v23 = RtlStringCchPrintfA(v139, 5uLL, "%04X", *(unsigned __int16 *)(*a1 + 2484));
