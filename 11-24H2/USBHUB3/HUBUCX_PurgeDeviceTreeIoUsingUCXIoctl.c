/*
 * XREFs of HUBUCX_PurgeDeviceTreeIoUsingUCXIoctl @ 0x140028AD0
 * Callers:
 *     HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured @ 0x140023650 (HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured.c)
 * Callees:
...
__int64 __fastcall HUBUCX_PurgeDeviceTreeIoUsingUCXIoctl(_QWORD *a1)
{
  ...
  *(_QWORD *)(v2 + 16) = a1[3];
  result = HUBUCX_SubmitUcxIoctl(a1, 4788307LL);
