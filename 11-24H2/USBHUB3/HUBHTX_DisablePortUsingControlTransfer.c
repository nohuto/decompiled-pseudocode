/*
 * XREFs of HUBHTX_DisablePortUsingControlTransfer @ 0x1400035E0
 * Callers:
 *     HUBPSM20_DisablingPortOnPortCycleWithTimer @ 0x1400127D0 (HUBPSM20_DisablingPortOnPortCycleWithTimer.c)
 * Callees:
...
__int64 __fastcall HUBHTX_DisablePortUsingControlTransfer(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 172) = *(unsigned __int16 *)(a1 + 200);
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v2, 4u, 4u, 0x32u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v4);
  }
  ...
  if ( (int)result < 0 )
  {
    ...
    {
      LODWORD(v5) = result;
      WPP_RECORDER_SF_d(*v2, 2u, 4u, 0x33u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v5);
    }
