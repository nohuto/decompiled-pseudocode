/*
 * XREFs of HUBUCX_EnableDisableEndpointsUsingUCXIoctl @ 0x14002709C
 * Callers:
 ...
 *     HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency @ 0x140021E70 (HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency.c)
