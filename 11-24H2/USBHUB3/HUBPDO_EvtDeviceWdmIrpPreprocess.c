/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpPreprocess @ 0x140016B10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_113:
      ...
      else
      {
        if ( (_DWORD)v22 == 42 )
        {
          ...
          {
            if ( (unsigned __int16)(*(_WORD *)(v22 + 1998) - 256) > 0xFFu && (*(_DWORD *)(v22 + 1640) & 0x80u) == 0
              || (*(_DWORD *)(v22 + 1652) & 2) != 0 )
            {
              BYTE1(v21[5].AccessState) = *(_BYTE *)(v22 + 2060);
              v21->AccessState = *(_ACCESS_STATE **)(*(_QWORD *)(v7 + 24) + 24LL);
              goto LABEL_107;
            }
            if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          ...
          if ( !v40 )
            goto LABEL_51;
          v41 = *(unsigned __int16 **)(*(_QWORD *)(v7 + 24) + 2496LL);
...
LABEL_52:
          ...
          if ( BYTE3(v21[5].AccessState) == 1 )
          {
            ...
            v36 = (unsigned __int16 *)(*(_QWORD *)(v7 + 24) + 1996LL);
            v38 = 18;
      ...
      if ( v52 != 128 )
      {
        v18 = (*(_DWORD *)(*(_QWORD *)(v7 + 24) + 1640LL) & 2) != 0 ? 5 : 3;
        goto LABEL_256;
      }
      goto LABEL_89;
    }
...
LABEL_135:
          ...
          else
          {
            ...
            {
              v62 = *(_QWORD *)(v7 + 24);
              if ( (*(_DWORD *)(v62 + 2444) & 0x400) != 0 )
                HUBMISC_VerifierDbgBreak("DeviceHwVerifierClientInitiatedCyclePort", v62 + 512);
...
LABEL_117:
    ...
    if ( LowPart <= 0x491043 )
    {
      if ( LowPart == 4788291 )
      {
        ...
        v86->SecurityQos = *(_SECURITY_QUALITY_OF_SERVICE **)(*(_QWORD *)(v7 + 16) + 2464LL);
        v87 = *(_QWORD *)(v7 + 24);
        *(_OWORD *)&v86->AccessState = *(_OWORD *)(v87 + 1996);
        LOWORD(v86[1].SecurityQos) = *(_WORD *)(v87 + 2012);
        WORD1(v86[1].SecurityQos) = *(_WORD *)(*(_QWORD *)(v7 + 24) + 2200LL);
        WORD2(v86[1].SecurityQos) = *(_WORD *)(*(_QWORD *)(v7 + 24) + 2202LL);
        v86[2].AccessState = *(_ACCESS_STATE **)(*(_QWORD *)(v7 + 24) + 2576LL);
        v86[2].DesiredAccess = *(_DWORD *)(*(_QWORD *)(v7 + 24) + 2584LL);
        BYTE2(v86[1].DesiredAccess) = *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v7 + 24) + 8LL) + 202LL);
        HIWORD(v86[1].AccessState) = *(_WORD *)(*(_QWORD *)(v7 + 24) + 2210LL);
        LOWORD(v86[1].DesiredAccess) = *(_WORD *)(*(_QWORD *)(v7 + 24) + 2212LL);
        v88 = *(_QWORD *)(v7 + 16);
        LOWORD(v86[1].FullCreateOptions) = *(_WORD *)(v88 + 1204)
                                         + *(_WORD *)(v88 + 2508)
                                         + *(_WORD *)(*(_QWORD *)(v7 + 24) + 2590LL);
        v89 = *(_QWORD *)(v7 + 24);
        if ( (*(_DWORD *)(v89 + 2224) & 1) != 0 )
        {
          HIWORD(v86[1].SecurityQos) = *(unsigned __int8 *)(v89 + 2205);
          v90 = *(_BYTE *)(*(_QWORD *)(v7 + 16) + 240LL);
        }
        else
        {
          HIWORD(v86[1].SecurityQos) = *(_WORD *)(v88 + 2494);
          v90 = *(_BYTE *)(v88 + 2496);
        }
        LOBYTE(v86[1].AccessState) = v90;
        v91 = *(_QWORD *)(v7 + 24);
        if ( (*(_DWORD *)(v91 + 2224) & 2) != 0 )
        {
          WORD1(v86[1].AccessState) = *(_WORD *)(v91 + 2208);
          v92 = *(_BYTE *)(*(_QWORD *)(v7 + 16) + 240LL);
        }
        else
        {
          WORD1(v86[1].AccessState) = *(_WORD *)(v88 + 2498);
          v92 = *(_BYTE *)(v88 + 2500);
        }
        BYTE4(v86[1].AccessState) = v92;
        if ( (*(_DWORD *)(v88 + 2512) & 1) != 0 )
          LODWORD(v86[2].SecurityQos) |= 1u;
        if ( (*(_DWORD *)(v88 + 2512) & 4) != 0 )
          LODWORD(v86[2].SecurityQos) |= 4u;
        if ( (*(_DWORD *)(*(_QWORD *)(v7 + 24) + 1640LL) & 0x2000) != 0 )
          LODWORD(v86[2].SecurityQos) |= 2u;
        if ( (*(_DWORD *)(*(_QWORD *)(v7 + 16) + 44LL) & 8) != 0 || (*(_DWORD *)(v88 + 2512) & 8) != 0 )
...
LABEL_261:
      ...
      {
        v85 = *(_QWORD *)(v7 + 24);
        if ( (*(_DWORD *)(v85 + 1652) & 0x1000000) == 0 )
        {
          Status = -1073741275;
          goto LABEL_53;
        }
    ...
    if ( !v93 )
    {
      ...
      {
        v102 = -((*(_DWORD *)(*(_QWORD *)(v7 + 24) + 1464LL) & 0x10000) != 0);
      }
      else
      {
        ...
        else
        {
          ...
          v110 = *(_DWORD *)(*(_QWORD *)(v7 + 24) + 1464LL) & 0xB00;
        }
        v102 = -(v110 == 0);
      }
