/*
 * XREFs of HUBHTX_GetErrorResponseEventForInvalidPortStatusInPendingReset @ 0x140004800
 * Callers:
 *     HUBPSM20_ErrorOnResettingPort @ 0x1400129C0 (HUBPSM20_ErrorOnResettingPort.c)
 * Callees:
...
LABEL_13:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_dDD(a1[179], a2, *((unsigned __int16 *)a1 + 100), a4);
  return v7;
}
