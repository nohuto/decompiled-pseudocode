/*
 * XREFs of NdisGetThreadObjectCompartmentId @ 0x140048050
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_13:
  ...
  v8 = (unsigned int)v23;
LABEL_7:
  if ( v8 >= dword_14011C950 )
    return 1LL;
  v17 = KeAcquireSpinLockRaiseToDpc(&qword_14011C9A0);
  if ( v8 < dword_14011C950 )
    v3 = *((_DWORD *)qword_14011C9F0 + 6 * v8);
  KeReleaseSpinLock(&qword_14011C9A0, v17);
  if ( !v3 )
    return 1;
  return v3;
}
