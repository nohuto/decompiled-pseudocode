/*
 * XREFs of ??$ndisCallNextDatapathHandler@$00AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z0AEAPEAU0@AEAK55@Z @ 0x140048C90
 * Callers:
 *     ??$ndisDataPathExpandStackCallback@$00$$A6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z@@YAXPEAX@Z @ 0x14008CFE0 (--$ndisDataPathExpandStackCallback@$00$$A6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z@@YAXPEAX@Z.c)
 * Callees:
