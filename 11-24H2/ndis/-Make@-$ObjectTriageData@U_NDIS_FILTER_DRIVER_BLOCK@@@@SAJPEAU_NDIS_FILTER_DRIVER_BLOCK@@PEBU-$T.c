/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_FILTER_DRIVER_BLOCK@@@@SAJPEAU_NDIS_FILTER_DRIVER_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_FILTER_DRIVER_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x140099D84
 * Callers:
...
__int64 __fastcall ObjectTriageData<_NDIS_FILTER_DRIVER_BLOCK>::Make(
        _LIST_ENTRY *a1,
        _DWORD *a2,
        TriageData *a3,
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  v11 = ObjectTriageData<_NDIS_FILTER_DRIVER_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, (void **)&v25);
  if ( v11 )
  {
...
LABEL_17:
      ...
      if ( Pool2 )
      {
        ...
        *(_QWORD *)(Pool2 + 80) = ObjectTriageData<_NDIS_FILTER_DRIVER_BLOCK>::Callback;
