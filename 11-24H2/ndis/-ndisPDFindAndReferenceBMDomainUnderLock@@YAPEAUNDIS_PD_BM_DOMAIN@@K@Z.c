/*
 * XREFs of ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x14013D68C
 * Callers:
...
KPushLockBase *__fastcall ndisPDFindAndReferenceBMDomainUnderLock(int a1)
{
  ...
  for ( i = (KPushLockBase *)qword_14011CF58[1030].m_Lock.Value;
        i != &qword_14011CF58[1030];
