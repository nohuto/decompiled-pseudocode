/*
 * XREFs of ndisAllocateSharedMemoryInternal @ 0x14005D040
 * Callers:
...
LABEL_16:
  ...
  if ( v24 >= 0 )
  {
    *((_QWORD *)v12 + 19) = *((_QWORD *)a3 + 5);
    ...
    _InterlockedAdd64(&qword_14011CF78, *((unsigned int *)a3 + 8));
...
LABEL_30:
  ...
  if ( v24 == -1073741670 )
LABEL_36:
    _InterlockedAdd64(&qword_14011CF80, *((unsigned int *)a3 + 8));
  return (unsigned int)v24;
}
