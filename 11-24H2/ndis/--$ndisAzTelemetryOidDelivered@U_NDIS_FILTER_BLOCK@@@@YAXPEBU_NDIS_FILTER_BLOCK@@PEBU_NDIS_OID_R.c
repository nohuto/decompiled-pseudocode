/*
 * XREFs of ??$ndisAzTelemetryOidDelivered@U_NDIS_FILTER_BLOCK@@@@YAXPEBU_NDIS_FILTER_BLOCK@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x140016EF0
 * Callers:
...
LABEL_9:
    if ( (unsigned int)v2 > 4 && (v7 & 0x400) != 0 )
    {
      ...
      if ( v2 == v6 )
      {
        ...
        v47[0] = v15;
        v30 = v17 + 4008;
        UserData.Ptr = (unsigned __int64)off_14011A7B8;
        ...
        *(_DWORD *)&EventDescriptor.Id = 184549376;
        ...
        UserData.Size = *(unsigned __int16 *)off_14011A7B8;
        v27 = &unk_140102AF3;
        UserData.Reserved = 2;
        v28 = 98;
        v29 = 1;
        v24[1] = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
        LODWORD(v2) = EtwWriteTransfer(qword_14011A7D0, &EventDescriptor, (LPCGUID)(v13 + 168), 0LL, 0xBu, &UserData);
      }
    }
  }
  return v2;
