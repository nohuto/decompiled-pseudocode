/*
 * XREFs of ?ndisOidPreRcvFilterEnumFilters@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400AA150
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumFilters(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  $6A74A2D77AECD4C8EC53F6C92D95B01A *Flink; // rcx
  unsigned int v22; // r11d
  __int64 i; // rsi
  struct _NDIS_PCW_DATA_BLOCK **p_PcwDataBlock; // rax
  _DWORD *v25; // r8
  $6A74A2D77AECD4C8EC53F6C92D95B01A *v26; // r9
  KIRQL v27; // dl
  __int64 v28; // rax
      ...
      *(_DWORD *)(*((_QWORD *)a1 + 4) + 68LL) = v20;
      if ( v20 <= *(_DWORD *)(*((_QWORD *)a1 + 4) + 52LL) )
      {
        *(_DWORD *)v14 = 1835392;
        if ( v3 )
        {
          Flink = ($6A74A2D77AECD4C8EC53F6C92D95B01A *)v3->FilterList.Flink;
          *(_DWORD *)(v14 + 24) = v3->VPortParams.VPortId;
        }
        else
        {
          Flink = *($6A74A2D77AECD4C8EC53F6C92D95B01A **)&ReceiveQueueByQueueId->Reserved4.Length;
        ...
        *(_DWORD *)(v14 + 16) = 16;
        for ( i = v14 + 28; v22 < NumFilters; Flink = *($6A74A2D77AECD4C8EC53F6C92D95B01A **)&Flink->Reserved4.Length )
        {
          if ( v3 )
          {
            if ( Flink == ($6A74A2D77AECD4C8EC53F6C92D95B01A *)&v3->FilterList )
              break;
