/*
 * XREFs of ?ndisBindGetFilterDriver@@YA?AV?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@PEBU_GUID@@_N@Z @ 0x14015DBC0
 * Callers:
 ...
 *     ?grow@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@AEAA_N_K@Z @ 0x140143614 (-grow@-$KArray@V-$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@AEAA_N_K@Z.c)
        ...
        char a3)
{
  ...
  v3 = qword_14011D080;
  v22.m_Lock = (KPushLockBase *)qword_14011D080;
  ...
  v10 = 0LL;
  v11 = *(unsigned int *)(qword_14011D080 + 28);
  while ( v10 != v11 )
  {
  ...
  if ( ndisBindReadFilterDriverConfiguration(v18)
    && (v19 = qword_14011D080,
        Rtl::KArray<KRef<NDIS_BIND_FILTER_DRIVER>,1>::grow(
          (unsigned int *)(qword_14011D080 + 24),
          (unsigned int)(*(_DWORD *)(qword_14011D080 + 28) + 1))) )
  {
