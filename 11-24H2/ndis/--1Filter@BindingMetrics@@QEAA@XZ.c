/*
 * XREFs of ??1Filter@BindingMetrics@@QEAA@XZ @ 0x140059B80
 * Callers:
...
void __fastcall BindingMetrics::Filter::~Filter(BindingMetrics::Filter *this)
{
  ...
  if ( *((_BYTE *)this + 17) )
  {
    ...
    if ( !v2 )
      v3 = (unsigned __int16 *)&unk_1400F2F80;
    if ( (unsigned int)dword_14011A7B0 > 4
      && (qword_14011A7C0 & 0x20) != 0
      && (qword_14011A7C8 & 0x20) == qword_14011A7C8 )
    {
