/*
 * XREFs of ?RtlUnicodeStringCopy@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x140057150
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x140057220 (RtlUnicodeStringValidateWorker_0.c)
 */
