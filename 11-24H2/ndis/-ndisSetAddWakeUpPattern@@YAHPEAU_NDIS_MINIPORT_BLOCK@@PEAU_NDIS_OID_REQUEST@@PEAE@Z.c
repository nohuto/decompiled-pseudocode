/*
 * XREFs of ?ndisSetAddWakeUpPattern@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAE@Z @ 0x1400B50F4
 * Callers:
        ...
        char *a3)
{
  ...
  {
    v29 = (char)PatternOffset;
    LOBYTE(PatternOffset) = 4;
    WPP_RECORDER_SF_qq(
...
LABEL_21:
  ...
  v30 = HIDWORD(j[6].Next);
  HIDWORD(j[6].Next) = 0;
  HIDWORD(j[7].Next) = 0;
  if ( memcmp(InformationBuffer, &j[6], v19)
    || memcmp((char *)InformationBuffer + v31, (char *)&j[6] + Next_high, LODWORD(j[8].Next)) )
  {
    InformationBuffer->PatternOffset = v31;
    InformationBuffer->Reserved = v34;
    HIDWORD(j[7].Next) = Next_high;
    HIDWORD(j[6].Next) = v30;
    goto LABEL_21;
  }
  v20 = j;
  InformationBuffer->PatternOffset = v31;
