/*
 * XREFs of NdisMDeregisterWdiMiniportDriver @ 0x1401683A0
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisMpHookGetHookUnsafe@@YAPEBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@W4_NDIS_MINIPORT_HOOK_DRIVER_TYPE@@@Z @ 0x140050AE0 (-ndisMpHookGetHookUnsafe@@YAPEBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@W4_NDIS_MINIPORT_HOOK_DRIVER_T.c)
