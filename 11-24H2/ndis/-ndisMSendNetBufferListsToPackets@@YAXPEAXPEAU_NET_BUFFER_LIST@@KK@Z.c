/*
 * XREFs of ?ndisMSendNetBufferListsToPackets@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z @ 0x14004BCA0
 * Callers:
        ...
        int a4)
{
  ...
  struct _NDIS_FILTER_BLOCK *v15; // [rsp+48h] [rbp-80h]
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( !v13 )
        break;
      ((void (__fastcall *)(struct _NDIS_FILTER_BLOCK *, _OWORD *))a1[1].Characteristics.ReceiveNetBufferListsHandler)(
        a1,
        v16);
      if ( !v7 )
        goto LABEL_4;
