/*
 * XREFs of NdisMAllocatePort @ 0x140065090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAddPortToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PORT_BLOCK@@@Z @ 0x1400A7C54 (-ndisAddPortToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PORT_BLOCK@@@Z.c)
