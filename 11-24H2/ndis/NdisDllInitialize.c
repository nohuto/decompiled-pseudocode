/*
 * XREFs of NdisDllInitialize @ 0x140095A10
 * Callers:
 ...
 *     ?NdispRegisterShim@@YAXXZ @ 0x14013EF40 (-NdispRegisterShim@@YAXXZ.c)
 */
...
__int64 NdisDllInitialize()
{
  ...
  if ( !ndisDllInitialized )
  {
    ...
    qword_14011C690 = (__int64)&ndisPerProcessorDescriptorList;
    ...
    {
      qword_14011C938 = ExAllocatePool2(64LL, 520LL * ndisMaxNumberOfProcessors, 538985550LL);
      if ( !qword_14011C938 )
        v0 = -1073741801;
    }
