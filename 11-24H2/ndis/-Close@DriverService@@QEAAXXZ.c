/*
 * XREFs of ?Close@DriverService@@QEAAXXZ @ 0x14014B454
 * Callers:
 ...
 * Callees:
 *     ?reset@?$unique_storage@U?$resource_policy@PEAU_FILE_OBJECT@@P6A_JPEAX@Z$1?ObfDereferenceObject@@YA_J0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAU_FILE_OBJECT@@@Z @ 0x1400DCF38 (-reset@-$unique_storage@U-$resource_policy@PEAU_FILE_OBJECT@@P6A_JPEAX@Z$1-ObfDereferenceObject@.c)
 *     ?UnloadDriver@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1400DCFB4 (-UnloadDriver@@YAJPEAU_UNICODE_STRING@@@Z.c)
 */
