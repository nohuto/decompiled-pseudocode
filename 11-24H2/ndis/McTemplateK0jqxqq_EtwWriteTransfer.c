/*
 * XREFs of McTemplateK0jqxqq_EtwWriteTransfer @ 0x140036BD0
 * Callers:
...
__int64 __fastcall McTemplateK0jqxqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  _QWORD v9[12]; // [rsp+30h] [rbp-78h] BYREF
  ...
  v9[9] = 4LL;
  v9[11] = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&NDIS_PROVIDER_ID_Context, a2, a3, 6LL, v9);
}
