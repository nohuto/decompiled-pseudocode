/*
 * XREFs of ?ndisInitializeGlobalTriageData@@YAXXZ @ 0x140098B08
 * Callers:
...
void __fastcall ndisInitializeGlobalTriageData(void *a1)
{
  ...
  bool (__fastcall *v4)(__int64, TriageDataArray *); // [rsp+38h] [rbp-41h]
  int v5; // [rsp+40h] [rbp-39h]
  bool (__fastcall *v6)(__int64, TriageDataArray *); // [rsp+48h] [rbp-31h]
  int v7; // [rsp+50h] [rbp-29h]
  bool (__fastcall *v8)(__int64, TriageDataArray *); // [rsp+58h] [rbp-21h]
  int v9; // [rsp+60h] [rbp-19h]
  bool (__fastcall *v10)(__int64, TriageDataArray *); // [rsp+68h] [rbp-11h]
  int v11; // [rsp+70h] [rbp-9h]
  bool (__fastcall *v12)(__int64, TriageDataArray *); // [rsp+78h] [rbp-1h]
  int v13; // [rsp+80h] [rbp+7h]
  bool (__fastcall *v14)(__int64, TriageDataArray *); // [rsp+88h] [rbp+Fh]
  int v15; // [rsp+90h] [rbp+17h]
  bool (__fastcall *v16)(__int64, TriageDataArray *); // [rsp+98h] [rbp+1Fh]
  int v17; // [rsp+A0h] [rbp+27h]
  bool (__fastcall *v18)(__int64, TriageDataArray *); // [rsp+A8h] [rbp+2Fh]
  int v19; // [rsp+B0h] [rbp+37h]
  void (*v20)(void *, struct TriageDataArray *, const struct BugcheckParameters *); // [rsp+B8h] [rbp+3Fh]
