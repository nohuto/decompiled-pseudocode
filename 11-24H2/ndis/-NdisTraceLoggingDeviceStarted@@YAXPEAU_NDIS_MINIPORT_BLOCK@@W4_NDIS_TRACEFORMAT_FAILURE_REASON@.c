/*
 * XREFs of ?NdisTraceLoggingDeviceStarted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@J@Z @ 0x14005EF70
 * Callers:
 ...
 *     ?NdisTraceLoggingDiscoverOperationalStatus@@YA?AW4_NDIS_TRACEFORMAT_OPERATIONAL_STATUS@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14006F170 (-NdisTraceLoggingDiscoverOperationalStatus@@YA-AW4_NDIS_TRACEFORMAT_OPERATIONAL_STATUS@@PEAU_NDI.c)
...
void __fastcall NdisTraceLoggingDeviceStarted(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (int)a3 < 0 )
  {
    if ( (unsigned int)dword_14011A7E8 > 5 && (unsigned __int8)tlgKeywordOn(&dword_14011A7E8, 0x200000000000LL) )
    {
      v12 = v8;
      v11[0] = v9 + 4008;
      v13 = v7;
