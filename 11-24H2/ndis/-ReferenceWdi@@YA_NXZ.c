/*
 * XREFs of ?ReferenceWdi@@YA_NXZ @ 0x140146D54
 * Callers:
...
char ReferenceWdi(void)
{
  ...
  v0 = 0;
  v5.m_State = Unlocked;
  v5.m_Lock = (KPushLockBase *)&WPP_MAIN_CB.Dpc.DpcData;
...
LABEL_6:
    ...
    KWaitEventBase<wistd::integral_constant<enum _EVENT_TYPE,0>>::Wait(&WPP_MAIN_CB.ActiveThreadCount);
  }
