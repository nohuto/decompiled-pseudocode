/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1400C3FB0
 * Callers:
...
LABEL_11:
  ...
  if ( !a7 )
    v36 = L"\b";
  LOWORD(v42) = 45;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_d69e2148828f3cdf9c5ee0d0c96342c3_Traceguids, v42, a6, 16LL, v36, 2LL, v35);
}
