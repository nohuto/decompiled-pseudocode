/*
 * XREFs of ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x14001F4D0
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(struct _NET_BUFFER *a1, char a2, struct _NDIS_PACKET **a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rdx
  $BCC1C7D3307CCB7E335E7B9F29F874AB *ProtocolReserved; // r10
  _MDL *CurrentMdl; // rax
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($BCC1C7D3307CCB7E335E7B9F29F874AB *)v8->ProtocolReserved;
    if ( !a2 )
