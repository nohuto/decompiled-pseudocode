/*
 * XREFs of ?DuplicateCollectorsArray@?$ObjectTriageData@U_NDIS_FILTER_BLOCK@@@@CAJPEBU?$TriageDataCollector@U_NDIS_FILTER_BLOCK@@@@_KAEAV?$unique_any_array_ptr@U?$TriageDataCollector@U_NDIS_FILTER_BLOCK@@@@UTriageDataCollectorArrayDeleter@?$ObjectTriageData@U_NDIS_FILTER_BLOCK@@@@Uempty_deleter@wil@@_K@wil@@@Z @ 0x140097E4C
 * Callers:
...
__int64 __fastcall ObjectTriageData<_NDIS_FILTER_BLOCK>::DuplicateCollectorsArray(void *Src, size_t a2, void **a3)
{
  unsigned int v5; // edi
  void *Pool2; // rdi
  __int64 v7; // rax
  ...
  v10 = 0LL;
  Size = 0LL;
  v5 = RtlULongLongMult(8uLL, 0x10uLL, &Size);
  if ( !v5 )
  {
