/*
 * XREFs of ?ndisAllocateAndInitializeTimestampForFilter@@YAPEAU_NDIS_TIMESTAMP_CAPABILITIES@@PEAU1@@Z @ 0x1400329C0
 * Callers:
        ...
        struct _NDIS_TIMESTAMP_CAPABILITIES *a1)
{
  ...
  result = (struct _NDIS_TIMESTAMP_CAPABILITIES *)ExAllocatePool2(64LL, 56LL, 1936999502LL);
  if ( result )
  {
    if ( a1 )
    {
