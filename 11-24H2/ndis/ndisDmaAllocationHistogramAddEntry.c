/*
 * XREFs of ndisDmaAllocationHistogramAddEntry @ 0x140135300
 * Callers:
 *     ??1NdisDmaAllocationHistogramStopwatch@@QEAA@XZ @ 0x1401352C0 (--1NdisDmaAllocationHistogramStopwatch@@QEAA@XZ.c)
 * Callees:
 *     ?IncrementBucket@KHistogram@@AEAAX_K@Z @ 0x140001B6C (-IncrementBucket@KHistogram@@AEAAX_K@Z.c)
...
void __fastcall ndisDmaAllocationHistogramAddEntry(unsigned __int64 a1, __int64 a2)
{
  ...
  v19.m_Lock = &stru_14011C8E8;
  KeEnterCriticalRegion();
  v19.m_Region.m_Entered = 1;
  ExAcquirePushLockExclusiveEx(&stru_14011C8E8, 0LL);
  v19.m_State = Exclusive;
  if ( !qword_14011CF38 )
  {
    ExReleasePushLockExclusiveEx(&stru_14011C8E8, 0LL);
    KeLeaveCriticalRegion();
    return;
  }
  v6 = MEMORY[0xFFFFF78000000008];
  v7 = qword_14011CF38;
  if ( *(void **)qword_14011CF38 != qword_14011CF38 )
  {
    HistogramEntry = *(_QWORD *)qword_14011CF38 - 16LL;
    if ( !*((_DWORD *)qword_14011CF38 + 5) )
      goto LABEL_9;
    if ( (unsigned __int64)(*(_QWORD *)HistogramEntry + 600000000LL) >= MEMORY[0xFFFFF78000000008] )
    {
      ...
      {
LABEL_9:
        if ( *(_QWORD *)qword_14011CF38 != 16LL )
          goto LABEL_20;
      }
    }
  }
  if ( *((_DWORD *)qword_14011CF38 + 4) > *((_DWORD *)qword_14011CF38 + 6) )
  {
    v10 = *((_QWORD *)qword_14011CF38 + 1);
    if ( *(void **)v10 != qword_14011CF38 )
      goto LABEL_25;
    v11 = *(_QWORD **)(v10 + 8);
    if ( *v11 != v10 )
      goto LABEL_25;
    *((_QWORD *)qword_14011CF38 + 1) = v11;
...
LABEL_25:
  ...
  HistogramEntry = ndisAllocateHistogramEntry(qword_14011CF38, v4, v5);
  if ( HistogramEntry )
  {
    v9 = (__int64 *)qword_14011CF38;
    ++*((_DWORD *)qword_14011CF38 + 4);
    goto LABEL_18;
  }
  _InterlockedIncrement64(&qword_14011CFE8);
LABEL_13:
