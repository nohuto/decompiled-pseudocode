/*
 * XREFs of ?ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z @ 0x14003CDE0
 * Callers:
 *     NdisDprReleaseReadWriteLock @ 0x1400C2450 (NdisDprReleaseReadWriteLock.c)
 * Callees:
