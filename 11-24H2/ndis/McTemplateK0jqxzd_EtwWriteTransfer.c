/*
 * XREFs of McTemplateK0jqxzd_EtwWriteTransfer @ 0x140036DD0
 * Callers:
...
__int64 __fastcall McTemplateK0jqxzd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a8)
{
  ...
  v20 = v8;
  v23 = &a8;
  return McGenEventWrite_EtwWriteTransfer(&NDIS_PROVIDER_ID_Context, &ProtocolBindStatus, a3, 6LL, v13);
}
