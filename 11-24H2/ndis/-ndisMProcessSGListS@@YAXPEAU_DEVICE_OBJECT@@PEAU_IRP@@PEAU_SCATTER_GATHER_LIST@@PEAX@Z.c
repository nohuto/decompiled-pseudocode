/*
 * XREFs of ?ndisMProcessSGListS@@YAXPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAU_SCATTER_GATHER_LIST@@PEAX@Z @ 0x1400DAEB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _NDIS_PACKET *a4)
{
  ...
  *(unsigned __int64 *)((char *)a4->Reserved + NdisPacketOobOffset) = (unsigned __int64)a3;
  ...
  v6 = *(_QWORD *)v11;
  if ( **(_BYTE **)v11 == 5 )
    v7 = *(struct _NDIS_MINIPORT_BLOCK **)(v6 + 32);
  else
    v7 = *(struct _NDIS_MINIPORT_BLOCK **)(v6 + 16);
  NDIS_ACQUIRE_MINIPORT_SPIN_LOCK_DPC(v7);
