/*
 * XREFs of ?ndisPnPNotifyBinding@@_Y2PAGENPNP@@AHPEAU_NDIS_OPEN_BLOCK@@PEAU_NET_PNP_EVENT_NOTIFICATION@@@Z @ 0x140173270
 * Callers:
...
__int64 __fastcall ndisPnPNotifyBinding(struct _NDIS_PROTOCOL_BLOCK *a1, struct _NET_PNP_EVENT_NOTIFICATION *a2)
{
  ...
  if ( v8->MajorNdisVersion >= 6u || v8->PnPEventHandler )
  {
    ...
    if ( v20.NetPnPEvent.NetEvent == NetEventPause && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
