/*
 * XREFs of ?ndisVerifierAllocateMemory@@YAHPEAPEAXIIT_LARGE_INTEGER@@@Z @ 0x1400C5A80
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisVerifierInjectResourceFailure@@YAEE@Z @ 0x1400C5FE4 (-ndisVerifierInjectResourceFailure@@YAEE@Z.c)
 *     NdisAllocateMemory @ 0x1400D45C0 (NdisAllocateMemory.c)
