/*
 * XREFs of ?ndisClearTransientBindFailuresAboveThisFilter@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@@Z @ 0x1401601A0
 * Callers:
...
LABEL_9:
  ...
  for ( i = 0LL; i != v10; ++i )
  {
    ...
    if ( (v15 != 0) != ((v15 & 0xFFFBFFE3) != 0) || !v13->BindState.Miniport )
    {
      ...
      v17 = (unsigned __int8)byte_14011CBA3 < 4u;
