/*
 * XREFs of ?ndisMSendPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1400D8400
 * Callers:
 *     ?ndisMSend@@YAHPEAXPEAU_NDIS_PACKET@@@Z @ 0x1400D8330 (-ndisMSend@@YAHPEAXPEAU_NDIS_PACKET@@@Z.c)
 * Callees:
