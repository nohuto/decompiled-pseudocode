/*
 * XREFs of ?ndisPnPPortActivation@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NET_PNP_EVENT_NOTIFICATION@@@Z @ 0x140065F90
 * Callers:
...
__int64 __fastcall ndisPnPPortActivation(struct _NDIS_MINIPORT_BLOCK *a1, struct _NET_PNP_EVENT_NOTIFICATION *a2)
{
  ...
  __int64 v16; // rcx
  int v17; // edx
  struct _GUID *v19; // [rsp+20h] [rbp-118h]
  __int64 v20; // [rsp+30h] [rbp-108h]
  __int64 v21; // [rsp+38h] [rbp-100h]
  struct _NET_PNP_EVENT_NOTIFICATION v22; // [rsp+40h] [rbp-F8h] BYREF
...
LABEL_33:
          ...
          if ( (byte_14011B103 & 0x20) != 0 )
          {
            ...
            McTemplateK0jqxqq_EtwWriteTransfer(
              (__int64)Flink,
              (__int64)&PnPPortActivationFailed,
