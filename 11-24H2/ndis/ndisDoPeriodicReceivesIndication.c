/*
 * XREFs of ndisDoPeriodicReceivesIndication @ 0x14003FE50
 * Callers:
...
__int64 __fastcall ndisDoPeriodicReceivesIndication(void *a1, struct _NET_BUFFER_LIST *Alignment)
{
  ...
  __int64 v17; // rdx
  struct _NDIS_FILTER_BLOCK *v18; // r14
    ...
    if ( !*((_BYTE *)a1 + 1995) )
    {
            ...
            (unsigned int)v13 < 3) )
      {
        ...
        *(_DWORD *)((char *)ndisPerProcRcvTrackers + (_QWORD)v12) = v13 + 1;
        Pool2 = (__int64)&v12[696 * v13 + 8 + (_QWORD)v11];
LABEL_16:
        ...
        *(_BYTE *)(Pool2 + 692) = 0;
        ...
        while ( v16 );
        v18 = (struct _NDIS_FILTER_BLOCK *)v15[41];
        ...
        else
        {
          ...
          *(_DWORD *)(Pool2 + 40) = v7;
          *(_DWORD *)(Pool2 + 44) = i;
          ndisSortNetBufferLists((struct _NDIS_NBL_RCV_TRACKER *)Pool2, v17, v12);
...
LABEL_38:
            ...
            if ( v10 )
            {
              if ( ExAcquireRundownProtectionCacheAware(RunRefCacheAware) )
              {
                ...
                *(_QWORD *)((char *)&v30 + 4) = v23 | 0x100000000LL;
                ...
                HIDWORD(v32) = 204;
                v33 = -536866809;
                (*(void (__fastcall **)(_QWORD, __int64, __int128 *, __int64 *, _QWORD))(*((_QWORD *)&xmmword_14011D820
                                                                                         + 1)
                                                                                       + 48LL))(
                  xmmword_14011D820,
                  v24,
    ...
    ndisMDispatchReceiveNetBufferListsWithLock((struct _NDIS_FILTER_BLOCK *)a1, v6, v7, i, 1u);
LABEL_49:
    if ( *((_BYTE *)a1 + 32) < 6u && (*((_DWORD *)a1 + 30) & 0x40000) == 0 )
    {
      KeAcquireSpinLockAtDpcLevel((PKSPIN_LOCK)a1 + 12);
