/*
 * XREFs of NdisGetSessionCompartmentId @ 0x140029740
 * Callers:
 *     NdisGetJobObjectCompartmentId @ 0x140029680 (NdisGetJobObjectCompartmentId.c)
 *     ?ndisNsiGetAllSessionInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1400296E0 (-ndisNsiGetAllSessionInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z.c)
...
LABEL_2:
  if ( v2 >= dword_14011C950 )
    return 1LL;
  v10 = KeAcquireSpinLockRaiseToDpc(&qword_14011C9A0);
  if ( v2 < dword_14011C950 )
    v1 = *((_DWORD *)qword_14011C9F0 + 6 * v2);
