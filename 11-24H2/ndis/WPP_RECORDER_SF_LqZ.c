/*
 * XREFs of WPP_RECORDER_SF_LqZ @ 0x140054980
 * Callers:
...
LABEL_11:
  ...
  if ( !a8 )
    v14 = L"\b";
  ndisWppFastTraceMessage(a5, a4, &a6, 4LL, &a7, 8LL, v14, 2LL, v13, v12, 0LL);
LABEL_2:
  if ( !v8 )
    v8 = L"\b";
  LOWORD(v15) = a4;
  return WppAutoLogTrace(a1, 4LL, 9LL, a5, v15, &a6, 4LL, &a7, 8LL, v8);
}
