/*
 * XREFs of ?ndisWdfAcquireAsyncPowerRefAndResume@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400C3A60
 * Callers:
...
void __fastcall ndisWdfAcquireAsyncPowerRefAndResume(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  ndisWdfSelectiveSuspendResumeOperations((struct _NDIS_FILTER_BLOCK *)a1, v2, 1);
}
