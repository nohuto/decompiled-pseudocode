/*
 * XREFs of ?ndisWmiQuerySingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAUtagWNODE_SINGLE_INSTANCE@@KPEAK@Z @ 0x14002E290
 * Callers:
 *     ndisWMIDispatch @ 0x14002EAB0 (ndisWMIDispatch.c)
 *     NdisWdfQuerySingleInstance @ 0x14006C790 (NdisWdfQuerySingleInstance.c)
 * Callees:
