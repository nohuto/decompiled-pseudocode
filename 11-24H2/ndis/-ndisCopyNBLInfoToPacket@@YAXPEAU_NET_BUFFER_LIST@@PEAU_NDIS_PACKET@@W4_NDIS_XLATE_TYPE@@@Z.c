/*
 * XREFs of ?ndisCopyNBLInfoToPacket@@YAXPEAU_NET_BUFFER_LIST@@PEAU_NDIS_PACKET@@W4_NDIS_XLATE_TYPE@@@Z @ 0x14004C240
 * Callers:
 ...
 * Callees:
 *     ndisIPsecNblInfoToPktInfo @ 0x1400A2A24 (ndisIPsecNblInfoToPktInfo.c)
 */
