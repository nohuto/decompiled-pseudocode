/*
 * XREFs of ?ndisValidateLWMiniportDriverCharacteristicsHeader@@YAHPEBU_NDIS_LWM_DRIVER_CHARACTERISTICS@@PEAE@Z @ 0x140137A7C
 * Callers:
        ...
        unsigned __int8 *a2)
{
  ...
  v2 = (const struct _GUID *)&unk_1400F7EE0;
