/*
 * XREFs of ?ndisInitializeConfiguration@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAX@Z @ 0x14016A2A0
 * Callers:
...
__int64 __fastcall ndisInitializeConfiguration(struct _NDIS_MINIPORT_BLOCK *a1, PCWSTR Path)
{
  ...
  *((_QWORD *)v9 + 1) = a1;
  ...
  {
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_INTERNAL )
    {
...
LABEL_27:
    ...
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_PCMCIA )
    {
      IntegerData = PCMCIABus;
      v18 = 8;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_PCI )
    {
      IntegerData = PCIBus;
      v18 = 5;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_USB )
    {
      IntegerData = Vmcs;
      v18 = 16;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_IRDA )
    {
      IntegerData = ACPIBus;
      v18 = 17;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_ISAPNP )
    {
      IntegerData = PNPISABus;
      v18 = 14;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_1394 )
    {
      v18 = 18;
      goto LABEL_27;
    }
    if ( PropertyBuffer == *(_OWORD *)&GUID_BUS_TYPE_EISA )
    {
      IntegerData = Eisa;
      v18 = 2;
      goto LABEL_27;
