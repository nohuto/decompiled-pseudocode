/*
 * XREFs of ?ndisRejectUnsupportedPMOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400B4AA4
 * Callers:
...
LABEL_2:
  v10[0] = 0;
  for ( i = a1->PMProtocolOffloadList.Next; i; i = *(_SINGLE_LIST_ENTRY **)v4 )
  {
    if ( !ndisIsPMProtocolOffloadSupported(SHIDWORD(i[7].Next), a1) )
    {
      ...
      else
      {
        ...
        *(_DWORD *)&v12.NdisReserved[16] |= 0x1800000u;
        ...
        v12.DATA.QUERY_INFORMATION.Oid = -50265841;
