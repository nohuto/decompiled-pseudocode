/*
 * XREFs of ?AddTriageBlocks@?$GlobalDataCollector@U_NDIS_GLOBAL_TRIAGE_BLOCK@@$1?ndisGlobalTriageBlock@@3U1@A@@SAXPEAXPEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x140098740
 * Callers:
 *     <none>
 * Callees:
