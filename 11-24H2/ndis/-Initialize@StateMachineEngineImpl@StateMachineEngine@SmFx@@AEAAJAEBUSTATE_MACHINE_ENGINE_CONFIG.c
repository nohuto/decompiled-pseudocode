/*
 * XREFs of ?Initialize@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAAJAEBUSTATE_MACHINE_ENGINE_CONFIG@3@@Z @ 0x1400E67A8
 * Callers:
 ...
 *     ?AllocatePoolWithTag@Memory@SmFx@@YAPEAXW4PoolType@12@_KI@Z @ 0x1400E6F00 (-AllocatePoolWithTag@Memory@SmFx@@YAPEAXW4PoolType@12@_KI@Z.c)
 */
