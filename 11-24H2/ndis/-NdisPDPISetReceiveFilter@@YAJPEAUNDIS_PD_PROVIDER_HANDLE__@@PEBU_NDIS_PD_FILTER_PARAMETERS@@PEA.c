/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x14013BD70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*((_BYTE *)a1 + 88) )
  {
    ...
    *((_QWORD *)PoolWithTag + 9) = 0LL;
    ...
    if ( HeaderGroupMatchArrayTotalSize )
    {
      ...
      Pool2 = (void *)ExAllocatePool2(66LL, HeaderGroupMatchArrayTotalSize, 1715553358LL);
      *((_QWORD *)v12 + 13) = Pool2;
      if ( !Pool2 )
      {
        v7 = -1073741670;
