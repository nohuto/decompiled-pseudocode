/*
 * XREFs of WPP_RECORDER_SF_sL @ 0x1400B725C
 * Callers:
...
__int64 WPP_RECORDER_SF_sL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const char *a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !a6 )
      v11 = "NULL";
    ndisWppFastTraceMessage(&WPP_588cecccef1c306149c05f90e63600c9_Traceguids, 0x4Bu, v11, v10, va, 4LL, 0LL);
  }
  if ( a6 )
  {
    do
  ...
  if ( !a6 )
    v6 = "NULL";
  LOWORD(v14) = 75;
  return WppAutoLogTrace(a1, 2LL, 14LL, &WPP_588cecccef1c306149c05f90e63600c9_Traceguids, v14, v6, v12, va, 4LL, 0LL);
}
