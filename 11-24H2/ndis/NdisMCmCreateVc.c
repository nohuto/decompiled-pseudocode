/*
 * XREFs of NdisMCmCreateVc @ 0x1400D19B0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  *NdisVcHandle = 0LL;
  ...
  v34 = (*(__int64 (__fastcall **)(__int64, _LIST_ENTRY *, _LIST_ENTRY **))(v19 + 1056))(v20, v11, &v11[1].Blink);
  if ( v34 )
  {
    ExFreePoolWithTag(v9, 0);
  ...
  else
  {
    ...
    v9[3] = v22;
    v11[6].Blink = v22;
    v11[6].Flink = *(_LIST_ENTRY **)(v21 + 1064);
    ExInterlockedInsertHeadList((PLIST_ENTRY)(v21 + 1120), v11 + 2, (PKSPIN_LOCK)(v21 + 232));
    Flink = v11[12].Flink;
    v9[5] = v11;
    ...
    if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 24LL) + 56LL) < 6u )
    {
      if ( (unsigned __int8)v24 < 6u )
      {
        ...
        v28 = 0LL;
        v30 = ndisCoSendPacketsToNdisPackets;
      }
      else
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
