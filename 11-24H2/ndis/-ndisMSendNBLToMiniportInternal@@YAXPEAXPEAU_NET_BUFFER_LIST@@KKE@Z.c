/*
 * XREFs of ?ndisMSendNBLToMiniportInternal@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKE@Z @ 0x140038F10
 * Callers:
 ...
 *     ?ndisMSendNBLToMiniport@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z @ 0x140038EF0 (-ndisMSendNBLToMiniport@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z.c)
 * Callees:
...
LABEL_29:
    ...
    v22 = (a1->Flags & 0x80u) == 0
        ? ndisWdmSetBusyAsync(a1)
        : ndisWdfSetBusyAsync((__int64)a1, v21, 0x34u, (__int64)v8, v7);
    if ( v22 )
    {
LABEL_37:
      if ( *(_DWORD *)ndisNblTrackerMode )
        ndisNblTrackerTransferOwnershipInternal(v8, 0LL, (unsigned __int64)a1->NblTracker, 0x92u, a4 & 1);
      if ( byte_14011D800 )
      {
        ...
        if ( CompContext )
        {
          if ( (*((_DWORD *)CompContext + 14) & 1) != 0 )
            PktMonClientNblLogNdis((__int64)&a1->PktMonEdge, (__int64)v8, a3, 2);
        }
      }
...
LABEL_25:
    ...
    if ( (a4 & 1) != 0 )
      v14 |= 1u;
    ndisMSendNetBufferListsCompleteInternal((struct _NDIS_FILTER_BLOCK *)a1, v15, v14, 0);
LABEL_26:
    v15 = v17;
  }
  while ( v17 );
