/*
 * XREFs of ?ndisOidPrePDOpenProvider@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x14013CEF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z @ 0x1401396D0 (--_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z.c)
 ...
 *     ?ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z @ 0x14013C8B8 (-ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z.c)
...
LABEL_36:
  ...
  *(_QWORD *)(v21 + 8) = v20;
  ...
  if ( *((_UNKNOWN **)PoolWithTag + 10) == &unk_1400F3390 )
    PoolWithTag[88] = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v24 = L"PASS_THROUGH";
