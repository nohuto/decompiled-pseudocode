/*
 * XREFs of ?ndisAllocateCombinedRSSParameters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAPEAU_NDIS_VPORT_BLOCK@@PEAPEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@33@Z @ 0x1400AB77C
 * Callers:
 ...
 *     ?ndisGetVPortBlockForRequest@@YAPEAU_NDIS_VPORT_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x1400ABE48 (-ndisGetVPortBlockForRequest@@YAPEAU_NDIS_VPORT_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@PEBU_NDIS_OID_R.c)
 *     ?ndisShouldCacheRSSv2ParametersInMiniport@@YAEPEBU_NDIS_OID_REQUEST@@@Z @ 0x1400ADD68 (-ndisShouldCacheRSSv2ParametersInMiniport@@YAEPEBU_NDIS_OID_REQUEST@@@Z.c)
        ...
        struct _NDIS_RECEIVE_SCALE_PARAMETERS **a6)
{
  ...
  if ( ndisShouldCacheRSSv2ParametersInMiniport(a2) )
  {
    ...
    {
      Pool2 = (_NDIS_MINIPORT_RSS_PARAMETERS_CACHE *)ExAllocatePool2(72LL, 2216LL, 1936868430LL);
  ...
  else
  {
    ...
    {
      RssParametersBuffer = (struct _NDIS_RECEIVE_SCALE_PARAMETERS *)ExAllocatePool2(72LL, 2216LL, 1936868430LL);
