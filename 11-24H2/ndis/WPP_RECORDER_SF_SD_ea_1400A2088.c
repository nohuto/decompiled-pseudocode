/*
 * XREFs of WPP_RECORDER_SF_SD @ 0x1400A2088
 * Callers:
...
__int64 WPP_RECORDER_SF_SD(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, const wchar_t *a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x4000000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    if ( !a6 )
      v13 = L"NULL";
    ndisWppFastTraceMessage(&WPP_9b060fe0224b38c36bb70306e6018616_Traceguids, a4, v13, v12, va, 4LL, 0LL);
  }
  v14 = a6 == 0LL;
  if ( a6 )
  {
  ...
  if ( v14 )
    v6 = L"NULL";
  LOWORD(v16) = a4;
  return WppAutoLogTrace(a1, 4LL, 27LL, &WPP_9b060fe0224b38c36bb70306e6018616_Traceguids, v16, v6, v10, va, 4LL, 0LL);
}
