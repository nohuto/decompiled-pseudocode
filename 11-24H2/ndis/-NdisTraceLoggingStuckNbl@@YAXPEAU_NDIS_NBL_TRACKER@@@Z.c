/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1400AF550
 * Callers:
  ...
  if ( *((_WORD *)a1 + 8) != 1 )
  {
    if ( *((_WORD *)a1 + 8) == 2 )
    {
      if ( (unsigned int)dword_14011A7E8 > 5 && tlgKeywordOn((__int64)&dword_14011A7E8, 0x400000000000LL) )
      {
        ...
        v28[1] = v7;
        v24 = 4LL;
        v10 = *(_WORD *)(v9 + 72) & 0xFFFE;
        v27 = *(_QWORD *)(v9 + 80);
        v28[0] = v10;
        v23 = &v16;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14011A7E8, byte_140101C64, 0LL, 0LL, 5u, &v22);
      }
      return;
    }
