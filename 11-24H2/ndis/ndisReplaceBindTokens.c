/*
 * XREFs of ndisReplaceBindTokens @ 0x140146AB8
 * Callers:
...
__int64 __fastcall ndisReplaceBindTokens(__int64 a1, NetSetupPropertyBag *a2)
{
  ...
  if ( *((_QWORD *)qword_14011D088 + 11) )
  {
    ...
    if ( !v13 )
    {
      Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_14011D088, L"ndis5");
      v6 = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_14011D088, L"wlan");
      if ( !Atom || !v6 )
        return 3221225626LL;
