/*
 * XREFs of ?ndisMIndicateReceiveNblsWithThrottling@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x140040490
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  struct _NDIS_FILTER_BLOCK *v37; // r14
  _QWORD *v38; // r9
  struct _NDIS_FILTER_BLOCK *v39; // r14
...
LABEL_35:
    ...
    *(_QWORD *)&a1[2].MediaType = KeGetCurrentThread();
    ...
    v28 = (unsigned __int64)(v7 + (int)a1[2].MediaConnectState) >> 32;
    if ( *(_DWORD *)&a1[2].PnPRef.ReferenceCount == 1 )
    {
      if ( !(_DWORD)v28 )
      {
        if ( v27 < 0x3E8 )
...
LABEL_32:
    *(_QWORD *)&a1[2].MediaType = 0LL;
    v32 = (KSPIN_LOCK *)&a1[2].PnPRef.RefCountTracker;
    if ( v25 )
  ...
  while ( Alignment )
  {
          ...
          (unsigned int)v34 < 3) )
    {
      ...
      *(_DWORD *)((char *)ndisPerProcRcvTrackers + (_QWORD)v18) = v34 + 1;
      Pool2 = (__int64)&v18[696 * v34 + 8 + (_QWORD)v33];
    }
    else
    {
    ...
    *(_BYTE *)(Pool2 + 692) = 0;
    ...
    v37 = *(struct _NDIS_FILTER_BLOCK **)(RcvLinkSpeedIndicateUp + 328);
    ...
    else
    {
      ...
      *(_QWORD *)Pool2 = a1;
      *(_DWORD *)(Pool2 + 44) = v13;
      ndisSortNetBufferLists((struct _NDIS_NBL_RCV_TRACKER *)Pool2, RcvLinkSpeedIndicateUp, v18);
      if ( *(_QWORD *)(Pool2 + 64) || *(_DWORD *)(Pool2 + 688) )
      {
        ...
        if ( !v37 )
        {
          v39 = (struct _NDIS_FILTER_BLOCK *)v38[1];
          if ( v39 )
          {
            ...
            do
            {
              ...
              v39 = (struct _NDIS_FILTER_BLOCK *)IterativeDataPathTracker;
            }
