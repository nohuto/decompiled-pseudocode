/*
 * XREFs of ndisPublishSleepStudyNapsCustomData @ 0x140136464
 * Callers:
 ...
 * Callees:
 *     ndisSleepStudyGetNameFromReasonCode @ 0x14008F508 (ndisSleepStudyGetNameFromReasonCode.c)
        ...
        char *a7)
{
  ...
  __int128 v24; // [rsp+80h] [rbp-41h] BYREF
  struct _GUID v25; // [rsp+90h] [rbp-31h] BYREF
  struct _GUID v26; // [rsp+A0h] [rbp-21h] BYREF
