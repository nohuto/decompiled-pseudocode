/*
 * XREFs of ?ndisMDispatchReceiveNetBufferLists@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x14001D9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  struct _NDIS_FILTER_BLOCK *v17; // rsi
  ...
  *(_BYTE *)(Pool2 + 692) = 0;
  ...
  v17 = (struct _NDIS_FILTER_BLOCK *)RcvLinkSpeedIndicateUp[41];
  ...
  else
  {
    ...
    *(_DWORD *)(Pool2 + 40) = a3;
    *(_DWORD *)(Pool2 + 44) = a4;
    ndisSortNetBufferLists((struct _NDIS_NBL_RCV_TRACKER *)Pool2, v13, v12);
    if ( *(_QWORD *)(Pool2 + 64) || *(_DWORD *)(Pool2 + 688) )
    {
      ...
      if ( !v17 )
      {
        v18 = (struct _NDIS_FILTER_BLOCK *)RcvLinkSpeedIndicateUp[1];
        if ( v18 )
        {
          ...
          do
          {
            ...
            v18 = (struct _NDIS_FILTER_BLOCK *)IterativeDataPathTracker;
          }
...
LABEL_25:
    if ( a2 )
    {
      if ( byte_14011D800 && ((__int64)v7[4].PendingOidRequest & 2) != 0 )
