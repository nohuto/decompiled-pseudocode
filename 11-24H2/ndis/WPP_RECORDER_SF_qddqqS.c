/*
 * XREFs of WPP_RECORDER_SF_qddqqS @ 0x14008E130
 * Callers:
        ...
        const wchar_t *a11)
{
  ...
  {
    do
      v15 = *(_WORD *)(v11 + 2 * v12++ + 2) == 0;
    while ( !v15 );
  }
  LOWORD(v19) = 48;
  return WppAutoLogTrace(a1, 4LL, 29LL, &WPP_bb899958c3b83c4be5ffe2f3031e3faa_Traceguids, v19, &a6, 8LL, &a7, 4LL, &a8);
}
