/*
 * XREFs of ?NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETRY_REASON_DATA@@KPEAU_NDIS_NAPS_TELEMETRY_OID_DATA@@@Z @ 0x1400AEB30
 * Callers:
 ...
 *     ?ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z @ 0x140070FF0 (-ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z.c)
        ...
        struct _NDIS_NAPS_TELEMETRY_OID_DATA *a11)
{
  ...
  union _LARGE_INTEGER v69; // [rsp+2F8h] [rbp+90h] BYREF
  const wchar_t *v70; // [rsp+300h] [rbp+98h] BYREF
  ...
  if ( (a1->PMHardwareCapabilities.Flags & 4) != 0 && a1->SelectiveSuspend && a3 >= 0x927C0 )
  {
    ...
    else
    {
      ...
      v15 = *(_QWORD *)&a1->MiniportAutoNegotiationFlags / 0x2710uLL;
    }
    v50.QuadPart = 0LL;
    if ( !a2 )
      ndisConvertInterruptTimeToLocalTime((__int64)a1, &v50);
