/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_M_DRIVER_BLOCK@@@@SAJPEAU_NDIS_M_DRIVER_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_M_DRIVER_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x140092274
 * Callers:
        ...
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  v11 = ObjectTriageData<_NDIS_M_DRIVER_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v26);
  if ( v11 )
  {
