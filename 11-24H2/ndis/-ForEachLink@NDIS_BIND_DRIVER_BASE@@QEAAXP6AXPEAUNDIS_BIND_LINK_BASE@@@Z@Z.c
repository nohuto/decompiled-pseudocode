/*
 * XREFs of ?ForEachLink@NDIS_BIND_DRIVER_BASE@@QEAAXP6AXPEAUNDIS_BIND_LINK_BASE@@@Z@Z @ 0x14015F800
 * Callers:
...
void __fastcall NDIS_BIND_DRIVER_BASE::ForEachLink(NDIS_BIND_DRIVER_BASE *this, void (__fastcall *a2)(_LIST_ENTRY *))
{
  ...
  m_Lock = (KPushLockBase *)(qword_14011D080 + 8);
  v11.m_Lock = (KPushLockBase *)(qword_14011D080 + 8);
