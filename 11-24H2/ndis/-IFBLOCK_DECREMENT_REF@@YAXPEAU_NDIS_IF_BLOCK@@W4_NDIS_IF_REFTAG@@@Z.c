/*
 * XREFs of ?IFBLOCK_DECREMENT_REF@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_IF_REFTAG@@@Z @ 0x1400110D0
 * Callers:
...
void __fastcall IFBLOCK_DECREMENT_REF(struct _NDIS_IF_BLOCK *a1, enum _NDIS_IF_REFTAG a2)
{
  bool v3; // zf
  ...
  _LIST_ENTRY *v8; // rdx
  _LIST_ENTRY *v9; // rcx
  struct _NDIS_IF_NETWORK_BLOCK *Network; // rax
  ...
  NdisDereferenceWithTag((ULONG_PTR)a1->RefCountTracker);
  v3 = a1->Ref-- == 1;
  if ( v3 )
  {
