/*
 * XREFs of ?NdisTraceLoggingDeviceAddFailure@@YAXW4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEBUNDIS_MINIPORT_CREATION_CONFIG@@JEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400AE45C
 * Callers:
...
char __fastcall NdisTraceLoggingDeviceAddFailure(int a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  const wchar_t *v15; // [rsp+58h] [rbp-18h] BYREF
  ...
  {
    result = tlgKeywordOn((__int64)&dword_14011A7E8, 0x400000000000LL);
    if ( result )
    {
