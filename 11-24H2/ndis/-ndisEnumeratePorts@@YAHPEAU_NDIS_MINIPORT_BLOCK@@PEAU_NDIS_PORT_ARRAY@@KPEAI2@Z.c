/*
 * XREFs of ?ndisEnumeratePorts@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PORT_ARRAY@@KPEAI2@Z @ 0x1400A7CB4
 * Callers:
...
{
  unsigned int v6; // esi
  struct _NDIS_PORT_ARRAY *v8; // rbx
  bool v10; // cl
  unsigned int NumberOfActivePorts; // ebp
  unsigned int v12; // r14d
  unsigned int v13; // edx
  _NDIS_PORT_CHARACTERISTICS *Ports; // rbx
  _LIST_ENTRY *i; // rax
  KIRQL v16; // dl
  ...
  *a5 = v12;
  if ( v12 <= a3 )
  {
    ...
    if ( v10 )
    {
      ...
      *(_QWORD *)&Ports->Header.Type = 4194688LL;
      Ports->Flags = 0;
      v13 = 1;
