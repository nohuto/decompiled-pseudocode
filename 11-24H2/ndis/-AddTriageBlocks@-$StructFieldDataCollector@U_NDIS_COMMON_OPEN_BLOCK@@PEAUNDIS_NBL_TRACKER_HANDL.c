/*
 * XREFs of ?AddTriageBlocks@?$StructFieldDataCollector@U_NDIS_COMMON_OPEN_BLOCK@@PEAUNDIS_NBL_TRACKER_HANDLE__@@$0CEI@@@SAXPEAU_NDIS_COMMON_OPEN_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400B7520
 * Callers:
 *     <none>
 * Callees:
