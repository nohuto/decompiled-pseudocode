/*
 * XREFs of NdisNblTrackerTransferOwnership @ 0x1400A2040
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1400A1A28 (-ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z.c)
 */
