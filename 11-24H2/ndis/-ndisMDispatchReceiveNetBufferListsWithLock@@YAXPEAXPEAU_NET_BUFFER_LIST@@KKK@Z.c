/*
 * XREFs of ?ndisMDispatchReceiveNetBufferListsWithLock@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x14003F570
 * Callers:
        ...
        unsigned int a5)
{
  ...
  *(_BYTE *)(Pool2 + 692) = 0;
  ...
  {
    ndisMIndicateNetBufferListsToOpen(*(struct _NDIS_FILTER_BLOCK **)(v17 + 328), a2, a3, a4, a5);
...
LABEL_26:
    if ( a2 )
    {
      if ( byte_14011D800 && ((__int64)v6[4].PendingOidRequest & 2) != 0 )
