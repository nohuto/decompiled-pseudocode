/*
 * XREFs of ??$ndisCallNextDatapathHandler@$0A@AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@KK@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z0AEAPEAU0@AEAK55@Z @ 0x1400462D0
 * Callers:
 *     ??$ndisDataPathExpandStackCallback@$0A@$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z@@YAXPEAX@Z @ 0x140046290 (--$ndisDataPathExpandStackCallback@$0A@$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z@@YAXPEAX@Z.c)
 * Callees:
