/*
 * XREFs of ndisKLoaderIrpCreateHandler @ 0x1400DCA80
 * Callers:
 ...
 *     ?GetDeviceObject@DriverService@@QEBAPEAU_DEVICE_OBJECT@@XZ @ 0x14014B510 (-GetDeviceObject@DriverService@@QEBAPEAU_DEVICE_OBJECT@@XZ.c)
 */
