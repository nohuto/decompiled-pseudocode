/*
 * XREFs of ?ndisBindGetProtocolDriver@@YA?AV?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@PEAU_UNICODE_STRING@@_N1@Z @ 0x14015D4F0
 * Callers:
        ...
        bool a4)
{
  ...
  m_Lock = (KPushLockBase *)qword_14011D080;
  v25.m_Lock = (KPushLockBase *)qword_14011D080;
  ...
  v10 = *(unsigned int *)(qword_14011D080 + 44);
  while ( 1 )
  {
    if ( v9 == v10 )
    {
        ...
        if ( v19->Name.__ptr_.__value_
          ...
          && (v22 = qword_14011D080,
              Rtl::KArray<KRef<NDIS_BIND_PROTOCOL_DRIVER>,1>::grow(
                (unsigned int *)(qword_14011D080 + 40),
                (unsigned int)(*(_DWORD *)(qword_14011D080 + 44) + 1))) )
        {
