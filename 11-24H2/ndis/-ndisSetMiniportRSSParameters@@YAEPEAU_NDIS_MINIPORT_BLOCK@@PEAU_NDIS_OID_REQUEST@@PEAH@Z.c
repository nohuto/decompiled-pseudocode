/*
 * XREFs of ?ndisSetMiniportRSSParameters@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x140073430
 * Callers:
...
__int64 __fastcall ndisSetMiniportRSSParameters(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OID_REQUEST *a2, int *a3)
{
  ...
  unsigned int InformationBufferLength; // r11d
  ...
  v7 = 1;
  v3->DATA.QUERY_INFORMATION.BytesNeeded = 0;
  if ( InformationBufferLength < 0x1C )
  {
    v3->DATA.QUERY_INFORMATION.BytesNeeded = 28;
    v8 = -1073676268;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_qql(
        *((_QWORD *)WPP_GLOBAL_Control + 8),
...
LABEL_21:
    v14 = ndisCalculateRssParametersSize(
            (struct _NDIS_RECEIVE_SCALE_PARAMETERS *)v3->DATA.QUERY_INFORMATION.InformationBuffer,
            &v21);
    v8 = v14;
    if ( v14 )
    {
    ...
    if ( *((_WORD *)InformationBuffer + 6) <= 0x200u )
    {
      if ( *((_WORD *)InformationBuffer + 10) == 40 || (InformationBuffer[4] & 0x10) != 0 || !InformationBuffer[8] )
      {
        ...
        v3->DATA.QUERY_INFORMATION.BytesNeeded = v21;
        v8 = -1073676268;
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          goto LABEL_39;
        v16 = 133;
...
LABEL_28:
  ...
  v3->DATA.QUERY_INFORMATION.BytesNeeded = v13;
  v8 = -1073676268;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qql(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
