/*
 * XREFs of ?ndisMWanSend@@YAHPEAX00@Z @ 0x1400D9080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMWanSend(_QWORD *a1, _LIST_ENTRY *a2, _LIST_ENTRY *a3)
{
  ...
  if ( (v3->Flags & 0x40000) != 0 || v4 )
  {
    ...
    if ( !v9 )
    {
      ...
      if ( v12 )
      {
        v13 = &v12[KeGetPcr()->Prcb.Number];
        v13->ifHCOutUcastOctets += LODWORD(a3[1].Blink);
        v13->ifHCOutOctets += LODWORD(a3[1].Blink);
      }
    }
  }
  else
