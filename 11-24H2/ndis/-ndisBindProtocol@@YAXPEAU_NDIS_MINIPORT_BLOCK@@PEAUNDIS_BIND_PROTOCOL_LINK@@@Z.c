/*
 * XREFs of ?ndisBindProtocol@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@@Z @ 0x140154760
 * Callers:
...
void __fastcall ndisBindProtocol(struct _NDIS_MINIPORT_BLOCK *a1, Ndis::BindState *this)
{
  ...
  else
  {
    *((_BYTE *)m_AdditionalContext + 1) = 1;
    ...
    if ( v7 )
    {
      ...
      if ( Ndis::BindState::SetSource(this, RemoveBindSource, UnsolicitedOpen) && (unsigned __int8)byte_14011CBA3 >= 4u )
      {
        v14 = this->Miniport;
  ...
  if ( v12 )
  {
    ...
    if ( v9 != v13 || !this->Miniport )
    {
      ...
      v12 = (unsigned __int8)byte_14011CBA3 < 4u;
