/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1401384D0
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x14018C098 (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1400E70B0 (__security_check_cookie.c)
 *     memset @ 0x1400E7500 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x14018C078 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
