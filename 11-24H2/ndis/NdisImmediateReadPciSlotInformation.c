/*
 * XREFs of NdisImmediateReadPciSlotInformation @ 0x140172B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisImmediateReadPciSlotInformation(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  __int64 v5; // rbx
