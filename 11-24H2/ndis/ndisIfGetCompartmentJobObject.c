/*
 * XREFs of ndisIfGetCompartmentJobObject @ 0x140057690
 * Callers:
 *     NdisGetAndReferenceCompartmentJobObject @ 0x140057670 (NdisGetAndReferenceCompartmentJobObject.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall ndisIfGetCompartmentJobObject(unsigned int a1, unsigned int *a2, __int64 a3)
{
  ...
  while ( *((_DWORD *)v7 + 4) != a1 )
  {
    if ( *((_DWORD *)v7 + 4) <= a1 )
    {
      ...
      if ( v7 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_14011CAA0 )
        continue;
    }
    goto LABEL_5;
  }
