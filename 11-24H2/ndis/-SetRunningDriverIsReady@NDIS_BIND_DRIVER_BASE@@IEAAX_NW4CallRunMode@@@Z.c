/*
 * XREFs of ?SetRunningDriverIsReady@NDIS_BIND_DRIVER_BASE@@IEAAX_NW4CallRunMode@@@Z @ 0x14015F1B0
 * Callers:
 ...
 * Callees:
 *     _lambda_062918d3b118b4760965b8092450098c_::operator_void_(__cdecl_)(NDIS_BIND_LINK_BASE__) @ 0x1401434D4 (_lambda_062918d3b118b4760965b8092450098c_--operator_void_(__cdecl_)(NDIS_BIND_LINK_BASE__).c)
