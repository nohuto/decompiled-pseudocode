/*
 * XREFs of ?ndisBuildDeviceAcl@@YAJPEAPEAU_ACL@@K@Z @ 0x140064960
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x14013EEBC (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 * Callees:
...
__int64 __fastcall ndisBuildDeviceAcl(struct _ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v8 = RtlLengthSid(&unk_1400FC218);
    v9 = RtlLengthSid(&unk_1400FC238) + v8;
    v10 = RtlLengthSid(&unk_1400FC258);
    v5 = v9 + v10 + v26 + 32;
  }
  v11 = a2 & 4;
  if ( (a2 & 4) != 0 )
...
LABEL_43:
  ...
  v22 = a2 & 0x80;
  if ( v22 )
    v5 += RtlLengthSid(&unk_1400FC1F8) + 8;
  ...
  if ( v23 )
  {
    ...
    if ( Acl >= 0 )
    {
      ...
      if ( v7 )
      {
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_1400FC258);
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_1400FC238);
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_1400FC218);
      }
      if ( v11 )
      ...
      if ( v22 )
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_1400FC1F8);
      Acl = 0;
      *v30 = v24;
    }
    else
