/*
 * XREFs of ?ndisIfReadNetworkGuidFromKey@@YAJAEAVKRegKey@@PEAU_GUID@@@Z @ 0x1400C939C
 * Callers:
 ...
 *     ??0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z @ 0x1401360B0 (--0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z.c)
