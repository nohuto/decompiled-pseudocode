/*
 * XREFs of ?AddTriageBlocks@?$OidRequestQueueCollector@U_NDIS_FILTER_BLOCK@@@@SAXPEAU_NDIS_FILTER_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x140097B90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall OidRequestQueueCollector<_NDIS_FILTER_BLOCK>::AddTriageBlocks(__int64 a1, TriageDataArray *a2)
{
  void *v4; // rcx
