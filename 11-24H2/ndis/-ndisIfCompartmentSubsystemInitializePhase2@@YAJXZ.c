/*
 * XREFs of ?ndisIfCompartmentSubsystemInitializePhase2@@YAJXZ @ 0x1400C9B20
 * Callers:
...
__int64 ndisIfCompartmentSubsystemInitializePhase2(void)
{
  ...
  struct _NDIS_IF_COMPARTMENT_BLOCK *v20; // [rsp+98h] [rbp-70h] BYREF
  ...
  LODWORD(v21[8]) = 1640;
  LODWORD(v21[13]) = 0;
  v3 = NsiEnumerateObjectsAllParametersEx(v21);
  if ( v3 >= 0 )
  {
    v4 = v21[13];
    if ( LODWORD(v21[13]) )
    {
      while ( 1 )
      {
        ...
        v2 = (4 * v4 + 7) & 0xFFFFFFF8;
        if ( 4 * (unsigned __int64)v4 > 0xFFFFFFFF || v2 + 1640 * v4 < v2 )
        {
          v3 = -1073741670;
          goto LABEL_33;
        }
        v5 = v2;
        Pool2 = ExAllocatePool2(64LL, v2 + 1640LL * v4, 1718174798LL);
        v0 = (void *)Pool2;
        if ( !Pool2 )
        {
          v3 = -1073741670;
          ...
          if ( *(_BYTE *)v11 == 0xAD )
          {
            ...
            if ( v12 )
            {
              ...
              if ( v13 >= 0x448u )
              {
                ...
                v3 = ndisIfCreateCompartmentBlock(*(unsigned int *)(v10 + 4LL * v8), 0LL, v11, &v20);
                if ( v3 >= 0 )
                {
                  v15 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceObjectExtension);
                  if ( dword_14011AF2C <= (unsigned int)(*(_DWORD *)(v10 + 4LL * v8) + 1) )
                    dword_14011AF2C = *(_DWORD *)(v10 + 4LL * v8) + 1;
    ...
    else
    {
      ...
      *(_OWORD *)&v22[135] = xmmword_1400FE310;
