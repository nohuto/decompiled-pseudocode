/*
 * XREFs of ?ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1400487E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_11:
          if ( v10 < dword_14011C950 )
          {
            v20 = KeAcquireSpinLockRaiseToDpc(&qword_14011C9A0);
            if ( v10 < dword_14011C950 )
              v5 = *((_DWORD *)qword_14011C9F0 + 6 * v10);
            KeReleaseSpinLock(&qword_14011C9A0, v20);
            if ( !v5 )
              v5 = 1;
            v11 = v5;
          }
