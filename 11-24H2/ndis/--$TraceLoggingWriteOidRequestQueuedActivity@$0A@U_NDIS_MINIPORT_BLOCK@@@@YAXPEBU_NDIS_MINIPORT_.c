/*
 * XREFs of ??$TraceLoggingWriteOidRequestQueuedActivity@$0A@U_NDIS_MINIPORT_BLOCK@@@@YAXPEBU_NDIS_MINIPORT_BLOCK@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x14008DE30
 * Callers:
 ...
 *     ?ndisMQueueOidRequest@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x140046FA0 (-ndisMQueueOidRequest@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z.c)
 * Callees:
 ...
 *     ?GetRequestSourceInstanceName@@YAPEBU_UNICODE_STRING@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x1400DD1A8 (-GetRequestSourceInstanceName@@YAPEBU_UNICODE_STRING@@PEBU_NDIS_OID_REQUEST@@@Z.c)
 */
...
void TraceLoggingWriteOidRequestQueuedActivity<0,_NDIS_MINIPORT_BLOCK>()
{
  ...
  if ( (unsigned int)dword_14011A7B0 > 4 && tlgKeywordOn((__int64)&dword_14011A7B0, 1024LL) )
  {
