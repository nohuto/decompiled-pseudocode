/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_COMMON_OPEN_BLOCK@@@@SAJPEAU_NDIS_COMMON_OPEN_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_COMMON_OPEN_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x1400B792C
 * Callers:
        ...
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  v11 = ObjectTriageData<_NDIS_COMMON_OPEN_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, (void **)&v25);
  if ( v11 )
  {
