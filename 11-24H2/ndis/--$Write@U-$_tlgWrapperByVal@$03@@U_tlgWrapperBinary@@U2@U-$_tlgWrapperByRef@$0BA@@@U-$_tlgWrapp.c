        ...
        __int64 a11)
{
  ...
  int v14; // eax
  __int64 v15; // rcx
  _EVENT_DATA_DESCRIPTOR v17; // [rsp+30h] [rbp-A1h] BYREF
  ...
  const wchar_t *v32; // [rsp+C0h] [rbp-11h]
  ...
  v23[1] = 0;
  v19 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14011A7E8, a2, 0LL, 0LL, 0xBu, &v17);
}
