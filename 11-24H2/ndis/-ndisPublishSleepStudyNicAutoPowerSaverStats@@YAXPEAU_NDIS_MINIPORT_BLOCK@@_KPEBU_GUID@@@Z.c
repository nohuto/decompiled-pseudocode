/*
 * XREFs of ?ndisPublishSleepStudyNicAutoPowerSaverStats@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_KPEBU_GUID@@@Z @ 0x140168D40
 * Callers:
 ...
 *     ??$ReadAcquire@EX@mem@@YAEPEDE@Z @ 0x14008F2F8 (--$ReadAcquire@EX@mem@@YAEPEDE@Z.c)
