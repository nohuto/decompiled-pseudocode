/*
 * XREFs of ?ReadKnobFromKey@RegistryKnobCollection@@MEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobState@@@Z @ 0x140160AF0
 * Callers:
 *     ?ReadKnobFromKey@ExecutionContextCpuKnobCollection@@MEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobState@@@Z @ 0x140149E70 (-ReadKnobFromKey@ExecutionContextCpuKnobCollection@@MEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKn.c)
 *     ?ReadKnobFromKey@InterfaceProfileKnobCollection@@MEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobState@@@Z @ 0x140160AC0 (-ReadKnobFromKey@InterfaceProfileKnobCollection@@MEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobS.c)
 * Callees:
