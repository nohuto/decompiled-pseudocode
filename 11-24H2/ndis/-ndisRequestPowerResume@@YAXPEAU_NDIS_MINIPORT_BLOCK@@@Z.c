/*
 * XREFs of ?ndisRequestPowerResume@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400C2F54
 * Callers:
 ...
 *     ?ndisMoveLinkedList@@YAXPEAU_LIST_ENTRY@@0@Z @ 0x1400506D0 (-ndisMoveLinkedList@@YAXPEAU_LIST_ENTRY@@0@Z.c)
...
{
  struct _NDIS_SELECTIVE_SUSPEND *PendingOidRequest; // rdi
  KIRQL v3; // al
  int v4; // ecx
  KIRQL v5; // bp
