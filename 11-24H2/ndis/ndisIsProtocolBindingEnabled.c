/*
 * XREFs of ndisIsProtocolBindingEnabled @ 0x14014640C
 * Callers:
...
__int64 __fastcall ndisIsProtocolBindingEnabled(__int64 a1, __int64 a2, bool *a3)
{
  ...
  if ( *(_DWORD *)(a1 + 64) || (v6 = 0LL, *(_DWORD *)(a2 + 60)) )
    v6 = 1LL;
  netsetupBuildBindingRegistryPath(v6, 0LL, a1, a2, 0LL, 0LL, pszSrc);
  return ndisIsBindPathEnabled(pszSrc, *(_BYTE *)(a2 + 56), a3);
}
