/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x14014DB64
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x14014DFF4 (SeUtilSecurityInfoFromSecurityDescriptor.c)
