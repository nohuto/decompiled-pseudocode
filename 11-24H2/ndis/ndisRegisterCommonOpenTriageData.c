/*
 * XREFs of ndisRegisterCommonOpenTriageData @ 0x1400B8298
 * Callers:
...
__int64 __fastcall ndisRegisterCommonOpenTriageData(__int64 a1, __int64 a2, TriageData *a3)
{
  ...
  bool (__fastcall *v6)(void *, TriageDataArray *); // [rsp+28h] [rbp-21h]
  int v7; // [rsp+30h] [rbp-19h]
  bool (__fastcall *v8)(__int64, TriageDataArray *); // [rsp+38h] [rbp-11h]
  int v9; // [rsp+40h] [rbp-9h]
  bool (__fastcall *v10)(__int64, TriageDataArray *); // [rsp+48h] [rbp-1h]
  int v11; // [rsp+50h] [rbp+7h]
  bool (__fastcall *v12)(__int64, TriageDataArray *); // [rsp+58h] [rbp+Fh]
  int v13; // [rsp+60h] [rbp+17h]
  void (__fastcall *v14)(__int64, TriageDataArray *); // [rsp+68h] [rbp+1Fh]
  int v15; // [rsp+70h] [rbp+27h]
  bool (__fastcall *v16)(__int64, TriageDataArray *); // [rsp+78h] [rbp+2Fh]
  int v17; // [rsp+80h] [rbp+37h]
  char (__fastcall *v18)(__int64, TriageDataArray *); // [rsp+88h] [rbp+3Fh]
  ...
  v3 = ObjectTriageData<_NDIS_COMMON_OPEN_BLOCK>::Make((_LIST_ENTRY *)a1, &v5, a3, (TriageData **)(a1 + 1024));
