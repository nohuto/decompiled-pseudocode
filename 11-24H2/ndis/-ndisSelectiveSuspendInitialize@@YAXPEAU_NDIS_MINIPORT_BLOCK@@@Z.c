/*
 * XREFs of ?ndisSelectiveSuspendInitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1401412C8
 * Callers:
    ...
    && DriverHandle->CancelIdleNotificationHandler )
  {
    ...
    if ( Pool2 )
    {
      ...
      *((_QWORD *)v5 + 75) = v6;
      if ( v6 )
      {
        *(_OWORD *)v6 = xmmword_1400F6BA0;
        *(_OWORD *)(v6 + 16) = xmmword_1400F6BB0;
        *(_OWORD *)(v6 + 32) = xmmword_1400F6BC0;
        *(_OWORD *)(v6 + 48) = xmmword_1400F6BD0;
        *(_OWORD *)(v6 + 64) = xmmword_1400F6BE0;
        *(_OWORD *)(v6 + 80) = xmmword_1400F6BF0;
        *(_OWORD *)(v6 + 96) = xmmword_1400F6C00;
        *(_QWORD *)(v6 + 112) = 0LL;
        *((_QWORD *)v5 + 68) = 0LL;
