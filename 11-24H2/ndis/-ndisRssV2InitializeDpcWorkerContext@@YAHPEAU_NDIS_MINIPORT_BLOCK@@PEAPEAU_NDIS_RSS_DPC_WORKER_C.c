/*
 * XREFs of ?ndisRssV2InitializeDpcWorkerContext@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAPEAU_NDIS_RSS_DPC_WORKER_CONTEXT@@@Z @ 0x1400742D0
 * Callers:
...
__int64 __fastcall ndisRssV2InitializeDpcWorkerContext(PVOID DeferredContext, struct _KDPC **a2)
{
  ...
  *a2 = 0LL;
  Pool2 = (struct _KDPC *)ExAllocatePool2(72LL, 3208LL, 1936868430LL);
  v5 = Pool2;
  if ( !Pool2 )
    return 3221225626LL;
