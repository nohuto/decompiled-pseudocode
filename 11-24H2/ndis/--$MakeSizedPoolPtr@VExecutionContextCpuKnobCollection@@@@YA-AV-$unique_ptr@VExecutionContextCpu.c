/*
 * XREFs of ??$MakeSizedPoolPtr@VExecutionContextCpuKnobCollection@@@@YA?AV?$unique_ptr@VExecutionContextCpuKnobCollection@@U?$KFreePool@VExecutionContextCpuKnobCollection@@@@@wistd@@K_K@Z @ 0x14014981C
 * Callers:
...
_QWORD *__fastcall MakeSizedPoolPtr<ExecutionContextCpuKnobCollection>(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 Pool2; // rax
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 88) = 0LL;
    *(_OWORD *)(Pool2 + 8) = 0LL;
    *(_QWORD *)Pool2 = &ExecutionContextCpuKnobCollection::`vftable';
    *(_QWORD *)(Pool2 + 24) = 0LL;
    *(_QWORD *)(Pool2 + 32) = 0LL;
    *(_QWORD *)(Pool2 + 40) = 0LL;
    *(_QWORD *)(Pool2 + 48) = 0LL;
