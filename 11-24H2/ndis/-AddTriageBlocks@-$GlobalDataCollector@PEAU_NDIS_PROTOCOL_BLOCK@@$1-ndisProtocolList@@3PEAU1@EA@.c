/*
 * XREFs of ?AddTriageBlocks@?$GlobalDataCollector@PEAU_NDIS_PROTOCOL_BLOCK@@$1?ndisProtocolList@@3PEAU1@EA@@SAXPEAXPEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400986E0
 * Callers:
 *     <none>
 * Callees:
