/*
 * XREFs of _lambda_3ed15a572a362cb111cc1d3010d8268d_::operator() @ 0x140144134
 * Callers:
...
__int64 __fastcall lambda_3ed15a572a362cb111cc1d3010d8268d_::operator()(unsigned int *a1, const struct _GUID *a2)
{
  ...
  wchar_t pszSrc[256]; // [rsp+50h] [rbp-B0h] BYREF

  v2 = *a1;
  netsetupBuildObjectPath(2LL, a2, *a1);
  v9.m_ptr = 0LL;
  v4 = KRegKey::Open(&v9, 1u, pszSrc, 0LL);
  if ( v4 >= 0 )
  {
    netsetupBuildObjectPath(2LL, a2, v2);
    v10.m_ptr = 0LL;
    v5 = KRegKey::Open(&v10, 1u, pszSrc, 0LL);
