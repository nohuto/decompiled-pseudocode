/*
 * XREFs of ?ndisMIsLoopbackNetBuffer@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NET_BUFFER@@PEAU_NET_BUFFER_LIST@@PEAE3@Z @ 0x14004D100
 * Callers:
  ...
  *v13 = 0;
  if ( MappedSystemVa )
  {
    ...
    if ( a1->MiniportMediaType == NdisMedium802_3 )
    {
      ...
      BindListLock = a1->EthDB->BindListLock;
