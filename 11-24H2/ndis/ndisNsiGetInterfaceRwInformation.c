/*
 * XREFs of ndisNsiGetInterfaceRwInformation @ 0x1401517F0
 * Callers:
...
LABEL_21:
          ...
          memset(v41, 0, 0x204uLL);
          *(_WORD *)v41 = *(_WORD *)(v22[2] + 112LL) + 12 + *(_WORD *)(*(_QWORD *)(v22[4] + 4040LL) + 596LL);
          if ( *(_WORD *)v41 > 0x200u )
            *(_WORD *)v41 = 512;
          memmove(
            &v41[2],
          ...
          v24 = *(unsigned __int16 *)(*(_QWORD *)(v22[4] + 4040LL) + 596LL);
          v25 = *(_WORD *)v41;
          v26 = &v41[v24 + 2];
          v35 = &v41[v24 + 2];
          ...
          if ( v25 - (unsigned int)v24 >= 8 )
            *(_QWORD *)v26 = *(_QWORD *)(*(_QWORD *)(v22[5] + 8LL)
...
LABEL_25:
      ...
      {
        v20 = *(_QWORD *)(v36 + 1320);
        v21 = *(unsigned int (__fastcall **)(__int64, _QWORD, unsigned int *, char *))(*(_QWORD *)(v36 + 1328) + 56LL);
        v32 = v17;
        if ( !v21(v20, v16, &v32, v10) )
        {
          if ( v32 < v17 )
