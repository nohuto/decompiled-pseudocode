/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U_tlgWrapperBinary@@U2@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@AEBU_tlgWrapperBinary@@43@Z @ 0x140002D8C
 * Callers:
        ...
        __int64 a8)
{
  ...
  v15[1] = 0;
  v11 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14011A7E8, a2, 0LL, 0LL, 8, v9);
}
