/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1400D4FFC
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1400D5230 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1400D52E0 (NdisImmediateWriteSharedMemory.c)
 * Callees:
