/*
 * XREFs of ?ndisReinitializeHistograms@@YAJXZ @ 0x140138CD8
 * Callers:
 ...
 *     ??3?$KALLOCATOR@$0GHGIEEEO@$00@@SAXPEAX@Z @ 0x140138788 (--3-$KALLOCATOR@$0GHGIEEEO@$00@@SAXPEAX@Z.c)
...
LABEL_8:
      ...
      KLockThisExclusive::KLockThisExclusive(&v11, &stru_14011C8E8);
      if ( qword_14011CF38 )
      {
        ndisHistogramDeleteAllEntries();
        KALLOCATOR<1734886478,1>::operator delete(qword_14011CF38);
        qword_14011CF38 = 0LL;
      }
      v7 = v2;
      if ( v10 )
