/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1400CCF9C
 * Callers:
 ...
 *     ndisIfGetUniqueSiteId @ 0x1400CD290 (ndisIfGetUniqueSiteId.c)
 */
  ...
  if ( (*(_DWORD *)(a1 + 40) & 1) == 0 && v8 && ndisIsValidIfStringParts(v10, *(unsigned __int16 *)(a3 + 12)) )
  {
    ...
    if ( Pool2 )
    {
      ...
      *((_DWORD *)v13 + 19) = 1;
      ...
      while ( v11 );
      v25 = (__int64 *)qword_14011CAB0;
      *v17 = *(_OWORD *)a3;
      while ( v25 != &qword_14011CAB0 )
      {
