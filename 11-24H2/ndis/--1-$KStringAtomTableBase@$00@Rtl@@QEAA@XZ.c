/*
 * XREFs of ??1?$KStringAtomTableBase@$00@Rtl@@QEAA@XZ @ 0x140144D38
 * Callers:
 *     ??1NdisBindBuilderGlobal@@QEAA@XZ @ 0x140144EB4 (--1NdisBindBuilderGlobal@@QEAA@XZ.c)
 * Callees:
 *     ?FreeBuckets@?$KHashTableBase@$00@Rtl@@CAXPEAX0@Z @ 0x140145024 (-FreeBuckets@-$KHashTableBase@$00@Rtl@@CAXPEAX0@Z.c)
 */
