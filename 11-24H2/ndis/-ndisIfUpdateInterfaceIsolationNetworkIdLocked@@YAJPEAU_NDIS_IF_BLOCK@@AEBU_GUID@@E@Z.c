/*
 * XREFs of ?ndisIfUpdateInterfaceIsolationNetworkIdLocked@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@E@Z @ 0x14002B6B0
 * Callers:
        ...
        char a3)
{
  ...
  if ( !a1->NetworkIdOverridden || a3 )
  {
    ...
    {
LABEL_12:
      if ( a1->ProviderHandle == qword_14011D530 && (a1->Flags & 2) != 0 )
      {
        if ( a1->IsNdisFilter )
        {
