/*
 * XREFs of ?AddTriageBlocks@?$GlobalDataCollector@PEAU_NDIS_M_DRIVER_BLOCK@@$1?ndisMiniDriverList@@3PEAU1@EA@@SAXPEAXPEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400986B0
 * Callers:
 *     <none>
 * Callees:
