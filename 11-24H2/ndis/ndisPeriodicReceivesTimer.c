/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x14004E360
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_14011B500 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
  ...
  if ( *(char **)v5 == v5 )
  {
    *((_DWORD *)qword_14011B4F8 + Number) = 0;
  }
  else
  {
    v9.QuadPart = -1LL;
    if ( DueTime.QuadPart )
      v9 = DueTime;
    KeSetTimer(
      (PKTIMER)qword_14011B4F0 + 2 * (unsigned __int64)KeGetPcr()->Prcb.Number,
      v9,
      (PKDPC)qword_14011B4F0 + 2 * Number + 1);
  }
