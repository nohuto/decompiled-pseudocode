/*
 * XREFs of ?ndisReadPMRegistry@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x140083D30
 * Callers:
...
void __fastcall ndisReadPMRegistry(NDIS_HANDLE ConfigurationHandle, struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  Status = 0;
  ParameterValue = 0LL;
  a2->PMAdminConfig.Value = (4 * v7) | v8;
  v9 = 0;
  ...
  v10 = (16 * v9) | a2->PMAdminConfig.Value & 0xFFFFFFCF;
  Status = 0;
  ...
  v12 = (v11 << 6) | a2->PMAdminConfig.Value & 0xFFFFFF3F;
  Status = 0;
  ...
  v16 = (v15 << 10) | a2->PMAdminConfig.Value & 0xFFFFF3FF;
  Status = 0;
