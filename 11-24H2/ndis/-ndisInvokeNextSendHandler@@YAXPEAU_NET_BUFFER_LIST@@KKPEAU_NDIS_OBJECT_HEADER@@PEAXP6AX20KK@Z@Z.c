/*
 * XREFs of ?ndisInvokeNextSendHandler@@YAXPEAU_NET_BUFFER_LIST@@KKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KK@Z@Z @ 0x1400207D0
 * Callers:
        ...
        void (*a6)(void *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int))
{
  ...
  else
  {
    ...
    v32 = *(_QWORD *)(v31 + qword_14011D048);
    LowLimit = v32;
    v33 = *(_QWORD *)(v31 + qword_14011D040);
    HighLimit = v33;
    ...
    if ( (unsigned __int64)&retaddr - v32 < v30 )
    {
      ...
      if ( KeExpandKernelStackAndCalloutEx(
             ...
             0LL) < 0 )
      {
        if ( byte_14011D800 && (*(_DWORD *)&v7[210] & 2) != 0 )
