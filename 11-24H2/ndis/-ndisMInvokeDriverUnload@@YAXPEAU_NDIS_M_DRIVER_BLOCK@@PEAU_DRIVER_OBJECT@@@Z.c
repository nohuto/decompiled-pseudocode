/*
 * XREFs of ?ndisMInvokeDriverUnload@@YAXPEAU_NDIS_M_DRIVER_BLOCK@@PEAU_DRIVER_OBJECT@@@Z @ 0x14013808C
 * Callers:
...
void __fastcall ndisMInvokeDriverUnload(struct _NDIS_M_DRIVER_BLOCK *a1, struct _DRIVER_OBJECT *a2)
{
  ...
  if ( (unsigned int)dword_14011A7B0 > 4 && tlgKeywordOn((__int64)&dword_14011A7B0, 512LL) )
  {
    v7 = 1;
    v4 = 1;
  }
