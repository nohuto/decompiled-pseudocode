/*
 * XREFs of ?ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x140147420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMpHookNmrClientAttachProvider(void *a1, void *a2, const struct _NPI_REGISTRATION_INSTANCE *a3)
{
  ...
  if ( a3->Version == 1
    ...
    && (v4 = *(int *)NpiSpecificCharacteristics, (_DWORD)v4 == 1) )
  {
    return MINIPORT_HOOK_DRIVER::Register(
             (struct MINIPORT_HOOK_DRIVER *)((char *)g_MiniportHookDrivers + 128 * v4),
             a1,
