/*
 * XREFs of ?ndisCreateNdisSupportedOidList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14006DE10
 * Callers:
...
__int64 __fastcall ndisCreateNdisSupportedOidList(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  Pool2 = ExAllocatePool2(64LL, v6, 1835091022LL);
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 176) = *((_DWORD *)&ndisHandledNdis5Ndis6GenOids + 44);
    if ( a1->MajorNdisVersion >= 6u )
    {
      ...
      *(_OWORD *)(ndisSupportedOidList + 49) = xmmword_140189AF0;
      *(_OWORD *)(ndisSupportedOidList + 53) = xmmword_140189B00;
      *(_OWORD *)(ndisSupportedOidList + 57) = xmmword_140189B10;
      *(_OWORD *)(ndisSupportedOidList + 61) = xmmword_140189B20;
      *(_OWORD *)(ndisSupportedOidList + 65) = xmmword_140189B30;
      *(_OWORD *)(ndisSupportedOidList + 69) = xmmword_140189B40;
      *(_OWORD *)(ndisSupportedOidList + 73) = xmmword_140189B50;
      *(_OWORD *)(ndisSupportedOidList + 77) = xmmword_140189B60;
      *(_QWORD *)(ndisSupportedOidList + 81) = qword_140189B70;
    }
    if ( a1->MediaType == NdisMedium802_3 )
    {
