/*
 * XREFs of ?ndisPDUpdateQDepthCounter@@YAXPEAUNDIS_PD_EC@@@Z @ 0x1400A4594
 * Callers:
...
void __fastcall ndisPDUpdateQDepthCounter(LARGE_INTEGER *a1)
{
  ...
  if ( !PerformanceFrequency.QuadPart )
  {
    ...
    qword_14011CF48 = PerformanceFrequency.QuadPart / 100;
  }
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  if ( PerformanceCounter.QuadPart - a1[18].QuadPart >= (unsigned __int64)qword_14011CF48 )
  {
