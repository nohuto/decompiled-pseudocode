/*
 * XREFs of ?ndisLoadNetworkInterfaceFromPersistedState@@YAJAEBU_GUID@@AEAVKRegKey@@1@Z @ 0x14015AB30
 * Callers:
        ...
        struct KRegKey *a3)
{
  ...
  *(_OWORD *)&v9[0].m_ptr = 0LL;
  ...
  if ( NetworkInterfaceV2 >= 0 )
  {
    ...
    if ( (unsigned int)ndisIfCreateInterfaceFromPersistentStore(a1, (__int64)v9, v5) )
    {
