/*
 * XREFs of ?ndisValidateMiniportDriverCharacteristicsHeader@@YAHPEBU_NDIS_MINIPORT_DRIVER_CHARACTERISTICS@@PEBU_UNICODE_STRING@@PEAK22@Z @ 0x140168790
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  *a5 = 0;
  ...
  for ( i = (const struct _GUID *)&unk_1400F7EE0; ; i = (const struct _GUID *)((char *)i + 8) )
  {
