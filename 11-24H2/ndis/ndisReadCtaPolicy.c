/*
 * XREFs of ndisReadCtaPolicy @ 0x140137BB8
 * Callers:
 *     ndisHiveLoadCallback @ 0x140137BA0 (ndisHiveLoadCallback.c)
 * Callees:
 *     ??$WriteNoFence@EX@mem@@YAXPECEE@Z @ 0x14008E9A0 (--$WriteNoFence@EX@mem@@YAXPECEE@Z.c)
