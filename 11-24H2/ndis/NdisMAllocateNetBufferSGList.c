/*
 * XREFs of NdisMAllocateNetBufferSGList @ 0x1400283A0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ScatterGatherListBufferSize)
{
  ...
  if ( v20 < 0 )
  {
    v32 = 0LL;
    Lookaside = 0LL;
    Pool2 = (void *)ExAllocatePool2(66LL, Length, 1735607374LL);
    Entryb = Pool2;
    if ( Pool2 )
    {
    ...
    NetBuffer->NdisReserved[0] = 0LL;
    v36 = NetBuffer->Reserved & 0xFFFD;
    NetBuffer->Reserved = v36;
    if ( v20 < 0 )
      NetBuffer->Reserved = v36 & 0xFFFB;
  }
LABEL_16:
  if ( (v8 & 0x400) != 0 )
  {
