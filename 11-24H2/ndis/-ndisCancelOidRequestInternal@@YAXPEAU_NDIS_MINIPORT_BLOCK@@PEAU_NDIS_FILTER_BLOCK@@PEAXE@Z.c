/*
 * XREFs of ?ndisCancelOidRequestInternal@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_BLOCK@@PEAXE@Z @ 0x1400B98CC
 * Callers:
 *     ?ndisFCancelOidRequestInternal@@YAXPEAX@Z @ 0x140099FE0 (-ndisFCancelOidRequestInternal@@YAXPEAX@Z.c)
 ...
 *     NdisCancelOidRequest @ 0x1400C1040 (NdisCancelOidRequest.c)
 * Callees:
