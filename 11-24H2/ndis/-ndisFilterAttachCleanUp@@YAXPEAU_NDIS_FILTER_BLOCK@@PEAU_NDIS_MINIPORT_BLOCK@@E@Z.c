/*
 * XREFs of ?ndisFilterAttachCleanUp@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x14004EAC0
 * Callers:
...
void __fastcall ndisFilterAttachCleanUp(_NDIS_FILTER_BLOCK *this, struct _NDIS_MINIPORT_BLOCK *a2, char a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( v11 )
    {
      ...
      KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceObjectExtension, v16);
    }
