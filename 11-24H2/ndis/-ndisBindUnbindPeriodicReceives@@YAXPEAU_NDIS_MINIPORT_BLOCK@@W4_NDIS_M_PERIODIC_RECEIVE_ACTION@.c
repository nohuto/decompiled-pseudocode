/*
 * XREFs of ?ndisBindUnbindPeriodicReceives@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_M_PERIODIC_RECEIVE_ACTION@@@Z @ 0x14008D3A0
 * Callers:
    ...
    switch ( a2 )
    {
      ...
      case 2:
        ...
        *(_QWORD *)(a1 + 3184) = KeGetCurrentThread();
        ++*(_DWORD *)(a1 + 3216);
        if ( !*(_DWORD *)(a1 + 464) && byte_14011B4C1 == 1 && dword_14011B4C4 != -1 && !*(_DWORD *)(a1 + 3168) )
      ...
      case 5:
        ...
        *(_QWORD *)(a1 + 3184) = CurrentThread;
        ...
        v7 = qword_14011B4D8;
        if ( qword_14011B4D8 == (void *)a1 )
        {
          qword_14011B4D8 = (void *)*((_QWORD *)qword_14011B4D8 + 395);
          goto LABEL_16;
        }
        break;
      default:
