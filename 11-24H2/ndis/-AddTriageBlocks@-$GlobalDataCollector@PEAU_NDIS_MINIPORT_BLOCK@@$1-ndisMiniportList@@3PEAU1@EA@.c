/*
 * XREFs of ?AddTriageBlocks@?$GlobalDataCollector@PEAU_NDIS_MINIPORT_BLOCK@@$1?ndisMiniportList@@3PEAU1@EA@@SAXPEAXPEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x140098680
 * Callers:
 *     <none>
 * Callees:
