/*
 * XREFs of PktMonClientNblDrop @ 0x14001F9D0
 * Callers:
...
void __fastcall PktMonClientNblDrop(__int64 a1, __int64 a2, int a3, __int64 a4, __int64 a5, int a6, int a7, int a8)
{
  ...
  v19 = 0;
  v21[1] = 0;
  if ( byte_14011D800 && (*(_DWORD *)(a1 + 56) & 2) != 0 && (*(_DWORD *)(a2 + 128) & 0x8000) == 0 )
  {
    if ( ExAcquireRundownProtectionCacheAware(RunRefCacheAware) )
    {
      ...
      v17 = a3;
      v20 = 0LL;
      (*(void (__fastcall **)(_QWORD, __int64, __int16 *, _WORD *, _QWORD))(*((_QWORD *)&xmmword_14011D820 + 1) + 48LL))(
        xmmword_14011D820,
        v11,
        &v12,
        v21,
