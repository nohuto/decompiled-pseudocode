/*
 * XREFs of ?ndisAcquireReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@EPEAU_LOCK_STATE@@E@Z @ 0x140028FA0
 * Callers:
 *     NdisDprAcquireReadWriteLock @ 0x1400C2430 (NdisDprAcquireReadWriteLock.c)
 * Callees:
