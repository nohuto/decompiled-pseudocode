/*
 * XREFs of ?ndisPreSetPMParameters@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x140005B60
 * Callers:
 ...
 *     ?ndisIsValidPMConfig@@YAEPEAU_NDIS_PM_PARAMETERS@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x140005D50 (-ndisIsValidPMConfig@@YAEPEAU_NDIS_PM_PARAMETERS@@PEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 ...
 *     ?ndisXlatePMParametersToWakeUpEnableOid@@YAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1400B6700 (-ndisXlatePMParametersToWakeUpEnableOid@@YAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 */
...
LABEL_25:
  ...
  if ( v8->MajorNdisVersion <= 6u && (v8->MajorNdisVersion != 6 || v8->MinorNdisVersion < 0x14u) )
  {
    ...
    v15 = ndisSetMiniportEnableWakeUp(v8, (struct _NDIS_OID_REQUEST *)v1, &v17);
    v2 = v17;
    *((_DWORD *)a1 + 10) = v15;
    if ( v2 == 1 )
      goto LABEL_13;
