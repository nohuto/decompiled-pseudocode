/*
 * XREFs of ?ndisSSUpdateOidCacheValue@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x14004B560
 * Callers:
 *     ?ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x14004B520 (-ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
      ...
      if ( v4 )
      {
        ...
        *(_BYTE *)(v4 + 20) = 0;
        if ( !*((_DWORD *)a1 + 10) && *(_DWORD *)(v2 + 48) >= *(_DWORD *)(v4 + 4) )
        {
          Pool2 = *(void **)(v4 + 8);
          if ( Pool2
            || (Pool2 = (void *)ExAllocatePool2(66LL, *(unsigned int *)(v4 + 4), 1936933966LL),
