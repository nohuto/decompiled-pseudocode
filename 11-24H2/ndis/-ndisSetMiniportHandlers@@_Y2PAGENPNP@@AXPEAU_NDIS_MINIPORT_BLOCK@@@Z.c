/*
 * XREFs of ?ndisSetMiniportHandlers@@_Y2PAGENPNP@@AXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14017EDB0
 * Callers:
 ...
 *     ndisMIsPowerSynchronizedDatapathRequired @ 0x14007E900 (ndisMIsPowerSynchronizedDatapathRequired.c)
 */
