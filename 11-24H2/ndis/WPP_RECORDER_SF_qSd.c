/*
 * XREFs of WPP_RECORDER_SF_qSd @ 0x14009114C
 * Callers:
...
__int64 WPP_RECORDER_SF_qSd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x80u) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !v17 )
      v11 = L"NULL";
    ndisWppFastTraceMessage(&WPP_78fc2fada0c137ca2e9d99d042b3d7f2_Traceguids, 0x10u, va, 8LL, v11, v10, va1, 4LL, 0LL);
  }
  v12 = v5 == 0LL;
  if ( v5 )
  {
  ...
  return WppAutoLogTrace(
           ...
           2LL,
           8LL,
           &WPP_78fc2fada0c137ca2e9d99d042b3d7f2_Traceguids,
           v14,
           (__int64 *)va,
           8LL,
           v5,
