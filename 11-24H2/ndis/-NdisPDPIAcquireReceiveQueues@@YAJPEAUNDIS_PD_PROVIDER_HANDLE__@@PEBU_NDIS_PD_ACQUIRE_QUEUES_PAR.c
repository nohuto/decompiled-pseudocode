/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x14013AA40
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisGetNextPDCounterId@@YAKXZ @ 0x1400A4028 (-ndisGetNextPDCounterId@@YAKXZ.c)
        ...
        unsigned int *a7)
{
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v31, qword_14011CF58);
...
LABEL_43:
  ...
  *((_BYTE *)a1 + 89) = 1;
  ...
  {
LABEL_42:
    KLockThisExclusive::KLockThisExclusive(&v32, qword_14011CF58);
    v17 = &v32;
    *((_BYTE *)a1 + 89) = 0;
    goto LABEL_43;
  }
  ...
  if ( (unsigned int)v12 < 0x38
    || (v12 & 0xFFFFFFF8) != v12
    || (v18 = (unsigned int)v12 * (unsigned __int64)(unsigned int)v13, v18 > 0xFFFFFFFF)
    || (unsigned int)v18 > *a6 )
  {
LABEL_38:
    v15 = -1073741776;
...
LABEL_44:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qddd(*((_QWORD *)WPP_GLOBAL_Control + 8), v12, v13, v14, v27);
