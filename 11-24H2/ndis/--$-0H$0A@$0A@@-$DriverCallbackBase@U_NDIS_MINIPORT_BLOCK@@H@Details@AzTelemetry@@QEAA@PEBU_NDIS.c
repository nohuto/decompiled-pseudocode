/*
 * XREFs of ??$?0H$0A@$0A@@?$DriverCallbackBase@U_NDIS_MINIPORT_BLOCK@@H@Details@AzTelemetry@@QEAA@PEBU_NDIS_MINIPORT_BLOCK@@AEBH@Z @ 0x14009C2D4
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)a1 = &AzTelemetry::Details::DriverCallbackBase<_NDIS_MINIPORT_BLOCK,void>::`vftable';
  v4 = a2;
  if ( (unsigned int)dword_14011A7B0 <= 4 || (v6 = !tlgKeywordOn((__int64)&dword_14011A7B0, 512LL), v7 = 1, v6) )
    v7 = v3;
  *(_BYTE *)(a1 + 16) = v7;
  *(_QWORD *)(a1 + 24) = v4;
  *(_QWORD *)(a1 + 40) = v3;
