/*
 * XREFs of CreateNewEventEntry @ 0x1400E5AAC
 * Callers:
 *     InsertEventEntryInLookUpTable @ 0x1400E5EA0 (InsertEventEntryInLookUpTable.c)
 * Callees:
 *     CBufferGetNextOffset @ 0x1400E595C (CBufferGetNextOffset.c)
        ...
        __int64 *a7)
{
  ...
  *(_OWORD *)v25 = v26;
  ...
  {
    v28 = v24 - 54 - a4;
    v29 = (const void **)(a4 + 16LL * v27 + 8);
    v30 = (unsigned __int8)(v8 - v27);
    do
    {
      v32 = (void *)CBufferGetNextOffset(v35, *(unsigned int *)v29);
      memmove(v32, *(v29 - 1), v31);
      v33 = (char *)v29 + v28;
      *(_QWORD *)&v33[*(_QWORD *)(v25 + 16)] = v32;
      *(_DWORD *)&v33[*(_QWORD *)(v25 + 16) + 12] = *((_DWORD *)v29 + 1);
      v34 = *(_DWORD *)v29;
      v29 += 2;
