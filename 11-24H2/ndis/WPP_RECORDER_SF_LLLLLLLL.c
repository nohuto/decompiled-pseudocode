/*
 * XREFs of WPP_RECORDER_SF_LLLLLLLL @ 0x1400A05D0
 * Callers:
        ...
        ...)
{
  ...
  _DWORD v14[4]; // [rsp+C8h] [rbp-1h] BYREF
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 5u )
    ndisWppFastTraceMessage(
      ...
      0LL);
  LOWORD(v11) = 174;
  return WppAutoLogTrace(a1, 5LL, 24LL, &WPP_af651eb67934303d7b17b39d6bfcb024_Traceguids, v11, &a6, 4LL, v14, 4LL, &a8);
}
