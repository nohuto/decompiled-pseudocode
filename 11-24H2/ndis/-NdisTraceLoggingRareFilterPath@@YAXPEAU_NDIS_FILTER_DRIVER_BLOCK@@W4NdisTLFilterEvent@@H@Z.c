/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x14013F2D8
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(__int64 a1)
{
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_14011A7E8 > 5 && tlgKeywordOn((__int64)&dword_14011A7E8, 0x400000000000LL) )
    {
      v10 = *(_QWORD *)(v2 + 152);
  ...
  else if ( (unsigned int)dword_14011A7E8 > 5 && tlgKeywordOn((__int64)&dword_14011A7E8, 0x400000000000LL) )
  {
    v20 = 0;
    v17 = 0;
    v18 = &v9;
    ...
    v16 = 4;
    v8 = v7;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14011A7E8, byte_140101AED, 0LL, 0LL, 4u, &v14);
  }
}
