/*
 * XREFs of ?AddTriageBlocks@?$StructSliceDataCollector@U_NDIS_COMMON_OPEN_BLOCK@@$0OE@$0BAM@@@SAXPEAU_NDIS_COMMON_OPEN_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400B7580
 * Callers:
 *     <none>
 * Callees:
