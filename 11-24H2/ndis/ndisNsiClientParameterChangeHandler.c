/*
 * XREFs of ndisNsiClientParameterChangeHandler @ 0x140160430
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall ndisNsiClientParameterChangeHandler(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  _UNKNOWN **v4; // rax
  int v5; // edi
  int **v7; // rbx
  ...
  if ( *v7 )
  {
    if ( a1 == 1 )
    {
      ...
      if ( (byte_14011B101 & 0x20) != 0 )
        LODWORD(v4) = McTemplateK0qx_EtwWriteTransfer(
                        a1,
                        a2,
                        (__int64)a3,
                        HIWORD(*(_QWORD *)*v7),
                        (*(_QWORD *)*v7 >> 24) & 0xFFFFFFLL);
    }
    else
    {
      LODWORD(v4) = a1;
      if ( a1 )
      {
        ...
        if ( a1 == 6 )
        {
          ...
          if ( (byte_14011B101 & 0x20) != 0 )
            LODWORD(v4) = McTemplateK0j_EtwWriteTransfer(a1, a2, (__int64)a3, (__int64)v9);
        }
        else
        {
          LODWORD(v4) = a1 - 7;
