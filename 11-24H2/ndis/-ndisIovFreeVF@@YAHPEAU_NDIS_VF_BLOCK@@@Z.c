/*
 * XREFs of ?ndisIovFreeVF@@YAHPEAU_NDIS_VF_BLOCK@@@Z @ 0x1400DEAA4
 * Callers:
 *     ?ndisOidPostIovFreeVF@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400DFB10 (-ndisOidPostIovFreeVF@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
