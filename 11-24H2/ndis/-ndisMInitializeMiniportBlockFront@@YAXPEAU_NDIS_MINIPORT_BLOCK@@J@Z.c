/*
 * XREFs of ?ndisMInitializeMiniportBlockFront@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x14017E1A0
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x14006FF10 (-ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
