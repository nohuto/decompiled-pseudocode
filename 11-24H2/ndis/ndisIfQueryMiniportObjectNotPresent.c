/*
 * XREFs of ndisIfQueryMiniportObjectNotPresent @ 0x1401501F0
 * Callers:
...
__int64 __fastcall ndisIfQueryMiniportObjectNotPresent(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  unsigned int v6; // ebx
  int v8; // eax
...
LABEL_14:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_DqL(*((_QWORD *)WPP_GLOBAL_Control + 8), a2, (__int64)a3, 0x12u, v10);
  return 0LL;
}
