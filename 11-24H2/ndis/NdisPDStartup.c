      ...
      *v13 = (unsigned __int64)v13;
      ...
      if ( ndisPDReferenceClientDriver(a1) )
      {
        ...
        *a5 = &unk_1400F3400;
        ...
        for ( i = (KPushLockBase *)qword_14011CF58[1].m_Lock.Value;
              i != &qword_14011CF58[1];
...
LABEL_15:
        ...
        ClearBitsAndSet = RtlFindClearBitsAndSet((PRTL_BITMAP)&qword_14011CF58[3], 1u, 0);
        ...
        *(_WORD *)&v12[13].m_Lock.0 = ClearBitsAndSet;
        v18 = qword_14011CF58 + 1;
        Value = (KPushLockBase **)qword_14011CF58[2].m_Lock.Value;
