/*
 * XREFs of ?AddTriageBlocks@?$StructSliceDataCollector@U_NDIS_M_DRIVER_BLOCK@@$0A@$0BGA@@@SAXPEAU_NDIS_M_DRIVER_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x140091B10
 * Callers:
 *     <none>
 * Callees:
