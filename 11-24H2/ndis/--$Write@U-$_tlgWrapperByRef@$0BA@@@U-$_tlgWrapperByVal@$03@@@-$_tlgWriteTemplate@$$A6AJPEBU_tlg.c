 ...
 * Callers:
 *     ?NdisTraceLoggingOffloadConfigRead@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x140071B70 (-NdisTraceLoggingOffloadConfigRead@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
        ...
        __int64 a6)
{
  ...
  v9 = 16LL;
  v8 = *a5;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14011A7E8, a2, 0LL, 0LL, 4u, &v7);
}
