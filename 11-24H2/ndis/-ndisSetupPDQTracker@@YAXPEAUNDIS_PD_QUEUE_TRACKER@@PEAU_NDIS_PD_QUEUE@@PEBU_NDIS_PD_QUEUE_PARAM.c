/*
 * XREFs of ?ndisSetupPDQTracker@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@PEAU_NDIS_PD_QUEUE@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAUNDIS_PD_ASSOCIATION@@PEAUNDIS_PD_COUNTER@@EE@Z @ 0x14013E084
 * Callers:
 ...
 * Callees:
 *     ?ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x14013C8D8 (-ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z.c)
        ...
        unsigned __int8 a7)
{
  ...
  *((_DWORD *)DeferredContext + 68) = _InterlockedIncrement((volatile signed __int32 *)&qword_14011CF58[1029].m_Lock.Ptr + 1);
  if ( a7 )
    ndisInitPDQAWM(DeferredContext);
  v10 = qword_14011CF58;
  a2->PDPlatformReserved[0] = (void *)a2->Dispatch;
  a2->Dispatch = (const _NDIS_PD_QUEUE_DISPATCH *)&unk_1400F3360;
