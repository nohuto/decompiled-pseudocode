/*
 * XREFs of ?NdisTraceLoggingDeviceAddSuccess@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_IF_BLOCK@@E@Z @ 0x1400AE530
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceAddSuccess(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_IF_BLOCK *a2)
{
  ...
  const wchar_t *v8; // [rsp+68h] [rbp+1Fh] BYREF
