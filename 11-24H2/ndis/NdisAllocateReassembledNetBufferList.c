/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1400C6990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x140046840 (NetioCopyOpaqueNetBufferListInformation.c)
