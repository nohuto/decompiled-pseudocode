/*
 * XREFs of ?DuplicateCollectorsArray@?$ObjectTriageData@X@@CAJPEBU?$TriageDataCollector@X@@_KAEAV?$unique_any_array_ptr@U?$TriageDataCollector@X@@UTriageDataCollectorArrayDeleter@?$ObjectTriageData@X@@Uempty_deleter@wil@@_K@wil@@@Z @ 0x1400987E8
 * Callers:
...
__int64 __fastcall ObjectTriageData<void>::DuplicateCollectorsArray(void *Src, size_t a2, void **a3)
{
  unsigned int v5; // edi
  void *Pool2; // rdi
  __int64 v7; // rax
  ...
  v10 = 0LL;
  Size = 0LL;
  v5 = RtlULongLongMult(9uLL, 0x10uLL, &Size);
  if ( !v5 )
  {
