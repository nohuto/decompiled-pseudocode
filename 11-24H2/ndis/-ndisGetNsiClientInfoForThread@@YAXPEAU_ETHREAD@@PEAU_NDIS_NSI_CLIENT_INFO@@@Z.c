/*
 * XREFs of ?ndisGetNsiClientInfoForThread@@YAXPEAU_ETHREAD@@PEAU_NDIS_NSI_CLIENT_INFO@@@Z @ 0x140043570
 * Callers:
...
LABEL_9:
          ...
          {
            v22 = 0;
            v23 = KeAcquireSpinLockRaiseToDpc(&qword_14011C9A0);
            if ( v10 < dword_14011C950 )
              v22 = *((_DWORD *)qword_14011C9F0 + 6 * v10);
            KeReleaseSpinLock(&qword_14011C9A0, v23);
            if ( !v22 )
              v22 = 1;
            v11 = v22;
          }
