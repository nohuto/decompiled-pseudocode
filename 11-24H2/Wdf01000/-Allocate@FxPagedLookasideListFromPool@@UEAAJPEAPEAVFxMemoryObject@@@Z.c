/*
 * XREFs of ?Allocate@FxPagedLookasideListFromPool@@UEAAJPEAPEAVFxMemoryObject@@@Z @ 0x140052E40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     FxAllocateFromPagedLookasideList @ 0x140095CB4 (FxAllocateFromPagedLookasideList.c)
