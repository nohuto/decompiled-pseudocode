/*
 * XREFs of imp_WdfDmaTransactionInitializeUsingRequest @ 0x140086C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SupportsChainedMdls@FxDmaEnabler@@QEAAEXZ @ 0x140068A64 (-SupportsChainedMdls@FxDmaEnabler@@QEAAEXZ.c)
