/*
 * XREFs of ?_SearchForDevice@FxDeviceBase@@SAPEAV1@PEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x140013910
 * Callers:
        ...
        _WDF_OBJECT_ATTRIBUTES *Attributes)
{
  ...
  if ( !ParentObject )
    return 0LL;
  FxObjectHandleGetPtr(FxDriverGlobals, ParentObject, 0x1000u, (void **)&pParentObject);
