/*
 * XREFs of FxPurgeBugCheckDriverInfo @ 0x14007D75C
 * Callers:
...
void __fastcall FxPurgeBugCheckDriverInfo(_FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  if ( (_DWORD)BugCheckDriverInfoIndex )
  {
    if ( qword_1400C8030 )
    {
      if ( (unsigned int)BugCheckDriverInfoIndex < unk_1400C8028 )
      {
        v5 = (_FX_DRIVER_GLOBALS **)((char *)qword_1400C8030 + 56 * BugCheckDriverInfoIndex);
        if ( *v5 == FxDriverGlobals )
        {
          if ( unk_1400C8028 - (_DWORD)BugCheckDriverInfoIndex != 1 )
            memmove(v5, v5 + 7, 56LL * (unsigned int)(unk_1400C8028 - BugCheckDriverInfoIndex - 1));
          if ( (unsigned int)BugCheckDriverInfoIndex < --unk_1400C8028 )
          {
            do
            {
              ...
              --*(_DWORD *)(*((_QWORD *)qword_1400C8030 + 7 * v6) + 356LL);
            }
            while ( (unsigned int)BugCheckDriverInfoIndex < unk_1400C8028 );
          }
        }
      }
    }
  }
  KeReleaseSpinLock(&qword_1400C8010, v4);
}
