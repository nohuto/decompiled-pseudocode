/*
 * XREFs of ?GetNextDevice@FxChildList@@QEAAJPEAPEAUWDFDEVICE__@@PEAU_WDF_CHILD_LIST_ITERATOR@@PEAU_WDF_CHILD_RETRIEVE_INFO@@@Z @ 0x1400020E0
 * Callers:
 *     imp_WdfChildListRetrieveNextDevice @ 0x140001F00 (imp_WdfChildListRetrieveNextDevice.c)
 * Callees:
 *     ?MatchStateToFlags@FxDeviceDescriptionEntry@@QEAAEK@Z @ 0x1400023E4 (-MatchStateToFlags@FxDeviceDescriptionEntry@@QEAAEK@Z.c)
