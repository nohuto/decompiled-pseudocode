/*
 * XREFs of FxRegistrySettingsInitialize @ 0x14006C094
 * Callers:
 ...
 *     ?SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z @ 0x14006D09C (-SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z.c)
