/*
 * XREFs of ?Open@FxIoTargetRemote@@QEAAJPEAU_WDF_IO_TARGET_OPEN_PARAMS@@@Z @ 0x14002A5A0
 * Callers:
 ...
 *     ?GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z @ 0x14002AEE8 (-GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z.c)
 ...
 *     ?RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ @ 0x14002B50C (-RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ.c)
...
__int64 __fastcall FxIoTargetRemote::Open(FxIoTargetRemote *this, _WDF_IO_TARGET_OPEN_PARAMS *OpenParams)
{
  ...
  __m128i v65; // [rsp+88h] [rbp-59h] BYREF
    ...
    if ( Type == WdfIoTargetOpenByName )
    {
      ...
      *(_QWORD *)params = &this->m_Globals;
      ...
      else
      {
        ...
        if ( Length == 0xFFFE )
        {
          v15 = *(FX_POOL ***)&pended[32];
          v63[1] = *(void **)&pended[32];
          goto LABEL_11;
        }
        if ( *(_QWORD *)&pended[32] )
        {
          FxPoolFree(*(_QWORD **)&pended[32]);
          m_Globals = v66;
        ...
        *(_QWORD *)pended = 256LL;
        if ( !m_Globals->FxPoolTrackingOn )
          v14 = 0LL;
        v15 = FxPoolAllocator(m_Globals, &m_Globals->FxPoolFrameworks, (__m128i *)&v63[1], v12, Tag, v14);
        v63[1] = v15;
