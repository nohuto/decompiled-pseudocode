/*
 * XREFs of ??0FxIoTarget@@QEAA@PEAU_FX_DRIVER_GLOBALS@@G@Z @ 0x140014068
 * Callers:
        ...
        unsigned __int16 ObjectSize)
{
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  {
    FxDriverGlobals = this->m_Globals;
    if ( FxDriverGlobals->FxVerifierLock )
    {
      VerifierLock = 0LL;
      FxVerifierLock::CreateAndInitialize(&VerifierLock, FxDriverGlobals, this);
      this[-1].m_TargetDevice = (_DEVICE_OBJECT *)VerifierLock;
    }
  }
  ...
  FxCREvent::FxCREvent(&this->m_SentIoEvent, (unsigned __int8)FxDriverGlobals);
