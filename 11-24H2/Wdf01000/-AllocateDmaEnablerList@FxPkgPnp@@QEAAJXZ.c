/*
 * XREFs of ?AllocateDmaEnablerList@FxPkgPnp@@QEAAJXZ @ 0x1400A72F8
 * Callers:
 *     ?AllocateDmaEnablerList@FxDevice@@UEAAJXZ @ 0x140094D30 (-AllocateDmaEnablerList@FxDevice@@UEAAJXZ.c)
 * Callees:
