/*
 * XREFs of _woutput_l @ 0x14008463C
 * Callers:
 *     _vsnwprintf_l @ 0x140084534 (_vsnwprintf_l.c)
 * Callees:
 *     ?AddChildList@FxDeviceBase@@UEAAXPEAVFxChildList@@@Z @ 0x140076710 (-AddChildList@FxDeviceBase@@UEAAXPEAVFxChildList@@@Z.c)
 ...
 *     _get_printf_count_output @ 0x140085068 (_get_printf_count_output.c)
