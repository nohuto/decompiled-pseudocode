/*
 * XREFs of ?AllocateCommonBuffer@FxCommonBuffer@@QEAAJ_KPEAU_WDF_COMMON_BUFFER_CONFIG@@@Z @ 0x1400AB66C
 * Callers:
        ...
        _WDF_COMMON_BUFFER_CONFIG *Config)
{
  ...
  unsigned __int64 *p_m_RawLength; // r14
  ...
  if ( (int)result >= 0 )
  {
    ...
    *p_m_RawLength = v13;
    ...
    if ( v10.QuadPart >= QuadPart )
    {
      ...
      if ( !v19 )
        v20 = 0LL;
      WPP_IFR_SF_qi(m_Globals, v19, v18, 0xCu, WPP_FxCommonBuffer_cpp_Traceguids, v20, v18);
      goto LABEL_26;
    }
