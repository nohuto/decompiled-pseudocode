/*
 * XREFs of imp_WdfUsbTargetPipeFormatRequestForUrb @ 0x14004E8B0
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( !v25 || v25->m_RequestType != 17 )
          {
            ...
            *(_QWORD *)&buf.DataType = 64LL;
            if ( v26->FxPoolTrackingOn )
              ...
              v27 = 0LL;
            v28 = FxPoolAllocator(v26, &v26->FxPoolFrameworks, (__m128i *)&v65, 0x88uLL, v26->Tag, v27);
            v25 = (FxRequestContext *)v28;
            if ( !v28 )
            {
              v33 = -1073741670;
LABEL_40:
            ...
            FxUsbRequestContext::FxUsbRequestContext((FxUsbRequestContext *)v28, 0x11u);
