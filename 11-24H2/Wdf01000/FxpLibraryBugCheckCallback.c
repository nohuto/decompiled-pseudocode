/*
 * XREFs of FxpLibraryBugCheckCallback @ 0x1400ABC30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned int ReasonSpecificLength)
{
  ...
  v4 = 56 * dword_1400C8028;
  if ( *(_DWORD *)&ReasonSpecificData->Data4[4] < 56 * dword_1400C8028 )
    v4 = 56 * (*(_DWORD *)&ReasonSpecificData->Data4[4] / 0x38u);
  if ( v4 )
  {
    *(_QWORD *)&ReasonSpecificData[2].Data1 = qword_1400C8030;
