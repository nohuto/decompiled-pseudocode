/*
 * XREFs of ?ReportDdiFunctionCountMismatch@@YAXPEBU_UNICODE_STRING@@KKE@Z @ 0x14008E3E0
 * Callers:
        ...
        unsigned __int8 a4)
{
  ...
  *(_DWORD *)RawDataLen = 458;
  ...
  if ( (int)RtlStringCchPrintfW(
              ...
              RawDataBuf,
              *(_QWORD *)RawDataLen) >= 0 )
    LibraryLogEvent((_DRIVER_OBJECT *)WPP_GLOBAL_WDF_Control.Reserved, -2147024894, -1073741811, insertString, 0LL, 0);
