/*
 * XREFs of ?PerfEvtDeviceD0ExitStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x14008F8D4
 * Callers:
...
char __fastcall PerfEvtDeviceD0ExitStart(unsigned __int64 Handle, _GUID *pActivityId)
{
  ...
  if ( ((__int64)WPP_GLOBAL_WDF_Control.Queue.ListEntry.Flink & 1) != 0 )
    McTemplateK0pp_EtwWriteTransfer(v8, &FX_POWER_D0_EXIT_START, pActivityId, v7, (const void *)Handle);
  return v2;
}
