/*
 * XREFs of ?_Create@FxRequest@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_IRP@@PEAVFxIoTarget@@W4FxRequestIrpOwnership@@W4FxRequestConstructorCaller@@PEAPEAV1@@Z @ 0x14000F550
 * Callers:
 ...
 *     ?SetSubmitIrp@FxRequestBase@@QEAAPEAU_IRP@@PEAU2@E@Z @ 0x1400609B4 (-SetSubmitIrp@FxRequestBase@@QEAAPEAU_IRP@@PEAU2@E@Z.c)
...
LABEL_38:
      ...
      else
      {
        ...
        globals = (unsigned __int64)RequestAttributes->ParentObject;
        if ( globals )
        {
          LOWORD(m_Globals_low) = 0;
          Driver = (FxVerifierLock *)(~globals & 0xFFFFFFFFFFFFFFF8uLL);
          if ( (globals & 1) != 0 )
          {
