/*
 * XREFs of imp_WdfRegistryAssignMultiString @ 0x1400997E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z @ 0x1400712C0 (-FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z.c)
