/*
 * XREFs of imp_WdfCxDeviceInitSetPnpPowerEventCallbacks @ 0x140092F50
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFCX_PNPPOWER_EVENT_CALLBACKS *CxPnpPowerCallbacks)
{
  ...
  if ( (int)FxValiateCx(ClientDriverGlobals, v3) >= 0 )
  {
    ...
    {
      WPP_IFR_SF_DDd(ClientDriverGlobals, 0xC8u, 0x12u, 0x13u, WPP_FxCxDeviceInitApi_cpp_Traceguids, _a2, 0xC8u, 280);
LABEL_9:
