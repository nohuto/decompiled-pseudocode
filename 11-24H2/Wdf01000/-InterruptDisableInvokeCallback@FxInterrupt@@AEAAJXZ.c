/*
 * XREFs of ?InterruptDisableInvokeCallback@FxInterrupt@@AEAAJXZ @ 0x1400713C4
 * Callers:
 *     ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1400713A0 (-_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z.c)
 * Callees:
