/*
 * XREFs of LibraryRegisterClient @ 0x140076CE0
 * Callers:
 *     <none>
 * Callees:
 *     WdfBindClientHelper @ 0x140076E90 (WdfBindClientHelper.c)
  ...
  *Context = 0LL;
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      LibraryLogEvent((_DRIVER_OBJECT *)WPP_GLOBAL_WDF_Control.Reserved, -2147024895, v7, insertString, rawData, 0x10u);
    }
