/*
 * XREFs of ?InterruptEnableInvokeCallback@FxInterrupt@@AEAAJXZ @ 0x140071494
 * Callers:
 *     ?_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z @ 0x140071470 (-_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z.c)
 * Callees:
