/*
 * XREFs of ?Cleanup@FxSelfManagedIoMachine@@KA?AW4FxSelfManagedIoStates@@PEAV1@PEAJPEAW4FxCxCallbackProgress@@@Z @ 0x14007B220
 * Callers:
 *     <none>
 * Callees:
        ...
        FxCxCallbackProgress *Progress)
{
  ...
  if ( !m_ObjectSize )
    v5 = 0LL;
  This->m_DeviceSelfManagedIoCleanup.m_Device = v5;
