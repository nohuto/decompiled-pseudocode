/*
 * XREFs of ?ConfigureDynamicDispatching@FxPkgIo@@QEAAJEPEAUFxCxDeviceInfo@@P6AJPEAUWDFDEVICE__@@EEKPEAXPEAU_IRP@@2@Z2@Z @ 0x1400A0A14
 * Callers:
 ...
 *     ?Mj2Index@FxIrpDynamicDispatchInfo@@SAHE@Z @ 0x140062778 (-Mj2Index@FxIrpDynamicDispatchInfo@@SAHE@Z.c)
