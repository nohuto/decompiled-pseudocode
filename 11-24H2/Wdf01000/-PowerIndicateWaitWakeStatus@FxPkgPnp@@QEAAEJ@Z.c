/*
 * XREFs of ?PowerIndicateWaitWakeStatus@FxPkgPnp@@QEAAEJ@Z @ 0x14006E4FC
 * Callers:
 ...
 *     ?IndicateWakeStatus@FxChildList@@QEAAXJ@Z @ 0x14006E33C (-IndicateWakeStatus@FxChildList@@QEAAXJ@Z.c)
