/*
 * XREFs of USBD_CreateHandle @ 0x140075388
 * Callers:
 *     ?InitDevice@FxUsbDevice@@QEAAJK@Z @ 0x140050A64 (-InitDevice@FxUsbDevice@@QEAAJK@Z.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1400757D8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
