/*
 * XREFs of ?_SendTransfer@FxUsbPipe@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFUSBPIPE__@@PEAUWDFREQUEST__@@PEAU_WDF_REQUEST_SEND_OPTIONS@@PEAU_WDF_MEMORY_DESCRIPTOR@@PEAKK@Z @ 0x14001EE38
 * Callers:
        ...
        unsigned int Flags)
{
  ...
  if ( v13 >= 0 )
  {
    ...
    {
      if ( !MemoryDescriptor
        || (v13 = FxRequestBuffer::ValidateMemoryDescriptor(&buf, m_Globals, MemoryDescriptor, 0LL), v13 >= 0) )
      {
