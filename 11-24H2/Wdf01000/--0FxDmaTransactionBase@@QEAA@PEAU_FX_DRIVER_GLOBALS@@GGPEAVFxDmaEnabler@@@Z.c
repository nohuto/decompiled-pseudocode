/*
 * XREFs of ??0FxDmaTransactionBase@@QEAA@PEAU_FX_DRIVER_GLOBALS@@GGPEAVFxDmaEnabler@@@Z @ 0x140064DC8
 * Callers:
 ...
 *     ?Reset@FxDmaTransactionBase@@AEAAXXZ @ 0x14006510C (-Reset@FxDmaTransactionBase@@AEAAXXZ.c)
 */
