/*
 * XREFs of ?PowerNotRequiredCallbackWorker@FxPoxInterface@@AEAAXE@Z @ 0x140004D50
 * Callers:
 ...
 *     ?PowerNotRequiredCallback@FxPoxInterface@@CAXPEAX@Z @ 0x140004D20 (-PowerNotRequiredCallback@FxPoxInterface@@CAXPEAX@Z.c)
 * Callees:
