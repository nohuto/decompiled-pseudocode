/*
 * XREFs of imp_WdfDeviceWdmDispatchIrp @ 0x1400584A0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 DispatchContext)
{
  ...
  if ( (Device & 1) != 0 )
  {
    v8 = (_FX_DRIVER_GLOBALS *)LOWORD(flags->FxDeviceBase::FxNonPagedObject::FxObject::__vftable);
    flags = (FxDevice *)((char *)flags - (__int64)v8);
  }
  ...
  {
    Vf_VerifyWdfDeviceWdmDispatchIrp(v8, DriverGlobals, flags, (void *)DispatchContext);
    flags = v21;
  }
