/*
 * XREFs of ?OnCreate@FxPkgGeneral@@AEAAJPEAVFxIrp@@@Z @ 0x1400374F0
 * Callers:
 ...
 *     ?ForwardCreateRequest@FxPkgGeneral@@AEAAJPEAVFxIrp@@P6AJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z3@Z @ 0x1400607F0 (-ForwardCreateRequest@FxPkgGeneral@@AEAAJPEAVFxIrp@@P6AJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z3@Z.c)
...
__int64 __fastcall FxPkgGeneral::OnCreate(FxPkgGeneral *this, FxIrp *FxIrp)
{
  ...
  __m128i v105; // [rsp+A0h] [rbp-9h] BYREF
  ...
  if ( v13 != 1 )
  {
    ...
    if ( v14->FxVerifierHandle )
    {
      ...
      v23 = ContextTypeInfo;
      v105.m128i_i64[0] = ContextTypeInfo;
...
LABEL_23:
      ...
      if ( v27 )
      {
        ...
        if ( attributes.ContextTypeInfo )
        {
          ...
          memset(v15 + 26, 0, (ContextSize + 7) & 0xFFFFFFFFFFFFFFF8uLL);
          v28 = attributes.ContextTypeInfo;
        }
        v15[24] = (FX_POOL *)v28;
      }
      if ( v15 )
      {
        FxNonPagedObject::FxNonPagedObject((FxNonPagedObject *)v15, 0x1018u, 0xA0u, m_DeviceBase->m_Globals);
        *v15 = (FX_POOL *)FxFileObject::`vftable'{for `FxNonPagedObject'};
        v15[15] = (FX_POOL *)FxFileObject::`vftable'{for `IFxHasCallbacks'};
        v15[16] = (FX_POOL *)FileObject;
        v15[17] = 0LL;
        v15[12] = (FX_POOL *)m_DeviceBase;
        v30 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)v15 + 7);
        *((_WORD *)v15 + 12) |= 2u;
        KeReleaseSpinLock((PKSPIN_LOCK)v15 + 7, v30);
        v19 = FxObject::Commit((FxObject *)v15, &attributes, 0LL, m_DeviceBase, 1u);
        if ( v19 >= 0 )
        {
          ...
          v33 = (FX_POOL *)&m_DeviceBase[2];
          v34 = m_DeviceBase[2].FxNonPagedObject::FxObject::__vftable;
          v35 = (FxDeviceBase_vtbl **)(v15 + 18);
          if ( (FxDeviceBase *)v34->~FxObject != &m_DeviceBase[2] )
            __fastfail(3u);
          *v35 = v34;
          v15[19] = v33;
          v34->~FxObject = (void (__fastcall *)(FxObject *))v35;
          *(_QWORD *)&v33->NonPagedLock.m_DbgFlagIsInitialized = v35;
          if ( SLOBYTE(m_DeviceBase->m_ObjectFlags) < 0
          ...
          for ( i = this->m_FileObjectInfoHeadList.Blink->Blink; ; i = i->Blink )
          {
            ...
            if ( _mm_cvtsi128_si32(*(__m128i *)&attributes.Size) )
            {
              ...
              v19 = FxObjectAllocateContext((FxObject *)v15, &attributes, 1u, 0LL);
              if ( v19 < 0 )
                break;
            }
          }
...
LABEL_8:
  if ( this->m_DriverCreatedQueue || (this->m_Flags & 0xC) != 0 )
  {
    if ( p_m_FileObjectInfoHeadList->Flink == p_m_FileObjectInfoHeadList )
    {
      ...
      attributes = *(_WDF_OBJECT_ATTRIBUTES *)&v38[2].m_ExecutionLevel;
    }
    else
    {
      Blink = this->m_FileObjectInfoHeadList.Blink;
    ...
    if ( *(FxDeviceBase **)&v38[1].m_ExecutionLevel != (FxDeviceBase *)&v38[1].m_ExecutionLevel )
    {
      attributes.ExecutionLevel = WdfExecutionLevelDispatch;
      attributes.SynchronizationScope = WdfSynchronizationScopeNone;
      attributes.ParentObject = 0LL;
    }
    v19 = FxRequest::_CreateForPackage((FX_POOL *)v38, &attributes, FxIrp->m_Irp, (FX_POOL ***)&pRequest);
    if ( v19 >= 0 )
    {
      v39 = pRequest;
...
LABEL_170:
    ...
    if ( !v15 )
      goto LABEL_65;
LABEL_144:
    FxFileObject::DeleteFileObjectFromFailedCreate((FxFileObject *)v15);
LABEL_65:
