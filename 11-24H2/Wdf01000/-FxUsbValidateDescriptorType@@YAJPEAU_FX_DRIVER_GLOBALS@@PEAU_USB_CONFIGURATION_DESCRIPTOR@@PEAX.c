/*
 * XREFs of ?FxUsbValidateDescriptorType@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAU_USB_CONFIGURATION_DESCRIPTOR@@PEAX2J_KW4FxUsbValidateDescriptorOp@@K@Z @ 0x14007D49C
 * Callers:
        ...
        unsigned int FxDriverGlobals_0)
{
  ...
  while ( 1 )
  {
    v12 = FxUsbFindDescriptorType(v9, v8, Start, DescriptorType);
    v16 = v12;
    if ( !v12 )
      break;
    flags = v12->bLength;
