/*
 * XREFs of ?FxIFRCreateSnapshot@@YAPEAU_WDF_IFR_HEADER@@PEBDPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x14008CAA8
 * Callers:
...
_WDF_IFR_HEADER *__fastcall FxIFRCreateSnapshot(const char *DriverName, _FX_DRIVER_GLOBALS *FxGlobalsForTracing)
{
  ...
  v3 = 0LL;
  v4 = 0;
  v6 = KeAcquireSpinLockRaiseToDpc(&qword_1400C8010);
  Flink = (_FX_DRIVER_GLOBALS *)qword_1400C8018;
  v9 = v6;
  while ( 1 )
  {
    if ( Flink == (_FX_DRIVER_GLOBALS *)&qword_1400C8018 )
    {
...
LABEL_31:
  KeReleaseSpinLock(&qword_1400C8010, v9);
  if ( v4 < 0 )
