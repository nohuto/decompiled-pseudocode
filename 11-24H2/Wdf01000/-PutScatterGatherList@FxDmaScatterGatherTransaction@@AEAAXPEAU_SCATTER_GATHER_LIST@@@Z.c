/*
 * XREFs of ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x1400689CC
 * Callers:
 *     ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x140069520 (-ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z.c)
 * Callees:
