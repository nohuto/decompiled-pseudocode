/*
 * XREFs of WdmlibRtlInitUnicodeStringEx @ 0x1400AAFC0
 * Callers:
 ...
 *     PpRegStateUpdateStackCreationSettings @ 0x1400DA74C (PpRegStateUpdateStackCreationSettings.c)
 *     CmRegUtilCreateWstrKey @ 0x1400DAA58 (CmRegUtilCreateWstrKey.c)
 *     CmRegUtilOpenExistingWstrKey @ 0x1400DAAB8 (CmRegUtilOpenExistingWstrKey.c)
 *     CmRegUtilWstrValueGetDword @ 0x1400DAE14 (CmRegUtilWstrValueGetDword.c)
 *     CmRegUtilWstrValueSetWstrString @ 0x1400DAEB8 (CmRegUtilWstrValueSetWstrString.c)
 * Callees:
 *     <none>
 */
