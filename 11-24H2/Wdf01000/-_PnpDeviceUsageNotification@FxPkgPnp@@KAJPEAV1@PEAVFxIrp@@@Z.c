/*
 * XREFs of ?_PnpDeviceUsageNotification@FxPkgPnp@@KAJPEAV1@PEAVFxIrp@@@Z @ 0x1400775D0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall FxPkgPnp::_PnpDeviceUsageNotification(FxPkgPnp *This, FxIrp *Irp)
{
