/*
 * XREFs of imp_WdfUsbTargetPipeConfigContinuousReader @ 0x14009C010
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetMaxPacketSize@FxUsbPipe@@QEAAKXZ @ 0x140065E5C (-GetMaxPacketSize@FxUsbPipe@@QEAAKXZ.c)
 *     ?IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z @ 0x1400667C4 (-IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z.c)
