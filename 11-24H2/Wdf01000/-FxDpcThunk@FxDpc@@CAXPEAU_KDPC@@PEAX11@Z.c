/*
 * XREFs of ?FxDpcThunk@FxDpc@@CAXPEAU_KDPC@@PEAX11@Z @ 0x14005D8F0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *SystemArgument2)
{
  ...
  if ( *(_BYTE *)(v5 + 348) )
    *(_QWORD *)((unsigned int)(unk_1400C8080 * HIDWORD(KeGetPcr()[1].LockArray)) + unk_1400C8070) = v5;
  v6 = (void (__fastcall **)(unsigned __int64))(DeferredContext + 208);
  if ( *(_QWORD *)(DeferredContext + 208) )
  {
    v7 = *(void (__fastcall **)(unsigned __int64, __int64, __int64, __int64, char))(unk_1400C80A8 + 8LL);
    if ( v7 )
