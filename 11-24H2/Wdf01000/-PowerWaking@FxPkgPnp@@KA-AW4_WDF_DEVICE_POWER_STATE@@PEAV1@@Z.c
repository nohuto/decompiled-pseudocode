/*
 * XREFs of ?PowerWaking@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1400341E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SleepStudyResetBlockersForD0@FxPkgPnp@@QEAAXXZ @ 0x1400738CC (-SleepStudyResetBlockersForD0@FxPkgPnp@@QEAAXXZ.c)
 */
...
__int64 __fastcall FxPkgPnp::PowerWaking(FxPkgPnp *This)
{
  ...
  if ( FxPrePostCallback::InvokeStateful(p_m_DeviceD0Entry, &progress, FxCxCleanupAfterPreOrClientFailure) < 0 )
