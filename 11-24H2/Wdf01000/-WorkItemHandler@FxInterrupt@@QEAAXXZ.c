/*
 * XREFs of ?WorkItemHandler@FxInterrupt@@QEAAXXZ @ 0x140055F38
 * Callers:
 *     ?_InterruptWorkItemCallback@FxInterrupt@@CAXPEAX@Z @ 0x140055F20 (-_InterruptWorkItemCallback@FxInterrupt@@CAXPEAX@Z.c)
 * Callees:
 *     FX_TRACK_DRIVER @ 0x1400563E0 (FX_TRACK_DRIVER.c)
...
void __fastcall FxInterrupt::WorkItemHandler(FxInterrupt *this)
{
  ...
  if ( m_CallbackLock )
  {
    ...
    v12 = *(void (__fastcall **)(void (__fastcall **)(WDFINTERRUPT__ *, void *), __int64, __int64, __int64, char))(unk_1400C80A8 + 24LL);
    if ( v12 )
  ...
  {
    v5 = *(void (__fastcall **)(void (__fastcall **)(WDFINTERRUPT__ *, void *), __int64, __int64, __int64, char))(unk_1400C80A8 + 24LL);
    if ( v5 )
