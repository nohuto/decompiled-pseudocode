/*
 * XREFs of imp_WdfDmaEnablerGetFragmentLength @ 0x1400A1ED0
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 v4; // rbx
  $C917870CF6F2291303947F7793E18A6D *v6; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v6 = ($C917870CF6F2291303947F7793E18A6D *)&pDmaEnabler->m_DuplexAdapterInfo[1];
