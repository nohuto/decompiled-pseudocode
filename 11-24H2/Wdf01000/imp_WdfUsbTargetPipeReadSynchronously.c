/*
 * XREFs of imp_WdfUsbTargetPipeReadSynchronously @ 0x14006B190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall imp_WdfUsbTargetPipeReadSynchronously(
        ...
        unsigned int *BytesRead)
{
  ...
  return FxUsbPipe::_SendTransfer(v9, (unsigned __int64)Pipe, Request, RequestOptions, MemoryDescriptor, BytesRead, 3u);
}
