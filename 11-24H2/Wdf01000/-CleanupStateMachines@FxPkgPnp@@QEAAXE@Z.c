/*
 * XREFs of ?CleanupStateMachines@FxPkgPnp@@QEAAXE@Z @ 0x14003EF90
 * Callers:
 ...
 *     ?SetFinished@FxEventQueue@@QEAAEPEAUFxCREvent@@@Z @ 0x14003F2CC (-SetFinished@FxEventQueue@@QEAAEPEAUFxCREvent@@@Z.c)
