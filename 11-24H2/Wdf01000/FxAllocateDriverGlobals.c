/*
 * XREFs of FxAllocateDriverGlobals @ 0x14007D13C
 * Callers:
 *     FxLibraryCommonRegisterClient @ 0x140077028 (FxLibraryCommonRegisterClient.c)
 * Callees:
 *     AllocAndInitializeTelemetryContext @ 0x140099FA4 (AllocAndInitializeTelemetryContext.c)
 */
...
_WDF_DRIVER_GLOBALS *__fastcall FxAllocateDriverGlobals()
{
  ...
  if ( result )
  {
    *(_DWORD *)result->DriverName = 1;
    ...
    v3 = qword_1400C8018;
    if ( *(_QWORD **)(qword_1400C8018 + 8LL) != &qword_1400C8018 )
      __fastfail(3u);
    v1->Driver = (WDFDRIVER__ *)qword_1400C8018;
    *(_QWORD *)&v1->DriverFlags = &qword_1400C8018;
    *(_QWORD *)(v3 + 8) = v1;
    qword_1400C8018 = v1;
    KeReleaseSpinLock(&qword_1400C8010, v2);
    v1[1].DriverFlags = -1;
    v4 = Tlgg_TelemetryProviderProv.LevelPlus1 == 0;
    *(_QWORD *)&v1[1].DriverName[24] = &WPP_GLOBAL_WDF_Control.Reserved;
