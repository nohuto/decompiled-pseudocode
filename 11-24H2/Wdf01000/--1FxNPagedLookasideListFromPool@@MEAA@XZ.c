/*
 * XREFs of ??1FxNPagedLookasideListFromPool@@MEAA@XZ @ 0x1400956B0
 * Callers:
 *     ??_EFxNPagedLookasideListFromPool@@MEAAPEAXI@Z @ 0x140095760 (--_EFxNPagedLookasideListFromPool@@MEAAPEAXI@Z.c)
 * Callees:
