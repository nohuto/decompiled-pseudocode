/*
 * XREFs of FxIoTargetSendIoctl @ 0x14000D490
 * Callers:
 *     imp_WdfIoTargetSendIoctlSynchronously @ 0x14000EB40 (imp_WdfIoTargetSendIoctlSynchronously.c)
 *     imp_WdfIoTargetSendInternalIoctlSynchronously @ 0x140073FB0 (imp_WdfIoTargetSendInternalIoctlSynchronously.c)
 * Callees:
...
LABEL_28:
          ...
          if ( InputBuffer )
          {
            v24 = FxRequestBuffer::ValidateMemoryDescriptor(&inputBuf, m_Globals, InputBuffer, 0LL);
            if ( v24 < 0 )
            {
              v29 = 39;
              goto LABEL_42;
          ...
          if ( OutputBuffer )
          {
            v24 = FxRequestBuffer::ValidateMemoryDescriptor(&outputBuf, m_Globals, OutputBuffer, 0LL);
            if ( v24 < 0 )
            {
              v29 = 40;
LABEL_42:
