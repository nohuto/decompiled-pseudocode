/*
 * XREFs of imp_WdfDeviceSetDeviceState @ 0x14007DBE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x140081814 (-SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
