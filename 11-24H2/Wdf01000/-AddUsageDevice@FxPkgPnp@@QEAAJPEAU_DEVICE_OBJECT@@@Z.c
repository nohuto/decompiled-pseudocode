/*
 * XREFs of ?AddUsageDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1400A5DBC
 * Callers:
...
__int64 __fastcall FxPkgPnp::AddUsageDevice(
        FxPkgPnp *this,
        ...
        __int64 a4)
{
  ...
  if ( v9 )
  {
    ...
    *v11 = v11;
    ...
    this->m_UsageDependentDeviceList = v10;
LABEL_7:
    v12 = 0;
    goto LABEL_8;
  }
  ...
  if ( !(_WORD)m_ObjectSize )
    _a1 = 0LL;
  WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x49u, WPP_FxPkgPnp_cpp_Traceguids, _a1, -1073741670);
LABEL_8:
...
LABEL_13:
  ...
  if ( !v18 )
    return 3221225626LL;
  v20 = FxTransactionedList::Add(this->m_UsageDependentDeviceList, this->m_Globals, (FxTransactionedEntry *)(v18 + 104));
  if ( v20 < 0 )
