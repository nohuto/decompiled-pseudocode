/*
 * XREFs of ?FormatControlRequest@FxUsbDevice@@QEAAJPEAVFxRequestBase@@PEAT_WDF_USB_CONTROL_SETUP_PACKET@@PEAUFxRequestBuffer@@@Z @ 0x14004DBA0
 * Callers:
        ...
        FxRequestBuffer *RequestBuffer)
{
  ...
  const void *v60; // rdx
  __m128i v61; // [rsp+40h] [rbp-48h] BYREF
...
LABEL_12:
  ...
  if ( !v15 || v15->m_RequestType != 19 )
  {
    ...
    v61.m128i_i64[1] = 64LL;
    if ( v17->FxPoolTrackingOn )
      v19 = retaddr;
    else
      v19 = 0LL;
    v20 = FxPoolAllocator(v17, &v17->FxPoolFrameworks, &v61, 0x128uLL, v17->Tag, v19);
    if ( !v20 )
      return 3221225626LL;
    FxUsbDeviceControlContext::FxUsbDeviceControlContext((FxUsbDeviceControlContext *)v20, v18);
