/*
 * XREFs of imp_WdfUsbTargetDeviceFormatRequestForUrb @ 0x14004D750
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *UrbOffsets)
{
  ...
  FxObjectHandleGetPtr(v8, (unsigned __int64)UrbMemory, 0x100Au, (void **)&pMemory);
  FxObjectHandleGetPtr(v8, (unsigned __int64)Request, 0x1008u, (void **)&pRequest);
  v9 = UrbOffsets;
