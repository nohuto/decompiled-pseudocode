/*
 * XREFs of imp_WdfRequestGetFileObject @ 0x140013460
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  FxRequest *pRequest; // [rsp+B0h] [rbp+50h] BYREF
  _FX_DRIVER_GLOBALS *globals; // [rsp+B8h] [rbp+58h]
  ...
  else
  {
    ...
    v23 = flags->__vftable;
    v32 = 4104;
    v24 = v23->QueryInterface(flags, (FxQueryInterfaceParams *)&p_pRequest);
    v3 = 0LL;
    if ( v24 < 0 )
    {
     ...
     || m_Globals->FxVerifyDownlevel != (_BYTE)v3) )
  {
    ...
    FxNonPagedObject::Lock(flags, &irql);
  ...
  if ( v8->FxVerifierIO != (_BYTE)v3 )
  {
    ...
    FxNonPagedObject::Unlock(flags, irql);
    v3 = 0LL;
    if ( _a1 < 0 )
    {
LABEL_32:
...
LABEL_55:
    if ( SLODWORD(m_DeviceBase[1].m_DisposeSingleEntry.Next) < 0 )
      return 0LL;
    goto LABEL_31;
  }
...
LABEL_49:
    if ( BYTE4(m_DeviceBase[1].m_Globals) && m_DeviceBase->m_DeviceObject.m_DeviceObject->DeviceType == 27 && v18 != v17 )
    {
      ...
      if ( v18 == (FxDeviceBase_vtbl *)144 )
        ...
        v28 = *(const void **)(FsContext + 128);
      WPP_IFR_SF_qq(globals, 3u, 0x12u, 0xFu, WPP_FxFileObject_cpp_Traceguids, FileObject, v28);
