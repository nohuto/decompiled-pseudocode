/*
 * XREFs of CmFcpManagerPublishFeatureUsageDataIfNearCapacity @ 0x1407E4EE8
 * Callers:
 *     CmFcpManagerPublishFeatureUsageDataIfNearCapacityWorker @ 0x1407E5050 (CmFcpManagerPublishFeatureUsageDataIfNearCapacityWorker.c)
 * Callees:
 ...
 *     CmFcpManagerFeatureUsageBufferNearCapacityThreshold @ 0x1404BC1D8 (CmFcpManagerFeatureUsageBufferNearCapacityThreshold.c)
...
LABEL_20:
    ...
    v11 = v10;
    if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 1400), 0LL) )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 1400), (__int64)v10, a1 + 1400);
    if ( v11 )
      *((_BYTE *)v11 + 10) = 1;
    v5 = 1;
    v4 = *v2 & 1;
