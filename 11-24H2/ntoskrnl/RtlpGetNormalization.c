/*
 * XREFs of RtlpGetNormalization @ 0x14078D4E0
 * Callers:
 *     RtlIsNormalizedString @ 0x140786C90 (RtlIsNormalizedString.c)
 *     RtlNormalizeString @ 0x140786D20 (RtlNormalizeString.c)
 * Callees:
 *     NormalizationListEntry_Alloc @ 0x1405F1198 (NormalizationListEntry_Alloc.c)
 *     NormalizationList__InsertTail @ 0x1405F11BC (NormalizationList__InsertTail.c)
 *     NormalizationList__Lock @ 0x1405F11F0 (NormalizationList__Lock.c)
 *     NormalizationList__Lookup @ 0x1405F1254 (NormalizationList__Lookup.c)
