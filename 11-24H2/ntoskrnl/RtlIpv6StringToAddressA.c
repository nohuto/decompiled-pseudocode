/*
 * XREFs of RtlIpv6StringToAddressA @ 0x14049C260
 * Callers:
 *     RtlIpv6StringToAddressExA @ 0x1405EDF70 (RtlIpv6StringToAddressExA.c)
 * Callees:
 *     strtol @ 0x1404FD688 (strtol.c)
 *     __isascii @ 0x1404FE990 (__isascii.c)
 *     isdigit @ 0x1404FE9B0 (isdigit.c)
 *     isxdigit @ 0x1404FEAA0 (isxdigit.c)
...
LABEL_16:
  ...
  if ( v6 == 1 )
  {
    ...
    else
    {
      ...
      v17 = Addr;
      Addr->u.Word[v26] = __ROR2__(v16, 8);
    }
  }
  else
  {
  ...
  {
    v19 = (char *)v17 + 2 * v11;
    memmove((char *)&v17[1] + 2 * (v11 - v8), v19, 2LL * (v8 - v11));
