/*
 * XREFs of DifZwCancelTimerWrapper @ 0x14063B250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelTimerWrapper(HANDLE TimerHandle, PBOOLEAN CurrentState)
{
  ...
  DWORD2(v16) = ZwCancelTimer(TimerHandle, CurrentState);
  if ( v6 )
  {
