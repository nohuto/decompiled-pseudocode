/*
 * XREFs of DrvDbGetDeviceIdMappedPropertyKeys @ 0x140822180
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  InfoKey = PnpCtxRegQueryInfoKey((unsigned int)&v14, v8, 0, 0, (__int64)&v14, 0LL, 0LL);
  if ( InfoKey >= 0 )
  {
    v11 = a5;
    if ( !v14
      || (InfoKey = DrvDbGetCompositeMappedPropertyKeys(v10, (__int64)off_140E0A560, 3u, a4, a5, v6), InfoKey >= 0) )
    {
      if ( v11 < *v6 )
        InfoKey = -1073741789;
    }
