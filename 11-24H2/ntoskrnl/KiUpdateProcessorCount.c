/*
 * XREFs of KiUpdateProcessorCount @ 0x140B558D8
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x140B577A0 (KiUpdateNumberProcessorsIpi.c)
 ...
 *     KiGetCurrentGroupCount @ 0x1405BB774 (KiGetCurrentGroupCount.c)
 */
