/*
 * XREFs of DifZwQueryLicenseValueWrapper @ 0x140644630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryLicenseValueWrapper(
        UNICODE_STRING *a1,
        ULONG *a2,
        void *a3,
        ULONG a4,
        ULONG *ResultDataSize)
{
  ...
  LODWORD(v21) = ZwQueryLicenseValue(a1, a2, a3, a4, ResultDataSize);
  if ( v10 )
  {
