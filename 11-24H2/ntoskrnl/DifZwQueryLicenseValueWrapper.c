/*
 * XREFs of DifZwQueryLicenseValueWrapper @ 0x140646070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryLicenseValueWrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  LODWORD(v25) = ZwQueryLicenseValue(a1, a2, a3, a4, a5);
  if ( v12 )
  {
