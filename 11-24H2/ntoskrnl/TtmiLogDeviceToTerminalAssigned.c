/*
 * XREFs of TtmiLogDeviceToTerminalAssigned @ 0x14076CD08
 * Callers:
...
void __fastcall TtmiLogDeviceToTerminalAssigned(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v6 = a1;
    v7 = a2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)word_14004FC4A, 0LL, 0LL, 5u, &v8);
  }
}
