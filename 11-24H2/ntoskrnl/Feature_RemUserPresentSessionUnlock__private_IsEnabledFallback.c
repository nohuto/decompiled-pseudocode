/*
 * XREFs of Feature_RemUserPresentSessionUnlock__private_IsEnabledFallback @ 0x1405DADE4
 * Callers:
...
__int64 __fastcall Feature_RemUserPresentSessionUnlock__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
