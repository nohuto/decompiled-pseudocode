/*
 * XREFs of DifZwFlushKeyWrapper @ 0x14063E7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFlushKeyWrapper(HANDLE KeyHandle)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(99);
  ...
  LODWORD(v14) = ZwFlushKey(KeyHandle);
  if ( v4 )
  {
