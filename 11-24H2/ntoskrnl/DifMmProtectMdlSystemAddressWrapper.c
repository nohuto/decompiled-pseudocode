/*
 * XREFs of DifMmProtectMdlSystemAddressWrapper @ 0x140634700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmProtectMdlSystemAddressWrapper(PMDL MemoryDescriptorList, ULONG NewProtect)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *(_QWORD *)&v20 = MemoryDescriptorList;
    DWORD2(v19) = NewProtect;
  ...
  DWORD2(v20) = MmProtectMdlSystemAddress(MemoryDescriptorList, NewProtect);
  if ( v8 )
  {
