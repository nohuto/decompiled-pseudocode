/*
 * XREFs of DifMmProtectMdlSystemAddressWrapper @ 0x140632CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmProtectMdlSystemAddressWrapper(PMDL MemoryDescriptorList, ULONG NewProtect)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(440);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = MemoryDescriptorList;
    DWORD2(v15) = NewProtect;
  ...
  DWORD2(v16) = MmProtectMdlSystemAddress(MemoryDescriptorList, NewProtect);
  if ( v6 )
  {
