/*
 * XREFs of NtSetTimerEx @ 0x1402BD5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG TimerSetInformationLength)
{
  ...
  if ( !v7 || (result = PoCaptureReasonContext(v7, PreviousMode, 0LL, 0, (__int64)v16, &P), result >= 0) )
  {
    v8 = *((_QWORD *)v4 + 5);
    TolerableDelay = *((_DWORD *)v4 + 9);
    v17 = *((_DWORD *)v4 + 8);
    v10 = *((_QWORD *)v4 + 2);
    v11 = *((_QWORD *)v4 + 1);
    Object = 0LL;
...
LABEL_16:
    ...
    {
      if ( !v11 && !v10 && !P && !TolerableDelay && !v8 )
      {
    ...
    else
    {
      ...
      {
        v14 = ExpSetTimerObject((ULONG_PTR)Object, v10, (__int64)P, v16[0], v17, TolerableDelay, v8);
LABEL_15:
        v12 = v14;
        goto LABEL_16;
      }
