/*
 * XREFs of ExpMoveSharedFastResourceOwnershipWithFlags @ 0x1403D707C
 * Callers:
 *     ExMoveFastResourceOwnershipWithFlags @ 0x1403D7050 (ExMoveFastResourceOwnershipWithFlags.c)
 * Callees:
