/*
 * XREFs of SUBTRACT_MAP_REGISTERS @ 0x140B84E20
 * Callers:
...
void __fastcall SUBTRACT_MAP_REGISTERS(__int64 a1, int a2)
{
  ...
  {
    v4 = -v3;
    ViHalPreprocessOptions(byte_140E0E918, "Freed too many map registers: -%x.", 5);
    VfReportIssueWithOptions(0xE6u, 5uLL, v4, 0LL, 0LL, byte_140E0E918);
  }
