/*
 * XREFs of DifExTryToAcquireResourceExclusiveLiteWrapper @ 0x1406213B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExTryToAcquireResourceExclusiveLiteWrapper(PERESOURCE Resource)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(462);
  ...
  LOBYTE(v18) = ExTryToAcquireResourceExclusiveLite(Resource);
  if ( v6 )
  {
