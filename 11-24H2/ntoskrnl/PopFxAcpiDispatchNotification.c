/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1405DC3B0
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1404C9C70 (PoFxPlatformRequestHandler.c)
 * Callees:
 *     PopFxAcpiValidateParameters @ 0x1404BFB3C (PopFxAcpiValidateParameters.c)
