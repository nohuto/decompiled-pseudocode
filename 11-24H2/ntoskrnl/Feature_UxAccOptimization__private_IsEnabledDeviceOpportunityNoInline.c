/*
 * XREFs of Feature_UxAccOptimization__private_IsEnabledDeviceOpportunityNoInline @ 0x140669268
 * Callers:
...
__int64 Feature_UxAccOptimization__private_IsEnabledDeviceOpportunityNoInline()
{
  if ( (Feature_UxAccOptimization__private_featureState & 0x20) != 0 )
