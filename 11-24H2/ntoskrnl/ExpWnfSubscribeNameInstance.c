/*
 * XREFs of ExpWnfSubscribeNameInstance @ 0x1409D34B4
 * Callers:
        ...
        unsigned int *a11)
{
  ...
  *((_QWORD *)v20 + 7) = *(_QWORD *)(a1 + 40);
  ...
  if ( v27 )
  {
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 112), (__int64)v26, a1 + 112);
    v26 = v42;
  }
  if ( v26 )
    *((_BYTE *)v26 + 10) = 1;
  if ( *(_QWORD *)(a1 + 48) )
  {
      ...
      || (int)ExpWnfUpdateSubscription(a1, v41, a3, v45, a6, (__int64)&v40, (__int64)&v38, (__int64)&v39, (__int64)a8) < 0 )
    {
      ...
      *((_QWORD *)v20 + 6) = a1;
      *((_QWORD *)v20 + 2) = v21;
      ExAcquireRundownProtection((PEX_RUNDOWN_REF)v20 + 1);
      if ( a9 )
        ExAcquireRundownProtection((PEX_RUNDOWN_REF)v20 + 1);
      v28 = v20 + 24;
      v29 = v41 + 88;
