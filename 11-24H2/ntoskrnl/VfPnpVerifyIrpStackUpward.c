/*
 * XREFs of VfPnpVerifyIrpStackUpward @ 0x140BA78F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VfPnpVerifyIrpStackUpward(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  _QWORD *v16; // rbx
  _QWORD *BottomDeviceObjectWithTag; // rcx
  BOOL v18; // ebx
  const void *v19; // r9
...
LABEL_21:
  if ( *(_BYTE *)(a2 + 1) == 23 )
  {
    ...
    else
    {
      ...
      v18 = BottomDeviceObjectWithTag == v16 && PpvUtilIsPdo((__int64)BottomDeviceObjectWithTag);
    ...
    if ( (_DWORD)result )
      return ViErrorReport10(0x242u, v12, *(const void **)(v11 + 64), v19);
  }
  return result;
}
