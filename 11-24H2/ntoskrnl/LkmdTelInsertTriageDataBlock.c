/*
 * XREFs of LkmdTelInsertTriageDataBlock @ 0x1406A5470
 * Callers:
...
__int64 __fastcall LkmdTelInsertTriageDataBlock(__int64 *a1, const void *a2, unsigned int a3)
{
  ...
  if ( (*(_DWORD *)(*a1 + 4152) & 0x800) != 0
    && (v8 = *(_DWORD *)(v7 + 8316)) != 0
    && (v9 = *(unsigned int *)(v7 + 8312), v9 + 16 * (unsigned __int64)v8 <= 0x40000) )
  {
    v10 = 0x40000;
    v11 = (_DWORD *)(v9 + v7 + 12);
    v12 = 0;
    ...
    if ( 262140 - v12 >= 0x40000 || (((_DWORD)v4 + 7) & 0xFFFFFFF8) + 16 > 262140 - v12 )
    {
      return (unsigned int)-1073741789;
    }
    else
    {
      memmove((void *)(v7 + v10 + 16), (const void *)(v7 + v10), v12 - v10);
      v17 = 0;
      v18 = *(_DWORD *)(v7 + 8316);
