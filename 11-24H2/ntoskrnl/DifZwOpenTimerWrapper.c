/*
 * XREFs of DifZwOpenTimerWrapper @ 0x1406415C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenTimerWrapper(
        PHANDLE TimerHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(70);
  ...
  LODWORD(v19) = ZwOpenTimer(TimerHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
