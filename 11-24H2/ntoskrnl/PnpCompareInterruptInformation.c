/*
 * XREFs of PnpCompareInterruptInformation @ 0x140A12D20
 * Callers:
    ...
    if ( *v5 == a3 )
    {
      ...
      if ( v3 != v4 && (unsigned int)dword_140E06FA8 > 5 )
      {
        ...
        if ( (_BYTE)v3 )
        {
          ...
          v18[0] = v10;
          v17 = v4;
          v12 = (unsigned __int8 *)byte_1400464AD;
LABEL_20:
          v23 = v14;
          v26[1] = v27;
          v26[3] = *(_QWORD *)(v6 + 48);
...
LABEL_21:
    ...
    else if ( (unsigned int)dword_140E06FA8 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v17 = v8;
        v18[0] = v4;
        v12 = (unsigned __int8 *)&word_140046456;
        goto LABEL_20;
      }
    }
  }
  else if ( (unsigned int)dword_140E06FA8 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v20 = "Not Found";
      v21 = v7 + 1;
      v12 = (unsigned __int8 *)&dword_140046504;
      v24 = 2LL;
      v23 = (int *)v26;
      v25 = *(int **)(v6 + 48);
