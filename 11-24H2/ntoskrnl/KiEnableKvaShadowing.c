/*
 * XREFs of KiEnableKvaShadowing @ 0x140B5A87C
 * Callers:
 ...
 *     HvlRescindEnlightenments @ 0x14058B9DC (HvlRescindEnlightenments.c)
 *     KiIsKvaShadowDisabled @ 0x1405BDF24 (KiIsKvaShadowDisabled.c)
 *     KiInitializeDescriptorIst @ 0x1405C3898 (KiInitializeDescriptorIst.c)
 *     SpcIsKvaLeakageSimulated @ 0x1406A0B10 (SpcIsKvaLeakageSimulated.c)
 *     SpcQueryKvaLeakagePresent @ 0x1406A0B20 (SpcQueryKvaLeakagePresent.c)
    ...
    if ( (unsigned int)SpcQueryKvaLeakagePresent() || SpcIsKvaLeakageSimulated() )
    {
      ...
      *(_QWORD *)(v9 + 4100) = v9 + 16896;
      ...
      else
      {
        ...
        byte_140FCF060 = 1;
        _InterlockedOr(dword_140FCF4FC, 0x4000u);
