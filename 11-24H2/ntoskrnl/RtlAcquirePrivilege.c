/*
 * XREFs of RtlAcquirePrivilege @ 0x1409A82D4
 * Callers:
...
NTSTATUS __cdecl RtlAcquirePrivilege(PULONG Privilege, ULONG NumPriv, ULONG Flags, PVOID *ReturnedState)
{
  ...
  if ( (Flags & 2) == 0 )
    v7 = Flags;
  Pool2 = ExAllocatePool2(0x41uLL, 12 * (NumPriv - 1 + 90LL), 0x62507452u);
  v9 = Pool2;
  if ( Pool2 )
  {
    *(_QWORD *)Pool2 = 0LL;
...
LABEL_13:
        ...
        *(_DWORD *)(v9 + 1064) = v5;
        ...
        if ( v11 == -1073741789 )
        {
          while ( 1 )
          {
            PreviousState = (struct _TOKEN_PRIVILEGES *)ExAllocatePool2(0x41uLL, BufferLength, 0x62507452u);
