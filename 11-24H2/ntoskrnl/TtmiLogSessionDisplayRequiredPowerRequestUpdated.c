/*
 * XREFs of TtmiLogSessionDisplayRequiredPowerRequestUpdated @ 0x14076DE10
 * Callers:
...
void TtmiLogSessionDisplayRequiredPowerRequestUpdated()
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)qword_140050850, 0LL, 0LL, 5u, &v7);
  }
}
