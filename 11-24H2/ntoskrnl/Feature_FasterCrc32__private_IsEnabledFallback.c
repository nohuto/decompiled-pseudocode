/*
 * XREFs of Feature_FasterCrc32__private_IsEnabledFallback @ 0x1404F8DE4
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_FasterCrc32__private_descriptor);
}
