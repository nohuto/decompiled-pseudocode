/*
 * XREFs of ?KiAdaptThreadIdealProcessorForProcessIdealSetChange@@YAXPEAU_KPROCESS@@PEAU_KTHREAD@@PEAU_KAFFINITY_EX@@2PEAE3PEAK@Z @ 0x1404A5B9C
 * Callers:
  ...
  if ( (v24 & *(_QWORD *)(v23 + 200)) == 0 && (v18 & v24) != 0 )
  {
    if ( v21 != 2 || (v13 = 1, *a7 % (unsigned int)__popcnt(v20) >= (unsigned int)__popcnt(v19)) )
    {
      ...
      *v8 = *(_WORD *)(*(_QWORD *)(v26 + 192) + 138LL) != *(_WORD *)(*(_QWORD *)(v23 + 192) + 138LL);
      if ( !v27 )
        EtwTraceIdealProcessor(a2, 1351LL);
      goto LABEL_22;
    }
  }
LABEL_21:
