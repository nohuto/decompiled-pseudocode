/*
 * XREFs of HalpDpReplaceBegin @ 0x1407005F0
 * Callers:
 *     <none>
 * Callees:
 *     HalpInterruptDpReplaceBegin @ 0x14055F7CC (HalpInterruptDpReplaceBegin.c)
 *     memmove @ 0x1406C0B40 (memmove.c)
 *     HalpDpSortApicList @ 0x1407007D8 (HalpDpSortApicList.c)
...
__int64 __fastcall HalpDpReplaceBegin(__int64 a1, __int64 *a2)
{
  ...
  Pool2 = ExAllocatePool2(0x40uLL, (unsigned int)(4 * (v5 + 2 * v6 + 32)), 0x436C6148u);
  v9 = Pool2;
  if ( !Pool2 )
...
LABEL_18:
  ...
  if ( !(_DWORD)v6
    || (v11 = ExAllocatePool2(0x40uLL, (unsigned int)(v2 * v6), 0x436C6148u), (*(_QWORD *)(v9 + 32) = v11) != 0LL) )
  {
