/*
 * XREFs of SepIsParentOfChildAppContainer @ 0x140794F90
 * Callers:
 *     SeIsParentOfChildAppContainer @ 0x14078F820 (SeIsParentOfChildAppContainer.c)
 * Callees:
...
LABEL_19:
    ...
    v17 = v14;
    if ( v15 )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)BugCheckParameter2, (__int64)v14, BugCheckParameter2);
    if ( v17 )
      *((_BYTE *)v17 + 10) = 1;
