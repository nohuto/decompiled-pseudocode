/*
 * XREFs of DifIoWMIAllocateInstanceIdsWrapper @ 0x140629CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoWMIAllocateInstanceIdsWrapper(LPCGUID Guid, ULONG InstanceCount, ULONG *FirstInstanceId)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(306);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = Guid;
    LODWORD(v18) = InstanceCount;
    *((_QWORD *)&v17 + 1) = FirstInstanceId;
  ...
  LODWORD(v19) = IoWMIAllocateInstanceIds(Guid, InstanceCount, FirstInstanceId);
  if ( v8 )
  {
