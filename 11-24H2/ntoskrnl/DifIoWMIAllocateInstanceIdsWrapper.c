/*
 * XREFs of DifIoWMIAllocateInstanceIdsWrapper @ 0x14062B6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoWMIAllocateInstanceIdsWrapper(LPCGUID Guid, ULONG InstanceCount, ULONG *FirstInstanceId)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = Guid;
    LODWORD(v22) = InstanceCount;
    *((_QWORD *)&v21 + 1) = FirstInstanceId;
  ...
  LODWORD(v23) = IoWMIAllocateInstanceIds(Guid, InstanceCount, FirstInstanceId);
  if ( v10 )
  {
