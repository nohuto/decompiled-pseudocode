/*
 * XREFs of StartFirstUserProcess @ 0x140C620B8
 * Callers:
 ...
 *     RtlNormalizeProcessParams @ 0x140C38B44 (RtlNormalizeProcessParams.c)
...
void StartFirstUserProcess()
{
  ...
  *(_DWORD *)(&DestinationString.MaximumLength + 1) = 0;
  ...
  MaximumLength = stru_140FCFD18.MaximumLength;
  p_UnicodeString = &UnicodeString;
  if ( v0 < 0 )
    p_UnicodeString = (UNICODE_STRING *)&NtInitialUserProcess;
  v3 = p_UnicodeString->MaximumLength + stru_140FCFD08.MaximumLength + 1096LL;
  Pool2 = ExAllocatePool2(0x40uLL, v3 + stru_140FCFD18.MaximumLength, 0x62537350uLL);
  v5 = Pool2;
  if ( !Pool2 )
  ...
  *(_WORD *)(Pool2 + 58) = stru_140FCFD08.MaximumLength;
  RtlCopyUnicodeString((PUNICODE_STRING)(Pool2 + 56), &stru_140FCFD08);
  ...
  *(_OWORD *)(v5 + 112) = v7;
  ...
  RtlCopyUnicodeString(&DestinationString, &stru_140FCFD18);
  if ( v5 == -96 || (v10 = RtlNormalizeProcessParams((PRTL_USER_PROCESS_PARAMETERS)v5), (v9 = (__int64)v10) == 0) )
  {
