/*
 * XREFs of DifKeTryToAcquireQueuedSpinLockWrapper @ 0x14062F7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeTryToAcquireQueuedSpinLockWrapper(KSPIN_LOCK_QUEUE_NUMBER Number, PKIRQL OldIrql)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(244);
  ...
  DWORD2(v16) = KeTryToAcquireQueuedSpinLock(Number, OldIrql);
  if ( v6 )
  {
