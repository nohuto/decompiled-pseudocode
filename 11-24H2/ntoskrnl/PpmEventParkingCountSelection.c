/*
 * XREFs of PpmEventParkingCountSelection @ 0x1404700AC
 * Callers:
        ...
        char a11)
{
  ...
  char v36; // [rsp+130h] [rbp+28h] BYREF
  char v37; // [rsp+138h] [rbp+30h] BYREF
  char v38; // [rsp+140h] [rbp+38h] BYREF
  ...
  if ( PpmEtwRegistered )
  {
    LOBYTE(v11) = EtwEventEnabled(PpmEtwHandle, &PPM_ETW_PARKING_COUNT_SELECTION_V0);
    if ( (_BYTE)v11 )
    {
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      v31 = 4LL;
      v33 = 4LL;
      LOBYTE(v11) = EtwWriteEx(PpmEtwHandle, &PPM_ETW_PARKING_COUNT_SELECTION_V0, 0LL, 0, 0LL, 0LL, 0xBu, &UserData);
    }
  }
  return (char)v11;
}
