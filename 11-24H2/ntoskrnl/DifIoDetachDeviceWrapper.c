/*
 * XREFs of DifIoDetachDeviceWrapper @ 0x1406264A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifIoDetachDeviceWrapper(PDEVICE_OBJECT TargetDevice)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(344);
