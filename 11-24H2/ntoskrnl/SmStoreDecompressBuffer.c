/*
 * XREFs of SmStoreDecompressBuffer @ 0x1402F9A18
 * Callers:
...
LABEL_46:
    ...
    v21 = RtlDecompressBufferEx(word_140011540[SDWORD2(v36)], v8, v16, (PUCHAR)v7, v9, &v29, WorkSpace);
    v28 = v21;
    HIDWORD(v36) = v21;
    if ( v21 >= 0 )
    {
