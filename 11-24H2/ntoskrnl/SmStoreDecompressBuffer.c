/*
 * XREFs of SmStoreDecompressBuffer @ 0x14039C718
 * Callers:
  ...
  *((_QWORD *)&v35 + 1) = a6;
  ...
  if ( DWORD2(v36) == 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *((_QWORD *)&v34 + 1) )
        break;
      v21 = RtlDecompressBufferEx((unsigned __int16)word_140014BB8[SDWORD2(v36)], v8, v16, v22, v25, (__int64)&v45, v17);
      v26 = v21;
      HIDWORD(v36) = v21;
      if ( v21 >= 0 )
      {
...
LABEL_46:
    ...
    v21 = RtlDecompressBufferEx((unsigned __int16)word_140014BB8[SDWORD2(v36)], v8, v16, v7, v9, (__int64)&v29, v17);
    v28 = v21;
    HIDWORD(v36) = v21;
    if ( v21 >= 0 )
    {
