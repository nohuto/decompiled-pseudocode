/*
 * XREFs of DifZwWaitForSingleObjectWrapper @ 0x140648330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForSingleObjectWrapper(HANDLE Handle, BOOLEAN a2, LARGE_INTEGER *a3)
{
  ...
  LODWORD(v19) = ZwWaitForSingleObject(Handle, a2, a3);
  if ( v8 )
  {
