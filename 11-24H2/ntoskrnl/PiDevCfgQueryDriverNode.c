/*
 * XREFs of PiDevCfgQueryDriverNode @ 0x140996564
 * Callers:
          ...
          *(_QWORD *)v41 = DEVPKEY_DriverPackage_DriverDate;
          ...
          if ( DriverPackageId >= 0 )
          {
            ...
            *(_DWORD *)&v35.Length = 1572886;
            ...
            v20 = IopOpenRegistryKeyEx(&v38, Handle, &v35, 131097LL);
            DriverPackageId = v20;
            if ( v20 == -1073741772 )
              goto LABEL_64;
            if ( v20 < 0 )
              goto LABEL_23;
            v21 = IopOpenRegistryKeyEx(&v33, v38, v13 + 72, 131097LL);
            DriverPackageId = v21;
            if ( v21 == -1073741772 )
            {
LABEL_64:
            ...
            else
            {
              ...
              v71 = v13 + 88;
              v69 = 288;
              DriverPackageId = RtlpQueryRegistryValues(-1073741824, (int)v33, (int)v68, 0, v26, 1);
              if ( DriverPackageId < 0 )
                goto LABEL_23;
            ...
            if ( v22 )
            {
              ...
              else
              {
                ...
                *(_QWORD *)v68 = PiDevCfgQueryDriverVersionValueCallback;
                ...
                v78 = v13 + 160;
                v76 = 304;
                DriverPackageId = RtlpQueryRegistryValues(-1073741824, (int)v32, (int)v68, 0, v26, 1);
                if ( DriverPackageId < 0 )
                  goto LABEL_23;
