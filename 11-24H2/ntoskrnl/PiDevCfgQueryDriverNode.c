/*
 * XREFs of PiDevCfgQueryDriverNode @ 0x140AC0A0C
 * Callers:
 ...
 *     PiDevCfgEnforceDriverPolicy @ 0x140727084 (PiDevCfgEnforceDriverPolicy.c)
        ...
        __int64 *a7)
{
  ...
  *(_QWORD *)&v45.Length = 0LL;
  ...
  v42 = a3;
  v35 = -16777216;
  DriverPackageId = PiDevCfgGetDriverPackageId(SourceString, (__int64)&UnicodeString);
  if ( DriverPackageId >= 0 )
  {
    ...
    if ( DriverPackageId >= 0 )
    {
      ...
      *(_QWORD *)v47 = DEVPKEY_DriverPackage_Invalidated;
      ...
      v53 = 8210;
      v56 = 6;
      DriverPackageId = PiDevCfgQueryObjectProperties(v12, UnicodeString.Buffer, 8u, Handle, (__int64)v47, 2u);
      if ( DriverPackageId >= 0 )
      {
        if ( v51 >= 0 && v33 == -1 )
        {
        ...
        *(_QWORD *)(Pool2 + 384) = Pool2 + 384;
          ...
          && (!i || RtlCreateUnicodeString((PUNICODE_STRING)(Pool2 + 128), i)) )
        {
          ...
          *(_QWORD *)v47 = DEVPKEY_DriverPackage_DriverDate;
          ...
          v70 = Pool2 + 144;
          v72 = 2;
          DriverPackageId = PiDevCfgQueryObjectProperties(16LL, UnicodeString.Buffer, 8u, Handle, (__int64)v47, 5u);
          if ( DriverPackageId >= 0 )
          {
            if ( v51 < 0 )
            ...
            *(_DWORD *)(Pool2 + 108) = v17;
            if ( (a5 & 2) != 0 )
            {
              ...
              *(_QWORD *)v47 = DEVPKEY_DriverPackage_F6;
              ...
              v48 = 17;
              v50 = 1;
              DriverPackageId = PiDevCfgQueryObjectProperties(v18, UnicodeString.Buffer, 8u, Handle, (__int64)v47, 1u);
              if ( DriverPackageId < 0 )
                goto LABEL_25;
              if ( v51 >= 0 )
              {
              ...
              && (*a6 & 2) != 0 )
            {
              ...
              *(_QWORD *)v47 = &DEVPKEY_DriverPackage_Inbox;
              ...
              v59 = 9;
              v61 = 8;
              DriverPackageId = PiDevCfgQueryObjectProperties(8LL, UnicodeString.Buffer, 8u, Handle, (__int64)v47, 3u);
              if ( DriverPackageId < 0 )
                goto LABEL_25;
              if ( v51 >= 0 )
              {
...
LABEL_81:
            ...
            *(_QWORD *)v47 = DEVPKEY_DriverPackage_NeedsReconfig;
            ...
            v48 = 17;
            v50 = 1;
            DriverPackageId = PiDevCfgQueryObjectProperties(v27, UnicodeString.Buffer, 8u, Handle, (__int64)v47, 1u);
            if ( DriverPackageId >= 0 )
            {
              if ( v51 >= 0 )
              {
