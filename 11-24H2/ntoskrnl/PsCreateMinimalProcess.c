/*
 * XREFs of PsCreateMinimalProcess @ 0x1407797C4
 * Callers:
        ...
        _QWORD *a12)
{
  ...
  __int64 v34[48]; // [rsp+D0h] [rbp-30h] BYREF
        ...
        Process >= 0) )
  {
    ...
    if ( MemoryPartitionContext >= 0 )
    {
      ...
      if ( Process >= 0 )
      {
        ...
        if ( (_BYTE)v26 )
          v23 = 3;
        Process = PspInsertProcess(v22, 0LL, v23, v32, (__int64)v34);
        if ( Process >= 0 )
        {
          v15 |= 4u;
          if ( !v12 || (Process = PsAssignProcessToJobObject(v12, (ULONG_PTR)Object), Process >= 0) )
          {
            ...
            v15 |= 2u;
            v35 |= 0x200u;
            Process = PspCreateObjectHandle(Object, v34, PsProcessType);
            if ( Process >= 0 )
            {
              v15 &= ~4u;
              *v33 = v36;
