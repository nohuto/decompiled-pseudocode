/*
 * XREFs of DifExConvertFastResourceExclusiveToSharedWrapper @ 0x14061B6D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExConvertFastResourceExclusiveToSharedWrapper(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(457);
  ...
  ExConvertFastResourceExclusiveToShared(BugCheckParameter2, a2);
  if ( v6 )
  {
