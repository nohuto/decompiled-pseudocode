/*
 * XREFs of SbpAddTransportToInstance @ 0x140C60B84
 * Callers:
...
__int64 SbpAddTransportToInstance()
{
  ...
  {
    Pool2 = (char *)ExAllocatePool2(0x40uLL, 0xD0uLL, 0x42626D53uLL);
    v0 = Pool2;
    if ( !Pool2 )
      goto LABEL_3;
    *(_DWORD *)Pool2 = 16;
    ...
    *(_OWORD *)(Pool2 + 188) = *(_OWORD *)L"70}-0000";
    ...
    v6 = IoBuildDeviceIoControlRequest(0x1401B0u, v5, Pool2, 0xD0u, 0LL, 0, 0, &Object, &IoStatusBlock);
    v7 = v6;
    if ( v6 )
    {
