/*
 * XREFs of HalpNumaQueryMemorySideCacheInfo @ 0x140701980
 * Callers:
 *     <none>
 * Callees:
 *     HalpNumaCompareMemorySideCacheNodeAndLevel @ 0x140701954 (HalpNumaCompareMemorySideCacheNodeAndLevel.c)
 */
