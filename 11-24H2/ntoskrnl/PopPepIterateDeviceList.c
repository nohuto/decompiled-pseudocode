/*
 * XREFs of PopPepIterateDeviceList @ 0x1405DBBE4
 * Callers:
...
char __fastcall PopPepIterateDeviceList(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, char a6, __int64 a7)
{
  ...
  if ( v8 )
    guard_dispatch_icall_no_overrides(a7, a2, a3, a4);
  for ( i = (__int64 *)PopPepDeviceList; i != &PopPepDeviceList; i = (__int64 *)*i )
  {
    if ( !(unsigned __int8)guard_dispatch_icall_no_overrides(i, a7, a3, a4) )
    {
      v9 = 0;
      break;
    }
  ...
  {
    LOBYTE(a1) = v9;
    guard_dispatch_icall_no_overrides(a1, a7, a3, a4);
  }
  if ( a6 )
  {
