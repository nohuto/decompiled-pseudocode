/*
 * XREFs of PopBlackBoxUpdate @ 0x140A1ABD8
 * Callers:
...
__int64 __fastcall PopBlackBoxUpdate(__int64 a1, char a2)
{
  ...
  v7 = KeAbPreAcquire((__int64)&PopBlackBoxLock, 0LL);
  v8 = v7;
  if ( _interlockedbittestandset64((volatile signed __int32 *)&PopBlackBoxLock, 0LL) )
    ExfAcquirePushLockExclusiveEx(&PopBlackBoxLock, (__int64)v7, (__int64)&PopBlackBoxLock);
  if ( v8 )
    *((_BYTE *)v8 + 10) = 1;
  if ( ((_DWORD)v4[2] & 2) != 0 )
  {
  ...
  if ( !v5 )
  {
    ...
    v4[11] = (__int64 (*)[2])v11;
LABEL_12:
    if ( v4[10] || (Pool2 = ExAllocatePool2(0x40uLL), (v4[10] = (__int64 (*)[2])Pool2) != 0LL) )
    {
