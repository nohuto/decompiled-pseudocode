/*
 * XREFs of sub_1407B85B0 @ 0x1407B85B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1407B85B0(__int64 a1, _DWORD *a2, _DWORD *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  _DWORD *v8; // rbx
...
LABEL_16:
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)v10, 0LL) )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)v10, (__int64)v17, (__int64)v10);
    if ( v18 )
      *((_BYTE *)v18 + 10) = 1;
    v19 = *(_QWORD *)(a1 + 47016);
...
LABEL_45:
  ...
  if ( v39 )
  {
    v30 = a5;
    *a6 = 1;
    return (unsigned int)sub_1407B82EC(v8, a3, a4, v30, 0);
  }
  else
  {
    v29 = -1073741772;
