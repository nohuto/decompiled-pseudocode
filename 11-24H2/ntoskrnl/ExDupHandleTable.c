/*
 * XREFs of ExDupHandleTable @ 0x14093D080
 * Callers:
  ...
  *a5 = (PVOID)v12;
  ...
  while ( 1 )
  {
    ...
    if ( *(unsigned int *)*a5 >= v11 )
      break;
    if ( !ExpAllocateHandleTableEntrySlow(v14, 0LL) )
    {
...
LABEL_13:
      ...
      if ( (v13 & 3) != 0 )
      {
        v20 = *(_QWORD *)(*(_QWORD *)(v13 + 8 * (v19 >> 19) - 2) + 8 * ((v19 >> 10) & 0x1FF));
        goto LABEL_13;
      }
      v21 = v13 + 4 * v19;
    }
LABEL_14:
    ...
    else
    {
      ...
      v23 = *(_QWORD *)(*(_QWORD *)(v13 + 8 * (v19 >> 19) - 2) + 8 * ((v19 >> 10) & 0x1FF));
    }
    v19 = v6 & 0x3FC;
    v24 = v23 + 4 * v19;
LABEL_18:
  ...
  *v18 = 0LL;
  ...
  else
  {
    *((_DWORD *)v27 + 23) = *((_DWORD *)v27 + 22);
    v28 = KeAbPreAcquire((__int64)&HandleTableListLock, 0LL);
    v29 = v28;
    if ( _interlockedbittestandset64((volatile signed __int32 *)&HandleTableListLock, 0LL) )
      ExfAcquirePushLockExclusiveEx(&HandleTableListLock, (__int64)v28, (__int64)&HandleTableListLock);
    if ( v29 )
      *((_BYTE *)v29 + 10) = 1;
    v30 = (_QWORD *)qword_140FD8FB0;
    v31 = (char *)*a5 + 24;
  ...
  KiLeaveCriticalRegionUnsafe((__int64)CurrentThread, v22, v19, v13);
