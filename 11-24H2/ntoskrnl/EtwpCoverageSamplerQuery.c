/*
 * XREFs of EtwpCoverageSamplerQuery @ 0x14095DA30
 * Callers:
...
__int64 __fastcall EtwpCoverageSamplerQuery(ULONG_PTR BugCheckParameter2, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v9 = stru_140EFEC80.Count & 0xFFFFFFFFFFFFFFFEuLL;
  ...
  v11 = qword_140EFEC78;
  v118 = qword_140EFEC78;
  v124 = qword_140EFEC78;
  if ( qword_140EFEC78 != BugCheckParameter2 )
  {
    v12 = -1073741431;
    v13 = 0LL;
    goto LABEL_121;
  ...
  if ( (*(_DWORD *)(v129 + 16) & 1) != 0 )
  {
    ...
    if ( *(_QWORD *)(v117 + 1320) )
    {
      ...
      if ( _interlockedbittestandset64((volatile signed __int32 *)BugCheckParameter2a, 0LL) )
        ExfAcquirePushLockExclusiveEx((unsigned __int64 *)BugCheckParameter2a, (__int64)v43, BugCheckParameter2a);
      if ( v44 )
        *((_BYTE *)v44 + 10) = 1;
    ...
    if ( *(_QWORD *)(v41 + 1328) )
    {
      ...
      v51 = v50;
      if ( _interlockedbittestandset64((volatile signed __int32 *)BugCheckParameter2a, 0LL) )
        ExfAcquirePushLockExclusiveEx((unsigned __int64 *)BugCheckParameter2a, (__int64)v50, BugCheckParameter2a);
      if ( v51 )
        *((_BYTE *)v51 + 10) = 1;
  ...
  while ( v74 != &v116 )
  {
    ...
    *((_DWORD *)v68 + 11) = *((_DWORD *)v74 + 6);
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)(v6 + 1176), 0LL) )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(v6 + 1176), (__int64)v78, v6 + 1176);
    if ( v79 )
      *((_BYTE *)v79 + 10) = 1;
...
LABEL_121:
    ...
    if ( (_DWORD)v13 )
    {
      ...
      do
      {
        ...
        if ( *v101 )
        {
          ...
          if ( (v102 & 1) != 0 )
          {
            guard_dispatch_icall_no_overrides(v103, v11, a3, a4);
          }
          else if ( v103 )
          {
            ExFreePool(v103);
  ...
  {
    _m_prefetchw(&stru_140EFEC80);
    v104 = stru_140EFEC80.Count & 0xFFFFFFFFFFFFFFFEuLL;
