/*
 * XREFs of sub_140BD60B0 @ 0x140BD60B0
 * Callers:
...
__int64 __fastcall sub_140BD60B0(
        __int64 a1,
        unsigned int *a2,
        unsigned int a3,
        ULONG_PTR a4,
        ...
        unsigned int *a7)
{
  ...
  {
    v13 = sub_140BD7AF8(v7, v12, *((unsigned int *)v7 + 593));
    if ( !v13 )
      return 3221225626LL;
    v15 = *((_DWORD *)v7 + 630);
    if ( (v15 & 2) == 0 )
          ...
          *(_DWORD *)(v13 + 2524) &= ~0x200000u;
          if ( v120 != *(_QWORD *)(v13 + 2688) )
          {
            ...
            *(_DWORD *)(v123 + 16) = v122;
            ...
            sub_140BD8384(v13, 0LL, v120, 256LL);
          }
        }
      }
LABEL_195:
      ...
      *(_DWORD *)(v13 + 2524) &= ~0x200000u;
      if ( v173 != *(_QWORD *)(v13 + 2688) )
      {
        ...
        *(_DWORD *)(v176 + 16) = v177;
        ...
        sub_140BD8384(v13, 0LL, v173, 256LL);
      }
    }
  }
  if ( v264 )
