/*
 * XREFs of DifIoSetDeviceInterfaceStateWrapper @ 0x140629270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoSetDeviceInterfaceStateWrapper(PUNICODE_STRING SymbolicLinkName, BOOLEAN a2)
{
  ...
  DWORD2(v16) = IoSetDeviceInterfaceState(SymbolicLinkName, a2);
  if ( v6 )
  {
