/*
 * XREFs of DifPoFxActivateComponentWrapper @ 0x1406353C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxActivateComponentWrapper(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3, int a3)
{
