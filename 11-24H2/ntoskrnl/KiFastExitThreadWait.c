/*
 * XREFs of KiFastExitThreadWait @ 0x14024F840
 * Callers:
...
__int64 __fastcall KiFastExitThreadWait(struct _KPRCB *a1, ULONG_PTR BugCheckParameter1, char a3)
{
  unsigned int v6; // esi
  __int64 result; // rax
  int v8; // ebx
    ...
    *(_BYTE *)(v11 + BugCheckParameter1 + 824) = v13;
    if ( !v13 )
    {
      ...
      *(_DWORD *)(BugCheckParameter1 + 856) = v14;
      ...
      {
        v15 = KiComputeThreadPriority(BugCheckParameter1, 0LL, 0LL);
