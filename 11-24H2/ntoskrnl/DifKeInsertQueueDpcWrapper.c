/*
 * XREFs of DifKeInsertQueueDpcWrapper @ 0x14062C9A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeInsertQueueDpcWrapper(PRKDPC Dpc, PVOID SystemArgument1, PVOID SystemArgument2)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = Dpc;
    *(_QWORD *)&v18 = SystemArgument1;
    *((_QWORD *)&v17 + 1) = SystemArgument2;
  ...
  LOBYTE(v19) = KeInsertQueueDpc(Dpc, SystemArgument1, SystemArgument2);
  if ( v8 )
  {
