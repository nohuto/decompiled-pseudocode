/*
 * XREFs of DifKeInsertQueueDpcWrapper @ 0x14062E3E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeInsertQueueDpcWrapper(PRKDPC Dpc, PVOID SystemArgument1, PVOID SystemArgument2)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = Dpc;
    *(_QWORD *)&v22 = SystemArgument1;
    *((_QWORD *)&v21 + 1) = SystemArgument2;
  ...
  LOBYTE(v23) = KeInsertQueueDpc(Dpc, SystemArgument1, SystemArgument2);
  if ( v10 )
  {
