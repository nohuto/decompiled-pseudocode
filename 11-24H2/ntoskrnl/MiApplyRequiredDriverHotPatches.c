/*
 * XREFs of MiApplyRequiredDriverHotPatches @ 0x1406FBC44
 * Callers:
...
__int64 __fastcall MiApplyRequiredDriverHotPatches(__int64 a1)
{
  ...
  if ( (dword_140E374B4 & 1) == 0 || (*(_DWORD *)(MiGetBaseLoaderPortion(a1) + 184) & 0x2000) != 0 )
    return 0LL;
  ...
  v9 = v2;
  v8 = v3;
  HotPatchRecord = MiFindHotPatchRecord((int)&qword_140E37478, 0, v2, v3, 34404, 0LL, &DestinationString);
  if ( HotPatchRecord >= 0 )
  {
