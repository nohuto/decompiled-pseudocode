/*
 * XREFs of sub_1408F980C @ 0x1408F980C
 * Callers:
...
__int64 __fastcall sub_1408F980C(unsigned int *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  unsigned int v7; // ecx
  __int64 v8; // r9
  size_t v9; // rdx
  ...
  {
    v12 = a1 + 4;
    v13 = sub_140A651B4(*((void **)a1 + 2), v9);
    if ( v13 < 0 )
