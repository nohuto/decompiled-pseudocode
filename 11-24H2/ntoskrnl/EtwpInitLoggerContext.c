/*
 * XREFs of EtwpInitLoggerContext @ 0x1408309D4
 * Callers:
...
LABEL_19:
  *(_QWORD *)(v9 + 1576) = -1LL;
  *(_DWORD *)(v9 + 320) = 1;
  v13 = (unsigned __int64)(MmGetNumberOfPhysicalPages(0) << 12) >> 20;
  ...
  UsedProcessorCount = EtwpQueryUsedProcessorCount(v9, v12);
