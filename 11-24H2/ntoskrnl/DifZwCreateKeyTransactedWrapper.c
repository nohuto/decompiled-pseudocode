/*
 * XREFs of DifZwCreateKeyTransactedWrapper @ 0x14063DCB0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG *Disposition)
{
  ...
  ULONG v28; // [rsp+60h] [rbp-21h]
  UNICODE_STRING *v29; // [rsp+68h] [rbp-19h]
  ULONG v30; // [rsp+70h] [rbp-11h]
  OBJECT_ATTRIBUTES *v31; // [rsp+78h] [rbp-9h]
  ACCESS_MASK v32; // [rsp+80h] [rbp-1h]
  HANDLE *v33; // [rsp+88h] [rbp+7h]
