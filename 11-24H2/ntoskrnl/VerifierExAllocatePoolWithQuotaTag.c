/*
 * XREFs of VerifierExAllocatePoolWithQuotaTag @ 0x140B91520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierExAllocatePoolWithQuotaTag(POOL_TYPE PoolType, SIZE_T a2, ULONG a3)
{
  ...
  if ( (PoolType & 8) == 0 )
    v3 = PoolType;
  if ( VfExAllocPoolInternal == (__int64 (__fastcall *)(__int64, __int64, __int64, __int64))pXdvExAllocatePoolWithQuotaTag[0]
  ...
  {
    result = guard_dispatch_icall_no_overrides(v3 | 0x80u, 0LL, a2, a3);
  }
  if ( !result && !v4 )
