/*
 * XREFs of _CmDeleteInstallerClass @ 0x140818A18
 * Callers:
...
__int64 __fastcall CmDeleteInstallerClass(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v6; // rdi
  int v7; // eax
  unsigned int v8; // eax
  ...
  if ( v6 )
  {
    v7 = guard_dispatch_icall_no_overrides(a1, a2, 2LL, 3LL);
    if ( v7 == -1073741822 )
    {
      v6 = 0LL;
    }
  ...
  v8 = CmDeleteInstallerClassWorker(a1, a2, v15);
  v9 = v8;
  if ( !v6 )
    return v9;
  v14[0] = v8;
  v10 = guard_dispatch_icall_no_overrides(a1, a2, 2LL, 3LL);
  v11 = v10;
  if ( v10 == -1073741822 )
    return v9;
  if ( v10 == -1073741536 )
