/*
 * XREFs of SymCryptScsTableLoad128Xmm @ 0x140536BB4
 * Callers:
...
__m128 *__fastcall SymCryptScsTableLoad128Xmm(__int64 a1, unsigned int a2, __m128 *a3)
{
  ...
  v6 = (__m128)_mm_cmpeq_epi32(v4, (__m128i)0LL);
  v7 = _mm_and_ps(v6, *v3);
  ...
  if ( *(_DWORD *)(a1 + 8) != 1 )
  {
    do
    {
      v17 = (__m128)_mm_cmpeq_epi32(v4, si128);
      si128 = _mm_add_epi32(si128, (__m128i)_xmm);
      v7 = _mm_or_ps(v7, _mm_and_ps(v17, *result));
      v8 = _mm_or_ps(v8, _mm_and_ps(v17, result[1]));
      v9 = _mm_or_ps(v9, _mm_and_ps(v17, result[2]));
      v10 = _mm_or_ps(v10, _mm_and_ps(v17, result[3]));
      v11 = _mm_or_ps(v11, _mm_and_ps(v17, result[4]));
      v12 = _mm_or_ps(v12, _mm_and_ps(v17, result[5]));
      v18 = _mm_and_ps(v17, result[6]);
      v19 = _mm_and_ps(v17, result[7]);
      v13 = _mm_or_ps(v13, v18);
      result += 8;
      v14 = _mm_or_ps(v14, v19);
      --v16;
    }
    while ( v16 );
  }
