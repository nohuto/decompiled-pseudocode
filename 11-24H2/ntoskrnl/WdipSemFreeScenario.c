/*
 * XREFs of WdipSemFreeScenario @ 0x1407A2890
 * Callers:
 *     WdipSemAddScenarioToTable @ 0x1407A0D00 (WdipSemAddScenarioToTable.c)
...
PSLIST_ENTRY __fastcall WdipSemFreeScenario(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    {
      v3 = *(struct _SLIST_ENTRY **)(a1 + 8 * i + 56);
      if ( v3 )
      {
    ...
    *(_DWORD *)(a1 + 48) = 0;
    ...
    {
      v5 = *(struct _SLIST_ENTRY **)(a1 + 8 * j + 1048);
      if ( v5 )
      {
