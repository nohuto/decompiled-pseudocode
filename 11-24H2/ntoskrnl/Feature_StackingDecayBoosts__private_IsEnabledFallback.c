/*
 * XREFs of Feature_StackingDecayBoosts__private_IsEnabledFallback @ 0x1405C2740
 * Callers:
...
__int64 __fastcall Feature_StackingDecayBoosts__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
