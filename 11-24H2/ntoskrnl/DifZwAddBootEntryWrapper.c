/*
 * XREFs of DifZwAddBootEntryWrapper @ 0x1406399C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddBootEntryWrapper(PBOOT_ENTRY BootEntry, PULONG Id)
{
  ...
  DWORD2(v16) = ZwAddBootEntry(BootEntry, Id);
  if ( v6 )
  {
