/*
 * XREFs of DifExIsFastResourceHeldExclusiveWrapper @ 0x14061D950
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExIsFastResourceHeldExclusiveWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(460);
  ...
  LOBYTE(v14) = ExIsFastResourceHeldExclusive(BugCheckParameter2);
  if ( v4 )
  {
