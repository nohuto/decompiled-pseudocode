/*
 * XREFs of KiDpcWatchdogCaptureStack @ 0x14043FD44
 * Callers:
...
void __fastcall KiDpcWatchdogCaptureStack(__int64 a1)
{
  ...
  if ( v2 )
  {
    v3 = *(_QWORD *)(a1 + 36528);
    v4 = v3;
    if ( (unsigned int)(*(_DWORD *)(a1 + 14556) - 416) < (unsigned __int64)(v3 - v2) )
      v4 = v2;
    ...
    if ( v5 - 3 <= 0x31 )
    {
      v6 = v5 - 2;
      *(_WORD *)v4 = v6;
      *(_WORD *)(v4 + 2) = *(_WORD *)(a1 + 33772);
      *(_DWORD *)(v4 + 4) = *(_DWORD *)(a1 + 14528);
      *(_QWORD *)(v4 + 8LL * v6 + 8) = v3;
      *(_QWORD *)(a1 + 36528) = v4 + 8 * (v6 + 2LL);
    }
  }
}
