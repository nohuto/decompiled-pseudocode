/*
 * XREFs of DifExInitializeResourceLiteWrapper @ 0x14061D670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExInitializeResourceLiteWrapper(_QWORD *a1)
{
  ...
  LODWORD(v14) = ExInitializeResourceLite2(a1, -1);
  if ( v4 )
  {
