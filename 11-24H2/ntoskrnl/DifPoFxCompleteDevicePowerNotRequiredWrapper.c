/*
 * XREFs of DifPoFxCompleteDevicePowerNotRequiredWrapper @ 0x140635540
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxCompleteDevicePowerNotRequiredWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(192);
  ...
  PoFxCompleteDevicePowerNotRequired(BugCheckParameter2);
  if ( v4 )
  {
