        ...
        char a10)
{
  ...
  _BYTE v26[4]; // [rsp+48h] [rbp-61h] BYREF
  int v27; // [rsp+4Ch] [rbp-5Dh] BYREF
  _DWORD v28[4]; // [rsp+50h] [rbp-59h] BYREF
  _BYTE v29[64]; // [rsp+60h] [rbp-49h] BYREF
  ...
  if ( PpmEventPerfCheckData && PpmEtwRegistered )
  {
    ...
    {
      v24 = KeCountSetBitsAffinityEx(a2);
      UserData->Ptr = (ULONGLONG)&v30;
      *(_QWORD *)&UserData->Size = 1LL;
      v25 = 1;
      PpmEventAddAffinityMaskAsSubset(0LL, a2, (__int64)v26, (__int64)v29, (__int64)UserData, v28, &v27, &v25);
      v14 = v25;
      v15 = 2LL * v25;
