/*
 * XREFs of MiInvalidatePageFileBitmapsCache @ 0x140367598
 * Callers:
...
LABEL_14:
    ...
    if ( v14 == a2 || (v20 = a2 + a3, v21 = v14 + *v15, a2 + a3 == v21) )
    {
      ...
      *v15 = v16;
      ...
      if ( !v16 )
      {
        RtlRbRemoveNode((unsigned __int64 *)(a1 + 112), (unsigned __int64 *)a4);
        RtlRbRemoveNode((unsigned __int64 *)(a1 + 128), (unsigned __int64 *)(a4 + 24));
        v18 = a1 + 144;
        v19 = *(_QWORD **)(v18 + 8);
        if ( *v19 == v18 )
        {
          ...
          if ( *(_QWORD *)(*(_QWORD *)v23 + 8LL) == v23 )
          {
            ...
            *v15 = v25;
            ...
            if ( v28 )
            {
              while ( 1 )
              {
                if ( *(_QWORD *)(v23 + 48) >= *(_QWORD *)(v28 + 48) )
                {
                  v30 = *(_QWORD *)(v28 + 8);
                  if ( (*(_BYTE *)(a1 + 120) & 1) != 0 )
                  {
...
LABEL_59:
            ...
            RtlRbInsertNodeEx(v27, v28, v29, v23);
            v31 = (__int64 *)(a1 + 128);
            v32 = *(_QWORD *)(a1 + 128);
            ...
            if ( v32 )
            {
              while ( 1 )
              {
                if ( *(_DWORD *)(v23 + 48) < *(_DWORD *)(v32 + 24) )
                {
                  v33 = *(_QWORD *)v32;
                  if ( (*(_BYTE *)(a1 + 136) & 1) != 0 )
                  {
...
LABEL_41:
            ...
            RtlRbInsertNodeEx(v31, v32, v5, v23 + 24);
            return;
          }
        }
LABEL_20:
