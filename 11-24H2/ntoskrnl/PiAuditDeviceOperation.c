/*
 * XREFs of PiAuditDeviceOperation @ 0x140A6F4C0
 * Callers:
...
__int64 __fastcall PiAuditDeviceOperation(__int64 a1, int a2, char a3)
{
  ...
  *((_QWORD *)&v47 + 1) = v14;
  v36 = 512;
  v17 = (const wchar_t *)ExAllocatePool2(0x100uLL);
  v18 = (wchar_t *)v17;
  if ( v17 )
  {
    while ( 1 )
    ...
    *((_QWORD *)&v46 + 1) = v18;
    while ( 1 )
    {
      v21 = (const wchar_t *)ExAllocatePool2(0x100uLL);
      v4 = (wchar_t *)v21;
      if ( !v21 )
        break;
      ...
      if ( v22 != -1073741789 )
      {
        ...
        *((_QWORD *)&v45 + 1) = v4;
        ...
        while ( 1 )
        {
          v25 = (const wchar_t *)ExAllocatePool2(0x100uLL);
          v26 = (wchar_t *)v25;
          if ( !v25 )
            goto LABEL_66;
          ...
          if ( v27 != -1073741789 )
          {
            ...
            v38 = 32;
            v28 = (const wchar_t *)ExAllocatePool2(0x100uLL);
            v29 = (wchar_t *)v28;
            if ( v28 )
            {
                          ...
                          0) )
              {
                ...
                v31 = (const wchar_t *)ExAllocatePool2(0x100uLL);
                v29 = (wchar_t *)v31;
                if ( !v31 )
                  goto LABEL_73;
              }
