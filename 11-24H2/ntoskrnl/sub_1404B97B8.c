/*
 * XREFs of sub_1404B97B8 @ 0x1404B97B8
 * Callers:
...
__int64 __fastcall sub_1404B97B8(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  unsigned int *v4; // r8
  void *v5; // r12
  _DWORD *v8; // r9
  ...
  if ( qword_140FD73F8 )
  {
    ...
    if ( !v22 )
      v23 = v5;
    v24 = guard_dispatch_icall_no_overrides(v23, (unsigned int)v20, &v52, v8);
  }
  else
  {
    v24 = -1073741637;
