/*
 * XREFs of CmpLoadSystemVersionData @ 0x1407D7168
 * Callers:
...
NTSTATUS CmpLoadSystemVersionData()
{
  ...
  v1 = 0;
  v12 = 0;
  result = ZwOpenKey(&KeyHandle, 0x20019u, (POBJECT_ATTRIBUTES)&stru_14000BBB0);
  if ( result >= 0 )
  {
    ...
    if ( LayerVersions >= 0 )
    {
      CmpLoadLayerVersions(P, &v12, v5, KeyHandle, (UNICODE_STRING *)&CmpServicingLayersString, 64);
