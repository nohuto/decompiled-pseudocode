/*
 * XREFs of SepRmCapUpdateWrkr @ 0x140796050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall SepRmCapUpdateWrkr(__int64 a1, __int64 a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    v12 = v11;
    if ( v7 )
      ExfAcquirePushLockExclusiveEx(&SepRmCapTableLock, (__int64)v11, (__int64)&SepRmCapTableLock);
    if ( v12 )
      *((_BYTE *)v12 + 10) = 1;
    SepRmEnforceCap = 1;
  ...
  else
  {
    ...
    v8 = v6;
    if ( v7 )
      ExfAcquirePushLockExclusiveEx(&SepRmCapTableLock, (__int64)v6, (__int64)&SepRmCapTableLock);
    if ( v8 )
      *((_BYTE *)v8 + 10) = 1;
