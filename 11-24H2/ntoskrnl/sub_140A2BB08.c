/*
 * XREFs of sub_140A2BB08 @ 0x140A2BB08
 * Callers:
...
__int64 __fastcall sub_140A2BB08(
        int a1,
        char *a2,
        char *a3,
        unsigned int a4,
        ...
        _BYTE *a9)
{
  ...
  v18 = *a5;
  if ( a1 )
    sub_140407E30((__int64)&v19, a2, a3, a4, v18, a6, a9);
  else
    sub_1404081B0((__int64)&v19, a2, a3, a4, v18, a6, a9);
  return 0LL;
}
