/*
 * XREFs of DifPsSetLoadImageNotifyRoutineWrapper @ 0x140638F20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsSetLoadImageNotifyRoutine @ 0x14077A300 (PsSetLoadImageNotifyRoutine.c)
 */
...
__int64 __fastcall DifPsSetLoadImageNotifyRoutineWrapper(PLOAD_IMAGE_NOTIFY_ROUTINE NotifyRoutine)
{
  ...
  LODWORD(v18) = PsSetLoadImageNotifyRoutine(NotifyRoutine);
  if ( v6 )
  {
