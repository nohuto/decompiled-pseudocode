/*
 * XREFs of DifPsSetLoadImageNotifyRoutineWrapper @ 0x1406374E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsSetLoadImageNotifyRoutine @ 0x14077A400 (PsSetLoadImageNotifyRoutine.c)
 */
...
__int64 __fastcall DifPsSetLoadImageNotifyRoutineWrapper(PLOAD_IMAGE_NOTIFY_ROUTINE NotifyRoutine)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(171);
  ...
  LODWORD(v14) = PsSetLoadImageNotifyRoutine(NotifyRoutine);
  if ( v4 )
  {
