/*
 * XREFs of EtwTimLogControlProtectionKernelModeReturnMismatch @ 0x14064FA08
 * Callers:
  ...
  if ( a1 == 1 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    if ( v19 )
      ...
      v12 = 0LL;
    v29 = v12;
    if ( (unsigned int)Feature_4015215930__private_IsEnabledDeviceUsageNoInline() )
      v20 = 0LL;
    v49 = &v20;
    v50 = 8LL;
    v51 = &v29;
    ...
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140E09128, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v74 = v14;
        v66 = &v27;
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_140053549,
                       0LL,
                       0LL,
                       0xEu,
                       &v65);
