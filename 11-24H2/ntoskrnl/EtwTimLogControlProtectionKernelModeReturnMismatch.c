/*
 * XREFs of EtwTimLogControlProtectionKernelModeReturnMismatch @ 0x14064E0B4
 * Callers:
...
char __fastcall EtwTimLogControlProtectionKernelModeReturnMismatch(int a1, __int64 a2)
{
  ...
  if ( a1 == 1 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140E09198, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v74 = v14;
        v66 = &v27;
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)&dword_140053DFC,
                       0LL,
                       0LL,
                       0xEu,
                       &v65);
