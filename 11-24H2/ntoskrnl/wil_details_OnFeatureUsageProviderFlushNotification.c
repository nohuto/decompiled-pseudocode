/*
 * XREFs of wil_details_OnFeatureUsageProviderFlushNotification @ 0x1407D60B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall wil_details_OnFeatureUsageProviderFlushNotification(int a1)
{
  ...
  {
    for ( i = (__int64 (__fastcall **)())&wil_details_featureDescriptors_a; ; i = v3 + 7 )
    {
      ...
      if ( !v2 )
        break;
      if ( (*(_DWORD *)v2[1] & 1) != 0 )
        wil_details_RecordCachedUsage(*((_DWORD *)v2 + 6), (__int64)v2[1]);
    }
  }
}
