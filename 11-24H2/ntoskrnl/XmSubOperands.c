/*
 * XREFs of XmSubOperands @ 0x140468260
 * Callers:
 *     XmSubOp @ 0x140468220 (XmSubOp.c)
 *     XmDecOp @ 0x140468240 (XmDecOp.c)
 *     XmCmpxchgOp @ 0x1405759C0 (XmCmpxchgOp.c)
 *     XmNegOp @ 0x140575A30 (XmNegOp.c)
 *     XmSbbOp @ 0x140575A60 (XmSbbOp.c)
 * Callees:
