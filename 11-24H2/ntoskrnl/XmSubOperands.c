/*
 * XREFs of XmSubOperands @ 0x140460C10
 * Callers:
 *     XmSubOp @ 0x140460BD0 (XmSubOp.c)
 *     XmDecOp @ 0x140460BF0 (XmDecOp.c)
 *     XmCmpxchgOp @ 0x140572E50 (XmCmpxchgOp.c)
 *     XmNegOp @ 0x140572EC0 (XmNegOp.c)
 *     XmSbbOp @ 0x140572EF0 (XmSbbOp.c)
 * Callees:
