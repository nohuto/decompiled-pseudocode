/*
 * XREFs of HalpIumSetVariable @ 0x14055F5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpIumSetVariable(_WORD *Src, __int128 *a2, int a3, size_t a4, void *Srca)
{
  ...
  if ( !qword_140FC11F0 || KeGetCurrentIrql() > 2u )
  ...
  Pool2 = ExAllocatePool2(0x40uLL, (v10 + a4 + 4151) & 0xFFFFFFFFFFFFF000uLL, 0x77466B53u);
  v13 = (_QWORD *)Pool2;
  if ( !Pool2 )
