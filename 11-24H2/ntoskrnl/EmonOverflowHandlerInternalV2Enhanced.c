/*
 * XREFs of EmonOverflowHandlerInternalV2Enhanced @ 0x14055CA90
 * Callers:
 *     EmonOverflowHandlerEnhanced @ 0x14055C1D0 (EmonOverflowHandlerEnhanced.c)
 * Callees:
...
unsigned __int64 __fastcall EmonOverflowHandlerInternalV2Enhanced(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned __int64 a4)
{
  ...
  while ( !v11 )
  {
    ...
    if ( *(_DWORD *)(v17 + 24) )
      goto LABEL_59;
    LODWORD(v18) = 0;
    if ( (unsigned int)v12 > *(_DWORD *)(v14 + 8) || *(_DWORD *)(v17 + 28) == 3 )
      goto LABEL_59;
    v19 = *(_DWORD *)v14;
    v20 = 0LL;
    v41 = 0LL;
...
LABEL_28:
    ...
    if ( v27 )
    {
      LODWORD(v18) = *(_DWORD *)(v26 + HalpProfileData + 16);
        ...
        if ( v43 == *(_QWORD *)(v26 + v25 + 8) )
        {
          ...
          if ( v35.QuadPart != *(_QWORD *)(v26 + HalpProfileData) )
          {
            ...
            if ( v18 - 4096 > 0x7FFFEFFF )
              LODWORD(v18) = *(_DWORD *)(v26 + HalpProfileData + 28);
            *(_DWORD *)(v26 + HalpProfileData + 16) = v18;
            *(LARGE_INTEGER *)(v26 + v36) = v35;
          }
          *(_DWORD *)(v28 + v25 + 40) = v18;
...
LABEL_40:
    if ( *(_DWORD *)v14 )
    {
      if ( *(_DWORD *)v14 == 1 )
      {
        if ( (unsigned int)EmonFixedCounterResolution < 0x40 )
          ...
          v33 = -1LL;
        __writemsr(v12 + 777, v33 & -(__int64)(unsigned int)v18);
    ...
    else
    {
      if ( (unsigned int)EmonCounterResolution < 0x40 )
        ...
        v39 = -1LL;
      __writemsr(v12 + 193, v39 & -(__int64)(unsigned int)v18);
      v37 = v42;
      __writemsr(v12 + 390, v42 | 0x500000);
    }
    EmonIsModifiedByBadActorInternalEnhanced(v12, (int *)v14, v37, &v49);
    if ( (_BYTE)v49 )
      *(_BYTE *)(v20 + 40) = 1;
LABEL_59:
    v11 = !_BitScanForward64((unsigned __int64 *)&v12, v6);
