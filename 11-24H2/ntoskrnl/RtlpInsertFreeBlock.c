/*
 * XREFs of RtlpInsertFreeBlock @ 0x1405EA8C0
 * Callers:
...
void __fastcall RtlpInsertFreeBlock(__int64 a1, ULONG_PTR a2, _QWORD *Entry)
{
  ULONG_PTR v3; // rbx
    ...
    while ( v4 )
    {
      ...
      *(_WORD *)(v3 + 12) = *(_WORD *)(a1 + 140) ^ v5;
      ...
      else
      {
        ...
        if ( v13 >= 0xFE )
        {
          RtlpLogHeapFailure(3, v12, v3, v8, 0LL, 0LL);
          v11 = *(_BYTE *)(v3 + 10);
        }
      }
      *(_BYTE *)(v3 + 14) = v13;
      ...
      *(_BYTE *)(v3 + 15) = 0;
      ...
      v16 = (_QWORD **)(a1 + 336);
      if ( *(_QWORD *)(a1 + 312) )
        Entry = (_QWORD *)RtlpFindEntry(a1, v10);
      else
        Entry = *v16;
      if ( v16 != Entry )
      {
      ...
      {
        RtlpLogHeapFailure(13, 0LL, (ULONG_PTR)Entry, 0LL, *v20, 0LL);
      }
...
LABEL_49:
    ...
    *(_WORD *)(v3 + 12) = *(_WORD *)(a1 + 140) ^ v5;
    if ( !(_WORD)v5 && RtlpHeapErrorHandlerThreshold >= 1 && ((v3 + 4095) & 0xFFFFFFFFFFFFF000uLL) != v3 )
    {
