/*
 * XREFs of DifRtlUpcaseUnicodeStringWrapper @ 0x14063AEC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlUpcaseUnicodeStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlUpcaseUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
