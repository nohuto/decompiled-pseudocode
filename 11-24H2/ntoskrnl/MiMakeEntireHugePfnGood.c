/*
 * XREFs of MiMakeEntireHugePfnGood @ 0x140670DEC
 * Callers:
...
_QWORD *__fastcall MiMakeEntireHugePfnGood(int a1)
{
  ...
  *((_QWORD *)&v9 + 1) = v6[4];
  *(_QWORD *)&v9 = 0x40000LL;
  qword_140E2FF28 -= RtlNumberOfSetBitsEx((__int64 *)&v9);
  RtlAvlRemoveNode((unsigned __int64 *)&qword_140E2FF20, (__int64)v6);
