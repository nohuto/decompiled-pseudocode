/*
 * XREFs of ViMiscEnforceRule @ 0x140B9F480
 * Callers:
 *     VfMiscMmAllocateContiguousMemoryEx_Entry @ 0x140B9E0A0 (VfMiscMmAllocateContiguousMemoryEx_Entry.c)
 *     VfMiscMmAllocateContiguousMemory_Entry @ 0x140B9E0D0 (VfMiscMmAllocateContiguousMemory_Entry.c)
 * Callees:
