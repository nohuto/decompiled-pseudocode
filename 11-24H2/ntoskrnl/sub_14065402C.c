/*
 * XREFs of sub_14065402C @ 0x14065402C
 * Callers:
...
__int64 __fastcall sub_14065402C(__int64 a1)
{
  ...
  v3 = 0LL;
  Pool2 = (_DWORD *)ExAllocatePool2(0x100uLL, 0x14008uLL, 0x69534C53u);
  if ( Pool2 && (v6 = (_DWORD *)ExAllocatePool2(0x100uLL, 0xB7C0uLL, 0x69534C53u), (v3 = v6) != 0LL) )
  {
    Pool2[20481] = 0;
