/*
 * XREFs of DifPoFxRegisterDeviceWrapper @ 0x140635E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifPoFxRegisterDeviceWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(186);
  ...
  LODWORD(v19) = PoFxRegisterDevice(a1, a2, a3);
  if ( v8 )
  {
