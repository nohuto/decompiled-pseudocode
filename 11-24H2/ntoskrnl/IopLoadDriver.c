/*
 * XREFs of IopLoadDriver @ 0x1409C90C0
 * Callers:
...
LABEL_15:
      ...
      v21 = RtlImageNtHeader((unsigned __int64)v57);
      v7 = *(unsigned __int16 *)(v21 + 70) | (*(unsigned __int16 *)(v21 + 68) << 16);
      DriverNameFromKeyNode = PnpPrepareDriverLoading((int)&v53, Handle, (unsigned __int64)v57, v8, &v51, (bool *)&v46);
      if ( DriverNameFromKeyNode < 0
...
LABEL_69:
      ...
      ReturnLength[0] = v24;
      *(_DWORD *)v22 = 22020100;
      v27 = RtlImageNtHeader((unsigned __int64)v26);
      v28 = (char *)v25 + *(unsigned int *)(v27 + 40);
      ...
      *((_DWORD *)v22 + 8) = *(_DWORD *)(v27 + 80);
      DriverNameFromKeyNode = ObInsertObjectEx((struct _FILE_OBJECT *)v22, 0LL, 1, 0, 0, 0LL, (__int64)&Handlea);
      ExReleaseResourceLite(&IopDriverLoadResource);
      if ( DriverNameFromKeyNode < 0 )
        goto LABEL_69;
      ...
      if ( v33 )
      {
        ...
        else
        {
          ...
          if ( v53.Buffer )
          {
            ...
            *(_QWORD *)(v31[6] + 32LL) = ExAllocatePool2(0x40uLL);
            v40 = v31[6];
            if ( *(_QWORD *)(v40 + 32) )
            {
              *(_WORD *)(v40 + 26) = MaximumLength;
              *(_WORD *)(v31[6] + 24LL) = v53.Length;
          ...
          DriverNameFromKeyNode = PnpCallDriverEntry((__int64)v31, (__int64)v33);
          if ( DriverNameFromKeyNode >= 0 )
          {
