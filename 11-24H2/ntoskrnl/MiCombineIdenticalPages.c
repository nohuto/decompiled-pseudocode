/*
 * XREFs of MiCombineIdenticalPages @ 0x140A9C0E0
 * Callers:
...
LABEL_30:
    ...
    if ( (a3 & 1) == 0 || (ULONG *)a1 == &MiSystemPartition )
    {
      ...
      v24[0] = 0;
      v24[1] = -1;
      v25[0] = qword_140E37368;
      v25[1] = qword_140E373A0;
      v31 = v25;
      v32 = v24;
      v28[1] = v23;
      v29[11] = &v37;
      ...
      do
      {
        ...
        if ( (unsigned int)(v13 + 1) < 2 )
          v14 = 2;
        v36 = v14;
        v13 = _InterlockedCompareExchange(&dword_140E2FE1C, v14, v13);
      }
      while ( v13 != v15 );
      MiInitializePageColorBase(
        ...
        0,
        (__int64)&v26);
      if ( (unsigned int)MiCreateUltraThreadContext((__int64)v35, (__int64)&v26, 8, 0) )
      {
        if ( (a3 & 2) != 0 )
        {
