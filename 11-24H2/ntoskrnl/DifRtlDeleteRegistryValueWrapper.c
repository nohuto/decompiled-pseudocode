/*
 * XREFs of DifRtlDeleteRegistryValueWrapper @ 0x140639930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlDeleteRegistryValueWrapper(ULONG RelativeTo, PCWSTR Path, PCWSTR ValueName)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    DWORD2(v22) = RelativeTo;
    *(_QWORD *)&v22 = Path;
    *((_QWORD *)&v21 + 1) = ValueName;
  ...
  HIDWORD(v22) = RtlDeleteRegistryValue(RelativeTo, Path, ValueName);
  if ( v10 )
  {
