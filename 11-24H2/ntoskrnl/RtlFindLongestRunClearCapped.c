/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x140366278
 * Callers:
  ...
  for ( i = 0; ; i = v39 + 1 )
  {
    ...
    if ( v17 )
    {
      ...
      if ( v14 != v11 )
        v10 = v33;
      v14 = 8 * v12 - v13 + 8;
      v22 = *((_BYTE *)qword_140012BC0 - v13) | byte_14002B770[*((unsigned __int8 *)RtlpBitsClearLow + v17)];
      while ( 1 )
      {
        v17 |= v22;
        if ( v17 == 0xFF )
