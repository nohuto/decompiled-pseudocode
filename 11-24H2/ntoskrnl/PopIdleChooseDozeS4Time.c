/*
 * XREFs of PopIdleChooseDozeS4Time @ 0x1405D56AC
 * Callers:
...
char __fastcall PopIdleChooseDozeS4Time(unsigned __int64 *a1, int *a2)
{
  ...
  else if ( qword_140F0B8B8 > MEMORY[0xFFFFF78000000014] && PopSmartUserPresenceAction == 1 )
  {
    if ( MEMORY[0xFFFFF78000000008] - qword_140F0B8E8 <= 10000000
                                                       * (unsigned __int64)(unsigned int)PopSmartUserPresenceGracePeriod )
      v3 = 10000000LL * (unsigned int)PopSmartUserPresenceGracePeriod - (MEMORY[0xFFFFF78000000008] - qword_140F0B8E8);
    if ( (__int64)(v3 + MEMORY[0xFFFFF78000000014]) >= qword_140F0B8B8
...
LABEL_16:
  ...
  {
    v4 = 1;
    v3 = -10000000LL * *((unsigned int *)PopPolicy + 22);
    v5 = 1;
  }
  *a1 = v3;
  if ( a2 )
