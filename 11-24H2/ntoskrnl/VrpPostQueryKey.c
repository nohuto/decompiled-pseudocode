/*
 * XREFs of VrpPostQueryKey @ 0x140927F20
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E0A5B0 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)word_140058C82,
      &ActivityId,
      0LL,
      5u,
      &UserData);
...
LABEL_33:
      if ( (unsigned int)dword_140E0A5B0 > 2 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E0A5B0,
          (unsigned __int8 *)word_140058C02,
          &ActivityId,
          0LL,
          5u,
          &UserData);
  ...
  *(_DWORD *)(a1 + 24) = v6;
  ...
  if ( (unsigned int)dword_140E0A5B0 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EtwWriteTransfer(qword_140E0A5D0, &EventDescriptor, &ActivityId, 0LL, 6u, &UserData);
    v3 = v27;
    v7 = v28;
  }
LABEL_5:
