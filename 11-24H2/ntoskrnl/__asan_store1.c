/*
 * XREFs of __asan_store1 @ 0x1405A9570
 * Callers:
 *     <none>
 * Callees:
...
signed __int8 __fastcall _asan_store1(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ...
  if ( byte_140FCECAA )
  {
    ...
    if ( BugCheckParameter1 >= 0xFFFF800000000000uLL )
    {
      ...
      if ( KcsaniValidationEnabled )
        return KcsanValidateAddress(BugCheckParameter1, 1, 1, 0, v1);
    }
  }
  return result;
}
