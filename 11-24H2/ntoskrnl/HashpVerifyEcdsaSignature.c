/*
 * XREFs of HashpVerifyEcdsaSignature @ 0x14082FC54
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( !v15 )
  {
    v16 = SymCryptEcurveAllocate((__int64)v13, 0);
    if ( !v16 )
  ...
  if ( !v17 )
    return (unsigned int)-1073741801;
  if ( (unsigned int)SymCryptEckeySetValue(0LL, 0LL, a2, v8, 2u, 2, 4352, v17) )
  {
    v12 = -1073740760;
  }
  else
