/*
 * XREFs of PopEtEnergyTrackerQuery @ 0x140AC9770
 * Callers:
 ...
 *     PopEtDataSectionReserve @ 0x140A5B5AC (PopEtDataSectionReserve.c)
 *     PopEtDataSectionStart @ 0x140A6DAD8 (PopEtDataSectionStart.c)
 */
