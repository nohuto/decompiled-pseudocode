/*
 * XREFs of Feature_PerProcessorClockTickServer__private_IsEnabledPreCheck @ 0x1405B6484
 * Callers:
...
__int64 Feature_PerProcessorClockTickServer__private_IsEnabledPreCheck()
{
  unsigned __int8 v1; // [rsp+30h] [rbp+8h]

  if ( (Feature_PerProcessorClockTickServer__private_featureState & 0x10) == 0 )
  {
    v1 = Feature_PerProcessorClockTickServer__private_featureState | 1;
