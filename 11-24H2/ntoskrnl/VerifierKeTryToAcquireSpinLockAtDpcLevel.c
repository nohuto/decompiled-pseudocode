/*
 * XREFs of VerifierKeTryToAcquireSpinLockAtDpcLevel @ 0x140B95C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierKeTryToAcquireSpinLockAtDpcLevel(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v5; // r8
  unsigned int v6; // edx
