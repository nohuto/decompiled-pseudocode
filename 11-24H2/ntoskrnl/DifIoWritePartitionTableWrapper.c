/*
 * XREFs of DifIoWritePartitionTableWrapper @ 0x14062A100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoWritePartitionTableWrapper(
        ...
        struct _DRIVE_LAYOUT_INFORMATION *PartitionBuffer)
{
  ...
  DWORD2(v21) = IoWritePartitionTable(a1, a2, a3, a4, PartitionBuffer);
  if ( v10 )
  {
