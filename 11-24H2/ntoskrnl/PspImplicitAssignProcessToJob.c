/*
 * XREFs of PspImplicitAssignProcessToJob @ 0x1408E7184
 * Callers:
...
__int64 __fastcall PspImplicitAssignProcessToJob(_DWORD *Object, unsigned __int64 a2, unsigned int a3)
{
...
LABEL_10:
  ...
  if ( v9 < 0 )
    goto LABEL_10;
  v9 = PspEstablishJobHierarchy((char *)EffectiveServerSilo, a2, 0LL, 1);
  if ( v9 < 0 )
    goto LABEL_10;
