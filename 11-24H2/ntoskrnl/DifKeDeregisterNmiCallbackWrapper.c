/*
 * XREFs of DifKeDeregisterNmiCallbackWrapper @ 0x14062B830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeDeregisterNmiCallbackWrapper(void *a1)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(287);
  ...
  LODWORD(v14) = KiDeregisterNmiSxCallback(a1);
  if ( v4 )
  {
