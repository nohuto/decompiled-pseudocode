/*
 * XREFs of DifRtlOemStringToCountedUnicodeStringWrapper @ 0x140639DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlOemStringToCountedUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
