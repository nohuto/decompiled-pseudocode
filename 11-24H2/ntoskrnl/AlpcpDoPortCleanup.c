/*
 * XREFs of AlpcpDoPortCleanup @ 0x14088B7F4
 * Callers:
...
__int64 __fastcall AlpcpDoPortCleanup(__int64 a1)
{
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 352), 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 352), (__int64)v3, a1 + 352);
  if ( v4 )
    *((_BYTE *)v4 + 10) = 1;
  if ( *(_QWORD *)(a1 + 360) )
  ...
  *(_DWORD *)(a1 + 416) |= 0x40u;
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)v2, 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 352), (__int64)v7, a1 + 352);
  if ( v8 )
    *((_BYTE *)v8 + 10) = 1;
