/*
 * XREFs of ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x140AA9460
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall TlgAggregateInternalProviderCallback(const struct _GUID *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 == 2 && a4 == 32 )
  {
    v4 = KeAbPreAcquire((__int64)&qword_140EEFBF0, 0LL);
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140EEFBF0, 0LL) )
    {
      if ( v4 )
        KeAbPostReleaseEx((ULONG_PTR)&qword_140EEFBF0, (ULONG_PTR)v4);
    }
    else
    {
      if ( v4 )
        *((_BYTE *)v4 + 10) = 1;
      for ( i = qword_140EEFBE8; i; i = *(_QWORD *)(i + 352) )
