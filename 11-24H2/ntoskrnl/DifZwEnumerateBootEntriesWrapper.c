/*
 * XREFs of DifZwEnumerateBootEntriesWrapper @ 0x14063F700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateBootEntriesWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v20) = ZwEnumerateBootEntries(a1, a2);
  if ( v8 )
  {
