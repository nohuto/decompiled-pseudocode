/*
 * XREFs of DifIoOpenDeviceInterfaceRegistryKeyWrapper @ 0x140627E80
 * Callers:
 *     <none>
 * Callees:
        ...
        PHANDLE DeviceInterfaceRegKey)
{
  ...
  LODWORD(v19) = IoOpenDeviceInterfaceRegistryKey(SymbolicLinkName, DesiredAccess, DeviceInterfaceRegKey);
  if ( v8 )
  {
