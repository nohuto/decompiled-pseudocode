/*
 * XREFs of DifIoOpenDeviceInterfaceRegistryKeyWrapper @ 0x1406298C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PHANDLE DeviceInterfaceRegKey)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = SymbolicLinkName;
    LODWORD(v22) = DesiredAccess;
    *((_QWORD *)&v21 + 1) = DeviceInterfaceRegKey;
  ...
  LODWORD(v23) = IoOpenDeviceInterfaceRegistryKey(SymbolicLinkName, DesiredAccess, DeviceInterfaceRegKey);
  if ( v10 )
  {
