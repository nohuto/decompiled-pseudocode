/*
 * XREFs of WbCreateHeapExecutedBlock @ 0x1408FDAD8
 * Callers:
...
__int64 __fastcall WbCreateHeapExecutedBlock(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v41 = 0;
  v42 = 0;
  v50 = (unsigned int)dword_140E3E970;
  v4 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    *(_QWORD *)(v8 + 80) = 1LL;
    ...
    if ( v10 == 1 )
    {
      v4 = sub_1408FABDC((UCHAR *)(a2 + 16), 0xF8u);
      if ( v4 < 0 )
        goto LABEL_45;
    ...
    else
    {
      ...
      v4 = sub_1408FABDC((UCHAR *)(a2 + 16), 0xF0u);
      if ( v4 < 0 )
        goto LABEL_45;
    ...
    v39 = 1;
    v4 = sub_1409E0E44(*(PVOID *)(a2 + 328));
    if ( v4 >= 0 )
    {
      v4 = sub_1409E0444(v47, *(unsigned int *)(a2 + 320), &v46, &v45);
      if ( v4 >= 0 )
      {
        v12 = 0LL;
        v4 = 0;
        if ( *(_DWORD *)(a2 + 320) && (v12 = (void *)ExAllocatePool2(0x100uLL)) == 0LL )
          v4 = -1073741801;
        else
          Src = v12;
        SddlpFree(0LL);
        if ( v4 >= 0 )
        {
          ...
          MmProbeAndLockPagesPrivate((__int64)v14, v15);
          v41 = 1;
          v16 = *(_DWORD *)(a2 + 280);
          v17 = *(_DWORD *)(a2 + 284);
          v18 = (char *)Src + *(unsigned int *)(a2 + 288);
          v52 = &off_140002C10;
          v48 = 0;
          v53 = *(_OWORD *)(a2 + 96);
          v54 = *(_OWORD *)(a2 + 112);
          ...
          v61 = *(_OWORD *)(a2 + 224);
          v62 = *(_OWORD *)(a2 + 240);
          sub_1404081B0((__int64)&v52, v18, v18, v17, *(_QWORD *)(a2 + 88), v16, v36);
          v4 = sub_1409E0E44(*(PVOID *)(a2 + 272));
          if ( v4 >= 0 )
          {
            if ( !*(_QWORD *)(a2 + 296) )
              goto LABEL_37;
            ...
            v20 = IoAllocateMdl(*(PVOID *)(a2 + 296), *(_DWORD *)(a2 + 308), 0, 0, 0LL);
            v44 = v20;
            if ( !v20 )
            {
              v4 = -1073741801;
            ...
            MmProbeAndLockPagesPrivate((__int64)v20, v21);
            v42 = 1;
            v22 = *(_DWORD *)(a2 + 304);
            v23 = *(_DWORD *)(a2 + 308);
            v24 = (char *)Src + *(unsigned int *)(a2 + 312);
            v63 = &off_140002C10;
            v49 = 0;
            v64 = *(_OWORD *)(a2 + 96);
            v65 = *(_OWORD *)(a2 + 112);
            ...
            v72 = *(_OWORD *)(a2 + 224);
            v73 = *(_OWORD *)(a2 + 240);
            sub_1404081B0((__int64)&v63, v24, v24, v23, *(_QWORD *)(a2 + 88), v22, v36);
            v4 = sub_1409E0E44(*(PVOID *)(a2 + 296));
            if ( v4 >= 0 )
            {
LABEL_37:
              v25 = v46;
              ...
              *(_QWORD *)(v38 + 64) = *(_QWORD *)a2;
              ...
              v26[5] = v25;
              v29 = v26 + 3;
              v26[3] = v45 + *(unsigned int *)(a2 + 288);
              v30 = *(unsigned int *)(a2 + 312);
              if ( (_DWORD)v30 )
                v26[4] = v45 + v30;
              else
                v26[4] = 0LL;
              ...
              *(_QWORD *)(v31 + 48) = *(_QWORD *)(a2 + 272);
              v32 = *(_QWORD *)(a2 + 272) - *v29;
              *(_QWORD *)(v31 + 56) = v32;
...
LABEL_40:
                *(_QWORD *)*v28 = v32;
              *(_QWORD *)(*v28 + 8LL) = v50;
              v4 = ZwFlushInstructionCache(-1LL, *v29);
              if ( v4 >= 0 )
              {
