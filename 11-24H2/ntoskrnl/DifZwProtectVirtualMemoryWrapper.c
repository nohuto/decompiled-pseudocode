/*
 * XREFs of DifZwProtectVirtualMemoryWrapper @ 0x140643AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwProtectVirtualMemoryWrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  LODWORD(v25) = ZwProtectVirtualMemory(a1, a2, a3, a4, a5);
  if ( v12 )
  {
