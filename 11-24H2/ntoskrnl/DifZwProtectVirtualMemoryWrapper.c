/*
 * XREFs of DifZwProtectVirtualMemoryWrapper @ 0x140642090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwProtectVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4, ULONG *OldProtect)
{
  ...
  LODWORD(v21) = ZwProtectVirtualMemory(a1, a2, a3, a4, OldProtect);
  if ( v10 )
  {
