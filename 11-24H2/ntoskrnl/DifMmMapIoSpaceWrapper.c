/*
 * XREFs of DifMmMapIoSpaceWrapper @ 0x140633BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        MEMORY_CACHING_TYPE CacheType)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((PHYSICAL_ADDRESS *)&v22 + 1) = PhysicalAddress;
    *(_QWORD *)&v22 = NumberOfBytes;
    DWORD2(v21) = CacheType;
  ...
  v23 = MmMapIoSpace(PhysicalAddress, NumberOfBytes, CacheType);
  if ( v10 )
  {
