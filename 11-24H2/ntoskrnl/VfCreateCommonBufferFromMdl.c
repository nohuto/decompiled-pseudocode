/*
 * XREFs of VfCreateCommonBufferFromMdl @ 0x140B86140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VfCreateCommonBufferFromMdl(int a1, ULONG_PTR a2, ULONG_PTR a3, unsigned int a4)
{
  ...
  v10 = guard_dispatch_icall_no_overrides(RealDmaAdapter, a2, a3, a4);
  if ( v10 == -1073741811 )
  {
    if ( AdapterInformationInternal )
    {
      ViHalPreprocessOptions(
        ...
        a3,
        (const void *)a4);
      VfReportIssueWithOptions(0xE6u, 0x26uLL, a3, a4, a2, byte_140E0E93C);
    }
  }
