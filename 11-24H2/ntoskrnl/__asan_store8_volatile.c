/*
 * XREFs of __asan_store8_volatile @ 0x1405AA0A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store8_volatile(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r9d
  ...
  if ( (BugCheckParameter1 & 7) != 0 )
  {
    ...
    else
    {
      ...
      if ( v5 && v5 < 8 && (char)(((BugCheckParameter1 + 7) & 7) + 1) > v5 )
LABEL_26:
        LOBYTE(v3) = (unsigned __int8)KasaniReport(BugCheckParameter1, 8uLL, 1u, v1, v5);
    }
  }
  else if ( v5 && v5 < 8 )
  {
...
LABEL_27:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 8, 1, v4, v1);
  }
  return v3;
}
