/*
 * XREFs of MiReserveDriverPtes @ 0x140AB636C
 * Callers:
...
unsigned __int64 __fastcall MiReserveDriverPtes(int a1, __int64 a2)
{
    ...
    if ( v10 )
    {
      ...
      *((_DWORD *)Pool + 8) = v15;
      ...
      if ( (unsigned int)MiMakeZeroedPageTables(v16, (int)v17 - 8, 1, 11) )
      {
        ...
        v7 = v16;
        *(_QWORD *)Pool = qword_140E2D860;
        qword_140E2D860 = Pool;
        goto LABEL_16;
      }
      MiReturnSystemVa(v11, (__int64)((PteAddress << 25) + (v22 << 28)) >> 16, 11);
    }
