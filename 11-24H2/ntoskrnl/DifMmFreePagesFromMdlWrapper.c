/*
 * XREFs of DifMmFreePagesFromMdlWrapper @ 0x140631BE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmFreePagesFromMdlWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(224);
  ...
  MiFreePagesFromMdl(BugCheckParameter2, 0, 0, 0);
  if ( v4 )
  {
