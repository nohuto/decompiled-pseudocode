/*
 * XREFs of BgpRasInitializeRasterizer @ 0x140C73474
 * Callers:
...
__int64 __fastcall BgpRasInitializeRasterizer(__int64 a1)
{
  ...
  unsigned __int32 v19; // [rsp+B0h] [rbp+67h] BYREF
  unsigned __int32 v20; // [rsp+B8h] [rbp+6Fh] BYREF
  ...
  v11 = 0LL;
  v12 = 0LL;
  TableOffsetAndSize = FopGetTableOffsetAndSize(v4, v1, 1751474532, (unsigned __int32 *)(a1 + 64), &v20);
  if ( TableOffsetAndSize >= 0 )
  {
    v20 = 0;
    TableOffsetAndSize = FopGetTableOffsetAndSize(v4, v1, 1735162214, (unsigned __int32 *)(a1 + 60), &v20);
    if ( TableOffsetAndSize >= 0 )
    {
      v20 = 0;
      TableOffsetAndSize = FopGetTableOffsetAndSize(v4, v1, 1819239265, (unsigned __int32 *)(a1 + 72), &v20);
      if ( TableOffsetAndSize >= 0 )
      {
        v20 = 0;
        TableOffsetAndSize = FopGetTableOffsetAndSize(v4, v1, 1752003704, (unsigned __int32 *)(a1 + 68), &v20);
        if ( TableOffsetAndSize >= 0 )
        {
          ...
          if ( TableOffsetAndSize >= 0 )
          {
            ...
            *(_WORD *)(a1 + 120) = __ROR2__(WORD1(v15), 8);
            TableOffsetAndSize = FopGetTableOffsetAndSize(v4, v1, 1751672161, &v19, &v20);
            if ( TableOffsetAndSize >= 0 )
            {
              ...
              if ( TableOffsetAndSize >= 0 )
              {
                ...
                *(_DWORD *)(a1 + 96) = 96;
                ...
                {
                  dword_140EF0174 = 0;
                  qword_140EF0148 = (__int64)&RaspBitmapCache;
