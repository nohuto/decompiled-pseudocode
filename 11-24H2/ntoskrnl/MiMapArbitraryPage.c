/*
 * XREFs of MiMapArbitraryPage @ 0x140313BE8
 * Callers:
...
__int64 __fastcall MiMapArbitraryPage(_QWORD *a1, _QWORD *a2, __int64 a3, int a4, int a5)
{
  __int64 v5; // rsi
  ULONG_PTR *v7; // r14
  unsigned int v8; // ebp
  ...
  v7 = (ULONG_PTR *)a2[9];
  v8 = a3;
  v11 = MiSafeLockPage(0xAAAAAAAAAAAAAAABuLL * ((v5 + 0x220000000000LL) >> 4), (__int64)a2, a3);
  if ( v11 != 17 )
  {
