/*
 * XREFs of BapdpRecordIumStatus @ 0x140C41A70
 * Callers:
...
int BapdpRecordIumStatus()
{
  ...
  if ( result >= 0 )
  {
    ...
    v10 = v3 + 2892;
    v11 = 4;
    v4 = (const EVENT_DESCRIPTOR *)BOOT_ENVIRONMENT_VSM_POLICY_ENABLEMENT;
    if ( *(int *)(*(_QWORD *)(KeLoaderBlock_0 + 240) + 2896LL) < 0 )
      v4 = &BOOT_ENVIRONMENT_VSM_POLICY_ENABLEMENT_FAILURE;
