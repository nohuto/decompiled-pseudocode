/*
 * XREFs of PopPowerAggregatorNotifyPdcSleepTransition @ 0x140A9B2F0
 * Callers:
...
__int64 __fastcall PopPowerAggregatorNotifyPdcSleepTransition(char a1, int a2, int a3)
{
  ...
  if ( (_DWORD)xmmword_140F08938 == 4 )
  {
    v7 = 0;
    if ( !a1 )
    {
LABEL_5:
      LOBYTE(xmmword_140F08948) = 0;
      *(_QWORD *)((char *)&xmmword_140F08948 + 4) = 0LL;
      goto LABEL_8;
    }
LABEL_7:
    DWORD2(xmmword_140F08948) = a3;
    v7 = 259;
    DWORD1(xmmword_140F08948) = a2;
...
LABEL_8:
  ...
  PopPowerAggregatorDiagTracePdcSleepTransition(
    v6,
    a2,
    (unsigned int)&xmmword_140F08910,
    (unsigned int)&xmmword_140F08938,
    v7);
