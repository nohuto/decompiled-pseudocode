/*
 * XREFs of VerifierIoReleaseRemoveLockAndWaitEx @ 0x140B927B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierIoReleaseRemoveLockAndWaitEx(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
