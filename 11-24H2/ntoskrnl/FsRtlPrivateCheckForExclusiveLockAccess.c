/*
 * XREFs of FsRtlPrivateCheckForExclusiveLockAccess @ 0x140248EE0
 * Callers:
 ...
 *     FsRtlFindFirstOverlapInNode @ 0x1404FA7E0 (FsRtlFindFirstOverlapInNode.c)
 */
