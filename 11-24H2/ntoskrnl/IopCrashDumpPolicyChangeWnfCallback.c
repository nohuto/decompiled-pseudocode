/*
 * XREFs of IopCrashDumpPolicyChangeWnfCallback @ 0x14070E6B0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
  ...
  if ( v2 )
  {
    ...
    if ( (unsigned int)dword_140E06DC8 > 5 && tlgKeywordOn((__int64)&dword_140E06DC8, 0x400000000000LL) )
    {
      ...
      v19 = 4LL;
      v21 = 1LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06DC8, (unsigned __int8 *)byte_140045725, 0LL, 0LL, 5u, v15);
    }
    if ( KeyHandle )
      ZwClose(KeyHandle);
    return v5;
  ...
  else
  {
    ...
    if ( (unsigned int)dword_140E06DC8 > 5 && tlgKeywordOn((__int64)&dword_140E06DC8, 0x400000000000LL) )
    {
      ...
      p_UserData = &UserData;
      v17 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06DC8, (unsigned __int8 *)byte_1400456E8, 0LL, 0LL, 3u, v15);
    }
    return 3221225485LL;
  }
}
