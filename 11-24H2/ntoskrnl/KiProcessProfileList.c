/*
 * XREFs of KiProcessProfileList @ 0x1404980CC
 * Callers:
...
unsigned __int64 __fastcall KiProcessProfileList(__int64 a1, int a2, unsigned __int16 *a3, __int64 a4)
{
  ...
  for ( i = *(unsigned __int16 **)a3; i != a3; i = *(unsigned __int16 **)i )
  {
    ...
    if ( (_DWORD)result == a2 )
    {
      if ( *(i - 4) == 17 )
      {
        result = guard_dispatch_icall_no_overrides(a1, *((_QWORD *)i + 4), a3, a4);
      }
      else
      {
        ...
        if ( (_DWORD)result )
        {
          ...
          v10 = *((_QWORD *)i + 3);
          if ( result >= v10 && result < *((_QWORD *)i + 4) )
          {
            result = *((_QWORD *)i + 6) + (((result - v10) >> *((_DWORD *)i + 10)) & 0xFFFFFFFC);
