/*
 * XREFs of ObpCreateSymbolicLinkName @ 0x1406F8670
 * Callers:
 ...
 *     Feature_Servicing_ReferSymbolicLinkFlagGlobal__private_IsEnabledDeviceUsageNoInline @ 0x1405CC2E8 (Feature_Servicing_ReferSymbolicLinkFlagGlobal__private_IsEnabledDeviceUsageNoInline.c)
 ...
 *     ObpParseComponentName @ 0x14099CED0 (ObpParseComponentName.c)
...
LABEL_8:
              ...
              ObpLockDirectoryShared(&v34, v8);
              while ( (unsigned __int8)ObpParseComponentName(&v32, &v33) )
              {
                v11 = ObpLookupDirectoryEntry(&v33, 0LL, &v34);
                v12 = v11;
                if ( !v11 )
                  goto LABEL_28;
...
LABEL_47:
                ...
                ObpLockChildDirectory(&v34, v12, 0LL);
              }
