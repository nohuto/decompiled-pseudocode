/*
 * XREFs of VmpMergeMemoryRanges @ 0x1404D06B0
 * Callers:
 ...
 *     VmpVaMemoryRangeGetNext @ 0x1404A2FDC (VmpVaMemoryRangeGetNext.c)
            ...
            && ((*(_BYTE *)(Next + 72) ^ *(_BYTE *)(v9 + 72)) & 2) == 0 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( v16 == (_QWORD *)(v9 + 40) )
              {
                ...
                do
                {
                  RtlRbRemoveNode((unsigned __int64 *)(SpinLock + 8), v23 + 3);
                  v24 = v23[7];
                  v23[5] = -1LL;
                  v22[7] = v24;
                  if ( (v23[8] & 1) != 0 )
                ...
                RtlRbRemoveNode((unsigned __int64 *)(SpinLock + 24), (unsigned __int64 *)Next);
                *(_QWORD *)(Next + 16) = -1LL;
                v3 = (void *)Next;
