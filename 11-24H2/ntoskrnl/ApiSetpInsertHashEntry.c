/*
 * XREFs of ApiSetpInsertHashEntry @ 0x140663870
 * Callers:
 ...
 *     ApiSetSchemaExpander_InsertGroupContractEntry @ 0x140662D90 (ApiSetSchemaExpander_InsertGroupContractEntry.c)
 ...
 *     ApiSetpFindHashInsertionPoint_V7 @ 0x140663770 (ApiSetpFindHashInsertionPoint_V7.c)
...
__int64 __fastcall ApiSetpInsertHashEntry(__int64 a1, unsigned int *a2, unsigned __int16 a3, __int64 a4)
{
  ...
  if ( a3 == (_WORD)v6 )
  {
    ...
    {
      memmove(
        (void *)(a1 + 8LL * v27 + 8 + *((unsigned __int8 *)a2 + 8) * (v6 + 1) - *(unsigned __int16 *)(a1 + 18) + *a2),
        (const void *)(a1
                     + 8LL * v27
                     + *a2
                     + *((unsigned __int8 *)a2 + 8) * (unsigned __int64)(unsigned int)v6
    ...
    *(_DWORD *)(v15 + v16 + 4) = v5;
    if ( (_DWORD)v13 )
    {
      memmove(
        ...
        (const void *)(a1
                     + *a2
                     + *((unsigned __int8 *)a2 + 8) * (unsigned __int64)*(unsigned __int16 *)v4
                     - *(unsigned __int16 *)(a1 + 18)),
        8 * v13);
      v4 = v14;
    }
    ...
    if ( v19 <= 1u )
      return 0LL;
    v25 = *(_DWORD *)(v24 + (unsigned int)v23 - v18 + a1);
    while ( 1 )
    {
      v26 = *(_DWORD *)(v23 + v24 + 8LL * v21 - v18 + a1);
      if ( v25 >= v26 )
        break;
      ++v21;
      v25 = v26;
