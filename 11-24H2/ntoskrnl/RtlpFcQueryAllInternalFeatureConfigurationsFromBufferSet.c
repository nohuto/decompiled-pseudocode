/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x1405F2A18
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x140AA05A0 (RtlpFcConfigurationTypeToBufferType.c)
 */
