/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x1405F0058
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x140A9B930 (RtlpFcConfigurationTypeToBufferType.c)
 */
