/*
 * XREFs of VERIFY_BUFFER_LOCKED @ 0x140B84EB4
 * Callers:
...
void __fastcall VERIFY_BUFFER_LOCKED(ULONG_PTR a1)
{
  ...
  {
    ViHalPreprocessOptions(byte_140E0E928, "DMA Pages Not Locked! MDL %p for DMA not locked", (const void *)0xE);
    VfReportIssueWithOptions(0xE6u, 0xEuLL, a1, 0LL, 0LL, byte_140E0E928);
  }
}
