/*
 * XREFs of __asan_store8 @ 0x1405A9F50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store8(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r8d
...
LABEL_27:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 8, v4, 0, v1);
  }
  return v3;
}
