/*
 * XREFs of DifIoAllocateDriverObjectExtensionWrapper @ 0x140623AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoAllocateDriverObjectExtensionWrapper(struct _DRIVER_OBJECT *a1, void *a2, ULONG a3, PVOID *a4)
{
  ...
  DWORD2(v20) = IoAllocateDriverObjectExtension(a1, a2, a3, a4);
  if ( v9 )
  {
