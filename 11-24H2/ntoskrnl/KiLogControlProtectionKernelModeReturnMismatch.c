/*
 * XREFs of KiLogControlProtectionKernelModeReturnMismatch @ 0x1405C6CE4
 * Callers:
...
void __fastcall KiLogControlProtectionKernelModeReturnMismatch(unsigned int a1, __int64 a2)
{
  ...
  {
    _InterlockedAdd(&dword_140FC708C, 1u);
    if ( *(_DWORD *)(a2 + 28) )
      _InterlockedAdd(&dword_140FC7094, 1u);
    if ( !KeGetPcr()->Prcb.CombinedNmiMceActive && KeGetCurrentIrql() < 0xFu )
    {
      if ( *(_DWORD *)(a2 + 28) && !_InterlockedCompareExchange(&dword_140FC7090, 1, 0) )
      {
LABEL_11:
      ...
      {
        v2 = dword_140FC7084;
        while ( v2 < dword_140FC7088 )
        {
          v3 = v2;
          v2 = _InterlockedCompareExchange(&dword_140FC7084, v2 + 1, v2);
          if ( v3 == v2 )
            goto LABEL_11;
        }
      }
