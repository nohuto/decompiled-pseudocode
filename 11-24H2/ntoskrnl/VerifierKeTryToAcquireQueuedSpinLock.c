/*
 * XREFs of VerifierKeTryToAcquireQueuedSpinLock @ 0x140B95A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierKeTryToAcquireQueuedSpinLock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  __int64 v6; // rsi
  void *v7; // r8
