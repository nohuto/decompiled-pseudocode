/*
 * XREFs of CmFcInitSystem3 @ 0x140C5F210
 * Callers:
...
char CmFcInitSystem3()
{
  ...
  TlgRegisterAggregateProvider((__int64)&dword_140E09EB0);
  result = KeLoaderBlock_0;
  if ( (unsigned int)dword_140E09EB0 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140E09EB0, 0x400000000000LL);
    if ( result )
    {
      v2 = *v1;
      v13 = 1LL;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)byte_1400545DB,
               0LL,
               0LL,
               0xBu,
               &v11);
