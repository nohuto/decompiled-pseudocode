/*
 * XREFs of CmFcInitSystem3 @ 0x140C61360
 * Callers:
...
char CmFcInitSystem3()
{
  ...
  TlgRegisterAggregateProvider((__int64)&dword_140E09F20);
  result = KeLoaderBlock_0;
  if ( (unsigned int)dword_140E09F20 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140E09F20, 0x400000000000LL);
    if ( result )
    {
      v2 = *v1;
      v13 = 1LL;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)byte_1400550D5,
               0LL,
               0LL,
               0xBu,
               &v11);
