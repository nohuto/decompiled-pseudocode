/*
 * XREFs of NtDeleteWnfStateName @ 0x140900ED0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)v18 = 0LL;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( (_DWORD)v7 != 3 )
    {
      if ( PreviousMode )
      {
        v3 = ExpWnfLookupPermanentName(v20, (PSECURITY_DESCRIPTOR **)&P);
        if ( v3 < 0 )
          goto LABEL_21;
        v14 = (void *)*((_QWORD *)P + 2);
    ...
    while ( v2 )
    {
      v3 = ExpWnfLookupNameInstance((__int64)v2, v4, &v15);
      if ( v3 >= 0 )
      {
        if ( !v9 )
        {
