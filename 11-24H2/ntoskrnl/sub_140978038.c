/*
 * XREFs of sub_140978038 @ 0x140978038
 * Callers:
...
__int64 __fastcall sub_140978038(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  unsigned int v6; // r8d
  unsigned int *v7; // rax
  unsigned int i; // edx
  ...
  if ( (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, __int64))qword_140FD7438 == ntoskrnl_27 )
    v13 = ntoskrnl_27((__int64)&DestinationString, (__int64)&v41, (__int64)&v40, 4LL, (__int64)&v38);
  else
    v13 = guard_dispatch_icall_no_overrides(&DestinationString, &v41, &v40, 4LL);
  v6 = v13;
  if ( v13 != -1073741772 )
  {
    if ( v13 < 0 )
  ...
  do
  {
    v14 = KeWaitForSingleObject(&stru_140EF09C0, UserRequest, 1, 1u, 0LL);
    v15 = v14;
  }
  while ( v14 == 257 );
  if ( v14 >= 0 && v14 != 192 )
