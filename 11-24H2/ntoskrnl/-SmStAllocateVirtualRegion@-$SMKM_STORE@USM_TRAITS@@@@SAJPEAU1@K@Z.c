/*
 * XREFs of ?SmStAllocateVirtualRegion@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@K@Z @ 0x140469C50
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStAllocateVirtualRegion(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_QWORD *)(v2 + 8LL * a2) )
    return 0LL;
  v14 = 0LL;
  v5 = *(unsigned int *)(a1 + 7016);
  v12 = 0LL;
  v11[0] = 0LL;
  v11[1] = v5;
  LODWORD(v5) = *(_DWORD *)(a1 + 7588);
  v6 = *(unsigned __int8 *)(a1 + 6837);
  DWORD2(v12) = v5;
  v7 = *(_QWORD *)(a1 + 7576);
  HIDWORD(v12) = (v6 >> 6) & 1;
  v13 = 0LL;
  *(_QWORD *)&v12 = v7;
  result = SMKM_STORE<SM_TRAITS>::SmStHelperSendCommand(a1, 2, (__int64)v11, 4u);
  if ( (int)result >= 0 )
  {
