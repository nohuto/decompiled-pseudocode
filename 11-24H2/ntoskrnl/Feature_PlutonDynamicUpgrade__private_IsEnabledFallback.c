/*
 * XREFs of Feature_PlutonDynamicUpgrade__private_IsEnabledFallback @ 0x1405D33D4
 * Callers:
...
__int64 __fastcall Feature_PlutonDynamicUpgrade__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
