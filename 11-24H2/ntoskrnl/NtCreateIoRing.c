/*
 * XREFs of NtCreateIoRing @ 0x140714CF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  *((_QWORD *)Object + 13) = 0LL;
  ...
  Handle = 0LL;
  inserted = ObInsertObjectEx(Object, 0, (__int64)&Object, (__int64)&Handle);
  HIDWORD(PreviousMode) = inserted;
  if ( inserted >= 0 )
  {
    *v38 = Handle;
...
LABEL_43:
  if ( inserted >= 0 && Object )
  {
    ...
    if ( (unsigned int)dword_140E06E48 > 5 && tlgKeywordOn((__int64)&dword_140E06E48, 0x400000000000LL) )
    {
      ...
      v72 = &v40;
      v73 = 8LL;
      tlgWriteAgg((__int64)&dword_140E06E48, (unsigned __int8 *)&byte_1400458DF, (__int64)v20, 0x12u, (__int64)v43);
    }
