/*
 * XREFs of DifZwSetInformationKeyWrapper @ 0x140646BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationKeyWrapper(void *a1, KEY_SET_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(16);
  ...
  DWORD2(v20) = ZwSetInformationKey(a1, a2, a3, a4);
  if ( v9 )
  {
