/*
 * XREFs of Amd64PauseProfilingInternal @ 0x14056990C
 * Callers:
 *     Amd64PauseProfiling @ 0x1405698D0 (Amd64PauseProfiling.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall Amd64PauseProfilingInternal(int a1, unsigned int a2)
{
  __int64 v2; // r10
  __int64 result; // rax
  __int64 v4; // r8
...
LABEL_22:
          ...
          result = __readmsr(v11) & 0xFFBFFFFF;
