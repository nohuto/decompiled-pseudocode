/*
 * XREFs of DifPoFxSetDeviceIdleTimeoutWrapper @ 0x140636590
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxSetDeviceIdleTimeoutWrapper(__int64 a1, unsigned __int64 a2)
{
  ...
  PoFxSetDeviceIdleTimeout(a1, a2);
  if ( v6 )
  {
