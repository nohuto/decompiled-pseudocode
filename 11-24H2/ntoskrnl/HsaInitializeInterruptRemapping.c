/*
 * XREFs of HsaInitializeInterruptRemapping @ 0x140B54BB8
 * Callers:
 *     HsaInitializeIommu @ 0x140B54D50 (HsaInitializeIommu.c)
 * Callees:
 *     RtlInitializeBitMap @ 0x140455E70 (RtlInitializeBitMap.c)
  ...
  if ( v3 )
  {
    if ( v3 == 1 )
    {
      if ( !*((_QWORD *)&HsaSharedRemappingTable + 1) )
      {
        ...
        v4 = guard_dispatch_icall_no_overrides(-1LL, (unsigned int)NumberOfBytes >> 12);
