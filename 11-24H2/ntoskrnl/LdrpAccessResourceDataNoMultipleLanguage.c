/*
 * XREFs of LdrpAccessResourceDataNoMultipleLanguage @ 0x140A03160
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  v5 = a3;
  v7 = a1;
  v26 = RtlImageDirectoryEntryToData(a1, 1, 2u, &v25);
  if ( !v26 )
    return 3221225609LL;
  v25 = 0LL;
    ...
    else
    {
      ...
      if ( v12 )
      {
        ...
        if ( *a2 > *(_DWORD *)(v18 + 8) )
        {
          ...
          if ( !v22 )
            return 3221225609LL;
          v24 = RtlAddressInSectionTable(v14, v7, *(unsigned int *)(v22 + 12));
