/*
 * XREFs of DifExIsResourceAcquiredExclusiveLiteWrapper @ 0x14061F7D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExIsResourceAcquiredExclusiveLiteWrapper(PERESOURCE Resource)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(463);
  ...
  LOBYTE(v18) = ExIsResourceAcquiredExclusiveLite(Resource);
  if ( v6 )
  {
