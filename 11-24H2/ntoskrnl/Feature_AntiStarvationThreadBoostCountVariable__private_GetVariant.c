/*
 * XREFs of Feature_AntiStarvationThreadBoostCountVariable__private_GetVariant @ 0x1405B2014
 * Callers:
...
__int64 Feature_AntiStarvationThreadBoostCountVariable__private_GetVariant()
{
  __int64 CachedVariantState; // rax
  unsigned int v1; // ebx

  CachedVariantState = wil_details_FeatureStateCache_GetCachedVariantState(
                         &Feature_AntiStarvationThreadBoostCountVariable__private_featureState,
                         (__int64)&Feature_AntiStarvationThreadBoostCountVariable__private_descriptor);
