/*
 * XREFs of MiReplacePageTablePage @ 0x140311CD4
 * Callers:
...
unsigned __int64 __fastcall MiReplacePageTablePage(unsigned __int64 a1)
{
  ...
  *(_DWORD *)(a1 + 56) = -1073741823;
  ...
  v48 = v10;
  ProtectionPfnCompatible = MiMakeProtectionPfnCompatible(4LL, 48 * v5 - 0x220000000000LL);
    ...
    if ( v50 )
    {
      ...
      do
      {
        ...
        if ( (v27 & 1) != 0 )
        {
          ...
          v51 = v24;
          if ( v31 <= qword_140E2DBE0 && ((*(_QWORD *)(48 * v31 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 && v31 != v45 )
          {
