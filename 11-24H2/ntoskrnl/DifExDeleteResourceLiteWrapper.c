/*
 * XREFs of DifExDeleteResourceLiteWrapper @ 0x14061DA00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExDeleteResourceLiteWrapper(PERESOURCE Resource)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(407);
  ...
  LODWORD(v18) = ExDeleteResourceLite(Resource);
  if ( v6 )
  {
