/*
 * XREFs of DifZwCreateDirectoryObjectWrapper @ 0x14063D440
 * Callers:
 *     <none>
 * Callees:
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v23) = ZwCreateDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v10 )
  {
