/*
 * XREFs of MiIsPageEligibleForProtectedStandby @ 0x140428E30
 * Callers:
...
_BOOL8 __fastcall MiIsPageEligibleForProtectedStandby(__int64 a1, __int64 a2)
{
  ...
  result = !_bittest64((const signed __int64 *)(a2 + 40), 0x35u)
        && (!byte_140E3CAE6
         || (v2 = (0xAAAAAAAAAAAAAAABuLL * ((a2 + 0x220000000000LL) >> 4)) >> 9, !*(_BYTE *)(qword_140E3D140 + 2 * v2))
         || *(_BYTE *)(qword_140E3D140 + 2 * v2) == 10)
        && a1
        && (*(_BYTE *)(a2 + 35) & 0x10) == 0
