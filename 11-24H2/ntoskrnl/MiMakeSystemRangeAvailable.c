/*
 * XREFs of MiMakeSystemRangeAvailable @ 0x1403A5094
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v20 = 0LL;
  if ( a3 == 4 )
    v7 = qword_140E2DAF8 + 384LL * (unsigned int)MiNonPagedPoolToNode(BugCheckParameter2);
  else
...
LABEL_11:
  ...
  _InterlockedAdd64(&qword_140E38908[(int)BugCheckParameter4], -(__int64)v4);
  if ( (_DWORD)BugCheckParameter4 == 7 )
    qword_140E2EDC8 += BugCheckParameter3;
