/*
 * XREFs of DifExAcquireFastResourceExclusiveWrapper @ 0x14061B750
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireFastResourceExclusiveWrapper(ULONG_PTR BugCheckParameter2, __int64 a2, char a3)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(442);
  ...
  LOBYTE(v23) = ExAcquireFastResourceExclusive(BugCheckParameter2, a2, a3);
  if ( v10 )
  {
