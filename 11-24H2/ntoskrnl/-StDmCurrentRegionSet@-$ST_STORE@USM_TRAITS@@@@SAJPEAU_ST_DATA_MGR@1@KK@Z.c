/*
 * XREFs of ?StDmCurrentRegionSet@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KK@Z @ 0x14039960C
 * Callers:
...
LABEL_3:
    *v5 = -1;
    ...
    if ( (_DWORD)v3 != -1 )
    {
      ...
      if ( !*(_BYTE *)(a1 + 776) )
        ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(*(_QWORD *)(a1 + 2296), 3, 0x1388u, 0xFFFFFFFE);
    }
    *v5 = v3;
    result = 0LL;
    v5[1] = v8;
