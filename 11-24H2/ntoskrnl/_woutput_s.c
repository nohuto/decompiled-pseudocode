/*
 * XREFs of _woutput_s @ 0x140502F9C
 * Callers:
 ...
 *     write_char_1 @ 0x1405038E8 (write_char_1.c)
...
__int64 __fastcall woutput_s(__int64 a1, unsigned __int16 *a2, int *a3)
{
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v10 - v14) > 0x5Au )
      ...
      v16 = *((_BYTE *)&_lookuptable_s[-4] + v10) & 0xF;
    v13 = *((unsigned __int8 *)_lookuptable_s + (unsigned int)(v16 + v13 + 8 * v16)) >> 4;
    v58 = v13;
    switch ( v13 )
    {
      case 8:
...
LABEL_56:
              ...
              if ( (v4 & 0x20) != 0 )
              {
                SrcCh[0] = v24;
                SrcCh[1] = v9;
                v25 = safecrt_mbtowc(DstCh, SrcCh, _mb_cur_max);
                LODWORD(v9) = 0;
                if ( v25 < 0 )
                  v69 = 1;
              }
...
LABEL_91:
          ...
          v29 = v68;
          v60 = v28 != 0 ? v60 : 0;
          for ( j = (wchar_t *)&v73; ; j = (wchar_t *)((char *)j - 1) )
          {
            v31 = v5--;
            if ( v31 <= 0 && !v28 )
              break;
