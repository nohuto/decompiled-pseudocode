/*
 * XREFs of KseDsCallbackHookIrpDeviceControlFunction @ 0x1405CAB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KseDsCallbackHookIrpDeviceControlFunction(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v6; // edi
  __int64 v7; // r8
  __int64 v8; // r9
