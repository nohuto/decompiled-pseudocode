/*
 * XREFs of MiMarkLargePagePte @ 0x140C4FE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiMarkLargePagePte(__int64 a1, unsigned __int64 *a2, int a3)
{
  ...
  if ( a3 != 3 )
  {
    ...
    if ( (v4 & 0x81) == 0x81 )
    {
      ...
      if ( v5 <= qword_140E2DBE0 && ((*(_QWORD *)(48 * v5 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
      {
        v6 = 512LL;
        if ( a3 > 1 )
        {
        ...
        MiUpdateLargePageBitMap((__int64)&MiSystemPartition, v5, v6, 5);
      }
    }
  }
  return 0LL;
