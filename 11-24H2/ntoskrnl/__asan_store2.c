/*
 * XREFs of __asan_store2 @ 0x1405A9B30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store2(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r8d
...
LABEL_14:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 2, v4, 0, v1);
  }
  return v3;
}
