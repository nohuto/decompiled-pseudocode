/*
 * XREFs of Feature_CrashDumpOneMBTransferSize__private_IsEnabledFallback @ 0x1405D3380
 * Callers:
...
__int64 __fastcall Feature_CrashDumpOneMBTransferSize__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
