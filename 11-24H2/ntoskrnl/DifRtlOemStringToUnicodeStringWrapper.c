/*
 * XREFs of DifRtlOemStringToUnicodeStringWrapper @ 0x140639F30
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlOemStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
