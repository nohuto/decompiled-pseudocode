/*
 * XREFs of MiChangePagingFileMaximum @ 0x140679DB0
 * Callers:
...
void __fastcall MiChangePagingFileMaximum(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 )
  {
    ...
    v14 = (((unsigned int)dword_140E3728C * (unsigned __int64)*v11) >> 12)
        + ((((unsigned int)dword_140E3728C * (unsigned __int64)*v11) & 0xFFF) != 0);
    v26 = v14;
    if ( *v11 >= *v3 )
      v15 = (((unsigned int)dword_140E3728C * (unsigned __int64)*v3) >> 12)
          + ((((unsigned int)dword_140E3728C * (unsigned __int64)*v3) & 0xFFF) != 0);
    else
      v15 = (((unsigned int)dword_140E3728C * (unsigned __int64)*v11) >> 12)
          + ((((unsigned int)dword_140E3728C * (unsigned __int64)*v11) & 0xFFF) != 0);
    if ( v15 )
    {
      v16 = (_QWORD *)v13;
  ...
  *v10 = a3;
  ...
  if ( v12 )
  {
    ...
    MiReleasePtes((__int64)&qword_140E37568, v12, v14);
  }
}
