/*
 * XREFs of DifZwOpenTransactionWrapper @ 0x1406418F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenTransactionWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        HANDLE TmHandle)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(69);
  ...
  LODWORD(v21) = ZwOpenTransaction(a1, a2, a3, a4, TmHandle);
  if ( v10 )
  {
