/*
 * XREFs of PnpRecordBlackboxDeviceCompletionQueueInformation @ 0x1409ED7A0
 * Callers:
...
void __fastcall PnpRecordBlackboxDeviceCompletionQueueInformation(__int64 a1)
{
  ...
  {
    v2 = 72LL;
    Pool2 = ExAllocatePool2(0x40uLL, 0x48uLL, 0x4B706E50u);
    v1 = Pool2;
    if ( Pool2 )
    {
      *(_DWORD *)Pool2 = 1;
      ...
      *(_QWORD *)(v1 + 56) = *(_QWORD *)&PnpDeviceActionThread;
