/*
 * XREFs of MiRelocateImage @ 0x1408F5784
 * Callers:
 ...
 *     RtlInitializeSystemOverrideDelta @ 0x1408F74A4 (RtlInitializeSystemOverrideDelta.c)
...
__int64 __fastcall MiRelocateImage(__int64 a1, __int64 a2, int a3, int a4, __int64 a5, int a6)
{
  ...
  __int64 v65; // [rsp+58h] [rbp-100h] BYREF
  ...
  unsigned __int64 v78[2]; // [rsp+D0h] [rbp-88h] BYREF
  ...
  *(_QWORD *)(Pool + 24) = 0LL;
  if ( (v9 & 2) == 0 )
    goto LABEL_24;
  if ( (int)MiMapImageInSystemSpace((__int64 *)v15, 3, (__int64)v78) < 0 )
  {
  ...
  v9 |= 1u;
  Config = MiParseImageLoadConfig((_QWORD *)v15, v52, v73, v79 << 12, (__int64)(v24 + 9));
  if ( Config >= 0 )
  {
LABEL_24:
    v59 = v9;
    Config = MiSelectImageBase(v72, (_DWORD)v24, a4, a6, (__int64)&v65);
    if ( Config < 0 )
    {
    ...
    {
      Config = MiUpdateImageSystemWideBitmaps(v15, v65, v24 + 9);
      if ( Config < 0 )
        goto LABEL_83;
      if ( (v9 & 2) != 0 )
      {
...
LABEL_57:
              ...
              MiLogRelocationFaults(v15, (unsigned int *)&v69, (__int64)v24);
              *((_DWORD *)v24 + 14) = v34 + 1;
              if ( (v9 & 0x14) == 0x14 )
        ...
        if ( (*(_BYTE *)(v15 + 62) & 0xC) != 4 || (Config = MiCreateFileOnlyImageFixupList(v15, v24, &P), Config >= 0) )
        {
          ...
          *(_DWORD *)(v15 + 92) |= 0x400000u;
          ...
          if ( (MiFlags & 0x2000) == 0
            ...
            || (Config = SeSetImageBaseAddress(*(_QWORD *)(v48 + 40) & 0xFFFFFFFFFFFFFFF8uLL, v65), Config >= 0) )
          {
            if ( a4 )
              SessionId = -1;
            else
            ...
            if ( !a6 || (v9 & 0x88) != 0 )
            {
              if ( (*(_BYTE *)(v15 + 62) & 0xC) != 4
                || (Config = MiWalkEntireImage(v15, (unsigned __int64)P, 4u, SessionId), Config >= 0) )
              {
