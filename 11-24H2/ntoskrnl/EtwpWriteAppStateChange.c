/*
 * XREFs of EtwpWriteAppStateChange @ 0x14094D6B0
 * Callers:
...
void __fastcall EtwpWriteAppStateChange(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E090F0 > 5
    && (qword_140E09100 & 0x200000000001LL) != 0
    && (qword_140E09108 & 0x200000000001LL) == qword_140E09108 )
  {
    v9 = 0;
    *(_DWORD *)&EventDescriptor.Level = 5;
    UserData.Ptr = (ULONGLONG)off_140E090F8;
    v7 = a1;
    EventDescriptor.Keyword = 0x200000000001LL;
    v8 = 98;
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    UserData.Size = *(unsigned __int16 *)off_140E090F8;
    v4 = &word_1400526E6;
    UserData.Reserved = 2;
    v5 = 319;
    v6 = 1;
    EtwWriteTransfer(qword_140E09110, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
  }
}
