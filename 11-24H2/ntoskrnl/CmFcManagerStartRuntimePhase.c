/*
 * XREFs of CmFcManagerStartRuntimePhase @ 0x140C4D180
 * Callers:
 ...
 *     CmFcpSwapSectionState @ 0x1406F5934 (CmFcpSwapSectionState.c)
 ...
 *     RtlGetSwapReferenceIndex @ 0x140A8A718 (RtlGetSwapReferenceIndex.c)
...
__int64 CmFcManagerStartRuntimePhase()
{
  ...
  *(_OWORD *)&DestinationString[1] = 0LL;
  ...
  if ( SectionFromBuffer >= 0 )
  {
    ...
    CmpVolumeManagerLockContextListExclusive(&stru_140EF6F10);
    RtlpFcBufferManagerReferenceBuffers((__int64)qword_140EF6F88, (__int64)&v39, DestinationString);
    v7 = v39;
    v8 = v42;
    v9 = 4LL;
    do
    ...
    if ( !v13
      || (SectionFromBuffer = CmFcpManagerCreateSectionFromBuffer(v13, v10[11], v7, CmFcSystemManager[0], (__int64)v45),
          SectionFromBuffer >= 0) )
    {
      RtlpFcBufferManagerDereferenceBuffers(qword_140EF6F88, (__int64)v10);
      DestinationString[0] = 0LL;
      ...
      CmpVolumeManagerLockContextListExclusive(&stru_140EF6F08);
      v16 = 0LL;
      do
      {
      ...
      while ( v18 != 1 );
      RtlpFcBufferManagerUpdateBuffers(qword_140EF6F88, v39, (__int64)v41);
      memset_0(v41, 0, sizeof(v41));
      RtlpFcWriteHighLowHigh(MmWriteableSharedUserData + 1824, v39);
      CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140EF6F08);
      SectionFromBuffer = ZwUpdateWnfStateData((__int64)&WNF_CMFC_FEATURE_CONFIGURATION_CHANGED, (__int64)&v39);
      if ( SectionFromBuffer < 0 )
        goto LABEL_54;
      for ( j = 0; j < 2; ++j )
      {
        v20 = ((unsigned __int8)RtlGetSwapReferenceIndex(qword_140EF7078) - 1) & 1;
        ...
        RtlUpdateSwapReference((__int64)qword_140EF7078, v20);
      }
      qword_140EF7130 = ExAllocateTimer(
      ...
      if ( SectionFromBuffer < 0 )
        goto LABEL_54;
      qword_140EF7500 = ExAllocateTimer((__int64)CmFcpManagerFlushUsageTimerRoutine, (__int64)CmFcSystemManager, 8u);
      if ( !qword_140EF7500
        || (qword_140EF7508 = ExAllocateTimer(
...
LABEL_30:
      ...
      CmpVolumeManagerLockContextListExclusive(&stru_140EF7478);
      v2 = 1;
      v28 = ((unsigned __int8)RtlGetSwapReferenceIndex(qword_140EF72B0) - 1) & 1;
      ...
      *(_DWORD *)(v30 + 28) = 508;
      ...
      RtlUpdateSwapReference((__int64)qword_140EF72B0, v28);
      v31 = ((_BYTE)v28 - 1) & 1;
      v32 = (_DWORD *)CmFcSystemManager[v31 + 165];
      if ( v32 )
      {
        if ( byte_140EF75F8 && v32[4] )
        {
...
LABEL_38:
            SectionFromBuffer = -1073741670;
LABEL_53:
            CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140EF7478);
LABEL_54:
            CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140EF6F10);
      ...
      if ( _InterlockedExchange(&dword_140EF7600, 1) == 2 )
        CmFcpManagerPublishFeatureUsageData((__int64)CmFcSystemManager, 1);
      if ( (dword_140EF75D0 & 2) != 0 )
