/*
 * XREFs of DifZwAlpcCreatePortWrapper @ 0x14063A5B0
 * Callers:
 *     <none>
 * Callees:
        ...
        PALPC_PORT_ATTRIBUTES PortAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(141);
  ...
  LODWORD(v19) = ZwAlpcCreatePort(PortHandle, ObjectAttributes, PortAttributes);
  if ( v8 )
  {
