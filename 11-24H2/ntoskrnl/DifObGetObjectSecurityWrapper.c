/*
 * XREFs of DifObGetObjectSecurityWrapper @ 0x140635EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifObGetObjectSecurityWrapper(
        PVOID Object,
        ...
        PBOOLEAN MemoryAllocated)
{
  ...
  LODWORD(v23) = ObGetObjectSecurity(Object, SecurityDescriptor, MemoryAllocated);
  if ( v10 )
  {
