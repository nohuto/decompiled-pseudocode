/*
 * XREFs of NtCreateTimer @ 0x1409EADF0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( PreviousMode )
    {
      ...
      if ( (*(_DWORD *)&Process->0 & 0x10) != 0 )
      {
        ...
        if ( v14 )
        {
          ...
          LOBYTE(v11) = (*(_DWORD *)(v14 + 1552) & 0x40000) != 0 && *(_DWORD *)(v14 + 1064);
        }
        v10 = (struct _KTIMER *)DeferredContext;
...
LABEL_10:
    inserted = ObInsertObjectEx((struct _FILE_OBJECT *)v10, 0LL, DesiredAccess, 0, 0, 0LL, (__int64)&v20);
    if ( inserted >= 0 )
