/*
 * XREFs of SymCryptParallelHashProcess @ 0x14051FF14
 * Callers:
  ...
  if ( a5 )
  {
    ...
    if ( v39 + v40 <= a6 + a7 )
    {
      ...
      for ( i = (unsigned __int64 *)(a4 + 40 * a5); (unsigned __int64)i > a4; v19[3] = i )
      {
        ...
        if ( !*v19 )
        {
          *v19 = a2 + v18 * *(unsigned int *)(v42 + 40);
          v15[v16++] = v19;
        }
        v20 = *((_DWORD *)i + 2);
        if ( v20 == 1 )
      ...
      if ( v16 )
      {
        ...
        do
        {
          ...
          guard_dispatch_icall_no_overrides(v15, v28, (unsigned int)v32 & -*(_DWORD *)(v30 + 48), v40);
          v34 = 0LL;
          if ( v28 )
          {
            v35 = &v15[v28];
            ...
            {
              v36 = v15[v34];
              if ( *(_QWORD *)(v36 + 40) < (unsigned __int64)*(unsigned int *)(v42 + 48)
