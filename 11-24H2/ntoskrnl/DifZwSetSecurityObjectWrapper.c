/*
 * XREFs of DifZwSetSecurityObjectWrapper @ 0x1406473A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSecurityObjectWrapper(
        HANDLE Handle,
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(11);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = Handle;
    LODWORD(v18) = SecurityInformation;
    *((_QWORD *)&v17 + 1) = SecurityDescriptor;
  ...
  LODWORD(v19) = ZwSetSecurityObject(Handle, SecurityInformation, SecurityDescriptor);
  if ( v8 )
  {
