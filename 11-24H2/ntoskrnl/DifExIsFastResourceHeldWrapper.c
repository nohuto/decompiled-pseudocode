/*
 * XREFs of DifExIsFastResourceHeldWrapper @ 0x14061DAC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExIsFastResourceHeldWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(459);
  ...
  LOBYTE(v14) = ExIsFastResourceHeld(BugCheckParameter2);
  if ( v4 )
  {
