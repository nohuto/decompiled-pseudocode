/*
 * XREFs of DifMmCreateMdlWrapper @ 0x1406312E0
 * Callers:
 *     <none>
 * Callees:
...
PMDL __fastcall DifMmCreateMdlWrapper(PMDL MemoryDescriptorList, PVOID Base, SIZE_T Length)
{
  ...
  PMDL Mdl; // [rsp+40h] [rbp-10h]
  _UNKNOWN *retaddr; // [rsp+78h] [rbp+28h]

  Mdl = 0LL;
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(227);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = MemoryDescriptorList;
    *(_QWORD *)&v18 = Base;
    *((_QWORD *)&v17 + 1) = Length;
  ...
  Mdl = MmCreateMdl(MemoryDescriptorList, Base, Length);
  if ( v8 )
  {
