/*
 * XREFs of DifZwQueryKeyWrapper @ 0x140644480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryKeyWrapper(void *a1, KEY_INFORMATION_CLASS a2, void *a3, ULONG a4, ULONG *ResultLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(41);
  ...
  LODWORD(v21) = ZwQueryKey(a1, a2, a3, a4, ResultLength);
  if ( v10 )
  {
