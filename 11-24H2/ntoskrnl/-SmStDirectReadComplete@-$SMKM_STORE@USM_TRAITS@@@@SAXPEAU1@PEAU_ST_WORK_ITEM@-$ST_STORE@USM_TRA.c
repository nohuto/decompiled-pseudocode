/*
 * XREFs of ?SmStDirectReadComplete@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@PEAU_ST_WORK_ITEM@?$ST_STORE@USM_TRAITS@@@@J@Z @ 0x140230604
 * Callers:
...
void __fastcall SMKM_STORE<SM_TRAITS>::SmStDirectReadComplete(__int64 a1, _SLIST_ENTRY *a2, unsigned int a3)
{
  ...
  v3 = a3;
  SMKM_STORE_MGR<SM_TRAITS>::SmWorkItemFree(*(_QWORD *)(a1 + 7576), a1, a2, &v3);
}
