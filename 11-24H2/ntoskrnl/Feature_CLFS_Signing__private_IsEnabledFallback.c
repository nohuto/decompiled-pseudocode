/*
 * XREFs of Feature_CLFS_Signing__private_IsEnabledFallback @ 0x140666CBC
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_CLFS_Signing__private_descriptor);
}
