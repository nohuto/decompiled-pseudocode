/*
 * XREFs of sub_1409DABF4 @ 0x1409DABF4
 * Callers:
...
__int64 __fastcall sub_1409DABF4(PVOID BaseAddress, unsigned int a2, int a3)
{
  __int64 v3; // rsi
  __int64 v6; // rdx
  NTSTATUS v7; // r8d
  ...
  if ( v7 >= 0 )
  {
    ...
    LOBYTE(v8) = v8 & 0xF;
    if ( qword_140F04B60 && (LOBYTE(v6) = 12, (unsigned int)guard_dispatch_icall_no_overrides(v8, v6)) )
    {
      v7 = 0;
      if ( a3 )
      {
