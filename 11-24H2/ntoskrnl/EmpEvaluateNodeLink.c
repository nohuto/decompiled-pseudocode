/*
 * XREFs of EmpEvaluateNodeLink @ 0x14043D87C
 * Callers:
...
LABEL_14:
        ...
        if ( v47 == v44 + v46 + v26 )
        {
          ...
          {
            matched = HalMatchAcpiOemId(v12, v26, Pool2, v28, v17, v29, *(_QWORD *)(v18 + 32));
          }
          else
          {
            matched = guard_dispatch_icall_no_overrides(v12, v26, Pool2, v28);
          }
          v16 = matched;
        }
LABEL_41:
...
LABEL_49:
  ...
  if ( v13 )
    ...
    return (unsigned int)guard_dispatch_icall_no_overrides(a6, a7, a2, a3);
}
