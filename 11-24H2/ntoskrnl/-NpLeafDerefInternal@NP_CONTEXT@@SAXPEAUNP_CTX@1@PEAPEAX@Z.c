/*
 * XREFs of ?NpLeafDerefInternal@NP_CONTEXT@@SAXPEAUNP_CTX@1@PEAPEAX@Z @ 0x140463D20
 * Callers:
...
void __fastcall NP_CONTEXT::NpLeafDerefInternal(struct NP_CONTEXT::NP_CTX *a1, void **a2)
{
  ...
  *(_DWORD *)a2 = v5;
  if ( (v3 & 0x3FF) == 0 )
  {
    v6 = v5 & 0xFFFFFFFD;
    *(_DWORD *)a2 = v6;
    v7 = (__int64)((unsigned int)KeMaximumIncrement
                 * (unsigned __int64)(unsigned int)((__int64)MEMORY[0xFFFFF78000000320] >> 12)) >> 17;
    v8 = v7 - *(_DWORD *)(*(_QWORD *)a1 + 52LL);
    if ( v8 > 0x3FF )
      v8 = 1023;
    *(_DWORD *)a2 ^= (*(_DWORD *)a2 ^ (4 * v8)) & 0xFFC;
    if ( v8 >= 0x2FF )
    {
      v9 = v7 - 511;
      guard_dispatch_icall_no_overrides(
        ...
        (unsigned int)(v9 - *(_DWORD *)(*(_QWORD *)a1 + 52LL)),
        v6);
      *(_DWORD *)(*(_QWORD *)a1 + 52LL) = v9;
    }
  }
}
