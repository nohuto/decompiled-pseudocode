/*
 * XREFs of EtwpWriteUserEvent @ 0x140920F90
 * Callers:
 ...
 *     DecodeProviderTraits @ 0x1403FEA20 (DecodeProviderTraits.c)
 *     ExAcquireRundownProtectionCacheAwareEx @ 0x14040CCA0 (ExAcquireRundownProtectionCacheAwareEx.c)
 *     EtwpCreateEventKey @ 0x140434490 (EtwpCreateEventKey.c)
        ...
        unsigned __int64 *a16)
{
  ...
  unsigned __int16 v115; // [rsp+1E8h] [rbp+8h]
  ...
  _OWORD v167[48]; // [rsp+350h] [rbp+170h] BYREF
  unsigned int v168; // [rsp+650h] [rbp+470h]
  _OWORD v169[5]; // [rsp+660h] [rbp+480h] BYREF
...
LABEL_10:
    ...
    while ( 1 )
    {
      ...
      if ( ExAcquireRundownProtectionCacheAwareEx(
             *(PEX_RUNDOWN_REF_CACHE_AWARE *)(8 * v41 + *(_QWORD *)(v131 + 704)),
             1u) )
      {
        ...
        {
          _mm_lfence();
          v126 = *(_QWORD *)(v42 + *(_QWORD *)(v131 + 712));
        }
        v43 = 1;
      }
      else
      ...
      if ( (v47 & 0xFFFFFF9F) != 0 )
      {
        ...
        {
          v45 |= 0x100u;
          v46 += (LOWORD(Flink[281].Flink) + 15) & 0xFFFFFFF8;
          v116 = v46;
        }
        if ( (v47 & 1) != 0 )
        {
              ...
              && EtwpApplyEventNameFilter(v100, i, a10, v128, 1, 0, a8, a9, 1) )
            {
              ...
              if ( (v114 & 1) == 0 )
              {
                ...
                if ( StackLookasideListEntry )
                {
                  ...
                  if ( !EtwpGetStackExtendedHeaderItem(v126, v151, 0, (__int64)StackLookasideListEntry, 0, 0LL) )
                  {
...
LABEL_61:
        ...
        while ( 1 )
        {
          ...
          if ( v51 > 0xFFFF )
          {
            ...
            ExReleaseRundownProtectionCacheAwareEx(
              *(PEX_RUNDOWN_REF_CACHE_AWARE *)((char *)v120 + *(_QWORD *)(v131 + 704)),
              1u);
            v34 = v129;
            v24 = 0x140000000uLL;
            goto LABEL_22;
      ...
      *((_DWORD *)v48 + 10) = v46;
      ...
      if ( v53 )
      {
        ...
        *(_OWORD *)(v53 + 24) = v56;
        *(_DWORD *)v53 = dword_140037B28[v127] | v46;
        if ( v45 )
        {
          if ( (v45 & 0x100) != 0 )
          {
            ...
            v120 = v57;
            v58 = Flink;
            v59 = (LOWORD(Flink[281].Flink) + 15) & 0xFFF8;
            *v57 = v59;
            v57[1] = 16;
            v57[3] = (unsigned __int16)v58[281].Flink;
            v57[2] &= ~1u;
            v57[2] = 0;
            v60 = v59 - LOWORD(v58[281].Flink) - 8;
            v61 = v57 + 4;
            memmove(v57 + 4, v58[280].Blink, LOWORD(v58[281].Flink));
            memset_0((char *)v61 + LOWORD(Flink[281].Flink), 0, v60);
            v53 = v149;
            *(_WORD *)(v149 + 4) |= 1u;
            v22 = v53 + 80;
          ...
          if ( v81 )
          {
            ...
            else
            {
              ...
              if ( !v142 || (char *)v142 + v80 < v142 || (char *)v142 + v80 > v161 || !v122 )
                goto LABEL_135;
              if ( (_DWORD)v80 && (v80 + v26 > 0x7FFFFFFF0000LL || v80 + v26 < v26) )
              {
                v46 = v116;
                v22 = (__int64)v142;
              }
...
LABEL_135:
        ...
        *(_DWORD *)(v53 + 12) = v89[1].CycleTime;
        ...
        if ( *(_QWORD *)(v90 + 1552) )
        {
          EtwpInvokeEventCallback(v90, (__int64 *)&v162, v137 + 40);
          goto LABEL_10;
        }
      }
      else
    ...
    v33 = v131;
    if ( v43 )
      ExReleaseRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v42 + *(_QWORD *)(v131 + 704)), 1u);
  }
  while ( v132 != 3 );
  v109 = -1073741816;
  v26 = 3221226238LL;
...
LABEL_186:
      ExReleaseRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v33 + 704) + 8LL * **v91), 1u);
      ++i;
    }
  }
