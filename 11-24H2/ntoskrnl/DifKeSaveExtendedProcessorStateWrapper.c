/*
 * XREFs of DifKeSaveExtendedProcessorStateWrapper @ 0x14062ED60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeSaveExtendedProcessorStateWrapper(ULONG64 Mask, PXSTATE_SAVE XStateSave)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(250);
  ...
  DWORD2(v16) = KeSaveExtendedProcessorState(Mask, XStateSave);
  if ( v6 )
  {
