/*
 * XREFs of RtlpHpFixedVsAllocate @ 0x1404A3AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlFindClearRunsEx @ 0x1404A3BA4 (RtlFindClearRunsEx.c)
 */
...
__int64 __fastcall RtlpHpFixedVsAllocate(__int64 a1, unsigned int a2, _DWORD *a3, _DWORD *a4)
{
  ...
  if ( (*(_DWORD *)(a1 + 20) & 0x8000000) != 0 )
    ...
    v8 = RtlpHpAcquireLockExclusive((int *)(a1 + 24), *(unsigned __int8 *)(a1 + 32), (__int64)a3);
  v9 = a1 ^ *(_QWORD *)(a1 + 56);
  v14[0] = *(_QWORD *)(a1 + 48);
  v14[1] = v9;
