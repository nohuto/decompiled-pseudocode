/*
 * XREFs of MiAllocateProcessVads @ 0x1408F8DC8
 * Callers:
...
_QWORD *__fastcall MiAllocateProcessVads(__int64 a1, __int64 a2)
{
  ...
  Vad = (_QWORD *)MiAllocateVad(0x7FFE0000uLL, 0x7FFE0FFFuLL, 1);
  if ( !Vad )
    return 0LL;
  if ( !qword_140E2DA78 )
    goto LABEL_5;
  v5 = (_QWORD *)MiAllocateVad(qword_140E2DA78, qword_140E2DA78 + 4095, 1);
  if ( v5 )
  {
    *v5 = Vad;
    Vad = v5;
