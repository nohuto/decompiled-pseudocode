/*
 * XREFs of sub_140BD9DF0 @ 0x140BD9DF0
 * Callers:
 *     <none>
 * Callees:
 *     sub_140BD8384 @ 0x140BD8384 (sub_140BD8384.c)
 *     KeGuardDispatchICall @ 0x140BDAA60 (KeGuardDispatchICall.c)
 *     RtlMinimalBarrier @ 0x140BDABE4 (RtlMinimalBarrier.c)
 */

__int64 __fastcall sub_140BD9DF0(__int64 a1)
{
  _DWORD *v2; // rcx
  char *v3; // rax
  int v4; // ecx
