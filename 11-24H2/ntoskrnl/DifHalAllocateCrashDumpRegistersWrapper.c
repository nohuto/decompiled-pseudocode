/*
 * XREFs of DifHalAllocateCrashDumpRegistersWrapper @ 0x140620770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifHalAllocateCrashDumpRegistersWrapper(PADAPTER_OBJECT AdapterObject, PULONG NumberOfMapRegisters)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(374);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = AdapterObject;
    *((_QWORD *)&v15 + 1) = NumberOfMapRegisters;
  ...
  *((_QWORD *)&v16 + 1) = HalAllocateCrashDumpRegisters(AdapterObject, NumberOfMapRegisters);
  if ( v6 )
  {
