/*
 * XREFs of DifHalAllocateCrashDumpRegistersWrapper @ 0x1406221B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifHalAllocateCrashDumpRegistersWrapper(PADAPTER_OBJECT AdapterObject, PULONG NumberOfMapRegisters)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *(_QWORD *)&v20 = AdapterObject;
    *((_QWORD *)&v19 + 1) = NumberOfMapRegisters;
  ...
  *((_QWORD *)&v20 + 1) = HalAllocateCrashDumpRegisters(AdapterObject, NumberOfMapRegisters);
  if ( v8 )
  {
