/*
 * XREFs of SmKmStoreAdd @ 0x140A432D4
 * Callers:
  ...
  for ( i = 0LL; (unsigned int)i < 0x20; i = (unsigned int)(i + 1) )
  {
    if ( !*(_QWORD *)(a1 + 8 * i) )
    {
      ...
      if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 416), 0LL) )
        ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 416), (__int64)v26, a1 + 416);
      if ( v27 )
        *((_BYTE *)v27 + 10) = 1;
      if ( !*(_QWORD *)(a1 + 8 * i) )
      {
...
LABEL_13:
  ...
  v16 = v15;
  if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 416), 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 416), (__int64)v15, a1 + 416);
  if ( v16 )
    *((_BYTE *)v16 + 10) = 1;
  if ( (*v29 & 0x100) == 0 )
    goto LABEL_19;
...
LABEL_19:
    ...
    *(_QWORD *)v5 = a2;
    ...
    ExAcquireRundownProtection((PEX_RUNDOWN_REF)(v5 + 8));
