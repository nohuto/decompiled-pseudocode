/*
 * XREFs of MiEmptyPte @ 0x140287AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiEmptyPte(__int64 a1, unsigned __int64 a2, int a3)
{
    ...
    && ((v14 & 0x42) == 0 || (v14 & 0x20) == 0) )
  {
    ...
    if ( v31 )
    {
      ...
      if ( KernelWaitTime )
      {
        v34 = *(_QWORD *)(KernelWaitTime + 8 * ((a2 >> 3) & 0x1FF));
        if ( (v34 & 0x20) != 0 )
          v32 |= 0x20uLL;
        v14 = v32 | 0x42;
        if ( (v34 & 0x42) == 0 )
  ...
  if ( v15 < 0xFFFFF68000000000uLL || (v17 = 1LL, v15 > 0xFFFFF6FFFFFFFFFFuLL) )
    v17 = 0LL;
  if ( !(_DWORD)v17 || (*(_QWORD *)(v16 + 24) & 0x3FFFFFFFFFFFFFFFLL) == 1 && !(unsigned int)MiIsPageTableLocked(v9, a2) )
  {
    ...
    if ( (unsigned __int16)*(_DWORD *)(v16 + 32) <= 1u || (*(_DWORD *)(v9 + 184) & 0xF) == 0 )
    {
      ...
      else
      {
        ...
        v18 = (ULONG *)*((_QWORD *)qword_140E2FF88 + v17);
      }
      if ( !v18[4363]
...
LABEL_33:
        ...
        {
          v37 = *(_DWORD *)(v10 + 16);
          if ( (v37 & 4) == 0 && v15 >= 0xFFFFF68000000000uLL && v15 <= 0xFFFFF6FFFFFFFFFFuLL )
            *(_DWORD *)(v10 + 16) = v37 | 4;
        }
LABEL_34:
        for ( i = 0; ; i = 1 )
        ...
        while ( v22 )
        {
          ...
          if ( (unsigned __int64)(v22 - 1) <= 0x3FF )
            v35 = v22;
          *(_QWORD *)(v10 + 8 * v24 + 40) = v15 & 0xFFFFFFFFFFFFF000uLL | ((_WORD)v35 - 1) & 0x3FF;
          v36 = *(_DWORD *)(v10 + 28);
          *(_QWORD *)(v10 + 32) += v35;
