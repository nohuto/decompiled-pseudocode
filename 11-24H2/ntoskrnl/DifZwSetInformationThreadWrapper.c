/*
 * XREFs of DifZwSetInformationThreadWrapper @ 0x140647080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationThreadWrapper(void *a1, THREADINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  DWORD2(v20) = ZwSetInformationThread(a1, a2, a3, a4);
  if ( v9 )
  {
