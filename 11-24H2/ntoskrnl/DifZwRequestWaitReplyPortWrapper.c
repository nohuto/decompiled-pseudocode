/*
 * XREFs of DifZwRequestWaitReplyPortWrapper @ 0x1406459E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PPORT_MESSAGE ReplyMessage)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    *(_QWORD *)&v18 = RequestMessage;
    *((_QWORD *)&v17 + 1) = ReplyMessage;
  ...
  LODWORD(v19) = ZwRequestWaitReplyPort(PortHandle, RequestMessage, ReplyMessage);
  if ( v8 )
  {
