/*
 * XREFs of WmipRegisterFirmwareProviders @ 0x140C3CB5C
 * Callers:
...
__int64 WmipRegisterFirmwareProviders()
{
  ...
  v6 = PnpDriverObject;
  result = NtSetSystemInformation(75LL, (unsigned __int64)&v1, 24LL);
  if ( dword_140EFEAF0 == 1 )
  {
    ...
    v6 = PnpDriverObject;
    return NtSetSystemInformation(75LL, (unsigned __int64)&v1, 24LL);
  }
  return result;
}
