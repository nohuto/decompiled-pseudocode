/*
 * XREFs of DrvDbGetDeviceIdDriverInfMatches @ 0x140993BAC
 * Callers:
    ...
    if ( v22 )
    {
      ...
      if ( Pool2 )
      {
        for ( i = 0; i < v22; ++i )
        {
          ...
          {
            LODWORD(a5) = 4;
            v13 = RegRtlEnumValue(v7, i, Pool2, &v25, v24, &v23, (unsigned int *)&a5);
            if ( v13 < 0 )
            {
              InfoKey = 0;
              if ( v13 != -2147483622 )
          ...
          {
            InfoKey = RegRtlEnumValue(v7, i, Pool2, &v25, v24, 0LL, 0LL);
            if ( InfoKey < 0 )
            {
              v21 = 0;
