/*
 * XREFs of DifMmAllocatePagesForMdlWrapper @ 0x140632A30
 * Callers:
 *     <none>
 * Callees:
        ...
        SIZE_T a4)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    *(PHYSICAL_ADDRESS *)&v23 = LowAddress;
    *((PHYSICAL_ADDRESS *)&v22 + 1) = HighAddress;
    *(PHYSICAL_ADDRESS *)&v22 = SkipBytes;
    *((_QWORD *)&v21 + 1) = a4;
  ...
  *((_QWORD *)&v23 + 1) = MmAllocatePagesForMdl(LowAddress, HighAddress, SkipBytes, a4);
  if ( v11 )
  {
