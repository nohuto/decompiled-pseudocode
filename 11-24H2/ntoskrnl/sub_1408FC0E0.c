/*
 * XREFs of sub_1408FC0E0 @ 0x1408FC0E0
 * Callers:
...
__int64 __fastcall sub_1408FC0E0(__int64 a1, __int64 a2, _QWORD *a3, int *a4)
{
  _QWORD *v4; // rsi
  int v5; // r14d
  int v6; // r12d
  ...
  while ( v6 <= v5 )
  {
    ...
    {
      v14 = sub_1408FCCD0(v13, a2, 8LL);
    }
    else if ( v12 == sub_1408FCD00 )
    {
      v14 = sub_1408FCD00(v13, a2, 8LL);
    }
    else if ( v12 == sub_1408FCD30 )
    {
      v14 = sub_1408FCD30(v13, a2, 8LL);
    }
    else
    {
      v14 = guard_dispatch_icall_no_overrides(v13, a2, 8LL, a4);
    }
    v15 = v14 < 0;
    if ( !v14 )
    {
