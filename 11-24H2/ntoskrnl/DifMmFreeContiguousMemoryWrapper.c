/*
 * XREFs of DifMmFreeContiguousMemoryWrapper @ 0x1406317A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmFreeContiguousMemoryWrapper(PVOID BaseAddress)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(226);
