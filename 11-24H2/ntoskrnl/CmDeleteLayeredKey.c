/*
 * XREFs of CmDeleteLayeredKey @ 0x14041AAA8
 * Callers:
 ...
 *     CmpInitializeKcbStack @ 0x1409A1630 (CmpInitializeKcbStack.c)
 ...
 *     CmpInitializeDiscardReplaceContext @ 0x140A4AE64 (CmpInitializeDiscardReplaceContext.c)
