/*
 * XREFs of sub_1409E0950 @ 0x1409E0950
 * Callers:
...
__int64 __fastcall sub_1409E0950(__int64 *a1, int a2, _DWORD *a3)
{
  void *v6; // rsi
  int v7; // ebx
  __int64 v8; // rdx
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v9 >= 0 )
      {
              ...
              v7 >= 0) )
        {
          ...
          v30 = *(_OWORD *)(v10 + 224);
          v13 = v17;
          sub_1404081B0((__int64)&v20, (char *)v6, v17, v12, *(_QWORD *)(v10 + 72), v11, v15);
          v16 = 0;
          if ( !a2
            || (v7 = sub_14046A994(
                       a1[5],
