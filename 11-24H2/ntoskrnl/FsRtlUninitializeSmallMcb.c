/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x140BDC800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(__int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 2080) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 640))(CompleteDev + 2080, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 2024);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 264);
  v5 = *(unsigned int *)(CompleteDev + 2052);
  v6 = *(_QWORD *)(CompleteDev + 2032);
  ...
  v9 = (unsigned __int64 *)&loc_140BDC886;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
