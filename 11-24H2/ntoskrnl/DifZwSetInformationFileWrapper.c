/*
 * XREFs of DifZwSetInformationFileWrapper @ 0x1406468A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationFileWrapper(
        void *a1,
        ...
        FILE_INFORMATION_CLASS FileInformationClass)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(18);
  ...
  DWORD2(v21) = ZwSetInformationFile(a1, a2, a3, a4, FileInformationClass);
  if ( v10 )
  {
