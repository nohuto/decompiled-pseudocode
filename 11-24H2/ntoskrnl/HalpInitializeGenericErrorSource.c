/*
 * XREFs of HalpInitializeGenericErrorSource @ 0x140B4E2D4
 * Callers:
 *     HalpInitializeErrSrc @ 0x140B4BB90 (HalpInitializeErrSrc.c)
 * Callees:
 *     MmMapIoSpaceEx @ 0x1402E9A50 (MmMapIoSpaceEx.c)
 *     HalpRegisterPeiErrorSource @ 0x140554798 (HalpRegisterPeiErrorSource.c)
  ...
  switch ( *(_BYTE *)(a2 + 64) )
  {
    case 0:
      ...
      *((_QWORD *)P + 2) = MEMORY[0xFFFFF78000000320];
      if ( inited < 0 )
        return v5;
      v21 = (_QWORD *)qword_140FC0798;
      if ( *(__int64 **)qword_140FC0798 == &HalpGenericPolledErrorSourceListHead )
      {
        v22 = HalpGenericPollingInitDone == 0;
        *v20 = &HalpGenericPolledErrorSourceListHead;
        v20[1] = v21;
        *v21 = v20;
        qword_140FC0798 = (__int64)v20;
        if ( v22 )
        {
    ...
    case 4:
      ...
      if ( v14 >= 0 )
      {
        ...
        v18 = (_QWORD *)qword_140FC08B8;
        if ( *(__int64 **)qword_140FC08B8 != &HalpGenericNmiErrorSourceListHead )
          goto LABEL_56;
        *v15 = &HalpGenericNmiErrorSourceListHead;
        v15[1] = v18;
        *v18 = v15;
        qword_140FC08B8 = (__int64)v15;
      }
    ...
    case 8:
      ...
      if ( v11 >= 0 )
      {
        v12 = (_QWORD *)qword_140FC0788;
        if ( *(__int64 **)qword_140FC0788 != &HalpGenericSeaErrorSourceListHead )
          goto LABEL_56;
        v13 = P;
        *(_QWORD *)P = &HalpGenericSeaErrorSourceListHead;
        v13[1] = v12;
        *v12 = v13;
        qword_140FC0788 = (__int64)v13;
      }
    ...
    case 9:
      ...
      if ( v8 >= 0 )
      {
        v9 = (_QWORD *)qword_140FC0778;
        if ( *(__int64 **)qword_140FC0778 != &HalpGenericSeiErrorSourceListHead )
          goto LABEL_56;
        v10 = P;
        *(_QWORD *)P = &HalpGenericSeiErrorSourceListHead;
        v10[1] = v9;
        *v9 = v10;
        qword_140FC0778 = (__int64)v10;
      }
    ...
    case 0xA:
      ...
      if ( (v5 & 0x80000000) != 0 )
        return v5;
      v7 = (_QWORD *)qword_140FC0768;
      if ( *(__int64 **)qword_140FC0768 == &HalpGenericPeiErrorSourceListHead )
      {
        *v6 = &HalpGenericPeiErrorSourceListHead;
        v6[1] = v7;
        *v7 = v6;
        qword_140FC0768 = (__int64)v6;
LABEL_59:
