/*
 * XREFs of DifZwQueryFullAttributesFileWrapper @ 0x140644CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryFullAttributesFileWrapper(
        ...
        PFILE_NETWORK_OPEN_INFORMATION FileInformation)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(52);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *(_QWORD *)&v20 = ObjectAttributes;
    *((_QWORD *)&v19 + 1) = FileInformation;
  ...
  DWORD2(v20) = ZwQueryFullAttributesFile(ObjectAttributes, FileInformation);
  if ( v8 )
  {
