/*
 * XREFs of DifZwQueryFullAttributesFileWrapper @ 0x140643280
 * Callers:
 *     <none>
 * Callees:
        ...
        PFILE_NETWORK_OPEN_INFORMATION FileInformation)
{
  ...
  DWORD2(v16) = ZwQueryFullAttributesFile(ObjectAttributes, FileInformation);
  if ( v6 )
  {
