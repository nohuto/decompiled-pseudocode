/*
 * XREFs of DifKeSynchronizeExecutionWrapper @ 0x140630DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SynchronizeContext)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = Interrupt;
    *(_QWORD *)&v22 = SynchronizeRoutine;
    *((_QWORD *)&v21 + 1) = SynchronizeContext;
  ...
  LOBYTE(v23) = KeSynchronizeExecution(Interrupt, SynchronizeRoutine, SynchronizeContext);
  if ( v10 )
  {
