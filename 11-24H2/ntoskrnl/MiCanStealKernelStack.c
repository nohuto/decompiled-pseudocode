/*
 * XREFs of MiCanStealKernelStack @ 0x140430A58
 * Callers:
...
_BOOL8 __fastcall MiCanStealKernelStack(__int64 a1, __int16 a2)
{
  ...
  v2 = a2;
  v3 = a1;
  return 0xAAAAAAAAAAAAAAABuLL * ((a1 + 0x220000000000LL) >> 4) <= qword_140E2DBE0
      && ((*(_QWORD *)(16 * ((a1 + 0x220000000000LL) >> 4) - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0
      && ((*(_QWORD *)(a1 + 40) >> 60) & 7) == 2
      && ((byte_140E2DAC9 & 1) != 0 || ((MiGetPfnKernelStack(a1, 1LL) + 32) & 0xFFFFFFFFFFFFFFDFuLL) != 0)
      && (*(_BYTE *)(v3 + 34) & 7) == 6
