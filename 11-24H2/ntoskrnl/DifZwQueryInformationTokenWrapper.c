/*
 * XREFs of DifZwQueryInformationTokenWrapper @ 0x140643E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationTokenWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQueryInformationToken(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
