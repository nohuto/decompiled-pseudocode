/*
 * XREFs of BiResolveLocateDevice @ 0x140812B7C
 * Callers:
  ...
  if ( !v6 )
  {
    ...
    if ( (v7 & 0xF000000) == 0x2000000 )
    {
      ...
      if ( ElementData != -1073741789 )
        goto LABEL_16;
      Pool2 = (WCHAR *)ExAllocatePool2(0x102uLL, BufferSize, 0x4B444342u);
      v5 = Pool2;
      if ( !Pool2 )
        goto LABEL_6;
...
LABEL_10:
  ...
  Destination.Buffer = (wchar_t *)ExAllocatePool2(0x102uLL, (unsigned __int16)(2 * (v12 + v11) + 2), 0x4B444342u);
