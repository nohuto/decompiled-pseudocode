/*
 * XREFs of PopDirectedDripsDiagBroadcastTreeEnd @ 0x140763FF0
 * Callers:
...
void __fastcall PopDirectedDripsDiagBroadcastTreeEnd(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( a1 )
  {
    ...
    v10 = v8;
    if ( v9 )
      ExfAcquirePushLockExclusiveEx(&PopDirectedDripsDiagLock, (__int64)v8, (__int64)&PopDirectedDripsDiagLock);
    if ( v10 )
      *((_BYTE *)v10 + 10) = 1;
    if ( a2 < 0
