/*
 * XREFs of IopQueryInformation @ 0x1409D4F90
 * Callers:
...
__int64 __fastcall IopQueryInformation(__int64 a1, struct _DEVICE_OBJECT *a2, __int64 a3, __int64 a4, _BYTE *a5)
{
    ...
    if ( FastIoDispatch )
    {
      if ( FastIoDispatch->SizeOfFastIoDispatch > 0xC0 )
      {
        ...
        if ( FastIoQueryOpen )
        {
          ...
          *v9 = guard_dispatch_icall_no_overrides(a3, *(_QWORD *)(a1 + 104), a2, a4);
          if ( v8 )
  ...
  result = FsRtlGetSupportedFeatures((__int64)a2, &v16, a3, a4);
  if ( (int)result >= 0 )
  {
    if ( (v16 & 4) == 0 )
    {
