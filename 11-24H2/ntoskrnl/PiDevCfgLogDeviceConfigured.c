/*
 * XREFs of PiDevCfgLogDeviceConfigured @ 0x140A98C04
 * Callers:
...
void __fastcall PiDevCfgLogDeviceConfigured(__int64 a1, __int64 a2, __int64 a3, int a4, int a5, __int64 a6, int *a7)
{
  ...
  const wchar_t *v127; // [rsp+98h] [rbp-C8h]
  const wchar_t *v128; // [rsp+C8h] [rbp-98h]
  ...
  *(_QWORD *)&v154.Year = 0LL;
  ...
  if ( a3 )
  {
    ...
    v176 = 17;
    v178 = 1;
    if ( (int)PiDevCfgQueryObjectProperties(18LL, v14, 8u, v13, (__int64)&v159, 4u) < 0 )
    {
LABEL_203:
      v101 = v137;
      goto LABEL_204;
...
LABEL_202:
  ...
  if ( v80 != (__int64 *)(a3 + 208) )
  {
    ...
    do
    {
      ...
      p_UnicodeString = (UNICODE_STRING *)&v158;
      v162 = 6;
      ...
      v171 = 8210;
      v176 = 18;
      if ( (int)PiDevCfgQueryObjectProperties(18LL, v84, 8u, v83, (__int64)&v159, 4u) >= 0 )
      {
...
LABEL_187:
    ...
    v162 = 6;
    v165 = 17;
    if ( (int)PiDevCfgQueryObjectProperties(v116, *(WCHAR **)(v139 + 8), 1u, *(void **)(v139 + 16), (__int64)&v159, 2u) >= 0 )
    {
      if ( v163 < 0 )
