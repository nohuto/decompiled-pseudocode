/*
 * XREFs of KiAdjustTimer2DueTimes @ 0x1404551A0
 * Callers:
 ...
 *     KiShouldActivateHRTimerClock @ 0x1404553DC (KiShouldActivateHRTimerClock.c)
...
LABEL_31:
  ...
  while ( v4 < (__int64)&KiHrTimerActiveCount );
  v21 = 0;
  if ( v3 != v28 )
  {
    do
