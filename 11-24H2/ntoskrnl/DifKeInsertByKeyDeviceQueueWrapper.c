/*
 * XREFs of DifKeInsertByKeyDeviceQueueWrapper @ 0x14062E0F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG SortKey)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = DeviceQueue;
    *(_QWORD *)&v22 = DeviceQueueEntry;
    DWORD2(v21) = SortKey;
  ...
  LOBYTE(v23) = KeInsertByKeyDeviceQueue(DeviceQueue, DeviceQueueEntry, SortKey);
  if ( v10 )
  {
