/*
 * XREFs of DifRtlQueryRegistryValueWithFallbackWrapper @ 0x14063A0B0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG *ResultLength)
{
  ...
  ULONG v26; // [rsp+68h] [rbp-11h]
  UNICODE_STRING *v27; // [rsp+70h] [rbp-9h]
  void *v28; // [rsp+78h] [rbp-1h]
  void *v29; // [rsp+80h] [rbp+7h]
