/*
 * XREFs of AlpcpInitializeMessageLog @ 0x140742C30
 * Callers:
...
__int64 __fastcall AlpcpInitializeMessageLog(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  qword_140F0F278 = (__int64)&AlpcpMessageLogListHead;
  AlpcpMessageLogListHead = (__int64)&AlpcpMessageLogListHead;
  qword_140F0F268 = (__int64)&AlpcpFreeMessageLogListHead;
  AlpcpFreeMessageLogListHead = (__int64)&AlpcpFreeMessageLogListHead;
  qword_140F0F258 = (__int64)&AlpcpFreeMessageSnapshotListHead;
...
LABEL_9:
    ...
    if ( a1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13[7] = v13 + 6;
        v13[6] = v13 + 6;
        v14 = (_QWORD *)qword_140F0F268;
        if ( *(__int64 **)qword_140F0F268 != &AlpcpFreeMessageLogListHead )
          break;
        v13[1] = qword_140F0F268;
        ++v11;
        *v13 = &AlpcpFreeMessageLogListHead;
        *v14 = v13;
        v12 = v11;
        qword_140F0F268 = (__int64)v13;
        if ( v11 >= a1 )
          goto LABEL_16;
      }
LABEL_21:
