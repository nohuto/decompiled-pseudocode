/*
 * XREFs of ?SmStDirectReadCallout@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAX@Z @ 0x14027C730
 * Callers:
...
void __fastcall SMKM_STORE<SM_TRAITS>::SmStDirectReadCallout(PVOID Parameter)
{
  ...
  *((_DWORD *)Parameter + 6) = 0;
  ...
  if ( v4 != -1073741550 )
  {
    SMKM_STORE<SM_TRAITS>::SmStDirectReadComplete(*(_QWORD *)Parameter, *((struct _SLIST_ENTRY **)Parameter + 1), v4);
