/*
 * XREFs of WmipGetGuidSecurityDescriptor @ 0x1409B4974
 * Callers:
...
__int64 __fastcall WmipGetGuidSecurityDescriptor(__int64 a1, PVOID *a2)
{
  ...
  __int64 (__fastcall *v21)(__int64, int, void *, ULONG, __int64, _QWORD *); // [rsp+98h] [rbp-68h]
  ...
  *a2 = 0LL;
  ...
  while ( 1 )
  {
    if ( BufferLengthIn )
    {
      Pool2 = (WCHAR *)ExAllocatePool2(0x100uLL, BufferLengthIn, 0x70696D57u);
      if ( !Pool2 )
        return 3221225626LL;
    }
