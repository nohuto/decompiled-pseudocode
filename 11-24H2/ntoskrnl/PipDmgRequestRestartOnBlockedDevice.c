/*
 * XREFs of PipDmgRequestRestartOnBlockedDevice @ 0x14072FEC0
 * Callers:
...
LABEL_32:
  ...
  result = PnpRequestDeviceAction(Object, 0x19u, 1, 0LL, 0LL, 0LL, 0LL);
  if ( (int)result >= 0 )
    return PnpRequestDeviceAction(Object, 0x10u, 0, 0LL, 0LL, 0LL, 0LL);
  return result;
}
