/*
 * XREFs of DifExAcquireSharedWaitForExclusiveWrapper @ 0x14061A5E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireSharedWaitForExclusiveWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(420);
  ...
  BYTE8(v16) = ExAcquireSharedWaitForExclusive(Resource, a2);
  if ( v6 )
  {
