/*
 * XREFs of MiInitializeSystemImageRegion @ 0x140C5B698
 * Callers:
...
__int64 __fastcall MiInitializeSystemImageRegion(__int64 a1)
{
  ...
  while ( v6 );
  MxMarkActiveDriverBits((unsigned int)&qword_140E2EEF0, v3, v4, (unsigned int)&v15, 3);
  v7 = qword_140E2EEF8;
  v8 = (_QWORD *)((((unsigned __int64)qword_140E2EEF8 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  for ( i = 0LL; i < qword_140E2EEF0; i += 0x8000LL )
  {
    if ( (*v8 & 0x800LL) == 0 )
    {
      if ( !(unsigned int)MiSplitBitmapPages(4LL) )
        return 0LL;
      RtlClearBitsEx((__int64)&qword_140E2EEF0, i, 0x8000uLL);
    }
    v7 += 4096LL;
    ++v8;
  }
  ...
  while ( !(_DWORD)v10 )
  {
    ...
    if ( !Pool )
      return 0LL;
    v10 = 1LL;
    qword_140E2D848[0] = v12;
    qword_140E2D848[1] = Pool;
  }
  ...
  MiFreeKernelPadSections(
    *(_QWORD *)(qword_140E2D840[0] + 48),
    *(_QWORD *)(qword_140E2D840[0] + 48) + *(_DWORD *)(qword_140E2D840[0] + 64));
  return 1LL;
}
