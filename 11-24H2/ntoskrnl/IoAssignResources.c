/*
 * XREFs of IoAssignResources @ 0x14071A1E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PCM_RESOURCE_LIST *AllocatedResources)
{
  ...
  v16 = (int)RequestedResources;
  if ( RequestedResources && (!RequestedResources->AlternativeLists || !RequestedResources->List[0].Count) )
    v16 = 0;
  if ( AllocatedResources )
    *AllocatedResources = 0LL;
  return IopLegacyResourceAllocation(2, (_DWORD)DriverObject, (_DWORD)DeviceObject, v16, (__int64)AllocatedResources);
}
