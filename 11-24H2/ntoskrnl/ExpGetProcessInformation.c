/*
 * XREFs of ExpGetProcessInformation @ 0x140ADAE00
 * Callers:
 ...
 *     PsGetProcessActiveThreadCount @ 0x1404C7B80 (PsGetProcessActiveThreadCount.c)
...
LABEL_211:
          ...
          *(_DWORD *)(v24 + 56) = 0;
          ...
          {
            v26 = qword_140E2DBE8 << 12;
            *(_QWORD *)(v24 + 144) = qword_140E2DBE8 << 12;
            *(_QWORD *)(v24 + 8) = v26;
          }
          if ( v22 < 0 )
          {
LABEL_210:
        ...
        if ( a5 == 148 )
        {
          ...
          ObFastDereferenceObject(NextProcess + 73, v49, 0x746C6644u);
          v51 = Size[0];
    ...
    if ( a5 != 253 )
    {
      ...
      {
        if ( Object == (char **)PsInitialSystemProcess )
        {
          v55 = ExpSystemProcessName;
        }
        else if ( Object == (char **)PsSecureSystemProcess )
        {
