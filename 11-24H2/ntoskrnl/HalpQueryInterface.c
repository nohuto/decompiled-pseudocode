/*
 * XREFs of HalpQueryInterface @ 0x140AA9A00
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  v11 = *a2 - *(_QWORD *)&GUID_ACPI_CMOS_INTERFACE_STANDARD.Data1;
  if ( *a2 == *(_QWORD *)&GUID_ACPI_CMOS_INTERFACE_STANDARD.Data1 )
    v11 = a2[1] - *(_QWORD *)GUID_ACPI_CMOS_INTERFACE_STANDARD.Data4;
  if ( !v11 )
  {
    if ( a5 < 0x30 )
    {
  ...
  v12 = *a2 - *(_QWORD *)&GUID_DMA_CACHE_COHERENCY_INTERFACE.Data1;
  if ( *a2 == *(_QWORD *)&GUID_DMA_CACHE_COHERENCY_INTERFACE.Data1 )
    v12 = a2[1] - *(_QWORD *)GUID_DMA_CACHE_COHERENCY_INTERFACE.Data4;
  if ( v12 )
    return 3221225659LL;
  *a7 = 0;
  if ( a5 >= 0x28 )
