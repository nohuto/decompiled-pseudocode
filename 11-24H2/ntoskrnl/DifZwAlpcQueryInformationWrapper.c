/*
 * XREFs of DifZwAlpcQueryInformationWrapper @ 0x14063ABC0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(136);
  ...
  LODWORD(v21) = ZwAlpcQueryInformation(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
