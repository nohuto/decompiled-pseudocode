/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x1409F8090
 * Callers:
 *     IoUpdateLinkShareAccess @ 0x140714EB0 (IoUpdateLinkShareAccess.c)
 *     IoUpdateShareAccess @ 0x1409F8070 (IoUpdateShareAccess.c)
 * Callees:
 *     <none>
 */
