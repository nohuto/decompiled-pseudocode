/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x1409F0A00
 * Callers:
 *     IoUpdateLinkShareAccess @ 0x140712A40 (IoUpdateLinkShareAccess.c)
 *     IoUpdateShareAccess @ 0x1409F09E0 (IoUpdateShareAccess.c)
 * Callees:
 *     <none>
 */
