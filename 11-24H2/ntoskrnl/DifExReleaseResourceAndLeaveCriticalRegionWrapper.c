/*
 * XREFs of DifExReleaseResourceAndLeaveCriticalRegionWrapper @ 0x14061F100
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseResourceAndLeaveCriticalRegionWrapper(PERESOURCE Resource)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(388);
