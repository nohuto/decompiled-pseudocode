...
__int64 PfpPrefetchEntireDirectory(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, ...)
{
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  v10 = PfpOpenHandleCreate((unsigned int)&Handle, a1, v9, v8, 1048577, 16417, 0, a2);
  v11 = v19;
  v12 = v10;
  if ( v10 >= 0 )
  {
    if ( a4 )
    {
      ...
      if ( (int)IopQueryXxxInformation(BugCheckParameter2[0], (__int64)&v15, (__int64)va, 1) >= 0 )
      {
        *(_QWORD *)(a4 + 12) = v15;
