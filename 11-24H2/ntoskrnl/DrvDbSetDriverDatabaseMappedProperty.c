/*
 * XREFs of DrvDbSetDriverDatabaseMappedProperty @ 0x140822E34
 * Callers:
...
LABEL_27:
    ...
    for ( i = 0; ; ++i )
    {
      if ( i >= 8 )
      {
        ...
        if ( Handle )
          v41 = (int)Handle;
        DatabaseNode = DrvDbSetRegValueMappedProperty(v41, v41, (_DWORD)v7, a5, (__int64)SourceString, a7);
        if ( DatabaseNode >= 0 && v48 && (*(_DWORD *)(v48 + 64) & 0x10) != 0 && *(_DWORD *)(a4 + 16) == 14 )
        {
          ...
          if ( !v43 && a5 )
          {
            if ( a7 >= 2 && SourceString && !SourceString[((unsigned __int64)a7 >> 1) - 1] )
            {
              ...
              ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v45 + 152), 1u);
              RtlFreeAnsiString((PUNICODE_STRING)(v45 + 48));
              v46 = DestinationString;
              *(_DWORD *)(v45 + 40) = 0;
              *(UNICODE_STRING *)(v45 + 48) = v46;
              v29 = *(struct _ERESOURCE **)(v45 + 152);
              goto LABEL_123;
            }
            goto LABEL_124;
          }
    ...
    switch ( v24 )
    {
      case 5:
        ...
        if ( a5 == 17 && a7 == 1 && SourceString )
        {
          ...
          ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v27 + 152), 1u);
          if ( *(_BYTE *)SourceString == 0xFF )
            v28 = DrvDbLoadDatabaseNode(a1, v27);
          else
            v28 = DrvDbUnloadDatabaseNode(a1, v27);
          v29 = *(struct _ERESOURCE **)(v27 + 152);
          DatabaseNode = v28;
LABEL_123:
