/*
 * XREFs of KiInitDynamicTraceSupport @ 0x140C2A2A0
 * Callers:
...
__int64 KiInitDynamicTraceSupport()
{
  ...
  if ( !(_BYTE)KdDebuggerNotPresent )
    v0 = 5;
  v1 = v0 | 2;
  result = TraceInitSystem(&v5, KiDynamicTraceCallouts, &qword_140FC6408);
  if ( (int)result >= 0 )
  {
    v3 = RtlLookupFunctionEntry(qword_140FC6408, &v4, 0LL);
    if ( v3 )
    {
      qword_140FC6408 = v4 + *v3;
      qword_140FC6410 = v4 + v3[1];
    }
    result = (__int64)v5;
