/*
 * XREFs of LZNT1DecompressChunkWorkItem @ 0x140439050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall LZNT1DecompressChunkWorkItem(char *P)
{
  ...
  ++unk_140E282DC;
  if ( LOWORD(RtlLznt1DecompressChunkLookaside.Alignment) >= unk_140E282D0 )
  {
    ++unk_140E282E0;
    if ( (void (__stdcall *)(PVOID))unk_140E282F8 == ExFreePool )
      ExFreePool(P);
    else
  ...
  {
    if ( (void (__stdcall *)(PPRIVILEGE_SET))unk_140E282F8 == CmSiFreeMemory )
    {
      ...
      if ( byte_140FCECA8 )
      {
        ...
        if ( &P[dword_140E282EC[0]] < P + 8 )
          KeBugCheckEx(0x1F1u, 2uLL, 3uLL, (ULONG_PTR)(P + 8), dword_140E282EC[0] - 8LL);
        v5 = (dword_140E282EC[0] - 8LL - (unsigned __int64)((LOBYTE(dword_140E282EC[0]) - 9) & 7) + 7) >> 3;
        if ( v5 )
        {
          LOBYTE(v3) = -116;
