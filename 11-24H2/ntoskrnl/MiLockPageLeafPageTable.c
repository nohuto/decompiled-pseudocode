/*
 * XREFs of MiLockPageLeafPageTable @ 0x140283A60
 * Callers:
      ...
      *(_QWORD *)(a1 + 40) = 0xFFFFF6FB7DBEDF68uLL;
      ...
      while ( 1 )
      {
        ...
        if ( v16 == 0xFFFFF6FB7DBEDF68uLL )
        {
          ...
          v18 = *(_DWORD *)(v2 + 184) & 0xF;
          if ( !v18 )
          {
            v19 = 2LL;
LABEL_40:
            KxReleaseQueuedSpinLock(&CurrentPrcb->SelfmapLockHandle[v19]);
            goto LABEL_24;
          }
          if ( v18 != 7 )
          {
          ...
          KxReleaseQueuedSpinLock(&CurrentPrcb->SelfmapLockHandle[1]);
               ...
               || (v20 = KeGetCurrentThread()->ApcState.Process[2].ActiveProcessors[5].StaticBitmap[7]) == 0 )
        {
          if ( (*(_DWORD *)(v2 + 184) & 0xF) != 0 && v16 >= 0xFFFFF6FB7DBED000uLL && v16 <= 0xFFFFF6FB7DBEDFFFuLL )
            _InterlockedAnd(
              &dword_140E2F0AC[(unsigned __int64)(2 * (unsigned int)((__int64)(v16 + 0x90482413000LL) >> 3)) >> 5],
        ...
        {
          ExReleaseSpinLockRegardlessFromDpcLevel(v20 + 4 * ((v16 >> 3) & 0x1FF));
        }
LABEL_24:
        *(_QWORD *)(a1 + 40) = v13;
        if ( v15 )
