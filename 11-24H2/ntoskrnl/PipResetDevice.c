/*
 * XREFs of PipResetDevice @ 0x140C23DB0
 * Callers:
...
__int64 __fastcall PipResetDevice(__int64 a1, const WCHAR *a2)
{
  ...
  if ( PipResetDeviceBreakOnReset )
    __debugbreak();
  v11 = 78;
  if ( (int)CmGetDeviceRegProp(a1, (__int64)a2, 0LL, 9u, (__int64)&v12, (__int64)SourceString, (__int64)&v11, 0) < 0
    || v12 != 1
    || v11 < 2
...
LABEL_14:
    ...
    if ( v5 >= 0 && v7 < 0 )
      v5 = v7;
    v11 = 4;
    if ( (int)CmGetDeviceRegProp(a1, (__int64)a2, 0LL, 0xBu, (__int64)&v12, (__int64)&v13, (__int64)&v11, 0) >= 0
      && v12 == 4
      && v11 == 4 )
    {
      v8 = v13;
    ...
    {
      v13 = v8 | 0x20;
      v9 = CmSetDeviceRegProp(a1, (__int64)a2, 0LL, 0xBu, 4, (__int64)&v13, 4, 0);
      if ( v5 >= 0 && v9 < 0 )
