/*
 * XREFs of sub_1406F418C @ 0x1406F418C
 * Callers:
...
__int64 __fastcall sub_1406F418C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  unsigned int *v8; // rax
  unsigned int i; // edx
  ...
  if ( v4 && *(_DWORD *)a1 > 3u )
  {
    ...
    Pool2 = (void *)ExAllocatePool2(0x100uLL, 0x800uLL, 0x20534C53u);
    if ( !Pool2 )
...
LABEL_88:
    ...
    *(_DWORD *)(a4 + 4) = 2080;
    v14 = 0;
    v24 = ExAllocatePool2(0x100uLL, 0x820uLL, 0x20534C53u);
    if ( v24 )
    {
      *(_QWORD *)(a4 + 8) = v24;
      *(_DWORD *)a4 = 0;
    ...
    if ( v34 )
    {
      ...
      if ( v34 + 1 < v34 )
        goto LABEL_65;
      if ( (unsigned __int64)(v34 + 513) > *(_QWORD *)(a4 + 8) + (unsigned __int64)*(unsigned int *)(a4 + 4) )
        goto LABEL_73;
      *v34 = 2048;
      memmove(v34 + 1, Pool2, 0x800uLL);
LABEL_75:
      ++*(_DWORD *)a4;
      v38 = *(_DWORD **)(a4 + 8);
      if ( !v38 )
