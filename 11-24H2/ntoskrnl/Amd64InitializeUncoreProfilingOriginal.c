/*
 * XREFs of Amd64InitializeUncoreProfilingOriginal @ 0x140569178
 * Callers:
...
void Amd64InitializeUncoreProfilingOriginal()
{
      ...
      do
      {
        ...
        *(_DWORD *)&Affinity.Group = (unsigned __int16)(v9 >> 6);
        ...
        if ( (Amd64PerfFeatures & 2) != 0 )
          Amd64InitializeDataFabricStatusOriginal(v11, v10);
        if ( (Amd64PerfFeatures & 4) != 0 )
          Amd64InitializeCacheStatusOriginal(v11, v10, v12, v13);
        v7 += 4LL;
        --v8;
      }
      while ( v8 );
