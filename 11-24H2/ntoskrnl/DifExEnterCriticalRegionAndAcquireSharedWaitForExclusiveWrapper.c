/*
 * XREFs of DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper @ 0x14061DFC0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper(PERESOURCE Resource)
{
  ...
  v18 = ExEnterCriticalRegionAndAcquireSharedWaitForExclusive(Resource);
  if ( v6 )
  {
