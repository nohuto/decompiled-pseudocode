/*
 * XREFs of WdipSemLoadScenarioTable @ 0x1407A1C18
 * Callers:
 ...
 *     WdipSemUpdateProviderEntryForEvent @ 0x1407A3550 (WdipSemUpdateProviderEntryForEvent.c)
...
LABEL_3:
        ...
        if ( v4 >= 0 )
        {
          ...
          if ( RtlGUIDFromString(&v31, &Guid) >= 0 )
          {
            ...
            {
              for ( i = 0; i < *((_DWORD *)WdipSemDisabledScenarioTable + 256); ++i )
              {
                v6 = 16LL * i;
                v7 = *(_QWORD *)&Guid.Data1 - *(_QWORD *)((char *)WdipSemDisabledScenarioTable + v6);
                if ( *(_QWORD *)&Guid.Data1 == *(_QWORD *)((char *)WdipSemDisabledScenarioTable + v6) )
                  v7 = *(_QWORD *)Guid.Data4 - *(_QWORD *)((char *)WdipSemDisabledScenarioTable + v6 + 8);
                if ( !v7 )
                  goto LABEL_3;
              }
            }
