/*
 * XREFs of DifZwOpenSectionWrapper @ 0x140640E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSectionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(75);
  ...
  LODWORD(v19) = ZwOpenSection(SectionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
