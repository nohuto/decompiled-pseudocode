/*
 * XREFs of VfSuspectExcludedDriversAllocateEntry @ 0x140B9D0D4
 * Callers:
...
__int64 __fastcall VfSuspectExcludedDriversAllocateEntry(unsigned __int16 *a1, unsigned int a2)
{
  __int64 Pool2; // rax
  __int64 v4; // rbx
  size_t v5; // r8
  ...
  Pool2 = ExAllocatePool2(0x40uLL, a1[1] + 32LL, a2);
  v4 = Pool2;
  if ( Pool2 )
  {
    v5 = *a1;
