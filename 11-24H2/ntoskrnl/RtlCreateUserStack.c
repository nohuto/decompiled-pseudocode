/*
 * XREFs of RtlCreateUserStack @ 0x1409E5C7C
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  struct _LIST_ENTRY *v28; // [rsp+48h] [rbp-70h]
  ...
  if ( !a1 || (v12 = a2) == 0 )
  {
    v22 = RtlImageNtHeader(KeGetCurrentThread()->ApcState.Process[1].Padding[5]);
    if ( !v22 )
      return 3221225595LL;
    if ( *(_WORD *)(v22 + 24) == 523 )
    {
  ...
  v28 = Blink[49].Blink;
  if ( v28 && v14 < (unsigned __int64)v28 )
  {
    v14 = v13 & ((unsigned __int64)v28 + v8 - 1);
    if ( v14 >= v15 )
      v15 = (v14 + 0xFFFFF) & 0xFFFFFFFFFFF00000uLL;
    v15 = (v15 + 0xFFFF) & 0xFFFFFFFFFFFF0000uLL;
  }
  v29 = v7;
  v30 = 0LL;
  v31 = 0;
