/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x140A004D0
 * Callers:
 ...
 *     RtlFxToFnFrame @ 0x140431320 (RtlFxToFnFrame.c)
 */
...
__int64 __fastcall RtlpWow64CtxFromAmd64(int a1, _DWORD *a2, int *a3)
{
  ...
  if ( (a1 & 0x10002) == 0x10002 && (v3 & 0x100002) == 0x100002 )
  {
    v5 |= 0x10002u;
    a3[39] = a2[44];
    a3[40] = a2[42];
  ...
  if ( (a1 & 0x10004) == 0x10004 && (v3 & 0x100004) == 0x100004 )
  {
    a3[35] = 43;
    v5 |= 0x10004u;
    a3[37] = 43;
  ...
  {
    a3[34] = 0;
    RtlFxToFnFrame((__int64)(a3 + 7), v9);
    v5 |= 0x10008u;
  }
  ...
  if ( (a1 & 0x10040) == 0x10040 && (v3 & 0x100040) == 0x100040 && (v5 & 0x10040) == 0x10040 )
    v4 = RtlpCopyXStateChunk(1, (__int64)(a3 + 179), (__int64)(a3 + 179), (__int64)(a2 + 308), (__int64)(a2 + 308));
  if ( (a1 & 0x40000000) != 0 )
