/*
 * XREFs of PopDirectedDripsDiagTraceNotifyDevices @ 0x14049C73C
 * Callers:
...
char __fastcall PopDirectedDripsDiagTraceNotifyDevices(unsigned __int8 a1, int a2, __int64 a3)
{
  ...
  if ( a2 >= 0 )
  {
    ...
    v7 = v5;
    if ( v6 )
      ExfAcquirePushLockExclusiveEx(&PopDirectedDripsDiagLock, (__int64)v5, (__int64)&PopDirectedDripsDiagLock);
    if ( v7 )
      *((_BYTE *)v7 + 10) = 1;
    ...
    if ( PopDirectedDripsDiagSessionContext != &PopDirectedDripsDiagSessionContext )
    {
      do
      {
        ...
        v13 = (char *)&v9[v12];
        v14 = &v9[v11];
        if ( *((_DWORD *)v9 + 9) == dword_140F06848 && v10 && ((_DWORD)v9[5] & 0x100) == 0 )
        {
          v15 = 0;
          v16 = v8 - v10;
