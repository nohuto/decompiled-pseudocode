/*
 * XREFs of DifRtlUnicodeStringToOemStringWrapper @ 0x14063A8C0
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlUnicodeStringToOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
