/*
 * XREFs of DifRtlUpcaseUnicodeStringToCountedOemStringWrapper @ 0x14063ABC0
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlUpcaseUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
