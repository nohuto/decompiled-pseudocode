/*
 * XREFs of DifRtlUpcaseUnicodeStringToCountedOemStringWrapper @ 0x140639180
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlUpcaseUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
