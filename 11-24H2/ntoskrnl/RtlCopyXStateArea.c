/*
 * XREFs of RtlCopyXStateArea @ 0x1403FFF70
 * Callers:
...
void __fastcall RtlCopyXStateArea(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a2 )
  {
    v5 = 0;
    v6 = 2;
    v7 = (MEMORY[0xFFFFF780000005F0] | MEMORY[0xFFFFF780000003D8] | 3LL) & a2;
    v8 = v7 & *(_QWORD *)(a3 + 512);
    *(_QWORD *)(a1 + 512) = v8 | *(_QWORD *)(a1 + 512) & ~v7;
    ...
    {
      v9 = MEMORY[0xFFFFF780000005F0] | MEMORY[0xFFFFF780000003D8] | 0x8000000000000003uLL;
      ...
      do
      {
        ...
        if ( (v20 & 1) != 0 )
        {
          v23 = v24;
          if ( (v22 & 1) != 0 )
            v23 = (v24 + 63) & 0xFFFFFFC0;
          v30 = v23 + *v18;
        }
        if ( (v21 & 1) != 0 )
        {
          memmove((void *)(a1 + v23), (const void *)(a3 + v16), v19 - v16);
          v17 = v26;
          v18 = (_DWORD *)v28;
        }
        v22 = v27 >> 1;
