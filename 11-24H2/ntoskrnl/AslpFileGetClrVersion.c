/*
 * XREFs of AslpFileGetClrVersion @ 0x14080D638
 * Callers:
  ...
  *a1 = 0;
  ...
  if ( ImageNtHeader >= 0 )
  {
    ...
    if ( !(_DWORD)v8 || v4[1] < 0x48 )
      return (unsigned int)-1073741701;
    v9 = AslpImageRvaToVa(v15, a2 + 8, v8);
    if ( v9 )
    {
      if ( *(_WORD *)(v9 + 4) != 2 )
        return (unsigned int)-1073741637;
      v12 = (_DWORD *)AslpImageRvaToVa(v6, a2 + 8, *(unsigned int *)(v9 + 8));
      if ( v12 )
      {
        if ( *v12 != 1112167234 )
        {
...
LABEL_13:
  ...
  AslLogCallPrintf(1, (unsigned int)"AslpFileGetClrVersion", 5297, (unsigned int)"AslpFileGetImageNtHeader failed [%x]");
  return (unsigned int)ImageNtHeader;
}
