/*
 * XREFs of PerfInfoLogVirtualAlloc @ 0x140A2C1A8
 * Callers:
...
void __fastcall PerfInfoLogVirtualAlloc(__int64 a1, __int64 a2, __int64 a3, int a4, __int16 a5, __int16 a6)
{
  ...
  EtwTraceSiloKernelEvent(ProcessServerSilo, (__int64)&v15, 1u, 0x20008000u, 610, 0x601902u);
  if ( a5 != a6 )
  {
    v17 = 0;
    WORD4(v11) = a6;
    ...
    *(_QWORD *)&v11 = a1;
    ...
    EtwTraceSiloKernelEvent(v10, (__int64)&v15, 1u, 0x20008000u, 649, 0x601902u);
  }
}
