/*
 * XREFs of DifKeAcquireGuardedMutexUnsafeWrapper @ 0x14062A5A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeAcquireGuardedMutexUnsafeWrapper(PFAST_MUTEX FastMutex)
{
