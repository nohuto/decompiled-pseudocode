/*
 * XREFs of KiNmiInterruptStart @ 0x1406B67C0
 * Callers:
 *     KiNmiInterruptShadow @ 0x140BBB240 (KiNmiInterruptShadow.c)
 * Callees:
...
LABEL_8:
    ...
    v18 = KiProcessorBlock[*((unsigned int *)qword_140F21E78 + (v20 | (unsigned int)v19))] - 384;
    goto LABEL_8;
  }
  if ( (KiKvaShadow & 1) == 0 )
    __asm { swapgs }
