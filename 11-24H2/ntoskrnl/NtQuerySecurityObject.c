/*
 * XREFs of NtQuerySecurityObject @ 0x140879460
 * Callers:
        ...
        PULONG LengthNeeded)
{
  ...
  NTSTATUS v24; // ebx
  __int64 *HandleInformation; // [rsp+28h] [rbp-50h]
  ...
  if ( PreviousMode )
  {
    ...
    *(_DWORD *)v8 = *(_DWORD *)v8;
    if ( Lengtha )
    {
      ...
      if ( (unsigned __int64)SecurityDescriptor > v11 || v11 >= 0x7FFFFFFF0000LL )
  ...
  if ( result >= 0 )
  {
    ...
    v27 = v21 + 76;
    v26 = *(_DWORD *)(v21 + 100);
    HandleInformation = (__int64 *)((char *)Object - 8);
    if ( (char *)v22 == (char *)SeDefaultObjectMethod )
    {
      SetSecurityObject = SeDefaultObjectMethod(
                            (__int64)Object,
                            1,
                            &v30,
    ...
    {
      SetSecurityObject = guard_dispatch_icall_no_overrides(Object, 1LL, &v30, SecurityDescriptor);
    }
