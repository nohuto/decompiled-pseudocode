/*
 * XREFs of MmIsVerifierEnabled @ 0x140B82D50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)VfRuleClasses )
  {
    ...
    while ( 1 )
    {
      if ( v6 >= 8 )
        return v3;
      v7 = 32LL * v6;
      v8 = *(_DWORD *)((char *)&unk_140E08F18 + v7);
      if ( v8 )
      {
        if ( (v8 & (unsigned int)VfRuleClasses) == 0 )
          goto LABEL_16;
        v9 = (ULONG *)((char *)&unk_140E08F1C + v7);
      }
      else
      {
        v9 = (ULONG *)((char *)&unk_140E08F1C + v7);
        v10 = *(_DWORD *)((char *)&unk_140E08F1C + v7);
        if ( v10 >= 0x40 )
          goto LABEL_16;
        v11 = *((_DWORD *)&VfRuleClasses + ((unsigned __int64)v10 >> 5));
        if ( !_bittest(&v11, *(_DWORD *)((_BYTE *)&unk_140E08F1C + v7) & 0x1F) )
          goto LABEL_16;
      }
      v12 = *(_QWORD *)((char *)&unk_140E08F08 + v7);
      if ( retaddr > v12 && retaddr < *(_QWORD *)((char *)&unk_140E08F10 + v7) + v12 )
      {
        if ( !v8 )
          v8 = *v9;
        *VerifierFlags = v8;
