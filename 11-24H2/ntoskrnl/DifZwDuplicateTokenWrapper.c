/*
 * XREFs of DifZwDuplicateTokenWrapper @ 0x14063DB10
 * Callers:
 *     <none>
 * Callees:
        ...
        HANDLE *NewTokenHandle)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    *((_QWORD *)&v21 + 1) = a1;
    LODWORD(v20) = TokenType;
    *((_QWORD *)&v19 + 1) = NewTokenHandle;
    LODWORD(v21) = a2;
    *((_QWORD *)&v20 + 1) = a3;
    BYTE4(v20) = a4;
  ...
  LODWORD(v22) = ZwDuplicateToken(a1, a2, a3, a4, TokenType, NewTokenHandle);
  if ( v11 )
  {
