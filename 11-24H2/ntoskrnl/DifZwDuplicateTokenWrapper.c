/*
 * XREFs of DifZwDuplicateTokenWrapper @ 0x14063F550
 * Callers:
 *     <none>
 * Callees:
        ...
        HANDLE *NewTokenHandle)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v15 = 0;
    *((_QWORD *)&v25 + 1) = a1;
    LODWORD(v24) = TokenType;
    *((_QWORD *)&v23 + 1) = NewTokenHandle;
    LODWORD(v25) = a2;
    *((_QWORD *)&v24 + 1) = a3;
    BYTE4(v24) = a4;
  ...
  LODWORD(v26) = ZwDuplicateToken(a1, a2, a3, a4, TokenType, NewTokenHandle);
  if ( v13 )
  {
