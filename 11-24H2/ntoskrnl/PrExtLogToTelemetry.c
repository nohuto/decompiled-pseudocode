/*
 * XREFs of PrExtLogToTelemetry @ 0x140664244
 * Callers:
...
__int64 PrExtLogToTelemetry()
{
  ...
  if ( IsTraceloggingEnabled
    || (IsTraceloggingEnabled = (int)TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140E097F0, 0LL, 0LL) >= 0) != 0 )
  {
    v4 = dword_140EF7848;
    v2[0] = MCUpdateRegistryData;
    v3 = qword_140EF7840;
    v2[1] = xmmword_140EF7830;
