/*
 * XREFs of DifZwEnumerateDriverEntriesWrapper @ 0x14063DE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateDriverEntriesWrapper(PVOID Buffer, PULONG BufferLength)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(105);
  ...
  DWORD2(v16) = ZwEnumerateDriverEntries(Buffer, BufferLength);
  if ( v6 )
  {
