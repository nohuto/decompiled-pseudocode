/*
 * XREFs of sub_140AC0280 @ 0x140AC0280
 * Callers:
...
__int64 __fastcall sub_140AC0280(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rsi
  unsigned int v7; // ebx
  unsigned int *v8; // rcx
  ...
  if ( v25 && *(_DWORD *)a1 > 5u )
  {
    ...
    if ( v28 >= v25 )
    {
      if ( !(_DWORD)v27
        ...
        || pcbLength + 2 != v30
        || (v31 = pcbLength >> 1, 2 * (unsigned int)(pcbLength >> 1) == -2) )
      {
        v7 = -1073741762;
        goto LABEL_59;
      }
      v32 = 2 * (unsigned int)(pcbLength >> 1) + 2;
      v33 = (void *)ExAllocatePool2(0x100uLL);
      if ( !v33 )
        goto LABEL_50;
      v6 = v33;
      memmove(v33, v29, v32);
      v35 = guard_dispatch_icall_no_overrides((unsigned int)(2 * v21 + 2), v24, (unsigned int)(2 * v31 + 2), v6);
      if ( v35 >= 0 )
      {
        if ( qword_140FD73E0 )
        {
          v35 = guard_dispatch_icall_no_overrides(v24, v34, v36, v37);
          if ( v35 == -1073741198 )
            v35 = 0;
        }
        else
      ...
      *(_DWORD *)(a4 + 4) = 20;
      v38 = (_DWORD *)ExAllocatePool2(0x100uLL);
      if ( !v38 )
      {
LABEL_50:
        v7 = -1073741801;
...
LABEL_65:
        ...
        *v38 = 4;
        ...
        {
          v45 = *(_DWORD *)v40 + 4;
          if ( *(_DWORD *)v40 >= 0xFFFFFFFC || v40 + v45 < v40 )
            goto LABEL_58;
          v40 += v45;
        }
        if ( v40 + 4 >= v40 )
