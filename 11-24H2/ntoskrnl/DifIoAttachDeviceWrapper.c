/*
 * XREFs of DifIoAttachDeviceWrapper @ 0x140624460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoAttachDeviceWrapper(
        ...
        PDEVICE_OBJECT *AttachedDevice)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(363);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = SourceDevice;
    *(_QWORD *)&v18 = TargetDevice;
    *((_QWORD *)&v17 + 1) = AttachedDevice;
  ...
  LODWORD(v19) = IoAttachDevice(SourceDevice, TargetDevice, AttachedDevice);
  if ( v8 )
  {
