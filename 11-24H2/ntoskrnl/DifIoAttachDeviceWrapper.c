/*
 * XREFs of DifIoAttachDeviceWrapper @ 0x140625EA0
 * Callers:
 *     <none>
 * Callees:
        ...
        PDEVICE_OBJECT *AttachedDevice)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = SourceDevice;
    *(_QWORD *)&v22 = TargetDevice;
    *((_QWORD *)&v21 + 1) = AttachedDevice;
  ...
  LODWORD(v23) = IoAttachDevice(SourceDevice, TargetDevice, AttachedDevice);
  if ( v10 )
  {
