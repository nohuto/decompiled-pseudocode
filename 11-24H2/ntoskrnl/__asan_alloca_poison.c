/*
 * XREFs of __asan_alloca_poison @ 0x1405AAEF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_alloca_poison(ULONG_PTR BugCheckParameter3, ULONG_PTR a2)
{
  ...
  if ( byte_140FCDC28 )
  {
    ...
    v8 = (_BYTE *)(qword_140FC42D0 + (BugCheckParameter3 >> 3));
    v9 = 31 - v6 + (((_BYTE)a2 - 1) & 7) - v2;
    if ( a2 >> 3 )
    {
      LOBYTE(v2) = (unsigned __int8)memset_0((void *)(qword_140FC42D0 + (BugCheckParameter3 >> 3)), 0, a2 >> 3);
      v8 += a2 >> 3;
      v5 = 0;
    }
    if ( (a2 & 7) != 0 )
  ...
  if ( byte_140FCDC28 )
  {
    ...
    *(_DWORD *)(qword_140FC42D0 + (v12 >> 3)) = -2088533117;
  }
  return v2;
}
