/*
 * XREFs of Uart16550InitializePortCommon @ 0x1406A5BA4
 * Callers:
 *     IaLpssInitializePort @ 0x1406A55E0 (IaLpssInitializePort.c)
 *     IaLpssSetPowerD0 @ 0x1406A5880 (IaLpssSetPowerD0.c)
 *     Uart16550InitializePort @ 0x1406A5B80 (Uart16550InitializePort.c)
 *     Uart16550LegacyInitializePort @ 0x1406A5C60 (Uart16550LegacyInitializePort.c)
 *     Uart16550MmInitializePort @ 0x1406A5CD0 (Uart16550MmInitializePort.c)
 * Callees:
 *     Uart16550SetBaud @ 0x1406A5E70 (Uart16550SetBaud.c)
 *     UartpSetAccess @ 0x1406A65BC (UartpSetAccess.c)
