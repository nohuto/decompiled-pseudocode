/*
 * XREFs of CreateSystemRootLink @ 0x140C0A3F8
 * Callers:
...
__int64 __fastcall CreateSystemRootLink(_QWORD *a1)
{
  ...
  DirectoryObject = NtCreateDirectoryObject((__int64)&Handle, 983055LL, (__int64)&v16);
  ...
  LODWORD(v19) = 80;
  v21[0] = 0LL;
  v3 = NtCreateDirectoryObject((__int64)&Handle, 983055LL, (__int64)&v16);
  if ( v3 < 0 )
