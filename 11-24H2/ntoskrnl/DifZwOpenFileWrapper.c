/*
 * XREFs of DifZwOpenFileWrapper @ 0x14063FE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenFileWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        ULONG OpenOptions)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(85);
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    *((_QWORD *)&v21 + 1) = a1;
    *((_QWORD *)&v19 + 1) = __PAIR64__(ShareAccess, OpenOptions);
    LODWORD(v21) = a2;
    *((_QWORD *)&v20 + 1) = a3;
    *(_QWORD *)&v20 = a4;
  ...
  LODWORD(v22) = ZwOpenFile(a1, a2, a3, a4, ShareAccess, OpenOptions);
  if ( v11 )
  {
