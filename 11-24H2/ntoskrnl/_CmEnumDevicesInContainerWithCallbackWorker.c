/*
 * XREFs of _CmEnumDevicesInContainerWithCallbackWorker @ 0x140819D68
 * Callers:
        ...
        int a6)
{
  ...
  if ( a3 )
    goto LABEL_6;
  v10 = PnpOpenObjectRegKey(a1, a2, 5, 1, 0, (__int64)&v24);
  if ( v10 < 0 )
    goto LABEL_35;
  v11 = (int)v24;
  if ( !v24 )
LABEL_6:
    v11 = v8;
  v10 = PnpCtxRegOpenKey(a1, v11, (unsigned int)L"BaseContainers", 0, 8, (__int64)&v22);
  if ( v10 >= 0 )
  {
    ...
    if ( Pool2 )
    {
      ...
      while ( 1 )
      {
        Handle = 0LL;
        a6 = 200;
        v14 = PnpCtxRegEnumKey(v12, v22, v13, Pool2, &a6);
        v10 = v14;
        if ( v14 == -2147483622 )
          break;
        if ( v14 != -1073741789 )
        {
          if ( v14 < 0 )
            goto LABEL_35;
          v10 = PnpCtxRegOpenKey(a1, (_DWORD)v22, (_DWORD)Pool2, 0, 1, (__int64)&Handle);
          if ( v10 < 0 )
            goto LABEL_35;
          for ( i = 0; ; ++i )
          {
            ...
            {
              a6 = 200;
              v17 = PnpCtxRegEnumValue(v15, Handle, i, Pool2, &a6, v21, 0LL, 0LL);
              v10 = v17;
              if ( v17 == -2147483622 )
              {
                v10 = 0;
            ...
            if ( v17 < 0 )
              goto LABEL_27;
            v7 = guard_dispatch_icall_no_overrides(a1, Pool2, a5, v18);
            if ( v7 )
              break;
          }
          if ( v7 != 1 && v7 != 2 )
