/*
 * XREFs of ?SmStAcquireStoreLockExclusive@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@@Z @ 0x14039C560
 * Callers:
...
void __fastcall SMKM_STORE<SM_TRAITS>::SmStAcquireStoreLockExclusive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 6837) & 4) != 0 )
  {
    ...
    v5 = KeAbPreAcquire(a1 + 6840, 0LL);
    v6 = v5;
    if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 6840), 0LL) )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 6840), (__int64)v5, a1 + 6840);
    if ( v6 )
      *((_BYTE *)v6 + 10) = 1;
    ++*(_QWORD *)(a1 + 6856);
    *(_DWORD *)(a1 + 6848) = 1;
