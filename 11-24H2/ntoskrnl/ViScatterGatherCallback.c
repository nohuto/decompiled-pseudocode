/*
 * XREFs of ViScatterGatherCallback @ 0x140B89B30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VF_MARK_SCATTER_GATHER_LIST @ 0x140B85150 (VF_MARK_SCATTER_GATHER_LIST.c)
 */
...
__int64 __fastcall ViScatterGatherCallback(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4)
{
  ...
  *(_QWORD *)(a4 + 64) = a3;
  ...
  return guard_dispatch_icall_no_overrides(a1, a2, a3, *(_QWORD *)a4);
}
