/*
 * XREFs of WheapLogInitEvent @ 0x1407C8368
 * Callers:
...
void WheapLogInitEvent()
{
  ...
  Size = 1072 * dword_140EEED0C;
  Pool2 = (char *)ExAllocatePool2(0x42uLL);
  if ( Pool2 )
  {
    v1 = (__int64 *)qword_140EEED18;
    for ( i = 0; v1 != &qword_140EEED18; v1 = (__int64 *)*v1 )
    {
      v3 = v1;
      v4 = 8LL;
      v5 = &Pool2[1072 * i];
    ...
    v18 = 0;
    v21 = 0;
    UserData.Ptr = (ULONGLONG)&dword_140EEED0C;
    p_Size_4 = &Size_4;
    p_Size = &Size;
    v20 = Size;
    UserData.Size = 4;
    ...
    if ( EtwEventEnabled(WheapEtwHandle, &EVENT_WHEA_INIT_OP) == 1 )
      EtwWrite(WheapEtwHandle, &EVENT_WHEA_INIT_OP, 0LL, 4u, &UserData);
