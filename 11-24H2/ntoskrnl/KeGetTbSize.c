...
__int64 KeGetTbSize()
{
  ...
  __int64 j; // rbx
  int v29; // r8d
  __int128 v30; // [rsp+20h] [rbp-19h]
  _BYTE v31[8]; // [rsp+30h] [rbp-9h]
  __int64 v32; // [rsp+38h] [rbp-1h]
  char v33; // [rsp+40h] [rbp+7h]
  __int64 v34; // [rsp+48h] [rbp+Fh]
  char v35; // [rsp+50h] [rbp+17h]
  __int64 v36; // [rsp+58h] [rbp+1Fh]
  char v37; // [rsp+60h] [rbp+27h]
  __int64 v38; // [rsp+68h] [rbp+2Fh]
  char v39; // [rsp+70h] [rbp+37h]
  __int64 v40; // [rsp+78h] [rbp+3Fh]
