/*
 * XREFs of MiCheckLargePageOk @ 0x140C55B84
 * Callers:
...
__int64 __fastcall MiCheckLargePageOk(ULONG_PTR BugCheckParameter2)
{
  ...
  while ( !(_DWORD)v10 )
  {
    v12 = v11[6];
    v19 = 0LL;
    qword_140E2D840[v10] = (__int64)v11;
    RtlImageNtHeaderEx(1, v12, 0LL, &v19);
    v13 = *(unsigned int *)(v19 + 56);
    if ( (_DWORD)v13 != 4096 )
      KeBugCheckEx(0x1Au, 0x3030307uLL, BugCheckParameter2, v13, 0LL);
