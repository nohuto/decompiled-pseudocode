/*
 * XREFs of PopNewWakeInfo @ 0x140B67F44
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 24) = Pool2 + 24;
    ...
    {
      v2 = (_QWORD *)qword_140F0D0B8;
      v3 = *(_QWORD **)(qword_140F0D0B8 + 8);
      if ( *(__int64 **)qword_140F0D0B8 != &PopWakeInfoList || *v3 != qword_140F0D0B8 )
        __fastfail(3u);
      qword_140F0D0B8 = *(_QWORD *)(qword_140F0D0B8 + 8);
      *v3 = &PopWakeInfoList;
      v2[1] = v2;
      *v2 = v2;
