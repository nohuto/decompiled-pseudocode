/*
 * XREFs of WheaRegisterInUsePageOfflineNotification @ 0x1407C7660
 * Callers:
 *     HvlRegisterWheaErrorNotification @ 0x14070ECA0 (HvlRegisterWheaErrorNotification.c)
 * Callees:
...
NTSTATUS __stdcall WheaRegisterInUsePageOfflineNotification(PFN_IN_USE_PAGE_OFFLINE_NOTIFY Callback, PVOID Context)
{
  ...
  *(_QWORD *)(Pool2 + 16) = Callback;
  ...
  if ( v10 )
    *((_BYTE *)v10 + 10) = 1;
  v11 = (_QWORD *)qword_140EEED58;
  if ( *(PVOID **)qword_140EEED58 != &WheapInUsePageOfflineNotifyList )
    __fastfail(3u);
  *v6 = &WheapInUsePageOfflineNotifyList;
  v6[1] = v11;
  *v11 = v6;
  qword_140EEED58 = (__int64)v6;
