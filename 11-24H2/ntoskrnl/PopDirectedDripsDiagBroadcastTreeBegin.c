/*
 * XREFs of PopDirectedDripsDiagBroadcastTreeBegin @ 0x140A7EA5C
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( DeviceDiagnostic )
  {
    if ( *(_DWORD *)(DeviceDiagnostic + 148) == -1 )
      *(_DWORD *)(DeviceDiagnostic + 148) = dword_140F06844++;
...
LABEL_9:
      ...
      *(_DWORD *)(Pool2 + 32) = v11;
      *(_QWORD *)(Pool2 + 16) = v10;
      v15 = (__int64 *)qword_140F06628;
      if ( *(PVOID **)qword_140F06628 != &PopDirectedDripsDiagSessionContext )
        __fastfail(3u);
