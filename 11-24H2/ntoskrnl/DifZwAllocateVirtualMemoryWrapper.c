/*
 * XREFs of DifZwAllocateVirtualMemoryWrapper @ 0x14063B890
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG Protect)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v15 = 0;
    *((_QWORD *)&v25 + 1) = a1;
    *((_QWORD *)&v23 + 1) = __PAIR64__(AllocationType, Protect);
    *(_QWORD *)&v25 = a2;
    *((_QWORD *)&v24 + 1) = a3;
    *(_QWORD *)&v24 = a4;
  ...
  LODWORD(v26) = ZwAllocateVirtualMemory(a1, a2, a3, a4, AllocationType, Protect);
  if ( v13 )
  {
