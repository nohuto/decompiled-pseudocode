/*
 * XREFs of DifZwAllocateVirtualMemoryWrapper @ 0x140639E50
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG Protect)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    *((_QWORD *)&v21 + 1) = a1;
    *((_QWORD *)&v19 + 1) = __PAIR64__(AllocationType, Protect);
    *(_QWORD *)&v21 = a2;
    *((_QWORD *)&v20 + 1) = a3;
    *(_QWORD *)&v20 = a4;
  ...
  LODWORD(v22) = ZwAllocateVirtualMemory(a1, a2, a3, a4, AllocationType, Protect);
  if ( v11 )
  {
