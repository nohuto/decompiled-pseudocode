/*
 * XREFs of TtmiLogSessionPowerStateChange @ 0x14076E33C
 * Callers:
...
void __fastcall TtmiLogSessionPowerStateChange(char a1)
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v9 = &v3;
    v10 = 1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)byte_1400506F3, 0LL, 0LL, 4u, &v5);
  }
}
