/*
 * XREFs of IopCreateSecurityDescriptorPerType @ 0x1409A3AF0
 * Callers:
...
__int64 __fastcall IopCreateSecurityDescriptorPerType(char *a1, int a2, __int64 *a3, _DWORD *a4)
{
  char v7; // bp
  int v8; // edx
  int v9; // edx
...
LABEL_4:
  ...
  *a1 = 1;
  ...
  RtlAddMandatoryAce(v13, 2u, 0, (unsigned __int8 *)SeLowMandatorySid, 17, 1);
  v15 = *a1;
  if ( *a1 == 1 )
  {
    v16 = *((_WORD *)a1 + 1);
