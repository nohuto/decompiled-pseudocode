/*
 * XREFs of NtCreateTimer2 @ 0x140A20AE0
 * Callers:
 *     NtCreateIRTimer @ 0x1407BB390 (NtCreateIRTimer.c)
 * Callees:
  ...
  *(_DWORD *)v16 = 0;
    ...
    || (LOBYTE(v7) = PreviousMode, result = ExpCheckIRTimerAccess(*(unsigned int *)v16, v7), (int)result >= 0) )
  {
    ...
    if ( inserted >= 0 )
    {
      ...
      v13[17] = 0LL;
      *((_DWORD *)v13 + 40) = a4;
      inserted = ObInsertObjectEx((struct _FILE_OBJECT *)v13, 0LL, a5, 0, 0, 0LL, (__int64)&v18);
