/*
 * XREFs of PnpRebalance @ 0x1407352B8
 * Callers:
 ...
 *     PnpFindBestConfiguration @ 0x1407221B0 (PnpFindBestConfiguration.c)
 ...
 *     PnpFindRebalanceCandidates @ 0x140734EBC (PnpFindRebalanceCandidates.c)
