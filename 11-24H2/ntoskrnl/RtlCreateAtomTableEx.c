/*
 * XREFs of RtlCreateAtomTableEx @ 0x1404959E0
 * Callers:
 *     RtlCreateAtomTable @ 0x140A7FAD0 (RtlCreateAtomTable.c)
 * Callees:
 ...
 *     RtlpInitializeLockAtomTable @ 0x140A968D8 (RtlpInitializeLockAtomTable.c)
 */
