/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140C16C38
 * Callers:
 ...
 *     HalpValidateMpns @ 0x140701E2C (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140C17048 (HalpSelectFeasibleLowPowerState.c)
 */
