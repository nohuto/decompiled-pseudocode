/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140C14C38
 * Callers:
 ...
 *     HalpValidateMpns @ 0x14070426C (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140C15048 (HalpSelectFeasibleLowPowerState.c)
 */
