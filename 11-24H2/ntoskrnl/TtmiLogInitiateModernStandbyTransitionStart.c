/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStart @ 0x14076D2AC
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v13 = 1;
    v7 = a2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)word_14004FF32, 0LL, 0LL, 5u, &v8);
  }
}
