/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStart @ 0x14076D4CC
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD88C8 > 5 && tlgKeywordOn((__int64)&dword_140FD88C8, 1LL) )
  {
    ...
    v13 = 1;
    v7 = a2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD88C8, (unsigned __int8 *)byte_140050603, 0LL, 0LL, 5u, &v8);
  }
}
