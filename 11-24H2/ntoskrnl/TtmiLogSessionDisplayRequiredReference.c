/*
 * XREFs of TtmiLogSessionDisplayRequiredReference @ 0x14090241C
 * Callers:
...
void TtmiLogSessionDisplayRequiredReference()
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)byte_140050C61, 0LL, 0LL, 5u, &v6);
  }
}
