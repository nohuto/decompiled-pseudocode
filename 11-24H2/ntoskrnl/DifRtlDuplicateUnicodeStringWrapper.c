/*
 * XREFs of DifRtlDuplicateUnicodeStringWrapper @ 0x1406381F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlDuplicateUnicodeStringWrapper(
        ULONG Flags,
        ...
        PUNICODE_STRING StringOut)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(162);
  ...
  HIDWORD(v18) = RtlDuplicateUnicodeString(Flags, StringIn, StringOut);
  if ( v8 )
  {
