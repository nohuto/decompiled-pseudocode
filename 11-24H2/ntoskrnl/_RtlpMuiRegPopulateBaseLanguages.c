/*
 * XREFs of _RtlpMuiRegPopulateBaseLanguages @ 0x14082DDEC
 * Callers:
...
__int64 __fastcall RtlpMuiRegPopulateBaseLanguages(__int64 a1, __int64 a2, _WORD *a3, __int64 a4)
{
  ...
  *(_DWORD *)(v4 + 40) = 0;
  *(_OWORD *)(v4 + 24) = 0LL;
  memset_0((void *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 64), 0, 0xAAuLL);
  memset_0((void *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 768), 0, 0xAAuLL);
  memset_0((void *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 944), 0, 0xAAuLL);
  *(_WORD *)v4 = 0;
  v8 = 0;
  ...
  if ( a3[2] == v10 )
  {
    if ( v13 )
    {
      ...
      *(_WORD *)(((unsigned __int64)v21 & 0xFFFFFFFFFFFFFFE0uLL) + 0x1A) = 170;
      if ( (unsigned __int8)RtlLCIDToCultureName(v13, v4 + 24) )
      {
        if ( ZwQueryValueKey(
