/*
 * XREFs of DifZwQueryInformationProcessWrapper @ 0x140645330
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a5)
{
  ...
  v23 = 0LL;
  v24 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(48);
  ...
  LODWORD(v25) = ZwQueryInformationProcess(a1, a2, a3, a4, a5);
  if ( v12 )
  {
