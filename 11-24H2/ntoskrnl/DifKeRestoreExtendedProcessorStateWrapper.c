/*
 * XREFs of DifKeRestoreExtendedProcessorStateWrapper @ 0x14062EC00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeRestoreExtendedProcessorStateWrapper(ULONG_PTR BugCheckParameter3)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(251);
  ...
  KeRestoreExtendedAndSupervisorState(BugCheckParameter3);
  if ( v4 )
  {
