/*
 * XREFs of VhdiAutoAttachOneVhd @ 0x140829E6C
 * Callers:
...
void __fastcall VhdiAutoAttachOneVhd(void *Src, size_t Size, _OWORD *a3, unsigned int a4)
{
  unsigned int v4; // esi
  __int64 Pool2; // rax
  _QWORD *v9; // rbx
    ...
    if ( PnpSetupOOBEInProgress && PnpSetupUpgradeInProgress )
    {
      ...
      if ( Pool2 )
      {
        ...
        *(_OWORD *)(Pool2 + 20) = *a3;
        ...
        v10 = (_QWORD *)qword_140E65050;
        if ( *(PVOID **)qword_140E65050 != &qword_140E65048 )
          __fastfail(3u);
        *v9 = &qword_140E65048;
        v9[1] = v10;
        *v10 = v9;
        qword_140E65050 = (__int64)v9;
      }
    }
    else
    {
      ...
      LOBYTE(v15) = v11;
      if ( v11 < 0 || (v15 = VhdiMountVhdFile(Src, v4, a4, 0LL, a3), RtlReleasePrivilege(P), v15 < 0) )
      {
        ...
        if ( (unsigned int)dword_140E06E48 > 5 && tlgKeywordOn((__int64)&dword_140E06E48, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)&word_140059026,
            0LL,
            0LL,
            7u,
            &v19);
