/*
 * XREFs of ExpWnfDeleteNameInstance @ 0x1408AA6E8
 * Callers:
...
__int64 __fastcall ExpWnfDeleteNameInstance(__int64 a1, struct _EX_RUNDOWN_REF *a2, char a3)
{
  ...
  if ( a2[6].Count )
  {
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)&a2[14], 0LL) )
      ExfAcquirePushLockExclusiveEx(&a2[14].Count, (__int64)v10, (__int64)&a2[14]);
    if ( v11 )
      *((_BYTE *)v11 + 10) = 1;
    if ( a3 )
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)v9, 0LL) )
      ExfAcquirePushLockExclusiveEx(&a2[14].Count, (__int64)v12, (__int64)&a2[14]);
    if ( v13 )
      *((_BYTE *)v13 + 10) = 1;
    while ( 1 )
    {
      ...
      if ( v24 )
        *((_BYTE *)v24 + 10) = 1;
      v25 = KeAbPreAcquire((__int64)&a2[14], 0LL);
      v26 = v25;
      if ( _interlockedbittestandset64((volatile signed __int32 *)v9, 0LL) )
        ExfAcquirePushLockExclusiveEx(&a2[14].Count, (__int64)v25, (__int64)&a2[14]);
      if ( v26 )
        *((_BYTE *)v26 + 10) = 1;
      if ( Count[-2].Count )
      {
