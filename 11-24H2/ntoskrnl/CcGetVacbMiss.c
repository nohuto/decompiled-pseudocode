/*
 * XREFs of CcGetVacbMiss @ 0x1402D5510
 * Callers:
...
unsigned __int64 __fastcall CcGetVacbMiss(__int64 a1, __int64 a2, unsigned int a3, int a4)
{
  ...
  while ( 1 )
  {
    ...
    v12 = (volatile __int64 *)*((_QWORD *)ArbitraryUserPointer + 9);
    v13 = (__int64)ArbitraryUserPointer + 64;
    if ( (BYTE6(PerfGlobalGroupMask) & 0x21) == 0 || PopHibernateInProgress )
    {
      if ( _InterlockedExchange64(v12, v13) )
    ...
    v25 = KeAbPreAcquire(a1 + 104, 0LL, 0LL);
    v26 = v25;
    if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 104), 0LL) )
      ExfAcquirePushLockExclusiveEx(a1 + 104, v25, a1 + 104);
    if ( v26 )
      *(_BYTE *)(v26 + 10) = 1;
    v27 = *(_QWORD *)(a1 + 32);
    v28 = *(_QWORD *)(a1 + 88);
