/*
 * XREFs of MiMapImageForEnclaveUse @ 0x1408DB088
 * Callers:
...
__int64 __fastcall MiMapImageForEnclaveUse(ULONG_PTR a1, int a2, char a3, int a4, __int64 *a5)
{
  __int64 result; // rax
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_DWORD *)(v9 + 56) & 0x20) != 0 )
    {
      ...
      if ( (*(_QWORD *)((*(_QWORD *)(v8 + 96) & 0xFFFFFFFFFFFFFFF8uLL) + 40) & 0xFFFFFFFFFFFFFFF8uLL) <= 0x7FFFFFFFFFFFFFF8LL )
      {
        ...
        v11 = MiValidateSectionCreate(v12, v10, -1, a2, 0x40000000, 4, 0);
