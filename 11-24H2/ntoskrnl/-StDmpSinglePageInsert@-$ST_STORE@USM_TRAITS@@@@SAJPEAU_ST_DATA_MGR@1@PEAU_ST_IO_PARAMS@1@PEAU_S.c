/*
 * XREFs of ?StDmpSinglePageInsert@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_IO_PARAMS@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x140382530
 * Callers:
  ...
  else
  {
    ...
    if ( v26 < (unsigned int)v24 )
    {
      ...
      if ( (unsigned int)v24 >= v57 && (v57 = (_DWORD)v24 + 8, (int)v24 + 8 < (unsigned int)v24)
        ...
        || (Pool2 = ExAllocatePool2(0x40uLL), (v60 = (void *)Pool2) == 0LL) )
      {
        v55 = -1073741670;
        goto LABEL_68;
      }
...
LABEL_99:
    v71[1] += v69;
  if ( (dword_140E287DC & 0x10) != 0 )
    SmEtwLogStoreOp((unsigned int)&qword_140E287D0, 0, (unsigned int)&v91, v69, *v62, v6, *((_BYTE *)v62 + 4), *v98 & 7);
  return 0LL;
}
