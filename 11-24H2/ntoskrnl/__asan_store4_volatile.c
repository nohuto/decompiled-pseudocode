/*
 * XREFs of __asan_store4_volatile @ 0x1405A9E30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store4_volatile(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r9d
...
LABEL_21:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 4, 1, v4, v1);
  }
  return v3;
}
