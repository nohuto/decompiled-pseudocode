/*
 * XREFs of RtlpInternEntryFind @ 0x1408DF320
 * Callers:
...
__int64 __fastcall RtlpInternEntryFind(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
        ...
        * ((37
          * (BYTE6(v15)
           ...
           * (BYTE5(v15)
            + 37
            * (BYTE4(v15)
             + 37 * (BYTE3(v15) + 37 * (BYTE2(v15) + 37 * (BYTE1(v15) + 37 * ((unsigned __int8)v11 + 11623883)))))))
          + HIBYTE(v15)) & ((v4 >> 5) - 1));
LABEL_5:
    while ( 1 )
    {
      ...
      if ( v11 == (v9 & *(_QWORD *)(v10 + 8)) )
      {
        if ( !v10 )
          return v6;
        if ( RtlpInternEntryMatch(v10, a2, a4) )
        {
