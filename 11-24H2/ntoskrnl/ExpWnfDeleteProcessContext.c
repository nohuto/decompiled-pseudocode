/*
 * XREFs of ExpWnfDeleteProcessContext @ 0x1408AA090
 * Callers:
...
void __fastcall ExpWnfDeleteProcessContext(unsigned __int64 *P, int a2)
{
  ...
  while ( 1 )
  {
    ...
    v11 = v10;
    if ( _interlockedbittestandset64((volatile signed __int32 *)v2, 0LL) )
      ExfAcquirePushLockExclusiveEx(v2, (__int64)v10, (__int64)v2);
    if ( v11 )
      *((_BYTE *)v11 + 10) = 1;
  }
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)v2, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)P + 14, 0LL) )
    ExfAcquirePushLockExclusiveEx(P + 7, (__int64)v13, (__int64)(P + 7));
  if ( v14 )
    *((_BYTE *)v14 + 10) = 1;
  ...
  while ( 1 )
  {
    ...
    v24 = KeAbPreAcquire((__int64)(P + 7), 0LL);
    v25 = v24;
    if ( _interlockedbittestandset64((volatile signed __int32 *)v12, 0LL) )
      ExfAcquirePushLockExclusiveEx(P + 7, (__int64)v24, (__int64)(P + 7));
    if ( v25 )
      *((_BYTE *)v25 + 10) = 1;
  }
  if ( (_InterlockedExchangeAdd64(v12, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
  ...
  if ( a2 )
  {
    ...
    v19 = v17;
    if ( v18 )
      ExfAcquirePushLockExclusiveEx(&ExpWnfProcessesListLock, (__int64)v17, (__int64)&ExpWnfProcessesListLock);
    if ( v19 )
      *((_BYTE *)v19 + 10) = 1;
