/*
 * XREFs of BgDisplayProgressIndicator @ 0x140BB2628
 * Callers:
...
__int64 __fastcall BgDisplayProgressIndicator(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  char v4; // bl
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  {
    LOBYTE(v6) = v4;
    v7 = AnFwDisplayProgressIndicator(v6);
  }
  else
  {
    v7 = -1073741823;
