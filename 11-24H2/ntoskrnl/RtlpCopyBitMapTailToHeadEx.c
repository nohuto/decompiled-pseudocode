/*
 * XREFs of RtlpCopyBitMapTailToHeadEx @ 0x140411E44
 * Callers:
...
__int64 __fastcall RtlpCopyBitMapTailToHeadEx(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (a3 & 7) != 0 )
  {
    ...
    v12 = a3 & 0x3F;
    v13 = v10 & 0x3F;
    v14 = (__int64 *)(*v7 + 8 * (v11 + (a3 >> 6)));
    result = (__int64)*v5;
    v15 = (unsigned __int64 *)v14;
    v16 = (__int64 *)((char *)*v5 + 8 * v11);
    if ( v13 )
    {
      v17 = *v16;
      v18 = 64 - v12;
  ...
  else
  {
    ...
    {
      result = (__int64)*v5;
      *(_BYTE *)(*v7 + v6 + v8) = ((1 << v9) - 1) & *((_BYTE *)*v5 + v8) | *(_BYTE *)(*v7 + v6 + v8) & ~((1 << v9) - 1);
    }
    if ( v8 )
      return (__int64)memmove((void *)(v6 + *v7), *v5, v8);
  }
  return result;
}
