/*
 * XREFs of VerifierMmAllocateNonCachedMemory @ 0x140BA04E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierMmAllocateNonCachedMemory(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
