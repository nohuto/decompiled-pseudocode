/*
 * XREFs of HalpTimerConvertPerformanceCounterToAuxiliaryCounter @ 0x14053A910
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpTimerConvertAuxiliaryCounter @ 0x1404923F8 (HalpTimerConvertAuxiliaryCounter.c)
 */
