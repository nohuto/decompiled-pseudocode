/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x140651298
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x140651398 (EtwpDequeueBufferPendingCompressionFromQueue.c)
