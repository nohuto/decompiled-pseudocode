/*
 * XREFs of VerifierMmAllocateNodePagesForMdlEx @ 0x140BA03F0
 * Callers:
 *     <none>
 * Callees:
...
struct _MDL *__fastcall VerifierMmAllocateNodePagesForMdlEx(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  struct _MDL *v9; // rax
  struct _MDL *v10; // rbx
