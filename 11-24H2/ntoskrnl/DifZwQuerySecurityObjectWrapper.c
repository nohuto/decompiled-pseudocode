/*
 * XREFs of DifZwQuerySecurityObjectWrapper @ 0x140644B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySecurityObjectWrapper(
        void *a1,
        ...
        ULONG *LengthNeeded)
{
  ...
  LODWORD(v21) = ZwQuerySecurityObject(a1, a2, a3, a4, LengthNeeded);
  if ( v10 )
  {
