/*
 * XREFs of ?SmCompressCtxCreateThreadParams@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAPEAU_SM_COMPRESS_THREAD_PARAMS@1@PEAU_SM_COMPRESS_CONTEXT@1@K@Z @ 0x14044AAA4
 * Callers:
...
_QWORD *__fastcall SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxCreateThreadParams(__int64 a1, int a2)
{
  ...
  v5 = 0LL;
  if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(a1 + 144)) )
  {
    v6 = 40LL;
