...
unsigned __int64 __fastcall RtlpCopyBitMapTailToHead(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( (a3 & 7) != 0 )
  {
    ...
    v11 = a3 & 0x1F;
    v12 = a4 & 0x1F;
    v13 = (unsigned int *)(*v7 + 4 * (v10 + (v8 >> 5)));
    result = (unsigned __int64)*v5;
    v14 = v13;
    v15 = (int *)((char *)*v5 + 4 * v10);
    if ( v12 )
    {
      v16 = *v15;
      v17 = 32 - v11;
  ...
  else
  {
    ...
    {
      result = (unsigned __int64)*v5;
      *(_BYTE *)(v6 + *v7 + v25) = ((1 << v26) - 1) & *((_BYTE *)*v5 + v25) | *(_BYTE *)(v6 + *v7 + v25) & ~((1 << v26) - 1);
    }
    if ( v25 )
      return (unsigned __int64)memmove((void *)(v6 + *v7), *v5, v25);
  }
  return result;
}
