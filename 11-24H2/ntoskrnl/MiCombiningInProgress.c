/*
 * XREFs of MiCombiningInProgress @ 0x14068549C
 * Callers:
...
__int64 __fastcall MiCombiningInProgress(__int64 *a1, _QWORD *a2, int a3)
{
  ...
  v3 = *a1;
  v7 = 0;
  v8 = ExAcquireSpinLockExclusive(&dword_140E2FE00);
  if ( !a3 )
  {
    v14 = *a2;
    if ( *(_QWORD **)(*a2 + 8LL) == a2 )
    {
      ...
      if ( (_QWORD *)*v15 == a2 )
      {
        *v15 = v14;
        *(_QWORD *)(v14 + 8) = v15;
        RtlAvlRemoveNode((unsigned __int64 *)&qword_140E2FE08, (__int64)(a2 + 2));
        --*((_DWORD *)a1 + 16);
        if ( dword_140E2FE04 == 1 )
          MiFlushEntireTbDueToAttributeChange();
        --dword_140E2FE04;
        return MiReleaseSpinLockExclusive(&dword_140E2FE00, v8);
      }
    }
LABEL_19:
    __fastfail(3u);
  ...
  {
    dword_140E2FE18 = 1;
    qword_140E2FE10 = _InterlockedIncrement64(&PsNextSecurityDomain);
  }
...
LABEL_10:
  ...
  v7 = 1;
LABEL_12:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140E2FE08, (unsigned __int64)v12, v7, a2 + 2);
  return MiReleaseSpinLockExclusive(&dword_140E2FE00, v8);
}
