/*
 * XREFs of Feature_Servicing_IntgrSched_Sleep_Enlightenment__private_IsEnabledFallback @ 0x1405448C0
 * Callers:
...
__int64 __fastcall Feature_Servicing_IntgrSched_Sleep_Enlightenment__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
{
  return wil_details_IsEnabledFallback(
           a1,
           a2,
           (volatile signed __int32 **)&Feature_Servicing_IntgrSched_Sleep_Enlightenment__private_descriptor,
           a4);
}
