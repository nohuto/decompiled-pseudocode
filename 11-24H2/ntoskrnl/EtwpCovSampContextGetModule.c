/*
 * XREFs of EtwpCovSampContextGetModule @ 0x140901050
 * Callers:
 ...
 *     ProcessForExeModule @ 0x140489778 (ProcessForExeModule.c)
 *     EtwpCheckDebugInfoEqual @ 0x1404B31C0 (EtwpCheckDebugInfoEqual.c)
 ...
 *     EtwpCovSampContextFastFindModule @ 0x140A2B9BC (EtwpCovSampContextFastFindModule.c)
...
LABEL_42:
  ...
  {
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)v16, (__int64)v33, (__int64)v16);
    v33 = v104;
  }
  if ( v33 )
    *((_BYTE *)v33 + 10) = 1;
