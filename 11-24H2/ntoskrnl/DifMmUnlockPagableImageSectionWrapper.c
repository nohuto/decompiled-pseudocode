/*
 * XREFs of DifMmUnlockPagableImageSectionWrapper @ 0x140634B50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmUnlockPagableImageSectionWrapper(PVOID ImageSectionHandle)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *((_QWORD *)&v16 + 1) = ImageSectionHandle;
