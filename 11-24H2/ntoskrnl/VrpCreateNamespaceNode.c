        ...
        __int64 *a7)
{
  ...
  void *v31; // rcx
  void *v32; // rcx
  unsigned __int64 v33; // [rsp+20h] [rbp-30h] BYREF
...
LABEL_16:
      ...
      BestMatchNamespaceNode = VrpFindBestMatchNamespaceNode((unsigned __int64 *)a1, (unsigned __int16 *)v14, &v33);
      v23 = BestMatchNamespaceNode;
      if ( !BestMatchNamespaceNode || (v24 = *((_DWORD *)BestMatchNamespaceNode + 14), (v24 & 4) != 0) )
      {
        v28 = -1073741811;
      }
      else
      {
        ...
        *(_DWORD *)(v14 + 56) |= v24 & 2;
        ...
        v28 = VrpBuildKeyPath((PCUNICODE_STRING)(v23 + 12), &Source, (PUNICODE_STRING)(v14 + 40));
        if ( v28 >= 0 )
          goto LABEL_16;
      }
    }
