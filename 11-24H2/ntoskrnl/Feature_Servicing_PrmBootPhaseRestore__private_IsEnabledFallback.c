/*
 * XREFs of Feature_Servicing_PrmBootPhaseRestore__private_IsEnabledFallback @ 0x14054CA74
 * Callers:
...
__int64 __fastcall Feature_Servicing_PrmBootPhaseRestore__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
