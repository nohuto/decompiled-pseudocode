/*
 * XREFs of DifZwQueryInformationJobObjectWrapper @ 0x140643740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationJobObjectWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(49);
  ...
  LODWORD(v21) = ZwQueryInformationJobObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
