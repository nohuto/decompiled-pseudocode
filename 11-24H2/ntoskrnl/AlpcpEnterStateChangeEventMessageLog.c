/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x140898F7C
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x140742B20 (AlpcpAllocateSnapshotMessageLog.c)
