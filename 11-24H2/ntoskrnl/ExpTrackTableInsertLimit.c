/*
 * XREFs of ExpTrackTableInsertLimit @ 0x140653A30
 * Callers:
...
__int64 __fastcall ExpTrackTableInsertLimit(__int64 a1)
{
  ...
  if ( v3 >= 0 )
  {
    Pool2 = (unsigned int *)ExAllocatePool2(0x40uLL, 56LL * (unsigned int)(*(_DWORD *)(a1 + 4) - 1) + 64, 0x6C6F6F50u);
    if ( Pool2 )
    {
      v5 = 0LL;
      *Pool2 = *(_DWORD *)(a1 + 4);
      ...
      {
        v6 = (_WNF_STATE_NAME *)ExAllocatePool2(0x40uLL, 0x70uLL, 0x6C6F6F50u);
        ...
        *(_QWORD *)&Pool2[v7 + 2] = v6;
        ...
        while ( v10 );
        StateName = 0LL;
        if ( ZwCreateWnfStateName(&StateName, WnfTemporaryStateName, WnfDataScopeSystem, 0, 0LL, 4u, &unk_140E290D0) >= 0 )
          v6[8] = StateName;
      ...
      for ( i = 0; i < *Pool2; ++i )
      {
        ...
        else
        {
          ...
          *v14 = *(_QWORD *)(qword_140E290C8 + 8 * v18);
