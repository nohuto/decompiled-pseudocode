/*
 * XREFs of BiExportEfiBootManager @ 0x140AADFCC
 * Callers:
 ...
 *     BiTranslateDisplayOrder @ 0x140AA4E84 (BiTranslateDisplayOrder.c)
...
__int64 __fastcall BiExportEfiBootManager(void *a1, __int64 **a2)
{
  ...
  {
    Count >>= 4;
    Pool2 = (void *)ExAllocatePool2(0x102uLL, 4LL * Count, 0x4B444342u);
    Buf1 = Pool2;
    v11 = Pool2;
    if ( !Pool2 )
    {
