/*
 * XREFs of IpmiLibpParseDeviceInfo @ 0x14069FAAC
 * Callers:
...
__int64 __fastcall IpmiLibpParseDeviceInfo(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&xmmword_140EF9C10 = *(_QWORD *)(a2 + 8) & 0xFFFFFFFFFFFFFFFEuLL;
  BYTE8(xmmword_140EF9C10) = *(_BYTE *)(a2 + 8) & 1;
  BYTE9(xmmword_140EF9C10) = *(_BYTE *)(a2 + 6) & 0xFE;
  return 0LL;
}
