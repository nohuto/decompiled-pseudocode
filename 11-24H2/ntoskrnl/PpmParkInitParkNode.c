/*
 * XREFs of PpmParkInitParkNode @ 0x1405E3894
 * Callers:
  ...
  *(_QWORD *)(a1 + 840) = 2097153LL;
  ...
  do
  {
    ...
    *(_QWORD *)(v8 + v9 + 304) = 2097153LL;
    ...
    v35 = 0;
    v12 = (_WORD *)(*(_QWORD *)(a1 + 1280) + 640LL * v10);
  ...
  v3 = v40;
LABEL_27:
  if ( !*(_QWORD *)(a1 + 1272) && (PpmHeteroHgsContainmentState & 2) != 0 )
  ...
  *(_BYTE *)(a1 + 1185) = v21 > 1u;
  ...
  if ( v21 )
  {
    ...
    {
      v24 = v23++;
      v25 = (_WORD *)(*(_QWORD *)(a1 + 1280) + 640 * v24);
      LOWORD(v24) = *v25;
      v22 += *v25;
      v25[3] = *v25;
      v25[4] = v24;
        ...
        if ( (_WORD)v31 )
        {
          *v3 += 3 * (v31 + 1);
          if ( v4 && v28 < *(_BYTE *)(v4 + 12) )
            v32 = *(_QWORD *)(*(_QWORD *)(v4 + 1280) + v30 + 568);
          else
            v32 = 0LL;
