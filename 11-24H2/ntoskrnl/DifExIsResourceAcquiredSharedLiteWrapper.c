/*
 * XREFs of DifExIsResourceAcquiredSharedLiteWrapper @ 0x14061F940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExIsResourceAcquiredSharedLiteWrapper(PERESOURCE Resource)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(464);
  ...
  LODWORD(v18) = ExIsResourceAcquiredSharedLite(Resource);
  if ( v6 )
  {
