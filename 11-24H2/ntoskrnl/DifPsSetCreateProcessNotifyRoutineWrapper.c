/*
 * XREFs of DifPsSetCreateProcessNotifyRoutineWrapper @ 0x140637200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifPsSetCreateProcessNotifyRoutineWrapper(PCREATE_PROCESS_NOTIFY_ROUTINE NotifyRoutine, BOOLEAN a2)
{
  ...
  DWORD2(v16) = PsSetCreateProcessNotifyRoutine(NotifyRoutine, a2);
  if ( v6 )
  {
