/*
 * XREFs of PiDevCfgResolveVariableDeviceProperty @ 0x140A8B600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_62:
      ...
      if ( (unsigned int)v26 <= 0xD )
      {
        if ( (_DWORD)v26 == 13 )
        {
          ...
          {
            v18 = v27.Length + 2;
            Pool2 = (GUID *)ExAllocatePool2(0x100uLL, v18, 0x63647050u);
            v14 = Pool2;
            if ( Pool2 )
            {
              Buffer = v27.Buffer;
...
LABEL_18:
            if ( (_DWORD)v23 == 2 )
            {
              v15 = 4;
              v18 = 4;
              v14 = (PGUID)ExAllocatePool2(0x100uLL, 4uLL, 0x63647050u);
              if ( v14 )
              {
...
LABEL_48:
      ...
      if ( (_DWORD)v26 == 17 )
      {
        if ( (_DWORD)v23 == 1 )
        {
          v15 = 4;
          v18 = 4;
          v21 = ExAllocatePool2(0x100uLL, 4uLL, 0x63647050u);
          Data1_low = 0;
          v14 = (PGUID)v21;
          if ( v21 )
          {
