/*
 * XREFs of PpmParkSteerInterrupts @ 0x140352C70
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)&v67.Count = 2097153LL;
  ...
  while ( 1 )
  {
    while ( v17 )
    {
      ...
      v17 &= ~(1LL << v19);
      v20 = *((unsigned int *)qword_140F21E78 + 64 * (unsigned __int16)v18 + (unsigned __int8)v19);
...
LABEL_32:
  ...
  if ( !v16 )
  {
    if ( PpmCachedSystemAllowedCpuSet.Count == 1 )
    {
      ...
      LowestClassProcessorInMask = KiIntPartGetLowestClassProcessorInMask(&v60);
    }
    else
    {
      ...
      if ( v41 < v15 )
      {
        ...
        *(_QWORD *)&v73.Count = 2097153LL;
        ...
        if ( PpmParkPreferenceHandler )
        {
          ...
          v56 = 0LL;
          v55 = 0LL;
          guard_dispatch_icall_no_overrides(1LL, PpmCheckTime, v41, &v67);
        }
        v42 = 0;
        if ( v66.Count )
        {
