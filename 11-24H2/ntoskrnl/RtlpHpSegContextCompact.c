/*
 * XREFs of RtlpHpSegContextCompact @ 0x1402B4260
 * Callers:
      ...
      do
      {
              ...
              i += 32LL * *(unsigned __int8 *)(i + 31) )
        {
          if ( (*(_BYTE *)(i + 24) & 1) == 0 && *(_WORD *)(i + 28) != 0xFFFF )
          {
            ...
            *(_BYTE *)(v9 + i + 24) |= 1u;
            i = RtlpHpSegPageRangeCoalesce(a1, i, 1LL, &v17);
            v10 = (_QWORD *)RtlpHpSegFreeRangeInsert(a1, i, 0LL);
            if ( v10 )
            {
              v11 = *v10;
              v5 = (_QWORD *)v5[1];
