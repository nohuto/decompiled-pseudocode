/*
 * XREFs of Feature_AntiStarvationReadyPeriodVariable__private_GetVariant @ 0x1405B1EEC
 * Callers:
...
__int64 Feature_AntiStarvationReadyPeriodVariable__private_GetVariant()
{
  __int64 CachedVariantState; // rax
  unsigned int v1; // ebx

  CachedVariantState = wil_details_FeatureStateCache_GetCachedVariantState(
                         &Feature_AntiStarvationReadyPeriodVariable__private_featureState,
                         (__int64)&Feature_AntiStarvationReadyPeriodVariable__private_descriptor);
