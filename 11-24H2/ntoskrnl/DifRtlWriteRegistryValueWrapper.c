/*
 * XREFs of DifRtlWriteRegistryValueWrapper @ 0x14063B040
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ValueLength)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v15 = 0;
    LODWORD(v26) = a1;
    *(_QWORD *)&v24 = ValueData;
    DWORD2(v23) = ValueLength;
    *((_QWORD *)&v25 + 1) = a2;
    *(_QWORD *)&v25 = a3;
    DWORD2(v24) = a4;
  ...
  HIDWORD(v26) = RtlWriteRegistryValue(a1, a2, a3, a4, ValueData, ValueLength);
  if ( v13 )
  {
