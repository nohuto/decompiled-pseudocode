/*
 * XREFs of DifRtlWriteRegistryValueWrapper @ 0x140639600
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ValueLength)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    LODWORD(v22) = a1;
    *(_QWORD *)&v20 = ValueData;
    DWORD2(v19) = ValueLength;
    *((_QWORD *)&v21 + 1) = a2;
    *(_QWORD *)&v21 = a3;
    DWORD2(v20) = a4;
  ...
  HIDWORD(v22) = RtlWriteRegistryValue(a1, a2, a3, a4, ValueData, ValueLength);
  if ( v11 )
  {
