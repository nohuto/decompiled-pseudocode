/*
 * XREFs of MiProbeLockFrame @ 0x140282AC0
 * Callers:
...
__int64 __fastcall MiProbeLockFrame(__int64 a1, int a2)
{
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 136) = 0xAAAAAAAAAAAAAAABuLL * ((v8 + 0x220000000000LL) >> 4);
  }
...
LABEL_66:
        v14 = 1;
        v15 = (ULONG *)*((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(v8 + 40) >> 43) & 0x3FFLL));
...
LABEL_23:
    ...
    if ( !(unsigned int)MiChargePartitionResidentAvailable(v15, 1LL, 0LL) )
    {
      if ( v14 )
...
LABEL_27:
  ...
  *(_DWORD *)(v8 + 32) = v19;
  ...
  if ( ((*(_QWORD *)(v8 + 40) >> 43) & 0x3FF) != 0 )
    ExAcquireRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*((_QWORD *)qword_140E2FF88
