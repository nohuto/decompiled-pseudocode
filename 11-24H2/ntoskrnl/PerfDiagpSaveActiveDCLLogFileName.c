/*
 * XREFs of PerfDiagpSaveActiveDCLLogFileName @ 0x140A87340
 * Callers:
...
void PerfDiagpSaveActiveDCLLogFileName()
{
  ...
  if ( ValueData )
  {
    ...
    wcscpy(&xmmword_140EFF76C, L"WdiContextLog");
    RtlInitUnicodeString(&stru_140EFF820, &xmmword_140EFF76C);
    qword_140EFF818 = (__int64)ValueData;
    word_140EFF812 = 520;
    LODWORD(dword_140EFF790[0]) = 176;
    if ( (int)NtTraceControl(3u, (unsigned int *)dword_140EFF790, 0xB0u, dword_140EFF790, 0xB0u, (unsigned __int64)&v3) < 0
      || (unsigned __int16)word_140EFF810 < 2u )
    {
      KeyHandle = 0LL;
    ...
    {
      v1 = (unsigned __int16)word_140EFF810 >> 1;
      ValueData[v1] = 0;
