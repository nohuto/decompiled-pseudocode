/*
 * XREFs of DifMmAllocateContiguousMemoryWrapper @ 0x140631F30
 * Callers:
 *     <none>
 * Callees:
        ...
        PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *(_QWORD *)&v20 = NumberOfBytes;
    *((PHYSICAL_ADDRESS *)&v19 + 1) = HighestAcceptableAddress;
  ...
  *((_QWORD *)&v20 + 1) = MmAllocateContiguousMemory(NumberOfBytes, HighestAcceptableAddress);
  if ( v8 )
  {
