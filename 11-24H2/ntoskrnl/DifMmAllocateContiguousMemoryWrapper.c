/*
 * XREFs of DifMmAllocateContiguousMemoryWrapper @ 0x1406304F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmAllocateContiguousMemoryWrapper(
        ...
        PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(238);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = NumberOfBytes;
    *((PHYSICAL_ADDRESS *)&v15 + 1) = HighestAcceptableAddress;
  ...
  *((_QWORD *)&v16 + 1) = MmAllocateContiguousMemory(NumberOfBytes, HighestAcceptableAddress);
  if ( v6 )
  {
