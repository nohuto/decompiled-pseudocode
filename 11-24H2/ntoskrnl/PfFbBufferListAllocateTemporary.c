/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x140477570
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x140477540 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x140746FB0 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
