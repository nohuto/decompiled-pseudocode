/*
 * XREFs of sub_1407B9488 @ 0x1407B9488
 * Callers:
...
__int64 __fastcall sub_1407B9488(__int64 a1, const void *a2, _DWORD *a3, void *a4, unsigned int a5, _DWORD *a6)
{
  void *v8; // rax
  ...
  v8 = bsearch(
         ...
         *(unsigned int *)(a1 + 46824),
         0x10uLL,
         (int (__cdecl *)(const void *, const void *))sub_1407B8D30);
  if ( v8 )
  {
