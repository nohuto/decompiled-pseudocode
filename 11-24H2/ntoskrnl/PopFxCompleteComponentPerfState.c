/*
 * XREFs of PopFxCompleteComponentPerfState @ 0x1404B6CBC
 * Callers:
...
__int64 __fastcall PopFxCompleteComponentPerfState(__int64 a1, unsigned int a2, __int64 a3, char a4)
{
  ...
  PopDiagTraceFxPerfRequestProgress(a3, v10 & 7, i);
  if ( v10 >= 0 )
  {
  ...
  LOBYTE(v14) = a4;
  guard_dispatch_icall_no_overrides(*(_QWORD *)(a1 + 192), a2, v14, v9);
  if ( v10 < 0 )
  {
