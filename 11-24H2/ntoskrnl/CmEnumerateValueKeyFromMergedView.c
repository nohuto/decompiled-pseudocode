/*
 * XREFs of CmEnumerateValueKeyFromMergedView @ 0x140A5F148
 * Callers:
...
LABEL_17:
            if ( !v66 )
            {
              ...
              if ( (*(_BYTE *)(v41 + 140) & 1) != 0 )
                ...
                CellFlat = HvpGetCellPaged(v41, v40, v63);
              v69 = CellFlat;
              if ( !CellFlat )
              {
...
LABEL_51:
            ...
            for ( i = *(_QWORD *)v60 + 32LL; ; i = v70 )
            {
              ...
              if ( !v14 )
              {
                v35 = *v22;
                v36 = v67[1];
                v37 = (*(_BYTE *)(*v22 + 140) & 1) != 0 ? HvpGetCellFlat(v35, v36, v57) : HvpGetCellPaged(v35, v36, v57);
                v56 = v37;
                v14 = v37;
                if ( !v37 )
                {
              ...
              if ( (*(_BYTE *)(v27 + 140) & 1) != 0 )
                CellPaged = HvpGetCellFlat(v27, v28, &v55);
              else
                CellPaged = HvpGetCellPaged(v27, v28, &v55);
              v30 = CellPaged;
              if ( !CellPaged )
                goto LABEL_46;
...
LABEL_96:
            ...
            if ( v44 > a4 )
            {
              ...
              if ( (*(_BYTE *)(*(_QWORD *)i + 140LL) & 1) != 0 )
                ...
                v51 = HvpGetCellPaged(v49, v50, v61);
              v23 = v51;
              if ( v51 )
              {
                v52 = a4 - v72;
                ...
                if ( (*(_BYTE *)(v27 + 140) & 1) != 0 )
                  v54 = HvpGetCellFlat(v27, v53, &v55);
                else
                  v54 = HvpGetCellPaged(v27, v53, &v55);
                v30 = v54;
                if ( v54 )
                {
                  v43 = *(_QWORD *)v60;
...
LABEL_50:
        ...
        if ( (*(_BYTE *)(v19 + 140) & 1) != 0 )
          ...
          v21 = HvpGetCellPaged(v19, v20, v62);
        v68 = v21;
        if ( v21 )
        {
