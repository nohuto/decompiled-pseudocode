/*
 * XREFs of KeGetNextClockTickDuration @ 0x1405B8FD0
 * Callers:
...
LABEL_10:
  if ( (unsigned int)dword_140E070B8 > 5 )
  {
    ...
    v25 = 1;
    v26 = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E070B8, (unsigned __int8 *)byte_140047B1B, 0LL, 0LL, 6u, &v14);
  }
  return v5;
}
