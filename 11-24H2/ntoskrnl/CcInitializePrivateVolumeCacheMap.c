...
char __fastcall CcInitializePrivateVolumeCacheMap(__int64 a1, __int64 a2, __int64 *a3, __int64 a4)
{
  ...
  char v30; // [rsp+B0h] [rbp+30h] BYREF
  ...
  *(_DWORD *)(a2 + 804) = CcMaxCachemapUninitWorkerThreads;
  ...
  {
    v21 = CcAzure_LazyWriterPercentageOfNumProcs * KeQueryActiveProcessorCountEx(0xFFFFu) / 0x64;
    if ( *(_DWORD *)(a2 + 776) < v21 )
      *(_DWORD *)(a2 + 776) = v21;
  }
  *(_DWORD *)(a2 + 704) = 0;
  *(_BYTE *)(a2 + 708) = 0;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
         ...
         (PVOID)a2) >= 0 )
  {
    ...
    {
      if ( !(unsigned __int8)CcInitializeNumaNodeForVolume(a2, v4 + 400LL * i, v23, i) )
        goto LABEL_40;
      if ( *a3 )
        *a3 = 0LL;
    }
    if ( (unsigned __int8)CcInitializeQuickLWSThreadItem(a2) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        *(_QWORD *)(a2 + 1072) = PoolWithTag;
        v30 = 1;
        CcForEachNumaNode(CcInitializeAsyncReadForNodeHelper, a1, a2, &v30);
        if ( v30 )
        {
          if ( (*(_DWORD *)(a2 + 1616) & 1) == 0
            || (v30 = 1, CcForEachNumaNode(CcInitializeAsyncLazywriteForNodeHelper, a1, a2, &v30), v30) )
          {
            ++*(_DWORD *)(a2 + 4);
            v9 = 1;
            *(_BYTE *)(a2 + 1236) = 1;
