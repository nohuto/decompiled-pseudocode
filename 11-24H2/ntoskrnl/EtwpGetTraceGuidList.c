/*
 * XREFs of EtwpGetTraceGuidList @ 0x140836488
 * Callers:
 *     NtTraceControl @ 0x140834A80 (NtTraceControl.c)
 * Callees:
 *     EtwpCopyMetaProviderGuids @ 0x14048CEFC (EtwpCopyMetaProviderGuids.c)
 *     EtwpMetaProviderCount @ 0x1404B3804 (EtwpMetaProviderCount.c)
