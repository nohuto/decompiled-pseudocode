/*
 * XREFs of LookUpTableFlushComplete @ 0x140A5206C
 * Callers:
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 288) )
    {
      if ( (unsigned int)dword_140E0A508 > 5 && tlgKeywordOn((__int64)&dword_140E0A508, 0x200000000000LL) )
      {
        v11 = 4;
        v37 = 42;
        v34 = L"SummaryCount";
