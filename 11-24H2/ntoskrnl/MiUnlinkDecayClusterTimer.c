/*
 * XREFs of MiUnlinkDecayClusterTimer @ 0x140451888
 * Callers:
...
unsigned __int64 __fastcall MiUnlinkDecayClusterTimer(__int64 a1)
{
  ...
  else
  {
    ...
    *(_QWORD *)(48 * (qword_140E35B00 + v6) - 0x220000000000LL + 8) ^= (result ^ *(_QWORD *)(48 * (qword_140E35B00 + v6)
                                                                                           - 0x220000000000LL
  ...
  if ( v5 == 0x7FFFFFFF )
    ...
    *(_QWORD *)(48 * (v5 + qword_140E35B00) - 0x220000000000LL + 8) = result ^ (*(_QWORD *)(48 * (v5 + qword_140E35B00)
                                                                                          - 0x220000000000LL
