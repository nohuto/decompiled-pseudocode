/*
 * XREFs of HvpViewMapPromoteRangeToMapping @ 0x14096AEDC
 * Callers:
...
__int64 __fastcall HvpViewMapPromoteRangeToMapping(ULONG_PTR a1, int a2, unsigned int a3, __int64 *a4)
{
  ...
  v13 = HvpViewMapCreateView(a1, (LARGE_INTEGER)(v4 & -MemoryAllocationGranularity), v6, &Node);
  v14 = Node;
  ViewRangeValid = v13;
  if ( v13 >= 0 )
  {
    ViewRangeValid = HvpViewMapMakeViewRangeValid(a1, Node, v4, v6, 0);
    if ( ViewRangeValid >= 0 )
    {
      ...
      v16 = (_RTL_BALANCED_NODE *)HvpViewMapFindViewForFileOffset(a1, v6 - 1);
      ...
      if ( v16[2].Children[0] == (_RTL_BALANCED_NODE *)v6 )
      {
