/*
 * XREFs of PopDiagTraceSleepStudyStop @ 0x140AA7A4C
 * Callers:
...
void __fastcall PopDiagTraceSleepStudyStop(__int64 a1)
{
    ...
    && EtwEventEnabled(PopDiagSleepStudyHandle, &SLEEPSTUDY_EVT_SCENARIO_STOP_REASON) )
  {
    ...
    {
      v13 = 0;
      v14 = byte_140F0A6C8 & 1;
      v3 = byte_140F0A6C9 & 1;
      v15 = ((unsigned __int8)byte_140F0A6C9 >> 1) & 1;
      v11 = ((unsigned __int8)byte_140F0A6C9 >> 4) & 1;
      v10 = ((unsigned __int8)byte_140F0A6C9 >> 3) & 1;
      v9 = ((unsigned __int8)byte_140F0A6C9 >> 5) & 3;
      v7 = (unsigned __int8)byte_140F0A721;
      v5 = (unsigned __int8)byte_140F0A720;
      v6 = (unsigned __int8)byte_140F0A6F8;
      v8 = dword_140F0A678;
      v4 = ((unsigned __int8)byte_140F0A6C9 >> 2) & 1;
      *(_QWORD *)UserData = &PopWdiScenarioStopEventData;
      *(_QWORD *)(UserData + 8) = 4LL;
      *(_QWORD *)(UserData + 16) = &unk_140F0A668;
      *(_QWORD *)(UserData + 24) = 8LL;
      *(_QWORD *)(UserData + 32) = &v14;
      *(_QWORD *)(UserData + 40) = 4LL;
      *(_QWORD *)(UserData + 48) = &unk_140F0A6D0;
      *(_QWORD *)(UserData + 56) = 8LL;
      *(_QWORD *)(UserData + 64) = &unk_140F0A6D8;
      *(_QWORD *)(UserData + 72) = 8LL;
      *(_QWORD *)(UserData + 80) = &unk_140F0A6E0;
      *(_QWORD *)(UserData + 88) = 8LL;
      *(_QWORD *)(UserData + 96) = &unk_140F0A660;
      *(_QWORD *)(UserData + 104) = 8LL;
      *(_QWORD *)(UserData + 112) = &unk_140F0A65C;
      *(_QWORD *)(UserData + 120) = 4LL;
      *(_QWORD *)(UserData + 128) = &unk_140F0A6A0;
      *(_QWORD *)(UserData + 136) = 8LL;
      *(_QWORD *)(UserData + 144) = &v13;
      *(_QWORD *)(UserData + 152) = 1LL;
      *(_QWORD *)(UserData + 160) = &unk_140F0A658;
      *(_QWORD *)(UserData + 168) = 4LL;
      *(_QWORD *)(UserData + 176) = &unk_140F0A698;
      *(_QWORD *)(UserData + 184) = 8LL;
      *(_QWORD *)(UserData + 192) = &unk_140F0A6C4;
      ...
      *(_QWORD *)(UserData + 240) = &unk_140F0A6A8;
      *(_QWORD *)(UserData + 256) = &v4;
      *(_QWORD *)(UserData + 264) = 4LL;
      *(_QWORD *)(UserData + 272) = &unk_140F0A6F0;
      *(_QWORD *)(UserData + 280) = 4LL;
      *(_QWORD *)(UserData + 288) = &unk_140F0A6F4;
      *(_QWORD *)(UserData + 296) = 4LL;
      *(_QWORD *)(UserData + 304) = &unk_140F0A6FC;
      *(_QWORD *)(UserData + 312) = 4LL;
      *(_QWORD *)(UserData + 320) = &unk_140F0A708;
      *(_QWORD *)(UserData + 328) = 4LL;
      *(_QWORD *)(UserData + 336) = &unk_140F0A70C;
      *(_QWORD *)(UserData + 344) = 4LL;
      *(_QWORD *)(UserData + 352) = &unk_140F0A648;
      *(_QWORD *)(UserData + 360) = 4LL;
      *(_QWORD *)(UserData + 368) = &unk_140F0A650;
      *(_QWORD *)(UserData + 376) = 8LL;
      *(_QWORD *)(UserData + 384) = &unk_140F0A71C;
      *(_QWORD *)(UserData + 392) = 4LL;
      *(_QWORD *)(UserData + 400) = &v5;
      *(_QWORD *)(UserData + 408) = 4LL;
      *(_QWORD *)(UserData + 416) = &unk_140F0A724;
      *(_QWORD *)(UserData + 424) = 4LL;
      *(_QWORD *)(UserData + 432) = &unk_140F0A728;
      ...
      *(_QWORD *)(UserData + 496) = &unk_140F0A700;
      *(_QWORD *)(UserData + 504) = 4LL;
      *(_QWORD *)(UserData + 512) = &unk_140F0A704;
      ...
      *(_QWORD *)(UserData + 592) = &unk_140F0A6B8;
      *(_QWORD *)(UserData + 600) = 4LL;
      *(_QWORD *)(UserData + 608) = &unk_140F0A6B0;
      *(_QWORD *)(UserData + 616) = 8LL;
      *(_QWORD *)(UserData + 624) = &unk_140F0A79C;
      *(_QWORD *)(UserData + 632) = 4LL;
      *(_QWORD *)(UserData + 640) = &unk_140F0A7C4;
      *(_QWORD *)(UserData + 648) = 1LL;
      *(_QWORD *)(UserData + 656) = &unk_140F0A7C8;
      *(_QWORD *)(UserData + 664) = 8LL;
      *(_QWORD *)(UserData + 680) = 8LL;
      *(_QWORD *)(UserData + 672) = &unk_140F0A7D0;
      *(_QWORD *)(UserData + 696) = 8LL;
      *(_QWORD *)(UserData + 688) = &unk_140F0A7D8;
      *(_QWORD *)(UserData + 712) = 8LL;
      *(_QWORD *)(UserData + 704) = &unk_140F0A7E0;
      *(_QWORD *)(UserData + 728) = 8LL;
      *(_QWORD *)(UserData + 720) = &unk_140F0A7E8;
      EtwWrite(
