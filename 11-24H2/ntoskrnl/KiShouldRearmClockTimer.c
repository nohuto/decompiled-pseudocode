/*
 * XREFs of KiShouldRearmClockTimer @ 0x14043516C
 * Callers:
...
char __fastcall KiShouldRearmClockTimer(__int64 a1, LARGE_INTEGER InterruptTimePrecise, char a3)
{
  ...
  ClockTimerEarliestDeadline = KiGetClockTimerEarliestDeadline(a1, a3);
  v10 = *(LARGE_INTEGER *)(a1 + 16LL * ClockTimerEarliestDeadline + 38296);
  ...
  if ( (unsigned int)dword_140E07080 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_140047E86,
      0LL,
      0LL,
      0xAu,
      &v22);
