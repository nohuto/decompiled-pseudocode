/*
 * XREFs of __asan_load16_volatile @ 0x1405A84C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_load16_volatile(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r9d
  ...
  if ( (((_BYTE)BugCheckParameter1 + 8) & 7) != 0 )
  {
    ...
    else
    {
      ...
      if ( v5 && v5 < 8 && (char)(((BugCheckParameter1 + 15) & 7) + 1) > v5 )
LABEL_49:
        LOBYTE(v3) = (unsigned __int8)KasaniReport(BugCheckParameter1, 0x10uLL, 0, v1, v5);
    }
  }
  else if ( v5 && v5 < 8 )
  {
...
LABEL_50:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 16, 0, v4, v1);
  }
  return v3;
}
