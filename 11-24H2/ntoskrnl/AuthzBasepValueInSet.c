/*
 * XREFs of AuthzBasepValueInSet @ 0x140325148
 * Callers:
...
LABEL_24:
      ...
      if ( LOWORD(v25[0]) == 4 )
      {
        v19 = AuthzBasepGetNextValue(a2, v22);
        v11 = v19;
        if ( v19 == -2147483622 )
          goto LABEL_24;
        if ( v19 < 0 )
      ...
      if ( AuthzBasepOperandValueTypesCompatible((__int16 *)v25) )
        break;
      if ( !a4 )
      {
        v11 = -1073741406;
...
LABEL_32:
    ...
    LODWORD(v18) = 128;
    v16 = AuthzBasepCompareFQBNOperands(v18, v25, a3);
LABEL_13:
    v11 = v16;
    if ( v16 < 0 )
      goto LABEL_14;
