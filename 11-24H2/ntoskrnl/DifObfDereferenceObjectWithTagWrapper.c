/*
 * XREFs of DifObfDereferenceObjectWithTagWrapper @ 0x140634C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifObfDereferenceObjectWithTagWrapper(PVOID Object, ULONG Tag)
{
  ...
  *((_QWORD *)&v16 + 1) = ObfDereferenceObjectWithTag(Object, Tag);
  if ( v6 )
  {
