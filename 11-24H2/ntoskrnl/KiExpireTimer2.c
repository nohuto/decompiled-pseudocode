/*
 * XREFs of KiExpireTimer2 @ 0x1403AF650
 * Callers:
...
LABEL_39:
    ...
    *(_QWORD *)(SystemArgument1 + 72) = v37;
    while ( 1 )
    {
      ...
      if ( v38 )
        goto LABEL_4;
      v52 = *(_QWORD *)(SystemArgument1 + 72);
      v53 = *(_QWORD *)(SystemArgument1 + 88);
      v54 = v52 + v53;
      if ( v52 + v53 < v52 || v54 == -1 )
      {
        v38 = 1;
        v54 = -2LL;
      }
      *(_QWORD *)(SystemArgument1 + 72) = v54;
      v55 = *(_QWORD *)(SystemArgument1 + 80);
      if ( v55 != -1LL )
      {
        v56 = v55 + v53;
        if ( v55 + v53 < v55 || v56 == -1 )
          v56 = -2LL;
        *(_QWORD *)(SystemArgument1 + 80) = v56;
      }
    }
    v9 = 1;
  }
  ...
  *(_DWORD *)(SystemArgument1 + 4) = 1;
  ...
  else
  {
    while ( v11 != v10 )
    {
      ...
      {
        case 1:
          KiTryUnwaitThread(a2, v50, *(unsigned __int16 *)(v50 + 18), 0LL);
          break;
        case 2:
          *(_BYTE *)(v50 + 17) = 5;
          KiInsertQueueInternal(*(_QWORD *)(v50 + 24), (__int64 *)v50);
          break;
        case 4:
          *(_BYTE *)(v50 + 17) = 5;
          *(_DWORD *)(SystemArgument1 + 4) = 0;
          KeInsertQueueDpc(*(PRKDPC *)(v50 + 24), (PVOID)SystemArgument1, (PVOID)v50);
          break;
        default:
          KiTryUnwaitThread(a2, v50, 256LL, 0LL);
          break;
      }
    }
...
LABEL_12:
  ...
  v63 = *(_DWORD *)SystemArgument1;
  v64 = v9 << 8;
  v65 = v64 | *(_DWORD *)SystemArgument1 & 0xFFFFF07F;
  v66 = _InterlockedCompareExchange((volatile signed __int32 *)SystemArgument1, v65, *(_DWORD *)SystemArgument1);
  if ( v63 != v66 )
  {
    do
    {
      v67 = v66;
      v65 = v64 | v66 & 0xFFFFF07F;
      v66 = _InterlockedCompareExchange((volatile signed __int32 *)SystemArgument1, v65, v66);
    }
    while ( v67 != v66 );
  }
  if ( (v65 & 0x3F00) == 0x2000 )
  {
    KiFinalizeTimer2Disablement(SystemArgument1);
    v28 = v69;
LABEL_25:
...
LABEL_26:
  ...
  if ( v28 )
  {
    ...
    if ( !v22 )
      EtwGetKernelTraceTimestamp((LARGE_INTEGER *)v83, 0x40020000u);
    return EtwTraceTimedEvent(3945, 0x40020000u, (__int64)&v76, 56, 0x500E02u, (__int64)v83);
  }
  return result;
}
