/*
 * XREFs of SshSessionManagerTraceBatteryCountChange @ 0x140766B0C
 * Callers:
...
__int64 __fastcall SshSessionManagerTraceBatteryCountChange(int a1, int a2, int a3, char a4, char a5)
{
