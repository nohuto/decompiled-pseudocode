/*
 * XREFs of RtlpHpVsSubsegmentCommitPages @ 0x1402C08BC
 * Callers:
 ...
 *     RtlpHpSegLfhVsDecommit @ 0x1402C1450 (RtlpHpSegLfhVsDecommit.c)
...
__int64 __fastcall RtlpHpVsSubsegmentCommitPages(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4, int a5)
{
  ...
  if ( a5 )
  {
    if ( (__int64 (__fastcall *)(__int64 *, __int64, unsigned int, _DWORD *))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 32)) == RtlpHpSegLfhVsCommit )
      ...
      v14 = guard_dispatch_icall_no_overrides(v13, v8, v11, 0LL);
    v15 = v14;
    if ( v14 < 0 )
      goto LABEL_9;
    *(_QWORD *)(a2 + 16) |= v12;
  ...
  else
  {
    if ( (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 40)) == RtlpHpSegLfhVsDecommit )
      ...
      guard_dispatch_icall_no_overrides(v13, v8, v11, a4);
    *(_QWORD *)(a2 + 16) &= ~v12;
    v16 = -(int)v6;
  }
