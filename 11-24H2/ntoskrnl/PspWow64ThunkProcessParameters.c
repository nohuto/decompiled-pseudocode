/*
 * XREFs of PspWow64ThunkProcessParameters @ 0x14047FE44
 * Callers:
  ...
  if ( result >= 0 )
  {
    ...
    *((_WORD *)v20 + 343) = *((_WORD *)a2 + 529);
    ...
    if ( *((_WORD *)a2 + 112) && *((_QWORD *)a2 + 29) )
    {
      v33 = 0LL;
      v35[35] = (_DWORD)v10;
      v23 = *((unsigned __int16 *)a2 + 112);
      if ( (unsigned __int16)v23 < 4u )
        v24 = 0LL;
      else
        v24 = **((unsigned int **)a2 + 29);
      v25 = v24 + 8 * v24 + 4;
      v33 = v25;
      ...
      {
        v27 = v23 - v25;
        memmove(v10, v26, v24 + 4);
        v28 = (_DWORD *)(v24 + *((_QWORD *)a2 + 29) + 4LL);
        v29 = &v10[v24 + 4];
        for ( i = 0LL; i < v24; ++i )
        {
          *(_DWORD *)v29 = *v28;
    ...
    {
      v35[174] = v21;
      v22 = (char *)((unsigned __int64)(v10 + 3) & 0xFFFFFFFFFFFFFFFCuLL);
      v36 = v22;
      v35[173] = (_DWORD)v22;
      memmove(v22, *((const void **)a2 + 134), 8LL * a2[270]);
      v36 = &v22[8 * a2[270]];
    }
    v35[18] = (_DWORD)v11;
    v35[164] = a2[252];
