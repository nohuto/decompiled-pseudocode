/*
 * XREFs of Feature_CompatPreallocatedVelocity55922062__private_IsEnabledFallback @ 0x140695ACC
 * Callers:
...
__int64 __fastcall Feature_CompatPreallocatedVelocity55922062__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
