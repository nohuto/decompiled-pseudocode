/*
 * XREFs of MiGetSystemAddressForImage @ 0x140A5536C
 * Callers:
 ...
 *     MiImageSuitableForSystem @ 0x140A90DB8 (MiImageSuitableForSystem.c)
...
LABEL_52:
        ...
        if ( (int)MiRelocateImage(*v4, (unsigned int)&ImageBase, v19, 1, -1LL, 1) < 0 )
          return 0LL;
