/*
 * XREFs of SepAdtMarshallAuditRecord @ 0x1403C2AF8
 * Callers:
...
__int64 __fastcall SepAdtMarshallAuditRecord(_DWORD *Src, void **a2, _DWORD *a3, int a4)
{
  ...
  *a2 = PoolWithTag;
  ...
  {
    *a3 = (a4 != 1) + 4;
    memmove(*a2, v13, 1048 - 32LL * (unsigned int)(32 - v13[2]));
    v52 = 0;
    *((_DWORD *)*a2 + 3) = v15;
    *((_DWORD *)*a2 + 5) |= 1u;
    v17 = v13[2];
...
LABEL_29:
          ...
          *v19 = v18 - (_BYTE *)*a2;
          v37 = v18 + 16;
          memmove(v37, v35[1], *(unsigned __int16 *)v35);
          v38 = *(_WORD *)v35;
          *(_WORD *)v36 = *(_WORD *)v35;
          *((_WORD *)v36 + 1) = v38;
          *((_QWORD *)v36 + 1) = v37 - (_BYTE *)*a2;
          v18 = &v37[(*(unsigned __int16 *)v35 + 7LL) & 0xFFFFFFF8LL];
          goto LABEL_19;
        }
        v23 = v22 - 2;
        if ( v23 )
