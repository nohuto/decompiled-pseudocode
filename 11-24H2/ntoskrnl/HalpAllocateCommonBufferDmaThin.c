/*
 * XREFs of HalpAllocateCommonBufferDmaThin @ 0x1403962A4
 * Callers:
 *     HalAllocateCommonBufferDmaThinEx @ 0x140396820 (HalAllocateCommonBufferDmaThinEx.c)
 *     HalAllocateCommonBufferWithBoundsDmaThin @ 0x14054EC20 (HalAllocateCommonBufferWithBoundsDmaThin.c)
 *     HalAllocateDomainCommonBufferDmaThin @ 0x14054ECA0 (HalAllocateDomainCommonBufferDmaThin.c)
 * Callees:
  ...
  if ( CommonBufferEntry >= 0 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)v28 = v10;
      ...
      if ( *(_DWORD *)(a1 + 48) == 2
        && ((v23 = *(PHYSICAL_ADDRESS *)(a1 + 16), a7 != 0x80000000)
...
LABEL_18:
        ...
        {
LABEL_19:
          CommonBufferEntry = HalpAllocateCommonBufferEntry((_DWORD)v12, (_DWORD)v9, 0, a1, 1, 0LL);
          *a8 = PhysicalAddress;
          v20 = a9;
          *a9 = v9;
          if ( CommonBufferEntry >= 0 )
          ...
          if ( v33 )
            guard_dispatch_icall_no_overrides(*(_QWORD *)(a1 + 40), 0LL);
LABEL_31:
        ...
        v25 = *(_QWORD *)(a1 + 40);
        *((_QWORD *)&v29 + 1) = v12;
        CommonBufferEntry = guard_dispatch_icall_no_overrides(v25, 3LL);
        if ( CommonBufferEntry >= 0 )
        {
