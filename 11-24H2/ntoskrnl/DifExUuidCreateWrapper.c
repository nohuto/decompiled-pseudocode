/*
 * XREFs of DifExUuidCreateWrapper @ 0x14061FDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExUuidCreateWrapper(UUID *Uuid)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(381);
