...
{
  ULONG_PTR FileObjectForSection; // rsi
  int v5; // eax
  signed int v6; // edi
  __int64 v7; // rax
  void *v8; // rbx
  ...
  v12 = 272;
  v5 = ObQueryNameStringMode((char *)FileObjectForSection, (__int64)Src, 0x110u, &v12, 0);
  v6 = v5;
  if ( v5 == -2147483643 || v5 == -1073741820 || v5 == -1073741789 )
  {
    if ( v12 > 0x110 )
    {
      ...
      if ( Pool2 )
      {
        v6 = ObQueryNameStringMode((char *)FileObjectForSection, Pool2, v12, &v12, 0);
        if ( v6 >= 0 )
          goto LABEL_11;
