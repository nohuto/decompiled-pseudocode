/*
 * XREFs of TtmiLogDeviceArrivedTerminalEvent @ 0x14076C2A8
 * Callers:
...
char __fastcall TtmiLogDeviceArrivedTerminalEvent(int a1, int a2, int a3, int a4, const wchar_t *a5)
{
  _UNKNOWN **v5; // rax
  int SessionId; // eax
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&dword_140050D9C,
                     0LL,
                     0LL,
                     8u,
                     &v17);
