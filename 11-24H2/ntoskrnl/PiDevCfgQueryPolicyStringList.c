/*
 * XREFs of PiDevCfgQueryPolicyStringList @ 0x140729008
 * Callers:
...
LABEL_5:
      ...
      v19 = v10;
      Pool2 = (unsigned int *)ExAllocatePool2(0x100uLL, v10, 0x63647050u);
      if ( !Pool2 )
        goto LABEL_10;
      ...
      while ( 2 )
      {
        ...
        v5 = (void *)ExAllocatePool2(0x100uLL, v12, 0x63647050u);
        if ( v5 )
        {
          v13 = v12 >> 1;
          v14 = 0;
          ...
          while ( 1 )
          {
            ...
            if ( v16 == -2147483643 )
            {
              ...
              v10 = ResultLength;
              v19 = ResultLength;
              Pool2 = (unsigned int *)ExAllocatePool2(0x100uLL, ResultLength, 0x63647050u);
              if ( !Pool2 )
              {
