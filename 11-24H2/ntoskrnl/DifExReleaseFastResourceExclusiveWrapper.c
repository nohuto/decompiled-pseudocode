/*
 * XREFs of DifExReleaseFastResourceExclusiveWrapper @ 0x14061ECB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseFastResourceExclusiveWrapper(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  ExReleaseFastResourceExclusive(BugCheckParameter2);
  if ( v6 )
  {
