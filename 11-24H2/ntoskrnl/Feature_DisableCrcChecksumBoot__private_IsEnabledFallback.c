/*
 * XREFs of Feature_DisableCrcChecksumBoot__private_IsEnabledFallback @ 0x140696B94
 * Callers:
...
__int64 __fastcall Feature_DisableCrcChecksumBoot__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
