/*
 * XREFs of TtmiLogInitCurrentSessionStop @ 0x14099E248
 * Callers:
...
void __fastcall TtmiLogInitCurrentSessionStop(int a1)
{
  ...
  if ( (unsigned int)dword_140FD88C8 > 5 && tlgKeywordOn((__int64)&dword_140FD88C8, 1LL) )
  {
    ...
    v9 = &v4;
    v4 = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD88C8, (unsigned __int8 *)byte_1400514B1, 0LL, 0LL, 4u, &v5);
  }
}
