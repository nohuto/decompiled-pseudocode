/*
 * XREFs of TtmiLogInitCurrentSessionStop @ 0x140903C98
 * Callers:
...
void __fastcall TtmiLogInitCurrentSessionStop(int a1)
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v9 = &v4;
    v4 = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)&dword_1400507C4, 0LL, 0LL, 4u, &v5);
  }
}
