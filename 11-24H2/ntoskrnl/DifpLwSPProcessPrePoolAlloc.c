/*
 * XREFs of DifpLwSPProcessPrePoolAlloc @ 0x140BA4264
 * Callers:
 *     DifpExAllocatePoolWithTagPriority_LwSP_Enter @ 0x140BA41C0 (DifpExAllocatePoolWithTagPriority_LwSP_Enter.c)
 * Callees:
