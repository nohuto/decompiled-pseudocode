/*
 * XREFs of NtAlertThreadByThreadIdEx @ 0x1409892F0
 * Callers:
 *     NtAlertThreadByThreadId @ 0x1409892D0 (NtAlertThreadByThreadId.c)
 * Callees:
...
__int64 __fastcall NtAlertThreadByThreadIdEx(__int64 a1, __int64 a2)
{
  ...
  _OWORD v28[2]; // [rsp+20h] [rbp-48h] BYREF
...
LABEL_18:
  ...
  {
    if ( CurrentThread == v3 || !KeAbIsValidUserModeLockAddress(a2) )
      a2 = 0LL;
    KeAlertThreadByThreadIdEx((__int64)v3, a2);
