/*
 * XREFs of MiComputeIdealDpcGang @ 0x1403A8170
 * Callers:
...
__int64 __fastcall MiComputeIdealDpcGang(__int64 a1, unsigned int a2, int a3)
{
  ...
  _OWORD v38[23]; // [rsp+90h] [rbp-70h] BYREF
...
LABEL_35:
  ...
  *(_QWORD *)(a1 + 224) = a1 + 296;
  v8 = (_WORD *)(a1 + 214);
  v30 = *(_QWORD *)(384 * v5 + qword_140E2DAF8 + 376);
  if ( (*(_DWORD *)(v30 + 36) & 1) != 0 )
  {
    *(_BYTE *)(a1 + 212) = 1;
    *v8 = word_140E2DAE8;
    v28 = &Src;
    if ( (unsigned __int16)word_140E2DAE8 <= 4u )
    {
      memmove((void *)(a1 + 232), Src, 16LL * (unsigned __int16)word_140E2DAE8);
      goto LABEL_15;
    }
  }
  else
  {
    *(_BYTE *)(a1 + 212) = 0;
    v30 = *(_QWORD *)(384LL * ClosestNodeWithProcessors + qword_140E2DAF8 + 376);
    v28 = (void **)v30;
...
LABEL_15:
  ...
  v37 = v12;
  v19 = 2LL * v12;
  LODWORD(v38[v19 + 17]) = (unsigned __int16)v16;
  *((_QWORD *)&v38[v19 + 17] + 1) = *(_QWORD *)(a1 + 224);
  v20 = v28;
  HIDWORD(v38[v19 + 16]) = 0;
  LODWORD(v38[v19 + 18]) = 0;
  DWORD2(v38[v19 + 16]) = v15;
  DWORD1(v38[v19 + 18]) = *((_DWORD *)v20 + 2);
  v36 = *(_BYTE *)(a1 + 212);
  LODWORD(BugCheckParameter2) = v7;
  HIDWORD(BugCheckParameter2) = v5;
  MiObtainParkedCoreMasks(v38, 0);
  v21 = 0;
  do
  {
    v31 = 0LL;
    ...
    if ( (int)MiGetNextAffinityWalker((ULONG_PTR)&BugCheckParameter2) < 0 )
      break;
    v22 = 0;
    v23 = KiProcessorBlock[DWORD1(v31)];
