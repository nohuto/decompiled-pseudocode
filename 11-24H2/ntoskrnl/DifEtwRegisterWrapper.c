/*
 * XREFs of DifEtwRegisterWrapper @ 0x140619750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifEtwRegisterWrapper(const GUID *a1, ETWENABLECALLBACK *a2, void *a3, ULONGLONG *a4)
{
  ...
  DWORD2(v20) = EtwRegister(a1, a2, a3, a4);
  if ( v9 )
  {
