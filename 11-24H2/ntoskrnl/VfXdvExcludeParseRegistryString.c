/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140C3E058
 * Callers:
...
LABEL_19:
        ...
        if ( v7 )
        {
          ...
          *((_QWORD *)&v11 + 1) = v1;
          ...
          {
            VfDriverLock();
            v9 = (_QWORD *)qword_140F04298;
            if ( *(__int64 **)qword_140F04298 != &VfXdvExcludedDriversList )
              __fastfail(3u);
            *v8 = &VfXdvExcludedDriversList;
            v8[1] = v9;
            *v9 = v8;
            qword_140F04298 = (__int64)v8;
