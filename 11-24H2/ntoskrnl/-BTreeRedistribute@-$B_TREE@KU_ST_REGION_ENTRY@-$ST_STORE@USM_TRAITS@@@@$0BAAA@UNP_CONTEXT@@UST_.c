/*
 * XREFs of ?BTreeRedistribute@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAPEAUNODE@?$B_TREE_HEADER@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14045E2A0
 * Callers:
        ...
        __int64 a2)
{
  ...
  else
  {
    ...
    if ( v19 == v12 )
    {
      v32 = 2LL * (v20 - 1);
      v21[2 * v32 + 4] = v31;
      *(_QWORD *)&v21[2 * v32 + 6] = *((_QWORD *)v21 + 1);
    }
    else
    {
      v33 = 2LL * v22;
      v21[2 * v33 + 4] = v31;
      *(_QWORD *)&v21[2 * v33 + 6] = *((_QWORD *)v19 + 1);
      v28 += v5;
    }
    if ( v19 == v12 )
    {
