/*
 * XREFs of RtlpLookupDynamicUserFunctionTable @ 0x140281D74
 * Callers:
...
__int64 __fastcall RtlpLookupDynamicUserFunctionTable(unsigned __int64 a1, __int64 a2)
{
  ...
  signed __int64 *p_SwapListEntry; // rbx
  __int64 v7; // r15
    ...
    if ( Blink && LODWORD(Blink->Flink) != 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( RtlKernelScpFunctionTableSize && a1 > 0x7FFFFFFEFFFFLL )
        {
          ...
          {
LABEL_16:
            v25 = *(__int128 *)((char *)&Blink[1] + 24 * v12);
...
LABEL_17:
          ...
          if ( a1 < v14 + v9 && v13 != PsHalImageBase && v13 != PsNtosImageBase )
          {
            *(_QWORD *)&v25 = &RtlKernelScpFunctionTable;
            goto LABEL_17;
          }
        }
        if ( a1 < v14 )
