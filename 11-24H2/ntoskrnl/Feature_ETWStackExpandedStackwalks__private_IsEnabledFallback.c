/*
 * XREFs of Feature_ETWStackExpandedStackwalks__private_IsEnabledFallback @ 0x1404FB4CC
 * Callers:
...
__int64 __fastcall Feature_ETWStackExpandedStackwalks__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
