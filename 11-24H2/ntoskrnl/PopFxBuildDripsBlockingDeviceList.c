/*
 * XREFs of PopFxBuildDripsBlockingDeviceList @ 0x140490504
 * Callers:
...
__int64 __fastcall PopFxBuildDripsBlockingDeviceList(__int64 a1, __int64 **a2)
{
  ...
  *(_QWORD *)&String1.Length = 655368LL;
  ...
  v8 = v6;
  if ( v7 )
    ExfAcquirePushLockExclusiveEx(&PopFxBlockingDeviceListLock, (__int64)v6, (__int64)&PopFxBlockingDeviceListLock);
  if ( v8 )
    *((_BYTE *)v8 + 10) = 1;
  ...
  v10 = v9;
  if ( v7 )
    ExfAcquirePushLockExclusiveEx(&PopFxDeviceListLock, (__int64)v9, (__int64)&PopFxDeviceListLock);
  if ( v10 )
    *((_BYTE *)v10 + 10) = 1;
  a2[1] = (__int64 *)a2;
  *a2 = (__int64 *)a2;
...
LABEL_51:
          ...
          if ( v22 >= v16 )
          {
            if ( (unsigned int)dword_140E076F0 > 5 && tlgKeywordOn((__int64)&dword_140E076F0, 0x400000000000LL) )
            {
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                ...
                (unsigned __int8 *)byte_1400486D5,
                0LL,
                v29,
                5u,
                &v45);
      ...
      if ( v22 != v16 && (unsigned int)dword_140E076F0 > 5 && tlgKeywordOn((__int64)&dword_140E076F0, 0x400000000000LL) )
      {
        v38 = v22;
        v53 = &v38;
        v54 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E076F0,
          (unsigned __int8 *)&dword_140048734,
          0LL,
          0LL,
          5u,
          &v52);
