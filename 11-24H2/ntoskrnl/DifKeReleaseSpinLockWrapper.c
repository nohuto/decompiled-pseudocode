/*
 * XREFs of DifKeReleaseSpinLockWrapper @ 0x14062FDA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeReleaseSpinLockWrapper(PKSPIN_LOCK SpinLock, KIRQL a2)
{
  ...
  PKSPIN_LOCK v19; // [rsp+30h] [rbp-28h]
