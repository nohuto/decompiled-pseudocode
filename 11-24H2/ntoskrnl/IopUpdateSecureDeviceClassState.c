/*
 * XREFs of IopUpdateSecureDeviceClassState @ 0x140A60830
 * Callers:
...
__int64 __fastcall IopUpdateSecureDeviceClassState(PGUID Guid, __int64 a2)
{
  ...
  while ( 1 )
  {
    TargetPath = (WCHAR *)ExAllocatePool2(0x100uLL, BufferLengthIn, 0x63466F49u);
    if ( !TargetPath )
    {
      inited = -1073741670;
      goto LABEL_19;
...
LABEL_8:
  ...
  if ( inited >= 0 )
  {
    inited = IopOpenRegistryKeyEx(&Handle, 0LL, &DestinationString, 0xF003Fu);
    if ( inited >= 0 )
    {
