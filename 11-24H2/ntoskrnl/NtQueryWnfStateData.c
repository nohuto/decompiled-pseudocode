/*
 * XREFs of NtQueryWnfStateData @ 0x1408ABBD0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  int StateData; // [rsp+50h] [rbp-118h]
  ...
  if ( PreviousMode )
  {
    ...
    *(_DWORD *)v22 = *(_DWORD *)v22;
    ...
    if ( v21 )
    {
      v24 = a5;
      v25 = v21 + a5 - 1;
      if ( a5 > v25 || v25 >= 0x7FFFFFFF0000LL )
...
LABEL_42:
    ...
    case 1:
      if ( PreviousMode )
      {
        if ( BugCheckParameter1 < 0x7FFFFFFF0000LL )
      ...
      {
        v30 = *(_DWORD *)BugCheckParameter1;
        LODWORD(Object[1]) = *(_DWORD *)BugCheckParameter1;
      }
...
LABEL_59:
  ...
  if ( StateData >= 0 )
  {
    ...
    v36 = KeAbPreAcquire(*(_QWORD *)v60 + 48LL, 0LL);
...
LABEL_81:
      ...
      if ( v70 )
      {
        v50 = *Count - *(_QWORD *)v70;
        if ( *Count == *(_QWORD *)v70 )
          v50 = Count[1] - *((_QWORD *)v70 + 1);
        if ( !v50 )
          goto LABEL_81;
        v41 = -1073741811;
      }
