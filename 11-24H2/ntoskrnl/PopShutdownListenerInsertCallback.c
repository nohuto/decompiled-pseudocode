/*
 * XREFs of PopShutdownListenerInsertCallback @ 0x1404CFB34
 * Callers:
...
__int64 __fastcall PopShutdownListenerInsertCallback(_QWORD *a1)
{
  ...
  if ( Pool2 )
  {
    ...
    v6 = (_QWORD *)qword_140F084B8;
    if ( *(PVOID **)qword_140F084B8 != &PopShutdownNotificationCallbackList )
      __fastfail(3u);
    *v4 = &PopShutdownNotificationCallbackList;
    v4[1] = v6;
    *v6 = v4;
    qword_140F084B8 = (__int64)v4;
