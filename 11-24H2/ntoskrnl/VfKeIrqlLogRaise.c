/*
 * XREFs of VfKeIrqlLogRaise @ 0x140BA7FE0
 * Callers:
 *     ViIrqlExAcquireFastMutex_Exit @ 0x140B9D590 (ViIrqlExAcquireFastMutex_Exit.c)
 *     ViIrqlExTryToAcquireFastMutex_Exit @ 0x140B9D5B0 (ViIrqlExTryToAcquireFastMutex_Exit.c)
