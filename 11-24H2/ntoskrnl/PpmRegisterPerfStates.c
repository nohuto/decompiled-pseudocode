/*
 * XREFs of PpmRegisterPerfStates @ 0x14074FED4
 * Callers:
 *     PpmPerfRegisterNativePerfStates @ 0x14074FBB0 (PpmPerfRegisterNativePerfStates.c)
...
__int64 __fastcall PpmRegisterPerfStates(__int64 a1, char a2)
{
  ...
  unsigned int v95; // [rsp+2Ch] [rbp-DCh]
  ULONG v96; // [rsp+30h] [rbp-D8h]
  unsigned int v97; // [rsp+34h] [rbp-D4h]
  __int64 v98; // [rsp+38h] [rbp-D0h]
  __int64 v99; // [rsp+40h] [rbp-C8h] BYREF
  unsigned int v100; // [rsp+48h] [rbp-C0h]
  int v101; // [rsp+4Ch] [rbp-BCh]
  __int64 v102; // [rsp+50h] [rbp-B8h]
  char *v103; // [rsp+58h] [rbp-B0h]
  __int64 v104; // [rsp+60h] [rbp-A8h]
  _QWORD v105[3]; // [rsp+68h] [rbp-A0h] BYREF
  __int64 v106; // [rsp+80h] [rbp-88h]
  __int128 v107; // [rsp+88h] [rbp-80h] BYREF
  __int128 v108; // [rsp+98h] [rbp-70h] BYREF
  struct _KAFFINITY_EX v109; // [rsp+A8h] [rbp-60h] BYREF
  __int64 v110; // [rsp+1B8h] [rbp+B0h] BYREF
  _BYTE v111[264]; // [rsp+1C0h] [rbp+B8h] BYREF

  memset_0(v111, 0, 0x100uLL);
  v107 = 0LL;
  ...
  *(_OWORD *)&v105[1] = 0LL;
  v8 = 0LL;
  *(_QWORD *)&v109.Count = 2097153LL;
  v108 = 0LL;
  memset_0(&v109.8, 0, sizeof(v109.8));
  v110 = 2097153LL;
  memset_0(v111, 0, 0x100uLL);
  KeQueryActiveProcessorAffinity2((__int64)&v110);
  v95 = 0;
  v11 = 0LL;
  if ( !a2 )
...
LABEL_28:
  ...
  {
LABEL_55:
    if ( (unsigned int)KeIsEmptyAffinityEx(&v109.Count) )
    {
      v48 = 0;
      if ( (_DWORD)v5 )
      {
...
LABEL_65:
    ...
    {
      KeFirstGroupAffinityEx((__int64)&v107, &v109.Count);
      FirstSetRightGroupAffinity = KeFindFirstSetRightGroupAffinity((__int64)&v107);
    ...
    *((_QWORD *)v8 + 3) = 2097153LL;
    ...
    KiCopyAffinityEx((struct _KAFFINITY_EX *)(v8 + 24), *((_WORD *)v8 + 13), &v109);
      ...
      do
      {
        if ( *v60 != 2 )
        {
          ...
          *(_QWORD *)v61 = v8;
          ...
          {
            PpmInstallFeedbackCounters(v61 - 35248, (__int64)&v105[1], *(_BYTE *)(a1 + 14));
          }
          v59 = v8 + 1216;
        }
        ++v57;
    ...
    *v71 = v8;
    ...
    KiOrAffinityEx(&v109, &PpmPerfStatesRegistered, &PpmPerfStatesRegistered, PpmPerfStatesRegistered.Size);
    ...
    *((_WORD *)v8 + 606) = 257;
    ...
    if ( (unsigned int)KeCheckProcessorAffinityEx(&v109.Count, 0) )
      PpmParkApplyPolicy(v78, v77, v79, v80);
    PpmCheckReInit(v78, v77);
    v8 = 0LL;
    v103 = 0LL;
    v27 = 0;
    LOBYTE(v81) = 1;
    PpmPerfUpdateDomainPolicy(v81);
    v11 = v102;
    goto LABEL_152;
  }
  v32 = 0LL;
...
LABEL_44:
    ...
    *(_BYTE *)(v33 + 121) = v41;
    ...
    v43 = 2LL;
    v44 = v98 * v31;
    v45 = v105[0] + 48LL * (unsigned int)v98 * v31;
    do
    {
  ...
  if ( v35 != -1 && !(unsigned int)KeCheckProcessorAffinityEx(&PpmPerfStatesRegistered.Count, v35) )
  {
    v106 = KeGetPrcb(v38);
    v104 = v106 + 35248;
    v27 = PpmAllocatePerfCheck(v106 + 35248);
    if ( v27 < 0 )
      goto LABEL_62;
    KeAddProcessorAffinityEx(&v109.Count, v96);
    *(_QWORD *)(v33 - 20) = v104;
...
LABEL_152:
  v82 = v94;
  if ( ((unsigned int)PpmPerfDomainCount > 1 || (_BYTE)v94)
    && (unsigned int)KeIsEqualAffinityEx(&PpmPerfStatesRegistered.Count, &PpmCheckRegistered.Count) )
  {
    PpmAcquireLock((struct _KTHREAD **)&PpmPerfPolicyLock, v83, v84);
    PpmPerfSchedulerDirectedPerfStatesSupported = v82;
    LOBYTE(v85) = 1;
    PpmReinitializeHeteroEngine(v85, v86, 0LL);
  }
  if ( v8 )
  {
    if ( v6 )
    {
      ...
      do
      {
        if ( *v87 )
        {
          v89 = (void *)*((_QWORD *)*v87 + 11);
          if ( v89 )
          {
            ExFreePoolWithTag(v89, 0x704D5050u);
            *((_QWORD *)*v87 + 11) = 0LL;
          }
          v90 = (void *)*((_QWORD *)*v87 + 19);
          if ( v90 )
          {
            ExFreePoolWithTag(v90, 0x704D5050u);
            *((_QWORD *)*v87 + 19) = 0LL;
          }
          v91 = (void *)*((_QWORD *)*v87 + 27);
          if ( v91 )
          {
