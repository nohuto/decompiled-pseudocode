/*
 * XREFs of pIoQueryBusDescription @ 0x14099C1E4
 * Callers:
...
__int64 __fastcall pIoQueryBusDescription(unsigned int **a1, UNICODE_STRING *a2, void *a3, _DWORD *a4, char a5)
{
  __int64 result; // rax
  PVOID v8; // rbx
  unsigned int v9; // eax
            ...
            if ( ZwOpenKey(&Handle, 0x20019u, &ObjectAttributes) >= 0 )
            {
              ...
              if ( RegistryValues >= 0 )
              {
                ...
                if ( v29[1] )
                {
                  if ( *((_DWORD *)v29[1] + 3) )
                  {
                    if ( *(_DWORD *)((char *)v29[1] + *((unsigned int *)v29[1] + 2)) == **a1 )
                    {
                      ...
                      *a4 = v17;
                      ...
                      if ( !v18 || *v18 == (_DWORD)v17 )
                      {
                        ...
                        {
                          v19 = guard_dispatch_icall_no_overrides(a1[7], &Destination, **a1, v17);
                        }
                        v14 = v29[1];
                        RegistryValues = v19;
                      }
