/*
 * XREFs of CmpRmAnalysisPhase @ 0x1407E0CE8
 * Callers:
...
__int64 __fastcall CmpRmAnalysisPhase(__int64 a1, CLFS_LSN a2)
{
  ...
  while ( v7 >= 0 )
  {
    ...
    {
      v8 = CmpTransSearchAddTransFromRm(a1, 0, (int)ppvReadBuffer + 16, 1, (__int64)&plsnUser);
      if ( v8 < 0 )
        break;
      v9 = plsnUser;
...
LABEL_24:
      ...
      while ( 1 )
      {
        NextElement = CmListGetNextElement(v2, &plsnUser, 0LL);
