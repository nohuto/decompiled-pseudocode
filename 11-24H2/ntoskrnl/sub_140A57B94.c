/*
 * XREFs of sub_140A57B94 @ 0x140A57B94
 * Callers:
...
__int64 __fastcall sub_140A57B94(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  __int64 i; // r9
  ...
  if ( (_DWORD)v17 )
    v19 = v18;
  v20 = qword_140FD73E8 ? guard_dispatch_icall_no_overrides(v19, (unsigned int)v17, qword_140FD73E8, i) : -1073741637;
  v21 = *(_DWORD *)(a2 + 32);
