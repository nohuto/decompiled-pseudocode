/*
 * XREFs of VslApplyHotPatch @ 0x14058CBC4
 * Callers:
        ...
        __int64 a8)
{
  ...
  *((_QWORD *)&v17 + 1) = a3;
  ...
  v19 = a5;
  v20 = a6;
  result = VslpEnterIumSecureMode(2u, 77LL, 0, (__int64)v15);
  if ( (int)result < 0 )
  {
    _InterlockedIncrement(dword_140F8DDC8);
  }
  else
  {
    _InterlockedIncrement(&dword_140F8DDC4);
    if ( a8 )
    {
      v13 = v18;
      v14 = v19;
