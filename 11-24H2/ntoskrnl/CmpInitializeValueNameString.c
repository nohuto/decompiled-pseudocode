/*
 * XREFs of CmpInitializeValueNameString @ 0x1409F82CC
 * Callers:
...
__int64 __fastcall CmpInitializeValueNameString(ULONG_PTR BugCheckParameter3, __int64 a2, unsigned __int64 a3)
{
  __int16 v3; // r9
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 16) & 1) != 0 )
  {
    ...
    *(_WORD *)a2 = v6;
    ...
    result = CmpCopyCompressedName(a3, 0x7FFFu, BugCheckParameter3 + 20, *(unsigned __int16 *)(BugCheckParameter3 + 2));
    *(_QWORD *)(a2 + 8) = a3;
    *(_WORD *)(a2 + 2) = 0x7FFF;
  }
  else
