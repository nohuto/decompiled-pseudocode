/*
 * XREFs of DifMmAllocateMappingAddressExWrapper @ 0x140630810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmAllocateMappingAddressExWrapper(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(465);
  ...
  *((_QWORD *)&v18 + 1) = MmAllocateMappingAddressEx(a1, a2, a3);
  if ( v8 )
  {
