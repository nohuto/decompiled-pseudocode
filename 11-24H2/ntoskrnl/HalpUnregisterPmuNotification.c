/*
 * XREFs of HalpUnregisterPmuNotification @ 0x140AB2A9C
 * Callers:
...
__int64 __fastcall HalpUnregisterPmuNotification(__int64 a1)
{
  ...
  if ( v9 )
    *((_BYTE *)v9 + 10) = 1;
  if ( !dword_140FC1DA8 || dword_140FC1D90 == 1 )
  {
LABEL_38:
    v5 = -1073741275;
  }
  ...
  {
    for ( i = (struct _EX_RUNDOWN_REF *)qword_140FC1D98; ; i = (struct _EX_RUNDOWN_REF *)i->Count )
    {
      v11 = *(_DWORD *)(a1 + 4);
      if ( i == (struct _EX_RUNDOWN_REF *)&qword_140FC1D98 )
        break;
      v1 = i;
    ...
    v12 = (struct _EX_RUNDOWN_REF *)xmmword_140FC1DF0;
    if ( *(_DWORD *)(xmmword_140FC1DF0 + 32) != v11 )
      goto LABEL_38;
    *(_BYTE *)(xmmword_140FC1DF0 + 56) = 1;
    v1 = v12;
    v2 = 1;
...
LABEL_17:
    if ( (dword_140FC1D90 == 4 || dword_140FC1D90 == 5) && dword_140FC1DE8 == *(_DWORD *)(a1 + 4) )
    {
      ...
      v15 = v14;
      if ( v8 )
        ExfAcquirePushLockExclusiveEx(&HalpPmuArbiter, (__int64)v14, (__int64)&HalpPmuArbiter);
      if ( v15 )
        *((_BYTE *)v15 + 10) = 1;
    }
    if ( !v2 )
    ...
    {
      ExDeleteTimer(qword_140FC1DB0, 1, 0, 0LL);
      qword_140FC1DB0 = 0LL;
      dword_140FC1D90 = 1;
    }
    v5 = 0;
