/*
 * XREFs of PopPotsLogHibernatePerformance @ 0x140A53C3C
 * Callers:
...
char __fastcall PopPotsLogHibernatePerformance(__int64 a1, char a2)
{
  ...
  if ( PotsPowerTransitionsHandleRegistered )
  {
    ...
    if ( (unsigned int)dword_140E08370 > 5 )
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140E08370, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v28 = *(_QWORD *)(v27 + 256);
        v62 = &v45;
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)&word_14004FC86,
                       0LL,
                       0LL,
                       0x23u,
                       &v61);
