        ...
        unsigned __int16 *a6)
{
  ...
  char v63[32]; // [rsp+130h] [rbp+30h] BYREF
...
LABEL_9:
  ...
  if ( (unsigned int)dword_140E09160 > 5 )
  {
    ...
    if ( (_BYTE)v12 )
    {
      ...
      v113 = 2LL;
      v115[1] = 0;
      tlgCreate1Sz_wchar_t((__int64)v116, (const wchar_t *)(v35 + 24));
      tlgCreate1Sz_wchar_t((__int64)v117, (const wchar_t *)(v31 + 280));
      v119 = 4LL;
      v121 = 4LL;
      v123 = 2LL;
      LODWORD(v35) = *a5;
