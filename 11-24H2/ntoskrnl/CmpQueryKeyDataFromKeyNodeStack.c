/*
 * XREFs of CmpQueryKeyDataFromKeyNodeStack @ 0x140462458
 * Callers:
 ...
 *     CmpPopulateKeyCachedInformation @ 0x140A7360C (CmpPopulateKeyCachedInformation.c)
 */
...
LABEL_5:
  ...
  {
    if ( (*(_BYTE *)(v6 + 140) & 1) != 0 )
      CellFlat = HvpGetCellFlat(v6, v15);
    else
