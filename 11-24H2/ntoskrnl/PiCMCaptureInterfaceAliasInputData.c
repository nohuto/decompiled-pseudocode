/*
 * XREFs of PiCMCaptureInterfaceAliasInputData @ 0x1408B33C4
 * Callers:
    ...
    *(_QWORD *)(a4 + 24) = 0LL;
    if ( (unsigned int)Feature_KernelPnP_ObjectNameUpdates__private_IsEnabledDeviceUsageNoInline() )
    {
      ...
      if ( v10 )
      {
        ...
        {
          UserModeCallersCopy = PiControlMakeUserModeCallersCopy((int)a4 + 24, v10, v11, 2, PreviousMode, 1);
          if ( UserModeCallersCopy < 0 )
          {
            *v9 = 0LL;
            *(_DWORD *)(a4 + 32) = 0;
    ...
    else
    {
      if ( v10 )
      {
        ...
        if ( v13 >= 2 )
        {
          UserModeCallersCopy = PiControlMakeUserModeCallersCopy((int)a4 + 24, v10, v13, 2, v17, 1);
          if ( UserModeCallersCopy < 0 )
          {
            *v9 = 0LL;
            *v12 = 0;
