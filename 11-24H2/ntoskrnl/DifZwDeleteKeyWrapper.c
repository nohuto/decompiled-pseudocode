/*
 * XREFs of DifZwDeleteKeyWrapper @ 0x14063D310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteKeyWrapper(HANDLE KeyHandle)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(112);
  ...
  LODWORD(v14) = ZwDeleteKey(KeyHandle);
  if ( v4 )
  {
