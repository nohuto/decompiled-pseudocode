/*
 * XREFs of SshpSetCollectionActive @ 0x1404794E0
 * Callers:
 *     SshpPowerSettingCallback @ 0x140A89F60 (SshpPowerSettingCallback.c)
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x140A979C0 (PdcPoSleepStudyHelperSetPhaseActive.c)
