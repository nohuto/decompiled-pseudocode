/*
 * XREFs of ?StLazyWorkMgrRunExpiredWork@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_LAZY_WORK_MGR@1@_K@Z @ 0x140405C68
 * Callers:
 ...
 *     ?StLazyWorkMgrSetSchedule@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_LAZY_WORK_MGR@1@_K@Z @ 0x140405D70 (-StLazyWorkMgrSetSchedule@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_LAZY_WORK_MGR@1@_K@Z.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StLazyWorkMgrRunExpiredWork(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 224) |= 1u;
  ...
  while ( v2 )
  {
    ...
    LODWORD(v14) = v12;
    v2 &= ~(1 << v12);
    ST_STORE<SM_TRAITS>::StWorkItemProcess(a1 - 6536, (unsigned __int64)&v13 + 1, (unsigned __int64)v7);
  }
  *(_DWORD *)(a1 + 224) &= ~1u;
