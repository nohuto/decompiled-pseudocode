/*
 * XREFs of sub_1408008D0 @ 0x1408008D0
 * Callers:
...
__int64 __fastcall sub_1408008D0(__int64 *a1)
{
  _BYTE *v1; // r14
  ...
  v1 = &unk_140FD7D00;
  v2 = (unsigned __int8 *)&unk_140FD7C82;
  v11 = *a1;
  ...
  {
    if ( *v1 < 0x1Fu )
      v3 ^= guard_dispatch_icall_no_overrides(v4, *(v2 - 2), *(v2 - 1), *v2);
    if ( v1[1] < 0x1Fu )
      v5 ^= guard_dispatch_icall_no_overrides(v4 + 1, v2[2], v2[3], v2[4]);
    v4 += 2LL;
    v1 += 2;
    v2 += 8;
    --v6;
