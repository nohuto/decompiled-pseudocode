/*
 * XREFs of DifRtlDowncaseUnicodeStringWrapper @ 0x140639AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlDowncaseUnicodeStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(163);
  ...
  LODWORD(v23) = RtlDowncaseUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
