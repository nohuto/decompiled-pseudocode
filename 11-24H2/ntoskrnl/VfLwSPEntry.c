/*
 * XREFs of VfLwSPEntry @ 0x140648690
 * Callers:
 *     <none>
 * Callees:
...
__int64 VfLwSPEntry()
{
  ...
  DifpLwSPAvailableSystemPages = DifGetAvailableSystemPages();
  ...
  v2 = DifiPluginControlDenominator;
  ...
  v4 = 413;
  v8 = 419;
  DifpLwSPAllowedSPPages = v1 * (DifpLwSPAvailableSystemPages / (unsigned __int64)v2);
  v12 = 418;
  v3 = "ExAllocatePool";
  v16 = 414;
