/*
 * XREFs of Feature_CvmDmaBouncing__private_IsEnabledFallback @ 0x140548B34
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_CvmDmaBouncing__private_descriptor);
}
