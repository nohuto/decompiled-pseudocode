/*
 * XREFs of BcpGetComponentOffsets @ 0x140699C40
 * Callers:
...
__int64 __fastcall BcpGetComponentOffsets(unsigned int *a1, _DWORD *a2, int *a3, int a4, int a5, char a6)
{
  ...
  *a1 = BcpCursor;
  ...
  v12 = dword_140EEFAE8;
  v13 = 0;
  a1[2] = dword_140EEFAE8;
  v14 = 84 * v10;
  *a1 = *((_DWORD *)&unk_140E0EED0 + 21 * v10 + 4) + *((_DWORD *)&unk_140E0EED0 + 21 * v10 + 8);
  v15 = v12 + *((_DWORD *)&unk_140E0EED0 + 21 * v10 + 11);
  a1[1] = v15;
  v16 = *((_DWORD *)&unk_140E0EED0 + 21 * v10 + 11) + v15;
  a1[2] = v16;
  v22 = *(_QWORD *)a1;
  if ( a6 )
  {
  ...
  v19 = *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 32) + *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 16);
  *a3 = v19;
  a3[1] = v16 + *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 52);
  if ( a5 )
    v7 = a5 + *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 56);
  *a2 = v19 + v7;
  v20 = v16 + *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 60);
  a2[1] = v20;
  a2[2] = *(_DWORD *)((char *)&unk_140E0EED0 + v14 + 44) + v20;
  return (unsigned int)v13;
}
