/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1407304E4
 * Callers:
...
void PnpTraceDeviceRemovalForResetComplete()
{
  ...
  if ( dword_140E06FA8
    && tlgKeywordOn((__int64)&dword_140E06FA8, 0x400000000000LL)
    && v1 > 5
    && tlgKeywordOn((__int64)&dword_140E06FA8, v0) )
  {
    v9 = 0x1000000LL;
    v12 = &v9;
    v13 = 8LL;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)word_140046F92,
      0LL,
      0LL,
      0xEu,
      &v11);
