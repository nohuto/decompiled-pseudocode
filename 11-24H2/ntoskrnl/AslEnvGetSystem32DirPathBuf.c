/*
 * XREFs of AslEnvGetSystem32DirPathBuf @ 0x14080BE2C
 * Callers:
        ...
        __int16 *a5)
{
  ...
  *pszDest = 0;
  ...
  for ( i = 0LL; ; i += 16LL )
  {
    ...
    if ( *(_WORD *)((char *)&unk_140E0A170 + i) == a4 && *(_WORD *)((char *)&unk_140E0A170 + i + 2) == v9 )
      break;
    ++v10;
  }
  v12 = AslPathToSystemPathBuf(pszSrc, 0x40uLL, *((NTSTRSAFE_PCWSTR *)&unk_140E0A170 + 2 * v10 + 1));
  if ( v12 < 0 )
  {
