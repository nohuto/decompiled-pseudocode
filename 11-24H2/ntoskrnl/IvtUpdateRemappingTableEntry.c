/*
 * XREFs of IvtUpdateRemappingTableEntry @ 0x14047FB50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall IvtUpdateRemappingTableEntry(__int64 a1, char a2, unsigned int a3, _DWORD *a4)
{
  ...
  if ( (v8 & 0x10) != 0 )
  {
    ...
    BugCheckParameter3 = ((unsigned __int64)(unsigned int)a4[12] << 16) ^ (((unsigned __int64)(unsigned int)a4[12] << 16) ^ v12) & 0xFFFFFFFFFF00FFFFuLL;
    if ( a2 )
