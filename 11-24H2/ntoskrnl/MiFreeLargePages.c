/*
 * XREFs of MiFreeLargePages @ 0x1403CC4F0
 * Callers:
...
__int64 __fastcall MiFreeLargePages(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4, char a5)
{
  ...
  v49 = *((_QWORD *)qword_140E2FF88 + Blink_high);
  v39 = *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(v12 + 40) >> 43) & 0x3FFLL));
...
LABEL_2:
  ...
  if ( (*(_QWORD *)a2 & 0xFFFFFFFFFFELL) != 0 )
    ...
    v51 = 0LL;
  v47 = *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(a2 + 40) >> 43) & 0x3FFLL));
  ...
  while ( 1 )
  {
    ...
    if ( (a5 & 1) == 0 && v17 != v49 )
      MiReturnCrossPartitionCharges(v17, 2u, 1, v41);
    v20 = v41 + v7;
    if ( v39 != v52 )
      v20 = v19;
    v21 = v38 + v18;
      ...
      && (*(_QWORD *)(a2 + 40) & 0x20000000000LL) == 0 )
    {
      ...
      *(_QWORD *)(a2 + 16) = DemandZeroPte;
      ...
      if ( KiIrqlFlags )
      {
        ...
        KiRaiseIrqlProcessIrqlFlags(v27, v28);
      }
      v32 = 0;
      v33 = 48 * v24;
      do
