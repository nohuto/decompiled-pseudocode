/*
 * XREFs of MmInitializeProcessAddressSpace @ 0x1408F8590
 * Callers:
 ...
 *     MiInitializeProcessPageTableCommitmentBitMaps @ 0x14048A590 (MiInitializeProcessPageTableCommitmentBitMaps.c)
        ...
        char a5)
{
  ...
  *(_DWORD *)(*(_QWORD *)(BugCheckParameter1 + 1040) + 1000LL) = 1;
  ...
  {
    ProcessVads = (_QWORD *)MiAllocateProcessVads(BugCheckParameter1, v30);
    if ( !ProcessVads )
    {
      inserted = -1073741670;
      goto LABEL_16;
