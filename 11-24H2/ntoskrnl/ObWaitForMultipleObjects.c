/*
 * XREFs of ObWaitForMultipleObjects @ 0x14084AF80
 * Callers:
...
LABEL_35:
  ...
  WaitObjectFlagMask = (unsigned int)v12;
  v45 = Object[(unsigned int)v12];
  while ( 1 )
  {
    v11 = (unsigned int)(WaitObjectFlagMask - 1);
    v46 = Object[v11];
    if ( v45 > v46 )
    {
LABEL_79:
      Object[(unsigned int)WaitObjectFlagMask] = v45;
    ...
    if ( v45 == v46 )
      break;
    Object[(unsigned int)WaitObjectFlagMask] = v46;
    WaitObjectFlagMask = (unsigned int)v11;
    if ( !(_DWORD)v11 )
      goto LABEL_79;
  }
  v58 = -1073741776;
