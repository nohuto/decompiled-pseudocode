...
__int64 __fastcall RtlGenerateClass5Guid(__int64 a1, UCHAR *a2, ULONG a3, __int64 a4)
{
  ...
  *(_OWORD *)pbInput = 0LL;
      ...
      if ( Pool2 )
      {
        ...
        if ( Property >= 0 )
        {
          ...
          *(_WORD *)&pbInput[6] = __ROR2__(*(_WORD *)(a1 + 6), 8);
          Property = BCryptHashData(phHash, pbInput, 0x10u, v14);
          if ( Property >= 0 )
          {
            Property = BCryptHashData(phHash, a2, a3, v16);
            if ( Property >= 0 )
            {
              Property = BCryptFinishHash(phHash, v27, 0x14u, v17);
              if ( Property >= 0 )
              {
  ...
  if ( phAlgorithm )
    BCryptCloseAlgorithmProvider(phAlgorithm, v10);
  if ( v4 )
