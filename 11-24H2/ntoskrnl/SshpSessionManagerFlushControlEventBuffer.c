/*
 * XREFs of SshpSessionManagerFlushControlEventBuffer @ 0x140767304
 * Callers:
...
LONG __fastcall SshpSessionManagerFlushControlEventBuffer(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v3 = 0;
  for ( i = 0LL; v3 < (unsigned int)dword_140F05DE8; v3 += v5 + 12 )
  {
    v4 = (char *)&unk_140F05DEC + v3;
    v5 = *(_DWORD *)v4;
    v6 = *(const EVENT_DESCRIPTOR **)(v4 + 4);
    i.Ptr = (ULONGLONG)(v4 + 12);
    *(_QWORD *)&i.Size = v5;
    SSHSupportEtwWrite((__int64)&unk_140F05DEC, v6, a3, 1u, &i);
  }
  LODWORD(dword_140F05DE8) = 0;
  byte_140F05D80 = 0;
  SshpAlpcCloseTraceSession();
  return KeSetEvent(&stru_140F05DD0, 0, 0);
}
