/*
 * XREFs of CcWaitForCurrentLazyWriterActivityOnPartition @ 0x14057B0B4
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x14057AED0 (CcWaitForCurrentLazyWriterActivityHelper.c)
