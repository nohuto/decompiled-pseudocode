/*
 * XREFs of EtwTelemetryCoverageReport @ 0x140457F60
 * Callers:
...
LABEL_36:
    if ( EtwpCoverageCoreTracingEnabled
      && (unsigned int)dword_140E091A8 > 5
      && tlgKeywordOn((__int64)&dword_140E091A8, 1LL) )
    {
      v19 = (const CHAR *)*a1;
      v23 = *(_DWORD *)v6;
      v29 = &v23;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140E091A8,
        (unsigned __int8 *)&unk_140053090,
        0LL,
        0LL,
        9u,
        &v28);
