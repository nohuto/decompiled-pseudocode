/*
 * XREFs of MiFreeContiguousLargePageRun @ 0x1406821E4
 * Callers:
...
unsigned __int64 __fastcall MiFreeContiguousLargePageRun(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  {
    v7 = *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(48 * a2 - 0x21FFFFFFFFD8LL) >> 43) & 0x3FFLL));
    v30 = v7;
    if ( a3 )
    {
      do
      {
        ...
        if ( (_DWORD)v17 )
        {
          ...
          if ( v7 != *((_QWORD *)qword_140E2FF88
                     + HIWORD(KeGetCurrentThread()->ApcState.Process[2].ProcessListEntry.Blink)) )
            MiReturnCrossPartitionCharges(v7, 2u, 1, v19);
        }
        else
        {
          v20 = 0LL;
