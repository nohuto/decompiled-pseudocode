/*
 * XREFs of MiIncrementSubsectionViewCount @ 0x1402624F0
 * Callers:
...
{
  __int64 v2; // r8
  ULONG_PTR SubsectionHoldingCrossPartitionReferences; // rdi
  ...
  if ( v23 == *((ULONG **)qword_140E2FF88 + (*(_WORD *)(v2 + 60) & 0x3FF)) )
    goto LABEL_2;
...
LABEL_22:
    ...
    v6 = *((_QWORD *)qword_140E2FF88 + (*(_WORD *)(*(_QWORD *)SubsectionHoldingCrossPartitionReferences + 60LL) & 0x3FF));
    v7 = (volatile signed __int32 *)(v6 + 1728);
    if ( (BYTE6(PerfGlobalGroupMask) & 0x21) == 0 || PopHibernateInProgress )
    {
      v8 = 0;
      if ( _interlockedbittestandset(v7, 0x1Fu) )
        v8 = ExpWaitForSpinLockExclusiveAndAcquire((int *)(v6 + 1728), 0xFFu, v2);
      v9 = *v7;
      v10 = *(unsigned int *)v7;
    ...
    *v12 = v12;
    v15 = *((_QWORD *)qword_140E2FF88 + (*(_WORD *)(*(_QWORD *)SubsectionHoldingCrossPartitionReferences + 60LL) & 0x3FF));
...
LABEL_20:
    _InterlockedAdd64(&qword_140E2CC18, -(__int64)v19);
    *(_QWORD *)(v15 + 2088) -= v19;
    v20 = (_DWORD *)(v6 + 1728);
