/*
 * XREFs of __asan_storeN @ 0x1405AA1F0
 * Callers:
 *     <none>
 * Callees:
...
signed __int8 __fastcall _asan_storeN(ULONG_PTR BugCheckParameter1, ULONG_PTR BugCheckParameter2)
{
...
LABEL_12:
      ...
      if ( KcsaniValidationEnabled )
        return KcsanValidateAddress(BugCheckParameter1, BugCheckParameter2, 1, 0, retaddr);
    }
  }
  return result;
}
