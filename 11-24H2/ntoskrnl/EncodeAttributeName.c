    ...
    if ( v8 )
    {
      ...
      if ( (_DWORD)v9 )
      {
        do
        {
          ...
          {
            *(_WORD *)(v11 + 2LL * v7) = 37;
            *(_WORD *)(v11 + 2LL * (v7 + 1)) = a0123456789abcd_0[(unsigned __int64)*v6 >> 12];
            *(_WORD *)(v11 + 2LL * (v7 + 2)) = a0123456789abcd_0[*((_BYTE *)v6 + 1) & 0xF];
            *(_WORD *)(v11 + 2LL * (v7 + 3)) = a0123456789abcd_0[(*v6 >> 4) & 0xF];
            *(_WORD *)(v11 + 2LL * (v7 + 4)) = a0123456789abcd_0[*(_BYTE *)v6 & 0xF];
            v7 += 5;
          }
          else
          {
