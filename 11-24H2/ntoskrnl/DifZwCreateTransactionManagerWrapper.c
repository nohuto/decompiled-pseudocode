/*
 * XREFs of DifZwCreateTransactionManagerWrapper @ 0x14063CCA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateTransactionManagerWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        ULONG CommitStrength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(115);
  ...
  if ( APIThunkContextById )
  {
    ...
    v13 = 0;
    *((_QWORD *)&v21 + 1) = a1;
    *((_QWORD *)&v19 + 1) = __PAIR64__(CreateOptions, CommitStrength);
    LODWORD(v21) = a2;
    *((_QWORD *)&v20 + 1) = a3;
    *(_QWORD *)&v20 = a4;
  ...
  LODWORD(v22) = ZwCreateTransactionManager(a1, a2, a3, a4, CreateOptions, CommitStrength);
  if ( v11 )
  {
