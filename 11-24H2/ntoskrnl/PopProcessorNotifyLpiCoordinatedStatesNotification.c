/*
 * XREFs of PopProcessorNotifyLpiCoordinatedStatesNotification @ 0x1405CFD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopProcessorNotifyLpiCoordinatedStatesNotification(__int64 a1, _DWORD *a2)
{
  ...
  return (unsigned __int8)guard_dispatch_icall_no_overrides(v3, 36LL) == 0 ? 0xC00000BB : 0;
}
