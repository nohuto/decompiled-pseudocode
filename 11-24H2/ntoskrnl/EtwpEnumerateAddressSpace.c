/*
 * XREFs of EtwpEnumerateAddressSpace @ 0x140951B80
 * Callers:
...
void __fastcall EtwpEnumerateAddressSpace(PRKPROCESS PROCESS, __int64 a2, _DWORD *a3)
{
  ...
  {
    Pool2 = (unsigned __int16 *)ExAllocatePool2(0x40uLL, 0x2000uLL, 0x66726550u);
    v3 = 1062;
    v48 = 611;
    v43 = 611;
    v58 = 0LL;
...
LABEL_55:
          ...
          *(_QWORD *)&v83 = i;
          *((_QWORD *)&v83 + 1) = v34;
          EtwpLogKernelEvent((__int64)&v83, *(_QWORD *)(v58 + 1360), *(_DWORD *)v58, 1u, v38, v35);
          i += 3;
          LOBYTE(v7) = v40;
          LOWORD(v3) = v46;
        }
        ...
        if ( v59 )
        {
          ...
          if ( v28 )
          {
            ...
            v90.m128i_i64[1] = 2LL;
            EtwpLogKernelEvent((__int64)v87, *(_QWORD *)(v58 + 1360), *(_DWORD *)v58, 3u, v47, 0x501803u);
          }
        }
        else
        {
...
LABEL_39:
        if ( v62 )
          guard_dispatch_icall_no_overrides(v62, v27);
