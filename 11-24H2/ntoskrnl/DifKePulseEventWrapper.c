/*
 * XREFs of DifKePulseEventWrapper @ 0x14062E970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKePulseEventWrapper(PRKEVENT Event, KPRIORITY Increment, BOOLEAN Wait)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(271);
  ...
  DWORD2(v22) = KePulseEvent(Event, Increment, Wait);
  if ( v10 )
  {
