/*
 * XREFs of MiSelectImageBase @ 0x1408F67EC
 * Callers:
...
LABEL_4:
  ...
  if ( !dword_140E2D7B0 || (*(_DWORD *)(v14 + 76) & 0x40) == 0 )
    goto LABEL_10;
  if ( ((unsigned int)dword_140E2D7B0 >> 12) + (unsigned int)v15 < (unsigned int)v15 )
    return 3221225503LL;
  LODWORD(v15) = ((unsigned int)dword_140E2D7B0 >> 12) + v15;
LABEL_10:
  ClearBits = -1LL;
  if ( v7 )
  {
  ...
  if ( !v8 )
  {
    ...
    v39 = 0LL;
    LOBYTE(a3) = v13 != 4;
    if ( dword_140FC4210 && (unsigned int)MiImageCanUseHighOverflowArea(a1, v17, a3) )
    {
LABEL_35:
...
LABEL_34:
    ...
    else
    {
      if ( v13 == 2 )
      {
        ...
        v40 = &qword_140E2D6C0;
        v37 = v29;
        v30 = KeAbPreAcquire((__int64)&qword_140E2D628, 0LL);
        v34 = v30;
        if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140E2D628, 0LL) )
        {
          ExfAcquirePushLockExclusiveEx(&qword_140E2D628, (__int64)v30, (__int64)&qword_140E2D628);
          v30 = v34;
        }
        if ( v30 )
          *((_BYTE *)v30 + 10) = 1;
        RtlCopyBitMapEx((unsigned __int64 *)&unk_140E2D668, &qword_140E2D6B0, 0LL);
        RtlMergeBitMapsEx((unsigned __int64 *)&qword_140E2D6B0, &qword_140E2D6C0);
        v33 = (unsigned __int16)v18;
        ClearBits = RtlFindClearBitsEx((unsigned __int64 *)&qword_140E2D6B0, (unsigned __int16)v18, v37);
        ...
        {
          KiCheckForKernelApcDelivery((__int64)CurrentThread, v31);
        }
        goto LABEL_21;
      }
      if ( v13 == 3 )
...
LABEL_21:
    if ( ClearBits != -1LL )
    {
      v23 = MiObtainRelocationBits(&v39, (unsigned __int16)v18, ClearBits);
      ClearBits = v23;
      if ( v23 != -1 )
      {
        v11 = v41 - ((v23 + v33) << 16);
