/*
 * XREFs of EmonAddProfileSource @ 0x140558450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EmonAddProfileSource(unsigned __int8 *a1, _DWORD *a2)
{
  ...
  *(_DWORD *)(v14 + 36) = 0;
  *(_DWORD *)(v14 + 32) = 2097153;
  memset_0((void *)(v14 + 40), 0, 0x100uLL);
  KiCopyAffinityEx((struct _KAFFINITY_EX *)(v14 + 32), *(_WORD *)(v14 + 34), (struct _KAFFINITY_EX *)(a1 + 16));
  *(_QWORD *)(v14 + 296) = v9;
  ...
  if ( HalpInsertProfileSource(v14, v20, 37, &v24) )
  {
    ...
    if ( a2 )
      *a2 = *(_DWORD *)v14;
    HalpReleaseHighLevelLock((volatile signed __int64 *)&HalpProfileSourceDescriptorListLock, v19);
    return 0LL;
  }
  else
  {
    ...
    {
      KeOrAffinityEx2(
        (struct _KAFFINITY_EX *)(v24 + 4),
        (struct _KAFFINITY_EX *)(v14 + 32),
        (struct _KAFFINITY_EX *)(v24 + 4));
      if ( a2 )
        *a2 = *(_DWORD *)v21;
      v5 = 0;
