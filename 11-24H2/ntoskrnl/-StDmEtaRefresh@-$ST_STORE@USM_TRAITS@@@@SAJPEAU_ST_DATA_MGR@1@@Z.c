/*
 * XREFs of ?StDmEtaRefresh@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z @ 0x1404CD31C
 * Callers:
 ...
 *     StEtaCheckForRefresh @ 0x14060CE40 (StEtaCheckForRefresh.c)
 *     StEtaStartRefresh @ 0x14060D0B0 (StEtaStartRefresh.c)
 */
