/*
 * XREFs of DifZwAlpcSetInformationWrapper @ 0x14063C990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcSetInformationWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v24) = ZwAlpcSetInformation(
                  a1,
                  a2,
                  a3,
                  a4,
