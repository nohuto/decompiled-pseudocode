/*
 * XREFs of DifZwQuerySymbolicLinkObjectWrapper @ 0x140646730
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnedLength)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = LinkHandle;
    *(_QWORD *)&v22 = LinkTarget;
    *((_QWORD *)&v21 + 1) = ReturnedLength;
  ...
  LODWORD(v23) = ZwQuerySymbolicLinkObject(LinkHandle, LinkTarget, ReturnedLength);
  if ( v10 )
  {
