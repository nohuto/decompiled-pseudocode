/*
 * XREFs of CmpConcatenateValueLists @ 0x140908178
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  {
    v12 = HvAllocateCell(BugCheckParameter3, 4 * v11, v9, &v27, &v26, (__int64)&v25);
    v13 = (char *)v26;
    v14 = v12;
    if ( v12 < 0 )
    {
    ...
    else
    {
      ...
      if ( *a2 )
      {
        ...
        if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
          CellFlat = (const void *)HvpGetCellFlat(BugCheckParameter3, v23, &v28);
        else
          CellFlat = (const void *)HvpGetCellPaged(BugCheckParameter3, v23, &v28);
      ...
      if ( *a3 )
      {
        v16 = a3[1];
        if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
          CellPaged = (const void *)HvpGetCellFlat(BugCheckParameter3, v16, &v28);
        else
          CellPaged = (const void *)HvpGetCellPaged(BugCheckParameter3, v16, &v28);
