/*
 * XREFs of DifRtlUpcaseUnicodeStringToOemStringWrapper @ 0x14063AD40
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v23) = RtlUpcaseUnicodeStringToOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
