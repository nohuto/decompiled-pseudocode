/*
 * XREFs of ExpWorkQueueManagerThread @ 0x1408F84F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpNewThreadNecessary @ 0x140421B30 (ExpNewThreadNecessary.c)
 *     KeBugCheckEx @ 0x1404F9250 (KeBugCheckEx.c)
 *     KeSetMaximumCountPriQueue @ 0x1405C6BF8 (KeSetMaximumCountPriQueue.c)
...
void __fastcall ExpWorkQueueManagerThread(_QWORD *a1)
{
  ...
  _BYTE v40[264]; // [rsp+70h] [rbp-98h] BYREF
  ...
  v35 = 1;
  v3 = 0LL;
  Pool2 = (_QWORD *)ExAllocatePool2(0x40uLL, 0x10uLL, 0x6C577845u);
  if ( Pool2 )
  {
    v3 = (struct _WORK_QUEUE_ITEM *)ExAllocatePool2(0x40uLL, 0x20uLL, 0x6C577845u);
    if ( v3 )
    {
      v35 = 0;
    }
...
LABEL_21:
    ...
    KeQueryNodeActiveAffinityEx(**v6, (unsigned __int16 *)&v39, &v36);
    v2 = 0;
    if ( !(unsigned int)KeIsEqualAffinityEx((unsigned __int16 *)&v39, &CurrentThread->UserAffinity->Count) )
      KeSetUserAffinityThread((__int64)CurrentThread, (__int64)&v39);
