/*
 * XREFs of ?StDmRegionEvict@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_SEARCH_RESULTS@1@KKKK@Z @ 0x14060A5C8
 * Callers:
...
LABEL_10:
  ...
  {
    HIDWORD(v23) = v18;
    Keys = ST_STORE<SM_TRAITS>::StDmPageRemove((_DWORD *)a1, (__int64)&v23);
    if ( Keys < 0 )
      return (unsigned int)Keys;
    v14 = *v17;
    v18 = 0;
