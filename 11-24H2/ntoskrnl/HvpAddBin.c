/*
 * XREFs of HvpAddBin @ 0x140968D94
 * Callers:
 ...
 *     HvpFindFreeBin @ 0x14096951C (HvpFindFreeBin.c)
...
LABEL_43:
        ...
        *(_DWORD *)(632LL * a3 + BugCheckParameter2 + 280) = v11;
        ...
        if ( v54 )
          guard_dispatch_icall_no_overrides(v54, 24LL);
        if ( v53 && !v8 )
...
LABEL_28:
        if ( (_DWORD)Size )
        {
          if ( v8 )
          {
            ...
            HIDWORD(Size) = Size;
            v57 = v8;
            Bin = HvpViewMapPromoteRangeToMapping(BugCheckParameter2 + 224, v11, (unsigned int)Size, &v52);
            if ( Bin < 0 )
              goto LABEL_42;
          ...
          {
            v57 = 0;
            Bin = HvpAllocateBin(BugCheckParameter2, Size, v17, 808602947, (__int64)&v52);
            if ( Bin < 0 )
              goto LABEL_42;
            v37 = HvpProtectBinPartial(BugCheckParameter2, (_DWORD)v52, v43, 0, Size, 1);
          }
          v57 = v8;
          Bin = v37;
          if ( v37 < 0 )
          ...
          *v47 = 1852400232;
          v47[2] = Size;
          v48 = guard_dispatch_icall_no_overrides(24LL, 0LL);
          v54 = v48;
          if ( !v48 )
            goto LABEL_41;
          *(_DWORD *)(v48 + 16) = Size;
        ...
        if ( v8 )
        {
          if ( CmpClaimGlobalQuota(v5, v15) )
          {
            HIDWORD(Size) += v5;
            v57 = v8;
            Bin = HvpViewMapPromoteRangeToMapping(BugCheckParameter2 + 224, v12, v5, &v53);
            if ( Bin >= 0 )
            {
              v57 = v8;
...
LABEL_41:
        ...
        {
          LOBYTE(v15) = a3 == 0;
          v27 = (_DWORD *)guard_dispatch_icall_no_overrides(v5, v15);
          if ( !v27 )
            goto LABEL_41;
          v20 = v27;
          v53 = v27;
