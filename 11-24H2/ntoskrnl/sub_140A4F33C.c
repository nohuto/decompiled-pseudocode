/*
 * XREFs of sub_140A4F33C @ 0x140A4F33C
 * Callers:
...
__int64 __fastcall sub_140A4F33C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  unsigned int i; // r9d
  ...
  if ( (_DWORD)v17 )
    v19 = v18;
  v20 = qword_140FD83F8 ? guard_dispatch_icall_no_overrides(v19, (unsigned int)v17) : -1073741637;
  v21 = *(_DWORD *)(a2 + 32);
