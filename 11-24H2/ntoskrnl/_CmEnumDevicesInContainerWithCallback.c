/*
 * XREFs of _CmEnumDevicesInContainerWithCallback @ 0x140819C18
 * Callers:
...
__int64 __fastcall CmEnumDevicesInContainerWithCallback(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( v9 )
  {
    v10 = guard_dispatch_icall_no_overrides(a1, a2, 5LL, 15LL);
    if ( v10 == -1073741822 )
    {
      v9 = 0LL;
    }
  ...
  if ( !v9 )
    return v12;
  v17[0] = v11;
  v13 = guard_dispatch_icall_no_overrides(a1, a2, 5LL, 15LL);
  v14 = v13;
  if ( v13 == -1073741822 )
    return v12;
  if ( v13 == -1073741536 )
