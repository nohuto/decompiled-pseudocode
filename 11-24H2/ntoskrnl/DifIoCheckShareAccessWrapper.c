/*
 * XREFs of DifIoCheckShareAccessWrapper @ 0x1406265D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoCheckShareAccess @ 0x1409A2A40 (IoCheckShareAccess.c)
 */

__int64 __fastcall DifIoCheckShareAccessWrapper(
        ACCESS_MASK a1,
        ULONG a2,
        struct _FILE_OBJECT *a3,
        struct _SHARE_ACCESS *a4,
        BOOLEAN Update)
{
  ...
  DWORD2(v25) = IoCheckShareAccess(a1, a2, a3, a4, Update);
  if ( v12 )
  {
