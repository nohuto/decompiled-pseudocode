/*
 * XREFs of DifRtlAnsiStringToUnicodeStringWrapper @ 0x1406377B0
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlAnsiStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
