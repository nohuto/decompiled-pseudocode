/*
 * XREFs of DifRtlAnsiStringToUnicodeStringWrapper @ 0x1406391F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlAnsiStringToUnicodeStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(169);
  ...
  LODWORD(v23) = RtlAnsiStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
