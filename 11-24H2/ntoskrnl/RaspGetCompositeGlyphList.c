/*
 * XREFs of RaspGetCompositeGlyphList @ 0x14069BF4C
 * Callers:
        ...
        __int64 *a8)
{
  ...
  *a3 = 0;
  ...
  FioFwReadUshortAtOffset(v11, v9 + a2, &v29);
  if ( (v29 & 0x8000u) == 0 )
    return 3221225485LL;
  v12 = a7;
  v13 = v10 + 10;
...
LABEL_18:
    ...
    if ( GlyphData < 0 )
      break;
    GlyphData = RaspLoadGlyphData(a1, v31, (unsigned int)v28, (unsigned int)&v32, (__int64)a8);
    if ( GlyphData < 0 )
      break;
    v22 = v34;
    *(_QWORD *)(v16 + 16) = v32;
