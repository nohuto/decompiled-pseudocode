/*
 * XREFs of DifRtlCreateSystemVolumeInformationFolderWrapper @ 0x140639650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlCreateSystemVolumeInformationFolderWrapper(PCUNICODE_STRING VolumeRootPath)
{
  ...
  LODWORD(v18) = RtlCreateSystemVolumeInformationFolder(VolumeRootPath);
  if ( v6 )
  {
