/*
 * XREFs of DifRtlCreateSystemVolumeInformationFolderWrapper @ 0x140637C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlCreateSystemVolumeInformationFolderWrapper(PCUNICODE_STRING VolumeRootPath)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(166);
  ...
  LODWORD(v14) = RtlCreateSystemVolumeInformationFolder(VolumeRootPath);
  if ( v4 )
  {
