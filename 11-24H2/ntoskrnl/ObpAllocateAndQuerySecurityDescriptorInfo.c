/*
 * XREFs of ObpAllocateAndQuerySecurityDescriptorInfo @ 0x140879E8C
 * Callers:
...
__int64 ObpAllocateAndQuerySecurityDescriptorInfo(__int64 BugCheckParameter2, ULONG a2, ...)
{
  __int16 **v2; // r12
  __int64 v4; // r15
  __int16 *v5; // rbx
  __int64 (__fastcall *v6)(__int64, int, ULONG *, __int16 *, PULONG, int, int, __int64, char); // r12
  ...
  v5 = (__int16 *)ExAllocatePool2(0x100uLL);
  if ( !v5 )
    return 3221225626LL;
  v6 = *(__int64 (__fastcall **)(__int64, int, ULONG *, __int16 *, PULONG, int, int, __int64, char))(v4 + 152);
  v12 = *(_DWORD *)(v4 + 100);
  ...
  if ( v6 == IopGetSetSecurityObject )
    ...
    SetSecurityObject = guard_dispatch_icall_no_overrides(BugCheckParameter2, 1LL, &SecurityInformation, v5);
  ...
  if ( !v11 )
    return 3221225626LL;
  v8 = guard_dispatch_icall_no_overrides(BugCheckParameter2, 1LL, &SecurityInformation, v11);
LABEL_6:
  v2 = v17;
LABEL_7:
  if ( v8 < 0 )
