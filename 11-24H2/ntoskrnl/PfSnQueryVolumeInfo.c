/*
 * XREFs of PfSnQueryVolumeInfo @ 0x14096E298
 * Callers:
...
__int64 __fastcall PfSnQueryVolumeInfo(__int64 a1, const WCHAR *a2, _OWORD *a3, _QWORD *a4, _DWORD *a5)
{
  ...
  {
    v12 = *(_OWORD *)FileHandle.m256i_i8;
    v13 = *(_OWORD *)&FileHandle.m256i_u64[2];
  ...
  if ( (v6 & 0x400000000LL) != 0 )
    PfpOpenHandleClose((__int64)&FileHandle, a1, v10, v11);
