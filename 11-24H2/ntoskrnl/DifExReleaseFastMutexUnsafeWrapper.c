/*
 * XREFs of DifExReleaseFastMutexUnsafeWrapper @ 0x14061E9F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseFastMutexUnsafeWrapper(PFAST_MUTEX FastMutex)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(389);
