/*
 * XREFs of DifPoFxCompleteIdleStateWrapper @ 0x140635810
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxCompleteIdleStateWrapper(__int64 a1, unsigned int a2)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(190);
