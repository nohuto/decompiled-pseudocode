/*
 * XREFs of TtmiLogSessionPowerRequestDeleted @ 0x14076E27C
 * Callers:
...
void TtmiLogSessionPowerRequestDeleted()
{
  ...
  if ( (unsigned int)dword_140FD78B8 > 5 && tlgKeywordOn((__int64)&dword_140FD78B8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78B8, (unsigned __int8 *)&unk_140050A90, 0LL, 0LL, 5u, &v7);
  }
}
