/*
 * XREFs of DifZwFreeVirtualMemoryWrapper @ 0x14063EAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFreeVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(97);
  ...
  DWORD2(v20) = ZwFreeVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
