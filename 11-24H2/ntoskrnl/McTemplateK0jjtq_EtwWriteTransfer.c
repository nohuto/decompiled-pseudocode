/*
 * XREFs of McTemplateK0jjtq_EtwWriteTransfer @ 0x14057EE24
 * Callers:
        ...
        char a7)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, (const EVENT_DESCRIPTOR *)TieredStorage_NewVolume, a3, 5u, &v8);
}
