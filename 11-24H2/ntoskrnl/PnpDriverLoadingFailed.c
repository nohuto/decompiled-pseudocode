/*
 * XREFs of PnpDriverLoadingFailed @ 0x140A9C798
 * Callers:
...
NTSTATUS __fastcall PnpDriverLoadingFailed(void *a1, UNICODE_STRING *a2)
{
  int v2; // r15d
  HANDLE v4; // rbx
  NTSTATUS result; // eax
  ...
  *(_OWORD *)v31 = 0LL;
  ...
  {
    result = PipOpenServiceEnumKeys(a2, 0x20019u, &Handle, &KeyHandle, 0);
    v4 = Handle;
    v2 = 1;
    v26 = 1;
  }
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)&ValueName.Length = 2097182;
    ...
    if ( v6 )
    {
      ...
      do
      {
        if ( (int)PipServiceInstanceToDeviceInstance((__int64)v4, (__int64)a2, v8, (UNICODE_STRING *)v31) >= 0 )
        {
