/*
 * XREFs of MiAllocateChildVads @ 0x1409C2580
 * Callers:
 ...
 *     MiVadShouldBeForked @ 0x14048A630 (MiVadShouldBeForked.c)
    ...
    *((_DWORD *)v16 + 9) = 0;
    ...
    if ( (*(_DWORD *)(v9 + 48) & 0x600000) == 0x600000 )
    {
      ...
      inserted = MiCreateWriteWatchView(
                   BugCheckParameter1,
                   v16,
                   (*((unsigned int *)v16 + 7) | ((unsigned __int64)*((unsigned __int8 *)v16 + 33) << 32))
                 - (*((unsigned int *)v16 + 6) | ((unsigned __int64)*((unsigned __int8 *)v16 + 32) << 32))
                 + 1);
      if ( inserted < 0 )
        goto LABEL_60;
    }
