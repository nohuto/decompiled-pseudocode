...
void PpmEventStaticPolicyRundown()
{
  ...
  {
    PpmEventStaticPolicyRundownEx();
  }
  else if ( PpmEtwRegistered && EtwEventEnabled(PpmEtwHandle, &PPM_ETW_STATIC_POLICY_RUNDOWN_V4) )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v31 = 4LL;
    v33 = 4LL;
    EtwWrite(PpmEtwHandle, &PPM_ETW_STATIC_POLICY_RUNDOWN_V4, 0LL, 0xFu, &UserData);
  }
}
