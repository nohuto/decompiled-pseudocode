/*
 * XREFs of I_MinCryptVerifyRFC3161TimeStamp @ 0x140826598
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  if ( v12 != 11 || RtlCompareMemory(qword_140B3BA20, Source2, 0xBuLL) != 11 )
    goto LABEL_15;
  HIDWORD(Length) = 14;
  Values = MinAsn1ExtractValues(v15, v14, (unsigned int)&Length + 4, (unsigned int)&qword_14000CEB0, 6, (__int64)v16);
  if ( Values > 0 )
    Values = v17;
  if ( Values < 0 )
  {
