/*
 * XREFs of MiGetSingleHugeRangeToZero @ 0x1404F0954
 * Callers:
...
unsigned __int64 __fastcall MiGetSingleHugeRangeToZero(unsigned __int64 a1, __int64 a2, volatile signed __int32 *a3)
{
  ...
  v9 = 0;
  v26 = dword_140E2DBC0[0];
  v10 = _InterlockedExchangeAdd(a3, 1u);
  v21 = (*((_QWORD *)&v22 + 1) >> 16) & 3LL;
  v11 = v10 % dword_140E2DBC0[v21];
  ColorHeadHugeRangeBase = MiGetColorHeadHugeRangeBase(a2, DWORD2(v22) ^ (v10 % dword_140E2DBC0[v21]), 1);
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( (v15 & 0x3FFFFF) == 0 )
        goto LABEL_8;
      if ( !_bittest64((const signed __int64 *)qword_140E2FFB8, v16) )
        goto LABEL_9;
      v17 = (__int64 *)(qword_140E2FFC0 + 8 * v16);
      if ( !v13
        && ((*(int *)(qword_140E2FFC8 + 4 * ((((__int64)(8 * v16) >> 3) & 0x3FFFFFuLL) >> 5)) >> (((__int64)(8 * v16) >> 3) & 0x1F)) & 1) != 0 )
      {
        v9 = 1;
LABEL_8:
        v11 = _InterlockedExchangeAdd(a3, 1u) % (unsigned int)dword_140E2DBC0[v21];
        ++v14;
        goto LABEL_9;
      }
      ...
      if ( (((unsigned __int64)*v17 >> 4) & 0x7FF) == v24 && (v18 & 7) == 2 )
      {
        ...
        {
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140E2FFC8
                                      + 4 * (((((__int64)v17 - qword_140E2FFC0) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << ((((__int64)v17 - qword_140E2FFC0) >> 3) & 0x1F)));
          return v6;
        }
        _InterlockedAnd(
          (volatile signed __int32 *)(qword_140E2FFC8
      ...
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140E2FFC8 + 4 * (((((__int64)v17 - qword_140E2FFC0) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v17 - qword_140E2FFC0) >> 3) & 0x1F)));
LABEL_9:
