/*
 * XREFs of _winput_s @ 0x140504A68
 * Callers:
...
__int64 __fastcall winput_s(FILE *File, wint_t *a2, _BYTE **a3)
{
  unsigned int v3; // ebx
...
LABEL_95:
      ...
      if ( v30 == 123 )
      {
        v54 = ReadStringDelimited_0(v53, &v77, (wint_t *)&v60, &v62, (__int64)v75, v14, File, v23, &v66);
        v4 = v77;
      }
      else
      {
        v54 = ReadString_0(v53, 0LL, (wint_t *)&v60, &v62, (__int64)v75, v14, File, v23, &v66);
      }
      LOWORD(v5) = v60;
      if ( v54 )
        goto LABEL_207;
