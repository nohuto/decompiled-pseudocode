/*
 * XREFs of IopMarkDeviceToBeReset @ 0x14071F0B0
 * Callers:
...
__int64 __fastcall IopMarkDeviceToBeReset(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( !BugCheckParameter2 )
    goto LABEL_16;
  v2 = *(_QWORD *)(*(_QWORD *)(BugCheckParameter2 + 312) + 40LL);
  if ( !v2 || (*(_DWORD *)(v2 + 396) & 0x20000) != 0 )
  {
    ...
    if ( v4 )
    {
      ...
      v5 = (_WORD *)(*(_QWORD *)(BugCheckParameter2 + 8) + 56LL);
      if ( *v5 )
      {
    ...
    if ( v6 )
    {
      ...
      v8 = (_WORD *)(*(_QWORD *)(*(_QWORD *)(BugCheckParameter2 + 312) + 40LL) + 56LL);
      if ( *v8 )
      {
      ...
      v9 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(BugCheckParameter2 + 312) + 40LL) + 16LL);
      if ( v9 && *(_WORD *)(v9 + 56) )
      {
...
LABEL_16:
  ...
  *(_DWORD *)(BugCheckParameter2 + 48) |= 0x4000000u;
  return IopQueryDeviceState(BugCheckParameter2, 0LL);
}
