/*
 * XREFs of RtlpHpSegSubAllocate @ 0x1402C0804
 * Callers:
 *     RtlpHpSegVsAllocate @ 0x1402C07E0 (RtlpHpSegVsAllocate.c)
 *     RtlpHpSegLfhAllocate @ 0x1402C0AF0 (RtlpHpSegLfhAllocate.c)
 * Callees:
 *     RtlpHpSegAlloc @ 0x1402C162C (RtlpHpSegAlloc.c)
 *     RtlpHpSegPageRangeComputeLargePageCost @ 0x1402C2DF0 (RtlpHpSegPageRangeComputeLargePageCost.c)
 */
