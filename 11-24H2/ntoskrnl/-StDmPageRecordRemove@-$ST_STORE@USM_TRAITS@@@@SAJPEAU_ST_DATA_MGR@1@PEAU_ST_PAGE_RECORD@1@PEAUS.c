/*
 * XREFs of ?StDmPageRecordRemove@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_RECORD@1@PEAUSEARCH_RESULT@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@@Z @ 0x140384710
 * Callers:
...
LABEL_39:
    ...
    *(_DWORD *)(v3 + 8LL * v13 + 2212) += v49;
    ...
    if ( (*v47 & 0x1FFF) == 0 && (_DWORD)v44 != *(_DWORD *)(v3 + 16 * (v13 + 102LL)) )
      ST_STORE<SM_TRAITS>::StReleaseRegion(v3, (unsigned int)v44);
