/*
 * XREFs of HvlpGetLogicalProcessorProperty @ 0x140584434
 * Callers:
 *     HvlLpGetLogicalProcessorHwId @ 0x140587500 (HvlLpGetLogicalProcessorHwId.c)
 *     HvlLpGetMachineCheckContext @ 0x140587550 (HvlLpGetMachineCheckContext.c)
 * Callees:
