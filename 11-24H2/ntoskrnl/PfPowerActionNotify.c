/*
 * XREFs of PfPowerActionNotify @ 0x140B6B9F8
 * Callers:
...
LABEL_8:
      ...
      PfpPartitionIterate(PfpPowerActionStartScenarioTracingCallback, 4, (__int64)&qword_140E66E80);
      if ( dword_140E66EB0 == 5 )
    ...
    else
    {
      ...
      if ( (unsigned int)result <= 3 )
      {
        ...
        if ( v9 )
        {
          ...
          HIDWORD(v10) = PfpScenCtxPrefetchWait((ULONG_PTR)&qword_140E66E80, v7, v8);
        }
  ...
  else
  {
    ...
    if ( (unsigned int)result <= 2 || a3 == 5 )
      return PfpScenCtxScenarioSet((ULONG_PTR)&qword_140E66E80);
  }
  return result;
}
