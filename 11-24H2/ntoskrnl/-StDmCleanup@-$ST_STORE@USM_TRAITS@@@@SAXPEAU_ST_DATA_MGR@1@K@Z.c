/*
 * XREFs of ?StDmCleanup@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@K@Z @ 0x14037EFFC
 * Callers:
  ...
  if ( *(_QWORD *)(a1 + 1416) )
  {
    ...
    if ( *(_DWORD *)(a1 + 788) )
    {
      do
      {
        ...
        if ( (v16 & 0x1FFF) != 0 )
          ST_STORE<SM_TRAITS>::StDmpUpdateRegionState(a1, (unsigned int)v15, -(v16 & 0x1FFF), 0LL);
