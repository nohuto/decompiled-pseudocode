/*
 * XREFs of DifExRegisterCallbackWrapper @ 0x14061FD00
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID CallbackContext)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = CallbackObject;
    *(_QWORD *)&v22 = CallbackFunction;
    *((_QWORD *)&v21 + 1) = CallbackContext;
  ...
  v23 = ExRegisterCallback(CallbackObject, CallbackFunction, CallbackContext);
  if ( v10 )
  {
