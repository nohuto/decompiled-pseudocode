/*
 * XREFs of DifZwFlushBuffersFileWrapper @ 0x14063FEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFlushBuffersFileWrapper(HANDLE FileHandle, PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(102);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *(_QWORD *)&v20 = FileHandle;
    *((_QWORD *)&v19 + 1) = IoStatusBlock;
  ...
  DWORD2(v20) = ZwFlushBuffersFile(FileHandle, IoStatusBlock);
  if ( v8 )
  {
