/*
 * XREFs of PopIdleWakeNotifyModernStandbyExitWorker @ 0x140A89DA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PopIdleWakeNotifyModernStandbyExitWorker(LARGE_INTEGER *P)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v14[0] = 0x1000000LL;
    v28 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_14004DAA5, 0LL, 0LL, 8u, v16);
  }
  v5 = P + 18;
  v6 = 32LL;
  do
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    if ( v3 )
    {
      ...
      v24 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_14004DB23, 0LL, 0LL, 6u, v16);
    }
  }
