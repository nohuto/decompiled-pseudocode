/*
 * XREFs of PopIdleWakeNotifyModernStandbyExitWorker @ 0x140A8D7D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PopIdleWakeNotifyModernStandbyExitWorker(char *P)
{
  ...
  if ( (unsigned int)dword_140E076F0 > 5 && tlgKeywordOn((__int64)&dword_140E076F0, 0x400000000000LL) )
  {
    ...
    v14[0] = 0x1000000LL;
    v28 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E076F0, (unsigned __int8 *)word_14004D482, 0LL, 0LL, 8u, v16);
  }
  v5 = P + 144;
  v6 = 32LL;
  do
  ...
  {
    if ( (qword_140E07700 & 0x200000000000LL) == 0 || (qword_140E07708 & 0x200000000000LL) != qword_140E07708 )
      v3 = 0;
    if ( v3 )
    {
      v14[0] = *((_QWORD *)P + 4758);
      ...
      v11 = 0x1000000LL;
      v24 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E076F0, (unsigned __int8 *)byte_14004D413, 0LL, 0LL, 6u, v16);
    }
  }
