/*
 * XREFs of InbvReleaseResources @ 0x14058F4EC
 * Callers:
...
__int64 __fastcall InbvReleaseResources(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  ...
  if ( qword_140E65D40 )
  {
    result = *(_QWORD *)(qword_140E65D40 + 168);
    if ( result )
