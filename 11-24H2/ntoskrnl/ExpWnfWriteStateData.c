/*
 * XREFs of ExpWnfWriteStateData @ 0x1408AD580
 * Callers:
...
__int64 __fastcall ExpWnfWriteStateData(__int64 a1, void *a2, unsigned int a3, int a4, int a5)
{
  ...
  *(_QWORD *)&DestinationString.Length = 2228224LL;
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 80), 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 80), (__int64)v14, a1 + 80);
  if ( v15 )
    *((_BYTE *)v15 + 10) = 1;
  if ( a5 )
  {
  ...
  if ( !v16 && (*(_QWORD *)(a1 + 104) || (_DWORD)v6) || (v17 = v16) != 0LL && v16[1] < (unsigned int)v6 )
  {
    ...
    *(_DWORD *)(Pool2 + 4) = v6;
    ...
    v28 = v27;
    if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 80), 0LL) )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 80), (__int64)v27, a1 + 80);
    if ( v28 )
      *((_BYTE *)v28 + 10) = 1;
    v17 = 0LL;
    if ( *(_QWORD *)(a1 + 88) != 1LL )
