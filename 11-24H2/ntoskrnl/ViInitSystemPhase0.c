/*
 * XREFs of ViInitSystemPhase0 @ 0x140C3B6E4
 * Callers:
 ...
 *     ViDisableVerification @ 0x140B83B0C (ViDisableVerification.c)
 *     VfSetVerifierRunningMode @ 0x140B9B1F8 (VfSetVerifierRunningMode.c)
