/*
 * XREFs of DifExAcquireResourceExclusiveLiteWrapper @ 0x14061A190
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireResourceExclusiveLiteWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(423);
  ...
  BYTE8(v16) = ExAcquireResourceExclusiveLite(Resource, a2);
  if ( v6 )
  {
