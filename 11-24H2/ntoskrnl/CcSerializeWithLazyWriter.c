/*
 * XREFs of CcSerializeWithLazyWriter @ 0x1404AADF4
 * Callers:
...
char __fastcall CcSerializeWithLazyWriter(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a2 + 152) & 0x20) != 0 )
  {
    ...
    if ( v5 )
    {
      v7 = (struct _SLIST_ENTRY *)(v5 & 0xFFFFFFFFFFFFFFFEuLL);
      Next = v7->Next;
      if ( *(&v7->Next->Next + 1) != v7 || (v9 = (struct _SLIST_ENTRY **)*((_QWORD *)&v7->Next + 1), *v9 != v7) )
        __fastfail(3u);
      *v9 = Next;
