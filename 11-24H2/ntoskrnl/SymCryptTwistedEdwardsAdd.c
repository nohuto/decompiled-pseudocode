/*
 * XREFs of SymCryptTwistedEdwardsAdd @ 0x1405352C0
 * Callers:
 *     SymCryptTwistedEdwardsAddDiffNonZero @ 0x1405356B0 (SymCryptTwistedEdwardsAddDiffNonZero.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  _QWORD v23[7]; // [rsp+80h] [rbp-98h] BYREF
