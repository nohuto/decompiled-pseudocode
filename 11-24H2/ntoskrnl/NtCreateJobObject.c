/*
 * XREFs of NtCreateJobObject @ 0x1408EAB60
 * Callers:
 *     <none>
 * Callees:
  ...
  *a1 = 0LL;
  ...
  else
  {
    ...
    *(_QWORD *)&v12[73].Header.Lock = 1LL;
    ...
    v13 = v12 + 1;
    v14 = (struct _LIST_ENTRY *)qword_140FD9060;
    if ( *(__int64 **)qword_140FD9060 != &PspJobList )
      __fastfail(3u);
    *(_QWORD *)&v13->Header.Lock = &PspJobList;
    v12[1].Header.WaitListHead.Flink = v14;
    v14->Flink = (struct _LIST_ENTRY *)v13;
    qword_140FD9060 = (__int64)&v12[1];
    ...
    PspIoRateEntryInitialize((__int64)&v12[68]);
    ...
    *(_QWORD *)&v12[71].Header.Lock = 0LL;
    ...
    if ( inserted >= 0 )
    {
      ...
      inserted = ObInsertObjectEx((struct _FILE_OBJECT *)v12, 0LL, a2, 0, 0, 0LL, (__int64)&v21);
      if ( inserted >= 0 )
      {
        *a1 = v21;
        goto LABEL_21;
