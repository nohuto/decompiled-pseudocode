/*
 * XREFs of DifRtlUnicodeStringToCountedOemStringWrapper @ 0x14063A740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlUnicodeStringToCountedOemStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(155);
  ...
  if ( APIThunkContextById )
  {
    ...
    *(_QWORD *)&v22 = SourceString;
    BYTE8(v21) = AllocateDestinationString;
  ...
  LODWORD(v23) = RtlUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v10 )
  {
