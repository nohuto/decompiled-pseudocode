/*
 * XREFs of DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper @ 0x14062DAC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper(volatile signed __int64 **a1)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(262);
