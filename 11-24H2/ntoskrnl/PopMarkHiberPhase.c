/*
 * XREFs of PopMarkHiberPhase @ 0x140B5D9D8
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0AD90, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0AD58, (unsigned int)dword_140F0AD60, 0);
  v3 = (char *)(Address + 20);
