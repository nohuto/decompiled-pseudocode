/*
 * XREFs of SepReadAndPopulateCapes @ 0x140795748
 * Callers:
...
LABEL_7:
    ...
    v16 = 56 * v13;
    v42 = a2 + 18;
    Pool2 = (ULONG *)ExAllocatePool2(0x100uLL, (unsigned int)(a2 + 18), 0x70536553u);
    if ( Pool2 )
    {
      v14 = v45;
      for ( i = 0; ; i = v44 + 1 )
      {
        ...
        if ( v18 < 0 )
        {
          ...
          v5 = (_DWORD *)ExAllocatePool2(0x100uLL, Length, 0x70536553u);
          if ( !v5 )
          {
            v11 = -1073741670;
            goto LABEL_60;
        ...
        v11 = ZwQueryValueKey(KeyHandlea, &CapeName, KeyValuePartialInformation, Pool2, v19, &Length);
        if ( v11 < 0 )
          goto LABEL_59;
      ...
      v24 = v16;
      v25 = (char *)ExAllocatePool2(0x100uLL, v16, 0x70536553u);
      v4 = v25;
      if ( v25 )
      {
        memset_0(v25, 0, v16);
        ...
        for ( j = 0; ; j = v44 + 1 )
        {
          ...
          *(_DWORD *)&v4[v28 + 48] = Pool2[3];
          v11 = ZwQueryValueKey(KeyHandlea, &CapeName, KeyValuePartialInformation, Pool2, v42, &Length);
          if ( v11 < 0 )
            goto LABEL_59;
