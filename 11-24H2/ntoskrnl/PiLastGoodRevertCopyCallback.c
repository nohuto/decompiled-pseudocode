/*
 * XREFs of PiLastGoodRevertCopyCallback @ 0x140C256D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiLastGoodRevertCopyCallback(unsigned __int16 *a1, __int64 a2, __int64 a3, _WORD *a4)
{
  ...
  v6 = *a4 + 2;
  v13 = 0LL;
  Pool2 = (_QWORD *)ExAllocatePool2(0x100uLL, v5, 0x674C7050uLL);
  if ( !Pool2 )
    return 3221225626LL;
  v9 = *((_QWORD *)a1 + 1);
  *(_OWORD *)Pool2 = *(_OWORD *)v9;
  Pool2[2] = *(_QWORD *)(v9 + 16);
  memmove(Pool2 + 3, (const void *)(*((_QWORD *)a1 + 1) + 2 * ((unsigned __int64)v6 >> 1)), *a1 - (unsigned __int64)v6);
  v10 = *a1 - v6;
  *((_QWORD *)&v13 + 1) = Pool2;
  LOBYTE(v11) = 1;
  LOWORD(v13) = v10 + 24;
