/*
 * XREFs of PsChangeQuantumTable @ 0x140A32230
 * Callers:
 ...
 *     PspComputeQuantum @ 0x140A32444 (PspComputeQuantum.c)
 */
...
LABEL_11:
  ...
  result = *((_BYTE *)v2 + 2);
  PspUseJobSchedulingClasses = v2 == (int *)byte_140B3B08B;
  byte_140FD8B56 = result;
  if ( a1 )
  {
