/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x140781C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlQueryAllFeatureConfigurations(int a1, _QWORD *a2, _QWORD *a3, unsigned __int64 *a4)
{
  ...
  v15 = 0LL;
  v6 = a1;
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140EF6F88, (__int64)&v16, &v15);
...
LABEL_8:
  ...
  RtlpFcBufferManagerDereferenceBuffers(qword_140EF6F88, v9);
