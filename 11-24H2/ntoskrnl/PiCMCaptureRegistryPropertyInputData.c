/*
 * XREFs of PiCMCaptureRegistryPropertyInputData @ 0x1408C3160
 * Callers:
...
LABEL_54:
      ...
      *(_QWORD *)(a4 + 40) = 0LL;
      if ( v18 )
      {
        ...
        if ( v20 )
        {
          UserModeCallersCopy = PiControlMakeUserModeCallersCopy((int)a4 + 40, v18, v20, 1, v23, 1);
          PreviousMode = v23;
          if ( UserModeCallersCopy >= 0 )
          {
            v12 = 1;
