/*
 * XREFs of EtwpTrackProviderRegistration @ 0x14083DAD0
 * Callers:
...
void __fastcall EtwpTrackProviderRegistration(__int64 a1)
{
  ...
  if ( (v1 & 8) == 0 )
  {
    ...
    while ( 1 )
    {
      if ( (*(_WORD *)(a1 + 100) & (unsigned __int16)v6) == 0 )
        goto LABEL_4;
      v9 = *(unsigned __int16 *)(v3 + v7 + 134);
      if ( (unsigned int)v9 >= *(_DWORD *)(v5 + 16) )
        goto LABEL_4;
      if ( (*(_QWORD *)(*(_QWORD *)(v5 + 712) + 8 * v9) & 1) != 0 )
        goto LABEL_4;
      v10 = 8 * v9;
      v11 = ExAcquireRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v5 + 704) + 8 * v9), 1u);
      v5 = v18;
      if ( !v11 )
        goto LABEL_4;
      if ( (unsigned int)v9 >= *(_DWORD *)(v18 + 16) )
        goto LABEL_13;
      _mm_lfence();
      v12 = *(_QWORD *)(*(_QWORD *)(v18 + 712) + 8 * v9);
      if ( (v12 & 1) != 0 )
        break;
      if ( !*(_DWORD *)(v12 + 320) )
      {
      ...
      if ( v12 )
      {
        ...
        v13 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(*(_QWORD *)(*(_QWORD *)(v12 + 1360) + 704LL)
                                                     + 8LL * *(unsigned int *)v12);
        goto LABEL_22;
      }
LABEL_4:
      if ( (*(_WORD *)(a1 + 104) & (unsigned __int16)v6) != 0 )
      {
    ...
    v10 = 8 * v9;
LABEL_13:
    v13 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(*(_QWORD *)(v18 + 704) + v10);
LABEL_22:
