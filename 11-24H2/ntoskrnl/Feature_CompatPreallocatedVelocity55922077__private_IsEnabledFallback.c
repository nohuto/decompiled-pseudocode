/*
 * XREFs of Feature_CompatPreallocatedVelocity55922077__private_IsEnabledFallback @ 0x140695F64
 * Callers:
...
__int64 __fastcall Feature_CompatPreallocatedVelocity55922077__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
