/*
 * XREFs of DifExCreateCallbackWrapper @ 0x14061B840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExCreateCallbackWrapper(PCALLBACK_OBJECT *a1, OBJECT_ATTRIBUTES *a2, BOOLEAN a3, BOOLEAN a4)
{
  ...
  LODWORD(v19) = ExCreateCallback(a1, a2, a3, a4);
  if ( v9 )
  {
