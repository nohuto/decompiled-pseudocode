/*
 * XREFs of DifZwRollbackEnlistmentWrapper @ 0x140645E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRollbackEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(25);
  ...
  DWORD2(v16) = ZwRollbackEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
