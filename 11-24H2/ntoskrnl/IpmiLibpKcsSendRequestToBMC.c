/*
 * XREFs of IpmiLibpKcsSendRequestToBMC @ 0x1406A1550
 * Callers:
...
__int64 __fastcall IpmiLibpKcsSendRequestToBMC(__int64 a1, __int64 a2, unsigned __int16 a3, __int64 a4)
{
  ...
  while ( a3 > 1u )
  {
    ...
    if ( (dword_140EF9F20 & 1) != 0 && (unsigned int)IpmiLibpHandleSendInterrupt(v8, a4) )
      goto LABEL_22;
    if ( (unsigned int)IpmiLibpKcsSpinRegister(v8, a4, 2LL) )
      goto LABEL_22;
  ...
  if ( (IpmiLibWriteOneByte(v11, 1u, 0x62u), dword_140EF9F54 = 2, (dword_140EF9F20 & 1) != 0)
