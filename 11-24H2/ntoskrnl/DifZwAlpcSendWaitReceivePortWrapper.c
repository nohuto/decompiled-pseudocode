/*
 * XREFs of DifZwAlpcSendWaitReceivePortWrapper @ 0x14063AD70
 * Callers:
 *     <none>
 * Callees:
        ...
        LARGE_INTEGER *Timeout)
{
  ...
  _QWORD **v20; // rsi
  _QWORD *j; // rbx
  _QWORD v23[7]; // [rsp+48h] [rbp-39h] BYREF
  ULONG v24; // [rsp+80h] [rbp-1h]
...
LABEL_17:
  v26 = ZwAlpcSendWaitReceivePort(a1, a2, a3, a4, ReceiveMessage, BufferLength, ReceiveMessageAttributes, Timeout);
  if ( v13 )
  {
