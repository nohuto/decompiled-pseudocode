/*
 * XREFs of DifZwQueryVolumeInformationFileWrapper @ 0x1406451B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryVolumeInformationFileWrapper(
        void *a1,
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(33);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *(_QWORD *)&v21 = a1;
    *((_QWORD *)&v19 + 1) = __PAIR64__(a4, FsInformationClass);
    *((_QWORD *)&v20 + 1) = a2;
    *(_QWORD *)&v20 = a3;
  ...
  DWORD2(v21) = ZwQueryVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v10 )
  {
