/*
 * XREFs of DifZwQueryVolumeInformationFileWrapper @ 0x140646BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v14 = 0;
    *(_QWORD *)&v25 = a1;
    *((_QWORD *)&v23 + 1) = __PAIR64__(a4, FsInformationClass);
    *((_QWORD *)&v24 + 1) = a2;
    *(_QWORD *)&v24 = a3;
  ...
  DWORD2(v25) = ZwQueryVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v12 )
  {
