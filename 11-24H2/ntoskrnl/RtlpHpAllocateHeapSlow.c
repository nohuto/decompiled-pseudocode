/*
 * XREFs of RtlpHpAllocateHeapSlow @ 0x1402B819C
 * Callers:
 ...
 *     RtlpHpCalculateAllocSize @ 0x14040C270 (RtlpHpCalculateAllocSize.c)
...
ULONG_PTR __fastcall RtlpHpAllocateHeapSlow(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  v16 = &v13[8 * (unsigned __int16)Value];
  v94 = BYTE4(Value);
  ...
  if ( !*((_WORD *)v16 + v14) )
  {
    ...
    {
      v18 = &v13[32 * (unsigned __int64)v94 + 184];
  ...
  if ( *(_WORD *)(v19 + 4) )
  {
    ...
    if ( (v20 & 0xFFF) != 0 )
    {
      ...
      *(_QWORD *)(v19 + 56) = v20 - 1;
      ...
      v91 = qword_140E28208 ^ *(_DWORD *)((v20 & 0xFFFFFFFFFFFFF000uLL) + 0x28) ^ ((v20 & 0xFFFFFFFFFFFFF000uLL) >> 12);
      v27 = (char *)Blink + v26;
...
LABEL_29:
  ...
  v87 = qword_140E28208 ^ *(_DWORD *)(v37 + 40) ^ (v37 >> 12);
  v42 = (char *)v40 + v41;
...
LABEL_57:
    ...
    if ( !*((_BYTE *)v13 + v61 + 92) )
    {
      *((_BYTE *)v13 + v61 + 92) = 1;
      v63 = *v13;
      if ( !(unsigned int)RtlpHpEnvCompactionIsScheduled(*(_QWORD *)(*v13 + 56)) )
        RtlpHpEnvCompactionSchedule(*(_QWORD **)(v63 + 56));
    }
    if ( BYTE2(v88) == 1 )
    {
      _R9 = (unsigned __int64)&v13[8 * (unsigned __int16)v88];
...
LABEL_68:
  if ( v85 )
    RtlpHpLfhBucketUpdateAffinityMapping(
      a1 + 832,
      (volatile signed __int8 *)&v13[8 * (unsigned __int64)*(unsigned __int16 *)(v19 + 2)]);
LABEL_70:
  v69 = v12;
  if ( Slow != -1LL )
  {
...
LABEL_74:
  ...
  {
    HeapBackend = RtlpHpVsContextAllocate((_BYTE *)(a1 + 704), a2, v69, v11);
  }
  Slow = HeapBackend;
LABEL_80:
  if ( Slow )
      ...
      if ( v86 )
      {
        ...
        *(_BYTE *)(v72 + 2) ^= (v86 ^ *(_BYTE *)(v72 + 2)) & 0xF;
        if ( (int)RtlpCallInterceptRoutine(v86, a1, Slow, 2, v72 + 16) < 0 )
        {
          ...
          {
            v74 = RtlCSparseBitmapBitmaskRead((__int64)&dword_140E68310, 2 * ((Slow - qword_140E68308) >> 20));
          ...
          if ( (RtlpHpHeapGlobals ^ *(_QWORD *)(v77 + 0x10) ^ v77) == v76 )
          {
            ...
            if ( *(_BYTE *)(v80 + 24) + (v81 == Slow) == 11 )
              ...
              RtlpHpSegFreeInternal((__int64 *)v76, Slow, v80, 0LL);
          }
          else
          {
