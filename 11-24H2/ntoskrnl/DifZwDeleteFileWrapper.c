/*
 * XREFs of DifZwDeleteFileWrapper @ 0x14063D1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteFileWrapper(POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(113);
  ...
  LODWORD(v14) = ZwDeleteFile(ObjectAttributes);
  if ( v4 )
  {
