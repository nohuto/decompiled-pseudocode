/*
 * XREFs of VerifierMmAllocateContiguousMemorySpecifyCacheNode @ 0x140BA0250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierMmAllocateContiguousMemorySpecifyCacheNode(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
