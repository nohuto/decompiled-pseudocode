/*
 * XREFs of _CmIsDeviceInContainer @ 0x14097AEDC
 * Callers:
        ...
        _BYTE *a7)
{
  ...
  *v9 = 0;
  ...
  if ( v13 < 0 )
    goto LABEL_14;
  v14 = a1 && *(_QWORD *)v8 ? *(_QWORD *)(*(_QWORD *)v8 + 8LL) : 0LL;
  v13 = RegRtlOpenKeyTransacted((__int64)v22, L"BaseContainers", 0, 1u, &v21, v14);
  if ( v13 < 0
    || (!a1 || !*(_QWORD *)v8 ? (v15 = 0LL) : (v15 = *(_QWORD *)(*(_QWORD *)v8 + 8LL)),
        (v13 = RegRtlOpenKeyTransacted((__int64)v21, a4, 0, 1u, &Handle, v15), v13 < 0)
