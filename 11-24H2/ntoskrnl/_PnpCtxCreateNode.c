/*
 * XREFs of _PnpCtxCreateNode @ 0x1408179EC
 * Callers:
        ...
        UNICODE_STRING **a9)
{
  ...
  a6 = 0LL;
  *a9 = 0LL;
  Pool2 = (UNICODE_STRING *)ExAllocatePool2(0x100uLL, 0x98uLL, 0x52504E50u);
  v15 = Pool2;
  if ( !Pool2 )
...
LABEL_5:
  ...
  *(_DWORD *)&v15[3].Length = a3;
  v21 = SysCtxOpenMachine(v17, a5, v18, v20, SourceHandle, *a1, (__int64)&a6);
  v13 = (wchar_t *)a6;
  v16 = v21;
  if ( v21 < 0 )
    goto LABEL_5;
