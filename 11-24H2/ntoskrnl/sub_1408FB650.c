/*
 * XREFs of sub_1408FB650 @ 0x1408FB650
 * Callers:
...
__int64 __fastcall sub_1408FB650(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  unsigned int *v6; // rdi
  unsigned int v7; // esi
  ...
  *(_OWORD *)P_8 = 0LL;
  ...
  if ( WowTrapFrame < 0 )
    goto LABEL_9;
  WowTrapFrame = sub_1408FBE0C(a1, v45, &P);
  if ( WowTrapFrame < 0 )
    goto LABEL_9;
  WowTrapFrame = sub_1408FC59C(a1, v9, &v38);
  if ( WowTrapFrame < 0 )
  {
LABEL_26:
    v6 = (unsigned int *)v38;
  ...
  if ( v6[4] + 1 >= v15 )
  {
    WowTrapFrame = sub_140A651B4(*((void **)v6 + 3), v16);
    if ( WowTrapFrame < 0 )
      goto LABEL_17;
    v6[5] += v6[8];
  }
...
LABEL_17:
  ...
  v37 = v7;
  v22 = P;
  WowTrapFrame = sub_1408FCEEC(v45, P, P_8, v43, v44, v37);
  if ( WowTrapFrame < 0 )
    goto LABEL_9;
...
LABEL_9:
  if ( v6 )
  {
    ...
    {
      v35 = v38;
      if ( (int)sub_1408FB1D0(a1, (__int64)v38, -1) >= 0 )
      {
        v36 = (void *)v35[3];
        if ( v36 )
