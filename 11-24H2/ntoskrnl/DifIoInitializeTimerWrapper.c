/*
 * XREFs of DifIoInitializeTimerWrapper @ 0x140629460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoInitializeTimerWrapper(
        ...
        PVOID Context)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = DeviceObject;
    *(_QWORD *)&v22 = TimerRoutine;
    *((_QWORD *)&v21 + 1) = Context;
  ...
  LODWORD(v23) = IoInitializeTimer(DeviceObject, TimerRoutine, Context);
  if ( v10 )
  {
