/*
 * XREFs of Xp10BuildHuffmanDecodeTable @ 0x1407892E0
 * Callers:
        ...
        __int64 a9)
{
  ...
  unsigned int v43; // [rsp+A8h] [rbp+50h]
            ...
            do
            {
              ...
              if ( v40 > 8 )
              {
                ...
                do
                {
                  ...
                  v30 -= 8;
                  v31 >>= 8;
                  v32 = *((unsigned __int8 *)qword_140033A70 + v33) | (v32 << 8);
                  --v24;
                }
                while ( v24 );
              }
              if ( v30 )
                v32 = (*((unsigned __int8 *)qword_140033A70 + (unsigned __int8)v31) | (v32 << 8)) >> (8 - v30);
