/*
 * XREFs of IopInitializeInMemoryDumpData @ 0x14059488C
 * Callers:
...
void IopInitializeInMemoryDumpData()
{
  ...
  *((_QWORD *)&v11 + 1) = 0xB50211F197DACBD4uLL;
  ...
  {
    dword_140E65E44 = 0;
    LODWORD(qword_140E65E30) = 0;
    v1 = 0;
    v2 = ZwFilterBootOption(1LL, 270532611LL, 637534368LL, v10, 1);
    if ( v2 >= 0 || v2 == -2143092730 && (_BYTE)KdDebuggerEnabled )
      v1 = 1;
    qword_140E65E28 = 9144LL;
    for ( i = 0; i < 2; ++i )
    {
      ContiguousNodeMemory = (void *)MmAllocateContiguousNodeMemory(qword_140E65E28, 0, -1, 0, 4, 0x80000000);
      *(_QWORD *)&InMemData[2 * i + 2] = ContiguousNodeMemory;
      if ( !ContiguousNodeMemory )
      {
        dword_140E65E44 = -1073741801;
        v6 = (PVOID *)&unk_140E65E18;
        do
        {
          if ( *v6 )
          {
      ...
      memset_0(ContiguousNodeMemory, 0, qword_140E65E28);
    ...
    v7 = __rdtsc();
    LODWORD(qword_140E65E38) = v7;
    v8 = __rdtsc();
    HIDWORD(qword_140E65E38) = v8;
    HIDWORD(qword_140E65E38) = ExGenRandom(1) & 0x7FFFFFFF;
    v9 = IoSetEnvironmentVariableEx(
           (unsigned int)L"DumpInstance",
           (unsigned int)v13,
           (unsigned int)&qword_140E65E38,
           8,
           7);
    if ( v9 < 0 )
    {
      dword_140E65E44 = v9;
      qword_140E65E38 = 0x4547415045474150LL;
    }
    dword_140E65E14 = 1;
LABEL_20:
