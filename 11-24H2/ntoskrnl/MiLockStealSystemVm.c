/*
 * XREFs of MiLockStealSystemVm @ 0x14022A3E0
 * Callers:
...
__int64 __fastcall MiLockStealSystemVm(__int64 a1, unsigned __int8 a2, _QWORD *a3, _DWORD *a4)
{
  ...
  v6 = a2;
  v20 = *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
  v7 = 0;
  v8 = (__int64)((_QWORD)a3 << 25) >> 16;
  if ( v8 < 0xFFFF800000000000uLL )
    v9 = 0;
  else
    v9 = byte_140E389A8[((v8 >> 39) & 0x1FF) - 256];
  ...
  switch ( v9 )
  {
    ...
    case 5u:
      ...
      break;
    case 0xBu:
      MiUnlockPage(a1, (unsigned __int8)v6);
      a4[12] = 1;
      break;
    case 0x11u:
      MiUnlockPage(a1, (unsigned __int8)v6);
      ...
      break;
    default:
      v12 = *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
      v20 = v12;
      if ( v9 == 8 )
      {
        ...
        for ( i = 0; i < v13; ++i )
        {
          ...
          if ( v16 && v8 >= v16 )
          {
            if ( v8 < *(_QWORD *)(v15 + 184)
                    + (unsigned int)dword_140E3728C * (unsigned __int64)*(unsigned int *)(v15 + 4) )
            {
              a4[12] = 2;
              _InterlockedAnd64((volatile signed __int64 *)(a1 + 24), 0x7FFFFFFFFFFFFFFFuLL);
              if ( (unsigned __int8)v6 < 2u )
...
LABEL_40:
      ...
      {
        if ( v19 <= qword_140E2DBE0
          && (*(_QWORD *)(16 * ((a1 + 0x220000000000LL) >> 4) - 0x21FFFFFFFFD8LL) & 0x40000000000000LL) != 0
          && *((_QWORD *)qword_140E2FF88 + ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL)) == v20
          && *(__int64 *)(a1 + 40) >= 0
