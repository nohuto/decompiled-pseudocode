...
__int64 __fastcall lm_init(__int64 a1)
{
  ...
  *(_WORD *)(*(_QWORD *)(a1 + 184) + 2LL * (unsigned int)(v2 - 1)) = 0;
  ...
  v3 = 2LL * *(int *)(a1 + 252);
  *(_DWORD *)(a1 + 248) = WORD1(qword_140009360[2 * *(int *)(a1 + 252)]);
  *(_DWORD *)(a1 + 260) = LOWORD(qword_140009360[v3]);
  *(_DWORD *)(a1 + 264) = WORD2(qword_140009360[v3]);
  *(_DWORD *)(a1 + 244) = HIWORD(qword_140009360[v3]);
  result = 2LL;
  *(_DWORD *)(a1 + 240) = 2;
  *(_DWORD *)(a1 + 216) = 2;
  *(_QWORD *)(a1 + 224) = 0LL;
