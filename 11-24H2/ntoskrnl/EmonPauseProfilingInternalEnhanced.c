/*
 * XREFs of EmonPauseProfilingInternalEnhanced @ 0x14055B08C
 * Callers:
 *     EmonPauseProfilingEnhanced @ 0x14055B050 (EmonPauseProfilingEnhanced.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall EmonPauseProfilingInternalEnhanced(int a1, int a2)
{
  __int64 result; // rax
  __int64 v3; // r8
  int v4; // ecx
