/*
 * XREFs of HalpCreateCommonBufferFromMdlVerifyParams @ 0x14054EBA8
 * Callers:
 ...
 * Callees:
 *     HalpParseCommonBufferExtendedConfigurations @ 0x14054ECAC (HalpParseCommonBufferExtendedConfigurations.c)
 */
