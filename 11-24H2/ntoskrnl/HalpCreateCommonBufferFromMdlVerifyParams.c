/*
 * XREFs of HalpCreateCommonBufferFromMdlVerifyParams @ 0x14054C4E8
 * Callers:
 ...
 * Callees:
 *     HalpParseCommonBufferExtendedConfigurations @ 0x14054C5EC (HalpParseCommonBufferExtendedConfigurations.c)
 */
