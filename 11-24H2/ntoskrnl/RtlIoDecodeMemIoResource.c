/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x1405E7030
 * Callers:
 *     IopGenericScoreRequirement @ 0x1407234A0 (IopGenericScoreRequirement.c)
 *     IopGenericUnpackRequirement @ 0x1407235D0 (IopGenericUnpackRequirement.c)
