/*
 * XREFs of DifExSetTimerResolutionWrapper @ 0x14061F690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExSetTimerResolutionWrapper(ULONG DesiredTime, BOOLEAN a2)
{
  ...
  LODWORD(v16) = ExSetTimerResolution(DesiredTime, a2);
  if ( v6 )
  {
