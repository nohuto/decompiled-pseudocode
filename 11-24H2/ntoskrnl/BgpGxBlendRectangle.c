...
__int64 __fastcall BgpGxBlendRectangle(_DWORD *a1, _DWORD *a2, _DWORD *a3, int **a4)
{
    ...
    && *a1 >= v10 + a3[1] )
  {
    ...
    if ( !*v6 )
    {
      ...
      v13 = BgpGxRectangleCreate(&v31, 32LL, &v29);
      v4 = v29;
      v5 = v13;
      if ( v13 < 0 )
        goto LABEL_25;
      ...
      if ( v14 )
      {
        ...
        do
        {
          ...
          if ( v20 )
          {
            ...
            do
            {
              *(_DWORD *)(v24 + v21) = BgpGxBlendColor(*(_DWORD *)(v25 + v21), *(_DWORD *)v21, *(_BYTE *)(v21 + 3));
              ++v23;
              v20 = v4[1];
              v21 += v17;
            }
