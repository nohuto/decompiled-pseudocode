/*
 * XREFs of Feature_ConfAccImp_IsEnabledWithReporting @ 0x140667850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Feature_ConfAccImp_IsEnabledWithReporting(__int64 a1)
{
  unsigned int v1; // ebx
  ...
  if ( (_DWORD)a1 )
  {
    if ( (_DWORD)a1 == 3 )
    {
      IsEnabledDeviceUsageNoInline = Feature_ConfAccImp__private_IsEnabledDeviceUsageNoInline();
    }
    else if ( (_DWORD)a1 == 4 )
    {
      IsEnabledDeviceUsageNoInline = Feature_ConfAccImp__private_IsEnabledDeviceOpportunityNoInline();
    }
    else
    {
      IsEnabledDeviceUsageNoInline = Feature_ConfAccImp__private_IsEnabledOtherReporting();
    }
  }
  else
  {
    IsEnabledDeviceUsageNoInline = Feature_ConfAccImp__private_IsEnabledNoReportingNoInline(a1, (unsigned __int8)a1);
  }
