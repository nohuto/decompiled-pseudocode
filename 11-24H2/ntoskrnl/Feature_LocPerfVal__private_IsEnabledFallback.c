/*
 * XREFs of Feature_LocPerfVal__private_IsEnabledFallback @ 0x140667DC8
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_LocPerfVal__private_descriptor);
}
