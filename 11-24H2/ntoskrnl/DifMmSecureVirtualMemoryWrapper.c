/*
 * XREFs of DifMmSecureVirtualMemoryWrapper @ 0x1406349D0
 * Callers:
 *     <none>
 * Callees:
...
HANDLE __fastcall DifMmSecureVirtualMemoryWrapper(PVOID Address, SIZE_T Size, ULONG ProbeMode)
{
  ...
  HANDLE v23; // [rsp+40h] [rbp-10h]
  _UNKNOWN *retaddr; // [rsp+78h] [rbp+28h]

  v23 = 0LL;
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(214);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v22 + 1) = Address;
    *(_QWORD *)&v22 = Size;
    DWORD2(v21) = ProbeMode;
  ...
  v23 = MmSecureVirtualMemory(Address, Size, ProbeMode);
  if ( v10 )
  {
