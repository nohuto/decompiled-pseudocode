/*
 * XREFs of DifExfAcquirePushLockExclusiveWrapper @ 0x14061FF20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExfAcquirePushLockExclusiveWrapper(unsigned __int64 *a1)
{
  ...
  ExfAcquirePushLockExclusiveEx(a1, 0LL, (__int64)a1);
  if ( v4 )
  {
