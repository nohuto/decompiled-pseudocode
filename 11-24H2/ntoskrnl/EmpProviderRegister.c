/*
 * XREFs of EmpProviderRegister @ 0x140AB3EE0
 * Callers:
 *     EmProviderRegister @ 0x140709BC0 (EmProviderRegister.c)
 *     HalRegisterErrataCallbacks @ 0x140BDE860 (HalRegisterErrataCallbacks.c)
...
__int64 __fastcall EmpProviderRegister(void *a1, __int64 a2, unsigned int a3, __int64 a4, unsigned int a5, __int64 *a6)
{
  ...
  v14 = v12;
  if ( v13 )
    ExfAcquirePushLockExclusiveEx(&EmpDatabaseLock, (__int64)v12, (__int64)&EmpDatabaseLock);
  if ( v14 )
    *((_BYTE *)v14 + 10) = 1;
