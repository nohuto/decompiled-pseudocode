/*
 * XREFs of DifZwFlushVirtualMemoryWrapper @ 0x14063E910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFlushVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, struct _IO_STATUS_BLOCK *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(98);
  ...
  DWORD2(v20) = ZwFlushVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
