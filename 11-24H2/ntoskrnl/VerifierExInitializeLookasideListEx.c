/*
 * XREFs of VerifierExInitializeLookasideListEx @ 0x140B9FBC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierExInitializeLookasideListEx(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
