/*
 * XREFs of KiOpGetPciConfigSpaceAccessInfoFromPhysicalAddress @ 0x1404B78F0
 * Callers:
        ...
        int *a6)
{
  ...
  v6 = a1;
  if ( !off_140E00CA0[0] || !(unsigned __int8)guard_dispatch_icall_no_overrides(a1, a2, a3, a4) )
    return 3221225473LL;
  *a6 = v6 & 0xFFF;
  return 0LL;
}
