/*
 * XREFs of DifExTryToConvertFastResourceSharedToExclusiveWrapper @ 0x14061FAE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExTryToConvertFastResourceSharedToExclusiveWrapper(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  BYTE8(v16) = ExTryToConvertFastResourceSharedToExclusive(BugCheckParameter2, a2);
  if ( v6 )
  {
