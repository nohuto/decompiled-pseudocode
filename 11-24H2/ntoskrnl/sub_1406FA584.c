/*
 * XREFs of sub_1406FA584 @ 0x1406FA584
 * Callers:
...
__int64 __fastcall sub_1406FA584(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // edx
  unsigned int *v7; // rax
  unsigned int i; // edx
  ...
  {
    if ( stru_140EF09C0.Header.SignalState || !dword_140FD7174 )
    {
      v14 = MEMORY[0xFFFFF78000000320];
      TimeIncrement = KeQueryTimeIncrement();
      dword_140FD7174 = 1;
      qword_140FD7118 = v14 * TimeIncrement / 10000;
