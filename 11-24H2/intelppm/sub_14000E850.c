/*
 * XREFs of sub_14000E850 @ 0x14000E850
 * Callers:
 *     sub_14000E900 @ 0x14000E900 (sub_14000E900.c)
 * Callees:
 *     __security_check_cookie @ 0x140010230 (__security_check_cookie.c)
 */

__int64 __fastcall sub_14000E850(__int64 *BugCheckParameter4, unsigned int a2, int a3)
{
  unsigned int v3; // ebx
  __int64 v5; // rcx
  ...
  v3 = 0;
  if ( !qword_140019800 && (a3 != -1 || !BYTE1(BugCheckParameter4[11 * a2 + 16])) )
  {
