/*
 * XREFs of sub_14002E5A8 @ 0x14002E5A8
 * Callers:
...
__int64 __fastcall sub_14002E5A8(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, _BYTE *a6)
{
  unsigned int v6; // ebx
  _BYTE *v8; // rdx
  __int64 v10; // r8
  ...
  *a6 = 0;
  while ( v11 < *(_DWORD *)(a4 + 12) )
  {
    ...
    else if ( !(unsigned int)KeIsEqualAffinityEx(a5, v15) )
    {
      ...
      v16 = 101;
LABEL_18:
      sub_14000C074((__int64)off_140018050->DeviceExtension, (__int64)v8, v10, v16, v18);
      return (unsigned int)-1073741811;
    }
