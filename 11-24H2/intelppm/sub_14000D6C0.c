/*
 * XREFs of sub_14000D6C0 @ 0x14000D6C0
 * Callers:
...
__int64 sub_14000D6C0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(off_140018050->Timer) & 1) != 0 && BYTE1(off_140018050->Timer) >= 2u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))qword_140018EE0)(
      ...
      0LL);
  LOWORD(v7) = 38;
  return WppAutoLogTrace(a1, 2LL, 1LL, &unk_140012AE0, v7, (__int64 *)va, 4LL, (__int64 *)va1);
}
