/*
 * XREFs of sub_14002BDAC @ 0x14002BDAC
 * Callers:
...
void __fastcall sub_14002BDAC(__int64 a1)
{
  void *v2; // rdi
  __int64 v3; // rsi
  __int64 v4; // r14
  ...
  v2 = 0LL;
  if ( EtwEventEnabled((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, &stru_1400142C0) )
  {
    v3 = *(_QWORD *)(a1 + 16);
    if ( v3 )
    {
      ...
      if ( Pool2 )
      {
        ...
        *(_DWORD *)(Pool2 + 56) = 4;
        ...
        EtwWrite((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, &stru_1400142C0, 0LL, 2 * v4 + 4, UserData);
LABEL_9:
