/*
 * XREFs of sub_1400406BC @ 0x1400406BC
 * Callers:
...
__int64 __fastcall sub_1400406BC(__int64 a1, _DWORD *a2)
{
  int v2; // r14d
  __int64 v5; // rdx
  int v6; // ebx
  ...
  v27 = 1;
  v30 = 20;
  if ( (*(unsigned int (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD *, int *, _QWORD, _QWORD))(qword_140019120 + 1488))(
         qword_140019128,
         v5,
         0LL,
         3325984LL,
    ...
    && (v6 = DWORD1(v38), DWORD1(v38) >= 0x14) )
  {
    ...
    if ( Pool2 )
    {
      ...
      v29 = (__int128 *)Pool2;
      v30 = v6;
      v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD *, int *, _QWORD, _DWORD *))(qword_140019120 + 1488))(
              qword_140019128,
              v11,
              0LL,
              3325984LL,
        ...
        if ( *v9 == 1198089537 && (v12 = v9[1]) != 0 && *(_QWORD *)&v31[1] == v7 )
        {
          ...
          if ( v12 > 1 )
          {
            ...
            do
            {
              ...
              {
                if ( *(_DWORD *)&aCst_0[8 * i] == v20 )
                {
                  v2 |= *(_DWORD *)&aCst_0[8 * i + 4];
                  break;
                }
              }
              --v15;
