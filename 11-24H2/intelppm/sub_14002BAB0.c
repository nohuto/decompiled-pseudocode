/*
 * XREFs of sub_14002BAB0 @ 0x14002BAB0
 * Callers:
 *     sub_14002B750 @ 0x14002B750 (sub_14002B750.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1400102D0 (_guard_dispatch_icall.c)
 *     sub_14002B9E0 @ 0x14002B9E0 (sub_14002B9E0.c)
 */

__int64 sub_14002BAB0()
{
  _DWORD *v0; // rdi
  int v1; // ebx
  __int64 Pool2; // rax
  ...
  P = 0LL;
  v1 = 0;
  if ( (qword_140019A90 & 0x200000000LL) != 0 )
  ...
  *(_DWORD *)(Pool2 + 24) = 2;
  v1 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(qword_140019120 + 2520))(qword_140019128, 0LL, Pool2 + 16);
  if ( v1 >= 0 )
  {
    v1 = sub_14002B9E0((__int64 *)&P);
    if ( v1 < 0 )
    {
      v0 = P;
    }
      ...
      *(_QWORD *)(v3 + 48) = v4;
      if ( v4 )
      {
        ...
        *(_QWORD *)(v5 + 24) = v12;
        if ( v12 )
        {
          ...
          *(_QWORD *)(v5 + 40) = v24;
          if ( v24 )
          {
            ...
            *(_QWORD *)(v3 + 32) = sub_140001EA0;
            *(_QWORD *)(v3 + 40) = sub_140004A30;
            v32 = (__int64 *)qword_140019AA0;
            if ( *(__int64 **)qword_140019AA0 != &qword_140019A98 )
              __fastfail(3u);
            *(_QWORD *)v3 = &qword_140019A98;
            *(_QWORD *)(v3 + 8) = v32;
            *v32 = v3;
        ...
        ExFreePoolWithTag(*(PVOID *)(v3 + 48), 0x72637250u);
      }
      else
      {
        v1 = -1073741670;
  ...
  ExFreePoolWithTag((PVOID)v3, 0x72637250u);
LABEL_38:
  if ( v0 )
    ExFreePoolWithTag(v0, 0x72637250u);
  return (unsigned int)v1;
}
