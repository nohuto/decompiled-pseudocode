...
__int64 __fastcall sub_14003E0E8(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebx
  unsigned int *v4; // r13
  __int64 v6; // rdi
  ...
  *(_QWORD *)(a2 + 24) = v9;
  ...
  if ( !v10 )
    v11 = sub_14000E850;
  *(_QWORD *)(v6 + 32) = v11;
  *(_QWORD *)(v6 + 40) = sub_14000E670;
  *(_QWORD *)(v6 + 48) = sub_14000E7B0;
  *(_QWORD *)(v6 + 64) = sub_140004880;
  *(_QWORD *)(v6 + 72) = sub_1400034D0;
  *(_QWORD *)(v6 + 80) = sub_14000E9A0;
  *(_QWORD *)(v6 + 88) = sub_14000E930;
  *(_BYTE *)(v6 + 16) = 1;
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)(v15 + 120) = v17;
    ...
    if ( ((v4[3 * v12 + 1] >> 3) & 0xF) != 0 )
    {
      ...
      if ( v19 != &v36 )
        *(_QWORD *)v18 = v19;
      if ( (int)sub_14003E4A0(a1, (_DWORD)v19, *((unsigned __int8 *)v19 + 12), 0, (__int64)&v34, (__int64)v29, 0LL, v18) < 0 )
      {
