/*
 * XREFs of sub_1400395E0 @ 0x1400395E0
 * Callers:
...
__int64 __fastcall sub_1400395E0(__int64 a1, _DWORD *a2, _DWORD *a3, __int64 a4)
{
  unsigned int v4; // esi
  unsigned int v5; // ebx
  _DWORD *v7; // r13
  ...
  if ( Pool2 )
  {
    ...
    *Pool2 = v4;
        ...
        *v23 = v21;
        ...
        if ( (_DWORD)v25 )
        {
          do
          {
            ...
            if ( *(_DWORD *)v27 != -1 )
              *(_QWORD *)(v26 + 24LL * v24) = *(_QWORD *)(sub_140006700(*(_DWORD *)v27) + 1120);
            v28 = *(_DWORD *)(v27 + 4);
            v29 = 0;
    ...
    ((void (__fastcall *)(_QWORD, unsigned int *, __int64, __int64))qword_140019500)(
      *(_QWORD *)(a1 + 1120),
      v20,
      v19,
      i);
