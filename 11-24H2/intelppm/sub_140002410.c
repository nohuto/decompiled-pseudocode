/*
 * XREFs of sub_140002410 @ 0x140002410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140002410(__int64 a1, char a2, _QWORD *a3, _QWORD *a4)
{
  ...
  *(_QWORD *)(v11 + a1 + 112) = v17;
  if ( (unsigned int)dword_140018CB8 > 5 )
  {
    v23 = *(_DWORD *)(a1 + 520);
    v34 = &v23;
    v24 = *(_DWORD *)(a1 + 64);
    ...
    v53 = 8LL;
    v55 = 1LL;
    sub_140001034((__int64)&dword_140018CB8, (unsigned __int8 *)dword_140014E39, v17, v12, 0xDu, &v33);
  }
  v18 = *(_QWORD *)(a1 + 24);
  ++*(_DWORD *)(a1 + 520);
  *a3 = v18;
