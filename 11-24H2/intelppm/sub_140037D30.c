/*
 * XREFs of sub_140037D30 @ 0x140037D30
 * Callers:
...
char __fastcall sub_140037D30(__int64 a1, unsigned int a2)
{
  __int64 v2; // rbp
  char v3; // si
  __int64 v5; // rdi
  ...
  if ( *(_DWORD *)(v2 + 24LL * a2 + 24) >= **(_DWORD **)(a1 + 728) )
    return v3;
  v6 = qword_1400191C8;
  if ( (__int64 *)qword_1400191C8 == &qword_1400191C8 )
    goto LABEL_6;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1400191C8 );
  if ( !v7 )
  {
LABEL_6:
    ...
    v9[1] = v9;
    *v9 = v9;
    v10 = (__int64 *)qword_1400191D0;
    if ( *(__int64 **)qword_1400191D0 != &qword_1400191C8 )
LABEL_15:
      __fastfail(3u);
    *(_QWORD *)v7 = &qword_1400191C8;
    *(_QWORD *)(v7 + 8) = v10;
    *v10 = v7;
    qword_1400191D0 = v7;
