/*
 * XREFs of sub_140007590 @ 0x140007590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140007590(__int64 a1, __int64 a2, char a3, char a4)
{
  unsigned int v5; // edx
  unsigned int v6; // ecx
  __int64 result; // rax
  ...
  if ( a4 && a3 )
  {
    ...
    return ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64))qword_140019528)(
