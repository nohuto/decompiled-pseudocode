/*
 * XREFs of sub_14003CB24 @ 0x14003CB24
 * Callers:
...
__int64 __fastcall sub_14003CB24(
        _DWORD *a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
...
LABEL_25:
      sub_140009A48((__int64)off_140018050->DeviceExtension, 2u, 1u, v30, (__int64)&unk_140013150, v29);
      return 3221225473LL;
    }
    ...
    if ( v20 == -1 )
      goto LABEL_19;
    v42 = v15 + 1;
    v22 = sub_140006700(v20);
    v23 = *(_QWORD *)(v22 + 544);
    if ( !v23 )
    {
      if ( off_140018058 == (_UNKNOWN *)&off_140018058 )
        return 3221225473LL;
      v29 = *(const wchar_t **)(v22 + 64);
      v30 = 13;
      goto LABEL_25;
    }
    if ( a11 )
    {
      KeAddProcessorAffinityEx(a11, *(unsigned int *)(v22 + 56));
      v21 = v40;
      v13 = a3;
    }
    v24 = 0LL;
...
LABEL_19:
  ...
  if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
  {
    v27 = *(const wchar_t **)(v22 + 64);
    v28 = 14;
LABEL_22:
    LODWORD(v38) = v13;
    sub_14000A1EC((__int64)off_140018050->DeviceExtension, v24, v25, v28, (__int64)&unk_140013150, v27, v38);
  }
  return 3221225473LL;
}
