/*
 * XREFs of sub_14003DDFC @ 0x14003DDFC
 * Callers:
...
__int64 __fastcall sub_14003DDFC(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r14
  unsigned int v4; // ebx
  __int64 v7; // r13
  ...
  {
    *(_BYTE *)(a2 + 19) = 1;
    *(_QWORD *)(a2 + 24) = sub_140009D90;
    v8 = 1;
    *(_DWORD *)(a2 + 96) = 0;
    *(_QWORD *)(a2 + 40) = sub_140009D40;
    *(_QWORD *)(a2 + 64) = sub_140003B90;
    *(_QWORD *)(a2 + 72) = guard_check_icall_nop;
    *(_QWORD *)(a2 + 80) = sub_140009D80;
    *(_QWORD *)(a2 + 88) = sub_140009D80;
    *(_BYTE *)(a2 + 16) = 0;
    *(_DWORD *)(a3 + 40) = 0;
    v25[0] = 0;
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      HIWORD(v31) = 0;
      v32 = 0;
      sub_14003E448(a1, (unsigned int)&v31, (unsigned int)&v26, (unsigned int)v25, a3 + 48);
      v8 = 2;
    ...
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        *v24 = v16;
        ...
        v28 = v16;
        if ( (int)sub_14003E4A0(v7, v3 + 4 * (i + v15), v17, 0, (__int64)&v26, (__int64)v25, 0LL, (__int64)v24) < 0 )
        {
