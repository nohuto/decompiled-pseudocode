/*
 * XREFs of sub_14003814C @ 0x14003814C
 * Callers:
...
__int64 __fastcall sub_14003814C(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rsi
  unsigned int v4; // ebx
  __int64 v5; // r12
  ...
  {
    *(_BYTE *)(a2 + 19) = 1;
    *(_QWORD *)(a2 + 40) = sub_14000E670;
    *(_QWORD *)(a2 + 24) = sub_14000E7F0;
    *(_QWORD *)(a2 + 64) = sub_14000FFF0;
    if ( _bittest64((const signed __int64 *)(a1 + 280), 0x2Cu) )
    {
      *(_QWORD *)(a2 + 48) = sub_14000EA90;
      v8 = sub_14000EA10;
    }
    else
    {
