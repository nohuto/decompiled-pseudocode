/*
 * XREFs of sub_140030730 @ 0x140030730
 * Callers:
 *     <none>
 * Callees:
 *     sub_1400050F8 @ 0x1400050F8 (sub_1400050F8.c)
 *     _guard_dispatch_icall @ 0x1400102D0 (_guard_dispatch_icall.c)
 *     sub_140030008 @ 0x140030008 (sub_140030008.c)
 */

__int64 __fastcall sub_140030730(__int64 a1)
{
      ...
      if ( Pool2 )
      {
          ...
          *v10 = 0;
          ...
          while ( 1 )
          {
            ...
            if ( *(_BYTE *)(v14 + 24 * v13 + 17) && *(_BYTE *)(v14 + 24 * v13 + 16) )
            {
              ...
              v12 = v32;
              v34 = (__int64)v16;
              if ( *(void (__fastcall **)(__int64, __int64, unsigned __int64 *, unsigned __int64 *))(v26 + 48) == sub_140001C20 )
              {
                v27 = *(_QWORD *)v15;
                v6 = sub_140030008((unsigned __int8 *)(*(_QWORD *)v15 + 296LL), (__int64)(v16 + 2));
                if ( v6 < 0 )
                  goto LABEL_45;
                v6 = sub_140030008((unsigned __int8 *)(v27 + 272), v34);
                if ( v6 < 0 )
                  goto LABEL_45;
                v15 = v28;
                v18 = 0;
          ...
          if ( *(_BYTE *)(a1 + 13) && qword_1400193D0 )
          {
            v6 = qword_1400193D0(*(_QWORD *)(32LL * (unsigned int)v12 + v9 + 8));
            if ( v6 < 0 )
            {
              *(_BYTE *)(a1 + 13) = 0;
              goto LABEL_45;
        ...
        *((_QWORD *)&v30 + 1) = Pool2;
        ...
        if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
          sub_1400050F8((__int64)off_140018050->DeviceExtension, 2u, 3u, 0x12u, (__int64)&unk_1400145F8, v6);
      }
      else
      {
        v6 = -1073741670;
...
LABEL_46:
  ...
  *((_QWORD *)&v30 + 1) = 0LL;
  ...
  if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
    sub_1400050F8((__int64)off_140018050->DeviceExtension, 2u, 3u, 0x11u, (__int64)&unk_1400145F8, v6);
  return (unsigned int)v6;
}
