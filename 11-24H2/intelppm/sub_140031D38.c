/*
 * XREFs of sub_140031D38 @ 0x140031D38
 * Callers:
...
__int64 __fastcall sub_140031D38(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // esi
  _DWORD *Pool2; // r15
  int v6; // edx
  ...
  v7 = sub_140040DB8(a1, v17, 0, (unsigned int)&P, (__int64)&v16);
  if ( v7 < 0 )
    goto LABEL_6;
  v8 = P;
  *(_QWORD *)(a1 + 272) |= *(_DWORD *)(a1 + 280) & 0x30000000;
  if ( !v8 )
  {
    ...
    {
      LOBYTE(v6) = 2;
      sub_140003D28(off_140018050->DeviceExtension, v6, 3, 23, (__int64)&unk_140012FE8);
    }
    v7 = -1073741823;
    goto LABEL_6;
  }
    ...
    *Pool2 = *((unsigned __int8 *)v8 + 8);
    while ( 1 )
    {
      ...
      if ( v7 < 0 )
      {
        ...
        {
          LODWORD(v14) = v2;
          sub_140005F24((__int64)off_140018050->DeviceExtension, 2u, 1u, 0x1Bu, (__int64)&unk_140012FE8, v14);
        }
        goto LABEL_6;
      }
