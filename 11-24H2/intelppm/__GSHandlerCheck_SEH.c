/*
 * XREFs of __GSHandlerCheck_SEH @ 0x140010194
 * Callers:
 *     <none>
 * Callees:
 *     __C_specific_handler @ 0x1400068AD (__C_specific_handler.c)
        ...
        struct _DISPATCHER_CONTEXT *DispatcherContext)
{
  ...
  sub_14001012C((__int64)EstablisherFrame, (__int64)DispatcherContext);
