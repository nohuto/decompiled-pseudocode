/*
 * XREFs of sub_1400412A8 @ 0x1400412A8
 * Callers:
...
void __fastcall sub_1400412A8(char a1)
{
  _DWORD *v1; // rsi
  _WORD *Pool2; // rdi
  ...
  if ( qword_1400197F8 )
  {
    v3 = (const EVENT_DESCRIPTOR *)&unk_140012C30;
    if ( a1 )
      v3 = &stru_140012C20;
    if ( EtwEventEnabled((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v3) )
    {
      LODWORD(v4) = 0;
      if ( !v1[1] )
        goto LABEL_9;
          ...
          do
          {
            *(_QWORD *)&UserData.Size = 4LL;
            ...
            if ( *((_DWORD *)v7 + 4) )
            {
              ...
              {
                v10 = v9;
                KeGetProcessorNumberFromIndex(*(_DWORD *)(*((_QWORD *)v7 + 5) + 8LL * v9), &ProcNumber);
                v11 = 3LL * v9;
            ...
            EtwWrite((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v3, 0LL, v6, &UserData);
