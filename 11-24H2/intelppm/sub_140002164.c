/*
 * XREFs of sub_140002164 @ 0x140002164
 * Callers:
 *     sub_140002140 @ 0x140002140 (sub_140002140.c)
 *     sub_140045920 @ 0x140045920 (sub_140045920.c)
 * Callees:
...
__int64 __fastcall sub_140002164(__int64 a1, __int64 a2, char a3)
{
  __int64 v4; // rcx
  __int64 v5; // rbp
  _QWORD *v6; // rsi
  ...
  for ( i = 0; i < 5; ++i )
  {
    ...
    if ( *(_BYTE *)v9 && (v5 & *(v6 - 1)) != 0 )
    {
      ++v7;
      if ( v16 )
        v11 = sub_140006718(*(unsigned int *)(a1 + 84), v6, 0LL);
      else
        v11 = sub_140002350(v6);
      v12 = v11;
