/*
 * XREFs of sub_140043AF8 @ 0x140043AF8
 * Callers:
...
char __fastcall sub_140043AF8(__int64 a1, char a2)
{
  void *v3; // r8
  bool v5; // zf
  void *v6; // rdx
  ...
  if ( a2 )
    v6 = &unk_140012DD8;
  v7 = (const EVENT_DESCRIPTOR *)sub_1400039B0((ULONG *)a1, (__int64)v6, (__int64)v3, (__int64)&v30, (__int64)&UserData);
  v8 = v7;
  if ( v7 )
  {
...
LABEL_10:
      ...
      else
      {
        if ( (v9 & 0x8000000) == 0 )
        {
          ...
          {
            v26 = 2;
            v14 = *(_DWORD *)(qword_140019740 + 28);
            v23 = v14;
            v25 = 100 * *(_DWORD *)(qword_140019740 + 36) / v14;
            v24 = 100 * *(_DWORD *)(qword_140019740 + 32) / v14;
          }
          else
          {
            if ( (v9 & 0x73300000) == 0 )
...
LABEL_16:
            ...
            v43 = 4LL;
            v45 = 4LL;
            EtwWrite((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v8, 0LL, 8u, &UserData);
            LOBYTE(v7) = (*(__int64 (__fastcall **)(__int64, _QWORD))(qword_140019120 + 2512))(
                           qword_140019128,
                           *(_QWORD *)(a1 + 208));
            return (char)v7;
          }
