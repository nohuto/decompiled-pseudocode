/*
 * XREFs of sub_14003EFEC @ 0x14003EFEC
 * Callers:
...
__int64 __fastcall sub_14003EFEC(__int64 a1, _QWORD *a2)
{
  int v2; // r15d
  _DWORD *v4; // r14
  unsigned int *v5; // rdi
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)&v23 + 1) = Pool2;
    v24 = v6;
    v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, __int128 *, __int128 *, _QWORD, __int64 *))(qword_140019120 + 1488))(
            qword_140019128,
            v9,
            0LL,
            3325956LL,
...
LABEL_14:
        ...
        *v4 = *((unsigned __int8 *)v5 + 8);
        ...
        {
          LODWORD(v19) = v2;
          sub_140005F24((__int64)off_140018050->DeviceExtension, 2u, 1u, 0x2Cu, (__int64)&unk_140012FE8, v19);
        }
        goto LABEL_8;
      }
      if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
...
LABEL_19:
      LOBYTE(v11) = 2;
      sub_140003D28(off_140018050->DeviceExtension, v11, 1, v15, (__int64)&unk_140012FE8);
    }
    v12 = -1073741275;
  }
LABEL_8:
