 ...
 *     sub_140003690 @ 0x140003690 (sub_140003690.c)
...
__int64 sub_140003834(__int64 a1, unsigned __int8 a2, unsigned int a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( _bittest(&v10, ((_BYTE)a3 - 1) & 0x1F) && *((_BYTE *)&off_140018050->Timer + 80 * v7 + 1) >= a2 )
    ((void (__fastcall *)(_QWORD, __int64, __int64, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))qword_140018EE0)(
      *((_QWORD *)&off_140018050->AttachedDevice + 10 * v7),
      ...
      0LL);
  LOWORD(v12) = a4;
  return WppAutoLogTrace(a1, v9, a3, a5, v12, (__int64 *)va, 4LL, va1, 4LL, 0LL);
}
