/*
 * XREFs of sub_140001C20 @ 0x140001C20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140001C20(__int64 a1, __int64 a2, unsigned __int64 *a3, unsigned __int64 *a4)
{
  __int64 v4; // r11
  int v5; // edx
