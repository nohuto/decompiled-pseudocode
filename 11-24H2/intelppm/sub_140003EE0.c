/*
 * XREFs of sub_140003EE0 @ 0x140003EE0
 * Callers:
...
BOOLEAN __fastcall sub_140003EE0(__int64 a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    v4 = (const EVENT_DESCRIPTOR *)&unk_140013020;
    if ( a2 != 1 )
      v4 = &stru_140013030;
  }
  else
  {
    v4 = (const EVENT_DESCRIPTOR *)&unk_140014400;
  }
  result = EtwEventEnabled((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v4);
  if ( result )
  {
    sub_140010680(v34, 0LL, 320LL);
    v14 = 0;
    for ( i = 0; i < 0x20u; ++i )
    {
    ...
    v30 = 0;
    v29 = 10 * v9;
    (*(void (__fastcall **)(__int64, __int64))(qword_140019120 + 2528))(qword_140019128, v10);
    for ( j = 0; j < *(unsigned __int8 *)(a1 + 308); ++j )
    {
      ...
      *(_QWORD *)&UserData.Size = 8LL;
      ...
      v33 = 0;
      EtwWrite((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v4, 0LL, 8u, &UserData);
      sub_140004168(v16, a2);
    }
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(qword_140019120 + 2536))(qword_140019128, *(_QWORD *)(a1 + 280));
  }
  return result;
}
