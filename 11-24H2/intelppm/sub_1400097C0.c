/*
 * XREFs of sub_1400097C0 @ 0x1400097C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1400097C0(__int64 a1, __int64 a2, char a3, char a4)
{
  __int64 v6; // r11
  unsigned int v7; // ebp
  unsigned int v8; // edx
  ...
  if ( a3 || a4 )
  {
    ...
    *(_QWORD *)(a1 + 80) = *(_QWORD *)a2;
    ...
    if ( *(_BYTE *)(a1 + 126) )
    {
      ...
      {
        v11 = sub_140001A00(a1, v8);
        v6 = v14 & ~v13 | v13 & (v11 << v12);
      }
      else
      {
        LODWORD(v6) = sub_140001A00(a1, v8);
      }
    }
    if ( *(_BYTE *)(a1 + 127) )
    {
      ...
      {
        v15 = sub_140001A00(a1, v7);
        v6 = v18 & ~v17 | v17 & (v15 << v16);
      }
      else
      {
        LODWORD(v6) = sub_140001A00(a1, v7);
      }
    }
    if ( *(_BYTE *)(a1 + 130) )
    {
      ...
      {
        v19 = sub_140001A00(a1, *(_DWORD *)(a2 + 32));
        v6 = v22 & ~v21 | v21 & (v19 << v20);
      }
      else
      {
        LODWORD(v6) = sub_140001A00(a1, *(_DWORD *)(a2 + 32));
      }
    }
    if ( *(_BYTE *)(a1 + 128) )
    {
    ...
    sub_140008EFC(*(unsigned int *)(*(_QWORD *)a1 + 84LL), a1 + 152, ~*(_QWORD *)(a1 + 184), v6);
  }
}
