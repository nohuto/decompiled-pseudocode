/*
 * XREFs of sub_14002C084 @ 0x14002C084
 * Callers:
...
BOOLEAN __fastcall sub_14002C084(unsigned __int8 *a1, char a2)
{
  ...
  v3 = (const EVENT_DESCRIPTOR *)&unk_140014320;
  if ( a2 )
    v3 = &stru_140014450;
  result = EtwEventEnabled((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v3);
  if ( result )
  {
    v5 = a1[57];
    UserData.Reserved = 0;
    ...
    v26 = 4;
    v11 = 1;
    return EtwWrite((REGHANDLE)DeviceObject.Queue.ListEntry.Blink, v3, 0LL, 7u, &UserData);
  }
  return result;
}
