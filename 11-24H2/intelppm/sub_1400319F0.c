/*
 * XREFs of sub_1400319F0 @ 0x1400319F0
 * Callers:
...
__int64 __fastcall sub_1400319F0(__int64 a1, int a2, _QWORD *a3)
{
  int v3; // r15d
  ...
  *(_DWORD *)v17 = a2;
  ...
  v8 = sub_140040DB8(a1, *(_DWORD *)v17, 0, (unsigned int)&P, (__int64)&v18);
  if ( v8 >= 0 )
  {
    if ( v18 )
    {
        ...
        if ( Pool2 )
        {
          ...
          *Pool2 = *((unsigned __int8 *)v9 + 8);
          ...
          if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
            sub_14000D03C((__int64)off_140018050->DeviceExtension, v13, v14, 0x16u, v16, (const char *)&v41);
        }
        else
        {
          v8 = -1073741670;
      ...
      {
        if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
          sub_140003BC4((__int64)off_140018050->DeviceExtension, 2u, 1u, 0x15u, (__int64)&unk_140012FE8, v17);
        v8 = -1073741275;
      }
    }
    else
    {
      if ( off_140018058 != (_UNKNOWN *)&off_140018058 )
        sub_140003BC4((__int64)off_140018050->DeviceExtension, 2u, 1u, 0x14u, (__int64)&unk_140012FE8, v17);
      v8 = -1073741275;
    }
  }
LABEL_12:
