/*
 * XREFs of sub_14003C3EC @ 0x14003C3EC
 * Callers:
...
__int64 __fastcall sub_14003C3EC(__int64 a1, _DWORD *a2, _BYTE *a3, _DWORD *a4, _BYTE *a5, _BYTE *a6)
{
  bool v9; // zf
  char v11; // cl
  int v12; // edi
  ...
  {
    v14 = v12;
    sub_1400050F8((__int64)off_140018050->DeviceExtension, 4u, 2u, 0x13u, (__int64)&unk_140014CC8, v14);
  }
