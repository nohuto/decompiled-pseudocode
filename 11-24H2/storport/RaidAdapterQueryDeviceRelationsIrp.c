/*
 * XREFs of RaidAdapterQueryDeviceRelationsIrp @ 0x140016D40
 * Callers:
...
__int64 __fastcall RaidAdapterQueryDeviceRelationsIrp(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_f9c5a744b2853f8434526ecbb453d058_Traceguids, a1, a2);
  }
  v5 = *(_QWORD *)(a2 + 184);
  v46 = 0LL;
  if ( *(_DWORD *)(v5 + 8) )
  {
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( (byte_140171462 & 0x20) != 0 )
        McTemplateK0pd_EtwWriteTransfer(v25, &EventPnpRequestComplete, &v49, a2, *(_DWORD *)(a2 + 48));
    }
  ...
  {
LABEL_5:
    v7 = RaidAdapterRescanBus(v6, &v45, &v41);
    if ( v7 < 0 )
      goto LABEL_7;
    goto LABEL_6;
  }
  v14 = StorAdapterNVMeEnumerateZNS(a1);
  if ( StorEtwLoggingEnabled )
  {
    v50 = 0LL;
    IoGetActivityIdIrp(a2, &v50);
    if ( (byte_140171463 & 0x40) != 0 )
      McTemplateK0pd_EtwWriteTransfer(v15, &EventNVMeEnumerate, &v50, a2, v14);
  }
  if ( v14 < 0 )
  {
    v6 = a1;
...
LABEL_6:
  v7 = RaidpBuildAdapterBusRelations(a1, &v46);
  v45 = v7;
LABEL_7:
  if ( v41 )
  {
    ...
    *(_QWORD *)(a1 + 4828) = 0LL;
    ...
    if ( v28 )
    {
      RaidAdapterAcquireStartIoLock(a1, &v47);
      v29 = RaidNtStatusToStorStatus(v45);
      v28(*(_QWORD *)(a1 + 616) + 16LL, v27, v44, v26, v29);
      RaidAdapterReleaseStartIoLock(a1, &v47);
    }
  }
  *(_QWORD *)(a2 + 56) = v46;
  *(_DWORD *)(a2 + 48) = v7;
  if ( v7 >= 0 )
  {
    if ( StorEtwLoggingEnabled )
    {
      ...
      IoGetActivityIdIrp(a2, &v49);
      if ( (byte_140171462 & 0x20) != 0 )
        McTemplateK0pd_EtwWriteTransfer(v12, &EventPnpRequestComplete, &v49, a2, v7);
    }
    v13 = *(_QWORD *)(a2 + 184);
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v17 )
          v2 = *v17;
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v9, v10, (unsigned int)&v49, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_13;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_34:
    McTemplateK0pd_EtwWriteTransfer(v9, v16, &v49, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_13;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_13;
...
LABEL_14:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 15LL, &WPP_f9c5a744b2853f8434526ecbb453d058_Traceguids, a1, a2, v7);
  }
