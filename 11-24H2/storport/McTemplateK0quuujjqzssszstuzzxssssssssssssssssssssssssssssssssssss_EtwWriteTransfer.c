/*
 * XREFs of McTemplateK0quuujjqzssszstuzzxssssssssssssssssssssssssssssssssssss_EtwWriteTransfer @ 0x1400ACDAC
 * Callers:
        ...
        const char *a57)
{
  ...
  int v337; // [rsp+410h] [rbp+308h] BYREF
  ...
  v225 = L"128us, 256us, 512us, 1ms, 4ms, 16ms, 64ms, 128ms, 256ms, 512ms, 1000ms, 2000ms, 10000ms, 10000+ms";
  v227 = &a21;
  v222 = 1LL;
  v224 = 86LL;
  v226 = 196LL;
