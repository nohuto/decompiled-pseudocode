/*
 * XREFs of StorpLogPhysicalTopologyInfo @ 0x1400B0FA0
 * Callers:
...
char __fastcall StorpLogPhysicalTopologyInfo(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 && tlgKeywordOn(v8, 0x400000000000LL) )
  {
    v55 = 16LL;
    v54 = a1 + 5064;
    ...
    v48 = v7;
    v62 = v12;
    tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_140160401, v14, v11, 7u, v53);
  }
              ...
              if ( (unsigned int)dword_140170178 > 5 )
              {
                ...
                if ( (_BYTE)v15 )
                {
                  ...
                  LOBYTE(v15) = tlgWriteTransfer_EtwWriteTransfer(
                                  (__int64)v81,
                                  (unsigned __int8 *)dword_140160361,
                                  v25,
                                  (__int64)v26,
                                  0xBu,
                                  v53);
              ...
              if ( (unsigned int)v15 <= (unsigned int)v4 )
              {
                for ( j = 0; j < v17[4]; ++j )
                {
                  ...
                  *(_OWORD *)v81 = v37;
                  if ( (unsigned int)dword_140170178 > 5 )
                  {
                    LOBYTE(v15) = tlgKeywordOn(v34, 0x400000000000LL);
                    if ( (_BYTE)v15 )
                    {
                      v55 = 16LL;
                      v54 = a1 + 5064;
                      ...
                      LOBYTE(v15) = tlgWriteTransfer_EtwWriteTransfer(
                                      (__int64)v81,
                                      (unsigned __int8 *)dword_14015EDAA,
                                      v38,
                                      v39,
                                      0xEu,
                                      v53);
