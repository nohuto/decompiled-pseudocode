/*
 * XREFs of NvmeNamespacePersistentReserveOutIoctl @ 0x14010575C
 * Callers:
...
LABEL_10:
  ...
  switch ( *(_BYTE *)(v2 + 8) & 0x1F )
  {
    ...
    case 3:
      v19 = 1LL;
LABEL_50:
      v17 = NvmeNamespaceReservationRelease(a1, v16, v7, v19);
      goto LABEL_55;
    case 4:
      v18 = 1LL;
      goto LABEL_52;
    case 5:
      v18 = 2LL;
LABEL_52:
      v17 = NvmeNamespaceReservationAcquire(a1, v16, v7, v18);
      goto LABEL_55;
    case 6:
      LOBYTE(v7) = 1;
LABEL_54:
      v17 = NvmeNamespaceReservationRegister(a1, v16, v7);
      goto LABEL_55;
  }
  if ( (*(_BYTE *)(v2 + 8) & 0x1F) != 7 )
    goto LABEL_10;
  v17 = NvmeNamespaceReservationRegisterAndMove(a1, v16, v7);
LABEL_55:
  v8 = v17;
LABEL_11:
...
LABEL_109:
    McTemplateK0pd_EtwWriteTransfer(v10, v20, &v43, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_110;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_110;
