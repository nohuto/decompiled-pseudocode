/*
 * XREFs of McTemplateK0qjzszhhssqtuuuq_EtwWriteTransfer @ 0x1400C2FBC
 * Callers:
        ...
        char a18)
{
  ...
  v67 = 1LL;
  v69 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v33, &EventMFNDSetOperationInformation, 0LL, 0x10u, &v35);
}
