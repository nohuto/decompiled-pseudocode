/*
 * XREFs of RaUnitQueryIdIrp @ 0x140186B14
 * Callers:
...
__int64 __fastcall RaUnitQueryIdIrp(__int64 a1, __int64 a2)
{
  ...
  if ( !v6 )
  {
    DeviceId = RaidUnitGetDeviceId(a1, &v37);
    goto LABEL_10;
  }
  v7 = v6 - 1;
  if ( !v7 )
  {
    DeviceId = RaidUnitGetHardwareIds(a1, &v37);
    goto LABEL_10;
  }
  v8 = v7 - 1;
  if ( !v8 )
  {
    DeviceId = RaidUnitGetCompatibleIds(a1, &v37);
    goto LABEL_10;
  }
  if ( v8 == 1 )
  {
    DeviceId = RaidUnitGetInstanceId(a1, &v37);
LABEL_10:
    v9 = DeviceId;
    goto LABEL_11;
  }
