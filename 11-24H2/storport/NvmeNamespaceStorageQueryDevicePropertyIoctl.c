/*
 * XREFs of NvmeNamespaceStorageQueryDevicePropertyIoctl @ 0x1401AE850
 * Callers:
...
__int64 __fastcall NvmeNamespaceStorageQueryDevicePropertyIoctl(__int64 a1, __int64 a2)
{
  ...
  int v6; // ecx
  __int64 v7; // rax
  int StorageDeviceProperty; // r14d
  bool v9; // zf
  ...
  {
    StorageDeviceProperty = NvmeNamespaceGetStorageDeviceProperty(a1, v4, &v34);
    v7 = v34;
