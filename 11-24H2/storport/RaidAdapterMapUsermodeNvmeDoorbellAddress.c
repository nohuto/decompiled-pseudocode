/*
 * XREFs of RaidAdapterMapUsermodeNvmeDoorbellAddress @ 0x14005C28C
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v14 < 0 )
  {
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      v16 = 32;
LABEL_11:
      WPP_SF_d((__int64)v15->AttachedDevice, v16, (__int64)&WPP_f9c5a744b2853f8434526ecbb453d058_Traceguids, v14);
      goto LABEL_31;
    }
    goto LABEL_31;
  }
