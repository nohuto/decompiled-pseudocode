/*
 * XREFs of RaInsertDFxQueue @ 0x14006C220
 * Callers:
...
LABEL_20:
  ...
  KeAcquireInStackQueuedSpinLock(RaidAdapter + 721, &LockHandle);
  v10 = (KSPIN_LOCK **)(RaidAdapter + 718);
  v11 = RaidAdapter[718];
  v12 = v5 + 1;
  if ( *(KSPIN_LOCK **)(v11 + 8) != RaidAdapter + 718 )
    goto LABEL_20;
  *v12 = v11;
  v5[2] = v10;
  *(_QWORD *)(v11 + 8) = v12;
  *v10 = v12;
  ++*((_DWORD *)RaidAdapter + 1440);
LABEL_22:
