/*
 * XREFs of McTemplateK0quuujjqzsssztuqquuuuuuqqi_EtwWriteTransfer @ 0x140023C2C
 * Callers:
        ...
        char a28)
{
  ...
  v99 = 4LL;
  v101 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v32, &EventUnitUniqueErrorData, 0LL, 26LL, v46);
}
