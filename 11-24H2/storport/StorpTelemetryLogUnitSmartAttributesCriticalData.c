/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1400B55D0
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v49 = 1LL;
      v51 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v52, *(const wchar_t **)(v2 + 4720));
      ...
      v102 = v11;
      v103 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_14016150D, v12, v8, 0x24u, &v39);
    }
  }
}
