/*
 * XREFs of RaidAdapterQueryBootLunsIoctl @ 0x14005D020
 * Callers:
...
__int64 __fastcall RaidAdapterQueryBootLunsIoctl(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 608) && *(_QWORD *)(a1 + 616) )
  {
    ...
    {
      v8 = RaBuildQueryBootLunsBufferForMiniport(a1, a2, &P, &v43);
      v7 = P;
      v9 = v8;
      if ( !v8 )
      {
        if ( P )
        {
          v9 = RaidAdapterSendSrbIoControlSynchronously(a1, (IRP *)a2, (unsigned int *)P, v43, 0LL, 0, 64, 0);
          if ( v9 >= 0 )
          {
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v37) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v14, v15, &v46, a2, v37, v38);
      }
      goto LABEL_83;
    }
...
LABEL_82:
    ...
    McTemplateK0pd_EtwWriteTransfer(v14, v17, &v46, a2, v37);
    goto LABEL_83;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_83;
...
LABEL_78:
      ...
      LOBYTE(v38) = v32;
      LODWORD(v37) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v18, &v46, a2, v37, v38, v39, v40, v3, v35, a2);
    }
  }
LABEL_83:
