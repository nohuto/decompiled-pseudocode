/*
 * XREFs of NvmeNamespaceDeleteDeviceIrp @ 0x1400FD7E8
 * Callers:
...
__int64 __fastcall NvmeNamespaceDeleteDeviceIrp(__int64 a1, __int64 a2, _BYTE *a3)
{
  int v3; // ebx
  ...
  {
    v7 = NvmeNamespaceWaitForRemoveLock(v35);
    v34 = v7;
  }
  StorpUninitializeNvmeNamespaceTelemetry(v35);
  NvmeControllerRemoveNvmeNamespaceFromList(*(_QWORD *)(a1 + 16), v35, 1);
  NvmeControllerDeleteNvmeNamespace(&v35);
