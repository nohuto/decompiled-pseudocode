/*
 * XREFs of McTemplateK0qjzsqhhsstttttq_EtwWriteTransfer @ 0x140139818
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzsqhhsstttttq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a18)
{
  ...
  v63 = 4LL;
  v65 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v29, a2, 0LL, 0x10u, &v32);
}
