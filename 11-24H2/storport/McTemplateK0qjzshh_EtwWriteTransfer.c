/*
 * XREFs of McTemplateK0qjzshh_EtwWriteTransfer @ 0x1400DDA3C
 * Callers:
        ...
        char a9)
{
  ...
  v24 = v10;
  v29 = &a9;
  return McGenEventWrite_EtwWriteTransfer((__int64)"NULL", &EventNVMeoFDisconnectDeleteQueue, 0LL, 7u, &v16);
}
