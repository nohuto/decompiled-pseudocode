/*
 * XREFs of NvmeNamespaceStorageQueryDeviceTrimPropertyIoctl @ 0x1401AEFF4
 * Callers:
...
__int64 __fastcall NvmeNamespaceStorageQueryDeviceTrimPropertyIoctl(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rsi
  int v3; // ebx
  __int64 v4; // rax
  ...
  if ( !v7 )
  {
    ...
    if ( v8 >= 0xC )
    {
      ...
      *v2 = 12;
      v2[1] = 12;
      *((_BYTE *)v2 + 8) = NvmeNamespaceIsDeallocateSupported(a1);
      *(_QWORD *)(a2 + 56) = 12LL;
    }
    else
    {
...
LABEL_71:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v11, v15, &v37, a2, *(_DWORD *)(a2 + 48), v27, v16, v19, v3, v30, a2);
    }
  }
LABEL_76:
