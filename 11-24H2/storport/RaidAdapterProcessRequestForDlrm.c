/*
 * XREFs of RaidAdapterProcessRequestForDlrm @ 0x14005CEC0
 * Callers:
...
void __fastcall RaidAdapterProcessRequestForDlrm(__int64 a1, __int64 a2)
{
  __int64 v2; // r10
  __int64 v3; // rdx
  _BYTE *v4; // r9
...
LABEL_27:
  ...
  {
    if ( v7 )
      DlrmProcessReadWriteRequest(v2, v7);
  }
}
