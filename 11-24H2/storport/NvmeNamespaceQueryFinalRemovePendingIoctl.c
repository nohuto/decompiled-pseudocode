/*
 * XREFs of NvmeNamespaceQueryFinalRemovePendingIoctl @ 0x140108944
 * Callers:
          ...
          if ( *(_BYTE *)(v48 + 1) == 7 && !*(_DWORD *)(v48 + 8) )
          {
            if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              if ( v49 )
                ...
                v50 = 0LL;
              McTemplateK0pqd_EtwWriteTransfer(v50, v48, &v91, a2, v50, *(_DWORD *)(a2 + 48));
            }
            goto LABEL_201;
          }
...
LABEL_201:
      ...
      McTemplateK0pd_EtwWriteTransfer(v47, v51, &v91, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_201;
    }
    v4 = StorEtwLoggingEnabled == 0;
    v5 = -1073741789;
  ...
  *(_BYTE *)(a2 + 141) = -84;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      ...
      v9 = (const GUID *)&v89;
LABEL_12:
      McTemplateK0pqd_EtwWriteTransfer(v6, v7, v9, a2, v2, *(_DWORD *)(a2 + 48));
      goto LABEL_202;
    }
    if ( (byte_140171462 & 0x20) == 0 )
      goto LABEL_202;
...
LABEL_135:
    McTemplateK0pd_EtwWriteTransfer(v6, v11, v10, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_202;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_202;
