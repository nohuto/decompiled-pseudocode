/*
 * XREFs of StorSetMFNDChildPFSettings @ 0x14019204C
 * Callers:
 ...
 *     StorBuildMFNDManagementCommand @ 0x1400C3744 (StorBuildMFNDManagementCommand.c)
...
__int64 __fastcall StorSetMFNDChildPFSettings(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  _OWORD v18[7]; // [rsp+60h] [rbp-19h] BYREF
    ...
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 6160) + 36LL) == 1 )
    {
      if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 0x88u )
      {
          ...
          && ((v10 & 2) == 0 || (unsigned int)(*(_DWORD *)(*(_QWORD *)(a2 + 24) + 60LL) - 1) <= 2) )
        {
          ...
          {
            StorGetAndLogMFNDQoSStatistics(a1, 1, 3, 1u, (unsigned __int16 *)(*(_QWORD *)(a2 + 24) + 16LL));
          }
          v7 = 1;
          ...
          if ( v19 >= 0 )
          {
            ...
            if ( Pool )
            {
              ...
              {
                *(_WORD *)Pool |= 1u;
                *(_WORD *)(Pool + 2) = *(_WORD *)(v6 + 22);
                *(_WORD *)(Pool + 4) = *(_WORD *)(v6 + 24);
                *(_BYTE *)(Pool + 6) = *(_BYTE *)(v6 + 26);
                *(_WORD *)(Pool + 8) = *(_WORD *)(v6 + 32);
                *(_WORD *)(Pool + 10) = *(_WORD *)(v6 + 36);
                *(_WORD *)(Pool + 12) = *(_WORD *)(v6 + 40);
                *(_WORD *)(Pool + 14) = *(_WORD *)(v6 + 44);
              }
              if ( (*(_BYTE *)(v6 + 20) & 2) != 0 )
              {
                *(_WORD *)Pool |= 2u;
              ...
              StorBuildMFNDManagementCommand((__int64)v18, 0, *(unsigned __int16 *)(v6 + 8), 0, 0x80u);
              v19 = StorSendMFNDCommand(
                      a1,
                      (void *)v12,
                      0LL,
                      0x80u,
