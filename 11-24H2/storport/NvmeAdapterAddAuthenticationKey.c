/*
 * XREFs of NvmeAdapterAddAuthenticationKey @ 0x140192B98
 * Callers:
      ...
      if ( *(_DWORD *)(v2 + 8) >= 0x210u )
      {
        if ( (*(_DWORD *)(v5 + 4) & 1) != 0 || (NvmeHostNQN = GetNvmeHostNQN(0, (char *)(v5 + 16)), NvmeHostNQN >= 0) )
        {
          ...
          if ( NvmeHostNQN >= 0 )
          {
            ...
            PopulateNvmeAuthenticationKeyInfo(v36, (__int64)v7);
            *(_QWORD *)(a2 + 56) = 528LL;
          }
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(Src) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v9, v10, &v37, a2, Src, v33);
      }
      goto LABEL_84;
    }
...
LABEL_83:
    ...
    McTemplateK0pd_EtwWriteTransfer(v9, v12, &v37, a2, Src);
    goto LABEL_84;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_84;
...
LABEL_79:
      ...
      LODWORD(Src) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v37, a2, Src, v33, v14, v17, v3, v30, a2);
    }
  }
LABEL_84:
