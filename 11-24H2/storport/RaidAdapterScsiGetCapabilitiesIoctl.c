/*
 * XREFs of RaidAdapterScsiGetCapabilitiesIoctl @ 0x14005EB90
 * Callers:
      ...
      if ( *(_BYTE *)(v29 + 1) == 7 && !*(_DWORD *)(v29 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          if ( v30 )
            ...
            v31 = 0LL;
          McTemplateK0pqd_EtwWriteTransfer(v31, v29, &v62, a2, v31, *(_DWORD *)(a2 + 48));
        }
        goto LABEL_134;
      }
...
LABEL_133:
      McTemplateK0pd_EtwWriteTransfer(v28, v32, &v62, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_134;
    }
    if ( byte_140171461 >= 0 )
      goto LABEL_134;
...
LABEL_127:
    if ( (_BYTE)v33 )
    {
      ...
      v52 = v39;
LABEL_130:
      McTemplateK0pduuuuup_EtwWriteTransfer(v52, v33, &v62, a2, *(_DWORD *)(a2 + 48), v47, v34, v37, v51, v52, a2);
      goto LABEL_134;
    }
LABEL_129:
    v37 = 0;
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v3 = *v9;
        McTemplateK0pqd_EtwWriteTransfer(v7, v8, &v61, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_135;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_14:
    McTemplateK0pd_EtwWriteTransfer(v7, v10, &v61, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_135;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_135;
...
LABEL_64:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v7, v11, &v61, a2, *(_DWORD *)(a2 + 48), v23, v12, v15, v3, v26, a2);
    }
  }
LABEL_66:
  v6 = -1073741789;
