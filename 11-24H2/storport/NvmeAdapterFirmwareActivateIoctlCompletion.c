/*
 * XREFs of NvmeAdapterFirmwareActivateIoctlCompletion @ 0x1400D0B30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_44:
  ...
  if ( (v64 & 0xE00) == 0 && (v64 & 0x1FE) == 0 )
  {
    ...
    {
      IoQueueWorkItemEx(*((PIO_WORKITEM *)Context + 166), NvmeAdapterFirmwareUpdateIdentifyWorker, v67, Context);
...
LABEL_105:
    ...
    *((_QWORD *)Context + 121) &= ~0x400uLL;
    v69 = (struct _IO_WORKITEM *)*((_QWORD *)Context + 166);
    ...
    *((_QWORD *)Context + 164) = a2;
    Context[1320] = 0;
    IoQueueWorkItemEx(v69, NvmeAdapterFirmwareActivateResetWorker, v67, Context + 1296);
    ...
    else
    {
      ...
      if ( (unsigned int)(unsigned __int8)v70 - 16 < 2 )
      {
        *((_QWORD *)Context + 121) |= 0x20uLL;
        v72 = (struct _IO_WORKITEM *)*((_QWORD *)Context + 166);
        *((_QWORD *)Context + 121) |= 0x800000uLL;
        *((_QWORD *)Context + 163) = NvmeAdapterFirmwareActivateAfterResetCallback;
        *((_QWORD *)Context + 162) = a2;
        *((_QWORD *)Context + 164) = a2;
        Context[1320] = v65 == 32;
        IoQueueWorkItemEx(v72, NvmeAdapterFirmwareActivateResetWorker, DelayedWorkQueue, Context + 1296);
        ...
        && (*((_QWORD *)Context + 121) & 0x10000LL) == 0 )
      {
        StorEtwNvmeControllerEvent(
          ...
          0);
        *((_QWORD *)Context + 121) |= 0x400uLL;
        v6 = NvmeAdapterFirmwareActivateIoctl(v7, (__int64)Context, v9, a2, 0LL);
        v10 = v6 >> 31;
        goto LABEL_120;
      }
    ...
    if ( *(_BYTE *)v74 != 15 )
    {
      ...
      if ( *(_BYTE *)(v74 + 1) == 7 && !*(_DWORD *)(v74 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          LODWORD(v94) = v3;
          McTemplateK0pqd_EtwWriteTransfer(12LL, v74, &v103, v9, v94, v95);
        }
        goto LABEL_186;
      }
...
LABEL_185:
      ...
      McTemplateK0pd_EtwWriteTransfer(v73, v76, &v103, v9, v94);
      goto LABEL_186;
    }
...
LABEL_182:
        ...
        LOBYTE(v95) = v89;
        LODWORD(v94) = *(_DWORD *)(v9 + 48);
        McTemplateK0pduuuuup_EtwWriteTransfer(v73, v77, &v103, v9, v94, v95, v96, v97, v98, v99, v9);
        goto LABEL_186;
      }
LABEL_181:
      v81 = 0;
