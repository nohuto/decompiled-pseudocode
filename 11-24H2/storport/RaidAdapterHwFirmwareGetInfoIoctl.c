/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x14000C1EC
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x14000CCA8 (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
...
__int64 __fastcall RaidAdapterHwFirmwareGetInfoIoctl(_QWORD *a1, __int64 a2)
{
  ...
  RaBuildHwFirmwareGetInfoBufferForMiniport(a1[1], a2, &P, &v38);
  v7 = P;
  if ( !P )
  {
  ...
  InfoFromMiniport = RaidAdapterHwFirmwareGetInfoFromMiniport(a1, a2, P, v38);
  ...
  if ( *(_BYTE *)v14 != 15 )
  {
    ...
    if ( *(_BYTE *)(v14 + 1) == 7 && !*(_DWORD *)(v14 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v17 )
          v3 = *v17;
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v13, v14, (unsigned int)&v41, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_16;
    }
