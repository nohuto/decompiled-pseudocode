/*
 * XREFs of RaidLunQueueCheckWaitTimeout @ 0x14006D2DC
 * Callers:
 ...
 *     RiRemoveSListEntry @ 0x14006D7EC (RiRemoveSListEntry.c)
 */
...
LABEL_4:
  ...
  while ( v10 != v4 )
  {
    ...
    *(_QWORD *)(v13 + 8) = v15;
    ...
    RiDecrementDeviceQueueCount(a1, v14);
    *(_BYTE *)(v14 + 20) &= ~1u;
    if ( (*(_BYTE *)(v14 + 20) & 4) != 0 )
    {
      v8 = a1 - 720;
