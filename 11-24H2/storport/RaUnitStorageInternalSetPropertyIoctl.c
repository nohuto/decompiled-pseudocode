/*
 * XREFs of RaUnitStorageInternalSetPropertyIoctl @ 0x140189B04
 * Callers:
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 8u )
  {
    ...
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( (byte_140171462 & 8) != 0 )
        McTemplateK0pd_EtwWriteTransfer(v28, &EventNonReadWriteRequestComplete, &v33, a2, *(_DWORD *)(a2 + 48));
    }
    ++*(_BYTE *)(a2 + 67);
    *(_QWORD *)(a2 + 184) += 72LL;
...
LABEL_62:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v33, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_67:
