/*
 * XREFs of NvmeControllerBuildIoPollingConfigurationCompletion @ 0x1400C8800
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    *(_WORD *)(*a2 + 4260) = *(_WORD *)(a3 + 14);
    ...
    if ( ((*(unsigned __int16 *)(v5 + 4260) >> 9) & 7) == 0 )
    {
      ...
      if ( (unsigned __int8)v6 <= 6u && !(_BYTE)v6 )
      {
        ...
        {
          *(_WORD *)(*(_QWORD *)(a1 + 1736) + 20LL) = *(_WORD *)v7;
          v8 = *(_QWORD *)(a1 + 1736);
          if ( *(_WORD *)(v8 + 20) >= 0x100u )
          {
            v9 = *(_WORD *)(v7 + 2);
            if ( *(_WORD *)(v7 + 2) > 0x64u )
              v9 = 100;
            *(_BYTE *)(v8 + 24) = v9;
            *(_DWORD *)(*(_QWORD *)(a1 + 1736) + 28LL) = *(_DWORD *)(v7 + 4);
            *(_DWORD *)(*(_QWORD *)(a1 + 1736) + 32LL) = *(_DWORD *)(v7 + 8);
            v10 = *(_BYTE **)(a1 + 1736);
            if ( v10[24] )
              *v10 = 1;
            v11 = *(_QWORD *)(a1 + 1736);
            if ( *(_WORD *)(v11 + 20) >= 0x101u )
            {
              *(_WORD *)(v11 + 36) = *(_WORD *)(v7 + 12);
              *(_WORD *)(*(_QWORD *)(a1 + 1736) + 38LL) = *(_WORD *)(v7 + 14);
            }
          }
        }
      }
