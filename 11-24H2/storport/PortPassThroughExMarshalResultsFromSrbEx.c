/*
 * XREFs of PortPassThroughExMarshalResultsFromSrbEx @ 0x1400325F8
 * Callers:
 *     PortpCompleteRequestIrp @ 0x140032324 (PortpCompleteRequestIrp.c)
 * Callees:
 *     PortPassThroughExApplyNormalizedRequest @ 0x14013AFF4 (PortPassThroughExApplyNormalizedRequest.c)
 *     PortPassThroughExNormalize @ 0x14013B0E4 (PortPassThroughExNormalize.c)
 *     memmove @ 0x140143780 (memmove.c)
 */

void __fastcall PortPassThroughExMarshalResultsFromSrbEx(PIRP Irp, __int64 a2, char a3, int *a4)
{
  _IRP *MasterIrp; // rax
...
LABEL_11:
        ...
        if ( v25 >= Length )
          v25 = Length;
        *((_QWORD *)a4 + 1) = v25;
        PortPassThroughExApplyNormalizedRequest(v12, Irp, v15, v17);
        goto LABEL_36;
      }
