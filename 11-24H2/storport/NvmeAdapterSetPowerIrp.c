/*
 * XREFs of NvmeAdapterSetPowerIrp @ 0x1401317A8
 * Callers:
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v11 )
          v4 = *v11;
        McTemplateK0pqd_EtwWriteTransfer(v9, v10, &v36, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
...
LABEL_64:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v36, a2, *(_DWORD *)(a2 + 48), v25, v14, v17, v4, v28, a2);
    }
  }
LABEL_69:
