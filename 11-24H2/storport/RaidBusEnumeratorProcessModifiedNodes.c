/*
 * XREFs of RaidBusEnumeratorProcessModifiedNodes @ 0x140056074
 * Callers:
 ...
 *     RaidUnitNotifyHardwareGone @ 0x14009FB30 (RaidUnitNotifyHardwareGone.c)
 */
...
__int64 __fastcall RaidBusEnumeratorProcessModifiedNodes(__int64 *a1, int a2, int a3)
{
  ...
  if ( *(_BYTE *)(v3 + 4370) && (v6 || v7) && (byte_140171466 & 1) != 0 )
