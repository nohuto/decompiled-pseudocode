/*
 * XREFs of StorpTelemetrySendUnitPauseRequestCounters @ 0x14005406C
 * Callers:
    ...
    || *(_DWORD *)(v2 + 5352) )
  {
    if ( (unsigned int)dword_140170178 > 5 )
    {
      if ( tlgKeywordOn(a1, 0x400000000000LL) )
      {
        ...
        v37 = &v15;
        v38 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)v6, (unsigned __int8 *)dword_14016277A, v4, v5, 0xDu, &v16);
      }
    }
    *(_QWORD *)(a1 + 2272) = 0LL;
    *(_DWORD *)(a1 + 2280) = 0;
