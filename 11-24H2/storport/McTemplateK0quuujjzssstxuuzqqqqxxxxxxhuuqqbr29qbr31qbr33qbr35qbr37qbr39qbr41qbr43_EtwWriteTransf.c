/*
 * XREFs of McTemplateK0quuujjzssstxuuzqqqqxxxxxxhuuqqbr29qbr31qbr33qbr35qbr37qbr39qbr41qbr43_EtwWriteTransfer @ 0x1400AE330
 * Callers:
        ...
        __int64 a48)
{
  ...
  int v170; // [rsp+380h] [rbp+278h] BYREF
  ...
  v166 = 4LL;
  v169 = 0;
  return McGenEventWrite_EtwWriteTransfer(v49, &EventUnitScsiDiagnostics, 0LL, 0x2Eu, &v66);
}
