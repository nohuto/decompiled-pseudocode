/*
 * XREFs of RaidAdapterScatterGatherExecuteBidirectionalRequest @ 0x140012F48
 * Callers:
...
__int64 __fastcall RaidAdapterScatterGatherExecuteBidirectionalRequest(__int64 a1, unsigned int *a2, __int64 a3)
{
  __int64 v3; // rdi
  __int64 v4; // rbx
  __int64 v5; // rsi
...
LABEL_12:
  ...
  result = RaidDmaBuildScatterGatherList((__int64 *)(a1 + 880), *(_QWORD *)(a1 + 8));
