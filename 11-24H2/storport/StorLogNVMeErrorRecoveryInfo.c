/*
 * XREFs of StorLogNVMeErrorRecoveryInfo @ 0x14008FB98
 * Callers:
...
__int16 __fastcall StorLogNVMeErrorRecoveryInfo(__int64 a1, __int64 a2)
{
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    v17 = 0;
    v18 = 0LL;
    LOWORD(v5) = RaidDriverGetName(v4, (__int64)&v14);
    ...
    if ( (byte_140171467 & 0x10) != 0 )
    {
      ...
      LOWORD(v5) = McTemplateK0qjzszhhssxqbr10_EtwWriteTransfer(
                     (__int64)v11,
                     v8,
                     v9,
                     *(_DWORD *)(v6 + 56),
