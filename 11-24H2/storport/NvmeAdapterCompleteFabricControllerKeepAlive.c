/*
 * XREFs of NvmeAdapterCompleteFabricControllerKeepAlive @ 0x1400DF620
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall NvmeAdapterCompleteFabricControllerKeepAlive(LARGE_INTEGER *a1, __int64 a2)
{
  _UNKNOWN **v2; // rax
  bool v4; // zf
...
LABEL_10:
  ...
  if ( v9 == 1 )
  {
    ...
    if ( (v10 & (unsigned __int8)v2) != 0 )
    {
      ...
      a1[136] = v11;
      LOBYTE(v2) = StorEtwNvmeControllerEvent(
                     (__int64)a1,
                     1,
                     4,
