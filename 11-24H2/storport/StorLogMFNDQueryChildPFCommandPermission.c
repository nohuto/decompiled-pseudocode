/*
 * XREFs of StorLogMFNDQueryChildPFCommandPermission @ 0x1400C5128
 * Callers:
...
__int16 __fastcall StorLogMFNDQueryChildPFCommandPermission(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v8; // xmm0
  __int64 v9; // rcx
  int v10; // eax
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( (byte_140171469 & 1) != 0 )
    {
      ...
      LOWORD(v10) = McTemplateK0qjzszhhssqqbr10uuq_EtwWriteTransfer(
                      v13,
