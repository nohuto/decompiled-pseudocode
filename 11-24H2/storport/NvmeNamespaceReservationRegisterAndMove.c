/*
 * XREFs of NvmeNamespaceReservationRegisterAndMove @ 0x14010C914
 * Callers:
...
__int64 __fastcall NvmeNamespaceReservationRegisterAndMove(__int64 a1, _BYTE *a2)
{
  ...
  v15 = 0LL;
  v5 = 0;
  ExtendedCommand = (_QWORD *)NvmeControllerGetExtendedCommand(v3);
  if ( ExtendedCommand )
  {
    v5 = 16;
    ...
    if ( DmaBuffer >= 0 )
    {
      ...
      *(_OWORD *)(*ExtendedCommand + 4160LL) = v15;
