/*
 * XREFs of RaUnitStorageQueryDeviceTemperaturePropertyIoctl @ 0x14009C17C
 * Callers:
...
LABEL_26:
  ...
  if ( v9 >= 0x28 )
  {
    ...
    if ( (*(_DWORD *)v12 & 0x20) == 0 )
      goto LABEL_21;
    v13 = RaBuildQueryTemperaturePropertyBufferForMiniport(*(_QWORD *)(a1 + 8), a2, &P, &v45);
    v7 = (unsigned int *)P;
    v10 = v13;
    if ( v13 < 0 )
      goto LABEL_22;
    v10 = RaidUnitSendSrbIoControlSynchronously(a1, a2, (__int64)P, v45, 0LL, 0, 64);
  ...
  if ( *(_BYTE *)v17 != 15 )
  {
    ...
    if ( *(_BYTE *)(v17 + 1) == 7 && !*(_DWORD *)(v17 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v40) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v16, v17, &v48, a2, v40, v41);
      }
      goto LABEL_96;
    }
...
LABEL_95:
    ...
    McTemplateK0pd_EtwWriteTransfer(v16, v20, &v48, a2, v40);
    goto LABEL_96;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_96;
...
LABEL_91:
      ...
      LOBYTE(v41) = v35;
      LODWORD(v40) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v16, v21, &v48, a2, v40, v41, v42, v25, v3, v38, a2);
    }
  }
LABEL_96:
