/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x14018C008
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x14018BF80 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1400A58A4 (wil_details_FeatureDescriptors_SkipPadding.c)
 *     __security_check_cookie @ 0x140143690 (__security_check_cookie.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x14018BCAC (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
