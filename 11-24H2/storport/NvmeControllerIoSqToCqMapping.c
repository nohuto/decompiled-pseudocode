/*
 * XREFs of NvmeControllerIoSqToCqMapping @ 0x1400F18F0
 * Callers:
 *     NvmeControllerInitPhase2 @ 0x1400EFCD4 (NvmeControllerInitPhase2.c)
 * Callees:
 *     RaidAllocatePool @ 0x14000E820 (RaidAllocatePool.c)
 *     NvmeControllerIoSqToCqMappingForHeteroPlatform @ 0x1400F1C60 (NvmeControllerIoSqToCqMappingForHeteroPlatform.c)
...
__int64 __fastcall NvmeControllerIoSqToCqMapping(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 1728) == 1 )
  {
    ...
    v9 = 4 * v8 + 8;
    Pool = (_DWORD *)RaidAllocatePool(256LL, v9, 1380147538LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL));
    v3 = Pool;
    if ( !Pool )
    ...
    {
      *Pool = 1;
      Pool[1] = *(unsigned __int16 *)(a1 + 26);
      if ( !(unsigned int)NvmeControllerQueryStorMQProperty(a1, 2147483656LL, v5) )
      {
  ...
  *v3 = 1;
  ...
  if ( (unsigned int)NvmeControllerQueryStorMQProperty(a1, 2147483655LL, v6) )
    goto LABEL_31;
...
LABEL_31:
  ...
  if ( *(_BYTE *)(a1 + 1728) == 1 )
    NvmeControllerSetStorMQProperty(a1, 2147483655LL, v6);
  if ( v3 )
