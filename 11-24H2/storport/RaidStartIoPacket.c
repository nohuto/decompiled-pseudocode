/*
 * XREFs of RaidStartIoPacket @ 0x140004760
 * Callers:
 ...
 *     RaidNotifyPerProcessorCompletions @ 0x140044ED0 (RaidNotifyPerProcessorCompletions.c)
...
__int64 __fastcall RaidStartIoPacket(__int64 a1, __int64 a2, int a3)
{
  ...
  char v142; // dl
  bool v143; // zf
  char v144; // [rsp+48h] [rbp-81h]
  char v145; // [rsp+60h] [rbp-69h]
  char v146; // [rsp+60h] [rbp-69h]
  unsigned __int64 v148; // [rsp+68h] [rbp-61h]
  unsigned __int64 v149; // [rsp+68h] [rbp-61h]
  KIRQL v151; // [rsp+78h] [rbp-51h]
  struct _PROCESSOR_NUMBER ProcNumber; // [rsp+7Ch] [rbp-4Dh] BYREF
  int v153; // [rsp+80h] [rbp-49h]
  int v154; // [rsp+84h] [rbp-45h] BYREF
  int v155; // [rsp+88h] [rbp-41h] BYREF
  signed __int32 v156; // [rsp+8Ch] [rbp-3Dh]
  __int64 v157; // [rsp+90h] [rbp-39h]
  __int64 v158; // [rsp+98h] [rbp-31h] BYREF
  __int128 v159; // [rsp+A0h] [rbp-29h] BYREF
  __int64 v160; // [rsp+B0h] [rbp-19h]
  int v161; // [rsp+B8h] [rbp-11h]
  struct _KLOCK_QUEUE_HANDLE LockHandle; // [rsp+C0h] [rbp-9h] BYREF
  __int128 v163; // [rsp+D8h] [rbp+Fh] BYREF
...
LABEL_67:
        ...
        *(_BYTE *)(v7 + 3) = v37;
        v111 = StorEtwLoggingEnabled == 0;
        *(_BYTE *)(v6 + 141) = -84;
        *(_DWORD *)(v6 + 48) = -1073740534;
        if ( v111 )
          goto LABEL_130;
        v163 = 0LL;
        IoGetActivityIdIrp(v6, &v163);
        v40 = *(char **)(v6 + 184);
        v41 = *v40;
        if ( *v40 != 15 )
        {
          if ( v41 == 14 )
          {
            if ( (byte_140171462 & 8) != 0 )
              McTemplateK0pd_EtwWriteTransfer(v39, &EventNonReadWriteRequestComplete, &v163, v6, *(_DWORD *)(v6 + 48));
          }
          else if ( v41 == 27 )
          {
            if ( v40[1] != 7 || *((_DWORD *)v40 + 2) )
            {
              if ( (byte_140171462 & 0x20) != 0 )
                McTemplateK0pd_EtwWriteTransfer(v39, &EventPnpRequestComplete, &v163, v6, *(_DWORD *)(v6 + 48));
            }
            else if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              if ( v42 )
                v3 = *v42;
              McTemplateK0pqd_EtwWriteTransfer(v39, (_DWORD)v40, (unsigned int)&v163, v6, v3, *(_DWORD *)(v6 + 48));
            }
          }
          goto LABEL_130;
        }
...
LABEL_176:
  ...
  LbaFromCdb = PortSrbGetLbaFromCdb(v69, v79);
  v6 = a2;
  ZoneIndexFromUnitAndLba = (unsigned int)GetZoneIndexFromUnitAndLba(a1, LbaFromCdb);
  if ( (unsigned __int8)RaidUpdateZoneIoReceiveWithStatus(a1 + 720, a2) || v156 )
  {
    v109 = a3 | 0x20;
    a3 |= 0x20u;
    goto LABEL_222;
  }
  RtlInterlockedSetBitRun(a1 + 3448, (unsigned int)ZoneIndexFromUnitAndLba, 1LL);
...
LABEL_206:
  ...
  v104 = *(_QWORD *)(a1 + 24);
  v105 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 3440) + ZoneIndexFromUnitAndLba);
  if ( v104 )
  {
    if ( *(_DWORD *)v104 != 1314275652 )
    {
      ...
      if ( v106 )
      {
        ...
        if ( v107 )
        {
          ...
          *(_QWORD *)(v108 + 8) = v103;
          *(_QWORD *)(v108 + 16) = ZoneIndexFromUnitAndLba;
          *(_QWORD *)(v108 + 24) = v105;
          *(_QWORD *)(v108 + 32) = 1LL;
        }
      }
  ...
  if ( v110 != 8 )
  {
    switch ( v110 )
    {
      ...
      case 37:
        goto LABEL_230;
      case 16:
        v111 = (unsigned __int8)RaidAdapterSupportsAbortCommand(*(_QWORD *)(a1 + 24)) == 0;
        goto LABEL_229;
      default:
        goto LABEL_231;
    }
...
LABEL_233:
    if ( KeGetCurrentIrql() >= 2u || *(char *)(a1 + 504) < 0 || (v112 = 1LL, (*(_BYTE *)(a1 + 505) & 1) != 0) )
      v112 = 2LL;
    RaidUnitStartDeviceBusy(a1, v6, v112);
  }
  if ( v145 )
  {
    v113 = 0LL;
    ...
    {
      Pool = (_DWORD *)RaidAllocatePool(64LL, 56LL, 1413701970LL, *(_QWORD *)(a1 + 8));
      v113 = Pool;
      if ( Pool )
      {
        *Pool = 300819165;
  ...
  v151 = KfRaiseIrql(2u);
  v116 = a2;
  v118 = RaidNotifyPerProcessorCompletions(*(_QWORD *)(a1 + 24), &ProcNumber);
  v146 = v118;
  v119 = v163;
  *(_BYTE *)(a2 + 141) = -87;
  *(_QWORD *)(v119 + 32) = a1;
  ...
  inserted = RaidInsertDeviceQueue((int)a1 + 720, v116, a3, v117, v3, (__int64)&v158, (__int64)&v155, (__int64)&v154);
  if ( !inserted )
    goto LABEL_311;
  if ( (_BYTE)v3 )
    ++*(_QWORD *)(a1 + 2096);
...
LABEL_311:
  if ( (a3 & 8) == 0
    && *(_BYTE *)(a1 + 759)
    && !(unsigned __int8)RaidUnitIsRegisteredForIdleDetection(a1)
    && (*(_DWORD *)(a1 + 512) & 0x70) == 0 )
  {
  ...
  {
    *(_BYTE *)(a2 + 141) = -88;
    if ( (unsigned __int8)StorSubmitIoGatewayItem(*(_QWORD *)(a1 + 728), a2 + 120, &v159) )
    {
      v141 = *(_QWORD *)(a1 + 728);
      v142 = *(_BYTE *)(*(_QWORD *)(v141 + 48) + 112LL);
      if ( FeatureFixKcsanRacyAccessV2 )
      {
        if ( (v142 & 4) == 0 || *(_DWORD *)(v141 + 40) != 1699901262 || !*(_DWORD *)(v141 + 24) )
          goto LABEL_333;
        v143 = *(_DWORD *)(v141 + 192) == 0;
      }
      else
      {
        if ( (v142 & 4) == 0 || *(_DWORD *)(v141 + 40) != 1699901262 || !*(_DWORD *)(v141 + 24) )
      ...
      {
        *(_DWORD *)(v141 + 40) = 0;
        RaidAdapterRestartGateway((PKSPIN_LOCK)v141);
      }
    }
    else
    {
      ...
      v140 = *(_QWORD *)(a1 + 704);
      if ( (char *)v139 == (char *)RaUnitStartIo )
        RaUnitStartIo(v140, a2, &v159, 0LL);
      else
        v139(v140, a2, &v159, 0LL);
      v125 = 1;
    }
  }
LABEL_333:
