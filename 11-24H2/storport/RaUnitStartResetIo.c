/*
 * XREFs of RaUnitStartResetIo @ 0x14009942C
 * Callers:
...
void __fastcall RaUnitStartResetIo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&v137.Data1 = v3;
  ...
  v9 = *(_QWORD *)(v5 + 8);
  v133 = v9;
  v11 = RaUnitCheckRemoveState(v3, a2);
  if ( v11 >= 0 )
  {
    v11 = RaUnitAcquireRemoveLock(v3, v10, 1);
    if ( v11 >= 0 )
    {
      v11 = RaidUnitClaimIrp(v3, a2, 0LL, a3);
      if ( v11 < 0 )
      {
...
LABEL_25:
        ...
        if ( (_BYTE)v25 == 40 )
          v25 = *(_DWORD *)(v19 + 20);
        if ( v25 == 16 && (unsigned int)dword_140170178 > 5 && tlgKeywordOn(v12, 0x400000000000LL) )
        {
          v141 = 16LL;
          v140 = v8 + 5064;
          v143 = 16LL;
          ...
          v149 = 1LL;
          v151 = 1LL;
          tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_14015E815, v13, v27, 8u, &v139);
        }
        *(_QWORD *)(v18 + 656) = RaidUnitCompleteResetRequest;
        if ( *(_BYTE *)(v8 + 4370) )
        {
          v28 = *(_QWORD *)(v18 + 168);
          if ( *(_BYTE *)(v28 + 2) == 40 )
          ...
          else
          {
            if ( *(_QWORD *)(v18 + 136) )
            {
              v30 = RaidAdapterScatterGatherExecuteBidirectionalRequest(v8, (unsigned int *)v18, v13);
              goto LABEL_57;
            }
            if ( (v29 & 0xC0) != 0 )
            {
              v30 = RaidAdapterScatterGatherExecute(v8, v18, v13);
              goto LABEL_57;
            }
          }
        }
        v30 = RaidAdapterPostScatterGatherExecute(v8, v18);
LABEL_57:
        if ( v30 >= 0 )
          return;
        v11 = v30;
...
LABEL_107:
          v73 = v132;
          StorUnmapSenseInfo(v46, *(_QWORD *)(*(_QWORD *)(v132 + 24) + 8LL));
...
LABEL_180:
            ...
            {
LABEL_110:
              RaidReleaseNvmeIceKeyResources(v73, v75);
              goto LABEL_119;
            }
          }
          RaidAdapterReleaseCryptoKeyResources(v74, v75);
          goto LABEL_119;
        }
...
LABEL_104:
            if ( StorEtwLoggingEnabled )
            {
              ...
              if ( byte_140171462 < 0 )
                McTemplateK0dud_EtwWriteTransfer(v71, v70, (__int64)&v138, v72, 4);
            }
            goto LABEL_107;
          }
...
LABEL_181:
  *(_QWORD *)(a2 + 56) = 0LL;
  *(_BYTE *)(v9 + 3) = RaidNtStatusToSrbStatus(v11);
  ...
  *(_QWORD *)(v101 + 16) = 0LL;
  v103 = *(_QWORD *)(v3 + 24);
  if ( (v102 & 1) != 0 && RaidUnitCheckAndAcquirePoFx(v3) )
  {
  ...
  if ( v102 >= 2u && *(_QWORD *)(v103 + 4960) )
    RaidAdapterPoFxIdleComponent(v103, 0LL, 0LL);
  v45 = StorEtwLoggingEnabled == 0;
  *(_BYTE *)(a2 + 141) = -84;
  *(_DWORD *)(a2 + 48) = v11;
  if ( v45 )
    goto LABEL_256;
  ...
  if ( *(_BYTE *)v105 == 14 )
  {
    if ( (byte_140171462 & 8) == 0 )
      goto LABEL_256;
    v107 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
    goto LABEL_255;
  }
  if ( *(_BYTE *)v105 != 15 )
  {
    ...
    if ( *(_BYTE *)(v105 + 1) == 7 && !*(_DWORD *)(v105 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v127) = *(_DWORD *)(a2 + 48);
        v126[0] = v4;
        McTemplateK0pqd_EtwWriteTransfer(v104, v105, &v137, a2, *(_QWORD *)v126, v127);
      }
      goto LABEL_256;
    }
    if ( (byte_140171462 & 0x20) == 0 )
      goto LABEL_256;
    v107 = &EventPnpRequestComplete;
LABEL_255:
    v126[0] = *(_DWORD *)(a2 + 48);
    McTemplateK0pd_EtwWriteTransfer(v104, v107, &v137, a2, *(_QWORD *)v126);
    goto LABEL_256;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_256;
...
LABEL_251:
      ...
      v126[0] = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v104, v108, &v137, a2, *(_QWORD *)v126, v127, v110, v113, v4, v125, a2);
    }
  }
LABEL_256:
