/*
 * XREFs of NvmeAdapterStorageInternalQueryPropertyIoctl @ 0x1400D99FC
 * Callers:
...
LABEL_54:
    ...
    if ( v14[1] == 7 && !*((_DWORD *)v14 + 2) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v29 )
          v3 = *v29;
        McTemplateK0pqd_EtwWriteTransfer(v13, (__int64)v14, &v48, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_117;
    }
    ...
    v39 = *(_DWORD *)(a2 + 48);
LABEL_116:
    McTemplateK0pd_EtwWriteTransfer(v13, v28, &v48, a2, v39);
    goto LABEL_117;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_117;
...
LABEL_111:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v13, v16, &v48, a2, *(_DWORD *)(a2 + 48), v34, v17, v20, v3, v37, a2);
    }
  }
LABEL_117:
