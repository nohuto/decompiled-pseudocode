/*
 * XREFs of RaUnitStorageQueryDeviceSelfEncryptionPropertyIoctl @ 0x140030E98
 * Callers:
  ...
  if ( !v7 )
  {
    ...
    else
    {
      if ( (unsigned int)v8 >= 0x10 )
      {
        ...
        *v2 = 16;
        v2[1] = 16;
        if ( TcgProperties >= 0 && **(_DWORD **)(a1 + 3592) == 512 )
        {
          v2[3] = 2;
          v29 = 1;
        }
  ...
  *(_DWORD *)(a2 + 48) = v9;
  ...
  if ( *(_BYTE *)v12 == 14 )
  {
    if ( (byte_140171462 & 8) != 0 )
      McTemplateK0pd_EtwWriteTransfer(v11, &EventNonReadWriteRequestComplete, &v38, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_8;
  }
  if ( *(_BYTE *)v12 != 15 )
  {
    if ( *(_BYTE *)v12 == 27 )
    {
      if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          if ( v15 )
            v3 = *v15;
          McTemplateK0pqd_EtwWriteTransfer((_DWORD)v11, v12, (unsigned int)&v38, a2, v3, *(_DWORD *)(a2 + 48));
        }
      }
      else if ( (byte_140171462 & 0x20) != 0 )
      {
        McTemplateK0pd_EtwWriteTransfer(v11, &EventPnpRequestComplete, &v38, a2, *(_DWORD *)(a2 + 48));
      }
    }
    goto LABEL_8;
  }
