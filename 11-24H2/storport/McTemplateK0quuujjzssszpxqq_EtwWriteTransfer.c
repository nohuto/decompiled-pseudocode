/*
 * XREFs of McTemplateK0quuujjzssszpxqq_EtwWriteTransfer @ 0x140087180
 * Callers:
        ...
        char a18)
{
  ...
  v68 = 4LL;
  v70 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v21, &EventNVMeLockPhysicalAddress, 0LL, 0x10u, &v35);
}
