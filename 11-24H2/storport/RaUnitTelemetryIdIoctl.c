/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x14003A938
 * Callers:
  ...
  if ( *(_DWORD *)(v2 + 16) >= 0x28u )
  {
    if ( (unsigned int)v6 >= 0x28 )
    {
      if ( *(_DWORD *)v5 == 40 && *(_DWORD *)(v5 + 4) == 40 )
      {
        ...
        *(_QWORD *)(a2 + 56) = 40LL;
        if ( (unsigned int)dword_140170178 > 5 && (unsigned __int8)tlgKeywordOn(v6, 0x400000000000LL) )
        {
          v57 = *(_QWORD *)(v55 + 24);
          v114 = 16LL;
          v115 = v56;
          ...
          v122 = 1LL;
          v124 = 1LL;
          tlgWriteTransfer_EtwWriteTransfer(v57, (unsigned __int8 *)dword_14015E6D3, v54, v55, 8u, &v112);
        }
          ...
          case 0x1B:
            if ( *(_BYTE *)(v59 + 1) == 7 && !*(_DWORD *)(v59 + 8) )
            {
              if ( (byte_140171462 & 0x40) != 0 )
              {
                ...
                if ( v60 )
                  v53 = *v60;
                McTemplateK0pqd_EtwWriteTransfer((_DWORD)v58, v59, (unsigned int)&v110, a2, v53, *(_DWORD *)(a2 + 48));
              }
              goto LABEL_209;
            }
...
LABEL_209:
        ...
        McTemplateK0pd_EtwWriteTransfer(v58, v61, &v110, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_209;
      }
      LOBYTE(v80) = 0;
      *(_BYTE *)(a2 + 141) = -84;
      ...
      if ( !v8 )
      {
        ...
        if ( *(_BYTE *)v82 != 15 )
        {
          if ( *(_BYTE *)v82 == 27 )
          {
            ...
            {
              if ( (byte_140171462 & 0x20) != 0 )
                McTemplateK0pd_EtwWriteTransfer(v81, &EventPnpRequestComplete, &v110, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              if ( v83 )
                v80 = *v83;
              McTemplateK0pqd_EtwWriteTransfer((_DWORD)v81, v82, (unsigned int)&v110, a2, v80, *(_DWORD *)(a2 + 48));
            }
          }
          goto LABEL_275;
        }
...
LABEL_132:
      ...
      if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
      {
        ...
        v12 = &v110;
LABEL_12:
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v9, v10, (_DWORD)v12, a2, v7, *(_DWORD *)(a2 + 48));
        goto LABEL_137;
      }
      if ( (byte_140171462 & 0x20) == 0 )
        goto LABEL_137;
      v13 = &v110;
LABEL_15:
      McTemplateK0pd_EtwWriteTransfer(v9, &EventPnpRequestComplete, v13, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_137;
    }
    if ( (byte_140171462 & 8) == 0 )
      goto LABEL_137;
    ...
    v102 = *(_DWORD *)(a2 + 48);
LABEL_136:
    McTemplateK0pd_EtwWriteTransfer(v9, &EventNonReadWriteRequestComplete, v32, a2, v102);
    goto LABEL_137;
  }
  LOBYTE(v7) = 0;
  *(_BYTE *)(a2 + 141) = -84;
