/*
 * XREFs of RaidUnitSetDevicePowerCompletionRoutine @ 0x1400790A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_71:
                    ...
                    McTemplateK0pduuuuup_EtwWriteTransfer(v10, v14, &v41, Context, v34, v27, v15, v18, v7, v30, Context);
                  }
                }
LABEL_73:
                v9 = Status;
      ...
      if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          if ( v12 )
            v7 = *v12;
          LODWORD(v34) = v7;
          McTemplateK0pqd_EtwWriteTransfer(v10, v11, &v41, Context, v34, *((_DWORD *)Context + 12));
        }
        break;
      }
...
LABEL_20:
        LODWORD(v34) = *((_DWORD *)Context + 12);
        McTemplateK0pd_EtwWriteTransfer(v10, v13, &v41, Context, v34);
      }
      break;
  }
LABEL_74:
