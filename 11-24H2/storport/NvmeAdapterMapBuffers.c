/*
 * XREFs of NvmeAdapterMapBuffers @ 0x1400D3F6C
 * Callers:
 ...
 *     IsPhysicalStorageController @ 0x14002AB20 (IsPhysicalStorageController.c)
 */
...
LABEL_34:
  ...
  if ( v18 && (v7 || *(_QWORD *)(a2 + 8)) )
  {
    ...
    {
      v30 = 0LL;
      LODWORD(v21) = RaidGetSystemAddressForMdl(*(_QWORD *)(a2 + 8), v7, *(_BYTE *)(a2 + 64) != 0 ? 16 : 32, &v30);
      if ( (int)v21 >= 0 )
        *(_QWORD *)(v5 + 64) = v30;
    }
