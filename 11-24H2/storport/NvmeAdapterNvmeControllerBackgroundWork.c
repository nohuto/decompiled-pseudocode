/*
 * XREFs of NvmeAdapterNvmeControllerBackgroundWork @ 0x1400E4750
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 != 1 )
  {
    ...
    while ( 1 )
    {
      *((_QWORD *)Context + 17) = v2 & 0xFFFFFFFDFFFFFFFFuLL;
      v18 = NvmeAdapterPerformFabricControllerDiscovery(Context, &v20);
...
LABEL_46:
  ...
  else if ( (*((_DWORD *)Context + 268) & 2) != 0 )
  {
    ...
    for ( j = 0; j < *((unsigned __int16 *)Context + 12); ++j )
    {
      ...
      if ( !(_DWORD)v13 )
        break;
      NvmeAdapterFabricControllerUpdateNamespace((__int64)Context, v13, &v21);
