/*
 * XREFs of StorpTelemetrySendUnitNvmeHealthInfo @ 0x140039030
 * Callers:
...
void __fastcall StorpTelemetrySendUnitNvmeHealthInfo(__int64 a1)
{
  ...
  P = (PVOID)Pool;
  if ( Pool && (int)StorpTelemetryNvmeGetLogPage(*(PDEVICE_OBJECT *)(a1 + 8), 0x230u) >= 0 )
  {
    v33 = 216;
    v2 = Pool + 8 + *(unsigned int *)(Pool + 24);
    v37 = v2;
    v36 = *(_QWORD *)(v2 + 48);
    v35 = *(_QWORD *)(v2 + 56);
    v32 = *(_BYTE *)(a1 + 2124);
  ...
  {
    v38 = (_WORD *)RaidAllocatePool(256LL, 560LL, 1700028754LL, *(_QWORD *)(a1 + 8));
    if ( v38 )
    {
      LogPage = StorpTelemetryNvmeGetLogPage(*(PDEVICE_OBJECT *)(a1 + 8), 0x230u);
      if ( LogPage < 0 )
      {
...
LABEL_17:
  if ( v2 || v3 )
  {
    ...
    if ( v10 )
    {
      for ( i = 0; i < g_RaidNumberProcessors; v12 += *(_QWORD *)(v15 + v10 + 24) )
      {
        v14 = i++;
        v15 = dword_140170E50 * v14;
    ...
    *(_QWORD *)(a1 + 3344) = v12;
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(a1 + 506) & 2) != 0 )
        g_StorpTraceLoggingCriticalEventEnabled = -1;
      v20 = g_StorpTraceLoggingCriticalEventEnabled != 0;
    }
    ...
    if ( v20 )
    {
      ...
      if ( v22 )
        LODWORD(v24) = v22;
      StorpTelemetryNvmeHealthCriticalInfo(a1, (_DWORD)v24, v2, v33, v31, v5, v3, v4, v18, v19, v36, v35, v6, v34);
    }
    else
    {
      v23 = &unk_140151214;
      ...
      StorpTelemetryNvmeHealthInfo(a1, (_DWORD)v25, v2, v33, v31, v5, v3, v4, v18, v19, v36, v35, v6, v34);
    }
    if ( !*(_BYTE *)(a1 + 2125) || *(_BYTE *)(a1 + 2124) != v32 )
    {
      ...
      if ( v26 )
      {
        v27 = (const wchar_t *)(v26 + 90);
      }
      else
      {
        v28 = *(_QWORD *)(a1 + 152);
        if ( !v28
          || (v27 = (const wchar_t *)(v28 + 41),
              (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 608LL) + 184LL) & 0x40) == 0) )
        {
          v27 = 0LL;
        }
      }
