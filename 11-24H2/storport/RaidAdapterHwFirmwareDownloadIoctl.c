/*
 * XREFs of RaidAdapterHwFirmwareDownloadIoctl @ 0x14005AB44
 * Callers:
...
LABEL_7:
      ...
      InfoFromMiniport = RaidAdapterHwFirmwareGetInfoFromMiniport(a1, a2, (__int64)P, v38);
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v32) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v8, v9, &v41, a2, v32, v33);
      }
      goto LABEL_81;
    }
...
LABEL_80:
    ...
    McTemplateK0pd_EtwWriteTransfer(v8, v11, &v41, a2, v32);
    goto LABEL_81;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_81;
...
LABEL_76:
      ...
      LODWORD(v32) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v8, v12, &v41, a2, v32, v33, v34, v35, v2, v30, a2);
    }
  }
LABEL_81:
