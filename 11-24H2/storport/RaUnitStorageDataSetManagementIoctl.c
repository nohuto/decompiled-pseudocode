/*
 * XREFs of RaUnitStorageDataSetManagementIoctl @ 0x1401B63D0
 * Callers:
...
LABEL_11:
        v60 = 60;
        v13 = RaUnitBuildDsmGeneralBufferForMiniport(a1, a2, (__int64 *)&P, &v59);
        goto LABEL_12;
      }
    }
  ...
  v60 = 1;
  v13 = RaUnitBuildDsmNotifyBufferForMiniport(a1, a2, (__int64 *)&P, &v59);
LABEL_12:
  v14 = v13;
  if ( v13 >= 0 )
  {
    *((_DWORD *)P + 3) = v60;
    ...
    Srb = (unsigned int *)RaidAllocateSrb(*(_QWORD *)(a1 + 8), 2u, *(_BYTE *)v16, 0);
    if ( Srb )
    {
      v18 = 316LL;
      ...
      ContiguousIoResources = StorAllocateContiguousIoResources(
                                ((*(_DWORD *)((char *)v2 + v18) + 7) & 0xFFFFFFF8) + 1184,
                                v17,
                                v2);
      v62 = ContiguousIoResources;
      if ( ContiguousIoResources )
      {
        ...
        *(_QWORD *)(v22 + 224) = a1;
        ...
        if ( *(_BYTE *)(v19 + 4370) )
          v30 = RaidAdapterRaiseIrqlAndExecuteXrb(v19, (_QWORD *)v22);
        else
          v30 = RaidAdapterPostScatterGatherExecute(v19, v22);
        v14 = v30;
        if ( v30 >= 0 )
        {
        ...
        v2 = *(_QWORD **)&v63.Data1;
        StorFreeContiguousIoResources(*(__int64 *)&v63.Data1, v62);
      }
      else
      {
        v14 = -1073741670;
    ...
    if ( v33[1] == 7 && !*((_DWORD *)v33 + 2) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v37 )
          v3 = *v37;
        LODWORD(Timeout) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v32, (__int64)v33, &v63, a2, Timeout, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_44;
    }
...
LABEL_64:
    ...
    McTemplateK0pd_EtwWriteTransfer(v32, v36, &v63, a2, Timeout);
    goto LABEL_44;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_44;
...
LABEL_87:
      ...
      LODWORD(Timeout) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v32, v38, &v63, a2, Timeout, v55, v45, v40, v3, v44, a2);
    }
  }
LABEL_44:
