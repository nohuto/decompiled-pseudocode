/*
 * XREFs of RaUnitQueryDeviceTextIrp @ 0x140185CFC
 * Callers:
      ...
      case 0x1B:
        if ( *(_BYTE *)(v78 + 1) == 7 && !*(_DWORD *)(v78 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v79 )
              v3 = *v79;
            McTemplateK0pqd_EtwWriteTransfer(v77, v78, &v124, a2, v3, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_297;
        }
...
LABEL_297:
    ...
    McTemplateK0pd_EtwWriteTransfer(v77, v80, &v124, a2, v98);
    goto LABEL_297;
  }
...
LABEL_73:
        ...
        if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
        {
          ...
          v14 = &v124;
LABEL_18:
          McTemplateK0pqd_EtwWriteTransfer(v11, v12, v14, a2, v3, *(_DWORD *)(a2 + 48));
          goto LABEL_143;
        }
        if ( (byte_140171462 & 0x20) == 0 )
          goto LABEL_143;
...
LABEL_142:
        McTemplateK0pd_EtwWriteTransfer(v11, v16, v15, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_143;
      }
      if ( (byte_140171462 & 8) == 0 )
        goto LABEL_143;
  ...
  if ( !v5 )
  {
    ...
    StorGetIdentityVendorId((__int64 *)(a1 + 112), (__int64)v126);
    StorGetIdentityProductId(a1 + 112, (__int64)v127);
    if ( (*(_DWORD *)(*((_QWORD *)v7 + 29) + 184LL) & 0x10) == 0 )
    {
      if ( (*(_DWORD *)(a1 + 1952) & 0x20) != 0 )
      {
        RtlStringCchPrintfW(v9, 0x100uLL, L"NVMe %hs %hs Device", v127, "ZNSDisk");
      }
      else
      {
        DeviceType = (_QWORD *)PortGetDeviceType(**(_BYTE **)(a1 + 112) & 0x1F);
        RtlStringCchPrintfW(v9, 0x100uLL, L"%hs %hs SCSI %hs Device", v126, v127, *DeviceType);
      }
      goto LABEL_162;
    }
    v52 = *(_QWORD *)(a1 + 160);
    if ( v52 )
    {
      ...
      {
LABEL_153:
        RtlStringCchPrintfW(v9, 0x100uLL, L"%hs %hs", v53, v54);
        goto LABEL_162;
      }
      v55 = v54;
    }
    ...
    RtlStringCchPrintfW(v9, 0x100uLL, L"%hs", v55);
    goto LABEL_162;
  }
  if ( v5 == 1 )
  {
  ...
  if ( *(_BYTE *)v58 != 15 )
  {
    ...
    if ( *(_BYTE *)(v58 + 1) == 7 && !*(_DWORD *)(v58 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v97) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v57, v58, &v124, a2, v97, v99);
      }
      goto LABEL_230;
    }
    if ( (byte_140171462 & 0x20) == 0 )
    ...
    LODWORD(v97) = *(_DWORD *)(a2 + 48);
LABEL_229:
    McTemplateK0pd_EtwWriteTransfer(v57, v60, &v124, a2, v97);
    goto LABEL_230;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_230;
...
LABEL_225:
      ...
      LOBYTE(v99) = v73;
      LODWORD(v97) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v57, v61, &v124, a2, v97, v99, v62, v65, v3, v76, a2);
    }
  }
LABEL_230:
  IofCompleteRequest((PIRP)a2, 0);
