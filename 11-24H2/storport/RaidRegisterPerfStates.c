/*
 * XREFs of RaidRegisterPerfStates @ 0x1400415CC
 * Callers:
...
LABEL_72:
    ...
    if ( RaidAdapter )
    {
      *(_QWORD *)(*((_QWORD *)RaidAdapter + 620) + 112LL) = v10;
      *(_DWORD *)(*((_QWORD *)RaidAdapter + 620) + 104LL) = *v55;
      *a6 = *(_QWORD *)(*((_QWORD *)RaidAdapter + 620) + 112LL);
      v53 = *(_DWORD *)(*((_QWORD *)RaidAdapter + 620) + 104LL);
      goto LABEL_72;
    }
LABEL_73:
    v35 = -1073741823;
