/*
 * XREFs of McTemplateK0qjzszhhsshhuuuuuq_EtwWriteTransfer @ 0x1400C1D30
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzszhhsshhuuuuuq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a20)
{
  ...
  v65 = 2LL;
  v77 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v35, a2, 0LL, 0x12u, &v38);
}
