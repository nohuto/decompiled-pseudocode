/*
 * XREFs of NvmeDumpStorageGetDumpInfoIoctl @ 0x14019FE00
 * Callers:
...
__int64 __fastcall NvmeDumpStorageGetDumpInfoIoctl(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  if ( !*(_BYTE *)(a2 + 64) )
  {
    ...
    DumpDiskInfo = NvmeDumpCreateDumpDiskInfo(a1, (__int64 *)&v51);
    if ( DumpDiskInfo >= 0 )
    {
      v9 = NvmeDumpCreateDumpAdapterInfo(
...
LABEL_16:
      ...
      if ( !v47 && v10 )
        NvmeNativeDumpFreeDumpDriverInfo((PVOID *)&v50);
      if ( !v48[0] && v19 )
        NvmeDumpFreeDumpAdapterInfo(&v49);
    }
    if ( v51 )
  ...
  if ( *(_BYTE *)v22 != 15 )
  {
    ...
    if ( *(_BYTE *)(v22 + 1) == 7 && !*(_DWORD *)(v22 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v44) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v21, v22, &v52, a2, v44, v45);
      }
      goto LABEL_93;
    }
...
LABEL_92:
    ...
    McTemplateK0pd_EtwWriteTransfer(v21, v24, &v52, a2, v44);
    goto LABEL_93;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_93;
...
LABEL_88:
      ...
      LOBYTE(v45) = v39;
      LODWORD(v44) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v21, v25, &v52, a2, v44, v45, v46, v29, v3, v42, a2);
    }
  }
LABEL_93:
