/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x14000675C
 * Callers:
  ...
  if ( *(_BYTE *)v18 != 15 )
  {
    ...
    if ( *(_BYTE *)(v18 + 1) == 7 && !*(_DWORD *)(v18 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v19 )
          v7 = *v19;
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v17, v18, (unsigned int)&v43, a2, v7, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_95;
    }
...
LABEL_96:
  ...
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 58LL, &WPP_3e1ffd7ece683aaa229dca75055d12f9_Traceguids, a1, a2, v12);
  }
