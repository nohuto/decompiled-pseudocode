/*
 * XREFs of NvmeControllerPowerInitialize @ 0x1400F2558
 * Callers:
 ...
 *     NvmeAdapterCacheOperationalPowerRange @ 0x1400DEE48 (NvmeAdapterCacheOperationalPowerRange.c)
 ...
 *     NvmeControllerValidatePowerStates @ 0x140132BA0 (NvmeControllerValidatePowerStates.c)
...
__int64 __fastcall NvmeControllerPowerInitialize(__int64 a1)
{
  ...
  if ( v8 == 3 )
  {
    ...
    {
      NvmeSetAutoPowerStateTransition(a1, 1u);
      NvmeGetAutoPowerStateTransition(a1);
    }
    return 0LL;
  }
  ...
  if ( (unsigned __int8)NvmeControllerValidatePowerStates(a1) )
  {
    ...
    if ( *(unsigned __int8 *)(v12 + 263) != -1 )
    {
      ...
      {
        LOBYTE(v10) = v13;
        PowerState = NvmeControllerGetPowerState(a1, v10);
    ...
    Pool = RaidAllocatePool(64LL, (unsigned int)(32 * (v5 + 3)), 1330667858LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL));
    v20 = (char *)Pool;
    if ( Pool )
    {
      if ( !v5
        || (v57 = RaidAllocatePool(72LL, 64LL, 1414095186LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL)),
            (v21 = (void *)v57) != 0LL)
        && (P = (PVOID)RaidAllocatePool(72LL, 64LL, 1414095186LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL))) != 0LL )
      {
        *((_DWORD *)v20 + 3) |= 0x40u;
        *(_DWORD *)v20 = 3;
        *((_DWORD *)v20 + 1) = 24;
        ...
        *((_DWORD *)v20 + 6) = 2;
        v22 = 40LL;
        *((_DWORD *)v20 + 7) = 40;
        *(_OWORD *)(v20 + 40) = xmmword_14015B000;
        ...
        *((_DWORD *)v20 + 4) = -1;
        *((_DWORD *)v20 + 3) = v24;
        v25 = *(_DWORD *)(*(_QWORD *)(a1 + 1048) + 48LL);
        if ( v25 == 2 )
        {
          *((_DWORD *)v20 + 3) = v24 | 4;
          *(_DWORD *)(v9 + 176) |= 2u;
        ...
        {
          *((_DWORD *)v20 + 3) = v24 | 4;
          *((_DWORD *)v20 + 4) = *(_DWORD *)(*(_QWORD *)(a1 + 1048) + 60LL);
        }
        v26 = *(_DWORD *)(*(_QWORD *)(a1 + 1048) + 48LL);
        if ( v26 <= 1 || v26 - 3 <= 1 )
          *((_DWORD *)v20 + 3) |= 2u;
        *((_DWORD *)v20 + 3) |= 8u;
        v27 = *((_DWORD *)v20 + 8);
        ...
        *((_DWORD *)v20 + 22) = -1;
        if ( v27 > 1 )
        {
          do
          {
            v29 = NvmeControllerGetPowerState(a1, (unsigned int)(v3 + v28));
            v31 = 32LL * v30;
            v32 = v30;
            v28 = v30 + 1;
            *(_DWORD *)&v20[v31 + 64] = 1;
        ...
        v11 = NvmeAdapterInitializePoFx(*(_QWORD *)(a1 + 128), v20, &v59, v28);
        if ( v11 >= 0 )
        {
          v37 = 0LL;
          v38 = 8 * v59;
          ...
          *(_DWORD *)(v9 + 188) = 15;
          if ( *(_DWORD *)(v40 + 16) > 1u )
          {
            ...
            if ( NvmeControllerGetPowerState(a1, v36) )
              *(_DWORD *)(v9 + 4) = 64;
          }
          v41 = *(_DWORD *)(*(_QWORD *)(a1 + 1048) + 68LL);
          if ( v41 != -1 )
            *(_DWORD *)(v9 + 188) = v41;
          if ( v60 )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(v9 + 8) + 112LL) = v42;
            KeInitializeDpc(*(PRKDPC *)(*(_QWORD *)(v9 + 8) + 112LL), NvmeFStateTimerDpcRoutine, *(PVOID *)(a1 + 128));
            PoFxSetComponentLatency(**(_QWORD **)(v9 + 8), 0LL, 0LL);
            PoFxSetComponentResidency(**(_QWORD **)(v9 + 8), 0LL, 0LL);
          }
          v43 = RaidAllocatePool(64LL, 24 * v4 + 40, 1330667858LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL));
          v2 = (unsigned int *)v43;
          if ( v43 )
          {
            *(_DWORD *)v43 = 1;
            ...
            *(_DWORD *)(v43 + 28) = 40;
            ...
            v53 = *(_QWORD *)(a1 + 128);
            v59 = 1;
            v11 = NvmeRegisterPerfStates(*(_QWORD *)(v53 + 8), v44, v45, (unsigned int)&v59, (__int64)v2, v55, *v52);
            if ( v11 >= 0 )
            {
              if ( NvmeAdapterCacheOperationalPowerRange(*(_QWORD *)(v9 + 8), v59, (__int64)v2) )
              {
                v54 = 3LL;
                do
                {
