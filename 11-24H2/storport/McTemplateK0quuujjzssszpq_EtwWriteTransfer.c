/*
 * XREFs of McTemplateK0quuujjzssszpq_EtwWriteTransfer @ 0x140058438
 * Callers:
        ...
        char a16)
{
  ...
  v62 = 8LL;
  v64 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v19, &EventNVMeUnlockPhysicalAddress, 0LL, 0xEu, &v33);
}
