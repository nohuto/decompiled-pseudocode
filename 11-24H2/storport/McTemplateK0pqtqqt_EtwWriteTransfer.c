/*
 * XREFs of McTemplateK0pqtqqt_EtwWriteTransfer @ 0x140056AC8
 * Callers:
...
NTSTATUS McTemplateK0pqtqqt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventAdapterPoFxRegistered, 0LL, 7u, &v4);
}
