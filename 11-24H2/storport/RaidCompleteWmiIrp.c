/*
 * XREFs of RaidCompleteWmiIrp @ 0x1400506F0
 * Callers:
...
LABEL_73:
        ...
        if ( v30[1] == 7 && !*((_DWORD *)v30 + 2) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v32 )
              v5 = *v32;
            McTemplateK0pqd_EtwWriteTransfer((_DWORD)v29, (_DWORD)v30, (unsigned int)&v66, a2, v5, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_134;
        }
...
LABEL_133:
        McTemplateK0pd_EtwWriteTransfer(v29, v33, &v66, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_134;
      }
      if ( byte_140171461 >= 0 )
        goto LABEL_134;
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v5 = *v9;
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v7, v8, (unsigned int)&v66, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_68:
    McTemplateK0pd_EtwWriteTransfer(v7, v10, &v66, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_69;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_69;
