/*
 * XREFs of McTemplateK0zqjuuujssstqq_EtwWriteTransfer @ 0x140090950
 * Callers:
        ...
        char a16)
{
  ...
  v56 = 4LL;
  v58 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v26, &EventUnitReportMisAlignedDataBuffer, 0LL, 0xEu, &v28);
}
