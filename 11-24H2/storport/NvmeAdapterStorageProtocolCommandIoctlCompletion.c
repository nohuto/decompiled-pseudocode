/*
 * XREFs of NvmeAdapterStorageProtocolCommandIoctlCompletion @ 0x1400D9FA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeAdapterStorageProtocolCommandIoctlCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // ebx
  __int64 v5; // rcx
  __int64 v7; // r13
...
LABEL_31:
  ...
  *((_QWORD *)v9 + 2) = 1LL;
  ...
  v59 = 84;
  StorGetStorageProtocolCommandBufferTotalLength(v9, &v59);
  v22 = v59;
LABEL_32:
  *(_QWORD *)(v7 + 56) = v22;
  v23 = *(_QWORD *)(*a2 + 4160);
  ...
  if ( *(_BYTE *)v25 != 15 )
  {
    ...
    if ( *(_BYTE *)(v25 + 1) == 7 && !*(_DWORD *)(v25 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v53) = *v21;
        LODWORD(v52) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v24, v25, &v62, v7, v52, v53);
      }
      goto LABEL_174;
    }
...
LABEL_173:
    LODWORD(v52) = *v21;
    McTemplateK0pd_EtwWriteTransfer(v24, v33, &v62, v7, v52);
    goto LABEL_174;
  }
...
LABEL_170:
      ...
      LOBYTE(v53) = v48;
      LODWORD(v52) = *v21;
      McTemplateK0pduuuuup_EtwWriteTransfer(v24, v34, &v62, v7, v52, v53, v54, v55, v56, v57, v7);
      goto LABEL_174;
    }
LABEL_169:
    v38 = 0;
