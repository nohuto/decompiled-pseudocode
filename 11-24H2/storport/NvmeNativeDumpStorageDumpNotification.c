/*
 * XREFs of NvmeNativeDumpStorageDumpNotification @ 0x14019FD84
 * Callers:
...
__int64 __fastcall NvmeNativeDumpStorageDumpNotification(__int64 a1, IRP *a2)
{
  unsigned int v2; // ebx
  _IRP *MasterIrp; // rax
  ...
  else if ( a2->Tail.Overlay.CurrentStackLocation->Parameters.Create.Options >= 0x10 )
  {
    ...
    {
      v2 = 0;
      *(_QWORD *)(a1 + 288) = MasterIrp->MdlAddress;
    }
    else
    {
      v2 = -1073741811;
