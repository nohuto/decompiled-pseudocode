/*
 * XREFs of RaidAdapterCheckWaitTimeout @ 0x140058F80
 * Callers:
 *     RaidQueueWaitCheckDpcRoutine @ 0x140066440 (RaidQueueWaitCheckDpcRoutine.c)
 * Callees:
...
void __fastcall RaidAdapterCheckWaitTimeout(KSPIN_LOCK *a1)
{
  ...
  KSPIN_LOCK *Pool; // [rsp+90h] [rbp-11h]
  ...
  v127 = DpcCompletionLimit;
  v128 = GatewayCheckWaitTimeout(v1, (unsigned int)DpcCompletionLimit, v125);
  while ( 1 )
  {
    v2 = v125[0];
    ...
    if ( *(_BYTE *)v21 != 15 )
    {
      ...
      if ( *(_BYTE *)(v21 + 1) == 7 && !*(_DWORD *)(v21 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          LODWORD(v114) = v23;
          McTemplateK0pqd_EtwWriteTransfer(v23, v21, &v131, v6, v114, v115);
        }
        goto LABEL_95;
      }
      if ( (byte_140171462 & 0x20) == 0 )
        goto LABEL_95;
      v24 = (const EVENT_DESCRIPTOR *)&EventPnpRequestComplete;
LABEL_94:
      LODWORD(v114) = *(_DWORD *)(v6 + 48);
      McTemplateK0pd_EtwWriteTransfer(v20, v24, &v131, v6, v114);
      goto LABEL_95;
    }
    if ( byte_140171461 >= 0 )
      goto LABEL_95;
...
LABEL_90:
        ...
        LOBYTE(v115) = v40;
        LODWORD(v114) = *(_DWORD *)(v6 + 48);
        McTemplateK0pduuuuup_EtwWriteTransfer(v48, v25, &v131, v6, v114, v115, v116, v117, v118, v119, v6);
      }
    }
LABEL_95:
  ...
  if ( v127 != v128 )
  {
    ...
    if ( v51 )
    {
      Pool = (KSPIN_LOCK *)RaidAllocatePool(64LL, 8LL * v51, 1280663890LL, v50[1]);
      v52 = Pool;
      if ( Pool )
      {
        v53 = v126;
        ...
        do
        {
          ...
          if ( v60 > v49 )
          {
            v63 = RaidLunQueueCheckWaitTimeout(v61 + 720, v60 - v49, v125);
            v62 = v63;
            v49 += v63;
            v61 = *v59;
          }
          ...
          if ( !v19 )
          {
            ...
            switch ( *(_BYTE *)v86 )
            {
              case 0xE:
                if ( (byte_140171462 & 8) != 0 )
                {
                  v89 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
LABEL_215:
                  LODWORD(v114) = *(_DWORD *)(v72 + 48);
                  McTemplateK0pd_EtwWriteTransfer(v85, v89, &v132, v72, v114);
                }
                break;
              case 0xF:
                if ( byte_140171461 < 0 )
              ...
              case 0x1B:
                if ( *(_BYTE *)(v86 + 1) == 7 && !*(_DWORD *)(v86 + 8) )
                {
                  if ( (byte_140171462 & 0x40) != 0 )
                  {
                    ...
                    LODWORD(v114) = v88;
                    McTemplateK0pqd_EtwWriteTransfer(v88, v86, &v132, v72, v114, v115);
                  }
                  break;
                }
                if ( (byte_140171462 & 0x20) != 0 )
                {
                  v89 = (const EVENT_DESCRIPTOR *)&EventPnpRequestComplete;
                  goto LABEL_215;
                }
                break;
            }
