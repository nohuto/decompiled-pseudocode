/*
 * XREFs of RaUnitStorageQueryDeviceEndurancePropertyIoctl @ 0x14009AF44
 * Callers:
...
LABEL_19:
  ...
  else
  {
    if ( v8 >= 0x38 )
    {
      v10 = RaBuildQueryEnduranceInfoPropertyBufferForMiniport(*(_QWORD *)(a1 + 8), a2, (__int64 *)&P, &v42);
      v11 = (unsigned int *)P;
      v9 = v10;
      if ( v10 >= 0 )
      {
