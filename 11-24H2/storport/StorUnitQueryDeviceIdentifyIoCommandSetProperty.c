/*
 * XREFs of StorUnitQueryDeviceIdentifyIoCommandSetProperty @ 0x14018CFD0
 * Callers:
...
__int64 __fastcall StorUnitQueryDeviceIdentifyIoCommandSetProperty(__int64 a1, __int64 a2)
{
  int v2; // ebx
  unsigned int v4; // esi
  const void *v5; // rdx
