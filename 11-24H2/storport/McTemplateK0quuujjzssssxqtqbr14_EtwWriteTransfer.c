/*
 * XREFs of McTemplateK0quuujjzssssxqtqbr14_EtwWriteTransfer @ 0x1400AE0D0
 * Callers:
        ...
        __int64 a19)
{
  ...
  v72 = 4LL;
  v74 = 512LL;
  return McGenEventWrite_EtwWriteTransfer(v32, &EventUnitSmartAttributes, 0LL, 0x11u, &v37);
}
