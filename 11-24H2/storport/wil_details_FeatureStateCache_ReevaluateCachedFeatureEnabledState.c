/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1400684EC
 * Callers:
 *     wil_details_AreDependenciesEnabled @ 0x140067F9C (wil_details_AreDependenciesEnabled.c)
 *     wil_details_IsEnabledFallback @ 0x140068770 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140068658 (wil_details_GetCurrentFeatureEnabledState.c)
