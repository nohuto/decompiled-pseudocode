/*
 * XREFs of NvmeAdapterRemoveSubsystemPort @ 0x14019BB24
 * Callers:
...
__int64 __fastcall NvmeAdapterRemoveSubsystemPort(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  {
    SubsystemPort = NvmeAdapterFindSubsystemPort(a1, *(_QWORD *)(v4 + 8) ^ a1, 1, &v47);
    *(_QWORD *)&v48.Data1 = SubsystemPort;
    v8 = SubsystemPort;
    if ( SubsystemPort )
    {
      v9 = *(_QWORD *)(SubsystemPort + 32);
      if ( (v9 & 1) != 0 )
      {
        if ( (v9 & 0x10) == 0 )
        {
          ...
          *(_QWORD *)(v12 + 8) = v13;
          ...
          NvmeAdapterCleanupSubsystemPort(a1, 1, (PVOID *)&v48);
          goto LABEL_19;
        }
        v6 = -2147483631;
      }
  ...
  if ( *(_BYTE *)v16 != 15 )
  {
    ...
    if ( *(_BYTE *)(v16 + 1) == 7 && !*(_DWORD *)(v16 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v38) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v15, v16, &v48, a2, v38, v39);
      }
      goto LABEL_85;
    }
    ...
    LODWORD(v38) = *(_DWORD *)(a2 + 48);
LABEL_84:
    McTemplateK0pd_EtwWriteTransfer(v15, v18, &v48, a2, v38);
    goto LABEL_85;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_85;
...
LABEL_80:
      ...
      LODWORD(v38) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v15, v19, &v48, a2, v38, v39, v40, v41, v42, v43, a2);
    }
  }
LABEL_85:
