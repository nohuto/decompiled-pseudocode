/*
 * XREFs of NvmeNamespaceFlushIrp @ 0x1401028B4
 * Callers:
...
__int64 __fastcall NvmeNamespaceFlushIrp(char *Context, PIRP Irp)
{
  ...
  {
    v29 = NvmeNamespaceAcquireRemoveLock((__int64)Context, (__int64)Irp);
    v4 = 0;
    v88 = v29;
    if ( v29 < 0 )
    {
...
LABEL_67:
        ...
        if ( CurrentStackLocation->MinorFunction == 7 && !CurrentStackLocation->Parameters.Read.Length )
        {
          ...
          v9 = &v92;
LABEL_12:
          McTemplateK0pqd_EtwWriteTransfer(v6, (__int64)CurrentStackLocation, v9, Irp, v4, Irp->IoStatus.Status);
          goto LABEL_138;
        }
...
LABEL_136:
    ...
    *((_BYTE *)&Irp->Tail.CompletionKey + 21) = -84;
    ...
    if ( v54->MajorFunction == 14 )
    {
      if ( (byte_140171462 & 8) == 0 )
        goto LABEL_214;
      v56 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
      goto LABEL_213;
    }
    if ( v54->MajorFunction != 15 )
    {
      ...
      if ( v54->MinorFunction == 7 && !v54->Parameters.Read.Length )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          if ( v55 )
            v4 = *v55;
          McTemplateK0pqd_EtwWriteTransfer(v53, (__int64)v54, &v92, Irp, v4, Irp->IoStatus.Status);
        }
        goto LABEL_214;
      }
      if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_213:
      McTemplateK0pd_EtwWriteTransfer(v53, v56, &v92, Irp, Irp->IoStatus.Status);
      goto LABEL_214;
    }
    if ( byte_140171461 >= 0 )
      goto LABEL_214;
...
LABEL_207:
    if ( (_BYTE)v57 )
    {
      ...
      v73 = v63;
LABEL_210:
      McTemplateK0pduuuuup_EtwWriteTransfer(v53, v57, &v92, Irp, Irp->IoStatus.Status, v70, v58, v61, v4, v73, Irp);
      goto LABEL_214;
    }
LABEL_209:
    v61 = 0;
...
LABEL_137:
    McTemplateK0pd_EtwWriteTransfer(v6, v11, v10, Irp, Irp->IoStatus.Status);
    goto LABEL_138;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_138;
