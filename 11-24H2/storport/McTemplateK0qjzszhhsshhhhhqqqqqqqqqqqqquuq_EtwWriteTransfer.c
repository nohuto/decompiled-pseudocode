/*
 * XREFs of McTemplateK0qjzszhhsshhhhhqqqqqqqqqqqqquuq_EtwWriteTransfer @ 0x1400C1594
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzszhhsshhhhhqqqqqqqqqqqqquuq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a33)
{
  ...
  v112 = 1LL;
  v114 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v47, &EventMFNDSetChildPFSettings, 0LL, 0x1Fu, &v50);
}
