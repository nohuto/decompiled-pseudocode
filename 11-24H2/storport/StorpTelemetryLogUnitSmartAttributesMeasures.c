/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesMeasures @ 0x1400B5A10
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v102 = v11;
      v103 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_14015F1AC, v12, v8, 0x24u, &v39);
    }
  }
}
