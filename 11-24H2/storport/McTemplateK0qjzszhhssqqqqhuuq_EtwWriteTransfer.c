/*
 * XREFs of McTemplateK0qjzszhhssqqqqhuuq_EtwWriteTransfer @ 0x140056EF4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzszhhssqqqqhuuq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a20)
{
  ...
  v73 = 1LL;
  v75 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v34, &EventReconfigureMFND, 0LL, 0x12u, &v37);
}
