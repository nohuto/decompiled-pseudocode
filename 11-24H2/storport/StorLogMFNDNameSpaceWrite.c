/*
 * XREFs of StorLogMFNDNameSpaceWrite @ 0x14006760C
 * Callers:
...
__int16 __fastcall StorLogMFNDNameSpaceWrite(
        __int64 a1,
        char a2,
        char a3,
        char a4,
        ...
        int a8)
{
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    v32 = 0;
    v33 = 0LL;
    LOWORD(v13) = RaidDriverGetName(v12, (__int64)&v29);
    ...
    if ( a8 >= 0 )
    {
      if ( (byte_140171467 & 4) != 0 )
      {
        ...
        LOWORD(v13) = McTemplateK0qjzszhhssqqqxqqquuq_EtwWriteTransfer(
                        a7 >> 1,
    ...
    else if ( (byte_140171469 & 2) != 0 )
    {
      ...
      if ( !v16 || (v21 = *(const wchar_t **)(v16 + 24)) == 0LL )
        v21 = (const wchar_t *)&unk_140151214;
      LOWORD(v13) = McTemplateK0qjzszhhssqqqxqqquuq_EtwWriteTransfer(
                      a7 >> 1,
