/*
 * XREFs of StorPortAdapterIdleState @ 0x14001C0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall StorPortAdapterIdleState(__int64 a1, unsigned int a2, int a3)
{
  __int64 *v6; // r8
  bool v7; // zf
  __int64 v8; // rcx
  ...
  *(_DWORD *)(*v6 + 16) = a3;
  if ( (unsigned __int8)RaidIsAdapterControlSupported(a1 + 376, 9LL) )
  {
...
LABEL_43:
      ...
      if ( !(unsigned __int8)RaidUnitCheckAndAcquirePoFx(v11) )
      {
LABEL_31:
        *(_BYTE *)(a1 + 4893) = v12;
        *(_BYTE *)(v11 + 1862) = v13;
