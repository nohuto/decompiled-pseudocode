/*
 * XREFs of McTemplateK0qjzshhusssssxsxsxsxsxsxsxsxduuu_EtwWriteTransfer @ 0x1400DE078
 * Callers:
        ...
        char a34)
{
  ...
  v154 = 1LL;
  v156 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(v75, &EventNVMeQueueRequestFailed, 0LL, 0x20u, &v80);
}
