/*
 * XREFs of NvmeNamespaceQueryDeviceEndurancePropertyCompletion @ 0x140108160
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeNamespaceQueryDeviceEndurancePropertyCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // esi
  __int64 v5; // rcx
  __int64 v7; // r14
...
LABEL_30:
  *(_QWORD *)(v8 + 56) = v23;
  NvmeFreeDmaBuffer(a1, *(_DWORD *)(*a2 + 4248), v22, *(_QWORD *)(*a2 + 4160), *(_QWORD *)(*a2 + 4168));
  ...
  if ( *(_BYTE *)v25 != 15 )
  {
    ...
    if ( *(_BYTE *)(v25 + 1) == 7 && !*(_DWORD *)(v25 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v90) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v24, v25, &v98, v8, v90, v91);
      }
      goto LABEL_163;
    }
...
LABEL_162:
    ...
    McTemplateK0pd_EtwWriteTransfer(v24, v72, &v98, v8, v90);
    goto LABEL_163;
  }
...
LABEL_159:
      ...
      LOBYTE(v91) = v86;
      LODWORD(v90) = *(_DWORD *)(v8 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v24, v73, &v98, v8, v90, v91, v92, v93, v94, v95, v8);
      goto LABEL_163;
    }
LABEL_158:
    v77 = 0;
