/*
 * XREFs of McTemplateK0zqjdz_EtwWriteTransfer @ 0x140076F88
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqjdz_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        const wchar_t *a4,
        ...
        char a7)
{
  ...
  v19 = 4LL;
  v21 = 16LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)L"NULL", &EventAdapterPowerRetryWithWorkItem, a3, 6u, &v10);
}
