/*
 * XREFs of StorEtwMiniportLogError @ 0x140042658
 * Callers:
  ...
  if ( (byte_140171464 & 0x10) != 0 )
  {
    ...
    if ( v28 )
    {
      ...
      if ( (byte_140171464 & 0x10) != 0 )
      {
        if ( FirstUnit )
        {
          v16 = (const wchar_t *)(FirstUnit + 242);
          LOBYTE(v17) = *(_BYTE *)(FirstUnit + 506) & 1;
          v18 = (const wchar_t *)(FirstUnit + 177);
          v19 = (const wchar_t *)(FirstUnit + 168);
        }
        else
        {
          v16 = &word_140150F48;
      ...
      if ( FirstUnit )
      {
        v22 = (wchar_t *)(FirstUnit + 242);
        v23 = (wchar_t *)(FirstUnit + 177);
        v15 = (wchar_t *)(FirstUnit + 168);
      }
      else
      {
        v22 = (wchar_t *)&word_140150F48;
        v23 = (wchar_t *)&word_140150F48;
      }
      LOBYTE(v13) = v25;
