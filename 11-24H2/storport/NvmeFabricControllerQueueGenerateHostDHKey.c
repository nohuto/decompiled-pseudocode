/*
 * XREFs of NvmeFabricControllerQueueGenerateHostDHKey @ 0x1400F7308
 * Callers:
 ...
 *     DhGetGenerator @ 0x1400DD5D4 (DhGetGenerator.c)
 *     DhGetKeyLength @ 0x1400DD608 (DhGetKeyLength.c)
 *     DhGetPrime @ 0x1400DD638 (DhGetPrime.c)
...
__int64 __fastcall NvmeFabricControllerQueueGenerateHostDHKey(__int64 a1)
{
  ...
  if ( KeyLength )
  {
    ...
    *(_DWORD *)(Pool + 8) = v6;
    ...
    cbOutput = v6 + 2 * (v6 + 4);
    v14 = (UCHAR *)RaidAllocatePool(64LL, cbOutput, 1095655762LL, *(_QWORD *)(*(_QWORD *)(*v7 + 128) + 8LL));
    v4 = v14;
    if ( v14 )
    {
