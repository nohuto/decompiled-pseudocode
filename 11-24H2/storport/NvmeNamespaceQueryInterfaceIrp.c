/*
 * XREFs of NvmeNamespaceQueryInterfaceIrp @ 0x140109DDC
 * Callers:
...
LABEL_71:
                  ...
                  McTemplateK0pduuuuup_EtwWriteTransfer(v11, v17, v33, a2, v69, v70, v71, v72, v73, v74, v75);
                  goto LABEL_208;
                }
              }
              else
...
LABEL_16:
        ...
        LODWORD(v69) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v11, v12, v14, a2, v69, v70);
        goto LABEL_208;
      }
      if ( (byte_140171462 & 0x20) == 0 )
        goto LABEL_208;
...
LABEL_207:
    LODWORD(v69) = *(_DWORD *)(a2 + 48);
    McTemplateK0pd_EtwWriteTransfer(v11, v16, v15, a2, v69);
    goto LABEL_208;
  }
  v7 = *(GUID **)(v2 + 8);
