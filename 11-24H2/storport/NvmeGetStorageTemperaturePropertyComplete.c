/*
 * XREFs of NvmeGetStorageTemperaturePropertyComplete @ 0x1400DB9B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeGetStorageTemperaturePropertyComplete(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // edi
  __int64 v5; // rbx
  void *v6; // r13
    ...
    *((_WORD *)v25 + 15) = 0x8000;
    ...
    if ( Pool )
    {
      ...
      *(_QWORD *)(*(_QWORD *)a2 + 4224LL) = v7;
      ...
      v5 = a1;
      v9 = NvmeControllerProcessCommand(a1, a2);
      if ( v9 >= 0 )
        return;
      goto LABEL_28;
    }
...
LABEL_28:
  *(_DWORD *)(v8 + 48) = v9;
  ...
  if ( v18 )
    NvmeFreeDmaBuffer(v5, *(_DWORD *)(*(_QWORD *)a2 + 4248LL), a3, v18, *(_QWORD *)(*(_QWORD *)a2 + 4168LL));
  _interlockedbittestandreset((volatile signed __int32 *)(*(_QWORD *)a2 + 4256LL), 3u);
  NvmeControllerReclaimExtendedCommand(v5, a2);
  if ( v7 )
  ...
  *(_BYTE *)(v8 + 141) = -84;
  ...
  if ( *(_BYTE *)v20 == 14 )
  {
    if ( (byte_140171462 & 8) == 0 )
      goto LABEL_180;
    v52 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
    goto LABEL_179;
  }
  if ( *(_BYTE *)v20 != 15 )
  {
    ...
    if ( *(_BYTE *)(v20 + 1) == 7 && !*(_DWORD *)(v20 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v21 )
          v3 = *v21;
        LODWORD(v71) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v19, v20, &v75, v8, v71, *(_DWORD *)(v8 + 48));
      }
      goto LABEL_180;
    }
...
LABEL_179:
    ...
    McTemplateK0pd_EtwWriteTransfer(v19, v52, &v75, v8, v71);
    goto LABEL_180;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_180;
...
LABEL_176:
      LODWORD(v71) = *(_DWORD *)(v8 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v19, v53, &v75, v8, v71, v66, v54, v57, v3, v70, v8);
      goto LABEL_180;
    }
LABEL_175:
    v57 = 0;
