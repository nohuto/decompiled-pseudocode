/*
 * XREFs of McTemplateK0pquuutq_EtwWriteTransfer @ 0x140076310
 * Callers:
...
NTSTATUS McTemplateK0pquuutq_EtwWriteTransfer(
        __int64 a1,
        _DWORD a2,
        _DWORD a3,
        __int64 a4,
        ...
        ...)
{
  ...
  v21 = 4LL;
  v23 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitPowerNotRequiredStart, 0LL, 8u, &v9);
}
