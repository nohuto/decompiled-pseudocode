/*
 * XREFs of McTemplateK0pqquuuqpp_EtwWriteTransfer @ 0x140071B88
 * Callers:
...
NTSTATUS McTemplateK0pqquuuqpp_EtwWriteTransfer(
        __int64 a1,
        _DWORD a2,
        const GUID *a3,
        __int64 a4,
        ...
        ...)
{
  ...
  v27 = 8LL;
  v29 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventStateChangeDetected, a3, 0xAu, &v11);
}
