/*
 * XREFs of NvmeNamespaceStorageSetPropertyIoctl @ 0x1401B0F1C
 * Callers:
      ...
      case 0x1B:
        if ( *(_BYTE *)(v54 + 1) == 7 && !*(_DWORD *)(v54 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v55 )
              v5 = *v55;
            McTemplateK0pqd_EtwWriteTransfer(v53, v54, &v86, a2, v5, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_204;
        }
...
LABEL_204:
    ...
    McTemplateK0pd_EtwWriteTransfer(v53, v56, &v86, a2, v75);
    goto LABEL_204;
  }
  v8 = *(_QWORD *)(a1 + 16);
      ...
      case 0x1B:
        if ( *(_BYTE *)(v33 + 1) == 7 && !*(_DWORD *)(v33 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v34 )
              v5 = *v34;
            McTemplateK0pqd_EtwWriteTransfer(v32, v33, &v86, a2, v5, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_139;
        }
        if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_139:
    ...
    McTemplateK0pd_EtwWriteTransfer(v32, v35, &v86, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_139;
  }
  v9 = StorEtwLoggingEnabled == 0;
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v5 = *v12;
        McTemplateK0pqd_EtwWriteTransfer(v10, v11, &v86, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
    if ( (byte_140171462 & 0x20) == 0 )
    ...
    v74 = *(_DWORD *)(a2 + 48);
LABEL_68:
    McTemplateK0pd_EtwWriteTransfer(v10, v13, &v86, a2, v74);
    goto LABEL_69;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_69;
...
LABEL_64:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v10, v14, &v86, a2, *(_DWORD *)(a2 + 48), v27, v15, v18, v5, v30, a2);
    }
  }
LABEL_69:
  IofCompleteRequest((PIRP)a2, 0);
