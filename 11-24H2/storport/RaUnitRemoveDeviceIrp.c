/*
 * XREFs of RaUnitRemoveDeviceIrp @ 0x140095E34
 * Callers:
...
__int64 __fastcall RaUnitRemoveDeviceIrp(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a1 + 56) != 6 )
  {
    ...
    if ( (*(_BYTE *)(a1 + 504) & 4) != 0 )
    {
      v28 = RaUnitDisableDeviceIrp(a1, a2);
      RaidUnitReenablePendingTimer(a1, 0);
    }
    else
    {
      v28 = RaUnitDeleteDeviceIrp(a1, a2);
    }
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      && (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v4 = *v8;
        LODWORD(v29) = v4;
        McTemplateK0pqd_EtwWriteTransfer(v6, v7, &v33, a2, v29, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_75;
    }
...
LABEL_70:
      ...
      LODWORD(v29) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v33, a2, v29, v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_75:
