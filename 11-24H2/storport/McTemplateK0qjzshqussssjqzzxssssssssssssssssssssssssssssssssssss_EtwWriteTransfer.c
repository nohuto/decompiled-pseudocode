/*
 * XREFs of McTemplateK0qjzshqussssjqzzxssssssssssssssssssssssssssssssssssss_EtwWriteTransfer @ 0x1400ABFE8
 * Callers:
        ...
        const char *a55)
{
  ...
  if ( !a55 )
    v179 = "NULL";
  v326 = v179;
  return McGenEventWrite_EtwWriteTransfer(v180, &NVMeNamespaceIoSizeDistribution, 0LL, 0x35u, &v182);
}
