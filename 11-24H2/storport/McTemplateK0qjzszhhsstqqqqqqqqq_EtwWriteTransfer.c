/*
 * XREFs of McTemplateK0qjzszhhsstqqqqqqqqq_EtwWriteTransfer @ 0x140076498
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzszhhsstqqqqqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a22)
{
  ...
  v80 = 4LL;
  v82 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v36, &EventPLDRRequestPowerIrpFailed, 0LL, 0x14u, &v39);
}
