/*
 * XREFs of StorProcessNotification @ 0x1401B2620
 * Callers:
...
void __fastcall StorProcessNotification(__int64 a1, __int64 a2)
{
  ...
  __int64 EventNotificationContext; // [rsp+80h] [rbp-9h]
  ...
  v3 = EventNotificationContext;
  if ( !EventNotificationContext )
    return;
  KeEnterCriticalRegion();
  ExAcquireResourceSharedLite((PERESOURCE)(EventNotificationContext + 24), 1u);
  v4 = EventNotificationContext + 8;
  v5 = *(__int64 **)(EventNotificationContext + 8);
  v79 = v5;
  if ( v5 == (__int64 *)(EventNotificationContext + 8) )
    goto LABEL_153;
  do
  {
...
LABEL_22:
                  ...
                  LODWORD(v68) = v14;
                  McTemplateK0pqd_EtwWriteTransfer(v14, CurrentStackLocation, v15, v7, v68, v69);
                }
LABEL_79:
...
LABEL_77:
              ...
              McTemplateK0pduuuuup_EtwWriteTransfer(v41, v18, v42, v7, v68, v69, v70, v71, v72, v73, v74);
            }
LABEL_78:
            v5 = v79;
            v4 = EventNotificationContext + 8;
...
LABEL_26:
          LODWORD(v68) = v7->IoStatus.Status;
          McTemplateK0pd_EtwWriteTransfer(v11, v16, v17, v7, v68);
          goto LABEL_79;
        }
        if ( byte_140171461 >= 0 )
          goto LABEL_79;
