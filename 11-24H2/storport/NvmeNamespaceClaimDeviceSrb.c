/*
 * XREFs of NvmeNamespaceClaimDeviceSrb @ 0x1400FC288
 * Callers:
...
__int64 __fastcall NvmeNamespaceClaimDeviceSrb(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 48) = v10;
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    v34 = *(_DWORD *)(a3 + 48);
LABEL_75:
    McTemplateK0pd_EtwWriteTransfer(v12, v15, &v40, a3, v34);
    goto LABEL_76;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_76;
...
LABEL_71:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v12, v16, &v40, a3, *(_DWORD *)(a3 + 48), v29, v17, v20, v8, v32, a3);
    }
  }
LABEL_76:
