/*
 * XREFs of NvmeRegisterForRuntimePowerManagement @ 0x140136338
 * Callers:
 ...
 *     RaidCheckAndReportDeviceD0OnlyToPoFx @ 0x1400BE0B4 (RaidCheckAndReportDeviceD0OnlyToPoFx.c)
 *     RaidNotifyPoAboutDFxOptOut @ 0x1400BE264 (RaidNotifyPoAboutDFxOptOut.c)
 *     NvmeControllerIsDisableDfx @ 0x140132280 (NvmeControllerIsDisableDfx.c)
 *     __security_check_cookie @ 0x140143690 (__security_check_cookie.c)
 */

__int64 __fastcall NvmeRegisterForRuntimePowerManagement(__int64 a1, int *a2, __int64 a3, __int64 a4)
{
...
LABEL_9:
  ...
  Pool = RaidAllocatePool(64LL, i, 1330667858LL, v64);
  v28 = Pool;
  if ( !Pool )
    return 3221225626LL;
  *(_DWORD *)Pool = 3;
  ...
  *(_QWORD *)(v28 + 8) |= 0x20uLL;
  if ( v29 )
  {
    ...
    {
      v31 = 56LL * v30;
      v32 = RaidGetStorPoFxComponent(v7, v30);
...
LABEL_28:
    ...
    do
    {
      v39 = RaidGetStorPoFxFState(v38, v37);
      v41 = 3 * v40;
      v37 = v40 + 1;
...
LABEL_44:
  ...
  {
    if ( IsDisableDfx )
      RaidNotifyPoAboutDFxOptOut(v63, v7[3] & 0x40);
    if ( v6 )
    {
      if ( (unsigned int)dword_140170178 > 5 )
      {
        if ( tlgKeywordOn(v46, 0x400000000000LL) )
        {
          v52 = *(_QWORD *)(v6 + 16);
          v53 = *(_QWORD *)(v52 + 128);
          v70 = 16LL;
          ...
          LODWORD(v64) = v50;
          v92 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer(v54, byte_1401633F7, v48, v49, 0xEu, v68);
        }
      }
    }
    else if ( v5 && (unsigned int)dword_140170178 > 5 && tlgKeywordOn((unsigned int)*v7, 0x400000000000LL) )
    {
      v70 = 16LL;
      v69 = v5 + 1032;
      LODWORD(v64) = v55;
      ...
      LODWORD(v65) = v57;
      v80 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v55, (unsigned __int8 *)dword_1401634BE, v56, v57, 8u, v68);
    }
  }
