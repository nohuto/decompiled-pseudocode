/*
 * XREFs of NvmeNamespaceDiskVerifyIoctl @ 0x1401A47F8
 * Callers:
...
__int64 __fastcall NvmeNamespaceDiskVerifyIoctl(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&v55.Data1 = a2;
  ...
  if ( *(__int64 *)v5 < 0
    || (v11 = *(unsigned int *)(a1 + 64), v12 = *(_QWORD *)(a1 + 432) * v11, v9 > v12)
    || v10 + v9 < v9
...
LABEL_25:
  ...
  if ( (_DWORD)v10 )
  {
    ...
    if ( ExtendedCommand )
    {
      ...
      *(_QWORD *)(ExtendedCommand->QuadPart + 4184) = 0LL;
      *(_QWORD *)(ExtendedCommand->QuadPart + 4192) = NvmeControllerCommandCompletion;
      *(_QWORD *)(ExtendedCommand->QuadPart + 4200) = ExtendedCommand;
      *(_QWORD *)(ExtendedCommand->QuadPart + 4160) = 0LL;
      *(_QWORD *)(ExtendedCommand->QuadPart + 4168) = 0LL;
      *(_DWORD *)(ExtendedCommand->QuadPart + 4248) = 0;
      do
      {
        v20 = v51;
        if ( v19 - v17 < v51 )
          v20 = v19 - v17;
        v50 = v20;
        memset_0((void *)(*v16 + 4096), 0, 0x40uLL);
        v21 = *(_DWORD *)(a1 + 64);
        v22 = *v16 + 4096;
        ...
        *(_QWORD *)(v22 + 52) = 0LL;
        *(_DWORD *)(v22 + 60) = 0;
        v7 = NvmeControllerProcessCommandSync(v2, v16, 0);
        if ( v7 < 0 )
          break;
        v17 += v50;
        v18 += v50;
      ...
      while ( v17 < v19 );
      NvmeControllerReclaimExtendedCommand((union _SLIST_HEADER *)v2, (__int64)v16);
      v8 = v54;
      v4 = *(_QWORD *)&v55.Data1;
      goto LABEL_26;
    }
  ...
  if ( *(_BYTE *)*v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v25 + 1) == 7 && !*(_DWORD *)(v25 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v26 )
          v3 = *v26;
        McTemplateK0pqd_EtwWriteTransfer(v24, v25, &v55, v4, v3, *(_DWORD *)(v4 + 48));
      }
      goto LABEL_92;
    }
...
LABEL_91:
    McTemplateK0pd_EtwWriteTransfer(v24, v27, &v55, v4, *(_DWORD *)(v4 + 48));
    goto LABEL_92;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_92;
...
LABEL_87:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v24, v28, &v55, v4, *(_DWORD *)(v4 + 48), v41, v29, v32, v3, v45, v4);
    }
  }
LABEL_92:
