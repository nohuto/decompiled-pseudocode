/*
 * XREFs of RaUnitGetQOSIoctl @ 0x140093D3C
 * Callers:
...
__int64 __fastcall RaUnitGetQOSIoctl(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 48) = v8;
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    v36 = *(_DWORD *)(a2 + 48);
LABEL_78:
    McTemplateK0pd_EtwWriteTransfer(v14, v17, &v41, a2, v36);
    goto LABEL_79;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_79;
...
LABEL_74:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v18, &v41, a2, *(_DWORD *)(a2 + 48), v31, v19, v22, v7, v34, a2);
    }
  }
LABEL_79:
