/*
 * XREFs of NvmeNamespaceDeviceUsageNotificationIrp @ 0x1400FDD98
 * Callers:
...
__int64 __fastcall NvmeNamespaceDeviceUsageNotificationIrp(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&v62.Data1 = v8;
  ...
  {
    v6 = (volatile signed __int32 *)(a1 + 280);
  }
  else
  {
    v11 = v56 - 3;
        ...
        if ( v10 )
        {
          ...
          *(_QWORD *)(v8 + 144) |= 0x2000uLL;
          if ( (unsigned int)dword_140170178 > 5 && tlgKeywordOn(v11, 0x400000000000LL) )
          {
            ...
            v73 = 4LL;
            v75 = 4LL;
            tlgCreate1Sz_wchar_t((__int64)v76, v14);
            v16 = *(const wchar_t **)(v8 + 1024);
            v17 = (*(_BYTE *)(v15 + 136) & 2) != 0;
            v78 = 1LL;
            v55 = v17 ? 20 : 17;
            v77 = &v55;
            tlgCreate1Sz_wchar_t((__int64)v79, v16);
            tlgWriteTransfer_EtwWriteTransfer((__int64)v63, (unsigned __int8 *)dword_1401632D8, v18, v19, 0xBu, v63);
          }
        }
        else
        {
    ...
    v6 = (volatile signed __int32 *)(a1 + 276);
  }
  if ( v6 && !*v6 && !v10 )
  {
    Status = -1073741823;
  ...
  if ( **v9 != 15 )
  {
    ...
    if ( v29[1] == 7 && !*((_DWORD *)v29 + 2) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v51) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v28, (__int64)v29, &v62, a2, v51, v52);
      }
      goto LABEL_103;
    }
...
LABEL_102:
    ...
    McTemplateK0pd_EtwWriteTransfer(v28, v31, &v62, a2, v51);
    goto LABEL_103;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_103;
...
LABEL_98:
      ...
      LOBYTE(v52) = v46;
      LODWORD(v51) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v28, v32, &v62, a2, v51, v52, v33, v36, v3, v49, a2);
    }
  }
LABEL_103:
