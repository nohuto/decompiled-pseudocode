/*
 * XREFs of McTemplateK0qjzszhhsshhhhqqqqhhqqqqqqqqquuq_EtwWriteTransfer @ 0x1400C1954
 * Callers:
        ...
        char a34)
{
  ...
  v115 = 1LL;
  v117 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v48, &EventMFNDQueryChildPFSettings, 0LL, 0x20u, &v51);
}
