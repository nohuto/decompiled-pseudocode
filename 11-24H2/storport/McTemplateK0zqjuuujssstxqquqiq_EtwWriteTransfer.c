/*
 * XREFs of McTemplateK0zqjuuujssstxqquqiq_EtwWriteTransfer @ 0x1400239D4
 * Callers:
        ...
        char a21)
{
  ...
  int v30; // eax
  __int64 v31; // rcx
  _BYTE v33[16]; // [rsp+38h] [rbp-D0h] BYREF
  ...
  v70 = 8LL;
  v72 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v31, &EventHighLatencyIo, 0LL, 19LL, v33);
}
