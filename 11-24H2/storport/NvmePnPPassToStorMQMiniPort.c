/*
 * XREFs of NvmePnPPassToStorMQMiniPort @ 0x1400DC604
 * Callers:
...
__int64 NvmePnPPassToStorMQMiniPort(__int64 a1, int a2, __int64 a3, ...)
{
  ...
  while ( 1 )
  {
    ...
    if ( !ContiguousIoResources )
      ContiguousIoResources = NVMeAllocateContiguousIoResources(v13 + 1184, v9, (_QWORD *)v3);
    if ( StorMQSrb && ContiguousIoResources )
    {
      ...
      *(_DWORD *)(StorMQSrb + 60) = 0;
      if ( v16 == 40 && (v17 = *(_DWORD *)(StorMQSrb + 56)) != 0 )
      {
        v18 = 0;
        while ( 1 )
        {
          v19 = *(unsigned int *)(StorMQSrb + 4LL * v18 + 120);
...
LABEL_26:
      ...
      *(_QWORD *)(ContiguousIoResources + 232) = *(_QWORD *)(StorMQSrb + 64);
      RaSrbSetMiniportContext((int *)v3, StorMQSrb, ContiguousIoResources + 1184);
      ...
      *(_DWORD *)(v21 + 16) = v22;
      ...
      v25 = ContiguousIoResources + 48;
      *(_QWORD *)(ContiguousIoResources + 704) = RaidXrbSignalCompletion;
      if ( (*(_DWORD *)(v3 + 144) & 0x1000LL) != 0 )
        v26 = NvmeAdapterRaiseIrqlAndExecuteXrb((_DWORD *)v3, v25);
      else
        v26 = NvmeAdapterExecuteXrb((_DWORD *)v3, v25, v24);
      v27 = v26;
      if ( v26 >= 0 )
