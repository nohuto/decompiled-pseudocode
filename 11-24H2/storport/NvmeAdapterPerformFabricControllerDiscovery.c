/*
 * XREFs of NvmeAdapterPerformFabricControllerDiscovery @ 0x1400E5B08
 * Callers:
...
__int64 __fastcall NvmeAdapterPerformFabricControllerDiscovery(__int64 a1, _BYTE *a2)
{
  ...
  *a2 = 0;
  while ( 1 )
  {
    ...
    *(_QWORD *)(a1 + 1600) = 0LL;
    ControllerLogPageSync = NvmeAdapterGetControllerLogPageSync(a1, v7, 0x70u, 0x400u, 0LL, v25, 0, &v27, &v34, &v36);
    v5 = v27;
    v9 = ControllerLogPageSync;
    ...
    if ( v12 )
    {
      while ( 2 )
      {
        ...
        if ( v12 < 4 )
          v14 = v12;
        LODWORD(v27) = v14;
        v15 = NvmeAdapterGetControllerLogPageSync(a1, v11, 0x70u, v14 << 10, v13, v26, 1, &P, &v34, &v36);
        v4 = (char *)P;
        v9 = v15;
        if ( v15 < 0 )
        {
        ...
        do
        {
          ...
          {
            if ( *v17 != *(_WORD *)(v29 + 4)
              || (v18 = (unsigned __int64)v16 << 10, _strnicmp(&v4[v18 + 256], (const char *)(v29 + 60), 0x100uLL))
              || _strnicmp(&v4[v18 + 512], (const char *)(v29 + 316), 0x100uLL) )
            {
              v9 = NvmeAdapterFabricControllerAddDiscoveryEntry((_QWORD *)a1, &v4[1024 * (unsigned __int64)v16]);
              if ( v9 < 0 )
              {
    ...
    ExFreePoolWithTag(v5, 0x52436152u);
    v27 = 0LL;
    v21 = NvmeAdapterGetControllerLogPageSync(a1, v20, 0x70u, 0x400u, 0LL, v26, 1, &v27, &v34, &v36);
    v5 = v27;
    v9 = v21;
    if ( v21 < 0 )
    {
