/*
 * XREFs of NvmeNativeDumpCreateDumpAdapterInfo @ 0x1401A02E4
 * Callers:
        ...
        _BYTE *a7)
{
  ...
  *(_OWORD *)(v20 + 24) = v22;
  v23 = (_DWORD *)RaidAllocatePool(64LL, 392LL, 1145266514LL, *(_QWORD *)(a1 + 8));
  v24 = v23;
  if ( v23 )
  {
    *v23 = 1145917490;
    ...
    *(_OWORD *)(v24 + 70) = *(_OWORD *)(a1 + 384);
    v29 = RaidAllocatePool(64LL, 132LL, 1145266514LL, *(_QWORD *)(a1 + 8));
    if ( !v29 )
    {
      v14 = -1073741670;
LABEL_31:
      if ( !v16 && v17 )
        NvmeNativeDumpFreeDumpDriverInfo(v41);
      if ( !v24 )
      {
LABEL_36:
        if ( !v20 )
...
LABEL_35:
    ...
    *((_QWORD *)v24 + 40) = v29;
    v24[82] = *(_DWORD *)(a2 + 56);
    v14 = NvmeNativeDumpCreateDumpDriverInfo(a1, a3, v41, &v44);
    if ( (v14 & 0x80000000) != 0 )
    {
      v16 = v44;
      v17 = v41[0];
    ...
    *(_WORD *)(a1 + 104) = 40;
    *(_WORD *)(a1 + 106) = 1;
    if ( RaidQueryCrashdumpFunctions(v34, (_LARGE_INTEGER)(a1 + 104)) >= 0
      && (v35 = *(_QWORD *)(a1 + 136)) != 0
      && *(_QWORD *)(a1 + 128) )
    {
      *((_QWORD *)v25 + 3) = v35;
