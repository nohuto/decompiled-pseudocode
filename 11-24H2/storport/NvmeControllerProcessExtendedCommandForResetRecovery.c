/*
 * XREFs of NvmeControllerProcessExtendedCommandForResetRecovery @ 0x1400F2EB8
 * Callers:
    ...
    if ( (result & 6) == 0 )
    {
      ...
      if ( (result & 0x2000) == 0 )
      {
        ...
        else
        {
          ...
          StorPushRequestToDeviceQueue(*(_QWORD *)(a1 + 1024), a3);
          _InterlockedOr(v14, 0);
          result = (unsigned int)_InterlockedCompareExchange(
                                   *(volatile signed __int32 **)(*(_QWORD *)(a1 + 1024) + 8 * v3 + 64),
                                   1,
                                   0);
          if ( !(_DWORD)result )
