/*
 * XREFs of RaDriverShutdownIrp @ 0x14006B9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( *(_BYTE *)(v33 + 1) == 7 && !*(_DWORD *)(v33 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v34 )
              v4 = *v34;
            LODWORD(v55) = v4;
            McTemplateK0pqd_EtwWriteTransfer(v32, v33, &v66, a2, v55, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_144;
        }
...
LABEL_90:
          ...
          McTemplateK0pd_EtwWriteTransfer(v32, v35, &v66, a2, v55);
        }
      }
LABEL_144:
...
LABEL_141:
      ...
      LODWORD(v55) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v32, v36, &v66, a2, v55, v50, v37, v40, v4, v53, a2);
    }
    goto LABEL_143;
  }
  if ( *v5 == 1314278989 )
...
LABEL_71:
        ...
        LODWORD(v55) = *(_DWORD *)(a2 + 48);
        McTemplateK0pduuuuup_EtwWriteTransfer(v31, v12, &v66, a2, v55, v26, v13, v16, v30, v31, a2);
      }
      goto LABEL_73;
    case 0x1B:
      if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
      {
        if ( (byte_140171462 & 0x40) != 0 )
        {
          ...
          if ( v9 )
            ...
            v10 = 0LL;
          LODWORD(v55) = v10;
          McTemplateK0pqd_EtwWriteTransfer(v10, v8, &v66, a2, v55, *(_DWORD *)(a2 + 48));
        }
        break;
      }
      if ( (byte_140171462 & 0x20) != 0 )
...
LABEL_20:
        LODWORD(v55) = *(_DWORD *)(a2 + 48);
        McTemplateK0pd_EtwWriteTransfer(v7, v11, &v66, a2, v55);
      }
      break;
  }
LABEL_74:
