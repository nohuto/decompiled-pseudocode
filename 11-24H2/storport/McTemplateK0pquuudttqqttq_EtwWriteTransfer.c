/*
 * XREFs of McTemplateK0pquuudttqqttq_EtwWriteTransfer @ 0x140076108
 * Callers:
...
NTSTATUS McTemplateK0pquuudttqqttq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitPoFxRegistered, 0LL, 0xEu, &v4);
}
