/*
 * XREFs of StorNotificationCsqCompleteCanceledIrp @ 0x140138290
 * Callers:
 *     <none>
 * Callees:
...
{
  void (__fastcall **p_CsqCompleteCanceledIrp)(_IO_CSQ *, _IRP *); // rbp
  bool v4; // zf
  __int64 v5; // rcx
    ...
    if ( CurrentStackLocation->MinorFunction == 7 && !CurrentStackLocation->Parameters.Read.Length )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( Information )
          ...
          v8 = 0LL;
        McTemplateK0pqd_EtwWriteTransfer(v8, (__int64)CurrentStackLocation, &v33, Irp, v8, Irp->IoStatus.Status);
      }
      goto LABEL_70;
    }
...
LABEL_69:
    McTemplateK0pd_EtwWriteTransfer(v5, v9, &v33, Irp, Irp->IoStatus.Status);
    goto LABEL_70;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_70;
