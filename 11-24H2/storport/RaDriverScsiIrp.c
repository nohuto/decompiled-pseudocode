/*
 * XREFs of RaDriverScsiIrp @ 0x1400038A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidAdapterIsRegisteredForIdleDetection @ 0x1400023C0 (RaidAdapterIsRegisteredForIdleDetection.c)
 ...
 *     RaUnitSwallowStopUnitCommand @ 0x1400056B8 (RaUnitSwallowStopUnitCommand.c)
...
__int64 __fastcall RaDriverScsiIrp(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_ce0a347073b43ea6ed7ab85136c3e909_Traceguids, a1, a2);
  }
  *(_BYTE *)(a2 + 141) = -88;
  v5 = *(_QWORD *)(a1 + 64);
  v6 = *(_DWORD *)v5;
...
LABEL_96:
      if ( (byte_140171462 & 8) != 0 )
        McTemplateK0pd_EtwWriteTransfer(v28, &EventNonReadWriteRequestComplete, &v240, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_54;
    }
    if ( byte_140171461 >= 0 )
      goto LABEL_54;
...
LABEL_286:
  ...
  if ( v11 < 0 )
  {
    v42 = RaidNtStatusToSrbStatus((unsigned int)v11);
    v60 = StorEtwLoggingEnabled == 0;
    *(_BYTE *)(v10 + 3) = v42;
    *(_QWORD *)(a2 + 56) = 0LL;
    *(_BYTE *)(a2 + 141) = -84;
...
LABEL_112:
          if ( (byte_140171462 & 0x20) != 0 )
            McTemplateK0pd_EtwWriteTransfer(v28, &EventPnpRequestComplete, &v240, a2, *(_DWORD *)(a2 + 48));
          goto LABEL_54;
        }
        if ( (byte_140171462 & 0x40) == 0 )
          goto LABEL_54;
...
LABEL_209:
        v86 = &v240;
LABEL_210:
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v28, (_DWORD)v27, (_DWORD)v86, a2, v8, *(_DWORD *)(a2 + 48));
        goto LABEL_54;
      }
      goto LABEL_96;
    }
...
LABEL_14:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 15LL, &WPP_e6323699744f33baefc587a6e43a33df_Traceguids, v5, a2, v16);
    v15 = v227;
  }
  if ( (v15 & 0x100000) == 0
    || (!RaidAdapterIsRegisteredForIdleDetection(*(_QWORD *)(v5 + 24))
     || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 4960LL) + 20LL) & 1) != 0)
        ...
        if ( *v17 == 27 && (v17[4] & 1) == 0 && (unsigned __int8)RaUnitSwallowStopUnitCommand(v5) )
        {
          ...
          *(_DWORD *)(a2 + 48) = 0;
          ...
          if ( *v37 != 15 )
          {
            ...
            {
              if ( (byte_140171462 & 8) != 0 )
                McTemplateK0pd_EtwWriteTransfer(v37, &EventNonReadWriteRequestComplete, &v242, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( v38 == 27 )
            {
              if ( v37[1] == 7 && !*((_DWORD *)v37 + 2) )
              {
                if ( (byte_140171462 & 0x40) != 0 )
                {
                  ...
                  if ( v67 )
                    ...
                    v68 = 0;
                  McTemplateK0pqd_EtwWriteTransfer(v68, v36, (unsigned int)&v242, a2, v68, *(_DWORD *)(a2 + 48));
                }
              }
              else if ( (byte_140171462 & 0x20) != 0 )
              {
                McTemplateK0pd_EtwWriteTransfer(v37, &EventPnpRequestComplete, &v242, a2, *(_DWORD *)(a2 + 48));
              }
            }
            goto LABEL_76;
          }
...
LABEL_35:
          ...
          if ( *v17 == 0xA2 )
          {
            ...
            {
LABEL_36:
              if ( StorEtwLoggingEnabled && (byte_140171461 & 0x1E) != 0 && ((*v17 - 8) & 0x5D) == 0 )
              {
...
LABEL_398:
              if ( (byte_140171462 & 0x20) != 0 )
                McTemplateK0pd_EtwWriteTransfer(v28, &EventPnpRequestComplete, &v241, a2, *(_DWORD *)(a2 + 48));
              goto LABEL_54;
            }
LABEL_400:
            if ( (byte_140171462 & 8) != 0 )
              McTemplateK0pd_EtwWriteTransfer(v28, &EventNonReadWriteRequestComplete, &v241, a2, *(_DWORD *)(a2 + 48));
            goto LABEL_54;
          }
          if ( byte_140171461 >= 0 )
            goto LABEL_54;
          ...
          if ( !v60 )
          {
            ...
            if ( *v154 != 15 )
            {
              ...
              else if ( v155 == 27 )
              {
                ...
                {
                  if ( (byte_140171462 & 0x20) != 0 )
                    McTemplateK0pd_EtwWriteTransfer(v154, &EventPnpRequestComplete, &v243, a2, *(_DWORD *)(a2 + 48));
                }
                else if ( (byte_140171462 & 0x40) != 0 )
                {
                  ...
                  if ( v156 )
                    ...
                    v157 = 0;
                  McTemplateK0pqd_EtwWriteTransfer(v157, v153, (unsigned int)&v243, a2, v157, *(_DWORD *)(a2 + 48));
                }
              }
              goto LABEL_553;
            }
...
LABEL_559:
          ...
          WPP_SF_qq(v180->AttachedDevice, v181, &WPP_e6323699744f33baefc587a6e43a33df_Traceguids, v5, a2);
LABEL_570:
          v12 = 0;
          goto LABEL_42;
        }
      ...
      case 23:
        ...
        *(_BYTE *)(a2 + 141) = -84;
        ...
        if ( *v204 != 15 )
        {
          ...
          {
            if ( (byte_140171462 & 8) != 0 )
              McTemplateK0pd_EtwWriteTransfer(v204, &EventNonReadWriteRequestComplete, &v241, a2, *(_DWORD *)(a2 + 48));
          }
          else if ( v205 == 27 )
          {
            ...
            {
              if ( (byte_140171462 & 0x20) != 0 )
                McTemplateK0pd_EtwWriteTransfer(v204, &EventPnpRequestComplete, &v241, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( (byte_140171462 & 0x40) != 0 )
            {
              v206 = *(_DWORD **)(a2 + 56);
...
LABEL_42:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_ce0a347073b43ea6ed7ab85136c3e909_Traceguids, a1, a2, v12);
  }
  return v12;
}
