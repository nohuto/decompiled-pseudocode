/*
 * XREFs of NvmeControllerCreateErrorRecoveryContext @ 0x1400EC3CC
 * Callers:
 *     NvmeAdapterCreateNvmeController @ 0x14019DFDC (NvmeAdapterCreateNvmeController.c)
 * Callees:
 *     RaidAllocatePool @ 0x14000E820 (RaidAllocatePool.c)
 *     NvmeControllerCreateCommandTimeoutDetectThread @ 0x1400EC2C8 (NvmeControllerCreateCommandTimeoutDetectThread.c)
 */

__int64 __fastcall NvmeControllerCreateErrorRecoveryContext(_QWORD *DeferredContext)
{
  __int64 Pool; // rax
  int CommandTimeoutDetectThread; // edi
  void *v4; // rcx
  __int64 v6; // rdx
  __int64 v7; // rdx
