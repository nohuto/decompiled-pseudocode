/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x14005505C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v40 = 1LL;
      v42 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v43, *(const wchar_t **)(v2 + 4720));
      ...
      v73 = &v18;
      v11 = v9[46];
      v18 = 3 * qword_140170E30;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_140170E30);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_140170E30) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_14016126B,
        v12,
        v13,
        0x1Du,
        &v30);
