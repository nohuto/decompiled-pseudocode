/*
 * XREFs of DeviceIdShimHookDeviceControl @ 0x1400BDB90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DeviceIdShimHookDeviceControl(__int64 a1, __int64 a2)
{
        ...
        if ( v8 )
        {
          if ( !v8[1] && *v8 == 2 )
          {
            ...
            if ( (unsigned int)v9 >= 8 )
            {
              ...
              (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), __int64))(qword_140170298 + 8))(
                a1,
                a2,
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD))qword_140170298)(*(_QWORD *)(a1 + 8));
