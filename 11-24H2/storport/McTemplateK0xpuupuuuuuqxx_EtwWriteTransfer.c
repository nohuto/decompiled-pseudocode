/*
 * XREFs of McTemplateK0xpuupuuuuuqxx_EtwWriteTransfer @ 0x1400A767C
 * Callers:
...
NTSTATUS McTemplateK0xpuupuuuuuqxx_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v28 = 8LL;
  v30 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, a3, 0xEu, &v4);
}
