/*
 * XREFs of NvmeAdapterStartRegistryWatch @ 0x1400D8E94
 * Callers:
...
__int64 __fastcall NvmeAdapterStartRegistryWatch(__int64 a1)
{
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( Pool )
      {
        ...
        if ( v6 )
        {
          ...
          Pool[1] = 0LL;
          *Pool = v7 + 16;
          v6[1] = NvmeAdapterUpdateDynamicRegistrySettings;
          *v6 = Pool;
          StorpInitRegistryWatch((__int64)KeyHandle, (__int64)v6);
          StorpWatchForRegistryChanges((__int64)v6);
          KeyHandle = 0LL;
          *(_QWORD *)(a1 + 992) = v6;
        }
        else
