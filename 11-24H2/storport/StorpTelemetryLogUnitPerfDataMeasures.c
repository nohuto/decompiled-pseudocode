/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x140034D34
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataMeasures(__int64 a1)
{
  ...
  {
    if ( (qword_140170188 & 0x400000000000LL) == 0 || (v1 = 1, (qword_140170190 & 0x400000000000LL) != qword_140170190) )
      v1 = 0;
    if ( v1 )
    {
      v2 = *(_QWORD *)(a1 + 24);
      ...
      v31[13] = 1LL;
      v31[15] = 1LL;
      tlgCreate1Sz_wchar_t(v32, *(_QWORD *)(v2 + 4720));
      tlgCreate1Sz_char(v33, v3 + 168);
      tlgCreate1Sz_char(v34, v4 + 177);
      tlgCreate1Sz_char(v35, v5 + 242);
      v36 = &v26;
      v17 = *(_BYTE *)(v6 + 8);
      v38 = &v17;
      v27 = *(_QWORD *)(v6 + 360);
      ...
      v61 = 8 * WORD1(TelemetryPerfContext);
      v53 = 8LL;
      v55 = 8LL;
      v57 = 24LL;
      v59 = 2LL;
      v62 = 0;
      tlgCreate1Sz_wchar_t(v63, v8);
      v65 = 26LL;
      ...
      v70 = &v19;
      v11 = v9[46];
      v19 = 3 * qword_140170E30;
      v72 = v11;
      v73 = 8 * (unsigned __int16)(3 * qword_140170E30);
      v74 = 0;
      tlgWriteTransfer_EtwWriteTransfer(3 * qword_140170E30, (int)&dword_14015FB6D, v12, v13, 0x1Fu, (__int64)v31);
    }
  }
}
