/*
 * XREFs of StorPortUnitIdleState @ 0x14001CBA0
 * Callers:
...
LABEL_12:
      if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1872) + 32LL) & 4) == 0
        || !(unsigned __int8)RaidIsUnitControlSupported(a1, 7LL) )
      {
        v12 = *(_QWORD *)(a1 + 24);
...
LABEL_143:
      ...
      if ( a3 <= v46
        ...
        && !(unsigned __int8)RaidAdapterPoFxActivateComponent(*(_QWORD *)(a1 + 24), 0LL, 0LL) )
      {
      ...
      if ( (unsigned __int8)RaidIsUnitControlSupported(a1, 7LL) )
      {
        ...
        v59 = v4;
        v60 = a3;
        RaCallMiniportUnitControl(v52, 7LL, v57);
      }
      if ( a3 > v46
...
LABEL_50:
        ...
        if ( !(unsigned __int8)RaidUnitCheckAndAcquirePoFx(*(_QWORD *)(v15 + 5016)) )
        {
LABEL_65:
          *(_BYTE *)(v15 + 4893) = v16;
          if ( v19 )
...
LABEL_72:
      ...
      if ( !(unsigned __int8)RaidUnitCheckAndAcquirePoFx(v27) )
      {
LABEL_87:
        *(_BYTE *)(v23 + 4893) = v24;
        if ( v27 )
