/*
 * XREFs of RaUnitSmartDataIoctl @ 0x1400987C8
 * Callers:
 ...
 *     RaUnitBuildSrbForSmartReadData @ 0x140091D38 (RaUnitBuildSrbForSmartReadData.c)
 *     RaUnitBuildSrbForSmartReturnStatus @ 0x140091FAC (RaUnitBuildSrbForSmartReturnStatus.c)
...
LABEL_22:
  ...
  if ( P )
  {
    v74 = (PVOID)RaidAllocatePool(64LL, 255LL, 1314087250LL, *(_QWORD *)(a1 + 8));
    if ( !v74 )
    {
      Status = -1073741801;
LABEL_33:
    ...
    RaUnitBuildSrbForSmartReturnStatus(a1, a2, Srb, (__int64)v74, v66, *((_BYTE *)v19 + 98));
    ...
    *((_BYTE *)v9 + 8) = v23;
    ...
    v68 = (__int64)v24;
    v26 = Irp;
    RaUnitBuildSrbForSmartReadData((__int64)Irp, a2, Srb, (__int64)P, v66, v68, v69, *((_BYTE *)v72 + 98));
    v28 = StorBuildSynchronousScsiRequest((__int64)v26->MdlAddress, Srb, v27, &v76);
    Irp = v28;
    if ( !v28 )
    {
      Status = -1073741801;
    ...
    v29 = RaSendIrpSynchronous((PDEVICE_OBJECT)v26->MdlAddress, v28);
    v30 = Irp;
    Status = v29;
    if ( v29 >= 0 )
    {
...
LABEL_34:
        ...
        if ( v74 )
          ExFreePoolWithTag(v74, 0x4E536152u);
        goto LABEL_36;
      }
  ...
  *(_DWORD *)(a2 + 48) = Status;
  ...
  if ( *(_BYTE *)v43 == 14 )
  {
    if ( (byte_140171462 & 8) == 0 )
      goto LABEL_124;
    v45 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
    goto LABEL_123;
  }
  if ( *(_BYTE *)v43 != 15 )
  {
    ...
    if ( *(_BYTE *)(v43 + 1) == 7 && !*(_DWORD *)(v43 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v66) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v42, v43, &v77, a2, v66, v67);
      }
      goto LABEL_124;
    }
...
LABEL_123:
    ...
    McTemplateK0pd_EtwWriteTransfer(v42, v45, &v77, a2, v66);
    goto LABEL_124;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_124;
...
LABEL_120:
      ...
      LODWORD(v66) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v42, v46, &v77, a2, v66, v67, v69, v70, v3, v64, a2);
      goto LABEL_124;
    }
LABEL_119:
    v50 = 0;
