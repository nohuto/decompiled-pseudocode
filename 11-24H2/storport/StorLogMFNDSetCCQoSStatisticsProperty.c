/*
 * XREFs of StorLogMFNDSetCCQoSStatisticsProperty @ 0x1400C5F50
 * Callers:
...
__int16 __fastcall StorLogMFNDSetCCQoSStatisticsProperty(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v7; // xmm0
  __int64 v8; // rcx
  int v9; // eax
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    v23 = 0;
    v24 = 0LL;
    LOWORD(v9) = RaidDriverGetName(v8, (__int64)&v20);
    v11 = *(__int16 **)(a1 + 6000);
    if ( v11 )
    {
      v27 = *(_OWORD *)(v11 + 12);
    ...
    if ( (byte_140171469 & 1) != 0 )
    {
      ...
      LOWORD(v9) = McTemplateK0qjzszhhssthhuuq_EtwWriteTransfer(
                     (__int64)v18,
                     &EventMFNDSetCCQoSStatisticsProperty,
                     v13,
                     *(_DWORD *)(a1 + 56),
                     (__int64)&v21,
                     *((const wchar_t **)&v20 + 1),
