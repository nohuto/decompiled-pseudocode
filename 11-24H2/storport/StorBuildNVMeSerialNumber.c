/*
 * XREFs of StorBuildNVMeSerialNumber @ 0x14008EC8C
 * Callers:
...
__int64 __fastcall StorBuildNVMeSerialNumber(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  {
    NvmeNamespaceGetIdentifier(a1, v4, &v22, &v20);
    if ( v20 == 16 )
    {
      v7 = 1;
LABEL_9:
...
LABEL_13:
  ...
  if ( v7 )
  {
    ...
    v15 = 16LL;
LABEL_20:
    v3 = StorSerialNumberFromNvmeId(v14, v15, a3, v13);
    goto LABEL_22;
  }
  if ( v10 )
  {
  ...
  *(_BYTE *)(a3 + 23) = `RaidHexFromUshort'::`2'::hexDigits[(unsigned __int8)v17 >> 4];
  *(_BYTE *)(a3 + 22) = `RaidHexFromUshort'::`2'::hexDigits[((unsigned int)v17 >> 8) & 0xF];
  *(_BYTE *)(a3 + 21) = `RaidHexFromUshort'::`2'::hexDigits[v17 >> 12];
  v18 = *(unsigned __int16 *)(a1 + 56);
  *(_BYTE *)(a3 + 28) = `RaidHexFromUshort'::`2'::hexDigits[*(_WORD *)(a1 + 56) & 0xF];
  *(_BYTE *)(a3 + 27) = `RaidHexFromUshort'::`2'::hexDigits[(unsigned __int8)v18 >> 4];
  *(_BYTE *)(a3 + 26) = `RaidHexFromUshort'::`2'::hexDigits[((unsigned int)v18 >> 8) & 0xF];
  *(_BYTE *)(a3 + 25) = `RaidHexFromUshort'::`2'::hexDigits[v18 >> 12];
  *(_BYTE *)(a3 + 29) = 46;
LABEL_22:
  if ( v3 < 0 )
    return 0;
