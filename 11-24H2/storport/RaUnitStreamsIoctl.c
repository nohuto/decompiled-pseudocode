/*
 * XREFs of RaUnitStreamsIoctl @ 0x14009CC74
 * Callers:
  ...
  *(_QWORD *)&v43.Data1 = a1;
  ...
  else
  {
    ...
    if ( Pool )
    {
      Pool[4] = v41[6];
      *Pool = 8;
      Pool[3] = *(_DWORD *)(a1 + 1392);
      Pool[6] = v8;
      if ( (_DWORD)v6 )
        memmove(Pool + 7, *(const void **)(a2 + 24), v6);
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v35) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v14, v15, &v43, a2, v35, v36);
      }
      goto LABEL_83;
    }
...
LABEL_82:
    ...
    McTemplateK0pd_EtwWriteTransfer(v14, v17, &v43, a2, v35);
    goto LABEL_83;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_83;
...
LABEL_78:
      ...
      LOBYTE(v36) = v30;
      LODWORD(v35) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v18, &v43, a2, v35, v36, v37, v22, v2, v33, a2);
    }
  }
LABEL_83:
