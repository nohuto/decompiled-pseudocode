/*
 * XREFs of RaUnitStorageNotificationConfigureIoctl @ 0x14009A3C4
 * Callers:
  ...
  if ( *(_BYTE *)*v5 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v2 = *v12;
        McTemplateK0pqd_EtwWriteTransfer(v10, v11, &v35, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_74;
    }
...
LABEL_69:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v10, v14, &v35, a2, *(_DWORD *)(a2 + 48), v26, v15, v18, v2, v29, a2);
    }
  }
LABEL_74:
