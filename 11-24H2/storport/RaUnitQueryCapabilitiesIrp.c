/*
 * XREFs of RaUnitQueryCapabilitiesIrp @ 0x1401B7B2C
 * Callers:
...
__int64 __fastcall RaUnitQueryCapabilitiesIrp(__int64 a1, __int64 a2)
{
  ...
  _OWORD v101[4]; // [rsp+90h] [rbp-29h] BYREF
...
LABEL_101:
      ...
      case 0x1B:
        if ( *(_BYTE *)(v49 + 1) == 7 && !*(_DWORD *)(v49 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v61 )
              v5 = *v61;
            McTemplateK0pqd_EtwWriteTransfer(v48, v49, &v100, a2, v5, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_49;
        }
    ...
    McTemplateK0pd_EtwWriteTransfer(v48, v51, &v100, a2, v91);
    goto LABEL_49;
  }
  v7 = 0;
  if ( *(_QWORD *)(v4 + 4960) )
  ...
  Pool = (_DWORD *)RaidAllocatePool(64LL, v97, 1918067026LL, *(_QWORD *)(a1 + 8));
  PortWdmGetDeviceCapabilities(*(PDEVICE_OBJECT *)(v4 + 8), v101);
  v10 = 256;
  *(_OWORD *)v8 = v101[0];
  *(_OWORD *)(v8 + 16) = v101[1];
  v11 = 128;
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 608) + 184LL) & 4) != 0 )
    {
      ...
      *Pool = 1572865;
      ...
      if ( v4 != -4736 && *(_BYTE *)(v4 + 4747) == 1 && *(_BYTE *)(v4 + 4746) == 6 )
        ...
        v47 = *(_DWORD *)(v8 + 8);
      Pool[2] = v47;
      Pool[1] = v46 & 0xFFFFF7FF;
    }
    v92 = 0;
    if ( (int)RaidPnPPassToMiniPort(*(_QWORD *)(a1 + 8), 9u, 0LL, (__int64)Pool, v97) >= 0 )
    {
      v13 = *(_DWORD *)(v8 + 4);
      v14 = Pool[1] ^ v13;
      if ( (*(_DWORD *)(*(_QWORD *)(v4 + 608) + 184LL) & 4) != 0 )
      {
        ...
        *(_DWORD *)(v8 + 4) = v24;
        *(_DWORD *)(v8 + 4) = v24 ^ (v24 ^ (Pool[1] << 7)) & 0x20000;
        *(_DWORD *)(v8 + 12) = Pool[3];
        *(_DWORD *)(v8 + 8) = Pool[2];
        if ( (Pool[1] & 0x800) != 0 )
        {
  ...
  *(_BYTE *)(a1 + 506) = v25 & 0x7F | ((unsigned __int8)(*(_DWORD *)(v8 + 4) >> 9) << 7);
  ...
  v27 = *(_QWORD *)(a1 + 24);
  if ( (v7 & 1) != 0 && RaidUnitCheckAndAcquirePoFx(v26) )
  {
    ...
    if ( *(_BYTE *)(v30 + 1) == 7 && !*(_DWORD *)(v30 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v52 )
          v5 = *v52;
        LODWORD(v90) = v5;
        McTemplateK0pqd_EtwWriteTransfer(v29, v30, &v100, a2, v90, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_26;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_52:
    ...
    McTemplateK0pd_EtwWriteTransfer(v29, v50, &v100, a2, v90, v92);
    goto LABEL_26;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_26;
...
LABEL_80:
          ...
          LODWORD(v90) = *(_DWORD *)(a2 + 48);
          McTemplateK0pduuuuup_EtwWriteTransfer(v29, v70, &v100, a2, v90, v92, v71, v56, v5, v60, a2);
          goto LABEL_26;
        }
LABEL_79:
        v56 = 0;
