/*
 * XREFs of RaUnitStorageSetPropertyIoctl @ 0x14018A9A8
 * Callers:
...
NTSTATUS __fastcall RaUnitStorageSetPropertyIoctl(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 8u )
  {
    ...
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( (byte_140171462 & 8) != 0 )
        McTemplateK0pd_EtwWriteTransfer(v29, &EventNonReadWriteRequestComplete, &v34, a2, *(_DWORD *)(a2 + 48));
    }
    ++*(_BYTE *)(a2 + 67);
    *(_QWORD *)(a2 + 184) += 72LL;
  ...
  *(_DWORD *)(a2 + 48) = -1073741585;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    v30 = *(_DWORD *)(a2 + 48);
LABEL_66:
    McTemplateK0pd_EtwWriteTransfer(v6, v9, &v34, a2, v30);
    goto LABEL_67;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_67;
...
LABEL_62:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v34, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_67:
