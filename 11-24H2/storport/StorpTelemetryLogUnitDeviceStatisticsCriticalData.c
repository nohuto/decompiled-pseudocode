/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1400B4068
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 && tlgKeywordOn(a1, 0x800000000000LL) )
  {
    v2 = *(_QWORD *)(v1 + 24);
    v47 = 16LL;
    v49 = 16LL;
    ...
    v55 = 1LL;
    v57 = 1LL;
    tlgCreate1Sz_wchar_t((__int64)v58, *(const wchar_t **)(v2 + 4720));
    tlgCreate1Sz_char((__int64)v59, (_BYTE *)(v3 + 168));
    tlgCreate1Sz_char((__int64)v60, (_BYTE *)(v4 + 177));
    tlgCreate1Sz_char((__int64)v61, (_BYTE *)(v5 + 242));
    v62 = &v43;
    v9 = -1;
    v10 = *(__int16 **)v7;
    ...
    v112 = &v33;
    v113 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v27, (unsigned __int8 *)dword_140162D38, v6, v7, 0x26u, &v45);
  }
}
