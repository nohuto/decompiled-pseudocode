/*
 * XREFs of StorEtwNvmeMiniportEvent @ 0x1400A9580
 * Callers:
        ...
        __int64 a12)
{
  ...
  const wchar_t *v72; // [rsp+100h] [rbp+0h]
  int v73; // [rsp+108h] [rbp+8h]
  int v74; // [rsp+10Ch] [rbp+Ch]
  const wchar_t *v75; // [rsp+110h] [rbp+10h]
...
LABEL_15:
  if ( a4 )
  {
    if ( a4 == 2 )
    {
      ...
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportHealthError;
      }
      else if ( v12 == 3 )
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportHealthWarning;
      }
      else
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportHealthInformational;
      }
    }
    else
    {
      ...
      if ( (unsigned int)(v12 - 1) <= 1 )
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportError;
      }
      else if ( v12 == 3 )
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportWarning;
      }
      else
      {
        v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportInformational;
      }
    }
  }
  else if ( (unsigned int)(v12 - 1) <= 1 )
  {
    v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportDiagnosticError;
  }
  else if ( v12 == 3 )
  {
    v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportDiagnosticWarning;
  }
  else
  {
    v23 = (EVENT_DESCRIPTOR)EventNVMeMiniportDiagnosticInformational;
  }
  EventDescriptor = v23;
  EventDescriptor.Opcode = a9;
  EventDescriptor.Level = v12;
  Keyword = StorEtwMiniportGetKeyword(a7, v23.Keyword);
  v25 = *(_QWORD *)(a1 + 16);
  EventDescriptor.Keyword = Keyword;
  RaidDriverGetName(v25, (__int64)&v54);
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  if ( !a2 )
    goto LABEL_47;
  v16 = (const wchar_t *)(a2 + 800);
  v29 = *(const wchar_t **)(a2 + 792);
  v17 = (const wchar_t *)(a2 + 841);
  v51 = *(_WORD *)(a2 + 4);
  v15 = &word_140150F48;
  if ( *(_QWORD *)(a2 + 752) )
    v15 = *(const wchar_t **)(a2 + 752);
  v52 = *(_DWORD *)(a2 + 744);
  if ( v29 )
  {
    v30 = -1LL;
...
LABEL_78:
        ...
        v48 = UserDataCount + 1;
        v47 *= 2LL;
        *(&UserData.Ptr + v47) = (unsigned __int64)v46;
        ...
        *(&UserData.Reserved + 2 * v47) = 0;
        ...
        UserDataCount = v48 + 1;
        ++v39;
        *(&UserData.Ptr + v50) = (unsigned __int64)v49;
