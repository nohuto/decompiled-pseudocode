/*
 * XREFs of McTemplateK0qjzshhssqqqqqqqqqxxxqqqqq_EtwWriteTransfer @ 0x1400AAC0C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzshhssqqqqqqqqqxxxqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a28)
{
  ...
  v92 = 4LL;
  v94 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v38, &EventDLRMStatistics, 0LL, 0x1Au, &v41);
}
