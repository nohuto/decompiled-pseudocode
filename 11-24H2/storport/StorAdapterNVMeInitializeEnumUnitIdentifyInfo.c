/*
 * XREFs of StorAdapterNVMeInitializeEnumUnitIdentifyInfo @ 0x1401B92F0
 * Callers:
 *     StorAdapterNVMeEnumerateZNS @ 0x1401B8B44 (StorAdapterNVMeEnumerateZNS.c)
 * Callees:
 *     RaidAllocatePool @ 0x14000E820 (RaidAllocatePool.c)
 *     StorUnitReleaseIdentifyNamespaceResources @ 0x14003D2B0 (StorUnitReleaseIdentifyNamespaceResources.c)
...
LABEL_13:
  ...
  v20 = v7;
  v21 = 0;
  while ( v19 && v21 < 0x1000 )
  {
    if ( v19 == 4 && v20[4] == 2 )
    {
      *(_DWORD *)(*(_QWORD *)(a3 + 8) + 1952LL) |= 0x20u;
      break;
    }
    v22 = v20[1];
    v21 += v22 + 4;
...
LABEL_15:
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3552LL) = v5;
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3560LL) = v8;
  }
