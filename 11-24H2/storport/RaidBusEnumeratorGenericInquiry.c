/*
 * XREFs of RaidBusEnumeratorGenericInquiry @ 0x14001A9E0
 * Callers:
 ...
 *     RaidBusEnumeratorReleaseDataBufferResource @ 0x140068D00 (RaidBusEnumeratorReleaseDataBufferResource.c)
 ...
 *     RaidInitializeInquirySrb @ 0x1401B7148 (RaidInitializeInquirySrb.c)
 */
...
LABEL_4:
    if ( !*(_QWORD *)(a2 + 32) )
    {
      Pool = RaidAllocatePool(64LL, 18LL, 1314087250LL, *((_QWORD *)v9 + 1));
      *(_QWORD *)(a2 + 32) = Pool;
      if ( !Pool )
        goto LABEL_40;
      v8 = 0;
...
LABEL_25:
    ...
    *(_BYTE *)(v13 + 1) = v23;
    *(_BYTE *)(v13 + 2) = v22;
    DataBufferResource = RaidBusEnumeratorIssueSynchronousRequest(a2, a4, (int)a2 + 8, v18, Irp);
