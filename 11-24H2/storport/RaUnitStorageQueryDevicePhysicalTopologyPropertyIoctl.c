/*
 * XREFs of RaUnitStorageQueryDevicePhysicalTopologyPropertyIoctl @ 0x14009BCE8
 * Callers:
...
LABEL_19:
  ...
  else
  {
    if ( v8 >= 0x38 )
    {
      v10 = RaBuildQueryPhysicalTopologyBufferForMiniport(*(_QWORD *)(a1 + 8), a2, (__int64 *)&P, &v42);
      v11 = (unsigned int *)P;
      v9 = v10;
      if ( v10 >= 0 )
      {
        v9 = RaidUnitSendSrbIoControlSynchronously(a1, a2, (__int64)P, v42, 0LL, 0, 64);
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v37) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v14, v15, &v45, a2, v37, v38);
      }
      goto LABEL_86;
    }
...
LABEL_85:
    ...
    McTemplateK0pd_EtwWriteTransfer(v14, v17, &v45, a2, v37);
    goto LABEL_86;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_86;
...
LABEL_81:
      ...
      LOBYTE(v38) = v32;
      LODWORD(v37) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v18, &v45, a2, v37, v38, v39, v22, v3, v35, a2);
    }
  }
LABEL_86:
