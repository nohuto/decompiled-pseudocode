/*
 * XREFs of StorPortSetDeviceQueueDepth @ 0x140027440
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidSetIoQueueDepth @ 0x140033814 (RaidSetIoQueueDepth.c)
        ...
        unsigned int a5)
{
  ...
  if ( CurrentIrql )
  {
    ...
    else
    {
      ...
      v18 = RaidAdapterFindUnitAtDirql(v10, v25);
      LOBYTE(v19) = v17;
      UnitAtDirql = v18;
      RaidAdapterReleaseInterruptLock(v10, v19);
    }
  }
  else
  {
  ...
  if ( *((_DWORD *)UnitAtDirql + 181) == a5 )
    return 1;
  v20 = RaidSetIoQueueDepth(UnitAtDirql + 88);
  if ( v20 == v21 )
  {
    v6 = 1;
