/*
 * XREFs of NvmeAdapterSetMaxOperationalPower @ 0x14013165C
 * Callers:
 *     NvmeAdapterPowerCapIoctl @ 0x1400D50F0 (NvmeAdapterPowerCapIoctl.c)
 *     NvmeAdapterPassiveCoolingCallback @ 0x14012EE90 (NvmeAdapterPassiveCoolingCallback.c)
 *     NvmePowerSettingCallback @ 0x140136080 (NvmePowerSettingCallback.c)
 * Callees:
 *     NvmeAdapterEffectiveMaxOperationalPower @ 0x14012E63C (NvmeAdapterEffectiveMaxOperationalPower.c)
 *     NvmeControllerMaxOperationalPower @ 0x1401322A4 (NvmeControllerMaxOperationalPower.c)
 */

__int64 __fastcall NvmeAdapterSetMaxOperationalPower(__int64 a1, unsigned __int64 *a2, char a3, int a4)
{
...
LABEL_10:
  ...
  *(_QWORD *)(v7 + 8LL * a4 + 40) = v5;
  v11 = NvmeAdapterEffectiveMaxOperationalPower(v7);
  v13 = *(_QWORD *)(v12 + 400);
  v18 = v11;
  if ( (*(_DWORD *)(v13 + 184) & 0x40000000) != 0 )
  {
    NvmeControllerMaxOperationalPower(*(_QWORD *)(v12 + 1136), v17);
    v11 = v18;
  }
  if ( a3 )
  {
