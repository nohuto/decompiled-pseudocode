/*
 * XREFs of StorpTelemetrySendUnitIoSizeDistributionData @ 0x1400BB4B0
 * Callers:
...
__int64 __fastcall StorpTelemetrySendUnitIoSizeDistributionData(__int64 a1)
{
  ...
  if ( *(_QWORD *)(v1 + 2384) )
  {
    Pool = (_QWORD *)RaidAllocatePool(72LL, (unsigned int)dword_140170E44, 1700028754LL, *(_QWORD *)(v1 + 8));
    v5 = Pool;
    if ( Pool
      && (RecommendedSharedDataAlignment = KeGetRecommendedSharedDataAlignment(),
          ...
          (v6 = (_QWORD *)RaidAllocatePool(
                            ...
                            *(_QWORD *)(v1 + 8))) != 0LL) )
    {
      memmove(Pool, *(const void **)(v1 + 2384), (unsigned int)dword_140170E44);
      for ( i = 1; i < g_RaidNumberProcessors; ++i )
      {
        v10 = (unsigned int)dword_140170E3C * i;
        if ( (_DWORD)v2 )
        {
          v11 = Pool + 1;
          v12 = v2;
      ...
      memmove(*(void **)(v1 + 2408), Pool, (unsigned int)dword_140170E3C);
      if ( v3 )
      {
        v19 = 0;
        v20 = 0LL;
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( v22 >= 9 )
              break;
            v24 = (void *)RaidAllocatePool(64LL, 351LL, 1700028754LL, *(_QWORD *)(v1 + 8));
            v25 = v52 + v20;
            v26 = *(_QWORD *)(v1 + 8);
            v27 = v24;
            P[v25] = v24;
            ...
            do
            {
              ...
              *(_OWORD *)pszSrc = 0LL;
              v33 = 2LL
                  * (v51 + (unsigned __int16)xmmword_140170E00 * (v50 + v29 * (unsigned int)WORD1(xmmword_140170E00)));
              StringCchPrintfA(
                pszDest,
                0x14uLL,
                "%lld",
                v6[2 * v51
                 + 2 * (unsigned __int16)xmmword_140170E00 * (v50 + v29 * (unsigned int)WORD1(xmmword_140170E00))]);
        ...
        {
          v41 = *(_QWORD *)(v1 + 24);
          v42 = (const char *)&word_140150F48;
          v43 = (const wchar_t *)&unk_140151214;
          if ( v39 )
            v42 = v39;
          if ( *(_QWORD *)(v41 + 5080) )
