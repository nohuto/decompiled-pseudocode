/*
 * XREFs of RaidRegisterForRuntimePowerManagement @ 0x1400781BC
 * Callers:
...
LABEL_37:
  ...
  if ( v45 >= 0 )
  {
    ...
    if ( v48 == 1431193940 )
    {
      ...
      if ( (unsigned int)dword_140170178 > 5 )
      {
        if ( tlgKeywordOn(v47, 0x400000000000LL) )
        {
          ...
          LODWORD(v66) = v53;
          v93 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer(v54, byte_14015E38F, v50, v51, 0xEu, v69);
        }
      }
    }
           ...
           && tlgKeywordOn((unsigned int)*a2, 0x400000000000LL) )
    {
      ...
      v62 = v58;
      v81 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v55, (unsigned __int8 *)dword_14015E456, v56, v57, 8u, v69);
    }
  }
