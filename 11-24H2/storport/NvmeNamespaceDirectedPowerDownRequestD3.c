/*
 * XREFs of NvmeNamespaceDirectedPowerDownRequestD3 @ 0x1401332AC
 * Callers:
 *     NvmeNamespaceDirectedPowerDown @ 0x140133170 (NvmeNamespaceDirectedPowerDown.c)
 *     NvmeNamespaceDirectedPowerDownRequestD3Passive @ 0x140133490 (NvmeNamespaceDirectedPowerDownRequestD3Passive.c)
 * Callees:
 *     <none>
 */

void __fastcall NvmeNamespaceDirectedPowerDownRequestD3(char *Context)
{
  KSPIN_LOCK *v2; // rcx
  __int64 v3; // rax
