/*
 * XREFs of NvmeNamespaceScsiModeSelectRequest @ 0x1401181E8
 * Callers:
...
__int64 __fastcall NvmeNamespaceScsiModeSelectRequest(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  unsigned int v4; // ebx
  _BYTE *v5; // rsi
  bool v6; // zf
