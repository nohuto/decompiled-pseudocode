/*
 * XREFs of SrbShimHookDeviceControl @ 0x140033160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SrbShimHookDeviceControl(__int64 a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)v2 + 6) == 2954240 )
  {
    ...
    if ( v8 )
    {
      if ( !v8[1] && *v8 == 1 && *((_DWORD *)v2 + 2) >= 0x20u )
      {
        ...
        (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), _QWORD))(qword_140170300 + 8))(
          a1,
          a2,
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD))qword_140170300)(*(_QWORD *)(a1 + 8));
