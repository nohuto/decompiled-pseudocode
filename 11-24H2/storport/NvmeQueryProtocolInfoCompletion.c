/*
 * XREFs of NvmeQueryProtocolInfoCompletion @ 0x14012AD40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeQueryProtocolInfoCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // ebx
  __int64 v5; // rdx
  char v6; // si
  ...
  union _SLIST_HEADER *v90; // [rsp+78h] [rbp-11h]
  ...
  *(_QWORD *)&v94.Data1 = *(_QWORD *)(v5 + 4216);
  ...
  if ( a3 )
  {
    Data = NvmeProtocolSpecificRequestGetData((__int64)v7, (*(_DWORD *)(v5 + 4256) & 0x400) != 0, &v88, v86);
    v18 = v88;
    v10 = Data;
    if ( Data < 0 )
      goto LABEL_170;
          ...
          if ( v8 )
          {
            if ( v6 )
            {
              ...
              if ( v43 != v44 )
              {
                ...
                NvmeControllerReuseExtendedCommand(v47, (__int64)a2);
                v49 = *(_DWORD *)(v8 + 44);
                if ( !v49 )
                  *(_DWORD *)(v8 + 4) &= ~1u;
                ...
                *(_DWORD *)(*a2 + 4248) = v46;
                ...
                else
                {
                  ...
                  *(_DWORD *)(*a2 + 4136) ^= ((unsigned __int16)*(_DWORD *)(*a2 + 4136) ^ (unsigned __int16)((unsigned __int16)v18[9] << 7)) & 0xF00;
                  if ( NvmeControllerSupportsUUIDList(v45) && (v18[9] & 0x7F00) != 0 && *(_BYTE *)v8 >= 0xC0u )
                ...
                v10 = NvmeControllerProcessCommand(v45, a2);
                if ( v10 >= 0 )
                  return;
              }
            }
...
LABEL_5:
  v12 = v90;
  NvmeFreeDmaBuffer((__int64)v90, *(_DWORD *)(*a2 + 4248), a3, *(_QWORD *)(*a2 + 4160), *(_QWORD *)(*a2 + 4168));
  v13 = *(void **)(*a2 + 4208);
  if ( v13 )
  {
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v79) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v14, v15, &v94, v7, v79, v80);
      }
      goto LABEL_239;
    }
...
LABEL_238:
    ...
    McTemplateK0pd_EtwWriteTransfer(v14, v60, &v94, v7, v79);
    goto LABEL_239;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_239;
...
LABEL_235:
      ...
      LODWORD(v79) = v7->IoStatus.Status;
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v61, &v94, v7, v79, v80, v81, v82, v83, v84, v7);
      goto LABEL_239;
    }
LABEL_234:
    v65 = 0;
