/*
 * XREFs of NvmeNamespaceStorageQueryAdapterPropertyIoctl @ 0x1401AB340
 * Callers:
...
NTSTATUS __fastcall NvmeNamespaceStorageQueryAdapterPropertyIoctl(__int64 a1, __int64 a2)
{
  ...
  if ( Irp )
  {
    ...
    *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(v2 + 32);
    ...
    v40 = RaSendIrpSynchronous(*(PDEVICE_OBJECT *)(v6 + 8), v11);
    v10 = v40;
    if ( v40 >= 0 )
    {
      v13 = *(_DWORD *)(v5 + 8);
  ...
  if ( *(_BYTE *)v16 != 15 )
  {
    ...
    if ( *(_BYTE *)(v16 + 1) == 7 && !*(_DWORD *)(v16 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v17 )
          v8 = *v17;
        McTemplateK0pqd_EtwWriteTransfer(v15, v16, &v42, a2, v8, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_75;
    }
...
LABEL_74:
    McTemplateK0pd_EtwWriteTransfer(v15, v18, &v42, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_75;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_75;
