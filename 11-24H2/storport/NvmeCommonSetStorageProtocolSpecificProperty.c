/*
 * XREFs of NvmeCommonSetStorageProtocolSpecificProperty @ 0x140128A68
 * Callers:
...
__int64 __fastcall NvmeCommonSetStorageProtocolSpecificProperty(__int64 a1, _QWORD *a2, _BYTE *a3)
{
  __int64 v3; // rax
  unsigned int v4; // r9d
  _DWORD *v5; // r11
  ...
  *a3 = 1;
  ...
  if ( v9 >= 0x48 )
  {
    ...
    if ( !v14 || (unsigned __int64)v12 + v13 + v14 - (_QWORD)v5 <= v8 && v14 + (_DWORD)v13 + 8 <= v9 )
      return (unsigned int)NvmeProcessSetProtocolSpecificProperty(a1, (__int64)a2, a3);
    return (unsigned int)-1073741585;
  }
  if ( v9 < 8 )
  {
