/*
 * XREFs of RaUnitFlushQueueSrb @ 0x140093090
 * Callers:
...
LABEL_33:
            ...
            McTemplateK0pd_EtwWriteTransfer(v18, v22, &v82, v11, v66);
          }
          break;
        case 0xF:
          if ( byte_140171461 >= 0 )
...
LABEL_84:
                  ...
                  LOBYTE(v67) = v37;
                  LODWORD(v66) = *(_DWORD *)(v11 + 48);
                  McTemplateK0pduuuuup_EtwWriteTransfer(v43, v23, &v82, v11, v66, v67, v68, v69, v70, v71, v11);
                }
              }
            }
          }
        ...
        case 0x1B:
          ...
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            LODWORD(v66) = v21;
            McTemplateK0pqd_EtwWriteTransfer(v21, v19, &v82, v11, v66, v67);
          }
          break;
        default:
          break;
  ...
  *(_DWORD *)(a2 + 48) = 0;
  ...
  if ( *(_BYTE *)v45 == 14 )
  {
    if ( (byte_140171462 & 8) == 0 )
      goto LABEL_155;
    v47 = (const EVENT_DESCRIPTOR *)&EventNonReadWriteRequestComplete;
    goto LABEL_154;
  }
  if ( *(_BYTE *)v45 != 15 )
  {
    ...
    if ( *(_BYTE *)(v45 + 1) == 7 && !*(_DWORD *)(v45 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v66) = v6;
        McTemplateK0pqd_EtwWriteTransfer(v44, v45, &v83, a2, v66, v67);
      }
      goto LABEL_155;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_154:
    ...
    McTemplateK0pd_EtwWriteTransfer(v44, v47, &v83, a2, v66);
    goto LABEL_155;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_155;
...
LABEL_151:
      ...
      LOBYTE(v67) = v61;
      LODWORD(v66) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v44, v48, &v83, a2, v66, v67, v68, v69, v70, v71, a2);
      goto LABEL_155;
    }
LABEL_150:
    v52 = 0;
