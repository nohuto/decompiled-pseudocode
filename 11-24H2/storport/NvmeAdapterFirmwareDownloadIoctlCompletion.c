/*
 * XREFs of NvmeAdapterFirmwareDownloadIoctlCompletion @ 0x1400D1E00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeAdapterFirmwareDownloadIoctlCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // edi
  __int64 v5; // rcx
  __int16 v7; // ax
...
LABEL_29:
  ...
  *(_DWORD *)(v23 + 48) = v21;
  *(_QWORD *)(v23 + 56) = 0LL;
  NvmeFreeDmaBuffer(a1, *(_DWORD *)(*a2 + 4248), v8, *(_QWORD *)(*a2 + 4160), *(_QWORD *)(*a2 + 4168));
  ...
  if ( *(_BYTE *)v64 != 15 )
  {
    ...
    if ( *(_BYTE *)(v64 + 1) == 7 && !*(_DWORD *)(v64 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v83) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v63, v64, &v92, v23, v83, v84);
      }
      goto LABEL_167;
    }
...
LABEL_166:
    ...
    McTemplateK0pd_EtwWriteTransfer(v63, v66, &v92, v23, v83);
    goto LABEL_167;
  }
...
LABEL_163:
      ...
      LOBYTE(v84) = v79;
      LODWORD(v83) = *(_DWORD *)(v23 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v63, v67, &v92, v23, v83, v84, v85, v86, v87, v88, v23);
      goto LABEL_167;
    }
LABEL_162:
    v71 = 0;
