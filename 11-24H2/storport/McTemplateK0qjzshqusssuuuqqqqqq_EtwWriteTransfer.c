/*
 * XREFs of McTemplateK0qjzshqusssuuuqqqqqq_EtwWriteTransfer @ 0x1400FA680
 * Callers:
        ...
        char a22)
{
  ...
  v79 = 4LL;
  v81 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v35, &EventNVMeNamespaceRequestFailure, 0LL, 0x14u, &v38);
}
