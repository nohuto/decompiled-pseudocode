/*
 * XREFs of RaidBusEnumeratorProbeLunZero @ 0x14001A200
 * Callers:
...
__int64 __fastcall RaidBusEnumeratorProbeLunZero(__int64 *a1, int a2)
{
  __int64 result; // rax
  PIRP *v5; // rsi
  void *v6; // rcx
  ...
  result = RaidBusEnumeratorGetUnit(a1, a2, (__int64)v56);
  if ( (int)result < 0 )
    return result;
  v54 = 0;
  v5 = (PIRP *)(a1 + 1);
  ...
  while ( 1 )
  {
    ...
    if ( *(_BYTE *)v40 == 1 )
    {
      ...
      if ( !Pool2 && v41 )
      {
        RaidLogAllocationFailure(v41, 64, 184, 1918067026, 0x80000000);
        a1[3] = 0LL;
        goto LABEL_25;
      }
      if ( Pool2 )
    ...
    else
    {
      ...
      if ( !v42 && v41 )
        RaidLogAllocationFailure(v41, 64, 88, 1918067026, 0x80000000);
    }
    a1[3] = v42;
    if ( !v42 )
      goto LABEL_25;
LABEL_5:
    if ( !a1[4] )
    {
      Pool = RaidAllocatePool(64LL, 18LL, 1314087250LL, *(_QWORD *)(v8 + 8));
      a1[4] = Pool;
      if ( !Pool )
        goto LABEL_25;
      v7 = 0;
    ...
    *((_DWORD *)a1 + 12) = 512;
    ...
    if ( !v11 && v43 )
      RaidLogAllocationFailure(v43, 64, 512, 842096978, 0x80000000);
    a1[5] = (__int64)v11;
    if ( !v11 )
      break;
LABEL_10:
...
LABEL_90:
    ...
    LOBYTE(v9) = BYTE1(v61);
    LOBYTE(v18) = a2;
    RaidInitializeInquirySrb(v17, v18, v9, v10, a1[5], v15, *(_BYTE *)v20);
    if ( *(_BYTE *)v20 == 1 )
    {
      *(_QWORD *)(v17 + 104) = 0LL;
      v50 = 0LL;
...
LABEL_24:
    *(_BYTE *)(v19 + 1) &= ~1u;
    *(_BYTE *)(v19 + 2) = 0;
    if ( (int)RaidBusEnumeratorIssueSynchronousRequest((_DWORD)a1, (unsigned int)v56, (int)a1 + 8, v17, v53) < 0 )
      goto LABEL_25;
    RaidBusEnumeratorProcessProbeLunZero(a1, v17, v56, &v60, &v54);
    if ( !(_BYTE)v60 || v62 || (int)RaidBusEnumeratorReAllocateDataBufferResource(a1, a1 + 1, v54) < 0 )
      goto LABEL_25;
    v63 = 1;
    v62 = 1;
  }
...
LABEL_25:
  ...
  if ( v58 )
  {
    ...
    v25 = RaidAdapterAcquireInterruptLock(v24);
