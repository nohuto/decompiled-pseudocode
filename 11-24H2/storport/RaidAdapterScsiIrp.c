/*
 * XREFs of RaidAdapterScsiIrp @ 0x140182C78
 * Callers:
...
__int64 __fastcall RaidAdapterScsiIrp(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 48) = -1073741823;
  ...
  if ( *(_BYTE *)v6 != 15 )
  {
    ...
    if ( *(_BYTE *)(v6 + 1) == 7 && !*(_DWORD *)(v6 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v7 )
          v3 = *v7;
        LODWORD(v27) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v5, v6, &v31, a2, v27, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_70;
    }
    ...
    LODWORD(v27) = *(_DWORD *)(a2 + 48);
LABEL_69:
    McTemplateK0pd_EtwWriteTransfer(v5, v8, &v31, a2, v27);
    goto LABEL_70;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_70;
...
LABEL_65:
      ...
      LODWORD(v27) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v5, v9, &v31, a2, v27, v22, v10, v13, v3, v25, a2);
    }
  }
LABEL_70:
