/*
 * XREFs of NvmeAdapterSetLedState @ 0x1400D70B0
 * Callers:
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v16 )
          v3 = *v16;
        McTemplateK0pqd_EtwWriteTransfer(v14, v15, &v39, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_82;
    }
...
LABEL_81:
    McTemplateK0pd_EtwWriteTransfer(v14, v17, &v39, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_82;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_82;
...
LABEL_77:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v14, v18, &v39, a2, *(_DWORD *)(a2 + 48), v31, v19, v22, v3, v34, a2);
    }
  }
LABEL_82:
