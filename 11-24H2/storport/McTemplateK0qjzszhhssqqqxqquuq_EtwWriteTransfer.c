/*
 * XREFs of McTemplateK0qjzszhhssqqqxqquuq_EtwWriteTransfer @ 0x1400578E8
 * Callers:
        ...
        char a21)
{
  ...
  int v81; // [rsp+1B8h] [rbp+B8h] BYREF
  ...
  v78 = 1LL;
  v80 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v36, a2, 0LL, 0x13u, &v39);
}
