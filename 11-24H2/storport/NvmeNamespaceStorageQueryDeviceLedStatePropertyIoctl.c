/*
 * XREFs of NvmeNamespaceStorageQueryDeviceLedStatePropertyIoctl @ 0x1401AD0C0
 * Callers:
...
LABEL_66:
      ...
      case 0x1B:
        if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
        {
          ...
          v11 = (const GUID *)&v142;
LABEL_12:
          McTemplateK0pqd_EtwWriteTransfer(v8, v9, v11, a2, v2, *(_DWORD *)(a2 + 48));
          goto LABEL_13;
        }
        if ( (byte_140171462 & 0x20) == 0 )
          goto LABEL_13;
    ...
    v33 = (const GUID *)&v142;
LABEL_70:
    McTemplateK0pd_EtwWriteTransfer(v8, v14, v33, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_13;
  }
  v51 = v3[1];
  if ( !v51 )
  {
    if ( (unsigned int)v5 >= 0x10 )
    {
      if ( (*(_DWORD *)(v6 + 144) & 0x40000) != 0
        || (LedState = NvmeAdapterQueryLedState(*(_QWORD *)(v6 + 8), *(_QWORD *)(v6 + 576) + 160LL),
            v135 = LedState,
            LedState >= 0) )
      {
        memset_0(v3, 0, v5);
        ...
        switch ( *(_BYTE *)v52 )
        {
          case 0xE:
            if ( (byte_140171462 & 8) == 0 )
              goto LABEL_14;
            v73 = (const GUID *)&v145;
            v55 = &EventNonReadWriteRequestComplete;
            break;
          case 0xF:
            if ( byte_140171461 >= 0 )
              goto LABEL_14;
...
LABEL_203:
        McTemplateK0pd_EtwWriteTransfer(v8, v55, v73, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_14;
      }
      v135 = LedState;
      v12 = LedState;
        ...
        if ( *(_BYTE *)(v75 + 1) == 7 && !*(_DWORD *)(v75 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v76 )
              ...
              v77 = 0LL;
            McTemplateK0pqd_EtwWriteTransfer(v77, v75, &v144, a2, v77, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_269;
        }
        if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_269:
    ...
    McTemplateK0pd_EtwWriteTransfer(v74, v78, &v144, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_269;
  }
  v7 = StorEtwLoggingEnabled == 0;
  v12 = -1073741637;
...
LABEL_202:
  ...
  if ( *(_BYTE *)v52 != 15 )
  {
    ...
    if ( *(_BYTE *)(v52 + 1) == 7 && !*(_DWORD *)(v52 + 8) )
    {
      ...
      v54 = &v143;
LABEL_289:
      McTemplateK0pqd_EtwWriteTransfer(v8, v52, v54, a2, v2, *(_DWORD *)(a2 + 48));
      goto LABEL_14;
    }
    if ( (byte_140171462 & 0x20) == 0 )
      goto LABEL_14;
...
LABEL_198:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v8, v56, &v143, a2, *(_DWORD *)(a2 + 48), v69, v57, v60, v2, v72, a2);
    }
  }
LABEL_14:
