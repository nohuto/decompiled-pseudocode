/*
 * XREFs of NvmeAdapterDirectedPowerDownRequestD3 @ 0x14012E190
 * Callers:
 *     NvmeAdapterDirectedPowerDown @ 0x14012E0F0 (NvmeAdapterDirectedPowerDown.c)
 *     NvmeAdapterDirectedPowerDownRequestD3Passive @ 0x14012E390 (NvmeAdapterDirectedPowerDownRequestD3Passive.c)
 * Callees:
 *     NvmeAdapterReleasePoFx @ 0x1401311D4 (NvmeAdapterReleasePoFx.c)
 */

void __fastcall NvmeAdapterDirectedPowerDownRequestD3(PVOID Context)
{
  KSPIN_LOCK *v2; // rcx
  __int64 v3; // rcx
  __int64 v4; // rcx
