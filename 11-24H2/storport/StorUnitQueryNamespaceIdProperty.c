/*
 * XREFs of StorUnitQueryNamespaceIdProperty @ 0x14018D758
 * Callers:
...
__int64 __fastcall StorUnitQueryNamespaceIdProperty(__int64 a1, __int64 a2)
{
  int v2; // ebx
  int *v4; // rdx
  unsigned int v5; // esi
