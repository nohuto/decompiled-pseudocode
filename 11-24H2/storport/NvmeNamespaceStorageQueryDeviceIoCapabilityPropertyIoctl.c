/*
 * XREFs of NvmeNamespaceStorageQueryDeviceIoCapabilityPropertyIoctl @ 0x1401ACCC0
 * Callers:
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v4 = *v14;
        McTemplateK0pqd_EtwWriteTransfer(v12, v13, &v38, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_76;
    }
...
LABEL_71:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v12, v16, &v38, a2, *(_DWORD *)(a2 + 48), v28, v17, v20, v4, v31, a2);
    }
  }
LABEL_76:
