/*
 * XREFs of McTemplateK0qjzszhhssxhhhxquxqbr17_EtwWriteTransfer @ 0x14008677C
 * Callers:
        ...
        __int64 a22)
{
  ...
  v81 = 4LL;
  v83 = 4096LL;
  return McGenEventWrite_EtwWriteTransfer(v36, &EventNvmeErrorInfoLog, 0LL, 0x14u, &v40);
}
