/*
 * XREFs of NvmeControllerProcessPendingCommand @ 0x1401297E0
 * Callers:
...
bool __fastcall NvmeControllerProcessPendingCommand(__int64 a1, int a2, int a3, __int64 a4, char a5)
{
  _DWORD *v5; // r13
  __int64 v7; // rdi
  __int64 v8; // r8
  ...
  while ( 2 )
  {
    for ( i = *(_QWORD *)(*(_QWORD *)(v8 + 1024) + 8LL * (unsigned int)v7 + 64);
          !*(_DWORD *)i && *(_DWORD *)(i + 48) == *(_DWORD *)(i + 52);
          i = *(_QWORD *)(*(_QWORD *)(v8 + 1024) + 8 * v7 + 64) )
    {
      v11 = v7 + 1;
      v7 = 0LL;
      if ( v11 < v5[2] )
    ...
    while ( 1 )
    {
      ...
      if ( (_DWORD)v14 == _InterlockedCompareExchange((volatile signed __int32 *)(i + 52), v15, v14) )
      {
                ...
                v18 <= *(_DWORD *)(*(_QWORD *)(i + 16) + 8LL)) )
          {
            if ( !_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(i + 16) + 16LL), 1, 0) )
            {
              ...
              if ( *(_BYTE *)(*(_QWORD *)(i + 16) + 20LL) )
                ...
                KeSetEvent((PRKEVENT)(v21 + 480), 0, 0);
            }
          }
        }
        KeLowerIrql(v13);
        ...
        else
        {
          ...
          v23 = NvmeControllerSendNonReadWriteCommand(*(_QWORD *)(i + 24), v9, v7, a3, v12);
          if ( v23 == 259 )
          {
            v9 = 0LL;
            if ( v12 )
...
LABEL_56:
    ...
    if ( v29 == (_DWORD)v7 )
      return a4 == 0;
LABEL_59:
    v26 = StorCheckDpcWatchdogTimerExpire(0xAu, 5u);
    a2 = v29;
    v8 = a1;
    if ( !v26 )
      continue;
