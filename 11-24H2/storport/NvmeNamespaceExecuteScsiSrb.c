/*
 * XREFs of NvmeNamespaceExecuteScsiSrb @ 0x140100028
 * Callers:
...
LABEL_80:
  ...
  if ( (*(_BYTE *)(a1 + 112) & 2) != 0 && *(_DWORD *)(a1 + 64) )
  {
    ...
    {
      if ( v27 == 37 || v27 == -98 )
        return (unsigned int)NvmeNamespaceScsiReadCapacityRequest(a1, v25, a2, v7);
LABEL_52:
      if ( v27 == 77 )
        return (unsigned int)NvmeNamespaceScsiLogSenseRequest(a1, v25, a2, v7);
      if ( v27 == 18 )
        return (unsigned int)NvmeNamespaceScsiInquiryRequest(a1, v25, a2, v7);
      if ( ((v27 - 26) & 0xBF) == 0 )
        return (unsigned int)NvmeNamespaceScsiModeSenseRequest(a1, v25, a2, v7);
      if ( ((v27 - 21) & 0xBF) == 0 )
        return (unsigned int)NvmeNamespaceScsiModeSelectRequest(a1, v25, a2, v7);
      switch ( v27 )
      {
        case 47:
        case -113:
        ...
        case 27:
          *(_BYTE *)(a2 + 3) = 1;
          break;
        case 53:
          v29 = NvmeNamespaceScsiSyncCacheRequest(a1, a3, a2, v24, CurrentProcessorNumber);
LABEL_73:
          v3 = v29;
          if ( v29 == -2147483631 || v29 == -1073741300 )
          {
            NvmeNamespaceQueueRequest(a1, a3, v26);
            return 259;
          }
          return v3;
        case 66:
          v29 = NvmeNamespaceScsiUnmapRequest(a1, a3, a2, (_DWORD)v7, CurrentProcessorNumber);
          goto LABEL_73;
        case 40:
        case -120:
        case 42:
        case -118:
          v29 = NvmeNamespaceScsiReadWriteRequest(a1, a3, a2, (_DWORD)v7, CurrentProcessorNumber);
          goto LABEL_73;
        default:
          LOBYTE(v24) = 32;
          LOBYTE(v23) = 5;
          SetSrbSenseData(a2, v25, v23, v24, 0);
