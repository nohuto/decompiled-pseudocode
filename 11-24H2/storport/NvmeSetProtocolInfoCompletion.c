/*
 * XREFs of NvmeSetProtocolInfoCompletion @ 0x14012CC50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_30:
  ...
  Data = NvmeProtocolSpecificRequestGetData((__int64)v7, (*(_DWORD *)(v5 + 4256) & 0x400) != 0, &v54, v53);
  if ( Data < 0 )
    goto LABEL_30;
...
LABEL_31:
  ...
  NvmeControllerReclaimExtendedCommand(v21, a2);
  if ( *(_QWORD *)&v57.Data1 )
  ...
  if ( *(_BYTE *)v23 != 15 )
  {
    ...
    if ( *(_BYTE *)(v23 + 1) == 7 && !*(_DWORD *)(v23 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v52) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v22, v23, &v57, v7, v52, v7->IoStatus.Status);
      }
      goto LABEL_174;
    }
...
LABEL_173:
    ...
    McTemplateK0pd_EtwWriteTransfer(v22, v33, &v57, v7, v52);
    goto LABEL_174;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_174;
...
LABEL_170:
      LODWORD(v52) = v7->IoStatus.Status;
      McTemplateK0pduuuuup_EtwWriteTransfer(v22, v34, &v57, v7, v52, v48, v35, v38, v3, v51, v7);
      goto LABEL_174;
    }
LABEL_169:
    v38 = 0;
