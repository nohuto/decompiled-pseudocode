/*
 * XREFs of NvmeNamespaceStopDeviceIrp @ 0x1401A9D68
 * Callers:
...
__int64 __fastcall NvmeNamespaceStopDeviceIrp(__int64 a1, __int64 a2)
{
  int v2; // ebx
  bool v4; // zf
  ...
  *(_QWORD *)(a1 + 112) |= 0x800uLL;
  v2 = 0;
  _InterlockedExchange((volatile __int32 *)(a1 + 96), 2);
...
LABEL_61:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v5, v9, &v30, a2, *(_DWORD *)(a2 + 48), v22, v10, v13, v2, v25, a2);
    }
  }
LABEL_66:
