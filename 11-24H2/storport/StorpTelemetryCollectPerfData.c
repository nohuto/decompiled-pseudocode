/*
 * XREFs of StorpTelemetryCollectPerfData @ 0x14000B4A0
 * Callers:
 ...
 * Callees:
 *     RaidQosSupportedCommand @ 0x14000C048 (RaidQosSupportedCommand.c)
...
LABEL_69:
            v43 = a3;
            if ( v40 + v9 >= HighLatencyIoThreshold
            ...
            if ( v89 )
            {
              ...
              v50 = (unsigned int)dword_140170DCC;
              v51 = (unsigned __int16)TelemetryPerfContext;
            }
            else
            {
              v48 = v93;
              ...
              for ( j = 0; j < 4; ++j )
              {
                if ( v39 <= *((_QWORD *)xmmword_140170DE0 + j) )
                {
                  v47 = j;
                  break;
                }
              }
              v50 = *((unsigned int *)&xmmword_140170DF0 + 3);
              v51 = (unsigned __int16)xmmword_140170DD0;
            }
            v52 = (_QWORD *)(*(_QWORD *)(v43 + 2376)
                           + (unsigned int)dword_140170E38 * v46
            ...
            if ( !v102 && (*(_BYTE *)(v43 + 507) & 0x10) != 0 )
            {
              ...
              while ( v5 < 8 )
              {
                if ( v86 <= *((__int64 *)xmmword_140170E10 + v5) )
                {
                  v84 = v5;
                  break;
                }
              ...
              v85 = (__m128i *)(*(_QWORD *)(v43 + 2384)
                              + (unsigned int)dword_140170E3C * v46
                              + 16
                              * (*((unsigned int *)&xmmword_140170E20 + 3)
                               + (unsigned __int64)(v48
                                                  + (unsigned __int16)xmmword_140170E00
                                                  * (v47 * (unsigned int)WORD1(xmmword_140170E00) + v84))));
...
LABEL_79:
            ...
            v63 = (unsigned __int64 *)(v62 + dword_140170E50 * v46);
            if ( *v63 < v40 )
              *v63 = v40;
            if ( v91 )
            {
...
LABEL_66:
        ...
        if ( a2 )
        {
          v81 = RaidQosSupportedCommand(a2, a3, v23, v42);
          v41 = a3;
          if ( v81 )
            goto LABEL_200;
          v42 = (_BYTE *)(a2 + 2);
...
LABEL_27:
  v23 = v12;
  PerformanceFrequency.QuadPart = (__int64)v15;
  LOBYTE(v23) = v12 & 0x3F;
...
LABEL_47:
    ...
    if ( g_StorpTraceLoggingPerformanceEnabled )
    {
      if ( !UseQPCTime )
        goto LABEL_53;
      v37 = g_StorpTraceLoggingPerformanceHighResolutionTimer == 0;
LABEL_49:
      if ( v37 )
LABEL_53:
