/*
 * XREFs of RaUnitStorageQueryDeviceIdPropertyIoctl @ 0x1401B6BF4
 * Callers:
...
__int64 __fastcall RaUnitStorageQueryDeviceIdPropertyIoctl(__int64 a1, __int64 a2)
{
  ...
  int v5; // ebx
  int v6; // ecx
  int UnitStorageDeviceIdProperty; // r13d
  bool v8; // zf
...
LABEL_24:
  ...
  {
    UnitStorageDeviceIdProperty = RaGetUnitStorageDeviceIdProperty(a1, v4, &v63);
  ...
  *(_DWORD *)(a2 + 48) = UnitStorageDeviceIdProperty;
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      ...
      v30 = (const GUID *)&v67;
LABEL_83:
      McTemplateK0pqd_EtwWriteTransfer(v9, v10, v30, a2, v5, *(_DWORD *)(a2 + 48));
      goto LABEL_9;
    }
    if ( (byte_140171462 & 0x20) == 0 )
      goto LABEL_9;
...
LABEL_25:
    McTemplateK0pd_EtwWriteTransfer(v9, v13, v12, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_9;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_9;
...
LABEL_9:
  ...
  return (unsigned int)UnitStorageDeviceIdProperty;
}
