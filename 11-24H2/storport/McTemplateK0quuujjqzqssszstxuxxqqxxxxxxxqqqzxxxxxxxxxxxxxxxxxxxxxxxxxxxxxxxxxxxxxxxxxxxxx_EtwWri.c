/*
 * XREFs of McTemplateK0quuujjqzqssszstxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer @ 0x140022F10
 * Callers:
        ...
        char a63)
{
  ...
  v247 = 8LL;
  v249 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&a34, &EventUnitPerformance, 0LL, 78LL, v88);
}
