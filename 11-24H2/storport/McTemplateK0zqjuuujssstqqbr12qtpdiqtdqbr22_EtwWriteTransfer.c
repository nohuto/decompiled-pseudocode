/*
 * XREFs of McTemplateK0zqjuuujssstqqbr12qtpdiqtdqbr22_EtwWriteTransfer @ 0x1400A79C0
 * Callers:
        ...
        __int64 a27)
{
  ...
  v91 = 4LL;
  v94 = 0;
  return McGenEventWrite_EtwWriteTransfer(v38, &EventUnitHwTimeout, a3, 0x19u, &v40);
}
