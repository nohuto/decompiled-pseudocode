/*
 * XREFs of NvmeAdapterCancelRemoveDeviceIrp @ 0x140193C38
 * Callers:
...
NTSTATUS __fastcall NvmeAdapterCancelRemoveDeviceIrp(__int64 a1, IRP *a2)
{
  __int64 v4; // rcx
  ...
  v7 = 0LL;
  _InterlockedExchange((volatile __int32 *)(a1 + 84), 1);
