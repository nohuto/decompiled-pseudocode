/*
 * XREFs of NvmeAdapterInterruptRoutine @ 0x1400D3940
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall NvmeAdapterInterruptRoutine(__int64 a1, _DWORD *a2)
{
  ...
  if ( StorEtwLoggingEnabled && (byte_140171463 & 8) != 0 )
  {
    ...
    if ( (byte_140171463 & 8) != 0 )
      McTemplateK0pqqx_EtwWriteTransfer(v14, v10, v11, NvmeAdapterInterruptRoutine, a2[14], CurrentProcessorNumber, v14);
  }
  return v6;
}
