/*
 * XREFs of TcglibpParseLevel0Data @ 0x140140108
 * Callers:
...
__int64 __fastcall TcglibpParseLevel0Data(__int64 a1, int *a2, unsigned int a3, _DWORD *a4)
{
  ...
  if ( a3 > 0x30 )
  {
    v8 = *a2;
    v23 = *a2;
    TcglibReverseBytes((char *)&v23, 4u);
    if ( a3 < v23 + 4 || (v23 = v8, TcglibReverseBytes((char *)&v23, 4u), a3 = v9 + v23, v9 + v23 > 0x30) )
    {
      v10 = a3 - 48;
      for ( i = a2 + 12; v10 >= 4; i = (_DWORD *)((char *)i + v13) )
      {
        LOWORD(v23) = *(_WORD *)i;
        TcglibReverseBytes((char *)&v23, 2u);
