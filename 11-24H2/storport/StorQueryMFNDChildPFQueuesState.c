/*
 * XREFs of StorQueryMFNDChildPFQueuesState @ 0x14018FEA4
 * Callers:
...
__int64 __fastcall StorQueryMFNDChildPFQueuesState(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  _DWORD v21[15]; // [rsp+80h] [rbp-19h] BYREF
    ...
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 6160) + 36LL) == 1 )
    {
      if ( *(_DWORD *)(v3 + 16) >= 0x18u )
      {
        ...
        if ( v5[4] == 1 && *((_DWORD *)v5 + 3) >= 0x10u && (unsigned __int16)(v5[8] - 1) <= 0xFFFDu )
        {
          ...
          v23 = 1;
          v25 = StorMFNDAttemptSwitchToAdminPrivilege(a1);
          v8 = v25;
          if ( v25 >= 0 )
          {
            ...
            v25 = StorSendMFNDCommand(a1, Pool, 0, 4096, (__int64)v21);
            v8 = v25;
            if ( v25 >= 0 )
            {
...
LABEL_34:
  StorMapMFNDErrorToNtStatus(0, &v25);
  v8 = v25;
LABEL_35:
  if ( v23 )
  ...
  if ( v7 )
    v4 = v7[4];
  StorLogMFNDQueryCCQueuesState(a1, v4, v18, 0, v8);
