/*
 * XREFs of RaidAdapterSendRPMBCommandSynchronously @ 0x140060440
 * Callers:
...
__int64 __fastcall RaidAdapterSendRPMBCommandSynchronously(__int64 a1, IRP *a2, char a3, void *a4, int a5)
{
  ...
  ContiguousIoResources = StorAllocateContiguousIoResources(v13 + 1184, v15, (_QWORD *)a1);
      ...
      if ( Pool )
      {
        if ( *(_BYTE *)v10 == 1 )
        {
          ...
          *((_QWORD *)Srb + 12) = v17;
          if ( *(_WORD *)(a1 + 5576) == 1 )
          {
            *((_BYTE *)Srb + v21 + 8) = *(_BYTE *)(a1 + 5584);
            *((_BYTE *)Srb + v21 + 9) = *(_BYTE *)(a1 + 5585);
            *((_BYTE *)Srb + v21 + 10) = *(_BYTE *)(a1 + 5586);
          }
          v25 = v35;
          *(_QWORD *)(v17 + 168) = Srb;
        ...
        else
        {
          ...
          *((_QWORD *)Srb + 6) = v17;
          if ( *(_WORD *)(a1 + 5576) == 1 )
          {
            *((_BYTE *)Srb + 5) = *(_BYTE *)(a1 + 5584);
            *((_BYTE *)Srb + 6) = *(_BYTE *)(a1 + 5585);
            *((_BYTE *)Srb + 7) = *(_BYTE *)(a1 + 5586);
          }
          v26 = (char *)(Srb + 18);
          *(_QWORD *)(v17 + 168) = Srb;
          v27 = *((_QWORD *)Srb + 3);
        ...
        *((_WORD *)v26 + 1) = v28;
        RaSrbSetMiniportContext((int *)a1, (__int64)Srb, v31 + 1184);
