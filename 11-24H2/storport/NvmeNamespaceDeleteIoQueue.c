/*
 * XREFs of NvmeNamespaceDeleteIoQueue @ 0x1400FDC1C
 * Callers:
...
void __fastcall NvmeNamespaceDeleteIoQueue(__int64 a1)
{
  ...
  if ( a1 && *(_QWORD *)(a1 + 256) )
  {
    ...
    {
      v3 = *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8 * i + 64);
      if ( v3 )
      {
        v4 = *(void **)(v3 + 32);
        if ( v4 )
          ExFreePoolWithTag(v4, 0x4D4E6152u);
        v5 = *(void **)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8 * i + 64) + 56LL);
        if ( v5 )
          ExFreePoolWithTag(v5, 0x4D4E6152u);
        ExFreePoolWithTag(*(PVOID *)(*(_QWORD *)(a1 + 256) + 8 * i + 64), 0x4D4E6152u);
        *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8 * i + 64) = 0LL;
      }
    }
