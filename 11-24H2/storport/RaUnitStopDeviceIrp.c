/*
 * XREFs of RaUnitStopDeviceIrp @ 0x140187608
 * Callers:
...
__int64 __fastcall RaUnitStopDeviceIrp(__int64 a1, __int64 a2)
{
  __int64 v3; // r8
  int v4; // ebx
  bool v5; // zf
  ...
  _InterlockedExchange((volatile __int32 *)(a1 + 56), 2);
  RaidLockDeviceQueue(a1 + 720);
  RaUnitLockForwardIo(v3, 1);
  v4 = 0;
  *(_BYTE *)(a2 + 141) = -84;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v4 = *v8;
        McTemplateK0pqd_EtwWriteTransfer(v6, v7, &v31, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_66;
    }
...
LABEL_61:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v31, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_66:
