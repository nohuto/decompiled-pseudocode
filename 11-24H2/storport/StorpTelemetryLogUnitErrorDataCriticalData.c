/*
 * XREFs of StorpTelemetryLogUnitErrorDataCriticalData @ 0x1400B4A48
 * Callers:
...
void __fastcall StorpTelemetryLogUnitErrorDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v36 = 1LL;
      v38 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v39, *(const wchar_t **)(v2 + 4720));
      ...
      v65 = 2LL;
      v67[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer(v9, (unsigned __int8 *)dword_14015EE6E, v10, (__int64)v8, 0x1Bu, &v24);
    }
  }
}
