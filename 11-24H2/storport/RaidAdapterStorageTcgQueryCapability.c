/*
 * XREFs of RaidAdapterStorageTcgQueryCapability @ 0x14007D928
 * Callers:
  ...
  if ( *(_BYTE *)v14 != 15 )
  {
    ...
    if ( *(_BYTE *)(v14 + 1) == 7 && !*(_DWORD *)(v14 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v36) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v13, v14, &v48, a2, v36, v37);
      }
      goto LABEL_83;
    }
    ...
    LODWORD(v36) = *(_DWORD *)(a2 + 48);
LABEL_82:
    McTemplateK0pd_EtwWriteTransfer(v13, v16, &v48, a2, v36);
    goto LABEL_83;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_83;
...
LABEL_78:
    ...
    LOBYTE(v37) = v31;
    LODWORD(v36) = *(_DWORD *)(a2 + 48);
    McTemplateK0pduuuuup_EtwWriteTransfer(v13, v17, &v48, a2, v36, v37, v38, v39, v40, v41, a2);
  }
LABEL_83:
