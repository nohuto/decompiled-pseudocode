/*
 * XREFs of NvmeAdapterFirmwareActivateAfterResetCallback @ 0x1400D00F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeAdapterFirmwareActivateAfterResetCallback(__int64 a1, char a2, __int64 a3)
{
  __int64 v5; // r14
  __int64 v6; // rbx
  int v7; // ebp
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v30) = v7;
        McTemplateK0pqd_EtwWriteTransfer(v9, v10, &v39, v5, v30, v31);
      }
      goto LABEL_66;
    }
...
LABEL_65:
    ...
    McTemplateK0pd_EtwWriteTransfer(v9, v12, &v39, v5, v30);
    goto LABEL_66;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_66;
...
LABEL_62:
      ...
      LOBYTE(v31) = v25;
      LODWORD(v30) = *(_DWORD *)(v5 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v39, v5, v30, v31, v32, v33, v34, v35, v5);
      goto LABEL_66;
    }
LABEL_61:
    v17 = 0;
