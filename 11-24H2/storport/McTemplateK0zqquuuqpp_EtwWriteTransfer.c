/*
 * XREFs of McTemplateK0zqquuuqpp_EtwWriteTransfer @ 0x1400587E4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqquuuqpp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a12)
{
  ...
  v32 = 8LL;
  v34 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)L"NULL", &EventTargetedReenumeration, 0LL, 0xAu, &v15);
}
