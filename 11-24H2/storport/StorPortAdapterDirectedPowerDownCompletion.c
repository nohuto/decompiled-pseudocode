/*
 * XREFs of StorPortAdapterDirectedPowerDownCompletion @ 0x140079910
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *Context)
{
  ...
  *((_QWORD *)Context + 666) = MEMORY[0xFFFFF78000000008];
  ...
  if ( StorEtwLoggingEnabled && (byte_140171462 & 0x10) != 0 )
  {
    ...
    McTemplateK0pqq_EtwWriteTransfer(v7, &EventAdapterDirectedPowerDownStop, v8, **((_QWORD **)Context + 620), v9, v10);
  }
  Context[109] |= 0x40u;
}
