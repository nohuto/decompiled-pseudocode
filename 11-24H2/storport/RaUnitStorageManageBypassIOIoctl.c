/*
 * XREFs of RaUnitStorageManageBypassIOIoctl @ 0x140189F08
 * Callers:
...
LABEL_45:
  ...
  *(_DWORD *)(a2 + 48) = v8;
  ...
  if ( *(_BYTE *)v29 != 15 )
  {
    ...
    v50 = *(_DWORD *)(a2 + 48);
LABEL_110:
    McTemplateK0pd_EtwWriteTransfer(v28, v31, &Src, a2, v50);
    goto LABEL_111;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_111;
...
LABEL_106:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v28, v32, &Src, a2, *(_DWORD *)(a2 + 48), v45, v33, v36, v3, v48, a2);
    }
  }
LABEL_111:
