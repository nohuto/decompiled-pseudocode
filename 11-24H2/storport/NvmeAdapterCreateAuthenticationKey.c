/*
 * XREFs of NvmeAdapterCreateAuthenticationKey @ 0x140194A68
 * Callers:
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 592) )
  {
      ...
      && (v6 = *(unsigned __int16 *)(v5 + 10), (unsigned __int16)v6 <= 0x100u) )
    {
      ...
      v9 = (void *)(v5 + 272);
      *(_WORD *)(v5 + 10) = 32;
      RandomBytes = GenerateRandomBytes(0x20u, v6, (void *)(v5 + 272));
      if ( RandomBytes >= 0 )
      {
LABEL_18:
          ...
          if ( (*(_DWORD *)(v5 + 4) & 1) != 0 || (RandomBytes = GetNvmeHostNQN(0, (char *)(v5 + 16)), RandomBytes >= 0) )
          {
            ...
            if ( RandomBytes >= 0 )
            {
              ...
              if ( RandomBytes >= 0 )
              {
                ...
                PopulateNvmeAuthenticationKeyInfo(v40[0], (__int64)v10);
                *(_QWORD *)(a2 + 56) = 528LL;
              }
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(Src) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v12, v13, (const GUID *)&v40[1], a2, Src, v36);
      }
      goto LABEL_93;
    }
...
LABEL_92:
    ...
    McTemplateK0pd_EtwWriteTransfer(v12, v15, (const GUID *)&v40[1], a2, Src);
    goto LABEL_93;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_93;
...
LABEL_88:
      ...
      LODWORD(Src) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v12, v16, (const GUID *)&v40[1], a2, Src, v36, v17, v20, v3, v33, a2);
    }
  }
LABEL_93:
