/*
 * XREFs of StorpRequestTimer @ 0x14004CEE0
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( !a1 || !a2 || !a3 )
  {
    ...
    {
      WPP_SF_qqq(WPP_GLOBAL_Control->AttachedDevice, 75LL, &WPP_befb7ec21e9436c8e96fa3f853ba0056_Traceguids, a1, a2, a3);
    }
    return 3238002694LL;
  }
  v9 = *(int ***)(a1 - 16);
...
LABEL_11:
  ...
  if ( !*(_QWORD *)a2 || *v13 != 1094997074 && *v13 != 1314275652 )
  {
    ...
    v7 = a2;
LABEL_37:
    WPP_SF_q(v19->AttachedDevice, v20, &WPP_befb7ec21e9436c8e96fa3f853ba0056_Traceguids, v7);
    return 3238002694LL;
  }
  if ( a5 )
  {
    if ( !_InterlockedCompareExchange64((volatile signed __int64 *)(a2 + 136), a3, 0LL) )
    {
      ...
      *(_QWORD *)(a2 + 144) = a4;
      ...
      if ( v10 )
      {
        v17 = ExpInterlockedPopEntrySList((PSLIST_HEADER)v10 + 68);
        if ( v17 )
        {
          ...
          *((_DWORD *)&v17[3].Next + 2) = v16;
          ExpInterlockedPushEntrySList((PSLIST_HEADER)v10 + 69, v17);
          KeInsertQueueDpc((PRKDPC)(v10 + 254), v10 + 252, 0LL);
          return 0LL;
        }
      ...
      {
        v18 = ExpInterlockedPopEntrySList((PSLIST_HEADER)v11 + 43);
        if ( v18 )
        {
          ...
          *((_DWORD *)&v18[3].Next + 2) = v16;
          ExpInterlockedPushEntrySList((PSLIST_HEADER)v11 + 44, v18);
          KeInsertQueueDpc((PRKDPC)(v11 + 154), v11 + 152, 0LL);
          return 0LL;
        }
      }
      return 3238002691LL;
