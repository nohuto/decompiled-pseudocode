/*
 * XREFs of RaUnitFillIrpData @ 0x14000AE80
 * Callers:
...
char __fastcall RaUnitFillIrpData(__int64 a1, __int64 *a2)
{
  __int64 v2; // r14
  __int64 v4; // rdx
  int v6; // ebx
  ...
  if ( KeGetProcessorNumberFromIndex(v6 & 0x7FFFFFFF, &ProcNumber) >= 0 )
  {
    ...
    if ( *v11 )
    {
      ...
      if ( *v12 )
      {
        ...
        {
          if ( v14 == 1314275652 )
            NvmeGetMessageNumberFromProcessorNumber(*v12, &ProcNumber, (char *)a2 + 52);
        }
