/*
 * XREFs of RaidAdapterStorageSetPciLinkBandwidthIoctl @ 0x1400643D4
 * Callers:
...
__int64 __fastcall RaidAdapterStorageSetPciLinkBandwidthIoctl(__int64 a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rcx
  int LinkConfigInterface; // r14d
  __int64 v7; // rcx
  int *v8; // r8
  __int64 v9; // rcx
  bool v10; // zf
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( *(_QWORD *)(a1 + 6224) )
  {
    LinkConfigInterface = -2147483631;
  }
  else
  {
    if ( *(_DWORD *)(a1 + 4276) != 17 || (*(_BYTE *)(a1 + 112) & 0x20) != 0 )
    {
      LinkConfigInterface = -1073741637;
      goto LABEL_20;
    }
    if ( *(_QWORD *)(a2 + 24) )
    {
      ...
      {
        LinkConfigInterface = -1073741789;
        goto LABEL_20;
      }
      v7 = *(_QWORD *)(a1 + 6216);
      if ( !v7 )
      {
        LinkConfigInterface = RaidGetLinkConfigInterface(*(_QWORD *)(a1 + 8), &v39);
        if ( LinkConfigInterface < 0 )
          goto LABEL_20;
        v7 = v39;
        if ( !v39 )
        {
          LinkConfigInterface = -1073741438;
          goto LABEL_20;
        }
        *(_QWORD *)(a1 + 6216) = v39;
      }
      v8 = &v38;
      LOBYTE(v8) = 1;
      LinkConfigInterface = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, char *, int *))(v7 + 32))(
                              *(_QWORD *)(v7 + 8),
                              **(unsigned int **)(a2 + 24),
                              v8,
                              &v36,
    ...
    LinkConfigInterface = -1073741811;
  }
LABEL_20:
  v10 = StorEtwLoggingEnabled == 0;
  *(_BYTE *)(a2 + 141) = -84;
  *(_DWORD *)(a2 + 48) = LinkConfigInterface;
  if ( v10 )
    goto LABEL_86;
  v40 = 0LL;
    ...
    if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v13 )
          v2 = *v13;
        LODWORD(v33) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v11, v12, &v40, a2, v33, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_86;
    }
...
LABEL_85:
    ...
    McTemplateK0pd_EtwWriteTransfer(v11, v14, &v40, a2, v33);
    goto LABEL_86;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_86;
...
LABEL_81:
      ...
      LODWORD(v33) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v11, v15, &v40, a2, v33, v28, v16, v19, v2, v31, a2);
    }
  }
LABEL_86:
  IofCompleteRequest((PIRP)a2, 0);
  return (unsigned int)LinkConfigInterface;
}
