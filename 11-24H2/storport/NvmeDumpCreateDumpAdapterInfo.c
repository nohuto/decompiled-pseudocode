/*
 * XREFs of NvmeDumpCreateDumpAdapterInfo @ 0x14019F024
 * Callers:
  ...
  if ( Pool
    && (v21 = (_QWORD *)(Pool + 8),
        ...
        *(_OWORD *)(v20 + 24) = *(_OWORD *)(a1 + 1032),
        v22 = (_DWORD *)RaidAllocatePool(64LL, 360LL, 1145266514LL, *(_QWORD *)(a1 + 8)),
        (v23 = v22) != 0LL) )
  {
    *v22 = 1145917490;
    v22[1] = 4097;
    ...
    *(_DWORD *)(v20 + 44) = 320;
    ...
    if ( v24 )
    {
      ...
      *((_WORD *)v23 + 152) = HiberFileHybridPriority;
      ...
      *((_QWORD *)v23 + 37) = v25;
      if ( *(_DWORD *)(a1 + 368) )
        NvmeDumpGetAdditionalCrashDumpArea(a1, v23 + 18);
      v26 = NvmeDumpCreateDumpDriverInfo(a1, v32, &v33, &v31);
      v27 = v31;
      v13 = v26;
      v28 = v26 < 0;
      v29 = v33;
      ...
      if ( !v27 && v29 )
        NvmeNativeDumpFreeDumpDriverInfo(&v33);
      if ( !v23 )
        goto LABEL_28;
    }
    else
