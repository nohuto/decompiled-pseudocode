/*
 * XREFs of StorpTelemetryAdapterNvmeHealthInfo @ 0x1400B256C
 * Callers:
...
char __fastcall StorpTelemetryAdapterNvmeHealthInfo(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a11)
{
  ...
  {
    LOBYTE(v11) = tlgKeywordOn(a1, 0x400000000000LL);
    if ( (_BYTE)v11 )
    {
      ...
      LOBYTE(v11) = tlgWriteTransfer_EtwWriteTransfer(
                      *(__int64 *)&g_SystemUptime_s,
                      (unsigned __int8 *)dword_14015E906,
                      v22,
                      v21,
                      0x14u,
                      &v35);
