/*
 * XREFs of McTemplateK0qjzsdqq_EtwWriteTransfer @ 0x1400CBC18
 * Callers:
        ...
        char a10)
{
  ...
  v34 = 4LL;
  v33 = &a10;
  return McGenEventWrite_EtwWriteTransfer((__int64)"NULL", &EventNVMeoFConnectControllerFailure, 0LL, 8u, &v18);
}
