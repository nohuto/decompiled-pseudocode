/*
 * XREFs of McTemplateK0zquuujqqbr7_EtwWriteTransfer @ 0x1400A7CB8
 * Callers:
        ...
        __int64 a12)
{
  ...
  v32 = 4LL;
  v35 = 0;
  return McGenEventWrite_EtwWriteTransfer((__int64)L"NULL", &EventMiniportBugAbortBroken, a3, 0xAu, &v15);
}
