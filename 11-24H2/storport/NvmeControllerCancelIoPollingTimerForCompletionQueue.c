/*
 * XREFs of NvmeControllerCancelIoPollingTimerForCompletionQueue @ 0x1400EB688
 * Callers:
...
_BYTE *__fastcall NvmeControllerCancelIoPollingTimerForCompletionQueue(__int64 a1, unsigned __int16 a2)
{
  _BYTE *result; // rax
  _DWORD *v3; // rbp
  __int64 v4; // rsi
