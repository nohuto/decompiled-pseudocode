/*
 * XREFs of StorSetMFNDChildPFQueuesState @ 0x140191D2C
 * Callers:
...
LABEL_44:
      ...
      *((_WORD *)Pool + 15) = *(_WORD *)(v6 + 50);
      ...
      v23 = StorSendMFNDCommand(a1, Pool, 0LL, v13, v26, v25, 2u, 0, 0, 0LL, &v30);
      v9 = v30;
      v12 = v23;
    }
    else
  ...
  v29 = -1073741637;
LABEL_45:
  StorMapMFNDErrorToNtStatus(v9, &v29);
  v12 = v29;
LABEL_46:
  if ( v7 )
    StorMFNDAttemptSwitchToUserPrivilege(a1);
  StorLogMFNDSetCCQueuesState(a1, v6, v9, v12);
