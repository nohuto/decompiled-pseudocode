/*
 * XREFs of NvmeNativeDumpStorageGetDumpInfoIoctl @ 0x1401A0D80
 * Callers:
 ...
 *     NvmeNativeDumpFreeDumpAdapterInfo @ 0x1401A0B9C (NvmeNativeDumpFreeDumpAdapterInfo.c)
 */
...
LABEL_5:
    ...
    v6 = NvmeNativeDumpCreateDumpDiskInfo(a1, &v51);
    if ( v6 >= 0 )
    {
      v9 = NvmeNativeDumpCreateDumpAdapterInfo(
...
LABEL_19:
      ...
      if ( !v47 && v10 )
        NvmeNativeDumpFreeDumpDriverInfo((PVOID *)&v49);
      if ( !v46 && v19 )
        NvmeNativeDumpFreeDumpAdapterInfo(&v50);
    }
    v5 = (__int64 *)(a2 + 184);
    if ( *(_QWORD *)&v51.Data1 )
      NvmeNativeDumpFreeDumpDiskInfo((PVOID *)&v51);
    goto LABEL_30;
  }
  v6 = -1073741637;
LABEL_30:
  ...
  if ( *(_BYTE *)*v5 != 15 )
  {
    ...
    if ( *(_BYTE *)(v22 + 1) == 7 && !*(_DWORD *)(v22 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v43) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v21, v22, &v51, a2, v43, v44);
      }
      goto LABEL_96;
    }
...
LABEL_95:
    ...
    McTemplateK0pd_EtwWriteTransfer(v21, v24, &v51, a2, v43);
    goto LABEL_96;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_96;
...
LABEL_91:
      ...
      LOBYTE(v44) = v38;
      LODWORD(v43) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v21, v25, &v51, a2, v43, v44, v45, v29, v2, v41, a2);
    }
  }
LABEL_96:
