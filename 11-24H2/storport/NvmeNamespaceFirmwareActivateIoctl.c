/*
 * XREFs of NvmeNamespaceFirmwareActivateIoctl @ 0x1401015B4
 * Callers:
...
NTSTATUS __fastcall NvmeNamespaceFirmwareActivateIoctl(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  ...
  *(_DWORD *)(a2 + 48) = -1073741637;
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    v29 = *(_DWORD *)(a2 + 48);
LABEL_66:
    McTemplateK0pd_EtwWriteTransfer(v7, v10, &v33, a2, v29);
    goto LABEL_67;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_67;
...
LABEL_62:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v7, v11, &v33, a2, *(_DWORD *)(a2 + 48), v24, v12, v15, v4, v27, a2);
    }
  }
LABEL_67:
