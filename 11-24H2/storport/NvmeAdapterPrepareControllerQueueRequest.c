/*
 * XREFs of NvmeAdapterPrepareControllerQueueRequest @ 0x1400E60E0
 * Callers:
...
LABEL_8:
  ...
  else
  {
    *(_BYTE *)(v21 + 60) = v23 & 0xBF;
    if ( a8 )
      ...
      v24 = *(_WORD *)(a1 + 1092);
    *(_WORD *)(v21 + 58) = v24;
    *(_QWORD *)(v21 + 64) = **(_QWORD **)(*(_QWORD *)(a3[11] + 1288LL) + 40LL);
  }
  if ( a6 || !a7 )
    v25 = 2;
  else
  ...
  *(_QWORD *)(a4 + 96) = v27;
  *(_DWORD *)(a4 + 40) = 10;
  RaSrbSetMiniportContext((int *)a1, a4, v26 + 1184);
  KeInitializeEvent((PRKEVENT)(v26 + 712), NotificationEvent, 0);
  *(_QWORD *)(v26 + 704) = NvmeAdapterCompleteControllerQueueRequest;
