/*
 * XREFs of NvmeControllerIoQueuesDeletion @ 0x1400F1250
 * Callers:
 *     NvmeControllerPowerDown @ 0x1400F2358 (NvmeControllerPowerDown.c)
 *     NvmeControllerStop @ 0x1400F51D8 (NvmeControllerStop.c)
 * Callees:
 *     NvmeControllerCancelIoPollingTimerForCompletionQueue @ 0x1400EB688 (NvmeControllerCancelIoPollingTimerForCompletionQueue.c)
...
__int64 __fastcall NvmeControllerIoQueuesDeletion(__int64 a1)
{
  ...
  if ( *(_WORD *)(a1 + 26) )
  {
    ...
    do
    {
      ...
      v2 = NvmeControllerIoCompletionQueueDelete(a1, v5);
      if ( v2 < 0 )
        *(_DWORD *)(a1 + 1192) = 16;
      ++v5;
    }
