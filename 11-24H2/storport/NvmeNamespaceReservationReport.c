/*
 * XREFs of NvmeNamespaceReservationReport @ 0x14010CD08
 * Callers:
 ...
 *     GetScsiReservationType @ 0x1400FA44C (GetScsiReservationType.c)
...
__int64 __fastcall NvmeNamespaceReservationReport(__int64 a1, __int64 a2)
{
  ...
  _QWORD *Size_4; // [rsp+38h] [rbp-30h]
  _BYTE *v52; // [rsp+40h] [rbp-28h]
  ...
  v53[0] = 0LL;
  Size_4 = (_QWORD *)NvmeControllerGetExtendedCommand(v3);
  if ( !Size_4 )
    goto LABEL_2;
  while ( 1 )
  {
    ...
    if ( v5 > 0x30 )
      v6 = v5;
    DmaBuffer = NvmeAllocateDmaBuffer(*(_QWORD *)(a1 + 16), v6, v8, (void **)v53, (_QWORD *)v53 + 1, 0);
    if ( DmaBuffer < 0 )
      goto LABEL_49;
    *(_DWORD *)(*Size_4 + 4256LL) &= ~1u;
    *(_DWORD *)(*Size_4 + 4256LL) |= 0x20u;
    *(_DWORD *)(*Size_4 + 4256LL) |= 2u;
    *(_QWORD *)(*Size_4 + 4184LL) = v4;
    *(_QWORD *)(*Size_4 + 4192LL) = NvmeControllerCommandCompletion;
    *(_QWORD *)(*Size_4 + 4200LL) = Size_4;
    *(_QWORD *)(*Size_4 + 4216LL) = a1;
    *(_OWORD *)(*Size_4 + 4160LL) = v53[0];
    *(_DWORD *)(*Size_4 + 4248LL) = v6;
    v10 = *Size_4 + 4096LL;
    v11 = **(_BYTE **)(*(_QWORD *)(a1 + 16) + 1280LL);
    v12 = *((_QWORD *)&v53[0] + 1);
    ...
    *(_DWORD *)(v10 + 44) = v13 ^ (v13 ^ (v11 >> 3)) & 1;
    v56 = NvmeControllerProcessCommandSync(*(_QWORD *)(a1 + 16), Size_4, 0);
    DmaBuffer = v56;
    if ( v56 < 0 )
      goto LABEL_49;
    v14 = *(_QWORD *)(a1 + 16);
    v15 = *(_QWORD *)(*Size_4 + 4160LL);
    v16 = *(unsigned __int16 *)(v15 + 5);
    v5 = (**(_BYTE **)(v14 + 1280) & 8) != 0 ? (v16 + 1) << 6 : 24 * (v16 + 1);
    if ( v6 >= v5 )
      break;
    NvmeFreeDmaBuffer(*(_QWORD *)(a1 + 16), v6, v14, *(__int64 *)&v53[0], *((__int64 *)&v53[0] + 1));
    v4 = a2;
    v53[0] = 0LL;
  }
  if ( (v52[8] & 0x1F) == 0 )
  {
    v41 = 8 * v16;
    v18 = v41 + 8;
    Pool = (_BYTE *)RaidAllocatePool(64LL, (unsigned int)(v41 + 8), 1296982354LL, *(_QWORD *)(a1 + 8));
    v7 = Pool;
    if ( Pool )
    {
      Pool[3] = *(_BYTE *)v15;
      ...
      *Pool = *(_BYTE *)(v15 + 3);
      ...
      if ( v41 )
      {
        ...
        else if ( v43 )
        {
          ...
          {
            v45 = v44++;
            Pool[8 * v45 + 15] = *(_BYTE *)(v15 + 24 * v45 + 40);
            Pool[8 * v45 + 14] = *(_BYTE *)(v15 + 24 * v45 + 41);
            Pool[8 * v45 + 13] = *(_BYTE *)(v15 + 24 * v45 + 42);
            Pool[8 * v45 + 12] = *(_BYTE *)(v15 + 24 * v45 + 43);
            Pool[8 * v45 + 11] = *(_BYTE *)(v15 + 24 * v45 + 44);
            Pool[8 * v45 + 10] = *(_BYTE *)(v15 + 24 * v45 + 45);
            Pool[8 * v45 + 9] = *(_BYTE *)(v15 + 24 * v45 + 46);
            Pool[8 * v45 + 8] = *(_BYTE *)(v15 + 24 * v45 + 47);
          }
          while ( v44 < *(_WORD *)(v15 + 5) );
        }
      }
  ...
  if ( (v52[8] & 0x1F) != 1 )
  {
    ...
    v17 = 32 * v16;
    v18 = v17 + 8;
    v19 = (_BYTE *)RaidAllocatePool(64LL, (unsigned int)(v17 + 8), 1296982354LL, *(_QWORD *)(a1 + 8));
    v7 = v19;
    if ( v19 )
    {
      v19[3] = *(_BYTE *)v15;
        ...
        if ( *(_WORD *)(v15 + 5) )
        {
          ...
          do
          {
            ...
            if ( (**(_BYTE **)(*(_QWORD *)(a1 + 16) + 1280LL) & 8) != 0 )
            {
              ...
              v7[v22 + 21] &= v21;
              v7[v22 + 20] = v31 ^ v32 & 1;
              ScsiReservationType = GetScsiReservationType(*(unsigned __int8 *)(v15 + 4));
              v7[v26 + 21] = v21 & ScsiReservationType;
            ...
            else
            {
              ...
              v7[v22 + 21] &= v21;
              v7[v22 + 20] = v23 ^ v24 & 1;
              v25 = GetScsiReservationType(*(unsigned __int8 *)(v15 + 4));
              v7[v26 + 21] = v21 & v25;
...
LABEL_2:
  ...
  v35 = v55 != 0 ? 0x10 : 0;
  v18 = v35 + 8;
  v36 = (_BYTE *)RaidAllocatePool(64LL, (unsigned int)(v35 + 8), 1296982354LL, *(_QWORD *)(a1 + 8));
  v7 = v36;
  if ( !v36 )
    goto LABEL_2;
  v36[3] = *(_BYTE *)v15;
  ...
  *v36 = *(_BYTE *)(v15 + 3);
  ...
  if ( !v55 )
    goto LABEL_46;
  v36[21] = GetScsiReservationType(*(unsigned __int8 *)(v15 + 4)) & 0xF;
  ...
  if ( !v37 )
    goto LABEL_46;
  while ( (**(_BYTE **)(*(_QWORD *)(a1 + 16) + 1280LL) & 8) == 0 )
  {
...
LABEL_46:
  memset_0(v52, 0, Size);
  if ( v18 >= *((unsigned __int16 *)v52 + 5) )
    v18 = *((unsigned __int16 *)v52 + 5);
  memmove(v52, v7, v18);
LABEL_49:
  NvmeControllerReclaimExtendedCommand(*(_QWORD *)(a1 + 16), Size_4);
  if ( *(_QWORD *)&v53[0] )
    NvmeFreeDmaBuffer(*(_QWORD *)(a1 + 16), v6, v48, *(__int64 *)&v53[0], *((__int64 *)&v53[0] + 1));
  if ( v7 )
