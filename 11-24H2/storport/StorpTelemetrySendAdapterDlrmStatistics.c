/*
 * XREFs of StorpTelemetrySendAdapterDlrmStatistics @ 0x1400B8D68
 * Callers:
...
char __fastcall StorpTelemetrySendAdapterDlrmStatistics(__int64 a1)
{
  ...
  *(_OWORD *)v117 = 0LL;
  ...
  if ( v4 )
  {
    ...
    v14 = *(_QWORD *)(a1 + 16);
    v53 = *(_OWORD *)(a1 + 5064);
    LOBYTE(v1) = RaidDriverGetName(v14, (__int64)&v52);
    v15 = *(_QWORD *)(a1 + 6000);
    if ( v15 )
    {
    ...
    {
      LOBYTE(v1) = tlgKeywordOn(v15, 0x400000000000LL);
      if ( (_BYTE)v1 )
      {
        v58 = &v48;
        v48 = 0x1000000LL;
        ...
        v61 = 16LL;
        v63 = 4LL;
        tlgCreate1Sz_wchar_t((__int64)v64, *((const wchar_t **)&v52 + 1));
        v24 = v5;
        v65 = &v24;
        v66 = 2LL;
        v67 = &v25;
        ...
        LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer(
                       (__int64)v117,
                       (unsigned __int8 *)dword_1401619D6,
                       v17,
                       v18,
                       0x1Cu,
                       &v57);
    ...
    if ( (byte_140171468 & 4) != 0 )
      LOBYTE(v1) = McTemplateK0qjzshhssqqqqqqqqqxxxqqqqq_EtwWriteTransfer(
