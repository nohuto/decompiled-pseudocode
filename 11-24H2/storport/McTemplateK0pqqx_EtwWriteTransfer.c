/*
 * XREFs of McTemplateK0pqqx_EtwWriteTransfer @ 0x140056A2C
 * Callers:
 ...
 *     NvmeAdapterMSIInterruptRoutine @ 0x1400D3DC0 (NvmeAdapterMSIInterruptRoutine.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x140024158 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140143690 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(a1, &EventIsr, 0LL, 5u, &v4);
}
