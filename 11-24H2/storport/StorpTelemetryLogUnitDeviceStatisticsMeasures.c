/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1400B4554
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v112 = &v33;
    v113 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v27, (unsigned __int8 *)dword_14015F900, v6, v7, 0x26u, &v45);
  }
}
