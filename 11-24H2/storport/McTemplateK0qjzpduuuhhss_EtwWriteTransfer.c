/*
 * XREFs of McTemplateK0qjzpduuuhhss_EtwWriteTransfer @ 0x1400DD694
 * Callers:
        ...
        const char *a15)
{
  ...
  if ( !a15 )
    v16 = "NULL";
  v50 = v16;
  return McGenEventWrite_EtwWriteTransfer(v22, &EventNVMeoFAddDiscoveryEntryFailure, 0LL, 0xDu, &v25);
}
