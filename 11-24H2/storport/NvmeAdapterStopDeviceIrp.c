/*
 * XREFs of NvmeAdapterStopDeviceIrp @ 0x14019C384
 * Callers:
...
NTSTATUS __fastcall NvmeAdapterStopDeviceIrp(__int64 a1, IRP *a2)
{
  ...
  {
    result = NvmeControllerSubmissionQueueQuiesce(*(_QWORD *)(a1 + 1136));
    if ( result < 0 )
      return result;
    if ( !NvmeControllerWaitForOutstandingIoComplete(*(_QWORD *)(a1 + 1136), 10) )
      return -1073741643;
  }
  else
  {
