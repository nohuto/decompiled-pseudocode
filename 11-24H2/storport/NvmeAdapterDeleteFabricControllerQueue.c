/*
 * XREFs of NvmeAdapterDeleteFabricControllerQueue @ 0x1400E0F60
 * Callers:
...
__int64 __fastcall NvmeAdapterDeleteFabricControllerQueue(__int64 a1)
{
  char *v1; // r14
  void *v2; // r12
...
LABEL_5:
  ...
  if ( v10 < 0 )
  {
    if ( (byte_14017146A & 8) != 0 )
    {
      ...
      McTemplateK0qjzshhdqsq_EtwWriteTransfer(
        v7 + 1032,
        &EventNVMeoFDeleteControllerQueueFailure,
        v28,
        *(_DWORD *)(v7 + 56),
        v7 + 1032,
  ...
  else if ( (byte_14017146A & 2) != 0 )
  {
    ...
    McTemplateK0qjzshhq_EtwWriteTransfer(
      v7 + 1032,
      &EventNVMeoFDeleteControllerQueueSuccess,
      v23,
      *(_DWORD *)(v7 + 56),
      v7 + 1032,
      *(const wchar_t **)(v7 + 1016),
