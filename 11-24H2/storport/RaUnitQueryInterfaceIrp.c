/*
 * XREFs of RaUnitQueryInterfaceIrp @ 0x140094D18
 * Callers:
 ...
 *     PortQueryInterfacePdoInfo @ 0x1401B4060 (PortQueryInterfacePdoInfo.c)
 */
...
LABEL_71:
                  ...
                  McTemplateK0pduuuuup_EtwWriteTransfer(v11, v17, v33, a2, v70, v71, v72, v73, v74, v75, v76);
                  goto LABEL_213;
                }
              }
              else
...
LABEL_16:
        ...
        LODWORD(v70) = v9;
        McTemplateK0pqd_EtwWriteTransfer(v11, v12, v14, a2, v70, v71);
        goto LABEL_213;
      }
      if ( (byte_140171462 & 0x20) == 0 )
        goto LABEL_213;
...
LABEL_212:
    LODWORD(v70) = *(_DWORD *)(a2 + 48);
    McTemplateK0pd_EtwWriteTransfer(v11, v16, v15, a2, v70);
    goto LABEL_213;
  }
  v6 = *(GUID **)(v2 + 8);
