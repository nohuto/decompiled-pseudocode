/*
 * XREFs of NvmeAdapterAddController @ 0x140193078
 * Callers:
      ...
      && v7 < 0x1001u )
    {
      if ( *(_DWORD *)(v2 + 8) >= 0x20u )
      {
        ...
        if ( SubsystemPort )
        {
          ...
          {
            v8 = NvmeAdapterCreateAddNvmeController(SubsystemPort, *(_WORD *)(v6 + 16), 1u, (int)v6 + 20, &v42);
            if ( v8 >= 0 )
            {
              v15 = *(_WORD *)(v6 + 18);
              v16 = v42;
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v3 = *v14;
        LODWORD(v39) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v12, v13, &v43, a2, v39, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_97;
    }
...
LABEL_96:
    ...
    McTemplateK0pd_EtwWriteTransfer(v12, v20, &v43, a2, v39);
    goto LABEL_97;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_97;
...
LABEL_92:
      ...
      LODWORD(v39) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v12, v21, &v43, a2, v39, v34, v22, v25, v3, v37, a2);
    }
  }
LABEL_97:
