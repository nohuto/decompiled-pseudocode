/*
 * XREFs of RaidAdapterStorageTcgGetLockingObjectMetadata @ 0x14007D338
 * Callers:
...
LABEL_23:
    *(_QWORD *)(a2 + 56) = 0LL;
    if ( v7 )
    {
      RaidDriverGetName(*(_QWORD *)(a1 + 16), (__int64)&v55);
  ...
  if ( *(_BYTE *)v17 != 15 )
  {
    ...
    if ( *(_BYTE *)(v17 + 1) == 7 && !*(_DWORD *)(v17 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v40) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v16, v17, &v56, a2, v40, v41);
      }
      goto LABEL_97;
    }
    ...
    LODWORD(v40) = *(_DWORD *)(a2 + 48);
LABEL_96:
    McTemplateK0pd_EtwWriteTransfer(v16, v19, &v56, a2, v40);
    goto LABEL_97;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_97;
...
LABEL_92:
    ...
    LODWORD(v40) = *(_DWORD *)(a2 + 48);
    McTemplateK0pduuuuup_EtwWriteTransfer(v16, v20, &v56, a2, v40, v41, v42, v43, v44, v45, a2);
  }
LABEL_97:
