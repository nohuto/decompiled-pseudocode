/*
 * XREFs of McTemplateK0qjzhqzusiddq_EtwWriteTransfer @ 0x1400CB904
 * Callers:
        ...
        char a15)
{
  ...
  v50 = 4LL;
  v52 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)"NULL", &EventNVMeAdapterCompleteInitialization, 0LL, 0xDu, &v26);
}
