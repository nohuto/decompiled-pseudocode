/*
 * XREFs of NvmeAdapterConnectFabricNvmeController @ 0x1400DFBF4
 * Callers:
...
LABEL_97:
  ...
  *(_WORD *)(DeferredContext[89] + 150LL) += *((unsigned __int8 *)DeferredContext + 742);
  ...
  {
    FabricControllerQueue = NvmeAdapterSetFabricControllerKeepAliveTimeout(DeferredContext, &word_140150F48);
  ...
  {
    LOBYTE(v43) = 0;
    v42 = (wchar_t *)&word_140150F48;
    LOBYTE(v41) = 0;
    v40 = (wchar_t *)&word_140150F48;
    LOBYTE(v39) = 0;
    Dpc = (wchar_t *)&word_140150F48;
