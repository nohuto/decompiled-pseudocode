/*
 * XREFs of RaUnitHwFirmwareGetInfoIoctl @ 0x14000C75C
 * Callers:
  ...
  if ( *(_BYTE *)v21 != 15 )
  {
    ...
    if ( *(_BYTE *)(v21 + 1) == 7 && !*(_DWORD *)(v21 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v27 )
          v8 = *v27;
        McTemplateK0pqd_EtwWriteTransfer((_DWORD)v20, v21, (unsigned int)&v49, a2, v8, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_24;
    }
...
LABEL_35:
    McTemplateK0pd_EtwWriteTransfer(v20, v26, &v49, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_24;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_24;
