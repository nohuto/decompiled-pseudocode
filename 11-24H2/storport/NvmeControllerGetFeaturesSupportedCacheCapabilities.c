/*
 * XREFs of NvmeControllerGetFeaturesSupportedCacheCapabilities @ 0x1400C8E14
 * Callers:
...
__int64 __fastcall NvmeControllerGetFeaturesSupportedCacheCapabilities(__int64 a1, char a2)
{
  int v4; // esi
  __int64 v5; // rdi
  __int64 v7; // rcx
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 592) + 525LL) & 1) == 0 )
    return 3221225659LL;
  if ( !NvmeVersionCheck(a1, 1u, 0) || (*(_BYTE *)(v8 + 520) & 0x10) == 0 )
    goto LABEL_8;
...
LABEL_8:
  ...
  *(_DWORD *)(v11 + 4136) = v12 | 0x300;
  v4 = NvmeControllerProcessCommandSync(a1, v10, a2);
  if ( v4 < 0 )
    goto LABEL_8;
LABEL_9:
