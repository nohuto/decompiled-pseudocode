/*
 * XREFs of NvmeAdapterDeviceUsageNotificationIrp @ 0x1400CF37C
 * Callers:
  ...
  if ( *(_BYTE *)v12 != 15 )
  {
    ...
    if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v13 )
          v4 = *v13;
        McTemplateK0pqd_EtwWriteTransfer(v11, v12, &v37, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_80;
    }
...
LABEL_75:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v11, v15, &v37, a2, *(_DWORD *)(a2 + 48), v28, v16, v19, v4, v31, a2);
    }
  }
LABEL_80:
