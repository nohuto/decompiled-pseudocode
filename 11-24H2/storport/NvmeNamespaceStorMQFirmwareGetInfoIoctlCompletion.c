/*
 * XREFs of NvmeNamespaceStorMQFirmwareGetInfoIoctlCompletion @ 0x140112E20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeNamespaceStorMQFirmwareGetInfoIoctlCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  __int64 *v4; // r15
  int v5; // edi
  __int64 v6; // rsi
  ...
  if ( v15 >= 0 )
  {
    ...
    *((_BYTE *)v25 + 12) = 1;
    ...
    if ( NvmeFirmwareGranularity )
    {
      ...
      v32 = *(_DWORD *)(v31 + 200) - (unsigned int)v18 % NvmeFirmwareGranularity;
...
LABEL_116:
  ...
  *(_QWORD *)(v17 + 56) = v19;
  NvmeFreeDmaBuffer(a1, *(_DWORD *)(*v4 + 4248), v18, *(_QWORD *)(*v4 + 4160), *(_QWORD *)(*v4 + 4168));
  ...
  if ( *(_BYTE *)v38 != 15 )
  {
    ...
    if ( *(_BYTE *)(v38 + 1) == 7 && !*(_DWORD *)(v38 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v59) = v5;
        McTemplateK0pqd_EtwWriteTransfer(v37, v38, &v68, v17, v59, v60);
      }
      goto LABEL_181;
    }
...
LABEL_180:
    ...
    McTemplateK0pd_EtwWriteTransfer(v37, v40, &v68, v17, v59);
    goto LABEL_181;
  }
...
LABEL_177:
      ...
      LODWORD(v59) = *(_DWORD *)(v17 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v37, v41, &v68, v17, v59, v60, v61, v62, v63, v64, v17);
      goto LABEL_181;
    }
LABEL_176:
    v45 = 0;
