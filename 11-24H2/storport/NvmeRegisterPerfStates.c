/*
 * XREFs of NvmeRegisterPerfStates @ 0x1401369C4
 * Callers:
 ...
 *     RaidGetStorPoFxPerfState @ 0x140072C48 (RaidGetStorPoFxPerfState.c)
 *     RaidValidatePerfSets @ 0x1400795EC (RaidValidatePerfSets.c)
 */
