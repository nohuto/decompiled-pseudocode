/*
 * XREFs of RaidUnitResetUnit @ 0x1400A01E8
 * Callers:
...
__int64 __fastcall RaidUnitResetUnit(__int64 a1)
{
  ...
  *(_OWORD *)&v32[1] = 0LL;
  ...
  Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0x20u, *(_BYTE *)v5, 0);
  v8 = Srb;
  if ( Srb )
  {
    if ( *(_BYTE *)v5 == 1 )
    ...
    if ( v15 )
    {
      ...
      if ( (unsigned int)dword_140170178 > 5 )
      {
        ...
        v32[0] = v20;
        v49 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v25, (unsigned __int8 *)dword_14015E4D8, v18, v20, 0xAu, &v33);
      }
      if ( (Microsoft_Windows_StorPortEnableBits & 1) != 0 )
        McTemplateK0quuu_EtwWriteTransfer(v19, v17, v18, *(_DWORD *)(*(_QWORD *)(a1 + 24) + 56LL), v4, v24, v23);
    }
    else
    {
      Status = -1073741801;
