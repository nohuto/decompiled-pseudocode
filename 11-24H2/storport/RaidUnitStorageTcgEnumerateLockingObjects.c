/*
 * XREFs of RaidUnitStorageTcgEnumerateLockingObjects @ 0x14008108C
 * Callers:
...
__int64 __fastcall RaidUnitStorageTcgEnumerateLockingObjects(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)v57 = 0LL;
  ...
  if ( v2 && *(_DWORD *)(v4 + 16) >= 0x20u && *(_WORD *)v2 == 1 && *(_DWORD *)(v2 + 4) == 32 )
  {
    ...
    {
      TcgProperties = RaidGetTcgLockingObjects(a1, v57, v63);
      if ( TcgProperties < 0 )
      {
LABEL_18:
      ...
      v13 = *(_QWORD *)(a1 + 3592);
      v55 = *(_DWORD *)(v4 + 8);
      RaidFillTcgLockingObjects(v13, v57[0], v2, (int)&v55, v11);
  ...
  if ( TcgProperties < 0 )
  {
    *(_QWORD *)(a2 + 56) = 0LL;
    if ( v52 )
    {
      v14 = *(_QWORD *)(a1 + 24);
      v55 = *(_DWORD *)(a1 + 104);
      RaidDriverGetName(*(_QWORD *)(v14 + 16), (__int64)&v61);
      v16 = *(_QWORD *)(a1 + 24);
  ...
  if ( *(_BYTE *)v23 != 15 )
  {
    ...
    if ( *(_BYTE *)(v23 + 1) == 7 && !*(_DWORD *)(v23 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v45) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v22, v23, &v62, a2, v45, v46);
      }
      goto LABEL_97;
    }
...
LABEL_96:
    ...
    McTemplateK0pd_EtwWriteTransfer(v22, v25, &v62, a2, v45);
    goto LABEL_97;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_97;
...
LABEL_92:
    ...
    LOBYTE(v46) = v40;
    LODWORD(v45) = *(_DWORD *)(a2 + 48);
    McTemplateK0pduuuuup_EtwWriteTransfer(v22, v26, &v62, a2, v45, v46, v47, v48, v49, v50, a2);
  }
LABEL_97:
