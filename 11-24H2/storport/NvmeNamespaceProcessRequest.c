/*
 * XREFs of NvmeNamespaceProcessRequest @ 0x140107538
 * Callers:
...
LABEL_24:
  ...
  if ( *v8 == 53 )
  {
    v16 = NvmeNamespaceScsiSyncCacheRequest(a1, a2, v7, (_DWORD)v8, v4);
LABEL_34:
    v17 = v16;
...
LABEL_166:
                        ...
                        McTemplateK0pduuuuup_EtwWriteTransfer(v63, v45, &v74, v5, v65, v58, v46, v49, v62, v63, v5);
                      }
                    }
                    goto LABEL_171;
                  }
          ...
          if ( *(_BYTE *)(v41 + 1) == 7 && !*(_DWORD *)(v41 + 8) )
          {
            if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              if ( v42 )
                ...
                v43 = 0LL;
              LODWORD(v65) = v43;
              McTemplateK0pqd_EtwWriteTransfer(v43, v41, &v74, v5, v65, *(_DWORD *)(v5 + 48));
            }
            goto LABEL_171;
          }
...
LABEL_171:
      ...
      LODWORD(v65) = *(_DWORD *)(v5 + 48);
      McTemplateK0pd_EtwWriteTransfer(v40, v44, &v74, v5, v65);
      goto LABEL_171;
    }
    goto LABEL_37;
  }
  if ( v15 == 66 )
  {
    v16 = NvmeNamespaceScsiUnmapRequest(a1, a2, v7, (_DWORD)v8, v4);
    goto LABEL_34;
  }
  if ( v15 == 40 || v15 == -120 || v15 == 42 || v15 == -118 )
  {
    v16 = NvmeNamespaceScsiReadWriteRequest(a1, a2, v7, (_DWORD)v8, v4);
    goto LABEL_34;
  }
  LOBYTE(v8) = 32;
  LOBYTE(a3) = 5;
  ...
  v17 = -1073741808;
LABEL_37:
  *(_BYTE *)(v7 + 3) = RaidNtStatusToSrbStatus(v17);
  *(_QWORD *)(v5 + 56) = 0LL;
  ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(a1 + 120));
  v18 = StorEtwLoggingEnabled == 0;
  *(_BYTE *)(v5 + 141) = -84;
    ...
    if ( *(_BYTE *)(v20 + 1) == 7 && !*(_DWORD *)(v20 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v21 )
          v3 = *v21;
        LODWORD(v65) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v19, v20, &v75, v5, v65, *(_DWORD *)(v5 + 48));
      }
      goto LABEL_172;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_102:
    LODWORD(v65) = *(_DWORD *)(v5 + 48);
    McTemplateK0pd_EtwWriteTransfer(v19, v22, &v75, v5, v65);
    goto LABEL_172;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_172;
...
LABEL_98:
      ...
      LODWORD(v65) = *(_DWORD *)(v5 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v19, v23, &v75, v5, v65, v36, v24, v27, v3, v39, v5);
    }
  }
LABEL_172:
