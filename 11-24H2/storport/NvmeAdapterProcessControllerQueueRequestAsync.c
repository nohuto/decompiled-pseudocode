/*
 * XREFs of NvmeAdapterProcessControllerQueueRequestAsync @ 0x1400E631C
 * Callers:
        ...
        __int64 a10)
{
  ...
  v18 = NvmeAdapterAssignControllerQueueSlot(a1, a3, &v22, &v25);
  ...
  NvmeAdapterPrepareControllerQueueRequest(
    ...
    a10,
    &v23);
  v17 = NvmeAdapterMapDataBuffer((__int64)v16, v23);
  if ( v17 < 0 )
  {
LABEL_5:
  ...
  if ( (v16[36] & 0x1000LL) != 0 )
    v21 = NvmeAdapterRaiseIrqlAndExecuteXrb(v16, v23);
  else
    v21 = NvmeAdapterExecuteXrb(v16, v23, v20);
  v17 = v21;
  if ( v21 >= 0 )
    return 259;
  _InterlockedAdd16((volatile signed __int16 *)(a1 + 148), 0xFFFFu);
LABEL_6:
  NvmeAdapterCleanupControllerQueueRequest(a1, v23);
LABEL_7:
  if ( *(_WORD *)(a1 + 136) )
