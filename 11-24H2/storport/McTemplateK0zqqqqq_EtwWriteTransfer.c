/*
 * XREFs of McTemplateK0zqqqqq_EtwWriteTransfer @ 0x1400A6050
 * Callers:
        ...
        char a9)
{
  ...
  v24 = &a9;
  v25 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)L"NULL", &EventIncreaseAdapterResourceList, 0LL, 7u, &v12);
}
