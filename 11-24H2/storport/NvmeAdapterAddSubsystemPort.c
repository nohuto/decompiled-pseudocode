/*
 * XREFs of NvmeAdapterAddSubsystemPort @ 0x14019363C
 * Callers:
  ...
  if ( *(_BYTE *)v24 != 15 )
  {
    ...
    if ( *(_BYTE *)(v24 + 1) == 7 && !*(_DWORD *)(v24 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        LODWORD(v46) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v23, v24, &v55, a2, v46, v47);
      }
      goto LABEL_94;
    }
...
LABEL_93:
    ...
    McTemplateK0pd_EtwWriteTransfer(v23, v26, &v55, a2, v46);
    goto LABEL_94;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_94;
...
LABEL_89:
      ...
      LODWORD(v46) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v23, v27, &v55, a2, v46, v47, v48, v49, v50, v51, a2);
    }
  }
LABEL_94:
