/*
 * XREFs of McTemplateK0zqjuuujssstsxx_EtwWriteTransfer @ 0x140022CE4
 * Callers:
        ...
        char a17)
{
  ...
  v59 = v18;
  v65 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v30, &EventQueuedIoExceededThreshold, 0LL, 15LL, v33);
}
