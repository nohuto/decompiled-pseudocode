/*
 * XREFs of StorBuildNVMeIdentifier @ 0x14008EAC0
 * Callers:
 ...
 * Callees:
 *     NvmeNamespaceGetIdentifier @ 0x140088440 (NvmeNamespaceGetIdentifier.c)
 *     StorGUIDToSCSINameString @ 0x14008F32C (StorGUIDToSCSINameString.c)
 *     __security_check_cookie @ 0x140143690 (__security_check_cookie.c)
 */

__int64 __fastcall StorBuildNVMeIdentifier(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdx
  __int64 v6; // rsi
  __int64 v7; // rax
  ...
  {
    NvmeNamespaceGetIdentifier(a1, v3, &v21, &v20);
    if ( v20 == 16 )
    {
      v11 = v21;
LABEL_8:
  ...
  v13 = 8LL;
LABEL_13:
  if ( (int)StorGUIDToSCSINameString(v13, v11, a3, a3) < 0 )
    return 0;
  return v12;
}
