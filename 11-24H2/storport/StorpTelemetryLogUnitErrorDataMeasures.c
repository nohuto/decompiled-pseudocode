/*
 * XREFs of StorpTelemetryLogUnitErrorDataMeasures @ 0x1400B4D58
 * Callers:
...
void __fastcall StorpTelemetryLogUnitErrorDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v35 = 1LL;
    v37 = 1LL;
    tlgCreate1Sz_wchar_t((__int64)v38, *(const wchar_t **)(v3 + 4720));
    ...
    v68 = 4LL;
    v70 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v6, (unsigned __int8 *)dword_140161C17, v7, (__int64)v4, 0x1Du, &v23);
  }
  *(_QWORD *)(a1 + 2284) = 0LL;
}
