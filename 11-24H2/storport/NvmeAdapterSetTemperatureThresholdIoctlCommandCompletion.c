/*
 * XREFs of NvmeAdapterSetTemperatureThresholdIoctlCommandCompletion @ 0x1400D7A90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeAdapterSetTemperatureThresholdIoctlCommandCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // ebx
  __int64 v5; // rcx
  __int64 v7; // rsi
  ...
  if ( *(_BYTE *)v20 != 15 )
  {
    ...
    if ( *(_BYTE *)(v20 + 1) == 7 && !*(_DWORD *)(v20 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v21 )
          v3 = *v21;
        McTemplateK0pqd_EtwWriteTransfer(v19, v20, &v47, v7, v3, *(_DWORD *)(v7 + 48));
      }
      goto LABEL_163;
    }
...
LABEL_156:
    if ( (_BYTE)v27 )
    {
      ...
      v44 = v33;
LABEL_159:
      McTemplateK0pduuuuup_EtwWriteTransfer(v19, v27, &v47, v7, *(_DWORD *)(v7 + 48), v41, v28, v31, v3, v44, v7);
      goto LABEL_163;
    }
LABEL_158:
    v31 = 0;
