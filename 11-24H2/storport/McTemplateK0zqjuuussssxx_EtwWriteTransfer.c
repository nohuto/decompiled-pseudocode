/*
 * XREFs of McTemplateK0zqjuuussssxx_EtwWriteTransfer @ 0x1400912A4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqjuuussssxx_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a15)
{
  ...
  v52 = v15;
  v58 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v28, &EventSMRUnsupportedZoneSizeErrorV2, 0LL, 0xDu, &v30);
}
