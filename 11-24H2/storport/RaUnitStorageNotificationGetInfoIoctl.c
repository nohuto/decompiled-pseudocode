/*
 * XREFs of RaUnitStorageNotificationGetInfoIoctl @ 0x14009A790
 * Callers:
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v3 = *v12;
        McTemplateK0pqd_EtwWriteTransfer(v10, v11, &v35, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_75;
    }
    ...
    v30 = *(_DWORD *)(a2 + 48);
LABEL_74:
    McTemplateK0pd_EtwWriteTransfer(v10, v13, &v35, a2, v30);
    goto LABEL_75;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_75;
...
LABEL_70:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v10, v14, &v35, a2, *(_DWORD *)(a2 + 48), v26, v15, v18, v3, v29, a2);
    }
  }
LABEL_75:
