/*
 * XREFs of StorLogMFNDNameSpaceRead @ 0x140067354
 * Callers:
        ...
        int a7)
{
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    v31 = 0;
    v32 = 0LL;
    LOWORD(v12) = RaidDriverGetName(v11, (__int64)&v28);
    ...
    if ( a7 >= 0 )
    {
      if ( (byte_140171467 & 4) != 0 )
      {
        ...
        if ( !v21 || (v26 = *(const wchar_t **)(v21 + 24)) == 0LL )
          v26 = (const wchar_t *)&unk_140151214;
        LOWORD(v12) = McTemplateK0qjzszhhssqqqxqquuq_EtwWriteTransfer(
                        a6 >> 1,
