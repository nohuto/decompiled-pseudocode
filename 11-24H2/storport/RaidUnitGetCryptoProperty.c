/*
 * XREFs of RaidUnitGetCryptoProperty @ 0x14009E600
 * Callers:
...
__int64 __fastcall RaidUnitGetCryptoProperty(__int64 a1, __int64 a2)
{
  ...
  if ( !v3 || !*(_QWORD *)(v3 + 104) )
    return 3221225659LL;
  v5 = RaidConvertCryptoCapabilitiesToExternal(a2, &v34, *(unsigned __int16 **)(v3 + 104), 2);
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v10 )
          v4 = *v10;
        McTemplateK0pqd_EtwWriteTransfer(v8, v9, &v35, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_68;
    }
