/*
 * XREFs of NvmeNamespacePowerIrp @ 0x140106734
 * Callers:
...
__int64 __fastcall NvmeNamespacePowerIrp(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&v89.Data1 = a1;
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v30 = NvmeNamespaceSetPowerIrp(v3, a2);
      goto LABEL_210;
    }
    *(_BYTE *)(a2 + 141) = -84;
    if ( v29 != 1 )
...
LABEL_210:
        ...
        case 0x1B:
          if ( *(_BYTE *)(v32 + 1) == 7 && !*(_DWORD *)(v32 + 8) )
          {
            if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              if ( v33 )
                v5 = *v33;
              McTemplateK0pqd_EtwWriteTransfer(v31, v32, &v90, a2, v5, *(_DWORD *)(a2 + 48));
            }
            goto LABEL_137;
          }
      ...
      McTemplateK0pd_EtwWriteTransfer(v31, v34, &v90, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_137;
    }
    v7 = StorEtwLoggingEnabled == 0;
    *(_DWORD *)(a2 + 48) = 0;
        ...
        if ( *(_BYTE *)(v53 + 1) == 7 && !*(_DWORD *)(v53 + 8) )
        {
          if ( (byte_140171462 & 0x40) != 0 )
          {
            ...
            if ( v54 )
              ...
              v55 = 0LL;
            McTemplateK0pqd_EtwWriteTransfer(v55, v53, &v90, a2, v55, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_206;
        }
        if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_206:
    ...
    McTemplateK0pd_EtwWriteTransfer(v52, v56, &v90, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_206;
  }
  v7 = StorEtwLoggingEnabled == 0;
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v10 )
          v5 = *v10;
        McTemplateK0pqd_EtwWriteTransfer(v8, v9, &v89, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_68:
    McTemplateK0pd_EtwWriteTransfer(v8, v11, &v89, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_69;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_69;
...
LABEL_64:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v8, v12, &v89, a2, *(_DWORD *)(a2 + 48), v24, v13, v16, v5, v27, a2);
    }
  }
LABEL_69:
  IofCompleteRequest((PIRP)a2, 0);
