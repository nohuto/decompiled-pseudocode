/*
 * XREFs of RaUnitDecrementOutstandingIrpRequests @ 0x14000C170
 * Callers:
...
int __fastcall RaUnitDecrementOutstandingIrpRequests(__int64 a1, unsigned int a2)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 32) + 80LL) & 1) != 0 )
  {
    ...
    if ( _InterlockedExchangeAdd(&v4[16 * (unsigned __int64)a2 + 1], 0xFFFFFFFE) == 2 )
    {
      ...
      if ( _InterlockedExchangeAdd(v4, 0xFFFFFFFC) == 4 )
      {
        ...
        {
          v8 = *(_QWORD *)(a1 + 24);
          if ( (v7 & 1) != 0 && (unsigned __int8)RaidUnitCheckAndAcquirePoFx(a1) )
          {
