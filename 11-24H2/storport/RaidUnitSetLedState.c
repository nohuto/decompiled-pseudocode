/*
 * XREFs of RaidUnitSetLedState @ 0x1400A0B24
 * Callers:
...
NTSTATUS __fastcall RaidUnitSetLedState(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 48) = v9;
  ...
  if ( *(_BYTE *)v17 != 15 )
  {
    ...
    v36 = *(_DWORD *)(a2 + 48);
LABEL_80:
    McTemplateK0pd_EtwWriteTransfer(v16, v19, &v41, a2, v36);
    goto LABEL_81;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_81;
...
LABEL_76:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v16, v20, &v41, a2, *(_DWORD *)(a2 + 48), v32, v21, v24, v3, v35, a2);
    }
  }
LABEL_81:
