/*
 * XREFs of NvmeControllerCreateCommandTimeoutDetectThread @ 0x1400EC2C8
 * Callers:
...
__int64 __fastcall NvmeControllerCreateCommandTimeoutDetectThread(_QWORD *a1)
{
  ...
  *(_QWORD *)&ObjectAttributes.Length = 48LL;
  ...
  {
    Object = 0LL;
    if ( ObReferenceObjectByHandle(*(HANDLE *)(*(_QWORD *)(a1[161] + 40LL) + 224LL), 0x1FFFFFu, 0LL, 0, &Object, 0LL) >= 0 )
    {
