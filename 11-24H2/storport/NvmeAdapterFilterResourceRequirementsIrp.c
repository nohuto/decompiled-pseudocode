/*
 * XREFs of NvmeAdapterFilterResourceRequirementsIrp @ 0x140196B4C
 * Callers:
...
__int64 __fastcall NvmeAdapterFilterResourceRequirementsIrp(__int64 a1, __int64 a2)
{
  ...
  v50 = 0LL;
  v5 = 0;
  v46 = RaForwardIrpSynchronous(v3, (IRP *)a2);
  v6 = v46;
  if ( v46 >= 0 )
  {
    ...
    if ( v7 )
    {
      ...
      *(_DWORD *)(a1 + 568) = v7[2];
      *(_DWORD *)(a1 + 572) = v7[3];
      if ( (*(_DWORD *)(v8 + 184) & 0x200) != 0 && !(unsigned __int8)RaidMachineRequireIoPortResource() )
      {
        v9 = v7 + 8;
        v10 = 0;
        v11 = v7 + 8;
...
LABEL_20:
      ...
      else if ( (v19 & 0x100) != 0 && NvmeIsAdapterControlSupported(a1 + 168, 13) )
      {
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( (byte_140171462 & 0x20) != 0 )
      McTemplateK0pd_EtwWriteTransfer(v20, &EventPnpRequestComplete, &v50, a2, *(_DWORD *)(a2 + 48));
  }
    ...
    if ( *(_BYTE *)(v23 + 1) == 7 && !*(_DWORD *)(v23 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v24 )
          v5 = *v24;
        LODWORD(v43) = v5;
        McTemplateK0pqd_EtwWriteTransfer(v22, v23, &v49, a2, v43, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_97;
    }
    if ( (byte_140171462 & 0x20) == 0 )
...
LABEL_96:
    ...
    McTemplateK0pd_EtwWriteTransfer(v22, v25, &v49, a2, v43);
    goto LABEL_97;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_97;
...
LABEL_92:
      ...
      LODWORD(v43) = *(_DWORD *)(a2 + 48);
      McTemplateK0pduuuuup_EtwWriteTransfer(v22, v26, &v49, a2, v43, v38, v27, v30, v5, v41, a2);
    }
  }
LABEL_97:
