/*
 * XREFs of StorGetAndLogMFNDQoSStatisticsWorkRoutine @ 0x1400C3A30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall StorGetAndLogMFNDQoSStatisticsWorkRoutine(__int64 a1, __int64 a2)
{
  ...
  v4 = 0;
  if ( *(_QWORD *)(*(_QWORD *)(v2 + 6160) + 48LL) && *(_WORD *)(a2 + 20) )
  {
    do
    {
      v5 = v4++;
      ...
      _interlockedbittestandreset(
        (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v2 + 6160) + 48LL) + 4 * ((unsigned __int64)(v6 - 1) >> 5)),
        ((_BYTE)v6 - 1) & 0x1F);
    }
