/*
 * XREFs of TranslateToExtendedSrb @ 0x140027B60
 * Callers:
 *     RaidUnitClaimIrp @ 0x14004FB60 (RaidUnitClaimIrp.c)
 * Callees:
 *     TranslateScsiRequestBlockToStorageRequestBlock @ 0x140028180 (TranslateScsiRequestBlockToStorageRequestBlock.c)
...
LABEL_52:
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 0x40) != 0 )
    McTemplateK0zx_EtwWriteTransfer(LowPart, v31.LowPart, v33, (unsigned int)L"Translate SCSI_REQUEST_BLOCK", v6);
