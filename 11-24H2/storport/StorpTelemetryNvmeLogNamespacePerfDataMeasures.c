/*
 * XREFs of StorpTelemetryNvmeLogNamespacePerfDataMeasures @ 0x1400B745C
 * Callers:
...
void __fastcall StorpTelemetryNvmeLogNamespacePerfDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v23 = v7 != 0 ? 20 : 17;
      v45 = &v23;
      tlgCreate1Sz_wchar_t((__int64)v47, *(const wchar_t **)(*(_QWORD *)(v6 + 128) + 1016LL));
      v48 = &v27;
      v17 = *(_BYTE *)(v8 + 8);
      v50 = &v17;
      v28 = *(_QWORD *)(v8 + 360);
      ...
      v77 = v15;
      v78 = 8 * (unsigned __int16)(3 * qword_140170E30);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_140170E30) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1401629E0,
        v16,
        (__int64)v13,
        0x1Cu,
        &v32);
