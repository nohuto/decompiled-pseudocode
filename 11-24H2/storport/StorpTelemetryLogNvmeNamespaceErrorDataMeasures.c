/*
 * XREFs of StorpTelemetryLogNvmeNamespaceErrorDataMeasures @ 0x1400B3DE4
 * Callers:
...
void __fastcall StorpTelemetryLogNvmeNamespaceErrorDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140170178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v55[1] = 0;
      v55[0] = 104 * v10;
      tlgWriteTransfer_EtwWriteTransfer(v11, (unsigned __int8 *)dword_14015FEDA, v8, v7, 0x16u, &v21);
    }
  }
}
