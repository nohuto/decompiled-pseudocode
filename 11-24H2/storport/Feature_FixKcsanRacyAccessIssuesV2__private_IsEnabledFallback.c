/*
 * XREFs of Feature_FixKcsanRacyAccessIssuesV2__private_IsEnabledFallback @ 0x1400A52EC
 * Callers:
...
__int64 __fastcall Feature_FixKcsanRacyAccessIssuesV2__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
  return wil_details_IsEnabledFallback(
           a1,
           a2,
           (volatile signed __int32 **)&Feature_FixKcsanRacyAccessIssuesV2__private_descriptor);
}
