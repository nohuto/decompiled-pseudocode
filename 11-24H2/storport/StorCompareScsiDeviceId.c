/*
 * XREFs of StorCompareScsiDeviceId @ 0x140033B0C
 * Callers:
...
__int64 __fastcall StorCompareScsiDeviceId(_BYTE *a1, _BYTE *a2)
{
  ...
  if ( a1[1] == 0x83 )
  {
    ...
    while ( 1 )
    {
      NextVPDIdDescriptor = StorGetNextVPDIdDescriptor(&v22);
      v11 = (_BYTE *)NextVPDIdDescriptor;
      if ( !NextVPDIdDescriptor )
        break;
      v13 = *(_BYTE *)(NextVPDIdDescriptor + 1);
