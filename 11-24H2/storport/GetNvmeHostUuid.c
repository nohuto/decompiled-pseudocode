/*
 * XREFs of GetNvmeHostUuid @ 0x14006E3F8
 * Callers:
...
__int64 __fastcall GetNvmeHostUuid(__int64 a1)
{
  ...
  *(_OWORD *)DstBuf = 0LL;
  v14 = 0LL;
  if ( !*(_QWORD *)&NvmeHostUuid.Data1 )
    v2 = *(_QWORD *)NvmeHostUuid.Data4 - *((_QWORD *)&v12 + 1);
  if ( v2 )
    goto LABEL_15;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v3 < 0 )
    {
      v3 = ExUuidCreate(&NvmeHostUuid);
      if ( v3 >= 0 )
        v3 = ZwSetValueKey(KeyHandle, &ValueName, 0, 3u, (PVOID)&NvmeHostUuid, 0x10u);
    }
