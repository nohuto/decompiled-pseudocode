/*
 * XREFs of NvmeAdapterGetAuthenticationKeys @ 0x14019707C
 * Callers:
...
__int64 __fastcall NvmeAdapterGetAuthenticationKeys(__int64 a1, _QWORD *a2)
{
  ...
  int NvmeHostNQN; // [rsp+70h] [rbp-98h]
    ...
    && (v15 = *(unsigned int *)(v8 + 8), (_DWORD)v15) )
  {
    if ( *(unsigned int *)(v2 + 8) >= (unsigned __int64)(528 * v15 + 8) )
    {
      ...
      *v20 = 524289;
      ...
      v21 = (const char *)RtlEnumerateGenericTableWithoutSplaying(&NvmeAuthKeyTable, &RestartKey);
      if ( v21 )
      {
        v22 = v49;
        do
        {
          if ( (!v6 || !_strnicmp(v21 + 20, Str2, 0x100uLL)) && ++v5 > v46 )
          {
            PopulateNvmeAuthenticationKeyInfo((__int64)v21, (__int64)&v20[132 * (v5 - v46) - 130]);
            ++v20[1];
            *((_WORD *)v20 + 1) += 528;
            if ( !--v22 )
              break;
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v3 = *v14;
        McTemplateK0pqd_EtwWriteTransfer(v12, v13, &RestartKey_8, v4, v3, *((_DWORD *)v4 + 12));
      }
      goto LABEL_95;
    }
...
LABEL_94:
    McTemplateK0pd_EtwWriteTransfer(v12, v23, &RestartKey_8, v4, *((_DWORD *)v4 + 12));
    goto LABEL_95;
  }
  if ( byte_140171461 >= 0 )
    goto LABEL_95;
