/*
 * XREFs of NvmeNamespaceCreateIoQueue @ 0x1400FD040
 * Callers:
    ...
    *(_DWORD *)(*(_QWORD *)(a1 + 256) + 12LL) = 90
    ...
    if ( *((_DWORD *)v1 + 2) )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) = RaidAllocatePoolEx(
                                                               72LL,
                                                               v10,
                                                               1296982354LL,
                                                               *(_QWORD *)(a1 + 8),
                                                               v12);
        v13 = *(_QWORD *)(a1 + 256);
        if ( !*(_QWORD *)(v13 + 8LL * v6 + 64) )
          break;
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) + 32LL) = RaidAllocatePoolEx(
                                                                                   72LL,
                                                                                   v9,
                                                                                   1296982354LL,
                                                                                   *(_QWORD *)(a1 + 8),
                                                                                   v12);
        v13 = *(_QWORD *)(a1 + 256);
        if ( !*(_QWORD *)(*(_QWORD *)(v13 + 8LL * v6 + 64) + 32LL) )
          break;
        v14 = 0LL;
        v15 = 16LL;
        do
        {
          InitializeSListHead((PSLIST_HEADER)(v14
                                            + *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) + 32LL)));
          v14 += 16LL;
          --v15;
        }
        while ( v15 );
        *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) + 12LL) = 16;
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) + 56LL) = RaidAllocatePoolEx(
                                                                                   72LL,
                                                                                   v25,
                                                                                   1296982354LL,
                                                                                   *(_QWORD *)(a1 + 8),
                                                                                   v12);
        v13 = *(_QWORD *)(a1 + 256);
        v16 = *(_QWORD *)(v13 + 8LL * v6 + 64);
        if ( !*(_QWORD *)(v16 + 56) )
          break;
        *(_QWORD *)(v16 + 16) = v13;
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64) + 24LL) = a1;
        ...
        if ( v17 )
        {
          ...
          if ( v18 )
          {
            *(_QWORD *)(v18 + 8LL * *(unsigned int *)(v18 + 4) + 264) = *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * v6 + 64);
      ...
      if ( v13 )
      {
        ...
        {
          v22 = *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * i + 64);
          if ( v22 )
          {
            v23 = *(void **)(v22 + 32);
            if ( v23 )
              ExFreePoolWithTag(v23, 0x4D4E6152u);
            v24 = *(void **)(*(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * i + 64) + 56LL);
            if ( v24 )
              ExFreePoolWithTag(v24, 0x4D4E6152u);
            ExFreePoolWithTag(*(PVOID *)(*(_QWORD *)(a1 + 256) + 8LL * i + 64), 0x4D4E6152u);
            *(_QWORD *)(*(_QWORD *)(a1 + 256) + 8LL * i + 64) = 0LL;
          }
        }
