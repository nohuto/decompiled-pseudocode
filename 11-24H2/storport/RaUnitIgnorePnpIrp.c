/*
 * XREFs of RaUnitIgnorePnpIrp @ 0x14018597C
 * Callers:
...
__int64 __fastcall RaUnitIgnorePnpIrp(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebp
  int v3; // ebx
  bool v4; // zf
  ...
  unsigned int v32; // [rsp+68h] [rbp-50h]
  GUID v33; // [rsp+70h] [rbp-48h] BYREF
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_140171462 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v3 = *v8;
        McTemplateK0pqd_EtwWriteTransfer(v6, v7, &v33, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
...
LABEL_62:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v33, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v3, v26, a2);
    }
  }
LABEL_67:
