/*
 * XREFs of NvmeNamespaceQueryDeviceTextIrp @ 0x1401A68F0
 * Callers:
...
__int64 __fastcall NvmeNamespaceQueryDeviceTextIrp(__int64 a1, __int64 a2)
{
  ...
  _BYTE v101[128]; // [rsp+E0h] [rbp-20h] BYREF
  ...
  if ( v4 <= 1 )
  {
    ...
    if ( Pool )
    {
      ...
      if ( v4 )
      {
        ...
        if ( v6 )
        {
          RaidRemoveTrailingBlanks((__int64)&v97, 21);
          RtlStringCchPrintfW(
            Pool,
            0x100uLL,
        ...
        {
          RaidRemoveTrailingBlanks((__int64)&v97, 21);
          StorBuildNVMeIdentifier(a1, v53, (__int64)v101);
          RtlStringCchPrintfW(
            Pool,
            0x100uLL,
      ...
      else
      {
        ...
        v99[1] = *(_OWORD *)(v51 + 40);
        v100 = *(_QWORD *)(v51 + 56);
        RaidRemoveTrailingBlanks((__int64)v99, 41);
        RtlStringCchPrintfW(Pool, 0x100uLL, L"%hs", v99);
      }
...
LABEL_200:
                      ...
                      McTemplateK0pduuuuup_EtwWriteTransfer(v80, v60, &v96, a2, v82, v83, v84, v64, v79, v80, a2);
                    }
                  }
                  goto LABEL_205;
                }
        ...
        case 0x1B:
          if ( *(_BYTE *)(v56 + 1) == 7 && !*(_DWORD *)(v56 + 8) )
          {
            if ( (byte_140171462 & 0x40) != 0 )
            {
              ...
              LODWORD(v82) = v58;
              McTemplateK0pqd_EtwWriteTransfer(v58, v56, &v96, a2, v82, v83);
            }
            goto LABEL_205;
          }
...
LABEL_205:
      ...
      LODWORD(v82) = *(_DWORD *)(a2 + 48);
      McTemplateK0pd_EtwWriteTransfer(v55, v59, &v96, a2, v82);
      goto LABEL_205;
    }
    v6 = StorEtwLoggingEnabled == 0;
    v7 = -1073741801;
  ...
  *(_DWORD *)(a2 + 48) = -1073741637;
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      ...
      v11 = &v94;
LABEL_12:
      McTemplateK0pqd_EtwWriteTransfer(v8, v9, v11, a2, v5, *(_DWORD *)(a2 + 48));
      goto LABEL_206;
    }
    if ( (byte_140171462 & 0x20) == 0 )
      goto LABEL_206;
...
LABEL_16:
    McTemplateK0pd_EtwWriteTransfer(v8, v13, v12, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_206;
  }
  if ( (byte_140171461 & 0x80) == 0 )
    goto LABEL_206;
...
LABEL_64:
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v8, v14, &v94, a2, *(_DWORD *)(a2 + 48), v27, v15, v18, v5, v30, a2);
    }
  }
LABEL_66:
  v7 = -1073741637;
