/*
 * XREFs of RtlFindActivationContextSectionString @ 0x18005DCB0
 * Callers:
...
__int64 __fastcall RtlFindActivationContextSectionString(int a1, __int64 a2, int a3, __int64 a4, _DWORD *a5)
{
  ...
  void (__fastcall *v16)(__int64, volatile signed __int32 *, _QWORD, _QWORD, _QWORD, _BYTE *); // rax
  ...
  volatile signed __int32 *v22; // [rsp+58h] [rbp-9h] BYREF
  volatile signed __int32 *v23; // [rsp+60h] [rbp-1h] BYREF
...
LABEL_7:
      ...
      else
      {
        ...
        if ( NextActivationContextSection >= 0 )
        {
          ...
          if ( (((unsigned __int64)v15 - 1) | 7) != 0xFFFFFFFFFFFFFFFFuLL )
          {
            v16 = (void (__fastcall *)(__int64, volatile signed __int32 *, _QWORD, _QWORD, _QWORD, _BYTE *))*((_QWORD *)v15 + 4);
            if ( v16 )
            {
              if ( (v15[12] & 8) == 0 || (v15[20] & 8) == 0 )
              {
                v17[0] = 0;
                v16(3LL, v15, *((_QWORD *)v15 + 3), *((_QWORD *)v15 + 5), 0LL, v17);
                *((_DWORD *)v15 + 12) |= 8u;
                if ( v17[0] )
                  *((_DWORD *)v15 + 20) |= 8u;
              }
