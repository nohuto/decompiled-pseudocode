/*
 * XREFs of RtlpHpTagQueryHeapsRemote @ 0x1800B7D40
 * Callers:
...
__int64 __fastcall RtlpHpTagQueryHeapsRemote(_OWORD *a1, size_t a2, size_t *a3)
{
  ...
  v6 = NtCreateSection(&Handle, 983071LL, 0LL, &v14);
  if ( v6 < 0 )
    goto LABEL_7;
  v13 = a2;
  v6 = ((__int64 (__fastcall *)(HANDLE, __int64, void **, _QWORD, size_t, _QWORD, size_t *, int, _DWORD, int))ZwMapViewOfSection)(
         Handle,
         -1LL,
         &Src,
         0LL,
