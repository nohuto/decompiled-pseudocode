/*
 * XREFs of RtlpHpVaMgrRangeFree @ 0x18009D854
 * Callers:
...
NTSTATUS __fastcall RtlpHpVaMgrRangeFree(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_BYTE *)(a1 + 46) & 0xE) == 0xA )
    return ((__int64 (__fastcall *)(__int64, __int64, PVOID *, ULONG_PTR *, int))(*(_QWORD *)(a1 + 32) ^ RtlpHpHeapGlobals ^ *(_QWORD *)(*(_QWORD *)(a1 + 32) + 16LL)))(
