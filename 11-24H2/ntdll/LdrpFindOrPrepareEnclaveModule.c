/*
 * XREFs of LdrpFindOrPrepareEnclaveModule @ 0x1800D3A60
 * Callers:
        ...
        __int64 a7)
{
  ...
  *a6 = 0LL;
  if ( (a4 & 0x20) != 0 )
  {
    if ( RtlEqualUnicodeString((PUNICODE_STRING)&stru_180172CD0, a2, 1u) )
    {
      if ( a5 == *(_QWORD *)(a1 + 120) || a5 == *(_QWORD *)(a1 + 128) )
        v9 = (_UNICODE_STRING *)&unk_180172CB0;
    }
    else
    {
      v11 = RtlPrefixUnicodeString((PUNICODE_STRING)&stru_180172CC0, v9, 1u);
      v12 = (_UNICODE_STRING *)&unk_180172CB0;
      if ( !v11 )
        v12 = v9;
      v9 = v12;
    }
