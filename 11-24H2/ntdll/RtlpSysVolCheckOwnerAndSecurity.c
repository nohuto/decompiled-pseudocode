/*
 * XREFs of RtlpSysVolCheckOwnerAndSecurity @ 0x1800CEBBC
 * Callers:
 ...
 *     RtlGetAce @ 0x1800CEF40 (RtlGetAce.c)
...
LABEL_25:
  ...
  {
    v9 = (unsigned __int16 *)(v6 + *(unsigned int *)(v6 + 4));
  }
  else
  {
    v9 = 0LL;
  ...
  v28 = 32;
  v29 = 544;
  if ( v9 && RtlEqualSid(v9, &v25) && v8 && v5 )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( !v12 )
        break;
      if ( !*(_BYTE *)v12 && RtlEqualSid((unsigned __int16 *)(v12 + 8), &v30) )
      {
        if ( (*(_BYTE *)(v12 + 1) & 3) != 3 )
        {
          *(_BYTE *)(v12 + 1) |= 3u;
  ...
  {
    v13 = v24;
    v14 = (void *)RtlpSysVolAllocate(v24);
    v15 = (__int64)v14;
    if ( !v14 )
    {
LABEL_40:
