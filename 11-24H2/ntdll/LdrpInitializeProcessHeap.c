/*
 * XREFs of LdrpInitializeProcessHeap @ 0x18002385C
 * Callers:
 ...
 *     NtOpenPartition @ 0x180162660 (NtOpenPartition.c)
...
LABEL_19:
    ...
    || (LdrpHeapPartitionName = *(_OWORD *)(a3 + 1056), _mm_srli_si128(LdrpHeapPartitionName, 8).m128i_u64[0]) )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v19 < 0 )
    {
      LdrpLogInternal("minkernel\\ldr\\ldrinit.c", 9274LL, "LdrpInitializeProcessHeap", 0LL, "Cannot open partition.");
...
LABEL_25:
  ...
  *a4 = Heap;
  ...
  v19 = RtlpHpLfhContextEnable(Heap + 832, &qword_1801D11E8);
  if ( v19 >= 0 )
  {
