/*
 * XREFs of TppCleanupGroupMemberInitialize @ 0x18001A830
 * Callers:
...
LABEL_12:
    ...
    else
    {
      ...
      v23 = (_QWORD *)(a1 + 152);
      v24 = off_1801CC740;
      if ( *off_1801CC740 != (_UNKNOWN *)&TppCleanupGroupMemberpNoPoolList )
        __fastfail(3u);
      *v23 = &TppCleanupGroupMemberpNoPoolList;
      *(_QWORD *)(a1 + 160) = v24;
      *v24 = v23;
      off_1801CC740 = (_UNKNOWN **)(a1 + 152);
    }
