/*
 * XREFs of RtlpCreateHeapEncoding @ 0x1800A8818
 * Callers:
  ...
  if ( (*(_BYTE *)(a1 + 120) & 2) == 0 && (*(_DWORD *)(a1 + 112) & 0x4000000) == 0 )
  {
    ...
    *(_DWORD *)(a1 + 124) = *(_DWORD *)(a1 + 136);
    ...
    do
    {
      ...
      v3 = v1;
      v1 = _InterlockedCompareExchange64(&qword_1801CDF00, v2, v1);
    }
    while ( v3 != v1 );
    *(_DWORD *)(a1 + 136) |= 1332534557 * v2;
    ...
    do
    {
      ...
      v6 = v4;
      v4 = _InterlockedCompareExchange64(&qword_1801CDF00, v5, v4);
    }
    while ( v6 != v4 );
    *(_WORD *)(a1 + 142) = 0;
