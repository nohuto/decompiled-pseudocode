/*
 * XREFs of LdrpPreprocessDllName @ 0x18005A570
 * Callers:
...
__int64 __fastcall LdrpPreprocessDllName(__int64 a1, unsigned __int16 *a2, __int64 a3, int *a4)
{
  int *v4; // r12
  char v5; // si
  const void **v7; // r15
    ...
    *(_OWORD *)Src = 0LL;
    ...
    if ( *(_BYTE *)v15 && (NtCurrentPeb()->TracingFlags & 4) != 0 )
    {
      v73 = (unsigned int)RtlGetCurrentServiceSessionId()
          ...
          : (char *)2147353477;
      if ( (*v73 & 0x20) != 0 )
        LdrpLogEtwEvent(5328, 0, 0, 0, a1, 0LL);
    }
    FullPath = ApiSetResolveToHost((_DWORD)ApiSetMap, a1, v9, (unsigned int)&v76, (__int64)Src);
    if ( FullPath >= 0 && v76 )
    {
      if ( !LOWORD(Src[0]) )
      {
      ...
      if ( *(_BYTE *)v12 && (NtCurrentPeb()->TracingFlags & 4) != 0 )
      {
        ...
        if ( (*(_BYTE *)v16 & 0x20) != 0 )
        {
          v41 = 5329;
LABEL_156:
          LdrpLogEtwEvent(v41, 0, 0, 0, v18, 0LL);
          goto LABEL_13;
        }
        goto LABEL_13;
      }
...
LABEL_100:
      ...
      *((_QWORD *)a2 + 1) = v63;
LABEL_55:
      memmove((void *)(*((_QWORD *)a2 + 1) + *a2), v7[1], *(unsigned __int16 *)v7);
      v47 = (unsigned __int16)(*a2 + *(_WORD *)v7);
      v48 = *((_QWORD *)a2 + 1);
      *a2 = v47;
      *(_WORD *)(v48 + 2 * (v47 >> 1)) = 0;
      goto LABEL_56;
  ...
  while ( *(_WORD *)v44 != 92 && *(_WORD *)v44 != 47 );
...
LABEL_89:
  ...
  FullPath = LdrpAppendUnicodeStringToFilenameBuffer((const void **)a2, v7);
LABEL_56:
  if ( FullPath < 0 )
    goto LABEL_89;
LABEL_57:
  v49 = (unsigned __int64)v42[1];
  v50 = (__int16 *)(v49 + *(unsigned __int16 *)v42);
  while ( 2 )
  {
