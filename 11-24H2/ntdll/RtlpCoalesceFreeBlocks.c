/*
 * XREFs of RtlpCoalesceFreeBlocks @ 0x18002EF80
 * Callers:
          ...
          *(_QWORD *)(v27 + 8) = v26;
          if ( (*(_BYTE *)(v7 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v7) )
          {
            ...
            if ( (v33 & 4) != 0 )
            {
              ...
              v35 = RtlCompareMemoryUlong(v7 + 32, v34, 4277075694LL);
              if ( v35 != v34 )
              {
                if ( NtCurrentPeb()->Ldr )
...
LABEL_93:
        ...
        *(_QWORD *)(v52 + 8) = v50;
        if ( (*(_BYTE *)(v8 + 10) & 8) != 0 )
        {
          if ( !(unsigned __int8)RtlpCommitBlock(a1, v8) )
          {
            LOBYTE(v62) = 1;
        ...
        if ( (v59 & 4) != 0 )
        {
          ...
          if ( (v59 & 2) != 0 && v60 > 4 )
            v60 = 16LL * *v55 - 36;
          v61 = RtlCompareMemoryUlong(v8 + 32, v60, 4277075694LL);
          if ( v61 != v60 )
          {
            if ( NtCurrentPeb()->Ldr )
              DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
...
LABEL_11:
    ...
    if ( *v14 == v11 + 16 && v16 == v17 )
    {
      ...
      *v14 = v15;
      *(_QWORD *)(v15 + 8) = v14;
      if ( (*(_BYTE *)(v11 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v11) )
      {
        v21 = *(_BYTE *)(v11 + 10);
        if ( (v21 & 4) != 0 )
        {
