    ...
    else
    {
      ...
      *(_BYTE *)((unsigned int)++*((_DWORD *)a1 + 1489) + a1[743]) = v19;
      ...
      if ( v20 >= 0x100u )
      {
        ...
        v22 = (unsigned __int8 *)&unk_180198C90;
      }
      else
      {
        v22 = (unsigned __int8 *)&dist_code;
      }
      ++*((_WORD *)a1 + 2 * v22[v21] + 1280);
      v23 = *((_DWORD *)a1 + 54);
      v24 = *((_DWORD *)a1 + 1489) == *((_DWORD *)a1 + 1490);
