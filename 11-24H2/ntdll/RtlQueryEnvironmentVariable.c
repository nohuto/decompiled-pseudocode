/*
 * XREFs of RtlQueryEnvironmentVariable @ 0x180007080
 * Callers:
  ...
  *ReturnLength = 0LL;
  if ( NameLength )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v12 )
        break;
      v13 = 0x180000000LL + 24LL * --v12 + 1515536;
      if ( v6 == *(_QWORD *)v13 )
      {
        if ( !wcsnicmp(v7, *(const wchar_t **)(0x180000008LL + 24LL * v12 + 1515536), v6) )
        {
          v14 = ReturnLength;
          ...
          if ( (unsigned int)v18 > 0x7A )
          {
            if ( qword_1801CC038 )
            {
              if ( (unsigned __int16)v18 >= 0xC0u )
                LOWORD(v18) = *(_WORD *)(qword_1801CC038
                                       + 2
                                       * ((v18 & 0xF)
                                        + *(unsigned __int16 *)(qword_1801CC038
                                                              + 2LL
                                                              * (((unsigned __int8)v18 >> 4)
                                                               + (unsigned int)*(unsigned __int16 *)(qword_1801CC038 + 2 * (v18 >> 8))))))
                            + v18;
            }
          }
          else
            ...
            while ( v30 < v33 )
            {
              ...
              if ( (_WORD)v34 != (_WORD)v35 )
              {
                if ( (unsigned int)v34 >= 0x61 )
                {
                  ...
                  {
                    if ( qword_1801CC038 && (unsigned __int16)v34 >= 0xC0u )
                      LOWORD(v34) = *(_WORD *)(qword_1801CC038
                                             + 2
                                             * ((v34 & 0xF)
                                              + *(unsigned __int16 *)(qword_1801CC038
                                                                    + 2LL
                                                                    * (((unsigned __int8)v34 >> 4)
                                                                     + (unsigned int)*(unsigned __int16 *)(qword_1801CC038 + 2 * (v34 >> 8))))))
                                  + v34;
                  }
                  else
                  {
                ...
                if ( (unsigned int)v35 >= 0x61 )
                {
                  ...
                  {
                    if ( qword_1801CC038 && (unsigned __int16)v35 >= 0xC0u )
                      LOWORD(v35) = *(_WORD *)(qword_1801CC038
                                             + 2
                                             * ((v35 & 0xF)
                                              + *(unsigned __int16 *)(qword_1801CC038
                                                                    + 2LL
                                                                    * (((unsigned __int8)v35 >> 4)
                                                                     + (unsigned int)*(unsigned __int16 *)(qword_1801CC038 + 2 * (v35 >> 8))))))
                                  + v35;
                  }
                  else
                  {
...
LABEL_43:
      if ( PseudoEnvironmentVariable == -1073741568 && !(_BYTE)xmmword_1801D1890 )
