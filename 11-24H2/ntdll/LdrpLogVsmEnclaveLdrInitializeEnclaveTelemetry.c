/*
 * XREFs of LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry @ 0x1800D8EA8
 * Callers:
...
struct _PEB *__fastcall LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry(int a1)
{
  ...
  if ( result->ProcessHeap )
  {
    ...
    {
      result = (struct _PEB *)tlgKeywordOn(&dword_1801CC9F0, 0x400000000000LL);
      if ( (_BYTE)result )
      {
        v10 = 0;
        v13 = 0;
        ...
        v6 = a1;
        v12 = v5;
        return (struct _PEB *)tlgWriteTransfer_EtwEventWriteTransfer(v3, byte_1801A2DA5, v4, v5, v5, (__int64)v7);
      }
    }
  }
  return result;
