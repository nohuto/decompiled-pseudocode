/*
 * XREFs of RtlGuardRestoreContext @ 0x1800358A0
 * Callers:
  ...
  if ( ExceptionRecord->ExceptionCode != -2147483610 )
  {
    ...
    else if ( ExceptionCode == -1073741785 )
    {
      if ( ((LdrSystemDllInitBlock.MitigationOptionsMap.Map[1] >> 60) & 3) != 1 )
      {
        ...
        {
          v24 = 0LL;
          if ( (unsigned __int64)Rip < *((_QWORD *)&xmmword_1801E6440 + 1)
            || (unsigned __int64)Rip >= *((_QWORD *)&xmmword_1801E6440 + 1)
          ...
          {
            *((_QWORD *)&v24 + 1) = *((_QWORD *)&xmmword_1801E6440 + 1);
          }
          if ( *((_QWORD *)&v24 + 1) )
          {
...
LABEL_7:
  if ( ((LdrSystemDllInitBlock.MitigationOptionsMap.Map[1] >> 60) & 3) != 1 )
  {
    ...
    if ( CfgBitMap )
    {
      ...
      {
        v23 = 0LL;
        if ( (unsigned __int64)v7 < *((_QWORD *)&xmmword_1801E6440 + 1)
          || (unsigned __int64)v7 >= *((_QWORD *)&xmmword_1801E6440 + 1)
                                   + (unsigned __int64)(unsigned int)qword_1801E6450 )
        {
        ...
        {
          *((_QWORD *)&v23 + 1) = *((_QWORD *)&xmmword_1801E6440 + 1);
        }
        if ( *((_QWORD *)&v23 + 1) )
        {
