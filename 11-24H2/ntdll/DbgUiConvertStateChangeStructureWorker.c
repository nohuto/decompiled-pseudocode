/*
 * XREFs of DbgUiConvertStateChangeStructureWorker @ 0x18010C4E4
 * Callers:
 *     DbgUiConvertStateChangeStructure @ 0x180112BC0 (DbgUiConvertStateChangeStructure.c)
 *     DbgUiConvertStateChangeStructureEx @ 0x180117720 (DbgUiConvertStateChangeStructureEx.c)
 * Callees:
  ...
  *(_DWORD *)(a2 + 8) = a1[4];
  ...
  if ( !v5 )
  {
    ...
    *(_QWORD *)(a2 + 32) = *((_QWORD *)a1 + 5);
    InformationThread = ZwQueryInformationThread(*((_QWORD *)a1 + 3), 0LL, v22, 48LL, 0LL);
    v17 = *((_QWORD *)&v22[0] + 1);
  ...
  if ( !v6 )
  {
    ...
    *(_QWORD *)(a2 + 64) = *((_QWORD *)a1 + 10);
    v20 = ZwQueryInformationThread(*((_QWORD *)a1 + 4), 0LL, v22, 48LL, 0LL);
    v21 = *((_QWORD *)&v22[0] + 1);
    *(_QWORD *)(a2 + 72) = 0LL;
    if ( v20 < 0 )
      v21 = 0LL;
