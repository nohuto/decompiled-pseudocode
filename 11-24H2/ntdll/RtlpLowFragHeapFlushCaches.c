/*
 * XREFs of RtlpLowFragHeapFlushCaches @ 0x180095D9C
 * Callers:
 ...
 *     RtlpGetReservedBlockSize @ 0x180096670 (RtlpGetReservedBlockSize.c)
...
unsigned int *__fastcall RtlpLowFragHeapFlushCaches(__int64 a1, __int64 a2, __int64 a3, __int64 i)
{
  unsigned int v5; // ecx
  __int64 v6; // rdx
  ...
  do
  {
    ...
    {
      if ( v7 )
        v8 = *(_QWORD *)(a1 + 8 * v6 + 2224) + 192LL * v7 - 192;
      else
        v8 = *(_QWORD *)(a1 + 8 * v6 + 1192);
      if ( v8 && *(_DWORD *)(v8 + 164) == 1 )
      {
        v19 = RtlpLocalInfoAllocFromCache((volatile __int64 *)v8, v7, a3, i);
        v20 = v19;
        if ( v19 )
        {
          *(_DWORD *)(*(_QWORD *)v8 + 36LL) = 0;
          ...
          {
            RtlpLogHeapFailure(3, v21, v19, 0LL, 0LL, 0LL);
          }
          else
          {
            _m_prefetchw(v22);
...
LABEL_43:
              *(_BYTE *)(v20 + 15) = 0x80;
              ...
              if ( v33 == -1 )
              {
                RtlpInterlockedPushEntrySList(v34, v20 + 16);
              }
              else
              {
                ...
                if ( *v34 )
                {
                  v56 = (_QWORD *)RtlpInterlockedFlushSList(v34);
                  while ( v56 )
                  {
                    v57 = *((_DWORD *)v56 - 1);
                    ++v24;
...
LABEL_89:
                      v55 = v38 + 12;
LABEL_90:
                      RtlpInterlockedPushEntrySList(v54, v55);
                    }
...
LABEL_66:
                  ...
                  if ( (*((_BYTE *)v22 + 38) & 3) != 0 )
                  {
                    ...
                    v65 = 0;
                    v61[0] = v44 & 0xFFFFFFFFFFFFF000uLL;
                    ReservedBlockSize = RtlpGetReservedBlockSize(v22, v36, a3, i);
                    v46 = *(_QWORD *)(v43 + 24);
                    v60 = 16 * ReservedBlockSize * (unsigned __int64)*((unsigned __int16 *)v22 + 20);
                    HeapProtection = RtlpGetHeapProtection(v46, 1LL);
                    ZwProtectVirtualMemory(-1LL, v61, &v60, HeapProtection, &v65);
                  }
                  *((_DWORD *)v22[1] + 5) = 0;
                  RtlpFreeUserBlock(v43, (unsigned __int64)v22[1], a3);
                  ...
                  do
                  {
                    v48 = *((_QWORD *)v42 + 20);
                    LODWORD(v59) = v48 + a3;
                    HIDWORD(v59) = HIDWORD(v48) - 1;
                  }
                  while ( _InterlockedCompareExchange64((volatile signed __int64 *)v42 + 20, v59, v48) != v48 );
                  v22[1] = 0LL;
...
LABEL_73:
            ...
            {
              RtlpLogHeapFailure(3, *(_QWORD *)(v26 + 24), v19, 0LL, 0LL, 0LL);
            }
          }
        }
LABEL_41:
...
LABEL_10:
  ...
  {
    v11 = 0;
    result = (unsigned int *)RtlpInterlockedFlushSList(v10);
    v13 = v58;
    v14 = result;
    if ( result )
    {
      do
      {
        ...
        if ( v16 > 0xF0000 )
          v16 = 983040LL;
        v17 = v16 + *((unsigned __int16 *)v15 + 9);
        v13 += v17;
        ...
        if ( *(_BYTE *)v18 )
        {
          ...
          if ( (result[222] & 1) != 0 )
          {
            ...
            result = (unsigned int *)RtlpLogHeapSubSegmentFree(*(_QWORD *)(a1 + 24), v15, v17, 0LL);
          }
        }
      }
      while ( v14 );
