/*
 * XREFs of LdrpCheckKnownDllFullPath @ 0x180074BA0
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( (_WORD)v12 != (_WORD)v13 )
    {
      if ( (unsigned int)v12 >= 0x61 )
      {
        ...
        {
          if ( qword_1801CD038 && (unsigned __int16)v12 >= 0xC0u )
        ...
        if ( (unsigned int)v13 > 0x7A )
        {
          if ( qword_1801CD038 )
          {
            if ( (unsigned __int16)v13 >= 0xC0u )
              LOWORD(v13) = *(_WORD *)(qword_1801CD038
                                     + 2
                                     * ((v13 & 0xF)
                                      + *(unsigned __int16 *)(qword_1801CD038
                                                            + 2LL
