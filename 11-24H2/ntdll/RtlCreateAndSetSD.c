/*
 * XREFs of RtlCreateAndSetSD @ 0x1800CE250
 * Callers:
 ...
 *     RtlSetGroupSecurityDescriptor @ 0x1800CE650 (RtlSetGroupSecurityDescriptor.c)
 *     RtlSetSaclSecurityDescriptor @ 0x1800CE6A0 (RtlSetSaclSecurityDescriptor.c)
 */

__int64 __fastcall RtlCreateAndSetSD(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, unsigned __int64 *a5)
{
  int Acl; // ebx
...
LABEL_43:
  RtlFreeHeap(v31, 0, v17);
  if ( v8 )
LABEL_44:
    RtlFreeHeap(v31, 0, v8);
