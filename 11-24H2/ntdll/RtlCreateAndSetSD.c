/*
 * XREFs of RtlCreateAndSetSD @ 0x1800C5E10
 * Callers:
 ...
 *     RtlSetGroupSecurityDescriptor @ 0x1800C6210 (RtlSetGroupSecurityDescriptor.c)
 *     RtlSetSaclSecurityDescriptor @ 0x1800C6260 (RtlSetSaclSecurityDescriptor.c)
 */
