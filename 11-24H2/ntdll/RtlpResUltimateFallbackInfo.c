/*
 * XREFs of RtlpResUltimateFallbackInfo @ 0x18009582C
 * Callers:
...
__int64 __fastcall RtlpResUltimateFallbackInfo(PVOID DllHandle, __int64 a2, _QWORD *a3, _DWORD *a4)
{
  ...
  if ( (*(_BYTE *)v8 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v11 = 2147353476LL;
    LdrpTraceLoadMUIDll((unsigned __int16 *)v12, *(unsigned __int8 *)v11);
  }
  if ( !DllHandle || !a3 || !a4 )
    return 3221225485LL;
  *a4 = 0;
  *a3 = 0LL;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_BYTE *)v7 & 1) != 0 )
    {
      ...
      LdrpTraceLoadMUIDll((unsigned __int16 *)v13, *(unsigned __int8 *)v9);
    }
    return 3221225473LL;
  }
  return result;
