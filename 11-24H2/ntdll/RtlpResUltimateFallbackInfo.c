/*
 * XREFs of RtlpResUltimateFallbackInfo @ 0x18007D820
 * Callers:
...
__int64 __fastcall RtlpResUltimateFallbackInfo(__int64 a1, unsigned __int64 a2, _QWORD *a3, _DWORD *a4, int a5)
{
  __int64 v9; // rsi
  __int64 v10; // rcx
  __int64 v11; // rdi
  ...
  if ( (*(_BYTE *)v10 & 1) != 0 )
  {
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      ...
      v17 = 2147353476LL;
    LdrpTraceLoadMUIDll((unsigned __int16 *)v18, *(unsigned __int8 *)v17);
  }
  if ( !a1 || !a3 || !a4 )
    return 3221225485LL;
  v12 = a5;
  *a4 = 0;
  *a3 = 0LL;
  result = LdrResGetRCConfig(a1, a2, &v20, v12, 1);
  if ( (int)result >= 0 )
  {
    v14 = v20;
    ...
    if ( (*(_BYTE *)v9 & 1) != 0 )
    {
      ...
      LdrpTraceLoadMUIDll((unsigned __int16 *)v19, *(unsigned __int8 *)v11);
    }
    return v16;
  }
  return result;
