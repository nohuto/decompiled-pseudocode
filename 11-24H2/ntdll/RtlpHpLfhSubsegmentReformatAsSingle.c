/*
 * XREFs of RtlpHpLfhSubsegmentReformatAsSingle @ 0x1800DB0C4
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentReformatAsSingle(__int64 a1, unsigned __int8 *a2)
{
  ...
  __int64 (__fastcall *v8)(__int64, unsigned __int8 *, __int64, _QWORD); // rax
  __int64 v9; // r8
  __int64 v10; // rcx
  ...
  v11 = 0;
  v12 = 0;
  if ( !(unsigned int)RtlpHpLfhSubsegmentReformatCheck(a1, a2, &v11, &v12) )
    return 3221226614LL;
  if ( a2[39] == 1 )
    return 0LL;
  if ( !v11
    || ((v6 = a2[38],
         v7 = &a2[v11 << 12 << v6],
         v8 = (__int64 (__fastcall *)(__int64, unsigned __int8 *, __int64, _QWORD))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 24)),
         v9 = ((unsigned int)a2[39] - v11) << 12 << v6,
         v10 = *(_QWORD *)a1,
         (char *)v8 != (char *)RtlpHpSegLfhVsCommit)
