/*
 * XREFs of LdrpInitializeKernel32Functions @ 0x1800C6FD8
 * Callers:
...
LABEL_4:
  ...
  LdrGetProcedureAddressForCaller(DllHandle, (PANSI_STRING)&stru_180172CA0, 0, ProcedureAddress, 0, retaddr);
