/*
 * XREFs of RtlpCreateSplitBlock @ 0x18002FC50
 * Callers:
...
LABEL_113:
    *v57 = v59;
    *(_QWORD *)(v59 + 8) = v57;
    if ( (*(_BYTE *)(v13 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v13) )
    {
      if ( a5 )
      {
        v73 = *(_BYTE *)(v13 + 10);
        if ( (v73 & 4) != 0 )
        {
          ...
          v75 = RtlCompareMemoryUlong(v13 + 32, v74, 4277075694LL);
          if ( v75 != v74 )
          {
            if ( NtCurrentPeb()->Ldr )
      ...
      *(_BYTE *)(v9 + 15) = 0;
      if ( a5 )
      {
        *(_BYTE *)(v9 + 10) &= 0xF0u;
        ...
        v107 = (unsigned __int64 *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          Entry = RtlpFindEntry(a1, (unsigned __int16)v95);
        else
          Entry = *v107;
        if ( v107 != (unsigned __int64 *)Entry )
        {
          v111 = *(_DWORD *)(a1 + 124);
          do
          {
            ...
            {
              LOWORD(v112) = *(_WORD *)(Entry - 8);
            }
            if ( (unsigned __int16)v95 <= (unsigned __int64)(unsigned __int16)v112 )
              break;
            Entry = *(_QWORD *)Entry;
          }
          while ( v107 != (unsigned __int64 *)Entry );
        }
        v108 = *(__int64 **)(Entry + 8);
        v109 = (unsigned __int64 *)(v9 + 16);
        if ( *v108 == Entry )
        {
          *v109 = Entry;
          *(_QWORD *)(v9 + 24) = v108;
        ...
        {
          RtlpLogHeapFailure(13, 0LL, Entry, 0LL, *v108, 0LL);
        }
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v9 + 8);
        ...
        LODWORD(v103) = Entry - 1;
      }
LABEL_195:
      LOBYTE(Entry) = 1;
      RtlpHeapAddListEntry(a1, v102, Entry, v9 + 16, v103, *(unsigned __int16 *)(v9 + 8));
      goto LABEL_55;
    }
    LOBYTE(v92) = 1;
...
LABEL_150:
    ...
    if ( v121 - (unsigned __int16)v93 <= 0 )
    {
LABEL_155:
