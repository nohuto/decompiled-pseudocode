/*
 * XREFs of OpenGlobalizationUserSettingsKey_ForSingleUserModel @ 0x180080044
 * Callers:
...
__int64 __fastcall OpenGlobalizationUserSettingsKey_ForSingleUserModel(unsigned int a1, HANDLE *a2)
{
  ...
  if ( !dword_1801D232C )
  {
    ...
    if ( !v30 || v7 != -1073741789 && v7 != -2147483643 )
    {
      ...
      {
        v13 = v18[0];
        memmove(word_1801CE2F0, v20, v18[0]);
        if ( v13 + 2 <= 0xAA )
          word_1801CE2F0[v13 >> 1] = 0;
        dword_1801D232C = 1;
      }
      v5 = 0;
      *a2 = Handle;
    ...
    if ( v5 >= 0 )
    {
      if ( *(_DWORD *)(v8 + 4) == 1 )
      {
        ...
        if ( (unsigned __int16)v16 <= 0xAAu )
        {
          ...
          memmove(word_1801CE2F0, Src, (unsigned __int16)v16);
          if ( v12 + 2 <= 0xAA )
            word_1801CE2F0[v12 >> 1] = 0;
          dword_1801D232C = 1;
        }
        v9 = v15;
      }
