/*
 * XREFs of OpenGlobalizationUserSettingsKey_ForSingleUserModel @ 0x1800CB894
 * Callers:
  ...
  if ( !dword_1801D132C )
  {
    ...
    *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
    ...
    if ( !ResultLength || v7 != -1073741789 && v7 != -2147483643 )
    {
      ...
      {
        v13 = v18[0];
        memmove(word_1801CD2F0, v20, v18[0]);
        if ( v13 + 2 <= 0xAA )
          word_1801CD2F0[v13 >> 1] = 0;
        dword_1801D132C = 1;
      }
      v5 = 0;
      ...
      if ( v8[1] == 1 )
      {
        ...
        *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
        ...
        if ( (unsigned __int16)v16 <= 0xAAu )
        {
          ...
          memmove(word_1801CD2F0, Src, (unsigned __int16)v16);
          if ( v12 + 2 <= 0xAA )
            word_1801CD2F0[v12 >> 1] = 0;
          dword_1801D132C = 1;
        }
        v9 = v15;
      }
...
LABEL_14:
  ...
  *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
  ValueName.Buffer = word_1801CD2F0;
  v14 = 2 * wcslen(word_1801CD2F0);
  *(_QWORD *)&ObjectAttributes.Length = 48LL;
  *(_QWORD *)&ObjectAttributes.Attributes = 576LL;
  ObjectAttributes.RootDirectory = 0LL;
  if ( v14 >= 0xFFFE )
