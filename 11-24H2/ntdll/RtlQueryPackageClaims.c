/*
 * XREFs of RtlQueryPackageClaims @ 0x180087120
 * Callers:
 *     RtlQueryPackageIdentity @ 0x180087050 (RtlQueryPackageIdentity.c)
 *     RtlQueryPackageIdentityEx @ 0x1800870B0 (RtlQueryPackageIdentityEx.c)
 ...
 *     ZwQuerySecurityAttributesToken @ 0x180164960 (ZwQuerySecurityAttributesToken.c)
        ...
        _QWORD *a8)
{
  ...
  if ( a7 || a8 )
    v13 = 2;
  result = ZwQuerySecurityAttributesToken(a1, &unk_180173A08, v13, v26, 816, &v20);
  if ( (int)result < 0 )
  {
    if ( v13 == 1 )
      return result;
    if ( (_DWORD)result != -1073741275 )
      return result;
    result = ZwQuerySecurityAttributesToken(a1, &unk_180173A08, 1LL, v26, 816, &v20);
    if ( (int)result < 0 )
      return result;
    v12 = 0;
  }
  ...
  {
    *a8 |= (2LL * v12) | 1;
    if ( (unsigned int)ZwQuerySecurityAttributesToken(a1, &unk_180173A38, 1LL, 0LL, 0, &v20) == -1073741789 )
      *a8 |= 4uLL;
    v16 = ZwQuerySecurityAttributesToken(a1, &unk_180173A28, 1LL, 0LL, 0, &v20);
    v15 = v28;
    if ( v16 == -1073741789 )
      *a8 |= 8uLL;
  }
