/*
 * XREFs of LdrpInitializeExecutionOptions @ 0x1800887A8
 * Callers:
 ...
 *     LdrpPayloadRestrictionMitigationsEnabled @ 0x18008967C (LdrpPayloadRestrictionMitigationsEnabled.c)
        ...
        __int64 a6)
{
  ...
  *v46 = v44;
  ...
  for ( i = 0LL; i != 6; i += 2LL )
  {
    ...
    v24 = *(bool **)((char *)&off_180173A50 + i * 8);
    *v24 = v37 != 0;
  }
  v37 = 0;
