/*
 * XREFs of RtlCompressBufferDeflateInternal @ 0x18014CDC4
 * Callers:
 *     RtlCompressBufferDeflateRaw @ 0x18014CED0 (RtlCompressBufferDeflateRaw.c)
 *     RtlCompressBufferDeflateZlib @ 0x18014CF20 (RtlCompressBufferDeflateZlib.c)
 * Callees:
