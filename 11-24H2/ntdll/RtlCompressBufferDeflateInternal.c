/*
 * XREFs of RtlCompressBufferDeflateInternal @ 0x18014B18C
 * Callers:
 *     RtlCompressBufferDeflateRaw @ 0x18014B290 (RtlCompressBufferDeflateRaw.c)
 *     RtlCompressBufferDeflateZlib @ 0x18014B2E0 (RtlCompressBufferDeflateZlib.c)
 * Callees:
