/*
 * XREFs of LdrResFallbackLangList @ 0x18007BF40
 * Callers:
...
__int64 __fastcall LdrResFallbackLangList(__int64 a1, int a2, unsigned __int16 a3, int a4, unsigned __int16 *a5)
{
  ...
  {
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      LdrpTraceLoadMUIDll((unsigned __int16 *)v27, *((unsigned __int8 *)NtCurrentPeb()->SharedData + 554));
    else
      LdrpTraceLoadMUIDll((unsigned __int16 *)v27, MEMORY[0x7FFE0384]);
  }
  v10 = a5;
  if ( !a5 )
  {
...
LABEL_25:
        ...
        if ( (*(_BYTE *)v7 & 1) != 0 )
        {
          ...
          LdrpTraceLoadMUIDll((unsigned __int16 *)v28, *(unsigned __int8 *)v9);
        }
        return (unsigned int)v20;
      case 3:
        if ( !a1 || (int)RtlpResUltimateFallbackInfo(a1, a2, (unsigned int)&String, (unsigned int)&v23, a4) < 0 )
          goto LABEL_33;
        *(_QWORD *)&v26 = 0LL;
        *((_QWORD *)&v26 + 1) = String;
        if ( String )
