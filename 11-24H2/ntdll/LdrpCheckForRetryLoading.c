/*
 * XREFs of LdrpCheckForRetryLoading @ 0x18008EC2C
 * Callers:
 ...
 *     LdrpCompareModuleName @ 0x18008F2A4 (LdrpCompareModuleName.c)
 */
...
LABEL_32:
    *(_DWORD *)(a1 + 32) |= 0x100000u;
    v14 = (_QWORD *)qword_1801D1678;
    v15 = (_QWORD *)(a1 + 64);
    v2 = 1;
    if ( *(__int64 **)qword_1801D1678 != &LdrpRetryQueue )
      __fastfail(3u);
    *v15 = &LdrpRetryQueue;
    *(_QWORD *)(a1 + 72) = v14;
    *v14 = v15;
    qword_1801D1678 = a1 + 64;
    goto LABEL_35;
  }
  return v2;
}
