/*
 * XREFs of RtlpHpEnvAllocVA @ 0x180092390
 * Callers:
 ...
 *     RtlpHpVaMgrRangeCommit @ 0x18011D148 (RtlpHpVaMgrRangeCommit.c)
 * Callees:
 *     NtAllocateVirtualMemoryEx @ 0x180162B80 (NtAllocateVirtualMemoryEx.c)
