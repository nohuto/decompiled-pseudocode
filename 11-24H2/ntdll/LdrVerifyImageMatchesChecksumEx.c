/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x18010B9E0
 * Callers:
 ...
 *     NtMakeTemporaryObject @ 0x180162360 (NtMakeTemporaryObject.c)
...
NTSTATUS __cdecl LdrVerifyImageMatchesChecksumEx(HANDLE ImageFileHandle, PLDR_VERIFY_IMAGE_INFO VerifyInfo)
{
  ...
  if ( (*(_BYTE *)p_Flags & 2) == 0 )
    p_SectionInfo = (LDR_SECTION_INFO *)&unk_180185680;
  v22 = p_SectionInfo;
...
LABEL_42:
    ...
    if ( v9 < 0 || p_SectionInfo == (LDR_SECTION_INFO *)&unk_180185680 )
    {
