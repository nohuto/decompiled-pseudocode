/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x180110720
 * Callers:
 ...
 *     NtMakeTemporaryObject @ 0x180163FA0 (NtMakeTemporaryObject.c)
...
__int64 __fastcall LdrVerifyImageMatchesChecksumEx(__int64 a1, unsigned __int64 a2)
{
  ...
  v7 = a1 & 1;
  v26 = (char *)(v5 + 4);
  result = NtCreateSection(&Handle, (unsigned int)v5[2], *((_QWORD *)v5 + 2), 0LL);
  if ( (int)result >= 0 )
  {
    v17 = 0LL;
    v24 = 0LL;
...
LABEL_42:
    ...
    if ( v9 < 0 || v5 == (_DWORD *)&unk_180186770 )
    {
