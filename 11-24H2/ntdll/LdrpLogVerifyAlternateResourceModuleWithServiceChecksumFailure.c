/*
 * XREFs of LdrpLogVerifyAlternateResourceModuleWithServiceChecksumFailure @ 0x180078828
 * Callers:
        ...
        __int64 a3)
{
  ...
  _BYTE v12[32]; // [rsp+48h] [rbp-49h] BYREF
  ...
  v6 = RtlRunOnceExecuteOnce(&unk_1801D25C0, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( v6 >= 0 && (unsigned int)dword_1801CC980 > 5 )
  {
    if ( (qword_1801CC990 & 0x200000000000LL) == 0
      || (LOBYTE(v6) = 1, (qword_1801CC998 & 0x200000000000LL) != qword_1801CC998) )
    {
      LOBYTE(v6) = 0;
    }
    if ( (_BYTE)v6 )
