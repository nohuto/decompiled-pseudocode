/*
 * XREFs of RtlpxLookupFunctionTable @ 0x1800430E0
 * Callers:
 ...
 *     RtlLookupFunctionTable @ 0x180041A80 (RtlLookupFunctionTable.c)
 ...
 *     RtlpImageDirectoryEntryToData32 @ 0x1800D6FE0 (RtlpImageDirectoryEntryToData32.c)
...
LABEL_55:
  ...
  if ( LdrpInvertedFunctionTables[0] != 1 )
  {
    ...
    {
      v11 = (v9 + v10) >> 1;
      v12 = (char *)&xmmword_1801E6440 + 24 * v11;
      v13 = *((_QWORD *)v12 + 1);
