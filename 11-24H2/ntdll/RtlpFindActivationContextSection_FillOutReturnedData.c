/*
 * XREFs of RtlpFindActivationContextSection_FillOutReturnedData @ 0x18003E6EC
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)(a2 + 72) = &v14[*(unsigned int *)&v14[24 * *(unsigned int *)(a2 + 64)
  ...
  result = RtlpLocateActivationContextSection((_DWORD)v14, 0, 1, (unsigned int)&v21, (__int64)&v22);
  if ( (int)result >= 0 )
  {
    v16 = v21;
    v17 = v22;
