/*
 * XREFs of RtlpValidateHeapSegment @ 0x180041A64
 * Callers:
        ...
        __int64 a8)
{
  ...
  unsigned int v51; // [rsp+80h] [rbp+18h]
...
LABEL_23:
        ...
        if ( (v16 & 8) == 0 )
        {
          v49 = RtlCompareMemoryUlong(v14 + 32, v25, 4277075694LL);
          if ( v49 != v25 )
          {
            if ( NtCurrentPeb()->Ldr )
              DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
...
LABEL_54:
        ...
        *v26 = v28;
        *(_QWORD *)(v28 + 8) = v26;
        if ( (*(_BYTE *)(v14 + 10) & 8) == 0 || (v37 = RtlpCommitBlock(a1, v14), v8 = 0LL, v37) )
        {
          ...
          *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v14 + 8);
          ...
          if ( v45 )
          {
            ...
            v48 = *(unsigned __int16 *)(v14 + 8);
LABEL_96:
            LOBYTE(v46) = 1;
            RtlpHeapAddListEntry(a1, (_DWORD)v45, v46, v14 + 16, v48, *(unsigned __int16 *)(v14 + 8));
            v8 = 0LL;
          }
          v11 = v51;
          v10 = v50;
