/*
 * XREFs of RtlStdInitializeStackDatabase @ 0x1800E0EC0
 * Callers:
...
LABEL_16:
    ...
    *((_QWORD *)BaseAddress[0] + 23) = v12;
    ...
    {
      memset_thunk_772440563353939046((char *)BaseAddress[0] + 728, 0, 16LL * *((unsigned int *)BaseAddress[0] + 180));
    }
    else
    {
    ...
    v14 = 208LL;
    v15 = 32LL;
    *((_QWORD *)BaseAddress[0] + 20) = (char *)BaseAddress[0] + v13;
    *((_QWORD *)BaseAddress[0] + 15) = *((_QWORD *)BaseAddress[0] + 20);
    do
    {
      RtlInitializeSListHead((PSLIST_HEADER)((char *)BaseAddress[0] + v14));
      v14 += 16LL;
      --v15;
    }
    while ( v15 );
