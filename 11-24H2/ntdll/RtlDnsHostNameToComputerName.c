/*
 * XREFs of RtlDnsHostNameToComputerName @ 0x1800CF200
 * Callers:
 *     <none>
 * Callees:
 ...
 *     UpcaseUnicodeToSingleByteNHelper @ 0x1800CF920 (UpcaseUnicodeToSingleByteNHelper.c)
    ...
    if ( CodePageTable.DBCSCodePage )
    {
      ...
      if ( v9 )
      {
        ...
        do
        {
          ...
          v26 = NLS_UPCASE(qword_1801CC038, v25);
          v10 = 2LL;
