/*
 * XREFs of RtlFindClearRuns @ 0x1800DFC60
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800DFC20 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  while ( v12 < v10 )
  {
    ...
    if ( v12 == v10 - 1 && v9 )
      v16 |= byte_18017EB08[SizeOfBitMap & 7];
    if ( !v16 )
    {
      LODWORD(v13) = v13 + 8;
      goto LABEL_6;
...
LABEL_8:
    ...
    v14 = v15 - v13 + 8;
    for ( j = *((_BYTE *)&unk_18017EB10 - v13) | byte_180191058[v17] | v16; ; j |= k )
    {
      v20 = v11;
      if ( j == 0xFF )
        break;
      ...
      v22 = *v21;
      v23 = 0;
      for ( k = byte_180191058[v22]; (k & j) != 0; ++v23 )
        k *= 2;
      ++v11;
      if ( v20 >= v5 )
        v11 = v20;
