/*
 * XREFs of RtlFindClearRuns @ 0x1800E47B0
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800E4770 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
...
LABEL_8:
    ...
    v14 = v15 - v13 + 8;
    for ( j = *((_BYTE *)&unk_180180330 - v13) | byte_180192060[v17] | v16; ; j |= k )
    {
      v20 = v11;
      if ( j == 0xFF )
        break;
      ...
      v22 = *v21;
      v23 = 0;
      for ( k = byte_180192060[v22]; (k & j) != 0; ++v23 )
        k *= 2;
      ++v11;
      if ( v20 >= v5 )
        v11 = v20;
