/*
 * XREFs of RtlpCreateHashTable @ 0x1800E6534
 * Callers:
 *     RtlCreateHashTable @ 0x18010D0F0 (RtlCreateHashTable.c)
 *     RtlCreateHashTableEx @ 0x1801438C0 (RtlCreateHashTableEx.c)
 * Callees:
 ...
 *     RtlpInitializeSecondLevelDir @ 0x1800E677C (RtlpInitializeSecondLevelDir.c)
