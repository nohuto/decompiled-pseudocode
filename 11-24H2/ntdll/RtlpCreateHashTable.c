/*
 * XREFs of RtlpCreateHashTable @ 0x1800E19E4
 * Callers:
 *     RtlCreateHashTable @ 0x1801080B0 (RtlCreateHashTable.c)
 *     RtlCreateHashTableEx @ 0x180141C70 (RtlCreateHashTableEx.c)
 * Callees:
 ...
 *     RtlpInitializeSecondLevelDir @ 0x1800E1C2C (RtlpInitializeSecondLevelDir.c)
