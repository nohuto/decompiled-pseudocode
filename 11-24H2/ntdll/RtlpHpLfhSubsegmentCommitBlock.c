/*
 * XREFs of RtlpHpLfhSubsegmentCommitBlock @ 0x180056390
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentCommitBlock(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  char v3; // cl
  int v5; // r15d
  __int64 v6; // r9
  ...
  v48 = 0;
  v5 = 0;
  v6 = (unsigned int)a3 >> 12 >> v3;
  v7 = *(unsigned __int8 *)(a2 + 24);
  v44 = (unsigned __int16)qword_1801CDEC8 ^ *(unsigned __int16 *)(a2 + 40) ^ (unsigned __int16)(a2 >> 12);
  v8 = 2 * v6;
  v9 = (volatile signed __int32 **)((((unsigned int)a3 + v44 - 1) >> 12 >> v3) - (unsigned int)v6 + 1);
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v5 )
        break;
      v5 = 1;
      RtlAcquireSRWLockExclusive((volatile signed __int32 *)(a2 + 56), v9, a3);
    }
    if ( v14 )
    {
      ++v12;
