/*
 * XREFs of _woutput_s @ 0x18012FC48
 * Callers:
 ...
 *     write_char_2 @ 0x180130594 (write_char_2.c)
          ...
          if ( v10 != 83 )
          {
            if ( v10 != 88 )
            {
              if ( v10 == 90 )
              {
                v20 = *(char **)v7;
                v67 = v7 + 2;
                if ( v20 && (v6 = (char *)*((_QWORD *)v20 + 1)) != 0LL )
                {
                  v21 = *(unsigned __int16 *)v20;
                  if ( *((_WORD *)v20 + 1) < (unsigned __int16)v21 )
                    goto LABEL_211;
                  LODWORD(v12) = *(unsigned __int16 *)v20;
                  if ( (v4 & 0x800) != 0 )
                  {
...
LABEL_142:
                      ...
                      else
                      {
                        ...
                        else if ( (int)v12 > 0 )
                        {
                          do
                          {
                            write_char_2(*(unsigned __int16 *)v47, v35, &v59);
                            v11 = v59;
                            v47 = (char *)(v49 + 2);
                          }
                          while ( v59 != -1 && v48 > 0 );
