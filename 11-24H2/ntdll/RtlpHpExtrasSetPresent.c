/*
 * XREFs of RtlpHpExtrasSetPresent @ 0x18009EA20
 * Callers:
...
void __fastcall RtlpHpExtrasSetPresent(_RTL_SRWLOCK *a1, __int64 a2)
{
  ...
  {
    v13 = RtlCSparseBitmapBitmaskRead((__int64)&BaseAddress, 2 * ((unsigned __int64)(a2 - qword_1801CD918) >> 20));
  ...
  else
  {
    ...
    if ( v11 == 8 )
    {
      *(_WORD *)(((unsigned __int16)qword_1801CCEC8 ^ *(unsigned __int16 *)(v12 + 40) ^ (unsigned __int64)(unsigned __int16)(v12 >> 12))
               + a2
               - 2) |= 0x4000u;
    }
    else
