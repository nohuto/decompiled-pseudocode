/*
 * XREFs of RtlpHpVsSubsegmentCreate @ 0x18004FC80
 * Callers:
...
unsigned __int64 __fastcall RtlpHpVsSubsegmentCreate(__int64 a1, int a2)
{
  ...
  __int64 v11; // r11
  __int64 (__fastcall *v12)(__int64, unsigned __int64, _QWORD, _QWORD); // rax
  __int64 v13; // r15
  __int64 v14; // r8
  ...
  if ( (v32 & 1) != 0 )
    v10 = v2;
  v11 = *(_QWORD *)(a1 + 8) ^ a1;
  v12 = (__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, _QWORD))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 32));
  ...
  {
    v20 = v12(*(_QWORD *)(a1 + 8) ^ a1, v9, v10, 0LL);
  }
  if ( v20 < 0 )
  {
    v29 = *(_QWORD *)(a1 + 8) ^ a1;
    ...
    if ( v30 == RtlpHpSegLfhVsFree )
    {
      ...
      {
        RtlpLogHeapFailure(9, *(_QWORD *)((*(_QWORD *)(a1 + 8) ^ a1) + 0x38), v9, 0LL, 0LL, 0LL);
      }
      else
      {
