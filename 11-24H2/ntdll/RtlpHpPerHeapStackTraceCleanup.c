/*
 * XREFs of RtlpHpPerHeapStackTraceCleanup @ 0x180149B24
 * Callers:
...
LABEL_9:
      ...
      v9 = 0LL;
LABEL_16:
      RtlStackDbStackRemove((__int64)&qword_1801CD8C0, *(_QWORD *)(v9 + 16));
...
LABEL_17:
    ...
    {
      v14[0] = RtlpHpEnvHandle;
      LODWORD(v5) = RtlpHpMetadataFree((__int64)v11, v14);
      if ( a3 )
        a1->Value = 0LL;
    }
  }
