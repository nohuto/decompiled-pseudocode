/*
 * XREFs of EtwpTrackBinaryForSession @ 0x18001C2A0
 * Callers:
...
LABEL_13:
  ...
  v14 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, (unsigned int)(v3 + 46));
  if ( !v14 )
    return 14;
  *(_DWORD *)(v14 + 40) = v3 + 2;
  ...
  *(_DWORD *)(v14 + 16) = 0;
  v16 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 0x20uLL);
  if ( !v16 )
    return 14;
