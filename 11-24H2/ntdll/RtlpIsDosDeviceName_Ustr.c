/*
 * XREFs of RtlpIsDosDeviceName_Ustr @ 0x180072C30
 * Callers:
      ...
      while ( v13 < v35 )
      {
        ...
        if ( (_WORD)v37 != (_WORD)v38 )
        {
          if ( (unsigned int)v37 >= 0x61 )
          {
            ...
            {
              if ( qword_1801CC038 && (unsigned __int16)v37 >= 0xC0u )
                LOWORD(v37) = *(_WORD *)(qword_1801CC038
                                       + 2
                                       * ((v37 & 0xF)
                                        + *(unsigned __int16 *)(qword_1801CC038
                                                              + 2LL
                                                              * (((unsigned __int8)v37 >> 4)
                                                               + (unsigned int)*(unsigned __int16 *)(qword_1801CC038 + 2 * (v37 >> 8))))))
                            + v37;
            }
            else
            {
            ...
            if ( (unsigned int)v38 > 0x7A )
            {
              if ( qword_1801CC038 )
              {
                if ( (unsigned __int16)v38 >= 0xC0u )
                  LOWORD(v38) = *(_WORD *)(qword_1801CC038
                                         + 2
                                         * ((v38 & 0xF)
                                          + *(unsigned __int16 *)(qword_1801CC038
                                                                + 2LL
                                                                * (((unsigned __int8)v38 >> 4)
                                                                 + (unsigned int)*(unsigned __int16 *)(qword_1801CC038 + 2 * (v38 >> 8))))))
                              + v38;
              }
            }
            else
