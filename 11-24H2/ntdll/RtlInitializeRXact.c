/*
 * XREFs of RtlInitializeRXact @ 0x180106310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlInitializeRXact(__int64 a1, char a2, unsigned __int64 *a3)
{
  ...
  *(_QWORD *)(Heap + 24) = 0LL;
  ...
  v22 = 24;
  v36 = 0LL;
  v11 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, 0x18uLL);
  v12 = v11;
  if ( !v11 )
  {
    v15 = -1073741670;
  ...
  v5 = *v14;
  if ( v15 >= 0 )
    memmove(&v37, (const void *)(v12 + 12), v5);
LABEL_11:
...
LABEL_13:
  ...
  {
    v17 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v20);
    if ( v17 )
    {
