/*
 * XREFs of RtlpMuiRegLoadPreferredUILanguages @ 0x1800C8B80
 * Callers:
        ...
        __int64 *a6)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v20 >= 0 )
  {
    v27 = Handle;
LABEL_153:
    v20 = RtlpLoadPolicyLanguageSpec(v27, v7, &v81, (__int16 *)&ResultLength);
    if ( !v20 )
    {
      LOBYTE(v59) = 1;
...
LABEL_129:
  ...
  if ( v6 == 1 )
  {
    ...
    *(_QWORD *)&ValueName.Length = 0LL;
    ...
    v20 = NtOpenKey(&v69, 0x20019u, p_ObjectAttributes);
    if ( v20 >= 0 )
    {
      v20 = RtlpLoadPolicyLanguageSpec(v69, v7, &v81, (__int16 *)&ResultLength);
      if ( !v20 )
      {
        if ( v10 )
        {
...
LABEL_84:
    ...
    *(_QWORD *)&v71.Attributes = 64LL;
    ...
    v71.ObjectName = &v62;
    *(_OWORD *)&v71.SecurityDescriptor = 0LL;
    v20 = NtOpenKey(&v63, 0x20019u, &v71);
    if ( v20 < 0 )
    {
      *v11 = 1;
      goto LABEL_40;
...
LABEL_78:
    ...
    v22 = 0;
    v20 = RtlpMuiRegAddMultiSzToLangFallbackList(a1, v9, v8 >> 1, 8, (unsigned int)(v6 != 1) + 2, 1u, &v61);
  }
  if ( v20 )
    goto LABEL_39;
  v10 = v61;
