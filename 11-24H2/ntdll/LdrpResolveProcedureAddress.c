/*
 * XREFs of LdrpResolveProcedureAddress @ 0x18006DB10
 * Callers:
...
LABEL_95:
    ...
    v31 = LdrpLoadForwardedDll(&SourceString, (int)v64, (char *)v61, (char *)BaseAddress, 2, (__int64 *)&BaseAddress);
    if ( v31 < 0 )
      goto LABEL_38;
      ...
      && _InterlockedExchangeAdd((volatile signed __int32 *)BaseAddress + 69, 0xFFFFFFFF) == 1 )
    {
      ...
      *v49 = v48;
      ...
      if ( *((_WORD *)v46 + 55) )
        LdrpReleaseTlsEntry(v46, 0LL);
      LdrpUnmapModule((__int64)v46);
  ...
  if ( (a5 & 1) != 0 && v31 >= 0 )
  {
    ...
    else
    {
      ...
      if ( LdrSystemDllInitBlock.CfgBitMap && (LdrSystemDllInitBlock.Flags & 1) == 0 )
      {
        v63 = 0LL;
        v62 = 0LL;
        if ( (unsigned __int64)v35 < *((_QWORD *)&xmmword_1801E6440 + 1)
          || (unsigned __int64)v35 >= *((_QWORD *)&xmmword_1801E6440 + 1)
                                    + (unsigned __int64)(unsigned int)qword_1801E6450 )
        {
          RtlpxLookupFunctionTable(v35, (char **)&v62);
        }
        else
        {
          v62 = xmmword_1801E6440;
        }
        if ( *((void **)&v62 + 1) != v35 )
          __fastfail(0x18u);
      }
