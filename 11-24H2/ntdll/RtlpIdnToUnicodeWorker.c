/*
 * XREFs of RtlpIdnToUnicodeWorker @ 0x1800BB490
 * Callers:
...
__int64 __fastcall RtlpIdnToUnicodeWorker(int a1, wchar_t *a2, int a3, void *a4, int *a5, _WORD *Src, __int64 a7)
{
  __int64 v7; // r12
  char v8; // bp
  wchar_t v9; // r13
  ...
  __int64 Heap; // [rsp+40h] [rbp-48h] BYREF
  ...
  LOBYTE(v27) = (v8 & 2) != 0;
  LOBYTE(v26) = (v8 & 4) != 0;
  result = punycode_decode(a2, v26, v27, (__int64)&a7, (__int64)&Heap);
  if ( (int)result < 0 )
    return result;
  if ( !v9 )
    return 3221227286LL;
