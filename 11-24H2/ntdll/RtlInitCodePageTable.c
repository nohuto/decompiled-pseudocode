/*
 * XREFs of RtlInitCodePageTable @ 0x1800AC760
 * Callers:
 *     RtlpInitCodePageTables @ 0x1800AC5F8 (RtlpInitCodePageTables.c)
 * Callees:
 *     <none>
 */
...
void __fastcall RtlInitCodePageTable(unsigned __int16 *a1, __int64 a2)
{
  ...
  else
  {
    ...
    *(_OWORD *)(a2 + 16) = xmmword_1801CD060;
    *(_OWORD *)(a2 + 32) = xmmword_1801CD070;
    *(_OWORD *)(a2 + 48) = unk_1801CD080;
  }
}
