/*
 * XREFs of LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry @ 0x18010FFD4
 * Callers:
  ...
  if ( v2->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_1801CB9B8 > 4 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        v9 = a2;
        v19 = 4;
        LOBYTE(v2) = tlgWriteTransfer_EtwEventWriteTransfer(v5, (unsigned __int8 *)dword_1801A1C15, v6, v7, 5u, &v11);
      }
    }
  }
  return (char)v2;
