/*
 * XREFs of RtlpChangeQueryDebugBufferTarget @ 0x180045670
 * Callers:
...
__int64 __fastcall RtlpChangeQueryDebugBufferTarget(_QWORD *a1, unsigned __int64 a2, int a3, HANDLE *a4)
{
  ...
  else
  {
    ...
    if ( Handle )
    {
      v17 = ZwMapViewOfSection(*a1, Handle, a1 + 2, 0LL, 0LL, &v21, &v20, 2, 0, 4, (_DWORD)Handle);
      if ( v17 == -1073741800 )
      {
        v18 = Handle;
        *v11 = 0LL;
        v17 = ZwMapViewOfSection(*a1, v18, a1 + 2, 0LL, 0LL, &v21, &v20, 2, 0, 4, (_DWORD)Handle);
      }
      if ( v17 < 0 )
      {
        NtClose(Handle);
