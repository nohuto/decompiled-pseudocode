/*
 * XREFs of RtlpFcUpdateUsageSubscriptions @ 0x18010F440
 * Callers:
 *     RtlSubscribeForFeatureUsageNotification @ 0x180145800 (RtlSubscribeForFeatureUsageNotification.c)
 *     RtlUnsubscribeFromFeatureUsageNotifications @ 0x180145810 (RtlUnsubscribeFromFeatureUsageNotifications.c)
 * Callees:
