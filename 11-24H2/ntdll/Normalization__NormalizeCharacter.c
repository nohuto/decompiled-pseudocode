/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1800BD13C
 * Callers:
 *     Normalization__Normalize @ 0x1800BCDC0 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x1800BDA94 (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x1800BD9C8 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x1800BDA20 (NormBuffer__Append.c)
 *     Normalization__AppendDecomposedChar @ 0x1800BDA94 (Normalization__AppendDecomposedChar.c)
 *     NormBuffer__GetLastChar @ 0x1800BE14C (NormBuffer__GetLastChar.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1800BE564 (NormBuffer__RewindOutputCharacter.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x1800BE5F4 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1800BE674 (NormBuffer__ReplaceLastStartBasePair.c)
 ...
 *     ComposeHangulLV @ 0x18011ED2C (ComposeHangulLV.c)
 */
