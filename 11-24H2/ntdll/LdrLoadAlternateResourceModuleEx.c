/*
 * XREFs of LdrLoadAlternateResourceModuleEx @ 0x18005FF20
 * Callers:
...
__int64 __fastcall LdrLoadAlternateResourceModuleEx(__int64 a1, unsigned __int16 a2, __int64 *a3, _QWORD *a4, int a5)
{
  ...
  volatile signed __int32 *v98; // [rsp+90h] [rbp-A98h] BYREF
  void *v99; // [rsp+98h] [rbp-A90h] BYREF
  unsigned int v100; // [rsp+A0h] [rbp-A88h] BYREF
...
LABEL_13:
  String = 0LL;
  Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 0x2BEuLL);
  v97 = Heap;
  if ( !Heap )
  {
LABEL_22:
  ...
  if ( v15 >= 0 )
  {
    ...
    Size = v95 + 2;
    v21 = (wchar_t *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, v95 + 2);
    v108 = v21;
    if ( v21 )
    {
...
LABEL_190:
  if ( v97 )
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v97);
  v89 = v15;
  if ( v15 < 0 )
    goto LABEL_106;
  v25 = v108;
...
LABEL_33:
  ...
  *((_QWORD *)&v114 + 1) = v126;
  ...
  {
    v30 = (char *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 2LL * v9 + 10);
    v113 = v30;
    if ( !v30 )
    {
      v15 = -1073741801;
...
LABEL_52:
  ...
  if ( v10 )
    RtlDeactivateActivationContextUnsafeFast((__int64)v118);
  if ( v42 < 0 )
  {
    v43 = 0;
  }
...
LABEL_68:
  ...
  Src = &v127;
  WORD1(v104) = 170;
  if ( (int)RtlLcidToLocaleName(v7, &v104, 2LL) < 0 )
  {
    v15 = -1073741811;
    goto LABEL_105;
  }
...
LABEL_80:
  ...
  {
    v80 = (wchar_t *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, v100);
    v58 = v80;
    v96 = v80;
    if ( v80 )
...
LABEL_88:
      ...
      if ( v15 >= 0 )
      {
        ...
        if ( (unsigned __int8)LdrpVerifyAlternateResourceModuleEx(a1, v93 | 1, v111, Src, a5, 2) )
        {
          v106 = String;
          v99 = v92;
          v98 = (volatile signed __int32 *)v95;
        }
        else
        {
...
LABEL_107:
  ...
  if ( !v98 )
    v64 = -1LL;
  v98 = (volatile signed __int32 *)v64;
  ...
  if ( v98 == (volatile signed __int32 *)-1LL )
  {
    *a3 = 0LL;
  }
  else
  ...
  if ( v108 )
  {
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)v108);
    v15 = v89;
  }
  if ( v109 )
  {
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)v109);
    v15 = v89;
  }
  if ( v113 )
  {
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)v113);
    v15 = v89;
  }
  if ( v58 && v128 != (_BYTE *)v58 )
  {
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)v58);
    return v89;
  }
