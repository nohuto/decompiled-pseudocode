/*
 * XREFs of RtlCapabilityCheck @ 0x18001A270
 * Callers:
...
LABEL_28:
  ...
  if ( !v6 )
  {
    ...
    if ( NtCurrentPeb()->ProcessHeap )
    {
      ...
      {
        if ( v13 != 259
          || (TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation(&dword_1801CB638),
...
LABEL_34:
          ...
          {
            if ( (unsigned int)dword_1801CB638 > 5
              && (qword_1801CB648 & 0x200000000000LL) != 0
              && (qword_1801CB650 & 0x200000000000LL) == qword_1801CB650 )
            {
              ...
              *(_DWORD *)&EventDescriptor.Level = 5;
              UserData.Ptr = (unsigned __int64)off_1801CB640;
              v37 = 1LL;
              v39 = 1LL;
              ...
              *(_DWORD *)&EventDescriptor.Id = 184549376;
              UserData.Size = *(unsigned __int16 *)off_1801CB640;
              v31 = &unk_1801A142C;
              UserData.Reserved = 2;
              v32 = 105;
              v33 = 1;
              v19 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
              EtwEventWriteTransfer(RegHandle, &EventDescriptor, 0LL, 0LL, 7u, &UserData);
            }
      ...
      RtlReportCriticalFailure((unsigned int)v13, &HasCapabilitya[1], 1LL);
      goto LABEL_34;
    }
  }
  return v9;
