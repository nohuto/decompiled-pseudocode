/*
 * XREFs of RtlNumberOfSetBits @ 0x1800ED840
 * Callers:
 *     TpSetPoolThreadCpuSets @ 0x180086140 (TpSetPoolThreadCpuSets.c)
 *     RtlNumberOfClearBits @ 0x1800ED810 (RtlNumberOfClearBits.c)
 * Callees:
 *     <none>
 */
...
ULONG __cdecl RtlNumberOfSetBits(PRTL_BITMAP BitMapHeader)
{
  ...
  for ( i = 0; v8; --v8 )
  {
    ...
    if ( i == v7 - 1 && v4 )
      v13 &= byte_180191058[SizeOfBitMap & 7];
    ++i;
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( i == v18 && (SizeOfBitMap & 7) != 0 )
        v19 &= byte_180191058[SizeOfBitMap & 7];
      ++i;
