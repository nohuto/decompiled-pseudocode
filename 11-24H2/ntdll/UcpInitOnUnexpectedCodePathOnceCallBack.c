/*
 * XREFs of UcpInitOnUnexpectedCodePathOnceCallBack @ 0x180155D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UcpInitOnUnexpectedCodePathOnceCallBack(PRTL_RUN_ONCE a1, PVOID a2, PVOID *a3)
{
  ...
  qword_1801D27A8 = (__int64)&UcpTriggeredList;
  UcpTriggeredList = (__int64)&UcpTriggeredList;
  TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation(&dword_1801CB6B8);
  result = 1LL;
