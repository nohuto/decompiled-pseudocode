/*
 * XREFs of RtlFlsSetValue @ 0x1800B9320
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( v16 )
  {
    ...
    *(_QWORD *)(v16 + 72) = 0LL;
    v2->FlsData = (void *)v16;
    RtlAcquireSRWLockExclusive((volatile signed __int32 *)&RtlpFlsContext, v17, v18);
    v19 = (__int64 *)qword_1801CDE80;
    if ( *(__int64 **)qword_1801CDE80 != &qword_1801CDE78 )
      __fastfail(3u);
    *(_QWORD *)FlsData = &qword_1801CDE78;
    *(_QWORD *)(FlsData + 8) = v19;
    *v19 = FlsData;
    qword_1801CDE80 = FlsData;
