/*
 * XREFs of RtlInsertElementGenericTableAvl @ 0x180071C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall RtlInsertElementGenericTableAvl(unsigned __int16 *a1, _QWORD *a2, unsigned __int64 a3, bool *a4)
{
  ...
  __int64 *v12; // rsi
  int v13; // r14d
  __int64 (__fastcall *v15)(__int64, unsigned int, unsigned __int64); // rax
  __int64 Heap; // rax
  __int64 *v17; // r8
  __int64 *j; // rdx
  bool v19; // zf
...
LABEL_16:
  ...
  {
    v15 = (__int64 (__fastcall *)(__int64, unsigned int, unsigned __int64))*((_QWORD *)a1 + 10);
    if ( v15 == RtlAllocateHeap )
    {
      Heap = RtlAllocateHeap((__int64)a1, (int)v5 + 32, a3);
      v6 = (__int64 **)(a1 + 8);
    }
    else
    {
