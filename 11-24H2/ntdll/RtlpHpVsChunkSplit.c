/*
 * XREFs of RtlpHpVsChunkSplit @ 0x1800687B0
 * Callers:
        ...
        __int64 a6)
{
  ...
  __int64 v75; // r13
  __int64 v76; // r10
  __int64 (__fastcall *v77)(__int64, unsigned __int64, _QWORD, _QWORD); // rax
  int v78; // eax
  char *i; // r8
  char v80; // al
  ...
  *(_DWORD *)(a4 + 8) = v25;
  ...
  if ( v28 )
  {
    ...
    *(_OWORD *)SRWLock = 0LL;
    ...
    v76 = *(_QWORD *)(a1 + 8) ^ a1;
    v77 = (__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, _QWORD))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 32));
    ...
    if ( (v80 & 1) == 0 )
    {
      v82 = (volatile signed __int32 *)(a2 + 8);
      *(_QWORD *)(a6 + 8) = a2 + 8;
      ...
      if ( SchedulerSharedDataSlot )
      {
        ...
        {
          v81 = (unsigned __int64)&SchedulerSharedDataSlot[8 * (unsigned int)i];
          if ( !*(_QWORD *)v81 )
          {
            if ( v81 )
              *(_QWORD *)v81 = v82;
      ...
      if ( _interlockedbittestandset64(v82, 0LL) )
        RtlpAcquireSRWLockExclusiveContended((unsigned __int64)v82, v81, i, SchedulerSharedDataSlot);
    }
    *(_DWORD *)(a4 + 8) &= ~0x200u;
  }
