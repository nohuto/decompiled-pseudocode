/*
 * XREFs of LdrpLogDelayLoadTrigger @ 0x1800DCC30
 * Callers:
...
struct _PEB *__fastcall LdrpLogDelayLoadTrigger(__int64 a1, unsigned int *a2, __int64 a3, __int64 a4)
{
  ...
  unsigned __int64 v101; // [rsp+30h] [rbp-78h]
  ...
  {
    result = NtCurrentPeb();
    v97 = (__int64)result->SharedData + 554;
  }
  else
  {
    v97 = 2147353476LL;
...
LABEL_13:
        ...
        v99 = v25 + 36;
        result = (struct _PEB *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1572864, v25 + 36);
        v101 = (unsigned __int64)result;
        if ( result )
        {
          *(_WORD *)&result->Padding0[2] = 5334;
          ...
          v28 = 2;
          v29 = (_WORD *)&result->ProcessParameters + 2;
          if ( v22 && *(_WORD *)v22 )
          {
            v30 = *(_QWORD *)(v22 + 8);
...
LABEL_74:
          ...
          return (struct _PEB *)RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v101);
        }
      }
    }
  }
