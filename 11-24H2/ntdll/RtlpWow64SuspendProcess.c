/*
 * XREFs of RtlpWow64SuspendProcess @ 0x1801323E8
 * Callers:
 *     RtlWow64ChangeProcessState @ 0x180132180 (RtlWow64ChangeProcessState.c)
 *     RtlWow64SuspendProcess @ 0x1801323B0 (RtlWow64SuspendProcess.c)
 * Callees:
 ...
 *     NtChangeProcessState @ 0x180162F80 (NtChangeProcessState.c)
 *     ZwSuspendProcess @ 0x180165640 (ZwSuspendProcess.c)
...
__int64 __fastcall RtlpWow64SuspendProcess(void *a1, __int64 a2, unsigned __int8 a3)
{
        ...
        if ( (WORD2(v23[0]) & 0x800) != 0 )
        {
          if ( !a2 || (SharedInfoProcess = ZwDuplicateObject(-1LL, a2, a1, &v17, 0, 0, 2), SharedInfoProcess >= 0) )
          {
            ...
            if ( v11 >= 0 )
            {
              ...
              ZwQueryInformationThread(v5, 0LL, v18, 48LL, 0LL);
  ...
  {
    LODWORD(v14) = 3;
    ZwDuplicateObject(a1, v17, 0LL, 0LL, 0, 0, v14);
  }
  if ( v5 )
    NtClose(v5);
