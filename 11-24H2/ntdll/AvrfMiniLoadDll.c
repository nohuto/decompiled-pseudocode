/*
 * XREFs of AvrfMiniLoadDll @ 0x180108F94
 * Callers:
...
__int64 __fastcall AvrfMiniLoadDll(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  ...
  __int64 (__fastcall *v96)(__int64, __int64, unsigned __int64); // [rsp+1E0h] [rbp+E0h]
...
LABEL_63:
            ...
            appended = NtCreateSection(&Handle, 13LL, 0LL, 0LL);
            if ( appended >= 0 )
            {
              *(_WORD *)(a5 + 394) = 520;
                  ...
                  if ( appended >= 0 )
                  {
                    if ( v102 )
                    {
                      ...
                      while ( 1 )
                      {
                        ...
                        if ( !*++v34 )
                        {
                          ZwProtectVirtualMemory(-1LL, &v102, v103, v105, &v61);
...
LABEL_69:
                  ...
                  if ( (v40 & 0x2004) == 4 )
                  {
                    ...
                    LdrInitSecurityCookie(
                      ...
                      *(_DWORD *)(a5 + 64),
                      0LL,
                      v41 ^ (unsigned int)dword_1801EA4E8,
                      &v70);
                    ...
                    && **((_DWORD **)&v87 + 1) == 176 )
                  {
                    ...
                    *(_OWORD *)&dword_1801CC588 = **((_OWORD **)&v87 + 1);
                    v47 = *(_OWORD *)(*((_QWORD *)&v87 + 1) + 32LL);
                    *((_OWORD *)&dword_1801CC588 + 1) = v46;
                    v48 = v45[3];
                    *((_OWORD *)&dword_1801CC588 + 2) = v47;
                    v49 = v45[4];
                    *((_OWORD *)&dword_1801CC588 + 3) = v48;
                    v50 = v45[5];
                    *((_OWORD *)&dword_1801CC588 + 4) = v49;
                    v51 = v45[6];
                    *((_OWORD *)&dword_1801CC588 + 5) = v50;
                    v52 = v45[8];
                    *((_OWORD *)&dword_1801CC588 + 6) = v51;
                    *((_OWORD *)&dword_1801CC588 + 7) = v45[7];
                    v53 = v45[9];
                    *((_OWORD *)&dword_1801CC588 + 8) = v52;
                    v54 = v45[10];
                    *((_OWORD *)&dword_1801CC588 + 9) = v53;
                    *((_OWORD *)&dword_1801CC588 + 10) = v54;
                    RtlpDebugPageHeapTable = (_UNKNOWN *)v87;
                    v44[10] = AVrfpVerifierFlags;
                    v44[11] = AVrfpDebug;
                    v55 = *(_QWORD *)(a5 + 48);
                    v58 = 0LL;
                    LdrpLogDllState(v55, a5 + 72, 0x14AEu);
                    *(_DWORD *)(a5 + 368) = 9;
                    *(_QWORD *)(a5 + 176) = 0LL;
                  }
                  else
