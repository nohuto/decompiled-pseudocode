/*
 * XREFs of deflateResetKeep @ 0x180152D28
 * Callers:
 *     deflateReset @ 0x180152CF0 (deflateReset.c)
 * Callees:
 *     deflateStateCheck @ 0x180152E18 (deflateStateCheck.c)
...
__int64 __fastcall deflateResetKeep(__int64 a1)
{
  ...
  *(_QWORD *)(v3 + 2976) = &off_180174BD8;
  *(_QWORD *)(v3 + 2984) = v3 + 2560;
  *(_QWORD *)(v3 + 3000) = &off_180174C18;
  *(_QWORD *)(v3 + 3008) = v3 + 2804;
  *(_QWORD *)(v3 + 3024) = &unk_180174BF8;
  *(_WORD *)(v3 + 5980) = 0;
  *(_DWORD *)(v3 + 5984) = 0;
  init_block(v3);
  return 0LL;
