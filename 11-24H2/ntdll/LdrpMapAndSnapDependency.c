/*
 * XREFs of LdrpMapAndSnapDependency @ 0x18000C8D0
 * Callers:
...
__int64 __fastcall LdrpMapAndSnapDependency(__int64 a1, __int64 a2)
{
  ...
  if ( v4
    && *(_DWORD *)(v2 + 268) != 9
    && (DllActivationContext = LdrpFindDllActivationContext(v2), DllActivationContext < 0)
...
LABEL_12:
  ...
  result = RtlAllocateHeap(LdrpHeap, (NtdllBaseTag + 1572864) | 8u, 8LL * v11);
  v9 = v36;
    ...
    else
    {
      ...
      if ( word_1801CCF9C )
      {
        while ( v23-- )
        {
          ...
          if ( *(_WORD *)(qword_1801CD020 + 2 * v31) )
          {
            if ( !v23 )
            {
              v24 += 2;
