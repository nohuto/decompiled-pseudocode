/*
 * XREFs of RtlpProcessReflectionStartup @ 0x1801316E0
 * Callers:
 ...
 *     ZwResumeProcess @ 0x180163180 (ZwResumeProcess.c)
...
__int64 __fastcall RtlpProcessReflectionStartup(PSIZE_T RegionSize)
{
  ...
  EventHandle = 0LL;
  *(&ProcessInformation.Length + 1) = 0;
  memset_thunk_772440563353939046(&ProcessInformation, 0, 0x64uLL);
  BaseAddress = 0LL;
  Buffer = 0LL;
  RegionSizea[0] = 0LL;
  TargetHandle = 0LL;
