/*
 * XREFs of punycode_encode @ 0x1800BDBA8
 * Callers:
 ...
 *     GetUTF32 @ 0x1800BE11C (GetUTF32.c)
 *     FindLabelEnd @ 0x1800BE1F0 (FindLabelEnd.c)
 *     RtlStringCchCopyNExW @ 0x1800BE22C (RtlStringCchCopyNExW.c)
