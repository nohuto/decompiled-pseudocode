/*
 * XREFs of LdrpSetModuleSigningLevel @ 0x18010AD84
 * Callers:
 ...
 *     NtGetCachedSigningLevel @ 0x180163BA0 (NtGetCachedSigningLevel.c)
 *     ZwSetCachedSigningLevel @ 0x180164F80 (ZwSetCachedSigningLevel.c)
 */
