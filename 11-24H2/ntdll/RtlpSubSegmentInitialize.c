/*
 * XREFs of RtlpSubSegmentInitialize @ 0x1800CDD80
 * Callers:
        ...
        __int64 a6)
{
  ...
  *v9 = a2;
  ...
  if ( (char *)v9 + v19 + v17 + 8 <= (char *)v9 + a5 )
  {
    do
    {
      v22 = *(_DWORD *)(v21 + 12) & 0xFF0000FF;
      *(_DWORD *)(v21 + 8) = *(_DWORD *)(v12 + 24) ^ v16 ^ (v21 >> 4) ^ (((_DWORD)v21 - (_DWORD)v9) << 12);
      v23 = (unsigned __int16)v20++;
      *(_DWORD *)(v21 + 12) = v22 | (v23 << 8);
      *(_BYTE *)(v21 + 15) = 0x80;
      v21 += v17;
    }
  ...
  v25 = a2;
  v24[(((unsigned __int64)v20 + 63) >> 6) - 1] |= ~(0xFFFFFFFFFFFFFFFFuLL >> (-(char)v20 & 0x3F));
  *(_WORD *)(a2 + 36) = v18;
  *(_WORD *)(a2 + 40) = v20;
  *(_QWORD *)a2 = v14;
  ...
  *(_OWORD *)(a2 + 16) = 0LL;
  *(_DWORD *)(a3 + 24) = a1 ^ v53 ^ a3 ^ ((unsigned __int16)v19 | ((unsigned __int16)(16 * v18) << 16));
  if ( *(_DWORD *)(v14 + 164) )
  {
    v27 = *(_WORD *)(v14 + 176) + 1;
    *(_WORD *)(v14 + 176) = v27;
...
LABEL_12:
  ...
  while ( _InterlockedCompareExchange64(
            ...
            ((unsigned int)v28 + v20) | (unsigned __int64)(v30 << 32),
            v28) != v28 );
  v31 = *(_QWORD *)v14;
  *(_DWORD *)(v14 + 168) = ++*(_DWORD *)(v31 + 32);
  v32 = NtCurrentTeb();
  ...
  if ( (_BYTE)v33 == HIBYTE(v32->HeapData) )
  {
    ...
    do
    {
      v45 = ((((v44 ^ (v44 >> 12)) << 25) ^ v44 ^ (v44 >> 12)) >> 27) ^ ((v44 ^ (v44 >> 12)) << 25) ^ v44 ^ (v44 >> 12);
      v46 = v44;
      v44 = _InterlockedCompareExchange64(&qword_1801CCF00, v45, v44);
    }
    while ( v46 != v44 );
    v34 = 29 * v45;
    HIBYTE(v32->HeapData) = 29 * v45;
  }
  else
  {
    v34 = BYTE2(v32->HeapData);
  }
  BYTE2(v32->HeapData) = v34 + 1;
  ...
  *(_DWORD *)(v25 + 44) = 1;
  ...
  {
    v35 = BYTE2(NtCurrentTeb()->HeapData);
    v36 = qword_1801CCF00;
    do
    {
      v37 = ((((v36 ^ (v36 >> 12)) << 25) ^ v36 ^ (v36 >> 12)) >> 27) ^ ((v36 ^ (v36 >> 12)) << 25) ^ v36 ^ (v36 >> 12);
      v38 = v36;
      v36 = _InterlockedCompareExchange64(&qword_1801CCF00, v37, v36);
    }
    while ( v38 != v36 );
