/*
 * XREFs of LdrpEnclaveAddForwarderModules @ 0x1800D94B8
 * Callers:
...
__int64 __fastcall LdrpEnclaveAddForwarderModules(__int64 a1)
{
  ...
  v4 = RtlImageDirectoryEntryToData(v3, 1, 0, &Value);
  v5 = v4;
  if ( v4 )
  {
    v6 = (unsigned int *)(v3 + *(unsigned int *)(v4 + 28));
    ...
    if ( v6 < v7 )
    {
      ...
      do
      {
        ...
        if ( v9 - v5 < v8 )
        {
          v11 = strrchr((const char *)(v3 + *v6), 46);
          if ( !v11 )
          ...
          v12 = v11[1] == 35;
          *((_QWORD *)&v13 + 1) = v9;
          LOWORD(v13) = (_WORD)v11 - v9;
          WORD1(v13) = (_WORD)v11 - v9;
          if ( v12 && RtlCharToInteger(v11 + 2, 0, &Value) < 0 )
            return (unsigned int)-1073741701;
