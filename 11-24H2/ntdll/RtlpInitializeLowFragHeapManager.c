/*
 * XREFs of RtlpInitializeLowFragHeapManager @ 0x1800F8148
 * Callers:
...
int RtlpInitializeLowFragHeapManager()
{
  ...
  do
  {
    ...
    v2 = v0;
    v0 = _InterlockedCompareExchange64(&qword_1801CDF00, v1, v0);
  }
  while ( v2 != v0 );
