/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x18013CDD8
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x18013CD30 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x18013CD40 (RtlSetTimeZoneInformation.c)
 * Callees:
