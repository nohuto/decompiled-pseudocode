/*
 * XREFs of TppTimerpExecuteCallback @ 0x18004D320
 * Callers:
...
void __fastcall TppTimerpExecuteCallback(PTP_CALLBACK_INSTANCE a1, __int64 a2)
{
  ...
  __int64 v16; // rax
  __int64 v17; // rdx
  void (__cdecl *v18)(PTP_CALLBACK_INSTANCE, PVOID, PTP_TIMER); // rax
  void *v19; // rdx
  _DWORD *v20; // rcx
  ...
  if ( (unsigned int)TppWorkCallbackPrologRelease(a1, (PVOID)v2) )
  {
    ...
    v18 = *(void (__cdecl **)(PTP_CALLBACK_INSTANCE, PVOID, PTP_TIMER))(v2 + 80);
    v19 = *(void **)(v2 + 88);
