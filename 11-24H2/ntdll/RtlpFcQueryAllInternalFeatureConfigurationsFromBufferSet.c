/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x18014F6AC
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x18017047C (RtlpFcConfigurationTypeToBufferType.c)
 */
