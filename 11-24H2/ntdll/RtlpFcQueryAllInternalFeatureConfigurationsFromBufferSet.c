/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x1801512EC
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x18017147C (RtlpFcConfigurationTypeToBufferType.c)
 */
