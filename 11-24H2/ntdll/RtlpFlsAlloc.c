/*
 * XREFs of RtlpFlsAlloc @ 0x1800B0E88
 * Callers:
 *     RtlFlsAllocEx @ 0x1800B0D70 (RtlFlsAllocEx.c)
 *     RtlpHpEnvTlsAlloc @ 0x1800B0DA8 (RtlpHpEnvTlsAlloc.c)
 *     RtlFlsAlloc @ 0x1800B0E60 (RtlFlsAlloc.c)
 * Callees:
...
LABEL_22:
  ...
  {
    v8 = -1073741801;
    RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotFree((__int64)&SRWLock[1], v14);
    goto LABEL_22;
  }
