/*
 * XREFs of RtlpComputeLangListCheckSum @ 0x180036440
 * Callers:
...
LABEL_16:
        ...
        if ( qword_1801CD038 && (unsigned __int16)v14 >= 0xC0u )
        {
          v15 = *(_WORD *)(qword_1801CD038
                         + 2
                         * ((v14 & 0xF)
                          + *(unsigned __int16 *)(qword_1801CD038
                                                + 2LL
                                                * (((unsigned __int8)v14 >> 4)
                                                 + (unsigned int)*(unsigned __int16 *)(qword_1801CD038 + 2 * (v14 >> 8))))))
              + v14;
          LOWORD(v14) = v15;
          goto LABEL_16;
        }
