/*
 * XREFs of RtlLoadString @ 0x1800976E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  unsigned __int64 v20; // [rsp+48h] [rbp-80h] BYREF
...
LABEL_8:
    ...
    if ( v12 )
    {
      v13 = LdrpSearchResourceSection_U((__int64)a1, (__int64)v25, 4u, 1u, &v22);
      if ( v13 < 0 )
        return (unsigned int)v13;
      v13 = LdrpAccessResourceData((unsigned __int64)a1, v22, (__int64)&v21, 0LL);
      v14 = v20;
    }
    else
    {
      v13 = LdrResSearchResource(a1, v25, (__int64)&v21, (__int64)&v20, a7, a8);
      v14 = v20;
      if ( v13 >= 0 && v20 > 0xFFFF )
