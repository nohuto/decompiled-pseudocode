/*
 * XREFs of RtlGetProductInfo @ 0x1800E6020
 * Callers:
 *     <none>
 * Callees:
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  if ( OSMajorVersion <= 5 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180172D60, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180172D70, &Type, v22, 0xC8u, &ResultDataSize) < 0 )
  {
