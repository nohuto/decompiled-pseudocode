/*
 * XREFs of RtlpAssemblyStorageMapResolutionDefaultCallback @ 0x180081C00
 * Callers:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v7 + 32) + 8LL) & 0x8000) != 0 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          LOBYTE(v20) = 1;
          *(_OWORD *)&v19[v17] = xmmword_18017D168;
...
LABEL_25:
  ...
  LODWORD(v7) = ((__int64 (__fastcall *)(HANDLE, _QWORD, _QWORD, _BYTE *, int, size_t *))NtEnumerateKey)(
                  v8,
                  (unsigned int)(v9 - 2),
                  0LL,
                  v30,
