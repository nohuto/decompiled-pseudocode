/*
 * XREFs of LZNT1CompressChunk @ 0x1800F52AC
 * Callers:
 *     RtlCompressBufferLZNT1 @ 0x1800F51A0 (RtlCompressBufferLZNT1.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  v11 = 0;
  v12 = a4;
  v27 = (unsigned __int64)(a2 + 4096) < a3;
  v36 = 0;
  v14 = a1;
  v15 = a7;
  v16 = &LZNT1Formats;
  ...
  *(_DWORD *)(a7 + 16) = 4098;
  ...
  {
    v22 = (unsigned int *)&unk_18018461C;
    while ( 1 )
    {
      if ( &a2[*v22] < v10 )
      {
      ...
      *v21 = (v23 - 3) | (((_WORD)v10 - *(_WORD *)(a7 + 24) - 1) << v33[16]);
LABEL_12:
      v25 = &v10[v23];
      v26 = (_WORD *)((char *)v21 + v24);
      v10 = v25;
      v18 = ((_BYTE)v18 + 1) & 7;
      v21 = v26;
      v32 = v18;
...
LABEL_16:
  if ( (unsigned __int64)v10 < a3 )
  {
    v31 = (unsigned int)(a3 - (_DWORD)a2);
    if ( (unsigned __int64)v12 + v31 + 2 > a5 )
    {
      return 3221225507LL;
    }
    else
    {
      memmove(v17, a2, (unsigned int)v31);
      *a6 = v31 + 2;
      *v12 = (v31 - 1) & 0xFFF | 0x3000;
      return 0LL;
    }
  }
  else
  {
    if ( (unsigned __int64)v20 >= v7 )
      ...
      *v20 = v19;
    v28 = (_DWORD)v21 - (_DWORD)v12;
    *a6 = v28;
    *v12 = (v28 - 3) & 0xFFF | 0xB000;
