/*
 * XREFs of KeyboardClassPlugPlayNotification @ 0x1C000E880
 * Callers:
 *     <none>
 * Callees:
 *     KeyboardClassEnableGlobalPort @ 0x1C000E784 (KeyboardClassEnableGlobalPort.c)
 */

__int64 __fastcall KeyboardClassPlugPlayNotification(char *NotificationStructure, volatile __int64 *Context)
{
  __int64 result; // rax
  __int64 v5; // rdx
  char v6; // dl
...
LABEL_4:
    v6 = 0;
    return KeyboardClassEnableGlobalPort((__int64)Context, v6);
  }
  ...
  if ( !v7 )
  {
    v8 = (void *)_InterlockedExchange64(Context + 41, 0LL);
    if ( !v8 )
      return result;
  ...
  if ( !v9 )
  {
    v10 = (void *)_InterlockedExchange64(Context + 41, 0LL);
    if ( v10 )
    {
