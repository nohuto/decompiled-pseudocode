/*
 * XREFs of KeyboardClassCleanupQueue @ 0x1C0001E00
 * Callers:
...
__int64 **__fastcall KeyboardClassCleanupQueue(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  v14 = &v13;
  v13 = (__int64 *)&v13;
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a2 + 160));
  v6 = *(__int64 ****)(a2 + 168);
  if ( v6 != (__int64 ***)(a2 + 168) )
  {
    do
    {
      v7 = *v6;
...
LABEL_11:
    ...
    while ( v7 != (__int64 **)(a2 + 168) );
  }
  KeReleaseSpinLock((PKSPIN_LOCK)(a2 + 160), v5);
  while ( 1 )
  {
    v8 = v13;
    result = &v13;
