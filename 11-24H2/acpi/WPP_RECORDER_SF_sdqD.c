/*
 * XREFs of WPP_RECORDER_SF_sdqD @ 0x140065B20
 * Callers:
...
__int64 WPP_RECORDER_SF_sdqD(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, const char *a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    if ( !a6 )
      v12 = "NULL";
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, const char *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
  ...
  if ( !a6 )
    v6 = "NULL";
  LOWORD(v15) = a4;
  return WppAutoLogTrace(a1, 2LL, 21LL, &WPP_46f050f87a9c3f86e1bf3d4ff5286087_Traceguids, v15, v6, v13, (__int64 *)va);
}
