/*
 * XREFs of SyncEvalObject @ 0x1400143C8
 * Callers:
...
__int64 __fastcall SyncEvalObject(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( !ThreadCurrentContext )
  {
    ...
    {
      v15 = 9LL * (_InterlockedExchangeAdd((_DWORD *)&qword_140089088 + 1, 1u) % (unsigned int)qword_140089088);
      *((_QWORD *)qword_140089090 + v15 + 1) = MEMORY[0xFFFFF78000000008];
      *((_DWORD *)qword_140089090 + 2 * v15) = 1398361667;
      *((_QWORD *)qword_140089090 + v15 + 2) = CurrentThread;
      *((_QWORD *)qword_140089090 + v15 + 3) = 0LL;
      *((_QWORD *)qword_140089090 + v15 + 4) = 0LL;
      *((_QWORD *)qword_140089090 + v15 + 5) = v14;
      *((_QWORD *)qword_140089090 + v15 + 6) = CurrentIrql;
      *((_QWORD *)qword_140089090 + v15 + 7) = a1;
      *((_QWORD *)qword_140089090 + v15 + 8) = 0LL;
    }
  ...
  if ( v17 == 32772 )
  {
    ...
    else
    {
      while ( 1 )
      {
        ...
        v17 = v29;
        if ( (_DWORD)v29 == 32771 )
          v17 = RestartContext(*((__int64 *)&v29 + 1), 0);
        if ( v17 != 32772 )
          goto LABEL_10;
      }
      LogError(-1072431098);
