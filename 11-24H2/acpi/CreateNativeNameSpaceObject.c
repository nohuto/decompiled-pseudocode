/*
 * XREFs of CreateNativeNameSpaceObject @ 0x140052F04
 * Callers:
 ...
 *     GetNextNameSegment @ 0x14006CB0C (GetNextNameSegment.c)
 *     SetClearAssociatedNativeObject @ 0x14006D9F4 (SetClearAssociatedNativeObject.c)
        ...
        __int64 *a8)
{
  ...
  {
    ObjectPath = (_BYTE *)GetObjectPath((__int64)v22);
    if ( ObjectPath )
    {
      ...
      while ( v15 )
      {
        ...
        v17 = CreateNameSpaceObject(v27, (__int64)Src, v10, v26, &v21, 0x20000);
        v8 = v23;
        v13 = v17;
        v18 = v21;
        if ( v17 < 0 )
