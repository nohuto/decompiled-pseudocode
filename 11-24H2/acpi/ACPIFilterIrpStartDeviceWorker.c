/*
 * XREFs of ACPIFilterIrpStartDeviceWorker @ 0x1400B9850
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ACPIFilterIrpStartDeviceWorker(__int64 a1)
{
  ...
  union _LARGE_INTEGER v33; // [rsp+D8h] [rbp+6Fh] BYREF
...
LABEL_14:
  ...
  *(_BYTE *)(v19 - 69) = 0;
  AcpiGetDriverProxyEndpoint(&v34, (__int64)ACPIRootIrpCompleteRoutine);
  ...
  *(_BYTE *)(v20 - 69) = -32;
  ...
  if ( v26 >= 0 )
  {
    ...
    *(_QWORD *)(v7 + 1120) &= ~0x10000000000000uLL;
  }
  else
  {
