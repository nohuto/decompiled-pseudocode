/*
 * XREFs of ACPIProcessorContainerEvaluateLpiObjects @ 0x14006624C
 * Callers:
 *     ACPIProcessorContainerEvaluateLpiObjects @ 0x14006624C (ACPIProcessorContainerEvaluateLpiObjects.c)
