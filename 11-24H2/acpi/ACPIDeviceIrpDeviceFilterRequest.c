/*
 * XREFs of ACPIDeviceIrpDeviceFilterRequest @ 0x14001A800
 * Callers:
 *     <none>
 * Callees:
        ...
        void (__fastcall *a3)(__int64, __int64, _QWORD))
{
  ...
  if ( v13 < 0 )
  {
    ACPIInternalDecrementIrpReferenceCount(v8, 1LL, v7);
    return (unsigned int)v13;
  }
  else if ( v9 != 1 && _bittest64((const signed __int64 *)(v8 + 1120), 0x24u) )
  {
    if ( a3 )
