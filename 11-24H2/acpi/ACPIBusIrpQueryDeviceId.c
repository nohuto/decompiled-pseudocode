/*
 * XREFs of ACPIBusIrpQueryDeviceId @ 0x1400B8F9C
 * Callers:
...
LABEL_46:
  ...
  {
LABEL_27:
    v23 = ACPIGet((__int64)a3, 1145653343, 268959798, 0LL, 0, 0LL, 0LL, (__int64)&Src, (__int64)&Size);
    v7 = v23;
    if ( v23 == -1073741661 )
    {
      v24 = a3[76];
...
LABEL_38:
      v7 = RtlStringCbPrintfExW(&v9[v12 >> 1], v10 - v12, ppszDestEnd, &pcbRemaining, 0, &word_140076578);
      goto LABEL_39;
    }
LABEL_2:
    v7 = -1073741670;
