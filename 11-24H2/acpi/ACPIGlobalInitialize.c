...
void *ACPIGlobalInitialize()
{
  ...
  qword_140088C38 = (__int64)ACPIGpeHalEnableDisableEvents;
  dword_140088C34 = 2;
  qword_140088C40 = (__int64)ACPIEnableInitializeACPI;
  qword_140088C48 = (__int64)ACPIWakeEnableWakeEvents;
  qword_140088C50 = (__int64)ACPIWakeMarkHiberPhase;
