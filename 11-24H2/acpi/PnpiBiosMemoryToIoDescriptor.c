/*
 * XREFs of PnpiBiosMemoryToIoDescriptor @ 0x1400BBDE0
 * Callers:
...
__int64 __fastcall PnpiBiosMemoryToIoDescriptor(unsigned __int8 *a1, __int64 a2, __int64 a3)
{
  bool v4; // al
  __int16 v5; // di
  int v6; // ecx
  ...
  if ( v9 )
  {
    result = PnpiUpdateResourceList(a2 + 8LL * (unsigned int)a3, &v13, a3);
    if ( (int)result < 0 )
      return result;
    v11 = v13;
    *(_WORD *)(v13 + 1) = 259;
