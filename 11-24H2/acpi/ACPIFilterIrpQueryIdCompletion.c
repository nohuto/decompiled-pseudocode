/*
 * XREFs of ACPIFilterIrpQueryIdCompletion @ 0x14009E6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIFilterIrpQueryIdCompletion(ULONG_PTR a1, __int64 a2)
{
  ...
  if ( (AcpiOverrideAttributes & 0x100000) != 0 && (*(_DWORD *)(DeviceExtension + 1120) & 0x800000) == 0 && v10 - 1 <= 1 )
  {
    if ( v9 )
    {
      ...
      v5 = v12;
      if ( v12 >= 0 && v20 == 2 )
        ACPIInternalSetFlags((void *)(DeviceExtension + 1120), 0x800000uLL);
    }
  }
  if ( (AcpiOverrideAttributes & 0x200000) == 0
    || (*(_DWORD *)(DeviceExtension + 1120) & 0x40000000) != 0
    || v10 - 1 > 1
    || !v9
...
LABEL_21:
  ...
  ACPIInternalSetFlags((void *)(DeviceExtension + 1120), 0x40000000uLL);
LABEL_22:
  v3 = DeviceExtension;
LABEL_23:
