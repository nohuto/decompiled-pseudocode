/*
 * XREFs of ACPIThermalQueryCoolingInterfaces @ 0x140068DD4
 * Callers:
 ...
 * Callees:
 *     ACPIGetRootDeviceObject @ 0x1400556C0 (ACPIGetRootDeviceObject.c)
 */
        ...
        *(_QWORD *)(v7 + 48) = WorkItem;
        if ( WorkItem )
        {
          ...
          *(_BYTE *)(v7 + 41) = PoGetThermalRequestSupport(v16, 1LL);
          ...
          {
            *(_QWORD *)(a1 + 656) = v7;
            v11 = (__int64 *)qword_140089C18;
            if ( *(__int64 **)qword_140089C18 != &AcpiThermalClientList )
              __fastfail(3u);
