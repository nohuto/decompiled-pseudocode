/*
 * XREFs of IrqArbpFindSuitableRangeMsi @ 0x1400BDFDC
 * Callers:
 ...
 *     ProcessorMsiSupported @ 0x1400BE104 (ProcessorMsiSupported.c)
 */
...
char __fastcall IrqArbpFindSuitableRangeMsi(__int64 a1, __int64 a2)
{
  ...
  LOBYTE(v10) = 0;
  if ( (int)ProcessorMsiSupported(v6 + 16, &v10) < 0 || !(_BYTE)v10 )
    return 0;
