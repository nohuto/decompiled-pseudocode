/*
 * XREFs of WPP_RECORDER_SF_SqLL @ 0x140063A68
 * Callers:
...
__int64 WPP_RECORDER_SF_SqLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const wchar_t *a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x20) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    ...
    if ( !a6 )
      v12 = L"NULL";
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, const wchar_t *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
  ...
  if ( v13 )
    v6 = L"NULL";
  LOWORD(v15) = 12;
  return WppAutoLogTrace(a1, 4LL, 6LL, &WPP_e31de8e794e03abc169a9744a0587e03_Traceguids, v15, v6, v9, (__int64 *)va);
}
