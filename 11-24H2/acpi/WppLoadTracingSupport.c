/*
 * XREFs of WppLoadTracingSupport @ 0x1400986B8
 * Callers:
...
PVOID WppLoadTracingSupport()
{
  ...
  pfnWppTraceMessage = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))MmGetSystemRoutineAddress(&DestinationString);
