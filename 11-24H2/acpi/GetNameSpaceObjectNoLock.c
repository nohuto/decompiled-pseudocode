/*
 * XREFs of GetNameSpaceObjectNoLock @ 0x14000AA30
 * Callers:
...
LABEL_33:
  ...
  v13 = -1073741773;
  dword_1400890B8 = -1073741773;
  v14 = 0LL;
  for ( j = (const char **)&unk_140088010; j[1]; j += 2 )
  {
  ...
  *(_QWORD *)&v25.Size = 6LL;
  v27 = 6LL;
  v29 = 4LL;
  EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_AMLI_ERROR, 0LL, 3u, &v25);
  if ( (_BYTE)KdDebuggerEnabled )
  {
    DbgPrintEx(0x19u, 0, off_1400874B8, a1, 0LL, 0LL, 0LL);
...
LABEL_26:
  if ( v24 < 0 && v13 == -1073741772 )
  {
    ...
    PrintDebugMessage(58, (_DWORD)a1, 0, 0, 0LL);
  }
  *a3 = 0LL;
  return v13;
}
