/*
 * XREFs of AcpiDiagTraceTemperatureChange @ 0x140038544
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureChange(__int64 a1, __int64 a2)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
    && EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_TEMPERATURE_CHANGE)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a2 + 760), &DestinationString, 1LL) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    v10 = 0;
    v12 = 4LL;
    EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_TEMPERATURE_CHANGE, 0LL, 3u, &UserData);
  }
