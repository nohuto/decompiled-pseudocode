/*
 * XREFs of ACPIThermalReleaseCoolingInterfaces @ 0x140048648
 * Callers:
...
LABEL_15:
        ...
        while ( 1 )
        {
          ...
          *v11 = v10;
          *(_QWORD *)(v10 + 8) = v11;
          v12 = (_QWORD *)qword_140089BF8;
          if ( *(__int64 **)qword_140089BF8 != &AcpiThermalUnclaimedConstraintList )
            break;
          *v9 = &AcpiThermalUnclaimedConstraintList;
          v9[1] = v12;
          *v12 = v9;
          qword_140089BF8 = (__int64)v9;
          if ( v7 == v3 + 2 )
            goto LABEL_15;
        }
      }
