/*
 * XREFs of ACPIBuildFilter @ 0x140046B74
 * Callers:
 ...
 *     ACPIIsFilterDebuggingDevice @ 0x1400C03C8 (ACPIIsFilterDebuggingDevice.c)
 */
      ...
      *(_QWORD *)(a2 + 24) = AcpiFilterIrpDispatch;
      ...
      if ( (unsigned __int8)ACPIIsFilterDebuggingDevice(a2) && AcpiRetainDebugDeviceInD0 )
      {
        do
        {
          ...
          _InterlockedOr64((volatile signed __int64 *)(a2 + 1120), 0x1000000000uLL);
