    ...
    if ( AttachedDeviceReference )
    {
      ...
      *(_QWORD *)&OutputBuffer[4] = *(_QWORD *)(RootDeviceExtension + 768);
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_140089E30 = OutputBuffer[1];
        unk_140089E40 = OutputBuffer[2];
        xmmword_140089E50 = OutputBuffer[3];
        xmmword_140089E60 = OutputBuffer[4];
        xmmword_140089E70 = OutputBuffer[5];
