/*
 * XREFs of AcpiDiagTraceDeviceCoolingRundown @ 0x140039394
 * Callers:
...
void __fastcall AcpiDiagTraceDeviceCoolingRundown(__int64 a1, char a2, char a3)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
    && EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_DEVICE_COOLING_RUNDOWN)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 760), &DestinationString, 1LL) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v13 = 2LL;
    v15 = 1LL;
    EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_DEVICE_COOLING_RUNDOWN, 0LL, 4u, &UserData);
  }
