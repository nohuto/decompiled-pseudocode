/*
 * XREFs of IrqArbpSetDeviceProperties @ 0x1400B2FA8
 * Callers:
 ...
 *     IrqPolicySetDeviceAffinity @ 0x1400B3354 (IrqPolicySetDeviceAffinity.c)
 */
  ...
  *(_OWORD *)&Iterator.Current = v4;
  while ( 1 )
  {
    if ( a1->Owner == *p_Owner )
    {
      ...
      DeviceIdtAssignment = ProcessorGetDeviceIdtAssignment(Owner, v10, 0LL, &v29);
    ...
    *(_OWORD *)&Iterator.Current = v28;
    while ( 1 )
    {
      if ( v9->Owner == *v24 )
      {
        ...
        DeviceIdtAssignment = ProcessorGetDeviceIdtAssignment(Pdo, v19, 0LL, &v29);
        if ( DeviceIdtAssignment < 0 )
          goto LABEL_30;
        if ( v7 )
          v18 -= DWORD2(v30);
