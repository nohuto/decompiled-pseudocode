/*
 * XREFs of ACPIBuildProcessDevicePhasePrx @ 0x14001FDA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDevicePhasePrx(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  *(_QWORD *)(v5 + 8 * v9 + 456) = AMLIGetNamedChild(*(__int64 **)(v5 + 760), *(_DWORD *)&aPs0Ps1Ps2[4 * v6]);
  v10 = *(_QWORD *)(a1 + 56);
  if ( !v10 )
    goto LABEL_4;
  if ( *(_WORD *)(v4 + 2) == 4 )
  {
    v8 = ACPIBuildDevicePowerNodes(v5, v10);
LABEL_11:
    dword_1400890B8 = 0;
    pszDest = 0;
    FreeDataBuffs(v4, 1u);
