/*
 * XREFs of ACPIPepQueueWorker @ 0x1400BA358
 * Callers:
 *     ACPIPepEffectivePowerModeCallback @ 0x1400A11F0 (ACPIPepEffectivePowerModeCallback.c)
 *     ACPIPepWnfCallback @ 0x1400A1920 (ACPIPepWnfCallback.c)
 *     ACPIPepPowerSettingChangeCallback @ 0x1400BA1C0 (ACPIPepPowerSettingChangeCallback.c)
 * Callees:
