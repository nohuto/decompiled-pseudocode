/*
 * XREFs of Simulator_NotifyTablesAreLoaded @ 0x1400C82BC
 * Callers:
...
__int64 Simulator_NotifyTablesAreLoaded()
{
  ...
  v9 = 0LL;
  if ( !(unsigned int)CreateNameSpaceObject(gpheapGlobal, (__int64)"MSLT", 0LL, 0LL, &v9, 0) )
  {
    v0 = v9;
    if ( v9 )
    {
  ...
  v9 = 0LL;
  if ( !(unsigned int)CreateNameSpaceObject(gpheapGlobal, (__int64)"MSUT", 0LL, 0LL, &v9, 0) )
  {
    v3 = v9;
    if ( v9 )
    {
