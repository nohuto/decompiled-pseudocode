/*
 * XREFs of ProcessLoadTable @ 0x14006FA50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
      ...
      RtlStringCchCopyNA(&v17[(unsigned int)v15], v29 - (unsigned int)v15, v3, (unsigned int)v14);
    ...
    else
    {
      ...
      RtlStringCchCopyNA(v21, (unsigned int)(v14 + 1), v3, (unsigned int)v14);
    }
    NameSpaceObject = GetNameSpaceObject(v17, *(_QWORD *)(BugCheckParameter2 + 80), (__int64)&v30, 0x80000000);
    v5 = NameSpaceObject;
    if ( NameSpaceObject )
    {
...
LABEL_44:
    ...
    else
    {
      v25 = v30 + 64;
      FreeObjData(v30 + 64);
      v26 = DupObjData(gpheapGlobal, v25, *(_QWORD *)(v6 + 80) + 200LL);
      v5 = v26;
      if ( v26 )
      {
        LogError(v26);
