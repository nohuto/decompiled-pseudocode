/*
 * XREFs of MidString @ 0x14002EA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MidString(__int64 a1, __int64 a2)
{
  ...
  if ( v6 )
    return v6;
  v6 = ValidateTarget(a1, *(_QWORD *)(a2 + 80) + 120LL, 135LL, &v17);
  if ( v6 )
    return v6;
  ...
  *(_WORD *)(*(_QWORD *)(a2 + 88) + 2LL) = v7;
  ...
  if ( v10 >= v9 )
  {
    if ( *(_WORD *)(v8 + 2) != 2 )
      return v6;
    v15 = HeapAlloc(gpheapGlobal, 1381258056, 1u);
...
LABEL_20:
  ...
  {
    v16 = HeapAlloc(gpheapGlobal, 1179992648, v11);
