/*
 * XREFs of WPP_RECORDER_SF_iDD @ 0x14003AF74
 * Callers:
...
__int64 WPP_RECORDER_SF_iDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_50e810bdc9813ec783e127f6110de7f2_Traceguids,
      10LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
