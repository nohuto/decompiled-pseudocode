/*
 * XREFs of IntpReconstructPartitionGroupFromKernel @ 0x140070948
 * Callers:
 *     IntPartArbInit @ 0x1400AC0E0 (IntPartArbInit.c)
 * Callees:
 *     RtlNumberOfSetBitsUlongPtr_0 @ 0x14005681B (RtlNumberOfSetBitsUlongPtr_0.c)
 *     IntpAllocateGroupContext @ 0x1400708F0 (IntpAllocateGroupContext.c)
