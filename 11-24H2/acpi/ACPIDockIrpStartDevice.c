/*
 * XREFs of ACPIDockIrpStartDevice @ 0x14009A030
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIBuildSynchronizationRequest @ 0x14002A254 (ACPIBuildSynchronizationRequest.c)
...
LABEL_38:
  ...
  KdDisableDebugger();
  v3 = ACPIGet(v6, 1262699615, 277086210, 1LL, 4, 0LL, 0LL, (__int64)&v17, 0LL);
  if ( v3 >= 0 )
    v3 = ACPIGet(v6, 1096045407, -1878783998, 0LL, 0, 0LL, 0LL, (__int64)&v18, 0LL);
  KdEnableDebugger();
  if ( v3 >= 0 )
  {
    v11 = byte_1400753E8;
