/*
 * XREFs of AcpiPccInitTypeLegacySubspace @ 0x14009FC34
 * Callers:
...
LABEL_20:
  ...
  *((_QWORD *)DeferredContext + 7) = v13;
  ...
  AcpiGetDriverProxyEndpoint(&v17, (__int64)AcpiPccRingDoorbell);
  ...
  if ( *DeferredContext == -1 || !*DeferredContext && (*((_DWORD *)DeferredContext + 2) & 1) != 0 )
    v4 = 0;
  *((_DWORD *)DeferredContext + 176) = v4;
  AcpiGetDriverProxyEndpoint(&v18, (__int64)AcpiPccWatchdog);
