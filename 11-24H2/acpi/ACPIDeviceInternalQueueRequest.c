...
LABEL_14:
    ...
    *v7 = v5;
    ...
    if ( (v3 & 1) != 0 )
    {
      result = (_QWORD *)qword_14008AFF8;
      if ( *(__int64 **)qword_14008AFF8 != &AcpiPowerDelayedQueueList )
        goto LABEL_14;
      *a2 = &AcpiPowerDelayedQueueList;
      a2[1] = result;
      *result = a2;
      qword_14008AFF8 = (__int64)a2;
    }
    else
    {
      result = (_QWORD *)qword_14008B008;
      if ( *(__int64 **)qword_14008B008 != &AcpiPowerQueueList )
        goto LABEL_14;
      *a2 = &AcpiPowerQueueList;
      a2[1] = result;
      *result = a2;
      qword_14008B008 = (__int64)a2;
    }
  }
LABEL_11:
