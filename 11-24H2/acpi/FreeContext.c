...
void __fastcall FreeContext(char *Entry)
{
  ...
  byte_140088D90 = KeAcquireSpinLockRaiseToDpc(&gmutCtxtList);
  ...
  *v4 = v4;
    ...
    && (unsigned __int8)tlgKeywordOn(&dword_140086930) )
  {
    ...
    v24 = v20;
    v33[2] = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_140086930, (int)&dword_14007D0A1, v19, v20, 5u, (__int64)&UserData);
  }
