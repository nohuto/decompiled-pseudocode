/*
 * XREFs of AcquireDeviceFirmwareLock @ 0x14005C27C
 * Callers:
 *     AcpiHandleDeviceFirmwareLock @ 0x140054470 (AcpiHandleDeviceFirmwareLock.c)
 * Callees:
 *     ACPIInternalGetDeviceFromNSOBJ @ 0x1400404B0 (ACPIInternalGetDeviceFromNSOBJ.c)
 *     DereferenceDeviceFirmwareLockHandlerEntry @ 0x14005C558 (DereferenceDeviceFirmwareLockHandlerEntry.c)
 *     FindDeviceFirmwareLockHandlerEntry @ 0x14005C79C (FindDeviceFirmwareLockHandlerEntry.c)
