...
__int64 __fastcall RestartContext(__int64 a1, char a2)
{
  ...
  {
    v10 = 9LL * (_InterlockedExchangeAdd((_DWORD *)&qword_140089088 + 1, 1u) % (unsigned int)qword_140089088);
    *((_QWORD *)qword_140089090 + v10 + 1) = MEMORY[0xFFFFF78000000008];
    *((_DWORD *)qword_140089090 + 2 * v10) = 1380275028;
    *((_QWORD *)qword_140089090 + v10 + 2) = CurrentThread;
    *((_QWORD *)qword_140089090 + v10 + 3) = v8;
    *((_QWORD *)qword_140089090 + v10 + 4) = a1;
    *((_QWORD *)qword_140089090 + v10 + 5) = v9;
    *((_QWORD *)qword_140089090 + v10 + 6) = a1;
    *((_QWORD *)qword_140089090 + v10 + 7) = v5;
    *((_QWORD *)qword_140089090 + v10 + 8) = v7;
  }
