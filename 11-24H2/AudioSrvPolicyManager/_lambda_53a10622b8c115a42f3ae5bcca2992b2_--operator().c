/*
 * XREFs of _lambda_53a10622b8c115a42f3ae5bcca2992b2_::operator() @ 0x1800486A4
 * Callers:
 *     ?Initialize@AssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@MEAA_NXZ @ 0x180048970 (-Initialize@AssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@MEAA_NXZ.c)
 * Callees:
