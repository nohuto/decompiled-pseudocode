/*
 * XREFs of ??$?4U?$default_delete@UMEDIAMANAGER_NOTIFICATION_BLOCK@@@std@@$0A@@?$unique_ptr@UMEDIAMANAGER_NOTIFICATION_BLOCK@@U?$default_delete@UMEDIAMANAGER_NOTIFICATION_BLOCK@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x18003C99C
 * Callers:
