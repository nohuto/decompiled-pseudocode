/*
 * XREFs of ?ReadBackgroundAudioPlaybackCapability@CApplicationManager@@QEAAJPEAXPEAH1@Z @ 0x1800389AC
 * Callers:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, v6);
  }
  if ( (_BYTE)v9 )
  {
    *a3 = 1;
