/*
 * XREFs of ?ReadUserSigninSupportCapability@CApplicationManager@@QEAAJPEAXPEAH@Z @ 0x180038C6C
 * Callers:
...
__int64 __fastcall CApplicationManager::ReadUserSigninSupportCapability(CApplicationManager *this, void *a2, int *a3)
{
  ...
  *a3 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x17u, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, v5);
  }
