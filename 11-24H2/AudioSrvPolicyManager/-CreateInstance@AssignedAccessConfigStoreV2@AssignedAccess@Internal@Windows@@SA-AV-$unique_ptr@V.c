/*
 * XREFs of ?CreateInstance@AssignedAccessConfigStoreV2@AssignedAccess@Internal@Windows@@SA?AV?$unique_ptr@VAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@U?$default_delete@VAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@@wistd@@@wistd@@XZ @ 0x18001CCF0
 * Callers:
...
__int64 __fastcall Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::CreateInstance(__int64 a1)
{
  ...
  v2[2] = 0LL;
  v2[3] = 0LL;
  *v2 = &Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::`vftable';
  v4 = (unsigned __int8 (*)(void))*(&Windows::Internal::AssignedAccess::AssignedAccessConfigStoreV2::`vftable' + 5);
...
LABEL_5:
  ...
  wistd::unique_ptr<void,wil::process_heap_deleter>::unique_ptr<void,wil::process_heap_deleter>(a1, &v6);
  if ( v6 )
    (**v6)(v6, 1LL);
  return a1;
}
