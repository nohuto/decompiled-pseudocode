/*
 * XREFs of ??1?$vector@ULockedListEntry@?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@V?$allocator@ULockedListEntry@?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@@std@@@std@@QEAA@XZ @ 0x180028584
 * Callers:
 *     _CLockedList_UniqueValuesOnly_CDuckingNotification_0_::ForEachEntry_::_1_::dtor$0 @ 0x18004A7EA (_CLockedList_UniqueValuesOnly_CDuckingNotification_0_--ForEachEntry_--_1_--dtor$0.c)
 * Callees:
