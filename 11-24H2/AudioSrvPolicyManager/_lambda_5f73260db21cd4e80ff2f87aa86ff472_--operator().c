/*
 * XREFs of _lambda_5f73260db21cd4e80ff2f87aa86ff472_::operator() @ 0x18002C714
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_5f73260db21cd4e80ff2f87aa86ff472__long_IAudioSessionInfo___::_Do_call @ 0x18002EC90 (std--_Func_impl_no_alloc__lambda_5f73260db21cd4e80ff2f87aa86ff472__long_IAudioSessionInfo___--_D.c)
 * Callees:
 ...
 *     ??$static_pointer_cast@UIDuckingDescriptor@@VDeactivatableDuckingDescriptor@@@std@@YA?AV?$shared_ptr@UIDuckingDescriptor@@@0@AEBV?$shared_ptr@VDeactivatableDuckingDescriptor@@@0@@Z @ 0x18001E65C (--$static_pointer_cast@UIDuckingDescriptor@@VDeactivatableDuckingDescriptor@@@std@@YA-AV-$shared.c)
 *     ??1?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18001F9D8 (--1-$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
        ...
        int (__fastcall ***a2)(__int64, GUID *, __int64 *))
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    ...
    v26 = v7;
    v27 = 0;
    tlgWriteTransfer_EventWriteTransfer((__int64)v4, byte_180057ACA, 0LL, 0LL, 3u, &v24);
  }
  v8 = *a2;
  v20 = 0LL;
