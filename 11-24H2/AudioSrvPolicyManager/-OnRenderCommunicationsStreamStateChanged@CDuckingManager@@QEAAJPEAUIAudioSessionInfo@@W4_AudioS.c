/*
 * XREFs of ?OnRenderCommunicationsStreamStateChanged@CDuckingManager@@QEAAJPEAUIAudioSessionInfo@@W4_AudioStreamState@@1PEAUIAudioStreamInfo@@@Z @ 0x18002E050
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( a4 != 1 )
  {
    ...
    std::wstring::wstring((__int64)&v27, v14);
    ...
    v16 = wil::com_ptr_t<IAudioStreamInfo,wil::err_returncode_policy>::com_ptr_t<IAudioStreamInfo,wil::err_returncode_policy>(
            &v21,
            a2);
    v17 = *v16;
    *v16 = 0LL;
    ...
    lambda_aa732a8a991b7eb0f1632fe44cffa677_::__lambda_aa732a8a991b7eb0f1632fe44cffa677_(&v27);
  ...
  EnterCriticalSection((LPCRITICAL_SECTION)((char *)v6 + 136));
  v20 = (struct _RTL_CRITICAL_SECTION *)((char *)v6 + 136);
  std::wstring::wstring((__int64)&v27, v8);
  ...
  if ( *((_DWORD *)v6 + 92) != 3 )
  {
    v20 = 0LL;
    wil::try_com_query_to<IDuckingController,IAudioStreamInfo * &>(&v21, (__int64)&v20);
    v10 = wil::com_ptr_t<IAudioStreamInfo,wil::err_returncode_policy>::com_ptr_t<IAudioStreamInfo,wil::err_returncode_policy>(
            &v21,
            a2);
    v11 = *v10;
    *v10 = 0LL;
    ...
    wil::com_ptr_t<IAudioSessionPolicyControl,wil::err_returncode_policy>::~com_ptr_t<IAudioSessionPolicyControl,wil::err_returncode_policy>(&v21);
LABEL_9:
    wil::com_ptr_t<IAudioSessionPolicyControl,wil::err_returncode_policy>::~com_ptr_t<IAudioSessionPolicyControl,wil::err_returncode_policy>((__int64 *)&v20);
  }
  return 0LL;
}
