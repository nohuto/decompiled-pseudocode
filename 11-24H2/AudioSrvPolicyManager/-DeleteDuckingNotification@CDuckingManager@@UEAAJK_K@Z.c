/*
 * XREFs of ?DeleteDuckingNotification@CDuckingManager@@UEAAJK_K@Z @ 0x18002D1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDuckingManager::DeleteDuckingNotification(CDuckingManager *this, __int64 a2, unsigned __int64 a3)
{
  ...
  try
  {
    ...
    v14[0] = v7;
    v14[1] = &v12;
    v9 = std::remove_if<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<CLockedList_UniqueValuesOnly<CDuckingNotification,0>::LockedListEntry>>>,_lambda_958c91c43235a8789bf8f41d13e0d823_>(
           &v15,
           *((_QWORD *)this + 13),
           v8,
           (__int64)v14);
