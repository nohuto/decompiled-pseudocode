/*
 * XREFs of ?UpdateEndpointVolume@CApplicationManager@@QEAAJPEBGHMHH@Z @ 0x1800398BC
 * Callers:
 ...
 *     WPP_SF_Sg @ 0x180039FA4 (WPP_SF_Sg.c)
        ...
        int a6)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    {
      v17 = a6;
      WPP_SF_Sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x33u, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, a2, v17);
    }
