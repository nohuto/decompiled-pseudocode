/*
 * XREFs of ??1?$function@$$A6AJPEAG_KPEA_K@Z@wistd@@QEAA@XZ @ 0x18001EE64
 * Callers:
 ...
 *     _wil::details_abi::RawUsageIndex::Iterate_::_1_::dtor$0 @ 0x18004A17C (_wil--details_abi--RawUsageIndex--Iterate_--_1_--dtor$0.c)
 * Callees:
