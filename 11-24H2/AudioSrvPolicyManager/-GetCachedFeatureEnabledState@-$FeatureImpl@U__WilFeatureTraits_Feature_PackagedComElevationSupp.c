/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_PackagedComElevationSupport_v2@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180036A38
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_PackagedComElevationSupport_v2>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *a2 = 0LL;
  v3 = *(_DWORD *)Feature_PackagedComElevationSupport_v2__descriptor;
  *(_DWORD *)a2 = *(_DWORD *)Feature_PackagedComElevationSupport_v2__descriptor;
  if ( (v3 & 6) != 6 )
  {
    v4 = wil::details::EnsureSubscribedToFeatureConfigurationChanges(a1);
    v15 = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_PackagedComElevationSupport_v2>::GetCurrentFeatureEnabledState(
      v6,
      &v16,
      &v15);
    for ( i = *(_DWORD *)a2; ; i = v11 )
    {
      ...
      *(_DWORD *)a2 = i | 0x40000;
      ...
      v11 = _InterlockedCompareExchange(
              (volatile signed __int32 *)Feature_PackagedComElevationSupport_v2__descriptor,
              v10,
              i);
      if ( i == v11 )
        break;
    ...
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        ...
        || (v13[1] = 0,
            v13[0] = 3,
            v14 = Feature_PackagedComElevationSupport_v2__descriptor,
            !wil::details_abi::heap_buffer::push_back((void **)&unk_180063EC8, v13, 0x10uLL)) )
      {
        _InterlockedAnd((volatile signed __int32 *)Feature_PackagedComElevationSupport_v2__descriptor, 0xFFFFFFFB);
      }
