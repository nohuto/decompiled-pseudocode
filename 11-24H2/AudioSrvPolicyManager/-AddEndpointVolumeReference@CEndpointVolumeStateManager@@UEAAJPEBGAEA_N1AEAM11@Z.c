/*
 * XREFs of ?AddEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x180043DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEndpointVolumeStateManager::AddEndpointVolumeReference(
        ...
        bool *a7)
{
  struct IVolumeProvider *v11; // rdi
  float *v12; // r15
  __int64 v13; // rbx
  CEndpointVolumeState **v14; // rbx
  CEndpointVolumeState *v15; // rax
  __int64 v16; // rax
  const unsigned __int16 *v18; // [rsp+20h] [rbp-C8h] BYREF
  CEndpointVolumeState *v19; // [rsp+28h] [rbp-C0h] BYREF
  float *v20; // [rsp+30h] [rbp-B8h]
  bool *v21; // [rsp+38h] [rbp-B0h]
  bool *v22; // [rsp+40h] [rbp-A8h]
  struct IVolumeProvider *v23[3]; // [rsp+48h] [rbp-A0h] BYREF
  __int128 v24; // [rsp+60h] [rbp-88h] BYREF
  __m128i si128; // [rsp+70h] [rbp-78h]
  _OWORD v26[2]; // [rsp+80h] [rbp-68h] BYREF
  CEndpointVolumeState *v27; // [rsp+A0h] [rbp-48h]
  ...
  *a4 = 0;
  *a6 = 0;
  v11 = (CEndpointVolumeStateManager *)((char *)this + 16);
  EnterCriticalSection((LPCRITICAL_SECTION)((char *)this + 16));
  v23[2] = v11;
  v12 = (float *)((char *)this + 56);
  ...
  if ( !v13 )
  {
    v23[0] = *((struct IVolumeProvider **)this + 15);
    v14 = std::make_unique<CEndpointVolumeState,IVolumeProvider *,unsigned short const * &,0>(&v19, v23, &v18);
    std::wstring::wstring((__int64)&v24, (__int64)a2);
    v26[0] = v24;
    v26[1] = si128;
    ...
    *v14 = 0LL;
    v27 = v15;
    std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::emplace<std::pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>>(
      v12,
      (__int64)v23,
      (__int64)v26);
    std::pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>::~pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>((__int64)v26);
    std::wstring::~wstring((__int64)&v24);
    std::unique_ptr<CEndpointVolumeState>::~unique_ptr<CEndpointVolumeState>(&v19);
    *a3 = 1;
    *a4 = 1;
    *v20 = 0.0;
    *v21 = 1;
  ...
  std::wstring::wstring((__int64)&v24, (__int64)a2);
  v16 = std::unordered_map<std::wstring,std::unique_ptr<CEndpointVolumeState>>::at(v12, &v24);
