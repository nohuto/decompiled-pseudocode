/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@IEAAXXZ @ 0x180033EB0
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x1800343C0 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
