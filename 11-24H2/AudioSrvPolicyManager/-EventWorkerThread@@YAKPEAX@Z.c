/*
 * XREFs of ?EventWorkerThread@@YAKPEAX@Z @ 0x18000E0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EventWorkerThread(PVOID Parameter)
{
  ...
  if ( v1 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_f83b1868846b35559e4ca4ac8dd6df44_Traceguids);
        v4 = WPP_GLOBAL_Control;
      }
      if ( v4 != &WPP_GLOBAL_Control && (*((_DWORD *)v4 + 7) & 0x40000000) != 0 && *((_BYTE *)v4 + 25) >= 2u )
        WPP_SF_d(v4[2], 11LL, &WPP_f83b1868846b35559e4ca4ac8dd6df44_Traceguids, v1);
    }
    AudPolicyLogError("EventWorkerThread", 145, v1);
    return v1;
  }
  else
  {
