 ...
 *     ?Instance@AudioSrvPolicyManagerTelemetryProvider@@KAPEAV1@XZ @ 0x180016B3C (-Instance@AudioSrvPolicyManagerTelemetryProvider@@KAPEAV1@XZ.c)
 *     __scrt_initialize_thread_safe_statics @ 0x180020760 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     _onexit @ 0x18002061C (_onexit.c)
 */
