/*
 * XREFs of ?GetValueFromSemaphore@SemaphoreValue@details_abi@wil@@CAJPEAXPEAJ@Z @ 0x180023B90
 * Callers:
...
__int64 __fastcall wil::details_abi::SemaphoreValue::GetValueFromSemaphore(HANDLE hHandle, int *a2)
{
  ...
  {
    v6 = 153LL;
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)v6, (int)"wil", v5);
  }
  if ( !v4 || v4 == 258 )
  {
    PreviousCount = 0;
  ...
  v8 = 154LL;
LABEL_25:
  wil::details::in1diag3::Return_Hr(retaddr, (void *)v8, (int)"wil", (const char *)0x8000FFFFLL);
  return 2147549183LL;
}
