/*
 * XREFs of ?CleanupDelayedInteractivityNotification@CApplication@@IEAAJXZ @ 0x180031914
 * Callers:
...
__int64 __fastcall CApplication::CleanupDelayedInteractivityNotification(const wchar_t **this)
{
  ...
  if ( this[67] )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x19u, &WPP_b18b59d12697333a0d06d17b7897f64c_Traceguids, this[3]);
    }
