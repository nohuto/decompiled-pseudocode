/*
 * XREFs of ?OnPoStandbyAudioRequestReceived@CWindowsPolicyManager@@UEAAJ_N@Z @ 0x180029820
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a2)
{
  ...
  if ( (a2 ^ 1) != g_PoBlockAudioPlayback )
  {
    ...
    if ( *(_DWORD *)v3 > 4u )
    {
      ...
      v13 = 4;
      v10 = 1;
      tlgWriteTransfer_EventWriteTransfer((__int64)v3, byte_180057764, 0LL, 0LL, 4u, &v8);
    }
