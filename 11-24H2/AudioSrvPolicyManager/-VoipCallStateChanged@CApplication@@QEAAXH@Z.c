/*
 * XREFs of ?VoipCallStateChanged@CApplication@@QEAAXH@Z @ 0x180034D48
 * Callers:
 ...
 *     WPP_SF_dd @ 0x180035BE8 (WPP_SF_dd.c)
 */
  ...
  *((_DWORD *)this + 169) = v5;
  ...
  else
  {
    if ( v6 != &WPP_GLOBAL_Control && (*((_DWORD *)v6 + 7) & 0x40000000) != 0 && *((_BYTE *)v6 + 25) >= 2u )
      WPP_SF_((TRACEHANDLE)v6[2], 0x22u, &WPP_b18b59d12697333a0d06d17b7897f64c_Traceguids);
    *((_DWORD *)this + 169) = 0;
  }
  *((_DWORD *)this + 52) &= ~0x10u;
LABEL_12:
