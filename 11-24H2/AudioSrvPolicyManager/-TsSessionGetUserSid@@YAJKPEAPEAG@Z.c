/*
 * XREFs of ?TsSessionGetUserSid@@YAJKPEAPEAG@Z @ 0x18003F2C8
 * Callers:
 ...
 *     ?GetUserSid@CWindowsPolicyManager@@UEAAJKPEAPEAG@Z @ 0x180028DE0 (-GetUserSid@CWindowsPolicyManager@@UEAAJKPEAPEAG@Z.c)
 * Callees:
