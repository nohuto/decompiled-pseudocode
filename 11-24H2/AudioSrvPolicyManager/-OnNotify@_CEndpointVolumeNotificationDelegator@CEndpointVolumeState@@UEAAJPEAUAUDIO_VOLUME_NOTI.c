/*
 * XREFs of ?OnNotify@_CEndpointVolumeNotificationDelegator@CEndpointVolumeState@@UEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x180044030
 * Callers:
 *     <none>
 * Callees:
 *     _o_log10_0 @ 0x180021248 (_o_log10_0.c)
 */
