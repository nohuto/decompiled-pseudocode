/*
 * XREFs of ??$_Construct_in_place@VDuckingDescriptor@@AEAMAEA_JAEA_NAEAW4EndpointApplicability@@@std@@YAXAEAVDuckingDescriptor@@AEAMAEA_JAEA_NAEAW4EndpointApplicability@@@Z @ 0x18003CAD4
 * Callers:
