/*
 * XREFs of ?MuteAllAppsInSession@CApplicationManager@@QEAAXK@Z @ 0x1800380FC
 * Callers:
...
void __fastcall CApplicationManager::MuteAllAppsInSession(CApplicationManager *this, int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x25u, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, a2);
  }
