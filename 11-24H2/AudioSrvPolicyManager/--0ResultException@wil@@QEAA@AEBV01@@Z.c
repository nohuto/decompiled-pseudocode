/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x1800224D8
 * Callers:
 *     <none>
 * Callees:
 *     ??0exception@std@@QEAA@AEBV01@@Z @ 0x18002262C (--0exception@std@@QEAA@AEBV01@@Z.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180026B0C (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
