/*
 * XREFs of ?reset@?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?ReleaseMutex@details@wil@@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x180026D74
 * Callers:
 ...
 *     ?ReleaseMutex@details@wil@@YAXPEAX@Z @ 0x180025440 (-ReleaseMutex@details@wil@@YAXPEAX@Z.c)
 */
