/*
 * XREFs of ?LoadPropertyStore@CAudioSessionPropertyStore@@AEAAJXZ @ 0x180016BF0
 * Callers:
 ...
 *     ?Create@?$CComSafeArray@M$03@ATL@@QEAAJKJ@Z @ 0x1800427A0 (-Create@-$CComSafeArray@M$03@ATL@@QEAAJKJ@Z.c)
 *     ?SetAt@?$CComSafeArray@M$03@ATL@@QEAAJJAEBMH@Z @ 0x180043200 (-SetAt@-$CComSafeArray@M$03@ATL@@QEAAJJAEBMH@Z.c)
 *     ?StringCbLengthA@@YAJPEBD_KPEA_K@Z @ 0x18004327C (-StringCbLengthA@@YAJPEBD_KPEA_K@Z.c)
