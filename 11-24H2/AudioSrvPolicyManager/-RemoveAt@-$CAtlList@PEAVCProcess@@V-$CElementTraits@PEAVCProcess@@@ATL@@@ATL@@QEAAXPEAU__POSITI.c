/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCProcess@@V?$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x180033C50
 * Callers:
...
__int64 __fastcall ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::RemoveAt(__int64 *a1, __int64 *a2)
{
  ...
  *a1 = *a2;
  ...
  if ( a2 == *(__int64 **)(v2 + 8) )
    ...
    *(_QWORD *)(*a2 + 8) = v3;
  return ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::FreeNode(v2, a2);
}
