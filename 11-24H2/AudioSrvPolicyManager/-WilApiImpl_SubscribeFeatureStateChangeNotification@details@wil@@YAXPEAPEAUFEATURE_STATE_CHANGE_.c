/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800265E0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( wil::details::g_featureStateManager )
    {
                             ...
                             &qword_180063118)) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_1800630D0,
          this,
          (void (*)(void *))a2,
          a3);
      }
