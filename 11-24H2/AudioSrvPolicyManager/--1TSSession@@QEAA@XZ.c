/*
 * XREFs of ??1TSSession@@QEAA@XZ @ 0x18003D610
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18003D580 (--1-$unique_storage@U-$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1-WTSFreeMemory@@YAX0@ZU-$integ.c)
 *     ??1CStreamClassPolicyGainsWrapper@@QEAA@XZ @ 0x18003D5B0 (--1CStreamClassPolicyGainsWrapper@@QEAA@XZ.c)
 *     ?UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ @ 0x180040B34 (-UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ.c)
 */
