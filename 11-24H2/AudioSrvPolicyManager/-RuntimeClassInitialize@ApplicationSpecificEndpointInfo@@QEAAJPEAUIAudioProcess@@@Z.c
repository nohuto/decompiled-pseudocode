/*
 * XREFs of ?RuntimeClassInitialize@ApplicationSpecificEndpointInfo@@QEAAJPEAUIAudioProcess@@@Z @ 0x180045FF0
 * Callers:
...
__int64 __fastcall ApplicationSpecificEndpointInfo::RuntimeClassInitialize(void **this, struct IAudioProcess *a2)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    v16 = _AllocStringWorker<CTCoAllocPolicy>(v15, v14, ApplicationName, v8, v20, (char **)this + 10);
    v17 = v16;
    if ( v16 >= 0 )
    {
      ...
      {
        ApplicationSpecificEndpointInfo::LoadApplicationDefaultEndpoints((ApplicationSpecificEndpointInfo *)this);
        RpcRevertToSelf();
        return 0LL;
      }
    }
