/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Flist_node@V?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18001D930
 * Callers:
 ...
 *     _TsSessionIdAddNotify_::_1_::dtor$13 @ 0x180048E62 (_TsSessionIdAddNotify_--_1_--dtor$13.c)
 *     _CStreamClassPolicyGains::UpdateStreamClassGainStage_::_1_::dtor$14 @ 0x180049410 (_CStreamClassPolicyGains--UpdateStreamClassGainStage_--_1_--dtor$14.c)
 *     _CStreamClassPolicyGains::UpdateStreamClassGainStage_::_1_::dtor$19 @ 0x180049450 (_CStreamClassPolicyGains--UpdateStreamClassGainStage_--_1_--dtor$19.c)
 *     _std::forward_list_std::unique_ptr_DuckingDescriptorAndId_std::default_delete_DuckingDescriptorAndId____std::allocator_std::unique_ptr_DuckingDescriptorAndId_std::default_delete_DuckingDescriptorAndId_______::emplace_after_std::unique_ptr_DuckingDescriptorAndId_std::default_delete_DuckingDescriptorAndId______::_1_::dtor$0 @ 0x18004AB26 (_std--forward_list_std--unique_ptr_DuckingDescriptorAndId_std--default_delete_DuckingDescriptorA.c)
 * Callees:
