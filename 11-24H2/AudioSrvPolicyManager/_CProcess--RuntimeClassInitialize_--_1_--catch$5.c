/*
 * XREFs of _CProcess::RuntimeClassInitialize_::_1_::catch$5 @ 0x180049C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::RuntimeClassInitialize_::_1_::catch_5(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
