        ...
        __int64 a3)
{
  ...
  if ( a2 != a3 )
  {
    ...
    v21 = a1 + 1;
    v22 = v5;
    v8 = std::_Uhash_compare<void *,std::hash<void *>,std::equal_to<void *>>::operator()<void *>((__int64)a1, a2 + 16);
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v7 + 8 * v11 + 8) = v5; ; *(_QWORD *)(v7 + 8 * v11 + 8) = v6 )
    {
      ...
      if ( v23 == a3 )
        break;
      v18 = std::_Uhash_compare<void *,std::hash<void *>,std::equal_to<void *>>::operator()<void *>(v15, v23 + 16);
      v11 = 2 * (a1[6] & v18);
