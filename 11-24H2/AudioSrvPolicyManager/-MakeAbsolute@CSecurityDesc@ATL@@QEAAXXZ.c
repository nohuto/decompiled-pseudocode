/*
 * XREFs of ?MakeAbsolute@CSecurityDesc@ATL@@QEAAXXZ @ 0x180046F6C
 * Callers:
 ...
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x18001F874 (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
