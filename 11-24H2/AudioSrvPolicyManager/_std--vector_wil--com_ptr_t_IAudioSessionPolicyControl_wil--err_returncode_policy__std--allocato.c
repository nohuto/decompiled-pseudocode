/*
 * XREFs of _std::vector_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy__const_&__::_1_::catch$0 @ 0x18004AAC8
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@V?$com_ptr_t@UIAudioSessionPolicyControl@@Uerr_returncode_policy@wil@@@wil@@@std@@QEAAXQEAV?$com_ptr_t@UIAudioSessionPolicyControl@@Uerr_returncode_policy@wil@@@wil@@_K@Z @ 0x1800358C4 (-deallocate@-$allocator@V-$com_ptr_t@UIAudioSessionPolicyControl@@Uerr_returncode_policy@wil@@@w.c)
