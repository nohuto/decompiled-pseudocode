/*
 * XREFs of ?GetApplication@CApplicationManager@@QEAAJPEBG_KKPEAPEAVCApplication@@HPEAH@Z @ 0x180003C10
 * Callers:
...
LABEL_9:
    ...
    if ( v10 < 0 )
    {
      ...
      AudPolicyLogError("CApplicationManager::GetApplication", 1420, v10);
    }
    if ( v13 )
...
LABEL_35:
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 26LL, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, v18);
  }
  v12 = v21;
  goto LABEL_8;
}
