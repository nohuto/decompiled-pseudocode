/*
 * XREFs of ?ForceSoundLevelNotification@CApplication@@IEAAXXZ @ 0x180031F68
 * Callers:
...
void __fastcall CApplication::ForceSoundLevelNotification(struct _RTL_CRITICAL_SECTION *this)
{
