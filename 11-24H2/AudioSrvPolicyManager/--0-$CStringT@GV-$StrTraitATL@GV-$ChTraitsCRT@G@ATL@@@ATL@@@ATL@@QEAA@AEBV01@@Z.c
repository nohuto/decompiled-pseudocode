/*
 * XREFs of ??0?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAA@AEBV01@@Z @ 0x18001E978
 * Callers:
...
_QWORD *__fastcall ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>(
        ...
        _QWORD *a2)
{
  *a1 = ATL::CSimpleStringT<unsigned short,0>::CloneData((volatile signed __int32 *)(*a2 - 24LL)) + 6;
  return a1;
}
