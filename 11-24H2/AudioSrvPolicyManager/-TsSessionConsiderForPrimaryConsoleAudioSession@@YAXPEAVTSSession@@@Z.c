/*
 * XREFs of ?TsSessionConsiderForPrimaryConsoleAudioSession@@YAXPEAVTSSession@@@Z @ 0x18003EC1C
 * Callers:
 ...
 *     ?TsSessionLogonConnectTime@@YA_JPEAVTSSession@@@Z @ 0x180040288 (-TsSessionLogonConnectTime@@YA_JPEAVTSSession@@@Z.c)
...
void __fastcall TsSessionConsiderForPrimaryConsoleAudioSession(struct TSSession *a1)
{
  ...
  if ( !*((_DWORD *)a1 + 1) && *(_DWORD *)a1 )
  {
    ...
    for ( i = *(__int64 **)qword_180064AA8; i != (__int64 *)qword_180064AA8; i = (__int64 *)*i )
    {
      v5 = (_DWORD *)i[3];
      if ( *v5 != (_DWORD)v2 && v5[278] != (_DWORD)v2 )
      {
        if ( i != (__int64 *)qword_180064AA8 )
