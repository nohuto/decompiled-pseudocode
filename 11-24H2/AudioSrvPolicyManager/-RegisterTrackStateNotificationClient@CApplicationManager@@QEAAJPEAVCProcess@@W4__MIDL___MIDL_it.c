/*
 * XREFs of ?RegisterTrackStateNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0003@@@Z @ 0x180039018
 * Callers:
        ...
        int a3)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xDu, &WPP_8d4f0c2ae8213c98c7518ad68b13e68c_Traceguids, v7);
    }
    AudPolicyLogError("CApplicationManager::RegisterTrackStateNotificationClient", 542, v7);
  }
  else
  {
