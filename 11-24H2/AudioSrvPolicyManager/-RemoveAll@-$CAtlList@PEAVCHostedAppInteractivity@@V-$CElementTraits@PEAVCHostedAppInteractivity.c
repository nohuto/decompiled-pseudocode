/*
 * XREFs of ?RemoveAll@?$CAtlList@PEAVCHostedAppInteractivity@@V?$CElementTraits@PEAVCHostedAppInteractivity@@@ATL@@@ATL@@QEAAXXZ @ 0x18001EF54
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__s_HostedAppInteractivityManager__ @ 0x18004B9B0 (_dynamic_atexit_destructor_for__s_HostedAppInteractivityManager__.c)
 * Callees:
