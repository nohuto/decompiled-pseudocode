/*
 * XREFs of ??$_Allocate_at_least_helper@V?$allocator@PEAUIAudioAppVolumePolicyChange@@@std@@@std@@YAPEAPEAUIAudioAppVolumePolicyChange@@AEAV?$allocator@PEAUIAudioAppVolumePolicyChange@@@0@AEA_K@Z @ 0x18002FDC4
 * Callers:
