/*
 * XREFs of ?RuntimeClassInitialize@CDuckingManager@@QEAAJXZ @ 0x18002E5CC
 * Callers:
 ...
 *     ?GetdBFromUserPreference@CDuckingManager@@CAMW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@@Z @ 0x180014C50 (-GetdBFromUserPreference@CDuckingManager@@CAMW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@@Z.c)
 ...
 *     ??$make_shared@VDuckingDescriptor@@MHH@std@@YA?AV?$shared_ptr@VDuckingDescriptor@@@0@$$QEAM$$QEAH1@Z @ 0x18002BEE8 (--$make_shared@VDuckingDescriptor@@MHH@std@@YA-AV-$shared_ptr@VDuckingDescriptor@@@0@$$QEAM$$QEA.c)
 *     ??$make_unique@VDuckingDescriptor@@MHH$0A@@std@@YA?AV?$unique_ptr@VDuckingDescriptor@@U?$default_delete@VDuckingDescriptor@@@std@@@0@$$QEAM$$QEAH1@Z @ 0x18002BF74 (--$make_unique@VDuckingDescriptor@@MHH$0A@@std@@YA-AV-$unique_ptr@VDuckingDescriptor@@U-$default.c)
...
__int64 __fastcall CDuckingManager::RuntimeClassInitialize(CDuckingManager *this)
{
  ...
  v10 = 0;
  v11 = 10000000;
  v12 = CDuckingManager::GetdBFromUserPreference(*((_DWORD *)this + 92));
  ...
  *v3 = 0LL;
  v3[1] = 0LL;
  *((_QWORD *)this + 49) = v4;
  v6 = (std::_Ref_count_base *)*((_QWORD *)this + 50);
  *((_QWORD *)this + 50) = v5;
  if ( v6 )
