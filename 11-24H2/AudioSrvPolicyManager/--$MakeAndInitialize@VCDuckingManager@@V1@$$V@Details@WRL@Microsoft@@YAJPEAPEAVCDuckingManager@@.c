/*
 * XREFs of ??$MakeAndInitialize@VCDuckingManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCDuckingManager@@@Z @ 0x1800279F8
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<CDuckingManager,CDuckingManager,>(CDuckingManager **a1)
{
  ...
  *a1 = 0LL;
  v2 = operator new(0x1A0uLL, (const struct std::nothrow_t *)&std::nothrow);
  v7 = v2;
  v8 = v2;
  if ( v2 )
  {
