/*
 * XREFs of ?DestroyPickerHostContext@PickerHostContextManager@@YAXPEAVCPickerHostContext@@@Z @ 0x18003A3C8
 * Callers:
 *     ?HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z @ 0x18003AC40 (-HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     ?Find@?$CAtlList@PEAVCPickerHostContext@@V?$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@QEBAPEAU__POSITION@@AEBQEAVCPickerHostContext@@PEAU3@@Z @ 0x1800178E0 (-Find@-$CAtlList@PEAVCPickerHostContext@@V-$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@Q.c)
        ...
        struct CPickerHostContext *a2)
{
  ...
  if ( v4 )
  {
    if ( v4 == (__int64 *)PickerHostContextManager::s_PickerHostContextList )
      ...
      *(_QWORD *)v4[1] = *v4;
    if ( v4 == (__int64 *)qword_180063F00 )
      qword_180063F00 = v4[1];
    else
      *(_QWORD *)(*v4 + 8) = v4[1];
