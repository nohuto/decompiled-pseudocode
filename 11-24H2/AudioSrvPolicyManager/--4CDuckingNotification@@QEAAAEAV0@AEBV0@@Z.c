/*
 * XREFs of ??4CDuckingNotification@@QEAAAEAV0@AEBV0@@Z @ 0x18002C3FC
 * Callers:
...
__int64 __fastcall CDuckingNotification::operator=(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 8) = *(_DWORD *)(a2 + 8);
  if ( a1 + 16 != a2 + 16 )
  {
    v4 = std::_String_val<std::_Simple_types<unsigned short>>::_Myptr(a2 + 16);
    std::wstring::assign(v6, v4, *(_QWORD *)(v5 + 16));
  }
  v7 = *(_QWORD *)(a2 + 48);
  v8 = *(_QWORD *)(a1 + 48);
  *(_QWORD *)(a1 + 48) = v7;
  if ( v7 )
    Microsoft::WRL::Details::SafeUnknownIncrementReference((Microsoft::WRL::Details *)(v7 + 12), (volatile int *)a2);
  if ( v8 )
