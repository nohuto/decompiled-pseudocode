/*
 * XREFs of ?QueueHostedAppInteractivityChangedWorkItem@CHostedAppInteractivityManager@@AEAAJPEBG_KKH@Z @ 0x18001C73C
 * Callers:
        ...
        int a5)
{
  ...
  const unsigned __int16 *v21; // [rsp+78h] [rbp+10h] BYREF
