/*
 * XREFs of _lambda_b2025209d5eaef5f99f9deda65cc799e_::operator() @ 0x18003DB6C
 * Callers:
 ...
 *     ??1?$out_param_t@V?$unique_ptr@$$BY0A@U_WTS_SESSION_INFOW@@U?$function_deleter@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@Z@wil@@@wistd@@@details@wil@@QEAA@XZ @ 0x18003D464 (--1-$out_param_t@V-$unique_ptr@$$BY0A@U_WTS_SESSION_INFOW@@U-$function_deleter@P6AXPEAX@Z$1-WTSF.c)
