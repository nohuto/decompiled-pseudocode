/*
 * XREFs of Windows::Internal::AssignedAccess::AssignedAccessConfigStoreHelper::FindIf__lambda_e4f37fdae08429a84761ade0db4bdd38___ @ 0x180015204
 * Callers:
...
LABEL_16:
  ...
  if ( v11 )
  {
    ...
    {
      v8 = *v7;
      if ( *(_DWORD *)(*a2 + 24LL) <= (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)*v7 + 32LL))(*v7)
        && (*(unsigned __int8 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v8 + 8LL))(v8, a2[1]) )
      {
        if ( v5 )
          (**v5)(v5, 1LL);
        if ( v4 )
