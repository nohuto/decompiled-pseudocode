/*
 * XREFs of ?TsSessionIdAddNotify@@YAJKKPEAPEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x180003760
 * Callers:
...
__int64 __fastcall TsSessionIdAddNotify(DWORD a1, int a2, struct AUDIOPROTOCOLNOTIFY **a3)
{
  ...
  try
  {
    ...
    if ( v7 )
    {
      ...
      v11 = 2 * (qword_180064AD0 & v9);
      v12 = *(_QWORD *)(qword_180064AB8 + 8 * v11 + 8);
      if ( v12 == qword_180064AA8 )
      {
LABEL_10:
        v12 = 0LL;
      }
      else
      {
        ...
        {
          if ( v12 == *(_QWORD *)(qword_180064AB8 + 8 * v11) )
            goto LABEL_10;
          v12 = *(_QWORD *)(v12 + 8);
        }
      }
