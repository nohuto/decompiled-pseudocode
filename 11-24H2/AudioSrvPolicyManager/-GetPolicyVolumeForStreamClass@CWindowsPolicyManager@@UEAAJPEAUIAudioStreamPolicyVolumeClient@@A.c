/*
 * XREFs of ?GetPolicyVolumeForStreamClass@CWindowsPolicyManager@@UEAAJPEAUIAudioStreamPolicyVolumeClient@@AEAUStreamCategoryPolicyVolumes@@@Z @ 0x180015A90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_32:
  ...
  v18 = 2 * (qword_180064AD0 & v16);
  v19 = *(_QWORD *)(qword_180064AB8 + 8 * v18 + 8);
  if ( v19 == qword_180064AA8 )
  {
LABEL_19:
    v19 = 0LL;
  }
  else
  {
    ...
    {
      if ( v19 == *(_QWORD *)(qword_180064AB8 + 8 * v18) )
        goto LABEL_19;
      v19 = *(_QWORD *)(v19 + 8);
    }
  }
