/*
 * XREFs of ??1?$ComPtr@VCProcess@@@WRL@Microsoft@@QEAA@XZ @ 0x1800363F8
 * Callers:
 *     _CApplicationManager::RpcGetProcess_::_1_::dtor$202 @ 0x180049300 (_CApplicationManager--RpcGetProcess_--_1_--dtor$202.c)
 * Callees:
