/*
 * XREFs of _vscwprintf @ 0x180021380
 * Callers:
 ...
 * Callees:
 *     __local_stdio_printf_options @ 0x18001FDA4 (__local_stdio_printf_options.c)
 *     _o___stdio_common_vswprintf_0 @ 0x18002117A (_o___stdio_common_vswprintf_0.c)
 */
