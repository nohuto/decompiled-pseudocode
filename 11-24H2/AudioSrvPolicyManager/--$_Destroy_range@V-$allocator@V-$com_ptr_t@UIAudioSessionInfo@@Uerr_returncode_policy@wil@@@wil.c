/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@YAXPEAV?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@QEAV12@AEAV?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@0@@Z @ 0x18002FDE4
 * Callers:
 ...
 *     ??$_Uninitialized_move@PEAV?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@YAPEAV?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@QEAV12@0PEAV12@AEAV?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@0@@Z @ 0x180030130 (--$_Uninitialized_move@PEAV-$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V-$.c)
 *     ??1?$vector@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180030708 (--1-$vector@V-$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$c.c)
 *     ?_Change_array@?$vector@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEAAXQEAV?$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@_K1@Z @ 0x180034E8C (-_Change_array@-$vector@V-$com_ptr_t@UIAudioSessionInfo@@Uerr_returncode_policy@wil@@@wil@@V-$al.c)
 *     _std::vector_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IAudioSessionPolicyControl_wil::err_returncode_policy__const_&__::_1_::catch$0 @ 0x18004AAC8 (_std--vector_wil--com_ptr_t_IAudioSessionPolicyControl_wil--err_returncode_policy__std--allocato.c)
 * Callees:
