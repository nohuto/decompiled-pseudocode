        ...
        unsigned __int64 a2)
{
  ...
  while ( v9 != (_QWORD *)v4 )
  {
    v10 = (_QWORD *)*v10;
    v11 = (__int64)(v9 + 2);
    v12 = std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>::operator()<std::wstring>(
            (__int64)v8,
            (__int64)(v9 + 2));
    v14 = *v5;
    v15 = 2 * (a1[6] & v12);
    if ( *(_QWORD *)(*v5 + 16 * (a1[6] & v12)) == v4 )
    {
      *(_QWORD *)(v14 + 16 * (a1[6] & v12)) = v13;
      *(_QWORD *)(v14 + 8 * v15 + 8) = v13;
    }
    else
    {
      v16 = *(_QWORD **)(v14 + 16 * (a1[6] & v12) + 8);
...
LABEL_16:
  ...
  v28 = 0LL;
  return std::_Hash<std::_Umap_traits<std::wstring,CRenderEndpointDuckingManagerContext,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,CRenderEndpointDuckingManagerContext>>,0>>::_Clear_guard::~_Clear_guard(&v28);
}
