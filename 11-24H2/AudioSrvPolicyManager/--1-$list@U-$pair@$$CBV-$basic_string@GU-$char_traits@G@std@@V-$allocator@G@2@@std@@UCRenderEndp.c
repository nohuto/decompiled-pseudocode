/*
 * XREFs of ??1?$list@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@UCRenderEndpointDuckingManagerContext@@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@UCRenderEndpointDuckingManagerContext@@@std@@@2@@std@@QEAA@XZ @ 0x180028534
 * Callers:
 *     _CDuckingManager::CDuckingManager_::_1_::dtor$12 @ 0x18004A51C (_CDuckingManager--CDuckingManager_--_1_--dtor$12.c)
 * Callees:
