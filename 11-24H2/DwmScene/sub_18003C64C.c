/*
 * XREFs of sub_18003C64C @ 0x18003C64C
 * Callers:
...
__m128 __fastcall sub_18003C64C(double a1, double a2, double a3)
{
  __m128 v3; // xmm4
  __m128 v4; // xmm6
  __m128 v5; // xmm5
  ...
  v7 = _mm_mul_ps(v6, (__m128)xmmword_1800FA110);
  v8 = _mm_shuffle_ps(*(__m128 *)&a1, *(__m128 *)&a1, 0);
  v9 = _mm_cmple_ps(v6, (__m128)xmmword_1800F8190);
  v10 = _mm_cmple_ps(_mm_add_ps(v3, v8), (__m128)xmmword_1800F8190);
  v11 = _mm_cmple_ps(_mm_sub_ps(v3, v8), (__m128)xmmword_1800F8190);
  v12 = _mm_add_ps(
          _mm_add_ps(_mm_add_ps(_mm_mul_ps(v8, (__m128)xmmword_1800FA120), (__m128)xmmword_1800F8180), v7),
          _mm_mul_ps((__m128)xmmword_1800FA130, v3));
