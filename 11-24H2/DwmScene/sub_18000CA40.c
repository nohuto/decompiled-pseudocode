/*
 * XREFs of sub_18000CA40 @ 0x18000CA40
 * Callers:
...
void __fastcall sub_18000CA40(_DWORD *a1)
{
  ...
  *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex) + 16LL) = dword_1801C3BD0;
LABEL_7:
