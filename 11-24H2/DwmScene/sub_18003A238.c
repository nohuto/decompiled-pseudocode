/*
 * XREFs of sub_18003A238 @ 0x18003A238
 * Callers:
 ...
 *     copysignf @ 0x1800D4F94 (copysignf.c)
 */

float *__fastcall sub_18003A238(__int64 a1, float *a2)
{
  float v4; // edi
  __m128 v5; // xmm2
  __m128 v6; // xmm2
