/*
 * XREFs of sub_1800D3854 @ 0x1800D3854
 * Callers:
...
__int64 __fastcall sub_1800D3854(__int64 a1, unsigned int a2, unsigned int a3, unsigned int a4, char a5, __int64 a6)
{
  __int64 v6; // rdx
  __m128 v7; // xmm3
  __int64 v8; // r9
  ...
  if ( a5 )
  {
    ...
    v19.m128_u64[0] = _mm_unpacklo_ps((__m128)v21.m128_u32[0], (__m128)v21.m128_u32[1]).m128_u64[0];
  }
  result = a6;
  v23 = 0LL;
