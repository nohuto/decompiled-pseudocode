...
_QWORD *__fastcall sub_180097544(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 *v6; // rax
  _QWORD *v7; // rax
  __int64 *v8; // rax
  ...
  v32 = 0;
  v33 = 0LL;
  sub_180029814((__int64 *)v34);
  sub_1800974B4(a1 + 928, (__int64)v17);
  sub_1800291FC(v34, (__int64)v34);
  *(_QWORD *)(a1 + 1056) = a2;
  v6 = (__int64 *)sub_1800253E8(*(_QWORD *)(a1 + 912), (__int64)v17, 0);
  sub_18009687C(a1, v6);
  sub_180096820(v17);
  if ( sub_1800969CC(a1) )
  {
  ...
  v8 = (__int64 *)sub_1800253E8(*(_QWORD *)(a1 + 912), (__int64)v17, 2u);
  sub_18009687C(a1 + 704, v8);
  sub_180096820(v17);
  if ( sub_1800969CC(a1 + 704) )
  {
    v9 = unknown_libname_81(v16, a3);
    sub_180096A04(a1 + 704, v9);
  }
  v10 = (__int64 *)sub_1800253E8(*(_QWORD *)(a1 + 912), (__int64)v17, 1u);
  sub_18009687C(a1 + 176, v10);
  sub_180096820(v17);
  if ( sub_1800969CC(a1 + 176) )
  {
    unknown_libname_81(v16, a3);
    v12 = unknown_libname_81(&v35, v11);
    sub_180096A6C(a1 + 176, v12, v13);
  }
  *(_DWORD *)(a1 + 920) = 1;
  result = sub_180011110((_QWORD *)(a1 + 896), a3);
  v15 = a3[1];
  if ( v15 )
    return (_QWORD *)sub_18001060C(v15);
  return result;
}
