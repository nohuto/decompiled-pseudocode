/*
 * XREFs of sub_1800D0EC4 @ 0x1800D0EC4
 * Callers:
...
unsigned __int64 __fastcall sub_1800D0EC4(_QWORD *a1, unsigned __int64 a2)
{
  ...
  while ( v8 != (_QWORD *)v4 )
  {
    v9 = (_QWORD *)*v9;
    v10 = (__int64)(v8 + 2);
    v11 = sub_1800131AC((__int64)(v8 + 2));
