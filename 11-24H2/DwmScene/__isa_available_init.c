/*
 * XREFs of __isa_available_init @ 0x18000BC14
 * Callers:
...
int __cdecl _isa_available_init()
{
  ...
  v14 = _RCX;
  if ( !(v6 ^ 0x756E6547 | v9)
    && ((qword_1801C3B50 = -1LL, v15 = _RAX & 0xFFF3FF0, qword_1801C3B48 = 0x8000LL, v15 == 67264)
     || v15 == 132704
     || v15 == 132720
     || (v16 = (unsigned int)(v15 - 198224), (unsigned int)v16 <= 0x20) && (v17 = 0x100010001LL, _bittest64(&v17, v16))) )
  {
    v18 = dword_1801C3CF4 | 1;
    dword_1801C3CF4 |= 1u;
  }
  else
  {
  ...
  if ( (v14 & 0x100000) != 0 )
  {
    ...
    if ( (v14 & 0x8000000) != 0 && (v14 & 0x10000000) != 0 )
    {
      ...
      if ( (_RAX & 6) == 6 )
      {
        v23 = dword_1801C3B44 | 8;
        dword_1801C3B40 = 3;
        dword_1801C3B44 |= 8u;
        if ( (v5 & 0x20) != 0 )
        {
          dword_1801C3B40 = 5;
          dword_1801C3B44 = v23 | 0x20;
          if ( (v5 & 0xD0030000) == 0xD0030000 && (v25 & 0xE0) == 0xE0 )
          {
            dword_1801C3B44 |= 0x40u;
            dword_1801C3B40 = 6;
          }
        }
      }
