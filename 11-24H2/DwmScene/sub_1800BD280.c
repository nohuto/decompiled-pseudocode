/*
 * XREFs of sub_1800BD280 @ 0x1800BD280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800BD280(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  __int64 result; // rax
  __int64 v10; // rdi
  ...
  if ( v24 )
  {
    *(_DWORD *)(a4 + 36) = 3;
    ...
    v15 = **v23;
    sub_18000E954(&v22);
    v16 = v15(v14, dword_1800F8220, &v22);
    v17 = v16;
    if ( v16 < 0 )
    {
      memset(&pExceptionRecord, 0, sizeof(pExceptionRecord));
    ...
    sub_18000E954(&v22);
    result = sub_18000E954((__int64 *)&v23);
  }
  if ( v25 )
