/*
 * XREFs of sub_1800467DC @ 0x1800467DC
 * Callers:
...
__int64 __fastcall sub_1800467DC(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  unsigned int v4; // eax
  int v5; // r8d
  _QWORD *v6; // rax
  ...
  LOBYTE(a4) = a3;
  return sub_1800468B8(a1, a2, *(unsigned int *)(a1 + 120), a4);
}
