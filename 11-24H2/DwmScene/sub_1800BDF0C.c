/*
 * XREFs of sub_1800BDF0C @ 0x1800BDF0C
 * Callers:
...
__int64 __fastcall sub_1800BDF0C(__int64 a1)
{
  __int64 result; // rax
  __int64 *v3; // r15
  signed int v4; // esi
  ...
  do
  {
    ...
    v5 = sub_180040B74(v3, v30, &v31)[2];
    if ( !*(_BYTE *)(v5 + 25) && v6 >= *(_DWORD *)(v5 + 32) )
    {
      v7 = sub_1800BC4C0(v3, (__int64)v27, &v31);
      result = (__int64)sub_1800BD9EC(a1, &v32, *(_DWORD *)(*(_QWORD *)v7 + 44LL));
      v8 = v32;
      if ( v32 <= 0 )
        break;
      v9 = &v28;
    ...
    result = (__int64)sub_180040B74(v3, v30, &v31);
    v11 = *v3;
    ...
    if ( v15 == v11 )
      break;
    sub_1800BD9EC(a1, &v33, *((_DWORD *)v12 + 11));
    result = (__int64)sub_1800BD9EC(a1, &v34, *(_DWORD *)(v15 + 44));
    if ( v33 <= 0 )
      break;
    result = v34;
    if ( v34 <= 0 )
...
LABEL_27:
    *(_QWORD *)(*(_QWORD *)sub_1800BC3C8((__int64 *)(a1 + 1632), (__int64)v9, &v31) + 40LL) = v8;
    --*(_DWORD *)(a1 + 1592);
    v16 = v4 + 1;
    result = 20 * (v16 / 0x14);
    v4 = v16 % 0x14;
  ...
  if ( *(_QWORD *)(a1 + 1608) > 0x14uLL )
  {
    ...
    v31 = *v17;
    do
      result = (__int64)sub_18001C420(&v31);
    while ( v19 != 1 );
    v20 = v31;
    v31 = v18;
    if ( *(_BYTE *)(v20 + 25) )
    {
      result = sub_1800BC36C(a1 + 1600, a1 + 1600, v17[1]);
      v17[1] = (__int64)v17;
      *v17 = (__int64)v17;
      v17[2] = (__int64)v17;
      *(_QWORD *)(a1 + 1608) = 0LL;
    ...
    else
    {
      ...
      {
        sub_18001C420(&v31);
        v26 = sub_180027298((_QWORD *)(a1 + 1600), v25);
        result = sub_180010234(v26, 0x48uLL);
        v18 = v31;
      }
    }
  }
  ...
  {
    v31 = **(_QWORD **)(a1 + 1616);
    sub_1800BC5AC(&v31, v21 - 20);
    result = sub_1800BEC68(a1 + 1616, &v31, v22, v31);
  }
  v23 = *(_QWORD *)(a1 + 1640);
  if ( v23 > 0x14 )
  {
    v31 = **(_QWORD **)(a1 + 1632);
    sub_1800BC5AC(&v31, v23 - 20);
    return sub_1800BEC68(a1 + 1632, &v31, v24, v31);
  }
  return result;
}
