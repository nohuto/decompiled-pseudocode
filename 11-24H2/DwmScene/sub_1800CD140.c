/*
 * XREFs of sub_1800CD140 @ 0x1800CD140
 * Callers:
 ...
 *     sub_1800CDB00 @ 0x1800CDB00 (sub_1800CDB00.c)
 *     j__guard_dispatch_icall @ 0x1800EB010 (j__guard_dispatch_icall.c)
 */

// Hidden C++ exception states: #wind=8
__int64 __fastcall sub_1800CD140(
...
LABEL_5:
  ...
  v60[0] = _mm_load_si128((const __m128i *)&xmmword_18018D4D0);
  v60[1] = _mm_load_si128((const __m128i *)&xmmword_18018D4C0);
  v61 = 37120;
  v19 = (char *)v60;
  v20 = v54[1];
  do
  ...
  DXGIFactory1 = CreateDXGIFactory1(&stru_18018B450, (void **)&v25->lpVtbl);
  if ( DXGIFactory1 < 0 )
    goto LABEL_5;
  if ( a5 )
  {
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( !v63 || (v59[38] & 2) == 0 )
    {
      ...
      *((_QWORD *)v30 + 6) = *((_QWORD *)v31 + 6);
      if ( !(unsigned __int8)sub_1800CDB00(v58, 0LL, v29, 128LL) )
      {
        if ( v59[34] < 0LL )
        ...
        if ( v33 )
          v48[0] = -8388609;
        sub_1800CCD74(&v57, (__int64)v51, (__int64)v48, (__int64)a2);
      }
    }
    v25 = v47;
  }
  ...
  while ( 1 )
  {
    ...
    v48[0] = 0;
    v47 = 0LL;
    sub_18000E954((__int64 *)&v47);
    sub_18000E954((__int64 *)v51);
    DXGIFactory1 = sub_1800CD960((IDXGIAdapter *)*a2, D3D_DRIVER_TYPE_UNKNOWN, v16, v20 - v16, v46, v51, v48, &v47);
    if ( DXGIFactory1 >= 0 )
      break;
    sub_18000E954(a2);
    sub_18000E954(v36);
...
LABEL_62:
  ...
  DXGIFactory1 = sub_1800B61EC((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))v51, v36);
  if ( DXGIFactory1 < 0
    || (v37 = v53,
        DXGIFactory1 = sub_1800CCB30((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))&v47, v53),
        DXGIFactory1 < 0) )
  {
    sub_18000E954((__int64 *)&v47);
    v41 = (__int64 *)v51;
...
LABEL_86:
  ...
  v50 = 0;
  *(_QWORD *)v48 = 0LL;
  sub_18000E954((__int64 *)v48);
  sub_18000E954((__int64 *)&v49);
  DXGIFactory1 = sub_1800CD960(0LL, D3D_DRIVER_TYPE_WARP, v16, v20 - v16, v46, &v49, &v50, (ID3D11DeviceContext **)v48);
  if ( DXGIFactory1 >= 0 )
  {
    v51[0] = 0LL;
    DXGIFactory1 = sub_1800CCB80((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))&v49, (__int64 *)v51);
    if ( DXGIFactory1 < 0 )
    {
LABEL_89:
      sub_18000E954((__int64 *)v51);
    ...
    if ( DXGIFactory1 < 0
      || (DXGIFactory1 = sub_1800B623C((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))&v47, a2), DXGIFactory1 < 0)
      || (v36 = v56,
          DXGIFactory1 = sub_1800B61EC((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))&v49, v56),
          DXGIFactory1 < 0)
      || (v37 = v53,
          DXGIFactory1 = sub_1800CCB30((__int64 (__fastcall ****)(_QWORD, void *, __int64 *))v48, v53),
          DXGIFactory1 < 0)
      || (DXGIFactory1 = (*(__int64 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)*a2 + 80LL))(*a2, v59),
          DXGIFactory1 < 0) )
    {
...
LABEL_7:
  if ( v16 )
    sub_180010234(v16, 4 * (v13 - v16));
  sub_1800CCF78((void **)&v57, (__int64)&v57);
