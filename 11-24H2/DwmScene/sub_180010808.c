/*
 * XREFs of sub_180010808 @ 0x180010808
 * Callers:
...
__int64 *__fastcall sub_180010808(_QWORD *a1, __int64 *a2)
{
  ...
  sub_180011C30(a1 + 2);
  v11 = _std_type_info_hash(&qword_1801B9BF8);
  sub_180011BC0(a1, &v12, &v11);
  if ( v12 == *a1 )
  {
    *a2 = 0LL;
    a2[1] = 0LL;
