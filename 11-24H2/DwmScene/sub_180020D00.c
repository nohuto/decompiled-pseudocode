...
unsigned __int8 __fastcall sub_180020D00(_QWORD *a1, void *a2)
{
  ...
  result = sub_180021E68(a1[14], a1 + 15);
  if ( (unsigned int)CallbackContext > 5 )
  {
    ...
    if ( result )
    {
      ...
      v10 = a2;
      v9 = 1;
      v13 = sub_1800209CC(v14, v5);
      return sub_180001B40(v6, byte_18019D25C, v7, v8, (void **)&v13, (__int64)&v9, &v12, &v11, &v10);
    }
  }
  return result;
}
