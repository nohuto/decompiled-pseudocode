/*
 * XREFs of sub_180045DDC @ 0x180045DDC
 * Callers:
...
void __fastcall sub_180045DDC(__int64 a1, __int64 *a2, __int64 a3)
{
  unsigned int *v6; // rbx
  __int128 *v7; // rdx
  _QWORD **v8; // rdi
  ...
  if ( *(_DWORD *)(a1 + 120) )
  {
    sub_180011C04(*a2 + 72, &v12);
    if ( !sub_180027C14(a1, *(_DWORD *)(v12 + 244)) )
    {
      if ( (*(_BYTE *)(a1 + 40) & 4) == 0 )
      {
LABEL_15:
    ...
    *(_DWORD *)(*(_QWORD *)(*a2 + 96) + 9832LL) = *(_DWORD *)(a1 + 300);
    if ( *(_QWORD *)(a1 + 272) )
    {
      sub_180037768(*a2, (_QWORD *)(a1 + 272));
      v8 = (_QWORD **)*a2;
      v9 = *(_DWORD *)(a1 + 112);
      ...
      _InterlockedAdd64(qword_1801C45A0, *(unsigned int *)(a1 + 112));
    }
    else
    {
      v15 = 0LL;
      sub_180037768(*a2, &v15);
      v10 = (_QWORD **)*a2;
      v11 = *(_DWORD *)(a1 + 120);
      (*(void (__fastcall **)(_QWORD *, _QWORD **))(*v10[12] + 8LL))(v10[12], v10);
      ((void (__fastcall *)(_QWORD **, _QWORD, _QWORD))(*v10)[25])(v10, v11, 0LL);
    }
    _InterlockedAdd64(&qword_1801C4500, *(unsigned int *)(a1 + 120));
    _InterlockedIncrement64(qword_1801C4C80);
    if ( *((_QWORD *)&v14 + 1) )
