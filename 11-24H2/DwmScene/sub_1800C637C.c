/*
 * XREFs of sub_1800C637C @ 0x1800C637C
 * Callers:
 ...
 *     sub_1800C64FC @ 0x1800C64FC (sub_1800C64FC.c)
 */

unsigned __int64 __fastcall sub_1800C637C(const void **a1, _BYTE *a2, __int64 a3)
{
  __int64 v3; // rbx
  ...
  v22 = v3;
  v12 = sub_18001D7D8(v10, &v22);
  v13 = v12 + (v4 & 0xFFFFFFFFFFFFFFE0uLL);
  v14 = v12;
  v16 = (void *)sub_1800C64FC(v15, v13, a3);
  v17 = a1[1];
  v18 = v16;
  v19 = *a1;
  if ( a2 == v17 )
  ...
  memmove(v18, v19, v20);
  sub_1800527A8((__int64)a1, v14, v9, v3);
  return v13;
}
