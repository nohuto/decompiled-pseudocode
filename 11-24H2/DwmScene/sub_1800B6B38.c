/*
 * XREFs of sub_1800B6B38 @ 0x1800B6B38
 * Callers:
...
int __fastcall sub_1800B6B38(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B9FD8);
  v3 = *(_QWORD *)sub_18004F18C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_075568019f0ba5dd51131882019b8c39_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
