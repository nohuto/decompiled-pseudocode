/*
 * XREFs of sub_18004EB64 @ 0x18004EB64
 * Callers:
...
int __fastcall sub_18004EB64(__int64 a1)
{
  ...
  v9[0] = &std::_Func_impl_no_alloc<_lambda_966210904f8ddb1ecfe06826adf9ae70_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
