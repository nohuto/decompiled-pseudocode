/*
 * XREFs of sub_18007C5C4 @ 0x18007C5C4
 * Callers:
...
_QWORD *__fastcall sub_18007C5C4(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  __int64 v4; // r8
  __int64 v6; // r9
  void *v7; // rax
  ...
  if ( v11[12] == 2 )
  {
    std::string::string(v18, "ShaderPropertyBlock::SetTexture() -- Cannot set the value of an imported property");
  ...
  result = sub_180011110((_QWORD *)(*(_QWORD *)(a1 + 56) + 40LL * (unsigned int)v11[10]), a3);
  v17 = a3[1];
  if ( v17 )
