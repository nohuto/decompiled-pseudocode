/*
 * XREFs of sub_18007A6A4 @ 0x18007A6A4
 * Callers:
...
__int64 __fastcall sub_18007A6A4(__int64 a1, unsigned __int16 a2, __int64 a3)
{
  char v6; // r14
  __int64 *v7; // rax
  int v8; // ebx
  ...
  {
    v7 = sub_18007A0C8(v32, *(_DWORD *)(a3 + 32), a3);
    v8 = 2;
  }
  else
  {
    v7 = sub_180078E04(v33, a3 + 40);
    v8 = 1;
  }
  LODWORD(v30[1]) = v8;
  sub_180078E04(v31, (__int64)v7);
  if ( (v8 & 2) != 0 )
  {
    LOBYTE(v8) = v8 & 0xFD;
    sub_18001AA80((__int64)v32);
  }
  if ( (v8 & 1) != 0 )
    sub_18001AA80((__int64)v33);
  v9 = *(_DWORD *)(a3 + 32);
  if ( v9 )
  {
    v10 = v9 - 1;
    if ( v10 )
    {
      ...
      if ( v11 )
      {
              ...
              if ( v15 )
              {
                ...
                if ( v16 )
                {
                  if ( v16 != 1 )
                  {
                    ...
                    sub_180038BB8(pExceptionObject, (__int64)v17, v18, (__int64)v36, 0);
                ...
                else
                {
                  ...
                  sub_18007A95C(a1, a2, pExceptionObject);
                }
              }
              else
              {
                v19 = *(_OWORD *)v31[0];
                *(_OWORD *)sub_180079204(a1, a2) = v19;
              }
            }
            else
            {
              *(_OWORD *)&v30[1] = *(_OWORD *)v31[0];
              sub_18007A990(a1, a2, &v30[1]);
            }
          }
          else
          {
            ...
            v21 = *(_DWORD *)(v31[0] + 4);
            v22 = *(_DWORD *)(v31[0] + 8);
            v23 = (_DWORD *)sub_180079204(a1, a2);
            *v23 = v20;
            v23[1] = v21;
            v23[2] = v22;
          }
        ...
        else
        {
          v24 = *(_DWORD *)v31[0];
          v25 = *(_DWORD *)(v31[0] + 4);
          v26 = (_DWORD *)sub_180079204(a1, a2);
          *v26 = v24;
          v26[1] = v25;
        }
      }
      ...
      {
        v27 = *(_DWORD *)v31[0];
        *(_DWORD *)sub_180079204(a1, a2) = v27;
      }
    }
    else
    {
      v28 = (int)*(float *)v31[0];
      *(_DWORD *)sub_180079204(a1, a2) = v28;
    }
  }
  else
  {
    if ( *(float *)v31[0] != 0.0 )
      v6 = 1;
    *(_DWORD *)sub_180079204(a1, a2) = -(v6 != 0);
  }
  return sub_18001AA80((__int64)v31);
}
