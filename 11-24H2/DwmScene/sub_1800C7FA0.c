/*
 * XREFs of sub_1800C7FA0 @ 0x1800C7FA0
 * Callers:
...
__int64 __fastcall sub_1800C7FA0(__int64 a1, __int128 *a2)
{
  __int128 v2; // xmm0
  __int128 v3; // xmm1
  __int64 v5; // rdx
  ...
  v10 = v3;
  v12 = &v8;
  sub_180025F78((__int64)v13, (__int64)&v8);
  sub_180025F78((__int64)&v8, a1);
  sub_180025F78(a1, (__int64)v13);
  sub_180012508((__int64)v13, v5);
  sub_180012508((__int64)&v8, v6);
  return a1;
}
