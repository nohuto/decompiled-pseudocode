/*
 * XREFs of sub_18000E2FC @ 0x18000E2FC
 * Callers:
 *     sub_18000DEF0 @ 0x18000DEF0 (sub_18000DEF0.c)
 * Callees:
 *     __security_check_cookie @ 0x18000B680 (__security_check_cookie.c)
 */

char __fastcall sub_18000E2FC(LPCWSTR lpModuleName, _DWORD *a2, _BYTE *a3, unsigned __int64 a4)
{
  HMODULE v6; // rcx
  __int64 v10; // rax
  CHAR *i; // rcx
