/*
 * XREFs of sub_180084ED8 @ 0x180084ED8
 * Callers:
...
__int64 __fastcall sub_180084ED8(const void **a1, unsigned __int64 a2, __int64 a3)
{
  __int64 v5; // rbx
  __int64 v6; // rsi
  __int64 v7; // rcx
  ...
  return sub_18001E4FC((__int64)a1, (__int64)v8, a2, v6);
}
