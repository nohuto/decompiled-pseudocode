/*
 * XREFs of sub_18006D7F0 @ 0x18006D7F0
 * Callers:
...
char __fastcall sub_18006D7F0(__int64 a1)
{
  ...
  v228 = std::wstring::wstring((__int64)v616, word_1800F88E8);
  ...
  v230 = std::wstring::wstring((__int64)v616, word_1800F88E8);
  ...
  v379 = std::wstring::wstring((__int64)v616, word_1800F88E8);
  ...
  v381 = std::wstring::wstring((__int64)v616, word_1800F88E8);
  ...
  return sub_180013228((__int64)v617);
}
