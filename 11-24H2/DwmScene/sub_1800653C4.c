/*
 * XREFs of sub_1800653C4 @ 0x1800653C4
 * Callers:
...
__int64 __fastcall sub_1800653C4(__int64 a1, __int64 *a2)
{
  __int64 *v2; // rbx
  __int64 v3; // rdx
  __int64 v4; // rax
  ...
  v2 = a2;
  v36 = sub_180032500(a1, *(_DWORD *)(*a2 + 112));
  v4 = sub_18005D888(*v2, v3);
  v5 = (_QWORD *)(v4 + 8);
  v6 = &off_1801B99D0;
  v7 = (__int64 *)(v4 + 64);
  v39 = 3LL;
  do
  {
    ...
    if ( v48 && v10 )
    {
      ...
      sub_180032310(a1, &v55, v33, v32);
      sub_180011C04(v55 + 56, &v50);
      v34 = _mm_load_si128(&v50);
      *(__m128i *)&v47[1] = v34;
      v50 = 0LL;
      sub_180039344((_QWORD *)(v10 + 96), &v47[1]);
      if ( _mm_srli_si128(v34, 8).m128i_u64[0] )
        sub_18001060C(_mm_srli_si128(v34, 8).m128i_i64[0]);
      if ( v62 )
      {
        v35 = -1077342245;
        v38 = 1;
      ...
      *(float *)(v12 + 112) = v46;
      *(_BYTE *)(v12 + 124) = v37;
      sub_180011C04(v12 + 56, &v51);
      result = (__int64)sub_180023824(v51, &v53);
      if ( v52 )
        result = sub_18001060C(v52);
      if ( v53 )
        result = sub_180057828(v53);
      if ( v54 )
        result = sub_18001060C(v54);
      if ( v56 )
        result = sub_18001060C(v56);
      if ( v11 )
        result = sub_18001060C(v11);
      if ( v49 )
        result = sub_18001060C(v49);
      v2 = a2;
      goto LABEL_24;
    }
    if ( v11 )
