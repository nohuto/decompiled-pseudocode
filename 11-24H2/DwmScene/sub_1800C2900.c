...
__int64 __fastcall sub_1800C2900(__int64 a1, _QWORD *a2, unsigned __int8 a3, char a4)
{
  ...
  if ( *a2 )
  {
    v7 = (__int64 *)sub_1800C3114(*a2, &v19, *(unsigned int *)(a1 + 88));
    v8 = 1;
    v9 = *v7;
  }
  else
  ...
  *v7 = 0LL;
  ...
  if ( (v8 & 1) != 0 && v20 )
    sub_18001060C(v20);
  v11 = unknown_libname_81(&v19, v18);
  sub_1800150A0(&v16, (__int64)v11, *v11);
  v13 = *(_QWORD *)(v12 + 8);
  if ( v13 )
    sub_18001060C(v13);
  sub_1800C3210(v16, &v21);
  v14 = v5 | 2;
  if ( !a4 )
    v14 = v5;
