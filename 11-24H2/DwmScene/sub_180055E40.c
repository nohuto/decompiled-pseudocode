/*
 * XREFs of sub_180055E40 @ 0x180055E40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800576DC @ 0x1800576DC (sub_1800576DC.c)
...
__int64 __fastcall sub_180055E40(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v5; // rbx
  _QWORD *v6; // r8
  __int64 v7; // rbx
  ...
  sub_180057494(a1, &v57, a2);
  if ( (*(_BYTE *)(a1 + 440) & 1) != 0 )
  {
    v5 = *(_QWORD *)(sub_180078578(a1) + 512);
    if ( *(_QWORD *)(a1 + 200) )
    {
      v54 = 0LL;
      sub_18004D2C8(v5, a1 + 184, &v54);
    }
    if ( *(_QWORD *)(a1 + 232) )
    {
      v54 = 0LL;
      sub_18004D2C8(v5, a1 + 216, &v54);
    }
    if ( *(_QWORD *)(a1 + 264) )
    {
      v59 = xmmword_1800F8620;
      v60 = xmmword_1800F8630;
      v61 = xmmword_1800F8640;
      v62 = xmmword_1800F8650;
      sub_18004D2AC(v5);
    }
  }
  v6 = (_QWORD *)(a1 + 152);
  ...
  {
    v10 = v57;
    sub_1800377FC((__int64)v57, (_QWORD *)(a1 + 136), v6);
  }
  else
  {
    ...
    v9 = (_QWORD *)v7;
    v10 = v57;
    sub_1800377FC((__int64)v57, v8, v9);
    if ( *((_QWORD *)&v54 + 1) )
      sub_18001060C(*((__int64 *)&v54 + 1));
    if ( v55.m128i_i64[1] )
      sub_18001060C(v55.m128i_i64[1]);
  ...
  v14 = xmmword_18018D380;
  v56 = xmmword_18018D380;
  sub_180057450(a1, &v69);
  *(_QWORD *)&v54 = 0LL;
  ...
  v44 = *(_QWORD *)(sub_180078578(a1) + 512);
  v45 = sub_180040888(a1, v52);
  sub_18003A064(*v45, (__int64)&v56);
  if ( *(_QWORD *)&v52[8] )
    sub_18001060C(*(__int64 *)&v52[8]);
  v55.m128i_i64[0] = v56;
  v55.m128i_i64[1] = DWORD2(v56) | 0x3F80000000000000LL;
  if ( *(_DWORD *)(a1 + 316) == 3 )
  {
    v46 = sub_180040888(a1, v52);
    sub_18003A3E0(*v46, &v63);
    *((float *)&v56 + 2) = -*((float *)&v65 + 2);
    v47 = 0LL;
    v47.m128_u64[0] = _mm_unpacklo_ps(
                        _mm_xor_ps((__m128)(unsigned int)v65, (__m128)xmmword_18018D670),
                        _mm_xor_ps((__m128)DWORD1(v65), (__m128)xmmword_18018D670)).m128_u64[0];
  ...
  *(__m128i *)v52 = v55;
  sub_18004D338(v44, (__int64)&unk_1801C8978);
  *(_OWORD *)v52 = v14;
  sub_18004D338(v44, (__int64)&unk_1801C89B8);
  sub_18007C4E0(*(_QWORD *)(v44 + 18648), &unk_1801C89D8);
  v59 = xmmword_18018D360;
  v60 = xmmword_18018D370;
  v61 = xmmword_18018D3B0;
  v62 = xmmword_18018D5C0;
  v50 = (__int128 *)sub_18005755C(a1, 0LL, 2LL);
  v63 = *v50;
  v64 = v50[1];
  v65 = v50[2];
  v66 = v50[3];
  sub_180058F98(&v63, &v59);
  v63 = v59;
  v64 = v60;
  v65 = v61;
  v66 = v62;
  sub_18004D2AC(v44);
  sub_180057518(a1, &v69);
  *(_QWORD *)&v54 = v69;
  *((float *)&v54 + 2) = 1.0 / *(float *)&v69;
  *((float *)&v54 + 3) = 1.0 / *((float *)&v69 + 1);
  *(_OWORD *)v52 = v54;
  result = sub_18004D338(v44, (__int64)&unk_1801C8298);
  if ( v58 )
    return sub_18001060C(v58);
  return result;
}
