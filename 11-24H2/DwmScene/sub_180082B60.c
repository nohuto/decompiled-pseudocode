/*
 * XREFs of sub_180082B60 @ 0x180082B60
 * Callers:
 ...
 *     sub_180083474 @ 0x180083474 (sub_180083474.c)
 *     sub_1800834AC @ 0x1800834AC (sub_1800834AC.c)
 */

char *__fastcall sub_180082B60(_QWORD *a1, _BYTE *a2, _WORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  if ( v6 == 0x7FFFFFFFFFFFFFFFLL )
    sub_180013278();
  v8 = v6 + 1;
  v17 = sub_180083474(a1, v6 + 1);
  v10 = (char *)sub_1800120B4(v9, &v17);
  v11 = &v10[2 * ((a2 - v3) >> 1)];
  *(_WORD *)v11 = *a3;
  v12 = v10;
  v13 = (_BYTE *)a1[1];
