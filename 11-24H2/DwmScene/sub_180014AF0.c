/*
 * XREFs of sub_180014AF0 @ 0x180014AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180014AF0(__int64 a1, _OWORD *a2)
{
  _QWORD *v4; // rax
  __int128 v5; // xmm1
  __int128 v6; // xmm2
  ...
  v4 = (_QWORD *)sub_18001268C(*(_QWORD *)(a1 + 32), &v9);
  sub_18002867C(*v4 + 16LL, v11);
  if ( v10 )
    sub_18001060C(v10);
  sub_18003A3E0(*(_QWORD *)(a1 + 32), v12);
  v5 = v12[1];
  v6 = v12[2];
  v7 = v12[3];
  *a2 = v12[0];
