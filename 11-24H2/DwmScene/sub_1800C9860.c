/*
 * XREFs of sub_1800C9860 @ 0x1800C9860
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_1800C9860(__int64 a1, __int64 a2, unsigned int a3, int a4, __int64 a5)
{
  int v7; // r9d
  int v8; // r9d
  __m128i v9; // xmm6
...
LABEL_11:
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( v16 )
    {
      ...
      v17(v16, &unk_1800F7B68, (unsigned int)v14, v15);
    }
  }
  sub_18000E954(v19.m128i_i64);
  if ( v10 )
    sub_18001060C(_mm_srli_si128(v9, 8).m128i_i64[0]);
  return v13 == 0;
}
