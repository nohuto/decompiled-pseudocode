/*
 * XREFs of sub_180013BCC @ 0x180013BCC
 * Callers:
...
_QWORD *__fastcall sub_180013BCC(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003BE7C();
  v4 = *(_QWORD *)sub_180013E0C(a1, &v10);
  if ( v11 )
    sub_18001060C(v11);
  if ( v4 )
  {
