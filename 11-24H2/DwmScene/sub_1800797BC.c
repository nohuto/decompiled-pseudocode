/*
 * XREFs of sub_1800797BC @ 0x1800797BC
 * Callers:
...
__int64 __fastcall sub_1800797BC(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_DWORD *)(a1 + 1168) )
  {
    ...
    v7 = std::string::string(
           ...
           "ropertylayout.cpp");
    sub_180038BB8(pExceptionObject, (__int64)v7, v8, (__int64)&v51, 0);
  ...
  if ( !*(_QWORD *)(a2 + 16) )
  {
    ...
    v9 = std::string::string(
           ...
           "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\shaderp"
           "ropertylayout.cpp");
    sub_180038BB8(pExceptionObject, (__int64)v9, v10, (__int64)&v51, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v11 = (__int64 *)(a1 + 56);
  if ( *(_QWORD *)(a1 + 64) - *(_QWORD *)(a1 + 56) == 28672LL )
  {
    ...
    v12 = std::string::string(
            ...
            "propertylayout.cpp");
    sub_180038BB8(pExceptionObject, (__int64)v12, v13, (__int64)&v51, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v14 = (unsigned __int16)sub_18004C05C(*(_QWORD *)(a1 + 1152), a2);
  if ( *(_WORD *)(a1 + 2 * v14 + 128) != 0xFFFF )
  {
    v15 = sub_18001B6DC(&v51, (__int64)"ShaderPropertyLayout::AddProperty() -- variable '", a2);
    v16 = sub_18001B5A8((__int64)pExceptionObject, (__int64)v15, (__int64)"' is already defined");
    v17 = std::string::string(
            &v42,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\shader"
            "propertylayout.cpp");
    sub_180038BB8(v53, (__int64)v17, v18, v16, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)v53;
  }
  if ( a3 == 1 )
  {
    v19 = (_QWORD *)sub_18004C6D4(*(_QWORD *)(a1 + 1152), &v42);
    sub_18007BFC4(*v19, &v51);
    if ( v43 )
      sub_18001060C(v43);
    v20 = v51;
    if ( v51 != a1 )
    {
      if ( *(_WORD *)(v20 + 2LL * (unsigned __int16)sub_180079FD4(v51, a2) + 128) == 0xFFFF )
        sub_18007BC84(*(_QWORD *)(*(_QWORD *)(a1 + 1152) + 18648LL), a2);
      *(_BYTE *)(a1 + 1241) = 1;
      a3 = 2;
    }
    if ( v52 )
  ...
  if ( v6 == 8 )
  {
    ...
    {
      sub_1800788D0((__int64 *)(a1 + 104), v21, (__int64)pExceptionObject);
    }
    else
    {
      sub_1800786C8();
    ...
    *(_WORD *)(a1 + 2 * v14 + 128) = 28087 * ((v11[1] - *v11) >> 3);
    ...
    if ( v24 == v11[2] )
    {
      sub_180078770(v11, v24, (__int64)&v42);
    }
    else
    {
      sub_180078CB8(v23, v24, (__int64)&v42);
      v11[1] += 56LL;
    }
    sub_180011B5C((__int64)&v42);
    sub_18006B2BC((__int64)pExceptionObject);
    goto LABEL_37;
  }
  v25 = sub_18007A340(v6);
  sub_180079C38(a1);
  v26 = a1 + 80;
  v27 = *(_QWORD *)(a1 + 80);
...
LABEL_32:
  ...
  if ( v29 > v28 )
  {
    ...
    {
      v30 = sub_180078C6C(*(_QWORD *)(a1 + 88), v29 - v28, v26);
      goto LABEL_32;
    }
    sub_180078B14((const void **)(a1 + 80), v29, v26);
  }
LABEL_33:
  *(_WORD *)(a1 + 2 * v14 + 128) = 28087 * ((v11[1] - *v11) >> 3);
  sub_180017054((__int64)pExceptionObject, a2);
  ...
  if ( v32 == v11[2] )
  {
    sub_180078770(v11, v32, (__int64)pExceptionObject);
  }
  else
  {
    sub_180078CB8(v31, v32, (__int64)pExceptionObject);
    v11[1] += 56LL;
  }
  sub_180011B5C((__int64)pExceptionObject);
LABEL_37:
  *(_BYTE *)(a1 + 1240) |= a3 == 2;
  sub_18007A6A4(a1, (unsigned __int16)v14, a2);
