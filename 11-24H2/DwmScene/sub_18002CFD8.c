/*
 * XREFs of sub_18002CFD8 @ 0x18002CFD8
 * Callers:
...
__int64 __fastcall sub_18002CFD8(_QWORD *a1, __int64 a2, __int64 *a3, __int64 a4)
{
  _QWORD *v4; // rax
  _QWORD *v9; // rbx
  __int64 v10; // rdx
...
LABEL_44:
  ...
  if ( a3 != (__int64 *)*v4 )
  {
    ...
    if ( v23 < 0 )
    {
      ...
      sub_1800138F8(a4);
      v30 = (const void *)sub_1800138F8((__int64)(v24 + 4));
      LOBYTE(v32) = sub_18001BCAC(v30, v24[6], v31, *(_QWORD *)(a4 + 16));
      if ( v32 >= 0 )
        goto LABEL_37;
...
LABEL_25:
    ...
    if ( !*((_BYTE *)v37 + 25) )
    {
      sub_1800138F8((__int64)(v37 + 4));
      v41 = (const void *)sub_1800138F8(a4);
      LOBYTE(v43) = sub_18001BCAC(v41, *(_QWORD *)(a4 + 16), v42, v37[6]);
      if ( v43 >= 0 )
        goto LABEL_37;
    }
LABEL_40:
...
LABEL_43:
  ...
  {
LABEL_37:
    sub_18001B9BC((__int64)a1, (__int64 **)&v47, a4);
    v44 = v48;
    if ( sub_18001BA80(v45, v48) )
    {
      *(_QWORD *)a2 = v44;
      *(_QWORD *)(a2 + 8) = 2LL;
      *(_BYTE *)(a2 + 16) = 1;
