 ...
 * Callees:
 *     sub_1800588B8 @ 0x1800588B8 (sub_1800588B8.c)
 */

__int64 __fastcall sub_1800584E0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r8
  int v5; // r9d
  __int64 v6; // r8
  ...
  *(_DWORD *)(a1 + 292) = 0;
  *(_OWORD *)(a1 + 932) = xmmword_1800F8620;
  *(_OWORD *)(a1 + 948) = xmmword_1800F8630;
  *(_OWORD *)(a1 + 964) = xmmword_1800F8640;
  *(_OWORD *)(a1 + 980) = xmmword_1800F8650;
  ...
  *(_QWORD *)(a1 + 520) = 0LL;
  *(_QWORD *)(a1 + 528) = 0LL;
  sub_1800588B8(a1, 1LL, a3, 2LL);
  sub_1800588B8(a1, 2LL, v4, 0LL);
  return sub_1800588B8(a1, (unsigned int)(v5 + 3), v6, (unsigned int)(v5 + 2));
}
