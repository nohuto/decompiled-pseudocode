/*
 * XREFs of sub_1800BAF10 @ 0x1800BAF10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800BAF10(__int64 a1, int a2)
{
  int v3; // edi
  __int64 result; // rax
  ...
  *(_DWORD *)(a1 + 416) = a2;
  ...
  if ( (_DWORD)result )
  {
    ...
    do
    {
      sub_180025240(a1, &v18, v6);
      v8 = v18;
      sub_18002867C((__int64)(v18 + 1), (__int64)v25);
      ...
      v15(v18);
      if ( v16 )
        sub_180027130(v16, _mm_unpacklo_ps(v11, v12).m128_i64[0]);
      if ( v17 )
        sub_18001060C(v17);
      if ( v22 )
        sub_18001060C(v22);
      result = sub_180011044((__int64)v25);
      if ( v19 )
