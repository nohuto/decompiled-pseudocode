/*
 * XREFs of sub_1800CDFE8 @ 0x1800CDFE8
 * Callers:
...
__int64 __fastcall sub_1800CDFE8(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( (unsigned __int8)sub_1800D17D0(v9, v10) )
  {
    ...
    else
    {
      ...
      v13 = (_DWORD *)sub_1800D16C0(v9, v12);
      v14 = (__int64)v13;
      if ( *v13 == 5 )
      {
        ...
        if ( (unsigned __int8)sub_1800D17D0(v14, v15)
          && (v16 = sub_180012444((__int64)v22, (__int64)v25), v17 = (_DWORD *)sub_1800D16C0(v14, v16), *v17 == 1) )
        {
          if ( v17[10] != a3 )
          {
            v18 = sub_180012444((__int64)v22, (__int64)v25);
            sub_1800CDF58(v14, v18, a3);
            v11 = 1;
          }
        }
        else
