/*
 * XREFs of sub_18003F764 @ 0x18003F764
 * Callers:
...
__int64 __fastcall sub_18003F764(__int64 a1, __int64 *a2, __int64 *a3)
{
  _QWORD *v6; // rax
  __int64 v7; // r8
  _QWORD *v8; // rax
  ...
  sub_18001268C(*a3, &v24);
  v10 = *(_QWORD *)sub_18001268C(*a2, &v21);
  v12 = *v11;
  if ( v22 )
    sub_18001060C(v22);
  if ( v25 )
  ...
  if ( v10 != v12 )
  {
    ...
    v13 = std::string::string(
            v23,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\scene.cpp");
    sub_180038BB8(pExceptionObject, (__int64)v13, v14, (__int64)&v24, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v15 = unknown_libname_81(&v24, a2);
  sub_18003F3C8(a1, v15);
  unknown_libname_81(&v24, a3);
  v16 = unknown_libname_81(v23, a2);
  result = sub_18003EE4C(a1, v16, v17);
  v19 = a2[1];
  if ( v19 )
