/*
 * XREFs of sub_18006CDFC @ 0x18006CDFC
 * Callers:
...
__int64 __fastcall sub_18006CDFC(_QWORD *a1, __int64 *a2)
{
  __int64 v4; // rsi
  _QWORD *v5; // rbx
  unsigned int v6; // eax
  ...
  v15[1] = a1;
  v15[7] = v15;
  sub_18006C680((__int64)a1, &v12, 0);
  unknown_libname_81(&v13, a1 + 38);
  v6 = (unsigned int)unknown_libname_81(&v14, a1 + 34);
  result = sub_18008D330(v4, v6, v7, v8, (__int64)v15, (__int64)v5);
  v10 = a2[1];
  if ( v10 )
