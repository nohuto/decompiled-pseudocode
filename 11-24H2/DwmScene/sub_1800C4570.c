/*
 * XREFs of sub_1800C4570 @ 0x1800C4570
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_1800C4570(__int64 a1, int a2, __int64 *a3, unsigned int a4)
{
  __int64 *result; // rax
  char v8; // di
  __int64 v9; // rsi
  ...
  if ( *a3 )
  {
    result = sub_1800C30B4(*a3, &v17, *(_DWORD *)(a1 + 88));
    v8 = 1;
    v9 = *result;
  }
  else
  ...
  *result = 0LL;
  ...
  if ( (v8 & 1) != 0 && v18 )
    result = (__int64 *)sub_18001060C(v18);
  if ( v9 )
  {
    v19 = *sub_1800C2FDC(v9, &v13);
    result = (__int64 *)sub_18000E954(&v13);
  }
  else
  {
    v19 = 0LL;
  ...
  if ( v10 )
    return (__int64 *)sub_18001060C(v10);
  return result;
}
