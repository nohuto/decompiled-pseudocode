/*
 * XREFs of sub_18001BCFC @ 0x18001BCFC
 * Callers:
 ...
 *     sub_18001BEA8 @ 0x18001BEA8 (sub_18001BEA8.c)
...
__int64 __fastcall sub_18001BCFC(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rbx
  __int64 v7; // rcx
  __int64 v8; // rbx
  ...
  else
  {
    ...
    *(_QWORD *)&v13 = a1;
    ...
    sub_18001BEA8(v10, v9 + 32, v11, &v16);
    *(_QWORD *)v9 = v8;
    *(_QWORD *)(v9 + 8) = v8;
    *(_QWORD *)(v9 + 16) = v8;
    *(_WORD *)(v9 + 24) = 0;
    *((_QWORD *)&v13 + 1) = 0LL;
    sub_18001C38C(&v13);
    v13 = v14;
    *(_QWORD *)a2 = sub_18001CB64(a1, &v13, v9);
    *(_BYTE *)(a2 + 8) = 1;
  }
  return a2;
}
