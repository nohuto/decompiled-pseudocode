/*
 * XREFs of sub_180047BB0 @ 0x180047BB0
 * Callers:
...
__int64 __fastcall sub_180047BB0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  ...
  *(_QWORD *)(a1 + 160) = 0LL;
  *(_BYTE *)(a1 + 168) = -1;
  *(_OWORD *)(a1 + 172) = xmmword_1800F8660;
  ...
  if ( v5 <= 1 )
  {
    if ( !v5 )
    {
      if ( 0x2E8BA2E8BA2E8BA3LL * ((*(_QWORD *)(a1 + 120) - v4) >> 3) )
        *(_QWORD *)(a1 + 112) = sub_1800478D8(*(_QWORD *)(a1 + 112), 1 - v5);
      else
        sub_180047778((__int64 *)(a1 + 104), 1uLL, 0x2E8BA2E8BA2E8BA3LL);
    }
  }
  else
  {
    v6 = v4 + 88;
    sub_180047740(v4 + 88, *(_QWORD *)(a1 + 112));
    *(_QWORD *)(a1 + 112) = v6;
  }
  v7 = a2[1];
  if ( v7 )
