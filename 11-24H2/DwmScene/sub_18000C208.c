/*
 * XREFs of sub_18000C208 @ 0x18000C208
 * Callers:
 *     __report_gsfailure @ 0x18000C130 (__report_gsfailure.c)
 * Callees:
 *     <none>
 */

struct _IMAGE_RUNTIME_FUNCTION_ENTRY *__fastcall sub_18000C208(PCONTEXT ContextRecord)
{
  ULONG64 Rip; // rsi
  int i; // edi
