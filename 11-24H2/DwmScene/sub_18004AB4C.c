/*
 * XREFs of sub_18004AB4C @ 0x18004AB4C
 * Callers:
 ...
 *     sub_18004AD10 @ 0x18004AD10 (sub_18004AD10.c)
 */

__int64 __fastcall sub_18004AB4C(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rbx
  __int64 v7; // rcx
  __int64 v8; // rbx
  ...
  else
  {
    ...
    *(_QWORD *)&v13 = a1;
    ...
    sub_18004AD10(v10, v9 + 32, v11, &v16);
    *(_QWORD *)v9 = v8;
    *(_QWORD *)(v9 + 8) = v8;
    *(_QWORD *)(v9 + 16) = v8;
    *(_WORD *)(v9 + 24) = 0;
