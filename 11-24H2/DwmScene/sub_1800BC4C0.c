/*
 * XREFs of sub_1800BC4C0 @ 0x1800BC4C0
 * Callers:
 ...
 *     sub_1800BC600 @ 0x1800BC600 (sub_1800BC600.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_1800BC4C0(__int64 *a1, __int64 a2, _DWORD *a3)
{
  _DWORD *v5; // r8
  __int64 v6; // rbx
  __int64 v7; // rdi
  ...
  if ( *(_BYTE *)(v13 + 25) || *v5 < *(_DWORD *)(v13 + 32) )
  {
    ...
    *(_QWORD *)&v11 = a1;
    ...
    sub_1800BC600(v8, v7 + 32, v9, &v14);
    *(_QWORD *)v7 = v6;
    *(_QWORD *)(v7 + 8) = v6;
    *(_QWORD *)(v7 + 16) = v6;
    *(_WORD *)(v7 + 24) = 0;
    *((_QWORD *)&v11 + 1) = 0LL;
    sub_18001C308((__int64)&v11);
    v11 = v12;
