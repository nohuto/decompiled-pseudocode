/*
 * XREFs of sub_1800684A0 @ 0x1800684A0
 * Callers:
 ...
 *     sub_180067F84 @ 0x180067F84 (sub_180067F84.c)
 */

__int64 __fastcall sub_1800684A0(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rsi
  _QWORD *v7; // r12
  _QWORD *v8; // r15
  ...
  if ( a2 != a3 )
  {
    ...
    v27 = v7;
    v28 = a2;
    v9 = sub_1800131AC(a2 + 16);
    v12 = sub_18001E5E0(v11, v9, 2LL * *(_QWORD *)(v10 + 32));
    v14 = 2 * (a1[6] & v12);
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v6 + 8 * v14 + 8) = v7; ; *(_QWORD *)(v6 + 8 * v14 + 8) = v8 )
    {
      ...
      if ( v28 == a3 )
        break;
      v20 = sub_1800131AC(v28 + 16);
      v23 = sub_18001E5E0(v22, v20, 2LL * *(_QWORD *)(v21 + 32));
      v14 = 2 * (a1[6] & v23);
