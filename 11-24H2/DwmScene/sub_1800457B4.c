/*
 * XREFs of sub_1800457B4 @ 0x1800457B4
 * Callers:
...
__int64 __fastcall sub_1800457B4(_DWORD *a1, __int64 a2, char a3)
{
  __int64 result; // rax
  char v5; // bl
  BOOL v6; // r12d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    {
      v7 = 1;
      v8 = (__int64 *)sub_180045B78(a1, &v23, 0LL);
      v9 = *v8;
      v20 = *v8;
      v21 = v8[1];
      *v8 = 0LL;
    ...
    {
      v7 = 0;
      v11 = (__int64 *)sub_180045B78(a1, &v22, 0LL);
      v9 = *v11;
      v19 = v11[1];
      *v11 = 0LL;
      v11[1] = 0LL;
    ...
    *v10 = 0LL;
    ...
    v29 = 0LL;
    v14 = a1[30];
    v15 = sub_180045BB0(a1, v25, 0LL);
    v23 = v26;
    v16 = sub_180045C20(a1, v26, 0LL);
    v17 = sub_180045BE8(a1, v27, 0LL);
    result = sub_1800D3CCC(v17, v16, v15, v14, (__int64)&v18, v13, v7, v6, a3, (__int64)v28);
    if ( *((_QWORD *)&v22 + 1) )
      return sub_18001060C(*((__int64 *)&v22 + 1));
  }
  return result;
}
