/*
 * XREFs of sub_18003C2B8 @ 0x18003C2B8
 * Callers:
...
__m128 __fastcall sub_18003C2B8(double a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm6
  __m128 v5; // xmm9
  __m128 v6; // xmm4
  ...
  v11 = _mm_mul_ps(_mm_mul_ps(*(__m128 *)&a1, (__m128)xmmword_1800FA0E0), v10);
