/*
 * XREFs of sub_1800857F0 @ 0x1800857F0
 * Callers:
 *     sub_180086F30 @ 0x180086F30 (sub_180086F30.c)
 * Callees:
...
__m128 *__fastcall sub_1800857F0(__int64 a1, __m128 *a2, __m128 *a3)
{
  __m128 v3; // xmm1
  __int64 v4; // rsi
  char *v5; // rbx
  ...
  *(_QWORD *)v22 = 0LL;
  v25[2] = 2;
  *a3 = _mm_mul_ps(
          _mm_min_ps(_mm_max_ps(v3, (__m128)xmmword_1800F8190), (__m128)xmmword_1800F8180),
