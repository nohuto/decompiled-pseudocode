/*
 * XREFs of sub_180034854 @ 0x180034854
 * Callers:
...
_UNKNOWN **__fastcall sub_180034854(__int64 a1, _QWORD *a2)
{
  _UNKNOWN **result; // rax
  __int64 v5; // rcx
  ...
  if ( *(_QWORD *)(a1 + 496) )
  {
    ...
    if ( !result )
    {
      ...
      v18 = 0LL;
      v19 = 0;
      sub_1800287FC(*a2 + 24LL, (__int64)v20);
      (*(void (__fastcall **)(_QWORD, __int128 *))(*(_QWORD *)*a2 + 88LL))(*a2, &v6);
      sub_180028584((__int64)v20);
  ...
  if ( v5 )
    return (_UNKNOWN **)sub_18001060C(v5);
  return result;
}
