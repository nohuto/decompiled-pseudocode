/*
 * XREFs of sub_180089B74 @ 0x180089B74
 * Callers:
...
void __fastcall sub_180089B74(char *a1, char *a2, float *a3, __int64 a4, __int64 a5, void *a6, __int64 a7, char a8)
{
  float *v8; // rax
  __int64 v11; // rdi
  __int64 v12; // r8
  ...
  if ( a2 != (char *)a3 )
  {
    ...
    while ( a1 != a2 )
    {
      if ( *(float *)a1 > *(float *)a2 )
      {
        ...
        {
          if ( v12 > a7 )
            sub_1800898DC((float *)a1, a2, v11, a4, v12, a6, a7, a8);
          else
            sub_18008A680(a1);
        }
        else
