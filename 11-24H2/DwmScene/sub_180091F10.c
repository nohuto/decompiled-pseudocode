...
_QWORD *__fastcall sub_180091F10(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  _QWORD *v6; // r13
  __int64 v8; // rdi
  ...
  v6 = (_QWORD *)a2;
  v72 = a2;
  sub_180027ADC((__int64)Buf2, 16LL, 16LL, (__int64 (__fastcall *)(__int64))unknown_libname_7);
  sub_180027ADC((__int64)v86, 16LL, 16LL, (__int64 (__fastcall *)(__int64))unknown_libname_7);
  v8 = a1[3];
  v9 = *(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v8 + 88LL);
  v72 = a3 + 8;
  v10 = sub_180011D64(a3 + 8, &v70);
  v9(v8, v10);
  ...
  if ( v11 != (__int64 *)a1[28] )
  {
    ...
    {
      v14 = 0LL;
      v14.m128_f32[0] = (float)(int)sub_180026FE0(*v11);
      v15 = 0LL;
      v15.m128_f32[0] = (float)(int)sub_180027030(*v11);
      v16 = 0LL;
      ...
      *(double *)v21.m128_u64 = v18;
      ...
      v83 = 0LL;
      sub_18004D338(*(_QWORD *)(v22 + 512), (__int64)&unk_1801C8FB8);
      ...
      v26 = sub_180011D64(v72, &v75);
      v23(a1, &v70, v26, v74, v25, v24);
      if ( v76 )
        sub_18001060C(v76);
      sub_18001254C(&v77, &v70);
      v12 += 8LL;
      if ( v71 )
        sub_18001060C(v71);
      v11 += 2;
  ...
  if ( v77 )
  {
    v28 = (float)(int)sub_180026FE0(a1[23]);
    v29 = *(int **)(v27 + 128);
    if ( v29 )
      v30 = *v29;
    else
      v30 = 0;
    sub_18009193C((__int64)a1, (__int64)Buf2, (__int64)v86, (float)v30, v28);
    v31 = *(_QWORD *)sub_18007BFC4(a1[36], &v75);
    std::string::string(v84, "BlurSampleArray");
    v32 = sub_180079FD4(v31, (__int64)v84);
    sub_180011B5C((__int64)v84);
    if ( v76 )
      sub_18001060C(v76);
    v33 = a1[36];
    v34 = (_OWORD *)sub_18007C124(v33, v32, 5);
    v35 = 2LL;
    ...
    v38 = 0LL;
    v38.m128_f32[0] = (float)(int)sub_180026FE0(a1[23]);
    v39 = 0LL;
    v39.m128_f32[0] = (float)(int)sub_180027030(a1[23]);
    v40 = 0LL;
    ...
    *(double *)v44.m128_u64 = v41;
    ...
    v71 = 0LL;
    sub_18004D338(*(_QWORD *)(v73 + 512), (__int64)&unk_1801C8FB8);
    ...
    v48 = sub_180011D64(v72, &v80);
    v45(a1, v48, v74, v47, v46);
    if ( v81 )
      sub_18001060C(v81);
    v49 = a1[36];
    v50 = (_OWORD *)sub_18007C124(v49, v32, 5);
    ...
    v52 = 0LL;
    v52.m128_f32[0] = (float)(int)sub_180026FE0(a1[23]);
    v53 = 0LL;
    v53.m128_f32[0] = (float)(int)sub_180027030(a1[23]);
    v52.m128_u64[0] = _mm_unpacklo_ps(v53, v52).m128_u64[0];
    *(float *)&v67 = COERCE_FLOAT(a1[33]) / v52.m128_f32[0];
    v54 = 0LL;
    v54.m128_f32[0] = (float)(int)sub_180026FE0(a1[25]);
    v55 = 0LL;
    v55.m128_f32[0] = (float)(int)sub_180027030(a1[25]);
    v56 = 0LL;
    ...
    v64 = sub_18002563C(a1[23], v84);
    v65 = sub_180011D64(v72, &v80);
    v62(a1, v65, v74, v64, v63);
    if ( v81 )
      sub_18001060C(v81);
  }
  v70 = 0x3F8000003F800000LL;
  v71 = _mm_srli_si128((__m128i)xmmword_18018D380, 8).m128i_u64[0];
  sub_18004D338(*(_QWORD *)(v73 + 512), (__int64)&unk_1801C8FB8);
  sub_18002563C(a1[25], v6);
  if ( v78 )
    sub_18001060C(v78);
  return v6;
}
