/*
 * XREFs of sub_1800D2940 @ 0x1800D2940
 * Callers:
...
__int64 __fastcall sub_1800D2940(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  __int64 v8; // r9
  int v10; // r11d
  _QWORD *v11; // r10
  ...
  while ( (unsigned int)v14 < v17 )
  {
      ...
      || (v20 = *(unsigned __int16 *)(v8 + 2LL * (unsigned int)(v14 + 2)), v20 >= a2) )
    {
      ...
      sub_1800D3430(pExceptionObject, v25);
    ...
    v21 = v12 && (v14 & 1) != 0;
    result = sub_1800D3854(v10, v18, v19, v20, v21, a7);
