/*
 * XREFs of sub_180020280 @ 0x180020280
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_180020280(__int64 a1, __int64 a2, __int64 a3, wchar_t *a4, __int64 a5, __int64 a6)
{
  wchar_t *v6; // r8
  __int64 v7; // r10
  __int64 v8; // rcx
  ...
  if ( (unsigned int)dword_1801B9188 > 5 )
  {
    v11 = a6;
    v12 = a5;
    v13 = sub_18001F5B4(a4);
    v14 = sub_18001F5B4(v6);
    v15 = v7;
    sub_180001010(v8, (__int64)&unk_18019C7C1, v9, v10, &v15, (__int64)&v14, (__int64)&v13, &v12, &v11);
  }
}
