/*
 * XREFs of sub_18000D2B8 @ 0x18000D2B8
 * Callers:
...
__int64 __fastcall sub_18000D2B8(int a1, int a2, int a3, int a4, __int64 a5, __int64 a6, __int64 a7, __int64 a8)
{
  __int64 result; // rax
  ...
  LOBYTE(v13) = 0;
  result = sub_18000E984(a1, a2, a3, a4, a5, a6, 2, a7, a8, v13, OutputString, 2048, (__int64)v15, 1024, (__int64)v14);
  if ( (v14[4] & 1) != 0 )
    sub_18000FB2C(v14);
  return result;
}
