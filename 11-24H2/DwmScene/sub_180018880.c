/*
 * XREFs of sub_180018880 @ 0x180018880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180018880(__int64 a1, __int64 a2, _OWORD *a3, unsigned __int8 a4)
{
  int v4; // r14d
  _QWORD *v8; // r9
  __int64 v9; // r8
  ...
  try
  {
    ...
    v10 = v59;
    sub_18002867C(v59 + 16, v63);
    v11 = sub_180012444((__int64)&v46, (__int64)&unk_1801C5038);
    sub_180015F84(v10, &v44, v11);
    sub_18004E580(v44, a2 + 48);
    if ( v45 )
      sub_18001060C(v45);
    ...
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 64) + 280LL))(*(_QWORD *)(a1 + 64)) )
    {
      ...
      *(_QWORD *)(v14 + 304) = 0LL;
      ...
      sub_180058CAC(v42, 0LL, *(_QWORD *)&v17, 1LL);
      v18 = *(_DWORD *)(a1 + 140);
      v19 = *(_DWORD *)(a1 + 132);
      v20 = *(_DWORD *)(a1 + 136);
      v21 = *(_DWORD *)(a1 + 128);
      ...
      *(_DWORD *)(v56 + 448) = 8 * (v4 ^ 1);
      ...
      v27 = (_QWORD *)sub_1800183B8(v24, &v46);
      v28 = 0LL;
      v28.m128_u64[0] = _mm_unpacklo_ps(v26, v25).m128_u64[0];
      v29 = 0LL;
      *(double *)v29.m128_u64 = v17;
      sub_180058CAC(*v27, v28.m128_u64[0], _mm_add_ps(v29, v28).m128_u64[0], 1LL);
      if ( *(_QWORD *)((char *)&v47 + 4) )
        sub_18001060C(*(__int64 *)((char *)&v47 + 4));
      v30 = *(_QWORD *)sub_1800183B8(v24, &v46);
    ...
    *(_OWORD *)&v61[32] = a3[2];
    *(_OWORD *)&v61[48] = a3[3];
    sub_180017828((__int64)v64, (__int128 *)v61, &v46);
    sub_180011C04(v42 + 56, &v56);
    v37 = sub_1800183EC(v64, (__int64)v61);
    sub_18003B5AC(v56, v37);
    if ( v57 )
      sub_18001060C(v57);
    sub_180057828(v42);
    ...
    *(_OWORD *)&v61[44] = 0LL;
    ...
    v40 = 0x40000000u;
    *(double *)&v40 = sub_18001A808();
    *(_OWORD *)v61 = v40;
    *(_OWORD *)&v61[16] = 0x40000000u;
    *(_OWORD *)&v61[32] = v39;
    *(_OWORD *)&v61[48] = v38;
    sub_180017828((__int64)v64, (__int128 *)v61, &v46);
    sub_18001A38C(v42, 5LL);
    sub_18001A2B0(v42, v64);
    sub_180011044((__int64)v63);
    sub_180053048(*(_QWORD *)(a1 + 48), &v42);
    sub_18005360C(*(_QWORD *)(a1 + 48));
    sub_18005355C(*(_QWORD *)(a1 + 48), &v42);
    if ( v43 )
      sub_18001060C(v43);
    if ( v60 )
      sub_18001060C(v60);
