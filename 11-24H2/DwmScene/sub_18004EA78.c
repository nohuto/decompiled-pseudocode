/*
 * XREFs of sub_18004EA78 @ 0x18004EA78
 * Callers:
...
int __fastcall sub_18004EA78(__int64 a1)
{
  ...
  v7[1] = a1 + 16;
  sub_180011C30(a1 + 16);
  v7[0] = _std_type_info_hash(&qword_1801BA5C8);
  v3 = *(_QWORD *)sub_18004F18C(a1, v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_55ce5d336e7bc116043b5e90d1e00759_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
