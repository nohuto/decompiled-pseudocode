/*
 * XREFs of sub_1800BF2C8 @ 0x1800BF2C8
 * Callers:
...
__int64 *__fastcall sub_1800BF2C8(__int64 *a1, __int64 *a2, int a3, int a4, __int64 **a5, __int64 a6)
{
  const char *v10; // rax
  _QWORD *v11; // rax
  __int64 v12; // rdi
  ...
  v35 = a6;
  v29 = 0;
  v10 = (const char *)sub_1800138F8(a6);
  sub_180011524(*a5, v10);
  v33 = 0;
  *(_DWORD *)v32 = sub_1800BD870(16, 0);
  ...
  *(_QWORD *)&v38[12] = 3LL;
  v26 = 0LL;
  v11 = sub_1800B9B64(*a2, &v27);
  v12 = *v11;
  v13 = *(int (__fastcall **)(__int64, __int128 *, _QWORD, __int64 **))(*(_QWORD *)*v11 + 40LL);
  sub_18000E954((__int64 *)&v26);
  v14 = v13(v12, &v37, 0LL, &v26);
  sub_18000E954((__int64 *)&v27);
  sub_1800BB2F8(*a2, v14);
  ...
  sub_180011524(v26, "BackBufferStaging");
  v25 = 0LL;
  v15 = sub_1800B9B64(*a2, &v24);
  v16 = *v15;
  ...
  v19 = (const char *)sub_1800138F8(a6);
  sub_180011524(v25, v19);
  sub_180010790(*a2, a1);
  v29 = 1;
  v20 = *a1;
  ...
  v22 = (_QWORD *)_RTDynamicCast(
                    *a1,
                    ...
                    1);
  v24 = v26;
  sub_1800115D0((__int64 *)&v24);
  v28 = *a5;
  sub_1800115D0((__int64 *)&v28);
  v27 = v25;
  if ( v25 )
    (*(void (__fastcall **)(__int64 *))(*v25 + 8))(v25);
  sub_1800BEE5C(v22, (__int64 *)&v27, (__int64 *)&v28, (__int64 *)&v24, a3, v30);
