/*
 * XREFs of sub_18003E51C @ 0x18003E51C
 * Callers:
...
void __fastcall sub_18003E51C(__int64 a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm5
  __m128 v4; // xmm6
  __m128 v5; // xmm4
  ...
  v9 = _mm_mul_ps(_mm_sub_ps(v8, v7), (__m128)xmmword_18018D550);
  v10 = _mm_mul_ps(_mm_add_ps(v8, v7), (__m128)xmmword_18018D550);
