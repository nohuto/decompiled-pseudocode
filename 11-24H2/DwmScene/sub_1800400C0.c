/*
 * XREFs of sub_1800400C0 @ 0x1800400C0
 * Callers:
...
unsigned __int64 __fastcall sub_1800400C0(_QWORD *a1, unsigned __int64 a2)
{
  ...
  sub_18003FEE0((__int64)(a1 + 3), 2 * v6, v4);
  a1[7] = v6;
  a1[6] = v6 - 1;
  v8 = *(_QWORD **)a1[1];
  v9 = v8;
  ...
  {
    v9 = (_QWORD *)*v9;
    v10 = sub_18001E5E0((__int64)v7, (__int64)(v8 + 2), 8uLL);
    v13 = a1[3];
    v14 = 2 * (a1[6] & v10);
