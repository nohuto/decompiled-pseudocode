/*
 * XREFs of sub_1800B90C0 @ 0x1800B90C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800B90C0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 *v6; // rax
  __int64 *v7; // rax
  __int64 *v8; // rax
  ...
  sub_18002863C(a1 + 24, (__int64)v45);
  (*(void (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)a3 + 320LL))(a3, v44);
  v6 = unknown_libname_81(&v35, (_QWORD *)(a1 + 272));
  sub_180017024(&v42, v6);
  sub_1800C3044(v42, &v30);
  (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)a3 + 32LL))(a3, &v31);
  sub_18002563C(v31, &v35);
  v7 = sub_180052358(v35, &v33, *(_DWORD *)(a1 + 244));
  sub_180017024(&v40, v7);
  sub_1800B9D44(v31, &v33);
  v8 = sub_180052358(v33, v29, *(_DWORD *)(a1 + 244));
  sub_180017024(&v38, v8);
  v9 = v30;
  v10 = *(void (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v30 + 376LL);
  v11 = *(_QWORD *)sub_1800C22A4(v40, &v28);
  v12 = (_QWORD *)sub_1800C22A4(v38, v29);
  v10(v9, *v12, v11);
  sub_18000E954(v29);
  sub_18000E954(&v28);
  sub_1800C22A4(v38, v29);
  *(_OWORD *)Src = 0LL;
  v13 = v29[0];
  ...
  v24 = LODWORD(Src[1]);
  v25 = (char *)Src[0];
  for ( i = (char *)sub_180025A2C(v17, a2, v16, v22 * 4 * v19); v22; --v22 )
  {
    memcpy(i, v25, v23);
    v25 += v24;
    i += v23;
  ...
  if ( v43 )
    sub_18001060C(v43);
  sub_180029CE0((__int64)v44);
  sub_180011044((__int64)v45);
  return 1;
}
