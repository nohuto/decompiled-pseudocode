/*
 * XREFs of sub_1800B79F8 @ 0x1800B79F8
 * Callers:
...
int __fastcall sub_1800B79F8(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801BACB0);
  v3 = *(_QWORD *)sub_18004F18C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_556c08597dcc0a279de66e0fd68990af_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
