/*
 * XREFs of sub_18004D7D4 @ 0x18004D7D4
 * Callers:
 ...
 *     sub_18001D774 @ 0x18001D774 (sub_18001D774.c)
 *     sub_18004DBE0 @ 0x18004DBE0 (sub_18004DBE0.c)
 *     sub_18004E870 @ 0x18004E870 (sub_18004E870.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_18004D7D4(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v17[8] )
  {
    ...
    for ( i = std::streambuf::sgetc(v9); ; i = std::streambuf::snextc(v13) )
    {
      ...
      LOBYTE(v12) = sub_18001D768(v11);
      sub_18001D6AC(a2, v12);
      v7 = 1;
