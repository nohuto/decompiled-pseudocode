/*
 * XREFs of sub_180014270 @ 0x180014270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180014270(__int64 a1, __int64 a2)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  __int128 *v5; // rax
  ...
  try
  {
    ...
    v4 = *(_QWORD *)sub_18001268C(v10, &v12) + 16LL;
    sub_18002867C(v4, v18);
    if ( *((_QWORD *)&v12 + 1) )
      sub_18001060C(*((__int64 *)&v12 + 1));
    sub_180013ED4(v10, &v13);
    if ( a2 )
    {
