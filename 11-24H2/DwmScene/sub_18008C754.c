/*
 * XREFs of sub_18008C754 @ 0x18008C754
 * Callers:
...
char *__fastcall sub_18008C754(__int64 *a1, __int64 a2, _QWORD *a3)
{
  __int64 v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r14
  ...
  if ( a2 != v14 )
  {
    sub_180012384(v16, a2, v11);
    v14 = a1[1];
    v15 = v13 + 16;
    v16 = a2;
  }
  sub_180012384(v16, v14, v15);
  sub_180013040((__int64)a1, (__int64)v11, v8, v9);
  return v13;
}
