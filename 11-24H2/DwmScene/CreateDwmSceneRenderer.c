/*
 * XREFs of CreateDwmSceneRenderer @ 0x180010670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateDwmSceneRenderer(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
  {
    ...
    v8 = sub_180010180((__int64 *)&v12, (__int64)a1);
    v6 = v8;
    if ( v8 >= 0 )
    {
      v8 = (**v12)(v12, a2, a3);
...
LABEL_14:
  ...
  v7 = 20LL;
LABEL_3:
  sub_18000F1E4(retaddr, v7, (__int64)"onecoreuap\\windows\\dwm\\spectre\\dwmscene\\source\\dwmsceneapi.cpp", v6);
  return v6;
}
