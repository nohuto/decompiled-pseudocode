...
int __fastcall sub_18000F61C(__int64 a1, __int64 a2)
{
  _WORD *v2; // rax
  int v3; // edi
  _WORD *v6; // rcx
  ...
  if ( v7 )
  {
    ...
    *(_WORD *)(a1 + 34) = v9;
    LODWORD(v2) = sub_18000F254(v7 + 80LL * v9, a2, _InterlockedIncrement(*(volatile signed __int32 **)(a1 + 8)));
  }
  return (int)v2;
}
