...
char __fastcall sub_1800C5A60(__int64 a1, __int64 *a2, const void *a3, int a4)
{
  __int64 *v6; // rax
  char v7; // bl
  __int64 v8; // rdi
  ...
  if ( *a2 )
  {
    v6 = sub_180052358(*a2, &v38, *(_DWORD *)(a1 + 88));
    v7 = 1;
    v8 = *v6;
  }
  else
  ...
  *v6 = 0LL;
  ...
  if ( (v7 & 1) != 0 && v39 )
    sub_18001060C(v39);
  v10 = -((unsigned int)sub_180052560(v8) != 2);
  sub_1800C2730(&v33, v35);
  v32 = 0LL;
  LODWORD(v40) = 1;
  v11 = *(_QWORD *)(*a2 + 128);
  v12 = (__int64 *)(a1 + 144);
  ...
  {
    v23 = sub_1800523AC(v16);
    sub_1800C31AC(v23);
    v24 = sub_1800524B0(v16);
    v26 = (int)v40 * DWORD2(v32) * v24 / v25;
    if ( v26 == v43 )
    {
      sub_1800100E4((void *)v32, v26, v42, v26);
      v22 = 1;
    }
    v27 = *sub_1800C22A4(v16, &v40);
    sub_18000E954(&v40);
    v28 = *v13;
    v29 = **v13;
    if ( v27 )
      v30 = sub_1800C22A4(v16, &v40);
    else
      v30 = sub_1800C226C(v16, &v40);
