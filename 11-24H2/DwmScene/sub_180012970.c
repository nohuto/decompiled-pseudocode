...
__int64 __fastcall sub_180012970(__int64 a1, _OWORD *a2)
{
  _QWORD *v4; // rax
  unsigned int v5; // ebx
  __int128 v6; // xmm1
  ...
  v4 = (_QWORD *)sub_18001268C(*(_QWORD *)(a1 + 16), &v10);
  sub_18002867C(*v4 + 16LL, v12);
  v5 = 0;
  if ( v11 )
    sub_18001060C(v11);
  v6 = a2[1];
  ...
  v13[2] = v7;
  v13[3] = v8;
  if ( !(unsigned __int8)sub_18003B5AC(*(_QWORD *)(a1 + 16), v13) )
  {
    v5 = -2147024809;
    sub_18000F1E4(
      retaddr,
