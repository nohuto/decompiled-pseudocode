/*
 * XREFs of sub_1800D14F4 @ 0x1800D14F4
 * Callers:
...
__int64 __fastcall sub_1800D14F4(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rax
  __int64 v7; // r8
  __int64 v8; // rcx
  ...
  {
    sub_1800D0DD4((__int64)a1);
    v17 = a3;
    v15 = a1 + 1;
    v10 = (_QWORD *)sub_18001B1F8(176LL);
    v16 = v10;
    sub_1800CFA8C(v11, (__int64)(v10 + 2), v12, &v17);
