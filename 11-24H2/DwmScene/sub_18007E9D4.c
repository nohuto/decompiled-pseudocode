/*
 * XREFs of sub_18007E9D4 @ 0x18007E9D4
 * Callers:
...
__int64 __fastcall sub_18007E9D4(_QWORD *a1, float a2, float a3, float a4, int a5, int a6)
{
  __int64 v7; // rcx
  __int64 v10; // rax
  __int128 v11; // xmm0
  ...
  *(_QWORD *)&v11 = *(_QWORD *)(v10 + 64);
    ...
    || HIDWORD(v34) != a6 )
  {
    ...
    v31.m128_i8[8] = 1;
    HIDWORD(v34) = a6;
    result = sub_18007F020(v7, &v30, 0LL);
    v15 = a1[8];
    if ( v15 )
    {
      v16 = *(_QWORD *)(v15 + 112);
      ...
      v31.m128_u64[0] = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v33 = v19;
      result = sub_18007F020(v15, &v30, 0LL);
    }
    v20 = a1[10];
    if ( v20 )
    {
      ...
      v31.m128_u64[0] = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v33 = v24;
      result = sub_18007F020(v20, &v30, 0LL);
    }
    v25 = a1[12];
    if ( v25 )
    {
      ...
      v31.m128_u64[0] = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v33 = v29;
      return sub_18007F020(v25, &v30, 0LL);
    }
  }
  return result;
}
