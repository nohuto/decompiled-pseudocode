/*
 * XREFs of sub_1800BD9EC @ 0x1800BD9EC
 * Callers:
 ...
 *     sub_1800BED0C @ 0x1800BED0C (sub_1800BED0C.c)
 */

_QWORD *__fastcall sub_1800BD9EC(__int64 a1, _QWORD *a2, int a3)
{
  __int64 v5; // r10
  __int64 *v6; // r11
  __int64 v7; // r11
  ...
  v21 = a3;
  if ( sub_1800BEC30(a1 + 1616, &v21) )
  {
    *a2 = *(_QWORD *)sub_1800BEBE0(v6, &v21);
    return a2;
  }
  ...
  sub_180040B74(v6, v19, &v21);
  sub_1800BED0C(v7, &v20, &v21);
  v10 = *v9;
  if ( v8 != (__int64 *)**v9 )
  {
    if ( *((_BYTE *)v8 + 25) )
