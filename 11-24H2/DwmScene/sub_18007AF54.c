/*
 * XREFs of sub_18007AF54 @ 0x18007AF54
 * Callers:
 ...
 *     sub_18007B0B8 @ 0x18007B0B8 (sub_18007B0B8.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_18007AF54(_QWORD *a1, __int64 a2, unsigned int *a3)
{
  __int64 *v5; // r14
  __int64 *v6; // rax
  __int64 *v7; // rdx
  ...
  if ( *((_BYTE *)v7 + 25) || *a3 < *((_DWORD *)v7 + 7) )
  {
    ...
    v16 = a3;
    *(_QWORD *)&v14 = a1;
    v9 = sub_18002768C(1uLL);
    v10 = std::_Allocate<16,std::_Default_allocate_traits,0>(v9);
    sub_18007B0B8(v11, v10 + 28, v12, &v16);
    *(_QWORD *)v10 = v5;
    *(_QWORD *)(v10 + 8) = v5;
    *(_QWORD *)(v10 + 16) = v5;
    *(_WORD *)(v10 + 24) = 0;
    *((_QWORD *)&v14 + 1) = 0LL;
    sub_180027920((__int64)&v14);
    v14 = v15;
