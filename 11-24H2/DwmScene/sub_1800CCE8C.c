/*
 * XREFs of sub_1800CCE8C @ 0x1800CCE8C
 * Callers:
...
char *__fastcall sub_1800CCE8C(_QWORD *a1, _BYTE *a2, _DWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  v8 = v6 + 1;
  v17 = sub_18001E484(a1, v6 + 1);
  v10 = (char *)sub_180016764(v9, &v17);
  v11 = &v10[4 * ((a2 - v3) >> 2)];
  *(_DWORD *)v11 = *a3;
  v12 = v10;
  v13 = (_BYTE *)a1[1];
  ...
  memmove(v12, v14, v15);
  sub_18001E4FC((__int64)a1, (__int64)v10, v8, v17);
