/*
 * XREFs of sub_180020C00 @ 0x180020C00
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall sub_180020C00(__int64 a1, int a2, void *a3)
{
  ...
  if ( (unsigned int)CallbackContext > 5 )
  {
    ...
    if ( result )
    {
      ...
      return sub_180001908(v8, byte_18019D8AF, v9, v10, (void **)&v15, (__int64)&v12, &v14, (__int64)&v11, &v13);
    }
  }
  return result;
}
