/*
 * XREFs of sub_18001F780 @ 0x18001F780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18001F780(__int64 a1, unsigned int a2)
{
...
LABEL_12:
      v20 = v12;
      v13 = (char *)sub_1800109E8(v9, (unsigned __int64 *)&v20);
      memcpy(v13, v10, v11);
      *(_QWORD *)(a1 + 104) = &v13[v11 + 1];
      ...
      if ( (*(_BYTE *)(a1 + 112) & 1) != 0 )
        sub_180010234(v10, v11);
      *(_DWORD *)(a1 + 112) |= 1u;
      v19 = (char *)std::streambuf::_Pninc(a1);
      *v19 = sub_18001D768(a2);
      return a2;
    }
    if ( v11 < 0x3FFFFFFF )
    {
