/*
 * XREFs of sub_180085E20 @ 0x180085E20
 * Callers:
...
char __fastcall sub_180085E20(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 32) = 2;
  ...
  while ( 1 )
  {
    v8 = sub_18004D944(a2, (__int64)&v29);
    if ( !(unsigned __int8)std::ios_base::operator bool(v8 + *(int *)(*(_QWORD *)v8 + 4LL)) )
      break;
    if ( v30 )
    {
      v9 = (_BYTE *)sub_1800138F8((__int64)&v29);
      if ( v10 != 1 || (*v9 != 13 ? (v11 = *v9 < 0xDu ? -1 : 1) : (v11 = 0), v11) )
      {
        v12 = (const __m128i *)sub_1800138F8((__int64)&v29);
        if ( v12->m128i_i8[0] != 35 )
        {
          v14 = (_QWORD *)(a3 + 8);
          if ( v5 )
          {
            sub_18004D9E0(v28, (__int64)&v29);
            v27 = 0;
            v26 = 0;
            v25 = 0;
          ...
          {
            v24[0] = 32;
            v5 = sub_180085180(v12, (const __m128i *)((char *)v12 + v13), v24) + 1;
            v6 = v5 * v5 * v5;
            ...
            if ( v6 > v16 )
            {
              ...
              {
                v17 = sub_180085128(*(_QWORD *)(a3 + 16), v6 - v16, a3 + 8);
LABEL_17:
                *(_QWORD *)(a3 + 16) = v17;
              }
              else
              {
                sub_180084F80(a3 + 8, v5 * v5 * v5, v15);
              }
            }
          }
        }
  ...
  *(_QWORD *)a3 = v5;
  return sub_180011B5C((__int64)&v29);
}
