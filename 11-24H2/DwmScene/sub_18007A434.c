/*
 * XREFs of sub_18007A434 @ 0x18007A434
 * Callers:
...
__int64 __fastcall sub_18007A434(__int64 a1, _QWORD *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  _QWORD *v6; // r15
  ...
  if ( *(_DWORD *)(a1 + 1168) != 1 )
  {
    ...
    v4 = std::string::string(
           ...
           "ropertylayout.cpp");
    sub_180038BB8(pExceptionObject, (__int64)v4, v5, (__int64)v29, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  sub_18001254C((__int64 *)(a1 + 1176), a2);
  v6 = (_QWORD *)(a1 + 1192);
  v7 = *(_QWORD *)(a1 + 1192);
    ...
    if ( *(_DWORD *)(v10 + 48) )
    {
      ...
      if ( (_WORD)v12 == 0xFFFF )
      {
        v21 = sub_18001B6DC(
                ...
                v10);
        v22 = sub_18001B5A8((__int64)v30, (__int64)v21, (__int64)"' required for import by this layout");
        v23 = std::string::string(
                v29,
                "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\sh"
                "aderpropertylayout.cpp");
        sub_180038BB8(v32, (__int64)v23, v24, v22, 0);
      ...
      if ( v14 != *(_DWORD *)(v13 + 36) )
      {
        v17 = sub_18001B6DC(
                ...
                v10);
        v18 = sub_18001B5A8((__int64)pExceptionObject, (__int64)v17, (__int64)"' imported by this layout");
        v19 = std::string::string(
                v29,
                "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\sh"
                "aderpropertylayout.cpp");
        sub_180038BB8(v32, (__int64)v19, v20, v18, 0);
        throw (Spectre::Engine::EngineInvalidArgException *)v32;
      }
      if ( v14 == 8 )
      {
        ...
        sub_180078DC8(v8, v28);
      }
      else
      {
        v15 = sub_18007A340(v14);
        for ( i = 0; i < v15; ++i )
        {
          LODWORD(v26) = i + *(_DWORD *)(v13 + 40);
          HIDWORD(v26) = i + *(_DWORD *)(v10 + 40);
          sub_180078DC8(v6, &v26);
        }
      }
      result = v27;
    }
