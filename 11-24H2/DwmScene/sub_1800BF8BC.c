/*
 * XREFs of sub_1800BF8BC @ 0x1800BF8BC
 * Callers:
...
__int64 __fastcall sub_1800BF8BC(__int64 a1, __int64 a2, int a3, int a4, __int64 a5)
{
  __int64 v5; // rbx
  unsigned int v7; // r9d
  int v8; // r10d
  ...
  v21 = *(_DWORD *)(v5 + 28);
  v20 = v15;
  v16 = sub_180050F94(&v19, (_DWORD *)v5, (int *)(v5 + 4), (int *)&a5, &v20, &v21);
  v17 = *v16;
  *v16 = 0LL;
  a5 = v17;
  sub_180051510(&v19);
  sub_1800BFD24(a1, &a5, v5 + 8, &v22);
