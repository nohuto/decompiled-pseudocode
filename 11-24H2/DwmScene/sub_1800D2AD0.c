...
__int64 __fastcall sub_1800D2AD0(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  int v9; // r11d
  _QWORD *v10; // r9
  ...
  while ( (unsigned int)v13 < v16 )
  {
    ...
    if ( v17 >= a2 || v18 >= a2 || v19 >= a2 )
    {
      ...
      sub_1800D3430(pExceptionObject, v24);
    ...
    v20 = v11 && (v13 & 1) != 0;
    result = sub_1800D3854(v9, v17, v18, v19, v20, a7);
