/*
 * XREFs of sub_1800B70C0 @ 0x1800B70C0
 * Callers:
...
int __fastcall sub_1800B70C0(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B9FA8);
  v3 = *(_QWORD *)sub_18004F18C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_53997277a49255653d15a2e9d753df18_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
