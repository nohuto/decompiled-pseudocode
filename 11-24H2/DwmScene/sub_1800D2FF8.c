/*
 * XREFs of sub_1800D2FF8 @ 0x1800D2FF8
 * Callers:
...
__int64 __fastcall sub_1800D2FF8(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  while ( (unsigned int)v16 < v19 )
  {
      ...
      || (v22 = *(unsigned __int16 *)(v11 + 2LL * (unsigned int)(v16 + 2)), v22 >= a2) )
    {
      ...
      sub_1800D3430(pExceptionObject, v29);
    ...
    v23 = v15 && (v16 & 1) != 0;
    sub_1800D4648(a1, v13, v20, v21, v22, v23, a9, a10);
    result = sub_1800D3854(v24, v25, v21, v22, v23, a8);
