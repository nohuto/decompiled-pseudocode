/*
 * XREFs of sub_180056E40 @ 0x180056E40
 * Callers:
...
bool __fastcall sub_180056E40(__int64 a1, __int64 a2)
{
  __int64 v4; // rdi
  float v5; // xmm6_4
  char v6; // al
  ...
  if ( !(unsigned __int8)sub_180078530() )
    return 0;
  v4 = _RTDynamicCast(
         a2,
         0LL,
         ...
         1);
  if ( !sub_1800540B4((__int64 *)(v4 + 104), (_QWORD *)(a1 + 104)) )
    return 0;
  ...
  if ( *(_DWORD *)(v4 + 176) != *(_DWORD *)(a1 + 176) )
    return 0;
  if ( sub_18001B53C(v4 + 216, a1 + 216) )
    return 0;
  if ( sub_18001B53C(v4 + 248, a1 + 248) )
    return 0;
  ...
  if ( *(_BYTE *)(v4 + 388) )
  {
    if ( !v6 )
      return 0;
    v7 = sub_180041104((_DWORD *)(v4 + 372), (_DWORD *)(a1 + 372));
  }
  else
  {
    v7 = v6 == 0;
  ...
  return v7
      ...
      && !sub_1800541D0((__int64 *)(v4 + 416), (_QWORD *)(a1 + 416))
      ...
      && !sub_180054158(v4 + 1616, a1 + 1616)
      && sub_180045074(*(_QWORD *)(v4 + 1696), *(_QWORD *)(a1 + 1696))
      && !*(_QWORD *)(v4 + 1760)
      && !*(_QWORD *)(a1 + 1760);
}
