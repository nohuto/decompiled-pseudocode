/*
 * XREFs of _lambda_201f500c0b3e8aa9f89acabd232435e5_::operator() @ 0x1800A40B8
 * Callers:
 *     wil::details::functor_wrapper_void__lambda_201f500c0b3e8aa9f89acabd232435e5__&_::Run @ 0x1800A55E0 (wil--details--functor_wrapper_void__lambda_201f500c0b3e8aa9f89acabd232435e5__-_--Run.c)
 * Callees:
 ...
 *     ??$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A3AC0 (--$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA-AV-.c)
 *     ??$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA?AV?$com_ptr_t@UIUriRuntimeClassFactory@Foundation@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A3B60 (--$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA-AV-$c_ea_1800A3B60.c)
 *     ??$query@UISecondaryTile2@StartScreen@UI@Windows@@@?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTile2@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A3E24 (--$query@UISecondaryTile2@StartScreen@UI@Windows@@@-$com_ptr_t@UISecondaryTile@StartScreen@UI@Wi.c)
 *     ??$query@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@@?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A3ECC (--$query@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@@-$com_ptr_t@UISecondaryTile@St.c)
 *     ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x1800A45D4 (-CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z.c)
 *     ?CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA?AVHString@Wrappers@WRL@Microsoft@@PEB_W@Z @ 0x1800A484C (-CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA-AVHString@Wrapp.c)
...
void __fastcall lambda_201f500c0b3e8aa9f89acabd232435e5_::operator()(__int64 a1)
{
  ...
  *(_QWORD *)v51 = 0LL;
  ...
  v33 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v57, (const WCHAR **)&off_1800DD2F0, v32);
  ...
  v43 = v46;
  v44 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v57, (const WCHAR **)&off_1800DD2F0, v40);
