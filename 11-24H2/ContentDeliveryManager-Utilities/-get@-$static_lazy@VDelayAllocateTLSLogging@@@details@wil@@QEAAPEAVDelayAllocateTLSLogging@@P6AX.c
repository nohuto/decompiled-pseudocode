/*
 * XREFs of ?get@?$static_lazy@VDelayAllocateTLSLogging@@@details@wil@@QEAAPEAVDelayAllocateTLSLogging@@P6AXXZ@Z @ 0x18003E4C4
 * Callers:
 *     ??$Allocated@AEAPEBG@DelayAllocateTLSTelemetry@@SAXAEAPEBG@Z @ 0x1800246D0 (--$Allocated@AEAPEBG@DelayAllocateTLSTelemetry@@SAXAEAPEBG@Z.c)
 * Callees:
...
__int64 *__fastcall wil::details::static_lazy<DelayAllocateTLSLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`DelayAllocateTLSLogging::Instance'::`2'::wrapper, 0, &v8, (LPVOID *)&v10) && v8 )
  {
    ...
    dword_18017B4A4 = 0;
    v10 = &qword_18017B490;
    qword_18017B490 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    v6 = &`DelayAllocateTLSLogging::Instance'::`2'::wrapper;
    byte_18017B4A0 = 0;
    qword_18017B4A8 = (__int64)&`DelayAllocateTLSLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
