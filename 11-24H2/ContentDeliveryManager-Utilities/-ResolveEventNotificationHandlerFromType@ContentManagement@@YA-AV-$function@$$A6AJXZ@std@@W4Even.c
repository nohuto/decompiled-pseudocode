/*
 * XREFs of ?ResolveEventNotificationHandlerFromType@ContentManagement@@YA?AV?$function@$$A6AJXZ@std@@W4EventNotificationType@1@@Z @ 0x180056C58
 * Callers:
...
_QWORD *__fastcall ContentManagement::ResolveEventNotificationHandlerFromType(_QWORD *a1, int a2)
{
  ...
  v3 = 0LL;
  for ( i = &unk_180179190; ; i += 5 )
  {
    if ( i == (_QWORD *)&unk_180179208 )
    {
