 ...
 *     ?_EnsureCount@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAXXZ @ 0x18003D668 (-_EnsureCount@-$NativeString@V-$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAXXZ.c)
 ...
 *     ?SetUriParam@CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@AEAAJPEBG0@Z @ 0x18007162C (-SetUriParam@CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@AEAAJPEBG0@Z.c)
 *     ?_Initialize@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_K@Z @ 0x180071770 (-_Initialize@-$NativeString@V-$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_.c)
        ...
        const unsigned __int16 *a2)
{
  ...
  __int64 v39; // rdx
  _WORD *v40; // rax
  _BYTE v42[8]; // [rsp+30h] [rbp-69h] BYREF
...
LABEL_66:
    ...
    v44 = 0LL;
    v11 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v43 + 136LL))(v43, &v44);
    v6 = v11;
    if ( v11 < 0 )
    {
...
LABEL_64:
    ...
    v45 = 0LL;
    v15 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v43 + 104LL))(v43, &v45);
    v6 = v15;
    if ( v15 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
...
LABEL_61:
    ...
    if ( v17 >= 0 )
    {
      ...
      if ( v17 >= 0 )
      {
        ...
        v21 = v43;
        v49 = 0LL;
        v22 = *(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v43 + 120LL);
        ...
        if ( v23 >= 0 )
        {
          ...
          if ( v26 >= 0 )
          {
            ...
            {
              v42[0] = 0;
              v32 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v48 + 56LL))(v48, v42);
              v6 = v32;
              if ( v32 >= 0 )
              {
                while ( v42[0] )
...
LABEL_43:
                  ...
                  v36 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v48 + 64LL))(v48, v42);
                  v6 = v36;
                  if ( v36 < 0 )
                  {
                    v39 = 81LL;
