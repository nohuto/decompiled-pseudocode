/*
 * XREFs of ?NotifyForDesktopSpotlightUpdates@SetDesktopWallpaperService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800A2F2C
 * Callers:
 *     ?Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800A26F0 (-Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z @ 0x1800A32F0 (-SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z.c)
