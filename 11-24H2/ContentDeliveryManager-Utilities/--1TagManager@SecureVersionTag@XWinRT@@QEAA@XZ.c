/*
 * XREFs of ??1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ @ 0x18008B020
 * Callers:
 ...
 * Callees:
 *     ?Release@Tag@SecureVersionTag@XWinRT@@QEAAJXZ @ 0x18008B1F4 (-Release@Tag@SecureVersionTag@XWinRT@@QEAAJXZ.c)
 */
