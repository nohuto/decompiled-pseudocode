/*
 * XREFs of ?Release@Tag@SecureVersionTag@XWinRT@@QEAAJXZ @ 0x18008B1F4
 * Callers:
 *     ??1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ @ 0x18008B020 (--1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ.c)
