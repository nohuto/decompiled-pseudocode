/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x18007DAF0
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < 0 )
  {
    ...
    {
      v11 = ContentDeliveryManager::Background::ContentDeliveryManagerLogging::Provider(v5);
      v12 = (__int64)v11;
    ...
    {
      v7 = ContentDeliveryManager::Background::ContentDeliveryManagerLogging::Provider(v5);
