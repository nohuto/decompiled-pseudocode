/*
 * XREFs of ??1LaunchUriService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800987A8
 * Callers:
 *     ??_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x180098AF0 (--_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
