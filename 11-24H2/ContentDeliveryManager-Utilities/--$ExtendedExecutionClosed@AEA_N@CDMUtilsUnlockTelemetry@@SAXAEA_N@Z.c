/*
 * XREFs of ??$ExtendedExecutionClosed@AEA_N@CDMUtilsUnlockTelemetry@@SAXAEA_N@Z @ 0x18008C3D8
 * Callers:
...
char __fastcall CDMUtilsUnlockTelemetry::ExtendedExecutionClosed<bool &>(char *a1)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v6 = v4;
      v9 = 1;
      LOBYTE(v2) = tlgWriteTransfer_EventWriteTransfer(v3, byte_180163E47, 0LL, 0LL, 3u, &v7);
    }
  }
  return (char)v2;
}
