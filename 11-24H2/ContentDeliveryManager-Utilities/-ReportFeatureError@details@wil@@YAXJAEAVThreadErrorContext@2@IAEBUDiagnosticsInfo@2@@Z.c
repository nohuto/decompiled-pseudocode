/*
 * XREFs of ?ReportFeatureError@details@wil@@YAXJAEAVThreadErrorContext@2@IAEBUDiagnosticsInfo@2@@Z @ 0x1800394BC
 * Callers:
 ...
 *     ?RecordFeatureError@details@wil@@YAXIAEBUFailureInfo@2@AEBUDiagnosticsInfo@2@PEAX@Z @ 0x180037548 (-RecordFeatureError@details@wil@@YAXIAEBUFailureInfo@2@AEBUDiagnosticsInfo@2@PEAX@Z.c)
 *     ?SetLastError@wil@@YAXAEBUFailureInfo@1@@Z @ 0x18003B2C8 (-SetLastError@wil@@YAXAEBUFailureInfo@1@@Z.c)
 */
