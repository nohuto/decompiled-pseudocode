/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::ProcessLayoutBindings_::_1_::catch$11 @ 0x1800BC878
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Get@HString@Wrappers@WRL@Microsoft@@QEBAPEAUHSTRING__@@XZ @ 0x18003079C (-Get@HString@Wrappers@WRL@Microsoft@@QEBAPEAUHSTRING__@@XZ.c)
 *     ?Get@HStringReference@Wrappers@WRL@Microsoft@@QEBAPEAUHSTRING__@@XZ @ 0x1800307A8 (-Get@HStringReference@Wrappers@WRL@Microsoft@@QEBAPEAUHSTRING__@@XZ.c)
        ...
        __int64 a2)
{
  ...
  v10 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(
          (HSTRING_HEADER *)(a2 + 488),
          (const WCHAR **)&off_1800DD390,
          v9);
