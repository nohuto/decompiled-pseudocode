/*
 * XREFs of ?SplitString@StringUtils@CommonHelper@CreativeFramework@@YA?AV?$vector@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@std@@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@5@PEB_W@Z @ 0x1800B3458
 * Callers:
...
LABEL_17:
      ...
      v14 = std::wstring::substr(a2, v16, v12, first_of - v12);
      std::vector<std::wstring>::push_back(a1, (unsigned __int64)v14);
