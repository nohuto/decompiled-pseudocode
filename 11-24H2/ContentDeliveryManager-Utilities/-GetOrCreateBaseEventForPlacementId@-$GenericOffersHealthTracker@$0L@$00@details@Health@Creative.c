/*
 * XREFs of ?GetOrCreateBaseEventForPlacementId@?$GenericOffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@CA?AV?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@std@@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@6@@Z @ 0x180052B90
 * Callers:
        ...
        const WCHAR *a2)
{
  ...
  __int64 v10; // rcx
  __int64 v11; // rdx
  char v13[8]; // [rsp+20h] [rbp-29h] BYREF
  ...
  if ( v15 == (_QWORD *)CreativeFramework::Health::details::s_placementToBaseScenarioEventsMap )
  {
    ...
    if ( v15 == (_QWORD *)CreativeFramework::Health::details::s_placementToBaseScenarioEventsMap )
    {
      if ( *((_QWORD *)a2 + 3) < 8uLL )
        ...
        v7 = *(const WCHAR **)a2;
      v13[0] = CreativeFramework::Health::details::GenericOffersHealthTracker<11,1>::ResolveIsCriticalHealthEnabledForPlacementId(v7);
