/*
 * XREFs of ?ReportVariantUsageToService@details@wil@@YAXPEAUwil_details_FeatureReportingCache@@IHHPEBUFEATURE_LOGGED_TRAITS@@HEIW4wil_VariantReportingKind@@_K@Z @ 0x180039E64
 * Callers:
 ...
 *     wil_details_MapVariantReportingKind @ 0x180040758 (wil_details_MapVariantReportingKind.c)
