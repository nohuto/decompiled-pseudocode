/*
 * XREFs of ?GetTaskConditionFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA?AW4TaskConditionFlags@CommonHelper@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x180080E48
 * Callers:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::GetTaskConditionFlagsForTrigger(__int64 *a1)
{
  ...
  if ( v3 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v9);
  v4 = (const wchar_t *)&unk_1800F1E30;
  v5 = 0;
  do
  {
  ...
  while ( v4 != L"Trigger Registration" );
  v6 = *a1;
  v12 = 0;
