/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x18003C454
 * Callers:
 ...
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18003B87C (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
 *     StringCopyWorkerW @ 0x18003BA0C (StringCopyWorkerW.c)
