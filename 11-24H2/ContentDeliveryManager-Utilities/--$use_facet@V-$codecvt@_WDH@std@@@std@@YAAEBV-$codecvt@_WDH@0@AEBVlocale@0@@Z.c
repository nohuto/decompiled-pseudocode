/*
 * XREFs of ??$use_facet@V?$codecvt@_WDH@std@@@std@@YAAEBV?$codecvt@_WDH@0@AEBVlocale@0@@Z @ 0x18000F0F8
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::codecvt<wchar_t,char,int>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::codecvt<wchar_t,char,int>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    else
    {
      ...
      v6 = v12;
      std::_Facetptr<std::codecvt<wchar_t,char,int>>::_Psave = (__int64)v12;
