/*
 * XREFs of ?do_get@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0_NAEAVios_base@2@AEAHAEAO@Z @ 0x1800180F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  v15[1] = -2LL;
  std::money_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getmfld(a1, v16, a3, a4, a5, a6, v18);
