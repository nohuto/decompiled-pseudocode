/*
 * XREFs of ??$use_facet@V?$collate@G@std@@@std@@YAAEBV?$collate@G@0@AEBVlocale@0@@Z @ 0x18000F244
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::collate<unsigned short>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::collate<unsigned short>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::collate<unsigned short>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::collate<unsigned short>>::_Psave = (__int64)v12;
