/*
 * XREFs of ?GetCurrentUserSidString@Actions@CreativeFramework@@YAJPEAPEA_W@Z @ 0x1800A1B1C
 * Callers:
 ...
 *     ?StringCchPrintfW@@YAJPEA_W_KPEB_WZZ @ 0x18008F7A8 (-StringCchPrintfW@@YAJPEA_W_KPEB_WZZ.c)
