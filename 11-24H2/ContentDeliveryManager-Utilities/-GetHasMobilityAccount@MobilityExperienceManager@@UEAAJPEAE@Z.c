/*
 * XREFs of ?GetHasMobilityAccount@MobilityExperienceManager@@UEAAJPEAE@Z @ 0x1800A7870
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??Dvector_iterator_nothrow@?$vector_range_nothrow@U?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@wil@@QEBAAEBV?$ComPtr@UIWebAccount@Credentials@Security@Windows@@@WRL@Microsoft@@XZ @ 0x1800A779C (--Dvector_iterator_nothrow@-$vector_range_nothrow@U-$IVectorView@PEAVWebAccount@Credentials@Secu.c)
 ...
 *     ?get_at_current@?$vector_range_nothrow@U?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@wil@@QEAAXI@Z @ 0x1800A82E8 (-get_at_current@-$vector_range_nothrow@U-$IVectorView@PEAVWebAccount@Credentials@Security@Window.c)
