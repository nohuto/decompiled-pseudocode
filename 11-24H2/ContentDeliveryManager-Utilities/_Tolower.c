/*
 * XREFs of _Tolower @ 0x180005DA8
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x18000B980 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x18000B9A0 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD68 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD74 (_GetLocaleHandleById.c)
 *     __crtLCMapStringA_Stub @ 0x18000DE3C (__crtLCMapStringA_Stub.c)
 */
...
int __cdecl Tolower(int a1, const _Ctypevec *a2)
{
  ...
  if ( (unsigned int)a1 < 0x100 )
  {
    ...
    if ( (a2->_Table[(unsigned __int8)a1] & 1) == 0 )
      return a1;
LABEL_13:
    v10 = ((unsigned int)(*p_Table)[BYTE1(a1)] >> 15) & 1;
    v11 = a1 >> 8;
    goto LABEL_14;
  }
  p_Table = &a2->_Table;
...
LABEL_14:
  ...
  v12 = _crtLCMapStringA_Stub(0LL, LocaleHandleById, 256LL, &v14, v4, &v17, 3, v6, 1);
  if ( !v12 )
    return a1;
  v13 = v12 == 1;
  result = v17;
