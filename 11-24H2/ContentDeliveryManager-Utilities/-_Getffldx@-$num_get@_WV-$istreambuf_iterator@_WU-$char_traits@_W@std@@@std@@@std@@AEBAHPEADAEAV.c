/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x18009EAA0
 * Callers:
        ...
        int *a6)
{
  ...
  v61 = a2;
  v62 = a6;
  v9 = std::ios_base::getloc(a5, (std::locale *)v59);
  v58 = std::use_facet<std::numpunct<wchar_t>>(v9);
  std::locale::~locale((std::locale *)v59);
  std::numpunct<unsigned short>::grouping((__int64)v58, (__int64)v65);
  v10 = std::ios_base::getloc(a5, (std::locale *)&v56);
...
LABEL_7:
  *v12 = 30768;
  ...
  v25 = v64;
  v26 = (void **)v63[0];
  while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v57) )
  {
    ...
    if ( v28 >= 0x16 )
    {
      ...
      if ( *v32 != (_WORD)v56 )
        break;
      std::string::append((__int64)v63, 1uLL, 0);
      ++v13;
      goto LABEL_40;
    }
    v18 = 1;
