/*
 * XREFs of ?get@?$static_lazy@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@@details@wil@@QEAAPEAVContentDeliveryManagerLogging@Background@ContentDeliveryManager@@P6AXXZ@Z @ 0x180045278
 * Callers:
        ...
        void (__cdecl *a2)())
{
    ...
    && v8 )
  {
    ...
    dword_18017B0FC = 0;
    v10 = &qword_18017B0E8;
    qword_18017B0E8 = (__int64)&ContentDeliveryManager::Background::ContentDeliveryManagerLogging::`vftable';
    v6 = &`ContentDeliveryManager::Background::ContentDeliveryManagerLogging::Instance'::`2'::wrapper;
    byte_18017B0F8 = 0;
    qword_18017B100 = (__int64)&`ContentDeliveryManager::Background::ContentDeliveryManagerLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
