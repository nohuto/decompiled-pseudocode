/*
 * XREFs of ??$use_facet@V?$money_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAAEBV?$money_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@AEBVlocale@0@@Z @ 0x18001C344
 * Callers:
 ...
 *     ?_Getcat@?$money_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18001CE64 (-_Getcat@-$money_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::money_get<char,std::istreambuf_iterator<char>>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::money_get<char,std::istreambuf_iterator<char>>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::money_get<char,std::istreambuf_iterator<char>>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::money_get<char,std::istreambuf_iterator<char>>>::_Psave = (__int64)v12;
