/*
 * XREFs of _lambda_929976d9f769b9ae6bfa1e1f0592e0ca_::operator() @ 0x18004CE48
 * Callers:
 ...
 *     ?IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z @ 0x180053918 (-IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z.c)
 *     ?ResolveEventNotificationHandlerFromType@ContentManagement@@YA?AV?$function@$$A6AJXZ@std@@W4EventNotificationType@1@@Z @ 0x180056C58 (-ResolveEventNotificationHandlerFromType@ContentManagement@@YA-AV-$function@$$A6AJXZ@std@@W4Even.c)
 *     ?_Tidy@?$_Func_class@_NAEAVPropertySetHelper@Triggers@CreativeFramework@@U_Nil@std@@U45@U45@U45@U45@U45@@std@@IEAAXXZ @ 0x18005BC70 (-_Tidy@-$_Func_class@_NAEAVPropertySetHelper@Triggers@CreativeFramework@@U_Nil@std@@U45@U45@U45@.c)
