/*
 * XREFs of _Strcoll @ 0x180021AF8
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x18001F8A0 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD68 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD74 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x18000DDD0 (__crtCompareStringA_Stub.c)
 *     memcmp_0 @ 0x18002296D (memcmp_0.c)
 */
