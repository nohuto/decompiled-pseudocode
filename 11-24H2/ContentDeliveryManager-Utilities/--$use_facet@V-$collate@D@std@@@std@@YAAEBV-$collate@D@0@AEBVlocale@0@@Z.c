/*
 * XREFs of ??$use_facet@V?$collate@D@std@@@std@@YAAEBV?$collate@D@0@AEBVlocale@0@@Z @ 0x18001C0AC
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::collate<char>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::collate<char>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::collate<char>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::collate<char>>::_Psave = (__int64)v12;
