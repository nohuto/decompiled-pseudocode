/*
 * XREFs of ?_Getmfld@?$money_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@0_NAEAVios_base@2@PEA_W@Z @ 0x180013700
 * Callers:
        ...
        __int16 *a7)
{
  ...
  if ( a5 )
  {
    ...
    v12 = 256;
    v13 = std::use_facet<std::moneypunct<wchar_t,1>>(&v124);
    v122 = v13;
    if ( v11 )
    {
  ...
  else
  {
    ...
    v12 = 128;
    v13 = std::use_facet<std::moneypunct<wchar_t,0>>(&v124);
    v122 = v13;
    if ( v15 )
    {
  ...
  *(_BYTE *)v9 = 0;
  ...
  v18 = v12 | 0x21;
  v19 = std::use_facet<std::ctype<wchar_t>>((std::locale *)&v124);
  v124 = v19;
  if ( v17 )
  {
