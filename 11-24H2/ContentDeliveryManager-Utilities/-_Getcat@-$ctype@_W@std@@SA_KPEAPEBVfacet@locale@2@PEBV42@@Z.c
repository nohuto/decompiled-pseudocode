/*
 * XREFs of ?_Getcat@?$ctype@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180059E1C
 * Callers:
 ...
 *     ??0?$ctype@G@std@@QEAA@AEBV_Locinfo@1@_K@Z @ 0x18004AE78 (--0-$ctype@G@std@@QEAA@AEBV_Locinfo@1@_K@Z.c)
