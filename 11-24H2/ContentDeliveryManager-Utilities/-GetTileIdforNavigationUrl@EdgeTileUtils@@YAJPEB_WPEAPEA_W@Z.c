/*
 * XREFs of ?GetTileIdforNavigationUrl@EdgeTileUtils@@YAJPEB_WPEAPEA_W@Z @ 0x1800A4D70
 * Callers:
 ...
 *     ?TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z @ 0x1800A55FC (-TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z.c)
