/*
 * XREFs of ?get@?$static_lazy@VCDMUtilsUnlockLogging@@@details@wil@@QEAAPEAVCDMUtilsUnlockLogging@@P6AXXZ@Z @ 0x18008FAF4
 * Callers:
 *     ?Provider@CDMUtilsUnlockLogging@@SAPEBU_tlgProvider_t@@XZ @ 0x18008E698 (-Provider@CDMUtilsUnlockLogging@@SAPEBU_tlgProvider_t@@XZ.c)
 * Callees:
...
__int64 *__fastcall wil::details::static_lazy<CDMUtilsUnlockLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`CDMUtilsUnlockLogging::Instance'::`2'::wrapper, 0, &v8, (LPVOID *)&v10) && v8 )
  {
    ...
    dword_18017B5E4 = 0;
    v10 = &qword_18017B5D0;
    qword_18017B5D0 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    v6 = &`CDMUtilsUnlockLogging::Instance'::`2'::wrapper;
    byte_18017B5E0 = 0;
    qword_18017B5E8 = (__int64)&`CDMUtilsUnlockLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
