/*
 * XREFs of ?ExceptionThrown@FeatureFunctorHost@details@wil@@UEAAJPEAX@Z @ 0x18002F280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x18003A144 (-RethrowCaughtException@wil@@YAXXZ.c)
 */
