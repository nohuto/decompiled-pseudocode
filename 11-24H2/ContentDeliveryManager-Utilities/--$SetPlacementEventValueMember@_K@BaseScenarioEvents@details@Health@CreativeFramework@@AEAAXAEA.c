/*
 * XREFs of ??$SetPlacementEventValueMember@_K@BaseScenarioEvents@details@Health@CreativeFramework@@AEAAXAEA_KAEB_K@Z @ 0x1800481FC
 * Callers:
 *     ??$SetEventValue@$08$$V@BaseScenarioEvents@details@Health@CreativeFramework@@QEAAXXZ @ 0x1800480E0 (--$SetEventValue@$08$$V@BaseScenarioEvents@details@Health@CreativeFramework@@QEAAXXZ.c)
 ...
 *     ?EnsurePlacementReportedInfoRead@BaseScenarioEvents@details@Health@CreativeFramework@@IEAAXXZ @ 0x18004EF78 (-EnsurePlacementReportedInfoRead@BaseScenarioEvents@details@Health@CreativeFramework@@IEAAXXZ.c)
 */
