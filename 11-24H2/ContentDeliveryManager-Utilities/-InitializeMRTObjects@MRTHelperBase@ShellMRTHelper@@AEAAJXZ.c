/*
 * XREFs of ?InitializeMRTObjects@MRTHelperBase@ShellMRTHelper@@AEAAJXZ @ 0x1800A9C98
 * Callers:
 ...
 *     ?FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800A9C20 (-FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?ScaleFactorToResourceScale@Common@ShellMRTHelper@@YA?AW4RESOURCE_SCALE@@W4DEVICE_SCALE_FACTOR@@@Z @ 0x1800AA4EC (-ScaleFactorToResourceScale@Common@ShellMRTHelper@@YA-AW4RESOURCE_SCALE@@W4DEVICE_SCALE_FACTOR@@.c)
 *     ?_Free@?$NativeString@V?$LocalMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAXXZ @ 0x1800AA748 (-_Free@-$NativeString@V-$LocalMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAXXZ.c)
...
LABEL_24:
    ...
    if ( v25 )
    {
      ...
      {
        if ( v26 != 1 )
          wil::details::in1diag3::FailFast_Hr(retaddr, (void *)0xCA, v20, (const char *)0x8000FFFFLL, ppv);
        v27 = L"light";
      }
      else
      {
    ...
    if ( v28 )
    {
      ...
      {
        if ( v29 != 1 )
          wil::details::in1diag3::FailFast_Hr(retaddr, (void *)0xE0, v20, (const char *)0x8000FFFFLL, ppv);
        v30 = L"lightunplated";
      }
      else
      {
