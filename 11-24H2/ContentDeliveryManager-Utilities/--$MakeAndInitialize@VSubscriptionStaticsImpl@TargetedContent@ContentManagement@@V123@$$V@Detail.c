/*
 * XREFs of ??$MakeAndInitialize@VSubscriptionStaticsImpl@TargetedContent@ContentManagement@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAVSubscriptionStaticsImpl@TargetedContent@ContentManagement@@@Z @ 0x180041DC0
 * Callers:
 ...
 *     ??0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ @ 0x180042444 (--0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ.c)
