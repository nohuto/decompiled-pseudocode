/*
 * XREFs of ?GetIsApplicable@AppManager@ContentManagement@@UEAAJPEAUHSTRING__@@0PEAE@Z @ 0x180074EC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$As@UIAppInstallManager3@InstallControl@Preview@Store@ApplicationModel@Windows@@@?$ComPtr@UIAppInstallManager@InstallControl@Preview@Store@ApplicationModel@Windows@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIAppInstallManager3@InstallControl@Preview@Store@ApplicationModel@Windows@@@WRL@Microsoft@@@Details@12@@Z @ 0x18007218C (--$As@UIAppInstallManager3@InstallControl@Preview@Store@ApplicationModel@Windows@@@-$ComPtr@UIAp.c)
 *     ?EnsureCallingProcessHasStoreAppInstallCapability@ContentManagement@@YAJXZ @ 0x18007448C (-EnsureCallingProcessHasStoreAppInstallCapability@ContentManagement@@YAJXZ.c)
