/*
 * XREFs of ?_Init@?$_Mpunct@D@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x18001E760
 * Callers:
 *     ?_Getcat@?$moneypunct@D$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18001CFF4 (-_Getcat@-$moneypunct@D$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 *     ?_Getcat@?$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18001D0DC (-_Getcat@-$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 ...
 *     ??$_Getvals@D@?$_Mpunct@D@std@@IEAAXDPEBUlconv@@@Z @ 0x18001BE24 (--$_Getvals@D@-$_Mpunct@D@std@@IEAAXDPEBUlconv@@@Z.c)
 *     memcpy_s_0 @ 0x180022492 (memcpy_s_0.c)
 */
...
errno_t __fastcall std::_Mpunct<char>::_Init(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(a1 + 48) = 0LL;
  ...
  v12 = *(_BYTE *)(a1 + 68);
  if ( v12 )
    int_frac_digits = v6->int_frac_digits;
  else
    int_frac_digits = v6->frac_digits;
  *(_DWORD *)(a1 + 56) = int_frac_digits;
  if ( (unsigned int)int_frac_digits > 0x7E )
    *(_DWORD *)(a1 + 56) = 0;
