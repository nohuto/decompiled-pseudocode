/*
 * XREFs of ?CreateSupportedWnfNameStateMap@Triggers@CreativeFramework@@YA?AV?$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@@std@@XZ @ 0x18008B9D4
 * Callers:
...
__int64 *__fastcall CreativeFramework::Triggers::CreateSupportedWnfNameStateMap(__int64 *a1)
{
  ...
  AcquireSRWLockShared(&stru_18017B378);
  v14 = &stru_18017B378;
  if ( !qword_18017B588 )
  {
    wil::last_error_context::last_error_context((wil::last_error_context *)&v14);
    ReleaseSRWLockShared(&stru_18017B378);
    wil::last_error_context::~last_error_context((wil::last_error_context *)&v14);
    v14 = 0LL;
    AcquireSRWLockExclusive(&stru_18017B378);
    v15 = &stru_18017B378;
    if ( qword_18017B588 )
    {
