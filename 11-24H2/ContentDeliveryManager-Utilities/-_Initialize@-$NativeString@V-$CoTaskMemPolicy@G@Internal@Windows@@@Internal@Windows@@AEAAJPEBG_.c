/*
 * XREFs of ?_Initialize@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_K@Z @ 0x180071770
 * Callers:
 ...
 *     ?TryRemoveImplicitResourcesPrefixFromShortenedMsResourceUri@Common@ShellMRTHelper@@YAJPEAUHSTRING__@@PEAPEAG@Z @ 0x1800AA5A0 (-TryRemoveImplicitResourcesPrefixFromShortenedMsResourceUri@Common@ShellMRTHelper@@YAJPEAUHSTRIN.c)
 * Callees:
 ...
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x1800716F4 (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
 */
