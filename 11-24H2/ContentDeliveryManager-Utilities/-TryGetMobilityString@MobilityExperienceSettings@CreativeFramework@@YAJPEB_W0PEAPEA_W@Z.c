/*
 * XREFs of ?TryGetMobilityString@MobilityExperienceSettings@CreativeFramework@@YAJPEB_W0PEAPEA_W@Z @ 0x1800A7E64
 * Callers:
 *     ?get_PairingContext@MobilityExperienceManager@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x1800A8170 (-get_PairingContext@MobilityExperienceManager@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 * Callees:
