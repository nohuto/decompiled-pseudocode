/*
 * XREFs of _FXp_mulh @ 0x18000CA44
 * Callers:
 *     _FXp_mulx @ 0x18000CC44 (_FXp_mulx.c)
 *     _FXp_setn @ 0x18000CD50 (_FXp_setn.c)
 * Callees:
 *     _FDscale @ 0x18000C3EC (_FDscale.c)
 *     _FXp_addh @ 0x18000C5C8 (_FXp_addh.c)
 *     _Feraise @ 0x1800214F8 (_Feraise.c)
 *     _FDtest @ 0x18002152C (_FDtest.c)
 *     _FDint @ 0x18002157C (_FDint.c)
