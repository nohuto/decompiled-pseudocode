/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x180091800
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800758C8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_N.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_7;
  if ( dword_18017B600 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18017B600);
    if ( dword_18017B600 == -1 )
    {
      byte_18017B604 = CreativeFramework::Actions::IsMsaConnected(v9);
      Init_thread_footer(&dword_18017B600);
    }
  }
  if ( !byte_18017B604 )
LABEL_7:
