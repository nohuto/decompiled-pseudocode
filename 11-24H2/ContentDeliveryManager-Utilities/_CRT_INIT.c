/*
 * XREFs of _CRT_INIT @ 0x180021FDC
 * Callers:
 *     __DllMainCRTStartup @ 0x180022264 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x180022985 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800229F0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180022B63 (_initterm_0.c)
