/*
 * XREFs of ??1AppInstallInfoRecordImpl@ContentManagement@@UEAA@XZ @ 0x180042830
 * Callers:
 *     ??_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z @ 0x180042C60 (--_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
 *     <none>
 */
