/*
 * XREFs of ??$make_shared@VPublishSystemStateService@Actions@CreativeFramework@@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V45@@std@@YA?AV?$shared_ptr@VPublishSystemStateService@Actions@CreativeFramework@@@0@$$QEAV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@0@0@Z @ 0x1800A0784
 * Callers:
 ...
 *     ??0PublishSystemStateService@Actions@CreativeFramework@@QEAA@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@0@Z @ 0x1800A0834 (--0PublishSystemStateService@Actions@CreativeFramework@@QEAA@V-$basic_string@_WU-$char_traits@_W.c)
 */
