/*
 * XREFs of ?GetSubscriptionConfigurationEntry@TargetedContent@CreativeFramework@@YA?AUTargetedContentSubscriptionConfiguration@12@PEBG@Z @ 0x180052E24
 * Callers:
...
__int64 __fastcall CreativeFramework::TargetedContent::GetSubscriptionConfigurationEntry(__int64 a1, __int64 a2)
{
  ...
  v10 = a2;
  *(_OWORD *)a1 = *(_OWORD *)&off_1800CA2D0;
  *(_OWORD *)(a1 + 16) = xmmword_1800CA2E0;
  *(_QWORD *)(a1 + 32) = 3600LL;
  *(_QWORD *)&v7 = &v10;
  *((_QWORD *)&v7 + 1) = a1;
  v9 = 0LL;
  ...
  *(_OWORD *)(v3 + 8) = v7;
  v9 = v3;
  for ( i = off_180179210; i != (wchar_t **)&unk_1801794B8; i += 5 )
  {
    if ( !v3 )
