/*
 * XREFs of ?GetResults@?$AsyncOperation@U?$IAsyncOperation@PEAUHSTRING__@@@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@PEAUHSTRING__@@@23@VCHSTRINGResult@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180032CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Get@CHSTRINGResult@Internal@Windows@@QEAAJPEAPEAUHSTRING__@@@Z @ 0x180030734 (-Get@CHSTRINGResult@Internal@Windows@@QEAAJPEAPEAUHSTRING__@@@Z.c)
 */
        ...
        HSTRING *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v8 != 3 )
  {
    ...
    return (unsigned int)Windows::Internal::CHSTRINGResult::Get(a1 + 13, a2);
  }
  v9 = 0;
