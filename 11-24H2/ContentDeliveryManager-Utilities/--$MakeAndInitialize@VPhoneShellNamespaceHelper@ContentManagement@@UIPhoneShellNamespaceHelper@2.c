/*
 * XREFs of ??$MakeAndInitialize@VPhoneShellNamespaceHelper@ContentManagement@@UIPhoneShellNamespaceHelper@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIPhoneShellNamespaceHelper@ContentManagement@@@Z @ 0x18002685C
 * Callers:
