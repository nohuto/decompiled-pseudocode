/*
 * XREFs of ??$MakeAndInitialize@VUniqueExtendedExecutionSession@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x18008C6FC
 * Callers:
 ...
 *     ??0UniqueExtendedExecutionSession@@QEAA@XZ @ 0x18008CF14 (--0UniqueExtendedExecutionSession@@QEAA@XZ.c)
