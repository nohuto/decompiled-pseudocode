        ...
        _QWORD *a5)
{
  ...
  {
    v8 = v9;
    v11 = std::wstring::compare(a4, v9 + 32);
    if ( v11 >= 0 )
    {
      v10 = 0;
      v9 = *(_QWORD *)(v9 + 16);
  ...
  try
  {
    ...
    if ( v10 )
    {
      ...
      {
        v12 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max(*(_QWORD *)v8);
      }
    }
