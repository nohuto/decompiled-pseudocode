/*
 * XREFs of ?IsCallerInAllowedAppList@LockScreenCategoryConfig@CreativeFramework@@YAJPEBQEBGH@Z @ 0x180033EE4
 * Callers:
 *     ??$MakeAndInitialize@VContextualSuggestionsManager@ContentManagement@@UIContextualSuggestionsManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIContextualSuggestionsManager@ContentManagement@@@Z @ 0x180025D00 (--$MakeAndInitialize@VContextualSuggestionsManager@ContentManagement@@UIContextualSuggestionsMan.c)
 ...
 *     ??$MakeAndInitialize@VThumbnailCacheHelper@ContentManagement@@UIThumbnailCacheHelper@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIThumbnailCacheHelper@ContentManagement@@@Z @ 0x180026970 (--$MakeAndInitialize@VThumbnailCacheHelper@ContentManagement@@UIThumbnailCacheHelper@2@$$V@Detai.c)
 * Callees:
        ...
        const unsigned __int16 *const *a2)
{
  ...
  if ( CallingProcessHandle >= 0 )
  {
    ...
    {
      v9 = (const WCHAR **)off_1800CA298;
      v10 = (char *)word_1800E78BC;
      do
      {
        v11 = word_1800E78BC;
        if ( *v9 )
      ...
      while ( (__int64)v9 < (__int64)off_1800CA2A0 );
      v19 = 0LL;
      v20 = 0LL;
      v21 = 0LL;
