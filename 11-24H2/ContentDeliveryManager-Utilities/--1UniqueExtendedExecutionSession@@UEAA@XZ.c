/*
 * XREFs of ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x18008D2D4
 * Callers:
 *     ??_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z @ 0x18008D590 (--_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z.c)
 * Callees:
