/*
 * XREFs of ?RuntimeClassInitialize@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@QEAAJW4ActionServices@Actions@CreativeFramework@@AEBUActionContext@78@PEAU?$IMapView@PEAUHSTRING__@@PEAU1@@Collections@Foundation@5@@Z @ 0x18006EE24
 * Callers:
        ...
        __int64 (***a4)(void))
{
  ...
  std::_Ref_count_base *StringRawBuffer; // rbx
  ...
  __int64 v41; // [rsp+38h] [rbp-80h] BYREF
  __int64 v42; // [rsp+40h] [rbp-78h] BYREF
  HSTRING v43; // [rsp+48h] [rbp-70h] BYREF
  __int64 v44; // [rsp+50h] [rbp-68h] BYREF
  void *v45[2]; // [rsp+58h] [rbp-60h] BYREF
  PCWSTR v46; // [rsp+68h] [rbp-50h] BYREF
  std::_Ref_count_base *v47; // [rsp+70h] [rbp-48h]
  _BYTE v48[16]; // [rsp+78h] [rbp-40h] BYREF
  char v49; // [rsp+88h] [rbp-30h] BYREF
  ...
  try
  {
    ...
    {
      v41 = 0LL;
      v11 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v42 + 48LL))(v42, &v41);
      v12 = v11;
      if ( v11 >= 0 )
      {
        LOBYTE(v51) = 0;
        v13 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v41 + 56LL))(v41, &v51);
        v14 = v13;
        if ( v13 >= 0 )
        {
          std::map<std::wstring,std::wstring>::map<std::wstring,std::wstring>(v45);
          while ( (_BYTE)v51 )
          {
            v44 = 0LL;
            v15 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v41 + 48LL))(v41, &v44);
            v16 = v15;
            if ( v15 < 0 )
            {
              ...
              std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>(v45);
            ...
            string = 0LL;
            v17 = v44;
            v18 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v44 + 48LL);
            ...
            v43 = 0LL;
            v21 = v44;
            v22 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v44 + 56LL);
            WindowsDeleteString(0LL);
            v43 = 0LL;
            v23 = v22(v21, &v43);
            v24 = v23;
            ...
            StringRawBuffer = (std::_Ref_count_base *)WindowsGetStringRawBuffer(v43, 0LL);
            v46 = WindowsGetStringRawBuffer(string, 0LL);
            v47 = StringRawBuffer;
            v26 = (const wchar_t *)std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<unsigned short const *,unsigned short const *>>(v45);
            std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_nohint<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
              ...
              v26 + 16,
              (__int64)v26);
            v28 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v41 + 64LL))(v41, &v51);
            v29 = v28;
            if ( v28 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
          ...
          ActionService = CreativeFramework::Actions::GetActionService(&v46, a2, a3, v45);
          v31 = 0LL;
          v32 = 0LL;
          if ( &v49 != (char *)ActionService )
          {
            v31 = *(_QWORD *)(ActionService + 8);
            *(_QWORD *)(ActionService + 8) = 0LL;
            v32 = *(_QWORD *)ActionService;
            *(_QWORD *)ActionService = 0LL;
          }
          v33 = *(std::_Ref_count_base **)(a1 + 80);
          *(_QWORD *)(a1 + 80) = v31;
          *(_QWORD *)(a1 + 72) = v32;
          if ( v33 )
          ...
          if ( (void **)(a1 + 88) != v45 )
          {
            std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::clear((_QWORD *)(a1 + 88));
            *(_QWORD *)(*v34 + 8) = std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(
                                      (_QWORD *)(a1 + 88),
                                      *((_QWORD *)v45[0] + 1),
                                      *v34,
                                      v51);
            *(void **)(a1 + 96) = v45[1];
            ...
            {
              v36 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Min((_QWORD *)v35);
              *v37 = v36;
              v38 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max(*(_QWORD *)(*v34 + 8));
              *(_QWORD *)(v39 + 16) = v38;
            }
          }
          std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>(v45);
