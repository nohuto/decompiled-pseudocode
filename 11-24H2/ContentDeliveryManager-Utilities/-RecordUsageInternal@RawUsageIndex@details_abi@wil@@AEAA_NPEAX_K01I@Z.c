/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180037944
 * Callers:
 ...
 *     ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x18002FA14 (-FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@.c)
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x1800331F0 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 ...
 *     ?SkipValues@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAE@Z @ 0x18003B5B0 (-SkipValues@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAE@Z.c)
 *     ?UpdateCount@UsageIndexProperty@details_abi@wil@@QEAAXI@Z @ 0x18003CAD0 (-UpdateCount@UsageIndexProperty@details_abi@wil@@QEAAXI@Z.c)
 *     ?Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z @ 0x18003D06C (-Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z.c)
 */
        ...
        unsigned int a6)
{
  ...
  __int16 v26; // [rsp+58h] [rbp-28h] BYREF
  char v27; // [rsp+5Ah] [rbp-26h]
  unsigned int v28; // [rsp+5Ch] [rbp-24h]
  __int16 v29; // [rsp+60h] [rbp-20h]
  ...
  if ( v6 )
  {
    ...
    LOWORD(v23) = *((_WORD *)this + 1);
    v12 = 0;
    BYTE2(v23) = *((_BYTE *)this + 4);
    ...
    while ( 1 )
    {
      ...
      v13 = wil::details_abi::UsageIndexProperty::Compare(&v23, a2, a3);
      if ( v13 < 0 )
      {
        InsertionPointOrIncrement = v11;
        goto LABEL_11;
