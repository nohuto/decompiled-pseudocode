...
__int64 __fastcall std::map<std::wstring,std::wstring>::operator[](__int64 *a1, _QWORD *a2)
{
  ...
  _QWORD v8[5]; // [rsp+38h] [rbp-31h] BYREF
  _QWORD v9[4]; // [rsp+60h] [rbp-9h] BYREF
  _BYTE v10[32]; // [rsp+80h] [rbp+17h] BYREF
  ...
  std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::lower_bound(
    ...
    a2);
  v4 = v7;
  if ( v7 == *a1 || (int)std::wstring::compare((__int64)a2, (_QWORD *)(v7 + 32)) < 0 )
  {
    v8[3] = 7LL;
    v8[2] = 0LL;
    LOWORD(v8[0]) = 0;
    std::wstring::wstring((__int64)v9, (__int64)a2);
    std::wstring::wstring((__int64)v10, (__int64)v8);
    v5 = (_QWORD *)std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<std::wstring,std::wstring>>(
                     (__int64)a1,
                     (__int64)v9);
