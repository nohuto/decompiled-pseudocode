/*
 * XREFs of ?SetCrossDevicePackageStubPreference@MobilityExperienceSettings@ContentManagement@@QEAAJE@Z @ 0x18003ADD0
 * Callers:
...
__int64 __fastcall ContentManagement::MobilityExperienceSettings::SetCrossDevicePackageStubPreference(
        ...
        char a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v3 >= 0 )
    {
      ...
      Microsoft::WRL::Wrappers::HStringReference::CreateReference(
        &hstringHeader,
        L"MicrosoftWindows.CrossDevice_cw5n1h2txyewy",
        0x2Bu,
        0x2Au);
      v3 = v8(v7, v13, v2);
      v4 = v3;
