/*
 * XREFs of ?OnContentUpdated@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@AEAAXXZ @ 0x18006279C
 * Callers:
 *     _lambda_83dc6366a20d9229952004eea2bdcbca_::operator() @ 0x18006093C (_lambda_83dc6366a20d9229952004eea2bdcbca_--operator().c)
 * Callees:
 ...
 *     ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x180063858 (-Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@Conte.c)
        ...
        RTL_SRWLOCK *this)
{
  ...
  _QWORD v27[42]; // [rsp+58h] [rbp-B0h] BYREF
