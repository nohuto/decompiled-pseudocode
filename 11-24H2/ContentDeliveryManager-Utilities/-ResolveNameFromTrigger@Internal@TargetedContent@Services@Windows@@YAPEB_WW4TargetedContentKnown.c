/*
 * XREFs of ?ResolveNameFromTrigger@Internal@TargetedContent@Services@Windows@@YAPEB_WW4TargetedContentKnownTrigger@1234@@Z @ 0x180081C38
 * Callers:
...
wchar_t *__fastcall Windows::Services::TargetedContent::Internal::ResolveNameFromTrigger(int a1)
{
  ...
  for ( i = (wchar_t **)&unk_1800D3A80; ; i += 2 )
  {
    if ( i == &off_1800D3B30 )
