/*
 * XREFs of ??$make_shared@VSetDesktopWallpaperService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA?AV?$shared_ptr@VSetDesktopWallpaperService@Actions@CreativeFramework@@@0@$$QEAPEB_W00@Z @ 0x1800A2570
 * Callers:
 ...
 *     ??0SetDesktopWallpaperService@Actions@CreativeFramework@@QEAA@PEB_W00@Z @ 0x1800A2604 (--0SetDesktopWallpaperService@Actions@CreativeFramework@@QEAA@PEB_W00@Z.c)
 */
