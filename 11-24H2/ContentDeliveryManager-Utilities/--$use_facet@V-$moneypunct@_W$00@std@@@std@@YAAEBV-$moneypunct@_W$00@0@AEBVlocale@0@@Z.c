/*
 * XREFs of ??$use_facet@V?$moneypunct@_W$00@std@@@std@@YAAEBV?$moneypunct@_W$00@0@AEBVlocale@0@@Z @ 0x18000FF3C
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@_W$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011C5C (-_Getcat@-$moneypunct@_W$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::moneypunct<wchar_t,1>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::moneypunct<wchar_t,1>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::moneypunct<wchar_t,1>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::moneypunct<wchar_t,1>>::_Psave = (__int64)v12;
