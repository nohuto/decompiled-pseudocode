/*
 * XREFs of ?_Fput@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WPEBD_K444@Z @ 0x180010ED4
 * Callers:
...
__int64 __fastcall std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Fput(
        int a1,
        __int64 a2,
        __int128 *a3,
        __int64 a4,
        ...
        unsigned __int64 a10)
{
  ...
  *(_QWORD *)&v53 = strcspn(Str, (const char *)&Control);
  ...
  v52[0] = std::use_facet<std::ctype<wchar_t>>((std::locale *)v52);
  if ( v15 )
  {
  ...
  v23 = std::use_facet<std::numpunct<wchar_t>>((std::locale *)v52);
  if ( v21 )
  {
