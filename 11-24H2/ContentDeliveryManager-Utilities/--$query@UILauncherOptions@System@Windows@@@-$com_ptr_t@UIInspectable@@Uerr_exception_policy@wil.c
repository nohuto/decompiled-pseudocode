/*
 * XREFs of ??$query@UILauncherOptions@System@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UILauncherOptions@System@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x180066A54
 * Callers:
