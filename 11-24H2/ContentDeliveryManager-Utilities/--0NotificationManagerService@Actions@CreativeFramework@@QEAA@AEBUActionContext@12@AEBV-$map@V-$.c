 ...
 *     ?ResolveAppIdFromName@Actions@CreativeFramework@@YAPEB_WPEB_W@Z @ 0x18009E380 (-ResolveAppIdFromName@Actions@CreativeFramework@@YAPEB_WPEB_W@Z.c)
        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)(a1 + 112) = 0LL;
  v5 = (__int64 *)(a1 + 120);
  v26 = (CreativeFramework::NotificationManager::ToastHelpers *)(a1 + 120);
  ...
  *(_QWORD *)(a1 + 136) = 0LL;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_ActionCenterNotification>::ReportUsage(
    ...
    v8);
  *(_BYTE *)(a1 + 8) = *(_BYTE *)a2;
  std::wstring::operator=((_QWORD *)(a1 + 16), (_QWORD *)(a2 + 8));
  if ( v5 != v28 )
  {
  ...
  wil::details::in1diag3::Throw_HrIfMsg(
    ...
    (__int64)"entityId",
    v24);
  std::wstring::operator=((_QWORD *)(a1 + 48), v10 + 8);
  std::wstring::wstring((__int64)v32);
  ...
  v12 = *(_QWORD *)std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::find(
                     ...
                     v32);
  std::wstring::_Tidy(v32, 1, 0LL);
  if ( v12 != *v5 && std::wstring::compare(v12 + 64, (wchar_t *)L"true") == 0 )
  {
    std::wstring::wstring((__int64)v32);
    ...
    if ( v14 != *v5 )
    {
      std::wistringstream::wistringstream(v31, (_QWORD *)(v14 + 64));
      std::wistream::operator>>(v31, a1 + 112);
      std::basic_istringstream<unsigned short>::`vbase destructor'((__int64)v31);
    }
  }
  std::wstring::wstring((__int64)v32);
  ...
  if ( v15 == *v5 )
  {
    v16 = std::wstring::wstring((__int64)v32);
    v17 = 2;
  }
  else
  {
    v16 = std::wstring::wstring((__int64)v34, v15 + 64);
    v17 = 1;
  }
  std::wstring::wstring((__int64)lpString2, v16);
  if ( (v17 & 2) != 0 )
  {
    v17 &= ~2u;
    std::wstring::_Tidy(v32, 1, 0LL);
  ...
  if ( lpString2[3] >= (LPCWCH)8 )
    v19 = lpString2[0];
  v20 = CreativeFramework::Actions::ResolveAppIdFromName(v19, v18);
  std::wstring::assign(a1 + 80, (__int64)v20);
  v21 = (CreativeFramework::NotificationManager::ToastHelpers *)operator new(0x48uLL);
  v26 = v21;
  if ( v21 )
    v22 = CreativeFramework::NotificationManager::ToastHelpers::ToastHelpers(v21);
  else
    v22 = 0LL;
  v27 = v22;
  if ( v6 != &v27 )
