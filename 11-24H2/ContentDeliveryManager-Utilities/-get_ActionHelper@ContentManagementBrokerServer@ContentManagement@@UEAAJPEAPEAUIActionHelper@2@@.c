/*
 * XREFs of ?get_ActionHelper@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIActionHelper@2@@Z @ 0x18003E850
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@VActionHelper@ContentManagement@@UIActionHelper@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIActionHelper@ContentManagement@@@Z @ 0x180025AC4 (--$MakeAndInitialize@VActionHelper@ContentManagement@@UIActionHelper@2@$$V@Details@WRL@Microsoft.c)
