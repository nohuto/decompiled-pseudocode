/*
 * XREFs of ??_GPublishWindowsTipService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800A03E0
 * Callers:
 *     <none>
 * Callees:
 *     ??1PublishWindowsTipService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800A03A0 (--1PublishWindowsTipService@Actions@CreativeFramework@@UEAA@XZ.c)
 */
