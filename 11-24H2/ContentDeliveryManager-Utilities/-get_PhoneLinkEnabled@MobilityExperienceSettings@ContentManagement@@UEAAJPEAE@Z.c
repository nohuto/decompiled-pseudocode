/*
 * XREFs of ?get_PhoneLinkEnabled@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z @ 0x18003EF90
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  if ( v3 >= 0 )
  {
    v3 = (*(__int64 (__fastcall **)(void *, const struct _GUID *))(*(_QWORD *)v8 + 112LL))(v8, a2);
    v4 = v3;
    if ( v3 >= 0 )
    {
      v4 = 0;
