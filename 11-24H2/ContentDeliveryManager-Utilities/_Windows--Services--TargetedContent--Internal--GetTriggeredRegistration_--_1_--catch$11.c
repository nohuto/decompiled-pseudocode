/*
 * XREFs of _Windows::Services::TargetedContent::Internal::GetTriggeredRegistration_::_1_::catch$11 @ 0x1800BADB9
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::GetTriggeredRegistration_::_1_::catch_11(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
