/*
 * XREFs of ??1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ @ 0x180093F1C
 * Callers:
 *     ??_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x180094540 (--_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
