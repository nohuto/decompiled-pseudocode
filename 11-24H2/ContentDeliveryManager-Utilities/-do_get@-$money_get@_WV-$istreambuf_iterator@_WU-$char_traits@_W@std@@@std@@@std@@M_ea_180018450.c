/*
 * XREFs of ?do_get@?$money_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0_NAEAVios_base@2@AEAHAEAV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@@Z @ 0x180018450
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a8)
{
  ...
  v22 = -2LL;
  std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld(a1, v23, a3, a4, a5, a6, v25);
  v11 = (char *)v23[2];
