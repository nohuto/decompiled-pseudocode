/*
 * XREFs of ??1?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@UEAA@XZ @ 0x180067274
 * Callers:
 *     ??_E?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@UEAAPEAXI@Z @ 0x1800678D0 (--_E-$wstring_convert@V-$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV-$allocator@G@2@V-$allocator@D@2@@st.c)
 ...
 *     _CreativeFramework::CommonHelper::StringUtils::WStringToUtf8String_::_1_::dtor$2 @ 0x1800B9BF0 (_CreativeFramework--CommonHelper--StringUtils--WStringToUtf8String_--_1_--dtor$2.c)
 * Callees:
