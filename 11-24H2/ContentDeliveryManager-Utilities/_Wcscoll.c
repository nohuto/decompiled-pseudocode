/*
 * XREFs of _Wcscoll @ 0x180021C50
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x180017FD0 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD68 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD74 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x18000DDDC (__crtCompareStringW_Stub.c)
 */
