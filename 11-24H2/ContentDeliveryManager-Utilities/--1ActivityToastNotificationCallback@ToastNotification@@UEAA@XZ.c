/*
 * XREFs of ??1ActivityToastNotificationCallback@ToastNotification@@UEAA@XZ @ 0x1800672B8
 * Callers:
 *     ??_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z @ 0x180067910 (--_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z.c)
 * Callees:
