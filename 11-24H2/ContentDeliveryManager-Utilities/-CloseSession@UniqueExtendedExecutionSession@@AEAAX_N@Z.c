/*
 * XREFs of ?CloseSession@UniqueExtendedExecutionSession@@AEAAX_N@Z @ 0x18008D5E0
 * Callers:
 *     ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x18008D2D4 (--1UniqueExtendedExecutionSession@@UEAA@XZ.c)
 *     ?OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionRevokedEventArgs@ExtendedExecution@ApplicationModel@Windows@@@Z @ 0x18008E5D0 (-OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionR.c)
 ...
 *     ?SHIsSameObject@@YAHPEAUIUnknown@@0@Z @ 0x18008F26C (-SHIsSameObject@@YAHPEAUIUnknown@@0@Z.c)
