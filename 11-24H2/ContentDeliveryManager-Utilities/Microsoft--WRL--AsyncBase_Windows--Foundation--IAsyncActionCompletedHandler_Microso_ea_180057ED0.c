/*
 * XREFs of Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions_&_anonymous_namespace_::EnableLockScreenRotationOperationName_&GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::Start @ 0x180057ED0
 * Callers:
 ...
 *     Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions_&_anonymous_namespace_::EnableLockScreenRotationOperationName_&GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::TraceOperationStart @ 0x1800592FC (Microsoft--WRL--AsyncBase_Windows--Foundation--IAsyncActionCompletedHandler_Microso_ea_1800592FC.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1800BE010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

__int64 __fastcall Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableLockScreenRotationOperationName__GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::Start(
        __int64 a1)
{
  __int64 v2; // rdx
  int v3; // ebx
         ...
         0) )
  {
    ...
    if ( v3 >= 0
      && InitOnceExecuteOnce(
           ...
           0LL) )
    {
      Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableLockScreenRotationOperationName__GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::TraceOperationStart(a1);
    }
  }
  else
  {
