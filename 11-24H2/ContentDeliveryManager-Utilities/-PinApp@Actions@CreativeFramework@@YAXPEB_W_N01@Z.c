/*
 * XREFs of ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18009D338
 * Callers:
 ...
 *     ?GetTaskBarSuggestionsPinHelper@Actions@CreativeFramework@@YA?AV?$com_ptr_t@UITaskBarSuggestionsPinHelper@TaskBarSuggestions@UI@Internal@Windows@@Uerr_exception_policy@wil@@@wil@@XZ @ 0x18009CD44 (-GetTaskBarSuggestionsPinHelper@Actions@CreativeFramework@@YA-AV-$com_ptr_t@UITaskBarSuggestions.c)
