 ...
 * Callers:
 *     _lambda_a031fdd1fd025cd2573b61ec83e0da08_::operator() @ 0x180084364 (_lambda_a031fdd1fd025cd2573b61ec83e0da08_--operator().c)
 * Callees:
 ...
 *     ?RuntimeClassInitialize@TargetedContentTriggerStateTransitionImpl@Internal@TargetedContent@Services@Windows@@QEAAJPEAUHSTRING__@@W4TargetedContentTriggerState@2345@1@Z @ 0x180077098 (-RuntimeClassInitialize@TargetedContentTriggerStateTransitionImpl@Internal@TargetedContent@Servi.c)
