/*
 * XREFs of _Towupper @ 0x1800062D0
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x18005D330 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18005D350 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
