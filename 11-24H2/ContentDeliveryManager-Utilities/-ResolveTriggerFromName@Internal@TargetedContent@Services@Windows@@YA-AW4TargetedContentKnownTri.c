/*
 * XREFs of ?ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentKnownTrigger@1234@PEB_W@Z @ 0x180081EF0
 * Callers:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::ResolveTriggerFromName(const WCHAR *a1)
{
  ...
  for ( i = (LPCWCH *)&unk_1800D3A80; ; i += 2 )
  {
    if ( i == (LPCWCH *)&off_1800D3B30 )
