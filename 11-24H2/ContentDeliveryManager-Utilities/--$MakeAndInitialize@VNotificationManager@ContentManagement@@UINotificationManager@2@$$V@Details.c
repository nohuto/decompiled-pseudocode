/*
 * XREFs of ??$MakeAndInitialize@VNotificationManager@ContentManagement@@UINotificationManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUINotificationManager@ContentManagement@@@Z @ 0x180026748
 * Callers:
