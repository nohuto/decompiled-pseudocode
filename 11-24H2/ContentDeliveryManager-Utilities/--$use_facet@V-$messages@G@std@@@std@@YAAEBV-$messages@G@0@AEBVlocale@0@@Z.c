/*
 * XREFs of ??$use_facet@V?$messages@G@std@@@std@@YAAEBV?$messages@G@0@AEBVlocale@0@@Z @ 0x18000F4DC
 * Callers:
 ...
 *     ?_Getcat@?$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800116A4 (-_Getcat@-$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::messages<unsigned short>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::messages<unsigned short>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::messages<unsigned short>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::messages<unsigned short>>::_Psave = (__int64)v12;
