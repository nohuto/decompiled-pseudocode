/*
 * XREFs of ?find@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBA_KPEBG_K1@Z @ 0x18005DA24
 * Callers:
 *     _anonymous_namespace_::StartsWith @ 0x1800583F8 (_anonymous_namespace_--StartsWith.c)
