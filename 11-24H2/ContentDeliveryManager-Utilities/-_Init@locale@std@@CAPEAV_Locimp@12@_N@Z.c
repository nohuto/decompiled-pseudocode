/*
 * XREFs of ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x180005338
 * Callers:
 ...
 *     ?_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z @ 0x180005548 (-_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z.c)
...
struct std::locale::_Locimp *__fastcall std::locale::_Init(char a1)
{
  ...
  v2 = (struct std::locale::_Locimp *)qword_18017A478;
  if ( !qword_18017A478 )
  {
    ...
    *((_DWORD *)v2 + 8) = 63;
    ...
    qword_18017A4B0 = (__int64)std::locale::_Locimp::_Clocptr;
  }
  if ( a1 )
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v2 + 8LL))(v2);
