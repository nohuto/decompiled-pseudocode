/*
 * XREFs of ??$use_facet@V?$codecvt@DDH@std@@@std@@YAAEBV?$codecvt@DDH@0@AEBVlocale@0@@Z @ 0x180006580
 * Callers:
 ...
 *     ?_Getcat@?$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800072C4 (-_Getcat@-$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::codecvt<char,char,int>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::codecvt<char,char,int>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    else
    {
      ...
      v6 = v12;
      std::_Facetptr<std::codecvt<char,char,int>>::_Psave = (__int64)v12;
