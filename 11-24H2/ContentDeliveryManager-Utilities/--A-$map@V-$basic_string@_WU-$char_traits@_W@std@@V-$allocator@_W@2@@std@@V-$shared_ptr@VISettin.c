...
__int64 __fastcall std::map<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>>::operator[](
        __int64 *a1,
        __int64 a2)
{
  __int64 v4; // rbx
  ...
  std::_Ref_count_base *v12[2]; // [rsp+38h] [rbp-21h] BYREF
  ...
  if ( v11 == (_BYTE *)*a1
    || (v11 = v13,
        v5 = std::wstring::wstring((__int64)v13, v4 + 32),
        v6 = std::wstring::wstring((__int64)v14, a2),
        (unsigned __int8)CreativeFramework::CommonHelper::Details::less::operator()(v7, v6, v5)) )
  {
    *(_OWORD *)v12 = 0LL;
    std::wstring::wstring((__int64)v14, a2);
    std::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>(
      &v15,
      (__int64 *)v12);
    v8 = (_QWORD *)std::_Tree_buy<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>::_Buynode<std::pair<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>(
                     (__int64)a1,
                     (__int64)v14);
