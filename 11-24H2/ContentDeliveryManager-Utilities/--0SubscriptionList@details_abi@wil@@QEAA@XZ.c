/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800297F8
 * Callers:
 *     wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x1800040E0 (wil--details--_dynamic_initializer_for__g_featureStateManager__.c)
