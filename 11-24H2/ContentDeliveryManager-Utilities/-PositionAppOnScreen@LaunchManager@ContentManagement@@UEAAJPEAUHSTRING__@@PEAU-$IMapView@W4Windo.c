/*
 * XREFs of ?PositionAppOnScreen@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@PEAU?$IMapView@W4WindowPosition@ContentManagement@@I@Collections@Foundation@Windows@@I@Z @ 0x180035A80
 * Callers:
 *     <none>
 * Callees:
 *     ?GetWindowExperienceManager@LaunchManager@ContentManagement@@AEAAJPEAPEAUIWindowExperienceManager@2@@Z @ 0x180033A54 (-GetWindowExperienceManager@LaunchManager@ContentManagement@@AEAAJPEAPEAUIWindowExperienceManage.c)
