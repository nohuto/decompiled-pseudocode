/*
 * XREFs of ??$ActivateInstance@UIAppInstallManager@InstallControl@Preview@Store@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIAppInstallManager@InstallControl@Preview@Store@ApplicationModel@1@@Z @ 0x180072054
 * Callers:
