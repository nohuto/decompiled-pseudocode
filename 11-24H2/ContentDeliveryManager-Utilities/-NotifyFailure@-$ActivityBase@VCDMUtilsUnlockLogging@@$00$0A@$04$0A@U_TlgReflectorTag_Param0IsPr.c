/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18008E280
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( (a2[1] & 2) == 0 )
  {
    ...
    {
      v8 = CDMUtilsUnlockLogging::Provider();
      if ( *(_DWORD *)v8 > 2u )
      {
        v9 = *((_QWORD *)a2 + 6);
        v10 = a1[34];
