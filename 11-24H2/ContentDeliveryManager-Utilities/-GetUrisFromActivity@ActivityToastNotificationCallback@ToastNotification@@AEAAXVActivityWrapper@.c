/*
 * XREFs of ?GetUrisFromActivity@ActivityToastNotificationCallback@ToastNotification@@AEAAXVActivityWrapper@MobilityExperience@@PEAPEAUHSTRING__@@1@Z @ 0x180068C60
 * Callers:
 ...
 *     ??$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@?$com_ptr_t@UIUriRuntimeClass@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x180066AA8 (--$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@-$com_ptr_t@UIUriRuntime.c)
