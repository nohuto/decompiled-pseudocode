/*
 * XREFs of ?ResultFromKnownLastError@@YAJXZ @ 0x180063558
 * Callers:
 ...
 *     ?OpenSubscriptionHandle@Details@SubscribedContentStore@CreativeFramework@@YAJPEBGPEAPEAX@Z @ 0x180062A30 (-OpenSubscriptionHandle@Details@SubscribedContentStore@CreativeFramework@@YAJPEBGPEAPEAX@Z.c)
 ...
 *     ?GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z @ 0x1800B2BD4 (-GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
