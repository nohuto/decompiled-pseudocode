/*
 * XREFs of ??1?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIPendingLaunch@Private@System@Windows@@@Details@WRL@Microsoft@@UEAA@XZ @ 0x18004C184
 * Callers:
 *     ??1UnlockActionHelper@@UEAA@XZ @ 0x18004C8FC (--1UnlockActionHelper@@UEAA@XZ.c)
 *     ??_E?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIPendingLaunch@Private@System@Windows@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x18004D7B0 (--_E-$RuntimeClass@U-$RuntimeClassFlags@$02@WRL@Microsoft@@UIPendingLaunch@Private@System@Window.c)
 * Callees:
