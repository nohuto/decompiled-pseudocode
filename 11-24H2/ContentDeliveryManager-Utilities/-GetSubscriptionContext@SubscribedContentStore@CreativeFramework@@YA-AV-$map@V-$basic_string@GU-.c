/*
 * XREFs of ?GetSubscriptionContext@SubscribedContentStore@CreativeFramework@@YA?AV?$map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@@std@@PEBG_N@Z @ 0x180061C10
 * Callers:
 ...
 * Callees:
 *     ??$?0$0BH@@StringReference@Internal@Windows@@QEAA@AEAY0BH@$$CBG@Z @ 0x1800241BC (--$-0$0BH@@StringReference@Internal@Windows@@QEAA@AEAY0BH@$$CBG@Z.c)
 *     ??$GetActivationFactory@V?$ComPtr@UIUriRuntimeClassFactory@Foundation@Windows@@@WRL@Microsoft@@@Foundation@Windows@@YAJPEAUHSTRING__@@V?$ComPtrRef@V?$ComPtr@UIUriRuntimeClassFactory@Foundation@Windows@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x180025628 (--$GetActivationFactory@V-$ComPtr@UIUriRuntimeClassFactory@Foundation@Windows@@@WRL@Microsoft@@@.c)
 ...
 *     ??$?0V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V01@@?$pair@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@QEAA@$$QEAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@0PEAPEAX@Z @ 0x18005ECF0 (--$-0V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V01@@-$pair@V-$basic_string@G.c)
 *     ??$As@UIUriEscapeStatics@Foundation@Windows@@@?$ComPtr@UIUriRuntimeClassFactory@Foundation@Windows@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIUriEscapeStatics@Foundation@Windows@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005EF2C (--$As@UIUriEscapeStatics@Foundation@Windows@@@-$ComPtr@UIUriRuntimeClassFactory@Foundation@Windo.c)
 *     ??$insert@U?$pair@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@$0A@@std@@@std@@QEAA?AU?$pair@V?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@std@@@std@@@std@@_N@1@$$QEAU?$pair@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@1@@Z @ 0x18005FA64 (--$insert@U-$pair@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V12@@std@@@-$_Tr.c)
 *     ??0?$_Tree_comp@$0A@V?$_Tmap_traits@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@U?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@$0A@@std@@@std@@QEAA@AEBU?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@1@AEBV?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@1@@Z @ 0x18005FF10 (--0-$_Tree_comp@$0A@V-$_Tmap_traits@V-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@.c)
 *     ??0?$map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@@std@@QEAA@XZ @ 0x180060080 (--0-$map@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V12@U-$less@V-$basic_stri.c)
 *     ??1?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x180060358 (--1-$_Tree@V-$_Tmap_traits@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V12@U-$.c)
 ...
 *     ?Throw_HrIfFalseMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ @ 0x180063DD0 (-Throw_HrIfFalseMsg@in1diag3@details@wil@@YA_NPEAXIPEBDJ_N1ZZ.c)
 *     __security_check_cookie @ 0x1800B6D70 (__security_check_cookie.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1800BE010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

// Hidden C++ exception states: #wind=15
__int64 __fastcall CreativeFramework::SubscribedContentStore::GetSubscriptionContext(
        __int64 a1,
        CreativeFramework::SubscribedContentStore::Details *a2)
{
  unsigned __int16 **v4; // r8
  const unsigned __int16 *v5; // r8
  int StringSetting; // eax
  __int64 v7; // rax
  const unsigned __int16 (*v8)[23]; // rdx
  __int64 *v9; // rax
  int v10; // eax
  int v11; // eax
  __int64 i; // rbx
  ...
  int v18; // eax
  __int64 v19; // rdi
  __int64 (__fastcall *v20)(__int64, HSTRING, HSTRING *); // r12
  PCWSTR v21; // r15
  ...
  HSTRING v37; // [rsp+60h] [rbp-A0h] BYREF
  void *v38; // [rsp+68h] [rbp-98h] BYREF
  __int64 v39; // [rsp+70h] [rbp-90h]
  bool v40[8]; // [rsp+78h] [rbp-88h] BYREF
  ...
  HSTRING v50[5]; // [rsp+F8h] [rbp-8h] BYREF
  _QWORD v51[8]; // [rsp+120h] [rbp+20h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+1A8h] [rbp+A8h]

  v35 = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))a1;
  lpSubKey = 0LL;
  ...
  *(_QWORD *)v40 = 0LL;
  v41 = 0LL;
  v42 = 0LL;
  Windows::Internal::NativeString<Windows::Internal::CoTaskMemPolicy<unsigned short>>::_Free((__int64)v40);
  v41 = -1LL;
  v42 = -1LL;
  LOBYTE(v5) = 1;
  ...
  if ( StringSetting < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v31);
  v7 = std::wstring::wstring((__int64)&string);
  CreativeFramework::SubscribedContentStore::Details::SplitString(&v45, v7, L"&");
  std::wstring::_Tidy(&string, 1, 0LL);
  std::map<std::wstring,std::wstring>::map<std::wstring,std::wstring>(&v38);
  v35 = 0LL;
  v9 = (__int64 *)Windows::Internal::StringReference::StringReference(v50, v8);
  ...
  if ( v10 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v31);
  v33 = 0LL;
  v11 = Microsoft::WRL::ComPtr<Windows::Foundation::IUriRuntimeClassFactory>::As<Windows::Foundation::IUriEscapeStatics>(
          &v35,
          &v33);
  if ( v11 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v31);
  v13 = *((_QWORD *)&v45 + 1);
  for ( i = v45; i != v13; i += 32LL )
  {
    CreativeFramework::SubscribedContentStore::Details::SplitString(&sourceString, i, L"=");
    if ( *(_QWORD *)(i + 24) < 8uLL )
      wil::details::in1diag3::Throw_HrIfFalseMsg(
        ...
        v44 - (_QWORD)sourceString == 64,
        (bool)"Improperly formatted value: %ls",
        (const char *)i);
    else
      wil::details::in1diag3::Throw_HrIfFalseMsg(
        retaddr,
    ...
    v36 = 0LL;
    v14 = v33;
    v15 = *(__int64 (__fastcall **)(__int64, HSTRING, HSTRING *))(*(_QWORD *)v33 + 48LL);
    v16 = sourceString;
    if ( *((_QWORD *)sourceString + 3) >= 8uLL )
    ...
    if ( v18 < 0 )
      wil::details::in1diag3::Throw_Hr(
        ...
        v32);
    v19 = v33;
    v20 = *(__int64 (__fastcall **)(__int64, HSTRING, HSTRING *))(*(_QWORD *)v33 + 48LL);
    v21 = sourceString + 16;
    if ( *((_QWORD *)sourceString + 7) >= 8uLL )
      v21 = *(PCWSTR *)v21;
    v22 = -1LL;
    do
      ++v22;
    ...
    WindowsCreateStringReference(v21, v22, &hstringHeader, &string);
    v23 = v20(v19, string, &v36);
    if ( v23 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        (void *)0x252,
    ...
    v24 = std::wstring::wstring((__int64)v50);
    WindowsGetStringRawBuffer(v37, 0LL);
    v25 = std::wstring::wstring((__int64)&string);
    std::pair<std::wstring,std::wstring>::pair<std::wstring,std::wstring>((__int64)v51, v25, v24);
    std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::insert<std::pair<std::wstring,std::wstring>>(
      ...
      (__int64)v47,
      (__int64)v51);
    std::pair<std::wstring const,std::wstring>::~pair<std::wstring const,std::wstring>(v51);
    std::wstring::_Tidy(&string, 1, 0LL);
    std::wstring::_Tidy(v50, 1, 0LL);
    Windows::Internal::String::~String(&v36);
    Windows::Internal::String::~String(&v37);
    if ( sourceString )
    {
      std::vector<std::wstring>::_Destroy(v26, (__int64)sourceString, v44);
      operator delete((void *)sourceString);
    }
  }
  std::_Tree_comp<0,std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Tree_comp<0,std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>((_QWORD *)a1);
  v27 = *(__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))a1;
  *(_QWORD *)a1 = v38;
  v38 = v27;
  v28 = *(_QWORD *)(a1 + 8);
  *(_QWORD *)(a1 + 8) = v39;
  ...
  if ( (_QWORD)v45 )
  {
    std::vector<std::wstring>::_Destroy(v29, v45, *((__int64 *)&v45 + 1));
