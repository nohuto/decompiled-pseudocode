/*
 * XREFs of ??$query@UISecondaryTile@StartScreen@UI@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A3E78
 * Callers:
