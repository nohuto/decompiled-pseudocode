/*
 * XREFs of _CreativeFramework::Actions::ResolveTargetPackageFamilyNameForLaunch_::_1_::dtor$0 @ 0x1800BBC6F
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
    std::pair<std::wstring const,std::wstring>::~pair<std::wstring const,std::wstring>(*(_QWORD **)(a2 + 48));
  }
}
