/*
 * XREFs of ?CreatePhoneLink@PhoneShellNamespaceHelper@ContentManagement@@AEAAJPEBG0PEAPEAG@Z @ 0x18002E2D8
 * Callers:
 ...
 * Callees:
 *     ??_U@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x1800226A0 (--_U@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     memcpy_0 @ 0x1800227E6 (memcpy_0.c)
 *     memset_0 @ 0x180022931 (memset_0.c)
 *     ??1?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@QEAA@XZ @ 0x18002A3B4 (--1-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-CloseHandle@@YAH0@Z@details@wil@.c)
 ...
 *     ?Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x18003A270 (-Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z.c)
...
LABEL_8:
  ...
  while ( a3[v10] );
  v15 = 2 * v10;
  InputBufferLength = v15 + UnicodeString.Length + 20;
...
LABEL_11:
  ...
  *(_DWORD *)v18 = -1610612733;
  ...
  v18[7] = v15;
  v18[6] = v20 + 2;
  memcpy_0((char *)v18 + v20 + 18, a3, (unsigned __int16)v15);
  IoStatusBlock = 0LL;
