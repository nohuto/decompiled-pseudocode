/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x18003CCD0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_180179928);
      v8 = &stru_180179928;
      if ( qword_180179998
        || (qword_180179998 = 0LL,
                             ...
                             &qword_180179998)) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_180179950,
          this,
          (void (*)(void *))a2,
          a3);
      }
