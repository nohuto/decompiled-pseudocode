/*
 * XREFs of ?get_NotificationManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUINotificationManager@2@@Z @ 0x18003EDD0
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@VNotificationManager@ContentManagement@@UINotificationManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUINotificationManager@ContentManagement@@@Z @ 0x180026748 (--$MakeAndInitialize@VNotificationManager@ContentManagement@@UINotificationManager@2@$$V@Details.c)
