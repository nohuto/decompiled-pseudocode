/*
 * XREFs of ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x18003B984
 * Callers:
 ...
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVexception@@PEAG_K@Z @ 0x1800352F8 (-MaybeGetExceptionString@details@wil@@YAXAEBVexception@@PEAG_K@Z.c)
 ...
 * Callees:
 *     StringVPrintfWorkerW @ 0x18003BA68 (StringVPrintfWorkerW.c)
 */
