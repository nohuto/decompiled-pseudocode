/*
 * XREFs of ??1CreativeEventReportedCache@ContentManagement@@UEAA@XZ @ 0x18004C798
 * Callers:
 *     ??_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z @ 0x18004DC30 (--_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
