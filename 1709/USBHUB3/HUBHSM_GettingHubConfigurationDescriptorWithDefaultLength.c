/*
 * XREFs of HUBHSM_GettingHubConfigurationDescriptorWithDefaultLength @ 0x1C00083F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_GettingHubConfigurationDescriptorWithDefaultLength(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 1248) = PoolWithTag;
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 2512), 2u, 3u, 0x11u, (__int64)&WPP_c9133184bb0b3c65ec7754ef3e1e0957_Traceguids);
