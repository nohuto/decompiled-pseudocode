/*
 * XREFs of HUBDTX_ValidateAndCacheSerialNumberStringDescriptor @ 0x1C0025360
 * Callers:
 *     HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice @ 0x1C001BA40 (HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheSerialNumberStringDescriptor(__int64 a1)
{
  ...
  v4 = (unsigned __int8 *)(v1 + 1732);
  v5 = BYTE5(v33[1]);
  LOWORD(v33[0]) = *(_WORD *)(v1 + 1990);
  HIDWORD(v33[0]) = *(_DWORD *)(v1 + 172);
  v6 = *(_DWORD *)(v2 + 4);
  v7 = *(_DWORD *)(v1 + 256);
  v8 = v7;
  if ( (v6 & 0x20) != 0 )
  ...
  v32 = *(_QWORD *)(v12 + 1432);
  v15 = HUBDESC_InternalValidateStringDescriptor((int)v1 + 1732, v7, (unsigned int)&v31, v3, v32, (__int64)v33);
  v16 = &WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids;
  v17 = v15;
  if ( !v15 )
    goto LABEL_20;
  v18 = *v4;
  ...
  if ( v20 )
  {
    ...
    do
    {
      ...
      if ( !*v22 )
        break;
      if ( (unsigned __int16)(v23 - 32) > 0x5Fu || v23 == 44 )
      {
        v17 = 0;
        LODWORD(v30) = v23;
        WPP_RECORDER_SF_d(v21, 2u, 5u, 0x111u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v30);
...
LABEL_20:
    WPP_RECORDER_SF_(v32, 2u, 5u, 0x112u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  if ( v17 )
  {
    v26 = *(void **)(v1 + 2152);
    if ( v26 )
...
LABEL_36:
    ...
    {
LABEL_37:
      memmove(v28, (const void *)(v1 + 1734), v7 - 2LL);
