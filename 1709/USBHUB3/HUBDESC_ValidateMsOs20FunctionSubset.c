/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x1C0033570
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Bu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Cu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  return v8;
}
