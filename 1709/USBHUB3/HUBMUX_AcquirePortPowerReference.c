/*
 * XREFs of HUBMUX_AcquirePortPowerReference @ 0x1C000D988
 * Callers:
 *     HUBPSM20_AcquiringPortReferenceOnStart @ 0x1C000E790 (HUBPSM20_AcquiringPortReferenceOnStart.c)
...
void __fastcall HUBMUX_AcquirePortPowerReference(volatile signed __int32 *a1)
{
  ...
  _InterlockedIncrement((volatile signed __int32 *)(v1 + 2336));
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 2324), 0xFFFFFFFF) == 1 )
    HUBSM_AddEvent(v1 + 1256, 2054);
}
