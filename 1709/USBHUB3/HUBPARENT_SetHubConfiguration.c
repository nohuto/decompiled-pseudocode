/*
 * XREFs of HUBPARENT_SetHubConfiguration @ 0x1C000655C
 * Callers:
 *     HUBHSM_SettingHubConfiguration @ 0x1C0008780 (HUBHSM_SettingHubConfiguration.c)
 * Callees:
...
__int64 __fastcall HUBPARENT_SetHubConfiguration(__int64 a1)
{
  ...
  v1 = *(struct _USB_CONFIGURATION_DESCRIPTOR **)(a1 + 1248);
  v2 = 0LL;
  v13 = 0LL;
  v4 = *(_DWORD *)(a1 + 248) - 1;
  if ( !v4 )
...
LABEL_9:
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0xCu, (__int64)&WPP_d887d9a76eb73ffd9207a7a58ef2b697_Traceguids);
LABEL_20:
  if ( v13 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1664))(WdfDriverGlobals);
  if ( v2 )
    ExFreePoolWithTag(v2, 0);
  return HUBSM_AddEvent(a1 + 1256, 2006LL);
}
