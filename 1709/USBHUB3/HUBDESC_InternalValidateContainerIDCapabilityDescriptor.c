/*
 * XREFs of HUBDESC_InternalValidateContainerIDCapabilityDescriptor @ 0x1C002FB6C
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a1 < 0x14u )
  {
    ...
    if ( v11 < 0x14 )
    {
      v15 = 1;
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v10, 2u, v13, 0x7Fu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, *a1, 20);
      goto LABEL_25;
    }
    *v5 = 2;
    *a3 = 20;
  ...
  if ( *a1 > 0x14u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *v5 = 2;
    WPP_RECORDER_SF_DDD(v10, 2u, v14, 0x80u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, *a1, 20);
  ...
  if ( *v20 <= v11 )
  {
    if ( a1[3] )
    {
      if ( *(_BYTE *)(a2 + 15) )
        *v5 = 2;
      LODWORD(v18) = a1[3];
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x82u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v18);
    ...
    if ( *(_QWORD *)(a1 + 4) == *(_QWORD *)&GUID_NULL.Data1 && *(_QWORD *)(a1 + 12) == *(_QWORD *)GUID_NULL.Data4 )
    {
      *(_BYTE *)(*(_QWORD *)(a2 + 80) + 41LL) = 1;
      WPP_RECORDER_SF_(v10, 2u, 5u, 0x83u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  ...
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 2;
    LODWORD(v18) = v9;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x81u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v18);
...
LABEL_25:
  ...
  {
    v15 = 0;
    WPP_RECORDER_SF_(v10, 2u, 5u, 0x84u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  }
  return v15;
}
