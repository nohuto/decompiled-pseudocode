/*
 * XREFs of HUBSM_FindAndSetTargetState @ 0x1C0008E7C
 * Callers:
...
char __fastcall HUBSM_FindAndSetTargetState(__int64 a1, int a2, _BYTE *a3)
{
  ...
  *a3 = 0;
  ...
  while ( 1 )
  {
    v10 = 0LL;
    v11 = 1002;
    v12 = *(_QWORD *)(v5 + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4LL * v8 + 852) - v7));
...
LABEL_8:
  ...
  if ( v11 <= 0x3EE )
  {
    ...
    {
      v23 = *(_QWORD **)(a1 + 960);
      v24 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64, _BYTE *))(WdfFunctions_01015 + 2280))(
              WdfDriverGlobals,
              v23[62],
              v10,
              a3);
...
LABEL_19:
    ...
    v18 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *, _BYTE *))(WdfFunctions_01015 + 1616))(
            WdfDriverGlobals,
...
LABEL_39:
  if ( v8 != (_DWORD)v3 && (unsigned int)v3 > v8 )
  {
    while ( 1 )
    {
      v26 = *(_DWORD *)(a1 + 984);
...
LABEL_49:
        v37 = *(_QWORD *)(a1 + 960);
        WPP_RECORDER_SF_qLLL(v12, v5, v10, v28, v36);
      }
...
LABEL_54:
  v30 = *(_QWORD *)(v43 + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4LL * v8 + 852) - v41));
...
LABEL_64:
      v37 = *(_QWORD *)(a1 + 960);
      WPP_RECORDER_SF_qLLL(v30, v8, v10, v32, v36);
      break;
  }
