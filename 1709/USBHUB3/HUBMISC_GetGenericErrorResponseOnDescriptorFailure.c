/*
 * XREFs of HUBMISC_GetGenericErrorResponseOnDescriptorFailure @ 0x1C0025A90
 * Callers:
 *     HUBDSM_ReturningErrorResponseOnProductStringQuery @ 0x1C001AFD0 (HUBDSM_ReturningErrorResponseOnProductStringQuery.c)
 * Callees:
