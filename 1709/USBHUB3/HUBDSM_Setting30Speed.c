/*
 * XREFs of HUBDSM_Setting30Speed @ 0x1C001AB30
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_ComputeDelayInNanoSecondsFromSpeedAttr @ 0x1C0028CE0 (HUBMISC_ComputeDelayInNanoSecondsFromSpeedAttr.c)
 */
