/*
 * XREFs of WMI_QueryInstanceDeviceNodeInfo @ 0x1C0035410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WMI_QueryInstanceDeviceNodeInfo(__int64 a1, unsigned int a2, _DWORD *a3, unsigned int *a4)
{
  ...
  *a4 = 1202;
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)(v11 + 40), v12);
  *(_OWORD *)((char *)a3 + 130) = *(_OWORD *)(v11 + 1988);
  *((_WORD *)a3 + 73) = *(_WORD *)(v11 + 2004);
  *(_DWORD *)((char *)a3 + 149) = *(_DWORD *)(v11 + 172);
