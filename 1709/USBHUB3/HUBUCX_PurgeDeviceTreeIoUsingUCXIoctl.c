/*
 * XREFs of HUBUCX_PurgeDeviceTreeIoUsingUCXIoctl @ 0x1C0021C9C
 * Callers:
 *     HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured @ 0x1C001CFA0 (HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured.c)
 * Callees:
