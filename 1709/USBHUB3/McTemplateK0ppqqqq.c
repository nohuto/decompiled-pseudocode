/*
 * XREFs of McTemplateK0ppqqqq @ 0x1C0008B7C
 * Callers:
...
NTSTATUS McTemplateK0ppqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(a1, a2, a3, 7u, &v4);
}
