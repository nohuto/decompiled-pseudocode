/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x1C0007048
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x1C0008A40 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
...
LABEL_6:
  if ( v4 < 0 )
  {
    ...
    return HUBSM_AddEvent(a1 + 1256, 2038LL);
  }
  return result;
}
