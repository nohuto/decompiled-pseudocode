/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x1C00337F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20CompatibleId(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 0x20) != 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Du, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  ...
  do
  {
    ...
    if ( *v12 )
    {
      if ( v11 == 1 )
      {
        v20 = 319;
LABEL_26:
        WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, v20, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
        v9 = 168LL;
        goto LABEL_6;
      }
