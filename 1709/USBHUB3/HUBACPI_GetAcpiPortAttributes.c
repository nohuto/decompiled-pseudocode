/*
 * XREFs of HUBACPI_GetAcpiPortAttributes @ 0x1C0073CD8
 * Callers:
...
__int64 __fastcall HUBACPI_GetAcpiPortAttributes(__int64 a1)
{
  ...
  v41[3] = 0x100000001LL;
  v3 = v2(WdfDriverGlobals, v41, (unsigned int)ExDefaultNonPagedPoolType, 1748191317LL, 20LL, &v36, v42);
  if ( v3 < 0 )
  {
    v4 = 32;
LABEL_3:
  ...
  v5 = HUBACPI_EnumChildren(a1, v36);
  if ( v5 == -1073741637 )
  {
    v6 = 33;
    v7 = 4;
LABEL_6:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), v7, 3u, v6, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    goto LABEL_47;
  }
  if ( v5 == -2147483643 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 4u, 3u, 0x22u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
...
LABEL_10:
    ...
    v3 = HUBACPI_EnumChildren(a1, v35);
    if ( v3 < 0 )
    {
      v4 = 36;
      goto LABEL_3;
    ...
    if ( *(_DWORD *)(v40 + 4) > 1u )
    {
      while ( 1 )
      {
        ...
        for ( i = *(_QWORD *)(a1 + 2352); ; i = *(_QWORD *)(v14 + 248) )
        {
          v14 = i - 248;
          if ( a1 + 2352 == v14 + 248 )
            goto LABEL_45;
...
LABEL_82:
        ...
        else
        {
          if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x4000) != 0 )
          {
            ...
            LODWORD(v31) = v12;
            McTemplateK0pqq(v46, &USBHUB3_ETW_EVENT_HUB_PORT_ACPI_UPC_FAILURE, 0LL, *(_QWORD *)(a1 + 16), v31, v33);
          }
          LODWORD(v33) = v12;
          WPP_RECORDER_SF_d(
            *(_QWORD *)(a1 + 2512),
