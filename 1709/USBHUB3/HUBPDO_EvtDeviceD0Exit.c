/*
 * XREFs of HUBPDO_EvtDeviceD0Exit @ 0x1C00154A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceD0Exit(__int64 a1, int a2)
{
  ...
  *(_DWORD *)(v4 + 384) = a2;
  ...
  if ( (*(_DWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(v5 + 1616))(
                      ...
                      off_1C005B110)
                  + 4) & 0x1000) != 0
    && EtwActivityIdControl(3u, (LPGUID)(v8 + 2176)) >= 0 )
  {
    v25 = *(_OWORD *)(v8 + 2176);
    _InterlockedOr((volatile signed __int32 *)(v8 + 1636), 0x80u);
  }
  KeClearEvent((PRKEVENT)(v8 + 1584));
  ...
  {
    if ( !v10 && (*(_DWORD *)(v8 + 1632) & 0x400) == 0 )
    {
      _InterlockedOr((volatile signed __int32 *)(v8 + 1632), 0x400u);
    ...
    if ( a2 == 4 )
    {
      ...
      if ( (*(_DWORD *)(v8 + 1632) & 0x4000) == 0 )
        HUBIDLE_AddEvent(v6 + 72, 6008LL, 0LL);
    }
  }
  v14 = 4071;
LABEL_23:
  HUBSM_AddEvent(v8 + 504, v14);
  HUBMISC_WaitForSignal((PVOID)(v8 + 1584));
  LOBYTE(v16) = 1;
  v17 = *(_DWORD *)(v8 + 1576);
  ...
  _InterlockedAnd((volatile signed __int32 *)(v8 + 1636), 0xFFFFFF7F);
  return v17;
}
