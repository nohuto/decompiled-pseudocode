/*
 * XREFs of HUBREG_OpenCreateUsbflagsDeviceKey @ 0x1C006E920
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(_DWORD *)&DestinationString.Length = 3407872;
  ...
  {
    LODWORD(v16) = v13;
    WPP_RECORDER_SF_d(a7, 2u, 5u, 0xAu, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v16);
LABEL_11:
    if ( *a6 )
    {
  ...
  {
    LODWORD(v16) = v14;
    WPP_RECORDER_SF_d(a7, 2u, 5u, 0xBu, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v16);
    goto LABEL_11;
  }
  ...
  {
    LODWORD(v17) = v13;
    WPP_RECORDER_SF_d(a7, 2u, 5u, 0xCu, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v17);
    goto LABEL_11;
  }
  return (unsigned int)v13;
}
