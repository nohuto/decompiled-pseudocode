/*
 * XREFs of HUBFDO_QueryHubErrataFlags @ 0x1C006A00C
 * Callers:
 *     HUBHSM_QueryingForHubHackFlags @ 0x1C00079D0 (HUBHSM_QueryingForHubHackFlags.c)
 * Callees:
...
__int64 __fastcall HUBFDO_QueryHubErrataFlags(__int64 a1)
{
  ...
  {
    v4 = a1 + 2448;
    HUBMISC_ConvertUsbDeviceIdsToString((unsigned __int16 *)(a1 + 2448), pszDest, v8, v6);
    v3 = v4;
  }
  else
  {
