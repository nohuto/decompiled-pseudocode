/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x1C0023B7C
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x1C001C130 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheBOSDescriptorHeader(__int64 a1)
{
  ...
  v5 = *(_DWORD *)(v4 + 4);
  v6 = *(_QWORD *)(a1 + 8);
  LOWORD(v16[0]) = *(_WORD *)(a1 + 1990);
  DWORD1(v16[0]) = *(_DWORD *)(a1 + 172);
  v7 = BYTE13(v16[0]);
  if ( (v5 & 0x20) != 0 )
    v7 = 1;
  *((_QWORD *)&v16[2] + 1) = a1;
