/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C00215C4
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C00087A0 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
LABEL_3:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2512), 2u, 3u, v5, (__int64)&WPP_3d53ed487f413aabe4c3ad9959a4b253_Traceguids, v6);
    goto LABEL_14;
  }
  memset(v7, 0, 0x38uLL);
  v7[4] = v9;
  ...
  *((_DWORD *)v8 + 6) = *(unsigned __int16 *)(a1 + 48);
  if ( *(_DWORD *)(a1 + 248) == 2 )
  {
    ...
    *((_DWORD *)v8 + 8) = (*(unsigned __int16 *)(a1 + 1175) >> 5) & 3;
  }
