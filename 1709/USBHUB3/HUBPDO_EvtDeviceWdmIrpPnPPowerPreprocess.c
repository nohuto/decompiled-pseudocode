/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpPnPPowerPreprocess @ 0x1C0013710
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HUBREG_UpdateSqmEnumerationFailureCode @ 0x1C0072C14 (HUBREG_UpdateSqmEnumerationFailureCode.c)
 */
...
__int64 __fastcall HUBPDO_EvtDeviceWdmIrpPnPPowerPreprocess(__int64 a1, IRP *a2)
{
  ...
  if ( CurrentStackLocation->MajorFunction == 22 )
  {
    if ( CurrentStackLocation->MinorFunction == 2 && CurrentStackLocation->Parameters.Create.Options == 1 )
    {
      ...
      LODWORD(v20) = CurrentStackLocation->Parameters.Read.ByteOffset.LowPart;
      WPP_RECORDER_SF_d(
        *(_QWORD *)(*(_QWORD *)(v3 + 8) + 1432LL),
        4u,
        5u,
...
LABEL_27:
    ...
    case 0x19u:
      ...
      v8 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
             ...
             off_1C005B070);
      v9 = v8;
      if ( *(_QWORD *)(*(_QWORD *)(v8 + 24) + 2632LL) )
        HUBPDO_PublishBillboardDetails(v8);
      if ( (*(_DWORD *)(*(_QWORD *)(v9 + 24) + 1632LL) & 0x40000) != 0 )
...
LABEL_39:
  ...
  else
  {
    ...
    *(_OWORD *)(&v17[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&v17->Parameters.SetQuota + 6);
    ...
    v18[-1].CompletionRoutine = (int (__fastcall *)(_DEVICE_OBJECT *, _IRP *, void *))HUBPDO_WdmPnpPowerIrpCompletionRoutineForAsynchronousCompletion;
    v18[-1].Context = (void *)v3;
    v18[-1].Control = -32;
  }
