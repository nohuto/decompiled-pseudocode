/*
 * XREFs of HUBDESC_InternalValidateIADescriptor @ 0x1C002F48C
 * Callers:
  ...
  *a3 = v12;
  if ( (unsigned __int8)v12 < 8u )
  {
    ...
    if ( v11 < 8 )
    {
      v17 = 1;
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v10, 2u, v14, 0x73u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, *a1, 8);
      goto LABEL_43;
    }
    *a3 = 8;
  ...
  if ( *a1 > 8u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    WPP_RECORDER_SF_DDD(v10, 2u, v15, 0x74u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, *a1, 8);
  ...
  if ( *a3 <= v11 )
  {
    if ( 256 - a1[2] < a1[3] )
    {
      ...
      LODWORD(v25) = a1[2];
      LODWORD(v24) = v9;
      WPP_RECORDER_SF_DDD(v10, 2u, v18, 0x76u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v24, v25, v26);
    ...
    if ( a1[3] > *(_BYTE *)(v28 + 4) )
    {
      ...
      LODWORD(v25) = a1[3];
      LODWORD(v24) = v9;
      WPP_RECORDER_SF_DDD(v10, 2u, v20, 0x77u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v24, v25, v26);
    ...
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    LODWORD(v24) = v9;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x79u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v24);
    v16 = 96LL;
  }
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    LODWORD(v24) = v9;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x75u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v24);
    v16 = 94LL;
  }
...
LABEL_43:
  ...
  {
    v17 = 0;
    WPP_RECORDER_SF_(v10, 2u, 5u, 0x7Au, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  }
  return v17;
}
