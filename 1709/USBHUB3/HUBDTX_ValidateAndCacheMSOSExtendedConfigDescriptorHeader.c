/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptorHeader @ 0x1C0024F84
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedConfigDescriptorHeader @ 0x1C001BA20 (HUBDSM_ValidatingMSOSExtendedConfigDescriptorHeader.c)
 * Callees:
...
LABEL_13:
    WPP_RECORDER_SF_(v4, 2u, 5u, 0x110u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  ...
  if ( v6 != 256 )
  {
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Cu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v6, 256);
  ...
  if ( v7 != 4 )
  {
    LODWORD(v11) = 4;
    LODWORD(v10) = v7;
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Du, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v10, v11);
    HUBMISC_LogDescriptorValidationErrorForDevice(a1, 125LL);
    v3 = 0;
  }
  if ( *(_BYTE *)(a1 + 1740) != 1 )
  {
    WPP_RECORDER_SF_(v4, 2u, 5u, 0x10Eu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
    v5 = 121LL;
    goto LABEL_3;
  }
  if ( *(_DWORD *)(a1 + 1732) != 40 )
  {
    ...
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Fu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v10, v11);
