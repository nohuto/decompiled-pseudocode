/*
 * XREFs of WPP_RECORDER_SF_qd @ 0x1C0002A08
 * Callers:
 *     HUBHTX_Get30PortChangeEvent @ 0x1C0004B7C (HUBHTX_Get30PortChangeEvent.c)
 *     HUBHSM_WaitingForOvercurrentToClear @ 0x1C0008160 (HUBHSM_WaitingForOvercurrentToClear.c)
 *     HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax @ 0x1C0026E08 (HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax.c)
 *     HUBMISC_StartOverCurrentTimer @ 0x1C002A080 (HUBMISC_StartOverCurrentTimer.c)
 *     HUBMISC_StartD3ColdReconnectTimer @ 0x1C002A170 (HUBMISC_StartD3ColdReconnectTimer.c)
 * Callees:
