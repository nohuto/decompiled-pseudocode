/*
 * XREFs of HUBSM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState @ 0x1C00094FC
 * Callers:
 *     HUBSM_EvtSmWorkItem @ 0x1C0009BE0 (HUBSM_EvtSmWorkItem.c)
            ...
            if ( v18 > 0xFC7 )
            {
              ...
              if ( v39 )
              {
                ...
                if ( v40 )
                {
                  ...
                  v33 = *(_QWORD *)(a1 + 960);
                  if ( (*(_DWORD *)(v33 + 1636) & 0x80u) == 0 )
                    goto LABEL_50;
                  v35 = a1 + 1012;
                  *(_OWORD *)(a1 + 1012) = *(_OWORD *)(v33 + 2176);
LABEL_45:
                  if ( g_IoSetActivityIdIrp )
                  {
                    g_IoSetActivityIdIrp(*(_QWORD *)(v33 + 264), v35);
                    if ( g_IoSetActivityIdIrp )
                      g_IoSetActivityIdIrp(*(_QWORD *)(v33 + 424), v35);
                  }
                  _InterlockedOr((volatile signed __int32 *)(v33 + 1636), 0x40u);
LABEL_49:
                  LODWORD(v17) = v53;
                  goto LABEL_50;
                }
            ...
            else if ( v18 != 4039 )
            {
              ...
              if ( !v29 )
              {
                ...
                {
                  if ( (*(_DWORD *)(*(_QWORD *)(v36 + 1328) + 1636LL) & 0x400) != 0 )
                  {
                    WPP_RECORDER_SF_(
                      *(_QWORD *)(v36 + 1432),
                      4u,
                    ...
                    _InterlockedAnd((volatile signed __int32 *)(*(_QWORD *)(v36 + 1328) + 1636LL), 0xFFFFFBFF);
                  }
                }
                else
                {
            ...
            {
              v35 = a1 + 1012;
              if ( (*(int (__fastcall **)(__int64, __int64))&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters)(v34, a1 + 1012) >= 0 )
                goto LABEL_45;
              goto LABEL_49;
            }
LABEL_50:
...
LABEL_76:
    ...
    *(_DWORD *)(a1 + 880) = v3;
    ...
    v49 = *(_QWORD *)(a1 + 960);
    WPP_RECORDER_SF_qLLL(v7, (__int64)v10, v9, v25, v48);
LABEL_25:
  ...
  (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(), __int64, _QWORD))(*(_QWORD *)(a1 + 1000) + 504LL))(
    *(_QWORD *)(a1 + 992),
    HUBSM_EvtSmWorkItem,
    a1,
