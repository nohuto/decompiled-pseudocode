/*
 * XREFs of HUBFDO_CleanupDeviceInterfaceForBillboard @ 0x1C000CAC8
 * Callers:
...
__int64 __fastcall HUBFDO_CleanupDeviceInterfaceForBillboard(__int64 a1, unsigned __int16 a2, __int64 a3, char a4)
{
  ...
  {
    v8 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 4u, 3u, 0x41u, (__int64)&WPP_ae437379bf4e39bc88b98c8aab0da7f7_Traceguids);
    goto LABEL_9;
  }
