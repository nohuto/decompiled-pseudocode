/*
 * XREFs of HUBDTX_LogBillboardEvent @ 0x1C002567C
 * Callers:
 *     HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried @ 0x1C001BCA0 (HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried.c)
