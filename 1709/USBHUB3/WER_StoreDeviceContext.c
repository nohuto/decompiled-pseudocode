/*
 * XREFs of WER_StoreDeviceContext @ 0x1C00349CC
 * Callers:
...
__int64 __fastcall WER_StoreDeviceContext(__int64 a1, __int64 a2)
{
  ...
  inserted = TelemetryData_InsertTriageDataBlock(a1, a2, 2696LL);
  if ( inserted >= 0 )
  {
    v5 = *(_QWORD *)(a2 + 48);
    if ( !v5 )
...
LABEL_12:
        v11 = *(_QWORD *)(a2 + 72);
        if ( !v11
          || (inserted = TelemetryData_InsertTriageDataBlock(a1, v11, 72LL * *(unsigned int *)(v11 + 24) + 40),
              inserted >= 0) )
        {
          v12 = *(_QWORD *)(a2 + 80);
          if ( !v12
            || (inserted = TelemetryData_InsertTriageDataBlock(a1, v12, 72LL * *(unsigned int *)(v12 + 24) + 40),
                inserted >= 0) )
          {
            v13 = *(_QWORD *)(a2 + 104);
            if ( !v13
      ...
      else
      {
        while ( 1 )
        {
          inserted = TelemetryData_InsertTriageDataBlock(a1, v10, (unsigned int)(72 * *(_DWORD *)(v10 + 24) + 40));
          if ( inserted < 0 )
            break;
