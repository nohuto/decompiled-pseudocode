/*
 * XREFs of McTemplateK0ppqzznhCR6zcqQ6qqqqqqqqqsssccx @ 0x1C00013DC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0ppqzznhCR6zcqQ6qqqqqqqqqsssccx(
        __int64 a1,
        ...
        char a31)
{
  ...
  v114 = 8LL;
  v113 = &a31;
  return McGenEventWriteKM(v51, a2, a3, 0x1Cu, &v53);
}
