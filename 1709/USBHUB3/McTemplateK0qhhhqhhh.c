/*
 * XREFs of McTemplateK0qhhhqhhh @ 0x1C0001C70
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qhhhqhhh(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 2LL;
  v28 = 2LL;
  return McGenEventWriteKM(a1, &USBHUB3_ETW_EVENT_PORT_STATUS_ERROR_V1, a3, 9u, &v12);
}
