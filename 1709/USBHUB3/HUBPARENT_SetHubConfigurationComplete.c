/*
 * XREFs of HUBPARENT_SetHubConfigurationComplete @ 0x1C0006400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPARENT_SetHubConfigurationComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v9 < 0 )
    goto LABEL_8;
  *(_QWORD *)(v8 + 1096) = *(_QWORD *)(a4 + 72);
  *(_QWORD *)(v8 + 80) = *(_QWORD *)(a4 + 32);
  v12 = *(_WORD *)(a4 + 64);
  *(_WORD *)(v11 + 88) = v12;
  if ( *(_WORD *)(v11 + 2450) >= 0x300u )
  {
    if ( v12 > 2u )
      v9 = -1073741216;
    if ( v12 != 2 )
...
LABEL_8:
  ...
  return HUBSM_AddEvent(v11 + 1256, ((v9 >> 31) & 0xFFFFFFFC) + 2010);
}
