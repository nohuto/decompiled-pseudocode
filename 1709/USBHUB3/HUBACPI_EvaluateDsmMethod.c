/*
 * XREFs of HUBACPI_EvaluateDsmMethod @ 0x1C0073114
 * Callers:
...
LABEL_4:
  ...
  if ( (unsigned __int64)(unsigned int)(v12 + 1) + 5 <= 0x100 )
  {
    ...
    *(_DWORD *)((char *)v21 + v23 + 288) = 3;
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD *))(WdfFunctions_01015 + 2024))(
            ...
            v20,
            v32) )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0xEu, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0x10u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
      v10 = -1072431089;
    }
  }
  else
  {
    v10 = -1073741811;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0xBu, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
  }
LABEL_28:
  if ( v29 )
