/*
 * XREFs of HUBHSM_SendingAckForHubChange @ 0x1C0007E10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_SendingAckForHubChange(__int64 a1)
{
  ...
  *(_BYTE *)(v1 + 944) = v2 | 0x20;
  v3 = *(unsigned __int16 *)(v1 + 780);
  *(_WORD *)(v1 + 946) = v3;
  *(_DWORD *)(v1 + 948) = 0;
  v6 = v3;
  WPP_RECORDER_SF_d(*(_QWORD *)(v1 + 2512), 4u, 3u, 0xCu, (__int64)&WPP_c9133184bb0b3c65ec7754ef3e1e0957_Traceguids, v6);
