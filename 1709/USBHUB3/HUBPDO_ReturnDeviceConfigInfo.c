/*
 * XREFs of HUBPDO_ReturnDeviceConfigInfo @ 0x1C0012410
 * Callers:
...
LABEL_3:
  ...
  *(_DWORD *)(v4 + 4) = 204;
  v7 = *(_DWORD *)(v4 + 8);
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 16) + 2488LL) & 2) != 0 )
    v7 = 1;
  *(_DWORD *)(v4 + 8) = v7;
  if ( *(_WORD *)(*(_QWORD *)(a1 + 16) + 2450LL) >= 0x200u )
    *(_DWORD *)(v4 + 8) |= 1u;
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 24) + 1632LL) & 1) != 0 )
  {
    *(_DWORD *)(v4 + 132) |= 1u;
    v8 = *(_QWORD *)(a1 + 24);
    *(_OWORD *)(v4 + 136) = *(_OWORD *)(v8 + 1664);
    *(_OWORD *)(v4 + 152) = *(_OWORD *)(v8 + 1680);
    *(_OWORD *)(v4 + 168) = *(_OWORD *)(v8 + 1696);
    *(_OWORD *)(v4 + 184) = *(_OWORD *)(v8 + 1712);
    *(_DWORD *)(v4 + 200) = *(_DWORD *)(v8 + 1728);
  }
