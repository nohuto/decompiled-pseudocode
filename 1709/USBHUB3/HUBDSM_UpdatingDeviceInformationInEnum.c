/*
 * XREFs of HUBDSM_UpdatingDeviceInformationInEnum @ 0x1C001A540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_UpdatingDeviceInformationInEnum(__int64 a1)
{
  ...
  memset(v2, 0, 0x48uLL);
  v2[6] |= 0xFu;
  if ( (*(_DWORD *)(v1 + 1644) & 0x400) != 0 )
    v2[6] |= 0x10u;
  *v2 = 72;
  *((_QWORD *)v2 + 1) = *(_QWORD *)(*(_QWORD *)v1 + 240LL);
  *((_QWORD *)v2 + 2) = *(_QWORD *)(v1 + 24);
  *((_QWORD *)v2 + 4) = v1 + 1988;
  *((_QWORD *)v2 + 5) = *(_QWORD *)(v1 + 2056);
  v3 = *(_BYTE *)(v1 + 2220);
  if ( (v3 & 8) == 0 || (*(_DWORD *)(v1 + 1644) & 0x80u) != 0 || (*(_DWORD *)(*(_QWORD *)v1 + 40LL) & 0x8000) != 0 )
  {
    v2[12] = 0;
  }
  else
  {
    v4 = *(unsigned __int16 *)(v1 + 2204);
    *(_BYTE *)(v1 + 2213) = ~(v3 >> 5) | 0xFE;
    v2[12] = v4;
  }
  if ( (*(_DWORD *)(v1 + 1632) & 2) != 0 )
    *((_BYTE *)v2 + 52) = 1;
  HUBUCX_ComputeUsb20HardwareLpmParameters(v1, v2);
  if ( (*(_DWORD *)(v1 + 2464) & 0x80u) != 0 )
  {
    v5 = *(_DWORD *)(v1 + 1632);
    if ( (v5 & 0x20) != 0 && (v5 & 2) == 0 && *(_DWORD *)(*(_QWORD *)(v1 + 8) + 208LL) == 512 )
    {
      v2[6] |= 0x40u;
      if ( *(_BYTE *)(*(_QWORD *)v1 + 232LL) )
        *((_WORD *)v2 + 32) = 20;
      else
        *((_WORD *)v2 + 32) = *(unsigned __int8 *)(*(_QWORD *)(v1 + 2504) + 5LL);
    }
  }
