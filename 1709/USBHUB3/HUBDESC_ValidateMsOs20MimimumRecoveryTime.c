/*
 * XREFs of HUBDESC_ValidateMsOs20MimimumRecoveryTime @ 0x1C0033BD0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20MimimumRecoveryTime(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( *(char *)a2 < 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Bu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Fu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  return v6;
}
