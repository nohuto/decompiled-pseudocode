/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x1C0068F50
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    *((_WORD *)v31 + 6) = v12;
    *((_DWORD *)v31 + 1) = 18;
    for ( i = v9[294]; ; i = *(_QWORD *)(v14 + 248) )
    {
      v14 = i - 248;
      if ( v9 + 294 == (_QWORD *)(v14 + 248) )
        goto LABEL_8;
    ...
    if ( v14 )
    {
      ...
      if ( *((_WORD *)v31 + 6) <= 1u )
      {
        ...
        if ( CompanionPort )
        {
          v23 = (unsigned __int16 *)(*(_QWORD *)CompanionPort + 2536LL);
...
LABEL_8:
  ...
  WPP_RECORDER_SF_d(v9[314], 2u, 3u, 0x2Du, (__int64)&WPP_ae437379bf4e39bc88b98c8aab0da7f7_Traceguids, v10);
LABEL_10:
