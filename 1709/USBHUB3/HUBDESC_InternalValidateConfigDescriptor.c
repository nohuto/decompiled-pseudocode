/*
 * XREFs of HUBDESC_InternalValidateConfigDescriptor @ 0x1C002D0B4
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = 9;
  ...
  {
    *v5 = 1;
    WPP_RECORDER_SF_DDD(v9, 2u, 9LL, 0x11u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, *a1, 9, 9);
  ...
  if ( a1[1] != 2 )
  {
    *v5 = 1;
    ...
    LODWORD(v20) = 2;
    LODWORD(v19) = a1[1];
    WPP_RECORDER_SF_DDD(v9, 2u, v10, 0x13u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v19, v20, v21);
  ...
  if ( *a3 <= v14 )
  {
    ...
    if ( v15 > v14 )
    {
      ...
      WPP_RECORDER_SF_dD(v9, 2u, 5u, 0x15u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v19, v20);
    ...
    *(_QWORD *)(a2 + 64) = *(_QWORD *)(a2 + 56) + *((unsigned __int16 *)a1 + 1);
    if ( (unsigned int)*((unsigned __int16 *)a1 + 1) > *(_DWORD *)(a2 + 72) )
    {
      ...
      WPP_RECORDER_SF_DDD(v9, 2u, v16, 0x16u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v19, v20, v21);
    ...
    if ( *((unsigned __int16 *)a1 + 1) < v15 )
    {
      ...
      LODWORD(v20) = v15;
      LODWORD(v19) = *((unsigned __int16 *)a1 + 1);
      WPP_RECORDER_SF_DDD(v9, 2u, v17, 0x17u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v19, v20, v21);
  ...
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    WPP_RECORDER_SF_(v9, 2u, 5u, 0x14u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
    (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 56LL);
  }
  if ( *v5 )
  {
    v11 = 0;
    WPP_RECORDER_SF_(v9, 2u, 5u, 0x18u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  }
  return v11;
}
