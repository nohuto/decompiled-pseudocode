/*
 * XREFs of HUBREG_WriteDeviceWerThrottleMask @ 0x1C0072E38
 * Callers:
...
__int64 __fastcall HUBREG_WriteDeviceWerThrottleMask(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      {
        LODWORD(v11) = v8;
        WPP_RECORDER_SF_d(a3, 2u, 5u, 0x84u, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v11);
      }
    }
    else
    {
      LODWORD(v11) = v7;
      WPP_RECORDER_SF_d(a3, 2u, 5u, 0x83u, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v11);
    }
  }
  else
  {
    LODWORD(v10) = v5;
    WPP_RECORDER_SF_d(a3, 2u, 5u, 0x82u, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v10);
  }
  if ( v13 )
