/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptor @ 0x1C0023760
 * Callers:
 *     HUBDSM_ValidatingBOSDescriptor @ 0x1C001C110 (HUBDSM_ValidatingBOSDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheBOSDescriptor(__int64 a1)
{
  ...
  *(_QWORD *)&v27[8] = &HUBMISC_LogDescriptorValidationWarningForDevice;
  ...
  if ( v34 )
  {
    ...
    *(_BYTE *)(a1 + 2657) = *(_BYTE *)(v34 + 21);
    UsbDualRoleFeaturesQueryLocalMachine(a1 + 2649);
    v17 = v34;
    v18 = *(_QWORD *)(a1 + 8);
    *(_DWORD *)(a1 + 2653) = *(_DWORD *)(v34 + 22);
    v19 = *(unsigned int *)(v17 + 22);
    LOBYTE(v17) = 1;
    HUBWNF_PublishUsbPartnerDualRoleFeatures(*(_QWORD *)(v18 + 1416), v17, v19);
  }
  if ( *(_BYTE *)(*(_QWORD *)(a1 + 2016) + 4LL) > 1u && v32 == 1 )
  {
    v20 = *(_BYTE *)(a1 + 1992);
