/*
 * XREFs of HUBREG_QueryDeviceWerThrottleMask @ 0x1C0072C4C
 * Callers:
...
__int64 __fastcall HUBREG_QueryDeviceWerThrottleMask(__int64 a1, __int64 a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    {
      LODWORD(v9) = v4;
      WPP_RECORDER_SF_d(a2, 2u, 5u, 0x80u, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v9);
    }
  }
  else
  {
    LODWORD(v8) = v3;
    WPP_RECORDER_SF_d(a2, 2u, 5u, 0x7Fu, (__int64)&WPP_78b0949afb12367861659e8bf410c603_Traceguids, v8);
  }
  if ( v12 )
