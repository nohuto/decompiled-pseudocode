/*
 * XREFs of HUBFDO_EvtIoInternalDeviceControlFromPDO @ 0x1C000B600
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HUBFDO_EvtIoInternalDeviceControlFromPDO(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  {
    WPP_RECORDER_SF_d(v7[314], 2u, 3u, 0x1Cu, (__int64)&WPP_ae437379bf4e39bc88b98c8aab0da7f7_Traceguids, a5);
