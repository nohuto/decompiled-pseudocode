/*
 * XREFs of HUBDSM_ComparingSerialNumberOnReEnumeration @ 0x1C001CD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ComparingSerialNumberOnReEnumeration(__int64 a1)
{
  ...
  {
    v2 = v1 + 1732;
    v10 = RtlCompareMemory((const void *)(v1 + 1734), v5, v7);
    if ( v10 == v7 )
      return v3;
    WPP_RECORDER_SF_dD(
  ...
  if ( v2 )
  {
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x400000) != 0 )
      McTemplateK0psqzq(v9, v8, v1 + 1516, *(_QWORD *)(*(_QWORD *)v1 + 240LL), (__int64)v5, v6, v2 + 2, v7);
    return 4061;
  }
  else
  {
    v3 = 4061;
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x400000) != 0 )
      McTemplateK0psqzq(v9, v8, v1 + 1516, *(_QWORD *)(*(_QWORD *)v1 + 240LL), (__int64)v5, v6, 0LL, 0);
  }
  return v3;
}
