/*
 * XREFs of McTemplateK0phczc @ 0x1C0022210
 * Callers:
...
NTSTATUS McTemplateK0phczc(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  ...
  v14 = v5;
  va_copy(v17, va3);
  return McGenEventWriteKM(v4, a2, a3, 6u, &v7);
}
