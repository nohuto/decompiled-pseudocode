/*
 * XREFs of HUBDESC_InternalValidateInterfaceDescriptor @ 0x1C002EFD0
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v9;
  if ( (unsigned __int8)v9 < 9u )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v12, 2u, v15, 0x68u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, *a1, v10, v15);
      goto LABEL_58;
    }
    ...
    if ( *v5 != 1 )
    {
      if ( v32 )
      {
        if ( _bittest64(*(const signed __int64 **)(a2 + 216), v18) )
        {
          ...
          LODWORD(v30) = v18;
          LODWORD(v29) = v10;
          WPP_RECORDER_SF_dD(v12, 2u, 5u, 0x6Cu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v29, v30);
          (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 103LL);
        }
        if ( !v21 && *(_BYTE *)(a2 + 80) > v18 )
        {
          if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
            *v5 = 2;
          LODWORD(v31) = *(unsigned __int8 *)(a2 + 80);
          LODWORD(v30) = v18;
          LODWORD(v29) = v10;
          WPP_RECORDER_SF_DDD(
            v12,
      ...
      else
      {
        ...
        if ( *(_BYTE *)(a2 + 81) >= v19 )
        {
          if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
            *v5 = 2;
          LODWORD(v31) = *(unsigned __int8 *)(a2 + 81);
          LODWORD(v30) = v19;
          LODWORD(v29) = v10;
          WPP_RECORDER_SF_DDD(
            v12,
...
LABEL_58:
  ...
  {
    v11 = 0;
    WPP_RECORDER_SF_(v12, 2u, 5u, 0x71u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  }
  return v11;
}
