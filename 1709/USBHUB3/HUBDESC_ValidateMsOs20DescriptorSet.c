/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C0033F38
 * Callers:
...
LABEL_23:
    *(_DWORD *)a2 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x15Fu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
    return v5;
  }
  if ( v7 < 0xA )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x15Eu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
