/*
 * XREFs of HUBHTX_CompleteGetPortStatusWithPortStatusResult @ 0x1C0005708
 * Callers:
 *     HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer @ 0x1C00075B0 (HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer.c)
 * Callees:
...
__int64 __fastcall HUBHTX_CompleteGetPortStatusWithPortStatusResult(__int64 *a1)
{
  ...
  if ( v3 == 2228240 )
  {
    ...
    {
      WPP_RECORDER_SF_d(a1[314], 2u, 3u, 0x71u, (__int64)&WPP_c9133184bb0b3c65ec7754ef3e1e0957_Traceguids, v4);
    }
  }
  else if ( v3 == 2228243 )
  {
