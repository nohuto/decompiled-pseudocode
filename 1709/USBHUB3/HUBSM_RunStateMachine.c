/*
 * XREFs of HUBSM_RunStateMachine @ 0x1C000A068
 * Callers:
...
KIRQL __fastcall HUBSM_RunStateMachine(__int64 a1, int a2, KIRQL *a3, char a4)
{
  ...
  while ( 1 )
  {
    if ( a2 == 1000 )
    {
      v10 = *(unsigned int *)(a1 + 984);
      for ( i = *(unsigned int *)(a1 + 880); ; i = (unsigned int)(i - 1) )
      {
        v12 = *(_QWORD *)(*(_QWORD *)(a1 + 976) + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4 * i + 852) - v10));
        if ( !(_DWORD)i || (*(_DWORD *)(v12 + 16) & 4) == 0 )
          break;
      }
      v13 = *(_BYTE *)(a1 + 948);
      v14 = 1000;
      LOBYTE(v10) = *(_BYTE *)(a1 + 949);
      v15 = v13;
      ...
      if ( v14 == 1000 )
      {
        ...
        *(_BYTE *)(a1 + 848) = 0;
        v41 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, __int64))(v38 + 1632))(
                v40,
                v39,
                v10,
                v16);
      ...
      else if ( v14 != 4039 )
      {
        if ( v14 == 3006 )
        {
          ...
          {
            if ( (*(_DWORD *)(*(_QWORD *)(v22 + 1328) + 1636LL) & 0x400) != 0 )
            {
              WPP_RECORDER_SF_(
                *(_QWORD *)(v22 + 1432),
                4u,
              ...
              _InterlockedAnd((volatile signed __int32 *)(*(_QWORD *)(v22 + 1328) + 1636LL), 0xFFFFFBFF);
            }
          }
          else
          {
