/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInformationExV2 @ 0x1C0069314
 * Callers:
 ...
 *     HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher @ 0x1C0028D50 (HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher.c)
 *     HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher @ 0x1C0028D94 (HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher.c)
        ...
        if ( (v12 & 4) != 0 )
        {
          ...
          *((_DWORD *)v28 + 1) = 16;
          (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 2200))(
            ...
            a2,
            16LL);
          for ( i = *(_QWORD *)(v9 + 2352); ; i = *(_QWORD *)(v14 + 248) )
          {
            v14 = i - 248;
            if ( v9 + 2352 == v14 + 248 )
              break;
