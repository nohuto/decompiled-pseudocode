/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader @ 0x1C0024C4C
 * Callers:
 *     HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor @ 0x1C001B780 (HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor.c)
 * Callees:
...
LABEL_10:
    WPP_RECORDER_SF_(v3, 2u, 5u, 0x102u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids);
  ...
  if ( v5 != 256 )
  {
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0xFFu, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v5, 256);
  ...
  if ( v6 != 6 )
  {
    LODWORD(v10) = 6;
    LODWORD(v9) = v6;
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x100u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, v10);
  ...
  if ( *(_DWORD *)(a1 + 1732) != 24 )
  {
    ...
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x101u, (__int64)&WPP_5b4d017512d138c94e3b39cc69d57afb_Traceguids, v9, v10);
