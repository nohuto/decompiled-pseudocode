/*
 * XREFs of HUBDSM_WaitingForD0EntryOnHwWake @ 0x1C001D570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_WaitingForD0EntryOnHwWake(__int64 a1)
{
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(WdfFunctions_01015 + 1616))(
         ...
         off_1C005B110);
  WPP_RECORDER_SF_q(*(_QWORD *)(v5 + 64), 4u, 2u, 0x7Du, (__int64)&WPP_0b66e4f802c5396ff2319e1600a602db_Traceguids, v4);
  return 1000LL;
}
