/*
 * XREFs of BaseIsThisAConsoleName @ 0x18010EA80
 * Callers:
...
const _UNICODE_STRING *__fastcall BaseIsThisAConsoleName(unsigned __int16 *a1, int a2)
{
  ...
  if ( *a1 )
  {
    if ( (v4 = (_WORD *)*((_QWORD *)a1 + 1), v5 = (unsigned __int16)v4[(*a1 - 1LL) >> 1], v6 = *v4 - 67, v6 <= 0x20u)
      ...
      || (_WORD)v5 == 110 )
    {
      ...
      *(_QWORD *)&String1.Length = *(_QWORD *)a1;
      ...
      v3 = 0LL;
      if ( RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_1801146C0, 1u) )
        return &stru_1801146C0;
      v13 = &stru_1801146B0;
      if ( !RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_1801146B0, 1u) )
      {
        if ( !RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_1801146A0, 1u) )
