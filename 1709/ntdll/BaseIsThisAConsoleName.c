...
unsigned __int16 *__fastcall BaseIsThisAConsoleName(unsigned __int16 *a1, int a2)
{
  ...
  if ( *a1 )
  {
      ...
      || (_WORD)v5 == 110 )
    {
      ...
      v3 = 0LL;
      if ( RtlEqualUnicodeString((unsigned __int16 *)&v16, word_1801146C0, 1) )
        return word_1801146C0;
      v13 = word_1801146B0;
      if ( !RtlEqualUnicodeString((unsigned __int16 *)&v16, word_1801146B0, 1) )
      {
        if ( !RtlEqualUnicodeString((unsigned __int16 *)&v16, word_1801146A0, 1) )
