/*
 * XREFs of RtlWow64GetCurrentCpuArea @ 0x18006D6E0
 * Callers:
 *     RtlWow64GetCurrentMachine @ 0x18006D6A0 (RtlWow64GetCurrentMachine.c)
 * Callees:
 *     RtlWow64GetCpuAreaInfo @ 0x18006D760 (RtlWow64GetCpuAreaInfo.c)
 */
