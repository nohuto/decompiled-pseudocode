        ...
        __int64 a8)
{
  ...
  if ( (*(_BYTE *)v13 & 1) != 0 )
  {
    ...
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v21 = 2147353476LL;
    LdrpTraceLoadMUIDll(&v37, *(unsigned __int8 *)v21);
  }
  else
  {
    v14 = 2147353476LL;
...
LABEL_34:
  if ( (v16 & 0x300) == 0 )
  {
    ...
    if ( result < 0 )
      return result;
LABEL_93:
    v22 = LdrpResMapFile(DosFileName, &Module, &Size);
    v18 = v22;
    v25 = v22;
    if ( v22 >= 0 )
    {
...
LABEL_37:
      if ( v30 )
      {
        ...
        if ( result < 0 )
          return result;
        v20 = LdrpResSearchResourceHandle(DosFileName, v34, v33, v32, v31);
      }
      else
      {
        v20 = LdrpResSearchResourceMappedFile((_DWORD)Module, Size, v16, (unsigned int)v43, v26, v34, v33, v32, v31);
      }
      v18 = v20;
      v25 = v20;
    }
LABEL_25:
    ...
    if ( (*(_BYTE *)v12 & 1) != 0 )
    {
      ...
      LdrpTraceLoadMUIDll(&v39, *(unsigned __int8 *)v14);
    }
    return v18;
  }
  Module = DosFileName;
