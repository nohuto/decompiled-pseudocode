/*
 * XREFs of RtlpOwnerAcesPresent @ 0x1800575C4
 * Callers:
 *     RtlpNewSecurityObject @ 0x180053F0C (RtlpNewSecurityObject.c)
 *     RtlOwnerAcesPresent @ 0x18008DBB0 (RtlOwnerAcesPresent.c)
 * Callees:
  ...
  *(_WORD *)&v11.Value[4] = 768;
  ...
  while ( 1 )
  {
    if ( (*(_BYTE *)(v5 + 1) & 8) == 0 )
    {
      ...
      {
        v4 = (unsigned __int8 *)(v5 + ((8LL * (*(_DWORD *)(v5 + 8) & 2)) | 0xC) + 16LL * (*(_DWORD *)(v5 + 8) & 1));
      }
      else if ( (_BYTE)v4 == 4 )
      {
      ...
      {
        v4 = (unsigned __int8)v4 < 0xBu || (unsigned __int8)((_BYTE)v4 - 13) <= 1u ? (unsigned __int8 *)(v5 + 8) : 0LL;
      }
      if ( v4
        && *(_WORD *)v4 == v8
