/*
 * XREFs of RtlRegisterWait @ 0x180011CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlRegisterWait(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, unsigned int a6)
{
  ...
  if ( (unsigned __int64)(a2 - 1) > 0xFFFFFFFFFFFFFFFCuLL || !a3 )
    return 3221225485LL;
  *a1 = 0LL;
  v8 = RtlpTpRevertCapture(&v17, a6 & 0x100, a3);
  v15 = v8;
  if ( v8 < 0 )
  {
    v10 = 0LL;
  ...
  else
  {
    ...
    if ( Heap )
    {
      v11 = (__int64 *)(Heap + 48);
      *(_QWORD *)(Heap + 48) = 0LL;
      v8 = RtlpTpInitializeData(Heap, a6, (__int64)v17);
      v15 = v8;
      if ( v8 >= 0 )
      {
        v14 = 1;
        ...
        *(_DWORD *)(v10 + 88) = 0;
        ...
        v8 = TpAllocWait(v11, (__int64)RtlpTpWaitCallback, v10, (__int64)&v18);
        v15 = v8;
        if ( v8 >= 0 )
        {
