/*
 * XREFs of RtlpMUIEnumerateFolder @ 0x1800ED098
 * Callers:
...
bool __fastcall RtlpMUIEnumerateFolder(__int64 a1, _QWORD *a2, unsigned __int64 *a3)
{
  _QWORD *v4; // r13
  bool v5; // r14
  ...
  if ( v8 >= 0x104 )
    goto LABEL_47;
  *a3 = 0LL;
  if ( RtlDosPathNameToRelativeNtPathName_U(a1, (int)&v23, 0, (__int64)&v28) )
  {
    v9 = *((_QWORD *)&v23 + 1);
    if ( (_WORD)v28 )
    {
