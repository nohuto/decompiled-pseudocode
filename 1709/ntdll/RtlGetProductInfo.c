/*
 * XREFs of RtlGetProductInfo @ 0x180083B60
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180083C98 (CompareVersions.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = *(_OWORD *)Type_8;
  v17 = xmmword_18011D7A0;
  if ( (int)CompareVersions(Type_8, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180113860, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180113850, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
