...
char RtlpHeapTrkDumpOutstandingAllocs()
{
  ...
  for ( i = 0LL; ; i += 16LL )
  {
    ...
    if ( _interlockedbittestandset64(*(volatile signed __int32 **)(qword_180160870 + 8 * v2), 0LL) )
      break;
    v3 = 16LL * v0;
    v4 = *(__int64 **)(i + qword_1801607C8);
    if ( v4 != (__int64 *)(v3 + qword_1801607C8) )
    {
      while ( 1 )
      {
        v5 = v4[3];
...
LABEL_12:
      ...
      RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180160870 + 8LL * (v0 & 0xF)));
      return 0;
    }
LABEL_13:
    RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180160870 + 8 * v2));
    if ( ++v0 >= 0x1EEF )
      return 1;
  }
  return 0;
