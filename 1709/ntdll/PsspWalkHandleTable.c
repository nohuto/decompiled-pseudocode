/*
 * XREFs of PsspWalkHandleTable @ 0x18005AA18
 * Callers:
 ...
 *     ZwQueryObject @ 0x1800A02C0 (ZwQueryObject.c)
        ...
        __int64 a6)
{
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      v14 = 0;
      v18 = 0;
      if ( (int)ZwDuplicateObject(result, v12, -1LL, &Handle, 0, 0, 2) < 0 )
        goto LABEL_20;
      v13 = 4;
...
LABEL_21:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v16 = (const wchar_t **)&off_180113CC0;
      ...
      v17 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *))*(&off_180113CC0 + v17 + 1))(Handle, v26, 64LL, &v18) < 0
        || !v18 )
      {
LABEL_15:
        v14 = 0;
