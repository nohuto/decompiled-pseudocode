/*
 * XREFs of wcstoxq @ 0x18009286C
 * Callers:
 *     _wcstoi64 @ 0x180092810 (_wcstoi64.c)
 *     _wcstoui64 @ 0x180092840 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x1800875E0 (_errno.c)
 *     _invalid_parameter @ 0x180090BC0 (_invalid_parameter.c)
 *     _iswctype_l @ 0x1800944EC (_iswctype_l.c)
 *     _wchartodigit @ 0x180098504 (_wchartodigit.c)
 */

unsigned __int64 __fastcall wcstoxq(__int64 a1, wint_t *a2, wint_t **a3, int a4, int a5, int *a6)
{
  int v6; // r14d
