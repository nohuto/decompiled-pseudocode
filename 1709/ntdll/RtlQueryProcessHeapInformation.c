/*
 * XREFs of RtlQueryProcessHeapInformation @ 0x1800D8640
 * Callers:
...
__int64 __fastcall RtlQueryProcessHeapInformation(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 112) = DebugInfo;
  ...
  v6 = RtlpEnumProcessHeaps((__int64 (__fastcall *)(_QWORD, _QWORD))RtlpQueryProcessEnumHeapsRoutine, a1, 2);
  if ( v6 < 0 )
  {
    *(_QWORD *)(a1 + 112) = 0LL;
  }
            ...
            *((_WORD *)v15 + 8) = i | 0x8000;
            ...
            if ( i )
            {
              if ( i >= 0x80 )
                ...
                RtlStringCbPrintfW(v19, 0x30uLL, L"Objects=%4u", 16 * i);
            }
            else
            {
              RtlStringCbPrintfW(v19, 0x30uLL, L"Objects>%4u", 2048LL);
            }
            v15 += 72;
            v17 = Sizea + 16;
            Sizea += 16LL;
