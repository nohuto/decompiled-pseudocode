...
LABEL_14:
      if ( (v4 & 4) != 0 )
      {
        v12 = (ConditionMask & 0x8000000000000000uLL) == 0LL
            ? BYTE2(ConditionMask)
            : RtlpVerGetConditionMask(ConditionMask, 4LL);
        if ( !(unsigned __int8)RtlpVerCompare(v12, VersionInfo->dwBuildNumber, v21[3], (unsigned int)v20, 0) )
          return -1073741735;
      }
      if ( (v4 & 8) != 0 )
      {
        v13 = (ConditionMask & 0x8000000000000000uLL) == 0LL ? 0 : RtlpVerGetConditionMask(ConditionMask, 8LL);
        if ( !(unsigned __int8)RtlpVerCompare(v13, VersionInfo->dwPlatformId, v21[4], (unsigned int)v20, 0) )
          return -1073741735;
      }
      if ( v4 < 0 )
      {
        v11 = (ConditionMask & 0x8000000000000000uLL) == 0LL ? 0 : RtlpVerGetConditionMask(ConditionMask, 128LL);
