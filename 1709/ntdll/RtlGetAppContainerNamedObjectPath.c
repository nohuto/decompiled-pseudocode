/*
 * XREFs of RtlGetAppContainerNamedObjectPath @ 0x18007A0D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  v13 = 0;
  result = NtQueryInformationToken(v4, 29LL, &v13, 4LL, &v18);
  if ( (int)result < 0 )
    return result;
  if ( !v13 )
  {
...
LABEL_11:
  if ( a3 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( v14 )
      {
        result = NtQueryInformationToken(v4, 42LL, &v15, 4LL, &v18);
        if ( (int)result < 0 )
          return result;
        if ( !(_DWORD)v15 )
          return 3221225659LL;
        ...
        if ( (int)result < 0 )
          return result;
        result = NtQueryInformationToken(v4, 1LL, &v17, 88LL, &v18);
        if ( (int)result < 0 )
          return result;
  ...
  if ( !v8 )
    v12 = v9;
  return RtlpGetTokenNamedObjectPath(v4, a2, v12, a4);
}
