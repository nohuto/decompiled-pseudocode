/*
 * XREFs of RtlpHeapGenerateRandomValue32 @ 0x180046DE0
 * Callers:
...
__int64 RtlpHeapGenerateRandomValue32()
{
  ...
  if ( !dword_180160090
    && NtQueryInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, (PROCESSINFOCLASS)36, &dword_180160090, 4u, 0LL) < 0 )
  {
  ...
  else
  {
    ...
    {
      v0 = RtlRunOnceComplete(&RtlpRandomExInit, 0LL);
      if ( v0 >= 0 )
        goto LABEL_4;
      v7 = 1;
    }
    ...
    {
      v0 = RtlRunOnceComplete(&RtlpRandomExInit, 4LL);
      if ( v0 >= 0 )
        goto LABEL_4;
      v7 = 2;
    }
...
LABEL_4:
  ...
  v1 = _InterlockedExchange(&RtlpRandomExConstantVector[RtlpRandomExAuxVarY & 0x7F], dword_180160090);
