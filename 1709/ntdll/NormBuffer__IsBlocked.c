/*
 * XREFs of NormBuffer__IsBlocked @ 0x1800F8E98
 * Callers:
...
bool __fastcall NormBuffer__IsBlocked(_QWORD *a1, unsigned __int8 a2)
{
  ...
  while ( 1 )
  {
    ...
    v5 = (unsigned __int64)*(unsigned __int8 *)(((__int64)CurrentOutputChar >> 7) + v7) << 7;
    LOBYTE(v5) = *(_BYTE *)((CurrentOutputChar & 0x7F) + v8 + v5 - 128) & 0x3F;
