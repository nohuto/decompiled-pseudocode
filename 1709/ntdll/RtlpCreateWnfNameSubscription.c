/*
 * XREFs of RtlpCreateWnfNameSubscription @ 0x18006DE60
 * Callers:
...
__int64 __fastcall RtlpCreateWnfNameSubscription(unsigned __int64 *a1, char *a2, __int64 a3, __int64 a4)
{
  ...
  if ( a3 )
    return 3221225485LL;
  v7 = (volatile signed __int64 *)(qword_1801600A8 + 8);
  RtlAcquireSRWLockShared((volatile signed __int64 *)(qword_1801600A8 + 8), a2, 0LL, a4);
  v8 = (_QWORD *)(v4 + 16);
