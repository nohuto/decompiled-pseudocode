...
__int64 __fastcall RtlpHpStackTraceSerialize(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // esi
  int v7; // ebx
  ...
  {
    v4 = 1;
    RtlAcquireSRWLockShared(&RtlpHpStackTrackingContext, (char *)0x20, a3, a4);
    if ( (dword_180160378 & 1) == 0 || (dword_180160378 & 2) == 0 )
    {
      v7 = -1073741811;
      goto LABEL_15;
    }
    v7 = RtlStackDbContextSerialize(&qword_180160380, *(_QWORD *)(a1 + 16), *(_QWORD *)(a1 + 24));
    if ( v7 < 0 )
      goto LABEL_15;
    v7 = RtlpEnumProcessHeaps(RtlpHpStackTraceHeapSerialize, a1, 0);
    if ( v7 < 0 )
      goto LABEL_15;
