/*
 * XREFs of RtlActivateActivationContextEx @ 0x180017E20
 * Callers:
 *     RtlActivateActivationContext @ 0x180017DD0 (RtlActivateActivationContext.c)
 * Callees:
        ...
        PULONG_PTR Cookie)
{
  ...
  if ( Cookie )
    *Cookie = 0LL;
  v6 = (_ACTIVATION_CONTEXT *)&unk_180113228;
