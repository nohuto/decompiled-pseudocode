/*
 * XREFs of _ResGetFileAttributesEx @ 0x1801101AC
 * Callers:
 ...
 *     NtQueryFullAttributesFile @ 0x1800A2830 (NtQueryFullAttributesFile.c)
 */
...
__int64 __fastcall ResGetFileAttributesEx(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( RtlDosPathNameToRelativeNtPathName_U(a1, (int)&v9, 0, (__int64)&v10) )
  {
    v5 = *((_QWORD *)&v9 + 1);
    if ( (_WORD)v10 )
    {
