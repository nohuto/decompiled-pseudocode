/*
 * XREFs of _winput_s @ 0x18009EED4
 * Callers:
...
LABEL_117:
      ...
      if ( v30 == 123 )
      {
        v56 = ReadStringDelimited_1(v55, &v77, (wint_t *)&v60, &v62, (void **)v75, v15, Stream, Src, &v70);
        v4 = v77;
      }
      else
      {
        v56 = ReadString_1(v55, 0LL, (wint_t *)&v60, &v62, (void **)v75, v15, Stream, Src, &v70);
      }
      LOWORD(v5) = v60;
      if ( v56 )
        goto LABEL_198;
