...
__int64 __fastcall RtlWow64LogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3)
{
  ...
  result = LdrLoadDll(0LL, 0LL, (__int64)&unk_180114248, &v14);
  if ( (int)result >= 0 )
  {
    if ( (int)LdrGetProcedureAddressForCaller(v14, word_180114268, 0, (__int64 *)&v10, 0, retaddr) >= 0
      && (int)LdrGetProcedureAddressForCaller(v14, word_180114258, 0, (__int64 *)v12, 0, retaddr) >= 0
      && (int)LdrGetProcedureAddressForCaller(v14, word_180114278, 0, (__int64 *)&v11, 0, retaddr) >= 0 )
    {
