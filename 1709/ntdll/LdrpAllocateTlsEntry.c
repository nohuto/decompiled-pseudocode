/*
 * XREFs of LdrpAllocateTlsEntry @ 0x18001CAE4
 * Callers:
...
__int64 __fastcall LdrpAllocateTlsEntry(__int64 a1, __int64 a2, int *a3, __int64 a4, __int64 *a5)
{
  ...
  Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (unsigned int)(NtdllBaseTag + 786432), 72LL);
  v9 = Heap;
  if ( !Heap )
    return 3221225495LL;
...
LABEL_6:
  ...
  *(_DWORD *)(v9 + 64) = v11;
  *(_QWORD *)(v9 + 56) = a2;
  v12 = (__int64 *)off_180159618;
  if ( *off_180159618 != (_UNKNOWN *)&LdrpTlsList )
    __fastfail(3u);
  *(_QWORD *)v9 = &LdrpTlsList;
  *(_QWORD *)(v9 + 8) = v12;
  *v12 = v9;
  off_180159618 = (_UNKNOWN **)v9;
  if ( a5 )
    *a5 = v9;
  return 0LL;
}
