/*
 * XREFs of RealSuccessor @ 0x1800700D8
 * Callers:
 *     RtlEnumerateGenericTableWithoutSplayingAvl @ 0x180070080 (RtlEnumerateGenericTableWithoutSplayingAvl.c)
 *     RtlEnumerateGenericTableLikeADirectory @ 0x1800F3A40 (RtlEnumerateGenericTableLikeADirectory.c)
 *     RtlGetElementGenericTableAvl @ 0x1800F3B70 (RtlGetElementGenericTableAvl.c)
 * Callees:
 *     <none>
 */
