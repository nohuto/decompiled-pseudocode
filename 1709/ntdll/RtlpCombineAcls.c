/*
 * XREFs of RtlpCombineAcls @ 0x1800569A0
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  {
    v35 = a5 + 8;
    for ( k = 0; k < *((unsigned __int16 *)a5 + 2); v35 += *((unsigned __int16 *)v35 + 1) )
    {
      v37 = v14;
      if ( *v35 == 20 )
      {
        v58 = -1;
        v59 = v14 + *((unsigned __int16 *)v35 + 1);
        v60 = v14;
        if ( v59 >= v14 )
          v58 = v14 + *((unsigned __int16 *)v35 + 1);
        v14 = v58;
  ...
  {
    v38 = a6 + 8;
    for ( m = 0; m < *((unsigned __int16 *)a6 + 2); v38 += *((unsigned __int16 *)v38 + 1) )
    {
      v40 = v14;
      if ( *v38 == 21 )
      {
        v61 = -1;
        v62 = v14 + *((unsigned __int16 *)v38 + 1);
        v63 = v14;
        if ( v62 >= v14 )
          v61 = v14 + *((unsigned __int16 *)v38 + 1);
        v14 = v61;
  ...
  {
    v41 = a3 + 8;
    for ( n = 0; n < *((unsigned __int16 *)a3 + 2); v41 += *((unsigned __int16 *)v41 + 1) )
    {
      v43 = v14;
      if ( *v41 == 18 )
      {
        v64 = -1;
        v65 = v14 + *((unsigned __int16 *)v41 + 1);
        v66 = v14;
        if ( v65 >= v14 )
          v64 = v14 + *((unsigned __int16 *)v41 + 1);
        v14 = v64;
  ...
  {
    v44 = a4 + 8;
    for ( ii = 0; ii < *((unsigned __int16 *)a4 + 2); v44 += *((unsigned __int16 *)v44 + 1) )
    {
      v46 = v14;
      if ( *v44 == 19 )
      {
        v67 = -1;
        v68 = v14 + *((unsigned __int16 *)v44 + 1);
        v69 = v14;
        if ( v68 >= v14 )
          v67 = v14 + *((unsigned __int16 *)v44 + 1);
        v14 = v67;
  ...
  {
    v23 = v22 & 0xFFFFFFFC;
    Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1310720, v23);
    v11 = Heap;
    if ( !Heap )
    {
      v20 = -1073741801;
    ...
    if ( Acl >= 0 )
    {
      if ( RtlFirstFreeAce(v11, &v70) )
      {
        if ( a1 && (v47 = (unsigned __int16 *)(a1 + 8), v48 = 0, *((_WORD *)a1 + 2)) )
        {
          ...
          {
            v49 = *(_BYTE *)v47;
            if ( *(_BYTE *)v47 >= 2u && (v49 <= 3u || v49 > 6u && (v49 <= 8u || (unsigned __int8)(v49 - 13) <= 3u)) )
            {
              memmove(v25, v47, v47[1]);
              ++*(_WORD *)(v11 + 4);
              v25 += v47[1];
            }
            ++v48;
