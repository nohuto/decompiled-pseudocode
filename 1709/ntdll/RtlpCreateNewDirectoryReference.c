/*
 * XREFs of RtlpCreateNewDirectoryReference @ 0x18007AA7C
 * Callers:
...
__int64 __fastcall RtlpCreateNewDirectoryReference(const void **a1, unsigned int a2, unsigned __int64 *a3)
{
  __int64 v4; // rsi
  __int64 result; // rax
  int v7; // r15d
