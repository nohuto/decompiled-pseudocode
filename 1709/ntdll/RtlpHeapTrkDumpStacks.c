...
char RtlpHeapTrkDumpStacks()
{
  ...
  if ( !TrkContext )
    return 0;
  v1 = 0LL;
  for ( *(_DWORD *)(TrkContext + 64) = dword_1801607D0;
        (unsigned int)v1 < dword_180160880;
        *(_QWORD *)(TrkContext + 80) += *(_QWORD *)(v2 + 24) )
  {
    *(_QWORD *)(TrkContext + 72) += *(_QWORD *)(*(_QWORD *)(qword_1801604E8 + 8 * v1) + 16LL);
  ...
  while ( 2 )
  {
    ...
    while ( v6 != (__int64 *)(qword_1801607D8 + 16LL * v3) )
    {
      ...
      *((_DWORD *)v6 + 5) = v0;
      ...
      {
        RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180160888 + 8 * v5));
        return 0;
      }
      v6 = (__int64 *)*v6;
    }
