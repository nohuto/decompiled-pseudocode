/*
 * XREFs of RtlInitializeHistoryTable @ 0x18007C980
 * Callers:
 *     LdrpInitializeProcess @ 0x1800D404C (LdrpInitializeProcess.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x180027C80 (RtlLookupFunctionEntry.c)
 *     LdrProtectMrdata @ 0x1800387F8 (LdrProtectMrdata.c)
 *     RtlpFunctionAddressTableEntry @ 0x18007CA50 (RtlpFunctionAddressTableEntry.c)
 */
...
void RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v5 + 6] = v4;
    v9 = qword_18016F3E8;
    if ( v7 < qword_18016F3E8 )
      v9 = v7;
    qword_18016F3E8 = v9;
    v10 = qword_18016F3F0;
    if ( v8 > qword_18016F3F0 )
      v10 = v8;
    qword_18016F3F0 = v10;
  }
