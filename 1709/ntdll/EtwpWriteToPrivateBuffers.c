        ...
        __int64 a10)
{
  ...
  __int64 v77; // [rsp+860h] [rbp+50h]
  unsigned __int16 *v78; // [rsp+868h] [rbp+58h]
  unsigned __int64 v79; // [rsp+870h] [rbp+60h] BYREF
  __int64 v80; // [rsp+880h] [rbp+70h]
  void *Src; // [rsp+890h] [rbp+80h]
  void *v82; // [rsp+898h] [rbp+88h]
  _BYTE *v83; // [rsp+8A0h] [rbp+90h]
  char v84[16]; // [rsp+8C0h] [rbp+B0h] BYREF
  char v85[80]; // [rsp+8D0h] [rbp+C0h] BYREF
  ...
  *(_DWORD *)(a10 + 128) = 0;
  ...
  if ( (a1[120] & 4) != 0 )
  {
    if ( (unsigned __int8)EtwpCheckForEnoughStackSpace(a1, 4LL, a2) )
    {
      v54 = alloca(2064LL);
      v75 = &v60;
      EtwpGetStackExtendedHeaderItem(&v75, v65);
    }
    v11 = a2;
  }
  v14 = 0;
...
LABEL_13:
    ...
    {
      v76 = *(_QWORD *)(EtwpLoggerArray + 8 * v20);
      v13 = 0;
      v72 = 0;
      goto LABEL_15;
    }
...
LABEL_79:
  ...
  v13 = EtwpDemuxUmTraceHandle((unsigned int)v19, &v74);
  v72 = v13;
  if ( !v13 )
  {
    v14 = v70;
...
LABEL_57:
  ...
  v21 = a7 != 0LL ? 104 : 80;
  if ( (*(v16 - 5) & 1) != 0 && (int)NtQueryInformationToken(-6LL, 1LL, v84, 88LL, &Size) >= 0 )
  {
    v55 = Size - 16;
    LODWORD(Size) = v55;
  ...
  v22 = v80 + 32LL * *(unsigned int *)(v80 + 128);
  v23 = 0;
  v24 = 0;
  if ( a8 )
  {
    ...
    {
      v26 = v21;
      v27 = v25 ? *(_BYTE *)(16LL * v23 + v77 + 12) : 0;
      if ( v27 )
      {
        if ( v27 == 1 )
        {
          v24 += *(_WORD *)(16LL * v23 + v77 + 8);
          v61 = v24;
          ++HIDWORD(Size);
        }
        else if ( v27 == 2 )
        {
          Src = *(void **)(v77 + 16LL * v23);
          v67 = *(_WORD *)(v77 + 16LL * v23 + 8);
          v21 += (v67 + 15) & 0xFFFFFFF8;
        }
      }
      else
      {
        v21 += *(_DWORD *)(16LL * v23 + v77 + 8);
      }
      if ( v21 < v26 )
        break;
      if ( ++v23 >= a8 )
    ...
    *(_GUID *)(v28 + 64) = ActivityId;
    ...
    if ( v62 == 1 )
    {
      ...
      *v56 = v71;
      ...
      v56[3] = Size;
      v56[2] = 0;
      memmove(v56 + 4, v85, (unsigned int)Size);
      *(_WORD *)(v28 + 4) |= 1u;
      v31 += v57;
      v66 = v31;
      if ( v17 )
