/*
 * XREFs of __C_specific_handler @ 0x180091100
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x18009FC7C (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x180026F90 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x180096E80 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x180096EB0 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x180096EB4 (__except_validate_context_record.c)
 */
        ...
        struct _DISPATCHER_CONTEXT *DispatcherContext)
{
  ...
  else
  {
    ...
    {
      if ( v10 >= HandlerData[4 * v11 + 1] && v10 < HandlerData[4 * v11 + 2] && HandlerData[4 * v11 + 4] )
      {
