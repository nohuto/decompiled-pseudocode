...
double __cdecl atan2(double Y, double X)
{
  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x7FF0000000000000LL )
  {
    v12 = LODWORD(X);
LABEL_3:
    handle_error((unsigned int)"atan2", 16, v12, 1, 0, 33, *(__int64 *)&X, *(__int64 *)&Y, 2);
    return Y;
  }
  v13 = 0LL;
...
LABEL_32:
    ...
    else
    {
      ...
      v30 = qword_180119DF0[v29];
      v31 = qword_180119660[v29];
    ...
    if ( v26 )
    {
      v31 = *(double *)&qword_180159AB8 - v31;
      v28 = *(double *)&qword_180159AC0 - v28;
    }
    if ( v10 )
    {
      v31 = *(double *)&qword_180159AA8 - v31;
      v28 = *(double *)&qword_180159AB0 - v28;
    }
    v36 = v31 + v28;
    if ( v11 )
      *(_QWORD *)&v36 ^= _xmm;
