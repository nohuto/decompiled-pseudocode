...
volatile signed __int32 *__fastcall RtlpCreateSerializationGroup(int a1)
{
  ...
  RtlAcquireSRWLockShared((PRTL_SRWLOCK)(qword_1801600A8 + 48));
  for ( i = *(_QWORD **)(qword_1801600A8 + 32); i != (_QWORD *)(qword_1801600A8 + 32); i = (_QWORD *)*i )
  {
    ...
    if ( *((_DWORD *)i - 1) == a1 )
    {
      ...
      RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_1801600A8 + 48));
      return v3;
    }
  }
  RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_1801600A8 + 48));
  ...
  if ( result )
  {
    ...
    v5 = (_RTL_SRWLOCK *)qword_1801600A8;
    *v3 = 2623763;
    *((_QWORD *)v3 + 3) = 0LL;
    *((_DWORD *)v3 + 1) = a1;
    *((_DWORD *)v3 + 8) = 1;
    RtlAcquireSRWLockExclusive(v5 + 6);
    v6 = (_RTL_SRWLOCK *)qword_1801600A8;
    v7 = qword_1801600A8 + 32;
    for ( j = *(_QWORD **)(qword_1801600A8 + 32); j != (_QWORD *)v7; j = (_QWORD *)*j )
    {
      v9 = (volatile signed __int32 *)(j - 1);
      if ( *((_DWORD *)j - 1) == a1 )
      {
        _InterlockedIncrement(v9 + 8);
        RtlReleaseSRWLockExclusive((PRTL_SRWLOCK)(qword_1801600A8 + 48));
        RtlFreeHeap(NtCurrentPeb()->ProcessHeap, 0, (PVOID)v3);
        return v9;
      }
    }
    v10 = *(__int64 ***)(qword_1801600A8 + 40);
    v11 = (__int64 *)(v3 + 2);
    if ( *v10 != (__int64 *)v7 )
      __fastfail(3u);
    *v11 = v7;
