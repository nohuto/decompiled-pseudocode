/*
 * XREFs of RtlWow64GetThreadSelectorEntry @ 0x1800DC390
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      if ( v8 != 40 )
      {
        if ( v8 == 80 )
        {
          ...
          {
            *(_WORD *)(a2 + 4) = 4095;
            *(_WORD *)(a2 + 6) = v11 + 0x2000;
            *(_BYTE *)(a2 + 11) = (unsigned int)(v11 + 0x2000) >> 24;
            *(_BYTE *)(a2 + 8) = (unsigned int)(v11 + 0x2000) >> 16;
            *(_DWORD *)(a2 + 8) &= 0xFFFFF3FF;
            *(_DWORD *)(a2 + 8) |= 0x1300u;
            v9 = *(_DWORD *)(a2 + 8) | 0x6000;
            *(_DWORD *)(a2 + 8) = v9;
            v9 |= 0x8000u;
            *(_DWORD *)(a2 + 8) = v9;
            v9 &= 0xFFF0FFFF;
