...
__int64 __fastcall RtlpMergeSecurityAttributeInformation(__int64 a1, __int64 a2, unsigned __int64 *a3, char a4)
{
  char v5; // di
...
LABEL_75:
    ...
    {
      Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1310720, v11);
      if ( Heap )
      {
        v12 = (_BYTE *)(Heap + 8);
        *(_QWORD *)Heap = 0LL;
