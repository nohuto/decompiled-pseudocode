/*
 * XREFs of RtlUnicodeStringCbCatStringN @ 0x18006E308
 * Callers:
 *     RtlGetFullPathName_Ustr @ 0x180033160 (RtlGetFullPathName_Ustr.c)
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x18006E41C (RtlWideCharArrayCopyStringWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x18006E61C (RtlUnicodeStringValidateDestWorker.c)
 */
