/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x180086318
 * Callers:
 *     LdrRelocateImageWithBias @ 0x180086228 (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800E2720 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800E2750 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1800E2758 (LdrpArmProcessRelocation.c)
