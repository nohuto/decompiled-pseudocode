/*
 * XREFs of _output_l @ 0x180097180
 * Callers:
 ...
 *     write_multi_char @ 0x180097A20 (write_multi_char.c)
...
LABEL_120:
                      ...
                      {
                        LOBYTE(v19) = 32;
                        write_multi_char(v19, v38, v57, &v51);
                      }
                      write_string(v53, v37, v57, &v51);
                      v40 = v57;
                      if ( (v7 & 0xC) == 8 )
                      {
                        LOBYTE(v39) = 48;
                        write_multi_char(v39, v38, v57, &v51);
                      }
                      v41 = SizeConverted;
                      if ( v55 && SizeConverted > 0 )
                      {
                        ...
                        while ( 1 )
                        {
                          ...
                          if ( wctomb_s(&v61, v65, 6uLL, v43) || !v61 )
                            break;
                          write_string(v65, (unsigned int)v61, v57, &v51);
                          if ( !v41 )
                            goto LABEL_134;
                        }
                        v13 = -1;
                      ...
                      {
                        write_string(v15, (unsigned int)SizeConverted, v40, &v51);
LABEL_134:
                        v13 = v51;
                      }
                      if ( v13 >= 0 && (v7 & 4) != 0 )
                      {
                        LOBYTE(v44) = 32;
                        write_multi_char(v44, v38, v57, &v51);
                        v13 = v51;
                      }
                      a2 = v60;
                      v8 = v54;
