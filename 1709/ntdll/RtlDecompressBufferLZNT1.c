/*
 * XREFs of RtlDecompressBufferLZNT1 @ 0x18008D030
 * Callers:
 *     <none>
 * Callees:
 *     LZNT1DecompressChunk @ 0x1800A4F90 (LZNT1DecompressChunk.c)
...
LABEL_13:
    ...
    if ( !a5 )
    {
      v8 = LZNT1DecompressChunk((_DWORD)v9, (_DWORD)v7, v14, v13, (__int64)&v23);
      if ( v8 < 0 )
        goto LABEL_26;
LABEL_5:
      v15 = v23;
