/*
 * XREFs of RtlFindNextForwardRunClearCapped @ 0x180003080
 * Callers:
 *     RtlFindNextForwardRunClear @ 0x180003070 (RtlFindNextForwardRunClear.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall RtlFindNextForwardRunClearCapped(__int64 a1, unsigned int a2, __int64 a3, unsigned int *a4)
{
  ...
  if ( *(_DWORD *)a1 > a2 )
  {
    ...
    if ( v9 != v10 && (*v9 | dword_18011CB70[i & 0x1F]) == -1 )
    {
      ++v9;
    ...
    v11 = 0;
    if ( v9 != v10 && (~dword_18011CB70[i & 0x1F] & *v9) == 0 )
    {
      v11 = 32 - (i & 0x1F);
      if ( v11 == -1 )
      {
