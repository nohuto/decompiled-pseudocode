/*
 * XREFs of LdrpHandleInvalidUserCallTarget @ 0x180090EF0
 * Callers:
 ...
 *     LdrpDispatchUserCallTarget @ 0x180091050 (LdrpDispatchUserCallTarget.c)
 *     LdrpDispatchUserCallTargetES @ 0x1800910A0 (LdrpDispatchUserCallTargetES.c)
 * Callees:
