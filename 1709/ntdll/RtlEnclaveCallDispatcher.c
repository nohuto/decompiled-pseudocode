/*
 * XREFs of RtlEnclaveCallDispatcher @ 0x1800A3EC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall RtlEnclaveCallDispatcher(void *a1, __int64 a2, __int64 a3, PVOID a4)
{
  ULONG i; // eax
  NTSTATUS result; // eax
  ...
  {
    v8 = a4;
    for ( i = ((__int64 (__fastcall *)(__int64, __int64))LdrpIssueEnclaveCall)(a2, a3); ; i = -1073741811 )
    {
