/*
 * XREFs of RtlpHpTagContextGetTag @ 0x180102960
 * Callers:
...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  *(_QWORD *)&v16 = SubProcessTag;
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_1801603D8;
  if ( !v4 )
    return 0LL;
  if ( word_18015D924 )
  {
    v6 = *(_QWORD *)(qword_18015D918 + 8LL * (unsigned __int16)word_18015D924 - 8);
