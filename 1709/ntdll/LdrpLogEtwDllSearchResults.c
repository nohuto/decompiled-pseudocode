  ...
  *(_QWORD *)&v19.Length = 0LL;
  ...
  if ( Heap )
  {
    ...
    *(_DWORD *)(Heap + 44) = *(_DWORD *)(a2 + 36);
    LdrpEventAddUnicodeString(a2, (_WORD *)(Heap + 48), 0x214u, &v21);
    ...
    if ( (a1 & 0x100) != 0 && (int)LdrpMakeUnicodeStringFromPathElement(*(_QWORD *)(a2 + 16), 4LL, &UnicodeString) >= 0 )
    {
      ...
      if ( v10 )
      {
        ...
        *(_DWORD *)(v10 + 32) = a1;
        *(_WORD *)(v10 + 6) = 5333;
        LdrpEventAddUnicodeString((__int64)&UnicodeString, (_WORD *)(v10 + 36), 0xC78u, &v21);
        v13 = 3192 - v21;
        v14 = (_WORD *)(v12 + 2 * ((unsigned __int64)v21 >> 1));
        LdrpEventAddUnicodeString((__int64)&v18, v14, 3192 - v21, &v21);
        v15 = v13 - v21;
        v16 = &v14[(unsigned __int64)v21 >> 1];
        LdrpEventAddUnicodeString((__int64)&v20, v16, v15, &v21);
        LdrpEventAddUnicodeString((__int64)&v19, &v16[(unsigned __int64)v21 >> 1], v15 - v21, &v21);
        RtlGetCurrentServiceSessionId();
        NtTraceEvent();
