...
__int64 __fastcall RtlpWnfProcessCurrentDescriptor(_WNF_STATE_NAME *BaseAddress, int a2)
{
  ...
  v6 = *(_QWORD **)(qword_1801600A8 + 16);
  if ( v6 == (_QWORD *)(qword_1801600A8 + 16) )
    goto LABEL_4;
  while ( 1 )
  {
    v7 = v6 - 4;
...
LABEL_26:
    ...
    v4 = 128;
LABEL_4:
    RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_1801600A8 + 8));
    goto LABEL_22;
  }
  if ( a2 )
  {
  ...
  if ( v4 )
  {
    ...
    for ( *((_DWORD *)v7 + 32) = 2; v13 != v9; v13 = (__int64 *)*v13 )
    {
      if ( (*((_BYTE *)v13 + 52) & 4) != 0 && *((_DWORD *)v13 + 28) )
      {
        if ( !v15 || v15 > v13[15] )
          v15 = v13[15];
        if ( *((_DWORD *)v13 + 32) < *(_DWORD *)(qword_1801600A8 + 72) )
          v14 = 0;
      }
    }
    v7[17] = v15;
