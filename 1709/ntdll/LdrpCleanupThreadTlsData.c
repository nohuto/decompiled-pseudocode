/*
 * XREFs of LdrpCleanupThreadTlsData @ 0x18007824C
 * Callers:
...
signed __int64 __fastcall LdrpCleanupThreadTlsData(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
