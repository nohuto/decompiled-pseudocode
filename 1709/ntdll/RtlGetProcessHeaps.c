/*
 * XREFs of RtlGetProcessHeaps @ 0x1800906F0
 * Callers:
...
ULONG __cdecl RtlGetProcessHeaps(ULONG NumberOfHeaps, PVOID *ProcessHeaps)
{
  ...
  RtlpEnumProcessHeaps(RtlGetProcessHeapsCallback, (__int64)&v8, 2);
  v4 = (char *)v9 - (char *)ProcessHeaps;
  v5 = v10;
  v6 = v4 >> 3;
  if ( dword_1801593E8 )
    v5 += ((__int64 (__fastcall *)(_QWORD))qword_180159430)(NumberOfHeaps - (unsigned int)v6);
  return v5;
}
