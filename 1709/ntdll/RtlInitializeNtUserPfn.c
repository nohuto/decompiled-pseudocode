/*
 * XREFs of RtlInitializeNtUserPfn @ 0x180090930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlInitializeNtUserPfn(_OWORD *a1, __int64 a2, _OWORD *a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  if ( byte_18016F1C8 || a2 != 184 || a4 != 184 || a6 != 88 )
    return 3221225485LL;
  LdrProtectMrdata(0);
  *(_OWORD *)NtUserPfn = *a1;
  ...
  *(_OWORD *)off_18016F170 = *(_OWORD *)a5;
  *(_OWORD *)off_18016F180 = *(_OWORD *)(a5 + 16);
  *(_OWORD *)off_18016F190 = *(_OWORD *)(a5 + 32);
  *(_OWORD *)off_18016F1A0 = *(_OWORD *)(a5 + 48);
  *(_OWORD *)off_18016F1B0 = *(_OWORD *)(a5 + 64);
  off_18016F1C0 = *(void (__fastcall __noreturn **)())(a5 + 80);
  byte_18016F1C8 = 1;
  LdrProtectMrdata(1);
  if ( CfgBitMap != LdrSystemDllInitBlock.CfgBitMap || v9 != *(_QWORD *)_guard_check_icall_fptr )
    __fastfail(0x13u);
  return 0LL;
}
