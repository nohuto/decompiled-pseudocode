...
__int64 __fastcall RtlpFreeHeap(__int64 a1, int a2, unsigned __int64 a3, __int64 a4)
{
  ...
  char v144; // [rsp+48h] [rbp-1E0h]
  char v145; // [rsp+49h] [rbp-1DFh]
  __int16 updated; // [rsp+4Ch] [rbp-1DCh]
  unsigned __int64 v147; // [rsp+50h] [rbp-1D8h] BYREF
  __int64 v148; // [rsp+58h] [rbp-1D0h]
  __int64 *v149; // [rsp+60h] [rbp-1C8h]
  _QWORD *v150; // [rsp+68h] [rbp-1C0h]
  unsigned __int8 v151; // [rsp+70h] [rbp-1B8h]
  unsigned __int16 v152; // [rsp+72h] [rbp-1B6h]
  unsigned __int16 v153; // [rsp+74h] [rbp-1B4h]
  __int64 *v154; // [rsp+78h] [rbp-1B0h]
  unsigned int v155; // [rsp+80h] [rbp-1A8h]
  unsigned int v156; // [rsp+84h] [rbp-1A4h]
  unsigned int v157; // [rsp+88h] [rbp-1A0h]
  unsigned int v158; // [rsp+90h] [rbp-198h]
  __int64 v159; // [rsp+98h] [rbp-190h]
  unsigned __int64 v160; // [rsp+A0h] [rbp-188h] BYREF
  unsigned __int64 v161; // [rsp+A8h] [rbp-180h]
  __int64 v162; // [rsp+B0h] [rbp-178h]
  unsigned int v163; // [rsp+B8h] [rbp-170h]
  int v166; // [rsp+C8h] [rbp-160h]
  int v167; // [rsp+CCh] [rbp-15Ch]
  int v168; // [rsp+D0h] [rbp-158h]
  int v169; // [rsp+D4h] [rbp-154h]
  __int64 v170; // [rsp+D8h] [rbp-150h]
  unsigned int NtGlobalFlag; // [rsp+E0h] [rbp-148h]
  unsigned __int64 v172; // [rsp+E8h] [rbp-140h]
  unsigned __int64 v173; // [rsp+F0h] [rbp-138h]
  __int64 v174; // [rsp+108h] [rbp-120h]
  unsigned __int64 v175; // [rsp+110h] [rbp-118h]
  unsigned int *v176; // [rsp+118h] [rbp-110h]
  __int64 v177; // [rsp+120h] [rbp-108h]
  unsigned __int64 v178; // [rsp+128h] [rbp-100h]
  __int64 v179; // [rsp+130h] [rbp-F8h]
  __int64 v180; // [rsp+138h] [rbp-F0h]
  int v181; // [rsp+148h] [rbp-E0h]
  int v182; // [rsp+158h] [rbp-D0h]
  int v183; // [rsp+178h] [rbp-B0h]
  int v184; // [rsp+188h] [rbp-A0h]
  int v185; // [rsp+198h] [rbp-90h]
  int v186; // [rsp+1A8h] [rbp-80h]
  int v187; // [rsp+1B8h] [rbp-70h]
  int v188; // [rsp+1C8h] [rbp-60h]
  int v189; // [rsp+1D8h] [rbp-50h]
  unsigned __int64 v190; // [rsp+1E0h] [rbp-48h]
  struct _TEB *v191; // [rsp+1F0h] [rbp-38h]
  unsigned __int64 v192; // [rsp+240h] [rbp+18h]
  ...
  {
    v12 = v192;
    if ( ((*(_BYTE *)(v192 + 10) ^ (unsigned __int8)(*(_BYTE *)(a1 + 138) & (*(_DWORD *)(a1 + 124) >> 17))) & 8) == 0 )
...
LABEL_25:
    ...
    if ( *(_DWORD *)(a1 + 124) )
    {
      *(_DWORD *)(v192 + 8) ^= *(_DWORD *)(a1 + 136);
      if ( *(_BYTE *)(v192 + 11) != (*(_BYTE *)(v192 + 8) ^ (unsigned __int8)(*(_BYTE *)(v192 + 9) ^ *(_BYTE *)(v192 + 10))) )
        RtlpAnalyzeHeapFailure(a1, v192);
    }
    v17 = *(__int64 ***)(a1 + 312);
    do
    {
      if ( *(unsigned __int16 *)(v192 + 8) < (unsigned __int64)*((unsigned int *)v17 + 2) )
        break;
      v17 = (__int64 **)*v17;
    }
    while ( v17 );
...
LABEL_36:
  ...
  if ( *(_BYTE *)(v12 + 15) == 4 )
  {
    ...
    v150 = (_QWORD *)v122;
    v162 = *(_QWORD *)(v122 + 32);
    v160 = v122 & 0xFFFFFFFFFFFF0000uLL;
    *(_QWORD *)(a1 + 560) -= v162;
    v123 = *(_QWORD *)v122;
    v124 = *(__int64 **)(v122 + 8);
    v125 = *v124;
    ...
    if ( !v5 )
    {
      ...
      v124 = (__int64 *)NtGlobalFlag;
      if ( (NtGlobalFlag & 0x800) != 0 )
      {
        v127 = *(_QWORD *)(v122 + 32) >> 4;
        v122 = (unsigned __int64)v150;
        RtlpUpdateTagEntry(a1, *((unsigned __int16 *)v150 + 9), v127, 0, 3);
      }
      else
      {
        v122 = (unsigned __int64)v150;
    ...
    v128 = *(_QWORD *)(v122 + 40);
    v180 = v128;
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v124, v125) )
    {
      v129 = (__int64)NtCurrentPeb()->SharedData + 558;
      LODWORD(v122) = (_DWORD)v150;
      v128 = v180;
    }
    else
    {
    ...
    if ( *(_BYTE *)v129 )
      RtlpHeapLogRangeRelease(a1, v160, v128);
    v147 = 0LL;
    RtlpSecMemFreeVirtualMemory(v129, &v160, &v147, 0x8000LL);
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v131, v130) )
    {
    ...
    if ( *(_BYTE *)v133 )
    {
      ...
      {
        if ( (unsigned int)RtlGetCurrentServiceSessionId(v133, v132) )
          v11 = (__int64)NtCurrentPeb()->SharedData + 550;
        LODWORD(v122) = (_DWORD)v150;
        RtlpLogHeapContractEvent(a1, (_DWORD)v150, v162, 16 * *(_QWORD *)(a1 + 192), 0, 0LL, *(unsigned __int8 *)v11);
      }
      else
      {
        LODWORD(v122) = (_DWORD)v150;
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId(v133, v132) )
    {
      v136 = (__int64)NtCurrentPeb()->SharedData + 560;
      LODWORD(v122) = (_DWORD)v150;
    }
    else
    {
    ...
    if ( *(_BYTE *)v136 )
    {
      if ( (unsigned int)RtlGetCurrentServiceSessionId(v136, v134) )
      {
        v135 = (__int64)NtCurrentPeb()->SharedData + 560;
        LODWORD(v122) = (_DWORD)v150;
      }
      RtlpLogHeapContractEvent(a1, v122, v162, 16 * *(_QWORD *)(a1 + 192), 0, 0LL, *(unsigned __int8 *)v135);
    }
    goto LABEL_317;
  }
  ...
  if ( !v5 )
  {
    v163 = NtCurrentPeb()->NtGlobalFlag;
    v12 = v192;
    if ( (v163 & 0x800) != 0 )
    {
      v23 = (*v18 & 2) == 0;
      ...
      {
        v25 = *(unsigned __int16 *)(v192 + 16LL * *v20 - 14);
      }
...
LABEL_85:
    ...
    *v154 = v148;
    *(_QWORD *)(v45 + 8) = v46;
    if ( (*(_BYTE *)(v28 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v28) )
    {
      v47 = *(_BYTE *)(v28 + 10);
      if ( (v47 & 4) != 0 )
      {
        ...
        v49 = RtlCompareMemoryUlong(v28 + 32, v48, 4277075694LL);
        if ( v49 != v48 )
        {
          if ( NtCurrentPeb()->Ldr )
      ...
      *(_BYTE *)(v28 + 15) = 0;
      v12 = v28;
      v173 = v28;
      v147 += *(unsigned __int16 *)(v28 + 8);
      *(_WORD *)(v28 + 8) = v147;
      *(_WORD *)(v28 + 16 * v147 + 12) = v147 ^ *(_WORD *)(a1 + 140);
    }
    else
    {
...
LABEL_100:
  ...
  if ( !*(_DWORD *)(a1 + 124) )
    goto LABEL_104;
  v188 = *(_DWORD *)(v50 + 8) ^ *(_DWORD *)(a1 + 136);
  if ( HIBYTE(v188) != ((unsigned __int8)v188 ^ (unsigned __int8)(BYTE1(v188) ^ BYTE2(v188))) )
...
LABEL_116:
        ...
        if ( v64 == v51 )
        {
          ...
          else
          {
            ...
            if ( *(_DWORD *)(a1 + 124) )
            {
              v183 = v67 ^ *(_DWORD *)(a1 + 136);
              if ( HIBYTE(v183) != ((unsigned __int8)v183 ^ (unsigned __int8)(BYTE1(v183) ^ BYTE2(v183))) )
              {
                RtlpLogHeapFailure(3, a1, v66 - 16, 0, 0LL, 0LL);
                v52 = v154;
              }
            }
            if ( v59 - (unsigned __int16)v183 )
            {
LABEL_131:
      ...
      *v149 = (__int64)v52;
      v52[1] = (__int64)v68;
      if ( (*(_BYTE *)(v50 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v50) )
      {
        v69 = *(_BYTE *)(v50 + 10);
        if ( (v69 & 4) != 0 )
        {
          ...
          v71 = RtlCompareMemoryUlong(v50 + 32, v70, 4277075694LL);
          if ( v71 != v70 )
          {
            if ( NtCurrentPeb()->Ldr )
              DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
        ...
        *(_BYTE *)(v12 + 10) = 0;
        *(_BYTE *)(v12 + 15) = 0;
        v147 += *(unsigned __int16 *)(v50 + 8);
        *(_WORD *)(v12 + 8) = v147;
        *(_WORD *)(v12 + 16 * v147 + 12) = v147 ^ *(_WORD *)(a1 + 140);
        v26 = v147;
        break;
      }
...
LABEL_318:
  if ( v144 )
  {
    if ( (*(_DWORD *)(a1 + 116) & 0x1000000) == 0 )
    {
      ++*(_DWORD *)(a1 + 608);
      v137 = *(_DWORD *)(a1 + 616);
      if ( *(_DWORD *)(a1 + 608) > v137 )
      {
        *(_DWORD *)(a1 + 608) = 0;
        v138 = *(_QWORD *)(a1 + 544) - 16LL * *(_QWORD *)(a1 + 192);
        if ( v138 > *(_QWORD *)(a1 + 640) )
          *(_QWORD *)(a1 + 640) = v138;
        *(_QWORD *)(a1 + 648) = v138;
      }
      if ( ++*(_DWORD *)(a1 + 620) >= 0x1000u )
      {
        if ( *(_BYTE *)(a1 + 386) != 2 || *(_DWORD *)(a1 + 624) <= 0x10u )
          v72 = 16;
        if ( *(_DWORD *)(a1 + 612) > v72 && v137 < 0x10000 )
          *(_DWORD *)(a1 + 616) = 2 * v137;
        *(_DWORD *)(a1 + 612) = 0;
        *(_DWORD *)(a1 + 620) = 0;
      }
    }
    v139 = *(_QWORD *)(a1 + 352);
    v23 = (*(_DWORD *)(v139 + 12))-- == 1;
    if ( v23 )
    {
      *(_QWORD *)(v139 + 16) = 0LL;
      v140 = _InterlockedCompareExchange((volatile signed __int32 *)(v139 + 8), -1, -2);
      if ( v140 != -2 )
      {
        if ( (*(_BYTE *)(v139 + 8) & 1) != 0 )
          RtlpNotOwnerCriticalSection(v139);
        DeferredCriticalSectionEvent = *(_QWORD *)(v139 + 24);
        if ( !DeferredCriticalSectionEvent )
          DeferredCriticalSectionEvent = RtlpCreateDeferredCriticalSectionEvent(v139);
        do
        {
          v142 = v140 & 2 | 1;
          v143 = _InterlockedCompareExchange((volatile signed __int32 *)(v139 + 8), v142 + v140, v140);
          v23 = v140 == v143;
          v140 = v143;
        }
        while ( !v23 );
        if ( (v142 & 2) != 0 )
          RtlpUnWaitCriticalSectionEx(v139, DeferredCriticalSectionEvent);
      }
    }
  }
  return v156;
