...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(OutHeaders->OptionalHeader.Subsystem - 2) > 1u )
    return 0LL;
  if ( NtOpenKey(&KeyHandle, 3u, (POBJECT_ATTRIBUTES)&stru_180113800) < 0
    || (v4 = NtQueryValueKey(KeyHandle, (PUNICODE_STRING)&stru_180114228, KeyValuePartialInformation, v25, 0x50u, v15),
        NtClose(KeyHandle),
        v4 < 0)
    || v26 != 4
    || v27 != 4
    || !v28 )
  {
    v10 = 0LL;
    v1 = 0;
    if ( NtOpenKey(&v10, 0x20019u, &stru_180159620) >= 0 )
    {
    ...
    if ( NtOpenKey(&Handle, 1u, (POBJECT_ATTRIBUTES)&stru_1801137D0) >= 0 )
    {
      if ( NtQueryValueKey(
             Handle,
        ...
        && v24 > 1 )
      {
        ...
        NtQueryValueKey(
          Handle,
          (PUNICODE_STRING)&stru_180114218,
          KeyValuePartialInformation,
          KeyValueInformation,
          0x50u,
          ResultLength);
    ...
    if ( RtlFormatCurrentUserKeyPath(&CurrentUserKeyPath) >= 0 )
    {
      ...
      {
LABEL_27:
        if ( LdrLoadDll(0LL, 0LL, (PUNICODE_STRING)&stru_180114208, &DllHandle) >= 0 )
        {
          v7 = DllHandle;
          if ( LdrGetProcedureAddressForCaller(
                 DllHandle,
                 (PANSI_STRING)&stru_180114238,
                 0,
                 &ProcedureAddress,
                 0,
                 retaddr) >= 0
