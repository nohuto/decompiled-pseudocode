...
__int64 __fastcall RtlpMuiRegValidateInstalled(__int64 a1)
{
  ...
  if ( InstalledLanguageIndexByLangId == -1073741772 || InstalledLanguageIndexByLangId == -1073741637 )
  {
    ...
    {
      v13 = RtlpMuiRegGetOrAddString(a1, v36, 1, (__int16 *)&v33);
      v14 = -1;
      if ( v13 >= 0 )
        v14 = v33;
      v41 = v14;
      ...
      v42 = 0LL;
      v43 = 0LL;
      RtlpMuiRegAddNeutralLanguage(a1, (__int64)&v39, v36);
...
LABEL_16:
    if ( v3 != -1 )
    {
      ...
      {
        if ( (int)RtlpIsALicensedRegularLanguage((_QWORD *)a1, v38) >= 0 )
        {
          v4 = 1;
        }
        else
