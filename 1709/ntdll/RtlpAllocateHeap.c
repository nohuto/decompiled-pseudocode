        ...
        _DWORD *a6)
{
  ...
  int v204; // [rsp+20h] [rbp-268h]
  int v205; // [rsp+28h] [rbp-260h]
  char v206; // [rsp+30h] [rbp-258h]
  __int64 v207; // [rsp+38h] [rbp-250h] BYREF
  char v208; // [rsp+40h] [rbp-248h]
  unsigned __int64 v209; // [rsp+48h] [rbp-240h]
  int v210; // [rsp+50h] [rbp-238h]
  void *v211; // [rsp+58h] [rbp-230h]
  unsigned __int64 v212; // [rsp+60h] [rbp-228h]
  ...
  unsigned __int64 m; // [rsp+90h] [rbp-1F8h]
  ...
  __int64 v225; // [rsp+C0h] [rbp-1C8h] BYREF
  __int64 v226; // [rsp+C8h] [rbp-1C0h] BYREF
  ...
  char *v235; // [rsp+100h] [rbp-188h]
  __int64 v236; // [rsp+108h] [rbp-180h]
  __int64 v237; // [rsp+110h] [rbp-178h]
  unsigned __int64 v238; // [rsp+118h] [rbp-170h]
  ...
  unsigned __int64 v244; // [rsp+148h] [rbp-140h]
  ...
  unsigned __int64 v267; // [rsp+2A8h] [rbp+20h] BYREF
  ...
  if ( (a2 & 0x7D010F60) != 0 || a3 >= 0x80000000 )
  {
    ...
    *a6 = 4;
    ...
    if ( a3 )
      ...
      v10 = 1LL;
    v203 = *((_QWORD *)Src + 33) & (v10 + *((_QWORD *)Src + 32));
    if ( v203 < 0x20 )
      v203 = 32LL;
    v267 = v203;
...
LABEL_26:
    if ( v12 > *((unsigned int *)Src + 37) )
    {
      if ( (Src[112] & 2) != 0 )
      {
        ...
        if ( (int)ZwAllocateVirtualMemory(-1LL, &v225, 0LL, &v226, 0x2000, HeapProtection) < 0 )
          goto LABEL_487;
        v207 = v134 + v225;
        if ( (int)ZwAllocateVirtualMemory(-1LL, &v207, 0LL, &v267, 4096, HeapProtection) >= 0 )
        {
          *(_WORD *)(v207 + 56) = v267 - a3;
          *(_BYTE *)(v207 + 58) = v6 | 2;
          *(_QWORD *)(v207 + 32) = v267;
          *(_QWORD *)(v207 + 40) = v226;
          *(_BYTE *)(v207 + 63) = 4;
          *((_QWORD *)Src + 70) += v267;
          ...
          if ( *(_BYTE *)v137 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
            RtlpLogHeapCommit(Src, v207, v267, 9LL);
          if ( (unsigned int)RtlGetCurrentServiceSessionId() )
          ...
          if ( *(_BYTE *)v138 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
          {
            ...
            RtlpLogHeapExtendEvent((_DWORD)Src, v207, v267, 16 * *((_QWORD *)Src + 24), *(unsigned __int8 *)v136);
          }
          v139 = 2147353482LL;
          if ( (unsigned int)RtlGetCurrentServiceSessionId() )
          ...
          if ( *(_BYTE *)v140 )
          {
            ...
            RtlpLogHeapExtendEvent((_DWORD)Src, v207, v267, 16 * *((_QWORD *)Src + 24), *(unsigned __int8 *)v139);
          }
          if ( (*((_DWORD *)Src + 28) & 0x8000000) != 0 )
            *(_WORD *)(v207 + 16) = RtlLogStackBackTraceEx(1u);
          ...
          if ( *((_DWORD *)Src + 31) )
          {
            ...
            *(_DWORD *)(v141 + 56) ^= *((_DWORD *)Src + 34);
            v141 = v207;
          }
          v142 = Src + 272;
          v143 = (__int64 *)*((_QWORD *)Src + 35);
          ...
          {
            RtlpLogHeapFailure(12, 0, (_DWORD)v142, 0, *v143, 0LL);
          }
          v211 = (void *)(v207 + 64);
          goto LABEL_487;
        }
    ...
    if ( (v8 & 0x800000) == 0 )
    {
      if ( v11 < *((unsigned __int16 *)Src + 200) )
      {
        ...
        v97 = v11 >> 3;
        v98 = v11 & 7;
        if ( ((unsigned __int8)(1 << (v11 & 7)) & (unsigned __int8)Src[(v11 >> 3) + 402]) != 0 )
          goto LABEL_32;
        v99 = (unsigned __int16 *)(*((_QWORD *)Src + 49) + 2 * v11);
      ...
      else if ( a3 > RtlpLargestLfhBlock || Src[386] == 2 && *((_QWORD *)Src + 47) || Src[387] != 2 )
      {
        goto LABEL_32;
      }
...
LABEL_32:
    if ( a5 )
    {
      ...
      if ( *a5 )
      {
        ...
        if ( *((_DWORD *)Src + 31) )
        {
          *(_DWORD *)(v33 + 8) ^= *((_DWORD *)Src + 34);
          if ( *(_BYTE *)(v33 + 11) != (*(_BYTE *)(v33 + 8) ^ (unsigned __int8)(*(_BYTE *)(v33 + 9) ^ *(_BYTE *)(v33 + 10))) )
            RtlpAnalyzeHeapFailure(Src, v101 - 2);
        }
        v123 = *v101;
        v124 = *(__int64 **)(v33 + 24);
        v125 = *v124;
        ...
        {
          RtlpLogHeapFailure(12, (_DWORD)Src, (_DWORD)v101, v126, v125, 0LL);
          goto LABEL_404;
        }
...
LABEL_242:
          v204 = v130;
          LOBYTE(v130) = 1;
          RtlpHeapRemoveListEntry((_DWORD)Src, (_DWORD)v127, v130, (_DWORD)v101, v204, v128);
        }
        *v124 = v123;
        *(_QWORD *)(v123 + 8) = v124;
        v52 = (char *)(v33 + 10);
        if ( (*(_BYTE *)(v33 + 10) & 8) != 0 && !(unsigned __int8)RtlpCommitBlock(Src, v33) )
        {
          RtlpDeCommitFreeBlock((unsigned __int64)Src, v33, *(unsigned __int16 *)(v33 + 8), 1);
LABEL_404:
...
LABEL_73:
        ...
        if ( !(_DWORD)v209 && (v53 & 4) != 0 )
        {
          ...
          v187 = RtlCompareMemoryUlong(v33 + 32, v186, 4277075694LL);
          if ( v187 != v186 )
          {
            if ( NtCurrentPeb()->Ldr )
        ...
        if ( (*v52 & 1) != 0 )
        {
          RtlpLogHeapFailure(3, (_DWORD)Src, v33, 0, 0LL, 0LL);
          goto LABEL_487;
        }
        *v52 = v212;
              ...
              if ( (*((_DWORD *)Src + 29) & 0x1000000) == 0 )
              {
                ...
                if ( ++*((_DWORD *)Src + 155) >= 0x1000u )
                {
                  if ( Src[386] == 2 && *((_DWORD *)Src + 156) > 0x10u )
                    ...
                    v157 = 16;
                  if ( *((_DWORD *)Src + 153) > v157 && v94 < 0x10000 )
                    *((_DWORD *)Src + 154) = 2 * v94;
                  *((_DWORD *)Src + 153) = 0;
                  *((_DWORD *)Src + 155) = 0;
                }
              }
...
LABEL_470:
          ...
          *(_BYTE *)(v217 + 11) = 0;
          if ( (*(_BYTE *)(v144 + 10) & 2) != 0 )
          {
            ...
            *ExtraStuffPointer = 0LL;
            ...
            if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
              *((_WORD *)v250 + 1) = RtlpUpdateTagEntry((_DWORD)Src, (v265 >> 18) & 0xFFF, 0, *v84, 0);
          }
          else if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
          {
            *(_BYTE *)(v144 + 11) = RtlpUpdateTagEntry((_DWORD)Src, (unsigned __int8)(v265 >> 18), 0, *v84, 0);
          }
          if ( *((_DWORD *)Src + 31) )
          {
        ...
        v59 = *(_BYTE *)(v33 + 14);
        if ( v59 )
          v60 = (char *)((v33 & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v59 << 16) + 0x10000);
        else
          v60 = Src;
        v221 = v55;
        v61 = v33 + 16 * v12;
        ...
        *(_BYTE *)(v61 + 10) = v53;
        *(_BYTE *)(v61 + 15) = 0;
        *(_WORD *)(v61 + 12) = v12 ^ *((_WORD *)Src + 70);
        v62 = (char *)*((_QWORD *)v60 + 5);
        if ( v62 == v60 )
        {
          LOBYTE(v63) = 0;
        }
        ...
        {
          v63 = ((v61 - (unsigned __int64)v60) >> 16) + 1;
          v252 = v63;
          if ( (v61 - (unsigned __int64)v60) >> 16 > 0xFC )
            RtlpLogHeapFailure(3, (_DWORD)v62, v61, (_DWORD)v60, 0LL, 0LL);
        }
        *(_BYTE *)(v61 + 14) = v63;
        *(_BYTE *)(v61 + 11) = 0;
        *(_WORD *)(v61 + 8) = v55;
        ...
        {
          v64 = v61 + 16 * v55;
          if ( ((*(_BYTE *)(v64 + 10) ^ (unsigned __int8)(Src[138] & (*((_DWORD *)Src + 31) >> 20))) & 1) != 0 )
            break;
          if ( *((_DWORD *)Src + 31) )
          {
            *(_DWORD *)(v64 + 8) ^= *((_DWORD *)Src + 34);
            if ( *(_BYTE *)(v64 + 11) != (*(_BYTE *)(v64 + 8) ^ (unsigned __int8)(*(_BYTE *)(v64 + 9) ^ *(_BYTE *)(v64 + 10))) )
              RtlpAnalyzeHeapFailure(Src, v61 + 16 * v55);
          }
          v158 = v64 + 16;
          v159 = *(_QWORD *)(v64 + 16);
          v160 = *(__int64 **)(v64 + 24);
...
LABEL_348:
              v243 = v166;
              LOBYTE(v158) = 1;
              RtlpHeapRemoveListEntry((_DWORD)Src, (_DWORD)v163, v158, v64 + 16, v166, v164);
            }
            *v160 = v159;
            *(_QWORD *)(v159 + 8) = v160;
            if ( (*(_BYTE *)(v64 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(Src, v61 + 16 * v55) )
            {
              if ( v58 )
              {
                v182 = *(_BYTE *)(v64 + 10);
                if ( (v182 & 4) != 0 )
                {
                  ...
                  v191 = RtlCompareMemoryUlong(v64 + 32, v190, 4277075694LL);
                  if ( v191 != v190 )
                  {
                    if ( NtCurrentPeb()->Ldr )
                      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
              ...
              *(_BYTE *)(v61 + 10) = *(_BYTE *)(v64 + 10);
              ...
              if ( v167 > 0xFF00 )
              {
                RtlpInsertFreeBlock((unsigned __int64)Src, v61, v167);
                v54 = (unsigned int)v209;
                goto LABEL_322;
              }
              *(_WORD *)(v61 + 8) = v167;
              *(_WORD *)(16 * v167 + v61 + 12) = v167 ^ *((_WORD *)Src + 70);
              if ( !v58 )
              {
                *(_BYTE *)(v61 + 10) = 0;
                *(_BYTE *)(v61 + 15) = 0;
                v168 = Src + 336;
                if ( *((_QWORD *)Src + 39) )
                  Entry = (_QWORD *)RtlpFindEntry((__int64)Src, (unsigned __int16)v167);
                else
                  Entry = (_QWORD *)*v168;
                while ( v168 != Entry )
                {
                  if ( *((_DWORD *)Src + 31) )
                  {
                    v176 = *((_DWORD *)Entry - 2);
                    v263 = v176;
                    if ( (v176 & *((_DWORD *)Src + 31)) != 0 )
                      v263 = v176 ^ *((_DWORD *)Src + 34);
                    v177 = v263;
                  }
                  else
                  {
                ...
                *((_QWORD *)Src + 24) += *(unsigned __int16 *)(v61 + 8);
                v172 = *((_QWORD *)Src + 39);
                if ( v172 )
                {
...
LABEL_380:
                v178 = Src + 336;
                if ( *((_QWORD *)Src + 39) )
                  v179 = (_QWORD *)RtlpFindEntry((__int64)Src, (unsigned __int16)v167);
                else
                  v179 = (_QWORD *)*v178;
                while ( v178 != v179 )
                {
                  if ( *((_DWORD *)Src + 31) )
                  {
                    v194 = *((_DWORD *)v179 - 2);
                    v264 = v194;
                    if ( (v194 & *((_DWORD *)Src + 31)) != 0 )
                      v264 = v194 ^ *((_DWORD *)Src + 34);
                    v195 = v264;
                  }
                  else
                  {
...
LABEL_390:
                  v247 = v175;
LABEL_365:
                  RtlpHeapAddListEntry((__int64)Src, v172, 1, (__int64)v170, v175, v173);
                }
LABEL_320:
                v54 = (unsigned int)v209;
                if ( *((_DWORD *)Src + 31) )
...
LABEL_451:
            ...
            RtlpDeCommitFreeBlock((unsigned __int64)Src, v61 + 16 * v55, *(unsigned __int16 *)(v64 + 8), 1);
          }
          else
          {
            RtlpLogHeapFailure(12, (_DWORD)Src, v158, v162, v161, 0LL);
          }
          if ( v210 )
          {
...
LABEL_246:
          ...
          while ( v66 != v70 )
          {
            if ( *((_DWORD *)Src + 31) )
            {
              v95 = *((_DWORD *)v70 - 2);
              v261 = v95;
              if ( (v95 & *((_DWORD *)Src + 31)) != 0 )
                v261 = v95 ^ *((_DWORD *)Src + 34);
              v96 = v261;
            }
            else
            {
...
LABEL_305:
          v146 = Src + 336;
          if ( *((_QWORD *)Src + 39) )
            v147 = (_QWORD *)RtlpFindEntry((__int64)Src, (unsigned __int16)v55);
          else
            v147 = (_QWORD *)*v146;
          while ( v146 != v147 )
          {
            if ( *((_DWORD *)Src + 31) )
            {
              v148 = *((_DWORD *)v147 - 2);
              v262 = v148;
              if ( (v148 & *((_DWORD *)Src + 31)) != 0 )
                v262 = v148 ^ *((_DWORD *)Src + 34);
              v149 = v262;
            }
            else
            {
...
LABEL_319:
            RtlpHeapAddListEntry((__int64)Src, v152, 1, (__int64)v150, v155, v153);
          }
          goto LABEL_320;
        }
        v188 = (_DWORD *)(v61 + 32);
        ...
        else
        {
          ...
          if ( v230 > 0 )
          {
            if ( !*k && (_DWORD)m == *((_DWORD *)k + 2) - 1 )
            {
              ...
              for ( n = *(char **)(k[6] + 8 * v26); v27 != n; n = *(char **)n )
              {
                v108 = *((_DWORD *)n - 2);
                v255 = v108;
                if ( *((_DWORD *)Src + 31) )
                {
                  v255 = v108 ^ *((_DWORD *)Src + 34);
...
LABEL_221:
    ...
    if ( v235 != v19 )
    {
      ...
      if ( *((_DWORD *)Src + 31) )
      {
        *(_DWORD *)(v33 + 8) ^= *((_DWORD *)Src + 34);
        if ( *(_BYTE *)(v33 + 11) != (*(_BYTE *)(v33 + 8) ^ (unsigned __int8)(*(_BYTE *)(v33 + 9) ^ *(_BYTE *)(v33 + 10))) )
          RtlpAnalyzeHeapFailure(Src, v19 - 16);
      }
      ...
      if ( v34 >= v12 )
      {
        ...
        v38 = *v37;
        v39 = *(_QWORD *)(v36 + 8);
        if ( *v37 != v39 || (char *)v38 != v19 )
        {
          RtlpLogHeapFailure(12, (_DWORD)Src, (_DWORD)v19, v39, v38, 0LL);
          goto LABEL_487;
        }
        *((_QWORD *)Src + 24) -= v34;
...
LABEL_60:
        ...
        else
        {
          ...
          if ( *(_QWORD *)v35 != v40[4] )
          {
            ...
            if ( *((_DWORD *)Src + 31) )
            {
              v256 = v102 ^ *((_DWORD *)Src + 34);
              if ( HIBYTE(v256) != ((unsigned __int8)v256 ^ (unsigned __int8)(BYTE1(v256) ^ BYTE2(v256))) )
              {
                RtlpLogHeapFailure(3, (_DWORD)Src, (_DWORD)v51 - 16, 0, 0LL, 0LL);
                v36 = v221;
                v37 = v222;
              }
            }
...
LABEL_72:
    ...
    v110 = (_QWORD *)RtlpExtendHeap(Src, v267);
    v33 = (__int64)v110;
    v216 = (char *)v110;
    if ( v110 )
    {
      ...
      {
        RtlpLogHeapFailure(12, (_DWORD)Src, (_DWORD)v111, v115, v114, 0LL);
        goto LABEL_487;
      }
      *((_QWORD *)Src + 24) -= *(unsigned __int16 *)(v33 + 8);
      v116 = (__int64 **)*((_QWORD *)Src + 39);
      if ( v116 )
      {
...
LABEL_216:
        ...
        v120 = (int)v111;
        LOBYTE(v111) = 1;
        RtlpHeapRemoveListEntry((_DWORD)Src, (_DWORD)v116, (_DWORD)v111, v120, v119, v205);
      }
      *v113 = v112;
      *(_QWORD *)(v112 + 8) = v113;
      goto LABEL_72;
...
LABEL_487:
  ...
  {
    if ( v207 )
      RtlpHeapLogRangeReserve(Src, v207 & 0xFFFFFFFFFFFF0000uLL, *(_QWORD *)(v207 + 40));
  }
  return (__int64)v201;
}
