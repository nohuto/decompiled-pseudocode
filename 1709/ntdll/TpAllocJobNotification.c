...
__int64 __fastcall TpAllocJobNotification(_PEB_LDR_DATA *Ldr, void *a2, __int64 a3, int a4, __int64 a5)
{
  int v5; // ebp
  ...
  *(_QWORD *)&v9->Length = 0LL;
  ...
  v11[31] = retaddr;
  v12 = TppCleanupGroupMemberInitialize((int)v11 + 72, a4, a5, v5, (__int64)TppJobpCleanupGroupMemberVFuncs);
  if ( v12 < 0 )
  {
LABEL_21:
  ...
  if ( v13 )
  {
    TppGetCurrentThreadNumaNode(v13, v11 + 8, (char *)v11 + 68);
  }
  else
  {
    *v15 = 0;
