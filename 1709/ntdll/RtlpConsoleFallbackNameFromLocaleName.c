/*
 * XREFs of RtlpConsoleFallbackNameFromLocaleName @ 0x1800502E0
 * Callers:
        ...
        unsigned __int16 a6)
{
  ...
  *a3 = 0;
  if ( !v10 || (unsigned __int8)RtlpLoadNlsData() )
  {
    ...
    {
      _mm_lfence();
      v12 = *(unsigned __int16 *)(pTblPtrs + 56)
      ...
      if ( NameIndex >= 0 )
      {
        _mm_lfence();
        v15 = 149;
        v16 = *(unsigned __int16 *)(pTblPtrs + 56)
            * *(unsigned __int16 *)(*(_QWORD *)(pTblPtrs + 32) + 8LL * NameIndex + 2);
        v17 = *(_QWORD *)(pTblPtrs + 16);
        v18 = *(unsigned __int16 *)(v16 + v17 + 112);
        v19 = *(unsigned __int16 *)(v16 + v17 + 110);
...
LABEL_12:
        ...
        v22 = (const wchar_t *)(*(_QWORD *)(pTblPtrs + 40) + 2LL + 2LL * *(unsigned int *)(v16 + v17 + 276));
...
LABEL_45:
        ...
        if ( wcsicmp(v22, String2) )
        {
          ...
          if ( v24 < 0 )
            goto LABEL_41;
          _mm_lfence();
          v25 = *(unsigned __int16 *)(pTblPtrs + 56) * *(unsigned __int16 *)(*(_QWORD *)(pTblPtrs + 32) + 8LL * v24 + 2);
