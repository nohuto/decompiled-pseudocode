/*
 * XREFs of _RtlpMuiRegValidateLIPLanguage @ 0x1800FEFCC
 * Callers:
 *     _RtlpMuiRegValidateInstalled @ 0x1800FEC08 (_RtlpMuiRegValidateInstalled.c)
 * Callees:
 *     RtlpMuiRegGetInstalledLangInfoIndex @ 0x18007EA2C (RtlpMuiRegGetInstalledLangInfoIndex.c)
 */
  ...
  while ( 1 )
  {
    ...
    if ( v8 != 2 )
    {
      ...
      if ( (int)RtlpMuiRegGetInstalledLangInfoIndex(v14, v8, v9, &v20) < 0
        ...
        || v20 == a2
        || (v16 = *(_WORD *)(28LL * v20 + *(_QWORD *)(v14 + 16)), (v16 & 4) != 0) )
      {
        v3 = a1;
        v17 = v7;
LABEL_25:
