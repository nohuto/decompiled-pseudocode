/*
 * XREFs of RtlpQueryExtendedInformationHeap @ 0x180012E80
 * Callers:
 ...
 *     RtlpHpHeapReportCounters @ 0x180013600 (RtlpHpHeapReportCounters.c)
...
__int64 __fastcall RtlpQueryExtendedInformationHeap(__int64 a1, __int64 a2)
{
  ...
  if ( v6 != 0x80000000 )
  {
    ...
    {
      LOBYTE(v18) = v20;
      result = RtlpWalkHeapInternal(a1, v46, v18);
      ...
      if ( (v46[2] & 0x40000000LL) != 0 )
      {
        ...
        {
          v49[2] = v46[0];
          Metadata = RtlpHpLargeAllocGetMetadata(v47);
          v49[3] = (*(_QWORD *)(Metadata + 32) & 0xFFFFFFFFFFFFF000uLL) + 4096;
          v49[4] = *(_QWORD *)(Metadata + 32) & 0xFFFFFFFFFFFFF000uLL;
        }
        else
        {
          v29 = v46[0] - 16LL;
        ...
        {
          v49[2] = v46[0];
          v30 = *(_QWORD *)(Metadata + 32) & 0xFFFFFFFFFFFFF000uLL;
          LODWORD(v49[4]) = 1;
          v49[3] = v30;
        ...
        else
        {
          ...
          v49[3] = *(_QWORD *)(v27 + 32);
          LODWORD(v49[4]) = 1;
          HIDWORD(v49[4]) = RtlpGetHeapProtection(a1, 0LL);
        }
        result = v43(v49, v42);
        if ( (int)result < 0 )
          return result;
...
LABEL_85:
    ...
    else if ( (v46[2] & 0x80000000LL) != 0 )
    {
      ...
      v44 = v46[0];
      v45 = v21;
      HeapProtection = RtlpGetHeapProtection(a1, 0LL);
      v40 = HeapProtection;
    }
    else
    {
      RtlpGetContainingRange(v23, v23, (unsigned int)&v44, (unsigned int)&v45, (__int64)v50, (__int64)&v40);
      v19 = v44;
      v21 = v45;
      HeapProtection = v40;
    }
