/*
 * XREFs of RtlWow64IsWowGuestMachineSupported @ 0x1800820E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlWow64IsWowGuestMachineSupported(unsigned __int16 a1, char *a2)
{
  ...
  v2 = 0;
  v16 = 0LL;
  v5 = NtQuerySystemInformationEx(181LL, &v16, 8LL, 0LL, 0, v15);
  v6 = v5;
  if ( v5 == -1073741789 )
  {
    v7 = v15[0] + 15LL;
    ...
    v9 = alloca(v8);
    v10 = alloca(v8);
    v6 = NtQuerySystemInformationEx(181LL, &v16, 8LL, v15, v15[0], v15);
    if ( v6 >= 0 )
    {
      v11 = v15[0];
      LODWORD(v12) = 0;
