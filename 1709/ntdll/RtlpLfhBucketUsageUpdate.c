/*
 * XREFs of RtlpLfhBucketUsageUpdate @ 0x18004C518
 * Callers:
...
signed __int64 __fastcall RtlpLfhBucketUsageUpdate(__int64 a1, unsigned int a2, int a3)
{
  ...
  do
  {
    ...
    if ( WORD1(v4) > 1u )
    {
      WORD1(v7) = WORD1(*(_QWORD *)(a1 + 8 * v3 + 208)) - 1;
LABEL_6:
      v5 = v7;
    }
  }
  while ( v4 != _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 8 * v3 + 208), v5, v4) );
  return v5;
}
