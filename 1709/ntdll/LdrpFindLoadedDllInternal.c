...
__int64 __fastcall LdrpFindLoadedDllInternal(unsigned __int16 *a1, int a2, _QWORD *a3, _DWORD *a4, int a5)
{
  ...
  *a3 = 0LL;
  ...
  else
  {
    ...
    v10[1] = 0LL;
    if ( (a5 & 0x200) != 0 )
      v9 = LdrpResolveDllName((_DWORD)a1, (unsigned int)&v12, (unsigned int)v11, (unsigned int)v10, a5);
    else
      v9 = LdrpSearchPath((_DWORD)a1, a2, 0, 0, (__int64)&v12, (__int64)v11, (__int64)v10, 0LL, 0LL);
    LoadedDllByName = v9;
    if ( v9 >= 0 )
    {
      LoadedDllByName = LdrpFindLoadedDllByName(v11, (unsigned __int16 *)v10, a5, (__int64)a3, a4);
