/*
 * XREFs of RtlpInsertInvertedFunctionTableEntry @ 0x18002274C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( LdrpInvertedFunctionTable[0] == dword_18016F4C4 )
  {
    byte_18016F4CC = 1;
  }
  else
  {
    _InterlockedIncrement(&dword_18016F4C8);
    v9 = 1;
    if ( LdrpInvertedFunctionTable[0] != 1 )
    {
      if ( LdrpInvertedFunctionTable[0] > 1u )
      {
        v10 = (unsigned __int64 *)&unk_18016F4F0;
        do
        {
          if ( a2 < *v10 )
            break;
