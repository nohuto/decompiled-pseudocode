/*
 * XREFs of RtlpInitializeStackTraceDatabase @ 0x1800FA4C8
 * Callers:
...
__int64 __fastcall RtlpInitializeStackTraceDatabase(void *a1, ULONG_PTR a2, ULONG_PTR a3)
{
  ...
  if ( v4 >= 0 && LdrInitState == 3 )
  {
    ...
    v6[1] = 0x8000000;
    v6[2] = 0x8000000;
    RtlpEnumProcessHeaps((__int64 (__fastcall *)(_QWORD, _QWORD))RtlpStackTraceDatabaseHeapEnum, (__int64)v6, 0);
  }
