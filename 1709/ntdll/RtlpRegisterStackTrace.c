/*
 * XREFs of RtlpRegisterStackTrace @ 0x1801021EC
 * Callers:
...
LABEL_15:
      if ( (int)RtlAllocateMemoryBlockLookaside(*(_QWORD *)RtlpHeapStackTraceLog, 8 * v5 + 16, &v14) < 0
        && ((int)RtlExtendMemoryZone(*(_QWORD *)(*(_QWORD *)RtlpHeapStackTraceLog + 16LL), 0x10000uLL, v11, v12) < 0
      ...
      *(_QWORD *)v13 = v10;
      ...
      RtlpInterlockedPushEntrySList(*(__int128 **)(v14 - 16), (_QWORD *)(v14 - 48));
    }
