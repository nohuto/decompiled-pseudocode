/*
 * XREFs of RtlpValidateActivationContextData @ 0x180016150
 * Callers:
...
__int64 __fastcall RtlpValidateActivationContextData(__int64 a1, _DWORD *a2)
{
  ...
  if ( !(_DWORD)v2 || (v2 & 3) != 0 )
  {
    DbgPrintEx(51LL, 0LL, "SXS: Warning: Activation context data at %p missing default TOC\n", a2);
    return (unsigned int)-1072365565;
  }
  v4 = (unsigned int)a2[6];
  if ( !(_DWORD)v4 || (v4 & 3) != 0 )
  {
    DbgPrintEx(51LL, 0LL, "SXS: Warning: Activation context data at %p lacks assembly roster\n", a2);
    return (unsigned int)-1072365565;
  }
  v5 = (unsigned int)a2[3];
  if ( (unsigned int)v2 >= (unsigned int)v5 || (v6 = (unsigned int)v2, v2 + 16 > v5) )
  {
    DbgPrintEx(51LL, 0LL, "SXS: Activation context data at %p has invalid TOC header offset\n", a2);
    return (unsigned int)-1072365565;
  }
...
LABEL_22:
    v11 = v7;
    DbgPrintEx(51LL, 0LL, v10, a2, v11);
    return (unsigned int)-1072365565;
  }
  ...
  {
    DbgPrintEx(51LL, 0LL, "SXS: Activation context data at %p has invalid TOC entry array offset\n", a2);
    return (unsigned int)-1072365565;
  }
  if ( (unsigned int)v4 >= (unsigned int)v5 || v4 + 20 > v5 )
  {
    DbgPrintEx(51LL, 0LL, "SXS: Activation context data at %p has invalid assembly roster offset\n", a2);
    return (unsigned int)-1072365565;
  }
