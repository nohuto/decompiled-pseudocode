...
void __fastcall TppCallbackEpilog(unsigned int *a1)
{
  ...
  __int64 v9; // rcx
  void (__fastcall *v10)(__int64, __int64, unsigned __int64, __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD)); // rax
  __int64 v11; // r8
...
LABEL_47:
      ...
      case 4:
        ...
        goto LABEL_12;
      case 5:
        TppBarrierAdjust(*((_QWORD *)a1 + 22) + 32LL, 0xFFFFFFFFLL, 0LL);
        *((_QWORD *)a1 + 22) = 0LL;
        goto LABEL_12;
      case 7:
