/*
 * XREFs of TppWorkCancelPendingCallbacks @ 0x180071EE0
 * Callers:
...
unsigned __int64 __fastcall TppWorkCancelPendingCallbacks(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
