/*
 * XREFs of ScsiSecurityProtocolOutRequest @ 0x1C00099BC
 * Callers:
...
__int64 __fastcall ScsiSecurityProtocolOutRequest(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (v6 & 0xFFF) != 0 )
    v6 = v6 - (v6 & 0xFFF) + 4096;
  v7 = 0LL;
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 1080) + 256LL) & 1) == 0 )
    goto LABEL_7;
  HIBYTE(v13) = a3[6];
  BYTE2(v13) = a3[7];
  BYTE1(v13) = a3[8];
  ...
  if ( *v10 >= v9 )
  {
    *(_BYTE *)(v6 + 4245) = *(_BYTE *)(v6 + 4245) & 0xFD | (v9 != 0 ? 2 : 0) | 1;
