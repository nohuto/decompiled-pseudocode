/*
 * XREFs of ScsiLogSenseRequest @ 0x1C00091F8
 * Callers:
...
__int64 __fastcall ScsiLogSenseRequest(__int64 a1, __int64 a2, size_t a3, __int64 a4)
{
  __int64 v4; // rdi
  ...
  v4 = a2;
  if ( (*(_BYTE *)(a3 + 1) & 1) == 0 && (*(_BYTE *)(a3 + 2) & 0xC0) == 0x40 )
  {
    v5 = *(_BYTE *)(a3 + 2) & 0x3F;
    if ( v5 <= 0x2Fu )
    {
      ...
      if ( _bittest64(&a4, v5) )
      {
        ...
        if ( !*(_BYTE *)(a3 + 3) )
        {
          ...
          {
            if ( v5 == 13 )
              return (unsigned int)LogSenseTemperature(a1, v4, a3, 0x800000002001LL);
            if ( v5 == 47 )
              return (unsigned int)LogSenseInformationalExceptions(a1, v4, a3, 0x800000002001LL);
          }
          else
          {
            if ( *(_BYTE *)(v4 + 2) == 40 )
