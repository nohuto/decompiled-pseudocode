/*
 * XREFs of GetProcessorInformation @ 0x1C00037BC
 * Callers:
...
char __fastcall GetProcessorInformation(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(a1 + 168) = 0;
  ...
  if ( !*v7 )
    goto LABEL_30;
  v12 = (32 * (unsigned int)*(unsigned __int16 *)(a1 + 162)) >> 2;
  if ( v12 )
    memset(*v7, 0, 4LL * v12);
  StorPortExtendedFunction(22LL, a1, a1 + 168, a4);
  StorPortExtendedFunction(20LL, a1, a1 + 164, v13);
        ...
        if ( v19 )
        {
          do
          {
            if ( _bittest64(&v19, (unsigned __int8)v20) )
            {
              ...
              *((_DWORD *)*v7 + 8 * v27) = v27;
              *((_QWORD *)*v7 + 4 * v27 + 1) = *(_QWORD *)(a1 + 176) + 16LL * v23;
