/*
 * XREFs of NVMePowerInitialize @ 0x1C00058CC
 * Callers:
        ...
        if ( !(unsigned int)StorPortExtendedFunction(0LL, a1, 24 * (unsigned int)v4 + 40, 1701672526LL) )
        {
          ...
          if ( v4 )
          {
            ...
            do
            {
              ...
              *(_DWORD *)(v33 + 4) = 24;
              v34 = *(_QWORD *)(a1 + 1080);
              if ( v29 <= 0x1Fu && v29 <= *(_BYTE *)(v34 + 263) && v34 + v32 )
                v35 = *(unsigned __int16 *)(v34 + v32) * ((*(_BYTE *)(v34 + v32 + 3) & 1) != 0 ? 100 : 10000);
              else
                v35 = -1;
              *(_QWORD *)(v33 + 16) = v30;
              ++v29;
