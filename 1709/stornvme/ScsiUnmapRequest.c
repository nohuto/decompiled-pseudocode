/*
 * XREFs of ScsiUnmapRequest @ 0x1C00095B0
 * Callers:
...
LABEL_16:
    ...
    *(_BYTE *)(v8 + 4245) = *(_BYTE *)(v8 + 4245) & 0xFC | 2;
    SrbAssignQueueId(a1, a2);
    if ( *(_BYTE *)(a2 + 2) == 40 )
      v18 = *(unsigned __int8 *)(*(unsigned int *)(a2 + 52) + a2 + 10);
    else
      v18 = *(unsigned __int8 *)(a2 + 7);
    if ( (unsigned int)v18 < *(_DWORD *)(a1 + 148) )
    {
      v19 = *(_QWORD *)(a1 + 8 * v18 + 1184);
      if ( v19 )
        v3 = *(_DWORD *)(v19 + 16);
    }
    *(_DWORD *)(v8 + 4140) |= 4u;
    ...
    *(_BYTE *)(v8 + 4136) = v13 - 1;
    *(_DWORD *)(v8 + 4100) = v3;
    PhysicalAddress = StorPortGetPhysicalAddress(a1, 0LL, v8, &v21);
    *(_BYTE *)(v8 + 4245) |= 4u;
