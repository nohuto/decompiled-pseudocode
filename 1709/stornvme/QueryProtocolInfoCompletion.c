/*
 * XREFs of QueryProtocolInfoCompletion @ 0x1C000B3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall QueryProtocolInfoCompletion(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  if ( *(_BYTE *)(a2 + 3) == 1 )
  {
    if ( v7[10] == 3 )
      v7[15] = *a3;
    v7[14] = *(_DWORD *)(v5 + 4232);
    result = *(unsigned int *)(v5 + 4232);
    if ( (_DWORD)result )
    {
      v8 = *(const void **)(v5 + 4200);
      if ( v8 )
  ...
  v9 = *(_QWORD *)(v5 + 4200);
  if ( v9 )
    result = StorPortExtendedFunction(25LL, a1, v9, *(unsigned int *)(v5 + 4232));
  *(_QWORD *)(v5 + 4200) = 0LL;
  *(_DWORD *)(v5 + 4232) = 0;
  *(_BYTE *)(v5 + 4245) |= 8u;
  return result;
