/*
 * XREFs of ?PostEvent@FallbackToBddEventData@DwmInitAsimov@@UEAAXPEBU_TlgProvider_t@@@Z @ 0x180007480
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DwmInitAsimov::FallbackToBddEventData::PostEvent(
        DwmInitAsimov::FallbackToBddEventData *this,
        ...
        const GUID *a4)
{
    ...
    && (*((_QWORD *)a2 + 3) & 0x200000000000LL) == *((_QWORD *)a2 + 3) )
  {
    ...
    v14 = 2LL;
    v16 = 2LL;
    TlgWrite(a2, &unk_18000C110, (LPCGUID)a2, a4, 8u, &pData);
  }
}
