 ...
 *     ?OneCoreSkipDwmLaunch@@YA_NXZ @ 0x180002ED4 (-OneCoreSkipDwmLaunch@@YA_NXZ.c)
...
__int64 __fastcall DwmpCreateSessionProcess(int a1)
{
    ...
    && (qword_18000F018 & 0x200000000000LL) == qword_18000F018 )
  {
    ...
    v30 = &gSessionId;
    v31 = 2;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18000BF15, v5, v6, 9u, &pData);
  }
  if ( Thread )
    CloseHandle(Thread);
  return v9;
