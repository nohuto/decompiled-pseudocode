...
BOOL __stdcall DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved)
{
  ...
  if ( fdwReason )
  {
    if ( fdwReason == 1 )
    {
      ...
      v8 = (GUID)*((_OWORD *)off_18000F008 - 1);
      qword_18000F028 = 0LL;
      qword_18000F030 = 0LL;
      hKey_8 = v8;
      if ( !EventRegister(&hKey_8, TlgEnableCallback, &hProvider, &RegHandle) )
        EventSetInformation(RegHandle, 2LL, off_18000F008, *(unsigned __int16 *)off_18000F008);
      if ( hProvider > 5u
        ...
        && (qword_18000F018 & 0x200000000000LL) == qword_18000F018 )
      {
        ...
        v23 = 2LL;
        v25 = 2LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18000BD69, v9, v10, 6u, Data);
      }
      if ( byte_18000F050 )
      {
        if ( qword_18000F048 )
