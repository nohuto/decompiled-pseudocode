/*
 * XREFs of __report_gsfailure @ 0x180008400
 * Callers:
 *     __security_check_cookie @ 0x1800082F0 (__security_check_cookie.c)
 * Callees:
 *     __raise_securityfailure @ 0x1800083C8 (__raise_securityfailure.c)
 */
...
void __cdecl __noreturn _report_gsfailure(uintptr_t StackCookie)
{
  ...
  qword_18000F0D0 = ContextRecord.Rip;
  ContextRecord.Rcx = StackCookie;
  dword_18000F0C0 = -1073740791;
  dword_18000F0C4 = 1;
  dword_18000F0D8 = 3;
  qword_18000F0E0[0] = 2LL;
  qword_18000F0E0[1] = _security_cookie;
  qword_18000F0E0[2] = _security_cookie_complement;
