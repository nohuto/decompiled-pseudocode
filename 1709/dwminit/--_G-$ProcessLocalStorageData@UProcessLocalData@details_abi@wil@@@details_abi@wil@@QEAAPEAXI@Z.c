/*
 * XREFs of ??_G?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x180006F40
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x878, v8, v9);
    __debugbreak();
  }
  v10 = (void *)a1[2];
  if ( v10 && !CloseHandle(v10) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x878, v11, v12);
    __debugbreak();
  }
  v13 = (void *)a1[1];
