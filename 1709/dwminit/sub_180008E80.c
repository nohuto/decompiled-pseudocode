 ...
 *     _XcptFilter_0 @ 0x1800093CF (_XcptFilter_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800097F0 (_guard_dispatch_icall_nop.c)
 */

__int64 __fastcall sub_180008E80(HINSTANCE hinstDLL, __int64 fdwReason, void *a3)
{
  DWORD v3; // edi
  unsigned int v5; // ebx
  int v6; // eax
  ...
  if ( (_DWORD)fdwReason || dword_18000F6AC )
  {
