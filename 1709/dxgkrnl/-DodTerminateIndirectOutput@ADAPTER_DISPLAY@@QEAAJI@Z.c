/*
 * XREFs of ?DodTerminateIndirectOutput@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C0174850
 * Callers:
...
LABEL_5:
  ...
  v8 = *(unsigned int (__fastcall **)(_QWORD, _QWORD))(v7 + 1608);
  if ( !v8 )
    return 3221225659LL;
  if ( v8(*(_QWORD *)(v7 + 1544), (unsigned int)a2) == -1073741637 )
