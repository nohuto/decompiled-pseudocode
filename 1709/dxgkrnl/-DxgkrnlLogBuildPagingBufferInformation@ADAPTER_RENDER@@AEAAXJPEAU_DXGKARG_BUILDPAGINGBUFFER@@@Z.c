/*
 * XREFs of ?DxgkrnlLogBuildPagingBufferInformation@ADAPTER_RENDER@@AEAAXJPEAU_DXGKARG_BUILDPAGINGBUFFER@@@Z @ 0x1C0080A50
 * Callers:
  ...
  else
  {
    ...
    switch ( Operation )
    {
      ...
      case DXGK_OPERATION_SPECIAL_LOCK_TRANSFER:
        v9 = (_QWORD *)WdLogNewEntry5_WdTrace(this, 0x1C0000000uLL);
        v9[3] = v5;
        v9[4] = a3->Transfer.hAllocation;
        v9[5] = a3->Transfer.Source.SegmentAddress.QuadPart;
        v9[6] = a3->Transfer.Destination.SegmentId;
      ...
      case DXGK_OPERATION_FILL:
        ...
        v15[5] = a3->Transfer.Source.SegmentId;
      ...
      case DXGK_OPERATION_VIRTUAL_FILL:
        ...
        v12[5] = a3->Transfer.Source.SegmentAddress.QuadPart;
        break;
