/*
 * XREFs of ?AcquireTargetOwnership@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@I@Z @ 0x1C01D9460
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( this[4] )
  {
    ...
    if ( v10 )
    {
      v12 = DXGDISPLAYMANAGEROBJECT::ExchangeTargetOwnershipDmm(v10, (struct DXGDISPLAYMANAGEROBJECT *)this, 0LL);
      if ( v12 >= 0 )
      {
        DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v15, this[2]);
