/*
 * XREFs of MonitorEnableDisableTargetAsHMD @ 0x1C01FE418
 * Callers:
...
__int64 __fastcall MonitorEnableDisableTargetAsHMD(DXGADAPTER *a1, unsigned int a2, char a3, __int64 a4)
{
  ...
  v12 = *(struct _FAST_MUTEX **)(*((_QWORD *)a1 + 288) + 96LL);
  if ( !v12 )
  {
  ...
  if ( (int)result >= 0 )
  {
    ...
    else if ( !*((_BYTE *)v16 + 564) )
    {
      return 0LL;
    }
    KeEnterCriticalRegion();
    ExAcquireResourceExclusiveLite((PERESOURCE)((char *)v16 + 280), 1u);
    *((_BYTE *)v16 + 564) = a3;
    DXGMONITOR::_DestroyTtmDevice(v16);
    MONITOR_MGR::_IssueMonitorEvent(v12, v4, 10, (a3 != 0) + 1LL, *((_DWORD *)v16 + 104), a4);
    ExReleaseResourceLite((PERESOURCE)((char *)v16 + 280));
