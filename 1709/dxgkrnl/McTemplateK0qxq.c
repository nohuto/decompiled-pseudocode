/*
 * XREFs of McTemplateK0qxq @ 0x1C0026CA4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qxq(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, char a6)
{
  ...
  v14 = 4LL;
  v13 = &a6;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventEtwVersion, a3, 4u, &v8);
}
