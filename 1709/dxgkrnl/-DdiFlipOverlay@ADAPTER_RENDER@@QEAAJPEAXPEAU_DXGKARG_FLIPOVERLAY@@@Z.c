/*
 * XREFs of ?DdiFlipOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_FLIPOVERLAY@@@Z @ 0x1C017A320
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiFlipOverlay(ADAPTER_RENDER *this, void *a2, struct _DXGKARG_FLIPOVERLAY *a3)
{
  ...
  __int64 v25; // rcx
  __int64 v26; // r8
  _BYTE v28[8]; // [rsp+20h] [rbp-78h] BYREF
  struct _KAPC_STATE ApcState; // [rsp+28h] [rbp-70h] BYREF

  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, (__int64)a3, 5034);
...
LABEL_15:
  ...
  v15 = (*(int (__fastcall **)(void *, struct _DXGKARG_FLIPOVERLAY *))(*((_QWORD *)this + 2) + 624LL))(a2, a3);
  if ( v28[0] )
  ...
  v22 = (_QWORD *)WdLogNewEntry5_WdTrace(v17, v14);
  v22[3] = v15;
  hSource = a3->hSource;
  v22[4] = a3->hSource;
  v22[5] = a2;
  if ( (_DWORD)v15 != -1073741811 && (_DWORD)v15 != -1073741801 && (_DWORD)v15 )
  {
    v24 = WdLogNewEntry5_WdError(hSource);
    *(_QWORD *)(v24 + 24) = v15;
    WdLogEvent5_WdError(v24);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v25, &EventProfilerExit, v26, 5034);
