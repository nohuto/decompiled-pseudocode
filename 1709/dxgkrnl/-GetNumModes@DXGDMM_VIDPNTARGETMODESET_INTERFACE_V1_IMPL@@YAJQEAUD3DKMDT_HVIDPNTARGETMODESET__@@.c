/*
 * XREFs of ?GetNumModes@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEA_K@Z @ 0x1C01F1630
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v7, &EventProfilerExit, v8, 6009);
  return v5;
}
