/*
 * XREFs of ?DdiGetGpuPartitionInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETGPUPARTITIONINFO@@@Z @ 0x1C018B114
 * Callers:
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETGPUPARTITIONINFO *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                             + 32LL))(
  ...
  if ( (_DWORD)v14 != -1073741811 && (_DWORD)v14 != -1073741789 )
  {
    v21 = (int)v14 < 0;
    if ( !(_DWORD)v14 )
      goto LABEL_27;
...
LABEL_27:
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5097);
