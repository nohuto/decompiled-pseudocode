/*
 * XREFs of ?IsAllocationInPrimaryAllocationsList@DXGDEVICE@@QEAAHIPEAVDXGALLOCATION@@@Z @ 0x1C0093578
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
  ...
  if ( *((_QWORD *)this + 209) == *(_QWORD *)(*((_QWORD *)this + 2) + 16LL) )
  {
    ...
    v9 = *((_DWORD *)this + v4 + 194);
    v10 = 0LL;
    if ( v9 )
    {
      while ( *(struct DXGALLOCATION **)(*((_QWORD *)this + v4 + 81) + 8 * v10) != a3 )
      {
