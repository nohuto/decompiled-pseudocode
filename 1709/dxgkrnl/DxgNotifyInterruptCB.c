/*
 * XREFs of DxgNotifyInterruptCB @ 0x1C000DE40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgNotifyInterruptCB(__int64 a1, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a2)
{
  ...
  else if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 3748LL), 0, 0) & 2) != 0 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        (*(void (__fastcall **)(__int64, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *))(*(_QWORD *)(*(_QWORD *)(v5 + 504)
                                                                                               + 8LL)
                                                                                   + 8LL))(
          a1,
          a2);
      ...
      {
        v7 = *(DXGDODPRESENT **)(*((_QWORD *)v4 + 288) + 264LL);
        if ( v7 )
