/*
 * XREFs of TlgAggregateInternalProviderCallback @ 0x1C00F9B40
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONGLONG MatchAnyKeyword)
{
  ...
  if ( ControlCode == 2
    && MatchAnyKeyword == 32
    && (unsigned __int8)ExTryAcquirePushLockExclusiveEx(&unk_1C0060F68, 0LL) )
  {
    for ( i = qword_1C0061A50; i; i = *(_QWORD *)(i + 352) )
