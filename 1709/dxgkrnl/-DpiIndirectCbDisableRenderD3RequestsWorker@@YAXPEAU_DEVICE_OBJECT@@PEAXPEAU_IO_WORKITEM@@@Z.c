/*
 * XREFs of ?DpiIndirectCbDisableRenderD3RequestsWorker@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C01E5070
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DpiIndirectCbDisableRenderD3RequestsWorker(PVOID IoObject, char *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000000) != 0 )
  {
    v11 = Miniport;
    v10 = *(_DWORD *)Context;
    McTemplateK0xtq(*(unsigned int *)Context, v6, v7, *(_QWORD *)(Context + 4), v10, v11);
  }
  if ( v8 >= 0 )
  {
    v9 = *((_QWORD *)v18 + 3);
