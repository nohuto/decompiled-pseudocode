/*
 * XREFs of ?DmmGetCurrentIntegerVSyncFromClientVidPnSource@@YAJPEAXIPEAIPEAW4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@@Z @ 0x1C00BA16C
 * Callers:
...
LABEL_28:
  ...
  if ( v11 )
  {
    ...
    if ( v39 )
    {
      v16 = *(_QWORD *)(*((_QWORD *)a1 + 288) + 112LL);
      v41 = 3760 * v5;
