/*
 * XREFs of ?RotateCursorShape@@YAJPEBU_DXGKARG_SETPOINTERSHAPE@@PEAU1@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@PEBU_DXGK_DRIVERCAPS@@@Z @ 0x1C01B384C
 * Callers:
...
LABEL_4:
  ...
  v29 = Pitch;
  if ( v19 <= a4->MaxPointerWidth && Width <= a4->MaxPointerHeight )
  {
    if ( v17 )
    {
