/*
 * XREFs of ?InitializePowerManagement@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01775C4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::InitializePowerManagement(ADAPTER_RENDER *this)
{
  ...
  if ( !v5 )
    v4 = DxgNotifyVSyncCB;
  v17[6] = v4;
  (*(void (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(v6 + 8) + 688LL))(*((_QWORD *)this + 64), v17);
  (*(void (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(*((_QWORD *)this + 66) + 8LL) + 728LL))(
    *((_QWORD *)this + 67),
    v17);
  v7 = *(_DWORD *)(v1 + 2488);
  LODWORD(v8) = 0;
  ...
  if ( v7 )
  {
    ...
    do
    {
      ...
      if ( v12 )
      {
        ...
        {
          case 2:
            v13 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, unsigned int, char *))(*(_QWORD *)(*((_QWORD *)this + 63) + 8LL) + 696LL))(
                    *((_QWORD *)this + 64),
                    2LL,
                    0LL,
            ...
            break;
          case 3:
            v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, int))(*(_QWORD *)(*((_QWORD *)this + 66)
                                                                                             + 8LL)
                                                                                 + 736LL))(
                    *((_QWORD *)this + 67),
      ...
      {
        v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, unsigned int, __int64))(*(_QWORD *)(*((_QWORD *)this + 63) + 8LL)
                                                                                               + 696LL))(
                *((_QWORD *)this + 64),
                0LL,
                *(unsigned __int16 *)(v10 + v11 + 6),
