/*
 * XREFs of ?VmBusFlushHeapTransitions@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0193610
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusFlushHeapTransitions(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_DWORD *)(v3 + 176) == 1 )
  {
    v4 = *(_QWORD *)(v3 + 2312);
    if ( v4 )
      (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(v4 + 528) + 8LL) + 1072LL))(*(_QWORD *)(v4 + 536));
  }
