/*
 * XREFs of ?ConvertMonochromeToColor@@YAXPEBU_DXGKARG_SETPOINTERSHAPE@@PEAU1@@Z @ 0x1C01B36A8
 * Callers:
  ...
  if ( a1->Height )
  {
    ...
    do
    {
      for ( i = 0; i < v8; v8 = a1->Width )
      {
        v10 = 128 >> (i & 7);
        v11 = Pitch * v3 + (i >> 3);
        v12 = (unsigned int *)((char *)a2->pPixels + 4 * i++ + (unsigned __int64)(a2->Pitch * v3));
