/*
 * XREFs of ?VmBusMarkDeviceAsError@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0194180
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusMarkDeviceAsError(
        ...
        __int64 a3)
{
  ...
  v4 = DxgkMarkDeviceAsError(*((_QWORD *)a1 + 9) + 24LL, a2, a3);
