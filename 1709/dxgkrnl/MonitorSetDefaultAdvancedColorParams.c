/*
 * XREFs of MonitorSetDefaultAdvancedColorParams @ 0x1C01FECD4
 * Callers:
...
__int64 __fastcall MonitorSetDefaultAdvancedColorParams(struct HDXGMONITOR__ *a1)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    ExAcquireResourceExclusiveLite((PERESOURCE)((char *)v4 + 280), 1u);
    DXGMONITOR::_SetColorPrimariesToBT709(v4);
    *((_DWORD *)v4 + 158) = 5000;
    *((_DWORD *)v4 + 159) = 2700000;
    *((_DWORD *)v4 + 160) = 2700000;
    *((_BYTE *)v4 + 648) = 0;
    ExReleaseResourceLite((PERESOURCE)((char *)v4 + 280));
