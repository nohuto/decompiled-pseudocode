/*
 * XREFs of ?SetVirtualFunctionPowerState@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x1C0189B00
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::SetVirtualFunctionPowerState(__int64 a1, int a2, unsigned int *a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v5 )
      return (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v5 + 96LL))(v5, a3);
  }
