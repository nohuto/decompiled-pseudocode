/*
 * XREFs of ?_GetColorPrimariesType@DXGMONITOR@@AEAA?AW4ColorPrimaryType@1@XZ @ 0x1C0108748
 * Callers:
 *     ?_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ @ 0x1C01086C8 (-_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ.c)
 * Callees:
 *     ?_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z @ 0x1C01089C4 (-_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z.c)
 *     ?_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z @ 0x1C0108A34 (-_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z.c)
 */
...
__int64 __fastcall DXGMONITOR::_GetColorPrimariesType(_DWORD *a1)
{
  ...
  if ( !v5 )
    return 0LL;
  v6 = (DXGMONITOR *)(unsigned int)a1[154];
  if ( !(_DWORD)v6 )
    return 0LL;
