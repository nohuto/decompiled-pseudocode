/*
 * XREFs of McTemplateK0pqqttq @ 0x1C002B6F0
 * Callers:
...
NTSTATUS McTemplateK0pqqttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOutputDuplicationReleaseFrame, a3, 7u, &v4);
}
