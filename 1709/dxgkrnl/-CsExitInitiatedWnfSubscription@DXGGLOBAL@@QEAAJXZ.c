/*
 * XREFs of ?CsExitInitiatedWnfSubscription@DXGGLOBAL@@QEAAJXZ @ 0x1C01197FC
 * Callers:
...
__int64 __fastcall DXGGLOBAL::CsExitInitiatedWnfSubscription(DXGGLOBAL *this)
{
  ...
  v1 = ExSubscribeWnfStateChange((char *)this + 1264, &v8, 1LL, 0LL, CsExitInitiatedWnfCallback, this);
  v5 = v1;
  if ( v1 < 0 )
  {
