/*
 * XREFs of ?AcquireAdapterOrdinal@DXGGLOBAL@@QEAAKXZ @ 0x1C011964C
 * Callers:
...
__int64 __fastcall DXGGLOBAL::AcquireAdapterOrdinal(struct _RTL_BITMAP *this)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v9, (struct DXGFASTMUTEX *const)&this[28].Buffer);
  ...
  if ( ClearBitsAndSet == -1 )
  {
    ...
    *(_QWORD *)(v8 + 24) = this[51].SizeOfBitMap;
