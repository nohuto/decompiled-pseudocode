/*
 * XREFs of McTemplateK0qqqqqtqtq @ 0x1C002B398
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqtqtq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_High_Level_Update_Stop, a3, 0xAu, &v13);
}
