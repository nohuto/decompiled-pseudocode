/*
 * XREFs of IoDevObjCreateDeviceSecure @ 0x1C010E880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IopDevObjApplyPostCreationSettings @ 0x1C010F0F8 (IopDevObjApplyPostCreationSettings.c)
  ...
  if ( updated >= 0 )
  {
    ...
    if ( !a8
      || (v23[0] = 2LL,
          v23[2] = 0LL,
          v23[1] = v19,
          updated = PpRegStateUpdateStackCreationSettings(a8, (__int64)v23),
          updated >= 0) )
    {
LABEL_9:
      v16 = a4;
