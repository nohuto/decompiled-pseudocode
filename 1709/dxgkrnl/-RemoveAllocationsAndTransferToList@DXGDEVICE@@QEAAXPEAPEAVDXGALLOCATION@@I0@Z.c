/*
 * XREFs of ?RemoveAllocationsAndTransferToList@DXGDEVICE@@QEAAXPEAPEAVDXGALLOCATION@@I0@Z @ 0x1C00952C4
 * Callers:
        ...
        struct DXGALLOCATION **a4)
{
  ...
  v5 = a3;
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v15, this + 20);
  v13 = 0LL;
  v14 = 0;
