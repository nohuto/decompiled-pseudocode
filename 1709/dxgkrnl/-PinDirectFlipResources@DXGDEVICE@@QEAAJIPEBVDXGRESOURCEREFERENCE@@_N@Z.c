/*
 * XREFs of ?PinDirectFlipResources@DXGDEVICE@@QEAAJIPEBVDXGRESOURCEREFERENCE@@_N@Z @ 0x1C00FFEB4
 * Callers:
        ...
        char a4)
{
  ...
  else
  {
    ...
    v42 = v40.Height;
    v39 = v40.Format;
    if ( (unsigned int)v9 >= *((_DWORD *)this + 420) )
    {
...
LABEL_16:
      while ( v29 )
      {
        ...
        if ( !DXGDEVICE::InsertDirectFlipAllocationToList((struct _KTHREAD **)this, v9, (struct DXGALLOCATION *)v29) )
        {
          v35 = WdLogNewEntry5_WdAssertion(v31);
          *(_QWORD *)(v35 + 24) = 6040LL;
