/*
 * XREFs of McTemplateK0did @ 0x1C002BE54
 * Callers:
...
NTSTATUS __fastcall McTemplateK0did(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  v10 = &a5;
  v12 = &a6;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventBltQueueCompleteIndirectPresent, a3, 4u, &v7);
}
