/*
 * XREFs of McTemplateK0pqpqtt @ 0x1C0029310
 * Callers:
...
NTSTATUS McTemplateK0pqpqtt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventFlip, a3, 7u, &v4);
}
