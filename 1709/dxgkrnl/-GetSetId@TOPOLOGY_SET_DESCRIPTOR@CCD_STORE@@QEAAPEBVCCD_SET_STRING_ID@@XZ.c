/*
 * XREFs of ?GetSetId@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAPEBVCCD_SET_STRING_ID@@XZ @ 0x1C00D9FB4
 * Callers:
...
void **__fastcall CCD_STORE::TOPOLOGY_SET_DESCRIPTOR::GetSetId(void **this)
{
  ...
  SetIdFromRegistry = CcdLazyRetrieveSetIdFromRegistry(this[8], (__int64)L"SetId", (__int64)this);
