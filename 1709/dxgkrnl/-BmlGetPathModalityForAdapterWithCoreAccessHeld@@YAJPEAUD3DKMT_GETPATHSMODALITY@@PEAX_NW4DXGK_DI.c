/*
 * XREFs of ?BmlGetPathModalityForAdapterWithCoreAccessHeld@@YAJPEAUD3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IPEAPEAUD3DKMDT_HVIDPN__@@@Z @ 0x1C00D1D18
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = (unsigned __int16 *)&unk_1C005FF20;
  v11 = 0;
  do
  {
    v12 = v6[1];
