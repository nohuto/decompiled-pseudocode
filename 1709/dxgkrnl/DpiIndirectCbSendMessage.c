/*
 * XREFs of DpiIndirectCbSendMessage @ 0x1C01E5DC0
 * Callers:
 *     <none>
 * Callees:
 *     ?DpiIndirectOpenDevice@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_FILE_OBJECT@@PEAPEAU1@@Z @ 0x1C01E5778 (-DpiIndirectOpenDevice@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_FILE_OBJECT@@PEAPEAU1@@Z.c)
