/*
 * XREFs of ??0COREDEVICEACCESS@@QEAA@QEAVDXGDEVICE@@W4_DXGDEVICEACCESS_TYPE@@I_N@Z @ 0x1C0001BB4
 * Callers:
...
__int64 __fastcall COREDEVICEACCESS::COREDEVICEACCESS(__int64 a1, __int64 a2, int a3, __int64 a4, char a5)
{
  ...
  *(_QWORD *)(a1 + 72) = a2;
  ...
  {
    v13 = *(_QWORD *)(a2 + 1672);
    if ( v13 && *(_QWORD *)(v13 + 2304) )
      goto LABEL_9;
    v14 = WdLogNewEntry5_WdAssertion(-1LL);
    *(_QWORD *)(v14 + 24) = 1304LL;
