/*
 * XREFs of ?DodGetOpmMftContext@ADAPTER_DISPLAY@@QEAAJIPEA_K@Z @ 0x1C0174638
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DodGetOpmMftContext(ADAPTER_DISPLAY *this, __int64 a2, unsigned __int64 *a3)
{
  ...
  v4 = *((_QWORD *)this + 2);
  v5 = *(__int64 (__fastcall **)(_QWORD, __int64, unsigned __int64 *))(v4 + 1576);
  if ( v5 )
  {
    v8 = v5(*(_QWORD *)(v4 + 1544), a2, a3);
    v10 = v8;
    if ( v8 < 0 )
    {
