/*
 * XREFs of ?GetAllocationSize@@YAJPEAVDXGDEVICE@@IPEAUtagRECT@@@Z @ 0x1C01C63B8
 * Callers:
...
LABEL_16:
  ...
  if ( *(_QWORD *)(v19 + 16) == *(_QWORD *)(v18 + 16) )
  {
    ...
    if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(*(ADAPTER_RENDER **)(*(_QWORD *)(v18 + 16) + 2312LL), &v25, v22) >= 0 )
    {
      Width = v25.Width;
      a3->left = 0;
      a3->top = 0;
