/*
 * XREFs of ?DmmCollectTdrDiagInfo@@YAJPEAU_TDR_RECOVERY_CONTEXT@@PEAX_K@Z @ 0x1C01EB710
 * Callers:
...
__int64 __fastcall DmmCollectTdrDiagInfo(struct _TDR_RECOVERY_CONTEXT *a1, void *a2, size_t a3)
{
  ...
  __int64 v17; // r8
  __int64 v18; // rax
  size_t v19; // [rsp+50h] [rbp+18h] BYREF
...
LABEL_3:
  ...
  if ( v9 )
  {
    ...
    v12 = *(_QWORD *)(*(_QWORD *)(v9 + 2304) + 88LL);
    if ( v12 )
    {
      v19 = 0LL;
      v14 = VIDPN_MGR::AcquireDiagInfo(v12, a2, 0x2000uLL, 1, 0LL, &v19);
      if ( v14 == -2147483643 )
      {
