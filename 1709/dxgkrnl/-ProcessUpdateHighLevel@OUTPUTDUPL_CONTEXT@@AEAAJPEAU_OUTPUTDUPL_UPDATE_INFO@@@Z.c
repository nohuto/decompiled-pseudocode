/*
 * XREFs of ?ProcessUpdateHighLevel@OUTPUTDUPL_CONTEXT@@AEAAJPEAU_OUTPUTDUPL_UPDATE_INFO@@@Z @ 0x1C01CCDC4
 * Callers:
...
LABEL_28:
  ...
  if ( (unsigned int)OUTPUTDUPL_MGR::IsHighFreqLoggingEnabled(*((OUTPUTDUPL_MGR **)this + 37)) )
  {
    ...
    v36 = (LOBYTE(v45[19]) ^ (unsigned __int8)*(_DWORD *)(v34 + 16)) & 3 ^ v45[19];
    v37 = *((_QWORD *)this + 34);
    v45[19] = v36;
