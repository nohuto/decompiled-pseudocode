/*
 * XREFs of ?DdiDestroyPeriodicFrameNotification@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C0179E78
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C0025340 (-ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTR.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5075);
  DXGADAPTER::AcquireDdiSync(*((_QWORD *)this + 2), 1);
  v5 = *(void **)(*((_QWORD *)this + 2) + 240LL);
  a2->hAdapter = v5;
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(struct _DXGKARG_DESTROYPERIODICFRAMENOTIFICATION *))(*((_QWORD *)this + 2) + 1032LL))(a2);
  if ( v27[0] )
  ...
  v21 = WdLogNewEntry5_WdTrace(v16, v13);
  *(_QWORD *)(v21 + 24) = v14;
  hNotification = a2->hNotification;
  *(_QWORD *)(v21 + 32) = a2->hNotification;
  if ( (_DWORD)v14 != -1073741811 && (_DWORD)v14 )
  {
    v23 = WdLogNewEntry5_WdError(hNotification);
    *(_QWORD *)(v23 + 24) = v14;
    WdLogEvent5_WdError(v23);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5075);
