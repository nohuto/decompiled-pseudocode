/*
 * XREFs of McTemplateK0ptpjqq @ 0x1C0033564
 * Callers:
...
NTSTATUS McTemplateK0ptpjqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v23; // [rsp+F0h] [rbp+6Fh]
  __int64 v24; // [rsp+F8h] [rbp+77h] BYREF
  va_list va3; // [rsp+F8h] [rbp+77h]
  va_list va4; // [rsp+100h] [rbp+7Fh] BYREF
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOPMConfigureProtectedOutput, a3, 7u, &v4);
}
