/*
 * XREFs of ?_AddPathToTopology@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJAEBU_LUID@@IIW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@1E@Z @ 0x1C01FA770
 * Callers:
        ...
        char a7)
{
  ...
  ++*((_WORD *)this + 4);
  result = CCD_TOPOLOGY::AddPathDescriptor(*(CCD_TOPOLOGY **)this, a2, a3, a4, a7, a5, a6, 0LL, 0);
