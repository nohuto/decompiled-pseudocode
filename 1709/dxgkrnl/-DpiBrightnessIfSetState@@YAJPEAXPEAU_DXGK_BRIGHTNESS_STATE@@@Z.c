/*
 * XREFs of ?DpiBrightnessIfSetState@@YAJPEAXPEAU_DXGK_BRIGHTNESS_STATE@@@Z @ 0x1C01E3970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfSetState(_QWORD *a1, struct _DXGK_BRIGHTNESS_STATE *a2)
{
  ...
  if ( *(_QWORD *)(v2 + 4552) )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGK_BRIGHTNESS_STATE *))(v2 + 4552))(*(_QWORD *)(v2 + 4496), a2);
