/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C00D9B9C
 * Callers:
 ...
 *     _anonymous_namespace_::_UpdateTimestampTopologySetCallback @ 0x1C00FAD60 (_anonymous_namespace_--_UpdateTimestampTopologySetCallback.c)
 * Callees:
 *     <none>
 */
