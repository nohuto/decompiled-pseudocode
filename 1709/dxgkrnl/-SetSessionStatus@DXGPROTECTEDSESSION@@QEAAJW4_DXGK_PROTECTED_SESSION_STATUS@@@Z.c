/*
 * XREFs of ?SetSessionStatus@DXGPROTECTEDSESSION@@QEAAJW4_DXGK_PROTECTED_SESSION_STATUS@@@Z @ 0x1C0029764
 * Callers:
 ...
 * Callees:
 *     ?QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ @ 0x1C01BC04C (-QueueSignal@DXGPROTECTEDSESSION@@QEAAJXZ.c)
 */
