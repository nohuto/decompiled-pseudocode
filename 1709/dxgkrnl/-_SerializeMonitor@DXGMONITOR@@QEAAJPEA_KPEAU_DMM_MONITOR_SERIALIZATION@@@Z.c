/*
 * XREFs of ?_SerializeMonitor@DXGMONITOR@@QEAAJPEA_KPEAU_DMM_MONITOR_SERIALIZATION@@@Z @ 0x1C0201D64
 * Callers:
        ...
        struct _DMM_MONITOR_SERIALIZATION *a3)
{
  ...
  if ( a3 && v13 <= *a2 )
  {
    ...
    *((_BYTE *)a3 + 12) = *((_DWORD *)this + 104) != 1;
    *((_BYTE *)a3 + 13) = ((_DWORD)this[3] & 8) != 0;
    ...
    *((_DWORD *)a3 + 5) = v15;
    v16 = 0;
    *((_DWORD *)a3 + 9) = *((_DWORD *)this + 104);
    *((_DWORD *)a3 + 10) = *((_DWORD *)this + 48);
    v17 = this[25];
    if ( v17 != (DXGMONITOR *)(this + 25) )
    {
      v18 = (char *)v17 - 96;
      if ( !v17 )
        v18 = 0LL;
    ...
    *((_BYTE *)a3 + v21) = *((_BYTE *)this + 240);
    v24 = this[31];
    if ( v24 != (DXGMONITOR *)(this + 31) )
    {
      v25 = (char *)v24 - 48;
      if ( !v24 )
        v25 = 0LL;
    ...
    *((_DWORD *)a3 + 7) = v21;
          ...
          *(_OWORD *)&v30[v33 + 128] = *(_OWORD *)(v12 + 136) )
    {
      ...
      *(_DWORD *)&v30[v33 + 8] = *(_DWORD *)(*((_QWORD *)this[15] + v29) + 12LL);
      ConvertMonitorCapablitiesOrigin(*(unsigned int *)(*((_QWORD *)this[15] + v29++) + 8LL), &v30[v33 + 12]);
      v12 = *((_QWORD *)this[15] + v31);
