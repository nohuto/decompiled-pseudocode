/*
 * XREFs of DxgkWriteUserModeDiagEntry @ 0x1C0182154
 * Callers:
...
__int64 __fastcall DxgkWriteUserModeDiagEntry(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_DWORD *)a1 + 1) < 0x400u )
  {
    ...
    if ( Global )
    {
      DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v14, (struct _KTHREAD **)Global + 68);
      ...
      *((_QWORD *)a1 + 1) = v17 * KeQueryTimeIncrement();
      v11 = (DXGDIAGNOSTICS *)*((_QWORD *)v6 + 72);
      if ( v11 )
      {
