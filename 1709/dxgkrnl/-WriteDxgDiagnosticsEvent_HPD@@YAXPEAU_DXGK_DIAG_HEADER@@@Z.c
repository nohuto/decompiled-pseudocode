/*
 * XREFs of ?WriteDxgDiagnosticsEvent_HPD@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C000D0BC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_HPD(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 1u, 0x200000000002uLL) && hProvider > 1u )
    {
      if ( TlgKeywordOn(v2, v3) )
      {
        ...
        v15 = 2;
        v17 = a1;
        TlgWrite(v5, &unk_1C0040D84, 0LL, v4, 5u, &pData);
      }
    }
  }
  else if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000002uLL)
         && hProvider > 4u
         && TlgKeywordOn(v6, v7) )
  {
    v13 = 0;
    ...
    v15 = 2;
    v17 = a1;
    TlgWrite(v9, &unk_1C0040D62, 0LL, v8, 5u, &pData);
  }
}
