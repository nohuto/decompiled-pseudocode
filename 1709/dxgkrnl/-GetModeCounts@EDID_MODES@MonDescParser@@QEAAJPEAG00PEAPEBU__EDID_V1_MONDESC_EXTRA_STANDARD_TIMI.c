/*
 * XREFs of ?GetModeCounts@EDID_MODES@MonDescParser@@QEAAJPEAG00PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@00@Z @ 0x1C00105EC
 * Callers:
 ...
 *     ?Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C000927C (-Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 ...
 *     ?DenseOnesBitCount@MonDescParser@@YAEE@Z @ 0x1C0010950 (-DenseOnesBitCount@MonDescParser@@YAEE@Z.c)
  ...
  if ( a7 )
  {
    ...
    *a7 = 0;
    if ( *((_DWORD *)v7 + 20) )
    {
      do
      {
        if ( (unsigned int)MonDescParser::EDID_PARSER::GetBlockType((MonDescParser::EDID_PARSER *)v7, v37) == 2 )
        {
          v42 = 0;
          v43 = &v7[(_QWORD)v7[10]];
          if ( v7 == v43 )
