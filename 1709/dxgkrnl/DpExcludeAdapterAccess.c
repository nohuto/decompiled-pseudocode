/*
 * XREFs of DpExcludeAdapterAccess @ 0x1C01DB0E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_32:
  ...
  if ( ((*((_DWORD *)DeviceExtension + 952) - 1) & 0xFFFFFFFB) == 0 )
  {
    v12 = -1073741661LL;
LABEL_29:
    LODWORD(v13) = v12;
...
LABEL_10:
  ...
  v16 = a2 & 2;
  if ( (a2 & 2) != 0 && ((a2 & 1) != 0 || !DxgkIsAdapterCoreSyncAcquired(*((DXGADAPTER **)DeviceExtension + 466), 2)) )
  {
  ...
  if ( (a2 & 4) != 0 && (!*((_QWORD *)DeviceExtension + 346) || !*((_QWORD *)DeviceExtension + 347)) )
  {
    LODWORD(v13) = -1073741637;
