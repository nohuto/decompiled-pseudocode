/*
 * XREFs of ?GetVidSchCompanionContext@DXGCONTEXT@@QEAAPEAU_VIDSCH_CONTEXT@@XZ @ 0x1C0187E14
 * Callers:
...
struct _VIDSCH_CONTEXT *__fastcall DXGCONTEXT::GetVidSchCompanionContext(DXGCONTEXT *this)
{
  ...
  if ( !*((_QWORD *)this + 30) )
  {
    ...
    v5 = 0LL;
    v6 = 0LL;
    v2 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 40LL) + 312LL);
    v4 = 64LL;
    LODWORD(v6) = v2;
    HIDWORD(v4) = *((_DWORD *)this + 55);
    LODWORD(v5) = *((_DWORD *)this + 90);
    *((_QWORD *)this + 30) = (*(__int64 (__fastcall **)(DXGCONTEXT *, __int64 *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 504LL)
                                                                                            + 8LL)
                                                                                + 216LL))(
                               this,
                               &v4);
