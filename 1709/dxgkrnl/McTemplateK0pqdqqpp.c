/*
 * XREFs of McTemplateK0pqdqqpp @ 0x1C002CBEC
 * Callers:
...
NTSTATUS McTemplateK0pqdqqpp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainCreate, a3, 8u, &v4);
}
