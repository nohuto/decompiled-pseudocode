/*
 * XREFs of ?MarkAbandoned@DXGSWAPCHAIN@@QEAAX_N@Z @ 0x1C01D5FC4
 * Callers:
...
void __fastcall DXGSWAPCHAIN::MarkAbandoned(struct _KTHREAD **this, __int64 a2, __int64 a3)
{
  ...
  if ( !*((_DWORD *)this + 11) || !*((_DWORD *)this + 12) )
  {
    v5 = (struct _KEVENT *)this[14];
    *((_DWORD *)this + 11) = 1;
    if ( v5 )
      KeSetEvent(v5, 2, 0);
    v6 = (struct _KEVENT *)this[20];
    if ( v6 )
      KeSetEvent(v6, 2, 0);
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000000) != 0 )
      McTemplateK0ppp((__int64)v6, &EventIndirectSwapChainMarkAbandoned, a3, this, this[20], this[14]);
  }
}
