/*
 * XREFs of DxgkUpdateContextAllocationCB @ 0x1C019AA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkUpdateContextAllocationCB(__int64 a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(DxgAdapter + 2312) + 528LL) + 8LL)
                                                  + 840LL))(
         *(_QWORD *)(*(_QWORD *)(DxgAdapter + 2312) + 536LL),
         a2);
  if ( v7[0] )
