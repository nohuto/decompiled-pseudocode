/*
 * XREFs of DpiPdoPollChild @ 0x1C01E8B84
 * Callers:
...
__int64 __fastcall DpiPdoPollChild(__int64 a1, int a2, int a3, char a4, char a5)
{
  ...
  v10 = ExAllocateFromNPagedLookasideList(&stru_1C0060940);
  v12 = v10;
  if ( v10 )
  {
    ...
    *((_BYTE *)v10 + 42) = 1;
    ...
    v15 = (_QWORD *)qword_1C0060A70;
    if ( *(PVOID **)qword_1C0060A70 != &Entry )
      __fastfail(3u);
    *v12 = &Entry;
    v12[1] = v15;
    *v15 = v12;
    qword_1C0060A70 = (__int64)v12;
