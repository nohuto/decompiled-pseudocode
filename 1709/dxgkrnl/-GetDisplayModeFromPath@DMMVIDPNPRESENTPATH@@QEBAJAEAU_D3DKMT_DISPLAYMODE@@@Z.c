/*
 * XREFs of ?GetDisplayModeFromPath@DMMVIDPNPRESENTPATH@@QEBAJAEAU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C00A5FC0
 * Callers:
        ...
        struct _D3DKMT_DISPLAYMODE *a2)
{
  ...
  if ( v7 )
  {
    ...
    v24 = v11;
    if ( v12
      && (v13 = D3DKMDT_VPPR_GET_CONTENT_ROTATION(*((D3DKMDT_VIDPN_PRESENT_PATH_ROTATION *)this + 29)),
          DMMVIDPNPRESENTPATH::IsFunctionalContentRotationType((D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v13))
