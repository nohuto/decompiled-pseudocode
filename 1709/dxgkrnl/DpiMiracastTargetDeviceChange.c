/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C002FFE0
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        *((_QWORD *)Context + 11) = 0LL;
        ...
        if ( v15 )
        {
          ...
          *v24 = v23;
          v23[1] = v24;
          v25 = (char **)qword_1C0060BF8;
          if ( *(__int64 **)qword_1C0060BF8 != &qword_1C0060BF0 )
            __fastfail(3u);
          *(_QWORD *)Context = &qword_1C0060BF0;
          *((_QWORD *)Context + 1) = v25;
          *v25 = Context;
          qword_1C0060BF8 = (__int64)Context;
