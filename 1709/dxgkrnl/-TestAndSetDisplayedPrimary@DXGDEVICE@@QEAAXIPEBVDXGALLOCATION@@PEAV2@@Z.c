/*
 * XREFs of ?TestAndSetDisplayedPrimary@DXGDEVICE@@QEAAXIPEBVDXGALLOCATION@@PEAV2@@Z @ 0x1C0003DEC
 * Callers:
        ...
        struct DXGALLOCATION *a4)
{
  ...
  if ( v8 == *((struct _KTHREAD **)this[2] + 2) )
    ADAPTER_DISPLAY::ReplaceDisplayedAllocation(*((ADAPTER_DISPLAY **)v8 + 288), a3, v7);
}
