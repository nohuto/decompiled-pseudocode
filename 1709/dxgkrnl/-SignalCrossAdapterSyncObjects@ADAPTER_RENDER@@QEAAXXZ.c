/*
 * XREFs of ?SignalCrossAdapterSyncObjects@ADAPTER_RENDER@@QEAAXXZ @ 0x1C0177E5C
 * Callers:
 ...
 *     ?AcquireExclusive@DXGSYNCOBJECTLOCK@@QEAAXXZ @ 0x1C0014BD0 (-AcquireExclusive@DXGSYNCOBJECTLOCK@@QEAAXXZ.c)
...
void __fastcall ADAPTER_RENDER::SignalCrossAdapterSyncObjects(ADAPTER_RENDER *this)
{
  ...
  for ( i = (__int64 *)*((_QWORD *)this + 24); i != (__int64 *)((char *)this + 192) && i; i = (__int64 *)*i )
  {
    if ( *((_BYTE *)i + 26) )
    {
      ...
      v6 = -1LL;
      v7 = v4;
      (*(void (__fastcall **)(_QWORD, _QWORD, __int64, __int64 *, _DWORD, __int64 *))(*(_QWORD *)(*((_QWORD *)this + 63)
                                                                                                + 8LL)
                                                                                    + 544LL))(
        0LL,
        0LL,
