/*
 * XREFs of DxgkSetMonitorColorSpaceTransform @ 0x1C00F9E90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ColorSpaceTransformValidate @ 0x1C0037DA4 (ColorSpaceTransformValidate.c)
...
LABEL_52:
    ...
    v24 = DXGK_GAMMA_RAMP::Initialize((size_t *)v3, 4u, 0LL);
    v6 = v24;
    if ( v24 < 0 )
    {
...
LABEL_32:
    ...
    *((_OWORD *)v28 + 2) = *((_OWORD *)v27 + 2);
    ...
    {
LABEL_59:
      if ( *(_BYTE *)(*((_QWORD *)v14 + 288) + 134LL) )
        v35 = COREADAPTERACCESS::AcquireExclusive(v48, 1u);
      else
      ...
      {
        LOBYTE(v49) = 0;
        v39 = DmmSetMonitorColorSpaceTransform(v14, v46[1].LowPart, (const void **)v3, (bool *)&v49);
        v6 = v39;
        if ( v39 >= 0 )
        {
          v41 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(*((ADAPTER_DISPLAY **)v14 + 288), v46[1].LowPart);
          if ( (_BYTE)v49
            || v41 == -1
