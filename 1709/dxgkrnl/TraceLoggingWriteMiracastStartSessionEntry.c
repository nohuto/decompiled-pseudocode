/*
 * XREFs of TraceLoggingWriteMiracastStartSessionEntry @ 0x1C00348F0
 * Callers:
...
void TraceLoggingWriteMiracastStartSessionEntry()
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C005F810, 0x400000000000uLL) )
    {
      v4 = 0;
      v2 = v0;
      v3 = 16;
      TlgWrite((TraceLoggingHProvider)&dword_1C005F810, &unk_1C00416DE, v0, v0, 3u, &pData);
    }
  }
}
