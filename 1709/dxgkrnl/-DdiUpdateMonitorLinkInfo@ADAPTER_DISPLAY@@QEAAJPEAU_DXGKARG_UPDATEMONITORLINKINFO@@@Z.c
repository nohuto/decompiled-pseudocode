/*
 * XREFs of ?DdiUpdateMonitorLinkInfo@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x1C0106094
 * Callers:
...
LABEL_15:
  ...
  v21[6] = a2->MonitorLinkInfo.UsageHints.Value;
  Value = a2->MonitorLinkInfo.Capabilities.Value;
  v21[7] = Value;
  if ( (_DWORD)v14 != -1073741801 && (_DWORD)v14 != -1073741637 && (_DWORD)v14 )
  {
    v23 = WdLogNewEntry5_WdError(Value);
    *(_QWORD *)(v23 + 24) = v14;
    WdLogEvent5_WdError(v23);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5072);
