/*
 * XREFs of ?ProcessPointerShape@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C01CCBF8
 * Callers:
        ...
        const struct _DXGKARG_SETPOINTERSHAPE *a3)
{
  ...
  const struct _DXGKARG_SETPOINTERSHAPE *v13; // [rsp+38h] [rbp-20h]
  const struct _DXGKARG_SETPOINTERPOSITION *v14; // [rsp+40h] [rbp-18h]

  if ( *((_DWORD *)this + 80) )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2) + 24) = 1992LL;
    return 0LL;
  }
  else
  {
