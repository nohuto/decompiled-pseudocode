/*
 * XREFs of ?DpiIndirectOpenDevice@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_FILE_OBJECT@@PEAPEAU1@@Z @ 0x1C01E5778
 * Callers:
 *     DpiIndirectCbSendMessage @ 0x1C01E5DC0 (DpiIndirectCbSendMessage.c)
 * Callees:
 *     <none>
 */
