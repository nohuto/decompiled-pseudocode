/*
 * XREFs of ?InitializeBootSettings@DXGVALIDATION@@QEAAXXZ @ 0x1C0013CA0
 * Callers:
...
void __fastcall DXGVALIDATION::InitializeBootSettings(DXGVALIDATION *this)
{
  ...
  struct _DEVOBJ_EXTENSION **p_DeviceObjectExtension; // [rsp+108h] [rbp+8h]
  ...
  ULONG *p_ActiveThreadCount; // [rsp+140h] [rbp+40h]
  ...
  v29 = &v9;
  v31 = &v6;
  p_DeviceObjectExtension = &DeviceObject.DeviceObjectExtension;
  v36 = &v10;
  v38 = &v6;
  ...
  if ( (int)RtlQueryRegistryValuesEx(2LL, &DeviceObject.Dpc.DpcListEntry, &v12, 0LL, 0LL) >= 0 )
  {
    v2 = v7;
    if ( v7 >= 2 )
      v2 = 2;
