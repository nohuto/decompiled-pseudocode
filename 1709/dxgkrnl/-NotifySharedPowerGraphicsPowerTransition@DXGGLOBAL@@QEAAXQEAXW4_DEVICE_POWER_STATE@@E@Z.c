/*
 * XREFs of ?NotifySharedPowerGraphicsPowerTransition@DXGGLOBAL@@QEAAXQEAXW4_DEVICE_POWER_STATE@@E@Z @ 0x1C01AAE0C
 * Callers:
        ...
        char a4)
{
  ...
  for ( i = (__int64 **)*((_QWORD *)this + 147); i != (__int64 **)((char *)this + 1176) && i; i = (__int64 **)*i )
  {
    if ( i[4] == a2 )
    {
      v11 = i[5];
      if ( v11 )
      {
        ...
        {
          v15 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v14, v13, v9);
          v15[3] = 275LL;
          v15[4] = 16LL;
          v15[5] = this;
          v15[6] = CurrentIrql;
