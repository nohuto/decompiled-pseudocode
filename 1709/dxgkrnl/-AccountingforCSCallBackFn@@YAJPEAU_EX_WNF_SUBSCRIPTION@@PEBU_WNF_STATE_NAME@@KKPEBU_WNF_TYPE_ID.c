/*
 * XREFs of ?AccountingforCSCallBackFn@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C01A9810
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  v17 = a4;
  v16 = 20;
  v4 = ((__int64 (__fastcall *)(struct _EX_WNF_SUBSCRIPTION *, int *, __int64 *, int *))ExQueryWnfStateData)(
         a1,
         &v17,
         &v18,
         &v16);
