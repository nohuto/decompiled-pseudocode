/*
 * XREFs of ?_ReadOneBlockMonitorDescriptorFromRegistry@DXGMONITOR@@CAJPEAXIPEAPEAU_MONITORDESCRIPTOR@1@@Z @ 0x1C0200448
 * Callers:
        ...
        struct DXGMONITOR::_MONITORDESCRIPTOR **a3)
{
  ...
  wchar_t pszDest; // [rsp+48h] [rbp-40h] BYREF
  ...
  *a3 = 0LL;
  v8 = RtlStringCbPrintfW(&pszDest, 8uLL, L"%d", (unsigned int)v3);
  v10 = v8;
  if ( v8 >= 0 )
  {
