/*
 * XREFs of ?InitializeQueryStateUnsafe@DISPLAY_SOURCE@@QEAAXXZ @ 0x1C01756E4
 * Callers:
...
void __fastcall DISPLAY_SOURCE::InitializeQueryStateUnsafe(DISPLAY_SOURCE *this)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 934); i = (unsigned int)(i + 1) )
  {
  ...
  *((_DWORD *)this + 935) = *((_DWORD *)this + 934);
  *((_BYTE *)this + 3696) = 1;
