/*
 * XREFs of ?DdiSetVirtualGpuResources@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPURESOURCES@@@Z @ 0x1C018D0FC
 * Callers:
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPURESOURCES *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                            + 936LL)
                                                                                + 80LL))(
  ...
  if ( (_DWORD)v14 != -1073741823 && (_DWORD)v14 != -1073741811 && (_DWORD)v14 )
  {
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v22, &EventProfilerExit, v23, 5101);
