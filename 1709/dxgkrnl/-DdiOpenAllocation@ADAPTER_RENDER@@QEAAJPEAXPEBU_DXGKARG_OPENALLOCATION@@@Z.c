/*
 * XREFs of ?DdiOpenAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_OPENALLOCATION@@@Z @ 0x1C016FD78
 * Callers:
        ...
        const struct _DXGKARG_OPENALLOCATION *a3)
{
  ...
  __int64 v28; // rcx
  __int64 v29; // r8
  _BYTE v31[24]; // [rsp+20h] [rbp-98h] BYREF
  _BYTE v32[8]; // [rsp+38h] [rbp-80h] BYREF
...
LABEL_15:
  ...
  v16 = (*(int (__fastcall **)(__int64, const struct _DXGKARG_OPENALLOCATION *))(*((_QWORD *)this + 2) + 584LL))(a2, a3);
  if ( v32[0] )
  ...
  v23[7] = pOpenAllocation->hDeviceSpecificAllocation;
  if ( (_DWORD)v16 != -1073741811 && (_DWORD)v16 != -1073741801 && (_DWORD)v16 )
  {
    v25 = WdLogNewEntry5_WdError(pOpenAllocation);
    *(_QWORD *)(v25 + 24) = v16;
  ...
  if ( !a3->pOpenAllocation->hDeviceSpecificAllocation && (int)v16 >= 0 )
  {
    ...
    *(_QWORD *)(v27 + 24) = 2427LL;
    WdLogEvent5_WdAssertion(v27);
  }
  DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v31);
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v28, &EventProfilerExit, v29, 5028);
