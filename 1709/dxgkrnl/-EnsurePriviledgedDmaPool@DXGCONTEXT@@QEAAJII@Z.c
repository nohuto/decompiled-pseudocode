/*
 * XREFs of ?EnsurePriviledgedDmaPool@DXGCONTEXT@@QEAAJII@Z @ 0x1C00C1184
 * Callers:
...
__int64 __fastcall DXGCONTEXT::EnsurePriviledgedDmaPool(DXGCONTEXT *this, int a2, int a3)
{
  ...
  {
    v12 = 1;
    v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, DXGCONTEXT *, char, _DWORD, int, int, _DWORD, _DWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 528LL) + 8LL) + 432LL))(
    ...
    *((_QWORD *)this + 28) = v7;
    if ( v7 )
    {
      v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 528LL)
                                                          + 8LL)
                                              + 440LL))(v7);
      if ( v3 < 0 )
      {
    ...
    {
      v11 = WdLogNewEntry5_WdWarning(0LL, v8, v9);
      v3 = -1073741801;
      *(_QWORD *)(v11 + 24) = this;
