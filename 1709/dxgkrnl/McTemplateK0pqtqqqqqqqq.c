/*
 * XREFs of McTemplateK0pqtqqqqqqqq @ 0x1C00214A4
 * Callers:
...
NTSTATUS McTemplateK0pqtqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v24 = 4LL;
  v26 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &DisplayConfigPostCompositionChange, a3, 0xCu, &v4);
}
