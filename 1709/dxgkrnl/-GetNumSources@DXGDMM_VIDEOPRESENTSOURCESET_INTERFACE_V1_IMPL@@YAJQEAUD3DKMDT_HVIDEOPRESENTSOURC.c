/*
 * XREFs of ?GetNumSources@DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@PEA_K@Z @ 0x1C01F17F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, (__int64)a3, 6040);
  v5 = 0;
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v7, &EventProfilerExit, v8, 6040);
  return v5;
}
