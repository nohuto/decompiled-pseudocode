/*
 * XREFs of McTemplateK0pqddqq @ 0x1C002C8D0
 * Callers:
...
NTSTATUS McTemplateK0pqddqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainAcquire, a3, 7u, &v4);
}
