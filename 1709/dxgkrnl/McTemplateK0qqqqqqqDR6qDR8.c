/*
 * XREFs of McTemplateK0qqqqqqqDR6qDR8 @ 0x1C002AF80
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqDR6qDR8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a13)
{
  ...
  v28 = 4LL;
  v33 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_Process_Present, a3, 0xBu, &v14);
}
