/*
 * XREFs of McTemplateK0pqdqp @ 0x1C002CA7C
 * Callers:
...
NTSTATUS McTemplateK0pqdqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainRelease, a3, 6u, &v4);
}
