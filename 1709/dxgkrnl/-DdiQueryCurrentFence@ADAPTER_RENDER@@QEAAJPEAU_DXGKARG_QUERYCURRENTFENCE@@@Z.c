/*
 * XREFs of ?DdiQueryCurrentFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C0022320
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C0025500 (-ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5015);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYCURRENTFENCE *))(*((_QWORD *)this + 2) + 464LL))(
  ...
  v20 = (_QWORD *)WdLogNewEntry5_WdTrace(v15, v13);
  v20[3] = v14;
  v20[4] = a2->CurrentFence;
  v20[5] = a2->NodeOrdinal;
  EngineOrdinal = a2->EngineOrdinal;
  v20[6] = EngineOrdinal;
  if ( (_DWORD)v14 )
  {
    v22 = WdLogNewEntry5_WdError(EngineOrdinal);
    *(_QWORD *)(v22 + 24) = v14;
    WdLogEvent5_WdError(v22);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v23, &EventProfilerExit, v24, 5015);
