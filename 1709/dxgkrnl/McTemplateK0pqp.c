/*
 * XREFs of McTemplateK0pqp @ 0x1C002CCB0
 * Callers:
...
NTSTATUS McTemplateK0pqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v9, va2);
  v8 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainSurfaceList, a3, 4u, &v4);
}
