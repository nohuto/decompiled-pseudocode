/*
 * XREFs of DpEvalAcpiMethod @ 0x1C0123D50
 * Callers:
        ...
        ULONG OutputBufferLength)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( KeGetCurrentIrql() )
  {
    ...
    {
      v21 = (_QWORD *)WdLogNewEntry5_WdCriticalError(0LL, a2, a3);
      v21[3] = 275LL;
      v21[4] = 21LL;
      v21[5] = -1073741811LL;
  ...
  if ( !*(_BYTE *)(v12 + 1141) )
  {
    ...
    v23 = WdLogNewEntry5_WdWarning(0LL, a2, a3);
  ...
  if ( *a3 != 1634885968 )
  {
    if ( v13 == 543451477 )
    {
      v24 = *(_QWORD *)(a1 + 64);
      *a3 = 1130980673;
      AcpiChildName = (const char *)DpiAcpiGetAcpiChildName(v24, a2);
      if ( !AcpiChildName )
      {
LABEL_22:
        v20 = -1073741810LL;
...
LABEL_51:
    ...
    if ( (int)v10 < 0 )
    {
      v18 = WdLogNewEntry5_WdWarning(v7, v16, v17);
...
LABEL_50:
  ...
  v31 = (struct _KMUTANT *)(v12 + 3272);
  KeWaitForSingleObject((PVOID)(v12 + 3272), Executive, 0, 0, 0LL);
