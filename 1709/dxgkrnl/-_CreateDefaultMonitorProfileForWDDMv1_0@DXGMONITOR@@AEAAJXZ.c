/*
 * XREFs of ?_CreateDefaultMonitorProfileForWDDMv1_0@DXGMONITOR@@AEAAJXZ @ 0x1C0202624
 * Callers:
...
__int64 __fastcall DXGMONITOR::_CreateDefaultMonitorProfileForWDDMv1_0(DXGMONITOR *this)
{
  ...
  *((_QWORD *)&v29 + 1) = 8LL;
  while ( 2 )
  {
    v8 = 0LL;
    v9 = (unsigned int)v7;
    v10 = &word_1C0046440[2 * v7];
    v11 = L"<FHKU";
    do
    {
      memset(&v30, 0, sizeof(v30));
      VideoModeDescriptor = GTF_GetVideoModeDescriptor(*v10, word_1C0046440[2 * v9 + 1], *v11, 1u, 0, &v30);
  ...
  if ( *((DXGMONITOR **)this + 31) != (DXGMONITOR *)((char *)this + 248) )
  {
    v22 = WdLogNewEntry5_WdAssertion(word_1C0046440);
    WdLogEvent5_WdAssertion(v22);
  }
  *((_DWORD *)this + 26) = 3;
LABEL_22:
  *((_DWORD *)this + 6) ^= (*((_DWORD *)this + 6) ^ ((unsigned int)~(_DWORD)v14 >> 28)) & 8;
