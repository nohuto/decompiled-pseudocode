/*
 * XREFs of McTemplateK0qqqqqqqdd @ 0x1C002B08C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqdd(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_Process_Pointer_Shape, a3, 0xAu, &v13);
}
