/*
 * XREFs of ?UnpinDirectFlipAllocationSynchronous@DXGDEVICE@@QEAAJIPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C019E504
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( DXGDEVICE::RemoveDirectFlipAllocationFromList((struct _KTHREAD **)this, a2, (struct DXGALLOCATION *)a3) )
  {
    ...
    if ( IsAllocationInPresentQueue )
    {
      if ( v18 <= 1 )
      {
        v12 = (*(__int64 (__fastcall **)(_QWORD, struct _VIDMM_MULTI_ALLOC *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 528LL)
                                                                                                 + 8LL)
                                                                                     + 696LL))(
