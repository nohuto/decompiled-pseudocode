/*
 * XREFs of ?DdiDestroyDevice@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C00807E4
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyDevice@@YAJPEAVADAPTER_RENDER@@PEAX@Z @ 0x1C0025480 (-ADAPTER_RENDER_DdiDestroyDevice@@YAJPEAVADAPTER_RENDER@@PEAX@Z.c)
...
LABEL_15:
  ...
  v15 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 576LL))(a2);
  if ( v29[0] )
  ...
  *(_QWORD *)(v22 + 32) = a2;
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v25, &EventProfilerExit, v26, 5027);
