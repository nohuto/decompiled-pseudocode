/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1C017CC10
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5077);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1048LL))(
  ...
  *(_QWORD *)(v22 + 24) = v14;
  *(_QWORD *)(v22 + 32) = a2->TargetId;
  WdLogEvent5_WdEvent(v22);
  if ( (_DWORD)v14 != -1073741801 && (_DWORD)v14 != -1071774904 && (_DWORD)v14 )
  {
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v25, &EventProfilerExit, v26, 5077);
