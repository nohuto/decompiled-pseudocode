/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KPEAPEAVDXGKEYEDMUTEX@@PEAIPEAXIU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@@Z @ 0x1C01BF044
 * Callers:
        ...
        struct _D3DKMT_CREATEKEYEDMUTEX2_FLAGS a7)
{
  ...
  if ( !a3 )
  {
    ...
    *(_QWORD *)(v11 + 24) = 3886LL;
    WdLogEvent5_WdAssertion(v11);
  }
  if ( !a4 )
  {
    v12 = WdLogNewEntry5_WdAssertion(this);
    *(_QWORD *)(v12 + 24) = 3887LL;
  ...
  *a4 = 0;
  ...
  DXGFASTMUTEX::Acquire((DXGGLOBAL *)((char *)this + 344));
  v19 = (DXGKEYEDMUTEX **)((char *)this + 384);
  v20 = *((_QWORD *)this + 48);
  if ( *(DXGGLOBAL **)(v20 + 8) != (DXGGLOBAL *)((char *)this + 384) )
    __fastfail(3u);
  *(_QWORD *)v15 = v20;
  *((_QWORD *)v15 + 1) = v19;
  *(_QWORD *)(v20 + 8) = v15;
  *v19 = v15;
  DXGFASTMUTEX::Release((struct _KTHREAD **)this + 43);
