/*
 * XREFs of ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x1C001E44C
 * Callers:
 ...
 *     ?RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z @ 0x1C0028E7C (-RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z.c)
 */
...
void __fastcall DXGADAPTER::CompletePStateTransitionCB(struct _MCGEN_TRACE_CONTEXT *this, int a2, unsigned int a3)
{
  ...
  if ( this[32].EnableBitMask )
  {
    v5 = *(_QWORD *)(520LL
                   * ((unsigned __int16)a2 + (unsigned int)*((unsigned __int16 *)&this[32].EnableKeyWords + HIWORD(a2)))
                   + *(_QWORD *)&this[32].Level
                   + 512);
    if ( bTracingEnabled )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
      {
        Arg1 = (const GUID *)((unsigned __int16)a2
                            + (unsigned int)*((unsigned __int16 *)&this[32].EnableKeyWords + HIWORD(a2)));
        McTemplateK0pqqq(
          this,
