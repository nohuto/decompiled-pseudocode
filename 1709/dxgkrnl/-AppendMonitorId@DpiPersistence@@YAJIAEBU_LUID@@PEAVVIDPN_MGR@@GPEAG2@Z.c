/*
 * XREFs of ?AppendMonitorId@DpiPersistence@@YAJIAEBU_LUID@@PEAVVIDPN_MGR@@GPEAG2@Z @ 0x1C00E211C
 * Callers:
        ...
        STRSAFE_PCNZWCH psz)
{
  ...
  LODWORD(v9) = DpiPersistence::GetMonitorIdFromTargetId(this, (unsigned int)a2, a3, a4, (unsigned __int16)psz, v15);
  if ( (int)v9 < 0 )
  {
  ...
  {
    v10 = RtlStringCchLengthW(psz, v6, pcchLength);
    v9 = v10;
    if ( v10 < 0 )
    {
