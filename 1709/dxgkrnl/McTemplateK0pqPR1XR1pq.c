/*
 * XREFs of McTemplateK0pqPR1XR1pq @ 0x1C0029A20
 * Callers:
...
NTSTATUS McTemplateK0pqPR1XR1pq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventWaitForSynchronizationObjectFromCpu, a3, 7u, &v4);
}
