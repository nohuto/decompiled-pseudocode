/*
 * XREFs of McTemplateK0qqqddt @ 0x1C002ACD0
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqddt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_Process_Pointer_Position, a3, 7u, &v10);
}
