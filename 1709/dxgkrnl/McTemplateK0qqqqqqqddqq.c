/*
 * XREFs of McTemplateK0qqqqqqqddqq @ 0x1C002B17C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqddqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a14)
{
  ...
  v35 = 4LL;
  v37 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_Get_Pointer_Shape_Data, a3, 0xCu, &v15);
}
