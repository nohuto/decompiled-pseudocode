/*
 * XREFs of McTemplateK0pqqqqqqqqqqqq @ 0x1C000D850
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSetDisplayMode, a3, 0xEu, &v4);
}
