/*
 * XREFs of BmlCompareSourceModes @ 0x1C00D4E3C
 * Callers:
 ...
 *     BmlGetPixelFormatPreference @ 0x1C00D4F88 (BmlGetPixelFormatPreference.c)
 ...
 *     ?RegionGreaterThanContentResAllDimension@@YAHAEBU_D3DKMDT_2DREGION@@AEBU_POINTL@@@Z @ 0x1C01F8AE4 (-RegionGreaterThanContentResAllDimension@@YAHAEBU_D3DKMDT_2DREGION@@AEBU_POINTL@@@Z.c)
 *     ?RegionGreaterThanContentResAnyDimension@@YAHAEBU_D3DKMDT_2DREGION@@AEBU_POINTL@@@Z @ 0x1C01F8B14 (-RegionGreaterThanContentResAnyDimension@@YAHAEBU_D3DKMDT_2DREGION@@AEBU_POINTL@@@Z.c)
 */
      ...
      && (*(_DWORD *)(v22 + a1 + 116) & 2) != 0 )
    {
      ...
      if ( (*(_QWORD *)&v24 & 0x20000LL) != 0 )
      {
        ...
        if ( *(_DWORD *)(*(_QWORD *)(v30 + 16) + 276LL) == 1297040209 )
        {
          ...
          {
            if ( (unsigned int)RegionGreaterThanContentResAnyDimension(&v38, v39 + 19) )
            {
        ...
        v34 = RegionGreaterThanContentResAllDimension(&v38, v39 + 19);
