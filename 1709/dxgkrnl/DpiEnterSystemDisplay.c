/*
 * XREFs of DpiEnterSystemDisplay @ 0x1C0011370
 * Callers:
 *     <none>
 * Callees:
...
LABEL_61:
    ...
    {
      v18 = v19;
      if ( !v19 && qword_1C0060A88 && v5 == *(_QWORD *)(qword_1C0060A88 + 64) )
        *(_DWORD *)(a2 + 16) = 1;
      else
        *(_DWORD *)(a2 + 16) = 5;
LABEL_60:
