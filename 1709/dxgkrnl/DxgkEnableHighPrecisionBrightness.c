/*
 * XREFs of DxgkEnableHighPrecisionBrightness @ 0x1C01AE380
 * Callers:
 *     <none>
 * Callees:
 *     ??0AutoResourceLock@@QEAA@PEAU_ERESOURCE@@@Z @ 0x1C00286B0 (--0AutoResourceLock@@QEAA@PEAU_ERESOURCE@@@Z.c)
 *     ?HasRegisteredInternalDisplay@LPMDisplayCtrl@@QEAAHXZ @ 0x1C00286E4 (-HasRegisteredInternalDisplay@LPMDisplayCtrl@@QEAAHXZ.c)
