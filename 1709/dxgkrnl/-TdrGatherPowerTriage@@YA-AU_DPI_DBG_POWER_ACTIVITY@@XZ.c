/*
 * XREFs of ?TdrGatherPowerTriage@@YA?AU_DPI_DBG_POWER_ACTIVITY@@XZ @ 0x1C0027144
 * Callers:
...
__int64 __fastcall TdrGatherPowerTriage(__int64 a1)
{
  ...
  v2 = 0;
  v3 = 0;
  v4 = (_QWORD *)((char *)Global + 440);
  v5 = (_QWORD *)*((_QWORD *)Global + 55);
  while ( v5 != v4 && v5 )
  {
    v6 = v5;
    v5 = (_QWORD *)*v5;
    ...
    {
      if ( (v2 & 1) != 0 || (v8 = 0, v6[290]) )
        v8 = 1;
      v9 = v8 | v2 & 0xFE;
      if ( (v9 & 2) != 0 || (v10 = 0, *((_DWORD *)v6 + 981)) )
        v10 = 2;
      v2 = v10 | v9 & 0xFD;
      LOBYTE(v12) = v2;
    }
