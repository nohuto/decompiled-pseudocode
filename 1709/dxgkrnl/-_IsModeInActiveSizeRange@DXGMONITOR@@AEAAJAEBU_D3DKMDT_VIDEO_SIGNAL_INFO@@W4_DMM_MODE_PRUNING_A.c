/*
 * XREFs of ?_IsModeInActiveSizeRange@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@PEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C0203188
 * Callers:
...
__int64 __fastcall DXGMONITOR::_IsModeInActiveSizeRange(__int64 a1, _DWORD *a2, int a3, char *a4, _DWORD *a5)
{
  ...
  v12 = a1 + 248;
  for ( i = *(_QWORD *)(a1 + 248); ; i = *((_QWORD *)v14 + 6) )
  {
    if ( i == v12 )
      goto LABEL_14;
    v14 = (int *)(i - 48);
