/*
 * XREFs of DpiSriovMitigationUpdate @ 0x1C01E0318
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v7 = a1[8];
  if ( bTracingEnabled )
    VgpuTrace(1, 0, (void *)v7, L"DpiSriovMitigationUpdate", 0LL);
  if ( !a2->RequestorMode || DxgkpCheckProcessForVirtualMachineManagementAccess() )
  {
    if ( a4 >= 2 && a3 && a6 >= 2 && a5 )
    {
      ...
      if ( *(_BYTE *)(v7 + 5108) && !*(_QWORD *)(v7 + 5096) )
      {
        CInterfaceCallContext::CInterfaceCallContext((CInterfaceCallContext *)v19, a1, a2);
        v18 = v20;
        if ( v20 >= 0 )
        {
          KeSetEvent((PRKEVENT)(v7 + 5168), 0, 0);
          *(_QWORD *)(v7 + 5096) = a2;
          a2->Tail.Overlay.CurrentStackLocation->Control |= 1u;
          IoCsqInsertIrp((PIO_CSQ)(v7 + 4992), a2, 0LL);
          v18 = 259;
          v20 = 259;
        }
        v12 = v18;
...
LABEL_21:
  if ( bTracingEnabled )
    VgpuTrace(0, v12, (void *)v7, L"DpiSriovMitigationUpdate", 0LL);
  return v12;
}
