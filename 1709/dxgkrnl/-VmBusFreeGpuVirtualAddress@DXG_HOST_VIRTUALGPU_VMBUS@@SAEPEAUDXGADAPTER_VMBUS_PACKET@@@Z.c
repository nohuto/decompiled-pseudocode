/*
 * XREFs of ?VmBusFreeGpuVirtualAddress@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C01936B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusFreeGpuVirtualAddress(
        ...
        __int64 a3)
{
  ...
  v4 = DxgkFreeGpuVirtualAddress(*((_QWORD *)a1 + 9) + 24LL, a2, a3);
