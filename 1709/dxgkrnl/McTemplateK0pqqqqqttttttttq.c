/*
 * XREFs of McTemplateK0pqqqqqttttttttq @ 0x1C002B574
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqttttttttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v32 = 4LL;
  v34 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOutputDuplicationProcessHighLevel, a3, 0x10u, &v4);
}
