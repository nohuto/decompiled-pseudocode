/*
 * XREFs of ?ReleaseComponentReferencesHelper@DXGGLOBAL@@QEAAXXZ @ 0x1C01AB7D0
 * Callers:
 *     ?CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z @ 0x1C01A9A50 (-CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z.c)
...
void __fastcall DXGGLOBAL::ReleaseComponentReferencesHelper(DXGGLOBAL *this)
{
  ...
  v1 = (volatile signed __int32 **)((char *)this + 440);
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v17, (DXGGLOBAL *)((char *)this + 400));
  ...
  while ( v5 != (volatile signed __int32 *)v1 && v5 )
  {
    ...
    if ( *((_DWORD *)v6 + 756) )
    {
      ...
      if ( (_BYTE)v7 )
      {
        ...
        {
          for ( i = 0; i < *((_DWORD *)v6 + 622); ++i )
          {
            if ( !*(_DWORD *)(520LL * i + *((_QWORD *)v6 + 293) + 208) )
              DXGADAPTER::SetPowerComponentIdleCBInternal((DXGADAPTER *)v6, i, 0);
          }
          _InterlockedDecrement(v6 + 756);
        }
