/*
 * XREFs of ?DpiBrightnessIfGetBacklightReduction@@YAJPEAXPEAU_DXGK_BACKLIGHT_INFO@@@Z @ 0x1C01E3520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfGetBacklightReduction(_QWORD *a1, struct _DXGK_BACKLIGHT_INFO *a2)
{
  ...
  if ( *(_QWORD *)(v2 + 4520) )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGK_BACKLIGHT_INFO *))(v2 + 4568))(*(_QWORD *)(v2 + 4496), a2);
