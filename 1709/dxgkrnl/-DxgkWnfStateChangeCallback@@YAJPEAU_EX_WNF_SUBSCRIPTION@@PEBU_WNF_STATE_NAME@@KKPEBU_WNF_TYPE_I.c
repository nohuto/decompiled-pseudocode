/*
 * XREFs of ?DxgkWnfStateChangeCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C00F6DF0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a6)
{
  ...
  ExReleasePushLockSharedEx((char *)v13 + 904, 0LL);
