/*
 * XREFs of ?NotifyDpc@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C002B908
 * Callers:
 *     DxgNotifyDpcCB @ 0x1C000DAE0 (DxgNotifyDpcCB.c)
 * Callees:
 *     ?UpdateVsyncCount@BLTQUEUE@@QEAAIPEAT_LARGE_INTEGER@@@Z @ 0x1C001D748 (-UpdateVsyncCount@BLTQUEUE@@QEAAIPEAT_LARGE_INTEGER@@@Z.c)
 *     ?PresentDisplayOnlySetProgress@DXGDODPRESENT@@QEAAXPEBU_DXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS@@@Z @ 0x1C002BAEC (-PresentDisplayOnlySetProgress@DXGDODPRESENT@@QEAAXPEBU_DXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS@@.c)
...
void __fastcall DXGDODPRESENT::NotifyDpc(DXGDODPRESENT *this, ADAPTER_DISPLAY **a2)
{
        ...
        v2 = (unsigned int)(v2 + 1) )
  {
    if ( _InterlockedExchange((volatile __int32 *)this + v2 + 4, 0) )
    {
      ...
      ADAPTER_DISPLAY::SignalVerticalBlankEvent(a2[288], (struct DXGADAPTER *)a2, v2, updated);
    }
    if ( (i & 3) != 0 )
    {
      v7.VidPnSourceId = v2;
