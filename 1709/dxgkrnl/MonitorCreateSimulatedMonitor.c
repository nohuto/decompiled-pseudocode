/*
 * XREFs of MonitorCreateSimulatedMonitor @ 0x1C01FDE0C
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a8)
{
  ...
  __int64 v23; // rax
  __int64 v24; // rax
  unsigned __int8 v25; // [rsp+58h] [rbp+10h] BYREF
  ...
  if ( a6 )
    goto LABEL_16;
  v25 = 0;
  IsTargetForcable = DmmIsTargetForcable((__int64)this, v10, &v25, v8);
