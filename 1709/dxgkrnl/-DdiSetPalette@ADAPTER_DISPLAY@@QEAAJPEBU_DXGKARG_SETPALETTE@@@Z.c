/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C017C110
 * Callers:
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 408LL))(
  ...
  v21[3] = v14;
  v21[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
  v21[5] = a2->FirstEntry;
  v21[6] = a2->NumEntries;
  ...
  if ( (_DWORD)v14 )
  {
    v23 = WdLogNewEntry5_WdError(VidPnSourceId);
    *(_QWORD *)(v23 + 24) = v14;
    WdLogEvent5_WdError(v23);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5017);
