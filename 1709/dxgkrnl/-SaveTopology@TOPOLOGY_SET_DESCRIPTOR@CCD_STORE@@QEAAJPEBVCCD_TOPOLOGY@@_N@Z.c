/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C00DA308
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C00FA920 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
        ...
        const struct CCD_TOPOLOGY *a2)
{
  ...
  ULONG v46[3]; // [rsp+4Ch] [rbp-24h] BYREF
  CCD_STORE::TOPOLOGY_SET_DESCRIPTOR *v47; // [rsp+58h] [rbp-18h]
  ...
  if ( *((_WORD *)ModalitySetId + 16) )
  {
    while ( 1 )
    {
      ...
      if ( v10 != v42 )
      {
        ...
        if ( Handle )
          ZwClose(Handle);
        v24 = CcdOpenRegistrySubkey((int)&Handle, 983103, *((_QWORD *)v47 + 8), &pszDest, &v46[1]);
        v25 = v24;
        if ( v24 < 0 )
        {
        ...
        if ( !v41 )
        {
          ...
          if ( (*(_QWORD *)v20 & 0x20000LL) != 0 )
          {
            ...
            {
              *(_DWORD *)(v20 + 96) = *(_DWORD *)(v20 + 156);
              v26 = *(_DWORD *)(v20 + 152);
            }
            else
            {
              *(_DWORD *)(v20 + 96) = *(_DWORD *)(v20 + 152);
              v26 = *(_DWORD *)(v20 + 156);
            }
            *(_DWORD *)(v20 + 100) = v26;
          }
          *(_DWORD *)(v20 + 112) = *(_DWORD *)(v20 + 96) * ((unsigned int)GetBitsPerPixel(*(_DWORD *)(v20 + 116)) >> 3);
          ...
          if ( v27 < 0
            || (*(_DWORD *)(v20 + 96) = v43,
                ...
                *(_DWORD *)(v20 + 112) = v45,
                v46[0] = 3,
                v29 = CcdWriteRegistryValues((int)Handle, 0LL, (__int64)v46),
                v28 = v29,
                v29 < 0) )
          {
            v38 = (_QWORD *)WdLogNewEntry5_WdError(v18);
...
LABEL_44:
      ...
      if ( !g_IsMobileCore
        && (*(_QWORD *)v20 & 0x800000000000LL) != 0
        && IsInternalVideoOutput(*(_DWORD *)(v20 + 88))
        && (v33 & 0x200) != 0 )
      {
        v37 = *(_DWORD *)(v20 + 132);
        *((_DWORD *)DXGGLOBAL::GetGlobal(v34) + 202) = v37;
      }
      if ( ++v5 >= v9[16] )
        goto LABEL_31;
    }
