/*
 * XREFs of ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00D4890
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  __int64 v9; // rcx
  __int64 v10; // rax
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v11; // r15
  DMMVIDPNTARGET *v12; // rax
  __int64 v13; // rcx
  DMMVIDPNTARGET *v14; // rbp
  int v15; // eax
  __int64 v16; // rcx
  __int64 v17; // rcx
  __int64 v18; // rax
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, (__int64)a3, 7050);
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v10 )
    {
      v11 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(*(_QWORD *)(v10 + 48) + 392LL);
      v12 = (DMMVIDPNTARGET *)IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v10 + 312), v6);
      v14 = v12;
      if ( v12 )
      {
        v26 = 0LL;
        v27 = 0LL;
        v15 = DMMVIDPNTARGET::CreateNewCofuncModeSet(v12, &v27);
        v7 = v15;
        if ( v15 < 0 )
        {
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v19, &EventProfilerExit, v20, 7050);
