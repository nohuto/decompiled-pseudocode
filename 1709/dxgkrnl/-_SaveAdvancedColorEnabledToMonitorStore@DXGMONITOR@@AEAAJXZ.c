/*
 * XREFs of ?_SaveAdvancedColorEnabledToMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C02006A0
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveAdvancedColorEnabledToMonitorStore(UNICODE_STRING *this)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v4; // rcx
  ...
  if ( (int)result >= 0 )
  {
    ...
    Data = (LODWORD(this[1].Buffer) >> 11) & 1;
