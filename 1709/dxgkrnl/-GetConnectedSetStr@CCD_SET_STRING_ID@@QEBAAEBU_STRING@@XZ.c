/*
 * XREFs of ?GetConnectedSetStr@CCD_SET_STRING_ID@@QEBAAEBU_STRING@@XZ @ 0x1C00DAD20
 * Callers:
 ...
 *     ?_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z @ 0x1C00DA634 (-_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z.c)
