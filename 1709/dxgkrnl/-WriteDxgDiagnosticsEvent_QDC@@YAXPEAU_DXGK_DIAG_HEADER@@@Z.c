/*
 * XREFs of ?WriteDxgDiagnosticsEvent_QDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00094EC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_QDC(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)a1) + 1568) )
  {
    if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 1u, 0x200000000001uLL) && hProvider > 1u )
    {
      if ( TlgKeywordOn(v2, v3) )
      {
        ...
        v15 = 2;
        v17 = a1;
        TlgWrite(v5, &unk_1C0040A8E, 0LL, v4, 5u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn(v6, v7) )
  {
    ...
    v15 = 2;
    v17 = a1;
    TlgWrite(v9, &unk_1C0040A6C, 0LL, v8, 5u, &pData);
  }
}
