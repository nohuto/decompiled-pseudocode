/*
 * XREFs of ?CapturePresentMultiPlaneOverlayArgs3@@YAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEAU1@PEAPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY3@@PEAPEAU2@PEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3@@PEAPEAUtagRECT@@PEAPEAI6PEAPEAEPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION@@@Z @ 0x1C01CF2A0
 * Callers:
 ...
 *     _CapturePresentMultiPlaneOverlayArgs3_::_2_::_AUTO::__AUTO @ 0x1C01CEE38 (_CapturePresentMultiPlaneOverlayArgs3_--_2_--_AUTO--__AUTO.c)
 */
...
LABEL_8:
      ...
      *(_QWORD *)(v18 + 32) = PsGetCurrentProcess(v21, v20);
      ...
      CapturePresentMultiPlaneOverlayArgs3_::_2_::_AUTO::__AUTO((__int64)v60);
      return v19;
    }
  }
  v31 = Src[0];
