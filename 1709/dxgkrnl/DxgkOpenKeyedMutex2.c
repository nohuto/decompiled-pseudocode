/*
 * XREFs of DxgkOpenKeyedMutex2 @ 0x1C01C1610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenKeyedMutex2(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v19; // rax
  __int64 v20; // rcx
  void *v21[2]; // [rsp+30h] [rbp-38h]
  unsigned int v22[2]; // [rsp+40h] [rbp-28h]
  unsigned int v23; // [rsp+78h] [rbp+10h] BYREF
  struct DXGKEYEDMUTEX *v24; // [rsp+80h] [rbp+18h] BYREF
  struct DXGPROCESS *v25; // [rsp+88h] [rbp+20h]
  ...
  if ( Current )
  {
    ...
    *(_OWORD *)v21 = *(_OWORD *)v9;
    *(_QWORD *)v22 = *(_QWORD *)(v9 + 16);
    v24 = 0LL;
    v23 = 0;
    DXGGLOBAL::GetGlobal(MmUserProbeAddress);
    v13 = DXGGLOBAL::OpenKeyedMutex(v10, (unsigned int)v21[0], &v24, &v23, (char *)v21[1], v22[0]);
    if ( v13 >= 0 )
    {
      v12 = (_DWORD *)(a1 + 4);
    ...
    if ( v13 < 0 )
    {
      v20 = v23;
      if ( v23 )
        DXGKEYEDMUTEX::DestroyHandle(v23, v11);
    }
    else
    {
      v14 = v23;
    ...
    if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q(v20, &EventProfilerExit, (__int64)v12, 2067);
  ...
  else
  {
    ...
    *(_QWORD *)(v6 + 24) = -1073741811LL;
    ...
    if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q(qword_1C005F010, &EventProfilerExit, v7, 2067);
    return 3221225485LL;
  }
}
