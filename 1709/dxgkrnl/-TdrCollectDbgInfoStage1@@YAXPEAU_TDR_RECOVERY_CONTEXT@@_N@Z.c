/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C01A63F0
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C002D6AC (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C002D730 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C002D828 (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C01A5D44 (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
      ...
      if ( v7 )
      {
        ...
        *((_DWORD *)a1 + 36) = 27;
        ...
        if ( v26 )
        {
          ...
          {
            v33 = DXGADAPTER::_DdiCollectDbgInfoNoLocks(*((DXGADAPTER **)a1 + 4), &v98, v32);
          }
          else
          {
            v34 = (DXGADAPTER *)*((_QWORD *)a1 + 4);
            DXGADAPTER::AcquireDdiSync((__int64)v34, 1);
            v33 = DXGADAPTER::_DdiCollectDbgInfoNoLocks(v34, &v98, v35);
        ...
        *((_DWORD *)a1 + 36) = 6;
        ...
        if ( !IsDisplayOnlyTdr && (_DWORD)v96 != 6 )
        {
          ...
          if ( v59 )
          {
            ...
            v61 = v58;
            v62 = (*(__int64 (__fastcall **)(struct _TDR_RECOVERY_CONTEXT *, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2312LL) + 504LL) + 8LL)
                                                                                            + 512LL))(
                    a1,
                    v60,
                    v58);
        ...
        if ( (_DWORD)v66 != 3 && !(unsigned __int8)TdrIsDisplayOnlyTdr(v66) && v56 != 6 )
        {
          ...
          if ( v69 )
          {
            ...
            if ( v71 )
              ...
              v72 = 0LL;
            if ( !(*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2312LL) + 528LL) + 8LL)
                                                                                             + 344LL))(
                    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2312LL) + 536LL),
                    *((unsigned int *)a1 + 14),
                    *((_QWORD *)a1 + 8),
                    v72,
                    v70,
