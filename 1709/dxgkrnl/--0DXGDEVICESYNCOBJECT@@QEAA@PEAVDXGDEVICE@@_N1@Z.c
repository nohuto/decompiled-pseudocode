/*
 * XREFs of ??0DXGDEVICESYNCOBJECT@@QEAA@PEAVDXGDEVICE@@_N1@Z @ 0x1C007AEB0
 * Callers:
  ...
  *((_BYTE *)this + 84) = (4 * a4) | (2 * a3) & 0xFB | v5 & 0xF8;
  if ( a3 )
  {
    ...
    if ( !DXGADAPTER::IsCoreResourceSharedOwner(*(DXGADAPTER **)(*((_QWORD *)a2 + 2) + 16LL)) )
    {
      ...
      *(_QWORD *)(v10 + 24) = 7329LL;
      WdLogEvent5_WdAssertion(v10);
    }
    v11 = (_QWORD *)((char *)a2 + 392);
    v12 = *((_QWORD *)a2 + 49);
    if ( *(struct DXGDEVICE **)(v12 + 8) != (struct DXGDEVICE *)((char *)a2 + 392) )
      __fastfail(3u);
    *(_QWORD *)this = v12;
    *((_QWORD *)this + 1) = v11;
    *(_QWORD *)(v12 + 8) = this;
