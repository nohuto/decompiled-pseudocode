/*
 * XREFs of DxgkGetYieldPercentage @ 0x1C0120970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetYieldPercentage(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v31; // rcx
  __int64 v32; // r8
  _BYTE v33[16]; // [rsp+28h] [rbp-40h] BYREF
  ...
  if ( CheckTokenForResourceManagerAccess() )
  {
    ...
    if ( *v7 >= 0x10u )
    {
      ...
      if ( HIDWORD(v35) )
      {
        ...
        *(_QWORD *)(v30 + 24) = -1073741811LL;
        ...
        if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
          McTemplateK0q(v31, &EventProfilerExit, v32, 2142);
        return 3221225485LL;
      }
      else
      {
        ...
        v20 = ((unsigned __int8)v36 ^ (unsigned __int8)*((_DWORD *)v19 + 389)) & 1 ^ v36;
        LODWORD(v36) = v20;
        v21 = *((_DWORD *)v19 + 386);
        HIDWORD(v36) = v21;
        ...
        *v23 = v20;
        ...
        if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
          McTemplateK0q(v24, &EventProfilerExit, v25, 2142);
        return 0LL;
      }
    }
    else
    {
      ...
      *(_QWORD *)(v9 + 24) = 3937LL;
      ...
      if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q(v10, &EventProfilerExit, v11, 2142);
      return 3221225485LL;
    }
  }
  else
  {
    ...
    *(_QWORD *)(v26 + 32) = -1073741790LL;
    ...
    if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q(qword_1C005F010, &EventProfilerExit, v29, 2142);
    return 3221225506LL;
  }
}
