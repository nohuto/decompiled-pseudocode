/*
 * XREFs of ?DdiCreateVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEVIRTUALGPU@@@Z @ 0x1C018AA68
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5100);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                          + 64LL))(
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v22, &EventProfilerExit, v23, 5100);
