/*
 * XREFs of McTemplateK0qqqddddddddddddqqqqqq @ 0x1C00263A0
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqddddddddddddqqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a24)
{
  ...
  v65 = 4LL;
  v67 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCheckMultiPlaneOverlaySupportPlane, a3, 0x16u, &v25);
}
