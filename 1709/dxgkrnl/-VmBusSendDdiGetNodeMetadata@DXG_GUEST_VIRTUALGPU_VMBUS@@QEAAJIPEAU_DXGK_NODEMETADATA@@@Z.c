/*
 * XREFs of ?VmBusSendDdiGetNodeMetadata@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIPEAU_DXGK_NODEMETADATA@@@Z @ 0x1C0195F50
 * Callers:
        ...
        struct _DXGK_NODEMETADATA *a3)
{
  ...
  v18 = 44;
  v14 = 80;
  if ( VmBusSendSyncMessage(v3, (struct DXGKVMB_COMMAND_BASE *)&v15, 0x20u, v20, &v14, v13) < 0 || v14 < 0x50 )
  {
    v6 = -1073741823;
  }
  else
