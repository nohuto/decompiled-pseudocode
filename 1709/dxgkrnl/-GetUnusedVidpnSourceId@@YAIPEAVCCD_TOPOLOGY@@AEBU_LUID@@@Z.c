/*
 * XREFs of ?GetUnusedVidpnSourceId@@YAIPEAVCCD_TOPOLOGY@@AEBU_LUID@@@Z @ 0x1C01C43F0
 * Callers:
...
__int64 __fastcall GetUnusedVidpnSourceId(struct CCD_TOPOLOGY *this, const struct _LUID *a2)
{
  ...
  struct D3DKMT_GETPATHSMODALITY *v22[8]; // [rsp+20h] [rbp-68h] BYREF
  __int64 v23; // [rsp+60h] [rbp-28h]
  int v24; // [rsp+74h] [rbp-14h]
