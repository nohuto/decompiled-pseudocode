/*
 * XREFs of ??0DMMVIDPNSOURCE@@QEAA@QEAVDMMVIDPNSOURCESET@@QEAVDMMVIDEOPRESENTSOURCE@@@Z @ 0x1C000A97C
 * Callers:
        ...
        struct DMMVIDEOPRESENTSOURCE *const a3)
{
  ...
  *((_DWORD *)this + 22) = 1;
  ...
  {
    v8[2] = 0;
    *(_QWORD *)v8 = &DoublyLinkedList<DMMVIDPNSOURCEMODESET,DoubleLinkedListElementDeleter<DMMVIDPNSOURCEMODESET>>::`vftable';
    *((_QWORD *)v8 + 4) = 0LL;
    *((_QWORD *)v8 + 3) = v8 + 4;
    *((_QWORD *)v8 + 2) = v8 + 4;
    v8[10] = 2;
