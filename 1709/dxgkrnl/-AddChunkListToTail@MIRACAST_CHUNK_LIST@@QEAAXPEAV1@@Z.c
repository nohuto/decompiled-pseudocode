/*
 * XREFs of ?AddChunkListToTail@MIRACAST_CHUNK_LIST@@QEAAXPEAV1@@Z @ 0x1C002E8C0
 * Callers:
 *     ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x1C002EAD0 (-MiracastProcessPendingDPCChunks@@YAEPEAX@Z.c)
 *     DpiMiracastMoveChunkList @ 0x1C002F8B0 (DpiMiracastMoveChunkList.c)
 * Callees:
 *     <none>
 */
...
void __fastcall MIRACAST_CHUNK_LIST::AddChunkListToTail(MIRACAST_CHUNK_LIST *this, struct MIRACAST_CHUNK_LIST *a2)
{
  ...
  {
    if ( v2[1] != a2 || (v3 = (struct MIRACAST_CHUNK_LIST **)*((_QWORD *)a2 + 1), *v3 != a2) )
      __fastfail(3u);
    ...
    *(_QWORD *)a2 = a2;
    ...
    if ( *(MIRACAST_CHUNK_LIST **)(*(_QWORD *)this + 8LL) != this || *v4 != this )
      __fastfail(3u);
    if ( *((struct MIRACAST_CHUNK_LIST ***)*v2 + 1) != v2 || *(struct MIRACAST_CHUNK_LIST ***)v2[1] != v2 )
      __fastfail(3u);
