/*
 * XREFs of ?GetRequestedPathsModality@@YAJIHPEAU_QDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C00E0E70
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  ...
  __int64 v21; // rax
  __int64 v22; // rax
  struct D3DKMT_GETPATHSMODALITY *v23[8]; // [rsp+20h] [rbp-88h] BYREF
  ...
  if ( !*((_DWORD *)a3 + 1) )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, a2) + 24) = 1281LL;
    return 3221225507LL;
  }
  v8 = a1 & 0x200000;
  if ( (a1 & 0x200000) != 0 )
  {
    ...
    DisplayConfigBufferSizes = DxgkGetDisplayConfigBufferSizes(v16, &v25);
