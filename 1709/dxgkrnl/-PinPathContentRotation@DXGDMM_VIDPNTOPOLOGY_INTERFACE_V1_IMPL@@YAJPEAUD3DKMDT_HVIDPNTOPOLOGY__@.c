/*
 * XREFs of ?PinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C00D3210
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a5)
{
        ...
        else
        {
          ...
          if ( v21 < 0 )
          {
            ...
            if ( v17 == D3DKMDT_VPPR_UNPINNED )
              v32 = DMMVIDPNPRESENTPATH::UnpinContentRotation(v16);
            else
              v32 = DMMVIDPNPRESENTPATH::PinContentRotation(v16, v17);
            if ( v32 < 0 )
            {
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v23, &EventProfilerExit, v24, 6028);
