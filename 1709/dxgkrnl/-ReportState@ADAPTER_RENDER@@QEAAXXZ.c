/*
 * XREFs of ?ReportState@ADAPTER_RENDER@@QEAAXXZ @ 0x1C01779BC
 * Callers:
 *     ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C01723C0 (-ReportState@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0016710 (_guard_dispatch_icall_nop.c)
 *     ?ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ @ 0x1C019CA00 (-ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ.c)
...
void __fastcall ADAPTER_RENDER::ReportState(ADAPTER_RENDER *this)
{
  ...
  {
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 66) + 8LL) + 48LL))(*((_QWORD *)this + 67));
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 63) + 8LL) + 56LL))(*((_QWORD *)this + 64));
  }
}
