/*
 * XREFs of ?CheckOwnership@DXGDISPLAYMANAGEROBJECT@@SAJU_LUID@@IPEAX@Z @ 0x1C00E89D0
 * Callers:
 ...
 *     ?IsValid@DXGDISPLAYMANAGERSOURCEOBJECT@@QEBA_NXZ @ 0x1C01D9B18 (-IsValid@DXGDISPLAYMANAGERSOURCEOBJECT@@QEBA_NXZ.c)
 */
  ...
  if ( v6 )
  {
    ...
    else
    {
      for ( i = 0; ; ++i )
      {
        ...
        v28 = (ReferenceCounted *)&v30;
        v16 = DmmDoForSpecifiedTarget__lambda_babeb6617360c1278b0dac3884c10b63_(v10, v36, &v28);
        if ( v16 < 0 )
          break;
        v28 = v30;
        if ( Handle )
