/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C00EFC30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a3)
{
  ...
  *(_QWORD *)(v5 + 32) = this;
  ...
  if ( *(DXGK_VIDPN_INTERFACE_V1_IMPL **)(v12 + 72) == v9 )
  {
    ...
    if ( v10 == *(struct D3DKMDT_HVIDPN__ **)(v11 + 112) )
    {
...
LABEL_20:
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)v13, &EventProfilerExit, v7, 7049);
  return v8;
}
