/*
 * XREFs of ?DdiDestroyProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAX@Z @ 0x1C017A0D0
 * Callers:
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 1136LL))(
  ...
  *(_QWORD *)(v22 + 24) = v14;
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v25, &EventProfilerExit, v26, 5109);
