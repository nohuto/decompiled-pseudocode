/*
 * XREFs of DpiLdaStartAdapterInChain @ 0x1C01E8334
 * Callers:
...
LABEL_3:
  ...
  v11 = *(unsigned int *)(v13 + 2600);
  if ( (_DWORD)v11 != *(_DWORD *)(v13 + 504) )
    goto LABEL_3;
  v10 = 0LL;
  *(_BYTE *)(v13 + 2604) = 0;
  if ( (_DWORD)v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v12 + 236) - 1) > 1 )
        goto LABEL_3;
      v19 = *(_BYTE *)(v13 + 2604) || *(_DWORD *)(v13 + 1108) != *(_DWORD *)(v12 + 1108);
...
LABEL_16:
  ...
  if ( (unsigned int)v11 > 1 )
  {
    do
    {
      v21 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v13 + 2592) + 8LL * v20) + 64LL);
      if ( *(_DWORD *)(v21 + 236) == 1 )
      {
...
LABEL_23:
    ...
    while ( v20 < *(_DWORD *)(v13 + 2600) );
  }
  started = DpiFdoStartAdapter(*(struct _DEVICE_OBJECT **)(v13 + 24), v9, a3, a4, a5, a6);
  if ( started < 0 )
  {
    v22 = *(struct _DEVICE_OBJECT **)(v13 + 152);
    goto LABEL_23;
  }
  return (unsigned int)started;
}
