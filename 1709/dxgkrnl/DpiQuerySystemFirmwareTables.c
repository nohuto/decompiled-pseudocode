/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C0120ED4
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C0120E60 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C01E0A30 (DpiEnumSystemFirmwareTables.c)
 * Callees:
