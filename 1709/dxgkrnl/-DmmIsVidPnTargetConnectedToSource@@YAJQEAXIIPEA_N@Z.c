/*
 * XREFs of ?DmmIsVidPnTargetConnectedToSource@@YAJQEAXIIPEA_N@Z @ 0x1C01ED848
 * Callers:
...
LABEL_5:
  ...
  if ( v15 )
  {
    ...
    auto_rc<DMMVIDPN const>::reset(&v21, v18);
    if ( v21 )
    {
      *a4 = (unsigned int)DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v21 + 96), a3) == a2;
      auto_rc<DMMVIDPN const>::reset(&v21, 0LL);
    }
    else
    {
      *(_QWORD *)(WdLogNewEntry5_WdTrace(0LL, v19) + 24) = a1;
      auto_rc<DMMVIDPN const>::reset(&v21, 0LL);
      v4 = -1071774884;
    }
    DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v20[0] + 40LL));
    return v4;
  }
  else
  {
