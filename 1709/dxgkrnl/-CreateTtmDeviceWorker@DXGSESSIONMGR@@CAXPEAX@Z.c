/*
 * XREFs of ?CreateTtmDeviceWorker@DXGSESSIONMGR@@CAXPEAX@Z @ 0x1C01218F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DXGSESSIONMGR::CreateTtmDeviceWorker(CTTMDEVICE *this)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v11, (struct DXGFASTMUTEX *const)v2);
  ...
  *(_QWORD *)(v2 + 160) = KeGetCurrentThread();
  ...
  else
  {
    ...
    *(_QWORD *)(v2 + 176) = this;
    ...
    {
      v13 = 0;
      CPROCESSATTACHHELPER::Attach(&ApcState, *(PRKPROCESS *)(v5 + 18592));
