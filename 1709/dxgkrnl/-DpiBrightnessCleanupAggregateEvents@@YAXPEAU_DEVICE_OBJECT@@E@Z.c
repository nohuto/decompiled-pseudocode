/*
 * XREFs of ?DpiBrightnessCleanupAggregateEvents@@YAXPEAU_DEVICE_OBJECT@@E@Z @ 0x1C01E2FF8
 * Callers:
...
void __fastcall DpiBrightnessCleanupAggregateEvents(struct _DEVICE_OBJECT *a1, char a2)
{
  ...
  do
  {
    if ( *(_QWORD *)&DeviceExtension[v4 + 4208] )
    {
      EADeleteAggregateEvent();
      if ( DeviceExtension[v4 + 4200] )
        v3 = 1;
      DeviceExtension[v4 + 4200] = 0;
      *(_QWORD *)&DeviceExtension[v4 + 4208] = 0LL;
    }
    v4 += 24LL;
    --v7;
  }
