/*
 * XREFs of ?DdiResetFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C017BC60
 * Callers:
...
LABEL_15:
  ...
  v13 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 432LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 240LL));
  if ( v27[0] )
  ...
  *(_QWORD *)(v21 + 32) = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5020);
