/*
 * XREFs of _lambda_593c7b7db45d2905858a3969fb7431d6_::_lambda_invoker_cdecl_ @ 0x1C008F740
 * Callers:
        ...
        PERESOURCE *a2)
{
  ...
  v8 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v6) + 73);
  if ( !v8
