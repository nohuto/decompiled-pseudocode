/*
 * XREFs of McTemplateK0pqddqqqqq @ 0x1C002C990
 * Callers:
...
NTSTATUS McTemplateK0pqddqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 0xAu, &v4);
}
