/*
 * XREFs of McTemplateK0qqqqqqqttQ3 @ 0x1C0024354
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqttQ3(
        __int64 a1,
        ...
        __int64 a13)
{
  ...
  v32 = 4LL;
  v34 = 12LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 0xBu, &v14);
}
