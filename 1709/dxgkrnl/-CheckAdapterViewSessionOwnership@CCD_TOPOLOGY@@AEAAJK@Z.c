/*
 * XREFs of ?CheckAdapterViewSessionOwnership@CCD_TOPOLOGY@@AEAAJK@Z @ 0x1C00DE704
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::CheckAdapterViewSessionOwnership(CCD_TOPOLOGY *this, unsigned int a2)
{
  ...
  if ( SessionDataForSpecifiedSession )
  {
    ...
    SessionAdapterFromLuid = DXGSESSIONDATA::GetSessionAdapterFromLuid(
                               ...
                               (const struct _LUID *)(224 * v2 + *(_QWORD *)(*((_QWORD *)this + 8) + 40LL)));
    if ( SessionAdapterFromLuid )
    {
      ...
      for ( i = 0; v13; v13 >>= 1 )
      {
        if ( (v13 & 1) != 0 && !SESSION_ADAPTER::GetDisplaySource(SessionAdapterFromLuid, i) )
        {
          ...
          v21[4] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + v9);
          v21[5] = i;
          v21[6] = (unsigned int)PsGetCurrentProcessSessionId(i);
          v21[7] = -1073741790LL;
          WdLogEvent5_WdError(v21);
          *(_DWORD *)(v9 + *(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 80) = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL)
                                                                                       + v9
                                                                                       + 80) & ~(1 << i);
    ...
    else
    {
      ...
      v19[3] = *(int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + v9 + 4);
      v20 = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 224 * v2);
      v19[4] = v20;
