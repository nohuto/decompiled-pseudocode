/*
 * XREFs of DpiReportAdapter @ 0x1C011A830
 * Callers:
 ...
 *     __chkstk_0 @ 0x1C00165FF (__chkstk_0.c)
...
void __fastcall DpiReportAdapter(__int64 a1, __int64 a2)
{
  ...
  __int64 v11; // rbx
  _OWORD *v12; // rax
  __int64 (__fastcall *v13)(_QWORD, _QWORD, _DWORD *, _QWORD, unsigned int); // rax
  __int64 v14; // rdx
  __int64 v15; // rdx
  _OWORD *v16; // rcx
  __int128 v17; // xmm1
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( PoolWithTag )
    {
      if ( *(_DWORD *)(v3 + 2600) )
      {
        ...
        do
        {
          PoolWithTag[v20] = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 2592) + 8 * v20) + 64LL);
          v20 = (unsigned int)(v20 + 1);
        }
        while ( (unsigned int)v20 < *(_DWORD *)(v3 + 2600) );
      }
      else
      {
        *PoolWithTag = v3;
      ...
      do
      {
        ...
        v11 = *v8;
        v31[1025] = *(_DWORD *)(*v8 + 500LL);
        v31[1026] = *(_DWORD *)(v11 + 504);
        LOBYTE(v31[1027]) = *(_BYTE *)(v11 + 508);
        v12 = (_OWORD *)(v11 + 1096);
        if ( *(_QWORD *)(v11 + 1096) )
        {
          v15 = 2LL;
        ...
        v13 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _DWORD *, _QWORD, unsigned int))(v11 + 616);
        if ( v13 )
        {
          v18 = v13(*(_QWORD *)(v11 + 568), 0LL, &v31[v9], v9 * 4, 4096 - v9 * 4);
          v14 = (unsigned int)(v18 + v31[1024]);
        }
        else
        {
          v14 = 0LL;
        ...
        if ( bTracingEnabled )
        {
          ...
          {
            LODWORD(v30) = *(_DWORD *)(v11 + 1124);
            LODWORD(v29) = *(_DWORD *)(v11 + 1120);
            LODWORD(v28) = *(_DWORD *)(v11 + 1116);
            LODWORD(v27) = *(_DWORD *)(v11 + 1112);
            LODWORD(v26) = *(_DWORD *)(v11 + 1108);
            LODWORD(v25) = *(_DWORD *)(v11 + 1104);
    ...
    {
      v19 = WdLogNewEntry5_WdLowResource(v6);
