/*
 * XREFs of SupportedPixelRate @ 0x1C0202E94
 * Callers:
...
char __fastcall SupportedPixelRate(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    v9 = *(_DWORD *)(a1 + 16);
    if ( (unsigned __int64)(unsigned int)(v9 * *(_DWORD *)(a1 + 12) * (*(_DWORD *)(a1 + 20) / *(_DWORD *)(a1 + 24))) > *(_QWORD *)(a2 + 40) )
      return 0;
    v10 = *(_DWORD *)(a1 + 20) / *(_DWORD *)(a1 + 24);
    if ( v10 - *(_DWORD *)(a2 + 4) / *(_DWORD *)(a2 + 8) < 0
      || v10 - *(_DWORD *)(a2 + 12) / *(_DWORD *)(a2 + 16) > 0 && v10 - 61 > 0 )
    {
      return 0;
    }
    v11 = v9 * (unsigned int)*(_QWORD *)(a1 + 20) / (unsigned int)HIDWORD(*(_QWORD *)(a1 + 20));
    if ( (int)(v11 - *(_DWORD *)(a2 + 20) / *(_DWORD *)(a2 + 24)) < 0 && v10 - 60 < 0 )
      return 0;
    if ( (int)(v11 - *(_DWORD *)(a2 + 28) / *(_DWORD *)(a2 + 32)) > 0 && v10 - 61 > 0 )
      return 0;
  }
  return 1;
}
