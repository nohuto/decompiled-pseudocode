/*
 * XREFs of McTemplateK0pqqqqqqq @ 0x1C002427C
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 9u, &v4);
}
