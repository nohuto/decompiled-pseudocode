/*
 * XREFs of ?TranslateAndCopyDWMMoveRegionToDDAMoveRegions@@YAXKPEBU_D3DKMT_MOVE_RECT@@PEAU1@@Z @ 0x1C01B7EC4
 * Callers:
        ...
        struct _D3DKMT_MOVE_RECT *a3)
{
  ...
  if ( a1 )
  {
    ...
    do
    {
      ...
      p_DestRect->left = *(p_top - 1) + *(_DWORD *)((char *)p_DestRect + v4 - 8);
