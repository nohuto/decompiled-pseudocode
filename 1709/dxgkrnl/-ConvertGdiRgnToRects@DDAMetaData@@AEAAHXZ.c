/*
 * XREFs of ?ConvertGdiRgnToRects@DDAMetaData@@AEAAHXZ @ 0x1C01CBAC0
 * Callers:
...
__int64 __fastcall DDAMetaData::ConvertGdiRgnToRects(DDAMetaData *this)
{
  ...
  {
    Buffer = AUTOEXPANDALLOCATION::GetBuffer(*((PVOID **)this + 4), v2, 0);
    if ( !(*(unsigned int (__fastcall **)(_QWORD, _QWORD, PVOID))(*((_QWORD *)this + 7) + 112LL))(
            *((_QWORD *)this + 8),
            v3,
            Buffer) )
    {
