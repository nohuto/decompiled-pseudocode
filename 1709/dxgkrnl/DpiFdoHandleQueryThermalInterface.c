/*
 * XREFs of DpiFdoHandleQueryThermalInterface @ 0x1C01E44A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  if ( Src[5] || Src[6] )
  {
    ...
    *PoolWithTag = 0;
    *(_BYTE *)(*(_QWORD *)(v4 + 4656) + 1LL) = 0;
    *(_BYTE *)(*(_QWORD *)(v4 + 4656) + 2LL) = 0;
    *(_DWORD *)(*(_QWORD *)(v4 + 4656) + 4LL) = 100;
    memmove((void *)(*(_QWORD *)(v4 + 4656) + 8LL), Src, 0x38uLL);
LABEL_20:
    memmove(a4, &unk_1C005FBF0, 0x38uLL);
    a4[1] = Object;
    if ( !*(_QWORD *)(*(_QWORD *)(v4 + 4656) + 48LL) )
      a4[5] = 0LL;
    if ( !*(_QWORD *)(*(_QWORD *)(v4 + 4656) + 56LL) )
      a4[6] = 0LL;
