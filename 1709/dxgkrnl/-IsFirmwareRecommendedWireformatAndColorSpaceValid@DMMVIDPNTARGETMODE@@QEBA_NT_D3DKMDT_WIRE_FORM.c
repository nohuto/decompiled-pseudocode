/*
 * XREFs of ?IsFirmwareRecommendedWireformatAndColorSpaceValid@DMMVIDPNTARGETMODE@@QEBA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@W4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x1C0035840
 * Callers:
        ...
        enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE a3)
{
  ...
  if ( ((v3 - 1) & v3) == 0 && (*((_DWORD *)this + 32) & v3) != 0 )
  {
    ...
    if ( (a3 == D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G22_P709
       || a3 == D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G2084_P2020
       || *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)this) + 1568) && a3 == D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G22_P2020)
      && v5 <= 0x20 )
    {
      v6 = 0x100010116LL;
      if ( _bittest64(&v6, v5) )
