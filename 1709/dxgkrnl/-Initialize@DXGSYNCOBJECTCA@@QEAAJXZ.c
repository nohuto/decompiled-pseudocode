/*
 * XREFs of ?Initialize@DXGSYNCOBJECTCA@@QEAAJXZ @ 0x1C01BF9E4
 * Callers:
...
__int64 __fastcall DXGSYNCOBJECTCA::Initialize(DXGSYNCOBJECTCA *this)
{
  ...
  *((_QWORD *)this + 33) = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    v6[1] = v6;
    *v6 = v6;
    KeInitializeSpinLock((PKSPIN_LOCK)(*((_QWORD *)this + 33) + 8LL));
    _InterlockedIncrement(*((volatile signed __int32 **)this + 33));
    *(_QWORD *)(*((_QWORD *)this + 33) + 40LL) = *((_QWORD *)this + 21);
    *(_QWORD *)(*((_QWORD *)this + 33) + 32LL) = *(_QWORD *)(*((_QWORD *)this + 33) + 40LL);
    return 0LL;
  }
  else
  {
