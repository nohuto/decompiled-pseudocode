/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C000CF44
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_MGR(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 1u, 0x200000000020uLL) && hProvider > 1u )
    {
      if ( TlgKeywordOn(v2, v3) )
      {
        ...
        v15 = 2;
        v17 = a1;
        TlgWrite(v5, &unk_1C0040A42, 0LL, v4, 5u, &pData);
      }
    }
  }
  else if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000020uLL)
         && hProvider > 4u
         && TlgKeywordOn(v6, v7) )
  {
    v13 = 0;
    ...
    v15 = 2;
    v17 = a1;
    TlgWrite(v9, &unk_1C0040A18, 0LL, v8, 5u, &pData);
  }
}
