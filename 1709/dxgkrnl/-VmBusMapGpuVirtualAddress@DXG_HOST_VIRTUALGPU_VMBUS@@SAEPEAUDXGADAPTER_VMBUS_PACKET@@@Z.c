/*
 * XREFs of ?VmBusMapGpuVirtualAddress@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0193E30
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusMapGpuVirtualAddress(
...
LABEL_30:
  ...
  if ( (_DWORD)v5 )
  {
    ...
    DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v31, *(_DWORD *)(v3 + 128), Current, &v30);
    v10 = v30;
    if ( *(_DWORD *)(v3 + 128) && !v30 )
    {
      LODWORD(v37) = -1073741811;
      v11 = WdLogNewEntry5_WdAssertion(v9);
      *(_QWORD *)(v11 + 24) = (int)v37;
      *(_QWORD *)(v11 + 32) = *(unsigned int *)(v3 + 128);
...
LABEL_9:
    ...
    if ( (v13 & 4) == 0 && (v13 & 8) == 0 )
    {
      ...
      v17 = (v16 >> 6) & 0xFFFFFF;
      if ( (unsigned int)v17 < *(_DWORD *)(v15 + 240)
        && (v18 = *(_QWORD *)(v15 + 224),
...
LABEL_21:
    ...
    LOBYTE(v29) = 0;
    LODWORD(v37) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, int, _DWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v10 + 2) + 528LL) + 8LL)
                                                                                            + 792LL))(
                     *(_QWORD *)(*((_QWORD *)v10 + 2) + 536LL),
                     0LL,
                     v14,
                     v3 + 24,
                     v29,
  ...
  {
    v26 = DxgkMapGpuVirtualAddress(v3 + 24, v5, a3);
    LODWORD(v37) = v26;
  }
  v36 = *(_QWORD *)(v3 + 120);
  v27 = *(_QWORD *)(v3 + 112);
...
LABEL_31:
  VmBusCompletePacket(*((struct VMBPACKETCOMPLETION__ **)a1 + 8), &v35, 0x18u);
  return 1;
}
