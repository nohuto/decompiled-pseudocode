/*
 * XREFs of ?DestroyFormattingBuffer@ADAPTER_RENDER@@QEAAXXZ @ 0x1C0021768
 * Callers:
...
void __fastcall ADAPTER_RENDER::DestroyFormattingBuffer(ADAPTER_RENDER *this)
{
  ...
  v1 = (void *)*((_QWORD *)this + 122);
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 123, &LockHandle);
  *((_QWORD *)this + 122) = 0LL;
