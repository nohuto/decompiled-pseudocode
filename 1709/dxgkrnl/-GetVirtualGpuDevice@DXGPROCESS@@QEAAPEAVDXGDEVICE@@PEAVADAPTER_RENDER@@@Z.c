/*
 * XREFs of ?GetVirtualGpuDevice@DXGPROCESS@@QEAAPEAVDXGDEVICE@@PEAVADAPTER_RENDER@@@Z @ 0x1C01B9BEC
 * Callers:
...
struct DXGDEVICE *__fastcall DXGPROCESS::GetVirtualGpuDevice(DXGPROCESS *this, struct ADAPTER_RENDER *a2)
{
  ...
  v5 = *(_QWORD *)(*((_QWORD *)this + 5) + 8LL * v2[50]);
  if ( !v5 )
  {
...
LABEL_3:
  ...
  if ( !*(_QWORD *)(v5 + 40) )
  {
    Device = ADAPTER_RENDER::CreateDevice(*(DXGADAPTER ***)(v5 + 48), v13, 0, 1, 0LL, 0, 0, 0LL);
    v10 = Device;
    if ( Device < 0 )
      goto LABEL_3;
  }
