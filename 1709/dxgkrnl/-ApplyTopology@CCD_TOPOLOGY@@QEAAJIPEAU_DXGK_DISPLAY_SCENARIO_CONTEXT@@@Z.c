/*
 * XREFs of ?ApplyTopology@CCD_TOPOLOGY@@QEAAJIPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00DBCCC
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  int v26; // eax
  __int64 v27; // rax
  struct D3DKMT_GETPATHSMODALITY *v28[8]; // [rsp+20h] [rbp-60h] BYREF
  ...
  {
    active = CCD_TOPOLOGY::AddActiveHMDPathsToTopology(this, (struct CCD_TOPOLOGY *)v28);
    v9 = active;
    if ( active < 0 )
      goto LABEL_30;
    if ( active == 255 )
  ...
  if ( v15 < 0 )
    goto LABEL_30;
  v30 = 0;
  CCD_TOPOLOGY::RemoveAllHMDPaths((CCD_TOPOLOGY *)v28, &v30);
  if ( !v30 )
  {
  ...
  for ( i = 0;
        i < *(_DWORD *)(v20 + 36);
        *(_DWORD *)(v25 + *(_QWORD *)(v20 + 40) + 76) &= ~*(_DWORD *)(224 * v24 + *(_QWORD *)(v20 + 40) + 220) )
  {
    v24 = i++;
    v25 = 224 * v24;
    *(_DWORD *)(v25 + *(_QWORD *)(v20 + 40) + 80) &= ~*(_DWORD *)(224 * v24 + *(_QWORD *)(v20 + 40) + 220);
  }
