/*
 * XREFs of ?DpiAcpiEventCallback@@YAXPEAXK@Z @ 0x1C0032EA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DpiAcpiEventCallback(PDEVICE_OBJECT DeviceObject, unsigned int a2, __int64 a3)
{
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0q((__int64)DeviceObject, &EventACPIEvent, a3, a2);
  DpiAcpiCallAcpiEventHandler(DeviceObject, 1u, a2, 0LL);
}
