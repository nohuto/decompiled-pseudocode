/*
 * XREFs of ?DdiCreateOverlay@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEOVERLAY@@@Z @ 0x1C01794B8
 * Callers:
...
LABEL_15:
  ...
  v22[3] = v14;
  v22[4] = a2->OverlayInfo.hAllocation;
  v22[5] = a2->hOverlay;
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v25, &EventProfilerExit, v26, 5032);
