/*
 * XREFs of ?DxgkCddMakeResident@@YAJIEPEAUD3DDDI_MAKERESIDENT@@@Z @ 0x1C00BC580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddMakeResident(__int64 a1, __int64 a2, struct D3DDDI_MAKERESIDENT *a3)
{
  __int64 v4; // rsi
  ...
  {
LABEL_2:
    ResidentInternal = DxgkMakeResidentInternal(a3, 0, (__int64)a3);
    goto LABEL_3;
  }
