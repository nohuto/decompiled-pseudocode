/*
 * XREFs of McTemplateK0pqqqxx @ 0x1C0020914
 * Callers:
...
NTSTATUS McTemplateK0pqqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_PowerComponentIdleState, a3, 7u, &v4);
}
