/*
 * XREFs of ?RemoveCloneGroupByModality@CCD_TOPOLOGY@@QEAAJAEBU_LUID@@I@Z @ 0x1C01F79D8
 * Callers:
...
LABEL_12:
    ...
    {
      if ( v4 != *(_DWORD *)(264LL * i + v10 + 232) )
      {
        if ( v5 != i )
          CCD_TOPOLOGY::SwapPathsDescriptors(this, i, v5);
        ++v5;
      }
      v10 = *((_QWORD *)this + 8);
    }
