/*
 * XREFs of ?AddPrimaryAllocation@DXGDEVICE@@QEAAJPEBVDXGALLOCATION@@@Z @ 0x1C00951D4
 * Callers:
...
__int64 __fastcall DXGDEVICE::AddPrimaryAllocation(DXGADAPTER **this, const struct DXGALLOCATION *a2)
{
  ...
  if ( DXGDEVICE::InsertPrimaryAllocation(this, v5, a2, &v17) )
  {
    ...
    if ( (*((_DWORD *)a2 + 18) & 0x800) != 0 )
      return 0LL;
    result = VIDMM_EXPORT::VidMmPinAllocation(v10[66], v10[67], *((struct _VIDMM_MULTI_ALLOC **)a2 + 3), 0LL, 0LL);
    if ( (int)result >= 0 )
      return 0LL;
  }
  else
