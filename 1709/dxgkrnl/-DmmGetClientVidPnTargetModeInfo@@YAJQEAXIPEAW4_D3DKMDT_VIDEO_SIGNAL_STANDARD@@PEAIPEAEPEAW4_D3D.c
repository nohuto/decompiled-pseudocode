/*
 * XREFs of ?DmmGetClientVidPnTargetModeInfo@@YAJQEAXIPEAW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@PEAIPEAEPEAW4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@PEAU_D3DKMDT_2DREGION@@PEAU_D3DDDI_RATIONAL@@@Z @ 0x1C01EBEFC
 * Callers:
        ...
        struct _D3DDDI_RATIONAL *a8)
{
  ...
  __int64 v33; // rdi
  __int64 v34; // rax
  const struct _D3DKMDT_VIDEO_SIGNAL_INFO *v35; // rcx
...
LABEL_15:
  ...
  if ( v20 )
  {
    ...
    if ( a5 )
    {
      v27 = IndexedSet<DMMVIDPNTARGET>::FindById(*((_QWORD *)a5 + 39), v9);
      if ( v27 )
      {
        if ( DMMVIDPNTOPOLOGY::IsTargetInTopology((DMMVIDPNTOPOLOGY *)(v28 + 96), v9) )
        {
          ...
          v35 = (const struct _D3DKMDT_VIDEO_SIGNAL_INFO *)(*(_QWORD *)(v33 + 144) + 72LL);
          a6 = *(enum _D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING **)(*(_QWORD *)(v33 + 144) + 92LL);
          DmmCalculatePresentationVSync(v35, (struct _D3DDDI_RATIONAL *)&a6);
          if ( a3 )
            *a3 = *v36;
          if ( a4 )
