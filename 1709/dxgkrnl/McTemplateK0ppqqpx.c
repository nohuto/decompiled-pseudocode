/*
 * XREFs of McTemplateK0ppqqpx @ 0x1C00160C0
 * Callers:
...
NTSTATUS McTemplateK0ppqqpx(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v15 = 8LL;
  v17 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 7u, &v5);
}
