/*
 * XREFs of ?AddEntry@DXGADAPTERSOURCEHASH@@AEAAPEAUADAPTERSOURCEHASH_ENTRY@1@PEBU_LUID@@IH@Z @ 0x1C0107264
 * Callers:
...
LABEL_9:
    ...
    *((_DWORD *)Entry + 2) = a3;
    *((_DWORD *)Entry + 3) = v13 ^ ((unsigned __int8)v13 ^ (unsigned __int8)(2 * a4)) & 2;
    result = Entry;
    ++*((_DWORD *)this + 14);
    return result;
  }
