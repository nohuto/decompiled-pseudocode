/*
 * XREFs of ?DxgkCddDestroySynchronizationObject@@YAJPEBU_D3DKMT_DESTROYSYNCHRONIZATIONOBJECT@@@Z @ 0x1C00F38C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddDestroySynchronizationObject(
        ...
        __int64 a3)
{
  return DxgkDestroySynchronizationObjectInternal(a1, 0LL, a3);
}
