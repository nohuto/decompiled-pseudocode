/*
 * XREFs of McTemplateK0ppxppttqddddddddq @ 0x1C0029160
 * Callers:
...
NTSTATUS McTemplateK0ppxppttqddddddddq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v38 = 4LL;
  v40 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventBlit, a3, 0x12u, &v6);
}
