/*
 * XREFs of ?QueueSerializedWorkItem@CSERIALIZEDWORKQUEUE@@QEAAJP6AXPEAX@Z0@Z @ 0x1C0122964
 * Callers:
    ...
    *v10 = v9;
    ...
    if ( !*((_BYTE *)this + 56) )
    {
      ...
      if ( WorkItem )
      {
        IoQueueWorkItemEx(
          WorkItem,
          (PIO_WORKITEM_ROUTINE_EX)CSERIALIZEDWORKQUEUE::SerializedQueueWorker,
          DelayedWorkQueue,
          this);
      }
      else
