/*
 * XREFs of McTemplateK0ppqq @ 0x1C0028924
 * Callers:
...
NTSTATUS McTemplateK0ppqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 5u, &v4);
}
