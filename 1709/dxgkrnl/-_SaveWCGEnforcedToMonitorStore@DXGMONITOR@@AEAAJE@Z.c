/*
 * XREFs of ?_SaveWCGEnforcedToMonitorStore@DXGMONITOR@@AEAAJE@Z @ 0x1C02009FC
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveWCGEnforcedToMonitorStore(UNICODE_STRING *this, unsigned __int8 a2)
{
  __int64 result; // rax
  __int64 v5; // rbx
  __int64 v6; // rcx
