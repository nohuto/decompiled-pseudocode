/*
 * XREFs of MonitorSetAdvancedColorParams @ 0x1C01FEAD8
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    ExAcquireResourceExclusiveLite((PERESOURCE)((char *)v12 + 280), 1u);
    v16 = *(_OWORD *)((char *)v12 + 596);
    v17 = *(_OWORD *)((char *)v12 + 612);
    *(_QWORD *)&Buf2 = *v20;
    Buf1[0] = v16;
    *((_QWORD *)&Buf2 + 1) = *v21;
    *(_QWORD *)&v23 = *a4;
    *((_QWORD *)&v23 + 1) = *a5;
    ...
    {
      v18 = v23;
      *(_OWORD *)((char *)v12 + 596) = Buf2;
      *(_OWORD *)((char *)v12 + 612) = v18;
      *((_DWORD *)v12 + 157) = 5;
      *((_DWORD *)v12 + 158) = a6;
      *((_DWORD *)v12 + 159) = a7;
      *((_DWORD *)v12 + 160) = a8;
      *((_BYTE *)v12 + 648) = 0;
      DXGMONITOR::_SendAdjustedHDRParamsToDriver(v12);
    }
    ExReleaseResourceLite((PERESOURCE)((char *)v12 + 280));
