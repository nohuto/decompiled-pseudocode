/*
 * XREFs of ?GetDisplayedAllMultiPlaneOverlays@DXGDEVICE@@QEAAXIPEAVDXGALLOCATIONREFERENCE@@I@Z @ 0x1C002C104
 * Callers:
        ...
        unsigned int a4)
{
  ...
  {
    ADAPTER_DISPLAY::GetAllocationsForAllPlanes(*(ADAPTER_DISPLAY **)(v6 + 2304), a2, a3, a4);
  }
  else
  {
