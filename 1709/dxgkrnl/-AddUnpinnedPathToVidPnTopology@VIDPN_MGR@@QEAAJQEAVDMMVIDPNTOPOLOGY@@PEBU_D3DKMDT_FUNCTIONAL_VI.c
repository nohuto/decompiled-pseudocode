/*
 * XREFs of ?AddUnpinnedPathToVidPnTopology@VIDPN_MGR@@QEAAJQEAVDMMVIDPNTOPOLOGY@@PEBU_D3DKMDT_FUNCTIONAL_VIDPN_PRESENT_PATH@@W4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@@Z @ 0x1C00A7C5C
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CONNECTIVITY_CHECKS a4)
{
  ...
  _QWORD *v22; // rax
  _QWORD *v23; // rax
  struct DMMVIDPNPRESENTPATH *v24; // [rsp+60h] [rbp+8h] BYREF
  struct DMMVIDPNPRESENTPATH *v25; // [rsp+68h] [rbp+10h] BYREF
  ...
  v24 = 0LL;
  v25 = 0LL;
  v9 = DMMVIDPNTOPOLOGY::CreateNewPath(a2, a3, &v25);
  v12 = v9;
  if ( v9 < 0 )
  {
  ...
  {
    v13 = v25;
    *((_WORD *)v25 + 54) = *(_WORD *)&a3[1].CopyProtection.OEMCopyProtection[44];
    auto_ptr<DMMVIDPNPRESENTPATH>::reset(
      (__int64 (__fastcall ****)(_QWORD, __int64))&v24,
      (__int64 (__fastcall ***)(_QWORD, __int64))v13);
    v14 = VIDPN_MGR::_AddPathToVidPnTopology(this, a2, v24, D3DKMDT_MCC_ENFORCE, 1u);
    v16 = v14;
    ...
    {
      v22 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v15);
      v22[3] = VidPnSourceId;
      v22[4] = VidPnTargetId;
      v22[5] = a2;
  ...
  auto_ptr<DMMVIDPNSOURCE>::~auto_ptr<DMMVIDPNSOURCE>((__int64 (__fastcall ****)(_QWORD, __int64))&v24);
