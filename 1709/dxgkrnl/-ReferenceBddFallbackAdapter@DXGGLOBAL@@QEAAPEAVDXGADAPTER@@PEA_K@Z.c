/*
 * XREFs of ?ReferenceBddFallbackAdapter@DXGGLOBAL@@QEAAPEAVDXGADAPTER@@PEA_K@Z @ 0x1C01AB6A4
 * Callers:
...
struct DXGADAPTER *__fastcall DXGGLOBAL::ReferenceBddFallbackAdapter(DXGGLOBAL *this, unsigned __int64 *a2)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v12, (DXGGLOBAL *)((char *)this + 400));
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v12);
  v5 = (DXGGLOBAL *)((char *)this + 440);
  v6 = (DXGADAPTER *)*((_QWORD *)this + 55);
  while ( v6 != v5 && v6 )
  {
    v7 = v6;
