/*
 * XREFs of ?PinVidPnTargetMode@VIDPN_MGR@@QEBAJQEAVDMMVIDPNTARGETMODESET@@I_N@Z @ 0x1C00A7ED8
 * Callers:
        ...
        char a4)
{
  ...
  else
  {
    ...
    LOBYTE(v14) = a4;
    v37 = -1;
    v15 = VIDPN_MGR::FormalizeVidPnChange(this, Container & -(__int64)(Container != -88), 5LL, v14, &v37);
    v19 = v15;
    if ( v15 < 0 )
    {
      if ( v15 == -1071774970 )
      ...
      if ( v8 )
        v34 = DMMVIDPNTARGETMODESET::PinMode(a2, *(_DWORD *)(v8 + 24));
      else
        v34 = DMMVIDPNTARGETMODESET::UnpinMode(a2);
      if ( v34 < 0 )
      {
