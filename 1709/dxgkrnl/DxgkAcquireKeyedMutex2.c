/*
 * XREFs of DxgkAcquireKeyedMutex2 @ 0x1C01C0A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex2(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 *v13; // rdx
  __int64 v14; // rax
  size_t v15; // [rsp+30h] [rbp-48h]
  unsigned int v16[4]; // [rsp+40h] [rbp-38h]
  __int128 v17; // [rsp+50h] [rbp-28h] BYREF
  void *v18[2]; // [rsp+60h] [rbp-18h]
  ...
  if ( !v9 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v8, &EventProfilerExit, (__int64)v7, 2068);
