/*
 * XREFs of McTemplateK0xqqqqqqqq @ 0x1C003220C
 * Callers:
...
NTSTATUS McTemplateK0xqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventMiracastInterrupt, a3, 0xAu, &v4);
}
