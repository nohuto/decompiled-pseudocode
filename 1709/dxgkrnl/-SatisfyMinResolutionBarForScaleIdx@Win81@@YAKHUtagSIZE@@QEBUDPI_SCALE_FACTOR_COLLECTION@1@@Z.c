/*
 * XREFs of ?SatisfyMinResolutionBarForScaleIdx@Win81@@YAKHUtagSIZE@@QEBUDPI_SCALE_FACTOR_COLLECTION@1@@Z @ 0x1C01D86D0
 * Callers:
 ...
 * Callees:
 *     ??PWin81@@YA_NAEBUtagSIZE@@0@Z @ 0x1C01D7F58 (--PWin81@@YA_NAEBUtagSIZE@@0@Z.c)
 */
  ...
  if ( (int)this >= 0 )
  {
    ...
    if ( v6 > 0 )
    {
      ...
      for ( i = v6; i > 0; i = v11 - 1 )
      {
        ...
        v13.cy = v8 / v10;
        v14 = v13;
        if ( Win81::operator>=(&v14, dword_1C003A8E0) )
          break;
        --v6;
      }
    }
