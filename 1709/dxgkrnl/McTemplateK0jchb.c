/*
 * XREFs of McTemplateK0jchb @ 0x1C0026B10
 * Callers:
 *     DxgLogEtwEventCb @ 0x1C0026A90 (DxgLogEtwEventCb.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C000D744 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C0014F90 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0jchb(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a7)
{
  ...
  v12 = 1LL;
  v14 = 2LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventExternalEvent, a3, 5u, &v8);
}
