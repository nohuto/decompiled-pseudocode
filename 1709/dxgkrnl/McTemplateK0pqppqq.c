/*
 * XREFs of McTemplateK0pqppqq @ 0x1C002B4B4
 * Callers:
...
NTSTATUS McTemplateK0pqppqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOutputDuplicationBlit, a3, 7u, &v4);
}
