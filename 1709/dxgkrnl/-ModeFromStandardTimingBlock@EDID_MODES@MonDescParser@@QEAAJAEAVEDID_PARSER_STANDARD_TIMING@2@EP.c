/*
 * XREFs of ?ModeFromStandardTimingBlock@EDID_MODES@MonDescParser@@QEAAJAEAVEDID_PARSER_STANDARD_TIMING@2@EPEAU_VideoModeDescriptor@@@Z @ 0x1C00103DC
 * Callers:
 ...
 * Callees:
 *     ?CalculateVerticalActivePixelsFrom@MonDescParser@@YAJGGGPEAG@Z @ 0x1C000FC88 (-CalculateVerticalActivePixelsFrom@MonDescParser@@YAJGGGPEAG@Z.c)
 *     ?IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ @ 0x1C00107D4 (-IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ.c)
        ...
        struct _VideoModeDescriptor *a4)
{
  ...
  unsigned __int16 v21[12]; // [rsp+30h] [rbp-18h] BYREF
  ...
  if ( v9 )
  {
    ...
    if ( !v12 )
    {
      ...
      v14 = 3;
LABEL_5:
      result = MonDescParser::CalculateVerticalActivePixelsFrom((MonDescParser *)v11, v13, v14, v21);
      v16 = v21[0];
      goto LABEL_6;
    }
    v18 = v12 - 1;
