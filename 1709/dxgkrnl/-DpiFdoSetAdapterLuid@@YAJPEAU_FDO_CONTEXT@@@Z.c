/*
 * XREFs of ?DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z @ 0x1C0012860
 * Callers:
...
int __fastcall DpiFdoSetAdapterLuid(struct _FDO_CONTEXT *a1)
{
  ...
  if ( *((_DWORD *)a1 + 650) )
  {
    ...
    while ( (unsigned int)v3 < *((_DWORD *)a1 + 650) );
  }
  else
  {
    result = IoSetDevicePropertyData(*((PDEVICE_OBJECT *)a1 + 19), &DEVPKEY_Gpu_Luid, 0, 0, 9u, 8u, (char *)a1 + 2536);
    if ( result >= 0 )
    {
      Data = 0;
