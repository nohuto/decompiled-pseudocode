/*
 * XREFs of ?WriteDxgDiagnosticsEvent_USER_CDS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C000CB2C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_USER_CDS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( TlgKeywordOn(v1, 0x200000000008uLL) )
    {
      v7 = 4LL;
      v6 = &unk_1C003CA34;
      v8 = v11;
      ...
      v10 = v3;
      v11[1] = (_DWORD)v2;
      TlgWrite(v4, &unk_1C0040D08, 0LL, v2, 5u, &pData);
    }
  }
}
