/*
 * XREFs of DxgkMiracastStartMiracastSession @ 0x1C0030D64
 * Callers:
...
LABEL_51:
    ...
    *(_DWORD *)(DeviceContextFromName + 672) = dword_1C0060C18;
    v35 = v94;
    ...
    *(_DWORD *)(DeviceContextFromName + 196) = v5[34].Common.RemoveEvent.Header.WaitListHead.Blink;
    ...
    else if ( Flink == 2 )
    {
      ...
      if ( ((unsigned __int8)(Blink - 48) <= 9u || (unsigned __int8)((Blink | 0x20) - 97) <= 5u)
        ...
        && ((v42 = BYTE2(v5[34].Common.RemoveEvent.Header.WaitListHead.Blink), (unsigned __int8)(v42 - 48) <= 9u)
         || (unsigned __int8)((v42 | 0x20) - 97) <= 5u)
        && ((v43 = BYTE3(v5[34].Common.RemoveEvent.Header.WaitListHead.Blink), (unsigned __int8)(v43 - 48) <= 9u)
         || (unsigned __int8)((v43 | 0x20) - 97) <= 5u) )
      {
        if ( (unsigned __int8)(LOBYTE(v5[34].Common.RemoveEvent.Header.WaitListHead.Blink) - 48) > 9u )
          v44 = (Blink - 7) & 0xF;
        else
          v44 = Blink - 48;
        ...
        if ( (unsigned __int8)(v43 - 48) > 9u )
          ...
          v46 = v43 - 48;
        v37 = v46 | (16 * (v45 | (16 * (v38 | (16 * v44)))));
      }
      else
      {
        v37 = WORD1(v5[34].Common.RemoveEvent.Header.WaitListHead.Blink);
      }
      v47 = BYTE4(v5[34].Common.RemoveEvent.Header.WaitListHead.Flink);
      if ( v47 == 32 || v47 == 95 )
      {
        v49 = BYTE5(v5[34].Common.RemoveEvent.Header.WaitListHead.Flink);
        if ( v49 == 32 || v49 == 95 )
          v48 = HIDWORD(v5[34].Common.RemoveEvent.Header.WaitListHead.Flink) & 0xFFFF0000;
        else
          v48 = (HIDWORD(v5[34].Common.RemoveEvent.Header.WaitListHead.Flink) & 0xFFFFFF00) << 8;
      }
      else
      {
        v48 = HIDWORD(v5[34].Common.RemoveEvent.Header.WaitListHead.Flink) << 16;
      }
      *(_DWORD *)(DeviceContextFromName + 200) = v37 | v48;
    }
    else
    {
    ...
    *(_BYTE *)(DeviceContextFromName + 589) = 0;
    ...
    v50 = (_DWORD *)(DeviceContextFromName + 456);
    ...
    DpiMiracastEtwLogStartMiracastSessionStage(DeviceContextFromName, 0, v53);
    v55 = (int)v5[96].Common.RemoveEvent.Header.WaitListHead.Flink;
    v87 = 1;
    if ( *v50 != v55 )
    {
    ...
    *(_QWORD *)(DeviceContextFromName + 496) = 0LL;
    ...
    v56 = operator new(0x18uLL, 0x4B677844u, (POOL_TYPE)512);
    if ( v56 )
    {
    ...
    *(_QWORD *)(DeviceContextFromName + 488) = v56;
    v58 = (struct _LIST_ENTRY *)operator new(0x18uLL, 0x4B677844u, (POOL_TYPE)512);
    if ( v58 )
    {
      v59 = v5[96].Common.RemoveEvent.Header.Lock;
      LODWORD(v58[1].Flink) = 0;
      HIDWORD(v58[1].Flink) = v59;
      v58->Blink = v58;
      v58->Flink = v58;
    }
    else
    ...
    v5[97].Common.RemoveEvent.Header.WaitListHead.Flink = v58;
    v60 = (struct _LIST_ENTRY *)operator new(0x18uLL, 0x4B677844u, (POOL_TYPE)512);
    if ( v60 )
    {
      v61 = v5[96].Common.RemoveEvent.Header.Lock;
    ...
    v5[97].Common.RemoveEvent.Header.WaitListHead.Blink = v60;
    v62 = operator new(0x18uLL, 0x4B677844u, (POOL_TYPE)512);
    v64 = v62;
    if ( v62 )
    {
      v63 = (MIRACAST_CHUNK_LIST *)(unsigned int)v5[96].Common.RemoveEvent.Header.Lock;
      v62[4] = 0;
      v62[5] = (_DWORD)v63;
      *((_QWORD *)v62 + 1) = v62;
      *(_QWORD *)v62 = v62;
    ...
    *(_QWORD *)&v5[98].Common.Removed = v64;
    if ( *(_QWORD *)(DeviceContextFromName + 488) )
    {
      v63 = (MIRACAST_CHUNK_LIST *)v5[97].Common.RemoveEvent.Header.WaitListHead.Flink;
      if ( v63 )
      {
        if ( v5[97].Common.RemoveEvent.Header.WaitListHead.Blink && v64 )
        {
          if ( !MIRACAST_CHUNK_LIST::AllocateNewChunks(v63, 0x14u) )
          {
LABEL_118:
            v9 = 11;
LABEL_119:
          ...
          *(_QWORD *)(DeviceContextFromName + 504) = v66;
          v67 = (MIRACAST_CHUNK_LIST *)operator new(0x18uLL, 0x4B677844u, (POOL_TYPE)512);
          v63 = v67;
          if ( v67 )
          {
            *((_QWORD *)v67 + 2) = 0LL;
          ...
          v68 = *(_QWORD *)(DeviceContextFromName + 504);
          *(_QWORD *)(DeviceContextFromName + 512) = v63;
          if ( v68 && v63 )
          {
            if ( MIRACAST_CHUNK_LIST::AllocateNewChunks(v63, 0x14u) )
            {
              ...
              *(_QWORD *)(DeviceContextFromName + 376) = *(_QWORD *)&v5[144].Common.Removed;
              *(_QWORD *)(DeviceContextFromName + 384) = *(_QWORD *)&v5[144].Common.RemoveEvent.Header.Lock;
              KeReleaseInStackQueuedSpinLock(&LockHandle);
              v88 = 1;
              Src = &v5[145];
              LODWORD(p_Blink) = *(unsigned __int16 *)&v5[145].Common.Removed + 72;
              ...
              if ( v70 )
              {
                ...
                *((_DWORD *)v70 + 10) = dword_1C0060C04;
                *((_BYTE *)v70 + 44) = v85;
                v73 = (unsigned __int16 *)Src;
                *((_OWORD *)v70 + 3) = *(_OWORD *)(DeviceContextFromName + 112);
                memmove(v70 + 8, *(const void **)&v5[145].Common.RemoveEvent.Header.Lock, *v73);
