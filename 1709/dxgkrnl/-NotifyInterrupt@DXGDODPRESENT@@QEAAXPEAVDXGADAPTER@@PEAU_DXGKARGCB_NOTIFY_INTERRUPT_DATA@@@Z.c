/*
 * XREFs of ?NotifyInterrupt@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@@Z @ 0x1C002B9AC
 * Callers:
        ...
        struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a3)
{
  ...
  {
    v5 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(a2[288], a3->DmaCompleted.SubmissionFenceId);
    if ( v5 != -1 )
  ...
  {
    v8 = (_QWORD *)WdLogNewEntry5_WdCriticalError(this, a2, a2);
    v8[3] = 275LL;
    v8[4] = 24LL;
    v8[5] = *((_QWORD *)this + 11);
