/*
 * XREFs of DpiFdoInvalidateChildStatus @ 0x1C01DE850
 * Callers:
...
__int64 __fastcall DpiFdoInvalidateChildStatus(__int64 a1, int a2, char a3, unsigned __int8 a4, char a5, __int64 a6)
{
  ...
  v15[1] = a6;
  BYTE2(v16) = 1;
  v15[0] = a2 & 0xFFFFFF | 0x1000000u | (unsigned __int64)((unsigned __int8)(a5 != 0) << 28);
  v10 = DpiDxgkDdiDisplayDetectControl(v6, *(_QWORD *)(v6 + 40), *(_QWORD *)(v6 + 48), (unsigned int *)v15);
  v12 = v10;
  if ( v10 < 0 )
  {
