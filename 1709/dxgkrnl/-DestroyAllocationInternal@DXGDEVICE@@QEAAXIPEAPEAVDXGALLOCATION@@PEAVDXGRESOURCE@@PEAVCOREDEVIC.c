/*
 * XREFs of ?DestroyAllocationInternal@DXGDEVICE@@QEAAXIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C009DD6C
 * Callers:
        ...
        struct _D3DDDICB_DESTROYALLOCATION2FLAGS a6)
{
  ...
  if ( *(_BYTE *)(v14 + 185) )
  {
    ...
    DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendDestroyAllocation(
      (DXG_GUEST_VIRTUALGPU_VMBUS *)(v14 + 3888),
      *((_DWORD *)Current + 106),
      v15,
      v11,
      v8,
  ...
  {
    v28 = 0LL;
    DXGDEVICE::RemoveAllocationsAndTransferToList((struct _KTHREAD **)this, a3, v8, &v28);
    v20 = v28;
    if ( v28 )
    {
