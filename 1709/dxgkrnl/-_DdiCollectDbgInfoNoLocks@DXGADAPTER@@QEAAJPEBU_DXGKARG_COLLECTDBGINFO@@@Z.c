/*
 * XREFs of ?_DdiCollectDbgInfoNoLocks@DXGADAPTER@@QEAAJPEBU_DXGKARG_COLLECTDBGINFO@@@Z @ 0x1C017DB64
 * Callers:
...
LABEL_17:
  ...
  v14 = (*((int (__fastcall **)(_QWORD, const struct _DXGKARG_COLLECTDBGINFO *))this + 57))(*((_QWORD *)this + 30), a2);
  if ( v26[0] )
  ...
  if ( (_DWORD)v14 != -1073741823 && (_DWORD)v14 != -1073741801 && (_DWORD)v14 )
  {
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v23, &EventProfilerExit, v24, 5023);
