/*
 * XREFs of ?VmBusSendFlushDevice@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGDEVICE@@W4DXGDEVICE_FLUSHSCHEDULER_REASON@@@Z @ 0x1C01967E0
 * Callers:
...
__int64 __fastcall DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFlushDevice(struct VMBCHANNEL__ **a1, __int64 a2, int a3)
{
  ...
  v3 = *a1;
  v4 = (struct _MDL *)*(unsigned int *)(*(_QWORD *)(a2 + 40) + 424LL);
  v7 = 0LL;
  v5 = *(_DWORD *)(a2 + 336);
  v8 = (int)v4;
  v9 = 0;
