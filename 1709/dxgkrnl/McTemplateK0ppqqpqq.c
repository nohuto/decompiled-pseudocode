/*
 * XREFs of McTemplateK0ppqqpqq @ 0x1C0015F58
 * Callers:
...
NTSTATUS McTemplateK0ppqqpqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, 4LL, 8u, &v5);
}
