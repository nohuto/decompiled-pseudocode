/*
 * XREFs of ??1DXGADAPTER@@QEAA@XZ @ 0x1C0170ABC
 * Callers:
...
void __fastcall DXGADAPTER::~DXGADAPTER(DXGADAPTER *this)
{
  ...
  v2 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 288);
  if ( v2 )
  {
    ADAPTER_DISPLAY::`scalar deleting destructor'(v2);
    *((_QWORD *)this + 288) = 0LL;
  }
  v3 = (ADAPTER_RENDER *)*((_QWORD *)this + 289);
  if ( v3 )
  {
  ...
  v8 = (void *)*((_QWORD *)this + 293);
  if ( v8 )
  {
    ExFreePoolWithTag(v8, 0);
    *((_QWORD *)this + 293) = 0LL;
  }
  v9 = (void *)*((_QWORD *)this + 456);
  if ( v9 )
  ...
  if ( *((_QWORD *)this + 277) )
  {
    for ( i = 0LL;
          ...
          i = (unsigned int)(i + 1) )
    {
      v11 = *(void **)(*((_QWORD *)this + 277) + 48 * i + 24);
      if ( v11 )
        ExFreePoolWithTag(v11, 0);
      v12 = *(void **)(*((_QWORD *)this + 277) + 48 * i + 32);
      if ( v12 )
        ExFreePoolWithTag(v12, 0);
      *(_QWORD *)(*((_QWORD *)this + 277) + 48 * i + 24) = 0LL;
      *(_QWORD *)(*((_QWORD *)this + 277) + 48 * i + 32) = 0LL;
    }
    v13 = (void *)*((_QWORD *)this + 277);
    if ( v13 )
