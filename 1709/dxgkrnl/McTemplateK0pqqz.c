/*
 * XREFs of McTemplateK0pqqz @ 0x1C00209D4
 * Callers:
...
NTSTATUS McTemplateK0pqqz(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( !v23 )
    v3 = L"NULL";
  v14 = v3;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventNodeMetadata, 0LL, 5u, &v7);
}
