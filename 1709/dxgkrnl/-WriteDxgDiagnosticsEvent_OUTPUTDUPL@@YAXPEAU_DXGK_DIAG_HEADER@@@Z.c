/*
 * XREFs of ?WriteDxgDiagnosticsEvent_OUTPUTDUPL@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0027BFC
 * Callers:
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000200uLL) )
  {
    ...
    if ( v3 )
    {
      ...
      if ( v4 )
      {
        if ( v4 == 10 && hProvider > v2 )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000200uLL) )
          {
            ...
            v19 = v6;
            v21 = (int)v5;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004087C, 0LL, v5, 5u, &pData);
          }
        }
      }
      else if ( hProvider > v2 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000200uLL) )
      {
        ...
        v19 = v9;
        v21 = (int)v8;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004084B, 0LL, v8, 5u, &pData);
      }
    }
    else if ( hProvider > v2 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000200uLL) )
    {
      ...
      v19 = v12;
      v21 = (int)v11;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00408B3, 0LL, v11, 5u, &pData);
    }
  }
}
