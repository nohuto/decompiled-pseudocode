/*
 * XREFs of ?PinPathContentScaling@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C01EEB54
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a3)
{
  ...
  v21 = *(_DWORD *)(v15 + 24);
  v16 = VIDPN_MGR::FormalizeVidPnChange((__int64)this, (D3DKMDT_HVIDPN)(v14 & -(__int64)(v14 != -88)), 7, 1, &v20);
  v10 = v16;
  if ( v16 < 0 )
  {
    if ( v16 == -1071774970 )
