/*
 * XREFs of ?OpenAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAVDXGALLOCATION@@PEAU_DXGK_OPENALLOCATIONINFO@@PEAPEAX4PEAXEEIPEAIPEA_K@Z @ 0x1C0099B90
 * Callers:
        ...
        unsigned __int64 *a13)
{
  ...
  void *v50; // [rsp+20h] [rbp-A8h]
  _DXGKARG_OPENALLOCATION v51; // [rsp+30h] [rbp-98h] BYREF
  struct DXGALLOCATION *v52; // [rsp+68h] [rbp-60h]
  ...
  if ( NumAllocations )
  {
    memset(&v51.pOpenAllocation, 0, 48);
    v51.Flags.Value = ((a10 == 0) ^ (unsigned __int8)(*(_DWORD *)&a2->Flags >> 6)) & 2 ^ (a10 == 0);
    ...
    while ( v22 < a2->NumAllocations )
    {
      ...
      else if ( v34->PrivateDriverDataSize && a9 )
      {
...
LABEL_34:
    ...
    if ( v20 >= 0 )
    {
      v20 = ADAPTER_RENDER::DdiOpenAllocation(*((ADAPTER_RENDER **)this + 2), *((void **)this + 52), &v51);
      if ( v20 >= 0 )
      {
        if ( a12 )
          *a12 = v51.Pitch;
