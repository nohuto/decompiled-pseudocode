/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0123C84
 * Callers:
 *     RegisteredProviderEtwCallback @ 0x1C00F9AC0 (RegisteredProviderEtwCallback.c)
 *     TlgAggregateInternalProviderCallback @ 0x1C00F9B40 (TlgAggregateInternalProviderCallback.c)
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C005F890 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C005F890, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C005F890, &unk_1C0041A9D, 0LL, v6, 0xBu, &pData);
      }
