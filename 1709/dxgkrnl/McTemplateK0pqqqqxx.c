/*
 * XREFs of McTemplateK0pqqqqxx @ 0x1C00261C4
 * Callers:
...
NTSTATUS McTemplateK0pqqqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &DevicePresentStateEvent, a3, 8u, &v4);
}
