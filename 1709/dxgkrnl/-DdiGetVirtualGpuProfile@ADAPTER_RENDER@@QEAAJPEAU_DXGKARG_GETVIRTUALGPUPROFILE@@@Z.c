/*
 * XREFs of ?DdiGetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUPROFILE@@@Z @ 0x1C018BA3C
 * Callers:
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETVIRTUALGPUPROFILE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                              + 56LL))(
...
LABEL_26:
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v24, &EventProfilerExit, v25, 5098);
