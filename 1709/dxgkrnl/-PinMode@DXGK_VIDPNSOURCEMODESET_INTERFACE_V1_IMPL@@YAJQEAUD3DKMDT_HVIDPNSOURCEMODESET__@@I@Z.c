/*
 * XREFs of ?PinMode@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@I@Z @ 0x1C01F4170
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)(v5 + 32) = this;
  ...
  if ( v7 )
  {
    v12 = DMMVIDPNSOURCEMODESET::PinMode(v7, v4);
    if ( v12 >= 0 )
    {
      v12 = 0;
    }
  ...
  if ( (qword_1C005F010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v10, &EventProfilerExit, v11, 7007);
