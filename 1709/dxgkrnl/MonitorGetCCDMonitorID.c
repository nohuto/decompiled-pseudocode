/*
 * XREFs of MonitorGetCCDMonitorID @ 0x1C00D8C78
 * Callers:
...
__int64 __fastcall MonitorGetCCDMonitorID(struct HDXGMONITOR__ *a1, int a2, unsigned __int16 *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( *((_DWORD *)v14 + 104) != 1 && DXGMONITOR::_GetAttachedPhysicalMonitor(v14) )
    ...
    MonitorCCDMonitorID = DXGMONITOR::_GetMonitorCCDMonitorID(
                            ...
                            a2,
                            a3);
    v9 = (struct _ERESOURCE *)((char *)AttachedPhysicalMonitor + 280);
