/*
 * XREFs of ?ScheduleAdapterActivityCheck@DXGADAPTER@@QEAAXXZ @ 0x1C001F71C
 * Callers:
...
void __fastcall DXGADAPTER::ScheduleAdapterActivityCheck(KSPIN_LOCK *this)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v7, this + 351, 0);
  ...
  *(_QWORD *)(this[338] + 392) = MEMORY[0xFFFFF78000000320];
  *(_QWORD *)(this[338] + 392) += this[331];
  v4 = (KSPIN_LOCK *)(this[338] + 400);
  if ( !*v4 )
  {
    v5 = (KSPIN_LOCK **)(this + 349);
    v2 = this[349];
    if ( *(KSPIN_LOCK **)(v2 + 8) != this + 349 )
      __fastfail(3u);
    *v4 = v2;
    v4[1] = (KSPIN_LOCK)v5;
    *(_QWORD *)(v2 + 8) = v4;
  ...
  if ( !*((_BYTE *)this + 2780) )
  {
    ...
    LOBYTE(v2) = 1;
    *((_BYTE *)this + 2780) = 1;
    (*(void (__fastcall **)(_QWORD, KSPIN_LOCK))(*(_QWORD *)(*(_QWORD *)(v6 + 504) + 8LL) + 760LL))(
      *(_QWORD *)(v6 + 512),
      v2);
  }
  if ( v10 )
