/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@P8OUTPUTDUPL_MGR@@EAAXI@ZI@@SAJPEAVDXGADAPTER@@_NIP8OUTPUTDUPL_MGR@@EAAXI@ZIP6AJPEAV3@2I@Z@Z @ 0x1C00F7B60
 * Callers:
 *     DxgkDesktopSwitch @ 0x1C00F7B30 (DxgkDesktopSwitch.c)
 * Callees:
