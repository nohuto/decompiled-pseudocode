/*
 * XREFs of ?DodSetIndirectSwapchain@ADAPTER_DISPLAY@@QEAAJIPEAX@Z @ 0x1C01746A4
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DodSetIndirectSwapchain(ADAPTER_DISPLAY *this, __int64 a2, void *a3)
{
  ...
  __int64 v8; // rcx
  struct _LUID v9; // rbx
  OUTPUTDUPL_MGR_INDIRECT *v10; // rbp
  __int64 v11; // rcx
  int updated; // r15d
  __int64 v13; // rax
  __int64 v15; // rcx
...
LABEL_4:
  ...
  {
    v15 = *((_QWORD *)this + 2);
    v16 = *(__int64 (__fastcall **)(_QWORD, _QWORD, void *, struct _LUID))(v15 + 1568);
    if ( v16 )
    {
