/*
 * XREFs of McTemplateK0xxqqqqqqqqx @ 0x1C000D4D0
 * Callers:
...
__int64 McTemplateK0xxqqqqqqqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v24 = 4LL;
  v26 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &DMM_SnapPerfCounters, a3, 12LL, v4);
}
