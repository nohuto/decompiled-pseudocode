/*
 * XREFs of ?DpiRuntimePowerIrpCompletion@@YAXPEAU_DEVICE_OBJECT@@ET_POWER_STATE@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1C002D510
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)DeviceExtension + 488, &LockHandle);
