/*
 * XREFs of ?CreateSourceObject@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@IPEAU_OBJECT_ATTRIBUTES@@KPEAPEAX@Z @ 0x1C01D964C
 * Callers:
        ...
        void **Handle)
{
  ...
  v10 = (DXGDISPLAYMANAGERSOURCEOBJECT *)operator new(0x48uLL, 1u, 1265072196, PagedPool);
  v12 = 0;
  if ( v10 )
