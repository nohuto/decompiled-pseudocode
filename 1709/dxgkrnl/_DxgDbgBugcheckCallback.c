/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C0026750
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C0061A60 )
    {
      v4 = (unsigned int)(dword_1C0061A5C - 1);
      if ( dword_1C0061A5C != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C0061A60) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C0060D18;
      ReasonSpecificData[4] = qword_1C0061A60;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C0060D18;
      if ( v5 )
      {
