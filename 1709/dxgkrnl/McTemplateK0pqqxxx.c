/*
 * XREFs of McTemplateK0pqqxxx @ 0x1C0021970
 * Callers:
...
NTSTATUS McTemplateK0pqqxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCalibrateGpuClock, a3, 7u, &v4);
}
