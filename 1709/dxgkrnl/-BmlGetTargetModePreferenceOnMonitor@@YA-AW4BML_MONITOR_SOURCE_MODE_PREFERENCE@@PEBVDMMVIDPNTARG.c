/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C00D777C
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C00D94E8 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C00D7910 (MonitorGetNextMonitorSourceMode.c)
 *     BmlGetMonitorModePreference @ 0x1C00D7A1C (BmlGetMonitorModePreference.c)
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C00D94C4 (BmlIsEDIDCapableOutputTechonology.c)
 */
