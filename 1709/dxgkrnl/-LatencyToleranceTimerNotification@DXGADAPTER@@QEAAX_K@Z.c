/*
 * XREFs of ?LatencyToleranceTimerNotification@DXGADAPTER@@QEAAX_K@Z @ 0x1C001E4EC
 * Callers:
 *     ?DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z @ 0x1C0177320 (-DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::LatencyToleranceTimerNotification(KSPIN_LOCK *this, __int64 a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v21, this + 351, 1);
  v4 = this + 349;
  v5 = (_QWORD *)this[349];
  while ( v5 != v4 )
  {
...
LABEL_19:
      ...
      else
      {
        ...
        DXGADAPTER::SetPowerComponentLatencyCB(
          (DXGADAPTER *)this,
          *((_DWORD *)v6 + 1),
          *(_QWORD *)(this[329] + 16LL * v8));
        *((_DWORD *)v6 + 96) = v8;
        v6[49] = a2 + *(_QWORD *)(this[329] + 16LL * v8 + 8);
        if ( v8 == *((_DWORD *)v6 + 97) )
        {
          v9 = v6 + 50;
          v10 = *v9;
