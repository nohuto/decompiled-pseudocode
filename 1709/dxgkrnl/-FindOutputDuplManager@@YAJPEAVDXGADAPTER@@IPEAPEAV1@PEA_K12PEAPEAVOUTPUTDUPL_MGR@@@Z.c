/*
 * XREFs of ?FindOutputDuplManager@@YAJPEAVDXGADAPTER@@IPEAPEAV1@PEA_K12PEAPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C00B461C
 * Callers:
        ...
        struct OUTPUTDUPL_MGR **a7)
{
  ...
  else
  {
    if ( a3 && !*a3 || a5 && !*a5 )
    {
      ...
      *(_QWORD *)(v15 + 24) = 3079LL;
      WdLogEvent5_WdAssertion(v15);
    }
    *a7 = *(struct OUTPUTDUPL_MGR **)(*((_QWORD *)*a5 + 288) + 104LL);
    return 0LL;
  }
}
