/*
 * XREFs of ?CompletePresentIndirectInternal@BLTQUEUE@@AEAAJPEAVBLTENTRY@@PEAT_LARGE_INTEGER@@H@Z @ 0x1C01CDE60
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  struct _D3DKMT_GETSETSWAPCHAINMETADATA v31; // [rsp+38h] [rbp-41h] BYREF
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)&v31.bProducer = 1LL;
    ...
    DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)&v31, (struct _KTHREAD **)this + 31);
