/*
 * XREFs of ?_RetrieveMonitorDescriptorsFromCache@DXGMONITOR@@AEAAJXZ @ 0x1C0202CE0
 * Callers:
 ...
 *     ?ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@@Z @ 0x1C02021C8 (-ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_.c)
 */
...
__int64 __fastcall DXGMONITOR::_RetrieveMonitorDescriptorsFromCache(DXGMONITOR *this)
{
  ...
  v13 = (EDIDCACHE *)*((_QWORD *)DXGGLOBAL::GetGlobal(v11) + 85);
  if ( v13 )
    EdidForTarget = EDIDCACHE::GetEdidForTarget(v13, v12, v10, v9 != 1, (__int64)(v6 + 3), &v21);
  else
