/*
 * XREFs of ?AddEdid@EDIDCACHE@@QEAAXPEAVDXGADAPTER@@IPEBEW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x1C012113C
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN a5)
{
  ...
  if ( this[76] )
  {
    v24 = 0;
    v20 = -2;
    v9 = (int)DxgkQueryMonitorTypeLockHeld(a2, a3, (__int64)&v24, 0LL, &v20, 0LL, 0LL, 0LL, 0LL, 0LL) >= 0;
