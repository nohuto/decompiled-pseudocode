/*
 * XREFs of DxgkMiracastEnforceInactiveMonitorPolicy @ 0x1C000F410
 * Callers:
...
LONG __fastcall DxgkMiracastEnforceInactiveMonitorPolicy(_DWORD *a1)
{
  ...
  for ( i = qword_1C0060BE0; (__int64 *)i != &qword_1C0060BE0; i = *(_QWORD *)i )
  {
    v1 = (void *)i;
    ...
    *(_QWORD *)(i + 88) = KeGetCurrentThread();
    if ( (unsigned int)(*(_DWORD *)(i + 408) - 1) <= 1 )
    {
      ...
      if ( *(_DWORD *)(v6 + 2536) == *a1 && *(_DWORD *)(v6 + 2540) == a1[1] )
      {
        *(_BYTE *)(i + 589) = 1;
      }
      else if ( *(_BYTE *)(i + 589) )
