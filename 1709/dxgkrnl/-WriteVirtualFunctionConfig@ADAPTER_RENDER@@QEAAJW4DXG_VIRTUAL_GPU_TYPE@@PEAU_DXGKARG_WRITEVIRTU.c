/*
 * XREFs of ?WriteVirtualFunctionConfig@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIG@@@Z @ 0x1C0189BA0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfig(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v5 )
      return (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 56LL))(v5, a3);
  }
