/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C00293A4
 * Callers:
 *     AcpiCppcHighestNotifyWorker @ 0x1C002C600 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
  ...
  if ( v6 )
  {
      ...
      && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C0019AD8 + 104))(*(_QWORD *)(qword_1C0019AD8 + 56), 0LL) >= 0 )
    {
      ...
      *(_DWORD *)(v6 + 68) = v10;
      ...
      GetPerfDomain(v3, (__int64)v13, &v12);
      ...
      ((void (__fastcall *)(_DWORD *))qword_1C00197E0)(v14);
