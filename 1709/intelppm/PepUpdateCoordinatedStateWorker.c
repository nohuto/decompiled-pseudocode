/*
 * XREFs of PepUpdateCoordinatedStateWorker @ 0x1C0032A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PepUpdateCoordinatedStateWorker(__int64 a1, __int64 a2)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  byte_1C0019B50 = 0;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2512))(WdfDriverGlobals, qword_1C00195E0);
  *(_BYTE *)(a2 + 40) = 1;
  v4 = ((__int64 (__fastcall *)(__int64))qword_1C0019810)(a2);
  if ( v4 >= 0 )
  {
    if ( a2 == qword_1C0019B18 )
