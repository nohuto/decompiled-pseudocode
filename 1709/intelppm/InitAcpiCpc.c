/*
 * XREFs of InitAcpiCpc @ 0x1C001EEC0
 * Callers:
 ...
 *     RegisterSubspaceForGenAddr @ 0x1C002C328 (RegisterSubspaceForGenAddr.c)
 */
...
LABEL_36:
  ...
  if ( v12 )
  {
    v15 = (*(__int64 (__fastcall **)(_QWORD))(qword_1C0019AD8 + 88))(*(_QWORD *)(qword_1C0019AD8 + 56));
    v3 = v15;
    if ( v15 < 0 )
    {
      v16 = 14;
  ...
  if ( v12 )
  {
    v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(qword_1C0019AD8 + 104))(*(_QWORD *)(qword_1C0019AD8 + 56), 0LL);
    if ( v3 == -1073741435 )
      v3 = 0;
    if ( v3 < 0 )
    {
