/*
 * XREFs of DriverEntry @ 0x1C0035050
 * Callers:
 ...
 *     EvtDriverUnload @ 0x1C0028DA0 (EvtDriverUnload.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  {
    dword_1C00195D4 = KeQueryActiveProcessorAffinity(&unk_1C0019638);
    KeInitializeAffinityEx(&unk_1C00198C8);
