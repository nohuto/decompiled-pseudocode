/*
 * XREFs of DeactivateFixedFunctionCounters @ 0x1C00065D0
 * Callers:
 *     SnapEnergyCounters @ 0x1C0006640 (SnapEnergyCounters.c)
 *     UnInitEnergyCounters @ 0x1C00268A0 (UnInitEnergyCounters.c)
 * Callees:
 *     <none>
 */
