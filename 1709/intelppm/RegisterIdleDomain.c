/*
 * XREFs of RegisterIdleDomain @ 0x1C002FAD0
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v5 = 3LL * a2;
  v6 = qword_1C0019618;
  if ( (__int64 *)qword_1C0019618 == &qword_1C0019618 )
    goto LABEL_5;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C0019618 );
  if ( !v7 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v7 + 24) = v7 + 16;
    *(_QWORD *)(v7 + 16) = v7 + 16;
    v9 = (__int64 *)qword_1C0019620;
    if ( *(__int64 **)qword_1C0019620 != &qword_1C0019618 )
      __fastfail(3u);
    *(_QWORD *)v7 = &qword_1C0019618;
    *(_QWORD *)(v7 + 8) = v9;
    *v9 = v7;
    qword_1C0019620 = v7;
