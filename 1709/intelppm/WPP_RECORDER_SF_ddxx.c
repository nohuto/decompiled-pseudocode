/*
 * XREFs of WPP_RECORDER_SF_ddxx @ 0x1C0009158
 * Callers:
...
__int64 WPP_RECORDER_SF_ddxx(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 59;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_43c87aadc204398ca111f18064ed4edf_Traceguids, v7, (__int64 *)va);
}
