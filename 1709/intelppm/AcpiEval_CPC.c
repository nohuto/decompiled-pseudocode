/*
 * XREFs of AcpiEval_CPC @ 0x1C00205EC
 * Callers:
...
LABEL_2:
  ...
  v6 = P;
  v5 = AcpiParseCore(v19, 2LL, (unsigned __int64)P + 12, *((_DWORD *)P + 1) - 12, (__int64)v4, 236, "_CPC", 1);
  if ( v5 < 0 )
  {
    v9 = 48;
LABEL_15:
  ...
  if ( v10 )
  {
    ...
    v5 = AcpiParseCore(v19, v12, (unsigned __int64)(v6 + 3), v6[1] - 12, (__int64)v4, 236, "_CPC", v13);
    if ( v5 < 0 )
    {
      v9 = 50;
      goto LABEL_15;
