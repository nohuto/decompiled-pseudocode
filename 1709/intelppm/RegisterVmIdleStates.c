/*
 * XREFs of RegisterVmIdleStates @ 0x1C002BECC
 * Callers:
 *     RegisterGuestIdleStates @ 0x1C002AE00 (RegisterGuestIdleStates.c)
...
__int64 __fastcall RegisterVmIdleStates(__int64 a1)
{
  ...
  if ( v2 && (v3 = *v2) != 0 )
  {
    ...
    if ( ProcessorNumberFromIndex >= 0 )
    {
      ...
      BYTE2(v8[2]) = 1;
      HIDWORD(v8[14]) = 1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD *))qword_1C00197F8)(v8);
      if ( ProcessorNumberFromIndex >= 0 )
      {
        if ( !*(_BYTE *)(a1 + 688) )
        {
