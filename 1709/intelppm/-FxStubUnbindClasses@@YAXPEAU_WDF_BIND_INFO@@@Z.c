/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C0003F20
 * Callers:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0003C20 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 * Callees:
 *     WdfVersionUnbindClass_0 @ 0x1C0003FE0 (WdfVersionUnbindClass_0.c)
 */
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  if ( off_1C0014148 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= (_QWORD *)off_1C0014148 )
  {
    do
    {
