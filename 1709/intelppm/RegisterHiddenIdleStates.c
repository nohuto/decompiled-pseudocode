/*
 * XREFs of RegisterHiddenIdleStates @ 0x1C001D044
 * Callers:
...
__int64 __fastcall RegisterHiddenIdleStates(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 78) )
    return 3221225485LL;
  if ( !HalPrivateDispatchTable[140] )
    return 3221225659LL;
  v3 = *(_DWORD **)(a1 + 496);
  ...
  if ( (int)result >= 0 )
    return ((__int64 (__fastcall *)(_QWORD, __int64))HalPrivateDispatchTable[140])(*(unsigned int *)(a1 + 80), v5);
  return result;
}
