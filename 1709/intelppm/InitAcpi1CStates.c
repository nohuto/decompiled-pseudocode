/*
 * XREFs of InitAcpi1CStates @ 0x1C002E090
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 256) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0019D9C)
  ...
  if ( (*(_BYTE *)(a1 + 264) & 4) != 0
    && (unsigned __int16)word_1C0019D82 <= 0x3E8u
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0019DB4)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0019D84)
    && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0019D9C)
    && IsValidAcpiGenericAddress((unsigned __int8 *)(a1 + 184))
    && dword_1C00195D4 == 1 )
  {
  ...
  if ( PoolWithTag )
  {
    ...
    *((_WORD *)v9 + 9) = 0;
    ...
    {
      LOBYTE(v9[5 * v10 + 4]) = 3;
      HIWORD(v9[5 * *v9 + 4]) = word_1C0019D82;
      v9[5 * *v9 + 5] = 0;
      if ( *(_DWORD *)(a1 + 188) != -5 )
      {
        LOBYTE(v9[5 * *v9 + 1]) = 1;
