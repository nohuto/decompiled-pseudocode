/*
 * XREFs of PepIdlePrepare @ 0x1C000D040
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C000CE10 (PepIdleCancel.c)
 */
...
__int64 __fastcall PepIdlePrepare(_QWORD **a1)
{
  ...
  if ( dword_1C0019B00 >= (unsigned int)dword_1C00195D4 )
  {
    ...
    v19 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C0019870)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C0019B08 )
