/*
 * XREFs of LookupNtProcessorNumber @ 0x1C000339C
 * Callers:
...
__int64 __fastcall LookupNtProcessorNumber(_DWORD *a1)
{
  ...
  if ( ActiveProcessorCount )
  {
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C00195D8,
      0LL);
    if ( (unsigned int)KeCheckProcessorAffinityEx(&unk_1C00198C8, v2) )
    {
    ...
    {
      a1[14] = v2;
      KeAddProcessorAffinityEx(&unk_1C00198C8, v2);
    }
  ...
  {
LABEL_5:
    if ( (Globals & 0x200000000000LL) != 0 && (v5 = 0, (v6 = HalPrivateDispatchTable[138](0xFFFFFFFFLL)) != 0) )
    {
      while ( 1 )
      {
        ProcessorIdByNtNumber = ((__int64 (__fastcall *)(_QWORD, int *))HalPrivateDispatchTable[139])(v5, &v9);
        if ( ProcessorIdByNtNumber >= 0 && v9 == a1[12] )
          break;
        if ( ++v5 >= v6 )
