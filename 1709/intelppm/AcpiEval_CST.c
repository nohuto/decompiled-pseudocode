/*
 * XREFs of AcpiEval_CST @ 0x1C001FC18
 * Callers:
 ...
 *     AcpiTranslateAccessSize @ 0x1C0020C6C (AcpiTranslateAccessSize.c)
...
LABEL_48:
    ...
    v19 = LOBYTE(v8[v15 + 4]);
    v10 = ++v23;
    if ( (v18 & 0x1010) == 0 && v19 == 1 || (v18 & 0x2020) == 0 && v19 == 2 || (v18 & 0x4040) == 0 && v19 >= 3 )
      LODWORD(v12) = v12 - 1;
