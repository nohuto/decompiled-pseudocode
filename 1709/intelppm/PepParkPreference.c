/*
 * XREFs of PepParkPreference @ 0x1C000E540
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  result = (unsigned int)dword_1C0019B00;
  if ( dword_1C0019B00 >= (unsigned int)dword_1C00195D4 )
  {
      ...
      if ( a3 > (unsigned int)result && a3 < v10 )
      {
        ...
        if ( !(_DWORD)result )
        {
          do
          {
            ...
            v12 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Flink->Flink + v20);
          ...
          if ( v13 && v12 )
          {
            ...
            v22[1] = v13;
            v23 = PepParkLists;
            v17 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C0019860)(*(_QWORD *)(v12 + 1088), v22);
            if ( v17 < 0 )
