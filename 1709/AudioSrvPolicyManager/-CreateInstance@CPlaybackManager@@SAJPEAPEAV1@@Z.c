/*
 * XREFs of ?CreateInstance@CPlaybackManager@@SAJPEAPEAV1@@Z @ 0x180017B3C
 * Callers:
...
__int64 __fastcall CPlaybackManager::CreateInstance(struct CPlaybackManager **a1)
{
  ...
  else
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_a368ca27e3b33483ffe51d7896b5e1e1_Traceguids, -2147024882);
    }
