/*
 * XREFs of ?CastingStateChanged@CApplication@@QEAAXH@Z @ 0x18000DFCC
 * Callers:
...
void __fastcall CApplication::CastingStateChanged(CApplication *this, int a2)
{
  ...
  *((_DWORD *)this + 142) += a2;
  ...
  {
    v6 = *((_DWORD *)this + 142);
    WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, a2, v6);
    v4 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  ...
  if ( *((int *)this + 142) < 0 )
  {
    if ( v4 != &WPP_GLOBAL_Control && (*((_DWORD *)v4 + 7) & 0x40000000) != 0 && *((_BYTE *)v4 + 25) >= 2u )
      WPP_SF_((TRACEHANDLE)v4[2], 0x23u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids);
    *((_DWORD *)this + 142) = 0;
    v5 = *((_DWORD *)this + 142) <= 0;
  }
  if ( v5 )
