/*
 * XREFs of ?FindTrackedEndpoint@CVolumeLimitTrackerImpl@@IEAAPEAVCTrackedEndpoint@@PEBG@Z @ 0x180022CF4
 * Callers:
        ...
        char *a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, &WPP_b0ca754e0f2d3c7c76d04bc667a3e56e_Traceguids);
  }
  return 0LL;
}
