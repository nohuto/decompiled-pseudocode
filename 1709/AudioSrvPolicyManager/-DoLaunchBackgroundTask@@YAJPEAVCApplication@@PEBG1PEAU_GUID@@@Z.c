/*
 * XREFs of ?DoLaunchBackgroundTask@@YAJPEAVCApplication@@PEBG1PEAU_GUID@@@Z @ 0x18001BC24
 * Callers:
    ...
    if ( !v11 || v11 == 1725 )
    {
      ...
      if ( v13 >= 0 || (v10 = v13 | 0x10000000, v10 >= 0) )
      {
        ...
        if ( v14 >= 0 || (v10 = v14 | 0x10000000, v10 >= 0) )
        {
          ...
          v15 = v25;
          v5 = 0;
          v16 = (_QWORD *)((char *)v25 + 256);
          if ( *((_QWORD *)v25 + 32) || (v10 = CreateOnDemandBrokerClient(L"AudioSrv", (char *)v25 + 256), v10 >= 0) )
          {
            if ( !*((_QWORD *)v15 + 33) )
            {
