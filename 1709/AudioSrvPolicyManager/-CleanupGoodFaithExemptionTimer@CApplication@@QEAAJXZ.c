/*
 * XREFs of ?CleanupGoodFaithExemptionTimer@CApplication@@QEAAJXZ @ 0x18000CEF8
 * Callers:
...
__int64 __fastcall CApplication::CleanupGoodFaithExemptionTimer(const wchar_t **this)
{
  ...
  if ( this[48] )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x18u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, this[3]);
    }
