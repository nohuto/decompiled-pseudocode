/*
 * XREFs of ?SetNotificationData@@YAJPEAV?$CAtlList@PEAVCApplication@@V?$CElementTraits@PEAVCApplication@@@ATL@@@ATL@@PEAE_K@Z @ 0x18001B87C
 * Callers:
...
__int64 __fastcall SetNotificationData(_QWORD *a1, __int64 a2, unsigned __int64 a3)
{
  ...
  while ( v3 )
  {
    ...
    *(_DWORD *)(v5 + a2) = v12;
    if ( v12 + v13 > a3 )
      return (unsigned int)-2147024774;
    memcpy_0((void *)(v13 + a2), *(const void **)(v8 + 24), v12);
    if ( v14 + 4 > a3 )
      return (unsigned int)-2147024774;
    v20 = 0;
    ...
    while ( v15 )
    {
      v17 = v15[2];
      v15 = (_QWORD *)*v15;
      if ( !*(_DWORD *)(v17 + 464) && *(_DWORD *)(v17 + 532) )
      {
