/*
 * XREFs of ?UnregisterAppVolumePolicyChange@CWindowsPolicyManager@@UEAAJKPEAUIAudioAppVolumePolicyChange@@@Z @ 0x180006270
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioAppVolumePolicyChange *a3)
{
  ...
  if ( v11 >= 0 )
    v11 = CApplication::UnregisterAppVolumePolicyChange(v9, a3);
  if ( v16 )
