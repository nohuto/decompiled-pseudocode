/*
 * XREFs of ?StartInactivityTimer@CProcess@@QEAAXXZ @ 0x18000FB68
 * Callers:
  ...
  if ( !*((_QWORD *)this + 51) )
  {
    ...
    *((_QWORD *)this + 51) = v3;
    ...
    if ( v2 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Au, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, v2);
      }
      AudPolicyLogError("CProcess::StartInactivityTimer", 3386, v2);
    }
  }
  if ( v6 )
