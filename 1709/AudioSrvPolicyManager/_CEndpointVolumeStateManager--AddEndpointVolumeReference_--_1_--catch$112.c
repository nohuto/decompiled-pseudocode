/*
 * XREFs of _CEndpointVolumeStateManager::AddEndpointVolumeReference_::_1_::catch$112 @ 0x180029183
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CEndpointVolumeStateManager::AddEndpointVolumeReference_::_1_::catch_112(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
