/*
 * XREFs of ?ReleaseEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x1800250F0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  _BYTE v20[32]; // [rsp+38h] [rbp-B0h] BYREF
  _BYTE v21[32]; // [rsp+58h] [rbp-90h] BYREF
  _BYTE v22[32]; // [rsp+78h] [rbp-70h] BYREF
  ...
  *a6 = 0;
  ...
  if ( v12 )
  {
    ...
    if ( !--*((_DWORD *)v14 + 7) )
    {
      ...
      *a5 = **v13;
      *a7 = *((_BYTE *)v15 + 4);
      v16 = _InterlockedCompareExchange((volatile signed __int32 *)*v13 + 2, 1234, 1234);
      v17 = _InterlockedCompareExchange((volatile signed __int32 *)*v13 + 3, 1234, 1234);
      *a4 = v16 == 0;
      *a6 = v17 == 0;
      *a3 = 1;
