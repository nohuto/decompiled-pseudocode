/*
 * XREFs of ?TsSessionIdDisplayNotificationCallback@@YAKPEAXK0@Z @ 0x18001D8D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_ds @ 0x18001AAB4 (WPP_SF_ds.c)
...
__int64 __fastcall TsSessionIdDisplayNotificationCallback(void *a1, __int64 a2, _DWORD *a3)
{
      ...
      *((_DWORD *)v18 + 57) = v11;
      if ( v12 != v11 && (v10 || g_bLowPowerEpoch) )
      {
        ...
        if ( v16 && (int)QueueApplicationManagerWorkItem<ModernStandbyStateChangedContext>(v15, v16) < 0 )
        {
          ...
          {
            WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, &WPP_20b02ace39a33070fb42b5dc2503046a_Traceguids);
          }
  ...
  if ( v4 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_20b02ace39a33070fb42b5dc2503046a_Traceguids, v4);
    }
    AudPolicyLogError("TsSessionIdDisplayNotificationCallback", 2094, v4);
  }
  return 0LL;
}
