/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x1800016C4
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$0 @ 0x180027B4A (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$0.c)
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$3 @ 0x180027C1F (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$3.c)
 * Callees:
  ...
  if ( this )
  {
    ...
    *(_WORD *)this = 0;
    if ( !v7 || !wil::details::g_resultMessageCallbackSet || (v7(a3, this, a2, a4), !*(_WORD *)this) )
    {
      ...
      v15 = v13;
      if ( v14 )
        v15 = wil::details::LogStringPrintf((wil::details *)v13, v11, L"(caller: %p) ", v14);
      ...
      {
        v19 = wil::details::LogStringPrintf((wil::details *)v17, v11, L"    ", v18);
