/*
 * XREFs of ?QueryInterface@CTrackedEndpoint@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800237A0
 * Callers:
 *     ?QueryInterface@CTrackedEndpoint@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180024630 (-QueryInterface@CTrackedEndpoint@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CTrackedEndpoint@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180024640 (-QueryInterface@CTrackedEndpoint@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
