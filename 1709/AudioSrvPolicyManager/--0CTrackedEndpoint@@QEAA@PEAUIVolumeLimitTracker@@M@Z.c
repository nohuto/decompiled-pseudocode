/*
 * XREFs of ??0CTrackedEndpoint@@QEAA@PEAUIVolumeLimitTracker@@M@Z @ 0x180023888
 * Callers:
        ...
        float a3)
{
  ...
  *((_DWORD *)this + 35) = 1074790400;
  ATL::CAtlMap<unsigned __int64,float,ATL::CElementTraits<unsigned __int64>,ATL::CElementTraits<float>>::UpdateRehashThresholds((char *)this + 112);
  return this;
}
