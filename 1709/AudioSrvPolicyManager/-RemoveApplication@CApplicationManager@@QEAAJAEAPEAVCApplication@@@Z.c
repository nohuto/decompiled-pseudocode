/*
 * XREFs of ?RemoveApplication@CApplicationManager@@QEAAJAEAPEAVCApplication@@@Z @ 0x180014140
 * Callers:
...
LABEL_4:
  ...
  if ( v5 )
  {
    ...
    try
    {
      ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::RemoveAt((_QWORD *)this + 9, v5);
    }
    catch ( ATL::CAtlException *v9 )
    {
      ...
      if ( v12 < 0 )
      {
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v12);
        }
        AudPolicyLogError("CApplicationManager::RemoveApplication", 1578, v12);
      }
      v2 = a2;
    }
  }
