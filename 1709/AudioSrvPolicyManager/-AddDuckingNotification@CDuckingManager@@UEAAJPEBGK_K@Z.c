/*
 * XREFs of ?AddDuckingNotification@CDuckingManager@@UEAAJPEBGK_K@Z @ 0x180008060
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x180003DB4 (WPP_SF_D.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x1800046C0 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_Sdx @ 0x180006CAC (WPP_SF_Sdx.c)
        ...
        __int64 a4)
{
  ...
  _BYTE v26[8]; // [rsp+78h] [rbp-30h] BYREF
  ...
  {
    *(_DWORD *)v16 = a3;
    WPP_SF_Sdx(*((_QWORD *)WPP_GLOBAL_Control + 2), v8, v9, a2, *(_DWORD *)v16, a4);
    v11 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  if ( *((_DWORD *)this + 72) == 1 )
  {
...
LABEL_16:
    if ( v11 != &WPP_GLOBAL_Control && (*((_DWORD *)v11 + 7) & 0x8000000) != 0 && *((_BYTE *)v11 + 25) >= 2u )
      WPP_SF_D((TRACEHANDLE)v11[2], 0x1Fu, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, v12);
    AudPolicyLogError("CDuckingManager::AddDuckingNotification", 610, v12);
    goto LABEL_21;
  }
  try
  {
