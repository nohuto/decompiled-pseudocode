/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x180002CA0
 * Callers:
...
LABEL_20:
  ...
  if ( v19 >= 0 )
  {
    if ( !CloseHandle(v18) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x878, v22, v23);
      __debugbreak();
    }
    *a3 = ((__int64)v27 << 31) | v28[0];
    goto LABEL_20;
  }
  wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0xD6, (__int64)"wil", (const char *)(unsigned int)v19);
  if ( !CloseHandle(v18) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x878, v20, v21);
    __debugbreak();
  }
LABEL_21:
