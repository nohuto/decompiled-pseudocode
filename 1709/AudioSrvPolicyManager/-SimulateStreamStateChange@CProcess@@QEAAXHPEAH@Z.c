/*
 * XREFs of ?SimulateStreamStateChange@CProcess@@QEAAXHPEAH@Z @ 0x18001073C
 * Callers:
...
void __fastcall CProcess::SimulateStreamStateChange(CProcess *this, unsigned int a2, int *a3)
{
  ...
  if ( *((int *)this + 80) > 0 )
  {
    ...
    do
    {
      if ( v7 < 0 || v3 >= *((_DWORD *)this + 80) )
      {
        ATL::_AtlRaiseException((unsigned int)this, a2);
        JUMPOUT(0x18001085ALL);
      }
      v8 = 0;
      v9 = v17;
      v10 = *(unsigned int **)(v7 + *((_QWORD *)this + 39));
      v11 = *(_QWORD *)(v7 + *((_QWORD *)this + 38));
      do
      {
        for ( i = 0; i < *v10; ++i )
        {
