/*
 * XREFs of ?StartGoodFaithPLMExemptionTimer@CApplication@@IEAAJH@Z @ 0x18000CBEC
 * Callers:
...
__int64 __fastcall CApplication::StartGoodFaithPLMExemptionTimer(const wchar_t **this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, this[3]);
  }
  if ( !this[48] )
  {
    ...
    if ( v2 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, v2);
      }
      AudPolicyLogError("CApplication::StartGoodFaithPLMExemptionTimer", 1315, v2);
    }
  }
  if ( v7 )
  {
