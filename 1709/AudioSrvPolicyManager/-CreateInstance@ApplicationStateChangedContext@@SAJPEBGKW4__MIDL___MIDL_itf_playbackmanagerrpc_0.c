/*
 * XREFs of ?CreateInstance@ApplicationStateChangedContext@@SAJPEBGKW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0002@@PEAPEAU1@@Z @ 0x18001FFF0
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v13 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_b248cfb32be6365c2b37d8015b37b144_Traceguids, v13);
    }
    AudPolicyLogError("ApplicationStateChangedContext::CreateInstance", 1007, v13);
  }
