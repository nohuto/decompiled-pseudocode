/*
 * XREFs of ?AddSession@CProcess@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x18000F464
 * Callers:
...
__int64 __fastcall CProcess::AddSession(CProcess *this, struct IAudioSessionInfo *a2)
{
  ...
  catch ( ATL::CAtlException *v8 )
  {
    ...
    if ( v11 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_9c3c8450e3c737dcda82a54556fbcbcb_Traceguids, v11);
      }
      AudPolicyLogError("CProcess::AddSession", 2969, v11);
    }
  }
  if ( v10 )
