/*
 * XREFs of ?OnScreenReaderStateChanged@CApplicationManager@@QEAAJPEAUScreenReaderStateChangedContext@@@Z @ 0x180015AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Sddd @ 0x180011D44 (WPP_SF_Sddd.c)
        ...
        struct ScreenReaderStateChangedContext *a2)
{
  ...
  *((_DWORD *)a2 + 3) = v6;
  ...
  if ( v8 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x37u, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v8);
    }
    AudPolicyLogError("CApplicationManager::OnScreenReaderStateChanged", 2862, v9);
  }
  else
  {
    v10 = *((_DWORD *)a2 + 2) == 0;
    v11 = *(_DWORD *)(*(_QWORD *)a2 + 528LL) != v10;
    *(_DWORD *)(*(_QWORD *)a2 + 528LL) = v10;
    if ( v15 || v11 )
