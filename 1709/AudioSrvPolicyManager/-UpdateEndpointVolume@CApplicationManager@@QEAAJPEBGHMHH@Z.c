/*
 * XREFs of ?UpdateEndpointVolume@CApplicationManager@@QEAAJPEBGHMHH@Z @ 0x1800161A4
 * Callers:
 ...
 *     WPP_SF_Sg @ 0x180011DE4 (WPP_SF_Sg.c)
        ...
        unsigned int a6)
{
  ...
  if ( a5 )
  {
    ...
    {
      v13 = a6;
      WPP_SF_Sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Du, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, a2, v13);
    }
    v9 = (*(__int64 (__fastcall **)(CApplicationManager *, _QWORD, __int64 *))(*(_QWORD *)v16 + 144LL))(
           v16,
           v11,
  ...
  if ( a3 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(CApplicationManager *, __int64, __int64 *))(*(_QWORD *)v16 + 64LL))(
           v16,
           v8,
           &PBM_INITIATED_ENDPOINT_VOLUME_CHANGE);
  }
...
LABEL_17:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Fu, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v9);
    }
    AudPolicyLogError("CApplicationManager::UpdateEndpointVolume", 3051, v9);
  }
  if ( v16 )
