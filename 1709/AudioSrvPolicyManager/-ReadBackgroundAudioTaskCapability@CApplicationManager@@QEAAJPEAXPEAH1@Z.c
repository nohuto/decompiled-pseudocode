/*
 * XREFs of ?ReadBackgroundAudioTaskCapability@CApplicationManager@@QEAAJPEAXPEAH1@Z @ 0x1800139B8
 * Callers:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v7 >= 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v8);
    }
  }
  CoUninitialize();
  if ( v7 < 0 )
...
LABEL_13:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Fu, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v7);
    }
    AudPolicyLogError("CApplicationManager::ReadBackgroundAudioTaskCapability", 1297, v7);
  }
