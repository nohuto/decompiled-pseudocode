/*
 * XREFs of ?RpcSetAccessibilityAudioMonoMixState@CWindowsPolicyManager@@UEAAJH@Z @ 0x180005E20
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( !v6 )
          {
            ...
            if ( !v6 )
            {
              ...
              if ( !v6 )
              {
                ...
                if ( !(unsigned int)TsSessionFromSessionId(v5, 1, 0LL, &v9) && *((_DWORD *)v9 + 74) != v6 )
                  *((_DWORD *)v9 + 75) = v7;
