/*
 * XREFs of ?AddHostedAppInteractivityNotification@CHostedAppInteractivityManager@@QEAAJPEBGKH@Z @ 0x1800173AC
 * Callers:
        ...
        int a4)
{
  ...
  v17 = 0LL;
  lpCriticalSection = (LPCRITICAL_SECTION)&unk_18003ADF0;
  v16 = 0;
