/*
 * XREFs of ?CreateInstance@CApplicationManager@@SAJPEAPEAV1@@Z @ 0x180012498
 * Callers:
...
__int64 __fastcall CApplicationManager::CreateInstance(struct CApplicationManager **a1)
{
  ...
  if ( a1 && !g_ApplicationManager )
  {
    ...
    v4 = (char *)HeapAlloc(ProcessHeap, 0, 0xA8uLL);
    v5 = v4;
    if ( v4 )
    {
      *((_DWORD *)v4 + 2) = 1;
  ...
  if ( v2 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_adf1d118c71e358e1570efa4731a0ba5_Traceguids, v2);
    }
    AudPolicyLogError("CApplicationManager::CreateInstance", 397, v2);
  }
