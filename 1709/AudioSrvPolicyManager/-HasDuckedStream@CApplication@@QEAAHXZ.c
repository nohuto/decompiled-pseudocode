/*
 * XREFs of ?HasDuckedStream@CApplication@@QEAAHXZ @ 0x18000D344
 * Callers:
 ...
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x180010880 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
...
LABEL_2:
  ...
  v9 = 0LL;
LABEL_7:
  if ( v9 >= 0 && v8 < *(_DWORD *)(v4 + 320) )
  {
    v10 = *(_DWORD **)(v9 + *(_QWORD *)(v4 + 312));
    v11 = *(_QWORD *)(v9 + *(_QWORD *)(v4 + 304));
    v16 = v11;
    v12 = 0;
    while ( 1 )
    {
