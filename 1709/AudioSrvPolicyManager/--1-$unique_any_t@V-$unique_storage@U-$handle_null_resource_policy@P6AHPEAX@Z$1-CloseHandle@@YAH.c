/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18000EBFC
 * Callers:
 *     _CProcess::Initialize_::_1_::dtor$0 @ 0x180028562 (_CProcess--Initialize_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
