/*
 * XREFs of ?EventWorkerThread@@YAKPEAX@Z @ 0x180004970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EventWorkerThread(PVOID Parameter)
{
  ...
  if ( v1 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_78549fd881243d94e0ba2a0c198539a5_Traceguids);
        v2 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      if ( v2 != &WPP_GLOBAL_Control && (*((_DWORD *)v2 + 7) & 0x40000000) != 0 && *((_BYTE *)v2 + 25) >= 2u )
        WPP_SF_D((TRACEHANDLE)v2[2], 0xBu, &WPP_78549fd881243d94e0ba2a0c198539a5_Traceguids, v1);
    }
    AudPolicyLogError("EventWorkerThread", 123, v1);
    return v1;
  }
  else
  {
