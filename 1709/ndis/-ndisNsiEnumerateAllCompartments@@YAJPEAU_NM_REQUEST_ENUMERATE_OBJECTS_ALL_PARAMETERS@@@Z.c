/*
 * XREFs of ?ndisNsiEnumerateAllCompartments@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C003E430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllCompartments(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  unsigned int v23[6]; // [rsp+28h] [rbp-50h] BYREF

  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x88u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1);
  ...
  *((_DWORD *)a1 + 22) = v5;
  ...
  {
    v11 = *((_QWORD *)a1 + 2);
    if ( v11 && *((_DWORD *)a1 + 6) != 4
      || (v13 = (_OWORD *)*((_QWORD *)a1 + 5)) != 0LL && *((_DWORD *)a1 + 12) < 0x668u )
    {
      v12 = -1073741306;
      goto LABEL_29;
    }
...
LABEL_29:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(0x89u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1, v12);
  return v12;
}
