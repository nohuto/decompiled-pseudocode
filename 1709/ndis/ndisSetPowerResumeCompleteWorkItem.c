/*
 * XREFs of ndisSetPowerResumeCompleteWorkItem @ 0x1C0071590
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall ndisSetPowerResumeCompleteWorkItem(__int64 a1)
{
  ...
  *(_QWORD *)((char *)v12 + 4) = 1LL;
  ...
  if ( v6 )
  {
    v7 = *(_QWORD *)(v1 + 4480);
    v3 = -1073741823;
    NdisTraceLoggingUnexpectedSelectiveSuspendError((struct _NDIS_MINIPORT_BLOCK *)v1, 0x7A0u, v6);
    *(_WORD *)(v7 + 626) = *(_WORD *)(v7 + 624);
    *(_WORD *)(v7 + 624) = 1952;
    if ( (unsigned __int8)byte_1C0098756 >= 2u )
      WPP_SF_dq(0x1Eu, &WPP_72bd2a87b7f83093ce8d5792cc2b4ff7_Traceguids, v6, v1);
  }
  else
  {
    v10 = *(_QWORD *)(v1 + 4488);
    ...
    if ( (unsigned __int8)byte_1C0098750 >= 4u )
      WPP_SF_qZ(0x1Fu, &WPP_72bd2a87b7f83093ce8d5792cc2b4ff7_Traceguids, v1, *(const wchar_t **)(v1 + 3880));
  }
