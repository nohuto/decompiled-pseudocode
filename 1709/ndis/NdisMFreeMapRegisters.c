/*
 * XREFs of NdisMFreeMapRegisters @ 0x1C010CC20
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisMFreeMapRegisters(NDIS_HANDLE MiniportAdapterHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x2Du, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x2Eu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)MiniportAdapterHandle);
}
