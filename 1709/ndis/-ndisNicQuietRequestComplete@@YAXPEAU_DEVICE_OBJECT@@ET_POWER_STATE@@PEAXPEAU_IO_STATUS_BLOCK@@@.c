/*
 * XREFs of ?ndisNicQuietRequestComplete@@YAXPEAU_DEVICE_OBJECT@@ET_POWER_STATE@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1C0073C80
 * Callers:
        ...
        struct _IO_STATUS_BLOCK *a5)
{
  ...
  if ( Status >= 0 )
  {
    if ( (unsigned __int8)byte_1C0098750 >= 4u )
      WPP_SF_qZ(0x27u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, (__int64)a4, &a4->pAdapterInstanceName->Length);
  }
  else
  {
    v10 = a4->AoAc;
    NdisTraceLoggingUnexpectedAoAcError(a4, 0x8CBu, Status);
    v10->LastUnexpectedFailureLine[1] = v10->LastUnexpectedFailureLine[0];
    v10->LastUnexpectedFailureLine[0] = 2251;
    if ( (unsigned __int8)byte_1C0098755 >= 2u )
      WPP_SF_dq(0x26u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, Status, a4);
  }
}
