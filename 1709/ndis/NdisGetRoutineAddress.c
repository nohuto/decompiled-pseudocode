/*
 * XREFs of NdisGetRoutineAddress @ 0x1C00C36A0
 * Callers:
 *     ndisVerifierGetRoutineAddress @ 0x1C00ED190 (ndisVerifierGetRoutineAddress.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C00C36F4 (FindExportedRoutineByName.c)
 */
