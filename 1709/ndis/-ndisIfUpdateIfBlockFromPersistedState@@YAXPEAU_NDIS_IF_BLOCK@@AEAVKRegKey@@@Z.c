/*
 * XREFs of ?ndisIfUpdateIfBlockFromPersistedState@@YAXPEAU_NDIS_IF_BLOCK@@AEAVKRegKey@@@Z @ 0x1C003DD30
 * Callers:
 ...
 *     ??$MakePoolPtr@U_NDIS_INTERFACE_ADDITIONAL_PROPERTIES@@@@YA?AV?$unique_ptr@U_NDIS_INTERFACE_ADDITIONAL_PROPERTIES@@U?$KFreePool@U_NDIS_INTERFACE_ADDITIONAL_PROPERTIES@@@@@wistd@@K@Z @ 0x1C00DA944 (--$MakePoolPtr@U_NDIS_INTERFACE_ADDITIONAL_PROPERTIES@@@@YA-AV-$unique_ptr@U_NDIS_INTERFACE_ADDI.c)
 */
...
void __fastcall ndisIfUpdateIfBlockFromPersistedState(struct _NDIS_IF_BLOCK *a1, struct KRegKey *a2)
{
  ...
  if ( (int)ndisIfReadNetworkGuidFromKey(a2, &v12) >= 0
    ...
    && (unsigned __int8)byte_1C009875D >= 3u )
  {
  ...
  if ( P )
  {
    if ( (int)Ndis::BindRegistry::ReadAdditionalNetworkInterfaceParameters(a2, (struct KRegKey *)P, v6) >= 0 )
    {
      if ( (unsigned __int8)byte_1C009875D >= 4u )
        WPP_SF__guid_(195LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, &a1->InterfaceGuid);
