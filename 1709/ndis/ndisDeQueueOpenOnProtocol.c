/*
 * XREFs of ndisDeQueueOpenOnProtocol @ 0x1C00FF620
 * Callers:
...
void __fastcall ndisDeQueueOpenOnProtocol(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C009874D >= 4u )
    WPP_SF_qq(0x2Cu, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)byte_1C009874D >= 4u )
    WPP_SF_qq(0x2Du, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, a2);
}
