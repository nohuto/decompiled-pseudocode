/*
 * XREFs of NetPacketRegisterClient @ 0x1C00FC470
 * Callers:
 *     <none>
 * Callees:
...
_WORD *__fastcall NetPacketRegisterClient(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *((_QWORD *)v10 + 4) = a3;
  *((_QWORD *)v10 + 5) = a4;
  ExAcquirePushLockExclusiveEx(&unk_1C0099EB0, 0LL);
  *((_QWORD *)v10 + 1) = qword_1C009A128;
  qword_1C009A128 = v10;
  ExReleasePushLockExclusiveEx(&unk_1C0099EB0, 0LL);
  *(_DWORD *)v10 = 1;
  QueueStateUpdates();
  return v10;
}
