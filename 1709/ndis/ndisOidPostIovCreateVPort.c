/*
 * XREFs of ndisOidPostIovCreateVPort @ 0x1C006C980
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qq @ 0x1C0039520 (WPP_SF_qq.c)
 *     ndisIovAddVPortToPFList @ 0x1C006B54C (ndisIovAddVPortToPFList.c)
 *     ndisIovAddVPortToVFList @ 0x1C006B59C (ndisIovAddVPortToVFList.c)
 */
...
void __fastcall ndisOidPostIovCreateVPort(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x2Fu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 152);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_13:
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x30u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
}
