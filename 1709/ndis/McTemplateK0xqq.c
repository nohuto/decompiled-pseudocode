/*
 * XREFs of McTemplateK0xqq @ 0x1C0074F24
 * Callers:
...
NTSTATUS McTemplateK0xqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v7, va1);
  va_copy(v9, va2);
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &NicActiveRefRundownEntry, a3, 4u, &v4);
}
