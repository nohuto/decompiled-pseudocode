/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@@Z @ 0x1C00F366C
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX *a4)
{
  ...
  v5 = (const unsigned __int16 **)off_1C007FE30;
  v9 = 11LL;
  do
  {
  ...
  while ( v9 );
  v10 = (const unsigned __int16 **)&off_1C0080000;
  v11 = 5LL;
  do
  {
