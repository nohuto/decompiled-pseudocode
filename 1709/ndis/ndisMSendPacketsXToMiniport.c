/*
 * XREFs of ndisMSendPacketsXToMiniport @ 0x1C0057000
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisMCheckPacketAndPad @ 0x1C005467C (ndisMCheckPacketAndPad.c)
...
void __fastcall ndisMSendPacketsXToMiniport(struct _NDIS_MINIPORT_BLOCK *a1, _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqd(0xEu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, a3);
  v6 = 0;
  v7 = a2;
  v8 = a2;
  if ( (_DWORD)v3 )
  ...
  {
    LODWORD(v17) = v6;
    WPP_SF_qqd(0xFu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, v17);
  }
}
