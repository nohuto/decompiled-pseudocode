/*
 * XREFs of NdisOpenConfigurationKeyByIndex @ 0x1C00C8860
 * Callers:
        ...
        PNDIS_HANDLE KeyHandle)
{
  ...
  *(_QWORD *)&SubKeyName.Length = 0LL;
  ...
  if ( (unsigned __int8)byte_1C009874F >= 4u )
    WPP_SF_q(0xFu, &WPP_fb5e2801bcb8364427405c45392b258b_Traceguids, (__int64)ConfigurationHandle);
  v9 = KeyHandle;
  *KeyHandle = 0LL;
  ...
  if ( (unsigned __int8)byte_1C009874F >= 4u )
    WPP_SF_q(0x10u, &WPP_fb5e2801bcb8364427405c45392b258b_Traceguids, (__int64)ConfigurationHandle);
}
