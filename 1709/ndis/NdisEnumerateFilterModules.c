/*
 * XREFs of NdisEnumerateFilterModules @ 0x1C0058060
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG BytesWritten)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0x27u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, (__int64)NdisHandle);
  switch ( *(_BYTE *)v5 )
  {
    case 5:
      v7 = (_QWORD *)v5[4];
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x28u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, (__int64)v5, v9);
  return v9;
}
