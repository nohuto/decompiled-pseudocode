/*
 * XREFs of ?ndisNsiSetNetworkInfo@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C003FDA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetNetworkInfo(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x72u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1);
...
LABEL_32:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(0x73u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1, v1);
  return v1;
}
