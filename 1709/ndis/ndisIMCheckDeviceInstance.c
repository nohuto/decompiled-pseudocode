/*
 * XREFs of ndisIMCheckDeviceInstance @ 0x1C00E40C8
 * Callers:
...
char __fastcall ndisIMCheckDeviceInstance(__int64 a1, const UNICODE_STRING *a2, wchar_t **a3)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x28u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1, &a2->Length);
...
LABEL_24:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x2Au, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1, &a2->Length);
  return v6;
}
