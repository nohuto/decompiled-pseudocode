/*
 * XREFs of ndisFilterSendNetBufferLists @ 0x1C00162F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisFilterSendNetBufferLists(_QWORD *a1, struct _NET_BUFFER_LIST *a2, unsigned int a3, unsigned int a4)
{
  ...
  struct _NET_BUFFER_LIST **v22; // r13
...
LABEL_9:
    ...
    else
    {
      ...
      v14 = (struct _NDIS_FILTER_BLOCK *)a1[58];
      NextSendNetBufferListsHandler = (void (__fastcall *)(void *, _NET_BUFFER_LIST *, unsigned int, unsigned int))a1[55];
      if ( v14->Header.Type == 17 )
      {
        ((void (__fastcall *)(void *, struct _NET_BUFFER_LIST *, _QWORD, _QWORD))a1[55])(
      ...
      else if ( !ndisIterativeDataPathDisabled && ((a4 & 1) != 0 || KeGetCurrentIrql() == 2) )
      {
        ...
        if ( v14->Header.Type == 5 )
        {
          ...
          {
            v24 = v14;
            v25 = (__int64)v14->IterativeDataPathTracker[Number];
            v26 = *(_BYTE *)(v25 + 16);
            *(_BYTE *)(v25 + 16) = 1;
            v27 = *v22;
            LOBYTE(v44) = v26;
            ...
            *(_BYTE *)(v25 + 16) = 0;
            ...
            v14 = (struct _NDIS_FILTER_BLOCK *)v14->NextSendNetBufferListsObject;
...
LABEL_44:
      ...
      else
      {
               ...
               0LL) < 0 )
        {
          ...
          while ( v16 );
          _InterlockedExchangeAdd(&v14->DroppedSendNbls, v17);
          ndisQueueStackExpansionFallbackNbls(v14, v44, 1u);
        }
      }
    }
  }
