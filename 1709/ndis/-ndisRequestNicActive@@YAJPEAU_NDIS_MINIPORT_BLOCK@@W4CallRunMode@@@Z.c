/*
 * XREFs of ?ndisRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@@Z @ 0x1C0073EE0
 * Callers:
  ...
  if ( ActiveState == NdisNicQuiet )
  {
    ...
    else
    {
      ...
      if ( v15 == 259 )
        goto LABEL_25;
      v17 = a1->AoAc;
      NdisTraceLoggingUnexpectedAoAcError(a1, 0x470u, v15);
      v17->LastUnexpectedFailureLine[1] = v17->LastUnexpectedFailureLine[0];
      v17->LastUnexpectedFailureLine[0] = 1136;
      if ( (unsigned __int8)byte_1C0098755 >= 2u )
        WPP_SF_dq(0x11u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, v16, a1);
    }
  }
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0098755 >= 2u )
        WPP_SF_q(0x12u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, (__int64)a1);
      KeReleaseSpinLock(&AoAc->Lock, v12);
