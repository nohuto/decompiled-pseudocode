/*
 * XREFs of ?ndisPostSetMiniportRSSv2Parameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C007ABE4
 * Callers:
        ...
        int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(0x23u, &WPP_f2ba63df2d4e3a1d5681283389008951_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
  ...
  {
    LODWORD(v9) = a3;
    WPP_SF_qqd(0x24u, &WPP_f2ba63df2d4e3a1d5681283389008951_Traceguids, a1, a2, v9);
  }
}
