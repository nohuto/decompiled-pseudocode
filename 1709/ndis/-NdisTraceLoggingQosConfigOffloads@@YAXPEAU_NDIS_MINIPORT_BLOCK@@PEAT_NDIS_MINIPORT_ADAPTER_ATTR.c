/*
 * XREFs of ?NdisTraceLoggingQosConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C0079178
 * Callers:
        ...
        union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v19 = &v9;
      v20 = 4LL;
      TlgWrite(&hProvider, &unk_1C0085381, v2, v3, 7u, &pData);
    }
  }
}
