/*
 * XREFs of NdisIfRegisterProvider @ 0x1C0021290
 * Callers:
        ...
        PNDIS_HANDLE pNdisIfProviderHandle)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(21LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, IfProviderContext);
  v6 = 0;
...
LABEL_14:
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qqd(22LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, IfProviderContext, pNdisIfProviderHandle, v6);
  return v6;
}
