/*
 * XREFs of ndisMDeferredSend @ 0x1C00548A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSend(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x18u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, (__int64)a1);
  while ( a1->FirstPendingPacket && (a1->Flags & 0x400000) != 0 )
  {
    ...
    if ( v5 != (struct _NDIS_MINIPORT_BLOCK *)&a1->PacketList )
      a1->FirstPendingPacket = (_NDIS_PACKET *)&v5[-1].PdcTaskClientMode;
...
LABEL_11:
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x19u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, (__int64)a1);
  return 0;
}
