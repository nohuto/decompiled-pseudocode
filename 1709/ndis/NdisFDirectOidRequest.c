/*
 * XREFs of NdisFDirectOidRequest @ 0x1C0058920
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisFDirectOidRequest(NDIS_HANDLE NdisFilterHandle, PNDIS_OID_REQUEST OidRequest)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x33u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, NdisFilterHandle, OidRequest);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0x34u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, (__int64)OidRequest, v4);
  return v4;
}
