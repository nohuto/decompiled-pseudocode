/*
 * XREFs of ndisMDeferredSendPackets @ 0x1C0054B20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPackets(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x16u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, (__int64)a1);
        ...
        && (unsigned __int8)ndisMLoopbackPacketX(a1, FirstPendingPacket) )
      {
        ...
        *((_DWORD *)v11 + 2) = 0;
        ...
        if ( *(_MDL **)((char *)&FirstPendingPacket[1].Private.Head + NdisPacketOobOffset) )
          ...
          (*(void (__fastcall **)(__int64, _NDIS_PACKET *))(v12 + 112))(v12, FirstPendingPacket);
...
LABEL_41:
    ...
    if ( v18 != -1073741670 )
    {
      ...
      if ( (*(_QWORD *)v30 & 0xFFFFFF00LL) != 0x4D4F4300 )
      {
        v21 = (_QWORD *)(v17 + 64);
        v22 = *(_QWORD *)(v17 + 64);
        if ( *(_QWORD *)(v22 + 8) != v17 + 64 || (v23 = *(_QWORD **)(v17 + 72), (_QWORD *)*v23 != v21) )
          __fastfail(3u);
        *v23 = v22;
        *(_QWORD *)(v22 + 8) = v23;
...
LABEL_50:
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x17u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, (__int64)a1);
  return 0;
}
