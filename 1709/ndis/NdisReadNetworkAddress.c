/*
 * XREFs of NdisReadNetworkAddress @ 0x1C00C5FE0
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_HANDLE ConfigurationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C009874F >= 4u )
    WPP_SF_q(0x19u, &WPP_fb5e2801bcb8364427405c45392b258b_Traceguids, (__int64)ConfigurationHandle);
  *Status = -1073741823;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C009874F >= 4u )
    WPP_SF_q(0x1Au, &WPP_fb5e2801bcb8364427405c45392b258b_Traceguids, (__int64)ConfigurationHandle);
}
