/*
 * XREFs of NdisCancelTimerObject @ 0x1C0061140
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __stdcall NdisCancelTimerObject(NDIS_HANDLE TimerObject)
{
  ...
  if ( (unsigned __int8)byte_1C0098753 >= 4u )
    WPP_SF_qq(0xCu, &WPP_49acf40009c130b7c86151e057504a2b_Traceguids, *((_QWORD *)TimerObject + 3), TimerObject);
  ...
  if ( v2 )
  {
    ...
    if ( (*(_BYTE *)(*(_QWORD *)(v5 + 3784) + 26LL) & 2) != 0 && v4 )
    {
