/*
 * XREFs of ndisOidPostMediaState @ 0x1C0045980
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostMediaState(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x4Fu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v1);
  v4 = 0;
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x50u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v1);
}
