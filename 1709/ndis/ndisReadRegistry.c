/*
 * XREFs of ndisReadRegistry @ 0x1C011C848
 * Callers:
...
__int64 ndisReadRegistry()
{
  ...
  int *v76; // [rsp+450h] [rbp+348h]
  int v77; // [rsp+458h] [rbp+350h]
  int *v78; // [rsp+460h] [rbp+358h]
  ...
  int *v83; // [rsp+488h] [rbp+380h]
  int v84; // [rsp+490h] [rbp+388h]
  int *v85; // [rsp+498h] [rbp+390h]
  ...
  _IO_ALLOCATION_ACTION (__fastcall **p_DeviceRoutine)(_DEVICE_OBJECT *, _IRP *, void *, void *); // [rsp+7D0h] [rbp+6C8h]
  ...
  __int64 (__fastcall *v234)(__int64, int, _DWORD *, __int64, int, _DWORD *); // [rsp+940h] [rbp+838h]
  int v235; // [rsp+948h] [rbp+840h]
  const wchar_t *v236; // [rsp+950h] [rbp+848h]
  unsigned int *v237; // [rsp+958h] [rbp+850h]
  int v238; // [rsp+960h] [rbp+858h]
  unsigned int *v239; // [rsp+968h] [rbp+860h]
  int v240; // [rsp+970h] [rbp+868h]
  __int64 (__fastcall *v241)(__int64, int, _DWORD *, __int64, int, _DWORD *); // [rsp+978h] [rbp+870h]
  int v242; // [rsp+980h] [rbp+878h]
  const wchar_t *v243; // [rsp+988h] [rbp+880h]
  unsigned int *v244; // [rsp+990h] [rbp+888h]
  int v245; // [rsp+998h] [rbp+890h]
  unsigned int *v246; // [rsp+9A0h] [rbp+898h]
  int v247; // [rsp+9A8h] [rbp+8A0h]
  __int64 v248; // [rsp+9B0h] [rbp+8A8h]
  _BYTE v249[48]; // [rsp+9B8h] [rbp+8B0h] BYREF
  ...
  v236 = L"ImplicitPowerRefManagement";
  v237 = &ndisPowerRefManagementState;
  v239 = &ndisPowerRefManagementState;
  ...
  v231 = 4;
  v233 = 0;
  v234 = ndisReadRegParameters;
  v235 = 16;
  v238 = 4;
  v240 = 0;
  v243 = L"DirectedMacForNapsEnabled";
  v241 = ndisReadRegParameters;
  v244 = &ndisDirectedMacForNapsState;
  v246 = &ndisDirectedMacForNapsState;
  v242 = 16;
  v245 = 4;
  v247 = 0;
  v248 = 0LL;
  ...
  *(_DWORD *)VersionInformation = 284;
  ...
  result = (unsigned int)(dword_1C0097F08 - 1);
