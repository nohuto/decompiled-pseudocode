/*
 * XREFs of ndisMDeferredSendPacketsSG @ 0x1C0054F90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPacketsSG(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x26u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1);
  v3 = *(_DWORD *)(a1 + 120);
  v4 = 0LL;
    ...
    do
    {
      ...
      *(_QWORD *)(a1 + 144) = v4;
        ...
        && (v12 = ndisMLoopbackPacketX(a1, v7), v4 = 0LL, v12) )
      {
        ...
        v14 = v35;
        v15 = *(_QWORD *)v35;
        if ( *(_QWORD *)(*(_QWORD *)v8 + 8LL) != v8 || (v16 = *(_QWORD **)(v7 + 72), *v16 != v8) )
          __fastfail(3u);
        *v16 = v13;
        *(_QWORD *)(v13 + 8) = v16;
        *(_QWORD *)(v7 + 72) = v7 + 64;
        ...
        *(_BYTE *)(v7 + 41) &= 0xC0u;
        if ( *(_QWORD *)(v18 + v7 + 112) )
          ...
          (*(void (__fastcall **)(__int64, __int64))(v15 + 112))(v15, v7);
...
LABEL_46:
    ...
    if ( v22 != -1073741670 )
    {
      ...
      if ( (*(_QWORD *)v35 & 0xFFFFFF00LL) != 0x4D4F4300 )
      {
        v25 = (_QWORD *)(v21 + 64);
        v26 = *(_QWORD *)(v21 + 64);
        if ( *(_QWORD *)(v26 + 8) != v21 + 64 || (v27 = *(_QWORD **)(v21 + 72), (_QWORD *)*v27 != v25) )
          __fastfail(3u);
        *v27 = v26;
        *(_QWORD *)(v26 + 8) = v27;
...
LABEL_55:
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_q(0x27u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1);
  return 0;
}
