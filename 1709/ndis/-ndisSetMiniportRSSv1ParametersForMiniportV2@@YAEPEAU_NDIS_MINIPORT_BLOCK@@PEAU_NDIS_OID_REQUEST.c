/*
 * XREFs of ?ndisSetMiniportRSSv1ParametersForMiniportV2@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C007B338
 * Callers:
...
LABEL_4:
      WPP_SF_qqd(v11, &WPP_f2ba63df2d4e3a1d5681283389008951_Traceguids, a1, a2, *(_QWORD *)&v31[0].Group);
    }
  }
  else
  {
    ...
    if ( (v19 & 0x10) != 0 || !(unsigned __int8)InformationBuffer[2] )
    {
      v21 = 0;
    }
    else
