/*
 * XREFs of NdisMAllocateSharedMemoryAsync @ 0x1C0061600
 * Callers:
 *     NdisMAllocateSharedMemoryAsyncEx @ 0x1C0061760 (NdisMAllocateSharedMemoryAsyncEx.c)
 * Callees:
        ...
        PVOID Context)
{
  ...
  if ( (unsigned __int8)byte_1C009875C >= 4u )
    WPP_SF_qD(0x20u, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)MiniportAdapterHandle, Length);
...
LABEL_13:
  if ( (unsigned __int8)byte_1C009875C >= 4u )
    WPP_SF_d(0x21u, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, v9);
  return v9;
}
