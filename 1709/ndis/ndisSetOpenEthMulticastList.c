/*
 * XREFs of ndisSetOpenEthMulticastList @ 0x1C00C2958
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenEthMulticastList(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0x74u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, a2);
  ...
  if ( IsValidMulticastFilter )
  {
    if ( (unsigned __int8)byte_1C0098752 >= 2u )
      WPP_SF_qqq(0x75u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, v5);
  }
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqqDD(0x76u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, v5, IsValidMulticastFilter, v7);
  if ( IsValidMulticastFilter && (dword_1C0099FC4 & 4) != 0 )
    McTemplateK0jqxqqq(
