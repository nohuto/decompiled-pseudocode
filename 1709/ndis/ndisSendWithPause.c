/*
 * XREFs of ndisSendWithPause @ 0x1C0057C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSendWithPause(__int64 a1, struct _NDIS_PACKET *a2)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x32u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2);
  ndisSendPacketsWithPause(a1, &v4, 1u);
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x33u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, v4);
  return 259LL;
}
