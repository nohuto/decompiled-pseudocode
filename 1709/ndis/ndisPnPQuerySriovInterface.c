/*
 * XREFs of ndisPnPQuerySriovInterface @ 0x1C00F19D0
 * Callers:
...
__int64 __fastcall ndisPnPQuerySriovInterface(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x57u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1);
  v5 = *(_QWORD *)(a2 + 184);
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x58u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1, v4);
  return v4;
}
