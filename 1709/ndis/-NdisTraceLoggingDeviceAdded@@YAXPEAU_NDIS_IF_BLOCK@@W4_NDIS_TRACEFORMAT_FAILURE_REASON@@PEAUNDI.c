/*
 * XREFs of ?NdisTraceLoggingDeviceAdded@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEAUNDIS_ADDDEVICE_PARAMETERS@@JPEBGE@Z @ 0x1C0011AF0
 * Callers:
 *     ndisAddDevice @ 0x1C0103FA8 (ndisAddDevice.c)
 * Callees:
 *     _TlgWrite @ 0x1C0011DA8 (_TlgWrite.c)
 *     _TlgKeywordOn @ 0x1C0012B70 (_TlgKeywordOn.c)
 *     _TlgCreateWsz @ 0x1C0012B9C (_TlgCreateWsz.c)
...
char __fastcall NdisTraceLoggingDeviceAdded(__int64 a1, int a2, __int64 a3, int a4, __int64 a5, unsigned __int8 a6)
{
  ...
  if ( a4 < 0 )
  {
    if ( hProvider.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v6 )
      {
        ...
        v23 = a6;
        v35 = 4LL;
        LOBYTE(v6) = TlgWrite(&hProvider, &unk_1C00847E0, v18, v19, 8u, &pData);
      }
    }
  }
  else if ( hProvider.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v22 = a6;
      v40 = 4LL;
      LOBYTE(v6) = TlgWrite(&hProvider, &unk_1C0084EDE, v13, v14, 0xBu, &pData);
    }
  }
  return (char)v6;
}
