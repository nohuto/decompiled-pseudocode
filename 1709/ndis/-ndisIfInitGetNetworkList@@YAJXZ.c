/*
 * XREFs of ?ndisIfInitGetNetworkList@@YAJXZ @ 0x1C00215E0
 * Callers:
...
__int64 ndisIfInitGetNetworkList(void)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_(33LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids);
...
LABEL_23:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_d(34LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (unsigned int)v1);
