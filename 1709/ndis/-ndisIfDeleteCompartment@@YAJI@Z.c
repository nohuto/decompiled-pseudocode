/*
 * XREFs of ?ndisIfDeleteCompartment@@YAJI@Z @ 0x1C003D630
 * Callers:
...
__int64 __fastcall ndisIfDeleteCompartment(unsigned int a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_d(158LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
...
LABEL_19:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_dd(159LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1, Flink_low);
  v1 = -1073740024;
LABEL_20:
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( v1 >= 0 )
    {
      ...
      *p_Flink = Flink;
      ...
      {
        v21 = *(_QWORD **)v20;
        ObfDereferenceObject(*(PVOID *)(*(_QWORD *)v20 + 16LL));
        v22 = *v21;
