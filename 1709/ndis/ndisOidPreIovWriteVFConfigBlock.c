/*
 * XREFs of ndisOidPreIovWriteVFConfigBlock @ 0x1C00F1790
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovWriteVFConfigBlock(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x41u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
  {
LABEL_4:
...
LABEL_16:
  ...
  {
    v10 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x42u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v4, v10);
  }
  return v4;
}
