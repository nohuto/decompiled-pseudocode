/*
 * XREFs of ?ndisExpandStackTrace@@YAEPEAPEAU_NDIS_STACK_TRACE@@PEAU_RTL_DYNAMIC_HASH_TABLE_CONTEXT@@PEA_K@Z @ 0x1C006DA18
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  {
    BYTE2(WPP_MAIN_CB.AlignmentRequirement) = 1;
    return 0;
  }
  else
  {
    ...
    *((_OWORD *)PoolWithTag + 3) = *((_OWORD *)a3 + 1);
    ...
    RtlRemoveEntryHashTable((PRTL_DYNAMIC_HASH_TABLE)&WPP_MAIN_CB.DeviceQueue, v3, a2);
    RtlInsertEntryHashTable((PRTL_DYNAMIC_HASH_TABLE)&WPP_MAIN_CB.DeviceQueue, v10, v3->Signature, a2);
    *a1 = v10;
