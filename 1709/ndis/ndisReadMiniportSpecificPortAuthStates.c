/*
 * XREFs of ndisReadMiniportSpecificPortAuthStates @ 0x1C00AF0D8
 * Callers:
...
__int64 __fastcall ndisReadMiniportSpecificPortAuthStates(_DWORD *a1, void *a2)
{
  ...
  *(_DWORD *)&v13.Length = 4456514;
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0x31u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x32u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, (__int64)a1, v4);
  return v4;
}
