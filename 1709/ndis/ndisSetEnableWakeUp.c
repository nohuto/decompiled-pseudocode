/*
 * XREFs of ndisSetEnableWakeUp @ 0x1C00E174C
 * Callers:
 *     ndisOidPreEnableWakeUp @ 0x1C00DF980 (ndisOidPreEnableWakeUp.c)
 * Callees:
...
unsigned __int8 __fastcall ndisSetEnableWakeUp(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0xCu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v5, v1, v3);
  *(_DWORD *)(a1 + 40) = 0;
  if ( v3[12] < 4u )
  {
    v3[14] = 4;
...
LABEL_7:
  ...
  if ( *(_QWORD *)(a1 + 24) )
  {
    ...
    *(_DWORD *)(a1 + 40) = v7;
    ...
    {
      if ( (unsigned __int8)byte_1C0098752 >= 4u )
        WPP_SF_(0xDu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids);
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 40) = v11;
      ...
      {
        if ( (unsigned __int8)byte_1C0098752 >= 4u )
          WPP_SF_qqq(0xEu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v5, v1, v3);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10) != 0 )
          McTemplateK0jqxtpp(
            v13,
            v12,
...
LABEL_8:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0xFu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v5, v1, v3);
  return v2;
}
