/*
 * XREFs of ?NdisPDAddProviderToBMGroup@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@PEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x1C00F4880
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_PROVIDER_HANDLE__ *a2)
{
  ...
  {
    if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)i + 6) + 5512LL) + 72LL) == *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 32)
                                                                                               + 5512LL)
                                                                                   + 72LL) )
    {
  ...
  *((_QWORD *)a1 + 4) = v6;
  if ( (unsigned __int8)byte_1C0098764 >= 4u )
  {
    WPP_SF_qq(
      ...
      a1,
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)i + 6) + 5512LL) + 72LL));
LABEL_17:
    if ( (unsigned __int8)byte_1C0098764 >= 4u )
    {
      v12 = v2;
