/*
 * XREFs of NdisWriteEventLogEntry @ 0x1C005BD30
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Data)
{
  ...
  {
    WPP_SF_qdD(0x2Eu, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, (__int64)LogHandle, EventCode, UniqueEventValue);
    v12 = LogHandle;
  }
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_(0x2Fu, &WPP_4a5d38b576c633146a968e2982301690_Traceguids);
  return v7;
}
