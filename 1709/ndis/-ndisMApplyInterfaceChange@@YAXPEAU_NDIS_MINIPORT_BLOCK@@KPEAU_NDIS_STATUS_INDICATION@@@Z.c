/*
 * XREFs of ?ndisMApplyInterfaceChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@KPEAU_NDIS_STATUS_INDICATION@@@Z @ 0x1C00E76B4
 * Callers:
        ...
        struct _NDIS_STATUS_INDICATION *a3)
{
  ...
  {
    if ( a1 )
      WPP_SF_Zq(0xAEu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, &a1->pAdapterInstanceName->Length, a1);
    else
      WPP_SF_Zq(0xAEu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, 0LL, 0LL);
  }
  ...
  if ( Ndis::BindState::SetPause(&a1->Bindings.Miniport, DatapathRunning, PauseReason_InterfaceChangeInProgress)
    && (unsigned __int8)byte_1C0098763 >= 4u )
  {
    WPP_SF_Zq(0xAFu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, &a1->pAdapterInstanceName->Length, a1);
  }
  a1->BindEngine.m_isDirty = 1;
  Ndis::BindEngine::EndPolicyUpdates(&a1->BindEngine);
