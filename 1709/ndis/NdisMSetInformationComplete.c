/*
 * XREFs of NdisMSetInformationComplete @ 0x1C00428D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMSetInformationComplete(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0x49u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, BugCheckParameter2, a2);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_q(0x4Au, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, BugCheckParameter2);
}
