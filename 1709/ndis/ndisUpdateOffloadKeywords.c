/*
 * XREFs of ndisUpdateOffloadKeywords @ 0x1C00DE1F0
 * Callers:
 ...
 *     ndisConvertOffloadValueToString @ 0x1C00DBF70 (ndisConvertOffloadValueToString.c)
...
__int64 __fastcall ndisUpdateOffloadKeywords(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_q(0xEEu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a1);
    LOBYTE(a2) = v52;
    LOBYTE(a3) = v53;
    v5 = 0;
    v9 = 0;
