/*
 * XREFs of ndisRejectUnsupportedWoLPatterns @ 0x1C00E1068
 * Callers:
    ...
    if ( !ndisIsWoLPacketTypeSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0098755 >= 2u )
          WPP_SF_d(0x7Eu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0098755 >= 2u )
          WPP_SF_d(0x7Fu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3944), 0, 1, 0);
    }
  }
