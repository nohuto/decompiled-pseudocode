/*
 * XREFs of ndisCreateAdapterInstanceName @ 0x1C00C1C68
 * Callers:
        ...
        _UNICODE_STRING **a4)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0xEu, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, (__int64)a3);
  *a1 = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    if ( appended < 0 )
    {
      if ( (unsigned __int8)byte_1C0098754 >= 2u )
      {
        v23 = 17;
LABEL_41:
        WPP_SF_qq(v23, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a2, a3);
      }
    }
    else
    {
      ...
      {
        if ( (unsigned __int8)byte_1C0098754 >= 4u )
          WPP_SF_Z(0x13u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, &v14->Length);
        if ( !v4 )
          goto LABEL_20;
        v15 = 0;
...
LABEL_20:
          *a1 = v14;
          if ( a2 )
          {
            ...
            {
              if ( (unsigned __int8)byte_1C0098754 >= 4u )
                WPP_SF_Z(0x16u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, &v14->Length);
            }
            else
            {
              if ( (unsigned __int8)byte_1C0098754 >= 4u )
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 2u )
  {
    v22 = 16;
LABEL_36:
    WPP_SF_qq(v22, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a2, a3);
  }
LABEL_26:
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x17u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, (__int64)a3, appended);
