/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C00235F4
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0023650 (RtlWideCharArrayCopyStringWorker.c)
