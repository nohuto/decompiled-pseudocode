/*
 * XREFs of ndisQueryPower @ 0x1C0105B58
 * Callers:
...
NTSTATUS __fastcall ndisQueryPower(PIRP Irp, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_q(0x26u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3);
  ...
  {
    if ( (unsigned __int8)byte_1C0098755 >= 4u )
      WPP_SF_qdD(0x27u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3, v7, *(_DWORD *)(a2 + 24));
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0098755 >= 4u )
        WPP_SF_qD(0x28u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3, *(_DWORD *)(a2 + 24));
    ...
    else
    {
      ...
      if ( (unsigned int)ndisDevicePnPEventNotifyFiltersAndAllTransports(
                           ...
                           (__int64)&v18)
        && (unsigned __int8)byte_1C0098755 >= 2u )
      {
        WPP_SF_q(0x29u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3);
      }
      if ( (*(_DWORD *)(a3 + 124) & 0x20) != 0 )
      {
        ...
        {
          if ( (unsigned __int8)byte_1C0098755 >= 4u )
            WPP_SF_q(0x2Au, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3);
          if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
            McTemplateK0jqxqqq(
              v13,
              &QueryPowerFailed,
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_qD(0x2Bu, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a3, v10);
  return v10;
}
