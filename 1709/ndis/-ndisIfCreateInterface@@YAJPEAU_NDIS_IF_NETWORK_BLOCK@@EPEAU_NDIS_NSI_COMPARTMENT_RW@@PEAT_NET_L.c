/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C00B48CC
 * Callers:
        ...
        enum NdisIfBlockSource a7)
{
  ...
  *(_DWORD *)&Source.Length = 262146;
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qqqqq(0x80u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1, a3, a4, a5, a6);
  if ( !a1
...
LABEL_77:
          ...
          *((_QWORD *)v13 + 79) = 1LL;
          if ( v43 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00982B2);
            ...
            *((_WORD *)v13 + 24) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00984C2);
            *(_DWORD *)&Destination.Length = 0x2000000;
...
LABEL_16:
          ...
          *(_GUID *)(v13 + 100) = NetworkGuid;
          ...
          appended = ndisIfRegisterInterfaceEx(v20, v18, a6, (struct _NET_IF_INFORMATION *)v13, a7, &v37);
          if ( !appended )
          {
            if ( a3 )
