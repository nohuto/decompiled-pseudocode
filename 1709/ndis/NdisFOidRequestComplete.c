/*
 * XREFs of NdisFOidRequestComplete @ 0x1C00195D0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisFOidRequestComplete(NDIS_HANDLE NdisFilterHandle, PNDIS_OID_REQUEST OidRequest, NDIS_STATUS Status)
{
  ...
  if ( v10 )
  {
    *((_QWORD *)NdisReserved + 3) = 0LL;
    ...
    if ( (unsigned __int8)byte_1C0098752 >= 4u )
      WPP_SF_qq(198LL, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, OidRequest->RequestHandle, OidRequest);
    if ( v13 )
    {
    ...
    if ( (unsigned __int8)byte_1C0098752 >= 4u )
      WPP_SF_qq(199LL, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, RequestHandle, 0LL);
