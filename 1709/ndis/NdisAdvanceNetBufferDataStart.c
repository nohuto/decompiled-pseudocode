/*
 * XREFs of NdisAdvanceNetBufferDataStart @ 0x1C0017AD0
 * Callers:
        ...
        NET_BUFFER_FREE_MDL_HANDLER FreeMdlHandler)
{
  ...
  {
    v7 = NetBuffer->CurrentMdlOffset + DataOffsetDelta;
    for ( i = NetBuffer->CurrentMdl; i; v7 -= ByteCount )
    {
    ...
    NetBuffer->Link.Region = (unsigned __int64)i;
