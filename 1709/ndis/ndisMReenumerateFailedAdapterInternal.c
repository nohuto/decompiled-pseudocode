/*
 * XREFs of ndisMReenumerateFailedAdapterInternal @ 0x1C0064E9C
 * Callers:
...
void __fastcall ndisMReenumerateFailedAdapterInternal(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  else
  {
    ...
    KeReleaseSpinLock(p_Lock, v4);
    if ( (unsigned __int8)byte_1C0098758 >= 2u )
      WPP_SF_q(0x44u, &WPP_c43bece8f9e83cce6c35b7786f97099d_Traceguids, (__int64)a1);
