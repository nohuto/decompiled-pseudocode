/*
 * XREFs of ndis5InterruptDpc @ 0x1C00622C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( ndisCheckWatchdogTimer() )
  {
    ...
    *(_QWORD *)(v4 + 520) = KeGetCurrentThread();
    v7 = *(_DWORD *)(v4 + 120);
    *(_DWORD *)(v4 + 1856) = 658208;
    if ( (v7 & 0x2000000) == 0 )
    {
      *(_DWORD *)(v4 + 120) = v7 | 0x2000000;
      ndisReferenceMiniportNoCheck(v4);
      ExQueueWorkItem((PWORK_QUEUE_ITEM)(v4 + 3432), CustomPriorityWorkQueue|RealTimeWorkQueue|0x8);
    }
    *(_QWORD *)(v4 + 520) = 0LL;
    *(_DWORD *)(v4 + 1856) = 0;
