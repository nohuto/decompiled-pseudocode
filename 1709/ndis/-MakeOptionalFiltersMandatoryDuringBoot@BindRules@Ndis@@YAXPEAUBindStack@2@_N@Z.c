/*
 * XREFs of ?MakeOptionalFiltersMandatoryDuringBoot@BindRules@Ndis@@YAXPEAUBindStack@2@_N@Z @ 0x1C00BC828
 * Callers:
  ...
  while ( v4 != v2 )
  {
    ...
    if ( v8[13] || v8[7] )
    {
        ...
        else
        {
          ...
          else
          {
            if ( (unsigned __int8)byte_1C0098763 >= 5u )
              WPP_SF_dd(0xEu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v9, v9 & 0xFFFFFFBF);
      ...
      if ( v3 == BindingEnabled )
      {
        ...
        {
          if ( (unsigned __int8)byte_1C0098763 >= 5u )
            WPP_SF_dd(0xEu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v13, v13 & 0xFFFFFFBF);
          *(_BYTE *)(*(_QWORD *)v8 + 5240LL) = 1;
          v14 = 1;
        }
        if ( v14 )
        {
          if ( (unsigned __int8)byte_1C0098763 >= 4u )
          {
            ...
            if ( (unsigned __int8)byte_1C0098763 >= 4u )
            {
              v22 = 43;
LABEL_52:
              WPP_SF_Zq(v22, &WPP_339be45e8b703252d0c5449fb14c5e43_Traceguids, (const wchar_t *)v24[1], v24[0]);
LABEL_11:
              if ( v5 )
              {
                v11 = *(_QWORD *)(v7 + 8 * v4);
  ...
  for ( i = 0LL; i != v15; ++i )
  {
    ...
    if ( v5 )
    {
      ...
      else
      {
        ...
        if ( (v19 != 0) != ((v19 & 0xFFFFFFBF) != 0) || !*(_QWORD *)v18 )
        {
          ...
          v23 = (unsigned __int8)byte_1C0098763 < 4u;
          *(_BYTE *)(*(_QWORD *)v18 + 5240LL) = 1;
          if ( !v23 )
            WPP_SF_Zq(
              0x2Du,
              &WPP_339be45e8b703252d0c5449fb14c5e43_Traceguids,
    ...
    else if ( v3 == BindingEnabled )
    {
      ...
      {
        if ( (unsigned __int8)byte_1C0098763 >= 5u )
          WPP_SF_dd(0xEu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v21, v21 & 0xFFFFFFBF);
        v23 = (unsigned __int8)byte_1C0098763 < 4u;
        *(_BYTE *)(*(_QWORD *)v20 + 5240LL) = 1;
        if ( !v23 )
          WPP_SF_Zq(
            0x2Fu,
            &WPP_339be45e8b703252d0c5449fb14c5e43_Traceguids,
