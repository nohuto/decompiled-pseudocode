/*
 * XREFs of NdisOpenFile @ 0x1C00E47D0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v10 < 0 )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x10u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v10);
    *Status = -1073676261;
    goto LABEL_32;
  }
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x11u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v11);
LABEL_16:
    ZwClose(FileHandlea);
    *Status = -1073676260;
    goto LABEL_32;
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x14u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v15);
    *Status = -1073676260;
  }
