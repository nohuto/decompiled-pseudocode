/*
 * XREFs of ndisCopyPacketInfoToNBL @ 0x1C004D394
 * Callers:
 ...
 * Callees:
 *     ?ndisIPsecPktInfoToNBLInfo@@YAXPEAU_NDIS_IPSEC_PACKET_INFO@@W4_NDIS_XLATE_TYPE@@PEAU_NDIS_IPSEC_OFFLOAD_V1_NET_BUFFER_LIST_INFO@@@Z @ 0x1C004BFD4 (-ndisIPsecPktInfoToNBLInfo@@YAXPEAU_NDIS_IPSEC_PACKET_INFO@@W4_NDIS_XLATE_TYPE@@PEAU_NDIS_IPSEC_.c)
 */
