/*
 * XREFs of NdisMGetVirtualDeviceLocation @ 0x1C00EEE00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x75u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x76u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1);
}
