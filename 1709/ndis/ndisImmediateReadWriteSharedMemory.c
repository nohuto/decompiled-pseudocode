/*
 * XREFs of ndisImmediateReadWriteSharedMemory @ 0x1C00E4CC8
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00E4700 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00E47B0 (NdisImmediateWriteSharedMemory.c)
 * Callees:
