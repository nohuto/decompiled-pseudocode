/*
 * XREFs of ndisOidPreIovEnumNicSwitches @ 0x1C006D0F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumNicSwitches(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x13u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1);
...
LABEL_19:
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x14u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v3;
}
