/*
 * XREFs of ?ndisNsiSetAllNetworkInfo@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C003F740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetAllNetworkInfo(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  *(_DWORD *)&NewIrql[4] = 0;
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x74u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1);
  ...
  *(_OWORD *)&v7->Header.Type = *v6;
  ...
  if ( !v16 )
  {
    ...
    {
LABEL_33:
      v2 = ndisIfCreateNetworkBlock(v3, v10, &v31, (_LIST_ENTRY ***)&v29);
      if ( v2 < 0 )
        goto LABEL_45;
      v12 = v29;
      v24 = 1;
...
LABEL_46:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(0x75u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1, v2);
