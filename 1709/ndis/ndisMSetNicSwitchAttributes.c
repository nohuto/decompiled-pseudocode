/*
 * XREFs of ndisMSetNicSwitchAttributes @ 0x1C00CA410
 * Callers:
...
__int64 __fastcall ndisMSetNicSwitchAttributes(void **a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qq(0x81u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 32);
  v6 = *(_BYTE *)(v5 + 1);
  if ( v6
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v13 )
        {
          ...
          if ( v14 )
          {
            ...
            if ( v18 < 0x84u )
              v11 = v18;
            memmove(a1[448], v17, v11);
            memmove(a1[449], *(const void **)(a2 + 40), v11);
            goto LABEL_27;
          }
        }
      }
...
LABEL_27:
  ...
  {
    v23 = v4;
    WPP_SF_qqd(0x82u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2, v23);
  }
  return v4;
}
