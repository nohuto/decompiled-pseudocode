/*
 * XREFs of ndisFDoLoopbackNetBufferList @ 0x1C0059138
 * Callers:
...
void __fastcall ndisFDoLoopbackNetBufferList(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqq(0x64u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1, a2, a3);
...
LABEL_40:
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqq(0x65u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1, a2, v5);
}
