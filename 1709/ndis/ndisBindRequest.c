/*
 * XREFs of ndisBindRequest @ 0x1C0064BA0
 * Callers:
 ...
 *     ?ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z @ 0x1C00FA880 (-ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z.c)
 */
        ...
        ULONG_PTR BugCheckParameter3)
{
  ...
  switch ( *(_DWORD *)(BugCheckParameter3 + 8) )
  {
    case 0x12:
      ...
      v11 = 57;
LABEL_28:
      WPP_SF_Zq(v11, &WPP_c43bece8f9e83cce6c35b7786f97099d_Traceguids, v15, v14);
      break;
    case 0x13:
    ...
    case 0x15:
      ...
      v9 = 60;
LABEL_23:
      WPP_SF_Zq(v9, &WPP_c43bece8f9e83cce6c35b7786f97099d_Traceguids, v15, v14);
LABEL_24:
      v7 = RunSynchronous;
      break;
  }
