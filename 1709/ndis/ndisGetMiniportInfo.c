/*
 * XREFs of ndisGetMiniportInfo @ 0x1C00E7CCC
 * Callers:
...
__int64 __fastcall ndisGetMiniportInfo(__int64 a1, __int64 a2, _DWORD *a3, char *a4, _DWORD *a5)
{
  ...
  *(_DWORD *)&Keyword.Length = 1048590;
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0x9Bu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
  *a5 = 1;
...
LABEL_28:
    ...
    if ( v22 )
    {
      if ( *(int *)(a1 + 464) < 20 )
      {
        if ( (unsigned __int8)byte_1C0098754 >= 3u )
          WPP_SF_(0x9Cu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids);
  ...
  if ( (unsigned int)v23 <= 0x13 && ndisMediaTypeCl[v23] || (_DWORD)v23 == 3 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0098754 >= 3u )
        WPP_SF_q(0x9Du, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        McTemplateK0jqxqqq(
          v24,
          &OidQueryFailed,
  ...
  if ( (*(_BYTE *)(a1 + 928) & 1) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0098754 >= 3u )
        WPP_SF_q(0x9Eu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        McTemplateK0jqxqqq(
          v26,
          &OidQueryFailed,
  ...
  if ( !v30 )
  {
    ...
    if ( v22 )
    {
      v5 = 1;
      if ( (unsigned __int8)byte_1C0098754 >= 3u )
        WPP_SF_q(0x9Fu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        McTemplateK0jqxqqq(
          v32,
          &OidQueryFailed,
    ...
    else
    {
      *(_WORD *)(a2 + 92) = 6;
      ...
      {
        if ( (unsigned __int8)byte_1C0098754 >= 3u )
          WPP_SF_q(0xA0u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          McTemplateK0jqxqqq(
            v34,
            &OidQueryFailed,
...
LABEL_77:
      ...
      {
        if ( (unsigned __int8)byte_1C0098754 >= 3u )
          WPP_SF_q(0xA2u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          McTemplateK0jqxqqq(
            v35,
            &OidQueryFailed,
...
LABEL_92:
  ...
  if ( v30 == 3 )
  {
    *(_WORD *)(a2 + 92) = 6;
    ...
    if ( (unsigned __int8)byte_1C0098754 >= 3u )
      WPP_SF_q(0xA3u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
    if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
      McTemplateK0jqxqqq(
        v31,
        &OidQueryFailed,
...
LABEL_109:
  ...
  *v56 = v5;
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0xA4u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, v8);
  return v8;
}
