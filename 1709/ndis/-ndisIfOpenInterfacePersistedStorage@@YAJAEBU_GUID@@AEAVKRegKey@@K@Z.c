/*
 * XREFs of ?ndisIfOpenInterfacePersistedStorage@@YAJAEBU_GUID@@AEAVKRegKey@@K@Z @ 0x1C00AF660
 * Callers:
...
__int64 __fastcall ndisIfOpenInterfacePersistedStorage(const struct _GUID *a1, struct KRegKey *a2, unsigned int a3)
{
  __int64 result; // rax
  int v7; // eax
  __int64 v8; // rdx
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v7 < 0 )
    {
      if ( (unsigned __int8)byte_1C009875D >= 3u )
        WPP_SF__guid_d(0xB1u, v8, (__int64)a1, v7);
      return v9;
    }
    else
    {
