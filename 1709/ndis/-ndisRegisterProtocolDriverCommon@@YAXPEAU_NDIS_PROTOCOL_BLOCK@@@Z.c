/*
 * XREFs of ?ndisRegisterProtocolDriverCommon@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C0010D44
 * Callers:
 ...
 *     ?SetDirty@BindEngine@Ndis@@QEAAXXZ @ 0x1C00FA9E8 (-SetDirty@BindEngine@Ndis@@QEAAXXZ.c)
 */
