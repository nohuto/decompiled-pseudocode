/*
 * XREFs of NdisIMRegisterLayeredMiniport @ 0x1C00E9650
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE DriverHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)*DriverHandle, v8);
  return v8;
}
