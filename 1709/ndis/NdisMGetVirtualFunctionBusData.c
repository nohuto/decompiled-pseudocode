/*
 * XREFs of NdisMGetVirtualFunctionBusData @ 0x1C006B1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMGetVirtualFunctionBusData(__int64 a1, unsigned __int16 a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x6Fu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x70u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1, v9);
  return v9;
}
