/*
 * XREFs of ndisMInvokeOidRequest @ 0x1C00B9A74
 * Callers:
...
__int64 __fastcall ndisMInvokeOidRequest(__int64 a1, _NDIS_OID_REQUEST *a2)
{
  ...
  PNDIS_OID_REQUEST v28; // [rsp+78h] [rbp+10h] BYREF
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0xE2u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, Oid);
  v6 = ndisOidCloneForCompatibility((_BYTE *)a1, (__int64)v3, 1, &v28);
  v7 = v28;
  v8 = v6;
  if ( v6 )
    goto LABEL_26;
  if ( v28 && (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(0xE3u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, v3, v28, v28->DATA.QUERY_INFORMATION.Oid);
  v9 = *(_QWORD *)(a1 + 3784);
  v10 = *(_QWORD *)(v9 + 352);
  if ( !v10 || *(_QWORD *)(v10 + 64) == *(_QWORD *)(v9 + 176) )
    v11 = *(struct _NDIS_REFCOUNT_BLOCK **)(a1 + 5496);
  else
  ...
  if ( v11 != (struct _NDIS_REFCOUNT_BLOCK *)-1LL )
  {
    ...
    v14[2].RefWithStack[0].Block.Dereferences[4] = (_NDIS_REFCOUNT_STACK_ENTRY)846677070;
    switch ( *(_BYTE *)a1 )
    {
      case 5:
        v15 = *(_QWORD *)(a1 + 32);
    ...
    *(_QWORD *)v14[3].RefWithStack[0].Block.Dereferences = v29;
...
LABEL_26:
  ...
  {
    LODWORD(v26) = v8;
    WPP_SF_qdD(0xE4u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, Oid, v26);
  }
  return v8;
}
