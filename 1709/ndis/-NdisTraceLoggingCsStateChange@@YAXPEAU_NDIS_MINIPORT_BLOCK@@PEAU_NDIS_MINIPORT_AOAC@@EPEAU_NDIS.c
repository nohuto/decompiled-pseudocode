/*
 * XREFs of ?NdisTraceLoggingCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@EPEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@4@Z @ 0x1C00781A0
 * Callers:
    ...
    *(_OWORD *)((char *)&v90[2] + 12) = v17;
    ...
    if ( hProvider.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        v87 = 68LL;
        v89 = 136LL;
        TlgWrite(&hProvider, &unk_1C0084B6D, v19, v20, 0x1Fu, &pData);
      }
    }
  }
}
