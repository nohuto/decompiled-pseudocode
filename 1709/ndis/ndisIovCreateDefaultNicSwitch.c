/*
 * XREFs of ndisIovCreateDefaultNicSwitch @ 0x1C00AD4D8
 * Callers:
...
__int64 __fastcall ndisIovCreateDefaultNicSwitch(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0xAu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1);
...
LABEL_6:
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0xBu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1, SwitchConfiguration);
