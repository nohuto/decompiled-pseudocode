/*
 * XREFs of ndisCleanUpForProtocol @ 0x1C00ABA84
 * Callers:
...
void __fastcall ndisCleanUpForProtocol(__int64 a1, int a2)
{
  ...
  if ( (unsigned __int8)byte_1C009874D >= 4u )
    WPP_SF_q(0x37u, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1);
  v3 = *(_DWORD **)(a1 + 16);
  if ( *(_DWORD *)(a1 + 432) )
  {
    v6 = 0;
  ...
  if ( (unsigned __int8)byte_1C009874D >= 4u )
    WPP_SF_q(0x38u, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1);
}
