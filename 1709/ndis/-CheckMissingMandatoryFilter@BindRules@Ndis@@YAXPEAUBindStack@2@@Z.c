/*
 * XREFs of ?CheckMissingMandatoryFilter@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00BCF38
 * Callers:
...
LABEL_55:
  ...
  for ( j = 0LL; j != v12; ++j )
  {
    ...
    if ( v3 )
    {
      ...
      {
        if ( (unsigned __int8)byte_1C0098763 >= 5u )
          WPP_SF_dd(0xEu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v16, v16 | 0x20);
    ...
    else
    {
      ...
      {
        if ( (unsigned __int8)byte_1C0098763 >= 5u )
          WPP_SF_dd(0xEu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v16, v16 & 0xFFFFFFDF);
        v18 = (unsigned __int8)byte_1C0098763 < 4u;
        *(_BYTE *)(*(_QWORD *)v15 + 5240LL) = 1;
        if ( !v18 )
          WPP_SF_Zq(
