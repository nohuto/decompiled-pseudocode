/*
 * XREFs of ndisQueryBusInterface @ 0x1C00C4F7C
 * Callers:
...
__int64 __fastcall ndisQueryBusInterface(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x16u, &WPP_8cdf937d6f313bc131af68fc7a29b768_Traceguids, a1);
  v2 = *(_QWORD *)(a1 + 3864);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x17u, &WPP_8cdf937d6f313bc131af68fc7a29b768_Traceguids, a1);
