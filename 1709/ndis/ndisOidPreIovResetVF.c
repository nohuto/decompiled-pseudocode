/*
 * XREFs of ndisOidPreIovResetVF @ 0x1C00F0F70
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovResetVF(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x43u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
  {
LABEL_4:
...
LABEL_13:
  ...
  {
    v8 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x44u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v4, v8);
  }
  return v4;
}
