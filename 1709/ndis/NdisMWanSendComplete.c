/*
 * XREFs of NdisMWanSendComplete @ 0x1C00540A0
 * Callers:
 *     ndisMStartWanSends @ 0x1C00571D0 (ndisMStartWanSends.c)
 *     ndisMWanSendCompleteInternal @ 0x1C0057730 (ndisMWanSendCompleteInternal.c)
 * Callees:
...
void __fastcall NdisMWanSendComplete(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqd(0x1Eu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, a3);
  ...
  *(_DWORD *)(a1 + 1856) = 1509064;
  ...
  if ( (*(_DWORD *)(a1 + 120) & 0x40000) != 0 && v6 != 2 )
    KeLowerIrql(v6);
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2);
}
