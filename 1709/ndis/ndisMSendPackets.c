/*
 * XREFs of ndisMSendPackets @ 0x1C00567A0
 * Callers:
 *     ndisMSend @ 0x1C0055F80 (ndisMSend.c)
 * Callees:
...
void __fastcall ndisMSendPackets(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqd(0xAu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, a3);
  v7 = 0;
  v21 = v4;
  v8 = 0;
  v18 = 0;
...
LABEL_28:
  if ( (unsigned __int8)byte_1C009874A >= 4u )
  {
    ...
    WPP_SF_qqd(0xBu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
