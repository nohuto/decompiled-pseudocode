/*
 * XREFs of ndisAoAcInitDisconnectedStandby @ 0x1C004EF40
 * Callers:
 *     ndisDriverReinit @ 0x1C00C9890 (ndisDriverReinit.c)
 * Callees:
...
LABEL_6:
  ...
  while ( v1 )
  {
    ...
    {
      v4 = *(_DWORD *)(i + 124);
      if ( (v4 & 0x200000) != 0 && ndisAoAcCapable || (*(_DWORD *)(i + 2692) & 0x200) != 0 )
      {
        *(_DWORD *)(i + 3888) |= 0x10u;
