/*
 * XREFs of ndisPublishSleepStudyNapsCustomData @ 0x1C00F37F8
 * Callers:
 ...
 *     ndisSleepStudyGetNameFromReasonCode @ 0x1C0074290 (ndisSleepStudyGetNameFromReasonCode.c)
        ...
        else
        {
          if ( v11 )
          {
            ...
            if ( (Microsoft_Windows_SleepStudyEnableBits & 1) != 0 )
              McTemplateK0cjqzr2jx(a1, a2, v14 + 252, v10, v9, *(_DWORD *)(a4 + 8), *(_QWORD *)a4, (__int64)&v26, 0);
          ...
          v25.Data4[0] = v20;
          if ( (Microsoft_Windows_SleepStudyEnableBits & 1) != 0 )
            McTemplateK0cjqzr2jx(v18, v20, v19 + 252, v10, (__int64)&v26, SDWORD2(v24), v24, (__int64)&v25, 0);
