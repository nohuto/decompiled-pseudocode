/*
 * XREFs of ndisOidPrePacketFilter @ 0x1C00BE170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisQueryMiniportPacketFilter @ 0x1C00DD78C (ndisQueryMiniportPacketFilter.c)
...
unsigned __int8 __fastcall ndisOidPrePacketFilter(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0x64u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v5, v3);
  v6 = *(_DWORD *)(v3 + 4);
  switch ( v6 )
  {
    case 2:
...
LABEL_8:
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqqL(0x65u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v5, v3, v4);
  return v4;
}
