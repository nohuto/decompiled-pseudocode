/*
 * XREFs of ndisOidPostIovAllocateVF @ 0x1C006C620
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovAllocateVF(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x21u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 144);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_14:
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x22u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
}
