/*
 * XREFs of ndisMDoProtocolRequest @ 0x1C00ABBF8
 * Callers:
...
__int64 __fastcall ndisMDoProtocolRequest(__int64 a1, __int64 a2, int a3, __int64 a4, int a5, unsigned int a6)
{
  ...
  if ( (unsigned __int8)byte_1C009874D >= 4u )
    WPP_SF_qD(0x39u, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, a3);
  v10 = *(void **)(a1 + 16);
  ...
  *(_DWORD *)&v15[48] = a5;
  ...
  {
    LODWORD(v14) = v9;
    WPP_SF_qdD(0x3Au, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, a3, v14);
  }
  return v9;
}
