/*
 * XREFs of ndisMAbortPackets @ 0x1C0001868
 * Callers:
...
__int64 **__fastcall ndisMAbortPackets(__int64 a1, __int64 a2, struct _NDIS_STACK_RESERVED *a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(68LL, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, 0LL);
  v4 = *(_QWORD **)(a1 + 832);
  if ( v4 )
  {
    *(_QWORD *)(a1 + 832) = *v4;
  ...
  *(_QWORD *)(a1 + 144) = 0LL;
  ...
  {
    v8 = *v5;
    if ( (__int64 **)(*v5)[1] != v5 || (v9 = (__int64 *)*v8, *(__int64 **)(*v8 + 8) != v8) )
      __fastfail(3u);
    *v5 = v9;
    v9[1] = (__int64)v5;
  ...
  *(_QWORD *)(a1 + 144) = 0LL;
  while ( 1 )
  {
    ...
    *(_DWORD *)(a1 + 1856) = 726103;
  }
  *(_DWORD *)(a1 + 120) |= 0x400000u;
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    return (__int64 **)WPP_SF_qq(69LL, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, 0LL);
  return result;
}
