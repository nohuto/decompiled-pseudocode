/*
 * XREFs of ndisReadBindPaths @ 0x1C00C4BB8
 * Callers:
...
__int64 __fastcall ndisReadBindPaths(__int64 a1, _RTL_QUERY_REGISTRY_TABLE *a2, const WCHAR *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0xCu, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1);
  a2->QueryRoutine = 0LL;
  Context = 0LL;
  a2[1].Flags = 20;
  a2[1].DefaultType = 0;
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0xDu, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, v5);
  return v8;
}
