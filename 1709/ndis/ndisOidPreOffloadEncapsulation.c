/*
 * XREFs of ndisOidPreOffloadEncapsulation @ 0x1C00C3900
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreOffloadEncapsulation(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0xDAu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v4, v3);
  v5 = (_DWORD *)(a1 + 40);
...
LABEL_9:
  ...
  {
    LODWORD(v12) = v10;
    WPP_SF_qqDD(0xDBu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v4, v12, *v5);
  }
  return v10;
}
