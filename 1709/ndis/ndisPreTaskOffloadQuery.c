/*
 * XREFs of ndisPreTaskOffloadQuery @ 0x1C0046A58
 * Callers:
...
char __fastcall ndisPreTaskOffloadQuery(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqDD(0xE2u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v7, a1, 1, *(_DWORD *)(a2 + 40));
  if ( !*(_QWORD *)(v7 + 4120) )
    goto LABEL_15;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
  {
    ...
    LODWORD(v13) = 1;
    WPP_SF_qqDD(0xE3u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v7, a1, v13, v14);
  }
  return 1;
}
