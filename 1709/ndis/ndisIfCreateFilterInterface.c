/*
 * XREFs of ndisIfCreateFilterInterface @ 0x1C00043A0
 * Callers:
...
__int64 __fastcall ndisIfCreateFilterInterface(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(201LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
...
LABEL_10:
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(202LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1, v5);
  return v5;
}
