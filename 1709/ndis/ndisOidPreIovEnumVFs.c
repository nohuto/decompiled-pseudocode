/*
 * XREFs of ndisOidPreIovEnumVFs @ 0x1C006D2E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVFs(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x29u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
...
LABEL_48:
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x2Au, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v1, v6[10]);
  return v7;
}
