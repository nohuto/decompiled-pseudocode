/*
 * XREFs of ndisMiniportPreAddProtocolOffload @ 0x1C00DF510
 * Callers:
...
__int64 __fastcall ndisMiniportPreAddProtocolOffload(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x5Eu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, a2);
  v8 = *(_DWORD **)(a2 + 40);
  *a3 = 1;
...
LABEL_15:
    ...
    if ( (unsigned __int8)byte_1C0098755 >= 2u )
      WPP_SF_d(0x5Fu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v14);
  }
  v3 = -1073676267;
LABEL_30:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qdD(0x60u, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, (unsigned __int8)*a3, v3);
  return v3;
}
