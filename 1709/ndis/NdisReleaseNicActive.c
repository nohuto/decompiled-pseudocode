/*
 * XREFs of NdisReleaseNicActive @ 0x1C00750D0
 * Callers:
 ...
 *     ?ndisValidComponentId@@YAEW4_NDIS_PM_COMPONENT_ID@@@Z @ 0x1C00748D0 (-ndisValidComponentId@@YAEW4_NDIS_PM_COMPONENT_ID@@@Z.c)
...
void __fastcall NdisReleaseNicActive(__int64 a1, enum _NDIS_PM_COMPONENT_ID a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_qD(0x34u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, a1, a2);
  if ( ndisValidComponentId(a2) && v2->AoAc )
  {
    ...
    if ( (unsigned __int8)byte_1C0098755 >= 4u )
      WPP_SF_dd(0x35u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, v4, v7);
  }
}
