/*
 * XREFs of ?ndisPDPcwQueueDepthCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C0076790
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisCountSetBits64@@YAK_K@Z @ 0x1C007643C (-ndisCountSetBits64@@YAK_K@Z.c)
 ...
 *     ?ndisWildCardStringMatch@@YAEPEBU_UNICODE_STRING@@0E@Z @ 0x1C00C9E9C (-ndisWildCardStringMatch@@YAEPEBU_UNICODE_STRING@@0E@Z.c)
 */
...
__int64 __fastcall ndisPDPcwQueueDepthCallback(int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  v19.m_Lock = (KPushLockBase *)qword_1C00987F8;
  v19.m_Region.m_Entered = 0;
  KLockHolder::AcquireExclusive(&v19);
  v6 = qword_1C00987F8;
  v7 = qword_1C00987F8 + 8;
  v8 = *(_QWORD **)(qword_1C00987F8 + 8);
  while ( v8 != (_QWORD *)v7 )
  {
    v9 = (__int64 *)v8[6];
    if ( v9 != v8 + 6 )
