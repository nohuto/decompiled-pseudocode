/*
 * XREFs of ndisMSendCompleteX @ 0x1C0056260
 * Callers:
...
void __fastcall ndisMSendCompleteX(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqd(0x12u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, a3);
  v6 = KfRaiseIrql(2u);
  ...
  *(_QWORD *)v9 = 1297040182LL;
  ...
  if ( v6 != 2 )
    KeLowerIrql(v6);
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x13u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2);
}
