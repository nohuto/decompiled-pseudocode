/*
 * XREFs of ?NdisTraceLoggingGreTaskeConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0024088
 * Callers:
...
void __fastcall NdisTraceLoggingGreTaskeConfigOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v22 = 1LL;
      v24 = 4LL;
      TlgWrite(&hProvider, &unk_1C008407F, v2, (LPCGUID)v3, 8u, &pData);
    }
  }
}
