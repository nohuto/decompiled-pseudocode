/*
 * XREFs of ndisOidTranslateBetweenOids @ 0x1C000D5AC
 * Callers:
...
__int64 __fastcall ndisOidTranslateBetweenOids(_BYTE *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_q(255LL, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a3);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    return WPP_SF_q(256LL, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a3);
  return result;
}
