/*
 * XREFs of ?ndisWdfSetBusySync@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_SS_BUSY_REASON@@K@Z @ 0x1C006EE2C
 * Callers:
...
void __fastcall ndisWdfSetBusySync(struct _NDIS_MINIPORT_BLOCK *a1, unsigned __int32 a2, unsigned int a3)
{
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0098756 >= 4u )
      WPP_SF_qD(0x24u, &WPP_72bd2a87b7f83093ce8d5792cc2b4ff7_Traceguids, (__int64)a1, a2);
