/*
 * XREFs of NdisMDeregisterInterruptEx @ 0x1C00FF6A0
 * Callers:
...
void __stdcall NdisMDeregisterInterruptEx(NDIS_HANDLE NdisInterruptHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x15u, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, v1, NdisInterruptHandle);
  ...
  *(_DWORD *)(v1 + 1856) = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x16u, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, v1);
}
