/*
 * XREFs of ndisOidPreSetPortAuthentication @ 0x1C0046740
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSetPortAuthentication(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0xD2u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, *(_DWORD *)(v2 + 8));
  if ( *(_QWORD *)a1 )
  {
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0xD3u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, *(_DWORD *)(v2 + 8));
  return v3;
}
