/*
 * XREFs of ?NdisTraceLoggingChecksumConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C00124D4
 * Callers:
...
void __fastcall NdisTraceLoggingChecksumConfigOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v30 = (v10 >> 6) & 3;
      v81 = 1LL;
      TlgWrite(&hProvider, &unk_1C008493C, v2, (LPCGUID)v3, 0x19u, &pData);
    }
  }
}
