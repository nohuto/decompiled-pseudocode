/*
 * XREFs of ndisRequestedDevicePowerIrpComplete @ 0x1C001FFC0
 * Callers:
        ...
        const unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_q(56LL, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, Arg2);
  v7 = *(_QWORD *)(a4 + 184);
  ...
  *(_OWORD *)(a4 + 48) = *(_OWORD *)a5;
  if ( *(int *)a5 < 0 )
  {
    if ( (unsigned __int8)byte_1C0098755 >= 2u )
      WPP_SF_q(58LL, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, Arg2);
    Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER>::Release(v8 + 5256);
    if ( (Microsoft_Windows_NDISEnableBits & 0x400000) != 0 )
      McTemplateK0qqq(v10, &IrpSetPowerFailed, &NDIS_PROVIDER_ID, *a5, 0x787u, (const unsigned int)Arg2);
    IofCompleteRequest((PIRP)a4, 0);
  }
  else
  {
    if ( (unsigned __int8)byte_1C0098755 >= 4u )
      WPP_SF_qD(57LL, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, Arg2, *(unsigned int *)(v7 + 24));
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_q(59LL, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, Arg2);
}
