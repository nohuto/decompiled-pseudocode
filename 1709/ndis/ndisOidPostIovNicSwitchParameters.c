/*
 * XREFs of ndisOidPostIovNicSwitchParameters @ 0x1C006CCF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovNicSwitchParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(
      0x1Bu,
      &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids,
      v3,
      v1,
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
}
