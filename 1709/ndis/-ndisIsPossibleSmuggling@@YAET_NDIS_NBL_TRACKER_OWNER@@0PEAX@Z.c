/*
 * XREFs of ?ndisIsPossibleSmuggling@@YAET_NDIS_NBL_TRACKER_OWNER@@0PEAX@Z @ 0x1C0066574
 * Callers:
...
char __fastcall ndisIsPossibleSmuggling(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rax
  __int64 v4; // r8
  bool v6; // zf
  ...
  if ( a2 == 24 )
  {
    v3 = ndisSourceHandleFromOwner(a1, 24LL, a3);
    return v4 != v3;
  }
  if ( (a1 & 1) != (a2 & 1) )
    return 1;
  if ( (a2 & 1) != 0 )
  {
    if ( (a1 & 4) != 0 || (a2 & 4) != 0 )
      return 0;
    v6 = ((a2 ^ a1) & 0xFFFFFFFFFFFFFFF8uLL) == 0;
  }
  else
  {
    v6 = a1 == a2;
