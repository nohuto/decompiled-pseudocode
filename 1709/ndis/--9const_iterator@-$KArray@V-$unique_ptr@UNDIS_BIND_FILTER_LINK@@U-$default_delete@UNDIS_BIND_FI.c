/*
 * XREFs of ??9const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QEBA_NAEBV012@@Z @ 0x1C00BC158
 * Callers:
...
bool __fastcall Rtl::KArray<wistd::unique_ptr<NDIS_BIND_FILTER_LINK,wistd::default_delete<NDIS_BIND_FILTER_LINK>>,1>::const_iterator::operator!=(
        __int64 a1,
        __int64 a2)
{
