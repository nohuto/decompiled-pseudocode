/*
 * XREFs of NdisMRegisterInterrupt @ 0x1C00EA650
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_INTERRUPT_MODE InterruptMode)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xCu, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, (__int64)MiniportAdapterHandle, InterruptLevel);
  ...
  *((_DWORD *)MiniportAdapterHandle + 30) &= ~0x20u;
  ...
  if ( v11 )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_qD(0xDu, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, (__int64)MiniportAdapterHandle, v7);
  ...
  if ( v25 )
  {
    ...
    *(_WORD *)&Parameters.MessageBased.SynchronizeIrql = v8;
    ...
    if ( v18 < 0 )
    {
      v11 = -1073741823;
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
        WPP_SF_dd(0xEu, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, v8, v17);
      if ( (Microsoft_Windows_NDISEnableBits & 0x100) != 0 )
        McTemplateK0jqxqqq(
          v19,
          &RegisterInterruptFailed,
...
LABEL_23:
  ...
  {
    LODWORD(v22) = v11;
    WPP_SF_qdD(0xFu, &WPP_89199a78c9ed372c807b20ed02a65825_Traceguids, (__int64)MiniportAdapterHandle, v8, v22);
  }
  return v11;
}
