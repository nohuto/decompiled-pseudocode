/*
 * XREFs of ndisMSendPacketsToMiniport @ 0x1C0056BE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToMiniport(struct _NDIS_MINIPORT_BLOCK *a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qqd(0xCu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, a3);
  v18 = 0;
  ...
  {
    LODWORD(v17) = a3;
    WPP_SF_qqd(0xDu, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2, v17);
  }
}
