/*
 * XREFs of ndisFreeReceiveQueue @ 0x1C003A1AC
 * Callers:
 *     ndisOidPostRcvFilterAllocateQueue @ 0x1C003A2A0 (ndisOidPostRcvFilterAllocateQueue.c)
 *     ndisOidPostRcvFilterFreeQueue @ 0x1C003A510 (ndisOidPostRcvFilterFreeQueue.c)
 * Callees:
...
__int64 __fastcall ndisFreeReceiveQueue(__int64 a1, unsigned int a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098760 >= 4u )
    WPP_SF_qD(0x12u, &WPP_ffc4cf2032893579d26374b00adf8efd_Traceguids, a1, a2);
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( v6 )
    ...
    v4 = -1073741811;
  if ( (unsigned __int8)byte_1C0098760 >= 4u )
    WPP_SF_qdD(0x13u, &WPP_ffc4cf2032893579d26374b00adf8efd_Traceguids, a1, a2, v4);
  return v4;
}
