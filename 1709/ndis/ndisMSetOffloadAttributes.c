/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C00C0320
 * Callers:
 ...
 *     ndisValidateOffloadCapability @ 0x1C00C06A0 (ndisValidateOffloadCapability.c)
 *     ndisValidateConnectionOffload @ 0x1C00EDA9C (ndisValidateConnectionOffload.c)
 */
