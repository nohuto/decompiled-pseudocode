/*
 * XREFs of McTemplateK0qxqqq @ 0x1C00402C0
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qxqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v19 = 4LL;
  v18 = &a8;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &ChangeNotificationInterfaceInfo, &NDIS_PROVIDER_ID, 6u, &v9);
}
