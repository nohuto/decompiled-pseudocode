/*
 * XREFs of ndisOidPreQosGetParameters @ 0x1C0046450
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosGetParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x85u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v1);
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_21:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x86u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v4, v9);
  }
  return v4;
}
