/*
 * XREFs of ndisXlateWakeUpPatternListToWolPatternList @ 0x1C00E2AEC
 * Callers:
 *     ndisOidPostWolPatternList @ 0x1C0049970 (ndisOidPostWolPatternList.c)
 * Callees:
 *     WPP_SF_ @ 0x1C0024644 (WPP_SF_.c)
 *     memmove @ 0x1C0024F40 (memmove.c)
 *     memset @ 0x1C0025280 (memset.c)
 *     ndisGetWakeUpPatternSize @ 0x1C0048BA0 (ndisGetWakeUpPatternSize.c)
 */
...
void __fastcall ndisXlateWakeUpPatternListToWolPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v5 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0098752 >= 2u )
      WPP_SF_(0x76u, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids);
    return;
  }
  if ( !(_DWORD)v5 )
    return;
