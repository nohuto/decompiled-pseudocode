/*
 * XREFs of McTemplateK0jcqjzzz @ 0x1C007566C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jcqjzzz(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        const wchar_t *a10)
{
  ...
  v37 = v19;
  v39 = 0;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &FilterStateChangeEx, a3, 8u, &v22);
}
