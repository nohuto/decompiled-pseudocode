/*
 * XREFs of NdisMResetComplete @ 0x1C005E3D0
 * Callers:
...
void __stdcall NdisMResetComplete(NDIS_HANDLE MiniportAdapterHandle, NDIS_STATUS Status, BOOLEAN AddressingReset)
{
  ...
  if ( (unsigned __int8)byte_1C0098758 >= 4u )
    WPP_SF_q(0x4Au, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 726453;
  if ( v8 )
  {
    DbgPrintEx(
      0x78u,
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  if ( (unsigned __int8)byte_1C0098758 >= 4u )
    WPP_SF_q(0x4Bu, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, (__int64)MiniportAdapterHandle);
}
