/*
 * XREFs of McTemplateK0jqxqqt @ 0x1C0065330
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxqqt(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &QuerySetMiniportDeviceStateFailed, a3, 7u, &v10);
}
