/*
 * XREFs of ndisValidateProtocolDriverCharacteristicsHeader @ 0x1C00BF58C
 * Callers:
...
LABEL_16:
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_DDDDDDDD(0x25u, *(unsigned __int8 *)(a1 + 1), 149, v5);
      return 3221291013LL;
    }
LABEL_10:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
    WPP_SF_DDZ(0x24u, (__int64)a2, v2, v4);
  return 3221291012LL;
}
