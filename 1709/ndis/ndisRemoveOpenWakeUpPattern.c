/*
 * XREFs of ndisRemoveOpenWakeUpPattern @ 0x1C004A5C8
 * Callers:
...
void __fastcall ndisRemoveOpenWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(37LL, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = *(_DWORD **)(a1 + 496);
    v7 = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(38LL, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, a2, a3);
}
