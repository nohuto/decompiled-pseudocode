/*
 * XREFs of ndisIMQueueDeviceInstance @ 0x1C00E44F4
 * Callers:
...
__int64 __fastcall ndisIMQueueDeviceInstance(__int64 a1, const UNICODE_STRING *a2, wchar_t *a3)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x26u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1, a2, a3);
...
LABEL_11:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqqL(0x27u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1, a2, a3, v6);
  return v6;
}
