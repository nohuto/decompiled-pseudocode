/*
 * XREFs of ndisFInvokeDirectOidRequest @ 0x1C0059504
 * Callers:
...
__int64 __fastcall ndisFInvokeDirectOidRequest(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
  {
    ...
    WPP_SF_qLq(0x83u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1, v4);
  }
  ...
  if ( !v6 )
  {
    if ( v12 )
    {
      if ( (unsigned __int8)byte_1C0098752 >= 4u )
      {
        ...
        WPP_SF_qqd(0x84u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a2, v12, v11);
      }
      v9 = (__int64)v7;
    }
    else
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qDqL(0x85u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1, v4);
  return v8;
}
