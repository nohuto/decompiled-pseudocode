/*
 * XREFs of ndisHandleLegacyTransport @ 0x1C00C4E68
 * Callers:
...
__int64 __fastcall ndisHandleLegacyTransport(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009874C >= 4u )
    WPP_SF_q(0x26u, &WPP_46b787ea35393f9b78a3e543862c6c95_Traceguids, a1);
  Context = 0LL;
...
LABEL_9:
          if ( (unsigned __int8)byte_1C009874C >= 4u )
            WPP_SF_(0x28u, &WPP_46b787ea35393f9b78a3e543862c6c95_Traceguids);
  ...
  if ( (unsigned __int8)byte_1C009874C >= 4u )
    WPP_SF_(0x27u, &WPP_46b787ea35393f9b78a3e543862c6c95_Traceguids);
  return 3221225473LL;
}
