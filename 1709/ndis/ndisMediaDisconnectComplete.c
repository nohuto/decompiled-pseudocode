/*
 * XREFs of ndisMediaDisconnectComplete @ 0x1C0065720
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMediaDisconnectComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_q(0x11u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a4);
  ...
  *(_DWORD *)(a4 + 1856) = 1704369;
  if ( (v7 & 0x200) != 0 )
  {
    ...
    *(_DWORD *)(a4 + 124) = v7 & 0xFFFFFDFF;
    ...
    {
      if ( (unsigned __int8)byte_1C0098755 >= 4u )
        WPP_SF_q(0x13u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a4);
  ...
  {
    if ( (unsigned __int8)byte_1C0098755 >= 4u )
      WPP_SF_q(0x12u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a4);
    *(_QWORD *)(a4 + 520) = 0LL;
    *(_DWORD *)(a4 + 1856) = 0;
    KeReleaseSpinLock((PKSPIN_LOCK)(a4 + 96), v6);
  }
  if ( (unsigned __int8)byte_1C0098755 >= 4u )
    WPP_SF_q(0x14u, &WPP_e05c952d5e8835369671e8581ad3d444_Traceguids, a4);
}
