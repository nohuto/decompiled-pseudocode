/*
 * XREFs of ndisSourcePreAddProtocolOffload @ 0x1C00E1E00
 * Callers:
...
__int64 __fastcall ndisSourcePreAddProtocolOffload(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x5Cu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, a3);
  v9 = *(int **)(a3 + 40);
  *a4 = 1;
  if ( a1 )
    v10 = *(_QWORD *)(a1 + 16);
...
LABEL_16:
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qdD(0x5Du, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1, (unsigned __int8)*a4, v8);
  return v8;
}
