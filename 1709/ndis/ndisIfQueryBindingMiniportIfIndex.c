/*
 * XREFs of ndisIfQueryBindingMiniportIfIndex @ 0x1C00B5FDC
 * Callers:
...
__int64 __fastcall ndisIfQueryBindingMiniportIfIndex(__int64 a1, _DWORD *a2, _QWORD *a3, _DWORD *a4, _QWORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x32u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
  *a2 = 0;
  *a3 = 0LL;
  *a4 = 0;
  *a5 = 0LL;
  ...
  *a3 = v11;
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x33u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
  return 0LL;
}
