/*
 * XREFs of ndisInvokeNextSendCompleteHandler @ 0x1C0059E78
 * Callers:
 ...
 *     ndisFakeFilterSendHandler @ 0x1C0059A60 (ndisFakeFilterSendHandler.c)
 * Callees:
  ...
  if ( ndisIterativeDataPathDisabled || (a2 & 1) == 0 && KeGetCurrentIrql() != 2 )
  {
    if ( a3->Header.Type == 5 )
    {
      ...
      if ( KeExpandKernelStackAndCalloutEx(
             ...
             0,
             0LL) < 0 )
        ndisQueueStackExpansionFallbackNbls(a3, a1, 1);
      return;
    }
LABEL_19:
      ...
      *v10 = 0LL;
      if ( v16 )
      {
        do
        {
          ...
          v16->ChildRefCount = 0;
          ndisCallSendCompleteHandler(v6, v12, v22, v16, 0, 0, ChildRefCount);
          v16 = Scratch;
        }
        while ( Scratch );
        v11 = v22;
