/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00F68E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_44:
  ...
  *((_QWORD *)v4 + 12) = a2->RxFilterContext;
  v25.m_Lock = (KPushLockBase *)qword_1C00987F8;
