/*
 * XREFs of ndisIovFreeVF @ 0x1C006C12C
 * Callers:
 *     ndisOidPostIovFreeVF @ 0x1C006CCA0 (ndisOidPostIovFreeVF.c)
 * Callees:
...
__int64 __fastcall ndisIovFreeVF(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x25u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, 0LL, P);
  if ( *((_DWORD *)v2 + 19) )
  {
    v1 = -1073741811;
  }
  ...
  {
    v14 = v1;
    WPP_SF_qqd(0x26u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v2, v14);
  }
  return v1;
}
