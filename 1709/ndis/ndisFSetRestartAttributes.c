/*
 * XREFs of ndisFSetRestartAttributes @ 0x1C00C3FB0
 * Callers:
...
__int64 __fastcall ndisFSetRestartAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x21u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1);
  if ( a2 )
  {
    if ( *(_BYTE *)(a1 + 1) == 1 )
    {
            ...
            *(_DWORD *)(v7 + 5100) = v8 | 0x20;
            if ( !v8 || !*(_QWORD *)(v7 + 5064) )
            {
              if ( (unsigned __int8)byte_1C0098763 >= 5u )
                WPP_SF_dd(0xFu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v8, v8 | 0x20);
              v9 = (unsigned __int8)byte_1C0098763 < 4u;
              *(_BYTE *)(*(_QWORD *)(v7 + 5064) + 5240LL) = 1;
              if ( !v9 )
              {
                ...
                if ( (unsigned __int8)byte_1C0098763 >= 4u )
                  WPP_SF_Zq(0x22u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, (const wchar_t *)v10[1], v10[0]);
              }
            }
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x23u, &WPP_adcd8872ba6737e2e82ea4a41ce92341_Traceguids, a1);
  return v4;
}
