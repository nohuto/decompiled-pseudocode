/*
 * XREFs of PpRegStateReadCreateClassCreationSettings @ 0x1C00FD008
 * Callers:
 ...
 *     CmRegUtilOpenExistingWstrKey @ 0x1C00FD3E8 (CmRegUtilOpenExistingWstrKey.c)
 *     CmRegUtilUcValueSetUcString @ 0x1C00FD5AC (CmRegUtilUcValueSetUcString.c)
 *     CmRegUtilWstrValueSetWstrString @ 0x1C00FD708 (CmRegUtilWstrValueSetWstrString.c)
 */
