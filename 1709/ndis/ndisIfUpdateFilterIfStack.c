/*
 * XREFs of ndisIfUpdateFilterIfStack @ 0x1C000469C
 * Callers:
...
void __fastcall ndisIfUpdateFilterIfStack(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(207LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
...
LABEL_4:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(208LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
}
