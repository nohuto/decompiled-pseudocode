/*
 * XREFs of ?ReStartTemporaryPause@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00BD5B4
 * Callers:
    ...
    if ( !v7[10] )
    {
      ...
      else
      {
        if ( (unsigned __int8)byte_1C0098763 >= 5u )
          WPP_SF_dd(0xFu, &WPP_dd4cdbe2961831c412ed9f171c8a4c99_Traceguids, v8, v8 & 0xFFFFFFDF);
        *(_BYTE *)(*(_QWORD *)v7 + 5240LL) = 1;
        v9 = 1;
      }
      if ( v9 && (unsigned __int8)byte_1C0098763 >= 4u )
      {
