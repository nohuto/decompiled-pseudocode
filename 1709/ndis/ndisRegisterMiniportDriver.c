/*
 * XREFs of ndisRegisterMiniportDriver @ 0x1C010D638
 * Callers:
...
__int64 __fastcall ndisRegisterMiniportDriver(struct _DRIVER_OBJECT **a1, _QWORD *a2, unsigned int a3, PVOID *a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xEu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)a1);
  if ( !a1 )
  {
    v4 = -1073741823;
    goto LABEL_38;
...
LABEL_15:
  ...
  else if ( IoAllocateDriverObjectExtension(*a1, (PVOID)0x4E4D4944, 0x4A8u, &DriverObjectExtension) >= 0 )
  {
    ...
    *((_BYTE *)DriverObjectExtension + 25) = *((_BYTE *)a2 + 1);
    ...
    (*a1)->MajorFunction[27] = ndisPnPDispatch;
...
LABEL_38:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)DriverObjectExtension);
  return v4;
}
