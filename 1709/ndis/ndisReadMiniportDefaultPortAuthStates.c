/*
 * XREFs of ndisReadMiniportDefaultPortAuthStates @ 0x1C00AF1A4
 * Callers:
...
__int64 __fastcall ndisReadMiniportDefaultPortAuthStates(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0x35u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1);
...
LABEL_9:
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x36u, &WPP_666d18e4e4b135fd66b72aa04d21ecd1_Traceguids, a1, MiniportMediaSpecificPortAuthStates);
