/*
 * XREFs of ?ndisCmSetThreadState@@YAJPEAU_ETHREAD@@PEAI1@Z @ 0x1C000411C
 * Callers:
 *     ndisNsiSetThreadInformation @ 0x1C00B39B0 (ndisNsiSetThreadInformation.c)
 *     NdisSetThreadObjectCompartmentId @ 0x1C00EE770 (NdisSetThreadObjectCompartmentId.c)
 *     NdisSetThreadObjectCompartmentScope @ 0x1C00EE790 (NdisSetThreadObjectCompartmentScope.c)
 *     ndisNsiSetAllThreadInformation @ 0x1C00EE960 (ndisNsiSetAllThreadInformation.c)
 * Callees:
