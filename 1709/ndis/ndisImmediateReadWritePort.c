/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00E4B70
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00E46A0 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00E46C0 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00E46E0 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00E4720 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00E4750 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00E4780 (NdisImmediateWritePortUshort.c)
 * Callees:
 *     ndisTranslateResources @ 0x1C00C56F8 (ndisTranslateResources.c)
 *     ndisStartMapping @ 0x1C00E4DA4 (ndisStartMapping.c)
 */
