/*
 * XREFs of ndisMSetQosAttributes @ 0x1C00E8804
 * Callers:
...
__int64 __fastcall ndisMSetQosAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qq(0x85u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 64);
  v6 = 20;
  v7 = *(_BYTE *)(v5 + 1);
  if ( !v7 || *(_WORD *)(v5 + 2) < 0x14u )
  {
    if ( (unsigned __int8)byte_1C0098754 >= 5u )
    {
      v18 = v7;
      v19 = 134;
      goto LABEL_22;
...
LABEL_23:
  ...
  if ( !v9 || *(_WORD *)(v8 + 2) < 0x14u )
  {
    if ( (unsigned __int8)byte_1C0098754 >= 5u )
    {
      ...
      v19 = 135;
LABEL_22:
      WPP_SF_DDDD(v19, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, v18, 1);
      goto LABEL_23;
    }
    goto LABEL_23;
  }
...
LABEL_28:
  ...
  {
    v23 = v4;
    WPP_SF_qqd(0x88u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2, v23);
  }
  return v4;
}
