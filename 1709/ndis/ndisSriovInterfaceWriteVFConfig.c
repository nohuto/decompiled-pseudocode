/*
 * XREFs of ndisSriovInterfaceWriteVFConfig @ 0x1C00F25D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVFConfig(void *a1, const void *a2, __int16 a3, int a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x5Bu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x5Cu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
