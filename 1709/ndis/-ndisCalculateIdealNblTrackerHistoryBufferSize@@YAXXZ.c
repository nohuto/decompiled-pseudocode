/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C00ED200
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C011D38C (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00245E0 (__security_check_cookie.c)
 *     memset @ 0x1C0025280 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C011DF80 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
