/*
 * XREFs of NdisGetRssProcessorInformation @ 0x1C001A410
 * Callers:
 *     ndisGetAdapterRssInfo @ 0x1C00E6A54 (ndisGetAdapterRssInfo.c)
 *     ndisGetHardwareInfo @ 0x1C00E6CD0 (ndisGetHardwareInfo.c)
 * Callees:
 *     ndisCalculateRssProcessorCount @ 0x1C001A504 (ndisCalculateRssProcessorCount.c)
 *     ndisPopulateRssProcessorSet @ 0x1C001A5A8 (ndisPopulateRssProcessorSet.c)
 */
