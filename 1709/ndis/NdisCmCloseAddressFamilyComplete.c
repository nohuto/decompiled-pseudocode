/*
 * XREFs of NdisCmCloseAddressFamilyComplete @ 0x1C010F810
 * Callers:
  ...
  if ( !Status )
  {
    ...
    *(_DWORD *)(v4 + 1856) = 1573677;
    ...
    if ( v6 )
    {
      ...
      ndisMDereferenceOpenLocked(*((_QWORD *)NdisAfHandle + 5));
    }
    else
    {
...
LABEL_13:
    ...
    ndisMDereferenceOpenLocked(*((_QWORD *)NdisAfHandle + 46));
    *(_QWORD *)(v4 + 520) = 0LL;
    *(_DWORD *)(v4 + 1856) = 0;
