/*
 * XREFs of ndisMValidatePMWakeReason @ 0x1C0049338
 * Callers:
...
bool __fastcall ndisMValidatePMWakeReason(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 4496) = *(_DWORD *)(v5 + 8);
  ...
  if ( (unsigned __int8)byte_1C0098750 >= 4u )
    WPP_SF_LqZ(0x8Cu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, *(_DWORD *)(v5 + 8), a1, *(_QWORD *)(a1 + 3880));
  if ( *(_BYTE *)v5 != 0x80
    || *(_BYTE *)(v5 + 1) != 1
    ...
    || v9 + (int)v8 > (unsigned int)v7 )
  {
    ...
    v12 = 142;
LABEL_33:
    WPP_SF_q(v12, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, a1);
    return 0;
  }
  v10 = *(_DWORD *)(v5 + 8);
  if ( v10 == 1 )
