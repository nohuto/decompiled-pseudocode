/*
 * XREFs of ndisOidPreOffloadCaps @ 0x1C0045FE0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qqDD @ 0x1C0039564 (WPP_SF_qqDD.c)
 *     WPP_SF_qqq @ 0x1C00395C4 (WPP_SF_qqq.c)
 *     ndisQueryFilterOffloadCaps @ 0x1C0046CD0 (ndisQueryFilterOffloadCaps.c)
 *     ndisQueryMiniportOffloadCaps @ 0x1C0046DA4 (ndisQueryMiniportOffloadCaps.c)
 */
...
unsigned __int8 __fastcall ndisOidPreOffloadCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0xECu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v4, v3);
  *((_DWORD *)a1 + 10) = -1073741637;
  ...
  if ( (*(_DWORD *)(v3 + 4) & 0xFFFFFFFD) == 0 )
  {
    if ( a1[2] )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v5 + 32) + 1856LL) = 2311082;
      v8 = *(_DWORD *)(v5 + 60);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
  {
    v11 = *((_DWORD *)a1 + 10);
    LODWORD(v10) = v6;
    WPP_SF_qqDD(0xEDu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v4, v10, v11);
  }
  return v6;
}
