/*
 * XREFs of NdisFreePacket @ 0x1C0020CC0
 * Callers:
      ...
      || *(_DWORD *)(Flink + 48) == 1 )
    {
      ...
      if ( ExQueryDepthSList((PSLIST_HEADER)(Flink + 32)) == Pool->PktsPerBlock )
      {
        *(_QWORD *)(Flink + 16) = MEMORY[0xFFFFF78000000320];
        v5 = *(_QWORD *)Flink;
        if ( *(_QWORD *)(*(_QWORD *)Flink + 8LL) != Flink || (v6 = *(_QWORD **)(Flink + 8), *v6 != Flink) )
          __fastfail(3u);
        *v6 = v5;
        *(_QWORD *)(v5 + 8) = v6;
      ...
      {
        v8 = *(_QWORD *)Flink;
        if ( *(_QWORD *)(*(_QWORD *)Flink + 8LL) != Flink || (v9 = *(_QWORD **)(Flink + 8), *v9 != Flink) )
          __fastfail(3u);
        *v9 = v8;
        *(_QWORD *)(v8 + 8) = v9;
      ...
      if ( MEMORY[0xFFFFF78000000320] > Pool->NextScavengeTick.QuadPart )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (_LIST_ENTRY *)v13->Region != p_AgingBlocks
            || (Alignment = (_LIST_ENTRY *)v13->Alignment, *(_SLIST_HEADER **)(v13->Alignment + 8) != v13) )
          {
            __fastfail(3u);
          }
