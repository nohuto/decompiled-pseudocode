/*
 * XREFs of ?ndisMSendOidPmParametersForAoAc@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00F33DC
 * Callers:
  ...
  *(_DWORD *)&v8[48] = 20;
  ...
  if ( SetMiniport )
  {
    ...
    if ( (unsigned __int8)byte_1C0098755 >= 2u )
      WPP_SF_dq(0x1Cu, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, v6, a1);
  }
  return v6;
}
