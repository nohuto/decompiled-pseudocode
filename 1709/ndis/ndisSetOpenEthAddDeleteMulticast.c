/*
 * XREFs of ndisSetOpenEthAddDeleteMulticast @ 0x1C00C232C
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenEthAddDeleteMulticast(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0x6Bu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, a2);
  IsValidMulticastFilter = ndisIsValidMulticastFilter(*(_QWORD *)(a1 + 16), a1, a2);
  if ( IsValidMulticastFilter )
  {
    if ( (unsigned __int8)byte_1C0098752 < 4u )
      goto LABEL_34;
    WPP_SF_(0x6Cu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids);
LABEL_32:
    if ( (unsigned __int8)byte_1C0098752 >= 4u )
      WPP_SF_qqqDD(0x6Eu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, a2, IsValidMulticastFilter, v4);
LABEL_34:
    if ( !IsValidMulticastFilter )
      goto LABEL_35;
    goto LABEL_55;
...
LABEL_31:
  ...
  *(_DWORD *)(a2 + 56) = 0;
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
  {
    WPP_SF_qqq(0x6Du, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, a1, a2);
    goto LABEL_32;
  }
LABEL_55:
  if ( (dword_1C0099FC4 & 4) != 0 )
    McTemplateK0jqxqqq(
