/*
 * XREFs of ?ndisNsiEnumerateAllIfStackEntriesFull@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C001B190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfStackEntriesFull(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(102LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(103LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, a1, v8);
  return v8;
}
