/*
 * XREFs of NdisMCoRequestComplete @ 0x1C01120A0
 * Callers:
...
void __stdcall NdisMCoRequestComplete(NDIS_STATUS Status, NDIS_HANDLE MiniportAdapterHandle, PNDIS_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(0x31u, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids, MiniportAdapterHandle, Request, Status);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_(0x32u, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids);
}
