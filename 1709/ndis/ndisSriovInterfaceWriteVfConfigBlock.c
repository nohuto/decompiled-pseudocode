/*
 * XREFs of ndisSriovInterfaceWriteVfConfigBlock @ 0x1C00F2760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVfConfigBlock(void *a1, __int16 a2, int a3, const void *a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qD(0x60u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
