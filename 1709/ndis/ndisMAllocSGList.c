/*
 * XREFs of ndisMAllocSGList @ 0x1C004B1B8
 * Callers:
 ...
 *     ?NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z @ 0x1C004AD38 (-NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z.c)
 *     NdisAllocateBuffer @ 0x1C00506E0 (NdisAllocateBuffer.c)
...
LABEL_34:
    if ( (unsigned __int8)byte_1C009874A >= 2u )
      WPP_SF_d(0xEu, &WPP_27989bf75f273fb4647da878cf4d879f_Traceguids, v27);
    if ( v26 )
      IoFreeMdl(v26);
    if ( v25 )
