/*
 * XREFs of ndisOidPostLinkSpeed @ 0x1C0045730
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostLinkSpeed(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x4Du, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x4Eu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v3, v1);
}
