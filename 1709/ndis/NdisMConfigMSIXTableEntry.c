/*
 * XREFs of NdisMConfigMSIXTableEntry @ 0x1C0023CB0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_MSIX_CONFIG_PARAMETERS MSIXConfigParameters)
{
  ...
  {
    v5 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))v3[539];
    if ( !v5 )
      goto LABEL_9;
    v6 = v5(v3[538], MSIXConfigParameters->TableEntry, MSIXConfigParameters->MessageNumber);
    goto LABEL_8;
  }
...
LABEL_12:
  ...
  v8 = (__int64 (__fastcall *)(_QWORD, _QWORD))v3[540];
LABEL_17:
  if ( v8 )
  {
    v6 = v8(v3[538], MSIXConfigParameters->TableEntry);
LABEL_8:
    v4 = v6;
  }
LABEL_9:
