/*
 * XREFs of ?ndisWdfRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@W4_NDIS_TMP_REF_REASON@@@Z @ 0x1C00749CC
 * Callers:
  ...
  if ( (unsigned int)(ActiveState - 1) > 1 )
  {
    if ( ActiveState == NdisNicError )
    {
      if ( (unsigned __int8)byte_1C0098755 >= 2u )
        WPP_SF_q(0x10u, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, (__int64)MiniportAdapterHandle);
...
LABEL_7:
  ...
  else
  {
    if ( (unsigned __int8)byte_1C0098756 >= 2u )
      WPP_SF_qD(0xFu, &WPP_46d537eb543d3d50e210eba5a2082b22_Traceguids, (__int64)MiniportAdapterHandle, v14);
    v15 = -1073741823;
  }
