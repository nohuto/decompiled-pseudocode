/*
 * XREFs of ndisQueryDeviceFlags @ 0x1C00C1F1C
 * Callers:
...
void __fastcall ndisQueryDeviceFlags(const wchar_t *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    else if ( (unsigned __int8)byte_1C0098754 >= 4u )
    {
      WPP_SF_Sd(0x70u, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, a1, DeviceFlags);
    }
    ExFreePoolWithTag(v7, 0);
  }
  else if ( (unsigned __int8)byte_1C0098754 >= 2u )
  {
    WPP_SF_(0x6Eu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids);
  }
}
