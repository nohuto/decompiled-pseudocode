/*
 * XREFs of McTemplateK0jqxzqqQR5 @ 0x1C005CC30
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxzqqQR5(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        __int64 a10)
{
  ...
  v29 = 4 * a9;
  v27 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &NdisErrorLogEntry, a3, 8u, &v14);
}
