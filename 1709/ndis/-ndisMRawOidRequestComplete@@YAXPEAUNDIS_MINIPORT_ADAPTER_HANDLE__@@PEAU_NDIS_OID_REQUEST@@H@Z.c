/*
 * XREFs of ?ndisMRawOidRequestComplete@@YAXPEAUNDIS_MINIPORT_ADAPTER_HANDLE__@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C00421FC
 * Callers:
 *     ?ndisMpHookDefaultOidRequestComplete@@YAXPEAXPEAUNDIS_MINIPORT_HOOK_ADAPTER_HANDLE__@@PEAUNDIS_MINIPORT_ADAPTER_HANDLE__@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C007C260 (-ndisMpHookDefaultOidRequestComplete@@YAXPEAXPEAUNDIS_MINIPORT_HOOK_ADAPTER_HANDLE__@@PEAUNDIS_M.c)
 *     ?ndisMpHookRawOidRequestComplete@@YAXPEAUNDIS_MINIPORT_ADAPTER_HANDLE__@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C007C5A0 (-ndisMpHookRawOidRequestComplete@@YAXPEAUNDIS_MINIPORT_ADAPTER_HANDLE__@@PEAU_NDIS_OID_REQUEST@@.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqd(37LL, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a1, a2, a3);
  v8 = *((_QWORD *)a1 + 473);
  v9 = *(_QWORD *)(v8 + 352);
  if ( !v9 || *(_QWORD *)(v9 + 64) == *(_QWORD *)(v8 + 176) )
    v10 = (NdisWatchdogState *)*((_QWORD *)a1 + 687);
  else
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x26u, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a1, a2);
}
