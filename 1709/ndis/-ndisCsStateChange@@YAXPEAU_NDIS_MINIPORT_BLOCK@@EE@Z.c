/*
 * XREFs of ?ndisCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C0072E00
 * Callers:
 ...
 *     ?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@@Z @ 0x1C00F366C (-ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIO.c)
...
void __fastcall ndisCsStateChange(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  *(_QWORD *)v37.Data4 = 0LL;
  ...
  {
    v14 = &AoAc->CsRefTimes[0].CurrentRefStartTime;
    v15 = 17LL;
    do
    {
      if ( *v14 )
    ...
    if ( !v18 )
    {
      ...
      for ( i = 0; i < 0x11; ++i )
      {
        ...
        if ( TotalRefTime )
        {
          ...
          v38.Data4[0] = i;
          v26 = (&off_1C007FEF0)[2 * (int)i];
          v27 = *((_DWORD *)&off_1C007FEF0 + 4 * (int)i + 2);
          ...
          {
            TotalRefTime = AoAc->TotalCsResiliencyTime;
