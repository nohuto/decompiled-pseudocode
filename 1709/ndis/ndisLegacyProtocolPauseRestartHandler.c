/*
 * XREFs of ndisLegacyProtocolPauseRestartHandler @ 0x1C005C254
 * Callers:
...
void __fastcall ndisLegacyProtocolPauseRestartHandler(__int64 a1, int *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x4Bu, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, *a2);
  if ( *a2 == 8 )
  {
    v5 = 0;
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qD(0x4Cu, &WPP_4a5d38b576c633146a968e2982301690_Traceguids, a1, *a2);
}
