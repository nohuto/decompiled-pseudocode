/*
 * XREFs of NdisMPauseComplete @ 0x1C001DE10
 * Callers:
...
void __stdcall NdisMPauseComplete(NDIS_HANDLE MiniportAdapterHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(151LL, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(152LL, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, MiniportAdapterHandle);
}
