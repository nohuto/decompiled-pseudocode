/*
 * XREFs of ndisMSetNative802_11Attributes @ 0x1C00E8754
 * Callers:
...
__int64 __fastcall ndisMSetNative802_11Attributes(__int64 a1, int a2, int a3, int a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x79u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
  if ( *(_QWORD *)(a1 + 768) )
  {
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
        WPP_SF_q(0x7Au, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1);
    }
    else
    {
      *(_QWORD *)(a1 + 768) = v8;
