/*
 * XREFs of ndisPnPPortDeactivation @ 0x1C003CB2C
 * Callers:
...
__int64 __fastcall ndisPnPPortDeactivation(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C009875E >= 4u )
    WPP_SF_q(0x18u, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
  ...
  if ( v5 && v6 )
  {
    ...
    if ( (PnPFlags & 0x80u) == 0 || *v5 )
    {
      ...
      while ( *v15 )
      {
        ...
        if ( !PortByPortNumber )
        {
          ...
          if ( (unsigned __int8)byte_1C009875E >= 2u )
            WPP_SF_qD(0x1Eu, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1, v5[v14]);
          if ( (dword_1C0099FC4 & 0x40) != 0 )
            McTemplateK0jqxqq(
              v5[v14],
        ...
        if ( *((_DWORD *)PortByPortNumber + 4) != 4 )
        {
          ...
          v19 = 0;
          if ( (unsigned __int8)byte_1C009875E >= 2u )
            WPP_SF_qD(0x1Fu, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1, v5[v14]);
          if ( (dword_1C0099FC4 & 0x40) != 0 )
            McTemplateK0jqxqq(
              v5[v14],
              &PnPPortDeactivationFailed,
        ...
        *((_DWORD *)PortByPortNumber + 4) = 2;
        if ( (unsigned __int8)byte_1C009875E >= 5u )
          WPP_SF_qD(0x20u, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1, *v15);
        ++v14;
        ++v15;
        if ( v14 >= v6 )
          goto LABEL_42;
      ...
      v19 = 0;
      if ( (unsigned __int8)byte_1C009875E >= 2u )
        WPP_SF_q(0x1Du, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
      if ( (dword_1C0099FC4 & 0x40) != 0 )
        McTemplateK0jqxqq(
          v17,
          &PnPPortDeactivationFailed,
...
LABEL_42:
    ...
    else
    {
      ...
      if ( v6 <= 1 )
      {
        ...
        if ( (Flags & 0x10000) != 0 )
        {
          ...
          if ( (unsigned __int8)byte_1C009875E >= 4u )
            WPP_SF_q(0x1Cu, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
        ...
        else
        {
          ...
          v2 = -1071448018;
          if ( (unsigned __int8)byte_1C009875E >= 2u )
            WPP_SF_q(0x1Bu, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
          if ( (dword_1C0099FC4 & 0x40) != 0 )
            McTemplateK0jqxqq(
              v12,
              &PnPPortDeactivationFailed,
      ...
      else
      {
        KeReleaseSpinLock(p_Lock, v7);
        if ( (unsigned __int8)byte_1C009875E >= 2u )
          WPP_SF_q(0x1Au, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
        if ( (dword_1C0099FC4 & 0x40) != 0 )
          McTemplateK0jqxqq(
            v10,
            &PnPPortDeactivationFailed,
  ...
  else
  {
    v2 = -1073741811;
    if ( (unsigned __int8)byte_1C009875E >= 2u )
      WPP_SF_q(0x19u, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
    if ( (dword_1C0099FC4 & 0x40) != 0 )
      McTemplateK0jqxqq(
        (__int64)a1,
        &PnPPortDeactivationFailed,
  ...
  if ( (unsigned __int8)byte_1C009875E >= 4u )
    WPP_SF_q(0x21u, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, (__int64)a1);
  return v2;
}
