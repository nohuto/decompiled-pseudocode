/*
 * XREFs of ndisOidPreLinkState @ 0x1C00C3A40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreLinkState(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0xBDu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, v4);
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0xBEu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, v1, 1, v11);
  }
  return 1;
}
