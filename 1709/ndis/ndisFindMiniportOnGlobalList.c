/*
 * XREFs of ndisFindMiniportOnGlobalList @ 0x1C010D318
 * Callers:
...
wchar_t *__fastcall ndisFindMiniportOnGlobalList(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)SourceString);
  ...
  if ( result )
  {
    ...
    if ( (unsigned __int8)byte_1C0098754 >= 4u )
      WPP_SF_q(0x60u, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)v5);
    return (wchar_t *)v5;
  }
  return result;
}
