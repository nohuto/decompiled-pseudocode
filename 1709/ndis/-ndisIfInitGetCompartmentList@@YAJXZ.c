/*
 * XREFs of ?ndisIfInitGetCompartmentList@@YAJXZ @ 0x1C0021824
 * Callers:
...
__int64 ndisIfInitGetCompartmentList(void)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_(35LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids);
...
LABEL_11:
    ...
    else
    {
      ...
      *(_OWORD *)&v21[135] = xmmword_1C0086410;
...
LABEL_24:
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_d(36LL, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (unsigned int)v1);
