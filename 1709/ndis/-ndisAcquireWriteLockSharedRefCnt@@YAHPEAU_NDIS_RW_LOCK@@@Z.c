/*
 * XREFs of ?ndisAcquireWriteLockSharedRefCnt@@YAHPEAU_NDIS_RW_LOCK@@@Z @ 0x1C005A61C
 * Callers:
 *     NdisAcquireReadWriteLock @ 0x1C0019D50 (NdisAcquireReadWriteLock.c)
 *     ndisAcquireReadWriteLockX @ 0x1C005B198 (ndisAcquireReadWriteLockX.c)
 * Callees:
 *     ?IsReadLockAlreadyHeldByCurrentThread@@YAHPEAU_NDIS_RW_LOCK@@@Z @ 0x1C005A52C (-IsReadLockAlreadyHeldByCurrentThread@@YAHPEAU_NDIS_RW_LOCK@@@Z.c)
 */
