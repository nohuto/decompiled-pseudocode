/*
 * XREFs of ndisIfInitialize @ 0x1C011BF80
 * Callers:
...
__int64 ndisIfInitialize()
{
  ...
  *(_DWORD *)&v17.Length = 655368;
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_(0x13u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids);
  ...
  qword_1C0098990 = (__int64)&ndisIfCompartmentList;
  ndisIfCompartmentList.Flink = &ndisIfCompartmentList;
  qword_1C00989A8 = (__int64)&ndisIfTypesList;
  qword_1C0098C00 = (__int64)&ndisIfNetworkList;
  ndisIfNetworkList.Flink = &ndisIfNetworkList;
  ndisIfTypesList = (struct _NDIS_IF_TYPE *)&ndisIfTypesList;
  qword_1C0098BF0 = (__int64)&ndisIfProviderList;
  ndisIfProviderList.Flink = &ndisIfProviderList;
  qword_1C0098980 = (__int64)&ndisIfList;
  ndisIfList.Flink = &ndisIfList;
  qword_1C00989F8 = (__int64)&ndisIfStackEntryList;
  ndisIfStackEntryList = &ndisIfStackEntryList;
  memset(&xmmword_1C00982B2, 0, 0x202uLL);
  memset(&xmmword_1C00984C2, 0, 0x202uLL);
  ...
  if ( !Status )
  {
    ...
    if ( Status || !ndisIsValidIfStringParts(v2, ParameterValue->ParameterData.StringData.Length) )
    {
      ...
      wmemcpy((wchar_t *)&xmmword_1C00982B2, L"Software Loopback Interface", 27);
    }
    else
    {
      ndisIfLoopbackDescr.Length = v11;
      memmove(&xmmword_1C00982B2, *(const void **)(v12 + 16), v11);
    }
            ...
            ParameterValue->ParameterData.StringData.Length) )
    {
      ...
      wmemcpy((wchar_t *)&xmmword_1C00984C2, L"Loopback Pseudo-Interface", 25);
    }
    else
    {
      ...
      if ( (unsigned __int16)v14 >= (unsigned __int16)v13 )
        v14 = v13;
      memmove(&xmmword_1C00984C2, *(const void **)(v15 + 16), v14);
    }
...
LABEL_23:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_d(0x14u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, v0);
