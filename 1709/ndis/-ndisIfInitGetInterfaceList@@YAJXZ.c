/*
 * XREFs of ?ndisIfInitGetInterfaceList@@YAJXZ @ 0x1C00DABA0
 * Callers:
...
__int64 ndisIfInitGetInterfaceList(void)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_(0xA9u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids);
        ...
        for ( i = v12[7]; v5 < LODWORD(v12[13]); ++v5 )
        {
          ...
          if ( *(_BYTE *)v8 == 0xAE && *(_BYTE *)(v8 + 1) && *(_WORD *)(v8 + 2) >= 0x484u )
          {
            if ( (*(_DWORD *)(v8 + 1084) & 1) != 0 )
            {
              ...
              if ( (unsigned __int8)byte_1C009875D >= 4u )
                WPP_SF_dd(0xAAu, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, v9, v10);
...
LABEL_26:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_d(0xABu, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, InterfaceFromPersistentStore);
