/*
 * XREFs of ndisNetBufferToPacket @ 0x1C004D59C
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(__int64 a1, char a2, PNDIS_PACKET *a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rcx
  $9FC76CE53D4534A99246255A62E85546 *ProtocolReserved; // r9
  _MDL *v10; // rdx
  __int64 v11; // r8
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($9FC76CE53D4534A99246255A62E85546 *)v8->ProtocolReserved;
    if ( !a2 )
