/*
 * XREFs of NdisMWriteConfigBlock @ 0x1C00EF0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMWriteConfigBlock(_QWORD *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x7Du, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1);
  ...
  if ( v8 && (v9 = a1[612]) != 0 && (v10 = a1[580]) != 0 && (*(_BYTE *)(v10 + 8) & 5) == 5 )
    ...
    v11 = -1073741637;
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_q(0x7Eu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, (__int64)a1);
  return v11;
}
