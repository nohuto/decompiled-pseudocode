/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C003F310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetNetworkInfo(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_q(0x70u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1);
...
LABEL_34:
  ...
  if ( (unsigned __int8)byte_1C009875D >= 4u )
    WPP_SF_qD(0x71u, &WPP_2bc6ba5610d33065eb742478dd1ca9e7_Traceguids, (__int64)a1, v3);
