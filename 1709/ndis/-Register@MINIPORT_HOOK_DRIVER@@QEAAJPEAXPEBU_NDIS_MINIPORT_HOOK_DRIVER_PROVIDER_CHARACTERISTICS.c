/*
 * XREFs of ?Register@MINIPORT_HOOK_DRIVER@@QEAAJPEAXPEBU_NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS@@@Z @ 0x1C00FB860
 * Callers:
 *     ?ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C00C98E0 (-ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z.c)
 * Callees:
 ...
 *     ?FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ @ 0x1C00C8444 (-FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ.c)
 */
        ...
        const struct _NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS *a3)
{
  ...
  else
  {
    ...
    *((_QWORD *)this + 2) = a2;
    ...
    v6 = NmrClientAttachProvider(v8, v7, &off_1C007FC40, (PVOID *)this + 3, (const void **)&ProviderDispatch);
    if ( v6 >= 0 )
    {
      v9 = ProviderDispatch;
