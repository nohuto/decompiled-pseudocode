/*
 * XREFs of ndisXlateWolPatternListToWakeUpPatternList @ 0x1C00E2D5C
 * Callers:
 *     ndisOidPostWakeUpPatternList @ 0x1C0049930 (ndisOidPostWakeUpPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWolPatternListToWakeUpPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v4 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0098752 >= 2u )
      WPP_SF_(0x75u, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids);
    return;
  }
  if ( !(_DWORD)v4 )
    return;
