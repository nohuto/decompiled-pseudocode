/*
 * XREFs of ?ndisSendPmOidsForSuspend@@YAHPEAU_NDIS_MINIPORT_BLOCK@@W4_DEVICE_POWER_STATE@@@Z @ 0x1C006E64C
 * Callers:
 ...
 *     ?ndisAoAcIsDataPathPdcActivatorPresent@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C007247C (-ndisAoAcIsDataPathPdcActivatorPresent@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_14:
  ...
  *(_QWORD *)((char *)v11 + 4) = 1LL;
  ...
  if ( v5 )
  {
    ...
    NdisTraceLoggingUnexpectedSelectiveSuspendError(a1, 0x38Bu, v5);
    SelectiveSuspend->LastUnexpectedFailureLine[1] = SelectiveSuspend->LastUnexpectedFailureLine[0];
    SelectiveSuspend->LastUnexpectedFailureLine[0] = 907;
    if ( (unsigned __int8)byte_1C0098756 >= 2u )
    {
      v7 = 19;
LABEL_24:
      WPP_SF_dq(v7, &WPP_72bd2a87b7f83093ce8d5792cc2b4ff7_Traceguids, v5, a1);
    }
  }
  else
  {
    ...
    *(_QWORD *)((char *)v11 + 4) = 1LL;
    ...
    if ( v5 )
    {
      ...
      NdisTraceLoggingUnexpectedSelectiveSuspendError(a1, 0x3ACu, v5);
      v8->LastUnexpectedFailureLine[1] = v8->LastUnexpectedFailureLine[0];
      v8->LastUnexpectedFailureLine[0] = 940;
      if ( (unsigned __int8)byte_1C0098756 >= 2u )
      {
        v7 = 20;
        goto LABEL_24;
