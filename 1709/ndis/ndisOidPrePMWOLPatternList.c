/*
 * XREFs of ndisOidPrePMWOLPatternList @ 0x1C00DFEA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMWOLPatternList(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0x5Au, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v4, v6, v8);
  v9 = *(_QWORD *)(a1 + 24);
  LOBYTE(a4) = 6;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqqL(0x5Bu, &WPP_02d7300eb5383415542bdbf7dfb5e076_Traceguids, v4, v6, v8, *(_DWORD *)(a1 + 40));
  return v7;
}
