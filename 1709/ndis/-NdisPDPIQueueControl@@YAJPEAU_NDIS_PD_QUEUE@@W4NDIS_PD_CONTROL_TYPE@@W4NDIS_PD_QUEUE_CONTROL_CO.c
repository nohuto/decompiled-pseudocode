/*
 * XREFs of ?NdisPDPIQueueControl@@YAJPEAU_NDIS_PD_QUEUE@@W4NDIS_PD_CONTROL_TYPE@@W4NDIS_PD_QUEUE_CONTROL_CODE@@PEAXK3KPEAK@Z @ 0x1C00F64C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a8)
{
  ...
  if ( (unsigned __int8)byte_1C0098764 >= 4u )
    WPP_SF_qdD(0x34u, &WPP_2929d52fc6803c0d5180733d460ecc8a_Traceguids, (__int64)a1, a2, a3);
...
LABEL_27:
  ...
  if ( (v15 & 0x80000000) == 0 )
  {
    ...
    WPP_SF_qD(v18, &WPP_2929d52fc6803c0d5180733d460ecc8a_Traceguids, (__int64)a1, v17);
  }
LABEL_12:
  if ( (unsigned __int8)byte_1C0098764 >= 4u )
  {
