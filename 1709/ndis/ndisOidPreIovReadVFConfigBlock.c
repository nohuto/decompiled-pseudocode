/*
 * XREFs of ndisOidPreIovReadVFConfigBlock @ 0x1C00F0CD0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovReadVFConfigBlock(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0098761 >= 4u )
    WPP_SF_qq(0x3Fu, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v1);
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
  v4 = 0;
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_22:
  ...
  {
    v10 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x40u, &WPP_5ff1401217a93c6fc594d1a65b549c1f_Traceguids, v3, v4, v10);
  }
  return v4;
}
