/*
 * XREFs of NdisSetOptionalHandlers @ 0x1C00C3DF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisSetSSHandlers @ 0x1C00F30F8 (ndisSetSSHandlers.c)
 *     ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C00F7BDC (-ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 */
...
NDIS_STATUS __stdcall NdisSetOptionalHandlers(NDIS_HANDLE NdisHandle, PNDIS_DRIVER_OPTIONAL_HANDLERS OptionalHandlers)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x6Cu, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)NdisHandle);
      ...
      switch ( *(_BYTE *)NdisHandle )
      {
        case 2:
          ...
          *((_QWORD *)NdisHandle + 74) = *(_QWORD *)&OptionalHandlers[10].Header.Type;
          break;
        case 4:
          *((_QWORD *)NdisHandle + 54) = *(_QWORD *)&OptionalHandlers[2].Header.Type;
          *((_QWORD *)NdisHandle + 55) = *(_QWORD *)&OptionalHandlers[4].Header.Type;
          *((_QWORD *)NdisHandle + 56) = *(_QWORD *)&OptionalHandlers[6].Header.Type;
          *((_QWORD *)NdisHandle + 57) = *(_QWORD *)&OptionalHandlers[8].Header.Type;
          *((_QWORD *)NdisHandle + 58) = *(_QWORD *)&OptionalHandlers[10].Header.Type;
          break;
        case 5:
    ...
    switch ( *(_BYTE *)NdisHandle )
    {
      case 3:
        ...
        *((_QWORD *)NdisHandle + 102) = *(_QWORD *)&OptionalHandlers[12].Header.Type;
        break;
      case 4:
        *((_QWORD *)NdisHandle + 42) = *(_QWORD *)&OptionalHandlers[2].Header.Type;
        *((_QWORD *)NdisHandle + 43) = *(_QWORD *)&OptionalHandlers[4].Header.Type;
        *((_QWORD *)NdisHandle + 44) = *(_QWORD *)&OptionalHandlers[6].Header.Type;
        *((_QWORD *)NdisHandle + 45) = *(_QWORD *)&OptionalHandlers[8].Header.Type;
        *((_QWORD *)NdisHandle + 46) = *(_QWORD *)&OptionalHandlers[10].Header.Type;
        *((_QWORD *)NdisHandle + 47) = *(_QWORD *)&OptionalHandlers[12].Header.Type;
        break;
      case 5:
...
LABEL_19:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x6Du, &WPP_94bf37800e1134dcb4e413b6850d45c3_Traceguids, (__int64)NdisHandle, v4);
  return v4;
}
