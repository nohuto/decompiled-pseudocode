/*
 * XREFs of ndisMCleanupMiniportBlockOnStop @ 0x1C00AB714
 * Callers:
 *     ndisInitializeAdapter @ 0x1C00C0828 (ndisInitializeAdapter.c)
 *     ndisPnPRemoveDevice @ 0x1C00FE208 (ndisPnPRemoveDevice.c)
 * Callees:
 *     ?ndisRssV2Uninitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00017D4 (-ndisRssV2Uninitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_11:
  ...
  if ( v13 )
  {
    ndisFreePerProcessorSlot(v13, 5403508);
    *(_QWORD *)(a1 + 3312) = 0LL;
  }
  v14 = *(void **)(a1 + 1984);
  if ( v14 )
