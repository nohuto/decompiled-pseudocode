/*
 * XREFs of ndisMSetSriovAttributes @ 0x1C00CA610
 * Callers:
 ...
 *     ndisIovInitVf @ 0x1C00EF760 (ndisIovInitVf.c)
 */
...
__int64 __fastcall ndisMSetSriovAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qq(0x83u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 48);
...
LABEL_22:
  if ( (unsigned __int8)byte_1C0098754 >= 4u )
    WPP_SF_qqd(0x84u, &WPP_89f39f5878d93d725c4978a535989123_Traceguids, a1, a2, LocallyUniqueId);
