/*
 * XREFs of NdisCoOidRequest @ 0x1C0110F20
 * Callers:
        ...
        PNDIS_OID_REQUEST OidRequest)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qqq(0x3Bu, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids, NdisBindingHandle, NdisAfHandle, OidRequest);
...
LABEL_27:
      ...
      if ( (unsigned __int8)byte_1C0098752 >= 4u )
        WPP_SF_qq(0x3Cu, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids, v13, OidRequest);
      if ( v10 )
...
LABEL_58:
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qD(0x3Du, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids, (__int64)OidRequest, v11);
  return v11;
}
