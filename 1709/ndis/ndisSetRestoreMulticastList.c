/*
 * XREFs of ndisSetRestoreMulticastList @ 0x1C00DD954
 * Callers:
...
void __fastcall ndisSetRestoreMulticastList(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x7Bu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a1, a2);
  v5 = v2;
  v6 = *v2;
...
LABEL_18:
  ...
  *(_DWORD *)(a2 + 48) = 6 * *((_DWORD *)v2 + 92);
  if ( (unsigned __int8)byte_1C0098752 >= 4u )
    WPP_SF_qq(0x7Cu, &WPP_ee6c48cc598f38db05b3783de794da88_Traceguids, a1, a2);
}
