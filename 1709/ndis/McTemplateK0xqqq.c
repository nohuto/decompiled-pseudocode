/*
 * XREFs of McTemplateK0xqqq @ 0x1C0074FA8
 * Callers:
...
NTSTATUS McTemplateK0xqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, a2, a3, 5u, &v4);
}
