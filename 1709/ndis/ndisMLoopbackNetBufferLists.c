/*
 * XREFs of ndisMLoopbackNetBufferLists @ 0x1C0055C7C
 * Callers:
...
void __fastcall ndisMLoopbackNetBufferLists(__int64 a1, __int64 a2, unsigned int a3, char a4, __int64 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x42u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2);
  v9 = a2;
  v15 = 0;
  v10 = a2;
  v16[0] = 0;
...
LABEL_18:
  ...
  *a5 = v10;
  if ( (unsigned __int8)byte_1C009874A >= 4u )
    WPP_SF_qq(0x43u, &WPP_984ad900609636e726551c04f4a7943f_Traceguids, a1, a2);
}
