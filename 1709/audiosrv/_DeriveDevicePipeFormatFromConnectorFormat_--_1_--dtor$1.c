/*
 * XREFs of _DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor$1 @ 0x1800826B3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor_1(__int64 a1, __int64 a2)
{
