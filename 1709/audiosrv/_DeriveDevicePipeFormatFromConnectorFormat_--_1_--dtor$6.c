/*
 * XREFs of _DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor$6 @ 0x1800826EF
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor_6(__int64 a1, __int64 a2)
{
