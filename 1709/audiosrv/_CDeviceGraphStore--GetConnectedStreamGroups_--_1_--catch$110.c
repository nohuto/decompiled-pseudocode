/*
 * XREFs of _CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch$110 @ 0x180096F25
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch_110(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
