/*
 * XREFs of s_ccCreateHandsfreeHidFileFromAudioId @ 0x180065220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindSupportedHidCollection@@YAJPEAV?$CAtlList@PEAGV?$CElementTraits@PEAG@ATL@@@ATL@@PEAPEAXPEAU_HIDP_CAPS@@PEAPEAU_HIDP_PREPARSED_DATA@@@Z @ 0x180064E48 (-FindSupportedHidCollection@@YAJPEAV-$CAtlList@PEAGV-$CElementTraits@PEAG@ATL@@@ATL@@PEAPEAXPEAU.c)
    ...
    *(_QWORD *)&v18 = v12;
    if ( v12 )
      *(_QWORD *)(v12 + 8) = 0LL;
      ...
      v18 = 0uLL;
    ATL::CAtlList<CAudioSessionStore *,ATL::CElementTraits<CAudioSessionStore *>>::FreeNode((__int64)&v18, v11);
    CoTaskMemFree(v13);
  }
  ATL::CAtlList<unsigned short *,ATL::CElementTraits<unsigned short *>>::RemoveAll((__int64 *)&v18);
