/*
 * XREFs of ?GetSpatialAudioPolicyFlags@SpatialAudioDevicePropertyReader@@UEAAJPEAW4SpatialAudioPolicyFlags@@@Z @ 0x1800D2BC0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum SpatialAudioPolicyFlags *a2)
{
  ...
  if ( *((_DWORD *)this + 130) )
  {
    if ( a2 )
    {
      *(_DWORD *)a2 = *((_DWORD *)this + 126);
      return v5;
    }
    v6 = -2147024809;
    if ( (unsigned int)dword_18014A3B0 > 2 )
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetSpatialAudioPolicyFlags");
      v13[0] = 753;
      v16 = v13;
      v18 = &v12;
      v17 = 4LL;
