/*
 * XREFs of ?SetProcessingPeriodInternal@CPolicyConfig@@CAJPEAVCEndpointCharacteristics@@PEA_J@Z @ 0x180088AB4
 * Callers:
...
__int64 __fastcall CPolicyConfig::SetProcessingPeriodInternal(struct CEndpointCharacteristics *a1, BYTE *a2)
{
  ...
  if ( *(_QWORD *)a2 && (unsigned __int64)(*(_QWORD *)a2 - 50000LL) > 0xE7EF0 )
  {
    v2 = -2005139386;
LABEL_9:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetProcessingPeriodInternal", 3511, v2);
