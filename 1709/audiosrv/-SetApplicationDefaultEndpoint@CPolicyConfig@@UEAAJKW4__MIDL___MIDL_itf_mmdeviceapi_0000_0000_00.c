/*
 * XREFs of ?SetApplicationDefaultEndpoint@CPolicyConfig@@UEAAJKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEBG@Z @ 0x180087230
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  Instance = -2147024809;
LABEL_16:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetApplicationDefaultEndpoint", 4341, Instance);
  v8 = v16;
  v9 = v17;
LABEL_17:
  if ( v9 )
