/*
 * XREFs of ?Invoke@CAudioStreamCreate@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x180014060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStreamCreate::Invoke(__int64 a1, CAudioSessionManager **a2)
{
  unsigned int v3; // edi
  CAudioSessionManager *v4; // rcx
  unsigned int (__fastcall *v5)(CServerAudioSessionControl *__hidden); // rax

  v3 = (*(__int64 (__fastcall **)(CAudioSessionManager *, _QWORD, __int64))(*(_QWORD *)*a2 + 88LL))(
         *a2,
         *(_QWORD *)(a1 + 8),
