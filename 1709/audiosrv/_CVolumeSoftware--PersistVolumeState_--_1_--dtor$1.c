/*
 * XREFs of _CVolumeSoftware::PersistVolumeState_::_1_::dtor$1 @ 0x180069EFA
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CVolumeSoftware::PersistVolumeState_::_1_::dtor_1(__int64 a1, __int64 a2)
{
