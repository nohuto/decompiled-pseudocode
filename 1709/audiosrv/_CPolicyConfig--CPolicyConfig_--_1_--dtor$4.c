/*
 * XREFs of _CPolicyConfig::CPolicyConfig_::_1_::dtor$4 @ 0x180060D54
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CPolicyConfig::CPolicyConfig_::_1_::dtor_4(__int64 a1, __int64 a2)
{
  `eh vector destructor iterator'(
    (char *)(*(_QWORD *)(a2 + 80) + 160LL),
    72LL,
    7LL,
