/*
 * XREFs of ?GetAudioSessionControl@CAudioSessionManager@@UEAAJK_NPEAVCAudioSession@@PEAPEAVCServerAudioSessionControl@@@Z @ 0x1800161A0
 * Callers:
        ...
        struct CServerAudioSessionControl **a5)
{
  ...
  if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_8db53f7ca00634d48047c78d0b32a6d0_Traceguids, a2);
      v8 = WPP_GLOBAL_Control;
    }
    if ( v8 != (CAudioDGProcess *)&WPP_GLOBAL_Control && (*((_BYTE *)v8 + 28) & 0x40) != 0 && *((_BYTE *)v8 + 25) >= 4u )
      WPP_SF_S(*((_QWORD *)v8 + 2), 15LL, &WPP_8db53f7ca00634d48047c78d0b32a6d0_Traceguids, 0LL);
  }
  ...
  if ( v9 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 16LL, &WPP_8db53f7ca00634d48047c78d0b32a6d0_Traceguids, v9);
    }
    v12 = v14;
    *a5 = 0LL;
  }
  ...
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionManager::GetAudioSessionControl", 0x1EBu, v10);
  if ( v12 )
