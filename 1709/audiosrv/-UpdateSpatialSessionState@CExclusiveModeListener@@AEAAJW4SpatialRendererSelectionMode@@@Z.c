/*
 * XREFs of ?UpdateSpatialSessionState@CExclusiveModeListener@@AEAAJW4SpatialRendererSelectionMode@@@Z @ 0x1800C7508
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v23 = 4;
    v24 = 0;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_180111471, a3, a4, 4u, &pData);
  }
  if ( a2 != *(_DWORD *)(a1 + 152) )
  {
    *(_DWORD *)(a1 + 152) = a2;
