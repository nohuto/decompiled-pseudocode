/*
 * XREFs of AudioServerGetEndpointBufferSize @ 0x18008EEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetEndpointBufferSize(_OWORD *a1, __int64 a2, __int64 a3)
{
  int v6; // eax
  unsigned int v7; // ebx
  ...
  v6 = (*(__int64 (__fastcall **)(_OWORD *, __int64, __int64))(*(_QWORD *)a1 + 112LL))(a1, a2, a3);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetEndpointBufferSize", 3383, v6);
