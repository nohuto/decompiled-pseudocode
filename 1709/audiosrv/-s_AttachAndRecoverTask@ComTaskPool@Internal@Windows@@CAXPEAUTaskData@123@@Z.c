/*
 * XREFs of ?s_AttachAndRecoverTask@ComTaskPool@Internal@Windows@@CAXPEAUTaskData@123@@Z @ 0x1800E59B4
 * Callers:
 ...
 *     ?s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1800E5A20 (-s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTA.c)
        ...
        struct Windows::Internal::ComTaskPool::TaskData *this)
{
              ...
              *((_QWORD *)this + 2)) < 0 )
  {
    ...
    if ( qword_18014C710 )
      *(_QWORD *)(qword_18014C710 + 24) = this;
    else
      Windows::Internal::ComTaskPool::s_taskFloodingList = this;
    qword_18014C710 = (__int64)this;
