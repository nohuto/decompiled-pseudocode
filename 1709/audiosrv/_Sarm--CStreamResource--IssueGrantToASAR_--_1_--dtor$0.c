/*
 * XREFs of _Sarm::CStreamResource::IssueGrantToASAR_::_1_::dtor$0 @ 0x1800C4E88
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall Sarm::CStreamResource::IssueGrantToASAR_::_1_::dtor_0(__int64 a1, __int64 a2)
{
