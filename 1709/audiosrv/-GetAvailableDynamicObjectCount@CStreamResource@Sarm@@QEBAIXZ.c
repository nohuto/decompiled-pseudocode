/*
 * XREFs of ?GetAvailableDynamicObjectCount@CStreamResource@Sarm@@QEBAIXZ @ 0x1800C484C
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::GetAvailableDynamicObjectCount(Sarm::CEndpointResourcePool **this)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v11 = 16;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_18011119F, v2, v3, 5u, &pData);
  }
  return v5[0];
}
