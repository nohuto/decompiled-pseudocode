/*
 * XREFs of _CVolumeStrip::RuntimeClassInitialize_::_1_::dtor$1 @ 0x18006E0BA
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CVolumeStrip::RuntimeClassInitialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
