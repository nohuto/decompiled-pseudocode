/*
 * XREFs of ?LogVolumePolicyChange@CSpatialAudioResourceManagerTraceLogger@@QEAAXKPEBG@Z @ 0x1800C3DF4
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v10 = 0;
    TlgCreateWsz(&v11, a3);
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_180110E62, v3, v4, cData, &pData);
  }
}
