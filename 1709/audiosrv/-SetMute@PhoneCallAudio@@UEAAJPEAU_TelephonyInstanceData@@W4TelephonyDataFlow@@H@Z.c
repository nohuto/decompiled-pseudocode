/*
 * XREFs of ?SetMute@PhoneCallAudio@@UEAAJPEAU_TelephonyInstanceData@@W4TelephonyDataFlow@@H@Z @ 0x1800C8B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PhoneCallAudio::SetMute(
        ...
        unsigned int a4)
{
  ...
  if ( a3 )
  {
    ...
    if ( v9 )
    {
      ...
      v10 = PhoneCallAudio::DoSetCellularRxMute((PhoneCallAudio *)&a1[-1].SpinCount, a2, a4);
      if ( v10 < 0 )
        goto LABEL_9;
    }
    v10 = PhoneCallAudio::DoSetCellularTxMute((PhoneCallAudio *)&a1[-1].SpinCount, a2, a4);
    if ( v10 < 0 )
LABEL_9:
      v8 = v10;
  }
  ...
  {
    v11 = PhoneCallAudio::DoSetCellularRxMute((PhoneCallAudio *)&a1[-1].SpinCount, a2, a4);
    if ( v11 < 0 )
      v8 = v11;
  }
LABEL_12:
