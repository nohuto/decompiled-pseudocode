/*
 * XREFs of _CPolicyConfig::SetDeviceFormatSwAudioEngine_::_1_::dtor$1 @ 0x180088111
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::SetDeviceFormatSwAudioEngine_::_1_::dtor_1(__int64 a1, __int64 a2)
{
