/*
 * XREFs of _AudioDeviceMgr::ProcessOnDeviceStateChanged_::_1_::dtor$3 @ 0x1800E7EA9
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::ProcessOnDeviceStateChanged_::_1_::dtor_3(__int64 a1, __int64 a2)
{
