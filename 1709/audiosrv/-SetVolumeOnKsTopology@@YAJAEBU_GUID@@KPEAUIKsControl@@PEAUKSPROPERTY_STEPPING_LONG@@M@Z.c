/*
 * XREFs of ?SetVolumeOnKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING_LONG@@M@Z @ 0x1800EEDCC
 * Callers:
 *     ?SetCellularVolume@TelephonyController@@UEAAJM@Z @ 0x1800EED90 (-SetCellularVolume@TelephonyController@@UEAAJM@Z.c)
 * Callees:
