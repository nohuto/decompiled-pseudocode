/*
 * XREFs of ?UpdateDeviceFormatEPProperty@CEndpointCharacteristics@@QEAAJ_NW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@@Z @ 0x1800B8530
 * Callers:
...
LABEL_22:
  ...
  LogEPCError("CEndpointCharacteristics::UpdateDeviceFormatEPProperty", 6281, v8);
  if ( v12 )
