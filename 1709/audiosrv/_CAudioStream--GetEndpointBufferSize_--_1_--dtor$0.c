/*
 * XREFs of _CAudioStream::GetEndpointBufferSize_::_1_::dtor$0 @ 0x18007C89D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioStream::GetEndpointBufferSize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
