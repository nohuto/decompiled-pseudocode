/*
 * XREFs of _AudioDeviceMgr::CreatePhoneTopology_::_1_::dtor$0 @ 0x1800E6DE4
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::CreatePhoneTopology_::_1_::dtor_0(__int64 a1, __int64 a2)
{
