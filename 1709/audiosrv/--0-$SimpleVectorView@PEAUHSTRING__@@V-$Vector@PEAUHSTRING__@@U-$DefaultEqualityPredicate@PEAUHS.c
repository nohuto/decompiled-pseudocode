        ...
        _DWORD *a2)
{
  ...
  *(_QWORD *)(a1 + 24) = &Microsoft::WRL::RuntimeClass<Windows::Foundation::Collections::IVectorView<HSTRING__ *>,Windows::Foundation::Collections::IIterable<HSTRING__ *>,Microsoft::WRL::FtmBase>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::FtmBase>'};
  *(_QWORD *)(a1 + 72) = 1LL;
  if ( v4 )
    (*(void (__fastcall **)(CAudioDGProcess *))(*(_QWORD *)v4 + 8LL))(v4);
