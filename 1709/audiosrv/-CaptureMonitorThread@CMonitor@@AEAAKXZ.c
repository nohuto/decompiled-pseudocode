/*
 * XREFs of ?CaptureMonitorThread@CMonitor@@AEAAKXZ @ 0x1800A787C
 * Callers:
 *     ?CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z @ 0x1800A7980 (-CaptureMonitorThreadWrapper@CMonitor@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x1800AB95C (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 *     ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x1800AB9A8 (-SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z.c)
 */
...
__int64 __fastcall CMonitor::CaptureMonitorThread(HANDLE *this)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, (__int64)&WPP_bd0193786e9e34b543d459a2183e6794_Traceguids, v2);
  }
  Handles[0] = this[36];
  Handles[1] = this[14];
  Handles[2] = this[29];
