/*
 * XREFs of _CAudioStream::UpdateStreamPriority_::_1_::dtor$0 @ 0x180039265
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioStream::UpdateStreamPriority_::_1_::dtor_0(__int64 a1, __int64 a2)
{
