/*
 * XREFs of _CPolicyConfig::_CPolicyConfig_::_1_::dtor$5 @ 0x18007F778
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CPolicyConfig::_CPolicyConfig_::_1_::dtor_5(__int64 a1, __int64 a2)
{
  `eh vector destructor iterator'(
    (char *)(*(_QWORD *)(a2 + 112) + 664LL),
    72LL,
    7LL,
