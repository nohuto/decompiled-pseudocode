/*
 * XREFs of ?SetEndpointAbilityToBeDefault@CPolicyConfig@@UEAAJPEBGH@Z @ 0x180088210
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  if ( !a2 )
  {
    v5 = -2147467261;
LABEL_16:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetEndpointAbilityToBeDefault", 4274, v5);
    v6 = v15;
    goto LABEL_17;
  }
  v5 = CoCreateInstance(
