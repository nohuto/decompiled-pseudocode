/*
 * XREFs of ?GetPositionForOffload@CBaseStreamGroupProxy@@UEAAJPEA_K0@Z @ 0x180093B10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( v3 )
  {
    ...
    Microsoft::WRL::ComPtr<IStreamGroupProxy>::InternalRelease(&v8);
    if ( v4 < 0 )
      AudSrvTraceLoggingErrorHelper("CBaseStreamGroupProxy::GetPositionForOffload", 768, v4);
  }
