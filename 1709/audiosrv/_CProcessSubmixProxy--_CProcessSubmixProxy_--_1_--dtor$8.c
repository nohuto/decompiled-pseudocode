/*
 * XREFs of _CProcessSubmixProxy::_CProcessSubmixProxy_::_1_::dtor$8 @ 0x1800386AD
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CProcessSubmixProxy::_CProcessSubmixProxy_::_1_::dtor_8(__int64 a1, __int64 a2)
{
