/*
 * XREFs of ?DoCreateMonitorForCaptureDeviceIfAppropriate@CMonitorManager@@AEAAJPEAUIMMDevice@@@Z @ 0x1800A3714
 * Callers:
        ...
        struct IMMDevice *a2)
{
  ...
  if ( CMonitor::IsCaptureMonitorEnabled(a2, &v12, &v19) )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control )
    {
      ...
      if ( v6 != (CAudioDGProcess *)&WPP_GLOBAL_Control
    ...
    v21 = 0LL;
    v4 = CMonitorManager::CreateMonitor(this, *((struct IMMDeviceEnumerator **)this + 8), a2, (char *)v12, v19, &v21);
    if ( v4 < 0 )
    {
      v7 = v21;
LABEL_53:
