/*
 * XREFs of _CAudioResourceManager::DestroyStream_::_1_::dtor$2 @ 0x18003845E
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioResourceManager::DestroyStream_::_1_::dtor_2(__int64 a1, __int64 a2)
{
