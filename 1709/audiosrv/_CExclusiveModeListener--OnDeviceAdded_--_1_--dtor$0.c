/*
 * XREFs of _CExclusiveModeListener::OnDeviceAdded_::_1_::dtor$0 @ 0x1800C6494
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CExclusiveModeListener::OnDeviceAdded_::_1_::dtor_0(__int64 a1, __int64 a2)
{
