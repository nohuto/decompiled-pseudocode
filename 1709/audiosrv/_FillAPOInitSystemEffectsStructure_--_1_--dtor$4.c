/*
 * XREFs of _FillAPOInitSystemEffectsStructure_::_1_::dtor$4 @ 0x1800DCDA7
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall FillAPOInitSystemEffectsStructure_::_1_::dtor_4(__int64 a1, __int64 a2)
{
