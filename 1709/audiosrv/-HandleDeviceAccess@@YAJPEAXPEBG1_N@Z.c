/*
 * XREFs of ?HandleDeviceAccess@@YAJPEAXPEBG1_N@Z @ 0x18007BF08
 * Callers:
 *     s_GrantDeviceAccessForPackage @ 0x18007C4B0 (s_GrantDeviceAccessForPackage.c)
 *     s_RevokeDeviceAccessForPackage @ 0x18007C4C0 (s_RevokeDeviceAccessForPackage.c)
 * Callees:
 ...
 *     ?GetTokenInformation@@YAKPEAXPEAPEAGPEAK12@Z @ 0x180061E34 (-GetTokenInformation@@YAKPEAXPEAPEAGPEAK12@Z.c)
...
__int64 __fastcall HandleDeviceAccess(void *a1, const unsigned __int16 *a2, const unsigned __int16 *a3, char a4)
{
  ...
  CAudioSessionManagerProvider *v14; // rdi
  void *TokenHandle; // [rsp+30h] [rbp-38h] BYREF
  unsigned __int16 *v17; // [rsp+38h] [rbp-30h] BYREF
  CAudioSessionManagerProvider *v18; // [rsp+40h] [rbp-28h] BYREF
  ...
  else
  {
    ...
    if ( v14 )
      (*(void (__fastcall **)(CAudioSessionManagerProvider *))(*(_QWORD *)v14 + 16LL))(v14);
  }
  LocalFree(v5);
