/*
 * XREFs of ?NDQueryInterface@CSystemEffectWrapper@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DBDA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_61:
  ...
  if ( !v8 )
  {
    if ( !this[15] )
    {
      v3 = CSystemEffectWrapper::QIInternal((CSystemEffectWrapper *)this, a2, this + 15);
      if ( v3 >= 0 )
        *a3 = this + 1;
      return (unsigned int)v3;
    }
