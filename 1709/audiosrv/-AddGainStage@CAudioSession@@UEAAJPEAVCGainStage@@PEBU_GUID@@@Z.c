/*
 * XREFs of ?AddGainStage@CAudioSession@@UEAAJPEAVCGainStage@@PEBU_GUID@@@Z @ 0x180070040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::AddGainStage(CAudioSession *this, struct CGainStage *a2, const struct _GUID *a3)
{
  ...
  {
    WPP_SF_S_guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 99, v6, *((_QWORD *)this + 96), (__int64)v3 + 16);
  }
                          ...
                          &v17) )
  {
    if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_S_guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 100, v7, *((_QWORD *)this + 96), (__int64)v3 + 16);
    }
    v9 = v17;
...
LABEL_19:
    if ( v8 )
      AudSrvTraceLoggingErrorHelper("CAudioSession::AddGainStage", 4483, v5);
LABEL_21:
    if ( v14 )
