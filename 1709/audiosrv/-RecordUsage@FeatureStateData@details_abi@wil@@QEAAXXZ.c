/*
 * XREFs of ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x1800019F0
 * Callers:
 *     _lambda_4acbc82402014b2d4c356edc25e0df58_::_lambda_invoker_cdecl_ @ 0x180031A20 (_lambda_4acbc82402014b2d4c356edc25e0df58_--_lambda_invoker_cdecl_.c)
 * Callees:
...
void __fastcall wil::details_abi::FeatureStateData::RecordUsage(RTL_SRWLOCK *this)
{
  ...
  *(_OWORD *)&v6[1] = 0LL;
  ...
  wil::details_abi::FeatureStateData::RetrieveUsageUnderLock(
    ...
    (struct wil::details_abi::UsageIndexes *)&v7);
  if ( this )
