/*
 * XREFs of ?GetAudioSessionManager@CAudioSessionManagerProvider@@UEAAJPEBGPEAPEAVCAudioSessionManager@@@Z @ 0x180013A20
 * Callers:
        ...
        struct CAudioSessionManager **a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_d4407cbbbdf0327ea3ff22e6cef445ee_Traceguids, a2);
  }
...
LABEL_20:
    v6 = -2147024809;
LABEL_21:
    AudSrvTraceLoggingErrorHelper("CAudioSessionManagerProvider::GetAudioSessionManager", 0x113u, v6);
    goto LABEL_14;
  }
