/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x1800317C0
 * Callers:
 ...
 *     ??1SemaphoreValue@details_abi@wil@@QEAA@XZ @ 0x18005CE08 (--1SemaphoreValue@details_abi@wil@@QEAA@XZ.c)
