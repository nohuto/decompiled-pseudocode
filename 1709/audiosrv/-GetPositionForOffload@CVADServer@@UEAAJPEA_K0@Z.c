/*
 * XREFs of ?GetPositionForOffload@CVADServer@@UEAAJPEA_K0@Z @ 0x18008B8C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_ii @ 0x180090908 (WPP_SF_ii.c)
 */
...
__int64 __fastcall CVADServer::GetPositionForOffload(CVADServer *this, unsigned __int64 *a2, unsigned __int64 *a3)
{
  ...
  {
LABEL_12:
    AudSrvTraceLoggingErrorHelper("CVADServer::GetPositionForOffload", 2088, PositionForOffload);
    goto LABEL_8;
  }
