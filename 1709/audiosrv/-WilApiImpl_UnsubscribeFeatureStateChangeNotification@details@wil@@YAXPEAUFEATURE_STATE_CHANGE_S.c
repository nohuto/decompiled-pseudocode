/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x18008CFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( ((unsigned int)this & 0x80000000) != 0 )
  {
    ...
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_18014BFD8;
  }
  else
  {
    if ( !wil::details::g_featureStateManager )
  ...
  wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_18014BF60, v2);
}
