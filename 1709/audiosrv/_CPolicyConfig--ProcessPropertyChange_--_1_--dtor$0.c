/*
 * XREFs of _CPolicyConfig::ProcessPropertyChange_::_1_::dtor$0 @ 0x180037BE4
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::ProcessPropertyChange_::_1_::dtor_0(__int64 a1, __int64 a2)
{
