/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioEncoderProperties@@V1@AEBU_GUID@@AEAH@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioEncoderProperties@@AEBU_GUID@@AEAH@Z @ 0x1800D6318
 * Callers:
        ...
        int *a3)
{
  ...
  *a1 = 0LL;
  v6 = (SpatialAudioEncoderProperties *)operator new(0x230uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v6 )
  {
