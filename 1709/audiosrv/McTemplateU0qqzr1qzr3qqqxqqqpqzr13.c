/*
 * XREFs of McTemplateU0qqzr1qzr3qqqxqqqpqzr13 @ 0x1800DF334
 * Callers:
 *     Pdcv2EventWrite_ACTIVATION_CLIENT_SET_BROKERED_PROCESSID @ 0x18002BE54 (Pdcv2EventWrite_ACTIVATION_CLIENT_SET_BROKERED_PROCESSID.c)
 * Callees:
        ...
        __int64 a17)
{
  ...
  v46 = 8LL;
  v48 = 4LL;
  return McGenEventWriteUM(PDC_EVENT_PROVIDER_Context, &PDCV2_ACTIVATION_SET_BROKERED_PID, 16LL, (__int64)v18);
}
