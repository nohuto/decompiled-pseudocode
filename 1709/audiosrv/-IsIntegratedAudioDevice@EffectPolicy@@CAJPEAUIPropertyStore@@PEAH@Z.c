/*
 * XREFs of ?IsIntegratedAudioDevice@EffectPolicy@@CAJPEAUIPropertyStore@@PEAH@Z @ 0x1800BDF4C
 * Callers:
...
__int64 __fastcall EffectPolicy::IsIntegratedAudioDevice(struct IPropertyStore *a1, int *a2)
{
  ...
  if ( a2 )
  {
    *a2 = 0;
    ...
    v8 = 0LL;
    v9 = 0LL;
    v4 = ((__int64 (__fastcall *)(struct IPropertyStore *, const PROPERTYKEY *, PROPVARIANT *))a1->lpVtbl->GetValue)(
           a1,
