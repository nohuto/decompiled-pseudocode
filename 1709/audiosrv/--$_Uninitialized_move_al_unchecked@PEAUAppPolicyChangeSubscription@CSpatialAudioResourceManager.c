...
_QWORD *__fastcall std::_Uninitialized_move_al_unchecked<Sarm::CSpatialAudioResourceManager::AppPolicyChangeSubscription *,Sarm::CSpatialAudioResourceManager::AppPolicyChangeSubscription *,std::allocator<Sarm::CSpatialAudioResourceManager::AppPolicyChangeSubscription>>(
        unsigned __int64 a1,
        unsigned __int64 a2,
        _QWORD *a3)
{
