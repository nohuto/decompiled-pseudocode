/*
 * XREFs of ?LogExclusiveModeListenerUpdateSessionState@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@HH@Z @ 0x1800C615C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v8 = 4LL;
    v10 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_180111529, a3, a4, 5u, &v4);
  }
}
