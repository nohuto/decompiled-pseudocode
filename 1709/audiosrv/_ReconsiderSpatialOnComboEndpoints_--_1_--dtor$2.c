/*
 * XREFs of _ReconsiderSpatialOnComboEndpoints_::_1_::dtor$2 @ 0x1800BB1AF
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ReconsiderSpatialOnComboEndpoints_::_1_::dtor_2(__int64 a1, __int64 a2)
{
