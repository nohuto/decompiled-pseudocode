/*
 * XREFs of _CMeterHardware::FindMeterControlForEndpoint_::_1_::dtor$1 @ 0x180065E7B
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CMeterHardware::FindMeterControlForEndpoint_::_1_::dtor_1(__int64 a1, __int64 a2)
{
