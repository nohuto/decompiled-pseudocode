/*
 * XREFs of ?Init@CSystemEffectWrapper@@AEAAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x1800DB994
 * Callers:
  ...
  *(struct _GUID *)(a1 + 80) = v7;
  ...
  else
  {
    ...
    do
      ++v15;
    while ( a4[v15] );
    v12 = _AllocStringWorker<CTCoAllocPolicy>(a1, (__int64)a2, a4, v15, (__int64)v22, (unsigned __int16 **)(a1 + 96));
  }
  a5 = v12;
  v16 = v12;
  if ( v12 >= 0 )
