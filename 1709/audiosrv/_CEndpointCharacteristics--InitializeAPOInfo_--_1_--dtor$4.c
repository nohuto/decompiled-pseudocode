/*
 * XREFs of _CEndpointCharacteristics::InitializeAPOInfo_::_1_::dtor$4 @ 0x1800B686C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CEndpointCharacteristics::InitializeAPOInfo_::_1_::dtor_4(__int64 a1, __int64 a2)
{
