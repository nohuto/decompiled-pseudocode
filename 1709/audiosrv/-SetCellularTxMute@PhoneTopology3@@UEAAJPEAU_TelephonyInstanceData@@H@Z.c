/*
 * XREFs of ?SetCellularTxMute@PhoneTopology3@@UEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x1800ECC20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PhoneTopology3::SetCellularTxMute(PhoneTopology3 *this, struct _TelephonyInstanceData *a2, int a3)
{
  int v6; // ecx
  _QWORD *v7; // rax
  _QWORD *v8; // rbx
  ...
  if ( a2 )
  {
    if ( *(int *)a2 < 3 )
    {
      v6 = (*(__int64 (__fastcall **)(PhoneTopology3 *, struct _TelephonyInstanceData *, int *))(*(_QWORD *)this + 64LL))(
             this,
             a2,
             &v13);
      if ( v6 >= 0 )
