/*
 * XREFs of ?GetStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x1800D2D30
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  if ( a3 && a4 && a5 )
  {
    ...
    *a4 = *(float *)(v11 + 8 * v12 + 4);
    *a5 = *(float *)(v11 + 8 * v12 + 8);
  }
  else
  {
    if ( (unsigned int)dword_18014A3B0 > 2 )
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetStaticObjectPosition");
      v16 = 612;
      v20 = &v16;
      v22 = &v17;
      v21 = 4LL;
