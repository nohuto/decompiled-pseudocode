/*
 * XREFs of _CVolumeHardware::FindVolumeControlForEndpoint_::_1_::dtor$0 @ 0x180068404
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CVolumeHardware::FindVolumeControlForEndpoint_::_1_::dtor_0(__int64 a1, __int64 a2)
{
