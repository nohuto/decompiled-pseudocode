/*
 * XREFs of ?InitializeAPOInfo@CEndpointCharacteristics@@AEAAJXZ @ 0x1800B64E0
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::InitializeAPOInfo(CEndpointCharacteristics *this)
{
  ...
  unsigned int v8; // edi
  enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 *v9; // r14
  int v10; // eax
...
LABEL_11:
  ...
  while ( v2 < 3 );
  v8 = 0;
  v9 = (enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 *)v24;
  while ( 1 )
  {
    v20 = 0LL;
    v21 = 0LL;
    v10 = SystemEffectDescriptor::GetSupportedProcessingModes((__int64)this + 96 * v8 + 616, &v20, 1);
    v11 = v10;
    if ( v10 < 0 )
    {
      wil::details::in1diag3::Return_Hr_NoOriginate(
