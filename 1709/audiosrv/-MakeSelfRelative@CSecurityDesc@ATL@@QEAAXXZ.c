/*
 * XREFs of ?MakeSelfRelative@CSecurityDesc@ATL@@QEAAXXZ @ 0x18002DD84
 * Callers:
 ...
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x18002DE44 (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
...
void __fastcall ATL::CSecurityDesc::MakeSelfRelative(PSECURITY_DESCRIPTOR *this)
{
  ...
  void *v3; // rax
  void *v4; // rdi
  void (__fastcall *v5)(ATL::CSecurityDesc *); // rax
  int Error; // ebx
