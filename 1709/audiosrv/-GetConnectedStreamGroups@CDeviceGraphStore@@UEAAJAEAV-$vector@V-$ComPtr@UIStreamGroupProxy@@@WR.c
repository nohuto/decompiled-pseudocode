/*
 * XREFs of ?GetConnectedStreamGroups@CDeviceGraphStore@@UEAAJAEAV?$vector@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@@std@@@std@@@Z @ 0x180096D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphStore::GetConnectedStreamGroups(__int64 a1, __int64 a2)
{
  ...
  try
  {
    ...
    while ( v10 != v11 )
    {
      v12 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)*v10 + 120LL))(*v10, a2);
      v13 = v12;
      if ( v12 < 0 )
      {
