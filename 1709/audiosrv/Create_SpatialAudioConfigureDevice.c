/*
 * XREFs of Create_SpatialAudioConfigureDevice @ 0x1800D5F84
 * Callers:
...
__int64 __fastcall Create_SpatialAudioConfigureDevice(
        ...
        _QWORD *a3)
{
  ...
  SpatialAudioConfigureDevice *v12[2]; // [rsp+40h] [rbp-29h] BYREF
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    LODWORD(v10) = Microsoft::WRL::Details::MakeAndInitialize<SpatialAudioConfigureDevice,SpatialAudioConfigureDevice,unsigned short const * &,IPropertyStore * &>(
                     v12,
                     &v10,
                     &v11);
    v4 = (unsigned int)v10;
    if ( (int)v10 >= 0 )
    {
      v4 = (**(__int64 (__fastcall ***)(SpatialAudioConfigureDevice *, GUID *, _QWORD *))v12[0])(
             v12[0],
