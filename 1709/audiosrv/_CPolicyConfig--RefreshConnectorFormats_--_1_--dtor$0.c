/*
 * XREFs of _CPolicyConfig::RefreshConnectorFormats_::_1_::dtor$0 @ 0x180086811
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::RefreshConnectorFormats_::_1_::dtor_0(__int64 a1, __int64 a2)
{
