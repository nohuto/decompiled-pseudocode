/*
 * XREFs of _CMuteHardware::FindMuteControlForEndpoint_::_1_::dtor$1 @ 0x180066C69
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CMuteHardware::FindMuteControlForEndpoint_::_1_::dtor_1(__int64 a1, __int64 a2)
{
