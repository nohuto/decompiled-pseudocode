/*
 * XREFs of _GetConnectorSignalProcessingModes_::_1_::dtor$0 @ 0x1800DD14C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall GetConnectorSignalProcessingModes_::_1_::dtor_0(__int64 a1, __int64 a2)
{
