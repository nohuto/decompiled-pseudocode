/*
 * XREFs of ?GetProperties@SpatialAudioEncoderProperties@@UEAAJPEAUSpatialAudioDeviceProperties@@@Z @ 0x1800D6FA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SpatialAudioDeviceProperties *a2)
{
  ...
  if ( a2 )
  {
    ...
    *((_OWORD *)a2 + 4) = *(_OWORD *)((char *)this + 168);
    *((_OWORD *)a2 + 5) = *(_OWORD *)((char *)this + 184);
    *((_OWORD *)a2 + 6) = *(_OWORD *)((char *)this + 200);
    *((_OWORD *)a2 + 7) = *(_OWORD *)((char *)this + 216);
    *((_OWORD *)a2 + 8) = *(_OWORD *)((char *)this + 232);
    *((_WORD *)a2 + 72) = *((_WORD *)this + 124);
  }
  else
  {
