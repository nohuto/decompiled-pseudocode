/*
 * XREFs of _CVolumeHardware::FindVolumeControlForEndpoint_::_1_::dtor$1 @ 0x180068410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CVolumeHardware::FindVolumeControlForEndpoint_::_1_::dtor_1(__int64 a1, __int64 a2)
{
