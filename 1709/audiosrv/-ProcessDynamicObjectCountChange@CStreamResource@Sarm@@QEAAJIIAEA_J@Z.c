/*
 * XREFs of ?ProcessDynamicObjectCountChange@CStreamResource@Sarm@@QEAAJIIAEA_J@Z @ 0x1800C4FBC
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    *((_DWORD *)this + 18) = v12;
    ...
    if ( (unsigned int)dword_18014A370 > 5 )
    {
      ...
      v38 = 4;
      v41 = 1;
      TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_1801110E9, v16, v17, 7u, &pData);
    }
