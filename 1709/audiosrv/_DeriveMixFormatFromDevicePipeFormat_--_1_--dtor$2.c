/*
 * XREFs of _DeriveMixFormatFromDevicePipeFormat_::_1_::dtor$2 @ 0x180082B8D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DeriveMixFormatFromDevicePipeFormat_::_1_::dtor_2(__int64 a1, __int64 a2)
{
