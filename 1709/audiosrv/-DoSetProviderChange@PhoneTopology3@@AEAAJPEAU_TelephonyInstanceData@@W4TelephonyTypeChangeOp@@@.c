/*
 * XREFs of ?DoSetProviderChange@PhoneTopology3@@AEAAJPEAU_TelephonyInstanceData@@W4TelephonyTypeChangeOp@@@Z @ 0x1800EB4A0
 * Callers:
 *     ?Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology3@@@Z @ 0x1800EC440 (-Process@CallProviderChangeWorkItem@@UEAAXPEAVPhoneTopology3@@@Z.c)
 * Callees:
...
__int64 __fastcall PhoneTopology3::DoSetProviderChange(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v6; // rbx
  unsigned int v7; // edi
  char v8; // al
