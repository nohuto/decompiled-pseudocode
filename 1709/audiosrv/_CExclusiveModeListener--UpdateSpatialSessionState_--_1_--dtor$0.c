/*
 * XREFs of _CExclusiveModeListener::UpdateSpatialSessionState_::_1_::dtor$0 @ 0x1800C76B6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CExclusiveModeListener::UpdateSpatialSessionState_::_1_::dtor_0(__int64 a1, __int64 a2)
{
