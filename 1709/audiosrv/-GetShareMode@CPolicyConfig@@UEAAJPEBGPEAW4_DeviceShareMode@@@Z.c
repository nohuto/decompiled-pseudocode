/*
 * XREFs of ?GetShareMode@CPolicyConfig@@UEAAJPEBGPEAW4_DeviceShareMode@@@Z @ 0x180084800
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _DeviceShareMode *a3)
{
  ...
  if ( PropertyStoreProperty < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetShareMode", 3560, PropertyStoreProperty);
  if ( v7 )
