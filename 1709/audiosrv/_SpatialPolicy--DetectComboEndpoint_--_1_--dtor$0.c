/*
 * XREFs of _SpatialPolicy::DetectComboEndpoint_::_1_::dtor$0 @ 0x1800BA7C6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall SpatialPolicy::DetectComboEndpoint_::_1_::dtor_0(__int64 a1, __int64 a2)
{
