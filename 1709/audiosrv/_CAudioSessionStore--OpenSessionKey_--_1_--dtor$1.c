/*
 * XREFs of _CAudioSessionStore::OpenSessionKey_::_1_::dtor$1 @ 0x180086407
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSessionStore::OpenSessionKey_::_1_::dtor_1(__int64 a1, __int64 a2)
{
