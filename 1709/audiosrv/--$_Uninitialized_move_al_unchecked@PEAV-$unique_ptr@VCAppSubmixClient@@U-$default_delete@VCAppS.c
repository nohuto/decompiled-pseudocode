...
__int64 **__fastcall std::_Uninitialized_move_al_unchecked<std::unique_ptr<CAppSubmixClient> *,std::unique_ptr<CAppSubmixClient> *,std::allocator<std::unique_ptr<CAppSubmixClient>>>(
        unsigned __int64 a1,
        unsigned __int64 a2,
        __int64 **a3)
{
