/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800CE744
 * Callers:
        ...
        __int64 a3)
{
    ...
    || (`wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(10237147, 0, &v12) )
    {
      if ( v3 )
      {
        v10 = v6;
