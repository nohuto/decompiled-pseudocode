/*
 * XREFs of ?OnHmdRemoved@CExclusiveModeListener@@AEAAJPEAUIHolographicDisplayWatcher@Internal@Holographic@Graphics@Windows@@PEAUIHolographicDisplay@456@@Z @ 0x1800C67E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v12 = (GUID *)((char *)this + 136);
  CSpatialAudioResourceManagerTraceLogger::LogOnHmdRemoved(v10, &v25, (const struct _GUID *)((char *)this + 136), v11);
  std::map<_GUID,HmdInfo>::_Try_emplace<_GUID const &,>((__int64 *)this + 20, (__int64)&v21, &v25);
  v13 = v21;
