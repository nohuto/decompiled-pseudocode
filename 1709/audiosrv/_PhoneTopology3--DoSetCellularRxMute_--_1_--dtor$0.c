/*
 * XREFs of _PhoneTopology3::DoSetCellularRxMute_::_1_::dtor$0 @ 0x1800EB3A8
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall PhoneTopology3::DoSetCellularRxMute_::_1_::dtor_0(__int64 a1, __int64 a2)
{
