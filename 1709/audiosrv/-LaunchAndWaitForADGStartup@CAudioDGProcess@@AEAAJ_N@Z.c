/*
 * XREFs of ?LaunchAndWaitForADGStartup@CAudioDGProcess@@AEAAJ_N@Z @ 0x18001DCF4
 * Callers:
...
__int64 __fastcall CAudioDGProcess::LaunchAndWaitForADGStartup(CAudioDGProcess *this, bool a2)
{
  ...
  unsigned int v11; // [rsp+38h] [rbp-41h] BYREF
  ...
  v14 = v5 / 1000.0;
  if ( (unsigned int)dword_18014A3F0 > 4 && TlgKeywordOn((TraceLoggingHProvider)&dword_18014A3F0, 0x200000000000uLL) )
  {
    v18 = 0;
    v21 = 0;
    v24 = 0;
    ...
    v26 = (int)v8;
    v29 = 8;
    TlgWrite(v6, &unk_18011231B, v7, v8, 7u, &pData);
  }
  result = v11;
  if ( v13 < 0 )
