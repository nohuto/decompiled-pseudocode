/*
 * XREFs of ?GetSubmixesForPID@CDeviceGraphStore@@UEAAJKW4ProcessSubmixCapture@@AEAV?$vector@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@Z @ 0x180097870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphStore::GetSubmixesForPID(__int64 a1, int a2, int a3, __int64 **a4)
{
