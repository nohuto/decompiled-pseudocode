/*
 * XREFs of ?IsExclusiveModeDisabled@@YAHPEBG@Z @ 0x18008BB7C
 * Callers:
...
__int64 __fastcall IsExclusiveModeDisabled(const unsigned __int16 *a1)
{
  ...
  if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Fu, (__int64)&WPP_cdc5f6c5d0f339869e28fa9670aa29b0_Traceguids, v1);
  }
  return v1;
}
