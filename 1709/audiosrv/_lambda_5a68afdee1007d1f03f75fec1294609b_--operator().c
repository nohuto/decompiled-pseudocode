/*
 * XREFs of _lambda_5a68afdee1007d1f03f75fec1294609b_::operator() @ 0x180096138
 * Callers:
 *     std::_Func_impl__lambda_5a68afdee1007d1f03f75fec1294609b__std::allocator_int__bool_ISaDeviceProxy_____ptr64_::_Do_call @ 0x180097C40 (std--_Func_impl__lambda_5a68afdee1007d1f03f75fec1294609b__std--allocator_int__bool__ea_180097C40.c)
 * Callees:
 *     __security_check_cookie @ 0x180032AC0 (__security_check_cookie.c)
 *     memcmp_0 @ 0x180036B89 (memcmp_0.c)
 *     _guard_dispatch_icall_nop @ 0x180036BB0 (_guard_dispatch_icall_nop.c)
 *     WPP_SF_qdd @ 0x180077200 (WPP_SF_qdd.c)
 *     WPP_SF_qDD @ 0x180097E20 (WPP_SF_qDD.c)
 *     WPP_SF_qdddd @ 0x180097E80 (WPP_SF_qdddd.c)
 *     WPP_SF_qii @ 0x180097EFC (WPP_SF_qii.c)
 */

char __fastcall lambda_5a68afdee1007d1f03f75fec1294609b_::operator()(__int64 *a1, __int64 a2)
{
  __int64 v4; // rbx
  __int64 v5; // rax
  __int64 v6; // rdx
    ...
    else
    {
             ...
             && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_qdd(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xCu,
          (__int64)&WPP_1c09718e5e7b33997c2f06ecaa90c919_Traceguids,
          a2,
          v28,
          v29);
      }
