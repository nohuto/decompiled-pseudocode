/*
 * XREFs of _CVolumeProvider::GetDeviceVolumeStrip_::_1_::dtor$1 @ 0x180037C2C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CVolumeProvider::GetDeviceVolumeStrip_::_1_::dtor_1(__int64 a1, __int64 a2)
{
