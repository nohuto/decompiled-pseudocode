/*
 * XREFs of ?UnescapeIdentifierString@CAudioIdentifier@@SAXAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18007F1C8
 * Callers:
 ...
 *     ??A?$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z @ 0x18007DDC8 (--A-$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z.c)
