/*
 * XREFs of _ReconsiderSpatialOnComboEndpoints_::_1_::dtor$3 @ 0x1800BB1BB
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ReconsiderSpatialOnComboEndpoints_::_1_::dtor_3(__int64 a1, __int64 a2)
{
