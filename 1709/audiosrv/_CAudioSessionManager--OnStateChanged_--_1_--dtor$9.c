/*
 * XREFs of _CAudioSessionManager::OnStateChanged_::_1_::dtor$9 @ 0x180038CD8
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionManager::OnStateChanged_::_1_::dtor_9(__int64 a1, __int64 a2)
{
