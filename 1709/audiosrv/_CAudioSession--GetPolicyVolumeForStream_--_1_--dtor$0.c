/*
 * XREFs of _CAudioSession::GetPolicyVolumeForStream_::_1_::dtor$0 @ 0x18003922D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSession::GetPolicyVolumeForStream_::_1_::dtor_0(__int64 a1, __int64 a2)
{
