/*
 * XREFs of ?SetSessionVolume@CPerStreamVolumeAudioStream@@UEAAJMKQEAM_J_N@Z @ 0x18002D5A0
 * Callers:
        ...
        bool a6)
{
  ...
  __int64 v13; // rax
  float v14; // xmm0_4
  __int64 (__fastcall *v15)(float **); // rax
  int v16; // eax
  float v18; // xmm6_4
  __int64 v19; // rcx
  __int64 v20; // rsi
  ...
  if ( *((_DWORD *)this + 21) )
  {
    ...
    while ( (unsigned int)v8 < *((_DWORD *)this + 21) );
  }
  v11 = *((_DWORD *)this + 21);
  if ( a3 < v11 )
  {
    ...
    if ( v11 )
    {
      ...
      while ( (unsigned int)v20 < *((_DWORD *)this + 21) );
    }
  }
  else
  {
    ...
    if ( v11 )
    {
      ...
      while ( (unsigned int)v12 < *((_DWORD *)this + 21) );
    }
  }
  *((_QWORD *)this + 70) = a5;
  if ( a6 )
  {
    v15 = *(__int64 (__fastcall **)(float **))(*(_QWORD *)this + 120LL);
    if ( v15 == CAudioStream::RecalculateVolume )
      v16 = CAudioStream::RecalculateVolume((float **)this);
    else
      v16 = v15((float **)this);
    v7 = v16;
    if ( v16 < 0 )
      AudSrvTraceLoggingErrorHelper("CPerStreamVolumeAudioStream::SetSessionVolume", 0x922u, v16);
  }
  return v7;
}
