/*
 * XREFs of _CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch$18 @ 0x18009693D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch_18(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
