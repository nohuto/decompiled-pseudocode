/*
 * XREFs of _ReconsiderSpatialOnComboEndpoints_::_1_::dtor$1 @ 0x1800BB1A3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ReconsiderSpatialOnComboEndpoints_::_1_::dtor_1(__int64 a1, __int64 a2)
{
