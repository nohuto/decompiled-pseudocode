/*
 * XREFs of _AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor$0 @ 0x1800E80F1
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor_0(__int64 a1, __int64 a2)
{
