/*
 * XREFs of ?LogOnHmdRemoved@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@0@Z @ 0x1800C6270
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_18014A370 > 4 )
  {
    ...
    v10 = 0;
    v9 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_1801115A8, a3, a4, 4u, &v4);
  }
}
