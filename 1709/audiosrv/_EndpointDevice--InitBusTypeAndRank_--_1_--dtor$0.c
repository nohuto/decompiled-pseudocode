/*
 * XREFs of _EndpointDevice::InitBusTypeAndRank_::_1_::dtor$0 @ 0x1800E9BC9
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EndpointDevice::InitBusTypeAndRank_::_1_::dtor_0(__int64 a1, __int64 a2)
{
