/*
 * XREFs of ?GetChannelsPeakValues@CAudioSession@@UEAAJIPEAM@Z @ 0x180071630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetChannelsPeakValues(CAudioSession *this, unsigned int a2, float *a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x21u, (__int64)&WPP_9673f45371ad3f1ae3c411824cdd701d_Traceguids, 0LL);
  }
  if ( !a3 )
  {
  ...
  if ( (_DWORD)v4 != v15 )
  {
    ...
    {
      WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL, &WPP_9673f45371ad3f1ae3c411824cdd701d_Traceguids);
    }
...
LABEL_28:
  ...
  if ( MeteringChannelCount < 0 )
LABEL_31:
    AudSrvTraceLoggingErrorHelper("CAudioSession::GetChannelsPeakValues", 1539, MeteringChannelCount);
