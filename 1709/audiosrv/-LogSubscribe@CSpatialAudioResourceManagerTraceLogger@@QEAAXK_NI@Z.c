/*
 * XREFs of ?LogSubscribe@CSpatialAudioResourceManagerTraceLogger@@QEAAXK_NI@Z @ 0x1800C3A84
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v9 = &v5;
    v11 = &v13;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_180110DB8, a3, a4, 5u, &pData);
  }
}
