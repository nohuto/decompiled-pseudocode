/*
 * XREFs of _lambda_0f6133618d0c12f17131f09684aeafcf_::operator()_std::unique_ptr_CAppSubmixClientContext_std::default_delete_CAppSubmixClientContext____const__ @ 0x18009E5F8
 * Callers:
        ...
        __int64 *a2)
{
  ...
  v11 = *a1;
  v12 = *(__int64 **)(*a2 + 48);
  v13 = (unsigned __int64)(*(_QWORD *)(*a2 + 56) - (_QWORD)v12 + 7LL) >> 3;
  if ( (unsigned __int64)v12 > *(_QWORD *)(*a2 + 56) )
    v13 = 0LL;
  if ( v13 )
  {
    do
    {
      v14 = *v12;
      v15 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v11 + 176LL))(*v11);
