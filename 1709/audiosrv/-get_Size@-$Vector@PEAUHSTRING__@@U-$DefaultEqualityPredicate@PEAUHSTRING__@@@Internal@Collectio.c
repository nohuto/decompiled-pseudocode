/*
 * XREFs of ?get_Size@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJPEAI@Z @ 0x1800E5950
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a2)
{
  ...
  *a2 = 0;
  v6 = 0;
  XWinRT::SerializingLockPolicy::Read((__int64)v5, (RTL_SRWLOCK *)(a1 + 112), &v6);
  if ( v6 >= 0 )
    *a2 = *(_DWORD *)(a1 + 80);
  if ( v5[0] )
  {
