/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioMetadataDictionary@@V1@W4DictionaryLoadKind@@AEBU_GUID@@AEAG$$TAEAPEAEAEAI@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioMetadataDictionary@@$$QEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG$$QEA$$TAEAPEAEAEAI@Z @ 0x1800D81FC
 * Callers:
        ...
        ...)
{
  ...
  *a1 = 0LL;
  v6 = (SpatialAudioMetadataDictionary *)operator new(0x90uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v6 )
  {
