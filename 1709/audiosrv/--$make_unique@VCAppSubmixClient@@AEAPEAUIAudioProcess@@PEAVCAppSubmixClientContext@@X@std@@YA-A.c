/*
 * XREFs of ??$make_unique@VCAppSubmixClient@@AEAPEAUIAudioProcess@@PEAVCAppSubmixClientContext@@X@std@@YA?AV?$unique_ptr@VCAppSubmixClient@@U?$default_delete@VCAppSubmixClient@@@std@@@0@AEAPEAUIAudioProcess@@$$QEAPEAVCAppSubmixClientContext@@@Z @ 0x18009EFA4
 * Callers:
...
_QWORD *__fastcall std::make_unique<CAppSubmixClient,IAudioProcess * &,CAppSubmixClientContext *,void>(
        _QWORD *a1,
        __int64 *a2,
        __int64 *a3)
{
