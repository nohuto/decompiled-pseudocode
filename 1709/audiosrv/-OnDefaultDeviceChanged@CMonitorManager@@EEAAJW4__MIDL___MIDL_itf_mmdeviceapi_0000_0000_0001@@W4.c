/*
 * XREFs of ?OnDefaultDeviceChanged@CMonitorManager@@EEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEBG@Z @ 0x1800A5590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_33:
  ...
  try
  {
    ...
    ATL::CSimpleStringT<unsigned short,0>::SetString(v9, (char *)a4, v13);
  }
  catch ( ATL::CAtlException *v18 )
  {
    ...
    if ( *v17 < 0 )
    {
      DefaultChangedContext::`scalar deleting destructor'((DefaultChangedContext *)v9);
      v10 = (DefaultChangedContext *)v9;
LABEL_31:
      v12 = WPP_GLOBAL_Control;
      goto LABEL_32;
