/*
 * XREFs of XWinRT::detail::AtomicUpdates::AtomicUpdate__lambda_9ef20e102c9ff3746e773950a40b935c___lambda_1ee46c767369a144b0488965c9630b66___ @ 0x1800E1320
 * Callers:
        ...
        __int64 a3)
{
  ...
  while ( 1 )
  {
    v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))(**(_QWORD **)(**(_QWORD **)a2 + 72LL)
                                                                           + 128LL))(
