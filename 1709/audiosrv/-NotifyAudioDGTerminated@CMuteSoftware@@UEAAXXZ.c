/*
 * XREFs of ?NotifyAudioDGTerminated@CMuteSoftware@@UEAAXXZ @ 0x1800671F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CMuteSoftware::NotifyAudioDGTerminated(CMuteSoftware *this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 32LL, &WPP_c071410194bb3e21497a264ebdcc8fa3_Traceguids, this);
  }
  v3 = 0;
