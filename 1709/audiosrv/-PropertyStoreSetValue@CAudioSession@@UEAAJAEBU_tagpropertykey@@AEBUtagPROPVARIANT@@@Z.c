/*
 * XREFs of ?PropertyStoreSetValue@CAudioSession@@UEAAJAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x180074E40
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPROPVARIANT *a3)
{
  ...
  if ( v8 != 2 )
    return (*(__int64 (__fastcall **)(_QWORD, const struct _tagpropertykey *, const struct tagPROPVARIANT *))(**((_QWORD **)this + 69) + 48LL))(
             *((_QWORD *)this + 69),
             a2,
             a3);
  AudSrvTraceLoggingErrorHelper("CAudioSession::PropertyStoreSetValue", 5989, -2147024809);
  return 2147942487LL;
}
