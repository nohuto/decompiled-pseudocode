/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionaryData@@QEAAJW4DictionaryLoadKind@@AEBU_GUID@@G@Z @ 0x1800D7F10
 * Callers:
...
LABEL_6:
  *(_OWORD *)(a1 + 112) = *v5;
  *(_WORD *)(a1 + 108) = *((_WORD *)v5 + 8);
  *(_DWORD *)(a1 + 104) = *((_DWORD *)v5 + 8);
  *(_QWORD *)(a1 + 96) = *((_QWORD *)v5 + 3);
  return (unsigned int)v9;
}
