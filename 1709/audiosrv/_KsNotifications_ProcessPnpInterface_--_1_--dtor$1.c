/*
 * XREFs of _KsNotifications_ProcessPnpInterface_::_1_::dtor$1 @ 0x1800BE818
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall KsNotifications_ProcessPnpInterface_::_1_::dtor_1(__int64 a1, __int64 a2)
{
