/*
 * XREFs of McTemplateU0qqzr1qzr3qqqxqpqqqzr13q @ 0x1800DF194
 * Callers:
        ...
        char a18)
{
  ...
  v50 = 4LL;
  v55 = 4LL;
  return McGenEventWriteUM(PDC_EVENT_PROVIDER_Context, &PDCV2_ACTIVATION_CALLBACK, 17LL, (__int64)v20);
}
