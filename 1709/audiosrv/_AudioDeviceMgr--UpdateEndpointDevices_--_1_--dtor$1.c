/*
 * XREFs of _AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor$1 @ 0x1800E80FD
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor_1(__int64 a1, __int64 a2)
{
