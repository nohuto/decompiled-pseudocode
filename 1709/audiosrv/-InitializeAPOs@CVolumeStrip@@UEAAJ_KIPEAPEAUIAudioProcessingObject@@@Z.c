/*
 * XREFs of ?InitializeAPOs@CVolumeStrip@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x180009550
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  if ( a4 || !a3 )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 24LL, &WPP_879f8c7a46163fac74ca54c33ad9d683_Traceguids, this);
    }
    v9 = this[31];
    if ( v9 )
