/*
 * XREFs of AudioServerGetFrequencyForOffload @ 0x18008F250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetFrequencyForOffload(_OWORD *a1, __int64 a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  ...
  v4 = (*(__int64 (__fastcall **)(_OWORD *, __int64))(*(_QWORD *)a1 + 128LL))(a1, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetFrequencyForOffload", 3446, v4);
