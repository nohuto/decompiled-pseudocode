/*
 * XREFs of ?OnChannelVolumeChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@KQEAMKPEBU_GUID@@@Z @ 0x1800777F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a6)
{
  ...
  if ( v11 )
  {
    v12 = 2 * *(_DWORD *)(*(_QWORD *)(v11 + 792) - 16LL) + 2;
    ...
    if ( v13 )
    {
      ...
      *(GUID *)(v14 + 7) = v17;
      ...
      StringCbCopyW((unsigned __int16 *)v14 + 36, v12, *(const unsigned __int16 **)(*((_QWORD *)this + 9) + 792LL));
      if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
        && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
