/*
 * XREFs of _EndpointDevice::InitAdapterInformation_::_1_::dtor$1 @ 0x1800E99B3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EndpointDevice::InitAdapterInformation_::_1_::dtor_1(__int64 a1, __int64 a2)
{
