/*
 * XREFs of ?FindMuteControlForEndpoint@CMuteHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x1800669A4
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( v7 < 0 )
    {
      ...
      AudSrvTraceLoggingErrorHelper("CMuteHardware::FindMuteControlForEndpoint", 410, v7);
    }
    if ( v14 )
