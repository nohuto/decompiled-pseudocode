/*
 * XREFs of _CAudioResourceManager::DestroyStream_::_1_::dtor$1 @ 0x180038452
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioResourceManager::DestroyStream_::_1_::dtor_1(__int64 a1, __int64 a2)
{
