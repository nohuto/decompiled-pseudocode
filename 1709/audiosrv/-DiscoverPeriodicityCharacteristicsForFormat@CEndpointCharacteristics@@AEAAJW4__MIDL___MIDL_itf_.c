/*
 * XREFs of ?DiscoverPeriodicityCharacteristicsForFormat@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEBUtWAVEFORMATEX@@PEAUPacketSizeConstraints@@_N_JPEAI6666@Z @ 0x1800B337C
 * Callers:
...
LABEL_14:
    ...
    *a8 = v21;
    ...
    {
      if ( *((_DWORD *)this + 37) == 1 && (unsigned int)g_MaxCapturePeriodicityInHns > v48 && (!a5 || !*(_BYTE *)a5) )
      {
      ...
      else if ( a6 )
      {
        ...
        if ( v27 )
        {
          ...
          if ( v28 + 1 >= v28 )
          {
            if ( v29 <= 0xFFFFFFFF )
              v26 = v29;
            v30 = v29 > 0xFFFFFFFF ? 0x80070216 : 0;
          }
        }
        else
        {
