/*
 * XREFs of _ATL::CAtlMap_CAudioSessionInstanceId_CAudioSession_____ptr64_CAudioSessionInstanceIdTraits_ATL::CElementTraits_CAudioSession_____ptr64___::SetAt_::_1_::catch$0 @ 0x180038AEE
 * Callers:
 *     <none>
 * Callees:
