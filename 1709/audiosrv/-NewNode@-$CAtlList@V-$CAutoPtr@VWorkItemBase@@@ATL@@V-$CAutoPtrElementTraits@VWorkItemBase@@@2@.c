/*
 * XREFs of ?NewNode@?$CAtlList@V?$CAutoPtr@VWorkItemBase@@@ATL@@V?$CAutoPtrElementTraits@VWorkItemBase@@@2@@ATL@@AEAAPEAVCNode@12@AEAV?$CAutoPtr@VWorkItemBase@@@2@PEAV312@1@Z @ 0x1800A5288
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<ATL::CAutoPtr<WorkItemBase>,ATL::CAutoPtrElementTraits<WorkItemBase>>::NewNode(
        __int64 a1,
        __int64 *a2,
        __int64 a3)
{
