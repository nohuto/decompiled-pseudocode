/*
 * XREFs of ?IsAudioFormatSupportedRemote@CAPOWrapperSrv@@UEAAJW4__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0001@@PEBUtWAVEFORMATEX@@1PEAPEAU3@@Z @ 0x1800DAC90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a5)
{
  ...
  if ( a3 )
  {
    v11 = CAudioMediaType::Create(a3, (unsigned int)a3->cbSize + 18, &v23, 0.0, 1);
    v5 = v23;
    v12 = v11;
    v22 = v11;
    if ( v11 < 0 )
  ...
  if ( a4 )
  {
    v13 = CAudioMediaType::Create(a4, (unsigned int)a4->cbSize + 18, &v25, 0.0, 1);
    v6 = v25;
    v12 = v13;
    v22 = v13;
    if ( v13 < 0 )
...
LABEL_17:
    if ( (unsigned int)dword_18014A3F0 > 2 )
    {
      ...
      v31 = 4;
      v34 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_18014A3F0, &unk_1801122EC, v19, v20, 5u, &pData);
      v12 = v22;
    }
    goto LABEL_19;
  }
