/*
 * XREFs of _CExclusiveModeListener::OnHmdRemoved_::_1_::dtor$2 @ 0x1800C6AA3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CExclusiveModeListener::OnHmdRemoved_::_1_::dtor_2(__int64 a1, __int64 a2)
{
