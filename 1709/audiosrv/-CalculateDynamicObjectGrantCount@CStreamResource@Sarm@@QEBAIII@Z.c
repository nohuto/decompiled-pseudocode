/*
 * XREFs of ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAIII@Z @ 0x1800C455C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (unsigned int)dword_18014A370 > 5 )
  {
    ...
    v38 = 1;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_18014A370, &unk_180111257, a3, (LPCGUID)v4, 0xCu, &pData);
    LODWORD(v4) = v10;
  }
