/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioMetadataDictionaryData@@V1@AEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioMetadataDictionaryData@@AEAW4DictionaryLoadKind@@AEBU_GUID@@AEAG@Z @ 0x1800D7918
 * Callers:
        ...
        unsigned __int16 *a4)
{
  ...
  *a1 = 0LL;
  v8 = (SpatialAudioMetadataDictionaryData *)operator new(0x80uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v8 )
  {
