/*
 * XREFs of ??$emplace_back@AEBQEAUIAudioStreamInfo@@@?$vector@PEAUIAudioStreamInfo@@V?$allocator@PEAUIAudioStreamInfo@@@std@@@std@@QEAAXAEBQEAUIAudioStreamInfo@@@Z @ 0x1800300A0
 * Callers:
...
char *__fastcall std::vector<IAudioStreamInfo *>::emplace_back<IAudioStreamInfo * const &>(const void **a1, char **a2)
{
  char *result; // rax
  char *v5; // rdi
  __int64 v6; // rdi
