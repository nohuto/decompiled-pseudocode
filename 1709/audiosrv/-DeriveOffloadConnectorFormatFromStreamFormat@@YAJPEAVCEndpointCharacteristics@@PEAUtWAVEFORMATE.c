/*
 * XREFs of ?DeriveOffloadConnectorFormatFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@PEAUtWAVEFORMATEX@@U_GUID@@22PEAPEAU2@@Z @ 0x180082BE4
 * Callers:
  ...
  if ( v16 )
  {
    ...
    if ( (int)CloneWaveFormat(Srca, &v24) >= 0 )
    {
      ...
      else
      {
        ...
        {
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 16LL, &WPP_4050dfb3bbe6354b31e7862a02621f78_Traceguids);
        }
