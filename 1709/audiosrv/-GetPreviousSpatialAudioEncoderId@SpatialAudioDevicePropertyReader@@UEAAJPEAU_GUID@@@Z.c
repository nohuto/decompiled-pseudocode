/*
 * XREFs of ?GetPreviousSpatialAudioEncoderId@SpatialAudioDevicePropertyReader@@UEAAJPEAU_GUID@@@Z @ 0x1800D24A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a2)
{
  ...
  if ( *((_DWORD *)this + 130) )
  {
    if ( a2 )
    {
      *a2 = *(struct _GUID *)((char *)this + 468);
      return v5;
    }
    v6 = -2147024809;
    if ( (unsigned int)dword_18014A3B0 > 2 )
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetPreviousSpatialAudioEncoderId");
      v13[0] = 825;
      v16 = v13;
      v18 = &v12;
      v17 = 4LL;
