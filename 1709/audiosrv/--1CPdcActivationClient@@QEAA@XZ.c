/*
 * XREFs of ??1CPdcActivationClient@@QEAA@XZ @ 0x18009C91C
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$0 @ 0x180060E69 (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$0.c)
