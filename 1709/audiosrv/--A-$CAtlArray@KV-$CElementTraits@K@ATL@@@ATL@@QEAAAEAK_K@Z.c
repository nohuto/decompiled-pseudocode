/*
 * XREFs of ??A?$CAtlArray@KV?$CElementTraits@K@ATL@@@ATL@@QEAAAEAK_K@Z @ 0x18006C3E8
 * Callers:
...
__int64 __fastcall ATL::CAtlArray<unsigned long,ATL::CElementTraits<unsigned long>>::operator[](
        _QWORD *a1,
        unsigned __int64 a2)
{
  if ( a2 >= a1[1] )
