/*
 * XREFs of ?OnDeviceIconChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x1800A59D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CMonitorManager::OnDeviceIconChanged(
        ...
        const struct _tagpropertykey *a3)
{
  ...
  else if ( v9 == 1 )
  {
    ...
    if ( v8[0] )
    {
      CMonitor::OnDeviceIconChanged((CMonitor *)v8[0][8].lpVtbl, v10);
      v6 = v8[0];
    }
    if ( v6 )
