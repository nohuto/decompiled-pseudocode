/*
 * XREFs of ?ResetState@SpatialAudioDeviceStateWriter@@UEAAJXZ @ 0x1800D3BD0
 * Callers:
 *     <none>
 * Callees:
 *     ?Store@SpatialAudioStateIO@@IEAAJXZ @ 0x1800D78C0 (-Store@SpatialAudioStateIO@@IEAAJXZ.c)
 */
