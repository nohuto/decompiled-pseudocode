/*
 * XREFs of ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x180084B30
 * Callers:
...
bool __fastcall CNtDeleteKey::Init(CNtDeleteKey *this)
{
  ...
  else
  {
    ...
    if ( Library )
    {
      qword_18014C6D8 = (__int64)GetProcAddress(Library, "NtDeleteKey");
      LOBYTE(Library) = qword_18014C6D8 != 0;
    }
  }
  return (char)Library;
}
