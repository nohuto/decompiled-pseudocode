/*
 * XREFs of ?ProviderFinalRelease@CVolumeStrip@@UEAAXXZ @ 0x18006D540
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::ProviderFinalRelease(unsigned __int64 this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_879f8c7a46163fac74ca54c33ad9d683_Traceguids);
  }
  v2 = *(_QWORD *)(this + 240);
  if ( v2 )
