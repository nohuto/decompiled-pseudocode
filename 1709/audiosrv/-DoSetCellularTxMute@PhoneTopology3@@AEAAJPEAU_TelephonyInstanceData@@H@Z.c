/*
 * XREFs of ?DoSetCellularTxMute@PhoneTopology3@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x1800EB3C0
 * Callers:
 *     ?Process@CallTxMuteWorkItem@@UEAAXPEAVPhoneTopology3@@@Z @ 0x1800EC460 (-Process@CallTxMuteWorkItem@@UEAAXPEAVPhoneTopology3@@@Z.c)
 * Callees:
...
__int64 __fastcall PhoneTopology3::DoSetCellularTxMute(
        PhoneTopology3 *this,
