/*
 * XREFs of _CMuteHardware::FindMuteControlForEndpoint_::_1_::dtor$0 @ 0x180066C5D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CMuteHardware::FindMuteControlForEndpoint_::_1_::dtor_0(__int64 a1, __int64 a2)
{
