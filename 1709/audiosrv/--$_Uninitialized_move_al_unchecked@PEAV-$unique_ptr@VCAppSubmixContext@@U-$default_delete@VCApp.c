...
__int64 **__fastcall std::_Uninitialized_move_al_unchecked<std::unique_ptr<CAppSubmixContext> *,std::unique_ptr<CAppSubmixContext> *,std::allocator<std::unique_ptr<CAppSubmixContext>>>(
        unsigned __int64 a1,
        unsigned __int64 a2,
        __int64 **a3)
{
