/*
 * XREFs of _FillAPOInitSystemEffectsStructure_::_1_::dtor$1 @ 0x1800DCD83
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall FillAPOInitSystemEffectsStructure_::_1_::dtor_1(__int64 a1, __int64 a2)
{
