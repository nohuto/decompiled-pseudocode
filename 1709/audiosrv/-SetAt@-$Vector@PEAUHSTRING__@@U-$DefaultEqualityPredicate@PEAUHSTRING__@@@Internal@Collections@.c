/*
 * XREFs of ?SetAt@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJIPEAUHSTRING__@@@Z @ 0x1800E4EB0
 * Callers:
 *     <none>
 * Callees:
 *     ??$?0PEAUHSTRING__@@@?$AutoValue@PEAUHSTRING__@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@@XWinRT@@QEAA@AEBQEAUHSTRING__@@PEAJ@Z @ 0x1800E1060 (--$-0PEAUHSTRING__@@@-$AutoValue@PEAUHSTRING__@@U-$DefaultLifetimeTraits@PEAUHSTRING__@@@Interna.c)
        ...
        HSTRING a3)
{
  ...
  {
    XWinRT::SerializingLockPolicy::Write(v9, a1 + 112, &Destination);
    v6 = (int)Destination;
    if ( (int)Destination >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        v6 = 0;
        if ( memmove_s(&Destination, 8uLL, (const void *const)(*(_QWORD *)(a1 + 96) + 8 * v3), 8uLL) )
        {
          v6 = -2147418113;
        ...
        {
          *(_QWORD *)(*(_QWORD *)(a1 + 96) + 8 * v3) = string;
          string = 0LL;
          ++*(_DWORD *)(a1 + 128);
          v5 = Destination;
