/*
 * XREFs of ?ShouldReportHangToWatson@CWatchdogTimer@@AEAA_NXZ @ 0x18006F364
 * Callers:
...
bool __fastcall CWatchdogTimer::ShouldReportHangToWatson(const struct _TlgProvider_t **this)
{
  ...
  if ( *(_DWORD *)v4 > 5u && TlgKeywordOn(v4, 2uLL) )
  {
    ...
    v17 = &v14;
    v18 = 4;
    TlgWrite(v6, &unk_18010ECC3, v7, v5, 3u, &pData);
    LODWORD(v5) = v14;
  }
  if ( (_DWORD)v5 != 1 )
    return 0;
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    if ( TlgKeywordOn(v9, 2uLL) )
    {
      ...
      v21 = &v15;
      v22 = 4;
      TlgWrite(v11, &unk_18010EC8E, v12, v10, 3u, &v20);
      LODWORD(v10) = v15;
    }
  }
  return (_DWORD)v10 == 0;
