/*
 * XREFs of _CAudioStream::GetFrequencyForOffload_::_1_::dtor$0 @ 0x18007C927
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioStream::GetFrequencyForOffload_::_1_::dtor_0(__int64 a1, __int64 a2)
{
