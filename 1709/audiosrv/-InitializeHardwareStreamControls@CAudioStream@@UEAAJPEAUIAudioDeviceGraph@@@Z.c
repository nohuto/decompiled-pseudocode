/*
 * XREFs of ?InitializeHardwareStreamControls@CAudioStream@@UEAAJPEAUIAudioDeviceGraph@@@Z @ 0x18007CBB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStream::InitializeHardwareStreamControls(CAudioStream *this, struct IAudioDeviceGraph *a2)
{
  ...
  *((_DWORD *)this + 33) = 2;
  ...
  if ( !*((_BYTE *)this + 41) && (!*((_QWORD *)this + 22) || !*((_QWORD *)this + 23) || !*((_QWORD *)this + 24)) )
    v4 = -2147467262;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioStream::InitializeHardwareStreamControls", 1079, v4);
  if ( v8 )
