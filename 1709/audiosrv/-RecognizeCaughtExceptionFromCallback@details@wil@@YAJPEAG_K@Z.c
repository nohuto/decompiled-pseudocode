/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x18005E130
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x18005E693 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
...
LABEL_14:
    ...
    catch ( std::exception *v9 )
    {
      ...
      wil::details::MaybeGetExceptionString(
        (wil::details *)v4[5],
        (const struct std::exception *)v4[8],
