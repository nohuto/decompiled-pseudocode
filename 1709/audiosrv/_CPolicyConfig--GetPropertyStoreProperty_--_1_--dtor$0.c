/*
 * XREFs of _CPolicyConfig::GetPropertyStoreProperty_::_1_::dtor$0 @ 0x180037BFC
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::GetPropertyStoreProperty_::_1_::dtor_0(__int64 a1, __int64 a2)
{
