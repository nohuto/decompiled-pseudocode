/*
 * XREFs of ?GetVolumeStepInfo@CVolumeControlBase@@UEAAJPEAI0@Z @ 0x180068CE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *a3 = *((_DWORD *)this + 14);
  ...
  {
    WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_a99c65f464be33b31308c514a5524983_Traceguids);
  }
  v7 = *((_DWORD *)this + 14) - 1;
  ...
  *a2 = v8;
  if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_a99c65f464be33b31308c514a5524983_Traceguids);
  }
  return (unsigned int)v5;
}
