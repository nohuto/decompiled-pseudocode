/*
 * XREFs of ?GetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x180084750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyValue", 4021, PropertyStoreProperty);
    goto LABEL_7;
  }
