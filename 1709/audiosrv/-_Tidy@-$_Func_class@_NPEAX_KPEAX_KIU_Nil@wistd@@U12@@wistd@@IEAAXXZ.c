/*
 * XREFs of ?_Tidy@?$_Func_class@_NPEAX_KPEAX_KIU_Nil@wistd@@U12@@wistd@@IEAAXXZ @ 0x18005C098
 * Callers:
 ...
 *     ??1?$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@XZ @ 0x18005C07C (--1-$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@XZ.c)
 * Callees:
