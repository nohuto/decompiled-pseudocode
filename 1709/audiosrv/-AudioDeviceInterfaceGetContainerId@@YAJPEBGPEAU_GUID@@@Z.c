/*
 * XREFs of ?AudioDeviceInterfaceGetContainerId@@YAJPEBGPEAU_GUID@@@Z @ 0x180064C00
 * Callers:
...
LABEL_15:
      ...
      v7 = MEMORY[0x30] - *(_QWORD *)&PKEY_Device_ContainerId.fmtid.Data1;
      if ( MEMORY[0x30] == *(_QWORD *)&PKEY_Device_ContainerId.fmtid.Data1 )
        v7 = MEMORY[0x38] - *(_QWORD *)PKEY_Device_ContainerId.fmtid.Data4;
