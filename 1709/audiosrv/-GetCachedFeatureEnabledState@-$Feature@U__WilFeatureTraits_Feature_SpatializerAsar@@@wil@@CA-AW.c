/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SpatializerAsar@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18009A6E0
 * Callers:
        ...
        __int64 a3)
{
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState(0x936ECCuLL, a2, a3);
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(9662156, 0, &v11) )
    {
      if ( v3 )
      {
        v9 = v6;
