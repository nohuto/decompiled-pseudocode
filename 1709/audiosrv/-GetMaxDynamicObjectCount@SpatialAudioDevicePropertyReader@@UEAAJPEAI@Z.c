/*
 * XREFs of ?GetMaxDynamicObjectCount@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x1800D22C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( a2 )
  {
    *a2 = *((unsigned __int16 *)this + 70);
  }
  else
  {
    if ( (unsigned int)dword_18014A3B0 > 2 )
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetMaxDynamicObjectCount");
      v9 = 646;
      v13 = &v9;
      v15 = &v10;
      v14 = 4LL;
