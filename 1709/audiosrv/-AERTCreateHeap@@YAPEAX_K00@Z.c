/*
 * XREFs of ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x1800DD710
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x1800DD9F0 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 * Callees:
 *     WPP_SF_PPPL @ 0x1800DDE64 (WPP_SF_PPPL.c)
