/*
 * XREFs of ?MME_ServiceStart@@YAJXZ @ 0x1800A1540
 * Callers:
 *     ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x180061F40 (-Initialize@CAudioSrv@@UEAAJJ@Z.c)
 * Callees:
 *     WPP_SF_ @ 0x180064AF4 (WPP_SF_.c)
 *     ?ConvertTwoStringSidsToSids@@YAHPEBG0PEAPEAX1@Z @ 0x1800A1030 (-ConvertTwoStringSidsToSids@@YAHPEBG0PEAPEAX1@Z.c)
...
__int64 MME_ServiceStart(void)
{
  ...
  if ( (unsigned int)IsMmeServiceStartSupported() )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Fu, (__int64)&WPP_b102d38601a836944f027ba64192a35a_Traceguids);
    }
