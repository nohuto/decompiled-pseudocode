/*
 * XREFs of ?GetMany@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJIIPEAPEAUHSTRING__@@PEAI@Z @ 0x1800E3590
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a5)
{
  ...
  v16 = 0LL;
  *a5 = 0;
  XWinRT::SerializingLockPolicy::Read(v15, a1 + 112, &v17);
  if ( !*(_DWORD *)(a1 + 88) || (v16 = operator new[](v5, (const struct std::nothrow_t *)&std::nothrow)) != 0LL )
  {
    v12 = v17;
  }
  else
      ...
      if ( *(_DWORD *)(a1 + 88) )
      {
        if ( (_DWORD)v5 )
        {
          do
          {
            if ( v10 + a2 >= v11 )
              break;
            v12 = WindowsDuplicateString(*(HSTRING *)(*(_QWORD *)(a1 + 96) + 8LL * (v10 + a2)), &v7[v10]);
            if ( v12 < 0 )
              break;
            ++v10;
          }
      ...
      else if ( (_DWORD)v5 )
      {
        do
        {
          if ( (unsigned int)v6 + a2 >= v11 )
            break;
          v12 = WindowsDuplicateString(*(HSTRING *)(*(_QWORD *)(a1 + 96) + 8LL * ((unsigned int)v6 + a2)), &v7[v6]);
          if ( v12 < 0 )
            break;
