/*
 * XREFs of ?SetMixFormatInternal@CPolicyConfig@@SAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEBUtWAVEFORMATEX@@@Z @ 0x180088790
 * Callers:
...
LABEL_17:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetMixFormatInternal", 3834, ProcessingModeSpecificMixFormatKey);
    goto LABEL_18;
  }
