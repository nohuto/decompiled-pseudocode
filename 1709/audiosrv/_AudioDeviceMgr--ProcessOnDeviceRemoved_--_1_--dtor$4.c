/*
 * XREFs of _AudioDeviceMgr::ProcessOnDeviceRemoved_::_1_::dtor$4 @ 0x1800E7C88
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::ProcessOnDeviceRemoved_::_1_::dtor_4(__int64 a1, __int64 a2)
{
