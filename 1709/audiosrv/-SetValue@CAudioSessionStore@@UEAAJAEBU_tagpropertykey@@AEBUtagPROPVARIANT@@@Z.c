/*
 * XREFs of ?SetValue@CAudioSessionStore@@UEAAJAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x1800891C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( v14 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionStore::SetValue", 5406, v14);
