/*
 * XREFs of ?NotifyAudioDGTerminated@CVolumeStrip@@UEAAXXZ @ 0x180009660
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::NotifyAudioDGTerminated(CVolumeStrip *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_879f8c7a46163fac74ca54c33ad9d683_Traceguids);
  }
  v2 = *((_QWORD *)this + 30);
  if ( v2 )
