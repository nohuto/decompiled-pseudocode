/*
 * XREFs of ?GetResourceSharingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAW4SpatialAudioResourceSharingMode@@@Z @ 0x1800D2960
 * Callers:
 *     <none>
 * Callees:
        ...
        enum SpatialAudioResourceSharingMode *a2)
{
  ...
  else
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetResourceSharingMode");
      v9 = 660;
      v13 = &v9;
      v15 = &v10;
      v14 = 4LL;
