/*
 * XREFs of ?OnPropertyValueChanged@AudioEffectsWatcher@@UEAAJPEBGU_tagpropertykey@@@Z @ 0x18006F8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _tagpropertykey *a3)
{
  ...
  if ( CompareStringOrdinal(a2, -1, *((LPCWCH *)this + 3), -1, 1) == 2 )
  {
    ...
    {
      if ( (int)CPolicyConfig::GetPropertyStoreProperty(*((const unsigned __int16 **)this + 3), 1u, v7, &pvar) >= 0
        && pvar.vt == 19 )
      {
        lVal = pvar.lVal;
      }
