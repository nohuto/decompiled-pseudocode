/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_7aa2d33e36a32a2890f09fc92a95f1fa___ @ 0x180035AEC
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_7aa2d33e36a32a2890f09fc92a95f1fa___(
        __int64 a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  if ( *(_DWORD *)(a1 + 148) )
  {
    v7 = *(_QWORD *)(a1 + 32);
    pvar = 0LL;
    v5 = (char *)&`CEndpointCharacteristics::FindFirstMatchingPreferredFormat<_lambda_7aa2d33e36a32a2890f09fc92a95f1fa_>'::`2'::PreferredFormatsMicrophone;
    lpsz = 0LL;
    v6 = 8;
    v20 = 0LL;
      ...
      && IIDFromString(lpsz, &iid) >= 0 )
    {
      ...
      {
        v5 = (char *)&`CEndpointCharacteristics::FindFirstMatchingPreferredFormat<_lambda_7aa2d33e36a32a2890f09fc92a95f1fa_>'::`2'::PreferredFormatsLineIn;
      }
    }
  ...
  {
    v5 = (char *)&`CEndpointCharacteristics::FindFirstMatchingPreferredFormat<_lambda_7aa2d33e36a32a2890f09fc92a95f1fa_>'::`2'::PreferredFormatsRender;
    v6 = 4;
  }
  v8 = 0LL;
  v9 = v6;
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(a2 + 16) = 22;
    ...
    if ( v15 < 0 )
      break;
    if ( v17 && (unsigned __int8)lambda_e9af1581bd6c783f369e35704f6cd4a0_::operator()(a3 + 3, a2) )
    {
