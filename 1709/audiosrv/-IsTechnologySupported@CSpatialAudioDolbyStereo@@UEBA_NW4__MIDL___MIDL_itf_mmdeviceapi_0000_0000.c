/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDolbyStereo@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800CF1D0
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a8)
{
  ...
  enum __MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003 v23; // r12d
  CSpatialAudioTech *v24; // r15
  _OWORD *v25; // rax
  __int64 v26; // rcx
  bool v28[4]; // [rsp+30h] [rbp-D0h] BYREF
  unsigned int v29; // [rsp+34h] [rbp-CCh]
  enum __MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003 v30; // [rsp+38h] [rbp-C8h]
  ...
  if ( !byte_18014CACA )
  {
    byte_18014CACB = GetFileAttributesW(L"DolbyHrtfEnc.dll") != -1;
    byte_18014CACA = 1;
  }
  v12 = 0;
  v28[0] = 0;
  ...
  *v32 = 0;
  ...
  if ( !byte_18014CAD8 || !*((_QWORD *)a1 + 1) && byte_18014B220 )
    goto LABEL_38;
...
LABEL_32:
    ...
    v23 = v30;
    v24 = v35;
    CSpatialAudioTech::AssignPriority(v35, v30, Speakers, 2u, v34, v28);
    v12 = v28[0];
    if ( v28[0] )
    {
      if ( *v22 )
      ...
      {
        CSpatialAudioTech::AssignPriority(v24, v23, Headphones, 2u, v22, v28);
        v12 = v28[0];
      }
    }
  }
