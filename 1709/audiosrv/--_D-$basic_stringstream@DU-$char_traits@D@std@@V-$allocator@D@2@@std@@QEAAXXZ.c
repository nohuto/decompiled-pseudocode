/*
 * XREFs of ??_D?$basic_stringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXXZ @ 0x18005AAB4
 * Callers:
 *     _CAudioStream::RecalculateVolume_::_1_::dtor$1 @ 0x1800392DD (_CAudioStream--RecalculateVolume_--_1_--dtor$1.c)
 * Callees:
