/*
 * XREFs of ?SetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEBUtagPROPVARIANT@@@Z @ 0x180088BE0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPROPVARIANT *a5)
{
  ...
  if ( !a2 || !a5 )
  {
    v7 = -2147467261;
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyValue", 4056, v7);
    goto LABEL_7;
  }
