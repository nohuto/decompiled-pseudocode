/*
 * XREFs of AudioServerSetStreamSampleRate @ 0x180090400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetStreamSampleRate(_OWORD *a1, __int64 a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  ...
  v4 = (*(__int64 (__fastcall **)(_OWORD *, __int64))(*(_QWORD *)a1 + 144LL))(a1, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetStreamSampleRate", 3541, v4);
