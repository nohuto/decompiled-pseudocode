/*
 * XREFs of _EndpointDevice::InitAdapterInformation_::_1_::dtor$2 @ 0x1800E99BF
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EndpointDevice::InitAdapterInformation_::_1_::dtor_2(__int64 a1, __int64 a2)
{
