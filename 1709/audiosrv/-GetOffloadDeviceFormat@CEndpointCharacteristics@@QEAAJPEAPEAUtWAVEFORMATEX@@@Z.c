/*
 * XREFs of ?GetOffloadDeviceFormat@CEndpointCharacteristics@@QEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x1800B56C8
 * Callers:
  ...
  if ( v4 >= 0 )
    v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, struct tWAVEFORMATEX **))(MEMORY[0] + 32LL))(
           ...
           *((_QWORD *)this + 2),
           1LL,
           a2);
  LogEPCError("CEndpointCharacteristics::GetOffloadDeviceFormat", 5598, v4);
