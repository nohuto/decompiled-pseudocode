/*
 * XREFs of _CDeviceGraphStore::GetSubmixesForPID_::_1_::catch$36 @ 0x18009793D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetSubmixesForPID_::_1_::catch_36(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
