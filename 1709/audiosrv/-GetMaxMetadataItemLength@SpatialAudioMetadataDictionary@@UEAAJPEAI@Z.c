/*
 * XREFs of ?GetMaxMetadataItemLength@SpatialAudioMetadataDictionary@@UEAAJPEAI@Z @ 0x1800D8A90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  else
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioMetadataDictionary::GetMaxMetadataItemLength");
      v9 = 231;
      v13 = &v9;
      v15 = &v10;
      v14 = 4LL;
