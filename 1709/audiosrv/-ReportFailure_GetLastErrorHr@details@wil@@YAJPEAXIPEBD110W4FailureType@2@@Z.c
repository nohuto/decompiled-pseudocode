/*
 * XREFs of ?ReportFailure_GetLastErrorHr@details@wil@@YAJPEAXIPEBD110W4FailureType@2@@Z @ 0x18005E4B8
 * Callers:
        ...
        const char *a6)
{
  ...
  wil::details::ReportFailure((__int64)a1, v7, a3, 0LL, 0LL, (__int64)a6, 1, v10, 0LL, 0);
  return v10;
}
