/*
 * XREFs of _EndpointCollection::GetDeviceByIdString_::_1_::dtor$0 @ 0x1800E8939
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EndpointCollection::GetDeviceByIdString_::_1_::dtor_0(__int64 a1, __int64 a2)
{
