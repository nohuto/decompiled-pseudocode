/*
 * XREFs of ?Create@CSystemEffectWrapper@@SAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x1800DB678
 * Callers:
 ...
 * Callees:
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x1800DAF50 (--0CSystemEffectWrapper@@QEAA@XZ.c)
