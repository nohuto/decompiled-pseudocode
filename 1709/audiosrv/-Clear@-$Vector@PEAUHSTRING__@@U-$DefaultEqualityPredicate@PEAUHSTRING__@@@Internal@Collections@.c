/*
 * XREFs of ?Clear@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJXZ @ 0x1800E2DF0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  v10 = 0;
  v3 = 0;
  XWinRT::SerializingLockPolicy::Write(&v8, a1 + 112, &v9);
  v4 = v9;
  if ( v9 >= 0 )
  {
