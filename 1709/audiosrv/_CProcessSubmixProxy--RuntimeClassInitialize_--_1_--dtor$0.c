/*
 * XREFs of _CProcessSubmixProxy::RuntimeClassInitialize_::_1_::dtor$0 @ 0x1800386B9
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CProcessSubmixProxy::RuntimeClassInitialize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
