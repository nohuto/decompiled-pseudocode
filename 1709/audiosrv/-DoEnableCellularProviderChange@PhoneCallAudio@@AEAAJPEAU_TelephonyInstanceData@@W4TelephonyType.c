/*
 * XREFs of ?DoEnableCellularProviderChange@PhoneCallAudio@@AEAAJPEAU_TelephonyInstanceData@@W4TelephonyTypeChangeOp@@@Z @ 0x1800C7D64
 * Callers:
...
__int64 __fastcall PhoneCallAudio::DoEnableCellularProviderChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v7 )
  {
    v8 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v7 + 88LL))(v7, a2, a3);
    if ( v8 < 0 )
      v6 = v8;
  }
  if ( v11 )
