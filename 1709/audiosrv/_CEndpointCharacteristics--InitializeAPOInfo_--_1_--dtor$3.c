/*
 * XREFs of _CEndpointCharacteristics::InitializeAPOInfo_::_1_::dtor$3 @ 0x1800B6860
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CEndpointCharacteristics::InitializeAPOInfo_::_1_::dtor_3(__int64 a1, __int64 a2)
{
