/*
 * XREFs of ?_Change_array@?$vector@V?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@std@@V?$allocator@V?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@std@@@2@@std@@AEAAXQEAV?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@2@_K1@Z @ 0x1800A010C
 * Callers:
...
__int64 **__fastcall std::vector<std::unique_ptr<CAppSubmixContext>>::_Change_array(
        __int64 ***a1,
        __int64 **a2,
        __int64 a3,
        __int64 a4)
