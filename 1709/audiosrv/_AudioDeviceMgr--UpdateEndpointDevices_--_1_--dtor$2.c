/*
 * XREFs of _AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor$2 @ 0x1800E8109
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::UpdateEndpointDevices_::_1_::dtor_2(__int64 a1, __int64 a2)
{
