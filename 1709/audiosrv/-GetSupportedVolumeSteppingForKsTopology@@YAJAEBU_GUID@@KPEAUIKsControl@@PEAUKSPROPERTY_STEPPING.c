/*
 * XREFs of ?GetSupportedVolumeSteppingForKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING_LONG@@@Z @ 0x1800EDA50
 * Callers:
 *     ?GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ @ 0x1800EDA0C (-GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ.c)
 * Callees:
        ...
        struct KSPROPERTY_STEPPING_LONG *a4)
{
  ...
  _DWORD v17[10]; // [rsp+58h] [rbp-28h] BYREF
  ...
  if ( a3 && a4 )
  {
    ...
    v9 = ((__int64 (__fastcall *)(struct IKsControl *, GUID *, __int64, _DWORD *, int, int *))KsProperty)(
           a3,
           &v14,
           24LL,
           v17,
