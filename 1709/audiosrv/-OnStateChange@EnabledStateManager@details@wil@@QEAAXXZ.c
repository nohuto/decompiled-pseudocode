/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x18008C3FC
 * Callers:
 ...
 *     _lambda_42ed7cb8e6cd03c5242b9a63c40e80d6_::_lambda_invoker_cdecl_ @ 0x18008A050 (_lambda_42ed7cb8e6cd03c5242b9a63c40e80d6_--_lambda_invoker_cdecl_.c)
 * Callees:
...
{
  RTL_SRWLOCK *v2; // rbp
  union wil_details_FeaturePropertyCache **Ptr; // rbx
  union wil_details_FeaturePropertyCache **v4; // rsi
