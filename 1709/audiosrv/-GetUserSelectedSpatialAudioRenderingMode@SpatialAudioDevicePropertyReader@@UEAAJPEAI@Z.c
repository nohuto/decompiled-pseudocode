/*
 * XREFs of ?GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x1800D30B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( a2 )
  {
    if ( *((_DWORD *)this + 110) )
    {
      ...
      if ( !*((_DWORD *)this + 130) )
        v8 = (char *)this + 116;
      *a2 = AudioEncoderIdToRenderingMode(v8);
    }
    else
    {
      *a2 = 0;
  ...
  else
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetUserSelectedSpatialAudioRenderingMode");
      v10 = 871;
      v14 = &v10;
      v16 = &v11;
      v15 = 4LL;
