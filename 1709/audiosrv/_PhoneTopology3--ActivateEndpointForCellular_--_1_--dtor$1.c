/*
 * XREFs of _PhoneTopology3::ActivateEndpointForCellular_::_1_::dtor$1 @ 0x1800EACE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall PhoneTopology3::ActivateEndpointForCellular_::_1_::dtor_1(__int64 a1, __int64 a2)
{
