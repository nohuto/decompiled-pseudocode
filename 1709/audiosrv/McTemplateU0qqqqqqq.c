/*
 * XREFs of McTemplateU0qqqqqqq @ 0x1800ABB38
 * Callers:
...
__int64 __fastcall McTemplateU0qqqqqqq(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        char a9)
{
  _BYTE v10[16]; // [rsp+20h] [rbp-61h] BYREF
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWriteUM(AUDIO_EVENT_PROVIDER_Context, &EVT_AUDIOSRV_FAIL_SET_SERVICE_STATUS, 8LL, (__int64)v10);
}
