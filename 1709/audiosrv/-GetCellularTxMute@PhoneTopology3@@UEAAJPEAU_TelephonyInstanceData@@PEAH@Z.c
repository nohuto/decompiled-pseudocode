/*
 * XREFs of ?GetCellularTxMute@PhoneTopology3@@UEAAJPEAU_TelephonyInstanceData@@PEAH@Z @ 0x1800EBA30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PhoneTopology3::GetCellularTxMute(PhoneTopology3 *this, struct _TelephonyInstanceData *a2, int *a3)
{
  unsigned int v6; // esi
  __int64 v7; // rdi
  _QWORD *v8; // rbx
