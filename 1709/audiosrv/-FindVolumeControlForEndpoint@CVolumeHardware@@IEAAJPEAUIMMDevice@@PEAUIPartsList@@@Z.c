/*
 * XREFs of ?FindVolumeControlForEndpoint@CVolumeHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x180068168
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_a99c65f464be33b31308c514a5524983_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control )
    {
      ...
      if ( v8 != (CAudioDGProcess *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v8 + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)v8 + 2), 35LL, &WPP_a99c65f464be33b31308c514a5524983_Traceguids, this);
      }
    }
    v9 = v17;
    if ( v17 != a2 )
    ...
    if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 36LL, &WPP_a99c65f464be33b31308c514a5524983_Traceguids, this);
    }
    ...
    if ( v7 < 0 )
LABEL_30:
      AudSrvTraceLoggingErrorHelper("CVolumeHardware::FindVolumeControlForEndpoint", 1163, v7);
    CoTaskMemFree(pv);
    pv = 0LL;
    if ( v14 )
