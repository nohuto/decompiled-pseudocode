/*
 * XREFs of s_pbmCastingAppStateChanged @ 0x1800319D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmCastingAppStateChanged(__int64 a1, unsigned int a2)
{
  ...
  else if ( g_PolicyManager )
  {
    ...
    v9 = 0LL;
    if ( (*v6)(g_PolicyManager, &GUID_0c93d812_7532_4f5c_8909_8c09f6c15677, &v9) >= 0 )
    {
      v8 = 0LL;
      ...
      {
        LOBYTE(v7) = a2 == 0;
        v4 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v9 + 32LL))(v9, v8, v7);
      }
      if ( v8 )
