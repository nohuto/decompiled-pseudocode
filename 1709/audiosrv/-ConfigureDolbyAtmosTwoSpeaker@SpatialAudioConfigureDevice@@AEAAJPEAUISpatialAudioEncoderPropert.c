/*
 * XREFs of ?ConfigureDolbyAtmosTwoSpeaker@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x1800D4B5C
 * Callers:
        ...
        if ( MetadataDictionaryData >= 0 )
        {
          ...
          if ( MetadataDictionaryData >= 0 )
          {
            ...
            if ( MetadataDictionaryData >= 0 )
            {
              ...
              {
                TlgCreateSz(&pDesc, "SpatialAudioConfigureDevice::ConfigureDolbyAtmosTwoSpeaker");
                v25 = 383;
                v30 = &v25;
                v31 = 4LL;
                v32 = &v24;
