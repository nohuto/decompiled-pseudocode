/*
 * XREFs of ?LogTelemetry@CSarmErrorEventValues@CSpatialAudioResourceManagerTraceLogger@@UEAAXXZ @ 0x1800C3B30
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialAudioResourceManagerTraceLogger::CSarmErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 0x400000000000uLL) )
        {
          ...
          v22 = 4LL;
          v24 = 4LL;
          TlgWrite(v5, &unk_180110E98, v6, v7, 7u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000000uLL) )
    {
      ...
      v22 = 4LL;
      v24 = 4LL;
      TlgWrite(v8, &unk_180110F2D, v9, v10, 7u, &pData);
    }
  }
}
