/*
 * XREFs of ?ServerEndpointIsStarted@@YA_NPEBG@Z @ 0x180063644
 * Callers:
...
char __fastcall ServerEndpointIsStarted(const unsigned __int16 *a1)
{
  ...
  if ( !v3 || v3 == 1718 )
  {
          ...
          if ( !RpcStringBindingParseW(StringBinding, 0LL, &Protseq, 0LL, String, 0LL) )
          {
            if ( !(unsigned int)_o__wcsicmp(Protseq, L"ncalrpc") )
            {
              if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
                ...
                && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
              {
                WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_1222a022b1c335ea5b3b60739ad81026_Traceguids);
              }
    ...
    if ( WPP_GLOBAL_Control != (CAudioDGProcess *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_1222a022b1c335ea5b3b60739ad81026_Traceguids, a1);
    }
LABEL_30:
    if ( BindingVector )
