/*
 * XREFs of ??$LogAecEffectPolicy@$0EAAAAAAAAAAI@@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x1800BB5E8
 * Callers:
...
void __fastcall LogAecEffectPolicy<70368744177672>(__int64 a1, const WCHAR *a2)
{
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000008uLL) )
    {
      ...
      v42 = 4LL;
      v44 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801108E0, v6, v7, 0x13u, &pData);
    }
  }
}
