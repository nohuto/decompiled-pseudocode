/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_068f763f677867854f08eaa5008b23ee___ @ 0x1800AD6D8
 * Callers:
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            if ( v10 >= (unsigned __int64)v12->cbSize + 18
              && lambda_068f763f677867854f08eaa5008b23ee_::operator()(a2, v12) )
            {
