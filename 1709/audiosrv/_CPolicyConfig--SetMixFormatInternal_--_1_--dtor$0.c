/*
 * XREFs of _CPolicyConfig::SetMixFormatInternal_::_1_::dtor$0 @ 0x18008891A
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::SetMixFormatInternal_::_1_::dtor_0(__int64 a1, __int64 a2)
{
