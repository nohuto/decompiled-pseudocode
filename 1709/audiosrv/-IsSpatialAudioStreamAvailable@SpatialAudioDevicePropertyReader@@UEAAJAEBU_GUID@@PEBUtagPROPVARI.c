/*
 * XREFs of ?IsSpatialAudioStreamAvailable@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEBUtagPROPVARIANT@@@Z @ 0x1800D34A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPROPVARIANT *a3)
{
  ...
  if ( v8 )
  {
    ...
    {
      v10 = *(_QWORD *)((char *)this + 116) - MICROSOFT_HRTF_SPATIAL_ENCODER;
      if ( !v10 )
        v10 = *(_QWORD *)((char *)this + 124) - *((_QWORD *)&MICROSOFT_HRTF_SPATIAL_ENCODER + 1);
      if ( !v10 )
        return 0;
    }
  }
