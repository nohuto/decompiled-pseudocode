/*
 * XREFs of _CPolicyConfig::SetApplicationDefaultEndpoint_::_1_::dtor$3 @ 0x180087456
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::SetApplicationDefaultEndpoint_::_1_::dtor_3(__int64 a1, __int64 a2)
{
