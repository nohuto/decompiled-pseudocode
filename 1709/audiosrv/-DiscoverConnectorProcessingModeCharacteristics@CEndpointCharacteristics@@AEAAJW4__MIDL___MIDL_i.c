        ...
        __int64 a9)
{
  ...
  v28 = 0LL;
  if ( !a2 )
    CEndpointCharacteristics::GetDefaultConnectorProcessingModeConfiguration(this, 0, &v46, 0LL, 0LL);
  v13 = (void **)operator new(0x10uLL, (const struct std::nothrow_t *)&std::nothrow);
  v14 = v13;
  *(_QWORD *)&v30.Data1 = v13;
  ...
  if ( v14 )
  {
    v16 = v9;
    v17 = 16 * v9;
    ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator=(&v27, (__int64)this + v17 + 64);
    if ( (_DWORD)v28 == *(_DWORD *)((char *)this + v17 + 72) )
    {
