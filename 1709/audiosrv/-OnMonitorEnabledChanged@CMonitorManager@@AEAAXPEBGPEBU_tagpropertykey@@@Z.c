/*
 * XREFs of ?OnMonitorEnabledChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x1800A5C70
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( MonitorForCaptureDeviceIfAppropriate >= 0 )
    {
      ...
      if ( MonitorForCaptureDeviceIfAppropriate >= 0 )
      {
        ...
        if ( v14 )
        {
          ...
          if ( v7 != (CAudioDGProcess *)&WPP_GLOBAL_Control
            && (*((_DWORD *)v7 + 7) & 0x800000) != 0
            && *((_BYTE *)v7 + 25) >= 4u )
          {
            WPP_SF_S(*((_QWORD *)v7 + 2), 0x26u, (__int64)&WPP_f44a6138b15d3ac2c57129b0cddf5064_Traceguids, a2);
          }
