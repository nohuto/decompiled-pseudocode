/*
 * XREFs of ?EscapeIdentifierString@CAudioIdentifier@@SAXAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18007DF2C
 * Callers:
...
__int64 __fastcall CAudioIdentifier::EscapeIdentifierString(const void **a1)
{
