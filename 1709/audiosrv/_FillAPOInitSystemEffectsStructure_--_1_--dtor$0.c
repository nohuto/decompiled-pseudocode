/*
 * XREFs of _FillAPOInitSystemEffectsStructure_::_1_::dtor$0 @ 0x1800DCD77
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall FillAPOInitSystemEffectsStructure_::_1_::dtor_0(__int64 a1, __int64 a2)
{
