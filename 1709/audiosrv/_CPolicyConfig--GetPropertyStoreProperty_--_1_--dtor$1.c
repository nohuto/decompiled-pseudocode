/*
 * XREFs of _CPolicyConfig::GetPropertyStoreProperty_::_1_::dtor$1 @ 0x180037C08
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CPolicyConfig::GetPropertyStoreProperty_::_1_::dtor_1(__int64 a1, __int64 a2)
{
