/*
 * XREFs of _std::_Uninitialized_move_al_unchecked_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________ptr64_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________ptr64_std::allocator_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________::_1_::catch$17 @ 0x18009EABC
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_Uninitialized_move_al_unchecked_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________ptr64_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________ptr64_std::allocator_std::unique_ptr_CAppSubmixContext_std::default_delete_CAppSubmixContext________::_1_::catch_17(
        __int64 a1,
        __int64 a2)
{
