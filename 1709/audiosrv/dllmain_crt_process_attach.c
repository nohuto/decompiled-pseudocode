/*
 * XREFs of dllmain_crt_process_attach @ 0x180032790
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x180033000 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18003309C (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800335EC (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180033608 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180033624 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180033634 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180033780 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800339C0 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800339C6 (_initterm_e_0.c)
