/*
 * XREFs of ?RegisterPnpNotifications@CAudioSrv@@UEAAJPEAUSERVICE_STATUS_HANDLE__@@@Z @ 0x1800632A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSrv::RegisterPnpNotifications(HPOWERNOTIFY *this, struct SERVICE_STATUS_HANDLE__ *a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 19LL, &WPP_1222a022b1c335ea5b3b60739ad81026_Traceguids, v4);
  }
  ...
  if ( v5
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_1222a022b1c335ea5b3b60739ad81026_Traceguids, v5);
  }
  ...
  if ( v6
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 21LL, &WPP_1222a022b1c335ea5b3b60739ad81026_Traceguids, v6);
  }
  return v7;
}
