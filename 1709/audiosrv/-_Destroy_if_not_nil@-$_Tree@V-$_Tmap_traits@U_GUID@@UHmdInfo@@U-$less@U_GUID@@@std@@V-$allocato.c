/*
 * XREFs of ?_Destroy_if_not_nil@?$_Tree@V?$_Tmap_traits@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@$0A@@std@@@std@@IEAAXPEAU?$_Tree_node@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@PEAX@2@@Z @ 0x1800C7754
 * Callers:
 ...
 *     _std::_Tree_std::_Tmap_traits__GUID_HmdInfo_std::less__GUID__std::allocator_std::pair__GUID_const__HmdInfo____0___::_Insert_hint_std::pair__GUID_const__HmdInfo__&___ptr64_std::_Tree_node_std::pair__GUID_const__HmdInfo__void_____ptr64______ptr64__::_1_::catch$117 @ 0x1800C5AC1 (_std--_Tree_std--_Tmap_traits__GUID_HmdInfo_std--less__GUID__std--allocator_std--pair__GUID_cons.c)
 ...
 *     _std::_Tree_std::_Tmap_traits__GUID_HmdInfo_std::less__GUID__std::allocator_std::pair__GUID_const__HmdInfo____0___::_Insert_nohint_std::pair__GUID_const__HmdInfo__&___ptr64_std::_Tree_node_std::pair__GUID_const__HmdInfo__void_____ptr64______ptr64__::_1_::catch$42 @ 0x1800C5C75 (_std--_Tree_std--_Tmap_traits__GUID_HmdInfo_std--less__GUID__std--allocator_std--pa_ea_1800C5C75.c)
 * Callees:
 *     ??1?$com_ptr_t@UIHolographicDisplay@Holographic@Graphics@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x180007BA0 (--1-$com_ptr_t@UIHolographicDisplay@Holographic@Graphics@Windows@@Uerr_returncode_policy@wil@@@w.c)
 */

void __fastcall std::_Tree<std::_Tmap_traits<_GUID,HmdInfo,std::less<_GUID>,std::allocator<std::pair<_GUID const,HmdInfo>>,0>>::_Destroy_if_not_nil(
        __int64 a1,
        _QWORD *a2)
{
