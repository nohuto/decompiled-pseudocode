/*
 * XREFs of _CAudioSessionManager::SetEndpointId_::_1_::dtor$0 @ 0x180038C38
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSessionManager::SetEndpointId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
