/*
 * XREFs of _AudioDeviceMgr::IsOnPhoneTopologyMultiplexer_::_1_::dtor$0 @ 0x1800E7687
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall AudioDeviceMgr::IsOnPhoneTopologyMultiplexer_::_1_::dtor_0(__int64 a1, __int64 a2)
{
