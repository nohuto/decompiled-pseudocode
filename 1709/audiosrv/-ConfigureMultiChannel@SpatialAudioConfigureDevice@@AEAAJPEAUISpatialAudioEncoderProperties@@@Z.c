/*
 * XREFs of ?ConfigureMultiChannel@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x1800D58C0
 * Callers:
...
__int64 __fastcall SpatialAudioConfigureDevice::ConfigureMultiChannel(
        ...
        struct ISpatialAudioEncoderProperties *a2)
{
  ...
  if ( v13[0] >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      {
        TlgCreateSz(&pDesc, "SpatialAudioConfigureDevice::ConfigureMultiChannel");
        v19 = 0;
        v22 = 0;
        v17 = v13;
        v18 = 4;
