/*
 * XREFs of ?GetCallState@PhoneCallAudio@@UEAAJPEAU_TelephonyInstanceData@@PEAW4TelephonyState@@@Z @ 0x1800C80F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 && a3 )
  {
    *(_DWORD *)a3 = 1;
    if ( this[1].DebugInfo )
    {
      ...
      {
        v11 = 0;
        v7 = (*(__int64 (__fastcall **)(PRTL_CRITICAL_SECTION_DEBUG, struct _TelephonyInstanceData *, int *))(*(_QWORD *)this[1].DebugInfo + 80LL))(
               this[1].DebugInfo,
               a2,
               &v11);
        if ( v7 >= 0 )
