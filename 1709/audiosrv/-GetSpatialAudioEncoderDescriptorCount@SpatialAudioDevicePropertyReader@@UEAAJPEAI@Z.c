/*
 * XREFs of ?GetSpatialAudioEncoderDescriptorCount@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x1800D2A50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( *((_DWORD *)this + 130) )
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioDevicePropertyReader::GetSpatialAudioEncoderDescriptorCount");
      v13[0] = 674;
      v16 = v13;
      v18 = &v12;
      v17 = 4LL;
