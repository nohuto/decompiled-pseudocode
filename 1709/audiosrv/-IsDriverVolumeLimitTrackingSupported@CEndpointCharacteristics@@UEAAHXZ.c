/*
 * XREFs of ?IsDriverVolumeLimitTrackingSupported@CEndpointCharacteristics@@UEAAHXZ @ 0x1800B69B0
 * Callers:
 *     <none>
 * Callees:
    ...
    && (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v8 + 64LL))(v8, &v10) >= 0 )
  {
           ...
           &v12) >= 0 )
    {
      ...
      *(_QWORD *)&v15[1] = 0x20000000039LL;
      if ( (*(int (__fastcall **)(__int64, _OWORD *, __int64, unsigned int *, int, int *))(*(_QWORD *)v12 + 24LL))(
             v12,
             v15,
             32LL,
             &v18,
