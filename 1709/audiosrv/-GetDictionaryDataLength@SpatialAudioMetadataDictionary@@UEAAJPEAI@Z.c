/*
 * XREFs of ?GetDictionaryDataLength@SpatialAudioMetadataDictionary@@UEAAJPEAI@Z @ 0x1800D87A0
 * Callers:
 *     ?GetDictionaryDataLength@SpatialAudioMetadataDictionary@@W7EAAJPEAI@Z @ 0x180037550 (-GetDictionaryDataLength@SpatialAudioMetadataDictionary@@W7EAAJPEAI@Z.c)
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  else
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioMetadataDictionary::GetDictionaryDataLength");
      v9 = 335;
      v13 = &v9;
      v15 = &v10;
      v14 = 4LL;
