/*
 * XREFs of ConcatenateResTemplate @ 0x1C0060F60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CheckAndPromoteAliasedObjects @ 0x1C005D248 (CheckAndPromoteAliasedObjects.c)
 */
...
__int64 __fastcall ConcatenateResTemplate(__int64 a1, __int64 a2)
{
  ...
  if ( !v5 )
  {
    ...
    v5 = ValidateTarget(a1, v6 + 80, 0x87u, &v22);
    if ( !v5 )
    {
      v8 = *(__int16 **)(a2 + 80);
      if ( v8[41] != 128 )
