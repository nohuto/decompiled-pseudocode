/*
 * XREFs of ACPIProcessorContainerEvaluateLpiObjects @ 0x1C005670C
 * Callers:
 *     ACPIProcessorContainerEvaluateLpiObjects @ 0x1C005670C (ACPIProcessorContainerEvaluateLpiObjects.c)
