/*
 * XREFs of ACPIButtonCompletePendingIrps @ 0x1C00467B4
 * Callers:
...
char __fastcall ACPIButtonCompletePendingIrps(__int64 a1, int a2)
{
  ...
  while ( v6 != &AcpiButtonList )
  {
    ...
    if ( *(_QWORD *)(v8[23] + 40) == a1 && _InterlockedExchange64(v8 + 13, 0LL) )
    {
      ...
      *((_DWORD *)v8 + 12) = 0;
      v8[7] = 4LL;
      v10 = v8[21];
      if ( *(__int64 **)(v10 + 8) != v8 + 21 || (v11 = (__int64 *)v8[22], (_QWORD *)*v11 != v9) )
        __fastfail(3u);
      *v11 = v10;
      *(_QWORD *)(v10 + 8) = v11;
      v12 = v19;
  ...
  while ( v13 != &v18 )
  {
    ...
    if ( (void **)Flink->Blink != &v14->Tail.CompletionKey + 6
      || (Blink = v14->Tail.Overlay.ListEntry.Blink, (void **)Blink->Flink != &v14->Tail.CompletionKey + 6) )
    {
      __fastfail(3u);
    }
    Blink->Flink = Flink;
