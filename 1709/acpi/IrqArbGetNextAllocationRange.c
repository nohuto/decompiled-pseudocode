/*
 * XREFs of IrqArbGetNextAllocationRange @ 0x1C0088020
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IrqArbpFindBootConfig @ 0x1C008CEA0 (IrqArbpFindBootConfig.c)
 *     ArbGetNextAllocationRange @ 0x1C00958B0 (ArbGetNextAllocationRange.c)
 *     IrqArbIrqFromGsiv @ 0x1C00A8640 (IrqArbIrqFromGsiv.c)
 *     IrqArbpFindIrqInAlternatives @ 0x1C00A8A20 (IrqArbpFindIrqInAlternatives.c)
 */
...
char __fastcall IrqArbGetNextAllocationRange(__int64 a1, _QWORD *a2)
{
  ...
  if ( (v6 & 0x20) != 0 )
    goto LABEL_28;
  if ( (int)PcisuppIsPciDevice(v4, &v27) < 0 )
    return 0;
  if ( !(_BYTE)v27 )
  {
LABEL_28:
