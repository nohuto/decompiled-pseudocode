/*
 * XREFs of ACPIBusIrpQueryDeviceId @ 0x1C00940AC
 * Callers:
 ...
 *     ACPIValidateStringVendorDeviceIdFormat @ 0x1C008D914 (ACPIValidateStringVendorDeviceIdFormat.c)
 */
...
LABEL_9:
      if ( v11 < Size )
        goto LABEL_12;
      v17 = RtlStringCbPrintfExW(&v10[Size >> 1], v11 - Size, ppszDestEnd, &pcbRemaining, 0, &word_1C00682B8);
LABEL_11:
      v7 = v17;
LABEL_12:
      if ( v7 >= 0 )
