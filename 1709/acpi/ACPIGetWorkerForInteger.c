/*
 * XREFs of ACPIGetWorkerForInteger @ 0x1C00074D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ACPIGetWorkerForInteger(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  {
    v23 = (_DWORD *)a4[8];
    if ( (v10 & 0x4000000) != 0 || (v26 = a4[3], (*(_QWORD *)(v26 + 8) & 0x2000000000000000LL) == 0) )
    {
      if ( v8 < 0 )
        goto LABEL_28;
      if ( *(_WORD *)(a3 + 2) != 1 )
    ...
    if ( (v10 & 0x4000000) != 0 )
    {
      if ( (_DWORD)a2 != -1073741772 )
      {
        if ( (int)a2 >= 0 )
        {
          v28 = *(_WORD *)(a3 + 2);
          if ( v28 != 1 )
            KeBugCheckEx(0xA5u, 8uLL, v11, 0LL, v28);
          v12 = *(_DWORD *)(a3 + 16);
        }
        else
        {
...
LABEL_7:
      ...
      {
        if ( (int)ACPIGetProcessorStatus(v11, a2, &v32) < 0 )
        {
          v12 = 0;
          v32 = 0;
        }
      ...
      if ( v8 != -1073741772 )
      {
        ...
        else
        {
          if ( *(_WORD *)(a3 + 2) != 1 )
          {
            v27 = AMLIGetNamedChild(*(__int64 **)(v11 + 712), 1096045407);
...
LABEL_28:
  *((_DWORD *)a4 + 18) = v8;
  ...
  if ( *(_QWORD *)(a3 + 32) )
  {
    ...
    if ( *(_WORD *)(a3 + 2) == 4 )
      FreeDataBuffs(*(_QWORD *)(a3 + 32) + 8LL, **(unsigned int **)(a3 + 32));
    FreeObjData(a3);
LABEL_89:
    v9 = a1;
  }
