/*
 * XREFs of ACPIDevicePowerProcessPhase5SystemSubPhase1 @ 0x1C00490F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase5SystemSubPhase1(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 212) = 4;
  ...
  {
    qword_1C0078FF8 = a1;
    qword_1C0078FE8 = (__int64)&AcpiPauseInterpreterEntry;
    qword_1C0078FF0 = (__int64)ACPIDeviceCompleteInterpreterRequest;
