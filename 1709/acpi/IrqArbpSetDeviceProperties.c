/*
 * XREFs of IrqArbpSetDeviceProperties @ 0x1C0089908
 * Callers:
 ...
 *     IrqPolicySetDeviceAffinity @ 0x1C008BA50 (IrqPolicySetDeviceAffinity.c)
 */
  ...
  *(_OWORD *)&Iterator.Current = v4;
  while ( 1 )
  {
    if ( a1->Owner == *p_Owner )
    {
      ...
      DeviceIdtAssignment = ProcessorGetDeviceIdtAssignment(Owner, v11, 0, &v30);
    ...
    *(_OWORD *)&Iterator.Current = v29;
    while ( 1 )
    {
      if ( v9->Owner == *v25 )
      {
        ...
        DeviceIdtAssignment = ProcessorGetDeviceIdtAssignment(Owner, v18, 0, &v30);
        if ( DeviceIdtAssignment < 0 )
          goto LABEL_24;
        if ( v7 )
          v17 -= v31;
        v19 = Range->UserData;
        v20 = 22LL * v17;
        memmove(&Data[v20 + 2], v19 + 8, 88LL * v31);
