/*
 * XREFs of ACPIThermalLoopEx @ 0x1C002408C
 * Callers:
 ...
 *     ACPIThermalReadTemperatureComplete @ 0x1C0058E60 (ACPIThermalReadTemperatureComplete.c)
        ...
        if ( *(_BYTE *)(v3 + 273) || (v15 & 2) != 0 )
        {
          ...
          else
          {
            *(_DWORD *)(a1 + 192) = v19 | 0x1000;
            ...
            v27 = (_QWORD *)qword_1C0078A08;
            v11 = v26;
            v28 = (_QWORD *)(a1 + 208);
            if ( *(__int64 **)qword_1C0078A08 != &AcpiThermalZoneList )
              __fastfail(3u);
            *v28 = &AcpiThermalZoneList;
            *(_QWORD *)(a1 + 216) = v27;
            *v27 = v28;
            qword_1C0078A08 = a1 + 208;
