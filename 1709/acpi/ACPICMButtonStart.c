/*
 * XREFs of ACPICMButtonStart @ 0x1C009759C
 * Callers:
 *     ACPICMPowerButtonStart @ 0x1C0097580 (ACPICMPowerButtonStart.c)
 *     ACPICMExperienceButtonStart @ 0x1C00A09E0 (ACPICMExperienceButtonStart.c)
 *     ACPICMLidStart @ 0x1C00A0B20 (ACPICMLidStart.c)
 *     ACPICMSleepButtonStart @ 0x1C00A0B40 (ACPICMSleepButtonStart.c)
 * Callees:
