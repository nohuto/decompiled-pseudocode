/*
 * XREFs of ArbInitializeRangeList @ 0x1C00A9190
 * Callers:
 *     <none>
 * Callees:
 *     RtlFreeRangeList_0 @ 0x1C002BC66 (RtlFreeRangeList_0.c)
 *     RtlInitializeRangeList_0 @ 0x1C002BC72 (RtlInitializeRangeList_0.c)
 *     RtlAddRange_0 @ 0x1C002BC7E (RtlAddRange_0.c)
 *     RtlInvertRangeList_0 @ 0x1C002BC8A (RtlInvertRangeList_0.c)
...
__int64 __fastcall ArbInitializeRangeList(__int64 a1, unsigned int a2, unsigned __int8 *a3, struct _RTL_RANGE_LIST *a4)
{
  ...
  int v10; // ecx
  NTSTATUS v11; // ebx
  ULONGLONG Start; // [rsp+40h] [rbp-48h] BYREF
  struct _RTL_RANGE_LIST RangeList; // [rsp+48h] [rbp-40h] BYREF
