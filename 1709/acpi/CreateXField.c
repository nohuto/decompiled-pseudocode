/*
 * XREFs of CreateXField @ 0x1C001BC5C
 * Callers:
 *     CreateBitField @ 0x1C001A3D0 (CreateBitField.c)
 *     CreateDWordField @ 0x1C001BC10 (CreateDWordField.c)
 *     CreateWordField @ 0x1C00295B0 (CreateWordField.c)
 *     CreateByteField @ 0x1C0029AE0 (CreateByteField.c)
 *     CreateField @ 0x1C002B330 (CreateField.c)
 *     CreateQWordField @ 0x1C005F140 (CreateQWordField.c)
 * Callees:
