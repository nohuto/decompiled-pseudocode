/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C0095CDC
 * Callers:
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C0078B30 = OutputBuffer[1];
        unk_1C0078B40 = OutputBuffer[2];
        xmmword_1C0078B50 = OutputBuffer[3];
        xmmword_1C0078B60 = OutputBuffer[4];
        xmmword_1C0078B70 = OutputBuffer[5];
