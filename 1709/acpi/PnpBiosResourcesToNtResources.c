/*
 * XREFs of PnpBiosResourcesToNtResources @ 0x1C008F030
 * Callers:
 ...
 *     PnpiClearAllocatedMemory @ 0x1C008F744 (PnpiClearAllocatedMemory.c)
...
LABEL_78:
    ...
    switch ( v16 )
    {
      ...
      case 0x89u:
        ...
        v59 = 0;
        v60 = 4 * v58 + 5;
        if ( AcpiInterruptCombiningSupported != 1 || (v61 = *(_BYTE *)(a2 + 1) + 3, v61 <= v60) )
        {
          DeviceExtension = 0;
...
LABEL_36:
        ...
        v53 = PnpiBiosInterruptCombineToIoDescriptor(a1, a2, v61 - v60 - 1, (int)v9, v67, a3);
        goto LABEL_78;
      case 0x8Au:
          ...
          for ( j = 1; j <= v24; ++j )
          {
            ...
            if ( v50 )
            {
              ...
              *(_DWORD *)(v49 + 4) = v23 + v50;
              WPP_RECORDER_SF_dqLD((__int64)WPP_GLOBAL_Control->DeviceExtension, v31, v32, v33, v64);
