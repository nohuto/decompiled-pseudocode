/*
 * XREFs of ACPIProcessorContainerStartDeviceWorker @ 0x1C0056C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIProcessorContainerStartDeviceWorker(__int64 a1)
{
  ...
  if ( !AcpiProcessorContainerHierarchyLocked )
  {
    for ( i = v4[93]; ; i = *(_QWORD *)(i + 744) )
    {
      if ( !i )
      {
        v8 = (_QWORD *)qword_1C0078A98;
        v9 = v4 + 23;
        if ( *(__int64 **)qword_1C0078A98 != &AcpiProcessorContainerRootList )
          __fastfail(3u);
        *v9 = &AcpiProcessorContainerRootList;
        v4[24] = v8;
        *v8 = v9;
        qword_1C0078A98 = (__int64)(v4 + 23);
        goto LABEL_12;
      }
