/*
 * XREFs of ACPIDevicePowerDpc @ 0x1C0006370
 * Callers:
 *     <none>
 * Callees:
 *     ACPIDevicePowerProcessGenericPhase @ 0x1C0003500 (ACPIDevicePowerProcessGenericPhase.c)
 *     ACPIInternalMovePowerList @ 0x1C0004E5C (ACPIInternalMovePowerList.c)
 ...
 *     ACPIDeviceRecordBlockedOnPhase3List @ 0x1C0049B20 (ACPIDeviceRecordBlockedOnPhase3List.c)
...
LABEL_9:
      ...
      if ( AcpiPowerPhase0List != &AcpiPowerPhase0List )
      {
        ...
        {
          v10 = (PVOID *)*v6;
          v11 = (struct _SLIST_ENTRY *)v6;
          v12 = _InterlockedCompareExchange((volatile signed __int32 *)v6 + 52, 1, 1);
          v13 = v12;
          if ( v12 >= 5 )
          ...
          if ( !v14 )
            goto LABEL_37;
          _InterlockedCompareExchange((volatile signed __int32 *)v6 + 52, 1, v12);
          if ( (*(int (__fastcall **)(PVOID *))(v14 + 8LL * *((int *)v6 + 12)))(v6) < 0 )
            break;
LABEL_41:
        ...
        if ( v13 == 1 )
        {
          ...
          if ( v16 )
          {
            ...
            if ( *(&v11->Next->Next + 1) != v11
              || (v44 = (struct _SLIST_ENTRY **)*((_QWORD *)&v11->Next + 1), *v44 != v11) )
            {
              __fastfail(3u);
            }
            *v44 = Next;
            *((_QWORD *)&Next->Next + 1) = v44;
            v11[6].Next = (_SLIST_ENTRY *)&AcpiPowerPhase0List;
            v45 = (struct _SLIST_ENTRY **)qword_1C0079078;
...
LABEL_19:
      ...
      v7 = (PVOID *)AcpiPowerPhase5List;
      if ( AcpiPowerPhase5List != &AcpiPowerPhase5List )
      {
        while ( 1 )
        {
          v23 = (PVOID *)*v7;
          v24 = (struct _SLIST_ENTRY *)v7;
          v25 = _InterlockedCompareExchange((volatile signed __int32 *)v7 + 52, 1, 1);
          if ( v25 >= 9 )
            KeBugCheckEx(0xA3u, 1uLL, 0xC1737uLL, 0LL, 0LL);
          _mm_lfence();
          ...
          if ( !v26 )
            goto LABEL_61;
          _InterlockedCompareExchange((volatile signed __int32 *)v7 + 52, 1, v25);
          if ( (*(int (__fastcall **)(PVOID *))(v26 + 8LL * *((int *)v7 + 12)))(v7) < 0 )
            break;
LABEL_69:
          if ( v7 == &AcpiPowerPhase5List )
            goto LABEL_21;
        }
        v25 = 0;
LABEL_61:
        ...
        if ( v25 == 1 )
        {
          ...
          if ( v28 )
          {
            ...
            if ( *(&v24->Next->Next + 1) != v24
              || (v41 = (struct _SLIST_ENTRY **)*((_QWORD *)&v24->Next + 1), *v41 != v24) )
            {
              __fastfail(3u);
            }
            *v41 = v40;
...
LABEL_21:
  ...
  KeReleaseSpinLockFromDpcLevel(&AcpiPowerQueueLock);
  v8 = (struct _SLIST_ENTRY *)Entry[0];
  if ( Entry[0] != Entry )
  {
    do
    {
      p_Next = (PVOID *)&v8->Next->Next;
      ACPIDeviceCompleteRequest(v8);
      v8 = (struct _SLIST_ENTRY *)p_Next;
    }
    while ( p_Next != Entry );
  }
}
