/*
 * XREFs of AcpiDiagRequeueThermalPollingTimer @ 0x1C0040B64
 * Callers:
 *     AcpiDiagThermalPollingTimerRoutine @ 0x1C0040C10 (AcpiDiagThermalPollingTimerRoutine.c)
 *     AcpiDiagThermalPollingTraceControlCallback @ 0x1C0040C80 (AcpiDiagThermalPollingTraceControlCallback.c)
