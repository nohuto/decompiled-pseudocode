/*
 * XREFs of AcpiArblibAllocateArbiterInstance @ 0x1C009F594
 * Callers:
 ...
 *     AMLIGetNSObjectNameSegment @ 0x1C000EC10 (AMLIGetNSObjectNameSegment.c)
 ...
 *     AMLIReferenceHandleEx @ 0x1C005B8BC (AMLIReferenceHandleEx.c)
 */
