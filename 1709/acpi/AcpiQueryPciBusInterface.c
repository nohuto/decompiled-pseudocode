/*
 * XREFs of AcpiQueryPciBusInterface @ 0x1C00956EC
 * Callers:
...
__int64 __fastcall AcpiQueryPciBusInterface(ULONG_PTR BugCheckParameter3)
{
  ...
  _BYTE v13[256]; // [rsp+88h] [rbp-80h] BYREF
  ...
  if ( PoolWithTag )
  {
    ...
    if ( AttachedDeviceReference )
    {
      ...
      v12 = &v8;
      v11 = PoolWithTag;
      v5 = ACPIInternalSendSynchronousIrp(AttachedDeviceReference, (__int64)v9, 0LL);
