/*
 * XREFs of IrqPolicyGetDevicePolicy @ 0x1C0089D5C
 * Callers:
        ...
        __int64 a6)
{
      ...
      case 3:
        ...
        if ( (unsigned int)(v14 - 1) <= 7 )
        {
          do
          {
            ...
            v13[1] = v14;
            v11 = *((unsigned __int8 *)v13 + v14 + 8) | (unsigned __int64)(v11 << 8);
          }
          while ( (_DWORD)v14 );
        }
        break;
  ...
  if ( RegistryValues >= 0 )
  {
    ...
    if ( v16 != 4 )
    {
      if ( v16 == 2 )
      {
        IrqTraceAffinityPolicy(Pdo, 2u, 0, 0LL);
        v16 = v23[0];
        LOWORD(v10) = v24;
      }
      if ( v16 )
...
LABEL_22:
    if ( !InitSafeBootMode && v10 != 0xFFFF && v11 )
    {
      v25 = 0;
      v9 = v11;
      IrqTraceAffinityPolicy(Pdo, 4u, v10, v11);
      v16 = v23[0];
      goto LABEL_31;
    }
LABEL_29:
