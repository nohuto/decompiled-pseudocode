/*
 * XREFs of SyncEvalObject @ 0x1C0006D00
 * Callers:
...
LABEL_5:
  ...
  if ( !v11 )
  {
    ...
    {
      v17 = _InterlockedExchangeAdd((_DWORD *)&qword_1C0079788 + 1, 1u);
      if ( (_DWORD)qword_1C0079788 == 204 )
        v18 = v17 % 0xCC;
      else
        v18 = v17 % (unsigned int)qword_1C0079788;
      v19 = 72LL * v18;
      *(_QWORD *)((char *)P + v19 + 8) = MEMORY[0xFFFFF78000000008];
      *(_DWORD *)((char *)P + v19) = 1398361667;
      *(_QWORD *)((char *)P + v19 + 16) = v14;
      *(_QWORD *)((char *)P + v19 + 24) = 0LL;
      *(_QWORD *)((char *)P + v19 + 32) = 0LL;
      *(_QWORD *)((char *)P + v19 + 40) = v15;
      *(_QWORD *)((char *)P + v19 + 48) = CurrentIrql;
      *(_QWORD *)((char *)P + v19 + 56) = a1;
      *(_QWORD *)((char *)P + v19 + 64) = 0LL;
    }
