/*
 * XREFs of ArbPruneOrdering @ 0x1C00A934C
 * Callers:
...
__int64 __fastcall ArbPruneOrdering(unsigned __int16 *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, 16LL * (2 * (unsigned int)*a1 + 1), 0x4C627241u);
  if ( !PoolWithTag )
...
LABEL_18:
  ...
  if ( (_WORD)v14 )
  {
    ...
    memmove(*((void **)a1 + 1), PoolWithTag, 16LL * (unsigned __int16)v14);
  }
  ExFreePoolWithTag(PoolWithTag, 0);
  result = 0LL;
  *a1 = v14;
