/*
 * XREFs of DebugExpr @ 0x1C005DD84
 * Callers:
 ...
 *     FindObjSymbol @ 0x1C005E650 (FindObjSymbol.c)
...
LABEL_4:
  ...
  {
    strupr_0(Src);
    if ( (unsigned int)GetNameSpaceObject(Src, 0LL, (__int64)&v14, 1) || (v10 = v14, *(_WORD *)(v14 + 66) != 8) )
    {
      v8 = Src;
      v9 = 232;
      goto LABEL_4;
