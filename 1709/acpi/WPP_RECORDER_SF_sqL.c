/*
 * XREFs of WPP_RECORDER_SF_sqL @ 0x1C004A6B0
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItems @ 0x1C0049BF0 (ACPIIsPhase3ListEmptyOfUnblockedItems.c)
        ...
        ...)
{
  ...
  if ( !a6 )
    v7 = "NULL";
  LOWORD(v19) = a4;
  return WppAutoLogTrace(a1, a2, a3, a5, v19, v7, v17, (__int64 *)va, 8LL, va1, 4LL, 0LL, v20, v21);
}
