/*
 * XREFs of ACPIDevicePowerProcessPhase0DeviceSubPhase1 @ 0x1C0004CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase0DeviceSubPhase1(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 56) |= 0x1000000u;
  v4 = 0;
  v6 = ACPIGet((_DWORD)v1, 1096045407, -1610344446, 0, 0, (__int64)ACPIDeviceCompleteGenericPhase, a1, v2 + 16, v2 + 24);
  v7 = &unk_1C0067B08;
  v8 = &unk_1C0067B08;
  if ( v1 )
  {
