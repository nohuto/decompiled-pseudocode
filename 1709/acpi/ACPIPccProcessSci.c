/*
 * XREFs of ACPIPccProcessSci @ 0x1C0052CEC
 * Callers:
 *     ACPIInterruptServiceRoutineDPC @ 0x1C0050670 (ACPIInterruptServiceRoutineDPC.c)
 * Callees:
 *     AcpiPccCommandComplete @ 0x1C005309C (AcpiPccCommandComplete.c)
 *     AcpiPccPlatformNotification @ 0x1C00534D4 (AcpiPccPlatformNotification.c)
 */
...
__int64 ACPIPccProcessSci()
{
  ...
  if ( AcpiPccSciReferenceCount )
  {
    ...
    if ( AcpiPccSubspaces )
    {
      result = (unsigned int)AcpiPccSubspaceCount;
