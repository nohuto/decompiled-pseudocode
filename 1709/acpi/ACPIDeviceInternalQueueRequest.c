/*
 * XREFs of ACPIDeviceInternalQueueRequest @ 0x1C0002C88
 * Callers:
  ...
  else
  {
    ...
    if ( (_QWORD *)*result == result )
    {
      ...
      *v5 = v6;
      ...
      if ( (v3 & 1) != 0 )
      {
        result = (_QWORD *)qword_1C0079058;
        if ( *(__int64 **)qword_1C0079058 != &AcpiPowerDelayedQueueList )
          __fastfail(3u);
        *a2 = &AcpiPowerDelayedQueueList;
        a2[1] = result;
        *result = a2;
        qword_1C0079058 = (__int64)a2;
      }
      else
      {
        result = (_QWORD *)qword_1C0079068;
        if ( *(__int64 **)qword_1C0079068 != &AcpiPowerQueueList )
          __fastfail(3u);
        *a2 = &AcpiPowerQueueList;
        a2[1] = result;
        *result = a2;
        qword_1C0079068 = (__int64)a2;
      }
    }
    else
    {
