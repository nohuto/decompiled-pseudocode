/*
 * XREFs of ACPIThermalDeviceControl @ 0x1C0023C00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
          ...
          WPP_RECORDER_SF_qDqssdddd(WPP_GLOBAL_Control->DeviceExtension, v41.Minute, v41.Hour, 15);
          v18 = 536871168;
        }
        else
        {
    ...
    else
    {
      ...
      WPP_RECORDER_SF_qqssdddd(
        ...
        (unsigned int)v44.Minute,
        (unsigned int)v44.Hour,
        0x10u,
        v33);
    }
  }
  ...
  v16 = 259;
  *(_BYTE *)(v20 + 3) |= 1u;
  v22 = (_QWORD *)qword_1C00789C8;
  if ( *(__int64 **)qword_1C00789C8 != &AcpiThermalList )
    __fastfail(3u);
  *v21 = &AcpiThermalList;
  v21[1] = v22;
  *v22 = v21;
  qword_1C00789C8 = (__int64)v21;
  KeReleaseSpinLock(&AcpiThermalLock, v19);
