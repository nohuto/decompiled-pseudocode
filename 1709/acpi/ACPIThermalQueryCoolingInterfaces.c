/*
 * XREFs of ACPIThermalQueryCoolingInterfaces @ 0x1C00234FC
 * Callers:
      ...
      *((_QWORD *)v7 + 6) = WorkItem;
      if ( WorkItem )
      {
        *((_QWORD *)v7 + 8) = v14;
        ...
        {
          *(_QWORD *)(a1 + 608) = v7;
          v10 = (_QWORD *)qword_1C00789F8;
          if ( *(__int64 **)qword_1C00789F8 != &AcpiThermalClientList )
            __fastfail(3u);
          *(_QWORD *)v7 = &AcpiThermalClientList;
          *((_QWORD *)v7 + 1) = v10;
          *v10 = v7;
          qword_1C00789F8 = (__int64)v7;
          v7 = 0LL;
        }
