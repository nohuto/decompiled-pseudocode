/*
 * XREFs of IrqTraceAffinityPolicy @ 0x1C0085740
 * Callers:
 ...
 *     IrqpAllocateInstancePath @ 0x1C00858D0 (IrqpAllocateInstancePath.c)
 */
...
void __fastcall IrqTraceAffinityPolicy(PDEVICE_OBJECT Pdo, unsigned __int16 a2, __int16 a3, __int64 a4)
{
  ...
  if ( dword_1C0076120 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0076120, 0x400000000000uLL) )
  {
    if ( a2 == 4 )
    ...
    if ( dword_1C0076120 > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0076120, 0x400000000000uLL) )
      {
        v20 = 0;
        v22[1] = 0;
        v25 = 0;
        ...
        v30 = 8;
        v33 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C0076120, &unk_1C006A092, (LPCGUID)4, v10, 8u, &pData);
      }
    }
