/*
 * XREFs of ACPIFilterIrpFilterResourceRequirements @ 0x1C008C280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalInterruptPolarityCacheStorePolarity @ 0x1C0027374 (ACPIInternalInterruptPolarityCacheStorePolarity.c)
