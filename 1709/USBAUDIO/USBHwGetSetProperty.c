/*
 * XREFs of USBHwGetSetProperty @ 0x1C001B970
 * Callers:
 *     USBHwGetSetByte @ 0x1C001BAB0 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C001BB70 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C001BC30 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C001FA60 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C001FC10 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C001FCC0 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C001FD70 (USBCntrlGetSetMixerLevels.c)
