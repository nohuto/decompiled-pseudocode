/*
 * XREFs of USBMidiInCreatePin @ 0x1C00060F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall USBMidiInCreatePin(__int64 a1)
{
  ...
  *(_QWORD *)(v6 + 24) = a1;
  v8 = v6 + 80;
  *(_DWORD *)(v6 + 16) = *(_DWORD *)(v5 + 200);
  *(_DWORD *)(v6 + 20) = *(_DWORD *)(v5 + 204);
  *(_QWORD *)(v6 + 72) = v6 + 64;
  *(_QWORD *)(v6 + 64) = v6 + 64;
  v9 = (_QWORD *)(v6 + 96);
  *(_QWORD *)(v6 + 88) = v6 + 80;
  *(_QWORD *)(v6 + 80) = v6 + 80;
  ...
  if ( v11 )
  {
    ...
    {
      v13 = 168LL * v12;
      if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v5 + 192) + 40LL) + v13 + 2) == *(_BYTE *)(*(_QWORD *)(v5 + 168) + 2LL) )
      {
