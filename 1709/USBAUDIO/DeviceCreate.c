  ...
  else
  {
    ...
    *(_QWORD *)&Context.Flags = 2LL;
    ...
    if ( v10 )
    {
      ...
      PoCreatePowerRequest((PVOID *)v8 + 62, *(PDEVICE_OBJECT *)(a1 + 24), &Context);
    }
