/*
 * XREFs of USBParseGetMicArrayDescriptor @ 0x1C001D070
 * Callers:
 ...
 *     USBHwGetSetMemory @ 0x1C001BC30 (USBHwGetSetMemory.c)
 */
...
__int64 __fastcall USBParseGetMicArrayDescriptor(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  SetMemory = USBHwGetSetMemory(a1, 0x85u, 0, v3, *(unsigned __int8 *)(*(_QWORD *)(v8 + 48) + 2LL), 0, 18, (__int64)v17);
  if ( SetMemory < 0 )
  {
