/*
 * XREFs of WPP_RECORDER_SF_id @ 0x1C0002F6C
 * Callers:
...
__int64 WPP_RECORDER_SF_id(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_d82a33061db734901bbdbf9feb709785_Traceguids,
      12LL,
      (__int64 *)va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 5LL, 3LL, &WPP_d82a33061db734901bbdbf9feb709785_Traceguids, v7, (__int64 *)va, 8LL, va1);
}
