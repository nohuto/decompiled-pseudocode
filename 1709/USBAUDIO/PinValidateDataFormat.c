/*
 * XREFs of PinValidateDataFormat @ 0x1C00141A4
 * Callers:
 *     PinCreate @ 0x1C00144D0 (PinCreate.c)
 *     PinSetDataFormat @ 0x1C00149C0 (PinSetDataFormat.c)
 *     PinMIDIDataFormatIntersection @ 0x1C0014C90 (PinMIDIDataFormatIntersection.c)
 * Callees:
 *     IsSampleRateInRange @ 0x1C0014098 (IsSampleRateInRange.c)
