 ...
 *     DriverCopyRegistryString @ 0x1C0013B78 (DriverCopyRegistryString.c)
 *     PropertyGetMicArrayGeometry @ 0x1C0018020 (PropertyGetMicArrayGeometry.c)
 *     PropertyAudioSignalProcessing @ 0x1C0018240 (PropertyAudioSignalProcessing.c)
 *     RegistryReadNameValue @ 0x1C0019EA0 (RegistryReadNameValue.c)
 *     RegistryGetValue @ 0x1C001A2EC (RegistryGetValue.c)
 *     WmiQueryRegInfo @ 0x1C001A840 (WmiQueryRegInfo.c)
 ...
 *     USBCntrlGetDescriptor @ 0x1C001FFC0 (USBCntrlGetDescriptor.c)
 *     USBCaptureCopyRequestToBuffer @ 0x1C0021258 (USBCaptureCopyRequestToBuffer.c)
 *     USBMidiInCopyEvent @ 0x1C00218B8 (USBMidiInCopyEvent.c)
 * Callees:
 *     <none>
 */
