/*
 * XREFs of USBType1LockDelay @ 0x1C002033C
 * Callers:
...
__int64 __fastcall USBType1LockDelay(struct _KSPIN *a1)
{
  ...
  {
    v2 = (unsigned int)*(unsigned __int16 *)(v5 + 5) / *(_DWORD *)(v4 + 100);
  }
  v6 = 1;
  if ( v2 )
    v6 = v2;
  v7 = *(_DWORD *)(v4 + 8) * (v6 * *(_DWORD *)(v4 + 100) + v6 * (*(_DWORD *)(v4 + 104) >> 14) / 0x3E8u);
