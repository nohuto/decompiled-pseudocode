/*
 * XREFs of USBHwGetAudioConfigurationDescriptor @ 0x1C001BD2C
 * Callers:
...
__int64 __fastcall USBHwGetAudioConfigurationDescriptor(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  *(_BYTE *)(a3 + 8) = 0;
  ...
  v14 = v8;
  ExFreePool(v3);
  PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, v9 + 2, 0x41627845u);
  v3 = PoolWithTag;
  if ( PoolWithTag )
  {
    memset(PoolWithTag, 0, v9 + 2);
    v11 = ExAllocatePoolWithTag((POOL_TYPE)512, 0x88uLL, 0x41627845u);
    if ( v11 )
