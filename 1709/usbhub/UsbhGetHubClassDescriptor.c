/*
 * XREFs of UsbhGetHubClassDescriptor @ 0x1C0026554
 * Callers:
...
__int64 __fastcall UsbhGetHubClassDescriptor(__int64 a1, void *a2)
{
  ...
  *(_QWORD *)v18 = v4 + 734;
  ...
  {
    LOBYTE(v14) = 0;
    UsbhException(a1, 0, 16, (int)a2, v19, v6, v20, v11, 3814, v14);
  }
  ...
  if ( v7 == 3 )
  {
    ...
    {
      LOBYTE(v14) = 0;
      UsbhException(a1, 0, 14, (int)v18, v19, v6, -1, v12, 4089, v14);
    }
  }
  ...
  else
  {
    ...
    UsbhException(a1, 0, 15, (int)v18, v19, -1073741811, -1, v9, 4098, v14);
  }
