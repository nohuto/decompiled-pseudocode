/*
 * XREFs of UsbhPdoWaitForD3Reconnect @ 0x1C0047184
 * Callers:
...
__int16 __fastcall UsbhPdoWaitForD3Reconnect(PDEVICE_OBJECT DeviceObject, PDEVICE_OBJECT a2)
{
  char v4; // r15
  int v5; // edi
  _DWORD *v6; // rax
  ...
  {
    v4 = 1;
    v5 = UsbhWaitEventWithTimeoutEx((__int64)DeviceObject, v6 + 726, v6[738], 1684222788, 0, 0LL);
  }
  KeWaitForSingleObject(v7 + 732, Executive, 0, 0, 0LL);
  v7[353] &= ~0x4000000u;
  KeSetEvent((PRKEVENT)v7 + 122, 0, 0);
