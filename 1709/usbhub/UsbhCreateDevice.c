/*
 * XREFs of UsbhCreateDevice @ 0x1C0009764
 * Callers:
...
__int64 __fastcall UsbhCreateDevice(__int64 a1, __int64 a2, unsigned __int16 a3, unsigned __int16 a4)
{
  ...
  if ( (*(_DWORD *)(v8 + 2560) & 0x40) != 0 )
  {
    ...
    if ( !DeviceHandle )
    {
      LOBYTE(v21) = 0;
      v16 = -1073741823;
      UsbhException(a1, (unsigned __int16)v5, 5, 0, 0, -1073741823, -1, usbfile_bus_c, 6278, v21);
...
LABEL_3:
    if ( *(_QWORD *)(v8 + 4256) )
    {
      ...
      {
        v12 = (_DWORD *)(v9 + 2680);
        *(_DWORD *)(v9 + 2684) = *(unsigned __int16 *)(v8 + 5208);
        v13 = (_DWORD *)(v9 + 2688);
        *(_QWORD *)(v9 + 2688) = 0LL;
        *(_QWORD *)(v9 + 2696) = 0LL;
        *(_DWORD *)(v9 + 2704) = 0;
      ...
      {
        if ( v28[1] == 5 )
          *(_DWORD *)(v9 + 2812) = v28[2] != 0 ? 1073807365 : 1073807360;
        Log(a1, 4, 1667524129, v26, v5);
        LOBYTE(v21) = 0;
        UsbhException(a1, (unsigned __int16)v5, 4, (int)v28, 84, v16, -1, usbfile_bus_c, 6398, v21);
  ...
  LOBYTE(v21) = 0;
  UsbhException(a1, (unsigned __int16)v5, 104, 0, 0, TtDeviceHandle, -1, usbfile_bus_c, 6297, v21);
