/*
 * XREFs of UsbhBusResume_Action @ 0x1C000E6C0
 * Callers:
...
LONG __fastcall UsbhBusResume_Action(PDEVICE_OBJECT DeviceObject, int a2)
{
  ...
  for ( i = 1; ; ++i )
  {
      ...
      if ( i <= v30[2938] )
      {
        ...
        if ( v31 )
        {
          ...
          if ( v32 )
          {
            v24 = *(_QWORD *)(v32 + 392);
            if ( v24 )
              v24 = UsbhRefPdo(v31, v24, 0LL, 1382380368);
          }
        }
      }
    }
    ...
    {
      v36 = PdoExt(v24);
      KeWaitForSingleObject((PVOID)(v36 + 2880), Executive, 0, 0, 0LL);
      *(_DWORD *)(v36 + 1412) &= ~0x10000000u;
      KeSetEvent((PRKEVENT)(v36 + 2880), 0, 0);
      UsbhUnlatchPdo(DeviceObject, v24, 0LL, 1382380368LL);
    }
  }
  UsbhPostInterrupt(DeviceObject);
  v33 = (_QWORD *)_InterlockedExchange64((volatile __int64 *)(FdoExt(DeviceObject) + 3288), 0LL);
  Log((_DWORD)DeviceObject, 2048, 1114863917, 0, (__int64)v33);
  return UsbhDecHubBusy((__int64)DeviceObject, v34, v33);
}
