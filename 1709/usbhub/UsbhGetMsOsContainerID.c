/*
 * XREFs of UsbhGetMsOsContainerID @ 0x1C00291BC
 * Callers:
...
__int64 __fastcall UsbhGetMsOsContainerID(int a1, __int64 a2)
{
  ...
  *((_QWORD *)PoolWithTag + 2) = 0LL;
  ...
  if ( (MsOsFeatureDescriptor & 0xC0000000) == 0xC0000000 )
  {
    ...
    {
      ValueData = 1;
      RtlWriteRegistryValue(2u, v12, L"SkipContainerIdQuery", 3u, &ValueData, 4u);
      v5[356] |= 0x8000u;
    }
    goto LABEL_3;
  }
  ...
  {
    LOBYTE(v16) = 0;
    UsbhException(a1, *((unsigned __int16 *)v5 + 710), 135, (int)v3, 24, 0, 0, usbfile_msos_c, 769, v16);
    goto LABEL_27;
  }
  ...
  if ( ValueData == 24 )
  {
    ...
    {
      LOBYTE(v16) = 0;
      UsbhException(a1, *((unsigned __int16 *)v5 + 710), 135, (int)v3, 24, 0, 0, usbfile_msos_c, 815, v16);
      goto LABEL_27;
    }
    v15 = *(_OWORD *)(v3 + 8);
    *((_BYTE *)v5 + 2724) = 1;
...
LABEL_2:
  ...
  LOBYTE(v16) = 0;
  UsbhException(a1, *((unsigned __int16 *)v5 + 710), 135, (int)v3, 24, 0, 0, usbfile_msos_c, 805, v16);
LABEL_27:
