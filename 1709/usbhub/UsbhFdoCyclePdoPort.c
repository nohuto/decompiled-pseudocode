/*
 * XREFs of UsbhFdoCyclePdoPort @ 0x1C003E7CC
 * Callers:
...
__int64 __fastcall UsbhFdoCyclePdoPort(__int64 a1, ULONG_PTR BugCheckParameter3, IRP *BugCheckParameter4)
{
  ...
  LOBYTE(v11) = 0;
  UsbhException(a1, *((unsigned __int16 *)v6 + 710), 96, 0, 0, 0, 0, usbfile_dioctl_c, 917, v11);
  if ( KeGetCurrentIrql() )
  {
    v7 = -1073741811;
    v9 = PdoExt(BugCheckParameter3);
    LOBYTE(v12) = 0;
    UsbhException(a1, *((unsigned __int16 *)v9 + 710), 95, 0, 0, -1073741811, 0, usbfile_dioctl_c, 931, v12);
  }
  else
  {
    ...
    if ( (v7 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v7) )
    {
      ...
      LOBYTE(v12) = 0;
      UsbhException(a1, *((unsigned __int16 *)v8 + 710), 94, 0, 0, v7, v13, usbfile_dioctl_c, 924, v12);
    }
  }
