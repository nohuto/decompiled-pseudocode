/*
 * XREFs of UsbhBusPause_Action @ 0x1C000D4D0
 * Callers:
...
__int64 __fastcall UsbhBusPause_Action(PDEVICE_OBJECT DeviceObject, __int64 a2)
{
  ...
  else
  {
    for ( i = 1; ; ++i )
    {
        ...
        if ( i <= v23[2938] )
        {
          ...
          if ( v24 )
          {
            ...
            if ( v25 )
            {
              v17 = *(_QWORD *)(v25 + 392);
              if ( v17 )
                v17 = UsbhRefPdo(v24, v17, 0LL, 1348564304);
            }
          }
        }
      }
      ...
      {
        v56 = PdoExt(v17);
        KeWaitForSingleObject((PVOID)(v56 + 2880), Executive, 0, 0, 0LL);
        *(_DWORD *)(v56 + 1412) |= 0x10000000u;
        KeSetEvent((PRKEVENT)(v56 + 2880), 0, 0);
                ...
                if ( v45 <= v51[2938] )
                {
                  ...
                  if ( v52 )
                  {
                    ...
                    if ( v54 )
                    {
                      v44 = *(_QWORD *)(v54 + 392);
                      if ( v44 )
                        v44 = UsbhRefPdo(v53, v44, 0LL, 1884308559);
                    }
                  }
                }
              }
