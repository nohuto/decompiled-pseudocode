/*
 * XREFs of UsbhDeregisterPdo @ 0x1C0043994
 * Callers:
...
void __fastcall UsbhDeregisterPdo(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v8 = PdoExt(a2);
  v9 = (__int64)v8;
  if ( *((_BYTE *)v8 + 2732) || (PortData = UsbhGetPortData(a1, *((_WORD *)v8 + 710)), (v11 = PortData) == 0) )
  {
    *(_DWORD *)(a5 + 136) = 0;
  ...
  else
  {
    ...
    v13 = (_QWORD *)(v9 + 1312);
    v14 = *(_QWORD *)(v9 + 1312);
    if ( *(_QWORD *)(v14 + 8) != v9 + 1312 || (v15 = *(_QWORD **)(v9 + 1320), (_QWORD *)*v15 != v13) )
      __fastfail(3u);
    *v15 = v14;
    *(_QWORD *)(v14 + 8) = v15;
