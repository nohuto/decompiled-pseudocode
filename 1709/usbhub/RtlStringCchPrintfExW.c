/*
 * XREFs of RtlStringCchPrintfExW @ 0x1C0025CE0
 * Callers:
 *     UsbhBusIfLocationGetLocationStrings @ 0x1C0025C40 (UsbhBusIfLocationGetLocationStrings.c)
 * Callees:
...
LABEL_3:
  if ( v9 >= 0 )
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (NTSTRSAFE_PCWSTR)&unk_1C005F9A8;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
