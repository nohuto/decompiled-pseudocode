/*
 * XREFs of UsbhPortResumeTimeout @ 0x1C00448BC
 * Callers:
...
__int64 __fastcall UsbhPortResumeTimeout(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3)
{
  ...
  if ( Usb_Disconnected(v9) )
    return v10;
  LOBYTE(v22) = 0;
  UsbhException((int)DeviceObject, *(unsigned __int16 *)(a3 + 4), 124, 0, 0, v10, v24, usbfile_bus_c, 7412, v22);
  ...
  if ( v12 )
  {
    ...
    else
    {
      ...
      if ( (v18 & 0xC0000000) == 0xC0000000 )
      {
        ...
        LOBYTE(v23) = 0;
        v20[353] &= ~0x4000u;
        UsbhException((int)DeviceObject, 0, 125, 0, 0, v19, 0, usbfile_bus_c, 7472, v23);
      }
      else
      {
