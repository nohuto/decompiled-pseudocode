/*
 * XREFs of UsbhPdoPnp_EnablePdo @ 0x1C001BCF4
 * Callers:
...
__int64 __fastcall UsbhPdoPnp_EnablePdo(__int64 a1)
{
  ...
  v4 = 0;
  v5 = *(_DWORD *)(v2 + 1120);
  if ( (*(_DWORD *)(v2 + 1412) & 0x8000000) == 0 && v5 == 100 || (*(_DWORD *)(v2 + 1132) & 4) != 0 )
    return 0LL;
  if ( ((v5 - 100) & 0xFFFFFFFC) == 0 && v5 != 101 )
  {
    UsbhSshSetPortsBusyState(*(_QWORD *)(v2 + 1176), *(_WORD *)(v2 + 1420), 2, 0);
    v7 = PdoExt(a1);
    ...
    {
      *(_DWORD *)(v2 + 1412) &= ~0x8000000u;
      UsbhSetPdo_AllowIo(v9, a1);
    }
    else
    {
      LOBYTE(v10) = 0;
      UsbhException((int)v3, *(unsigned __int16 *)(v2 + 1420), 86, 0, 0, v4, -1, usbfile_pdo_c, 2072, v10);
    }
  }
  return v4;
}
