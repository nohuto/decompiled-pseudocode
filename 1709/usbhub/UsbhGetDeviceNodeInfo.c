/*
 * XREFs of UsbhGetDeviceNodeInfo @ 0x1C004EBD8
 * Callers:
...
__int64 __fastcall UsbhGetDeviceNodeInfo(__int64 a1, _DWORD *a2, unsigned int a3, unsigned int *a4, __int64 a5)
{
  ...
  if ( v22 >= 0 )
  {
    ...
    *a2 = 1431519822;
    a2[1] = v14;
    *(_OWORD *)(a2 + 2) = *(_OWORD *)((char *)v9 + 2434);
    *(_OWORD *)(a2 + 6) = *(_OWORD *)((char *)v9 + 2450);
    *(_OWORD *)(a2 + 10) = *(_OWORD *)((char *)v9 + 2466);
    *(_OWORD *)(a2 + 14) = *(_OWORD *)((char *)v9 + 2482);
    *(_OWORD *)(a2 + 18) = *(_OWORD *)((char *)v9 + 2498);
    a2[22] = 0;
    UsbhBuildTopologyAddress(v10, a2 + 23, *((_WORD *)v9 + 710));
    ...
    *(_DWORD *)((char *)a2 + 1187) = v13[12];
    ...
    if ( v18 > 0x100 )
      v18 = 256;
    memmove((char *)a2 + 163, *((const void **)v9 + 262), v18);
    v19 = v9[527];
    if ( v19 > 0x100 )
      v19 = 256;
    memmove((char *)a2 + 419, *((const void **)v9 + 264), v19);
    v20 = v9[531];
    if ( v20 > 0x100 )
      v20 = 256;
    memmove((char *)a2 + 675, *((const void **)v9 + 266), v20);
    v21 = v9[551];
    if ( v21 > 0x100 )
      v21 = 256;
    memmove((char *)a2 + 931, *((const void **)v9 + 276), v21);
    result = 0LL;
    *a4 = v14;
  }
  else
