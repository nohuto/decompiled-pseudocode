/*
 * XREFs of UsbhPdoPnp_QueryCapabilities @ 0x1C001B630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryCapabilities(__int64 a1, IRP *a2)
{
  ...
  if ( (*(_DWORD *)(v3 + 1172) & 0x10) != 0 )
    ...
    HIDWORD(SecurityContext->SecurityQos) |= 0x10u;
  HIDWORD(SecurityContext->SecurityQos) = HIDWORD(SecurityContext->SecurityQos) & 0xFFFFFDBF | (*(_DWORD *)(v3 + 1412) >> 3) & 0x40;
  ...
  if ( !*(_DWORD *)(v3 + 1184) )
  {
    ...
    if ( v15 )
    {
      if ( (*(_DWORD *)(v3 + 1412) & 0x40000) == 0 )
        *(_DWORD *)(v3 + 1184) = FdoExt(v15)[1259];
    }
  }
