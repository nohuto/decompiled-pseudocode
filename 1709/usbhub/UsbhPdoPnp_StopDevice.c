/*
 * XREFs of UsbhPdoPnp_StopDevice @ 0x1C0055DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_StopDevice(ULONG_PTR a1, IRP *a2)
{
  ...
  v6 = UsbhCloseDeviceConfiguration(*((_QWORD *)v4 + 147), a1, &v8);
  Log(*((_QWORD *)v4 + 147), 256, 1936745522, (__int64)a2, v6);
  UsbhUnlinkPdoDeviceHandle(*((_QWORD *)v4 + 147), a1, 2017740854, 1);
