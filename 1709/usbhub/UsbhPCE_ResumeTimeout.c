/*
 * XREFs of UsbhPCE_ResumeTimeout @ 0x1C0041A7C
 * Callers:
...
__int64 __fastcall UsbhPCE_ResumeTimeout(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  __int64 result; // rax
  ...
  {
    LODWORD(v8) = 0;
    return UsbhDispatch_PortChangeQueueEventEx(a1, result, 14LL, a2, v8, 0, 0LL, 0LL);
  }
  return result;
}
