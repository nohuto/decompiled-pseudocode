/*
 * XREFs of UsbhGetBosDescriptor @ 0x1C0055448
 * Callers:
...
__int64 __fastcall UsbhGetBosDescriptor(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  __int64 v13; // r9
  void *v14; // rcx
  __int16 v16; // [rsp+98h] [rbp+58h] BYREF
  int v17; // [rsp+9Ah] [rbp+5Ah]
  unsigned __int16 v18; // [rsp+9Eh] [rbp+5Eh]
