/*
 * XREFs of UsbhBuildHardwareID @ 0x1C0021690
 * Callers:
    ...
    if ( PoolWithTag )
    {
      ...
      *(_OWORD *)PoolWithTag = *(_OWORD *)L"USB\\VID_nnnn";
      for ( PoolWithTag[2] = *(_QWORD *)L"nnnn"; *v13 != 110; ++v13 )
        ;
      v14 = 42;
      *v13 = (unsigned __int8)Nibble[(unsigned __int64)v10 >> 12];
      v13[1] = (unsigned __int8)Nibble[((unsigned __int64)v10 >> 8) & 0xF];
      v13[2] = (unsigned __int8)Nibble[(unsigned __int8)v10 >> 4];
      v13[3] = (unsigned __int8)Nibble[v10 & 0xF];
        ...
        if ( v23 )
        {
          ...
          *(_OWORD *)v25 = *(_OWORD *)L"USB\\VID_nnnn";
          for ( *((_QWORD *)v25 + 2) = *(_QWORD *)L"nnnn"; *(_WORD *)v25 != 110; v25 += 2 )
            ;
          *(_WORD *)v25 = (unsigned __int8)Nibble[v42 >> 12];
          *((_WORD *)v25 + 1) = (unsigned __int8)Nibble[(v42 >> 8) & 0xF];
          *((_WORD *)v25 + 2) = (unsigned __int8)Nibble[(unsigned __int8)v42 >> 4];
          *((_WORD *)v25 + 3) = (unsigned __int8)Nibble[v42 & 0xF];
        }
        else
        {
          v22 = 0;
