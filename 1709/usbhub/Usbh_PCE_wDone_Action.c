/*
 * XREFs of Usbh_PCE_wDone_Action @ 0x1C000F9A0
 * Callers:
...
LABEL_60:
  ...
  else
  {
    ...
    *(_DWORD *)(a2 + 12) = 9;
    *(_DWORD *)(v53 + a2 + 1384) = 9;
  }
  *(_QWORD *)(a2 + 384) = 0LL;
  UsbhUnlockPcqWithTag(a1, a2, v12);
  UsbhHubQueueProcessChangeWorker(v54, a2);
}
