 ...
 *     WppTraceCallback @ 0x1C000D110 (WppTraceCallback.c)
...
mset20:
  ...
  *(_QWORD *)&Val = 0x101010101010101LL * (unsigned __int8)Val;
  ...
  v8 = Size >> 6;
  if ( ((Size >> 3) & 7) != 0 )
    return (void *)((__int64 (__fastcall *)(_QWORD *, _QWORD))((char *)&loc_1C0001BFD + 4 * (8 - ((Size >> 3) & 7)) + 2))(
                     &v7[((Size >> 3) & 7) - 8],
                     *(_QWORD *)&Val);
  do
  {
