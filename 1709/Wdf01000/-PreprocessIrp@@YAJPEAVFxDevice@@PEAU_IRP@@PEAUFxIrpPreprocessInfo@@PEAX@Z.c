/*
 * XREFs of ?PreprocessIrp@@YAJPEAVFxDevice@@PEAU_IRP@@PEAUFxIrpPreprocessInfo@@PEAX@Z @ 0x1C007DAFC
 * Callers:
 *     imp_WdfDeviceWdmDispatchPreprocessedIrp @ 0x1C0034200 (imp_WdfDeviceWdmDispatchPreprocessedIrp.c)
 *     ?DispatchWorker@@YAJPEAVFxDevice@@PEAU_IRP@@PEAX@Z @ 0x1C007D810 (-DispatchWorker@@YAJPEAVFxDevice@@PEAU_IRP@@PEAX@Z.c)
 * Callees:
