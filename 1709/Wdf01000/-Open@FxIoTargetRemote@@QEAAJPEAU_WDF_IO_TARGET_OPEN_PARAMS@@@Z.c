/*
 * XREFs of ?Open@FxIoTargetRemote@@QEAAJPEAU_WDF_IO_TARGET_OPEN_PARAMS@@@Z @ 0x1C0013D88
 * Callers:
 ...
 *     ?RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ @ 0x1C00137FC (-RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ.c)
 *     ?GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z @ 0x1C0013848 (-GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z.c)
 ...
 *     ?Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK@Z @ 0x1C00141D8 (-Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK.c)
          ...
          else
          {
            while ( 1 )
            {
              ...
              if ( pended.Flink == &pended )
                break;
              if ( pended.Flink->Blink != &pended
                || (v38 = pended.Flink->Flink, pended.Flink->Flink->Blink != pended.Flink) )
              {
                __fastfail(3u);
              }
