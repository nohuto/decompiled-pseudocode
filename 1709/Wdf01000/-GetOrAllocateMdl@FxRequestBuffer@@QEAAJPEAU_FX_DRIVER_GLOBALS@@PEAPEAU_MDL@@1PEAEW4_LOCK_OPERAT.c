/*
 * XREFs of ?GetOrAllocateMdl@FxRequestBuffer@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAU_MDL@@1PEAEW4_LOCK_OPERATION@@EPEA_K@Z @ 0x1C00245E8
 * Callers:
 ...
 *     FxProbeAndLockWithAccess @ 0x1C00A5BCC (FxProbeAndLockWithAccess.c)
 */
