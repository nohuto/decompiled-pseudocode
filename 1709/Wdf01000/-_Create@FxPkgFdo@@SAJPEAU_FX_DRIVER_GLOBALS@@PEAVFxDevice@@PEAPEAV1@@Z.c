/*
 * XREFs of ?_Create@FxPkgFdo@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@PEAPEAV1@@Z @ 0x1C0020DC8
 * Callers:
...
__int64 __fastcall FxPkgFdo::_Create(_FX_DRIVER_GLOBALS *DriverGlobals, FxDevice *Device, FxPkgFdo **PkgFdo)
{
  ...
  v8 = FxPoolAllocator(
         ...
         DriverGlobals->FxVerifierHandle != 0 ? 1752LL : 1704LL,
         Tag,
         Caller);
  v9 = v8;
  if ( !v8 )
