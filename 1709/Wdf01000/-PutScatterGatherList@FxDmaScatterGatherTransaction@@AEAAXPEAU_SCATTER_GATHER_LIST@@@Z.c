/*
 * XREFs of ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x1C006B1A0
 * Callers:
 *     ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x1C006B200 (-ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z.c)
 *     ?TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ @ 0x1C006B4C0 (-TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ.c)
 * Callees:
 *     <none>
 */
