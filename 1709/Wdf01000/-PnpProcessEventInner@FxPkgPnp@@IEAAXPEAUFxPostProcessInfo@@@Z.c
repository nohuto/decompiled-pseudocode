/*
 * XREFs of ?PnpProcessEventInner@FxPkgPnp@@IEAAXPEAUFxPostProcessInfo@@@Z @ 0x1C002A2B0
 * Callers:
 *     ?PnpProcessEvent@FxPkgPnp@@QEAAXW4FxPnpEvent@@E@Z @ 0x1C0027E80 (-PnpProcessEvent@FxPkgPnp@@QEAAXW4FxPnpEvent@@E@Z.c)
 *     ?_PnpProcessEventInner@FxPkgPnp@@KAXPEAV1@PEAUFxPostProcessInfo@@PEAX@Z @ 0x1C002E630 (-_PnpProcessEventInner@FxPkgPnp@@KAXPEAV1@PEAUFxPostProcessInfo@@PEAX@Z.c)
 * Callees:
 ...
 *     ?Invoke@FxPnpStateCallback@@QEAAXW4_WDF_DEVICE_PNP_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PEAUWDFDEVICE__@@PEBU_WDF_DEVICE_PNP_NOTIFICATION_DATA@@@Z @ 0x1C009A5C8 (-Invoke@FxPnpStateCallback@@QEAAXW4_WDF_DEVICE_PNP_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PEAUWD.c)
 */
...
void __fastcall FxPkgPnp::PnpProcessEventInner(FxPkgPnp *this, FxPostProcessInfo *Info)
{
  ...
  const PNP_EVENT_TARGET_STATE *OtherTargetStates; // rax
  ...
  while ( 1 )
  {
    ...
    m_QueueHead = this->m_PnpMachine.m_QueueHead;
    v7 = v5;
    if ( m_QueueHead == this->m_PnpMachine.m_QueueTail )
      break;
    v8 = this->m_PnpMachine.m_Queue[m_QueueHead];
    if ( (v8 & 0x3C3000) == 0 && (*(_DWORD *)&v4->StateInfo.Bits & 1) == 0 )
      goto LABEL_22;
    this->m_PnpMachine.m_QueueHead = ((unsigned int)m_QueueHead + 1) % this->m_PnpMachine.m_QueueDepth;
    KeReleaseSpinLock(&this->m_PnpMachine.m_QueueLock.m_Lock, v5);
    if ( v4->FirstTargetState.PnpEvent == v8 )
    {
    ...
    if ( !OtherTargetStates
      || (PnpEvent = OtherTargetStates->PnpEvent, LODWORD(v23) = 0, OtherTargetStates->PnpEvent == PnpEventNull) )
    {
LABEL_45:
      ...
      if ( (globals & v8) == 0 )
      {
        ...
        WPP_IFR_SF_qqLLL(
          ...
          WPP_PnpStateMachine_cpp_Traceguids,
          v38,
          v37->m_DeviceObject.m_DeviceObject,
          (unsigned int)v37[1].FxNonPagedObject::FxObject::__vftable,
          v8,
          globals);
      }
      if ( (v8 & 0xDF4) != 0 )
        FxPkgPnp::PnpFinishProcessingIrp(this, v9);
    }
    else
    {
      v9 = 0LL;
      while ( PnpEvent != v8 )
      {
        ...
        v9 = (unsigned int)v23;
        PnpEvent = OtherTargetStates[v23].PnpEvent;
        if ( PnpEvent == PnpEventNull )
          goto LABEL_45;
      }
      _a3 = OtherTargetStates[v9].TargetState;
LABEL_6:
      ...
      do
      {
        ...
        if ( m_PnpStateCallbacks )
        {
          ...
          if ( !m_ObjectSize )
            v26 = 0LL;
          FxPnpStateCallback::Invoke(m_PnpStateCallbacks, _a4, StateNotificationLeaveState, v26, &NotificationData);
        }
        ...
        if ( v17 )
        {
          ...
          if ( !v28 )
            v29 = 0LL;
          FxPnpStateCallback::Invoke(v17, _a3, StateNotificationEnterState, v29, &NotificationData);
        }
        _a4 = _a3;
        ...
        if ( v19 )
        {
          ...
          if ( !v31 )
            v32 = 0LL;
          FxPnpStateCallback::Invoke(v19, _a4, StateNotificationPostProcessState, v32, &NotificationData);
        }
      }
  ...
  if ( (m_QueueFlags & 1) == 0 && !this->m_PnpMachine.m_WorkItemRunningCount )
  {
    if ( (m_QueueFlags & 4) != 0 )
    {
...
LABEL_22:
  KeReleaseSpinLock(&this->m_PnpMachine.m_QueueLock.m_Lock, v7);
}
