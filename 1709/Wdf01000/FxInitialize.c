/*
 * XREFs of FxInitialize @ 0x1C00158D0
 * Callers:
 ...
 *     ?FxPoolInitialize@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUFX_POOL@@@Z @ 0x1C0037CC8 (-FxPoolInitialize@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUFX_POOL@@@Z.c)
  ...
  if ( MmIsDriverVerifying(DriverObject) )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    if ( ZwOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes) >= 0
      && FxRegKey::_QueryULong(KeyHandle, &ValueName, &Value) >= 0 )
    {
      v7 = (Value & 0x10000) == 0;
    }
    if ( KeyHandle )
