/*
 * XREFs of ??1FxPkgPnp@@MEAA@XZ @ 0x1C009C518
 * Callers:
...
void __fastcall FxPkgPnp::~FxPkgPnp(FxPkgPnp *this, unsigned int a2)
{
  ...
  while ( Next )
  {
    v6 = (FxDeviceInterface *)&Next[-6];
    Next = Next->Next;
    v6->m_Entry.Next = 0LL;
    FxDeviceInterface::`scalar deleting destructor'(v6);
  }
  ...
  if ( m_Resources )
  {
    m_Resources->Release(m_Resources, this, 294, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
