/*
 * XREFs of ?_IrpCancelForQueue@FxIoQueue@@KAXPEAVFxIrpQueue@@PEAU_IRP@@PEAU_IO_CSQ_IRP_CONTEXT@@E@Z @ 0x1C0097320
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 Irql)
{
  ...
  p_Blink->Release(p_Blink, Irp, 4496, "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
}
