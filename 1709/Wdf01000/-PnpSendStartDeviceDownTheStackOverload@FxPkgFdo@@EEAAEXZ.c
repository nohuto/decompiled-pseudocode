/*
 * XREFs of ?PnpSendStartDeviceDownTheStackOverload@FxPkgFdo@@EEAAEXZ @ 0x1C0022470
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxPkgFdo::PnpSendStartDeviceDownTheStackOverload(FxPkgFdo *this)
{
  ...
  FxFilteredStartContext *v20; // rax
  unsigned int v21; // edx
  FxCmResList *v22; // rcx
  _CM_RESOURCE_LIST *WdmList; // rax
  FxCmResList *v24; // rcx
  _CM_RESOURCE_LIST *v25; // rax
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
  ...
  if ( this->m_DeviceRemoveAddedResources.m_Method && AllocatedResources && AllocatedResourcesTranslated )
  {
    ...
    v15 = m_ResourcesRaw->m_ObjectSize;
    v16 = m_DeviceBase->m_ObjectSize;
    if ( m_Method )
    {
      v17 = (unsigned __int64)m_Resources ^ 0xFFFFFFFFFFFFFFF8uLL;
      if ( !m_ObjectSize )
        v17 = 0LL;
      ...
      if ( !v16 )
        v19 = 0LL;
      v8 = m_Method((WDFDEVICE__ *)v19, (WDFCMRESLIST__ *)v18, (WDFCMRESLIST__ *)v17);
    }
    else
    {
      v8 = 0;
    ...
    {
      v20 = (FxFilteredStartContext *)FxPoolAllocator(
                                        this->m_Globals,
      ...
      if ( v20 )
      {
        v20->ResourcesRaw = 0LL;
        v20->ResourcesTranslated = 0LL;
      }
      else
      {
        v4 = 0LL;
      ...
      if ( v4 )
      {
        ...
        if ( v22->m_Count )
        {
          WdmList = FxCmResList::CreateWdmList(v22, ExDefaultNonPagedPoolType);
        ...
        if ( v8 < 0 )
          goto LABEL_38;
        v24 = this->m_Resources;
        if ( v24->m_Count )
        {
          v25 = FxCmResList::CreateWdmList(v24, ExDefaultNonPagedPoolType);
          v4->ResourcesTranslated = v25;
          if ( !v25 )
            v8 = -1073741670;
        }
        if ( v8 < 0 )
        {
LABEL_38:
          FxFilteredStartContext::`scalar deleting destructor'(v4, v21);
        }
        else
        {
          v3 = 1;
  ...
  if ( v3 )
  {
    FxIrp::SetCompletionRoutineEx(
      ...
      v4);
              ...
              1u) < 0 )
  {
    v26 = m_PendingPnPIrp->Tail.Overlay.CurrentStackLocation;
    v26[-1].CompletionRoutine = FxPkgFdo::_PnpStartDeviceCompletionRoutine;
    v26[-1].Context = this;
    v26[-1].Control = -32;
  }
