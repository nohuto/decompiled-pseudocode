/*
 * XREFs of imp_WdfUsbTargetDeviceRetrieveConfigDescriptor @ 0x1C008C840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetConfigDescriptor@FxUsbDevice@@QEAAJPEAXPEAG@Z @ 0x1C0091788 (-GetConfigDescriptor@FxUsbDevice@@QEAAJPEAXPEAG@Z.c)
 */
