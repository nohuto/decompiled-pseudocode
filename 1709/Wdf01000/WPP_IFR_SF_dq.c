/*
 * XREFs of WPP_IFR_SF_dq @ 0x1C0065CFC
 * Callers:
 ...
 *     ?FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ @ 0x1C0068D40 (-FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ.c)
