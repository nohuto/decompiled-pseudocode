/*
 * XREFs of USBD_UrbAllocate @ 0x1C00A4F54
 * Callers:
 ...
 *     ?AllocateUrb@FxUsbDeviceStringContext@@QEAAJPEAUUSBD_HANDLE__@@@Z @ 0x1C009093C (-AllocateUrb@FxUsbDeviceStringContext@@QEAAJPEAUUSBD_HANDLE__@@@Z.c)
...
$__tryLabel_7:
    ...
    if ( v2 && _InterlockedExchangeAdd((volatile signed __int32 *)USBDHandle + 55, 0xFFFFFFFF) <= 1 )
    {
      ...
      else if ( LOBYTE(WPP_GLOBAL_WDF_Control.AlignmentRequirement) )
      {
