/*
 * XREFs of FxInitializeBugCheckDriverInfo @ 0x1C0036D7C
 * Callers:
 *     FxLibraryGlobalsCommission @ 0x1C0036884 (FxLibraryGlobalsCommission.c)
 * Callees:
 *     RtlStringCopyWorkerA @ 0x1C0036E98 (RtlStringCopyWorkerA.c)
  ...
  if ( !FxLibraryGlobals.StaticallyLinked )
  {
    ...
    if ( result )
    {
      ...
      if ( result )
      {
        ...
        FxLibraryGlobals.BugCheckDriverInfo->Version.Minor = 23;
