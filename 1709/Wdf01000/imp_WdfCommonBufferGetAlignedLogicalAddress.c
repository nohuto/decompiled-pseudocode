/*
 * XREFs of imp_WdfCommonBufferGetAlignedLogicalAddress @ 0x1C0037490
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 CommonBuffer)
{
  ...
  LOWORD(Offset) = 0;
  if ( !CommonBuffer )
    FxVerifierBugCheckWorker((_FX_DRIVER_GLOBALS *)DriverGlobals[-8].DriverName, WDF_INVALID_HANDLE, 0LL, 0x1402uLL);
