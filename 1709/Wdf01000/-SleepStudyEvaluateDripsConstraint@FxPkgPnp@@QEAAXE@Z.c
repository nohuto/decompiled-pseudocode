/*
 * XREFs of ?SleepStudyEvaluateDripsConstraint@FxPkgPnp@@QEAAXE@Z @ 0x1C009F7B4
 * Callers:
 *     ?SleepStudyEvaluateParticipation@FxPkgPnp@@QEAAXXZ @ 0x1C0028320 (-SleepStudyEvaluateParticipation@FxPkgPnp@@QEAAXXZ.c)
 *     ?_SleepStudyWnfCallback@FxPkgPnp@@SAJPEAU_MX_WNF_SUBSCRIPTION_CONTEXT@@PEAX@Z @ 0x1C009FC50 (-_SleepStudyWnfCallback@FxPkgPnp@@SAJPEAU_MX_WNF_SUBSCRIPTION_CONTEXT@@PEAX@Z.c)
 * Callees:
...
$Done_61:
  ...
  if ( constraintsRegistered )
  {
    ...
    if ( v6 < 0 )
    {
      ...
      if ( !v16 )
        v17 = 0LL;
      WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x14u, WPP_FxPkgPnpKM_cpp_Traceguids, v17, v6);
    }
