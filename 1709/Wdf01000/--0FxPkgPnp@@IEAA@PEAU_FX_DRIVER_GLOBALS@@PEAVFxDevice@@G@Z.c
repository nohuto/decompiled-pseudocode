/*
 * XREFs of ??0FxPkgPnp@@IEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@G@Z @ 0x1C002B810
 * Callers:
        ...
        unsigned __int16 Type)
{
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 )
  {
    ...
    if ( v10->FxVerifierLock )
    {
      ...
      this[-1].m_DeviceSurpriseRemoval.__vftable = (FxPrePostCallback_vtbl *)VerifierLock;
    }
  }
  ...
  *(_WORD *)&this->m_PowerMachine.m_QueueFlags = 0;
  ...
  this->m_PowerMachine.m_HistoryIndex = ((int)v8 + 1) % (unsigned int)this->m_PowerMachine.m_QueueDepth;
  ...
  *(_WORD *)&this->m_PowerPolicyMachine.m_QueueFlags = 0;
  ...
  this->m_PowerPolicyMachine.m_HistoryIndex = ((int)v9 + 1) % (unsigned int)this->m_PowerPolicyMachine.m_QueueDepth;
