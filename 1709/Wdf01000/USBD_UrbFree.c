/*
 * XREFs of USBD_UrbFree @ 0x1C00A512C
 * Callers:
 ...
 *     ?Dispose@FxUsbPipeRequestContext@@UEAAXXZ @ 0x1C008DEC0 (-Dispose@FxUsbPipeRequestContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbPipeTransferContext@@UEAAXXZ @ 0x1C008DF10 (-Dispose@FxUsbPipeTransferContext@@UEAAXXZ.c)
 ...
 *     ?Dispose@FxUsbDeviceStringContext@@UEAAXXZ @ 0x1C00916C0 (-Dispose@FxUsbDeviceStringContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbUrb@@MEAAEXZ @ 0x1C0091710 (-Dispose@FxUsbUrb@@MEAAEXZ.c)
 * Callees:
 *     <none>
 */
