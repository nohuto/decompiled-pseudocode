/*
 * XREFs of ?NotifyDeviceRemove@FxChildList@@QEAAXPEAJ@Z @ 0x1C006F8EC
 * Callers:
...
void __fastcall FxChildList::NotifyDeviceRemove(FxChildList *this, int *ChildCount)
{
  ...
  while ( 1 )
  {
    ...
    if ( !WORD1(Flink->Blink) )
      _a2 = 0LL;
    WPP_IFR_SF_qqq(this->m_Globals, 4u, 0xCu, 0x33u, WPP_FxChildList_cpp_Traceguids, v9, _a2, Flink[10].Flink);
    v15 = v9->Flink;
    if ( v9->Flink->Blink != v9 || (Blink = v9->Blink, Blink->Flink != v9) )
      __fastfail(3u);
    Blink->Flink = v15;
    v15->Blink = Blink;
    v9->Blink = v9;
    ...
    FxPkgPnp::PnpProcessEvent((FxPkgPnp *)v9[4].Flink[40].Blink, PnpEventParentRemoved, v17);
    v10 = KeAcquireSpinLockRaiseToDpc(&this->m_ListLock);
  }
