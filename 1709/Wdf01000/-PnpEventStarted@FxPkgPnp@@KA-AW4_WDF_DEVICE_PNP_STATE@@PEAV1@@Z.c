/*
 * XREFs of ?PnpEventStarted@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C00146E0
 * Callers:
 *     <none>
 * Callees:
 *     IsLoggingEnabledAndNeeded @ 0x1C0014794 (IsLoggingEnabledAndNeeded.c)
 *     LogDriverInfoStream @ 0x1C0085914 (LogDriverInfoStream.c)
 */

__int64 __fastcall FxPkgPnp::PnpEventStarted(FxPkgPnp *This)
{
  FxDevice *m_Device; // rbx
  FxPkgPnp *m_PkgPnp; // rax
  _FX_DRIVER_GLOBALS *m_Globals; // rsi
  _IRP *m_PendingPnPIrp; // rbx
