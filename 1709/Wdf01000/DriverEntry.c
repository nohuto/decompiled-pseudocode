/*
 * XREFs of DriverEntry @ 0x1C0012490
 * Callers:
 *     GsDriverEntry @ 0x1C00DC010 (GsDriverEntry.c)
 * Callees:
 *     ?WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C0012614 (-WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
