/*
 * XREFs of ?ReleaseResources@FxDmaEnabler@@AEAAXXZ @ 0x1C006824C
 * Callers:
 ...
 *     ?Dispose@FxDmaEnabler@@UEAAEXZ @ 0x1C0068130 (-Dispose@FxDmaEnabler@@UEAAEXZ.c)
 * Callees:
 *     ?FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z @ 0x1C006816C (-FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z.c)
 */
