/*
 * XREFs of ??1FxDevice@@UEAA@XZ @ 0x1C007D234
 * Callers:
 ...
 *     ?IsDisposed@FxObject@@QEAAEXZ @ 0x1C007DAA0 (-IsDisposed@FxObject@@QEAAEXZ.c)
...
void __fastcall FxDevice::~FxDevice(FxDevice *this)
{
  ...
  while ( p_m_CxDeviceInfoListHead->Flink != p_m_CxDeviceInfoListHead )
  {
    ...
    if ( p_m_CxDeviceInfoListHead->Flink->Blink != p_m_CxDeviceInfoListHead
      || (v14 = v13->Flink, v13->Flink->Blink != v13) )
    {
      __fastfail(3u);
    }
