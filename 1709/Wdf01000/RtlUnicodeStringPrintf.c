/*
 * XREFs of RtlUnicodeStringPrintf @ 0x1C0012A0C
 * Callers:
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C00128FC (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 ...
 *     RtlUnicodeStringValidateDestWorker @ 0x1C0012AD4 (RtlUnicodeStringValidateDestWorker.c)
 */
