/*
 * XREFs of ?_Create@FxIoTargetRemote@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDeviceBase@@PEAPEAV1@@Z @ 0x1C0013490
 * Callers:
        ...
        FxIoTargetRemote **Target)
{
  ...
  *Target = 0LL;
  if ( Attributes && (ParentObject = Attributes->ParentObject) != 0LL )
  {
    ...
    v20 = FxDeviceBase::_SearchForDevice(pParent, 0LL);
    v21 = v20;
    if ( !v20 )
    {
      v22 = -1073741808;
...
LABEL_24:
  ...
  v16 = FxObject::Commit(v15, Attributes, &hTarget, pParent, 1u);
  v17 = v16;
  if ( v16 < 0 )
  {
