/*
 * XREFs of ?QueueForwardProgressIrpLocked@FxIoQueue@@AEAAJPEAU_IRP@@@Z @ 0x1C0097A30
 * Callers:
...
__int64 __fastcall FxIoQueue::QueueForwardProgressIrpLocked(FxIoQueue *this, _IRP *Irp)
{
  ...
  if ( Irp->Cancel && _InterlockedExchange64((volatile __int64 *)&Irp->CancelRoutine, 0LL) )
  {
    ...
    if ( p_ListEntry->Flink->Blink != p_ListEntry || (v6 = Irp->Tail.Overlay.ListEntry.Blink, v6->Flink != p_ListEntry) )
      __fastfail(3u);
    v6->Flink = Flink;
    Flink->Blink = v6;
    result = 3221225760LL;
