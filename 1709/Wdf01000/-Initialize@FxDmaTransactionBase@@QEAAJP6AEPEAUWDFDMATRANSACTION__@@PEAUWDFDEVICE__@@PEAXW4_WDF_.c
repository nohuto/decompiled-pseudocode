/*
 * XREFs of ?Initialize@FxDmaTransactionBase@@QEAAJP6AEPEAUWDFDMATRANSACTION__@@PEAUWDFDEVICE__@@PEAXW4_WDF_DMA_DIRECTION@@PEAU_SCATTER_GATHER_LIST@@@Z3PEAU_MDL@@_KK@Z @ 0x1C006C994
 * Callers:
 ...
 *     ?PrepareForSingleTransfer@FxDmaTransactionBase@@AEAAJXZ @ 0x1C006CBE4 (-PrepareForSingleTransfer@FxDmaTransactionBase@@AEAAJXZ.c)
        ...
        unsigned int Length)
{
  ...
  MaximumFragmentLength = this->m_AdapterInfo->MaximumFragmentLength;
  ...
  if ( this->m_RequireSingleTransfer )
  {
    ...
    v24 = FxDmaTransactionBase::PrepareForSingleTransfer(this);
    if ( v24 < 0 )
      goto LABEL_23;
  }
...
LABEL_23:
  ...
  if ( m_Globals->FxVerboseOn )
  {
    ...
    if ( !v25 )
      v26 = 0LL;
    WPP_IFR_SF_qd(m_Globals, 5u, 0xFu, 0xDu, WPP_FxDmaTransactionBase_cpp_Traceguids, v26, v24);
  }
