/*
 * XREFs of imp_WdfObjectDereferenceActual @ 0x1C0002820
 * Callers:
 *     <none>
 * Callees:
        ...
        char *File)
{
  ...
  unsigned int (__fastcall *v6)(FxObject *, void *, int, const char *); // rax
  __int16 v7; // cx
  FxTagTracker *v8; // r14
  ...
  _QWORD *v14; // rcx
  _QWORD *v15; // rsi
  void (__fastcall *v16)(FxObject *); // rdx
  void *(__fastcall *v17)(FxRegKey *, unsigned int); // rax
  void *v18; // rcx
  void *v19; // rcx
  ...
  v6 = *(unsigned int (__fastcall **)(FxObject *, void *, int, const char *))(*(_QWORD *)v5 + 16LL);
  ...
  if ( !_InterlockedDecrement((volatile signed __int32 *)(v5 + 12)) )
  {
    ...
    else
    {
      ...
      v16 = **(void (__fastcall ***)(FxObject *))v5;
      if ( v16 == FxObject::SelfDestruct )
      {
        v17 = *(void *(__fastcall **)(FxRegKey *, unsigned int))(*(_QWORD *)v5 + 8LL);
