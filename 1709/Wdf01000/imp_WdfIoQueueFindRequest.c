/*
 * XREFs of imp_WdfIoQueueFindRequest @ 0x1C00025E0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  $E83ED047D649F8330EF035260E0728C3 *v20; // rdx
  _QWORD *v21; // rcx
  bool v22; // r9
  _QWORD *v23; // r8
  int v24; // edi
  $E83ED047D649F8330EF035260E0728C3 *v26; // r10
  int v27; // r8d
  ...
  FxRequest *pTagRequest; // [rsp+40h] [rbp-58h] BYREF
  FxIoQueue *pQueue; // [rsp+48h] [rbp-50h] BYREF
  FxFileObject *pFO; // [rsp+50h] [rbp-48h] BYREF
  FxRequest *v36; // [rsp+58h] [rbp-40h]
  _FX_DRIVER_GLOBALS *v37; // [rsp+60h] [rbp-38h]
...
LABEL_19:
  ...
  while ( 1 )
  {
    if ( !*((_BYTE *)v23 - 100) )
    {
      v26 = ($E83ED047D649F8330EF035260E0728C3 *)*(v23 - 3);
      if ( !v22 )
      {
        v22 = v26 == v20;
        goto LABEL_63;
...
LABEL_38:
  v17 = (FxRequest *)&v26[-5];
  FxObject::AddRef((FxObject *)&v26[-5], 0LL, v27, "minkernel\\wdf\\framework\\shared\\core\\fxirpqueue.cpp");
  v24 = 0;
  if ( v15 )
  {
