/*
 * XREFs of ?RegisterCallbacks@FxPkgPnp@@QEAAJPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z @ 0x1C0028A80
 * Callers:
 *     ?Initialize@FxPkgPnp@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C002A790 (-Initialize@FxPkgPnp@@UEAAJPEAUWDFDEVICE_INIT@@@Z.c)
 * Callees:
 *     ?InitializeMachine@FxSelfManagedIoMachine@@QEAAXPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z @ 0x1C002FB68 (-InitializeMachine@FxSelfManagedIoMachine@@QEAAXPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z.c)
...
int __fastcall FxPkgPnp::RegisterCallbacks(FxPkgPnp *this, _WDF_PNPPOWER_EVENT_CALLBACKS *DispatchTable)
{
  ...
  FxPkgPnp *v4; // r10
  char v5; // si
  _WDF_EXECUTION_LEVEL *p_m_ExecutionLevel; // r15
  _WDF_EXECUTION_LEVEL *v7; // r11
  int result; // eax
    ...
    && !DispatchTable->EvtDeviceSelfManagedIoRestart )
  {
    ...
    v15 = 117834498;
    v16 = 8;
    v7 = *(_WDF_EXECUTION_LEVEL **)p_m_ExecutionLevel;
    if ( *(_WDF_EXECUTION_LEVEL **)p_m_ExecutionLevel == p_m_ExecutionLevel || !v7 )
      return v2;
    while ( !v5 )
    {
      v10 = 0;
      ...
      while ( 1 )
      {
        v12 = *(FxCxPnpPowerCallbackContext **)&v7[2 * *(unsigned __int8 *)v11 + 24];
        if ( v12 )
        {
      ...
      v5 = 1;
LABEL_20:
      v7 = *(_WDF_EXECUTION_LEVEL **)v7;
      if ( v7 == p_m_ExecutionLevel || !v7 )
      {
        if ( !v5 )
          return v2;
        break;
