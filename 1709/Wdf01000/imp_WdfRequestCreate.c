/*
 * XREFs of imp_WdfRequestCreate @ 0x1C0006A00
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **Request)
{
  ...
  _a3 = 0LL;
  *v5 = 0LL;
  _a4 = FxValidateObjectAttributes(DriverName, RequestAttributes, 0, (unsigned __int16)Request);
  if ( _a4 >= 0 )
  {
    ...
    if ( v16 )
    {
      ...
      *((_WORD *)&v16[1].m_NPLock.m_DbgFlagIsInitialized + 1) = 0;
      ...
      if ( v8 )
        _a4 = FxRequestBase::ValidateTarget(v16, (unsigned __int64)v8);
      if ( _a4 >= 0 )
      {
