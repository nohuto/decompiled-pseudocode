/*
 * XREFs of ?CloneEntryLocked@FxChildList@@IEAAEPEAU_LIST_ENTRY@@PEAUFxDeviceDescriptionEntry@@E@Z @ 0x1C006F180
 * Callers:
...
LABEL_15:
    ...
    {
      v20 = FreeListHead->Blink;
      if ( v20->Flink != FreeListHead )
        __fastfail(3u);
