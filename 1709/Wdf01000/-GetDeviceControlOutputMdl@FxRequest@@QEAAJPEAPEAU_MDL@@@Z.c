/*
 * XREFs of ?GetDeviceControlOutputMdl@FxRequest@@QEAAJPEAPEAU_MDL@@@Z @ 0x1C007AF98
 * Callers:
...
LABEL_21:
          ...
          if ( !this->m_ObjectSize )
            v20 = 0LL;
          WPP_IFR_SF_qd(m_Globals, 2u, 0x10u, v19, WPP_FxRequestKm_cpp_Traceguids, v20, -1073741789);
          goto LABEL_39;
        }
        break;
      case 3u:
...
LABEL_41:
        ...
        *pMdl = 0LL;
        ...
        if ( !v31 )
          v32 = 0LL;
        WPP_IFR_SF_qd(m_Globals, 2u, 0x10u, v30, WPP_FxRequestKm_cpp_Traceguids, v32, -1073741789);
        return v9;
    }
  }
  else
