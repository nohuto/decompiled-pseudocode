/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C001702C
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x1C0016F44 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     WdmlibProcgrpInitialize @ 0x1C00DA67C (WdmlibProcgrpInitialize.c)
 */
