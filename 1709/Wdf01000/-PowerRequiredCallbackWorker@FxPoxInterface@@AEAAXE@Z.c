/*
 * XREFs of ?PowerRequiredCallbackWorker@FxPoxInterface@@AEAAXE@Z @ 0x1C000FCC8
 * Callers:
 *     ?PowerRequiredCallback@FxPoxInterface@@CAXPEAX@Z @ 0x1C000EFD0 (-PowerRequiredCallback@FxPoxInterface@@CAXPEAX@Z.c)
 *     ?SimulateDevicePowerRequired@FxPoxInterface@@QEAAXXZ @ 0x1C000FD2C (-SimulateDevicePowerRequired@FxPoxInterface@@QEAAXXZ.c)
 * Callees:
