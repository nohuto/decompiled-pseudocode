/*
 * XREFs of ?HandleQueryDeviceRelations@FxPkgPnp@@IEAAJPEAVFxIrp@@PEAVFxRelatedDeviceList@@@Z @ 0x1C009D230
 * Callers:
...
__int64 __fastcall FxPkgPnp::HandleQueryDeviceRelations(FxPkgPnp *this, FxIrp *Irp, FxRelatedDeviceList *List)
{
  ...
  FxPnpDeviceD0ExitPreInterruptsDisabled::Invoke(&this->m_DeviceRelationsQuery, v11, Type);
  v12 = 0;
