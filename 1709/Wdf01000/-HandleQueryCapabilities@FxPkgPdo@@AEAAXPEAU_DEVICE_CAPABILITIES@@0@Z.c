/*
 * XREFs of ?HandleQueryCapabilities@FxPkgPdo@@AEAAXPEAU_DEVICE_CAPABILITIES@@0@Z @ 0x1C0021580
 * Callers:
        ...
        _DEVICE_CAPABILITIES *ParentCaps)
{
  ...
  v14.ByEnum = (FxPnpStateAndCaps::<unnamed_type_ByEnum>)this->m_PnpStateAndCaps;
  ...
  if ( (*(_WORD *)&v14.ByEnum & 0x3000) != 0 )
  {
    if ( (*(_WORD *)&v14.ByEnum & 0x3000) == 0x1000 )
  ...
  if ( (*(_WORD *)&v14.ByEnum & 0xC000) != 0 )
  {
    if ( (*(_WORD *)&v14.ByEnum & 0xC000) == 0x4000 )
  ...
  if ( (v14.Value & 0x30000) != 0 )
  {
    if ( (v14.Value & 0x30000) == 0x10000 )
  ...
  if ( (v14.Value & 0xC0000) != 0 )
  {
    if ( (v14.Value & 0xC0000) == 0x40000 )
  ...
  if ( (v14.Value & 0x300000) != 0 )
  {
    if ( (v14.Value & 0x300000) == 0x100000 )
  ...
  v15 = v14.Value & 0xC00000;
  if ( (v14.Value & 0xC00000) == 0x800000 )
  {
    if ( this->m_RawOK )
LABEL_32:
...
LABEL_33:
  if ( (v14.Value & 0x3000000) != 0 )
  {
    if ( (v14.Value & 0x3000000) == 0x1000000 )
  ...
  if ( (v14.Value & 0xC000000) != 0 )
  {
    if ( (v14.Value & 0xC000000) == 0x4000000 )
