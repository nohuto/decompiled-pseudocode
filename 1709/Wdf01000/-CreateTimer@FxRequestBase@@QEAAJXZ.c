/*
 * XREFs of ?CreateTimer@FxRequestBase@@QEAAJXZ @ 0x1C007E200
 * Callers:
...
__int64 __fastcall FxRequestBase::CreateTimer(FxRequestBase *this)
{
  ...
  if ( !this->m_Timer )
  {
    ...
    if ( !v4 )
      return 3221225626LL;
    v6 = MxTimer::Initialize(&v4->Timer, this, FxRequestBase::_TimerDPC, 0);
    if ( v6 < 0 )
    {
      WPP_IFR_SF_q(m_Globals, 2u, 0xDu, 0x13u, WPP_FxRequestBase_cpp_Traceguids, this);
      FxRequestTimer::`scalar deleting destructor'(v4);
