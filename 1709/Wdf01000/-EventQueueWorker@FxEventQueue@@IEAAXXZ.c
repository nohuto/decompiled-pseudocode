/*
 * XREFs of ?EventQueueWorker@FxEventQueue@@IEAAXXZ @ 0x1C00652A8
 * Callers:
 *     ?_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z @ 0x1C00A2BC0 (-_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z.c)
 * Callees:
