/*
 * XREFs of ?_PowerPolicyWaitWakeCompletionRoutine@FxPkgPnp@@KAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z @ 0x1C000EDD0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *Context)
{
    ...
    || _InterlockedExchange((volatile __int32 *)(*((_QWORD *)Context + 110) + 560LL), 1) == 1 )
  {
    ...
    if ( v12->FxVerboseOn )
      WPP_IFR_SF_q(v12, 5u, 0xCu, 0x2Bu, WPP_PowerPolicyStateMachine_cpp_Traceguids, OriginalIrp);
