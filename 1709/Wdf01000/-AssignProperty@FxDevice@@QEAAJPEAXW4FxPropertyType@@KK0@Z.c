/*
 * XREFs of ?AssignProperty@FxDevice@@QEAAJPEAXW4FxPropertyType@@KK0@Z @ 0x1C007CCBC
 * Callers:
        ...
        void *PropertyData_0)
{
  ...
  {
    v15 = IoSetDevicePropertyData(SafePhysicalDevice, v10, v8, v11, v9, PropertyBuffer, PropertyData_0);
    if ( v15 >= 0 )
