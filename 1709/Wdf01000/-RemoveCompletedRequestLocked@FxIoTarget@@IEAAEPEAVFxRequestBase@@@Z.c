/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x1C0005E80
 * Callers:
        ...
        unsigned __int8 a3)
{
  ...
  $E83ED047D649F8330EF035260E0728C3 *v7; // rax
  _IRP *Irp; // rdx
  ...
  v7 = &Request->120;
  if ( ($E83ED047D649F8330EF035260E0728C3 *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($E83ED047D649F8330EF035260E0728C3 **)&Irp->Type != v7) )
  {
    __fastfail(3u);
  }
