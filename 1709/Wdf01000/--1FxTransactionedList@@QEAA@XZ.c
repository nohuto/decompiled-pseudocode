/*
 * XREFs of ??1FxTransactionedList@@QEAA@XZ @ 0x1C0086318
 * Callers:
...
void __fastcall FxTransactionedList::~FxTransactionedList(FxTransactionedList *this)
{
  ...
  if ( !v1 )
  {
    ...
    while ( p_m_ListHead->Flink != p_m_ListHead )
    {
      ...
      if ( p_m_ListHead->Flink->Blink != p_m_ListHead || (v5 = Flink->Flink, Flink->Flink->Blink != Flink) )
        __fastfail(3u);
      ...
      if ( LODWORD(Flink[2].Flink) == 3 )
      {
        v6 = Flink + 1;
        v7 = Flink[1].Flink;
        if ( v7->Blink != &Flink[1] || (Blink = Flink[1].Blink, Blink->Flink != v6) )
          __fastfail(3u);
        Blink->Flink = v7;
        v7->Blink = Blink;
    ...
    while ( p_m_TransactionHead->Flink != p_m_TransactionHead )
    {
      ...
      if ( p_m_TransactionHead->Flink->Blink != p_m_TransactionHead || (v11 = v10->Flink, v10->Flink->Blink != v10) )
        __fastfail(3u);
