/*
 * XREFs of ?ConfigureBusMasterAdapters@FxDmaEnabler@@AEAAJPEAU_DEVICE_DESCRIPTION@@PEAU_WDF_DMA_ENABLER_CONFIG@@@Z @ 0x1C0033638
 * Callers:
        ...
        _WDF_DMA_ENABLER_CONFIG *Config)
{
  ...
  unsigned __int64 AlignmentRequirement; // rcx
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (v8 & 8) != 0 )
    {
      ...
      if ( v9 )
      {
        ...
        AlignmentRequirement = v6->m_FDO->AlignmentRequirement;
        if ( AlignmentRequirement <= v18 )
          LODWORD(AlignmentRequirement) = v18;
        v6->m_CommonBufferAlignment = AlignmentRequirement;
      ...
      else
      {
        ...
        v14 = v6->m_FDO->AlignmentRequirement;
        if ( v14 <= v12 )
          LODWORD(v14) = v12;
        v6->m_CommonBufferAlignment = v14;
