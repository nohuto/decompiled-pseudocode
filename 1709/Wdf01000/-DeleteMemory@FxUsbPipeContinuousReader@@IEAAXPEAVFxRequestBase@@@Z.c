/*
 * XREFs of ?DeleteMemory@FxUsbPipeContinuousReader@@IEAAXPEAVFxRequestBase@@@Z @ 0x1C008DE38
 * Callers:
 *     ??1FxUsbPipeContinuousReader@@QEAA@XZ @ 0x1C008DA7C (--1FxUsbPipeContinuousReader@@QEAA@XZ.c)
