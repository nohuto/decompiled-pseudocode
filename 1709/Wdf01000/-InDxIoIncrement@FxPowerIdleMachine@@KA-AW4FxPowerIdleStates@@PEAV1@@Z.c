/*
 * XREFs of ?InDxIoIncrement@FxPowerIdleMachine@@KA?AW4FxPowerIdleStates@@PEAV1@@Z @ 0x1C000DD90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPowerIdleMachine::InDxIoIncrement(FxPowerIdleMachine *This)
{
  ...
  if ( (This->m_Flags & 0x40) != 0 )
  {
    ...
    if ( !m_ObjectSize )
      _a1 = 0LL;
    WPP_IFR_SF_q(m_Globals, 4u, 0xCu, 0xBu, WPP_PowerIdleStateMachine_cpp_Traceguids, _a1);
  }
  else
  {
