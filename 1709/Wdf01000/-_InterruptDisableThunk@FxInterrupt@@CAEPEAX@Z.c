/*
 * XREFs of ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C000E120
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxInterrupt::_InterruptDisableThunk(_DWORD *SyncContext)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)SyncContext + 258LL) )
  {
    ...
    if ( !*(_WORD *)(v1 + 10) )
      v12 = 0LL;
    v7 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v1 + 320))(v12, v11);
  ...
  else
  {
    ...
    if ( !*(_WORD *)(v1 + 10) )
      v6 = 0LL;
    v7 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v1 + 320))(v6, v5);
  }
  result = 1;
  SyncContext[2] = v7;
  return result;
