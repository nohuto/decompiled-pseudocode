/*
 * XREFs of ?GetPdoPackageFromDeviceHandle@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFDEVICE__@@PEADPEAPEAVFxPkgPdo@@PEAPEAU1@PEAPEAVFxDevice@@@Z @ 0x1C006E4DC
 * Callers:
 ...
 *     imp_WdfPdoMarkMissing @ 0x1C006E650 (imp_WdfPdoMarkMissing.c)
