/*
 * XREFs of ?HandleQueryCapabilitiesCompletion@FxPkgFdo@@AEAAXPEAVFxIrp@@@Z @ 0x1C0022CB0
 * Callers:
...
void __fastcall FxPkgFdo::HandleQueryCapabilitiesCompletion(FxPkgFdo *this, FxIrp *Irp, unsigned __int8 a3)
{
  ...
  v9.ByEnum = (FxPnpStateAndCaps::<unnamed_type_ByEnum>)this->m_PnpStateAndCaps;
  if ( SLOBYTE(this->m_ObjectFlags) < 0
  ...
  {
    if ( (*(_WORD *)&v9.ByEnum & 0x3000) == 0 )
      HIDWORD(SecurityContext->SecurityQos) &= ~4u;
    if ( (*(_WORD *)&v9.ByEnum & 0xC000) == 0 )
      HIDWORD(SecurityContext->SecurityQos) &= ~8u;
    if ( (v9.Value & 0xC0000) == 0 )
      HIDWORD(SecurityContext->SecurityQos) &= ~0x20u;
    if ( (v9.Value & 0x30000) != 0 )
    {
      if ( (v9.Value & 0x30000) == 0x10000 )
