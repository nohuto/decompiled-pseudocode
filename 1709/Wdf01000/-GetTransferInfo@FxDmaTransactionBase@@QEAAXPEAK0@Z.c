/*
 * XREFs of ?GetTransferInfo@FxDmaTransactionBase@@QEAAXPEAK0@Z @ 0x1C006C7F4
 * Callers:
        ...
        unsigned int *ScatterGatherElementCount)
{
  ...
  *(_QWORD *)&info.Version = 0LL;
  *(_QWORD *)&info.V1.ScatterGatherElementCount = 0LL;
  ...
  else
  {
    ...
    while ( m_StartMdl && m_TransactionLength )
    {
      ...
      if ( ByteCount > m_StartOffset )
      {
        ...
        v21 = m_TransactionLength;
        info.V1.MapRegisterCount = v14;
        if ( v19 < m_TransactionLength )
          v21 = v19;
        m_TransactionLength -= v21;
      }
      else
      {
