/*
 * XREFs of ?ComponentActiveCallback@FxPoxInterface@@CAXPEAXK@Z @ 0x1C000E880
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxPoxInterface::ComponentActiveCallback(FxPoxInterface *Context, unsigned int Component)
{
  ...
  if ( PowerFrameworkSettings && PowerFrameworkSettings->ComponentActiveConditionCallback )
  {
    ...
    if ( v11->FxVerboseOn )
    {
      ...
      if ( !v12->m_ObjectSize )
        v13 = 0LL;
      WPP_IFR_SF_qq(v11, 5u, 0xCu, 0xDu, WPP_PoxInterfaceKm_cpp_Traceguids, v13, v12->m_DeviceObject.m_DeviceObject);
    }
