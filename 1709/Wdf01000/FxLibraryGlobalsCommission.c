/*
 * XREFs of FxLibraryGlobalsCommission @ 0x1C0036884
 * Callers:
 ...
 *     strcmp_0 @ 0x1C003D616 (strcmp_0.c)
...
NTSTATUS __fastcall FxLibraryGlobalsCommission()
{
  ...
  *(_WORD *)&FxLibraryGlobals.IfrDisabled = 0;
  ...
  v1 = (void (__fastcall *)(_OSVERSIONINFOEXW *))MmGetSystemRoutineAddress(&DestinationString);
