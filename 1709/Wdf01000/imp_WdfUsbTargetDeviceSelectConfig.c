/*
 * XREFs of imp_WdfUsbTargetDeviceSelectConfig @ 0x1C008C960
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Params->Type != WdfUsbTargetDeviceSelectConfigTypeSingleInterface )
    {
      ...
      if ( Params->Types.SingleInterface.NumberConfiguredPipes )
      {
        while ( 1 )
        {
          ...
          v26 = *((_BYTE *)v25 + 8);
          if ( v26 >= pUsbInterface->m_NumSettings )
            break;
        ...
        if ( pUsbDevice->m_ObjectSize )
          v27 = (const void *)((unsigned __int64)pUsbDevice ^ 0xFFFFFFFFFFFFFFF8uLL);
        else
          v27 = 0LL;
        v11 = -1073741811;
        WPP_IFR_SF_qqddd(
