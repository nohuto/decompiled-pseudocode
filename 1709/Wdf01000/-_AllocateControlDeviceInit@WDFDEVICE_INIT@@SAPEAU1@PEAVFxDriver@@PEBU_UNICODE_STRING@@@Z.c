/*
 * XREFs of ?_AllocateControlDeviceInit@WDFDEVICE_INIT@@SAPEAU1@PEAVFxDriver@@PEBU_UNICODE_STRING@@@Z @ 0x1C00386CC
 * Callers:
        ...
        const _UNICODE_STRING *SDDLString)
{
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)(v7 + 176) = v10;
    if ( v10 )
    {
      v12 = FxDuplicateUnicodeString(*(_FX_DRIVER_GLOBALS **)(v10 + 16), SDDLString, (_UNICODE_STRING *)(v10 + 104));
    }
    else
    {
      v12 = -1073741670;
