/*
 * XREFs of ?Add@FxChildList@@QEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@PEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@PEAK@Z @ 0x1C002E330
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)(v16 + 48) = v17;
      ...
      if ( this->m_StaticList )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(v21 + 648) + 1608LL) = v16;
        *(_BYTE *)(*(_QWORD *)(v21 + 648) + 1682LL) = 1;
      }
    }
  }
  else
