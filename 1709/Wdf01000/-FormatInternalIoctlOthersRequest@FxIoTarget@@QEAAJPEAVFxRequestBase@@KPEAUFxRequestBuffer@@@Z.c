/*
 * XREFs of ?FormatInternalIoctlOthersRequest@FxIoTarget@@QEAAJPEAVFxRequestBase@@KPEAUFxRequestBuffer@@@Z @ 0x1C002376C
 * Callers:
        ...
        FxRequestBuffer *Buffers)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    while ( 1 )
    {
      _a2 = FxRequestBuffer::GetBuffer(&Buffers[v12], *v11);
      v15 = _a2;
      if ( _a2 < 0 )
        break;
      ++v12;
