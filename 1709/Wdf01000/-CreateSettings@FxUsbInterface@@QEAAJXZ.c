/*
 * XREFs of ?CreateSettings@FxUsbInterface@@QEAAJXZ @ 0x1C0092DEC
 * Callers:
...
__int64 __fastcall FxUsbInterface::CreateSettings(FxUsbInterface *this)
{
  ...
  _USB_CONFIGURATION_DESCRIPTOR *v18; // rsi
  __int64 v19; // rdx
  _USB_COMMON_DESCRIPTOR *v20; // r9
  char *v21; // r11
  int v22; // esi
  ...
  if ( v6 )
  {
    ...
    while ( 1 )
    {
      InterfaceDescriptor = this->m_Settings[v15].InterfaceDescriptor;
      if ( !InterfaceDescriptor )
        break;
      bNumEndpoints = InterfaceDescriptor->bNumEndpoints;
      if ( bNumEndpoints )
      {
        v18 = this->m_UsbDevice->m_ConfigDescriptor;
        v20 = FxUsbFindDescriptorType((char *)v18, v18->wTotalLength, &InterfaceDescriptor->bLength, 4);
        if ( !v20 )
          v20 = (_USB_COMMON_DESCRIPTOR *)(&v18->bLength + v19);
        v22 = FxUsbValidateDescriptorType(this->m_Globals, v18, v21, v20, 5, 7uLL, globals, bNumEndpoints);
        if ( v22 < 0 )
        {
          WPP_IFR_SF_dd(
            this->m_Globals,
