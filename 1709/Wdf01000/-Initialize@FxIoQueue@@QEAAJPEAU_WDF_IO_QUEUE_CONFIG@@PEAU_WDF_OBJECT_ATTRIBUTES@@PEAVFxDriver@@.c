/*
 * XREFs of ?Initialize@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@E@Z @ 0x1C001B040
 * Callers:
 ...
 *     ?ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z @ 0x1C001AE2C (-ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z.c)
        ...
        unsigned __int8 InitialPowerStateOn)
{
  ...
  if ( DispatchType == WdfIoQueueDispatchManual )
  {
      ...
      || pConfig->EvtIoInternalDeviceControl )
    {
      ...
      if ( !v23 )
        v24 = 0LL;
      WPP_IFR_SF_qd(m_Globals, 2u, 0xDu, 0x10u, WPP_FxIoQueue_cpp_Traceguids, v24, -1073741811);
      return 3221225485LL;
    }
  }
  ...
  if ( pConfig->Size > 0x50 )
  {
    ...
    if ( NumberOfPresentedRequests && ((DispatchType - 1) & 0xFFFFFFFD) == 0 )
    {
      ...
      if ( !v19 )
        v20 = 0LL;
      WPP_IFR_SF_qd(m_Globals, 2u, 0xDu, 0x11u, WPP_FxIoQueue_cpp_Traceguids, v20, -1073741811);
      return 3221225485LL;
    }
...
LABEL_14:
  ...
  if ( (m_QueueState & 0x10000) != 0 )
  {
    ...
    if ( !this->m_ObjectSize )
      v22 = 0LL;
    WPP_IFR_SF_q(v14, 4u, 0xDu, 0x17u, WPP_FxIoQueue_cpp_Traceguids, v22);
  }
  else
  {
