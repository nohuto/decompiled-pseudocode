/*
 * XREFs of McTemplateK0pppxsbb @ 0x1C0007654
 * Callers:
...
NTSTATUS McTemplateK0pppxsbb(__int64 a1, __int64 a2, __int64 a3, ...)
{
  const char *v3; // rcx
  __int64 v4; // rax
  int v5; // eax
  ...
  v20 = 16LL;
  v22 = 16LL;
  return McGenEventWriteKM((__int64)v3, &USBXHCI_ETW_EVENT_CONTROLLER_ERROR, 0LL, 8u, &v7);
}
