/*
 * XREFs of McTemplateK0ppb @ 0x1C0007F10
 * Callers:
...
NTSTATUS McTemplateK0ppb(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v9 = v15;
  v10 = 16LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_COMMAND_SEND, 0LL, 4u, &v4);
}
