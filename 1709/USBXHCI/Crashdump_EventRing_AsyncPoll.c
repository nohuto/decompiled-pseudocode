/*
 * XREFs of Crashdump_EventRing_AsyncPoll @ 0x1C003AE2C
 * Callers:
 *     Crashdump_PollForCompletion @ 0x1C0039B40 (Crashdump_PollForCompletion.c)
 * Callees:
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C003B63C (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
