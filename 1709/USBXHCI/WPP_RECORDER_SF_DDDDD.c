/*
 * XREFs of WPP_RECORDER_SF_ddddd @ 0x1C0037574
 * Callers:
...
__int64 WPP_RECORDER_SF_ddddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_a5fd15ff1a8637a5810b72c9190e663e_Traceguids,
      39LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 39;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_a5fd15ff1a8637a5810b72c9190e663e_Traceguids, v7, (__int64 *)va);
}
