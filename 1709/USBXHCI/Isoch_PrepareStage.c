/*
 * XREFs of Isoch_PrepareStage @ 0x1C0028BB4
 * Callers:
 ...
 *     Isoch_Stage_AcquireMdl @ 0x1C002A3E8 (Isoch_Stage_AcquireMdl.c)
...
__int64 __fastcall Isoch_PrepareStage(__int64 a1)
{
  ...
  *((_DWORD *)v1 + 10) = v4;
  ...
  if ( (*(_QWORD *)(*(_QWORD *)(v8 + 8) + 272LL) & 0x800000000000000LL) != 0 || (*(_DWORD *)(v8 + 104) & 0x800) == 0 )
  {
    v10 = *(_DWORD *)(a1 + 328);
    if ( (v10 & 0x20) != 0 )
    {
  ...
  if ( (v7 <= 0x38u || v7 > 0x3Au) && (int)Isoch_Stage_AcquireMdl(v1, 0x800000000000000LL, v5, v9) < 0
