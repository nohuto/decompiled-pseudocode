/*
 * XREFs of WppInitKm @ 0x1C005AB14
 * Callers:
...
void __fastcall WppInitKm(__int64 a1, __int64 a2)
{
  ...
  void (__fastcall *ProcessorHistory)(_DRIVER_OBJECT *, _QWORD, __int64 (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, _VPB **); // rax
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( WPP_MAIN_CB.Dpc.TargetInfoAsUlong == 4 )
    {
      do
      {
        ProcessorHistory = (void (__fastcall *)(_DRIVER_OBJECT *, _QWORD, __int64 (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, _VPB **))WPP_MAIN_CB.Dpc.ProcessorHistory;
        v2->Vpb = 0LL;
