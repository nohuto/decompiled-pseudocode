/*
 * XREFs of Controller_WdfEvtDeviceAdd @ 0x1C0059AB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Etw_ControllerCreate @ 0x1C00382F8 (Etw_ControllerCreate.c)
...
__int64 __fastcall Controller_WdfEvtDeviceAdd(__int64 a1, __int64 a2)
{
  ...
  v4 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_1C004F8E8)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.32, a2);
  WdfDevice = v4;
  if ( v4 >= 0 )
  {
    ...
    v6 = (_QWORD *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, void *))(WdfFunctions_01015 + 1616))(
                     WdfDriverGlobals,
                     *(_QWORD *)v35,
                     off_1C004E408);
    ...
    {
      v24 = v8;
      WPP_RECORDER_SF_d(*(__int64 *)v34, 2u, 4u, 0xBu, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v24);
    }
    else
    {
      ...
      {
        v25 = v9;
        WPP_RECORDER_SF_d(*(__int64 *)v34, 2u, 4u, 0xCu, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v25);
        v3 = v37;
      }
    }
  }
  ...
  {
    v23 = v4;
    WPP_RECORDER_SF_d(*(__int64 *)v34, 2u, 4u, 0xAu, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v23);
  }
  if ( WdfDevice < 0 && v3 )
