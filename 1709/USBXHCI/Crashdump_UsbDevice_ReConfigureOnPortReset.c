/*
 * XREFs of Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C003D3C8
 * Callers:
 *     Crashdump_ResetDevice @ 0x1C0039BE0 (Crashdump_ResetDevice.c)
 * Callees:
 *     Crashdump_UsbDevice_Configure @ 0x1C003C75C (Crashdump_UsbDevice_Configure.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C003D970 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 */
