/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C0007400
 * Callers:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0007100 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 * Callees:
 *     WdfVersionUnbindClass_0 @ 0x1C00074C0 (WdfVersionUnbindClass_0.c)
 */
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  v1 = &Ucx_BIND_INFO;
  if ( off_1C004F5A8 != &__KMDF_CLASS_BIND_START && &Ucx_BIND_INFO <= off_1C004F5A8 )
  {
    do
    {
