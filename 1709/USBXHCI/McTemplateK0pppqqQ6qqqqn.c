/*
 * XREFs of McTemplateK0pppqqQ6qqqqn @ 0x1C0008184
 * Callers:
...
NTSTATUS McTemplateK0pppqqQ6qqqqn(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  __int64 v37; // [rsp+150h] [rbp+57h]
  __int64 v38; // [rsp+158h] [rbp+5Fh] BYREF
  va_list va5; // [rsp+158h] [rbp+5Fh]
  __int64 v40; // [rsp+160h] [rbp+67h] BYREF
  va_list va6; // [rsp+160h] [rbp+67h]
  __int64 v42; // [rsp+168h] [rbp+6Fh] BYREF
  va_list va7; // [rsp+168h] [rbp+6Fh]
  __int64 v44; // [rsp+170h] [rbp+77h] BYREF
  va_list va8; // [rsp+170h] [rbp+77h]
  __int64 v46; // [rsp+178h] [rbp+7Fh]
  __int64 v47; // [rsp+180h] [rbp+87h]
  va_list va9; // [rsp+188h] [rbp+8Fh] BYREF
  ...
  v24 = 4LL;
  v26 = 18LL;
  return McGenEventWriteKM(a1, a2, a3, 0xCu, &v4);
}
