/*
 * XREFs of McTemplateK0cqqq @ 0x1C0007E38
 * Callers:
...
NTSTATUS __fastcall McTemplateK0cqqq(__int64 a1, __int64 a2, const GUID *a3, char a4, char a5, char a6, char a7)
{
  ...
  v15 = &a7;
  v16 = 4LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_TRANSFER_INITIALIZED, a3, 5u, &v8);
}
