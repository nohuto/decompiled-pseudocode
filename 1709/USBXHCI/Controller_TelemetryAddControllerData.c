/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x1C005914C
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x1C0016978 (XilDeviceSlot_GetNumberOfDeviceSlots.c)
 *     XilDeviceSlot_GetUsbDeviceHandleArray @ 0x1C0016984 (XilDeviceSlot_GetUsbDeviceHandleArray.c)
 *     TelemetryData_InsertTriageDataBlock @ 0x1C00415C4 (TelemetryData_InsertTriageDataBlock.c)
 */
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x2C0u),
        (int)UsbDeviceHandleArray >= 0) )
  {
    ...
    if ( (int)UsbDeviceHandleArray >= 0 )
    {
            ...
            (int)UsbDeviceHandleArray >= 0) )
      {
        v5 = (const void *)a1[11];
        if ( !v5
          || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, v5, 0x80u),
              (int)UsbDeviceHandleArray >= 0) )
        {
          v6 = (const void *)a1[15];
          if ( !v6
            || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, v6, 0x128u),
                (int)UsbDeviceHandleArray >= 0) )
          {
            v7 = (const void *)a1[16];
            if ( !v7
              || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, v7, 0x48u),
                  (int)UsbDeviceHandleArray >= 0) )
            {
              v8 = (const void *)a1[17];
              if ( !v8
                    ...
                    (int)UsbDeviceHandleArray >= 0) )
              {
                      ...
                      (int)UsbDeviceHandleArray >= 0) )
                {
                  ...
                  if ( !v14
                    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, v14, 0xD8u),
                        (int)UsbDeviceHandleArray >= 0) )
                  {
