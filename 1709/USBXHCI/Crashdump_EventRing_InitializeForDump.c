/*
 * XREFs of Crashdump_EventRing_InitializeForDump @ 0x1C003B0E0
 * Callers:
...
__int64 __fastcall Crashdump_EventRing_InitializeForDump(__int64 *a1, __int64 a2)
{
  ...
  *a1 = a2;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v3 >= 0 )
    {
      PoolWithTag = ExAllocatePoolWithTag(*((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1), 0x58uLL, 0x43434858u);
