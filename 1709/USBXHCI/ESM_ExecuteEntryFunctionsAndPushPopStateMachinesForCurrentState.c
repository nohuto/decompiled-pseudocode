/*
 * XREFs of ESM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState @ 0x1C003DD40
 * Callers:
 *     ESM_AddEvent @ 0x1C003DBEC (ESM_AddEvent.c)
 *     ESM_RunStateMachine @ 0x1C003E574 (ESM_RunStateMachine.c)
 *     ESM_SmWorker @ 0x1C003E810 (ESM_SmWorker.c)
 * Callees:
...
LABEL_6:
      ...
      *((_BYTE *)Context + 832) = (*((_BYTE *)Context + 832) + 1) & 0x3F;
      ...
      v23 = (*(__int64 (__fastcall **)(unsigned int *, __int64, __int64))(v5 + 8))(Context, v10, v8);
      v7 = *(_DWORD **)(v5 + 24);
      v30 = v23;
      if ( !v7 )
        goto LABEL_7;
