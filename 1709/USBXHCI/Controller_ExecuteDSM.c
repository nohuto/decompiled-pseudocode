/*
 * XREFs of Controller_ExecuteDSM @ 0x1C0057028
 * Callers:
...
__int64 __fastcall Controller_ExecuteDSM(__int64 *a1, const void *a2, int a3, int a4, void *a5, unsigned __int16 a6)
{
  ...
  _QWORD v29[3]; // [rsp+68h] [rbp-51h] BYREF
  _QWORD v30[3]; // [rsp+80h] [rbp-39h] BYREF
  void *Src; // [rsp+98h] [rbp-21h]
  char v32[8]; // [rsp+A0h] [rbp-19h] BYREF
  ...
  if ( PoolWithTag )
  {
    ...
    *(_WORD *)((char *)v16 + v17 + 38) = a6;
    ...
    v29[0] = 1LL;
    v29[2] = 20LL;
    v19 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 336))(WdfDriverGlobals, v8);
