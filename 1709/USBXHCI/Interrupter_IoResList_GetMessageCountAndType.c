/*
 * XREFs of Interrupter_IoResList_GetMessageCountAndType @ 0x1C005C450
 * Callers:
...
char *__fastcall Interrupter_IoResList_GetMessageCountAndType(__int64 a1, unsigned int *a2, unsigned int *a3, char *a4)
{
  ...
  v7 = 0;
  v8 = a1;
  while ( v7 < (*(unsigned int (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2320))(
                 WdfDriverGlobals,
                 v8) )
  {
    ...
    for ( i = 0;
          ...
          ++i )
    {
      v14 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2392))(
              WdfDriverGlobals,
              v12,
              i);
