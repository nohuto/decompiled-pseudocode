/*
 * XREFs of WPP_RECORDER_SF_ddqDddd @ 0x1C004007C
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqDddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_476c7f6a61583b4cf1c220e4dc815a48_Traceguids,
      14LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 14;
  return WppAutoLogTrace(a1, 5LL, 8LL, &WPP_476c7f6a61583b4cf1c220e4dc815a48_Traceguids, v7, (__int64 *)va);
}
