/*
 * XREFs of Endpoint_SM_CompleteResetRequestFromClient @ 0x1C001A998
 * Callers:
 *     Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1C001AA30 (Endpoint_SM_OkToCompleteEndpointResetRequest.c)
 *     ESM_CompletingResetRequestWhenEndpointNotHalted @ 0x1C003EBA0 (ESM_CompletingResetRequestWhenEndpointNotHalted.c)
 * Callees:
