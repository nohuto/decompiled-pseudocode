/*
 * XREFs of McTemplateK0ppbqc @ 0x1C0008034
 * Callers:
...
NTSTATUS McTemplateK0ppbqc(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 1LL;
  return McGenEventWriteKM(a1, a2, 0LL, 6u, &v4);
}
