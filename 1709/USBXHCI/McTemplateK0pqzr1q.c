/*
 * XREFs of McTemplateK0pqzr1q @ 0x1C000848C
 * Callers:
...
NTSTATUS McTemplateK0pqzr1q(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 2 * v16;
  va_copy(v12, va2);
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_STARTDEVICE_FAIL, 0LL, 5u, &v4);
}
