/*
 * XREFs of XilCommand_CreateSecureObject @ 0x1C000ECE0
 * Callers:
...
__int64 __fastcall XilCommand_CreateSecureObject(__int64 a1)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v8 = v9;
      WPP_RECORDER_SF_d(v2[9], 2u, 7u, 0xBu, (__int64)&WPP_feebadd708d238b58d4835f0a8daaaf3_Traceguids, v8);
      Debug_FreAssertMsg(
  ...
  {
    v7 = v4;
    WPP_RECORDER_SF_d(v2[9], 2u, 7u, 0xAu, (__int64)&WPP_feebadd708d238b58d4835f0a8daaaf3_Traceguids, v7);
  }
  return v5;
}
