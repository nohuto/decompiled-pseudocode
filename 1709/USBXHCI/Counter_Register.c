/*
 * XREFs of Counter_Register @ 0x1C005FA6C
 * Callers:
...
NTSTATUS Counter_Register()
{
  ...
  if ( *(_BYTE *)(WPP_MAIN_CB.DeviceQueue.Lock + 28) )
  {
    ...
    Info.CounterCount = 6;
    PcwRegister((PPCW_REGISTRATION *)&WPP_MAIN_CB.DeviceQueue, &Info);
    v1 = 2359330;
    ...
    Info.Name = (const _UNICODE_STRING *)&v1;
    Info.CounterCount = 4;
    PcwRegister((PPCW_REGISTRATION *)&WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink, &Info);
    v1 = 2359330;
    ...
    Info.Name = (const _UNICODE_STRING *)&v1;
    Info.CounterCount = 7;
    return PcwRegister((PPCW_REGISTRATION *)&WPP_MAIN_CB.DeviceQueue.DeviceListHead, &Info);
  }
  return result;
}
