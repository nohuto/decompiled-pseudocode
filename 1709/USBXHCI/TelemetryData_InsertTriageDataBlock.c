/*
 * XREFs of TelemetryData_InsertTriageDataBlock @ 0x1C00415C4
 * Callers:
      ...
      if ( v8 + 16 * (unsigned __int64)v7 <= 0x40000 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v11 >= v7 )
          {
            ...
            {
              memmove((void *)(v6 + v9 + 16), (const void *)(v6 + v9), v14 - v9);
              v15 = 0;
              for ( i = v6 + *(unsigned int *)(v6 + 8312); v15 < *(_DWORD *)(v6 + 8316); i += 16LL )
              {
                *(_DWORD *)(i + 8) += 16;
                ++v15;
              }
