/*
 * XREFs of DynamicLock_Acquire @ 0x1C003FB80
 * Callers:
...
{
  if ( *(_DWORD *)a1 != 1 )
    return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD))(WdfFunctions_01015 + 2528))(
             WdfDriverGlobals,
             *(_QWORD *)(a1 + 8));
  if ( KeGetCurrentIrql() )
    Debug_FreAssertMsg(
      ...
      88);
  return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
           WdfDriverGlobals,
           *(_QWORD *)(a1 + 8),
           0LL);
}
