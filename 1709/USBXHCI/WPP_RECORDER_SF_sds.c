/*
 * XREFs of WPP_RECORDER_SF_sds @ 0x1C00160E4
 * Callers:
        ...
        const char *a8)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, const char *, __int64, char *, __int64, const char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_653d83762f4332ccb56b33124d8ced57_Traceguids,
      10LL,
      v17,
      v16,
      &a7,
  ...
  if ( !a6 )
    v10 = "NULL";
  LOWORD(v20) = 10;
  return WppAutoLogTrace(a1, 2LL, 2LL, &WPP_653d83762f4332ccb56b33124d8ced57_Traceguids, v20, v10);
}
