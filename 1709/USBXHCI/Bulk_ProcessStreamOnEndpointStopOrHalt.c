/*
 * XREFs of Bulk_ProcessStreamOnEndpointStopOrHalt @ 0x1C002EF6C
 * Callers:
 *     Bulk_EP_EndpointHalted @ 0x1C002DF50 (Bulk_EP_EndpointHalted.c)
 *     Bulk_EP_FSEReceived @ 0x1C002DFB0 (Bulk_EP_FSEReceived.c)
 * Callees:
...
LABEL_13:
  ...
  *(_DWORD *)(v4 + 108) += v11;
  if ( (*(_DWORD *)(*(_QWORD *)(v4 + 48) + 32LL) & 1) != 0 && *(_DWORD *)(v4 + 76) == 2 )
    memmove(*((void **)v2 + 8), *(const void **)(*((_QWORD *)v2 + 9) + 16LL), v11);
  result = v17;
LABEL_22:
