/*
 * XREFs of Endpoint_UcxEvtUsbDeviceEndpointAdd @ 0x1C005B850
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  LODWORD(v16[0]) = 96;
  ((void (__fastcall *)(_QWORD, __int64, _QWORD *))qword_1C004F8A8)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.32, a6, v16);
  v9 = 0LL;
