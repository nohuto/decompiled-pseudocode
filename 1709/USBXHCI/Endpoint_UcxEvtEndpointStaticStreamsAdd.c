/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsAdd @ 0x1C001C520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStaticStreamsAdd(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(v5 + 1336) )
    v6 = 2;
  LODWORD(v19[3]) = v6;
  v7 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64 *, _QWORD *, __int64 *))qword_1C004F8E0)(
  ...
  if ( v7 >= 0 )
  {
    ...
    *(_DWORD *)(v9 + 8) = v4;
    ...
    for ( i = v9 + 48; ; i += 104LL )
    {
      ...
      v18[0] = 24LL;
      v18[2] = v21;
      ((void (__fastcall *)(_QWORD, __int64, _QWORD *))qword_1C004F8D8)(
        *(_QWORD *)&WPP_MAIN_CB.DeviceQueue.32,
        v17,
        v18);
