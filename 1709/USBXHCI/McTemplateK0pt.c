/*
 * XREFs of McTemplateK0pt @ 0x1C0007998
 * Callers:
...
NTSTATUS McTemplateK0pt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 0;
  v9 = 4;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_CONTROLLER_WDF_POWER_REFERENCE_FOR_DEBUGGER, 0LL, 3u, &v4);
}
