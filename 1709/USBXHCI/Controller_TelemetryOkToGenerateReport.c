/*
 * XREFs of Controller_TelemetryOkToGenerateReport @ 0x1C0059314
 * Callers:
...
char __fastcall Controller_TelemetryOkToGenerateReport(_QWORD *a1, __int64 a2, int a3)
{
  ...
  {
    WPP_RECORDER_SF_L(a1[9], 4u, 4u, 0xD1u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, a3);
    goto LABEL_24;
  }
  v6 = a3 - 4109;
  if ( !v6 )
...
LABEL_14:
    ...
    if ( (int)(v10 + 0x80000000) >= 0 && v10 != -1073741772 )
    {
      ...
      LODWORD(v13) = v10;
LABEL_15:
      WPP_RECORDER_SF_d(a1[9], 3u, 4u, v9, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v13);
      goto LABEL_24;
    }
  }
  else
