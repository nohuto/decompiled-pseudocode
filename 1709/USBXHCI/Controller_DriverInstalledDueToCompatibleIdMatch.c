/*
 * XREFs of Controller_DriverInstalledDueToCompatibleIdMatch @ 0x1C0056F10
 * Callers:
...
char __fastcall Controller_DriverInstalledDueToCompatibleIdMatch(_QWORD *a1)
{
  ...
  else
  {
    ...
    WPP_RECORDER_SF_d(a1[9], 3u, 4u, 0x8Bu, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, Data);
  }
  return v2;
}
