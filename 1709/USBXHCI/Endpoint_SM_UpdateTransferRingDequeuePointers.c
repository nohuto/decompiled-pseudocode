/*
 * XREFs of Endpoint_SM_UpdateTransferRingDequeuePointers @ 0x1C001AF18
 * Callers:
 *     ESM_UpdatingTransferRingDequeuePointers @ 0x1C003F400 (ESM_UpdatingTransferRingDequeuePointers.c)
 * Callees:
