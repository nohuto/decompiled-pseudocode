/*
 * XREFs of WPP_RECORDER_SF_dDd @ 0x1C0021DFC
 * Callers:
...
__int64 WPP_RECORDER_SF_dDd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x400) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_f8b3066c4726396794ec16394522a5c0_Traceguids,
      201LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 201;
  return WppAutoLogTrace(a1, 3LL, 11LL, &WPP_f8b3066c4726396794ec16394522a5c0_Traceguids, v7, (__int64 *)va);
}
