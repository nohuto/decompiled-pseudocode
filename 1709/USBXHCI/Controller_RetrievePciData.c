/*
 * XREFs of Controller_RetrievePciData @ 0x1C0058670
 * Callers:
 ...
 *     Controller_PopulatePciDeviceInformation @ 0x1C005801C (Controller_PopulatePciDeviceInformation.c)
 */
...
__int64 __fastcall Controller_RetrievePciData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    LODWORD(v17) = v8;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x81u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v17);
  }
  ...
  if ( v9 >= 0 )
  {
    ...
    v12 = HIWORD(v21);
    LOWORD(v16) = 64;
    v13 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, GUID *, _QWORD *, int, _DWORD, _QWORD))(WdfFunctions_01015 + 1048))(
            WdfDriverGlobals,
            a1,
    ...
    if ( v13 >= 0 )
    {
      ...
      else
      {
        v10 = -1073741823;
        LODWORD(v19) = v14;
        WPP_RECORDER_SF_d(a2, 2u, 4u, 0x84u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v19);
      }
    }
    else
    {
      LODWORD(v19) = v13;
      WPP_RECORDER_SF_d(a2, 2u, 4u, 0x83u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v19);
    }
  }
  else
  {
    LODWORD(v18) = v9;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x82u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v18);
  }
  return v10;
}
