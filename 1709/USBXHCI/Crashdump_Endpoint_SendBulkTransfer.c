/*
 * XREFs of Crashdump_Endpoint_SendBulkTransfer @ 0x1C003BE40
 * Callers:
 *     Crashdump_DoBulkTransfer @ 0x1C00390DC (Crashdump_DoBulkTransfer.c)
 * Callees:
...
__int64 __fastcall Crashdump_Endpoint_SendBulkTransfer(__int64 a1, __int64 a2, _QWORD *a3, char a4)
{
  ...
  v10 = *(_DWORD *)(a2 + 36);
  v11 = 0;
  for ( *(_QWORD *)(a1 + 176) = a2; v10; v10 -= v12 )
  {
    v12 = 4096;
    ...
    *(_DWORD *)(v13 + 12) = v14 & 0xFFFFFFFE | (v11 != 0);
  ...
  *(_BYTE *)(v8 + 12) ^= 1u;
  ...
  if ( a4 )
  {
    v20 = *(_QWORD *)(a1 + 24);
    v21 = *(_DWORD *)(a1 + 32);
    *(_DWORD *)(*(_QWORD *)(**(_QWORD **)(v20 + 8) + 48LL) + 4LL * *(unsigned __int8 *)(v20 + 56)) = (unsigned __int8)v21 | ((*(_BYTE *)(a1 + 128) != 0) << 16);
    _InterlockedOr(v25, 0);
    DbgPrintEx(
      0x93u,
      3u,
