/*
 * XREFs of Controller_RetrieveUrsData @ 0x1C00588A8
 * Callers:
...
LABEL_3:
  ...
  v16 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 336))(WdfDriverGlobals, a1);
  v26 = v13;
  v25 = 1LL;
  v27 = 336LL;
  v15 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, __int64, _QWORD, __int64 *, _QWORD, _QWORD))(WdfFunctions_01015 + 1504))(
          WdfDriverGlobals,
          v16,
          0LL,
          2752516LL,
  ...
  if ( v15 >= 0 )
  {
    ...
    else
    {
      ...
      v21 = *((_DWORD *)v13 + 2);
      *a3 = 1;
      Controller_PopulatePciDeviceInformation(a2, v21, v20, v19, (_QWORD *)v13 + 2, v13 + 40, (__int64)a5, a6);
      *(_QWORD *)a4 = 0LL;
      *(_DWORD *)(a4 + 8) = 0;
      *(_WORD *)(a4 + 12) = 0;
      *(_BYTE *)(a4 + 14) = 0;
  ...
  {
    LODWORD(v24) = v15;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x87u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids, v24);
  }
  ExFreePoolWithTag(v13, 0x49434858u);
