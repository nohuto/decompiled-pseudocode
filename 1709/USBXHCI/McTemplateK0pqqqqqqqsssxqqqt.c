/*
 * XREFs of McTemplateK0pqqqqqqqsssxqqqt @ 0x1C0008290
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqqsssxqqqt(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  const char *v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // rax
  ...
  __int64 v52; // [rsp+190h] [rbp+90h] BYREF
  va_list va1; // [rsp+190h] [rbp+90h]
  __int64 v54; // [rsp+198h] [rbp+98h] BYREF
  ...
  __int64 v60; // [rsp+1B0h] [rbp+B0h] BYREF
  ...
  const char *v67; // [rsp+1D0h] [rbp+D0h]
  const char *v68; // [rsp+1D8h] [rbp+D8h]
  __int64 v69; // [rsp+1E0h] [rbp+E0h] BYREF
  ...
  v47 = 4LL;
  v49 = 4LL;
  return McGenEventWriteKM(v12, a2, a3, 0x11u, &v14);
}
