/*
 * XREFs of Endpoint_OnCancelSetDequeuePointerCompletion @ 0x1C00199A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_OnCancelSetDequeuePointerCompletion(__int64 a1, int a2, __int64 *a3)
{
  ...
  if ( *(_BYTE *)(a1 + 60) != 1 )
  {
    ...
    LOBYTE(v6) = 2;
    WPP_RECORDER_SF_dddL(*(_QWORD *)(v3 + 80), v6, *(unsigned __int8 *)(*(_QWORD *)(v3 + 16) + 135LL), 61);
...
LABEL_5:
  ...
  LOBYTE(v8) = 4;
  WPP_RECORDER_SF_dddL(*(_QWORD *)(v3 + 80), v8, *(unsigned __int8 *)(*(_QWORD *)(v3 + 16) + 135LL), 62);
  if ( *(_BYTE *)(v3 + 37) )
