/*
 * XREFs of XilDeviceSlot_CreateSecureObject @ 0x1C0016744
 * Callers:
...
__int64 __fastcall XilDeviceSlot_CreateSecureObject(_QWORD *a1)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v8 = v9;
      WPP_RECORDER_SF_d(v2[9], 2u, 0xAu, 0xBu, (__int64)&WPP_c9290fa77d4231816aaf940c56e9ce5a_Traceguids, v8);
      Debug_FreAssertMsg(
  ...
  {
    v7 = v4;
    WPP_RECORDER_SF_d(v2[9], 2u, 0xAu, 0xAu, (__int64)&WPP_c9290fa77d4231816aaf940c56e9ce5a_Traceguids, v7);
  }
  return v5;
}
