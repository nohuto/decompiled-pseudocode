/*
 * XREFs of WPP_RECORDER_SF_ddqq @ 0x1C00377E4
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqq(__int64 a1, _DWORD a2, _BYTE a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v7) = 64;
  return WppAutoLogTrace(a1, 5LL, 12LL, &WPP_a5fd15ff1a8637a5810b72c9190e663e_Traceguids, v7, (__int64 *)va);
}
