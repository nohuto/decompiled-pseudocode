/*
 * XREFs of Endpoint_SendClearStallTransfer @ 0x1C001AFAC
 * Callers:
...
__int64 __fastcall Endpoint_SendClearStallTransfer(_QWORD *Context)
{
  ...
  *(_BYTE *)(v8 - 69) = 0;
  v9 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD))(WdfFunctions_01015 + 248))(
                                  v7,
                                  *(_QWORD *)*Context);
  ...
  if ( v13 )
  {
    ...
    v19 = 3LL;
    v21 = v3;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, int *))(WdfFunctions_01015 + 1992))(
      WdfDriverGlobals,
      *(_QWORD *)(v15 + 144),
      &v18);
    ...
    result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64))(WdfFunctions_01015 + 2248))(
               WdfDriverGlobals,
               *(_QWORD *)(Context[33] + 144LL),
               v16);
    if ( (int)result < 0 )
