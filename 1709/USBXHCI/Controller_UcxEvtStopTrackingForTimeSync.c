/*
 * XREFs of Controller_UcxEvtStopTrackingForTimeSync @ 0x1C0013F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_UcxEvtStopTrackingForTimeSync(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( a4 < 8 )
  {
    WPP_RECORDER_SF_II(*(_QWORD *)(v9 + 72), v10, v11, 277);
    v14 = -1073741811;
    goto LABEL_3;
  }
  v14 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, unsigned __int64, __int64 **, _QWORD))(WdfFunctions_01015 + 2152))(
          WdfDriverGlobals,
          a2,
          a4,
          &v18,
  ...
  if ( v14 >= 0 )
  {
    if ( !*v18 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(v12 + 72), 2u, 4u, 0x116u, (__int64)&WPP_4b19db8c36bc33e5c568879992fcbff3_Traceguids);
LABEL_9:
      v14 = -1073741811;
      goto LABEL_3;
    }
    if ( v8 == 1 )
    {
      v7 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2216))(WdfDriverGlobals, a2);
      if ( v7 != *v18 )
      {
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_qq(
        ...
        if ( v17 < 0 )
        {
          WPP_RECORDER_SF_qd(
            *(_QWORD *)(v12 + 72),
            ...
            v17);
          if ( !v8 )
            (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1664))(WdfDriverGlobals, v7);
        }
      }
      else
      {
