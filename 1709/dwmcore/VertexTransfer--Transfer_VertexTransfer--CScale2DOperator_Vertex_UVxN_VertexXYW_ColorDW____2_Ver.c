/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801D7168
 * Callers:
        ...
        float *a2)
{
  ...
  for ( i = *(float *)(a1 + 44);
        v4 < v3;
        *(_DWORD *)(v9 + 12) = result | (((int)(float)BYTE1(v10) | (((int)(float)BYTE2(v10) | ((int)(float)((float)HIBYTE(v10) * i) << 8)) << 8)) << 8) )
  {
    ...
    *(_DWORD *)(v9 + 8) = 1065353216;
    v10 = *(_DWORD *)(v8 + 12);
    ++v4;
    result = (unsigned int)(int)(float)(unsigned __int8)v10;
  }
  return result;
}
