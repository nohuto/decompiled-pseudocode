/*
 * XREFs of ?OnNewContact@CManipulationContext@@QEAAJPEAVCInteractionChain@@IK_N@Z @ 0x1801A2630
 * Callers:
        ...
        bool a5)
{
  ...
  if ( !v12 )
  {
    ...
    NtDCompositionUpdatePointerCapture(*(unsigned int *)(*((_QWORD *)a2 + 1) + 212LL), a3);
    if ( !*((_QWORD *)this + 7) )
    ...
    *((_BYTE *)this + 28) = *((_BYTE *)this + 28) & 0xF7 | (8
                                                          * CManipulationContext::CheckForSingleTarget(
                                                              *((const struct CInteraction **)this + 7),
                                                              (const struct InputSinkAndEndpoints *)(*((_QWORD *)this + 7) + 64LL)));
  }
  v14 = a5;
  if ( !a5 || (*((_BYTE *)this + 28) & 1) != 0 )
  {
    for ( i = (_QWORD *)*((_QWORD *)a2 + 1); i; i = (_QWORD *)i[30] )
    {
      LOBYTE(v10) = !v14;
