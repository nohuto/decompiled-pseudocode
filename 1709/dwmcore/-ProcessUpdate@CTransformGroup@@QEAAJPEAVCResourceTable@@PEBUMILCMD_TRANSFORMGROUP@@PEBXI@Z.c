/*
 * XREFs of ?ProcessUpdate@CTransformGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TRANSFORMGROUP@@PEBXI@Z @ 0x1800B44B8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( !HIDWORD(v8) )
  {
    ...
    v10 = CResource::UnmarshalResourceArray(&v30, &a5, (unsigned int)v8, 127LL);
    v11 = v31;
    v12 = v10;
    *((_QWORD *)this + 23) = v31;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0xAF7u);
LABEL_40:
      CTransform3DGroup::UnRegisterNotifiers(this);
      goto LABEL_8;
    }
    ...
    v12 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0xB76u);
    if ( v12 < 0 )
    {
      v25 = 2810;
LABEL_39:
  ...
  if ( v16.m128i_i32[1] )
  {
    v18 = CResource::UnmarshalResourceArray(&v28, &v27, (unsigned int)_mm_cvtsi128_si32(v16), 127LL);
...
LABEL_31:
      ...
      {
        v12 = -2147024362;
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070216, 0xB30u);
LABEL_34:
        if ( v19 )
      ...
      if ( v18 >= 0 )
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0xB3Au);
        }
        else
        {
          v23 = *((_DWORD *)this + 44);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, v26);
    goto LABEL_31;
  }
LABEL_7:
  if ( v12 < 0 )
