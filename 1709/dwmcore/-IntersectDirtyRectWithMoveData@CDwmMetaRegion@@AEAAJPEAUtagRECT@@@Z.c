/*
 * XREFs of ?IntersectDirtyRectWithMoveData@CDwmMetaRegion@@AEAAJPEAUtagRECT@@@Z @ 0x18014FD50
 * Callers:
...
__int64 __fastcall CDwmMetaRegion::IntersectDirtyRectWithMoveData(CDwmMetaRegion *this, struct tagRECT *a2)
{
  ...
  if ( !RectRgn )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v2, 0x171u);
    goto LABEL_36;
  }
  SetLastError(0);
  ...
  if ( !v3 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v2, 0x176u);
    goto LABEL_36;
  }
  SetLastError(0);
  ...
  if ( !v4 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v2, 0x178u);
    goto LABEL_36;
  }
  SetLastError(0);
  if ( !CombineRgn(v4, v4, *((HRGN *)this + 3), 2) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v2, 0x17Cu);
    goto LABEL_36;
  }
  ...
  if ( !v24 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v2, 0x182u);
    goto LABEL_36;
  }
  if ( v24 != 1 )
  {
