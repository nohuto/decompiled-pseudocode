/*
 * XREFs of ?SetStereoContext@CHwStereoFullScreenRenderTarget@@UEAAJW4StereoContext@@@Z @ 0x1801B8320
 * Callers:
...
LABEL_7:
    v2 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070057, 0x169u);
    return v2;
  }
  v3 = *(_QWORD *)(a1 + 24);
LABEL_6:
