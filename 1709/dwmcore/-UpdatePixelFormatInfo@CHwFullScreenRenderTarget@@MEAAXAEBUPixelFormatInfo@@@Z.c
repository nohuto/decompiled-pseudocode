/*
 * XREFs of ?UpdatePixelFormatInfo@CHwFullScreenRenderTarget@@MEAAXAEBUPixelFormatInfo@@@Z @ 0x1801B8CA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CHwFullScreenRenderTarget::UpdatePixelFormatInfo(CD3DSurface **this, const struct PixelFormatInfo *a2)
{
  ...
  {
    (*((void (__fastcall **)(CD3DSurface **, _QWORD, _QWORD, CD3DSurface **))*this + 29))(this, 0LL, 0LL, &v6);
