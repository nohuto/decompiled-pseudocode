/*
 * XREFs of ?RectangleGeometrySetRectangle@CChannel@@UEAAJIMMMMMMMMMMMMH@Z @ 0x18000CE10
 * Callers:
 *     <none>
 * Callees:
        ...
        int a15)
{
  ...
  char *v29; // [rsp+A8h] [rbp+17h] BYREF
  ...
  *(float *)&v28[8] = a14;
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x745u);
  }
  else
  {
    v24 = 290;
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x74Du);
    }
    else
    {
      v24 = 293;
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x755u);
      }
      else
      {
        v24 = 292;
        ...
        if ( v21 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x75Du);
        }
        else
        {
          v24 = 289;
          ...
          v18 = v22;
          if ( v22 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x765u);
        }
      }
    }
  }
