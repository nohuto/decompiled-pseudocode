/*
 * XREFs of ?ProcessStartPointUpdate@CInk@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INK_STARTPOINTUPDATE@@@Z @ 0x180168F1C
 * Callers:
        ...
        const struct MILCMD_INK_STARTPOINTUPDATE *a3)
{
  ...
  *((_DWORD *)this + 43) = *((_DWORD *)a3 + 3);
  if ( v3 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ID2D1InkAndInkStyle, 0x72u);
  }
  else
  {
LABEL_5:
