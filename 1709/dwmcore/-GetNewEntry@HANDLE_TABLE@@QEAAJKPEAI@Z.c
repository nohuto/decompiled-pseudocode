/*
 * XREFs of ?GetNewEntry@HANDLE_TABLE@@QEAAJKPEAI@Z @ 0x180010248
 * Callers:
...
__int64 __fastcall HANDLE_TABLE::GetNewEntry(HANDLE_TABLE *this, int a2, unsigned int *a3)
{
  ...
  if ( *((_DWORD *)this + 3) >= 0x400u || (v13 = HANDLE_TABLE::Resize(this, 0x400u), v4 = v13, v13 >= 0) )
  {
    ...
    *((_DWORD *)this + 4) = v10;
    if ( !v7 )
    {
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x156u);
        return v4;
      }
      v7 = v9;
      *((_DWORD *)this + 4) = v9 + 1;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x120u);
  }
  return v4;
}
