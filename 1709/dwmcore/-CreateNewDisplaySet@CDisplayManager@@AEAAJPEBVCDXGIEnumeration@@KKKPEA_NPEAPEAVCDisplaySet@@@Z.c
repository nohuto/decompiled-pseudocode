/*
 * XREFs of ?CreateNewDisplaySet@CDisplayManager@@AEAAJPEBVCDXGIEnumeration@@KKKPEA_NPEAPEAVCDisplaySet@@@Z @ 0x180010940
 * Callers:
 ...
 *     ?ComputeDisplayBounds@CDisplaySet@@AEAAXXZ @ 0x1800985D0 (-ComputeDisplayBounds@CDisplaySet@@AEAAXXZ.c)
        ...
        struct CDisplaySet **a7)
{
  ...
  *a6 = 0;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202568, 2u, v14, 0x26Du);
  }
  else
  {
    ...
    if ( !v8 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202568, 2u, -2147024882, 0x274u);
      goto LABEL_18;
    }
    *((_QWORD *)v8 + 2) = a2;
    if ( a2 )
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202590, 1u, v16, 0xBEu);
    }
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202590, 1u, v17, 0xC0u);
      }
      else
      {
        ...
        v14 = v18;
        if ( v18 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202590, 1u, v18, 0xC4u);
      }
    }
    LODWORD(v21) = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180202568, 2u, v14, 0x27Fu);
    }
    else
    {
