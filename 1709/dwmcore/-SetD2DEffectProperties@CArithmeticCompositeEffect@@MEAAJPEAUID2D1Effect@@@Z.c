/*
 * XREFs of ?SetD2DEffectProperties@CArithmeticCompositeEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180180270
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Effect *a2)
{
  ...
  else
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x14u);
  }
  return v5;
}
