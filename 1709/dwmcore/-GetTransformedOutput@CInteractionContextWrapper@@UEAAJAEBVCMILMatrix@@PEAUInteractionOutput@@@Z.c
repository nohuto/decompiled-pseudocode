/*
 * XREFs of ?GetTransformedOutput@CInteractionContextWrapper@@UEAAJAEBVCMILMatrix@@PEAUInteractionOutput@@@Z @ 0x18019E640
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)a3 + 14) = *((_DWORD *)v3 + 14);
    if ( dword_18026D7B0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
      {
        ...
        v36 = v12;
        v38 = v12;
        TlgWrite(v10, &unk_180215CE3, v11, v7, 0xDu, &pData);
        LODWORD(v7) = v14;
      }
    }
  }
