/*
 * XREFs of ?CreateTileBrushIntermediate@CTileBrushUtils@@SAJPEBULegacyMilBrushContext@@PEBVCMILMatrix@@1PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4Enum@MilTileMode@@PEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@PEAV3@PEAHPEAW4XSpaceDefinition@@@Z @ 0x180187934
 * Callers:
        ...
        _DWORD *a10)
{
  ...
  if ( v10 )
  {
    ...
    v13 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x1FEu);
    else
      *a10 = 0;
  }
  else
  {
    ...
    v13 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x20Du);
    else
      *a10 = 1;
  }
  return v13;
