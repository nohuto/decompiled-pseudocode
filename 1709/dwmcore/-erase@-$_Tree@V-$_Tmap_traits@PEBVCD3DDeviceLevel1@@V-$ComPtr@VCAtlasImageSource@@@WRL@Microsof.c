...
__int64 *__fastcall std::_Tree<std::_Tmap_traits<CD3DDeviceLevel1 const *,Microsoft::WRL::ComPtr<CAtlasImageSource>,std::less<CD3DDeviceLevel1 const *>,std::allocator<std::pair<CD3DDeviceLevel1 const * const,Microsoft::WRL::ComPtr<CAtlasImageSource>>>,0>>::erase(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3)
{
...
LABEL_67:
  ...
  Microsoft::WRL::ComPtr<CAtlasImageSource>::InternalRelease((CGdiSpriteBitmap **)v6 + 5);
