/*
 * XREFs of ?ProcessAppend@CGeometryGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GEOMETRYGROUP@@PEBXI@Z @ 0x18017A320
 * Callers:
...
LABEL_22:
  ...
  if ( v14 + v22 >= v14 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x37Bu);
      }
      else
      {
        v16 = *((_DWORD *)this + 32);
        if ( v16 )
          memcpy_0(v7, this[17], 8LL * v16);
        memcpy_0(&v7[8 * *((unsigned int *)this + 32)], v12, 8 * v13);
        v17 = (void *)this[17];
        if ( v17 )
  ...
  v6 = -2147024362;
  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070216, 0x371u);
LABEL_25:
  if ( v12 )
    WPF::ProcessHeapImpl::Free(v12);
  if ( v7 )
