/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_RgbaSwapChains@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1801913FC
 * Callers:
        ...
        __int64 a3)
{
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0xB3D7A1, a2, a3);
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(11786145, 0, &v12) )
    {
      if ( v3 )
      {
        v10 = v6;
