/*
 * XREFs of ?ProcessSetCameraId@CHolographicDisplay@@QEAAJPEAVCResourceTable@@PEBUMILCMD_HOLOGRAPHICDISPLAY_SETCAMERAID@@@Z @ 0x1801BD2B0
 * Callers:
        ...
        const struct MILCMD_HOLOGRAPHICDISPLAY_SETCAMERAID *a3)
{
  ...
  *(_OWORD *)((char *)this + 104) = *(_OWORD *)((char *)a3 + 8);
  v6 = *((_QWORD *)this + 13) - *(_QWORD *)&DirectX::g_XMZero.Data1;
  if ( !v6 )
    v6 = *((_QWORD *)this + 14) - *(_QWORD *)DirectX::g_XMZero.Data4;
  if ( v6 )
    *((_DWORD *)this + 19) |= 4u;
  else
    *((_DWORD *)this + 19) &= ~4u;
