/*
 * XREFs of ?CreateWellFormedGradientArray@CGradientTextureGenerator@@CAXPEBVCGradientSpanInfo@@PEAV?$DynArray@UMILGradientStop@@$0A@@@W4Enum@MilColorInterpolationMode@@_NPEAU_D3DCOLORVALUE@@4@Z @ 0x1801D9C2C
 * Callers:
 ...
 * Callees:
 *     ??$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z @ 0x1801D8DE8 (--$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z.c)
 ...
 *     ?SetLastStop@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@IIPEAU_D3DCOLORVALUE@@@Z @ 0x1801DA230 (-SetLastStop@CGradientTextureGenerator@@CAXPEAV-$DynArray@UMILGradientStop@@$0A@@@IIPEAU_D3DCOLO.c)
