/*
 * XREFs of ??0CHwTextureRenderTarget@@IEAA@VDisplayId@@@Z @ 0x1800901A0
 * Callers:
 ...
 *     ??0CScratchRenderTargetBitmap@@IEAA@VDisplayId@@@Z @ 0x18008D2B0 (--0CScratchRenderTargetBitmap@@IEAA@VDisplayId@@@Z.c)
...
__int64 __fastcall CHwTextureRenderTarget::CHwTextureRenderTarget(__int64 a1, int a2)
{
  __int64 v2; // r10

  CHwSurfaceRenderTarget::CHwSurfaceRenderTarget(a1, a2);
  *(_QWORD *)v2 = &CHwTextureRenderTarget::`vftable'{for `CBaseRenderTarget'};
  *(_QWORD *)(v2 + 144) = &CHwTextureRenderTarget::`vftable'{for `CMILCOMBase'};
  *(_QWORD *)(v2 + 192) = &CHwTextureRenderTarget::`vftable'{for `IRenderTargetBitmap'};
  *(_QWORD *)(v2 + 200) = &CHwTextureRenderTarget::`vftable'{for `ID2DBitmap'};
  *(_QWORD *)(v2 + 208) = &CHwTextureRenderTarget::`vftable'{for `ID2DBitmapCacheSource'};
  *(_QWORD *)(v2 + 216) = &CHwTextureRenderTarget::`vftable'{for `IDeviceResource'};
  *(_QWORD *)(v2 + 224) = 0LL;
  *(_QWORD *)(v2 + 248) = 0LL;
  *(_QWORD *)(v2 + 256) = 0LL;
  *(_DWORD *)(v2 + 232) = 0;
