/*
 * XREFs of ?Transform3DGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x180123400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( v8 > 0xFFFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0xAF4u);
  }
  else
  {
    si128.m128i_i32[3] = 0;
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0xAF6u);
    }
    else
    {
