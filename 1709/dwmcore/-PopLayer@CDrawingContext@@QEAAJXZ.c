/*
 * XREFs of ?PopLayer@CDrawingContext@@QEAAJXZ @ 0x18003B6EC
 * Callers:
...
__int64 __fastcall CDrawingContext::PopLayer(CDrawingContext *this)
{
  ...
  if ( (_DWORD)v6 == 5 )
  {
    ...
    v2 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x1746u);
  }
  else if ( (_DWORD)v6 != 6 )
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x174Eu);
  }
  return v2;
}
