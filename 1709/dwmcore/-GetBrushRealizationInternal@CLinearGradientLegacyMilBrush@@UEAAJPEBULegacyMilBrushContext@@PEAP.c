/*
 * XREFs of ?GetBrushRealizationInternal@CLinearGradientLegacyMilBrush@@UEAAJPEBULegacyMilBrushContext@@PEAPEAVCMILBrush@@@Z @ 0x180181980
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILBrush **a3)
{
  ...
  int v8; // edi
  signed int LinearGradientRealization; // eax
  __int64 v10; // rax
  signed int v11; // eax
  __int128 v12; // xmm0
  ...
  if ( GradientColor < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, GradientColor, 0x41u);
  }
  else
  {
    if ( v17 < 2 )
    ...
    else
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, LinearGradientRealization, 0x48u);
        goto LABEL_15;
      }
       ...
       || *a3 == (struct CMILBrush *)(((unsigned __int64)this + 432) & -(__int64)((CLinearGradientLegacyMilBrush *)((char *)this + 408) != 0LL))) )
    {
      ...
      if ( v11 >= 0 )
        goto LABEL_16;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x6Cu);
    }
  }
LABEL_15:
  if ( v8 < 0 )
