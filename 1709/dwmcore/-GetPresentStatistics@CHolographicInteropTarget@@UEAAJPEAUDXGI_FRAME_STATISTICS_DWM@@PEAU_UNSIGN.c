/*
 * XREFs of ?GetPresentStatistics@CHolographicInteropTarget@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@PEAU_UNSIGNED_RATIO@@@Z @ 0x1801C1760
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _UNSIGNED_RATIO *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x10Eu);
  }
  else
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8898008D, 0x112u);
  }
