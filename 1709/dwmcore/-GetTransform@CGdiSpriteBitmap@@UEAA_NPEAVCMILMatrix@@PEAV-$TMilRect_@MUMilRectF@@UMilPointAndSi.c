/*
 * XREFs of ?GetTransform@CGdiSpriteBitmap@@UEAA_NPEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18009D300
 * Callers:
  ...
  *(_OWORD *)(a2 + 48) = _xmm;
  if ( a3 )
  {
    ...
    *a3 = v3;
    v4 = (float)a1[13];
    a3[1] = v4;
    a3[2] = fmaxf(v3, (float)(a1[76] - a1[12]));
    a3[3] = fmaxf(v4, (float)(a1[77] - a1[14]));
  }
  return 0;
}
