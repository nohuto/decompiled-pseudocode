/*
 * XREFs of ?UpdateValueWithChaining@CScrollAnimation@@IEAAMMMW4Boundary@@@Z @ 0x180189554
 * Callers:
 ...
 *     ?UpdateChainingDirection@CScrollAnimation@@AEAAXM@Z @ 0x1801894B4 (-UpdateChainingDirection@CScrollAnimation@@AEAAXM@Z.c)
 *     ?ChainToParent@CChainingHelper@@QEAAXPEAVCInteraction@@W4ScrollAxis@@W4Boundary@@_N@Z @ 0x180192520 (-ChainToParent@CChainingHelper@@QEAAXPEAVCInteraction@@W4ScrollAxis@@W4Boundary@@_N@Z.c)
...
void __fastcall CScrollAnimation::UpdateValueWithChaining(__int64 a1, float a2, float a3, unsigned int a4)
{
  ...
  unsigned __int32 v87; // [rsp+1B8h] [rbp+B8h] BYREF
  float v88; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  if ( v9 )
    v10 = *(_DWORD *)(v9 + 400);
  ShouldChainForAxis = CInteractionTracker::ShouldChainForAxis(v8, *(_DWORD *)(a1 + 276));
  if ( dword_18026D7B0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
  {
    ...
    v57 = v14 & 1;
    v86 = v16;
    TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_18021458F, v17, v18, 0x10u, &v59);
  }
  if ( (*(_BYTE *)(a1 + 388) & 2) == 0 && v10 == 2 )
  {
    LOBYTE(pData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
    LOBYTE(cData) = ShouldChainForAxis;
    CChainingHelper::RestoreSupportedInteractionsWithBoundaries(v19 + 340, v21, v20, a4, cData, pData);
    v22 = *(_QWORD *)(a1 + 280);
    if ( v22 )
      v23 = *(_QWORD *)(v22 + 8);
    else
      v23 = 0LL;
    v24 = 3LL * *(int *)(a1 + 276);
    *(_BYTE *)(v23 + 4 * v24 + 340) &= ~4u;
    *(_DWORD *)(v23 + 4 * v24 + 348) = 0;
    *(_BYTE *)(v23 + 376) |= 2u;
    *(_BYTE *)(a1 + 388) |= 2u;
  }
  v25 = *(_DWORD *)(a1 + 368);
  ...
  if ( v26 )
  {
    if ( v26 != 1 )
      goto LABEL_52;
    if ( *(_DWORD *)(a1 + 372) && ShouldChainForAxis )
    {
      if ( v10 != 2 )
        goto LABEL_52;
      LOBYTE(pData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
      LOBYTE(cData) = ShouldChainForAxis;
      CChainingHelper::RestoreSupportedInteractionsWithBoundaries(v27 + 340, v29, v28, a4, cData, pData);
      goto LABEL_51;
    }
    if ( v10 != 2 )
      goto LABEL_52;
...
LABEL_51:
  ...
  if ( !v30 || !ShouldChainForAxis )
  {
    ...
    {
      LOBYTE(cData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
      CChainingHelper::ChainToParent(v41 + 340, v43, v42, a4, cData);
    }
      ...
      if ( v44 != 0.0 )
      {
        ...
        if ( (float)(v45 > 0.0) != (float)(v44 > 0.0) && v45 != 0.0 )
        {
          ...
          if ( v46 )
            ...
            v47 = 0LL;
          v48 = 3LL * *(int *)(a1 + 276);
          *(_BYTE *)(v47 + 4 * v48 + 340) &= ~4u;
          *(_DWORD *)(v47 + 4 * v48 + 348) = 0;
          *(_BYTE *)(v47 + 376) |= 2u;
          *(_DWORD *)(a1 + 384) = 0;
        }
      }
...
LABEL_52:
  ...
  if ( ((v30 - 1) & 0xFFFFFFFD) == 0 && a4 == v30 && (float)((float)(v88 - *(float *)(a1 + 376)) > 0.0) < 0.0 )
  {
    LOBYTE(cData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
    CChainingHelper::ChainToParent(v31 + 340, v33, v32, a4, cData);
  }
  v34 = *(_DWORD *)(a1 + 372);
  if ( (unsigned int)(v34 - 2) <= 1 && a4 == v34 && (float)((float)(v88 - *(float *)(a1 + 376)) > 0.0) > 0.0 )
  {
    LOBYTE(cData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
    CChainingHelper::ChainToParent(v35 + 340, v37, v36, a4, cData);
  }
  if ( a4 )
  {
LABEL_53:
  ...
  LOBYTE(pData) = CInteractionTracker::ShouldChainAllForAxis(v8, *(unsigned int *)(a1 + 276));
  LOBYTE(cData) = ShouldChainForAxis;
  CChainingHelper::RestoreSupportedInteractionsWithBoundaries(v5 + 340, v40, v39, 0LL, cData, pData);
LABEL_55:
  *(float *)(a1 + 380) = v88;
  *(_DWORD *)(a1 + 372) = a4;
  *(_DWORD *)(a1 + 368) = v10;
