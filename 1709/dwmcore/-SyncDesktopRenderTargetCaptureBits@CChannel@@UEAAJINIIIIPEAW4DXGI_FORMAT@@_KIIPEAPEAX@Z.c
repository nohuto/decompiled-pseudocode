/*
 * XREFs of ?SyncDesktopRenderTargetCaptureBits@CChannel@@UEAAJINIIIIPEAW4DXGI_FORMAT@@_KIIPEAPEAX@Z @ 0x18000CD20
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a12)
{
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x7DAu);
  }
  else
  {
    v17 = v24;
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x7DCu);
    }
    else
    {
      v18 = a12;
