/*
 * XREFs of ?ProcessSetTransform@CSurfaceBrush@@QEAAJPEAVCResourceTable@@PEBUMILCMD_SURFACEBRUSH_SETTRANSFORM@@@Z @ 0x180025DE0
 * Callers:
        ...
        const struct MILCMD_SURFACEBRUSH_SETTRANSFORM *a3)
{
  ...
  if ( ResourceWithoutType != this[14] )
  {
    if ( ResourceWithoutType )
    {
      ...
      {
        v4 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0xEBu);
        return v4;
      }
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0xEEu);
        return v4;
      }
