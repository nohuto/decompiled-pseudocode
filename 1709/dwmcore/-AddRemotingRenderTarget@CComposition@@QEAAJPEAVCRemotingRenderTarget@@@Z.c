/*
 * XREFs of ?AddRemotingRenderTarget@CComposition@@QEAAJPEAVCRemotingRenderTarget@@@Z @ 0x180127AC4
 * Callers:
...
__int64 __fastcall CComposition::AddRemotingRenderTarget(CComposition *this, struct CRemotingRenderTarget *a2)
{
  ...
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x10CDu);
