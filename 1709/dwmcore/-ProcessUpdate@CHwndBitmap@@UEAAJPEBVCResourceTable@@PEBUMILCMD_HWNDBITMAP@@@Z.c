/*
 * XREFs of ?ProcessUpdate@CHwndBitmap@@UEAAJPEBVCResourceTable@@PEBUMILCMD_HWNDBITMAP@@@Z @ 0x1801680B0
 * Callers:
        ...
        const struct MILCMD_HWNDBITMAP *a3)
{
  ...
  {
    v6 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x88980403, 0x1BAu);
  }
  else
  {
    *((_QWORD *)this + 12) = v3;
    ...
    *((_BYTE *)this + 120) = 1;
    ...
    v6 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x1B6u);
  }
  return v6;
}
