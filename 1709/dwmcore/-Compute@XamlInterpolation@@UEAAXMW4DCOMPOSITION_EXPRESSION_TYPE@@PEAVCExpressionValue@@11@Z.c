/*
 * XREFs of ?Compute@XamlInterpolation@@UEAAXMW4DCOMPOSITION_EXPRESSION_TYPE@@PEAVCExpressionValue@@11@Z @ 0x1800B9680
 * Callers:
 ...
 * Callees:
 *     ?EvaluateCurve@XamlPowerInterpolation@@MEAANN@Z @ 0x1800B9720 (-EvaluateCurve@XamlPowerInterpolation@@MEAANN@Z.c)
