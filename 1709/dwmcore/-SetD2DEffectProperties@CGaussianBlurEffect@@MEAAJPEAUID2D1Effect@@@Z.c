/*
 * XREFs of ?SetD2DEffectProperties@CGaussianBlurEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180180AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGaussianBlurEffect::SetD2DEffectProperties(CGaussianBlurEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0x13u);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x18u);
    }
    else
    {
