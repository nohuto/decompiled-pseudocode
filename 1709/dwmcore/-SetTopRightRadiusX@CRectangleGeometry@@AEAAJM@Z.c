/*
 * XREFs of ?SetTopRightRadiusX@CRectangleGeometry@@AEAAJM@Z @ 0x180058820
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetTopRightRadiusX(CRectangleGeometry *this, float a2)
{
  unsigned int v2; // ebx
  int v5; // eax
  ...
  if ( *((float *)this + 32) != a2 )
  {
    *((float *)this + 32) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 7u, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x211u);
    else
