/*
 * XREFs of ?GetTextureBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@UBaseSampling@CoordinateSpace@@@@@Z @ 0x180180F50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (((unsigned __int8)v2 ^ ((unsigned __int8)v2 ^ (unsigned __int8)(v2 + 2)) & 6) & 6) == 2 )
  {
    if ( (*(_BYTE *)(a1 + 152) & 1) != 0 )
    {
      ...
      for ( i = 0uLL; (unsigned int)v5 < *(_DWORD *)(a1 + 96); v5 = (unsigned int)(v5 + 1) )
      {
        ...
        if ( v6 )
        {
          (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v6 + 176LL))(v6, v10);
