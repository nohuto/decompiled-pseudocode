/*
 * XREFs of ?NotifyVisualPropertyChange@CManipulationManager@@QEAAJPEAVCVisual@@PEBVCMILMatrix@@@Z @ 0x1801968BC
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  v3 = *((_QWORD *)this + 2);
  v7 = 0;
  if ( GetCurrentThreadId() == *(_DWORD *)(v3 + 560) )
  {
    ...
    {
      *((_OWORD *)InteractionInternal + 9) = *(_OWORD *)a3;
      *((_OWORD *)InteractionInternal + 10) = *((_OWORD *)a3 + 1);
      *((_OWORD *)InteractionInternal + 11) = *((_OWORD *)a3 + 2);
      *((_OWORD *)InteractionInternal + 12) = *((_OWORD *)a3 + 3);
      *((_DWORD *)InteractionInternal + 52) = *((_DWORD *)a3 + 16);
    }
  }
  else
  {
