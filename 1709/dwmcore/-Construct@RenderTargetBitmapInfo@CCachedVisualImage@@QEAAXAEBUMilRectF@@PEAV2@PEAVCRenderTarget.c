/*
 * XREFs of ?Construct@RenderTargetBitmapInfo@CCachedVisualImage@@QEAAXAEBUMilRectF@@PEAV2@PEAVCRenderTargetBitmap@@W4Enum@MilStretch@@@Z @ 0x18008AF34
 * Callers:
        ...
        int a5)
{
  ...
  *(_DWORD *)(a1 + 40) = a5;
  v11 = v8;
  *(_OWORD *)(a1 + 24) = v8;
  return ReleaseInterfaceNoNULL<CManipulationManager>(v5);
}
