/*
 * XREFs of ??0CD3DDeviceLevel1@@AEAA@PEAVIMILPoolManager@@@Z @ 0x180021390
 * Callers:
...
CD3DDeviceLevel1 *__fastcall CD3DDeviceLevel1::CD3DDeviceLevel1(CD3DDeviceLevel1 *this, struct IMILPoolManager *a2)
{
  ...
  *((_BYTE *)this + 1043) = 1;
  `vector constructor iterator'(
    (CD3DDeviceLevel1 *)((char *)this + 1048),
    8LL,
    8LL,
  ...
  *((_QWORD *)this + 145) = 0LL;
  `vector constructor iterator'(
    (CD3DDeviceLevel1 *)((char *)this + 1168),
    8LL,
    4LL,
    (__int64 (__fastcall *)(CInputSinkStruct::InputQueueInfo *__hidden))Microsoft::WRL::ComPtr<ID3D11DepthStencilState>::ComPtr<ID3D11DepthStencilState>);
  `vector constructor iterator'(
    (CD3DDeviceLevel1 *)((char *)this + 1200),
    8LL,
    24LL,
    (__int64 (__fastcall *)(CInputSinkStruct::InputQueueInfo *__hidden))Microsoft::WRL::ComPtr<ID3D11DepthStencilState>::ComPtr<ID3D11DepthStencilState>);
  `vector constructor iterator'(
    (CD3DDeviceLevel1 *)((char *)this + 1392),
    8LL,
    48LL,
    (__int64 (__fastcall *)(CInputSinkStruct::InputQueueInfo *__hidden))Microsoft::WRL::ComPtr<ID3D11DepthStencilState>::ComPtr<ID3D11DepthStencilState>);
  `vector constructor iterator'(
    (CD3DDeviceLevel1 *)((char *)this + 1776),
    8LL,
    1LL,
    (__int64 (__fastcall *)(CInputSinkStruct::InputQueueInfo *__hidden))Microsoft::WRL::ComPtr<ID3D11DepthStencilState>::ComPtr<ID3D11DepthStencilState>);
  `vector constructor iterator'(
