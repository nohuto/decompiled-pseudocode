/*
 * XREFs of ?SendInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAXXZ @ 0x18012C37C
 * Callers:
...
void __fastcall CTelemetryTouchLatencyAnalysis::SendInteractionSummary(CTelemetryTouchLatencyAnalysis *this)
{
  ...
  v1 = (unsigned __int16 *)((char *)this + 1968);
  if ( *((_WORD *)this + 984) )
  {
    v20 = 0;
    v21 = 0;
    ...
    v3 = *v1;
    v4 = *((_DWORD *)this + 500) - v3;
    if ( v4 )
    {
      v5 = *((_DWORD *)this + 531) / v4;
      v20 = v5;
      if ( v5 >= 0xFFFF )
        v20 = -1;
      v6 = *((_DWORD *)this + 532) / v4;
      v21 = v6;
      if ( v6 >= 0xFFFF )
        v21 = -1;
      v7 = *((_DWORD *)this + 533) / v4;
      v22 = v7;
      if ( v7 >= 0xFFFF )
        v22 = -1;
      v8 = *((_DWORD *)this + 534) / v4;
      v23 = v8;
      if ( v8 >= 0xFFFF )
        v23 = -1;
      v9 = *((_DWORD *)this + 535) / v4;
      v24 = v9;
      if ( v9 >= 0xFFFF )
        v24 = -1;
    }
    ...
    if ( (_WORD)v3 )
    {
      v10 = *((_DWORD *)this + 539) / v3;
      v25 = v10;
      if ( v10 >= 0xFFFF )
        v25 = -1;
      v11 = *((_DWORD *)this + 540) / v3;
      v26 = v11;
      if ( v11 >= 0xFFFF )
        v26 = -1;
      v12 = *((_DWORD *)this + 541) / v3;
      v27 = v12;
      if ( v12 >= 0xFFFF )
        v27 = -1;
      v13 = *((_DWORD *)this + 542) / v3;
      v28 = v13;
      if ( v13 >= 0xFFFF )
        v28 = -1;
      v14 = *((_DWORD *)this + 543) / v3;
      v29 = v14;
      if ( v14 >= 0xFFFF )
        v29 = -1;
    }
    ConvertTelemetryInteractionTypeToString(*((_DWORD *)this + 491));
    if ( dword_18026D7F0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7F0, 0x400000000002uLL) )
      {
        TlgCreateWsz(&pDesc, *((LPCWSTR *)this + 242));
        TlgCreateWsz(&v36, *((LPCWSTR *)this + 243));
        v38 = 4LL;
        v41 = (char *)this + 1970;
        v37 = (char *)this + 1952;
        v43 = (char *)this + 1972;
        ...
        v136 = &v32;
        v137 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7F0, &unk_1802119EB, v18, v19, 0x37u, &pData);
      }
    }
  }
}
