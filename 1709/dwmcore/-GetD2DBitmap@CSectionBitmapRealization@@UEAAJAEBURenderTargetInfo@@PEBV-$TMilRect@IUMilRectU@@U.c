/*
 * XREFs of ?GetD2DBitmap@CSectionBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x1801D0E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSectionBitmapRealization::GetD2DBitmap(__int64 a1, __int64 a2, __m128i *a3, char a4, _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021CB28, 1u, v9, 0xBCu);
  }
  else if ( *(_QWORD *)(a1 + 288) )
  {
    ...
    v10 = Bitmap;
    if ( Bitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021CB28, 1u, Bitmap, 0xC5u);
  }
  else
  {
