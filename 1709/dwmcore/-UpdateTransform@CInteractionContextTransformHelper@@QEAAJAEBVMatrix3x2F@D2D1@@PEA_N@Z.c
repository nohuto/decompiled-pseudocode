/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x1801CE210
 * Callers:
 ...
 *     GetInverse @ 0x1801CD570 (GetInverse.c)
 *     IsEqualMatrix @ 0x1801CD6F0 (IsEqualMatrix.c)
 */
