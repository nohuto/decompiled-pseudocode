/*
 * XREFs of ?CreateForControlledVisual@CCoRenderVisualProxy@@SAJPEAXPEAPEAV1@@Z @ 0x180129524
 * Callers:
        ...
        struct CCoRenderVisualProxy **a2)
{
  ...
  {
    v4 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x47u);
  }
  return v4;
}
