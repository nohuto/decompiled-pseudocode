/*
 * XREFs of ?AddBlockData@CDataStreamWriter@@QEAAJPEBXI@Z @ 0x18000F908
 * Callers:
 ...
 *     ?GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ @ 0x18000FD60 (-GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ.c)
