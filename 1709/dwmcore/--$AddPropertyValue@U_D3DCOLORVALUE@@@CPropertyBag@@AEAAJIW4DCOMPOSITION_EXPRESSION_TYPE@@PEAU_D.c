/*
 * XREFs of ??$AddPropertyValue@U_D3DCOLORVALUE@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAU_D3DCOLORVALUE@@@Z @ 0x1800A5F10
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<_D3DCOLORVALUE>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  DWORD v4; // edi
  _QWORD *inserted; // r13
  char *v10; // rbx
...
LABEL_21:
    v4 = v12;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, v15);
    return v4;
  }
  v10 = (char *)operator new(0x1CuLL);
  if ( v10 )
