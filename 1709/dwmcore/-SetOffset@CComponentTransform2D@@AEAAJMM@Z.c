/*
 * XREFs of ?SetOffset@CComponentTransform2D@@AEAAJMM@Z @ 0x1800954BC
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetOffset(CComponentTransform2D *this, double a2, double a3)
{
  ...
  if ( *((float *)this + 22) != *(float *)&a2 || *((float *)this + 23) != *(float *)&a3 )
  {
    ...
    *((_DWORD *)this + 23) = LODWORD(a3);
    ...
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 2u, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x128u);
    else
