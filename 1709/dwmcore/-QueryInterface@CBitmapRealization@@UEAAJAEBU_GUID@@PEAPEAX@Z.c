/*
 * XREFs of ?QueryInterface@CBitmapRealization@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002B340
 * Callers:
 ...
 *     ?QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C7120 (-QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WFI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C7130 (-QueryInterface@CBitmapRealization@@WFI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WJA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C7140 (-QueryInterface@CBitmapRealization@@WJA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
