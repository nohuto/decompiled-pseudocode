/*
 * XREFs of ?SetProperty@CInteraction@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180169FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v5 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070057, 0x257u);
  return v5;
}
