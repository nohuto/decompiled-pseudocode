/*
 * XREFs of ?SynchronizedCommit@CChannel@@UEAAJPEAX@Z @ 0x18000EEB0
 * Callers:
...
__int64 __fastcall CChannel::SynchronizedCommit(CChannel *this, void *a2)
{
  ...
  if ( v8 >= 0
    || (v5 = v8 | 0x10000000, MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8 | 0x10000000, 0x75u), v5 >= 0) )
  {
    *((_QWORD *)this + 20) = 0LL;
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x173u);
  }
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x134u);
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x1FDu);
  }
  else
  {
LABEL_2:
