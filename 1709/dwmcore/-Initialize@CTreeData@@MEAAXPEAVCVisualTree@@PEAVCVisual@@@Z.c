/*
 * XREFs of ?Initialize@CTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x1800A0280
 * Callers:
 ...
 *     ?Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x18011D520 (-Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z.c)
 * Callees:
 *     ?Initialize@CVisualOcclusionInfo@@MEAAXXZ @ 0x1800B6770 (-Initialize@CVisualOcclusionInfo@@MEAAXXZ.c)
...
void __fastcall CTreeData::Initialize(CTreeData *this, struct CVisualTree *a2, struct CVisual *a3)
{
  ...
  void (__fastcall *v5)(CDesktopTreeData *); // rax
  void (*v6)(void); // rax
  ...
  *((_BYTE *)this + 212) = 0;
  ...
  v5 = *(void (__fastcall **)(CDesktopTreeData *))(*(_QWORD *)this + 32LL);
