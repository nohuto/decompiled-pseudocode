/*
 * XREFs of ?Initialize@CCustomBlur@@AEAAJPEAUID2D1DeviceContext@@@Z @ 0x1800BCC7C
 * Callers:
...
__int64 __fastcall CCustomBlur::Initialize(CCustomBlur *this, struct ID2D1DeviceContext *a2)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x3Bu);
    return v7;
  }
  v12 = *v9;
  v30 = 1;
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v17, 0x40u);
    return v7;
  }
  v18 = *v13;
  v30 = 2;
  ...
  if ( v6 < 0 )
  {
    v29 = 77;
LABEL_37:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, v29);
    return v7;
  }
