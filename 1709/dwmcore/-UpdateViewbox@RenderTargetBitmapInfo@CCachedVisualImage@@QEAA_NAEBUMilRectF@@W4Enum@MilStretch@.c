/*
 * XREFs of ?UpdateViewbox@RenderTargetBitmapInfo@CCachedVisualImage@@QEAA_NAEBUMilRectF@@W4Enum@MilStretch@@@Z @ 0x18008AE00
 * Callers:
...
char __fastcall CCachedVisualImage::RenderTargetBitmapInfo::UpdateViewbox(__int64 a1, unsigned int *a2, int a3)
{
  ...
  *(_QWORD *)((char *)&v13 + 4) = __PAIR64__(v5, v4);
  HIDWORD(v13) = v7;
  if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEquivalentTo((float *)(a1 + 24), (float *)&v13) )
  {
