/*
 * XREFs of ??$ComputeHandledInteractionsFromLocal@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA?AUInteractionAxis@@PEAV?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@AEBUD2DVector3@@PEAUD2DMatrix@@@Z @ 0x1801996CC
 * Callers:
        ...
        struct D2DMatrix *a5)
{
  ...
  v5 = (__int64)a3 + 20;
  v10 = (_OWORD *)anonymous_namespace_::ReverseAndLeftShift(v22, (char *)a3 + 20);
  *(_OWORD *)a5 = *v10;
  *((_OWORD *)a5 + 1) = v10[1];
  *((_OWORD *)a5 + 2) = v10[2];
  *((_OWORD *)a5 + 3) = v10[3];
  v11 = D2DMatrixTranspose((struct D2DMatrix *)v22, a5);
  D3DXVec3TransformCoord((struct D2DVector3 *)&v20, a4, v11);
  if ( dword_18026D7B0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
  {
    ...
    v77 = 4LL;
    v79 = 4LL;
    TlgWrite(v12, &unk_180214FFF, v13, v14, 0x1Au, &pData);
  }
  if ( *(float *)&v20 > 0.0 && (a3[2] & 1) == 0 || *(float *)&v20 < 0.0 && (a3[2] & 2) == 0 )
    LODWORD(v20) = 0;
  if ( *((float *)&v20 + 1) > 0.0 && (a3[2] & 4) == 0 || *((float *)&v20 + 1) < 0.0 && (a3[2] & 8) == 0 )
    HIDWORD(v20) = 0;
