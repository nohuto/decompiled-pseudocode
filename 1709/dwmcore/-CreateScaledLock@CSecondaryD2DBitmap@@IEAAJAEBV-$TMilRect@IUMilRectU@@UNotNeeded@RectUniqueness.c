/*
 * XREFs of ?CreateScaledLock@CSecondaryD2DBitmap@@IEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@PEAPEAVIBitmapLock@@@Z @ 0x1801503C8
 * Callers:
...
__int64 __fastcall CSecondaryD2DBitmap::CreateScaledLock(__int64 a1, _DWORD *a2, __int64 *a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x13Eu);
  }
  else
  {
    ...
    else
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v15, 0x143u);
      }
      else
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v16, 0x14Fu);
          v4 = v34;
        }
        else
        {
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v17, 0x151u);
          }
          else
          {
            ...
            if ( v18 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x157u);
            }
            else
            {
              ...
              if ( v19 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v19, 0x159u);
              }
              else
              {
                ...
                if ( v20 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v20, 0x161u);
                }
                else
                {
                  ...
                  if ( v21 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v21, 0x166u);
                    v10 = v33;
                  }
                  else
                  {
                    ...
                    if ( v22 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v22, 0x168u);
                    }
                    else
                    {
                      v23 = a2[1];
                      ...
                      v13 = v26;
                      if ( v26 < 0 )
                        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v26, 0x16Fu);
                    }
                  }
                }
              }
