/*
 * XREFs of ?InitMeshGraph@Mesh@@AEAAJXZ @ 0x180154700
 * Callers:
...
__int64 __fastcall Mesh::InitMeshGraph(Mesh *this)
{
  ...
  if ( (*((_BYTE *)this + 236) & 2) != 0 )
  {
    ...
    if ( v2 )
    {
      ...
      if ( v3 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v3, 0x22Cu);
        return v4;
      }
    }
    else
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x230u);
        return v4;
      }
    }
