/*
 * XREFs of ?Create@CManipulationFrame@@SAJPEBUtagMANIPULATION_INPUT_INFO@@PEAPEAV1@@Z @ 0x1801A40A0
 * Callers:
        ...
        struct CManipulationFrame **a2)
{
  ...
  v5 = 0;
  if ( v4
    && (v6 = (unsigned int)(v4 - 1), (unsigned __int64)(224 * v6) <= 0xFFFFFFFF)
    && (unsigned int)(224 * v6 + 320) >= 0x140 )
  {
    v7 = 224 * v6 + 320;
  }
  else
  ...
  *a2 = 0LL;
  ...
  if ( v9 )
  {
    for ( i = 0; i < *((_DWORD *)a1 + 2); LOBYTE(v9[v14 + 39]) &= ~1u )
    {
      v14 = 28LL * i;
      v15 = 208LL * i++;
      v16 = &v9[v14 + 12];
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x31u);
  }
