/*
 * XREFs of ??0CDxHandleBitmapRealization@@IEAA@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@_NPEAVCDecodeBitmap@@@Z @ 0x18004D118
 * Callers:
        ...
        struct CDecodeBitmap *a5)
{
  ...
  *((_BYTE *)this + 404) = a4;
  *((_BYTE *)this + 405) = 1;
  v9 = *(_DWORD *)CBitmapRealization::CalcDisplayRestriction(
                    v8,
                    (struct DisplayId *)&v11,
                    *((_DWORD *)a2 + 29) & 1,
                    *((HMONITOR *)a2 + 1));
  result = this;
  *((_DWORD *)this + 100) = v9;
