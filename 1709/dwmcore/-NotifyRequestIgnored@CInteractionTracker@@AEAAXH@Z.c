/*
 * XREFs of ?NotifyRequestIgnored@CInteractionTracker@@AEAAXH@Z @ 0x18016C2A8
 * Callers:
...
void __fastcall CInteractionTracker::NotifyRequestIgnored(CInteractionTracker *this)
{
  ...
  {
    v4 = *(_QWORD *)(v2 + 48);
    v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 16) + 1288LL) + 56LL);
    if ( v4 )
      v3 = *(_DWORD *)(v4 + 68);
    v6[0] = v3;
    v6[1] = *(unsigned int *)(v2 + 56);
    CoreUICallSend(v5, v6, 2LL, 4LL, 2, &unk_1801F0537);
  }
}
