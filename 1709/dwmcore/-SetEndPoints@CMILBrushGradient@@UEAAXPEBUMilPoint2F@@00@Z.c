/*
 * XREFs of ?SetEndPoints@CMILBrushGradient@@UEAAXPEBUMilPoint2F@@00@Z @ 0x1800C10F0
 * Callers:
 *     ?SetEndPoints@CMILBrushLinearGradient@@WHA@EAAXPEBUMilPoint2F@@00@Z @ 0x1800C6170 (-SetEndPoints@CMILBrushLinearGradient@@WHA@EAAXPEBUMilPoint2F@@00@Z.c)
 * Callees:
 *     <none>
 */
