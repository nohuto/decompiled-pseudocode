/*
 * XREFs of ??$DwmHolographicDisplayUpdate@I@CompositorTracing@@SAX$$QEAI@Z @ 0x1801BF540
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicDisplayUpdate<unsigned int>(unsigned int *a1)
{
  ...
  if ( v2 && TraceLoggingProviderEnabled(v2, 0, 0LL) )
  {
    ...
    CompositorTracing::DwmHolographicDisplayUpdate_(v3, *a1);
  }
}
