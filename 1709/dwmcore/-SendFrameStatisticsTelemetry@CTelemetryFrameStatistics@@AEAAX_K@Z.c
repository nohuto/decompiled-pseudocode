/*
 * XREFs of ?SendFrameStatisticsTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x180001B9C
 * Callers:
...
void __fastcall CTelemetryFrameStatistics::SendFrameStatisticsTelemetry(CTelemetryFrameStatistics *this, __int64 a2)
{
  ...
  __int128 v14; // xmm0
  __int128 v15; // xmm1
  DWORD v16; // [rsp+38h] [rbp-D0h] BYREF
  ...
  DWORD *v24; // [rsp+A8h] [rbp-60h]
  int v25; // [rsp+B0h] [rbp-58h]
  int v26; // [rsp+B4h] [rbp-54h]
  DWORD *v27; // [rsp+B8h] [rbp-50h]
  ...
  if ( *((_DWORD *)this + 8) )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v49 = 4;
      v21 = v12 / v6;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1802127C4, (LPCGUID)4, (LPCGUID)8, 0xBu, &pData);
    }
