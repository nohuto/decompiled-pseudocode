/*
 * XREFs of ?ProcessSetDebugInfo@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUMILCMD_BASEEXPRESSION_SETDEBUGINFO@@PEBXI@Z @ 0x1801591C0
 * Callers:
        ...
        size_t *a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x16Du);
    }
  }
  return v4;
}
