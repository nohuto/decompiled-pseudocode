/*
 * XREFs of ?RepositionStopsForSmallGradientSpans@CGradientTextureGenerator@@CAJPEBVCGradientSpanInfo@@PEBU_D3DCOLORVALUE@@1PEAV?$DynArray@UMILGradientStop@@$0A@@@@Z @ 0x1801D9F08
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(5LL, 0LL, 0, v11, 0x392u);
  }
  else
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(5LL, 0LL, 0, v13, 0x398u);
    }
    else
    {
      v15 = *a3;
      ...
      if ( v19 && (v20 = DynArray<InputBoundsPair,0>::AddMultipleAndSet(a4, (__int64)&v27, v14), v12 = v20, v20 < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(5LL, 0LL, 0, v20, 0x3AAu);
      }
      else
      {
        v21 = DynArray<InputBoundsPair,0>::AddMultipleAndSet(a4, (__int64)&v27, v14);
        v12 = v21;
        if ( v21 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(5LL, 0LL, 0, v21, 0x3AFu);
        }
        else
        {
          v22 = 1;
