/*
 * XREFs of ?ProcessSetBottomInset@CRectangleGeometry@@QEAAJPEAVCResourceTable@@PEBUMILCMD_RECTANGLEGEOMETRY_SETBOTTOMINSET@@@Z @ 0x180058E10
 * Callers:
        ...
        const struct MILCMD_RECTANGLEGEOMETRY_SETBOTTOMINSET *a3)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x10Eu);
  return v4;
}
