/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_0_dll @ 0x1800C468B
 * Callers:
 *     __imp_load_UpdateWindowInputSinkHints @ 0x1800C467F (__imp_load_UpdateWindowInputSinkHints.c)
 * Callees:
