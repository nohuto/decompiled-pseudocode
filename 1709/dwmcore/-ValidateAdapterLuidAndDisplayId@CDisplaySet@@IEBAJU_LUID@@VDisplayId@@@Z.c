/*
 * XREFs of ?ValidateAdapterLuidAndDisplayId@CDisplaySet@@IEBAJU_LUID@@VDisplayId@@@Z @ 0x1800987D8
 * Callers:
...
__int64 __fastcall CDisplaySet::ValidateAdapterLuidAndDisplayId(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (_BYTE)v6 )
  {
    if ( v7 != DisplayId::Hmd )
    {
      ...
      if ( v9 )
      {
        while ( v7 != *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 48) + 8LL * v10) + 240LL) )
        {
          if ( ++v10 >= v9 )
            goto LABEL_13;
        }
...
LABEL_13:
      ...
      else
      {
        ...
        if ( *(_DWORD *)(v12 + 224) != v5.LowPart || (v13 = 0, *(_DWORD *)(v12 + 228) != v20) )
          v13 = 1;
        if ( !v13 )
          return v4;
        if ( v9 )
        {
          do
          {
            ...
            {
              v15 = *(_QWORD *)(v11 + 8 * v3);
              if ( *(_QWORD *)(v15 + 128) == v12
                && *(_DWORD *)(v15 + 224) == v5.LowPart
                && *(_DWORD *)(v15 + 228) == v20 )
              {
                return v4;
              }
...
LABEL_31:
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, v19);
      return v4;
    }
LABEL_32:
    ...
    v4 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x2A4u);
    return v4;
  }
  if ( v7 == DisplayId::Hmd )
    goto LABEL_32;
...
LABEL_30:
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v17 + 224) == v5.LowPart && *(_DWORD *)(v17 + 228) == v20 )
      return v4;
    v3 = (unsigned int)(v3 + 1);
