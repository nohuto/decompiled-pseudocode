/*
 * XREFs of ?ApplyState@CD2DLayer@@UEAAJPEAVCDrawingContext@@@Z @ 0x1800818D0
 * Callers:
...
__int64 __fastcall CD2DLayer::ApplyState(CD2DLayer *this, struct CDrawingContext *a2)
{
  ...
  void (__fastcall *v6)(CD2DContext *, const struct ID2DContextOwner *, const __m128i *, struct ID2D1Geometry *, struct D2D_MATRIX_3X2_F *, float, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND); // rax
  CD2DContext *v7; // rcx
  const __m128i *v8; // r8
  ...
  v12 = *((_DWORD *)this + 16);
  v11 = *((float *)this + 15);
  v6 = *(void (__fastcall **)(CD2DContext *, const struct ID2DContextOwner *, const __m128i *, struct ID2D1Geometry *, struct D2D_MATRIX_3X2_F *, float, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND))(**((_QWORD **)a2 + 48) + 56LL);
  v10 = (struct D2D_MATRIX_3X2_F *)(((unsigned __int64)this + 32) & -(__int64)(*((_BYTE *)this + 56) != 0));
  v7 = (CD2DContext *)*((_QWORD *)a2 + 48);
  v8 = (const __m128i *)((char *)this + 8);
  if ( v6 == CD2DContext::PushLayer )
    CD2DContext::PushLayer(v7, v5, v8, v4, v10, v11, v12, v13, v14);
  else
    ((void (__fastcall *)(CD2DContext *, const struct ID2DContextOwner *, const __m128i *, struct ID2D1Geometry *, struct D2D_MATRIX_3X2_F *, _DWORD, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND))v6)(
      v7,
      v5,
      v8,
      v4,
