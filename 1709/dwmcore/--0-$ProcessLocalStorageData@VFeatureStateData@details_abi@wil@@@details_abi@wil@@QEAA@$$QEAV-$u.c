 ...
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x180132830 (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)(a1 + 24) = a3[1];
  a3[1] = 0LL;
  memset_0((void *)(a1 + 32), 0, 0x110uLL);
  *(_QWORD *)(a1 + 32) = 0LL;
