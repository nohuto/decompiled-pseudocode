/*
 * XREFs of ?DrawMesh2D@CHwSurfaceRenderTarget@@UEAAJPEAVID2DContext@@PEBVID2DContextOwner@@PEAUCContextState@@PEAVCGeometry2D@@PEAVIBitmapSource@@@Z @ 0x1801B725C
 * Callers:
        ...
        struct IBitmapSource *a6)
{
  ...
  __int64 v11; // rax
  signed int v12; // eax
  signed int ScratchDrawBitmapBrushNoAddRef; // eax
  ...
  *((_BYTE *)a4 + 68) = 1;
  ...
  {
    v12 = (*(__int64 (__fastcall **)(CHwSurfaceRenderTarget *, __int64 *))(*(_QWORD *)this + 216LL))(this, &v57);
    LODWORD(v49) = v12;
    v6 = v12;
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x210u);
    }
    else
    {
      if ( EventEnabled(Microsoft_Windows_Dwm_Core_Provider_Context[0], &EVTDESC_ETWGUID_DRAWEVENT) )
      {
        ...
        CMILMatrix::Transform2DBoundsHelper<0>((__int64)a4 + 212, (__int64)&v67, &v62);
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ScratchDrawBitmapBrushNoAddRef, 0x21Bu);
      }
      else
      {
        (*(void (__fastcall **)(struct IBitmapSource *, __int64 *))(*(_QWORD *)a6 + 24LL))(a6, &v67);
        v14 = v50;
        CMILBrushBitmapLocalSetterWrapper::CMILBrushBitmapLocalSetterWrapper((__int64 *)&v50, (__int64)v50, (__int64)a6);
        v74 = 0LL;
        ...
        if ( v6 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x23Eu);
        ...
        else
        {
          ...
          v59 = 0LL;
          v52[0] = 0;
          v18 = *(_DWORD *)((*(__int64 (__fastcall **)(CHwSurfaceRenderTarget *, float *))(*(_QWORD *)this + 24LL))(
                              this,
                              &v62)
                          + 8);
          if ( !v18 || (v19 = 2, v18 != 1) )
            v19 = 1;
          D2DBrush = CHwBitmapBrush::GetD2DBrush((CD2DContext **)v17, 1.0, v19, &v58);
          LODWORD(v49) = D2DBrush;
          v6 = D2DBrush;
          if ( D2DBrush < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, D2DBrush, 0x24Bu);
          }
          else
          {
            ...
            if ( v21 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v21, 0x24Eu);
            }
            else
            {
              ...
              if ( MeshData < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, MeshData, 0x255u);
              }
              else
              {
                v23 = v52[0];
                ...
                if ( v25 )
                {
                  ...
                  v30 = (*(__int64 (__fastcall **)(struct ID2DContext *, __int64, __int64 *))(*(_QWORD *)a2 + 216LL))(
                          a2,
                          4LL,
                          &v51);
                  LODWORD(v49) = v30;
                  ...
                  if ( v30 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v30, 0x260u);
                  }
                  else
                  {
                    v31 = *((_QWORD *)v17 + 2);
                    ...
                    if ( v42 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v42, 0x270u);
                    }
                    else
                    {
                      v62 = v36;
                      ...
                      if ( v43 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v43, 0x273u);
                      }
                      else
                      {
                        ...
                        if ( v44 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v44, 0x27Au);
                        }
                        else
                        {
                          v45 = 12;
                          ...
                          v6 = v46;
                          if ( v46 < 0 )
                            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v46, 0x281u);
                        }
                      }
                    }
                  }
                ...
                else
                {
                  ...
                  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x258u);
                }
              }
            }
          }
  ...
  *((_BYTE *)a4 + 68) = 0;
  ...
  ReleaseInterfaceNoNULL<CManipulationManager>(v56);
  if ( v51 )
