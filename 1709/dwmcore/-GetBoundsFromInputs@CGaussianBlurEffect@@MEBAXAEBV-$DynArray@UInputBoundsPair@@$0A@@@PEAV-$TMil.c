/*
 * XREFs of ?GetBoundsFromInputs@CGaussianBlurEffect@@MEBAXAEBV?$DynArray@UInputBoundsPair@@$0A@@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180180A10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CGaussianBlurEffect::GetBoundsFromInputs(__int64 a1, __int64 a2, _OWORD *a3)
{
  ...
  *a3 = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
  ...
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v4 + 24); i = (unsigned int)(v8 + 1) )
  {
    ...
    if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v9) )
    {
    ...
    TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::UnionUnsafe(v6, (float *)&v9);
  }
}
