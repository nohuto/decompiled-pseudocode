/*
 * XREFs of ?InvalidateMCs@CManipulationContext@@SAXPEAUMCCollections@@PEAVCVisual@@PEAVCInteraction@@W4MidManipulationUpdateType@@PEAI@Z @ 0x1801A1F50
 * Callers:
...
LABEL_6:
  ...
  else if ( a2 )
  {
    ...
    if ( !ManipulationContext )
      goto LABEL_34;
    if ( (*((_BYTE *)ManipulationContext + 216) & 2) != 0 && a2[10] )
    {
...
LABEL_25:
      while ( !v14 )
      {
        ...
        v24 = 0LL;
        if ( v23 )
          v24 = *(const struct CVisual **)(v23 + 8);
        ...
        do
        {
          ...
          if ( (*(_BYTE *)(v27 + 28) & 4) == 0 )
          {
            ...
            if ( (_BYTE)ManipulationContext )
            {
              if ( v27 )
              {
                LOBYTE(ManipulationContext) = *(_BYTE *)(v27 + 28);
                if ( ((unsigned __int8)ManipulationContext & 4) == 0 )
                {
                  LOBYTE(ManipulationContext) = (unsigned __int8)ManipulationContext | 4;
                  *(_BYTE *)(v27 + 28) = (_BYTE)ManipulationContext;
                  ++*a5;
                }
              }
            }
