/*
 * XREFs of ?GetFrameRate@CDebugFrameCounter@@QEAAIXZ @ 0x18012FD38
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x18012FD14 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
