/*
 * XREFs of ?SetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@KPEAX@Z @ 0x18007F2CC
 * Callers:
...
__int64 __fastcall CRedirectedGDISurface::SetInformation(__int64 a1, int a2, unsigned int a3, unsigned int *a4)
{
  ...
  {
    SetLastError(0);
    if ( (unsigned int)DwmHLSurfSetSignalOnDirty(*(_QWORD *)(a1 + 24), 0LL, qword_180272818, *a4) )
      return v4;
  ...
  if ( a3 < 0x20 )
  {
    ...
    v8 = -2147024872;
LABEL_22:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_180207358, 1u, v8, v10);
    return v4;
  }
  SetLastError(0);
