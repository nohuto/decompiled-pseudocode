/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW____0_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801D66EC
 * Callers:
        ...
        float *a2)
{
  ...
  v4 = CMILMatrix::ComputeAdjointIgnoreZ((__int64)&v15, a2);
  v5 = *(_DWORD *)(a1 + 20);
  v6 = 0;
  v7 = *(_OWORD *)(v4 + 16);
  v13[0] = *(_OWORD *)v4;
