/*
 * XREFs of ?Link@CShaderLinkingGraphBuilder@@QEAAJAEBUSignatureParameter@1@PEAPEAUID3D10Blob@@@Z @ 0x180004C18
 * Callers:
        ...
        struct ID3D10Blob **a3)
{
  ...
  __int64 v17; // rcx
  const CHAR *v18; // rax
  _QWORD v19[2]; // [rsp+40h] [rbp-59h] BYREF
  ...
  v23 = 0LL;
  v24 = 0LL;
  v5 = ToD3D11ParameterDesc(v22, &unk_1801DC000, 2LL);
  ...
  v19[0] = &unk_1801DC000;
  v19[1] = 1LL;
  v10 = CShaderLinkingGraphBuilder::FulfillInputs((__int64)this, v24, v19);
  v9 = v10;
  if ( v10 < 0 )
  {
