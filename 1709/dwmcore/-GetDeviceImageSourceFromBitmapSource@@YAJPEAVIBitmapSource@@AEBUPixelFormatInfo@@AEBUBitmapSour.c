/*
 * XREFs of ?GetDeviceImageSourceFromBitmapSource@@YAJPEAVIBitmapSource@@AEBUPixelFormatInfo@@AEBUBitmapSourceInfo@@PEAPEAVIImageSource@@@Z @ 0x180190FC8
 * Callers:
        ...
        struct IImageSource **a4)
{
  ...
  signed int ImageSourceWrapperNoRef; // eax
  __int64 v11; // rax
  ...
  if ( ExistingDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ExistingDevice, 0x2B4u);
  }
  else
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x2BDu);
    }
    else
    {
      v9 = v13;
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ImageSourceWrapperNoRef, 0x2BFu);
      }
      else
      {
