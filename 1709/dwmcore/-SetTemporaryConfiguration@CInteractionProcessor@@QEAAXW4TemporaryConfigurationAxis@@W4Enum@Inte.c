/*
 * XREFs of ?SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x18019D524
 * Callers:
...
LABEL_8:
  ...
  {
    LOBYTE(v6) = TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL);
    if ( (_BYTE)v6 )
    {
      v43 = 0;
      v46 = 0;
      ...
      v37 = v26;
      v68 = &v37;
      v27 = ((unsigned __int8)a1[1064] >> 1) & 1;
      v69 = 4;
      v73 = 0;
      v38 = v27;
      v71 = &v38;
      v72 = 4;
      LOBYTE(v6) = TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_18021526E, v21, v22, 0xDu, &pData);
    }
  }
  return v6;
}
