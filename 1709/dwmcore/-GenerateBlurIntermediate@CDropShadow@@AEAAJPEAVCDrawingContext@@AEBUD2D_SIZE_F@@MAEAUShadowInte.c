/*
 * XREFs of ?GenerateBlurIntermediate@CDropShadow@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@MAEAUShadowIntermediates@1@@Z @ 0x18015FC9C
 * Callers:
        ...
        struct CDropShadow::ShadowIntermediates *a5)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x2BCu);
    goto LABEL_17;
  }
  v10 = v24;
  (*(void (__fastcall **)(struct IRenderTarget *, __int64))(*(_QWORD *)v24 + 136LL))(v24, 1LL);
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x2C5u);
    goto LABEL_15;
  }
  v12 = a5;
  v13 = *((_QWORD *)a5 + 1);
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x2C8u);
    goto LABEL_15;
  }
  v15 = v22;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v16, 0x2CEu);
    goto LABEL_15;
  }
  v17 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v7 + 216LL))(v7, 6LL, &v28);
  v9 = v17;
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v17, 0x2D1u);
    goto LABEL_15;
  }
  ...
  *(float *)&v27 = a4;
  *((float *)&v27 + 1) = a4;
  v18 = CDrawingContext::FillEffect(a2, v28, 0LL, (__int64)&v27, 1);
  v9 = v18;
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x2DEu);
LABEL_15:
  ...
  v9 = v19;
  if ( v19 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v19, 0x2E3u);
  else
    Microsoft::WRL::ComPtr<IImageSource>::operator=<CRenderTargetImageSource>((__int64 *)v12 + 2, (__int64 *)&v23);
LABEL_17:
  if ( v28 )
