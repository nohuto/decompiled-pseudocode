/*
 * XREFs of ?InitRemoteApp@CHwndRenderTargetRemoteApp@@QEAAJPEAVCDesktopRenderTarget@@PEAVCHwndRenderTarget@@PEAVCRemoteApplicationWindow@@@Z @ 0x1801478B4
 * Callers:
        ...
        struct CRemoteApplicationWindow *a4)
{
  ...
  *((_QWORD *)this + 45) = v8;
  *((_BYTE *)this + 802) = 0;
  ReplaceInterface<IDXGIResource,IDXGIResource>((__int64 *)this + 107, (__int64)a3);
  return 0LL;
}
