/*
 * XREFs of ?FrameUpdate@CHolographicClient@@UEAAJII@Z @ 0x1801C2C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHolographicClient::FrameUpdate(CHolographicClient *this, int a2, DWORD a3)
{
  ...
  if ( !v7 )
    goto LABEL_16;
  v8 = (CHolographicExclusiveView **)((char *)this + 136);
  if ( !*((_QWORD *)this + 17) )
  {
    ExclusiveViewByViewId = CHolographicClient::FindExclusiveViewByViewId(v3, v7);
    v10 = (__int64)ExclusiveViewByViewId;
    if ( ExclusiveViewByViewId )
    {
      ...
      Microsoft::WRL::ComPtr<CInteractionTrackerPositionAnimation>::operator=((__int64 *)this + 17, v10);
    }
  }
LABEL_8:
  v11 = *v8;
  if ( *v8 && !*((_BYTE *)v11 + 75) )
  {
    if ( (v14[0] = 0LL, v14[1] = 0LL, v15 = 0LL, *((_BYTE *)v11 + 72))
      ...
      || !WaitForSingleObject(*((HANDLE *)this + 23), a3)
      && *((_BYTE *)*v8 + 72)
