/*
 * XREFs of ?Thunk_UpdateHoverPointer_118@?$IManipulation_Receive@VCManipulationManager@@@@SAJPEAXPEAPEAX@Z @ 0x1800C0E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IManipulation_Receive<CManipulationManager>::Thunk_UpdateHoverPointer_118(__int64 a1, __int64 **a2)
{
  ...
  if ( *(float *)(v3 + 72) != *(float *)v2 || *(float *)(v3 + 76) != *((float *)v2 + 1) )
    *(_QWORD *)(v3 + 72) = *v2;
  CResource::InvalidateAnimationSources((CResource *)(v3 + 8));
