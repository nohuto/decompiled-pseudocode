/*
 * XREFs of ?IntersectFourLines@@YA_NULine3D@@000MPEAUfloat3@Numerics@Foundation@Windows@@@Z @ 0x18015B918
 * Callers:
...
bool __fastcall IntersectFourLines(__int128 *a1, __int128 *a2, __int128 *a3, __int128 *a4, float a5, __int64 a6)
{
  ...
  *(_DWORD *)(a6 + 8) = v15;
  return v14
      && v17
      && a5 > sqrtf_0(
                (float)((float)((float)(v19 - *(float *)&v24) * (float)(v19 - *(float *)&v24))
                      + (float)((float)(v20 - *((float *)&v24 + 1)) * (float)(v20 - *((float *)&v24 + 1))))
