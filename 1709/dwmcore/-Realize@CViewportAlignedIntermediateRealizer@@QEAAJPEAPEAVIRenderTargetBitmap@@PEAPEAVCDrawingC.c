/*
 * XREFs of ?Realize@CViewportAlignedIntermediateRealizer@@QEAAJPEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@PEAVCMILMatrix@@PEAH@Z @ 0x18018C6E4
 * Callers:
 ...
 *     ?SetToInverseOf2DTranslateOrScale@CMILMatrix@@QEAAXAEBV1@@Z @ 0x18018FE40 (-SetToInverseOf2DTranslateOrScale@CMILMatrix@@QEAAXAEBV1@@Z.c)
 */
        ...
        int *a5)
{
  ...
  signed int SurfaceAndContext; // eax
         ...
         v15[0])) )
  {
    ...
    if ( !*a5 )
    {
      ...
      if ( !*a5 )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, SurfaceAndContext, 0xCFu);
