/*
 * XREFs of ?TryFastWarpLock@CBitmapOfDeviceBitmaps@@AEAA_NAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAEPEAI2PEAPEAUIUnknown@@@Z @ 0x1801ACE94
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  *a4 = 0;
  ...
  {
    a5 = 0LL;
    if ( (int)CWarpLockSubresource::Create(*(struct CD3DVidMemOnlyTexture **)(v17 + 168), &a5) >= 0 )
    {
      v12 = a5;
      v7 = 1;
      v13 = *(_DWORD *)(a1 + 172);
