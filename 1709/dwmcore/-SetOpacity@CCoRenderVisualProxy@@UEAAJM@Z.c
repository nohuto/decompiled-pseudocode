/*
 * XREFs of ?SetOpacity@CCoRenderVisualProxy@@UEAAJM@Z @ 0x180129CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCoRenderVisualProxy::SetOpacity(CVisual **this, float a2)
{
  ...
  if ( v5 < 0.0000011920929 || CVisual::GetEffectInternal(this[3]) )
    goto LABEL_18;
  v6 = (CMILCOMBase *)KeyframeValue::operator new();
  v3 = v6;
  if ( v6 )
  {
    v7 = *((_QWORD *)this[3] + 2);
  ...
  {
    v2 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x139u);
    return v2;
  }
...
LABEL_18:
    if ( CVisual::GetEffectInternal(this[3]) )
    {
      ...
      v2 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x143u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x13Bu);
  }
  if ( v3 )
