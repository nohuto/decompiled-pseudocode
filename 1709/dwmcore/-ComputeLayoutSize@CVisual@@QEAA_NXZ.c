/*
 * XREFs of ?ComputeLayoutSize@CVisual@@QEAA_NXZ @ 0x18004F460
 * Callers:
...
char __fastcall CVisual::ComputeLayoutSize(CVisual *this)
{
  ...
  v14 = (float)(v21 * v3) + *(float *)(v11 + 124);
  v15 = (float)(v22 * v13) + *(float *)(v11 + 128);
  *(float *)(v11 + 136) = v15;
  *(float *)(v11 + 132) = v14;
  if ( v14 < 0.0 )
    *(_DWORD *)(v11 + 132) = 0;
  ...
  if ( v2 != v12 || (v16 = 0, v4 != v10) )
    v16 = 1;
  if ( v7 == *(float *)(v11 + 132) && v5 == *(float *)(v11 + 136) )
  {
    v17 = 0;
  }
  else
