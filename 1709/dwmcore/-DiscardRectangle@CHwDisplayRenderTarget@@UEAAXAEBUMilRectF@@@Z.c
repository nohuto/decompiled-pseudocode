/*
 * XREFs of ?DiscardRectangle@CHwDisplayRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x18002B5E0
 * Callers:
 *     ?DiscardRectangle@CHwDisplayRenderTarget@@WMA@EAAXAEBUMilRectF@@@Z @ 0x1800C6BC0 (-DiscardRectangle@CHwDisplayRenderTarget@@WMA@EAAXAEBUMilRectF@@@Z.c)
 * Callees:
