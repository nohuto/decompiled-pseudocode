/*
 * XREFs of CChainingHelper::RunForAllAxes__lambda_408235350fb3fde3f1635dd6a9cd52f4___ @ 0x1801923B0
 * Callers:
...
__int64 __fastcall CChainingHelper::RunForAllAxes__lambda_408235350fb3fde3f1635dd6a9cd52f4___(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  do
  {
    ...
    result = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(v10 + 200))(v11, TemporaryConfigurationAxis, 0LL);
    ++v4;
    v7 += 12LL;
    v6 += 12LL;
  }
