/*
 * XREFs of ?ReconcileLayouts@CHwBitmapColorSource@@CAJAEAURealizationParameters@1@II@Z @ 0x1801B62E0
 * Callers:
        ...
        unsigned int a3)
{
  ...
  else if ( *((_DWORD *)a1 + 15) )
  {
    ...
    v4 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x657u);
    return v4;
  }
  if ( v3 )
  {
    ...
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x660u);
  }
  return v4;
}
