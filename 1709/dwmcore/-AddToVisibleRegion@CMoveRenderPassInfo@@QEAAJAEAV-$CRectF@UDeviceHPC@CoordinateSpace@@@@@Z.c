/*
 * XREFs of ?AddToVisibleRegion@CMoveRenderPassInfo@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x18014DE50
 * Callers:
...
__int64 __fastcall CMoveRenderPassInfo::AddToVisibleRegion(__int64 a1, float *a2)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 72) + 264LL))(*(_QWORD *)(a1 + 72)) )
  {
    ...
    if ( RectRgn )
    {
      if ( *(_QWORD *)(a1 + 8) || (SetLastError(0), v15 = CreateRectRgn(0, 0, 0, 0), (*(_QWORD *)(a1 + 8) = v15) != 0LL) )
      {
        ...
        if ( !CombineRgn(*(HRGN *)(a1 + 8), *(HRGN *)(a1 + 8), RectRgn, 2) )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0x9Au);
        }
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0x94u);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0x90u);
    }
  }
