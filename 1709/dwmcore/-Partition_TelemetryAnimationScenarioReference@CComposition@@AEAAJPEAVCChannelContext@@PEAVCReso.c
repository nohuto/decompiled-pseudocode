/*
 * XREFs of ?Partition_TelemetryAnimationScenarioReference@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_PARTITION_TELEMETRYANIMATIONSCENARIOREFERENCE@@@Z @ 0x1800AB42C
 * Callers:
        ...
        const struct MILCMD_PARTITION_TELEMETRYANIMATIONSCENARIOREFERENCE *a4)
{
  ...
  __int64 v6; // rdx
  __int64 (__fastcall *v7)(CPartitionVerticalBlankScheduler *, unsigned int, __int64, const struct _GUID *); // rax
  const struct _GUID *v8; // r9

  v4 = *(_QWORD *)((char *)a4 + 20);
  v5 = (CPartitionVerticalBlankScheduler *)*((_QWORD *)this + 66);
  v6 = *((unsigned int *)a2 + 4);
  v7 = *(__int64 (__fastcall **)(CPartitionVerticalBlankScheduler *, unsigned int, __int64, const struct _GUID *))(*(_QWORD *)v5 + 48LL);
