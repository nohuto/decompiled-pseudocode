/*
 * XREFs of ??2CLinearGradientLegacyMilBrush@@KAPEAX_K@Z @ 0x180146590
 * Callers:
...
void *__fastcall CLinearGradientLegacyMilBrush::operator new()
{
  void *result; // rax
  const void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x1E0uLL);
  if ( !result )
