/*
 * XREFs of ?LogValueUpdate@CPropertyBagBase@@IEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800A528C
 * Callers:
...
__int64 __fastcall CPropertyBagBase::LogValueUpdate(__int64 a1, unsigned int a2, int a3, int a4, unsigned __int8 *a5)
{
  ...
  if ( a2 < 2 )
  {
    ...
    if ( !v8 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        v58[0] = v51;
        v60 = v58;
        v62 = &v57;
        ...
        v54 = v52;
        v69 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_18021448D, v48, v49, 7u, &pData);
      }
      return v5;
    }
    v9 = v8 - 1;
    if ( !v9 )
    {
      ...
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v67 = 4LL;
        v69 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_1802143B8, v44, v45, 7u, &pData);
      }
      return v5;
    }
    v10 = v9 - 17;
    if ( !v10 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v69 = 4LL;
        v71 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_18021441F, v40, v41, 8u, &pData);
      }
      return v5;
    }
    v11 = v10 - 17;
    if ( !v11 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v71 = 4LL;
        v73 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_1802142D3, v36, v37, 9u, &pData);
      }
      return v5;
    }
    v12 = v11 - 17;
    if ( !v12 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v73 = 4LL;
        v75 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_180214344, v32, v33, 0xAu, &pData);
      }
      return v5;
    }
    v13 = v12 - 1;
    if ( !v13 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v73 = 4LL;
        v75 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_18021425F, v28, v29, 0xAu, &pData);
      }
      return v5;
    }
    v14 = v13 - 1;
    if ( !v14 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v73 = 4LL;
        v75 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_180214344, v24, v25, 0xAu, &pData);
      }
      return v5;
    }
    v15 = v14 - 33;
    if ( !v15 )
    {
      if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
      {
        ...
        v77 = 4LL;
        v79 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_180214121, v20, v21, 0xCu, &pData);
      }
      return v5;
    }
    if ( v15 == 161 )
    {
      if ( dword_18026D7B0 > 5u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 1uLL) )
        {
          ...
          v97 = 4LL;
          v99 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_1802141A7, v16, v17, 0x16u, &pData);
        }
      }
      return v5;
    }
  ...
  v5 = -2147418113;
  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8000FFFF, cData);
  return v5;
}
