/*
 * XREFs of ??0CTelemetryTouchLatencyAnalysis@@QEAA@XZ @ 0x180125CD0
 * Callers:
        ...
        CTelemetryTouchLatencyAnalysis *this)
{
  ...
  *((_QWORD *)this + 276) = 0LL;
  memset_0((char *)this + 8, 0, 0x780uLL);
  memset_0(v16, 0, 0x100uLL);
  v2 = 2LL;
  v3 = (_OWORD *)((char *)this + 1928);
  v4 = v16;
  do
  {
    v5 = v4[1];
  ...
  *((_QWORD *)this + 273) = g_qpcFrequency.QuadPart / 1000;
  v14 = (double)(int)v13;
  if ( v12 )
    v14 = v14 + 1.844674407370955e19;
  result = this;
  *((double *)this + 274) = v14 / 1000.0;
  return result;
}
