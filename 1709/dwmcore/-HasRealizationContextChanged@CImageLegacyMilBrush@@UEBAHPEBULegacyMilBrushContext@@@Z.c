/*
 * XREFs of ?HasRealizationContextChanged@CImageLegacyMilBrush@@UEBAHPEBULegacyMilBrushContext@@@Z @ 0x18007CC20
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct LegacyMilBrushContext *a2)
{
  ...
  v2 = 0;
  if ( *((_DWORD *)this + 94) || *((_DWORD *)this + 108) == 1 && (unsigned __int8)operator!=((char *)a2 + 144) )
    return 1;
  return v2;
}
