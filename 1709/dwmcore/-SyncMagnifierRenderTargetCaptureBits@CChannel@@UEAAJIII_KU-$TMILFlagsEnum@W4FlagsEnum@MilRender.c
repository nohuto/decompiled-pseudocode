/*
 * XREFs of ?SyncMagnifierRenderTargetCaptureBits@CChannel@@UEAAJIII_KU?$TMILFlagsEnum@W4FlagsEnum@MilRenderPassFlags@@@@IAEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAI@Z @ 0x180123260
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a9)
{
  ...
  signed int v18; // [rsp+38h] [rbp-49h]
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x7FCu);
  }
  else
  {
    v15 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x7FEu);
    else
      *a9 = v19;
  }
