/*
 * XREFs of ?FindDDAHwndRenderTargetByDisplay@CDesktopRenderTarget@@AEAAPEAVCHwndRenderTarget@@PEBVCDisplay@@@Z @ 0x1801339F0
 * Callers:
        ...
        const struct CDisplay *a2)
{
  ...
  if ( *((_DWORD *)this + 36) )
  {
    while ( 1 )
    {
      ...
      if ( v6[14] == a2 )
      {
        if ( (*((unsigned __int8 (__fastcall **)(const struct CDisplay **))*v6 + 24))(v6) )
          break;
      }
