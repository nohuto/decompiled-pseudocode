/*
 * XREFs of ?GetBounds@CSnapshot@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180175F90
 * Callers:
...
__int64 __fastcall CSnapshot::GetBounds(__int64 a1, __int64 a2, float *a3, __int64 a4)
{
  ...
  *(_DWORD *)a4 = 0;
  *(_DWORD *)(a4 + 4) = 0;
  *(float *)(a4 + 8) = (float)*(int *)(a1 + 56);
  *(float *)(a4 + 12) = (float)*(int *)(a1 + 60);
