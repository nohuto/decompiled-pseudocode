/*
 * XREFs of ?CopyPixels@CFormatConverter@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x1801C56E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_43:
  ReleaseInterfaceNoNULL<CManipulationManager>(v32);
  if ( v10 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x19Cu);
