/*
 * XREFs of ?ProcessExclusiveSurfaceUpdate@CHolographicExclusiveView@@AEAA_NIPEAUEXCLUSIVE_SURFACE_UPDATE@@@Z @ 0x1801BDA40
 * Callers:
 ...
 *     ?CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ @ 0x1801BD824 (-CloseSurfaceHandles@CHolographicExclusiveView@@AEAAXXZ.c)
        ...
        struct EXCLUSIVE_SURFACE_UPDATE *a3)
{
  ...
  if ( AnalogExclusiveSurfaceUpdates >= 0 )
  {
    if ( v14 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x1D0u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, AnalogExclusiveSurfaceUpdates | 0x10000000, 0x1C6u);
  }
  return v3;
}
