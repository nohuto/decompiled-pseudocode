/*
 * XREFs of ?CopyFrom@CGradientColorData@@QEAAJPEBV1@@Z @ 0x1801CF15C
 * Callers:
...
__int64 __fastcall CGradientColorData::CopyFrom(CGradientColorData *this, const struct CGradientColorData *a2)
{
  ...
  *((_DWORD *)this + 14) = 0;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0x9Fu);
    goto LABEL_5;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0xA0u);
LABEL_5:
    *((_DWORD *)this + 6) = 0;
    *((_DWORD *)this + 14) = 0;
  }
