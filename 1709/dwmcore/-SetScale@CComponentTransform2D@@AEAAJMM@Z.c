/*
 * XREFs of ?SetScale@CComponentTransform2D@@AEAAJMM@Z @ 0x18009545C
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetScale(CComponentTransform2D *this, double a2, double a3)
{
  unsigned int v3; // edi
  signed int v6; // eax
  ...
  v3 = 0;
  if ( *((float *)this + 24) != *(float *)&a2 || *((float *)this + 25) != *(float *)&a3 )
  {
    *((_DWORD *)this + 24) = LODWORD(a2);
    *((_DWORD *)this + 25) = LODWORD(a3);
    CResource::NotifyOnChanged(this, 0LL, 0LL);
    v7 = _mm_unpacklo_ps(*(__m128 *)&a2, *(__m128 *)&a3).m128_u64[0];
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 5u, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x144u);
    else
