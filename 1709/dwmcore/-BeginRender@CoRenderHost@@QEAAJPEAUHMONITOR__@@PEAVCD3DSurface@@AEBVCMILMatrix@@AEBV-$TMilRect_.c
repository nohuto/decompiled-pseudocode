/*
 * XREFs of ?BeginRender@CoRenderHost@@QEAAJPEAUHMONITOR__@@PEAVCD3DSurface@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801254F0
 * Callers:
        ...
        float *a5)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0xBEu);
  }
  else
  {
    v10 = *((_QWORD *)a1 + 3);
    ...
    v9 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v20, 0xD3u);
  }
  return v9;
}
