/*
 * XREFs of ?Display@CDisplayDebugFrameCounter@@QEAAJIIPEAVCDrawingContext@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV4@@Z @ 0x18012F544
 * Callers:
        ...
        _OWORD *a8)
{
  ...
  *(_OWORD *)v32 = v16;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x40u);
  }
  else
  {
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v20, 0x43u);
    }
    else
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v21, 0x47u);
      }
      else
      {
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v22, 0x49u);
        }
        else if ( v11 )
        {
