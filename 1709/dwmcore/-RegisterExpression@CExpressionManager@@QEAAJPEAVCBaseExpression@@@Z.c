/*
 * XREFs of ?RegisterExpression@CExpressionManager@@QEAAJPEAVCBaseExpression@@@Z @ 0x1800A1058
 * Callers:
 ...
 *     ?GetMaxStackCount@CKeyframeAnimation@@UEBAIXZ @ 0x1800A3810 (-GetMaxStackCount@CKeyframeAnimation@@UEBAIXZ.c)
...
__int64 __fastcall CExpressionManager::RegisterExpression(CExpressionManager *this, struct CBaseExpression *a2)
{
  ...
  {
    v23 = DynArrayImpl<1>::AddMultipleAndSet((__int64)(v4 + 176), 8u, (__int64)v4, &v34);
    v7 = v23;
    if ( v23 < 0 )
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v7, 0x69u);
    goto LABEL_19;
  }
  v8 = v34;
  v9 = *(unsigned int (__fastcall **)(CKeyframeAnimation *__hidden))(*(_QWORD *)v34 + 168LL);
...
LABEL_40:
      v7 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, v26);
