/*
 * XREFs of ?OpenSharedHandleAsD2DBitmap@CD3DDeviceManager@@UEAAJU_LUID@@PEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@MMVDisplayId@@PEAPEAVCD2DBitmap@@@Z @ 0x18001A290
 * Callers:
        ...
        _QWORD *a10)
{
  ...
  *a10 = 0LL;
  ...
  if ( D3DDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, D3DDevice, 0x703u);
    v10 = v25;
    goto LABEL_15;
  }
  v10 = v25;
...
LABEL_23:
    v23 = v18;
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, v23, v24);
    goto LABEL_15;
  }
  ...
  v16 = v21;
  if ( v21 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, v21, 0x734u);
LABEL_15:
