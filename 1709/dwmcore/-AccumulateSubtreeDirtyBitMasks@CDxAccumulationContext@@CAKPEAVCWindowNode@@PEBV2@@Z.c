/*
 * XREFs of ?AccumulateSubtreeDirtyBitMasks@CDxAccumulationContext@@CAKPEAVCWindowNode@@PEBV2@@Z @ 0x18018B630
 * Callers:
        ...
        const struct CWindowNode *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(struct CWindowNode *, __int64))(*(_QWORD *)v11 + 48LL))(v11, 139LL) )
