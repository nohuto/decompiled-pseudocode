/*
 * XREFs of ?CalculateConditionValue@CConditionalExpression@@AEAAJIPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18015E550
 * Callers:
        ...
        bool *a5)
{
  ...
  v6 = *(_QWORD *)(*((_QWORD *)this + 35) + 16LL * a2);
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v7, 0x15Eu);
  }
  else
  {
    v9 = *((_QWORD *)a3 + 3);
    ...
    {
      v8 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070057, 0x164u);
    }
  }
  return v8;
}
