/*
 * XREFs of ?RemoveWindowNode@CWindowManager@@QEAAJPEAVCWindowNode@@@Z @ 0x1800B6924
 * Callers:
  ...
  if ( Entry >= 0 )
  {
    ...
    if ( v9 )
    {
      for ( i = 0LL; ; ++i )
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v15, 0x98u);
    ...
    else
    {
      ...
      Entry = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x9Fu);
    }
  }
  return (unsigned int)Entry;
}
