/*
 * XREFs of ?GetClippedD2D1CommandListForContext@CPrimitiveGroup@@QEAAJPEAVID2DContextOwner@@PEAVID2DContext@@PEAVCPolygon@@PEAPEAUID2D1PrivateCompositorCommandList@@@Z @ 0x180025F10
 * Callers:
...
LABEL_5:
  ...
  if ( !v7 )
  {
    if ( *((_BYTE *)this + 577) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, NewD2DCommandListForHeatMap, 0x23Fu);
        return v14;
      }
    }
    else
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, NewD2DCommandList, 0x243u);
        return v14;
      }
    }
    v7 = a5;
  ...
  if ( ID2DCommandList < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ID2DCommandList, 0x247u);
  return v14;
}
