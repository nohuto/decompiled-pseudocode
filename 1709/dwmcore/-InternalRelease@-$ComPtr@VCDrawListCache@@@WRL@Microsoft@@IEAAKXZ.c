/*
 * XREFs of ?InternalRelease@?$ComPtr@VCDrawListCache@@@WRL@Microsoft@@IEAAKXZ @ 0x1800844E4
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<CDrawListCache>::InternalRelease(__int64 *a1)
{
  __int64 result; // rax
  __int64 v3; // rcx
