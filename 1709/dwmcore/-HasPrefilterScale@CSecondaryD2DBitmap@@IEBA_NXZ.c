/*
 * XREFs of ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x180092334
 * Callers:
 ...
 *     ?GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z @ 0x180092580 (-GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z.c)
 * Callees:
 *     <none>
 */
