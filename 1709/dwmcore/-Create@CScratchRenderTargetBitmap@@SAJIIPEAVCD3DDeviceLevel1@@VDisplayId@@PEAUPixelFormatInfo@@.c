/*
 * XREFs of ?Create@CScratchRenderTargetBitmap@@SAJIIPEAVCD3DDeviceLevel1@@VDisplayId@@PEAUPixelFormatInfo@@_NPEAPEAV1@@Z @ 0x1800BC078
 * Callers:
        ...
        CHwTextureRenderTarget **a7)
{
  ...
  *a7 = 0LL;
  v11 = HeapAlloc(WPF::g_processHeap, 0, 0x118uLL);
  if ( !v11 )
    ModuleFailFastForHRESULT(2147942414LL, retaddr);
  v12 = CScratchRenderTargetBitmap::CScratchRenderTargetBitmap((__int64)v11, a4);
  v13 = (CHwTextureRenderTarget *)v12;
  if ( v12 )
  {
    CMILCOMBase::InternalAddRef((CMILCOMBase *)(v12 + 144));
    v18 = 24;
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x23u);
