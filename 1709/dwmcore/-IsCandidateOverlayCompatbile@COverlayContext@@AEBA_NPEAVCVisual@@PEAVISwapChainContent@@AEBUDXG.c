/*
 * XREFs of ?IsCandidateOverlayCompatbile@COverlayContext@@AEBA_NPEAVCVisual@@PEAVISwapChainContent@@AEBUDXGI_MULTIPLANE_OVERLAY_ATTRIBUTES@@W4DXGI_MODE_ROTATION@@I_N@Z @ 0x1801433A8
 * Callers:
        ...
        bool a7)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct ISwapChainContent *))(*(_QWORD *)a3 + 104LL))(a3)
    ...
    && (unsigned int)COverlayContext::FindOverlayCandidateIndex(this, 0LL, a3, v12) == -1
    ...
    && (a7 && *((_BYTE *)this + 1187) || *((_BYTE *)this + 1173) || a6 > 2) )
  {
    return 1;
  }
  return v11;
