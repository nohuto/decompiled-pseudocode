/*
 * XREFs of ?_Tidy@?$vector@PEAVCColorGradientStop@@V?$allocator@PEAVCColorGradientStop@@@std@@@std@@IEAAXXZ @ 0x180072284
 * Callers:
...
void __fastcall std::vector<CColorGradientStop *>::_Tidy(__int64 a1)
{
  void *v2; // rcx
