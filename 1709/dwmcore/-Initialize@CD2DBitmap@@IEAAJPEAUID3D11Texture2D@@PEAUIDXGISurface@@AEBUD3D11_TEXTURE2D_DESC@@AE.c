/*
 * XREFs of ?Initialize@CD2DBitmap@@IEAAJPEAUID3D11Texture2D@@PEAUIDXGISurface@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@I@Z @ 0x18004C74C
 * Callers:
        ...
        unsigned int a8)
{
  ...
  *(_OWORD *)(a1 + 232) = v12;
  ...
  {
    v16 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x24Fu);
LABEL_17:
  ...
  if ( ShaderResourceView < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ShaderResourceView, 0x25Fu);
  if ( v16 < 0 )
    goto LABEL_17;
