/*
 * XREFs of ?ComputePrefilteringDimensions@CMILMatrix@@QEBAXIIMAEAI0@Z @ 0x18018F870
 * Callers:
 ...
 *     ?ComputePrefilteredSize@@YAXIMMAEAI@Z @ 0x18018F6E4 (-ComputePrefilteredSize@@YAXIMMAEAI@Z.c)
 */
