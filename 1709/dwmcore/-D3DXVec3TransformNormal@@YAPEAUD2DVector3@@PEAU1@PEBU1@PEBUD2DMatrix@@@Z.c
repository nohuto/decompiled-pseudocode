/*
 * XREFs of ?D3DXVec3TransformNormal@@YAPEAUD2DVector3@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z @ 0x1801CA41C
 * Callers:
 *     ?InitializeForces@CNaturalAnimation@@AEAAXXZ @ 0x1801734D4 (-InitializeForces@CNaturalAnimation@@AEAAXXZ.c)
 *     _lambda_19d6a25917fce60deaaad219aba787fd_::operator() @ 0x180193898 (_lambda_19d6a25917fce60deaaad219aba787fd_--operator().c)
 * Callees:
 *     <none>
 */
