/*
 * XREFs of ?ProcessSetScale@CComponentTransform3D@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPONENTTRANSFORM3D_SETSCALE@@@Z @ 0x180096138
 * Callers:
        ...
        const struct MILCMD_COMPONENTTRANSFORM3D_SETSCALE *a3)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v3, 0x76u);
  return v4;
}
