/*
 * XREFs of ?CreatePrimitiveProperties@CD2DContext@@MEAAJPEAPEAVCD2DPrimitiveProperties@@@Z @ 0x180044540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DContext::CreatePrimitiveProperties(CD2DContext *this, struct CD2DPrimitiveProperties **a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x7B7u);
  }
  else
  {
    v6 = v12;
    ...
    *(_QWORD *)v9 = &CD2DPrimitiveProperties::`vftable'{for `CMILCOMBase'};
    if ( v6 )
