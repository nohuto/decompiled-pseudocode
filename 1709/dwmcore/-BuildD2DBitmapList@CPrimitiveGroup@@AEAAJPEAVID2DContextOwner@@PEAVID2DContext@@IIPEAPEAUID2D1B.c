/*
 * XREFs of ?BuildD2DBitmapList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@IIPEAPEAUID2D1Bitmap@@@Z @ 0x18002696C
 * Callers:
        ...
        struct ID2D1Bitmap **a6)
{
  ...
  if ( a5 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x41Fu);
  }
  return v6;
}
