/*
 * XREFs of ?SetIntensity@CCompositionPointLight@@AEAAXM@Z @ 0x18015C328
 * Callers:
...
void __fastcall CCompositionPointLight::SetIntensity(CCompositionPointLight *this, float a2)
{
  if ( *((float *)this + 53) != a2 )
  {
    *((float *)this + 53) = a2;
