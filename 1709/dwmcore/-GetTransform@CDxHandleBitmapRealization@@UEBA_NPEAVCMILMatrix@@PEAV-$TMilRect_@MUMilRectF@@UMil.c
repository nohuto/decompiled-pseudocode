/*
 * XREFs of ?GetTransform@CDxHandleBitmapRealization@@UEBA_NPEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18004D8A0
 * Callers:
 ...
 *     ?GetRotation@CDxHandleBitmapRealization@@UEBA?AW4DXGI_MODE_ROTATION@@XZ @ 0x18004D300 (-GetRotation@CDxHandleBitmapRealization@@UEBA-AW4DXGI_MODE_ROTATION@@XZ.c)
...
LABEL_31:
        ...
        v45 = (_OWORD *)Windows::Foundation::Numerics::operator*(&v53, a2, &v46);
        *(_OWORD *)a2 = *v45;
        *(_OWORD *)(a2 + 16) = v45[1];
        *(_OWORD *)(a2 + 32) = v45[2];
        *(_OWORD *)(a2 + 48) = v45[3];
