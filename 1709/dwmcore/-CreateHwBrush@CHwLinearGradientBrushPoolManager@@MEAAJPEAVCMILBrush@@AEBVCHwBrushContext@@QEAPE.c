/*
 * XREFs of ?CreateHwBrush@CHwLinearGradientBrushPoolManager@@MEAAJPEAVCMILBrush@@AEBVCHwBrushContext@@QEAPEAVCHwBrush@@@Z @ 0x1801BBED0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CHwBrush **const a4)
{
  ...
  *((_DWORD *)v8 + 20) = 1;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x36u);
