/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x18019E350
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InteractionOutput *a4)
{
  ...
  if ( !a3 )
  {
    if ( QueryPerformanceCounter(&PerformanceCount)
      && (unsigned int)QpcTimeConverter::QpcToMicroSec(
                         (QpcTimeConverter *)&this[15].OwningThread,
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct _RTL_CRITICAL_SECTION *))&this->DebugInfo[1].Flags)(this)
    && LODWORD(this[13].SpinCount) )
  {
    EnterCriticalSection(this + 14);
    v9 = CQueue<CBufferedInteractionOutput *>::PeekFirst(&this[13].OwningThread, v8, &PerformanceCount);
    if ( v9 )
    {
