/*
 * XREFs of ??2?$TValueResource@U_MilMatrix3x2D@@UMILCMD_MATRIXRESOURCE@@$0FI@@@KAPEAX_K@Z @ 0x1801462DC
 * Callers:
...
LPVOID TValueResource<_MilMatrix3x2D,MILCMD_MATRIXRESOURCE,88>::operator new()
{
  LPVOID result; // rax
