/*
 * XREFs of McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx @ 0x18012A134
 * Callers:
        ...
        __int64 a33)
{
  ...
  __int64 *v97; // [rsp+220h] [rbp+120h]
  __int64 v98; // [rsp+228h] [rbp+128h]
  int v99; // [rsp+260h] [rbp+160h] BYREF
  __int64 v100; // [rsp+268h] [rbp+168h] BYREF
  ...
  v96 = 8LL;
  v98 = 8LL;
  return McGenEventWriteUM(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_FRAMEINFO, 0x20u, &v36);
}
