/*
 * XREFs of ?GetReservedPlaneInfo@CPlaneCaptureRenderTargetEngine@@QEAAJPEAUReservedPlaneInfo@COverlayContext@@@Z @ 0x180139AF4
 * Callers:
        ...
        struct COverlayContext::ReservedPlaneInfo *a2)
{
  ...
  if ( !*((_BYTE *)this + 210) || TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)this + 95) )
    return 2291674884LL;
  memset_0(a2, 0, 0x90uLL);
  v4 = *((_DWORD *)this + 89);
  v5 = *((_DWORD *)this + 88);
  HIDWORD(v20) = *((_DWORD *)this + 80);
  HIDWORD(v16) = *((_DWORD *)this + 76);
  LODWORD(v17) = *((_DWORD *)this + 77);
  v6 = (int)*((float *)this + 91);
  DWORD1(v19) = 1;
  LODWORD(v22) = 2;
  DWORD1(v17) = v6;
  DWORD2(v17) = (int)*((float *)this + 92);
  HIDWORD(v17) = (int)*((float *)this + 93);
  v7 = v17;
  LODWORD(v18) = (int)*((float *)this + 94);
  DWORD1(v18) = (int)*((float *)this + 95);
  DWORD2(v18) = (int)*((float *)this + 96);
  HIDWORD(v18) = (int)*((float *)this + 97);
  LODWORD(v19) = (int)*((float *)this + 98);
  v8 = *(_QWORD *)(*((_QWORD *)this + 10) + 24LL);
  v9 = *((_QWORD *)this + 43);
  *((_OWORD *)a2 + 1) = v16;
  *((_QWORD *)a2 + 16) = v9;
  v10 = v18;
