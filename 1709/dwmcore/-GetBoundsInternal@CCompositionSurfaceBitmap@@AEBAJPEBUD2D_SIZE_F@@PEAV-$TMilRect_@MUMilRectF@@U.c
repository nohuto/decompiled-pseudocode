/*
 * XREFs of ?GetBoundsInternal@CCompositionSurfaceBitmap@@AEBAJPEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800286F8
 * Callers:
...
__int64 __fastcall CCompositionSurfaceBitmap::GetBoundsInternal(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(a1 + 96) )
  {
    ...
    {
      v10 = 0;
      v5 = *(_QWORD *)(v4 + 96) + 144LL;
      v6 = *(__int64 (__fastcall **)(__int64, _BYTE *, __int128 *))(*(_QWORD *)v5 + 40LL);
