/*
 * XREFs of ?SetAnchor@CComponentTransform2D@@AEAAJMM@Z @ 0x18009557C
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetAnchor(CComponentTransform2D *this, double a2, double a3)
{
  ...
  if ( *((float *)this + 18) != *(float *)&a2 || *((float *)this + 19) != *(float *)&a3 )
  {
    ...
    *((_DWORD *)this + 19) = LODWORD(a3);
    ...
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 0, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0xF0u);
    else
