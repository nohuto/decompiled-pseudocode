/*
 * XREFs of ??0CInlineStorageBase@PrimitiveStorage@@QEAA@AEBUGeometryCounts@CDrawListPrimitive@@I@Z @ 0x1800BA968
 * Callers:
        ...
        const struct CDrawListPrimitive::GeometryCounts *a2)
{
  ...
  *(_QWORD *)&v5 = (char *)this
                 + (((((_BYTE)this - 8) & 0xF) + 15) & 0x10)
                 - (unsigned __int64)(((_BYTE)this - 8) & 0xF)
                 + 104;
  ...
  *((_QWORD *)&v6 + 1) = (((((_BYTE)v6 + 8 * (_BYTE)v2) & 0xF) + 15) & 0x10)
