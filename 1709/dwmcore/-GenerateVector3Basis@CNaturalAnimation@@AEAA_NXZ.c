/*
 * XREFs of ?GenerateVector3Basis@CNaturalAnimation@@AEAA_NXZ @ 0x180172EF4
 * Callers:
 ...
 *     atan2f_0 @ 0x1800C5D32 (atan2f_0.c)
 *     ?D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z @ 0x1801C957C (-D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z.c)
 *     ?D2DMatrixRotationQuaternion@@YAPEAUD2DMatrix@@PEAU1@PEBUD2DQuaternion@@@Z @ 0x1801C9C68 (-D2DMatrixRotationQuaternion@@YAPEAUD2DMatrix@@PEAU1@PEBUD2DQuaternion@@@Z.c)
 ...
 *     ?D3DXVec3Cross@@YAPEAUD2DVector3@@PEAU1@PEBU1@1@Z @ 0x1801CA294 (-D3DXVec3Cross@@YAPEAUD2DVector3@@PEAU1@PEBU1@1@Z.c)
 */
...
char __fastcall CNaturalAnimation::GenerateVector3Basis(CNaturalAnimation *this)
{
  ...
  if ( (v1 & 4) != 0 )
  {
    v4 = *((float *)this + 71) - *((float *)this + 74);
    v5 = *((float *)this + 72) - *((float *)this + 75);
    v6 = *((float *)this + 73) - *((float *)this + 76);
    ...
    if ( (v1 & 1) == 0
      || (v10 = (float *)D3DXVec3Cross(
                           (CNaturalAnimation *)((char *)this + 320),
          ...
          v13 < 0.0000011920929) )
    {
      ...
      if ( v14 >= 0.0000011920929 )
      {
        ...
        D2DMatrixRotationQuaternion((CNaturalAnimation *)((char *)this + 396), (const struct D2DQuaternion *)v20);
        D2DMatrixInverse((CNaturalAnimation *)((char *)this + 460), 0LL, v18);
        v2 = 1;
      }
    }
    *((_BYTE *)this + 524) &= ~4u;
