/*
 * XREFs of ?QueryInterface@CMesh2DEffect@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801DADE0
 * Callers:
 *     ?QueryInterface@CMesh2DEffect@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C72E0 (-QueryInterface@CMesh2DEffect@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
