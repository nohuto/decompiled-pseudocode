/*
 * XREFs of ?GetCurrentSize@CCachedVisualImage@@QEBAXPEAI0@Z @ 0x18008DC1C
 * Callers:
 ...
 *     ?GetSize@CCachedVisualImage@@UEBAXPEAI0@Z @ 0x18008DFA0 (-GetSize@CCachedVisualImage@@UEBAXPEAI0@Z.c)
