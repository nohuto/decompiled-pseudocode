/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UINPUT_REGION_CONFIG@@$0A@@@QEAAJPEFBUINPUT_REGION_CONFIG@@I@Z @ 0x180132F24
 * Callers:
...
__int64 __fastcall DynArray<INPUT_REGION_CONFIG,0>::AddMultipleAndSet(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // rcx
  unsigned int v5; // eax
  DWORD v6; // ebx
  ...
  {
    v9 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0x48u, 1, a2);
    v6 = v9;
    if ( v9 < 0 )
  ...
  else
  {
    ...
    *(_OWORD *)(v7 + 8 * v8 + 32) = *(_OWORD *)(a2 + 32);
    *(_OWORD *)(v7 + 8 * v8 + 48) = *(_OWORD *)(a2 + 48);
    *(_QWORD *)(v7 + 8 * v8 + 64) = *(_QWORD *)(a2 + 64);
    *(_DWORD *)(a1 + 24) = a3;
  }
  return v6;
}
