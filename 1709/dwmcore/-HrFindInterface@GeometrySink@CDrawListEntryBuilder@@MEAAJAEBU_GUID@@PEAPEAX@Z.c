/*
 * XREFs of ?HrFindInterface@GeometrySink@CDrawListEntryBuilder@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180151E40
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80004002, 0xC8u);
  }
  else
  {
