/*
 * XREFs of ?GammaConvert_128bppABGR_64bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1801C72B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z @ 0x1801C87A8 (-Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z.c)
 */
