/*
 * XREFs of ?FillRectanglesAsDrawList@CDrawingContext@@AEAAJPEBUMilRectF@@I0PEAVIImageSource@@PEBUD2D_MATRIX_3X2_F@@MW4Enum@MilCompositingMode@@_N@Z @ 0x18003EEF0
 * Callers:
 ...
 *     ?SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z @ 0x18006B0E0 (-SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z.c)
        ...
        bool a9)
{
  ...
  int v25; // ecx
  int v26; // eax
  __int64 (__fastcall *v27)(CCachedVisualImage *__hidden, struct IBitmapRealization **); // rax
  int CurrentRenderingRealization; // eax
  void (__fastcall *v29)(CDxHandleBitmapRealization *__hidden, unsigned int *, unsigned int *); // rax
  ...
  CCachedVisualImage *v56; // [rsp+80h] [rbp-71h] BYREF
  ...
  CCachedVisualImage **v62; // [rsp+D0h] [rbp-21h] BYREF
  __int64 v63; // [rsp+D8h] [rbp-19h]
...
LABEL_13:
    v20[11] = v25;
    v20[14] = -1;
    v27 = *(__int64 (__fastcall **)(CCachedVisualImage *__hidden, struct IBitmapRealization **))(*(_QWORD *)v56 + 80LL);
    ...
    else if ( v27 == CCachedVisualImage::GetCurrentRenderingRealization )
    {
      CurrentRenderingRealization = CCachedVisualImage::GetCurrentRenderingRealization(v56, &v51);
    }
    else
    {
    ...
    {
      v29 = *(void (__fastcall **)(CDxHandleBitmapRealization *__hidden, unsigned int *, unsigned int *))(*(_QWORD *)v51 + 32LL);
      if ( v29 == CDxHandleBitmapRealization::GetSize )
      {
        CDxHandleBitmapRealization::GetSize(v51, &v50, &v49);
      }
      else if ( v29 == CCachedVisualImage::GetSize )
      {
        CCachedVisualImage::GetSize(v51, &v50, &v49);
      }
      else
      {
        v29(v51, &v50, &v49);
...
LABEL_60:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x7F9u);
  v10 = v52[0];
LABEL_27:
  if ( v51 )
