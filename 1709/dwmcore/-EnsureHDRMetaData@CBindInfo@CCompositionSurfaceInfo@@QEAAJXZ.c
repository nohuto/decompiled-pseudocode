/*
 * XREFs of ?EnsureHDRMetaData@CBindInfo@CCompositionSurfaceInfo@@QEAAJXZ @ 0x180076114
 * Callers:
...
__int64 __fastcall CCompositionSurfaceInfo::CBindInfo::EnsureHDRMetaData(CCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( CompositionSurfaceHDRMetaData < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CompositionSurfaceHDRMetaData | 0x10000000, 0x687u);
    if ( v2 < 0 )
      *v1 = 0;
  }
