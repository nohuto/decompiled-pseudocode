/*
 * XREFs of ?AddNineGrid@CoordMap@@QEAAJHAEBUD2D_RECT_F@@AEBVInsets@@01H@Z @ 0x18009F8A8
 * Callers:
 ...
 *     ?Clamp@Insets@@SA?AV1@AEBV1@MM@Z @ 0x1800BD6F4 (-Clamp@Insets@@SA-AV1@AEBV1@MM@Z.c)
...
LABEL_21:
    ...
    if ( v14 > 0.0 )
    {
      ...
      if ( v57 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v57, 0x21Au);
        return v42;
      }
      v30 = v75;
    }
    ...
    if ( v41 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v41, 0x221u);
      return v42;
    }
    v30 = v75;
LABEL_25:
    if ( v36 || v32 )
    {
      ...
      if ( v45 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v45, 0x228u);
        return v42;
      }
      if ( v36 )
      {
        ...
        if ( v58 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v58, 0x22Du);
          return v42;
        }
      }
    }
    ...
    if ( v72 )
    {
      ...
      if ( v59 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v59, 0x232u);
        return v42;
      }
    }
    else
...
LABEL_33:
        ...
        if ( v73 || v46 )
        {
          ...
          if ( v53 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v53, 0x240u);
            return v42;
          }
          if ( v51 )
          {
            ...
            if ( v60 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v60, 0x245u);
              return v42;
            }
          }
        }
        if ( v24 )
        {
          ...
          if ( v55 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v55, 0x24Cu);
            return v42;
          }
        }
        return 0;
    ...
    if ( v50 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v50, 0x239u);
      return v42;
    }
    v46 = v67;
    goto LABEL_33;
