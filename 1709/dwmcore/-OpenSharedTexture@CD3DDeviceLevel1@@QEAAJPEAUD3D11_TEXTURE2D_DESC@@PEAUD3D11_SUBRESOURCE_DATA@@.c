/*
 * XREFs of ?OpenSharedTexture@CD3DDeviceLevel1@@QEAAJPEAUD3D11_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAX_NPEAPEAUID3D11Texture2D@@@Z @ 0x180021BBC
 * Callers:
...
LABEL_5:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x76Eu);
  }
  else
  {
    ...
    if ( v14 >= 0 )
      goto LABEL_5;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x774u);
  }
LABEL_6:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
    McTemplateU0(&Microsoft_Windows_Dwm_Core_Provider_Context, &OPEN_SHARED_TEXTURE_EVENT_Stop);
  return CD3DDeviceLevel1::TranslateDXGIorD3DErrorInContext((__int64)this, v12, 7);
}
