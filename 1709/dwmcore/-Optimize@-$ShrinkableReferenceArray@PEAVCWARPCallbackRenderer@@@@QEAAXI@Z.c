/*
 * XREFs of ?Optimize@?$ShrinkableReferenceArray@PEAVCWARPCallbackRenderer@@@@QEAAXI@Z @ 0x1800BFF78
 * Callers:
...
void __fastcall ShrinkableReferenceArray<CWARPCallbackRenderer *>::Optimize(__int64 a1, unsigned int a2)
{
  unsigned int v2; // ebx
