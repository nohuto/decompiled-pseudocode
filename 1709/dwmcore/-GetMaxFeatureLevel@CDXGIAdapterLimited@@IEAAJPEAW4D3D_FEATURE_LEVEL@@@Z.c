/*
 * XREFs of ?GetMaxFeatureLevel@CDXGIAdapterLimited@@IEAAJPEAW4D3D_FEATURE_LEVEL@@@Z @ 0x1800753CC
 * Callers:
         ...
         &v13) < 0 )
  {
    ...
    if ( v8 < 0 )
    {
      if ( v8 != -2005270524 )
      {
        v12 = v8;
        v5 = v8;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1A6u);
        goto LABEL_6;
      }
      goto LABEL_7;
    }
