/*
 * XREFs of ?RunShader@CSurfaceShaderComposer@@QEAAJPEBXIPEAPEAUID3D11ShaderResourceView@@IAEBUD3D11_VIEWPORT@@W4Enum@BlendMode@@AEBUSamplerMode@@_NPEAUID3D11RenderTargetView@@PEAUID3D11PixelShader@@PEBUtagRECT@@5@Z @ 0x1801AB588
 * Callers:
        ...
        char a13)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, D3DSamplerStateNoRef, 0xDDu);
  }
  else
  {
    if ( a12 )
    ...
    (*(void (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v17 + 1048LL))(v17, *(_QWORD *)(a1 + 48), &v34);
    if ( a9 )
    {
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v24, 0x10Au);
    }
    else
    {
      v25 = v39;
      *v39 = *a2;
      ...
      v25[7] = a2[7];
      v25[8] = a2[8];
      (*(void (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v17 + 120LL))(v17, *(_QWORD *)(a1 + 40), 0LL);
      if ( a13 )
      ...
      (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v17 + 280LL))(
        v17,
        *(_QWORD *)(*(_QWORD *)(a1 + 72) + 8LL * v35 + 1200),
        0LL,
        0xFFFFFFFFLL);
