/*
 * XREFs of _anonymous_namespace_::Encoder::Serialize_0 @ 0x1800064D8
 * Callers:
...
__int64 __fastcall anonymous_namespace_::Encoder::Serialize_0(unsigned int *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rdx
  ...
  anonymous_namespace_::Encoder::AppendValue(&v6, a1[18]);
  anonymous_namespace_::Encoder::AppendValue(&v6, a1[19]);
  anonymous_namespace_::Encoder::AppendValue(&v6, a1[20]);
