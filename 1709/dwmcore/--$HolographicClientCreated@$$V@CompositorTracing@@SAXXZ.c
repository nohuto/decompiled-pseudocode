/*
 * XREFs of ??$HolographicClientCreated@$$V@CompositorTracing@@SAXXZ @ 0x1801BF638
 * Callers:
...
void CompositorTracing::HolographicClientCreated<>()
{
  ...
  if ( v0 && TraceLoggingProviderEnabled(v0, 0, 0LL) )
  {
    ...
    CompositorTracing::HolographicClientCreated_(v1);
  }
}
