/*
 * XREFs of ?IsEmpty@?$TMilRect@HUtagRECT@@U_CMilRectL_@RectUniqueness@@@@QEBA_NXZ @ 0x18007816C
 * Callers:
 ...
 *     ?OnChanged@CRgnGeometry@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x180096AB0 (-OnChanged@CRgnGeometry@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
