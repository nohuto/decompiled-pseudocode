/*
 * XREFs of ?Reset@CBindInfo@CCompositionSurfaceInfo@@QEAAXXZ @ 0x180076684
 * Callers:
...
void __fastcall CCompositionSurfaceInfo::CBindInfo::Reset(CCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( *((_DWORD *)this + 14) )
  {
    ...
    do
    {
      ...
      v6 = (CBitmapRealization *)((char *)v4 + 88);
      v7 = *(__int64 (__fastcall **)(CBitmapRealization *, const struct IDeviceResourceNotify *))(*((_QWORD *)v4 + 11)
                                                                                                + 32LL);
