/*
 * XREFs of ?CopyPixelsToBitmap@CHwDeviceBitmapColorSource@@QEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IPEBV2@PEAVIBitmapDest@@HH@Z @ 0x1801B6994
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *(_DWORD *)(v21 + 160) == DisplayId::None )
  {
    ...
    if ( D3DSurfaceLevel >= 0 )
    {
      ...
      v9 = v25;
      if ( v25 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v25, 0x366u);
      goto LABEL_77;
    }
    v48 = 858;
LABEL_74:
...
LABEL_65:
  v46 = v9;
LABEL_75:
  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v46, v48);
LABEL_76:
  v24 = v49;
LABEL_77:
  ReleaseInterfaceNoNULL<CManipulationManager>(v54);
  ReleaseInterfaceNoNULL<ID2D1Bitmap1>(v61);
