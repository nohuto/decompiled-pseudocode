/*
 * XREFs of ?CheckD3D11Caps@CD3DDeviceLevel1@@AEAAJXZ @ 0x1800209AC
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::CheckD3D11Caps(CD3DDeviceLevel1 *this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x3BAu);
  }
  else
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x3BDu);
    }
    else
    {
      if ( v12 )
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x3C4u);
      }
      else if ( v10 )
      {
        v8 = v9;
