/*
 * XREFs of ?SetFirstStop@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@PEAIPEAU_D3DCOLORVALUE@@@Z @ 0x1801DA08C
 * Callers:
 *     ?CreateWellFormedGradientArray@CGradientTextureGenerator@@CAXPEBVCGradientSpanInfo@@PEAV?$DynArray@UMILGradientStop@@$0A@@@W4Enum@MilColorInterpolationMode@@_NPEAU_D3DCOLORVALUE@@4@Z @ 0x1801D9C2C (-CreateWellFormedGradientArray@CGradientTextureGenerator@@CAXPEBVCGradientSpanInfo@@PEAV-$DynArr.c)
 * Callees:
 *     ?InterpolateColors@CGradientTextureGenerator@@CAXPEBU_D3DCOLORVALUE@@0MMMPEAU2@@Z @ 0x1801D9D64 (-InterpolateColors@CGradientTextureGenerator@@CAXPEBU_D3DCOLORVALUE@@0MMMPEAU2@@Z.c)
 *     ?IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z @ 0x1801D9E04 (-IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z.c)
 *     ?IsPositionLessThanOrEqual@CGradientTextureGenerator@@CAHMM@Z @ 0x1801D9E38 (-IsPositionLessThanOrEqual@CGradientTextureGenerator@@CAHMM@Z.c)
 */
...
void __fastcall CGradientTextureGenerator::SetFirstStop(float **a1, _DWORD *a2)
{
  ...
  v12 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*(float *)(v6 + 20 * v9)) & _xmm);
