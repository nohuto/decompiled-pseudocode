/*
 * XREFs of wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x1800011D0
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$shutdown_aware_object@VEnabledStateManager@details@wil@@@wil@@QEAA@XZ @ 0x1800C2554 (--0-$shutdown_aware_object@VEnabledStateManager@details@wil@@@wil@@QEAA@XZ.c)
 */
