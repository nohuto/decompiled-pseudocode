/*
 * XREFs of ?GetRealizationBoundsAndTransforms@CHwBrushContext@@QEBAXPEAVCMILBrushBitmap@@AEAVCMILMatrix@@AEAUBitmapToXSpaceTransform@@AEAV?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@@Z @ 0x1800BFDCC
 * Callers:
