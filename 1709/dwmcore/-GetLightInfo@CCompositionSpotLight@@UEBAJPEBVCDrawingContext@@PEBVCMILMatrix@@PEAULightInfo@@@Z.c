/*
 * XREFs of ?GetLightInfo@CCompositionSpotLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x18015D790
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 3;
  ...
  do
  {
    *v6 = *(float *)((char *)v6 + v5 + 212) * *((float *)this + 74);
    ++v6;
    --v9;
  }
  while ( v9 );
  ...
  do
  {
    *v10 = *(float *)((char *)v10 + v5 + 212) * *((float *)this + 75);
    ++v10;
    --v11;
  }
  while ( v11 );
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x4Cu);
  }
  else
  {
    *((_OWORD *)a4 + 5) = *(_OWORD *)CCompositionLight::CalcEyePointOrVector(v13, v21, *((_QWORD *)this + 22));
    *(_QWORD *)((char *)a4 + 36) = *((_QWORD *)this + 23);
    v15 = (CCompositionLight *)*((unsigned int *)this + 48);
    *((_DWORD *)a4 + 11) = (_DWORD)v15;
    *((_QWORD *)a4 + 6) = *(_QWORD *)((char *)this + 196);
    *((_DWORD *)a4 + 14) = *((_DWORD *)this + 51);
    CCompositionLight::TransformAttenuation(
      v15,
      (CCompositionSpotLight *)((char *)this + 160),
