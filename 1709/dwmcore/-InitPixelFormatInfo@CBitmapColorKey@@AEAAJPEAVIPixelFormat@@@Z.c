/*
 * XREFs of ?InitPixelFormatInfo@CBitmapColorKey@@AEAAJPEAVIPixelFormat@@@Z @ 0x1801BB9A4
 * Callers:
...
{
  __int64 v3; // rax
  signed int IsSupportedColorKeyFormat; // eax
  ...
  *((_DWORD *)this + 12) = *(_DWORD *)(v3 + 8);
  ...
  if ( IsSupportedColorKeyFormat < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, IsSupportedColorKeyFormat, 0x17Du);
  return 0LL;
}
