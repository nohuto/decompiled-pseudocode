/*
 * XREFs of ??0?$CInputTypeContext@UDwmPenInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@QEAA@W4InputType@@@Z @ 0x1800B7A98
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  *(_OWORD *)(a1 + 20) = xmmword_18020FF90;
  *(_OWORD *)(a1 + 36) = xmmword_18020FFA0;
  *(_OWORD *)(a1 + 52) = xmmword_18020FFB0;
  *(_OWORD *)(a1 + 68) = xmmword_18020FFC0;
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_QWORD *)(a1 + 96) = 0LL;
  *(_QWORD *)(a1 + 104) = 0LL;
  *(_DWORD *)(a1 + 112) = 0;
