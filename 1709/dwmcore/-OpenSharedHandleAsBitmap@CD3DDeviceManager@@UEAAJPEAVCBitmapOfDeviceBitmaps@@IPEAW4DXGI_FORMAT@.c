/*
 * XREFs of ?OpenSharedHandleAsBitmap@CD3DDeviceManager@@UEAAJPEAVCBitmapOfDeviceBitmaps@@IPEAW4DXGI_FORMAT@@PEAV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@U_LUID@@VDisplayId@@PEAX_NI@Z @ 0x1801A5870
 * Callers:
 *     <none>
 * Callees:
        ...
        int a10)
{
  ...
  *(_QWORD *)&v28 = a4;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v14, 0x759u);
    goto LABEL_12;
  }
  ...
  if ( D3DDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, D3DDevice, 0x75Bu);
    v11 = v27;
    goto LABEL_16;
  }
  v11 = v27;
  ...
  if ( Cache >= 0 )
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v18, 0x778u);
      v13 = v25;
    }
    else
    {
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v19, 0x77Cu);
      }
      else
      {
        v20 = (_DWORD *)v28;
...
LABEL_12:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, Cache, 0x767u);
  v12 = v26;
LABEL_14:
  if ( v12 )
