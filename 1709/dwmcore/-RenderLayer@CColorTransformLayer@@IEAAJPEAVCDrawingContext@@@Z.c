/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18014BCF4
 * Callers:
...
__int64 __fastcall CColorTransformLayer::RenderLayer(CColorTransformLayer *this, struct CDrawingContext *a2)
{
  ...
  *(float *)&v29[2] = (float)*((int *)this + 6);
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 96LL))(v6, &v26);
  v9 = v8;
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x64u);
  }
  else
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *))(**((_QWORD **)a2 + 48) + 216LL))(
            *((_QWORD *)a2 + 48),
            0LL,
            &v24);
    v9 = v10;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x69u);
    }
    else
    {
      v28[0] = 10;
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x7Au);
      }
      else
      {
        v12 = *((_QWORD *)this + 14);
        ...
        if ( v20 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v20, 0xA7u);
        }
        else
        {
          LODWORD(v25) = 2;
          ...
          if ( v21 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v21, 0xACu);
          }
          else
          {
            ...
            v22 = CDrawingContext::FillEffect(a2, v24, (__int64)v29, (__int64)v27, 1);
            v9 = v22;
            if ( v22 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v22, 0xC4u);
            }
  ...
  ReleaseInterfaceNoNULL<ID2D1Bitmap1>(v26);
  if ( v24 )
