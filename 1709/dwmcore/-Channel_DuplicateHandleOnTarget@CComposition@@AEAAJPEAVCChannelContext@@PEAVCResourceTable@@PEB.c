/*
 * XREFs of ?Channel_DuplicateHandleOnTarget@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_CHANNEL_DUPLICATEHANDLEONTARGET@@@Z @ 0x1800AB1D0
 * Callers:
        ...
        const struct MILCMD_CHANNEL_DUPLICATEHANDLEONTARGET *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, AttachedChannel, 0x86Fu);
  }
  else
  {
    ...
    v8 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v9, 0x877u);
  }
