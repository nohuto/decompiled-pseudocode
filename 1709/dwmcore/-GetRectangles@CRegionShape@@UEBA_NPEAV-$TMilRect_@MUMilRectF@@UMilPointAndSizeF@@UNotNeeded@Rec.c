/*
 * XREFs of ?GetRectangles@CRegionShape@@UEBA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@I@Z @ 0x180034FE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 && a3 == CRegionShape::GetRectCount(a1) )
  {
    ...
    if ( v9 )
    {
      ...
      if ( (_DWORD)v4 )
      {
        ...
        do
        {
          *(v10 - 1) = (float)*(int *)&v11[(_QWORD)v10 - 4];
