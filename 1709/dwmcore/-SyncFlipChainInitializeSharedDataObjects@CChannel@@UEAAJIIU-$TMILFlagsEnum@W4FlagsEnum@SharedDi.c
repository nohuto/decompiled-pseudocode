/*
 * XREFs of ?SyncFlipChainInitializeSharedDataObjects@CChannel@@UEAAJIIU?$TMILFlagsEnum@W4FlagsEnum@SharedDisplaySurface@@@@AEBUtagRECT@@PEBX22@Z @ 0x180123090
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  signed int *v22; // [rsp+68h] [rbp-8h]
  struct _RTL_CRITICAL_SECTION *v23; // [rsp+90h] [rbp+20h] BYREF
  signed int v24; // [rsp+98h] [rbp+28h] BYREF
  ...
  if ( v13 < 0 )
  {
    v16 = 2405;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, v16);
    goto LABEL_8;
  }
  v14 = v24;
  if ( v24 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v24, 0x966u);
LABEL_8:
