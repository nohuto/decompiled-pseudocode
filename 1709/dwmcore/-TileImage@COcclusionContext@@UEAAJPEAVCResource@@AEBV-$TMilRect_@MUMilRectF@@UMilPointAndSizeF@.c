/*
 * XREFs of ?TileImage@COcclusionContext@@UEAAJPEAVCResource@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBUMilPoint2F@@M@Z @ 0x18005DAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall COcclusionContext::TileImage(__int64 a1, __int64 a2)
{
  ...
  {
    v4 = v11;
    *(_QWORD *)&v12 = *(_QWORD *)(a1 + 808);
    LOBYTE(v13) = 1;
    v5 = *(unsigned int *)(a1 + 1176);
    *((_QWORD *)&v12 + 1) = (a2 - 16) & -(__int64)(a2 != 0);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6 < (unsigned int)v5 ? 0x80070216 : 0, 0xB5u);
    }
    else if ( v4 <= *(_DWORD *)(a1 + 1172) )
    {
      v9 = *(_QWORD *)(a1 + 1152);
      v10 = 5 * v5;
      *(_OWORD *)(v9 + 8 * v10) = v12;
    ...
    {
      v7 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 1152, 40LL, 1LL, &v12);
      if ( v7 < 0 )
