/*
 * XREFs of ?PushPolygon@CBspNode@@QEAAJPEAVCPolygon@@_N@Z @ 0x1801D8B9C
 * Callers:
...
__int64 __fastcall CBspNode::PushPolygon(CBspNode *this, struct CPolygon *a2, bool a3)
{
  ...
  if ( *((_DWORD *)this + 14) )
  {
    ...
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x98u);
        goto LABEL_36;
      }
    }
    if ( v18 )
    {
      if ( !*((_QWORD *)this + 2) )
      {
        v9 = (char *)CAnimationLoggingManager::operator new();
        if ( v9 )
        {
        ...
        *((_QWORD *)this + 2) = v9;
        ...
        {
          v6 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0xABu);
          goto LABEL_34;
        }
      }
      v11 = v17;
    ...
    if ( !*((_QWORD *)this + 3) )
    {
      v12 = (char *)CAnimationLoggingManager::operator new();
      if ( v12 )
      {
...
LABEL_34:
    ...
    v14 = 183;
LABEL_33:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v7, v14);
    goto LABEL_34;
  }
