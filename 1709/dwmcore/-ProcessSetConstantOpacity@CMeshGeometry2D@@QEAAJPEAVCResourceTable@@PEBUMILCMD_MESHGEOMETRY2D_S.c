/*
 * XREFs of ?ProcessSetConstantOpacity@CMeshGeometry2D@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MESHGEOMETRY2D_SETCONSTANTOPACITY@@@Z @ 0x180172488
 * Callers:
        ...
        const struct MILCMD_MESHGEOMETRY2D_SETCONSTANTOPACITY *a3)
{
  ...
  {
    v5 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x88980403, 0x3Bu);
  }
  return v5;
}
