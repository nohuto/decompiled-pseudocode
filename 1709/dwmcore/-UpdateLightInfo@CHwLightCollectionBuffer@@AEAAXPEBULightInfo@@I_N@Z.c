/*
 * XREFs of ?UpdateLightInfo@CHwLightCollectionBuffer@@AEAAXPEBULightInfo@@I_N@Z @ 0x1800B7834
 * Callers:
 ...
 *     ?Transpose@CMILMatrix@@QEAAXXZ @ 0x18011C2C8 (-Transpose@CMILMatrix@@QEAAXXZ.c)
 */
        ...
        char a4)
{
  ...
  *((_QWORD *)this + 60) = 0LL;
  if ( a3 )
  {
    ...
    do
    {
      ...
      {
        v8 = 1;
        *(__m128 *)((char *)this + 472) = _mm_add_ps(*(__m128 *)((char *)this + 472), *(__m128 *)(v9 - 8));
      }
      v9 += 232;
      --v10;
    }
  ...
  *((_DWORD *)this + 4) = -1;
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( *((_DWORD *)v14 - 3) )
      {
        ...
        *(_OWORD *)((char *)this + v20 + 84) = *(_OWORD *)(v14 + 152);
        *(_OWORD *)((char *)this + v20 + 100) = *(_OWORD *)(v14 + 168);
        *(_OWORD *)((char *)this + v20 + 116) = *(_OWORD *)(v14 + 184);
        *(_OWORD *)((char *)this + v20 + 132) = *(_OWORD *)(v14 + 200);
  ...
  memset_0((char *)this + 96 * v11 + 280, 0, 96 * (2LL - v11));
  if ( v8 || !a4 )
