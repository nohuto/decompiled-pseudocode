/*
 * XREFs of ?ResetAdvancedDirectFlipState@CCompositionSurfaceInfo@@AEAAXPEAVCBitmapRealization@@@Z @ 0x18004AE88
 * Callers:
...
{
  __int64 (__fastcall **v2)(CBitmapRealization *, const struct _GUID *, void **); // rax
  __int64 (__fastcall *v3)(CBitmapRealization *, const struct _GUID *, void **); // rax
  int v4; // eax
