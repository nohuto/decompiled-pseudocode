/*
 * XREFs of ?MergeAtlases@CAtlasManager@@AEAAXPEA_N@Z @ 0x1801AE740
 * Callers:
...
void __fastcall CAtlasManager::MergeAtlases(CAtlasManager *this, bool *a2)
{
  ...
  *(_QWORD *)v2 = 0LL;
  ...
  if ( v10 != *(_DWORD *)(v9 + 28) )
  {
    ...
    while ( v11 != v13 )
    {
      CAtlasTexture::CopyFrom(*v11, (const struct CAtlasTexture *)v9, &v14);
      v5 = 1;
      if ( v14 == v12 )
        break;
      ++v11;
  ...
  *(_QWORD *)v9 = &CAtlasTexture::`vftable';
  ...
  WPF::ProcessHeapImpl::Free(*(void **)(v9 + 16));
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)(v9 + 8));
  WPF::ProcessHeapImpl::Free((void *)v9);
}
