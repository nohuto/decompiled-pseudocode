/*
 * XREFs of ?SendReportToE3@CEnergyReporter@@AEAAXXZ @ 0x1800B74BC
 * Callers:
  ...
  if ( *((_DWORD *)this + 10) )
  {
    ...
    *((_DWORD *)this + 16) = GetCurrentThreadId();
    if ( *((_BYTE *)this + 80) )
    {
      if ( *((_BYTE *)this + 81) )
      {
        if ( (unsigned int)dword_18026DD2C < MEMORY[0x7FFE037C] && !(unsigned __int8)EtwCheckCoverage(&off_18026DD20) )
          NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_18026DD20, 0x18u);
      }
    ...
    *((_DWORD *)this + 16) = 0;
    ...
    if ( v2 < 0
      && (unsigned int)dword_18026DD14 < MEMORY[0x7FFE037C]
      && !(unsigned __int8)EtwCheckCoverage(&off_18026DD08) )
    {
      NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_18026DD08, 0x18u);
    }
    *((_DWORD *)this + 10) = 0;
  }
}
