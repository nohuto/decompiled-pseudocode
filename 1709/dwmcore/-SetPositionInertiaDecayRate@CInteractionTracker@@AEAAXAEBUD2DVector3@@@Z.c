/*
 * XREFs of ?SetPositionInertiaDecayRate@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x18016E20C
 * Callers:
        ...
        const struct D2DVector3 *a2)
{
  ...
  v4 = *(_QWORD *)((char *)this + 100) - v5;
  if ( !v4 )
    v4 = *((unsigned int *)this + 27) - (unsigned __int64)LODWORD(v3);
  if ( v4 )
  {
    *(_QWORD *)((char *)this + 100) = v5;
    *((float *)this + 27) = v3;
  }
