/*
 * XREFs of ?RealizeGradientPoints@CLinearGradientLegacyMilBrush@@QEAAXPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUMilPoint2F@@11@Z @ 0x180181C14
 * Callers:
        ...
        struct MilPoint2F *a5)
{
  ...
  *((float *)a5 + 1) = (float)(*(float *)a4 - *(float *)a3) + *(float *)(a3 + 4);
  ...
  CMILMatrix::Transform((CMILMatrix *)v15, (const struct MilPoint2F *)a3, (struct MilPoint2F *)a3, 1u);
  CMILMatrix::Transform((CMILMatrix *)v15, (const struct MilPoint2F *)a4, (struct MilPoint2F *)a4, 1u);
  CMILMatrix::Transform((CMILMatrix *)v15, a5, a5, 1u);
}
