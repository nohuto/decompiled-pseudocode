/*
 * XREFs of ?GetDirtyRects@CHolographicInteropTexture@@UEAAXIPEAIPEAUtagRECT@@PEA_N@Z @ 0x1801BE790
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( (unsigned int)v6 >= LODWORD(this[8].Ptr) )
  {
    *a3 = 0;
    *a5 = 1;
  }
  ...
  {
    v10 = 96 * v6;
    RectangleCount = FastRegion::CRegion::GetRectangleCount((FastRegion::CRegion *)((char *)this[5].Ptr + v10 + 16));
    if ( RectangleCount <= *a3 )
    {
      *a3 = RectangleCount;
      FastRegion::Internal::CRgnData::BeginIterator(
        *(FastRegion::Internal::CRgnData **)((char *)this[5].Ptr + v10 + 16),
