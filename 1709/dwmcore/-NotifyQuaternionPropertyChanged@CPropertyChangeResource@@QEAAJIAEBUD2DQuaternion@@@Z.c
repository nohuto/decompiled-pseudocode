/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@QEAAJIAEBUD2DQuaternion@@@Z @ 0x1801754E0
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, 0x14u) )
  {
    ...
    v3 = CoreUICallSend(v8, v11, 2LL, 8LL, 5, &unk_1801F0587);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v3, 0x155u);
  }
