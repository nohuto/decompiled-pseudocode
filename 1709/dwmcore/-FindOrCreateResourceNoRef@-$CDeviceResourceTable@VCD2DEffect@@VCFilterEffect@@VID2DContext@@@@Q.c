/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DEffect@@VCFilterEffect@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DEffect@@@Z @ 0x1801639E0
 * Callers:
        ...
        struct CD2DEffect **a3)
{
  ...
  char v5; // r12
  __int64 v6; // r9
  struct CD2DEffect *v9; // r8
  signed int DefaultDevice; // eax
  int v11; // eax
  struct CD2DEffect *v12; // r10
  ...
  struct CD2DEffect *v24; // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( *((_DWORD *)a1 + 10) )
  {
    ...
    v9 = *(struct CD2DEffect **)(*((_QWORD *)a1 + 2) + 8 * v6);
    v24 = v9;
    if ( v9 )
    {
LABEL_33:
...
LABEL_7:
  ...
  {
LABEL_10:
    v11 = CFilterEffect::CreateResource(*((CFilterEffect **)a1 + 1), a2, &v24);
    v3 = v11;
    if ( v11 < 0 )
    {
      v23 = 83;
...
LABEL_37:
  if ( v3 < 0 )
  {
    *a3 = 0LL;
    ...
    {
      if ( v24 )
        CD2DResource::RemoveResourceNotifier((struct CD2DEffect *)((char *)v24 + 16), a1);
    }
  }
