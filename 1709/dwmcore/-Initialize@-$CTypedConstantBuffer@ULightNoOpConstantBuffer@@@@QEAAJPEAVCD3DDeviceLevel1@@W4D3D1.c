/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@ULightNoOpConstantBuffer@@@@QEAAJPEAVCD3DDeviceLevel1@@W4D3D11_USAGE@@@Z @ 0x1800B835C
 * Callers:
        ...
        struct CD3DDeviceLevel1 *a2)
{
  ...
  if ( !*a1 )
  {
    ...
    *(_QWORD *)&v5.SysMemPitch = 0LL;
    ...
    v2 = v3;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v3, 0x44u);
  }
  return v2;
}
