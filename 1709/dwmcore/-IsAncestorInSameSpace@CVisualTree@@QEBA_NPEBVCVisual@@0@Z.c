/*
 * XREFs of ?IsAncestorInSameSpace@CVisualTree@@QEBA_NPEBVCVisual@@0@Z @ 0x18017D2E0
 * Callers:
 ...
 * Callees:
 *     ?IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z @ 0x18011A704 (-IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z.c)
 */
