/*
 * XREFs of ?GetBoundsInternal@CHwndBitmap@@AEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800744B8
 * Callers:
...
__int64 __fastcall CHwndBitmap::GetBoundsInternal(__int64 a1, __int64 a2)
{
  ...
  v4 = 0;
  if ( CHwndBitmap::IsValidVisual((CHwndBitmap *)a1) && (v5 = *(CVisualTree **)(a1 + 112)) != 0LL )
  {
