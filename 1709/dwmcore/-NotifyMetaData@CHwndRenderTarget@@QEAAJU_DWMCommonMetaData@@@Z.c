/*
 * XREFs of ?NotifyMetaData@CHwndRenderTarget@@QEAAJU_DWMCommonMetaData@@@Z @ 0x1801361E0
 * Callers:
    ...
    if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v4 + 440LL))(v4) )
    {
      ...
      if ( v6 )
      {
        ...
        *(_QWORD *)&v7 = *(_QWORD *)(a2 + 48);
        v10 = *(__int64 (__fastcall **)(__int64 *, _OWORD *))(v8 + 232);
        v13[2] = v9;
        v14 = v7;
        v11 = v10(v6, v13);
        v3 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x169u);
      }
    }
  }
  return v3;
