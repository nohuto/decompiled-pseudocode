/*
 * XREFs of ApplyTexcoordExtendMode @ 0x18000582C
 * Callers:
...
__int64 __fastcall ApplyTexcoordExtendMode(__int64 a1, __int16 a2, char a3, __int64 a4, __int16 *a5)
{
  ...
  *(_QWORD *)&v12 = &v13;
  ...
  appended = CShaderLinkingGraphBuilder::AppendNode(a1, v7, (__int64)&word_1801EFD5E, a4, (__int64)v9, &v12);
  v6 = appended;
  if ( appended < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, appended, 0x1AFu);
  }
  else
  {
LABEL_2:
