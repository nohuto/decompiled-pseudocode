/*
 * XREFs of ?HDRConvert@CD3DDeviceLevel1@@QEAAJPEAUID3D11ShaderResourceView@@IIAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@AEBUPixelFormatInfo@@1PEAUID3D11RenderTargetView@@IIW4DXGI_COLOR_SPACE_TYPE@@M_NPEAUtagRECT@@@Z @ 0x1801A7A60
 * Callers:
        ...
        __int64 a15)
{
  ...
  *((_QWORD *)&v51 + 1) = 1LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, CompositingPixelShaderNoRef, 0xAC7u);
  }
  else
  {
    v35 = this[145];
    ...
    *((float *)&v57 + 1) = (float)a11;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, updated, 0xACDu);
    }
    else
    {
      v38 = this[145];
