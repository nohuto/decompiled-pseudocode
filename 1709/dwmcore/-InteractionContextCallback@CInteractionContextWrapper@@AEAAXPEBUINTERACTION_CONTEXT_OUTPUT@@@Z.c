/*
 * XREFs of ?InteractionContextCallback@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x18019E900
 * Callers:
 *     ?s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x18019F650 (-s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@.c)
 * Callees:
  ...
  if ( *(_DWORD *)a2 == 1 )
  {
    ...
    *((_BYTE *)this + 156) = 1;
    ...
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
    {
      ...
      v29 = 4LL;
      v31 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_1802159EB, v4, v5, 0xBu, &pData);
    }
  }
  if ( dword_18026D7B0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
    {
      ...
      v19 = 4LL;
      v21 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_180215965, v6, v7, 6u, &pData);
    }
  }
}
