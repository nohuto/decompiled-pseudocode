/*
 * XREFs of ?ProcessUpdateMonitorRotation@CDesktopRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_DESKTOPRENDERTARGET_UPDATEMONITORROTATION@@@Z @ 0x1801343BC
 * Callers:
        ...
        const struct MILCMD_DESKTOPRENDERTARGET_UPDATEMONITORROTATION *a3)
{
  ...
  *((_QWORD *)&v11 + 1) = *((_QWORD *)a3 + 2);
  ...
  v8 = 0LL;
  *(_BYTE *)(**((_QWORD **)this + 15) + 814LL) = 1;
  if ( *((_DWORD *)this + 36) )
  {
    do
    {
      v9 = *(_QWORD *)(*((_QWORD *)this + 15) + 8 * v8);
      v8 = (unsigned int)(v8 + 1);
      *(_BYTE *)(v9 + 814) = 1;
    }
    while ( (unsigned int)v8 < *((_DWORD *)this + 36) );
    *((float *)this + 80) = (float)*((int *)a3 + 3);
    *((float *)this + 82) = (float)*((int *)a3 + 5);
    *((float *)this + 79) = (float)*((int *)a3 + 2);
    *((float *)this + 81) = (float)*((int *)a3 + 4);
  }
  return 0LL;
}
