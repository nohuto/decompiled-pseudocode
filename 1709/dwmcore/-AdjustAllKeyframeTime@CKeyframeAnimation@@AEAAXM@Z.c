/*
 * XREFs of ?AdjustAllKeyframeTime@CKeyframeAnimation@@AEAAXM@Z @ 0x18016F460
 * Callers:
...
void __fastcall CKeyframeAnimation::AdjustAllKeyframeTime(CKeyframeAnimation *this, float a2, double a3)
{
  ...
  if ( *(int *)(*(_QWORD *)(v4 + 312) + 104LL) > 0 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v11 + 96) + 8 * v12) *= v10;
      *(_BYTE *)(v11 + 132) |= 4u;
    }
    while ( (int)v9 < *(_DWORD *)(*(_QWORD *)(v4 + 312) + 104LL) );
  }
}
