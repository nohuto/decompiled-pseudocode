/*
 * XREFs of ?HrFindInterface@CHwDisplayRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002C5F0
 * Callers:
 ...
 *     ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B80D0 (-HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xBEu);
    return v3;
  }
  *a3 = 0LL;
  ...
  if ( !v4 )
  {
    v5 = (char *)(((unsigned __int64)this + 48) & -(__int64)(this != (CHwDisplayRenderTarget *)144));
LABEL_14:
    *a3 = v5;
    return v3;
  }
