/*
 * XREFs of ?CreateSharedHandleBitmap@CD3DDeviceManager@@UEAAJPEAVCBitmapOfDeviceBitmaps@@IAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAW4DXGI_FORMAT@@_N3U_LUID@@VDisplayId@@PEAPEAX@Z @ 0x1801A5460
 * Callers:
        ...
        CD3DDeviceLevel1 **a10)
{
  ...
  *a10 = 0LL;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v16, 0x57Eu);
    goto LABEL_19;
  }
  ...
  if ( D3DDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, D3DDevice, 0x580u);
    v12 = v34[0];
    goto LABEL_23;
  }
  v12 = v34[0];
  ...
  if ( Cache < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, Cache, 0x58Cu);
    v13 = v33;
  }
  else
  {
...
LABEL_14:
    ...
    if ( CurrentDisplaySet >= 0 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, SupportedTextureFormat, 0x5B1u);
        goto LABEL_21;
      }
LABEL_10:
      LOBYTE(v29) = a7;
      ...
      if ( v26 >= 0 )
      {
        ...
        if ( v27 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v27, 0x5C3u);
          goto LABEL_19;
        }
        ExistingSharedColorSourceHandle = v34[0];
        goto LABEL_14;
      }
      MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, v26, 0x5BFu);
      v15 = v32;
LABEL_19:
      if ( v15 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, &dword_18021BE18, 1u, CurrentDisplaySet, 0x5A9u);
    v10 = v31;
  }
LABEL_21:
  if ( v13 )
