/*
 * XREFs of ?Convert_D2D1_COLOR_F_sRGB_To_D2D1_COLOR_F_scRGB@@YA?AU_D3DCOLORVALUE@@AEBU1@@Z @ 0x1801C84C8
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a2)
{
  ...
  v4 = (int)floor_0((float)(a2->r * 255.0) + 0.5);
  v5 = -1;
  if ( v4 <= 255 )
  {
    v6 = 0;
  ...
  v8 = (int)floor_0((float)(g * 255.0) + 0.5);
  if ( v8 <= 255 )
  {
    v9 = 0;
    if ( v8 >= 0 )
  ...
  v11 = (int)floor_0((float)(b * 255.0) + 0.5);
  if ( v11 <= 255 )
  {
    v5 = 0;
    if ( v11 >= 0 )
