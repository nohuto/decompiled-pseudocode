/*
 * XREFs of ?GetInterpolatedValue@CAnimationInterpolator@@QEAA_N_JPEAMPEA_N@Z @ 0x18011BFD0
 * Callers:
 ...
 *     ?EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z @ 0x1801CAB10 (-EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z.c)
 * Callees:
  ...
  if ( CurrentPrimitive )
  {
    ...
    while ( 1 )
    {
      ...
      if ( PrimitiveAtIndex == v12 )
        return 0;
      v14 = CAnimationInterpolator::TransformTime((CAnimation **)this, v12, a2);
      a2 = v14;
      if ( *((_QWORD *)v12 + 1) < v14 )
        return 0;
      while ( 1 )
