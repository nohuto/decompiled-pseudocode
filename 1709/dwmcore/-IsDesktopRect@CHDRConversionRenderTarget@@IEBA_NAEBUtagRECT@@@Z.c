/*
 * XREFs of ?IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z @ 0x1801B9900
 * Callers:
...
bool __fastcall CHDRConversionRenderTarget::IsDesktopRect(CHDRConversionRenderTarget *this, const struct tagRECT *a2)
{
  ...
  v3 = 0;
  if ( !a2->left && !a2->top && a2->right == *((_DWORD *)this + 60) )
    return a2->bottom == *((_DWORD *)this + 61);
  return v3;
}
