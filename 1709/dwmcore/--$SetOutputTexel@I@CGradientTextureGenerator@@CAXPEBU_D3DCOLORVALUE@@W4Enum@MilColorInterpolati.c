/*
 * XREFs of ??$SetOutputTexel@I@CGradientTextureGenerator@@CAXPEBU_D3DCOLORVALUE@@W4Enum@MilColorInterpolationMode@@PEAI@Z @ 0x1801D935C
 * Callers:
 ...
 *     ?Premultiply@@YAII@Z @ 0x1801C8908 (-Premultiply@@YAII@Z.c)
 */
