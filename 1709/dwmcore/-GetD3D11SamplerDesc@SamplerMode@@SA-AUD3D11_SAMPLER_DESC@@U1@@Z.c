/*
 * XREFs of ?GetD3D11SamplerDesc@SamplerMode@@SA?AUD3D11_SAMPLER_DESC@@U1@@Z @ 0x1801548F8
 * Callers:
...
__int64 __fastcall SamplerMode::GetD3D11SamplerDesc(int *a1, _BYTE *a2)
{
  ...
  *a1 = v3;
  LOBYTE(a1) = a2[1];
  v4 = ExtendMode::ToD3D11TextureAddressMode(a1, a2, v2, a2);
  LOBYTE(v6) = *(_BYTE *)(v5 + 2);
  *(_DWORD *)(v7 + 4) = v4;
  v9 = ExtendMode::ToD3D11TextureAddressMode(v6, v8, v7, v5);
  *(_DWORD *)(v10 + 8) = v9;
  result = v10;
  *(_QWORD *)(v10 + 12) = 3LL;
  *(_DWORD *)(v10 + 20) = 1;
