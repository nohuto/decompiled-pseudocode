/*
 * XREFs of ?GetBounds@CAtlasedRectsMesh@@QEBAXPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800B6030
 * Callers:
    ...
    *(_DWORD *)(v4 + 4) = 0;
    for ( *(_DWORD *)v4 = 0; v5 < *(_DWORD *)(v3 + 60); v5 = v7 + 1 )
    {
      *(_OWORD *)v8 = *(_OWORD *)(*(_QWORD *)(v3 + 88) + 16LL * v5);
      result = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::UnionUnsafe((float *)v4, v8);
    }
    *(_BYTE *)(v3 + 128) = 0;
  }
  *v2 = *(_OWORD *)(v3 + 112);
