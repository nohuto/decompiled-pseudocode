/*
 * XREFs of ??2CConditionalExpression@@SAPEAX_K@Z @ 0x1801463D8
 * Callers:
...
void *__fastcall CConditionalExpression::operator new()
{
  void *result; // rax
  const void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x150uLL);
  if ( !result )
