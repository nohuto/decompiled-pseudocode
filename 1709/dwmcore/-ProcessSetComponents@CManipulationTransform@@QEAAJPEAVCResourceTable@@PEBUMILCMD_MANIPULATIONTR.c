/*
 * XREFs of ?ProcessSetComponents@CManipulationTransform@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MANIPULATIONTRANSFORM_SETCOMPONENTS@@@Z @ 0x1800B4854
 * Callers:
        ...
        const struct MILCMD_MANIPULATIONTRANSFORM_SETCOMPONENTS *a3)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x6Du);
  }
  else
  {
    v12 = *((_DWORD *)a3 + 7);
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v7, 0x70u);
    }
    else
    {
      v13 = *((_DWORD *)a3 + 10);
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x73u);
      }
      else
      {
        v14 = *((_DWORD *)a3 + 13);
        ...
        if ( v9 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v9, 0x76u);
        }
        else
        {
          if ( *((_BYTE *)this + 264) )
