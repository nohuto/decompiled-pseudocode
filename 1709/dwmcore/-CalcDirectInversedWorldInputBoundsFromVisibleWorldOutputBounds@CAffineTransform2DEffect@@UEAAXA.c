/*
 * XREFs of ?CalcDirectInversedWorldInputBoundsFromVisibleWorldOutputBounds@CAffineTransform2DEffect@@UEAAXAEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1PEAV3@2@Z @ 0x18017F610
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a6)
{
  ...
  *(_OWORD *)(a1 + 220) = *(_OWORD *)v26;
  v6.m128_f32[0] = v6.m128_f32[0] + v13;
  *(_OWORD *)&v27.m11 = *(_OWORD *)(a1 + 184);
  *(_QWORD *)(a1 + 236) = _mm_unpacklo_ps(v16, v6).m128_u64[0];
  *(_QWORD *)&v27.m[2][0] = *(_QWORD *)(a1 + 200);
  result = D2D1::Matrix3x2F::Invert(&v27);
  if ( result
    && (*a6 = *a3, v25 = *a3, (result = CFilterEffect::InvertTransformToCalc2DBounds((__int128 *)a2, &v25, v26)) != 0) )
  {
  ...
  *(float *)(a1 + 212) = *(float *)a5 - *(float *)(a2 + 48);
  *(float *)(a1 + 216) = *(float *)(a5 + 4) - *(float *)(a2 + 52);
  return result;
}
