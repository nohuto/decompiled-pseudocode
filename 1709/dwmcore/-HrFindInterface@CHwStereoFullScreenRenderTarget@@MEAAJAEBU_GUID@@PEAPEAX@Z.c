/*
 * XREFs of ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B80D0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 416) & -(__int64)(this != (CHwStereoFullScreenRenderTarget *)144));
      return 0LL;
    }
  }
  return result;
