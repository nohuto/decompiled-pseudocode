/*
 * XREFs of ?BlendPremultipliedColorDW@@YAKKM@Z @ 0x180154F9C
 * Callers:
...
{
  return (int)(float)((float)(unsigned __int8)a1 * a2) | (((int)(float)((float)BYTE1(a1) * a2) | (((int)(float)((float)BYTE2(a1) * a2) | (unsigned int)((int)(float)((float)HIBYTE(a1) * a2) << 8)) << 8)) << 8);
}
