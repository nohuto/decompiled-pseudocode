/*
 * XREFs of ?IsMonitorSpecificContent@CCachedVisualImage@@UEBA_NXZ @ 0x18008E090
 * Callers:
 ...
 *     ?IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ @ 0x180168070 (-IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
