/*
 * XREFs of ?FindExistingRenderTarget@CCachedVisualImage@@AEAAPEAURenderTargetBitmapInfo@1@U_LUID@@VDisplayId@@@Z @ 0x18008E438
 * Callers:
...
__int64 __fastcall CCachedVisualImage::FindExistingRenderTarget(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_DWORD *)(a1 + 264) )
  {
    while ( 1 )
    {
      ...
      if ( CCachedVisualImage::RenderTargetBitmapInfo::IsSameLuidAndDisplayId(v8, a2, a3) )
        break;
      if ( ++v7 >= *(_DWORD *)(a1 + 264) )
        return v3;
    }
