/*
 * XREFs of ?SetD2DEffectProperties@CLinearTransferEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180181E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearTransferEffect::SetD2DEffectProperties(CLinearTransferEffect *this, struct ID2D1Effect *a2)
{
  ...
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0x33u);
    }
    else
    {
      ...
      else
      {
        ...
        if ( v8 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x3Du);
        }
        else
        {
          ...
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v9, 0x42u);
          }
          else
          {
            ...
            if ( v10 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x47u);
            }
            else
            {
              ...
              if ( v11 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x4Cu);
              }
              else
              {
                ...
                if ( v12 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x51u);
                }
                else
                {
                  ...
                  if ( v13 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0x56u);
                  }
                  else
                  {
                    ...
                    if ( v14 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x5Bu);
                    }
                    else
                    {
                      ...
                      if ( v15 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v15, 0x60u);
                      }
                      else
                      {
                        ...
                        if ( v16 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v16, 0x65u);
                        }
                        else
                        {
                          ...
                          v5 = v17;
                          if ( v17 < 0 )
                            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v17, 0x6Au);
                        }
                      }
                    }
                  }
