/*
 * XREFs of ?ImageSourceToDrawListImageSource@CDrawingContext@@AEAAJPEAVIImageSource@@PEBVCMILMatrix@@PEAPEAV2@@Z @ 0x180037114
 * Callers:
 ...
 *     ?GetBounds@CGdiSpriteBitmap@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18009D390 (-GetBounds@CGdiSpriteBitmap@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV-$TMilRect_@MUMilRect.c)
...
{
  int (__fastcall **v4)(struct IImageSource *, GUID *, struct IBitmapRealization **); // rax
  struct IBitmapRealization *v5; // rbx
  struct IImageSource *v10; // r14
  __int64 (__fastcall *v11)(CCachedVisualImage *__hidden, struct IBitmapRealization **); // rax
  ...
  struct IBitmapRealization *v18; // rcx
  __int64 v20; // r8
  __int64 v21; // r10
  __int64 v22; // r9
  int v23; // eax
  ...
  struct IBitmapRealization *v29; // [rsp+40h] [rbp-39h] BYREF
  ...
  v4 = *(int (__fastcall ***)(struct IImageSource *, GUID *, struct IBitmapRealization **))a2;
  v5 = 0LL;
  v29 = 0LL;
  v28 = 0LL;
  v30 = 0LL;
  ...
  v11 = *(__int64 (__fastcall **)(CCachedVisualImage *__hidden, struct IBitmapRealization **))(*(_QWORD *)a2 + 80LL);
  ...
  {
    CurrentRenderingRealization = CCachedVisualImage::GetCurrentRenderingRealization(a2, &v28);
  }
  else
  {
  ...
  if ( CurrentRenderingRealization < 0 )
  {
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x237Cu);
      Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v27);
      goto LABEL_32;
    }
    v5 = v27;
    if ( v27 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DeviceImageSourceFromBitmapSource, 0x2383u);
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v27);
        v10 = v30;
        goto LABEL_32;
      }
...
LABEL_12:
  ...
  else if ( (char *)v15 == (char *)CCachedVisualImage::GetBounds )
  {
    Bounds = CCachedVisualImage::GetBounds(a2, 0LL, CurrentLayoutSize, v36);
  }
  else
  {
  ...
  if ( Bounds >= 0 )
  {
    CDrawingContext::RecordBitmapContentInfo(this, a2, v29, v36, a3);
    goto LABEL_12;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Bounds, 0x2391u);
LABEL_32:
  if ( v10 )
