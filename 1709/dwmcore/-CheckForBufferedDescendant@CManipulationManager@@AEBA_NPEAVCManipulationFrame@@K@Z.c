/*
 * XREFs of ?CheckForBufferedDescendant@CManipulationManager@@AEBA_NPEAVCManipulationFrame@@K@Z @ 0x180195B90
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v7 = 0;
  v8 = this;
  for ( i = *((_QWORD *)a2 + 28 * a3 + 15); v7 < *((_DWORD *)a2 + 4); ++v7 )
  {
    if ( v6 )
      break;
    v22 = 0LL;
    ...
    v9 = 224LL * v7;
    v10 = (char *)a2 + v9;
    if ( v7 == v4 || *(_QWORD *)((char *)a2 + v9 + 120) != -1LL )
      goto LABEL_10;
    v5 |= 1u;
