/*
 * XREFs of ?InflateRectFToPointAndSizeL@@YAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAUMilPointAndSizeL@@@Z @ 0x1800BF2EC
 * Callers:
...
__int64 __fastcall InflateRectFToPointAndSizeL(float *a1, __int64 a2, __int64 a3, double a4)
{
  ...
  {
    v4 = -2003304438;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8898000A, 0xF6u);
  }
  return v4;
}
