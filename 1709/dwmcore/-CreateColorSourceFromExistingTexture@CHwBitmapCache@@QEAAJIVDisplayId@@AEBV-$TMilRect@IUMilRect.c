/*
 * XREFs of ?CreateColorSourceFromExistingTexture@CHwBitmapCache@@QEAAJIVDisplayId@@AEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVCD3DVidMemOnlyTexture@@PEAPEAVCHwDeviceBitmapColorSource@@@Z @ 0x18007EC00
 * Callers:
        ...
        __int64 a6)
{
  ...
  v15 = 0LL;
  v6 = (__int64 *)a6;
  v8 = *(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))(a1 + 136);
  *(_QWORD *)a6 = 0LL;
  v10 = (**v8)(v8, &GUID_d82bbf04_48b7_4100_86b5_a6e5bb0e3213, &v15);
  v11 = v10;
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x4D4u);
  }
  else
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x4DCu);
    }
    else
    {
      v13 = *v6;
      *(_QWORD *)(v13 + 344) = *(_QWORD *)(a1 + 488);
      *(_QWORD *)(a1 + 488) = v13;
