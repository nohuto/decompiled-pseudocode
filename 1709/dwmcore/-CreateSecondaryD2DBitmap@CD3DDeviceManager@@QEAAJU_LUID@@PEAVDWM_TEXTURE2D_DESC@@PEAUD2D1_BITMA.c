/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDeviceManager@@QEAAJU_LUID@@PEAVDWM_TEXTURE2D_DESC@@PEAUD2D1_BITMAP_PROPERTIES1@@PEAW4DXGI_COLOR_SPACE_TYPE@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x18001A14C
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDeviceLevel1@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x180021B5C (-GetCompatibleTextureFormat@CD3DDeviceLevel1@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
        ...
        struct CSecondaryD2DBitmap **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, v13, 0x6ADu);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, D3DDevice, 0x6AFu);
      v7 = v24;
    }
    else
    {
      ...
      if ( a3->Width > v16 )
      {
        a4->dpiX = (float)((float)v16 / (float)(int)a3->Width) * a4->dpiX;
        a3->Width = v16;
      }
      if ( a3->Height > v17 )
      {
        a4->dpiY = (float)((float)v17 / (float)(int)a3->Height) * a4->dpiY;
        a3->Height = v17;
      }
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, v21, 0x6D1u);
        v8 = v25;
      }
      else
      {
        ...
        if ( SecondaryD2DBitmap < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801F0798, 1u, SecondaryD2DBitmap, 0x6DCu);
      }
    }
  }
