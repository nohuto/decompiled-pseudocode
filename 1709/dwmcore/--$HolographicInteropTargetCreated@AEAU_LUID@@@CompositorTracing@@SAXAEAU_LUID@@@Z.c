/*
 * XREFs of ??$HolographicInteropTargetCreated@AEAU_LUID@@@CompositorTracing@@SAXAEAU_LUID@@@Z @ 0x1801BF730
 * Callers:
...
void __fastcall CompositorTracing::HolographicInteropTargetCreated<_LUID &>(struct _LUID *a1)
{
  ...
  if ( v2 && TraceLoggingProviderEnabled(v2, 0, 0LL) )
  {
    ...
    CompositorTracing::HolographicInteropTargetCreated_(v3, a1);
  }
}
