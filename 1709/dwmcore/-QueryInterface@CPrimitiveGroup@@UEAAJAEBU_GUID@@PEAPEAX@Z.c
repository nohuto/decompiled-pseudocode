/*
 * XREFs of ?QueryInterface@CPrimitiveGroup@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180027AD0
 * Callers:
 ...
 *     ?QueryInterface@CPrimitiveGroup@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C60E0 (-QueryInterface@CPrimitiveGroup@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?HrFindInterface@CPrimitiveGroup@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180028240 (-HrFindInterface@CPrimitiveGroup@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
