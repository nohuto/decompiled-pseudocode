/*
 * XREFs of ?GetBitmap@CD2DBitmap@@UEAAJ_NPEAPEAUID2D1Bitmap1@@@Z @ 0x18004C3A0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a3 = 0LL;
  if ( a2 )
  {
    if ( !*((_QWORD *)this + 7) )
    {
      ...
      v3 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x23Fu);
    }
    if ( v3 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0xD4u);
