/*
 * XREFs of ?Translate@CMILMatrix@@QEAAXMMM@Z @ 0x180059558
 * Callers:
...
void __fastcall CMILMatrix::Translate(CMILMatrix *this, float a2, float a3, float a4)
{
  ...
  if ( v7 >= 0.000081380211
    || (v9 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 7)) & _xmm), v9 >= 0.000081380211)
    || (v10 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 11)) & _xmm), v10 >= 0.000081380211)
    || (v11 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)this + 15) - 1.0)) & _xmm), v11 >= 0.000081380211) )
  {
    v14 = *((float *)this + 7);
