        ...
        struct CHwSolidColorTextureSource **a12)
{
  ...
  char v18; // al
  signed int v19; // eax
  signed int BitmapColorSource; // eax
  signed int v21; // eax
  int v22; // eax
  signed int StockBlackSolidColorTextureSourceNoRef; // eax
...
LABEL_7:
    ...
    *(_QWORD *)v36 = *(_QWORD *)((((unsigned __int64)a2 - 16) & -(__int64)(a2 != 0LL)) + 0xB8);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, StockBlackSolidColorTextureSourceNoRef, 0x1B4u);
      goto LABEL_21;
    }
    v24 = v31;
    *a12 = v31;
...
LABEL_8:
  if ( !*a12 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v19, 0x1CFu);
    }
    else
    {
      v38 = v16;
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, BitmapColorSource, 0x1DFu);
        v12 = v26;
      }
      else
      {
        ...
        if ( v21 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v21, 0x1EDu);
        }
        else
        {
          *a12 = v12;
