/*
 * XREFs of ?GetD2DInk@CInk@@QEAAJPEAVID2DContext@@PEAPEAUID2D1Ink@@PEAPEAUID2D1InkStyle@@@Z @ 0x180168908
 * Callers:
...
__int64 __fastcall CInk::GetD2DInk(CInk *this, struct ID2DContext *a2, struct ID2D1Ink **a3, struct ID2D1InkStyle **a4)
{
  ...
  CD2DInk *v12; // [rsp+40h] [rbp+8h] BYREF
  ...
  *((_DWORD *)this + 8) = v7 ^ ((unsigned __int8)v7 ^ (unsigned __int8)(v7 + 2)) & 6;
  ...
  {
    v8 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80004005, 0x11Cu);
LABEL_8:
  ...
  ID2D1InkAndInkStyle = CD2DInk::GetID2D1InkAndInkStyle(v12, a3, a4);
  v8 = ID2D1InkAndInkStyle;
  if ( ID2D1InkAndInkStyle < 0 )
  {
    v11 = 288;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ID2D1InkAndInkStyle, v11);
    goto LABEL_8;
  }
LABEL_9:
