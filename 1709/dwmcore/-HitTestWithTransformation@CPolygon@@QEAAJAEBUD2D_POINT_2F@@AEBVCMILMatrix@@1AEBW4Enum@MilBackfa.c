/*
 * XREFs of ?HitTestWithTransformation@CPolygon@@QEAAJAEBUD2D_POINT_2F@@AEBVCMILMatrix@@1AEBW4Enum@MilBackfaceVisibility@@PEA_N@Z @ 0x18017EB5C
 * Callers:
 ...
 *     ?IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z @ 0x18017EE94 (-IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z.c)
        ...
        bool *a6)
{
  ...
  struct ID2D1Geometry *v30; // [rsp+50h] [rbp-B8h] BYREF
  struct ID2D1Geometry *v31[2]; // [rsp+58h] [rbp-B0h] BYREF
      ...
      *a6 = IsPointInPolygon;
      if ( IsPointInPolygon )
      {
        ...
        if ( v23 )
        {
          v28.m128_u64[0] = 0LL;
          v28.m128_i8[8] = 0;
          ShapeData = CGeometry::GetShapeData(v23, (const struct D2D_SIZE_F *)(v22 + 132), (struct CShapePtr *)&v28);
          v6 = ShapeData;
          if ( ShapeData < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, ShapeData, 0x1D7u);
          }
          else
          {
            D2DGeometry = CShapePtr::GetD2DGeometry((CShapePtr *)&v28, 0LL, &v30);
            v6 = D2DGeometry;
            if ( D2DGeometry >= 0 )
            {
              CShapePtr::Release((CRegionShape **)&v28);
              goto LABEL_10;
            }
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, D2DGeometry, 0x1D8u);
          }
          CShapePtr::Release((CRegionShape **)&v28);
          goto LABEL_17;
        }
...
LABEL_10:
      if ( v30 )
      {
        v26 = (*(__int64 (__fastcall **)(struct ID2D1Geometry *, unsigned __int64, _QWORD))(*(_QWORD *)v30 + 56LL))(
                v30,
                _mm_unpacklo_ps(v20, _mm_shuffle_ps(v20, v20, 85)).m128_u64[0],
                0LL);
        v6 = v26;
        if ( v26 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v26, 0x1E4u);
        else
          *a6 = (_DWORD)v29 != 0;
      }
    }
...
LABEL_17:
  ReleaseInterfaceNoNULL<CManipulationManager>((__int64)v30);
  return v6;
}
