/*
 * XREFs of ?RenderWorker@CComposeTop@@AEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@AEBVCShape@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18017D7D0
 * Callers:
        ...
        _OWORD *a5)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x17Au);
LABEL_14:
    if ( !v8 )
      goto LABEL_16;
    goto LABEL_15;
...
LABEL_12:
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0x188u);
    goto LABEL_18;
  }
  v9 = 1;
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v15, 0x18Fu);
LABEL_15:
...
LABEL_16:
    ...
    v16 = CDrawingContext::FillShapeWithBitmap(a2, *a1, (struct CMILMatrix *)&CMILMatrix::Identity, a4, 1);
    v12 = v16;
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v16, 0x194u);
      goto LABEL_15;
    }
    goto LABEL_12;
  }
  MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x18Bu);
LABEL_17:
