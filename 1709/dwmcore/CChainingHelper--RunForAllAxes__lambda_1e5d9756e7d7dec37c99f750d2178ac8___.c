/*
 * XREFs of CChainingHelper::RunForAllAxes__lambda_1e5d9756e7d7dec37c99f750d2178ac8___ @ 0x1801922CC
 * Callers:
        ...
        __int64 a4)
{
  ...
  do
  {
    ...
    result = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(v10 + 200))(v11, TemporaryConfigurationAxis, 1LL);
    ++v4;
    v7 += 12LL;
    v6 += 12LL;
  }
