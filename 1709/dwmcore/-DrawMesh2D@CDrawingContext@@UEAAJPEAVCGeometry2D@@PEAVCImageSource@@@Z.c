/*
 * XREFs of ?DrawMesh2D@CDrawingContext@@UEAAJPEAVCGeometry2D@@PEAVCImageSource@@@Z @ 0x18013CCD0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v8 )
      {
        if ( v9 )
        {
          v11 = CDrawingContext::ImageSourceToBitmapSource(
                  this,
                  (__int64 *)(((unsigned __int64)a3 + 8) & -(__int64)(a3 != 0LL)),
                  v10,
                  &v16,
                  &v15);
          v3 = v11;
          if ( v11 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x10F1u);
          }
          else if ( v15 )
          {
            ...
            if ( v12 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x10F5u);
            }
            else
            {
              ...
              v3 = v13;
              if ( v13 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0x10FBu);
            }
          }
        }
      }
