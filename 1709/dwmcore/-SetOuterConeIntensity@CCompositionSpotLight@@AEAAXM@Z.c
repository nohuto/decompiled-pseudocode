/*
 * XREFs of ?SetOuterConeIntensity@CCompositionSpotLight@@AEAAXM@Z @ 0x18015DA3C
 * Callers:
...
void __fastcall CCompositionSpotLight::SetOuterConeIntensity(CCompositionSpotLight *this, float a2)
{
  if ( *((float *)this + 75) != a2 )
  {
    *((float *)this + 75) = a2;
