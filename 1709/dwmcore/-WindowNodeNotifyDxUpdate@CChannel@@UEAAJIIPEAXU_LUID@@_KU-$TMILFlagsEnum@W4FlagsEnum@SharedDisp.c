/*
 * XREFs of ?WindowNodeNotifyDxUpdate@CChannel@@UEAAJIIPEAXU_LUID@@_KU?$TMILFlagsEnum@W4FlagsEnum@SharedDisplaySurface@@@@AEBUtagRECT@@HI@Z @ 0x180123B20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  v25 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 168);
