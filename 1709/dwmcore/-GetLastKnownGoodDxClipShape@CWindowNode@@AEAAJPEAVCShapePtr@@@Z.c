/*
 * XREFs of ?GetLastKnownGoodDxClipShape@CWindowNode@@AEAAJPEAVCShapePtr@@@Z @ 0x180178CC8
 * Callers:
...
__int64 __fastcall CWindowNode::GetLastKnownGoodDxClipShape(CWindowNode *this, CRegionShape **a2)
{
  _DWORD *v3; // rcx
  int v5; // eax
  float v6; // xmm0_4
  ...
  CRegionShape *v16; // [rsp+90h] [rbp+27h] BYREF
  ...
  *(float *)&v16 = v8;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0xBDDu);
  }
  else
  {
