/*
 * XREFs of ?Initialize@CDXGIAdapterLimited@@AEAAJXZ @ 0x18007574C
 * Callers:
...
__int64 __fastcall CDXGIAdapterLimited::Initialize(CDXGIAdapterLimited *this)
{
         ...
         &v23) < 0 )
  {
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x84u);
      goto LABEL_11;
    }
  }
  else
  {
    ...
    if ( v2 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x7Cu);
      goto LABEL_11;
    }
    v4 = 2LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, KMTDriverVersion, 0x87u);
  }
  else
  {
    ...
    if ( KMTAdapterType < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, KMTAdapterType, 0x88u);
    }
    else
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x8Au);
      }
      else
      {
        ...
        v3 = v19;
        if ( v19 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x91u);
      }
    }
  }
LABEL_11:
