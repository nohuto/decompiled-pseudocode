/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0 @ 0x18000940C
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 404) = *(_DWORD *)(a2 + 404);
  std::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>(
    a1 + 408,
    a2 + 408);
  std::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>(
    a1 + 424,
