/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@G$0A@@@QEAAJPEFBGI@Z @ 0x1800B2C38
 * Callers:
...
__int64 __fastcall DynArray<unsigned short,0>::AddMultipleAndSet(__int64 a1, const void *a2, unsigned int a3)
{
  unsigned int v3; // esi
  __int64 v5; // rcx
  unsigned int v6; // eax
  ...
  {
    v9 = DynArrayImpl<0>::AddMultipleAndSet(a1, 2u, a3, a2);
    v7 = v9;
    if ( v9 < 0 )
  ...
  {
    memcpy_0((void *)(*(_QWORD *)a1 + 2 * v5), a2, 2LL * a3);
    *(_DWORD *)(a1 + 24) = v3;
  }
  return v7;
}
