/*
 * XREFs of ?GetDeviceTexture@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x1801D2250
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDeviceTexture **a3)
{
  ...
  signed int DeviceImageSourceFromBitmapSource; // eax
  signed int v13; // eax
  signed int v14; // eax
  ...
  if ( *((_OWORD *)v5 + 26) == 0LL )
  {
    ...
    v8 = DeviceTexture;
    if ( DeviceTexture < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, DeviceTexture, 0xAEu);
  }
  else
  {
    v23 = 0LL;
    ...
    else
    {
      ...
      v10 = (*(__int64 (__fastcall **)(_QWORD, struct IBitmapSource **))(**((_QWORD **)this + 34) + 192LL))(
              *((_QWORD *)this + 34),
              &v23);
      v8 = v10;
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x8Cu);
      }
      else if ( v23 )
      {
        v11 = *a2;
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, DeviceImageSourceFromBitmapSource, 0xA3u);
        }
        else
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0xA5u);
          }
          else
          {
            ...
            v8 = v14;
            if ( v14 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0xA8u);
          }
        }
      }
      else
      {
        v8 = -2003292287;
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x88982F81, 0x8Fu);
      }
    }
    Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v24);
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v16);
