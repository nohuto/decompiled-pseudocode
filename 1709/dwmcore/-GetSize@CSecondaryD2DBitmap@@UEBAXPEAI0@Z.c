/*
 * XREFs of ?GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z @ 0x180092580
 * Callers:
 *     ?GetSize@CSecondaryD2DBitmap@@W7EBAXPEAI0@Z @ 0x1800C63C0 (-GetSize@CSecondaryD2DBitmap@@W7EBAXPEAI0@Z.c)
 *     ?GetSize@CSecondaryD2DBitmap@@WKA@EBAXPEAI0@Z @ 0x1800C63D0 (-GetSize@CSecondaryD2DBitmap@@WKA@EBAXPEAI0@Z.c)
 * Callees:
