/*
 * XREFs of ?DrawGeometry@CDrawingContext@@UEAAJPEAVCLegacyMilBrush@@PEAVCGeometry@@@Z @ 0x1800401C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CGeometry *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ShapeData, 0x4E1u);
      goto LABEL_7;
    }
    v7 = v13;
  }
  if ( v7 )
  {
    ...
    v6 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x4EAu);
  }
LABEL_7:
  v11 = 0;
  if ( v6 != -2003304438 )
