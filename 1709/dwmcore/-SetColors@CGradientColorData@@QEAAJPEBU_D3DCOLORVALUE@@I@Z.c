/*
 * XREFs of ?SetColors@CGradientColorData@@QEAAJPEBU_D3DCOLORVALUE@@I@Z @ 0x1801CF1F4
 * Callers:
  ...
  *((_DWORD *)this + 14) = 0;
  if ( a3 )
  {
    ...
    if ( a3 == 1 )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v9, 0x37u);
LABEL_17:
        *((_DWORD *)this + 6) = 0;
        *((_DWORD *)v4 + 6) = 0;
        return v3;
    ...
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x3Bu);
        goto LABEL_17;
      }
    }
    v16 = 0.0;
    ...
    if ( v7 > 1 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v13, 0x4Bu);
      goto LABEL_17;
    }
LABEL_12:
    v16 = FLOAT_1_0;
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x52u);
      goto LABEL_17;
    }
  }
  return v3;
