/*
 * XREFs of ?Begin@CDrawListEntryBuilder@@QEAAXAEBUDrawListEntryBuilderSetupParams@@PEAVCRenderingEffect@@@Z @ 0x1800630C8
 * Callers:
        ...
        struct CRenderingEffect *a3)
{
  ...
  *(_DWORD *)this = v4;
  ...
  v7 = *(__int64 (__fastcall **)(CCommonRenderingEffect *))(*(_QWORD *)a3 + 24LL);
