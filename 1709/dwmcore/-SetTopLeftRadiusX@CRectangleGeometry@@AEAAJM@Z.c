/*
 * XREFs of ?SetTopLeftRadiusX@CRectangleGeometry@@AEAAJM@Z @ 0x1800588A0
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetTopLeftRadiusX(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 30) != a2 )
  {
    *((float *)this + 30) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 5u, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x1E5u);
    else
