/*
 * XREFs of ??$AddPropertyValue@UD2DVector2@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector2@@@Z @ 0x1800A6178
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<D2DVector2>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  DWORD v4; // edi
  _QWORD *inserted; // r13
  char *v10; // rbx
