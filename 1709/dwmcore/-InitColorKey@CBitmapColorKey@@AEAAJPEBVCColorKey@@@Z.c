/*
 * XREFs of ?InitColorKey@CBitmapColorKey@@AEAAJPEBVCColorKey@@@Z @ 0x1801BB244
 * Callers:
...
LABEL_4:
      v3 = -2003292288;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x88982F80, v93);
      return v3;
    }
  ...
  switch ( v17 )
  {
    ...
    case 28:
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      v26 = (int)floor_0((float)(_mm_shuffle_ps(*(__m128 *)&v95.r, *(__m128 *)&v95.r, 255).m128_f32[0] * 255.0) + 0.5);
      v27 = -1;
      if ( v26 <= 255 )
      {
        v28 = 0;
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      v32 = (int)floor_0((float)(_mm_shuffle_ps(*(__m128 *)&v95.r, *(__m128 *)&v95.r, 255).m128_f32[0] * 255.0) + 0.5);
      if ( v32 <= 255 )
      {
        v27 = 0;
        if ( v32 >= 0 )
    ...
    default:
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      v18 = (int)floor_0((float)(_mm_shuffle_ps(*(__m128 *)&v95.r, *(__m128 *)&v95.r, 255).m128_f32[0] * 255.0) + 0.5);
      v19 = -1;
      if ( v18 <= 255 )
      {
        v20 = 0;
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      v23 = (int)floor_0((float)(_mm_shuffle_ps(*(__m128 *)&v95.r, *(__m128 *)&v95.r, 255).m128_f32[0] * 255.0) + 0.5);
      if ( v23 <= 255 )
      {
        v19 = 0;
        if ( v23 >= 0 )
