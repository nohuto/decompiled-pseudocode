/*
 * XREFs of ?VisualHasAnyChildFlagged@CManipulationContext@@SA_NPEAVCVisual@@@Z @ 0x1801A4060
 * Callers:
 ...
 *     ?GetCount@?$CPtrArray@VCVisual@@@@QEBA_KXZ @ 0x1800C287C (-GetCount@-$CPtrArray@VCVisual@@@@QEBA_KXZ.c)
 */
