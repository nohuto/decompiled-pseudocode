/*
 * XREFs of ?Realize@CDeviceAlignedIntermediateRealizer@@QEAAJPEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@PEAVCMILMatrix@@PEAH@Z @ 0x18018BD68
 * Callers:
        ...
        int *a5)
{
  ...
  if ( v12 > v10 && v13 > v11 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, SurfaceAndContext, 0x9Bu);
    }
    else
    {
      ...
      v6 = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v19, 0x9Du);
    }
  }
  else
  {
