/*
 * XREFs of ?Transform@?$CNonScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x1801D7D18
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(float *)(a6 + 4) = v7;
  if ( a4 )
  {
    ...
    do
    {
      *(_QWORD *)result = *(_QWORD *)&v8[(_QWORD)result - 32];
      result += 2;
      --v9;
    }
    while ( v9 );
