/*
 * XREFs of ?ProcessSetScale@CComponentTransform2D@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPONENTTRANSFORM2D_SETSCALE@@@Z @ 0x1800956E4
 * Callers:
        ...
        const struct MILCMD_COMPONENTTRANSFORM2D_SETSCALE *a3)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v3, 0x6Fu);
  return v4;
}
