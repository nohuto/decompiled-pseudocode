/*
 * XREFs of McTemplateU0xxqqxx @ 0x1801B3794
 * Callers:
...
ULONG McTemplateU0xxqqxx(REGHANDLE *a1, __int64 a2, ...)
{
  struct _EVENT_DATA_DESCRIPTOR v3; // [rsp+20h] [rbp-49h] BYREF
  va_list v4; // [rsp+30h] [rbp-39h]
  __int64 v5; // [rsp+38h] [rbp-31h]
  va_list v6; // [rsp+40h] [rbp-29h]
  __int64 v7; // [rsp+48h] [rbp-21h]
  va_list v8; // [rsp+50h] [rbp-19h]
  __int64 v9; // [rsp+58h] [rbp-11h]
  va_list v10; // [rsp+60h] [rbp-9h]
  __int64 v11; // [rsp+68h] [rbp-1h]
  va_list v12; // [rsp+70h] [rbp+7h]
  ...
  va_list va1; // [rsp+C8h] [rbp+5Fh]
  __int64 v20; // [rsp+D0h] [rbp+67h] BYREF
  va_list va2; // [rsp+D0h] [rbp+67h]
  __int64 v22; // [rsp+D8h] [rbp+6Fh] BYREF
  va_list va3; // [rsp+D8h] [rbp+6Fh]
  __int64 v24; // [rsp+E0h] [rbp+77h] BYREF
  va_list va4; // [rsp+E0h] [rbp+77h]
  va_list va5; // [rsp+E8h] [rbp+7Fh] BYREF
  ...
  v13 = 8LL;
  v15 = 8LL;
  return McGenEventWriteUM(a1, &EVTDESC_DETECT_REMOTEAPPWINDOW_STATE, 7u, &v3);
}
