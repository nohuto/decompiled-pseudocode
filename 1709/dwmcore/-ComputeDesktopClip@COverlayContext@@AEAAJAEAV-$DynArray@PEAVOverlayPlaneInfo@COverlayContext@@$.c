/*
 * XREFs of ?ComputeDesktopClip@COverlayContext@@AEAAJAEAV?$DynArray@PEAVOverlayPlaneInfo@COverlayContext@@$0A@@@AEAVCRegion@@@Z @ 0x180141714
 * Callers:
        ...
        const struct FastRegion::Internal::CRgnData **a3)
{
  ...
  if ( v15 >= 0 )
  {
    while ( 1 )
    {
      ...
      if ( !*(_BYTE *)(v17 + 179) )
      {
        v18 = FastRegion::CRegion::Union(
                a3,
                (const struct FastRegion::Internal::CRgnData **)((*(_QWORD *)(v17 + 168) + 16LL) & ((unsigned __int128)-(__int128)*(unsigned __int64 *)(v17 + 168) >> 64)));
        v4 = v18;
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0xDDBu);
          return v4;
        }
      }
      if ( --v16 < 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0xDD4u);
  }
  return v4;
}
