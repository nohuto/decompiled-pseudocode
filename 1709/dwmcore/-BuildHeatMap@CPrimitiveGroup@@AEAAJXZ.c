/*
 * XREFs of ?BuildHeatMap@CPrimitiveGroup@@AEAAJXZ @ 0x180174A80
 * Callers:
...
__int64 __fastcall CPrimitiveGroup::BuildHeatMap(CPrimitiveGroup *this)
{
  ...
  if ( *((_QWORD *)this + 63) && *((_QWORD *)this + 65) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x607u);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x60Cu);
      }
      else
      {
        ...
        while ( v1 + 148 <= (unsigned int)v15 )
        {
          v17 = v1;
          v1 += 148;
          *(_OWORD *)(v17 + v16 + 48) = *((_OWORD *)this + 41);
