/*
 * XREFs of ?GetCurrentVisual@CDrawingContext@@UEBAPEAVCVisual@@XZ @ 0x1800407C0
 * Callers:
 ...
 *     ?GetActiveLightCount@CDrawingContext@@QEBAIXZ @ 0x18013D9DC (-GetActiveLightCount@CDrawingContext@@QEBAIXZ.c)
...
struct CVisual *__fastcall CDrawingContext::GetCurrentVisual(CDrawingContext *this)
{
  ...
  if ( *((_BYTE *)this + 6512) )
  {
    if ( *((_BYTE *)this + 6513) )
      ...
      return *(struct CVisual **)(*((_QWORD *)this + 815) + 24LL);
  }
  return result;
}
