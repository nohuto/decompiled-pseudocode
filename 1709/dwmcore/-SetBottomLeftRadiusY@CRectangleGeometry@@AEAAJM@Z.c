/*
 * XREFs of ?SetBottomLeftRadiusY@CRectangleGeometry@@AEAAJM@Z @ 0x180058760
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetBottomLeftRadiusY(CRectangleGeometry *this, float a2)
{
  unsigned int v2; // ebx
  int v5; // eax
  ...
  if ( *((float *)this + 35) != a2 )
  {
    *((float *)this + 35) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 0xAu, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x253u);
    else
      CResource::InvalidateAnimationSources(this, 0xAu);
  }
  return v2;
}
