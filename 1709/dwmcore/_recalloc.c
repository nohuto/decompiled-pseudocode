/*
 * XREFs of _recalloc @ 0x1800C4160
 * Callers:
 *     ?Add@?$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV?$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_DATA@@PEAX@ATL@@@ATL@@QEAAHAEBQEAU_SEB_RPC_PUBLISH_DATA@@AEBQEAX@Z @ 0x1801CC934 (-Add@-$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV-$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_D.c)
 ...
 * Callees:
 *     _errno_0 @ 0x1800C43B6 (_errno_0.c)
 *     _invalid_parameter @ 0x1800C43BC (_invalid_parameter.c)
 */
