/*
 * XREFs of ?ProcessSetCreationParams@CCompositionCubeMap@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPOSITIONCUBEMAP_SETCREATIONPARAMS@@@Z @ 0x18015A80C
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONCUBEMAP_SETCREATIONPARAMS *a3)
{
  ...
  if ( *((_QWORD *)this + 19) != *((_QWORD *)a3 + 1) )
  {
    ...
    *((_BYTE *)this + 160) = *((_DWORD *)a3 + 4) != 0;
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0xA2u);
      return v7;
    }
    v8 = *(_QWORD *)this;
    *((_DWORD *)this + 26) = v5;
