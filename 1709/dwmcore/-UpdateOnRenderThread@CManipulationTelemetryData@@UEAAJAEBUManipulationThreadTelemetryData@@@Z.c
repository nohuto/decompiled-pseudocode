/*
 * XREFs of ?UpdateOnRenderThread@CManipulationTelemetryData@@UEAAJAEBUManipulationThreadTelemetryData@@@Z @ 0x18016A210
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct ManipulationThreadTelemetryData *a2)
{
  ...
  if ( dword_18026D7B0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18026D7B0, 2uLL) )
  {
    ...
    v47 = 4;
    v50 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_18026D7B0, &unk_180213875, v5, v6, 0xBu, &pData);
  }
  ...
  *(_OWORD *)v20 = 0LL;
  std::shared_ptr<ManipulationThreadTelemetryData>::_Resetp<ManipulationThreadTelemetryData>((__int64)v20, (__int64)v7);
  if ( v20[0] )
  {
    ...
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x66u);
  }
  else
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x65u);
  }
  if ( v20[1] )
