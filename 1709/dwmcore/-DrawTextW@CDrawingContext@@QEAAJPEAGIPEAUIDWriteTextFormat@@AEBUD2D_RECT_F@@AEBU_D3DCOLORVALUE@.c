/*
 * XREFs of ?DrawTextW@CDrawingContext@@QEAAJPEAGIPEAUIDWriteTextFormat@@AEBUD2D_RECT_F@@AEBU_D3DCOLORVALUE@@@Z @ 0x18013D3A4
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a6)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, unsigned __int16 *, __int64, struct IDWriteTextFormat *, const struct D2D_RECT_F *, const struct _D3DCOLORVALUE *, bool, int, _DWORD, _DWORD))(**((_QWORD **)this + 48) + 136LL))(
           *((_QWORD *)this + 48),
