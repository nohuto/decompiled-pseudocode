/*
 * XREFs of ?GetInputEffectForAtlasedSurface@CFilterEffect@@AEAAJPEAVID2DContext@@PEAVID2DContextOwner@@AEBUtagRECT@@PEAVCCompositionSurfaceBitmap@@PEAPEAUID2D1Effect@@@Z @ 0x1801641A0
 * Callers:
        ...
        struct ID2D1Effect **a6)
{
  ...
  D2DBitmapRealizationForContextOwner = (*(__int64 (__fastcall **)(struct ID2DContext *, GUID *, __int64 *))(*(_QWORD *)a2 + 248LL))(
                                          a2,
                                          &CLSID_D2D1Crop,
                                          &v20);
  v11 = D2DBitmapRealizationForContextOwner;
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v15, 0x355u);
    goto LABEL_13;
  }
  ...
  if ( D2DBitmapRealizationForContextOwner < 0 )
  {
    v18 = 861;
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, D2DBitmapRealizationForContextOwner, v18);
    goto LABEL_13;
  }
