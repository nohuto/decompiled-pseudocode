/*
 * XREFs of __tailMerge_ext_ms_win_compositor_hosting_l1_2_0_dll @ 0x1800C45E2
 * Callers:
 *     __imp_load_RegisterManipulationThread @ 0x1800C45D6 (__imp_load_RegisterManipulationThread.c)
 *     __imp_load_StopAndEndInertia @ 0x1800C465B (__imp_load_StopAndEndInertia.c)
 * Callees:
