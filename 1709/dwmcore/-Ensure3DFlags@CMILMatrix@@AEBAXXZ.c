/*
 * XREFs of ?Ensure3DFlags@CMILMatrix@@AEBAXXZ @ 0x18005A9F0
 * Callers:
...
void __fastcall CMILMatrix::Ensure3DFlags(CMILMatrix *this)
{
  ...
  if ( (v1 & 3) == 0 || (v1 & 0xC) == 0 || (v1 & 0xC0) == 0 || (*((_BYTE *)this + 65) & 0xC) == 0 )
  {
    ...
    if ( v2 >= 0.000081380211
      || (v3 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 6)) & _xmm), v3 >= 0.000081380211)
      || (v4 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 3)) & _xmm), v4 >= 0.000081380211)
      || (v5 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 7)) & _xmm), v5 >= 0.000081380211)
      || (v6 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 8)) & _xmm), v6 >= 0.000081380211)
      || (v7 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 9)) & _xmm), v7 >= 0.000081380211)
      || (v8 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 11)) & _xmm), v8 >= 0.000081380211)
    ...
    else
    {
      ...
      if ( v11 >= 0.000081380211
        || (v24 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 5)) & _xmm), v24 >= 0.000081380211) )
      {
      ...
      else
      {
        ...
        *((_BYTE *)this + 64) = v25;
        ...
        {
          v29 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 4)) & _xmm);
