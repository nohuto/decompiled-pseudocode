/*
 * XREFs of ?CopyPixels@CBitmapColorKey@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x1801BAF20
 * Callers:
 *     ?CopyPixels@CBitmapColorKey@@W7EAAJPEBUWICRect@@IIPEAE@Z @ 0x1800C6E60 (-CopyPixels@CBitmapColorKey@@W7EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  if ( !a2 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v9, 0x25Fu);
      return v10;
    }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x26Au);
  }
  else
  {
    v12 = (*(__int64 (__fastcall **)(_QWORD, const struct WICRect *, _QWORD, _QWORD, unsigned __int8 *))(**((_QWORD **)this + 2) + 48LL))(
            *((_QWORD *)this + 2),
            v7,
            a3,
            a4,
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v12, 0x272u);
    }
    else
    {
      ...
      v10 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v14, 0x27Au);
    }
  }
  return v10;
}
