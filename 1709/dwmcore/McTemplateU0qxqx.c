/*
 * XREFs of McTemplateU0qxqx @ 0x180129178
 * Callers:
...
ULONG McTemplateU0qxqx(__int64 a1, __int64 a2, int a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va2);
  return McGenEventWriteUM(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_DCOMPEVENT_RESOURCE, 5u, &v4);
}
