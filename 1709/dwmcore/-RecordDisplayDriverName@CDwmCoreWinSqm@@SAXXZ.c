/*
 * XREFs of ?RecordDisplayDriverName@CDwmCoreWinSqm@@SAXXZ @ 0x1801914C8
 * Callers:
 ...
 *     ??1CDisplayRegKey@@QEAA@XZ @ 0x18019222C (--1CDisplayRegKey@@QEAA@XZ.c)
 *     ?ReadString@CDisplayRegKey@@QEAA_NPEBGKPEAG@Z @ 0x180192250 (-ReadString@CDisplayRegKey@@QEAA_NPEBGKPEAG@Z.c)
 */
