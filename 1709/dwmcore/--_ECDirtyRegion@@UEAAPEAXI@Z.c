/*
 * XREFs of ??_ECDirtyRegion@@UEAAPEAXI@Z @ 0x1800341D0
 * Callers:
...
CDirtyRegion *__fastcall CDirtyRegion::`vector deleting destructor'(CDirtyRegion *this, char a2)
{
  ...
  *((_QWORD *)this + 49) = (char *)this + 392;
  v5 = (char **)*((_QWORD *)this + 141);
  if ( *v5 != v3 || (v6 = (char **)v5[1], *v6 != (char *)v5) )
    __fastfail(3u);
  *((_QWORD *)v3 + 1) = v6;
  *v6 = v3;
  while ( 1 )
  {
    ...
    if ( *(char **)v3 == v3 )
      break;
    if ( (char *)v7[1] != v3 || (v12 = *v7, *(_QWORD **)(*v7 + 8LL) != v7) )
      __fastfail(3u);
    *(_QWORD *)v3 = v12;
    *(_QWORD *)(v12 + 8) = v3;
  ...
  *((_DWORD *)v3 + 392) = 0;
  v8 = (char **)*((_QWORD *)v3 + 1);
  if ( *v8 != v3 || (v9 = (char **)v8[1], *v9 != (char *)v8) )
    __fastfail(3u);
  *((_QWORD *)v3 + 1) = v9;
  *v9 = v3;
  while ( 1 )
  {
    ...
    if ( *(char **)v3 == v3 )
      break;
    if ( (char *)v10[1] != v3 || (v13 = *v10, *(_QWORD **)(*v10 + 8LL) != v10) )
      __fastfail(3u);
    *(_QWORD *)v3 = v13;
    *(_QWORD *)(v13 + 8) = v3;
