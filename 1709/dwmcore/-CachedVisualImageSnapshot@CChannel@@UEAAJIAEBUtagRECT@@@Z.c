/*
 * XREFs of ?CachedVisualImageSnapshot@CChannel@@UEAAJIAEBUtagRECT@@@Z @ 0x18000C7C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CachedVisualImageSnapshot(CChannel *this, int a2, const struct tagRECT *a3)
{
  __int128 v6; // xmm0
  unsigned int v7; // ebx
