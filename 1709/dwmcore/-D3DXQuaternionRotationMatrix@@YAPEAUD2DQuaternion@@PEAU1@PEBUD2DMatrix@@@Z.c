/*
 * XREFs of ?D3DXQuaternionRotationMatrix@@YAPEAUD2DQuaternion@@PEAU1@PEBUD2DMatrix@@@Z @ 0x18009E60C
 * Callers:
...
struct D2DQuaternion *__fastcall D3DXQuaternionRotationMatrix(struct D2DQuaternion *a1, const struct D2DMatrix *a2)
{
  ...
  if ( (float)(v6 + v5) <= 0.0 )
  {
    ...
    *((float *)a1 + v12) = v14;
    *((float *)a1 + v13) = (float)(*((float *)a2 + 4 * v13 + v12) + *((float *)a2 + 4 * v12 + v13))
                         * (float)(0.25 / v14);
    *((float *)a1 + v15) = (float)(*((float *)a2 + 4 * v15 + v12) + *((float *)a2 + 4 * v12 + v15))
                         * (float)(0.25 / v14);
