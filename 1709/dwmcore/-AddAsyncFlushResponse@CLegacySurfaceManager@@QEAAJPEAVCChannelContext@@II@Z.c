/*
 * XREFs of ?AddAsyncFlushResponse@CLegacySurfaceManager@@QEAAJPEAVCChannelContext@@II@Z @ 0x18007F7D0
 * Callers:
        ...
        int a4)
{
  ...
  *((_QWORD *)v11 + 5) = a2;
  ...
  if ( v13 )
  {
    while ( 1 )
    {
      matched = CWindowNode::AddResponseToOutstandingDxSurfaces<ProcessTokenMatchPolicy>(v13[1], &v18, v12);
      v8 = matched;
      if ( matched < 0 )
        break;
      v13 = RtlEnumerateGenericTableWithoutSplaying((PRTL_GENERIC_TABLE)((char *)this + 136), &RestartKey);
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, matched, 0x28Au);
LABEL_11:
    if ( v8 < 0 )
