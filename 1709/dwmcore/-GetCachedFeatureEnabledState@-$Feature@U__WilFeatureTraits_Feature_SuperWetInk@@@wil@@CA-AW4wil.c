/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SuperWetInk@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18013AB30
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_SuperWetInk>::GetCachedFeatureEnabledState(
        __int64 a1,
        unsigned int a2,
        __int64 a3)
{
  ...
  v3 = `wil::Feature<__WilFeatureTraits_Feature_SuperWetInk>::GetFeaturePropertyCache'::`2'::data & 3;
  v4 = v3;
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0xAA1BAA, a2, a3);
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(11148202, 0, &v12) )
    {
      if ( v3 )
      {
        v10 = v6;
