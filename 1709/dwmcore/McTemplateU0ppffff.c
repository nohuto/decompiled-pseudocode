/*
 * XREFs of McTemplateU0ppffff @ 0x1801751A8
 * Callers:
...
ULONG McTemplateU0ppffff(REGHANDLE *a1, __int64 a2, ...)
{
  ...
  v13 = 4LL;
  v15 = 4LL;
  return McGenEventWriteUM(a1, &EVTDESC_ETWGUID_PRIMITIVE_GROUP_DRAW, 7u, &v3);
}
