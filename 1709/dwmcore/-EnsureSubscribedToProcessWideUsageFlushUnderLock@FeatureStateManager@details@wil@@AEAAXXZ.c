/*
 * XREFs of ?EnsureSubscribedToProcessWideUsageFlushUnderLock@FeatureStateManager@details@wil@@AEAAXXZ @ 0x1801338A4
 * Callers:
        ...
        wil::details::FeatureStateManager *this)
{
  ...
  if ( !*((_QWORD *)this + 9) && *((_QWORD *)this + 3) )
  {
    ...
    if ( *v1 )
    {
      ...
      if ( qword_180272048 )
        wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_180272048[25], qword_180272048, v3);
