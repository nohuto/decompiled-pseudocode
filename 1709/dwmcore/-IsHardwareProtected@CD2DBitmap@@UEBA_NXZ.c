/*
 * XREFs of ?IsHardwareProtected@CD2DBitmap@@UEBA_NXZ @ 0x18004C370
 * Callers:
 ...
 *     ?IsHardwareProtected@CD2DBitmap@@W7EBA_NXZ @ 0x1800C63E0 (-IsHardwareProtected@CD2DBitmap@@W7EBA_NXZ.c)
 * Callees:
 *     <none>
 */
