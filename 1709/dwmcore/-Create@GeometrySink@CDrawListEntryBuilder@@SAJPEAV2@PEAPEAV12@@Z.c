/*
 * XREFs of ?Create@GeometrySink@CDrawListEntryBuilder@@SAJPEAV2@PEAPEAV12@@Z @ 0x180151994
 * Callers:
        ...
        struct CDrawListEntryBuilder::GeometrySink **a2)
{
  ...
  {
    v4 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x89u);
  }
  return v4;
}
