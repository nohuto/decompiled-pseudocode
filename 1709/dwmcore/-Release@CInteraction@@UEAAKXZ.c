/*
 * XREFs of ?Release@CInteraction@@UEAAKXZ @ 0x1800916C0
 * Callers:
 *     ?Release@CInteraction@@W7EAAKXZ @ 0x1800C6670 (-Release@CInteraction@@W7EAAKXZ.c)
 * Callees:
...
__int64 __fastcall CInteraction::Release(CInteraction *this)
{
  ...
  if ( *((_DWORD *)this + 4) == 1 )
  {
    ...
    Entry = CInteraction::GetEntry(*((_DWORD *)this + 380));
    if ( Entry )
      *((_QWORD *)Entry + 1) = 0LL;
