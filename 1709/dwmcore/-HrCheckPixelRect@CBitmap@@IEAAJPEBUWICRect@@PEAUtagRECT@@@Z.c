/*
 * XREFs of ?HrCheckPixelRect@CBitmap@@IEAAJPEBUWICRect@@PEAUtagRECT@@@Z @ 0x18008CAEC
 * Callers:
...
__int64 __fastcall CBitmap::HrCheckPixelRect(CBitmap *this, const struct WICRect *a2, struct tagRECT *a3)
{
  ...
  if ( rcSrc1.left >> 31 == -1 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x27Au);
    return v5;
  }
  Width = a2->Width;
  v10 = -1;
  ...
  if ( (v5 & 0x80000000) != 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x27Bu);
    return v5;
  }
  v11 = left + v10;
  v12 = -1;
  ...
  if ( v11 < left )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x27Cu);
    return v5;
  }
  v13 = -1;
  v14 = -1;
  ...
  if ( v12 > 0x7FFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x27Du);
    return v5;
  }
  v15 = -1;
  if ( Y >= 0 )
  ...
  if ( Y >> 31 == -1 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x27Fu);
    return v5;
  }
  Height = a2->Height;
  v17 = -1;
  ...
  if ( (v5 & 0x80000000) != 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x280u);
    return v5;
  }
  v18 = v15 + v17;
  if ( v18 >= v15 )
  ...
  if ( v18 < v15 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x281u);
    return v5;
  }
  if ( v6 <= 0x7FFFFFFF )
    v13 = v6;
  ...
  if ( v6 > 0x7FFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v5, 0x282u);
    return v5;
  }
