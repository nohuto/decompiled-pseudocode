/*
 * XREFs of ?AppendHWGeometry@CDrawListEntryBuilder@@AEAAJ_N0@Z @ 0x180061CBC
 * Callers:
...
__int64 __fastcall CDrawListEntryBuilder::AppendHWGeometry(CDrawListEntryBuilder *this, bool a2, bool a3)
{
  ...
  if ( GeometryCount < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, GeometryCount, 0x583u);
    return v5;
  }
  v6 = v25;
  if ( (int)v25 > 0 )
  {
    v7 = v23;
    v8 = 8 * *(_DWORD *)this + 16;
    v9 = DynArrayImpl<0>::Grow((int)this + 360, 1, (int)v23 * v8, 0, 0LL);
    v5 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x58Au);
      return v5;
    }
    v10 = DynArrayImpl<0>::Grow((int)this + 1352, 1, v7 * v8, 0, 0LL);
    v5 = v10;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x58Bu);
      return v5;
    }
    v11 = DynArrayImpl<0>::Grow((int)this + 2352, 2, v6, 0, 0LL);
    v5 = v11;
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x58Cu);
      return v5;
    }
    v12 = *((_QWORD *)this + 294);
    ...
    if ( Geometry < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Geometry, 0x5A1u);
      return v5;
    }
    v15 = v23;
    *((_DWORD *)this + 586) += v23;
