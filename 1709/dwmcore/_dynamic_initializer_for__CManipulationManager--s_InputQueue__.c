/*
 * XREFs of _dynamic_initializer_for__CManipulationManager::s_InputQueue__ @ 0x180001410
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ @ 0x1800C25D8 (--0-$CQueue@V-$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ.c)
 */
