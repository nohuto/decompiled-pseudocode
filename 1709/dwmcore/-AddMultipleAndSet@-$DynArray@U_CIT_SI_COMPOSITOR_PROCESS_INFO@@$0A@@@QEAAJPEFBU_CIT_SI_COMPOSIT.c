/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@U_CIT_SI_COMPOSITOR_PROCESS_INFO@@$0A@@@QEAAJPEFBU_CIT_SI_COMPOSITOR_PROCESS_INFO@@I@Z @ 0x1800B902C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  {
    v9 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0x18u, a3, a2);
    v7 = v9;
    if ( v9 < 0 )
  ...
  {
    memcpy_0((void *)(*(_QWORD *)a1 + 24 * v5), a2, 24LL * a3);
    *(_DWORD *)(a1 + 24) = v3;
  }
  return v7;
}
