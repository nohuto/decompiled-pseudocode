/*
 * XREFs of ?AddMoveRectangle@CDwmMetaRegion@@QEAAJPEBUtagRECT@@PEBUtagPOINT@@@Z @ 0x18014E850
 * Callers:
        ...
        const struct tagPOINT *a3)
{
  ...
  if ( ho )
  {
    ...
    v10 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v11, 0x7Eu);
    if ( ho )
      DeleteObject(ho);
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v10, 0x7Cu);
  }
