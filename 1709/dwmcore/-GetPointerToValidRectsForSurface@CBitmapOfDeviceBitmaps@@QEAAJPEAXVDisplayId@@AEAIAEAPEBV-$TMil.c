/*
 * XREFs of ?GetPointerToValidRectsForSurface@CBitmapOfDeviceBitmaps@@QEAAJPEAXVDisplayId@@AEAIAEAPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801AC470
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  signed int PointerToValidRects; // eax
...
LABEL_5:
  ...
  if ( PointerToValidRects < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, PointerToValidRects, 0x45Cu);
  return v10;
}
