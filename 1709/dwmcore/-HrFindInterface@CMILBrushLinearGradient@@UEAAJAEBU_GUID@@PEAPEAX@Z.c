/*
 * XREFs of ?HrFindInterface@CMILBrushLinearGradient@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801CECC0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x80070057, 0x83u);
  }
  return v3;
}
