/*
 * XREFs of ?QueryInterface@CGdiSpriteBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009D1F0
 * Callers:
 ...
 *     ?QueryInterface@CGdiSpriteBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C6600 (-QueryInterface@CGdiSpriteBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?HrFindInterface@CGdiSpriteBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009D280 (-HrFindInterface@CGdiSpriteBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
...
__int64 __fastcall CGdiSpriteBitmap::QueryInterface(CGdiSpriteBitmap *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( (char *)v6 == (char *)CGdiSpriteBitmap::HrFindInterface )
        Interface = CGdiSpriteBitmap::HrFindInterface(this, a2, a3);
      else
        Interface = v6();
      v4 = Interface;
      if ( Interface < 0 )
