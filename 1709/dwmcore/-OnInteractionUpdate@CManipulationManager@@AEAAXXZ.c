/*
 * XREFs of ?OnInteractionUpdate@CManipulationManager@@AEAAXXZ @ 0x180009FF8
 * Callers:
 *     _lambda_d567cd3a6c68f97a2ae1dd4cccee7ffb_::_lambda_invoker_cdecl_ @ 0x1800C0350 (_lambda_d567cd3a6c68f97a2ae1dd4cccee7ffb_--_lambda_invoker_cdecl_.c)
      ...
      if ( v10 != 6 )
      {
        if ( v10 != 8 )
        {
          if ( v10 == 9 )
          {
            ...
            CInteractionProcessor::SetRailsEnabled((char *)v9 + 376, v3, *(unsigned int *)(v6 + 44));
          }
          goto LABEL_9;
        }
