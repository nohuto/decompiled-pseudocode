/*
 * XREFs of ?GetBounds@CHwDisplayRenderTarget@@UEAAXPEAUMilRectF@@@Z @ 0x18002C690
 * Callers:
 *     ?GetBounds@CHwDisplayRenderTarget@@WMA@EAAXPEAUMilRectF@@@Z @ 0x1800C6C00 (-GetBounds@CHwDisplayRenderTarget@@WMA@EAAXPEAUMilRectF@@@Z.c)
 * Callees:
