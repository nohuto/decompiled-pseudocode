/*
 * XREFs of ?Init@CD2DFactory@@AEAAJW4D2D1_FACTORY_TYPE@@UD2D1_FACTORY_OPTIONS@@@Z @ 0x180191930
 * Callers:
...
__int64 __fastcall CD2DFactory::Init(void **this, enum D2D1_FACTORY_TYPE a2, struct D2D1_FACTORY_OPTIONS a3)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v4, 0xC3u);
  }
  else
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v6, 0xC7u);
    else
