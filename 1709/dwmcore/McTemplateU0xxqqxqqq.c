/*
 * XREFs of McTemplateU0xxqqxqqq @ 0x1801668E0
 * Callers:
...
ULONG McTemplateU0xxqqxqqq(__int64 a1, __int64 a2, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWriteUM(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_FLIPCHAIN_BUFFER, 9u, &v3);
}
