/*
 * XREFs of ?AddWindowNode@CWindowManager@@QEAAJPEAVCWindowNode@@@Z @ 0x1800B69AC
 * Callers:
...
__int64 __fastcall CWindowManager::AddWindowNode(CWindowManager *this, struct CWindowNode *a2)
{
  ...
  v19 = 0LL;
  Entry = CWindowManager::FindEntry(this, *((_QWORD *)a2 + 74), &v19);
  if ( Entry >= 0 )
  {
    v13 = v19;
    for ( i = 0LL; ; ++i )
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v18, 0x63u);
  ...
  else
  {
    ...
    if ( v7 )
    {
      ...
      *v7 = *((_QWORD *)a2 + 74);
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, Entry, 0xB5u);
      }
      ...
      if ( Entry < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, Entry, 0x70u);
    ...
    {
      Entry = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x8007000E, 0x6Bu);
    }
  }
  return (unsigned int)Entry;
}
