/*
 * XREFs of ?ProcessSetColorTransform@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MAGNIFIERRENDERTARGET_SETCOLORTRANSFORM@@@Z @ 0x1801386A0
 * Callers:
...
__int64 __fastcall CMagnifierRenderTarget::ProcessSetColorTransform(
        ...
        const struct MILCMD_MAGNIFIERRENDERTARGET_SETCOLORTRANSFORM *a3)
{
  unsigned int v4; // ebx
  unsigned int v5; // edx
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x14u)) != 0LL )
  {
    if ( Resource != this[15] )
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, v8, 0x140u);
      }
      else
      {
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20LL, 0LL, 0, 0x88980403, 0x137u);
  }
  return v4;
}
