/*
 * XREFs of ?DrawBitmap@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap1@@PEBUD2D_RECT_F@@2MW4D2D1_ANTIALIAS_MODE@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x180044F60
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_PRIMITIVE_BLEND a9)
{
  ...
  struct D2D_RECT_F v19; // [rsp+50h] [rbp-79h] BYREF
  ...
  struct D2D_MATRIX_3X2_F v32; // [rsp+B0h] [rbp-19h] BYREF

  CD2DContext::FlushDrawList(this);
  CD2DContext::EnsureBeginDraw(this);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  {
    v14 = (*(__int64 (__fastcall **)(const struct ID2DContextOwner *))(*(_QWORD *)a2 + 32LL))(a2);
    McTemplateU0qq(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_DRAWEVENT_Start, 14LL, v14);
  }
  CD2DContext::SetCommonState(this, a2, a9, &a7, &v32);
  if ( a5 )
  {
    if ( EventEnabled(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_DRAWEVENT) )
    {
      ...
      v15 = *a5;
      v26 = 1065353216;
      v23 = *(_QWORD *)&v32.m[1][0];
      v19 = v15;
      v30 = 1065353216;
      v28 = *(_QWORD *)&v32.m[2][0];
      CMILMatrix::Transform2DBoundsHelper<0>(&v20, &v19, &v32);
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
        McTemplateU0ffff(
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  {
    ...
    McTemplateU0qq(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_DRAWEVENT_Stop, 14LL, v18);
  }
  return 0LL;
}
