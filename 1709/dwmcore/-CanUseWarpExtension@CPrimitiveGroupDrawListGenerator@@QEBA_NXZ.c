/*
 * XREFs of ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x180152638
 * Callers:
 ...
 *     ?Step@Iterator@CPrimitiveBuffer@@QEAA_NXZ @ 0x18011CBB8 (-Step@Iterator@CPrimitiveBuffer@@QEAA_NXZ.c)
 *     ??$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18018F468 (--$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
