/*
 * XREFs of ?CopySubresourceRectInternal1@CD3DDeviceLevel1@@AEAAXPEAUID3D11Resource@@IPEBUtagRECT@@0IPEBUtagPOINT@@I@Z @ 0x180020784
 * Callers:
        ...
        unsigned int a8)
{
  ...
  (*(void (__fastcall **)(_QWORD, struct ID3D11Resource *, _QWORD, _QWORD, LONG, _DWORD, struct ID3D11Resource *, int, _DWORD *, unsigned int))(**((_QWORD **)this + 82) + 920LL))(
    *((_QWORD *)this + 82),
    a5,
    a6,
    x,
