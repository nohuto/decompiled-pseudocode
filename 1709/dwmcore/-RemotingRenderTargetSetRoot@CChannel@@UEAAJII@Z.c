/*
 * XREFs of ?RemotingRenderTargetSetRoot@CChannel@@UEAAJII@Z @ 0x180122E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::RemotingRenderTargetSetRoot(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
