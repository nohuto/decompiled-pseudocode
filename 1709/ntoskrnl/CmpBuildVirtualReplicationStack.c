/*
 * XREFs of CmpBuildVirtualReplicationStack @ 0x1406911F8
 * Callers:
  ...
  *a3 = v14;
  while ( v14 > 1 )
  {
    if ( !v4 )
      goto LABEL_23;
    v21 = v14 - 1;
    v13[12 * v21 + 10] = *(_DWORD *)(v4 + 32) >> 31;
    HvpGetCellContextReinitialize((__int64)&v13[12 * v21 + 6]);
    v4 = *(_QWORD *)(v4 + 64);
  }
  v13[10] = 0;
  HvpGetCellContextReinitialize((__int64)(v13 + 6));
  result = 0LL;
  *a4 = v13;
  return result;
}
