/*
 * XREFs of RtlDecompressBufferLZNT1 @ 0x140563620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     LZNT1DecompressChunk @ 0x140189C80 (LZNT1DecompressChunk.c)
...
LABEL_12:
    ...
    if ( v11 >= 0 )
    {
      ...
      v18 = v15 - 2;
      v24 = v15 - 2;
      if ( (struct _LIST_ENTRY *)((char *)v8 + v15 - 2) > v9 )
      {
        v18 = (_DWORD)v9 - (_DWORD)v8;
        v24 = (_DWORD)v9 - (_DWORD)v8;
      }
      if ( (unsigned __int64)v6 + v18 + 2 > v7 )
        goto LABEL_12;
      memmove(v8, v6 + 1, v18);
      goto LABEL_26;
    }
    ...
    if ( !a5 )
    {
      v10 = LZNT1DecompressChunk(v8, v9, (_BYTE *)v6 + 2, (__int64)v6 + v15, &v24);
      if ( v10 < 0 )
      {
LABEL_28:
        *a6 = v24;
...
LABEL_6:
    ...
    v8 = (struct _LIST_ENTRY *)((char *)v8 + v14);
    if ( v8 == v9 )
      break;
    ...
    if ( v14 < 0x1000 )
    {
      v19 = (int)(4096 - v14);
      v20 = (char *)v8 + v19;
      if ( (struct _LIST_ENTRY *)((char *)v8 + v19) >= v9 )
        break;
      memset(v8, 0, v19);
      v8 = (struct _LIST_ENTRY *)v20;
    }
  }
  v16 = a6;
