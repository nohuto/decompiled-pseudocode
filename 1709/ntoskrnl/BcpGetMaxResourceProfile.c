/*
 * XREFs of BcpGetMaxResourceProfile @ 0x14013B348
 * Callers:
 *     BgpBcInitializeCriticalMode @ 0x14086F1D0 (BgpBcInitializeCriticalMode.c)
 * Callees:
 *     BcpGetCharacterMaxResourceProfile @ 0x14013B40C (BcpGetCharacterMaxResourceProfile.c)
 */
...
__int64 __fastcall BcpGetMaxResourceProfile(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  for ( i = 0; i < 0x16; ++i )
  {
    ...
    if ( v7 != (unsigned __int16 *)&unk_1402B6910 || (dword_14035A1B0 & 0x20000) == 0 )
    {
      CharacterMaxResourceProfile = 0;
      v8 = *v7 >> 1;
      v9 = 0;
