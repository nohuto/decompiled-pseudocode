/*
 * XREFs of NtGetMUIRegistryInfo @ 0x1404F25F8
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __cdecl NtGetMUIRegistryInfo(ULONG Flags, PULONG DataSize, PVOID Data)
{
  ...
  __int64 v26; // [rsp+B8h] [rbp-40h]
  int v27; // [rsp+C0h] [rbp-38h]
  __int128 v28; // [rsp+C8h] [rbp-30h]
  char v29; // [rsp+118h] [rbp+20h]
...
LABEL_48:
  ...
  v26 = 0LL;
  v28 = 0LL;
  v10 = PsCreateSystemThreadEx(&Handle, 0x1FFFFFLL, &v24, 0LL, 0LL, MUIRegistrySystemRoutine, &p_Event, 0LL, 0LL);
  if ( v10 >= 0 )
  {
    ZwClose(Handle);
