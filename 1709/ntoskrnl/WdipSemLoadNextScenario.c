/*
 * XREFs of WdipSemLoadNextScenario @ 0x1405AA3A8
 * Callers:
...
LABEL_36:
        ...
        while ( 1 )
        {
          v23 = (GUID *)WdipSemFastAllocate(0LL, 48LL);
          v6 = v23;
          if ( !v23 )
            goto LABEL_76;
          memset(v23, 0, 0x30uLL);
          NextEndEvent = WdipSemLoadNextEndEvent(v36, v22++, v6);
          v8 = NextEndEvent;
...
LABEL_68:
        ...
        if ( !v7 )
        {
          ...
          while ( 1 )
          {
            if ( !v6 )
            {
              v6 = (GUID *)WdipSemFastAllocate(0LL, 48LL);
              if ( !v6 )
                break;
            }
            memset(v6, 0, 0x30uLL);
            NextContextProvider = WdipSemLoadNextContextProvider(KeyHandlea, v26++, v6);
