/*
 * XREFs of PspApplyTimerDelayProcess @ 0x14024E464
 * Callers:
...
__int64 __fastcall PspApplyTimerDelayProcess(__int64 a1, _DWORD *a2)
{
  ...
  v9 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 1992), v8, v7 & 0x7FFFFFFFFFFFFFFFLL);
  if ( v10 != v9 )
  {
    do
    {
      ...
      v9 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 1992), v8, v9);
    }
    while ( v9 != v11 );
  }
  if ( (v8 & 0x4000000000000000LL) == 0 )
  {
    do
    {
      ...
      v8 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 1992), v8 & 0x1FFFFFFFFFFFFFFFLL, v8);
    }
    while ( v12 != v8 );
  }
LABEL_22:
