/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x140258244
 * Callers:
 *     RtlCompressBufferProgress @ 0x140257FD4 (RtlCompressBufferProgress.c)
 *     RtlCompressBufferXpressHuff @ 0x140258190 (RtlCompressBufferXpressHuff.c)
 * Callees:
 ...
 *     XpressDoHuffmanPass @ 0x14025ADAC (XpressDoHuffmanPass.c)
 */
        ...
        unsigned int a9)
{
  ...
  __int64 v57; // rax
  bool v58; // zf
  __int64 XpressCallback; // [rsp+30h] [rbp-98h]
  unsigned __int8 *v60; // [rsp+38h] [rbp-90h]
  unsigned __int8 *v61; // [rsp+40h] [rbp-88h]
...
LABEL_8:
    ...
    do
    {
      v27 = (unsigned __int16)XpressHashFunction[*v25] ^ (unsigned __int16)word_1402DD880[v25[2]] ^ (unsigned __int64)(unsigned __int16)word_1402DD680[v25[1]];
      v28 = *(_QWORD *)&a6[8 * v27];
      *(_QWORD *)&a6[8 * v27] = v25++;
...
LABEL_91:
        ...
        XpressCallback = RtlpMakeXpressCallback(v67, v22, v14, v22);
      }
      v29 = *(_DWORD *)v14;
...
LABEL_68:
      ...
      if ( v43 < 0x100 )
        ...
        v44 = (unsigned int)XpressHighBitIndexTable[v43 >> 8] + 8;
      v62 += v44;
      v45 = v43 - (1LL << v44);
      v46 = 16 * v44;
      if ( v35 - 3 < 0xF )
