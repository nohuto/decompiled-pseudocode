/*
 * XREFs of ?ExtractDeviceStrings@SC_DEVICE@@AEAAJXZ @ 0x140294308
 * Callers:
 ...
 *     ?ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z @ 0x1405A0580 (-ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z.c)
 */
