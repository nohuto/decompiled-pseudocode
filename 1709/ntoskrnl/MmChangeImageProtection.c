/*
 * XREFs of MmChangeImageProtection @ 0x140515760
 * Callers:
 *     <none>
 * Callees:
...
LABEL_19:
        ...
        if ( a4 == 1 )
        {
          v23 = *(_QWORD *)(v12 + 112);
          if ( v23
            && (v26 = *(_QWORD *)(*(_QWORD *)(MiSectionControlArea(v23) + 96) + 8LL), (v26 & 0xFFFFFFFFFFFFFFF8uLL) > 8) )
          {
          ...
          if ( qword_1403626B0 )
          {
            v25 = ((__int64 (__fastcall *)(unsigned __int64, __int64, unsigned __int64, __int64, unsigned __int64))qword_1403626B0)(
                    v24,
                    a1,
                    a2,
                    a3,
