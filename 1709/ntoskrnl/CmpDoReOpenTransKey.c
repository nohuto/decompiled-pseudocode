/*
 * XREFs of CmpDoReOpenTransKey @ 0x1406A21DC
 * Callers:
...
__int64 __fastcall CmpDoReOpenTransKey(__int64 a1, __int128 *a2, ACCESS_MASK a3, _QWORD *a4)
{
  ...
  _QWORD v31[30]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  while ( 1 )
  {
    ...
    v29 = 4928;
    v30 = 0LL;
    v9 = ObOpenObjectByName((__int64)&v26, (__int64)CmKeyObjectType, 0, 0LL, a3, (__int64)v31, &Handle);
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( (_WORD)v24 )
    {
      ...
      v29 = 4928;
      v30 = 0LL;
      v9 = ObOpenObjectByName((__int64)&v26, (__int64)CmKeyObjectType, 0, 0LL, a3, (__int64)v31, &v23);
      CmpCleanupParseContext((__int64)v31, v10);
      v16 = 0;
      if ( v9 < 0
