/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x14026E5F8
 * Callers:
...
LABEL_11:
  ...
  if ( v21 != (__int64 *)&v20 )
  {
    ...
    {
      v17 = (__int64)v20;
      v20 = (_QWORD *)(*v20 & 0xFFFFFFFFFFFFFFF8uLL);
      if ( (__int64 *)v17 == v16 )
      {
        v20 = 0LL;
        v21 = (__int64 *)&v20;
