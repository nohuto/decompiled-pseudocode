/*
 * XREFs of MfgInitSystem @ 0x140857D7C
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  LODWORD(qword_14035E6A8) = *(_DWORD *)(v2 + 2488);
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, WORD1(qword_14035E6A8), 0x5067664Du);
  qword_14035E6B0 = PoolWithTag;
  if ( PoolWithTag )
  {
    inited = RtlStringCbCopyW((NTSTRSAFE_PWSTR)PoolWithTag, WORD1(qword_14035E6A8), *(NTSTRSAFE_PCWSTR *)(v2 + 2496));
    if ( inited < 0 )
      goto LABEL_22;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_14035E6A8;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_14035E6B0, WORD1(qword_14035E6A8));
    if ( inited < 0 )
      goto LABEL_22;
