/*
 * XREFs of HvpViewMapPinForFileOffset @ 0x1401E5208
 * Callers:
 ...
 *     HvpViewMapCountPinMaskSetBits @ 0x1406A0604 (HvpViewMapCountPinMaskSetBits.c)
 */
    ...
    if ( v8 )
    {
      if ( (unsigned __int8)HvpViewMapAcquireChargesForPinnedPages(a1, v8) )
      {
        ...
        do
        {
          ...
          if ( (*v18 & 1) == 0 )
          {
            v21 = *(_QWORD *)(v26 + 8 * v19) + 32LL * ((v17 >> 18) & 0x3F);
            if ( (*(_QWORD *)v21 & 1) == 0 )
