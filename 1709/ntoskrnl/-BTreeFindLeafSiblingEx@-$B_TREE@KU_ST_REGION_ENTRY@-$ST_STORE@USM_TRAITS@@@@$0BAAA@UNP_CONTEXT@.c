/*
 * XREFs of ?BTreeFindLeafSiblingEx@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAPEAUNODE@?$B_TREE_HEADER@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@K@Z @ 0x1402611B8
 * Callers:
                       ...
                       v14) )
  {
    ...
    if ( v6 )
    {
      if ( (a3 & 2) != 0 )
      {
        ...
        if ( **(_DWORD **)v11 != -1 )
          NP_CONTEXT::NpLeafDerefInternal(v11, v10);
      }
