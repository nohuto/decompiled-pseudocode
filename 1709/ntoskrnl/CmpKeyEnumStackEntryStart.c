/*
 * XREFs of CmpKeyEnumStackEntryStart @ 0x14069B000
 * Callers:
...
__int64 __fastcall CmpKeyEnumStackEntryStart(__int64 *a1, unsigned int *a2, __int64 a3)
{
  __int64 *v5; // rsi
  unsigned int *v6; // rdi
  __int64 result; // rax
  ...
  *a1 = *(_QWORD *)a2;
  ...
  do
  {
    ...
    *(_DWORD *)((char *)a1 + (_QWORD)v6 + v9 - a3 + 8) = v12;
    ...
    if ( v12 > v13 )
    {
      v14 = (_WORD *)(*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD *))(*a1 + 8))(
                       *a1,
