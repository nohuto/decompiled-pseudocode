/*
 * XREFs of KeLoadMTRR @ 0x140426BF0
 * Callers:
 *     KiLoadMTRRTarget @ 0x140426BD0 (KiLoadMTRRTarget.c)
 * Callees:
 *     __security_check_cookie @ 0x14015D720 (__security_check_cookie.c)
 *     KeFlushCurrentTbImmediately @ 0x14017B290 (KeFlushCurrentTbImmediately.c)
 *     KiLockStepExecution @ 0x140426DD4 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x140426E18 (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x140426F28 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x140427038 (KiCompareVarMtrr.c)
 */
  ...
  if ( byte_14036AAB0 )
  {
    ...
    if ( (_BYTE)qword_14036AAA8 )
    {
      ...
      do
      {
        v12 = qword_14036AAB8;
        v13 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_14036AAB8 + v13));
        v8 = HIDWORD(v12[v13 + 1]);
        __writemsr(v11, v12[v13 + 1]);
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_14036AAA8 );
    }
    if ( qword_14036AAC0 )
    {
      ...
      {
        v14 = 0LL;
        v15 = (PVOID)((_BYTE *)qword_14036AAC0 - v18);
        v16 = v18;
        while ( *(_QWORD *)((char *)v16 + (_QWORD)v15) == *v16 )
        {
...
LABEL_17:
      KiWriteFixedMtrr(qword_14036AAC0, v14, v15);
    }
