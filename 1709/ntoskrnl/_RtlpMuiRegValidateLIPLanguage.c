/*
 * XREFs of _RtlpMuiRegValidateLIPLanguage @ 0x14078C148
 * Callers:
 *     _RtlpMuiRegValidateInstalled @ 0x1405BD8FC (_RtlpMuiRegValidateInstalled.c)
 * Callees:
 *     RtlpMuiRegGetInstalledLangInfoIndex @ 0x14078ABD4 (RtlpMuiRegGetInstalledLangInfoIndex.c)
 */
  ...
  while ( 1 )
  {
    ...
    if ( v9 != 2 )
    {
      ...
      if ( (int)RtlpMuiRegGetInstalledLangInfoIndex(v15, v9, v10, &v21) < 0
        ...
        || v21 == a2
        || (v17 = *(_WORD *)(28LL * v21 + *(_QWORD *)(v15 + 16)), (v17 & 4) != 0) )
      {
        v3 = a1;
        v18 = v7;
LABEL_25:
