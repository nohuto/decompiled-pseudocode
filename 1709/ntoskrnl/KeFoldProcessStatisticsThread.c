/*
 * XREFs of KeFoldProcessStatisticsThread @ 0x1400B8958
 * Callers:
 *     PspThreadDelete @ 0x1404FBC50 (PspThreadDelete.c)
 * Callees:
 *     RtlTimelineBitmapMerge @ 0x140009054 (RtlTimelineBitmapMerge.c)
 */
...
signed __int64 __fastcall KeFoldProcessStatisticsThread(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 600) += *(unsigned int *)(a1 + 340);
  ...
  if ( v3 )
  {
    RtlTimelineBitmapMerge((unsigned int *)(*(_QWORD *)(v1 + 1856) + 272LL), (unsigned int *)(v3 + 192));
    v6 = v5 - (_QWORD)v4;
    v7 = 4LL;
    do
    {
