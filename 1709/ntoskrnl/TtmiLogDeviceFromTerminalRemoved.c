/*
 * XREFs of TtmiLogDeviceFromTerminalRemoved @ 0x1407119F4
 * Callers:
...
char __fastcall TtmiLogDeviceFromTerminalRemoved(int a1, int a2, __int64 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn(&stru_1407F37A0, 1uLL);
    if ( (_BYTE)v4 )
    {
      ...
      v27 = 8;
      v30 = 4;
      LOBYTE(v4) = TlgWrite(&stru_1407F37A0, &unk_1402D2F36, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v4;
}
