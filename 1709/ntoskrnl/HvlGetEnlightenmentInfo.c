/*
 * XREFs of HvlGetEnlightenmentInfo @ 0x1401EBDE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HvlGetEnlightenmentInfo(_DWORD *a1)
{
  ...
  *((_QWORD *)a1 + 48) = HvlDmaAllocateDeviceDomain;
  *((_QWORD *)a1 + 49) = HvlDmaAttachDeviceDomain;
  *((_QWORD *)a1 + 50) = HvlDmaDetachDeviceDomain;
  *((_QWORD *)a1 + 51) = HvlDmaDeleteDeviceDomain;
  *((_QWORD *)a1 + 52) = HvlDmaMapDeviceLogicalRange;
  *((_QWORD *)a1 + 53) = HvlDmaUnmapDeviceLogicalRange;
