/*
 * XREFs of RtlStringCchCopyNExW @ 0x1400DE810
 * Callers:
 ...
 * Callees:
 *     RtlStringCopyWorkerW @ 0x1400DE970 (RtlStringCopyWorkerW.c)
...
LABEL_12:
  ...
  else if ( cchDest )
  {
    ...
    v12 = RtlStringCopyWorkerW(pszDest, cchDest, pcchNewDestLength, pszSrc, cchToCopy);
