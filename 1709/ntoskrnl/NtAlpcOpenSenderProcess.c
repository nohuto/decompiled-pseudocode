/*
 * XREFs of NtAlpcOpenSenderProcess @ 0x140467C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtAlpcOpenSenderProcess(_QWORD *a1, void *a2, unsigned __int64 a3, int a4, int a5, __int128 *a6)
{
