/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x1402481F0
 * Callers:
...
char __fastcall PopTraceThermalZonePassiveHistogram(__int64 a1)
{
  ...
  _DWORD v19[24]; // [rsp+A8h] [rbp-60h] BYREF
  ...
  if ( v4 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        v14 = 84;
        v17 = 21;
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_1402D230F, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( v3 )
