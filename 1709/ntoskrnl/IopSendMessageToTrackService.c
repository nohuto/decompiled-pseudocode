/*
 * XREFs of IopSendMessageToTrackService @ 0x1406B5B58
 * Callers:
  ...
  while ( 1 )
  {
    if ( !IopLinkTrackingServiceObject )
    {
      ...
      else
      {
        ...
        KeResetEvent(&stru_1403851C0);
        ExQueueWorkItem(&IopLinkTrackingPacket, DelayedWorkQueue);
        v9 = KeWaitForSingleObject(&stru_1403851C0, Executive, PreviousMode, 0, 0LL);
        v10 = v9;
        if ( v9 != 192 && v9 != 257 && dword_1403851D8 < 0 )
          v10 = dword_1403851D8;
        KeSetEvent(&IopLinkTrackingPortObject, 0, 0);
        if ( v10 )
          return v10;
    ...
    *v12 = 12058768LL;
    v16 = LpcpRequestWaitReplyPort((int)IopLinkTrackingServiceObject, (__int64)v12, (__int64)v17, 0, 0);
    v10 = v16;
    if ( v16 >= 0 )
      return v18;
    if ( v16 != -1073741769
