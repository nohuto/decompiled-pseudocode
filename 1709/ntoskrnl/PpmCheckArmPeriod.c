/*
 * XREFs of PpmCheckArmPeriod @ 0x140138E48
 * Callers:
...
char PpmCheckArmPeriod()
{
  ...
  if ( (unsigned int)(10000 * *(_DWORD *)(2688LL * dword_1403661AC + PpmCurrentProfile + 60)) > (unsigned __int64)PpmCheckMinimumPeriod )
    v0 = (unsigned int)(10000 * *(_DWORD *)(2688LL * dword_1403661AC + PpmCurrentProfile + 60));
  if ( !PpmCheckArmed )
    goto LABEL_7;
