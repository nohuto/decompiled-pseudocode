/*
 * XREFs of AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x140776AA8
 * Callers:
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140776C44 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 * Callees:
 *     <none>
 */
