/*
 * XREFs of RtlReserveChunkLZNT1 @ 0x140727800
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x140192C00 (memmove.c)
 *     RtlDescribeChunkLZNT1 @ 0x140727740 (RtlDescribeChunkLZNT1.c)
 */
  ...
  if ( v10 == -2147483622 )
  {
    ...
    *a3 = v4;
    ...
    if ( (unsigned __int64)*a1 <= a2 - v7 )
    {
      ...
      {
        LODWORD(v7) = 4098;
        if ( (unsigned __int64)v13 + (unsigned int)v14 + 4098 <= a2 )
        {
          memmove(v13 + 2049, v6, (unsigned int)v14);
          **a1 = 0x3FFF;
          ++*a3;
LABEL_15:
          v11 = 0;
      ...
      else if ( (_DWORD)v7 )
      {
        ...
        {
          memmove((char *)v13 + v7, v6, (unsigned int)v14);
          goto LABEL_15;
        }
      }
      else
      {
        LODWORD(v7) = 6;
        if ( (unsigned __int64)v13 + (unsigned int)v14 + 6 <= a2 )
        {
          memmove(v13 + 3, v6, (unsigned int)v14);
          **a1 = -20477;
          (*a1)[1] = 2;
          (*a1)[2] = 4092;
          goto LABEL_15;
