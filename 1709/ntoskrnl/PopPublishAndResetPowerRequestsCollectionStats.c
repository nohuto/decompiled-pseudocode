/*
 * XREFs of PopPublishAndResetPowerRequestsCollectionStats @ 0x14070C290
 * Callers:
 ...
 *     PoQueryStopWatchCollection @ 0x14024C3C0 (PoQueryStopWatchCollection.c)
 *     PoResetStopWatchCollection @ 0x14024C418 (PoResetStopWatchCollection.c)
...
__int64 __fastcall PopPublishAndResetPowerRequestsCollectionStats(char a1)
{
  ...
  *(_QWORD *)&v14.Size = 1LL;
  v2 = *(_OWORD *)PopGetBlockedPhaseGuid((__int64)&v12, 3);
  v19 = v3;
  v15 = &v13;
  v16 = 16LL;
  v17 = &v9;
