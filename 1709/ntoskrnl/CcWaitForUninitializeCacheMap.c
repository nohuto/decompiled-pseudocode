/*
 * XREFs of CcWaitForUninitializeCacheMap @ 0x140121200
 * Callers:
...
void __fastcall CcWaitForUninitializeCacheMap(__int64 a1)
{
  ...
  unsigned __int64 v18; // [rsp+30h] [rbp-A8h] BYREF
  ...
  char v25[8]; // [rsp+80h] [rbp-58h] BYREF
  ...
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 40) + 8LL) )
  {
    ...
    if ( v8 )
    {
      ...
      KxAcquireQueuedSpinLock((__int64)&v23, (volatile __int64 *)(Partition + 128));
      v6 = 1;
          ...
          *(_QWORD *)(v8 + 272) = (char *)&v18 + 1;
          ...
          if ( (v10 & 0x20) != 0 )
          {
            if ( *(_QWORD *)(v8 + 496) )
            {
              ...
              KxAcquireQueuedSpinLock((__int64)&v24, (volatile __int64 *)(Partition + 192));
              v12 = *(_QWORD *)(v8 + 496);
              if ( v12 )
              {
    ...
    if ( v2 )
    {
      ...
      if ( KeWaitForSingleObject(&Object, Executive, 0, 0, &Timeout) == 258 )
      {
        ...
        if ( v15 )
        {
          v16 = (unsigned __int64 *)(v15 + 272);
          if ( *(_QWORD *)(v15 + 272) )
          {
            while ( 1 )
            {
              v17 = *v16;
              if ( (unsigned __int64 *)*v16 == (unsigned __int64 *)((char *)&v18 + 1) )
                break;
              v16 = (unsigned __int64 *)(v17 & 0xFFFFFFFFFFFFFFFEuLL);
              if ( !*(_QWORD *)(v17 & 0xFFFFFFFFFFFFFFFEuLL) )
                goto LABEL_30;
            }
            *v16 = v18;
          }
