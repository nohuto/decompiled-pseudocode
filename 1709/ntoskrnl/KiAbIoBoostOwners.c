/*
 * XREFs of KiAbIoBoostOwners @ 0x14011B6B8
 * Callers:
...
__int64 __fastcall KiAbIoBoostOwners(__int64 a1, char a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  while ( v10 )
  {
    KiAbSetMinimumThreadPriority((__int64)v10, (__int64)&v14, a3, a4, v7, &v13);
    v12 = (__int64 *)v10[1];
    result = (__int64)v10;
    if ( v12 )
    {
  ...
  if ( (*(_BYTE *)(a1 + 25) & 1) == 0 )
    return KiAbSetMinimumThreadPriority(a1, (__int64)&v14, a3, a4, v7, &v13);
  return result;
}
