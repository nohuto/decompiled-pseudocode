        ...
        unsigned __int64 a9)
{
  ...
  *(_QWORD *)&v42[3] = 0LL;
  ...
  if ( !a9 )
    return -1073741776;
LABEL_14:
  result = ObReferenceObjectByHandle(a2, 2u, (POBJECT_TYPE)SeTokenObjectType, PreviousMode, &Token, &v52);
  if ( result < 0 )
    return result;
...
LABEL_36:
  AppContainerSidType = RtlGetAppContainerSidType(v20, &v45);
  if ( AppContainerSidType < 0 )
  {
LABEL_81:
    v29 = *(_QWORD *)&v42[3];
  ...
  if ( v45 == 1 )
  {
    AppContainerSidType = SepCheckCapabilities(Token, a6, v44, v27, (char *)v42);
    if ( !LOBYTE(v42[0]) )
    {
  ...
  if ( AppContainerSidType < 0 )
    goto LABEL_81;
  AppContainerSidType = SepDuplicateToken((__int64)Token, v9, 0, 1, 0, PreviousMode, 0, &v42[3]);
  if ( AppContainerSidType < 0 )
    goto LABEL_81;
  v28 = 1;
  v40 = 1;
  v29 = *(_QWORD *)&v42[3];
  AppContainerSidType = SeSetMandatoryPolicyToken(*(_QWORD *)&v42[3], &v49);
  if ( AppContainerSidType >= 0 )
  {
    ...
    if ( TokenIntegrity )
    {
      ...
      v35 = AppContainerPrivilegesEnabledExt(Src, 0x200800000LL, &v53, &v54);
    ...
    {
      v20 = (char *)Sid;
      AppContainerSidType = SepSetTokenCapabilities(v29, Sid, (void *)v44, a6);
      if ( AppContainerSidType < 0 )
        goto LABEL_82;
      AppContainerSidType = SepSetTokenLowboxNumber(v29, v20);
      if ( AppContainerSidType < 0 )
        goto LABEL_82;
      v55 = 0;
      v56 = v20;
      AppContainerSidType = SepSetTokenCachedHandles(v29, &v55, a8, P, (_DWORD)Object, HandleInformation, v39);
      if ( AppContainerSidType < 0 )
        goto LABEL_82;
      AppContainerSidType = SepSetTokenPackage(v29, v20);
      if ( AppContainerSidType < 0 )
        goto LABEL_82;
      AppContainerSidType = SepAppendAceToTokenDefaultDacl(v29, (__int64)v20);
      if ( AppContainerSidType < 0 )
        goto LABEL_82;
