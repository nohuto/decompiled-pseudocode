/*
 * XREFs of ?StDmCombineRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x14026C364
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCombineRegion(__int64 a1, int a2)
{
  ...
  **(_DWORD **)(a1 + 760) = v5;
  ...
  while ( 1 )
  {
    ...
    if ( !PreviousEntry )
      break;
    v7 = (unsigned int)(*PreviousEntry >> *(_DWORD *)(a1 + 456));
    _BitScanReverse((unsigned int *)&v8, v7);
    v9 = (_DWORD *)(*(unsigned int *)(a1 + 472)
                  + (unsigned int)(*(_DWORD *)(a1 + 464) * (*PreviousEntry & *(_DWORD *)(a1 + 460)))
                  + *(_QWORD *)(*(_QWORD *)(a1 + 8 * v8 + 192) + 16 * (v7 ^ (unsigned int)(1 << v8))));
    if ( *v9 >> *(_DWORD *)(a1 + 812) != a2 )
      break;
    if ( (v9[1] & 0xFFFFF000) <= 0x1000
      && (unsigned int)ST_STORE<SM_TRAITS>::StDmCombineBufferAddEntry(a1, (unsigned int *)v2, (unsigned int *)&v11, v9) == -2147483643 )
    {
