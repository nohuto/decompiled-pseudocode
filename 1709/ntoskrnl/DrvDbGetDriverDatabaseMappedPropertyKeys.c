/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x140786BA4
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)a6 = 0;
  v13 = 0;
  result = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_1403549C0, 5u, a4, a5, v37);
  if ( (int)result < 0 )
    return result;
  v16 = *v6;
  if ( (_DWORD)v16 )
  ...
  LOBYTE(v38) = 0;
  LODWORD(v36) = 1;
  v17 = DrvDbOpenObjectRegKey(v12, v12[4], 1u, v9, v36, v38, &KeyHandle, 0LL);
  if ( v17 < 0 )
    goto LABEL_48;
  v18 = KeyHandle;
  v19 = &off_1402BBE90;
...
LABEL_31:
  if ( !v10 )
  {
    v17 = DrvDbOpenDriverDatabaseRegKey(v12, v9, 1, 0, (__int64)&Handle, 0LL);
    if ( v17 < 0 )
      goto LABEL_48;
    v10 = Handle;
  }
