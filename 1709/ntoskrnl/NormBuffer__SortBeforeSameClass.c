/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x140256194
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x140255BC8 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x140255C6C (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x140726FC0 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x140726FD8 (Normalization__TableLookup.c)
 */
