/*
 * XREFs of AuthzBasepIsValidExpression @ 0x14001876C
 * Callers:
 *     AuthzBasepEvaluateAceCondition @ 0x140017110 (AuthzBasepEvaluateAceCondition.c)
 * Callees:
 *     AuthzBasepSupportSetOperation @ 0x140018890 (AuthzBasepSupportSetOperation.c)
 */
...
bool __fastcall AuthzBasepIsValidExpression(__int64 a1, __int64 a2, int a3, _BYTE *a4)
{
  ...
  *a4 = 0;
  ...
  if ( a3 )
  {
    ...
    {
      LOBYTE(a1) = v5;
      if ( !(unsigned __int8)AuthzBasepSupportSetOperation(a1) && v9 != 1 && *v10 > 1u )
        goto LABEL_33;
      ++v6;
      v7 = v10 + 10;
      if ( v6 >= v8 )
