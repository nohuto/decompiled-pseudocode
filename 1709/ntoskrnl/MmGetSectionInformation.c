/*
 * XREFs of MmGetSectionInformation @ 0x14048C730
 * Callers:
...
__int64 __fastcall MmGetSectionInformation(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( a2 != 1 && a2 != 4 )
  {
    if ( (v8 & 0x20) != 0 )
    {
      v19 = MiRelocateAmount(v6, 0LL);
      if ( a2 == 2 )
      {
        if ( (v20 & v6[14]) != 0 )
          v19 += qword_1403884C0 - *(_QWORD *)(*(_QWORD *)v6 + 32LL);
        *(_QWORD *)a3 = v19;
      }
      else
      {
  ...
  {
    *(_QWORD *)&v28 = qword_1403884C0 | (unsigned __int16)v28;
    v11 = v28;
  }
  if ( a2 == 4 )
  {
    ControlAreaLoadConfig = (_BYTE *)MiGetControlAreaLoadConfig((__int64)v6);
    LODWORD(v29) = v9;
    if ( ControlAreaLoadConfig )
    {
      v17 = (*ControlAreaLoadConfig & 0x10) == 0;
      v18 = v9;
      if ( !v17 )
        v18 = v16;
      LODWORD(v29) = v18;
