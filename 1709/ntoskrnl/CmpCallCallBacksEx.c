    ...
    for ( i = *v14; ; i = *(_QWORD *)i )
    {
      ...
      if ( *(int *)(i + 16) >= 0 )
      {
        ...
        *((_QWORD *)&PoolWithTag[1].Next + 1) = v46;
        ...
        v25 = (struct _SLIST_ENTRY **)*((_QWORD *)&a7->Next + 1);
        if ( *v25 != a7 )
          __fastfail(3u);
        PoolWithTag->Next = a7;
        ...
        *((_QWORD *)&a7->Next + 1) = PoolWithTag;
        ...
        if ( v28 < 0 )
        {
          ...
          v38 = (struct _SLIST_ENTRY **)*((_QWORD *)&PoolWithTag->Next + 1);
...
LABEL_46:
  ...
  if ( !v7 )
  {
    ...
    while ( a7->Next != v57 )
    {
      v30 = (struct _SLIST_ENTRY *)*((_QWORD *)&a7->Next + 1);
      v53 = v30;
      ...
      *v31 = a7;
      v49 = (struct _SLIST_ENTRY *)*((_QWORD *)&v30[1].Next + 1);
      v32 = v49;
      v11[4] = v30[2].Next;
