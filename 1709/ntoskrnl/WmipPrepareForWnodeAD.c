/*
 * XREFs of WmipPrepareForWnodeAD @ 0x140588B24
 * Callers:
...
__int64 __fastcall WmipPrepareForWnodeAD(__int64 a1, _OWORD *a2, unsigned int *a3, void **a4, _BYTE *a5)
{
  __int64 v5; // rdi
  int v8; // ebx
  bool v9; // zf
  ...
  if ( v15 != v14 )
  {
    do
    {
      ...
      if ( (*(_DWORD *)(v15 + 16) & 0x89000) == 0 )
      {
        ...
        v8 = WmipAddProviderIdToPIList((const void **)&v18, &v19, &v17, v11, (volatile signed __int64 *)v15);
      }
      v15 = *(_QWORD *)v15;
    }
    while ( v15 != v14 );
