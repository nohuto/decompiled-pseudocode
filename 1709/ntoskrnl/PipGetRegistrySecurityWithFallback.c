/*
 * XREFs of PipGetRegistrySecurityWithFallback @ 0x140576C08
 * Callers:
...
__int64 __fastcall PipGetRegistrySecurityWithFallback(__int64 a1, __int64 a2, __int64 a3, __int64 a4, void *a5)
{
  bool v8; // di
