/*
 * XREFs of EtwpLogMemInfoWsHelper @ 0x140746978
 * Callers:
...
void __fastcall EtwpLogMemInfoWsHelper(__int64 a1, _DWORD *a2)
{
  ...
  if ( a1 )
  {
    EtwpLogKernelEvent((__int64)&UserData, *(_QWORD *)(a1 + 2256), *(_DWORD *)a1, 2u, 0x27Du, 0x401804u);
  }
  else
  {
    EtwTraceKernelEvent((__int64)&UserData, 2u, 0x20800000u, 0x27Du, 0x401804u);
    if ( EtwpHostSiloState != -4464 && (*(_DWORD *)(EtwpHostSiloState + 4468) & 0x800000) != 0 )
