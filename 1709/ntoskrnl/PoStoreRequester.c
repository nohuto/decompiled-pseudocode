/*
 * XREFs of PoStoreRequester @ 0x1400B0064
 * Callers:
...
LABEL_37:
        ...
        if ( DeviceNode )
        {
          ...
          v6 = v25 + ResultLength + 40LL;
          if ( v10 && v4 >= v6 )
          {
            v10 = 1;
            RtlStringCbCopyUnicodeString((NTSTRSAFE_PWSTR)v9, ResultLength, (PCUNICODE_STRING)(DeviceNode + 20));
            *(_QWORD *)(a2 + 24) = &v9[-a2];
          }
          else
          {
