/*
 * XREFs of CmpVerifyLogRecord @ 0x14043C5B0
 * Callers:
 *     CmpRmReDoPhase @ 0x1406968A8 (CmpRmReDoPhase.c)
 * Callees:
 *     CmpVerifyCreateOrDeleteKeyLogRecord @ 0x14043C544 (CmpVerifyCreateOrDeleteKeyLogRecord.c)
 *     CmpVerifyRenameKeyLogRecord @ 0x14043C690 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x14043C6EC (CmpVerifySetOrDeleteValueLogRecord.c)
 *     CmpVerifySetSecurityDescriptorLogRecord @ 0x14043C770 (CmpVerifySetSecurityDescriptorLogRecord.c)
