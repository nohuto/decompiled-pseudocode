/*
 * XREFs of PpmInstallCoordinatedIdleStates @ 0x1406F5D30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmCheckCoordinatedStateInitiator @ 0x14023A730 (PpmCheckCoordinatedStateInitiator.c)
 ...
 *     PpmIdleUpdateCoordinatedDependencies @ 0x14070C518 (PpmIdleUpdateCoordinatedDependencies.c)
 */
...
LABEL_49:
  ...
  else
  {
    ...
    v72 = (v13 + 7 + 24 * v6) & 0xFFFFFFF8;
    v14 = v72 + 24 * v7;
    v65 = (v14 + 3) & 0xFFFFFFFC;
    v15 = (v14 + 4 * v4 * KeNumberProcessors_0 + 7) & 0xFFFFFFF8;
    v66 = (4 * v4 + 15) & 0xFFFFFFF8;
    v67 = (v15 + 1008 * v4 + 31) & 0xFFFFFFF8;
    v16 = (KeNumberProcessors_0 * v66 + 7 + v67) & 0xFFFFFFF8;
    v71 = v16;
    if ( PpmIdleVetoList )
    ...
    *(_QWORD *)(v12 + 48) = v19;
    ...
    v20 = 0LL;
    for ( i = v12 + v71; (unsigned int)v20 < *v1; v20 = (unsigned int)(v20 + 1) )
    {
        ...
        do
        {
          ...
          *(_BYTE *)(v52 + 8 * v53 + 2) = *(_BYTE *)(v51 + 4 * v48 + 3);
          if ( *(_DWORD *)(v46 + 24 * v45) == -1 )
          {
            ...
            *(_QWORD *)(v52 + 8 * v53 + 16) = *(_QWORD *)(v55 + v12 + 312);
          }
          else
          {
  ...
  {
    v57 = 0;
    for ( k = *(_QWORD *)(KeGetPrcb(j) + 23808); v57 < v68; *(_BYTE *)(v63 + 8 * v61 + 1) = v62 )
    {
      v60 = v68 - v57 - 1;
      v61 = 3 * v60;
      v62 = PpmCheckCoordinatedStateInitiator(
              j,
              *(_DWORD *)(*(_QWORD *)(k + 784) + 24 * v60 + 8),
              *(_QWORD *)(*(_QWORD *)(k + 784) + 24 * v60 + 16),
              v58);
      ++v57;
    }
  }
