/*
 * XREFs of CmpDoFlushNextHive @ 0x1404E3960
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      if ( (*(_DWORD *)(NextActiveHive + 144) & 3) == 0 )
      {
        if ( *(_DWORD *)(NextActiveHive + 88) || *(_BYTE *)(NextActiveHive + 175) )
        {
          ...
          v10 = *(_QWORD *)(NextActiveHive + 5384) + 10000000LL * (unsigned int)dword_140353870;
          if ( UnbiasedInterruptTime < v10 )
          {
            v3 = 1;
            v7 = v10 - UnbiasedInterruptTime;
          }
          else if ( (int)CmpFlushHive(NextActiveHive, 0x12u) < 0 )
          {
            v3 = 1;
            *a1 = 1;
            v7 = 10000000LL * (unsigned int)dword_14035387C;
          }
        }
