/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x14082955C
 * Callers:
...
_QWORD *MiFlushStrongCodeDriverLoadFailures()
{
  ...
  while ( 1 )
  {
    v1 = (unsigned __int16 *)qword_1403883E8;
    if ( qword_1403883E8 == &qword_1403883E8 )
      break;
    if ( *((PVOID **)qword_1403883E8 + 1) != &qword_1403883E8
      || (v3 = *(_QWORD *)qword_1403883E8, *(PVOID *)(*(_QWORD *)qword_1403883E8 + 8LL) != qword_1403883E8) )
    {
      __fastfail(3u);
    }
    qword_1403883E8 = *(PVOID *)qword_1403883E8;
    *(_QWORD *)(v3 + 8) = &qword_1403883E8;
    if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 0x400000000000uLL) )
    {
      ...
      v20 = 4;
      v23 = 4;
      TlgWriteEx(v7, &unk_1402D064E, v6, (ULONG)v7, v8, v9, 7u, &pData);
    }
