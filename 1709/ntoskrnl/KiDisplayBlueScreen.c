/*
 * XREFs of KiDisplayBlueScreen @ 0x140206534
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x1402061A8 (KeGetBugMessageText.c)
...
__int64 __fastcall KiDisplayBlueScreen(int a1)
{
  ...
  if ( (dword_14035A1B0 & 2) != 0 )
    BgpFwDisplayBugCheckScreen(v14, (unsigned int)&qword_140370C68, v3, (unsigned int)&v21, a1);
  BgpFwReleaseLock();
