/*
 * XREFs of EtwpLocateDbgIdForRegEntry @ 0x1404F1214
 * Callers:
 ...
 *     EtwpGetImageSize @ 0x1405EFFF0 (EtwpGetImageSize.c)
 */

NTSTATUS __fastcall EtwpLocateDbgIdForRegEntry(char a1, __int64 a2, __int64 *a3, unsigned int *a4)
{
  void *v7; // rcx
