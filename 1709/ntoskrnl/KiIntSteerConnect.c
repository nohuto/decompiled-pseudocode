/*
 * XREFs of KiIntSteerConnect @ 0x1400B32A0
 * Callers:
...
__int64 __fastcall KiIntSteerConnect(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  {
    v35 = *(_DWORD *)(a3 + 56);
    if ( (unsigned __int8)off_1403534C0[0]() )
    {
      v6 = 0;
      v26 = ((__int64 (__fastcall *)(__int64, int *))off_1403534A8[0])(a3, &v35);
      if ( !v26 )
        goto LABEL_38;
    }
    else
    ...
    if ( i )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        *(_QWORD *)(i + 120) = *(_QWORD *)(a3 + 80);
        ...
        v19 = (__int64 *)qword_14036A858;
        if ( *(ULONG_PTR **)qword_14036A858 != &KiIntTrackRootList )
          __fastfail(3u);
        *(_QWORD *)(i + 8) = qword_14036A858;
