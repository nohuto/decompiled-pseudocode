/*
 * XREFs of PopMarkHiberPhase @ 0x140433E88
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140365B50, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140365B18, (unsigned int)dword_140365B20, 0);
