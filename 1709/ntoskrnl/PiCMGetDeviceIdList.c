/*
 * XREFs of PiCMGetDeviceIdList @ 0x140586D80
 * Callers:
 ...
 *     PiCMConvertDeviceListFilters @ 0x1405870BC (PiCMConvertDeviceListFilters.c)
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x2000000) != 0 )
  {
    ...
    McTemplateK0zzt((__int64)v21, v10, v13, v26, v21, BYTE2(v25) & 1);
  }
  if ( !a3 || a4 < 0x14 )
  {
...
LABEL_18:
    ...
    {
      v19 = PiCMReturnBufferResultData(DeviceRelationsList, 2 * v22, 0, PoolWithTag, 2 * v22, v27, a3, a4, v6);
      goto LABEL_20;
    }
    goto LABEL_28;
  }
...
LABEL_28:
  v19 = PiCMReturnBufferResultData(DeviceRelationsList, 2 * v22, 0, 0LL, 0, v27, a3, a4, a6);
LABEL_20:
  v12 = v19;
  if ( PoolWithTag )
