/*
 * XREFs of KiSystemCall64 @ 0x140191400
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiConvertToGuiThread @ 0x140184AE0 (KiConvertToGuiThread.c)
        ...
        __int64 a49)
{
  ...
  else
  {
    if ( (a2 & 2) != 0 && (KeGetPcr()->Prcb.BpbFeatures & 4) == 0 )
    {
      ...
      v125 = 0x1401915E0LL;
      v124 = 0x1401915D7LL;
      *((_QWORD *)&v123 + 1) = 0x1401915CELL;
      *(_QWORD *)&v123 = 0x1401915C5LL;
      *((_QWORD *)&v122 + 1) = 0x1401915BCLL;
      *(_QWORD *)&v122 = 0x1401915B3LL;
      *((_QWORD *)&v121 + 1) = 0x1401915AALL;
      *(_QWORD *)&v121 = 0x1401915A1LL;
      *((_QWORD *)&v120 + 1) = 0x140191598LL;
      *(_QWORD *)&v120 = 0x14019158FLL;
      *((_QWORD *)&v119 + 1) = 0x140191586LL;
      *(_QWORD *)&v119 = 0x14019157DLL;
      *((_QWORD *)&v118 + 1) = 0x140191574LL;
      *(_QWORD *)&v118 = 0x14019156BLL;
      v117 = 0x140191562LL;
      v116 = 0x140191559LL;
      v115 = 0x140191550LL;
      v114 = 0x140191547LL;
...
LABEL_19:
  ...
  while ( v62 );
  v95 = *((unsigned int *)&xmmword_140401720 + 4);
  if ( (unsigned int)v73 >= (unsigned int)v95
    || (result = (unsigned int)*(char *)(v73 + xmmword_140401720 + 4 * v95), (int)result > 0) )
  {
LABEL_80:
    result = 3221225500LL;
  }
