/*
 * XREFs of PfpPrefetchRequestPerform @ 0x14043FA98
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x14043F9F4 (PfpPrefetchRequestPatchOffsets.c)
...
__int64 __fastcall PfpPrefetchRequestPerform(__int64 a1)
{
  ...
  *(_QWORD *)(v30[5] + 24LL) = v30;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v30[0] + 81LL) )
    {
      _InterlockedAdd(&dword_14039E918, 1u);
      p_Event = &Event;
      if ( *(_QWORD *)(v30[0] + 72LL) )
        p_Event = *(struct _KEVENT **)(v30[0] + 72LL);
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_14038D2C0, v5, (__int64)p_Event, 0, 0);
      if ( v4 < 0 )
        goto LABEL_26;
      if ( !*(_QWORD *)(v30[0] + 72LL) )
...
LABEL_12:
        ...
        if ( *(_DWORD *)(a1 + 20) )
        {
          ...
          v4 = v23;
          if ( v23 == -1073741670 || v23 == -1073741801 || v23 == -1073741248 )
            goto LABEL_26;
        }
        v15 = 0;
        if ( *(_DWORD *)(a1 + 8) )
...
LABEL_26:
        if ( v5 )
        {
          _InterlockedDecrement(&dword_14039E918);
          PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_14038D2C0, v5, 0LL, 1, 0);
        }
        goto LABEL_28;
      }
