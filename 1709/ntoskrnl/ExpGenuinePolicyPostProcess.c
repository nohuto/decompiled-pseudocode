...
__int64 __fastcall ExpGenuinePolicyPostProcess(__int64 a1, _BYTE *a2, int a3, __int64 a4, _BYTE *a5)
{
  ...
  *a5 = 0;
  if ( !v12 )
  {
    LicenseValue = sub_140757628(a1, (_DWORD)a2, a3, a4, 2);
    *a5 = 1;
...
LABEL_7:
  ...
  {
    LicenseValue = qword_1407F33E8 ? qword_1407F33E8(v15) : -1073741637;
    if ( LicenseValue >= 0 )
    {
      if ( qword_1407F33A8 )
      {
        LicenseValue = ExpOsProductCacheProviderHelper(
                         (PUNICODE_STRING)&stru_14078CB58,
...
LABEL_19:
      if ( !v15[0] || v8 )
      {
        LicenseValue = sub_140757628(v17, v5, a3, v16, 2);
        *a5 = 1;
      }
      goto LABEL_21;
    }
