/*
 * XREFs of NtDebugActiveProcess @ 0x1406AB268
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtDebugActiveProcess(HANDLE Process, HANDLE DebugObject)
{
  ...
  if ( result >= 0 )
  {
    ...
    else
    {
      ...
      if ( !v9 )
      {
        if ( (*(_QWORD *)(v7 + 720) & 1) == 0
          || (v22 = *(_QWORD *)(v7 + 720), v23 = 1LL, v10 = VslpEnterIumSecureMode(2u, 11LL, 0, (__int64)v21), v10 >= 0) )
        {
            ...
            || (v13 = *(_QWORD *)(v7 + 1064)) != 0 && ((v14 = *(_WORD *)(v13 + 8), v14 == 332) || v14 == 452) )
          {
            ...
            if ( v10 >= 0 )
            {
              v15 = ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)(v7 + 760));
