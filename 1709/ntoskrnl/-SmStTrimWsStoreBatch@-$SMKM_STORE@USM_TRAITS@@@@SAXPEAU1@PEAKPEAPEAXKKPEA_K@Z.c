/*
 * XREFs of ?SmStTrimWsStoreBatch@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@PEAKPEAPEAXKKPEA_K@Z @ 0x140269500
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  if ( (_DWORD)v7 )
  {
    do
    {
      result = SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v11, *v10++, v31, v32, MemoryInformationLength, 2);
      --v7;
    }
    while ( v7 );
  }
