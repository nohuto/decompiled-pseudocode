/*
 * XREFs of PoFxInitPowerManagement @ 0x1408527CC
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  *(_QWORD *)&PopFxResidentTimer.Processor = 0LL;
  ...
  v0 = 4LL;
  qword_140366D38 = (__int64)&SocSubsystemsList;
  v1 = (__int64 (__fastcall **)(__int64))&unk_140366D70;
  SocSubsystemsList = (__int64)&SocSubsystemsList;
  v2 = (char *)&unk_140366EC1;
  do
  {
    v1[3] = 0LL;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_1403652E8 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_1403653B0 = (__int64)PopPepIdleTimeoutRoutine;
