/*
 * XREFs of sub_14076CB9C @ 0x14076CB9C
 * Callers:
...
__int64 __fastcall sub_14076CB9C(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  int v4; // ebx
  __int64 v8; // r15
  signed int v9; // r8d
        ...
        if ( *(_DWORD *)a4 )
        {
          while ( 1 )
          {
            ...
            if ( *(_DWORD *)v37 < 0xFFFFFFFC )
              v38 = *(_DWORD *)v37 + 4;
            v9 = *(_DWORD *)v37 >= 0xFFFFFFFC ? 0xC0000095 : 0;
