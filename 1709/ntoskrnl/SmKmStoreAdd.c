/*
 * XREFs of SmKmStoreAdd @ 0x1404450EC
 * Callers:
...
__int64 __fastcall SmKmStoreAdd(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  ...
  do
  {
    if ( !*(_QWORD *)(a1 + 8 * v5) )
    {
      v18 = (char *)SmAlloc(0x500uLL, 0x61536D73u);
      v19 = (struct _PRIVILEGE_SET *)v18;
      if ( !v18 )
        return (unsigned int)-1073741670;
      v20 = (unsigned __int64)(v18 + 1280);
      if ( v18 < v18 + 1280 )
      {
        v21 = (struct _EX_RUNDOWN_REF *)(v18 + 8);
        do
        {
          memset(&v21[-1], 0, 0x28uLL);
          ExInitializePushLock(&v21->Count);
          ExWaitForRundownProtectionRelease(v21);
          v21[1].Count = 0LL;
          v21 += 5;
        }
        while ( (unsigned __int64)&v21[-1] < v20 );
      }
