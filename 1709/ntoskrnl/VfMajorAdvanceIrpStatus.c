/*
 * XREFs of VfMajorAdvanceIrpStatus @ 0x1407B4EA4
 * Callers:
...
__int64 __fastcall VfMajorAdvanceIrpStatus(unsigned __int8 *a1, unsigned int a2, __int64 a3)
{
  ...
  v6 = *a1;
  if ( *a1 > 0x1Bu )
    v7 = (unsigned int)(v6 != 0xFF) + 28;
  else
    v7 = v6;
  v8 = (unsigned int (__fastcall *)(unsigned __int8 *))*((_QWORD *)&unk_1407D5E68 + 12 * v7);
  if ( v8 && v8(a1) )
    return 1LL;
  if ( qword_1407D68E8 )
    return qword_1407D68E8(a1, a2, a3);
  else
    return 0LL;
}
