/*
 * XREFs of KeMarkHiberPhase @ 0x14042E018
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( *(_DWORD *)(v1 + 36) )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      Address,
      ((((_DWORD)KeNumberProcessors_0 << 6) + 72127) & 0xFFFFF000) + 28672,
      0x6370654Bu);
  }
  else
  {
  ...
  PoSetHiberRange(0LL, 0x10000u, *(PVOID *)(v1 + 25280), v6, 0x7873654Bu);
  v7 = *(void **)(v1 + 23808);
  if ( v7 )
    PoSetHiberRange(0LL, 0x10000u, v7, 0x428uLL, 0x7349654Bu);
  if ( qword_14036AAB8 )
    PoSetHiberRange(0LL, 0x10000u, qword_14036AAB8, 16 * (unsigned int)(unsigned __int8)qword_14036AAA8, 0x7272744Du);
  if ( qword_14036AAC0 )
    PoSetHiberRange(0LL, 0x10000u, qword_14036AAC0, 0x58uLL, 0x7272744Du);
  v8 = *(_QWORD **)(v1 + 8);
  v9 = (void *)((v8[6] + 4095LL) & 0xFFFFFFFFFFFFF000uLL);
  v10 = v8[7] - (_QWORD)v9;
  PoSetHiberRange(0LL, 0x10000u, v8, 0x818uLL, 0x6874654Bu);
