/*
 * XREFs of BapdRecordFirmwareBootStats @ 0x140424BFC
 * Callers:
...
void BapdRecordFirmwareBootStats()
{
  ...
  if ( BapdRegisterEtwProvider((const GUID *)&BOOTENV_ETW_PROVIDER, 1, &RegHandle) >= 0
    && ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, SIZE_T *))off_140354F48[0])(
         34LL,
         0LL,
         0LL,
         &NumberOfBytes) == -1073741820 )
  {
    if ( (_DWORD)NumberOfBytes )
    {
      ...
      if ( PoolWithTag )
      {
        if ( ((int (__fastcall *)(__int64, _QWORD, _QWORD *, SIZE_T *))off_140354F48[0])(
               34LL,
               ...
               &NumberOfBytes) >= 0 )
        {
          ...
          TraceLoggingRegisterEx(&stru_1403554B0, 0LL, 0LL);
          if ( stru_1403554B0.LevelPlus1 > 4 )
          {
            if ( TlgKeywordOn(&stru_1403554B0, 0x400000000000uLL) )
            {
              v30 = 0;
              v33 = 0;
              v36 = 0;
              ...
              v38 = 8;
              v41 = 8;
              TlgWrite(&stru_1403554B0, &unk_1402D4F05, 0LL, 0LL, 7u, &pData);
            }
          }
        }
