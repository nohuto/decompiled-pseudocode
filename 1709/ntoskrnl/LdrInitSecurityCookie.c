/*
 * XREFs of LdrInitSecurityCookie @ 0x14054301C
 * Callers:
...
__int64 __fastcall LdrInitSecurityCookie(void *a1, __int64 a2, __int64 a3, unsigned __int64 a4, _DWORD *a5)
{
  ...
  a5 = 0LL;
  AddressOfSecurityCookie = LdrpFetchAddressOfSecurityCookie(a1, (__int64)&a5);
