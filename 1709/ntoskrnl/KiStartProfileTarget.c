/*
 * XREFs of KiStartProfileTarget @ 0x1402087C0
 * Callers:
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)Argument + 2, 0xFFFFFFFF) == 1 )
  {
    ...
    else
    {
      ...
      *(_BYTE *)(v2 + 242) = 1;
      ...
      {
        v8 = (_QWORD *)qword_1403714E8;
        if ( *(__int64 **)qword_1403714E8 != &KiProfileListHead )
          __fastfail(3u);
        *v5 = &KiProfileListHead;
        *(_QWORD *)(v2 + 16) = v8;
        *v8 = v5;
        qword_1403714E8 = v2 + 8;
      }
...
LABEL_14:
      ...
      v11 = (char *)(v9 + 24);
      KeSubtractAffinityEx((char *)(v2 + 72), v11, (_BYTE *)Argument + 16);
      _InterlockedOr(v14, 0);
      KeOrAffinityEx((unsigned __int16 *)v11, (_WORD *)(v2 + 72), v11);
