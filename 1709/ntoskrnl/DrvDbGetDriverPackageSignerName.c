/*
 * XREFs of DrvDbGetDriverPackageSignerName @ 0x140787520
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( (*v8)[4] == 7 )
    {
      v11 = *(_QWORD *)v10 - DEVPKEY_DriverPackage_SignerName;
      if ( *(_QWORD *)v10 == DEVPKEY_DriverPackage_SignerName )
