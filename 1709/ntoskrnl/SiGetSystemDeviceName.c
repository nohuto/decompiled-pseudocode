/*
 * XREFs of SiGetSystemDeviceName @ 0x14057DA64
 * Callers:
 *     SyspartDirectGetSystemPartition @ 0x14057DA40 (SyspartDirectGetSystemPartition.c)
 *     SyspartGetSystemPartition @ 0x1405B1B1C (SyspartGetSystemPartition.c)
 *     SyspartDirectGetSystemDisk @ 0x1405DEAD0 (SyspartDirectGetSystemDisk.c)
