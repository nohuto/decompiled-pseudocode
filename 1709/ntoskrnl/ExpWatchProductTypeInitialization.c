/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x140839140
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  qword_14035E570 = (__int64)ExpWatchProductTypeWork;
  qword_14035E578 = 0LL;
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        if ( NtQueryValueKey(ExpProductTypeKey, &ValueName, KeyValuePartialInformation, v45, 0x10u, &ResultLength) != -2147483643 )
          goto LABEL_18;
        ResultLength += 16;
        qword_14038D018 = ExAllocatePoolWithTag(PagedPool, ResultLength, 0x2079654Bu);
        if ( !qword_14038D018 )
        ...
        if ( NtQueryValueKey(
               ...
               ResultLength,
               &ResultLength) >= 0
          || (ExFreePoolWithTag(qword_14038D018, 0), qword_14038D018 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
