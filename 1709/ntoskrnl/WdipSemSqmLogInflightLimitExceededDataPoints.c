/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x14058F7F4
 * Callers:
 ...
 *     WdipSemGetGuidKey @ 0x14073FCB4 (WdipSemGetGuidKey.c)
...
__int64 WdipSemSqmLogInflightLimitExceededDataPoints()
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_1403617E8, 0LL);
  v3 = (unsigned int)dword_1403617E0;
  if ( dword_1403617E0 )
  {
    v1 = WdipSemSqmIncrementDword(v2, (unsigned int)dword_1403617E0);
    if ( v1 < 0 )
      v1 = 0;
    if ( (_DWORD)v3 )
    {
  ...
  for ( i = 0; i < dword_1403617E0; WdipSemFrequentScenarioTable[v8] = 0LL )
  {
    v8 = i;
    WdipSemFastFree(5LL, WdipSemFrequentScenarioTable[i++]);
  }
  dword_1403617E0 = 0;
  ExReleasePushLockEx((ULONG_PTR)&qword_1403617E8, 0LL);
