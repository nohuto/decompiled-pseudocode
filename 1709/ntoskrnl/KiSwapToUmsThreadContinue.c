/*
 * XREFs of KiSwapToUmsThreadContinue @ 0x14020E7F0
 * Callers:
 *     KiUmsTrapEntryContinue @ 0x140192740 (KiUmsTrapEntryContinue.c)
 *     KiUmsCallEntryContinue @ 0x140192900 (KiUmsCallEntryContinue.c)
