/*
 * XREFs of BgpConsoleScrollScreen @ 0x1407D3640
 * Callers:
...
__int64 BgpConsoleScrollScreen()
{
  ...
  v1 = 0;
  v2 = 0LL;
  v3 = (_DWORD *)(qword_14038D868 + 60);
  v4 = (_DWORD *)(qword_14038D868 + 48);
  do
  {
    v5 = 0;
    if ( *(_DWORD *)(v0 + 4) != 1 )
    {
      do
      {
          ...
          || *(_DWORD *)(v0 + 12 * (v2 + v5 + 7LL)) != *(_DWORD *)(v0 + 12 * (v2 + v6 + 7)) )
        {
          ...
          if ( v15 >= 0 )
          {
            *(_WORD *)(qword_14038D868 + 4 * v10 + 88) = v8;
  ...
  do
  {
    ...
    if ( v21 >= 0 )
    {
      v22 = v20 + v18;
      v23 = 3 * v22;
      *(_WORD *)(qword_14038D868 + 4 * v23 + 88) = 32;
