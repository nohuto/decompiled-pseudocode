/*
 * XREFs of _CmDeleteInstallerClassMappedPropertyFromRegValue @ 0x140783624
 * Callers:
...
LABEL_22:
    ...
    if ( RtlInitUnicodeStringEx(&DestinationString, &word_1405F52C0) >= 0 )
      ZwDeleteValueKey(v5, &DestinationString);
    goto LABEL_32;
  }
  v6 = CmOpenInstallerClassRegKey((int)a1, a2, v10, (__int64)v9, 2, 0, (__int64)&Handle, 0LL);
  if ( v6 >= 0 )
  {
    v5 = Handle;
    goto LABEL_12;
