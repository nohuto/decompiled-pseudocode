/*
 * XREFs of MmAddPrivateDataToCrashDump @ 0x1404306F4
 * Callers:
...
__int64 __fastcall MmAddPrivateDataToCrashDump(__int64 (__fastcall **a1)(_QWORD, __int64, __int64), char a2)
{
  ...
  if ( (a2 & 1) != 0 )
  {
    v5 = MmAddRangeToCrashDump(a1, MmPfnDatabase, 48 * (qword_1403885E0 + 1));
    if ( v5 < 0 )
      v2 = v5;
  }
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v11 = (__int64 *)qword_140389300;
    while ( v11 != &qword_140389300 )
    {
