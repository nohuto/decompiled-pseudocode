/*
 * XREFs of PnpCmResourcesToIoResources @ 0x1405D2108
 * Callers:
...
LABEL_21:
    ...
    while ( 1 )
    {
      *v19 = 1;
      v19[1] = v20->Type;
      v19[2] = v20->ShareDisposition;
      *((_WORD *)v19 + 2) = v20->Flags;
      v19[3] = 0;
      *((_WORD *)v19 + 3) = 0;
      switch ( v20->Type )
      {
        ...
        case 2u:
          if ( (v20->Flags & 2) != 0 )
          {
            ...
            *((_WORD *)v19 + 8) = 4;
            *((_WORD *)v19 + 9) = v20->u.MessageInterrupt.Raw.Reserved;
        ...
        case 4u:
          ...
          {
            *((_DWORD *)v19 + 2) = v20->u.Generic.Start.HighPart;
            *((_DWORD *)v19 + 3) = v20->u.Generic.Start.HighPart;
            *((_DWORD *)v19 + 4) = v20->u.Generic.Start.LowPart;
            *((_DWORD *)v19 + 5) = v20->u.DmaV3.TransferWidth;
          }
          else
          {
            *((_DWORD *)v19 + 2) = v20->u.Generic.Start.LowPart;
            *((_DWORD *)v19 + 3) = v20->u.Generic.Start.LowPart;
          }
          goto LABEL_19;
        case 5u:
        ...
        case 6u:
          *((_DWORD *)v19 + 3) = v20->u.Generic.Start.LowPart;
          *((_DWORD *)v19 + 4) = v20->u.Generic.Start.LowPart - 1 + v20->u.Generic.Start.HighPart;
          HighPart = v20->u.Generic.Start.HighPart;
          break;
        case 7u:
LABEL_24:
          v24 = RtlCmDecodeMemIoResource(v20, &Start);
          *((_DWORD *)v19 + 2) = v20->u.Generic.Length;
          v25 = Start;
          *((_QWORD *)v19 + 2) = Start;
          Affinity = v25 + v24 - 1;
          *((_DWORD *)v19 + 3) = 1;
LABEL_25:
        ...
        default:
          *((_DWORD *)v19 + 2) = v20->u.Generic.Start.LowPart;
          *((_DWORD *)v19 + 3) = v20->u.Generic.Start.HighPart;
          *((_DWORD *)v19 + 4) = v20->u.Generic.Length;
          goto LABEL_19;
      }
