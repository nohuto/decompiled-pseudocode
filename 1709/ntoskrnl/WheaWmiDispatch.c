/*
 * XREFs of WheaWmiDispatch @ 0x14015AA60
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x14015AABC (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x14028A884 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x14028AAA0 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x14028AB00 (WheapWmiGetSingleInstance.c)
 */
