/*
 * XREFs of sub_140757B90 @ 0x140757B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140757B90(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
        ...
        if ( Data )
        {
          ...
          *(_QWORD *)&v19 = 0LL;
          ...
          if ( (_DWORD)v12 )
          {
            ...
            if ( v14 <= v11 )
              updated = ExpLicUpdateChecksum((__int64)qword_1407F54A0, v12, &v17);
            if ( updated )
            {
LABEL_12:
              *(_QWORD *)&v17 = 0LL;
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_140757628(a1, a2, a3, a4, 4);
  }
  else
  {
    v15 = -1073741772;
