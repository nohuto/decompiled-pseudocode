/*
 * XREFs of ?StDmpUpdateRegionState@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KJK@Z @ 0x140270134
 * Callers:
...
signed __int32 *__fastcall ST_STORE<SM_TRAITS>::StDmpUpdateRegionState(__int64 a1, __int64 a2, int a3, int a4)
{
  __int64 v4; // rdi
  int v5; // r11d
  __int64 v6; // rbx
  ...
  if ( (unsigned __int8)*(_DWORD *)(a1 + 776) )
    ...
    result = (signed __int32 *)(v8 >> 13);
  *(_WORD *)(v4 + 2LL * (unsigned int)a2) = v5 + v8;
  v10 = (_DWORD *)(a1 + 16LL * ((_QWORD)result + 78));
  *(_DWORD *)(a1 + 8LL * (_QWORD)result + 1828) += v5;
  if ( *v10 != (_DWORD)a2 )
  ...
  if ( v5 <= 0 )
  {
    if ( (*(_WORD *)(v4 + 2 * v6) & 0x1FFF) == 0 && (_DWORD)a2 != *v10 && !a4 )
      return (signed __int32 *)ST_STORE<SM_TRAITS>::StReleaseRegion(a1, a2);
  }
