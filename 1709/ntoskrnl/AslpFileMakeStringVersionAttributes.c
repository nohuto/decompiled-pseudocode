/*
 * XREFs of AslpFileMakeStringVersionAttributes @ 0x1407751FC
 * Callers:
...
LABEL_8:
    ...
    do
    {
      v14 = *(int *)((char *)&unk_1402BBCC0 + v2);
      pszSrc = *(const wchar_t **)((char *)&unk_1402BBCC0 + v2 + 8);
      LODWORD(v24) = *(_DWORD *)((char *)&unk_1402BBCC0 + v2);
