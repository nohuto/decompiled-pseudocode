/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x1406DCE44
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x1406DCBD8 (AlpcpAllocateSnapshotMessageLog.c)
 *     AlpcpLocateMessageLog @ 0x1406DCFF4 (AlpcpLocateMessageLog.c)
 */
