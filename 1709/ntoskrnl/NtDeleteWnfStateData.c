...
__int64 __fastcall NtDeleteWnfStateData(__int64 *a1, char *a2)
{
  ...
  *(_QWORD *)v19 = 0LL;
  ...
  v27[0] = 0LL;
  v27[1] = 0LL;
  v16 = ExpCaptureWnfStateName(a1, &v23, PreviousMode);
  if ( v16 >= 0 )
  {
    v7 = v23;
    v8 = (v23 >> 4) & 3;
    ...
    v5 = (v23 >> 6) & 0xF;
    v17 = (v23 >> 6) & 0xF;
    v16 = ExpWnfCaptureScopeInstanceId(v17, a2, v6, (__int64)v26, v27);
    if ( v16 >= 0 )
    {
      if ( PreviousMode )
      {
