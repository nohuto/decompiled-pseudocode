/*
 * XREFs of MmReadProcessPageTables @ 0x1402283A0
 * Callers:
...
__int64 __fastcall MmReadProcessPageTables(__int64 a1)
{
  ...
  v3 = ValidPte;
  __wbinvd();
  result = ExTryAcquireSpinLockSharedAtDpcLevel(&dword_14038A180);
  v5 = 0;
  if ( (_DWORD)result )
  {
...
LABEL_17:
    ...
    KeFlushSingleCurrentTb(v6, 0);
    ExReleaseSpinLockSharedFromDpcLevel(&dword_14038A180);
    return 1LL;
  }
  return result;
}
