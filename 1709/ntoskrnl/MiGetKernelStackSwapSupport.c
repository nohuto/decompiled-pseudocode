/*
 * XREFs of MiGetKernelStackSwapSupport @ 0x14000B0AC
 * Callers:
...
__int64 __fastcall MiGetKernelStackSwapSupport(__int64 a1, __int64 a2)
{
  ...
  v2 = -1;
  v3 = 0;
  v5 = *(_QWORD *)(qword_140388AF0 + 8LL * *(unsigned __int16 *)(a2 + 1452));
  v6 = *(_DWORD *)(v5 + 5784);
  if ( !v6 )
    return 3221225799LL;
  v7 = (__int64 *)(v5 + 5792);
  do
  {
    ...
    {
      if ( v2 == -1
        || (v12 = MiPageFileLargestBitmapsRun(*(_QWORD *)(v5 + 8LL * v2 + 5792)),
