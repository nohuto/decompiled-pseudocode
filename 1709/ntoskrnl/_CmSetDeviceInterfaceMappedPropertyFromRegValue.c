/*
 * XREFs of _CmSetDeviceInterfaceMappedPropertyFromRegValue @ 0x1405DA954
 * Callers:
...
LABEL_11:
  ...
  if ( v19 == 2 )
  {
    ...
    if ( !v23 )
    {
      ...
      if ( a3 )
        v24 = a3;
      Key = PnpCtxRegCreateKey(a1, (__int64)v24, (__int64)L"Device Parameters", v13, 2u, 0LL, (__int64)&KeyHandle, 0LL);
      if ( Key == -1073741444 )
        goto LABEL_28;
      if ( Key < 0 )
        goto LABEL_29;
      Key = RegRtlSetValue(KeyHandle, L"FriendlyName", 1u, a6, a7);
LABEL_19:
      if ( Key != -1073741444 )
      {
        if ( Key >= 0 )
