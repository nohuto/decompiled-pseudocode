/*
 * XREFs of RtlCompressBufferXpressHuffStandard @ 0x1402588CC
 * Callers:
        ...
        unsigned int a9)
{
  ...
  unsigned __int8 *v70; // [rsp+58h] [rbp-A0h]
...
LABEL_69:
        ...
        else
        {
          if ( v45 < 0x100 )
            ...
            v47 = (unsigned int)XpressHighBitIndexTable[v45 >> 8] + 8;
          v71 += v47;
          v48 = v45 - (1LL << v47);
          v49 = 16 * v47;
          v50 = v12 - v75 - 3;
...
LABEL_72:
            ...
            XpressCallback = RtlpMakeXpressCallback(v79, v22, v12, v18);
            v20 = v68;
            v18 = XpressCallback;
            v69 = XpressCallback;
          }
