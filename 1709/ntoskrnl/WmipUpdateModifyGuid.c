/*
 * XREFs of WmipUpdateModifyGuid @ 0x1407435C4
 * Callers:
 ...
 *     WmipIsEqualInstanceSets @ 0x1407430E0 (WmipIsEqualInstanceSets.c)
      ...
      && !WmipIsEqualInstanceSets((__int64)ISInDSByGuid, (__int64)v12) )
    {
      ...
      *((_QWORD *)ISInDSByGuid + 11) = 0LL;
      ...
      if ( *(volatile signed __int64 **)(*ISInDSByGuid + 8) != ISInDSByGuid
        || (v15 = (volatile signed __int64 **)*((_QWORD *)ISInDSByGuid + 1), *v15 != ISInDSByGuid) )
      {
        __fastfail(3u);
      }
