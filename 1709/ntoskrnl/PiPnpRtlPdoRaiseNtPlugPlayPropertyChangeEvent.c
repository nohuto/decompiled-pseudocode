/*
 * XREFs of PiPnpRtlPdoRaiseNtPlugPlayPropertyChangeEvent @ 0x14055F1C4
 * Callers:
...
char __fastcall PiPnpRtlPdoRaiseNtPlugPlayPropertyChangeEvent(ULONG_PTR BugCheckParameter2, int a2)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  __int64 v5; // rcx
  ...
  if ( !BugCheckParameter2 )
    goto LABEL_18;
  v3 = *(_QWORD *)(BugCheckParameter2 + 312);
  v4 = *(_QWORD *)(v3 + 40);
  if ( !v4 || (*(_DWORD *)(v4 + 396) & 0x20000) != 0 )
  {
    ...
    if ( v7 )
    {
      ...
      IoAddTriageDumpDataBlock(v7, 728);
      if ( *v8 )
      {
...
LABEL_18:
  ...
  if ( v4 != -40 )
    LOBYTE(v3) = PnpRaiseNtPlugPlayDevicePropertyChangeEvent(v4, *(_QWORD *)(v4 + 48), a2);
  return v3;
}
