/*
 * XREFs of TtmiLogProximityPowerPress @ 0x1407124E4
 * Callers:
...
char __fastcall TtmiLogProximityPowerPress(char a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  {
    LOBYTE(v5) = TlgKeywordOn(&stru_1407F37A0, 1uLL);
    if ( (_BYTE)v5 )
    {
      ...
      v32 = 4;
      v35 = 4;
      LOBYTE(v5) = TlgWrite(&stru_1407F37A0, &unk_1402D39D9, 0LL, 0LL, 8u, &pData);
    }
  }
  return (char)v5;
}
