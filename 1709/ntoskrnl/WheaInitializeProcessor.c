/*
 * XREFs of WheaInitializeProcessor @ 0x14043B3EC
 * Callers:
...
__int64 __fastcall WheaInitializeProcessor(__int64 a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    for ( i = qword_14038D838; (__int64 *)i != &qword_14038D838; i = *(_QWORD *)i )
    {
      result = (*((__int64 (__fastcall **)(_QWORD, __int64, _QWORD))&unk_1403A2D88 + 6 * *(int *)(i + 40)))(
                 a2,
                 i + 89,
                 *(_QWORD *)(i + 56));
      if ( (int)result < 0 )
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_DWORD *)PoolWithTag = dword_14038D834;
