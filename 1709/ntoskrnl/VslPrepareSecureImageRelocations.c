/*
 * XREFs of VslPrepareSecureImageRelocations @ 0x1401F3330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VslPrepareSecureImageRelocations(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v4 )
  {
    result = VslpLockPagesForTransfer((__int64)v9, a3, a4, 0, 0);
    if ( (int)result < 0 )
      return result;
  }
  else
