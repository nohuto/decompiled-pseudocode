/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1406F8324
 * Callers:
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v20 = (_QWORD *)qword_140366D38;
      if ( *(__int64 **)qword_140366D38 != &SocSubsystemsList )
        __fastfail(3u);
      *v5 = &SocSubsystemsList;
      v5[1] = v20;
      *v20 = v5;
      qword_140366D38 = (__int64)v5;
    }
    else
    {
