/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x1407CF6D0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  __int64 v57; // [rsp+38h] [rbp-40h]
  _BYTE v58[16]; // [rsp+40h] [rbp-38h] BYREF
  ...
  if ( byte_14038D871 )
  {
    ...
    v54 = qword_140358210;
    v57 = qword_140358220;
    v10 = 10 * (dword_1403581D0 - dword_1403581D0 / (unsigned int)(dword_14035A1B4 - dword_1403581D4));
    v13 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v9 )
      {
        ...
        v32 = 0LL;
        v33 = *(_QWORD *)(v6 + 24);
        for ( i = *(_QWORD *)(qword_140358218 + 24);
    ...
    else
    {
      if ( !v9 )
      {
        ...
        v15 = 0LL;
        v16 = *(_QWORD *)(v6 + 24);
        for ( m = *(_QWORD *)(qword_140358218 + 24);
    ...
    if ( !v7 )
    {
      if ( !v4 && !v22 || (BgpGxDrawRectangle(v54, (__int64)&xmmword_1403581F0), !v22) )
        v7 = 1;
    }
    if ( !v8 )
    {
      if ( !v4 && !v30 || (BgpGxDrawRectangle(v55, (__int64)&xmmword_140358228), !v30) )
        v8 = 1;
    }
    ...
    if ( v13 || v30 || v22 )
    {
      byte_1403581E0 = v7;
      byte_1403581E1 = v8;
      dword_1403581D0 = v10 / 0xA;
      dword_1403581D4 = v4 + 1;
      byte_1403581E2 = v9;
    }
    else
    {
