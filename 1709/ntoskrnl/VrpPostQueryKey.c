/*
 * XREFs of VrpPostQueryKey @ 0x1406A6A5C
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_140354A30.LevelPlus1 > 5 )
  {
    ...
    v30[0] = *v10;
    v28 = 2LL;
    TlgWrite(&stru_140354A30, &unk_1402CF44B, &ActivityId, 0LL, 5u, &pData);
  }
            ...
            if ( v13 >= 0 )
            {
              ...
              if ( v15 >= 0 )
              {
                ...
                *(_DWORD *)(v20 + 24) = v5;
                ...
                v30[0] = 4LL;
                v30[2] = 4LL;
                TlgWrite(&stru_140354A30, &unk_1402CF6A0, &ActivityId, 0LL, 6u, &pData);
              }
              else
              {
                v5 = v15;
...
LABEL_22:
  ...
  if ( v5 != -1073740541 && stru_140354A30.LevelPlus1 > 2 )
  {
    if ( *(_QWORD *)(v2 + 24) )
    ...
    v26 = 2LL;
    v30[0] = 4LL;
    TlgWrite(&stru_140354A30, &unk_1402CF410, &ActivityId, 0LL, 5u, &pData);
  }
LABEL_28:
