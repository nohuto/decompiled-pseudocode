/*
 * XREFs of WmipGetSMBiosTableData @ 0x140570DF8
 * Callers:
 *     WmipRawSMBiosTableHandler @ 0x140118410 (WmipRawSMBiosTableHandler.c)
 ...
 *     WmipSMBiosHideMachine @ 0x14074162C (WmipSMBiosHideMachine.c)
 */
