/*
 * XREFs of RtlStringCbCopyNExW @ 0x14012677C
 * Callers:
 *     _CmGetDeviceRegPropWorker @ 0x14052263C (_CmGetDeviceRegPropWorker.c)
 * Callees:
 *     RtlStringCopyWorkerW_3 @ 0x140126820 (RtlStringCopyWorkerW_3.c)
 */
        ...
        ULONG dwFlags)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    else
    {
      ...
      if ( v7 )
      {
        v9 = RtlStringCopyWorkerW_3(pszDest, cbDest >> 1, &v13, pszSrc, v11);
        if ( v9 < 0 )
        {
LABEL_14:
          if ( cbDest && v7 )
