/*
 * XREFs of CmpStartRMLog @ 0x1405E47A8
 * Callers:
...
LABEL_35:
  ...
  *((_QWORD *)a1 + 15) = CLFS_LSN_INVALID_EXT;
  if ( v7 )
  {
    Source = &CmpLogPath;
    if ( a2 )
      *(_OWORD *)(*(_QWORD *)(qword_140353EA0 + 64) + 128LL) = *a2;
    started = RtlStringFromGUIDEx((unsigned int *)(*(_QWORD *)(qword_140353EA0 + 64) + 128LL), (__int64)&v29, 1);
    if ( started < 0 )
      goto LABEL_27;
    v10 = (__int64)(a1 + 72);
