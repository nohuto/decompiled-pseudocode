/*
 * XREFs of CmpRegisterCallbackInternal @ 0x1405ECF38
 * Callers:
 *     CmRegisterCallback @ 0x1405ECF10 (CmRegisterCallback.c)
 *     CmRegisterCallbackEx @ 0x140689220 (CmRegisterCallbackEx.c)
