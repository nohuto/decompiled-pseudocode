/*
 * XREFs of EtwpGetSystemMaximumBufferCount @ 0x1404F0098
 * Callers:
 *     EtwpUpdateTrace @ 0x140450B18 (EtwpUpdateTrace.c)
 *     EtwpAllocateTraceBufferPool @ 0x1404EFFE4 (EtwpAllocateTraceBufferPool.c)
 * Callees:
 *     MmGetMaximumNonPagedPoolInBytes @ 0x1400B4814 (MmGetMaximumNonPagedPoolInBytes.c)
 */
...
unsigned __int64 __fastcall EtwpGetSystemMaximumBufferCount(unsigned int *a1)
{
  ...
  if ( (v1[208] & 2) != 0 && (v4 = v1[3], (v4 & 0x2000000) != 0) && (v4 & 0x400) != 0 )
    v5 = 50 * v3;
  else
