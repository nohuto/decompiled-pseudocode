/*
 * XREFs of AuthzBasepCopyoutSecurityAttributes @ 0x140018CC4
 * Callers:
            ...
            if ( a3 )
            {
              ...
              while ( 1 )
              {
                SecurityAttribute = AuthzBasepFindSecurityAttribute(
                                      (__int64)v9,
                                      (const UNICODE_STRING *)(a2 + 16LL * v16));
                if ( !SecurityAttribute )
                  break;
                *((_WORD *)v17 - 4) = *((_WORD *)SecurityAttribute + 24);
                v19 = (char *)((unsigned __int64)(v14 + 1) & 0xFFFFFFFFFFFFFFFEuLL);
                v20 = *((_DWORD *)SecurityAttribute + 15);
                *((_WORD *)v17 - 3) = 0;
                *v17 = v20;
                *(v17 - 1) = *((_DWORD *)SecurityAttribute + 13);
                v21 = *((unsigned __int16 *)SecurityAttribute + 16);
                v32 = v21;
                ...
                *((_WORD *)v17 - 11) = v21;
                *((_QWORD *)v17 - 2) = v19;
                memmove(v19, (const void *)SecurityAttribute[5], (unsigned int)v21);
                v22 = &v19[v32];
