/*
 * XREFs of EtwpValidateFilterDescriptors @ 0x14075128C
 * Callers:
  ...
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      if ( v14 == -2147483392 && (unsigned int)v12 > 0x1000 )
        break;
      if ( (v14 == -2147482624 || v14 == -2147475456) && (unsigned int)v12 > 0x1000 )
        break;
      if ( v10 + v12 < v10 || v10 + v12 > (unsigned int)a1[1] )
        break;
      v7 += v12;
      if ( v14 == -2147483644 )
      {
      ...
      else
      {
        ...
        v15 = (char *)a1 + v10;
        v17 = v14;
        result = EtwpAllocateFilter(v14, &v15, a2, (__int64)(a1 + 10));
        if ( (int)result < 0 )
          return result;
      }
