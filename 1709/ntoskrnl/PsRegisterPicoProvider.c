/*
 * XREFs of PsRegisterPicoProvider @ 0x140719EA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140362930 = *(_OWORD *)(a1 + 16);
  xmmword_140362940 = *(_OWORD *)(a1 + 32);
  xmmword_140362950 = *(_OWORD *)(a1 + 48);
  xmmword_140362960 = *(_OWORD *)(a1 + 64);
  qword_140362970 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140362950, 8).m128i_u64[0];
