/*
 * XREFs of KeRemoveSystemServiceTable @ 0x1406D7980
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall KeRemoveSystemServiceTable(int a1)
{
  ...
  if ( (unsigned int)(a1 - 1) <= 1
    && ((_QWORD)xmmword_1404198A0 || (_QWORD)xmmword_140401720 || (_QWORD)xmmword_140401760) )
  {
    if ( a1 == 1 )
    {
      *(_QWORD *)&xmmword_140401720 = 0LL;
      LODWORD(xmmword_140401730) = 0;
      *((_QWORD *)&xmmword_140401730 + 1) = 0LL;
    }
    else
    {
