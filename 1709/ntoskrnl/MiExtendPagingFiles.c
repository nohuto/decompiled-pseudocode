/*
 * XREFs of MiExtendPagingFiles @ 0x1406E46D4
 * Callers:
...
unsigned __int64 __fastcall MiExtendPagingFiles(__int64 a1)
{
  ...
  {
    _mm_lfence();
    v6 = *(_QWORD *)(v1 + 8 * result + 5792);
    if ( *(_QWORD *)(v6 + 8) - *(_QWORD *)v6 < v3 )
      return result;
    result = MiAttemptPageFileExtension(*(_QWORD *)(v1 + 8 * result + 5792), v3);
    v7 = result;
  ...
  v11 = 0LL;
  v12 = (unsigned __int64 **)(v1 + 5792);
  v13 = *(unsigned int *)(v1 + 5784);
  do
  {
    v14 = *v12;
