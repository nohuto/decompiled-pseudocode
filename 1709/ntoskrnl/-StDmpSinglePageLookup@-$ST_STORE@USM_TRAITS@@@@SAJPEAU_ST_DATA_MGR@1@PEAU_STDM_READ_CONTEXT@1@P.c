/*
 * XREFs of ?StDmpSinglePageLookup@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAPEAU_ST_PAGE_RECORD@1@@Z @ 0x14026FDC8
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpSinglePageLookup(__int64 *a1, __int64 a2, _DWORD *a3, _QWORD *a4)
{
  __int64 v5; // rbx
  ...
  v5 = *(_QWORD *)(a2 + 24);
  if ( (unsigned __int8)*a3 && *(_DWORD *)(a2 + 40) == *(_DWORD *)(a1[100] + 6036) )
  {
