...
__int64 __fastcall DbgkpSendErrorMessage(__int64 a1, char a2, _DWORD *a3)
{
  ...
  _OWORD v34[10]; // [rsp+70h] [rbp-90h] BYREF
  ...
  MmGetSectionInformation(*(_QWORD *)(Process + 952), 1, (__int64)v34);
  ServerSiloServiceSessionId = PsGetServerSiloServiceSessionId(ProcessServerSilo);
  if ( (unsigned int)MmGetSessionIdEx(Process) != ServerSiloServiceSessionId && LODWORD(v34[2]) != 1 && (a2 & 2) != 0 )
    ...
    else
    {
      ...
      if ( started >= 0 )
      {
        ...
        *(_OWORD *)(a3 + 62) = v20;
        ...
        AlpcInitializeMessageAttribute(0x10000000LL, v34, 0xA0uLL, &v31);
        DWORD1(v34[0]) = 0x10000000;
        MessageAttribute = AlpcGetMessageAttribute(v34, 0x10000000);
        *(_DWORD *)MessageAttribute = 0;
        *((_DWORD *)MessageAttribute + 4) = 4;
        *((_DWORD *)MessageAttribute + 5) = v22 ? 1055744 : 0x1FFFFF;
        *((_QWORD *)MessageAttribute + 1) = -2LL;
        ...
        if ( (*(_DWORD *)(&CurrentThread[1].SwapListEntry + 1) & 1) != 0 )
          started = -1073741749;
        if ( started < 0
          || (v24 = ZwAlpcSendWaitReceivePort(*(_QWORD *)(v13 + 8), 2228224LL, (__int64)a3), started = v24, v24 < 0) )
        {
        ...
        {
          if ( (a3[1] & 0x2000) != 0 )
            ZwAlpcSendWaitReceivePort(*(_QWORD *)(v13 + 8), 0x10000LL, (__int64)a3);
          started = a3[11];
          if ( started >= 0 && !v28 )
          {
            if ( started == 65538 )
