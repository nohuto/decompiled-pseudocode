/*
 * XREFs of IovpCallDriver1 @ 0x1407AF150
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x1407B3BE8 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x1407BF0AC (IovpSessionDataReference.c)
