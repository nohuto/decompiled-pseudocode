/*
 * XREFs of sub_14082686C @ 0x14082686C
 * Callers:
...
__int64 __fastcall sub_14082686C(__int64 a1)
{
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(a1 + 232))(
         512LL,
         (unsigned int)(v4 + 48),
         *(unsigned int *)(a1 + 1648));
  v9 = v8;
  if ( v8 )
  {
    v11 = v7;
  ...
  *(_QWORD *)v10 = v10 + 24;
  ...
  {
    *(_DWORD *)(a1 + 2008) |= 0x2000000u;
    *(_QWORD *)(v10 + 8) = 1LL;
  }
  _InterlockedOr(v39, 0);
  __rdtsc();
  v33 = (unsigned __int8)(*(_BYTE *)(a1 + 1912) - 1);
  v34 = __rdtsc();
  v35 = __ROR8__(v34, 3);
  v36 = v33
