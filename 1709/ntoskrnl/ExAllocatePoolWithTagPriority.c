/*
 * XREFs of ExAllocatePoolWithTagPriority @ 0x140081330
 * Callers:
...
LABEL_28:
  ...
  if ( (v11 & 1) != 0 )
  {
    _InterlockedIncrement64((volatile signed __int64 *)(v20 + v17 + 40));
    _InterlockedExchangeAdd64((volatile signed __int64 *)(v20 + v17 + 32), v13);
  }
  else
  {
    _InterlockedIncrement64((volatile signed __int64 *)(v20 + v17 + 16));
    _InterlockedExchangeAdd64((volatile signed __int64 *)(v20 + v17 + 8), v13);
  }
LABEL_39:
