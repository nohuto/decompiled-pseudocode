/*
 * XREFs of ViKeWaitForSingleObjectCommon @ 0x1407BA754
 * Callers:
 *     VerifierKeWaitForSingleObject @ 0x1407B9C70 (VerifierKeWaitForSingleObject.c)
 *     VerifierKeWaitForSingleObjectNoReboot @ 0x1407B9CD0 (VerifierKeWaitForSingleObjectNoReboot.c)
 * Callees:
