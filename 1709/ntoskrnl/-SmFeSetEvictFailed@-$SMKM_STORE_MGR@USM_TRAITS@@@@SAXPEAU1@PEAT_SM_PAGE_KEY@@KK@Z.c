/*
 * XREFs of ?SmFeSetEvictFailed@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x140266EC0
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmFeSetEvictFailed(__int64 a1, unsigned int *a2, int a3)
{
  ...
  __int64 v22; // rdx
  __int64 v23; // rcx
  unsigned int v25[2]; // [rsp+30h] [rbp-D0h] BYREF
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( (v19->AcquiredByte & 1) != 0
      ...
      && (*(_QWORD *)&v19->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_14041AB78 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_21:
    if ( (*((_DWORD *)&v13->0 + 1) & 0x10000) == 0 )
      KeBugCheckEx(0x162u, (ULONG_PTR)v13, (ULONG_PTR)&qword_14041AB78, SessionId, 0LL);
    goto LABEL_28;
  }
  v19->CrossThreadReleasableAndBusyByte |= 2u;
  if ( (__int64)v19->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v13->LockEntries[v18]);
  v25[0] = 0;
...
LABEL_28:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v13, (__int64)&qword_14041AB78, v25);
