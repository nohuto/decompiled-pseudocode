/*
 * XREFs of HvlpTryConfigureInterface @ 0x140134808
 * Callers:
...
__int64 __fastcall HvlpTryConfigureInterface(__int64 a1)
{
  ...
  v2 = *(__int64 (__fastcall **)())(*(_QWORD *)(a1 + 240) + 2600LL);
  if ( v2 )
    goto LABEL_11;
  if ( !(unsigned __int8)HviIsHypervisorMicrosoftCompatible() )
    return 3224702976LL;
  HviGetHypervisorFeatures(&v6);
  __writemsr(0x40000000u, ((unsigned __int64)BYTE1(CmNtCSDVersion) << 16) | 0x1040A00003FABLL);
  v4 = __readmsr(0x40000001u) | 1;
  if ( (v6 & 0x100000000000LL) != 0 || (*(_DWORD *)(*(_QWORD *)(a1 + 240) + 116LL) & 0x200) != 0 )
  {
    v5 = v4 & 0xFFFFFFFFFFFFF000uLL;
    v2 = (__int64 (__fastcall *)())((__int64 (__fastcall *)(unsigned __int64, __int64, __int64))qword_140353460)(
  ...
  v2 = (__int64 (__fastcall *)())((__int64 (__fastcall *)(__int64, __int64, unsigned __int64 *))qword_140353458)(
                                   a1,
                                   1LL,
                                   &v5);
  if ( !v2 )
