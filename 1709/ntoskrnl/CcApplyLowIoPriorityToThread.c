/*
 * XREFs of CcApplyLowIoPriorityToThread @ 0x140022680
 * Callers:
...
void __fastcall CcApplyLowIoPriorityToThread(__int64 a1, char a2, _DWORD *a3)
{
  ...
  if ( a2 )
  {
    ...
    *(_QWORD *)(a1 + 872) = a3;
    *(_DWORD *)(a1 + 884) = PsSetIoPriorityThread((__int64)CurrentThread, 0);
...
LABEL_25:
  ...
  else
  {
    ...
    v6 = a1 + 888;
    ExAcquirePushLockExclusiveEx(a1 + 888, 0LL);
    PsSetIoPriorityThread((__int64)CurrentThread, *(_DWORD *)(a1 + 884));
