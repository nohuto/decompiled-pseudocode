/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x14024CE58
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1401558B0 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x14024D484 (PopFxAcpiValidateParameters.c)
  ...
  if ( (unsigned __int8)PopFxAcpiValidateParameters() )
  {
    switch ( *(_DWORD *)a1 )
    {
      ...
      default:
        ...
        if ( *(_DWORD *)a1 != 4 )
        {
          v6 = PopFxAcpiForwardNotification((_DWORD)v5, *(_DWORD *)a1, *(_QWORD *)(a1 + 16), v3, (__int64)&v8);
          v1 = v8;
          v4 = v6;
          goto LABEL_15;
        }
