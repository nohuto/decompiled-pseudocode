/*
 * XREFs of KeAllocateCalloutStackEx @ 0x1405D60F0
 * Callers:
 *     KeAllocateCalloutStack @ 0x1405D60B0 (KeAllocateCalloutStack.c)
 * Callees:
...
__int64 __fastcall KeAllocateCalloutStackEx(int a1, unsigned __int8 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( a2 )
  {
    ...
    while ( v7 )
      MmDeleteKernelStack(*(_QWORD *)&PoolWithTag[2 * --v7 + 16], v5, v10);
