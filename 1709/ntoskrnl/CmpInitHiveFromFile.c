/*
 * XREFs of CmpInitHiveFromFile @ 0x1404DE1EC
 * Callers:
        ...
        void *a10)
{
  ...
  _DWORD v62[2]; // [rsp+188h] [rbp+88h] BYREF
  ...
  if ( stru_1403549F0.LevelPlus1 > 4 )
  {
    ...
    v62[0] = Source->Length;
    v62[1] = 0;
    TlgWrite(&stru_1403549F0, &unk_1402CE6A4, 0LL, 0LL, 4u, &pData);
    v13 = v43;
    a4 = v51;
    v10 = v47;
  }
...
LABEL_11:
  ...
  if ( stru_1403549F0.LevelPlus1 > 4 )
  {
    ...
    v65 = 4;
    TlgWrite(&stru_1403549F0, &unk_1402CE67A, 0LL, 0LL, 3u, &v63);
  }
