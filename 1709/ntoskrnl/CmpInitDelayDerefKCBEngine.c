/*
 * XREFs of CmpInitDelayDerefKCBEngine @ 0x1405BF808
 * Callers:
...
__int64 CmpInitDelayDerefKCBEngine()
{
  ...
  qword_140387058 = (__int64)&CmpDelayDerefKCBListHead;
  ...
  if ( !qword_140387D50 )
  {
    ...
    v10 = 4 * xmmword_140419890;
    v11 = KeServiceDescriptorTable + (unsigned int)(4 * xmmword_140419890);
    qword_140387D68 = v6;
