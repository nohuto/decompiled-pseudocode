/*
 * XREFs of SepLogTokenSidManagement @ 0x140730934
 * Callers:
 ...
 *     RtlConvertLuidToUlonglong @ 0x14025F860 (RtlConvertLuidToUlonglong.c)
 *     SepGetSidValuesDump @ 0x14025FDB4 (SepGetSidValuesDump.c)
 *     ExFreePoolWithTag @ 0x1402B2440 (ExFreePoolWithTag.c)
 *     SepGetSidManagementActionName @ 0x1407308BC (SepGetSidManagementActionName.c)
 */
...
void __fastcall SepLogTokenSidManagement(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( EtwKernelProvRegHandle && SepTokenSidManagementLoggingEnabled )
  {
    if ( a4 )
    {
      v37 = RtlConvertLuidToUlonglong(a4 + 16);
      v38 = RtlConvertLuidToUlonglong(v7 + 24);
      v29 = v8[48];
      v30 = v8[49];
      v31 = v8[50];
    }
