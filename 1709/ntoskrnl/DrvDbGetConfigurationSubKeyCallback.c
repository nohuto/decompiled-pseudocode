/*
 * XREFs of DrvDbGetConfigurationSubKeyCallback @ 0x1402923F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DrvDbGetConfigurationSubKeyCallback(int a1, int a2, _WORD *a3, __int64 a4)
{
  ...
  if ( !a4 )
    return 3;
  v9 = PnpCtxRegOpenKey(a1, a2, (_DWORD)a3, 0, 1, (__int64)&v20);
  if ( v9 >= 0 )
  {
    v17 = 4;
    if ( *(_BYTE *)(a4 + 16) )
    ...
    {
      v9 = PnpCtxRegQueryValue(v8, v20, L"ConfigFlags", &v18, &v21, &v17);
      if ( v9 < 0 || v18 != 4 || v17 != 4 )
      {
        if ( v9 == -1073741772 )
          v9 = 0;
