/*
 * XREFs of VrpAddNamespaceNodeToList @ 0x1406A5394
 * Callers:
...
LABEL_23:
      ...
      {
        v15 = a1[9];
        if ( v15 + NumberOfBytes >= v15 )
        {
          *(_QWORD *)(v15 + NumberOfBytes) = a2;
LABEL_52:
          ++a1[6];
          return 0LL;
        }
