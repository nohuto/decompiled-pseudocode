/*
 * XREFs of PopDiagTraceFirmwareS3Stats @ 0x14043923C
 * Callers:
...
void PopDiagTraceFirmwareS3Stats()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, ULONG *))off_140354F48[0])(35LL, 0LL, 0LL, &NumberOfBytes) == -1073741820 )
  {
    if ( NumberOfBytes )
    {
      ...
      if ( PoolWithTag )
      {
        if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, ULONG *))off_140354F48[0])(
               35LL,
               NumberOfBytes,
               PoolWithTag,
               &NumberOfBytes) >= 0 )
                ...
                i = (unsigned int *)((char *)i + *((char *)i + 2)) )
          {
            ...
            else
            {
              ...
              *(_QWORD *)&UserData.Size = 4LL;
              ...
              if ( !qword_140365C28 )
                qword_140365C28 = NumberOfBytes_4;
            }
          }
        }
