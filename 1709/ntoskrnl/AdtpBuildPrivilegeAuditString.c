/*
 * XREFs of AdtpBuildPrivilegeAuditString @ 0x140777224
 * Callers:
 ...
 *     AdtpLookupKnownPrivilegeNameQuickly @ 0x14028FDD0 (AdtpLookupKnownPrivilegeNameQuickly.c)
  ...
  *(_DWORD *)(&v21.MaximumLength + 1) = 0;
  ...
  if ( *a1 )
  {
    ...
    if ( *a1 )
    {
      do
      {
        if ( (unsigned int)AdtpLookupKnownPrivilegeNameQuickly(&a1[2 * v6 + 2 + v6], &v23) )
        {
          Length = v24.Length;
          Buffer = v24.Buffer;
        }
