/*
 * XREFs of SeSecureBootRegisterPolicy @ 0x140854970
 * Callers:
 ...
 *     SepSecureBootBuildRules @ 0x14086C710 (SepSecureBootBuildRules.c)
...
__int64 __fastcall SeSecureBootRegisterPolicy(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  qword_14038D708 = *(_QWORD *)(BugCheckParameter2 + 16);
...
LABEL_23:
  ...
  if ( v6[18] || v6[19] )
  {
    qword_1403A8078 = (__int64)v10 + v10[13] + 60;
...
LABEL_27:
      if ( qword_1403A3388 )
      {
        ExFreePoolWithTag(qword_1403A3388, 0);
        qword_1403A3388 = 0LL;
      }
