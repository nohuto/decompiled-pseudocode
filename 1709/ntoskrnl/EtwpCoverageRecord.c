/*
 * XREFs of EtwpCoverageRecord @ 0x140579384
 * Callers:
...
LABEL_8:
  ...
  if ( !v5 && v4 && stru_140354BD0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140354BD0, 2uLL) )
  {
    v15 = *a1;
    v16 = *(const CHAR **)a2;
    v23 = **a1;
    ...
    TlgWrite(&stru_140354BD0, &unk_1402D4176, 0LL, 0LL, 7u, &pData);
  }
  if ( EtwpCoverageCoreTracingEnabled && stru_140354BD0.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_140354BD0, 1uLL) )
    {
      v18 = *a1;
      v19 = *(const CHAR **)a2;
      v27 = **a1;
      ...
      v51 = 4;
      TlgCreateSz(&v53, v19);
      TlgWrite(&stru_140354BD0, &unk_1402D41D7, 0LL, 0LL, 9u, &v34);
    }
  }
}
