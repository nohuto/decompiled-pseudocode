/*
 * XREFs of EtwpProcessThreadImageRundown @ 0x14074E288
 * Callers:
 ...
 *     EtwpIsStackWalkingEnabled @ 0x140749860 (EtwpIsStackWalkingEnabled.c)
...
__int64 __fastcall EtwpProcessThreadImageRundown(__int64 a1, __int64 a2, char a3, unsigned int **a4, unsigned int a5)
{
  ...
  {
LABEL_17:
    EtwpProcessEnumCallback((PEPROCESS)PsIdleProcess, (__int64)v23);
    PsEnumProcesses((__int64 (__fastcall *)(__int64, __int64))EtwpProcessEnumCallback, (__int64)v23);
LABEL_18:
    if ( BYTE2(v23[13]) && stru_140354B90.LevelPlus1 > 5 && TlgKeywordOn(&stru_140354B90, 0x200000000000uLL) )
    {
      ...
      v47 = 8;
      v50 = 8;
      TlgWrite(&stru_140354B90, &unk_1402D4E51, 0LL, 0LL, 0xBu, &pData);
    }
    goto LABEL_22;
  }
  v12 = 0;
  ...
  if ( v8 >= 0 )
  {
    EtwpProcessEnumCallback(Process, (__int64)v23);
    goto LABEL_18;
  }
LABEL_22:
  if ( v23[2] )
