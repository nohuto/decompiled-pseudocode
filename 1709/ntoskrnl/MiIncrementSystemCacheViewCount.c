/*
 * XREFs of MiIncrementSystemCacheViewCount @ 0x140219DF8
 * Callers:
...
__int64 __fastcall MiIncrementSystemCacheViewCount(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v4; // rcx
