/*
 * XREFs of PfSnPrefetchCacheEntryUpdate @ 0x140452FF8
 * Callers:
...
_QWORD *__fastcall PfSnPrefetchCacheEntryUpdate(_DWORD *a1)
{
  ...
  v8 = qword_140389D90 - 16;
  if ( !memcmp((const void *)(qword_140389D90 - 16 + 32), v1, 0x40uLL)
    || (v8 = PfSnPrefetchCacheEntryGet(&unk_140389D78, v1, v4, 0LL)) != 0 )
  {
    *(_DWORD *)(v8 + 112) = a1[17];
    *(_DWORD *)(v8 + 116) = a1[18];
  }
