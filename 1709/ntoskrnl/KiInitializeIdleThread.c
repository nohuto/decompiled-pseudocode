/*
 * XREFs of KiInitializeIdleThread @ 0x1404263CC
 * Callers:
...
unsigned __int64 __fastcall KiInitializeIdleThread(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a1 + 195) = 127;
  if ( !*(_DWORD *)(a4 + 36) )
  {
    qword_14041BE50 = (__int64)&qword_14041BE48;
    qword_14041BE48 = (__int64)&qword_14041BE48;
  }
  ...
  *(_QWORD *)(a1 + 1848) = 0LL;
  v8 = (_QWORD *)(a1 + 1704);
  v9 = (_QWORD *)qword_14041BE50;
  if ( *(__int64 **)qword_14041BE50 != &qword_14041BE48 )
    __fastfail(3u);
  *v8 = &qword_14041BE48;
  v8[1] = v9;
  *v9 = v8;
  qword_14041BE50 = (__int64)v8;
