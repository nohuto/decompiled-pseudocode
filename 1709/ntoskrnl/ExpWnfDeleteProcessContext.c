...
void __fastcall ExpWnfDeleteProcessContext(unsigned __int64 *P, int a2)
{
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)v2, 0LL) )
    ExfAcquirePushLockExclusiveEx(v2, v5, (__int16 *)v2);
  if ( v6 )
    *(_BYTE *)(v6 + 26) |= 1u;
  ...
  while ( 1 )
  {
    ...
    v11 = v10;
    if ( _interlockedbittestandset64((volatile signed __int32 *)v2, 0LL) )
      ExfAcquirePushLockExclusiveEx(v2, v10, (__int16 *)v2);
    if ( v11 )
      *(_BYTE *)(v11 + 26) |= 1u;
  }
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)v2, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)P + 14, 0LL) )
    ExfAcquirePushLockExclusiveEx(P + 7, v13, (__int16 *)P + 28);
  if ( v14 )
    *(_BYTE *)(v14 + 26) |= 1u;
  ...
  while ( 1 )
  {
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)v12, 0LL) )
      ExfAcquirePushLockExclusiveEx(P + 7, v25, (__int16 *)P + 28);
    if ( v26 )
      *(_BYTE *)(v26 + 26) |= 1u;
  }
  if ( (_InterlockedExchangeAdd64(v12, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
  ...
  if ( a2 )
  {
    ...
    v19 = v17;
    if ( v18 )
      ExfAcquirePushLockExclusiveEx(&ExpWnfProcessesListLock, v17, (__int16 *)&ExpWnfProcessesListLock);
    if ( v19 )
      *(_BYTE *)(v19 + 26) |= 1u;
