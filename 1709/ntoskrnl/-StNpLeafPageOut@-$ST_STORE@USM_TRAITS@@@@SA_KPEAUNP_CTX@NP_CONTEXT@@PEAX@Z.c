/*
 * XREFs of ?StNpLeafPageOut@?$ST_STORE@USM_TRAITS@@@@SA_KPEAUNP_CTX@NP_CONTEXT@@PEAX@Z @ 0x140270BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StNpLeafPageOut(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(v4 + 56) |= 1u;
  ...
  v7 = ST_STORE<SM_TRAITS>::StDmpSinglePageAdd(v4, (__int64)v10, 0LL, &v12);
  v8 = 0LL;
  if ( v7 >= 0 )
    return 4 * v5;
  return v8;
