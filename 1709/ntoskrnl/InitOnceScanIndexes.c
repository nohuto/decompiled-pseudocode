/*
 * XREFs of InitOnceScanIndexes @ 0x140529B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitOnceScanIndexes(PRTL_RUN_ONCE a1, _DWORD *a2, PVOID *a3)
{
  ...
  if ( a2 )
  {
    if ( a3 )
    {
      ...
      FirstChild = SdbGetFirstChild((__int64)a2, 0LL);
      v8 = FirstChild;
      if ( FirstChild )
      {
        ...
        a2[339] = 0;
        for ( i = SdbFindFirstTag((__int64)a2, v8, 30723); ; i = SdbFindNextTag(a2, v8, v10) )
        {
          v10 = i;
          if ( !i )
          {
          ...
          if ( a2[339] == 32 )
            break;
          FirstTag = SdbFindFirstTag((__int64)a2, i, 14338);
          if ( !FirstTag )
          {
          ...
          v12 = SdbFindFirstTag((__int64)a2, v10, 14339);
          if ( !v12 )
          {
          ...
          v13 = SdbFindFirstTag((__int64)a2, v10, 16406);
          if ( v13 )
            a2[10 * a2[339] + 20] = SdbReadDWORDTag((__int64)a2, v13, 0);
          else
            a2[10 * a2[339] + 20] = 0;
          v14 = SdbFindFirstTag((__int64)a2, v10, 38913);
