/*
 * XREFs of MiLockMemoryLists @ 0x14022AEB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiLockMemoryLists(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    *v2 = 0LL;
    v2[1] = a1 + 4000;
    KxAcquireQueuedSpinLock((__int64)v2, (volatile __int64 *)(a1 + 4000));
    LODWORD(v8) = 1;
    v9 = (__int64 *)(a1 + 2048);
    v10 = 2LL;
    v11 = 8LL;
    ...
    {
      v12 = 0;
      for ( i = *v9; v12 < dword_140388544; ++v12 )
      {
    ...
    v18[1] = a1 + 6368;
    *v18 = 0LL;
    KxAcquireQueuedSpinLock((__int64)v18, (volatile __int64 *)(a1 + 6368));
    v19 = (unsigned int)(v8 + 1);
    v20 = (volatile __int64 *)(a1 + 3360);
    v21 = 16LL;
    do
    {
      v22 = &v2[3 * v19];
    ...
    if ( KeNumberNodes )
    {
      v24 = (volatile __int64 *)(*(_QWORD *)(a1 + 16) + 8200LL);
      do
      {
        v25 = &v2[3 * v19];
        v25[1] = v24;
    ...
    v26[1] = a1 + 6432;
    *v26 = 0LL;
    return KxAcquireQueuedSpinLock((__int64)v26, (volatile __int64 *)(a1 + 6432));
  }
  else
  {
    v5 = dword_140388544;
    v6 = (unsigned __int16)KeNumberNodes;
    result = (unsigned int)(unsigned __int16)KeNumberNodes + 2 * dword_140388544 + 27;
    if ( (_DWORD)result )
    {
      do
      {
