/*
 * XREFs of SepCaptureTokenSecurityAttributesInformation @ 0x14046C82C
 * Callers:
        ...
        const void ***a4)
{
  ...
  *((_DWORD *)PoolWithTag + 1) = v9;
  ...
  v10 = 40 * v9;
  v36 = 40 * v9;
  if ( (unsigned __int64)(40 * v9) > 0xFFFFFFFF )
  {
    v10 = -1;
    LODWORD(v36) = -1;
    v6 = -1073741675;
  ...
  v7 = (unsigned int *)ExAllocatePoolWithTag(PagedPool, v10, 0x74416553u);
  v37 = v7;
  if ( !v7 )
  {
    ExFreePoolWithTag(PoolWithTag, 0);
