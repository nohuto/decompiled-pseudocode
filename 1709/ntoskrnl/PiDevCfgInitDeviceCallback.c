/*
 * XREFs of PiDevCfgInitDeviceCallback @ 0x1406C6210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiDevCfgInitDeviceCallback(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (int)PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, v6, v5, 983103, 0, (__int64)&Handle, 0LL, 0) >= 0 )
  {
    ...
    if ( (v8 & 0x20) == 0 )
    {
      if ( (int)PiDevCfgInitDeviceContext(*(_QWORD *)(a1 + 16), (__int64)Handle, v14) < 0 )
        goto LABEL_13;
      if ( (int)PiDevCfgCheckDeviceNeedsUpdate((__int64)v14, &v12) >= 0 && v12 )
      {
        v15 |= v12;
        PiDevCfgSetDeviceRegProp(v9, (__int64)v14, 0xBu, 4, (__int64)&v15, 4);
      }
    }
    *a3 = 0;
  }
