/*
 * XREFs of KiOpDecode @ 0x1400DB06C
 * Callers:
 *     KiPreprocessFault @ 0x1400DA6B4 (KiPreprocessFault.c)
 * Callees:
 *     KiOpFetchNextByte @ 0x1400DB1A8 (KiOpFetchNextByte.c)
 *     KiOpIsPrefix @ 0x1400DB1CC (KiOpIsPrefix.c)
 *     KiOpLocateDecodeEntry @ 0x1400DB270 (KiOpLocateDecodeEntry.c)
 *     KiOpDecodeModRM @ 0x14015C9B0 (KiOpDecodeModRM.c)
 *     memset @ 0x140192F40 (memset.c)
 *     KiOpFetchBytes @ 0x14020D3AC (KiOpFetchBytes.c)
 */
