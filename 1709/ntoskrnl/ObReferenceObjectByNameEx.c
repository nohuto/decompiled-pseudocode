/*
 * XREFs of ObReferenceObjectByNameEx @ 0x140467F24
 * Callers:
    ...
    if ( (int)v39 >= 0 )
    {
      ...
      if ( (int)v39 >= 0 )
      {
        ...
        if ( (int)v39 >= 0 )
        {
          ...
          v20 = (void *)v38;
          v21 = ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ *(unsigned __int8 *)(v38 - 24) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)(v38 - 48) >> 8)];
