/*
 * XREFs of AdtpBuildObjectTypeStrings @ 0x1407785A8
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  v21 = 0;
  v7 = a4;
  RtlInitUnicodeString(DestinationString, &word_1402CBB00);
  v8 = a6;
  *a6 = 0;
  if ( !(_DWORD)v7 )
    return 0LL;
  ...
  do
  {
    ...
    if ( *(_WORD *)v12 >= 4u )
      v16 = 3;
    appended = AdtpAppendZString((__int64)DestinationString, (__int64)v8, (&off_1402BBDA0)[v16], &v21);
    if ( appended < 0 )
      return (unsigned int)appended;
    v20[0] = 0;
