/*
 * XREFs of ViDeadlockAnalyze @ 0x1407BBF00
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1407BBB70 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x1407BBF00 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x1407BC200 (ViDeadlockCertify.c)
...
__int64 __fastcall ViDeadlockAnalyze(ULONG_PTR a1, ULONG_PTR a2, int a3, unsigned int a4, __int64 a5)
{
  ...
  if ( a3 )
  {
    ...
    *((_QWORD *)v8 + 4107) = 0LL;
    if ( v9 )
      ViDeadlockState |= 8u;
    KeQueryCurrentStackInformation((_DWORD *)v8 + 8283, (unsigned __int64 *)v8 + 4142, (unsigned __int64 *)v8 + 4143);
    a4 = v23;
  }
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = v6;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, v6, a2, 0LL, byte_140359ADC);
      return 0LL;
    }
    v7 = 0;
    goto LABEL_32;
