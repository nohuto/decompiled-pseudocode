/*
 * XREFs of VfGetScatterGatherList @ 0x1407ABC80
 * Callers:
 *     <none>
 * Callees:
...
__int64 VfGetScatterGatherList(__int64 a1, __int64 a2, ...)
{
  ...
  __int64 (__fastcall *v35)(__int64, __int64, ULONG_PTR, __int64, unsigned int, __int64 (__fastcall *)(), __int64, _BYTE); // [rsp+58h] [rbp-10h]
  ULONG_PTR v38; // [rsp+C0h] [rbp+58h] BYREF
  va_list va; // [rsp+C0h] [rbp+58h]
  __int64 v40; // [rsp+C8h] [rbp+60h] BYREF
  va_list va1; // [rsp+C8h] [rbp+60h]
  __int64 v42; // [rsp+D0h] [rbp+68h]
  __int64 (__fastcall *v43)(); // [rsp+D8h] [rbp+70h]
  __int64 v44; // [rsp+E0h] [rbp+78h]
  ...
  LOBYTE(v8) = 1;
  v35 = (__int64 (__fastcall *)(__int64, __int64, ULONG_PTR, __int64, unsigned int, __int64 (__fastcall *)(), __int64, _BYTE))RealDmaOperation;
  ...
  if ( *(_DWORD *)(v11 + 192) == 3 )
  {
    ...
    if ( v13 )
    {
      ...
      ViHalPreprocessOptions(
        ...
        0LL,
        0LL);
      VfReportIssueWithOptions(0xE6u, 0x24uLL, v14, 0LL, 0LL, byte_140359A54);
    }
  }
...
LABEL_16:
    ...
    *v27 = v26;
    v27[1] = *(_OWORD *)(v4 + 16);
    v27[2] = *(_OWORD *)(v4 + 32);
    ViSwap(&v34, (ULONG_PTR *)va, (__int64 *)va1);
    v4 = v38;
  }
  v3 = v40;
LABEL_20:
  v28 = v35(a1, a2, v4, v3, v10, v43, v44, v45);
  v29 = v28;
  if ( v11 && v28 < 0 )
  {
    DECREMENT_SCATTER_GATHER_LISTS(v11);
    ...
    if ( v2 )
    {
      ...
      v31 = *(_QWORD *)(v2 + 72);
      if ( *(_QWORD *)(v31 + 8) != v2 + 72 || (v32 = *(_QWORD **)(v2 + 80), *v32 != v2 + 72) )
        __fastfail(3u);
      *v32 = v31;
      *(_QWORD *)(v31 + 8) = v32;
