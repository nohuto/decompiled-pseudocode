/*
 * XREFs of PopPepDeviceDState @ 0x140123504
 * Callers:
 ...
 *     PopFxUpdateComponentPerfStateNominalChange @ 0x14023F790 (PopFxUpdateComponentPerfStateNominalChange.c)
...
__int64 __fastcall PopPepDeviceDState(__int64 a1, unsigned int a2, __int64 a3, char a4)
{
  ...
  if ( *(_BYTE *)(a1 + 124) )
  {
    ...
    if ( !v6 && v11 != a2 )
    {
      if ( a2 == 1 && *(_DWORD *)(a1 + 180) )
      {
        v13 = 0;
        do
        {
          v14 = 200LL * v13;
          v15 = *(unsigned int *)(v14 + a1 + 360);
          PopPepUpdateIdleStateRefCount(0LL, *(unsigned int *)(*(_QWORD *)(v14 + a1 + 376) + 24 * v15 + 16), 1LL);
    ...
    if ( v6 && *(_DWORD *)(a1 + 168) != a2 )
    {
      if ( PopFxPerfQueryOnDevicePowerChanges && (*(_BYTE *)(a1 + 177) || *(_BYTE *)(a1 + 176) && a2 == 1) )
      {
        for ( i = 0; i < *(_DWORD *)(a1 + 180); ++i )
        {
          ...
          {
            LOBYTE(v17) = 1;
            PopFxUpdateComponentPerfStateNominalChange(*(_QWORD *)(a1 + 32), *(unsigned int *)(v19 + a1 + 192), v17, a2);
          }
        }
      }
      if ( *(_DWORD *)(a1 + 168) == 1 && *(_DWORD *)(a1 + 180) )
      {
        do
        {
          ...
          PopPepUpdateIdleStateRefCount(
            *(unsigned int *)(*(_QWORD *)(v20 + a1 + 376) + 24LL * *(unsigned int *)(v20 + a1 + 360) + 16),
            0LL,
            0LL);
          PopFxUpdateComponentAccountingEnhanced(
            *(_QWORD *)(a1 + 32),
            *(unsigned int *)(v20 + a1 + 192),
            (unsigned int)(*(_DWORD *)(v20 + a1 + 372) - 1),
            1LL);
          ++v4;
        }
