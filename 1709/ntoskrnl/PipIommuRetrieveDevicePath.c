/*
 * XREFs of PipIommuRetrieveDevicePath @ 0x14058FA04
 * Callers:
...
__int64 __fastcall PipIommuRetrieveDevicePath(ULONG_PTR BugCheckParameter2, _QWORD *a2)
{
  ...
  v2 = *(unsigned int (__fastcall **)(_QWORD, _QWORD, _QWORD, SIZE_T *))(BugCheckParameter2 + 72);
  v3 = 0LL;
  if ( !v2 )
  {
    v7 = -1073741637;
...
LABEL_7:
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD, SIZE_T, void *, _QWORD))(BugCheckParameter2 + 72))(
  ...
  if ( v7 >= 0 )
  {
    PipIommuValidateDevicePath(BugCheckParameter2, (ULONG_PTR)v3);
    goto LABEL_7;
  }
LABEL_12:
  if ( v3 )
