/*
 * XREFs of PfpRpControlRequestUpdate @ 0x14043EA18
 * Callers:
...
__int64 __fastcall PfpRpControlRequestUpdate(__int64 a1, _DWORD *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !v13
      || !*(_DWORD *)(a1 + 112)
      || (result = PfpRpCHashDeleteEntries(a1, a1 + 96, (signed __int64 *)(a1 + 120), v13, (__int64)&v2[2 * a2[1]]),
          (int)result >= 0) )
    {
      ...
      if ( v14 && *(_DWORD *)(a1 + 72) )
      {
        result = PfpRpCHashDeleteEntries(a1, a1 + 56, (signed __int64 *)(a1 + 88), v14, v9);
        if ( (int)result < 0 )
          return result;
        *(_QWORD *)(a1 + 80) = 0LL;
      }
