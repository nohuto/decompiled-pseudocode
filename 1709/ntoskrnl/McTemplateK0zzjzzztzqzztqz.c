/*
 * XREFs of McTemplateK0zzjzzztzqzztqz @ 0x1401335B0
 * Callers:
...
__int64 __fastcall McTemplateK0zzjzzztzqzztqz(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        const wchar_t *a17)
{
  ...
  v81 = v43;
  v83 = 0;
  return McGenEventWriteKM(&MS_KernelPnP_Provider_Context, a2, 0LL, 15LL, v46);
}
