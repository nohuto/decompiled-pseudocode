/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x1402B1210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(__int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 1632) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 608))(CompleteDev + 1632, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 1576);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 240);
  v5 = *(unsigned int *)(CompleteDev + 1604);
  v6 = *(_QWORD *)(CompleteDev + 1584);
  ...
  v9 = (unsigned __int64 *)&loc_1402B1296;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
