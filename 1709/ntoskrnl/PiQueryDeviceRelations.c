/*
 * XREFs of PiQueryDeviceRelations @ 0x1406D3858
 * Callers:
...
__int64 __fastcall PiQueryDeviceRelations(__int64 a1, int a2, int *a3, _WORD *a4)
{
  ...
  PpDevNodeLockTree(0);
  v15 = PnpDeviceObjectFromDeviceInstanceWithTag(a1, 0x43706E50u);
  v16 = v15;
  if ( v15 && (v17 = *(_QWORD *)(v15[39] + 40LL), (unsigned int)(*(_DWORD *)(v17 + 300) - 787) > 1) )
  {
    ...
    if ( v21 && *v21 )
    {
      ...
      do
      {
        ...
        ObfDereferenceObjectWithTag(*(PVOID *)&v21[2 * v25 + 2], 0x43706E50u);
        v21 = P[0];
        ++v25;
      }
