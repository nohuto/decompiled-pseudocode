/*
 * XREFs of CmpAddToLeaf @ 0x1404740BC
 * Callers:
 ...
 *     CmpGenerateFastLeafHintForUnicodeString @ 0x1404744E0 (CmpGenerateFastLeafHintForUnicodeString.c)
...
LABEL_16:
    ...
    v15 = CmpCompareInIndex(BugCheckParameter2, a4, (_DWORD)v23, (_DWORD)v7, (__int64)&v22);
    if ( v15 != 2 )
    {
      if ( v15 > 0 )
