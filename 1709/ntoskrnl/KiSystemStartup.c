/*
 * XREFs of KiSystemStartup @ 0x140423010
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall __noreturn KiSystemStartup(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  v2 = (unsigned int *)DriverObject->MajorFunction[3];
  _RDX = v2 - 96;
  *((_QWORD *)_RDX + 3) = _RDX;
  *((_QWORD *)_RDX + 4) = v2;
  v4 = __readcr0();
  ...
  *MK_FP(43, _RDX + 3) = *MK_FP(43, v8 + 72);
  ...
  __writecr8(0xFuLL);
  v11 = alloca((unsigned int)KeXStateLength);
  ...
  if ( !*MK_FP(43, &KeGetPcr()->Prcb.Number) )
  {
    v17 = __rdtsc();
    v15 = __ROR8__(v17, 49);
    v18 = __ROL8__(ExpSecurityCookieRandomData ^ v15 ^ v17, 16);
    LOWORD(v18) = 0;
  ...
  *MK_FP(43, &CurrentThread->WaitBlockFill11[70]) = 2;
  ...
  while ( !v20 );
  KiIdleLoop((__int64)CurrentThread, v15, v16);
}
