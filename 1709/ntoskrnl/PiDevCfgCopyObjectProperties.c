/*
 * XREFs of PiDevCfgCopyObjectProperties @ 0x1405A47EC
 * Callers:
        ...
        void *a7)
{
  ...
  {
    if ( a7
      || (GenericStorePropertyKeys = PnpOpenObjectRegKey(v7, (__int64)a5, a6, 33554433, 0, (__int64)&v25, 0LL, 0),
          GenericStorePropertyKeys >= 0) )
    {
                  ...
                  do
                  {
                    ...
                    else
                    {
                      ...
                      GenericStorePropertyKeys = PiDevCfgSetObjectProperty(
                                                   ...
                                                   (unsigned int *)v14,
                                                   NumberOfBytes);
                      if ( GenericStorePropertyKeys == -1073741790 )
                        GenericStorePropertyKeys = 0;
                      if ( GenericStorePropertyKeys < 0 )
                        break;
                    }
