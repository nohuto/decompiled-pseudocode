/*
 * XREFs of NtQuerySecurityPolicy @ 0x140727C3C
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 Address)
{
  ...
  *(_QWORD *)&Length[1] = 0LL;
  ...
  if ( v11 >= 0 )
  {
    v11 = SepCaptureUnicodeStringArray(a2, 1u, PreviousMode, &v19);
    if ( v11 >= 0 )
    {
      v11 = SepCaptureUnicodeStringArray(a3, 1u, PreviousMode, v20);
      if ( v11 >= 0 )
      {
        if ( PreviousMode == 1 )
        {
        ...
        if ( qword_1403626B8 )
        {
          if ( !PoolWithQuotaTag || Length[0] )
            v11 = qword_1403626B8(P, v19, v20[0], &v17, PoolWithQuotaTag, Length);
          else
            v11 = -1073741811;
        }
        else
