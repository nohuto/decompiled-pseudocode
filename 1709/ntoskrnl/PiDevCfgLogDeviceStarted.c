/*
 * XREFs of PiDevCfgLogDeviceStarted @ 0x1405A3B98
 * Callers:
...
void __fastcall PiDevCfgLogDeviceStarted(__int64 a1)
{
  ...
  *(_DWORD *)&v29.Length = 0;
  ...
  if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x180000) == 0x180000 )
  {
    ...
    LODWORD(v33[16]) = 8210;
    LODWORD(v33[21]) = 8210;
    if ( (int)PiDevCfgQueryObjectProperties(8210LL, v2, 1u, 0LL, (__int64)v33, 5u) >= 0 )
    {
      if ( SLODWORD(v33[4]) < 0 )
      {
        v32[0] = 0LL;
      ...
      if ( v6 || !PipIsDevNodeDNStarted(a1) )
      {
        if ( (v5 & 0x2000) != 0 && *(_DWORD *)(a1 + 404) == 14 )
        {
          if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x200000) == 0 )
            goto LABEL_31;
          v9 = (wchar_t *)&dword_140792EA4;
          v27 = v8;
          v20 = &dword_140792EA4;
          LOBYTE(v26) = 14;
          v12 = (const wchar_t *)&dword_140792EA4;
          v11 = L"null";
          ...
          v13 = &KMPnPEvt_DeviceStart_RebootRequired;
          if ( Buffer )
            v12 = Buffer;
          if ( v31.Buffer )
            v9 = v31.Buffer;
        ...
        {
          v21 = (wchar_t *)&dword_140792EA4;
          v22 = (const wchar_t *)&dword_140792EA4;
          v23 = L"null";
          if ( UnicodeString.Buffer )
            v23 = UnicodeString.Buffer;
          v24 = (const wchar_t *)&dword_140792EA4;
          if ( v4 )
            v22 = v4;
          if ( Buffer )
            v24 = Buffer;
      ...
      else if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x80000) != 0 )
      {
        ...
        v13 = &KMPnPEvt_DeviceStart_Success;
LABEL_30:
        McTemplateK0zzjzzzqq(
          (__int64)v12,
          (__int64)v13,
