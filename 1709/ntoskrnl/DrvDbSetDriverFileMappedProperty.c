/*
 * XREFs of DrvDbSetDriverFileMappedProperty @ 0x1407875D4
 * Callers:
        ...
        ULONG a7)
{
  ...
  v13 = DrvDbSetRegValueMappedProperty(v15, a3, (__int64)v16, a5, a6, a7);
LABEL_17:
  if ( Handle[0] )
    ZwClose(Handle[0]);
