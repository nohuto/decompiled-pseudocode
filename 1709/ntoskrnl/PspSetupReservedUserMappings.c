/*
 * XREFs of PspSetupReservedUserMappings @ 0x14058D2BC
 * Callers:
...
__int64 __fastcall PspSetupReservedUserMappings(_KPROCESS *a1, $709EDFC2F9E0D4565D6AA3C4377BC643 *a2, _QWORD *a3)
{
  int v5; // ebx
