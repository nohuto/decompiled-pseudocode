/*
 * XREFs of PnpBuildUnsafeRemovalDeviceList @ 0x1405EF9D4
 * Callers:
 ...
 *     PnpIsBeingRemovedSafely @ 0x1405EFA68 (PnpIsBeingRemovedSafely.c)
 */

void __fastcall PnpBuildUnsafeRemovalDeviceList(__int64 a1, unsigned int **a2, _QWORD *a3)
{
  int v5; // ebx
  __int64 v6; // r9
  ...
  *a3 = 0LL;
  if ( a2 )
  {
    v5 = 0;
    v13 = 0LL;
    while ( IopEnumerateRelations(a2, (int *)&v13, &v14, &v12, 0LL) )
    {
