/*
 * XREFs of ?ReadPartitionTable@SC_RAW@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x1402945E4
 * Callers:
...
__int64 __fastcall SC_RAW::ReadPartitionTable(SC_RAW *this, struct SC_DISK_LAYOUT **a2)
{
  ...
  v3 = 0;
  v5 = *(const __m128i **)(*(_QWORD *)this + 192LL);
  *a2 = 0LL;
  ...
  {
    memset(v6, 0, 0xC0uLL);
    if ( *(_DWORD *)(*(_QWORD *)this + 152LL) == 11 || v5[31].m128i_i16[7] == -21931 )
    {
      *v7 = 0;
      v7[1] = 1;
      v7[2] = 1;
      ...
      v7[12] = 0;
      *((_QWORD *)v7 + 7) = 0LL;
      v8 = *(_QWORD *)(*(_QWORD *)this + 176LL) << *(_DWORD *)(*(_QWORD *)this + 172LL);
      v7[18] = -1;
      *((_QWORD *)v7 + 8) = v8;
      *((_WORD *)v7 + 40) = 4;
      *((_BYTE *)v7 + 82) = v9;
