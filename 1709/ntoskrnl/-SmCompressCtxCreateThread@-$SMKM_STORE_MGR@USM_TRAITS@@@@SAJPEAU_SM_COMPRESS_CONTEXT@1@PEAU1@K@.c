/*
 * XREFs of ?SmCompressCtxCreateThread@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_COMPRESS_CONTEXT@1@PEAU1@K@Z @ 0x140265110
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxCreateThread(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  NTSTATUS v7; // edi
  void (__fastcall *StartRoutine)(struct _EX_RUNDOWN_REF **, __int64, _SINGLE_LIST_ENTRY *, __int64); // rax
    ...
    *(_QWORD *)(ThreadParams + 8) = a2;
    if ( a3 )
    {
      ...
      *(_QWORD *)(ThreadParams + 16) = &Object;
      StartRoutine = (void (__fastcall *)(struct _EX_RUNDOWN_REF **, __int64, _SINGLE_LIST_ENTRY *, __int64))SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxWorkerThread;
    }
    else
    {
      StartRoutine = SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxBalancerThread;
    }
