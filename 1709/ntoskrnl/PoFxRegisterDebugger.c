/*
 * XREFs of PoFxRegisterDebugger @ 0x140857ED8
 * Callers:
...
void PoFxRegisterDebugger()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, SIZE_T *))off_140354F48[0])(
         33LL,
         0LL,
         0LL,
         &NumberOfBytes) == -2147483643 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, SIZE_T *))off_140354F48[0])(
             33LL,
             v0,
             v2,
             &NumberOfBytes) >= 0
