/*
 * XREFs of SdbpFindFirstIndexedWildCardTag @ 0x140547B48
 * Callers:
...
__int64 __fastcall SdbpFindFirstIndexedWildCardTag(void *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int *a5)
{
  ...
  *((_QWORD *)a5 + 4) = a4;
  ...
  while ( 1 )
  {
    ...
    {
      v17 = v15[2];
      FirstTag = SdbFindFirstTag((__int64)a1, v17, *((_WORD *)a5 + 6));
      if ( FirstTag )
      {
        StringTagPtr = (WCHAR *)SdbGetStringTagPtr((__int64)a1, FirstTag);
        if ( StringTagPtr )
        {
          if ( (unsigned int)AslStringPatternMatchW(StringTagPtr, *((WCHAR **)a5 + 4)) )
            break;
        }
      }
    }
