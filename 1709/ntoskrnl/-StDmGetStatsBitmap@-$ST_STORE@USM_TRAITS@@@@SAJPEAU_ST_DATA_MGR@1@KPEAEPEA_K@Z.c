/*
 * XREFs of ?StDmGetStatsBitmap@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KPEAEPEA_K@Z @ 0x14026D124
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmGetStatsBitmap(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4)
{
  ...
  char v27; // cl
  _DWORD *v29; // [rsp+20h] [rbp-38h] BYREF
    ...
    **(_DWORD **)(a1 + 760) = 0;
    ...
    if ( v9 != -1073741818 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( LeafSibling )
        {
          v10 = (unsigned __int64)(LeafSibling + 4);
          v29 = LeafSibling;
          v30 = LeafSibling + 4;
          v11 = (__int64)LeafSibling;
LABEL_17:
          LeafSibling = (_DWORD *)v10;
        }
LABEL_18:
        if ( !LeafSibling )
          goto LABEL_28;
        ...
        v14 = 4096;
        v15 = (unsigned int)(*LeafSibling >> *(_DWORD *)(a1 + 456));
        _BitScanReverse((unsigned int *)&v16, v15);
        v17 = *(_QWORD *)(*(_QWORD *)(a1 + 8 * v16 + 192) + 16 * (v15 ^ (unsigned int)(1 << v16)));
        v18 = 4096LL;
        v19 = (unsigned int)(*(_DWORD *)(a1 + 464) * (*LeafSibling & *(_DWORD *)(a1 + 460))) + v17;
