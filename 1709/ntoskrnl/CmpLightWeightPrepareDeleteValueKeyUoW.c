/*
 * XREFs of CmpLightWeightPrepareDeleteValueKeyUoW @ 0x14044C6E4
 * Callers:
  ...
  if ( TransientPoolWithTag )
  {
    ...
    *TransientPoolWithTag = -1;
    ...
    if ( v8 )
    {
      ...
      v10 = PoolWithTag;
      if ( PoolWithTag
        && (CmpInitializeValueNameString(v8, v14, PoolWithTag),
                               ...
                               (__int64)&BugCheckParameter3)) )
      {
        ...
        if ( (unsigned __int8)CmpMarkValueDataDirty(v4) && (unsigned __int8)HvpMarkCellDirty(v4, v11) )
        {
