/*
 * XREFs of ViCreateProcessCallbackInternal @ 0x1407B7DA4
 * Callers:
 *     ViCreateProcessCallback @ 0x14012B490 (ViCreateProcessCallback.c)
 * Callees:
 ...
 *     ViFaultsGetBaseImageName @ 0x1407B81EC (ViFaultsGetBaseImageName.c)
