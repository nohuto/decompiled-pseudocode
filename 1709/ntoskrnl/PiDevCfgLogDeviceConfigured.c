  ...
  if ( a3 )
  {
    ...
    else
    {
      ...
      *StringRoutine = 0;
      v36 = (_QWORD *)(v6 + 208);
      v37 = *(_QWORD *)(v6 + 208);
      TimeFields = (struct _TIME_FIELDS)v35;
      v124 = (size_t *)v37;
      if ( v37 != v6 + 208 )
      {
        Size = (size_t)L" ";
...
LABEL_32:
  if ( v6 )
  {
    ...
    if ( v85 )
    {
      memset(v85, 0, Size);
      v86 = *(size_t **)(v6 + 192);
      TimeFields = (struct _TIME_FIELDS)v134;
      v124 = v86;
      ...
      while ( 1 )
      {
        ...
        if ( (int)PiDevCfgQueryObjectProperties(v94, v93, 7u, v92, (__int64)v140, 3u) >= 0 )
        {
          ...
          if ( SLODWORD(v140[9]) < 0 || (int)RtlStringFromGUIDEx(v139, (__int64)&v135, 1) < 0 )
            RtlInitUnicodeString(&v135, 0LL);
