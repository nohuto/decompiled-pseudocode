/*
 * XREFs of PpDevNodeRemoveFromTree @ 0x1401590B4
 * Callers:
...
char __fastcall PpDevNodeRemoveFromTree(__int64 a1)
{
  ...
  if ( v4 )
  {
    ...
    *i = *(_QWORD *)a1;
    ...
    __writecr8(v3);
    v8 = *(_QWORD *)(a1 + 624);
    if ( *(_QWORD *)(v8 + 8) != a1 + 624 || (v9 = *(_QWORD **)(a1 + 632), *v9 != a1 + 624) )
      __fastfail(3u);
    *v9 = v8;
    *(_QWORD *)(v8 + 8) = v9;
  ...
  while ( v10 != (_QWORD *)(a1 + 160) )
  {
    ...
    *(_QWORD *)(v14 + 8) = v15;
    v16 = v13[3];
    if ( *(_QWORD **)(v16 + 8) != v13 + 3 || (v17 = (_QWORD *)v13[4], (_QWORD *)*v17 != v13 + 3) )
      __fastfail(3u);
    *v17 = v16;
    *(_QWORD *)(v16 + 8) = v17;
  ...
  while ( v11 != (_QWORD *)(a1 + 176) )
  {
    ...
    *(_QWORD *)(v19 + 8) = v20;
    v21 = v18[3];
    if ( *(_QWORD **)(v21 + 8) != v18 + 3 || (v22 = (_QWORD *)v18[4], (_QWORD *)*v22 != v18 + 3) )
      __fastfail(3u);
    *v22 = v21;
    *(_QWORD *)(v21 + 8) = v22;
