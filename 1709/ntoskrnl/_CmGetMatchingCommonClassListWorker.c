/*
 * XREFs of _CmGetMatchingCommonClassListWorker @ 0x1405E7994
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  *((_QWORD *)v10 + 3) = a5;
  v10[8] = a6;
  CachedContextBaseKey = PnpCtxRegEnumKeyWithCallback(a1, v14, (__int64)CmClassSubkeyCallback, (__int64)v10);
  if ( CachedContextBaseKey >= 0 )
  {
    v15 = v10[9];
    *a7 = v15;
