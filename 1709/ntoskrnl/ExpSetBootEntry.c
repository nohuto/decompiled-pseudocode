/*
 * XREFs of ExpSetBootEntry @ 0x140759AFC
 * Callers:
 *     NtAddBootEntry @ 0x14075B8E8 (NtAddBootEntry.c)
 *     NtModifyBootEntry @ 0x14075C9CC (NtModifyBootEntry.c)
 * Callees:
...
__int64 __fastcall ExpSetBootEntry(int a1, _DWORD *a2, unsigned __int64 a3)
{
  ...
  struct _FILE_PATH *v41; // [rsp+40h] [rbp-B8h]
  _DWORD *v42; // [rsp+50h] [rbp-A8h]
  struct _FILE_PATH *v43; // [rsp+58h] [rbp-A0h]
...
LABEL_85:
    ...
    v16 = (struct _FILE_PATH *)((char *)v14 + v48);
    v43 = v16;
    ...
    if ( EnvironmentVariable >= 0 )
    {
      ...
      {
        Length = v16->Length;
        v41 = (struct _FILE_PATH *)((char *)v14 + v48);
      }
      else
      {
