/*
 * XREFs of PopTraceThermalRequestPassiveHistogram @ 0x140247EB8
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x140244E48 (PopDiagSnapPassiveHistogram.c)
      ...
      if ( (int)PoStoreDiagnosticContext(*(_QWORD *)(a1 + 24), PoolWithTag, NumberOfBytes) >= 0 )
      {
        ...
        if ( pCallbackContext.LevelPlus1 > 5 )
        {
          if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
          {
            ...
            v17 = 84;
            v20 = 21;
            TlgWrite(&pCallbackContext, &unk_1402D2290, 0LL, 0LL, 7u, &pData);
          }
        }
      }
    }
