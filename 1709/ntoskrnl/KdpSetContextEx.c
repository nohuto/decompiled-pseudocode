/*
 * XREFs of KdpSetContextEx @ 0x140201AD0
 * Callers:
 ...
 *     KdpSanitizeContextFlags @ 0x14079980C (KdpSanitizeContextFlags.c)
 */
...
__int64 __fastcall KdpSetContextEx(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 < 0x500u && KiProcessorBlock[v4] && KdpContextSent )
  {
    ...
    if ( (unsigned int)v6 <= 0x1000
      ...
      && v7 + v8 <= v6 )
    {
      KdpQuickMoveMemory((char *)&unk_1403A4E08 + (unsigned int)v7, *(_QWORD *)(a2 + 8), (unsigned int)v8);
      if ( v10 == v9 )
      {
        v11 = *(_WORD *)(a1 + 6);
        if ( v11 != (unsigned __int16)KeGetPcr()->Prcb.Number )
          a3 = *(_QWORD *)(KiProcessorBlock[v11] + 25280);
        KdpSanitizeContextFlags(&unk_1403A4E08, (unsigned int)v9, &v15);
        KdpCopyContext(a3, v15, &unk_1403A4E08);
      }
      *(_DWORD *)(a1 + 8) = 0;
      *(_DWORD *)(a1 + 24) = v8;
    }
