/*
 * XREFs of sub_14080CF60 @ 0x14080CF60
 * Callers:
...
__int64 __fastcall sub_14080CF60(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // rsi
  int v6; // r13d
  ...
  v3 = *(_BYTE **)a1;
  v193 = (char **)(*(__int64 (__fastcall **)(ULONG_PTR))(*(_QWORD *)a1 + 488LL))(a2);
  v5 = (__int64)v193;
  if ( !v193 )
    return 3221225595LL;
  v6 = (*((__int64 (__fastcall **)(ULONG_PTR))v3 + 83))(a2);
  LODWORD(v190) = v6;
  ...
  if ( *((_WORD *)v193 + 3) && *((_DWORD *)v193 + 14) >= 0x1000u && (a2 & 0xFFF) == 0 )
  {
    ...
    __writecr8(0xFuLL);
    (*((void (__fastcall **)(__int64))v3 + 40))(v8);
    v10 = 24;
    v11 = (unsigned int *)**((_QWORD **)v3 + 185);
    ...
    v200 = v13;
LABEL_10:
    (*((void (__fastcall **)(_QWORD))v3 + 48))(*((_QWORD *)v3 + 159));
    ...
    v18 = *((unsigned int *)v3 + 401);
    v19 = *((_DWORD *)v3 + 479);
    v189 = ((a2 & 0xFFF) + 4095 + v17) >> 12;
    v20 = 20 * v189;
    v21 = 20 * v189 + v18 + 48;
    v22 = (v6 != 0) + 33;
    if ( v21 <= *((_DWORD *)v3 + 535) )
    {
      v23 = v3;
      v196 = (__int64)v3;
      *((_DWORD *)v3 + 401) = v21;
    ...
    else
    {
      ...
      if ( (v24 & 4) == 0 )
      {
        v25 = *((_DWORD *)v3 + 401);
        v26 = *((_QWORD *)v3 + 197);
        v27 = (v24 & 0x20000000) != 0 ? *((_DWORD *)v3 + 479) : 0;
        if ( v25 >= 8 )
        {
        ...
        *((_DWORD *)v23 + 479) = v27;
        if ( v27 == 3 )
        {
          (*((void (__fastcall **)(__int64))v23 + 107))(v26);
        }
        else
        {
          v30 = 0;
          if ( (*((_DWORD *)v23 + 502) & 0x10000000) == 0 )
            v30 = v27;
          if ( v30 )
            (*((void (__fastcall **)(__int64, _QWORD))v23 + 67))(v26 - 8, *(_QWORD *)(v26 - 8));
          else
            (*((void (__fastcall **)(__int64))v23 + 30))(v26);
        }
        *((_DWORD *)v23 + 479) = v29;
      }
      *((_DWORD *)v23 + 502) &= ~4u;
    ...
    *(_QWORD *)a1 = v23;
    ...
    LOBYTE(v38) = 1;
    v42 = (*((__int64 (__fastcall **)(ULONG_PTR, _QWORD *, __int64, unsigned int *))v23 + 60))(
            BugCheckParameter2,
            v38,
            12LL,
            &v214);
...
LABEL_82:
    ...
    {
      v49 = (char *)*((_QWORD *)v23 + 241);
      v50 = (__int64 *)*((_QWORD *)v23 + 242);
      v51 = (char *)v46 - v49;
      v52 = (char *)*((_QWORD *)v23 + 243);
      v53 = 7;
      v54 = (char *)*((_QWORD *)v23 + 244);
      while ( 1 )
      {
...
LABEL_74:
    ...
    if ( (int)v46[9] < 0 )
      v45 = 1;
    if ( v45 && *v46 == 1414090313 && v46[1] == 1195525195 && (*((_DWORD *)v23 + 503) & 0x2000) != 0 )
      v45 = 0;
    v71 = v46[2];
    v72 = v45 == 0;
    v181 = v46[3];
...
LABEL_138:
        ...
        if ( v80 >= v73 )
        {
          ...
          {
            if ( (*((_DWORD *)v23 + 502) & 0x200000) == 0 )
            {
              v194 = -201326588;
              KeBugCheckEx(__ROR4__(-201326588, 90), 0xAuLL, BugCheckParameter2, 5uLL, 0LL);
            }
            if ( !*((_DWORD *)v23 + 468) )
            {
              *((_QWORD *)v23 + 236) = 0LL;
              *((_QWORD *)v23 + 235) = v23 - 0x5C5FC0A76E374B18LL;
              *((_QWORD *)v23 + 237) = 271LL;
              *((_QWORD *)v23 + 238) = BugCheckParameter2;
              *((_DWORD *)v23 + 468) = 1;
            }
            return 3221225595LL;
          }
          ...
          if ( (v82 & 0x2000000) != 0
            ...
            || v85 == 1162297680 && ((v86 = *(_WORD *)v81, *(_WORD *)v81 == 30583) || v86 == 29303 || v86 == 30839)
          ...
          {
            v87 = (char *)*((_QWORD *)v23 + 241);
            v88 = 7;
            v202 = (__int64 *)*((_QWORD *)v23 + 242);
            v89 = v84 - v87;
            v203 = (char *)*((_QWORD *)v23 + 243);
            v204 = (char *)*((_QWORD *)v23 + 244);
            v201 = v87;
            while ( 1 )
            {
...
LABEL_127:
          if ( (int)v81[8] < 0 )
            v83 = 1;
          if ( v83 && *(v81 - 1) == 1414090313 && *v81 == 1195525195 && (*((_DWORD *)v23 + 503) & 0x2000) != 0 )
            v83 = 0;
          v108 = v81[1];
          v72 = v83 == 0;
          if ( v81[3] > v108 )
...
LABEL_151:
          ...
          if ( (_DWORD)v117 )
          {
            ...
            do
            {
              ...
              do
              {
                ...
                *((_DWORD *)v23 + 418) += 4096;
                v127 = v125;
                for ( j = *((_DWORD *)v23 + 413); v127 < v125 + 4096; v127 += 64 )
                  _mm_prefetch(v127, 0);
                v129 = *((_QWORD *)v23 + 207);
                v182 = 32;
                v130 = v129;
              ...
              v136 = v189;
              v137 = (__int64)v193;
              sub_14017579C((__int64)v23, (__int64)v193, v121);
              v138 = v209;
              ...
              v120 = v187 - v121;
              v189 = v136 + 20 * v121;
              *(_DWORD *)(v196 + 1672) += (_DWORD)v121 << 15;
              v187 = v120;
            }
            while ( v120 );
            LODWORD(v117) = v185;
    ...
    v153 = *((unsigned int *)v23 + 401);
    v154 = *((_DWORD *)v23 + 479);
    v207 = 0LL;
    v155 = v152 + 13;
    v156 = v153 + 48;
    if ( (unsigned int)(v153 + 48) <= *((_DWORD *)v23 + 535) )
    {
      v157 = (__int64)v23;
      *((_DWORD *)v23 + 401) = v156;
LABEL_212:
      ...
      *(_DWORD *)(v165 + 16) = v151;
      v170 = (const char *)v42;
      *(_DWORD *)(v157 + 1672) += v151;
      v171 = *(_DWORD *)(v157 + 1652);
      if ( v42 < v42 + v151 )
      {
        do
        {
        ...
        while ( (unsigned __int64)v170 < v42 + v151 );
      }
      v172 = *(_QWORD *)(v157 + 1656);
      for ( m = (unsigned int)v151 >> 7; m; --m )
      {
        v174 = 8LL;
        do
        {
          v175 = v169[1] ^ __ROL8__(*v169 ^ v172, v171);
          v169 += 2;
          v172 = __ROL8__(v175, v171);
          --v174;
        }
        while ( v174 );
        v176 = (__ROL8__(*(_QWORD *)(v157 + 1656) ^ ((unsigned __int64)v169 - v42), 17) ^ *(_QWORD *)(v157 + 1656) ^ ((unsigned __int64)v169 - v42))
             * (unsigned __int128)0x7010008004002001uLL;
        v171 = ((unsigned __int8)v176 ^ (unsigned __int8)(BYTE8(v176) ^ v171)) & 0x3F;
        if ( !v171 )
          LOBYTE(v171) = 1;
      }
      v177 = v151 & 0x7F;
      ...
      *(_DWORD *)(v157 + 1672) += v151;
      if ( (*(_DWORD *)(v157 + 2008) & 0x40000000) != 0 )
      {
        if ( (_DWORD)v151 )
          sub_14017573C(v157, v42, v151, v165 + 28);
      }
      *(_DWORD *)(v165 + 24) = 1;
      *(_QWORD *)a1 = v157;
      return 0LL;
    }
    v157 = sub_1402AEFBC(v23, v156, v154);
    if ( v157 )
    {
      v158 = *((_DWORD *)v23 + 502);
      if ( (v158 & 4) == 0 )
      {
        v159 = *((_DWORD *)v23 + 401);
        v160 = *((_QWORD *)v23 + 197);
        v161 = (v158 & 0x20000000) != 0 ? *((_DWORD *)v23 + 479) : 0;
        if ( v159 >= 8 )
        {
        ...
        for ( ; v159; --v159 )
          *v23++ = 0;
        v163 = *(_DWORD *)(v157 + 1916);
        *(_DWORD *)(v157 + 1916) = v161;
        if ( v161 == 3 )
        {
          (*(void (__fastcall **)(__int64))(v157 + 856))(v160);
        }
        else
        {
          v164 = 0;
          if ( (*(_DWORD *)(v157 + 2008) & 0x10000000) == 0 )
            v164 = v161;
          if ( v164 )
            (*(void (__fastcall **)(__int64, _QWORD))(v157 + 536))(v160 - 8, *(_QWORD *)(v160 - 8));
          else
            (*(void (__fastcall **)(__int64))(v157 + 240))(v160);
        }
        *(_DWORD *)(v157 + 1916) = v163;
      }
      *(_DWORD *)(v157 + 2008) &= ~4u;
      goto LABEL_212;
    }
  ...
  if ( (*((_DWORD *)v3 + 502) & 0x200000) == 0 )
  {
    v195 = -201326588;
    KeBugCheckEx(__ROR4__(-201326588, 90), 0xAuLL, a2, 4uLL, 0LL);
  }
  if ( !*((_DWORD *)v3 + 468) )
  {
    *((_QWORD *)v3 + 236) = 0LL;
    *((_QWORD *)v3 + 237) = 271LL;
    *((_QWORD *)v3 + 235) = v3 - 0x5C5FC0A76E374B18LL;
    *((_QWORD *)v3 + 238) = a2;
    *((_DWORD *)v3 + 468) = 1;
  }
  return 3221225595LL;
