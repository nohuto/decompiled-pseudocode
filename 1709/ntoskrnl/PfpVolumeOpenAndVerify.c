/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x14043FDE4
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x14043FA98 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x140002028 (PfVolumeSupportedForPrefetch.c)
...
__int64 __fastcall PfpVolumeOpenAndVerify(__int64 a1, _OWORD *a2, __int64 a3)
{
  ...
  v19[3] = (HANDLE)((unsigned __int64)v19[3] | 0x200000000LL);
  memset(v20, 0, sizeof(v20));
  Src = *(void **)(a3 + 32);
  v6 = *((_QWORD *)&v20[1] + 1) | 0x200000000LL;
  v17[0] = 2 * *(_WORD *)(a3 + 24);
  v17[1] = v17[0] + 2;
  ObjectAttributes.ObjectName = (PUNICODE_STRING)v17;
  *((_QWORD *)&v20[1] + 1) |= 0x200000000uLL;
  P = 0LL;
  FileHandle = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x1310uLL, 0LL, 0LL, 0LL);
...
LABEL_6:
        ...
        if ( (DevicePowerState & 0xC0000000) == 0xC0000000 )
          goto LABEL_15;
        if ( DevicePowerState == 259 )
          KeBugCheckEx(0x191u, 0x1359uLL, 0LL, 0LL, 0LL);
