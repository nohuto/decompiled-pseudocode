/*
 * XREFs of IopTrackLink @ 0x14055854C
 * Callers:
 ...
 *     IoGetTransactionParameterBlock @ 0x1401022E0 (IoGetTransactionParameterBlock.c)
        ...
        KPROCESSOR_MODE AccessMode)
{
  ...
  if ( AccessMode )
  {
    ...
    memmove(PoolWithQuota_1, Src, a4);
    v7 = a1;
    v9 = AccessMode;
    v6 = a4;
  }
  ...
  v12 = *(void **)PoolWithQuota_1;
  if ( !*(_QWORD *)PoolWithQuota_1 && v9 == 1 )
  {
LABEL_88:
          ...
          if ( *(_QWORD *)PoolWithQuota_1 )
          {
            ...
            if ( *(_QWORD *)PoolWithQuota_1 )
            {
              if ( (v8->DeviceObject->Characteristics & 0x10) != 0 )
              {
                ...
                if ( v16 < 0 )
                  goto LABEL_80;
                IopMarshalIds(&v53, v42, v52, PoolWithQuota_1);
...
LABEL_68:
          ...
          if ( IoGetTransactionParameterBlock(a1) || *(_QWORD *)PoolWithQuota_1 && IoGetTransactionParameterBlock(v8) )
            goto LABEL_79;
          ...
          if ( *(_QWORD *)PoolWithQuota_1 )
          {
            if ( (v8->DeviceObject->Characteristics & 0x10) == 0 )
            {
              ...
              if ( v15 != -1073741772 )
              {
                ...
                {
                  if ( !IoGetTransactionParameterBlock(a1)
                    && (!*(_QWORD *)PoolWithQuota_1 || !IoGetTransactionParameterBlock(v8)) )
                  {
...
LABEL_80:
          ...
          v37 = v41;
          v35.m128i_i8[0] = _mm_cvtsi128_si32(v39) & 0xFE;
          v23 = IopSendMessageToTrackService(v45, &v34, PoolWithQuota_1);
        }
        v16 = v23;
        goto LABEL_80;
      }
