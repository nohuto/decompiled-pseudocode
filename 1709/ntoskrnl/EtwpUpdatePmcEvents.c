/*
 * XREFs of EtwpUpdatePmcEvents @ 0x140749DB4
 * Callers:
...
__int64 __fastcall EtwpUpdatePmcEvents(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a3 && a3 <= 4 )
  {
    if ( *(_QWORD *)(a1 + 2152) || (PmcData = EtwpAllocatePmcData(a1)) == 0 )
    {
      if ( *(_DWORD *)(*(_QWORD *)(a1 + 2152) + 32LL) )
        PmcData = -1073741053;
      for ( i = 0LL; ; i = (unsigned int)(i + 1) )
      {
        ...
        if ( (unsigned int)i >= a3 )
          break;
        *(_WORD *)(*(_QWORD *)(a1 + 2152) + 2 * i + 36) = *(_WORD *)(a2 + 4 * i);
      }
      _InterlockedOr(v9, 0);
      *(_DWORD *)(*(_QWORD *)(a1 + 2152) + 32LL) = a3;
    }
  }
  else
  {
