/*
 * XREFs of BgpTxtDisplayString @ 0x1407D4284
 * Callers:
 ...
 *     BgpGxFillRectangle @ 0x14013C6E8 (BgpGxFillRectangle.c)
 *     BgpFoGetTextMetrics @ 0x14013C854 (BgpFoGetTextMetrics.c)
 ...
 *     TxtpJustifyRectangle @ 0x1407D44A4 (TxtpJustifyRectangle.c)
 */
...
LABEL_13:
        ...
        if ( AdvanceWidth >= 0 )
        {
          ...
          if ( v16 >= 0 )
          {
            ...
            v22 = *(_DWORD **)(a1 + 24);
            v28 = 0LL;
            v23 = BgpGxBlendRectangle(v22, v17, &v30, (__int64 *)&v28);
            v24 = (__int64)v28;
            AdvanceWidth = v23;
            if ( v23 >= 0 )
            {
