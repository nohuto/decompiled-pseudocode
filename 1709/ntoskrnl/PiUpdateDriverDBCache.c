/*
 * XREFs of PiUpdateDriverDBCache @ 0x140544B48
 * Callers:
...
_QWORD *__fastcall PiUpdateDriverDBCache(__int64 a1, void *a2, __int64 a3, int a4, __int128 *a5)
{
  ...
  {
    v20 = *v13;
    if ( *(_QWORD **)(*v13 + 8LL) != v13 || (v21 = (_QWORD *)v13[1], (_QWORD *)*v21 != v13) )
      __fastfail(3u);
    *v21 = v20;
    *(_QWORD *)(v20 + 8) = v21;
    goto LABEL_24;
...
LABEL_24:
  ...
  if ( result )
  {
    ...
    if ( result )
    {
      v18 = (_QWORD *)qword_1407F40B0;
      if ( *(PVOID **)qword_1407F40B0 != &PiDDBCacheList )
        __fastfail(3u);
      *result = &PiDDBCacheList;
      result[1] = v18;
      *v18 = result;
      qword_1407F40B0 = (__int64)result;
    }
  }
  return result;
}
