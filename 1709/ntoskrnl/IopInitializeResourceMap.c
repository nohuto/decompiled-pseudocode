/*
 * XREFs of IopInitializeResourceMap @ 0x14084DD34
 * Callers:
 *     IopInitializePlugPlayServices @ 0x14083F81C (IopInitializePlugPlayServices.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x140085150 (RtlInitUnicodeString.c)
 *     RtlCmEncodeMemIoResource @ 0x1401516D0 (RtlCmEncodeMemIoResource.c)
...
LABEL_20:
    ...
    {
      IopWriteResourceList((__int64)Handle, (__int64)&DestinationString, (__int64)&v30, &v29, v12, v10);
      ZwClose(Handle);
    }
