/*
 * XREFs of EtwpFindUserBufferSpace @ 0x140532FCC
 * Callers:
 *     EtwpRealtimeInjectEtwBuffer @ 0x140532DE0 (EtwpRealtimeInjectEtwBuffer.c)
 * Callees:
 *     RtlFindNextAlignedForwardRunClear @ 0x1400E09F4 (RtlFindNextAlignedForwardRunClear.c)
 *     RtlInterlockedSetClearRun @ 0x1400E0B00 (RtlInterlockedSetClearRun.c)
