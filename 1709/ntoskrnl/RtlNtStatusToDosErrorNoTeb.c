/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x140110170
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1402C9594[8 * v5] )
        {
          v8 = (unsigned __int16)word_1402C9596[4 * v5];
          if ( byte_1402C9595[8 * v5] == 1 )
