/*
 * XREFs of sub_14076883C @ 0x14076883C
 * Callers:
...
__int64 __fastcall sub_14076883C(__int64 a1, void *a2, int a3, __int64 a4)
{
  signed int v6; // ebx
...
LABEL_88:
  ...
  if ( !PoolWithTag )
    goto LABEL_95;
  v6 = FsRtlKernelFsControlFile(v38, 0x900F4u, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v65);
  if ( v6 < 0 )
    goto LABEL_112;
  if ( (unsigned int)v65 < 0x40 )
    goto LABEL_111;
  Object[0] = *(PVOID *)&PoolWithTag->Type;
  v6 = FsRtlKernelFsControlFile(v38, 0x900EBu, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v65);
  if ( v6 < 0 )
    goto LABEL_112;
  if ( (unsigned int)v65 < 0x40 )
  {
...
LABEL_113:
  ...
  v46 = (struct _IRP *)ExAllocatePoolWithTag(PagedPool, 0x248uLL, 0x20534C53u);
  if ( !v46 )
    goto LABEL_95;
  v6 = FsRtlKernelFsControlFile(v38, 0x900F4u, 0LL, 0, v46, 0x248u, (ULONG *)&v65);
  if ( v6 >= 0 )
  {
    if ( (unsigned int)v65 < 0x40 )
    {
LABEL_126:
    ...
    Object[0] = *(PVOID *)&v46->Type;
    v6 = FsRtlKernelFsControlFile(v38, 0x900EBu, 0LL, 0, v46, 0x248u, (ULONG *)&v65);
    if ( v6 >= 0 )
    {
      if ( (unsigned int)v65 < 0x40 )
        goto LABEL_126;
      Object[1] = v46->AssociatedIrp.MasterIrp;
      v45 = *(__m128i *)Object;
    }
  }
LABEL_130:
...
LABEL_96:
  ...
  *(_QWORD *)(v48 + 50) = 0LL;
  v40 = v48;
  v6 = FsRtlSetKernelEaFile(v38, v48, 0x3Au);
LABEL_97:
  if ( TargetFile )
    ZwClose(TargetFile);
  if ( v38 )
