...
LABEL_88:
  ...
  if ( !PoolWithTag )
    goto LABEL_95;
  v6 = FsRtlKernelFsControlFile(v38, 0x900F4u, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v66);
  if ( v6 < 0 )
    goto LABEL_112;
  if ( (unsigned int)v66 < 0x40 )
    goto LABEL_111;
  Object[0] = *(PVOID *)&PoolWithTag->Type;
  v6 = FsRtlKernelFsControlFile(v38, 0x900EBu, 0LL, 0, PoolWithTag, 0x248u, (ULONG *)&v66);
  if ( v6 < 0 )
    goto LABEL_112;
  if ( (unsigned int)v66 < 0x40 )
  {
...
LABEL_113:
  ...
  v47 = (struct _IRP *)ExAllocatePoolWithTag(PagedPool, 0x248uLL, 0x20534C53u);
  if ( !v47 )
    goto LABEL_95;
  v6 = FsRtlKernelFsControlFile(v38, 0x900F4u, 0LL, 0, v47, 0x248u, (ULONG *)&v66);
  if ( v6 >= 0 )
  {
    if ( (unsigned int)v66 < 0x40 )
    {
LABEL_126:
    ...
    Object[0] = *(PVOID *)&v47->Type;
    v6 = FsRtlKernelFsControlFile(v38, 0x900EBu, 0LL, 0, v47, 0x248u, (ULONG *)&v66);
    if ( v6 >= 0 )
    {
      if ( (unsigned int)v66 < 0x40 )
        goto LABEL_126;
      Object[1] = v47->AssociatedIrp.MasterIrp;
      v45 = *(__m128i *)Object;
    }
  }
LABEL_130:
...
LABEL_96:
  ...
  *(_QWORD *)(v49 + 50) = 0LL;
  v40 = v49;
  v6 = FsRtlSetKernelEaFile(v38, v49, 0x3Au);
LABEL_97:
  if ( v62 )
    ZwClose(v62);
  if ( v38 )
