/*
 * XREFs of RtlpPopulateLanguageConfigList @ 0x1405BD0E0
 * Callers:
 ...
 *     RtlpMuiRegConfigListAddLanguage @ 0x14078A77C (RtlpMuiRegConfigListAddLanguage.c)
            ...
            *(_WORD *)(((unsigned __int64)&v31 & 0xFFFFFFFFFFFFFFE0uLL) + 0x42) = v20;
            ...
            if ( (_DWORD)v23 )
            {
              ...
              do
              {
                ...
                v12 = RtlStringCbLengthW(v22, v24, (size_t *)v3 + 6);
                if ( v12 < 0 )
                  goto LABEL_31;
...
LABEL_39:
            ...
            if ( v12 >= 0 )
            {
              v28 = RtlpMuiRegValidateConfigNode(v6, (unsigned __int16 *)v3 + 32);
              v4 = 0;
              v12 = v28;
              if ( v28 >= 0 )
              {
