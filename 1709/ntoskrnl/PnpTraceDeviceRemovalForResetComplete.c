/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1406D1054
 * Callers:
...
char __fastcall PnpTraceDeviceRemovalForResetComplete(__int64 a1, UCHAR a2)
{
  ...
  LOBYTE(v2) = TraceLoggingProviderEnabled(&stru_140354A70, a2, 0x400000000000uLL);
  if ( (_BYTE)v2 )
  {
    v2 = *(_QWORD *)(v3 + 184);
    if ( v2 )
    ...
    {
      LOBYTE(v2) = TlgKeywordOn(&stru_140354A70, 0x400000000000uLL);
      if ( (_BYTE)v2 )
      {
        v8 = *(_DWORD *)(v4 + 300);
        v9 = *(_DWORD *)(v5 + 164);
        ...
        v33 = 2LL;
        v35[1] = v6;
        LOBYTE(v2) = TlgWrite(&stru_140354A70, &unk_1402CFEB4, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  return v2;
