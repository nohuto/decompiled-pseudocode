/*
 * XREFs of AslGuidToString_UStr @ 0x140771DCC
 * Callers:
...
__int64 __fastcall AslGuidToString_UStr(__int64 a1, unsigned int *a2)
{
  ...
  *(_DWORD *)a1 = 5111884;
  ...
  if ( v4 )
  {
    ...
    {
      AslLogCallPrintf(1, (unsigned int)"AslGuidToString_UStr", 257, (unsigned int)"RtlStringCchPrintfW failed [%x]");
    }
    if ( v4 )
  ...
  {
    AslLogCallPrintf(1, (unsigned int)"AslGuidToString_UStr", 237, (unsigned int)"Out of memory");
