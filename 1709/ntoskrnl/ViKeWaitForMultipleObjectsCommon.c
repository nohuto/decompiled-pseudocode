/*
 * XREFs of ViKeWaitForMultipleObjectsCommon @ 0x1407BA66C
 * Callers:
 *     VerifierKeWaitForMultipleObjects @ 0x1407B9B70 (VerifierKeWaitForMultipleObjects.c)
 *     VerifierKeWaitForMultipleObjectsNoReboot @ 0x1407B9C20 (VerifierKeWaitForMultipleObjectsNoReboot.c)
 * Callees:
