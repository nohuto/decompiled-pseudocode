/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x14028A9A8
 * Callers:
 *     WheapWmiExecuteMethod @ 0x14028A884 (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x140763548 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x140763630 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x14076363C (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x140763680 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x140763708 (WheapSetPolicyValue.c)
 */
