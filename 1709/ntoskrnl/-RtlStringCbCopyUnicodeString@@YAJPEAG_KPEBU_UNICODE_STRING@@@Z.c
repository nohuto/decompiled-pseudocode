/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14027285C
 * Callers:
 *     SmKmKeyGenStart @ 0x14073ABA4 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x140272904 (RtlUnicodeStringValidateSrcWorker.c)
 */
