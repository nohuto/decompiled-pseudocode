/*
 * XREFs of PfpPrefetchDirectoryStream @ 0x140440598
 * Callers:
...
__int64 PfpPrefetchDirectoryStream(_QWORD *a1, __int64 a2, __int64 a3, ...)
{
  ...
  int v20; // r10d
  SIZE_T v22; // [rsp+48h] [rbp-70h]
  ULONG_PTR v23[2]; // [rsp+60h] [rbp-58h] BYREF
  ...
  *((_QWORD *)Src + 1) = (8 * (v9 & 7)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
  ...
  if ( v13 >= 0 )
  {
    ...
    while ( v15 < *(_DWORD *)(a3 + 16) )
    {
      ...
      LODWORD(v22) = 0;
      v13 = IopXxxControlFile(Handle[0], (__int64)v23, 590112, Src, 8 * v20 + 16, 0LL, v22, 0);
      if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
