        ...
        _DWORD *a12)
{
  ...
  _BYTE v53[4]; // [rsp+3Ch] [rbp-C4h] BYREF
  _DWORD *v54; // [rsp+40h] [rbp-C0h]
  unsigned int v55; // [rsp+48h] [rbp-B8h] BYREF
  char v56; // [rsp+4Ch] [rbp-B4h]
  ...
  _OWORD v63[5]; // [rsp+70h] [rbp-90h] BYREF
  _DWORD *v64; // [rsp+C0h] [rbp-40h]
  unsigned int v65; // [rsp+C8h] [rbp-38h]
  void *v66; // [rsp+D0h] [rbp-30h]
  PVOID v67; // [rsp+D8h] [rbp-28h] BYREF
  __int64 v68; // [rsp+E0h] [rbp-20h] BYREF
  void *v69; // [rsp+E8h] [rbp-18h]
  void *v70; // [rsp+F0h] [rbp-10h]
  PCUNICODE_STRING String2; // [rsp+F8h] [rbp-8h]
  __int64 CurrentIrql; // [rsp+100h] [rbp+0h]
  _QWORD v73[5]; // [rsp+108h] [rbp+8h] BYREF
  __int128 v74; // [rsp+130h] [rbp+30h] BYREF
  PVOID P[16]; // [rsp+140h] [rbp+40h] BYREF
  _DWORD v76[256]; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  *((_QWORD *)&v74 + 1) = 0LL;
  ...
  LOWORD(v63[0]) = 0;
  BYTE4(v63[0]) = 0;
  memset((char *)v63 + 5, 0, 0x4BuLL);
  LOWORD(v73[0]) = 0;
  memset((char *)v73 + 4, 0, 0x24uLL);
  v52 = -1;
  v68 = -1LL;
  v59 = 0;
  v61 = 0;
  ...
  *a12 = -1;
  ...
  AuthzBasepResetOperands(v63, v51);
  LODWORD(v17) = 4;
  v57 = 0;
  v15 = 0LL;
  if ( a9 <= 4 )
...
LABEL_17:
      ...
      if ( (_DWORD)v15 == 2 )
      {
        if ( HIDWORD(v63[0]) == 1 )
          goto LABEL_172;
        v52 = AuthzBasepEvaluateAttribute(*(_QWORD *)&v63[1]);
        ...
        *(_OWORD *)&P[4] = *(_OWORD *)&P[13];
        v63[0] = *(_OWORD *)((char *)&v63[2] + 8);
        *(_OWORD *)((char *)&v63[1] + 8) = v63[4];
        *(_QWORD *)&v63[1] = &v74;
        v51[0] = HIBYTE(v51[0]);
        memset((char *)&v63[2] + 8, 0, 0x28uLL);
        memset(&P[7], 0, 0x48uLL);
        v15 = 1LL;
        v57 = 1;
      }
      if ( a9 - (unsigned int)v22 < 4 || (v23 = *(_DWORD *)((char *)a8 + v22), v24 = v22 + 4, v65 = v23, a9 - v24 < v23) )
      {
LABEL_172:
      ...
      LODWORD(v73[3]) = v23;
      v73[4] = (char *)a8 + v24;
      v60 = 72LL * (unsigned int)v15;
      String2 = (PCUNICODE_STRING)&P[v60 / 8];
      SecurityAttributeAndValues = AuthzBasepUnicodeStringFromOperandValue(
                                     (__int64)v73,
                                     0,
                                     (unsigned __int16 *)&P[v60 / 8],
                                     (_BYTE *)v51 + (unsigned int)v15);
      if ( SecurityAttributeAndValues < 0 )
        goto LABEL_71;
      v26 = v60;
      if ( (_BYTE)v18 == 0xF9 )
      ...
      *(PVOID *)((char *)&P[6] + v26) = 0LL;
        ...
        && !v58 )
      {
        if ( !v56 )
        {
          v48 = SepValidateAndCopyGlobalEntry(v66, &v67);
...
LABEL_34:
      ...
      {
        v31 = 40 * v25;
        *(_WORD *)((char *)v63 + v31) = P[9 * v25 + 2];
        *(_DWORD *)((char *)v63 + v31 + 4) = P[9 * v25 + 3];
        *(_QWORD *)((char *)&v63[1] + v31) = &P[9 * v25 - 2];
        goto LABEL_36;
      }
      if ( SecurityAttributeAndValues != -1073741275 )
        goto LABEL_71;
LABEL_65:
      ...
      SecurityAttributeAndValues = 0;
      *((_WORD *)v63 + 4 * v38) = 0;
      *((_DWORD *)v63 + 2 * v38 + 1) = 0;
      *((_QWORD *)&v63[1] + v38) = 0LL;
      if ( *((_BYTE *)v51 + v25) )
      {
        ExFreePoolWithTag(P[v60 / 8 + 1], 0);
        if ( v25 >= 2 )
...
LABEL_36:
      ...
      v15 = v57 + 1;
      LODWORD(v17) = v65 + v24;
      *(_DWORD *)((char *)&v63[1] + v32 + 8) = 0;
      *(_QWORD *)((char *)&v63[2] + v32) = 0LL;
      *(_DWORD *)((char *)v63 + v32 + 8) = 0;
      *(_DWORD *)((char *)v63 + v32 + 12) = P[9 * v25 - 2];
LABEL_37:
      v57 = v15;
      goto LABEL_38;
    }
    ...
    {
      LODWORD(v17) = v17 + 1;
      if ( !(unsigned __int8)AuthzBasepIsValidExpression(162LL, v63, v15, v50) )
        goto LABEL_172;
      if ( (_DWORD)v15 == 1 )
      {
        v52 = AuthzBasepEvaluateAttribute(*(_QWORD *)&v63[1]);
      ...
      {
        SecurityAttributeAndValues = AuthzBasepPopResult(v76, &v55, &v52);
        if ( SecurityAttributeAndValues < 0 )
          goto LABEL_71;
        v19 = v52;
      }
...
LABEL_57:
        ...
        case 0x8F:
          LODWORD(v17) = v17 + 1;
          if ( !(unsigned __int8)AuthzBasepIsValidExpression((unsigned __int8)v18, v63, v15, v50) )
          {
            SecurityAttributeAndValues = -1073741406;
            if ( !v50[0] )
              goto LABEL_71;
LABEL_107:
          ...
          if ( v50[0] )
            goto LABEL_107;
          AuthzBasepEvaluateExpression((unsigned __int8)v18, v63, &v52);
          if ( ((_BYTE)v18 == 0x8E || (_BYTE)v18 == 0x8F) && v52 != -1 )
            v52 = v52 == 0;
LABEL_62:
          SecurityAttributeAndValues = AuthzBasepPushResult(v76, &v55);
          if ( SecurityAttributeAndValues < 0 )
...
LABEL_120:
          ...
          if ( !v50[0] )
          {
            ...
            SecurityAttributeAndValues = AuthzBasepMemberOf((unsigned int)v63, (_DWORD)v64, a10, a11, v45, (__int64)v53);
          }
          if ( SecurityAttributeAndValues < 0 )
            goto LABEL_120;
          v39 = v53[0] != 0;
...
LABEL_70:
        ...
        case 0xA1:
          ...
          if ( (_DWORD)v15 == 2 )
          {
            v59 = AuthzBasepEvaluateAttribute(*(_QWORD *)&v63[1]);
            v42 = AuthzBasepEvaluateAttribute(*((_QWORD *)&v63[3] + 1));
            v61 = v42;
          }
          else
          {
            ...
            SecurityAttributeAndValues = AuthzBasepPopResult(v76, &v55, &v61);
            if ( SecurityAttributeAndValues < 0 )
              goto LABEL_71;
            v42 = v61;
          }
...
LABEL_112:
          ...
          if ( v50[0] )
            goto LABEL_112;
          AuthzBasepComputeExpression((unsigned __int8)v18, v63, &v68);
          if ( v68 == -1 )
            goto LABEL_112;
          v44 = v68 != 0;
LABEL_113:
...
LABEL_38:
  ...
  if ( !v55 && (_DWORD)v15 == 1 )
  {
    v40 = AuthzBasepEvaluateAttribute(*(_QWORD *)&v63[1]);
    v33 = v54;
    *v54 = v40;
    goto LABEL_42;
  }
...
LABEL_42:
  ...
  if ( v56 )
  {
    ...
    if ( v67 )
    {
      AuthzBasepFreeSecurityAttributesList(v67, v14, v15);
