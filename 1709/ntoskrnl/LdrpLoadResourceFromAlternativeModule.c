/*
 * XREFs of LdrpLoadResourceFromAlternativeModule @ 0x1400DD444
 * Callers:
...
__int64 __fastcall LdrpLoadResourceFromAlternativeModule(unsigned __int64 a1, __int64 a2, int a3, char a4, _QWORD *a5)
{
