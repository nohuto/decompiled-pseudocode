/*
 * XREFs of MmMarkHiberPhase @ 0x140430420
 * Callers:
...
unsigned __int64 MmMarkHiberPhase()
{
  ...
  MiEnumerateLeafPtes(
    ...
    0LL,
    2);
  PoSetHiberRange(0LL, 0x14000u, qword_1403891E8, 1uLL, 0x61676D4Du);
  CurrentProcess = PsGetCurrentProcess();
  PoSetHiberRange(0LL, 0x10000u, CurrentProcess, 0x840uLL, 0x62706D4Du);
  v2 = (void *)PsGetCurrentProcess()[2].Affinity.Bitmap[0];
  if ( v2 )
    PoSetHiberRange(0LL, 0x10000u, v2, 0x1000uLL, 0x62706D4Du);
  MiEnumerateLeafPtes(
    qword_140388850,
    (qword_140388850 + qword_140388858 - 2) & 0xFFFFFFFFFFFFF000uLL,
    (__int64 (__fastcall *)(__int64, unsigned __int64, unsigned __int64))MiMarkNonPagedHiberPhasePages,
    0LL,
    0);
