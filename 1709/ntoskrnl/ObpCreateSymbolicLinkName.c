/*
 * XREFs of ObpCreateSymbolicLinkName @ 0x14058C2D8
 * Callers:
...
char __fastcall ObpCreateSymbolicLinkName(__int64 a1)
{
  ...
  __int64 v27[2]; // [rsp+58h] [rbp-29h] BYREF
...
LABEL_15:
      ...
      v14 = ObpLookupDirectoryEntryEx(v8, (unsigned __int16 *)&v26, 0, 0LL, 0, (__int64)v27);
      v15 = v14;
      if ( v8 == v32 )
      {
        LOBYTE(v28) = v5;
