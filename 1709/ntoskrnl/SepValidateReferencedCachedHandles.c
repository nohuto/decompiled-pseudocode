/*
 * XREFs of SepValidateReferencedCachedHandles @ 0x1405641B4
 * Callers:
...
__int64 __fastcall SepValidateReferencedCachedHandles(__int64 a1, PSID *a2, unsigned int a3, HANDLE *a4)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  else
  {
    ...
    {
      v11 = a2[1];
      v12 = RtlSubAuthoritySid(v11, 0xBu);
...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    {
      v21 = v4;
      if ( RtlPrefixUnicodeString((UNICODE_STRING *)((char *)&v36 + 24 * v4), &String2, 1u) )
        break;
      if ( ++v4 >= v10 )
        goto LABEL_53;
    }
