/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x14021E570
 * Callers:
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1, int a2)
{
  ...
  CurrentThread = 0LL;
  v13 = 0;
  if ( _InterlockedIncrement(&dword_140389248) <= 1 && KeAreInterruptsEnabled() )
  {
...
LABEL_22:
        ...
        {
          if ( a1 == 1 )
            v15 = *(ULONG_PTR **)(qword_140388AF0 + 8LL * *(unsigned __int16 *)(v3 + 172));
          else
