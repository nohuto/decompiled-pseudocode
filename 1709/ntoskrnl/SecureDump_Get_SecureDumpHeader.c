/*
 * XREFs of SecureDump_Get_SecureDumpHeader @ 0x1401FC820
 * Callers:
...
__int64 __fastcall SecureDump_Get_SecureDumpHeader(__int64 a1, _DWORD *a2, unsigned int a3)
{
  ...
  if ( !byte_140387F14 )
    return 3221225485LL;
  if ( a3 < dword_140387F60 )
    return 3221225485LL;
  v5 = a3;
  if ( a3 < pcbResult + (unsigned __int64)(unsigned int)dword_140387F2C + 4184 )
    return 3221225485LL;
  memset(a2, 0, a3);
  a2[2] = 1;
  a2[3] = dword_140387F60;
  *a2 = *(_DWORD *)a1;
  a2[1] = *(_DWORD *)(a1 + 4);
  a2[12] = *(_DWORD *)(a1 + 48);
  ...
  *((_QWORD *)a2 + 11) = 0LL;
  ...
  a2[7] = v7;
  a2[8] = v8;
  a2[6] = dword_140387F2C;
  memmove((char *)a2 + v7, qword_140387F30, (unsigned int)dword_140387F2C);
  a2[9] = dword_140387F5C;
  return 0LL;
}
