/*
 * XREFs of EtwpUpdateLastBranchTracingEvents @ 0x140752688
 * Callers:
...
__int64 __fastcall EtwpUpdateLastBranchTracingEvents(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( !a3 || a3 > 4 )
    return 3221225485LL;
  if ( *(_QWORD *)(a1 + 2160) || (result = EtwpAllocateLbrData(a1), (int)result >= 0) )
  {
    for ( i = 0LL; ; i = (unsigned int)(i + 1) )
    {
      ...
      if ( (unsigned int)i >= a3 )
        break;
      *(_WORD *)(*(_QWORD *)(a1 + 2160) + 2 * i + 12) = *(_WORD *)(a2 + 4 * i);
    }
    _InterlockedOr(v8, 0);
    *(_DWORD *)(*(_QWORD *)(a1 + 2160) + 8LL) = a3;
    return 0LL;
  }
  return result;
}
