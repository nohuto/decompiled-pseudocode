 ...
 *     _inc @ 0x140166974 (_inc.c)
 *     _ungetc_nolock @ 0x140168144 (_ungetc_nolock.c)
 */

__int64 __fastcall input_s(FILE *File, unsigned __int8 *a2, _DWORD *a3)
{
  int v3; // r13d
...
LABEL_121:
      ...
      if ( v29 == 123 )
      {
        v53 = ReadStringDelimited(v52, &v77, &v61, &v60, (_WORD **)&v73, v14, File, v26, &v68);
        v4 = v77;
      }
      else
      {
        v53 = ReadString(v52, 0LL, &v61, &v60, (_WORD **)&v73, v14, File, v26, &v68);
      }
      v5 = v61;
      if ( v53 )
        goto LABEL_201;
