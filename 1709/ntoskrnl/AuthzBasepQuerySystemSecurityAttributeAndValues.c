/*
 * XREFs of AuthzBasepQuerySystemSecurityAttributeAndValues @ 0x140483C80
 * Callers:
...
__int64 __fastcall AuthzBasepQuerySystemSecurityAttributeAndValues(__int64 a1)
{
  ...
  {
    SystemSecurityAttribute = AuthzBasepFindSystemSecurityAttribute((const UNICODE_STRING *)(a1 + 16));
