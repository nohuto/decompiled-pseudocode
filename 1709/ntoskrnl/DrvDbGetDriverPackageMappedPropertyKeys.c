/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x1407872AC
 * Callers:
...
LABEL_23:
      ...
      do
      {
        ...
        if ( Value == -1073741772 )
        {
          ...
          if ( *((_DWORD *)*v25 + 4) != 7 )
            goto LABEL_35;
          v29 = *(_QWORD *)v28 - DEVPKEY_DriverPackage_SignerName;
          if ( *(_QWORD *)v28 == DEVPKEY_DriverPackage_SignerName )
          ...
          if ( a3 )
            v30 = (int)a3;
          if ( (int)DrvDbGetDriverPackageSignerScore((int)a1, v44, v30, (wchar_t *)&v40) < 0 || v40 != 218103811 )
          {
LABEL_35:
            CompositeMappedPropertyKeys = 0;
            goto LABEL_44;
