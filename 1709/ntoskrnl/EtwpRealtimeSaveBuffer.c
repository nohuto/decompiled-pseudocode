/*
 * XREFs of EtwpRealtimeSaveBuffer @ 0x1405DA000
 * Callers:
...
__int64 __fastcall EtwpRealtimeSaveBuffer(__int64 a1, unsigned int *Buffer)
{
  ...
  v4 = *(LARGE_INTEGER *)(a1 + 408);
  v6 = *(LARGE_INTEGER *)(a1 + 416);
  ByteOffset = v2;
  if ( v2.QuadPart >= v4.QuadPart )
  {
    Length = Buffer[12];
    if ( v2.QuadPart + Length > *(_QWORD *)(a1 + 432) )
    {
      v6 = v2;
      v2.QuadPart = 72LL;
  ...
  {
LABEL_5:
    v8 = ZwWriteFile(*(HANDLE *)(a1 + 376), 0LL, 0LL, 0LL, &IoStatusBlock, Buffer, Length, &ByteOffset, 0LL);
    if ( v8 < 0 )
    {
      ++*(_DWORD *)(a1 + 276);
      *(_DWORD *)(a1 + 464) = 2;
    ...
    else
    {
      ...
      *(_QWORD *)(a1 + 416) = QuadPart;
      *(_QWORD *)(a1 + 424) += Buffer[12];
      v13 = v11 - *(_QWORD *)(a1 + 424);
      ++*(_DWORD *)(a1 + 440);
      if ( v13 <= v12 && *(int *)(a1 + 16) >= 0 )
      {
        *(_DWORD *)(a1 + 16) = -1073741432;
        if ( EtwEventEnabled(EtwpEventTracingProvRegHandle, &ETW_EVENT_BACKING_FILE_FULL) )
          EtwpEventWriteTemplateBackingFile(v19, v18, v20, a1 + 152);
      }
    }
  ...
  else
  {
    ...
    *(_DWORD *)(a1 + 464) = 2;
    if ( EtwEventEnabled(EtwpEventTracingProvRegHandle, &ETW_EVENT_BACKING_FILE_FULL) )
      EtwpEventWriteTemplateBackingFile(v16, v15, v17, a1 + 152);
    return 3221225864LL;
  }
}
