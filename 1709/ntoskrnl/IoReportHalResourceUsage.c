/*
 * XREFs of IoReportHalResourceUsage @ 0x140853A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IoReportHalResourceUsage(__int64 a1, void *a2, _DWORD *a3, unsigned int a4)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( P )
        v12 = P;
      v8 = IopWriteResourceList((__int64)Handle, (__int64)&DestinationString, a1, &v20, v12, v11);
      if ( v8 >= 0 )
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          v8 = IopWriteResourceList((__int64)Handle, (__int64)&DestinationString, a1, &v20, a3, v14);
          if ( v13 )
