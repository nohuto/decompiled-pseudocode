/*
 * XREFs of PspClearProcessThreadCidRefs @ 0x1404D5438
 * Callers:
...
__int64 __fastcall PspClearProcessThreadCidRefs(__int64 a1, __int64 a2, ULONG_PTR a3)
{
  ...
  --*(_WORD *)(a1 + 486);
  v5 = ExMapHandleToPointer(*(unsigned int **)((char *)&Mm64BitPhysicalAddress + 5), a2);
  v6 = (unsigned __int64)*v5 >> 1;
  *v5 &= 0xFFFFFFFFFFFE0001uLL;
  v7 = *(__int64 *)((char *)&Mm64BitPhysicalAddress + 5);
