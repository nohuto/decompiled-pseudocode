/*
 * XREFs of MiComputeOptimalZeroPath @ 0x140829810
 * Callers:
...
void MiComputeOptimalZeroPath()
{
  ...
  while ( 1 )
  {
    ...
    if ( v2 >= 2 )
    {
      v43 = 0LL;
      v7 = &v39;
      v34 = (unsigned __int64 *)&unk_1403885C0;
      v33 = &v39;
      v8 = 0LL;
      v35 = 2LL;
      do
      ...
      do
      {
        ...
        MiInsertPageInFreeOrZeroedList(v38[v0 + 2], 2);
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      MiInsertPageInFreeOrZeroedList(v38[v29 + 2], 2);
