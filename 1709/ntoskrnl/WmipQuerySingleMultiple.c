/*
 * XREFs of WmipQuerySingleMultiple @ 0x140742240
 * Callers:
        ...
        _DWORD *a9)
{
  ...
  while ( 1 )
  {
    ...
    if ( v11 )
    {
      ...
      Object = *(PVOID *)(v11 + 8LL * (unsigned int)v21);
      v52 = 0LL;
    ...
    *((_WORD *)v25 + 32) = v37;
    ...
    v38 = *v25;
    if ( (int)WmipQuerySetExecuteSI(Object, Irp, a2, 1u, (__int64)v25, v42, &v38) < 0 )
      goto LABEL_43;
    v28 = v25[11];
    if ( (v28 & 0x100) != 0 )
      goto LABEL_43;
