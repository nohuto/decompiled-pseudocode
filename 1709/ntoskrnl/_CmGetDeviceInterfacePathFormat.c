/*
 * XREFs of _CmGetDeviceInterfacePathFormat @ 0x14044B5FC
 * Callers:
...
__int64 __fastcall CmGetDeviceInterfacePathFormat(__int64 a1, const WCHAR *a2, _BYTE *a3)
{
  ...
  if ( inited >= 0 )
  {
    ...
    if ( RtlPrefixUnicodeString(&stru_1402B5160, &DestinationString, 0) )
    {
      *a3 = 1;
      return (unsigned int)inited;
    }
    if ( !RtlPrefixUnicodeString(&stru_1402B5150, &DestinationString, 0) )
      return (unsigned int)-1073741773;
    *a3 = 0;
  }
  return (unsigned int)inited;
