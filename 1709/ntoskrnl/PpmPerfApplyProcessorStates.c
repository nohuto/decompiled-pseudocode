/*
 * XREFs of PpmPerfApplyProcessorStates @ 0x14014D300
 * Callers:
 *     <none>
 * Callees:
...
char PpmPerfApplyProcessorStates()
{
  ...
  for ( i = PpmPerfDomainHead; (__int64 *)i != &PpmPerfDomainHead; i = *(_QWORD *)i )
  {
    if ( *(_BYTE *)(i + 614) )
    {
      KeOrAffinityEx((unsigned __int16 *)(i + 24), &v17, &v17);
      v3 = 0;
      LODWORD(v13) = 0;
      if ( *(_DWORD *)(i + 200) )
      {
        do
        {
          v4 = *(_QWORD *)(i + 208) + ((unsigned __int64)v3 << 7);
          if ( *(_BYTE *)(v4 + 16) )
          {
            if ( *(_BYTE *)(v4 + 120) )
            {
              LOBYTE(v2) = 1;
              PpmPerfApplyHiddenProcessorState(i, *(_QWORD *)(i + 208) + ((unsigned __int64)v3 << 7), v2);
              *(_BYTE *)(v4 + 120) = 0;
            }
