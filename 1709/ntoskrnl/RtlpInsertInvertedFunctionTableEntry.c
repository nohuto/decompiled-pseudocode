/*
 * XREFs of RtlpInsertInvertedFunctionTableEntry @ 0x140015DE0
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( PsInvertedFunctionTable[0] == dword_140418014 )
  {
    byte_14041801C = 1;
  }
  else
  {
    _InterlockedIncrement(&dword_140418018);
    v9 = 1;
    if ( PsInvertedFunctionTable[0] != 1 )
    {
      if ( PsInvertedFunctionTable[0] > 1u )
      {
        v10 = (unsigned __int64 *)&unk_140418040;
        do
        {
          if ( a2 < *v10 )
            break;
