/*
 * XREFs of ?SmStTrimWsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@_K@Z @ 0x1402691F0
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStTrimWsStore(__int64 a1, __int64 a2)
{
  ...
  $709EDFC2F9E0D4565D6AA3C4377BC643 v27; // [rsp+58h] [rbp-81h] BYREF
  _DWORD v28[10]; // [rsp+88h] [rbp-51h] BYREF
  _QWORD v29[8]; // [rsp+B0h] [rbp-29h] BYREF

  v2 = a2;
  v25 = a2;
  KiStackAttachProcess(*(_KPROCESS **)(a1 + 6568), 0, (__int64)&v27);
  ...
  else
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(a1 + 6212) )
      {
        while ( 1 )
        {
          if ( (*(_QWORD *)(*(_QWORD *)(a1 + 6216) + 8LL * v18) & 0x7FFFFFFFFFFF0000LL) != 0
