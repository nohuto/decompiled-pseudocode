/*
 * XREFs of RtlpCoalesceFreeBlocks @ 0x14010D830
 * Callers:
...
LABEL_29:
  ...
  if ( *(_DWORD *)(a1 + 124) )
  {
    v34 = *(_DWORD *)(a1 + 136) ^ *(_DWORD *)(v9 + 8);
    if ( HIBYTE(v34) != ((unsigned __int8)v34 ^ (unsigned __int8)(((unsigned __int16)(*(_WORD *)(a1 + 136) ^ *(_WORD *)(v9 + 8)) >> 8) ^ BYTE2(v34))) )
      RtlpLogHeapFailure(3, a1, v9, 0, 0LL);
  }
  while ( ((*(_BYTE *)(v9 + 10) ^ (unsigned __int8)(*(_BYTE *)(a1 + 138) & (*(_DWORD *)(a1 + 124) >> 20))) & 1) == 0 )
  {
    if ( *(_DWORD *)(a1 + 124) )
    {
...
LABEL_17:
        v33 = v16;
        LOBYTE(v16) = 1;
        RtlpHeapRemoveListEntry(a1, (_DWORD)v14, v16, v9 + 16, v33, *(unsigned __int16 *)(v9 + 8));
      }
      *v11 = v12;
      *(_QWORD *)(v12 + 8) = v11;
      v17 = *(_BYTE *)(v9 + 10);
      if ( (v17 & 4) != 0 )
      {
        ...
        if ( (v17 & 2) != 0 && v31 > 4 )
          v31 = 16LL * *(unsigned __int16 *)(v9 + 8) - 36;
        v32 = RtlCompareMemoryUlong((PVOID)(v9 + 32), v31, 0xFEEEFEEE);
        if ( v32 != v31 )
        {
          DbgPrint(
            "HEAP: Free Heap block %p modified at %p after it was freed\n",
            (const void *)v9,
            (const void *)(v32 + v9 + 32));
          if ( (_BYTE)KdDebuggerEnabled )
            __debugbreak();
        }
      }
      *(_BYTE *)(v4 + 10) = 0;
      *(_BYTE *)(v4 + 15) = 0;
      *a3 += *(unsigned __int16 *)(v9 + 8);
      *(_WORD *)(v4 + 8) = *(_WORD *)a3;
      *(_WORD *)(v4 + 16LL * *a3 + 12) = *(_WORD *)(a1 + 140) ^ *(_WORD *)a3;
      return v4;
    }
    RtlpLogHeapFailure(12, a1, v9 + 16, v13, *v11);
  }
  return v4;
}
