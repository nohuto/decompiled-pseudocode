/*
 * XREFs of ExpSaPageGroupFreeMemory @ 0x140156564
 * Callers:
...
bool __fastcall ExpSaPageGroupFreeMemory(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)v3, 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)v3, (__int64)v7, (__int16 *)v3);
  if ( v8 )
    BYTE2(v8[1].Left) |= 1u;
...
LABEL_21:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v3, (unsigned int *)&v22);
  v14 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v14 )
  {
    v20 = &CurrentThread->152;
    if ( ($B476B70DB57F76B110DA5B9238C3E934 *)v20->ApcState.ApcListHead[0].Flink != v20 )
