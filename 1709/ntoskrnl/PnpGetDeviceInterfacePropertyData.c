/*
 * XREFs of PnpGetDeviceInterfacePropertyData @ 0x1406C1E54
 * Callers:
 ...
 *     IoGetDeviceInterfacePropertyData @ 0x1406BF470 (IoGetDeviceInterfacePropertyData.c)
 * Callees:
        ...
        __int64 a8)
{
  ...
  _BYTE v15[8]; // [rsp+68h] [rbp-110h] BYREF
