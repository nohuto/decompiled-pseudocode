/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x140255ED8
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x140725DFC (Normalization__GetSecondDecomposedCharPlane0.c)
 */
