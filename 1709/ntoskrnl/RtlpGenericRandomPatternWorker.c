/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x140257A68
 * Callers:
 *     RtlScrubMemory @ 0x1402573DC (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x140257514 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x140257F88 (RtlpTestMemoryRandomUp.c)
 */
