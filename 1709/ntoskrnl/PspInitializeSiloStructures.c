/*
 * XREFs of PspInitializeSiloStructures @ 0x140843AC8
 * Callers:
 ...
 *     PspSiloInitializeSharedUserSessionId @ 0x14059F62C (PspSiloInitializeSharedUserSessionId.c)
...
char PspInitializeSiloStructures()
{
  ...
  qword_14041B990 = (__int64)PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  memset(PoolWithTag, 0, 0x248uLL);
  if ( (int)PspSiloInitializeSharedUserSessionId(qword_14041B990) < 0
...
LABEL_15:
  ...
  qword_140362998 = (__int64)&PspSiloMonitorList;
  ...
  if ( (int)ObCreateObjectType((const UNICODE_STRING *)L"$&", (__int64)v4, 0LL, (__int64)&PsSiloContextPagedType) >= 0 )
  {
    ...
    {
      if ( (int)PspAllocStorage(&qword_14041B978) >= 0 )
        return 1;
