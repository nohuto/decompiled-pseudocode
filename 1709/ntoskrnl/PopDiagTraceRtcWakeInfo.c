/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x140246A9C
 * Callers:
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  PopDiagInterruptTimeToSystemTime(qword_140365850, v26);
  PopDiagInterruptTimeToSystemTime(qword_140365868, v27);
  PopDiagInterruptTimeToSystemTime(qword_140365828, v28);
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v83 = 8LL;
      v85 = 4LL;
      result = TlgWrite(&pCallbackContext, &unk_1402D1E09, 0LL, 0LL, 0x10u, &pData);
    }
  }
