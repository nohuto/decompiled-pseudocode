/*
 * XREFs of MiReleaseSessionVa @ 0x1400F7EA8
 * Callers:
...
__int64 __fastcall MiReleaseSessionVa(__int64 a1, unsigned int a2)
{
  ...
  v3 = (unsigned __int64)(a1 - qword_140388478) >> 21;
...
LABEL_19:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v7, v6, (unsigned int *)&v18);
  v11 = v7->SpecialApcDisable++ == -1;
  if ( v11 && ($B476B70DB57F76B110DA5B9238C3E934 *)v7->ApcState.ApcListHead[0].Flink != &v7->152 )
