/*
 * XREFs of PnpTraceRebalanceResult @ 0x1406D15E4
 * Callers:
...
BOOLEAN __fastcall PnpTraceRebalanceResult(__int64 a1, UCHAR a2)
{
  ...
  result = TraceLoggingProviderEnabled(&stru_140354A70, a2, 0x400000000000uLL);
  if ( result )
  {
    ...
    {
      result = TlgKeywordOn(&stru_140354A70, 0x400000000000uLL);
      if ( result )
      {
        v8 = v4 - *((_QWORD *)v6 + 7);
        v11 = *v6;
        ...
        v40 = 8LL;
        v42 = 8LL;
        return TlgWrite(&stru_140354A70, &unk_1402CFF47, 0LL, 0LL, 0xFu, &pData);
      }
    }
  }
  return result;
