/*
 * XREFs of MiSectionInitialization @ 0x14085467C
 * Callers:
  ...
  *(_OWORD *)((char *)&v12[1] + 4) = MiSectionMapping;
  ...
  if ( (int)ObCreateObjectType(&v4, (__int64)v12, 0LL, (__int64)&MmSectionObjectType) >= 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memset(&qword_140388130, 0, 0xF0uLL);
      v1[5] = 0LL;
      dword_1403881D8 |= 0x400u;
      v8 = 0LL;
      v9 = &v5;
      qword_140388130 = (__int64)&qword_1403881A0;
      qword_1403881A0 = (__int64)v1;
      qword_1403881B8 = 1LL;
      *v1 = &qword_1403881A0;
      v7 = 48;
      v10 = 65552;
      ...
      {
        v2 = Object;
        *((_QWORD *)Object + 5) = &qword_1403881A0;
