/*
 * XREFs of KiSelectReadyThread @ 0x14006F300
 * Callers:
...
unsigned __int64 *__fastcall KiSelectReadyThread(signed int a1, __int64 a2, unsigned __int64 *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( v3 )
    {
      ...
      v11 = v27;
      if ( v12 > v27 || v12 == v27 && !_bittest((const signed __int32 *)(a2 + 22812), v27) )
      {
        v28 = 0;
...
LABEL_19:
        ...
        if ( v15 >= v4 && v15 >= v10 )
        {
          ...
          while ( 1 )
          {
            ...
            v19 = -1LL;
            if ( v18 )
              v19 = *(_QWORD *)(*(_QWORD *)(a2 + 192) + 24 * ((int)v18 + 8LL));
            if ( (v19 & *(_QWORD *)(a2 + 200)) != 0 || (v19 & *(_QWORD *)(a2 + 24896) & v7) == 0 )
              break;
            v17 = (_QWORD *)*v17;
            v25 = v17;
            if ( v17 == v16 )
          ...
          v20 = (unsigned __int64 **)v9[27];
          v21 = (unsigned __int64 **)v9[28];
          if ( v20[1] != v9 + 27 || *v21 != v9 + 27 )
            __fastfail(3u);
          *v21 = (unsigned __int64 *)v20;
          ...
          if ( v21 == v20 )
            *(_DWORD *)(v3 + 8) ^= 1 << v26;
          --*(_DWORD *)(v3 + 608);
          *(_QWORD *)(v3 + 616) -= *((unsigned int *)v9 + 506);
        ...
        {
          if ( v26 == v27 )
            _bittestandset((signed __int32 *)(a2 + 22812), v27);
          goto LABEL_35;
        }
        v12 = v26;
        v11 = v27;
    ...
    if ( v11 >= a1 )
    {
      a3 = *(unsigned __int64 **)(a2 + 16 * (v11 + 1432LL));
      v7 = *a3;
      v9 = a3 - 27;
      ...
      *(_QWORD *)(v7 + 8) = v24;
      ...
      --*(_DWORD *)(a2 + 23476);
      *(_QWORD *)(a2 + 23480) -= *((unsigned int *)v9 + 506);
      if ( v11 == v12 )
...
LABEL_35:
    ...
    if ( !v22 )
      return v9;
    v23 = *(unsigned int *)(a2 + 216) + v22;
    if ( !v23 )
      return v9;
    LOBYTE(v7) = 1;
    if ( !(unsigned int)KiGetThreadEffectiveRankNonZero((_DWORD)v9, v23, (_DWORD)a3, v7, 0LL) )
      return v9;
    KiAddThreadToScbQueue(a2, v23, v9, 0LL);
  }
}
