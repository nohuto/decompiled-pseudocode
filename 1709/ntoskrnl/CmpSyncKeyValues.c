/*
 * XREFs of CmpSyncKeyValues @ 0x1405A62E4
 * Callers:
...
char __fastcall CmpSyncKeyValues(__int64 a1, int a2, __int64 a3, ULONG_PTR a4, unsigned int a5, __int64 a6, char a7)
{
...
LABEL_31:
    ...
    *v13 = v14;
    ...
    else
    {
      ...
      v37[1] = 0;
      v38[1] = 0;
      v43 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(a4 + 8))(a4, v18, v36);
      v28 = a4;
      if ( !v43 )
        goto LABEL_29;
      v29 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(a4 + 8))(a4, v14, v37);
      v44 = v29;
      if ( !v29 )
      {
        v27 = v36;
LABEL_27:
        (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v27);
        goto LABEL_28;
      }
      BugCheckParameter3a = *(_DWORD *)(v29 + 8);
      v45 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(a4 + 8))(a4, BugCheckParameter3a, v38);
      if ( !v45 )
      {
        (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v36);
        v27 = v37;
        goto LABEL_27;
      }
      ...
      {
        (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v36);
        (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v37);
        v27 = v38;
        goto LABEL_27;
      }
      v30 = v43;
      ...
      *(_DWORD *)(v45 + 4) = v19;
      (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v36);
      (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v37);
      (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v38);
    }
    ...
    *(_DWORD *)(v12 + 64) = *(_DWORD *)(a3 + 64);
    ...
    if ( !v20 )
      return 1;
    v21 = (unsigned int *)(*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(a1 + 8))(
                            a1,
                            *(unsigned int *)(a3 + 40),
                            v41);
    if ( v21 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v46 == -1 || !(*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(a4 + 8))(a4, (unsigned int)v46, v42) )
        {
          v8 = *(_DWORD *)(v12 + 40);
          goto LABEL_16;
        }
      ...
      if ( v8 != -1 )
      {
        v32 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(a4 + 8))(a4, v8, v40);
        if ( v32 )
        {
          while ( v22 )
            HvFreeCell(a4, *(unsigned int *)(v32 + 4LL * --v22));
          (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(a4 + 16))(a4, v40);
        }
      }
LABEL_16:
