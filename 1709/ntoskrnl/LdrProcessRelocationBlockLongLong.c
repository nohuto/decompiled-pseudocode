/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x1405BE6E8
 * Callers:
 *     LdrRelocateImageWithBias @ 0x1405BE60C (LdrRelocateImageWithBias.c)
 * Callees:
 *     LdrpGenericProcessRelocation @ 0x140142D9C (LdrpGenericProcessRelocation.c)
 *     LdrpArmProcessRelocation @ 0x140256244 (LdrpArmProcessRelocation.c)
