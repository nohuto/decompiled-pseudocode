/*
 * XREFs of ?SmIoCtxPrepareToQueue@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_IO_CONTEXT@1@PEAU1@KPEAU_SM_WORK_ITEM@1@PEAU_SM_QUEUE_CONTEXT@1@@Z @ 0x1402671BC
 * Callers:
        ...
        __int64 a5)
{
  ...
  *(_QWORD *)&v18 = 0LL;
  ...
  v7 = SmFpAllocate((PEX_SPIN_LOCK)(a2 + 1536), v13);
  if ( v7 )
  {
