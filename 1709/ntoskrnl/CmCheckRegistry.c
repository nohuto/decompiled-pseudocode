/*
 * XREFs of CmCheckRegistry @ 0x140471AFC
 * Callers:
...
__int64 __fastcall CmCheckRegistry(ULONG_PTR BugCheckParameter2, int a2, __int64 a3)
{
  ...
  if ( (PVOID)BugCheckParameter2 == CmpMasterHive )
    return v3;
  v11 = a2;
  v12 = *(_DWORD *)(BugCheckParameter2 + 1400) >> 3;
  ...
  while ( 1 )
  {
    if ( v15 )
    {
      ...
      v16 = HvCheckHive(BugCheckParameter2, v8, v9, p_BitMapHeader, v22, a3);
      v3 = v16;
      if ( v16 < 0 )
      {
        v19 = 16;
      ...
      *(_DWORD *)(BugCheckParameter2 + 6016) = v22[12];
      *(_DWORD *)(BugCheckParameter2 + 6020) = v22[13];
    }
...
LABEL_15:
      ...
      if ( v16 == -2147483606 )
      {
        v10 = 1;
LABEL_16:
        *(_DWORD *)(BugCheckParameter2 + 6028) = v20;
