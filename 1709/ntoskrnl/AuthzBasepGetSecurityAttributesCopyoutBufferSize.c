/*
 * XREFs of AuthzBasepGetSecurityAttributesCopyoutBufferSize @ 0x1400179E0
 * Callers:
 *     AuthzBasepQuerySecurityAttributesToken @ 0x1400178A0 (AuthzBasepQuerySecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetSecurityAttributeValueCopyoutBufferSize @ 0x140017FE0 (AuthzBasepGetSecurityAttributeValueCopyoutBufferSize.c)
