/*
 * XREFs of PfSnGetPrefetchInstructions @ 0x140453D1C
 * Callers:
...
__int64 __fastcall PfSnGetPrefetchInstructions(__int64 a1, int a2, _QWORD *a3)
{
  ...
  RtlStringCbPrintfW(PoolWithTag, v9, L"%s\\%ws-%08X.%ws", word_14038D130, a1, *(_DWORD *)(a1 + 60), L"pf");
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)qword_14038D298, 0LL, 17LL) != 17 )
    ExfReleasePushLockShared((signed __int64 *)qword_14038D298);
  KeAbPostRelease((ULONG_PTR)qword_14038D298);
  KeLeaveCriticalRegion();
