/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x140281494
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x140281588 (EtwpDequeueBufferPendingCompressionFromQueue.c)
