/*
 * XREFs of EtwpUpdatePmcCounters @ 0x140749C90
 * Callers:
...
__int64 __fastcall EtwpUpdatePmcCounters(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a3 - 1 > 7 || *(_DWORD *)(a1 + 316) == 1 )
    return 3221225485LL;
  if ( *(_QWORD *)(a1 + 2152) || (result = EtwpAllocatePmcData(a1), !(_DWORD)result) )
  {
    v8 = *(_QWORD *)(a1 + 2152);
    if ( *(_DWORD *)(v8 + 44) )
    {
    ...
    else
    {
      ...
      for ( j = 0; j < v6; ++j )
      {
        v10 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD, __int64))off_140353510[0])(
                j,
                v8,
                a3,
                v8 + 8 * (j + 6LL));
      ...
      if ( v10 )
      {
        ...
        {
          ((void (__fastcall *)(_QWORD))off_140353520[0])(*(_QWORD *)(v8 + 8 * k + 48));
