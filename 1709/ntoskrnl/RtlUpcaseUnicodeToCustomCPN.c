/*
 * XREFs of RtlUpcaseUnicodeToCustomCPN @ 0x14071EF50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( CustomCP->DBCSCodePage )
  {
    ...
    if ( v7 )
    {
      ...
      do
      {
        ...
        v22 = DBCSOffsets[HIBYTE(v21)];
        if ( v22 )
          v23 = DBCSOffsets[(unsigned __int8)v21 + v22];
        else
          v23 = CustomCP->MultiByteTable[(unsigned __int8)v21];
        if ( v23 >= 0x61u )
        {
          if ( v23 > 0x7Au )
            v23 += *(_WORD *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * (v23 & 0xF)
                                                                           + 2
                                                                           * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((v23 >> 4) & 0xF) + 2 * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int64)v23 >> 8)]]];
          else
            v23 -= 32;
        }
  ...
  else
  {
    ...
    if ( v11 )
    {
      ...
      do
      {
        ...
        {
          if ( v15 > 0x7Au )
            v15 += *(_WORD *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * (v15 & 0xF)
                                                                           + 2
                                                                           * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((v15 >> 4) & 0xF) + 2 * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int64)v15 >> 8)]]];
          else
            v15 -= 32;
        }
        ++v13;
