/*
 * XREFs of PiDrvDbCreateNode @ 0x1405C6554
 * Callers:
...
LABEL_19:
  ...
  if ( appended >= 0 )
  {
    ...
    if ( appended >= 0 )
    {
      ...
      {
LABEL_13:
        v15 = (__int64 *)qword_140382688;
        if ( *(__int64 **)qword_140382688 != &PiDrvDbNodeList )
          __fastfail(3u);
        *(_QWORD *)(v8 + 8) = qword_140382688;
