/*
 * XREFs of McTemplateK0qz @ 0x14020097C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qz(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, int a4, const wchar_t *a5)
{
  ...
  if ( !a5 )
    v5 = L"NULL";
  v13 = v5;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, a2, 0LL, 3u, &v10);
}
