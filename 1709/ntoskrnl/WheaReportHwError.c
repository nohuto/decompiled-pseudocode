/*
 * XREFs of WheaReportHwError @ 0x1402890D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WheapApplyThresholdChecks @ 0x1402894C4 (WheapApplyThresholdChecks.c)
...
__int64 __fastcall WheaReportHwError(__int64 a1)
{
  ...
  *(_DWORD *)(v11 + 24) ^= ((unsigned __int8)*(_DWORD *)(v11 + 24) ^ (unsigned __int8)(*(_DWORD *)(a1 + 12) >> 2)) & 8;
  v15 = (*((__int64 (__fastcall **)(__int64, __int64, __int64, __int64, _QWORD))&unk_1403A2D90 + 6 * *(int *)(v10 + 40)))(
          v10 + 89,
          a1,
          v11 + 40,
          v14,
