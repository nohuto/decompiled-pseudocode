/*
 * XREFs of CreateNewEventEntry @ 0x1401217E4
 * Callers:
 *     InsertEventEntryInLookUpTable @ 0x1400BA53C (InsertEventEntryInLookUpTable.c)
 * Callees:
 *     CBufferGetNextOffset @ 0x140121A2C (CBufferGetNextOffset.c)
        ...
        __int64 *a7)
{
  ...
  char *v32; // rdx
  int v33; // eax
  PVOID v35; // [rsp+20h] [rbp-38h] BYREF
  ...
  *a7 = 0LL;
  ...
  if ( !v17 )
    return 3221225495LL;
  PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)(a1 != 0 ? PagedPool : NonPagedPoolNx), v12 + v16 + 46, 0x47417254u);
  v19 = PoolWithTag;
  if ( PoolWithTag )
