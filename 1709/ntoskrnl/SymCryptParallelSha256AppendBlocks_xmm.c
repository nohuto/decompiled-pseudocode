/*
 * XREFs of SymCryptParallelSha256AppendBlocks_xmm @ 0x140178AD0
 * Callers:
  ...
  *a4 = v12;
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      do
      {
        v49 = _mm_loadu_si128(v46 + 3);
        v50 = _mm_loadu_si128(v46 + 2);
        v51 = _mm_loadu_si128(v46 + 1);
        v52 = _mm_add_epi32(
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
  ...
  v68 = _mm_loadu_si128(a4 + 11);
  v69 = _mm_loadu_si128(a4 + 9);
