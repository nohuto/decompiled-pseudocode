/*
 * XREFs of PopVerifySystemPowerPolicy @ 0x1405B94B4
 * Callers:
...
__int64 __fastcall PopVerifySystemPowerPolicy(_OWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 224) = *((_QWORD *)v4 + 12);
  ...
  if ( *(_DWORD *)(a2 + 212) < (unsigned int)qword_140366230 )
    *(_DWORD *)(a2 + 212) = qword_140366230;
  if ( *(_DWORD *)(a2 + 212) > HIDWORD(qword_140366230) )
    *(_DWORD *)(a2 + 212) = HIDWORD(qword_140366230);
  ...
  PopVerifySystemPowerState(v6, 1LL);
  PopVerifySystemPowerState(v7, 1LL);
  v9 = (int *)(a2 + 76);
  ...
  {
    v12 = *v11;
    PopVerifyPowerActionPolicy(v10 - 12);
    if ( v12 == 3 && *v11 < 3 )
    {
      *v11 = 6;
      PopVerifyPowerActionPolicy(v11);
    }
    PopVerifySystemPowerState(v10, 1LL);
    if ( *v11 == 2 && v11[3] > 4 )
    {
      v11[3] = 4;
      PopVerifySystemPowerState(v10, 1LL);
