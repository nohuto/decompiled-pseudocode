/*
 * XREFs of KiDoubleFaultAbort @ 0x14018D440
 * Callers:
 *     KiDoubleFaultAbortShadow @ 0x140297500 (KiDoubleFaultAbortShadow.c)
 * Callees:
...
void __fastcall __noreturn KiDoubleFaultAbort(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v33 & 1) != 0 )
  {
    ...
    v14 = *(_QWORD *)&CurrentThread->Process[2].Spare2[7];
