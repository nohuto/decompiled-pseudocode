/*
 * XREFs of sub_140175620 @ 0x140175620
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_140175620(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v7 = (0x7010008004002001LL * v4) ^ ((v4 * (unsigned __int128)0x7010008004002001uLL) >> 64);
  v8 = 4;
  v9 = v7;
  v10 = (_QWORD *)(a2 + 24);
  do
  ...
  {
    v11 = *(_QWORD *)a2;
    v12 = (unsigned __int64)(*(_QWORD *)a2 ^ __ROL8__(*(_QWORD *)a2, 17)) * (unsigned __int128)0x7010008004002001uLL;
    v13 = 6;
    *((_QWORD *)&v12 + 1) ^= v12;
    v14 = (ULONG *)(*(_QWORD *)a2 + 40LL);
    v15 = *((_QWORD *)&v12 + 1) + v9;
    do
    {
      *(_QWORD *)v14 ^= v15;
    ...
    while ( v13 );
    v16 = ((unsigned __int64)(unsigned int)*(__int16 *)(v11 + 8) - 48) >> 3;
    if ( (_DWORD)v16 )
    {
      v17 = (_QWORD *)(v11 + 8 * ((int)v16 + 5LL));
      do
      {
        *v17 ^= v15;
