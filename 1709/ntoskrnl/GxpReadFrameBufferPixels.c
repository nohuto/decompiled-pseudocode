/*
 * XREFs of GxpReadFrameBufferPixels @ 0x1407CEA70
 * Callers:
...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, __int64 a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !(_BYTE)BgInternal )
    {
      ...
      v30[1] = *(_DWORD *)(a1 + 4);
      v30[3] = *(_DWORD *)(a1 + 12);
      v30[2] = xmmword_14035A150;
      v31 = *(_QWORD *)(a1 + 24);
      v12 = ((__int64 (__fastcall *)(_DWORD *, __int64, __int64))qword_14035A160)(v30, v2, v11);
      goto LABEL_19;
    }
    v13 = *(char **)(a1 + 24);
    v21 = (char *)qword_14035A160;
    if ( BYTE2(BgInternal) )
    {
      v18 = 0;
      HIDWORD(v35) = 0;
...
LABEL_30:
    ...
    {
      v14 = *(_DWORD *)a1;
      v15 = (char *)qword_14035A160 + v4 * (*(_DWORD *)v2 + v23 * *(_DWORD *)(v2 + 4));
      if ( !*(_DWORD *)a1 )
      {
LABEL_19:
