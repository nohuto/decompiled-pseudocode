/*
 * XREFs of LookupSidInTable @ 0x14057C5D8
 * Callers:
...
LABEL_6:
  v12 = 0;
  v13 = (PSID *)&unk_140356800;
  do
  {
    if ( !v25 )
    {
      Str2a = (wchar_t *)((char *)&unk_1403567F0 + 104 * v12 + 2);
...
LABEL_10:
  ...
  {
    v14 = v12;
    return (__int64)&unk_1403567F0 + 104 * v14;
  }
  if ( v10 && a6 && !a3 && v11 < 0x3F )
  {
    if ( v23 )
    {
      ...
      {
        v18 = 104LL * v11;
        v19 = *(void **)((char *)&unk_1403567F0 + v18 + 16);
        if ( v19 )
        {
          ...
          *a7 = v21;
          ...
          {
            _mm_lfence();
            memmove(v21, *(const void **)((char *)&unk_1403567F0 + v18 + 16), v20);
            v22 = RtlSubAuthorityCountSid(*(PSID *)((char *)&unk_1403567F0 + v18 + 16));
