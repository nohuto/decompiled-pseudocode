/*
 * XREFs of ViKeTryToAcquireSpinLockAtDpcLevelCommon @ 0x1407BA5E0
 * Callers:
 *     VerifierKeTryToAcquireSpinLockAtDpcLevel @ 0x1407B9AF0 (VerifierKeTryToAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeTryToAcquireSpinLockAtDpcLevelNoReboot @ 0x1407B9B50 (VerifierKeTryToAcquireSpinLockAtDpcLevelNoReboot.c)
 * Callees:
