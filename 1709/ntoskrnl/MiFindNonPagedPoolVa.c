/*
 * XREFs of MiFindNonPagedPoolVa @ 0x1400C193C
 * Callers:
...
unsigned __int64 __fastcall MiFindNonPagedPoolVa(int a1, __int64 a2, unsigned int a3, _DWORD *a4)
{
  ...
  v5 = a3;
  v8 = a1 & 0x200;
  v9 = (unsigned __int16 *)((char *)qword_140388508 + 2 * a3 * (unsigned __int16)KeNumberNodes);
  ...
  while ( 1 )
  {
    if ( v8 )
    {
      ...
      {
        *a4 = 0;
        return qword_140388510[25 * v5 + 20].Alignment + (v11 << 12);
      }
    }
