/*
 * XREFs of PopEstimateChargeTime @ 0x1406FECF4
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_140365930; (__int64 *)i != &qword_140365930; i = *(_QWORD *)i )
    {
      v7 = *(_DWORD *)(i + 64);
      if ( v7 != -1 )
      {
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_1402D1440, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
