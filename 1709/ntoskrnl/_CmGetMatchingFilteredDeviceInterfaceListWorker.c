/*
 * XREFs of _CmGetMatchingFilteredDeviceInterfaceListWorker @ 0x1405EC82C
 * Callers:
...
LABEL_8:
  ...
  else if ( v17 >= 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)v13 + 364) = a8;
      *((_DWORD *)v13 + 365) = 0;
      v19 = PnpCtxRegEnumKeyWithCallback(a1, (__int64)Handle, (__int64)CmDeviceClassesSubkeyCallback, (__int64)v13);
