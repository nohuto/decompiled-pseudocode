/*
 * XREFs of IopGetNetworkOpenInformation @ 0x1405F1B78
 * Callers:
...
__int64 __fastcall IopGetNetworkOpenInformation(struct _FILE_OBJECT *Object, __int64 a2)
{
  ...
  v4 = IopQueryXxxInformation(Object, 4, 40, 0, (__int64)v7, &v6, 1);
  if ( v4 >= 0 )
  {
    v4 = IopQueryXxxInformation(Object, 5, 24, 0, (__int64)v9, &v6, 1);
    if ( v4 >= 0 )
    {
      **(_QWORD **)(a2 + 104) = v7[0];
