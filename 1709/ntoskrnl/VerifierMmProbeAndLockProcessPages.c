/*
 * XREFs of VerifierMmProbeAndLockProcessPages @ 0x1407C48D0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall VerifierMmProbeAndLockProcessPages(
        ...
        unsigned int a4)
{
  ...
  if ( (MmVerifierData & 0x1000) != 0 )
    return ViTargetAddToCounter(retaddr, 152LL, 0xA0u, *(unsigned int *)(BugCheckParameter2 + 40));
  return result;
}
