/*
 * XREFs of PopFlushVolumeWorker @ 0x140436680
 * Callers:
...
void __fastcall PopFlushVolumeWorker(struct _KEVENT *StartContext)
{
  ...
  struct _OBJECT_NAME_INFORMATION ObjectNameInfo; // [rsp+B8h] [rbp-50h] BYREF
  ...
  while ( 1 )
  {
    ...
    *v4 = v3;
    *(_QWORD *)(v3 + 8) = v4;
    v5 = (_QWORD *)qword_140366078;
    if ( *(__int64 **)qword_140366078 != &PopVolumeDevices )
      __fastfail(3u);
    *v2 = &PopVolumeDevices;
    v2[1] = v5;
    *v5 = v2;
    qword_140366078 = (__int64)v2;
