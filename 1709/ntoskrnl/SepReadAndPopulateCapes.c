/*
 * XREFs of SepReadAndPopulateCapes @ 0x1405EB5EC
 * Callers:
...
__int64 __fastcall SepReadAndPopulateCapes(HANDLE KeyHandle, int a2, unsigned int *a3, PVOID *a4)
{
  ULONG *v4; // rdi
...
LABEL_2:
    ...
    v15 = a2 + 18;
    v16 = 56 * v11;
    v4 = (ULONG *)ExAllocatePoolWithTag(PagedPool, v15, 0x70536553u);
    if ( v4 )
    {
      v17 = 0;
      v41 = 0;
      while ( 1 )
      {
        ...
        if ( v10 < 0 )
          break;
        v26 = ZwQueryKey(Handle, KeyFullInformation, PoolWithTag, v7, &Length);
        v10 = v26;
        if ( v26 < 0 )
        {
        ...
        if ( v27 > v15 )
        {
          v4 = (ULONG *)SepRmCapPoolExpand(v4, v27);
          if ( !v4 )
            goto LABEL_35;
          v15 = v27;
        }
        v10 = ZwQueryValueKey(Handle, &CapeName, KeyValuePartialInformation, v4, v15, &Length);
        if ( v10 < 0 )
          break;
        v28 = v4[2] + ((v16 + 1) & 0xFFFFFFFE);
        v10 = ZwQueryValueKey(Handle, &CapePredicate, KeyValuePartialInformation, v4, v15, &Length);
        if ( v10 < 0 )
          break;
        v29 = v4[2] + v28;
        v10 = ZwQueryValueKey(Handle, &CapeSD, KeyValuePartialInformation, v4, v15, &Length);
        if ( v10 < 0 )
          break;
        v30 = v4[2] + ((v29 + 7) & 0xFFFFFFF8);
        v10 = ZwQueryValueKey(Handle, &CapeStagedSD, KeyValuePartialInformation, v4, v15, &Length);
        if ( v10 < 0 )
          break;
        v16 = v4[2] + ((v30 + 7) & 0xFFFFFFF8);
        ZwClose(Handle);
        Handle = 0LL;
        v17 = v41 + 1;
        v41 = v17;
        if ( v17 >= (unsigned int)v11 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( v10 < 0 )
              goto LABEL_10;
            v10 = ZwQueryValueKey(Handle, &CapeFlags, KeyValuePartialInformation, v4, v15, &Length);
            if ( v10 < 0 )
              goto LABEL_10;
            if ( v4[2] != 4 )
            {
            ...
            *((_DWORD *)v21 + 2) = v25;
            ...
            if ( &v32[v4[2]] > v43 )
              goto LABEL_67;
            *((_QWORD *)v21 + 3) = v32;
            memmove(v32, v4 + 3, v4[2]);
            v33 = v4[2];
            if ( !SeValidSecurityDescriptor(v4[2], *((PSECURITY_DESCRIPTOR *)v21 + 3)) )
              goto LABEL_63;
            v10 = ZwQueryValueKey(Handle, &CapeStagedSD, KeyValuePartialInformation, v4, v15, &Length);
            if ( v10 < 0 )
              goto LABEL_10;
            v34 = v4[2];
            v35 = (char *)((unsigned __int64)&v32[v33 + 7] & 0xFFFFFFFFFFFFFFF8uLL);
            if ( &v35[v34] > v43 )
            {
LABEL_67:
              v10 = -1073741789;
            ...
            {
              *((_QWORD *)v21 + 4) = v35;
              memmove(v35, v4 + 3, v4[2]);
              if ( !SeValidSecurityDescriptor(v4[2], *((PSECURITY_DESCRIPTOR *)v21 + 4)) )
              {
LABEL_63:
                v10 = -1073741703;
                goto LABEL_10;
