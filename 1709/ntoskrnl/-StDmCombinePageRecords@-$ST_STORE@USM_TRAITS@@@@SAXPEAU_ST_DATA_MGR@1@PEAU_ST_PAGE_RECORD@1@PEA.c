/*
 * XREFs of ?StDmCombinePageRecords@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_RECORD@1@PEAUSEARCH_RESULT@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@1@Z @ 0x14026C244
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCombinePageRecords(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4)
{
  ...
  *a2 = -1;
  ...
  ++*(_DWORD *)(a1 + 1896);
  v9 = *(_BYTE *)(a1 + 1905);
  if ( (v9 & 3) == 0 && *(_DWORD *)(a1 + 1896) > 0x400u )
  {
    v10 = *(_QWORD *)(a1 + 1912);
    *(_BYTE *)(a1 + 1905) = v9 & 0xFC | 1;
    ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(v10, 5LL, 30000LL, 4294967294LL);
  }
  v11 = *(_DWORD *)(a4 + 4);
  if ( (v11 & 0xFFFFF000) >= 0xFFFFF000 )
    NT_ASSERT("TargetPageRecord->RefCount < ((1 << 20) - 1)");
  result = (unsigned int)(v11 + 4096);
  *(_DWORD *)(a4 + 4) = v11 + 4096;
  return result;
}
