/*
 * XREFs of KiBoundFaultShadow @ 0x140297380
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiBoundFaultShadow(int a1, unsigned __int64 a2, int a3, int a4, char a5)
{
  ...
  if ( (v11.OffsetLow & 1) != 0 )
  {
    ...
    return KiBoundFault(a1, a2, a3, a4, a5);
  }
  else
  {
    _mm_lfence();
