/*
 * XREFs of LdrpArmProcessRelocation @ 0x140256244
 * Callers:
 *     LdrpThumbProcessRelocation @ 0x140256318 (LdrpThumbProcessRelocation.c)
 *     LdrProcessRelocationBlockLongLong @ 0x1405BE6E8 (LdrProcessRelocationBlockLongLong.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall LdrpArmProcessRelocation(_WORD *a1, __int64 a2, int a3)
{
  ...
  if ( (*a1 & 0xF000) == 0x5000 )
  {
    ...
    *(_DWORD *)(v3 + 4) = v6 & 0xFFF | *(_DWORD *)(v3 + 4) & 0xFFF0F000 | (16 * (v7 & 0xF000));
  }
  else
  {
    return 0;
