/*
 * XREFs of _woutput_s @ 0x140165C98
 * Callers:
 ...
 *     write_char_1 @ 0x1401665C4 (write_char_1.c)
 *     write_string_2 @ 0x140166614 (write_string_2.c)
 */
