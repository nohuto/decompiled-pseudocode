/*
 * XREFs of MiRemoveMdlPages @ 0x1406E09D0
 * Callers:
...
_DWORD *__fastcall MiRemoveMdlPages(char *P, unsigned int a2)
{
  ...
  if ( v2 <= (__int64 *)v5 )
  {
    do
    {
      if ( v12 || (v6 = *v2, *v2 != v11) )
      {
        if ( v8 )
        {
          if ( v7 < 0 || (v18 = MiRemovePhysicalMemory((struct _KPRCB *)v10, v8, HIWORD(a2) & 8), v7 = v18, v18 < 0) )
          {
  ...
  _InterlockedExchangeAdd64(&qword_1403893E0, -(__int64)v3);
  if ( v9 )
  {
    if ( v9 == v3 )
    {
