/*
 * XREFs of TtmiLogProximityBlockedRequest @ 0x1407123C8
 * Callers:
...
char __fastcall TtmiLogProximityBlockedRequest(char a1, int a2, int a3)
{
  ...
  {
    LOBYTE(v3) = TlgKeywordOn(&stru_1407F37A0, 1uLL);
    if ( (_BYTE)v3 )
    {
      ...
      v22 = 2;
      v25[0] = 4;
      LOBYTE(v3) = TlgWrite(&stru_1407F37A0, &unk_1402D3047, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v3;
}
