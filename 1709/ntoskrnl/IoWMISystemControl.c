/*
 * XREFs of IoWMISystemControl @ 0x14057070C
 * Callers:
 *     WmipSystemControl @ 0x1405706F0 (WmipSystemControl.c)
 * Callees:
 ...
 *     WmipFindGuid @ 0x140570F98 (WmipFindGuid.c)
...
LABEL_15:
              if ( v8 )
              {
                ...
                else
                {
                  ...
                  v14 = (char *)Parameters + v13;
                  v15 = LowPart - v13;
                }
                return (unsigned int)WmipQueryWmiDataBlock(v6, (int)a3, v7, 0, v8, p_OutboundQuota, v15, v14);
              }
              else
              {
            ...
            return (unsigned int)IoWMICompleteRequest(v39, v38, a3, 3221226133LL, 0);
          }
