/*
 * XREFs of PopFxRegisterComponentPerfStates @ 0x1406F8F24
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  unsigned __int64 v56; // [rsp+40h] [rbp-78h]
...
LABEL_8:
      ...
      v52 = PopPluginRegisterComponentPerfStates(v7, *(_DWORD *)(v9 + 16), (__int64)v11);
      if ( !v52 && (v8 & 1) == 0 )
      {
        v12 = -1073741822;
        goto LABEL_48;
      ...
      v58 = (*(unsigned int *)v11 * (unsigned __int128)0x20uLL) >> 64;
      ...
      if ( v15 >= 0xA0 )
      {
        ...
        if ( v19 + 8 >= v19 )
        {
          v59 = (v14 * (unsigned __int128)0x30u) >> 64;
            ...
            if ( (_DWORD)v14 )
            {
              ...
              do
              {
                if ( !*(v24 - 1) )
                {
                  v26 = *v24;
                  v25 = 16 * v26;
                  v60 = (*v24 * (unsigned __int128)0x10uLL) >> 64;
...
LABEL_41:
              ...
              v56 = v37;
              v61 = (v14 * (unsigned __int128)0x10uLL) >> 64;
                  ...
                  *(_DWORD *)&v40[v19] = *(_DWORD *)v11;
                  ...
                  if ( *(_DWORD *)v11 )
                  {
                    do
                    {
                      ...
                      v42 += 3;
                      ++v49;
                      v50 += (*((unsigned __int16 *)v51 + 4) >> 1) + 1;
                    }
                    while ( v49 < *(_DWORD *)v11 );
                    v6 = a6;
                  }
                  *((_QWORD *)v40 + 6) = &v40[v56];
                  *(_QWORD *)v40 = a2;
