/*
 * XREFs of KdSystemDebugControl @ 0x1406D6B20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KdpSysGetVersion @ 0x14079888C (KdpSysGetVersion.c)
        ...
        KPROCESSOR_MODE a7)
{
  ...
  P = 0LL;
  if ( (KdpBootedNodebug || KdPitchDebugger || !(_BYTE)KdDebuggerEnabled) && !BYTE1(KdDebuggerNotPresent) )
    return 3221225506LL;
  if ( a1 > 14 )
  {
    v19 = a1 - 15;
