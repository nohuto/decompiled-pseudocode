/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x140578AF4
 * Callers:
 *     EtwpAddLogHeader @ 0x14057866C (EtwpAddLogHeader.c)
 *     ExpRefreshTimeZoneInformation @ 0x1405C1FB4 (ExpRefreshTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x140722F50 (RtlQueryDynamicTimeZoneInformation.c)
 *     RtlQueryTimeZoneInformation @ 0x140722F70 (RtlQueryTimeZoneInformation.c)
 * Callees:
