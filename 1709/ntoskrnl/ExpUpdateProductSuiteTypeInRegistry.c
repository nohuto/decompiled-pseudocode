/*
 * XREFs of ExpUpdateProductSuiteTypeInRegistry @ 0x140839930
 * Callers:
...
NTSTATUS ExpUpdateProductSuiteTypeInRegistry()
{
  ...
  *(_DWORD *)((char *)&Data.Buffer + 2) = 0;
  ...
  result = (unsigned int)memset(v40, 0, 0x2F6uLL);
  ...
  RtlInitUnicodeString(&Data, v4);
  DataSize = 18;
LABEL_6:
  v6 = NtSetValueKey(v0, &DestinationString, 0, 1u, Data.Buffer, DataSize);
  if ( v6 < 0 )
  ...
  if ( ExVerifySuite(SmallBusiness) )
  {
    ...
    do
      ++v13;
    while ( aSmallBusiness[v13] );
    v14 = 2 * v13 + 2;
    if ( v14 < 0x2F6 )
    {
      memmove(v40, L"Small Business", v14);
      v7 = &v40[v14];
      v1 = 758 - v14;
    }
  }
  if ( ExVerifySuite(Enterprise) )
  {
    ...
    do
      ++v15;
    while ( aEnterprise[v15] );
    v16 = 2 * v15 + 2;
    if ( v1 > v16 )
    {
      memmove(v7, L"Enterprise", v16);
      v7 += v16;
      v1 -= v16;
    }
  }
  if ( ExVerifySuite(BackOffice) )
  {
    ...
    do
      ++v17;
    while ( aBackoffice[v17] );
    v18 = 2 * v17 + 2;
    if ( v1 > v18 )
    {
      memmove(v7, L"BackOffice", v18);
      v7 += v18;
      v1 -= v18;
    }
  }
  if ( ExVerifySuite(CommunicationServer) )
  {
    ...
    do
      ++v19;
    while ( aCommunications[v19] );
    v20 = 2 * v19 + 2;
    if ( v1 > v20 )
    {
      memmove(v7, L"CommunicationServer", v20);
      v7 += v20;
      v1 -= v20;
    }
  }
  ...
  if ( ExVerifySuite(SmallBusinessRestricted) )
  {
    ...
    do
      ++v21;
    while ( aSmallBusinessR[v21] );
    v22 = 2 * v21 + 2;
    if ( v1 > v22 )
    {
      memmove(v7, L"Small Business(Restricted)", v22);
      v7 += v22;
      v1 -= v22;
    }
  }
  if ( ExVerifySuite(EmbeddedNT) )
  {
    ...
    do
      ++v23;
    while ( aEmbeddednt[v23] );
    v24 = 2 * v23 + 2;
    if ( v1 > v24 )
    {
      memmove(v7, L"EmbeddedNT", v24);
      v7 += v24;
      v1 -= v24;
    }
  }
  if ( ExVerifySuite(DataCenter) )
  {
    ...
    do
      ++v10;
    while ( aDatacenter[v10] );
    v11 = 2 * v10 + 2;
    if ( v1 > v11 )
    {
      memmove(v7, L"DataCenter", v11);
      v7 += v11;
      v1 -= v11;
    }
  }
  ...
  result = NtSetValueKey(v0, &DestinationString, 0, 7u, v40, 760 - v1);
  if ( result < 0 )
