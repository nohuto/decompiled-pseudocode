/*
 * XREFs of PiDevCfgQueryIncludedDriverNode @ 0x1406C6DE8
 * Callers:
...
LABEL_39:
        ...
        *(_QWORD *)(v23 + 352) = v23 + 352;
        ...
        {
          *(_DWORD *)(v23 + 104) = a4;
          RegistryValue = IopGetRegistryValue(KeyHandle, L"IncludeScope", 0, &v34);
          v9 = v34;
          v11 = RegistryValue;
...
LABEL_68:
          ...
          if ( RegistryValue >= 0 )
          {
            if ( !PnpValidateRegistryMultiSz(v34) )
            {
              v11 = -1073741823;
              goto LABEL_69;
            }
            for ( i = (wchar_t *)((char *)v9 + v9[2]); ; i += v31 + 1 )
            {
              ...
              if ( !(_WORD)v24 )
                goto LABEL_68;
              v28 = *i - asc_1405F5890[0];
              if ( !v28 )
                v28 = i[1] - asc_1405F5890[1];
              if ( !v28 )
              {
                *(_DWORD *)(v23 + 104) = -1;
                goto LABEL_68;
