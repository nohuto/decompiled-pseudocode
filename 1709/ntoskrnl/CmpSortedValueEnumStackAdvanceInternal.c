/*
 * XREFs of CmpSortedValueEnumStackAdvanceInternal @ 0x14069BE80
 * Callers:
 *     CmpSortedValueEnumStackAdvance @ 0x14069BE50 (CmpSortedValueEnumStackAdvance.c)
 * Callees:
...
__int64 __fastcall CmpSortedValueEnumStackAdvanceInternal(__int16 *a1)
{
  ...
  for ( j = 0LL; v7 >= 0; --v7 )
  {
    ...
    if ( (unsigned int)v10 < *(_DWORD *)(v9 + 24) )
    {
      ...
      if ( v8 )
      {
        if ( CmpSortedValueEnumStackValueCompareFunction(&j, &v12) > 0 )
          v8 = v11;
        j = v8;
      }
      else
