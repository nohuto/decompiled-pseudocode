/*
 * XREFs of WdipSemAddScenarioToTable @ 0x1405AAE88
 * Callers:
  ...
  if ( a1 )
  {
    ...
    if ( dword_14035F380 )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v3 >= dword_14035F380 )
          goto LABEL_7;
      }
      v8 = WdipSemMergeScenarios(a1, WdipSemScenarioTable[v3]);
      v1 = v8;
      if ( v8 >= 0 )
      {
...
LABEL_7:
      if ( (unsigned int)dword_14035F380 >= 0x40 )
        ...
        WdipSemScenarioTable[dword_14035F380++] = a1;
    }
  }
  else
  {
