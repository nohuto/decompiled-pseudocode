/*
 * XREFs of ViThunkRecoverPristines @ 0x1407B659C
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1407B5D7C (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1407B6974 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1407B69E4 (ViThunkReplaceSpecialPristine.c)
 */
