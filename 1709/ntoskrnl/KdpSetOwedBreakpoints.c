/*
 * XREFs of KdpSetOwedBreakpoints @ 0x140799DAC
 * Callers:
...
void __fastcall KdpSetOwedBreakpoints(__int64 a1)
{
  ...
  if ( KdpOweBreakpoint )
  {
    ...
    while ( 1 )
    {
      ...
      v1 += 5;
      if ( (__int64)v1 >= (__int64)&unk_140372C48 )
        return;
    }
    v7 = KdEnterDebugger(0LL);
    KdpOweBreakpoint = 0;
    v8 = (unsigned __int8 *)&unk_140372765;
    do
    {
    ...
    while ( (__int64)v8 < (__int64)byte_140372C65 );
    KdExitDebugger(v7);
  }
}
