/*
 * XREFs of RtlSelfRelativeToAbsoluteSD @ 0x14057B850
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x140192C00 (memmove.c)
 *     RtlpQuerySecurityDescriptor @ 0x14057BDB0 (RtlpQuerySecurityDescriptor.c)
 */
        ...
        PULONG PrimaryGroupSize)
{
    ...
    && v27 <= *PrimaryGroupSize )
  {
    ...
    *((_QWORD *)AbsoluteSecurityDescriptor + 4) = 0LL;
    ...
    {
      v24 = Owner;
      memmove(Owner, v29, 4 * (unsigned int)*((unsigned __int8 *)v29 + 1) + 8);
      *((_QWORD *)AbsoluteSecurityDescriptor + 1) = v24;
    }
    if ( v30 )
    {
      v25 = PrimaryGroup;
      memmove(PrimaryGroup, v30, 4 * (unsigned int)*((unsigned __int8 *)v30 + 1) + 8);
