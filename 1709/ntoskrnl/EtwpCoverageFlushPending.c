/*
 * XREFs of EtwpCoverageFlushPending @ 0x14059C530
 * Callers:
...
int *__fastcall EtwpCoverageFlushPending(int **a1)
{
  ...
  if ( *((_DWORD *)a1 + 16) )
  {
    ...
    v9 = *((_WORD *)a1 + 32);
    if ( stru_140354BD0.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&stru_140354BD0, 0x400000000000uLL) )
      {
        v5 = *a1;
        v6 = *((_WORD *)v3 + 12);
        v10 = **a1;
        ...
        v25 = 4;
        v28 = 2;
        TlgWrite(&stru_140354BD0, &unk_1402D4118, 0LL, 0LL, 8u, &pData);
      }
    }
