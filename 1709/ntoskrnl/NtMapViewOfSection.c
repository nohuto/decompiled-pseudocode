/*
 * XREFs of NtMapViewOfSection @ 0x1404CF7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG AccessProtection)
{
  ...
  if ( (unsigned int)(InheritDisposition - 1) > 1 )
    return -1073741578;
  if ( (AllocationType & 0x9F2BDF80) != 0 )
    return -1073741577;
...
LABEL_43:
    ...
    v25 = *(_DWORD *)(v24 + 56);
    if ( (AllocationType & 0x840000) != 0 && (v25 & 0x20) == 0 )
    {
      v22 = -1073741577;
    }
    else if ( (v25 & 0x400) != 0 )
...
LABEL_36:
        ...
        if ( v26 >= 0 )
        {
          if ( (*(_DWORD *)(v24 + 56) & 0x20) != 0 && (v21[720] & 1) == 0 )
