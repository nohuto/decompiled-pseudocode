/*
 * XREFs of PpmInfoAdjustSetting @ 0x1404E00A8
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1404DEB98 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x140157BDC (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1404E0168 (PpmInfoWriteData.c)
 */
