/*
 * XREFs of IoGetDmaAdapter @ 0x140599080
 * Callers:
  ...
  if ( PhysicalDeviceObject )
  {
    ...
    if ( !DeviceNode || (DeviceNode[99] & 0x20000) != 0 )
    {
      ...
      if ( v13 )
      {
        ...
        IoAddTriageDumpDataBlock((int)v13, 728);
        if ( *v14 )
        {
    ...
    ((void (__fastcall *)(struct _KTHREAD *, PDEVICE_OBJECT))off_140353648[0])(
      KeGetCurrentThread(),
    ...
    ((void (__fastcall *)(struct _KTHREAD *, _QWORD))off_140353648[0])(KeGetCurrentThread(), 0LL);
  }
