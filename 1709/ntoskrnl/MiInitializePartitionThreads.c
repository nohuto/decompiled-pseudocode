/*
 * XREFs of MiInitializePartitionThreads @ 0x1406E2988
 * Callers:
...
__int64 __fastcall MiInitializePartitionThreads(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( !(_DWORD)v6 )
    {
      ...
      *(_QWORD *)(a1 + 5280) = ZeroThreadContext;
  ...
  if ( !(_DWORD)v6 )
  {
    MiDeleteZeroThreadContext(*(_QWORD *)(a1 + 5280));
    ExFreePoolWithTag(*(PVOID *)(a1 + 5280), 0);
    *(_QWORD *)(a1 + 5280) = 0LL;
  }
