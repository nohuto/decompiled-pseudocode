/*
 * XREFs of _CmGetDeviceRegPropWorker @ 0x14052263C
 * Callers:
 ...
 *     _MapCmDevicePropertyToNtProperty @ 0x1400DED8C (_MapCmDevicePropertyToNtProperty.c)
 ...
 *     RtlStringCbCopyNExW @ 0x14012677C (RtlStringCbCopyNExW.c)
  ...
  switch ( a4 )
  {
    case 8:
      ...
      if ( DeviceRegProp != -1073741789 )
      {
        ...
        v47 = 0;
        *a7 = cbDest;
        InstallerClassRegProp = CmGetInstallerClassRegProp(v29, (__int64)v46, 0LL, 8, a5, v12, a7);
        goto LABEL_43;
      }
      inited = -1073741595;
      goto LABEL_26;
...
LABEL_61:
  ...
  if ( (int)(InstallerClassRegProp + 0x80000000) >= 0 && InstallerClassRegProp != -1073741789 )
    goto LABEL_43;
  if ( (v25 = v40, v40 == 1) && cbDest_4 < 2 || v40 == 7 && cbDest_4 < 2 || v40 == 4 && cbDest_4 != 4 )
  {
LABEL_36:
    inited = -1073741275;
    goto LABEL_26;
