/*
 * XREFs of WheapWmiExecuteErrorInjectionMethod @ 0x14028A3AC
 * Callers:
 *     WheapWmiExecuteMethod @ 0x14028A884 (WheapWmiExecuteMethod.c)
 * Callees:
 *     <none>
 */
...
LABEL_10:
  ...
  if ( v7 == 1 )
  {
    ...
    if ( a2 >= 4 )
    {
      v9 = PshedInjectError(v10, v11, v13, *v14, v14[1]);
      if ( v9 >= 0 )
      {
        *a3 = 0;
        goto LABEL_14;
