/*
 * XREFs of EtwpApplyEventIdPayloadFilter @ 0x140280188
 * Callers:
        ...
        unsigned __int8 a9)
{
  ...
  if ( a9 < 2u )
  {
    ...
    __writecr8(2uLL);
    v14 = 96LL * a2;
    if ( *(_QWORD *)(*(_QWORD *)(a1 + 368) + v14 + 64) )
    {
...
LABEL_7:
    ...
    v12 = *(volatile signed __int32 **)(*(_QWORD *)(v11 + 368) + v14 + 72);
    if ( v12 )
      _InterlockedAdd(v12, 1u);
    goto LABEL_7;
  }
  v17 = 96LL * a2;
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 368) + v17 + 64) )
  {
  ...
  v12 = *(volatile signed __int32 **)(*(_QWORD *)(v11 + 368) + v17 + 72);
LABEL_13:
  if ( v12 )
  {
    LOBYTE(a4) = a8;
