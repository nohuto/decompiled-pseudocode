/*
 * XREFs of VslValidateSecureImagePages @ 0x140159BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VslValidateSecureImagePages(__int64 a1, int a2, unsigned __int64 a3, int a4, __int64 a5, char a6)
{
  NTSTATUS v6; // esi
  ...
  char v17[8]; // [rsp+90h] [rbp-70h] BYREF
  ...
  for ( i = a3; i; i -= v12 )
  {
    ...
    v13 = (v12 >> 12) + v11;
    v6 = VslpLockPagesForTransfer((unsigned int)v16, a4, v13 << 12, 0, 0);
    if ( v6 < 0 )
      break;
    v18 = a1;
    v20 = v16[0];
