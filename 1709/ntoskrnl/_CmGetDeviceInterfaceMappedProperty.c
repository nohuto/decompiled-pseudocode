/*
 * XREFs of _CmGetDeviceInterfaceMappedProperty @ 0x14051C784
 * Callers:
...
LABEL_6:
    ...
    return (unsigned int)CmGetDeviceInterfaceMappedPropertyFromComposite((int)a1, a2, a3, a5, a6, a7, a8, a9);
  }
  return DeviceInterfaceMappedPropertyFromRegValue;
}
