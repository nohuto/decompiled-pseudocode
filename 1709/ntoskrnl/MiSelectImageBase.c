/*
 * XREFs of MiSelectImageBase @ 0x140504474
 * Callers:
...
__int64 __fastcall MiSelectImageBase(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, unsigned __int64 *a5)
{
  ...
  *(_DWORD *)(v5 + 92) ^= (*(_DWORD *)(v5 + 92) ^ (v11 << 21)) & 0x600000;
  ...
  if ( a3 )
  {
    v22 = ((unsigned int)dword_140400168 >> 12) + v13 + ((dword_140400168 & 0xFFF) != 0);
...
LABEL_10:
    ...
    if ( v17 <= 0x7FFFFFFEFFFFLL )
    {
      ...
      v26 = v25 + v17;
      if ( v25 + v17 > v17 && v26 <= 0x7FFFFFFEFFFFLL )
      {
        ...
        if ( v27 + *(_QWORD *)(a1 + 40) )
        {
          ...
          {
            v20 = v27 + v17;
            if ( v27 + v17 >= v17 && v25 + v20 <= 0x7FFFFFFDFFFFLL && v25 + v20 >= v26 )
              goto LABEL_28;
            return 3221225595LL;
          }
          v20 = v17 - v27;
