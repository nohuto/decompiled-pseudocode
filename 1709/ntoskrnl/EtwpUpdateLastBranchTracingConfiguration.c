/*
 * XREFs of EtwpUpdateLastBranchTracingConfiguration @ 0x1407525C8
 * Callers:
  ...
  if ( EtwpLastBranchSupportedOptions )
  {
    ...
    else
    {
      if ( (*(_DWORD *)(a1 + 832) & 0x8000) != 0 )
        return 3221226243LL;
      if ( *(_QWORD *)(a1 + 2160) || (LbrData = EtwpAllocateLbrData(a1), LbrData >= 0) )
      {
        if ( **(_DWORD **)(a1 + 2160) )
        {
        ...
        {
          LbrData = ((__int64 (__fastcall *)(_QWORD))off_1403536F0[0])(v4);
          if ( LbrData >= 0 )
          {
            EtwpReferenceLastBranchLookasideList();
            *(_DWORD *)(*(_QWORD *)(a1 + 2160) + 4LL) = v4;
