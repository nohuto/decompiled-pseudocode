/*
 * XREFs of KiMarkBugCheckRegions @ 0x1401690CC
 * Callers:
...
__int64 __fastcall KiMarkBugCheckRegions(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v7; // esi
  __int64 v8; // r14
  unsigned int v9; // edi
  ...
  if ( qword_140359D18 )
  {
    KiMismatchSummary = qword_140359D18;
    IoAddTriageDumpDataBlock((int)&KiMismatchSummary, 8);
  }
  if ( (_DWORD)a4 == 257 && dword_140359D10 )
  {
    v8 = qword_140359D00;
    v9 = 0;
    do
      ...
      if ( MmIsAddressValid((PVOID)((v8 + v9) & 0xFFFFFFFFFFFFF000uLL)) )
      {
        ...
        do
        {
          ...
          else
          {
            ...
            if ( !(_DWORD)v12 )
              break;
            LODWORD(v11) = *(char *)v32[(unsigned int)v12] < 0;
          }
        }
        while ( (_DWORD)v12 );
        v14 = 4;
    ...
    while ( v9 < dword_140359D10 );
    dword_140359D10 = 4096;
  }
  v16 = &qword_140359D00;
  v17 = 2LL;
  v18 = &dword_140359D10;
    ...
    if ( MmIsAddressValid((PVOID)(a3 & 0xFFFFFFFFFFFFF000uLL)) )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          if ( !(_DWORD)v22 )
            break;
          LODWORD(v21) = *(char *)v33[(unsigned int)v22] < 0;
        }
      }
      while ( (_DWORD)v22 );
      v24 = 4;
    ...
    if ( MmIsAddressValid((PVOID)v19) )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          if ( !(_DWORD)v28 )
            goto LABEL_45;
          LODWORD(v27) = *(char *)v34[(unsigned int)v28] < 0;
        }
      }
      while ( (_DWORD)v28 );
      do
...
LABEL_45:
  ...
  result = sub_140176C50(a1, a2, a3, a4);
  if ( qword_140401088 )
    return IoAddTriageDumpDataBlock(qword_140401088, 2256);
  return result;
}
