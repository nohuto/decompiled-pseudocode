/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x1406EDB48
 * Callers:
        ...
        char a5)
{
  ...
  if ( (a5 & 4) == 0 )
    v8 = 2 * ((a5 & 1) == 0) + 1048673;
  v9 = 0LL;
  if ( !(unsigned int)MiAcquireNonPagedResources(v5, a3, a3, a4) )
    return 3221225626LL;
  while ( 1 )
  {
    v11 = a3 - v9;
    ...
    if ( v5 == &MiSystemPartition )
      _InterlockedExchangeAdd64(&qword_1403893E0, v12);
    v9 += v12;
    if ( v9 == a3 )
      goto LABEL_19;
    v6 = v34;
...
LABEL_19:
  ...
  if ( v9 != a3 )
  {
    while ( 1 )
    {
      ...
      if ( a3 - v9 > v19 )
        v20 = v19;
      PagesForMdl = MiAllocatePagesForMdl((__int64)v5, v17, 0xFFFFFFFFFFFFFFFFuLL, v18, v20 << 12, 1u, v34, v16);
