/*
 * XREFs of PpmEventDomainPerfStateChange @ 0x14015A7B4
 * Callers:
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v16 = 2LL * v11;
      *(&UserData.Ptr + v16) = a1 + 488;
      *((_QWORD *)&UserData.Size + v16) = 4LL;
      v17 = v11 + 1;
      v18 = v11 + 2;
      v17 *= 2LL;
      *(&UserData.Ptr + v17) = a1 + 496;
      *((_QWORD *)&UserData.Size + v17) = 4LL;
      v19 = 2LL * v18;
      *(&UserData.Ptr + v19) = a1 + 500;
      *((_QWORD *)&UserData.Size + v19) = 4LL;
      v20 = v18 + 1;
      v18 += 2;
      v20 *= 2LL;
      *(&UserData.Ptr + v20) = a1 + 504;
      v21 = *(unsigned __int8 *)(a1 + 516);
