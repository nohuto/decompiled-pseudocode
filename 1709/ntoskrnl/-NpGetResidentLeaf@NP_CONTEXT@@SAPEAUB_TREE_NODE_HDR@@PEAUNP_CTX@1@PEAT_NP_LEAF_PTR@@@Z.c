/*
 * XREFs of ?NpGetResidentLeaf@NP_CONTEXT@@SAPEAUB_TREE_NODE_HDR@@PEAUNP_CTX@1@PEAT_NP_LEAF_PTR@@@Z @ 0x1402645A8
 * Callers:
...
struct B_TREE_NODE_HDR *__fastcall NP_CONTEXT::NpGetResidentLeaf(struct NP_CONTEXT::NP_CTX *a1, union _NP_LEAF_PTR *a2)
{
  ...
  v2 = *(_DWORD *)a2;
  if ( (*(_DWORD *)a2 & 2) != 0 )
    *(_DWORD *)a2 = v2 ^ ((unsigned __int16)v2 ^ (unsigned __int16)(v2 + 4)) & 0xFFC;
  else
