/*
 * XREFs of ?WritePartitionTable@SC_GPT@@QEAAJPEAVSC_DISK_LAYOUT@@E@Z @ 0x140293524
 * Callers:
...
__int64 __fastcall SC_GPT::WritePartitionTable(SC_DISK **this, struct SC_DISK_LAYOUT *a2, char a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( *((_DWORD *)a2 + 10) > 0x80u )
      v7 = *((_DWORD *)a2 + 10);
    *((_DWORD *)a2 + 10) = ((unsigned int)~(*((_DWORD *)v4 + 41) - 1) >> 7) & ((unsigned int)((v7 << 7)
                                                                                            + *((_DWORD *)v4 + 41)
                                                                                            - 1) >> 7);
  }
  if ( !*((_DWORD *)a2 + 10) )
  {
    v8 = 0;
    v9 = *((_QWORD *)*this + 24);
    v10 = ((*((_DWORD *)*this + 32) & 1) == 0) + 1;
    if ( ((*((_DWORD *)*this + 32) & 1) == 0) != -1 )
    {
      while ( 1 )
      {
        Header = SC_GPT::ReadHeader(this, v8, (struct GPT_HEADER *)v9);
        if ( Header >= 0 )
          break;
        if ( ++v8 >= v10 )
    ...
    *((_DWORD *)a2 + 10) = *(_DWORD *)(v9 + 80);
  }
  v12 = *((_DWORD *)a2 + 10);
  if ( *((_DWORD *)a2 + 1) <= v12 )
  {
    v13 = *((_DWORD *)*this + 43);
    v14 = ~(*((_DWORD *)*this + 41) - 1) & (*((_DWORD *)*this + 41) + (v12 << 7) - 1);
    v15 = (2 << v13) + v14;
    v16 = v14 >> v13;
    v51 = v16;
    v17 = v15;
