/*
 * XREFs of RtlpLookupFunctionEntryForStackWalks @ 0x1400D83C0
 * Callers:
...
unsigned int *__fastcall RtlpLookupFunctionEntryForStackWalks(unsigned __int64 a1, __int64 a2)
{
  ...
  {
    v16 = RtlpLookupUserFunctionTable(a1, a2);
    goto LABEL_28;
  }
  if ( a1 < *(&xmmword_140418020 + 1) || a1 >= *(&xmmword_140418020 + 1) + (unsigned int)qword_140418030 )
  {
    v16 = (__int64)RtlpxLookupFunctionTable(a1, (__int64 *)a2);
LABEL_28:
    v5 = v16;
    goto LABEL_4;
  }
  *(_OWORD *)a2 = *(_OWORD *)&xmmword_140418020;
  *(_QWORD *)(a2 + 16) = qword_140418030;
  v5 = *(_QWORD *)a2;
LABEL_4:
  if ( v5 )
  {
