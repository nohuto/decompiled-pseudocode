/*
 * XREFs of McTemplateK0pqzzzzzzz @ 0x1401FEE90
 * Callers:
...
NTSTATUS McTemplateK0pqzzzzzzz(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  int v24; // edx
  struct _EVENT_DATA_DESCRIPTOR v26; // [rsp+30h] [rbp-99h] BYREF
  ...
  if ( !v62 )
    v23 = L"NULL";
  v49 = v23;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_DevQuery_QueryStart, a3, 0xAu, &v26);
}
