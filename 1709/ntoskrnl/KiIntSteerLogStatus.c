/*
 * XREFs of KiIntSteerLogStatus @ 0x14020BA1C
 * Callers:
 *     KiIntSteerEventTraceControlCallback @ 0x1405F2F70 (KiIntSteerEventTraceControlCallback.c)
 * Callees:
...
char __fastcall KiIntSteerLogStatus(char a1)
{
  ...
  {
    v11[1] = (unsigned __int16 *)qword_140401408[0];
