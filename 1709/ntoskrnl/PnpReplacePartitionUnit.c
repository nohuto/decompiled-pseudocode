/*
 * XREFs of PnpReplacePartitionUnit @ 0x1406CB3C0
 * Callers:
 ...
 *     PnprMmConstruct @ 0x1406CD688 (PnprMmConstruct.c)
...
LONG __fastcall PnpReplacePartitionUnit(_QWORD *a1)
{
  ...
  if ( *((int *)a1 + 4) >= 0 )
  {
    ...
    if ( v4 )
    {
        ...
        if ( *a1 )
        {
          ...
          if ( v14 )
          {
            ...
            if ( v13 )
              ...
              LODWORD(v16) = 0;
            IoAddTriageDumpDataBlock(v16, 728);
            if ( *(_WORD *)(v15 + 40) )
            {
      ...
      IoAddTriageDumpDataBlock(a1[1], *(unsigned __int16 *)(v4 + 2));
      v30 = *(_QWORD *)(a1[1] + 8LL);
      if ( v30 )
      {
      ...
      if ( v33 )
      {
        ...
        if ( v32 )
          ...
          LODWORD(v35) = 0;
        IoAddTriageDumpDataBlock(v35, 728);
        if ( *(_WORD *)(v34 + 40) )
        {
...
LABEL_114:
  ...
  if ( (unsigned __int8)PnprLegacyDeviceDriversPresent() )
  {
    ...
    v54 = 7;
LABEL_119:
    *(_DWORD *)(v52 + 20984) = v53;
    v55 = *(_DWORD *)(v52 + 20988);
    if ( !v55 )
      v55 = v54;
    *(_DWORD *)(v52 + 20988) = v55;
    goto LABEL_188;
  }
  ...
  {
    v56 = PnprContext;
    v57 = *(_DWORD *)(PnprContext + 20984);
    if ( !v57 )
      v57 = 223;
    *(_DWORD *)(PnprContext + 20984) = v57;
    v58 = *(_DWORD *)(v56 + 20988);
    if ( !v58 )
      v58 = 3;
    *(_DWORD *)(v56 + 20988) = v58;
    goto LABEL_188;
  }
  ...
  {
    v59 = PnprContext;
    v60 = *(_DWORD *)(PnprContext + 20984);
    if ( !v60 )
      v60 = 236;
    *(_DWORD *)(PnprContext + 20984) = v60;
    v61 = *(_DWORD *)(v59 + 20988);
    if ( !v61 )
      v61 = 1;
    goto LABEL_135;
  }
...
LABEL_138:
    ...
    {
      v65 = *(_DWORD *)(v9 + 20896);
      if ( (v65 & 1) == 0 || !*(_QWORD *)(v9 + 20928) )
      {
        v66 = 277;
        goto LABEL_164;
      }
      if ( (v65 & 2) != 0 && !*(_QWORD *)(v9 + 20936) )
      {
        v66 = 285;
LABEL_164:
        v71 = PnprContext;
        ...
        *(_DWORD *)(PnprContext + 20984) = v72;
        v73 = *(_DWORD *)(v71 + 20988);
        if ( !v73 )
          v73 = 9;
        *(_DWORD *)(v71 + 20988) = v73;
        goto LABEL_114;
      }
    ...
    *(_DWORD *)(v9 + 176) = v3;
    ...
    v59 = PnprContext;
    PluginDriver = -1073741621;
    v79 = *(_DWORD *)(PnprContext + 20984);
    if ( !v79 )
      v79 = 383;
    *(_DWORD *)(PnprContext + 20984) = v79;
    v61 = *(_DWORD *)(v59 + 20988);
    if ( !v61 )
      v61 = 6;
LABEL_135:
    *(_DWORD *)(v59 + 20988) = v61;
    goto LABEL_188;
  }
  v67 = 262;
LABEL_146:
  v68 = PnprContext;
  v3 = v89;
  v69 = *(_DWORD *)(PnprContext + 20984);
  if ( !v69 )
    v69 = v67;
  *(_DWORD *)(PnprContext + 20984) = v69;
  v70 = *(_DWORD *)(v68 + 20988);
  if ( !v70 )
    v70 = 1;
  *(_DWORD *)(v68 + 20988) = v70;
LABEL_188:
  if ( *((int *)a1 + 4) >= 0 )
  {
    if ( PluginDriver < 0 )
