/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromRegProp @ 0x140450944
 * Callers:
...
LABEL_27:
        ...
        if ( v10
          && v25 >= 2
          && ((unsigned __int8)PnpParseIndirectInfString(v10) || (unsigned __int8)PnpParseIndirectResourceString(v10)) )
        {
          *a5 = 25;
        }
        if ( PoolWithTag )
