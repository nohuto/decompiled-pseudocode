/*
 * XREFs of CmLogMcUpdateStatus @ 0x1401E3D98
 * Callers:
...
__int64 __fastcall CmLogMcUpdateStatus(ULONG Value, __int64 a2)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v4 < 0 )
    goto LABEL_17;
  ObjectAttributes.Length = 48;
  ObjectAttributes.ObjectName = (PUNICODE_STRING)&unk_1407F4E10;
  ObjectAttributes.RootDirectory = KeyHandle;
  ObjectAttributes.Attributes = 64;
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  v7 = NtOpenKey((PHANDLE)&v15, 0x20019u, &ObjectAttributes);
  v8 = *(void **)&v15.Length;
  v6 = v7;
  if ( v7 >= 0 )
  {
    RtlIntegerToChar(Value, 0xAu, 0xCu, String);
    RtlInitAnsiString(&v15, String);
    *(_DWORD *)&DestinationString.Length = 1572864;
    DestinationString.Buffer = (wchar_t *)&v19;
    RtlAnsiStringToUnicodeString(&DestinationString, &v15, 0);
    ObjectAttributes.Length = 48;
