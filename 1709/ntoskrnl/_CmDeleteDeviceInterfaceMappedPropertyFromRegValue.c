/*
 * XREFs of _CmDeleteDeviceInterfaceMappedPropertyFromRegValue @ 0x1407831E4
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterfaceMappedPropertyFromRegValue(__int64 *a1, __int64 a2, void *a3, __int64 a4)
{
  ...
  {
    if ( a3
      || (v5 = CmOpenDeviceInterfaceRegKey((__int64)a1, a2, 0x30u, (__int64)v12, 1, 0, (__int64)&Handle, 0LL), v5 >= 0) )
    {
      v15 = *(_DWORD *)(a4 + 16);
      if ( v15 != 2 )
        goto LABEL_42;
