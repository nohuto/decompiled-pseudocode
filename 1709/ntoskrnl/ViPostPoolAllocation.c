/*
 * XREFs of ViPostPoolAllocation @ 0x1407A67BC
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)(a1 + 16) = v10;
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v14 > *(_DWORD *)(v8 + 88) )
      *(_DWORD *)(v8 + 88) = v14;
    v15 = v10 + _InterlockedExchangeAdd64(&qword_14036A110, v10);
    if ( v15 > qword_14036A120 )
      qword_14036A120 = v15;
    v16 = _InterlockedIncrement(&dword_14036A100);
    if ( v16 > dword_14036A108 )
      dword_14036A108 = v16;
  }
  else
  {
    ...
    if ( v18 > *(_DWORD *)(v8 + 92) )
      *(_DWORD *)(v8 + 92) = v18;
    v19 = v10 + _InterlockedExchangeAdd64(&qword_14036A118, v10);
    if ( v19 > qword_14036A128 )
      qword_14036A128 = v19;
    v20 = _InterlockedIncrement(&dword_14036A104);
    if ( v20 > dword_14036A10C )
      dword_14036A10C = v20;
  }
  result = v2;
  *v12 = a1;
