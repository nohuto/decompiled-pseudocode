/*
 * XREFs of FsRtlPruneTunnelCache @ 0x140566074
 * Callers:
...
__int64 __fastcall FsRtlPruneTunnelCache(__int64 a1, __int64 a2)
{
  ...
  __int64 v6; // rbx
  _QWORD *v7; // rax
  struct _RTL_SPLAY_LINKS *v8; // rdx
  __int64 v9; // rax
  __int64 result; // rax
  ...
  while ( 1 )
  {
    ...
    if ( (_QWORD *)*v3 == v3 )
      break;
    v8 = (struct _RTL_SPLAY_LINKS *)(v7 - 3);
    v9 = v7[2];
    if ( v9 >= v6 && v9 <= v5 )
      break;
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)result <= TunnelMaxEntries )
      break;
    FsRtlRemoveNodeFromTunnel(a1, (struct _RTL_SPLAY_LINKS *)(*v3 - 24LL), a2, &v11);
  }
  return result;
}
