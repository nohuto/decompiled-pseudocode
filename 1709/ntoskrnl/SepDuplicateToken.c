        ...
        _QWORD *a8)
{
  ...
  _QWORD *v67; // [rsp+A0h] [rbp-48h]
  unsigned int *v68; // [rsp+A8h] [rbp-40h]
...
LABEL_41:
      ...
      *v52 = v51;
      ...
      RtlSidHashInitialize(*v32, *((_DWORD *)v21 + 31), (_QWORD *)v21 + 29);
      RtlSidHashInitialize(*v58, *v60, (_QWORD *)v21 + 63);
      if ( *v66 )
        RtlSidHashInitialize(*v66, *v68, v67);
