/*
 * XREFs of SmIssueIo @ 0x140275C98
 * Callers:
 *     ?StDeviceIoIssue@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z @ 0x14026B4C0 (-StDeviceIoIssue@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z.c)
 * Callees:
        ...
        unsigned __int64 a6)
{
  ...
  if ( v13 )
  {
    _InterlockedAdd((volatile signed __int32 *)(a1 + 6104), 1u);
    v9 = 1;
  }
  ...
  v20[0] = v16;
  v14 = SmKmIssueIo((struct _SMKM_FILE_INFO *)(a1 + 6216), (__int64)v20, v17, (void *)v6, (*(_DWORD *)a1 >> 13) & 1);
  if ( v14 >= 0 )
  {
    v7 = 0;
    v9 = 0;
