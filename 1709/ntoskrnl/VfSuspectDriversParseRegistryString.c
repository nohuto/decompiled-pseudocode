/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x14086CD1C
 * Callers:
 ...
 *     VfSuspectDriversInsert @ 0x1407BD618 (VfSuspectDriversInsert.c)
...
LABEL_28:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140361B58;
        if ( *(__int64 **)qword_140361B58 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140361B58 = (__int64)v10;
        goto LABEL_28;
      }
    }
    v4 = 0x100002601LL;
