/*
 * XREFs of MiCommitVadCfgBits @ 0x1404D1EE4
 * Callers:
...
__int64 __fastcall MiCommitVadCfgBits(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( MiIsProcessCfgEnabled() )
  {
    ...
    if ( v16 < 0 )
      return v18;
    v21 = *(_QWORD *)&KeGetCurrentThread()->ApcState.Process[1].IdealGlobalNode + 272LL;
    if ( v12 == v21 )
    {
      v21 = *(_QWORD *)&KeGetCurrentThread()->ApcState.Process[1].IdealGlobalNode + 296LL;
      if ( v9 > 0x100000000LL )
        return v18;
