/*
 * XREFs of KdLogDbgPrint @ 0x140798C80
 * Callers:
...
struct _KPRCB *__fastcall KdLogDbgPrint(unsigned __int16 *a1)
{
  ...
  if ( (struct _KPRCB *)qword_1403A37A8 == result )
  {
  ...
  if ( KdPrintCircularBuffer )
  {
    ...
    do
    {
      v7 = v4 + v6 - (unsigned int)KdPrintBufferSize;
      v8 = v6;
      if ( (unsigned __int64)v4 + v6 < (unsigned __int64)KdPrintCircularBuffer + (unsigned int)KdPrintBufferSize )
        v7 = v4 + v6;
