/*
 * XREFs of ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x140293C0C
 * Callers:
...
void __fastcall SC_MBR::Initialize(SC_MBR *this, struct SC_DISK *a2)
{
  ...
  *(_QWORD *)this = a2;
  ...
  if ( !v2 || v2 > 1024 )
    *((_QWORD *)a2 + 18) = 1024LL;
  if ( (unsigned int)(*(_DWORD *)(*(_QWORD *)this + 156LL) - 1) > 0xFE )
    *(_DWORD *)(*(_QWORD *)this + 156LL) = 255;
  if ( (unsigned int)(*(_DWORD *)(*(_QWORD *)this + 160LL) - 1) > 0x3E )
    *(_DWORD *)(*(_QWORD *)this + 160LL) = 63;
}
