/*
 * XREFs of PfSnOpenVolumesForPrefetch @ 0x1404412FC
 * Callers:
...
__int64 __fastcall PfSnOpenVolumesForPrefetch(__int64 *a1, _DWORD *a2)
{
  ...
  unsigned int v58; // [rsp+150h] [rbp+50h]
  int v59; // [rsp+150h] [rbp+50h]
  int cbDest; // [rsp+160h] [rbp+60h]
  size_t cbDesta; // [rsp+160h] [rbp+60h]
  ...
  *((_QWORD *)&v55[1] + 1) |= 0x200000000uLL;
  memset(v50, 0, sizeof(v50));
  LOBYTE(v4) = 1;
  v5 = *a1;
  v6 = *((_QWORD *)&v50[1] + 1) | 0x200000000LL;
  v7 = *a1;
          ...
          if ( *SourceString )
          {
            while ( 1 )
            {
              ...
              if ( IsVolumeMounted < 0 )
                v19 = 0;
              cbDest = v19;
              if ( v19 && !v63 && (int)PfSnQueryVolumeInfo(a1[1], v16, v55, &v52, &v51) >= 0 )
              {
              ...
              while ( 1 )
              {
                ...
                *(_QWORD *)(v29 + 96) = v27 + v30[7];
                ...
                do
                {
                  ...
                  v33 = v31;
                  v52 = (PVOID *)v31[8];
                  if ( (unsigned __int8)PfMetadataRecordIsEqual(v30, &v52, v32) )
                    break;
                  v31 = (PVOID *)*v31;
                }
                while ( v31 != &P );
                if ( v31 == &P )
                  goto LABEL_70;
                RtlStringCbPrintfW(v26, cbDesta, L"%s\\", v33[6]);
                v53 = 0;
                v34 = 0x7FFFLL;
                v54 = 0LL;
                v35 = v26;
...
LABEL_70:
                ...
                {
                  *(_OWORD *)(v29 + 32) = *(_OWORD *)v37;
                  *(_OWORD *)(v29 + 48) = *((_OWORD *)v37 + 1);
                  memset(v37, 0, 0x20uLL);
                  v38 = v50[0];
                  v37[3] |= 0x200000000uLL;
                  v39 = v50[1];
                  *(_OWORD *)(v29 + 64) = v38;
                  *(_OWORD *)(v29 + 80) = v39;
                  memset(v50, 0, sizeof(v50));
                  ...
                  *v40 = v29;
                  a1[6] = v29;
                  *(_DWORD *)(v29 + 108) ^= ((unsigned __int8)PfSnVolumeCheckSeekPenalty(v29 + 32, v41) ^ (unsigned __int8)*(_DWORD *)(v29 + 108)) & 1;
                ...
                v59 = v28;
                if ( (unsigned int)v28 >= *(_DWORD *)(v5 + 112) )
                  break;
                v27 = v64;
              }
            }
...
LABEL_44:
  ...
  while ( 1 )
  {
    ...
    if ( P == &P )
      break;
    if ( *((PVOID **)P + 1) != &P || (v43 = *(_QWORD *)P, *(PVOID *)(*(_QWORD *)P + 8LL) != P) )
      __fastfail(3u);
    P = *(PVOID *)P;
    *(_QWORD *)(v43 + 8) = &P;
    if ( (v42[5] & 0x400000000LL) != 0 )
      PfpOpenHandleClose(v42 + 2, a1[1]);
