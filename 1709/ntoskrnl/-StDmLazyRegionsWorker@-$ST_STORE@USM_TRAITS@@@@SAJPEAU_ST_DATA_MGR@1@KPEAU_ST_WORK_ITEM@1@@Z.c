/*
 * XREFs of ?StDmLazyRegionsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KPEAU_ST_WORK_ITEM@1@@Z @ 0x14026D694
 * Callers:
...
LABEL_28:
        ...
        v13 = v8;
        if ( (*(_WORD *)(*(_QWORD *)(a1 + 1032) + 2LL * v8) & 0x1FFF) != 0 )
          break;
        v14 = *(_QWORD *)(a1 + 800);
...
LABEL_29:
      ...
      {
        v20 = SmFpAllocate((PEX_SPIN_LOCK)(v18 + 6592), 0);
        v8 = v24;
        if ( v20 )
LABEL_25:
