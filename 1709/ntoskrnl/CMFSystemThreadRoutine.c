/*
 * XREFs of CMFSystemThreadRoutine @ 0x1407618F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CMFGetLargePageSectionSize @ 0x14076152C (CMFGetLargePageSectionSize.c)
...
void __fastcall CMFSystemThreadRoutine(__int64 a1)
{
  ...
  unsigned int v34; // [rsp+D8h] [rbp-30h] BYREF
        ...
        if ( *(_BYTE *)(a1 + 12) )
        {
          ...
          if ( v23 )
          {
            *((_DWORD *)PoolWithTag + 19) = 0;
            v9 = CMFReadCompressedSegment(FileHandle, (__int64)BaseAddress, LowPart, PoolWithTag);
            if ( v9 < 0 )
              goto LABEL_61;
          }
          else
