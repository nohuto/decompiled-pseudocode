/*
 * XREFs of PipGetRegistryDwordWithFallback @ 0x140576B28
 * Callers:
...
char __fastcall PipGetRegistryDwordWithFallback(int a1, __int64 a2, __int64 a3, __int64 a4, void *a5, _DWORD *a6)
{
  char v6; // bl
  ...
  if ( (int)CmGetDeviceRegProp(*(__int64 *)&PiPnpRtlCtx, a2, a3, a1, (__int64)&v11, (__int64)&v12, (__int64)&v10, 0) >= 0
    ...
    && v10 == 4
    || a5
    && (v10 = 4, (int)CmGetInstallerClassRegProp(*(__int64 *)&PiPnpRtlCtx, a4, a5, a1, &v11, &v12, &v10) >= 0)
    && v11 == 4
    && v10 == 4 )
  {
    v6 = 1;
