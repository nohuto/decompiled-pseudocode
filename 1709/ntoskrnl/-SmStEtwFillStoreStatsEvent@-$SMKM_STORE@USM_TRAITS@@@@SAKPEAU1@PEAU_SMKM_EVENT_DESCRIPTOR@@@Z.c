/*
 * XREFs of ?SmStEtwFillStoreStatsEvent@?$SMKM_STORE@USM_TRAITS@@@@SAKPEAU1@PEAU_SMKM_EVENT_DESCRIPTOR@@@Z @ 0x140275580
 * Callers:
 ...
 *     StLcBucketsCopy @ 0x140272684 (StLcBucketsCopy.c)
 */
