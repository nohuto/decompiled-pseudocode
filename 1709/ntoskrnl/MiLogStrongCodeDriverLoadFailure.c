/*
 * XREFs of MiLogStrongCodeDriverLoadFailure @ 0x1406E1B44
 * Callers:
  ...
  if ( hProvider )
  {
    if ( hProvider->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(hProvider, 0x400000000000uLL) )
      {
        ...
        v21 = 4;
        v24 = 4;
        TlgWriteEx(v5, &unk_1402D05FD, 0LL, 1u, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_DWORD *)(v8 + 44) = *(_DWORD *)(a2 + 156);
      v10 = (__int64 *)qword_1403883F0;
      if ( *(PVOID **)qword_1403883F0 != &qword_1403883E8 )
        __fastfail(3u);
      *(_QWORD *)v8 = &qword_1403883E8;
      *(_QWORD *)(v8 + 8) = v10;
      *v10 = v8;
      qword_1403883F0 = v8;
    }
