/*
 * XREFs of CmpFileReadEx @ 0x1400AF4A4
 * Callers:
 *     CmpFileRead @ 0x1404E3EE0 (CmpFileRead.c)
 * Callees:
...
LABEL_13:
  ...
  while ( 1 )
  {
    ...
    if ( IoStatusBlock.Information != Length )
    {
      ...
      CmRegistryIODebug = 1;
      dword_1407F3E58 = LODWORD(IoStatusBlock.Information) - Length;
      result = 3221225489LL;
      qword_1407F3E50 = (__int64)v7;
      return result;
    }
LABEL_12:
    v6 = v18;
