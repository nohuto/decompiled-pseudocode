/*
 * XREFs of IopInitializeDeviceInstanceKey @ 0x1405BA584
 * Callers:
...
__int64 __fastcall IopInitializeDeviceInstanceKey(HANDLE KeyHandle, PCUNICODE_STRING SourceString, __int64 a3)
{
  ...
  int Handle; // [rsp+44h] [rbp-1Ch] BYREF
...
LABEL_7:
  ...
  if ( DeviceInstancePath >= 0 )
  {
    ...
    if ( (unsigned int)PipAllocateDeviceNode((__int64)v13, &v32) == -1073740946 || (v14 = (char *)v32) == 0LL )
    {
      IoDeleteDevice(v12);
      DeviceInstancePath = -1073741670;
    }
...
LABEL_20:
              ...
              if ( ((*((_DWORD *)v14 + 99) & 0x2000) == 0 || *((_DWORD *)v14 + 101) != 22)
                ...
                && !(unsigned int)PnpIsDeviceInstanceEnabled(KeyHandle, v15, 1) )
              {
                PipClearDevNodeProblem((__int64)v14);
                PipSetDevNodeProblem((__int64)v14, 22, 0);
              }
              LOBYTE(v18) = 1;
              PpDeviceRegistration((__int64)v15, v18, (__int64)(v14 + 56), 0);
              PnpMapDeviceObjectToDeviceInstance(*((_QWORD *)v14 + 4), (__int64)v15);
              v32 = 0LL;
              if ( (int)PnpGetDeviceResourcesFromRegistry((__int64)v12, 0, 4, &v32, &Handle) >= 0 )
              {
                v27 = v32;
                if ( v32 )
                {
