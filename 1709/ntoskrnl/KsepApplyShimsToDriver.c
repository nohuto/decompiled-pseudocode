/*
 * XREFs of KsepApplyShimsToDriver @ 0x1405ECA70
 * Callers:
...
__int64 __fastcall KsepApplyShimsToDriver(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  __int64 v8; // rsi
  unsigned int v9; // edi
  void (__fastcall *v10)(__int64, _QWORD, _QWORD, _QWORD, _DWORD); // rax
  void *v11; // rcx
  __int64 v12; // rax
  __int64 v13; // rax
  __int64 v15; // rax
...
LABEL_16:
    ...
    LODWORD(KsepHistoryMessages[v13]) = 459420;
...
LABEL_15:
  ...
  dword_14036A2C4[2 * v15] = v9;
  KsepHistoryErrors[2 * v15] = 459377;
