/*
 * XREFs of KiSetFeatureBits @ 0x140427A44
 * Callers:
 ...
 *     KiDetectAccessBitErrata @ 0x14042847C (KiDetectAccessBitErrata.c)
 *     KiDetectCacheErrata @ 0x1404284EC (KiDetectCacheErrata.c)
...
char __fastcall KiSetFeatureBits(__int64 a1)
{
  ...
  unsigned int v143; // [rsp+30h] [rbp-78h]
  bool v144; // [rsp+38h] [rbp-70h]
  unsigned int v145; // [rsp+40h] [rbp-68h]
  int v146; // [rsp+44h] [rbp-64h]
...
LABEL_105:
  v89 = *(_BYTE *)(a1 + 141);
  if ( (unsigned __int8)(v89 - 1) > 2u || v51 < 0x80000008 )
  {
    if ( v89 == 1 )
  ...
  if ( (unsigned __int8)(v89 - 1) <= 1u && v58 >= 7 )
  {
    _RAX = 7LL;
    __asm { cpuid }
    v104 = v49 | 1;
    ...
    if ( (_RBX & 1) == 0 )
      v49 = v104;
    LOBYTE(_RAX) = v49;
    if ( (_RBX & 0x400) != 0 && (v146 & 0x20000) != 0 )
