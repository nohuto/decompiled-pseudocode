/*
 * XREFs of ExpOsProductCacheProviderHelper @ 0x1405DED04
 * Callers:
 ...
 *     ExpOsProductPfnCacheProvider @ 0x1405DECD0 (ExpOsProductPfnCacheProvider.c)
 *     ExpGetSubscriptionPfn @ 0x140757714 (ExpGetSubscriptionPfn.c)
 *     ExpOsProductContentIdCacheProvider @ 0x140757910 (ExpOsProductContentIdCacheProvider.c)
 * Callees:
        ...
        _BYTE *ResultLength)
{
  ...
  KeyHandle = 0LL;
  *ResultLength = 1;
  ValueKey = ZwOpenKey(&KeyHandle, 0x20019u, (POBJECT_ATTRIBUTES)&stru_14078DBC8);
  if ( ValueKey >= 0 )
  {
