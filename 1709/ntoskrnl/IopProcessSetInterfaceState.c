/*
 * XREFs of IopProcessSetInterfaceState @ 0x140556128
 * Callers:
...
__int64 __fastcall IopProcessSetInterfaceState(UNICODE_STRING *a1, char a2, void *a3)
{
  char v3; // al
  char v5; // r13
  PVOID v7; // r15
...
LABEL_36:
      ...
      if ( (_BYTE)NumberOfBytes )
        PiDmRemoveCacheReferenceForObject(3LL, (__int64)v9, a3);
      goto LABEL_42;
    }
LABEL_58:
    v8 = (unsigned int *)BugCheckParameter2;
