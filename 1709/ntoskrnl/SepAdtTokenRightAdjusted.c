/*
 * XREFs of SepAdtTokenRightAdjusted @ 0x14053A1CC
 * Callers:
 ...
 *     SepAdtAuditablePrivilege @ 0x14025EB98 (SepAdtAuditablePrivilege.c)
    ...
    if ( CurrentThreadProcess[1].ActiveProcessors.Bitmap[15] )
    {
      ...
      if ( (int)PsGetAllocatedFullProcessImageNameEx(CurrentThreadProcess, &P) >= 0 )
      {
        ...
        if ( a5 )
        {
          ...
          *PoolWithTag = a5;
          v19 = v33;
          v20 = (char *)((char *)PoolWithTag - v33);
          v21 = a5;
          do
          {
            *(_QWORD *)&v20[(_QWORD)v19 + 8] = *(_QWORD *)v19;
            *(_DWORD *)&v20[(_QWORD)v19 + 16] = *((_DWORD *)v19 + 2);
            v19 += 12;
            --v21;
          }
          while ( v21 );
