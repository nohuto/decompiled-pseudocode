/*
 * XREFs of _PnpGetGenericObjectList @ 0x1405ED3FC
 * Callers:
        ...
        _DWORD *a7)
{
  int v7; // edx
  int v8; // ecx
  char (__fastcall *v10)(__int64, const WCHAR *, __int64, __int64); // [rsp+20h] [rbp-28h] BYREF
  ...
  *a7 = 0;
  ...
  v12 = a5;
  v13 = a6;
  v7 = PnpCtxRegEnumKeyWithCallback(a1, a2, (__int64)PnpObjectListCallback, (__int64)&v10);
  if ( v7 >= 0 )
  {
    v8 = HIDWORD(v13);
    *a7 = HIDWORD(v13);
