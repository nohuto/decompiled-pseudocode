/*
 * XREFs of VerifierMmProbeAndLockPages @ 0x1407C47D0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall VerifierMmProbeAndLockPages(ULONG_PTR BugCheckParameter2, char a2, unsigned int a3)
{
