/*
 * XREFs of ExpPartitionInitialize @ 0x1405DDCC4
 * Callers:
...
LABEL_12:
        ...
        while ( 1 )
        {
          v10 = (char *)KeNodeBlock[v9];
          if ( v10 == (char *)&KiNodeInit + 320 * v9 )
            v10 = 0LL;
          ...
          *(_QWORD *)(v3[1] + 8LL * v9) = ExAllocatePoolWithTag(NonPagedPoolNx, 0x40uLL, 0x6C577845u);
          ...
          PoolInternal = ExpPartitionCreatePoolInternal((_DWORD)v3, 0, ExpMaximumKernelWorkerThreads, (_DWORD)v10, 0);
          if ( PoolInternal < 0 )
            goto LABEL_13;
          PoolInternal = ExpPartitionCreatePoolInternal((_DWORD)v3, 0, ExpMaximumKernelWorkerThreads, (_DWORD)v10, 1);
          if ( PoolInternal < 0 )
            goto LABEL_13;
