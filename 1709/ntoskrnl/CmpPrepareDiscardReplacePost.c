/*
 * XREFs of CmpPrepareDiscardReplacePost @ 0x140698100
 * Callers:
...
__int64 __fastcall CmpPrepareDiscardReplacePost(ULONG_PTR a1, __int64 a2)
{
  unsigned int v2; // ebx
  char v5; // si
  int v6; // edi
  ...
  v2 = 0;
  v10 = 0LL;
  v5 = CmpReferenceKeyControlBlock(a1);
  if ( v5 )
  {
