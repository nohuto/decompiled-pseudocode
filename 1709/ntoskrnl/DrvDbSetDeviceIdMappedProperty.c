/*
 * XREFs of DrvDbSetDeviceIdMappedProperty @ 0x140448F74
 * Callers:
...
__int64 __fastcall DrvDbSetDeviceIdMappedProperty(int a1, int a2, void *a3, __int64 a4, int a5, __int64 a6, ULONG a7)
{
  ...
  v17 = 5 * v13;
  v18 = &(&off_1402B5118)[5 * v13];
  if ( !v18 )
    return (unsigned int)-1073741802;
  v19 = a5;
  if ( a5 != *((_DWORD *)v18 + 2) && a5 )
    return (unsigned int)-1073741811;
  if ( a3 || (v20 = DrvDbOpenObjectRegKey(a1, 0, 5, a2, 3, 0, (__int64)&Handle, 0LL), v8 = Handle, v21 = v20, v20 >= 0) )
  {
    if ( *(_DWORD *)(a4 + 16) != 3 )
      goto LABEL_38;
