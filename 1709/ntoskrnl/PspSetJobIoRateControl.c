/*
 * XREFs of PspSetJobIoRateControl @ 0x1404454F8
 * Callers:
 *     NtSetInformationJobObject @ 0x140510C80 (NtSetInformationJobObject.c)
 * Callees:
 *     PspIoRateControlInfoIsAnySet @ 0x140007D88 (PspIoRateControlInfoIsAnySet.c)
...
__int64 __fastcall PspSetJobIoRateControl(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a2 + 36) & 1) != 0 )
  {
    PspLockRootJobExclusive(a1, CurrentThread, &v18);
...
LABEL_12:
    ...
    if ( *(_QWORD *)(a2 + 24) )
    {
      v3 = PspSetJobIoRateControlForVolume(a1, a2, (unsigned int)&v16, (unsigned int)&v17, (__int64)&v19);
      if ( v3 < 0 )
        goto LABEL_11;
    }
    else
...
LABEL_8:
      ...
      v3 = PspIoRateEntryActivate(a1 + 1384, a1, a2, &v16);
      if ( v3 < 0 )
      {
LABEL_11:
        PspLockRootJobExclusive(a1, CurrentThread, &v18);
