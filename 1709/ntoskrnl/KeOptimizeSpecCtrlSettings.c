/*
 * XREFs of KeOptimizeSpecCtrlSettings @ 0x14017B4B0
 * Callers:
 ...
 *     KiAddSpecCtrlSsbdBit @ 0x14017B784 (KiAddSpecCtrlSsbdBit.c)
...
LABEL_15:
  ...
  else if ( (KiFeatureSettings & 1) != 0 )
  {
    ...
    if ( v3 )
    {
      if ( (HvlpFlags & 2) != 0 && HvlIsCoreSharingPossible() && (a2 & 0x20) != 0 )
      {
  ...
  {
    v9 = BYTE2(KiSpeculationFeatures) & 0x3F | (BYTE2(KiSpeculationFeatures) | (HIWORD(KiSpeculationFeatures) >> 1)) & 0x40;
    ...
    if ( (v9 & 0x40) != 0 )
    {
      ...
      CurrentPrcb->BpbUserSpecCtrl = *v10;
    }
  }
  else
  {
