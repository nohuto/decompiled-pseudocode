/*
 * XREFs of IoDiskIoAttributionQuery @ 0x1400075A0
 * Callers:
 ...
 *     KeQueryUnbiasedInterruptTimePrecise @ 0x140101890 (KeQueryUnbiasedInterruptTimePrecise.c)
...
__int64 __fastcall IoDiskIoAttributionQuery(__int64 a1, _OWORD *a2, _OWORD *a3)
{
  ...
  IopRecordIoAttribution(a1, v11, 3LL);
  v6 = *(_OWORD *)(a1 + 104);
  *a2 = *(_OWORD *)(a1 + 88);
  v7 = *(_OWORD *)(a1 + 128);
  a2[1] = v6;
