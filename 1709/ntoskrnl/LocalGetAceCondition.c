/*
 * XREFs of LocalGetAceCondition @ 0x1407332A8
 * Callers:
        ...
        char a9)
{
  ...
  *a4 = 0;
  ...
  if ( v9 != 11 )
  {
    *a4 = *((unsigned __int16 *)a1 + 1) - RtlLengthSid(a2) - 8;
    goto LABEL_8;
  }
LABEL_7:
  v16 = *((_DWORD *)a1 + 2);
  *a4 = *((unsigned __int16 *)a1 + 1) - 16 * (v16 & 1) - 8 * (v16 & 2) - RtlLengthSid(a2) - 12;
LABEL_8:
  v17 = *a4;
  if ( *a4 )
  {
    ...
    if ( v9 == 18 )
      StringForRelativeAttribute = LocalGetStringForRelativeAttribute(v18, v17, a6, v19);
    else
