/*
 * XREFs of ?SmStEtwFillStoreEvent@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@PEAU_SMKM_EVENT_DESCRIPTOR@@@Z @ 0x1402751B0
 * Callers:
...
_QWORD *__fastcall SMKM_STORE<SM_TRAITS>::SmStEtwFillStoreEvent(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 24) += 8;
  ...
  if ( *(_BYTE *)(a1 + 6020) == 1 )
    v51 = *(_QWORD *)(*(_QWORD *)(a1 + 6224) + 24LL);
  else
    v51 = 0LL;
  v7 = v51;
  v51 = a1 + 80;
  ...
  *(_DWORD *)(a2 + 24) += 4;
  ...
  ST_STORE<SM_TRAITS>::StDmGetSpaceStats(a1 + 2016, &v52, &v54);
