/*
 * XREFs of sub_1407662F8 @ 0x1407662F8
 * Callers:
...
__int64 __fastcall sub_1407662F8(__int64 a1, __int64 a2, int a3, __int64 a4)
{
...
LABEL_19:
  ...
  if ( v9 < 0 )
    return (unsigned int)v9;
  v16 = qword_1407F3370 ? qword_1407F3370() : -1073741637;
  v9 = v16;
  if ( v16 < 0 )
    return (unsigned int)v9;
  v17 = *(_DWORD *)(a2 + 32);
