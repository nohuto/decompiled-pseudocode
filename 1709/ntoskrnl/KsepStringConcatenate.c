/*
 * XREFs of KsepStringConcatenate @ 0x140546278
 * Callers:
...
__int64 __fastcall KsepStringConcatenate(__int64 a1, _WORD *a2, _WORD *a3, int a4)
{
  ...
  if ( !a1 )
  {
    ...
    KsepHistoryErrors[2 * v18] = 197324;
  ...
  if ( !a2 )
  {
    ...
    KsepHistoryErrors[2 * v19] = 197325;
    if ( (KsepDebugFlag & 4) != 0 )
  ...
  if ( !a3 )
  {
    ...
    KsepHistoryErrors[2 * v20] = 197326;
    if ( (KsepDebugFlag & 4) != 0 )
  ...
  *(_QWORD *)(a1 + 8) = 0LL;
  ...
  if ( v13 - 1 > 0xFFFE )
    return 2147483653LL;
  Paged = KsepPoolAllocatePaged(v13);
  if ( !Paged )
    return 3221225495LL;
  *(_QWORD *)(a1 + 8) = Paged;
