/*
 * XREFs of WheaInitializeServices @ 0x1408520B4
 * Callers:
 *     InitBootProcessor @ 0x14082FD94 (InitBootProcessor.c)
 * Callees:
 *     WheapInitializeInUsePageOfflineNotifications @ 0x1405E5D48 (WheapInitializeInUsePageOfflineNotifications.c)
 */
...
__int64 *WheaInitializeServices()
{
  ...
  qword_1403A3028 = (__int64)&WheapPfaList;
