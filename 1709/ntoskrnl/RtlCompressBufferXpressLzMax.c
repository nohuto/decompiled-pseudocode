/*
 * XREFs of RtlCompressBufferXpressLzMax @ 0x14025908C
 * Callers:
        ...
        unsigned int a9)
{
  ...
  unsigned __int8 *v60; // [rsp+40h] [rbp-78h]
...
LABEL_17:
  ...
  while ( 1 )
  {
    if ( v18 >= v26 )
    {
      ...
      XpressCallback = RtlpMakeXpressCallback(v64, v25, v18, v24);
      v19 = v56;
      v24 = a6;
      v25 = v60;
      v57 = XpressCallback;
    ...
    v33 = *(_DWORD *)v18;
    v34 = *(unsigned __int8 **)&v24[8 * ((v31 + v30) & 0x3FFF) + 0x40000];
    if ( (unsigned __int64)v34 >= v30 )
    {
      ...
      if ( (v35 & 0xFFFFFF) == 0 )
        goto LABEL_36;
      v34 = *(unsigned __int8 **)&v24[8 * ((unsigned __int64)&v34[-a1] & 0x3FFF) + 0x40000];
      if ( (unsigned __int64)v34 >= v30 )
      {
        v36 = v33 ^ *(_DWORD *)v34;
        if ( !v36 )
...
LABEL_66:
  ...
  {
LABEL_74:
    v34 = *(unsigned __int8 **)&v39[8 * ((unsigned __int64)&v34[-v38] & 0x3FFF) + 0x40000];
    if ( (unsigned __int64)v34 < v30 )
      break;
    if ( v33 == *(_DWORD *)v34 )
      goto LABEL_38;
