        ...
        _QWORD *a7)
{
  ...
  _QWORD *v48; // [rsp+A0h] [rbp-60h]
  __int64 v49[3]; // [rsp+A8h] [rbp-58h] BYREF
  char v50; // [rsp+C6h] [rbp-3Ah]
  ...
  *(_QWORD *)Revision = a3;
  ...
  if ( SecurityDescriptor != v47 )
  {
    ...
    ObpReleaseLookupContext((__int64)v49);
...
LABEL_51:
      ObpDeleteDirectoryEntry(v49, v19, v20);
      ObpReleaseLookupContext((__int64)v49);
LABEL_44:
      ObpDecrementHandleCount(BugCheckParameter1);
      return (unsigned int)v15;
  ...
  if ( SecurityDescriptor )
    ObReleaseObjectSecurity(SecurityDescriptor, MemoryAllocated[0]);
  ObpDeleteDirectoryEntry(v49, v28, v30);
  ObpReleaseLookupContext((__int64)v49);
  ObpDecrementHandleCount(BugCheckParameter1);
