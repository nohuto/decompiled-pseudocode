/*
 * XREFs of EtwpAllocateEventNameFilter @ 0x140750064
 * Callers:
...
__int64 __fastcall EtwpAllocateEventNameFilter(_DWORD *a1, _QWORD *a2)
{
  ...
  if ( v2 < 0x18 )
    return 3221225485LL;
  v5 = *(_QWORD *)a1;
  v6 = *(unsigned __int16 *)(*(_QWORD *)a1 + 18LL);
  ...
  if ( (unsigned int)v7 < 2 * v6 )
    return 3221225485LL;
  v8 = 24 * v6;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v8 + v7 + 40, 0x46777445u);
  if ( !PoolWithTag )
    return 3221225495LL;
  ...
  *((_QWORD *)PoolWithTag + 2) = *(_QWORD *)(v5 + 8);
  ...
  v37 = PoolWithTag + 40;
  v39 = v13;
  memmove(v13, (const void *)(v5 + 20), (unsigned int)v7);
  ...
  if ( v6 )
  {
    ...
    while ( 1 )
    {
      if ( v14 >= v15 )
        goto LABEL_43;
      v16 = &v13[v14];
      v17 = v16 ? strnlen(v16, (unsigned int)v7 - v14) : 0;
      v18 = v17 + 1;
      if ( v17 + 1 > (unsigned int)v7 - v14 || v17 == -1 )
        goto LABEL_43;
      v19 = v17;
