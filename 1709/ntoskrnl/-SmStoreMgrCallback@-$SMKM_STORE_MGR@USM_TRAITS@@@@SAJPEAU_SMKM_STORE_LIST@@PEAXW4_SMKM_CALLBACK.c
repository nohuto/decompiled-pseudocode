/*
 * XREFs of ?SmStoreMgrCallback@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SMKM_STORE_LIST@@PEAXW4_SMKM_CALLBACK_TYPE@@@Z @ 0x1400041F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmStoreMgrCallback(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  result = 0LL;
  if ( *(_QWORD *)(a1 + 1832) )
    return (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(a1 + 1832))(a1, a2, a3);
  return result;
}
