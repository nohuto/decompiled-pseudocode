/*
 * XREFs of CmpLightWeightCommitDeleteKeyUoW @ 0x14069EE20
 * Callers:
...
void __fastcall CmpLightWeightCommitDeleteKeyUoW(__int64 a1, _QWORD *a2)
{
  ...
  if ( (int)CmpFreeKeyByCell(v6, *(_DWORD *)(v5 + 32), 0) < 0
    && stru_1403549F0.LevelPlus1 > 5
    && TlgKeywordOn(&stru_1403549F0, 0x200000000000uLL) )
  {
    v20 = 0;
    v18 = &v14;
    v14 = v7;
    v19 = 4;
    TlgWrite(&stru_1403549F0, &unk_1402CF100, 0LL, 0LL, 3u, &pData);
  }
