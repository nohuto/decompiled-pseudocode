/*
 * XREFs of MiLogOutswappedProcessCommitReacquire @ 0x140212208
 * Callers:
  ...
  if ( hProvider )
  {
    if ( a3 )
    {
      if ( a4 )
      {
        if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 4uLL) )
        {
          ...
          v24 = v10;
          v27 = 8;
          TlgWriteEx(v12, &unk_1402D0406, v11, v10, v17, v18, 5u, &pData);
        }
      }
      else if ( hProvider->LevelPlus1 > 5 && TlgKeywordOn(hProvider, 4uLL) )
      {
        ...
        v24 = v14;
        v27 = 8;
        TlgWriteEx(v16, &unk_1402D0362, v15, v14, v17, v18, 5u, &pData);
      }
    }
    else if ( hProvider->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(hProvider, 4uLL) )
      {
        ...
        v24 = v6;
        v27 = 8;
        TlgWriteEx(v8, &unk_1402D03B6, v7, v6, v17, v18, 5u, &pData);
      }
    }
  }
}
