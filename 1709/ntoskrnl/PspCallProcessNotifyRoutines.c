/*
 * XREFs of PspCallProcessNotifyRoutines @ 0x1404D265C
 * Callers:
...
LABEL_17:
  if ( (PspNotifyEnableMask & 2) != 0 || (_BYTE)v10 )
  {
      ...
      if ( v19 )
      {
        ...
        if ( !v30 || (v22 & 4) != 0 )
        {
          if ( (v22 & 2) != 0 )
          {
            if ( (_BYTE)v10 )
            {
              v27 = (void (__fastcall *)(_QWORD *, _QWORD, __int64 *))ExGetCallBackBlockRoutine(v23);
              v27(a1, a1[92], v17);
            }
          }
          else
    ...
    v9 = *((_DWORD *)v17 + 16);
    PsTerminateProcess(a1, (unsigned int)v26);
LABEL_21:
    ExtensionTable = v29;
  }
