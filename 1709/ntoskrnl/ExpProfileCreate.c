/*
 * XREFs of ExpProfileCreate @ 0x140760250
 * Callers:
 *     NtCreateProfile @ 0x140760898 (NtCreateProfile.c)
 *     NtCreateProfileEx @ 0x140760974 (NtCreateProfileEx.c)
 * Callees:
        ...
        char a11)
{
  ...
  v32 = a8;
  v25 = 0;
  if ( ((int (__fastcall *)(__int64, __int64, int *, int *))off_140354F48[0])(1LL, 24LL, &v32, &v25) < 0
    || v25 != 24
    || !v33 )
  {
    return 3221225659LL;
  ...
  v36 = 0LL;
  v38 = 0LL;
  inserted = ObCreateObjectEx(0, ExProfileObjectType, (__int64)&v34, PreviousMode, v24, 240, 0, 488, &v30, 0LL);
  if ( inserted < 0 )
  {
    if ( Object )
  ...
  else
  {
    ...
    *((_DWORD *)v23 + 17) = a8;
    ...
    inserted = ObInsertObjectEx(v23, 0LL, 1u, 0, 0, 0LL, (unsigned __int64 *)&v31);
