/*
 * XREFs of _output_s @ 0x140165030
 * Callers:
...
__int64 __fastcall output_s(__int64 a1, char *a2, int *a3)
{
  ...
  do
  {
    ...
    if ( (unsigned __int8)(v11 - 32) <= 0x58u )
      v4 = _lookuptable_s[v11 - 32] & 0xF;
    v15 = v13 + 8 * v4 + v4;
    v16 = (unsigned int)v15;
    v17 = _lookuptable_s[v15];
    v4 = 0;
    v13 = v17 >> 4;
    v51 = v13;
    if ( v13 == 8 )
...
LABEL_114:
                      ...
                      {
                        LOBYTE(v19) = 32;
                        write_multi_char_0(v19, v35, v54, &v48);
                        v34 = v44;
                      }
                      write_string_1(v46, v34, v54, &v48);
                      v37 = v54;
                      if ( (v6 & 0xC) == 8 )
                      {
                        LOBYTE(v36) = 48;
                        write_multi_char_0(v36, v35, v54, &v48);
                      }
                      if ( v50 && (int)v12 > 0 )
                      {
                        ...
                        while ( 1 )
                        {
                          v40 = *v38++;
                          --v39;
                          if ( (unsigned int)safecrt_wctomb_s(&v55, v60, 6LL, v40) || !v55 )
                            break;
                          write_string_1(v60, v55, v54, &v48);
                          v4 = 0;
                          if ( !v39 )
                          {
                            a2 = v56;
                      ...
                      {
                        write_string_1(v14, (unsigned int)v12, v37, &v48);
                      }
                      v4 = 0;
LABEL_129:
                      if ( v48 >= 0 && (v6 & 4) != 0 )
                      {
                        LOBYTE(v41) = 32;
                        write_multi_char_0(v41, v35, v54, &v48);
                        v9 = v44;
                        goto LABEL_132;
                      }
                      v9 = v44;
...
LABEL_50:
                  ...
                  if ( (v6 & 0x810) != 0 )
                  {
                    v24 = safecrt_wctomb_s(&v47, v57, 512LL, *((unsigned __int16 *)a3 - 4));
                    LODWORD(v12) = v47;
                    v4 = 0;
                    v8 = v45;
                    if ( v24 )
