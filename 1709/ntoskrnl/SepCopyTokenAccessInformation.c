/*
 * XREFs of SepCopyTokenAccessInformation @ 0x14045C51C
 * Callers:
        ...
        unsigned __int8 *a15)
{
  ...
  *(_QWORD *)(a2 + 64) = v27;
  ...
  {
    v31 = v30;
    memmove(v30, *(const void **)(a1 + 784), 4 * (unsigned int)*(unsigned __int8 *)(*(_QWORD *)(a1 + 784) + 1LL) + 8);
  }
  v32 = a15;
  *(_QWORD *)(a2 + 56) = v31;
  if ( !a14 )
  ...
  {
    v21 = v33;
    memmove(v33, v32, 4 * (unsigned int)v32[1] + 8);
  }
  v34 = &v33[a12];
  *(_QWORD *)(a2 + 72) = v21;
