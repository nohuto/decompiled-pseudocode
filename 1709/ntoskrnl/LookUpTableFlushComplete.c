/*
 * XREFs of LookUpTableFlushComplete @ 0x1404F06DC
 * Callers:
 ...
 *     UpdateInternalStatsOnFlush @ 0x1404F09E8 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( stru_140354C10.LevelPlus1 > 5 && TlgKeywordOn(&stru_140354C10, 0x400000000000uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite(&stru_140354C10, &unk_1402D4FD4, 0LL, 0LL, 0xBu, &pData);
      }
