/*
 * XREFs of IopGetSetStreamIdentifier @ 0x1401FA004
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x1401F9210 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x1401F9500 (IoGetSfioStreamIdentifier.c)
 * Callees:
...
__int64 __fastcall IopGetSetStreamIdentifier(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4, char a5)
{
  ...
  v5 = a2;
  result = IopGetSetSpecificExtension(a1, 4, 0x10u, a5, &v20, v21);
  v10 = 0;
  if ( (int)result < 0 )
    goto LABEL_12;
  v11 = v20;
