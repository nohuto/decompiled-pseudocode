/*
 * XREFs of ExInitializePoolDescriptor @ 0x1405B73F8
 * Callers:
...
void __fastcall ExInitializePoolDescriptor(__int64 a1, int a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 192) = a3;
  ...
  {
    ExpSessionPoolLookaside = qword_1403884B8 + 256;
    ExpSessionPoolTrackTable = qword_1403884B8 + 0x2000;
    v5 = 146LL;
    if ( _BitScanReverse64((unsigned __int64 *)&v7, 0x92uLL) )
      v5 = 1LL << v7;
