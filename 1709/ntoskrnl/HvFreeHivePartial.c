/*
 * XREFs of HvFreeHivePartial @ 0x140565630
 * Callers:
...
__int64 __fastcall HvFreeHivePartial(ULONG_PTR BugCheckParameter2, unsigned int a2, int a3)
{
  ...
  if ( a2 != (_DWORD)result )
  {
      ...
      if ( FreeBin )
      {
        if ( (*(_DWORD *)(FreeBin + 24) & 1) != 0 )
          HvpFreeBin(
            ...
            *(_DWORD *)(FreeBin + 16),
            a3,
            *(_QWORD *)(v13 + 8) & 0xFFFFFFFFFFFFFFF0uLL,
            *(_QWORD *)(v13 + 16) & 0xFFFFFFFFFFFFFFF0uLL);
        else
          CmpReleaseGlobalQuota(*(_DWORD *)(FreeBin + 16));
        v15 = (_QWORD *)*v14;
        if ( *(_QWORD **)(*v14 + 8LL) != v14 || (v16 = (void **)v14[1], *v16 != v14) )
          __fastfail(3u);
        *v16 = v15;
        v15[1] = v16;
        v7 += *((_DWORD *)v14 + 4);
        CmpReleaseGlobalQuota(0x20u);
    ...
    if ( !a3 )
      CmpUpdateSystemHiveHysteresis(BugCheckParameter2, a2 & 0x7FFFFFFF, *(_DWORD *)(v5 + BugCheckParameter2 + 1400));
