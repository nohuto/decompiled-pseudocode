/*
 * XREFs of PiDqPropertyCallback @ 0x14052D3D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
      ...
      if ( !*(_QWORD *)a1 )
      {
        PnpObjectType = PiDqGetPnpObjectType(
                          *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 24LL) + 16LL),
                          ...
                          a3,
                          *(_QWORD *)(a1 + 40) + 32LL);
        v9 = PiDqOpenObjectRegKey(1, *(_QWORD *)(a1 + 32), PnpObjectType, 1, 0, v19, (_QWORD *)a1);
        if ( v9 == -1073741772 )
        {
          *(_QWORD *)a1 = -1LL;
          v9 = 0;
    ...
    {
      v13 = PiDqGetPnpObjectType(*(unsigned int *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 24LL) + 16LL), a2, a3, a4);
    }
    if ( (v9 & 0x80000000) != 0 )
      return v9;
...
LABEL_30:
  ...
  while ( 1 )
  {
    ...
    {
      v16 = *(_QWORD *)v7 - *(_QWORD *)((char *)a3 + a2);
      if ( *(_QWORD *)v7 == *(_QWORD *)((char *)a3 + a2) )
        v16 = *(_QWORD *)(v7 + 8) - *(_QWORD *)((char *)a3 + a2 + 8);
      if ( !v16 && *(_DWORD *)(v7 + 20) == *(_DWORD *)((char *)a3 + a2 + 20) )
      {
        v17 = *(const wchar_t **)(v7 + 24);
        a2 = *(_QWORD *)((char *)a3 + a2 + 24);
        if ( v17 == (const wchar_t *)a2 || v17 && a2 && !wcsicmp(v17, (const wchar_t *)a2) )
          break;
      }
    }
    if ( ++v11 >= *(_DWORD *)(a1 + 24) )
