/*
 * XREFs of PpmWmiGetAllData @ 0x140707568
 * Callers:
    ...
    *(_DWORD *)(a4 + 60) = v18;
    ...
    if ( v27 || !v16 )
    {
      ...
      if ( v28 || !*a1 )
      {
        ...
        if ( !v34 && v16 )
          PpmPerfGetCurrentState(v36, v25, 0LL, v25 + 2, v25 + 1, 0LL);
      }
      else
      {
    ...
    else
    {
      ...
      *((_BYTE *)v25 + 29) = *(_BYTE *)(v16 + 353);
      v25[8] = *(_DWORD *)(2688LL * dword_1403661AC + PpmCurrentProfile + 60);
