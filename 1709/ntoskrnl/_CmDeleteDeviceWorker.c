/*
 * XREFs of _CmDeleteDeviceWorker @ 0x14077F7C4
 * Callers:
...
LABEL_10:
            ...
            PoolWithTag = ExAllocatePoolWithTag(PagedPool, v12, 0x52504E50u);
            if ( !PoolWithTag )
              break;
            v5 = v33;
          }
...
LABEL_19:
          ...
          for ( j = 0; ; j = v34 )
          {
            ...
            if ( MatchingDeviceList != -1073741789 )
              goto LABEL_34;
            if ( 2 * (unsigned __int64)v34 > 0xFFFFFFFF )
            {
            ...
            v38 = ExAllocatePoolWithTag(PagedPool, v17, 0x52504E50u);
            v7 = v38;
            if ( !v38 )
              break;
          }
          ...
          if ( v9 >= 0 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( DeviceMappedPropertyKeys != -1073741789 )
                break;
              v24 = v32;
              if ( 20 * (unsigned __int64)v32 > 0xFFFFFFFF )
              {
              ...
              P = ExAllocatePoolWithTag(PagedPool, v25, 0x52504E50u);
              v8 = P;
              if ( !P )
              {
