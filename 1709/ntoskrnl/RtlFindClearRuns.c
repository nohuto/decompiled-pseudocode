/*
 * XREFs of RtlFindClearRuns @ 0x140101440
 * Callers:
 *     RtlFindLongestRunClear @ 0x140252740 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  if ( !v10 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v12 == v11 - 1 && v6 )
        v17 |= byte_1402C7740[SizeOfBitMap & 7];
      if ( v17 )
      {
        ...
        v15 = v16 - v14 + 8;
        v26 = byte_1402C7730[v24] | byte_1402C7740[8 - v14] | v17;
        if ( v26 != 0xFF )
        {
          while ( v13 < v7 || v5[v13 - 1].NumberOfBits < RtlpBitsClearAnywhere[v26] )
          {
            ...
            for ( j = byte_1402C7730[v34]; ((unsigned __int8)j & v26) != 0; ++v33 )
              j *= 2;
            v36 = v13 + 1;
            ...
            {
              v38 = v37;
              for ( k = &RunArray[v37 + 1]; v38 >= 0 && k[-1].NumberOfBits < (unsigned __int8)v34; --k )
              {
                --v37;
                --v38;
                *k = k[-1];
...
LABEL_6:
  ...
  if ( v14 && (v13 < v7 || v5[v13 - 1].NumberOfBits < v14) )
  {
    ...
    {
      v20 = v19;
      for ( m = &v5[v19 + 1]; v20 >= 0 && m[-1].NumberOfBits < v14; --m )
      {
        --v19;
        --v20;
        *m = m[-1];
