/*
 * XREFs of ?StQueueCompaction@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@W4_ST_COMPACTION_CHECK_RESULT@@@Z @ 0x140270CB4
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StQueueCompaction(__int64 a1, int a2)
{
  ...
  {
    v4 = -2;
    *(_BYTE *)(a1 + 1904) = v2 & 0xFC | 1;
    v5 = (unsigned __int8)*(_DWORD *)(a1 + 776) != 0 ? 400 : 30;
  }
  else
  {
    v4 = 0;
    *(_BYTE *)(a1 + 1904) = v2 & 0xFC | 2;
    v5 = 0;
  }
  return ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(*(_QWORD *)(a1 + 1912), v3, v5, v4);
}
