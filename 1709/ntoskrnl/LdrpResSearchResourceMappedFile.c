/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x1400ADB40
 * Callers:
 ...
 *     LdrpFindMessageInAlternateModule @ 0x1400DD6F0 (LdrpFindMessageInAlternateModule.c)
        ...
        __int64 a9)
{
  ...
  ULONGLONG v43; // [rsp+80h] [rbp-378h] BYREF
  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
        ...
        || v33 == 3072 )
      {
        ...
        {
          v17 = v15 | LdrIsResItemExist(ullAugend, a4, 0LL);
          v16 = a5;
        }
      }
      else
  ...
  {
    result = LdrpResGetResourceDirectory(ullAugend, Size, (__int64)&v50);
    if ( (int)result < 0 )
      return result;
  }
  MappingSize = 0;
