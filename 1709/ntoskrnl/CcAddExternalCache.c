/*
 * XREFs of CcAddExternalCache @ 0x14015C8C4
 * Callers:
...
__int64 __fastcall CcAddExternalCache(__int64 a1)
{
  ...
  v3 = (_QWORD *)qword_140387518;
  v4 = v2;
  v5 = (_QWORD *)(a1 + 32);
  if ( *(__int64 **)qword_140387518 != &CcExternalCacheList )
    __fastfail(3u);
  *v5 = &CcExternalCacheList;
  v6 = CcNumberOfExternalCaches;
  v5[1] = v3;
  *v3 = v5;
  qword_140387518 = (__int64)v5;
  if ( v6 + 1 < v6 )
    KeBugCheckEx(0x34u, 0x12FCuLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
