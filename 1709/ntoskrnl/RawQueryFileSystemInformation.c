/*
 * XREFs of RawQueryFileSystemInformation @ 0x14071D9F8
 * Callers:
 ...
 *     RawComputeFileSystemInformationChecksum @ 0x14071D9A8 (RawComputeFileSystemInformationChecksum.c)
 */
...
__int64 __fastcall RawQueryFileSystemInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD v18[2]; // [rsp+68h] [rbp-11h] BYREF
