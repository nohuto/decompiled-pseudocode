...
void __fastcall KiAbProcessThreadLocks(__int64 a1, unsigned int a2, int a3, int a4, __int64 a5, __int64 a6, __int64 a7)
{
  ...
  if ( (*(_BYTE *)(a1 + 792) | *(_BYTE *)(a1 + 1422)) != 63 )
  {
    ...
    for ( i = !_BitScanForward((unsigned int *)&a1, v11); !i; v7 = v31 )
    {
      ...
      v16 = 0;
      v27 = 0;
      LockedHeadEntry = KiAbEntryGetLockedHeadEntry(v14, a2, (__int64)&LockHandle);
      v18 = LockedHeadEntry;
      if ( LockedHeadEntry )
      {
        if ( (*(_BYTE *)(v14 + 25) & 1) != 0 )
...
LABEL_45:
            ...
            KiAbCpuBoostOwners(v18, (unsigned __int8)CpuPriorityKey, a5, a6, a7);
LABEL_30:
        ...
        else
        {
          ...
          if ( v29 )
          {
            if ( (unsigned int)KiAbSetMinimumThreadPriority(v14, (__int64)&v29, a5, a6, a7, &v27) && v14 != v18 )
