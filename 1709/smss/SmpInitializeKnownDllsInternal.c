/*
 * XREFs of SmpInitializeKnownDllsInternal @ 0x140006870
 * Callers:
 *     SmpInitializeKnownDlls @ 0x140006E00 (SmpInitializeKnownDlls.c)
 * Callees:
 *     SmpRandomizeDllList @ 0x140006CE0 (SmpRandomizeDllList.c)
...
LABEL_27:
        ...
        else
        {
          ...
          if ( *(struct _UNICODE_STRING **)(*(_QWORD *)&v20->Length + 8LL) != v20
            || (Buffer = (void **)v20->Buffer, *Buffer != v20) )
          {
            __fastfail(3u);
          }
          *Buffer = v21;
      ...
      v8 = v24;
      v26 = v33;
      if ( *((PVOID **)v32 + 1) != &v32 || *v33 != &v32 )
        __fastfail(3u);
      *v33 = v32;
      v25[1] = v26;
      v27 = qword_1400211D8;
      if ( *((PVOID **)SmpKnownDllsList + 1) != &SmpKnownDllsList || *(PVOID **)qword_1400211D8 != &SmpKnownDllsList )
        __fastfail(3u);
      if ( *(_QWORD **)(*v25 + 8LL) != v25 || *(_QWORD **)v25[1] != v25 )
        __fastfail(3u);
      *(_QWORD *)qword_1400211D8 = v25;
      qword_1400211D8 = v25[1];
