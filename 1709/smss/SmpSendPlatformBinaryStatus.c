/*
 * XREFs of SmpSendPlatformBinaryStatus @ 0x140012778
 * Callers:
 ...
 *     _TlgWrite @ 0x140012DC0 (_TlgWrite.c)
 */
...
char __fastcall SmpSendPlatformBinaryStatus(int a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  if ( a4 )
  {
    if ( (unsigned int)dword_140020020 > 5 )
    {
      ...
      v34 = 2LL;
      v36[1] = 0;
      LOBYTE(Heap) = TlgWrite(v13, &unk_14001BA52, v10, v11, 6u, &pData);
    }
  }
  else if ( (unsigned int)dword_140020020 > 5 )
  {
    ...
    v39 = 4LL;
    v41 = 8LL;
    LOBYTE(Heap) = TlgWrite(v13, &unk_14001BA21, v10, v11, 4u, &v37);
  }
  return (char)Heap;
}
