/*
 * XREFs of RtlStringCbPrintfExW @ 0x14001172C
 * Callers:
 ...
 *     RtlStringVPrintfWorkerW @ 0x1400119A0 (RtlStringVPrintfWorkerW.c)
 */
        ...
        ...)
{
  ...
  if ( (dwFlags & 0x100) != 0 )
  {
    v13 = (const wchar_t *)&unk_14001C1A8;
    if ( pszFormat )
      v13 = pszFormat;
  }
  else
