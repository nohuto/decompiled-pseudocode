/*
 * XREFs of SmpExecPgm @ 0x140003570
 * Callers:
 ...
 *     SmpGetMuSessionIdFromClientContext @ 0x140004B7C (SmpGetMuSessionIdFromClientContext.c)
...
__int64 __fastcall SmpExecPgm(__int64 a1, __int64 a2)
{
  ...
  MuSessionIdFromClientContext = SmpGetMuSessionIdFromClientContext(a2, &v13);
  if ( v13 )
  {
    v5 = 0LL;
    v6 = 0;
    ...
    Session = SmpSbCreateSession(MuSessionIdFromClientContext, v13, a1 + 48);
    v9 = Session;
    if ( !v6 )
      return v9;
    if ( Session < 0 )
    ...
    if ( *(_QWORD *)(v5 + 72) != SmpUniqueProcessId )
    {
      ...
      v23 = v15;
      v24 = *(_QWORD *)(v7 + 48);
      NtAlpcSendWaitReceivePort(SmpApiConnectionPort, 0x10000LL, v19, 0LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( (unsigned int)SmpSessionIdToInitialSessionIndex(MuSessionIdFromClientContext) != -1 )
      SmpSetCoreProcessIds(MuSessionIdFromClientContext, &v14, 0LL);
    if ( MuSessionIdFromClientContext == *(_DWORD *)SmpCoreProcessIds )
    {
      if ( !v7 )
        return v9;
