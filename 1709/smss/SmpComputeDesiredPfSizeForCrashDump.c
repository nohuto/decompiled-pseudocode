/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x14000FBC4
 * Callers:
 *     SmpInitializeManagedPagefileSupport @ 0x14000FFB0 (SmpInitializeManagedPagefileSupport.c)
 * Callees:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140021248 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140021248
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140021248 - 1)
                                                   + 8256LL);
