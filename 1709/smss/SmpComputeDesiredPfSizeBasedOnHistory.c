/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x14000F8DC
 * Callers:
...
__int64 SmpComputeDesiredPfSizeBasedOnHistory()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (unsigned int)Data < 0xF0 )
    v18 = Data;
  if ( v18 )
    memcpy_0(Base, &unk_140021594, 4LL * v18);
  qsort(Base, v18, 4uLL, SmpPagefileUsageSampleCompare);
  v19 = (unsigned int)dword_140021248 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v19 + (v19 >> 4);
}
