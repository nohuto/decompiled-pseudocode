/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x140004F90
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( v19 >= 0 )
  {
    ...
    {
      wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x88, v33, (const char *)(unsigned int)v32, v35);
      return v34;
    }
  }
  else
  {
    wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x84, v20, (const char *)(unsigned int)v19, v35);
    return v21;
  }
}
