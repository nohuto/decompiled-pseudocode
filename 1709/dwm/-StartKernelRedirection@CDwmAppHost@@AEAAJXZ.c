/*
 * XREFs of ?StartKernelRedirection@CDwmAppHost@@AEAAJXZ @ 0x140001F10
 * Callers:
...
__int64 __fastcall CDwmAppHost::StartKernelRedirection(CDwmAppHost *this, __int64 a2, void *a3, __int64 a4)
{
  ...
  v4 = 4LL;
  if ( dword_14000FA24 > *(_DWORD *)(*(_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + 4LL) )
  {
    Init_thread_header(&dword_14000FA24, 4LL, a3, a4);
    if ( dword_14000FA24 == -1 )
    {
      dword_14000F984 = -2147024865;
      Init_thread_footer(&dword_14000FA24);
    }
  }
  if ( *(&g_dwmAppHost + 1) )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)DwmKernelStartup() )
      {
        ...
        if ( v6 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_14000F984, 1u, v6, 0x121u);
        goto LABEL_11;
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_14000F984, 1u, v6, v9);
LABEL_11:
