        ...
        int *a5)
{
  ...
  *a5 = 0;
  ...
  if ( (*(_WORD *)(v8 + 4) & 0x7FFF) == 1 )
  {
    ...
    if ( !v18 )
    {
      if ( *(_DWORD *)(v9 + 8) == (_DWORD)qword_14000F9A0 )
      {
...
LABEL_28:
    ...
    else
    {
      if ( *(_DWORD *)(v9 + 8) != (_DWORD)qword_14000F9A0 )
        return v7;
      CSettingsManager::PropagateUserLogon((CSettingsManager *)&qword_14000F9C8, 0LL, 0LL, 1);
    }
    (*(void (__fastcall **)(struct CPortMessage *, _QWORD))(*(_QWORD *)a2 + 24LL))(a2, 0LL);
    goto LABEL_28;
  }
...
LABEL_5:
  ...
  else if ( *(_DWORD *)(v9 + 8) == (_DWORD)qword_14000F9A0 )
  {
    CSettingsManager::PropagateUserLogon(
      (CSettingsManager *)&qword_14000F9C8,
      *(HKEY *)(v9 + 52),
      *(HKEY *)(v9 + 60),
      *(_DWORD *)(v9 + 68) != 0);
  }
