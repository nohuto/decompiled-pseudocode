/*
 * XREFs of ?LpcNotifySettingsChange@CDwmAppHost@@AEAAJK@Z @ 0x140001130
 * Callers:
 *     ?NotifyWndProc@CDwmAppHost@@AEAA_JPEAUHWND__@@I_K_J@Z @ 0x1400011C0 (-NotifyWndProc@CDwmAppHost@@AEAA_JPEAUHWND__@@I_K_J@Z.c)
 ...
 *     ??0CPortClient@@QEAA@IPEAX@Z @ 0x1400015E0 (--0CPortClient@@QEAA@IPEAX@Z.c)
