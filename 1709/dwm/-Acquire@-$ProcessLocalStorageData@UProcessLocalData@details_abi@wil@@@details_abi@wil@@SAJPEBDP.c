/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x140004DB8
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x6A, v14, (const char *)(unsigned int)v7, v18);
  }
  if ( v7 >= 0 )
  {
    if ( v8 )
    ...
    else
    {
      ...
      if ( v16 < 0 )
      {
        wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x129, v17, (const char *)(unsigned int)v16, v18);
        goto LABEL_14;
      }
    }
    v7 = 0;
LABEL_14:
  ...
  wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x121, v14, (const char *)(unsigned int)v7, v18);
LABEL_15:
  if ( v21 )
