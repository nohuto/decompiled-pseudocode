/*
 * XREFs of WppInitKm @ 0x1C000A0D0
 * Callers:
...
void WppInitKm()
{
  ...
  void (__fastcall *v1)(struct _DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, char, __int64 *, __int64), struct _DEVICE_OBJECT *, PVPB *); // rax
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( WPPTraceSuite == 4 )
    {
      do
      {
        v1 = (void (__fastcall *)(struct _DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, char, __int64 *, __int64), struct _DEVICE_OBJECT *, PVPB *))pfnEtwRegisterClassicProvider;
        v0->Vpb = 0LL;
