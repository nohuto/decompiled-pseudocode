/*
 * XREFs of CiDispatchInitialize @ 0x1C000C0B8
 * Callers:
 *     CsInitialize @ 0x1C000C194 (CsInitialize.c)
 * Callees:
 *     WPP_SF_Zd @ 0x1C000202C (WPP_SF_Zd.c)
 *     WPP_SF_Zq @ 0x1C00020BC (WPP_SF_Zq.c)
 */
...
NTSTATUS __fastcall CiDispatchInitialize(struct _DRIVER_OBJECT *a1)
{
  ...
  result = IoCreateDevice(a1, 0, (PUNICODE_STRING)0x1C000E020LL, 0x22u, 0x20000u, 0, &CiDeviceObject);
  v2 = result;
  if ( result >= 0 )
  {
