/*
 * XREFs of CiSchedulerThreadFunction @ 0x1C00035A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CiSchedulerThreadFunction(struct _KEVENT *StartContext)
{
  ...
  _QWORD *v14; // rdx
  char v15; // bl
  __int32 v16; // [rsp+50h] [rbp+8h] BYREF

  p_Reserved = 0LL;
  if ( byte_1C00062A8 )
    CiLogSchedulerWakeup(1);
  ...
  do
  {
    ...
    if ( CiThreadsMovedUp && v9 > 1 )
    {
      v12 = p_Reserved[4];
      v6 = p_Reserved + 4;
      if ( (PVOID *)v12[1] != p_Reserved + 4 || (v13 = *v12, *(_QWORD **)(*v12 + 8LL) != v12) )
        __fastfail(3u);
      *v6 = v13;
      *(_QWORD *)(v13 + 8) = v6;
      v14 = p_Reserved[5];
