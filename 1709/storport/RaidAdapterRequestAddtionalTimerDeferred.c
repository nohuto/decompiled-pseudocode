/*
 * XREFs of RaidAdapterRequestAddtionalTimerDeferred @ 0x1C001ECF0
 * Callers:
...
__int64 __fastcall RaidAdapterRequestAddtionalTimerDeferred(__int64 a1, __int64 a2, _SLIST_ENTRY *a3, int a4)
{
  ...
  v8 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(a1 + 1168));
  if ( v8 )
  {
    ...
    *((_DWORD *)&v8[3].Next + 2) = a4;
    RaidQueueDeferredItem((char *)(a1 + 1088), v8);
    return 0LL;
  }
  else
  {
