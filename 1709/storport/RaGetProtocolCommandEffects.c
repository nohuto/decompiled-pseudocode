/*
 * XREFs of RaGetProtocolCommandEffects @ 0x1C002C21C
 * Callers:
...
__int64 __fastcall RaGetProtocolCommandEffects(__int64 a1, IRP *a2, _BYTE *a3, _BYTE *a4)
{
  ...
  *a4 = 0;
  ...
  if ( (*(_BYTE *)(v4 + 109) & 0x10) != 0 )
  {
    ...
    *((_DWORD *)v7 + 13) = 44;
    *((_DWORD *)v7 + 14) = 4096;
    v5 = RaidAdapterSendSrbIoControlSynchronously(v4, a2, (unsigned int *)v7, 0x1050u, 0LL, 0, 64);
    if ( v5 >= 0 )
    {
      v15 = *(_OWORD **)(v4 + 5472);
  ...
  if ( v27 )
  {
    ...
    if ( LODWORD(MasterIrp->IoStatus.Information) == 1 )
      v29 = (unsigned int *)(v27 + 4LL * (unsigned __int8)UserEvent);
    else
      v29 = (unsigned int *)(v27 + 4 * ((unsigned __int8)UserEvent + 256LL));
    v30 = *v29;
    if ( (*v29 & 1) != 0 )
    {
