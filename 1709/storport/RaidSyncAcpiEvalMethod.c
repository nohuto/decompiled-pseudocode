/*
 * XREFs of RaidSyncAcpiEvalMethod @ 0x1C001D0BC
 * Callers:
...
LABEL_9:
  ...
  if ( !v11 )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_5155b04a891832e57879a5a4e4c79a88_Traceguids, DeviceObject);
    }
    Status = -1073741670;
    goto LABEL_9;
  }
