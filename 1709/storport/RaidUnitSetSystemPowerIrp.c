/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x1C000E82C
 * Callers:
...
__int64 __fastcall RaidUnitSetSystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 200) = EaLength;
  ...
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 57LL, &WPP_0c5c8aed4ecb3cf637873a43b49c0b60_Traceguids, a1, a2, v12);
  }
  return v12;
}
