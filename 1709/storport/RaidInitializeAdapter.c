/*
 * XREFs of RaidInitializeAdapter @ 0x1C0061E4C
 * Callers:
        ...
        unsigned int a7)
{
  ...
  _BYTE v50[8]; // [rsp+A8h] [rbp-58h] BYREF
  __int64 v51; // [rsp+B0h] [rbp-50h]
  _OWORD v52[21]; // [rsp+C0h] [rbp-40h] BYREF
  UUID Uuid; // [rsp+210h] [rbp+110h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+220h] [rbp+120h] BYREF
  const GUID *v55; // [rsp+240h] [rbp+140h]
  __int64 v56; // [rsp+248h] [rbp+148h]
  int *v57; // [rsp+250h] [rbp+150h]
  __int64 v58; // [rsp+258h] [rbp+158h]
  int *v59; // [rsp+260h] [rbp+160h]
  __int64 v60; // [rsp+268h] [rbp+168h]
  __int64 *v61; // [rsp+270h] [rbp+170h]
  __int64 v62; // [rsp+278h] [rbp+178h]
  int *v63; // [rsp+280h] [rbp+180h]
  __int64 v64; // [rsp+288h] [rbp+188h]
  __int64 *v65; // [rsp+290h] [rbp+190h]
  __int64 v66; // [rsp+298h] [rbp+198h]
  ...
  *(_QWORD *)(a1 + 296) = a1;
  ...
  {
    v14 = i - 26;
    if ( (*(_DWORD *)(i - 3) & 0x800) != 0 && *((_DWORD *)v14 + 1) == -1 )
  ...
  *(_QWORD *)(a1 + 528) = v14;
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(_QWORD *)(a1 + 5000) = 0LL;
    ...
    RtlInitUnicodeString(&v34, L"TotalSenseDataBytes");
    p_Uuid = (UUID *)&v35;
    v32 = 4;
    ...
    RtlInitUnicodeString(&v34, L"EnableIdlePowerManagement");
    *(_BYTE *)(a1 + 104) &= ~0x20u;
    p_Uuid = (UUID *)&v36;
    v32 = 4;
    ...
    RtlInitUnicodeString(&v34, L"DisableRuntimePowerManagement");
    *(_BYTE *)(a1 + 108) &= ~0x10u;
    p_Uuid = (UUID *)&v37;
    v32 = 4;
    if ( (int)PortRegistryReadDeviceKey(
    ...
    RtlInitUnicodeString(&v34, L"DisableD3Cold");
    ...
    *(_BYTE *)(a1 + 108) = v23;
    ...
    RtlInitUnicodeString(&v34, L"IdleTimeoutInMS");
    *(_DWORD *)(a1 + 5104) = 60000;
    ...
    RtlInitUnicodeString(&v34, L"UseDMAv3");
    *(_BYTE *)(a1 + 109) &= ~2u;
    p_Uuid = (UUID *)&v40;
    v32 = 4;
    if ( (int)PortRegistryReadDeviceKey(
                ...
                (__int64)&p_Uuid,
                (__int64)&v32) >= 0 )
      *(_BYTE *)(a1 + 109) = (v40 != 0 ? 2 : 0) | *(_BYTE *)(a1 + 109) & 0xFD;
    RtlInitUnicodeString(&v34, L"PowerSrbTimeout");
    *(_DWORD *)(a1 + 5688) = *v18;
    p_Uuid = (UUID *)&v41;
    v32 = 4;
    if ( (int)PortRegistryReadDeviceKey(
    ...
    *(_QWORD *)(a1 + 4368) = *((_QWORD *)&v52[1] + 1);
    *(_QWORD *)(a1 + 4376) = *(_QWORD *)&v52[1];
    *(_DWORD *)(a1 + 4352) = v52[2];
    *(_DWORD *)(a1 + 4360) = HIDWORD(v52[2]);
    *(_QWORD *)(a1 + 4400) = 0xFFFFFFFFLL;
    *(_QWORD *)(a1 + 4384) = 0LL;
    *(_QWORD *)(a1 + 4392) = 0LL;
    *(_DWORD *)(a1 + 4356) = 6;
    if ( (unsigned __int8)PortReadStorageBusType(*(_QWORD *)(a1 + 16) + 40LL, &v43) )
      *(_DWORD *)(a1 + 4356) = v43;
    RaidDriverGetName(v48, (__int64)v50);
    *(_QWORD *)(a1 + 4800) = v51;
    ...
    *(_DWORD *)(a1 + 5060) = RaidLogListSize;
    if ( v26 )
      *(_QWORD *)(a1 + 5064) = a1 + 5824;
    else
      *(_QWORD *)(a1 + 5064) = 0LL;
    *(_QWORD *)&Uuid.Data1 = 0LL;
    *(_QWORD *)Uuid.Data4 = 0LL;
    RtlInitUnicodeString(&v34, L"AdapterGuid");
    v32 = 16;
    p_Uuid = &Uuid;
    if ( (int)PortRegistryReadDeviceKey(
                (_DWORD)DeviceObject,
    ...
    *(UUID *)(a1 + 5192) = Uuid;
    ...
    if ( (unsigned int)dword_1C0056060 > 5 )
    {
      if ( TlgKeywordOn(v27, 0x400000000000uLL) )
      {
        ...
        v64 = 4LL;
        v66 = 4LL;
        TlgWrite(v28, &unk_1C004B5C4, v29, v30, 8u, &pData);
      }
    }
    KeInitializeDpc(
