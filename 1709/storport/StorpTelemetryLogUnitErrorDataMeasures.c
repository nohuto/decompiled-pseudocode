/*
 * XREFs of StorpTelemetryLogUnitErrorDataMeasures @ 0x1C0002174
 * Callers:
  ...
  if ( (unsigned int)dword_1C0056060 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = WPP_MAIN_CB.SecurityDescriptor;
      ...
      v62 = 2LL;
      v64[1] = 0;
      TlgWrite(&hProvider, &unk_1C004D001, v11, v12, 0x1Au, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
