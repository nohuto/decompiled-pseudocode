/*
 * XREFs of RaUnitQueryCapabilitiesIrp @ 0x1C0061894
 * Callers:
    ...
    if ( PoolWithTag )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 528LL) + 184LL) & 4) != 0 )
      {
        *PoolWithTag = 1572865;
        ...
        v13 = PoolWithTag[1] ^ (HIDWORD(SecurityContext->SecurityQos) ^ PoolWithTag[1]) & 2;
        PoolWithTag[1] = v13;
        v14 = v13 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v13) & 4;
        PoolWithTag[1] = v14;
        v15 = v14 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v14) & 8;
        PoolWithTag[1] = v15;
        v16 = v15 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v15) & 0x10;
        PoolWithTag[1] = v16;
        v17 = v16 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v16) & 0x20;
        PoolWithTag[1] = v17;
        v18 = v17 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v17) & 0x40;
        PoolWithTag[1] = v18;
        v19 = v18 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v18) & 0x80;
        PoolWithTag[1] = v19;
        v20 = v19 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v19) & 0x100;
        PoolWithTag[1] = v20;
        v21 = v20 ^ (HIDWORD(SecurityContext->SecurityQos) ^ v20) & 0x200;
        PoolWithTag[1] = v21;
        PoolWithTag[1] = v21 ^ ((unsigned __int16)v21 ^ (unsigned __int16)(HIDWORD(SecurityContext->SecurityQos) >> 7)) & 0x400;
        PoolWithTag[3] = HIDWORD(SecurityContext->AccessState);
        v22 = *(_QWORD *)(a1 + 24);
        if ( *(_BYTE *)(v22 + 4839) == 1 && *(_BYTE *)(v22 + 4838) == 6 )
