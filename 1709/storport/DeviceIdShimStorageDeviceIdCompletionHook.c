/*
 * XREFs of DeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0047090
 * Callers:
 *     <none>
 * Callees:
  ...
  *PoolWithTag = 16;
  ...
  do
  {
    ...
    if ( PoolWithTag[1] <= v6 )
    {
      *v12 = *v14 & 0xF;
      v12[1] = v14[1] & 0xF;
      v12[3] = ((unsigned __int8)v14[1] >> 4) & 3;
      v16 = (unsigned __int8)v14[3];
      *((_WORD *)v12 + 5) = v15;
      *((_WORD *)v12 + 4) = v16;
      memmove(v12 + 4, v14 + 4, (unsigned __int8)v14[3]);
      v12 = (int *)((char *)v12 + *((unsigned __int16 *)v12 + 5));
    }
  }
  while ( v10 < v11 );
  v4 = MsftId;
