/*
 * XREFs of StorSqmAddToStream @ 0x1C00488FC
 * Callers:
...
NTSTATUS __fastcall StorSqmAddToStream(__int64 a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( byte_1C00566C9 )
  {
    *(_QWORD *)&UserData[0].Size = 4LL;
    ...
    UserData[1].Ptr = (unsigned __int64)&unk_1C0056280;
    ...
    *(_QWORD *)&UserData[2].Size = 4LL;
    ...
    return EtwWrite(qword_1C00566E8, &SQM_ADD_STREAMROW, 0LL, 0x40u, UserData);
  }
  return result;
}
