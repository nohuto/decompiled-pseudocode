/*
 * XREFs of RaidBusEnumeratorGetLunListFromTarget @ 0x1C0014CDC
 * Callers:
 *     RaidBusEnumeratorGetLunList @ 0x1C0014980 (RaidBusEnumeratorGetLunList.c)
 * Callees:
 *     RaidBusEnumeratorIssueReportLuns @ 0x1C0014E90 (RaidBusEnumeratorIssueReportLuns.c)
...
LABEL_9:
      ...
      do
      {
        ...
        if ( v15 >= 0xFFu )
        {
          if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
          {
            ...
            {
              WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_6a92be7ca9eb3b415b66b736f6ea9340_Traceguids, v15);
            }
          }
        }
        else
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_6a92be7ca9eb3b415b66b736f6ea9340_Traceguids, *a1);
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_6a92be7ca9eb3b415b66b736f6ea9340_Traceguids);
      }
    }
    for ( i = v11; i < 0xFFu; ++i )
    {
      if ( *a4 != (_BYTE)v11
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 21LL, &WPP_6a92be7ca9eb3b415b66b736f6ea9340_Traceguids, i);
      }
      ++a4;
    }
    return 0LL;
