/*
 * XREFs of RaUnitAtaPassThroughIoctl @ 0x1C0003E90
 * Callers:
 ...
 *     RaUnitSetAtaPassThroughCdb @ 0x1C00012DC (RaUnitSetAtaPassThroughCdb.c)
...
LABEL_18:
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x80000) != 0 )
      McTemplateK0pq(v10, &EventNonReadWriteRequestComplete, P, a2, Status);
  }
