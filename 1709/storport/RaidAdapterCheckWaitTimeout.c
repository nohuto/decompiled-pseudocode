/*
 * XREFs of RaidAdapterCheckWaitTimeout @ 0x1C002C9C8
 * Callers:
 *     RaidQueueWaitCheckDpcRoutine @ 0x1C00305C0 (RaidQueueWaitCheckDpcRoutine.c)
 * Callees:
 ...
 *     RaidLunQueueCheckWaitTimeout @ 0x1C0031AB4 (RaidLunQueueCheckWaitTimeout.c)
 *     GatewayCheckWaitTimeout @ 0x1C0040374 (GatewayCheckWaitTimeout.c)
 */
...
void __fastcall RaidAdapterCheckWaitTimeout(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (_QWORD *)v34[0] == v34 )
      break;
    if ( *(_QWORD **)(v34[0] + 8LL) != v34 || (v5 = *(_QWORD *)v34[0], *(_QWORD *)(*(_QWORD *)v34[0] + 8LL) != v34[0]) )
      __fastfail(3u);
    v34[0] = *(_QWORD *)v34[0];
    *(_QWORD *)(v5 + 8) = v34;
    v6 = (_QWORD *)(v4 - 24);
  ...
  if ( v36 != v3 )
  {
    ...
    if ( Pool )
    {
      ...
      for ( i = *v17; i != v17; i = (_QWORD *)*i )
      {
        v19 = i - 6;
        if ( *((_BYTE *)i + 2576)
          && (*((_DWORD *)v19 + 662) != -1 || (*((_BYTE *)v19 + 154) & 2) != 0)
      ...
      if ( v15 )
      {
        ...
        do
        {
          ...
          if ( v36 > v3 )
          {
            ...
            v3 += v22;
            if ( v22 )
              _InterlockedExchangeAdd64((volatile signed __int64 *)(*v21 + 1848), v22);
          }
      ...
      while ( 1 )
      {
        ...
        if ( *(_QWORD **)(v34[0] + 8LL) != v34
          || (v24 = *(_QWORD *)v34[0], *(_QWORD *)(*(_QWORD *)v34[0] + 8LL) != v34[0]) )
        {
          __fastfail(3u);
        }
        v34[0] = *(_QWORD *)v34[0];
