/*
 * XREFs of RaAttemptHighWaterMarkIncrease @ 0x1C00407B4
 * Callers:
 ...
 *     RaAttemptHighWaterMarkIncreasePassive @ 0x1C001F160 (RaAttemptHighWaterMarkIncreasePassive.c)
 * Callees:
...
char __fastcall RaAttemptHighWaterMarkIncrease(__int64 a1, __int64 a2)
{
  ...
  if ( KeGetCurrentIrql() && !*(_BYTE *)(a1 + 184) )
  {
    ...
    if ( *(_QWORD *)(v4 + 5744)
      || (WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(v4 + 8)), (*(_QWORD *)(v4 + 5744) = WorkItem) != 0LL) )
    {
      if ( !_InterlockedCompareExchange((volatile signed __int32 *)(v4 + 5760), 1, 0) )
        IoQueueWorkItem(
          *(PIO_WORKITEM *)(v4 + 5744),
...
LABEL_13:
      ...
      if ( Pool )
      {
        ...
        *(_DWORD *)(Pool + 760) = *(_DWORD *)(a1 + 180);
        v12 = *(_DWORD *)(a1 + 180);
        if ( v12 )
          *(_QWORD *)(Pool + 776) = Pool + (unsigned int)(*(_DWORD *)(a1 + 148) - v12);
        if ( *(_BYTE *)(a1 + 184) )
          *(_QWORD *)(Pool + 800) = 0LL;
        *(_DWORD *)(a1 + 164) = 0;
        v3 = 1;
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 168) = MEMORY[0xFFFFF78000000320];
        ...
        v18 = (unsigned int)++*(_DWORD *)(a1 + 176);
