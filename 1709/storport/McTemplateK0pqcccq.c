/*
 * XREFs of McTemplateK0pqcccq @ 0x1C0036608
 * Callers:
...
NTSTATUS McTemplateK0pqcccq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v14 = 1LL;
  v16 = 4LL;
  return McGenEventWriteKM(a1, a2, 0LL, 7u, &v4);
}
