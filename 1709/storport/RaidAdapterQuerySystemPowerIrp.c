/*
 * XREFs of RaidAdapterQuerySystemPowerIrp @ 0x1C000F4E4
 * Callers:
...
__int64 __fastcall RaidAdapterQuerySystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 32LL, &WPP_0c5c8aed4ecb3cf637873a43b49c0b60_Traceguids, a1, a2);
  }
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 33LL, &WPP_0c5c8aed4ecb3cf637873a43b49c0b60_Traceguids, a1, a2, 259);
  }
  return 259LL;
}
