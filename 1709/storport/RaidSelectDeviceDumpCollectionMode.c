/*
 * XREFs of RaidSelectDeviceDumpCollectionMode @ 0x1C0015F28
 * Callers:
 *     RaidBusEnumeratorGetLunListFromTarget @ 0x1C0014CDC (RaidBusEnumeratorGetLunListFromTarget.c)
 * Callees:
 *     RaidRegGetDeviceDumpSupportLevel @ 0x1C0015FE0 (RaidRegGetDeviceDumpSupportLevel.c)
 *     RaidRegGetDeviceDumpMaxSize @ 0x1C0016054 (RaidRegGetDeviceDumpMaxSize.c)
