/*
 * XREFs of RaUnitStorageQueryDevicePowerPropertyIoctl @ 0x1C00645A4
 * Callers:
  ...
  else
  {
    ...
    if ( Length >= 0x14 )
    {
      ...
      *(_DWORD *)(&MasterIrp->Size + 1) = 20;
      LOBYTE(MasterIrp->MdlAddress) = (*(_BYTE *)(a1 + 1568) & 2) != 0;
      BYTE1(MasterIrp->MdlAddress) = (*(_BYTE *)(a1 + 1568) & 4) != 0;
      if ( RaidUnitCheckAndAcquirePoFx(a1) )
      {
        BYTE2(MasterIrp->MdlAddress) = 1;
        BYTE3(MasterIrp->MdlAddress) = (*(_BYTE *)(a1 + 153) & 4) != 0;
        MasterIrp->Flags = *(_DWORD *)(*(_QWORD *)(a1 + 1488) + 20LL);
