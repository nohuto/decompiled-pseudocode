/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C0044D88
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(const struct _TlgProvider_t *a1, __int64 a2)
{
  ...
  void *SecurityDescriptor; // [rsp+58h] [rbp-A8h] BYREF
  ...
  void (**p_AnnotationFunc)(...); // [rsp+D0h] [rbp-30h]
  ...
  void **p_SecurityDescriptor; // [rsp+150h] [rbp+50h]
  ...
  if ( (unsigned int)dword_1C0056060 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x800000000000uLL) )
    {
      ...
      p_AnnotationFunc = &a1[26].AnnotationFunc;
      v40 = &v24;
      v35 = v11;
      v13 = *(_QWORD *)(a2 + 88);
      v42 = &v18;
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = v12 / 0x2710;
      ...
      v90 = v10;
      v92 = 0;
      TlgWrite(&hProvider, &unk_1C004CDE7, v16, v17, 0x21u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
    }
  }
}
