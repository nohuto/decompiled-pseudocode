/*
 * XREFs of RaidRegisterPerfStates @ 0x1C0037C5C
 * Callers:
 ...
 *     RaidGetStorPoFxPerfState @ 0x1C003313C (RaidGetStorPoFxPerfState.c)
 *     RaidValidatePerfSets @ 0x1C0038858 (RaidValidatePerfSets.c)
 */
    ...
    do
    {
      ...
      *v19 = v20;
      ...
      else
      {
        *((_QWORD *)v19 + 2) = v17;
        v22 = 0;
        for ( v19[2] = *(_DWORD *)v18; v22 < *(_DWORD *)v18; v17 += 2 )
        {
