/*
 * XREFs of RaidAdapterAcquireCryptoKeyResources @ 0x1C002C590
 * Callers:
 *     RaUnitStartIo @ 0x1C0008160 (RaUnitStartIo.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C0006050 (RaidAllocatePool.c)
 *     RaidAdapterGetCryptoKeyIndex @ 0x1C002D2F8 (RaidAdapterGetCryptoKeyIndex.c)
 */
...
__int64 __fastcall RaidAdapterAcquireCryptoKeyResources(__int64 a1, struct _SLIST_ENTRY *a2)
{
  ...
  *((_QWORD *)&Next->Next + 1) = 0LL;
    ...
    && *((_DWORD *)&v6->Next + 3) == *(_DWORD *)(v7 + 20 * v8 + 24) )
  {
    ...
    {
      v25 = *(_QWORD *)(a1 + 5712) + ((unsigned __int64)CryptoKeyIndex << 6);
      v26 = *v29;
      v27 = *(_DWORD *)v25;
      ...
      *((_DWORD *)&a2[49].Next->Next + 2) = v27;
      ...
      ExReleaseSpinLockSharedFromDpcLevel((PEX_SPIN_LOCK)(a1 + 5720));
    ...
    for ( i = 0; i < v12; ++i )
    {
      if ( !*(_DWORD *)(((unsigned __int64)i << 6) + *(_QWORD *)(a1 + 5712) + 44) )
        break;
    }
    if ( i == v12 )
    {
LABEL_16:
      ...
      *(_BYTE *)(a1 + 5708) = 1;
      if ( v12 )
      {
        do
        {
          if ( !*(_DWORD *)(((unsigned __int64)i << 6) + *(_QWORD *)(a1 + 5712) + 40) )
            break;
          ++i;
        }
        while ( i < *(_DWORD *)(a1 + 5704) );
      }
    }
    if ( i == *(_DWORD *)(a1 + 5704) )
    {
    ...
    if ( WorkItem && Pool )
    {
      v17 = *(_QWORD *)(a1 + 5712) + ((unsigned __int64)i << 6);
      ...
      *((_DWORD *)&a2[49].Next->Next + 2) = v18;
      ...
      IoQueueWorkItemEx(WorkItem, (PIO_WORKITEM_ROUTINE_EX)RaidAdapterProgramCryptoKeyRoutine, CriticalWorkQueue, v16);
LABEL_24:
      ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(a1 + 5720));
      return 259;
    }
