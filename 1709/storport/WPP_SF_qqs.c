/*
 * XREFs of WPP_SF_qqs @ 0x1C00398D8
 * Callers:
...
__int64 WPP_SF_qqs(__int64 a1, unsigned __int16 a2, __int64 a3, ...)
{
  ...
  if ( !v11 )
    v3 = "NULL";
  return (*(__int64 (__fastcall **)(__int64, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, const char *, __int64, _QWORD))&WPP_MAIN_CB.SectorSize)(
           a1,
           43LL,
