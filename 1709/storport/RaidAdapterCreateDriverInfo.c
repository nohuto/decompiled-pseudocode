/*
 * XREFs of RaidAdapterCreateDriverInfo @ 0x1C0065F60
 * Callers:
 ...
 *     RtlStringCbCopyW @ 0x1C00307F0 (RtlStringCbCopyW.c)
 */

__int64 __fastcall RaidAdapterCreateDriverInfo(__int64 a1, _QWORD *a2, const wchar_t *a3, _QWORD *a4, _BYTE *a5)
{
  _BYTE *v5; // r14
  _QWORD *v6; // rsi
  _QWORD *v7; // rdi
  ...
  *v5 = 0;
  ...
  {
LABEL_5:
    Pool = RaidAllocatePool(NonPagedPoolNx, 0x78uLL, 0x44436152u, *(_QWORD *)(a1 + 8));
    v25 = Pool;
    v14 = Pool;
    if ( Pool )
    {
