/*
 * XREFs of RaidUnitRegisterInterfaces @ 0x1C00140C0
 * Callers:
...
__int64 __fastcall RaidUnitRegisterInterfaces(__int64 a1)
{
  ...
  if ( (int)result >= 0 )
  {
    v5 = *(_QWORD *)(PortGetDeviceType(**(_BYTE **)(a1 + 96) & 0x1F) + 16);
    v9 = -1LL;
    do
      ++v9;
    while ( *(_WORD *)(v5 + 2 * v9) );
    PortMapBuildLunEntry((int)Handle, v11, v8, a1 + 104, v7, v6, v5, v9, v10);
    ZwClose(Handle);
