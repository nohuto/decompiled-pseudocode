/*
 * XREFs of RaidAdapterQueryDeviceRelationsIrp @ 0x1C00123E4
 * Callers:
...
NTSTATUS __fastcall RaidAdapterQueryDeviceRelationsIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_d17971f34b7c3fdc440c591ea55cafdf_Traceguids, a1, a2);
  }
  ...
  else
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 15LL, &WPP_d17971f34b7c3fdc440c591ea55cafdf_Traceguids, a1, a2, v9);
    }
    return v10;
  }
}
