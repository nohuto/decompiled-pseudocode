/*
 * XREFs of PortPassThroughExMarshalResultsFromSrbEx @ 0x1C0047AA4
 * Callers:
 *     PortpCompleteRequestIrp @ 0x1C0048220 (PortpCompleteRequestIrp.c)
 * Callees:
 *     memmove @ 0x1C001F340 (memmove.c)
 *     PortPassThroughExApplyNormalizedRequest @ 0x1C0047938 (PortPassThroughExApplyNormalizedRequest.c)
