/*
 * XREFs of McTemplateK0zqqcccqpp @ 0x1C002BEB0
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqqcccqpp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a12)
{
  ...
  v32 = 8LL;
  v34 = 8LL;
  return McGenEventWriteKM(v13, &EventTargetedReenumeration, 0LL, 0xAu, &v15);
}
