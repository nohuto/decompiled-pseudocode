/*
 * XREFs of McTemplateK0pqqccc @ 0x1C0032C58
 * Callers:
...
NTSTATUS McTemplateK0pqqccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 1LL;
  v16 = 1LL;
  return McGenEventWriteKM(a1, &EventPortPauseDevice, 0LL, 7u, &v4);
}
