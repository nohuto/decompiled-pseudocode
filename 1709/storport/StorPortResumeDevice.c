/*
 * XREFs of StorPortResumeDevice @ 0x1C0001DD0
 * Callers:
 *     StorPortResumeDeviceVrfy @ 0x1C006B6F0 (StorPortResumeDeviceVrfy.c)
 * Callees:
...
char __fastcall StorPortResumeDevice(__int64 a1, unsigned __int8 a2, unsigned __int8 a3, unsigned __int8 a4)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 4) != 0 )
    McTemplateK0pqccc(v9, a2, a3, v7, v9, a2, a3, a4);
  if ( v8 )
  {
    LOBYTE(v14) = a2;
    BYTE1(v14) = a3;
    ...
    {
      WPP_SF_ddd(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_1c803bf8f161365631cb9595cf3477cb_Traceguids, a2, a3, a4);
    }
    ...
    if ( Unit )
    {
      ...
      if ( (qword_1C0056210 & 0x800) != 0 )
        DbgLogRequest(v8, 22, (_DWORD)retaddr, 642, 0LL, 0LL, 0LL);
    }
  }
  return 0;
}
