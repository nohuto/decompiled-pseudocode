/*
 * XREFs of StorpTelemetryLogUnitErrorDataCriticalData @ 0x1C0044A74
 * Callers:
  ...
  if ( (unsigned int)dword_1C0056060 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x800000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = WPP_MAIN_CB.SecurityDescriptor;
      ...
      v63 = 2LL;
      v65[1] = 0;
      TlgWrite(&hProvider, &unk_1C004CBB7, v12, v13, 0x1Au, (EVENT_DATA_DESCRIPTOR *)&hProvider.ProviderMetadataPtr);
    }
  }
}
