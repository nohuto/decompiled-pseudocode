/*
 * XREFs of RaidAdapterScsiGetInquiryDataIoctl @ 0x1C002E7AC
 * Callers:
...
__int64 __fastcall RaidAdapterScsiGetInquiryDataIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    v10 = 8 * (v9 + 6 * *(_DWORD *)(a1 + 136)) + 4;
    if ( CurrentStackLocation->Parameters.Read.Length >= v10 )
    {
      v11 = (__int64 *)(a1 + 120);
      for ( i = *(__int64 **)(a1 + 120); i != v11; i = (__int64 *)*i )
      {
        if ( (i[13] & 8) == 0 )
        {
          v13 = *((_DWORD *)i + 10);
        ...
        do
        {
          *((_BYTE *)p_MdlAddress - 4) = *(_BYTE *)v25;
          if ( (unsigned __int8)v24 < 8u )
            v27 = *(_BYTE *)((unsigned __int8)v24 + a1 + 377);
          else
            v27 = -1;
          v28 = *((_BYTE *)p_MdlAddress - 4) == 0;
          *((_BYTE *)p_MdlAddress - 3) = v27;
          if ( v28 )
          {
            *p_MdlAddress = 0;
          }
          else
          {
            ...
            *(_DWORD *)(*((_QWORD *)v25 + 1) + 48LL * (unsigned int)(*v25 - 1) + 8) = 0;
          }
          ++v24;
          p_MdlAddress += 2;
          v25 += 4;
