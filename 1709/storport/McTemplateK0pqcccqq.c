/*
 * XREFs of McTemplateK0pqcccqq @ 0x1C00366BC
 * Callers:
...
NTSTATUS McTemplateK0pqcccqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(a1, a2, 0LL, 8u, &v4);
}
