/*
 * XREFs of RaUnitDeregisterFromIdleDetection @ 0x1C0037270
 * Callers:
...
void __fastcall RaUnitDeregisterFromIdleDetection(__int64 a1)
{
  ...
  if ( *(char *)(a1 + 153) < 0 )
  {
    ...
    KeReleaseInStackQueuedSpinLock(&LockHandle);
    v5 = *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 96LL);
    if ( v5 )
    {
      PoUnregisterCoalescingCallback(v5, v3, v4);
      *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 96LL) = 0LL;
    }
    v6 = *(void **)(*(_QWORD *)(a1 + 1488) + 104LL);
    if ( v6 )
    {
      PoUnregisterPowerSettingCallback(v6);
      *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 104LL) = 0LL;
    }
    v7 = *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 112LL);
    if ( v7 )
    {
      LOBYTE(v3) = 1;
      ExDeleteTimer(v7, v3, 0LL, 0LL, v12, v13, v14);
      *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 112LL) = 0LL;
    }
    v8 = *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 120LL);
    if ( v8 )
    {
      LOBYTE(v3) = 1;
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 1488) + 120LL) = 0LL;
      if ( v9 )
      {
        if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1488) + 140LL) & 1) != 0 )
          RaidUnitPoFxIdleComponent(a1, 0, 0, 0LL);
      }
    }
    v10 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(a1 + 1480);
    *(_BYTE *)(a1 + 153) &= ~0x80u;
