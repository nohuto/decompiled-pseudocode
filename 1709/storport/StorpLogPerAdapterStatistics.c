/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C00029EC
 * Callers:
 *     StorpLogStatistics @ 0x1C0004218 (StorpLogStatistics.c)
 * Callees:
 *     StorpInitializeHierarchicalResetBuckets @ 0x1C00029BC (StorpInitializeHierarchicalResetBuckets.c)
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
  ...
  if ( ((_DWORD)v2
     ...
     || *(_DWORD *)(a1 + 5248)
     || *(_DWORD *)(a1 + 5260))
    && (unsigned int)dword_1C0056060 > 5
    && TlgKeywordOn(v2, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v5, &unk_1C004DAEB, v6, v7, 0x13u, &pData);
  }
  v3 = (const struct _TlgProvider_t *)*(unsigned int *)(a1 + 5272);
  if ( ((_DWORD)v3
     || *(_DWORD *)(a1 + 5284)
     || *(_DWORD *)(a1 + 5296)
     || *(_DWORD *)(a1 + 5308)
    ...
    && TlgKeywordOn(v3, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v8, &unk_1C004E4BD, v9, v10, 0x13u, &pData);
  }
