/*
 * XREFs of DeviceIdShimHookDeviceControl @ 0x1C0046F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DeviceIdShimHookDeviceControl(__int64 a1, __int64 a2)
{
        ...
        if ( v8 )
        {
          if ( !v8[1] && *v8 == 2 )
          {
            ...
            if ( (unsigned int)v9 >= 8 )
            {
              ...
              (*(void (__fastcall **)(__int64, __int64, void *, __int64))(qword_1C00560B8 + 8))(
                a1,
                a2,
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD))qword_1C00560B8)(*(_QWORD *)(a1 + 8));
