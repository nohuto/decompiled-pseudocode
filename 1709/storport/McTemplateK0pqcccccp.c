/*
 * XREFs of McTemplateK0pqcccccp @ 0x1C002B878
 * Callers:
...
NTSTATUS McTemplateK0pqcccccp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v18 = 1LL;
  v20 = 8LL;
  return McGenEventWriteKM(a1, &EventIORequestComplete, a3, 9u, &v4);
}
