/*
 * XREFs of PortPassThroughMarshalResultsFromSrb @ 0x1C0047EE4
 * Callers:
 *     PortpCompleteRequestIrp @ 0x1C0048220 (PortpCompleteRequestIrp.c)
 * Callees:
 *     memmove @ 0x1C001F340 (memmove.c)
 *     PortPassThroughApplyNormalizedRequest @ 0x1C0047894 (PortPassThroughApplyNormalizedRequest.c)
 *     PortPassThroughNormalize @ 0x1C0048034 (PortPassThroughNormalize.c)
 */
