/*
 * XREFs of PortMiniportRegistryRead @ 0x1C0016380
 * Callers:
 *     StorPortRegistryRead @ 0x1C0016240 (StorPortRegistryRead.c)
 * Callees:
...
__int64 __fastcall PortMiniportRegistryRead(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( a3 == 1 )
  {
    ...
    {
      v19 = v18 + 1;
      if ( WORD1(v25) - (unsigned int)(unsigned __int16)v25 >= 2 && *((_WORD *)P + v19 - 1) && v19 < v17 )
        ++v19;
