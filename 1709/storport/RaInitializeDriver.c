/*
 * XREFs of RaInitializeDriver @ 0x1C005FCBC
 * Callers:
 *     StorPortInitialize @ 0x1C0010820 (StorPortInitialize.c)
 * Callees:
 *     StorSqmInitialize @ 0x1C000FF08 (StorSqmInitialize.c)
 *     McGenEventRegister @ 0x1C000FFA4 (McGenEventRegister.c)
 *     RaidAddPortDriver @ 0x1C0010A50 (RaidAddPortDriver.c)
