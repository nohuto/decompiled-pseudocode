/*
 * XREFs of McTemplateK0pqcccqttqqttq @ 0x1C003677C
 * Callers:
...
NTSTATUS McTemplateK0pqcccqttqqttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWriteKM(a1, &EventUnitPoFxRegistered, 0LL, 0xEu, &v4);
}
