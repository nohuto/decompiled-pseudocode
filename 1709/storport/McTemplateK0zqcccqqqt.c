/*
 * XREFs of McTemplateK0zqcccqqqt @ 0x1C0032F54
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqcccqqqt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a12)
{
  ...
  v32 = 4LL;
  v34 = 4LL;
  return McGenEventWriteKM(v13, &EventSetLunQueueDepthBtl8, 0LL, 0xAu, &v15);
}
