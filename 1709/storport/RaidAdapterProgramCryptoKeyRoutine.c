/*
 * XREFs of RaidAdapterProgramCryptoKeyRoutine @ 0x1C001EF20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RaidAdapterProgramCryptoKeyRoutine(PVOID IoObject, _QWORD *Context, __int64 IoWorkItem)
{
  int v3; // ebp
  PSLIST_ENTRY EntrySList; // r14
  int v5; // r15d
  struct _IO_WORKITEM *v6; // r12
  ...
  EntrySList = 0LL;
  v5 = 0;
  v6 = (struct _IO_WORKITEM *)IoWorkItem;
  if ( Context )
  {
    ...
    v8 = *(_QWORD *)(*Context + 5712LL) + ((unsigned __int64)*((unsigned int *)Context + 2) << 6);
    ...
    if ( v3 >= 0 )
    {
      v10 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5720LL));
      *(_DWORD *)(v8 + 44) = 2;
      v11 = v10;
      EntrySList = FirstEntrySList((PSLIST_HEADER)(v8 + 48));
      InitializeSListHead((PSLIST_HEADER)(v8 + 48));
      ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5720LL), v11);
    }
  }
  v12 = 0LL;
  if ( EntrySList )
  ...
  if ( v3 >= 0 && v12 )
  {
    do
    {
      ...
      if ( *(_BYTE *)(*Context + 4450LL) )
        ...
        v18 = RaidAdapterExecuteXrb(v17, v16, IoWorkItem);
      if ( v18 < 0 )
      {
        LOBYTE(IoWorkItem) = 1;
        *(_BYTE *)(*((_QWORD *)&v15[10].Next + 1) + 3LL) = 4;
        RaidAdapterRequestComplete(*Context, v15, IoWorkItem);
      }
      ++v5;
    }
    while ( v14 );
