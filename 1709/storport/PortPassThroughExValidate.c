/*
 * XREFs of PortPassThroughExValidate @ 0x1C0047CFC
 * Callers:
 ...
 *     PortPassThroughExGetDataBuffers @ 0x1C0069ABC (PortPassThroughExGetDataBuffers.c)
 *     PortPassThroughExValidateNormalizedRequest @ 0x1C0069D98 (PortPassThroughExValidateNormalizedRequest.c)
 */
        ...
        unsigned int *a6)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      PortpPassThroughZeroUnusedBuffers(a2);
      LOBYTE(v12) = a3;
