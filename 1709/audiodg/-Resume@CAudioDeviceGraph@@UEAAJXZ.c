/*
 * XREFs of ?Resume@CAudioDeviceGraph@@UEAAJXZ @ 0x140042280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioDeviceGraph::Resume(CAudioDeviceGraph *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, (__int64)&WPP_6080fe2713ce397b188bf80ec1d83326_Traceguids);
  }
  return v3;
}
