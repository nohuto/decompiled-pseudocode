/*
 * XREFs of ?GetFrequencyForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K@Z @ 0x14003A8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_d7c84bfd30153aba078899c41fbb18ca_Traceguids, *a2);
  }
  if ( v8 )
