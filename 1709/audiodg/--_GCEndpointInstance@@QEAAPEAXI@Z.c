/*
 * XREFs of ??_GCEndpointInstance@@QEAAPEAXI@Z @ 0x1400301AC
 * Callers:
 ...
 *     ??1?$unique_ptr@VCEndpointInstance@@U?$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x1400313A8 (--1-$unique_ptr@VCEndpointInstance@@U-$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@X.c)
 *     ??1CAPOEndpointProcessNode@@UEAA@XZ @ 0x140040648 (--1CAPOEndpointProcessNode@@UEAA@XZ.c)
 *     ??1?$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ @ 0x140042518 (--1-$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ.c)
 * Callees:
