/*
 * XREFs of ?GetInputDataPointer@CCrossProcessClientInputEndpoint@@UEAAXPEAUAPO_CONNECTION_PROPERTY@@PEAUAE_CURRENT_POSITION@@@Z @ 0x140057870
 * Callers:
 *     <none>
 * Callees:
        ...
        struct AE_CURRENT_POSITION *a3)
{
  ...
  __int64 v16; // rcx
  struct SharedMessageQueueItem *v17; // [rsp+60h] [rbp+8h] BYREF
  ...
  *((_DWORD *)this + 4) = 2;
  ...
  if ( !u32ValidFrameCount )
    goto LABEL_5;
  if ( !CCrossProcessBaseEndpoint::PeekNextTimestampMessage((CCrossProcessBaseEndpoint *)v3, &v17) )
  {
    AEWMILOG_GLITCH(v11, v3, v10, 2u, 0LL, 0LL, 0LL, 0LL);
    if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
      McTemplateU0pq(v12, &EVT_GLITCH_CP_CLIENT_INPUT_NO_MESSAGES, v3);
    ...
    v14 = 1;
LABEL_16:
    CCrossProcessEndpointTraceLogger::Glitch((__int64)this - 248, v14, v13);
    goto LABEL_5;
  }
  v15 = v17;
  if ( *((_DWORD *)v17 + 14) != u32ValidFrameCount )
  {
    ...
    if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
      McTemplateU0pq(v16, &EVT_GLITCH_CP_CLIENT_INPUT_SIZE_MISMATCH, v3);
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x80000) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 3u )
    {
  ...
  if ( *((_DWORD *)v15 + 2) != 2 )
  {
    ...
    a2->pBuffer = *((_QWORD *)this - 46) + *((unsigned int *)v15 + 1);
    *((_DWORD *)this + 4) = 0;
    goto LABEL_6;
  }
  *((_DWORD *)this + 4) = 0;
