/*
 * XREFs of ?GetPingPongWriteIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14005F004
 * Callers:
...
LABEL_6:
  ...
  {
    v13 = 1;
    (**(void (__fastcall ***)(__int64, _QWORD, int *))(v6 + 736))(v6 + 736, 0LL, &v13);
    v9 = -2005139387;
  ...
  if ( (_DWORD)v8 == 2 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v6 + 880) + 80LL));
    v9 = -2005139359;
LABEL_13:
  ...
  result = 0LL;
  *(_DWORD *)(*(_QWORD *)(v6 + 880) + 4 * v8 + 56) = *(_DWORD *)(*(_QWORD *)(v6 + 880) + 52LL);
  *a2 = v8;
  return result;
}
