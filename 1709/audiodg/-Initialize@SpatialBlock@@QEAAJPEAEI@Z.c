/*
 * XREFs of ?Initialize@SpatialBlock@@QEAAJPEAEI@Z @ 0x14005F25C
 * Callers:
 ...
 * Callees:
 *     ?GetMemoryRequirement@SpatialBlock@@SAIIIII@Z @ 0x14005EBB4 (-GetMemoryRequirement@SpatialBlock@@SAIIIII@Z.c)
 *     ?SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ @ 0x14005FC28 (-SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ.c)
