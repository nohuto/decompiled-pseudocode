/*
 * XREFs of ?RegisterThread@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUThreadRegistrationToken__@@@Z @ 0x140002F00
 * Callers:
 *     <none>
 * Callees:
 *     ?InitialRegisterForThread@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@Z @ 0x140002CF0 (-InitialRegisterForThread@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@.c)
