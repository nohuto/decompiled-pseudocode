/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCSystemAudioDeviceShared@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14003C110
 * Callers:
 *     <none>
 * Callees:
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  v10 = &`CSystemAudioDeviceShared::_GetEntries'::`2'::_entries;
  v11 = a1 + 6;
  if ( !v11 )
