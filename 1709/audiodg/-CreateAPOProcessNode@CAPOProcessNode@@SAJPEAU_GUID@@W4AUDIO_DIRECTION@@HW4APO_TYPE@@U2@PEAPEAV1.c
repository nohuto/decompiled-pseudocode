/*
 * XREFs of ?CreateAPOProcessNode@CAPOProcessNode@@SAJPEAU_GUID@@W4AUDIO_DIRECTION@@HW4APO_TYPE@@U2@PEAPEAV1@@Z @ 0x14000AA90
 * Callers:
 ...
 *     _wcsicmp @ 0x14001D994 (_wcsicmp.c)
        ...
        _QWORD *a6)
{
  ...
  {
    WPP_SF__guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_12ee975d414f3dc6e1f6d6e7c2eb499f_Traceguids, a1);
  }
  v9 = 0;
  v10 = 0;
