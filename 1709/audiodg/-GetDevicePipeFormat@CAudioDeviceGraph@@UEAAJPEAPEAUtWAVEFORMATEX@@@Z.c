/*
 * XREFs of ?GetDevicePipeFormat@CAudioDeviceGraph@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x14000BBC0
 * Callers:
...
__int64 __fastcall CAudioDeviceGraph::GetDevicePipeFormat(CAudioDeviceGraph *this, struct tWAVEFORMATEX **a2)
{
  ...
  if ( *((_DWORD *)this + 52) )
  {
    v5 = *(CProcessNode **)ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::GetHead((_QWORD *)(*((_QWORD *)this + 14) + 16LL));
    if ( v5 )
    {
  ...
  if ( v8 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetDevicePipeFormat", 0x4B8u, v8);
  }
  if ( v17 )
  {
