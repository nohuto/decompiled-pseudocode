/*
 * XREFs of ?SetEventHandle@CCrossProcessBaseClientEndpoint@@UEAAJPEAX@Z @ 0x1400568E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z @ 0x14004786C (-Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z.c)
 ...
 *     WPP_SF_SD @ 0x140056D34 (WPP_SF_SD.c)
    ...
    if ( v7 )
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_SD(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          14,
          (unsigned int)&WPP_a656f1dc337437ce15896b73439d7644_Traceguids,
          *((_QWORD *)this + 9) + 4,
          v5);
        v9 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      ...
      else if ( v5 >= 0 && v2 < 0 )
      {
        ...
        if ( v9 != &WPP_GLOBAL_Control && (*((_DWORD *)v9 + 7) & 0x80000) != 0 && *((_BYTE *)v9 + 25) >= 2u )
          WPP_SF_D((__int64)v9[2], 0x10u, (__int64)&WPP_a656f1dc337437ce15896b73439d7644_Traceguids, v2);
