/*
 * XREFs of ?WersvcSendMessage@@YAJPEBGPEAU_WERSVC_MSG@@1K@Z @ 0x14003BAE0
 * Callers:
 ...
 *     ?WaitForWerSvc@@YAJK@Z @ 0x14003BA38 (-WaitForWerSvc@@YAJK@Z.c)
 */
...
__int64 __fastcall WersvcSendMessage(const unsigned __int16 *a1, struct _WERSVC_MSG *a2, struct _WERSVC_MSG *a3)
{
  ...
  _QWORD v26[10]; // [rsp+D0h] [rbp-30h] BYREF
