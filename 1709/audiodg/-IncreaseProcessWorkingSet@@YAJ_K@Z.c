/*
 * XREFs of ?IncreaseProcessWorkingSet@@YAJ_K@Z @ 0x140047388
 * Callers:
 ...
 *     WPP_SF_PP @ 0x140047524 (WPP_SF_PP.c)
...
LABEL_13:
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x15u, (__int64)&WPP_2231d4232b023e68cc7c9e9806fbc5db_Traceguids, v7);
  }
  return v7;
}
