/*
 * XREFs of ?GetOutputDataPointer@CCrossProcessServerOutputEndpoint@@UEAA_KIPEAUAE_CURRENT_POSITION@@@Z @ 0x140059230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct AE_CURRENT_POSITION *a3)
{
  ...
  *((_DWORD *)this + 4) = 2;
  v36 = a2;
  AEWMILOG_DATA(v36, (char *)this - 440, (unsigned __int8)a3, 9u, v36, v6, 0LL);
  ...
  *((_QWORD *)this + 15) = *(_QWORD *)&a3->f32FramesPerSecond;
  ...
  if ( v17 == v16 )
  {
    ...
    *(_DWORD *)(((unsigned __int64)v18 << 6) + *((_QWORD *)this - 41) + 52) = 1;
    ...
    if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
      McTemplateU0pxqxq(v21, v20, (_DWORD)v7, v11, *(_DWORD *)(v19 + *((_QWORD *)this - 41) + 4), v12, v14);
  ...
  if ( v23 < v14 )
  {
    ...
    if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
    {
      v33 = v14;
      v28 = v35;
      McTemplateU0pqqq(v27, v26, (_DWORD)v7, v25, v35, v33);
    }
    else
    {
      v28 = v35;
...
LABEL_29:
  v29 = *((_QWORD *)this - 42);
LABEL_30:
  AEWMILOG_DATA(v9, v7, v8, 0xAu, v36, 0LL, 0LL);
  return v29;
}
