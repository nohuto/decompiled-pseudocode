/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointGlitchEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005D640
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 0x200000000000uLL) )
        {
          ...
          v26 = 4LL;
          v28 = 8LL;
          TlgWrite(v5, &unk_140072B02, v6, v7, 9u, &pData);
        }
      }
    }
    else
    {
      if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000000uLL) )
      {
        ...
        v26 = 4LL;
        v28 = 8LL;
        TlgWrite(v8, &unk_140072BA9, v9, v10, 9u, &pData);
      }
      *((_QWORD *)this + 8) = 0LL;
    }
  }
