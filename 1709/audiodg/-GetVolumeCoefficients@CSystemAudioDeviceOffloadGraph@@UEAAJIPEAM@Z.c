/*
 * XREFs of ?GetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAM@Z @ 0x14003EEA0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_07dfb70a96f13fbfd7442f1423bb079c_Traceguids, v6);
    }
