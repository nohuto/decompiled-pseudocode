/*
 * XREFs of ??1?$CAggregateTelemetryClustered@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x140017EDC
 * Callers:
 *     ??1CCrossProcessBaseEndpoint@@UEAA@XZ @ 0x140017C58 (--1CCrossProcessBaseEndpoint@@UEAA@XZ.c)
 *     ??1CCrossProcessEndpointTraceLogger@@UEAA@XZ @ 0x140031534 (--1CCrossProcessEndpointTraceLogger@@UEAA@XZ.c)
