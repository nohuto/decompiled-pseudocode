/*
 * XREFs of ?GetVolumeChannelCount@CSystemAudioDeviceOffload@@UEAAJPEAI@Z @ 0x14003D6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceOffload::GetVolumeChannelCount(CSystemAudioDeviceOffload *this, unsigned int *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffload::GetVolumeChannelCount", 0x291u, v4);
  }
  EtwEventActivityIdControl(4LL, &v6);
