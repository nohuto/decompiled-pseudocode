/*
 * XREFs of ?CreateStreamEndpointInstance@CEndpointInstance@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x1400024B0
 * Callers:
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_DDD(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      10LL,
      &WPP_a8d630645d0b339664572c2ddd340e05_Traceguids,
      v14,
      v15,
      v16);
  }
...
LABEL_50:
  if ( v27 != &WPP_GLOBAL_Control && (*((_DWORD *)v27 + 7) & 0x20000) != 0 && *((_BYTE *)v27 + 25) >= 2u )
    WPP_SF_D(v27[2], 13LL, &WPP_a8d630645d0b339664572c2ddd340e05_Traceguids, (unsigned int)started);
