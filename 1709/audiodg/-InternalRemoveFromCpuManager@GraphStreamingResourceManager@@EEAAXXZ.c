/*
 * XREFs of ?InternalRemoveFromCpuManager@GraphStreamingResourceManager@@EEAAXXZ @ 0x140036F50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall GraphStreamingResourceManager::InternalRemoveFromCpuManager(GraphStreamingResourceManager *this)
{
  ...
  Microsoft::WRL::ComPtr<CpuManager>::InternalRelease((volatile signed __int32 **)this + 35);
}
