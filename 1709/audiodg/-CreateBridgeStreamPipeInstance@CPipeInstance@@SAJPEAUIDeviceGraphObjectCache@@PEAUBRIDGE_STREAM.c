/*
 * XREFs of ?CreateBridgeStreamPipeInstance@CPipeInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAV1@PEAUtWAVEFORMATEX@@PEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x14003FA80
 * Callers:
        ...
        struct CPipeInstance **a7)
{
  ...
  LPVOID *v27; // [rsp+30h] [rbp-A8h] BYREF
  ...
  LPVOID *v41; // [rsp+E8h] [rbp+10h] BYREF
  ...
  *a7 = 0LL;
  try
  {
    ...
    ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::AddTail((__int64 **)&v33, (__int64 *)&v27);
    v41 = 0LL;
    v15 = (CPipeInstance *)operator new(0x138uLL);
    if ( v15 )
    ...
    do
      ++v20;
    while ( v19[v20] );
    v21 = _AllocStringWorker<CTCoAllocPolicy>(v17, v16, v19, v20, v26, (char **)v18 + 23);
    v22 = v21;
    if ( v21 < 0 )
    {
      v32 = v21;
  ...
  if ( v22 < 0 )
    AudDGTraceLoggingErrorHelper("CPipeInstance::CreateBridgeStreamPipeInstance", 0x39Au, v22);
  ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::RemoveAll((__int64)&v33);
