/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@UEAA@XZ @ 0x140016854
 * Callers:
 *     ??_GEventTargetArray@Details@WRL@Microsoft@@UEAAPEAXI@Z @ 0x140016700 (--_GEventTargetArray@Details@WRL@Microsoft@@UEAAPEAXI@Z.c)
 *     _CpuManager::CpuManager_::_1_::dtor$0 @ 0x140021DC8 (_CpuManager--CpuManager_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
