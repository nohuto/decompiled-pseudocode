/*
 * XREFs of ?UpdateLoopbackConstrictionLevel@CAudioDeviceGraph@@QEAAJW4EAudioConstriction@@@Z @ 0x140042300
 * Callers:
...
LABEL_13:
  ...
  if ( v4 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::UpdateLoopbackConstrictionLevel", 0x5FFu, v4);
  }
