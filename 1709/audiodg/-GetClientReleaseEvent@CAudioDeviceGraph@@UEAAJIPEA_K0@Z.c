/*
 * XREFs of ?GetClientReleaseEvent@CAudioDeviceGraph@@UEAAJIPEA_K0@Z @ 0x1400414C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetClientReleaseEvent", 0x337u, v5);
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, (__int64)&WPP_6080fe2713ce397b188bf80ec1d83326_Traceguids, v5);
  }
  return (unsigned int)v5;
}
