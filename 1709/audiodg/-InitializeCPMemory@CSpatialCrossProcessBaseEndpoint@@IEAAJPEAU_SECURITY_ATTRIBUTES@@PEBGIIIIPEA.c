/*
 * XREFs of ?InitializeCPMemory@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAU_SECURITY_ATTRIBUTES@@PEBGIIIIPEAPEAX@Z @ 0x14005F2C8
 * Callers:
 ...
 *     ??_H@YAXPEAX_K1P6APEAX0@Z@Z @ 0x140046B88 (--_H@YAXPEAX_K1P6APEAX0@Z@Z.c)
    ...
    if ( v15 >= 0 )
    {
      ...
      *((_QWORD *)this + 38) = v21;
      ...
      if ( *((_QWORD *)this + 39) )
      {
        ...
        if ( v23[8] <= 0x100u )
        {
          memcpy_0((char *)*v16 + 532, v23, v23[8] + 18LL);
