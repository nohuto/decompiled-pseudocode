/*
 * XREFs of ??1AudioDeviceBroker@Internal@Devices@Media@Windows@@UEAA@XZ @ 0x140018790
 * Callers:
        ...
        void *a2)
{
  ...
  *((_QWORD *)this + 2) = &Windows::Media::Devices::Internal::AudioDeviceBroker::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::FtmBase>'};
  if ( *((_QWORD *)this + 14) )
  ...
  if ( *((_QWORD *)this + 23) )
  {
    ...
    *((_BYTE *)this + 200) = 1;
    if ( this != (Windows::Media::Devices::Internal::AudioDeviceBroker *)-176LL )
      ReleaseSRWLockExclusive((PSRWLOCK)this + 22);
    SetThreadpoolWait(*((PTP_WAIT *)this + 23), 0LL, 0LL);
    WaitForThreadpoolWaitCallbacks(*((PTP_WAIT *)this + 23), 1);
