/*
 * XREFs of ?OnDisconnectedFromRightSubmix@CPipeInstance@@QEAAX_J@Z @ 0x1400060F0
 * Callers:
...
void __fastcall CPipeInstance::OnDisconnectedFromRightSubmix(CPipeInstance *this, __int64 a2)
{
  ...
  void (__fastcall *v9)(CCrossProcessBaseServerEndpoint *, GUID *, CCrossProcessBaseServerEndpoint **); // rax
  ...
  while ( v3 )
  {
    ...
    if ( *(_DWORD *)(v4 + 40) == 3 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        if ( v11 )
        {
          v9 = **(void (__fastcall ***)(CCrossProcessBaseServerEndpoint *, GUID *, CCrossProcessBaseServerEndpoint **))v11;
          if ( (char *)v9 == (char *)ATL::CComObject<CCrossProcessServerInputEndpoint>::QueryInterface )
            ATL::CComObject<CCrossProcessServerInputEndpoint>::QueryInterface(
              v11,
              &GUID_1d3009e2_e512_4c63_86eb_f5ea64a140ee,
              &v12);
          else
            v9(v11, &GUID_1d3009e2_e512_4c63_86eb_f5ea64a140ee, &v12);
          v8 = v12;
          v7 = v11;
        }
        if ( v8 )
