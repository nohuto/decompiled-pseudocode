/*
 * XREFs of ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14003DCF0
 * Callers:
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC40 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC50 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC60 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBCI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBDA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC70 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBDA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC80 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001EC90 (-QueryInterface@-$CComObject@VCSystemAudioDeviceOffload@@@ATL@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  v3 = &`CSystemAudioDeviceOffload::_GetEntries'::`2'::_entries;
  if ( !a1 )
    return 2147942487LL;
  if ( !a3 )
    return 2147500035LL;
