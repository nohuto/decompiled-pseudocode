/*
 * XREFs of ?LogPulseEndpoint@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005CFC0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1400890A0 > 5 )
  {
    ...
    v4 = (_BYTE)a3 != 0;
    v10 = &v4;
    TlgWrite((TraceLoggingHProvider)&dword_1400890A0, &unk_140072D8A, a3, a4, 5u, &pData);
  }
}
