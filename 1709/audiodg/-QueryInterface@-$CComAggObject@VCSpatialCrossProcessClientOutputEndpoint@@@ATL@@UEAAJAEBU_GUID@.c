/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCSpatialCrossProcessClientOutputEndpoint@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14005B2B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  v9 = &`CSpatialCrossProcessClientOutputEndpoint::_GetEntries'::`2'::_entries;
  v10 = v7 + 24;
  if ( v7 == -24 )
  ...
  *v8 = 0LL;
  ...
  {
    v11 = v7 + 936;
    v12 = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v7 + 936) + 8LL);
    ...
    {
      ATL::CComObject<CSystemAudioDeviceShared>::AddRef(v7 + 936);
      goto LABEL_20;
    }
    ...
    {
      ATL::CComObject<CSystemAudioDeviceExclusive>::AddRef(v7 + 936);
      goto LABEL_20;
    }
    v13 = v7 + 936;
