/*
 * XREFs of ?LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z @ 0x14005C970
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1400890A0 > 5 )
  {
    ...
    v15 = 4LL;
    v17 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1400890A0, &unk_140072FC1, a3, a4, 5u, &pData);
    a2 = v9;
    v4 = v10;
  }
  LOBYTE(cData) = 1;
