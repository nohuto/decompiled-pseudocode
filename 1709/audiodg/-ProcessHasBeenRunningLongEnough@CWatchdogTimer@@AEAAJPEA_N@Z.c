/*
 * XREFs of ?ProcessHasBeenRunningLongEnough@CWatchdogTimer@@AEAAJPEA_N@Z @ 0x14003B1B8
 * Callers:
 ...
 *     ?Return_HrMsg@in1diag3@details@wil@@YAXPEAXIPEBDJ1ZZ @ 0x14003B6C8 (-Return_HrMsg@in1diag3@details@wil@@YAXPEAXIPEBDJ1ZZ.c)
 */

__int64 __fastcall CWatchdogTimer::ProcessHasBeenRunningLongEnough(CWatchdogTimer *this, bool *a2)
{
  ...
  if ( v16 >= *(_QWORD *)&CreationTime )
  {
    ...
    v8 = v7 / 10000000.0;
    v9 = (const struct _TlgProvider_t *)*((_QWORD *)this + 1);
    v14 = v8;
    if ( *(_DWORD *)v9 > 5u )
    {
      if ( TlgKeywordOn(v9, 2uLL) )
      {
        ...
        v24 = 8;
        v27 = 8;
        TlgWrite(v10, &unk_140072356, v11, v12, 5u, &pData);
        v8 = v14;
      }
    }
    *a2 = v8 >= 300.0;
