/*
 * XREFs of ?SetMute@CSystemAudioDeviceOffloadGraph@@UEAAJEPEA_JW4AUDIO_CURVE_TYPE@@0@Z @ 0x14003F6E0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum AUDIO_CURVE_TYPE a4)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_07dfb70a96f13fbfd7442f1423bb079c_Traceguids, v7);
    }
