/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x14001DC3F
 * Callers:
 *     __imp_load_QueryServiceStatusEx @ 0x14001DC33 (__imp_load_QueryServiceStatusEx.c)
 * Callees:
