/*
 * XREFs of ?ConnectToRightSubmix@CSubmixImpl@@UEAAJPEAUISubmix@@W4SUBMIX_CONNECT_OPTIONS@@@Z @ 0x140010890
 * Callers:
 ...
 *     ?GetInterruptPeriodicity@CSubmixImpl@@UEAA_JXZ @ 0x140012240 (-GetInterruptPeriodicity@CSubmixImpl@@UEAA_JXZ.c)
 ...
 *     ?CreateFormatConverterPipe@CSubmixImpl@@IEAAJPEAUtWAVEFORMATEX@@_J@Z @ 0x140045DE4 (-CreateFormatConverterPipe@CSubmixImpl@@IEAAJPEAUtWAVEFORMATEX@@_J@Z.c)
 */
        ...
        char a3)
{
  ...
  __int64 (__fastcall *v13)(CSystemAudioDeviceSharedBase *, struct tWAVEFORMATEX **); // rax
  int InputFormat; // eax
