/*
 * XREFs of ?AERTUnlockZoneHeap@@YAJPEAX@Z @ 0x140047278
 * Callers:
...
__int64 __fastcall AERTUnlockZoneHeap(void *a1, void *a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( (v4 & 0xC0000000) == 0xC0000000 )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x39u, (__int64)&WPP_2231d4232b023e68cc7c9e9806fbc5db_Traceguids);
      }
    }
  }
  else
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Au, (__int64)&WPP_2231d4232b023e68cc7c9e9806fbc5db_Traceguids);
  }
