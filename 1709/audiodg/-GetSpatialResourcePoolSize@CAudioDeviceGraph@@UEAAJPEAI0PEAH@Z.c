/*
 * XREFs of ?GetSpatialResourcePoolSize@CAudioDeviceGraph@@UEAAJPEAI0PEAH@Z @ 0x140041E40
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  if ( (int)CPipeInstance::GetAdaptiveSpatialAudioRenderer(v8, &v13) >= 0 )
    v9 = (*(__int64 (__fastcall **)(struct IAdaptiveSpatialAudioRenderer *, unsigned int *, unsigned int *, int *))(*(_QWORD *)v13 + 56LL))(
           v13,
           a2,
           a3,
           a4);
