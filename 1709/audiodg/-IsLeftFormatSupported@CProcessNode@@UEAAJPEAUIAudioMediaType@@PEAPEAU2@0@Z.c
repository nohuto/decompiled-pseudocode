/*
 * XREFs of ?IsLeftFormatSupported@CProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x14000B180
 * Callers:
...
LABEL_26:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_12ee975d414f3dc6e1f6d6e7c2eb499f_Traceguids, v10);
    }
