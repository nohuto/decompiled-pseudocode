/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCProcessSubmix@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400466E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CProcessSubmix>::QueryInterface(
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  v10 = &`CProcessSubmix::_GetEntries'::`2'::_entries;
  v11 = a1 + 6;
  if ( !v11 )
