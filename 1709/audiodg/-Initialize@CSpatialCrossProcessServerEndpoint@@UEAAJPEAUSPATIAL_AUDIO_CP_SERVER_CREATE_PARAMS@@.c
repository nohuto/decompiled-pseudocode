/*
 * XREFs of ?Initialize@CSpatialCrossProcessServerEndpoint@@UEAAJPEAUSPATIAL_AUDIO_CP_SERVER_CREATE_PARAMS@@PEA_K1@Z @ 0x1400618F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetWasapiStreamFormat@CSpatialCrossProcessBaseEndpoint@@IEAAJPEBUtWAVEFORMATEX@@@Z @ 0x14005FCAC (-SetWasapiStreamFormat@CSpatialCrossProcessBaseEndpoint@@IEAAJPEBUtWAVEFORMATEX@@@Z.c)
        ...
        unsigned __int64 *a4)
{
  ...
  if ( !*((_BYTE *)this - 840) )
  {
    ...
    *((_QWORD *)this + 21) = *((_QWORD *)a2 + 17);
    ...
    {
      v14 = v13;
      v15 = (void *)AERTCreateZoneHeap(v13);
      *((_QWORD *)this - 102) = v15;
      if ( !v15 )
      {
      ...
      *((_DWORD *)this - 202) = v24;
      ...
      if ( v25 )
        *((_DWORD *)this - 202) = v24 + *(unsigned __int16 *)(v23 + 12) - v25;
      *((_DWORD *)this + 24) = 0;
      *((_QWORD *)this + 11) = 0LL;
      *((_DWORD *)this + 20) = 24;
