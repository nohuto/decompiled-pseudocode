/*
 * XREFs of ?DeactivateAPOsAndRemoveConnections@CPipeInstance@@QEAAXXZ @ 0x140007360
 * Callers:
...
void __fastcall CPipeInstance::DeactivateAPOsAndRemoveConnections(CPipeInstance *this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 40LL, &WPP_467e7e5d32f730dac41c79a61116708c_Traceguids, this);
  }
  if ( *((_DWORD *)this + 29) )
  {
    v2 = *((_QWORD *)this + 18);
