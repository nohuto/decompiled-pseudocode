/*
 * XREFs of ?AddPipeToLoopbackConnection@CSubmixImpl@@UEAAJPEAVCPipeInstance@@@Z @ 0x140045C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSubmixImpl::AddPipeToLoopbackConnection(CSubmixImpl *this, struct CPipeInstance *a2)
{
  ...
  if ( v4 )
  {
    ...
    v6 = CPipeInstance::ResolvePendingConnections(a2, *((_QWORD *)LoopbackConnection + 1), 1LL, 0);
    v7 = v6;
    if ( v6 < 0 )
    {
      v8 = 1157LL;
