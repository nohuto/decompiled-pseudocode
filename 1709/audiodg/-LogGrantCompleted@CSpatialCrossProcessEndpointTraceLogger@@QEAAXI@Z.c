/*
 * XREFs of ?LogGrantCompleted@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x14005CE98
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1400890A0 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1400890A0, &unk_140072EA4, a3, a4, 4u, &v4);
  }
}
