/*
 * XREFs of ?GetCurrentPadding@CCrossProcessBaseEndpoint@@UEAAXPEA_JPEAUAE_CURRENT_POSITION@@@Z @ 0x140055C30
 * Callers:
 ...
 *     WPP_SF_ii @ 0x14003BD90 (WPP_SF_ii.c)
        ...
        struct AE_CURRENT_POSITION *a3)
{
    ...
    && CCrossProcessBaseEndpoint::IsValidOffset((CCrossProcessBaseEndpoint *)v4, v8, v9) )
  {
    ...
    v14 = (unsigned int)(int)((double)(int)v13
                            * 10000000.0
                            / (double)(int)(*(_DWORD *)(*((_QWORD *)this + 8) + 160LL)
                                          / (unsigned int)*(unsigned __int16 *)(*((_QWORD *)this + 8) + 164LL))
                            + 0.5);
    *a2 = v14;
    AEWMILOG_GENERIC(v14, 0LL, v13, 100, v7, v8, v14, v13, 0.0, 0.0, 0.0, 0.0);
  }
  else
  {
    *a2 = 0LL;
