/*
 * XREFs of ?GetPosition@CSpatialCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x140061120
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  if ( a2 )
  {
    ...
    if ( *a2 < v28 )
    {
      ...
      AEWMILOG_GENERIC(v32, (char *)this - 912, *a2, 8, *a2, v28, v32, 0LL, 0.0, 0.0, 0.0, 0.0);
    }
