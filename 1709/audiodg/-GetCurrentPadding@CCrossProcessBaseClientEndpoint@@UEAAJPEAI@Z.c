/*
 * XREFs of ?GetCurrentPadding@CCrossProcessBaseClientEndpoint@@UEAAJPEAI@Z @ 0x140055B30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, (__int64)&WPP_a656f1dc337437ce15896b73439d7644_Traceguids, v2);
  }
