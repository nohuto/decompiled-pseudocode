/*
 * XREFs of ??1?$CSimpleMap@U_GUID@@PEAVCPipeInstance@@V?$CSimpleMapEqualHelper@U_GUID@@PEAVCPipeInstance@@@ATL@@@ATL@@QEAA@XZ @ 0x140030BBC
 * Callers:
 *     _CAudioDeviceGraph::_CAudioDeviceGraph_::_1_::dtor$6 @ 0x1400211D0 (_CAudioDeviceGraph--_CAudioDeviceGraph_--_1_--dtor$6.c)
