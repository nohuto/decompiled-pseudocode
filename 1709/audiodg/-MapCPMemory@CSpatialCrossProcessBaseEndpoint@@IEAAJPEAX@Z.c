/*
 * XREFs of ?MapCPMemory@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAX@Z @ 0x14005F644
 * Callers:
...
__int64 __fastcall CSpatialCrossProcessBaseEndpoint::MapCPMemory(CSpatialCrossProcessBaseEndpoint *this, void *a2)
{
  ...
  if ( v5 < 0 )
    goto LABEL_23;
  v6 = *((_DWORD *)*v4 + 132);
  UnmapMemory<CSpatialCrossProcessBaseEndpoint::ControlData>((LPCVOID *)v4, 0x326u);
