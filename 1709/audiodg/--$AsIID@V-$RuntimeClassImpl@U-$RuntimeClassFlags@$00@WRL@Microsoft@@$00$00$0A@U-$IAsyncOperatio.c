    ...
    && !InlineIsEqualGUID(v3, &GUID_af86e2e0_b12d_4c6a_9c5a_d7aa65101e90) )
  {
    ...
    else
    {
      if ( InlineIsEqualGUID(v7, &GUID_00000038_0000_0000_c000_000000000046)
        || InlineIsEqualGUID(v12, &GUID_00000036_0000_0000_c000_000000000046) )
      {
        *v8 = (void *)v13;
        v11 = v14;
      }
      ...
      {
        v11 = -2147467262;
        if ( Microsoft::WRL::FtmBase::CanCastTo((Microsoft::WRL::FtmBase *)(v13 + 72), v15, v8) >= 0 )
          v11 = v16;
      }
      if ( v11 < 0 )
