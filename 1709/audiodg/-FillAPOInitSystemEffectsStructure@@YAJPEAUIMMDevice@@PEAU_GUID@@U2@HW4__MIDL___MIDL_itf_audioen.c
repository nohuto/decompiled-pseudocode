/*
 * XREFs of ?FillAPOInitSystemEffectsStructure@@YAJPEAUIMMDevice@@PEAU_GUID@@U2@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@AEAUAPOInitSystemEffects2@@@Z @ 0x140014460
 * Callers:
 ...
 *     ?FillAuxiliaryInputInitStruct@@YAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@AEAUAPOInitSystemEffects2@@@Z @ 0x140034854 (-FillAuxiliaryInputInitStruct@@YAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@AEAU.c)
 * Callees:
        ...
        struct APOInitSystemEffects2 *a6)
{
  ...
  struct tWAVEFORMATEX *v46; // r14
  void *v47; // rcx
  struct tWAVEFORMATEX *v48; // rsi
  void *v49; // rcx
  struct tWAVEFORMATEX *v50; // r14
  __int64 v51; // rdx
