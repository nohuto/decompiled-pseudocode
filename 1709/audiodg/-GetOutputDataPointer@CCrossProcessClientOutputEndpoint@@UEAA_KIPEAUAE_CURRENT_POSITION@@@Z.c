/*
 * XREFs of ?GetOutputDataPointer@CCrossProcessClientOutputEndpoint@@UEAA_KIPEAUAE_CURRENT_POSITION@@@Z @ 0x140057FA0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)this + 4) = 2;
    ...
    && a2 )
  {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_ii(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xEu,
          (__int64)&WPP_8ba84e4c02b33f572bdb63ead5dc6032_Traceguids,
          v9,
          v8);
      }
      AEWMILOG_GLITCH(v15, v4, v13, 9u, v9, v8, 0LL, v14);
      if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
        McTemplateU0pxxq(v17, v16, (_DWORD)v4, v9, v8, v14);
    ...
    else
    {
      ...
      {
        LODWORD(v27) = *(_DWORD *)(*((_QWORD *)this - 45) + 144LL);
        LODWORD(v26) = v14;
        LODWORD(v25) = v22;
        WPP_SF_DDDD(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xFu,
          &WPP_8ba84e4c02b33f572bdb63ead5dc6032_Traceguids,
          v21,
          v25,
          v26,
          v27);
