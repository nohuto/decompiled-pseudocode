/*
 * XREFs of ?ZeroOutObject@CSpatialCrossProcessBaseEndpoint@@IEAAJII@Z @ 0x14005FE38
 * Callers:
 ...
 *     ?ZeroOutObject@SpatialBlock@@QEAAJII@Z @ 0x14005FE6C (-ZeroOutObject@SpatialBlock@@QEAAJII@Z.c)
 */
