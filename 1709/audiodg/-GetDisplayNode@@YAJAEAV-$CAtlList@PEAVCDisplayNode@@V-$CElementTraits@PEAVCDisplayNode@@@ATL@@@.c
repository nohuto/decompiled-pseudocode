/*
 * XREFs of ?GetDisplayNode@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@PEAVCProcessNode@@PEAPEAVCDisplayNode@@@Z @ 0x140043B90
 * Callers:
...
__int64 __fastcall GetDisplayNode(__int64 *a1, __int64 a2, CDisplayNode **a3)
{
  ...
  CDisplayNode *v15; // [rsp+60h] [rbp+8h] BYREF
