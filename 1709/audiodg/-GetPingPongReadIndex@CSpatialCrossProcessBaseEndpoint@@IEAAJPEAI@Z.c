/*
 * XREFs of ?GetPingPongReadIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14005EED8
 * Callers:
...
LABEL_6:
  ...
  if ( v8 == 2 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 110) + 76LL));
    v9 = -2005139358;
LABEL_13:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongReadIndex", 675, v9);
    return v9;
  }
  *a2 = v8;
  return 0LL;
