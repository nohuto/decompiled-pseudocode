/*
 * XREFs of ?ConfigureAPOInterfaces@CPipeInstance@@AEAAJPEAUIAudioGraphCallback@@@Z @ 0x140006230
 * Callers:
 ...
 * Callees:
 *     ?InitializeAPOs@CSystemAudioDeviceBase@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x140014B70 (-InitializeAPOs@CSystemAudioDeviceBase@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z.c)
...
__int64 __fastcall CPipeInstance::ConfigureAPOInterfaces(CPipeInstance *this, struct IAudioGraphCallback *a2)
{
  ...
  __int64 v14; // rcx
  __int64 (__fastcall *v15)(CSystemAudioDeviceBase *__hidden, unsigned __int64, unsigned int, struct IAudioProcessingObject **); // rax
...
LABEL_33:
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 57LL, &WPP_467e7e5d32f730dac41c79a61116708c_Traceguids, v17);
        }
        AudDGTraceLoggingErrorHelper("CPipeInstance::ConfigureAPOInterfaces", 0x10FCu, v17);
        return v17;
      }
      memset(v8, 0, 8 * v2);
      v9 = *((_QWORD *)this + 3);
