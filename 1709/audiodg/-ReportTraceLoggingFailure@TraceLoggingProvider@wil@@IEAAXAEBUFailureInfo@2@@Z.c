/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x140035A28
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x1400352D0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( **((_DWORD **)this + 1) > 5u )
  {
    ...
    v64 = 4;
    TlgCreateSz(&v66, v22);
    TlgWrite(v25, &unk_140072230, v23, v24, 0x13u, &pData);
  }
}
