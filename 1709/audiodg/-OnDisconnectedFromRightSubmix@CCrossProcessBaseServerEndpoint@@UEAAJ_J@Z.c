/*
 * XREFs of ?OnDisconnectedFromRightSubmix@CCrossProcessBaseServerEndpoint@@UEAAJ_J@Z @ 0x1400168F0
 * Callers:
 ...
 * Callees:
 *     ?UpdateLatency@CCrossProcessBaseServerEndpoint@@UEAAJ_J@Z @ 0x140016F90 (-UpdateLatency@CCrossProcessBaseServerEndpoint@@UEAAJ_J@Z.c)
