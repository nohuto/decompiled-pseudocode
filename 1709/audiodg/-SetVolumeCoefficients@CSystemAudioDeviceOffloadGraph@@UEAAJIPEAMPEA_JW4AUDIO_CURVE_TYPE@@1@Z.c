/*
 * XREFs of ?SetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAMPEA_JW4AUDIO_CURVE_TYPE@@1@Z @ 0x14003F7C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a6)
{
  ...
  if ( v9 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_07dfb70a96f13fbfd7442f1423bb079c_Traceguids, v9);
    }
