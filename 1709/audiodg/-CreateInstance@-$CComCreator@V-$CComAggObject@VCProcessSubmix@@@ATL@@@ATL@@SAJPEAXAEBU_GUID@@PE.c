/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCProcessSubmix@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140046598
 * Callers:
 ...
 *     ??0?$CComAggObject@VCProcessSubmix@@@ATL@@QEAA@PEAX@Z @ 0x140046428 (--0-$CComAggObject@VCProcessSubmix@@@ATL@@QEAA@PEAX@Z.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  try
  {
    ...
    if ( v8 )
      v9 = ATL::CComAggObject<CProcessSubmix>::CComAggObject<CProcessSubmix>((__int64)v8, a1);
    else
      v9 = 0LL;
    v12 = v9;
  }
