/*
 * XREFs of ?GetObjectMetadata@CSpatialCrossProcessClientOutputEndpoint@@UEAAJIPEAPEAXPEAI@Z @ 0x140060E20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessClientOutputEndpoint::GetObjectMetadata", 213, ObjectMetadata);
