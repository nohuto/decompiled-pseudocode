/*
 * XREFs of ?GetPositionForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K0@Z @ 0x14003ABF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x14003A4B8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
