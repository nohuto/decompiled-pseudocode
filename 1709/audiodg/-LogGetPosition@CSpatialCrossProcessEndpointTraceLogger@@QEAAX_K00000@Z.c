/*
 * XREFs of ?LogGetPosition@CSpatialCrossProcessEndpointTraceLogger@@QEAAX_K00000@Z @ 0x14005CDB8
 * Callers:
        ...
        char a7)
{
  ...
  const GUID **v12; // [rsp+78h] [rbp-21h]
  ...
  const GUID *v23; // [rsp+F8h] [rbp+5Fh] BYREF
  ...
  if ( (unsigned int)dword_1400890A0 > 5 )
  {
    ...
    v19 = 8LL;
    v21 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1400890A0, &unk_140072DFE, a3, a4, 9u, &pData);
  }
}
