/*
 * XREFs of ?PreMessageLoop@CAudioDGModule@@QEAAJH@Z @ 0x140012D50
 * Callers:
...
LABEL_74:
  ...
  if ( v4 )
    goto LABEL_72;
  v4 = RpcServerRegisterIf3(&unk_140066750, 0LL, 0LL, 33LL, 1234, 0, AudioDGRpcIfCallback, SecurityDescriptor);
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x10) != 0
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
...
LABEL_72:
  ...
  if ( !v8 )
  {
    ...
    v17 = 15LL;
LABEL_46:
    WPP_SF_D(v16[2], v17, &WPP_23720d765f8d3da2cbc3c5fdd3fad56c_Traceguids, (unsigned int)v4);
    goto LABEL_30;
  }
