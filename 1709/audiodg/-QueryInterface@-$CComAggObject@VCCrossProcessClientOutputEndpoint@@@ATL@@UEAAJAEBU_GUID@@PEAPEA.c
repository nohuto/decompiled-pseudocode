/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCCrossProcessClientOutputEndpoint@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400539B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  v9 = &`CCrossProcessClientOutputEndpoint::_GetEntries'::`2'::_entries;
  v10 = v7 + 24;
  if ( v7 == -24 )
  ...
  *v8 = 0LL;
  ...
  {
    v11 = v7 + 416;
    v12 = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v7 + 416) + 8LL);
    if ( v12 == ATL::CComObject<CAPOWrapperSrv>::AddRef )
    {
      _InterlockedIncrement((volatile signed __int32 *)(v7 + 448));
      goto LABEL_20;
    }
    if ( v12 == ATL::CComObject<CSystemAudioDeviceShared>::AddRef )
    {
      ATL::CComObject<CSystemAudioDeviceShared>::AddRef(v7 + 416);
      goto LABEL_20;
    }
    ...
    {
      ATL::CComObject<CSystemAudioDeviceExclusive>::AddRef(v7 + 416);
      goto LABEL_20;
    }
    v13 = v7 + 416;
