/*
 * XREFs of _lambda_6e535b2589e16be8e59d14ca837e6d0f_::operator() @ 0x14004B2F8
 * Callers:
...
__int64 __fastcall lambda_6e535b2589e16be8e59d14ca837e6d0f_::operator()(__int64 a1, __int64 a2, _DWORD *a3)
{
  int v5; // edi
  __int64 result; // rax
