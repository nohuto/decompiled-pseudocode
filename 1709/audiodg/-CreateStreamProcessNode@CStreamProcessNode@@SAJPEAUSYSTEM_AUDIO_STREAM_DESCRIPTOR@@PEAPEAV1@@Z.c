/*
 * XREFs of ?CreateStreamProcessNode@CStreamProcessNode@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAPEAV1@@Z @ 0x140001FE0
 * Callers:
        ...
        struct IAudioMediaType ***a2)
{
  ...
  if ( v5 )
  {
    v7 = CAudioMediaType::Create(a1[10], (unsigned int)a1[10]->cbSize + 18, v5 + 6, 0.0, 0);
    if ( (v7 & 0x80000000) == 0 )
    {
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 16LL, &WPP_12ee975d414f3dc6e1f6d6e7c2eb499f_Traceguids, v7);
  }
  AudDGTraceLoggingErrorHelper("CStreamProcessNode::CreateStreamProcessNode", 0x195u, v7);
  return v7;
}
