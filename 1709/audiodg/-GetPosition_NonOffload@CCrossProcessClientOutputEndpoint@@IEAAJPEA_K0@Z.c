/*
 * XREFs of ?GetPosition_NonOffload@CCrossProcessClientOutputEndpoint@@IEAAJPEA_K0@Z @ 0x140058488
 * Callers:
...
LABEL_12:
    *a2 = *((_QWORD *)this + 21);
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_8ba84e4c02b33f572bdb63ead5dc6032_Traceguids, v4);
    }
    AudCPTraceLoggingErrorHelper("CCrossProcessClientOutputEndpoint::GetPosition_NonOffload", 299, v4);
    return v4;
  }
  v20 = *((_QWORD *)this + 8);
