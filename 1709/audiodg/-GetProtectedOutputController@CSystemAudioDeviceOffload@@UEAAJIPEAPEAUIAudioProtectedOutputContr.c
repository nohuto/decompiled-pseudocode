/*
 * XREFs of ?GetProtectedOutputController@CSystemAudioDeviceOffload@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x14003D5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProtectedOutputController **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffload::GetProtectedOutputController", 0xF6u, v6);
  }
  else
  {
