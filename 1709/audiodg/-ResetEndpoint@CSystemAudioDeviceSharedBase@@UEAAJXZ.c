/*
 * XREFs of ?ResetEndpoint@CSystemAudioDeviceSharedBase@@UEAAJXZ @ 0x14003B5D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceSharedBase::ResetEndpoint(CSystemAudioDeviceSharedBase *this)
{
  ...
  if ( v2 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::ResetEndpoint", 0x218u, v2);
  }
  if ( v5 )
