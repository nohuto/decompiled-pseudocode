/*
 * XREFs of ?CreateAPOEndpointProcessNode@CAPOEndpointProcessNode@@SAJW4SYSTEM_AUDIO_STREAM_TYPE@@PEAUIAudioProcessingObject@@PEAUtWAVEFORMATEX@@PEAPEAV1@@Z @ 0x1400406F4
 * Callers:
 ...
 *     ??0?$CComQIPtr@UIAPOAuxiliaryInputConfiguration@@$1?_GUID_4ceb0aab_fa19_48ed_a857_87771ae1b768@@3U__s_GUID@@B@ATL@@QEAA@PEAUIUnknown@@@Z @ 0x140030EE4 (--0-$CComQIPtr@UIAPOAuxiliaryInputConfiguration@@$1-_GUID_4ceb0aab_fa19_48ed_a857_87771ae1b768@@.c)
 *     ??0?$CComPtrBase@UIAudioMediaType@@@ATL@@IEAA@PEAUIAudioMediaType@@@Z @ 0x14004061C (--0-$CComPtrBase@UIAudioMediaType@@@ATL@@IEAA@PEAUIAudioMediaType@@@Z.c)
  ...
  if ( v22 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( (v10 & 8) != 0 )
      {
        v10 &= ~8u;
        if ( v19 )
          (*(void (__fastcall **)(CAudioMediaType *))(*(_QWORD *)v19 + 16LL))(v19);
      }
      if ( (v10 & 4) != 0 )
      {
        v10 &= ~4u;
      ...
      if ( v9 >= 0 )
      {
        ...
        v15 = (CAudioMediaType *)operator new(0x40uLL);
        v16 = v15;
        v19 = v15;
        if ( v15 )
        {
          ...
          *((_QWORD *)v15 + 4) = 0LL;
          *((_DWORD *)v15 + 10) = 5;
          *(_QWORD *)v15 = &CAPOEndpointProcessNode::`vftable';
          *((_QWORD *)v15 + 6) = 0LL;
          *((_DWORD *)v15 + 14) = 0;
        }
        else
        ...
        *((_DWORD *)v16 + 15) = a1;
        ATL::CComPtr<IAudioMediaType>::operator=((CAudioMediaType **)v16 + 6, &v20);
        ATL::CComPtr<IAudioMediaType>::operator=((CAudioMediaType **)v16 + 1, &v20);
        ATL::CComPtr<IAudioMediaType>::operator=((CAudioMediaType **)v16 + 2, &v20);
        v24 = 0LL;
        *a4 = v16;
      }
      else
...
LABEL_34:
  ...
  if ( v7 )
    (*(void (__fastcall **)(CAudioMediaType *))(*(_QWORD *)v7 + 16LL))(v7);
  if ( v6 )
