/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCCrossProcessClientInputEndpoint@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140053770
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  v9 = &`CCrossProcessClientInputEndpoint::_GetEntries'::`2'::_entries;
  v10 = v7 + 24;
  if ( v7 == -24 )
