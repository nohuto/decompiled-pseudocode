/*
 * XREFs of ?QueryInterface@?$CComObject@VCVpoContext@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140045700
 * Callers:
 *     ?QueryInterface@?$CComObject@VCVpoContext@@@ATL@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001F090 (-QueryInterface@-$CComObject@VCVpoContext@@@ATL@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall ATL::CComObject<CVpoContext>::QueryInterface(__int64 a1, _DWORD *a2, __int64 *a3)
{
  GUID **v3; // rdi
  __int64 result; // rax
  __int64 v8; // rbx
  ...
  v3 = &`CVpoContext::_GetEntries'::`2'::_entries;
  if ( !a1 )
    return 2147942487LL;
  if ( !a3 )
    return 2147500035LL;
  *a3 = 0LL;
  ...
  {
    v8 = a1 + 8;
    v9 = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 + 8) + 8LL);
