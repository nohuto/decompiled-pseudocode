/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCStreamGroup@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140035650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CStreamGroup>::QueryInterface(
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  v10 = &`CStreamGroup::_GetEntries'::`2'::_entries;
  v11 = a1 + 6;
  if ( !v11 )
