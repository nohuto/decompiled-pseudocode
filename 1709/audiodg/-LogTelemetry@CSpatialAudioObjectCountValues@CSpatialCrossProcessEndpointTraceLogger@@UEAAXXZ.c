/*
 * XREFs of ?LogTelemetry@CSpatialAudioObjectCountValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005D280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StdDev@?$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@QEAANW4SpatialObjectCountTypes@@@Z @ 0x14005DBAC (-StdDev@-$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@QEAANW4SpatialObjec.c)
 */
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues *this)
{
  ...
  if ( *(_DWORD *)*v1 > 4u && TlgKeywordOn(*v1, 0x400000000000uLL) )
  {
    ...
    v31 = &v9;
    v32 = 8LL;
    TlgWrite(v3, &unk_140072A60, v4, v5, 0xDu, &pData);
  }
}
