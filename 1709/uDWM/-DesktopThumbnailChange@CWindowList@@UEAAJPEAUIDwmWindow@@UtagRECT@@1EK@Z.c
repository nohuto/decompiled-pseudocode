/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x18007AB50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0xEA7u);
    goto LABEL_35;
  }
  v13 = v31;
  if ( !v31 )
    goto LABEL_35;
  v14 = (CTopLevelWindow *)*((_QWORD *)v31 + 50);
  if ( !v14 || *((_DWORD *)v31 + 28) == 1 )
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xEB1u);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DesktopThumbnail, 0xEB5u);
LABEL_27:
    v16 = v28;
    goto LABEL_28;
  }
  v16 = v28;
  v17 = v28;
  *((_QWORD *)v28 + 34) = *((_QWORD *)v13 + 15);
  updated = CDesktopThumbnailBase::UpdateWindowClones(v17);
  v10 = updated;
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0xEB6u);
    goto LABEL_28;
  }
  v34 = *a4;
  ...
  if ( PerMonitorDesktopThumbnail >= 0 )
  {
    ...
    if ( v20 )
    {
      if ( (a6 & 0x200000) != 0 )
      {
        VisualCollection::Remove((VisualCollection *)(*(_QWORD *)(v20 + 24) + 32LL), *((struct CVisual **)v13 + 73));
        v21 = (CBaseObject *)*((_QWORD *)v13 + 73);
        if ( v21 )
        {
      ...
      {
        *(_DWORD *)(v20 + 340) = a6;
        CDesktopThumbnailCVIVisual::Update(*((CDesktopThumbnailCVIVisual **)v13 + 73), a3, (double)a5 / 255.0);
      }
      goto LABEL_28;
    }
    if ( (a6 & 0x200000) == 0 )
      ...
      if ( v22 >= 0 )
      {
        ...
        *((_BYTE *)v24 + 337) = 0;
        ...
        if ( v25 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0xED7u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0xED4u);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0xECEu);
        v11 = (volatile signed __int32 *)v29;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, PerMonitorDesktopThumbnail, 0xEB7u);
  }
LABEL_28:
  if ( v16 )
