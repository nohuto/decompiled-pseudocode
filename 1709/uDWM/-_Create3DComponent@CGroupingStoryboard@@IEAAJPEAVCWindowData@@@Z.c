/*
 * XREFs of ?_Create3DComponent@CGroupingStoryboard@@IEAAJPEAVCWindowData@@@Z @ 0x180094C4C
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)&rc.right = 0LL;
      ...
      if ( v15 < 0 )
      {
        ...
        v16 = v15;
LABEL_20:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v16, v22);
        goto LABEL_37;
      }
