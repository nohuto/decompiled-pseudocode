/*
 * XREFs of ?EnsureSecondaryWindowVisual@CThumbnailVisual@@QEAAJXZ @ 0x18000BE40
 * Callers:
...
__int64 __fastcall CThumbnailVisual::EnsureSecondaryWindowVisual(CThumbnailVisual *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x30Fu);
  }
  else if ( *((_BYTE *)this + 472) )
  {
    ...
    else
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x314u);
      }
      else
      {
        ...
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x315u);
        }
        else
        {
          ...
          if ( v7 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x316u);
          }
          else if ( CThumbnailVisual::_HasBorder(this)
                 && (v20 = CThumbnailVisual::_AddBorderInstructions(v8), v3 = v20, v20 < 0) )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x319u);
          }
          else
          {
              ...
              if ( v10 )
              {
                ...
                if ( !*(_BYTE *)(*((_QWORD *)this + 46) + 34LL) )
                {
                  ...
                  if ( v14 != 0.0 && v12 != 0.0 )
                  {
                    ...
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, RectangleGeometry, 0x345u);
                      return v3;
                    }
                  ...
                  v3 = v29;
                  if ( v29 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x34Au);
                }
              }
            }
          }
