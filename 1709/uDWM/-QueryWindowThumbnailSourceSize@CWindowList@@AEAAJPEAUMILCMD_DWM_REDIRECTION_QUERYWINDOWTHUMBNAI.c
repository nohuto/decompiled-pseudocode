/*
 * XREFs of ?QueryWindowThumbnailSourceSize@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_QUERYWINDOWTHUMBNAILSOURCESIZE@@@Z @ 0x1800385CC
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_QUERYWINDOWTHUMBNAILSOURCESIZE *a2)
{
  ...
  CBaseObject *v27; // [rsp+88h] [rbp+48h] BYREF
  struct CWindowData *v28; // [rsp+90h] [rbp+50h] BYREF
  struct _RTL_CRITICAL_SECTION *v29; // [rsp+98h] [rbp+58h] BYREF
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowDataByHwnd, 0xD5Au);
    goto LABEL_17;
  }
  v7 = v28;
  if ( !v28 )
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xD63u);
    goto LABEL_17;
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xD6Au);
    goto LABEL_14;
  }
  v25 = *((_DWORD *)v27 + 24);
