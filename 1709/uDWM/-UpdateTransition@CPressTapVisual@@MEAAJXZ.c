/*
 * XREFs of ?UpdateTransition@CPressTapVisual@@MEAAJXZ @ 0x180089D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPressTapVisual::UpdateTransition(CPressTapVisual *this)
{
  ...
  if ( v1 < v3 )
  {
    ...
    v15 = (float)((float)(*((float *)this + 94) - *((float *)this + 93)) * v14) + *((float *)this + 93);
  ...
  {
    v4 = v3 / v1;
    v5 = (float)((float)(*((float *)this + 96) - *((float *)this + 95)) * v4) + *((float *)this + 95);
