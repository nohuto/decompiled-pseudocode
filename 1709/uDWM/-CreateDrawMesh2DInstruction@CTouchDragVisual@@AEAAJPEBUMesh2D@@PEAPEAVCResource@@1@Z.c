/*
 * XREFs of ?CreateDrawMesh2DInstruction@CTouchDragVisual@@AEAAJPEBUMesh2D@@PEAPEAVCResource@@1@Z @ 0x180086ED0
 * Callers:
        ...
        struct CResource **a4)
{
  ...
  if ( v8 >= 0 )
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD, _DWORD, _QWORD, _DWORD))(**((_QWORD **)*a4 + 2) + 1064LL))(
            *((_QWORD *)*a4 + 2),
            *((unsigned int *)*a4 + 6),
            *(_QWORD *)a2,
            *((unsigned int *)a2 + 6),
    ...
    if ( v10 >= 0 )
    {
      v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**((_QWORD **)*a4 + 2) + 968LL))(
              *((_QWORD *)*a4 + 2),
              *((unsigned int *)*a4 + 6),
              0xFFFFFFFFLL);
      v9 = v11;
      if ( v11 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          v13 = *a3;
          v17 = *((_DWORD *)*a4 + 6);
          v14 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, __int64))(**((_QWORD **)v13 + 2) + 1072LL))(
                  *((_QWORD *)v13 + 2),
                  *((unsigned int *)v13 + 6),
                  &v17,
                  1LL);
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x10Cu);
          }
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x10Au);
        }
      }
      else
      {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xFAu);
  }
  if ( v9 < 0 )
  {
    if ( *a4 )
