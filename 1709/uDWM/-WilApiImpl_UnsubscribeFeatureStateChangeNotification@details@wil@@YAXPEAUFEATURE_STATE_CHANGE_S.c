/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x180068530
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( ((unsigned int)this & 0x80000000) != 0 )
  {
    ...
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_1800C1798;
  }
  else
  {
    if ( !wil::details::g_featureStateManager )
  ...
  wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_1800C1720, v2);
}
