/*
 * XREFs of ?_StageCloneRelative@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCVisual@@_N1222PEA_N@Z @ 0x1800071EC
 * Callers:
...
LABEL_10:
  ...
  *(_WORD *)((char *)&v34 + 1) = 257;
  if ( a9 )
  {
    v30 = *a9 && CTransitionVisualController::AllowSnapshotForSWR(*(HWND *)(*(_QWORD *)(v13 + 720) + 40LL));
    *v21 = v30;
    BYTE2(v34) = v30;
  }
