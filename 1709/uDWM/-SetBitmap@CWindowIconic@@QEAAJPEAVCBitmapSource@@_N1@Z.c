/*
 * XREFs of ?SetBitmap@CWindowIconic@@QEAAJPEAVCBitmapSource@@_N1@Z @ 0x180037F4C
 * Callers:
    ...
    if ( CentralImage >= 0 )
    {
      if ( v10 == a3 || (v13 = CWindowIconic::OnWindowStyleUpdated(this, 0), v5 = v13, v13 >= 0) )
      {
        ...
        if ( updated >= 0 )
        {
          ...
          v5 = v15;
          if ( v15 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x254u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x253u);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x24Eu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CentralImage, 0x24Au);
    }
  }
  return v5;
}
