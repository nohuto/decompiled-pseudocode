/*
 * XREFs of ?_AnimateOpaqueVisuals@CLivePreview@@AEAAJPEAVCWindowData@@@Z @ 0x18006A20C
 * Callers:
...
__int64 __fastcall CLivePreview::_AnimateOpaqueVisuals(CLivePreview *this, struct CWindowData *a2, unsigned int a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x2D9u);
      goto LABEL_37;
    }
    v3 = v27;
  }
  ...
  if ( (!v7 || *(_DWORD *)(v7 + 112) == 1) && *((_DWORD *)this + 140) != 4 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x2DEu);
      goto LABEL_37;
    }
    v3 = v27;
  }
...
LABEL_25:
        ...
        if ( (*(_BYTE *)(v12 + 593) & 1) != 0 )
        {
          ...
          if ( MDIOwner )
          {
            if ( !v11 )
            {
              ...
              if ( v17 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x307u);
                goto LABEL_37;
              }
            }
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x315u);
    }
    else
    {
LABEL_35:
      ...
      v6 = started;
      if ( started < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x31Bu);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x2E1u);
  }
LABEL_37:
