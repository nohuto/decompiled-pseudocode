/*
 * XREFs of ?ScheduleStopAnimation@CStoryboard@@QEAAJXZ @ 0x1800947B8
 * Callers:
...
__int64 __fastcall CStoryboard::ScheduleStopAnimation(CStoryboard *this)
{
  ...
  if ( v3 )
  {
    ...
    if ( v5 != -1 )
    {
      ...
      v2 = v6;
      if ( v6 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v6, 0x1592u);
    }
  }
