/*
 * XREFs of ?SnapToAnchor@CTextTetherVisual@@QEAAJXZ @ 0x1800854E0
 * Callers:
...
__int64 __fastcall CTextTetherVisual::SnapToAnchor(CTextTetherVisual *this)
{
  ...
  *((_QWORD *)this + 37) = v6;
  ...
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xF3u);
LABEL_12:
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xF5u);
    goto LABEL_12;
  }
  return v7;
}
