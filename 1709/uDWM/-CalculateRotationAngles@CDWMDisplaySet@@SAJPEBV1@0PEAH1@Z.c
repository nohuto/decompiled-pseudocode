/*
 * XREFs of ?CalculateRotationAngles@CDWMDisplaySet@@SAJPEBV1@0PEAH1@Z @ 0x180068B70
 * Callers:
 ...
 *     ?DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z @ 0x180068C5C (-DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z.c)
 */
        ...
        int *a4)
{
  ...
  if ( ClonePrimaryDisplaysNoRef >= 0 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x28Du);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ClonePrimaryDisplaysNoRef, 0x287u);
  }
