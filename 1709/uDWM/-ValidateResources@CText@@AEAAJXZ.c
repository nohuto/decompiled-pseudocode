/*
 * XREFs of ?ValidateResources@CText@@AEAAJXZ @ 0x1800143BC
 * Callers:
...
__int64 __fastcall CText::ValidateResources(CText *this)
{
  ...
  if ( *((_QWORD *)this + 36) )
  {
    v12 = (CTextCache *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 31);
    if ( v12 )
    {
          ...
          if ( DrawTextW(v6, *((LPCWSTR *)this + 36), -1, &rc, v17 | 0x8404) )
          {
            ...
            if ( Bitmap )
            {
              ...
              if ( SolidBrush )
              {
                ...
                {
                  GdiFlush();
                  v27 = (*(__int64 (__fastcall **)(_QWORD, HBITMAP, _QWORD, __int64, struct IWICBitmap **))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 34) + 168LL))(
                  ...
                  {
                    v27 = CResource::Create(21LL, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (char *)this + 392);
                    v4 = v27;
                    if ( v27 < 0 )
                    {
                      format = 360;
                    ...
                    else
                    {
                      ...
                      if ( v27 >= 0 )
                      {
                        ...
                        if ( v28 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x16Au);
                        }
                        else
                        {
                          ...
                          if ( v30 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x16Cu);
                            v5 = v50;
                          }
                          else
                          {
                            ...
                            if ( v31 >= 0 )
                            {
                              ...
                              if ( v32 < 0 )
                              {
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0x16Eu);
                              }
                              else
                              {
                                ...
                                if ( v33 >= 0 )
                                {
                                  ...
                                  if ( v34 < 0 )
                                  {
                                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x171u);
                                    goto LABEL_6;
                                  }
                                ...
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x170u);
                              }
LABEL_101:
                              v7 = v45;
                              goto LABEL_6;
                            }
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, 0x16Du);
                          }
                        }
                        v1 = v46;
                        goto LABEL_101;
...
LABEL_73:
          ...
          v38 = v4;
LABEL_76:
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, format);
          goto LABEL_77;
        }
      }
    }
...
LABEL_6:
  ...
  if ( v51 )
    ReleaseGDIObject<HRGN__ *>(&v51);
  if ( v52 )
    ReleaseGDIObject<HRGN__ *>(&v52);
  if ( v8 )
