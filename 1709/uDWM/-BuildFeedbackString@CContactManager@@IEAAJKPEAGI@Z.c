/*
 * XREFs of ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x1800805D4
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18003EEAC (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
 */

__int64 __fastcall CContactManager::BuildFeedbackString(size_t **this, char a2, unsigned __int16 *a3, unsigned int a4)
{
  __int64 v4; // rbp
  int v8; // r10d
  char v9; // di
