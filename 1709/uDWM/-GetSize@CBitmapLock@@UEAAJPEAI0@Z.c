/*
 * XREFs of ?GetSize@CBitmapLock@@UEAAJPEAI0@Z @ 0x1800A1910
 * Callers:
 *     ?GetSize@CBitmapLock@@W7EAAJPEAI0@Z @ 0x180046A90 (-GetSize@CBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
...
LABEL_5:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x7Du);
  }
LABEL_12:
