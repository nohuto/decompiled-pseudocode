/*
 * XREFs of ?SetRepresentationType@CWindowIconic@@QEAAJW4IconicRepresentationType@@_N@Z @ 0x1800373C0
 * Callers:
 ...
 *     ??0?$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z @ 0x18007D2E4 (--0-$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z.c)
 */
