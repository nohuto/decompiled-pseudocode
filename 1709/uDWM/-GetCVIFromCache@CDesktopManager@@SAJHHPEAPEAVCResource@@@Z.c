/*
 * XREFs of ?GetCVIFromCache@CDesktopManager@@SAJHHPEAPEAVCResource@@@Z @ 0x18000C150
 * Callers:
...
__int64 __fastcall CDesktopManager::GetCVIFromCache(int a1, int a2, struct CResource **a3)
{
  ...
  if ( CDesktopManager::_IsSameAsTargetCachedCVI(a1, a2) )
  {
    ...
    *a3 = (struct CResource *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + v3 + 88);
    *((_QWORD *)v8 + v3 + 88) = 0LL;
    return 0;
  }
  return v6;
