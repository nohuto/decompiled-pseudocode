/*
 * XREFs of ?DestroyWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800281C0
 * Callers:
...
LABEL_3:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x5BEu);
  if ( v5 < 0 )
  {
LABEL_21:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x63Du);
    goto LABEL_6;
  }
  if ( v4 )
  {
