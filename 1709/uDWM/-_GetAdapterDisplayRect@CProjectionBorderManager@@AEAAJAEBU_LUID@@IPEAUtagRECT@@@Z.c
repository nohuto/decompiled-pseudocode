/*
 * XREFs of ?_GetAdapterDisplayRect@CProjectionBorderManager@@AEAAJAEBU_LUID@@IPEAUtagRECT@@@Z @ 0x18007485C
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  *(_QWORD *)&a4->right = 0LL;
      ...
      if ( modeInfoArray )
      {
        ...
        else
        {
          ...
          if ( (_DWORD)numPathArrayElements )
          {
            ...
            v18 = v17;
            v19 = (unsigned __int64)v7[v17].sourceInfo.modeInfoIdx << 6;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DisplayConfigBufferSizes, 0x12u);
  }
LABEL_25:
