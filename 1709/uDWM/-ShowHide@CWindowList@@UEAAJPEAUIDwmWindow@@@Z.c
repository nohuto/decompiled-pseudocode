/*
 * XREFs of ?ShowHide@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180028580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ShowHide(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x754u);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      ...
      if ( v7 != (*((_BYTE *)v6 + 592) & 1) )
      {
        *((_BYTE *)v6 + 592) ^= (v7 ^ *((_BYTE *)v6 + 592)) & 1;
        ...
        v5 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x75Eu);
      }
    }
  }
