/*
 * XREFs of ?_UpdateClipping@CTransitionVisualController@@IEAAXPEAVCAnimationComponent@@@Z @ 0x180005F60
 * Callers:
...
LABEL_6:
  ...
  if ( !*(_BYTE *)(v7 + 986) )
  {
    v8 = CTransitionVisualController::_SetAnimationClipRegion(
           (CTransitionVisualController *)-v7,
           (struct CVisual *)((v7 + 8) & -(__int64)(v7 != 0)),
           &v14);
