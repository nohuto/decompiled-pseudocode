/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x180088D8C
 * Callers:
...
__int64 __fastcall CFlickVisual::Start(__int64 a1, POINT *a2, int a3, int a4)
{
  ...
  *(_QWORD *)(a1 + 352) = v11;
  ...
  if ( v13 >= 0 )
  {
    ...
    {
      v12 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x6Eu);
LABEL_40:
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BitmapFromAtlas, 0x75u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x42u);
  }
  if ( v12 < 0 )
    goto LABEL_40;
  return (unsigned int)v12;
