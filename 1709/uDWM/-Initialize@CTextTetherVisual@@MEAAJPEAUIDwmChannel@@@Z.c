/*
 * XREFs of ?Initialize@CTextTetherVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x180085280
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v18 >= 0 )
              {
                ...
                if ( v19 >= 0 )
                {
                  ...
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x4Cu);
                  }
                }
                else
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x48u);
                }
              }
              else
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x47u);
              }
            }
            else
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x45u);
            }
          }
          else
          {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x3Eu);
        }
      }
      else
      {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BitmapFromAtlas, 0x3Au);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x36u);
  }
  return v5;
}
