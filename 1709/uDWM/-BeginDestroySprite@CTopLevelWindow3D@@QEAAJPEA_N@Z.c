/*
 * XREFs of ?BeginDestroySprite@CTopLevelWindow3D@@QEAAJPEA_N@Z @ 0x180022CD4
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::BeginDestroySprite(CTopLevelWindow3D *this, bool *a2)
{
  ...
  if ( CTopLevelWindow3D::ShouldDelayTransition(this, 0) )
  {
    ...
    if ( started < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x126u);
      goto LABEL_3;
    }
    goto LABEL_8;
  }
    ...
    && !CTopLevelWindow3D::IsWindowInSystemArrangementAnimation(this) )
  {
    if ( !*((_QWORD *)this + 45) || *((_DWORD *)this + 92) != 3 )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x131u);
        goto LABEL_3;
      }
    }
LABEL_8:
