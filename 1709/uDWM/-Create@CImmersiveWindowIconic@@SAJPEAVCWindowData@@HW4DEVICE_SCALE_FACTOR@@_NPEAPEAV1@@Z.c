/*
 * XREFs of ?Create@CImmersiveWindowIconic@@SAJPEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@_NPEAPEAV1@@Z @ 0x180071C20
 * Callers:
        ...
        struct CImmersiveWindowIconic **a5)
{
  ...
  if ( v10 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x24u);
    }
    if ( v10 )
    {
