/*
 * XREFs of ?Initialize@CCubicBezierInterpolator@@IEAAJNPEANI@Z @ 0x18008FFD4
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *((_QWORD *)this + 2) = v10;
  if ( !v10 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xDBu);
LABEL_11:
  ...
  *((_QWORD *)this + 3) = v12;
  if ( !v12 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xDEu);
    goto LABEL_11;
  }
  ...
  *((_QWORD *)this + 8) = v13;
  if ( !v13 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xE1u);
    goto LABEL_11;
  }
  if ( a4 )
  {
