/*
 * XREFs of ?Activate@CLivePreview@@QEAAJ_NPEAUHWND__@@1W4LIVEPREVIEW_TRIGGER@@I0PEAUtagRECT@@@Z @ 0x180034B78
 * Callers:
 ...
 *     ?_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ @ 0x18006B684 (-_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ.c)
...
LABEL_29:
        ...
        if ( a2 )
        {
          ...
          *(_QWORD *)(a1 + 544) = CWindowList::FindWindowDataByHwnd(*((CWindowList **)v22 + 57), a4);
          *(_DWORD *)(a1 + 560) = a5;
          ...
          else
          {
            ...
            *(_WORD *)(a1 + 280) = 257;
            ...
            if ( *(_DWORD *)(a1 + 328) )
            {
              ...
              NotifyWinEvent(0x21u, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 80), 0, 0);
            }
          }
    ...
    if ( *(_DWORD *)(a1 + 328) )
    {
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
        McTemplateU0(&Microsoft_Windows_Dwm_Udwm_Provider_Context, &UdwmLivePreviewAnimation_Start);
      NotifyWinEvent(0x22u, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 80), 0, 0);
    }
