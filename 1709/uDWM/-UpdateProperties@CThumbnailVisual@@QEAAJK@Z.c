/*
 * XREFs of ?UpdateProperties@CThumbnailVisual@@QEAAJK@Z @ 0x18001019C
 * Callers:
...
__int64 __fastcall CThumbnailVisual::UpdateProperties(CThumbnailVisual *this, int a2)
{
  ...
  if ( updated < 0 && (v2 & 1) != 0 && *((_QWORD *)this + 46) )
  {
    ...
    {
      v54 = *(struct tagSIZE *)(*((_QWORD *)this + 46) + 40LL);
      CVisual::SetOffset(this, (const struct tagPOINT *)&v54);
    }
    ...
    if ( *((_QWORD *)this + 47) && *((_QWORD *)this + 54) )
    {
      ...
      if ( (*(_BYTE *)(v39 + 36) & 3) == 3 && *((_BYTE *)this + 474) )
      {
        ...
        if ( *(_DWORD *)(v39 + 48) - *(_DWORD *)(v39 + 40) >= 0 )
          v41 = *(_DWORD *)(v39 + 48) - *(_DWORD *)(v39 + 40);
        v42 = 0;
        if ( *(_DWORD *)(v39 + 64) - *(_DWORD *)(v39 + 56) >= 0 )
          v42 = *(_DWORD *)(v39 + 64) - *(_DWORD *)(v39 + 56);
        if ( v41 == v42 )
        {
          v43 = *(_DWORD *)(v39 + 52) - *(_DWORD *)(v39 + 44);
          v44 = *(_DWORD *)(v39 + 68) - *(_DWORD *)(v39 + 60);
          v45 = 0;
          if ( v43 >= 0 )
            v45 = v43;
          v46 = 0;
          if ( v44 >= 0 )
            v46 = v44;
          if ( v45 == v46 && v41 == *((_DWORD *)this + 127) )
            v40 = v45 == *((_DWORD *)this + 128);
        }
      }
      ...
      v47 = (CBaseObject *)*((_QWORD *)this + 48);
      if ( v47 )
      {
...
LABEL_61:
    ...
    DynArray<CThumbnailData *,0>::Remove(*(_QWORD *)&(*v18)[3] + 512LL, (char *)this + 368);
    v22 = (__m128i *)v54;
    v23 = v53;
    v24 = *(_QWORD *)&v54 + 512LL;
    (*v18)[3] = v54;
    ...
    {
      v34 = DynArrayImpl<0>::AddMultipleAndSet(v24, 8LL, 1LL, (char *)this + 368);
      v3 = v34;
      if ( v34 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0xC0u);
    }
    else
    {
...
LABEL_84:
    v36 = v3;
LABEL_86:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, v52);
    goto LABEL_38;
  }
LABEL_34:
  if ( (v2 & 0x800000) != 0 )
  {
    ...
    v49 = (CBaseObject *)*((_QWORD *)this + 54);
    if ( v49 )
    {
      CBaseObject::Release(v49);
      *((_QWORD *)this + 54) = 0LL;
    }
    v50 = (CBaseObject *)*((_QWORD *)this + 47);
    if ( v50 )
    {
...
LABEL_38:
  if ( v3 < 0 )
  {
    v51 = (CBaseObject *)*((_QWORD *)this + 58);
    if ( v51 )
    {
