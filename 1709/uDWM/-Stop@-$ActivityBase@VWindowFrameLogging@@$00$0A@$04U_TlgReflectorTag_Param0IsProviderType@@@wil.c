/*
 * XREFs of ?Stop@?$ActivityBase@VWindowFrameLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18000A24C
 * Callers:
        ...
        unsigned int a2)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v7 > 5u )
    {
      ...
      p_SRWLock = &SRWLock;
      v16 = 4;
      TlgWrite(v7, &unk_1800ADEA6, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
