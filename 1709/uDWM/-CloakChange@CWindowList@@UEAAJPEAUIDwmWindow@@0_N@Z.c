/*
 * XREFs of ?CloakChange@CWindowList@@UEAAJPEAUIDwmWindow@@0_N@Z @ 0x18002AA70
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a4 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            v9 = 0;
            v18 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 60);
            ...
            if ( (_BYTE)v17 )
            {
              ...
              v9 = v24;
              if ( v24 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x3F6u);
            }
            if ( v9 < 0 )
            {
              v25 = 4678;
