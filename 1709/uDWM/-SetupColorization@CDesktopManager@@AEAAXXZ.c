/*
 * XREFs of ?SetupColorization@CDesktopManager@@AEAAXXZ @ 0x18003BC70
 * Callers:
...
void __fastcall CDesktopManager::SetupColorization(CDesktopManager *this)
{
  ...
  *((_DWORD *)this + 130) = 1;
  ...
  v10[11] = (char *)this + 520;
  v10[12] = L"ColorizationGlassAttribute";
  v10[13] = (char *)this + 524;
...
LABEL_14:
    if ( (unsigned __int8)CDesktopManager::CheckAnyPolicy(4u) )
    {
      ...
      *((_DWORD *)v1 + 5) = 1;
      *(_DWORD *)v1 = v5;
      *((_DWORD *)this + 127) = v3 / 0xFF;
      *((_DWORD *)this + 129) = 100 - v3 / 0xFF;
    }
  }
  if ( *((_DWORD *)this + 127) > 0x64u )
    *((_DWORD *)this + 127) = 27;
  if ( *((_DWORD *)this + 128) > 0x64u )
    *((_DWORD *)this + 128) = 0;
  if ( *((_DWORD *)this + 129) > 0x64u )
    *((_DWORD *)this + 129) = 73;
