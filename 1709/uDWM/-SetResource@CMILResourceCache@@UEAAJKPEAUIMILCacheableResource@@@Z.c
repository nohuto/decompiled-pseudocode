/*
 * XREFs of ?SetResource@CMILResourceCache@@UEAAJKPEAUIMILCacheableResource@@@Z @ 0x1800A2020
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IMILCacheableResource *a3)
{
    ...
    || (v10 = CMILResourceCache::EnsureCount(this, (int)v4 + 1), v3 = v10, v10 >= 0) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x233u);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x228u);
  }
