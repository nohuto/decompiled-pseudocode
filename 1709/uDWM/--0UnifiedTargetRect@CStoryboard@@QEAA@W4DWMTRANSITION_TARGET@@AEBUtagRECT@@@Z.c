/*
 * XREFs of ??0UnifiedTargetRect@CStoryboard@@QEAA@W4DWMTRANSITION_TARGET@@AEBUtagRECT@@@Z @ 0x180092898
 * Callers:
...
__int64 __fastcall CStoryboard::UnifiedTargetRect::UnifiedTargetRect(__int64 a1, __int16 a2, _OWORD *a3)
{
  ...
  *(_OWORD *)(a1 + 4) = *a3;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7 < (unsigned int)v6 ? 0x80070216 : 0, 0xB5u);
  }
  return a1;
}
