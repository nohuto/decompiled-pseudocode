/*
 * XREFs of ?_CreateAndAddAnimationComponentControlReuse@CStoryboard@@IEAAJPEAVCWindowData@@_NHPEAUtagRECT@@2H1PEAPEAVCAnimationComponent@@@Z @ 0x180004820
 * Callers:
        ...
        struct CAnimationComponent **a9)
{
  ...
  int v17; // eax
  bool v19; // [rsp+48h] [rbp-20h]
  struct CAnimationComponent *v20; // [rsp+78h] [rbp+10h] BYREF
  ...
  if ( ((*(__int64 (__fastcall **)(CStoryboard *, _QWORD))(*(_QWORD *)this + 96LL))(this, *((_DWORD *)a2 + 150) & 0xFFF) & 4) != 0 )
    *((_DWORD *)a2 + 150) |= 0x4000000u;
  LOBYTE(v13) = a3;
  v19 = a8;
  v14 = CTransitionVisualController::CreateAnimationComponent(
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v14, 0x149Fu);
LABEL_8:
    v16 = (volatile signed __int32 *)v20;
    goto LABEL_9;
  }
  v16 = (volatile signed __int32 *)v20;
  v17 = CStoryboard::_AddAnimationComponent(this, v20);
  v15 = v17;
  if ( v17 >= 0 )
  {
    *a9 = (struct CAnimationComponent *)v16;
    if ( !v16 )
      return v15;
    _InterlockedIncrement(v16 + 2);
    goto LABEL_8;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v17, 0x14A0u);
LABEL_9:
  if ( v16 )
