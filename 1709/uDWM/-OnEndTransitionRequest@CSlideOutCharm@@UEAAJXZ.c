/*
 * XREFs of ?OnEndTransitionRequest@CSlideOutCharm@@UEAAJXZ @ 0x180094240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetGhost@CAnimationComponent@@QEAAXXZ @ 0x18009AE70 (-SetGhost@CAnimationComponent@@QEAAXXZ.c)
 */
