/*
 * XREFs of ?UpdateOcclusionHints@CTopLevelWindow@@QEAAJXZ @ 0x18001BB00
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateOcclusionHints(CTopLevelWindow *this)
{
    ...
    && (*((_DWORD *)this + 151) || *((_DWORD *)this + 153) || *((_DWORD *)this + 152) || *((_DWORD *)this + 154)) )
  {
    ...
    if ( (*(_BYTE *)(v11 + 593) & 0x20) != 0 && *(_DWORD *)(v11 + 152) != 2 && (*(_DWORD *)(v11 + 104) & 0x200000) == 0 )
    {
      ...
      v16 = *(_OWORD *)((char *)v12 + 500);
      v41 = *((_DWORD *)v12 + 131);
      v17 = *(_QWORD *)((char *)v12 + 516);
      v18 = *((_DWORD *)v12 + 116);
      v39 = v16;
      v38 = v18;
      v40 = v17;
      ...
      if ( v26 )
      {
        ...
        *(_QWORD *)&v37.left = v27;
        ...
        v29 = DynArray<CRenderDataInstruction *,0>::AddMultipleAndSet((char *)v28 + 248, &v37);
        v30 = v29;
        if ( v29 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x2Cu);
        }
        else
        {
        ...
        v2 = v30;
        if ( v30 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0xE87u);
      ...
      else
      {
        ...
        v2 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xE85u);
      }
    }
  }
  return v2;
