/*
 * XREFs of ?_EnsureCVIResource@CTransitionWindowSnapshot@@AEAAJPEBUtagRECT@@@Z @ 0x18000C3D0
 * Callers:
        ...
        const struct tagRECT *a2)
{
  ...
  if ( !*((_QWORD *)this + 36) )
  {
    ...
    {
      v10 = CResource::Create(5LL, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (char *)this + 288);
      v11 = v10;
      if ( v10 < 0 )
      {
...
LABEL_33:
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *, double *, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)*v7 + 2) + 992LL))(
          *((_QWORD *)*v7 + 2),
          *((unsigned int *)*v7 + 6),
          v29,
          &v27,
  ...
  v19 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, double *))(**((_QWORD **)*v7 + 2) + 1008LL))(
          *((_QWORD *)*v7 + 2),
          *((unsigned int *)*v7 + 6),
          &v27);
  v11 = v19;
