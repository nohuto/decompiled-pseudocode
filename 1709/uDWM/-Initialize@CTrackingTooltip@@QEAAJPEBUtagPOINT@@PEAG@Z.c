/*
 * XREFs of ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x180088AB0
 * Callers:
 ...
 * Callees:
 *     ?CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z @ 0x1800889E0 (-CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z.c)
 *     ?UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ @ 0x180088BA8 (-UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ.c)
 */
