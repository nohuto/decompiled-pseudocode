/*
 * XREFs of ?UpdateOutputDuplication@CProjectionBorderManager@@UEAAJPEBU_D3DKMT_OUTPUTDUPL_LOWBOX_CONTEXTS_@@@Z @ 0x180074420
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_FindProjectionVisualByAdapter@CProjectionBorderManager@@AEAAHAEBU_LUID@@I@Z @ 0x18007477C (-_FindProjectionVisualByAdapter@CProjectionBorderManager@@AEAAHAEBU_LUID@@I@Z.c)
...
LABEL_27:
  ...
  if ( ProjectionVisualByAdapter == -1 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x82u);
      goto LABEL_31;
    }
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x84u);
      goto LABEL_31;
    }
...
LABEL_24:
  ...
  if ( inserted >= 0 )
    goto LABEL_24;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0xAEu);
LABEL_29:
  if ( ProjectionVisualByAdapter != -1 )
