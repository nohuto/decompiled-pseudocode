/*
 * XREFs of ?DrawStateW@CButton@@AEAAJPEAVCAtlasButton@@W4ButtonStates@1@@Z @ 0x180015C6C
 * Callers:
...
__int64 __fastcall CButton::DrawStateW(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  CAtlasButton::SetGlyphImage(
    ...
    v8,
    v11,
    (unsigned int)(int)((double)*(int *)(a1 + 408) * *((double *)CDesktopManager::s_pDesktopManagerInstance + 56)));
