/*
 * XREFs of ?RemoveAllElements@?$CGenericTableMap@W4IMMERSIVE_COLOR_TYPE@@UColorData@ColorCache@@@@QEAAXXZ @ 0x1800450A4
 * Callers:
 *     _dynamic_atexit_destructor_for__ColorCache::_cachedColors__ @ 0x180046E70 (_dynamic_atexit_destructor_for__ColorCache--_cachedColors__.c)
 * Callees:
 *     <none>
 */
