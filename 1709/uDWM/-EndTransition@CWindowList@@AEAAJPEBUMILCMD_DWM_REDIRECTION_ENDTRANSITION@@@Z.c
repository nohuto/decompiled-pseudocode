/*
 * XREFs of ?EndTransition@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_ENDTRANSITION@@@Z @ 0x1800079D0
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_ENDTRANSITION *a2)
{
  ...
  if ( v4 != -1 )
  {
    ...
    v6 = (CAnimationScheduler *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 28);
    EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
