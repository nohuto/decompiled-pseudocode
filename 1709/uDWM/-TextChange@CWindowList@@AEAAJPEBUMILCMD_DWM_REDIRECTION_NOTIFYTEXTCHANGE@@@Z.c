/*
 * XREFs of ?TextChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYTEXTCHANGE@@@Z @ 0x180026744
 * Callers:
...
__int64 __fastcall CWindowList::TextChange(CWindowList *this, const struct MILCMD_DWM_REDIRECTION_NOTIFYTEXTCHANGE *a2)
{
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x9A9u);
  }
  else if ( v7 )
  {
...
LABEL_16:
    ...
    v14 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 60);
    v15 = *(_DWORD *)(v14 + 360);
    if ( v15 )
    {
      v17 = *(_QWORD *)(v14 + 336);
