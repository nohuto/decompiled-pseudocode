/*
 * XREFs of ?EnsureSnapshot@CTransitionVisualController@@QEAAJPEAVCWindowData@@@Z @ 0x1800051A0
 * Callers:
...
LABEL_20:
  if ( v2 )
  {
    ...
    {
      v22 = DynArrayImpl<0>::AddMultipleAndSet(v17, 16LL, 1LL, &v32);
      inserted = v22;
      if ( v22 < 0 )
...
LABEL_31:
          ...
          {
            EtwppTemplate_q(&Microsoft_Windows_Dwm_Udwm_Provider_Context, &EtwTraceInfo_9009, v2);
          }
