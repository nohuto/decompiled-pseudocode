/*
 * XREFs of ?_WindowEnumCallback@CCrossFade@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180098AB0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 != 18 )
  {
    switch ( *(_DWORD *)(a2 + 600) & 0xFFF )
    {
      ...
      case 61:
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v15, 0x685u);
          goto LABEL_16;
        }
LABEL_9:
...
LABEL_22:
  ...
  if ( v17 >= 0 )
    goto LABEL_9;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v17, 0x67Du);
LABEL_16:
  if ( v19 )
