/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x18003ADC0
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeMargins, 0x385u);
      return v4;
    }
    if ( *(_DWORD *)(v20 + 24) )
    {
...
LABEL_31:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x384u);
  return v4;
}
