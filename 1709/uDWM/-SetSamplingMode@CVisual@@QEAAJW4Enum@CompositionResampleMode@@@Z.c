/*
 * XREFs of ?SetSamplingMode@CVisual@@QEAAJW4Enum@CompositionResampleMode@@@Z @ 0x18003DC4C
 * Callers:
...
__int64 __fastcall CVisual::SetSamplingMode(__int64 a1, unsigned int a2)
{
  ...
  v2 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(a1 + 16) + 16LL) + 1208LL))(
         *(_QWORD *)(*(_QWORD *)(a1 + 16) + 16LL),
         *(unsigned int *)(*(_QWORD *)(a1 + 16) + 24LL),
         a2);
  v3 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x2BEu);
  return v3;
}
