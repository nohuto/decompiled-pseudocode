/*
 * XREFs of ?Start@CRippleEffect@@QEAAJPEBUtagPOINT@@M@Z @ 0x18007EFE0
 * Callers:
...
__int64 __fastcall CRippleEffect::Start(CRippleEffect *this, const struct tagPOINT *a2, float a3)
{
  ...
  {
    v5 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467261, 0x67u);
    goto LABEL_17;
  }
  ...
  *((_DWORD *)this + 62) = v8;
  v10 = MulDiv(v9, v6, 96);
  v11 = (struct tagSIZE *)*((_QWORD *)this + 35);
  *((_DWORD *)this + 63) = v10;
  ...
  *((_QWORD *)this + 33) = v16;
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x75u);
LABEL_17:
  ...
  if ( v17 >= 0 )
  {
    ...
    *((struct tagPOINT *)this + 30) = *a2;
    v20 = *((_DWORD *)this + 61);
    *((float *)this + 64) = a3;
    v21 = v20 - *((_DWORD *)this + 63) / 2;
    CVisual::SetInsetFromParentLeft(*((CVisual **)this + 35), v18.x - v19 / 2);
    CVisual::SetInsetFromParentTop(*((CVisual **)this + 35), v21);
    (*(void (__fastcall **)(CRippleEffect *))(*(_QWORD *)this + 88LL))(this);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x77u);
  }
  if ( v5 < 0 )
    goto LABEL_17;
  return (unsigned int)v5;
