/*
 * XREFs of ?OnShowContact@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_SHOWCONTACT@@@Z @ 0x1800824C0
 * Callers:
 ...
 *     ?UpdateShowContact@CDirectTouchVisual@@QEAAJW4DWM_SHOWCONTACT@@@Z @ 0x180084444 (-UpdateShowContact@CDirectTouchVisual@@QEAAJW4DWM_SHOWCONTACT@@@Z.c)
  ...
  else
  {
    ...
    *(_DWORD *)((char *)v9 + v10 + 40) = *((_DWORD *)a2 + 2);
    ...
    else
    {
      ...
      if ( (_DWORD)v14 )
      {
        v18 = *(_QWORD *)(v10 + v11 + 48);
        if ( v18 )
          CDirectTouchVisual::UpdateShowContact(v18, v14, v4, v7);
        v19 = *(_QWORD *)(v10 + *((_QWORD *)this + 7) + 88);
        if ( v19 )
          CTouchDragVisual::UpdateShowContact(v19, *((unsigned int *)a2 + 2), v4, v7);
      }
      else
      {
        v15 = *(struct CTouchVisual **)(v10 + v11 + 48);
      ...
      v20 = *((_QWORD *)this + 7);
      if ( *(_QWORD *)(v10 + v20 + 56) )
        *(_DWORD *)(*(_QWORD *)(v10 + v20 + 56) + 348LL) = *((_DWORD *)a2 + 2);
    }
  }
