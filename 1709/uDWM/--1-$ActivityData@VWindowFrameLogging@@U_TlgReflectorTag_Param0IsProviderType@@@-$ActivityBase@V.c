/*
 * XREFs of ??1?$ActivityData@VWindowFrameLogging@@U_TlgReflectorTag_Param0IsProviderType@@@?$ActivityBase@VWindowFrameLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAA@XZ @ 0x18000A838
 * Callers:
 ...
 *     ?reset@shared_buffer@details@wil@@QEAAXXZ @ 0x18000C090 (-reset@shared_buffer@details@wil@@QEAAXXZ.c)
