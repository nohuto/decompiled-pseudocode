/*
 * XREFs of ?IsEquivalentRotated@CDWMDisplaySet@@QEBA_NPEBV1@@Z @ 0x1800328D0
 * Callers:
 ...
 *     ?IsRenderTargetEquivalentTo@CDWMDisplay@@QEBA_NPEBV1@@Z @ 0x180033A7C (-IsRenderTargetEquivalentTo@CDWMDisplay@@QEBA_NPEBV1@@Z.c)
 *     ??1CDWMDisplay@@AEAA@XZ @ 0x180033AD4 (--1CDWMDisplay@@AEAA@XZ.c)
 *     __security_check_cookie @ 0x180045230 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180046790 (_guard_dispatch_icall_nop.c)
 *     ??4CDWMDisplay@@QEAAAEAV0@AEBV0@@Z @ 0x180067CC0 (--4CDWMDisplay@@QEAAAEAV0@AEBV0@@Z.c)
