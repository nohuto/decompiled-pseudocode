/*
 * XREFs of ?_OnBeginAnimationClock@CAnimationScheduler@@AEAAJPEAVCStoryboard@@PEBU_GUID@@PEAU3@@Z @ 0x180004090
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  do
  {
    ...
    {
      v12 = 5LL * v9;
      v21 = *(_QWORD *)&dword_1800BE2E0[10 * v9 + 1] - *(_QWORD *)&GUID_NULL.Data1;
      if ( !v21 )
        v21 = *(_QWORD *)&dword_1800BE2E0[10 * v9 + 3] - *(_QWORD *)GUID_NULL.Data4;
      if ( !v21 )
        goto LABEL_25;
      if ( a3 )
      {
        v22 = *(_QWORD *)&dword_1800BE2E0[10 * v9 + 1] - *(_QWORD *)&a3->Data1;
        if ( !v22 )
          v22 = *(_QWORD *)&dword_1800BE2E0[10 * v9 + 3] - *(_QWORD *)a3->Data4;
        if ( !v22 )
        {
LABEL_25:
          v13 = *(GUID *)&dword_1800BE2E0[10 * v9 + 5];
          v8 = dword_1800BE2E0[10 * v9 + 9];
          pguid = v13;
          goto LABEL_6;
        }
      }
