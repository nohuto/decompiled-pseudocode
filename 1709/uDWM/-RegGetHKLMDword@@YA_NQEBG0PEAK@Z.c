/*
 * XREFs of ?RegGetHKLMDword@@YA_NQEBG0PEAK@Z @ 0x180044D50
 * Callers:
 *     ?ForceHighColor@@YAKXZ @ 0x1800340EC (-ForceHighColor@@YAKXZ.c)
 *     ?MilInstrumentationBreak@@YAXK_N@Z @ 0x18009FB50 (-MilInstrumentationBreak@@YAXK_N@Z.c)
 * Callees:
 *     ?RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z @ 0x180044DC0 (-RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z.c)
 */
