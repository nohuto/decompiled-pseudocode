/*
 * XREFs of ?_StopAnimations@CTransitionVisualController@@IEAAXPEAVCWindowData@@@Z @ 0x180006D9C
 * Callers:
...
void __fastcall CTransitionVisualController::_StopAnimations(CTransitionVisualController *this, HWND *a2)
{
  ...
  if ( WindowDataByHwnd )
  {
    v3 = (CTopLevelWindow3D *)*((_QWORD *)WindowDataByHwnd + 51);
    if ( v3 )
    {
      CTopLevelWindow3D::StopAnimation(v3);
      v5 = *((_DWORD *)WindowDataByHwnd + 150);
