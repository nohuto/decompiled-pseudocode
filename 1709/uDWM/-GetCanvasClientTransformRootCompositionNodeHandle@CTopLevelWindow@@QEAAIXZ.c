/*
 * XREFs of ?GetCanvasClientTransformRootCompositionNodeHandle@CTopLevelWindow@@QEAAIXZ @ 0x180078608
 * Callers:
...
__int64 __fastcall CTopLevelWindow::GetCanvasClientTransformRootCompositionNodeHandle(CTopLevelWindow *this)
{
  __int64 v1; // rcx
  __int64 result; // rax
  __int64 v3; // rcx
