/*
 * XREFs of ?UpdateTransition@CTouchPressHoldVisual@@MEAAJXZ @ 0x18009DCF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StopAllTimelines@CTouchPressHoldVisual@@IEAAXXZ @ 0x18009D638 (-StopAllTimelines@CTouchPressHoldVisual@@IEAAXXZ.c)
