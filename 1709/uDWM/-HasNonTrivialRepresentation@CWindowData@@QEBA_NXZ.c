/*
 * XREFs of ?HasNonTrivialRepresentation@CWindowData@@QEBA_NXZ @ 0x1800112B8
 * Callers:
 ...
 *     ?IsSplashScreen@CWindowData@@QEBA_NXZ @ 0x180010DEC (-IsSplashScreen@CWindowData@@QEBA_NXZ.c)
 */
...
bool __fastcall CWindowData::HasNonTrivialRepresentation(CWindowData *this)
{
  ...
  if ( CWindowData::IsImmersiveWindow(this) )
    return (*((_BYTE *)this + 596) & 0x10) == 0 || CWindowData::IsSplashScreen(this);
  if ( !*((_QWORD *)this + 50) )
    return 0;
  v3 = 1;
  ...
  if ( !*((_QWORD *)this + 48) && (*((_BYTE *)this + 593) & 0x10) == 0 && (*((_DWORD *)this + 26) & 0x200000) == 0 )
    return 0;
  if ( (*((_DWORD *)this + 25) & 0x20000000) != 0 )
  {
    ...
    if ( v6 <= SystemMetrics )
    {
      v7 = *((_DWORD *)this + 50) - *((_DWORD *)this + 48);
