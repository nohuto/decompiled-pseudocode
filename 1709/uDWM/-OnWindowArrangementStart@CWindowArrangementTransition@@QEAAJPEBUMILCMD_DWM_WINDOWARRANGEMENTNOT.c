/*
 * XREFs of ?OnWindowArrangementStart@CWindowArrangementTransition@@QEAAJPEBUMILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION@@@Z @ 0x18007F59C
 * Callers:
        ...
        const struct MILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION *a2)
{
  ...
  int v25; // eax
  int v26; // eax
  struct tagRECT v28; // [rsp+30h] [rbp-18h] BYREF
  ...
  *((_BYTE *)this + 24) = 0;
  ...
  if ( WindowDataByHwnd && CWindowArrangementTransition::ShouldShowTransition(v6, WindowDataByHwnd) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x70u);
    }
    else
    {
      ...
      if ( inserted >= 0 )
      {
        ...
        if ( v14 )
        {
          ...
          if ( v15 )
          {
            ...
            if ( v16 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x78u);
              return v4;
            }
          }
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x7Au);
            return v4;
          }
        }
        ...
        {
          started = CAnimatedGlassSheet::StartRectAnimation(v20, &v28, v18, 0.2);
          v4 = started;
          if ( started < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x83u);
            return v4;
          }
          ...
          if ( updated < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x84u);
            return v4;
          }
          v23 = this[1];
          if ( v23 )
          {
            ...
            if ( v24 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x87u);
              return v4;
            }
          }
        }
        ...
        {
          v25 = CAnimatedGlassSheet::StartRectAnimation(v20, &v28, v18, 0.000001);
          v4 = v25;
          if ( v25 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0x92u);
            return v4;
          }
          ...
          if ( v26 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x93u);
            return v4;
          }
        }
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x72u);
      }
    }
  }
  return v4;
