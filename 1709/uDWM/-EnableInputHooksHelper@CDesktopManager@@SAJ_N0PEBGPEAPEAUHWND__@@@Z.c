/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x18006E1B4
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( !a1 )
  {
    ...
    v15 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 81);
    if ( v15 )
    {
      if ( IsWindow(v15) )
        CDesktopManager::SetForegroundWindowAsync(*a4, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 81), v16);
...
LABEL_18:
  ...
  {
    v19 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 404);
    v8 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 412);
    v9 = v19;
  }
  ...
  if ( WindowInBand )
  {
    *a4 = WindowInBand;
    ...
    if ( a2 )
      return v4;
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 81) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800AEFE0, 2u, v13, 0xA1Bu);
    }
    goto LABEL_18;
  }
  v4 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800AEFE0, 2u, -2147024890, 0xA0Au);
LABEL_19:
  if ( a1 )
