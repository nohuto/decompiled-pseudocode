/*
 * XREFs of ?OnSetMagnifierSamplingMode@CMagnifier@@QEAAJW4Enum@MilMagnifierSamplingMode@@@Z @ 0x180072D88
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetMagnifierSamplingMode(__int64 a1, int a2)
{
  ...
  if ( a2 != 1 )
    v2 = 0LL;
  v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(*(_QWORD *)(a1 + 32) + 16LL) + 1216LL))(
         *(_QWORD *)(*(_QWORD *)(a1 + 32) + 16LL),
         *(unsigned int *)(*(_QWORD *)(a1 + 32) + 24LL),
         v2);
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x1E1u);
  return v4;
}
