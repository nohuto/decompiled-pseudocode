/*
 * XREFs of ?UpdateInstructions@CTetherVisual@@IEAAJXZ @ 0x18008825C
 * Callers:
...
__int64 __fastcall CTetherVisual::UpdateInstructions(CTetherVisual *this)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xD9u);
    goto LABEL_26;
  }
  if ( !*((_QWORD *)this + 50) )
  {
    ...
    v11 = CResource::Create(0x17u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), v2);
    v10 = v11;
    if ( v11 >= 0 )
    {
      v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, __int64, int, __int64, int, __int64, int))(**((_QWORD **)*v2 + 2) + 1064LL))(
              *((_QWORD *)*v2 + 2),
              *((unsigned int *)*v2 + 6),
              v20[0],
              v21,
      ...
      if ( v12 >= 0 )
      {
        v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**((_QWORD **)*v2 + 2) + 968LL))(
                *((_QWORD *)*v2 + 2),
                *((unsigned int *)*v2 + 6),
                0xFFFFFFFFLL);
        v10 = v13;
        if ( v13 >= 0 )
        {
          ...
          if ( v14 >= 0 )
          {
            v15 = *v5;
            v28 = *((_DWORD *)*v2 + 6);
            v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, __int64))(**((_QWORD **)v15 + 2) + 1072LL))(
                    *((_QWORD *)v15 + 2),
                    *((unsigned int *)v15 + 6),
                    &v28,
                    1LL);
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v17 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0xF3u);
            ...
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0xF2u);
            }
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0xF0u);
          }
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0xEEu);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0xEAu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xE0u);
    }
    Mesh2D::~Mesh2D((Mesh2D *)v20);
  }
LABEL_26:
