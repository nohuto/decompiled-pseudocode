/*
 * XREFs of ?ReportFailure_Win32@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K@Z @ 0x180069324
 * Callers:
        ...
        int a8)
{
  ...
  if ( wil::details::g_pfnOriginateCallback )
    wil::details::g_pfnOriginateCallback(a7, v8);
  wil::details::ReportFailure(a1, a2, a3, 0LL, 0LL, a6, a7, v8);
  return v8;
}
