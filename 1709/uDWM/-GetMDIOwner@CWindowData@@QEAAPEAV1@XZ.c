/*
 * XREFs of ?GetMDIOwner@CWindowData@@QEAAPEAV1@XZ @ 0x18007B644
 * Callers:
...
struct CWindowData *__fastcall CWindowData::GetMDIOwner(HWND *this)
{
  ...
  if ( PropW )
    return CWindowList::FindWindowDataByHwnd(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 57), PropW);
