/*
 * XREFs of ?UpdateSizeOrMargins@CWindowIconic@@AEAAJ_N@Z @ 0x180037414
 * Callers:
...
__int64 __fastcall CWindowIconic::UpdateSizeOrMargins(CWindowIconic *this, char a2)
{
  ...
  *(_QWORD *)&Rect.right = 0LL;
  ...
  if ( *((_BYTE *)this + 20) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, WindowRectForLivePreview, 0x168u);
      return v4;
    }
    bottom = Rect.bottom;
  }
...
LABEL_10:
  ...
  if ( (_QWORD)v26 != *(_QWORD *)&v30.left )
    v3 = 1;
  v15 = v7 != (_DWORD)v28 || __PAIR64__(v9, right) != *(_QWORD *)((char *)&v28 + 4) || bottom != HIDWORD(v28);
  ...
  else
  {
    ...
    if ( v14 || v15 )
    {
      ...
      if ( updated < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x184u);
      }
      else
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x185u);
        }
        else
        {
          ...
          if ( v19 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x186u);
          }
          else if ( a2 )
          {
