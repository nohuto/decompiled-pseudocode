/*
 * XREFs of ?FreezeDesktopThumbnail@CDesktopThumbnail@@SAJPEAVCWindowData@@_N@Z @ 0x18009B660
 * Callers:
    ...
    *((_QWORD *)v15 + 34) = v6;
    ...
    if ( updated >= 0 )
    {
      ...
      if ( PerMonitorDesktopThumbnail >= 0 )
      {
        ...
        v5 = v12;
        if ( v12 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0xE8u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, PerMonitorDesktopThumbnail, 0xE7u);
      }
      if ( v11 )
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0xE5u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DesktopThumbnail, 0xE4u);
  }
  return v5;
}
