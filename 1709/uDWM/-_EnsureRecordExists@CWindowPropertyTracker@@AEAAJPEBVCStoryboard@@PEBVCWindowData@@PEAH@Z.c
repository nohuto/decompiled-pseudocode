/*
 * XREFs of ?_EnsureRecordExists@CWindowPropertyTracker@@AEAAJPEBVCStoryboard@@PEBVCWindowData@@PEAH@Z @ 0x180001770
 * Callers:
        ...
        int *a4)
{
  ...
  if ( Record >= 0 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31 < (unsigned int)v30 ? 0x80070216 : 0, 0xB5u);
    }
    goto LABEL_22;
  }
  ...
  if ( v12 )
  {
    *v12 = *((_QWORD *)a3 + 5);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16 < (unsigned int)v15 ? 0x80070216 : 0, 0xB5u);
    }
