/*
 * XREFs of ?CreateRootVisualForDesktop@CWindowList@@AEAAJPEAUDESKTOP_WINDOWLIST_MAP_ENTRY@1@@Z @ 0x18003D364
 * Callers:
        ...
        struct CWindowList::DESKTOP_WINDOWLIST_MAP_ENTRY *a2)
{
  ...
  struct CRenderDataVisual *v18; // [rsp+70h] [rbp+30h] BYREF
  struct CVisual *v19; // [rsp+80h] [rbp+40h] BYREF
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x47Au);
LABEL_12:
    v7 = (volatile signed __int32 *)v19;
    goto LABEL_13;
  }
  v7 = (volatile signed __int32 *)v19;
  (*(void (__fastcall **)(struct CVisual *))(*(_QWORD *)v19 + 88LL))(v19);
  v8 = CRenderDataVisual::Create(*((struct IDwmChannel **)CDesktopManager::s_pDesktopManagerInstance + 4), &v18);
  v6 = v8;
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x480u);
LABEL_25:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x484u);
    goto LABEL_25;
  }
  v3 = (volatile signed __int32 *)v18;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x48Cu);
  }
  else
  {
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x491u);
    }
    else
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x494u);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x496u);
      }
    }
  }
LABEL_13:
