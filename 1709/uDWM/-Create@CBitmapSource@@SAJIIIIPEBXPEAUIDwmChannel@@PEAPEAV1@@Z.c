/*
 * XREFs of ?Create@CBitmapSource@@SAJIIIIPEBXPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x18006D108
 * Callers:
        ...
        struct CBitmapSource **a7)
{
  ...
  if ( v10 > 0xFFFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x101u);
    goto LABEL_24;
  }
  ...
  if ( v15 >= 0 )
  {
    ...
    {
      v14 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0x10Cu);
      goto LABEL_24;
    }
    if ( a3 != a1 || a4 != a2 )
    {
      ...
      {
        v14 = -2147024890;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0x114u);
        goto LABEL_24;
      }
      ...
      {
        v14 = -2147024890;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0x119u);
        goto LABEL_24;
      }
    }
...
LABEL_23:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, v19);
LABEL_24:
  if ( v20 )
