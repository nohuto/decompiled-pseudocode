/*
 * XREFs of ?OnWindowClientContentRectChange@CWindowPropertyTracker@@QEAAJPEBVCStoryboard@@PEBVCWindowData@@PEBUtagRECT@@2@Z @ 0x18009A768
 * Callers:
        ...
        const struct tagRECT *a5)
{
  ...
  if ( a4 || a5 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x4Au);
    }
  }
