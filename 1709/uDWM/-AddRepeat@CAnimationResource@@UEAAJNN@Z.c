/*
 * XREFs of ?AddRepeat@CAnimationResource@@UEAAJNN@Z @ 0x18009EA50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ConvertDoubleToQPC@CAnimationResource@@KA_KN@Z @ 0x18009F014 (-_ConvertDoubleToQPC@CAnimationResource@@KA_KN@Z.c)
 */
