/*
 * XREFs of ?GetAnimationIds@CTopLevelWindow3D@@AEAAJW4WindowAnimationType@1@PEAH1@Z @ 0x180023174
 * Callers:
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          ...
          if ( v9 )
          {
            ...
            {
              v4 = -2147024809;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x5Fu);
              return v4;
            }
            *a3 = 50;
          }
