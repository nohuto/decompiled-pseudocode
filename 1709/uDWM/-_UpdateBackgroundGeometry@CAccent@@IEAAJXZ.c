/*
 * XREFs of ?_UpdateBackgroundGeometry@CAccent@@IEAAJXZ @ 0x180008620
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBackgroundGeometry(CAccent *this)
{
  ...
  if ( v10
    && (v11 = CAccent::_UpdateSolidFill(this, v10, *((unsigned int *)this + 72), &v15, LODWORD(FLOAT_1_0)),
        ...
        v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x2AEu);
  }
  else
  {
    v12 = *((_QWORD *)this + 41);
    if ( v12 )
    {
      updated = CAccent::_UpdateSolidFill(this, v12, *((unsigned int *)this + 76), &v15, *((_DWORD *)this + 92));
      v1 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x2B3u);
    }
  }
  return v1;
}
