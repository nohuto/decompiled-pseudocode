/*
 * XREFs of ?TelemetrySetAnimationScenarioGUID@CAnimationResource@@UEAAJAEBU_GUID@@@Z @ 0x18009EDA0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  if ( !*((_QWORD *)this + 4) )
  {
    ...
    *((_QWORD *)this + 4) = v5;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x174u);
    }
  }
  return v4;
}
