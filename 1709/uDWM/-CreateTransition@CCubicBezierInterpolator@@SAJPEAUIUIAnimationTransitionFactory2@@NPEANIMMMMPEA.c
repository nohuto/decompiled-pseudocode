/*
 * XREFs of ?CreateTransition@CCubicBezierInterpolator@@SAJPEAUIUIAnimationTransitionFactory2@@NPEANIMMMMPEAPEAUIUIAnimationTransition2@@@Z @ 0x18008FE4C
 * Callers:
        ...
        struct IUIAnimationTransition2 **a9)
{
  ...
  if ( v12 )
  {
    ...
    if ( v14 >= 0 )
    {
      ...
      if ( v15 >= 0 )
        return v13;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x129u);
    }
    else
    {
  ...
  v13 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x126u);
  return v13;
}
