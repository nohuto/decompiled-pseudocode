/*
 * XREFs of ?OnSetRenderTargetTextures@CMagnifier@@QEAAJPEBUMAGN_ADAPTERTEXTURES@@@Z @ 0x180072DEC
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetRenderTargetTextures(CMagnifier *this, const struct MAGN_ADAPTERTEXTURES *a2)
{
  ...
  if ( *(_DWORD *)a2 <= v5 )
  {
    ...
    *((_DWORD *)this + 45) = *((_DWORD *)a2 + 2);
    ...
    v13 = v30;
    if ( v30 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x1C1u);
  }
  else
  {
    if ( v5 )
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x186u);
        return v13;
      }
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x18Au);
        return v13;
      }
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x18Eu);
        return v13;
      }
      ...
      *((_DWORD *)this + 44) = 0;
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x193u);
        return v13;
      }
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x194u);
        return v13;
      }
    }
    v19 = *(_DWORD *)a2;
    ...
    *((_DWORD *)this + 45) = *((_DWORD *)a2 + 2);
    ...
    v13 = v24;
    if ( v24 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x1A9u);
  }
  return v13;
}
