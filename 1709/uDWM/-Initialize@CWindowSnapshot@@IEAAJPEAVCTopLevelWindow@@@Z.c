/*
 * XREFs of ?Initialize@CWindowSnapshot@@IEAAJPEAVCTopLevelWindow@@@Z @ 0x18000D234
 * Callers:
...
__int64 __fastcall CWindowSnapshot::Initialize(CWindowSnapshot *this, struct CTopLevelWindow *a2)
{
  ...
  struct CVisual *v18; // [rsp+58h] [rbp+10h] BYREF
  ...
  if ( v8 == WPF::ProcessHeapImpl::AllocClear )
    ...
    v9 = (CWindowData *)((__int64 (__fastcall *)(WPF::ProcessHeapImpl *, __int64))v8)(WPF::g_pProcessHeap, 744LL);
  if ( v9 )
  ...
  *(_BYTE *)(*((_QWORD *)this + 4) + 593LL) = (!CWindowData::IsSimpleClientArea((CWindowData *)v2) ? 0x10 : 0) | *(_BYTE *)(*((_QWORD *)this + 4) + 593LL) & 0xEF;
