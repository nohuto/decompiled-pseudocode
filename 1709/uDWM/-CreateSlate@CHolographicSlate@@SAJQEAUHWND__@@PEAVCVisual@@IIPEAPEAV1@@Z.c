/*
 * XREFs of ?CreateSlate@CHolographicSlate@@SAJQEAUHWND__@@PEAVCVisual@@IIPEAPEAV1@@Z @ 0x18006FFCC
 * Callers:
        ...
        struct CHolographicSlate **a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v11 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x21u);
      }
      if ( v11 )
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x1Bu);
  }
  return v9;
}
