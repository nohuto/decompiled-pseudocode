/*
 * XREFs of ?Initialize@CTransitionVisualSet@CAnimationEngine@@QEAAJPEAPEAUIAnimatedVisual@@I@Z @ 0x18002F728
 * Callers:
    ...
    if ( a3 )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v10 * 8 + *((_QWORD *)this + 3)) = v12;
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x64Du);
          goto LABEL_13;
        }
        ++v9;
        ++v10;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x64Cu);
LABEL_13:
      if ( v6 < 0 )
        goto LABEL_22;
    }
