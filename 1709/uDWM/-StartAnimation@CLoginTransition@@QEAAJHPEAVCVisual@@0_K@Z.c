/*
 * XREFs of ?StartAnimation@CLoginTransition@@QEAAJHPEAVCVisual@@0_K@Z @ 0x180030324
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  *((_DWORD *)this + 18) = a2;
  ...
  if ( v51 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x31u);
      goto LABEL_52;
    }
    *((_QWORD *)this + 4) = a3;
    if ( a3 )
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          v20 = *(struct tagRECT *)((char *)CDesktopManager::s_pDesktopManagerInstance + 420);
          v61 = v20;
          rc = v20;
                  ...
                  else
                  {
                    ...
                    if ( inserted >= 0 )
                    {
                      ...
                      else
                      {
                        ...
                        {
                          v48 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v57, 8u, 1, &v56);
                          v11 = v48;
                          if ( v48 < 0 )
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v48, 0xC0u);
                        }
                        else
                        {
                          v59 = v42;
                        ...
                        {
                          v9 = v51;
                          v44 = CAnimationEngine::RegisterForAnimationCompleteNotification(v51, this);
                          v11 = v44;
                          if ( v44 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v44, 0x7Cu);
                          }
                          else
                          {
                            ...
                            if ( started < 0 )
                            {
                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x7Fu);
                            }
                            else
                            {
                              v46 = CDesktopManager::PostStartAnimations(CDesktopManager::s_pDesktopManagerInstance);
                              v11 = v46;
                              if ( v46 < 0 )
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v46, 0x83u);
                              else
                                *((_BYTE *)this + 68) = 1;
                            }
                          }
