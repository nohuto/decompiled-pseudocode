/*
 * XREFs of ?UpdateWindowScale@CWindowList@@QEAAJPEAVCWindowData@@H@Z @ 0x1800263D0
 * Callers:
 ...
 *     PixelAligningFactor @ 0x18007BFF8 (PixelAligningFactor.c)
 */
...
LABEL_7:
  ...
  *((_DWORD *)a2 + 15) = (_DWORD)v16;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x18DFu);
  }
  else
  {
  ...
  if ( v26 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0xA20u);
  }
  else
  {
LABEL_32:
