/*
 * XREFs of ?EnsureThumbnailVisual@CDCompVirtualDesktopThumbnailData@@UEAAJXZ @ 0x18007AEF0
 * Callers:
...
__int64 __fastcall CDCompVirtualDesktopThumbnailData::EnsureThumbnailVisual(CDCompVirtualDesktopThumbnailData *this)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x1DC8u);
    return v3;
  }
  if ( *((_QWORD *)this + 13) )
    return v3;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x1DD0u);
    goto LABEL_22;
  }
  v6 = v19;
  *((_QWORD *)v19 + 35) = this;
  *((_QWORD *)v6 + 34) = *(_QWORD *)(*((_QWORD *)this + 2) + 120LL);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x1DD2u);
    goto LABEL_23;
  }
    ...
    *((_QWORD *)v10 + 3) = v6;
    ...
    if ( v13 >= 0 )
    {
      ...
      *((_BYTE *)v14 + 337) = 1;
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x1DDEu);
LABEL_22:
        v6 = v19;
        goto LABEL_23;
      }
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x1DD9u);
    }
    v4 = v20;
    goto LABEL_22;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1DD5u);
LABEL_23:
  if ( v6 )
