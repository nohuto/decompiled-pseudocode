/*
 * XREFs of _lambda_f1fd7dcd3a18171c461af661371627e6_::_lambda_invoker_cdecl_ @ 0x180068D60
 * Callers:
 *     <none>
 * Callees:
...
{
  lambda_f1fd7dcd3a18171c461af661371627e6_::operator()((_DWORD)Instance, (_DWORD)Context, (_DWORD)Context, WaitResult);
}
