/*
 * XREFs of ?ShouldCloneWindow@CTransitionVisualController@@SA_NPEAUHWND__@@@Z @ 0x18000ACFC
 * Callers:
    ...
    do
    {
      ...
      if ( CAnimationScheduler::IsWindowCurrentlyAnimating(
             *((CAnimationScheduler **)v3 + 28),
             0LL,
             *((_DWORD *)&off_1800A5430 + 4 * v5 + 2),
             0) )
      {
        v12 = ClassName;
        v13 = (char *)(&off_1800A5430)[2 * v5] - (char *)ClassName;
        while ( 1 )
        {
          v14 = *v12;
