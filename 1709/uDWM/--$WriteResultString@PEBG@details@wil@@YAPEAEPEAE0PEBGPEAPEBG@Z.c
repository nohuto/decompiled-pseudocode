/*
 * XREFs of ??$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z @ 0x180066114
 * Callers:
 ...
 * Callees:
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x180067670 (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
