/*
 * XREFs of ?OnTick@CAnimationEngine@@QEAAJNPEA_N@Z @ 0x18002DAB4
 * Callers:
 ...
 *     ?NeedToUpdateScene@CAnimatedTransitionVisual@@UEAA_NXZ @ 0x18002EEB0 (-NeedToUpdateScene@CAnimatedTransitionVisual@@UEAA_NXZ.c)
