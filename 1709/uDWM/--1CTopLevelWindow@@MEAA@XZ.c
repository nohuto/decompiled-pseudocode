/*
 * XREFs of ??1CTopLevelWindow@@MEAA@XZ @ 0x18001F1BC
 * Callers:
...
void __fastcall CTopLevelWindow::~CTopLevelWindow(CBaseObject **this)
{
  ...
  *this = (CBaseObject *)&CTopLevelWindow::`vftable';
  ...
  CTopLevelWindow::UnregisterIndirectSwapchainRenderTarget((CTopLevelWindow *)this, &v32);
  v8 = this[98];
  if ( v8 )
  {
