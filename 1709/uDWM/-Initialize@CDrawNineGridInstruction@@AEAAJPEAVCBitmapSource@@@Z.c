/*
 * XREFs of ?Initialize@CDrawNineGridInstruction@@AEAAJPEAVCBitmapSource@@@Z @ 0x180013A48
 * Callers:
 ...
 *     ?GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLayout@@@Z @ 0x18003588C (-GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLay.c)
...
__int64 __fastcall CDrawNineGridInstruction::Initialize(struct _MARGINS *this, struct CBitmapSource *a2)
{
  ...
  for ( i = this + 3; ; i = (struct _MARGINS *)((char *)i + 8) )
  {
    ...
    v18 = v24[v9 + 4];
    v11 = v24[v10];
    v12 = v24[(unsigned int)(v10 + 1)];
    v19 = v24[(unsigned int)(v9 + 1) + 4];
    if ( v12 - v11 <= 0 || v19 - v18 <= 0 )
    {
      *(_QWORD *)&i->cxLeftWidth = 0LL;
      goto LABEL_6;
    }
    ++this[7].cyTopHeight;
    v14 = CResource::Create(17LL, *(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL), (char *)&this[3] + 8 * v3);
    v6 = v14;
    if ( v14 < 0 )
      break;
