/*
 * XREFs of ?Capture@CScreenRotation@@QEAAJXZ @ 0x18009046C
 * Callers:
...
LABEL_6:
  ...
  v27.left = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 101);
  v27.right = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 103) + v27.left;
  v27.top = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 102);
  v27.bottom = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 104) + v27.top;
...
LABEL_32:
  ...
  if ( inserted < 0 )
  {
    v18 = 146;
LABEL_17:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, v18);
    return v2;
  }
  if ( *v6 )
  {
