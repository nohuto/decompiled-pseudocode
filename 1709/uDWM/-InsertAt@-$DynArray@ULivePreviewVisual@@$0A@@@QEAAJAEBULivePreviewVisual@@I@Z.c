/*
 * XREFs of ?InsertAt@?$DynArray@ULivePreviewVisual@@$0A@@@QEAAJAEBULivePreviewVisual@@I@Z @ 0x180069AF4
 * Callers:
...
__int64 __fastcall DynArray<LivePreviewVisual,0>::InsertAt(__int64 a1, unsigned __int64 a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x1CDu);
  }
  return v4;
}
