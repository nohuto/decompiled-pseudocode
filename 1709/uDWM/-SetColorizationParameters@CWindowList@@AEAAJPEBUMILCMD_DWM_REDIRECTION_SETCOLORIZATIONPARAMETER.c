/*
 * XREFs of ?SetColorizationParameters@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS@@@Z @ 0x180025AAC
 * Callers:
 ...
 *     ?ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z @ 0x180016B48 (-ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z.c)
        ...
        const struct MILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS *a2)
{
  ...
  else
  {
    v5 = *((_DWORD *)a2 + 1);
    v6 = 0;
    v7 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 131) == 2;
    v8 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 516);
    v20 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 500);
    LODWORD(v20) = v5;
