/*
 * XREFs of ?OnSetDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x18006F3D0
 * Callers:
        ...
        const struct MilColorTransform *a2)
{
  ...
  *((_DWORD *)this + 42) = *((_DWORD *)a2 + 24);
  ...
  v3 = updated;
  if ( updated < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x111u);
  return v3;
}
