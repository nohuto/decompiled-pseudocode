/*
 * XREFs of ?RemoveTargetsForStoryboard@CTransitionVisualController@@QEAAJPEAVCStoryboard@@_NK@Z @ 0x1800070A0
 * Callers:
 ...
 *     ?GetStoryboardInfo@CWindowClose@@UEAAPEBUStoryboardInfo@@XZ @ 0x1800369C0 (-GetStoryboardInfo@CWindowClose@@UEAAPEBUStoryboardInfo@@XZ.c)
        ...
        int a4)
{
  ...
  const struct StoryboardInfo *(__fastcall *v10)(CLauncherDismiss *__hidden); // rax
  ...
  {
    v10 = *(const struct StoryboardInfo *(__fastcall **)(CLauncherDismiss *__hidden))(*(_QWORD *)a2 + 16LL);
