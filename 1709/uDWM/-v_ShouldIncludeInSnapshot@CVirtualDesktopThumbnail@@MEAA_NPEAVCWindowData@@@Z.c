/*
 * XREFs of ?v_ShouldIncludeInSnapshot@CVirtualDesktopThumbnail@@MEAA_NPEAVCWindowData@@@Z @ 0x18009C980
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CWindowData *a2)
{
  ...
  if ( (unsigned int)DynArray<HMONITOR__ *,0>::Find(*((_QWORD *)this + 35) + 128LL, &v11)
    || !(unsigned int)DynArray<HMONITOR__ *,0>::Find(v10 + 160, &v11) && (*((_BYTE *)a2 + 596) & 1) == 0 )
  {
    return 1;
  }
  return v5;
