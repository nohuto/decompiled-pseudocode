/*
 * XREFs of ?GetTitleBarInfo@CTopLevelWindow@@QEAAXPEAUtagTITLEBARINFOEX@@PEA_N@Z @ 0x180009A24
 * Callers:
  ...
  if ( CTopLevelWindow::HasRenderedBorder(*((_DWORD *)this + 146)) )
  {
    ...
    *(_QWORD *)&a2->rgstate[4] = 0LL;
    ...
    if ( (*(_DWORD *)(*((_QWORD *)this + 90) + 100LL) & 0xC00000) == 0xC00000 )
    {
      ...
      SystemMetricsForDpi = GetSystemMetricsForDpi(8LL, *(unsigned int *)(*((_QWORD *)this + 90) + 332LL));
      a2->rcTitleBar.top = (int)floor_0((float)((float)SystemMetricsForDpi * *(float *)(*((_QWORD *)this + 90) + 176LL)) + 0.5);
      ...
      for ( i = 2; i <= 5; ++i )
      {
        ...
        v15 = *((_DWORD *)this + 146);
        if ( (v15 & dword_1800AAF68[2 * v14]) != 0 )
        {
          if ( (v15 & dword_1800AAF68[2 * v14 + 1]) != 0 )
          {
