/*
 * XREFs of ?Initialize@CImmersiveWindowIconic@@IEAAJPEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@_N@Z @ 0x180071D20
 * Callers:
        ...
        unsigned int a5)
{
  ...
  *((_DWORD *)this + 79) = a4;
    ...
    if ( v14 >= 0 )
    {
      *(_BYTE *)(*((_QWORD *)this + 35) + 594LL) |= 1u;
      if ( a3 )
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x4Cu);
          return v13;
        }
        ...
        *((_DWORD *)this + 78) = v18;
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x60u);
          return v13;
        }
      }
      ...
      if ( IconW >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          v13 = v27;
          if ( v27 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x67u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x66u);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, IconW, 0x65u);
      }
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x42u);
  }
  return v13;
}
