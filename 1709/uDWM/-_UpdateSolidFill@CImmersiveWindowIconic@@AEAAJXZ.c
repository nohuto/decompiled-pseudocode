/*
 * XREFs of ?_UpdateSolidFill@CImmersiveWindowIconic@@AEAAJXZ @ 0x180072298
 * Callers:
...
__int64 __fastcall CImmersiveWindowIconic::_UpdateSolidFill(CImmersiveWindowIconic *this)
{
  ...
  *((float *)&v17 + 3) = _mm_cvtepi32_ps(v6).m128_f32[0] + 0.0;
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *((_OWORD *)v10 + 1) = v12;
      ...
      v8 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x85u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x81u);
    }
    if ( v10 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x7Fu);
  }
  return v8;
}
