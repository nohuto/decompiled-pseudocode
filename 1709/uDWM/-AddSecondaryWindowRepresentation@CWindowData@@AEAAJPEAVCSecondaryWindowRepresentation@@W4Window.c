/*
 * XREFs of ?AddSecondaryWindowRepresentation@CWindowData@@AEAAJPEAVCSecondaryWindowRepresentation@@W4WindowRepresentationType@@_N@Z @ 0x1800116B8
 * Callers:
        ...
        char a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( v15 >= (unsigned int)v14 )
    {
      ...
      {
        v16 = DynArrayImpl<0>::AddMultipleAndSet(v13, 8LL, 1LL, &v21);
        v4 = v16;
        if ( v16 < 0 )
...
LABEL_25:
  ...
  else
  {
    if ( ++*(_DWORD *)(a1 + 472) != 1 )
    {
      ...
      while ( 1 )
      {
        v19 = *(char **)(*(_QWORD *)(a1 + 552) + 8 * v18);
        if ( v19[593] < 0 )
        {
          v11 = CSecondaryWindowRepresentation::OnEligibleOwnedWindowAddedOrRemoved(v21, (struct CWindowData *)v19, 1);
          v4 = v11;
          if ( v11 < 0 )
            break;
        }
