/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x180066468
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( (_DWORD)v15 )
    v17 = v15;
  v33 = (wil::details *)CreateSemaphoreExW(0LL, v15, v17, Name, 0, 0x1F0003u);
  if ( v33 )
  {
    wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,0,std::nullptr_t>>::reset(
      this + 1,
