/*
 * XREFs of ?StartRectAnimation@CAnimatedGlassSheet@@QEAAJPEBUtagRECT@@0M@Z @ 0x18007E6A0
 * Callers:
        ...
        float a4)
{
  ...
  *((_QWORD *)this + 54) = v11;
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x123u);
LABEL_14:
  ...
  *((struct tagRECT *)this + 25) = *a3;
  ...
  if ( v13 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x128u);
  if ( v12 < 0 )
    goto LABEL_14;
  return (unsigned int)v12;
}
