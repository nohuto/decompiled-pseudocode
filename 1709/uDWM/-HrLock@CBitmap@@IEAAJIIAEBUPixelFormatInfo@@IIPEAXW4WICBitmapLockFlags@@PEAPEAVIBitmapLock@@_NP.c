/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x1800441A0
 * Callers:
 ...
 *     ??0CBitmapLock@@QEAA@XZ @ 0x180043048 (--0CBitmapLock@@QEAA@XZ.c)
        ...
        struct IUnknown *a11)
{
  ...
  if ( (a8 & 2) != 0 )
  {
    ...
    v24 = 667;
LABEL_32:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, v24);
    return v17;
  }
  if ( (a8 & 1) == 0 )
  {
...
LABEL_8:
  ...
  if ( v19 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x2B5u);
  }
  else
  {
    v17 = -2147024882;
