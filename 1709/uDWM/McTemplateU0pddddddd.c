/*
 * XREFs of McTemplateU0pddddddd @ 0x18008FBD8
 * Callers:
...
__int64 __fastcall McTemplateU0pddddddd(
        _QWORD *a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  _BYTE v11[16]; // [rsp+20h] [rbp-79h] BYREF
  __int64 *v12; // [rsp+30h] [rbp-69h]
  ...
  v25 = 4LL;
  v27 = 4LL;
  return McGenEventWriteUM(a1, &UdwmSystemAnimation_CreateVisual, 9LL, (__int64)v11);
}
