/*
 * XREFs of ?OnWindowArrangementContinue@CWindowList@@AEAAJPEBUMILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION@@@Z @ 0x18007BE68
 * Callers:
        ...
        const struct MILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x16ECu);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x16EBu);
  }
