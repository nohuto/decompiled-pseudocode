/*
 * XREFs of ?UpdateClientBlur@CTopLevelWindow@@AEAAJXZ @ 0x18001BF28
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateClientBlur(CTopLevelWindow *this)
{
  ...
  CBaseObject *v37; // [rsp+50h] [rbp-11h] BYREF
  ...
  if ( (*(_BYTE *)(v1 + 593) & 4) != 0 )
  {
    ...
    else
    {
      ...
      if ( inserted < 0 )
      {
        v35 = 3562;
LABEL_54:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, v35);
        return v5;
      }
    }
    ...
    if ( (v5 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0xE08u);
      return v5;
    }
    if ( v22 )
    {
      ...
      if ( v25 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0xE0Du);
        v2 = v37;
LABEL_46:
        if ( v2 )
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0xE17u);
        v3 = v36;
        goto LABEL_46;
      }
    }
...
LABEL_37:
    ...
    if ( !*((_QWORD *)this + 95) )
    {
      ...
      if ( updated < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0xE23u);
        goto LABEL_46;
      }
    ...
    if ( !*((_DWORD *)*v18 + 68) )
    {
      ...
      {
        v4 = v38;
        v34 = CRenderDataVisual::AddInstruction((CRenderDataVisual *)*v18, v38);
        v5 = v34;
        if ( v34 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0xE37u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0xE35u);
        v4 = v38;
      }
    }
    goto LABEL_46;
