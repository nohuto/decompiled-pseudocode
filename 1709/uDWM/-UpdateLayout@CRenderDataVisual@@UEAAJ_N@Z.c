/*
 * XREFs of ?UpdateLayout@CRenderDataVisual@@UEAAJ_N@Z @ 0x180015580
 * Callers:
...
__int64 __fastcall CRenderDataVisual::UpdateLayout(CRenderDataVisual *this, char a2)
{
  ...
  int v16; // eax
  void (__fastcall *v17)(CThumbnailVisual *, int); // rax
...
LABEL_13:
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x160u);
    goto LABEL_23;
  }
