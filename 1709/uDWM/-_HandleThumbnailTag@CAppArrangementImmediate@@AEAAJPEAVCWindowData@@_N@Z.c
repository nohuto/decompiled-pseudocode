/*
 * XREFs of ?_HandleThumbnailTag@CAppArrangementImmediate@@AEAAJPEAVCWindowData@@_N@Z @ 0x180095C40
 * Callers:
        ...
        char a3)
{
  ...
  *(_QWORD *)&v30.right = 0LL;
  ...
  if ( a3 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v10, 0xE0Du);
LABEL_6:
      v12 = v26;
      goto LABEL_30;
    }
  ...
  else
  {
    ...
    *(_QWORD *)&rc.right = 0LL;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v18, 0xE20u);
      goto LABEL_6;
    }
  }
  v19 = *((_DWORD *)a2 + 150);
