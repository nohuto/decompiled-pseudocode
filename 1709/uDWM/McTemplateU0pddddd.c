/*
 * XREFs of McTemplateU0pddddd @ 0x18007D22C
 * Callers:
...
__int64 __fastcall McTemplateU0pddddd(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v20 = &a8;
  v21 = 4LL;
  return McGenEventWriteUM(&Microsoft_Windows_Dwm_Udwm_Provider_Context, &UdwmWindowDPI_Change, 7LL, (__int64)v9);
}
