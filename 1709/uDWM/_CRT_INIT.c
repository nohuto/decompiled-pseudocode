/*
 * XREFs of _CRT_INIT @ 0x180045FD4
 * Callers:
 *     __DllMainCRTStartup @ 0x180046250 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800464A2 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180046500 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180046650 (_initterm_0.c)
