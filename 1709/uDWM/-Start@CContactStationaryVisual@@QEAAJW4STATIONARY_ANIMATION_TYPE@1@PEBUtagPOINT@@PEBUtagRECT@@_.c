/*
 * XREFs of ?Start@CContactStationaryVisual@@QEAAJW4STATIONARY_ANIMATION_TYPE@1@PEBUtagPOINT@@PEBUtagRECT@@_N@Z @ 0x1800848C8
 * Callers:
...
__int64 __fastcall CContactStationaryVisual::Start(__int64 a1, int a2, struct tagPOINT *a3, _DWORD *a4, char a5)
{
  ...
  *(_DWORD *)(a1 + 348) = v11;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BitmapsFromAtlasImageStrip, 0x63u);
    goto LABEL_60;
  }
  if ( a5 )
    ...
    *(struct tagPOINT *)(a1 + 296) = *a3;
    ...
    else
    {
      ...
      if ( (_BYTE)v35 )
      {
        ...
        {
          v16 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x95u);
LABEL_61:
        ...
        *(_DWORD *)(a1 + 304) = BoundedContactWidth;
        v30 = (struct tagSIZE *)(a1 + 376);
        v38 = (float)BoundedContactWidth * *(float *)(a1 + 336);
        *(_DWORD *)(a1 + 376) = (int)v38;
        if ( (int)v38 < 1 )
          v30->cx = 1;
        *(_DWORD *)(a1 + 380) = v30->cx;
      }
      else
      {
        v30 = (struct tagSIZE *)(a1 + 376);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x7Du);
  }
LABEL_60:
  if ( v16 < 0 )
    goto LABEL_61;
