/*
 * XREFs of ?CopyAndAddRef@CBitmapSourceArray@@QEAAJAEBV1@@Z @ 0x180025588
 * Callers:
...
__int64 __fastcall CBitmapSourceArray::CopyAndAddRef(CBitmapSourceArray *this, const struct CBitmapSourceArray *a2)
{
  ...
  *((_DWORD *)this + 6) = 0;
  v8 = *((_DWORD *)a2 + 6);
  Src = *(void **)a2;
  v9 = DynArrayImpl<0>::Grow((__int64)this, 8u, v8, 0, (unsigned __int64 *)&Src);
  v10 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x28Bu);
  }
  else
  {
