/*
 * XREFs of ??1?$shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAA@XZ @ 0x180045140
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_featureStateManager__ @ 0x180046E50 (wil--details--_dynamic_atexit_destructor_for__g_featureStateManager__.c)
 * Callees:
        ...
        wil *a1)
{
  if ( wil::ProcessShutdownInProgress(a1) )
  {
    ...
    if ( qword_1800C1710 )
      wil::details_abi::ProcessLocalStorageData<wil::details_abi::FeatureStateData>::Release(qword_1800C1710);
  }
  else
  {
