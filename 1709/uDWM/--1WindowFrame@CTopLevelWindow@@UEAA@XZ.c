/*
 * XREFs of ??1WindowFrame@CTopLevelWindow@@UEAA@XZ @ 0x18003CB04
 * Callers:
 ...
 *     ??1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x18003CDD0 (--1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
 */
