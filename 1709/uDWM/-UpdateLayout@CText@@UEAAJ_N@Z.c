/*
 * XREFs of ?UpdateLayout@CText@@UEAAJ_N@Z @ 0x180014320
 * Callers:
...
__int64 __fastcall CText::UpdateLayout(CText *this, bool a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x1B9u);
  }
  else
  {
    ...
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x1BAu);
  }
