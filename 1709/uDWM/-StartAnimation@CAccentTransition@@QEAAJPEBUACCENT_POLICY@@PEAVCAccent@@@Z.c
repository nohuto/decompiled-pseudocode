/*
 * XREFs of ?StartAnimation@CAccentTransition@@QEAAJPEBUACCENT_POLICY@@PEAVCAccent@@@Z @ 0x18009AAA8
 * Callers:
...
LABEL_23:
  ...
  if ( *((_DWORD *)a2 + 3) == 5 )
  {
    ...
    v17 = *(_BYTE *)(*((_QWORD *)this + 3) + 608LL) != 0;
    rc = si128;
    OffsetRect(&rc, (v17 ? 1 : -1) * (int)(*((double *)CDesktopManager::s_pDesktopManagerInstance + 55) * 81.0), 0);
