/*
 * XREFs of ?LoadIconW@CImmersiveWindowIconic@@AEAAJXZ @ 0x180071F74
 * Callers:
    ...
    if ( IconicResourceNoRef )
    {
      ...
      if ( BitmapSourceNoRef )
      {
        ...
        if ( v9 >= 0 )
        {
          ...
          v2 = v10;
          if ( v10 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xBAu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0xB8u);
        }
