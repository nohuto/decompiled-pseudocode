        ...
        const char *a4)
{
  ...
  const char *v11; // r9
  wil::details::event_watcher_state *v12; // rsi
  void *v13; // rdx
  void *v15; // rdx
  ...
  wil::details *v23; // [rsp+48h] [rbp+10h] BYREF

  v5 = a2;
  if ( !a2 )
  {
    wil::details::in1diag3::FailFast_Unexpected(retaddr, (void *)0xD60, a3, a4);
    __debugbreak();
  }
  v23 = a2;
