/*
 * XREFs of ?UpdateGeometry2DWithClip@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008B588
 * Callers:
    ...
    if ( v10 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          v8 = v16;
          if ( v16 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x4B3u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x4AEu);
        }
        if ( v13 )
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x4A4u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x4A2u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x4A1u);
  }
  if ( v18 )
