/*
 * XREFs of ?RemoveAnimationComponent@CTransitionVisualController@@QEAAJPEAVCAnimationComponent@@@Z @ 0x1800057E0
 * Callers:
        ...
        struct CVisual **a2)
{
  ...
  else
  {
    ...
    {
      v7 = (unsigned int)DynArray<CAnimationComponent *,0>::Remove((__int64 *)this + 14, (__int64 *)&v14) != 0;
      if ( !*((_DWORD *)this + 34) )
        *((_QWORD *)this + 12) = -1LL;
      v8 = a2[4];
      if ( v8
