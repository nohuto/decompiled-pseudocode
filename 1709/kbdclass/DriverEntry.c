 ...
 *     WppInitKm @ 0x1C000CF50 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000CFF0 (WppLoadTracingSupport.c)
 *     WppCleanupKm @ 0x1C000E714 (WppCleanupKm.c)
  ...
  *((_WORD *)::P + ((unsigned __int64)RegistryPath->Length >> 1)) = 0;
  ...
  else
  {
    ...
    if ( v13 )
    {
      ...
      for ( j = 0; v16 != &qword_1C00094E8; v16 = (__int64 *)*v16 )
