/*
 * XREFs of KeyboardClassServiceCallback @ 0x1C0004A20
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C0002AC0 (memmove.c)
 *     KeyboardClassDequeueRead @ 0x1C00043CC (KeyboardClassDequeueRead.c)
 *     KeyboardClassReadCopyData @ 0x1C00046A0 (KeyboardClassReadCopyData.c)
 *     WPP_RECORDER_SF_ @ 0x1C00053A0 (WPP_RECORDER_SF_.c)
 *     WPP_RECORDER_SF_qL @ 0x1C000551C (WPP_RECORDER_SF_qL.c)
 *     WPP_RECORDER_SF_qLL @ 0x1C00055EC (WPP_RECORDER_SF_qLL.c)
 *     WPP_RECORDER_SF_qLqq @ 0x1C00056E0 (WPP_RECORDER_SF_qLqq.c)
 *     WPP_RECORDER_SF_qlqqd @ 0x1C00058C0 (WPP_RECORDER_SF_qlqqd.c)
 *     WPP_RECORDER_SF_qqLLqq @ 0x1C0005B0C (WPP_RECORDER_SF_qqLLqq.c)
 *     WPP_RECORDER_SF_qqiL @ 0x1C0006228 (WPP_RECORDER_SF_qqiL.c)
 */
...
__int64 **__fastcall KeyboardClassServiceCallback(__int64 a1, char *a2, int a3, _DWORD *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v21 )
  {
    ...
    *a4 += v21 / 0xC;
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qlqqd(WPP_GLOBAL_Control->DeviceExtension, v21 / 0xC, v24, v25);
  }
  while ( *(_DWORD *)(v8 + 84) )
  {
    ...
    if ( !v30 )
      break;
    *((_DWORD *)v30 + 12) = KeyboardClassReadCopyData(v8, v30, v31, v32);
    v34 = v41;
    v35 = (__int64 ***)(v33 + 21);
    if ( *v41 != (__int64 *)&v40 )
      __fastfail(3u);
