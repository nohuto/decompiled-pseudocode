/*
 * XREFs of KeyboardClassCancel @ 0x1C0001480
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall KeyboardClassCancel(__int64 a1, IRP *a2)
{
  __int64 v2; // rdi
  KIRQL v4; // al
  ...
  v4 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 160));
  ...
  Blink->Flink = Flink;
  Flink->Blink = Blink;
  KeReleaseSpinLock((PKSPIN_LOCK)(v2 + 160), v4);
