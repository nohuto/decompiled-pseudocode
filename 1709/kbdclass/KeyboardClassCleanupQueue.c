/*
 * XREFs of KeyboardClassCleanupQueue @ 0x1C0004270
 * Callers:
 *     KeyboardClassRemoveDevice @ 0x1C00048CC (KeyboardClassRemoveDevice.c)
 * Callees:
 *     <none>
 */
...
__int64 **__fastcall KeyboardClassCleanupQueue(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( v14 == (__int64 *)&v14 )
      break;
    if ( (__int64 **)v14[1] != &v14 || (v13 = (__int64 *)*v14, *(__int64 **)(*v14 + 8) != v14) )
      __fastfail(3u);
    v14 = (__int64 *)*v14;
    v13[1] = (__int64)&v14;
