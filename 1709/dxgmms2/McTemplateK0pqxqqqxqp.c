/*
 * XREFs of McTemplateK0pqxqqqxqp @ 0x1C002723C
 * Callers:
...
NTSTATUS McTemplateK0pqxqqqxqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDmaIsrComplete, a3, 0xAu, &v4);
}
