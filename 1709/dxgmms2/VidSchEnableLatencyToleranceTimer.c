/*
 * XREFs of VidSchEnableLatencyToleranceTimer @ 0x1C002B790
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchEnableLatencyToleranceTimer(__int64 a1, char a2, __int64 a3)
{
  ...
  *(_BYTE *)(a1 + 2960) = a2;
  if ( a2 )
  {
    if ( bTracingEnabled && ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
      McTemplateK0(a1, &Dxgk_LatencyToleranceTimerEnable, a3);
    ...
    *(_QWORD *)(a1 + 2944) = v5 + *(_QWORD *)(a1 + 2952);
    *(_QWORD *)(a1 + 1552) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(a1 + 1520), 0, 0);
  }
  else if ( bTracingEnabled && ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
  {
    McTemplateK0(a1, &Dxgk_LatencyToleranceTimerDisable, a3);
  }
}
