/*
 * XREFs of ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C002A970
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchPeriodicMonitoredFenceTimerCallback(struct _EX_TIMER *a1, int *a2)
{
  ...
  v4 = *(_QWORD *)(v3 + 8LL * (unsigned int)a2[2] + 3008);
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v3 + 1888), &LockHandle);
  v5 = *(_QWORD *)(v4 + 23560);
  v6 = *(_QWORD *)(v4 + 23552);
