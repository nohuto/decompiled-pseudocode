/*
 * XREFs of ?VidSchiFindPriorityLevelToSchedule@@YAKPEAU_VIDSCH_NODE@@PEA_N@Z @ 0x1C0024C74
 * Callers:
...
__int64 __fastcall VidSchiFindPriorityLevelToSchedule(struct _VIDSCH_NODE *a1, bool *a2)
{
  ...
  v5 = *((unsigned int *)a1 + 426);
  if ( *((_BYTE *)a1 + 1960) && (v5 & 0xC0000000) == 0 && (v5 & (0xFFFFFFFFuLL >> (31 - *(_BYTE *)(v2 + 176)))) != 0 )
  {
  ...
  {
    MostSignificantBit = RtlFindMostSignificantBit(*((unsigned int *)a1 + 426));
    *a2 = 0;
  }
