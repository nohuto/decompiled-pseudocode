/*
 * XREFs of ?NeedsApertureForLock@VIDMM_GLOBAL@@IEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0059A9C
 * Callers:
...
bool __fastcall VIDMM_GLOBAL::NeedsApertureForLock(VIDMM_GLOBAL *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v2 = *((_DWORD *)a2 + 19);
  return (v2 & 0xD0000) == 0 && (*(_BYTE *)(1552LL * (v2 & 0x3F) + *((_QWORD *)this + 5021) + 437) & 0x40) != 0;
}
