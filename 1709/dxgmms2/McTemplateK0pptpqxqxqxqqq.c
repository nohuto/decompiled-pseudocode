/*
 * XREFs of McTemplateK0pptpqxqxqxqqq @ 0x1C00175BC
 * Callers:
...
__int64 McTemplateK0pptpqxqxqxqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpSpecialLockTransfer, a3, 14LL, v4);
}
