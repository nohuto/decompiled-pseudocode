/*
 * XREFs of ?VidMmiMoveAndFlipDisplayingAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_GLOBAL_ALLOC@@_K2@Z @ 0x1C00A96A0
 * Callers:
        ...
        union _LARGE_INTEGER a4)
{
  ...
  *((union _LARGE_INTEGER *)a2 + 18) = v8;
  ...
  VidSchiUpdateFlipQueueEntriesForMove(*(_QWORD *)(*((_QWORD *)this + 2) + 512LL), a2);
}
