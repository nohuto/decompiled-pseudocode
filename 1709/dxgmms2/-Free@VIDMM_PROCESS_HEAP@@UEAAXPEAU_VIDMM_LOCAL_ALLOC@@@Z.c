/*
 * XREFs of ?Free@VIDMM_PROCESS_HEAP@@UEAAXPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00B03A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( (*v5 & 1) != 0 )
  {
    ...
    *(_QWORD *)(*((_QWORD *)this + 1) + 88LL) -= *((_QWORD *)v5 + 7);
    ...
    {
      v17[14] -= *((_QWORD *)v5 + 7);
      *(_QWORD *)(*((_QWORD *)this + 1) + 120LL) -= *((_QWORD *)v5 + 7);
    }
    else
    {
      v18 = v16 == 2;
      ...
      {
        v17[18] -= v19;
        *(_QWORD *)(*((_QWORD *)this + 1) + 152LL) -= *((_QWORD *)v5 + 7);
      }
    }
    if ( bTracingEnabled )
    {
