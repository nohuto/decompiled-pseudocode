/*
 * XREFs of ?VidMmProcessAsyncOperation@@YAXPEAX@Z @ 0x1C0072B50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v2 )
  {
    ...
    if ( (_DWORD)v5 )
    {
      if ( (_DWORD)v5 == 1 )
      {
        ...
        {
          v18 = 0;
          if ( !VIDMM_GLOBAL::IsAllocationInPresentQueue(v5, v10, &v18) )
            break;
          if ( v18 > 1 )
            break;
        ...
        VidMmCompleteAsyncUnpin((struct VIDMM_GLOBAL *)v9, &v20);
