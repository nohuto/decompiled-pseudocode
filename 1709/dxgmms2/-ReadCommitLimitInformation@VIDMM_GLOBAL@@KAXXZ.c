/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C0080E14
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C0040478 = v1;
  dword_1C004047C = v8 << 20;
  dword_1C0040480 = v2;
  dword_1C0040484 = v4;
  if ( !v0 )
    qword_1C0040180 = (unsigned __int64)qword_1C0040168 >> 3;
}
