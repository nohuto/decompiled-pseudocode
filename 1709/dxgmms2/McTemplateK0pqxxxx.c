/*
 * XREFs of McTemplateK0pqxxxx @ 0x1C00273DC
 * Callers:
...
NTSTATUS McTemplateK0pqxxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventYieldConditionEvaluation, a3, 7u, &v4);
}
