/*
 * XREFs of ?WaitDmaBufferNotBusy@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@EPEAE@Z @ 0x1C006769C
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  LODWORD(v17[2]) = 0;
  if ( VidSchIsWorkerThread(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 512LL)) )
  {
  ...
  if ( (v11 & 2) == 0 )
  {
    ...
    if ( v12 )
      v12 = *(_QWORD *)(v12 + 232);
    v17[3] = v12;
    LODWORD(v17[4]) = v17[4] & 0xFFFFFFFD | (v12 != 0 ? 2 : 0);
  }
  VidSchRegisterCompletionEvent(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 512LL), v17);
  while ( *((_BYTE *)a2 + 24) == 1 )
  {
    if ( (unsigned int)VidSchWaitForCompletionEvent(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 512LL), v17, 1LL) == -1073741130 )
    {
      if ( a4 )
        *a4 = 1;
      break;
  ...
  VidSchiInterlockedRemoveEntryList(
    (KSPIN_LOCK *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 512LL) + 1904LL),
    v17,
    0LL);
}
