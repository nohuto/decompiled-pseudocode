/*
 * XREFs of McTemplateK0pppppppppppp @ 0x1C002171C
 * Callers:
 ...
 *     VidMmReportMultiAlloc @ 0x1C00A3860 (VidMmReportMultiAlloc.c)
...
NTSTATUS McTemplateK0pppppppppppp(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 0xDu, &v4);
}
