/*
 * XREFs of ?VidSchiAdvanceContextSubmissionId@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C00243A4
 * Callers:
...
void __fastcall VidSchiAdvanceContextSubmissionId(struct _VIDSCH_QUEUE_PACKET *a1, __int64 a2, __int64 a3)
{
  ...
  else
  {
    ...
    *(_QWORD *)(*((_QWORD *)a1 + 11) + 152LL) = *((_QWORD *)a1 + 14);
