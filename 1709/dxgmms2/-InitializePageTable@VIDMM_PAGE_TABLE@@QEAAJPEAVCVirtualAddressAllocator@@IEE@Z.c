/*
 * XREFs of ?InitializePageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@IEE@Z @ 0x1C0057B4C
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  v7 = a3;
  v9 = *(_QWORD *)(*((_QWORD *)a2 + 10) + 40168LL) + 1552LL * ((*(_DWORD *)this >> 7) & 0x1F);
  ...
  *((_QWORD *)this + 3) = v13;
  if ( v13 )
  {
    ...
    if ( a4 )
    {
      v16 = *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL);
    }
    else
    {
      v16 = *(_DWORD *)(v9 + 32);
      if ( a5 && *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL) > v16 )
        v16 = *(_DWORD *)(*(_QWORD *)(v9 + 440) + 12LL);
    }
  ...
  {
    _InterlockedIncrement(&dword_1C0040698);
    v21 = WdLogNewEntry5_WdLowResource(v15, v14);
    *(_QWORD *)(v21 + 24) = 3950LL;
