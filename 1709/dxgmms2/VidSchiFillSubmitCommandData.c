/*
 * XREFs of VidSchiFillSubmitCommandData @ 0x1C0013638
 * Callers:
...
LABEL_13:
  ...
  *((_DWORD *)a2 + 18) = v11;
  ...
  else
  {
    *a2 = *(_QWORD *)(v2 + 64);
    ...
    {
      *((_DWORD *)a2 + 18) |= 0x30u;
      *((_DWORD *)a2 + 17) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 412LL);
      *((_DWORD *)a2 + 16) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 176LL);
    }
    *((_DWORD *)a2 + 18) ^= (*((_DWORD *)a2 + 18) ^ (*(_DWORD *)(a1 + 92) >> 7)) & 2;
    *((_DWORD *)a2 + 18) ^= ((unsigned __int8)*((_DWORD *)a2 + 18) ^ (unsigned __int8)(*(_DWORD *)(a1 + 92) >> 1)) & 4;
  }
  v12 = *(_QWORD *)(a1 + 64);
  if ( v12 )
  {
  ...
  *((_DWORD *)a2 + 19) = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 424) + 6LL);
  result = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 424) + 8LL);
  *((_DWORD *)a2 + 22) = result;
  return result;
}
