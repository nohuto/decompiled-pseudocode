/*
 * XREFs of VidSchiCheckFlipQueueTimeout @ 0x1C000ABA0
 * Callers:
...
__int64 __fastcall VidSchiCheckFlipQueueTimeout(__int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  {
    v9 = a1 + 3008;
    while ( !*(_QWORD *)v9 || !*(_DWORD *)(*(_QWORD *)v9 + 2952LL) )
    {
      ++v8;
      v9 += 8LL;
      if ( v8 >= v7 )
...
LABEL_23:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v15 + 8) = MEMORY[0xFFFFF78000000320];
    if ( *(_DWORD *)(v12 + 2940) )
    {
      v18 = v15 + 1232LL * *(unsigned int *)(v15 + 44) + 56;
      v34 = v18;
      v19 = *(_DWORD *)(v18 + 1052);
      if ( v19 == 5 || v19 == 15 )
      {
