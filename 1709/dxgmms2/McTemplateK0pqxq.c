/*
 * XREFs of McTemplateK0pqxq @ 0x1C00270AC
 * Callers:
...
NTSTATUS McTemplateK0pqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventYieldAccumulateRunningTime, a3, 5u, &v4);
}
