/*
 * XREFs of McTemplateK0piixqq @ 0x1C0025F78
 * Callers:
 ...
 *     VidSchiResetContextQuantumAtISR @ 0x1C0011F70 (VidSchiResetContextQuantumAtISR.c)
 *     VidSchiStartContextRunningTimeAtISR @ 0x1C0011FF0 (VidSchiStartContextRunningTimeAtISR.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0016910 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C002152C (McGenEventWriteKM.c)
 */

NTSTATUS McTemplateK0piixqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventUpdateContextRunningTime, a3, 7u, &v4);
}
