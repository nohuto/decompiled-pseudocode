/*
 * XREFs of VidSchiWaitForSchedulerEvents @ 0x1C006EB80
 * Callers:
 *     VidSchiScheduleCommandToRun @ 0x1C0009D80 (VidSchiScheduleCommandToRun.c)
 * Callees:
 *     VidSchiIsFlipQueueBusy @ 0x1C0006E20 (VidSchiIsFlipQueueBusy.c)
...
__int64 __fastcall VidSchiWaitForSchedulerEvents(__int64 a1)
{
  ...
  Event[0] = (PRKEVENT)(a1 + 1408);
  Event[1] = (PRKEVENT)(a1 + 1352);
  v30 = a1 + 1520;
  while ( 1 )
  {
    v2 = Event;
