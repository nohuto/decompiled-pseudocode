/*
 * XREFs of ?UncommitVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_MAPPED_VA_RANGE@@PEAPEAUVIDMM_ALLOC@@E@Z @ 0x1C0054BF0
 * Callers:
        ...
        char a4)
{
  ...
  *(_QWORD *)&v25.SegmentId = 32LL * v24;
  ...
  if ( v26 )
  {
    ...
    v29[13] = -1;
    if ( (**(_DWORD **)(1552LL * v24 + v12 + 440) & 0x80u) != 0 )
