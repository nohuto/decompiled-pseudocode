/*
 * XREFs of ?MemoryTransferInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@PEAU_MDL@@234U_DXGK_TRANSFERFLAGS@@@Z @ 0x1C005E16C
 * Callers:
        ...
        DXGK_TRANSFERFLAGS a12)
{
  ...
  v13 = a2;
  v42 = a2;
  if ( (*(_BYTE *)(1552LL * a2 + *((_QWORD *)this + 5021) + 436) & 4) == 0 )
  {
    ...
    VIDMM_GLOBAL::SetupForBuildPagingBuffer(this, v13, (struct _VIDMM_GLOBAL_ALLOC *)a3, &v43);
    Value = a12.Value;
    ...
    while ( 1 )
    {
      VIDMM_GLOBAL::SetupForBuildPagingBufferIteration(this, v13, (struct _VIDMM_GLOBAL_ALLOC *)a3, &v43);
      if ( a3 )
      {
        v25 = a3[5];
        if ( v25 )
      ...
      if ( a3 )
        v28 = !VIDMM_GLOBAL::IsPagingOperationPending(this, (struct _VIDMM_GLOBAL_ALLOC *)a3, 0) ? 4 : 0;
      else
        v28 = 4;
...
LABEL_55:
      ...
      v13 = a2;
LABEL_58:
      VIDMM_GLOBAL::CompleteBuildPagingBufferIteration(this, v13, (struct _VIDMM_GLOBAL_ALLOC *)a3, &v43, v44, 0, 0LL);
      v21 = a6;
      if ( v44 >= 0 )
        return;
    }
