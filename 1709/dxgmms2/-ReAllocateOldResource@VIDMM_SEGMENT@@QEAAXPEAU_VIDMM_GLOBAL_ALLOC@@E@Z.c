/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C00AB404
 * Callers:
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  *((_QWORD *)this + 28) += *((_QWORD *)a2 + 2);
  if ( *((_DWORD *)this + 92) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
  {
    ...
    v13 = v12 + *((_QWORD *)a2 + 2);
    *((_QWORD *)this + 29) = v13;
    if ( v12 <= qword_1C0040410 && v13 > qword_1C0040410 )
  ...
  if ( (*((_DWORD *)this + 20) & 0x1001) != 0 )
  {
    ...
    if ( v14 )
    {
      if ( _InterlockedIncrement((volatile signed __int32 *)(v14 + 20)) == 1 )
        _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 61) + 48LL), *((_QWORD *)a2 + 2));
      if ( _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)a2 + 62) + 16LL)) != 1 )
        goto LABEL_21;
    }
    else
    {
