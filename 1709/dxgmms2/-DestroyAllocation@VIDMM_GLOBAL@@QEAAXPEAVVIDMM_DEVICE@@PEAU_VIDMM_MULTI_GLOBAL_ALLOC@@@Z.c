/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0064280
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0013000 (VidMmDestroyAllocation.c)
 * Callees:
