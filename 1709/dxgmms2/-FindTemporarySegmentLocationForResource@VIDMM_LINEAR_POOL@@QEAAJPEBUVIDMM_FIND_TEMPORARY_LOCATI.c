/*
 * XREFs of ?FindTemporarySegmentLocationForResource@VIDMM_LINEAR_POOL@@QEAAJPEBUVIDMM_FIND_TEMPORARY_LOCATION_ARGS@@_NPEA_K2@Z @ 0x1C00B2050
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  __int64 v13; // rax
  __int64 v15; // rax
  _QWORD v16[5]; // [rsp+20h] [rbp-68h] BYREF
  ...
  while ( v7 != v5 )
  {
    ...
    this = *(VIDMM_LINEAR_POOL **)v12;
    v8 = *(_QWORD *)v12 + *((_QWORD *)v12 + 1);
    if ( v8 > *((_QWORD *)a2 + 1) )
      break;
