/*
 * XREFs of VidSchiUpdateFlipQueueEntriesForMove @ 0x1C002A5DC
 * Callers:
...
void __fastcall VidSchiUpdateFlipQueueEntriesForMove(__int64 a1, _QWORD *a2)
{
  ...
  {
    v6 = *(_QWORD *)(a1 + 8LL * i + 3008);
    if ( v6 )
    {
      LOWORD(v7) = *(_WORD *)(v6 + 23520);
      while ( (_WORD)v7 )
      {
        v8 = *(unsigned __int16 *)(v6 + 23522);
        v9 = -1;
        v10 = 0;
        ...
        if ( v8 )
        {
          ...
          memset(&v25[1], 0, 0x850uLL);
          HIDWORD(v25[1]) = *(unsigned __int16 *)(v13 + v6 + 3064);
          v25[3] = *(_QWORD *)(v13 + v6 + 3040);
          v25[0] = a1;
          LODWORD(v25[1]) = i;
          if ( v10 )
            v15 = (__int64 *)(v6 + v13 + 3056);
          else
            v15 = &v29;
          v25[2] = *v15;
          v16 = 0;
          ...
          do
          {
            if ( v16 )
            {
              v18 = 3LL * (v16 - 1);
              v19 = 32 * ((v17 << 6) + v16);
              v25[v18 + 71] = *(_QWORD *)(32 * (v16 + (v17 << 6) + 95) + v6);
              LOWORD(v25[v18 + 72]) = *(_WORD *)(v19 + v6 + 3064);
              if ( v10 == v16 )
                v20 = &v23;
              else
                v20 = (__int64 *)(v19 + v6 + 3056);
              v25[3 * v16 + 70] = *v20;
              v8 = v25[4];
            }
            ++v16;
