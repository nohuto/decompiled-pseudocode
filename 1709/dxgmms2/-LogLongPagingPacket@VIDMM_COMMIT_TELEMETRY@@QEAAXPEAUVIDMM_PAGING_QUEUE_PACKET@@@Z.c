/*
 * XREFs of ?LogLongPagingPacket@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00AE754
 * Callers:
        ...
        struct VIDMM_PAGING_QUEUE_PACKET *a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 252LL)) <= 5 )
  {
      ...
      && (qword_1C0040068 & 0x400000000008LL) == qword_1C0040068 )
    {
      v4 = *((_QWORD *)a2 + 18);
      v5 = *((_QWORD *)a2 + 17);
      v6 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1248LL);
      v20 = 0;
      v18 = v22;
      v19 = 2;
      v7 = *v6;
      ...
      v15 = v11 - v5;
      v33 = 8;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0033591, &ActivityId, (LPCGUID)8, 8u, &pData);
    }
