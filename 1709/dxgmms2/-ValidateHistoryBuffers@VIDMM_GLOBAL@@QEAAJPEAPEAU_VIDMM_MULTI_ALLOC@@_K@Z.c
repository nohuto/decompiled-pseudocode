/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C009EE2C
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C0020F40 (VidMmValidateHistoryBuffers.c)
 * Callees:
  ...
  while ( 1 )
  {
    ...
    if ( v4[38] < 2 )
    {
      ...
      *(_QWORD *)(v7 + 32) = v4[38];
      ...
      VidSchiMarkDeviceAsError(*(_QWORD *)(*((_QWORD *)v4 + 1) + 32LL), 17);
      return 3221225473LL;
    }
  }
