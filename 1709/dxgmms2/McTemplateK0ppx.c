/*
 * XREFs of McTemplateK0ppx @ 0x1C0021F10
 * Callers:
...
NTSTATUS McTemplateK0ppx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 8LL;
  va_copy(v9, va2);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingQueueSelect, a3, 4u, &v4);
}
