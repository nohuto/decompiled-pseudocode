/*
 * XREFs of VidSchCreateProcess @ 0x1C0072720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchCreateProcess(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(v5 + 8) = a1;
  *(_DWORD *)(v5 + 16) = *(_BYTE *)(a1 + 305) != 0 ? 5 : 2;
  TdrHistoryInit((struct _TDR_HISTORY *)(v5 + 32));
  Global = DXGGLOBAL::GetGlobal();
  MaximumAdapterCount = DXGGLOBAL::GetMaximumAdapterCount(Global);
  v8 = ExAllocatePoolWithTag(PagedPool, 4 * ((unsigned __int64)(MaximumAdapterCount + 31) >> 5), 0x68536956u);
  *(_QWORD *)(v5 + 2616) = v8;
  if ( !v8 )
  {
...
LABEL_13:
  ...
  memset(v8, 0, 4 * ((unsigned __int64)(MaximumAdapterCount + 31) >> 5));
