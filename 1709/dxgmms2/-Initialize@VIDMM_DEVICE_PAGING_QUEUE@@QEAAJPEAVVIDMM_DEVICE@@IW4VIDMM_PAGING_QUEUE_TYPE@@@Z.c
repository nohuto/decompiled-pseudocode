/*
 * XREFs of ?Initialize@VIDMM_DEVICE_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IW4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C00705EC
 * Callers:
...
__int64 __fastcall VIDMM_DEVICE_PAGING_QUEUE::Initialize(_QWORD *a1, __int64 *a2, int a3, int a4)
{
  int v6; // eax
  __int64 v7; // rdx
  __int64 v8; // rcx
  ...
  v6 = VIDMM_PAGING_QUEUE::InitializePagingQueue((__int64)a1, (__int64)a2, a3, *a2, a4);
  v9 = v6;
  if ( v6 < 0 )
  {
...
LABEL_7:
  ...
  *(_QWORD *)&v17[2] = 4294962295LL;
  SyncObject = VidSchCreateSyncObject(*(_QWORD *)(v11 + 512), 0LL, (unsigned int *)v17, 0LL, (__int64)a1, a1 + 19, 0LL);
  v9 = SyncObject;
  if ( SyncObject < 0 )
  {
