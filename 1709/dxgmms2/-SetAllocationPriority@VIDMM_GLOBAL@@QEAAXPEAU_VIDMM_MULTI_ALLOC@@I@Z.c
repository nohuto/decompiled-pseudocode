/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C009D134
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C0020DB0 (VidMmSetAllocationPriority.c)
 * Callees:
