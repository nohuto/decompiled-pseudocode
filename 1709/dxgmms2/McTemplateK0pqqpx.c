/*
 * XREFs of McTemplateK0pqqpx @ 0x1C0026834
 * Callers:
...
NTSTATUS McTemplateK0pqqpx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventWaitQueueSubmit, a3, 6u, &v4);
}
