/*
 * XREFs of McTemplateK0pptpqxpxx @ 0x1C0017148
 * Callers:
...
__int64 McTemplateK0pptpqxpxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpFlushTlb, a3, 10LL, v4);
}
