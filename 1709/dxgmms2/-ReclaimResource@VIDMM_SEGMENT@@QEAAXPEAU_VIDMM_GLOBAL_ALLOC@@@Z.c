/*
 * XREFs of ?ReclaimResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C004F6AC
 * Callers:
 ...
 * Callees:
 *     ?ReclaimBlock@VIDMM_LINEAR_POOL@@QEAAXPEAX@Z @ 0x1C00502F4 (-ReclaimBlock@VIDMM_LINEAR_POOL@@QEAAXPEAX@Z.c)
...
void __fastcall VIDMM_SEGMENT::ReclaimResource(VIDMM_LINEAR_POOL **this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  *((_QWORD *)SegmentGroupState + 14) += v6;
  ...
  {
    v17 = *((_QWORD *)a2 + 62);
    if ( !v17 || _InterlockedIncrement((volatile signed __int32 *)(v17 + 20)) == 1 )
      _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 61) + 48LL), *((_QWORD *)a2 + 2));
  }
  v12 = (char *)a2 + 384;
  v13 = *(_QWORD *)v12;
  if ( *(char **)(*(_QWORD *)v12 + 8LL) != v12 || (v14 = (char **)*((_QWORD *)v12 + 1), *v14 != v12) )
    __fastfail(3u);
  *v14 = (char *)v13;
  v15 = (char *)(this + 20);
  *(_QWORD *)(v13 + 8) = v14;
