/*
 * XREFs of ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C006431C
 * Callers:
 *     VidMmTerminateAllocation @ 0x1C00132E0 (VidMmTerminateAllocation.c)
 * Callees:
