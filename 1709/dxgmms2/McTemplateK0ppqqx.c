/*
 * XREFs of McTemplateK0ppqqx @ 0x1C002616C
 * Callers:
...
NTSTATUS McTemplateK0ppqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v15 = 4LL;
  v17 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPropagatePresentHistory, 0LL, 6u, &v7);
}
