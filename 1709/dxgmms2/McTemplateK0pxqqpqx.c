/*
 * XREFs of McTemplateK0pxqqpqx @ 0x1C0027514
 * Callers:
...
NTSTATUS McTemplateK0pxqqpqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCancelFlip, a3, 8u, &v4);
}
