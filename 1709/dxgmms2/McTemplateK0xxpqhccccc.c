/*
 * XREFs of McTemplateK0xxpqhccccc @ 0x1C0023F9C
 * Callers:
...
NTSTATUS McTemplateK0xxpqhccccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 1LL;
  v24 = 1LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventVidMmProcessBudgetChange, a3, 0xBu, &v4);
}
