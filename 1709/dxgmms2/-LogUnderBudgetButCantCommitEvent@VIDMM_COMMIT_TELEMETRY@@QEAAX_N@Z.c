/*
 * XREFs of ?LogUnderBudgetButCantCommitEvent@VIDMM_COMMIT_TELEMETRY@@QEAAX_N@Z @ 0x1C00AF124
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogUnderBudgetButCantCommitEvent(VIDMM_COMMIT_TELEMETRY *this, char a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 248LL)) <= 5 )
  {
    ...
    {
      v5 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1248LL);
      v12 = 0;
      v10 = v14;
      v11 = 2;
      v6 = *v5;
      ...
      v13 = v7;
      v14[0] = v6;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003376B, &ActivityId, v4, 4u, &pData);
    }
    VIDMM_COMMIT_TELEMETRY::LogAllocationInformation((LPCGUID)this, *((__int64 ***)this + 2), a2, &ActivityId);
    VIDMM_COMMIT_TELEMETRY::LogMemoryState((VIDMM_GLOBAL **)this, &ActivityId);
