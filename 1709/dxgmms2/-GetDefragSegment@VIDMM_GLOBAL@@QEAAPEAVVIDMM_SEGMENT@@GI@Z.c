/*
 * XREFs of ?GetDefragSegment@VIDMM_GLOBAL@@QEAAPEAVVIDMM_SEGMENT@@GI@Z @ 0x1C009AFF4
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( !a3 )
    return 0LL;
  v4 = *((_QWORD *)this + 464);
  v5 = *(_DWORD *)(1552LL * a2 + *((_QWORD *)this + 5021) + 20);
  while ( 1 )
  {
    ...
    if ( *(_BYTE *)(v7 + 473) )
    {
      if ( *(_QWORD *)(v7 + 480) != *(_QWORD *)(*(_QWORD *)this + 232LL) )
        break;
    }
    if ( !a3 )
      return 0LL;
