/*
 * XREFs of McTemplateK0pppxqpq @ 0x1C0022D20
 * Callers:
...
NTSTATUS McTemplateK0pppxqpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingQueueSubmit, a3, 8u, &v4);
}
