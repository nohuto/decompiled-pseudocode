/*
 * XREFs of McTemplateK0pptpqxqqppqqxxpqx @ 0x1C00172F8
 * Callers:
...
__int64 McTemplateK0pptpqxqqppqqxxpqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v36 = 4LL;
  v38 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpUpdatePageTable, a3, 18LL, v4);
}
