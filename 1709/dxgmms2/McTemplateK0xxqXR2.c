/*
 * XREFs of McTemplateK0xxqXR2 @ 0x1C0023E78
 * Callers:
...
NTSTATUS McTemplateK0xxqXR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v11 = v20;
  v12 = 8 * v18;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventLockAllocationBackingStore, a3, 5u, &v4);
}
