/*
 * XREFs of McTemplateK0txqqqtxtx @ 0x1C002AFB8
 * Callers:
 *     VidSchExitIndependentFlipInternal @ 0x1C0014E08 (VidSchExitIndependentFlipInternal.c)
 *     VidSchEnterIndependentFlip @ 0x1C00153C0 (VidSchEnterIndependentFlip.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0016910 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C002152C (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0txqqqtxtx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  v29 = 4LL;
  v31 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndependentFlipTransition, a3, 0xAu, &v13);
}
