/*
 * XREFs of ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00A6B9C
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00A6D44 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
 */
