/*
 * XREFs of McTemplateK0ppqxqpq @ 0x1C00262E8
 * Callers:
...
NTSTATUS McTemplateK0ppqxqpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDmaSubmit, a3, 8u, &v4);
}
