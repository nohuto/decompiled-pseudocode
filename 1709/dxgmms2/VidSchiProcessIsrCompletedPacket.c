/*
 * XREFs of VidSchiProcessIsrCompletedPacket @ 0x1C000C470
 * Callers:
...
__int64 __fastcall VidSchiProcessIsrCompletedPacket(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v10 + 16) = 1;
    ...
    if ( v16 && v16 != v20 )
      *(_QWORD *)(v16 + 448) = *(_QWORD *)(v20 + 448);
    if ( (*(_DWORD *)(v10 + 92) & 0x200) != 0 )
    {
      VidSchiUpdateCurrentIsrFrameTime(
        v8,
        *(_QWORD *)(v8 + 8LL * *(unsigned int *)(*(_QWORD *)(v10 + 56) + 176LL) + 3008),
        0LL);
      *(_QWORD *)(*(_QWORD *)(v10 + 56) + 152LL) = *(_QWORD *)(*(_QWORD *)(v8
                                                                         + 8LL
                                                                         * *(unsigned int *)(*(_QWORD *)(v10 + 56)
                                                                                           + 176LL)
                                                                         + 3008)
                                                             + 23528LL);
      *(_DWORD *)(*(_QWORD *)(v10 + 56) + 144LL) = *(_DWORD *)(*(_QWORD *)(v8
                                                                         + 8LL
                                                                         * *(unsigned int *)(*(_QWORD *)(v10 + 56)
                                                                                           + 176LL)
                                                                         + 3008)
    ...
    VidSchiProfilePerformanceTick(8LL, v8, a1, v15, 0LL, 0LL, v10, 0LL);
    ExpInterlockedPushEntrySList((PSLIST_HEADER)(v8 + 1936), (PSLIST_ENTRY)(v10 + 32));
