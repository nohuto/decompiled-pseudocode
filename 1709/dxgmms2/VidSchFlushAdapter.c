/*
 * XREFs of VidSchFlushAdapter @ 0x1C00B4320
 * Callers:
 ...
 *     VidSchiUnlinkCrossAdapterSyncObjects @ 0x1C002A454 (VidSchiUnlinkCrossAdapterSyncObjects.c)
  ...
  if ( a1 )
  {
    ...
    if ( VidSchIsWorkerThread((__int64)a1) )
    {
      if ( v3 )
      {
        ...
        if ( (unsigned int)(*((_DWORD *)a1 + 69) - 2) > 1 )
          VidSchiHandleControlEvent((__int64)a1);
      }
    }
    else if ( *(_BYTE *)(*((_QWORD *)a1 + 1) + 761LL) )
    {
    ...
    else if ( (unsigned int)VidSchiGetSchedulerStatus((__int64)a1) == 1 )
    {
      ...
      if ( v5 >= 0 && (v3 & 1) != 0 )
      {
        ...
        {
          VidSchiClearFlipDevice(a1, 0LL, 9u);
          VidSchiInterlockedReadUlong((KSPIN_LOCK *)a1 + 239, (_DWORD *)a1 + 240);
        }
      }
    }
    LOBYTE(v2) = v3 == 15;
    _InterlockedOr((volatile signed __int32 *)a1 + 1551, v2);
