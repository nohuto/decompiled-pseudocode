/*
 * XREFs of VidSchSetPriorityContext @ 0x1C0072300
 * Callers:
 ...
 *     VidSchiComputePriority @ 0x1C0072388 (VidSchiComputePriority.c)
 */

__int64 __fastcall VidSchSetPriorityContext(__int64 a1, __int64 a2, int a3, int a4)
{
  int v4; // esi
  __int64 v6; // rdi
  int v7; // edi
