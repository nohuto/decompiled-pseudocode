/*
 * XREFs of McTemplateK0pqxqt @ 0x1C002732C
 * Callers:
...
NTSTATUS McTemplateK0pqxqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDmaDpcComplete, a3, 6u, &v4);
}
