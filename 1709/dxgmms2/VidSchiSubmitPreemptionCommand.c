/*
 * XREFs of VidSchiSubmitPreemptionCommand @ 0x1C0071AE8
 * Callers:
...
__int64 __fastcall VidSchiSubmitPreemptionCommand(__int64 a1)
{
  ...
  *(_DWORD *)(DmaPacket + 88) = 3;
  ...
  _InterlockedIncrement((volatile signed __int32 *)(a1 + 2788));
  _InterlockedIncrement((volatile signed __int32 *)(v4 + 1196));
  _InterlockedIncrement((volatile signed __int32 *)(v1 + 768));
  if ( *(_DWORD *)(a1 + 5904) != -1 )
  {
    v8 = *(void (__fastcall **)(_QWORD))(v3 + 2864);
    if ( v8 )
      v8(*(_QWORD *)(v3 + 2928));
  }
