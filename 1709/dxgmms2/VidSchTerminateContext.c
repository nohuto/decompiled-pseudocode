/*
 * XREFs of VidSchTerminateContext @ 0x1C00706B0
 * Callers:
 ...
 *     ?VidSchiRemoveContextFromSyncPoints@@YAXPEAU_VIDSCH_CONTEXT@@@Z @ 0x1C000E8E0 (-VidSchiRemoveContextFromSyncPoints@@YAXPEAU_VIDSCH_CONTEXT@@@Z.c)
...
__int64 __fastcall VidSchTerminateContext(struct _VIDSCH_CONTEXT *a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    _InterlockedCompareExchange((volatile signed __int32 *)a1 + 220, 1, 0);
    ...
    if ( (v4 & 1) != 0 && (v7 = (void *)*((_QWORD *)a1 + 8)) != 0LL )
    {
      ...
      *((_QWORD *)a1 + 8) = 0LL;
      ...
      v13 = *(_OWORD *)((char *)a1 + 924);
      v14 = *(_OWORD *)((char *)a1 + 940);
