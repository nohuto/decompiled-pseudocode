/*
 * XREFs of McTemplateK0pptpqxq @ 0x1C0017238
 * Callers:
...
__int64 McTemplateK0pptpqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpNotifyResidency, a3, 8LL, v4);
}
