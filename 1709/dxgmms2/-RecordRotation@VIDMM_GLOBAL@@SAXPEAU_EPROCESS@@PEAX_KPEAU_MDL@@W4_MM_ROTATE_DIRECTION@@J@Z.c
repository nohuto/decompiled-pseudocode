/*
 * XREFs of ?RecordRotation@VIDMM_GLOBAL@@SAXPEAU_EPROCESS@@PEAX_KPEAU_MDL@@W4_MM_ROTATE_DIRECTION@@J@Z @ 0x1C00731F0
 * Callers:
        ...
        int a6)
{
  ...
  {
    v7 = 6LL * (_InterlockedExchangeAdd((_DWORD *)&qword_1C0040490 + 1, 1u) % (unsigned int)qword_1C0040490);
