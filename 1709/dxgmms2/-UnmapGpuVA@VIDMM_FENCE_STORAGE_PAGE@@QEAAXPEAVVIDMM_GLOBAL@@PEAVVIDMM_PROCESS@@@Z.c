/*
 * XREFs of ?UnmapGpuVA@VIDMM_FENCE_STORAGE_PAGE@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@@Z @ 0x1C006FE58
 * Callers:
        ...
        if ( (*((_DWORD *)v9 + 20))-- == 1 )
        {
          if ( v9[16] )
          {
            ...
            *(_QWORD *)&v16.hAdapter = 0LL;
            ...
            v12 = *((_QWORD *)a2 + 3);
            v16.Size = 4096LL;
            VirtualAddressAllocator = VIDMM_PROCESS::GetVirtualAddressAllocator(v11, *(_DWORD *)(v12 + 200), 0xFFFFFFFF);
          ...
          v14 = *((_QWORD *)v9 + 8);
          if ( *(char **)(v14 + 8) != v9 + 64 || (v15 = (char **)*((_QWORD *)v9 + 9), *v15 != v9 + 64) )
            __fastfail(3u);
          *v15 = (char *)v14;
          *(_QWORD *)(v14 + 8) = v15;
