/*
 * XREFs of McTemplateK0pptpqqx @ 0x1C0016FA8
 * Callers:
...
__int64 McTemplateK0pptpqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpDiscard, a3, 8LL, v4);
}
