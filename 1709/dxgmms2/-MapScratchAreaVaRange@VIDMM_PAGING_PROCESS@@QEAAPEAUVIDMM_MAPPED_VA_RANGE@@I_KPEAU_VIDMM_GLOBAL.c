/*
 * XREFs of ?MapScratchAreaVaRange@VIDMM_PAGING_PROCESS@@QEAAPEAUVIDMM_MAPPED_VA_RANGE@@I_KPEAU_VIDMM_GLOBAL_ALLOC@@0I0PEAU_MDL@@PEAE0@Z @ 0x1C0072574
 * Callers:
        ...
        unsigned __int64 a10)
{
  ...
  if ( a6 )
  {
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 3712LL)
                               + 8LL
                               * (*(_DWORD *)(1552LL * a2 + *(_QWORD *)(*((_QWORD *)this + 2) + 40168LL) + 20) + a6 - 1))
                   + 376LL) == 0x10000
      && !(_WORD)a3 )
    {
      v13 = *((_DWORD *)a4 + 8);
  ...
  *(_BYTE *)a9 = v14;
  ...
  v18 = (struct VIDMM_VAD **)*((_QWORD *)this + v10 + 4);
