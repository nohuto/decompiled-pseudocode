/*
 * XREFs of ?RecordVaPagingHistoryCommit@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1I1PEAU_MDL@@PEAXW4VIDMM_VAD_OWNER_TYPE@@@Z @ 0x1C00A4800
 * Callers:
        ...
        int a9)
{
  ...
  if ( *(_QWORD *)(a1 + 40920) )
  {
    ...
    *(_QWORD *)(v13 + 8) = KeGetCurrentThread();
    ...
    if ( v14 )
    {
      if ( *(_DWORD *)(a1 + 40928) == dword_1C004033C )
        *(_DWORD *)(a1 + 40928) = 0;
