/*
 * XREFs of ?VidschiUnselectContext@@YAXPEAU_VIDSCH_CONTEXT@@@Z @ 0x1C0011110
 * Callers:
...
void __fastcall VidschiUnselectContext(struct _VIDSCH_CONTEXT *a1)
{
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL) + 1888LL), &LockHandle);
  if ( (*((_DWORD *)a1 + 44) & 0x400) != 0 )
  {
    *((_DWORD *)a1 + 44) &= ~0x400u;
    if ( (*((_DWORD *)a1 + 44) & 0x200) != 0 && (*((_DWORD *)a1 + 44) & 2) == 0 )
      VidSchiUpdateContextStatus((__int64)a1, (_QWORD *)0xA, (_QWORD *)0x1CC);
  }
