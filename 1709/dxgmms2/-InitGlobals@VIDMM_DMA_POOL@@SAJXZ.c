/*
 * XREFs of ?InitGlobals@VIDMM_DMA_POOL@@SAJXZ @ 0x1C007DD14
 * Callers:
...
__int64 VIDMM_DMA_POOL::InitGlobals(void)
{
  ...
  qword_1C0040720 = (__int64)&VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_DmaPoolsListHead.Flink = &VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_MaxNbDmaBuffers = dword_1C0040298;
  VIDMM_DMA_POOL::_MaxNbCddDmaBuffers = dword_1C004029C;
  VIDMM_DMA_POOL::_MaxDmaBufferBytes = (unsigned int)dword_1C00402A0;
  VIDMM_DMA_POOL::_MaxAllocationListBytes = (unsigned int)dword_1C00402A4;
  VIDMM_DMA_POOL::_MaxPatchLocationListBytes = (unsigned int)dword_1C00402A4;
  v0 = ((unsigned __int64)((unsigned int)dword_1C00402A0
                         + (((unsigned __int128)(unsigned int)dword_1C00402A0 * (__int64)0xA3D70A3D70A3D70BuLL) >> 64)) >> 63)
     + ((__int64)((unsigned int)dword_1C00402A0
                + (((unsigned __int128)(unsigned int)dword_1C00402A0 * (__int64)0xA3D70A3D70A3D70BuLL) >> 64)) >> 6);
  ...
  v1 = ((unsigned __int64)((unsigned int)dword_1C00402A4
                         + (((unsigned __int128)(unsigned int)dword_1C00402A4 * (__int64)0xA3D70A3D70A3D70BuLL) >> 64)) >> 63)
     + ((__int64)((unsigned int)dword_1C00402A4
                + (((unsigned __int128)(unsigned int)dword_1C00402A4 * (__int64)0xA3D70A3D70A3D70BuLL) >> 64)) >> 6);
  ...
  if ( v2 )
  {
    ...
    {
      VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark = dword_1C00402A8;
      return 0LL;
    }
  }
  else
