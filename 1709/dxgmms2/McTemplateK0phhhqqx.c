/*
 * XREFs of McTemplateK0phhhqqx @ 0x1C0023968
 * Callers:
...
NTSTATUS McTemplateK0phhhqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventVidMmVprDefragmentLowCommit, a3, 8u, &v5);
}
