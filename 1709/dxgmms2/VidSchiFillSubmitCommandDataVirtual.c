/*
 * XREFs of VidSchiFillSubmitCommandDataVirtual @ 0x1C00068F0
 * Callers:
...
__int64 __fastcall VidSchiFillSubmitCommandDataVirtual(__int64 a1, _QWORD *a2)
{
  ...
  *((_DWORD *)a2 + 13) = v11;
  v12 = v11 ^ ((unsigned __int16)v11 ^ (unsigned __int16)(*(unsigned __int8 *)(v2 + 885) << 8)) & 0x100;
  *((_DWORD *)a2 + 13) = v12;
  if ( *(_DWORD *)(a1 + 88) )
  {
    *((_DWORD *)a2 + 13) = v12 | 1;
  ...
  else
  {
    *a2 = *(_QWORD *)(v2 + 64);
    ...
    {
      *((_DWORD *)a2 + 13) |= 0x30u;
      *((_DWORD *)a2 + 12) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 412LL);
      *((_DWORD *)a2 + 11) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 176LL);
    }
    *((_DWORD *)a2 + 13) ^= (*((_DWORD *)a2 + 13) ^ (*(_DWORD *)(a1 + 92) >> 7)) & 2;
    *((_DWORD *)a2 + 13) ^= ((unsigned __int8)*((_DWORD *)a2 + 13) ^ (unsigned __int8)(*(_DWORD *)(a1 + 92) >> 1)) & 4;
  }
  a2[1] = *(_QWORD *)(a1 + 176);
  ...
  *((_DWORD *)a2 + 14) = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 424) + 6LL);
