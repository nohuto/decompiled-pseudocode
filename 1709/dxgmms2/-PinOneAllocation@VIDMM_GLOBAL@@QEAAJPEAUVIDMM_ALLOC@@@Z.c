/*
 * XREFs of ?PinOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@@Z @ 0x1C0074388
 * Callers:
 ...
 *     ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAKPEAT_LARGE_INTEGER@@@Z @ 0x1C007445C (-PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAKPEAT_LARGE_INTEGER@@@Z.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::PinOneAllocation(VIDMM_GLOBAL *this, VIDMM_DEVICE **a2)
{
  ...
  if ( (int)result >= 0 && !v11 )
  {
    ...
    v10[2] = a2;
    v6 = *(_QWORD *)v5;
    LODWORD(v10[4]) = (**(_DWORD **)(*(_QWORD *)v5 + 504LL) & 0x20000) != 0 ? 5 : 0;
