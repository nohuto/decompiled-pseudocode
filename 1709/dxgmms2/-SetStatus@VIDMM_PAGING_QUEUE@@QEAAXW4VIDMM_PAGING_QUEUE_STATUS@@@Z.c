/*
 * XREFs of ?SetStatus@VIDMM_PAGING_QUEUE@@QEAAXW4VIDMM_PAGING_QUEUE_STATUS@@@Z @ 0x1C006D590
 * Callers:
 ...
 *     ?Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ @ 0x1C006D9AC (-Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ.c)
