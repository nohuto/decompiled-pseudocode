/*
 * XREFs of McTemplateK0pptpxxpq @ 0x1C00179B4
 * Callers:
...
__int64 McTemplateK0pptpxxpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  _BYTE v4[16]; // [rsp+30h] [rbp-81h] BYREF
  ...
  v18 = 8LL;
  v20 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpUpdateContextAllocation, a3, 9LL, v4);
}
