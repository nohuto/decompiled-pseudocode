/*
 * XREFs of ?DeInitGlobals@VIDMM_GLOBAL@@SAXXZ @ 0x1C0099FD0
 * Callers:
 *     VidMmDeInitGlobals @ 0x1C0020BD0 (VidMmDeInitGlobals.c)
 * Callees:
 ...
 *     McGenEventUnregister @ 0x1C0021500 (McGenEventUnregister.c)
