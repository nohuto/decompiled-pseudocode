/*
 * XREFs of ?NotifyMemorySegmentIdle@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C0021370
 * Callers:
 *     ?VidMmSetSegmentPowerState@@YAXPEAVVIDMM_GLOBAL@@IIIE@Z @ 0x1C00209F0 (-VidMmSetSegmentPowerState@@YAXPEAVVIDMM_GLOBAL@@IIIE@Z.c)
...
void __fastcall VIDMM_GLOBAL::NotifyMemorySegmentIdle(VIDMM_GLOBAL *this, struct VIDMM_SEGMENT *a2)
{
  ...
  v4 = (_DWORD *)(*((_QWORD *)this + 5021) + 1552LL * *((unsigned int *)a2 + 95));
  v5 = (char *)this + 40992;
  v6 = 1 << *((_DWORD *)a2 + 5);
  ...
  *((_QWORD *)v5 + 1) = KeGetCurrentThread();
  ...
  {
    v4[108] &= ~v6;
    if ( ((*((_DWORD *)a2 + 20) >> 12) & 1) != 0 )
      v7 = 0;
    else
      v7 = *((_DWORD *)a2 + 4) + 1;
    if ( v4[16] != v7 )
    {
      v8 = ((*((_DWORD *)a2 + 20) >> 12) & 1) != 0 ? 0 : *((_DWORD *)a2 + 4) + 1;
      if ( v4[12] != v8 )
