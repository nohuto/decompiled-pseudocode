/*
 * XREFs of VidSchiProcessDpcDmaPacket @ 0x1C002863C
 * Callers:
...
void __fastcall VidSchiProcessDpcDmaPacket(struct _VIDSCH_DMA_PACKET *a1, __int64 a2)
{
  ...
  *(_DWORD *)(v4 + 496) = ((unsigned __int8)*(_DWORD *)(v4 + 496) + 1) & 0xF;
  KeAcquireInStackQueuedSpinLockAtDpcLevel(v6 + 236, &LockHandle);
  v8 = *((_DWORD *)a1 + 23);
  if ( (v8 & 0x400) != 0 )
  {
    *((_DWORD *)a1 + 23) = v8 & 0xFFFFFBFF;
    if ( *(_DWORD *)(v4 + 5904) != -1 )
    {
      v9 = (void (__fastcall *)(KSPIN_LOCK))v6[362];
      if ( v9 )
        v9(v6[366]);
    }
  }
  ...
  {
    if ( *(_DWORD *)(v6[*(unsigned int *)(*((_QWORD *)a1 + 7) + 404LL) + 376] + 23648) != -1 )
    {
      v10 = (void (__fastcall *)(KSPIN_LOCK))v6[360];
      if ( v10 )
        v10(v6[366]);
    }
    *((_DWORD *)a1 + 23) &= ~0x800u;
  ...
  VidSchiInterlockedInsertTailList((KSPIN_LOCK *)(*(_QWORD *)(v4 + 24) + 1896LL), v4 + 5912, (_QWORD *)a1 + 2, 0LL);
}
