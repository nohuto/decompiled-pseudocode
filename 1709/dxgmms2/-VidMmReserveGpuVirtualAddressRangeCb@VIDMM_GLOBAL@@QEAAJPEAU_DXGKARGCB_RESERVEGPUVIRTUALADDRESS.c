/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C00649E8
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C0013F80 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
...
LABEL_9:
  ...
  v10 = 1;
  if ( *(_BYTE *)(*((_QWORD *)v2->hDxgkProcess + 4) + 305LL) )
  {
    if ( ((unsigned __int8)a2 & 0x10) == 0 )
    {
      result = VIDMM_PROCESS::OpenAdapter(*((struct DXGPROCESS ***)v2->hDxgkProcess + 1), this);
      v8 = result;
      if ( (int)result < 0 )
        return result;
      *((_BYTE *)this + 40872) |= 0x10u;
    }
    v10 = *((_DWORD *)this + 1604);
  }
  v11 = 0;
  if ( v10 )
  {
    ...
    do
    {
      ...
      else if ( (*(_BYTE *)(*((_QWORD *)this + 5021) + v12 + 436) & 1) != 0 )
      {
        return 3221225485LL;
      }
      ++v11;
