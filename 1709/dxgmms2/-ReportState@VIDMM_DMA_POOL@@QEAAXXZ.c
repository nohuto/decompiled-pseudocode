/*
 * XREFs of ?ReportState@VIDMM_DMA_POOL@@QEAAXXZ @ 0x1C00A2514
 * Callers:
 *     VidMmReportDmaPoolState @ 0x1C0020D30 (VidMmReportDmaPoolState.c)
...
LABEL_26:
    ...
    v18 = *(_QWORD *)(v7 + 136);
    if ( v18 && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    {
