/*
 * XREFs of McTemplateK0pqqxqqtp @ 0x1C0026FCC
 * Callers:
...
NTSTATUS McTemplateK0pqqxqqtp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventQueueSubmit, a3, 9u, &v4);
}
