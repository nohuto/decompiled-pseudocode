/*
 * XREFs of McTemplateK0ppqq @ 0x1C0021A3C
 * Callers:
...
NTSTATUS McTemplateK0ppqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventLock, a3, 5u, &v4);
}
