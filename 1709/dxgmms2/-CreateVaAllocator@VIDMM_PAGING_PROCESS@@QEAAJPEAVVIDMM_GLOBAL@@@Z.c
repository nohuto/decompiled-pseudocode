/*
 * XREFs of ?CreateVaAllocator@VIDMM_PAGING_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C007C948
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_PROCESS::CreateVaAllocator(VIDMM_PAGING_PROCESS *this, struct VIDMM_GLOBAL *a2)
{
  ...
  *((_QWORD *)this + 2) = a2;
  ...
  while ( 1 )
  {
    v5 = 1552LL * (unsigned int)v4;
    if ( (*(_BYTE *)(v5 + *((_QWORD *)a2 + 5021) + 436) & 1) == 0 )
      goto LABEL_8;
