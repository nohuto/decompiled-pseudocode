/*
 * XREFs of VidSchiProcessIsrFaultedPacket @ 0x1C00287C4
 * Callers:
...
void __fastcall VidSchiProcessIsrFaultedPacket(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a1 + 64) != a2 && *(_DWORD *)(a1 + 72) != a2 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(*(_QWORD *)(v11 + 104) + 168LL) = *(_QWORD *)(a4 + 16);
      *(_DWORD *)(*(_QWORD *)(v11 + 104) + 176LL) = *(_DWORD *)(a4 + 24);
      *(_DWORD *)(*(_QWORD *)(v11 + 104) + 180LL) = *(_DWORD *)(a4 + 28);
      *(_DWORD *)(*(_QWORD *)(v11 + 104) + 184LL) = *(_DWORD *)(a4 + 32);
      *(_QWORD *)(*(_QWORD *)(v11 + 104) + 192LL) = *(_QWORD *)(a4 + 40);
      *(_DWORD *)(*(_QWORD *)(v11 + 104) + 188LL) = *(_DWORD *)(a4 + 60);
