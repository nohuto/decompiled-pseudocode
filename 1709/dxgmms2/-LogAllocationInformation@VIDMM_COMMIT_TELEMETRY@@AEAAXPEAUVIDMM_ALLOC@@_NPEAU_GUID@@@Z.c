/*
 * XREFs of ?LogAllocationInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_ALLOC@@_NPEAU_GUID@@@Z @ 0x1C00AE148
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  if ( pRelatedActivityId[1].Data4[0] && *(_QWORD *)&pRelatedActivityId[1].Data1 )
  {
    ...
    if ( !a3
      || (v7 = *(_DWORD *)(v6 + 76),
          *(char *)(1552LL * (v7 & 0x3F) + *(_QWORD *)(*(_QWORD *)&pRelatedActivityId->Data1 + 40168LL) + 437) >= 0)
      || (v8 = 1, (v7 & 0x400) != 0) )
    {
      v8 = 0;
    }
    ...
    {
      v9 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)&pRelatedActivityId->Data1 + 24LL) + 1248LL);
      v19 = v22;
      v20 = 2LL;
      v10 = *v9;
      v21 = *((_QWORD *)v9 + 1);
      ...
      v17 = HIBYTE(v11) & 0x1F;
      v36 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00337AD, a4, pRelatedActivityId, 0xBu, &pData);
    }
  }
}
