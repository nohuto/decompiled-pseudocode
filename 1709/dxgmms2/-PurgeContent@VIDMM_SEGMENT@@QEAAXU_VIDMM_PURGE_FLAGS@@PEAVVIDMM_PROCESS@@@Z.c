/*
 * XREFs of ?PurgeContent@VIDMM_SEGMENT@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C0075584
 * Callers:
        ...
        do
        {
          ...
          if ( (_QWORD *)*v41 != v41 )
          {
            while ( 1 )
            {
              ...
              {
                v28 = WdLogNewEntry5_WdWarning(v13);
                *(_QWORD *)(v28 + 24) = v12;
...
LABEL_11:
            ...
            VIDMM_GLOBAL::UnpinOneAllocation(*(struct VIDMM_ALLOC ***)(a1 + 8), v12, 3LL, 0);
LABEL_9:
            a2 = v39;
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( *v15 == (__int64 *)v15 )
      break;
    v17 = v16 - 48;
    if ( (*(_DWORD *)v16[15] & 0x10000000) == 0
      && (*((_DWORD *)v17 + 19) & 0x100) == 0
      && ((v4 & 4) == 0 || (unsigned __int64)(v17[2] + v17[18]) > *(_QWORD *)(a1 + 128))
      && !*((_DWORD *)v17 + 40) )
    {
    ...
    if ( *v16 )
    {
      if ( (__int64 *)v18[1] != v16 || (v19 = (__int64 **)v16[1], *v19 != v16) )
        __fastfail(3u);
      *v19 = v18;
      v18[1] = (__int64)v19;
      v20 = v38;
  ...
  while ( 1 )
  {
    ...
    if ( *v25 == (__int64 *)v25 )
      break;
    v30 = v26 - 48;
    if ( (*(_DWORD *)v26[15] & 0x10000000) == 0
      && (*((_DWORD *)v30 + 19) & 0x100) == 0
      && ((v4 & 4) == 0
       || (*(_DWORD *)(a1 + 80) & 0x200) == 0
       || (unsigned __int64)(v30[2] + v30[18]) > *(_QWORD *)(a1 + 128))
      && !*((_DWORD *)v30 + 40) )
    {
    ...
    if ( *v26 )
    {
      if ( (__int64 *)v31[1] != v26 || (v32 = (__int64 **)v26[1], *v32 != v26) )
        __fastfail(3u);
      *v32 = v31;
      v31[1] = (__int64)v32;
      v33 = v38;
