/*
 * XREFs of ?AsyncUnpinAllocation@VIDMM_GLOBAL@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1C00738E4
 * Callers:
 *     VidMmAsyncUnpinAllocation @ 0x1C0014BC0 (VidMmAsyncUnpinAllocation.c)
 * Callees:
 ...
 *     ?AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ @ 0x1C0014C00 (-AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ.c)
