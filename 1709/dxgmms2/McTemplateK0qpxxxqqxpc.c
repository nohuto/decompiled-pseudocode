/*
 * XREFs of McTemplateK0qpxxxqqxpc @ 0x1C0023D04
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpxxxqqxpc(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a13)
{
  ...
  v33 = 8LL;
  v35 = 1LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventReportSegment, 0LL, 0xBu, &v15);
}
