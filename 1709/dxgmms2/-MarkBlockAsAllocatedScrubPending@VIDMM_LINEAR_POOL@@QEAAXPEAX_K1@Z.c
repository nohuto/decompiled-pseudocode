/*
 * XREFs of ?MarkBlockAsAllocatedScrubPending@VIDMM_LINEAR_POOL@@QEAAXPEAX_K1@Z @ 0x1C00B2408
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( *a2 > a3 )
  {
    ...
    if ( a3 == *(_QWORD *)v11 )
    {
      v23 = v11 + 40;
      v24 = *((_QWORD *)v11 + 5);
      if ( *(char **)(v24 + 8) != v11 + 40 || (v25 = (_QWORD *)*((_QWORD *)v11 + 6), (_QWORD *)*v25 != v23) )
        __fastfail(3u);
      *v25 = v24;
      *(_QWORD *)(v24 + 8) = v25;
      *v23 = 0LL;
      ...
      *((_QWORD *)v11 + 6) = 0LL;
      v27 = *((_QWORD *)v11 + 3);
      if ( *(char **)(v27 + 8) != v11 + 24 || (v28 = (_QWORD *)*((_QWORD *)v11 + 4), (_QWORD *)*v28 != v26) )
        __fastfail(3u);
      *v28 = v27;
      *(_QWORD *)(v27 + 8) = v28;
      *v26 = 0LL;
...
LABEL_59:
  ...
  else
  {
    ...
    else
    {
      v29 = v14 + 40;
      v30 = *((_QWORD *)v14 + 5);
      if ( *(char **)(v30 + 8) != v14 + 40 || (v31 = (_QWORD *)*((_QWORD *)v14 + 6), (_QWORD *)*v31 != v29) )
        __fastfail(3u);
      *v31 = v30;
      *(_QWORD *)(v30 + 8) = v31;
      *v29 = 0LL;
      ...
      *((_QWORD *)v14 + 6) = 0LL;
      v33 = *((_QWORD *)v14 + 3);
      if ( *(char **)(v33 + 8) != v14 + 24 || (v34 = (_QWORD *)*((_QWORD *)v14 + 4), (_QWORD *)*v34 != v32) )
        __fastfail(3u);
      *v34 = v33;
      *(_QWORD *)(v33 + 8) = v34;
      *v32 = 0LL;
  ...
  *((_BYTE *)a2 + 56) = 5;
  v47 = a2[3];
  if ( *(unsigned __int64 **)(v47 + 8) != a2 + 3 || (v48 = (unsigned __int64 *)a2[4], (_QWORD *)*v48 != v46) )
    __fastfail(3u);
  *v48 = v47;
  *(_QWORD *)(v47 + 8) = v48;
