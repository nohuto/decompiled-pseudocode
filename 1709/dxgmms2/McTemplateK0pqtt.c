/*
 * XREFs of McTemplateK0pqtt @ 0x1C0021CEC
 * Callers:
...
NTSTATUS McTemplateK0pqtt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventResetBackingStore, a3, 5u, &v4);
}
