/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C009EF1C
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0020B90 (VidMmCreateCompanionContext.c)
 * Callees:
