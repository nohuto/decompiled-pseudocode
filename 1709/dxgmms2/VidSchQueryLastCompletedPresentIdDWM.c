/*
 * XREFs of VidSchQueryLastCompletedPresentIdDWM @ 0x1C0012070
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall VidSchQueryLastCompletedPresentIdDWM(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    else
    {
      ...
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v6 + 1896), &v10);
      *(_DWORD *)a3 = *(_DWORD *)(a1 + 4 * v3 + 468);
      *(_DWORD *)(a3 + 4) = *(_DWORD *)(a1 + 8 * v3 + 536);
      *(_QWORD *)(a3 + 8) = *(_QWORD *)(a1 + 8 * v3 + 664);
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&v10);
      *(_DWORD *)(a3 + 16) = *(_DWORD *)(*(_QWORD *)(v6 + 8 * v3 + 3008) + 23552LL);
      *(_QWORD *)(a3 + 24) = *(_QWORD *)(*(_QWORD *)(v6 + 8 * v3 + 3008) + 23560LL);
      *(_DWORD *)(a3 + 32) = *(_DWORD *)(*(_QWORD *)(v6 + 8 * v3 + 3008) + 140LL);
