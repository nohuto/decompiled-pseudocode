/*
 * XREFs of ?LockAllocationRange@VIDMM_APERTURE_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1EPEAEPEAPEAU_MDL@@@Z @ 0x1C00A7580
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _MDL **a7)
{
  ...
  *v11 = 0;
  ...
  if ( ((unsigned __int8)v16 & 4) != 0 )
  {
    ...
    v17 = WdLogNewEntry5_WdLowResource(v16, a2);
    *(_QWORD *)(v17 + 24) = 1542LL;
  ...
  {
    v21 = VIDMM_GLOBAL::ProbeAndLockAllocation(v16, (struct _VIDMM_LOCAL_ALLOC *)v13, a2, a3, a4, v23, this, 1u);
    if ( v21 >= 0 )
    {
LABEL_24:
      *((_QWORD *)a2 + 35) = a4;
