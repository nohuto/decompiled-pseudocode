/*
 * XREFs of McTemplateK0ppqqxx @ 0x1C0026228
 * Callers:
...
NTSTATUS McTemplateK0ppqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSelectContext, a3, 7u, &v4);
}
