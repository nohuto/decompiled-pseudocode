/*
 * XREFs of ?CreatePageDirectory@@YAPEAVVIDMM_PAGE_DIRECTORY@@PEAVCVirtualAddressAllocator@@II@Z @ 0x1C007328C
 * Callers:
        ...
        int a3)
{
  ...
  v4 = a2;
  v6 = *(_QWORD *)(*((_QWORD *)a1 + 10) + 40168LL) + 1552LL * a2;
