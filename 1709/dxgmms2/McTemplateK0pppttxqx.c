/*
 * XREFs of McTemplateK0pppttxqx @ 0x1C0023B2C
 * Callers:
...
NTSTATUS McTemplateK0pppttxqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventReportCommittedAllocation, a3, 9u, &v4);
}
