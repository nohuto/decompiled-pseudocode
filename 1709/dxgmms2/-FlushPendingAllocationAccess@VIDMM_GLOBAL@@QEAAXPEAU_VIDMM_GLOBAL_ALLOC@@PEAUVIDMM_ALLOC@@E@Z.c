/*
 * XREFs of ?FlushPendingAllocationAccess@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAUVIDMM_ALLOC@@E@Z @ 0x1C009AB9C
 * Callers:
    ...
    if ( *v5 != v5 )
    {
      do
      {
        ...
        for ( i = (_QWORD *)*(v10 - 2); i != v12; i = (_QWORD *)*i )
        {
          ...
          {
            v13 = *(i - 4);
            if ( !a4 || (v14 = *(_QWORD *)(v13 + 24)) != 0 && !*(_BYTE *)(*(_QWORD *)(v14 + 40) + 306LL) )
            {
              v11 = *(_QWORD *)(v13 + 32);
