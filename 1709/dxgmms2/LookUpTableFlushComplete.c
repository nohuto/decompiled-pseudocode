/*
 * XREFs of LookUpTableFlushComplete @ 0x1C00812E4
 * Callers:
 *     RegisteredProviderEtwCallback @ 0x1C0073560 (RegisteredProviderEtwCallback.c)
 *     TlgAggregateInternalProviderCallback @ 0x1C00735B0 (TlgAggregateInternalProviderCallback.c)
 *     FlushWorkItemRoutineKernelMode @ 0x1C00B6650 (FlushWorkItemRoutineKernelMode.c)
 *     TlgUnregisterAggregateProvider @ 0x1C00B6790 (TlgUnregisterAggregateProvider.c)
 * Callees:
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(_DWORD *a1)
{
  ...
  if ( a1[64] )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C0040090 > 5
        && (qword_1C00400A0 & 0x400000000000LL) != 0
        && (qword_1C00400A8 & 0x400000000000LL) == qword_1C00400A8 )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0040090, &unk_1C0033ED7, 0LL, v5, 0xBu, &pData);
      }
