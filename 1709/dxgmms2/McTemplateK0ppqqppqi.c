/*
 * XREFs of McTemplateK0ppqqppqi @ 0x1C0016CF8
 * Callers:
...
__int64 McTemplateK0ppqqppqi(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 9LL, v4);
}
