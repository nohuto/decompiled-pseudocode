/*
 * XREFs of VidSchiProcessPeriodicNotificationCookie @ 0x1C0028A24
 * Callers:
 ...
 *     VidSchiCalculatePeriodicTargetFrameNumber @ 0x1C0027B08 (VidSchiCalculatePeriodicTargetFrameNumber.c)
...
void __fastcall VidSchiProcessPeriodicNotificationCookie(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = *(union _SLIST_HEADER **)(a1 + 8 * v4 + 3008);
  if ( (char)Microsoft_Windows_DxgKrnlEnableBits < 0 )
    McTemplateK0qqix(a1, v4, a3, v4, v6, v7[1472].Region, v7[1472].Alignment);
  ExpInterlockedPushEntrySList(v7 + 3552, (PSLIST_ENTRY)(a2 + 16));
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(a1 + 1888), &LockHandle);
  Alignment = v7[3551].Alignment;
  if ( !Alignment
  ...
  Region = v7[1472].Region;
  v15 = VidSchiCalculatePeriodicTargetFrameNumber(v11, Region, v7[1472].Alignment, (int *)&v27);
  v27 = v15;
  v17 = *(_QWORD *)(v11 + 56);
  if ( v17 == v15 )
  {
