/*
 * XREFs of ?RemoveDmaBufferFromPool@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C0073F10
 * Callers:
  ...
  else
  {
    ...
    *((_DWORD *)this + 34) += -24 * *((_DWORD *)a2 + 13);
    if ( v8 )
    {
      ...
      ExAcquirePushLockExclusiveEx(v9 + 432, 0LL);
      *(_QWORD *)(v9 + 448) -= *((_QWORD *)a2 + 5);
      --*(_DWORD *)(v9 + 440);
      *(_DWORD *)(v9 + 456) += -24 * *((_DWORD *)a2 + 12);
      *(_DWORD *)(v9 + 460) += -24 * *((_DWORD *)a2 + 13);
      ExReleasePushLockExclusiveEx(v9 + 432, 0LL);
