/*
 * XREFs of VidSchSignalSyncObjectsFromGpu @ 0x1C0007290
 * Callers:
 ...
 * Callees:
 *     VidSchiSignalSyncObject @ 0x1C00077F0 (VidSchiSignalSyncObject.c)
...
LABEL_5:
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*((_QWORD *)*a4 + 1) + 1888LL), &LockHandle);
  v11 = 0;
  if ( !(_DWORD)v6 )
  {
LABEL_15:
  ...
  if ( v9 )
  {
    ...
    do
    {
      if ( v8 )
        ...
        v23 = *(_QWORD *)(*((_QWORD *)*a4 + 1) + 224LL);
      v50 = v23;
      KeAcquireInStackQueuedSpinLock(v21, &LockHandle);
      if ( *(_QWORD *)(v50 + 648) == v50 + 648 )
      {
        KeReleaseInStackQueuedSpinLock(&LockHandle);
      }
      else
      {
        KeReleaseInStackQueuedSpinLock(&LockHandle);
        QueuePacket = (_DWORD *)VidSchiAllocateQueuePacket(v50, *(_DWORD *)(v50 + 780) == 0);
        *(_QWORD *)v22 = QueuePacket;
        if ( !QueuePacket )
        {
          v47 = WdLogNewEntry5_WdWarning();
          *(_QWORD *)(v47 + 24) = -1073741801LL;
          *(_QWORD *)(v47 + 32) = 9442LL;
        ...
        *(_QWORD *)(*(_QWORD *)v22 + 104LL) = KeGetCurrentThread();
        *(_DWORD *)(*(_QWORD *)v22 + 72LL) = 0;
        *(_DWORD *)(*(_QWORD *)v22 + 288LL) ^= ((unsigned __int8)a5 ^ (unsigned __int8)*(_DWORD *)(*(_QWORD *)v22 + 288LL)) & 1;
        if ( (a5 & 4) != 0 )
          *(_DWORD *)(*(_QWORD *)v22 + 288LL) |= 4u;
        if ( *((_DWORD *)*a4 + 10) == 2 )
          *(_QWORD *)(*(_QWORD *)v22 + 552LL) = *a6;
        if ( (_DWORD)v6 )
        {
          v25 = a4;
          v26 = v6;
          do
          {
            *(void **)((char *)v25 + 296LL - (_QWORD)a4 + *(_QWORD *)v22) = *v25;
            if ( (unsigned int)(*((_DWORD *)*v25 + 10) - 4) <= 1 )
              *(void **)((char *)v25 + 552LL - (_QWORD)a4 + *(_QWORD *)v22) = *(void **)((char *)v25
                                                                                       + (char *)a6
                                                                                       - (char *)a4);
            ++v25;
            --v26;
        ...
        *(_DWORD *)(*(_QWORD *)v22 + 292LL) = v6;
        *(_QWORD *)(*(_QWORD *)v22 + 808LL) = 0LL;
        v27 = *(_QWORD *)v22;
        if ( v53 )
        {
          *(_QWORD *)(v27 + 816) = v53;
          *(_QWORD *)(v53 + 808) = *(_QWORD *)v22;
        }
        else
        {
          *(_QWORD *)(v27 + 816) = 0LL;
    ...
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v56 + 1888), &LockHandle);
