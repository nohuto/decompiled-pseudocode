/*
 * XREFs of ?SuspendResumeProcessGpuMmuContexts@VIDMM_PROCESS@@QEAAXI_N@Z @ 0x1C00A2130
 * Callers:
        ...
        unsigned __int8 a3)
{
        ...
        for ( i = 0; i < *(_DWORD *)(v5 + 12); ++i )
        {
          ...
          while ( v10 != v9 )
          {
            ...
            if ( v12 && !*(_QWORD *)(v11 + 176) )
              VidSchSuspendResumeDevice(*(_QWORD *)(v12 + 600), a3, 0, 1);
            v6 = *(_QWORD *)(v5 + 16);
            v10 = (_QWORD *)*v10;
            v9 = (_QWORD *)(v8 + v6 + 40);
          }
  ...
  *((_DWORD *)this + 12) = *((_DWORD *)this + 12) & 0xFFFFFFFB | (4 * a3);
}
