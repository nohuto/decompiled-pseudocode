/*
 * XREFs of ?GetPinnedAllocationInfo@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAIPEAT_LARGE_INTEGER@@@Z @ 0x1C0074190
 * Callers:
 *     VidMmGetPinnedAllocationInfo @ 0x1C0015B60 (VidMmGetPinnedAllocationInfo.c)
 * Callees:
 *     <none>
 */
