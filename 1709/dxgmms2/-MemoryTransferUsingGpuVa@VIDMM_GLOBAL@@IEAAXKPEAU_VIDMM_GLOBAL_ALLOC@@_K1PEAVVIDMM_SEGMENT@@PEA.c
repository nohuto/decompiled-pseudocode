/*
 * XREFs of ?MemoryTransferUsingGpuVa@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@PEAU_MDL@@234U_DXGK_TRANSFERFLAGS@@@Z @ 0x1C009BBB4
 * Callers:
        ...
        struct _MDL *a11)
{
  ...
  if ( a10 )
    ...
    v16 = 0LL;
  v17 = (char *)a3 + 192;
  for ( i = (char *)*((_QWORD *)a3 + 24); i != v17; i = *(char **)i )
  {
    v19 = *((_QWORD *)i + 4);
    if ( v14 <= v19 )
      break;
