/*
 * XREFs of ?TrimOfferList@VIDMM_SEGMENT@@QEAAJPEAU_LIST_ENTRY@@U_VIDMM_TRIM_PROCESS_FLAGS@@_K2@Z @ 0x1C00AC418
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  while ( v9 != a2 )
  {
    v10 = (__int64)(v9 - 50);
    v9 = (_QWORD *)*v9;
    if ( *(_WORD *)(*(_QWORD *)(v10 + 504) + 4LL) != 1 )
    {
      v11 = (_QWORD *)(v10 + 400);
      v12 = *(_QWORD *)(v10 + 400);
      if ( *(_QWORD *)(v12 + 8) != v10 + 400 || (v13 = *(_QWORD **)(v10 + 408), (_QWORD *)*v13 != v11) )
        __fastfail(3u);
      *v13 = v12;
      *(_QWORD *)(v12 + 8) = v13;
      *v11 = 0LL;
