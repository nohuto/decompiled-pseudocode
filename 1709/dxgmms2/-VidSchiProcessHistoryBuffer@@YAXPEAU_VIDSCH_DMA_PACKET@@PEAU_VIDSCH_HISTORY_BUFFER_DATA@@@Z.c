/*
 * XREFs of ?VidSchiProcessHistoryBuffer@@YAXPEAU_VIDSCH_DMA_PACKET@@PEAU_VIDSCH_HISTORY_BUFFER_DATA@@@Z @ 0x1C00252EC
 * Callers:
...
void __fastcall VidSchiProcessHistoryBuffer(struct _VIDSCH_DMA_PACKET *a1, struct _VIDSCH_HISTORY_BUFFER_DATA *a2)
{
  ...
  v2 = a1;
  if ( (qword_1C0040010 & 0x21C8ED7) != 0
    && (qword_1C0040018 & 0xFFFFFFFFFDE37128uLL) == 0
    && (qword_1C0040010 & 0x4000) != 0 )
  {
    v3 = *(_QWORD *)a2;
    v4 = *((_QWORD *)a1 + 6);
    v43 = v4;
...
LABEL_39:
    ...
    v10 = *(_QWORD *)(v7 + 8);
    v11 = *(_QWORD *)(v7 + 8LL * *(unsigned __int16 *)(v5 + 4) + 424);
    v12 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 2216LL)
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v10 + 984), &LockHandle);
    v21 = *(_QWORD *)(*(_QWORD *)(v7 + 8) + 976LL);
    if ( v21 )
    {
      v39 = 0;
      while ( 1 )
