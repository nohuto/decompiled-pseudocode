/*
 * XREFs of McTemplateK0pptqx @ 0x1C0017D2C
 * Callers:
...
__int64 McTemplateK0pptqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 6LL, v4);
}
