/*
 * XREFs of VidSchiFinishMeasuringPreemptionTime @ 0x1C000DF5C
 * Callers:
...
void __fastcall VidSchiFinishMeasuringPreemptionTime(__int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 488) )
  {
    ...
    v4 = *(_QWORD *)(v2 + 40);
    v5 = (LARGE_INTEGER)(*(_QWORD *)&KeQueryPerformanceCounter(&PerformanceFrequency) - *(_QWORD *)(a1 + 488));
...
LABEL_9:
    if ( v7 >= *(_QWORD *)(v3 + 2608) )
    {
      _InterlockedIncrement((volatile signed __int32 *)(v4 + 2656));
      if ( v7 >= *(_QWORD *)(v3 + 2592) && !*(_BYTE *)(*(_QWORD *)(v2 + 40) + 2624LL) )
      {
        v11 = *(_DWORD *)(v2 + 48);
        if ( (v11 & 8) == 0
          && (v11 & 1) == 0
          ...
          && (*(_DWORD *)(v3 + 2168) & 0x800) != 0 )
        {
          KeSetTimer((PKTIMER)(a1 + 496), (LARGE_INTEGER)-*(_QWORD *)(v3 + 2600), (PKDPC)(a1 + 560));
          VidSchiUpdateContextStatus(a1, (_QWORD *)7, (_QWORD *)0x6171);
          if ( bTracingEnabled )
          {
            v14 = *(_QWORD *)(a1 + 56);
