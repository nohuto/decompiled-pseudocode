/*
 * XREFs of McTemplateK0ppqqpt @ 0x1C0016E8C
 * Callers:
...
__int64 McTemplateK0ppqqpt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 7LL, v4);
}
