/*
 * XREFs of VidSchSetPagingNodePageDirectory @ 0x1C0016704
 * Callers:
...
void __fastcall VidSchSetPagingNodePageDirectory(_QWORD *a1, unsigned int a2, UINT a3, UINT a4, UINT64 a5)
{
  ...
  for ( i = 0; ; i = 1 )
  {
    ...
    *(_QWORD *)(v11 + 808) = v13.Address.SegmentOffset;
    VIDMM_GLOBAL::RecordVaPagingHistorySetPageDirectory(
      *(VIDMM_GLOBAL **)(a1[1] + 536LL),
      0LL,
      &v13,
      (struct _VIDSCH_CONTEXT *)v11);
    if ( i || (*(_BYTE *)(*(_QWORD *)(a1[2] + 2216LL) + 48 * v7 + 16) & 0xC) != 0xC )
      break;
  }
}
