/*
 * XREFs of VidSchiRecoverFromTDR @ 0x1C00B62F8
 * Callers:
...
void __fastcall VidSchiRecoverFromTDR(__int64 a1)
{
    ...
    && (qword_1C0040068 & 0x400000000010LL) == qword_1C0040068 )
  {
    ...
    v20 = 8LL;
    v22 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0033DE4, 0LL, (LPCGUID)8, 8u, &pData);
  }
  v5 = *(struct _TDR_RECOVERY_CONTEXT **)(a1 + 2840);
  *(_DWORD *)(a1 + 2836) = 2;
