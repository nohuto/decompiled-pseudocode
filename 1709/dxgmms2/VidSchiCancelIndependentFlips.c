/*
 * XREFs of VidSchiCancelIndependentFlips @ 0x1C001514C
 * Callers:
  ...
  if ( v8 )
  {
    ...
    if ( (_DWORD)result )
    {
      v10 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 40LL) + 24LL)
                      ...
                      + 8 * v4
                      + 520);
      _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)(a1 + 8 * v4 + 6056) + 8LL), -(int)result);
      result = *(_QWORD *)(a1 + 8 * v4 + 6056);
      *(_DWORD *)(result + 4) += v9;
      *(_DWORD *)(v10 + 4) += v9;
    }
  }
