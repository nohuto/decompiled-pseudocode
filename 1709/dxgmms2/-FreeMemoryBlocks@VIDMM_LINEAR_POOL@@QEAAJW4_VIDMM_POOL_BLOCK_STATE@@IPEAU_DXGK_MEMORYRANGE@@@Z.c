/*
 * XREFs of ?FreeMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z @ 0x1C00B2194
 * Callers:
...
__int64 __fastcall VIDMM_LINEAR_POOL::FreeMemoryBlocks(VIDMM_LINEAR_POOL *a1, char a2, __int64 a3, _QWORD *a4)
{
  ...
  do
  {
    if ( v7 == v6 )
    {
      v9 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v7, v6, a3);
      v9[3] = 275LL;
      v9[4] = 23LL;
      v9[5] = 7LL;
      v9[6] = *a4;
  ...
  if ( v8[1] != a4[1] )
  {
    v11 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v7, v6, a3);
    v11[3] = 275LL;
    v11[4] = 23LL;
    v11[5] = v8[1];
    v12 = a4[1];
