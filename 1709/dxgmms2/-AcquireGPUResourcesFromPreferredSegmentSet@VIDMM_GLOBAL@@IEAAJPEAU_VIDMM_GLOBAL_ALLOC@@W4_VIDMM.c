/*
 * XREFs of ?AcquireGPUResourcesFromPreferredSegmentSet@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@KK@Z @ 0x1C005E564
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = ((a3 - 3) & 0xFFFFFFFA) == 0
    && a3 != 8
    && ((v20 = **(_DWORD **)(a2 + 504), (v20 & 0x20000000) == 0) || v20 >= 0)
    && (v20 & 0x80000) == 0;
  if ( !*(_BYTE *)(a1 + 7096) || v8 )
    v9 = 2;
  else
    v9 = 0;
  v10 = *(_QWORD *)(a1 + 40168) + 1552LL * (*(_DWORD *)(a2 + 76) & 0x3F);
  do
  {
    v11 = 0;
    do
