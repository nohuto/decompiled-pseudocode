/*
 * XREFs of McTemplateK0pqqPR2 @ 0x1C00265B8
 * Callers:
...
NTSTATUS McTemplateK0pqqPR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v11 = v20;
  v12 = 8 * v18;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventReferenceWrittenPrimaries, a3, 5u, &v4);
}
