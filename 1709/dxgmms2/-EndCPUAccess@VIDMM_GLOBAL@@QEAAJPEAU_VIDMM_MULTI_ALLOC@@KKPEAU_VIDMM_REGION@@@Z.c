/*
 * XREFs of ?EndCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKPEAU_VIDMM_REGION@@@Z @ 0x1C006476C
 * Callers:
 *     VidMmEndCPUAccess @ 0x1C0013A60 (VidMmEndCPUAccess.c)
 * Callees:
