/*
 * XREFs of McTemplateK0pqIR1 @ 0x1C00263A8
 * Callers:
...
NTSTATUS McTemplateK0pqIR1(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 8 * v14;
  v8 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventRecordGpuWork, a3, 4u, &v4);
}
