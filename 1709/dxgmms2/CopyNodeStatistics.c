/*
 * XREFs of CopyNodeStatistics @ 0x1C00B4100
 * Callers:
 *     VidSchQueryNodeStatistics @ 0x1C00B4930 (VidSchQueryNodeStatistics.c)
 *     VidSchQueryProcessNodeStatistics @ 0x1C00B49E0 (VidSchQueryProcessNodeStatistics.c)
 * Callees:
 *     <none>
 */
