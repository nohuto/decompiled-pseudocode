/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1C006F570
 * Callers:
 ...
 *     VidSchiRunningDeviceAllowsLongRunningPackets @ 0x1C0029B38 (VidSchiRunningDeviceAllowsLongRunningPackets.c)
...
__int64 __fastcall VidSchiCheckNodeTimeout(__int64 a1, _QWORD *a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 440) & 2) != 0 || *(_DWORD *)(a1 + 1964) || *(_DWORD *)(a1 + 1968) )
  {
    if ( a2 )
      *a2 = *(_QWORD *)(a1 + 448);
    return 1LL;
