/*
 * XREFs of VidSchiReleaseSyncObjectReference @ 0x1C000B3C0
 * Callers:
...
void __fastcall VidSchiReleaseSyncObjectReference(char *P)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)P + 8, 0xFFFFFFFF) == 1 )
  {
    ...
    if ( P[27] )
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*((_QWORD *)P + 1) + 2992LL), &LockHandle);
      v3 = (char **)*((_QWORD *)P + 21);
      if ( v3[1] != P + 168 || (v4 = (PVOID *)*((_QWORD *)P + 22), *v4 != P + 168) )
        __fastfail(3u);
      *v4 = v3;
      v3[1] = (char *)v4;
      ...
      if ( *((_QWORD *)P + 15) )
      {
        ...
        v6 = *(_QWORD *)v5;
        if ( *(char **)(*(_QWORD *)v5 + 8LL) != v5 || (v7 = (char **)*((_QWORD *)P + 16), *v7 != v5) )
          __fastfail(3u);
        *v7 = (char *)v6;
        *(_QWORD *)(v6 + 8) = v7;
