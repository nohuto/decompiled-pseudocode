/*
 * XREFs of ?AttemptToGrowVPRForAllocation@VIDMM_SEGMENT@@QEAAJ_KPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00A98B4
 * Callers:
        ...
        char a5)
{
  ...
  v7 = *((_QWORD *)a3 + 2);
  v10 = a2 & ~(v5 - 1);
  if ( v10 < v7 || v10 - v7 <= *((_QWORD *)this + 48) )
    return 3221225495LL;
  ...
  v16 = (v10 - v7) & ~((v5 - 1) | *((_QWORD *)this + 50));
  result = VIDMM_LINEAR_POOL::Allocate(
             *((VIDMM_LINEAR_POOL **)this + 19),
             v7,
             v5,
             ...
             (void **)a3 + 26);
  if ( (int)result < 0
    && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 24LL) + 2216LL)
                  + 48LL * *((unsigned int *)this + 95)
                  + 16) & 4) != 0 )
  {
    v17 = *((_QWORD *)this + 19);
    v18[1] = *((_QWORD *)this + 53);
