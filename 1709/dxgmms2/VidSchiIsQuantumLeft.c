/*
 * XREFs of VidSchiIsQuantumLeft @ 0x1C000CDC4
 * Callers:
...
__int64 __fastcall VidSchiIsQuantumLeft(__int64 a1, volatile signed __int32 **a2)
{
  ...
  v6 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 428), v5, 3) == 2;
  v7 = *(_QWORD *)(a1 + 96);
  if ( v6 )
  {
    v19 = 0;
    ...
    v13 = (__int64 *)(a1 + 8);
    v14 = *(__int64 **)(a1 + 8);
    if ( v14[1] != a1 + 8 || (v15 = *(__int64 ***)(a1 + 16), *v15 != v13) )
      __fastfail(3u);
    *v15 = v14;
    v14[1] = (__int64)v15;
  ...
  else
  {
    ...
    while ( 2 )
    {
      for ( i = *v8; i != v8; i = (_QWORD *)*i )
      {
        ...
        {
          if ( _InterlockedCompareExchange(v12 + 107, (*((_DWORD *)v12 + 44) >> 1) & 1, 3) != 2 )
          {
            *a2 = v12;
            goto LABEL_7;
          }
