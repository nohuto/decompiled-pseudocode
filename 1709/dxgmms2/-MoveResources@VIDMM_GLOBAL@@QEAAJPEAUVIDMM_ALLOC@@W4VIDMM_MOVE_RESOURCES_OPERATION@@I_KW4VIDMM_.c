/*
 * XREFs of ?MoveResources@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4VIDMM_MOVE_RESOURCES_OPERATION@@I_KW4VIDMM_MOVE_RESOURCES_DEFRAG_STAGE@@22W4VIDMM_DEFRAGMENT_DIRECTION@@PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C009BDF4
 * Callers:
 ...
 *     ?MovePinnedResourcesOverRange@VIDMM_SEGMENT@@QEAAJ_K0PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00AAD60 (-MovePinnedResourcesOverRange@VIDMM_SEGMENT@@QEAAJ_K0PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
        ...
        struct _VIDMM_GLOBAL_ALLOC **a11)
{
  ...
  if ( v12 )
  {
    ...
    if ( v19 )
    {
      if ( v19 == 1 )
      {
        VidSchiSuspendFlipQueues(*(_QWORD *)(*((_QWORD *)a1 + 2) + 512LL), 0xFFFFFFFFLL);
        v21 = a7;
        result = VIDMM_SEGMENT::MovePinnedResourcesOverRange((VIDMM_SEGMENT *)v14, a7, a8, a10, a11);
        if ( (int)result < 0 )
          return result;
        VidSchiResumeFlipQueues(*(struct _VIDSCH_GLOBAL **)(*((_QWORD *)a1 + 2) + 512LL));
      }
      else
      {
