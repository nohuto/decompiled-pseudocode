/*
 * XREFs of McTemplateK0pqqpqqqxxqq @ 0x1C002671C
 * Callers:
...
NTSTATUS McTemplateK0pqqpqqqxxqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v24 = 4LL;
  v26 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndependentFlip, a3, 0xCu, &v4);
}
