/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C007F0F4
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v26;
  v5 = 10000 * v24;
  dword_1C00403A0 = 10000 * v26;
  dword_1C0040394 = 10000 * v2;
  dword_1C004039C = 10000 * v24;
  dword_1C0040398 = 10000 * v3;
  if ( 10000 * v24 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
