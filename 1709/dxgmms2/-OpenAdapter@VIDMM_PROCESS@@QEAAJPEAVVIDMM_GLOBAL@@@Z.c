/*
 * XREFs of ?OpenAdapter@VIDMM_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C005274C
 * Callers:
 *     VidMmOpenAdapter @ 0x1C0013B30 (VidMmOpenAdapter.c)
    ...
    *((_QWORD *)this[2] + v5) = v8;
    ...
    if ( bTracingEnabled )
    {
      VIDMM_GLOBAL::GetProcessBudgetBandAndVisibility(
        v9,
        this[4],
        (struct VIDMM_PROCESS_ADAPTER_INFO *)((char *)v10 + 392),
        (struct VIDMM_PROCESS_ADAPTER_INFO *)((char *)v10 + 384));
