/*
 * XREFs of ?InitializePageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@@Z @ 0x1C0055794
 * Callers:
        ...
        struct CVirtualAddressAllocator *a2)
{
  ...
  v4 = *(_QWORD *)(*((_QWORD *)a2 + 10) + 40168LL) + 1552LL * ((*(_DWORD *)this >> 7) & 0x1F);
