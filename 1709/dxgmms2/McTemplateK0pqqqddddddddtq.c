/*
 * XREFs of McTemplateK0pqqqddddddddtq @ 0x1C0026A94
 * Callers:
...
NTSTATUS McTemplateK0pqqqddddddddtq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v30 = 4LL;
  v32 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &MMIOFlipMultiPlaneOverlay3, a3, 0xFu, &v4);
}
