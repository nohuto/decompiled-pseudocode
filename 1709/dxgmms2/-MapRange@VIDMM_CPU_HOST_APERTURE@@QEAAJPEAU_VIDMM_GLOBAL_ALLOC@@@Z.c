/*
 * XREFs of ?MapRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0001330
 * Callers:
 ...
 * Callees:
 *     ?CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z @ 0x1C0001170 (-CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z.c)
...
__int64 __fastcall VIDMM_CPU_HOST_APERTURE::MapRange(VIDMM_CPU_HOST_APERTURE *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v4 = *(unsigned int *)(*((_QWORD *)this + 6) + 376LL);
  ...
  if ( (*(_DWORD *)(v17 + 80) & 0x1000) != 0 )
    ...
    v28 = *(_WORD *)(v17 + 16) + 1;
  v29 = *(_WORD *)(v17 + 380);
  v18 = DxgCoreInterface[39](*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v17 + 8) + 24LL) + 2312LL), &v27, 1LL);
  v19 = *(_QWORD *)this;
