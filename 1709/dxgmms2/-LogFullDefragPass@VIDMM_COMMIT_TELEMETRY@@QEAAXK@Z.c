/*
 * XREFs of ?LogFullDefragPass@VIDMM_COMMIT_TELEMETRY@@QEAAXK@Z @ 0x1C00AE5D8
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogFullDefragPass(VIDMM_COMMIT_TELEMETRY *this, int a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 256LL)) <= 5 )
  {
    ...
    if ( (unsigned int)hProvider > 5
      && (qword_1C0040060 & 0x200000000000LL) != 0
      && (qword_1C0040068 & 0x200000000000LL) == qword_1C0040068 )
    {
      v15 = 0;
      v13 = &v9;
      v5 = *(_QWORD *)this;
      v9 = 1;
      v14 = 4;
      v6 = *(unsigned __int16 **)(*(_QWORD *)(v5 + 24) + 1248LL);
      v18 = 0;
      v16 = v20;
      v17 = 2;
      v7 = *v6;
      ...
      v10 = a2;
      v22 = 4;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003371B, &ActivityId, v4, 6u, &pData);
    }
