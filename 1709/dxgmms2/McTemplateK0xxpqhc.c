/*
 * XREFs of McTemplateK0xxpqhc @ 0x1C0022BB4
 * Callers:
...
NTSTATUS McTemplateK0xxpqhc(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v14 = 2LL;
  v16 = 1LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 7u, &v4);
}
