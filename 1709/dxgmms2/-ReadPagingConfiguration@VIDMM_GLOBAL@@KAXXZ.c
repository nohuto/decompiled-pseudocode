/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C007EBA8
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  qword_1C00403B8 = 10000LL * v3;
  qword_1C00403C0 = 10000LL * v4;
  qword_1C00403C8 = 10000LL * v5;
  qword_1C00403D0 = 10000LL * v6;
  qword_1C00403F0 = v29;
  dword_1C00403F8 = v9;
  qword_1C00403D8 = 10000LL * v0;
  qword_1C00403E0 = (unsigned int)(10000 * v7);
  qword_1C0040418 = (unsigned __int64)v10 << 20;
  dword_1C0040348 = v11;
  dword_1C00403FC = v12;
  dword_1C0040400 = v13;
  qword_1C00403E8 = (unsigned int)(10000 * v8);
}
