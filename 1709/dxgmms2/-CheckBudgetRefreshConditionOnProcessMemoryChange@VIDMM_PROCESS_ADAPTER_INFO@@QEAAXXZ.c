/*
 * XREFs of ?CheckBudgetRefreshConditionOnProcessMemoryChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C00992F4
 * Callers:
        ...
        VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 6416LL) )
  {
    do
    {
      ...
      DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v12, (struct _KTHREAD **)this + 45);
      v5 = (_QWORD *)((char *)v4 + 184);
      v6 = 0;
      v7 = (unsigned int *)(1552LL * v2 + *(_QWORD *)(*(_QWORD *)this + 40168LL) + 488LL);
      while ( 1 )
      {
        v8 = *(v5 - 6);
        if ( v6 == 1 )
