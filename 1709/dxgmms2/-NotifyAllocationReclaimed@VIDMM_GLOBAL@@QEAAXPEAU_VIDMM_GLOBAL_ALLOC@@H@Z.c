/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C0079A28
 * Callers:
 ...
 *     ?NotifyAllocationReclaimed@@YAXPEAX@Z @ 0x1C009C290 (-NotifyAllocationReclaimed@@YAXPEAX@Z.c)
