/*
 * XREFs of ?FillAllocationInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_KIPEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@@Z @ 0x1C005D770
 * Callers:
        ...
        union _LARGE_INTEGER *a7)
{
  ...
  v8 = a2;
  if ( (*((_BYTE *)this[5021] + 1552 * a2 + 436) & 4) != 0 )
  {
