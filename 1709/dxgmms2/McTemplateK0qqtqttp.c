/*
 * XREFs of McTemplateK0qqtqttp @ 0x1C0022034
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqtqttp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventVidMmTryOperation, a3, 8u, &v11);
}
