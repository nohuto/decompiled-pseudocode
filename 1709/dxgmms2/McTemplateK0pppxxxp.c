/*
 * XREFs of McTemplateK0pppxxxp @ 0x1C0022C6C
 * Callers:
...
NTSTATUS McTemplateK0pppxxxp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventAddDmaBuffer, a3, 8u, &v4);
}
