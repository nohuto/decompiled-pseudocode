/*
 * XREFs of VidSchRestartAdapter @ 0x1C00B5030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchRestartAdapter(__int64 a1)
{
    ...
    && (qword_1C0040068 & 0x400000000010LL) == qword_1C0040068 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0033D6D, 0LL, v5, 9u, &pData);
  }
  *(_BYTE *)(a1 + 2860) &= ~4u;
  v6 = 0;
  *(_QWORD *)(a1 + 2840) = 0LL;
  *(_DWORD *)(a1 + 2836) = 0;
  *(_QWORD *)(a1 + 384) = 0LL;
  for ( *(_QWORD *)(a1 + 392) = 0LL; v6 < *(_DWORD *)(a1 + 60); *(_QWORD *)(*(_QWORD *)(a1 + 8 * v7 + 424) + 40LL) = 0LL )
    v7 = v6++;
  *(_QWORD *)(a1 + 2848) = 0LL;
