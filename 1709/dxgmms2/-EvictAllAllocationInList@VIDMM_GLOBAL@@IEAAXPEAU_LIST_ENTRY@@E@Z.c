/*
 * XREFs of ?EvictAllAllocationInList@VIDMM_GLOBAL@@IEAAXPEAU_LIST_ENTRY@@E@Z @ 0x1C005E8B8
 * Callers:
...
void __fastcall VIDMM_GLOBAL::EvictAllAllocationInList(VIDMM_GLOBAL *this, struct _LIST_ENTRY *a2, __int64 a3)
{
  ...
  for ( i = a2->Flink; i != a2; *((_QWORD *)p_Blink + 42) = 0LL )
  {
    ...
    if ( bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0p(v7, &EventEvictAllocation, a3, p_Blink);
    v8 = p_Blink + 328;
    v9 = *((_QWORD *)p_Blink + 41);
    if ( *(char **)(v9 + 8) != p_Blink + 328 || (v10 = (_QWORD *)*((_QWORD *)p_Blink + 42), (_QWORD *)*v10 != v8) )
      __fastfail(3u);
    *v10 = v9;
    *(_QWORD *)(v9 + 8) = v10;
    *v8 = 0LL;
