/*
 * XREFs of McTemplateK0pptpqxpx @ 0x1C0017068
 * Callers:
...
__int64 McTemplateK0pptpqxpx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 8LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpInitContextResource, a3, 9LL, v4);
}
