/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C009D974
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C0020E90 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
        ...
        const struct _DXGK_QUERYSEGMENTMEMORYSTATE *a2)
{
  ...
  {
    v7 = 1552LL * a2->PhysicalAdapterIndex;
