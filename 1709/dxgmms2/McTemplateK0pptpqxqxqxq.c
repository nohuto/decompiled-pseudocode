/*
 * XREFs of McTemplateK0pptpqxqxqxq @ 0x1C00174A4
 * Callers:
...
__int64 McTemplateK0pptpqxqxqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v24 = 8LL;
  v26 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpTransfer, a3, 12LL, v4);
}
