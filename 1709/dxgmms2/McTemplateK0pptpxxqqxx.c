/*
 * XREFs of McTemplateK0pptpxxqqxx @ 0x1C0017A94
 * Callers:
...
__int64 McTemplateK0pptpxxqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  _BYTE v4[16]; // [rsp+30h] [rbp-B1h] BYREF
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpVirtualFill, a3, 11LL, v4);
}
