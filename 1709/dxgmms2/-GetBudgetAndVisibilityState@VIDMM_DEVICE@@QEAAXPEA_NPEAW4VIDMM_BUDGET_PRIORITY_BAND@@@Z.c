/*
 * XREFs of ?GetBudgetAndVisibilityState@VIDMM_DEVICE@@QEAAXPEA_NPEAW4VIDMM_BUDGET_PRIORITY_BAND@@@Z @ 0x1C0098C30
 * Callers:
  ...
  *a2 = 0;
  if ( v3 )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)this + 6416LL) )
    {
      while ( 1 )
      {
        v5 = (_QWORD *)(*(_QWORD *)(v3 + 48) + 296LL * v4);
