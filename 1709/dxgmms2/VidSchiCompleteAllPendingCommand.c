/*
 * XREFs of VidSchiCompleteAllPendingCommand @ 0x1C002C5F8
 * Callers:
...
__int64 __fastcall VidSchiCompleteAllPendingCommand(__int64 a1)
{
  ...
  for ( i = 0; i < *(_DWORD *)(a1 + 60); ++i )
  {
    ...
    *(_DWORD *)(v4 + 196) = (*(_DWORD *)(v4 + 196) + 1) & (*(_DWORD *)(v4 + 192) - 1);
    ...
    v5[2] = *(LARGE_INTEGER *)(*(_QWORD *)(a1 + 8LL * i + 424) + 152LL);
    LOBYTE(v5[3].LowPart) = *(_BYTE *)(a1 + 2860) & 1;
    IsTDRPending = VidSchIsTDRPending(a1);
    BYTE2(v5[3].u.LowPart) = 0;
    BYTE1(v5[3].LowPart) = IsTDRPending;
    v7 = *(_QWORD *)(a1 + 8LL * i + 424);
    VidSchiCompletePendingCommandInNodeHwQueue(v7, *(_QWORD *)(v7 + 152), 0LL);
    *(_QWORD *)(*(_QWORD *)(a1 + 8LL * i + 424) + 64LL) = *(_QWORD *)(*(_QWORD *)(a1 + 8LL * i + 424) + 168LL);
    v8 = *(_QWORD *)(a1 + 8LL * i + 424);
    *(_QWORD *)(v8 + 72) = *(_QWORD *)(v8 + 64);
    VidSchiCompletePreemption(*(_QWORD *)(a1 + 8LL * i + 424));
  }
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 1888), &v11);
  if ( *(_DWORD *)(a1 + 40) )
  {
    do
