/*
 * XREFs of ?ReferenceSystemResource@CConnection@DirectComposition@@QEAAXVResourceHandle@@@Z @ 0x1C00332D0
 * Callers:
...
__int64 __fastcall DirectComposition::CConnection::ReferenceSystemResource(__int64 a1, int a2)
{
  ...
  if ( a2 && (v6 = *(_QWORD **)(a1 + 152), v5 < v6[17]) )
    v7 = *(DirectComposition::CResourceMarshaler **)(v5 * v6[18] + v6[14]);
  else
    v7 = 0LL;
