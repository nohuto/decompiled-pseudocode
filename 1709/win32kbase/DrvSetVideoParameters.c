/*
 * XREFs of DrvSetVideoParameters @ 0x1C00FA7B0
 * Callers:
...
LABEL_32:
  ...
  if ( a4 )
  {
    if ( a6 && (*((_DWORD *)DeviceFromName + 40) & 0x800000) == 0 )
      return 0xFFFFFFFFLL;
    v18 = PALLOCMEM2(0x2C8uLL, 1936876615LL, 0);
    v28 = v18;
    if ( !v18 )
    {
    ...
    *((_DWORD *)v20 + 24) = *((_DWORD *)v21 + 24);
    ...
    v25 = GreDeviceIoControlEx(*((PDEVICE_OBJECT *)DeviceFromName + 17), 0x230020u, v18, 0x164u, v18, 0x164u, &v27, 0);
    if ( v25 )
      v25 = -5;
    v10 = v25;
    v26 = v18;
