/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_9bcc85e78bb6b0fe9658e97887836fde___ @ 0x1C0146EB8
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(*a3 + 24);
  v6 = *a3;
  *(_QWORD *)(v5 + 12) = *(_QWORD *)(*a3 + 120);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(v6 + 128);
  return 1;
}
