/*
 * XREFs of ?Win32kNtUserCleanup@@YAHXZ @ 0x1C0075320
 * Callers:
...
__int64 __fastcall Win32kNtUserCleanup(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  tagObjLock *v17; // [rsp+30h] [rbp+8h] BYREF
