/*
 * XREFs of ?BuildAccelerationCurve@CTouchpadAcceleration@@UEAAXPEAUtagMONITOR@@@Z @ 0x1C0060EE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CTouchpadAcceleration::BuildAccelerationCurve(CTouchpadAcceleration *this, struct tagMONITOR *a2)
{
  ...
  {
    v4 = qword_1C018EC78;
    if ( !(_DWORD)qword_1C018EC78 )
    {
      v4 = *((_DWORD *)this + 24);
      LODWORD(qword_1C018EC78) = v4;
    }
    v5 = ((unsigned __int64)v4 << 16) / 0xA;
    if ( __CFSHR__(HIDWORD(qword_1C018EC78), 7) )
      v6 = *((_WORD *)a2 + 112);
    else
