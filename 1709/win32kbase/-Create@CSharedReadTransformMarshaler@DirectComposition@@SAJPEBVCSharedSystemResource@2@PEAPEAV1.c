/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C007F4B0
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C007F470 (CreateSharedReadTransformMarshaler.c)
 * Callees:
