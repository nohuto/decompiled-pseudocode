/*
 * XREFs of ?HandleConnectionRequest@ServerPorts@CoreMessagingK@@CAXPEAUServerPortInfo@2@PEAU_PORT_MESSAGE@@@Z @ 0x1C0088780
 * Callers:
        ...
        struct _PORT_MESSAGE *a2)
{
  ...
  if ( dword_1C0188C40 > 5u )
  {
    ...
    v36 = 4;
    v39 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0188C40, &unk_1C016C33D, 0LL, v12, 8u, &pData);
  }
}
