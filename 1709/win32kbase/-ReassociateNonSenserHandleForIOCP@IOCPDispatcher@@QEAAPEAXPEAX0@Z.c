/*
 * XREFs of ?ReassociateNonSenserHandleForIOCP@IOCPDispatcher@@QEAAPEAXPEAX0@Z @ 0x1C003B660
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall IOCPDispatcher::ReassociateNonSenserHandleForIOCP(IOCPDispatcher *this, void *a2, __int64 a3)
{
  ...
  v4 = 0;
  v5 = 0LL;
  return IOCPDispatcher::SetupIOCPForDispatcherHandle((__int64)this, a2, a3, 2, (__int64)&v4);
}
