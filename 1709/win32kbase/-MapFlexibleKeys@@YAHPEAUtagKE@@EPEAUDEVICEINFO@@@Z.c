/*
 * XREFs of ?MapFlexibleKeys@@YAHPEAUtagKE@@EPEAUDEVICEINFO@@@Z @ 0x1C012E988
 * Callers:
 *     ?MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z @ 0x1C012EC70 (-MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 *     ?IsKeyDownSpecified@@YAHEPEBE@Z @ 0x1C012E824 (-IsKeyDownSpecified@@YAHEPEBE@Z.c)
...
LABEL_32:
  ...
  v35[0] = 0;
  ProcessKeyboardInputWorker(v35, v4, 0LL, v7);
  if ( *((__int16 *)v5 + 1) >= 0 )
  {
