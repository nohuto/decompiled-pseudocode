/*
 * XREFs of ?SetIntegerProperty@CCompositionSkyBoxBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C0147F10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
