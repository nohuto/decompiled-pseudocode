/*
 * XREFs of McTemplateK0qqqdd @ 0x1C00E36DC
 * Callers:
 *     EtwTracePointerDeviceContactIds @ 0x1C00E0DB0 (EtwTracePointerDeviceContactIds.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0009120 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qqqdd(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWriteKM(a1, &PointerDeviceContactIds, &W32kControlGuid, 6u, &v9);
}
