/*
 * XREFs of ?CreateSystemVisualForCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIPEAVResourceHandle@@@Z @ 0x1C002F32C
 * Callers:
        ...
        struct ResourceHandle *a3)
{
  ...
  if ( v6 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 120LL))(v6, 134LL) )
    {
      v7 = Win32AllocPoolWithQuotaZInit(0x108uLL, 0x63784344u);
      v8 = v7;
      if ( v7 )
      {
        v7[6] = 0;
      ...
      if ( v8 )
      {
        ...
        if ( SystemResource < 0
          || (SystemResource = DirectComposition::CApplicationChannel::RegisterResource(
              ...
              SystemResource < 0) )
        {
          (*(void (__fastcall **)(_DWORD *, DirectComposition::CApplicationChannel *))(*(_QWORD *)v8 + 112LL))(v8, this);
          (*(void (__fastcall **)(_DWORD *, __int64))(*(_QWORD *)v8 + 104LL))(v8, 1LL);
          v8 = 0LL;
        }
        else
        {
        ...
        if ( SystemResource < 0
          || (v12 = *(_QWORD *)v8,
              v14 = 0,
              SystemResource = (*(__int64 (__fastcall **)(_DWORD *, DirectComposition::CApplicationChannel *, __int64, _QWORD, _QWORD, char *))(v12 + 240))(
                                 v8,
                                 this,
                                 v6,
                                 0LL,
        ...
        else
        {
          if ( v14 )
            DirectComposition::CApplicationChannel::PutResourceOnUpdatedList(
              this,
              (struct DirectComposition::CResourceMarshaler *)v8);
          DirectComposition::CConnection::ReferenceSystemResource(*((_QWORD *)this + 5), (unsigned int)v8[60]);
          *(_DWORD *)a3 = v8[60];
        }
      }
      else
