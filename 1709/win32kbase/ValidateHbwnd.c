/*
 * XREFs of ValidateHbwnd @ 0x1C00DBA10
 * Callers:
...
__int64 __fastcall ValidateHbwnd(unsigned __int64 a1)
{
  ...
  {
    v2 = a1 >> 16;
    v3 = (char *)qword_1C018E9B8 + (unsigned int)(v1 * dword_1C018E9C0);
    if ( ((_WORD)v2 == *((_WORD *)v3 + 13) || (_WORD)v2 == 0xFFFF || !(_WORD)v2 && PsGetCurrentProcessWow64Process(v2))
      && v3[24] == 23 )
    {
      W32GetThreadWin32Thread((__int64)KeGetCurrentThread());
      if ( *((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((v3 - (_BYTE *)qword_1C018E9B8) >> 5)) )
      {
        if ( (v3[25] & 1) == 0 )
          return *((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((v3 - (_BYTE *)qword_1C018E9B8) >> 5));
      }
    }
  }
