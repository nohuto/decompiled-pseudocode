/*
 * XREFs of ?EmitUpdateCommands@CDesktopTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C008EB10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  v4 = 0;
  if ( (*(unsigned __int8 (__fastcall **)(DirectComposition::CDesktopTargetMarshaler *))(*(_QWORD *)this + 240LL))(this)
    && (*(unsigned __int8 (__fastcall **)(DirectComposition::CDesktopTargetMarshaler *, struct DirectComposition::CBatch **))(*(_QWORD *)this + 248LL))(
         this,
         a2)
    ...
    && (*(unsigned __int8 (__fastcall **)(DirectComposition::CDesktopTargetMarshaler *, struct DirectComposition::CBatch **))(*(_QWORD *)this + 264LL))(
         ...
         a2) )
  {
    return (*(unsigned __int8 (__fastcall **)(DirectComposition::CDesktopTargetMarshaler *, struct DirectComposition::CBatch **))(*(_QWORD *)this + 288LL))(
             this,
             a2) != 0;
  }
  return v4;
