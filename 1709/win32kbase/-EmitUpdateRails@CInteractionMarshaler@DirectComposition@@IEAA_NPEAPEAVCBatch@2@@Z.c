/*
 * XREFs of ?EmitUpdateRails@CInteractionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0021F58
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x800) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 1) = 188;
      *((_DWORD *)v5 + 3) = (*((unsigned __int8 *)this + 280) >> 5) & 1;
      *((_DWORD *)v5 + 4) = (*((unsigned __int8 *)this + 280) >> 6) & 1;
