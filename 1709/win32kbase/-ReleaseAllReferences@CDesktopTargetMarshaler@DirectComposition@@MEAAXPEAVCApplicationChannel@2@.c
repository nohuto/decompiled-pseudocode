/*
 * XREFs of ?ReleaseAllReferences@CDesktopTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C008E810
 * Callers:
 *     ?ReleaseAllReferences@CSharedWriteDesktopTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C008F740 (-ReleaseAllReferences@CSharedWriteDesktopTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicatio.c)
 * Callees:
