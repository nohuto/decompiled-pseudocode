/*
 * XREFs of ?Create@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00047B8
 * Callers:
 *     CreateSharedWriteAnimationTriggerMarshaler @ 0x1C0004780 (CreateSharedWriteAnimationTriggerMarshaler.c)
 * Callees:
