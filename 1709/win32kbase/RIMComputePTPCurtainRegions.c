/*
 * XREFs of RIMComputePTPCurtainRegions @ 0x1C0105B50
 * Callers:
 *     RIMCreatePointerDeviceInfo @ 0x1C000F028 (RIMCreatePointerDeviceInfo.c)
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x1C001802C (WPP_RECORDER_SF_d.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 *     EtwTraceTouchPadCurtainSize @ 0x1C00E14A0 (EtwTraceTouchPadCurtainSize.c)
 *     RtlUnicodeStringCatString @ 0x1C0106864 (RtlUnicodeStringCatString.c)
 *     RtlUnicodeStringCopyString @ 0x1C01068D8 (RtlUnicodeStringCopyString.c)
 */
...
LABEL_35:
    a1[69] |= 1u;
    return EtwTraceTouchPadCurtainSize(a1[59], a1[60], a1[61], -__CFSHR__(a1[69], 2));
  }
  v4 = v29;
  v2 = v28;
LABEL_19:
...
LABEL_20:
  ...
  if ( v6 + v4 + v16 - v7 < v19 )
    v19 = v6 + v4 + v16 - v7;
  a1[61] = v19;
  if ( v17 == a1[36] && v18 == a1[35] && v19 == a1[37] || v7 > v4 + v6 )
    v5 = 0;
  a1[69] = v5 | a1[69] & 0xFFFFFFFD;
  return EtwTraceTouchPadCurtainSize(a1[59], a1[60], a1[61], -__CFSHR__(a1[69], 2));
}
