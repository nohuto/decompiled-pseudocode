/*
 * XREFs of ?FilterKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C0117630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FilterKeys(struct tagKE *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v4 == -95 )
  {
    ...
    else if ( gPhysModifierState == 2 && (dword_1C018F8EC & 4) != 0 && !gtmridFKActivation && gFilterKeysState != 8 )
    {
      gFilterKeysState = 1;
  ...
  v8 = (unsigned int)dword_1C018F8EC;
  if ( (dword_1C018F8EC & 1) != 0 )
  {
    if ( v5 )
    {
      if ( v4 == gLastVkDown )
      {
        ApiSetEditionKillAccessibilityTimer((unsigned int)dword_1C018F8EC, gtmridFKResponse);
        ...
        {
          gBounceVk = v4;
          gtmridFKResponse = ApiSetEditionSetAccessibilityTimer(0LL, dword_1C018F8FC, FKBounceKeyTimer);
