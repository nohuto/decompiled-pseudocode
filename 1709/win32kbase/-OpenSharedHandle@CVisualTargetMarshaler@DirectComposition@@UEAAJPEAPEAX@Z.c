/*
 * XREFs of ?OpenSharedHandle@CVisualTargetMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C0150240
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DirectComposition::CVisualTargetMarshaler::OpenSharedHandle(
