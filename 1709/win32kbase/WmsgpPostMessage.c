/*
 * XREFs of WmsgpPostMessage @ 0x1C01C4598
 * Callers:
 *     PostWinlogonMessage @ 0x1C007AFE0 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C007B050 (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C007B090 (WMsg_midl_user_allocate.c)
 *     WMsg_midl_user_free @ 0x1C013D610 (WMsg_midl_user_free.c)
 */
