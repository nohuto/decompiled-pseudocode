/*
 * XREFs of ?Connect@CConnection@DirectComposition@@QEAAJPEAX@Z @ 0x1C0033B80
 * Callers:
...
__int64 __fastcall DirectComposition::CConnection::Connect(DirectComposition::CConnection *this, void *a2)
{
  ...
  if ( v7 < 0
    || (v17 = DirectComposition::CEvent::Create(a2, v6, (struct DirectComposition::CEvent **)this + 10), v17 < 0) )
  {
