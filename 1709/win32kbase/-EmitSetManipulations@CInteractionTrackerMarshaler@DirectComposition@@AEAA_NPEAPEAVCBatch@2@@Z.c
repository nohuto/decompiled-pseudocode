/*
 * XREFs of ?EmitSetManipulations@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0145038
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v2 = 1;
  v3 = 1;
  if ( (*((_DWORD *)this + 4) & 0x800) != 0 || *((_DWORD *)this + 82) )
  {
    for ( ; *((_DWORD *)this + 83) < *((_DWORD *)this + 82); *((_DWORD *)this + 83) += v8 )
    {
      ...
      v8 = (unsigned int)(*((_DWORD *)this + 82) - *((_DWORD *)this + 83));
      if ( v8 >= ((unsigned __int64)v7 - 16) >> 3 )
        LODWORD(v8) = ((unsigned __int64)v7 - 16) >> 3;
      ...
      *((_DWORD *)v9 + 2) = *((_DWORD *)this + 6);
      ...
      {
        *v11 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 40) + 16LL * (v10 + *((_DWORD *)this + 83))) + 24LL);
        v12 = *(_QWORD *)(*((_QWORD *)this + 40) + 16LL * (v10 + *((_DWORD *)this + 83)) + 8);
        if ( v12 )
          v11[1] = *(_DWORD *)(v12 + 24);
        else
          v11[1] = 0;
  ...
  if ( *((_DWORD *)this + 83) != *((_DWORD *)this + 82) || !v3 )
    return 0;
  return v2;
}
