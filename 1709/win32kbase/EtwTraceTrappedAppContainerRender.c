/*
 * XREFs of EtwTraceTrappedAppContainerRender @ 0x1C00FD2F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EtwTraceTrappedAppContainerRender(PEPROCESS Process, PEPROCESS a2)
{
  ...
  if ( ((unsigned int)Microsoft_Windows_Win32kEnableBits & 0x40000000) != 0 )
  {
    v17 = 256LL;
    v18 = 256LL;
...
LABEL_22:
      ...
      if ( ((unsigned int)Microsoft_Windows_Win32kEnableBits & 0x40000000) != 0 )
      {
        ...
        if ( a2 )
          ...
          ProcessImageFileName = &unk_1C0163108;
        if ( v20 )
          v8 = v16;
