/*
 * XREFs of ?SetReferenceProperty@CCompositionSpotLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00017F0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  if ( a3 != 5 )
    return 3221225485LL;
  v9 = (struct DirectComposition::CResourceMarshaler **)((char *)this + 88);
  if ( this == (DirectComposition::CCompositionSpotLightMarshaler *)-88LL
    || a4
