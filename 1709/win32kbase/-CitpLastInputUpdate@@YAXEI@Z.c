/*
 * XREFs of ?CitpLastInputUpdate@@YAXEI@Z @ 0x1C0022F64
 * Callers:
 ...
 * Callees:
 *     ?OnUserActiveEvent@CIT_USER_ACTIVE_TRACKER@@QEAAXI@Z @ 0x1C0023184 (-OnUserActiveEvent@CIT_USER_ACTIVE_TRACKER@@QEAAXI@Z.c)
...
void __fastcall CitpLastInputUpdate(unsigned __int8 a1, unsigned int a2)
{
  ...
  if ( qword_1C0193750 )
  {
    if ( a2 < dword_1C0193758 )
      v2 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v4 = qword_1C0193750;
    dword_1C0193758 = v2;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)qword_1C0193750 + 212), v2);
    if ( a1 != 32 )
    ...
    if ( v5 )
    {
      ...
      if ( (unsigned int)(v2 - *(_DWORD *)(v6 + 84)) > 0x3E8 )
      {
        *(_DWORD *)(v6 + 84) = v2;
        *(_BYTE *)(v6 + 90) = 0;
        CitpStatIncrement((unsigned __int16 *)v4 + 70, 1u);
      ...
      if ( (a1 & *(_BYTE *)(v6 + 90)) == 0 )
      {
        ...
        CitpStatIncrement((unsigned __int16 *)((char *)v4 + v7), 1u);
        *(_BYTE *)(v6 + 90) |= a1;
      }
    }
  }
