/*
 * XREFs of ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x1C0003490
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 8) + 24LL) & 3) != 0 )
  {
    ...
    v13 = (struct DirectComposition::CAnimationTimeList *)*((_QWORD *)this + 8);
