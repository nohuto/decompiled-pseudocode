/*
 * XREFs of _woutput_l @ 0x1C00A79DC
 * Callers:
 ...
 *     write_multi_char @ 0x1C00A8310 (write_multi_char.c)
 *     write_string @ 0x1C00A8368 (write_string.c)
 *     _get_printf_count_output @ 0x1C00A8D80 (_get_printf_count_output.c)
