/*
 * XREFs of ?Disconnect@CConnection@DirectComposition@@QEAAXXZ @ 0x1C003393C
 * Callers:
 ...
 *     ?GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z @ 0x1C0033D54 (-GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z.c)
 ...
 *     ?TryAcquireExclusive@CCriticalSection@DirectComposition@@QEAA_NXZ @ 0x1C0080170 (-TryAcquireExclusive@CCriticalSection@DirectComposition@@QEAA_NXZ.c)
...
void __fastcall DirectComposition::CConnection::Disconnect(DirectComposition::CConnection *this)
{
  ...
  v2 = *(struct _ERESOURCE **)(*((_QWORD *)this + 19) + 32LL);
