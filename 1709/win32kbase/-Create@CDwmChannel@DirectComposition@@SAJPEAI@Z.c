/*
 * XREFs of ?Create@CDwmChannel@DirectComposition@@SAJPEAI@Z @ 0x1C009641C
 * Callers:
...
__int64 __fastcall DirectComposition::CDwmChannel::Create(unsigned int *a1)
{
  ...
  {
    v3 = (DirectComposition::CApplicationChannel *)Win32AllocPoolWithQuotaZInit(0x310uLL, 0x63644344u);
    v5 = (int *)v3;
    if ( v3 )
    {
