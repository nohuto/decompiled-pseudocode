/*
 * XREFs of ?CitpDPDataLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0154654
 * Callers:
...
void __fastcall CitpDPDataLog(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  v1 = (char *)a1 + 512;
  v3 = 0x546000u / BYTE3(qword_1C0193740);
  v4 = 8.0 / (double)BYTE2(qword_1C0193740);
  CitpDPCalcInit((struct _CIT_DP_CALC_CONTEXT *)v72, v4, (double)(((unsigned int)qword_1C0193740 >> 2) & 0xF) * 0.025);
  ...
  v21 = ((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24) - *((_DWORD *)a1 + 186);
  *((_DWORD *)a1 + 186) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  *((_QWORD *)v1 + 4) = v20;
    ...
    do
    {
      ...
      if ( (qword_1C0193740 & 1) != 0 )
      {
        if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
        {
          ...
          v130 = &v61;
          v131 = v121;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C016BB4B, 0LL, v26, 0xAu, &pData);
        }
      }
      else if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000800uLL) )
      {
        ...
        v147 = &v65;
        v148 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C016BAD3, 0LL, v30, 0xAu, &v132);
      }
      if ( hProvider > 5u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000800uLL) )
        {
          ...
          v97 = &v67;
          v96 = 4LL;
          v56 = ((unsigned int)qword_1C0193740 >> 2) & 0xF;
          v99 = &v56;
          v33 = v4;
          v98 = 4LL;
          v101 = &v68;
          v68 = dword_1C019373C / 0x3E8u;
          v66 = v33;
          v100 = 2LL;
          v103 = &v69;
          v105 = &v70;
          ...
          v113 = &v71;
          v114 = 4LL;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C016BA0E, 0LL, v32, 0xFu, &v88);
        }
      }
      ++v22;
      ++v23;
