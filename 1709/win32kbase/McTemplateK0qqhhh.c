/*
 * XREFs of McTemplateK0qqhhh @ 0x1C00E3528
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqhhh(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 2LL;
  return McGenEventWriteKM(a1, &PowerDisplayEvent, &W32kControlGuid, 6u, &v9);
}
