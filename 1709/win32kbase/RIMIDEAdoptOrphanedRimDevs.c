/*
 * XREFs of RIMIDEAdoptOrphanedRimDevs @ 0x1C009382C
 * Callers:
 ...
 *     RIMIDEIsCompatibleDevice @ 0x1C010A314 (RIMIDEIsCompatibleDevice.c)
 */
...
_QWORD *__fastcall RIMIDEAdoptOrphanedRimDevs(PVOID **Object)
{
  ...
  for ( result = &v24; v5 != &v24; result = &v24 )
  {
    ...
    v11 = (_QWORD *)(v9 + 136);
    v12 = *(_QWORD *)(v9 + 136);
    if ( *(_QWORD *)(v12 + 8) != v9 + 136 || (v13 = *(_QWORD **)(v9 + 144), (_QWORD *)*v13 != v11) )
      __fastfail(3u);
    *v13 = v12;
    *(_QWORD *)(v12 + 8) = v13;
    v14 = v10 + 69;
    *(_QWORD *)(v9 + 144) = v9 + 136;
    *v11 = v11;
    while ( *v14 )
    {
      if ( *v14 == v9 )
    ...
    if ( (*(_DWORD *)(v9 + 184) & 0x100) != 0 )
    {
      v15 = (_QWORD *)(v9 + 120);
      v16 = *(_QWORD *)(v9 + 120);
      if ( *(_QWORD *)(v16 + 8) != v9 + 120 || (v17 = *(_QWORD **)(v9 + 128), (_QWORD *)*v17 != v15) )
        __fastfail(3u);
      *v17 = v16;
      *(_QWORD *)(v16 + 8) = v17;
      *(_QWORD *)(v9 + 128) = v9 + 120;
      *v15 = v15;
      *(_DWORD *)(v9 + 184) &= ~0x100u;
    }
    if ( (*(_DWORD *)(v9 + 200) & 0x80u) != 0 )
    {
      v18 = (_QWORD *)(*(_QWORD *)(v9 + 472) + 824LL);
      v19 = *v18;
      if ( *(_QWORD **)(*v18 + 8LL) != v18 || (v20 = *(_QWORD **)(*(_QWORD *)(v9 + 472) + 832LL), (_QWORD *)*v20 != v18) )
        __fastfail(3u);
      *v20 = v19;
      *(_QWORD *)(v19 + 8) = v20;
      v18[1] = v18;
    ...
    RIMRemoveHoldingFrame((__int64)v10, v9);
    v10[13] = 0LL;
    ...
    *(_QWORD *)(v9 + 344) = Object;
    *(_QWORD *)(v9 + 40) = Object[69];
    *(_QWORD *)(v9 + 344) = Object;
    v21 = Object[96] == 0LL;
    Object[69] = (PVOID *)v9;
    if ( !v21 || *((_DWORD *)Object + 244) )
      *(_DWORD *)(v9 + 184) = *(_DWORD *)(v9 + 184) & 0xFF81FFFF | 0x20000;
    if ( (*(_DWORD *)(v9 + 200) & 0x80u) != 0 )
    {
      v22 = Object[71];
      v23 = (_QWORD *)(*(_QWORD *)(v9 + 472) + 824LL);
      if ( *v22 != Object + 70 )
        __fastfail(3u);
      *v23 = Object + 70;
      v23[1] = v22;
