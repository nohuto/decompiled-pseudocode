/*
 * XREFs of ?RemoveVisualChild@CApplicationChannel@DirectComposition@@QEAAJII@Z @ 0x1C002FE30
 * Callers:
        ...
        int a3)
{
  ...
  if ( v8 >= 0 )
  {
    if ( a3 )
    {
      ...
      if ( !v3 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 120LL))(v3, 134LL) )
        v8 = -1073741811;
    }
    if ( v8 >= 0 )
    {
