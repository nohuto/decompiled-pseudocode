/*
 * XREFs of ??_E_AUTO@?1??DrvSetDisplayConfig@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@IIPEAXEPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAU_MDEV@@PEAPEAU4@PEAKPEAW4_DXGK_DIAG_SDC_STAGE@@PEAE7PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z@UEAAPEAXI@Z @ 0x1C00F51F0
 * Callers:
 *     <none>
 * Callees:
