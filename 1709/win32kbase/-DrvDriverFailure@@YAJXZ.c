/*
 * XREFs of ?DrvDriverFailure@@YAJXZ @ 0x1C00E5164
 * Callers:
 *     ?UserInitialize@@YAJXZ @ 0x1C0007750 (-UserInitialize@@YAJXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 *     memset @ 0x1C00ABB80 (memset.c)
 *     ??4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEBU0@@Z @ 0x1C00E5040 (--4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEBU0@@Z.c)
...
__int64 DrvDriverFailure(void)
{
  ...
  _QWORD v13[36]; // [rsp+90h] [rbp-70h] BYREF
  ...
  v13[27] = gpDeviceInfoList;
  v13[28] = gpresDeviceInfoList;
  v13[29] = gpWin32kDriverObject;
  LODWORD(v13[30]) = gnRetryReadInput;
  if ( gbExitInProgress )
  {
    v0 = 1;
  }
  ...
  if ( v0 != 1 )
  {
    ...
    if ( gpDispInfo )
      tagKERNELDISPLAYINFO::operator=((__int64)&v13[31]);
