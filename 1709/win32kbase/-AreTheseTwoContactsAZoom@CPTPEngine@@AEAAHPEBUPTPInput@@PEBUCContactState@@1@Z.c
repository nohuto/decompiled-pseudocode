/*
 * XREFs of ?AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z @ 0x1C0132538
 * Callers:
        ...
        const struct CContactState *a4)
{
  ...
  v6 = *((_DWORD *)a3 + 9);
  v7 = *((_DWORD *)a3 + 10);
  v8 = *(_QWORD *)((char *)a3 + 20);
  v9 = *((_QWORD *)this + 12);
  v10 = v8 - v6;
  v11 = *((_DWORD *)a4 + 10);
  v12 = *((_DWORD *)a4 + 9);
  v13 = *(_QWORD *)((char *)a4 + 20) - v12;
  v14 = v12 - v6;
  v15 = *((unsigned int *)this + 94);
  v16 = HIDWORD(*(_QWORD *)((char *)a4 + 20)) - v11;
  v17 = v11 - v7;
  v18 = HIDWORD(v8) - v7;
