/*
 * XREFs of EtwTraceAcquiredExclusiveUserCrit @ 0x1C003C090
 * Callers:
...
__int64 __fastcall EtwTraceAcquiredExclusiveUserCrit(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 v5; // rbx
  ...
  if ( result )
  {
    ...
    if ( (*(_QWORD *)&WPP_MAIN_CB.SectorSize & 0x200000010000000LL) != 0 )
    {
        ...
        && ((unsigned int)Microsoft_Windows_Win32kEnableBits & 0x800000) != 0 )
      {
        ...
        McTemplateK0xqx(v10, (unsigned int)&AcquiredExclusiveUserCritEvent, v7, v8, 0, gullUserCritAcquireToken);
      }
    }
