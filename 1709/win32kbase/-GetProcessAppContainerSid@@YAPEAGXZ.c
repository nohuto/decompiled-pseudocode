/*
 * XREFs of ?GetProcessAppContainerSid@@YAPEAGXZ @ 0x1C008BBF8
 * Callers:
...
unsigned __int16 *__fastcall GetProcessAppContainerSid(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&UnicodeString.Length = 0LL;
  ...
  {
    v6 = (wchar_t *)Win32AllocPoolWithQuotaZInit(UnicodeString.Length + 2LL, 0x79747355u);
    v2 = (__int64)v6;
    if ( v6 )
      v3 = RtlStringCchCopyNW(
             v6,
