/*
 * XREFs of DrvDisplayConfigSetDeviceInfo @ 0x1C00F9720
 * Callers:
...
__int64 __fastcall DrvDisplayConfigSetDeviceInfo(int *a1, __int64 a2)
{
  ...
  result = ((__int64 (__fastcall *)(int *, _QWORD, int *, int *))qword_1C0190A30)(
             a1 + 2,
             (unsigned int)a1[4],
             a1 + 2,
             a1 + 4);
  if ( (int)result >= 0 )
  {
    ...
    if ( *a1 == -18 )
    {
      if ( a1[1] == 24 )
      {
        v58 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C01906A0)(0LL, a1);
        v11 = v58;
        if ( v58 >= 0 )
    ...
    switch ( v10 )
    {
      case -16:
        if ( a1[1] != 68 )
          return -1073741811LL;
        v57 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C01906A0)(0LL, a1);
        v11 = v57;
        if ( v57 < 0 )
          goto LABEL_55;
        if ( v57 != 259 )
      ...
      case -6:
        if ( a1[1] == 28 )
        {
          v56 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C01906A0)(0LL, a1);
          v11 = v56;
          if ( v56 >= 0 )
          {
            if ( !a1[6] )
...
LABEL_12:
        ...
        if ( a1[1] == 24 )
        {
          v14 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C01906A0)(0LL, a1);
          v11 = v14;
          if ( v14 >= 0 )
          {
            if ( v14 == 255 )
...
LABEL_55:
      ...
      if ( a1[1] != 24 )
        return -1073741811LL;
      v21 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C01906A0)(0LL, a1);
      v11 = v21;
      if ( v21 < 0 )
        goto LABEL_55;
LABEL_16:
      ...
      v17 = 2447;
LABEL_17:
      v18 = xxxUserSetDisplayConfig(0, 0LL, v17, v16, 0LL, 1, 0LL, 0LL, a2);
      v11 = v18;
      if ( v18 >= 0 )
        return (unsigned int)v11;
...
LABEL_56:
    ...
    v23 = ((__int64 (*)(void))qword_1C01906B8)();
    v11 = v23;
    if ( v23 < 0 )
    {
    ...
    if ( (v27 & 1) != 0 )
    {
      ...
      if ( PathsModality < 0 )
      {
        ...
        {
          if ( (int)((__int64 (*)(void))qword_1C01906C0)() < 0 )
          {
    ...
    v41 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, _QWORD))qword_1C0190678)(*(_QWORD *)v6, *v5, v40, 0LL);
    v11 = v41;
    if ( v41 >= 0 )
    {
      if ( !v28 )
        goto LABEL_37;
      v46 = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C0190640)(0x40000000LL, v28);
      v50 = v46;
      if ( v46 >= 0 )
        goto LABEL_37;
