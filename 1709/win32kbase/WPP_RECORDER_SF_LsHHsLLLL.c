/*
 * XREFs of WPP_RECORDER_SF_LsHHsLLLL @ 0x1C0129434
 * Callers:
...
__int64 WPP_RECORDER_SF_LsHHsLLLL(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( !v6 )
    v6 = "NULL";
  LOWORD(v17) = 264;
  return WppAutoLogTrace(a1, 4LL, 11LL, &WPP_ab792a5fe60e342e9a304d2fbada8869_Traceguids, v17, (__int64 *)va, 4LL, v6);
}
