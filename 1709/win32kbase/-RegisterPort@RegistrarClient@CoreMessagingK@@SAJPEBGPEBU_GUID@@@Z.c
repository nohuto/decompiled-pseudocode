/*
 * XREFs of ?RegisterPort@RegistrarClient@CoreMessagingK@@SAJPEBGPEBU_GUID@@@Z @ 0x1C0086A1C
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::RegisterPort(const unsigned __int16 *a1, const struct _GUID *a2)
{
  ...
  v4 = CoreUICallSend(
         ...
         7,
         (unsigned __int8 *)&byte_1C0161F5A,
  ...
  if ( dword_1C0188C40 > 5u )
  {
    ...
    v17 = 16;
    v20 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0188C40, &unk_1C016C241, 0LL, v8, 5u, &pData);
  }
  return v6;
}
