/*
 * XREFs of ?Init@DispBrokerClient@DispBroker@@SAJXZ @ 0x1C009A480
 * Callers:
...
__int64 DispBroker::DispBrokerClient::Init(void)
{
  ...
  PoolWithTag = (DispBroker::DispBrokerClientReference *)ExAllocatePoolWithTag(PagedPool, 0x10uLL, 0x44535042u);
  v1 = 0;
  v2 = PoolWithTag;
  if ( PoolWithTag )
  {
