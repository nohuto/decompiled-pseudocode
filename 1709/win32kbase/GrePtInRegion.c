/*
 * XREFs of GrePtInRegion @ 0x1C00851F0
 * Callers:
 *     NtGdiPtInRegion @ 0x1C00FB8A0 (NtGdiPtInRegion.c)
 * Callees:
 ...
 *     ?bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z @ 0x1C0046510 (-bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z.c)
 *     EngSetLastError @ 0x1C008AC50 (EngSetLastError.c)
 */

__int64 __fastcall GrePtInRegion(struct HOBJ__ *a1, LONG a2, LONG a3)
{
  unsigned int v5; // ebx
