/*
 * XREFs of ?CitpProcessGetProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C01551B4
 * Callers:
...
struct _CIT_PROG_DATA *__fastcall CitpProcessGetProgData(struct _CIT_PROCESS **a1)
{
  ...
  IsValid = CitpProcessInfoIsValid(a1[110]);
  v3 = 0LL;
  if ( !IsValid )
    return 0LL;
  v5 = *(_WORD *)(v2 + 26);
  if ( v5 )
  {
    ...
    if ( (unsigned int)v6 < *((_DWORD *)qword_1C0193750 + 14) )
    {
      v7 = *(_QWORD *)qword_1C0193750 + 96 * v6;
      if ( *(_WORD *)(v7 + 32) == v5 )
      {
