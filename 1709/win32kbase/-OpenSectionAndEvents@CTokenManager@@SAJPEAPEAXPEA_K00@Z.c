/*
 * XREFs of ?OpenSectionAndEvents@CTokenManager@@SAJPEAPEAXPEA_K00@Z @ 0x1C0097968
 * Callers:
...
NTSTATUS __fastcall CTokenManager::OpenSectionAndEvents(void **a1, unsigned __int64 *a2, void **a3, void **a4)
{
  ...
  *a4 = (void *)-1LL;
  if ( !v4 )
    return -1073741823;
  result = ObOpenObjectByPointer(*((PVOID *)v4 + 2), 0x40u, 0LL, 4u, MmSectionObjectType, 0, a1);
  if ( result >= 0 )
  {
    v9 = g_pTokenManager;
    *a2 = *((_QWORD *)g_pTokenManager + 4);
    result = CTokenManager::OpenEventForSynchonize(*((void **)v9 + 5), a3);
    if ( result >= 0 )
      return CTokenManager::OpenEventForSynchonize(*((void **)g_pTokenManager + 6), a4);
  }
  return result;
}
