/*
 * XREFs of ?xxxManageKeyboardModifiers@@YAXPEAUtagKL@@0@Z @ 0x1C012C810
 * Callers:
...
void __fastcall xxxManageKeyboardModifiers(struct tagKL *a1, struct tagKL *a2)
{
  ...
  if ( *((_QWORD *)gptiCurrent + 51) )
  {
    if ( a1 )
    {
      ...
      v6 = *((_QWORD *)a1 + 6);
      if ( v6 && (*(_DWORD *)(*(_QWORD *)(v6 + 32) + 80LL) & 1) != 0 && (byte_1C018F544 & 4) == 0 )
    ...
    else
    {
      do
      {
        *(_BYTE *)(v3 + *((_QWORD *)v2 + 51) + 224) &= 0xAAu;
