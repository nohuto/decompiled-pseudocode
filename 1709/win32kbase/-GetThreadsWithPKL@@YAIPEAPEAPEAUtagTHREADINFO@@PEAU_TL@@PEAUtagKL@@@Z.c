/*
 * XREFs of ?GetThreadsWithPKL@@YAIPEAPEAPEAUtagTHREADINFO@@PEAU_TL@@PEAUtagKL@@@Z @ 0x1C00728D0
 * Callers:
  ...
  if ( grpWinStaList )
  {
    do
    {
      for ( i = *(_QWORD *)(v10 + 16); i; i = *(_QWORD *)(i + 32) )
      {
        ...
        {
          v13 = j - 89;
          if ( j != (_QWORD *)712 && (!a3 || a3 == (struct tagKL *)v13[52]) )
          {
            v14 = (PVOID *)v13[50];
            if ( *v14 == gpepCSRSS || *(_QWORD *)v13[50] == PsGetCurrentProcess(v14, v8) )
            {
              if ( (_DWORD)v6 == v7 )
              {
                v7 += 128;
