/*
 * XREFs of RtlUnicodeStringCopyString @ 0x1C01068D8
 * Callers:
 *     RIMComputePTPCurtainRegions @ 0x1C0105B50 (RIMComputePTPCurtainRegions.c)
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C010693C (RtlUnicodeStringValidateDestWorker.c)
 *     RtlWideCharArrayCopyStringWorker @ 0x1C01069C0 (RtlWideCharArrayCopyStringWorker.c)
 */
