/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C009B7C8
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C013E200 (NtDCompositionDestroyConnection.c)
 * Callees:
