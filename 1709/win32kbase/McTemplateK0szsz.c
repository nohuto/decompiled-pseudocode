/*
 * XREFs of McTemplateK0szsz @ 0x1C00FD82C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0szsz(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4,
        ...
        const wchar_t *a7)
{
  ...
  v30 = v17;
  v32 = 0;
  return McGenEventWriteKM(v7, &TrappedAppContainerRenderEvent, &W32kControlGuid, 5u, &v20);
}
