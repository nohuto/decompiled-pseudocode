/*
 * XREFs of HmgShareLockCheckIgnoreStockBit @ 0x1C0051670
 * Callers:
...
__int64 __fastcall HmgShareLockCheckIgnoreStockBit(struct HOBJ__ *a1, char a2)
{
  unsigned int v3; // ebx
  __int64 v4; // rsi
  _DWORD *v5; // r14
  ...
  {
    v5 = v29;
    if ( *((_BYTE *)v29 + 14) == a2 && ((v29[6] ^ HIWORD(v3)) & 0xFFFFFF7F) == 0 )
    {
