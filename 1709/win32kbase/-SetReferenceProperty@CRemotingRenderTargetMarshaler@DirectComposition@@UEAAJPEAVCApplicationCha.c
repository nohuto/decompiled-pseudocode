/*
 * XREFs of ?SetReferenceProperty@CRemotingRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0143EC0
 * Callers:
 *     <none>
 * Callees:
