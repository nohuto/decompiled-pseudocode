/*
 * XREFs of ?CoalesceNodeWithPrevious@CTouchProcessor@@AEAA_KPEBUCPointerInputFrame@@0PEAUCPointerInfoNode@@KH@Z @ 0x1C011ABD0
 * Callers:
 ...
 * Callees:
 *     EtwTracePointerCoalesce @ 0x1C00E0D50 (EtwTracePointerCoalesce.c)
