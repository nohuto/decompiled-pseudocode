/*
 * XREFs of ?bInit@BEZIER32@@QEAAHPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C001D810
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C001D300 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?lError@HFDBASIS32@@QEAAJXZ @ 0x1C001DAB8 (-lError@HFDBASIS32@@QEAAJXZ.c)
...
__int64 __fastcall BEZIER32::bInit(BEZIER32 *this, struct _POINTFIX *a2, struct _RECTFX *a3)
{
  ...
  *(_DWORD *)this = 1;
  ...
  v8 = *(_OWORD *)&v7[1] - v3->xLeft;
  v9 = *(_OWORD *)v7 - v3->xLeft;
  v10 = _mm_srli_si128(*v7, 8).m128i_u32[0] - v3->xLeft;
  ...
  if ( ((v9 | v10 | v8 | v11 | v14 | v17 | v16 | v15) & 0xFFFFC000) != 0 )
    return 0LL;
  v18 = (BEZIER32 *)((char *)this + 4);
  *((_DWORD *)this + 1) = v9 << 10;
  *((_DWORD *)this + 2) = (v11 - v9) << 10;
  *((_DWORD *)this + 3) = 6144 * (v11 + v10 - 2 * v8);
  *((_DWORD *)this + 4) = 6144 * (v8 + v9 - 2 * v10);
