/*
 * XREFs of McTemplateK0cpppqqq @ 0x1C00E2258
 * Callers:
...
NTSTATUS __fastcall McTemplateK0cpppqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a10)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWriteKM(a1, &RetrieveInputMessage, &W32kControlGuid, 8u, &v14);
}
