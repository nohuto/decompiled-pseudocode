/*
 * XREFs of ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C0088D9C
 * Callers:
...
__int64 __fastcall CitpDPGetAppIndex(struct _CIT_PROCESS *a1)
{
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  v7 = 0;
  v8 = (PCUNICODE_STRING *)&unk_1C015A8B0;
  ...
  if ( *(_DWORD *)v8 > 6u )
  {
    ...
    {
      case 7u:
        if ( (unsigned int)dword_1C018D644 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D638;
          goto LABEL_25;
        }
        break;
      case 8u:
        if ( (unsigned int)dword_1C018D62C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D620;
          goto LABEL_25;
        }
        break;
      case 9u:
        if ( (unsigned int)dword_1C018D614 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D608;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 10 && (unsigned int)dword_1C018D5FC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D5F0;
          goto LABEL_25;
        }
  ...
  else
  {
    ...
    {
      case 6u:
        if ( (unsigned int)dword_1C018D65C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D650;
          goto LABEL_25;
        }
        break;
      case 1u:
        if ( (unsigned int)dword_1C018D014 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D008;
LABEL_25:
        ...
        break;
      case 2u:
        if ( (unsigned int)dword_1C018CFFC >= MEMORY[0xFFFFF7800000037C] )
          break;
        v10 = &off_1C018CFF0;
        goto LABEL_25;
      case 3u:
        if ( (unsigned int)dword_1C018D68C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D680;
          goto LABEL_25;
        }
        break;
      case 4u:
        if ( (unsigned int)dword_1C018D674 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018D668;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 5 && (unsigned int)dword_1C018CFE4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C018CFD8;
          goto LABEL_25;
        }
