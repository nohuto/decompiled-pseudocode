/*
 * XREFs of ?_ProcessPenPacket@PalmTelemetry@@AEAAXPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagHPD_CONTACT@@KH@Z @ 0x1C0115F30
 * Callers:
 ...
 *     ?_DiscardOldTouchPackets@PalmTelemetry@@AEAAXK@Z @ 0x1C0115EA4 (-_DiscardOldTouchPackets@PalmTelemetry@@AEAAXK@Z.c)
 */
