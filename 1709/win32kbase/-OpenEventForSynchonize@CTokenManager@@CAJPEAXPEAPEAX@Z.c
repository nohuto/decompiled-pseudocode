/*
 * XREFs of ?OpenEventForSynchonize@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C0097A1C
 * Callers:
 *     ?OpenSectionAndEvents@CTokenManager@@SAJPEAPEAXPEA_K00@Z @ 0x1C0097968 (-OpenSectionAndEvents@CTokenManager@@SAJPEAPEAXPEA_K00@Z.c)
