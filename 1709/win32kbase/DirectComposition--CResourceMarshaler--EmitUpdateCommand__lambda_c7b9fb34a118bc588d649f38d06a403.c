/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_c7b9fb34a118bc588d649f38d06a4036___ @ 0x1C0029528
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v6 + 1) = *(_DWORD *)(a1 + 24);
  v7 = *a3;
  *(_OWORD *)(v6 + 8) = *(_OWORD *)(*a3 + 120);
  *(_OWORD *)(v6 + 24) = *(_OWORD *)(v7 + 136);
  *(_OWORD *)(v6 + 40) = *(_OWORD *)(v7 + 152);
  v8 = *(_OWORD *)(v7 + 168);
  result = 1;
  *(_OWORD *)(v6 + 56) = v8;
  return result;
