/*
 * XREFs of ?hbmCreateDriverSurface@@YAPEAUHBITMAP__@@KPEAUDHSURF__@@UtagSIZE@@JKKPEAX@Z @ 0x1C008DCF4
 * Callers:
 *     EngCreateDeviceSurface @ 0x1C008DC20 (EngCreateDeviceSurface.c)
 *     EngCreateRedirectionDeviceBitmap @ 0x1C008DC80 (EngCreateRedirectionDeviceBitmap.c)
 *     EngCreateBitmap @ 0x1C008DCC0 (EngCreateBitmap.c)
 *     EngCreateDeviceBitmap @ 0x1C00FC3D0 (EngCreateDeviceBitmap.c)
 * Callees:
