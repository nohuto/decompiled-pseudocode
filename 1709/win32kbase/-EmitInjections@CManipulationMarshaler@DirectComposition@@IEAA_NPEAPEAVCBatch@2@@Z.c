/*
 * XREFs of ?EmitInjections@CManipulationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0141D60
 * Callers:
    ...
    *(_OWORD *)(v4 + 124) = v6[7];
    ...
    if ( !v7 )
    {
      do
      {
        ...
        *(_QWORD *)(*((_QWORD *)this + 12) + 8 * v8) = *(_QWORD *)(*((_QWORD *)this + 12) + 8 * v9);
        v8 = v9;
      }
      while ( (unsigned int)v9 < *((_DWORD *)this + 26) );
    }
    if ( !*((_DWORD *)this + 26) )
      return 1;
  }
