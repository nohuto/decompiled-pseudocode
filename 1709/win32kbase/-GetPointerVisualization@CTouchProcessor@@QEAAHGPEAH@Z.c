/*
 * XREFs of ?GetPointerVisualization@CTouchProcessor@@QEAAHGPEAH@Z @ 0x1C01214D0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  CInpLockGuardShared::CInpLockGuardShared((CInpLockGuardShared *)&v12, (CTouchProcessor *)((char *)this + 224));
