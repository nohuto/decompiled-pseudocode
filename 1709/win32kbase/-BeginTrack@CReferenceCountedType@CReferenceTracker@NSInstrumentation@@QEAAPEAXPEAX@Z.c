/*
 * XREFs of ?BeginTrack@CReferenceCountedType@CReferenceTracker@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C00FE258
 * Callers:
 ...
 * Callees:
 *     ?Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00FE0D8 (-Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ.c)
