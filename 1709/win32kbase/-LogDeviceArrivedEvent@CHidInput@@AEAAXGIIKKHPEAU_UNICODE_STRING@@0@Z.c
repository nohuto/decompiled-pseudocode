/*
 * XREFs of ?LogDeviceArrivedEvent@CHidInput@@AEAAXGIIKKHPEAU_UNICODE_STRING@@0@Z @ 0x1C0019478
 * Callers:
        ...
        struct _UNICODE_STRING *a9)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v29 = 2LL;
      v31[1] = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C016ABC6, 0LL, v9, 0xCu, &pData);
    }
  }
}
