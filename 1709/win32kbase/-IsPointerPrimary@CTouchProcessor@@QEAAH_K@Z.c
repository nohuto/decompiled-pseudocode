/*
 * XREFs of ?IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z @ 0x1C01222A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTouchProcessor::IsPointerPrimary(CTouchProcessor *this, __int64 a2)
{
  ...
  CInpLockGuardShared::CInpLockGuardShared((CInpLockGuardShared *)&v5, (CTouchProcessor *)((char *)this + 224));
  if ( a2 )
