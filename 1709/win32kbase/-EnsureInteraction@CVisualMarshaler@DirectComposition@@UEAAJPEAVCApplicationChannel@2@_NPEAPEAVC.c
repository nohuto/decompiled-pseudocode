/*
 * XREFs of ?EnsureInteraction@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@_NPEAPEAVCInteractionMarshaler@2@@Z @ 0x1C002B960
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CInteractionMarshaler **a4)
{
  ...
  {
    v13 = 0LL;
    v9 = DirectComposition::CApplicationChannel::CreateInternalResource(a2, 0x4Cu, &v13);
    v10 = v13;
    v4 = v9;
    if ( v9 < 0 )
      goto LABEL_9;
