/*
 * XREFs of ?SetHitTestResult@CPTPProcessor@@AEAAXPEAUCPointerInputFrame@@_N@Z @ 0x1C012B71C
 * Callers:
...
void __fastcall CPTPProcessor::SetHitTestResult(CPTPProcessor *this, struct CPointerInputFrame *a2, char a3)
{
  ...
  if ( a3 )
  {
    ...
    v17 = (CPTPProcessor *)((char *)this + 552);
LABEL_7:
  ...
  v17 = (CPTPProcessor *)((char *)this + 552);
  if ( *((_DWORD *)this + 138)
    && (CInputDest::TestWindowFlag((CPTPProcessor *)((char *)this + 552), 1152) || CInputDest::TestWindowFlag(v17, 896)) )
  {
