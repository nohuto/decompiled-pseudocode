/*
 * XREFs of McTemplateK0qqqzzzqx @ 0x1C00E3F1C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqzzzqx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v35 = v19;
  v41 = 8LL;
  return McGenEventWriteKM((__int64)v19, &InputProcessDelayEvent, &W32kControlGuid, 9u, &v22);
}
