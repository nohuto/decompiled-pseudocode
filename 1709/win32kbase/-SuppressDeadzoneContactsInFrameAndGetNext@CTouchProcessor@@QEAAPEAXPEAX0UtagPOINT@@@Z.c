/*
 * XREFs of ?SuppressDeadzoneContactsInFrameAndGetNext@CTouchProcessor@@QEAAPEAXPEAX0UtagPOINT@@@Z @ 0x1C01276B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagPOINT a4)
{
  ...
  v14 = 0LL;
  if ( v13 && v13 != (CTouchProcessor *)((char *)this + 280) )
    v14 = (char *)v13 - 8;
  if ( !v18 )
  {
    v15 = (PERESOURCE *)v17;
