/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C0138550
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PTPEngineTraceProducer::OnEngineOutput(PTPEngineTraceProducer *this, const struct PTPEngineOutput *a2)
{
  ...
  v2 = dword_1C018D230;
  if ( dword_1C018D230 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C018D230, 5uLL) )
  {
    v11 = 0;
    v14 = 0;
    v17 = 0;
    ...
    v18 = a2;
    v19 = 24;
    TlgWrite((TraceLoggingHProvider)&dword_1C018D230, &unk_1C016AE62, 0LL, v5, 6u, &pData);
    v2 = dword_1C018D230;
  }
  if ( *((_DWORD *)a2 + 5) && v2 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C018D230, 5uLL) )
  {
    v11 = 0;
    v14 = 0;
    v17 = 0;
    ...
    v13 = 4;
    v16 = 2;
    TlgWrite((TraceLoggingHProvider)&dword_1C018D230, &unk_1C016AE20, 0LL, v6, 6u, &pData);
  }
