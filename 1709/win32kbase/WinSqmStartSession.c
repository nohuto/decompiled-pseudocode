/*
 * XREFs of WinSqmStartSession @ 0x1C0096794
 * Callers:
 ...
 *     ?RegisterWinSqmProvider@@YAKXZ @ 0x1C009693C (-RegisterWinSqmProvider@@YAKXZ.c)
...
__int64 WinSqmStartSession()
{
  ...
  if ( ((__int64)WPP_MAIN_CB.DeviceObjectExtension & 2) == 0
    && (unsigned int)IsSessionDisabled(&Win32kSQMSession, 0x62004u) )
  {
    LODWORD(WPP_MAIN_CB.DeviceObjectExtension) |= 2u;
  }
  else
  {
    ...
    if ( v0 )
    {
      v2 = xmmword_1C018DEB8;
      *(_DWORD *)(v0 + 16) = 40;
      *(_OWORD *)v0 = v2;
      *(_DWORD *)(v0 + 20) = v5;
      *(GUID *)(v0 + 24) = Win32kSQMSession;
      if ( WPP_MAIN_CB.Reserved || !RegisterWinSqmProvider() )
      {
