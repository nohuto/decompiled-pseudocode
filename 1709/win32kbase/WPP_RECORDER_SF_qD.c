/*
 * XREFs of WPP_RECORDER_SF_qd @ 0x1C010F060
 * Callers:
...
__int64 WPP_RECORDER_SF_qd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, const union _LARGE_INTEGER *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 3LL, 20LL, &WPP_90e310c6b5353faf2d096768653107e7_Traceguids, v8, (__int64 *)va, 8LL, va1);
}
