/*
 * XREFs of ?UpdateHistoryWithTarget@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@PEBUCPointerInfoNode@@AEBVCInputDest@@HPEBUtagPOINT@@HHH@Z @ 0x1C01282C8
 * Callers:
        ...
        int a9)
{
  ...
  v9 = *((_DWORD *)a3 + 79);
  v10 = (CTouchProcessor *)((char *)this + 280);
  v12 = a4;
  v13 = *((_DWORD *)a3 + 100);
  v14 = (CTouchProcessor *)*((_QWORD *)a2 + 1);
  if ( v14 != (CTouchProcessor *)((char *)this + 280) )
  {
    do
    {
      if ( v9 <= 1 )
