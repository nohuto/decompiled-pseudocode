/*
 * XREFs of NtGdiGetOPMInformation @ 0x1C00A0CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_ @ 0x1C00A1BEC (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_.c)
...
__int64 __fastcall NtGdiGetOPMInformation(void *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( Information >= 0 )
    {
      ...
      if ( Information >= 0 )
        Information = SafelyCopyKernelModeDataToUserModeData__DXGKMDT_OPM_REQUESTED_INFORMATION_(a3, &unk_1C0194B10);
    }
    UserSessionSwitchLeaveCrit((__int64)v10, v9, (__int64)v12, (__int64)v13);
    if ( Information < 0 )
