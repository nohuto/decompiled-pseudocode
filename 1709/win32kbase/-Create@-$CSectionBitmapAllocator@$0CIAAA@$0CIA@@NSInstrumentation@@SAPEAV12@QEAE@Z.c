/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0CIAAA@$0CIA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x1C0090ADC
 * Callers:
...
PVOID *__fastcall NSInstrumentation::CSectionBitmapAllocator<163840,640>::Create(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 9) = 0;
    if ( NSInstrumentation::CSectionBitmapAllocator<163840,640>::Initialize(PoolWithTag, a1) )
      return v3;
