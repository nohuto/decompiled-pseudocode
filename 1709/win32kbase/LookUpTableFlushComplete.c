/*
 * XREFs of LookUpTableFlushComplete @ 0x1C01C4530
 * Callers:
 *     TlgUnregisterAggregateProvider @ 0x1C01C42D8 (TlgUnregisterAggregateProvider.c)
 *     TlgAggregateInternalProviderCallback @ 0x1C01C44A0 (TlgAggregateInternalProviderCallback.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0156290 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C01C52AC (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C0188C80 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0188C80, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0188C80, &unk_1C016C482, 0LL, v6, 0xBu, &pData);
      }
