/*
 * XREFs of ?InitializeSensor@CBaseInput@@QEAAJXZ @ 0x1C001A700
 * Callers:
...
__int64 __fastcall CBaseInput::InitializeSensor(CBaseInput *this)
{
  ...
  *((_DWORD *)this + 238) = (unsigned int)PsGetCurrentProcessId() & 0xFFFFFFFC;
  *((_DWORD *)this + 239) = (unsigned int)PsGetCurrentThreadId();
