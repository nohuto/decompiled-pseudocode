/*
 * XREFs of ?ApplyElasticDragModeDeltas@CPTPEngine@@AEAAHPEAUCContactState@@PEAUtagPOINTER_INFO@@PEAUtagPOINT@@@Z @ 0x1C013232C
 * Callers:
        ...
        struct tagPOINT *a4)
{
  ...
  v4 = *((_QWORD *)a3 + 5);
  v5 = 0;
  v7 = (unsigned __int64)(1000LL * (*((_QWORD *)a3 + 10) - *((_QWORD *)a2 + 10))) / *((_QWORD *)this + 12);
  v8 = *((_DWORD *)this + 32);
  v9 = *((_DWORD *)this + 33);
  v10 = v8 / 0xA * v7;
  if ( (int)v4 <= v9 )
