/*
 * XREFs of McTemplateK0ddxdddd @ 0x1C00E2950
 * Callers:
 *     EtwTraceTouchHWTimeStamp @ 0x1C00E1340 (EtwTraceTouchHWTimeStamp.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0009120 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0ddxdddd(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWriteKM(a1, &TouchHWTimeStamp, &W32kControlGuid, 8u, &v11);
}
