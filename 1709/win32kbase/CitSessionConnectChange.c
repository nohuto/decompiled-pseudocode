/*
 * XREFs of CitSessionConnectChange @ 0x1C009ADA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CitSessionConnectChange(char a1, char a2)
{
  ...
  v2 = qword_1C0193750;
  if ( !qword_1C0193750 || ((*((_BYTE *)qword_1C0193750 + 112) & 2) != 0) == a1 )
    return;
  v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( a1 )
    ++*((_WORD *)qword_1C0193750 + 57);
  else
  ...
  if ( !a2 )
  {
    if ( a1 )
    {
      if ( (unsigned int)dword_1C018D584 >= MEMORY[0xFFFFF7800000037C] )
        goto LABEL_10;
      v6 = &off_1C018D578;
      goto LABEL_9;
    }
    if ( (unsigned int)dword_1C018CF9C < MEMORY[0xFFFFF7800000037C] )
    {
      v6 = &off_1C018CF90;
LABEL_9:
