/*
 * XREFs of NtMITMinuserWindowCreated @ 0x1C00E6A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMITMinuserWindowCreated(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v13 = (int)UserAddBaseWindowHandle(a1);
