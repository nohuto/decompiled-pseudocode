/*
 * XREFs of NtUserInjectKeyboardInput @ 0x1C00E9120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserInjectKeyboardInput(char *Src, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r15
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  v4 = (unsigned int)a2;
  EnterLeaveCrit::EnterLeaveCrit((EnterLeaveCrit *)&v26, a2, a3, a4);
...
LABEL_21:
  ...
  v13 = (void *)Win32AllocPoolWithQuota(24 * v4, 0x6B697355u);
  v14 = (__int64)v13;
  if ( !v13 )
    ExRaiseStatus(-1073741801);
  memmove(v13, Src, 24 * v4);
  if ( *(_QWORD *)(CurrentProcessWin32Process + 864) == -1LL )
  {
    v18 = PsGetCurrentProcessWin32Process(v16, v15, v17);
    if ( (int)RIMIDECreatePseudoMouseOrKeyboardDevice(1LL, v18 + 864) < 0 )
    {
      v19 = 1359;
LABEL_15:
      v20 = 0;
  ...
  v20 = RIMIDEInjectKeyboardFromKeybdInputStruct(*(_QWORD *)(CurrentProcessWin32Process + 864), v14, (unsigned int)v4);
  if ( !v20 )
  {
    v19 = 87;
    goto LABEL_15;
