/*
 * XREFs of ?EnsureTokenQueue@CTokenManager@@IEAAJPEAUCompositionSurfaceObject@@PEAPEAUTokenQueueTableEntry@1@@Z @ 0x1C00354DC
 * Callers:
        ...
        struct CTokenManager::TokenQueueTableEntry **a3)
{
  ...
  v5 = 0;
  v8[1] = 0LL;
  inserted = RtlInsertElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 136), v8, 0x10u, &v9);
  if ( inserted )
  {
    if ( v9 )
    {
