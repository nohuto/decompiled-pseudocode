/*
 * XREFs of McTemplateK0xqxq @ 0x1C00FDA20
 * Callers:
 *     EtwPhysicalSurfCreateEvent @ 0x1C0089210 (EtwPhysicalSurfCreateEvent.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0009120 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0xqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWriteKM(a1, &PhysicalSurfCreateEvent, &W32kControlGuid, 5u, &v4);
}
