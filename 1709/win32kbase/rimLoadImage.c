/*
 * XREFs of rimLoadImage @ 0x1C008D19C
 * Callers:
 ...
 *     _strnicmp @ 0x1C00A7554 (_strnicmp.c)
      ...
      if ( v6 != -1073741820 )
      {
        if ( v6 >= 0 )
        {
          ...
          if ( *v8 )
          {
            ...
            v11 = *(void **)&v8[74 * v9 + 6];
            qword_1C0190D40 = (__int64)RtlImageDirectoryEntryToData(*(PVOID *)&v8[74 * v10 + 6], 1u, 0, &Size);
            AddressOfEntryPoint = RtlImageNtHeader(v11)->OptionalHeader.AddressOfEntryPoint;
            qword_1C0190D30 = 0LL;
            qword_1C0190D38 = (__int64)v11 + AddressOfEntryPoint;
            v1 = 1;
            qword_1C0190D28 = (__int64)v11;
          }
        }
LABEL_21:
