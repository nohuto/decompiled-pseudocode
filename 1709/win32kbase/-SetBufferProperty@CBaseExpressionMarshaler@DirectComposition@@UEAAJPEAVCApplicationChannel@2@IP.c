/*
 * XREFs of ?SetBufferProperty@CBaseExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C002B2D0
 * Callers:
 *     ?SetBufferProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C0027E10 (-SetBufferProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2.c)
 ...
 *     ?SetBufferProperty@CNaturalAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C0147230 (-SetBufferProperty@CNaturalAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@.c)
 * Callees:
        ...
        bool *a6)
{
  ...
  if ( a3 != 5 )
  {
    ...
    if ( !*((_QWORD *)this + 14) && a5 <= 0x7D0 )
    {
      ...
      *((_QWORD *)this + 14) = v10;
      ...
      {
        v15[0] = 0LL;
        if ( (int)StringCbLengthW(a4, a5, v15) >= 0
          && v15[0] + 2 == a5
        ...
        Win32FreePool(*((_QWORD *)this + 14), v11, v12);
        *((_QWORD *)this + 14) = 0LL;
        return (unsigned int)-1073741811;
      }
  ...
  if ( a5 == 16 )
  {
    if ( *(_DWORD *)a4 != 2 )
      return (unsigned int)-1073741811;
    v14 = (_OWORD *)Win32AllocPoolWithQuota(16LL, 0x6D654344u);
    if ( v14 )
    {
      *((_QWORD *)this + 9) = v14;
      *v14 = *(_OWORD *)a4;
