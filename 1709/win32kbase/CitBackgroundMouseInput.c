/*
 * XREFs of CitBackgroundMouseInput @ 0x1C0018248
 * Callers:
...
void __fastcall CitBackgroundMouseInput(struct tagPROCESSINFO *a1)
{
  ...
  if ( qword_1C0193750 )
  {
    if ( *((struct tagPROCESSINFO **)qword_1C0193750 + 15) != a1 )
    {
      ...
      if ( v3 )
      {
        ...
        if ( (unsigned int)(v4 - *((_DWORD *)v3 + 19)) > 0x3E8 )
        {
          *((_DWORD *)v3 + 19) = v4;
          ...
          v5 = CitpInteractionSummaryEnsure(v1, v3);
          if ( v5 )
            CitpStatIncrement((unsigned __int16 *)v5 + 43, 1u);
        }
      }
    }
  }
