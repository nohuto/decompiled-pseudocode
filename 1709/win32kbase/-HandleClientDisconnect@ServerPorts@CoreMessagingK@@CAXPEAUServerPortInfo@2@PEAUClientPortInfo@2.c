/*
 * XREFs of ?HandleClientDisconnect@ServerPorts@CoreMessagingK@@CAXPEAUServerPortInfo@2@PEAUClientPortInfo@2@@Z @ 0x1C0088970
 * Callers:
        ...
        struct CoreMessagingK::ClientPortInfo *a2)
{
  ...
  if ( dword_1C0188C40 > 5u )
  {
    ...
    v18 = 4;
    v17 = (char *)a2 + 12;
    TlgWrite((TraceLoggingHProvider)&dword_1C0188C40, &unk_1C016C2EB, 0LL, v8, 6u, &pData);
  }
