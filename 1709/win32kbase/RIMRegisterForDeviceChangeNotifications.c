/*
 * XREFs of RIMRegisterForDeviceChangeNotifications @ 0x1C000BE84
 * Callers:
        ...
        PVOID *a5)
{
  ...
  if ( v5 )
  {
    ...
    if ( v7 < 0 )
    {
      ...
      WPP_RECORDER_SF_DSd(WPP_GLOBAL_Control->DeviceExtension, v10, v11, v12, v13, v7, *(_QWORD *)(a1 + 216), v9);
    }
  }
