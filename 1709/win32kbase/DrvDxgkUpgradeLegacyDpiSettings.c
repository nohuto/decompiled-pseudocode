/*
 * XREFs of DrvDxgkUpgradeLegacyDpiSettings @ 0x1C00F9DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DrvDxgkUpgradeLegacyDpiSettings(__int64 a1, _DWORD *a2)
{
  ...
  _QWORD *v22; // rax
  __int64 v23; // rcx
  PDEV *v24; // [rsp+30h] [rbp-D0h] BYREF
  ...
  *a2 = 0;
  ...
  if ( gppdevList )
  {
    while ( 1 )
    {
      ...
      v10 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, _DWORD *))qword_1C0190A90)(
              a1,
              *(_QWORD *)(v9 + 256),
              *(unsigned int *)(v9 + 272),
              v27);
      ...
      if ( v10 < 0 )
        break;
      v25[0] = *(__m128i *)((char *)v7 + 2472);
      v25[1] = *(__m128i *)((char *)v7 + 2488);
      v25[2] = *(__m128i *)((char *)v7 + 2504);
      v25[3] = *(__m128i *)((char *)v7 + 2520);
      v25[4] = *(__m128i *)((char *)v7 + 2536);
      v26 = *(_OWORD *)((char *)v7 + 2552);
      if ( v27[2] != _mm_srli_si128(*v25, 8).m128i_i32[1] )
      {
        ...
        while ( (__int64)v14 < (__int64)&dword_1C016C864 );
        ...
        while ( (__int64)v15 < (__int64)&dword_1C016C864 );
        v17 = v13 - v16;
        v18 = v17;
        if ( (int)v26 > v17 )
          v18 = v26;
        ...
        v19 = *(_DWORD *)(*((_QWORD *)v7 + 324) + 272LL);
        v20 = PDEVOBJ::pAdapterLuid((PDEVOBJ *)&v24);
        v21 = ((__int64 (__fastcall *)(struct _LUID *, _QWORD, _QWORD, __m128i *))qword_1C0190A70)(
                v20,
                v19,
                (unsigned int)v17,
                v25);
...
LABEL_26:
    ...
    v22[3] = v4;
    v22[4] = *(_QWORD *)(*((_QWORD *)v7 + 324) + 256LL);
    v22[5] = *(unsigned int *)(*((_QWORD *)v7 + 324) + 272LL);
