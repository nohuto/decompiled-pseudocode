/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C0153CA8
 * Callers:
        ...
        struct CToken **a7)
{
  ...
  *a5 = 0;
  if ( *v12 != this || (v13 = (CTokenQueue ***)v12[1], *v13 != v12) )
    __fastfail(3u);
  *((_QWORD *)this + 1) = v13;
  *v13 = (CTokenQueue **)this;
  ...
  {
    v14 = v12 - 1;
    if ( (*((int (__fastcall **)(CTokenQueue **, __int64, unsigned int **))*(v12 - 1) + 21))(v12 - 1, a2, &a6) < 0 )
    {
LABEL_10:
...
LABEL_11:
    v12 = (CTokenQueue **)*((_QWORD *)this + 1);
    if ( *v12 != this || (v17 = (CTokenQueue ***)v12[1], *v17 != v12) )
      __fastfail(3u);
    *((_QWORD *)this + 1) = v17;
    ...
    *(_QWORD *)(v21 + 8) = v29;
    if ( v19 != v29 )
    {
      ...
      do
      {
        ...
        {
          *((_DWORD *)a3 + 7) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v23 + 112LL))(v23);
          v20 = 1;
          v25 = CFlipToken::FromToken(v23);
          EtwTraceCompositionSurfaceObjectUpdateEvent((__int64)v24, *((_DWORD *)v25 + 23), v26);
          *v22 = v23;
        }
        v19 = (_QWORD *)v29[0];
        if ( *(_QWORD **)(v29[0] + 8LL) != v29
