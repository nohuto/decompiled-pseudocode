/*
 * XREFs of ?DrvSetDisconnectedGraphicsDevice@@YAHH@Z @ 0x1C0059068
 * Callers:
...
__int64 __fastcall DrvSetDisconnectedGraphicsDevice(int a1)
{
  ...
  v4 = (char *)PALLOCMEM2(0x148uLL, 1986291527LL, 1);
  if ( !v4 )
    return v1;
  ...
  *((_WORD *)v4 + 12) = v5;
  *((_WORD *)v4 + 124) = -1;
  RegistryHandleFromDeviceMap = DrvGetRegistryHandleFromDeviceMap((unsigned __int16 *)v4, 0, 0LL, 0LL, 0, &v11, 0xFFFFu);
  v7 = v11;
