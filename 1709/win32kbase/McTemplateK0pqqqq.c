/*
 * XREFs of McTemplateK0pqqqq @ 0x1C00E3010
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1C007D5B0 (EtwDirtyRectUpdate.c)
 *     EtwTraceTimerProc @ 0x1C007E1B0 (EtwTraceTimerProc.c)
 *     EtwTraceInternalSetTimer @ 0x1C007FA70 (EtwTraceInternalSetTimer.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C00FD0E0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C00FD120 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C00FD490 (EtwTranslationUpdate.c)
 * Callees:
...
NTSTATUS McTemplateK0pqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 4LL;
  return McGenEventWriteKM(a1, a2, &W32kControlGuid, 6u, &v4);
}
