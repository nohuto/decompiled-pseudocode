/*
 * XREFs of ?ReleaseAllReferences@CDropShadowMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0001260
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::CDropShadowMarshaler::ReleaseAllReferences(
