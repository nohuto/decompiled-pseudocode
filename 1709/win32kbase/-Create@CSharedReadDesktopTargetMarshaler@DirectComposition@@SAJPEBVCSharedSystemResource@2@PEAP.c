/*
 * XREFs of ?Create@CSharedReadDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0150B88
 * Callers:
 *     CreateSharedReadDesktopTargetMarshaler @ 0x1C0150C40 (CreateSharedReadDesktopTargetMarshaler.c)
 * Callees:
