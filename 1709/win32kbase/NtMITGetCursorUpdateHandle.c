/*
 * XREFs of NtMITGetCursorUpdateHandle @ 0x1C009AEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMITGetCursorUpdateHandle(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v12 = (unsigned int)PsGetCurrentThreadId() == *(_DWORD *)(v11 + 40);
  ...
  else
  {
    ...
    CursorUpdateHandle = -1LL;
    if ( qword_1C0188018 )
      CursorUpdateHandle = (__int64)CMouseSensor::GetCursorUpdateHandle(qword_1C0188018);
  }
  UserSessionSwitchLeaveCrit((__int64)v18, v15, v16, v17);
