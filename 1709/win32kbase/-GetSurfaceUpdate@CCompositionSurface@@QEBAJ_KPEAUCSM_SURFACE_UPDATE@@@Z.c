/*
 * XREFs of ?GetSurfaceUpdate@CCompositionSurface@@QEBAJ_KPEAUCSM_SURFACE_UPDATE@@@Z @ 0x1C0039254
 * Callers:
        ...
        struct CSM_SURFACE_UPDATE *a3)
{
  ...
  if ( *((_QWORD *)this + 7) != a2 || !a2 )
  {
    ...
    if ( RenderingBuffer )
    {
      if ( *((int *)this + 9) > 0 )
      {
        v6 = (*(__int64 (__fastcall **)(struct CCompositionBuffer *, __int64 *))(*(_QWORD *)RenderingBuffer + 208LL))(
               RenderingBuffer,
               &v11);
        if ( v6 >= 0 )
        {
          ...
          *((_DWORD *)a3 + 48) = (*(__int64 (__fastcall **)(struct CCompositionBuffer *))(*(_QWORD *)v8 + 168LL))(v8);
        }
      }
    }
  }
