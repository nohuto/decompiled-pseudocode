/*
 * XREFs of rimDispatchAutoRepeatCompleteFrame @ 0x1C010B940
 * Callers:
 ...
 *     RIMFixUpAutoRepeatCompleteFrameTimeStamps @ 0x1C010D344 (RIMFixUpAutoRepeatCompleteFrameTimeStamps.c)
 */

void __fastcall rimDispatchAutoRepeatCompleteFrame(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int *v5; // rdi
  ...
  if ( *(_BYTE *)(a1 + 712) )
  {
    ...
    {
      rimProcessAnyQueuedCompleteFrames(a1, (__int64 **)a2, a3);
    }
  }
}
