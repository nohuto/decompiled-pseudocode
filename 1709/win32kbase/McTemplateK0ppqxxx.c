/*
 * XREFs of McTemplateK0ppqxxx @ 0x1C00E2DBC
 * Callers:
 ...
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C0058480 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0009120 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0ppqxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(a1, &TokenCompositionSurfaceObjectEvent, &W32kControlGuid, 7u, &v4);
}
