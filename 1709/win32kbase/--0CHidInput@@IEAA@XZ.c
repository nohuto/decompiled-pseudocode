/*
 * XREFs of ??0CHidInput@@IEAA@XZ @ 0x1C0019714
 * Callers:
...
CHidInput *__fastcall CHidInput::CHidInput(CHidInput *this)
{
  ...
  *(_QWORD *)this = &CHidInput::`vftable';
  ...
  v2 = imp_WppRecorderLogCreate(WPP_GLOBAL_Control, v5, (char *)this + 912);
  if ( v2 < 0 )
  {
    v4 = v2;
    WPP_RECORDER_SF_d(gBaseLog, 2u, 3u, 0xAu, (__int64)&WPP_8b16f5b88e933a800b65a74dea699925_Traceguids, v4);
    *((_QWORD *)this + 114) = gBaseLog;
  }
  return this;
}
