/*
 * XREFs of McTemplateK0pqqqqqq @ 0x1C00FD604
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C007D760 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C008B370 (EtwDevLockEndTightUpdate.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0009120 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00A7160 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(a1, a2, &W32kControlGuid, 8u, &v4);
}
