/*
 * XREFs of ?DrvGetDevModeForLddmPath@@YAJPEAUtagGRAPHICS_DEVICE@@KPEAU_devicemodeW@@PEA_N@Z @ 0x1C0064028
 * Callers:
...
__int64 __fastcall DrvGetDevModeForLddmPath(struct tagGRAPHICS_DEVICE *a1, int a2, struct _devicemodeW *a3, bool *a4)
{
  ...
  bool v11; // bp
  _DWORD *v12; // rsi
  _BYTE v14[16]; // [rsp+20h] [rbp-1E8h] BYREF
  _BYTE v15[384]; // [rsp+30h] [rbp-1D8h] BYREF
  unsigned int v16; // [rsp+1B0h] [rbp-58h]
  __int64 v17; // [rsp+1B8h] [rbp-50h]
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v16 )
    {
      ...
      while ( 1 )
      {
        v12 = (_DWORD *)(v17 + 192 * v10);
        if ( *((_DWORD *)a1 + 68) == v12[6] && *((_DWORD *)a1 + 66) == v12[4] && *((_DWORD *)a1 + 67) == v12[5] )
          break;
      ...
      v9 = 0;
      if ( !a3
        || (v9 = ((__int64 (__fastcall *)(__int64, struct _devicemodeW *))qword_1C0190BC8)(v17 + 192 * v10, a3), v9 >= 0) )
      {
        if ( a4 )
        {
