/*
 * XREFs of ?AddPropertyUpdate@CPropertyBagMarshaler@DirectComposition@@AEAAJPEBUPropertyUpdate@@@Z @ 0x1C002A86C
 * Callers:
        ...
        const struct PropertyUpdate *a2)
{
  ...
  {
    v7 = 0LL;
    while ( *(_DWORD *)(v7 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8)) != *(_DWORD *)a2 )
    {
      v7 = ++v5;
      if ( v5 >= v4 )
        goto LABEL_5;
...
LABEL_5:
          ...
          v2 >= 0) )
    {
      v8 = *((_QWORD *)this + 13);
      *((_QWORD *)this + 13) = v8 + 1;
      memmove((void *)(*((_QWORD *)this + 8) + v8 * *((_QWORD *)this + 12)), a2, *((_QWORD *)this + 12));
    }
  }
