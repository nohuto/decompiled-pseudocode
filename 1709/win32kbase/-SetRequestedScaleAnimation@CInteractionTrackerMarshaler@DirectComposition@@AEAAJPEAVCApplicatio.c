/*
 * XREFs of ?SetRequestedScaleAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAAJPEAVCApplicationChannel@2@PEAVCBaseExpressionMarshaler@2@PEA_N@Z @ 0x1C01466FC
 * Callers:
        ...
        bool *a4)
{
  ...
  else
  {
    ...
    v11 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 24);
    if ( v11 )
