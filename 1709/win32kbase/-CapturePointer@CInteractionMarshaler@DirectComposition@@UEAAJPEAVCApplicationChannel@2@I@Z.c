/*
 * XREFs of ?CapturePointer@CInteractionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I@Z @ 0x1C01439D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  v3 = (char *)this + 232;
  result = CDynamicArray<unsigned int,2003858261>::Grow((char *)this + 232, a2);
  if ( (int)result >= 0 )
  {
