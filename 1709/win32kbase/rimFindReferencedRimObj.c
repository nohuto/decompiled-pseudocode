/*
 * XREFs of rimFindReferencedRimObj @ 0x1C00FF854
 * Callers:
...
__int64 __fastcall rimFindReferencedRimObj(int a1, __int16 a2, unsigned __int16 a3, struct _LIST_ENTRY **a4)
{
  ...
  if ( gObRimList.Flink != &gObRimList )
  {
    ...
    {
      v9 = Flink - 1;
      if ( !LOBYTE(Flink[3].Blink) && !BYTE1(v9[4].Blink) )
      {
        Blink_high = HIDWORD(v9[4].Blink);
        if ( (Blink_high & a1) != 0 && !HIDWORD(v9[61].Flink) )
        {
  ...
  if ( gObRimList.Flink != &gObRimList )
  {
    ...
    {
      v9 = v12 - 1;
      if ( !LOBYTE(v12[3].Blink) && !BYTE1(v9[4].Blink) && (HIDWORD(v9[4].Blink) & a1) != 0 && !HIDWORD(v9[61].Flink) )
      {
  ...
  {
    v9 = v14 - 1;
    if ( !LOBYTE(v14[3].Blink) && !BYTE1(v9[4].Blink) && (HIDWORD(v9[4].Blink) & 0x20) != 0 && LODWORD(v9[61].Flink) )
      break;
    v14 = v14->Flink;
    v9 = 0LL;
  }
