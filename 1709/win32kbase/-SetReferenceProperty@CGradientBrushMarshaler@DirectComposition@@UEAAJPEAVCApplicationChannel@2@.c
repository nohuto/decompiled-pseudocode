/*
 * XREFs of ?SetReferenceProperty@CGradientBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0002820
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  if ( this == (DirectComposition::CGradientBrushMarshaler *)-48LL
    || a4
