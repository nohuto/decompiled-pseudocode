/*
 * XREFs of ??1DwmHitTestLeaveEnterCrit@@QEAA@XZ @ 0x1C00DB7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  tagObjLock *v12; // [rsp+38h] [rbp+10h] BYREF
  ...
  CLockDomainExclusive<DLT_THREADLOCK>::CLockDomainExclusive<DLT_THREADLOCK>((__int64 *)&v12);
