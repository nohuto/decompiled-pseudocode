/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C00971D0
 * Callers:
 *     <none>
 * Callees:
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C0097394 (-NlsSetKeyStateToggle@@YAXE@Z.c)
...
void NlsKbdInitializePerSystem()
{
  ...
  if ( gKeyboardInfo == 7 && byte_1C018DFF9 == 3 )
