/*
 * XREFs of ?IsPointerWindowFrameMessage@CTouchProcessor@@QEAAH_KPEAUHWND__@@PEBUtagMSG@@H@Z @ 0x1C01222F0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a5)
{
  ...
  v9 = *((_DWORD *)a4 + 2);
  v14 = ((unsigned int)(v9 - 577) <= 3 || (unsigned int)(v9 - 581) <= 0x12 && v9 != 589)
     && v9 != 595
