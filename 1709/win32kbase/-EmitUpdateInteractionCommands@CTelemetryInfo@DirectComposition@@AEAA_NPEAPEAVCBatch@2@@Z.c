/*
 * XREFs of ?EmitUpdateInteractionCommands@CTelemetryInfo@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00746B8
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  while ( 1 )
  {
    ...
    v6 = *(_OWORD **)v3;
    if ( *(char **)(*(_QWORD *)v3 + 8LL) != v3 || (v7 = *(_QWORD *)v6, *(_OWORD **)(*(_QWORD *)v6 + 8LL) != v6) )
      __fastfail(3u);
    *(_QWORD *)v3 = v7;
    *(_QWORD *)(v7 + 8) = v3;
    v8 = (char *)v9;
