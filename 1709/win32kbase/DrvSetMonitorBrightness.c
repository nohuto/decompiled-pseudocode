/*
 * XREFs of DrvSetMonitorBrightness @ 0x1C007876C
 * Callers:
      ...
      if ( *(_DWORD *)(v14 + 224) )
      {
        do
        {
          ...
          if ( (*(_DWORD *)(v15 + 20LL * v13) & 1) != 0
            ...
            && (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, _DWORD *))qword_1C01907F8)(
                      v15 + 4 * (5LL * v13 + 2),
                      ...
                      &v26[1]) >= 0 )
          {
            ...
            GreDeviceIoControlEx(AttachedDeviceReference, 0x232433u, &InputBuffer, 4u, 0LL, 0, (__int64)v26, 1u);
              ...
              if ( *(_QWORD *)(v14 + 144) )
              {
                if ( (*(_DWORD *)(v14 + 160) & 0x800000) != 0 )
                {
                  ...
                  if ( a1 )
                  {
                    ...
                    {
                      LOBYTE(v19) = a4;
                      ((void (__fastcall *)(__int64, __int64))qword_1C0190868)(a1, v19);
                    }
                  }
                }
              }
