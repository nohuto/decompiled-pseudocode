/*
 * XREFs of ?EmitUpdateTouchConfiguration@CInteractionConfigurationGroup@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0022AA0
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  while ( (*((_DWORD *)this + 3) & 4) != 0 || *((_DWORD *)this + 8) < *((_DWORD *)this + 6) )
  {
    ...
    v6 = (unsigned int)(*((_DWORD *)this + 6) - *((_DWORD *)this + 8));
    v7 = (v5 - 24) / 0xC;
    if ( v6 >= v7 )
      LODWORD(v6) = v7;
