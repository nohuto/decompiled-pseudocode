/*
 * XREFs of ?GetPointerBarrelVisualization@CTouchProcessor@@QEAAHG@Z @ 0x1C011F4C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTouchProcessor::GetPointerBarrelVisualization(CTouchProcessor *this, unsigned __int16 a2)
{
  ...
  CInpLockGuardShared::CInpLockGuardShared((CInpLockGuardShared *)&v10, (CTouchProcessor *)((char *)this + 224));
