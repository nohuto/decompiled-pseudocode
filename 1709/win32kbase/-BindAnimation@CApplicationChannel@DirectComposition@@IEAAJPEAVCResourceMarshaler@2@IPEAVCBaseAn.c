/*
 * XREFs of ?BindAnimation@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@@Z @ 0x1C002FBB8
 * Callers:
 ...
 *     ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x1C0003490 (-GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z.c)
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 120LL))(v12, 2LL) )
  {
    ...
    if ( v4 && *(_DWORD *)(v4 + 156) )
    {
      ...
      if ( v29
        ...
        && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v21 + 120LL))(v21, 113LL) )
      {
        v23 = v20[10];
      }
      else
      {
        (*(void (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, int *))(*(_QWORD *)a2 + 200LL))(
          a2,
          a3,
          &v23);
      }
