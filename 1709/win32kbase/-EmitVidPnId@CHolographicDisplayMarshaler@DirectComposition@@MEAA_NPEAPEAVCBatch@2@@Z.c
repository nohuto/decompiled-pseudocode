/*
 * XREFs of ?EmitVidPnId@CHolographicDisplayMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C014CED0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CHolographicDisplayMarshaler::EmitVidPnId(
