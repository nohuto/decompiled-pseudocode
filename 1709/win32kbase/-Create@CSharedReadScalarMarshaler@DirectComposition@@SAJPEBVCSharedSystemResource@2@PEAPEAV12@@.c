/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01507E0
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01509E0 (CreateSharedReadScalarMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadScalarMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(_DWORD *, const struct DirectComposition::CSharedSystemResource *))(*((_QWORD *)v5 + 2) + 240LL))(
           v5 + 4,
           a1);
    if ( v6 < 0 )
    {
