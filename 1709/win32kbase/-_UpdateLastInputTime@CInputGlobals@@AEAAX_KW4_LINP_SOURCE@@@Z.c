/*
 * XREFs of ?_UpdateLastInputTime@CInputGlobals@@AEAAX_KW4_LINP_SOURCE@@@Z @ 0x1C001139C
 * Callers:
...
char __fastcall CInputGlobals::_UpdateLastInputTime(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_QWORD *)(a1 + 16) = a2;
  ...
  {
    LOBYTE(v4) = byte_1C0188DA8 - 1;
    if ( (unsigned __int8)(byte_1C0188DA8 - 1) > 2u && (qword_1C0188D90 & 0x2000000000008000LL) != 0 )
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C0188D98 & 0x2000000000008000LL) == qword_1C0188D98 && giPowerOffTimeOutMs > 0 )
      {
