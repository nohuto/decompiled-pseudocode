/*
 * XREFs of ?OnEvent@PTPEngineTraceProducer@@UEAAJPEAUPTPEngineEvent@@@Z @ 0x1C0138710
 * Callers:
...
__int64 __fastcall PTPEngineTraceProducer::OnEvent(PTPEngineTraceProducer *this, struct PTPEngineEvent *a2)
{
  ...
  if ( dword_1C018D230 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C018D230, 3uLL) )
  {
    ...
    v14 = a2;
    v15 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C018D230, &unk_1C016AEDA, 0LL, v4, 6u, &pData);
  }
