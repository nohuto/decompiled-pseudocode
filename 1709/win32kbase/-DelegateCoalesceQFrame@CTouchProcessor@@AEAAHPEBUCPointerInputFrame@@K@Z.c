/*
 * XREFs of ?DelegateCoalesceQFrame@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@K@Z @ 0x1C011C388
 * Callers:
...
LABEL_3:
  ...
  v15 = CTouchProcessor::CoalesceQFrames(
          (unsigned __int64)this,
          v13,
          (struct CPointerQFrame *)v5,
