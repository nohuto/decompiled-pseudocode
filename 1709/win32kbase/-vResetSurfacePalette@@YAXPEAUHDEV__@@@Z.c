/*
 * XREFs of ?vResetSurfacePalette@@YAXPEAUHDEV__@@@Z @ 0x1C006DD08
 * Callers:
  ...
  if ( (*((_DWORD *)a1 + 547) & 0x100) != 0 )
  {
    ...
    if ( *(_DWORD *)(v2 + 60) == 20 )
    {
      ...
      if ( (v3 & 0x1000) == 0 && (v3 & 0x10000) == 0 )
      {
        ...
        while ( 1 )
        {
          v8 = *(_DWORD *)(v5 + *((_QWORD *)v4 + 15));
          HIBYTE(v8) = 48;
          *(_DWORD *)(v5 + *(_QWORD *)(v2 + 120)) = v8;
          v5 += 4LL;
          if ( v5 >= 40 )
            break;
          v2 = v10;
        ...
        {
          v9 = *(_DWORD *)(*((_QWORD *)v4 + 15) + i - 944);
          HIBYTE(v9) = 48;
          *(_DWORD *)(i + *(_QWORD *)(v10 + 120)) = v9;
        }
        v2 = v10;
      }
    }
    if ( (a1[4] & 0x400) == 0 )
    {
      v7 = (void (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))a1[360];
      if ( v7 )
        v7(a1[227], &v10, 0LL, 0LL, *(_DWORD *)(v2 + 28));
    }
  }
}
