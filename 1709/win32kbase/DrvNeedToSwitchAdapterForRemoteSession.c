/*
 * XREFs of DrvNeedToSwitchAdapterForRemoteSession @ 0x1C00FA2C8
 * Callers:
...
__int64 __fastcall DrvNeedToSwitchAdapterForRemoteSession(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( (*((_DWORD *)i + 40) & 0x4000000) != 0 && *((_QWORD *)i + 40) == a1 )
        return 1LL;
    }
  }
  if ( (int)((__int64 (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD))qword_1C01907A8)(0LL, &v5, 0LL, 0LL) < 0 )
    return 0LL;
  v4 = gpRemoteGraphicsDeviceList;
  if ( gpRemoteGraphicsDeviceList )
  {
    while ( (*((_DWORD *)v4 + 40) & 0x4000000) == 0 || *((_QWORD *)v4 + 39) == v5 )
    {
