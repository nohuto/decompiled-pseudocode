/*
 * XREFs of ?EmitSetKeyframeData@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00283FC
 * Callers:
  ...
  if ( (*((_DWORD *)this + 4) & 0x800) == 0 && *((_QWORD *)this + 15) && *((_QWORD *)this + 17) )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x48uLL, &v10) )
    {
      ...
      *v6 = 211;
      ...
      v6[7] = *((_DWORD *)this + 51);
      v6[8] = *((_DWORD *)this + 53);
      v6[16] = *((_DWORD *)this + 55);
      v6[9] = *((_DWORD *)this + 56);
      v6[10] = *((_DWORD *)this + 57);
      v7 = *((_QWORD *)this + 34);
      if ( v7 )
