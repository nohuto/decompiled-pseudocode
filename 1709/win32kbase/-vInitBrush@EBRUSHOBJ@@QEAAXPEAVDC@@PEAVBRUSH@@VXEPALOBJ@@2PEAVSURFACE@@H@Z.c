/*
 * XREFs of ?vInitBrush@EBRUSHOBJ@@QEAAXPEAVDC@@PEAVBRUSH@@VXEPALOBJ@@2PEAVSURFACE@@H@Z @ 0x1C003F6E0
 * Callers:
 ...
 * Callees:
 *     rgbFromColorref @ 0x1C003FBB0 (rgbFromColorref.c)
 *     ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C003FBF4 (-ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z.c)
        ...
        unsigned int a7)
{
  ...
  *((_QWORD *)a1 + 15) = a3;
  ...
  v43 = v15 & 1;
  if ( (v15 & 1) == 0
    || (v42 & 0x20010) != 0 && ((v42 & 3) != 0 || (struct BRUSH *)a3 == gpbrDCBrush || (struct BRUSH *)a3 == gpbrDCPen) )
  {
    goto LABEL_101;
  }
  if ( (*(_DWORD *)(a3 + 48) & 0x400) == 0 )
  {
    if ( !v18 )
      goto LABEL_101;
    v44 = (*(_DWORD *)(*(_QWORD *)(a2 + 80) + 8LL) & 0x40000) == 0;
LABEL_100:
    if ( !v44 )
      goto LABEL_101;
LABEL_22:
  ...
  if ( v18 )
  {
    v44 = (*(_DWORD *)(*(_QWORD *)(a2 + 80) + 8LL) & 0x80000) == 0;
    goto LABEL_100;
  }
LABEL_101:
  a1[18] = v15;
  *((_QWORD *)a1 + 8) = v18;
  ...
  if ( v43 && v18 && (v15 & 0x10000000) != 0 && (a1[32] & 0x10) != 0 )
  {
    a1[4] |= 4u;
    v25 = 1;
  }
...
LABEL_23:
  ...
  *((_QWORD *)a1 + 13) = *(_QWORD *)(v26 + 1824);
  ...
  if ( v28 )
  {
    v45 = (volatile signed __int32 *)(v28 - 16);
...
LABEL_40:
    ...
    v39 = a7;
LABEL_76:
    if ( ((a1[32] & 4) != 0 || (*(_DWORD *)(v26 + 1840) & 0x800000) != 0) && v39 )
    {
