/*
 * XREFs of ?InitializeThreadInfoIocp@@YAJPEAU_EPROCESS@@PEAUtagTHREADINFO@@@Z @ 0x1C0074094
 * Callers:
...
__int64 __fastcall InitializeThreadInfoIocp(struct _EPROCESS *a1, void **a2)
{
  ...
  *(_OWORD *)&v11.SecurityDescriptor = 0LL;
  v5 = ZwCreateIoCompletion(a2 + 173, 0x1F0003u, &v11, 0);
  if ( v5 < 0 )
  {
    *v2 = 0LL;
  ...
  v6 = a2 + 174;
  v10 = 0;
  v5 = ObDuplicateObject(a1, *v2, a1, a2 + 174, 0, 0, 2, v10);
  if ( v5 < 0 )
    goto LABEL_11;
  LOBYTE(v8) = 1;
  ...
  v6 = a2 + 176;
  v5 = ZwCreateWaitCompletionPacket(a2 + 176, 1LL, &v11);
  if ( v5 < 0 )
  {
LABEL_11:
    *v6 = 0LL;
  ...
  return (unsigned int)ZwAssociateWaitCompletionPacket(*v6, *v2, a2[175], 0LL, 1LL, 0, 0LL, 0LL);
}
