/*
 * XREFs of ?PostRawMouse@CMouseRawInput@CMouseProcessor@@QEAAXPEBUtagINPUTDEST@@W4RawInputPrerequisite@@@Z @ 0x1C0017988
 * Callers:
 ...
 * Callees:
 *     ApiSetEditionPostRawMouseInputMessage @ 0x1C00184BC (ApiSetEditionPostRawMouseInputMessage.c)
 */
