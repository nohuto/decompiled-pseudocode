/*
 * XREFs of ?Initialize@CTokenManager@@AEAAJXZ @ 0x1C0036360
 * Callers:
...
__int64 __fastcall CTokenManager::Initialize(CTokenManager *this)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    v4 = Object;
    v2 = v3;
    *((_QWORD *)this + 2) = Object;
    if ( v3 >= 0 )
    {
      Object = 0LL;
      v2 = MmMapViewInSessionSpace(v4, (PVOID *)this + 3, (PSIZE_T)&Object);
      if ( v2 >= 0 )
      {
        *((_QWORD *)this + 4) = 4096LL;
        v2 = ZwCreateEvent((PHANDLE)this + 5, 0x1F0003u, &ObjectAttributes, NotificationEvent, 0);
        if ( v2 >= 0 )
          v2 = ZwCreateEvent((PHANDLE)this + 6, 0x1F0003u, &ObjectAttributes, SynchronizationEvent, 0);
      }
    }
