/*
 * XREFs of ?xxxMKToggleMouseKeys@@YAHG@Z @ 0x1C01186B0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall xxxMKToggleMouseKeys()
{
  ...
  if ( (gdwPUDFlags & 0x2000) == 0 )
  {
    ...
    {
      v3 = *(_QWORD *)(v1 + 24);
      if ( (((unsigned int)dword_1C018F8C4 >> 7) & 1) == (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & *((_BYTE *)&gafAsyncKeyState + ((unsigned __int64)(unsigned __int8)gNumLockVk >> 2))) != 0) )
      {
        gbMKMouseMode = 1;
