/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C007F100
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C007F0B0 (CreateVisualTargetMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CVisualTargetMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CVisualTargetMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 240LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
