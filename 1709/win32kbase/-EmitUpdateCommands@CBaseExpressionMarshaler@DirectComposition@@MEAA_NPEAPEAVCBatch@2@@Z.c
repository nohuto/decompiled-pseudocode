/*
 * XREFs of ?EmitUpdateCommands@CBaseExpressionMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C002B550
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x200) == 0 )
  {
    ...
    if ( v5 )
    {
      ...
      v21 = 4096LL - *(_QWORD *)(*((_QWORD *)*a2 + 15) + 40LL);
      if ( v21 < v13 && (!DirectComposition::CBatch::AllocateNewFragment(a2, &v21) || v21 < v13) )
        return 0;
      DirectComposition::CBatch::EnsureBatchBuffer(a2, v13, &v22);
      v14 = (char *)v22;
      *(_DWORD *)v22 = v12;
      *(_QWORD *)(v14 + 4) = 0LL;
      *((_DWORD *)v14 + 3) = 0;
  ...
  {
    v15 = 4096LL - *(_QWORD *)(*((_QWORD *)*a2 + 15) + 40LL);
    v21 = v15;
    if ( v15 < 0x14 )
    {
    ...
    DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(4 * v16 + 16), &v22);
    v17 = (char *)v22;
    v18 = 0;
    *(_DWORD *)v22 = 4 * v16 + 16;
    v19 = v17 + 16;
