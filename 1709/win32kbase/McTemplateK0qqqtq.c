/*
 * XREFs of McTemplateK0qqqtq @ 0x1C00E3E6C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqtq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWriteKM(a1, &TouchPadAAP, &W32kControlGuid, 6u, &v9);
}
