 ...
 * Callees:
 *     RtlUpcaseUnicodeToMultiByteN_0 @ 0x1C00A8FCC (RtlUpcaseUnicodeToMultiByteN_0.c)
 *     RtlAnsiCharToUnicodeChar_0 @ 0x1C00A8FD8 (RtlAnsiCharToUnicodeChar_0.c)
 */
