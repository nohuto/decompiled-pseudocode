/*
 * XREFs of ?SetVisualInputSink@CApplicationChannel@DirectComposition@@QEAAJIPEAX@Z @ 0x1C003051C
 * Callers:
        ...
        void *a3)
{
  ...
  if ( v6 && !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 120LL))(v6, 134LL) )
    v7 = -1073741811;
  v9 = 0LL;
  if ( v7 >= 0 )
  {
