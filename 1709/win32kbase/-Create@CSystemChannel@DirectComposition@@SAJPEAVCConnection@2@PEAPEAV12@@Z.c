/*
 * XREFs of ?Create@CSystemChannel@DirectComposition@@SAJPEAVCConnection@2@PEAPEAV12@@Z @ 0x1C008996C
 * Callers:
        ...
        struct DirectComposition::CSystemChannel **a2)
{
  ...
  v4 = (DirectComposition::CApplicationChannel *)Win32AllocPoolZInit(0x310uLL, 1668498244LL);
  v5 = v4;
  if ( v4 )
  {
