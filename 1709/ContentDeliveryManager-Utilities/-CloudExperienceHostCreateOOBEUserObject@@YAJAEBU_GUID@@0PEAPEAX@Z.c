/*
 * XREFs of ?CloudExperienceHostCreateOOBEUserObject@@YAJAEBU_GUID@@0PEAPEAX@Z @ 0x18000C21C
 * Callers:
 *     ?put_OptedIn@MobilityExperienceSettings@ContentManagement@@UEAAJE@Z @ 0x1800115E0 (-put_OptedIn@MobilityExperienceSettings@ContentManagement@@UEAAJE@Z.c)
 *     ?get_OptedIn@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z @ 0x180011680 (-get_OptedIn@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z.c)
 * Callees:
...
LABEL_5:
  ...
  v4 = (*(__int64 (__fastcall **)(LPVOID, GUID *, GUID *, void **))(*(_QWORD *)v10 + 32LL))(
         ...
         &GUID_158cd129_aee8_4594_960e_450a1c2e9b1d,
         a3);
  v5 = v4;
  if ( v4 < 0 )
  {
