        ...
        __int64 a1)
{
  ...
  v2 = *(void (__fastcall ****)(_QWORD, __int64))(a1 + 272);
  if ( v2 )
    (**v2)(v2, 1LL);
  *(_QWORD *)(a1 + 272) = 0LL;
  if ( GetCurrentThreadId() != *(_DWORD *)(a1 + 352) )
