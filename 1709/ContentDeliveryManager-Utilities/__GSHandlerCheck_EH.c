/*
 * XREFs of __GSHandlerCheck_EH @ 0x1800B4310
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x1800B39AC (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x1800B42A0 (__GSHandlerCheckCommon.c)
 */
