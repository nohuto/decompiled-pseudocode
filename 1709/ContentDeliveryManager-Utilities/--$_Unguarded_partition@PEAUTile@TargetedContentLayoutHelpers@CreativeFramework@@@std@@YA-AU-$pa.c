/*
 * XREFs of ??$_Unguarded_partition@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@@std@@YA?AU?$pair@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@PEAU123@@0@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@0@Z @ 0x18008FCF4
 * Callers:
 ...
 *     ??$iter_swap@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@PEAU123@@std@@YAXPEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@0@Z @ 0x1800902CC (--$iter_swap@PEAUTile@TargetedContentLayoutHelpers@CreativeFramework@@PEAU123@@std@@YAXPEAUTile@.c)
 */
        ...
        unsigned __int64 a3)
{
  ...
  else
  {
    ...
    if ( CreativeFramework::TargetedContentLayoutHelpers::Tile::operator<(v6 - v10, v6 - v22) )
      ((void (*)(void))std::iter_swap<CreativeFramework::TargetedContentLayoutHelpers::Tile *,CreativeFramework::TargetedContentLayoutHelpers::Tile *>)();
  ...
  while ( 1 )
  {
    while ( v14 < a3 )
    {
      ...
      v11 += 56LL;
LABEL_41:
      std::iter_swap<CreativeFramework::TargetedContentLayoutHelpers::Tile *,CreativeFramework::TargetedContentLayoutHelpers::Tile *>(v16);
LABEL_42:
      v14 += 56LL;
    }
    v17 = v15 == a2;
      ...
      do
      {
        if ( !CreativeFramework::TargetedContentLayoutHelpers::Tile::operator<(v18, v8) )
        {
          if ( CreativeFramework::TargetedContentLayoutHelpers::Tile::operator<(v8, v18) )
            break;
          v8 -= 56LL;
          std::iter_swap<CreativeFramework::TargetedContentLayoutHelpers::Tile *,CreativeFramework::TargetedContentLayoutHelpers::Tile *>(v8);
        }
        v15 -= 56LL;
        v18 -= 56LL;
      }
    ...
    v8 -= 56LL;
    if ( v15 != v8 )
      std::iter_swap<CreativeFramework::TargetedContentLayoutHelpers::Tile *,CreativeFramework::TargetedContentLayoutHelpers::Tile *>(v15);
    v11 -= 56LL;
    v19 = v8;
LABEL_60:
    std::iter_swap<CreativeFramework::TargetedContentLayoutHelpers::Tile *,CreativeFramework::TargetedContentLayoutHelpers::Tile *>(v19);
  }
  if ( v14 != a3 )
  {
    if ( v11 != v14 )
