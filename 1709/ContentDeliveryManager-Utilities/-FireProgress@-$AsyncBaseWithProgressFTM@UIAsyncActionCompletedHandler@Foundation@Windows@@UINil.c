 ...
 *     ??$CopyLocal@UINilDelegate@Internal@Windows@@@?$GitPtrSupportsAgile@UINilDelegate@Internal@Windows@@@Internal@Windows@@QEAAJV?$ComPtrRef@V?$ComPtr@UINilDelegate@Internal@Windows@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x180020A30 (--$CopyLocal@UINilDelegate@Internal@Windows@@@-$GitPtrSupportsAgile@UINilDelegate@I_ea_180020A30.c)
        ...
        unsigned int a2)
{
  ...
  if ( v6 > 0 )
  {
    do
    {
      if ( v6 == _InterlockedCompareExchange(a1 + 40, v6 + 1, v6) )
        break;
      v6 = *((_DWORD *)a1 + 40);
    }
    while ( v6 > 0 );
    if ( v6 > 0 )
    {
             ...
             &v21) >= 0 )
      {
                    ...
                    &v22) >= 0 )
        {
          ...
          v9 = v23;
          BiasHelper<IUnknown,Windows::Internal::INilDelegate,1>::CreateBias(&pStm, (__int64)v23, v21, (__int64)v22);
