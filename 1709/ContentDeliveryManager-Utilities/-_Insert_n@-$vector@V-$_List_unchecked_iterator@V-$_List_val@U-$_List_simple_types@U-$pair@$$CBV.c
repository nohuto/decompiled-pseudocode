        ...
        unsigned __int64 *a5)
{
  ...
  if ( a4 )
  {
    ...
    {
      v19 = a1[1];
      if ( (v9 - (__int64)a3) >> 3 >= a4 )
      {
        v24 = *a5;
        v25 = a4;
        v26 = (unsigned __int64 *)(v9 - 8 * a4);
    ...
    else
    {
      ...
      if ( v11 )
      {
        if ( v11 > 0x1FFFFFFFFFFFFFFFLL || (v15 = (char *)operator new(8 * v11), (v29 = v15) == 0LL) )
          std::_Xbad_alloc();
      }
      v16 = ((__int64)v6 - *a1) >> 3;
      try
