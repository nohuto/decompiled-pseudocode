 ...
 *     ?MakeAppUninstallService@Actions@CreativeFramework@@YA?AV?$shared_ptr@VIActionService@Actions@CreativeFramework@@@std@@AEBUActionContext@12@AEBV?$map@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@U?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@@4@@Z @ 0x1800736C0 (-MakeAppUninstallService@Actions@CreativeFramework@@YA-AV-$shared_ptr@VIActionService@Actions@Cr.c)
...
void **__fastcall CreativeFramework::Actions::GetRequiredParameter<std::wstring>(void **a1, __int64 **a2, char *a3)
{
  ...
  a1[2] = 0LL;
  *(_WORD *)a1 = 0;
  std::wstring::assign(a1, (void **)v7 + 8, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  return a1;
}
