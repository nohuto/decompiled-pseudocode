/*
 * XREFs of ??$_Getvals@_W@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@IEAAX_WAEBV_Locinfo@1@@Z @ 0x1800960B8
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 16) = v11;
  ...
  if ( *(_QWORD *)(a3 + 56) )
  {
    ...
    if ( !v14 )
      v14 = (const wchar_t *)(a3 + 64);
  }
  else
  {
    v14 = L":Jan:January:Feb:February:Mar:March:Apr:April:May:May:Jun:June:Jul:July:Aug:August:Sep:September:Oct:October:N"
