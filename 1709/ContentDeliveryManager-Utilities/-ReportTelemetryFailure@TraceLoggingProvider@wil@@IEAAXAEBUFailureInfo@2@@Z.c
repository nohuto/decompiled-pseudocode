/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x1800083A0
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x180008370 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
        ...
        const struct wil::FailureInfo *a2)
{
    ...
    && (*((_QWORD *)v2 + 3) & 0x200000000000LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    v60 = 2 * v5 + 2;
    v61 = 0;
    TlgWrite(v2, &unk_18013B0F7, 0LL, 0LL, 0x10u, &pData);
  }
}
