/*
 * XREFs of ?CloseConnection@ContentManagementService@ContentManagement@@AEAAXXZ @ 0x18002D9A4
 * Callers:
...
void __fastcall ContentManagement::ContentManagementService::CloseConnection(RTL_SRWLOCK *this)
{
  ...
  if ( Ptr )
  {
    if ( this[18].Ptr )
    {
      v4 = (*(__int64 (__fastcall **)(PVOID, PVOID))(*(_QWORD *)Ptr + 120LL))(Ptr, this[18].Ptr);
      if ( v4 < 0 )
