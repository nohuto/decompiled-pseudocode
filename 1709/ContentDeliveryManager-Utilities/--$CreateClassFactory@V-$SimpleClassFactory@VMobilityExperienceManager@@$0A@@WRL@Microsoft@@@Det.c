/*
 * XREFs of ??$CreateClassFactory@V?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800870F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)v7 = &Microsoft::WRL::SimpleClassFactory<MobilityExperienceManager,0>::`vftable';
    ((void (__fastcall *)(_DWORD *))*(&Microsoft::WRL::SimpleClassFactory<MobilityExperienceManager,0>::`vftable' + 1))(v7);
