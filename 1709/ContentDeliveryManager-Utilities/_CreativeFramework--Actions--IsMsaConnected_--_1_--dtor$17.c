/*
 * XREFs of _CreativeFramework::Actions::IsMsaConnected_::_1_::dtor$17 @ 0x1800B9A60
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall CreativeFramework::Actions::IsMsaConnected_::_1_::dtor_17(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
