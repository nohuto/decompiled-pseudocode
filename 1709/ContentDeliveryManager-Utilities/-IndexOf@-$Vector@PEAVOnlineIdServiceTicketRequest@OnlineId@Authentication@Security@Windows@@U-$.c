  ...
  *a4 = 0;
  ...
  if ( *(_DWORD *)(a1 + 48) )
  {
    ...
    if ( !is_mul_ok(*(unsigned int *)(a1 + 40), 8uLL) )
      v13 = -1LL;
    v7 = operator new[](v13, (const struct std::nothrow_t *)&TLV::nothrow);
    if ( v7 )
    {
      v14 = 0LL;
      if ( *(_DWORD *)(a1 + 40) )
