/*
 * XREFs of _ToastNotification::ActivityToastNotificationCallback::LaunchUriWithFallback_::_1_::dtor$10 @ 0x1800B7777
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ToastNotification::ActivityToastNotificationCallback::LaunchUriWithFallback_::_1_::dtor_10(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
