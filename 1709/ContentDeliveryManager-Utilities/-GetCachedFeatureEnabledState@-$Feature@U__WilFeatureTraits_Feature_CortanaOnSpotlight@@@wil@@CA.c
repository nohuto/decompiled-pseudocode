/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800718F4
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@SA_NXZ @ 0x180071870 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@SA_NXZ.c)
 * Callees:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(11545976, (enum wil_FeatureEnabledState *)&v10) )
    {
      v3 = v10;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  if ( !g_wil_details_testStates || !(unsigned int)wil_HasFeatureTestState(11545976, 0LL) )
  {
    ...
    {
      do
        v8 = `wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data;
