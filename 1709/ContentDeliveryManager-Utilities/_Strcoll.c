/*
 * XREFs of _Strcoll @ 0x1800B3020
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800B0D70 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800A03FC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800A0400 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800A0474 (__crtCompareStringA_Stub.c)
