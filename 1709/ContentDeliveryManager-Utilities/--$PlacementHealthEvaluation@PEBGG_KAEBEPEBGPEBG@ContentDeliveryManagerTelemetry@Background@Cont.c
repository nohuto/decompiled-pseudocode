/*
 * XREFs of ??$PlacementHealthEvaluation@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x1800366C0
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    v37 = v17 + 1;
    v38 = 0;
    LODWORD(v10) = TlgWrite(v11, &unk_18013B7BD, 0LL, 0LL, 9u, &pData);
  }
  return (int)v10;
}
