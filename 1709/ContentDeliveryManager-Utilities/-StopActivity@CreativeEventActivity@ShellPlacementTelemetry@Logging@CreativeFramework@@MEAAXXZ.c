/*
 * XREFs of ?StopActivity@CreativeEventActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@MEAAXXZ @ 0x1800270E0
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v82 = v10 + 1;
      v83 = 0;
      TlgWrite(v6, &unk_18013B644, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v33 = CurrentThreadId;
      v87 = &v33;
      TlgWrite(v26, &unk_18013BCB5, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v84);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
