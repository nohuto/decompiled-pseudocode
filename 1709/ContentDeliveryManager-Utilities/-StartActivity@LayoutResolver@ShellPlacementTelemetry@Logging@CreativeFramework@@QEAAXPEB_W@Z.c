/*
 * XREFs of ?StartActivity@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEB_W@Z @ 0x180089CEC
 * Callers:
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v7 > 5u && (*((_QWORD *)v7 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v7 + 3) )
    {
      ...
      TlgWrite(v9, &unk_18013EF0A, (LPCGUID)(v12 + 8), v13, 4u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
