/*
 * XREFs of ?Stop@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18006EFCC
 * Callers:
        ...
        CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *this)
{
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
    i = CDMUtilsUnlockLogging::Provider();
    v7 = i;
    if ( *(_DWORD *)i > 5u )
    {
      v14 = 0;
  ...
  {
    LODWORD(i) = wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::ReportStopActivity(this);
  }
  if ( *((_DWORD *)this + 8) )
  {
    v9 = (char *)this + 8;
