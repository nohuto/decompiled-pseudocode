/*
 * XREFs of ?s_AddThreadAffineWrapper@ComTaskPool@Internal@Windows@@CAJPEAUIComPoolTask@23@PEAPEAU423@@Z @ 0x1800046A4
 * Callers:
        ...
        struct Windows::Internal::IComPoolTask **a2)
{
  ...
  *a2 = 0LL;
  v11 = 0LL;
  v4 = (struct Windows::Internal::IComPoolTask *)operator new(0x20uLL, (const struct std::nothrow_t *)&TLV::nothrow);
  v5 = v4;
  if ( !v4 )
  {
    v6 = -2147024882;
