/*
 * XREFs of ?Stop@DiagTrackRuleSetHandlerRemoveRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x18006A290
 * Callers:
        ...
        const char *a2)
{
  ...
  EVENT_DATA_DESCRIPTOR v92; // [rsp+1A8h] [rbp+A0h] BYREF
  PSRWLOCK *v93; // [rsp+1C8h] [rbp+C0h]
  __int64 v94; // [rsp+1D0h] [rbp+C8h]
  __int64 *v95; // [rsp+1D8h] [rbp+D0h]
  __int64 v96; // [rsp+1E0h] [rbp+D8h]
  const unsigned __int16 *v97; // [rsp+1E8h] [rbp+E0h]
  int v98; // [rsp+1F0h] [rbp+E8h]
  int v99; // [rsp+1F4h] [rbp+ECh]
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
    ...
    if ( *(_DWORD *)v8 > 5u )
    {
      ...
      v90 = v12 + 1;
      v91 = 0;
      TlgWrite(v8, &unk_18013E5BF, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v29 > 5u )
    {
      ...
      v98 = v32 + 1;
      v99 = 0;
      TlgWrite(v29, &unk_18013E513, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v92);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
