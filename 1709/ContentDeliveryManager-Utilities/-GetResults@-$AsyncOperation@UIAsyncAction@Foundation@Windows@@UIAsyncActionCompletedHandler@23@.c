        ...
        __int64 a1)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v7[0] == 3 )
    {
      _InterlockedCompareExchange((volatile signed __int32 *)&v8, *(_DWORD *)(a1 - 124), v8);
      if ( *(_QWORD *)(a1 - 136) )
        SetRestrictedErrorInfo();
      return v8;
    }
