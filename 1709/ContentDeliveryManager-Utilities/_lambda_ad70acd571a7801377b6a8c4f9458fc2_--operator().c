/*
 * XREFs of _lambda_ad70acd571a7801377b6a8c4f9458fc2_::operator() @ 0x1800503F8
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_ad70acd571a7801377b6a8c4f9458fc2____Windows::Internal::CNoResult_::Run @ 0x180051DC0 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_ad70acd571a7801.c)
 * Callees:
...
__int64 __fastcall lambda_ad70acd571a7801377b6a8c4f9458fc2_::operator()(__int64 a1)
{
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 80LL) + 40LL))(*(_QWORD *)(*(_QWORD *)a1 + 80LL));
  }
  catch ( ... )
  {
