/*
 * XREFs of ?GetIids@ThumbnailCacheHelper@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18000EDE0
 * Callers:
 *     ?GetIids@ThumbnailCacheHelper@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800217D0 (-GetIids@ThumbnailCacheHelper@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
