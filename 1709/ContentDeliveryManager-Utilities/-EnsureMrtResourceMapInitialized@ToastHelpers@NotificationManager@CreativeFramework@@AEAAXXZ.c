/*
 * XREFs of ?EnsureMrtResourceMapInitialized@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXXZ @ 0x18008612C
 * Callers:
  ...
  if ( !*((_QWORD *)this + 7) )
  {
    ...
    *(_QWORD *)&hstringHeader.Reserved.Reserved2[16] = 0LL;
    ...
    v8 = RoGetActivationFactory(
           *(_QWORD *)&hstringHeader.Reserved.Reserved2[16],
           &GUID_6795a838_4013_4a1a_943d_0f8db4f3d396,
           &v26);
    if ( v8 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
