/*
 * XREFs of ?from_bytes@?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@QEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@PEBD0@Z @ 0x18004AA48
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  _WORD *Src[2]; // [rsp+80h] [rbp-39h] BYREF
  ...
  std::wstring::append((_WORD **)v20, 8uLL, 0);
  *(_QWORD *)(a1 + 96) = 0LL;
  i = v13;
  if ( v13 == a4 )
  {
