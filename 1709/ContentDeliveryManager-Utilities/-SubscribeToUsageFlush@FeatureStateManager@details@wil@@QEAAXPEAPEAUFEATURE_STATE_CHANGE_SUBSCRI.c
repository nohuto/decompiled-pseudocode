/*
 * XREFs of ?SubscribeToUsageFlush@FeatureStateManager@details@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z@Z @ 0x18000A518
 * Callers:
  ...
  if ( *(_BYTE *)this && wil::details::FeatureStateManager::EnsureStateData(this) )
  {
    ...
    if ( !*((_QWORD *)this + 9) && *((_QWORD *)this + 3) )
    {
      ...
      if ( *v6 )
      {
        ...
        if ( qword_18015C178 )
          wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_18015C178[25], qword_18015C178, v7);
