  ...
  *(_QWORD *)(a1 + 96) = 0LL;
  ...
  else if ( v3 )
  {
    if ( (_DWORD)v4 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<ContentManagement::IAppInstallInfoRecord>(v5);
        v5 += 16;
        --v6;
      }
      while ( v6 );
