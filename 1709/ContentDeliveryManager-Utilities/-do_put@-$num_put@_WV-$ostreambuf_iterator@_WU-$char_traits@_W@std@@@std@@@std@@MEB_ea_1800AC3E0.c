/*
 * XREFs of ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WO@Z @ 0x1800AC3E0
 * Callers:
 *     <none>
 * Callees:
        ...
        double a6)
{
  ...
  *(_OWORD *)v19 = *a3;
  v16 = std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Ffmt(a1, v20, 76, v10);
