/*
 * XREFs of ?get_IdentityManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIIdentityManager@2@@Z @ 0x1800123F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContentManagement::IIdentityManager **a2)
{
  ...
  while ( v3 );
  v4 = operator new(0x50uLL, (const struct std::nothrow_t *)&TLV::nothrow);
  v5 = v4;
  v13 = v4;
  if ( !v4 )
  {
...
LABEL_13:
  ...
  *v7 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IIdentityManager>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::FtmBase,IWeakReferenceSource,ContentManagement::IIdentityManager>'};
  v8 = v5 + 6;
  v5[6] = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IIdentityManager>::`vftable'{for `IWeakReferenceSource'};
  v9 = (CreativeFramework::LockScreenCategoryConfig *)(v5 + 7);
  v5[7] = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IIdentityManager>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::IIdentityManager>'};
  ...
  *v7 = &ContentManagement::IdentityManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::FtmBase,IWeakReferenceSource,ContentManagement::IIdentityManager>'};
