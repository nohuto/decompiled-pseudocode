/*
 * XREFs of ?DownloadLatestUtcSettings@FeatureManager@ContentManagement@@UEAAJXZ @ 0x180010C10
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr_NoOriginate@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180002E8C (-Return_Hr_NoOriginate@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??$make_shared@VUtcApiWrapper@Diagnostics@Microsoft@@@std@@YA?AV?$shared_ptr@VUtcApiWrapper@Diagnostics@Microsoft@@@0@XZ @ 0x180018658 (--$make_shared@VUtcApiWrapper@Diagnostics@Microsoft@@@std@@YA-AV-$shared_ptr@VUtcApiWrapper@Diag.c)
 *     ?DownloadLatestSettingsForNamespaceAsync@UtcApiWrapper@Diagnostics@Microsoft@@QEAAJPEBG0HHH@Z @ 0x180092064 (-DownloadLatestSettingsForNamespaceAsync@UtcApiWrapper@Diagnostics@Microsoft@@QEAAJPEBG0HHH@Z.c)
