/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x180080950
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  _WORD *v27[3]; // [rsp+68h] [rbp-69h] BYREF
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    v12 = std::use_facet<std::numpunct<wchar_t>>(&v22);
    ...
    std::wstring::append(v27, v29, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    if ( v30 >= 8 )
    ...
    if ( v28 >= 8 )
      v14 = v27[0];
    v15 = v21;
    v10 = std::_Getloctxt<unsigned short,std::istreambuf_iterator<unsigned short>>(a3, (__int64)v21, 2uLL, v14);
    if ( v28 >= 8 )
