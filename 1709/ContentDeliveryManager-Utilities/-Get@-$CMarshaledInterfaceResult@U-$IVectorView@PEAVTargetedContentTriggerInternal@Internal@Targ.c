        ...
        void **a2)
{
  ...
  if ( v7 )
  {
    ...
    (*(void (__fastcall **)(PVOID, GUID *, PVOID *))(*(_QWORD *)v7 + 24LL))(
      v7,
      &GUID_825906ff_fa5d_5af8_83b4_3bba69c98b1e,
      &v12);
    ...
    {
      v13 = 0LL;
      if ( (int)RoGetAgileReference(0LL, &GUID_825906ff_fa5d_5af8_83b4_3bba69c98b1e, v12, &v13) < 0 )
      {
        v9 = v13;
      }
      else
  ...
  *a2 = 0LL;
  ...
  {
    v10 = CMarshaledInterface::_Unmarshal((CMarshaledInterface *)&v14, &GUID_825906ff_fa5d_5af8_83b4_3bba69c98b1e, a2);
    Ptr = v14;
  }
  else
  {
