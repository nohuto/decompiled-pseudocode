/*
 * XREFs of ?get_EventName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x1800557D0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = WindowsDuplicateString(this[19], a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
