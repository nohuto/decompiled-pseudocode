/*
 * XREFs of ?GetIids@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18004C790
 * Callers:
 *     ?GetIids@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180053B10 (-GetIids@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@WDI@EAAJPE.c)
 * Callees:
 *     <none>
 */
