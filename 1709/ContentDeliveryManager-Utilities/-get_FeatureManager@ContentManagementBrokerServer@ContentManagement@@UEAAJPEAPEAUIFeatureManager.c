/*
 * XREFs of ?get_FeatureManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIFeatureManager@2@@Z @ 0x180012250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  *v6 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IFeatureManager>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::FtmBase,IWeakReferenceSource,ContentManagement::IFeatureManager>'};
  v7 = v4 + 6;
  v4[6] = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IFeatureManager>::`vftable'{for `IWeakReferenceSource'};
  v8 = (CreativeFramework::LockScreenCategoryConfig *)(v4 + 7);
  v4[7] = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IFeatureManager>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::IFeatureManager>'};
  ...
  *v6 = &ContentManagement::FeatureManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,Microsoft::WRL::FtmBase,IWeakReferenceSource,ContentManagement::IFeatureManager>'};
  *v7 = &ContentManagement::FeatureManager::`vftable'{for `IWeakReferenceSource'};
  *(_QWORD *)v8 = &ContentManagement::FeatureManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::IFeatureManager>'};
  v18 = v4;
  v17 = 0LL;
  IsCallerInAllowedAppList = CreativeFramework::LockScreenCategoryConfig::IsCallerInAllowedAppList(
                               v8,
                               (const unsigned __int16 *const *)&ContentManagement::FeatureManager::`vftable'{for `IWeakReferenceSource'});
  v5 = IsCallerInAllowedAppList;
  if ( IsCallerInAllowedAppList >= 0 )
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD *, GUID *, _QWORD))*v4)(v4, &GUID_0b6ddd08_896c_4665_a48d_8ec84a507666, &v16);
  }
  else
  {
...
LABEL_10:
  if ( v5 < 0 )
    goto LABEL_11;
  v12 = (**v16)(v16, &GUID_0b6ddd08_896c_4665_a48d_8ec84a507666, a2);
  v5 = v12;
  if ( v12 < 0 )
  {
