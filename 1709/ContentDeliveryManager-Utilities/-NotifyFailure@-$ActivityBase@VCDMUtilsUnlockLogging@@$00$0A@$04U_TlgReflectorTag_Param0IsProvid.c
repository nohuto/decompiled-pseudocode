/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18006E9B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v2; // eax
  ...
  {
    v23 = CDMUtilsUnlockLogging::Provider();
    if ( *(_DWORD *)v23 > 5u )
    {
      ...
      v101 = v27 + 1;
      v102 = 0;
      TlgWrite(v23, &unk_18013EA77, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v59);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v138 = 2 * v8 + 2;
      v139 = 0;
      TlgWrite(v5, &unk_18013D3F5, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
