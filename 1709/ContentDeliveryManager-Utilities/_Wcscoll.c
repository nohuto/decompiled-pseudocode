/*
 * XREFs of _Wcscoll @ 0x1800B316C
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800A9AD0 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800A03FC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800A0400 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800A047C (__crtCompareStringW_Stub.c)
 */
