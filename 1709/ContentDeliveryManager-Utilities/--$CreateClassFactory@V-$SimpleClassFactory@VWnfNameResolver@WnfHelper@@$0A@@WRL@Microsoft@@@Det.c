/*
 * XREFs of ??$CreateClassFactory@V?$SimpleClassFactory@VWnfNameResolver@WnfHelper@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180053C60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    *(_QWORD *)v7 = &Microsoft::WRL::SimpleClassFactory<WnfHelper::WnfNameResolver,0>::`vftable';
    ((void (__fastcall *)(_DWORD *))*(&Microsoft::WRL::SimpleClassFactory<WnfHelper::WnfNameResolver,0>::`vftable' + 1))(v7);
