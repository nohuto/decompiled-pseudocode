/*
 * XREFs of ?do_get_date@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800B15C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v11 = std::use_facet<std::ctype<char>>(&v70);
...
LABEL_25:
  ...
  if ( (*(_WORD *)(*((_QWORD *)v11 + 3) + 2LL * *(unsigned __int8 *)(a3 + 9)) & 4) != 0 )
  {
    v22 = a7;
    if ( v15 != 2 )
    {
...
LABEL_40:
  while ( !std::istreambuf_iterator<char>::equal((__int64 *)a3, a4) )
  {
    ...
    if ( (*(_BYTE *)(*((_QWORD *)v11 + 3) + 2LL * *(unsigned __int8 *)(a3 + 9)) & 0x48) == 0 )
      break;
  ...
  v32 = (*(__int64 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v11 + 80LL))(v11, v28, 0LL);
...
LABEL_71:
  ...
  while ( (*(_BYTE *)(*((_QWORD *)v11 + 3) + 2LL * *(unsigned __int8 *)(a3 + 9)) & 0x48) != 0 );
  if ( std::istreambuf_iterator<char>::equal((__int64 *)a3, a4) )
    goto LABEL_93;
  if ( !*(_BYTE *)(a3 + 8) )
  {
  ...
  if ( (*(_WORD *)(*((_QWORD *)v11 + 3) + 2LL * *(unsigned __int8 *)(a3 + 9)) & 4) != 0 )
  {
    ...
    {
      v43 = (_DWORD *)(v22 + 16);
      *v17 |= std::time_get<char,std::istreambuf_iterator<char>>::_Getint(a1, a3, a4, 1, 12, v43, (__int64)v11);
      --*v43;
    }
    goto LABEL_93;
  }
...
LABEL_108:
  ...
  v52 = (*(__int64 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v11 + 80LL))(v11, v48, 0LL);
