/*
 * XREFs of ??1HandleResumableTaskNotificationActivity@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@QEAA@XZ @ 0x180045DB0
 * Callers:
 *     _lambda_8e4e9cc2004ae5ecc1ef9233f35a06b9_::operator() @ 0x180047AE4 (_lambda_8e4e9cc2004ae5ecc1ef9233f35a06b9_--operator().c)
 *     __lambda_8e4e9cc2004ae5ecc1ef9233f35a06b9_::operator()_::_1_::dtor$2 @ 0x1800B7548 (__lambda_8e4e9cc2004ae5ecc1ef9233f35a06b9_--operator()_--_1_--dtor$2.c)
 * Callees:
...
LABEL_12:
  ...
  wil::ActivityBase<MobilityExperience::Telemetry::MobilityExperienceLogging,1,140737488355328,5,_TlgReflectorTag_Param0IsProviderType>::~ActivityBase<MobilityExperience::Telemetry::MobilityExperienceLogging,1,140737488355328,5,_TlgReflectorTag_Param0IsProviderType>(this);
}
