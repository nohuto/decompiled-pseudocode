/*
 * XREFs of _lambda_507b8746d9d21652e67ea22c8df447bd_::operator() @ 0x18004FF58
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_507b8746d9d21652e67ea22c8df447bd____Windows::Internal::CNoResult_::Run @ 0x180051DF0 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_507b8746d9d2165.c)
 * Callees:
...
__int64 __fastcall lambda_507b8746d9d21652e67ea22c8df447bd_::operator()(__int64 a1)
{
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 80LL) + 32LL))(*(_QWORD *)(*(_QWORD *)a1 + 80LL));
  }
  catch ( ... )
  {
