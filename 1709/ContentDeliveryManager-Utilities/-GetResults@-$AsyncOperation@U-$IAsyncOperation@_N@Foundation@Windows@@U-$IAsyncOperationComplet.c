/*
 * XREFs of ?GetResults@?$AsyncOperation@U?$IAsyncOperation@_N@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@_N@23@V?$CBasicResult@E$0A@@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAJPEAE@Z @ 0x1800709D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        _BYTE *a2)
{
  ...
  *a2 = 0;
  ...
  if ( v10 == 3 )
  {
    ...
    if ( v11 == 3 )
    {
      _InterlockedCompareExchange(&v9, *(_DWORD *)(a1 - 124), v9);
      v6 = *(_QWORD *)(a1 - 136);
      if ( v6 )
