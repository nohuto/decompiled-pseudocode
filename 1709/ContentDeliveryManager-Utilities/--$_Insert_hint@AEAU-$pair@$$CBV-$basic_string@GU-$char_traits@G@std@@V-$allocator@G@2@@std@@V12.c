        ...
        __int64 a5)
{
  ...
  if ( (unsigned __int8)std::less<std::wstring>::operator()(i, v14 + 4, a4) )
  {
    if ( *(_BYTE *)(v14[2] + 25) )
      std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
        a1,
  ...
  {
LABEL_47:
    if ( !(unsigned __int8)std::less<std::wstring>::operator()(i, (_QWORD *)(a3 + 32), a4) )
      goto LABEL_44;
    v17 = (__int64 *)a3;
    if ( !*(_BYTE *)(a3 + 25) )
    {
      ...
      if ( *(_BYTE *)(v18 + 25) )
      {
        for ( k = *(_QWORD *)(a3 + 8); !*(_BYTE *)(k + 25) && v17 == *(__int64 **)(k + 16); k = *(_QWORD *)(k + 8) )
          v17 = (__int64 *)k;
        v17 = (__int64 *)k;
      }
      else
    ...
    if ( v17 != *a1 && !(unsigned __int8)std::less<std::wstring>::operator()(v16, a4, v17 + 4) )
    {
LABEL_44:
