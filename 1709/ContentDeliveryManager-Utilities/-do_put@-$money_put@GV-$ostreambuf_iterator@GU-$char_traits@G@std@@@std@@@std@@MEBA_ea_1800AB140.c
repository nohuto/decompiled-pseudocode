/*
 * XREFs of ?do_put@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@_NAEAVios_base@2@GO@Z @ 0x1800AB140
 * Callers:
 *     <none>
 * Callees:
...
__int128 *__fastcall std::money_put<unsigned short,std::ostreambuf_iterator<unsigned short>>::do_put(
        __int64 a1,
        __int128 *a2,
        __int128 *a3,
        char a4,
        ...
        double a7)
{
  ...
  if ( v12 >= 0 )
  {
    ...
    *(_QWORD *)&v23 = v14;
    ...
    v15 = std::use_facet<std::ctype<unsigned short>>((__int64 *)&v23);
    *(_QWORD *)&v23 = v15;
