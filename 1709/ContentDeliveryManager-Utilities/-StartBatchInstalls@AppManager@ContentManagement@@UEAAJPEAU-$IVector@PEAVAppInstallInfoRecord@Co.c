/*
 * XREFs of ?StartBatchInstalls@AppManager@ContentManagement@@UEAAJPEAU?$IVector@PEAVAppInstallInfoRecord@ContentManagement@@@Collections@Foundation@Windows@@PEAPEAU?$IVectorView@PEAVAppInstallInfoRecord@ContentManagement@@@456@@Z @ 0x18000CCC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
  ...
  v31 = 0LL;
  v12 = v30;
  v7 = WaitForCompletion<Windows::Foundation::IAsyncOperationCompletedHandler<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::Internal::InstallAppInfo *> *>,Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::Internal::InstallAppInfo *> *>>(v30);
  if ( v7 < 0 || (v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v12 + 64LL))(v12, &v31), v7 < 0) )
  {
    v15 = (unsigned int)v7;
    v16 = 262LL;
LABEL_29:
  ...
  v14 = ContentManagement::AppManager::ConvertFromStoreRecords(v13, v31, a3);
  v7 = v14;
  if ( v14 < 0 )
  {
