/*
 * XREFs of ?_Reallocate@?$vector@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@std@@IEAAX_K@Z @ 0x180094478
 * Callers:
...
void __fastcall std::vector<std::wstring>::_Reallocate(void **a1, unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( a2 > 0x7FFFFFFFFFFFFFFLL || (v4 = (void **)operator new(32 * a2), (v9 = v4) == 0LL) )
      std::_Xbad_alloc();
  }
  try
  {
  ...
  a1[2] = &v4[4 * a2];
  a1[1] = (char *)v4 + (v8 & 0xFFFFFFFFFFFFFFE0uLL);
  *a1 = v4;
}
