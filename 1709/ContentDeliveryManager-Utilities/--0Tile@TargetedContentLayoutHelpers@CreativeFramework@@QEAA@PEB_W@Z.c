/*
 * XREFs of ??0Tile@TargetedContentLayoutHelpers@CreativeFramework@@QEAA@PEB_W@Z @ 0x18008F090
 * Callers:
 ...
 *     ?stoul@std@@YAKAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@1@PEA_KH@Z @ 0x18008F01C (-stoul@std@@YAKAEBV-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@1@PEA_KH@Z.c)
...
wchar_t *__fastcall CreativeFramework::TargetedContentLayoutHelpers::Tile::Tile(wchar_t *this, wchar_t *a2)
{
  ...
  *this = 0;
  ...
  v5 = std::wstring::find((char *)String, L"!", 0LL, asc_1801341E0[0] != 0);
  *((_BYTE *)this + 48) = 0;
  if ( this != String )
