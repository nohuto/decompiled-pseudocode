/*
 * XREFs of _lambda_745238b28a452f34781447bba762a765_::operator() @ 0x18004F7B8
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_745238b28a452f34781447bba762a765____Windows::Internal::CNoResult_::Run @ 0x180051E50 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_745238b28a452f3.c)
 * Callees:
...
__int64 __fastcall lambda_745238b28a452f34781447bba762a765_::operator()(__int64 a1)
{
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 80LL) + 16LL))(*(_QWORD *)(*(_QWORD *)a1 + 80LL));
  }
  catch ( ... )
  {
