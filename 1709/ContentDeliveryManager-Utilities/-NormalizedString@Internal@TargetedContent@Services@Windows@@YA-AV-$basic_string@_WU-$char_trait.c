/*
 * XREFs of ?NormalizedString@Internal@TargetedContent@Services@Windows@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W00@Z @ 0x18005F2C4
 * Callers:
...
void **__fastcall Windows::Services::TargetedContent::Internal::NormalizedString(void **Src, char *a2)
{
  ...
  *(_WORD *)Src = 0;
  ...
  {
    v4 = (void **)std::wstring::replace(Src, asc_1800ED274[0] != 0);
    if ( Src != v4 )
