/*
 * XREFs of ?StartActivity@TriggerManagerUnregisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x180056F90
 * Callers:
        ...
        const char *a2)
{
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v7 > 5u )
  {
    ...
    TlgWrite(v7, &unk_18013E252, (LPCGUID)(v11 + 8), v12, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
