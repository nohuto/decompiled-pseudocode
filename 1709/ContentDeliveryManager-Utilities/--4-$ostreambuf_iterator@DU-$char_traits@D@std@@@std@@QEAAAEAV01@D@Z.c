/*
 * XREFs of ??4?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@D@Z @ 0x180099728
 * Callers:
...
__int64 __fastcall std::ostreambuf_iterator<char>::operator=(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( !v4
    || (!**(_QWORD **)(v4 + 64) ? (v5 = 0) : (v5 = **(_DWORD **)(v4 + 88)),
        v5 <= 0
      ? (v8 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v4 + 24LL))(v4, a2))
      : (--**(_DWORD **)(v4 + 88), v6 = *(unsigned __int8 ***)(v4 + 64), v7 = *v6, ++*v6, *v7 = a2, v8 = a2),
        v8 == -1) )
  {
    *(_BYTE *)a1 = 1;
  }
