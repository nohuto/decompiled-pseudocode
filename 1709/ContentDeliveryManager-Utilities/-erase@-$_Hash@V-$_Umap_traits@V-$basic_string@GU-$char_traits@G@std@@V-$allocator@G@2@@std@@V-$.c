 ...
 * Callers:
 *     ?UnregisterSubscription@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UEAAJPEAUHSTRING__@@PEAUISubscriptionPriv@234@@Z @ 0x180040DA0 (-UnregisterSubscription@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UEAA.c)
        ...
        _QWORD *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 48) <= v11 )
    v11 += -1LL - (v10 >> 1);
  v12 = 2 * v11;
  for ( i = *(_QWORD **)(*(_QWORD *)(a1 + 16) + 8 * v12); ; i = (_QWORD *)*i )
  {
    v14 = *(_QWORD *)(a1 + 16);
    v15 = *(_QWORD ***)a1;
    if ( *(_QWORD *)(v14 + 8 * v12) != *(_QWORD *)a1 )
      v15 = **(_QWORD ****)(v14 + 8 * v12 + 8);
    if ( i == v15 )
      goto LABEL_21;
  ...
  while ( 1 )
  {
    v17 = *(_QWORD *)(a1 + 16);
    v18 = *(_QWORD **)a1;
    if ( *(_QWORD *)(v17 + 8 * v12) != *(_QWORD *)a1 )
      v18 = **(_QWORD ***)(v17 + 8 * v12 + 8);
    if ( i == v18
      || (unsigned __int8)std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>::operator()(
                            v17,
                            a2,
                            i + 2,
                            v8) )
