/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_ActionCenterNotification@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800360EC
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_ActionCenterNotification@@@wil@@SA_NXZ @ 0x18002F620 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_ActionCenterNotification@@@wil@@SA_NXZ.c)
...
__int64 wil::Feature<__WilFeatureTraits_Feature_ActionCenterNotification>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(8598334, (enum wil_FeatureEnabledState *)&v9) )
    {
      v3 = v9;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  if ( !g_wil_details_testStates || !(unsigned int)wil_HasFeatureTestState(8598334, 0LL) )
  {
    ...
    {
      do
        v7 = `wil::Feature<__WilFeatureTraits_Feature_ActionCenterNotification>::GetFeaturePropertyCache'::`2'::data;
