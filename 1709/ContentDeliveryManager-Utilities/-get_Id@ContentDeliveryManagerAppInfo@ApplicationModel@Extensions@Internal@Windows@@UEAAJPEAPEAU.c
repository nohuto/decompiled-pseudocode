/*
 * XREFs of ?get_Id@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180087E80
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = (*(__int64 (__fastcall **)(_QWORD, HSTRING *))(**((_QWORD **)this + 10) + 48LL))(*((_QWORD *)this + 10), a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
