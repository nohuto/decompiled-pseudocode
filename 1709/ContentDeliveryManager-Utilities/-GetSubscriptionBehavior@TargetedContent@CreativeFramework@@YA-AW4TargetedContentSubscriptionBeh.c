/*
 * XREFs of ?GetSubscriptionBehavior@TargetedContent@CreativeFramework@@YA?AW4TargetedContentSubscriptionBehavior@12@PEBG@Z @ 0x180029104
 * Callers:
...
__int64 __fastcall CreativeFramework::TargetedContent::GetSubscriptionBehavior(__int64 a1)
{
  ...
  v7 = -2LL;
  v5 = a1;
  v8 = *(_OWORD *)&off_1800CCEB0;
  v9 = xmmword_1800CCEC0;
  v10 = 3600LL;
  *(_QWORD *)&v6 = &v5;
  *((_QWORD *)&v6 + 1) = &v8;
  v12 = 0LL;
  ...
  if ( !v1 )
    std::_Xbad_alloc();
  *(_QWORD *)v1 = off_1800C3B80;
  *(_OWORD *)(v1 + 8) = v6;
  v12 = v1;
  v2 = (__int64 (__fastcall **)())off_1800C3910;
  do
  {
