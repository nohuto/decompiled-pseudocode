/*
 * XREFs of _CreativeFramework::Actions::MakeAppInstallService_::_1_::dtor$14 @ 0x1800B9DB7
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CreativeFramework::Actions::MakeAppInstallService_::_1_::dtor_14(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 84) & 0x10) != 0 )
  {
    *(_DWORD *)(a2 + 84) &= ~0x10u;
