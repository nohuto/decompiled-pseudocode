        ...
        void **a4)
{
  ...
  try
  {
    ...
    if ( v5 != (void **)-16LL )
    {
      ...
      v5[4] = 0LL;
      *(_WORD *)v7 = 0;
      std::wstring::assign(v7, a4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    }
  }
  catch ( ... )
  {
