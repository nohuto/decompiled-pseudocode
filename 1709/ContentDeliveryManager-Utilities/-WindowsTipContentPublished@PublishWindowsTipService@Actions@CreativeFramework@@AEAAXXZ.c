/*
 * XREFs of ?WindowsTipContentPublished@PublishWindowsTipService@Actions@CreativeFramework@@AEAAXXZ @ 0x180083008
 * Callers:
 *     ?Invoke@PublishWindowsTipService@Actions@CreativeFramework@@UEAAXXZ @ 0x180083000 (-Invoke@PublishWindowsTipService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        CreativeFramework::Actions::PublishWindowsTipService *this)
{
  ...
  _BYTE v21[32]; // [rsp+58h] [rbp-B0h] BYREF
  ...
  *v10 = 0;
  ...
  v18 = 0LL;
  v14 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v19 + 112LL))(v19, &v18);
  if ( v14 < 0 )
  {
    wil::details::in1diag3::_Throw_Hr(
      retaddr,
  ...
  v15 = v18;
  v16 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v21, v20);
  v17 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, _BYTE *))(*(_QWORD *)v15 + 48LL))(
          v15,
          *(_QWORD *)(v16 + 24),
          1024LL,
          v22);
