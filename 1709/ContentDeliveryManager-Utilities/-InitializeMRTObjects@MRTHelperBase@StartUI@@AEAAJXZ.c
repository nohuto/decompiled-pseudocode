/*
 * XREFs of ?InitializeMRTObjects@MRTHelperBase@StartUI@@AEAAJXZ @ 0x180088A48
 * Callers:
...
LABEL_26:
  ...
  if ( *((_WORD *)this + 17) )
  {
    if ( *((_BYTE *)this + 35) )
    {
      Instance = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)*v14 + 112LL))(
                   *v14,
    ...
    {
      Instance = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v14 + 120LL))(*v14);
      if ( Instance < 0 )
      {
        v9 = 117LL;
        goto LABEL_12;
  ...
  if ( *((_BYTE *)this + 36) )
  {
    v18 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)*v14 + 128LL))(*v14, *((unsigned int *)this + 7));
    v19 = v18;
    if ( v18 < 0 )
    {
      wil::details::in1diag3::Return_Hr_NoOriginate(
