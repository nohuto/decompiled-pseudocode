/*
 * XREFs of ??$ReportPlacementHealth@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x180036850
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
      ...
      && (*((_QWORD *)v11 + 3) & 0x800000000000LL) == *((_QWORD *)v11 + 3) )
    {
      ...
      v36 = v14 + 1;
      v37 = 0;
      LODWORD(v10) = TlgWrite(v11, &unk_18013B99D, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v10;
}
