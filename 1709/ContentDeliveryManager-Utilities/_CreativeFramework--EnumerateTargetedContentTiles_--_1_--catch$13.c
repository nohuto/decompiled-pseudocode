/*
 * XREFs of _CreativeFramework::EnumerateTargetedContentTiles_::_1_::catch$13 @ 0x1800BBDB2
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CreativeFramework::EnumerateTargetedContentTiles_::_1_::catch_13(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
