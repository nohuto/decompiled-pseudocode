        ...
        __int64 a2)
{
  ...
  else if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 20)) == 1 )
  {
    ...
    {
      v18 = 0LL;
      AgileReference = RoGetAgileReference(0LL, &GUID_3ace5b1e_08a6_557d_b94b_a904f023687c, a2, &v18);
      if ( AgileReference < 0 )
      {
        v7 = v18;
      }
