        ...
        _BYTE *a3)
{
  ...
  *a3 = 0;
  v6 = *(_DWORD *)(*(_QWORD *)(a1 + 80) + 12LL);
  result = 0LL;
  v8 = 0LL;
  while ( (unsigned int)v8 < v6 )
  {
    v9 = *(_QWORD *)(*(_QWORD *)(a1 + 80) + 8 * v8 + 16);
    v10 = 0;
