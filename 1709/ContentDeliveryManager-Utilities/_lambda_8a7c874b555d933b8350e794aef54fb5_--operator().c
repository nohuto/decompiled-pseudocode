/*
 * XREFs of _lambda_8a7c874b555d933b8350e794aef54fb5_::operator() @ 0x18004FB88
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_8a7c874b555d933b8350e794aef54fb5____Windows::Internal::CNoResult_::Run @ 0x180051E20 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_8a7c874b555d933.c)
 * Callees:
...
__int64 __fastcall lambda_8a7c874b555d933b8350e794aef54fb5_::operator()(__int64 a1)
{
  __int64 v2; // rax
  ...
  v2 = std::map<std::wstring,std::wstring>::operator[](*(_QWORD *)a1 + 96LL, v17);
  ...
  v4 = std::map<std::wstring,std::wstring>::operator[](*(_QWORD *)a1 + 96LL, v14);
  ...
  v6 = std::map<std::wstring,std::wstring>::operator[](*(_QWORD *)a1 + 96LL, v11);
  ...
  v34 = 0LL;
  v35 = 0LL;
  v20[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v20,
    v7,
    v5,
    v3);
  if ( v13 >= 8 )
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 80LL) + 24LL))(*(_QWORD *)(*(_QWORD *)a1 + 80LL));
  }
  catch ( ... )
  {
