/*
 * XREFs of ?InitializeNotificationTemplate@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXXZ @ 0x180084BA8
 * Callers:
...
void __fastcall CreativeFramework::NotificationManager::ToastHelpers::InitializeNotificationTemplate(void **this)
{
  ...
  void **v10; // rax
  char *v11; // rdx
  __int64 *v12[2]; // [rsp+48h] [rbp-49h] BYREF
  ...
  v14 = 0LL;
  LOWORD(v13[0]) = 0;
  v6 = (char *)&unk_18015C810;
  while ( (unsigned int)std::wstring::compare(v19, *((_WORD **)v6 + 1)) )
  {
    v6 += 24;
