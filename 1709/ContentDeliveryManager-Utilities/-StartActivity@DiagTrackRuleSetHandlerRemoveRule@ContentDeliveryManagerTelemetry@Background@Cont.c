/*
 * XREFs of ?StartActivity@DiagTrackRuleSetHandlerRemoveRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_WIPEBD@Z @ 0x18006A0C0
 * Callers:
        ...
        const char *a4)
{
  ...
  const unsigned __int16 *v29; // [rsp+90h] [rbp+17h]
  ...
  *(_DWORD *)v7 = 1;
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    TlgWrite(v10, &unk_18013E311, (LPCGUID)(v16 + 8), v17, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
