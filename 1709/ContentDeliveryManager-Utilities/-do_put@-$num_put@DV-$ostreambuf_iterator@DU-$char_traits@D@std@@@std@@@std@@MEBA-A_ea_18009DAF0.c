/*
 * XREFs of ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DN@Z @ 0x18009DAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        double a6)
{
  ...
  *(_OWORD *)v19 = *a3;
  v16 = (const char *)std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Ffmt(a1, v20, 0LL);
