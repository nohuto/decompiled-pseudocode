/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180030020
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  {
    v23 = CreativeFramework::Logging::ShellPlacementLogging::Provider();
    if ( *(_DWORD *)v23 > 5u )
    {
