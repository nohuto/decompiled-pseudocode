/*
 * XREFs of ?do_get_date@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800AA580
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v11 = std::use_facet<std::ctype<unsigned short>>(&v43);
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v11 + 32LL))(
          v11,
          4LL,
          *v18) )
  {
...
LABEL_16:
  ...
  v23 = (*(__int64 (__fastcall **)(struct std::_Facet_base *, _QWORD, _QWORD))(*(_QWORD *)v11 + 112LL))(v11, *v22, 0LL);
...
LABEL_23:
  ...
  while ( (*(unsigned __int8 (__fastcall **)(struct std::_Facet_base *, __int64, _QWORD))(*(_QWORD *)v11 + 32LL))(
            v11,
            72LL,
            *v25) );
  if ( std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
...
LABEL_36:
  ...
  v31 = (*(__int64 (__fastcall **)(struct std::_Facet_base *, _QWORD, _QWORD))(*(_QWORD *)v11 + 112LL))(v11, *v30, 0LL);
