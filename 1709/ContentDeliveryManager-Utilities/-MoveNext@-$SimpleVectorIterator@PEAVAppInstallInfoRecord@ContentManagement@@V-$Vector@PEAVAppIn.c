    ...
    while ( 1 )
    {
      *a2 = 0;
      if ( v5 >= *(_DWORD *)(a1 + 84) )
        break;
      v3 = 0;
      *a2 = v5 + 1 < *(_DWORD *)(a1 + 84);
      v7 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 80), v5 + 1, v5);
      v6 = v5 == v7;
      v5 = v7;
      if ( v6 )
        goto LABEL_8;
