  ...
  *a4 = 0;
  ...
  if ( v11 )
  {
    ...
    do
    {
      ...
      {
        ++v10;
        v32[v12++] = byte_1800DFB40[v11 - "0123456789abcdefABCDEF"];
      }
      v11 = memchr("0123456789abcdefABCDEF", *++v8, 0x16uLL);
    }
    while ( v11 );
  ...
  if ( v16 )
  {
    ...
    do
    {
      ...
      {
        ++v10;
        v32[v17++] = byte_1800DFB40[v16 - "0123456789abcdefABCDEF"];
        --*a4;
      }
      v16 = memchr("0123456789abcdefABCDEF", *++v15, 0x16uLL);
    }
