/*
 * XREFs of ??$_Buffered_rotate@PEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@_JV12@@std@@YAPEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@0@PEAV10@00_J1AEAV?$_Temp_iterator@V?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@0@@Z @ 0x180091910
 * Callers:
 ...
 *     ??$rotate@PEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@YAPEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@0@PEAV10@00@Z @ 0x180091DC0 (--$rotate@PEAV-$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@YAP.c)
 */
        ...
        __int64 a6)
{
  ...
  void *v23[5]; // [rsp+48h] [rbp-28h] BYREF
  ...
  else
  {
    ...
    if ( *v11 != v13 )
    {
      do
      {
        v13 -= 2;
        a3 -= 2;
        std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>::operator=(a3, v13);
      }
      while ( v13 != v12 );
    }
    return a3;
