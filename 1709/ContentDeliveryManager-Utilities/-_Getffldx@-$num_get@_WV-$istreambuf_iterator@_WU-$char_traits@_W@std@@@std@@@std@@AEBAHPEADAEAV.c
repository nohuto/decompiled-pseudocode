/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x180081770
 * Callers:
        ...
        int *a6)
{
  ...
  size_t v79[3]; // [rsp+78h] [rbp-69h] BYREF
  ...
  v10 = std::use_facet<std::numpunct<wchar_t>>(&v72);
  v75 = v10;
