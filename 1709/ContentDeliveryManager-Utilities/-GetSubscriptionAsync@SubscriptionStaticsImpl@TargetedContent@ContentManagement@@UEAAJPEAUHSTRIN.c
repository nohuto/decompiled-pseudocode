/*
 * XREFs of ?GetSubscriptionAsync@SubscriptionStaticsImpl@TargetedContent@ContentManagement@@UEAAJPEAUHSTRING__@@PEAU?$IMap@PEAUHSTRING__@@PEAU1@@Collections@Foundation@Windows@@PEAPEAU?$IAsyncOperation@PEAVTargetedContentSubscription@TargetedContent@ContentManagement@@@78@@Z @ 0x18006C130
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a4)
{
  ...
  __int16 v6; // [rsp+24h] [rbp-14h]
  __int64 v7; // [rsp+28h] [rbp-10h]
  __int16 v8; // [rsp+5Ch] [rbp+24h]
