/*
 * XREFs of _lambda_b7df6605325939df64e4896ead66165a_::operator() @ 0x18004F318
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_b7df6605325939df64e4896ead66165a____Windows::Internal::CNoResult_::Run @ 0x180051E80 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_b7df6605325939d.c)
 * Callees:
...
__int64 __fastcall lambda_b7df6605325939df64e4896ead66165a_::operator()(__int64 a1)
{
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 80LL) + 8LL))(*(_QWORD *)(*(_QWORD *)a1 + 80LL));
  }
  catch ( ... )
  {
