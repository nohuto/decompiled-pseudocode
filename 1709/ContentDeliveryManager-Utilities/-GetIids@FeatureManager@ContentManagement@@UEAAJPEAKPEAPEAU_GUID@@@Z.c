/*
 * XREFs of ?GetIids@FeatureManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180010BF0
 * Callers:
 *     ?GetIids@FeatureManager@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180021430 (-GetIids@FeatureManager@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
