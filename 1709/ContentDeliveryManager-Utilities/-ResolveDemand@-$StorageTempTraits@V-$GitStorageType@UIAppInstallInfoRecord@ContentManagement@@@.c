        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( *(_BYTE *)(a1 + 8) )
  {
    ...
    *a2 = 0LL;
    v2 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, _QWORD *))(*(_QWORD *)qword_18015DDF8 + 40LL))(
           qword_18015DDF8,
           *((unsigned int *)v5 + 1),
