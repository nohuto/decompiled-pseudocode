/*
 * XREFs of _lambda_56cf871f6c9639d4a89a91dc6a4d1d9c_::operator() @ 0x18000FE44
 * Callers:
...
__int64 __fastcall lambda_56cf871f6c9639d4a89a91dc6a4d1d9c_::operator()(__int64 a1)
{
  int v2; // ebx
  int v3; // eax
  PCWSTR v4; // rcx
