/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18008D370
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v2 == `wil::TraceLoggingProvider::WasAlreadyReportedToTelemetry'::`2'::s_lastFailureSeen )
  {
      ...
      && (*((_QWORD *)v23 + 3) & 0x400000000000LL) == *((_QWORD *)v23 + 3) )
    {
      ...
      v101 = v26 + 1;
      v102 = 0;
      TlgWrite(v23, &unk_18013CE83, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v59);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x600000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v138 = 2 * v8 + 2;
      v139 = 0;
      TlgWrite(v5, &unk_18013CFF2, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
