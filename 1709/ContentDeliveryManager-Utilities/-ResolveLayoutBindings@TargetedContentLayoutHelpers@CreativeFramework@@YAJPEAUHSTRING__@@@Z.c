/*
 * XREFs of ?ResolveLayoutBindings@TargetedContentLayoutHelpers@CreativeFramework@@YAJPEAUHSTRING__@@@Z @ 0x18008B004
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_d0249701552e980dd27d25ea59751cd6____Windows::Internal::CNoResult_::Run @ 0x180038B70 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_d0249701552e980.c)
 * Callees:
        ...
        HSTRING a2)
{
  ...
  try
  {
    *(_OWORD *)string = 0LL;
    ...
    wil::ActivityBase<CreativeFramework::Logging::ShellPlacementLogging,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::Stop((CreativeFramework::Logging::ShellPlacementTelemetry::LayoutResolver *)v18);
    v5 = v14;
    if ( (_QWORD)v14 )
    {
      v6 = *((_QWORD *)&v14 + 1);
