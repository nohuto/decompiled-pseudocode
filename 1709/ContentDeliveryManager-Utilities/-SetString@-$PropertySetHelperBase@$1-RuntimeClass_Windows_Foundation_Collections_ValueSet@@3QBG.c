/*
 * XREFs of ?SetString@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_ValueSet@@3QBGB@Triggers@CreativeFramework@@QEAAJPEBG0@Z @ 0x180030A74
 * Callers:
        ...
        const WCHAR *a3)
{
  ...
  _BYTE v22[24]; // [rsp+68h] [rbp-9h] BYREF
  __int64 v23; // [rsp+80h] [rbp+Fh]
  _BYTE v24[24]; // [rsp+88h] [rbp+17h] BYREF
  ...
  v18 = 0LL;
  v5 = *(_QWORD *)(a1 + 8);
  v6 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v22, &v20);
...
LABEL_5:
  ...
  v12 = v19;
  v13 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v24, v21);
