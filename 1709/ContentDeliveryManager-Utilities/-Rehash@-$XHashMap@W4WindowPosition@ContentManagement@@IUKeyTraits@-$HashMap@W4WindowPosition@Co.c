  ...
  if ( v2 != *(_DWORD *)(a1 + 24) )
  {
    if ( *(_QWORD *)(a1 + 8) )
    {
      ...
      if ( !is_mul_ok(v2, 8uLL) )
        v4 = -1LL;
      v5 = operator new[](v4, (const struct std::nothrow_t *)&TLV::nothrow);
      v6 = v5;
      if ( !v5 )
        return 2147942414LL;
      if ( v2 > 0x1FFFFFFF )
