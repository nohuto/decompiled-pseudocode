/*
 * XREFs of ?SetWasAppUnpinnedFromTaskBar@ContentManagementService@ContentManagement@@UEAAJPEAUHSTRING__@@E@Z @ 0x18002ECF0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a3)
{
  ...
  int v6; // eax
  struct WindowsInternal::CDSProperties::ICDSLocalTileProperties *v7; // rcx
  wil::details::in1diag3 *retaddr; // [rsp+38h] [rbp+0h]
  struct WindowsInternal::CDSProperties::ICDSLocalTileProperties *v10; // [rsp+40h] [rbp+8h] BYREF
  ...
  {
    LOBYTE(v4) = a3;
    v6 = (*(__int64 (__fastcall **)(struct WindowsInternal::CDSProperties::ICDSLocalTileProperties *, __int64))(*(_QWORD *)v10 + 104LL))(
           v10,
           v4);
  ...
  {
    v10 = 0LL;
    (*(void (__fastcall **)(struct WindowsInternal::CDSProperties::ICDSLocalTileProperties *))(*(_QWORD *)v7 + 16LL))(v7);
  }
