/*
 * XREFs of ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WN@Z @ 0x1800AC220
 * Callers:
 *     <none>
 * Callees:
        ...
        double a6)
{
  ...
  v14 = 0LL;
  v15 = v6 - v12;
  if ( (v10 & 0x3000) == 0x2000 && a6 * 0.5 != a6 )
  {
    if ( a6 < 0.0 )
  ...
  *(_OWORD *)v19 = *a3;
  v16 = std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Ffmt(a1, v20, 0, v10);
