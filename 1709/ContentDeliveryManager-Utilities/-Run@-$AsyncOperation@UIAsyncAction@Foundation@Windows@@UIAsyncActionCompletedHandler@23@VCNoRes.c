/*
 * XREFs of ?Run@?$AsyncOperation@UIAsyncAction@Foundation@Windows@@UIAsyncActionCompletedHandler@23@VCNoResult@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncCausalityOptions@$1?ResolveLayoutBindingsOperationName@?A0xb8965cb7@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAXXZ @ 0x18001F850
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  if ( v10 )
  {
    ...
    if ( v11 != 3 )
      goto LABEL_6;
    _InterlockedCompareExchange((volatile signed __int32 *)&v9, *(_DWORD *)(a1 - 148), v9);
    if ( *(_QWORD *)(a1 - 160) )
...
LABEL_6:
  ...
  v5 = a1 - 208;
  result = (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(v5 + 264));
  if ( (_DWORD)result == 1 )
  {
    v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, __int64))(**(_QWORD **)(v5 + 272) + 8LL))(
           *(_QWORD *)(v5 + 272),
           1LL,
           v4,
           v5 + 296);
    if ( v7 >= 0 && *(_BYTE *)(v5 + 305) )
    {
      result = (unsigned int)_InterlockedExchangeAdd((volatile signed __int32 *)(v5 + 288), 0xFFFFFFFF);
      if ( (_DWORD)result != 1 )
        return result;
      v8 = *(unsigned int *)(v5 + 292);
    }
    else
    {
      v8 = (unsigned int)v7;
