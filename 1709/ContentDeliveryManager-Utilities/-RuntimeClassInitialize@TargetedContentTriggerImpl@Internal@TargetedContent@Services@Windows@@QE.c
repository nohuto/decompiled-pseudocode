/*
 * XREFs of ?RuntimeClassInitialize@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@QEAAJW4TargetedContentKnownTrigger@2345@PEAUHSTRING__@@1111@Z @ 0x180054F70
 * Callers:
  ...
  try
  {
    ...
    *(_DWORD *)(a1 + 72) = a2;
    ...
    if ( !a4 || a4 != (char *)*v12 )
    {
      ...
      *v12 = 0LL;
      v13 = WindowsDuplicateString((HSTRING)a4, v9 + 17);
    }
    if ( v13 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
    ...
    if ( !string || string != *v14 )
    {
      ...
      *v14 = 0LL;
      v15 = WindowsDuplicateString(string, v9 + 13);
    }
    if ( v15 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
    ...
    if ( !a6 || a6 != *v16 )
    {
      ...
      *v16 = 0LL;
      v17 = WindowsDuplicateString(a6, v9 + 10);
    }
    if ( v17 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
    ...
    if ( !a7 || a7 != v9[15] )
    {
      WindowsDeleteString(v9[15]);
      v9[15] = 0LL;
      v18 = WindowsDuplicateString(a7, v9 + 15);
    }
    if ( v18 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
