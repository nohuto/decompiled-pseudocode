/*
 * XREFs of ?do_get_date@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180094E30
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v11 = std::use_facet<std::ctype<wchar_t>>(&v43);
