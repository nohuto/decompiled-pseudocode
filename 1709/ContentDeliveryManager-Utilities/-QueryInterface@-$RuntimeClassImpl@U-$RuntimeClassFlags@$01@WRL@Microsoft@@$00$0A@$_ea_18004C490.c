/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@U?$IAsyncOperationCompletedHandler@PEAU?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C490
 * Callers:
 *     ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@U?$IAsyncOperationCompletedHandler@PEAU?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C6C0 (-QueryInterface@-$RuntimeClassImpl@U-$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$_ea_18004C6C0.c)
 * Callees:
        ...
        void **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( *(_DWORD *)a2 == -1039594100
      && *(_DWORD *)(a2 + 4) == *(_DWORD *)&GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data2
      && *(_DWORD *)(a2 + 8) == *(_DWORD *)GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data4
      && *(_DWORD *)(a2 + 12) == *(_DWORD *)&GUID_c2090d8c_37d8_5c47_9581_0f17b91a0cd3.Data4[4] )
    {
      *a3 = (void *)a1;
      v4 = 0;
    }
