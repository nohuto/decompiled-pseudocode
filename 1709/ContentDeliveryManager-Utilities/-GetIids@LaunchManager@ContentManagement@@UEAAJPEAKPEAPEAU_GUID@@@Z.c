/*
 * XREFs of ?GetIids@LaunchManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18000FBB0
 * Callers:
 *     ?GetIids@LaunchManager@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180021710 (-GetIids@LaunchManager@ContentManagement@@WDI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
