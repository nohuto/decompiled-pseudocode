/*
 * XREFs of _Towlower @ 0x180098860
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x180026820 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x180026830 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800A03FC (_GetLocaleHandleByColl.c)
 *     __crtLCMapStringW_Stub @ 0x1800A04D0 (__crtLCMapStringW_Stub.c)
 */
