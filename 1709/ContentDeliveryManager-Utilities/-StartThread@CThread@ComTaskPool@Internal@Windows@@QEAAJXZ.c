/*
 * XREFs of ?StartThread@CThread@ComTaskPool@Internal@Windows@@QEAAJXZ @ 0x180004E34
 * Callers:
 ...
 * Callees:
 *     ?_StartThreadCommon@CThread@ComTaskPool@Internal@Windows@@QEAAJXZ @ 0x180004C44 (-_StartThreadCommon@CThread@ComTaskPool@Internal@Windows@@QEAAJXZ.c)
