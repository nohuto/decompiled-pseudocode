/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::ResolveLayoutBindings_::_1_::catch$3 @ 0x1800BBEA0
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CreativeFramework::TargetedContentLayoutHelpers::ResolveLayoutBindings_::_1_::catch_3(
        wil *a1,
        _DWORD *a2,
        unsigned int a3)
{
