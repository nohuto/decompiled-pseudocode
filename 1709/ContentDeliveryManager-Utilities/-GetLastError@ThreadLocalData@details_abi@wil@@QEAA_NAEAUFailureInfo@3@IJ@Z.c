/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z @ 0x180003854
 * Callers:
        ...
        int a4)
{
  ...
  v5 = *((_QWORD *)this + 3);
  v6 = v5 + 88LL * *((unsigned __int16 *)this + 17);
  v7 = *(_DWORD *)(v6 + 4);
  if ( a3 < v7 )
  {
    if ( !a4 )
...
LABEL_4:
      ...
      *(_DWORD *)a2 = *(_DWORD *)(v6 + 28);
      *((_QWORD *)a2 + 15) = *(_QWORD *)(v6 + 40);
      *((_QWORD *)a2 + 16) = *(_QWORD *)(v6 + 48);
      *((_QWORD *)a2 + 17) = *(_QWORD *)(v6 + 56);
      *((_QWORD *)a2 + 2) = *(_QWORD *)(v6 + 64);
      return 1;
    }
    v6 = 0LL;
    v9 = v5 + 88LL * *((unsigned __int16 *)this + 16);
    if ( v5 != v9 )
    {
      do
      {
