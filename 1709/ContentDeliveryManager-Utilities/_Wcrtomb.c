/*
 * XREFs of _Wcrtomb @ 0x180098BB4
 * Callers:
 *     ?do_narrow@?$ctype@G@std@@MEBADGD@Z @ 0x180026A10 (-do_narrow@-$ctype@G@std@@MEBADGD@Z.c)
 *     ?do_narrow@?$ctype@_W@std@@MEBAPEB_WPEB_W0DPEAD@Z @ 0x180026A70 (-do_narrow@-$ctype@_W@std@@MEBAPEB_WPEB_W0DPEAD@Z.c)
