/*
 * XREFs of ??_E?$COperationLambda0@V?$CCallAsyncLambda@V_lambda_d740ccd9d37e805433cbe5cb5e47d6b6_@@@Internal@Windows@@V?$CBasicResult@E$0A@@23@@Internal@Windows@@UEAAPEAXI@Z @ 0x18006F880
 * Callers:
 *     <none>
 * Callees:
