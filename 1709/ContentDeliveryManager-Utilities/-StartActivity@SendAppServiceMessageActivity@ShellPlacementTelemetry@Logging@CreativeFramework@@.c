/*
 * XREFs of ?StartActivity@SendAppServiceMessageActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXW4TriggerId@Triggers@4@@Z @ 0x1800281B8
 * Callers:
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)Local > 5u && (*((_QWORD *)Local + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)Local + 3) )
    {
      ...
      LODWORD(Local) = TlgWrite(v9, &unk_18013B558, (LPCGUID)(v11 + 8), v12, 4u, &pData);
    }
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
