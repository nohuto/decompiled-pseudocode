/*
 * XREFs of _CRT_INIT @ 0x1800B34E4
 * Callers:
 *     __DllMainCRTStartup @ 0x1800B3760 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800B43B3 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800B4410 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800B4560 (_initterm_0.c)
