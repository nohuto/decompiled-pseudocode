...
_QWORD *__fastcall CreativeFramework::Actions::MakeSetLockScreenHotspotsService(_QWORD *a1, __int64 a2, __int64 **a3)
{
  char v5; // bl
  ...
  if ( v6 )
  {
    ...
    if ( (unsigned __int64)v10[3] >= 8 )
      v10 = (void **)*v10;
    v11 = (void (__fastcall ***)(_QWORD, __int64))CreativeFramework::Actions::SetLockScreenHotspotsService::SetLockScreenHotspotsService(
                                                    v6,
                                                    (wchar_t *)v10,
                                                    v9,
                                                    v8,
