/*
 * XREFs of ?get_PackageFamilyName@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180087F60
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = (*(__int64 (__fastcall **)(_QWORD, HSTRING *))(**((_QWORD **)this + 10) + 72LL))(*((_QWORD *)this + 10), a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
