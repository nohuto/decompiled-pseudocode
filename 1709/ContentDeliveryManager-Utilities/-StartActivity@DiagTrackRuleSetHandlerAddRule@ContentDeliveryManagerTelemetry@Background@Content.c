/*
 * XREFs of ?StartActivity@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_WIPEBD@Z @ 0x180069630
 * Callers:
        ...
        const char *a4)
{
  ...
  *(_DWORD *)v7 = 1;
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    TlgWrite(v10, &unk_18013E2A5, (LPCGUID)(v16 + 8), v17, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
