/*
 * XREFs of ?get_ScoreName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x1800558C0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = WindowsDuplicateString(this[22], a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
