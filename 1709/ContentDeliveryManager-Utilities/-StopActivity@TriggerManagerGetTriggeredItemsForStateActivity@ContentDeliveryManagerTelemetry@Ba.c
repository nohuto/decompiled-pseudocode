/*
 * XREFs of ?StopActivity@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x1800575B0
 * Callers:
 *     <none>
 * Callees:
        ...
        ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity *this)
{
  ...
  EVENT_DATA_DESCRIPTOR v84; // [rsp+190h] [rbp+90h] BYREF
  PSRWLOCK *v85; // [rsp+1B0h] [rbp+B0h]
  __int64 v86; // [rsp+1B8h] [rbp+B8h]
  DWORD *v87; // [rsp+1C0h] [rbp+C0h]
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v82 = v10 + 1;
      v83 = 0;
      TlgWrite(v6, &unk_18013DA6F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v33 = CurrentThreadId;
      v87 = &v33;
      TlgWrite(v26, &unk_18013D7A4, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v84);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
