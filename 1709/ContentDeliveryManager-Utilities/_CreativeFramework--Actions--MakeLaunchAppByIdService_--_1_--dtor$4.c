/*
 * XREFs of _CreativeFramework::Actions::MakeLaunchAppByIdService_::_1_::dtor$4 @ 0x1800BAD4F
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreativeFramework::Actions::MakeLaunchAppByIdService_::_1_::dtor_4(__int64 a1, __int64 a2)
{
  __int64 result; // rax
