/*
 * XREFs of ??$MakeAndInitialize@VSpatialInputControllerHeadEventHandler@@V1@$$V@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@VSpatialInputControllerHeadEventHandler@@@WRL@Microsoft@@@012@@Z @ 0x18009825C
 * Callers:
        ...
        volatile signed __int32 **a1)
{
  ...
  *a1 = 0LL;
  v4 = (char *)operator new(0x80uLL, (const struct std::nothrow_t *)&std::nothrow);
  v5 = v4;
  if ( v4 )
  {
    v6 = Microsoft::WRL::Details::ModuleBase::module_;
    *((_DWORD *)v4 + 3) = 1;
    *(_QWORD *)v4 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,IHeadEventHandler>::`vftable';
    if ( v6 )
    ...
    *((_QWORD *)v5 + 9) = 0LL;
    InitializeCriticalSectionEx((LPCRITICAL_SECTION)v5 + 2, 0, 0);
    *((_QWORD *)v5 + 15) = 0LL;
