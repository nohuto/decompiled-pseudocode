/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_IMPCInputProviderBase__std::allocator_Microsoft::WRL::ComPtr_IMPCInputProviderBase_____::emplace_back_Microsoft::WRL::ComPtr_IMPCInputProviderBase____::_1_::catch$107 @ 0x1800CF08F
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_IMPCInputProviderBase__std::allocator_Microsoft::WRL::ComPtr_IMPCInputProviderBase_____::emplace_back_Microsoft::WRL::ComPtr_IMPCInputProviderBase____::_1_::catch_107(
        __int64 a1,
        unsigned __int64 *a2)
{
  _QWORD *v3; // rbx
  ...
  v3 = (_QWORD *)a2[16];
  v4 = (__int64 *)std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[a2[17]]);
