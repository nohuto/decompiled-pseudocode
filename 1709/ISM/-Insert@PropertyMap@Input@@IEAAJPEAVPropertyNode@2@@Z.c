/*
 * XREFs of ?Insert@PropertyMap@Input@@IEAAJPEAVPropertyNode@2@@Z @ 0x180031A54
 * Callers:
 ...
 * Callees:
 *     ??$_Buynode@AEBU_GUID@@AEAPEAVPropertyNode@Input@@@?$_Tree_comp_alloc@V?$_Tmap_traits@U_GUID@@PEAVPropertyNode@Input@@U?$KeyCompareTrait@U_GUID@@@3@V?$allocator@U?$pair@$$CBU_GUID@@PEAVPropertyNode@Input@@@std@@@std@@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBU_GUID@@PEAVPropertyNode@Input@@@std@@PEAX@1@AEBU_GUID@@AEAPEAVPropertyNode@Input@@@Z @ 0x180032ABC (--$_Buynode@AEBU_GUID@@AEAPEAVPropertyNode@Input@@@-$_Tree_comp_alloc@V-$_Tmap_traits@U_GUID@@PE.c)
