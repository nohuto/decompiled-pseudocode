/*
 * XREFs of ?StartActivity@CloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x1800B0FD8
 * Callers:
...
int __fastcall HolographicDriverClientTrace::CloseHolographicDevice::StartActivity(
        __int64 a1,
        const wchar_t *a2,
        int a3,
        __int64 a4)
{
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
    ...
    LODWORD(Local) = TlgWrite(v12, &unk_1800F1444, (LPCGUID)(v17 + 8), v18, 6u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
