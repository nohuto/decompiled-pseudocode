/*
 * XREFs of _ViewHierarchy::GetAllAncestors_::_1_::catch$104 @ 0x1800D0810
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall ViewHierarchy::GetAllAncestors_::_1_::catch_104(__int64 a1, __int64 a2)
{
