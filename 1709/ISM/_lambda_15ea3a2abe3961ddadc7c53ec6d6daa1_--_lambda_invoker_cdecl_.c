/*
 * XREFs of _lambda_15ea3a2abe3961ddadc7c53ec6d6daa1_::_lambda_invoker_cdecl_ @ 0x18003DB90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall lambda_15ea3a2abe3961ddadc7c53ec6d6daa1_::_lambda_invoker_cdecl_(ControllerProcessor *this)
{
  ...
  v2 = 0;
  v3 = 0;
  v4 = (_DWORD *)((char *)this + 328);
  v5 = (_DWORD *)((char *)this + 324);
  ...
  CursorAttraction::ApplyCursorAttraction(
    (ControllerProcessor *)((char *)this + 3892),
    &pt,
    (const struct tagRECT *)((char *)this + 324));
  v6 = pt;
  if ( (*((_BYTE *)this + 320) & 8) == 0 || PtInRect((const RECT *)((char *)this + 360), pt) )
  {
    if ( *v5 != v6.x || *v4 != pt.y )
    {
      ...
      if ( v7 < 0 )
      {
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(v8, &MinInput_Warning_CheckResult, 12, 2736, v7);
