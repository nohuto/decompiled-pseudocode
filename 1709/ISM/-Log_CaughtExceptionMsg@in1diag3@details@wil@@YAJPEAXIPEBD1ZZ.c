/*
 * XREFs of ?Log_CaughtExceptionMsg@in1diag3@details@wil@@YAJPEAXIPEBD1ZZ @ 0x180084938
 * Callers:
 *     _ViewHierarchy::GetAllAncestors_::_1_::catch$104 @ 0x1800D0810 (_ViewHierarchy--GetAllAncestors_--_1_--catch$104.c)
 * Callees:
