/*
 * XREFs of ?SetValueForKey@?$FixedSizeMap@UCursorId@@PEAVMobileCursor@@$0DC@@@QEAAJAEBUCursorId@@AEBQEAVMobileCursor@@@Z @ 0x180030758
 * Callers:
...
__int64 __fastcall FixedSizeMap<CursorId,MobileCursor *,50>::SetValueForKey(__int64 a1, int *a2, _QWORD *a3)
{
  int v3; // edi
  unsigned int v4; // ebx
  _DWORD *v5; // r9
  ...
  if ( *a2 == v8 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v9 = 152;
LABEL_4:
      McTemplateU0qqq(a1, &MinInput_Warning_CheckResult, 0, v9, v4);
    }
  }
  else
  {
