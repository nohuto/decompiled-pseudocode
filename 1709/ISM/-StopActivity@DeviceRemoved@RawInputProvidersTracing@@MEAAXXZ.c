/*
 * XREFs of ?StopActivity@DeviceRemoved@RawInputProvidersTracing@@MEAAXXZ @ 0x18008DEF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RawInputProvidersTracing::DeviceRemoved::StopActivity(RawInputProvidersTracing::DeviceRemoved *this)
{
  int *v1; // rbx
  int v3; // eax
  int *v4; // rbx
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      ...
      v81 = v9 + 1;
      v82 = 0;
      TlgWrite(v6, &unk_1800F00D9, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 4u )
    {
      ...
      v32 = CurrentThreadId;
      v86 = &v32;
      TlgWrite(v26, &unk_1800F009B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v83);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
