/*
 * XREFs of ?Initialize@HIDDeviceCollection@@QEAAJKQEAU_RIM_USAGE_ANDPAGE@@KKPEAPEAX@Z @ 0x18009C844
 * Callers:
  ...
  *((_QWORD *)this + 343) = v10;
  if ( !v10 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 90, 14);
    goto LABEL_20;
  }
  memset(v10, 0, 4 * v8);
  *((_DWORD *)this + 688) = a4;
...
LABEL_19:
  ...
  *((_DWORD *)this + 8) = 32;
  ...
  if ( v20 < 0 )
  {
    ...
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        McTemplateU0qqq(v19, &MinInput_Warning_CheckResult, 0, 114, v12);
      goto LABEL_20;
    }
  }
  if ( !*((_QWORD *)this + 10) )
