/*
 * XREFs of ?Create@TouchDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x18008ADF4
 * Callers:
...
__int64 __fastcall TouchDeviceCollection::Create(
        struct IRawInputClient *a1,
        struct IRawInputProvider *a2,
        void **a3,
        struct TouchDeviceCollection **a4)
{
...
LABEL_22:
  ...
  *(_QWORD *)v9 = &TouchDeviceCollection::`vftable';
  ...
  *((_DWORD *)v9 + 693) = 0;
  *((_QWORD *)v9 + 3) = a2;
  v11 = HIDDeviceCollection::Initialize(v9, 0x10u, 0x6F0u, a3);
  if ( v11 >= 0 )
    goto LABEL_13;
  v14 = Microsoft_OneCore_MinInputEnableBits;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    McTemplateU0qqq(v13, &MinInput_Warning_CheckResult, 0, 83, v11);
LABEL_13:
    v14 = Microsoft_OneCore_MinInputEnableBits;
  }
  if ( v11 >= 0 )
