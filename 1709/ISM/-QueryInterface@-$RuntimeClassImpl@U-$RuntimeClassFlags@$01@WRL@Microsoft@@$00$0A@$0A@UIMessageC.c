/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIMessageConversationHost@@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800816C0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a3 = 0LL;
  ...
  else
  {
    if ( *a2 == 1845159642
      ...
      && a2[3] == *(_DWORD *)&GUID_6dfae6da_7941_4c1e_a565_c18161b30018.Data4[4] )
    {
      v5 = 1;
      *a3 = a1;
    }
