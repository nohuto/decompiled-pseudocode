/*
 * XREFs of ?ControllerNodeTrackingSkipped_@RawInputProvidersTracing@@QEAAXK@Z @ 0x18008F29C
 * Callers:
...
void __fastcall RawInputProvidersTracing::ControllerNodeTrackingSkipped_(RawInputProvidersTracing *this, int a2)
{
  __int64 v2; // rcx
  ...
  if ( *(_DWORD *)v2 > 4u && (*(_BYTE *)(v2 + 16) & 2) != 0 && (*(_QWORD *)(v2 + 24) & 2LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v4 = &v7;
    v5 = 4;
    TlgWrite((TraceLoggingHProvider)v2, &unk_1800EFA25, 0LL, 0LL, 3u, &pData);
  }
}
