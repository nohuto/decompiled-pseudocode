/*
 * XREFs of ?GetViewId@MPCSharedWorldInputTarget@@UEAAJPEAK@Z @ 0x1800AD780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::GetViewId(MPCSharedWorldInputTarget *this, unsigned int *a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
