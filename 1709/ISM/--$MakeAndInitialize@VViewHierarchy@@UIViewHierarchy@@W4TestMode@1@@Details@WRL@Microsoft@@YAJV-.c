/*
 * XREFs of ??$MakeAndInitialize@VViewHierarchy@@UIViewHierarchy@@W4TestMode@1@@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIViewHierarchy@@@WRL@Microsoft@@@012@$$QEAW4TestMode@ViewHierarchy@@@Z @ 0x180084608
 * Callers:
        ...
        unsigned int *a2)
{
  ...
  *a1 = 0LL;
  v5 = (ViewHierarchy *)operator new(0xC0uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v5 )
  {
    v7 = ViewHierarchy::ViewHierarchy(v5);
    v6 = (*(__int64 (__fastcall **)(ViewHierarchy *, _QWORD))(*(_QWORD *)v7 + 64LL))(v7, *a2);
    if ( v6 >= 0 )
      v6 = (**(__int64 (__fastcall ***)(ViewHierarchy *, GUID *, __int64 *))v7)(
             v7,
