/*
 * XREFs of ?LogMPCSpatialControllerInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x18005F4E4
 * Callers:
...
void __fastcall ISMTracing::LogMPCSpatialControllerInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  const bool *v16; // [rsp+90h] [rbp+17h]
  __int64 v17; // [rsp+98h] [rbp+1Fh]
  char *v18; // [rsp+A0h] [rbp+27h]
  ...
  if ( (*((_BYTE *)a1 + 700) & 7) != 0 )
  {
    ...
    if ( *(_DWORD *)v4 > 5u && (*(_BYTE *)(v4 + 16) & 1) != 0 && (*(_QWORD *)(v4 + 24) & 1LL) == *(_QWORD *)(v4 + 24) )
    {
      ...
      v19 = 4LL;
      v21 = 4LL;
      TlgWrite((TraceLoggingHProvider)v4, &unk_1800EEEC9, 0LL, 0LL, 8u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      v19 = 4LL;
      v21 = 4LL;
      TlgWrite((TraceLoggingHProvider)v5, &unk_1800EEC0D, 0LL, 0LL, 8u, &pData);
    }
  }
}
