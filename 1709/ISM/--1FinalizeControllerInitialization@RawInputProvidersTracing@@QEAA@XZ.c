/*
 * XREFs of ??1FinalizeControllerInitialization@RawInputProvidersTracing@@QEAA@XZ @ 0x18008DCD0
 * Callers:
 *     _SpatialInputControllerCollection::FinalizeControllerInitialization_::_1_::dtor$0 @ 0x1800D0E3B (_SpatialInputControllerCollection--FinalizeControllerInitialization_--_1_--dtor$0.c)
 * Callees:
...
void __fastcall RawInputProvidersTracing::FinalizeControllerInitialization::~FinalizeControllerInitialization(
        RawInputProvidersTracing::FinalizeControllerInitialization *this)
{
  volatile signed __int32 *v2; // rcx
  char *v3; // rdi

  *(_QWORD *)this = &RawInputProvidersTracing::FinalizeControllerInitialization::`vftable';
  ...
  wil::details::ThreadFailureCallbackHolder::~ThreadFailureCallbackHolder((RawInputProvidersTracing::FinalizeControllerInitialization *)((char *)this + 8));
}
