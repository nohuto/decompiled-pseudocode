/*
 * XREFs of ?ParsingInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKPEB_WGG_N1GGG1EIKAEBUPoseData@2@2@Z @ 0x1800C2CEC
 * Callers:
        ...
        const struct SpatialInteractionDevices::PoseData *a18)
{
  ...
  const wchar_t *v34; // [rsp+88h] [rbp-80h]
    ...
    && (*((_QWORD *)v20 + 3) & 0x400000000000LL) == *((_QWORD *)v20 + 3) )
  {
    ...
    v68 = v74;
    v69 = 2 * v22 + 2;
    TlgWrite(v20, &unk_1800F26E6, 0LL, 0LL, 0x15u, &pData);
  }
}
