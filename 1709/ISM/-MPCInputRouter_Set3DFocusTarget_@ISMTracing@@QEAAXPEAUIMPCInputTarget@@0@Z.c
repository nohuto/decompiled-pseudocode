/*
 * XREFs of ?MPCInputRouter_Set3DFocusTarget_@ISMTracing@@QEAAXPEAUIMPCInputTarget@@0@Z @ 0x1800A8588
 * Callers:
...
LABEL_18:
  ...
  v30 = 2 * v10 + 2;
  v31 = 0;
  TlgWrite((TraceLoggingHProvider)v6, &unk_1800F0A34, 0LL, 0LL, 8u, &pData);
}
