/*
 * XREFs of ?GetThreadIdFromViewId@ViewHelper@@SAKPEAUIViewHierarchy@@I@Z @ 0x1800357C0
 * Callers:
...
__int64 __fastcall ViewHelper::GetThreadIdFromViewId(struct IViewHierarchy *a1, unsigned int a2)
{
  ...
  if ( v13 )
  {
    ...
    if ( WindowA >= 0 )
    {
      ...
      if ( v14 )
      {
        v8 = (*(__int64 (__fastcall **)(__int64 *, unsigned int *))(*v14 + 112))(v14, &v12);
        if ( v8 < 0 )
        {
    ...
    else
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        McTemplateU0qqq(v5, &MinInput_Warning_CheckResult, 0, 171, WindowA);
      if ( !v14 )
        goto LABEL_14;
      v6 = *v14;
    }
