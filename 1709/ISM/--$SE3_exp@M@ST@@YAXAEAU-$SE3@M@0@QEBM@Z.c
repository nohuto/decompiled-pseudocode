/*
 * XREFs of ??$SE3_exp@M@ST@@YAXAEAU?$SE3@M@0@QEBM@Z @ 0x1800C90F8
 * Callers:
 ...
 * Callees:
 *     ??$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z @ 0x1800C9694 (--$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z.c)
