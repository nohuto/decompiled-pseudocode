/*
 * XREFs of ?LogMPCRawInputReport_@ISMTracing@@QEAAXPEAUInputInfo@@@Z @ 0x180066568
 * Callers:
...
void __fastcall ISMTracing::LogMPCRawInputReport_(ISMTracing *this, struct InputInfo *a2)
{
  ...
  {
    if ( ((*((_DWORD *)a2 + 174) - 6) & 0xFFFFFFFD) != 0 )
    {
      ...
      if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 1) != 0 && (*(_QWORD *)(v4 + 24) & 1LL) == *(_QWORD *)(v4 + 24) )
      {
        ...
        v20 = 4LL;
        v22 = 4LL;
        TlgWrite((TraceLoggingHProvider)v4, &unk_1800EF3D3, 0LL, 0LL, 8u, &pData);
      }
    }
    else
    {
      ...
      if ( *(_DWORD *)v5 > 5u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
      {
        ...
        v20 = 4LL;
        v22 = 4LL;
        TlgWrite((TraceLoggingHProvider)v5, &unk_1800EF360, 0LL, 0LL, 8u, &pData);
      }
    }
  }
}
