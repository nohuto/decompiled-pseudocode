/*
 * XREFs of _std::_Tree_comp_alloc_std::_Tmap_traits_unsigned_int_MPCProcessor::InputData_std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__MPCProcessor::InputData____0___::_Buyheadnode_::_1_::catch$24 @ 0x1800CED5B
 * Callers:
 *     <none>
 * Callees:
