/*
 * XREFs of ?OnDeviceAttach@PTPDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x18008A800
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( DeviceId >= 0 )
    {
      ...
      else
      {
        ...
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(v14, &MinInput_Warning_CheckResult, 0, 317, v13);
      }
      if ( v9 >= 0 )
      {
        *(_OWORD *)((char *)*a3 + 44) = *((_OWORD *)v11 + 8);
      }
      else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      {
        McTemplateU0qqq(v14, &MinInput_Warning_CheckResult, 0, 106, v9);
      }
    }
    else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
