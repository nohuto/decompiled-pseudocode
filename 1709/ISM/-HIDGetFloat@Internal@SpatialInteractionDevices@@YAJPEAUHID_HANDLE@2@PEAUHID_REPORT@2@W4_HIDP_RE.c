/*
 * XREFs of ?HIDGetFloat@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@2@PEAUHID_REPORT@2@W4_HIDP_REPORT_TYPE@@GGGGPEAM@Z @ 0x18007CC74
 * Callers:
...
LABEL_4:
  ...
  *a8 = 0.0;
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      v20 = HidP_GetUsageValue(HidP_Input, v15, *(_WORD *)(v26 + 6), v14, &UsageValue, this[12], Report, *(_DWORD *)a2);
