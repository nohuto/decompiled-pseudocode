/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x18003B630
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v11 && *v11 )
  {
    ...
    if ( a5 )
    {
        ...
        && (*(_QWORD *)(v13 + 24) & 2LL) == *(_QWORD *)(v13 + 24) )
      {
        ...
        v54 = 4LL;
        v56 = 8LL;
        TlgWrite((TraceLoggingHProvider)v13, &unk_1800ED9C4, 0LL, 0LL, 9u, &pData);
      }
      if ( *((_BYTE *)a2 + 4) == 1 )
      {
        if ( v8 )
        {
            ...
            && (*(_QWORD *)(v14 + 24) & 0xALL) == *(_QWORD *)(v14 + 24) )
          {
            ...
            v54 = 4LL;
            v56 = 8LL;
            TlgWrite((TraceLoggingHProvider)v14, &unk_1800EDD03, 0LL, 0LL, 9u, &pData);
          }
        }
      }
    }
    else
    {
      ...
      if ( a6 )
      {
          ...
          && (*(_QWORD *)(v16 + 24) & 4LL) == *(_QWORD *)(v16 + 24) )
        {
          ...
          v56 = 1LL;
          v58 = 8LL;
          TlgWrite((TraceLoggingHProvider)v16, &unk_1800EDC7B, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( a3 )
      {
          ...
          && (*(_QWORD *)(v17 + 24) & 1LL) == *(_QWORD *)(v17 + 24) )
        {
          ...
          v83 = 0;
          v85 = 4LL;
          TlgWrite((TraceLoggingHProvider)v17, &unk_1800EDA35, 0LL, 0LL, 0x14u, &pData);
        }
      }
    }
  }
