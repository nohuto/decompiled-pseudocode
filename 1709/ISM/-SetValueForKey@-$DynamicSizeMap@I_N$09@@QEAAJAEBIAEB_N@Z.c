/*
 * XREFs of ?SetValueForKey@?$DynamicSizeMap@I_N$09@@QEAAJAEBIAEB_N@Z @ 0x180016794
 * Callers:
...
__int64 __fastcall DynamicSizeMap<unsigned int,bool,10>::SetValueForKey(__int64 a1, _DWORD *a2, _BYTE *a3)
{
  unsigned int v3; // ebx
  ...
  if ( *a2 == *(_DWORD *)(a1 + 16) )
  {
    ...
    v10 = 153;
LABEL_4:
    McTemplateU0qqq(a1, &MinInput_Warning_CheckResult, 4, v10, v9);
LABEL_5:
  ...
  do
  {
    ...
    if ( v14 == *a2 )
    {
      LOBYTE(v13[2 * (unsigned int)v12 + 1]) = *a3;
      return v3;
    }
...
LABEL_16:
  if ( *(_DWORD *)(a1 + 12) == (_DWORD)v11 )
  {
    ...
    *(_QWORD *)a1 = v17;
    if ( !v17 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      McTemplateU0qqq(v18, &MinInput_Warning_CheckResult, 4, 387, 14);
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      v10 = 185;
      goto LABEL_4;
  ...
  v3 = -2147467259;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 4, 180, 5);
  return v3;
}
