...
LABEL_114:
  v36 = a3[5];
  if ( v36 )
    (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v36 + 16LL))(v36, v11);
  v37 = a3[4];
  if ( v37 )
