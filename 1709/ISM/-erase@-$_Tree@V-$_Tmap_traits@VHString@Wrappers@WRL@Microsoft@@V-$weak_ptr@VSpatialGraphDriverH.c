...
LABEL_81:
  ...
  if ( v36 && _InterlockedExchangeAdd(v36 + 3, 0xFFFFFFFF) == 1 )
    (*(void (__fastcall **)(volatile signed __int32 *, __int64 *))(*(_QWORD *)v36 + 8LL))(v36, v11);
