/*
 * XREFs of ?MPCSixDofProcessorSourceLost_@ISMTracing@@QEAAXPEAUIInputTarget@@PEAUInputInfo@@@Z @ 0x18004CBD4
 * Callers:
...
void __fastcall ISMTracing::MPCSixDofProcessorSourceLost_(
        ISMTracing *this,
        ...
        struct InputInfo *a3)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      v34 = 4;
      v37 = 4;
      TlgWrite((TraceLoggingHProvider)v6, &unk_1800EE29B, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
