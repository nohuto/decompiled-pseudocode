/*
 * XREFs of ?StabilizeTargetRay@MPCInputProviderBase@@UEAAXPEAUInputInfo@@@Z @ 0x18005FF20
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  RayStabilizer::StabilizeInput((MPCInputProviderBase *)((char *)this + 416), a2, a3, a4);
}
