/*
 * XREFs of ?OnRIMDeferredRead@RIMDeviceCollection@@CAJPEAXK0@Z @ 0x180089630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RIMDeviceCollection::OnRIMDeferredRead(RIMDeviceCollection *a1, int a2, void *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)a1, &MinInput_Warning_CheckResult, 2, 514, 255);
  }
  else
  {
    *((_BYTE *)a1 + 2736) = 0;
    ...
    if ( InputReportFromRIM < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(v4, &MinInput_Warning_CheckResult, 2, 510, InputReportFromRIM);
  }
  return v5;
}
