/*
 * XREFs of ?ProcessTap@PTPProcessor@@AEAAJPEAUInputInfo@@@Z @ 0x18006EF74
 * Callers:
  ...
  if ( (v2 & 1) != 0 )
  {
    ...
    *v6 = *(_OWORD *)v4;
    ...
    if ( v10 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v12 = 600;
LABEL_14:
      McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 11, v12, v10);
    }
  }
  else if ( (v2 & 0x800) != 0 )
  {
