/*
 * XREFs of _DWMHardwareCursor::UpdateBitmapSource_::_1_::dtor$7 @ 0x1800CDC34
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DWMHardwareCursor::UpdateBitmapSource_::_1_::dtor_7(__int64 a1, __int64 a2)
{
