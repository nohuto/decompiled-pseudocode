/*
 * XREFs of ??$MakeAndInitialize@V?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIInspectable@@@WRL@Microsoft@@@012@@Z @ 0x1800BD4C4
 * Callers:
        ...
        __int64 *a1)
{
  ...
  *a1 = 0LL;
  v3 = operator new(0x90uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v3 )
  {
    ...
    v5[80] = (unsigned int)RegistryHelpers::GetDwordWithDefault(
                             v6,
