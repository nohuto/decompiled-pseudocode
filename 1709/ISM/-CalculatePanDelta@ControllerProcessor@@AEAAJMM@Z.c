/*
 * XREFs of ?CalculatePanDelta@ControllerProcessor@@AEAAJMM@Z @ 0x18003FCE8
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculatePanDelta(ControllerProcessor *this, float a2, float a3)
{
  ...
  if ( v6 > 0.00000011920929 || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(a2) & _xmm) > 0.00000011920929 )
  {
    ...
    if ( v8 == 0.0
      ...
      || *(float *)&dword_18010F048 >= v10
      || v10 >= (float)(1.0 / *(float *)&dword_18010F048) )
    {
    ...
    v12 = v9 + *((float *)this + 97);
    *((float *)this + 96) = v8 + *((float *)this + 96);
    *((float *)this + 97) = v12;
  }
  return 0LL;
}
