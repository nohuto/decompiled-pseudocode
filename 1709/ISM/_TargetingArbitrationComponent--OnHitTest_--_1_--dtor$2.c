/*
 * XREFs of _TargetingArbitrationComponent::OnHitTest_::_1_::dtor$2 @ 0x1800D1780
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall TargetingArbitrationComponent::OnHitTest_::_1_::dtor_2(__int64 a1, __int64 a2)
{
