/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_FIREVIEWHITTEST_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_FIREVIEWHITTEST_MESSAGE@@@Z@std@@@Z @ 0x18001D8B0
 * Callers:
...
void __fastcall KernelInputConnection<_MIT_FIREVIEWHITTEST_MESSAGE>::Initialize(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
...
LABEL_25:
  ...
  v24 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall *)(), _QWORD *, _QWORD, _QWORD *))(*(_QWORD *)v23 + 80LL))(
          v23,
          KernelInputConnection<_MIT_FIREVIEWHITTEST_MESSAGE>::s_OnKernelInputEventStatic,
          a1,
          *a1,
          a1 + 2);
  if ( v24 < 0 )
  ...
  v26 = MITCoreMsgKOpenConnectionTo(5LL, a1 + 3);
  if ( v26 < 0 )
