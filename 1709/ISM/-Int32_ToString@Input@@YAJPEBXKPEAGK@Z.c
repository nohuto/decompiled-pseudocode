/*
 * XREFs of ?Int32_ToString@Input@@YAJPEBXKPEAGK@Z @ 0x180034F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Input::Int32_ToString(Input *this, const void *a2, char *a3, unsigned __int16 *a4)
{
  __int64 v4; // rbx
  ...
  if ( Input::NullValue_ToString(this, a3, (unsigned __int16 *)(unsigned int)a4) )
    return 0LL;
  return StringCchPrintfW((wchar_t *)a3, v4, L"%d", *(unsigned int *)this);
}
