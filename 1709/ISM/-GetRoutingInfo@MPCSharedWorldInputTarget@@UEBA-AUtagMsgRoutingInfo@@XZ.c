/*
 * XREFs of ?GetRoutingInfo@MPCSharedWorldInputTarget@@UEBA?AUtagMsgRoutingInfo@@XZ @ 0x1800ACF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::GetRoutingInfo(__int64 a1, __int64 a2)
{
  int v3; // eax
  __int64 v4; // rcx
