/*
 * XREFs of ?GetBounds@DisplayBinding@@UEAAJPEAJ0@Z @ 0x1800234B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DisplayBinding::GetBounds(DisplayBinding *this, int *a2, int *a3)
{
         ...
         &v13) == -2089336820 )
  {
    ...
    {
      McTemplateU0qqq(0LL, &MinInput_Warning_CheckResult, 0, 176, v10);
    }
    return v10;
  }
  ...
  else
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v8 = 182;
LABEL_6:
      McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 0, v8, 122);
    }
  }
  return v7;
}
