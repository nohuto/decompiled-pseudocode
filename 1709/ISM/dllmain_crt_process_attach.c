/*
 * XREFs of dllmain_crt_process_attach @ 0x1800C9E20
 * Callers:
 *     dllmain_crt_dispatch @ 0x1800C9DD0 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800CA210 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_dllmain_after_initialize_c @ 0x1800CA284 (__scrt_dllmain_after_initialize_c.c)
 *     __scrt_dllmain_before_initialize_c @ 0x1800CA2B8 (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x1800CA3B4 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800CA4E0 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800CA57C (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800CA634 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x1800CA644 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x1800CA790 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800CA9D0 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800CA9D6 (_initterm_e_0.c)
