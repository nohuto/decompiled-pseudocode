/*
 * XREFs of ?UpdateCoordinateSystemForTick@MPCSpatialGestureRecognizerHandler@@AEAAJ_J@Z @ 0x180065C44
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( !*((_QWORD *)this + 14) )
  {
    ...
    v12 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v10 + 96LL))(v10, (char *)this + 112);
    if ( v12 < 0 )
      wil::details::in1diag3::_FailFast_Hr(
        retaddr,
        (void *)0x270,
