/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18003B158
 * Callers:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const wchar_t *v42; // [rsp+C8h] [rbp-40h]
  ...
  const wchar_t *v55; // [rsp+118h] [rbp+10h]
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
    ...
    v20 = (const wchar_t *)*((_QWORD *)a2 + 14);
    v61 = v5 + 1;
    LODWORD(v5) = 0;
    v60 = v19;
    v62 = 0;
    ...
    v71 = v5 + 1;
    v72 = 0;
    TlgWrite(v2, &unk_1800EDB55, 0LL, 0LL, 0x13u, &pData);
  }
}
