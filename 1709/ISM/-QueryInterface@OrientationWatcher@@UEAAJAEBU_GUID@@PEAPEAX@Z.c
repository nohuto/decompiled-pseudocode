/*
 * XREFs of ?QueryInterface@OrientationWatcher@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006DD50
 * Callers:
 *     ?QueryInterface@OrientationWatcher@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006DEF0 (-QueryInterface@OrientationWatcher@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
