/*
 * XREFs of ?EnableInputInjection@LegacyInjectionRawInputProvider@@UEAAJG_N@Z @ 0x180086810
 * Callers:
 *     <none>
 * Callees:
        ...
        char a3)
{
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 212, 1);
    return v3;
  }
  if ( (a2 & 2) == 0 )
    goto LABEL_25;
      ...
      if ( !*((_QWORD *)this + 10) )
      {
        ...
        if ( InjectionDevices < 0 )
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          {
            v8 = 223;
LABEL_44:
            McTemplateU0qqq((__int64)this, &MinInput_Warning_CheckResult, 0, v8, InjectionDevices);
            return v3;
          }
          return v3;
        }
