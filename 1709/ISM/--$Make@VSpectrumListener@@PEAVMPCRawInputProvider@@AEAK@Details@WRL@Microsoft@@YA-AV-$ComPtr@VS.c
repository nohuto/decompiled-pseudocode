/*
 * XREFs of ??$Make@VSpectrumListener@@PEAVMPCRawInputProvider@@AEAK@Details@WRL@Microsoft@@YA?AV?$ComPtr@VSpectrumListener@@@12@$$QEAPEAVMPCRawInputProvider@@AEAK@Z @ 0x18006788C
 * Callers:
...
SpectrumListener **__fastcall Microsoft::WRL::Details::Make<SpectrumListener,MPCRawInputProvider *,unsigned long &>(
        SpectrumListener **a1,
        ...
        unsigned int *a3)
{
  ...
  *a1 = 0LL;
  v6 = (SpectrumListener *)operator new(0x48uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v6 )
  {
