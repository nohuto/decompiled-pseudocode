/*
 * XREFs of ??1?$unique_ptr@VMPCCursorManager@@U?$default_delete@VMPCCursorManager@@@std@@@std@@QEAA@XZ @ 0x180059878
 * Callers:
 *     _MPCHolographicInputManager::MPCHolographicInputManager_::_1_::dtor$8 @ 0x1800CEEEB (_MPCHolographicInputManager--MPCHolographicInputManager_--_1_--dtor$8.c)
 * Callees:
