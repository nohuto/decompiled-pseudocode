/*
 * XREFs of ?TrackPosition@MPCGestureCancelTracker@@QEAAXAEBUfloat3@Numerics@Foundation@Windows@@@Z @ 0x180060ACC
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::float3 *a2)
{
  if ( !*((_BYTE *)this + 16)
    && *((_BYTE *)this + 17)
    && sqrtf_0(
         (float)((float)((float)(*(float *)a2 - *(float *)this) * (float)(*(float *)a2 - *(float *)this))
               + (float)((float)(*((float *)a2 + 1) - *((float *)this + 1))
