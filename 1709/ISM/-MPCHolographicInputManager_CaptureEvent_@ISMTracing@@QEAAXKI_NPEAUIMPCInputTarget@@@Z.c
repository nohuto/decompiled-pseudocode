/*
 * XREFs of ?MPCHolographicInputManager_CaptureEvent_@ISMTracing@@QEAAXKI_NPEAUIMPCInputTarget@@@Z @ 0x180055E98
 * Callers:
  ...
  if ( v7 )
  {
    if ( *v7 )
    {
      ...
      if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
      {
        ...
        v31 = 2 * v16 + 2;
        v32 = 0;
        TlgWrite((TraceLoggingHProvider)v8, &unk_1800EE810, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
