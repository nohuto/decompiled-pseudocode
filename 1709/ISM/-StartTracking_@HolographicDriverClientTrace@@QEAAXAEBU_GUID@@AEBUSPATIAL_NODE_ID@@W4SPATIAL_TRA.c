/*
 * XREFs of ?StartTracking_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x1800B1500
 * Callers:
...
int __fastcall HolographicDriverClientTrace::StartTracking_(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 )
  {
    ...
    if ( v7 == *(struct HolographicDriverClientTrace **)(v8 + 24) )
    {
      ...
      v20 = 0;
      v22 = 8LL;
      LODWORD(v7) = TlgWrite((TraceLoggingHProvider)v8, &unk_1800F1679, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v7;
}
