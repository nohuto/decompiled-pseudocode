...
void __fastcall __noreturn std::_List_buy_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread____std::allocator_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread_______::_Buynode_std::piecewise_construct_t_const_____ptr64_std::tuple_unsigned_int_const_____ptr64__std::tuple_____::_1_::catch_21(
        __int64 a1,
        __int64 a2)
{
