/*
 * XREFs of ?QueryInterface@MPCSharedWorldInputTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC960
 * Callers:
 *     ?QueryInterface@MPCSharedWorldInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AD9C0 (-QueryInterface@MPCSharedWorldInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCSharedWorldInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AD9D0 (-QueryInterface@MPCSharedWorldInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCSharedWorldInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AD9F0 (-QueryInterface@MPCSharedWorldInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::QueryInterface(
        ...
        const char *a4)
{
  ...
  {
    (*(void (__fastcall **)(MPCSharedWorldInputTarget *))(*(_QWORD *)this + 8LL))(this);
    v7 = (char *)this + 24;
LABEL_13:
    *a3 = v7;
    return v6;
