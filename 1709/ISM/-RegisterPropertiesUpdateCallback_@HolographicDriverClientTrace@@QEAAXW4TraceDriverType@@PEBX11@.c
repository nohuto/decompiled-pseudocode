/*
 * XREFs of ?RegisterPropertiesUpdateCallback_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@PEBX11@Z @ 0x1800B178C
 * Callers:
...
int HolographicDriverClientTrace::RegisterPropertiesUpdateCallback_(__int64 a1, int a2, ...)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 )
  {
    ...
    if ( v3 == *(struct HolographicDriverClientTrace **)(v4 + 24) )
    {
      ...
      v15 = 8LL;
      v17 = 8LL;
      LODWORD(v3) = TlgWrite((TraceLoggingHProvider)v4, &unk_1800F107E, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v3;
}
