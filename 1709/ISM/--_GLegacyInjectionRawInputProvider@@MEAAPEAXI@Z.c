/*
 * XREFs of ??_GLegacyInjectionRawInputProvider@@MEAAPEAXI@Z @ 0x18008629C
 * Callers:
 *     ??_ELegacyInjectionRawInputProvider@@OBI@EAAPEAXI@Z @ 0x180087620 (--_ELegacyInjectionRawInputProvider@@OBI@EAAPEAXI@Z.c)
 * Callees:
