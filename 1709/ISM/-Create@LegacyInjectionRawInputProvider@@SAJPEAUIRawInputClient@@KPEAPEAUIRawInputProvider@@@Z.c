/*
 * XREFs of ?Create@LegacyInjectionRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x1800863E0
 * Callers:
 *     <none>
 * Callees:
 *     McTemplateU0qqq @ 0x180001C0C (McTemplateU0qqq.c)
 *     ??0LegacyInjectionRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z @ 0x180086184 (--0LegacyInjectionRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z.c)
        ...
        struct IRawInputProvider **a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    if ( v7 )
    {
      ...
      {
        McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 75, v10);
      }
    }
    else
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      {
        v9 = 72;
LABEL_17:
        McTemplateU0qqq((__int64)a1, &MinInput_Warning_CheckResult, 0, v9, v8);
      }
    }
  }
  else
