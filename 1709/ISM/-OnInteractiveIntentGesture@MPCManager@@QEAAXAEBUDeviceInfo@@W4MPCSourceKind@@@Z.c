/*
 * XREFs of ?OnInteractiveIntentGesture@MPCManager@@QEAAXAEBUDeviceInfo@@W4MPCSourceKind@@@Z @ 0x18005DB94
 * Callers:
...
void __fastcall MPCManager::OnInteractiveIntentGesture(__int64 a1, __int128 *a2, int a3)
{
  __int64 *v3; // rdi
  __int64 *v7; // rbx
  __int128 *v8; // rax
  ...
  __int64 *v23; // rax
  __int64 *i; // rax
  int v25; // [rsp+20h] [rbp-A88h]
  _BYTE v26[2624]; // [rsp+40h] [rbp-A68h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+AA8h] [rbp+0h]
  __int64 v28; // [rsp+AB0h] [rbp+8h] BYREF
