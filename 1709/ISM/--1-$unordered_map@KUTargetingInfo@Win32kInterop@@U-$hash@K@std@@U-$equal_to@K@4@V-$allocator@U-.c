/*
 * XREFs of ??1?$unordered_map@KUTargetingInfo@Win32kInterop@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUTargetingInfo@Win32kInterop@@@std@@@4@@std@@QEAA@XZ @ 0x18000B22C
 * Callers:
 *     _Win32kInterop::_scalar_deleting_destructor__::_1_::dtor$4 @ 0x1800CCC5E (_Win32kInterop--_scalar_deleting_destructor__--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
