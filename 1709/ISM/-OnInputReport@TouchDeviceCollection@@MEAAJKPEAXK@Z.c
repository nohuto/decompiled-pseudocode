/*
 * XREFs of ?OnInputReport@TouchDeviceCollection@@MEAAJKPEAXK@Z @ 0x18008B200
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  _QWORD v28[356]; // [rsp+48h] [rbp-B8h] BYREF
  struct tagMONITORINFO mi; // [rsp+B68h] [rbp+A68h] BYREF
    ...
    if ( a3[6] )
    {
      ...
      while ( 1 )
      {
        ...
        if ( *(_DWORD *)(v14 + v15 + 16) != 2 )
          break;
        LODWORD(v28[6 * v13 + 7]) = *(unsigned __int16 *)(v14 + v15 + 8);
        if ( (*(_BYTE *)(v14 + v15 + 28) & 2) != 0 )
          HIDWORD(v28[6 * LODWORD(v28[6]) + 7]) |= 1u;
        if ( (*(_BYTE *)(v14 + v15 + 28) & 4) != 0 )
          HIDWORD(v28[6 * LODWORD(v28[6]) + 7]) |= 2u;
        if ( (*(_DWORD *)(v14 + v15 + 28) & 0x8000) != 0 )
          HIDWORD(v28[6 * LODWORD(v28[6]) + 7]) |= 4u;
        HIDWORD(v28[6 * LODWORD(v28[6]) + 8]) = *(_DWORD *)(v14 + v15 + 64);
        LODWORD(v28[6 * LODWORD(v28[6]) + 9]) = *(_DWORD *)(v14 + v15 + 68);
        v8 = 6 * v12;
        HIDWORD(v28[6 * v12 + 11]) = *(_DWORD *)(v14 + v15 + 156);
        if ( *((_QWORD *)v11 + 2) )
        {
          ...
          {
            HIDWORD(v28[6 * LODWORD(v28[6]) + 8]) -= mi.rcMonitor.left;
            v8 = 6LL * LODWORD(v28[6]);
            LODWORD(v28[6 * LODWORD(v28[6]) + 9]) -= mi.rcMonitor.top;
          }
        }
        v16 = v28[86];
...
LABEL_35:
        ...
        v23 = 287;
LABEL_34:
        McTemplateU0qqq(v22, &MinInput_Warning_CheckResult, 0, v23, ValueForKey);
        goto LABEL_35;
      }
      v20 = v25;
    }
