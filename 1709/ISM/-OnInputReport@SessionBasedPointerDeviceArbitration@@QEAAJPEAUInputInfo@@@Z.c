/*
 * XREFs of ?OnInputReport@SessionBasedPointerDeviceArbitration@@QEAAJPEAUInputInfo@@@Z @ 0x180071D7C
 * Callers:
  ...
  if ( !*((_BYTE *)a2 + 689) )
  {
    ...
    if ( PointersFromInput < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      {
        v9 = 125;
LABEL_6:
        McTemplateU0qqq(v8, &MinInput_Warning_CheckResult, 0, v9, PointersFromInput);
        return v2;
      }
      return v2;
    }
