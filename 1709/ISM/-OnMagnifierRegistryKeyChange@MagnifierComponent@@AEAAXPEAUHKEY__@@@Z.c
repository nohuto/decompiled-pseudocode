/*
 * XREFs of ?OnMagnifierRegistryKeyChange@MagnifierComponent@@AEAAXPEAUHKEY__@@@Z @ 0x1800A5C34
 * Callers:
 *     ?OnMagnifierRegistryKeyChangeStatic@MagnifierComponent@@SAXPEAXPEAUHKEY__@@@Z @ 0x1800A5C20 (-OnMagnifierRegistryKeyChangeStatic@MagnifierComponent@@SAXPEAXPEAUHKEY__@@@Z.c)
 * Callees:
