/*
 * XREFs of _std::vector_Microsoft::WRL::Wrappers::HString_std::allocator_Microsoft::WRL::Wrappers::HString___::emplace_back_Microsoft::WRL::Wrappers::HString__::_1_::catch$107 @ 0x1800D1160
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$destroy@VHString@Wrappers@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@VHString@Wrappers@WRL@Microsoft@@@std@@@std@@QEAAXPEAVHString@Wrappers@WRL@Microsoft@@@Z @ 0x180098EB0 (--$destroy@VHString@Wrappers@WRL@Microsoft@@@-$_Wrap_alloc@V-$allocator@VHString@Wrappers@WRL@Mi.c)
 *     _CxxThrowException_0 @ 0x1800CB710 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::vector_Microsoft::WRL::Wrappers::HString_std::allocator_Microsoft::WRL::Wrappers::HString___::emplace_back_Microsoft::WRL::Wrappers::HString__::_1_::catch_107(
        __int64 a1,
        unsigned __int64 *a2)
{
  _QWORD *v3; // rbx
  ...
  v3 = (_QWORD *)a2[18];
  v4 = (HSTRING *)std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[a2[19]]);
