/*
 * XREFs of ?MPCInputRouter_CreateMPCTarget_@ISMTracing@@QEAAXPEAUIInputTarget@@KI_K1PEAUIMPCInputTarget@@@Z @ 0x1800A83BC
 * Callers:
  ...
  if ( v9 )
  {
    if ( *v9 )
    {
        ...
        && (*(_QWORD *)(v10 + 24) & 1LL) == *(_QWORD *)(v10 + 24) )
      {
        ...
        v34 = 8LL;
        v36 = 8LL;
        TlgWrite((TraceLoggingHProvider)v10, &unk_1800F08B8, 0LL, 0LL, 9u, &pData);
      }
    }
  }
}
