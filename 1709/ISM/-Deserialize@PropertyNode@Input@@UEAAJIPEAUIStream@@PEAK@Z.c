/*
 * XREFs of ?Deserialize@PropertyNode@Input@@UEAAJIPEAUIStream@@PEAK@Z @ 0x180031200
 * Callers:
 *     ?Deserialize@Property@Input@@UEAAJIPEAUIStream@@PEAK@Z @ 0x180031640 (-Deserialize@Property@Input@@UEAAJIPEAUIStream@@PEAK@Z.c)
 *     ?Deserialize@PropertyMap@Input@@UEAAJIPEAUIStream@@PEAK@Z @ 0x180031DA0 (-Deserialize@PropertyMap@Input@@UEAAJIPEAUIStream@@PEAK@Z.c)
 *     ?Deserialize@PropertyVector@Input@@UEAAJIPEAUIStream@@PEAK@Z @ 0x180032360 (-Deserialize@PropertyVector@Input@@UEAAJIPEAUIStream@@PEAK@Z.c)
 * Callees:
