/*
 * XREFs of ?UnInitialize3DComponents@MPCHolographicInputManager@@AEAAXXZ @ 0x180056734
 * Callers:
...
void __fastcall MPCHolographicInputManager::UnInitialize3DComponents(MPCHolographicInputManager *this)
{
  ...
  if ( *((_BYTE *)this + 3128) )
  {
    v2 = (__int64 *)*((_QWORD *)this + 385);
    v3 = (__int64 *)*((_QWORD *)this + 386);
    while ( v2 != v3 )
    {
      v4 = *v2;
      if ( *v2 )
        (*(void (__fastcall **)(__int64))(*(_QWORD *)v4 + 8LL))(v4);
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v4 + 288LL))(v4);
    ...
    *((_QWORD *)this + 394) = 0LL;
    ...
    v12 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 393) + 104LL))(*((_QWORD *)this + 393));
    if ( v12 < 0 )
    {
