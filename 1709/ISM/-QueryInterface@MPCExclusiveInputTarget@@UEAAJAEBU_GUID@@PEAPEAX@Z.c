/*
 * XREFs of ?QueryInterface@MPCExclusiveInputTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB4C0
 * Callers:
 *     ?QueryInterface@MPCExclusiveInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC3D0 (-QueryInterface@MPCExclusiveInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCExclusiveInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC3F0 (-QueryInterface@MPCExclusiveInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCExclusiveInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC410 (-QueryInterface@MPCExclusiveInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
