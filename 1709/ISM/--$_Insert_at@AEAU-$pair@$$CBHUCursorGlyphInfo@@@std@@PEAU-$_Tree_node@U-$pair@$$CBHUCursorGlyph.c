...
unsigned __int64 **__fastcall std::_Tree<std::_Tmap_traits<int,CursorGlyphInfo,std::less<int>,std::allocator<std::pair<int const,CursorGlyphInfo>>,0>>::_Insert_at<std::pair<int const,CursorGlyphInfo> &,std::_Tree_node<std::pair<int const,CursorGlyphInfo>,void *> *>(
        _QWORD *a1,
        unsigned __int64 **a2,
        char a3,
        unsigned __int64 **a4,
