/*
 * XREFs of ??$destroy@VHString@Wrappers@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@VHString@Wrappers@WRL@Microsoft@@@std@@@std@@QEAAXPEAVHString@Wrappers@WRL@Microsoft@@@Z @ 0x180098EB0
 * Callers:
