/*
 * XREFs of ?StartActivity@DestroySpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x1800B3404
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  *(_DWORD *)v6 = 1;
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    TlgWrite(v9, &unk_1800F129B, (LPCGUID)(v11 + 8), v12, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
