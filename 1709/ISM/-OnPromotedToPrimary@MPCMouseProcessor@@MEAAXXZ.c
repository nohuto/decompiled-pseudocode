/*
 * XREFs of ?OnPromotedToPrimary@MPCMouseProcessor@@MEAAXXZ @ 0x18004BF50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCMouseProcessor::OnPromotedToPrimary(MPCMouseProcessor *this)
{
  ...
  *(_QWORD *)((char *)this + 684) = *((_QWORD *)Instance + 22);
  *((_DWORD *)this + 173) = *((_DWORD *)Instance + 46);
  ...
  v13 = *((_OWORD *)v3 + 1);
  v14 = *((float *)this + 172);
  v15 = (__m128)*((unsigned int *)this + 171);
  ...
  *((_QWORD *)this + 87) = _mm_unpacklo_ps(v16, v18).m128_u64[0];
  *((_DWORD *)this + 176) = v15.m128_i32[0];
  *(_QWORD *)((char *)this + 708) = _mm_unpacklo_ps((__m128)0LL, (__m128)0LL).m128_u64[0];
  *((_DWORD *)this + 179) = 0;
}
