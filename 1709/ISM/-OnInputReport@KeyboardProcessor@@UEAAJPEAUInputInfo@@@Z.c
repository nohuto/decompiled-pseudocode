/*
 * XREFs of ?OnInputReport@KeyboardProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1800494A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KeyboardProcessor::OnInputReport(KeyboardProcessor *this, struct InputInfo *a2)
{
  ...
  if ( (*(_DWORD *)a2 & 4) != 0 )
  {
    ...
    if ( !(unsigned int)KeyboardModifierState::KeyboardModifierFromScanCode(v4, (enum KeyboardModifier *)&v16) )
    {
      v7 = v16;
      v8 = (*((_BYTE *)a2 + 700) & 1) == 0;
      if ( (*((_BYTE *)a2 + 700) & 1) != 0 || (v16 & *((_DWORD *)this + 16)) == 0 )
      {
    ...
    if ( ((1LL << gdwDeviceFamily) & 0x224A) == 0 )
    {
      ...
      v11 = 268;
LABEL_28:
      McTemplateU0qqq(v10, &MinInput_Warning_CheckResult, 0, v11, updated);
      return v5;
    }
    memset(&pInputs, 0, sizeof(pInputs));
    v12 = *((_WORD *)a2 + 350);
    pInputs.ki.dwExtraInfo = *((_QWORD *)a2 + 83);
    v13 = *((_WORD *)a2 + 349);
    pInputs.type = 1;
    if ( (v12 & 0x40) != 0 )
    {
  ...
  v5 = -2147024809;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    McTemplateU0qqq(0LL, &MinInput_Warning_CheckResult, 0, 189, 87);
  return v5;
}
