        ...
        void *Block)
{
  ...
  try
  {
    ...
    if ( v9 )
    {
      if ( v8 == (__int64 *)**a1 )
      {
        *(_QWORD *)a2 = *(_QWORD *)std::_Tree<std::_Tmap_traits<unsigned long,GazeHidParser *,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,GazeHidParser *>>,0>>::_Insert_at<std::pair<unsigned long const,GazeHidParser *> &,std::_Tree_node<std::pair<unsigned long const,GazeHidParser *>,void *> *>(
                                     (_DWORD)a1,
                                     (unsigned int)&v16,
                                     1,
                                     (_DWORD)v8);
