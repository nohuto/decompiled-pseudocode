/*
 * XREFs of ?IoctlTimeout_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@KK0AEBUSPATIAL_NODE_ID@@PEB_W@Z @ 0x1800B12B8
 * Callers:
        ...
        const wchar_t *a7)
{
  ...
  const wchar_t *v24; // [rsp+B8h] [rbp+1Fh]
    ...
    && (*((_QWORD *)v9 + 3) & 0x200000000000LL) == *((_QWORD *)v9 + 3) )
  {
    ...
    v25 = 2 * v11 + 2;
    v26 = 0;
    TlgWrite(v9, &unk_1800F2416, 0LL, 0LL, 8u, &pData);
  }
}
