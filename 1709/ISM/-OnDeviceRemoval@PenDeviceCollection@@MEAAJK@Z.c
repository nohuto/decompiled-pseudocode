/*
 * XREFs of ?OnDeviceRemoval@PenDeviceCollection@@MEAAJK@Z @ 0x18008B7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PenDeviceCollection::OnDeviceRemoval(PenDeviceCollection *this, int a2)
{
  char *v2; // rdi
  unsigned int v3; // ebx
  int ValueForKey; // eax
