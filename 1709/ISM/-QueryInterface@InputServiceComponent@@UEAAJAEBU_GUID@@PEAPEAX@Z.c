/*
 * XREFs of ?QueryInterface@InputServiceComponent@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002EAA0
 * Callers:
 *     ?QueryInterface@InputServiceComponent@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002EF30 (-QueryInterface@InputServiceComponent@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@InputServiceComponent@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002EF40 (-QueryInterface@InputServiceComponent@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
