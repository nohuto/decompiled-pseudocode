/*
 * XREFs of ?OnGetTargetWithFocus@EdgeGestureComponent@@UEAAJPEAUIInputDisplay@@PEAUDeviceInfo@@PEAUIInputTarget@@PEAUInputTargetingDecision@@@Z @ 0x18002AA50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputTargetingDecision *a5)
{
  ...
  else
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 524, 87);
  }
  return v5;
}
