/*
 * XREFs of ?GetKeys@?$DynamicSizeMap@UtagMsgRoutingInfo@@PEAUIInputTarget@@$00@@QEAAJPEAUtagMsgRoutingInfo@@I@Z @ 0x18001EE64
 * Callers:
      ...
      if ( !(unsigned __int8)operator==(*(_QWORD *)v6 + 48 * v3, v7) )
      {
        if ( (_DWORD)v11 == a3 )
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
            McTemplateU0qqq(v8, &MinInput_Warning_CheckResult, 0, 323, 87);
