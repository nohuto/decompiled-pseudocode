/*
 * XREFs of ?OnDeviceRemoval@TouchDeviceCollection@@MEAAJK@Z @ 0x18008B130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TouchDeviceCollection::OnDeviceRemoval(TouchDeviceCollection *this, int a2)
{
  char *v2; // rdi
  unsigned int v3; // ebx
  int ValueForKey; // eax
  ...
  v2 = (char *)this + 2760;
  v3 = 0;
  if ( DynamicSizeMap<unsigned long,InputInfoSanitizer *,1>::ExistsValueForKey((__int64)this + 2760, &v9) )
  {
    v8 = 0LL;
    ...
    ValueForKey = DynamicSizeMap<unsigned long,DeviceInfo *,1>::RemoveKey((__int64)v2, &v9);
    v3 = ValueForKey;
    if ( ValueForKey < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
