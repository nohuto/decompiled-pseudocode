...
unsigned __int64 **__fastcall std::_Tree<std::_Tmap_traits<unsigned long,std::wstring,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,std::wstring>>,0>>::erase(
        _QWORD *a1,
        unsigned __int64 **a2,
        unsigned __int64 *a3)
{
...
LABEL_81:
  ...
  *((_BYTE *)v10 + 24) = 1;
LABEL_114:
  std::wstring::_Tidy_deallocate(a3 + 5);
  operator delete(a3);
  v36 = a1[1];
  if ( v36 )
    a1[1] = v36 - 1;
