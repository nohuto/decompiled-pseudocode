/*
 * XREFs of ?SetLocked@MobileCursorBroker@@UEAAJUCursorIdInfo@@_N@Z @ 0x180030580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MobileCursorBroker::SetLocked(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( ValueForKey >= 0 )
  {
    ...
    if ( *(_QWORD *)((*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v13 + 40LL))(v13, &v14) + 8) == v4 )
    {
      ...
      {
        McTemplateU0qqq((unsigned int)Microsoft_OneCore_MinInputEnableBits, &MinInput_Warning_CheckResult, 0, 599, v10);
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(
            (unsigned int)Microsoft_OneCore_MinInputEnableBits,
            &MinInput_Warning_CheckResult,
            0,
            658,
            v11);
      }
    ...
    {
      McTemplateU0qqq(v9, &MinInput_Warning_CheckResult, 0, 655, 5);
    }
  }
  else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 0, 651, ValueForKey);
  }
  return 0LL;
}
