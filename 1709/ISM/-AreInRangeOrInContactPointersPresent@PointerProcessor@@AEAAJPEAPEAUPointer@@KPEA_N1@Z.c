/*
 * XREFs of ?AreInRangeOrInContactPointersPresent@PointerProcessor@@AEAAJPEAPEAUPointer@@KPEA_N1@Z @ 0x180071BE8
 * Callers:
        ...
        bool *a5)
{
  ...
  else
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 669, 87);
  }
  return v5;
}
