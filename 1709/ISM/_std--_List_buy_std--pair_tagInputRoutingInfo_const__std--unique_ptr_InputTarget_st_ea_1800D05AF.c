...
void __fastcall __noreturn std::_List_buy_std::pair_tagInputRoutingInfo_const__std::unique_ptr_InputTarget_std::default_delete_InputTarget______std::allocator_std::pair_tagInputRoutingInfo_const__std::unique_ptr_InputTarget_std::default_delete_InputTarget_________::_Buynode_std::piecewise_construct_t_const_____ptr64_std::tuple_tagInputRoutingInfo_const_____ptr64__std::tuple_____::_1_::catch_23(
        __int64 a1,
        __int64 a2)
{
