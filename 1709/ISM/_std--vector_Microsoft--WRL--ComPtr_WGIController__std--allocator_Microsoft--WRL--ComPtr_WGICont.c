/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::emplace_back_Microsoft::WRL::ComPtr_WGIController____::_1_::catch$107 @ 0x1800D1452
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$destroy@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@QEAAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@@Z @ 0x18009EB48 (--$destroy@V-$ComPtr@VWGIController@@@WRL@Microsoft@@@-$_Wrap_alloc@V-$allocator@V-$ComPtr@VWGIC.c)
 *     _CxxThrowException_0 @ 0x1800CB710 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::emplace_back_Microsoft::WRL::ComPtr_WGIController____::_1_::catch_107(
        __int64 a1,
        unsigned __int64 *a2)
{
  _QWORD *v3; // rbx
  ...
  v3 = (_QWORD *)a2[16];
  v4 = (volatile signed __int64 **)std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[a2[17]]);
