/*
 * XREFs of ?SetValueForKey@?$DynamicSizeMap@IUInputFrame@GestureTargetingComponent@@$04@@QEAAJAEBIAEBUInputFrame@GestureTargetingComponent@@@Z @ 0x18001471C
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  if ( *a2 == v5 )
  {
    ...
    v12 = 153;
LABEL_4:
    McTemplateU0qqq(a1, &MinInput_Warning_CheckResult, 4, v12, v11);
LABEL_5:
  ...
  do
  {
    ...
    if ( *(_DWORD *)(v15 + a1) == v3 )
    {
      v16 = 88LL * v14;
      *(_OWORD *)(v16 + a1 + 8) = *a3;
      *(_OWORD *)(v16 + a1 + 24) = a3[1];
      *(_OWORD *)(v16 + a1 + 40) = a3[2];
      *(_OWORD *)(v16 + a1 + 56) = a3[3];
      *(_OWORD *)(v16 + a1 + 72) = a3[4];
      return v4;
    }
    if ( !v7 && *(_DWORD *)(v15 + a1) == v5 )
    {
      v6 = v14;
      v7 = 1;
    }
...
LABEL_16:
  if ( *(_DWORD *)(v10 + 12) == v13 )
  {
    ...
    *(_QWORD *)v10 = v19;
    if ( !v19 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      McTemplateU0qqq(0LL, &MinInput_Warning_CheckResult, 4, 387, 14);
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      v12 = 185;
      goto LABEL_4;
  ...
  v4 = -2147467259;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    McTemplateU0qqq(a1, &MinInput_Warning_CheckResult, 4, 180, 5);
  return v4;
}
