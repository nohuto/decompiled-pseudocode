/*
 * XREFs of ?GetCursor@DWMCursorBroker@@UEAAJKKPEAPEAUICursor@@@Z @ 0x180025EF0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ICursor **a4)
{
  ...
  v17 = 0LL;
  if ( __PAIR64__(a3, a2) == *((_QWORD *)this + 160) )
  {
  ...
  if ( v7 )
  {
    ...
    v16 = *(_OWORD *)(v9 + 24 * v8 + 8);
    ValueForKey = FixedSizeMap<CursorId,DWMCursor *,50>::GetValueForKey((char *)this + 48, &v16, &v17);
    v10 = ValueForKey;
    if ( ValueForKey >= 0 )
    {
      v15 = v17;
    ...
    {
      McTemplateU0qqq(v14, &MinInput_Warning_CheckResult, 0, 551, ValueForKey);
    }
  }
  else
  {
LABEL_12:
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 550, 5);
    }
  }
  return v10;
}
