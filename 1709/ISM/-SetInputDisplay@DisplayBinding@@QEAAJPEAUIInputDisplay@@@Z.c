/*
 * XREFs of ?SetInputDisplay@DisplayBinding@@QEAAJPEAUIInputDisplay@@@Z @ 0x1800237E4
 * Callers:
...
__int64 __fastcall DisplayBinding::SetInputDisplay(DisplayBinding *this, struct IInputDisplay *a2)
{
  ...
  struct Input::PropertyNode *v15[2]; // [rsp+48h] [rbp-19h] BYREF
  __int64 v16; // [rsp+58h] [rbp-9h]
  void **v17; // [rsp+60h] [rbp-1h] BYREF
  __int128 v18; // [rsp+68h] [rbp+7h]
  __int64 v19; // [rsp+78h] [rbp+17h]
  void *Block; // [rsp+80h] [rbp+1Fh]
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v6 >= 0 )
        {
          ...
          {
            McTemplateU0qqq(v10, &MinInput_Warning_CheckResult, 0, 273, v6);
          }
        }
        else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        {
          McTemplateU0qqq(v9, &MinInput_Warning_CheckResult, 0, 271, v6);
        }
      }
      else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      {
