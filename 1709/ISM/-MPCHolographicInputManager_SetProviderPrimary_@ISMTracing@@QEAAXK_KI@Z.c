/*
 * XREFs of ?MPCHolographicInputManager_SetProviderPrimary_@ISMTracing@@QEAAXK_KI@Z @ 0x180055A20
 * Callers:
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v20 = 2 * v13 + 2;
        v21 = 0;
        TlgWrite((TraceLoggingHProvider)v6, &unk_1800EEA4D, 0LL, 0LL, 5u, &pData);
      }
    }
  }
}
