/*
 * XREFs of ?AttachDevice@RIMDeviceCollection@@AEAAJPEAX0KPEAPEAVRIMDevice@@@Z @ 0x18008A024
 * Callers:
        ...
        struct RIMDevice **a5)
{
  ...
  if ( v12 < 0 )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)v13, &MinInput_Warning_CheckResult, 2, 1113, v12);
    return v14;
  }
...
LABEL_14:
  if ( v15 != -2147023728 )
  {
    ...
    v16 = 1049;
LABEL_7:
    McTemplateU0qqq((__int64)v13, &MinInput_Warning_CheckResult, 2, v16, v14);
LABEL_24:
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq((__int64)v13, &MinInput_Warning_CheckResult, 2, 1115, v15);
    return v14;
  }
  v20 = 0LL;
  while ( *v13 )
...
LABEL_23:
  ...
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(v22, &MinInput_Warning_CheckResult, 2, 1122, v21);
    return v14;
  }
  if ( !v27 || !*((_DWORD *)v27 + 1) )
  {
  ...
  *(_DWORD *)v27 = v11;
  ...
  if ( *(_DWORD *)v27 != *((_DWORD *)a5 + 10) || !*((_DWORD *)v27 + 1) )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
      return v14;
    McTemplateU0qqq((__int64)v27, &MinInput_Warning_CheckResult, 0, 48, 87);
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
      return v14;
    v25 = 1135;
LABEL_42:
    McTemplateU0qqq(v22, &MinInput_Warning_CheckResult, 2, v25, v14);
    return v14;
  }
  a5[4] = v27;
  v14 = 0;
  if ( (*((_DWORD *)v27 + 1) & 0xFFFFFEFF) != 0 )
  {
    ...
    if ( v23 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(v24, &MinInput_Warning_CheckResult, 2, 1156, v23);
  }
  return v14;
}
