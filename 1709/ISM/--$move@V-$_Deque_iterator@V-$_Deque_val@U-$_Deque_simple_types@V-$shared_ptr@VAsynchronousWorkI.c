/*
 * XREFs of ??$move@V?$_Deque_iterator@V?$_Deque_val@U?$_Deque_simple_types@V?$shared_ptr@VAsynchronousWorkItem@SpatialInputControllerCollection@@@std@@@std@@@std@@@std@@V12@@std@@YA?AV?$_Deque_iterator@V?$_Deque_val@U?$_Deque_simple_types@V?$shared_ptr@VAsynchronousWorkItem@SpatialInputControllerCollection@@@std@@@std@@@std@@@0@V10@00@Z @ 0x1800988E4
 * Callers:
...
__int64 **__fastcall std::move<std::_Deque_iterator<std::_Deque_val<std::_Deque_simple_types<std::shared_ptr<SpatialInputControllerCollection::AsynchronousWorkItem>>>>,std::_Deque_iterator<std::_Deque_val<std::_Deque_simple_types<std::shared_ptr<SpatialInputControllerCollection::AsynchronousWorkItem>>>>>(
        __int64 **a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
