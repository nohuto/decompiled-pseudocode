/*
 * XREFs of ??_Gregistry_watcher_state@details@wil@@QEAAPEAXI@Z @ 0x18004D614
 * Callers:
        ...
        __int64 a2)
{
  ...
  wil::details::registry_watcher_state *v8; // rcx
  wil::details::in1diag3 *retaddr; // [rsp+28h] [rbp+0h]

  v2 = (struct _TP_WAIT *)*((_QWORD *)this + 16);
  if ( v2 )
  {
  ...
  v8 = (wil::details::registry_watcher_state *)*((_QWORD *)this + 13);
  if ( v8 )
  {
    LOBYTE(a2) = v8 != this;
    (*(void (__fastcall **)(wil::details::registry_watcher_state *, __int64))(*(_QWORD *)v8 + 24LL))(v8, a2);
    *((_QWORD *)this + 13) = 0LL;
  }
