/*
 * XREFs of ?SetInteractionObject@MPCSharedWorldInputTarget@@UEAAJI@Z @ 0x1800AD4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::SetInteractionObject(MPCSharedWorldInputTarget *this, unsigned int a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
