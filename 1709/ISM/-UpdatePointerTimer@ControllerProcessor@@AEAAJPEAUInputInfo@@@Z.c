/*
 * XREFs of ?UpdatePointerTimer@ControllerProcessor@@AEAAJPEAUInputInfo@@@Z @ 0x1800405A0
 * Callers:
...
__int64 __fastcall ControllerProcessor::UpdatePointerTimer(ControllerProcessor *this, struct InputInfo *a2)
{
  ...
  if ( !*((_BYTE *)a2 + 760) )
  {
    v4 = COERCE_DOUBLE(*((_QWORD *)a2 + 91) & _xmm) <= 0.239532470703125
      && COERCE_DOUBLE(*((_QWORD *)a2 + 92) & _xmm) <= 0.239532470703125;
    v5 = COERCE_DOUBLE(*((_QWORD *)a2 + 93) & _xmm) <= 0.265167236328125
      && COERCE_DOUBLE(*((_QWORD *)a2 + 94) & _xmm) <= 0.265167236328125;
    v6 = COERCE_DOUBLE(*((_QWORD *)a2 + 89) & _xmm) <= 0.1171875
      && COERCE_DOUBLE(*((_QWORD *)a2 + 90) & _xmm) <= 0.1171875;
    if ( v5 && !*((_BYTE *)this + 376) && *((_DWORD *)this + 306) == 1 )
      ControllerProcessor::TryUpdateInteractionType(this, 0LL);
    if ( v6 && ((*((_DWORD *)this + 306) - 16) & 0xFFFFFFEF) == 0 )
      ControllerProcessor::TryUpdateInteractionType(this, 0LL);
    if ( v4 && v5 && v6 )
      v3 = 0;
  }
  ...
  if ( v3 )
  {
    if ( !*((_DWORD *)this + 59) && !v12 )
    {
      ...
      if ( v7 < 0 )
      {
        ...
        v10 = 1915;
LABEL_34:
        McTemplateU0qqq(v8, &MinInput_Warning_CheckResult, 12, v10, v7);
LABEL_35:
