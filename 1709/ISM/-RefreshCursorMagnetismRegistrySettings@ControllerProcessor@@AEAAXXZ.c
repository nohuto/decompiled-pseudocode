/*
 * XREFs of ?RefreshCursorMagnetismRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x180041990
 * Callers:
 *     ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x18003D638 (-Initialize@ControllerProcessor@@IEAAJXZ.c)
 *     _lambda_828562b8234057b7c70d01bfff3fe312_::_lambda_invoker_cdecl_ @ 0x18003DD30 (_lambda_828562b8234057b7c70d01bfff3fe312_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     ?ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z @ 0x18004184C (-ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z.c)
 */
...
void __fastcall ControllerProcessor::RefreshCursorMagnetismRegistrySettings(ControllerProcessor *this)
{
  ...
  *((_QWORD *)this + 508) = v13;
  ...
  if ( v14 )
    v15 = 100;
  pcbData = v15;
  *((_DWORD *)this + 1018) = ControllerProcessor::ConvertDIPSToPixels(this, &pcbData);
  pcbData = 4;
  v16 = RegGetValueW(
          HKEY_LOCAL_MACHINE,
          L"Software\\Microsoft\\Input\\Settings\\ControllerProcessor\\CursorMagnetism",
  ...
  if ( v16 )
    v17 = 100;
  pcbData = v17;
  *((_DWORD *)this + 1019) = ControllerProcessor::ConvertDIPSToPixels(this, &pcbData);
  v18 = 0LL;
  ...
  *((_QWORD *)this + 491) = _mm_unpacklo_ps(v18, v19).m128_u64[0];
  *((_DWORD *)this + 984) = v20;
  *((_QWORD *)this + 505) = 10000LL * v9;
  v21 = 10000LL * *((_QWORD *)this + 508);
  *((_QWORD *)this + 506) = 10000LL * (unsigned int)v11;
  *((_QWORD *)this + 507) = v21;
}
