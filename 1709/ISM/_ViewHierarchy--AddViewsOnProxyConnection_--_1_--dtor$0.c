/*
 * XREFs of _ViewHierarchy::AddViewsOnProxyConnection_::_1_::dtor$0 @ 0x1800CD449
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ViewHierarchy::AddViewsOnProxyConnection_::_1_::dtor_0(__int64 a1, __int64 a2)
{
