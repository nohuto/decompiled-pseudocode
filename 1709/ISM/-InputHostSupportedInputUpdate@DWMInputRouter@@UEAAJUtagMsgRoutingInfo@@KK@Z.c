/*
 * XREFs of ?InputHostSupportedInputUpdate@DWMInputRouter@@UEAAJUtagMsgRoutingInfo@@KK@Z @ 0x180019780
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  {
    v17[0] = 0LL;
    ValueForKey = DynamicSizeMap<tagMsgRoutingInfo,IInputTarget *,1>::GetValueForKey(a1 + 24, a2, v17);
    if ( ValueForKey < 0 )
    {
    ...
    if ( v11 < 0 )
    {
      ...
      JUMPOUT(0x1800198F9LL);
    }
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)(a1 - 56) + 144LL))(a1 - 56, v16);
    v12 = v16;
    if ( v16 )
    {
      v16 = 0LL;
