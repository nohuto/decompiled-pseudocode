/*
 * XREFs of ?Create@ConsumerControlDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x18009A3D8
 * Callers:
...
LABEL_17:
        ...
        {
          McTemplateU0qqq(v14, &MinInput_Warning_CheckResult, 0, 38, v12);
        }
        if ( v12 < 0 )
          (*(void (__fastcall **)(_DWORD *, __int64))(*(_QWORD *)v10 + 24LL))(v10, 1LL);
        return (unsigned int)v12;
      }
      McTemplateU0qqq(v14, &MinInput_Warning_CheckResult, 0, 89, v12);
    }
    v15 = Microsoft_OneCore_MinInputEnableBits;
    goto LABEL_17;
  }
