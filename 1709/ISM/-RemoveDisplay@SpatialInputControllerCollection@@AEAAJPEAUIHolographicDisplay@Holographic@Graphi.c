/*
 * XREFs of ?RemoveDisplay@SpatialInputControllerCollection@@AEAAJPEAUIHolographicDisplay@Holographic@Graphics@Windows@@@Z @ 0x180095C5C
 * Callers:
...
LABEL_5:
  ...
  v6 = 0LL;
  while ( v6 < (__int64)(*((_QWORD *)this + 390) - *((_QWORD *)this + 389)) >> 3 )
  {
    v7 = *((_QWORD *)this + 389);
    if ( (*((_QWORD *)this + 390) - v7) >> 3 <= v6 )
    ...
    if ( (*(int (__fastcall **)(_QWORD, _QWORD *))(**(_QWORD **)(v7 + 8 * v6) + 48LL))(*(_QWORD *)(v7 + 8 * v6), v19) >= 0
      ...
      && v18[1] == v19[1] )
    {
      v8 = (char *)*((_QWORD *)this + 390);
      for ( i = (char *)(*((_QWORD *)this + 389) + 8 * v6 + 8); i != v8; i += 8 )
      {
        v10 = 0LL;
        if ( &v17 != i )
        {
