/*
 * XREFs of ?QueryInterface@GestureTargetingComponent@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800137F0
 * Callers:
 *     ?QueryInterface@GestureTargetingComponent@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180014960 (-QueryInterface@GestureTargetingComponent@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GestureTargetingComponent@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180014970 (-QueryInterface@GestureTargetingComponent@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
