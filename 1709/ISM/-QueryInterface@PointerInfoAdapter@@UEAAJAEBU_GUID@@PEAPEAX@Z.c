/*
 * XREFs of ?QueryInterface@PointerInfoAdapter@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800703C0
 * Callers:
 *     ?QueryInterface@PointerInfoAdapter@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180070AF0 (-QueryInterface@PointerInfoAdapter@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
