        ...
        unsigned __int64 *Block)
{
  ...
  try
  {
    ...
    if ( *((_DWORD *)v14 + 8) >= *a4 )
    {
      std::wstring::_Tidy_deallocate(Block + 5);
      operator delete(v8);
      *(_QWORD *)a2 = v14;
      *(_BYTE *)(a2 + 8) = 0;
    }
  ...
  {
    std::_Tree<std::_Tmap_traits<unsigned long,std::wstring,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,std::wstring>>,0>>::_Destroy_if_not_nil(
      v15,
      Block);
    throw;
  }
