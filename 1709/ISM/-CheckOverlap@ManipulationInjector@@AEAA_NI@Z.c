/*
 * XREFs of ?CheckOverlap@ManipulationInjector@@AEAA_NI@Z @ 0x1800C1780
 * Callers:
  ...
  else
  {
    if ( *((_DWORD *)this + 22) != 32 )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        a4);
      JUMPOUT(0x1800C1908LL);
    }
    v19 = a2 + 1;
    if ( *(_DWORD *)this == 3 )
    {
      v20 = *((_DWORD *)this + 38 * v19 + 38) - *((_DWORD *)this + 38 * a2 + 38);
      v23 = __OFSUB__(v20, *((_DWORD *)this + 188));
      v21 = v20 == *((_DWORD *)this + 188);
      v22 = v20 - *((_DWORD *)this + 188) < 0;
    }
    else
    {
