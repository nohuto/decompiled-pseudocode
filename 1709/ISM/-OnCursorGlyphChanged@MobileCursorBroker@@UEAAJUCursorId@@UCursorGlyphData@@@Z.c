/*
 * XREFs of ?OnCursorGlyphChanged@MobileCursorBroker@@UEAAJUCursorId@@UCursorGlyphData@@@Z @ 0x180030350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MobileCursorBroker::OnCursorGlyphChanged(__int64 a1, __int64 a2, const unsigned __int16 *a3)
{
  ...
  if ( ValueForKey >= 0 )
  {
    ...
    if ( ((*(__int64 (__fastcall **)(struct MobileCursor *))(*(_QWORD *)v14[0] + 48LL))(v14[0]) & 8) != 0 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 530, 87);
    }
    else
    {
      ...
      else
      {
        v8 = -2147024891;
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(v12, &MinInput_Warning_CheckResult, 0, 535, 5);
      }
    }
  }
  else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v9 = 525;
LABEL_13:
    McTemplateU0qqq(v7, &MinInput_Warning_CheckResult, 0, v9, ValueForKey);
  }
  return v8;
}
