/*
 * XREFs of _std::vector_InputProvider_std::allocator_InputProvider___::emplace_back_InputProvider__::_1_::catch$73 @ 0x1800CE532
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$destroy@UInputProvider@@@?$_Wrap_alloc@V?$allocator@UInputProvider@@@std@@@std@@QEAAXPEAUInputProvider@@@Z @ 0x1800055E4 (--$destroy@UInputProvider@@@-$_Wrap_alloc@V-$allocator@UInputProvider@@@std@@@std@@QEAAXPEAUInpu.c)
 *     _CxxThrowException_0 @ 0x1800CB710 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::vector_InputProvider_std::allocator_InputProvider___::emplace_back_InputProvider__::_1_::catch_73(
        __int64 a1,
        unsigned __int64 *a2)
{
  _QWORD *v3; // rbx
  ...
  v3 = (_QWORD *)a2[17];
  v4 = std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[3 * a2[16]]);
