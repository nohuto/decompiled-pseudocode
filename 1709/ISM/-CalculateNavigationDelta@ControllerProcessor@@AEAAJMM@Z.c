/*
 * XREFs of ?CalculateNavigationDelta@ControllerProcessor@@AEAAJMM@Z @ 0x18003FA18
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculateNavigationDelta(ControllerProcessor *this, double a2, double a3)
{
  ...
  *(double *)v11.m128_u64 = v8.m128_f32[0];
  ...
  if ( v12.m128_f32[0] > 0.00000011920929 )
  {
    ...
    v14 = GetTickCount64() - *((_QWORD *)this + 44);
    v15 = 0LL;
    v15.m128_f32[0] = (float)(int)v14;
    if ( v14 < 0 )
      v15.m128_f32[0] = v15.m128_f32[0] + 1.8446744e19;
    if ( v15.m128_f32[0] < 1000.0 )
    {
      v15.m128_f32[0] = (float)(powf(v15.m128_f32[0] / 1000.0, 0.60000002) * 0.89999998) + 0.1;
  ...
  result = 0LL;
  v17 = _mm_mul_ps(_mm_mul_ps((__m128)_xmm, v9), (__m128)_xmm);
  v18 = _mm_shuffle_ps(v17, v17, 85).m128_f32[0] + *((float *)this + 86);
  v17.m128_f32[0] = v17.m128_f32[0] + *((float *)this + 85);
  *((float *)this + 86) = v18;
  *((_DWORD *)this + 85) = v17.m128_i32[0];
  return result;
}
