/*
 * XREFs of ?Stop@?$ActivityBase@VRawInputProvidersTracing@@$0A@$0A@$03U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800969AC
 * Callers:
...
int __fastcall wil::ActivityBase<RawInputProvidersTracing,0,0,4,_TlgReflectorTag_Param0IsProviderType>::Stop(
        __int64 a1,
        int a2)
{
  __int64 v4; // rax
  ...
  *(_DWORD *)(v4 + 72) = v7;
  ...
  if ( v7 )
  {
    ...
    if ( *(_DWORD *)v9 > 5u )
    {
      ...
      p_SRWLock = &SRWLock;
      v21 = 4;
      LODWORD(i) = TlgWrite(v9, &unk_1800EF6D8, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
    }
  }
  else
  {
