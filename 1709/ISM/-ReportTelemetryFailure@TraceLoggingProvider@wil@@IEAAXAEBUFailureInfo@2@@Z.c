/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18003AEC0
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x18003AE90 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const wchar_t *v38; // [rsp+C8h] [rbp-40h]
  ...
  const wchar_t *v51; // [rsp+118h] [rbp+10h]
  ...
  const wchar_t *v59; // [rsp+148h] [rbp+40h]
    ...
    && (*((_QWORD *)v2 + 3) & 0x200000000000LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    v16 = (const wchar_t *)*((_QWORD *)a2 + 11);
    v49 = v5 + 1;
    LODWORD(v5) = 0;
    v48 = v15;
    v17 = &word_1800DF514;
    ...
    v19 = (const wchar_t *)*((_QWORD *)a2 + 14);
    v57 = v5 + 1;
    LODWORD(v5) = 0;
    v56 = v3;
    v58 = 0;
    ...
    v60 = 2 * v5 + 2;
    v61 = 0;
    TlgWrite(v2, &unk_1800ED8C1, 0LL, 0LL, 0x10u, &pData);
  }
}
