...
_WORD *std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,Windows::Internal::Holographic::HolographicDisplaySnapshot,Windows::Internal::Holographic::CaseInsensitiveStringLess,std::allocator<std::pair<std::wstring const,Windows::Internal::Holographic::HolographicDisplaySnapshot>>,0>>::_Buyheadnode()
{
  _WORD *result; // rax
  _QWORD *v1; // rcx

  result = operator new(0x3A8uLL);
  try
  {
    if ( result )
