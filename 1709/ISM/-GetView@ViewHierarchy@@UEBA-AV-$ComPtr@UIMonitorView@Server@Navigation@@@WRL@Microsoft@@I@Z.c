/*
 * XREFs of ?GetView@ViewHierarchy@@UEBA?AV?$ComPtr@UIMonitorView@Server@Navigation@@@WRL@Microsoft@@I@Z @ 0x180083D80
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall ViewHierarchy::GetView(__int64 a1, char *a2, int a3)
{
  ...
  if ( *(_QWORD *)(a1 + 48) || *(_DWORD *)(a1 + 144) == 1 )
  {
    ...
    for ( j = v13; ; j = (__int64 *)*j )
    {
      v15 = v13 == *(__int64 **)(a1 + 88) ? *(__int64 **)(a1 + 88) : **(__int64 ***)(v11 + 8 * v12 + 8);
      if ( j == v15 )
        break;
      if ( *((_DWORD *)j + 4) == a3 )
        goto LABEL_14;
