/*
 * XREFs of ?MPCSharedWorldInputTarget_DeliverInput_@ISMTracing@@QEAAXPEAUIInputTarget@@KPEAUInputInfo@@_N@Z @ 0x1800AC41C
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *(_DWORD *)v7 > 5u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
    {
      ...
      v42 = 4;
      v45 = 1;
      TlgWrite((TraceLoggingHProvider)v8, &unk_1800F0B59, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
