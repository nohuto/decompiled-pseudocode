/*
 * XREFs of ?GetValueForKey@?$DynamicSizeMap@_KUPreviousState@InputInfoSanitizer@@$00@@QEAAJAEB_KPEAUPreviousState@InputInfoSanitizer@@@Z @ 0x1800A382C
 * Callers:
