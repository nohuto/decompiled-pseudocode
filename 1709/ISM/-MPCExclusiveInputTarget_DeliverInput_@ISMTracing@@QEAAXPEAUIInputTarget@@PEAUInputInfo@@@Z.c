/*
 * XREFs of ?MPCExclusiveInputTarget_DeliverInput_@ISMTracing@@QEAAXPEAUIInputTarget@@PEAUInputInfo@@@Z @ 0x1800AAF9C
 * Callers:
        ...
        struct InputInfo *a3)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    if ( *(_DWORD *)v6 > 5u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      v34 = 4;
      v37 = 4;
      TlgWrite((TraceLoggingHProvider)v6, &unk_1800F0AC5, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
