/*
 * XREFs of ?Initialize@?$KernelInputConnection@UtagQMSGINPUTREPORT@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBUtagQMSGINPUTREPORT@@@Z@std@@@Z @ 0x180080458
 * Callers:
...
void __fastcall KernelInputConnection<tagQMSGINPUTREPORT>::Initialize(_QWORD *a1, __int64 *a2, __int64 a3, __int64 a4)
{
  _QWORD *v7; // rbx
  _BYTE *v8; // rcx
...
LABEL_25:
  ...
  v26 = MITCoreMsgKOpenConnectionTo(1LL, a1 + 3);
  if ( v26 < 0 )
