/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget_@ISMTracing@@QEAAXPEAUIInputTarget@@_NPEAUIMPCInputPostProcessor@@@Z @ 0x1800A80EC
 * Callers:
        ...
        struct IMPCInputPostProcessor *a4)
{
  ...
  int PIDOfTarget; // [rsp+48h] [rbp-69h] BYREF
  int v14; // [rsp+4Ch] [rbp-65h] BYREF
  struct IInputTarget *v15; // [rsp+50h] [rbp-61h] BYREF
  _QWORD v16[4]; // [rsp+58h] [rbp-59h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+78h] [rbp-39h] BYREF
  char *v18; // [rsp+98h] [rbp-19h]
  int v19; // [rsp+A0h] [rbp-11h]
  int v20; // [rsp+A4h] [rbp-Dh]
  struct IInputTarget **v21; // [rsp+A8h] [rbp-9h]
  int v22; // [rsp+B0h] [rbp-1h]
  int v23; // [rsp+B4h] [rbp+3h]
  _QWORD *v24; // [rsp+B8h] [rbp+7h]
  int v25; // [rsp+C0h] [rbp+Fh]
  int v26; // [rsp+C4h] [rbp+13h]
  int *p_PIDOfTarget; // [rsp+C8h] [rbp+17h]
  int v28; // [rsp+D0h] [rbp+1Fh]
  int v29; // [rsp+D4h] [rbp+23h]
  int *v30; // [rsp+D8h] [rbp+27h]
  int v31; // [rsp+E0h] [rbp+2Fh]
  int v32; // [rsp+E4h] [rbp+33h]
  char v33; // [rsp+128h] [rbp+77h] BYREF
    ...
    if ( *v6 )
    {
      ...
      if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        if ( a2 )
        {
          ...
          if ( v9 >= 0 && v12 )
          {
            (*(void (__fastcall **)(__int64, int *))(*(_QWORD *)v12 + 48LL))(v12, &v11);
            v10 = v12;
          }
          if ( v10 )
          {
        ...
        v31 = 4;
        v32 = 0;
        TlgWrite((TraceLoggingHProvider)v7, &unk_1800F0940, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
