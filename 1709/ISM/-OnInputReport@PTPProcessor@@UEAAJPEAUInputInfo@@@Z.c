/*
 * XREFs of ?OnInputReport@PTPProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x18006E8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PTPProcessor::OnInputReport(__int64 this, struct InputInfo *a2)
{
  ...
  if ( (*(_DWORD *)a2 & 0x20) == 0 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v5 = 286;
LABEL_4:
      McTemplateU0qqq(this, &MinInput_Warning_CheckResult, 11, v5, v2);
      return v2;
    }
    return v2;
  }
  *(_DWORD *)a2 = 8;
  (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(this + 632) + 24LL))(*(_QWORD *)(this + 632));
  v6 = *(_DWORD *)(v4 + 592);
  this = *(unsigned int *)(v4 + 584);
  v7 = v6 & 0x200801;
  v8 = v6 & 0x5020C0;
  if ( !(_DWORD)this )
  {
    if ( (*(_DWORD *)(v4 + 592) & 0x800) == 0 )
      this = (*(_DWORD *)(v4 + 592) & 0x400) != 0;
    if ( (_BYTE)this )
    {
      if ( *(_BYTE *)(v4 + 656) )
      {
        v9 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(v4 + 648) + 96LL))(*(_QWORD *)(v4 + 648));
        v2 = v9;
        if ( v9 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(v10, &MinInput_Warning_CheckResult, 11, 349, v9);
      }
      return v2;
    }
    if ( !v6 )
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 4) != 0 )
      McTemplateU0qq(this, &MinInput_Log_PTPGesture, 11, v6);
    if ( *(_BYTE *)(v4 + 656) )
    {
      if ( (*(_DWORD *)(v4 + 592) & 0x100040) != 0 )
      {
        v11 = *(_QWORD *)(v4 + 648);
        *(_BYTE *)(v4 + 656) = 0;
        ...
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
            McTemplateU0qqq(v13, &MinInput_Warning_CheckResult, 11, 366, v12);
          return v2;
        }
        *(_DWORD *)(v4 + 592) &= ~0x40u;
        *(_DWORD *)(v4 + 592) |= 0x100000u;
      }
      else
      {
        ...
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
            McTemplateU0qqq(v17, &MinInput_Warning_CheckResult, 11, 378, v16);
          return v2;
        }
      }
    }
    if ( v7 )
    {
      ...
      {
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          McTemplateU0qqq(v15, &MinInput_Warning_CheckResult, 11, 384, v14);
        return v2;
      }
LABEL_49:
      *(_DWORD *)(v4 + 584) = 0;
    ...
    if ( v18 < 0 )
    {
      ...
      v20 = 389;
LABEL_53:
      McTemplateU0qqq(v19, &MinInput_Warning_CheckResult, 11, v20, v18);
      return v2;
    }
    goto LABEL_54;
  }
...
LABEL_45:
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v23 = 571;
LABEL_40:
    McTemplateU0qqq(this, &MinInput_Warning_CheckResult, 11, v23, v22);
  }
LABEL_46:
  if ( (v2 & 0x80000000) == 0 )
    goto LABEL_49;
