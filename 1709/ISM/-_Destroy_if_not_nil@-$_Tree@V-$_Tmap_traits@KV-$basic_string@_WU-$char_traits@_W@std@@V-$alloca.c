 ...
 *     _std::_Tree_std::_Tmap_traits_unsigned_long_std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t____std::less_unsigned_long__std::allocator_std::pair_unsigned_long_const__std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t________0___::_Insert_nohint_std::pair_unsigned_long_const__std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t______&___ptr64_std::_Tree_node_std::pair_unsigned_long_const__std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t______void_____ptr64______ptr64__::_1_::catch$51 @ 0x1800D23C6 (_std--_Tree_std--_Tmap_traits_unsigned_long_std--basic_string_wchar_t_std--char_traits_wchar_t__.c)
 * Callees:
...
void __fastcall std::_Tree<std::_Tmap_traits<unsigned long,std::wstring,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,std::wstring>>,0>>::_Destroy_if_not_nil(
        __int64 a1,
        unsigned __int64 *a2)
{
