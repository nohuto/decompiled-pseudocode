/*
 * XREFs of ?StopActivity@OnHolographicDisplayChanged@RawInputProvidersTracing@@MEAAXXZ @ 0x18008E660
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RawInputProvidersTracing::OnHolographicDisplayChanged::StopActivity(
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      ...
      v81 = v9 + 1;
      v82 = 0;
      TlgWrite(v6, &unk_1800EFF65, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 4u )
    {
      ...
      v32 = CurrentThreadId;
      v86 = &v32;
      TlgWrite(v26, &unk_1800EFF19, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v83);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
