/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget3D_@ISMTracing@@QEAAX_NPEAUIMPCInputTarget@@0@Z @ 0x1800A82B0
 * Callers:
        ...
        char a4)
{
  ...
  struct IMPCInputTarget *v9; // [rsp+38h] [rbp-31h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+40h] [rbp-29h] BYREF
  char *v11; // [rsp+60h] [rbp-9h]
  int v12; // [rsp+68h] [rbp-1h]
  int v13; // [rsp+6Ch] [rbp+3h]
  struct IMPCInputTarget **v14; // [rsp+70h] [rbp+7h]
  ...
  char v23; // [rsp+D8h] [rbp+6Fh] BYREF
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v20 = &v8;
        v21 = 4;
        TlgWrite((TraceLoggingHProvider)v6, &unk_1800F09B4, 0LL, 0LL, 6u, &pData);
      }
    }
  }
}
