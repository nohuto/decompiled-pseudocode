/*
 * XREFs of ?DropInvalidContacts@GestureTargetingTarget@@AEAAJPEAUInputInfo@@@Z @ 0x180015D9C
 * Callers:
...
__int64 __fastcall GestureTargetingTarget::DropInvalidContacts(GestureTargetingTarget *this, struct InputInfo *a2)
{
  ...
  if ( PointersFromInput < 0 )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 4, 669, PointersFromInput);
LABEL_16:
    if ( (v7 & 0x80000000) == 0 )
      return v7;
    goto LABEL_21;
...
LABEL_9:
        if ( (Microsoft_OneCore_MinInputEnableBits & 4) != 0 )
          McTemplateU0qqq(v6, &MinInput_Log_PointerFrameRouting_PointerDropped, 4, v10, *(_DWORD *)v9);
      }
      else
      {
...
LABEL_19:
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
    return v7;
  McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 4, 691, 255);
LABEL_21:
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 4, 633, v7);
  return v7;
}
