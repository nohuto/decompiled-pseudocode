/*
 * XREFs of ??$destroy@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@QEAAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@@Z @ 0x18009EB48
 * Callers:
