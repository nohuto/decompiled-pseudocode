/*
 * XREFs of _std::_List_alloc_std::_List_base_types_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread____std::allocator_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread_________::_Buynode0_::_1_::catch$14 @ 0x1800CE6DF
 * Callers:
 *     <none>
 * Callees:
