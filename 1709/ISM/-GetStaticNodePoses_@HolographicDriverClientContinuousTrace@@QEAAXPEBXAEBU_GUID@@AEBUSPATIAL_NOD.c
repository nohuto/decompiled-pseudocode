/*
 * XREFs of ?GetStaticNodePoses_@HolographicDriverClientContinuousTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@KPEBU3@PEBUSPATIAL_GRAPH_STATIC_NODE_POSE@@@Z @ 0x1800B2694
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a6)
{
  ...
  if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 2) != 0 && (*(_QWORD *)(v8 + 24) & 2LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v20 = 16 * a5;
    v21 = 0;
    TlgWrite((TraceLoggingHProvider)v8, &unk_1800F0FC3, 0LL, 0LL, 7u, &pData);
  }
}
