/*
 * XREFs of ?GetStaticNodePoses@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJAEBUSPATIAL_NODE_ID@@KPEBU5@PEAUSPATIAL_GRAPH_STATIC_NODE_POSE@@@Z @ 0x1800BF3C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        struct SPATIAL_GRAPH_STATIC_NODE_POSE *a5)
{
  return Windows::Internal::Holographic::SpatialGraphDriverClient::GetStaticNodePoses(
           (Windows::Internal::Holographic::HolographicDriverHandleWrapper **)(a1 - 16),
           a2,
           a3,
           a4,
           a5);
