/*
 * XREFs of ?Create@GazeDeviceCollection@@SAJPEAUIRawInputClient@@PEAPEAXPEAPEAV1@@Z @ 0x18009B4CC
 * Callers:
...
__int64 __fastcall GazeDeviceCollection::Create(
        ...
        void **a2,
        struct GazeDeviceCollection **a3)
{
...
LABEL_22:
  ...
  *(_QWORD *)v7 = &GazeDeviceCollection::`vftable';
  ...
  *((_QWORD *)v7 + 345) = std::_Tree_comp_alloc<std::_Tmap_traits<unsigned long,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>>,0>>::_Buyheadnode();
  LODWORD(v14) = 1179649;
  v9 = HIDDeviceCollection::Initialize(v7, v8, (struct _RIM_USAGE_ANDPAGE *const)&v14, 1u, 0x40u, a2);
  if ( v9 >= 0 )
    goto LABEL_13;
  v12 = Microsoft_OneCore_MinInputEnableBits;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 89, v9);
LABEL_13:
    v12 = Microsoft_OneCore_MinInputEnableBits;
  }
  if ( v9 >= 0 )
  ...
  {
    McTemplateU0qqq(v11, &MinInput_Warning_CheckResult, 0, 47, v9);
  }
  if ( v9 < 0 )
