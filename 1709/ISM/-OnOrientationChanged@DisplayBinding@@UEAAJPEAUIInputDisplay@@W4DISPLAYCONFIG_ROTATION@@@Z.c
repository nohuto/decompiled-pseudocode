/*
 * XREFs of ?OnOrientationChanged@DisplayBinding@@UEAAJPEAUIInputDisplay@@W4DISPLAYCONFIG_ROTATION@@@Z @ 0x180023A80
 * Callers:
 *     <none>
 * Callees:
        ...
        enum DISPLAYCONFIG_ROTATION a3)
{
  ...
  else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v8 = 295;
LABEL_14:
    McTemplateU0qqq(v6, &MinInput_Warning_CheckResult, 0, v8, v7);
  }
