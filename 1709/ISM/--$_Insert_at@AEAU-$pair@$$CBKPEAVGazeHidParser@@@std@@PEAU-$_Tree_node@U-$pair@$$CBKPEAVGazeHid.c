/*
 * XREFs of ??$_Insert_at@AEAU?$pair@$$CBKPEAVGazeHidParser@@@std@@PEAU?$_Tree_node@U?$pair@$$CBKPEAVGazeHidParser@@@std@@PEAX@2@@?$_Tree@V?$_Tmap_traits@KPEAVGazeHidParser@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKPEAVGazeHidParser@@@std@@@3@$0A@@std@@@std@@IEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKPEAVGazeHidParser@@@std@@@std@@@std@@@1@_NPEAU?$_Tree_node@U?$pair@$$CBKPEAVGazeHidParser@@@std@@PEAX@1@AEAU?$pair@$$CBKPEAVGazeHidParser@@@1@1@Z @ 0x18008C7CC
 * Callers:
...
_QWORD *__fastcall std::_Tree<std::_Tmap_traits<unsigned long,GazeHidParser *,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,GazeHidParser *>>,0>>::_Insert_at<std::pair<unsigned long const,GazeHidParser *> &,std::_Tree_node<std::pair<unsigned long const,GazeHidParser *>,void *> *>(
        _QWORD *a1,
        _QWORD *a2,
        char a3,
        _QWORD *a4,
