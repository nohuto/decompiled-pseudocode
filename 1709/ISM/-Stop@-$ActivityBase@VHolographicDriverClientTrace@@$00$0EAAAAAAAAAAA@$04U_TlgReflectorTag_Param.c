/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800BB018
 * Callers:
        ...
        __int64 a1)
{
  ...
  RTL_SRWLOCK *v4; // rcx
  int v5; // edi
  struct HolographicDriverClientTrace *i; // rax
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
    i = HolographicDriverClientTrace::Instance();
    v7 = (const struct _TlgProvider_t *)*((_QWORD *)i + 1);
    if ( *(_DWORD *)v7 > 5u && (*((_QWORD *)v7 + 2) & 0x400000000000LL) != 0 )
    {
      i = (struct HolographicDriverClientTrace *)(*((_QWORD *)v7 + 3) & 0x400000000000LL);
      if ( i == *((struct HolographicDriverClientTrace **)v7 + 3) )
      {
        v12 = 0;
        v17 = 0;
        v15 = &v12;
        ...
        p_SRWLock = &SRWLock;
        v19 = 4;
        LODWORD(i) = TlgWrite(v7, &unk_1800F1035, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
      }
    }
  }
  else
  ...
  if ( *(_DWORD *)(a1 + 32) )
  {
    ...
    *((_DWORD *)v9 + 6) = 0;
    for ( i = (struct HolographicDriverClientTrace *)*v9; *(_QWORD *)i; *v9 = i )
    {
      v10 = (_QWORD **)**v9;
      if ( v10 == v9 )
      {
        i = (struct HolographicDriverClientTrace *)v9[2];
        **v9 = i;
        break;
      }
      i = (struct HolographicDriverClientTrace *)(v10 + 2);
    }
    *v9 = 0LL;
  }
  return (int)i;
