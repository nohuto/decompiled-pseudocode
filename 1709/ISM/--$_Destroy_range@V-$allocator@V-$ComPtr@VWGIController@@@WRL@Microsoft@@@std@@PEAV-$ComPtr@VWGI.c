/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@PEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@YAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@0AEAU?$_Wrap_alloc@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@0@@Z @ 0x18009EB64
 * Callers:
 *     _std::_Uninitialized_move_al_unchecked_Microsoft::WRL::ComPtr_WGIController______ptr64_Microsoft::WRL::ComPtr_WGIController______ptr64_std::allocator_Microsoft::WRL::ComPtr_WGIController______::_1_::catch$4 @ 0x1800D14E5 (_std--_Uninitialized_move_al_unchecked_Microsoft--WRL--ComPtr_WGIController______ptr64_Microsoft.c)
 * Callees:
