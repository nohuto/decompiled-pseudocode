/*
 * XREFs of McTemplateU0qqqqqqq @ 0x180005B08
 * Callers:
...
ULONG __fastcall McTemplateU0qqqqqqq(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        char a9)
{
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWriteUM(MinInput_Context, &MinInput_Log_InputInfo_Pointer, 8u, &v10);
}
