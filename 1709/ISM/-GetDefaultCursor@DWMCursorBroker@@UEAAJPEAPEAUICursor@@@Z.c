/*
 * XREFs of ?GetDefaultCursor@DWMCursorBroker@@UEAAJPEAPEAUICursor@@@Z @ 0x180025E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMCursorBroker::GetDefaultCursor(__int64 this, struct ICursor **a2)
{
  char *v2; // r9
  _DWORD *v4; // rax
  unsigned int v5; // edi
...
LABEL_5:
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      McTemplateU0qqq(this, &MinInput_Warning_CheckResult, 0, 530, 255);
  }
  else
  {
    LODWORD(this) = 0;
    ...
    {
      McTemplateU0qqq(v8, &MinInput_Warning_CheckResult, 0, 525, ValueForKey);
    }
  }
  return v5;
}
