/*
 * XREFs of ?Enqueue@?$DynamicSizeQueue@UInputInfo@@$09@@QEAAJAEBUInputInfo@@@Z @ 0x180016114
 * Callers:
...
LABEL_10:
  ...
  v6 = *a1;
  v7 = 2 * v2;
  v8 = (char *)operator new[](saturated_mul((unsigned int)(2 * v2), 0xB20uLL));
  *a1 = v8;
  v9 = v8;
  if ( v8 )
  {
    if ( *((_DWORD *)a1 + 3) )
    {
      v12 = 2848LL * (unsigned int)(*((_DWORD *)a1 + 2) - *((_DWORD *)a1 + 3));
      memcpy_0(v8, &v6[2848 * *((unsigned int *)a1 + 3)], v12);
    ...
    memcpy_0(v9, v6, 2848 * v11);
    memset(&(*a1)[2848 * *((unsigned int *)a1 + 2)], 0, 2848LL * *((unsigned int *)a1 + 2));
