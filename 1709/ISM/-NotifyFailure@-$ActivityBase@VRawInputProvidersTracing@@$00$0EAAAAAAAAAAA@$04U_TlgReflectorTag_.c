/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VRawInputProvidersTracing@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180096C00
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<RawInputProvidersTracing,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v4; // edx
  ...
  const wchar_t *v94; // [rsp+160h] [rbp+60h]
  ...
  const wchar_t *v117; // [rsp+210h] [rbp+110h]
  ...
  const wchar_t *v130; // [rsp+260h] [rbp+160h]
  ...
  const wchar_t *v138; // [rsp+290h] [rbp+190h]
  ...
  if ( v5 )
  {
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v38 = (const wchar_t *)*((_QWORD *)a2 + 11);
      v84 = v27 + 1;
      LODWORD(v27) = 0;
      v83 = v37;
      v39 = &word_1800DF514;
      ...
      v42 = (const wchar_t *)*((_QWORD *)a2 + 14);
      v92 = v27 + 1;
      LODWORD(v27) = 0;
      v91 = v41;
      v93 = 0;
      ...
      v102 = v27 + 1;
      v103 = 0;
      TlgWrite(v24, &unk_1800EF5B0, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v60);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x600000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v139 = 2 * v9 + 2;
      v140 = 0;
      TlgWrite(v6, &unk_1800F10DF, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
