/*
 * XREFs of ?StartActivity@TelemetryOpenHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x1800AFCEC
 * Callers:
        ...
        __int64 a4)
{
  ...
  PSRWLOCK *v25; // [rsp+68h] [rbp-19h]
  __int64 v26; // [rsp+70h] [rbp-11h]
  const char *v27; // [rsp+78h] [rbp-9h]
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( Local == *((struct HolographicDriverClientTrace **)v13 + 3) )
    {
      ...
      LODWORD(Local) = TlgWrite(v13, &unk_1800F15DD, (LPCGUID)(v18 + 8), v19, 6u, &pData);
    }
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
