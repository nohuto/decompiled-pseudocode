/*
 * XREFs of ??1CommandRegistrationToken@TestCommandHost@@QEAA@XZ @ 0x180009B84
 * Callers:
 *     ??1DWMCursor@@MEAA@XZ @ 0x1800266A0 (--1DWMCursor@@MEAA@XZ.c)
 *     _DWMCursor::_DWMCursor_::_1_::dtor$6 @ 0x1800CDAC1 (_DWMCursor--_DWMCursor_--_1_--dtor$6.c)
 * Callees:
