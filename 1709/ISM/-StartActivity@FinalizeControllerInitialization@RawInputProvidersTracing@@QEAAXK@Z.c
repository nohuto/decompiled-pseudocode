/*
 * XREFs of ?StartActivity@FinalizeControllerInitialization@RawInputProvidersTracing@@QEAAXK@Z @ 0x18008DD4C
 * Callers:
...
void __fastcall RawInputProvidersTracing::FinalizeControllerInitialization::StartActivity(
        ...
        int a2)
{
  ...
  *(_DWORD *)v3 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    TlgWrite(v7, &unk_1800F036A, (LPCGUID)(v9 + 8), v10, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
