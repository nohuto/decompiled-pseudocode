/*
 * XREFs of ?SetHapticsFeedback_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKGEG@Z @ 0x1800C34F0
 * Callers:
        ...
        char a7)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v18 = 1LL;
    v20 = 2LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_1800F283B, 0LL, 0LL, 8u, &pData);
  }
}
