/*
 * XREFs of ?GetDynamicNodeTrackingCapabilities_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_CAPABILITY_FLAGS@@@Z @ 0x1800B19B8
 * Callers:
        ...
        int a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 )
  {
    ...
    if ( v7 == *(struct HolographicDriverClientTrace **)(v8 + 24) )
    {
      ...
      v17 = 16LL;
      v19 = 4LL;
      LODWORD(v7) = TlgWrite((TraceLoggingHProvider)v8, &unk_1800F1529, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v7;
}
