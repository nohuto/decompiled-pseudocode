/*
 * XREFs of _MPCHolographicInputManager::ProcessCapture_::_1_::dtor$1 @ 0x1800CF006
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall MPCHolographicInputManager::ProcessCapture_::_1_::dtor_1(__int64 a1, __int64 a2)
{
