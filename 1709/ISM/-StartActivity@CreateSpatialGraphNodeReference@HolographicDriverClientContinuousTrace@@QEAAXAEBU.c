/*
 * XREFs of ?StartActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x1800B2DD4
 * Callers:
        ...
        int a4)
{
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
    ...
    LODWORD(Local) = TlgWrite(v12, &unk_1800F13C0, (LPCGUID)(v13 + 8), v14, 6u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
    v15 = a1 + 8;
