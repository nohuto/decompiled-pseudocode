/*
 * XREFs of ?IsMobile0DButtonDevice@MobileButtonDeviceCollection@@AEAAJPEAVHIDDevice@@PEA_N@Z @ 0x18009A004
 * Callers:
        ...
        bool *a3)
{
  ...
  else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v9 = 370;
LABEL_7:
    McTemplateU0qqq((__int64)v5, &MinInput_Warning_CheckResult, 0, v9, v8);
  }
  return (unsigned int)v8;
}
