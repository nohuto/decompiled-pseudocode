/*
 * XREFs of _std::_Tree_comp_alloc_std::_Tmap_traits__GUID_Input::PropertyTypeInfo_Input::KeyCompareTrait__GUID__std::allocator_std::pair__GUID_const__Input::PropertyTypeInfo____0___::_Buynode0_::_1_::catch$36 @ 0x1800CE40B
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_Tree_comp_alloc_std::_Tmap_traits__GUID_Input::PropertyTypeInfo_Input::KeyCompareTrait__GUID__std::allocator_std::pair__GUID_const__Input::PropertyTypeInfo____0___::_Buynode0_::_1_::catch_36(
        __int64 a1,
        __int64 a2)
{
