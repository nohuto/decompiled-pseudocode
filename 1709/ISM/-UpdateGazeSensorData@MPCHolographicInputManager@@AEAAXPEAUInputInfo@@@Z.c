/*
 * XREFs of ?UpdateGazeSensorData@MPCHolographicInputManager@@AEAAXPEAUInputInfo@@@Z @ 0x1800573A0
 * Callers:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  if ( *((_DWORD *)a2 + 174) == 8 )
  {
    *(_OWORD *)this = *(_OWORD *)((char *)a2 + 1320);
    *((_OWORD *)this + 1) = *(_OWORD *)((char *)a2 + 1336);
    *((_OWORD *)this + 2) = *(_OWORD *)((char *)a2 + 1352);
    *((_OWORD *)this + 3) = *(_OWORD *)((char *)a2 + 1368);
