/*
 * XREFs of ?FixupPrimaryGestureContact@@YAXPEAUtagPOINTERINFONODE@@IPEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@H@Z @ 0x1C01AE51C
 * Callers:
        ...
        int a5)
{
  ...
  if ( *((_DWORD *)a1 + 17) )
  {
    if ( a5 )
    {
      ...
      *((_DWORD *)a1 + 22) = gptCursorAsync[0];
      *((_DWORD *)a1 + 23) = gptCursorAsync[1];
      *((_QWORD *)a3 + 211) = v5;
