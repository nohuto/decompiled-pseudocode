/*
 * XREFs of ?AsyncWindowPos@@YAXPEAUtagSMWP@@@Z @ 0x1C01046C8
 * Callers:
  ...
  while ( v2 )
  {
    while ( 1 )
    {
      if ( *v1 )
      {
        v3 = v1[13];
        v4 = *(_QWORD *)(v3 + 408);
        if ( v4 != *(_QWORD *)(gptiCurrent + 408LL) )
          break;
      }
      v1 += 21;
      if ( !--v2 )
    ...
    if ( v8 )
    {
      ...
      *(_QWORD *)(v8 + 40) = v8 + 48;
      while ( v5 )
      {
        if ( *v10 )
        {
          if ( *(_QWORD *)(v10[13] + 408LL) == *(_QWORD *)(v3 + 408) )
          {
            --v5;
            *v11 = *(_OWORD *)v10;
            v12 = v11 + 8;
      ...
      if ( !(unsigned int)PostEventMessageEx((struct tagTHREADINFO *)v3, *(_QWORD *)(v3 + 408), 3u, 0LL, 0, v8, v3, 0LL) )
