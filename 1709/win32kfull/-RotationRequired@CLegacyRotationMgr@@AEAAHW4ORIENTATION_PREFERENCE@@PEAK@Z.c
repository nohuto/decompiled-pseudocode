/*
 * XREFs of ?RotationRequired@CLegacyRotationMgr@@AEAAHW4ORIENTATION_PREFERENCE@@PEAK@Z @ 0x1C01AC618
 * Callers:
...
_BOOL8 __fastcall CLegacyRotationMgr::RotationRequired(CLegacyRotationMgr *a1, int a2, unsigned int *a3)
{
  ...
  if ( dword_1C03267D8 )
  {
    if ( (v8 & 0xBFFFFFFF) != 0 )
    {
      ...
      {
        v9 = dword_1C03267C4;
        if ( !a2 || _bittest(&a2, ((_BYTE)dword_1C03267C4 + 1) & 3) )
          goto LABEL_36;
LABEL_13:
        if ( (a2 & 2) == 0 )
        {
  ...
  else if ( (v8 & 0xBFFFFFFF) != 0 )
  {
    ...
    {
      v9 = dword_1C03267C4;
      if ( !a2 || _bittest(&a2, dword_1C03267C4) )
        goto LABEL_36;
    }
    else
    {
