/*
 * XREFs of ?RealizePendingRecreateTouchInjectionDevices@@YAHPEAUtagPROCESSINFO@@H@Z @ 0x1C01BCB44
 * Callers:
  ...
  if ( gpTouchInjectorProcesses )
  {
    if ( v2 )
    {
      ...
      v5 = InitializeTouchInjectionWorker(
             *(unsigned int *)(*((_QWORD *)a1 + 106) + 28LL),
             *(unsigned int *)(*((_QWORD *)a1 + 106) + 24LL),
             a1);
    }
    if ( a2 )
    {
