/*
 * XREFs of ?vExpandAndCopyText@@YAXPEAVSURFACE@@PEAU_FONTOBJ@@PEAU_GLYPHPOS@@KPEAEKK00PEAU_RECTL@@4HHK44KPEAU_BRUSHOBJ@@PEAU_POINTL@@@Z @ 0x1C0011FE0
 * Callers:
        ...
        struct _POINTL *a19)
{
  ...
  LONG bottom; // edx
  int v52; // edx
  int v53; // [rsp+80h] [rbp-3A8h]
  LONG v54; // [rsp+98h] [rbp-390h]
  int v55; // [rsp+A8h] [rbp-380h]
  __int64 v56; // [rsp+B0h] [rbp-378h] BYREF
  struct _RECTL *v57; // [rsp+B8h] [rbp-370h]
  struct _POINTL v58; // [rsp+C0h] [rbp-368h] BYREF
  struct _RECTL v59; // [rsp+C8h] [rbp-360h] BYREF
  int v60; // [rsp+D8h] [rbp-350h]
  int v61; // [rsp+DCh] [rbp-34Ch]
  void * near *v62; // [rsp+E0h] [rbp-348h]
  __int64 v63; // [rsp+E8h] [rbp-340h] BYREF
  struct _POINTL *v64; // [rsp+F0h] [rbp-338h]
  struct _BRUSHOBJ *v65; // [rsp+F8h] [rbp-330h]
  struct SURFACE *v66; // [rsp+100h] [rbp-328h]
  _QWORD v67[2]; // [rsp+108h] [rbp-320h]
  __int64 v68; // [rsp+118h] [rbp-310h]
  _BYTE v69[80]; // [rsp+120h] [rbp-308h] BYREF
  char v70[56]; // [rsp+170h] [rbp-2B8h] BYREF
  unsigned int v71; // [rsp+1A8h] [rbp-280h]
  int v72; // [rsp+1ACh] [rbp-27Ch]
  unsigned __int8 *v73; // [rsp+1C0h] [rbp-268h]
  unsigned int v74; // [rsp+1C8h] [rbp-260h]
  int v75; // [rsp+1D0h] [rbp-258h]
  __int16 v76; // [rsp+1D4h] [rbp-254h]
  ...
  if ( (a14 & 1) != 0 || a4 <= 1 || (unsigned int)(a3->ptl.x - a3[a4 - 1].ptl.x + 0x8000000) <= 0x10000000 )
  {
    ...
    {
      if ( (a14 & 0x20) != 0 )
        v32 = (__int64 (__fastcall *)(int, int, int, int, int, int, int, int))vSrcAlphaCopyS8D32;
      else
