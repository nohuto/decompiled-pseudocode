/*
 * XREFs of cjFillPolygon @ 0x1C022CE40
 * Callers:
...
__int64 __fastcall cjFillPolygon(__int64 a1, int a2, _QWORD *a3, unsigned int a4)
{
  ...
  void (__fastcall *v38)(char *, _QWORD, _QWORD, _QWORD, int); // [rsp+48h] [rbp-70h]
  ...
  v38 = (void (__fastcall *)(char *, _QWORD, _QWORD, _QWORD, int))v15;
  v33 = 0;
  v16 = (unsigned __int16)(*(_WORD *)(v13 + 2LL * v12 - 2) + 1);
  v17 = v7;
  ...
  while ( v11 >= (unsigned __int64)v10 + 12 )
  {
    ...
    if ( v19 <= v20 )
    {
      ...
      do
      {
        ...
        if ( v41 < v32 )
          return 0xFFFFFFFFLL;
        v38(v30, (unsigned int)*v22, (unsigned int)*v23, v34, v35);
        v29 = v39;
        ++v19;
        v30 += 8;
        v32 += 8LL;
