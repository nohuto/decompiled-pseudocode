/*
 * XREFs of ?CheckProcessIdentity@@YAHPEAUtagWND@@I_K_J@Z @ 0x1C00DFDC0
 * Callers:
 *     ?xxxWrapDesktopWndProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C00DF400 (-xxxWrapDesktopWndProc@@YA_JPEAUtagWND@@I_K_J1@Z.c)
...
__int64 __fastcall CheckProcessIdentity(struct tagWND *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( a1 != (struct tagWND *)-1LL )
  {
    ...
    if ( v6 != 717 )
    {
      ...
      if ( v13 )
      {
        MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, v6, a3, a4, 1, v12 + 2);
      }
      else
      {
        ...
        {
          MSGSQMAddMessage(v9, (struct tagPROCESSINFO *)v10, v6, a3, a4, 1, gbEnforceUIPI != 0 ? 5 : 1);
          v13 = 1;
        }
        else
        {
          ...
          {
            v19 = *((_QWORD *)a1 + 2);
            if ( *(struct tagWND **)(v19 + 1352) == a1 && *(_QWORD *)(v19 + 408) == *(_QWORD *)(gptiCurrent + 408LL) )
              return 1LL;
          }
