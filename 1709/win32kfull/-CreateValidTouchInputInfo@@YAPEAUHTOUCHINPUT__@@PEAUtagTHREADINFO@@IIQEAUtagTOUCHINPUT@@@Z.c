/*
 * XREFs of ?CreateValidTouchInputInfo@@YAPEAUHTOUCHINPUT__@@PEAUtagTHREADINFO@@IIQEAUtagTOUCHINPUT@@@Z @ 0x1C01BCA58
 * Callers:
...
LABEL_3:
  ...
  v21[1] = a3;
  v22 = a4;
  v14 = CopyTouchInputListSorted((const struct tagTOUCHINPUTLIST *)v21, (struct tagTOUCHINPUTLIST *)v18, v13, &v23);
  v17 = v19;
  if ( v14 )
