/*
 * XREFs of ?ulClearTypeFilter_6x5@@YAKPEAU_GLYPHBITS@@PEAU_GLYPHDATA@@PEAVRFONT@@@Z @ 0x1C00D4DE4
 * Callers:
 ...
 * Callees:
 *     ?interpolatePixel_6x5@@YAEEEEEE@Z @ 0x1C00D5380 (-interpolatePixel_6x5@@YAEEEEEE@Z.c)
...
__int64 __fastcall ulClearTypeFilter_6x5(struct _GLYPHBITS *a1, struct _GLYPHDATA *a2, struct RFONT *a3)
{
  ...
  switch ( cy )
  {
    ...
    case 2:
      ...
      if ( (_DWORD)cx )
      {
        v44 = _mm_loadu_si128(&v64);
        v45 = cx;
        do
        {
          v46 = (char *)_mm_srli_si128(v44, 8).m128i_u64[0];
          v47 = (unsigned __int8 *)v44.m128i_i64[0];
          v44 = _mm_add_epi64(v44, (__m128i)_xmm);
          *aj++ = interpolatePixel_6x5(0, 0, 0, *v47, *v46);
          --v45;
        }
        while ( v45 );
        v7 = v69;
    ...
    case 3:
      ...
      {
        v51 = (char *)v65;
        v52 = (unsigned __int8 *)v64.m128i_i64[1];
        v53 = (unsigned __int8 *)v64.m128i_i64[0];
        do
        {
          v54 = *v52;
          v55 = *v53;
          ...
          ++v53;
          ++v51;
          *aj++ = interpolatePixel_6x5(0, 0, v55, v54, v59);
          --cx;
        }
        while ( cx );
        v7 = v69;
    ...
    case 4:
      ...
      if ( (_DWORD)cx )
      {
        ...
        do
        {
          v38 = *v66;
          v39 = *v65;
          v40 = *(_BYTE *)v64.m128i_i64[1];
          v41 = *(_BYTE *)v64.m128i_i64[0];
          for ( i = 0LL; i < 4; i += 2LL )
            *(__m128i *)((char *)&v64 + 8 * i) = _mm_add_epi64(
                                                   _mm_loadu_si128((__m128i *)((char *)&v64 + 8 * i)),
                                                   (__m128i)_xmm);
          *aj++ = interpolatePixel_6x5(0, v41, v40, v39, v38);
          --v37;
        }
        while ( v37 );
        v7 = v69;
  ...
  switch ( v60 )
  {
    case 4:
      if ( (_DWORD)cx )
      {
        ...
        {
          v43 = *v11++;
          *aj++ = interpolatePixel_6x5(v43, 0, 0, 0, 0);
          --v10;
        }
        while ( v10 );
      }
    ...
    case 3:
      if ( (_DWORD)cx )
      {
        ...
        while ( 1 )
        {
          v56 = _mm_add_epi64(v56, (__m128i)_xmm);
          v57 = *v26;
          v58 = *v11;
          v64 = v56;
    ...
    case 2:
      if ( (_DWORD)cx )
      {
        ...
        do
        {
          ...
          ++v27;
          ++v26;
          *aj = interpolatePixel_6x5(aj[v48], v50, v49, 0, 0);
          ++aj;
          --v10;
        }
        while ( v10 );
