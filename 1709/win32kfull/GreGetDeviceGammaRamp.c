/*
 * XREFs of GreGetDeviceGammaRamp @ 0x1C00F6FA8
 * Callers:
 *     PrepareGammaRampData @ 0x1C00F6DC0 (PrepareGammaRampData.c)
 *     NtGdiGetDeviceGammaRamp @ 0x1C0291740 (NtGdiGetDeviceGammaRamp.c)
 * Callees:
 ...
 *     GreGetDeviceGammaRampInternal @ 0x1C00F704C (GreGetDeviceGammaRampInternal.c)
 */
...
__int64 __fastcall GreGetDeviceGammaRamp(HDC a1, __int64 a2)
{
  ...
  if ( v6 )
  {
    if ( !*((_DWORD *)v6 + 8) )
    {
      ...
      DeviceGammaRampInternal = GreGetDeviceGammaRampInternal(*((_QWORD *)v6 + 6), a2);
