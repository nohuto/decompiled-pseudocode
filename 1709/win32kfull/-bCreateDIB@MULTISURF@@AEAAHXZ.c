/*
 * XREFs of ?bCreateDIB@MULTISURF@@AEAAHXZ @ 0x1C0281A24
 * Callers:
 *     ?bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z @ 0x1C0281EE8 (-bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z.c)
 * Callees:
...
__int64 __fastcall MULTISURF::bCreateDIB(MULTISURF *this)
{
  ...
  v15 = v3;
  v14 = v5;
  ERECTL::operator*=(&v12, (_DWORD *)this + 2);
  v16[0] = 0;
  v16[1] = 0;
  v16[2] = v14 - v12;
  v16[3] = v15 - v13;
  ...
  if ( SURFMEM::bCreateDIB(
         ...
         0,
         0)
    && (v8 = *(void (__fastcall **)(__int64, __int64, _QWORD, _QWORD, _DWORD *, int *))(v4 + 2856)) != 0LL )
  {
    v8(
    ...
    *((_DWORD *)this + 18) = *v9 - v12;
    *((_DWORD *)this + 19) = v9[1] - v13;
    *((_DWORD *)this + 20) = v9[2] - v12;
    *((_DWORD *)this + 21) = v9[3] - v13;
  }
  else
  {
    return 0;
