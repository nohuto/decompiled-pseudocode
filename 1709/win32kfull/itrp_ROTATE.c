/*
 * XREFs of itrp_ROTATE @ 0x1C02D1810
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall itrp_ROTATE(__int64 a1)
{
  ...
  if ( (qword_1C0327C90 ^ *(_QWORD *)qword_1C0327C90 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0327C90 + 424)) == *(_QWORD *)(qword_1C0327C90 + 432)
    && (v2 = qword_1C0327C78, (unsigned __int64)((qword_1C0327C78 - *(_QWORD *)qword_1C0327C90) >> 2) >= 3) )
  {
    v3 = *(_DWORD *)(qword_1C0327C78 - 8);
    *(_DWORD *)(qword_1C0327C78 - 8) = *(_DWORD *)(qword_1C0327C78 - 4);
