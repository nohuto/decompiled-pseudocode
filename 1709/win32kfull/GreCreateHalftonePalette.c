/*
 * XREFs of GreCreateHalftonePalette @ 0x1C0292144
 * Callers:
 *     CreateDIBPalette @ 0x1C01F4868 (CreateDIBPalette.c)
 * Callees:
 ...
 *     ??1NEEDGRELOCK@@QEAA@XZ @ 0x1C01A0B18 (--1NEEDGRELOCK@@QEAA@XZ.c)
 */
...
__int64 __fastcall GreCreateHalftonePalette(HDC a1)
{
  ...
  if ( v16[0] )
  {
      ...
      || (unsigned int)PDEVOBJ::bEnableHalftone((PDEVOBJ *)&v18, 0LL) )
    {
      ...
      {
        v10 = *(unsigned int **)(v17 + 120);
      }
      else
      {
        v9 = logDefaultPal[1];
        v10 = (unsigned int *)&logDefaultPal[2];
      }
