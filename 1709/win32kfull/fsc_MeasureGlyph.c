/*
 * XREFs of fsc_MeasureGlyph @ 0x1C02BAC28
 * Callers:
 *     fs_FindBitMapSize @ 0x1C02B4CD4 (fs_FindBitMapSize.c)
 * Callees:
 *     FindExtrema @ 0x1C02B9FF0 (FindExtrema.c)
 ...
 *     GetIxEstimate @ 0x1C02C6E4C (GetIxEstimate.c)
 *     fsc_AddXReversal @ 0x1C02C71B4 (fsc_AddXReversal.c)
 *     fsc_AddYReversal @ 0x1C02C71F8 (fsc_AddYReversal.c)
 */
