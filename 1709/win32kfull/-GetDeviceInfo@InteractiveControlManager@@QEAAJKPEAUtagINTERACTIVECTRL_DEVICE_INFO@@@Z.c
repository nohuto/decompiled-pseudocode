/*
 * XREFs of ?GetDeviceInfo@InteractiveControlManager@@QEAAJKPEAUtagINTERACTIVECTRL_DEVICE_INFO@@@Z @ 0x1C021B5D0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1C0320190 > 4 )
  {
    ...
    v18 = a2;
    v26 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0320190, &unk_1C02E8EAB, (LPCGUID)a3, a4, 4u, &pData);
  }
