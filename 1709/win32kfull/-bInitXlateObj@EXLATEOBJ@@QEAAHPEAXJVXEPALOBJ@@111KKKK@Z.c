/*
 * XREFs of ?bInitXlateObj@EXLATEOBJ@@QEAAHPEAXJVXEPALOBJ@@111KKKK@Z @ 0x1C0022CE0
 * Callers:
...
LABEL_3:
        ...
        if ( *(_DWORD *)(v28 + 20) == v27 )
        {
          ...
          if ( *(_DWORD *)(v31 + 28) == v29 )
          {
            ...
            *a1 = (__int64)v32;
            ...
            if ( (v33 & 0x6000) == a11 )
            {
              if ( (v34 = v32[1], (v34 & 4) == 0 && (v33 & 0x100) == 0)
                || (v34 & 4) != 0
                && a10 == v32[6]
  ...
  result = CreateXlateObject(a2, a3, a4, v13, v20, v11, a8, a9, a10, a11);
  *a1 = result;
  if ( result )
  {
