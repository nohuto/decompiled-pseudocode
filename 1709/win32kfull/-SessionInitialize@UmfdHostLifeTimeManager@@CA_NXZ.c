/*
 * XREFs of ?SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ @ 0x1C00FEA94
 * Callers:
...
char UmfdHostLifeTimeManager::SessionInitialize(void)
{
  ...
  if ( !UmfdHostLifeTimeManager::s_WinlogonCallbackEvent )
    return 0;
  UmfdHostLifeTimeManager::s_SessionRasterizerInitializedEvent = (PVOID)Win32AllocPoolNonPaged(24LL, 1986348102LL);
  if ( !UmfdHostLifeTimeManager::s_SessionRasterizerInitializedEvent )
    return 0;
  UmfdHostLifeTimeManager::s_InitialFontsAddedEvent = (PVOID)Win32AllocPoolNonPaged(24LL, 1986348102LL);
  ...
  KeInitializeEvent((PRKEVENT)UmfdHostLifeTimeManager::s_InitialFontsAddedEvent, NotificationEvent, 0);
