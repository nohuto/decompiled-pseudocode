/*
 * XREFs of ?bCalculateWishCell@MAPPER@@AEAAHXZ @ 0x1C00ADA24
 * Callers:
...
__int64 __fastcall MAPPER::bCalculateWishCell(MAPPER *this)
{
  ...
  if ( (v3 & 0x20) == 0 )
  {
    ...
    EXFORMOBJ::vQuickInit((EXFORMOBJ *)&v17, *(struct XDCOBJ **)this, 516);
    v6 = 0;
    ...
    {
      if ( v4 != 900 * (v4 / 900)
        || (v11 = (v9 + v8) | (v7 - v10) | ((unsigned __int8)v7 ^ (unsigned __int8)~(_BYTE)v8) & 1u) != 0 )
      {
    ...
    if ( *(_DWORD *)(*((_QWORD *)this + 1) + 4LL) && (v14 & 0x10) == 0 )
    {
      v18 = 0;
      bFToL(v11, &v18, 0LL);
      v16 = v18;
