/*
 * XREFs of ?xxxPoke@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C01F1248
 * Callers:
  ...
  if ( v6 == 2 )
  {
    if ( (*((_WORD *)v8 + 36) & 0x2000) != 0 )
    {
      ...
      v13 = (unsigned int)GiveObject(
                            *((unsigned __int16 *)v8 + 37),
                            v10,
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 6) + 16LL) + 400LL) + 56LL)) == 0;
      v14 = v18;
      if ( !v13 )
        v14 = v18 | 0x4000;
      v15 = v14 | 0x400;
    ...
    else
    {
      v13 = (unsigned int)AddPublicObject(
                            *((unsigned __int16 *)v8 + 37),
                            *((void **)v8 + 6),
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 5) + 16LL) + 400LL) + 56LL)) == 0;
      v15 = v18;
      if ( !v13 )
        v15 = v18 | 0x2000;
    }
