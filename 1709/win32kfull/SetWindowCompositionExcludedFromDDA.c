/*
 * XREFs of SetWindowCompositionExcludedFromDDA @ 0x1C020C434
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludedFromDDA(struct tagWND *a1, __int128 *a2)
{
  unsigned int v4; // ebx
  int v5; // r8d
  __int64 v6; // rcx
  ...
  if ( (unsigned int)GetWindowCompositionInfo((__int64)a1, (__int64)v9) )
  {
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 24, a2);
    }
  }
  return v4;
}
