/*
 * XREFs of ?bCalculateAndDrawTriangle@@YAHPEAVSURFACE@@PEAU_TRIVERTEX@@11PEAU_TRIANGLEDATA@@P6AX02@Z@Z @ 0x1C013086C
 * Callers:
 ...
 *     ?bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1C01310C4 (-bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
        ...
        void (*a6)(struct SURFACE *, struct _TRIANGLEDATA *))
{
  ...
  v9 = lCalculateTriangleArea(v7, v8, v6, a5);
  if ( !v9 )
    return 0LL;
  if ( v9 < 0 )
  {
    ...
    v8 = v6;
    v6 = v21;
    if ( (int)lCalculateTriangleArea(v7, v8, v21, v10) <= 0 )
      return 0LL;
  }
  y = *((_DWORD *)a5 + 1);
  if ( v7->y > y )
  ...
  *((_DWORD *)a5 + 29) = v13;
  ...
  if ( v6->Blue > 0xFF00u )
    v6->Blue = -256;
  bCalulateColorGradient(v7, v8, v6, a5);
  vCalculateLine(v7, v8, a5);
  vCalculateLine(v8, v6, a5);
  vCalculateLine(v6, v7, a5);
