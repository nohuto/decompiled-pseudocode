/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x1C024A758
 * Callers:
 *     NtGdiDestroyPhysicalMonitor @ 0x1C024AB40 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::DestroyPhysicalMonitor(CMonitorAPI *this, void *a2)
{
  ...
  v7 = this;
  v2 = (struct CMutex *)qword_1C0327BA0;
  CAutoMutex::CAutoMutex((CAutoMutex *)&v8, (struct CMutex *)((char *)qword_1C0327BA0 + 32));
