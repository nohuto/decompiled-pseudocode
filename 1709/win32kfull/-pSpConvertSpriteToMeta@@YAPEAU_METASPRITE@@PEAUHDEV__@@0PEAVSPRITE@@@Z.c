/*
 * XREFs of ?pSpConvertSpriteToMeta@@YAPEAU_METASPRITE@@PEAUHDEV__@@0PEAVSPRITE@@@Z @ 0x1C025DB34
 * Callers:
...
struct _METASPRITE *__fastcall pSpConvertSpriteToMeta(_DWORD *a1, _DWORD *a2, struct SPRITE *a3)
{
  ...
  _DWORD *v21; // rax
  __int64 v23; // rdx
  __int64 *v24[30]; // [rsp+20h] [rbp-99h] BYREF
      ...
      if ( v6 )
      {
        ...
        if ( a1[35] )
        {
          while ( 1 )
          {
            ...
            *((_QWORD *)a3 + 24) = 0LL;
            v16 = *((_DWORD *)a3 + 29) + a2[651] - *((_DWORD *)v26 + 651);
            v27.x = *((_DWORD *)a3 + 28) + a2[650] - *((_DWORD *)v26 + 650);
            v27.y = v16;
...
LABEL_8:
          ...
          *((_QWORD *)a1 + 19) = v6;
          ...
          {
            for ( i = 0; i < a1[35]; ++i )
              pSpHintSpriteShape((struct SPRITE *)v6[i + 4], *((HSURF *)a3 + 30), 0);
            *(_DWORD *)v6 |= 0x40u;
          }
