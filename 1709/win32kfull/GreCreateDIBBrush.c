/*
 * XREFs of GreCreateDIBBrush @ 0x1C013D6AC
 * Callers:
 ...
 *     ??1BRUSHMEMOBJ@@QEAA@XZ @ 0x1C013D88C (--1BRUSHMEMOBJ@@QEAA@XZ.c)
...
LABEL_20:
  ...
  BRUSHMEMOBJ::BRUSHMEMOBJ((BRUSHMEMOBJ *)v40, v25, a6, 0, a2, 0x80u, a5);
  if ( v40[0] )
  {
    v41 = 1;
