/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01D8484
 * Callers:
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01D8B78 (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
 */
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  v24 = a1;
  v6 = (*((_DWORD *)a2 + 49) >> 15) & 7;
  v7 = *(_DWORD *)*gpDispInfo > 1u && (unsigned int)v6 < 6;
  ComputeSourceRectAndMonitorWithPrecision(a2, &v24, v22, &v23);
  v8 = *((_BYTE *)v22[0] + 4 * v6 + 537);
  v9 = *((_BYTE *)v22[0] + 4 * v6 + 536);
  v10 = *((_BYTE *)v22[0] + 4 * v6 + 539);
  if ( v7 )
  {
    if ( !v8 )
      v8 = gWinArrGlobal[dword_1C02E4414[4 * (unsigned int)v6]];
    if ( !v9 )
      v9 = gWinArrGlobal[dword_1C02E4410[4 * (unsigned int)v6]];
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02E441C[4 * (unsigned int)v6]];
  }
  v11 = v23;
