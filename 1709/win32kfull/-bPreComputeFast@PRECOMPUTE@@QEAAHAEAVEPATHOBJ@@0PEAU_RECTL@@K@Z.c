/*
 * XREFs of ?bPreComputeFast@PRECOMPUTE@@QEAAHAEAVEPATHOBJ@@0PEAU_RECTL@@K@Z @ 0x1C02A7C84
 * Callers:
        ...
        char a5)
{
  ...
  if ( (unsigned int)v5 > 0x14 )
  {
    if ( (unsigned __int64)(48 * v5) > 0xFFFFFFFF )
      return 0LL;
    v10 = 0;
    v26 = PALLOCMEM2((unsigned int)(48 * v5), 1734632775LL, 0);
    v9 = v26;
    if ( !v26 )
      return 0LL;
    v27 = 1;
...
LABEL_37:
        ...
        {
          if ( (_DWORD)v16 )
            v25 = PRECOMPUTE::bAddPreComputedFastStrokeRects((PRECOMPUTE *)v20, (__int64)a3, &v35, 0x14u);
          else
            v25 = PRECOMPUTE::bAddPreComputedFastFillRects((PRECOMPUTE *)v20, (__int64)a3, &v35, 0x14u);
          if ( !v25 )
          {
            v8 = 1;
            goto LABEL_53;
...
LABEL_44:
    ...
    if ( v13 )
    {
      ...
      {
        v9 = v26;
        if ( !(unsigned int)PRECOMPUTE::bAddPreComputedFastStrokeRects((PRECOMPUTE *)v31, (__int64)a3, &v35, v13) )
          v8 = 1;
        goto LABEL_54;
      }
      if ( !(unsigned int)PRECOMPUTE::bAddPreComputedFastFillRects((PRECOMPUTE *)v31, (__int64)a3, &v35, v13) )
        v8 = 1;
    }
LABEL_53:
    v9 = v26;
