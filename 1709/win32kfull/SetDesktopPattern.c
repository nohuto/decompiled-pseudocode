/*
 * XREFs of SetDesktopPattern @ 0x1C00F9308
 * Callers:
 ...
 *     ?SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z @ 0x1C01F7FD0 (-SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z.c)
 */
...
__int64 __fastcall SetDesktopPattern(__int64 a1, const wchar_t *a2)
{
  ...
  if ( !a2 )
  {
    if ( !(unsigned int)FastGetProfileStringFromIDW(a1, 4LL, 2LL, &word_1C02D9FB8, v15, 260, 0) )
      return v4;
    a2 = v15;
  }
  ...
  {
    SolidBrush = GreCreateSolidBrush(*(unsigned int *)(gpsi + 4556LL));
    if ( SolidBrush )
    {
      v6 = *(HBRUSH *)(gpsi + 4688LL);
      if ( v6 )
      {
