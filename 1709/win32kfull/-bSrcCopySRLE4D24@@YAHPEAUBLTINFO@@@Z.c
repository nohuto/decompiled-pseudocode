/*
 * XREFs of ?bSrcCopySRLE4D24@@YAHPEAUBLTINFO@@@Z @ 0x1C02A5AE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D24(struct BLTINFO *a1)
{
  ...
  int v62; // [rsp+Ch] [rbp-4Ch]
  BOOL v63; // [rsp+10h] [rbp-48h]
  int v64; // [rsp+14h] [rbp-44h]
  int v65; // [rsp+18h] [rbp-40h]
  int v66; // [rsp+1Ch] [rbp-3Ch]
  unsigned int v67; // [rsp+20h] [rbp-38h]
  __int64 v68; // [rsp+28h] [rbp-30h]
  int v69; // [rsp+30h] [rbp-28h]
  unsigned int v70; // [rsp+38h] [rbp-20h]
  int v71; // [rsp+3Ch] [rbp-1Ch]
  ...
  while ( 1 )
  {
    ...
    if ( v5 < v65 && v7 < v3 && (int)(v13 + v7) > v2 )
    {
      ...
      v45 = v13 + v7;
      v46 = v13 >> 1;
      v47 = *(_DWORD *)(v68 + 4 * (v15 >> 4));
      v70 = v47;
      v58 = v47;
      v48 = *(_DWORD *)(v68 + 4 * v44);
      v59 = v48;
      if ( v46 )
      {
    ...
    if ( (_DWORD)v15 != 2 )
    {
      ...
      else
      {
        ...
        if ( v26 )
        {
          ...
          {
            v29 = *v4++;
            v30 = *(_DWORD *)(v68 + 4 * (v29 >> 4));
            v31 = *(_DWORD *)(v68 + 4 * (v29 & 0xF));
            *(_BYTE *)(v19 + v6) = v30;
        ...
        if ( v24 )
        {
          v35 = *(_DWORD *)(v68 + 4 * ((unsigned __int64)*v4 >> 4));
          *(_BYTE *)(v19 + v6) = v35;
