/*
 * XREFs of ?ValidatePointer@InkDevice@@AEBAJI@Z @ 0x1C02201B4
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)v19 = 0LL;
  PointerInfoByPointerId = Pointer::GetPointerInfoByPointerId((Pointer *)a2, v19, a3, a4);
  v9 = PointerInfoByPointerId;
  if ( PointerInfoByPointerId >= 0 )
  {
    LOBYTE(v6) = 19;
    v10 = *(_QWORD *)(HMValidateHandleNoSecure(*(_QWORD *)(*(_QWORD *)v19 + 16LL), v6, (__int64)v7, (__int64)v8) + 472);
    if ( *(_DWORD *)(v10 + 24) == 5 )
    {
      v13 = *(_QWORD *)(v10 + 16);
      v14 = *(_DWORD *)(v13 + 1400);
          ...
          && *(unsigned __int16 *)(v15 + 110) == *((_DWORD *)this + 33) )
        {
          ...
          if ( v16 && *v16 )
          {
            if ( !byte_1C0334030 )
            {
              ...
              {
                TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E9414, v11, v12, 2u, &pData);
              }
              byte_1C0334030 = 1;
            }
            v9 = -1073741811;
            if ( (unsigned int)pRelatedActivityId > 2 )
            {
              ...
              v24 = 45LL;
              TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E8C52, v11, v12, 4u, &pData);
            }
          }
        }
        else
    ...
    else
    {
      ...
      if ( (unsigned int)pRelatedActivityId > 2 )
      {
        ...
        v24 = 29LL;
        v26 = 1LL;
        TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E9198, v11, v12, 5u, &pData);
      }
    }
  }
  else if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v24 = 37LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E8C52, v7, v8, 4u, &pData);
  }
  return v9;
}
