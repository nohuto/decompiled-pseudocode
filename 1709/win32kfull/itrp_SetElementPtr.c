/*
 * XREFs of itrp_SetElementPtr @ 0x1C02D42A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    && (qword_1C0327C78 - *(_QWORD *)qword_1C0327C90) >> 2 )
  {
    ...
    if ( (unsigned int)v2 <= 1 )
    {
      ...
      if ( v3 )
      {
        ...
        if ( !v4 )
        {
          qword_1C0327C58 = qword_1C0327C88 + 112 * v2;
          goto LABEL_10;
        }
        v5 = v4 - 1;
        if ( !v5 )
        {
          qword_1C0327C60 = qword_1C0327C88 + 112 * v2;
          goto LABEL_10;
        }
        if ( v5 != 1 )
        {
LABEL_10:
      ...
      LocalGS = qword_1C0327C88 + 112 * v2;
      goto LABEL_10;
    }
