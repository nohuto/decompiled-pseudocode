/*
 * XREFs of itrp_CheckSingleWidth @ 0x1C02CA66C
 * Callers:
...
__int64 __fastcall itrp_CheckSingleWidth(int a1)
{
  ...
  v1 = qword_1C0327C90;
  if ( dword_1C0327CD0 == 2 )
  {
    fixed = *(_DWORD *)(qword_1C0327C90 + 112);
  }
  else if ( dword_1C0327CD0 == 3 )
  {
    CVTScale = itrp_GetCVTScale();
    fixed = FixMul(*(_DWORD *)(qword_1C0327C90 + 112), CVTScale);
  }
  else
  {
