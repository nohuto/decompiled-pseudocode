/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C00B3D88
 * Callers:
        ...
        int a10)
{
  ...
  WCHAR v35[32]; // [rsp+68h] [rbp-59h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 88LL) = _InterlockedIncrement(&dword_1C032B8F8);
  ...
  if ( v21 )
  {
    *(_DWORD *)(*(_QWORD *)this + 136LL) = 0;
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 32LL) + 40LL) )
    {
      ...
      cCapString(v35, (WCHAR *)(v18 + *v32), 32);
      if ( v22 < v23 )
      {
        v24 = v35[0];
        v25 = v22 + 195;
        do
        {
          if ( !(*v25 | *(v25 - 66)) )
          {
            ...
            if ( v24 == *(_WORD *)(v25 - 65) )
            {
              ...
              {
                v28 = *++v26;
                if ( *v26 != *(WCHAR *)((char *)v26 + v25 - &v36) )
                  goto LABEL_31;
              }
              *(_BYTE *)((unsigned int)(*(_DWORD *)(*(_QWORD *)this + 136LL))++ + *(_QWORD *)this + 144LL) = (v25 - (_BYTE *)gpfsTable - 195) / 196;
              v24 = v35[0];
            }
          }
LABEL_31:
