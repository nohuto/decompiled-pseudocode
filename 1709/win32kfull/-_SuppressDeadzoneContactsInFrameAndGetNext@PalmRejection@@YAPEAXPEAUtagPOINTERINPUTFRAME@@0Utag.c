/*
 * XREFs of ?_SuppressDeadzoneContactsInFrameAndGetNext@PalmRejection@@YAPEAXPEAUtagPOINTERINPUTFRAME@@0UtagPOINT@@@Z @ 0x1C01E085C
 * Callers:
    ...
    do
    {
      ...
      if ( (unsigned int)IsPointerInfoNodeValid((const struct tagPOINTERINFONODE *)v10) )
      {
        if ( (*(_DWORD *)(v10 + 68) & 0x10000) != 0
          && (v11 = *(_QWORD *)(v10 + 112),
              v15[0] = *(_OWORD *)(*((_QWORD *)a2 + 13) + 176LL),
