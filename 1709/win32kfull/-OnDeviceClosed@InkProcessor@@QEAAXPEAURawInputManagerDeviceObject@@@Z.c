/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C02190D0
 * Callers:
 ...
 *     ?OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C020BC20 (-OnDeviceClosed@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
