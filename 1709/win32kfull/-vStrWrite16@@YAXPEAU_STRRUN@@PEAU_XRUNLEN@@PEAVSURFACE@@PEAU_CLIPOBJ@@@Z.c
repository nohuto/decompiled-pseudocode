/*
 * XREFs of ?vStrWrite16@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C029C3F0
 * Callers:
 *     <none>
 * Callees:
            ...
            while ( v4 != v7 )
            {
              ...
              if ( v26 >= rclBounds.left )
              {
                ...
                if ( v26 < (int)v20 )
                  v28 = v25 + *(_DWORD *)v4;
                v29 = v28 - left;
                v30 = (_WORD *)(v23 + 2LL * left);
                v31 = v30;
                if ( left < v28 )
                {
                  v32 = left - v24;
                  v33 = v29;
                  v34 = (int *)((char *)v4 + 4 * v32 + 8);
                  do
                  {
                    v35 = *(_WORD *)v34++;
                    *v31++ = v35;
              ...
              v4 = (struct _XRUNLEN *)((char *)v4 + 4 * v25 + 8);
            }
          }
        }
      }
...
LABEL_56:
        ...
        while ( v40 )
        {
          ...
          if ( v39 >= rclBounds.top && v39 < rclBounds.bottom )
          {
            ...
            v42 = v4;
            for ( i = v41; v42 != v7; v42 = (struct _XRUNLEN *)((char *)v42 + 4 * *((int *)v42 + 1) + 8) )
            {
              v43 = *(int *)v42;
