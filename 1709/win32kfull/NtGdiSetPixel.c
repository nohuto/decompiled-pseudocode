/*
 * XREFs of NtGdiSetPixel @ 0x1C002AA00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  {
    v11 = (unsigned __int64)v9 + 336;
    v41 = (char *)v9 + 336;
  }
  if ( (*(_BYTE *)(v11 + 32) & 0x43) != 0x43 )
  {
  ...
  *(_QWORD *)&v63 = __PAIR64__(a3, v5);
  ...
  if ( DEVLOCKOBJ::bLock((DEVLOCKOBJ *)&v54, (struct XDCOBJ *)&v36, 0) )
  {
    ...
    if ( (unsigned __int64)(v16 + SDWORD1(v63) + 0x80000000LL) > 0xFFFFFFFF )
      goto LABEL_74;
    if ( (unsigned __int64)(v16 + SHIDWORD(v63) + 0x80000000LL) > 0xFFFFFFFF )
      goto LABEL_74;
    v17 = v15 + v63;
    LODWORD(v63) = v17;
    v18 = (unsigned int)(*((_DWORD *)v14 + 358) + DWORD2(v63));
    DWORD2(v63) += *((_DWORD *)v14 + 358);
    v19 = *((_DWORD *)v14 + 359) + DWORD1(v63);
    DWORD1(v63) = v19;
    v20 = *((_DWORD *)v14 + 359) + HIDWORD(v63);
    HIDWORD(v63) = v20;
...
LABEL_74:
    ...
    if ( v17 >= *((_DWORD *)v36 + 354)
      && (int)v18 <= *((_DWORD *)v36 + 356)
      && v19 >= *((_DWORD *)v36 + 355)
      && v20 <= *((_DWORD *)v36 + 357) )
    {
LABEL_38:
      if ( (*(_DWORD *)(v13 + 116) & 8) == 0 && !*(_QWORD *)(v13 + 232)
        || (v18 = 512LL, (*(_WORD *)(v13 + 102) & 0x200) == 0) )
      {
        v23 = *(_DWORD *)(v13 + 112);
        if ( (v23 & 0x800) != 0 )
        {
          v24 = UserSurfaceAccessCheck(*(_QWORD *)(v13 + 584), v18);
        }
        else
        {
          if ( (v23 & 0x10000000) == 0 )
...
LABEL_47:
            ...
            {
              v62 = v63;
              XDCOBJ::vAccumulateTight((XDCOBJ *)&v36, (struct ECLIPOBJ *)v18, (struct ERECTL *)&v62);
              v12 = v36;
            }
            v25 = *((_QWORD *)v12 + 12);
            v26 = *(_QWORD *)(v13 + 128);
            ...
            if ( (*(_DWORD *)(v13 + 112) & 1) != 0 )
              v33 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, _QWORD, __int128 *, _QWORD, _QWORD, unsigned int *, char *, int))(*(_QWORD *)(v13 + 48) + 2848LL))(
                      v31,
                      0LL,
                      0LL,
                      0LL,
          ...
          v24 = UserScreenAccessCheck(v12, v18);
        }
        if ( v24 )
        {
          v12 = v36;
