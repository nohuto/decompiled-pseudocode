/*
 * XREFs of ?hGetHandleFromFilePath@@YAPEAXPEBGH@Z @ 0x1C00B6668
 * Callers:
 ...
 *     ?PffDuplicateFileHandle@@YAJPEAVPFF@@PEAU_EPROCESS@@1PEAPEAX@Z @ 0x1C024B2C0 (-PffDuplicateFileHandle@@YAJPEAVPFF@@PEAU_EPROCESS@@1PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
