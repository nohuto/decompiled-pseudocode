/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C00B2304
 * Callers:
 *     bAddFlEntry @ 0x1C00B1C44 (bAddFlEntry.c)
 *     bDeleteFlEntry @ 0x1C0274498 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C00B3D24 (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
