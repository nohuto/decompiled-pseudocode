/*
 * XREFs of ?ComputeSourceRectAndMonitorWithPrecision@@YAXQEBU_MOVESIZEDATA@@PEAUtagPOINT@@PEAPEAUtagMONITOR@@PEAUtagRECT@@@Z @ 0x1C01D7CE8
 * Callers:
...
LABEL_13:
  ...
  if ( *(_DWORD *)*gpDispInfo <= 1u || (*(_DWORD *)(*((_QWORD *)a1 + 2) + 368LL) & 0xF) == 2 )
  {
    if ( (v9 & 0x20) != 0 )
      v14 = ValidateHmonitorNoRip(*(_QWORD *)(*((_QWORD *)a1 + 2) + 360LL));
    else
      v14 = *((_QWORD *)a1 + 26);
    v21 = v14;
    LogicalToPhysicalDPIPoint(a2, a2, v10, &v21);
    v15 = MonitorFromPoint((__int64)*a2, 2u, 0x12u);
    v16 = (struct tagWND *)*((_QWORD *)a1 + 2);
    v21 = v15;
