/*
 * XREFs of ?MsgSQMPopulateProcessSQMInfo@@YAXPEAUtagPROCESSINFO@@PEAUtagMSGSQM_PROCESSSQMINFO@@@Z @ 0x1C01F28BC
 * Callers:
...
void __fastcall MsgSQMPopulateProcessSQMInfo(struct tagPROCESSINFO *a1, WCHAR *a2)
{
  ...
  *((_DWORD *)a2 + 8) = *((_DWORD *)a1 + 208);
  *((_DWORD *)a2 + 9) = *((_DWORD *)a1 + 209);
