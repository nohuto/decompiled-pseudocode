/*
 * XREFs of DwmAsyncUpdateSprite @ 0x1C00E7400
 * Callers:
  ...
  if ( Object )
  {
    ...
    *(_QWORD *)((char *)&v29[18] + 4) = a11;
    if ( a10 && g_cDelayedUpdateSpriteNotifications < 0x14 )
    {
      v20 = v29[19];
      v21 = *(_OWORD *)&v29[7];
      v22 = 116LL * g_cDelayedUpdateSpriteNotifications++;
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22) = *(_OWORD *)&v29[5];
      v23 = *(_OWORD *)&v29[9];
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 16) = v21;
      v24 = *(_OWORD *)&v29[11];
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 32) = v23;
      v25 = *(_OWORD *)&v29[13];
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 48) = v24;
      v26 = *(_OWORD *)&v29[15];
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 64) = v25;
      v27 = *(_OWORD *)&v29[17];
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 80) = v26;
      *(_OWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 96) = v27;
      *(_DWORD *)((char *)&g_rgDelayedUpdateSpriteNotifications + v22 + 112) = v20;
    }
    else
    {
