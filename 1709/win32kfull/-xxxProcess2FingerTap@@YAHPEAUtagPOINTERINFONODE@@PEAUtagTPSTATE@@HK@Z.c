/*
 * XREFs of ?xxxProcess2FingerTap@@YAHPEAUtagPOINTERINFONODE@@PEAUtagTPSTATE@@HK@Z @ 0x1C01B34E4
 * Callers:
...
__int64 __fastcall xxxProcess2FingerTap(struct tagPOINTERINFONODE *a1, struct tagTPSTATE *a2, int a3, int a4)
{
  ...
  if ( (v7 & 0x800) != 0 )
  {
    if ( a4 == 1 )
    {
      if ( (v8 & 0x40000) != 0 && (*((_DWORD *)a2 + 480) & 1) == a3 )
      {
        v10 = *((_DWORD *)v9 + 66);
        if ( (v10 & 4) == 0
          && ((v10 & 0x80u) == 0
           || *((_QWORD *)v9 + 8) - *((_QWORD *)v9 + 7) < (unsigned __int64)(gliQpcFreq * gTPThresholds[0] / 1000LL)) )
        {
          v11 = v7 & 0xFFFFF7FF;
          *((_DWORD *)a2 + 480) = v11;
          if ( (v11 & 0x20) == 0 )
      ...
      if ( (v8 & 0x20000) != 0 && (*((_DWORD *)a2 + 480) & 1) == a3 && (*((_DWORD *)v9 + 66) & 4) == 0 )
        return 1LL;
    }
  ...
  if ( v13 < v15 )
    ...
    v16 = v13 - v15;
  if ( v16 > gliQpcFreq * (unsigned int)gTPThresholds[4] / 1000LL
    || (*((_DWORD *)v9 + 66) & 4) != 0
