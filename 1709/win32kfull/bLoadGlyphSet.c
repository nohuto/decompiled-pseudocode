/*
 * XREFs of bLoadGlyphSet @ 0x1C0228FB8
 * Callers:
 *     bLoadTTF @ 0x1C022910C (bLoadTTF.c)
 *     bReloadGlyphSet @ 0x1C0229854 (bReloadGlyphSet.c)
 * Callees:
 *     cjComputeGLYPHSET_HIGH_BYTE @ 0x1C022A658 (cjComputeGLYPHSET_HIGH_BYTE.c)
 *     cjComputeGLYPHSET_MSFT_GENERAL @ 0x1C022A8A4 (cjComputeGLYPHSET_MSFT_GENERAL.c)
