/*
 * XREFs of GreDrawEscape @ 0x1C0257504
 * Callers:
...
__int64 __fastcall GreDrawEscape(HDC a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  __int64 *v20[6]; // [rsp+B0h] [rbp-50h] BYREF
  _BYTE v21[4]; // [rsp+E0h] [rbp-20h] BYREF
  _BYTE v22[76]; // [rsp+E4h] [rbp-1Ch] BYREF
  ...
  if ( !v14[0] )
    return v7;
  if ( *((_QWORD *)v14[0] + 64) && (*(_DWORD *)(*((_QWORD *)v14[0] + 10) + 8LL) & 0x4000) == 0 && (a2 != 8 || a3 >= 4) )
  {
    v16 = 0LL;
    v17 = 0;
    v18 = 0;
    ...
    v9 = *((_QWORD *)v14[0] + 6);
    v10 = *(__int64 (__fastcall **)(__int64, __int64, _BYTE *, struct _RECTL *, unsigned int, __int64))(v9 + 2904);
    if ( v10 )
    {
      if ( a2 != 8 )
      {
        if ( (v15[24] & 1) != 0 )
        {
          v19 = *(struct _RECTL *)((char *)v14[0] + 1448);
          v12 = XDCOBJ::prgnEffRao(v14);
          v23 = 0LL;
          v24 = 0;
          v26 = 0LL;
          v25 = 1;
          XCLIPOBJ::vSetup((XCLIPOBJ *)v21, v12, (struct ERECTL *)&v19, 0);
          if ( ERECTL::bEmpty((ERECTL *)v22) )
          {
            v7 = 1;
          }
          else if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL((*((_QWORD *)v14[0] + 64) + 24LL) & -(__int64)(*((_QWORD *)v14[0] + 64) != 0LL))
                               + 112) & 0x200000) != 0 )
          {
            if ( (*(_DWORD *)(v9 + 32) & 1) != 0 )
            {
            ...
            ++*(_DWORD *)(*((_QWORD *)v14[0] + 64) + 92LL);
            v7 = v10(
                   (*((_QWORD *)v14[0] + 64) + 24LL) & -(__int64)(*((_QWORD *)v14[0] + 64) != 0LL),
                   a2,
                   v21,
                   &v19,
                   a3,
                   a4);
            DEVEXCLUDERECT::~DEVEXCLUDERECT(v20);
            if ( (*(_DWORD *)(v9 + 32) & 1) != 0 )
            {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL((*((_QWORD *)v14[0] + 64) + 24LL) & -(__int64)(*((_QWORD *)v14[0] + 64) != 0LL))
                      + 112) & 0x200000) != 0 )
      {
        v11 = v10(
                (*((_QWORD *)v14[0] + 64) + 24LL) & -(__int64)(*((_QWORD *)v14[0] + 64) != 0LL),
