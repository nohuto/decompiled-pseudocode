/*
 * XREFs of ?DT_DrawJustifiedLine@@YAXPEAUHDC__@@HPEBGHIPEAUDRAWTEXTDATA@@H@Z @ 0x1C023B414
 * Callers:
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  if ( (a5 & 3) != 0 )
  {
    v11 = *((_DWORD *)a6 + 14) + DT_DrawStr(a1, v10, a2, a3, a4, 0, a5, a6, -1);
    v12 = *((_DWORD *)a6 + 2);
    if ( (a5 & 1) != 0 )
      v10 = *(_DWORD *)a6 + ((v12 - *(_DWORD *)a6 - v11) >> 1);
    else
      v10 = v12 - v11;
  }
  v13 = *((_DWORD *)a6 + 14) + DT_DrawStr(a1, v10, a2, a3, a4, 1, a5, a6, -1);
  if ( v13 > *((_DWORD *)a6 + 9) )
    *((_DWORD *)a6 + 9) = v13;
}
