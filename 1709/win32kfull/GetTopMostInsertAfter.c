/*
 * XREFs of GetTopMostInsertAfter @ 0x1C01AB1DC
 * Callers:
...
__int64 __fastcall GetTopMostInsertAfter(__int64 a1)
{
  ...
  if ( (((*(_WORD *)(a1 + 82) & 0x3FFF) - 668) & 0xFFFB) != 0
    ...
    && (*(_DWORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 12LL) & 0x200000) == 0 )
  {
    v1 = *(PVOID *)(gptiCurrent + 432LL);
    if ( v1 != grpdeskLogon && v1 == *(PVOID *)(gHardErrorHandler + 432LL) )
    {
