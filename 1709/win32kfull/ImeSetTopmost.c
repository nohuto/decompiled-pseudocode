/*
 * XREFs of ImeSetTopmost @ 0x1C00568B8
 * Callers:
...
void __fastcall ImeSetTopmost(__int64 a1, int a2, __int64 a3)
{
    ...
    if ( (*(_BYTE *)(v12 + 60) & 0x20) != 0 )
    {
      for ( i = LastTopMostWindowNoIME; i; i = (struct tagWND *)*((_QWORD *)i + 11) )
      {
        if ( i == (struct tagWND *)v12 )
          break;
        v18 = *((_QWORD *)i + 21);
        if ( (*(_BYTE *)(v18 + 102) & 1) == 0 && *(_WORD *)(v18 + 8) != *(_WORD *)(gpsi + 882LL) )
  ...
  while ( v8 )
  {
    ...
    {
      v15 = *((_QWORD *)v8 + 21);
      if ( ((*(_BYTE *)(v15 + 102) & 1) != 0 || *(_WORD *)(v15 + 8) == *(_WORD *)(gpsi + 882LL))
