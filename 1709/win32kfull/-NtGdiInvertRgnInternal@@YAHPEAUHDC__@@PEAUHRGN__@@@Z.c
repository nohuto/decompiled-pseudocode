/*
 * XREFs of ?NtGdiInvertRgnInternal@@YAHPEAUHDC__@@PEAUHRGN__@@@Z @ 0x1C012B6D0
 * Callers:
        ...
        else
        {
          ...
          *((_QWORD *)v9 + 191) = v8;
          ...
          if ( (v22 & 1) != 0 && (unsigned int)DC::bTightenRao(v16[0]) )
          {
            ...
            v25[0] += *((_DWORD *)v16[0] + 2 * v11 + 358);
            v25[2] += *((_DWORD *)v16[0] + 2 * v11 + 358);
            v25[1] += *((_DWORD *)v16[0] + 2 * v11 + 359);
            v25[3] += *((_DWORD *)v16[0] + 2 * v11 + 359);
