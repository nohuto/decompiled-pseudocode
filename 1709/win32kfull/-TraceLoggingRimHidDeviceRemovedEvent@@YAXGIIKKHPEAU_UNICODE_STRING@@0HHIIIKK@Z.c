/*
 * XREFs of ?TraceLoggingRimHidDeviceRemovedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0HHIIIKK@Z @ 0x1C01A3088
 * Callers:
        ...
        char a15)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v50 = 4LL;
      v52 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E79C0, v15, v16, 0x13u, &pData);
    }
  }
}
