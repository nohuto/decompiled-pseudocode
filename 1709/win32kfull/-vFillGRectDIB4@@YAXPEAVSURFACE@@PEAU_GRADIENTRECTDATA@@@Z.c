/*
 * XREFs of ?vFillGRectDIB4@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02A9B20
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v24 < v30 )
        {
          ...
          do
          {
            ...
            v28 = v11[Xlate555[((unsigned __int64)DefaultSaturationTable[v27 + BYTE6(v23)] >> 3) | (4
                                                                                                  * (DefaultSaturationTable[v27 + BYTE6(v21)] & 0xF8 | (32 * (DefaultSaturationTable[v27 + BYTE6(v20)] & 0xF8u))))]];
            v29 = *v25;
            if ( (v24 & 1) != 0 )
              *v25++ = v28 | v29 & 0xF0;
            else
