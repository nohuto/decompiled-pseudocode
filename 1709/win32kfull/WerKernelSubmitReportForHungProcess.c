/*
 * XREFs of WerKernelSubmitReportForHungProcess @ 0x1C023DABC
 * Callers:
 *     ?WerSubmitReportWorker@@YAXPEAX@Z @ 0x1C020DD90 (-WerSubmitReportWorker@@YAXPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0143530 (__security_check_cookie.c)
 *     memset @ 0x1C0145A00 (memset.c)
 *     WerStartSystemErrorHandler @ 0x1C023DDEC (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C023DEFC (WerWaitForSystemErrorHandler.c)
