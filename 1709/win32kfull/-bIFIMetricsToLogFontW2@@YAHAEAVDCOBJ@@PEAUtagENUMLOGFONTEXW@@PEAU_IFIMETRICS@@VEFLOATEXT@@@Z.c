/*
 * XREFs of ?bIFIMetricsToLogFontW2@@YAHAEAVDCOBJ@@PEAUtagENUMLOGFONTEXW@@PEAU_IFIMETRICS@@VEFLOATEXT@@@Z @ 0x1C003B8A8
 * Callers:
 *     cjCopyFontDataW @ 0x1C003AEDC (cjCopyFontDataW.c)
 * Callees:
 *     ?vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z @ 0x1C003BA2C (-vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z.c)
        ...
        int a4)
{
  ...
  v19 = *(_QWORD *)a1;
  v35 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 80LL) + 68LL);
  v36 = *(_DWORD *)(*(_QWORD *)(v19 + 80) + 312LL) & 1;
