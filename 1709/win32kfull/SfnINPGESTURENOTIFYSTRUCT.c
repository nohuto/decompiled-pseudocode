/*
 * XREFs of SfnINPGESTURENOTIFYSTRUCT @ 0x1C01FE4D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( result )
  {
    ...
    *((_DWORD *)v17 + 12) = v8;
    *((_QWORD *)v17 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v17, a4, *(_DWORD *)a4, (void **)v17 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v17 + 9) = a5;
    *((_QWORD *)v17 + 10) = a6;
    ...
    *((_QWORD *)v17 + 2) = 0LL;
    v28 = KeUserModeCallback(114LL, v17, *(unsigned int *)v17, &v42, v40);
