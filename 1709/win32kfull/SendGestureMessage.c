/*
 * XREFs of SendGestureMessage @ 0x1C01F9904
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  if ( a4 + 56 < a4 || (unsigned __int64)v10 > MmUserProbeAddress )
  ...
  if ( !(unsigned int)ValidateGestureInfo(a1, a2, v17) )
    return 0LL;
  v13 = AllocGestureInfo(a1, 0LL, (__int64)v17, v8);
  if ( !v13 )
    return 0LL;
