/*
 * XREFs of ?xxxForceSizeRecToDockTarget@@YAHPEAU_MOVESIZEDATA@@W4eTHRESHOLD_MARGIN_DIRECTION@@PEAUtagMONITOR@@PEAKPEAUtagRECT@@PEAPEAUtagCHECKPOINT@@@Z @ 0x1C01DA7B8
 * Callers:
        ...
        struct tagCHECKPOINT **a6)
{
  ...
  v8 = a2;
  v25 = *GetMonitorWorkRectForWindow(&v25, a3, *(struct tagWND **)(a1 + 16));
  if ( (_DWORD)v8 == 2 )
  {
