/*
 * XREFs of ?vFillGRectDIB32BGRA@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C00B7980
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  else
  {
    ...
    {
      v39 = AllocFreeTmpBuffer((unsigned int)(4 * v20));
      v21 = (int *)v39;
      if ( v39 )
      {
        v22 = *((_QWORD *)a2 + 6);
        ...
        if ( v30 )
        {
          ...
          do
          {
            ...
            BYTE6(v34) = BYTE6(v24);
            v24 += v38;
            *v21++ = BYTE6(v34) | ((v35 | (((unsigned __int8)v34 | (v33 << 8)) << 8)) << 8);
          }
          while ( v3 != v30 );
          v21 = (int *)v39;
          v5 = v41;
