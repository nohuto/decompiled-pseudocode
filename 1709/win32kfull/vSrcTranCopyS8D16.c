/*
 * XREFs of vSrcTranCopyS8D16 @ 0x1C0256210
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SURFACE *a11)
{
  ...
  __int64 v18; // rdx
  __int64 v19; // r8
  void (*v20)(unsigned __int8 *, unsigned __int8 *, unsigned __int8 *, int, unsigned __int16 **); // [rsp+58h] [rbp-50h]
  ...
  vSrcTranCopyS8D16New(v14, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, v20, v15);
  if ( v16 )
