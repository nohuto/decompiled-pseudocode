/*
 * XREFs of GdiThreadCalloutFlushUserBatch @ 0x1C00FB290
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned __int64 __fastcall GdiThreadCalloutFlushUserBatch(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)result <= 0x134 )
  {
    do
    {
      ...
      result = (unsigned __int64)p_ArbitraryUserPointer + v8;
      if ( (unsigned __int64)p_ArbitraryUserPointer + v8 > p_Self )
        break;
      if ( *((_WORD *)p_ArbitraryUserPointer + 1) == 8 )
        NtGdiDeleteObjectApp(p_ArbitraryUserPointer[1], 1LL, a3);
      --StackLimit;
      result = ((_DWORD)v8 + 7) & 0xFFFFFFF8;
