/*
 * XREFs of ?bPaintPath@@YAHPEAVSURFACE@@PEAU_PATHOBJ@@PEAU_RECTL@@KHK@Z @ 0x1C00EA6A8
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v6 = a4;
  if ( (unsigned int)(*((_DWORD *)a1 + 24) - 1) <= 5 || !bUMPDSecurityGateEx((__int64)a1, (__int64)a2, (__int64)a3, a4) )
  {
