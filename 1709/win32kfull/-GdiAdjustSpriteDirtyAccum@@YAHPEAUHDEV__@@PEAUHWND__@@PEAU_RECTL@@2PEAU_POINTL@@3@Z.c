/*
 * XREFs of ?GdiAdjustSpriteDirtyAccum@@YAHPEAUHDEV__@@PEAUHWND__@@PEAU_RECTL@@2PEAU_POINTL@@3@Z @ 0x1C0258C80
 * Callers:
        ...
        struct _POINTL *a6)
{
  ...
  v8 = v23;
  v9 = 0;
  v10 = (const struct _SPRITESTATE *)(v23 + 18);
  if ( *((_DWORD *)v23 + 35) )
  {
    ...
    if ( MetaSprite && v12 )
    {
      ...
      do
      {
        ...
        v16 = v13->x - *(_DWORD *)(v14 + 2600);
        v17 = (struct _RECTL *)*(unsigned int *)(v14 + 2604);
