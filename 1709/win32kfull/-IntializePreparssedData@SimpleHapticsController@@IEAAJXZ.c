/*
 * XREFs of ?IntializePreparssedData@SimpleHapticsController@@IEAAJXZ @ 0x1C022449C
 * Callers:
...
__int64 __fastcall SimpleHapticsController::IntializePreparssedData(SimpleHapticsController *this)
{
  ...
  else
  {
    if ( (unsigned int)dword_1C0320150 > 2 )
    {
      ...
      v14 = "Function failed.";
      v15 = 17;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320150, &unk_1C02E97EB, v3, v4, 4u, &pData);
    }
    DbgPrintEx(
      0x4Du,
      0,
