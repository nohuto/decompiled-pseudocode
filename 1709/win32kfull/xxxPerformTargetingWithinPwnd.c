/*
 * XREFs of xxxPerformTargetingWithinPwnd @ 0x1C01D6548
 * Callers:
 ...
 *     PerformTargetingWithinPwnd @ 0x1C01D5E30 (PerformTargetingWithinPwnd.c)
 * Callees:
...
__int64 __fastcall xxxPerformTargetingWithinPwnd(__int64 *BugCheckParameter2, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  a3[1] = 0;
  result = GetProp((__int64)BugCheckParameter2, gatomPtrTargetFlags, 1);
  if ( (result & 0xFFFD) != 0 )
  {
