/*
 * XREFs of ?bGIQtoIntegerLine@@YAHPEAU_POINTFIX@@0PEAU_RECTL@@PEAU_DDALINE@@@Z @ 0x1C0139DD8
 * Callers:
...
LABEL_24:
      ...
      if ( v33 > (int)v25 && v31 > v24 && v32 <= (int)v22 )
      {
        ...
        if ( v34 <= (int)v37 )
        {
          ...
          if ( v32 <= v24
            || ((v24 = v32, v38 = v20 + v11 * (__int64)v32, v38 >= 0xFFFFFFFFLL)
              ? (v25 = (v20 + v11 * (__int64)v32) / (unsigned __int64)v8)
              : (LODWORD(v25) = (unsigned int)v38 / v8),
                v33 > (int)v25) )
          {
            if ( v34 <= (int)v25
