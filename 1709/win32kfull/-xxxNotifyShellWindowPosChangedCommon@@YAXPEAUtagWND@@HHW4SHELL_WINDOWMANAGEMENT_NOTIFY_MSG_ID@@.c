/*
 * XREFs of ?xxxNotifyShellWindowPosChangedCommon@@YAXPEAUtagWND@@HHW4SHELL_WINDOWMANAGEMENT_NOTIFY_MSG_ID@@@Z @ 0x1C01B8368
 * Callers:
...
__int64 __fastcall xxxNotifyShellWindowPosChangedCommon(__int64 a1, int a2, int a3, int a4)
{
  ...
  else if ( a3 && (*(_BYTE *)(a1 + 305) & 3) != 0 )
  {
    v8 = 3;
  }
  v10 = *(_QWORD *)(a1 + 24);
  HIDWORD(v12[2]) = v8;
  TransformRectBetweenCoordinateSpaces(&v12[3], a1 + 128, *(_QWORD *)(v10 + 328), a1);
