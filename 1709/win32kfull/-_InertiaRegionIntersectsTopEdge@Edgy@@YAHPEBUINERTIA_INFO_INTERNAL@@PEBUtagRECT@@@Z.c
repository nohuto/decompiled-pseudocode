/*
 * XREFs of ?_InertiaRegionIntersectsTopEdge@Edgy@@YAHPEBUINERTIA_INFO_INTERNAL@@PEBUtagRECT@@@Z @ 0x1C01D262C
 * Callers:
 ...
 *     GetInertiaRegionInVirtualizedScreen @ 0x1C020D838 (GetInertiaRegionInVirtualizedScreen.c)
 */
