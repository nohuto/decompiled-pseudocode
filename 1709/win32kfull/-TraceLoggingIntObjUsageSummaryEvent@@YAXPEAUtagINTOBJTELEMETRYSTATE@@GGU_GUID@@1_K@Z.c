/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C01A220C
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v15 = dword_1C03340A4;
      v54 = &v15;
      v10 = (unsigned int)qword_1C03340B8 / 0x3E8;
      v17 = dword_1C03340AC;
      v18 = (unsigned int)qword_1C03340E8 / 0x3E8;
      v28 = v6;
      v29 = 16LL;
      v33 = 16LL;
      v37 = 4LL;
      ...
      v77 = 4LL;
      v79 = 8LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E75F5, (LPCGUID)0x10624DD3, v6, 0x1Cu, &pData);
    }
  }
}
