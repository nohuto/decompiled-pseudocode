/*
 * XREFs of ?GrepDwmCreateComposedEvent@@YAJPEAUDwmState@@@Z @ 0x1C00DE328
 * Callers:
 ...
 *     ?RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C00DE5DC (-RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 */
