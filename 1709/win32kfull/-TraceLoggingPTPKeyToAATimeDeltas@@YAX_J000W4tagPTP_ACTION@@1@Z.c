/*
 * XREFs of ?TraceLoggingPTPKeyToAATimeDeltas@@YAX_J000W4tagPTP_ACTION@@1@Z @ 0x1C01A27EC
 * Callers:
...
void __fastcall TraceLoggingPTPKeyToAATimeDeltas(int a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v27 = 4LL;
      v29 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E7E49, v7, v8, 8u, &pData);
    }
  }
}
