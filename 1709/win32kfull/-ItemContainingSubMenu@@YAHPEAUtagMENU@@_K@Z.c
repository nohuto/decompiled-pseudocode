/*
 * XREFs of ?ItemContainingSubMenu@@YAHPEAUtagMENU@@_K@Z @ 0x1C0213AC8
 * Callers:
 *     ?UT_FindTopLevelMenuIndex@@YAHPEAUtagMENU@@I@Z @ 0x1C013E2AC (-UT_FindTopLevelMenuIndex@@YAHPEAUtagMENU@@I@Z.c)
 *     ?ItemContainingSubMenu@@YAHPEAUtagMENU@@_K@Z @ 0x1C0213AC8 (-ItemContainingSubMenu@@YAHPEAUtagMENU@@_K@Z.c)
 * Callees:
 *     ?ItemContainingSubMenu@@YAHPEAUtagMENU@@_K@Z @ 0x1C0213AC8 (-ItemContainingSubMenu@@YAHPEAUtagMENU@@_K@Z.c)
 */
...
__int64 __fastcall ItemContainingSubMenu(struct tagMENU *a1, unsigned __int64 a2)
{
  ...
  if ( v4 >= 0 )
  {
    v6 = (struct tagMENU **)(*((_QWORD *)a1 + 12) + 152LL * v4 + 16);
    do
    {
      v7 = *v6;
      if ( *v6 )
