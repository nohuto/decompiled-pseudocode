/*
 * XREFs of ?DelegateDiscardMessages@@YAXPEAUtagQ@@HPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01BEE4C
 * Callers:
 ...
 *     ?GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z @ 0x1C01BEFEC (-GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z.c)
