/*
 * XREFs of ?InkProcessorProcessInkFeedbackCommand@@YAJIPEAXI@Z @ 0x1C01F552C
 * Callers:
...
__int64 __fastcall InkProcessorProcessInkFeedbackCommand(unsigned int a1, const GUID *a2, unsigned int a3)
{
  ...
  if ( a1 < 5 )
  {
    ...
    else if ( (unsigned int)pRelatedActivityId > 2 )
    {
      ...
      v11 = 4;
      TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E9672, a2, (LPCGUID)a3, 3u, &pData);
    }
  }
  else
  {
