/*
 * XREFs of NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C0290220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     STROBJ_bGetAdvanceWidths @ 0x1C0297740 (STROBJ_bGetAdvanceWidths.c)
 */
...
__int64 __fastcall NtGdiSTROBJ_bGetAdvanceWidths(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( !v11
    ...
    || (v13 = (POINTQF *)UMPDOBJ::_AllocUserMem(v10, (unsigned int)(16 * v5), 0LL, v12), (v14 = v13) == 0LL) )
  {
    --*((_DWORD *)v10 + 108);
    return 0LL;
  }
  AdvanceWidths = STROBJ_bGetAdvanceWidths(v11, v6, v5, v13);
  if ( AdvanceWidths )
  {
    v16 = 16 * v5 + a4;
