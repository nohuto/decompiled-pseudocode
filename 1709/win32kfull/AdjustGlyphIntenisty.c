/*
 * XREFs of AdjustGlyphIntenisty @ 0x1C0253C60
 * Callers:
 ...
 *     ?ScaleUpAlpha@@YAEEM@Z @ 0x1C02536F0 (-ScaleUpAlpha@@YAEEM@Z.c)
 *     CalcActualGlyphIntensity @ 0x1C0253DA0 (CalcActualGlyphIntensity.c)
 */
    ...
    if ( v6 > v5 )
    {
      ...
      if ( v3 )
      {
        ...
        do
        {
          if ( *v11 )
          {
            *(_DWORD *)v18 = *(_DWORD *)(v13 + 4LL * (unsigned __int8)*v11 + 3006560);
            v14 = v19[v18[0] - 1 + v18[1] + v18[2]];
            ScaleUpAlpha(v18[0], v14);
            ScaleUpAlpha(v18[1], v14);
            v15 = ScaleUpAlpha(v18[2], v14);
            *v11 = *(_BYTE *)((unsigned int)v15 + 7 * (v17 + 7 * v16) + v13 + 3041488);
          }
          ++v11;
          --v12;
        }
