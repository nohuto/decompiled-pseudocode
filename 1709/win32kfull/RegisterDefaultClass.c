/*
 * XREFs of RegisterDefaultClass @ 0x1C0075794
 * Callers:
...
__int64 __fastcall RegisterDefaultClass(wchar_t *Str1)
{
  ...
  while ( 1 )
  {
    if ( v3 && (*(_DWORD *)v6 & 1) == 0 || ((*(_DWORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 792LL) >> v5) & 1) != 0 )
      goto LABEL_8;
    v2 = 0;
    if ( IntegerAtom )
      break;
...
LABEL_13:
  ...
  if ( (*((_DWORD *)&gDefaultServerClasses + 12 * v5) & 2) != 0 && (v10 = *(__int64 **)&gasyscur[4]) != 0LL )
    v19 = *v10;
  else
    v19 = 0LL;
  ...
  if ( result )
  {
    *(_DWORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 792LL) |= 1 << v5;
LABEL_9:
    if ( v2 )
