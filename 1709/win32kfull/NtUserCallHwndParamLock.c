/*
 * XREFs of NtUserCallHwndParamLock @ 0x1C009DFA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserCallHwndParamLock(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (_DWORD)v4 == 124
    || (_DWORD)v4 == 115
    || (_DWORD)v4 == 120
    || (unsigned int)v4 > 0x7D && (unsigned int)v4 <= 0x7F )
  {
    gbValidateHandleForIL = 0;
  }
  v7 = ValidateHwnd(a1);
  if ( v7 && ((_DWORD)v4 != 122 && (_DWORD)v4 != 109 || (((*(_WORD *)(v7 + 82) & 0x3FFF) - 669) & 0xFFFFFFFD) != 0) )
  {
    v10 = gptiCurrent;
