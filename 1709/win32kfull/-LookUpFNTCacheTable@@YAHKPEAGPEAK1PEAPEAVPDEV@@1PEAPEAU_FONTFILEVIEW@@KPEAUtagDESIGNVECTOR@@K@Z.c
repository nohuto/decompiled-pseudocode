/*
 * XREFs of ?LookUpFNTCacheTable@@YAHKPEAGPEAK1PEAPEAVPDEV@@1PEAPEAU_FONTFILEVIEW@@KPEAUtagDESIGNVECTOR@@K@Z @ 0x1C00B511C
 * Callers:
 *     UmfdLoadFontFileView @ 0x1C00B4E04 (UmfdLoadFontFileView.c)
 * Callees:
 *     ComputeFNTCacheFastCheckSum @ 0x1C00B60DC (ComputeFNTCacheFastCheckSum.c)
