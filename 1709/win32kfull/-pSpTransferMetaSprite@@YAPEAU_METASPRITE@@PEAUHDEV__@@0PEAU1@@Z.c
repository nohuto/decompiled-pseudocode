/*
 * XREFs of ?pSpTransferMetaSprite@@YAPEAU_METASPRITE@@PEAUHDEV__@@0PEAU1@@Z @ 0x1C025E000
 * Callers:
          ...
          while ( 1 )
          {
            if ( !*((_QWORD *)v5 + v20 + 4) )
            {
              ...
              if ( Sprite )
              {
                ...
                *((_QWORD *)v51 + 24) = 0LL;
                v26 = *((_DWORD *)v51 + 29) + *(_DWORD *)(v25 + 2604) - *((_DWORD *)v41 + 651);
                v44.x = *((_DWORD *)v51 + 28) + *(_DWORD *)(v25 + 2600) - *((_DWORD *)v41 + 650);
                v44.y = v26;
