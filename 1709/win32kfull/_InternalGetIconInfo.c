/*
 * XREFs of _InternalGetIconInfo @ 0x1C001D404
 * Callers:
        ...
        int a6)
{
  ...
  int v18; // r9d
  int v19; // r10d
  unsigned int v20; // [rsp+70h] [rbp-B8h] BYREF
  ...
  Bitmap = GreCreateBitmap(v20, v10, 1LL, 1LL, 0LL);
  if ( !Bitmap )
    return 0LL;
  v11 = 0LL;
  v23 = 0LL;
  ...
  v25 = GreSelectBitmap(ghdcMem, Bitmap);
  if ( v22 )
  {
    v17 = *(_QWORD *)(v8 + 96);
    if ( !v17 || a6 )
    ...
    if ( !v17 || a6 )
      ...
      v19 = v9 / 2;
    GreStretchBltInternal(ghdcMem, 0, 0, v20, v19, ghdcMem2, 0, 0, *(_DWORD *)(v8 + 140), v18, 13369376, 0xFFFFFF, 0);
  }
  else
  {
    if ( a6 || !*(_QWORD *)(v8 + 96) )
      ...
      v13 = v9 / 2;
    NtGdiBitBltInternal(ghdcMem, 0LL, 0LL, v20, v13, ghdcMem2, 0, 0, 13369376, 0xFFFFFF, 0);
  }
  if ( v11 )
  {
    ...
    if ( v22 )
      ...
      NtGdiBitBltInternal(ghdcMem, 0LL, 0LL, v20, v9 / 2, ghdcMem2, 0, 0, 13369376, 0, 0);
  }
