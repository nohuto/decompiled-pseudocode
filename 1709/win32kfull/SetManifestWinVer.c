/*
 * XREFs of SetManifestWinVer @ 0x1C00F3B20
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00F3C48 (SbGetProcessSwitchContext.c)
 */
...
__int64 SetManifestWinVer()
{
  ...
  if ( v1 )
  {
    ...
    v3 = ProcessWow64Process
       ...
       : *(_QWORD *)(PsGetProcessPeb(**(_QWORD **)(gptiCurrent + 400LL)) + 728);
