...
__int64 __fastcall SfnTOUCH(volatile signed __int32 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // r12d
  ...
  *(_QWORD *)(*(_QWORD *)(v11 + 456) + 80LL) = v24;
  ...
  v25 = KeUserModeCallback(112LL, v39, 48LL, &v36, v35);
