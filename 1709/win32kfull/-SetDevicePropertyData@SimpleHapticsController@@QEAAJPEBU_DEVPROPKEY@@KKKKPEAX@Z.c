/*
 * XREFs of ?SetDevicePropertyData@SimpleHapticsController@@QEAAJPEBU_DEVPROPKEY@@KKKKPEAX@Z @ 0x1C02252D8
 * Callers:
        ...
        PVOID Data)
{
  ...
  if ( (unsigned int)dword_1C0320150 > 4 )
  {
    ...
    v14 = 51;
    v17 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0320150, &unk_1C02E9891, a3, a4, 4u, &pData);
  }
  v8 = *((_QWORD *)this + 7);
  if ( v8 )
  {
