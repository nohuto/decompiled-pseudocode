/*
 * XREFs of ?AdjustProcessPriorityForDrag@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C01D7968
 * Callers:
 *     xxxMoveSize @ 0x1C01DF270 (xxxMoveSize.c)
 * Callees:
 *     SetForegroundPriority @ 0x1C0085D30 (SetForegroundPriority.c)
 *     ?IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z @ 0x1C01D86F0 (-IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z.c)
 */
...
void __fastcall AdjustProcessPriorityForDrag(struct _MOVESIZEDATA *a1)
{
  ...
  if ( (v3 & 0x100000) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 400) + 776LL) & 0x30000) == 0
      && (*(_DWORD *)(*(_QWORD *)(gptiForeground + 400LL) + 776LL) & 0x30000) != 0 )
    {
      v5 = 1;
LABEL_8:
