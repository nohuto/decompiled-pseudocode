/*
 * XREFs of SetAppImeCompatFlags @ 0x1C0077FDC
 * Callers:
...
__int64 __fastcall SetAppImeCompatFlags(__int64 a1, const UNICODE_STRING *a2)
{
  ...
  if ( (unsigned __int16)((DefaultLocaleId & 0x3FF) - 17) > 1u || *(_WORD *)(a1 + 608) > 0x30Au )
    *(_DWORD *)(*(_QWORD *)(a1 + 400) + 736LL) = Value & 0xC00000;
  else
    *(_DWORD *)(*(_QWORD *)(a1 + 400) + 736LL) = Value;
  if ( !gpastrSetupExe )
    return 0LL;
  String1[0] = a2;
  for ( i = 0LL; i < 1; ++i )
