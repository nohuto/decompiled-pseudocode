/*
 * XREFs of ?UMPDDrvBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00B6D20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&v45[3], v13)
      ...
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&v45[8], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&v45[9], 8u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&v45[10], 8u)
      || !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v16, (UMPDOBJ *)((char *)v16 + 144), (void **)&v45[11], 0x18u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&v45[12], 8u)
      || (LODWORD(Size) = 4, UMPDOBJ::Thunk(v16, v45, 0x70u, &v22, Size) == -1)
      || (v17 = 1, !v22) )
    {
      v17 = 0;
    }
