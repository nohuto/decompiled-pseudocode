/*
 * XREFs of ?DdcciGetVCPFeature@CMonitorAPI@@QEAAJPEAXKPEAW4_MC_VCP_CODE_TYPE@@PEAK2@Z @ 0x1C024A248
 * Callers:
 *     NtGdiDDCCIGetVCPFeature @ 0x1C024AC50 (NtGdiDDCCIGetVCPFeature.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  v13 = this;
  v6 = (char *)qword_1C0327BA0;
  CAutoMutex::CAutoMutex((CAutoMutex *)v12, (struct CMutex *)qword_1C0327BA0);
