/*
 * XREFs of GetConsoleDesktop @ 0x1C01C61A0
 * Callers:
 ...
 *     ?GetConsoleHostProcess@@YAJKPEAPEAX@Z @ 0x1C01C609C (-GetConsoleHostProcess@@YAJKPEAPEAX@Z.c)
 */
  ...
  if ( (int)result >= 0 )
  {
    ...
    *a4 = ProcessWin32Process;
    ...
    if ( *a4 && (v11 = *(_QWORD *)(v10 + 304)) != 0 )
    {
      *a2 = *(_QWORD *)(v11 + 568);
      if ( a3 )
        *a3 = *(_QWORD *)(*(_QWORD *)(v10 + 304) + 432LL);
      return 0LL;
    }
    else
    {
