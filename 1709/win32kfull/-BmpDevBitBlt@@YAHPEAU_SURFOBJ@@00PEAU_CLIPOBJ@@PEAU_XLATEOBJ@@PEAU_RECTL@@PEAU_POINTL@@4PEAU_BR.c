/*
 * XREFs of ?BmpDevBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C0275220
 * Callers:
 *     ?BmpDevCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C02754C0 (-BmpDevCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z.c)
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct SURFACE *v30; // [rsp+70h] [rbp-48h] BYREF
  struct SURFACE *v31; // [rsp+78h] [rbp-40h] BYREF
  struct SURFACE *v32; // [rsp+80h] [rbp-38h] BYREF
              ...
              if ( (*(_DWORD *)(v21 + 1840) & 0x8000000) != 0 )
              {
                ...
                if ( (v22 & 0x1000) != 0 && (v22 & 0x8000) != 0 )
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v21 + 1808) + 208LL) )
                  {
                    ...
                    (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, struct _POINTL *, struct _BRUSHOBJ *, struct _POINTL *, unsigned int))(v24 + 208))(
                      v26,
                      DevBitmap,
                      a3,
                      a4,
