/*
 * XREFs of ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C01E199C
 * Callers:
        ...
        struct tagMOUSE_PROMOTION_ENTRY **a5)
{
  ...
  v10 = CacheById;
  if ( !CacheById || CacheById == word_1C0327638 && (dword_1C0327738 & 2) != 0 )
    return 0LL;
