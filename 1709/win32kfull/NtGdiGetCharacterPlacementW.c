/*
 * XREFs of NtGdiGetCharacterPlacementW @ 0x1C0289D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCharacterPlacementW(HDC a1, const void *a2, int a3, int a4, ULONG64 a5, int a6)
{
  ...
  if ( v11 )
  {
    ...
    v22 = (ULONG64)v7 + v14;
    if ( v22 < (unsigned __int64)v7 || v22 > MmUserProbeAddress )
    ...
    if ( (a6 & 0x200000) != 0 && a5 && v16 )
    {
      v23 = 4 * v6;
      v24 = *(void **)(v10 + 24);
      if ( &v16[v23] < v16 || (unsigned __int64)&v16[v23] > MmUserProbeAddress )
        *(_BYTE *)MmUserProbeAddress = 0;
    ...
    if ( CharacterPlacementW && a5 )
    {
      ...
      *(_DWORD *)(a5 + 56) = v25;
      ...
      if ( v42[1] )
      {
        ...
        if ( (char *)v42[1] + v26 > (void *)MmUserProbeAddress || (char *)v42[1] + v26 <= v42[1] )
          *(_BYTE *)MmUserProbeAddress = 0;
      ...
      if ( Src[0] )
      {
        ...
        if ( (char *)Src[0] + v27 > (void *)MmUserProbeAddress || (char *)Src[0] + v27 <= Src[0] )
          *(_BYTE *)MmUserProbeAddress = 0;
      ...
      if ( v16 )
      {
        ...
        if ( (unsigned __int64)&v16[v27] > MmUserProbeAddress || &v16[v27] <= v16 )
          *(_BYTE *)MmUserProbeAddress = 0;
      ...
      if ( v44[0] )
      {
        ...
        if ( (char *)v44[0] + v27 > (void *)MmUserProbeAddress || (char *)v44[0] + v27 <= v44[0] )
          *(_BYTE *)MmUserProbeAddress = 0;
      ...
      if ( v44[1] )
      {
        ...
        if ( (char *)v44[1] + v25 > (void *)MmUserProbeAddress || (char *)v44[1] + v25 <= v44[1] )
          *(_BYTE *)MmUserProbeAddress = 0;
      ...
      if ( v45[0] )
      {
        ...
        if ( (char *)v45[0] + v26 > (void *)MmUserProbeAddress || (char *)v45[0] + v26 <= v45[0] )
          *(_BYTE *)MmUserProbeAddress = 0;
