/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C00E5DBC
 * Callers:
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C00E5F58 (-vNextEvent@LINER@@QEAAXXZ.c)
 * Callees:
 *     ?bNextFigure@READER@@IEAAHXZ @ 0x1C00E6038 (-bNextFigure@READER@@IEAAHXZ.c)
 *     ?bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z @ 0x1C00E6094 (-bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z.c)
 *     ?vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEA_J@Z @ 0x1C013B5DC (-vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEA_J@Z.c)
