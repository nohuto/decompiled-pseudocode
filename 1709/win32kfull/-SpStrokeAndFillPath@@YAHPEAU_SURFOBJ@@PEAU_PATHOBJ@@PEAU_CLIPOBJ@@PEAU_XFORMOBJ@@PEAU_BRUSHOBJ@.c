/*
 * XREFs of ?SpStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C025AC70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  __int64 *v66[9]; // [rsp+3B0h] [rbp+2B0h] BYREF
  int v67; // [rsp+3F8h] [rbp+2F8h]
  ...
  v58 = a8;
  v51 = a3;
  ENUMUNDERLAYS::ENUMUNDERLAYS((ENUMUNDERLAYS *)v66, a1, a3, &a3->rclBounds);
  while ( (unsigned int)ENUMUNDERLAYS::bEnum(v66, &v52, &v54, &v51) )
  {
    v12 = 0LL;
    ...
    {
      if ( v63 && EPATHOBJ::bClone((EPATHOBJ *)&v62, (struct EPATHOBJ *)this) )
      {
        x = v54.x;
        y = v54.y;
...
LABEL_53:
          ...
          {
            v37 = (BOOL (__stdcall *)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))*((_QWORD *)v13->hdev + 161);
            goto LABEL_42;
          }
          goto LABEL_41;
        }
