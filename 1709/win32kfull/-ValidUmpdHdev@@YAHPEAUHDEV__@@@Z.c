/*
 * XREFs of ?ValidUmpdHdev@@YAHPEAUHDEV__@@@Z @ 0x1C01199C4
 * Callers:
 *     NtGdiEngAssociateSurface @ 0x1C01196F0 (NtGdiEngAssociateSurface.c)
 *     NtGdiGetDhpdev @ 0x1C028FAA0 (NtGdiGetDhpdev.c)
 * Callees:
 *     <none>
 */
