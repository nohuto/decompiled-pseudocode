/*
 * XREFs of CurveTransitions @ 0x1C02BF0E8
 * Callers:
 *     Misoriented @ 0x1C02BF974 (Misoriented.c)
 * Callees:
 *     FQuadraticEqn @ 0x1C02BF6C0 (FQuadraticEqn.c)
 */
...
__int64 __fastcall CurveTransitions(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  FQuadraticEqn(
    v7 * v9 - v11 * v8,
    v7 * v12 - v11 * v10,
    HIDWORD(a3) * v7 + a1 * (HIDWORD(a2) - HIDWORD(a1)) - v7 * HIDWORD(a1) - a3 * (HIDWORD(a2) - HIDWORD(a1)),
    (unsigned int)&a5,
    (__int64)v21,
    (__int64)&v22);
  v13 = 0;
