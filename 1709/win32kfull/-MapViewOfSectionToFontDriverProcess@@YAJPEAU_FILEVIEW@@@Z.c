/*
 * XREFs of ?MapViewOfSectionToFontDriverProcess@@YAJPEAU_FILEVIEW@@@Z @ 0x1C00B3684
 * Callers:
...
__int64 __fastcall MapViewOfSectionToFontDriverProcess(struct _FILEVIEW *a1, __int64 a2, __int64 a3)
{
