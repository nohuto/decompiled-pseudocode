/*
 * XREFs of SetWindowCompositionPassiveUpdateMode @ 0x1C020C6E0
 * Callers:
...
__int64 __fastcall SetWindowCompositionPassiveUpdateMode(struct tagWND *a1, __int128 *a2)
{
  ...
  if ( (unsigned int)GetWindowCompositionInfo((__int64)a1, (__int64)v9) )
  {
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 25, a2);
    }
  }
  return v4;
}
