/*
 * XREFs of ?SetHapticsMode@InteractiveControlDevice@@QEAAJW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C0222038
 * Callers:
...
__int64 __fastcall InteractiveControlDevice::SetHapticsMode(__int64 a1, int a2)
{
  ...
  if ( v6 )
  {
    ...
    else if ( (unsigned int)dword_1C0320190 > 2 )
    {
      ...
      v11 = v7;
      v17 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320190, &unk_1C02E8FB5, v8, v9, 4u, &pData);
    }
  }
  return v2;
}
