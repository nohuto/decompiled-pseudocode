/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C029FC80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vPatXorRow8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  if ( a3 )
  {
    do
    {
      ...
      {
        v23 = v18;
        *(_DWORD *)(v11 + v6) ^= v16 & v17 & *(_DWORD *)(v18 + v9);
      }
      else
      {
        if ( (_DWORD)v12 )
        {
          v23 = v18;
          *(_DWORD *)(v11 + v6) ^= v16 & *(_DWORD *)(v18 + v9);
          LODWORD(v11) = v11 + 4;
          v18 += 4;
        }
        ...
        if ( v19 )
        {
          ...
          v23 = v18;
          v26 = v20;
          if ( (((unsigned __int8)v18 | (unsigned __int8)v20) & 3) != 0 )
          {
            vFetchShiftAndMerge(&v21);
          }
          else
          {
            v26 = v20 >> 2;
            vFetchAndMerge((__int64)&v21);
          }
          v17 = v27;
          v9 = v22;
          v19 = v25;
        ...
        if ( v28 )
          *(_DWORD *)(v14 + v6) ^= v17 & *(_DWORD *)(((int)v18 + 4 * (unsigned __int64)v19) % *((unsigned int *)a1 + 10)
                                                   + v9);
      }
      if ( ++v8 == *((_DWORD *)a1 + 11) )
      {
