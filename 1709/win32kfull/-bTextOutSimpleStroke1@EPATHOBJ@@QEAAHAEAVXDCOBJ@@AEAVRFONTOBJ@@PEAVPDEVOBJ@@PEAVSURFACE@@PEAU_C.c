/*
 * XREFs of ?bTextOutSimpleStroke1@EPATHOBJ@@QEAAHAEAVXDCOBJ@@AEAVRFONTOBJ@@PEAVPDEVOBJ@@PEAVSURFACE@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x1C026621C
 * Callers:
        ...
        struct _POINTL *a8)
{
  ...
  v16 = *(_QWORD *)(v15 + 48);
  v24 = v31;
  if ( (*(_DWORD *)(v16 + 32) & 0x8080) == 0x8080 && *(_QWORD *)a3 )
  {
    v17 = UMPDReleaseRFONTSem(a3, 0LL, &v22, &v23, (void **)&v24);
    v10 = v22;
    v12 = v17;
    v11 = v23;
    v8 = v24;
