/*
 * XREFs of ?bAddPreComputedFastStrokeRects@PRECOMPUTE@@QEAAHAEAVEPATHOBJ@@PEAU_RECTL@@K@Z @ 0x1C02A79A0
 * Callers:
...
LABEL_13:
  ...
  v11 = *(const void **)(v7 + 72);
  if ( v11 )
    memmove(v9, v11, 16LL * *(unsigned int *)(v7 + 64));
  memmove(&v10[16 * *(unsigned int *)(v7 + 64)], a3, 16 * v6);
  v13 = *(_QWORD *)(v7 + 72);
  if ( v13 )
