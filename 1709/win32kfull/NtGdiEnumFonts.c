/*
 * XREFs of NtGdiEnumFonts @ 0x1C01021A0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtGdiEnumFonts(
        HDC a1,
        unsigned int a2,
        __int16 a3,
        unsigned int a4,
        ...
        _DWORD *Address)
{
  ...
  if ( v11 )
  {
    ...
    if ( (unsigned int)PsGetWin32KFilterSet() == 5 && a1 == (HDC)-589410304LL )
      a1 = *(HDC *)(gpDispInfo + 48LL);
    v11 = GreEnumFonts(a1, a2, a3, (const unsigned __int16 *)v10, a6, &v17, Address);
    v15 = (_DWORD *)a7;
    if ( a7 >= MmUserProbeAddress )
