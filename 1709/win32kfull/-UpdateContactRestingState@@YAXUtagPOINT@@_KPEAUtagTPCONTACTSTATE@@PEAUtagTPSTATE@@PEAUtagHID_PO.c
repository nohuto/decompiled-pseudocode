/*
 * XREFs of ?UpdateContactRestingState@@YAXUtagPOINT@@_KPEAUtagTPCONTACTSTATE@@PEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01AF59C
 * Callers:
        ...
        struct tagHID_POINTER_DEVICE_INFO *a5)
{
  ...
  struct tagTPCONTACTSTATE *v22; // r11
  int v23; // r8d
  ...
  struct tagTPCONTACTSTATE *v34; // r11
  ...
  if ( (v12 & 0x200) == 0 && !v11 )
  {
    ...
    if ( v9 >= gliQpcFreq * (gTPThresholds[17] / 0xAu) / 1000LL || !v10 )
    {
      if ( v10 )
      {
        v14 = -__CFSHR__(*((_DWORD *)a3 + 66), 8);
        SetContactRestingState(a3, a4, 0);
        v17 = y;
        if ( y >= *((_DWORD *)a4 + 471) && (v14 || *((_DWORD *)a4 + 415) == 1 && !*((_DWORD *)a4 + 414))
          || PointInsideCurtainRegion(v15, a5) && v14 )
        {
          v18 = (*((_DWORD *)a3 + 66) & 0x100) != 0 ? *((unsigned int *)a3 + 31) : 0LL;
          if ( (int)((*((_QWORD *)a3 + v18 + 17) - v15.x) * (*((_QWORD *)a3 + v18 + 17) - v15.x)
        ...
        v19 = *v16 * (unsigned int)gTPThresholds[17] / 1000LL;
        if ( *((_DWORD *)a4 + 416) != 1 || !v14 || (*((_DWORD *)a3 + 66) & 4) == 0 || v10 >= v19 )
          goto LABEL_41;
        v20 = 1;
        v21 = 0;
        do
...
LABEL_41:
      v13 = 0x20C49BA5E353F7CFLL;
LABEL_42:
      *((struct tagPOINT *)a3 + *((unsigned int *)a3 + 31) + 17) = v15;
      v24 = *((_DWORD *)a3 + 31) + 1;
      *((_QWORD *)a3 + 9) = a2;
    ...
    if ( (*v25 & 1) != 0 )
    {
      ...
      if ( v25 - 66 != (_DWORD *)a3 && ((*v25 & 0x80u) != 0 || (*((_DWORD *)a3 + 66) & 0x80u) != 0) )
      {
        ...
        if ( v27 <= v28 )
          ...
          v29 = v27 - v28;
        if ( v29 < ((unsigned __int64)((unsigned __int128)(300LL * gliQpcFreq * (__int128)v13) >> 64) >> 63)
                 + ((__int64)((unsigned __int128)(300LL * gliQpcFreq * (__int128)v13) >> 64) >> 7) )
        {
          v30 = *((_DWORD *)a4 + 471);
          if ( *((_DWORD *)a3 + 1) >= v30 && *(v25 - 65) >= v30 )
          {
            v31 = *(_QWORD *)a3 - *v26;
            v32 = HIDWORD(*(_QWORD *)a3) - HIDWORD(*v26);
            if ( v31 * v31 + v32 * v32 <= (unsigned __int64)(unsigned int)gTPThresholds[46] )
            {
              SetContactRestingState(a3, a4, 0);
              SetContactRestingState(v34, v33, 0);
              *((_DWORD *)a3 + 66) |= 0x200u;
              *v25 |= 0x200u;
            }
          }
