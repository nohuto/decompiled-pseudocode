/*
 * XREFs of ?cjOTMAWSize@@YAIPEAU_IFIMETRICS@@PEAI@Z @ 0x1C0038764
 * Callers:
...
__int64 __fastcall cjOTMAWSize(struct _IFIMETRICS *a1, unsigned int *a2)
{
  ...
  *a2 += v20;
  ...
  while ( v23[v3] );
  v24 = 2 * v3;
  LOBYTE(v6) = RtlUnicodeToMultiByteSize(&BytesInMultiByteString, v23, v24) >= 0;
  v25 = BytesInMultiByteString + v22;
  *a2 += v24;
  return (v21 & v6) != 0 ? v25 : 0;
}
