/*
 * XREFs of ?GetPointerEventTarget@@YAHPEBUtagPOINTERINFONODE@@PEAPEAUHWND__@@@Z @ 0x1C01CB3EC
 * Callers:
...
__int64 __fastcall GetPointerEventTarget(PointerList **a1, HWND *a2, __int64 a3, __int64 a4)
{
  ...
  PointerList::GetPointerCapture(a1[2], (*(_DWORD *)(ThreadWin32Thread + 1184) >> 13) & 1, (int)&v9, 0LL, v8);
  if ( v9 )
    *a2 = *v9;
  else
    *a2 = (HWND)a1[10];
