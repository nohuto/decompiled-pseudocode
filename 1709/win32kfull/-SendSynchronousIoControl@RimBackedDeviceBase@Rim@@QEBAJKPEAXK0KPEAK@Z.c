/*
 * XREFs of ?SendSynchronousIoControl@RimBackedDeviceBase@Rim@@QEBAJKPEAXK0KPEAK@Z @ 0x1C020BC94
 * Callers:
 ...
 *     SendSynchronousIoControl @ 0x1C020BD98 (SendSynchronousIoControl.c)
 */
        ...
        unsigned int *a7)
{
  ...
  if ( !v7
    || (v10 = Io::DeviceObjectPointer::GetByObjectName(
                (struct _UNICODE_STRING *)((*((_QWORD *)this + 2) + 272LL) & -(__int64)(*((_QWORD *)this + 2) != 0LL)),
                *((_QWORD *)this + 2) + 272LL,
                a3,
                (void **)&v12),
        v10 >= 0) )
