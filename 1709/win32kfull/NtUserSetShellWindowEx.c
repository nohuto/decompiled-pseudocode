/*
 * XREFs of NtUserSetShellWindowEx @ 0x1C00D59A0
 * Callers:
 *     <none>
 * Callees:
      ...
      *(_QWORD *)(gptiCurrent + 392LL) = v16;
      ...
      if ( ValidateHWNDND(a2, &v18) )
      {
        if ( PsGetCurrentProcessWin32Process(v10)
          && ((unsigned int)*(_QWORD *)(PsGetCurrentProcessWin32Process(v12) + 832) >= 0x2000 || !gbEnforceUIPI)
          && *(_QWORD *)(*(_QWORD *)(v8 + 16) + 400LL) == PsGetCurrentProcessWin32Process(gbEnforceUIPI) )
        {
          v17[0] = *(_QWORD *)(gptiCurrent + 392LL);
          *(_QWORD *)(gptiCurrent + 392LL) = v17;
          v17[1] = v18;
          _InterlockedIncrement((volatile signed __int32 *)v18 + 2);
          v7 = xxxSetShellWindow(v8, v18);
