/*
 * XREFs of ?vLoadAndConvert4ToBGRA@@YAXPEAKPEAEJJPEAU_XLATEOBJ@@@Z @ 0x1C029D4D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vLoadAndConvert4ToBGRA(unsigned int *a1, unsigned __int8 *a2, int a3, int a4, struct _XLATEOBJ *a5)
{
  ...
  if ( (a5->flXlate & 2) != 0 )
  {
    ...
    if ( a4 >= 2 )
    {
      ...
      do
      {
        ...
        if ( v13 > v12 )
          v13 %= v12;
        v14 = *v8 & 0xF;
        *a1 = *((_DWORD *)&a5[3].iSrcType + v13) | 0xFF000000;
        v15 = a5->cEntries;
        if ( v14 > v15 )
          v14 %= v15;
        ++v8;
        a1[1] = *((_DWORD *)&a5[3].iSrcType + v14) | 0xFF000000;
        a1 += 2;
        --v11;
      }
      while ( v11 );
    ...
    if ( a4 )
    {
      ...
      *a1 = *((_DWORD *)&a5[3].iSrcType + v17) | 0xFF000000;
    }
  }
}
