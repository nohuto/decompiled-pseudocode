/*
 * XREFs of GreMaskBlt @ 0x1C01023EC
 * Callers:
 ...
 *     NtGdiMaskBlt @ 0x1C0102370 (NtGdiMaskBlt.c)
 * Callees:
        ...
        int a13)
{
  ...
  DC *v37[2]; // [rsp+70h] [rbp-90h] BYREF
...
LABEL_9:
  ...
  v40 = v21 & 0xD4;
  if ( (v21 & 0xD4) != 0 && (XDCOBJ::vLock(v37, a6), v37[0]) )
  {
...
LABEL_24:
  ...
  if ( (v21 & 0xE8) != 0 )
  {
    ...
    if ( ((unsigned __int8)v35 & (unsigned __int8)v16) != 0
      || ((unsigned __int8)*((_DWORD *)v22 + 83) & (unsigned __int8)v16) != 0 )
    {
  ...
  if ( !(unsigned int)DestSurfaceAccessCheck(*((struct SURFACE **)v22 + 64)) )
    goto LABEL_79;
