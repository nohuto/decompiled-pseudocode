/*
 * XREFs of NtGdiArcInternal @ 0x1C028C580
 * Callers:
 *     <none>
 * Callees:
        ...
        int a10)
{
  ...
  PATHOBJ v51[11]; // [rsp+F8h] [rbp-10h] BYREF
  _BYTE v52[32]; // [rsp+150h] [rbp+48h] BYREF
...
LABEL_10:
  ...
  EBOX::EBOX((EBOX *)v45, (struct DCOBJ *)v41, &v38, (struct _LINEATTRS *)&v41[0][23], 1);
  if ( v45[1] )
    goto LABEL_10;
  if ( !v45[0] )
  {
    ...
    {
      vCosSinPrecise(_mm_cvtsi128_si32(v26), (float *)&v42, &v43);
...
LABEL_37:
    ...
    {
      if ( a1 <= 1 )
        v34 = EPATHOBJ::bStrokeAndOrFill(v51, v41, (LINEATTRS *)&v41[0][23], &v44, 1u);
      else
        v34 = EPATHOBJ::bStrokeAndOrFill(v51, v41, (LINEATTRS *)&v41[0][23], &v44, 3u);
      v14 = v34;
    }
  }
LABEL_11:
