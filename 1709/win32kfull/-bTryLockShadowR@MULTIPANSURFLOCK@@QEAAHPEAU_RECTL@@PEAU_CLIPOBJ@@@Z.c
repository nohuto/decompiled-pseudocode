/*
 * XREFs of ?bTryLockShadowR@MULTIPANSURFLOCK@@QEAAHPEAU_RECTL@@PEAU_CLIPOBJ@@@Z @ 0x1C0272AA8
 * Callers:
...
__int64 __fastcall MULTIPANSURFLOCK::bTryLockShadowR(MULTIPANSURFLOCK *this, struct _RECTL *a2, struct _CLIPOBJ *a3)
{
  ...
  if ( !v10 )
    v11 = *((_QWORD *)this + 5);
  v12 = (unsigned int)v40 / *(_DWORD *)(v11 + 768);
  v13 = v10;
  v14 = v12;
  if ( !v10 )
    v13 = *((_QWORD *)this + 5);
  v15 = DWORD2(v40) / *(_DWORD *)(v13 + 768);
  v16 = v10;
  v17 = v15;
  if ( !v10 )
    v16 = *((_QWORD *)this + 5);
  v18 = DWORD1(v40) / *(_DWORD *)(v16 + 772);
  if ( !v10 )
    v10 = *((_QWORD *)this + 5);
  v19 = HIDWORD(v40) / *(_DWORD *)(v10 + 772);
  *((_BYTE *)this + 48) = 1;
  v20 = v19 + 1;
