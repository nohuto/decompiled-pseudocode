/*
 * XREFs of ?UmfdInsertFontFileViewForLookup@@YAHPEAPEAU_FONTFILEVIEW@@I@Z @ 0x1C00B4A60
 * Callers:
...
__int64 __fastcall UmfdInsertFontFileViewForLookup(struct _FONTFILEVIEW **a1, unsigned int a2)
{
  ...
  {
LABEL_5:
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v15, (struct _EX_PUSH_LOCK *)&UmfdFileViewPushLock);
