/*
 * XREFs of CachedHalftonePattern @ 0x1C00797DC
 * Callers:
 ...
 * Callees:
 *     Generate_HTSC_WORD @ 0x1C0105F44 (Generate_HTSC_WORD.c)
 */
...
__int64 __fastcall CachedHalftonePattern(__int64 a1, __int64 a2, __int64 a3, __int16 a4, __int16 a5, int a6)
{
  ...
  *(_QWORD *)&v26 = v11 + v22 + (__int64)(int)(v16 * v23);
  if ( a6 )
  {
    *((_QWORD *)&v26 + 1) = v11 + v22 - (unsigned __int64)v16;
    *(_QWORD *)&v27 = *((_QWORD *)&v26 + 1) + v18;
    v16 = -6 * WORD4(v10);
  }
  else
  {
