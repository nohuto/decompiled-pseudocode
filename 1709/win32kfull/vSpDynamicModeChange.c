/*
 * XREFs of vSpDynamicModeChange @ 0x1C00ECC20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C00ED174 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
