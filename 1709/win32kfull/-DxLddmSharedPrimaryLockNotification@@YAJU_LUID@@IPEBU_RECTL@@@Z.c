/*
 * XREFs of ?DxLddmSharedPrimaryLockNotification@@YAJU_LUID@@IPEBU_RECTL@@@Z @ 0x1C0250D90
 * Callers:
 ...
 *     ?sizl@PDEVOBJ@@QEAA?AUtagSIZE@@XZ @ 0x1C02516E4 (-sizl@PDEVOBJ@@QEAA-AUtagSIZE@@XZ.c)
      ...
      if ( (v10 & 0x400) == 0 && (v10 & 0x20000) == 0 )
      {
        if ( (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v32) )
        {
          if ( LowPart == PDEVOBJ::pAdapterLuid((PDEVOBJ *)&v32)->LowPart )
          {
            ...
            if ( v36.HighPart == v11->HighPart && *(_DWORD *)(*((_QWORD *)v32 + 324) + 272LL) == v7 )
            {
              GreLockVisRgn(v32);
              GreLockSprite(v32);
              ...
              if ( v5 >= 0 )
              {
                ...
                if ( v5 >= 0 )
                {
                  ...
                  PDEVOBJ::vSync(
                    (PDEVOBJ *)&v32,
                    (struct _SURFOBJ *)((*((_QWORD *)v32 + 321) + 24LL) & -(__int64)(*((_QWORD *)v32 + 321) != 0LL)),
                    0LL,
                    6u);
                }
                v7 = v34;
