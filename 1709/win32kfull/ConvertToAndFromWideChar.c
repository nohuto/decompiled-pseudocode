/*
 * XREFs of ConvertToAndFromWideChar @ 0x1C00F1C50
 * Callers:
 *     WCSToMBEx @ 0x1C00DE10C (WCSToMBEx.c)
 *     cUnicodeRangesSupported @ 0x1C00F1B34 (cUnicodeRangesSupported.c)
 ...
 *     EngMultiByteToWideChar @ 0x1C0258600 (EngMultiByteToWideChar.c)
 *     EngWideCharToMultiByte @ 0x1C0258630 (EngWideCharToMultiByte.c)
 ...
 *     ConvertToAndFromWideCharSymCP @ 0x1C02582F8 (ConvertToAndFromWideCharSymCP.c)
        ...
        int a6)
{
  ...
  else
  {
    ...
    if ( a6 )
      v19 = RtlCustomCPToUnicodeN(p_CodePageTable, a2, a3, &BytesInUnicodeString, a4, MaxBytesInMultiByteString);
    else
      v19 = RtlUnicodeToCustomCPN(p_CodePageTable, a4, MaxBytesInMultiByteString, &BytesInUnicodeString, a2, a3);
    v20 = v19;
    v21 = BytesInUnicodeString;
    if ( v20 < 0 )
      v21 = -1;
    BytesInUnicodeString = v21;
