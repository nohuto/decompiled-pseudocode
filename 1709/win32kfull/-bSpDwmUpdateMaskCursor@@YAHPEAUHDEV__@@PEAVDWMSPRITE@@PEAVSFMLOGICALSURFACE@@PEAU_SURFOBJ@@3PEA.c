/*
 * XREFs of ?bSpDwmUpdateMaskCursor@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@3PEAU_RECTL@@PEAKPEAPEAV3@@Z @ 0x1C024EC6C
 * Callers:
  ...
  if ( DIB )
  {
    ...
    if ( DIB )
    {
      ...
      if ( DIB )
      {
        ...
        v15 = v28;
        *((_DWORD *)v28 + 50) = ((_DWORD)v18 != 0 ? 4 : 0) | *((_DWORD *)v28 + 50) & 0xFFFFFFFB;
