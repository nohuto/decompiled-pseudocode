/*
 * XREFs of NtGdiGetFontFileInfo @ 0x1C011C120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetFontFileInfo(unsigned int a1, unsigned int a2, wchar_t *a3, unsigned __int64 a4, ULONG64 a5)
{
  __int64 v7; // rsi
