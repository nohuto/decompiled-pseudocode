/*
 * XREFs of AAHalftoneBitmap @ 0x1C00799CC
 * Callers:
 *     HT_HalftoneBitmap @ 0x1C007A0A0 (HT_HalftoneBitmap.c)
 * Callees:
 *     SetGrayColorTable @ 0x1C000CB3C (SetGrayColorTable.c)
...
__int64 __fastcall AAHalftoneBitmap(__int64 *a1)
{
  ...
  __int64 (__fastcall *v43)(__int128 *); // [rsp+30h] [rbp-18h] BYREF
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      if ( v5 >= 0 )
      {
        ...
        if ( v5 > 0 )
        {
          DyesColorMappingTable = CreateDyesColorMappingTable((__int64)a1);
