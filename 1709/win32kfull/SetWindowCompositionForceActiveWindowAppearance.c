/*
 * XREFs of SetWindowCompositionForceActiveWindowAppearance @ 0x1C011AC64
 * Callers:
...
__int64 __fastcall SetWindowCompositionForceActiveWindowAppearance(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 9) == v5 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFEFF | (v5 << 8);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v8, *(_QWORD *)a1, 15, a2);
    }
  }
  return v4;
}
