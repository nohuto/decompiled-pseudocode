/*
 * XREFs of ?AllocAndLinkThreadPointerData@@YAPEAUtagTHREADPOINTERDATA@@PEAUtagTHREADINPUTPOINTERLIST@@@Z @ 0x1C01CAD48
 * Callers:
 ...
 *     EditionAllocAndLinkThreadPointerData @ 0x1C01CDFD0 (EditionAllocAndLinkThreadPointerData.c)
 * Callees:
 *     <none>
 */
