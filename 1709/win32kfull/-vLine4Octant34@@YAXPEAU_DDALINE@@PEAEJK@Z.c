/*
 * XREFs of ?vLine4Octant34@@YAXPEAU_DDALINE@@PEAEJK@Z @ 0x1C02AD500
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vLine4Octant34(struct _DDALINE *a1, unsigned __int8 *a2, int a3, char a4)
{
  ...
  while ( --v9 )
  {
    ...
    v6[(unsigned __int64)v4 >> 1] = v6[(unsigned __int64)v4 >> 1] & PixelLineMask4[v4 & 1] | v10 & ~PixelLineMask4[v4 & 1];
  }
}
