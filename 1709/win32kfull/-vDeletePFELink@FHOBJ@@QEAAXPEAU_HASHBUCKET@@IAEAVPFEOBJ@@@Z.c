/*
 * XREFs of ?vDeletePFELink@FHOBJ@@QEAAXPEAU_HASHBUCKET@@IAEAVPFEOBJ@@@Z @ 0x1C003A27C
 * Callers:
...
void __fastcall FHOBJ::vDeletePFELink(FHOBJ *this, struct _HASHBUCKET *a2, __int64 a3, struct PFEOBJ *a4)
{
  ...
  if ( a2 )
  {
    v5 = (struct _HASHBUCKET *)*((_QWORD *)a2 + 1);
    v7 = (unsigned int)a3;
    v8 = a2;
    if ( *((_QWORD *)v5 + 1) == *(_QWORD *)a4 )
    {
      v9 = *(struct _HASHBUCKET **)v5;
      *((_QWORD *)a2 + 1) = *(_QWORD *)v5;
      if ( !v9 )
        *((_QWORD *)a2 + 2) = 0LL;
LABEL_5:
      if ( v5 )
