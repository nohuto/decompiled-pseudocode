/*
 * XREFs of fsg_ExecuteGlyph @ 0x1C02C105C
 * Callers:
 ...
 *     scl_IncrementChildElement @ 0x1C02B857C (scl_IncrementChildElement.c)
 *     fsg_AllocateGlyphDataMemory @ 0x1C02BFFE0 (fsg_AllocateGlyphDataMemory.c)
 ...
 *     fsg_DoScanControl @ 0x1C02C0CB0 (fsg_DoScanControl.c)
 *     fsg_InitializeGlyphData @ 0x1C02C1C14 (fsg_InitializeGlyphData.c)
 *     fsg_LinkChild @ 0x1C02C1D00 (fsg_LinkChild.c)
 *     fsg_MergeGlyphData @ 0x1C02C1D64 (fsg_MergeGlyphData.c)
 *     fsg_SimpleInnerGridFit @ 0x1C02C24D0 (fsg_SimpleInnerGridFit.c)
 *     sfac_ReadComponentData @ 0x1C02C4614 (sfac_ReadComponentData.c)
