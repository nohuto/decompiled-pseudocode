/*
 * XREFs of ?vSpSmallUnderlayCopy@@YAXPEAVSPRITE@@PEAU_POINTL@@PEAU_SURFOBJ@@12JJPEAU_RECTL@@3@Z @ 0x1C02632E4
 * Callers:
...
LABEL_53:
      ...
      do
        vSpReadFromScreen((struct _SPRITESTATE *)v11, v67, a3, &v136[v68++]);
      while ( v68 != v130 );
      v69 = a8;
      for ( i = pSpFindInZ(*(struct SPRITE **)(v11 + 16), a8); ; i = pSpFindInZ(*((struct SPRITE **)v129 + 3), v69) )
      {
        v129 = i;
        if ( !i )
          return;
...
LABEL_93:
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a3) + 112) & 0x400) == 0 )
              goto LABEL_102;
            v104 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)a3->hdev + 166);
          }
          else
          {
            if ( v75->iType == 1
...
LABEL_102:
            ...
            v104 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(*((_QWORD *)v129 + 20) + 24LL) + 1328LL);
          }
LABEL_103:
          OffCopyBits(
...
LABEL_107:
        ...
        v69 = a8;
LABEL_109:
        SINGLEREADERLOCK::vUnlock((struct _KMUTANT **)v129 + 31);
      }
    }
    v12 = 0LL;
    v134[0] = a6 + v133.left;
...
LABEL_28:
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a5) + 112) & 0x400) != 0 )
        {
          hdev = a5->hdev;
LABEL_46:
          v54 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)hdev + 166);
          goto LABEL_48;
        }
        goto LABEL_47;
      }
