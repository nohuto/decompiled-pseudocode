/*
 * XREFs of DCEHitTestWindow @ 0x1C01C3214
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01C27E0 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01C2FFC (BuildVertexList.c)
 *     DCEInverseTransform @ 0x1C01C32F0 (DCEInverseTransform.c)
 */
