/*
 * XREFs of SetWindowCompositionForceIconicSWR @ 0x1C011F9E4
 * Callers:
...
__int64 __fastcall SetWindowCompositionForceIconicSWR(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 4) == v5 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFFF7 | (8 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 7, a2);
    }
  }
  return v4;
}
