/*
 * XREFs of ?bSetFontXform@PFEOBJ@@QEAAHAEAVXDCOBJ@@PEAUtagLOGFONTW@@PEAU_FD_XFORM@@KKQEAU_POINTL@@AEAVIFIOBJ@@H@Z @ 0x1C003BCB0
 * Callers:
        ...
        int a9)
{
  ...
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)v18, a2, 516);
