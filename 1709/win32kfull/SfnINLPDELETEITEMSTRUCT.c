/*
 * XREFs of SfnINLPDELETEITEMSTRUCT @ 0x1C013AFA0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  _QWORD v33[4]; // [rsp+80h] [rbp-A8h] BYREF
  _QWORD v34[17]; // [rsp+A0h] [rbp-88h] BYREF
  char v35; // [rsp+130h] [rbp+8h] BYREF
  char v36; // [rsp+138h] [rbp+10h] BYREF
  int v37; // [rsp+140h] [rbp+18h] BYREF
  unsigned __int64 v38; // [rsp+148h] [rbp+20h] BYREF
  ...
  *(_QWORD *)(*(_QWORD *)(v11 + 456) + 80LL) = v21;
  ...
  v22 = KeUserModeCallback(11LL, v34, 72LL, &v38, &v37);
