/*
 * XREFs of ?CanCoalesceNodeWithPrevious@@YAHPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagQMSG@@PEAUtagPOINTERQFRAME@@PEAW4tagPOINTERCOALESCE@@@Z @ 0x1C01A3DBC
 * Callers:
      ...
      if ( *((_DWORD *)v11 + 17) == *((_DWORD *)a2 + 17) )
      {
        ...
        else
        {
          v16 = *(struct tagQ **)(*(_QWORD *)(*(_QWORD *)(gpKernelHandleTable
                                                        + 24LL * (unsigned __int16)*((_DWORD *)a2 + 20))
                                            + 16LL)
                                + 408LL);
