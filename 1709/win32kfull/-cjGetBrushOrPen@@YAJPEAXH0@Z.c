/*
 * XREFs of ?cjGetBrushOrPen@@YAJPEAXH0@Z @ 0x1C012BF1C
 * Callers:
...
__int64 __fastcall cjGetBrushOrPen(HBRUSH a1, unsigned int a2, _QWORD *a3)
{
  ...
  if ( (v7 & 0x800) != 0 )
  {
    ...
    if ( a3 )
    {
      ...
      *(_DWORD *)a3 = *((_DWORD *)v6 + 42);
      *((_DWORD *)a3 + 1) = *((_DWORD *)v6 + 40);
      *((_DWORD *)a3 + 2) = 0;
  ...
  if ( (v7 & 0x400) != 0 )
  {
    ...
    if ( a3 )
    {
      if ( (int)a2 < v11 )
        goto LABEL_10;
      *(_DWORD *)a3 = *((_DWORD *)v15[0] + 42);
      *((_DWORD *)a3 + 1) = *((_DWORD *)v6 + 40);
      *((_DWORD *)a3 + 6) = v10;
      if ( v10 )
      {
        v12 = (float *)*((_QWORD *)v6 + 22);
        v13 = (int *)a3 + 7;
        do
        {
          if ( (*((_DWORD *)v6 + 42) & 0xF0000) != 0 )
            bFToL(*v12, v13, 6);
          else
            *v13 = *(_DWORD *)v12;
          ++v13;
