/*
 * XREFs of SetWindowCompositionDisallowPeek @ 0x1C020C380
 * Callers:
...
__int64 __fastcall SetWindowCompositionDisallowPeek(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 10) == v5 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFDFF | (v5 << 9);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 16, a2);
    }
  }
  return v4;
}
