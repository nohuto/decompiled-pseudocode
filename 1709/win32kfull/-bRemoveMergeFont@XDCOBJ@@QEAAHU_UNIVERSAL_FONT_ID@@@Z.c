/*
 * XREFs of ?bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z @ 0x1C028877C
 * Callers:
...
__int64 __fastcall XDCOBJ::bRemoveMergeFont(__int64 a1, __int64 a2)
{
  ...
  int v11; // r9d
  __int64 v12; // rdx
  struct PFT **v14; // [rsp+40h] [rbp+8h] BYREF
...
LABEL_8:
    ...
    if ( v10 != gpPFTPrivate )
      v11 = 32;
    v2 = PFTOBJ::bUnloadWorkhorse((PFTOBJ *)&v14, (struct PFF *)*v4, 0LL, v11);
    if ( v2 )
    {
