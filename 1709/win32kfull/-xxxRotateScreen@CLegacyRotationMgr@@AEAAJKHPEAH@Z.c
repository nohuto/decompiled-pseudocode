/*
 * XREFs of ?xxxRotateScreen@CLegacyRotationMgr@@AEAAJKHPEAH@Z @ 0x1C01ACB9C
 * Callers:
...
LABEL_12:
  if ( v54 != 0x80000000 && v54 != 11 && v54 != 13 )
  {
    ...
    if ( hProvider > 5u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
      {
        ...
        v21 = 1003;
        v37 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8556, v11, v12, 5u, &pData);
      }
    }
    return 0LL;
  }
  ...
  if ( v6 == v55 )
  {
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
    {
      ...
      v23 = 1001;
      v44 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8556, v14, v15, 5u, &v38);
    }
    return 0LL;
  }
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v25 = 1000;
    v51 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E8556, v16, v13, 5u, &v45);
    LODWORD(v13) = v55;
  }
  v17 = v52;
  if ( v6 != (_DWORD)v13 )
