/*
 * XREFs of ?Create@CEventPoolEntry@CEventPool@@SAQEAV12@XZ @ 0x1C00FE530
 * Callers:
 ...
 * Callees:
 *     ?Create@CManualResetEvent@@SAQEAV1@XZ @ 0x1C00FE70C (-Create@CManualResetEvent@@SAQEAV1@XZ.c)
