/*
 * XREFs of ?QueryDockedOrientationRegistrySetting@CLegacyRotationMgr@@AEAAJPEAK0@Z @ 0x1C01AC4B8
 * Callers:
        ...
        unsigned int *a3)
{
  __int64 result; // rax
  char v6; // cl
  int v7; // [rsp+20h] [rbp-E8h] BYREF
  int v8; // [rsp+24h] [rbp-E4h] BYREF
  unsigned int v9; // [rsp+28h] [rbp-E0h] BYREF
  _BYTE v10[16]; // [rsp+30h] [rbp-D8h] BYREF
  _BYTE v11[12]; // [rsp+40h] [rbp-C8h] BYREF
  unsigned int v12; // [rsp+4Ch] [rbp-BCh]
