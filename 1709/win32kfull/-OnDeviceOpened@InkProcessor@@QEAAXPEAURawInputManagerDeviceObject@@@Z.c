/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C021926C
 * Callers:
 ...
 *     ?OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C020BC50 (-OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
  ...
  if ( *((_BYTE *)this + 8) )
  {
    ...
    if ( InkDeviceByRimDeviceObject )
    {
      ...
      if ( (unsigned int)pRelatedActivityId > 4 )
      {
        ...
        v13 = a2;
        v25 = 8;
        TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E8C84, v9, v10, 6u, &pData);
      }
    }
  }
