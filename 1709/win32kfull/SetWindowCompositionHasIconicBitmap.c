/*
 * XREFs of SetWindowCompositionHasIconicBitmap @ 0x1C0115F70
 * Callers:
...
__int64 __fastcall SetWindowCompositionHasIconicBitmap(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 6) == v5 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFFDF | (32 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 9, a2);
    }
  }
  return v4;
}
