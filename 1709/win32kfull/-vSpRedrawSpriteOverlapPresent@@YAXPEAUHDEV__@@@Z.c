/*
 * XREFs of ?vSpRedrawSpriteOverlapPresent@@YAXPEAUHDEV__@@@Z @ 0x1C0065E58
 * Callers:
...
void __fastcall vSpRedrawSpriteOverlapPresent(HDEV a1)
{
  ...
  GreAcquireSemaphore(*((_QWORD *)v1 + 16));
  EtwTraceGreLockAcquireSemaphoreExclusive(L"hsem", *((_QWORD *)v1 + 16), 8LL);
  ...
  v38 = 0LL;
  v34 = 0LL;
  XCLIPOBJ::vSetup((XCLIPOBJ *)v23, v2, (struct ERECTL *)(v1 + 12), 0);
  XCLIPOBJ::vSetup((XCLIPOBJ *)v31, v4, (struct ERECTL *)(v1 + 12), 0);
  ...
  if ( v7 == v8 )
  {
    ...
    if ( v25 == v33 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v9 )
        {
          v11 = XCLIPOBJ::bEnum((XCLIPOBJ *)v23, 0x144u, (char *)&v47, 0LL);
          v10 = v47;
          v9 = v11;
        }
        if ( v5 )
        {
          v12 = XCLIPOBJ::bEnum((XCLIPOBJ *)v31, 0x144u, (char *)v49, 0LL);
          v3 = v49[0];
          v5 = v12;
        }
        if ( v10 != v3 )
...
LABEL_34:
  ...
  *((_QWORD *)v1 + 131) = *((_QWORD *)v1 + 132);
  ...
  v46 = 0LL;
  v42 = 0LL;
  XCLIPOBJ::vSetup((XCLIPOBJ *)v39, v17[0], (struct ERECTL *)(v1 + 12), 1);
  switch ( v41 )
  {
    case 0:
...
LABEL_38:
      ...
      do
      {
        v15 = XCLIPOBJ::bEnum((XCLIPOBJ *)v39, 0x144u, (char *)&v47, 0LL);
LABEL_40:
        if ( v47 )
        {
          do
...
LABEL_2:
  EtwTraceGreLockReleaseSemaphore(L"hsem", *((_QWORD *)v1 + 16));
  GreReleaseSemaphoreInternal(*((_QWORD *)v1 + 16));
