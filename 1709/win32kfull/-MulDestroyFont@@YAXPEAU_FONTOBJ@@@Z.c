/*
 * XREFs of ?MulDestroyFont@@YAXPEAU_FONTOBJ@@@Z @ 0x1C027E350
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DestroyTable@MULTIFONT@@QEAAXXZ @ 0x1C027C834 (-DestroyTable@MULTIFONT@@QEAAXXZ.c)
 */
...
void __fastcall MulDestroyFont(struct _FONTOBJ *a1)
{
  ...
  struct PDEV *v8; // [rsp+50h] [rbp+8h] BYREF
