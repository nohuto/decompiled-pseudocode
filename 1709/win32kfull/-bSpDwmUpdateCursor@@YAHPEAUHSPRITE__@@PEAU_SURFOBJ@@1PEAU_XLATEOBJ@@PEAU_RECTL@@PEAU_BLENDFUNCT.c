/*
 * XREFs of ?bSpDwmUpdateCursor@@YAHPEAUHSPRITE__@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_BLENDFUNCTION@@@Z @ 0x1C00E46A4
 * Callers:
        ...
        struct _BLENDFUNCTION *a6)
{
  ...
  struct _BLENDFUNCTION v22; // [rsp+100h] [rbp+6Fh] BYREF
