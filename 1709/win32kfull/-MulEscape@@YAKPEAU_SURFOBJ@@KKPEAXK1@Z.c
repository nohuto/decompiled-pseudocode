/*
 * XREFs of ?MulEscape@@YAKPEAU_SURFOBJ@@KKPEAXK1@Z @ 0x1C027EA90
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a6)
{
  ...
  struct PDEV *v16[2]; // [rsp+40h] [rbp-D8h] BYREF
  ...
  if ( a1->iType == 3 )
  {
    if ( (unsigned int)MSURF::bFindSurface((MSURF *)v17, a1, 0LL, 0LL) )
    {
      do
      {
        v16[0] = (struct PDEV *)v18->hdev;
        if ( *((_QWORD *)v16[0] + 362) )
        {
          v10 = PDEVOBJ::Escape(v16, v18, a2, a3, a4, a5, a6);
          if ( v10 )
            v6 = v10;
        }
      }
  ...
  else
  {
    ...
    {
      --v12;
      v16[0] = (struct PDEV *)i[6];
      if ( *((_QWORD *)v16[0] + 362) )
      {
        v14 = PDEVOBJ::Escape(v16, (struct _SURFOBJ *)i[8], a2, a3, a4, a5, a6);
        if ( v14 )
          v6 = v14;
      }
    }
