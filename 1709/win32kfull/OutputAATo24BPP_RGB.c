/*
 * XREFs of OutputAATo24BPP_RGB @ 0x1C0127760
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall OutputAATo24BPP_RGB(unsigned int *a1, __int64 a2, unsigned __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (result & 0x80u) != 0LL )
  {
    if ( (unsigned __int64)v6 < a3 )
    {
      ...
      do
      {
        if ( v6[3] )
        {
          v9[1] = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[2] + 512));
          *v9 = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[1] + 256));
          result = *v6;
  ...
  else if ( (unsigned __int64)v6 < a3 )
  {
    ...
    {
      v8 += 3LL;
      *(_BYTE *)(v8 - 2) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[2] + 512));
      *(_BYTE *)(v8 - 3) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[1] + 256));
      result = *v6;
      v6 += 4;
