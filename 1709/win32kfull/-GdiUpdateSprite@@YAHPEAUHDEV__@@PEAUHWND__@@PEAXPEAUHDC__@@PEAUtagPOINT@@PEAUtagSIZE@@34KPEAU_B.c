/*
 * XREFs of ?GdiUpdateSprite@@YAHPEAUHDEV__@@PEAUHWND__@@PEAXPEAUHDC__@@PEAUtagPOINT@@PEAUtagSIZE@@34KPEAU_BLENDFUNCTION@@KPEAUtagRECT@@@Z @ 0x1C000A5F0
 * Callers:
  ...
  if ( *((_DWORD *)v27 + 35) )
  {
    ...
    if ( MetaSprite )
    {
      ...
      if ( v21 )
      {
        ...
        {
          v24 = 0LL;
          v25 = *(_QWORD *)(*((_QWORD *)v17 + 18) + 8 * v23);
          if ( a5 )
          {
            v24 = &v28;
            v28.x = a5->x - *(_DWORD *)(v25 + 2600);
            v28.y = a5->y - *(_DWORD *)(v25 + 2604);
          }
          updated &= bSpUpdateSprite(
                       *((struct SPRITE **)MetaSprite + v23 + 4),
                       v33,
                       v24,
                       v32,
                       v31,
        ...
        while ( (unsigned int)v23 < *((_DWORD *)v17 + 35) );
      }
    }
  }
  else
