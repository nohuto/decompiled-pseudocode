/*
 * XREFs of ?vPatCpyRow4_8x8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C029F078
 * Callers:
 *     ?vBrushPath4_8x8EnumRow@@YAXJPEAU_ROW@@KPEAX@Z @ 0x1C02A7F80 (-vBrushPath4_8x8EnumRow@@YAXJPEAU_ROW@@KPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0143530 (__security_check_cookie.c)
 *     ?vPatternCopyLoopRow@@YAXJPEAKPEAU_PATBLTFRAME@@HKKKKJ0@Z @ 0x1C02A043C (-vPatternCopyLoopRow@@YAXJPEAKPEAU_PATBLTFRAME@@HKKKKJ0@Z.c)
 */
...
void __fastcall vPatCpyRow4_8x8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  do
  {
    v14 = dword_1C02F0CD8[*v4 & 7];
    v15 = ~v14;
    v16 = dword_1C02F0CD8[v4[1] & 7];
    if ( !v16 )
      v16 = -1;
