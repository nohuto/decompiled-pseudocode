/*
 * XREFs of NtGdiEngAlphaBlend @ 0x1C028D620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z @ 0x1C028CA1C (--$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z.c)
 */
