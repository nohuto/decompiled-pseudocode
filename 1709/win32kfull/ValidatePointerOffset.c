/*
 * XREFs of ValidatePointerOffset @ 0x1C01D63E0
 * Callers:
...
__int64 __fastcall ValidatePointerOffset(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  int v4; // r15d
  unsigned int v5; // ebp
  ...
  *(_QWORD *)a4 = a3;
  ...
  if ( a3 )
  {
    v10 = *(_QWORD *)(a2 + 24);
    LOBYTE(a2) = 19;
    v11 = HMValidateHandleNoSecure(v10, a2, a3, (__int64)a4);
    if ( v11 )
    {
      v12 = *(_DWORD **)(v11 + 472);
      v13 = v9 + v4;
