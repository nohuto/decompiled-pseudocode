/*
 * XREFs of SetGestureConfigSettings @ 0x1C0119F1C
 * Callers:
 ...
 *     ?SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z @ 0x1C011A084 (-SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z.c)
...
__int64 __fastcall SetGestureConfigSettings(struct tagWND *a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( !GetGCData(a1) )
  {
    ...
    *v10 = 0;
    v9[2] = 0LL;
    VWPLAddBase((struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 400LL) + 824LL), (__int64)v9, a1, 5u);
  }
  GCData = GetGCData(a1);
  if ( *(_DWORD *)a4 )
