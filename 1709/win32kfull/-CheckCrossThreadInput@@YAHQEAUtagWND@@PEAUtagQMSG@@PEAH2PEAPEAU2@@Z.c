/*
 * XREFs of ?CheckCrossThreadInput@@YAHQEAUtagWND@@PEAUtagQMSG@@PEAH2PEAPEAU2@@Z @ 0x1C00CF8DC
 * Callers:
        ...
        struct tagQMSG **a5)
{
  ...
  if ( *(_QWORD *)(gptiCurrent + 648LL)
    || *(struct tagQMSG **)(*(_QWORD *)(gptiCurrent + 408LL) + 80LL) != a2
    || a2 == (struct tagQMSG *)1 )
  {
    goto LABEL_7;
  }
