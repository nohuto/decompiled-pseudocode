/*
 * XREFs of ?FindMirrorDriver@@YAJPEBGPEAU_DISPLAY_DEVICEW@@@Z @ 0x1C01F8440
 * Callers:
...
__int64 __fastcall FindMirrorDriver(PCWSTR SourceString, struct _DISPLAY_DEVICEW *a2)
{
  ...
  a2->cb = 840;
  if ( (int)DrvEnumDisplayDevices(0LL, *(_QWORD *)(*(_QWORD *)(gpDispInfo + 88LL) + 232LL), 0LL, a2, 0, 0) >= 0 )
  {
    while ( 1 )
    {
      ++v4;
...
LABEL_26:
      if ( (int)DrvEnumDisplayDevices(0LL, *(_QWORD *)(*(_QWORD *)(gpDispInfo + 88LL) + 232LL), v4, a2, 0, 0) < 0 )
        goto LABEL_29;
    }
    v11 = 0;
    if ( v10 )
