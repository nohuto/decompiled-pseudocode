/*
 * XREFs of bSetDevDragRect @ 0x1C00E35F0
 * Callers:
...
__int64 __fastcall bSetDevDragRect(HDEV a1, __int64 a2, _OWORD *a3, char a4)
{
  ...
  _OWORD *v22; // rax
  void *v23; // rax
  HDEV v25; // [rsp+70h] [rbp-59h] BYREF
  _OWORD *v26; // [rsp+78h] [rbp-51h]
  char v27[8]; // [rsp+80h] [rbp-49h] BYREF
  __int64 v28; // [rsp+88h] [rbp-41h] BYREF
  char v29[8]; // [rsp+90h] [rbp-39h] BYREF
  __int64 v30; // [rsp+98h] [rbp-31h]
  __int64 v31; // [rsp+A0h] [rbp-29h]
  _BYTE v32[56]; // [rsp+A8h] [rbp-21h] BYREF
  ...
  if ( a2 )
  {
    *((_DWORD *)v4 + 280) = v14;
    ...
    do
    {
      ...
      Sprite = GreCreateSprite(a1, v19, 0LL, (struct tagMINIWINDOWINFO *)v32, 0x9900u, v14, 1, 0, 0, 0, 0LL);
      *v17++ = Sprite;
      v21 = Sprite != 0LL ? v7 : 0;
      v7 = v21;
      --v18;
