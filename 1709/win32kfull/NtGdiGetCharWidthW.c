/*
 * XREFs of NtGdiGetCharWidthW @ 0x1C0103BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCharWidthW(HDC a1, __int64 a2, __int64 a3, const void *a4, int a5, char *a6)
{
  __int64 v7; // rbx
  ...
  if ( a4 )
  {
    ...
    if ( (unsigned int)a3 <= 0x1388000 )
      v10 = PALLOCMEM2((unsigned int)(2 * a3), 1886221383LL, 0);
  }
  if ( !v11 || v10 )
  {
