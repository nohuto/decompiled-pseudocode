/*
 * XREFs of ?vRemoveHash@PFFOBJ@@QEAAXXZ @ 0x1C0038E48
 * Callers:
 ...
 *     ?vFree@FHOBJ@@QEAAXXZ @ 0x1C003A970 (-vFree@FHOBJ@@QEAAXXZ.c)
 */
...
void __fastcall PFFOBJ::vRemoveHash(PFFOBJ *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)this + 80LL) )
  {
    ...
    if ( v5 == gppdevTrueType || v5 == qword_1C0334158 && !*(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 80LL) + 8LL) )
      --gcTrueTypeFonts;
  }
  else
  {
