/*
 * XREFs of ?vPatNotRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C029FA80
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v19 )
        {
          ...
          {
            vFetchShiftNotAndCopy(&v21);
          }
          else
          {
            v26 = v20 >> 2;
            vFetchNotAndCopy(&v21);
          }
          v17 = v27;
          v9 = v22;
          v19 = v25;
        ...
        if ( v28 )
          *(_DWORD *)(v14 + v6) = *(_DWORD *)(v14 + v6) & ~v17 | v17 & ~*(_DWORD *)(((int)v18 + 4
