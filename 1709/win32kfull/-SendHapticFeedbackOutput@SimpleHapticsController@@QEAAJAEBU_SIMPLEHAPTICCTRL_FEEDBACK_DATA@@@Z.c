/*
 * XREFs of ?SendHapticFeedbackOutput@SimpleHapticsController@@QEAAJAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x1C0224B50
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1C0320150 > 4 )
  {
    ...
    v29 = 4LL;
    v31 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C0320150, &unk_1C02E98C9, a3, a4, 7u, &v21);
  }
...
LABEL_22:
  if ( (unsigned int)dword_1C0320150 > 4 )
  {
    ...
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C0320150, &unk_1C02E9891, a3, a4, 4u, &v21);
    return v17;
  }
  return result;
}
