/*
 * XREFs of ?wpgdGetLinkMetricsPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@PEAVXDCOBJ@@PEAVESTROBJ@@PEAG2KPEAHH@Z @ 0x1C0034CC8
 * Callers:
        ...
        int a8)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 320LL) )
  {
    ...
    {
      v32 = *a4;
      if ( *a4 >= gqlTTSystem && v32 <= (unsigned __int16)word_1C032F962 )
      {
        v33 = (struct RFONTOBJ *)((v32 - gqlTTSystem) / 32);
        if ( ((0x80000000 >> ((v32 - gqlTTSystem) % 32)) & *(_DWORD *)(qword_1C032F968 + 4LL * (_QWORD)v33)) != 0 )
        {
  ...
  if ( (*(_DWORD *)(*(_QWORD *)this + 720LL) & 1) == 0 )
  {
    ...
    if ( v19 )
    {
      GreAcquireSemaphore(*(_QWORD *)(v19 + 528));
      a5 = 0LL;
      RFONTOBJ::~RFONTOBJ((RFONTOBJ *)&a5);
    }
    v20 = *(_QWORD *)(*(_QWORD *)this + 744LL);
    if ( v20 )
    {
    ...
    v21 = *(_QWORD *)this;
    v22 = 0;
    v23 = *(_DWORD *)(*(_QWORD *)this + 848LL);
    if ( v23 > 0x20 )
    {
      do
      {
        v37 = *(_QWORD *)(*(_QWORD *)(v21 + 752) + 8LL * v22);
        if ( v37 )
        {
      ...
      while ( v22 < *(_DWORD *)(*(_QWORD *)this + 848LL) );
    }
    else if ( v23 )
    {
      do
      {
        v29 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 752LL)
                        + 8LL * *(unsigned __int8 *)(v22 + *(_QWORD *)this + 864LL));
        if ( v29 )
        {
          GreAcquireSemaphore(*(_QWORD *)(v29 + 528));
          a5 = 0LL;
          RFONTOBJ::~RFONTOBJ((RFONTOBJ *)&a5);
        }
        ++v22;
  ...
  v26 = a7;
  v27 = v24 >> 1;
  result = RFONTOBJ::FindLinkedGlyphDataPlus(this, a2, a3, *a4, v27, a6, a7, 0, a8);
  if ( !result )
  {
    result = v25
    ...
    if ( !result )
    {
      result = RFONTOBJ::FindLinkedGlyphDataPlus(this, a2, a3, EudcDefaultChar, v27, a6, v26, 1, v25);
      if ( !result )
        return RFONTOBJ::pgdDefault(this);
    }
  }
