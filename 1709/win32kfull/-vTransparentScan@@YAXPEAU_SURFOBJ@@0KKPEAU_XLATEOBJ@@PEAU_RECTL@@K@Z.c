/*
 * XREFs of ?vTransparentScan@@YAXPEAU_SURFOBJ@@0KKPEAU_XLATEOBJ@@PEAU_RECTL@@K@Z @ 0x1C026FB18
 * Callers:
 ...
 *     ?ReadScanLine@@YAKPEAEKKKK@Z @ 0x1C026E154 (-ReadScanLine@@YAKPEAEKKKK@Z.c)
 *     ?SkipScanLine@@YAKPEAEKKKK@Z @ 0x1C026E234 (-SkipScanLine@@YAKPEAEKKKK@Z.c)
 */
    ...
    do
    {
      ...
      if ( ScanLine - 1 > v7 )
      {
        ...
        if ( (*(_DWORD *)(v13 + 112) & 0x400) != 0 )
          (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, _QWORD, struct _XLATEOBJ *, __int128 *, _DWORD *))(v14 + 2856))(
            v20,
            a2,
            0LL,
            v19,
