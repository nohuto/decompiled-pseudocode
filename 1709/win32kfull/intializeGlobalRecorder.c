/*
 * XREFs of intializeGlobalRecorder @ 0x1C011B9F4
 * Callers:
 *     InitializeEditionAutoLogger @ 0x1C011B970 (InitializeEditionAutoLogger.c)
 * Callees:
 *     RtlStringCchCopyA @ 0x1C011BA9C (RtlStringCchCopyA.c)
