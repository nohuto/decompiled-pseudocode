/*
 * XREFs of ?bIFIMetricsToTextMetricW2@@YAHAEAVDCOBJ@@PEAU_NTMW_INTERNAL@@AEAVPFEOBJ@@HKVEFLOATEXT@@JJ@Z @ 0x1C003B360
 * Callers:
        ...
        int a8)
{
  ...
  int v60; // [rsp+88h] [rbp+48h] BYREF
  int v61; // [rsp+90h] [rbp+50h] BYREF
  ...
  if ( v14 != 0 && *(_WORD *)(v13 + 56) != 0 )
  {
    ...
    v38 = *(_QWORD *)a1;
    v58 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 80LL) + 68LL);
    v59 = *(_DWORD *)(*(_QWORD *)(v38 + 80) + 312LL) & 1;
