/*
 * XREFs of ?EndActiveCommandsByPointerId@InkFeedbackProviderBase@@UEAAXI@Z @ 0x1C021D4F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall InkFeedbackProviderBase::EndActiveCommandsByPointerId(InkFeedbackProviderBase *this, int a2)
{
  ...
  const GUID *v26; // [rsp+A8h] [rbp+17h]
  int v27; // [rsp+B0h] [rbp+1Fh]
  int v28; // [rsp+B4h] [rbp+23h]
  char *v29; // [rsp+B8h] [rbp+27h]
    ...
    do
    {
      ...
      if ( *((_DWORD *)v6 + 5) == a2 )
      {
        if ( (unsigned int)pRelatedActivityId > 4 )
        {
          ...
          do
            ++v7;
          while ( aTerminatingAct_0[v7] );
          v8 = (const CHAR *)*((_QWORD *)this + 6);
          v21 = 0;
          v19 = "Terminating active command by pointer id";
          v20 = v7 + 1;
