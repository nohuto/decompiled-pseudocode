/*
 * XREFs of ?TraceLoggingScreenOrientationArStateChangeEvent@@YAXKW4arInitiatedBy@@W4tagAR_STATE@@@Z @ 0x1C01A34A0
 * Callers:
...
void TraceLoggingScreenOrientationArStateChangeEvent()
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v5 = (int)v0;
      v14 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E826B, 0LL, v0, 6u, &pData);
    }
  }
}
