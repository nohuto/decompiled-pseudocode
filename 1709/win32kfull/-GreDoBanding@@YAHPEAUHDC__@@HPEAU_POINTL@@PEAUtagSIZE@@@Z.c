/*
 * XREFs of ?GreDoBanding@@YAHPEAUHDC__@@HPEAU_POINTL@@PEAUtagSIZE@@@Z @ 0x1C010D740
 * Callers:
 *     NtGdiDoBanding @ 0x1C010D690 (NtGdiDoBanding.c)
 * Callees:
...
__int64 __fastcall GreDoBanding(HDC a1, int a2, struct _POINTL *a3, struct tagSIZE *a4)
{
  ...
  v9 = v19[0];
  if ( !valid
    || (v10 = *(_QWORD *)(v19[0] + 512LL)) == 0
    || (v11 = *(_QWORD *)(v19[0] + 48LL), !*(_QWORD *)(v11 + 2576))
...
LABEL_33:
  ...
  if ( a2 )
  {
    v15 = *(__int64 (__fastcall **)(__int64, struct _POINTL *))(v11 + 3160);
    ...
    a4->cy = *(_DWORD *)(v10 + 60);
LABEL_11:
    *(struct _POINTL *)(v9 + 2536) = *a3;
    goto LABEL_12;
  }
  v12 = *(__int64 (__fastcall **)(__int64, struct _POINTL *))(v11 + 3168);
  if ( gUMPDSecurityLevel != 2 )
  {
