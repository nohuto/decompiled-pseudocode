/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C00430FC
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C0043340 (DestroyProcessInfoEditionRundown.c)
 * Callees:
...
void __fastcall TraceLoggingProcessUsageOnTerminationEvent(struct tagPROCESSINFO *const a1)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v14 = -__CFSHR__(v4, 3);
      v43 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E836E, v5, v6, 0x10u, &pData);
    }
  }
}
