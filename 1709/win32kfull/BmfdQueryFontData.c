/*
 * XREFs of BmfdQueryFontData @ 0x1C02345FC
 * Callers:
 ...
 *     cjBmfdDeviceMetrics @ 0x1C0234B9C (cjBmfdDeviceMetrics.c)
 *     vBmfdScrubGLYPHBITS @ 0x1C0234E88 (vBmfdScrubGLYPHBITS.c)
 *     vFill_RotateGLYPHDATA @ 0x1C0234ED8 (vFill_RotateGLYPHDATA.c)
 *     pjRawBitmap @ 0x1C0235E98 (pjRawBitmap.c)
...
__int64 __fastcall BmfdQueryFontData(__int64 a1, int a2, unsigned int a3, __int64 a4, _DWORD *pv, size_t Size)
{
  ...
  v17 = v30;
  v21 = cjGlyphDataSimulated(a1, v30 * *(_DWORD *)(v11 + 36), v16, 0, 0);
  v22 = *(_DWORD *)(v11 + 16);
  switch ( v22 )
  {
    case 0:
