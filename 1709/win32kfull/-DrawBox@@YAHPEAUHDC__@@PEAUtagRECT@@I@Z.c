/*
 * XREFs of ?DrawBox@@YAHPEAUHDC__@@PEAUtagRECT@@I@Z @ 0x1C009C70C
 * Callers:
...
__int64 __fastcall DrawBox(HDC a1, struct tagRECT *a2, __int16 a3)
{
  ...
  {
    LODWORD(v29) = *(_DWORD *)(gpsi + 4640LL);
    HIDWORD(v29) = *(_DWORD *)(gpsi + 4636LL);
    LODWORD(v30) = *(_DWORD *)(gpsi + 4632LL);
    v8 = *(_DWORD *)(gpsi + 4616LL);
  }
  HIDWORD(v30) = v8;
  if ( (a3 & 0x300) != 0 )
  {
    v9 = *(_DWORD *)(gpsi + 4612LL);
  }
  else if ( v5 == 1032 )
  {
    v9 = *(_DWORD *)(gpsi + 4632LL);
  }
  else
  {
    v9 = *(_DWORD *)(gpsi + 4572LL);
  }
  v28 = v9;
  if ( (a3 & 1) != 0 )
  {
...
LABEL_10:
  ...
  v16 = top + (v12 - v14) / 2;
  if ( v5 == 1032 && (*(_WORD *)(gpsi + 9972LL) < 8u || *(_DWORD *)(gpsi + 4632LL) == 0xFFFFFF) )
  {
    v23 = GreSetBkColor(a1, *(_DWORD *)(gpsi + 4632LL));
    v17 = GreSetTextColor(a1, *(_DWORD *)(gpsi + 4612LL));
    v26[0] = v15;
    v26[2] = v24;
    v26[3] = v25;
    v26[1] = v16;
    v27 = *(_QWORD *)(gpsi + 4928LL);
    GrePolyPatBlt(a1, 15728673, (struct _POLYPATBLT *)v26, 1);
  ...
  if ( (a3 & 0x400) != 0 )
  {
    if ( (a3 & 0x108) != 0 )
    {
      v20 = *(_DWORD *)(gpsi + 4616LL);
    }
    else if ( (a3 & 0x1000) != 0 )
    {
      v20 = *(_DWORD *)(gpsi + 4656LL);
    }
    else
    {
      v20 = *(_DWORD *)(gpsi + 4584LL);
    }
