/*
 * XREFs of ?UnInitialize@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C020BD60
 * Callers:
 *     ??_ERimBackedDeviceBase@Rim@@UEAAPEAXI@Z @ 0x1C020B980 (--_ERimBackedDeviceBase@Rim@@UEAAPEAXI@Z.c)
