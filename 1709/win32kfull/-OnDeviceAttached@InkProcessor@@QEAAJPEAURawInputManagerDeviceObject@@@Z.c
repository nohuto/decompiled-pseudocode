/*
 * XREFs of ?OnDeviceAttached@InkProcessor@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1C0218DF4
 * Callers:
 ...
 *     ??_EInkDevice@@UEAAPEAXI@Z @ 0x1C0218D90 (--_EInkDevice@@UEAAPEAXI@Z.c)
...
LABEL_16:
  ...
  if ( v6 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      *v14 = v15;
      ...
      if ( (unsigned int)pRelatedActivityId > 4 )
      {
        ...
        v22 = a2;
        v36 = &v22;
        TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E8BE3, v16, v17, 7u, &pData);
      }
    }
    else if ( (unsigned int)pRelatedActivityId > 2 )
    {
      ...
      v28 = 32;
      v20 = a2;
      TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E8CDE, v12, v13, 5u, &pData);
    }
    goto LABEL_16;
  }
  v7 = -1073741801;
