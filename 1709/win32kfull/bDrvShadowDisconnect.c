/*
 * XREFs of bDrvShadowDisconnect @ 0x1C0298D2C
 * Callers:
  ...
  if ( a1 && (*(_DWORD *)(a1 + 32) & 1) != 0 )
  {
    SEMOBJEX::SEMOBJEX(
      ...
      *(HSEMAPHORE *)(a1 + 48),
      ...
      ghsemHT,
      6u);
    GreAcquireSemaphore(v13[5]);
    EtwTraceGreLockAcquireSemaphoreExclusive(L"po.hsemDevLock()", v13[5], 11LL);
    PDEVOBJ::vSync((PDEVOBJ *)&v13, (struct _SURFOBJ *)((v13[321] + 24LL) & -(__int64)(v13[321] != 0LL)), 0LL, 0);
    v5 = v13;
    v6 = (__int64 (__fastcall *)(__int64, _QWORD))v13[419];
    if ( v6 )
    {
      v7 = v6(a2, a3);
      v5 = v13;
    ...
    {
      v10 = (void (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))v5[360];
      if ( v10 )
      {
        v10(v5[227], &v14, 0LL, 0LL, *(_DWORD *)(v9 + 28));
        v5 = v13;
      }
      else
      {
    ...
    EtwTraceGreLockReleaseSemaphore(L"po.hsemDevLock()", v5[5]);
    GreReleaseSemaphoreInternal(v13[5]);
