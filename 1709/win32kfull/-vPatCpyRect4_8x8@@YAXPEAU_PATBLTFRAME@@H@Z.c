/*
 * XREFs of ?vPatCpyRect4_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C029EA00
 * Callers:
 *     ?vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x1C02A7F60 (-vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0143530 (__security_check_cookie.c)
 *     ?vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJ11@Z @ 0x1C029FE58 (-vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJ11@Z.c)
 */
...
void __fastcall vPatCpyRect4_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  do
  {
    v13 = dword_1C02F0CD8[v3->left & 7];
    v14 = ~v13;
    v15 = dword_1C02F0CD8[v3->right & 7];
    if ( !v15 )
      v15 = -1;
