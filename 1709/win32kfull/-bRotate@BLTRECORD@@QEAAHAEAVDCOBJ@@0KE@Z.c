/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C0002190
 * Callers:
 ...
 *     ?vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C00020AC (-vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
        ...
        unsigned __int8 a5)
{
  ...
  _OWORD v71[4]; // [rsp+B4h] [rbp-4Ch] BYREF
  ...
  if ( (a4 & 0xD4) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 80LL) + 312LL) & 1) != 0 )
    {
      if ( BLTRECORD::pSurfMskOut((BLTRECORD *)this) )
      {
        ...
        uMultiplicand = v28;
        if ( v25 < v27
          || (v29 = *(_DWORD *)(*(_QWORD *)&v23 + 60LL), v29 < v28)
          || v25 - v27 < v24
          || v29 - uMultiplicand < v26 )
        {
      ...
      || !*((_WORD *)XDCOBJ::pSurfaceEff(a3) + 50) )
    {
      ...
      if ( v37 == 52428 || v37 == 43724 )
      {
        if ( *(_QWORD *)(v36 + 512) && *(_QWORD *)(v35 + 512) )
        {
          ...
          v43 = *(_QWORD *)a2;
          v44 = *(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1LL;
          this[15].x += 16 * *(_DWORD *)(*(_QWORD *)a2 + 8 * v44 + 1432);
          this[15].y += 16 * *(_DWORD *)(v43 + 8 * v44 + 1436);
          this[16].x += 16 * *(_DWORD *)(v43 + 8 * v44 + 1432);
          this[16].y += 16 * *(_DWORD *)(v43 + 8 * v44 + 1436);
          this[17].x += 16 * *(_DWORD *)(v43 + 8 * v44 + 1432);
          this[17].y += 16 * *(_DWORD *)(v43 + 8 * v44 + 1436);
          this[18].x += 16 * *(_DWORD *)(v43 + 8 * v44 + 1432);
          this[18].y += 16 * *(_DWORD *)(v43 + 8 * v44 + 1436);
          v45 = *(_QWORD *)a3;
          ...
          this[23].y += v46[1];
          v47 = *(_QWORD *)a2;
          v48 = *(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1LL;
          v66 += *(_DWORD *)(*(_QWORD *)a2 + 8 * v48 + 1432);
          v68 = *(_DWORD *)(v47 + 8 * v48 + 1432) + v41;
          v67 += *(_DWORD *)(v47 + 8 * v48 + 1436);
          v69 = *(_DWORD *)(v47 + 8 * v48 + 1436) + v40;
          v49 = XDCOBJ::prgnEffRao(a2);
          v72 = 0LL;
          v73 = 0;
          v74 = 1;
          v75 = 0LL;
          ...
          if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)v71) )
          {
            ...
            {
              v65 = v71[0];
              XDCOBJ::vAccumulateTight(a2, v50, (struct ERECTL *)&v65);
            }
      ...
      else
      {
        *(_QWORD *)&v65 = 0LL;
        ...
        {
          v38 = BLTRECORD::bBitBlt((BLTRECORD *)this, a2, a3, a4);
          v39 = *(_QWORD *)a2;
          *(_DWORD *)(v39 + 36) |= 0x10u;
          *(_QWORD *)(v39 + 1528) = 0LL;
        }
...
LABEL_9:
  ...
  if ( (a4 & 0x10000) == 0 || (unsigned int)BLTRECORD::bRotate((BLTRECORD *)this, (struct SURFMEM *)&v59, a5) )
  {
    ...
    {
      v15 = BLTRECORD::bBitBlt((BLTRECORD *)this, a2, a3, a4);
      v16 = *(_QWORD *)a2;
      *(_DWORD *)(v16 + 36) |= 0x10u;
      *(_QWORD *)(v16 + 1528) = 0LL;
      v12 = v15;
