/*
 * XREFs of vSrcTranCopyS1D4 @ 0x1C026DA80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
char __fastcall vSrcTranCopyS1D4(__int64 a1, int a2, int a3, __int64 a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  unsigned __int8 *v56; // [rsp+10h] [rbp-48h]
  __int64 v57; // [rsp+18h] [rbp-40h]
  ...
  if ( v21 > 0 )
  {
    ...
    do
    {
      ...
      {
        v27 = *v18++;
        *v22 = v15 & *((_BYTE *)&v59 + ((unsigned __int64)v27 >> 6)) | *v22 & ~*((_BYTE *)&v59
                                                                               + ((unsigned __int64)v27 >> 6));
        v28 = *((_BYTE *)&v59 + ((v27 >> 4) & 3));
        v22[1] = v15 & v28 | v22[1] & ~v28;
        v29 = *((_BYTE *)&v59 + (v27 & 3));
        v22[2] = v15 & *((_BYTE *)&v59 + ((v27 >> 2) & 3)) | v22[2] & ~*((_BYTE *)&v59 + ((v27 >> 2) & 3));
  ...
  if ( v14 )
  {
        ...
        do
        {
          ...
          if ( v37 >= 2 )
          {
            ...
            do
            {
              ...
              v35 *= 4;
              *v36 = v15 & *((_BYTE *)&v59 + v39) | *v36 & ~*((_BYTE *)&v59 + v39);
              ++v36;
              --v38;
            }
            while ( v38 );
    ...
    do
    {
      ...
      for ( ; v46; v46 -= 2 )
      {
        v20 = (unsigned __int64)(unsigned __int8)v45 >> 6;
        v45 *= 4;
        LOBYTE(v20) = v15 & *((_BYTE *)&v59 + v20) | *v30 & ~*((_BYTE *)&v59 + v20);
        *v30++ = v20;
      }
      v42 += v55;
      v30 += v43;
    ...
    do
    {
      ...
      if ( v17 >= 2 )
      {
        ...
        do
        {
          ...
          v51 *= 4;
          LOBYTE(v20) = v15 & *((_BYTE *)&v59 + v20) | *v48 & ~*((_BYTE *)&v59 + v20);
          *v48++ = v20;
          --v53;
        }
        while ( v53 );
