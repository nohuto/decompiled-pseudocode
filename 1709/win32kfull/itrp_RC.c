...
__int64 __fastcall itrp_RC(__int64 a1, char a2)
{
  ...
  {
    if ( (int)v7 >= *(_DWORD *)(qword_1C0327C90 + 440) || (int)v7 < 0 )
      goto LABEL_14;
    v12 = 5;
  }
...
LABEL_14:
  ...
  *(_DWORD *)qword_1C0327C78 = InvokeProject(v16, v15, *(_DWORD *)(v14 + 4 * v7));
  result = a1;
  qword_1C0327C78 += 4LL;
  return result;
}
