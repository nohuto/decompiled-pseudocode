/*
 * XREFs of bSpEnableSprites @ 0x1C00EBB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSpEnableSprites(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 208) = GreCreateSemaphore();
  ...
  if ( !v8 )
    goto LABEL_24;
  Surface = psoSpCreateSurface((struct _SPRITESTATE *)(a1 + 72), 0, 1, 1, v16);
  if ( !Surface )
  {
    Win32FreePool(v8, 0LL, v10);
LABEL_24:
    v14 = *(_QWORD *)(a1 + 200);
    if ( v14 )
  ...
  *(_QWORD *)(a1 + 216) = v8;
  *(_QWORD *)(a1 + 224) = v8 + 10;
  RGNOBJ::vSet((RGNOBJ *)&v17, (struct _RECTL *)(a1 + 120));
  v11 = v17;
  *(_QWORD *)(a1 + 944) = v17;
