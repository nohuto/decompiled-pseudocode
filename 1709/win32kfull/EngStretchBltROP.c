/*
 * XREFs of EngStretchBltROP @ 0x1C00FA890
 * Callers:
...
LABEL_30:
  ...
  v20 = v18 & 2;
  if ( v20 )
    v21 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))(v19 + 2864);
  else
    v21 = EngStretchBlt;
  v22 = 0LL;
  if ( v20 && (*(_DWORD *)(v19 + 32) & 0x20000) == 0 )
  {
    if ( iMode == 4 && (*(_BYTE *)(v19 + 1840) & 0x10) == 0 )
      v21 = EngStretchBlt;
    if ( *(_WORD *)(v16 + 100) == 1 && v17 && (v17[8] & 0x20000) != 0 )
    {
      v47 = v17[650];
      if ( prclSrc->left < v47 )
        goto LABEL_55;
