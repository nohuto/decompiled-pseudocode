/*
 * XREFs of ?xxxSetAutoRotationConvertible@CLegacyRotationMgr@@AEAAXH@Z @ 0x1C0042AB8
 * Callers:
...
void __fastcall CLegacyRotationMgr::xxxSetAutoRotationConvertible(CLegacyRotationMgr *this, int a2)
{
  const GUID *v2; // r9
  const GUID *v4; // r8
  ...
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E871E, v4, v2, 4u, &pData);
    LODWORD(v2) = v12;
  }
  if ( dword_1C03267D4 && !(_DWORD)v2 && !dword_1C03267D0 )
  {
    CLegacyRotationMgr::xxxRestoreSlateAutorotationPreferences(this);
    LODWORD(v2) = v12;
  }
  dword_1C03267D4 = (int)v2;
}
