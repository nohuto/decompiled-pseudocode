/*
 * XREFs of _TelemPTPConfigUpdateEx @ 0x1C01A7DE8
 * Callers:
 *     CheckPointerDeviceConfiguration @ 0x1C0043BB4 (CheckPointerDeviceConfiguration.c)
 *     TelemPTPConfigUpdate @ 0x1C01A7D90 (TelemPTPConfigUpdate.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  *(_QWORD *)pwsz = 0LL;
  ...
  if ( !a7 )
  {
    TelemDeviceData = GetTelemDeviceData(v24, pwsz, &v17, &v18, &v15, &v16, a5, a6);
    v8 = v15;
    v7 = v16;
    v10 = v17;
    v9 = v18;
