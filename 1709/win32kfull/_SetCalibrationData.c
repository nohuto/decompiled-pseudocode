...
__int64 __fastcall SetCalibrationData(__int64 a1, __int64 a2, void *a3, int a4)
{
  ...
  if ( a3 )
  {
    if ( ValidateCalibrationData(a2, (__int64)a3, a4) )
    {
      ...
      updated = UpdateTiltCalData(*(_QWORD *)(a1 + 472), DataSize, (__int64)a3, a4, &v17);
      v5 = updated;
      if ( v4 && updated )
      {
