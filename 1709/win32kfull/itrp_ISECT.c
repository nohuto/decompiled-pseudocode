/*
 * XREFs of itrp_ISECT @ 0x1C02CD440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_ISECT(__int64 a1)
{
  ...
  if ( (qword_1C0327C90 ^ *(_QWORD *)qword_1C0327C90 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0327C90 + 424)) != *(_QWORD *)(qword_1C0327C90 + 432)
    || (v64 = 5, (unsigned __int64)((qword_1C0327C78 - *(_QWORD *)qword_1C0327C90) >> 2) < 5) )
  {
  ...
  v60 = v3;
  v62 = qword_1C0327C78 - 8;
  v5 = v3[4];
  v6 = v3[6];
  v7 = *(int *)(qword_1C0327C78 - 8);
  v8 = v6;
  if ( v5 > v6 )
    v8 = v3[4];
  if ( v8 <= 1u )
  ...
  {
    v11 = *(_WORD *)(v2 + 80);
    if ( v11 < 1 || v11 > v66 || (int)v4 < v10 + *(__int16 *)(*(_QWORD *)(v2 + 64) + 2LL * (v11 - 1)) )
    {
      v12 = v6;
      if ( v5 > v6 )
        v12 = v5;
      ...
      if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, v2)
        && (v11 < 1 || v11 > v67 || (int)v7 < v14 + *(__int16 *)(*(_QWORD *)(v2 + 64) + 2LL * (v11 - 1))) )
      {
        ...
        {
          v22 = *(_WORD *)(v16 + 80);
          if ( v22 < 1 || v22 > v20 || (int)v17 < v21 + *(__int16 *)(*(_QWORD *)(v16 + 64) + 2LL * (v22 - 1)) )
          {
            v23 = v6;
            if ( v5 > v6 )
              v23 = v5;
            ...
            if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, v16) )
            {
              ...
              else
              {
                v27 = v22;
                v28 = v69;
                if ( v27 <= v25 && v69 >= v26 + *(__int16 *)(*(_QWORD *)(v16 + 64) + 2LL * (v27 - 1)) )
                  goto LABEL_78;
              }
              v29 = v17;
              ...
              if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, qword_1C0327C60) )
              {
                ...
                if ( v40 < 1
                  || v40 > v38
                  || (v41 = v40 - 1, (int)v37 < v64 + *(__int16 *)(*(_QWORD *)(v39 + 64) + 2 * v41)) )
                {
                  qword_1C0327C78 = (__int64)(v63 - 1);
                  if ( v39 != v59 && *(_BYTE *)(v1 + 333) == 2 && (*(_BYTE *)(v1 + 452) & 2) != 0 )
                    AddProportion(v41, v39, v57, v37, v56);
                  v42 = v55;
                  *(_BYTE *)(*(_QWORD *)(qword_1C0327C60 + 72) + v37) |= 3u;
                  v43 = *(_QWORD *)qword_1C0327C60;
                  v44 = *(_QWORD *)(qword_1C0327C60 + 8);
                  if ( v55 )
                  {
                    v51 = v54;
                    if ( !v54 )
