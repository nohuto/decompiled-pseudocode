/*
 * XREFs of ?lOverhang@RFONTOBJ@@QEAAJXZ @ 0x1C0036620
 * Callers:
...
__int64 __fastcall RFONTOBJ::lOverhang(RFONTOBJ *this)
{
  ...
  v2 = 0;
  v4 = 0;
  v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 112LL) + 32LL);
  if ( (*(_DWORD *)(v5 + 48) & 6) == 0 || v1[22] )
    return v4;
  v7 = v1[3];
  if ( (v7 & 0x4000) != 0 )
    v4 = (v1[86] - 1) / 2;
  ...
  if ( (*(_DWORD *)(v5 + 48) & 4) == 0 )
    return ++v4;
  EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v14, (struct MATRIX *)v16, 8);
  if ( v14[0] )
  {
