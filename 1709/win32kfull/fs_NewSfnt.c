/*
 * XREFs of fs_NewSfnt @ 0x1C02B5E84
 * Callers:
 ...
 *     fsg_PrivateFontSpaceSize @ 0x1C02C2070 (fsg_PrivateFontSpaceSize.c)
 *     fsg_WorkSpaceSetOffsets @ 0x1C02C28F4 (fsg_WorkSpaceSetOffsets.c)
