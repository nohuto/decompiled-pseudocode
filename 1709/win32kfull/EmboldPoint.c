/*
 * XREFs of EmboldPoint @ 0x1C02BF428
 * Callers:
        ...
        _QWORD *a13)
{
  ...
  v22 = HIDWORD(a6) - HIDWORD(a7);
  if ( a4 )
  {
    v21 = HIDWORD(a6) - HIDWORD(a5);
    v19 = (unsigned int)(a5 - a6);
    v20 = a6 - a7;
    v22 = HIDWORD(a7) - HIDWORD(a6);
  }
  v23 = a11;
  v24 = a9;
  v49 = a6;
  if ( !v52 )
  {
    itrp_Normalize((unsigned int)v21, v19, &v52);
    a11 = (__int16)v52 >> 8;
    v28 = SHIWORD(v52) >> 8;
    itrp_Normalize((unsigned int)v22, v20, &v52);
    v25 = a8;
    v29 = a8;
    v30 = (__int16)v52 >> 8;
    v31 = SHIWORD(v52) >> 8;
...
LABEL_18:
  ...
  v45 = a12;
  *(_DWORD *)(v39 + *v38) += v24;
  *(_DWORD *)(v39 + v38[1]) += v23;
  result = v38[1];
  if ( *(_DWORD *)(v39 + result) < v45 )
    *(_DWORD *)(v39 + result) = v45;
  if ( v16 != a2 )
  {
    for ( i = v16 + 1; (unsigned int)i <= a2; i = (unsigned int)(i + 1) )
    {
      *(_DWORD *)(*v38 + 4 * i) = *(_DWORD *)(v39 + *v38);
      v48 = v38[1];
      result = *(unsigned int *)(v39 + v48);
