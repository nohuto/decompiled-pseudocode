/*
 * XREFs of ?TabletRetrieveDevMode@@YAJPEAU_devicemodeW@@@Z @ 0x1C01B9FF0
 * Callers:
...
__int64 __fastcall TabletRetrieveDevMode(struct _devicemodeW *a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *((_WORD *)BaseAddress + 34) = 220;
    v2 = DrvEnumDisplaySettings(0LL, *(_QWORD *)(*(_QWORD *)(gpDispInfo + 88LL) + 232LL), 0xFFFFFFFFLL, BaseAddress, 6);
    if ( v2 >= 0 )
    {
      v3 = BaseAddress;
