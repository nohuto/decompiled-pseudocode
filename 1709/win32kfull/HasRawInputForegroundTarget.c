/*
 * XREFs of HasRawInputForegroundTarget @ 0x1C00FA77C
 * Callers:
...
__int64 __fastcall HasRawInputForegroundTarget(_QWORD *a1)
{
  ...
  *a1 = 0LL;
  ...
  if ( gpqForeground )
  {
    if ( (*(_DWORD *)(gpqForeground + 380LL) & 0x2000000) != 0 )
    {
      ...
      if ( v8 )
      {
        ...
        if ( (v9 & 0x40000) != 0 && (v9 & 0x80000) == 0 && (v9 & 0x100000) == 0 )
        {
          ...
          if ( v10 )
          {
            ...
            if ( v11 )
              v11 = *(_QWORD *)(v11 + 16);
            if ( v11 && (*(_DWORD *)(v11 + 1184) & 0x200000) != 0 && v11 == *(_QWORD *)(v10 + 16) )
            {
              a1[1] = v11;
              v1 = 1;
              a1[2] = v10;
