/*
 * XREFs of ?vSpDeviceControlSprites@@YAXPEAUHDEV__@@PEAVEWNDOBJ@@K@Z @ 0x1C0260A28
 * Callers:
...
void __fastcall vSpDeviceControlSprites(HDEV a1, struct EWNDOBJ *a2, __int64 a3, __int64 a4)
{
  ...
  __int64 *v134[24]; // [rsp+138h] [rbp+30h] BYREF
  ...
  v6 = v130 + 18;
  UNDODESKTOPCOORD::UNDODESKTOPCOORD((UNDODESKTOPCOORD *)v131, a2, (struct _SPRITESTATE *)(v130 + 18));
  if ( v5 != 1 )
  {
...
LABEL_83:
                           ...
                           + 20LL) & 0x400) == 0 )
      {
        ...
        v98 = *((_QWORD *)v6 + 5);
LABEL_82:
        v112 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(v98 + 24) + 1328LL);
        goto LABEL_84;
      }
...
LABEL_40:
                         ...
                         + 20LL) & 0x400) == 0 )
    {
        ...
        && (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*((_QWORD *)v8 + 20)) + 112) & 0x400) != 0 )
      {
        v39 = *((_QWORD *)v8 + 20);
LABEL_39:
        v53 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(v39 + 24) + 1328LL);
        goto LABEL_41;
      }
      goto LABEL_40;
    }
