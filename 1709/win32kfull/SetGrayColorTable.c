/*
 * XREFs of SetGrayColorTable @ 0x1C000CB3C
 * Callers:
...
void __fastcall SetGrayColorTable(_OWORD *a1, __int64 a2)
{
  ...
  if ( *(_WORD *)(a2 + 2) )
  {
    ...
    if ( a1 )
    {
      do
      {
        v5 = *((_DWORD *)a1 + (unsigned int)v4[1] + 256) + *((_DWORD *)a1 + (unsigned int)v4[2] + 512);
        v6 = *v4;
        v4 += 4;
  ...
  else
  {
    ...
    if ( a1 != v10 )
    {
      v11 = 8LL;
      v12 = 8LL;
      v13 = &v10[64 * *(unsigned __int8 *)(a2 + 68)];
      v14 = a1;
      do
      {
        *v13 = *v14;
      ...
      while ( v12 );
      v16 = (_OWORD *)(*(_QWORD *)(a2 + 8) + 4LL * (*(unsigned __int8 *)(a2 + 67) << 8));
      v17 = 8LL;
      v18 = a1 + 64;
      do
      {
      ...
      while ( v17 );
      v20 = (_OWORD *)(*(_QWORD *)(a2 + 8) + 4LL * (*(unsigned __int8 *)(a2 + 66) << 8));
      v21 = a1 + 128;
      do
      {
        *v20 = *v21;
