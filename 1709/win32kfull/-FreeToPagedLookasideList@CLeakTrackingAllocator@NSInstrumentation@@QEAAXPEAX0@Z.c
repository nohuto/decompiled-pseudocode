/*
 * XREFs of ?FreeToPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX0@Z @ 0x1C01A07F8
 * Callers:
        ...
        struct _SLIST_ENTRY *a3)
{
  ...
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v4; // rsi
  ...
  if ( *a2 )
  {
    v7 = *(NSInstrumentation::CPointerHashTable **)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 48LL);
    v9 = 0LL;
    v3 = a3 - 1;
    ...
    NSInstrumentation::CSharedStorage<NSInstrumentation::CBackTraceBucket,long volatile,NSInstrumentation::CBackTraceStorageUnit,NSInstrumentation::CBackTrace>::Remove(
      *(NSInstrumentation::CPrioritizedWriterLock **)(*(_QWORD *)&v4 + 64LL),
      v9);
    ++*((_DWORD *)a2 + 11);
