/*
 * XREFs of AdjustLinearity @ 0x1C01A9F00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
                ...
                if ( v30 != v31 )
                {
                  ...
                  if ( v32 != v33 )
                  {
                    ...
                    *(_WORD *)(a1 + 10) = v16;
                    ...
                    v35 = v31 + (v15 - v27) * (v33 - v31) / (v26 - v27);
                    v36 = v26 + (v42 - v26) * (v45 - v33) / (v32 - v33);
                    if ( v43 != v35 && v36 != v34 )
                    {
                      v37 = *(unsigned __int16 *)(a1 + 8 * v48 + 16);
                      v38 = v37 + (v45 - v35) * (*(unsigned __int16 *)(a1 + 8 * v49 + 16) - v37) / (v43 - v35);
                      v39 = *(unsigned __int16 *)(a1 + 8 * v48 + 18);
                      v40 = v39 + (v44 - v34) * (*(unsigned __int16 *)(a1 + 8 * v50 + 18) - v39) / (v36 - v34);
                      if ( v38 >= 0 )
                      {
                        if ( v46 <= v38 )
                          v38 = v46 - 1;
                      ...
                      if ( v46 )
                      {
                        if ( v47 )
                        {
                          *a2 = *a4 + v38 * (a4[2] - *a4 + 1) / (unsigned int)v46;
                          *a3 = a4[1] + (unsigned int)(v40 * (a4[3] - a4[1] + 1)) / *(_DWORD *)(a1 + 4);
                        }
                      }
                    }
                  }
