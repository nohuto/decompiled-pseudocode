/*
 * XREFs of ?CreateUsermodeParameters@EscapeRequest@@UEAAJPEAVUmfdTls@@PEAPEAX@Z @ 0x1C02B3B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EscapeRequest::CreateUsermodeParameters(EscapeRequest *this, UmfdUMBuffer **a2, void **a3)
{
  ...
  if ( !v10 )
    return 3221225495LL;
  *((_QWORD *)this + 11) = v10 + 48;
  *((_QWORD *)this + 12) = &v10[v7 + 48];
  v12 = (const void *)*((_QWORD *)this + 7);
  if ( v12 )
    memmove(*((void **)this + 11), v12, *((unsigned int *)this + 13));
  else
    *((_QWORD *)this + 11) = 0LL;
  if ( !*((_QWORD *)this + 9) )
    *((_QWORD *)this + 12) = 0LL;
  ...
  *((_QWORD *)v11 + 2) = *((_QWORD *)this + 11);
  v11[6] = *((_DWORD *)this + 16);
  *((_QWORD *)v11 + 4) = *((_QWORD *)this + 12);
  *a3 = v11;
  return 0LL;
}
