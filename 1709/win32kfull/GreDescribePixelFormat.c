/*
 * XREFs of GreDescribePixelFormat @ 0x1C029502C
 * Callers:
...
LABEL_15:
  ...
  *(_QWORD *)&v15.left = *(_QWORD *)(v7 + 48);
  ...
  {
    v15 = *(struct _RECTL *)(v7 + 1448);
    DeviceHdev = hdevFindDeviceHdev(*(_QWORD **)(v7 + 48), &v15, 0LL);
    if ( DeviceHdev )
      v11 = DeviceHdev;
  }
  v13 = *(unsigned int (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(v11 + 3144);
  if ( !v13 || !v13(*(_QWORD *)(v11 + 1816), (unsigned int)a2, a3, a4) )
    v10 = 0;
