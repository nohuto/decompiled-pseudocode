/*
 * XREFs of ?bRectangleMesh@@YAHPEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAU_GRADIENT_RECT@@KKPEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C00B7448
 * Callers:
 ...
 *     ?MDiv64@@YA_J_J00@Z @ 0x1C00B7888 (-MDiv64@@YA_J_J00@Z.c)
 *     ?bCalcGradientRectOffsets@@YAHPEAU_GRADIENTRECTDATA@@@Z @ 0x1C00B78D4 (-bCalcGradientRectOffsets@@YAHPEAU_GRADIENTRECTDATA@@@Z.c)
        ...
        struct _POINTL *a9)
{
  ...
  if ( v40 || (v44 = *((_QWORD *)a1 + 6), (v40 = *(_QWORD *)(v44 + 1824)) != 0) )
  {
    ...
    while ( (unsigned int)v15 < a6 )
    {
      ...
      if ( v49 - v47 > 0 && v22 > 0 )
      {
        v51 = (unsigned __int64)v20->Red << 40;
        v52 = (unsigned __int64)v20->Green << 40;
        v53 = (unsigned __int64)v20->Blue << 40;
        v23 = (unsigned __int64)v20->Alpha << 40;
        v54 = v23;
        v24 = ((unsigned __int64)v19->Red << 40) - v51;
        if ( a7 )
        {
          v57 = 0LL;
          v58 = 0LL;
          v25 = ((unsigned __int64)v19->Alpha << 40) - v23;
        ...
        else
        {
          v55 = 0LL;
          v56 = 0LL;
          v34 = ((unsigned __int64)v19->Alpha << 40) - v23;
