/*
 * XREFs of ?FinishStockFontInitInternal@@YAXPEBGH@Z @ 0x1C00C0450
 * Callers:
 ...
 *     bDeleteFont @ 0x1C00C0910 (bDeleteFont.c)
...
void __fastcall FinishStockFontInitInternal(const unsigned __int16 *a1, int a2)
{
  ...
  for ( i = 0; i < 3; ++i )
  {
    ...
    while ( 1 )
    {
      ...
      *v16 = 0;
      if ( v8 < 0 || (int)StringCchCatW(v7, v15, (char *)v6) < 0 )
        goto LABEL_35;
      LOBYTE(v18) = 10;
      v19 = v10[*v11];
