/*
 * XREFs of ?BmpDevStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02761C0
 * Callers:
 *     <none>
 * Callees:
          ...
          do
          {
            ...
            if ( v21 )
            {
              if ( (*(_DWORD *)(v21 + 1840) & 0x8000000) != 0 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v21 + 1808) + 224LL) )
                  {
                    ...
                    (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, struct _RECTL *, struct _POINTL *, unsigned int))(v24 + 224))(
                      v27,
                      v26,
                      DevBitmap,
                      a4,
