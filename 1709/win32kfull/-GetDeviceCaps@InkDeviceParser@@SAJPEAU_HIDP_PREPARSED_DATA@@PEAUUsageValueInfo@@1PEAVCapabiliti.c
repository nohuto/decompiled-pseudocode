/*
 * XREFs of ?GetDeviceCaps@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAUUsageValueInfo@@1PEAVCapabilities@InkDevice@@@Z @ 0x1C0219A64
 * Callers:
  ...
  if ( SpecificValueCaps >= 0 )
  {
    ...
    if ( (unsigned int)pRelatedActivityId > 2 )
    {
      *(_DWORD *)ValueCapsLength = -1073741762;
      v25 = ValueCapsLength;
      v26 = 4LL;
      TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E9672, v14, v15, 3u, &pData);
    }
    return 3221225534LL;
  }
  else
