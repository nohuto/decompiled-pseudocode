/*
 * XREFs of _EnableIAMThreadAccess @ 0x1C01005B8
 * Callers:
...
__int64 __fastcall EnableIAMThreadAccess(__int64 a1, int a2)
{
  ...
  if ( a2 )
  {
    IAMThread = (struct _LIST_ENTRY *)FindIAMThread((const struct tagTHREADINFO *)a1);
    if ( !IAMThread )
    {
    ...
    IAMThread[1].Blink = *(struct _LIST_ENTRY **)(a1 + 432);
    return 1;
  }
  v4 = FindIAMThread((const struct tagTHREADINFO *)a1);
  if ( v4 )
  {
    v6 = *(_QWORD *)v4;
    if ( *(struct tagIAM_THREAD **)(*(_QWORD *)v4 + 8LL) != v4
      || (v7 = (struct tagIAM_THREAD **)*((_QWORD *)v4 + 1), *v7 != v4) )
    {
      __fastfail(3u);
    }
    *v7 = (struct tagIAM_THREAD *)v6;
    *(_QWORD *)(v6 + 8) = v7;
    Win32FreePool(v4, v7, v5);
    return 1;
  }
  return v2;
}
