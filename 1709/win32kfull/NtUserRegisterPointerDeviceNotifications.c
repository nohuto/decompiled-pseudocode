/*
 * XREFs of NtUserRegisterPointerDeviceNotifications @ 0x1C01192C0
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x1C0064344 (UserSetLastError.c)
 *     _RegisterPointerDeviceNotifications @ 0x1C011937C (_RegisterPointerDeviceNotifications.c)
 */
...
__int64 __fastcall NtUserRegisterPointerDeviceNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      if ( a2
        && (v10 = *(_QWORD *)(gptiCurrent + 400LL), (unsigned int)*(_QWORD *)(v10 + 832) <= 0x1FFF)
        && gbEnforceUIPI )
      {
