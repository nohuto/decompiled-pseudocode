/*
 * XREFs of ?HidRequestValidityCheck@@YAHQEAUtagRAWINPUTDEVICE@@PEBUtagPROCESS_HID_TABLE@@W4_REGISTER_RAW_INPUT_INTERNAL@@@Z @ 0x1C00C7550
 * Callers:
...
__int64 __fastcall HidRequestValidityCheck(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (v8 & 0x200) != 0 )
  {
    ...
    if ( *(_WORD *)(a1 + 2) == 2 )
    {
      ...
      v8 = *(_QWORD *)(v5 + 16);
      v16 = *(_QWORD *)(v8 + 400) == CurrentProcessWin32Process;
    }
    else
    {
      v16 = *(_WORD *)(a1 + 2) == 6;
...
LABEL_20:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v5 + 16) + 400LL) == PsGetCurrentProcessWin32Process(v8) )
  {
LABEL_25:
