/*
 * XREFs of CheckImeHotKey @ 0x1C00CEB64
 * Callers:
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(__int64 a1, int a2, int a3)
{
  ...
  v6 = *(_BYTE *)(a1 + 264);
  v7 = ((v6 & 0x10) != 0 ? 0x8002 : 0) | ((v6 & 0x40) != 0 ? 0x4002 : 0) | ((*(_BYTE *)(a1 + 265) & 1) != 0 ? 0x8001 : 0) | ((*(_BYTE *)(a1 + 265) & 4) != 0 ? 0x4001 : 0);
