/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C004F8A0
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1)
{
  ...
  v16[12] = (char *)a1 + 96;
  v16[14] = (char *)a1 + 112;
  if ( (unsigned int)RIMIsDefaultUILanguageRTL() != dword_1C032002C )
  {
    v12 = xmmword_1C0320D18;
    xmmword_1C0320D18 = xmmword_1C0320CB8;
    dword_1C032002C = dword_1C032002C == 0;
    xmmword_1C0320CB8 = v12;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C0320CB8;
    *((_OWORD *)a1 + 1) = xmmword_1C0320CD0;
    *((_OWORD *)a1 + 2) = xmmword_1C0320CE8;
    *((_OWORD *)a1 + 3) = xmmword_1C0320D00;
    *((_OWORD *)a1 + 4) = xmmword_1C0320D18;
    *((_OWORD *)a1 + 5) = xmmword_1C0320D30;
    *((_OWORD *)a1 + 6) = xmmword_1C0320D48;
    *((_OWORD *)a1 + 7) = xmmword_1C0320D60;
  }
