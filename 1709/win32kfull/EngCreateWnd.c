/*
 * XREFs of EngCreateWnd @ 0x1C0266C10
 * Callers:
...
LABEL_9:
    if ( v11 )
    {
      for ( i = *((_QWORD *)v11 + 3); ; i = *(_QWORD *)(i + 160) )
      {
        if ( !i )
        {
    ...
    do
    {
      if ( *((_QWORD *)v13 + 4) == v9 && *((WNDOBJCHANGEPROC *)v13 + 5) == pfn )
        break;
      v13 = (TRACKOBJ *)*((_QWORD *)v13 + 1);
    }
    while ( v13 );
    if ( !v13 )
    {
