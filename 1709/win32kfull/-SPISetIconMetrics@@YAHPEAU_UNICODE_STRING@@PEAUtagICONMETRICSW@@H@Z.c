/*
 * XREFs of ?SPISetIconMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagICONMETRICSW@@H@Z @ 0x1C01B7978
 * Callers:
 ...
 *     ?RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z @ 0x1C01B75C0 (-RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z.c)
...
__int64 __fastcall SPISetIconMetrics(struct _UNICODE_STRING *a1, struct tagICONMETRICSW *a2, int a3)
{
  ...
  if ( v8 )
  {
    SetIconMetrics(a1, (char *)a2);
    v12 = *(_QWORD *)(gptiCurrent + 432LL);
    if ( v12 )
      v4 = *(struct tagWND **)(*(_QWORD *)(v12 + 8) + 16LL);
