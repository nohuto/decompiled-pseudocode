/*
 * XREFs of ?GreDeleteColorTransform@@YAHPEAUHDC__@@PEAX@Z @ 0x1C0290BC4
 * Callers:
 *     NtGdiDeleteColorTransform @ 0x1C0291720 (NtGdiDeleteColorTransform.c)
 * Callees:
