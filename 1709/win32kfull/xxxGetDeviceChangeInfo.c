/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x1C01BEBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1, __int64 a2)
{
  ...
  _QWORD v17[3]; // [rsp+88h] [rbp+Fh] BYREF
  _QWORD v18[6]; // [rsp+A0h] [rbp+27h] BYREF
  char OutputBuffer; // [rsp+E0h] [rbp+67h] BYREF
  char v20; // [rsp+E1h] [rbp+68h]
  ...
  {
    v4 = qword_1C032A458;
    v5 = *(_QWORD **)(qword_1C032A458 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C032A458 != &gMediaChangeList || *v5 != qword_1C032A458 )
      __fastfail(3u);
    qword_1C032A458 = *(_QWORD *)(qword_1C032A458 + 8);
    *v5 = &gMediaChangeList;
  }
  ExReleaseFastMutexUnsafeAndLeaveCriticalRegion(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels);
  if ( !v4 )
    return 0LL;
  PushW32ThreadLock(v4, v18, (__int64)Win32FreePool, v6);
  ...
  {
    PushW32ThreadLock((__int64)FileObject, v17, UserDereferenceObject, v9);
  ...
  PopAndFreeAlwaysW32ThreadLock((__int64)v18, v7, v8, v9);
  return v2;
}
