/*
 * XREFs of RegisterIconTitleClass @ 0x1C0108AB4
 * Callers:
...
__int64 RegisterIconTitleClass()
{
  ...
  v12 = 32772LL;
  v14 = 32772LL;
  result = (__int64)InternalRegisterClassEx((__int64)v2, 667LL, 0x41u);
  if ( result )
  {
    result = 1LL;
    *(_DWORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 12LL) |= 0x10000000u;
  }
  return result;
}
