/*
 * XREFs of ?EngNineGridHelper@@YAHAEAVXDCOBJ@@PEAVPALETTE@@1PEAU_SURFOBJ@@2PEAU_RECTL@@3PEAU_MARGINS@@@Z @ 0x1C0258A8C
 * Callers:
                       ...
                       0) )
  {
                         ...
                         0) )
    {
                           ...
                           0) )
      {
        ...
        {
          v21 = v22;
          v8 = EngNineGrid(v10, (__int64)a5, 0, v16, (__int64)a6, (__int64)a7, (__int64)v17, &v18);
        }
      }
    }
  }
