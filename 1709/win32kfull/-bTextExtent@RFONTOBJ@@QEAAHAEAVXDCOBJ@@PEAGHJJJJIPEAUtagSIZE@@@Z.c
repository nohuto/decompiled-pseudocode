/*
 * XREFs of ?bTextExtent@RFONTOBJ@@QEAAHAEAVXDCOBJ@@PEAGHJJJJIPEAUtagSIZE@@@Z @ 0x1C0035FB8
 * Callers:
 ...
 *     ?bIs1Over16@EFLOAT@@QEAAHXZ @ 0x1C00B355C (-bIs1Over16@EFLOAT@@QEAAHXZ.c)
        ...
        struct tagSIZE *a10)
{
  ...
  if ( (_DWORD)v14 )
  {
    while ( 1 )
    {
      ...
      if ( v20 > 82 )
        v22 = 82;
      if ( !(unsigned int)RFONTOBJ::bGetGlyphMetrics(this, v22, &v49, v21, v16, 0LL) )
        return 0LL;
      if ( v22 > 0 )
      {
        v23 = v44;
...
LABEL_14:
    ...
    v28 = *(_QWORD *)this;
    if ( (unsigned __int8)bCalcBreakExtra(*(unsigned int *)(*(_QWORD *)this + 400LL), a7, a8, &v43) )
    {
      v36 = *(_DWORD *)(v28 + 464);
      v37 = v43;
      if ( v11 + v36 + v43 < 0 )
