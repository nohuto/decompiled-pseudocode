/*
 * XREFs of PlaySoundPostMessage @ 0x1C036B008
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00E0DF4 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00C4940 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C00E0E74 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00E0EC0 (PlaySndClient_midl_user_allocate.c)
 */
