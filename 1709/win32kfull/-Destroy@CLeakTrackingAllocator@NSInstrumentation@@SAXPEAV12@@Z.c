/*
 * XREFs of ?Destroy@CLeakTrackingAllocator@NSInstrumentation@@SAXPEAV12@@Z @ 0x1C0116144
 * Callers:
 ...
 *     ?Destroy@?$CSortedVector@PEAXPEAX@NSInstrumentation@@SAXPEAV12@@Z @ 0x1C02B25FC (-Destroy@-$CSortedVector@PEAXPEAX@NSInstrumentation@@SAXPEAV12@@Z.c)
 *     ?Uninitialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXXZ @ 0x1C02B32F8 (-Uninitialize@-$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@.c)
 */
        ...
        struct NSInstrumentation::CLeakTrackingAllocator *a1)
{
  ...
  v1 = (_QWORD *)WPP_MAIN_CB.DeviceQueue.1;
  if ( *(_BYTE *)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 72LL) )
  {
    v2 = *(void **)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 48LL);
    if ( v2 )
