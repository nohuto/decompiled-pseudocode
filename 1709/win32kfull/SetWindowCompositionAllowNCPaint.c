/*
 * XREFs of SetWindowCompositionAllowNCPaint @ 0x1C020C2CC
 * Callers:
...
__int64 __fastcall SetWindowCompositionAllowNCPaint(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 2) == v5 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFFFD | (2 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v7, *(_QWORD *)a1, 4, a2);
    }
  }
  return v4;
}
