/*
 * XREFs of ?prunPlgRead4@@YAPEAU_PLGRUN@@PEAU_PLGDDA@@PEAU1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C02AE220
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v18 & dword_1C02F0FE0[v20]) != 0 )
        {
          v21 = (v13 & (unsigned int)dword_1C02F1060[v19]) >> dword_1C02F0FB8[v19];
          if ( a5 )
  ...
  else
  {
    ...
    if ( v8 < a7 )
    {
      while ( 1 )
      {
        v15 = (v13 & (unsigned int)dword_1C02F1060[v14]) >> dword_1C02F0FB8[v14];
