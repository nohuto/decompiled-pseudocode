/*
 * XREFs of ?hsurfSpCreateSurface@@YAPEAUHSURF__@@PEAUHDEV__@@PEAUtagSIZE@@@Z @ 0x1C0043480
 * Callers:
...
__int64 __fastcall hsurfSpCreateSurface(__int64 a1, struct tagSIZE *a2)
{
  ...
  __int64 v11; // [rsp+80h] [rbp-49h] BYREF
  char v12; // [rsp+88h] [rbp-41h]
  int v13; // [rsp+8Ch] [rbp-3Dh]
  _QWORD v14[4]; // [rsp+90h] [rbp-39h] BYREF
  _BYTE v15[80]; // [rsp+B0h] [rbp-19h] BYREF
  __int64 v16; // [rsp+130h] [rbp+67h] BYREF
