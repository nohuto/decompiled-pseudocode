/*
 * XREFs of ?bGetFaceName@MAPPER@@AEAAHXZ @ 0x1C00ADE18
 * Callers:
 ...
 *     ?FindFaceName@@YAPEAGK@Z @ 0x1C00B0F20 (-FindFaceName@@YAPEAGK@Z.c)
 */
...
__int64 __fastcall MAPPER::bGetFaceName(MAPPER *this)
{
  ...
  *((_DWORD *)this + 63) |= 0x20000u;
  ...
  if ( (unsigned int)MAPPER::bFindBitmapFont(this, FaceName)
    || (FaceName = FindFaceName(v8 | 0x800), (unsigned int)MAPPER::bFindBitmapFont(this, FaceName)) )
  {
