/*
 * XREFs of NtUserMenuItemFromPoint @ 0x1C01E9C20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !a1 || (a1 = ValidateHwnd(a1)) != 0 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 392LL) = v23;
    ...
    if ( v10 )
    {
      if ( a1 )
      {
        if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v8, v11, v12) + 456) + 224LL) & 1) == 0 )
        {
          v17 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v13, v14, v15) + 456);
