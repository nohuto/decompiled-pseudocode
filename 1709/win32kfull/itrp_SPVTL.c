/*
 * XREFs of itrp_SPVTL @ 0x1C02D3A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_SPVTL(__int64 a1, char a2)
{
  ...
  {
    v12 = *(_WORD *)(v11 + 80);
    if ( v12 < 1 || v12 > v27 || (int)v4 < v28 + *(__int16 *)(*(_QWORD *)(v11 + 64) + 2LL * (v12 - 1)) )
    {
      v13 = v8;
      if ( v7 > v8 )
        v13 = v7;
...
LABEL_36:
          if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, qword_1C0327C58) )
          {
            ...
            if ( v17 < 1 || v17 > v14 || (int)v6 < v16 + *(__int16 *)(*(_QWORD *)(v15 + 64) + 2LL * (v17 - 1)) )
            {
              ...
              {
                v18 = dword_1C0327C68;
                LOWORD(dword_1C0327C68) = -HIWORD(dword_1C0327C68);
                HIWORD(dword_1C0327C68) = v18;
              }
              itrp_ComputeAndCheck_PF_Proj();
              dword_1C0327CBC = 1;
              dword_1C0327CC0 = 1;
              v19 = *(_WORD *)(qword_1C0327C90 + 452);
              if ( (v19 & 1) == 0 )
                goto LABEL_54;
              if ( (v19 & 4) != 0 )
              {
...
LABEL_50:
              if ( v21 )
              {
                ...
                if ( (*(_BYTE *)(qword_1C0327C90 + 120) & 4) != 0 || *(_BYTE *)(qword_1C0327C90 + 333) )
                {
                  v22 = 8LL;
LABEL_56:
                  *(_DWORD *)(qword_1C0327C90 + 128) = itrp_RoundFunctionId[v22
