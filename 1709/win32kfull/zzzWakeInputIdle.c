/*
 * XREFs of zzzWakeInputIdle @ 0x1C0048C68
 * Callers:
  ...
  if ( (*(_DWORD *)(a1 + 464) & 0x1000) != 0 )
  {
    if ( *(_QWORD *)(*(_QWORD *)(a1 + 592) + 24LL) )
    {
      ...
      if ( v8 )
      {
        ...
        {
          KeSetEvent(v8, 1, 0);
          ObfDereferenceObject(*(PVOID *)(*(_QWORD *)(*(_QWORD *)(a1 + 592) + 24LL) + 32LL));
          *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 592) + 24LL) + 32LL) = -1LL;
        }
      }
      else
      {
