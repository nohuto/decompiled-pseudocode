/*
 * XREFs of ?vSrcCopyS1D8@@YAXPEAUBLTINFO@@@Z @ 0x1C00BE660
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vSrcCopyS1D8(struct BLTINFO *a1)
{
  ...
  struct BLTINFO *v87; // [rsp+40h] [rbp-31h]
  int v88; // [rsp+48h] [rbp-29h]
  int v89; // [rsp+4Ch] [rbp-25h]
...
LABEL_18:
  if ( (v89 & 7) != 0 && v18 != v17 )
  {
    v61 = *((_DWORD *)v2 + 8);
    v62 = *((_DWORD *)v2 + 13) - 1;
    v63 = *((_QWORD *)v2 + 2) + (v89 & 0xFFFFFFFFFFFFFFF8uLL);
