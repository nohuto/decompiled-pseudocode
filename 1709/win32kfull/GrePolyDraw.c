/*
 * XREFs of GrePolyDraw @ 0x1C027B4C8
 * Callers:
 *     NtGdiPolyDraw @ 0x1C028B0C0 (NtGdiPolyDraw.c)
 * Callees:
...
__int64 __fastcall GrePolyDraw(HDC a1, struct _POINTL *a2, char *a3, unsigned int a4)
{
  ...
  PATHOBJ v24[90]; // [rsp+80h] [rbp-318h] BYREF
...
LABEL_18:
  ...
  *(_DWORD *)(*(_QWORD *)&v18[10] + 88LL) = *(_DWORD *)(*(_QWORD *)&Current + 4LL);
  if ( (v20[0][22].x & 1) != 0 || (unsigned int)EPATHOBJ::bStrokeAndOrFill(v24, v20, (LINEATTRS *)&v20[0][23], &v22, 1u) )
    v8 = 1;
  XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)v24);
  DCOBJ::~DCOBJ((DCOBJ *)v20);
  return v8;
