/*
 * XREFs of ?MulDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C027E420
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  struct _DISPSURF *v67; // [rsp+120h] [rbp+20h]
  int v68[2]; // [rsp+128h] [rbp+28h]
  struct _CLIPOBJ *v69; // [rsp+130h] [rbp+30h]
  int v70[6]; // [rsp+138h] [rbp+38h]
  _BYTE v71[96]; // [rsp+150h] [rbp+50h] BYREF
  int v72[2]; // [rsp+1B0h] [rbp+B0h]
  _BYTE v73[96]; // [rsp+1C0h] [rbp+C0h] BYREF
...
LABEL_78:
              ...
              v49 = EngDrawStream;
              if ( *(_QWORD *)(v48 + 3424) )
                v49 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, int *, unsigned int, _DWORD *, _QWORD *))(v48 + 3424);
