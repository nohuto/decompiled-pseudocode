/*
 * XREFs of DwmSyncMagnUpdateWindowSharedTextures @ 0x1C024DB58
 * Callers:
 *     MagGetLensContextInformation @ 0x1C01A8324 (MagGetLensContextInformation.c)
 * Callees:
 *     ?SyncLpcCheckNtStatus@@YAJJPEAU_PORT_MESSAGE@@@Z @ 0x1C004C968 (-SyncLpcCheckNtStatus@@YAJJPEAU_PORT_MESSAGE@@@Z.c)
        ...
        _DWORD *a10)
{
  ...
  if ( Object )
  {
    ...
    if ( !gbInVideoPnpCallout )
    {
      ...
      *(_OWORD *)&v24[64] = v15;
      *(_QWORD *)&v24[80] = v14;
      EtwUpdateEvent(0LL, 1073741925LL);
