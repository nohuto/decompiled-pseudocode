/*
 * XREFs of xxxSetInternalWindowPos @ 0x1C01D2EAC
 * Callers:
    ...
    else
    {
      *(_QWORD *)(v9 + 16) = *a4;
      if ( *((_QWORD *)a1 + 13) == GetDesktopWindow((__int64)a1) )
      {
        ...
        v18 = *MonitorRect;
        *(_DWORD *)(v9 + 16) += _mm_cvtsi128_si32(v16) - *MonitorRect;
        *(_DWORD *)(v9 + 20) += _mm_cvtsi128_si32(_mm_srli_si128(v16, 4)) - DWORD1(v18);
      }
      v19 = *(_DWORD *)(v9 + 32) | 9;
    }
    *(_DWORD *)(v9 + 32) = v19;
