/*
 * XREFs of IncVisWindows @ 0x1C0092CD4
 * Callers:
...
__int64 __fastcall IncVisWindows(__int64 a1)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    v5 = *(_DWORD **)(v3 + 400);
    result = (unsigned int)v5[245];
    if ( v5[244] > (unsigned int)result && (v5[194] & 0x4000) == 0 )
    {
      GreDxgkSetProcessStatus(v5, 2LL);
      PsUpdateComponentPower(**(_QWORD **)(v3 + 400), 5LL);
      result = *(_QWORD *)(v3 + 400);
      *(_DWORD *)(result + 776) |= 0x4000u;
    }
    *(_DWORD *)(v3 + 1184) |= 0x40000000u;
  }
  return result;
}
