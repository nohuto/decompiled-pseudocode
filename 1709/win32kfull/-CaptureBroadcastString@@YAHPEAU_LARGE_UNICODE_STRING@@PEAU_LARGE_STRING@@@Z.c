/*
 * XREFs of ?CaptureBroadcastString@@YAHPEAU_LARGE_UNICODE_STRING@@PEAU_LARGE_STRING@@@Z @ 0x1C01208E4
 * Callers:
    ...
    *((_QWORD *)a1 + 1) = v6;
    if ( v6 )
    {
      ...
      *((_DWORD *)a1 + 1) = BytesInUnicodeString & 0x7FFFFFFF;
      if ( *((int *)a2 + 1) < 0 )
      {
        v10 = (unsigned int)RtlMultiByteToUnicodeN(
                              v6,
                              v7,
      ...
      *(_WORD *)(*((_QWORD *)a1 + 1) + 2 * ((unsigned __int64)*(unsigned int *)a1 >> 1)) = 0;
      if ( (int)v10 >= 0 )
        return 1LL;
      Win32FreePool(*((_QWORD *)a1 + 1), v10, v9);
    }
  }
  return 0LL;
}
