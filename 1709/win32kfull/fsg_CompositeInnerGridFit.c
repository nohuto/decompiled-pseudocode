/*
 * XREFs of fsg_CompositeInnerGridFit @ 0x1C02C0758
 * Callers:
 *     fsg_ExecuteGlyph @ 0x1C02C105C (fsg_ExecuteGlyph.c)
 * Callees:
 *     memmove @ 0x1C01456C0 (memmove.c)
 *     memset @ 0x1C0145A00 (memset.c)
 *     scl_AdjustOldSideBearingPoints @ 0x1C02B7D08 (scl_AdjustOldSideBearingPoints.c)
 *     scl_CalcOrigPhantomPoints @ 0x1C02B81EC (scl_CalcOrigPhantomPoints.c)
 *     scl_CopyCurrentPhantomPoints @ 0x1C02B8518 (scl_CopyCurrentPhantomPoints.c)
 *     scl_InitializeChildScaling @ 0x1C02B8684 (scl_InitializeChildScaling.c)
 *     scl_OriginalPhantomPointsToCurrentFixedFUnits @ 0x1C02B8E30 (scl_OriginalPhantomPointsToCurrentFixedFUnits.c)
 *     scl_RoundCurrentSideBearingPnt @ 0x1C02B8F24 (scl_RoundCurrentSideBearingPnt.c)
 *     scl_ScaleBackCurrentCharPoints @ 0x1C02B9300 (scl_ScaleBackCurrentCharPoints.c)
 *     scl_ScaleBackCurrentPhantomPoints @ 0x1C02B93D8 (scl_ScaleBackCurrentPhantomPoints.c)
 *     scl_ScaleFixedCurrentCharPoints @ 0x1C02B957C (scl_ScaleFixedCurrentCharPoints.c)
 *     scl_ScaleOldPhantomPoints @ 0x1C02B98E8 (scl_ScaleOldPhantomPoints.c)
        ...
        _DWORD *a18)
{
  ...
  *a18 = 0;
  ...
  if ( !a11 )
  {
    ...
    v26[1] = v23;
    v27 = v24;
    scl_InitializeChildScaling(v22, (int *)v26, a6);
