/*
 * XREFs of ?bIsLinkedGlyph@RFONTOBJ@@QEAAHG@Z @ 0x1C0034518
 * Callers:
...
__int64 __fastcall RFONTOBJ::bIsLinkedGlyph(RFONTOBJ *this, unsigned __int16 a2)
{
  ...
  if ( (unsigned __int16)(a2 + 0x2000) <= 0x18FFu
    ...
    && a2 >= gqlEUDC
    && a2 <= *(&gqlEUDC + 1)
    && ((0x80000000 >> (a2 & 0x1F)) & *(_DWORD *)(qword_1C0327408 + 4 * ((unsigned __int64)a2 >> 5))) != 0 )
  {
    v4 = 1;
    goto LABEL_4;
  }
...
LABEL_6:
  ...
  for ( i = PFEOBJ::pGetLinkedFontList((PFEOBJ *)&v21)->Flink; i != PFEOBJ::pGetLinkedFontList((PFEOBJ *)&v21); i = i->Flink )
  {
      ...
      && a2 <= *((_WORD *)PFEOBJ::pql((PFEOBJ *)&v20) + 1) )
    {
      ...
      if ( ((0x80000000 >> ((a2 - v10) % 32)) & *(_DWORD *)(*((_QWORD *)PFEOBJ::pql((PFEOBJ *)&v20) + 1) + 4 * v11)) != 0 )
        goto LABEL_15;
      v7 = a2;
    }
  }
