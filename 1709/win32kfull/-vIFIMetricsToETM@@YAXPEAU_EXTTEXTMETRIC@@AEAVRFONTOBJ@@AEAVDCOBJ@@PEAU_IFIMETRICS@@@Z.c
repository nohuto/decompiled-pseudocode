/*
 * XREFs of ?vIFIMetricsToETM@@YAXPEAU_EXTTEXTMETRIC@@AEAVRFONTOBJ@@AEAVDCOBJ@@PEAU_IFIMETRICS@@@Z @ 0x1C013A44C
 * Callers:
        ...
        struct _IFIMETRICS *a4)
{
  ...
  _QWORD v23[5]; // [rsp+50h] [rbp-39h] BYREF
  int v24; // [rsp+7Ch] [rbp-Dh]

  IFIOBJR::IFIOBJR((IFIOBJR *)v23, a4, a2, a3);
  v9 = v23[0];
  *(_WORD *)a1 = 52;
  v10 = (*(_DWORD *)(*(_QWORD *)a2 + 316LL) + 8) >> 4;
  if ( (*(_DWORD *)(v9 + 48) & 0x3000010) != 0 )
  {
    v11 = *(_DWORD *)(*(_QWORD *)a2 + 376LL);
    if ( v11 == 0x80000000 )
    {
      EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v22, (struct MATRIX *)v23, 8);
