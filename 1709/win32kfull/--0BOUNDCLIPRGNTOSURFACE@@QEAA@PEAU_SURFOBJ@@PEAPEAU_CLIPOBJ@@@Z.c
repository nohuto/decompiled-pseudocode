/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C012D6E0
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEAAHAEAU_RECTL@@@Z @ 0x1C012D854 (-bContain@ERECTL@@QEAAHAEAU_RECTL@@@Z.c)
