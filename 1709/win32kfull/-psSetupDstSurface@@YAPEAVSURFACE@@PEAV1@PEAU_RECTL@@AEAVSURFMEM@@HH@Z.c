/*
 * XREFs of ?psSetupDstSurface@@YAPEAVSURFACE@@PEAV1@PEAU_RECTL@@AEAVSURFMEM@@HH@Z @ 0x1C00B7284
 * Callers:
    ...
    *(_QWORD *)&v19.right = __PAIR64__(v8, v6);
    if ( a5 )
    {
      ...
      if ( v15 )
        ...
        v16 = (*(__int64 (__fastcall **)(__int64, unsigned __int64, _QWORD, XLATEOBJ *const, struct _RECTL *, _DWORD *))(v12 + 2856))(
                (*(_QWORD *)a3 + 24LL) & -(__int64)(*(_QWORD *)a3 != 0LL),
                ((unsigned __int64)v9 + 24) & -(__int64)(v9 != 0LL),
                0LL,
                xloIdent,
