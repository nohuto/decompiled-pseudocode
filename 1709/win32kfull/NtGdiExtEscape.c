/*
 * XREFs of NtGdiExtEscape @ 0x1C0036CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiExtEscape(HDC a1, char *a2, __int64 a3, unsigned int a4, int a5, char *Src, int a7, char *a8)
{
  __int64 v8; // r14
  char *v10; // rdi
  __int64 result; // rax
  ...
  char *v20; // [rsp+68h] [rbp-2E0h]
  _QWORD v21[4]; // [rsp+70h] [rbp-2D8h] BYREF
  _QWORD v22[4]; // [rsp+90h] [rbp-2B8h] BYREF
  ...
  if ( v20 )
  {
    ...
    Str1 = v25;
    v14 = 2 * v8;
    if ( &v20[v14] < v20 || (unsigned __int64)&v20[v14] > MmUserProbeAddress )
  ...
  if ( a5 )
  {
    ...
    {
      if ( a5 <= 40960000 )
        v12 = (char *)PALLOCMEM2((unsigned int)a5);
      if ( !v12 )
        goto LABEL_76;
      v17 = 1;
      goto LABEL_18;
...
LABEL_24:
    ...
    if ( Str1 )
      result = GreNamedEscape(Str1, a4, a5, v12, a7, v10);
    else
...
LABEL_61:
  ...
  if ( a7 <= 40960000 )
    v10 = (char *)PALLOCMEM2((unsigned int)a7);
  if ( v10 )
  {
    v16 = 1;
    goto LABEL_61;
