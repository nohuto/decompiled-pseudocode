/*
 * XREFs of NtGdiCreateRoundRectRgn @ 0x1C00B5E20
 * Callers:
 *     <none>
 * Callees:
...
struct HOBJ__ *__fastcall NtGdiCreateRoundRectRgn(unsigned int a1, unsigned int a2, int a3, int a4, unsigned int a5)
{
  int v9; // r8d
...
LABEL_22:
  ...
  if ( v18[0] )
  {
    ...
    {
LABEL_11:
      v11 = RGNOBJ::hrgnAssociate((void **)&v14);
      if ( !v11 )
