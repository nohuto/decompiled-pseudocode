/*
 * XREFs of ?InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C00C7A24
 * Callers:
        ...
        __int16 a3)
{
  ...
  __int64 v10; // rcx
  struct tagPROCESS_HID_REQUEST **v11; // rdx
  __int64 v12; // rcx
  __int64 v13; // rdx
  ...
  if ( result )
  {
    if ( v5 != result )
    {
      ...
      if ( *(struct tagPROCESS_HID_REQUEST **)(*(_QWORD *)result + 8LL) != result
        || (v11 = (struct tagPROCESS_HID_REQUEST **)*((_QWORD *)result + 1), *v11 != result) )
      {
        __fastfail(3u);
      }
...
LABEL_8:
    ...
    if ( *(struct tagPROCESS_HID_REQUEST **)v9 != result )
    {
      v13 = *(_QWORD *)result;
      if ( *(struct tagPROCESS_HID_REQUEST **)(*(_QWORD *)result + 8LL) != result
        || (v14 = (struct tagPROCESS_HID_REQUEST **)*((_QWORD *)result + 1), *v14 != result) )
      {
        __fastfail(3u);
      }
      ...
      *(_QWORD *)(v13 + 8) = v14;
      ...
      if ( *(struct tagPROCESS_HID_REQUEST **)(*(_QWORD *)v9 + 8LL) != v9 )
        __fastfail(3u);
      *(_QWORD *)result = v15;
      *((_QWORD *)result + 1) = v9;
      *((_QWORD *)v15 + 1) = result;
    ...
    if ( v18 )
    {
      if ( v17 != v18 )
      {
        ...
        if ( *(struct tagPROCESS_HID_TABLE **)(*(_QWORD *)v18 + 8LL) != v18
          || (v20 = (struct tagPROCESS_HID_TABLE **)*((_QWORD *)v18 + 1), *v20 != v18) )
        {
          __fastfail(3u);
        }
        *v20 = v19;
