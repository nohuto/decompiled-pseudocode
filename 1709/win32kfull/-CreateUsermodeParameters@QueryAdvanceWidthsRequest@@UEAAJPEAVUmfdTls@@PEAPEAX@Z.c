/*
 * XREFs of ?CreateUsermodeParameters@QueryAdvanceWidthsRequest@@UEAAJPEAVUmfdTls@@PEAPEAX@Z @ 0x1C0037F60
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( !v11 )
    return 3221225495LL;
  *((_QWORD *)this + 11) = v11 + 6;
  *((_QWORD *)this + 12) = v11 + 14;
  *((_QWORD *)this + 13) = (char *)v11 + v8 + 112;
  v13 = *((_QWORD *)this + 11);
  v14 = *((_QWORD *)this + 6);
  ...
  *(_QWORD *)(v13 + 24) = **(_QWORD **)(v14 + 24);
  ...
  v11[1] = *((_QWORD *)this + 11);
  *v11 = *((_QWORD *)this + 5);
  *((_DWORD *)v11 + 4) = *((_DWORD *)this + 14);
  *((_DWORD *)v11 + 10) = *((_DWORD *)this + 20);
  v11[3] = *((_QWORD *)this + 12);
