/*
 * XREFs of _PostMessageCheckIL @ 0x1C01C0F9C
 * Callers:
...
__int64 __fastcall PostMessageCheckIL(
        struct tagWND *a1,
        unsigned int a2,
        unsigned __int64 a3,
        struct _LARGE_STRING *a4)
{
  ...
  if ( a2 != 717 )
  {
      ...
      if ( gbEnforceUIPI )
      {
        if ( (unsigned int)v17 <= v15 )
        {
          if ( (_DWORD)v17 != v15 || (v18 = HIDWORD(v17), (_DWORD)v18 != v16) && (_DWORD)v18 != -1 && v16 != -1 )
          {
            ...
            MSGSQMAddMessage(v11, (struct tagPROCESSINFO *)v9, a2, a3, (unsigned __int64)a4, 0, 0);
            goto LABEL_30;
          }
        }
      }
    ...
    MSGSQMAddMessage(v11, (struct tagPROCESSINFO *)v9, a2, a3, (unsigned __int64)a4, 0, v13);
LABEL_30:
    if ( !v12 )
      return 0LL;
    return PostMessage((__int64)a1, a2, a3, a4);
