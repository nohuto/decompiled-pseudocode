/*
 * XREFs of InitializeClientPfnArrays @ 0x1C011E58C
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C011E4A0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2) == gpepCSRSS )
  {
    ...
    *(_QWORD *)(gpsi + 840LL) = *(_QWORD *)(a3 + 80);
    ...
    qword_1C0326C68 = *(_QWORD *)(gpsi + 608LL);
    qword_1C0326C70 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0326C78 = *(_QWORD *)(gpsi + 672LL);
    qword_1C0326C88 = *(_QWORD *)(gpsi + 640LL);
    qword_1C0326CF0 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0326D08 = *(_QWORD *)(gpsi + 584LL);
    qword_1C0326C90 = *(_QWORD *)(gpsi + 680LL);
    qword_1C0326C98 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0326CE8 = 1LL;
    qword_1C0326CF8 = 3LL;
    qword_1C0326D00 = 2LL;
    qword_1C0326D10 = 5LL;
