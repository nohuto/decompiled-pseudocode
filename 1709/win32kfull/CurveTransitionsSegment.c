/*
 * XREFs of CurveTransitionsSegment @ 0x1C02BF2C0
 * Callers:
...
__int64 __fastcall CurveTransitionsSegment(unsigned __int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v10 = 0;
  LODWORD(a1) = (a2 - a1) * (HIDWORD(a4) - HIDWORD(a3)) - (HIDWORD(a2) - HIDWORD(a1)) * (a4 - a3);
  if ( !(_DWORD)a1 )
    return v10;
  v11 = QDiv2(
          -65536LL
        * ((HIDWORD(a2) - HIDWORD(a1)) * v4 + v6 * HIDWORD(a3) - v6 * (int)v5 - (HIDWORD(a2) - HIDWORD(a1)) * (int)a3),
          (int)a1);
  ...
  if ( (int)abs32(v6) <= (int)abs32(v12) )
  {
    ...
    if ( v12 < 0 )
    {
      if ( (__int64)v12 << 16 <= v16 )
        return v16 < 0;
      return v10;
    }
    if ( v16 <= 0 )
      return v10;
    v15 = v16 <= (__int64)v12 << 16;
  }
  else
  {
    v14 = v11 * v8 + ((__int64)(v13 - v4) << 16);
    if ( v6 < 0 )
    {
