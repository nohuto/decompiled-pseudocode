/*
 * XREFs of ?BltLnkRect@@YAXPEAU_BLTLNKINFO@@PEAU_RECTL@@@Z @ 0x1C00BBD30
 * Callers:
 ...
 *     ?BltLnkAccel6666@@YAXPEAE0JJJJ@Z @ 0x1C02B0D64 (-BltLnkAccel6666@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccel8888@@YAXPEAE0JJJJ@Z @ 0x1C02B0E04 (-BltLnkAccel8888@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z @ 0x1C02B0EAC (-BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z.c)
 */
...
LABEL_65:
    ...
    v5 = (unsigned __int8 *)(v12 + v13 * *((_DWORD *)a1 + 30));
    goto LABEL_5;
  }
  v72 = *((_DWORD *)a1 + 38);
  v13 = v71;
LABEL_5:
  v14 = *((_DWORD *)a1 + 19);
  if ( v14 <= 0 )
    v15 = *((_DWORD *)a1 + 29) * (bottom - 1);
  else
    v15 = top * *((_DWORD *)a1 + 29);
  v84 = *((_QWORD *)a1 + 11) + v15;
  v16 = *((_QWORD *)a1 + 10);
  if ( v16 )
  {
    v122 = *((_QWORD *)a1 + 6);
...
LABEL_22:
      ...
      if ( *((_DWORD *)a1 + 56) )
      {
        if ( v22 )
        {
          ...
          while ( v80-- )
          {
            ...
            if ( v5 )
            {
              v94((unsigned __int8 *)v136 + v82, v81, v5, v83, v72, v9, v86);
              if ( *((_DWORD *)a1 + 19) == 1 )
              {
                ++v13;
                v5 += *((int *)a1 + 34);
                ...
                {
                  v13 = 0;
                  v5 = (unsigned __int8 *)*((_QWORD *)a1 + 13);
                }
              }
              else if ( v13 )
              {
              ...
              {
                v13 = v85 - 1;
                v5 = (unsigned __int8 *)(*((_QWORD *)a1 + 13) + (v85 - 1) * *((_DWORD *)a1 + 30));
              }
              v65 = v73;
              v66 = 0LL;
              while ( v65 )
        ...
        else
        {
          ...
          while ( v79-- )
          {
            if ( *((_DWORD *)a1 + 57) && v5 )
            {
              v94((unsigned __int8 *)v137 + v82, v81, v5, v83, v72, v9, v86);
              if ( *((_DWORD *)a1 + 19) == 1 )
              {
                ++v13;
                v5 += *((int *)a1 + 34);
  ...
  if ( v89 == -1
    ...
    || (v39 = *(_DWORD *)(v10 + 96), (unsigned int)(v39 - 3) > 3) )
  {
LABEL_18:
    if ( !v20
      && *((_DWORD *)a1 + 55)
