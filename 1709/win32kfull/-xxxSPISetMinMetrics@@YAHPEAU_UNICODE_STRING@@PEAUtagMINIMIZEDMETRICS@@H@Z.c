/*
 * XREFs of ?xxxSPISetMinMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagMINIMIZEDMETRICS@@H@Z @ 0x1C01216A8
 * Callers:
...
__int64 __fastcall xxxSPISetMinMetrics(struct _UNICODE_STRING *a1, struct tagMINIMIZEDMETRICS *a2, int a3)
{
  ...
  v9 = *(_WORD *)(gpsi + 9974LL);
  if ( v8 != v9 )
  {
    v11 = v8;
    *((_DWORD *)a2 + 1) = EngMulDiv(*((_DWORD *)a2 + 1), v9, v8);
    *((_DWORD *)a2 + 2) = EngMulDiv(*((_DWORD *)a2 + 2), *(unsigned __int16 *)(gpsi + 9974LL), v11);
    *((_DWORD *)a2 + 3) = EngMulDiv(*((_DWORD *)a2 + 3), *(unsigned __int16 *)(gpsi + 9974LL), v11);
  }
  if ( a3 )
  {
