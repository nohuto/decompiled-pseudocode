/*
 * XREFs of ValidateAcpiCStates @ 0x1C002B148
 * Callers:
...
LABEL_24:
          ...
          case 2:
            ...
            break;
          default:
            if ( !IsValidAcpiGenericAddress((char *)&dword_1C0011BE4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BB4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BCC) )
            {
              v8 = 27;
              goto LABEL_24;
            }
