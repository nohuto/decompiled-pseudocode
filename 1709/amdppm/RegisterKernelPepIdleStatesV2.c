/*
 * XREFs of RegisterKernelPepIdleStatesV2 @ 0x1C0025F3C
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStatesV2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 48) = 0LL;
  *(_DWORD *)(a3 + 40) = 0;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v12 + 2504))(v11, qword_1C00113F0, 0LL);
  *(_BYTE *)(a1 + 1145) = 0;
  v35[1] = 0x100000000LL;
  v35[0] = 127LL;
  v36 = 0;
