/*
 * XREFs of ProcLibTracePStateDomainRundown @ 0x1C0005C4C
 * Callers:
...
BOOLEAN __fastcall ProcLibTracePStateDomainRundown(__int64 a1)
{
  ...
  result = EtwEventEnabled(ProcLibEtwHandle, &PPM_ETW_PTSTATE_DOMAIN_FIRMWARE_RUNDOWN);
  if ( result )
  {
    UserData.Ptr = a1 + 36;
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v6 = a1 + 32;
    v7 = 4LL;
    return EtwWrite(ProcLibEtwHandle, &PPM_ETW_PTSTATE_DOMAIN_FIRMWARE_RUNDOWN, 0LL, 3u, &UserData);
  }
  return result;
}
