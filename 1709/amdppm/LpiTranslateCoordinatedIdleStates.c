/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x1C002F584
 * Callers:
                ...
                while ( 1 )
                {
                  ...
                  *(_QWORD *)(v33 + 184) = *(_QWORD *)(v29 + 8);
                  ...
                  if ( v8 < 0 )
                    break;
                  v36 = Size;
                  if ( (unsigned int)KeIsEqualAffinityEx(Size, &unk_1C00116D8) )
                    *(_BYTE *)(Size + 208) = 1;
                  v37 = v62;
                  v34[48] = *(_BYTE *)(v36 + 208);
                  v38 = (char *)(v29 + v37 + 48);
