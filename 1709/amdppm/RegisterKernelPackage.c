/*
 * XREFs of RegisterKernelPackage @ 0x1C0029660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 78) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C00116C8)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C0011418;
...
LABEL_8:
    ...
    *(_DWORD *)(v5 + 32) = v3;
    *(_DWORD *)(v5 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1C00116D0)(v3);
