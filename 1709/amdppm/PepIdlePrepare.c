/*
 * XREFs of PepIdlePrepare @ 0x1C0005F00
 * Callers:
 *     <none>
 * Callees:
 *     PepIdleCancel @ 0x1C0006340 (PepIdleCancel.c)
...
__int64 __fastcall PepIdlePrepare(__int64 a1)
{
  ...
  if ( dword_1C0011910 >= (unsigned int)dword_1C00113E4 )
  {
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C0011918 )
