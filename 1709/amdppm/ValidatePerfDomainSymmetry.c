/*
 * XREFs of ValidatePerfDomainSymmetry @ 0x1C002B810
 * Callers:
 ...
 *     ValidatePctPtcSymmetry @ 0x1C002BD80 (ValidatePctPtcSymmetry.c)
...
LABEL_41:
      ...
      {
        WPP_RECORDER_SF_ddxx((__int64)WPP_GLOBAL_Control->DeviceExtension, v7 & 0x10FF300000LL, v4, v5, (int)v30);
        v7 = *(_QWORD *)(v1 + 264);
