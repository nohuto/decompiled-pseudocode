/*
 * XREFs of PopulateEnergyEstimationParameters @ 0x1C0030E68
 * Callers:
  ...
  do
  {
    ...
    if ( (int)ReadPowerCurve(v3, v1) >= 0 )
    {
        ...
        && (qword_1C0011078 & 0x400000000000LL) == qword_1C0011078 )
      {
        ...
        v23 = 1;
        v26 = 2;
        TlgWrite(v4, &unk_1C000E859, (LPCGUID)v5, v6, 6u, &pData);
      }
    }
LABEL_22:
    cData[0] = v0;
