/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C002EB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeGenAddressToHvPerfReg @ 0x1C002EEA4 (DecodeGenAddressToHvPerfReg.c)
 */
            ...
            *v15 = 0;
            for ( i = 0; i < *(_DWORD *)(a1 + 32); v27 = v13 )
            {
              ...
              if ( *(_BYTE *)(v19 + 24LL * i + 17) && *(_BYTE *)(v19 + 24LL * i + 16) )
              {
                ...
                v34 = *v13;
                v21 = &v15[6 * *v15];
                if ( *(__int64 (__fastcall **)(__int64, __int64, __int64 *, __int64 *))(*v13 + 48) == GetCpcDifferentialFeedback )
                {
                  v33 = *(_QWORD *)(v20 + 56);
