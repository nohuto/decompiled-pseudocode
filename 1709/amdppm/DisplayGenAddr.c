/*
 * XREFs of DisplayGenAddr @ 0x1C00043E4
 * Callers:
...
unsigned __int8 __fastcall DisplayGenAddr(char *a1, const char *a2, __int64 a3, __int64 a4)
{
  ...
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    ...
    result = WPP_RECORDER_SF_sDs((__int64)WPP_GLOBAL_Control->DeviceExtension, v7, a3, a4, v16, a2, v7, v13);
  }
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
...
LABEL_35:
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    return WPP_RECORDER_SF_sx((__int64)WPP_GLOBAL_Control->DeviceExtension, (__int64)a2, a3, a4, v16, a2);
  return result;
}
