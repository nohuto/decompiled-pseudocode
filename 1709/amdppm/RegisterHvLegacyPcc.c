/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C002E290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00113E8,
    0LL);
  PerfDomain = GetPerfDomain(a1, (__int64)v17, v15);
  ...
  if ( v10 >= 0 )
  {
    HIDWORD(v18[0]) = dword_1C0011800;
    v18[2] = qword_1C0011830;
    LODWORD(v18[3]) = dword_1C0011838;
    v18[6] = v5 << v4;
    v18[5] = v3 << v4;
    LODWORD(v18[0]) = 0;
