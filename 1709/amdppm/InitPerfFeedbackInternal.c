/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C00277EC
 * Callers:
 *     RegisterKernelPerfFeedback @ 0x1C0027BA0 (RegisterKernelPerfFeedback.c)
 *     RegisterHvPerfFeedbackCounters @ 0x1C002EAB0 (RegisterHvPerfFeedbackCounters.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(__int64 a1, __int64 (__fastcall *a2)(char *, _QWORD))
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00113E8,
    0LL);
  PerfDomain = GetPerfDomain(a1, (__int64)v23, &v25);
