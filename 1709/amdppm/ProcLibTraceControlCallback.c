/*
 * XREFs of ProcLibTraceControlCallback @ 0x1C0020770
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONGLONG MatchAnyKeyword)
{
  ...
  if ( ControlCode == 2 )
  {
    ...
    for ( j = qword_1C0011408; (__int64 *)j != &qword_1C0011408; j = *(_QWORD *)j )
    {
