/*
 * XREFs of PepNotifyCoordinatedLpiStates @ 0x1C0023E90
 * Callers:
...
__int64 __fastcall PepNotifyCoordinatedLpiStates(__int64 a1, _DWORD *a2, unsigned int *a3, __int64 a4)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *v19 = v4;
    ...
    for ( i = 0LL; (unsigned int)i < *v7; i = (unsigned int)(i + 1) )
    {
      ...
      if ( v35 )
      {
        for ( j = 0; j < *(_DWORD *)(v35 + 16); *(_QWORD *)&v19[v37 + 20] = *(_QWORD *)(v35 + 8 * v20 + 96) )
        {
          ...
          {
            LOBYTE(v19[v37 + 8]) = *(_BYTE *)(v35 + 80LL * j + 48);
    ...
    ((void (__fastcall *)(_QWORD, _DWORD *, __int64, __int64))qword_1C0011698)(*(_QWORD *)(a1 + 1088), v19, v20, i);
