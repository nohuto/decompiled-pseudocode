/*
 * XREFs of InitializeEnergyEstimation @ 0x1C002A448
 * Callers:
...
__int64 InitializeEnergyEstimation()
{
  ...
  qword_1C0011B78 = PerformanceFrequency.QuadPart;
  HalPrivateDispatchTable[76]((__int64)&unk_1C0011B80);
  ...
  v2 = 1;
  qword_1C00115B8 = qword_1C0011A68[0];
  if ( i > 1 )
  {
    while ( Globals[32 * (unsigned __int64)v2 + 211] == qword_1C0011A68[0] )
    {
      if ( ++v2 >= i )
        goto LABEL_8;
    }
...
LABEL_8:
  v3 = (void *)qword_1C0011A60[0];
  v4 = 1LL;
  qword_1C00115B0 = qword_1C0011A60[0];
  if ( i > 1 )
  {
    while ( Globals[32 * (unsigned __int64)(unsigned int)v4 + 210] == qword_1C0011A60[0] )
    {
