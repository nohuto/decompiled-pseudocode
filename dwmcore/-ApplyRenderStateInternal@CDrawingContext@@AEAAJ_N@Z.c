/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x1800748A0
 * Callers:
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x1800762C0 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
