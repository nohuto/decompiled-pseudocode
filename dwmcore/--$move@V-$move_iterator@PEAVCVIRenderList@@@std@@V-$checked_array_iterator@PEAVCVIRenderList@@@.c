/*
 * XREFs of ??$move@V?$move_iterator@PEAVCVIRenderList@@@std@@V?$checked_array_iterator@PEAVCVIRenderList@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAVCVIRenderList@@@stdext@@V?$move_iterator@PEAVCVIRenderList@@@0@0V12@@Z @ 0x1801BD024
 * Callers:
        ...
        __int64 *a4)
{
  ...
  v4 = a4 + 2;
  v5 = a3 - (_QWORD)a2;
  v8 = 0xCCCCCCCCCCCCCCCDuLL * ((a3 - (__int64)a2) >> 3);
  if ( v8 < 0 )
  {
    if ( *v4 >= (unsigned __int64)(0x3333333333333333LL * ((a3 - (__int64)a2) >> 3)) )
      goto LABEL_3;
LABEL_6:
...
LABEL_3:
  ...
  result = a1;
  *v4 = 0xCCCCCCCCCCCCCCCDuLL * (((__int64)v10 + v5 - v9) >> 3);
  v12 = a4[2];
  *(_OWORD *)a1 = *(_OWORD *)a4;
  *(_QWORD *)(a1 + 16) = v12;
  return result;
