/*
 * XREFs of ?EnsureSwapChain@CDDARenderTarget@@IEAAJXZ @ 0x18012D5DC
 * Callers:
 *     ?CheckOcclusionState@CDDARenderTarget@@UEAAJXZ @ 0x18012D5BA (-CheckOcclusionState@CDDARenderTarget@@UEAAJXZ.c)
 * Callees:
