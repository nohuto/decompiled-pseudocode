/*
 * XREFs of ?SetScale@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector2Behavior@@@Z @ 0x1801C671C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[18] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x9DCu, 0LL);
    }
    else
    {
