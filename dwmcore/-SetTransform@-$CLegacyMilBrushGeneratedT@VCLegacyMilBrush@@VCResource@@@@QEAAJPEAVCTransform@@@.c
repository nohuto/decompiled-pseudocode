/*
 * XREFs of ?SetTransform@?$CLegacyMilBrushGeneratedT@VCLegacyMilBrush@@VCResource@@@@QEAAJPEAVCTransform@@@Z @ 0x1800FCB2C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[10] )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x336u, 0LL);
    }
    else
    {
