/*
 * XREFs of ?WindowNodeSetSpriteBitmap@CChannel@@UEAAJII@Z @ 0x1800F6BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetSpriteBitmap(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  if ( a3 )
    CChannel::CheckHandle((__int64)this, a3, 65);
  v8[0] = 439;
  v8[1] = a2;
  v8[2] = a3;
