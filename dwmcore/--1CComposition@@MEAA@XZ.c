/*
 * XREFs of ??1CComposition@@MEAA@XZ @ 0x1801B0AEC
 * Callers:
 ...
 *     ?UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ @ 0x1801B202C (-UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ.c)
