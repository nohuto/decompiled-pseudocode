/*
 * XREFs of ?SetOcclusionInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801C4910
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[17] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1513u, 0LL);
    }
    else
    {
