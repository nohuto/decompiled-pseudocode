/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TestUx32@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801163B8
 * Callers:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TestUx32@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180113C3C (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_TestUx32@@@details@wil@@.c)
 */
