/*
 * XREFs of ?AnimationStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801E24F4
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      LODWORD(v12) = a2;
      return CoreUICallSend(v10, v14, 2LL, 0LL, 2, &unk_1803536A2, v12);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
