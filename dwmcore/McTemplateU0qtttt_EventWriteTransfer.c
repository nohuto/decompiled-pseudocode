/*
 * XREFs of McTemplateU0qtttt_EventWriteTransfer @ 0x1801CEC18
 * Callers:
...
ULONG __fastcall McTemplateU0qtttt_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v17 = &a7;
  v18 = 4LL;
  return McGenEventWrite_EventWriteTransfer(Microsoft_Windows_Dwm_Compositor_Context, &WaitForWork_Stop, a3, 6u, &v8);
}
