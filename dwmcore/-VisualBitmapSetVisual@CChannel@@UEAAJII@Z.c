/*
 * XREFs of ?VisualBitmapSetVisual@CChannel@@UEAAJII@Z @ 0x1801CDE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualBitmapSetVisual(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
