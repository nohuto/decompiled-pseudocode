/*
 * XREFs of ?SetImageSource@?$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@QEAAJPEAVCImageSource@@@Z @ 0x1800F7AE0
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[23] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x628u, 0LL);
    }
    else
    {
