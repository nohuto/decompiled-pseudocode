/*
 * XREFs of ?PushColorTransformLayerForNode@CDrawingContext@@AEAAJPEBVCVisual@@PEAVCColorTransformResource@@@Z @ 0x1801D3500
 * Callers:
        ...
        struct CColorTransformResource *a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0xE7Du, 0LL);
  }
  else
  {
    v10 = CColorTransformLayer::Create(this[4], (const struct MilPointAndSizeL *)v15, a3, &v16);
    v9 = v10;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0xE82u, 0LL);
      v4 = v16;
    }
    else
    {
