/*
 * XREFs of ?PartitionSetExcludeFromDDA@CChannel@@UEAAJI_N@Z @ 0x1801CD160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::PartitionSetExcludeFromDDA(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
