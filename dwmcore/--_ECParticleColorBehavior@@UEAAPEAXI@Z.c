/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x1801C0240
 * Callers:
 *     ??_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z @ 0x180117B30 (--_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
