/*
 * XREFs of _anonymous_namespace_::SetArrayConfiguration_DwmTouchpadInteractionConfigurationPrimitive_ @ 0x1800C3ACC
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 24) = 0;
  ...
  v6 = DynArray<DwmTouchpadInteractionConfigurationPrimitive,0>::AddMultipleAndSet(a3, a1, a2);
  if ( v6 < 0 )
  {
LABEL_6:
    *(_DWORD *)(a3 + 24) = 0;
