/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_NiwTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180112148
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_NiwTest@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180115798 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_NiwTest@@@details@wil@@QEAAX_NW4Reporting.c)
 * Callees:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_NiwTest>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_NiwTest>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    for ( i = *a2; ; i = v9 )
    {
      v7 = v13 == 0;
      v8 = i;
