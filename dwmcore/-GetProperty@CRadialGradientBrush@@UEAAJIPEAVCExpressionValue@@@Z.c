/*
 * XREFs of ?GetProperty@CRadialGradientBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18024AB20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRadialGradientBrush::GetProperty(CRadialGradientBrush *this, int a2, struct CExpressionValue *a3)
{
  unsigned int v4; // ebx
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x21u, (void *)(v7 & v10));
  }
  return v4;
}
