/*
 * XREFs of ?GdiSpriteBitmapSetPixelFormat@CChannel@@UEAAJIW4DXGI_FORMAT@@@Z @ 0x1800F9920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapSetPixelFormat(CChannel *this, unsigned int a2, enum DXGI_FORMAT a3)
{
  unsigned int v6; // ebx
