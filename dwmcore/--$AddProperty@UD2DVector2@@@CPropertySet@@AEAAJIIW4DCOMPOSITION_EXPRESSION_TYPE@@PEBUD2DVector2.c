/*
 * XREFs of ??$AddProperty@UD2DVector2@@@CPropertySet@@AEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector2@@@Z @ 0x18001E410
 * Callers:
        ...
        __int64 a5)
{
  ...
  v9 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector2>(
         (char *)this + 88,
         a4,
         a5,
         &v16);
  ...
  v9 = CPropertySet::PropertyUpdated<D2DVector2>(this, v5);
  v11 = v9;
  if ( v9 < 0 )
  {
    v14 = 377;
