/*
 * XREFs of ?_Change_array@?$vector@PEAVCSceneNode@@V?$allocator@PEAVCSceneNode@@@std@@@std@@AEAAXQEAPEAVCSceneNode@@_K1@Z @ 0x1801C76FC
 * Callers:
...
__int64 __fastcall std::vector<CSceneNode *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
