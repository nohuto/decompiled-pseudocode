/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoDataSourceProxy@@EEAAJXZ @ 0x1801E0010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourceProxy::OnPropertiesRefreshedCallout(
        BamoDataSourceProxy *this,
        __int64 a2,
        __int64 a3,
        const char *a4)
{
  BamoDataSourceProxy *v4; // rbx
  __int64 v5; // rdx
  __int64 v6; // r8
  const char *v7; // r9
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    a3,
    a4);
  LODWORD(v4) = (*(__int64 (__fastcall **)(BamoDataSourceProxy *))(*(_QWORD *)v4 + 48LL))(v4);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    (__int64)v9,
    v5,
    v6,
