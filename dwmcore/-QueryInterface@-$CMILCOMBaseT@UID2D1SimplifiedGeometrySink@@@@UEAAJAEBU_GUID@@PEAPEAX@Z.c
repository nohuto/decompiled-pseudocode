/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UID2D1SimplifiedGeometrySink@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B0090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ID2D1SimplifiedGeometrySink>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  int v5; // edi
  __int64 v6; // rax
