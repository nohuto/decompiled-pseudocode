/*
 * XREFs of ?NotifyRenderedRect@CConversionSwapChain@@UEAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18029EF10
 * Callers:
 *     ?NotifyRenderedRect@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18011D070 (-NotifyRenderedRect@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAXPEBV-$TMilRect_@HUtagRECT@@UMilPoin.c)
 * Callees:
...
void __fastcall CConversionSwapChain::NotifyRenderedRect(__int64 a1, const struct tagRECT *a2)
{
  ...
  if ( a2 )
  {
    ...
    v5 = FastRegion::CRegion::Union(
           (const struct FastRegion::Internal::CRgnData **)(a1 + 672),
