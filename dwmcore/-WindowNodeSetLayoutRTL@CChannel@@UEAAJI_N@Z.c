/*
 * XREFs of ?WindowNodeSetLayoutRTL@CChannel@@UEAAJI_N@Z @ 0x1800F56A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetLayoutRTL(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
