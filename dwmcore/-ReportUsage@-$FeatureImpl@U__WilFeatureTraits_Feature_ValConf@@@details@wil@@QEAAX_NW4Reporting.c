/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801164B4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_ValConf>::GetCachedFeatureEnabledState(a1, v8);
    v11 = v4;
  }
  v10 = 2;
  v9 = 0;
