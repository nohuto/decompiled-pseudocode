/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Interaction_NullptrSmackdown@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180111E00
 * Callers:
