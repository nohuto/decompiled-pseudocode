/*
 * XREFs of ?Matrix4x4FromRotationY@CExpressionValueStack@@QEAAJI@Z @ 0x18025C004
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Matrix4x4FromRotationY(CExpressionValueStack *this, __int64 a2)
{
  unsigned int v2; // eax
  int v3; // r15d
  __int64 v5; // rax
...
LABEL_20:
  ...
  if ( v7[18] != 18 )
    goto LABEL_20;
  D2DMatrixRotationY((struct D2DMatrix *)&v27, *(float *)v7);
  v8 = v28;
  *(_OWORD *)v7 = v27;
  v7[18] = 265;
  v9 = v29;
