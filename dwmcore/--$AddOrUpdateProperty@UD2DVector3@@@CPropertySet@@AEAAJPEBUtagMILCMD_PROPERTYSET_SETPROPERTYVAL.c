/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector3@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector3@@@Z @ 0x1800DD948
 * Callers:
...
LABEL_10:
  ...
  {
    updated = CPropertySet::UpdateProperty<D2DVector3>(v7);
    v5 = updated;
    if ( updated < 0 )
    {
      v10 = 336;
