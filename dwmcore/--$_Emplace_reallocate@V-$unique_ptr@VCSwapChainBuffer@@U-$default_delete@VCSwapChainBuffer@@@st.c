...
_QWORD *__fastcall std::vector<std::unique_ptr<CSwapChainBuffer>>::_Emplace_reallocate<std::unique_ptr<CSwapChainBuffer>>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *v17 = v14;
  ...
  if ( a2 != v18 )
  {
    std::_Uninitialized_move<std::unique_ptr<CSwapChainBuffer> *,std::allocator<std::unique_ptr<CSwapChainBuffer>>>(
      v19,
      a2,
      v13);
    v18 = a1[1];
  ...
  std::_Uninitialized_move<std::unique_ptr<CSwapChainBuffer> *,std::allocator<std::unique_ptr<CSwapChainBuffer>>>(
    ...
    v18,
    v16);
  std::vector<std::unique_ptr<CSwapChainBuffer>>::_Change_array(a1, v15, v9, v3);
  return v17;
}
