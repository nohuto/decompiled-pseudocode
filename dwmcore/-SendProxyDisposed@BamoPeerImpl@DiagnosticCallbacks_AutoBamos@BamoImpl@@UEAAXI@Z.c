/*
 * XREFs of ?SendProxyDisposed@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1801B7E00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl::SendProxyDisposed(
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, 7, &unk_1803536BA, v6);
  if ( v4 < 0 )
