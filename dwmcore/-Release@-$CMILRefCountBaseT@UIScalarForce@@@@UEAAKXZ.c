/*
 * XREFs of ?Release@?$CMILRefCountBaseT@UIScalarForce@@@@UEAAKXZ @ 0x18023A410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILRefCountBaseT<IScalarForce>::Release(volatile signed __int32 *a1)
{
