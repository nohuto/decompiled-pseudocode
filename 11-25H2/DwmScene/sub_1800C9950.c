/*
 * XREFs of sub_1800C9950 @ 0x1800C9950
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800C9950(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    std::string::string(
      &v21,
      "GeometryShaderD3D11::Load() -- this function can only be called once per shader instance");
  ...
  if ( !sub_18004D510((__int64)a2) )
  {
    ...
    v6 = v18;
    v7 = *(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v18 + 104LL);
    v8 = (__int64 *)(a1 + 104);
    ...
    if ( v11 < 0 )
    {
      sub_18001C99C(&stru_1801B8588, 5);
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
