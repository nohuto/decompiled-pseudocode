/*
 * XREFs of sub_18002DC94 @ 0x18002DC94
 * Callers:
...
__int64 __fastcall sub_18002DC94(__int64 *a1, __int64 a2, _QWORD *a3)
{
  ...
  sub_18002D444((__int64)a1, (__int64 **)&v14, a3);
  v6 = v15;
  if ( sub_18002D9D0(v7, v15, a3) )
  {
    *(_QWORD *)a2 = v6;
    *(_BYTE *)(a2 + 8) = 0;
  }
