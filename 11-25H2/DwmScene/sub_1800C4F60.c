/*
 * XREFs of sub_1800C4F60 @ 0x1800C4F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800C4F60(__int64 a1, int a2, __int64 *a3, unsigned int a4)
{
  __int64 *v5; // rax
  char v6; // bl
  __int64 v7; // rdi
  ...
  if ( *a3 )
  {
    v5 = sub_1800521F8(*a3, &v33, *(_DWORD *)(a1 + 88));
    v6 = 1;
    v7 = *v5;
  }
  else
  ...
  *v10 = 0LL;
  ...
  if ( v22 )
  {
    _InterlockedIncrement64(qword_1801C3BD0);
    v8 = v26;
    v14 = v32;
  }
