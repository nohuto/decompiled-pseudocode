/*
 * XREFs of sub_18003C238 @ 0x18003C238
 * Callers:
...
__m128 __fastcall sub_18003C238(double a1, double a2, double a3)
{
  __m128 v3; // xmm2
  __m128 v4; // xmm5
  __m128 v5; // xmm6
  ...
  v10 = _mm_cmpneq_ps((__m128)xmmword_1800F6F80, v9);
  v11 = _mm_sqrt_ps(v9);
  v12 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v11), _mm_div_ps(v5, v11)), v10),
          _mm_andnot_ps(v10, (__m128)xmmword_1800F6FD0));
  ...
  v18 = _mm_sqrt_ps(v17);
  v19 = _mm_cmpneq_ps(v17, (__m128)xmmword_1800F6F80);
  v20 = _mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v18), _mm_div_ps(v14, v18));
  v21 = v8;
  v22 = _mm_mul_ps(v8, v12);
  v23 = _mm_or_ps(_mm_and_ps(v20, v19), _mm_andnot_ps(v19, (__m128)xmmword_1800F6FD0));
  ...
  return _mm_shuffle_ps(
           _mm_shuffle_ps(
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_1800F7040, _mm_shuffle_ps(v24, v24, 0)),
               _mm_and_ps((__m128)xmmword_1800F7040, v23)),
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_1800F7040, _mm_shuffle_ps(v29, v29, 0)),
               _mm_and_ps((__m128)xmmword_1800F7040, v28)),
             68),
           _mm_shuffle_ps(
             _mm_or_ps(
               _mm_andnot_ps((__m128)xmmword_1800F7040, _mm_shuffle_ps(v22, v22, 0)),
               _mm_and_ps((__m128)xmmword_1800F7040, v12)),
             (__m128)xmmword_1800F7150,
             68),
           136);
}
