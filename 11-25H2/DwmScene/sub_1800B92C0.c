/*
 * XREFs of sub_1800B92C0 @ 0x1800B92C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800B92C0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v7; // rax
  __int64 *v8; // rax
  __int64 *v9; // rax
  ...
  sub_180016F24(&v44, v7);
  sub_1800C2EE4(v44, &v34);
  sub_1800254DC(a4, &v37);
  sub_1800B9BE4(a4, &v42);
  v8 = sub_1800521F8(v37, &v35, *(_DWORD *)(a1 + 244));
  sub_180016F24(&v40, v8);
  v9 = sub_1800521F8(v42, &v33, *(_DWORD *)(a1 + 244));
  sub_180016F24(&v35, v9);
  v10 = v34;
  v11 = *(void (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v34 + 376LL);
  v12 = *(_QWORD *)sub_1800C2144(v40, &v31);
  v13 = v35;
  v33 = v35;
  v14 = (_QWORD *)sub_1800C2144(v35, &v32);
  v11(v10, *v14, v12);
  sub_18000E854(&v32);
  sub_18000E854(&v31);
  *(_OWORD *)Src = 0LL;
  v15 = *(int (__fastcall **)(__int64, _QWORD, _QWORD, __int64, _DWORD, void **))(*(_QWORD *)v10 + 112LL);
  v16 = (_QWORD *)sub_1800C2144(v13, &v31);
  ...
  v25 = LODWORD(Src[1]);
  v26 = (char *)Src[0];
  for ( i = (char *)sub_1800258CC(v18, a2, a4, v23 * v24); v23; --v23 )
  {
    memcpy(i, v26, v24);
    v26 += v25;
    i += v24;
  ...
  *(_DWORD *)(a2 + 20) = 1;
  ...
  v29 = (_QWORD *)sub_1800C2144(v33, &v31);
  v28(v10, *v29, 0LL);
  sub_18000E854(&v31);
  if ( v36 )
    sub_18001050C(v36);
