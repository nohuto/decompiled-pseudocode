/*
 * XREFs of sub_1800C53F0 @ 0x1800C53F0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a11)
{
  ...
  if ( *a2 )
  {
    v11 = sub_1800521F8(*a2, v56, *(_DWORD *)(a1 + 88));
    v12 = 1;
    v13 = *v11;
  }
  else
  ...
  *v11 = 0LL;
  ...
  if ( (v12 & 1) != 0 && *((_QWORD *)&v56[0] + 1) )
    sub_18001050C(*((__int64 *)&v56[0] + 1));
  sub_1800C25D0(&v49, v53);
  v15 = v49;
  v16 = sub_18005224C(v49);
  v17 = sub_18004596C(v16);
  v45 = v17;
  if ( (unsigned int)sub_1800523E0(v15) != 1 )
  {
    ...
    sub_180068508(pExceptionObject, (__int64)v18, v19, (__int64)&v54, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v20 = *sub_1800C2144(v15, &v54);
  sub_18000E854(&v54);
  if ( !v20 )
  {
    ...
    v21 = std::string::string(
            v56,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\shared\\nativerendererd3d11\\cpp\\source\\commandlistd3d11.cpp");
    sub_180068508(pExceptionObject, (__int64)v21, v22, (__int64)&v54, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v23 = a9 * a11;
  v24 = v17 * v46;
  if ( v17 * v46 + (int)v23 >= a8 )
  {
    ...
    v25 = std::string::string(
            v56,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\shared\\nativerendererd3d11\\cpp\\source\\commandlistd3d11.cpp");
    sub_180068508(pExceptionObject, (__int64)v25, v26, (__int64)&v54, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  if ( v17 * (v46 + a5) + v42 * (a6 + (_DWORD)v44 - 1) > a8 )
  {
    ...
    v27 = std::string::string(
            v56,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\shared\\nativerendererd3d11\\cpp\\source\\commandlistd3d11.cpp");
    sub_180068508(pExceptionObject, (__int64)v27, v28, (__int64)&v54, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  sub_1800C1DB0(v15, &v44, a5, a6);
  v51 = 0LL;
  v29 = v52;
  v30 = v44;
  v31 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64, _DWORD, __int128 *))(**(_QWORD **)(v52 + 144)
          ...
          *(_QWORD *)(v52 + 144),
          ...
          0,
          &v51);
  sub_180011B04(v29 + 72, v56);
  sub_1800C2568(&v54, v56);
  if ( *((_QWORD *)&v56[0] + 1) )
    sub_18001050C(*((__int64 *)&v56[0] + 1));
  sub_1800BB198(v54, v31);
