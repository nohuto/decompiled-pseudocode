/*
 * XREFs of sub_180013ACC @ 0x180013ACC
 * Callers:
 ...
 *     sub_180013E9C @ 0x180013E9C (sub_180013E9C.c)
...
_QWORD *__fastcall sub_180013ACC(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003BD1C();
  v4 = *(_QWORD *)sub_180013D0C(a1, &v10);
  if ( v11 )
    sub_18001050C(v11);
  if ( v4 )
  {
