/*
 * XREFs of sub_1800985C8 @ 0x1800985C8
 * Callers:
...
__int64 __fastcall sub_1800985C8(__int64 a1)
{
  __m128 *v1; // r8
  __m128 v2; // xmm2
  __m128 *v3; // rcx
  ...
  sub_1800984C8(a1);
  v2 = _mm_add_ps(
         _mm_add_ps(_mm_mul_ps(v1[3], (__m128)xmmword_18018C520), _mm_mul_ps(v1[4], (__m128)xmmword_18018C520)),
         _mm_mul_ps((__m128)xmmword_18018C510, v1[5]));
  ...
  v4 = _mm_mul_ps(v1[1], (__m128)xmmword_18018C5C0);
  ...
  v5 = _mm_mul_ps(v1[2], (__m128)xmmword_18018C5C0);
  ...
  v6 = _mm_mul_ps((__m128)xmmword_18018C5C0, *v1);
  ...
  v7 = _mm_mul_ps(v1[8], (__m128)xmmword_18018C630);
  ...
  v8 = _mm_mul_ps(v1[6], (__m128)xmmword_18018C630);
  ...
  v9 = _mm_sub_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18018C640, v1[5]), _mm_mul_ps((__m128)xmmword_18018C580, v1[3])),
         _mm_mul_ps(v1[4], (__m128)xmmword_18018C580));
  ...
  v10 = _mm_mul_ps(v1[7], (__m128)xmmword_18018C630);
  ...
  v11 = _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18018C630, v1[3]), _mm_mul_ps(v1[4], (__m128)xmmword_18018C630));
  ...
  sub_18009854C(v3, COERCE_DOUBLE(1078530011LL));
  return v12;
}
