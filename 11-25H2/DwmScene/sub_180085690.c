/*
 * XREFs of sub_180085690 @ 0x180085690
 * Callers:
 *     sub_180086DD0 @ 0x180086DD0 (sub_180086DD0.c)
 * Callees:
 *     __security_check_cookie @ 0x18000B2B0 (__security_check_cookie.c)
 *     _o_floorf @ 0x18000BFEC (_o_floorf.c)
 *     sub_180085898 @ 0x180085898 (sub_180085898.c)
 */

__m128 *__fastcall sub_180085690(__int64 a1, __m128 *a2, __m128 *a3)
{
  __m128 v3; // xmm1
  __int64 v4; // rsi
  char *v5; // rbx
  ...
  *(_QWORD *)v22 = 0LL;
  v25[2] = 2;
  *a3 = _mm_mul_ps(
          _mm_min_ps(_mm_max_ps(v3, (__m128)xmmword_1800F7190), (__m128)xmmword_1800F7180),
  ...
  v13 = v4 * HIDWORD(v23);
  *a2 = (__m128)xmmword_1800F7600;
  v14 = (int)v23 + (int)v4 * (int)v4 * v11 + v13;
  LOBYTE(v15) = 0;
  do
  {
    if ( (v15 & 2) != 0 )
