/*
 * XREFs of sub_180079F68 @ 0x180079F68
 * Callers:
...
__int64 *__fastcall sub_180079F68(__int64 *a1, int a2, __int64 a3)
{
  int v4; // edx
  int v5; // edx
  int v6; // edx
...
LABEL_18:
  ...
  if ( !v10 )
  {
    ...
    *((_QWORD *)&v17 + 1) = v19;
    v13 = &v17;
LABEL_19:
    sub_180041DF8(a1, (__int64)v13, a3);
    return a1;
  }
  if ( v10 != 1 )
  {
    ...
    v11 = std::string::string(
            ...
            "propertylayout.cpp");
    sub_180038A58(pExceptionObject, (__int64)v11, v12, (__int64)v19, 0);
