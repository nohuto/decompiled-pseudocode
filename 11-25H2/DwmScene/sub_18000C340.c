/*
 * XREFs of sub_18000C340 @ 0x18000C340
 * Callers:
...
const __m128i *__fastcall sub_18000C340(const __m128i *a1, const __m128i *a2, unsigned __int8 a3)
{
  ...
  v8 = a1;
  if ( v4 >= 0x10 && (dword_1801C2B8C & 4) != 0 )
  {
    v9 = _mm_loadu_si128(a1);
    si128 = _mm_load_si128((const __m128i *)&xmmword_1800F6B80);
    v11 = (const __m128i *)((char *)a1 + (v4 & 0xFFFFFFFFFFFFFFF0uLL));
    v12 = 0LL;
    ++a1;
    v13 = si128;
    v14 = _mm_loadu_si128(&xmmword_1800F6B60[a3]);
    ...
    if ( v21.m128i_i64[0] != 0x7FFFFFFFFFFFFFFFLL )
    {
      ...
      v24 = _mm_blendv_epi8(_mm_load_si128((const __m128i *)&xmmword_1800F6B30), v12, v22);
      v25 = v24.m128i_i64[0];
