/*
 * XREFs of sub_1800B811C @ 0x1800B811C
 * Callers:
...
_QWORD *__fastcall sub_1800B811C(_QWORD *a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  __int64 v10; // rax
