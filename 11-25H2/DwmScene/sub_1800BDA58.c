/*
 * XREFs of sub_1800BDA58 @ 0x1800BDA58
 * Callers:
...
__int64 __fastcall sub_1800BDA58(_QWORD *a1)
{
  __int64 v2; // rcx
  __int64 result; // rax
  __int128 v4; // xmm0
  ...
  if ( !(_DWORD)result )
  {
    if ( (_DWORD)v9 )
    {
      v7 = v10;
      v4 = v9;
      v5 = *(_QWORD *)sub_1800BC360(a1 + 200, (__int64)v8, &v9);
      *(_OWORD *)(v5 + 40) = v4;
      *(_OWORD *)(v5 + 56) = v7;
      v6 = *(_QWORD *)sub_1800BC268(a1 + 202, (__int64)v8, (_DWORD *)&v9 + 2);
      result = v10;
      *(_QWORD *)(v6 + 40) = v10;
    }
  }
