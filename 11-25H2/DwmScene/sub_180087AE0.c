/*
 * XREFs of sub_180087AE0 @ 0x180087AE0
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_180087AE0(__int64 a1, _OWORD *a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
  ...
  if ( v8 )
  {
    ...
    *(_DWORD *)(v8 + 8) = 1;
    *(_DWORD *)(v8 + 12) = 1;
    *(_QWORD *)v8 = &std::_Ref_count_obj2<Spectre::Engine::ViewerCamera>::`vftable';
    sub_18008735C(v8 + 16, a4);
  }
  else
  {
    v9 = 0LL;
