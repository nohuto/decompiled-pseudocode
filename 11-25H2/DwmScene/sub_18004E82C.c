/*
 * XREFs of sub_18004E82C @ 0x18004E82C
 * Callers:
...
int __fastcall sub_18004E82C(__int64 a1)
{
  ...
  v9[0] = &std::_Func_impl_no_alloc<_lambda_1ffa97e75efc20dc5ba4ef23b8bdb63a_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
