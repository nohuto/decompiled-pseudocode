/*
 * XREFs of sub_18008A148 @ 0x18008A148
 * Callers:
...
unsigned __int64 __fastcall sub_18008A148(__int64 a1, char *a2, __int64 a3, __int64 a4)
{
  ...
  v24 = v8;
  v14 = sub_1800108F8(v8, &v24);
  v15 = v14 + (v5 & 0xFFFFFFFFFFFFFFF0uLL);
  v16 = (char *)v14;
  sub_18008AA80(v17, v15, a3, a4);
  v18 = *(char **)(a1 + 8);
  v19 = v16;
  v20 = *(_BYTE **)a1;
  if ( a2 == v18 )
