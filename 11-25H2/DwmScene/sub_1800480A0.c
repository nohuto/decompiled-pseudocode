...
__int64 __fastcall sub_1800480A0(__int64 a1, unsigned __int64 a2, _QWORD *a3)
{
  unsigned int v5; // eax
  int v6; // r8d
  _QWORD *v7; // rdi
  ...
  if ( a2 >= 0x2E8BA2E8BA2E8BA3LL * ((__int64)(*(_QWORD *)(a1 + 112) - *(_QWORD *)(a1 + 104)) >> 3) )
  {
    ...
    sub_180068508((unsigned int)pExceptionObject, v5, v6, (unsigned int)&v23, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v7 = (_QWORD *)sub_180049B78();
  unknown_libname_81(&v23, (_QWORD *)(*a3 + 96LL));
  v8 = (__int64 *)sub_180079B50(v23, &v18);
  sub_180011010(v7 + 3, v8);
  if ( v19 )
    sub_18001050C(v19);
  unknown_libname_81(&v18, (_QWORD *)(*a3 + 144LL));
  v9 = (__int64 *)sub_180079B50(v18, &v16);
  sub_180011010(v7 + 5, v9);
  if ( v17 )
    sub_18001050C(v17);
  unknown_libname_81(&v16, (_QWORD *)(*a3 + 208LL));
  v10 = (__int64 *)sub_180079B50(v16, &v14);
  sub_180011010(v7 + 7, v10);
  if ( v15 )
    sub_18001050C(v15);
  unknown_libname_81(&v14, (_QWORD *)(*a3 + 224LL));
  v11 = (__int64 *)sub_180079B50(v14, &v21);
  sub_180011010(v7 + 9, v11);
  if ( v22 )
    sub_18001050C(v22);
  result = sub_180078140(a1);
  if ( v15 )
