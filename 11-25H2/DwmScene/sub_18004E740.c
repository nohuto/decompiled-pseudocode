/*
 * XREFs of sub_18004E740 @ 0x18004E740
 * Callers:
...
int __fastcall sub_18004E740(__int64 a1)
{
  ...
  v9[0] = &std::_Func_impl_no_alloc<_lambda_2f7a86c028961b1be19ef61dc11d1eb9_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
