/*
 * XREFs of sub_18004667C @ 0x18004667C
 * Callers:
 ...
 *     sub_180046E00 @ 0x180046E00 (sub_180046E00.c)
...
__int64 __fastcall sub_18004667C(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  unsigned int v4; // eax
  int v5; // r8d
  _QWORD *v6; // rax
  ...
  LOBYTE(a4) = a3;
  return sub_180046758(a1, a2, *(unsigned int *)(a1 + 120), a4);
}
