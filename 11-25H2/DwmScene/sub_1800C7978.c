/*
 * XREFs of sub_1800C7978 @ 0x1800C7978
 * Callers:
...
__int64 __fastcall sub_1800C7978(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 v4; // r8
  int v5; // ecx
  ...
  *(_WORD *)(a2 + 16) = -1;
  si128 = _mm_load_si128((const __m128i *)&xmmword_18018C460);
  *(_DWORD *)(a2 + 20) = 1;
  ...
  *(_DWORD *)(a2 + 28) = v12;
  ...
  while ( v13 < 8 );
  v15 = _mm_load_si128((const __m128i *)&xmmword_18018C460);
