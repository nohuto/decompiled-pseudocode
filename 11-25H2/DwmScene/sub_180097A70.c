/*
 * XREFs of sub_180097A70 @ 0x180097A70
 * Callers:
...
__int64 __fastcall sub_180097A70(__int64 a1, __int64 a2, char a3)
{
  __int64 v4; // rdi
  __int64 *v6; // rax
  __m128i v7; // xmm9
  ...
  v66 = 0;
  v67 = 0LL;
  sub_1800296B4((__int64 *)v68);
  sub_180097354(v4, (__int64)&v51[8]);
  sub_18002909C(v68, (__int64)v68);
  if ( *(_DWORD *)(a1 + 920) == 2 )
  {
    if ( a3 )
      sub_180037284(*(_QWORD ***)(a1 + 896));
    if ( sub_18009686C(a1) )
    {
      v6 = (__int64 *)sub_1800969CC(a1, (__int64)v69);
    }
    else
    {
      v44 = 4LL;
    ...
    if ( _mm_cvtsi128_si32(v7) == 2 )
    {
      ...
      while ( !*((_BYTE *)v9 + 25) )
      {
        v8 = (unsigned __int8)sub_1800982F4(v9 + 8) != 0 ? v8 : 0;
        v10 = (__int64 **)v9[2];
        if ( *((_BYTE *)v10 + 25) )
        {
      ...
      {
        v13 = (__int64 *)sub_1800969CC(a1 + 176, (__int64)v72);
      }
      else
      {
        v44 = 4LL;
      ...
      v73 = v13[2];
      v15 = a1 + 352;
      if ( sub_18009686C(a1 + 352) )
      {
        v16 = (__int64 *)sub_1800969CC(a1 + 352, (__int64)v72);
      }
      else
      {
        v44 = 4LL;
      ...
      {
        v19 = (__int64 *)sub_1800969CC(a1 + 528, (__int64)v72);
      }
      else
      {
        v44 = 4LL;
      ...
      {
        v21 = (_OWORD *)sub_180096A64(a1 + 704, (__int64)&v51[8]);
      }
      else
      {
        v74[0] = 4LL;
      ...
      if ( v8 && v23 && v24 && v25 && v26 )
      {
        ...
        else
        {
          ...
          *(_BYTE *)(a1 + 1048) = 1;
          ...
          while ( !*((_BYTE *)v37 + 25) )
          {
            v38 = sub_180098214(v37 + 8, v72);
            sub_180016F54((__int64)v74, (__int64)(v37 + 4));
            v75 = *(_OWORD *)v38;
            v76 = *(_QWORD *)(v38 + 16);
            sub_180096E48((_QWORD *)(a1 + 1064), (__int64)&v44, (__int64)v74);
        ...
        sub_180096638((__int64)&v51[8]);
        sub_18009671C(a1, (__int64 *)&v51[8]);
        sub_1800966C0(&v51[8]);
        sub_180096638((__int64)&v51[8]);
        sub_18009671C(a1 + 176, (__int64 *)&v51[8]);
        sub_1800966C0(&v51[8]);
        sub_180096638((__int64)&v51[8]);
        sub_18009671C(v15, (__int64 *)&v51[8]);
        sub_1800966C0(&v51[8]);
        sub_180096638((__int64)&v51[8]);
        sub_18009671C(v18, (__int64 *)&v51[8]);
        sub_1800966C0(&v51[8]);
        sub_180096638((__int64)&v51[8]);
        sub_18009671C(a1 + 704, (__int64 *)&v51[8]);
        sub_1800966C0(&v51[8]);
        v42 = *(_QWORD *)(a1 + 880);
        sub_18009551C(a1 + 880, a1 + 880, *(char **)(v42 + 8));
        *(_QWORD *)(v42 + 8) = v42;
        *(_QWORD *)v42 = v42;
        *(_QWORD *)(v42 + 16) = v42;
        *(_QWORD *)(a1 + 888) = 0LL;
