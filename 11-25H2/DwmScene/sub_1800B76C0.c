...
int __fastcall sub_1800B76C0(__int64 *a1)
{
  ...
  v9[0] = &std::_Func_impl_no_alloc<_lambda_973e7e53f49bf9ebe6ecec01f6a7b8f1_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
