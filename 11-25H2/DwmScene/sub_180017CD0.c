/*
 * XREFs of sub_180017CD0 @ 0x180017CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180017CD0(__int64 a1, __int64 **a2)
{
  __int64 v3; // rbx
  int v4; // eax
  unsigned int v5; // ebx
  ...
  sub_180016F54((__int64)v12, v3 + 18496);
  sub_18004CCE0(v3, &v10, v12);
  sub_18005B17C(v10, &v8);
  v14 = 0LL;
  sub_18000E854((__int64 *)&v14);
  v4 = sub_18001613C(&v14, &v8);
  v5 = v4;
  if ( v4 >= 0 )
  {
    v7 = v14;
