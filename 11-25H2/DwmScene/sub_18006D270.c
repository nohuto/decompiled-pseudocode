/*
 * XREFs of sub_18006D270 @ 0x18006D270
 * Callers:
...
__int64 __fastcall sub_18006D270(_QWORD *a1, __int64 *a2)
{
  __int64 v2; // rsi
  __int64 i; // rbx
  __int64 v5; // r8
  ...
  for ( i = *a2; i != v2; i += 152LL )
  {
    ...
    if ( *(_BYTE *)(i + 120) )
    {
      result = sub_18006D178(v8, i);
    }
    else
    {
      sub_18006D178(v8, v5 + 152 * v6);
      *(_BYTE *)(v8 + 120) = 0;
      *(_QWORD *)(v8 + 128) = *(_QWORD *)(i + 128);
      result = sub_18006D368(v8 + 136);
    }
  }
  return result;
}
