/*
 * XREFs of sub_18004A9EC @ 0x18004A9EC
 * Callers:
 ...
 *     sub_18004ABB0 @ 0x18004ABB0 (sub_18004ABB0.c)
 */

__int64 __fastcall sub_18004A9EC(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rbx
  __int64 v7; // rcx
  __int64 v8; // rbx
  ...
  else
  {
    ...
    *(_QWORD *)&v13 = a1;
    ...
    sub_18004ABB0(v10, v9 + 32, v11, &v16);
    *(_QWORD *)v9 = v8;
    *(_QWORD *)(v9 + 8) = v8;
    *(_QWORD *)(v9 + 16) = v8;
    *(_WORD *)(v9 + 24) = 0;
