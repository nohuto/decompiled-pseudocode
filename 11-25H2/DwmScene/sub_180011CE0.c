/*
 * XREFs of sub_180011CE0 @ 0x180011CE0
 * Callers:
...
_QWORD *__fastcall sub_180011CE0(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003BD1C();
  v4 = *(_QWORD *)sub_180011E00(a1, &v10);
  if ( v11 )
    sub_18001050C(v11);
  if ( v4 )
  {
