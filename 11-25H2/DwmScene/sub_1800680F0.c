/*
 * XREFs of sub_1800680F0 @ 0x1800680F0
 * Callers:
...
__int64 __fastcall sub_1800680F0(_QWORD *a1, unsigned __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    v8 = (_QWORD *)*v8;
    v10 = (__int64)(v9 + 2);
    v11 = sub_1800130AC((__int64)(v9 + 2));
