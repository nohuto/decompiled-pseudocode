/*
 * XREFs of sub_1800BE290 @ 0x1800BE290
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_1800BE290(__int64 *a1, __int64 *a2)
{
  __int64 v4; // r12
  _QWORD *v5; // rsi
  __int64 v6; // r13
  ...
  else
  {
    ...
    v34 = 32;
    v35 = 2;
    v32[2] = sub_1800BD6BC((__int64)a1);
    ...
    v32[3] = 0;
    v26[0] = 0LL;
    sub_1800BD804((__int64)a1, &v27);
    if ( v27 )
    {
      sub_1800B9884(v27, &v25);
      if ( v28 )
        sub_18001050C(v28);
      v19 = (__int64)v25;
    }
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v4 + 16LL))(v4) )
  {
    ...
    sub_18000E854(&v24);
    v17 = v16(v15, 0LL, &unk_18018A6C0, &v24);
    v18 = v17;
    if ( v17 < 0 )
    {
      memset(&pExceptionRecord, 0, sizeof(pExceptionRecord));
