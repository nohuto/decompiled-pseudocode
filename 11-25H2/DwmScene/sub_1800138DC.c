/*
 * XREFs of sub_1800138DC @ 0x1800138DC
 * Callers:
...
void __fastcall sub_1800138DC(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm3
  __m128 v4; // xmm4
  __m128 v5; // xmm1
  ...
  v11 = _mm_mul_ps(_mm_add_ps(v4, v3), (__m128)xmmword_18018C560);
  v12 = _mm_mul_ps(_mm_sub_ps(v3, v5), (__m128)xmmword_18018C560);
