/*
 * XREFs of sub_1800CDAD0 @ 0x1800CDAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18001E614 @ 0x18001E614 (sub_18001E614.c)
 *     sub_18001E81C @ 0x18001E81C (sub_18001E81C.c)
 */

// Hidden C++ exception states: #wind=1
_OWORD *__fastcall sub_1800CDAD0(__int64 a1, _OWORD *a2, __int64 a3)
{
  __int64 v4; // r10
  __int64 v5; // rax
  ...
  if ( !*(_QWORD *)(a3 + 16) )
  {
    ...
    sub_18001D21C(pExceptionObject, (__int64)&v15);
    throw (Spectre::Utils::SpectreInvalidArgException *)pExceptionObject;
  }
  if ( *(_WORD *)sub_1800130AC(a3) == 47 )
  {
    v5 = sub_1800130AC(v4);
    v13[0] = v8;
    if ( v6 > 1 && (v9 = sub_18001E614((_WORD *)(v5 + 2), v6 - 1, v13)) != 0LL )
    ...
    sub_18001E81C(v7, (__int64)&v15, 1uLL, v11 - 1);
    *a2 = v15;
    a2[1] = si128;
  ...
  {
    sub_180012344((__int64)a2, (__int64)&unk_1801C88F0);
  }
  return a2;
}
