/*
 * XREFs of sub_18001E1E8 @ 0x18001E1E8
 * Callers:
...
__int64 __fastcall sub_18001E1E8(__int64 a1, const WCHAR *a2, __int64 a3)
{
  int v3; // edi
  int v6; // eax
  int cbMultiByte; // ebp
  ...
  if ( a3 )
  {
    ...
    if ( v6 <= 0 )
      __fastfail(7u);
    sub_18001E730(&v11, v6);
    lpMultiByteStr = (CHAR *)sub_1800137F8((__int64)&v11);
