/*
 * XREFs of sub_1800BA900 @ 0x1800BA900
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_1800BA900(__int64 a1, int a2)
{
  int v2; // r8d
  int v3; // edx
  int v4; // edx
...
LABEL_21:
            std::string::string(v17, "unknown device feature queried");
            sub_18001B2B0((__int64)pExceptionObject, (__int64)v17, 0);
