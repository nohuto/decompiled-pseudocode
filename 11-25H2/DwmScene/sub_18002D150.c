...
__int64 __fastcall sub_18002D150(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *v4; // rax
  _QWORD *v9; // rbx
  __int64 v10; // rdx
...
LABEL_36:
  ...
  if ( a3 != *v4 )
  {
    ...
    if ( v23 < 0 )
    {
      ...
      sub_1800137F8(a4);
      v30 = (const void *)sub_1800137F8(v24 + 32);
      LOBYTE(v32) = sub_18001BB4C(v30, *(_QWORD *)(v24 + 48), v31, *(_QWORD *)(a4 + 16));
      if ( v32 >= 0 )
        goto LABEL_29;
...
LABEL_25:
    ...
    {
      v47 = a3;
      v37 = sub_18001C2C0(&v47);
      v38 = *v37;
      if ( !*(_BYTE *)(*v37 + 25) )
      {
        sub_1800137F8(v38 + 32);
        v39 = (const void *)sub_1800137F8(a4);
        LOBYTE(v41) = sub_18001BB4C(v39, *(_QWORD *)(a4 + 16), v40, *(_QWORD *)(v38 + 48));
        if ( v41 >= 0 )
          goto LABEL_29;
      }
  ...
  {
LABEL_29:
    sub_18001B85C((__int64)a1, (__int64 **)&v45, a4);
    v42 = v46;
    if ( sub_18001B920(v43, v46) )
    {
      *(_QWORD *)a2 = v42;
      *(_QWORD *)(a2 + 8) = 2LL;
      *(_BYTE *)(a2 + 16) = 1;
