/*
 * XREFs of sub_180050950 @ 0x180050950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180050950(__int64 a1, __int64 a2)
{
  unsigned int v4; // ebx
  __int64 v5; // r8
  __int64 v6; // rdx
  ...
  if ( (v15 - v14) >> 4 )
  {
    ...
    do
    {
      ...
      v16 = *(_DWORD *)(v11 + 244);
      v7 = sub_180050140((__int64 *)(a1 + 128), (__int64)v13, &v16);
  ...
  return sub_1800130E0((__int64)&v14);
}
