/*
 * XREFs of sub_180052C10 @ 0x180052C10
 * Callers:
...
__int64 __fastcall sub_180052C10(__int64 a1, __int64 a2, int a3, int a4)
{
  __int64 *v5; // rbx
  __int64 v6; // rax
  ...
  *(_OWORD *)(a1 + 104) = 0LL;
  *(_BYTE *)(a1 + 120) = 0;
  sub_18001C148((struct _Mtx_internal_imp_t *)(a1 + 128));
