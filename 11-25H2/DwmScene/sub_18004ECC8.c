/*
 * XREFs of sub_18004ECC8 @ 0x18004ECC8
 * Callers:
...
int __fastcall sub_18004ECC8(__int64 a1)
{
  ...
  v7[1] = a1 + 16;
  sub_180011B30(a1 + 16);
  v7[0] = _std_type_info_hash(&qword_1801B9600);
  v3 = *(_QWORD *)sub_18004F02C(a1, v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_76eddb9b03c24eac3632c1cece1b494c_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
