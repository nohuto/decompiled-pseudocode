/*
 * XREFs of sub_18003A7B4 @ 0x18003A7B4
 * Callers:
...
char __fastcall sub_18003A7B4(__int32 *a1, unsigned __int64 *a2, _OWORD *a3)
{
  ...
  *((_QWORD *)&v40 + 1) = v6;
  sub_180038AEC((__int64)v45, (int *)&v42, &v39, &v40, &v41);
  if ( !sub_180039A94((__int64)v45, (__int64)a2, a3, v35) )
    return 0;
  v36 = 0LL;
  result = 1;
