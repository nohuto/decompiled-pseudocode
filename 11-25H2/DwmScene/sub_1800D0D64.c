/*
 * XREFs of sub_1800D0D64 @ 0x1800D0D64
 * Callers:
...
unsigned __int64 __fastcall sub_1800D0D64(_QWORD *a1, unsigned __int64 a2)
{
  ...
  sub_18003FD80((__int64)(a1 + 3), 2 * v7, v4);
  a1[7] = v7;
  a1[6] = v7 - 1;
  v8 = *(_QWORD **)a1[1];
  v9 = v8;
  while ( v8 != (_QWORD *)v4 )
  {
    v9 = (_QWORD *)*v9;
    v10 = (__int64)(v8 + 2);
    v11 = sub_1800130AC((__int64)(v8 + 2));
    v13 = sub_18001E480(v12, v11, 2LL * *(_QWORD *)(v10 + 16));
    v16 = *v5;
    v17 = 2 * (a1[6] & v13);
    ...
    else
    {
      ...
      if ( sub_18005C53C(v14, v10, (__int64)(v18 + 2)) )
      {
        v25 = v18;
        while ( *(_QWORD **)(v16 + 8 * v17) != v25 )
        {
          v18 = (_QWORD *)v18[1];
          v25 = v18;
          if ( !sub_18005C53C(v19, v10, (__int64)(v18 + 2)) )
          {
            v26 = *v18;
            v27 = *(_QWORD **)(v20 + 8);
            *v27 = v9;
