/*
 * XREFs of sub_1800B704C @ 0x1800B704C
 * Callers:
...
int __fastcall sub_1800B704C(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B9C08);
  v3 = *(_QWORD *)sub_18004F02C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_8063c925c9079455a8b5523fef35cede_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
