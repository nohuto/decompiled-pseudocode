/*
 * XREFs of sub_18001565C @ 0x18001565C
 * Callers:
...
_QWORD *__fastcall sub_18001565C(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rax
  _QWORD *v9; // rax
  __int64 v10; // r10
  ...
  v8 = sub_18001B098(4264LL);
  if ( v8 )
  {
    v9 = unknown_libname_81(&v15, (_QWORD *)(a1 + 464));
    v8 = sub_1800B84DC(v10, a1, v9);
  }
  sub_180014FCC(v14, v8);
  v11 = v14[0];
