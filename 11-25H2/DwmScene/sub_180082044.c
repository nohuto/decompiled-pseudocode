/*
 * XREFs of sub_180082044 @ 0x180082044
 * Callers:
...
__int64 __fastcall sub_180082044(__int64 a1, __int64 *a2)
{
  __int64 v4; // r8
  int v5; // r15d
  __int64 *v6; // r14
  ...
  if ( *(_QWORD *)(a1 + 152) && (*(_DWORD *)(a1 + 152) != 1 || *(_DWORD *)(*(_QWORD *)*v6 + 32LL) != v5) )
  {
    ...
    if ( v8 )
    {
      ...
      if ( *(_QWORD *)(a1 + 120) - *(_QWORD *)(a1 + 112) == *(_QWORD *)(v4 + 120) - *(_QWORD *)(v4 + 112) )
        v9 = sub_180081CB8(*(_QWORD *)(a1 + 112), *(_QWORD *)(a1 + 120), *(_QWORD *)(v4 + 112));
      else
        v9 = 0;
    }
    else
...
LABEL_12:
      ...
      sub_180068508(pExceptionObject, (__int64)v10, v11, (__int64)v21, 0);
      throw (Spectre::Engine::EngineException *)pExceptionObject;
    }
  }
  v18 = v5;
  v12 = *(_QWORD *)sub_180050140(v6, (__int64)v20, &v18);
  result = *a2;
  v14 = a2[1];
  *a2 = 0LL;
  a2[1] = 0LL;
  ...
  *(_QWORD *)(v12 + 48) = v14;
  if ( v15 )
    result = sub_18001050C(v15);
  if ( v7 )
  {
    v18 = v5;
    v16 = *(_QWORD *)(*(_QWORD *)sub_180050140((__int64 *)(a1 + 144), (__int64)v20, &v18) + 40LL);
