/*
 * XREFs of sub_1800828F4 @ 0x1800828F4
 * Callers:
 ...
 *     sub_18007C8E4 @ 0x18007C8E4 (sub_18007C8E4.c)
 *     sub_18007C92C @ 0x18007C92C (sub_18007C92C.c)
 *     sub_180082B30 @ 0x180082B30 (sub_180082B30.c)
 */

char *__fastcall sub_1800828F4(_QWORD *a1, _BYTE *a2, __int64 a3)
{
  _BYTE *v3; // rbp
  ...
  if ( v7 == 0x1555555555555555LL )
    sub_180013178();
  v8 = v7 + 1;
  v19 = sub_18007C8E4(a1, v7 + 1);
  v9 = v19;
  v11 = (char *)sub_18007AB34(v10, &v19);
  v12 = (__int64)((unsigned __int128)((a2 - v3) * (__int128)0x2AAAAAAAAAAAAAABLL) >> 64) >> 1;
  v13 = &v11[12 * ((a2 - v3) / 12)];
  sub_180082B30(3 * ((v12 >> 63) + v12), v13, a3);
  v14 = (_BYTE *)a1[1];
  v15 = v11;
  v16 = (_BYTE *)*a1;
  if ( a2 == v14 )
  ...
  memmove(v15, v16, v17);
  sub_18007C92C((__int64)a1, (__int64)v11, v8, v9);
  return v13;
}
