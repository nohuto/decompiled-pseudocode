/*
 * XREFs of sub_1800B75D4 @ 0x1800B75D4
 * Callers:
...
int __fastcall sub_1800B75D4(__int64 *a1)
{
  ...
  v9[0] = &std::_Func_impl_no_alloc<_lambda_4751ef0567697aa51a05750371275a1e_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
