/*
 * XREFs of sub_18004516C @ 0x18004516C
 * Callers:
...
__int64 __fastcall sub_18004516C(_DWORD *a1)
{
  __int64 result; // rax
  char v3; // bl
  BOOL v4; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    {
      v5 = 1;
      v6 = (__int64 *)sub_180045A18(a1, v18, 0LL);
      v7 = *v6;
      v14 = *v6;
      v15 = v6[1];
      *v6 = 0LL;
    ...
    {
      v5 = 0;
      v9 = (__int64 *)sub_180045A18(a1, &v17, 0LL);
      v7 = *v9;
      *((_QWORD *)&v16 + 1) = v9[1];
      *v9 = 0LL;
      v9[1] = 0LL;
    ...
    *v8 = 0LL;
    ...
    v17 = 0LL;
    v12 = a1[30];
    v13 = sub_180045A88(a1, v18, 0LL);
    result = sub_1800D3878(v13, v12, (unsigned int)&v14, v11, v5, v4, (__int64)v20);
    if ( *((_QWORD *)&v16 + 1) )
      return sub_18001050C(*((__int64 *)&v16 + 1));
  }
  return result;
}
