/*
 * XREFs of sub_18007C2F4 @ 0x18007C2F4
 * Callers:
...
int __fastcall sub_18007C2F4(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v6 = *(const void **)a3;
  v7 = (unsigned __int64)(unsigned int)((__int64)(*(_QWORD *)(a3 + 8) - *(_QWORD *)a3) >> 6) << 6;
  v8 = (void *)sub_18007BFC4(a1, v5, 7);
