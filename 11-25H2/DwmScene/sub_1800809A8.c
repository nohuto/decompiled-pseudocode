/*
 * XREFs of sub_1800809A8 @ 0x1800809A8
 * Callers:
 *     sub_180081540 @ 0x180081540 (sub_180081540.c)
 * Callees:
...
_QWORD *__fastcall sub_1800809A8(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  __int64 v8; // rax
  __int64 v9; // rcx
