/*
 * XREFs of sub_1800788C8 @ 0x1800788C8
 * Callers:
...
char *__fastcall sub_1800788C8(_QWORD *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  v8 = v6 + 1;
  v17 = sub_18006D574(a1, v6 + 1);
  v10 = (char *)sub_180016644(v9, &v17);
  v11 = &v10[8 * ((a2 - v3) >> 3)];
  *(_QWORD *)v11 = *a3;
  v12 = v10;
  v13 = (_BYTE *)a1[1];
