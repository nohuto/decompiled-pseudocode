/*
 * XREFs of sub_1800BF4C4 @ 0x1800BF4C4
 * Callers:
...
char __fastcall sub_1800BF4C4(__int64 a1, int a2, int a3, int a4, int a5)
{
  int v7; // r14d
  int v8; // r15d
  __int64 *v9; // rax
  ...
  if ( a3 )
    v8 = a3;
  sub_180011B04(a1 + 72, &v21);
  v9 = sub_180015A5C(v21, &v17);
  v10 = (__int64 *)(a1 + 96);
  sub_180011010((_QWORD *)(a1 + 96), v9);
  if ( v18 )
    sub_18001050C(v18);
  sub_180027A8C(a1, (__int64)v24);
  if ( !v25 )
    sub_180013818((__int64)v24, "RenderTargetD3D11", 0x11uLL);
  v11 = *v10;
  v12 = sub_180016F54((__int64)v19, (__int64)v24);
  ...
  v20[6] = 0;
  sub_180051910(*v10, (__int64)v20);
  if ( (a5 & 0x80u) != 0 )
  {
    if ( !*(_QWORD *)(a1 + 112) )
    {
      v13 = sub_180015A5C(v21, &v17);
      sub_180011010((_QWORD *)(a1 + 112), v13);
      if ( v18 )
        sub_18001050C(v18);
    }
    v14 = *(_QWORD *)(a1 + 112);
    v15 = sub_18001B4B0(v23, (__int64)v24, (__int64)" (staging)");
    sub_180027C24(v14, (__int64)v15);
    v19[0] = v7;
    v19[1] = v8;
    v19[2] = 1;
    v19[3] = 1;
    ...
    v19[6] = 3;
    sub_180051910(*(_QWORD *)(a1 + 112), (__int64)v19);
  }
  result = sub_180011A5C((__int64)v24);
  if ( v22 )
    return sub_18001050C(v22);
  return result;
}
