/*
 * XREFs of sub_1800C70D0 @ 0x1800C70D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800C70D0(__int64 a1, unsigned int **a2)
{
  unsigned int *v4; // rdx
  __m128i v5; // xmm0
  __int64 v6; // rax
  ...
  v19 = a2;
  sub_180011B04(a1 + 72, &v17);
  v4 = *a2;
  si128 = _mm_load_si128((const __m128i *)&xmmword_18018C4B0);
  v25 = _mm_load_si128((const __m128i *)&xmmword_18018C3D0);
  v26 = 4;
  v27 = 5;
  v28 = 16;
  LODWORD(v20) = si128.m128i_i32[*v4];
  v5 = _mm_load_si128((const __m128i *)&xmmword_1800F74F0);
  si128 = v5;
  v25.m128i_i32[0] = 5;
