/*
 * XREFs of sub_1800B6D88 @ 0x1800B6D88
 * Callers:
...
int __fastcall sub_1800B6D88(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B9C40);
  v3 = *(_QWORD *)sub_18004F02C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_0afe27ddc9a0cdc90bbf3e2db7bb1a1d_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
