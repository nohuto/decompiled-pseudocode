/*
 * XREFs of sub_180072E1C @ 0x180072E1C
 * Callers:
...
__int64 *__fastcall sub_180072E1C(__int64 *a1, _QWORD *a2)
{
  __int64 v4; // rax
  __int64 v5; // rcx
  _QWORD *v6; // rax
  ...
  *a1 = 0LL;
  ...
  v11 = a1;
  v12 = a1;
  v4 = sub_180072ECC(a1, a2);
  *a1 = v4;
  *(_QWORD *)(*a1 + 8) = sub_180072F28(a1, *(_QWORD *)(*a2 + 8LL), v4);
  a1[1] = a2[1];
  v5 = *(_QWORD *)(*a1 + 8);
  if ( *(_BYTE *)(v5 + 25) )
  {
