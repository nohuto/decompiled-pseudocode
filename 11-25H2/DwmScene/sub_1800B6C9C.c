/*
 * XREFs of sub_1800B6C9C @ 0x1800B6C9C
 * Callers:
...
int __fastcall sub_1800B6C9C(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B9B48);
  v3 = *(_QWORD *)sub_18004F02C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_1bf4f65eb3aa0df8ad84d0734f8c2df8_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
