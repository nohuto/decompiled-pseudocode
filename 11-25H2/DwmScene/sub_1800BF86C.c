/*
 * XREFs of sub_1800BF86C @ 0x1800BF86C
 * Callers:
...
__int64 __fastcall sub_1800BF86C(__int64 a1, __int64 a2, int a3, int a4, __int64 a5)
{
  __int64 v5; // rbx
  int v7; // edi
  int v8; // r9d
  ...
  {
    v26 = v17;
    v19 = sub_180050D9C(&v21, (_DWORD *)v5, v18, &v25, (int *)&a5, (int *)&v24, &v26);
    v7 = 0;
  }
  else
  {
    v25 = v17;
    v19 = sub_180050E34(&v22, (_DWORD *)v5, v18, (int *)&a5, (int *)&v24, &v25);
    v12 = 0;
  }
  a5 = *v19;
  *v19 = 0LL;
