/*
 * XREFs of sub_1800D33D8 @ 0x1800D33D8
 * Callers:
...
__int64 __fastcall sub_1800D33D8(int a1, int a2, int a3, _QWORD *a4, __int64 a5)
{
  ...
  if ( a2 != (_DWORD)result )
  {
    do
    {
      ...
      v13 = v7 && (v9 & 1) != 0;
      result = sub_1800D36F4(a1, v9, v9 + 1, v9 + 2, v13, a5);
      v9 += v8;
      ++v11;
    }
    while ( v9 < v12 );
