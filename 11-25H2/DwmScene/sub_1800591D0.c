/*
 * XREFs of sub_1800591D0 @ 0x1800591D0
 * Callers:
...
char __fastcall sub_1800591D0(__int64 a1)
{
  double v2; // xmm2_8
  int v3; // eax
  float v4; // xmm0_4
...
LABEL_7:
      ...
      *(float *)&v7 = *(float *)&v7 * 0.017453292;
      v8 = sub_18005715C((__int64)v19, v7, v2, *(double *)&v5, LODWORD(v4));
      v9 = v8[1];
      v10 = v8[2];
      v11 = v8[3];
      v18[0] = *v8;
...
LABEL_16:
      *(float *)v12.m128i_i32 = sub_18001A748(*(float *)v12.m128i_i32);
    ...
    case 5:
      ...
      break;
    default:
      v9 = xmmword_1800F7630;
      v10 = xmmword_1800F7640;
      v11 = xmmword_1800F7650;
      v18[0] = 0x3F800000uLL;
      break;
  }
  v13 = *(_DWORD *)(a1 + 316) == 5;
