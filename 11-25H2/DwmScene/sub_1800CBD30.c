 ...
 *     sub_1800C7EF4 @ 0x1800C7EF4 (sub_1800C7EF4.c)
...
__int64 __fastcall sub_1800CBD30(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  double v6; // xmm0_8
  char v7; // r12
  int v8; // eax
  ...
  v77 = a2;
  sub_1800CBA48((__int64)a1, &v102);
  sub_1800B9A04(v102, &v88);
  ...
  *(_BYTE *)(*a3 + 1) = v7;
  v75 = 0LL;
  v8 = sub_1800CAD54(&v76, (__int64 *)&v75);
  v9 = v8;
  if ( v8 < 0 )
  {
  ...
  sub_180011424(v75, "CameraBackBuffer");
  v71 = 0;
  v10 = 0;
  v70 = 0;
  v11 = (__int64 *)(*a3 + 8);
  ...
  if ( (__int64 *)*v11 != v75 )
  {
    ...
    {
      sub_1800C8154((__int64 *)(*a3 + 96), (__int64 *)(*a3 + 48));
    }
    *(_QWORD *)&v100 = v13 | 0x100000000LL;
    ...
    sub_1800BD5D4(v73, "DxgiBackBuffer");
    v74[0] = 0LL;
    v24 = v73;
    ...
    *(_QWORD *)&v118[12] = 3LL;
    ...
    sub_180011424(*(__int64 **)(*a3 + 16), "BackBufferStaging");
    sub_18000E854((__int64 *)(*a3 + 56));
    sub_18000E854((__int64 *)(*a3 + 104));
    v71 = 1;
    sub_18000E854(v74);
    sub_18000E854(&v73);
    v10 = 0;
  ...
  if ( !*(_QWORD *)(*a3 + 56) || !*(_QWORD *)(v37 + 104) )
  {
    ...
    *(_QWORD *)((char *)&v110 + 4) = 1LL;
    ...
    sub_180011424(*(__int64 **)(*a3 + 24), "BackBuffer_DepthStencilTexture");
    sub_1800C7EF4(v79, (v7 != 0) + 3);
    v82 = 1;
    ...
    sub_180011424(*(__int64 **)(*a3 + 56), "BackBuffer_DepthStencilView_LeftEye");
    if ( v7 )
    {
      v81 = 1;
      ...
      sub_180011424(*(__int64 **)(*a3 + 104), "BackBuffer_DepthStencilView_RightEye");
    }
    else
    {
      sub_1800C8154((__int64 *)(*a3 + 104), (__int64 *)(*a3 + 56));
    }
    v10 = 1;
    v70 = 1;
  }
  v50 = (*(__int64 (__fastcall **)(_QWORD *, _BYTE *))(*a1 + 376LL))(a1, v104);
  sub_180011B04(v50, &v91);
  if ( v105 )
    sub_180010544(v105);
  v51 = v91;
  ...
  if ( v71 )
  {
    ...
    do
    {
      ...
      sub_1800BECFC(v93, &v86, &v84, &v83, v74[0], v73);
      sub_1800107FC(v57, &v94);
      sub_180026710(v94, &v96);
      sub_18001244C((__int64 *)(*a3 + 64 + 48LL * v53), &v94);
      if ( v95 )
        sub_18001050C(v95);
      if ( v97 )
        sub_18001050C(v97);
    ...
    v52 = v78;
    if ( !v72 )
      sub_18001244C((__int64 *)(*a3 + 64), (_QWORD *)(*a3 + 112));
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      sub_1800C833C(v78, (__int64 *)&v77, &v85);
      sub_180023410(v63, &v89);
      v65 = unknown_libname_81(&v106, &v98);
      sub_180069048(v66, v65, 5);
      v67 = unknown_libname_81(&v107, &v89);
      sub_18002ABC4((__int64)a1, v67);
      sub_18001244C((__int64 *)(*a3 + 80 + 48LL * v61), &v89);
      if ( v90 )
        sub_18001050C(v90);
      if ( v99 )
        sub_18001050C(v99);
    ...
    while ( v52 );
    if ( !v72 )
      sub_18001244C((__int64 *)(*a3 + 80), (_QWORD *)(*a3 + 128));
  }
  if ( v92 )
    sub_18001050C(v92);
  sub_18000E854((__int64 *)&v75);
  v68 = v76;
  if ( v76 )
  {
    v76 = 0LL;
  ...
  result = sub_18000E854(&v88);
  if ( v103 )
    return sub_18001050C(v103);
  return result;
}
