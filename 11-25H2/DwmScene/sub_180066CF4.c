/*
 * XREFs of sub_180066CF4 @ 0x180066CF4
 * Callers:
 ...
 *     sub_180067D98 @ 0x180067D98 (sub_180067D98.c)
...
char __fastcall sub_180066CF4(__int64 a1, __int64 *a2, int a3, _QWORD *a4)
{
  __m128 v4; // xmm2
  __m128 v5; // xmm3
  __int64 v8; // rax
  ...
  v89 = a4;
  LODWORD(v86) = a3;
  v8 = sub_18005D728(*a2, (__int64)a2);
  unknown_libname_81(&v98, (_QWORD *)(v8 + 184));
  v9 = sub_1800323A0(a1, *(_DWORD *)(*a2 + 112));
  v10 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v9 + 64LL))(v9, &unk_1801C5A48, 1LL);
  v11 = *(void (__fastcall **)(__int64, _BYTE *, void *, __int64))(*(_QWORD *)v9 + 96LL);
  v12 = std::wstring::wstring((__int64)v105, word_1800F78E8);
  v11(v9, v109, &unk_1801C5AE8, v12);
  sub_18002BF54((__int64)v108, (__int64)v109);
  ...
  v19 = 0;
  v20 = *a2;
  v21 = sub_180012344((__int64)v105, (__int64)&unk_1801C4028);
  v22 = *(_QWORD *)sub_18003EA7C(v20, (__int64)&v92, v21);
  sub_18003BCDC(v22);
  *(_QWORD *)v97 = *(_QWORD *)(v22 + 172);
  ...
  if ( v15 )
  {
    ...
    v25 = std::wstring::wstring((__int64)&v92, word_1800F78E8);
    v24(v9, v105, &unk_1801C5B08, v25);
    sub_18002BF54((__int64)v106, (__int64)v105);
    sub_180011B04(v83 + 56, &v87);
    sub_18003A280(v87, v102);
    v26 = (__m128)xmmword_18018C380;
    v82 = xmmword_18018C380;
    v27 = *a2;
    v28 = sub_180012344((__int64)v101, (__int64)&unk_1801C3FE8);
    sub_18003EA7C(v27, (__int64)&v92, v28);
    v29 = v92;
    sub_18003BCDC(v92);
    v30 = *(__int64 **)(v29 + 40);
    v31 = *(__int64 **)(v29 + 32);
    if ( v31 != v30 )
    {
      do
      {
        sub_180039BD8(*v31, (__int64)v104);
        sub_1800137F8((__int64)v106);
        v33 = (const void *)sub_1800137F8(v32);
        v36 = v34 == v107 && !memcmp(v33, v35, v34);
        sub_180011A5C((__int64)v104);
        if ( v36 )
        {
          sub_18001244C((__int64 *)&v96, v31);
          v37 = (unsigned int *)sub_180039F04(v96, (__int64)&v85);
          v17 = (__m128)*v37;
          v18 = (__m128)v37[1];
          v19 = v37[2];
          LODWORD(v95) = v19;
          ...
          v111 = 0;
          sub_18003B924(v96, (__int64)&v90, &v110);
          v38 = 0LL;
          ...
          v42 = _mm_or_ps(
                  _mm_and_ps((__m128)xmmword_1800F7040, v39),
                  _mm_andnot_ps((__m128)xmmword_1800F7040, _mm_sub_ps((__m128)0LL, _mm_shuffle_ps(v40, v40, 0))));
    ...
    *(double *)&v43 = sub_180067D98();
    *(_OWORD *)v100 = v43;
    *(_OWORD *)&v100[16] = 0LL;
    *(__m128 *)&v100[32] = v4;
    *(__m128 *)&v100[48] = v5;
    sub_180039F04(v87, (__int64)&v110);
    *(_QWORD *)&v82 = v110;
    *((_QWORD *)&v82 + 1) = v111 | 0x3F80000000000000LL;
    ...
    if ( _mm_shuffle_ps(v46, v46, 170).m128_f32[0] >= 0.0 )
    {
      ...
      *(_OWORD *)&v104[24] = 0LL;
      *(_OWORD *)&v104[44] = 0LL;
      *(_OWORD *)v104 = COERCE_UNSIGNED_INT64(sub_180067D98());
      memset(&v104[16], 0, 32);
      *(__m128 *)&v104[48] = v5;
      v50 = sub_180017768((__int64)v103, (__int128 *)v104, v102);
      sub_180017768((__int64)v101, v50, v100);
      sub_180011B04(v23 + 56, &v82);
      GsDriverEntry(v82, (__int64)v101);
      if ( *((_QWORD *)&v82 + 1) )
        sub_18001050C(*((__int64 *)&v82 + 1));
      sub_1800588CC(v23, *(float *)(v83 + 328));
      v51 = v83;
      v52 = *(_BYTE *)(v83 + 336);
      ...
      sub_180058EBC(v51);
      sub_180058728(v23, *(float *)(v51 + 332));
      sub_18005896C(v53, *(float *)(v83 + 320));
      sub_18005889C(v23, *(float *)(v83 + 324));
      v54 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v9 + 88LL))(v9, &unk_1801C5A68);
      v47 = *(float *)&v54;
      sub_18005D8E0(v49, &v85);
      if ( !v85.m128_u64[0] )
      {
        sub_1800324D4(a1, &v94, v86);
        v55 = sub_18005E428(&v82);
        v56 = (_DWORD *)*v55;
        v57 = v55[1];
        *v55 = 0LL;
        v55[1] = 0LL;
        ...
        *((_QWORD *)&v82 + 1) = v57;
        v85 = 0LL;
        sub_18006B38C(v49, &v82);
        v86 = a1;
        *(_QWORD *)(v23 + 1696) = &Spectre::Engine::ImageProcessingEffectPlanarReflection `RTTI Type Descriptor';
        sub_18005C498(v23 + 1704, &v86);
        if ( v95 )
          sub_18001050C(v95);
      }
      if ( v85.m128_u64[1] )
        sub_18001050C(v85.m128_i64[1]);
    }
    v59 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v9 + 64LL))(v9, &unk_1801C5AC8, 0LL);
    v110 = 0x400000005LL;
    v111 = 2;
    v60 = *((_DWORD *)&v110
          + (*(int (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v9 + 72LL))(v9, &unk_1801C5A88, 2LL));
    v61 = (__int64 *)sub_18006C60C(v49, &v82, v60);
    sub_1800588FC(v23, v61);
    v62 = (__int64 *)sub_18006C520(v49, &v82, v60);
    sub_180058790(v23, v62);
    *(_BYTE *)(v23 + 465) |= 3u;
    v63 = v47 + v47;
    if ( v47 >= 0.5 )
    {
    ...
    *((_QWORD *)&v82 + 1) = __PAIR64__(LODWORD(v16), LODWORD(v66));
    ...
    if ( v83 )
    {
      v70 = sub_180016F54((__int64)v104, (__int64)&unk_1801C72E8);
      sub_180058AA8(v69, v70, &v82, -1);
      v71 = v83;
      v72 = sub_180016F54((__int64)v104, (__int64)&unk_1801C72C8);
      v82 = xmmword_1800F7670;
      sub_180058AA8(v71, v72, &v82, -1);
      v73 = v83;
      v74 = sub_180016F54((__int64)v104, (__int64)&unk_1801C7308);
      v82 = xmmword_1800F7670;
      sub_180058AA8(v73, v74, &v82, -1);
    }
    v75 = sub_180016F54((__int64)v104, (__int64)&unk_1801C72E8);
    v82 = xmmword_1800F7670;
    sub_180058AA8(v23, v75, &v82, -1);
    LODWORD(v82) = 1053609165;
    DWORD1(v82) = v17.m128_i32[0];
    *((_QWORD *)&v82 + 1) = __PAIR64__(v19, v18.m128_u32[0]);
    v76 = sub_180016F54((__int64)v104, (__int64)&unk_1801C72C8);
    v85 = (__m128)v82;
    sub_180058AA8(v23, v76, &v85, -1);
    v77 = sub_180016F54((__int64)v104, (__int64)&unk_1801C7308);
    v82 = (__int128)v26;
    sub_180058AA8(v23, v77, &v82, -1);
    if ( v91 )
      sub_18001050C(v91);
    if ( v93 )
      sub_18001050C(v93);
  ...
  *(_BYTE *)(v23 + 72) = v15;
  ...
  if ( v88 )
    sub_18001050C(v88);
  if ( *((_QWORD *)&v96 + 1) )
    sub_18001050C(*((__int64 *)&v96 + 1));
  if ( v84 )
    sub_18001050C(v84);
  sub_180011A5C((__int64)v108);
  result = sub_180013128((__int64)v109);
  if ( v99 )
    return sub_18001050C(v99);
  return result;
}
