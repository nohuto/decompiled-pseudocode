/*
 * XREFs of sub_1800D2150 @ 0x1800D2150
 * Callers:
 *     sub_1800356CC @ 0x1800356CC (sub_1800356CC.c)
 * Callees:
 *     _o_floor @ 0x18000BFE0 (_o_floor.c)
...
char __fastcall sub_1800D2150(__int64 a1)
{
  char *v2; // rsi
  __int64 v3; // rcx
  __int64 v4; // rdx
  ...
  v28 = (__int64 *)(a1 + 56);
  sub_180011B30(a1 + 56);
  sub_1800D2064((__int64 *)a1, &v30, *(__int64 **)(a1 + 8), *(_QWORD *)(a1 + 24), *(_QWORD *)(a1 + 32));
  v3 = *(_QWORD *)(a1 + 24);
  v4 = *(_QWORD *)(a1 + 32);
  if ( v3 != v4 )
  {
  ...
  for ( i = (char *)*((_QWORD *)&v26 + 1); v5 != v23; v5 += 2 )
  {
    ...
    v8 = 1;
    v9 = v24;
    if ( !sub_180040290(v24 + 168) )
    {
      v28 = (__int64 *)(v29 - *(_QWORD *)(v9 + 8));
      sub_1800D1E80((__int64)&v30, (__int64)&v28);
      sub_1800D1E80((__int64)&v31, v9 + 16);
      v10 = v30 / v31;
      v11 = 0.0;
      v12 = 0.0;
      v13 = (int)(v30 / v31);
    ...
    LOBYTE(v6) = sub_180040290(v9 + 168);
    if ( (_BYTE)v6 || !v8 )
    {
LABEL_20:
      if ( *(_QWORD *)(v9 + 160) && v8 )
        sub_180024928(v9 + 104);
      if ( i == v2 )
      {
        LOBYTE(v6) = (unsigned __int8)sub_18006A4B8((__int64 *)&v26, (__int64)i, &v24);
        v2 = v27;
        i = (char *)*((_QWORD *)&v26 + 1);
      }
      else
    ...
    if ( v25 )
      LOBYTE(v6) = sub_18001050C(v25);
  }
  v17 = (void *)v26;
  for ( j = (char *)v26; j != i; j += 16 )
  {
    v19 = *(__int64 **)(a1 + 8);
    v20 = sub_1800D20C0(&v28, *(__int64 **)a1, v19, j);
    LOBYTE(v6) = sub_1800D2444(a1, &v30, *v20, v19);
  }
  if ( v17 )
  {
    sub_180012040((__int64)v17, (__int64)i);
    LOBYTE(v6) = sub_180010134(v17, (v2 - (_BYTE *)v17) & 0xFFFFFFFFFFFFFFF0uLL);
  }
  return (char)v6;
}
