/*
 * XREFs of sub_1800CF434 @ 0x1800CF434
 * Callers:
...
__int64 __fastcall sub_1800CF434(_QWORD *a1, __int64 a2, _DWORD *a3)
{
  __int64 *v5; // r14
  __int64 *v6; // rax
  __int64 *v7; // rdx
  ...
  if ( *((_BYTE *)v7 + 25) || *a3 < *((_DWORD *)v7 + 8) )
  {
    ...
    v16 = a3;
    *(_QWORD *)&v14 = a1;
    v9 = sub_18001B098(104LL);
    sub_1800CF870(v10, v9 + 32, v11, &v16);
    *(_QWORD *)v9 = v5;
    *(_QWORD *)(v9 + 8) = v5;
    *(_QWORD *)(v9 + 16) = v5;
    *(_WORD *)(v9 + 24) = 0;
    *((_QWORD *)&v14 + 1) = 0LL;
    sub_18004F1D8((__int64)&v14, v12);
    v14 = v15;
    *(_QWORD *)a2 = sub_18001CA04((__int64)a1, (__int64)&v14, v9);
    *(_BYTE *)(a2 + 8) = 1;
  }
  else
  {
