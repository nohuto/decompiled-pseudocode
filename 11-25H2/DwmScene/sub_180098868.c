/*
 * XREFs of sub_180098868 @ 0x180098868
 * Callers:
...
__int64 __fastcall sub_180098868(__int64 a1)
{
  __m128 *v1; // r8
  __m128 v2; // xmm2
  __m128 *v3; // rcx
  ...
  sub_180098804(a1);
  v2 = _mm_mul_ps(v1[3], (__m128)xmmword_18018C620);
  ...
  v4 = _mm_mul_ps(v1[1], (__m128)xmmword_18018C620);
  ...
  v5 = _mm_mul_ps(v1[2], (__m128)xmmword_18018C620);
  ...
  v6 = _mm_add_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18018C5B0, *v1), _mm_mul_ps(v1[6], (__m128)xmmword_18018C4F0)),
         _mm_mul_ps(v1[8], (__m128)xmmword_18018C530));
  ...
  v7 = _mm_sub_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18018C5B0, *v1), _mm_mul_ps((__m128)xmmword_18018C4F0, v1[6])),
         _mm_mul_ps(v1[8], (__m128)xmmword_18018C530));
  ...
  v8 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_18018C540, v1[6]), _mm_mul_ps((__m128)xmmword_18018C5B0, *v1));
  ...
  v9 = _mm_mul_ps(v1[5], (__m128)xmmword_18018C5A0);
  ...
  v10 = _mm_mul_ps(v1[7], (__m128)xmmword_18018C5A0);
  ...
  v11 = _mm_mul_ps(v1[4], (__m128)xmmword_18018C5A0);
  ...
  sub_18009854C(v3, COERCE_DOUBLE(1050868099LL));
  return v12;
}
