/*
 * XREFs of sub_18003B66C @ 0x18003B66C
 * Callers:
...
unsigned __int64 __fastcall sub_18003B66C(__int64 a1, __m128 *a2)
{
  char v4; // bl
  __int64 *v5; // rax
  __m128 *v6; // rax
  ...
  v4 = 0;
  sub_18003BD1C();
  if ( *sub_180012554(a1, &v17) )
  {
    v5 = sub_180012554(a1, &v15);
    v4 = 1;
    v6 = sub_18003A010(*v5, &v18);
  }
  else
  {
    v14 = xmmword_1800F7610;
    v6 = (__m128 *)&v14;
  }
  ...
  if ( (v4 & 1) != 0 && v16 )
    sub_18001050C(v16);
  if ( v17.m128_u64[1] )
    sub_18001050C(v17.m128_i64[1]);
  v8 = _mm_mul_ps(v7, v7);
  v9 = _mm_add_ps(_mm_shuffle_ps(v7, v8, 64), v8);
  v10 = _mm_add_ps(_mm_shuffle_ps(v8, v9, 48), v9);
  v11 = _mm_shuffle_ps(v10, v10, 170);
  v12 = _mm_cmple_ps(v11, (__m128)xmmword_1800F7080);
  v17 = _mm_or_ps(
          _mm_andnot_ps(v12, _mm_div_ps(_mm_mul_ps(v7, (__m128)xmmword_1800F9100), v11)),
          _mm_and_ps(v12, (__m128)xmmword_1800F7190));
  v17 = *sub_180039228(&v18, a2, &v17);
  return sub_18003B2D0(a1, &v17);
}
