/*
 * XREFs of sub_180038BA8 @ 0x180038BA8
 * Callers:
...
__int64 __fastcall sub_180038BA8(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r8
  __int64 v5; // r8
  ...
  *(_QWORD *)(a1 + 576) = 0LL;
  *(_QWORD *)(a1 + 584) = 0LL;
  v6 = _InterlockedIncrement64(&qword_1801C2BB0);
  *(_QWORD *)(a1 + 208) = v6;
  if ( v6 < *(_QWORD *)(a1 + 216) )
    v6 = *(_QWORD *)(a1 + 216);
  *(_QWORD *)(a1 + 216) = v6;
  LOBYTE(v5) = 1;
  sub_18003AE74(a1, 0LL, v5);
  LOBYTE(v7) = 1;
  sub_18003AE74(a1, 1LL, v7);
  LOBYTE(v8) = 1;
  sub_18003AE74(a1, 2LL, v8);
  LOBYTE(v9) = 1;
  sub_18003AE74(a1, 16LL, v9);
  sub_18003BA44(a1);
  v10 = a2[1];
  if ( v10 )
    sub_18001050C(v10);
