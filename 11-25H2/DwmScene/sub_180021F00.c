/*
 * XREFs of sub_180021F00 @ 0x180021F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180021F00(__int64 a1, __int64 *a2, __int64 a3, void *a4, __int64 a5, int *a6, int *a7)
{
  ...
  v17 = sub_180022A6C((char *)(a1 + 120));
  return sub_180023180(v8, v17);
}
