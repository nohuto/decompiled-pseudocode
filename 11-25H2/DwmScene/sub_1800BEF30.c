/*
 * XREFs of sub_1800BEF30 @ 0x1800BEF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800BEF30(__int64 a1, int a2, int a3, int a4, int a5)
{
  int v7; // r15d
  int v8; // r12d
  __int64 *v9; // rax
  ...
  if ( a3 )
    v8 = a3;
  sub_1800BF4C4(a1, v7, v8, a4, a5);
  sub_180011B04(a1 + 72, &v30);
  v9 = unknown_libname_81(&v24, &v30);
  sub_1800BEBEC(&v26, v9);
  sub_1800B9A04(v26, &v21);
  v10 = unknown_libname_81(v23, (_QWORD *)(a1 + 96));
  sub_180016F24(&v24, v10);
  sub_1800C2144(v24, v23);
  v32 = 0LL;
  v33 = 0LL;
  v34 = 0LL;
  v35 = 0;
  ...
  if ( (unsigned int)(a4 - 23) <= 1 )
    ...
    v12 = (a5 & 8) != 0;
  v28[0] = sub_1800BD710(a4, v12);
  v28[1] = v11 ? 6 : 4;
  v28[2] = 0;
  sub_1800C2144(v24, &v22);
  v13 = v21;
  v14 = *(__int64 (__fastcall **)(__int64, __int64, _DWORD *, __int64))(*(_QWORD *)v21 + 72LL);
  sub_18000E854((__int64 *)(a1 + 128));
  v15 = v14(v13, v22, v28, a1 + 128);
  sub_1800BB198(v26, v15);
  v16 = sub_180027A8C(a1, (__int64)v36);
  v17 = (const char *)sub_1800137F8(v16);
  sub_180011424(*(__int64 **)(a1 + 128), v17);
  sub_180011A5C((__int64)v36);
  v18 = 0LL;
  v18.m128_f32[0] = (float)v8;
  v19 = 0LL;
  v19.m128_f32[0] = (float)v7;
  sub_180026EF4(a1, _mm_unpacklo_ps(v19, v18).m128_i64[0]);
  sub_18000E854(&v22);
  sub_18000E854(v23);
  if ( v25 )
    sub_18001050C(v25);
  result = sub_18000E854(&v21);
  if ( v27 )
