/*
 * XREFs of ?dllmain_crt_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z @ 0x18000AF30
 * Callers:
 *     ?dllmain_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z @ 0x18000B128 (-dllmain_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z.c)
 * Callees:
 *     sub_18000B444 @ 0x18000B444 (sub_18000B444.c)
 *     __scrt_dllmain_crt_thread_detach @ 0x18000B474 (__scrt_dllmain_crt_thread_detach.c)
 */
...
__int64 __fastcall dllmain_crt_dispatch(HINSTANCE a1, int a2, void *const a3)
{
  ...
  {
    LOBYTE(result) = sub_18000B444(a1, v4, a3);
  }
