/*
 * XREFs of sub_18004E4A4 @ 0x18004E4A4
 * Callers:
...
void __fastcall sub_18004E4A4(__int64 a1)
{
  __m128 v1; // xmm2
  __m128 v2; // xmm2
  __m128 v3; // xmm1
  ...
  *(__m128 *)(a1 + 400) = _mm_mul_ps((__m128)xmmword_18018C500, *(__m128 *)(a1 + 400));
  ...
  *(float *)(v6 + 8) = (float)((float)(_mm_shuffle_ps(v5, v5, 85).m128_f32[0] * 0.71520001)
  ...
  sub_18003AAE8((unsigned __int64 *)v6);
}
