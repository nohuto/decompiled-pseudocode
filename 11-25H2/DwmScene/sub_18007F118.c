/*
 * XREFs of sub_18007F118 @ 0x18007F118
 * Callers:
 ...
 *     sub_18007F2B0 @ 0x18007F2B0 (sub_18007F2B0.c)
 */

// Hidden C++ exception states: #wind=1
__int64 *__fastcall sub_18007F118(__int64 *a1, size_t a2, const void *a3, size_t a4)
{
  size_t v7; // r15
  __int64 v8; // r14
  __int64 v9; // rax
  ...
  *a1 = v8;
  a1[1] = v9;
  v14 = 0;
  sub_18007F2B0(&pExceptionObject);
  v10 = (void *)*a1;
  if ( !*a1 )
  {
    v13 = "bad allocation";
