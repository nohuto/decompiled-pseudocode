/*
 * XREFs of sub_18005BCF8 @ 0x18005BCF8
 * Callers:
...
__int64 __fastcall sub_18005BCF8(_DWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  const char *v9; // rdx
  size_t v10; // r8
  ...
  v4 = (__int64)(a1 + 18);
  a1[26] = 40960;
  sub_180013818((__int64)(a1 + 18), "<unknown>", 9uLL);
  if ( (int)a1[26] >= 40960 )
  {
