/*
 * XREFs of sub_1800CE734 @ 0x1800CE734
 * Callers:
...
__int64 __fastcall sub_1800CE734(__int64 a1, __int64 a2, char a3, int a4)
{
    ...
    else
    {
      ...
      if ( *(_DWORD *)v13 == 5 )
      {
        ...
        if ( (unsigned __int8)sub_1800D1670(v14, v15)
          && (v16 = sub_180012344((__int64)v22, (__int64)v25), v17 = sub_1800D1560(v14, v16), *(_DWORD *)v17 == 4) )
        {
          if ( *(_BYTE *)(v17 + 60) != a3 )
          {
            v18 = sub_180012344((__int64)v22, (__int64)v25);
            sub_1800CE6A0(v14, v18, a3);
            v11 = 1;
          }
        }
        else
