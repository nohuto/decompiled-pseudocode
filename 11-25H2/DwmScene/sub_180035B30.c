/*
 * XREFs of sub_180035B30 @ 0x180035B30
 * Callers:
 ...
 *     sub_180032C10 @ 0x180032C10 (sub_180032C10.c)
...
__int64 __fastcall sub_180035B30(__int64 a1)
{
  _QWORD *v2; // rdi
  _QWORD *v3; // rax
  _QWORD *v4; // rax
  ...
  v4 = sub_1800323E8(a1, &v27);
  sub_180015174(&v20, v4);
  sub_18002F2B4(v36, (__int64)&v20);
  if ( v21 )
    sub_180010544(v21);
  if ( v28 )
    sub_18001050C(v28);
  ...
  v6 = sub_1800323E8(a1, &v30);
  sub_180015174(&v22, v6);
  sub_18002F2B4(v35, (__int64)&v22);
  if ( v23 )
    sub_180010544(v23);
  if ( v31 )
    sub_18001050C(v31);
  ...
  v18 = 0;
  sub_180011B8C(&v19);
  sub_18009521C(v17, &v17);
  v24 = 0LL;
  *(_OWORD *)&v16[1] = 0LL;
  sub_180033070(a1, 0, &v16[1], &v24);
  sub_18002FFC8((__int64)v35);
  sub_18001EADC((__int64)v37);
  v8 = *(__int64 **)(a1 + 704);
  v9 = *(__int64 **)(a1 + 712);
  if ( v8 != v9 )
  {
    ...
    do
    {
      v12 = (__int128 *)sub_18006D5B0(a1 + 376, v7);
      v32 = *v12;
      v33 = v12[1];
      v34 = v12[2];
      v14 = sub_18006D5B0(a1 + 200, v13);
      if ( sub_180032C10(v14) && !sub_180032C10((__int64)&v32) )
      {
        while ( _InterlockedExchange((volatile __int32 *)(a1 + 248), 1) )
          ;
        *v10 = v32;
        *(_DWORD *)(a1 + 216) = v33;
        *(_QWORD *)(a1 + 280) = *sub_180011B8C(&v25);
        *(_DWORD *)(a1 + 248) = 0;
      }
      *(_OWORD *)(a1 + 376) = *v10;
      ...
      *(_OWORD *)(a1 + 408) = *(_OWORD *)(a1 + 232);
      ...
      if ( (_QWORD *)(a1 + 432) != v11 )
        sub_18006D3A8(a1 + 432, *v11, (__int64)(*(_QWORD *)(a1 + 264) - *(_QWORD *)(a1 + 256)) >> 3);
      *(_QWORD *)(a1 + 456) = *(_QWORD *)(a1 + 280);
      sub_1800356CC((_QWORD *)a1, v8);
      v8 += 2;
    }
    while ( v8 != v9 );
  }
  ...
  *(_QWORD *)(a1 + 240) = 2LL;
  *(_DWORD *)(a1 + 248) = 0;
  sub_18002FFC8((__int64)v36);
  return sub_18001EADC((__int64)v38);
}
