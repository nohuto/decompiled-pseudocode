/*
 * XREFs of sub_18008F048 @ 0x18008F048
 * Callers:
...
__int64 __fastcall sub_18008F048(__int64 a1, __int64 a2, char a3)
{
  int v5; // eax
  int v6; // ecx
  unsigned int v7; // ebx
  ...
  if ( (*(_DWORD *)(v45 + 560) & 2) == 0 )
    v6 = v5;
  v55 = v6;
  v7 = sub_18005B968(*(_QWORD *)(a1 + 56));
  v8 = sub_18005B968(*(_QWORD *)(a1 + 56));
  v9 = sub_18005B968(*(_QWORD *)(a1 + 56));
  v10 = sub_18005B968(*(_QWORD *)(a1 + 56));
  v54 = v10;
  v11 = v7;
  v12 = 1LL << v7;
  v56 = v12;
  ...
  v41 = v13;
  v14 = sub_18004C59C(v11, (_DWORD **)&v40);
  v15 = 0LL;
  v16 = 1LL << v8;
  v17 = 1LL << v9;
  v42 = 1LL << v9;
  do
  {
    ...
    if ( !v19 || !v20 && !result )
    {
      sub_18005B398(*(_QWORD *)(a1 + 56), &v40, v18, v14 & ~v18, 1);
      *(_QWORD *)&v48 = 0LL;
      BYTE8(v48) = 0;
      *(_OWORD *)&v50[4] = 0LL;
      v53 = 3;
      ...
      *(_DWORD *)v50 = 7;
      v51 = 1;
      sub_180040908(v45, &v43);
      sub_18007EEC0(v43, (__int64)&v46, 0LL);
      v22 = unknown_libname_81(&v57, &v43);
      sub_18007E20C(v23, v22);
      if ( !v19 )
      {
        HIDWORD(v46) = 1;
        v24 = sub_180040908(v45, &v58);
        sub_180011010(&v43, v24);
        if ( v59 )
          sub_18001050C(v59);
        sub_18007EEC0(v43, (__int64)&v46, 0LL);
        v25 = unknown_libname_81(&v60, &v43);
        sub_18001244C((__int64 *)(v26 + 64), v25);
        v27 = v25[1];
        if ( v27 )
          sub_18001050C(v27);
        HIBYTE(v52) = 0;
        v28 = sub_180040908(v45, &v61);
        sub_180011010(&v43, v28);
        if ( v62 )
          sub_18001050C(v62);
        sub_18007EEC0(v43, (__int64)&v46, 0LL);
        v29 = unknown_libname_81(&v63, &v43);
        sub_18001244C((__int64 *)(v30 + 80), v29);
        v31 = v29[1];
        if ( v31 )
          sub_18001050C(v31);
        HIDWORD(v46) = 2;
        v32 = sub_180040908(v45, &v64);
        sub_180011010(&v43, v32);
        if ( v65 )
          sub_18001050C(v65);
        sub_18007EEC0(v43, (__int64)&v46, 0LL);
        v33 = unknown_libname_81(&v66, &v43);
        sub_18001244C((__int64 *)(v34 + 96), v33);
        v35 = v33[1];
        if ( v35 )
          sub_18001050C(v35);
      }
      ...
      *(_QWORD *)v50 = 0LL;
      ...
      {
        v47 = *(_QWORD *)(a1 + 112);
        sub_18007E7DC((__int64)v40, (__int64)&v46);
      }
      else
      {
        v47 = *(_QWORD *)(a1 + 120);
        sub_18007E7DC((__int64)v40, (__int64)&v46);
        v36 = v40;
        v37 = std::string::string(&v46, byte_1800F6C80);
        sub_18007E344(v36, 5, (__int64)v37);
      }
      v38 = *(_QWORD **)(a1 + 136);
      if ( v38 == *(_QWORD **)(a1 + 144) )
      {
        result = (__int64)sub_18008D6A0((__int64 *)(a1 + 128), *(_QWORD *)(a1 + 136), &v40);
      }
      else
      {
      ...
      if ( v41 )
        result = sub_18001050C((__int64)v41);
      v17 = v42;
    }
    v15 = v14 & ((~v14 | v15) + 1);
    v12 = v56;
