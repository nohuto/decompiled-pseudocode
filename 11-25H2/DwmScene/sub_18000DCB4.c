/*
 * XREFs of sub_18000DCB4 @ 0x18000DCB4
 * Callers:
...
__int64 (__fastcall *__fastcall sub_18000DCB4(unsigned __int64 a1, _BYTE *a2, __int64 a3))(_QWORD, _QWORD)
{
...
LABEL_8:
    ...
    {
      *a2 = 0;
      if ( (unsigned __int8)sub_18000E340(v5, *v11, a2, a3) )
        *(_QWORD *)(v5 + 72) = a2;
      v12 = *v11;
      do
      {
  ...
  result = qword_1801C3310;
  if ( qword_1801C3310 )
  {
    if ( v7 || (*(_BYTE *)(v5 + 4) & 2) != 0 )
      v6 = 1;
    LOBYTE(a1) = v6;
    return (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1801C3310(a1, v5);
  }
  return result;
}
