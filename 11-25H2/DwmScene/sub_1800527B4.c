/*
 * XREFs of sub_1800527B4 @ 0x1800527B4
 * Callers:
...
unsigned __int64 __fastcall sub_1800527B4(__int64 *a1, __int64 a2, _QWORD *a3)
{
  __int64 v4; // r14
  __int64 v6; // rdi
  __int64 v7; // rcx
  ...
  v19 = v7;
  v12 = sub_1800108F8(v7, &v19);
  sub_180010CC0(v13, (_QWORD *)((v4 & 0xFFFFFFFFFFFFFFF0uLL) + v12), a3);
  v14 = a1[1];
  v15 = v12;
  v16 = *a1;
  if ( a2 != v14 )
  {
    sub_180010C7C(v16, a2, v12);
    v14 = a1[1];
    v15 = (v4 & 0xFFFFFFFFFFFFFFF0uLL) + v12 + 16;
    v16 = a2;
  }
  sub_180010C7C(v16, v14, v15);
  if ( *a1 )
  {
    sub_180010AA8(*a1, a1[1]);
