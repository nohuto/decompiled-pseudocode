...
int __fastcall sub_18004EDB4(__int64 a1)
{
  ...
  v7[1] = a1 + 16;
  sub_180011B30(a1 + 16);
  v7[0] = _std_type_info_hash(&qword_1801B9550);
  v3 = *(_QWORD *)sub_18004F02C(a1, v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_838beeeaa6fb5cde8c4026525d949f60_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
