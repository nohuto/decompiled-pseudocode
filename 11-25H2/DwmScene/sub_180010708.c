/*
 * XREFs of sub_180010708 @ 0x180010708
 * Callers:
...
__int64 *__fastcall sub_180010708(_QWORD *a1, __int64 *a2)
{
  ...
  sub_180011B30(a1 + 2);
  v11 = _std_type_info_hash(&qword_1801B8BF8);
  sub_180011AC0(a1, &v12, &v11);
  if ( v12 == *a1 )
  {
    *a2 = 0LL;
    a2[1] = 0LL;
