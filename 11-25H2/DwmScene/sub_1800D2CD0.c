/*
 * XREFs of sub_1800D2CD0 @ 0x1800D2CD0
 * Callers:
...
__int64 __fastcall sub_1800D2CD0(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a9)
{
  ...
  while ( (unsigned int)v16 < v19 )
  {
    ...
    {
      std::string::string(v27, "Index out of range while computing tangents");
      sub_1800D32D0(pExceptionObject, v27);
    ...
    v23 = v14 && (v16 & 1) != 0;
    result = sub_1800D44E8(v12, a5, v20, v21, v22, v23, a8, a9);
