/*
 * XREFs of sub_180090BE0 @ 0x180090BE0
 * Callers:
...
__int64 __fastcall sub_180090BE0(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rsi
  _QWORD *v7; // r12
  _QWORD *v8; // r15
  ...
  if ( a2 != a3 )
  {
    ...
    v27 = v7;
    v28 = a2;
    v9 = sub_1800137F8(a2 + 16);
    v12 = sub_18001E480(v11, v9, *(_QWORD *)(v10 + 32));
    v14 = 2 * (a1[6] & v12);
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v6 + 8 * v14 + 8) = v7; ; *(_QWORD *)(v6 + 8 * v14 + 8) = v8 )
    {
      ...
      if ( v28 == a3 )
        break;
      v20 = sub_1800137F8(v28 + 16);
      v23 = sub_18001E480(v22, v20, *(_QWORD *)(v21 + 32));
      v14 = 2 * (a1[6] & v23);
