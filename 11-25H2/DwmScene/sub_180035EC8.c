/*
 * XREFs of sub_180035EC8 @ 0x180035EC8
 * Callers:
...
char *__fastcall sub_180035EC8(__int64 a1)
{
  _QWORD *v2; // rcx
  char *v3; // r8
  char *v4; // r9
  ...
  *(_QWORD *)(a1 + 944) = v11 + 1;
  sub_180028A2C(
    ...
    v11);
  v3 = (char *)&unk_1801C3570;
  do
  {
    v4 = v3 - 144;
    do
    {
      v5 = sub_18003C83C(v4 - 16);
      *v8 += v5;
      *(v8 - 1) = v5;
      v9 = v8[1];
      v4 = (char *)(v8 + 4);
    ...
    while ( v4 - 16 != v6 );
    v3 = v6 + 160;
    result = &byte_1801C3E30;
  }
  while ( v7 != &byte_1801C3E30 );
  return result;
}
