/*
 * XREFs of sub_18002B220 @ 0x18002B220
 * Callers:
...
__int64 __fastcall sub_18002B220(float *a1, float a2, float a3, float a4, float a5)
{
  __int64 v6; // rax
  __int64 result; // rax
  __int64 v8; // r14
  ...
  result = sub_180011B04(v6, &v17);
  if ( v16 )
    result = sub_180010544(v16);
  v8 = v17;
  if ( v17 )
  {
    v9 = *((_DWORD *)a1 + 41);
