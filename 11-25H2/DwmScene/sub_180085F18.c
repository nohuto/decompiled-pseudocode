/*
 * XREFs of sub_180085F18 @ 0x180085F18
 * Callers:
...
char __fastcall sub_180085F18(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v5 != 6 * (v5 / 6) )
  {
    ...
    sub_180038A58(pExceptionObject, (__int64)v7, v8, (__int64)v27, 0);
  ...
  if ( v13 != v6 )
  {
    ...
    v14 = std::string::string(
            v27,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\colortransform.cpp");
    sub_180038A58(pExceptionObject, (__int64)v14, v15, (__int64)v26, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  *(_QWORD *)a3 = v12;
  v16 = (__int64 *)(a3 + 8);
  ...
  if ( v6 >= v17 )
  {
    ...
    {
      LOBYTE(v13) = sub_180084E20(a3 + 8, v5 / 6, v10);
      goto LABEL_18;
    }
    v13 = sub_180084FC8(*(_QWORD *)(a3 + 16), v6 - v17, a3 + 8);
  }
  else
  {
    v13 = *v16 + 16 * v6;
...
LABEL_18:
  ...
  *(_DWORD *)(a3 + 32) = 0;
  if ( v6 )
  {
    ...
    do
    {
      sub_18001D58C(a2, v26, v19, 6uLL);
      v21 = sub_180086E30(v26, v20, 16LL);
      v22 = sub_180085898(v25, v21);
      v23 = *v16;
      *(float *)(v18 + v23) = *v22;
      *(float *)(v18 + v23 + 4) = v22[1];
      *(float *)(v18 + v23 + 8) = v22[2];
      *(float *)(v18 + v23 + 12) = v22[3];
      LOBYTE(v13) = sub_180011A5C((__int64)v26);
      v19 += 6LL;
      v18 += 16LL;
      --v6;
    }
