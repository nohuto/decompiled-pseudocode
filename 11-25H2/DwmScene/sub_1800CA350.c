/*
 * XREFs of sub_1800CA350 @ 0x1800CA350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800CA350(__int64 a1, __int64 a2, int a3)
{
  int v6; // ecx
  int v7; // ecx
  int v8; // eax
  ...
  if ( *(_DWORD *)(a1 + 136) != 1 )
    goto LABEL_19;
  sub_180011B04(*(_QWORD *)(a1 + 120) + 72LL, &v11);
  sub_1800C2568(&v13, &v11);
  if ( v12 )
    sub_18001050C(v12);
  sub_1800C2EE4(*(_QWORD *)(a1 + 120), &v11);
  v6 = *(_DWORD *)(a1 + 140);
  if ( !v6 )
  {
    v15 = 0LL;
