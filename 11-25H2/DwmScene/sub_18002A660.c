/*
 * XREFs of sub_18002A660 @ 0x18002A660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18002A660(_QWORD *a1)
{
  __int64 v2; // rax
  __int64 result; // rax
  unsigned int v4; // eax
  ...
  if ( !v8 )
  {
    ...
    sub_180068508((unsigned int)pExceptionObject, v4, v5, (unsigned int)v11, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  result = sub_18006B954(a1[26]);
  if ( v9 )
