/*
 * XREFs of sub_18000E504 @ 0x18000E504
 * Callers:
...
__int64 __fastcall sub_18000E504(HANDLE hHandle, int *a2)
{
  DWORD v4; // eax
  __int64 v5; // rdx
  __int64 v7; // rdx
  ...
  {
    v5 = 153LL;
    return sub_18000F0C4(retaddr, v5);
  }
  if ( !v4 || v4 == 258 )
  {
    PreviousCount = 0;
  ...
  v7 = 154LL;
LABEL_25:
  sub_18000F0E4(retaddr, v7, "wil", 2147549183LL);
  return 2147549183LL;
}
