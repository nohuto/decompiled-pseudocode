/*
 * XREFs of sub_180090590 @ 0x180090590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180090590(__int64 a1, __int64 a2)
{
  ...
  sub_1800488C8(a2, &v11);
  result = (__int64)sub_1800488EC(a2, &v7, v3);
  if ( v7 )
  {
    v5 = sub_180040728(a2, &v9);
    sub_18003A280(*v5, v20);
    if ( v10 )
      sub_18001050C(v10);
    v6 = sub_180040728(a2, &v9);
    sub_18003A3A8(*v6, (__int64)v21);
    if ( v10 )
      sub_18001050C(v10);
    v13 = 1065353216;
    v14 = 0LL;
    ...
    v18 = 0LL;
    v19 = 1065353216;
    sub_180058E38(v20, (__m128 *)&v13);
    sub_18007C274(v7, (__int64)&unk_1801C6FE8, &v13);
    sub_18007C274(v7, (__int64)&unk_1801C7008, v21);
    sub_18007C380(v7, (__int64)&unk_1801C7028);
    sub_18007C380(v7, (__int64)&unk_1801C7048);
    result = sub_18007C380(v7, (__int64)&unk_1801C7068);
  }
  if ( v8 )
