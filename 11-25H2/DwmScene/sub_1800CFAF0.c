/*
 * XREFs of sub_1800CFAF0 @ 0x1800CFAF0
 * Callers:
...
__int64 __fastcall sub_1800CFAF0(__int64 a1, int a2, _QWORD *a3)
{
  _QWORD *v5; // rax
  __int64 v6; // rax
  __int64 v7; // rax
  ...
  *(_QWORD *)a1 = &Spectre::Utils::JsonConfigurationManager::`vftable';
  sub_18001C148((struct _Mtx_internal_imp_t *)(a1 + 64));
  *(_QWORD *)(a1 + 96) = 0LL;
  *(_QWORD *)(a1 + 104) = 0LL;
  v6 = sub_18001B098(192LL);
  *(_QWORD *)v6 = v6;
  *(_QWORD *)(v6 + 8) = v6;
  *(_QWORD *)(v6 + 16) = v6;
  *(_WORD *)(v6 + 24) = 257;
  *(_QWORD *)(a1 + 96) = v6;
  sub_18001C148((struct _Mtx_internal_imp_t *)(a1 + 112));
  *(_QWORD *)(a1 + 144) = 0LL;
  *(_QWORD *)(a1 + 152) = 0LL;
