/*
 * XREFs of sub_180078220 @ 0x180078220
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall sub_180078220(__int64 a1, _QWORD *a2, _DWORD *a3, __int64 a4)
{
  __int64 v6; // rcx
  __int64 v8; // rbx
  __int64 *v9; // rax
  ...
  if ( (*a3 & 0x10000) == 0 )
  {
    ...
    v9 = sub_18001B57C(v17, (__int64)"Component::Clone() -- component '", a1 + 24);
    v10 = sub_18001B448((__int64)v18, (__int64)v9, (__int64)"' of type ");
    v11 = sub_18001B448((__int64)v19, v10, v8);
    v12 = sub_18001B448((__int64)v20, v11, (__int64)" does not support cloning.");
    v13 = std::string::string(
            v15,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\component.cpp");
    sub_1800479C0(pExceptionObject, (__int64)v13, v14, v12);
