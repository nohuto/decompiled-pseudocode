/*
 * XREFs of sub_18004014C @ 0x18004014C
 * Callers:
...
__int64 __fastcall sub_18004014C(_QWORD *a1, __int64 a2, __int64 a3)
{
  _QWORD *v6; // r12
  _QWORD *v7; // r15
  __int64 v8; // rsi
  ...
  if ( a2 != a3 )
  {
    ...
    v22 = v6;
    v23 = a2;
    v9 = sub_18001E480((__int64)a1, a2 + 16, 8uLL);
    v11 = 2 * (a1[6] & v9);
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v8 + 8 * v11 + 8) = v6; ; *(_QWORD *)(v8 + 8 * v11 + 8) = v7 )
    {
      ...
      if ( v23 == a3 )
        break;
      v18 = sub_18001E480(v15, v23 + 16, 8uLL);
      v11 = 2 * (a1[6] & v18);
