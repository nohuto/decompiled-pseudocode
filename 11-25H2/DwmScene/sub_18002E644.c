/*
 * XREFs of sub_18002E644 @ 0x18002E644
 * Callers:
...
_QWORD *__fastcall sub_18002E644(_QWORD *a1, __int64 a2, unsigned int *a3, unsigned int *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
