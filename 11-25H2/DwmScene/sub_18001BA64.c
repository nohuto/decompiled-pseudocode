/*
 * XREFs of sub_18001BA64 @ 0x18001BA64
 * Callers:
...
void **sub_18001BA64(void **Src, unsigned __int64 a2, __int64 a3, ...)
{
  char *v3; // r14
  ...
  v6 = &v3[a2];
  v15 = sub_1800117EC((__int64)&v3[a2], v5, 0x7FFFFFFFFFFFFFFFuLL);
  v8 = (char *)sub_180010918(v7, (unsigned __int64 *)va);
  v9 = Size;
  v10 = Srca;
  Src[3] = (void *)v15;
  Src[2] = v6;
