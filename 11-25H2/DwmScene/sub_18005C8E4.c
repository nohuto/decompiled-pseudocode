/*
 * XREFs of sub_18005C8E4 @ 0x18005C8E4
 * Callers:
...
_QWORD *__fastcall sub_18005C8E4(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003BD1C(a1);
  v4 = *(_QWORD *)sub_18005D4CC(a1, &v10);
  if ( v11 )
    sub_18001050C(v11);
  if ( v4 )
  {
