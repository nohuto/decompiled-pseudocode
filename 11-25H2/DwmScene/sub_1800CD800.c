/*
 * XREFs of sub_1800CD800 @ 0x1800CD800
 * Callers:
...
HRESULT __fastcall sub_1800CD800(
        ...
        ID3D11DeviceContext **a10)
{
  ...
  while ( 1 )
  {
    v15 = sub_180040290((__int64)&byte_1801C2BCC);
    v16 = v10 & 0xFFFFFFFD;
    v10 |= 2u;
    if ( !v15 )
      v10 = v16;
    ...
    sub_18000E854((__int64 *)&ppImmediateContext);
    sub_18000E854((__int64 *)ppDevice);
