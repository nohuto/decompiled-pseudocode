/*
 * XREFs of ?dllmain_crt_process_detach@@YAH_N@Z @ 0x18000B0A0
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x18000B530 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x18000B6C0 (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x18000B6EC (__scrt_uninitialize_crt.c)
 *     sub_18000B888 @ 0x18000B888 (sub_18000B888.c)
...
__int64 __fastcall dllmain_crt_process_detach(char a1)
{
  ...
  if ( dword_1801C2C90 <= 0 )
    return 0LL;
  --dword_1801C2C90;
  v4 = _scrt_acquire_startup_lock();
  if ( dword_1801C2C94 != 2 )
  {
    sub_18000B8E0(7LL);
    __debugbreak();
    JUMPOUT(0x18000B120LL);
  }
