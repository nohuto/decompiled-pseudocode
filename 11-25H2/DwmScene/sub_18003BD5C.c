/*
 * XREFs of sub_18003BD5C @ 0x18003BD5C
 * Callers:
 *     sub_180039A94 @ 0x180039A94 (sub_180039A94.c)
 * Callees:
...
char __fastcall sub_18003BD5C(__int64 a1, _OWORD *a2, _OWORD *a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm2
  ...
  __m128 v50; // xmm1
  __m128 v51; // xmm2
  unsigned __int64 v52; // xmm7_8^8
  __m128 *v53; // rcx
  __int64 v54; // r11
  float v55; // xmm0_4
  __int128 v57; // xmm0
  __m128 v58; // [rsp+28h] [rbp-79h] BYREF
  __m128 v59; // [rsp+38h] [rbp-69h] BYREF
  _OWORD v60[2]; // [rsp+48h] [rbp-59h] BYREF
  _QWORD v61[3]; // [rsp+68h] [rbp-39h]

  v58 = v4;
  *a3 = *(_OWORD *)&a4;
  v60[1] = xmmword_1800F7150;
  v7 = 0LL;
  v8 = _mm_mul_ps(v4, v4);
  v61[0] = &v58;
  v59 = v5;
...
LABEL_14:
  if ( *(float *)(a1 + 4 * v22) < 0.000099999997 )
    *(_OWORD *)v61[v22] = *off_1800F1540[v22];
  v25 = (__m128 *)v61[v22];
  ...
  v29 = _mm_sqrt_ps(v28);
  v30 = _mm_cmpneq_ps(v28, (__m128)xmmword_1800F6F80);
  v31 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v25, v29), _mm_cmpneq_ps((__m128)0LL, v29)), v30),
          _mm_andnot_ps(v30, (__m128)xmmword_1800F6FD0));
  *v25 = v31;
  if ( *(float *)(a1 + 4 * v24) < 0.000099999997 )
  {
    ...
    v36 = _mm_shuffle_ps(*(__m128 *)off_1800F1540[v7], *(__m128 *)off_1800F1540[v7], 210);
  ...
  v41 = _mm_sqrt_ps(v40);
  v42 = _mm_cmpneq_ps(v40, (__m128)xmmword_1800F6F80);
  v43 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v37, v41), _mm_cmpneq_ps((__m128)0LL, v41)), v42),
          _mm_andnot_ps(v42, (__m128)xmmword_1800F6FD0));
  *v37 = v43;
  ...
  v50 = _mm_sqrt_ps(v49);
  v51 = _mm_cmpneq_ps(v49, (__m128)xmmword_1800F6F80);
  *v46 = _mm_or_ps(
           _mm_and_ps(_mm_and_ps(_mm_div_ps(*v46, v50), _mm_cmpneq_ps(v50, (__m128)0LL)), v51),
           _mm_andnot_ps(v51, (__m128)xmmword_1800F6FD0));
  v52 = v58.m128_u64[1];
  v55 = sub_18003C158(v25, v12);
  if ( v55 < 0.0 )
  {
    v55 = -v55;
