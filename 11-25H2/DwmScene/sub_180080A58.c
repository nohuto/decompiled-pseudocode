/*
 * XREFs of sub_180080A58 @ 0x180080A58
 * Callers:
 *     sub_180081560 @ 0x180081560 (sub_180081560.c)
 * Callees:
...
_QWORD *__fastcall sub_180080A58(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  __int64 v8; // rax
  __int64 v9; // rcx
