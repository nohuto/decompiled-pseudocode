/*
 * XREFs of sub_180088B00 @ 0x180088B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180088B00(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __m128 v5; // xmm1
...
LABEL_23:
  if ( *(_DWORD *)(a1 + 1868) )
  {
    *(float *)(a1 + 1876) = sub_18001110C(*(float *)(a1 + 1876), *(float *)(a1 + 1820), *(float *)(a1 + 1824));
    v17 = *(float *)(a1 + 1832);
    LODWORD(v18) = sub_1800884F4(a1).m128_u32[0];
    v19 = (__m128)*(unsigned int *)(a1 + 1880);
    v19.m128_f32[0] = sub_18001110C(v19.m128_f32[0], v18, v17);
    ...
    *((float *)&v28 + 1) = v21;
    ...
    sub_180011B04(a1 + 56, &v38);
    v32 = v19.m128_u64[0];
    v33 = v26;
    sub_18003B538(v38, (__int64)&v32);
    if ( v39 )
      sub_18001050C(v39);
    sub_180011B04(a1 + 56, &v40);
    v34 = 0x3F80000000000000LL;
    v35 = 0;
    v36 = v22.m128_u64[0];
    v37 = v23;
    sub_18003A4E8(v40, &v36, (__int64)&v34);
    if ( v41 )
      sub_18001050C(v41);
  }
  return sub_1800576C8(a1);
}
