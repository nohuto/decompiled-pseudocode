...
__int64 __fastcall sub_18001BE10(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  size_t v6; // rsi
  ...
  *(_QWORD *)(a1 + 24) = 0LL;
  ...
  if ( v8 <= *(_QWORD *)(a3 + 24) - v6 && v9 <= *(_QWORD *)(a3 + 24) )
  {
    ...
    *(_BYTE *)a3 = 0;
    sub_1800137F8(a1);
    v11 = (const void *)sub_1800137F8(a4);
    v14 = v13;
LABEL_4:
    memcpy(v14, v11, v12);
    *(_QWORD *)(a1 + 16) = v10;
  ...
  if ( v6 <= v9 - v8 )
  {
    ...
    *(_BYTE *)a4 = 0;
    ...
    v11 = (const void *)sub_1800137F8(a3);
    v14 = v15;
    v12 = v6;
    goto LABEL_4;
  }
  if ( 0x7FFFFFFFFFFFFFFFLL - v6 < v8 )
    sub_180011AA0();
  v22 = sub_1800117EC(v8 + v6, 0xFuLL, 0x7FFFFFFFFFFFFFFFuLL);
  v17 = (char *)sub_180010918(v16, &v22);
  *(_QWORD *)(a1 + 24) = v22;
  *(_QWORD *)a1 = v17;
  *(_QWORD *)(a1 + 16) = v10;
  v18 = (const void *)sub_1800137F8(a3);
  memcpy(v17, v18, v6);
  v19 = (const void *)sub_1800137F8(a4);
