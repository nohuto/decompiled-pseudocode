/*
 * XREFs of sub_1800932FC @ 0x1800932FC
 * Callers:
...
__int64 __fastcall sub_1800932FC(__int64 a1, int a2, __int64 a3)
{
  unsigned int i; // ebx
  int v7; // eax
  ...
  *(_BYTE *)(a1 + 4620) = 1;
  for ( i = 0; i < 6; ++i )
  {
    v7 = *(_DWORD *)(a1 + 4616);
    if ( _bittest(&v7, i) )
      sub_1800930F0((__int64 *)(a1 + ((unsigned __int64)i << 8) + 3080), a3 + 448);
  }
  return a1;
}
