/*
 * XREFs of sub_1800BE640 @ 0x1800BE640
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_1800BE640(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // rdi
