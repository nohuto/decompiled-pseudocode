/*
 * XREFs of sub_1800B7138 @ 0x1800B7138
 * Callers:
...
int __fastcall sub_1800B7138(__int64 *a1)
{
  ...
  v7[0] = _std_type_info_hash(&qword_1801B95C8);
  v3 = *(_QWORD *)sub_18004F02C(a1, (__int64)v8, v7);
  v9[0] = &std::_Func_impl_no_alloc<_lambda_d7f4d8d432685ceaae68a7b31eb4d631_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v9[7] = v9;
  v11 = 0LL;
