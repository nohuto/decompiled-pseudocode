/*
 * XREFs of sub_1800CAA88 @ 0x1800CAA88
 * Callers:
...
_QWORD *__fastcall sub_1800CAA88(_QWORD *a1, __int64 *a2, __int64 *a3, unsigned int a4)
{
  size_t v4; // r15
  __int64 v7; // r12
  __int64 v8; // rbx
  ...
  sub_1800BB198(v7, v10);
  v11 = sub_1800B9A3C(v7, &v20);
  (*(void (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)*v11 + 376LL))(*v11, v21, *a3);
  sub_18000E854((__int64 *)&v20);
  *(_OWORD *)Src = 0LL;
  v12 = sub_1800B9A3C(v7, &v20);
