/*
 * XREFs of sub_180045324 @ 0x180045324
 * Callers:
...
__int64 __fastcall sub_180045324(_DWORD *a1, __int64 a2, char a3)
{
  __int64 result; // rax
  char v5; // bl
  BOOL v6; // r15d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    {
      v7 = 1;
      v8 = (__int64 *)sub_180045A18(a1, v22, 0LL);
      v9 = *v8;
      v19 = *v8;
      v20 = v8[1];
      *v8 = 0LL;
    ...
    {
      v7 = 0;
      v11 = (__int64 *)sub_180045A18(a1, &v21, 0LL);
      v9 = *v11;
      v18 = v11[1];
      *v11 = 0LL;
      v11[1] = 0LL;
    ...
    *v10 = 0LL;
    ...
    v26 = 0LL;
    v14 = a1[30];
    v15 = sub_180045AC0(a1, v22, 0LL);
    v16 = sub_180045A88(a1, v24, 0LL);
    result = sub_1800D3FE0(v16, v15, v14, (unsigned int)&v17, v13, v7, v6, a3, (__int64)v25);
    if ( *((_QWORD *)&v21 + 1) )
      return sub_18001050C(*((__int64 *)&v21 + 1));
  }
  return result;
}
