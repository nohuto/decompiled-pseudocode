/*
 * XREFs of sub_180069310 @ 0x180069310
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180069310(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 *v3; // rbx
  int v6; // esi
  __int64 v7; // rax
  ...
  v10 = v6;
  if ( sub_18004099C(a1 + 256, (__int64)&v10) == *(_QWORD *)(a1 + 256) )
    return 0;
  v10 = v6;
  v7 = sub_180050140(v3, (__int64)v9, &v10);
