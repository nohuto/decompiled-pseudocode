/*
 * XREFs of sub_18001F7E0 @ 0x18001F7E0
 * Callers:
 *     <none>
 * Callees:
 *     ?eq@?$_Narrow_char_traits@DH@std@@SA_NDD@Z @ 0x18001D4B8 (-eq@-$_Narrow_char_traits@DH@std@@SA_NDD@Z.c)
...
__int64 __fastcall sub_18001F7E0(__int64 a1, unsigned int a2)
{
