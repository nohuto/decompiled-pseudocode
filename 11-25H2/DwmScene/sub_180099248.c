...
__int64 __fastcall sub_180099248(__int64 a1, _QWORD *a2, __int64 a3)
{
  _QWORD *v3; // rsi
  __int64 v4; // r14
  ...
  v3 = a2;
  v4 = a1;
  sub_18000CBBC(a1, 16LL, 3LL, (__int64 (__fastcall *)(__int64))_Stl_critical_section::_Stl_critical_section);
  HIDWORD(v66) = 1;
...
LABEL_4:
    ...
    while ( 1 )
    {
      ...
      v15 = *(_DWORD *)(v83 + 120);
      sub_180011B04(v83 + 56, &v85);
      sub_18003A0D8(v85, &v73);
      v16 = v86;
      if ( v86 )
        sub_18001050C(v86);
      v17 = (__m128)LODWORD(v74);
      v17.m128_f32[0] = (float)(v74 * v73) * v75;
      v18 = _mm_and_ps(v17, (__m128)xmmword_18018C670);
      *(double *)v18.m128_u64 = o_cbrtf(v16);
      v19 = v18;
      sub_180011B04(v10 + 56, &v87);
      sub_180039F04(v87, (__int64)&v64);
      if ( v88 )
        sub_18001050C(v88);
      sub_180011B04(v10 + 56, &v89);
      sub_18003A280(v89, &v98);
      *(float *)&v61 = -v99;
      *((float *)&v61 + 1) = -v100;
      *(float *)&v62 = -v101;
      if ( v90 )
...
LABEL_23:
      ...
      if ( v15 == 1 )
      {
        ...
        o_cosf();
        o_log2f();
        v30 = _mm_xor_ps((__m128)0x3C23D70Au, (__m128)xmmword_18018C680);
...
LABEL_25:
      ...
      *((float *)v38 + 3) = v19.m128_f32[0] * v14.m128_f32[0];
      if ( v6 < 3 )
      {
        if ( !*(v8 - 1) )
        {
          sub_180011B04(v10 + 56, &v91);
          v39 = sub_18005D4CC(v91, &v93);
          v40 = *v39;
          v41 = v39[1];
          *v39 = 0LL;
          v39[1] = 0LL;
        ...
        if ( v43 )
        {
          if ( *(_BYTE *)(v10 + 124) )
          {
            v45 = (__m128 *)sub_1800573FC(v43, 0, 2);
            v97[0] = *v45;
            v97[1] = v45[1];
            v97[2] = v45[2];
            v97[3] = v45[3];
            sub_180058E38(v97, (__m128 *)(v7 + *(_QWORD *)(a3 + 64)));
          }
          else
          {
            v46 = (_OWORD *)sub_180038AEC(
                              (__int64)v102,
                              (int *)&xmmword_1800F7670,
                              &xmmword_1800F7670,
                              &xmmword_1800F7670,
                              &xmmword_1800F7670);
            v47 = *(_QWORD *)(a3 + 64);
