/*
 * XREFs of sub_1800595F0 @ 0x1800595F0
 * Callers:
...
char __fastcall sub_1800595F0(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // rcx
  float v4; // xmm1_4
  ...
  if ( (*(_BYTE *)(a1 + 544) & 4) != 0 && !sub_180057614(a1, 4) )
  {
    v2 = *sub_180040728(a1, &v32);
    if ( v33 )
      sub_18001050C(v33);
    if ( !v2 )
      goto LABEL_15;
...
LABEL_11:
        ...
        *(float *)(a1 + 1588) = v13;
        ...
        v20 = 0LL;
        v14.m128_u64[0] = _mm_mul_ps(_mm_movelh_ps(v14, v19), (__m128)xmmword_18018C560).m128_u64[0];
        v20.m128_u64[0] = v17.m128_u64[0];
        LODWORD(v33) = *(_DWORD *)(a1 + 392);
        LODWORD(v31) = _mm_shuffle_ps(v17, v17, 170).m128_u32[0];
        v20.m128_u64[0] = _mm_mul_ps(_mm_movelh_ps(v20, (__m128)(unsigned int)v31), (__m128)xmmword_18018C560).m128_u64[0];
        v19.m128_f32[0] = *(float *)(a1 + 396) - *(float *)&v33;
        v32 = v14.m128_u64[0];
        v29 = v20.m128_i32[0];
        LODWORD(v31) = v19.m128_i32[0];
        v30 = v20.m128_f32[1] * -1.0;
        sub_180039A10((__int64)v36, &v32);
        v21 = (__int128 *)sub_1800399A0((__int64)v37, (unsigned int *)&v29);
        sub_180017768((__int64)v34, v21, v22);
        sub_18001832C(v34, (__int64)v35);
        v23 = v34[1];
...
LABEL_15:
      ...
      v4 = (float)(int)sub_1800574F0(*(_QWORD *)(a1 + 152));
      *(float *)(a1 + 1596) = v4;
      v6 = (float)(int)sub_180057394(v5);
    }
    *(float *)(a1 + 1600) = v6;
    *(float *)(a1 + 1608) = v6;
    *(float *)(a1 + 1604) = v4;
