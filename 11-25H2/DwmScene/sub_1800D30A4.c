/*
 * XREFs of sub_1800D30A4 @ 0x1800D30A4
 * Callers:
...
__int64 __fastcall sub_1800D30A4(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  while ( (unsigned int)v15 < v18 )
  {
    ...
    if ( v19 >= a2 || v20 >= a2 || v21 >= a2 )
    {
      ...
      sub_1800D32D0(pExceptionObject, v28);
    ...
    v22 = v14 && (v15 & 1) != 0;
    sub_1800D44E8(a1, v12, v19, v20, v21, v22, a9, a10);
    result = sub_1800D36F4(v23, v24, v20, v21, v22, a8);
