/*
 * XREFs of sub_18000D0E4 @ 0x18000D0E4
 * Callers:
...
__int64 __fastcall sub_18000D0E4(int a1, int a2, int a3, __int64 a4, int a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  ...
  result = sub_18000E884(a1, a2, a3, 0, 0LL, a6, 1, a7, 0LL, v11, OutputString, v12, (__int64)v15, v13, (__int64)v14);
  if ( (v14[4] & 1) != 0 )
    sub_18000FA2C(v14);
  return result;
}
