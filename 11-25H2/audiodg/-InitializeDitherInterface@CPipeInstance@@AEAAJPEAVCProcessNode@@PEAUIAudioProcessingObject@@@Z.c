/*
 * XREFs of ?InitializeDitherInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x140003A44
 * Callers:
        ...
        struct IAudioProcessingObject *a3)
{
  ...
  else
  {
    ...
    if ( v4 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 43LL, &WPP_ece7ed133f5c32246e9f73031954d020_Traceguids);
      }
      AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeDitherInterface", 0xD6Bu, v4);
    }
  }
  if ( v6 )
