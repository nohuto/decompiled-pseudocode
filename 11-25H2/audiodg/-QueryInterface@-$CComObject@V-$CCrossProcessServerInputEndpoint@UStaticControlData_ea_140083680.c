/*
 * XREFs of ?QueryInterface@?$CComObject@V?$CCrossProcessServerInputEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@@ATL@@WBOA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x140083680
 * Callers:
 *     <none>
 * Callees:
 *     <none>
