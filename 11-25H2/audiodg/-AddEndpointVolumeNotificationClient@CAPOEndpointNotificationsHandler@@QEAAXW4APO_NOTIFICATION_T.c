/*
 * XREFs of ?AddEndpointVolumeNotificationClient@CAPOEndpointNotificationsHandler@@QEAAXW4APO_NOTIFICATION_TYPE@@PEAVCAPOProcessingHostObject@@@Z @ 0x140017178
 * Callers:
...
void __fastcall CAPOEndpointNotificationsHandler::AddEndpointVolumeNotificationClient(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( a2 != 1 )
    v7 = a1 + 160;
  CAPOEndpointNotificationsHandler::AddEndpointVolumeNotificationClient(a1, v7, a3);
  if ( v6 )
