/*
 * XREFs of ?WriteToRenderEndpoint@CBridgeToRenderGraph@@AEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x1400350B0
 * Callers:
 *     ?OnAudioPacket@CBridgeToRenderGraph@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x140035040 (-OnAudioPacket@CBridgeToRenderGraph@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@.c)
