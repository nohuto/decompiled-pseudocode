        ...
        __int64 a3)
{
  ...
  v5 = (void *)_o__recalloc(SadMap, dword_1400C47D8 + 1, 8LL);
  if ( !v5 )
    return 0LL;
  SadMap = v5;
  v6 = (void *)_o__recalloc(Block, dword_1400C47D8 + 1, 8LL);
  if ( !v6 )
    return 0LL;
  Block = v6;
