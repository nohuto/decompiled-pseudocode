/*
 * XREFs of ?InitializeCPMemory@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAUICrossProcessMemoryManager@@PEAUtWAVEFORMATEX@@PEBGIIIIIPEAPEAUICrossProcessMemory@@@Z @ 0x14008EADC
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x14000F0E0 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
