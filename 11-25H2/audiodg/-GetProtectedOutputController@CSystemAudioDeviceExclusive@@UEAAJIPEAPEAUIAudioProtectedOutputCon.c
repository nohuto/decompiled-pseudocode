/*
 * XREFs of ?GetProtectedOutputController@CSystemAudioDeviceExclusive@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x140071080
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProtectedOutputController **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceExclusive::GetProtectedOutputController", 229, v7);
  }
  else
  {
