/*
 * XREFs of ??$make_wnf_subscription_state@UWNF_AUDIO_ORIENTATION_STATE@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBUWNF_AUDIO_ORIENTATION_STATE@@@Z@wistd@@KPEAPEAU?$wnf_subscription_state@UWNF_AUDIO_ORIENTATION_STATE@@@01@@Z @ 0x14005BD50
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  v6[1] = 0LL;
  *v6 = &wil::details::wnf_subscription_state<WNF_AUDIO_ORIENTATION_STATE>::`vftable';
  if ( *(_QWORD *)(a2 + 112) )
  {
    v6[16] = v6 + 3;
...
LABEL_11:
    ...
    v9 = wil::details::in1diag3::Return_NtStatus(retaddr, v11, v12, (const char *)(unsigned int)v10, (int)v7);
    goto LABEL_9;
  }
  wil::details::in1diag3::Return_Hr(
    retaddr,
