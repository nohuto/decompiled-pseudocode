/*
 * XREFs of ?GetMicBoostNotificationHandler@CAPOProcessingHost@@AEAAJPEAUIMMDevice@@PEAPEAVCMicBoostNotificationsHandler@@@Z @ 0x14006230C
 * Callers:
 ...
 *     ??$MakeAndInitialize@VCMicBoostNotificationsHandler@@V1@AEAPEAUIMMDevice@@@Details@WRL@Microsoft@@YAJPEAPEAVCMicBoostNotificationsHandler@@AEAPEAUIMMDevice@@@Z @ 0x1400610A8 (--$MakeAndInitialize@VCMicBoostNotificationsHandler@@V1@AEAPEAUIMMDevice@@@Details@WRL@Microsoft.c)
        ...
        struct CMicBoostNotificationsHandler **a3)
{
  ...
  __int64 v14; // rbx
  int v15; // ebx
  struct CMicBoostNotificationsHandler *v16; // rcx
  struct IMMDevice *v17; // [rsp+20h] [rbp-68h] BYREF
  struct _RTL_CRITICAL_SECTION *v18; // [rsp+28h] [rbp-60h] BYREF
  struct IMMDevice *v19; // [rsp+30h] [rbp-58h] BYREF
  unsigned __int8 *v20[2]; // [rsp+38h] [rbp-50h] BYREF
  unsigned __int8 *v21[4]; // [rsp+48h] [rbp-40h] BYREF
  ...
  wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
    (void **)&v17,
    0LL);
  v8 = ((__int64 (__fastcall *)(struct IMMDevice *, struct IMMDevice **))GetId)(a2, &v17);
  v9 = v8;
  if ( v8 < 0 )
  {
  ...
  {
    v15 = Microsoft::WRL::Details::MakeAndInitialize<CMicBoostNotificationsHandler,CMicBoostNotificationsHandler,IMMDevice * &>(
            a3,
            &v19);
    if ( v15 < 0 )
    {
  ...
  {
    v16 = *(struct CMicBoostNotificationsHandler **)(v14 + 48);
    if ( v16 )
    {
      *a3 = v16;
      (*(void (__fastcall **)(struct CMicBoostNotificationsHandler *))(*(_QWORD *)v16 + 8LL))(v16);
    }
    else
    {
      *a3 = 0LL;
