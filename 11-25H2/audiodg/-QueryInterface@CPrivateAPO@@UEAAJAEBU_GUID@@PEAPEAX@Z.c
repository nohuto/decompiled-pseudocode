/*
 * XREFs of ?QueryInterface@CPrivateAPO@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002CC40
 * Callers:
 *     ?QueryInterface@CPrivateAPO@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14006B950 (-QueryInterface@CPrivateAPO@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
