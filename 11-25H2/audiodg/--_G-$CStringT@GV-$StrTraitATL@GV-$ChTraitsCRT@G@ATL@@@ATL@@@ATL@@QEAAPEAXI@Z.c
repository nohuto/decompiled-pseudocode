/*
 * XREFs of ??_G?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAPEAXI@Z @ 0x14002A31C
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__SadMap__ @ 0x140097560 (_dynamic_atexit_destructor_for__SadMap__.c)
 * Callees:
