/*
 * XREFs of ??1?$CTempBuffer@E$0BAA@VCCRTAllocator@ATL@@@ATL@@QEAA@XZ @ 0x14008956C
 * Callers:
 ...
 *     _ATL::CRegParser::AddValue_::_1_::dtor$2 @ 0x1400972B5 (_ATL--CRegParser--AddValue_--_1_--dtor$2.c)
 *     _ATL::CRegObject::RegisterFromResource_::_1_::dtor$1 @ 0x14009737B (_ATL--CRegObject--RegisterFromResource_--_1_--dtor$1.c)
 * Callees:
