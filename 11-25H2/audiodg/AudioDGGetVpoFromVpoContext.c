/*
 * XREFs of AudioDGGetVpoFromVpoContext @ 0x1400765B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindKey@?$CSimpleMap@KPEAVCVpoContext@@V?$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@QEBAHAEBK@Z @ 0x140076158 (-FindKey@-$CSimpleMap@KPEAVCVpoContext@@V-$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@Q.c)
...
__int64 __fastcall AudioDGGetVpoFromVpoContext(__int64 a1, int a2, __int64 a3, unsigned int a4, __int64 *a5)
{
  ...
  {
    if ( Key < 0 || Key >= dword_1400C4840 )
    {
      ATL::_AtlRaiseException(0xC000008C);
      JUMPOUT(0x140076796LL);
    }
    v9 = *((_QWORD *)qword_1400C4838 + Key);
  }
