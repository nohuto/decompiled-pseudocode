/*
 * XREFs of ?GetDeviceGraphObjectCacheManager@@YAJPEAPEAUIDeviceGraphObjectCacheManager@@@Z @ 0x140005A6C
 * Callers:
...
__int64 __fastcall GetDeviceGraphObjectCacheManager(struct IDeviceGraphObjectCacheManager **a1)
{
  ...
  *a1 = 0LL;
  if ( dword_1400C5840 > *(_DWORD *)(*(_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + 4LL) )
  {
    Init_thread_header(&dword_1400C5840);
    if ( dword_1400C5840 == -1 )
    {
      ...
      *v5 = 0LL;
      ...
      Init_thread_footer(&dword_1400C5840);
    }
  }
  if ( qword_1400C5838 )
  {
    v2 = (**(__int64 (__fastcall ***)(__int64, GUID *, struct IDeviceGraphObjectCacheManager **))qword_1400C5838)(
           qword_1400C5838,
