/*
 * XREFs of pre_c_initialization @ 0x140058B40
 * Callers:
 *     <none>
 * Callees:
 *     __scrt_initialize_onexit_tables @ 0x140058FC4 (__scrt_initialize_onexit_tables.c)
 *     atexit @ 0x140059194 (atexit.c)
 *     _get_startup_argv_mode @ 0x140059650 (_get_startup_argv_mode.c)
 *     __scrt_initialize_winrt @ 0x14005965C (__scrt_initialize_winrt.c)
 *     _get_startup_file_mode @ 0x140059668 (_get_startup_file_mode.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x140059674 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_stub_for_acrt_uninitialize @ 0x140059688 (__scrt_stub_for_acrt_uninitialize.c)
 *     _guard_check_icall_nop @ 0x1400596A0 (_guard_check_icall_nop.c)
 *     __scrt_fastfail @ 0x140059700 (__scrt_fastfail.c)
 *     __scrt_initialize_mta @ 0x1400598A8 (__scrt_initialize_mta.c)
 *     _RTC_Initialize @ 0x140059984 (_RTC_Initialize.c)
 *     __p__commode @ 0x14005A02A (__p__commode.c)
 *     _configthreadlocale @ 0x14005A08A (_configthreadlocale.c)
 *     _o__configure_wide_argv_0 @ 0x14005A096 (_o__configure_wide_argv_0.c)
 *     _o__initialize_wide_environment_0 @ 0x14005A0D2 (_o__initialize_wide_environment_0.c)
 *     _set_app_type @ 0x14005A114 (_set_app_type.c)
 *     _o__set_fmode_0 @ 0x14005A120 (_o__set_fmode_0.c)
 */
