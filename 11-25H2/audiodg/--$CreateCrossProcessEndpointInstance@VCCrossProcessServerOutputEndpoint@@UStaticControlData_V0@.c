/*
 * XREFs of ??$CreateCrossProcessEndpointInstance@VCCrossProcessServerOutputEndpoint@@UStaticControlData_V0@@UVolatileControlData_V0@@UControlData_V0@@@@YAJU_GUID@@AEBU0@PEAPEAX@Z @ 0x140082400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateCrossProcessEndpointInstance<CCrossProcessServerOutputEndpoint,StaticControlData_V0,VolatileControlData_V0,ControlData_V0>(
        _OWORD *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  v16 = v8;
  if ( v8 )
    v9 = (_OWORD *)ATL::CComObject<CCrossProcessServerOutputEndpoint<StaticControlData_V0,VolatileControlData_V0,ControlData_V0>>::CComObject<CCrossProcessServerOutputEndpoint<StaticControlData_V0,VolatileControlData_V0,ControlData_V0>>(v8);
  else
    v9 = 0LL;
  v16 = v9;
  if ( !v9 )
