/*
 * XREFs of ??0CAPOEndpointNotificationsHandler@@QEAA@XZ @ 0x14003FE5C
 * Callers:
 *     ??$MakeAndInitialize@VCAPOEndpointNotificationsHandler@@V1@AEAPEAUIMMDevice@@@Details@WRL@Microsoft@@YAJPEAPEAVCAPOEndpointNotificationsHandler@@AEAPEAUIMMDevice@@@Z @ 0x14003FDB8 (--$MakeAndInitialize@VCAPOEndpointNotificationsHandler@@V1@AEAPEAUIMMDevice@@@Details@WRL@Micros.c)
 * Callees:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIAudioEndpointVolumeInternalCallback@@@WRL@Microsoft@@QEAA@XZ @ 0x140057FF8 (--0-$RuntimeClass@U-$RuntimeClassFlags@$02@WRL@Microsoft@@UIAudioEndpointVolumeInternalCallback@.c)
 */
