/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x14005E688
 * Callers:
...
__int64 __fastcall wil::details_abi::SemaphoreValue::TryGetPointer(char *a1, void **a2, __int64 a3, bool *a4)
{
  ...
  *a2 = 0LL;
  ...
  else
  {
    ...
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6D, (int)"wil", (const char *)v6);
    return v6;
  }
}
