/*
 * XREFs of ??$Make@VCDeviceOrientationNotificationsHandler@@$$V@Details@WRL@Microsoft@@YA?AV?$ComPtr@VCDeviceOrientationNotificationsHandler@@@12@XZ @ 0x140060F5C
 * Callers:
 ...
 *     ??0CDeviceOrientationNotificationsHandler@@QEAA@XZ @ 0x140061840 (--0CDeviceOrientationNotificationsHandler@@QEAA@XZ.c)
