/*
 * XREFs of ??1?$ComPtr@VCDeviceGraphObjectCache@@@WRL@Microsoft@@QEAA@XZ @ 0x14001C6A4
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_CDeviceGraphObjectCache_CDeviceGraphObjectCache___int64_&_float_&_unsigned_int_&__tlgProvider_t_const___&__::_1_::dtor$1 @ 0x140093216 (_Microsoft--WRL--Details--MakeAndInitialize_CDeviceGraphObjectCache_CDeviceGraphObj_ea_140093216.c)
 * Callees:
