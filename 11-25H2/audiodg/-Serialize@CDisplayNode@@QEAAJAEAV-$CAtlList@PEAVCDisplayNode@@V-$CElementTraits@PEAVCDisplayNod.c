/*
 * XREFs of ?Serialize@CDisplayNode@@QEAAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAPEAEAEAI@Z @ 0x14006AF1C
 * Callers:
 ...
 *     ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x14006A27C (-GetDisplayName@CDisplayNode@@QEAAPEBDXZ.c)
