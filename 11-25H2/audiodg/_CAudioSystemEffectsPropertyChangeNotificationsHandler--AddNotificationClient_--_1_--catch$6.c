/*
 * XREFs of _CAudioSystemEffectsPropertyChangeNotificationsHandler::AddNotificationClient_::_1_::catch$6 @ 0x140092F9C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSystemEffectsPropertyChangeNotificationsHandler::AddNotificationClient_::_1_::catch_6(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
