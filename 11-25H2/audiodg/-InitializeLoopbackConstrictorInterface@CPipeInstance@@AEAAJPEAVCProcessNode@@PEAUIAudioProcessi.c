/*
 * XREFs of ?InitializeLoopbackConstrictorInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x140004284
 * Callers:
...
__int64 __fastcall CPipeInstance::InitializeLoopbackConstrictorInterface(
        ...
        struct IAudioProcessingObject *a3)
{
        ...
        v6 >= 0) )
  {
    if ( this[22] != v8 )
    {
      ATL::AtlComPtrAssign(this + 22, v8);
      v5 = v8;
    }
  }
  else
