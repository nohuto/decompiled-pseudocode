/*
 * XREFs of ?LogSetGrantedCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_J@Z @ 0x14008D454
 * Callers:
 *     ?SetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJI_J@Z @ 0x14008F3E0 (-SetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJI_J@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (unsigned int)dword_1400C34B0 > 5 )
  {
    ...
    v9 = 4LL;
    v7 = 16LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1400C34B0, byte_1400B13E7, 0LL, 0LL, 5u, &v5);
  }
}
