/*
 * XREFs of ??$insert@PEBE$0A@@?$vector@EV?$allocator@E@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@E@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@E@std@@@std@@@1@PEBE1@Z @ 0x140056B20
 * Callers:
        ...
        __int64 a5)
{
  ...
  v5 = a3 - *a1;
  std::vector<unsigned char>::_Insert_counted_range<unsigned char const *>(a1, a3, a4, a5 - a4);
  result = a2;
  *a2 = v5 + *a1;
  return result;
}
