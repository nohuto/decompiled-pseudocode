/*
 * XREFs of ?WorkCallback@CSerialWorkQueue@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WORK@@@Z @ 0x140008330
 * Callers:
 *     <none>
 * Callees:
 *     ??_G_WorkTask@@QEAAPEAXI@Z @ 0x140008410 (--_G_WorkTask@@QEAAPEAXI@Z.c)
 *     ?load@?$_Atomic_storage@_N$00@std@@QEBA_NW4memory_order@2@@Z @ 0x140063930 (-load@-$_Atomic_storage@_N$00@std@@QEBA_NW4memory_order@2@@Z.c)
