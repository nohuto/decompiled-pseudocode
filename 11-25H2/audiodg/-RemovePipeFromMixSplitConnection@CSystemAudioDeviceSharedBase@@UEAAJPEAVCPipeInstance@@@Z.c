/*
 * XREFs of ?RemovePipeFromMixSplitConnection@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x14003B990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceSharedBase::RemovePipeFromMixSplitConnection(
        ...
        struct CPipeInstance *a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(__int64, struct CPipeInstance *))(*(_QWORD *)v5 + 72LL))(v5, a2);
    v5 = v8;
  }
  else
  {
