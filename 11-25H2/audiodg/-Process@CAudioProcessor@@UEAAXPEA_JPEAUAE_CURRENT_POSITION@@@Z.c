/*
 * XREFs of ?Process@CAudioProcessor@@UEAAXPEA_JPEAUAE_CURRENT_POSITION@@@Z @ 0x14000F5F0
 * Callers:
 *     <none>
 * Callees:
 *     ??1?$CComPtrBase@UIAudioEndpointLastBufferControl@@@ATL@@QEAA@XZ @ 0x14000FD90 (--1-$CComPtrBase@UIAudioEndpointLastBufferControl@@@ATL@@QEAA@XZ.c)
