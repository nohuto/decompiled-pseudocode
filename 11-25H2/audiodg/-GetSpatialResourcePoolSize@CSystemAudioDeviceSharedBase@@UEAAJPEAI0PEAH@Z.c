/*
 * XREFs of ?GetSpatialResourcePoolSize@CSystemAudioDeviceSharedBase@@UEAAJPEAI0PEAH@Z @ 0x140074560
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  LODWORD(v5) = (*(__int64 (__fastcall **)(_QWORD, unsigned int *, unsigned int *, int *))(**((_QWORD **)v5 + 23) + 120LL))(
                  *((_QWORD *)v5 + 23),
                  a2,
                  a3,
                  a4);
