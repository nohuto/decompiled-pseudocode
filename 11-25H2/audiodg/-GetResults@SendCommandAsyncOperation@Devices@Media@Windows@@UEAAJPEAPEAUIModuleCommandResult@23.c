/*
 * XREFs of ?GetResults@SendCommandAsyncOperation@Devices@Media@Windows@@UEAAJPEAPEAUIModuleCommandResult@234@@Z @ 0x14007BBB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Media::Devices::IModuleCommandResult **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    if ( v8 == 1 && (v6 = (struct Windows::Media::Devices::IModuleCommandResult *)*((_QWORD *)this + 21)) != 0LL )
    {
      *a2 = v6;
