/*
 * XREFs of _CDeviceOrientationNotificationsHandler::AddNotificationClient_::_1_::catch$6 @ 0x140095810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceOrientationNotificationsHandler::AddNotificationClient_::_1_::catch_6(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
