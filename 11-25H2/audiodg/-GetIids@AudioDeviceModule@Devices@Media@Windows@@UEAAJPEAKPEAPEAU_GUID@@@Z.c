/*
 * XREFs of ?GetIids@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x14007B5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Media::Devices::AudioDeviceModule::GetIids(
        ...
        struct _GUID **a3)
{
  ...
  *a2 = 0;
  ...
  {
    v10 = 0;
    Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,0,Windows::Media::Devices::IAudioDeviceModule,IWeakReferenceSource,Microsoft::WRL::FtmBase>::FillArrayWithIid(
      v6,
      &v10,
      (__int64)v7);
    *a2 = 2;
