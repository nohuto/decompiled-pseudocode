/*
 * XREFs of ?DisconnectFromRightSubmix@CStreamInstance@@UEAAJPEAUISubmixInternal@@@Z @ 0x14003A2A0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x14000ABF4 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?OnDisconnectedFromRightSubmix@CPipeInstance@@QEAAX_J@Z @ 0x14003A394 (-OnDisconnectedFromRightSubmix@CPipeInstance@@QEAAX_J@Z.c)
