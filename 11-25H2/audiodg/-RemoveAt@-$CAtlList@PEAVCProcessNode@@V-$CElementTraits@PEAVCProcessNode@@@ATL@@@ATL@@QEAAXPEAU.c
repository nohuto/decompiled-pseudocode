/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCProcessNode@@V?$CElementTraits@PEAVCProcessNode@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x14000FE74
 * Callers:
 *     ?RemoveDummyProcessNodes@CPipeInstance@@AEAAXXZ @ 0x1400104A0 (-RemoveDummyProcessNodes@CPipeInstance@@AEAAXXZ.c)
