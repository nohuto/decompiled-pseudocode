/*
 * XREFs of ??$MakeAndInitialize@VCAPOEnvironmentStateChangedNotificationsHandler@@V1@AEAPEBG@Details@WRL@Microsoft@@YAJPEAPEAVCAPOEnvironmentStateChangedNotificationsHandler@@AEAPEBG@Z @ 0x140060FE0
 * Callers:
 ...
 *     ??0CAPOEnvironmentStateChangedNotificationsHandler@@QEAA@XZ @ 0x140061794 (--0CAPOEnvironmentStateChangedNotificationsHandler@@QEAA@XZ.c)
