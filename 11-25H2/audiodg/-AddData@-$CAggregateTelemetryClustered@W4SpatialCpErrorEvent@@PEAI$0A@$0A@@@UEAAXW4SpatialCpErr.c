/*
 * XREFs of ?AddData@?$CAggregateTelemetryClustered@W4SpatialCpErrorEvent@@PEAI$0A@$0A@@@UEAAXW4SpatialCpErrorEvent@@PEAI@Z @ 0x14008D100
 * Callers:
 *     <none>
 * Callees:
 *     ?AddData@?$CAggregateTelemetry@V?$CAggregateValuesClusteredBase@W4SpatialCpErrorEvent@@PEAI@@W4SpatialCpErrorEvent@@PEAI$0A@$0A@@@UEAAXW4SpatialCpErrorEvent@@PEAI@Z @ 0x14008D0C0 (-AddData@-$CAggregateTelemetry@V-$CAggregateValuesClusteredBase@W4SpatialCpErrorEvent@@PEAI@@W4S.c)
