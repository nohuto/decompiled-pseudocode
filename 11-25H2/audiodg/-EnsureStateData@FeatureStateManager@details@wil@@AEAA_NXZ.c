/*
 * XREFs of ?EnsureStateData@FeatureStateManager@details@wil@@AEAA_NXZ @ 0x14007A55C
 * Callers:
  ...
  if ( !this[3].Ptr )
  {
    ...
    else
    {
      if ( !this[2].Ptr )
      {
        ...
        v6 = 0LL;
        if ( wil::details_abi::ProcessLocalStorageData<wil::details_abi::FeatureStateData>::Acquire(Ptr, (void **)&v6) >= 0
          && !this[2].Ptr )
        {
          this[2].Ptr = v6;
        }
