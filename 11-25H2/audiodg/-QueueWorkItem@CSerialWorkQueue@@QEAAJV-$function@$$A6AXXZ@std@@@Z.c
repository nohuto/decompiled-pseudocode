/*
 * XREFs of ?QueueWorkItem@CSerialWorkQueue@@QEAAJV?$function@$$A6AXXZ@std@@@Z @ 0x1400085B8
 * Callers:
 ...
 *     ?Initialize@CSerialWorkQueue@@AEAAJXZ @ 0x1400087A0 (-Initialize@CSerialWorkQueue@@AEAAJXZ.c)
 *     ??0?$function@$$A6AXXZ@std@@QEAA@AEBV01@@Z @ 0x1400088B8 (--0-$function@$$A6AXXZ@std@@QEAA@AEBV01@@Z.c)
