/*
 * XREFs of ??$MakeAndInitialize@VCAPOServiceProvider@@UIServiceProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIServiceProvider@@@Z @ 0x140037510
 * Callers:
 ...
 * Callees:
 *     ??0CAPOServiceProvider@@QEAA@XZ @ 0x1400375CC (--0CAPOServiceProvider@@QEAA@XZ.c)
