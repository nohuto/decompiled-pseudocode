/*
 * XREFs of ?CreateStreamInstance@CStreamInstance@@SAJPEAPEAUIStreamInstanceInternal@@_JKW4SYSTEM_AUDIO_STREAM_TYPE@@_KPEAVCPipeInstance@@11U_GUID@@@Z @ 0x14006E3D8
 * Callers:
 ...
 *     ?CreateInstance@?$CComCreator@V?$CComObject@VCStreamInstance@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14003AE64 (-CreateInstance@-$CComCreator@V-$CComObject@VCStreamInstance@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAP.c)
