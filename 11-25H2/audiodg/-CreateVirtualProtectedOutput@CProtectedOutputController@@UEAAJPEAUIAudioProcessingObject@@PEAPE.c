/*
 * XREFs of ?CreateVirtualProtectedOutput@CProtectedOutputController@@UEAAJPEAUIAudioProcessingObject@@PEAPEAUIAudioVirtualProtectedOutput@@@Z @ 0x14006CEA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CVirtualProtectedOutput@@QEAA@PEAVCProtectedOutputController@@@Z @ 0x14006CD80 (--0CVirtualProtectedOutput@@QEAA@PEAVCProtectedOutputController@@@Z.c)
