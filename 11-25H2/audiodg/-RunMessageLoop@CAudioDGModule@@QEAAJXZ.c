/*
 * XREFs of ?RunMessageLoop@CAudioDGModule@@QEAAJXZ @ 0x140049200
 * Callers:
...
__int64 __fastcall CAudioDGModule::RunMessageLoop(HANDLE *this, __int64 a2)
{
  ...
  if ( qword_1400C3C68 || dword_1400C47D8 > 0 )
  {
    MicrosoftTelemetryAssertTriggeredArgs("AudioDg.exe", qword_1400C3C68, (unsigned int)dword_1400C47D8);
