/*
 * XREFs of ?RuntimeClassInitialize@?$CCPAudioHistoryControl@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@QEAAJPEAUICrossProcessMemory@@@Z @ 0x140081D74
 * Callers:
