/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCAudioPump@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140041C4C
 * Callers:
 ...
 *     ??0CAudioPump@@QEAA@XZ @ 0x140057810 (--0CAudioPump@@QEAA@XZ.c)
