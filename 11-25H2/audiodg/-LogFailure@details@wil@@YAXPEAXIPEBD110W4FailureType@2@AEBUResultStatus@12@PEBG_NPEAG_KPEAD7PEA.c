/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x140042A44
 * Callers:
 ...
 * Callees:
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x140042DE4 (-RecordReturn@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x14004E7E4 (-RecordLog@details@wil@@YAHJ@Z.c)
 *     ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x14005CF24 (-GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z.c)
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x14005DA58 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x14005DA80 (-RecordFailFast@details@wil@@YAHJ@Z.c)
        ...
        unsigned __int64 a15)
{
  ...
  *(_DWORD *)(a15 + 12) = a8[1];
  ...
  if ( a7 )
  {
    ...
    {
      case 1:
        v25 = wil::details::RecordReturn((wil::details *)v17, a2);
        break;
      case 2:
        if ( (v17 & 0x80000000) == 0 )
        {
        ...
        v25 = wil::details::RecordLog((wil::details *)v17, a2);
        break;
      case 3:
        v25 = wil::details::RecordFailFast((wil::details *)v17, a2);
        break;
      default:
        goto LABEL_5;
    }
  ...
  {
    v25 = wil::details::RecordException((wil::details *)v17, a2);
  }
  v18 = v25;
LABEL_5:
  *(_DWORD *)a15 = a7;
  ...
  *(_QWORD *)(a15 + 128) = ModuleName;
  ...
  if ( *(int *)(a15 + 8) >= 0 )
  {
    ...
    *(_DWORD *)(a15 + 12) = wil::details::HrToNtStatus((wil::details *)0x8000FFFFLL, v20);
  }
    ...
    && (*(_BYTE *)(a15 + 4) & 2) == 0 )
  {
    ...
    if ( !*(_WORD *)lpOutputString )
      wil::GetFailureLogString(lpOutputString, (unsigned __int16 *)0x800, a15, v22);
