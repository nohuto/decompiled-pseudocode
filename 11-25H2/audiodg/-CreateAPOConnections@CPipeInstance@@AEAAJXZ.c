/*
 * XREFs of ?CreateAPOConnections@CPipeInstance@@AEAAJXZ @ 0x14002EE28
 * Callers:
 ...
 *     ?CanDoInPlace@CConnectionInstance@@QEAAHPEAV1@@Z @ 0x14002EFF4 (-CanDoInPlace@CConnectionInstance@@QEAAHPEAV1@@Z.c)
