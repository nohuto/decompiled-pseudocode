/*
 * XREFs of ?ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z @ 0x14001D338
 * Callers:
 ...
 *     ?ValidateInheritedHandle@CAudioDGModule@@QEAA_NPEAX@Z @ 0x1400589EC (-ValidateInheritedHandle@CAudioDGModule@@QEAA_NPEAX@Z.c)
 */
