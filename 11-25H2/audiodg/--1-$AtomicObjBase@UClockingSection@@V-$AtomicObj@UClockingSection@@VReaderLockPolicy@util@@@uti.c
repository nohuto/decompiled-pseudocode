/*
 * XREFs of ??1?$AtomicObjBase@UClockingSection@@V?$AtomicObj@UClockingSection@@VReaderLockPolicy@util@@@util@@VAtomicObjState@3@VReaderLockPolicy@3@$$V@util@@UEAA@XZ @ 0x14008DFB4
 * Callers:
 ...
 * Callees:
 *     ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x140038680 (-_Decwref@_Ref_count_base@std@@QEAAXXZ.c)
