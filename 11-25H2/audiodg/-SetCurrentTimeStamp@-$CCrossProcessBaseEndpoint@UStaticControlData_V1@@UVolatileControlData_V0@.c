/*
 * XREFs of ?SetCurrentTimeStamp@?$CCrossProcessBaseEndpoint@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x1400520A0
 * Callers:
 *     <none>
 * Callees:
