/*
 * XREFs of ?QueryInterface@CAPOServiceProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140036DD0
 * Callers:
 *     ?QueryInterface@CAPOServiceProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x140063880 (-QueryInterface@CAPOServiceProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CAPOServiceProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x140063890 (-QueryInterface@CAPOServiceProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
