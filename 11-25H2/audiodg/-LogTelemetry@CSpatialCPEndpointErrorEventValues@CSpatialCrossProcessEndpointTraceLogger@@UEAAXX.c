/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointErrorEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14008D630
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *v6 > 3u )
      {
        if ( tlgKeywordOn((__int64)v6, 0x200000000000LL) )
        {
          ...
          v27 = 8;
          v24 = 16;
          tlgWriteTransfer_EventWriteTransfer(v7, byte_1400B1237, 0LL, 0LL, 8u, &v22);
        }
      }
    }
