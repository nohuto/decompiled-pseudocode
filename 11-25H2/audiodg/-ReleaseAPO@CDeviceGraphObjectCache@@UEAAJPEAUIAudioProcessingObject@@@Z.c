/*
 * XREFs of ?ReleaseAPO@CDeviceGraphObjectCache@@UEAAJPEAUIAudioProcessingObject@@@Z @ 0x140005DC0
 * Callers:
 ...
 *     ?CommitAttachCount@CConnectionNode@@QEAAXXZ @ 0x14003835C (-CommitAttachCount@CConnectionNode@@QEAAXXZ.c)
