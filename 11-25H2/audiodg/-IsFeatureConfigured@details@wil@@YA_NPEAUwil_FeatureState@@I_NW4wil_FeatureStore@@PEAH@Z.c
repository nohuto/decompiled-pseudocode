/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x14007C98C
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x140080230 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 * Callees:
    ...
    if ( !v17 && (v13 & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v11
        ...
        || (v15[1] = 0,
            v15[0] = 0,
            v16 = v7,
            !wil::details_abi::heap_buffer::push_back((void **)&unk_1400C3CE0, v15, 0x10uLL)) )
      {
