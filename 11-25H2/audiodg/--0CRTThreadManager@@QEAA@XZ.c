/*
 * XREFs of ??0CRTThreadManager@@QEAA@XZ @ 0x14004A0B0
 * Callers:
 *     ??$MakeAndInitialize@VCRTThreadManager@@V1@AEAH@Details@WRL@Microsoft@@YAJPEAPEAVCRTThreadManager@@AEAH@Z @ 0x140055398 (--$MakeAndInitialize@VCRTThreadManager@@V1@AEAH@Details@WRL@Microsoft@@YAJPEAPEAVCRTThreadManage.c)
 * Callees:
