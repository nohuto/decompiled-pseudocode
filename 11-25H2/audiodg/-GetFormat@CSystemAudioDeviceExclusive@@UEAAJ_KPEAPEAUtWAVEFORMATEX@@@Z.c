/*
 * XREFs of ?GetFormat@CSystemAudioDeviceExclusive@@UEAAJ_KPEAPEAUtWAVEFORMATEX@@@Z @ 0x140070E20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceExclusive::GetFormat", 431, v6);
  }
