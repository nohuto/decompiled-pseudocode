/*
 * XREFs of ?SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z @ 0x14005E4C8
 * Callers:
 ...
 * Callees:
 *     ?ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z @ 0x14005D720 (-ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z.c)
