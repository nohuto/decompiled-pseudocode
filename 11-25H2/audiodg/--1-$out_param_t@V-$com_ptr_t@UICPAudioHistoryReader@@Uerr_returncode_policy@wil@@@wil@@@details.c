/*
 * XREFs of ??1?$out_param_t@V?$com_ptr_t@UICPAudioHistoryReader@@Uerr_returncode_policy@wil@@@wil@@@details@wil@@QEAA@XZ @ 0x140057508
 * Callers:
 *     _PopulateAudioHistoryForStreamInternal_::_1_::dtor$3 @ 0x1400949C1 (_PopulateAudioHistoryForStreamInternal_--_1_--dtor$3.c)
 * Callees:
