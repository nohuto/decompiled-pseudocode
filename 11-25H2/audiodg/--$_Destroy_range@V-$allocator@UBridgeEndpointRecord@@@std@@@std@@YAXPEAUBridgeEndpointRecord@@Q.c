/*
 * XREFs of ??$_Destroy_range@V?$allocator@UBridgeEndpointRecord@@@std@@@std@@YAXPEAUBridgeEndpointRecord@@QEAU1@AEAV?$allocator@UBridgeEndpointRecord@@@0@@Z @ 0x140066E84
 * Callers:
 ...
 *     _std::vector_BridgeEndpointRecord_std::allocator_BridgeEndpointRecord___::_Emplace_reallocate___int64_&_Microsoft::WRL::WeakRef_&__::_1_::catch$1 @ 0x1400961E6 (_std--vector_BridgeEndpointRecord_std--allocator_BridgeEndpointRecord___--_Emplace_reallocate___.c)
 *     _dynamic_atexit_destructor_for__g_bridgeEndpointRegistry__ @ 0x1400975F0 (_dynamic_atexit_destructor_for__g_bridgeEndpointRegistry__.c)
 * Callees:
