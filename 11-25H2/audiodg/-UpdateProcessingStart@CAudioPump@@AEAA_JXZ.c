/*
 * XREFs of ?UpdateProcessingStart@CAudioPump@@AEAA_JXZ @ 0x14001F9A0
 * Callers:
 *     ?SetDeadlineForNextProcessingPass@CAudioPump@@AEAAXXZ @ 0x14001F680 (-SetDeadlineForNextProcessingPass@CAudioPump@@AEAAXXZ.c)
 * Callees:
 *     ?RebaseSums@?$LinearFitT@$0BAA@@@QEAA_NXZ @ 0x14001E9F0 (-RebaseSums@-$LinearFitT@$0BAA@@@QEAA_NXZ.c)
 *     ?AddToSums@?$LinearFitT@$0BAA@@@QEAA_NAEBUPoint@1@@Z @ 0x14001EB00 (-AddToSums@-$LinearFitT@$0BAA@@@QEAA_NAEBUPoint@1@@Z.c)
 *     McGenEventWrite_EtwEventWriteTransfer @ 0x1400213E0 (McGenEventWrite_EtwEventWriteTransfer.c)
 *     ?Reset@?$LinearFitT@$0BAA@@@QEAAXXZ @ 0x140021444 (-Reset@-$LinearFitT@$0BAA@@@QEAAXXZ.c)
 *     ?InitWithPoint@?$LinearFitT@$0BAA@@@QEAAXAEBUPoint@1@@Z @ 0x140022B9C (-InitWithPoint@-$LinearFitT@$0BAA@@@QEAAXAEBUPoint@1@@Z.c)
 *     __security_check_cookie @ 0x140058DE0 (__security_check_cookie.c)
 *     floor @ 0x14005A150 (floor.c)
 */
