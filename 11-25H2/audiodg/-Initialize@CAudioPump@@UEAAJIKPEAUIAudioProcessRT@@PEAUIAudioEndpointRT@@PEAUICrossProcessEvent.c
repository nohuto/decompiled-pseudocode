/*
 * XREFs of ?Initialize@CAudioPump@@UEAAJIKPEAUIAudioProcessRT@@PEAUIAudioEndpointRT@@PEAUICrossProcessEventManager@@@Z @ 0x140027BE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimerRequired@CAudioPump@@AEAA_NI@Z @ 0x1400441A4 (-IsTimerRequired@CAudioPump@@AEAA_NI@Z.c)
