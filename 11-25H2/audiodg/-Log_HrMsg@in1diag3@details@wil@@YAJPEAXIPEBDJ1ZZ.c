/*
 * XREFs of ?Log_HrMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ @ 0x14005D394
 * Callers:
        ...
        ...)
{
  ...
  wil::details::ReportFailure_HrMsg<2>((__int64)this, (unsigned int)a2, a3, (__int64)a4, v8, retaddr, v9);
  return v6;
}
