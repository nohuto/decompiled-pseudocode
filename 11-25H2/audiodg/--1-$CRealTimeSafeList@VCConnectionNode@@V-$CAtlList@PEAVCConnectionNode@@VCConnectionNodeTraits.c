/*
 * XREFs of ??1?$CRealTimeSafeList@VCConnectionNode@@V?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@@@QEAA@XZ @ 0x140035C60
 * Callers:
 *     ??1CAudioProcessor@@QEAA@XZ @ 0x140035AA0 (--1CAudioProcessor@@QEAA@XZ.c)
 *     _CAudioProcessor::CAudioProcessor_::_1_::dtor$4 @ 0x140094492 (_CAudioProcessor--CAudioProcessor_--_1_--dtor$4.c)
 * Callees:
