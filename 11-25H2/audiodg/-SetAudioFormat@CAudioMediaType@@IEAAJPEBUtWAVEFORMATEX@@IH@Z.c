/*
 * XREFs of ?SetAudioFormat@CAudioMediaType@@IEAAJPEBUtWAVEFORMATEX@@IH@Z @ 0x14005B040
 * Callers:
 ...
 *     ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14005B184 (-ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z.c)
