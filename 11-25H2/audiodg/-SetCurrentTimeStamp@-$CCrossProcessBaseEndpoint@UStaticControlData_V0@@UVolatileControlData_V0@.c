/*
 * XREFs of ?SetCurrentTimeStamp@?$CCrossProcessBaseEndpoint@UStaticControlData_V0@@UVolatileControlData_V0@@UControlData_V0@@@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x1400522A0
 * Callers:
 *     <none>
 * Callees:
