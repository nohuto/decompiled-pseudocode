/*
 * XREFs of ?RemoveAt@?$CSimpleMap@KPEAVCVpoContext@@V?$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@QEAAHH@Z @ 0x140076480
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < 0 )
    return 0LL;
  v3 = dword_1400C4840;
  if ( (int)v2 >= dword_1400C4840 )
    return 0LL;
  if ( (_DWORD)v2 != dword_1400C4840 - 1 )
  {
    v4 = memmove_s(
           (char *)CVpoContext::s_mapVpoContext + 4 * v2,
           4LL * (dword_1400C4840 - (int)v2),
           (char *)CVpoContext::s_mapVpoContext + 4 * v2 + 4,
           4LL * (dword_1400C4840 - (int)v2 - 1));
    ATL::AtlCrtErrorCheck(v4);
    v5 = memmove_s(
           (char *)qword_1400C4838 + 8 * v2,
           8LL * (dword_1400C4840 - (int)v2),
           (char *)qword_1400C4838 + 8 * v2 + 8,
           8LL * (dword_1400C4840 - (int)v2 - 1));
    ATL::AtlCrtErrorCheck(v5);
    v3 = dword_1400C4840;
  }
  v6 = (void *)_o__recalloc(CVpoContext::s_mapVpoContext, v3 - 1, 4LL);
  if ( v6 || dword_1400C4840 == 1 )
    CVpoContext::s_mapVpoContext = v6;
  v7 = (void *)_o__recalloc(qword_1400C4838, dword_1400C4840 - 1, 8LL);
  if ( v7 || dword_1400C4840 == 1 )
    qword_1400C4838 = v7;
  result = 1LL;
  --dword_1400C4840;
  return result;
