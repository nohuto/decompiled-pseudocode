/*
 * XREFs of ?RuntimeClassInitialize@?$CCPAudioHistoryReader@UStaticControlData_V1@@UVolatileControlData_V0@@UControlData_V1@@@@QEAAJ_K0H0PEAUVolatileControlData_V0@@PEAUSharedMessageQueueItem@@III0@Z @ 0x140081E6C
 * Callers:
