/*
 * XREFs of ?ndisCreateThreadStateObject@@YAJAEAV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUNDIS_THREAD_STATE@@$$A6A_JPEAX@Z$1?ObfDereferenceObject@@YA_J0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@@Z @ 0x1400EB8B8
 * Callers:
...
__int64 __fastcall ndisCreateThreadStateObject(__int64 *a1)
{
  ...
  v4 = 0LL;
  result = ObCreateObject(0LL, qword_140127858, 0LL, 0LL, 0LL, 32, 0, 0, &v4);
  if ( !(_DWORD)result )
  {
    v3 = v4;
    *v4 = 0LL;
