/*
 * XREFs of NdisWdfReadConfiguration @ 0x140050570
 * Callers:
 *     <none>
 * Callees:
 *     NdisReadConfiguration @ 0x140050D30 (NdisReadConfiguration.c)
 *     ndisIsWdfMiniportConfigurationKeywordDeprecated @ 0x140051380 (ndisIsWdfMiniportConfigurationKeywordDeprecated.c)
