/*
 * XREFs of ?ExecuteEventAction@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAA?AW4EngineState@123@AEBUEVENT_ACTION@123@@Z @ 0x140074FA0
 * Callers:
 ...
 *     ?ShouldTransitionToWorkerForState@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAA_NAEBUSTATE_SPECIFICATION@3@@Z @ 0x1400EDC34 (-ShouldTransitionToWorkerForState@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAA_NAEBUSTAT.c)
