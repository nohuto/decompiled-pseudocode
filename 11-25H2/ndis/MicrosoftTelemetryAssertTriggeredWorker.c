/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1400EBEE0
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1400EBEB0 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     _tlgCreate1Sz_char @ 0x140004758 (_tlgCreate1Sz_char.c)
 ...
 *     GetImageTuple @ 0x1400EBC98 (GetImageTuple.c)
...
LABEL_35:
  ...
  v20 = "<unknown>";
  v21 = v29;
  if ( (unsigned int)dword_14013F040 > 5 && tlgKeywordOn((__int64)&dword_14013F040, 0x400000000000LL) )
  {
    v29 = 10;
    v38 = &v29;
    v22 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14013F040, byte_14010C284, 0LL, 0LL, 0xBu, v37);
  }
  if ( dword_14013F078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_14013F040 > 5 && tlgKeywordOn((__int64)&dword_14013F040, 0x400000000000LL) )
    {
      ...
      v30 = v23;
      v52 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14013F040, byte_14010C397, v24, 0LL, v25, v37);
    }
    if ( !v23 )
    {
