/*
 * XREFs of ?PauseNeededForBind@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUBindStack@2@@Z @ 0x1401648C0
 * Callers:
          ...
          if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED && *((_WORD *)WPP_GLOBAL_Control + 36) )
            WPP_RECORDER_SF_Ld(
              *((_QWORD *)WPP_GLOBAL_Control + 8),
              ...
              v22,
              v22 | 4);
          v23 = (unsigned __int8)byte_140126C63 < 4u;
          *(_BYTE *)(*(_QWORD *)&a2->Reserved4.Length + 5224LL) = 1;
          if ( !v23 && *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
          {
