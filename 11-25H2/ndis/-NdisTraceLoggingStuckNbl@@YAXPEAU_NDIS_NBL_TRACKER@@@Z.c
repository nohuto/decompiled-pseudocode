/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1400B74E0
 * Callers:
  ...
  if ( *((_WORD *)a1 + 8) != 1 )
  {
    if ( *((_WORD *)a1 + 8) == 2 )
    {
      if ( (unsigned int)dword_1401247E8 > 5 && tlgKeywordOn((__int64)&dword_1401247E8, 0x400000000000LL) )
      {
        ...
        v28[0] = v10;
        v23 = &v16;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1401247E8, byte_14010ACE4, 0LL, 0LL, 5u, &v22);
      }
      return;
    }
