/*
 * XREFs of McTemplateK0juqjzzz_EtwWriteTransfer @ 0x140024C70
 * Callers:
        ...
        const wchar_t *a10)
{
  ...
  v37 = v10;
  v39 = 0;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, (const EVENT_DESCRIPTOR *)"H(", a3, 8u, &v22);
}
