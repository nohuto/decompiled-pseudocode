/*
 * XREFs of ?ndisResizeRefCountBlockTagged@@YAXPEAU_NDIS_REFCOUNT_BLOCK@@E@Z @ 0x14004CEA0
 * Callers:
...
void __fastcall ndisResizeRefCountBlockTagged(struct _NDIS_REFCOUNT_BLOCK *a1, unsigned __int8 a2)
{
  ...
  $21EF1B37CC057D0A3E6C7DEAA7D2E6FA *v7; // rcx
  unsigned __int8 *p_NumOverflowTaggedEntries; // rdx
  _NDIS_REFCOUNT_TAGGED_ENTRY *v9; // rcx
  unsigned __int16 v10; // bp
  unsigned __int16 i; // bp

  Pool2 = (_NDIS_REFCOUNT_TAGGED_ENTRY *)ExAllocatePool2(64LL, 2 * (unsigned int)a2, 2020754510);
  v5 = Pool2;
  if ( Pool2 )
  {
