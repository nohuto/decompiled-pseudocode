/*
 * XREFs of ?Initialize@KnobNamespace@@QEAAXPEAU_DRIVER_OBJECT@@PEAU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x140086AA0
 * Callers:
        ...
        struct _CONFIG_KNOB_NAMESPACE *a3)
{
  ...
  *(_DWORD *)&this->m_id.ObjectId.Data4[4] = v3;
  ...
  KPushLockBase::AcquireExclusive(&stru_140126B90);
  v6 = (_LIST_ENTRY **)qword_140126BA0;
  p_m_globalLinkage = &this->m_globalLinkage;
  if ( *(__int64 **)qword_140126BA0 != &qword_140126B98 )
    __fastfail(3u);
  this->m_globalLinkage.Blink = (_LIST_ENTRY *)qword_140126BA0;
  p_m_globalLinkage->Flink = (_LIST_ENTRY *)&qword_140126B98;
  *v6 = p_m_globalLinkage;
  qword_140126BA0 = (__int64)&this->m_globalLinkage;
  KPushLockBase::ReleaseExclusive(&stru_140126B90);
