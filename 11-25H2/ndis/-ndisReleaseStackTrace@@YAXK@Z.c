/*
 * XREFs of ?ndisReleaseStackTrace@@YAXK@Z @ 0x14007CF60
 * Callers:
 ...
 *     ?ndisFillEventLogEntry@@YAXPEAU_NDIS_EVENT_LOG@@KGPEAX@Z @ 0x140071C60 (-ndisFillEventLogEntry@@YAXPEAU_NDIS_EVENT_LOG@@KGPEAX@Z.c)
