/*
 * XREFs of ?ndisXlateSendNetBufferListsToPacketArray@@YAEPEAU_NDIS_NBLS_TO_PKT_ARRAY@@E@Z @ 0x14002F410
 * Callers:
 ...
 *     ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x14002FC30 (-ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z.c)
 *     NdisGetNetBufferListProtocolId @ 0x140030130 (NdisGetNetBufferListProtocolId.c)
...
LABEL_52:
      ...
      else
      {
        ...
        for ( j = v4; j; j = (struct _NET_BUFFER *)j->Link.Alignment )
        {
          ...
          v12 = ndisNetBufferToPacket(j, 1u, v21);
          if ( v12 )
            goto LABEL_13;
          v22 = *v21;
