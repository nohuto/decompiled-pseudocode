/*
 * XREFs of ?ndisMSetSriovAttributes@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES@@@Z @ 0x1400A782C
 * Callers:
 ...
 *     ?ndisIovInitVf@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400E6028 (-ndisIovInitVf@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_33:
  ...
  if ( (a2->CurrentSriovCapabilities->SriovCapabilities & 3) != 3 || ndisSystemSupportsSriov )
  {
    ...
    if ( !v13 )
      goto LABEL_16;
    v14 = (_NDIS_SRIOV_CAPABILITIES *)ExAllocatePool2(64LL, 12LL, 1869169742);
