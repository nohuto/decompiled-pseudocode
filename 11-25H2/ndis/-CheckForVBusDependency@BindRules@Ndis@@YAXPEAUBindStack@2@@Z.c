/*
 * XREFs of ?CheckForVBusDependency@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x140163420
 * Callers:
    ...
    if ( v8 )
    {
      if ( (*(_DWORD *)(v8 + 64) & 0x10000000) == 0 || LOBYTE(WPP_MAIN_CB.DeviceQueue.Lock) )
      {
        ...
        if ( (v12 != 0) != ((v12 & 0xFFDFFFFF) != 0) || !*(_QWORD *)v7 )
        {
          ...
          v10 = (unsigned __int8)byte_140126C63 < 4u;
          *(_BYTE *)(*(_QWORD *)v7 + 5224LL) = 1;
          if ( !v10 && *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_Zq(
              *((_QWORD *)WPP_GLOBAL_Control + 8),
              **v6,
              0x1Cu,
