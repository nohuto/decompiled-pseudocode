/*
 * XREFs of NdisAllocateCloneOidRequest @ 0x140022390
 * Callers:
...
LABEL_13:
        ...
        *((_DWORD *)v9 + 13) = BytesWritten;
        v22 = *(_DWORD *)&v8->NdisReserved[16];
        v23 = *((_DWORD *)v9 + 22);
        v24 = *(_OWORD *)&v8->NdisReserved[96];
        *((_QWORD *)v9 + 12) = v8;
        v25 = v23 ^ ((unsigned __int16)v23 ^ (unsigned __int16)v22) & 0x8000 ^ ((unsigned __int8)v22 ^ (unsigned __int8)v23) & 0x80;
        ...
        *((_DWORD *)v9 + 38) = *(_DWORD *)&v8->NdisReserved[80];
        ...
        v27 = v26 ^ (v22 ^ v26) & 0x800000 ^ (v22 ^ v26 ^ (v22 ^ v26) & 0x800000) & 0x1000000 | 0x4000;
        *((_DWORD *)v9 + 22) = v27 ^ (v22 ^ v27) & 0x30000000;
        *(_OWORD *)(v9 + 168) = v24;
        if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_qDDqq(*((_QWORD *)WPP_GLOBAL_Control + 8), v27, v22, (_DWORD)v9);
        goto LABEL_23;
      }
    }
    else if ( Revision == 2 )
