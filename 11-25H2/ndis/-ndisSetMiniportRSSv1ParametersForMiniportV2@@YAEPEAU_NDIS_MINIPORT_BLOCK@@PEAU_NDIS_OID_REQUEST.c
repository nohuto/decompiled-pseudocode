/*
 * XREFs of ?ndisSetMiniportRSSv1ParametersForMiniportV2@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1400B5320
 * Callers:
 ...
 *     ?ndisAreProcessorsEqual@@YAEU_PROCESSOR_NUMBER@@0@Z @ 0x1400B3B00 (-ndisAreProcessorsEqual@@YAEU_PROCESSOR_NUMBER@@0@Z.c)
 ...
 *     ?ndisSetCombinedRSSParameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAU_NDIS_VPORT_BLOCK@@PEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@@Z @ 0x1400B52A0 (-ndisSetCombinedRSSParameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAU_NDIS_VPO.c)
        ...
        int a4)
{
  ...
  struct _PROCESSOR_NUMBER v19; // ecx
  ...
  unsigned int v35; // [rsp+5Ch] [rbp-1Dh]
  void *Src; // [rsp+60h] [rbp-19h] BYREF
  struct _NDIS_RECEIVE_SCALE_PARAMETERS *v37; // [rsp+68h] [rbp-11h] BYREF
  size_t Size; // [rsp+70h] [rbp-9h] BYREF
  struct _NDIS_VPORT_BLOCK *v39; // [rsp+78h] [rbp-1h] BYREF
  void *v40; // [rsp+80h] [rbp+7h]
  struct _PROCESSOR_NUMBER *v41; // [rsp+88h] [rbp+Fh]
  struct _PROCESSOR_NUMBER *v42; // [rsp+90h] [rbp+17h]
...
LABEL_14:
    ...
    IsTargetNonDefaultVPort = ndisIsTargetNonDefaultVPort(a2, (NDIS_OBJECT_HEADER *)&Size);
    ...
    v19 = v33;
    if ( *(_DWORD *)&v33 <= v18 )
      v19 = (struct _PROCESSOR_NUMBER)v18;
    LODWORD(Size) = v19;
    ...
    if ( v43 )
    {
      ...
      if ( (v23 & 8) == 0 )
      {
        ...
        v40 = &InformationBuffer->Header.Type + InformationBuffer->HashSecretKeyOffset;
      }
      if ( v17 && (v23 & 0x20) == 0 )
      {
      ...
      if ( (v23 & 4) == 0 )
      {
        v42 = (struct _PROCESSOR_NUMBER *)(&v20->Header.Type + v20->IndirectionTableOffset);
        v25 = v20->IndirectionTableSize >> 2;
        v34 = v25;
        v8 = *((_WORD *)Src + 6) >> 2;
        v41 = (struct _PROCESSOR_NUMBER *)((char *)Src + *((unsigned int *)Src + 4));
        v30 = v8 < v25;
        if ( v8 > v25 )
        {
          v5 |= 0x10u;
    ...
    {
      MaxNumRssProcessors = v39->VPortParams.NumQueuePairs;
    }
    ...
    if ( v43 )
    {
      ...
      v12 = ndisInternalSetRSSv2IndirectionTable(a1, a2, v34, v42, DefaultProcessorNumber, v8, v41, v27);
      if ( v12 )
        goto LABEL_51;
      if ( v30 )
      {
...
LABEL_50:
    ...
    ndisSetCombinedRSSParameters(a1, a2, v39, v37);
    v28 = NewIrql;
    a1->MiniportThread = 0LL;
