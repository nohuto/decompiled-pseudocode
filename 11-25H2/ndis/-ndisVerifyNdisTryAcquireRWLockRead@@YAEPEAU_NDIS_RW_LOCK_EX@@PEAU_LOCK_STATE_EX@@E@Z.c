/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockRead@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1400C99E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockRead @ 0x1400C9C60 (NdisTryAcquireRWLockRead.c)
 */
