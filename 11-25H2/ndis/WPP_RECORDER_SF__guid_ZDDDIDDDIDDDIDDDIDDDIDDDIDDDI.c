/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1400CAF64
 * Callers:
...
LABEL_11:
  if ( !a7 )
    v35 = L"\b";
  LOWORD(v41) = 44;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_0da1f7415b08391dc91ed9194dfe6793_Traceguids, v41, a6, 16LL, v35);
}
