/*
 * XREFs of ?ndisMergeOffloadCapsAndRegistry@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x140082750
 * Callers:
...
void __fastcall ndisMergeOffloadCapsAndRegistry(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( a2->Header.Type == 0xA7 && a2->Header.Size >= 0x70u && a2->Header.Revision )
  {
    ...
    if ( (v2 & 0x300) == 0 && (v2 & 0xC0) == 0 && (v2 & 0x30) == 0 )
    ...
    if ( (v3 & 0x300) == 0 && (v3 & 0xC0) == 0 && (v3 & 0x30) == 0 )
    ...
    if ( a2->Header.Revision >= 2u && a2->Header.Size >= 0x90u )
    {
      ...
      if ( (Value & 0x400000) != 0 )
      {
        ...
        if ( (a1->OffloadRegistry.Value & 0x200000) != 0 )
          a2->IPsecV2.Esp = 0;
        v7 = (a1->OffloadRegistry.Value & 0x300000) == 3145728;
      }
      else
      {
        if ( (Value & 0x40000) != 0 )
        ...
        if ( (a1->OffloadRegistry.Value & 0x80000) != 0 )
          a2->IPsecV2.Esp = 0;
        v7 = (a1->OffloadRegistry.Value & 0xC0000) == 786432;
      }
      if ( v7 )
