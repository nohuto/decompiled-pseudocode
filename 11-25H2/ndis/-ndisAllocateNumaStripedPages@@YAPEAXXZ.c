/*
 * XREFs of ?ndisAllocateNumaStripedPages@@YAPEAXXZ @ 0x14014C32C
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?ndisFreeMappingAddress@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1400CB9D8 (--1-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@Z$1-ndisFreeMappingAddress@@YAX0@ZU-$integra.c)
 *     ?ndisFreeMappingAddress@@YAXPEAX@Z @ 0x1400CBAC0 (-ndisFreeMappingAddress@@YAXPEAX@Z.c)
...
__int64 ndisAllocateNumaStripedPages(void)
{
  ...
  Pool2 = (_OWORD *)ExAllocatePool2(64LL, v4, 1833780302);
  if ( Pool2 )
  {
    *Pool2 = 0LL;
    Pool2[1] = 0LL;
  ...
  if ( !is_mul_ok(v0, 8uLL) )
    v8 = -1LL;
  v9 = (PMDL *)ExAllocatePool2(256LL, v8, 1833780302);
  v10 = v9;
  if ( !v9 )
  {
