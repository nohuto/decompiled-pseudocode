/*
 * XREFs of ndisQueueDpcWorkItem @ 0x140045F60
 * Callers:
  ...
  if ( (*(_DWORD *)(v16 + 68) & 1) == 0 )
  {
    ...
    *(_DWORD *)(v16 + 64) = Number;
    if ( a5 )
    {
      ...
      *(_DWORD *)(v16 + 68) |= 2u;
      v18 = (char *)qword_140125540 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
      ...
      *((_QWORD *)v18 + 1) = v16;
      ...
      if ( !_InterlockedExchange((volatile __int32 *)qword_140125538 + v20, 1) )
      {
        v21.QuadPart = -1LL;
        v22 = (struct _KDPC *)((char *)qword_140125530 + 128 * (unsigned __int64)KeGetPcr()->Prcb.Number + 64);
        if ( DueTime.QuadPart )
          v21 = DueTime;
        KeSetTimer((PKTIMER)qword_140125530 + 2 * (unsigned __int64)KeGetPcr()->Prcb.Number, v21, v22);
      }
    }
    else
    {
