/*
 * XREFs of ?FreeBuckets@?$KHashTableBase@$00@Rtl@@CAXPEAX0@Z @ 0x14014FCE4
 * Callers:
 *     ??1?$KStringAtomTableBase@$00@Rtl@@QEAA@XZ @ 0x14014F9F8 (--1-$KStringAtomTableBase@$00@Rtl@@QEAA@XZ.c)
