/*
 * XREFs of ?ndisPostProcessRestartParametersAfterMiniport@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x14007C110
 * Callers:
...
LABEL_15:
        ...
        if ( a2->General.SupportedOidListLength && !SupportedOidListLength )
          a1->SupportedOidList = (unsigned int *)ExAllocatePool2(66LL, a2->General.SupportedOidListLength, 1835091022);
