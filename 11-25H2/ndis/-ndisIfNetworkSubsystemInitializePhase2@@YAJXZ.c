/*
 * XREFs of ?ndisIfNetworkSubsystemInitializePhase2@@YAJXZ @ 0x1400D497C
 * Callers:
...
__int64 ndisIfNetworkSubsystemInitializePhase2(void)
{
  ...
  LODWORD(v20[8]) = 528;
  LODWORD(v20[13]) = 0;
  v2 = NsiEnumerateObjectsAllParametersEx(v20);
  if ( v2 >= 0 )
  {
    v3 = v20[13];
    if ( LODWORD(v20[13]) )
    {
      while ( 1 )
      {
        ...
        v5 = v4;
        Pool2 = ExAllocatePool2(64LL, v4 + 528LL * v3, 1718174798);
        v23 = (void *)Pool2;
        v0 = (void *)Pool2;
        if ( !Pool2 )
        {
          ...
          do
          {
            ...
            if ( *(_BYTE *)v12 == 0xAC && *(_BYTE *)(v12 + 1) && *(_WORD *)(v12 + 2) >= 0x210u )
            {
              ...
              if ( CompartmentBlock )
              {
                ...
                if ( !NetworkBlock )
                  v2 = ndisIfCreateNetworkBlock(v16, v17, v12, &NetworkBlock);
              }
              else
              {
