/*
 * XREFs of ?ndisMInitializeMiniportBlockFront@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1401868B0
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x14008C4F0 (-ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
