/*
 * XREFs of ??1NdisFreeSharedMemoryTelemetry@@QEAA@XZ @ 0x14007B8E0
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::~NdisFreeSharedMemoryTelemetry(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  {
    _InterlockedIncrement64(&qword_1401270B8);
    _InterlockedAdd64(&qword_1401270C0, *((unsigned int *)this + 8));
  }
  if ( *(_BYTE *)this )
  {
    v2 = *((_BYTE *)this + 80) == 0;
