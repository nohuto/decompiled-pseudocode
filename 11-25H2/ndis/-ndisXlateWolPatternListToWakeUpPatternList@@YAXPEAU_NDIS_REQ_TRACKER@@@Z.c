/*
 * XREFs of ?ndisXlateWolPatternListToWakeUpPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400BEB60
 * Callers:
 *     ?ndisOidPostWakeUpPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400BAF10 (-ndisOidPostWakeUpPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
...
void __fastcall ndisXlateWolPatternListToWakeUpPatternList(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  int v12; // r12d
  struct _NDIS_PM_WOL_PATTERN *v13; // rsi
