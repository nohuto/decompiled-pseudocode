/*
 * XREFs of ?ndisFDoLoopbackNetBufferList@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NET_BUFFER@@PEAU_NET_BUFFER_LIST@@KK@Z @ 0x140044330
 * Callers:
        ...
        char a5)
{
  ...
  if ( (v8 + DataLength) >> 32 )
    return;
  Pool2 = (struct _MDL *)ExAllocatePool2(64LL, (unsigned int)(v8 + DataLength), 1886143566);
  v10 = Pool2;
  if ( !Pool2 )
    return;
