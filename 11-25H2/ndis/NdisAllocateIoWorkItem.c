/*
 * XREFs of NdisAllocateIoWorkItem @ 0x1400721D0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_HANDLE __stdcall NdisAllocateIoWorkItem(NDIS_HANDLE NdisObjectHandle)
{
  ...
  result = (NDIS_HANDLE)ExAllocatePool2(64LL, 48LL, 1769423950);
  v3 = result;
  if ( result )
  {
...
LABEL_16:
        ...
        ndisDereferenceFilterDriver((struct _NDIS_FILTER_DRIVER_BLOCK *)NdisObjectHandle, 0, 1u);
        break;
      case 9:
        ...
        else
        {
          ...
          if ( v11 )
            goto LABEL_5;
          ndisDereferenceFilterDriver(*((struct _NDIS_FILTER_DRIVER_BLOCK **)NdisObjectHandle + 3), 0, 2u);
        }
LABEL_27:
        ExFreePoolWithTag(v3, 0);
        v3 = 0LL;
