/*
 * XREFs of WPP_RECORDER_SF_ZZ @ 0x1400D3BC4
 * Callers:
...
LABEL_15:
  ...
  ndisWppFastTraceMessage(
    &WPP_f1054d40bcb63b47024375fafc740b75_Traceguids,
    0x10u,
    v15,
    2LL,
    v14,
...
LABEL_18:
  ...
  if ( v16 )
    v8 = L"\b";
  LOWORD(v18) = 16;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_f1054d40bcb63b47024375fafc740b75_Traceguids, v18, v8, 2LL, v7);
}
