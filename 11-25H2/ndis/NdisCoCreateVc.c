/*
 * XREFs of NdisCoCreateVc @ 0x1400D8100
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  ...
  v14 = ExAllocatePool2(64LL, 144LL, 1868776526);
  v15 = v14;
  if ( !v14 )
  {
    v9 = -1073741670;
  ...
  *(_QWORD *)(v15 + 120) = v59;
  if ( !v7 )
  {
    v9 = (*((__int64 (__fastcall **)(LARGE_INTEGER, _DWORD *, _DWORD *))NdisBindingHandle + 129))(v59[3], v10, v10 + 50);
    if ( v9 )
    {
  ...
  *((_QWORD *)v10 + 1) = v15 + 4;
  if ( !v5 )
  {
    ...
    *((_QWORD *)v10 + 21) = *((_QWORD *)NdisBindingHandle + 133);
    v48 = *((_QWORD *)NdisBindingHandle + 134);
...
LABEL_57:
  ...
  else
  {
    ...
    *v31 = ProtocolVcContext;
    v9 = ((__int64 (__fastcall **)(NDIS_HANDLE, _DWORD *, _DWORD *))v33)[131](v39, v10, v10 + 6);
  }
  if ( v9 )
  {
LABEL_74:
...
LABEL_76:
  ...
  if ( Increment )
  {
    ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)NdisBindingHandle + 1112), (PLIST_ENTRY)v10 + 2, v40);
    v50 = *((_DWORD *)v5 + 98) < 6u;
    *((_QWORD *)v10 + 13) = *v31;
    if ( v50 )
      v42 = v5[3];
    ...
    *((_QWORD *)v10 + 12) = v42[2];
    if ( !v61 )
      ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)v5[5] + 1112), (PLIST_ENTRY)(v10 + 38), (PKSPIN_LOCK)v5[5] + 29);
  }
  else
  {
    *((_QWORD *)v10 + 13) = *((_QWORD *)v10 + 3);
    *((_QWORD *)v10 + 12) = *((_QWORD *)v5[46] + 132);
    ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)NdisBindingHandle + 1112), (PLIST_ENTRY)(v10 + 38), v40);
    ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)v5[46] + 1112), (PLIST_ENTRY)v10 + 2, (PKSPIN_LOCK)v5[46] + 29);
    v20 = 0LL;
  }
LABEL_97:
  ...
  if ( v50 )
  {
    if ( v49 < 6u )
    {
      ...
      v20 = (void (__fastcall *)(void *, struct _NDIS_PACKET **, unsigned int))ndisCoSendPacketsToNdisPackets;
      v54 = 0LL;
