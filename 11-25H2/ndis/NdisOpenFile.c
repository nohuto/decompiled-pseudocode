/*
 * XREFs of NdisOpenFile @ 0x1400DBBC0
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  Pool2 = ExAllocatePool2(66LL, v9, 1852195918);
...
LABEL_15:
  ...
  v14 = (void *)ExAllocatePool2(66LL, DWORD2(FileInformation), 1768309838);
  v16 = v14;
  if ( !v14 )
  {
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  ...
  {
    v18 = (_QWORD *)ExAllocatePool2(64LL, 24LL, 1684423758);
    v19 = v18;
    if ( v18 )
    {
      *v18 = v16;
