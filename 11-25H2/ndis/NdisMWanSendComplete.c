/*
 * XREFs of NdisMWanSendComplete @ 0x1400E0520
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMWanSendComplete(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, int a3)
{
  ...
  if ( !a3 )
  {
    ...
    if ( v9 )
    {
      v10 = &v9[KeGetPcr()->Prcb.Number];
      v10->ifHCOutUcastOctets += *(unsigned int *)(a2 + 24);
      v10->ifHCOutOctets += *(unsigned int *)(a2 + 24);
    }
  }
