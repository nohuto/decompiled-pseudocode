/*
 * XREFs of NdisAllocateFragmentNetBufferList @ 0x140019B60
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisAllocateMdlInternal@@YAPEAU_MDL@@PEAK@Z @ 0x140019760 (-ndisAllocateMdlInternal@@YAPEAU_MDL@@PEAK@Z.c)
