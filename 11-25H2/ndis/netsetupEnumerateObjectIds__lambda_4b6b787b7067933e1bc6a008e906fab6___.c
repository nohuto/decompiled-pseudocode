/*
 * XREFs of netsetupEnumerateObjectIds__lambda_4b6b787b7067933e1bc6a008e906fab6___ @ 0x14014F400
 * Callers:
 ...
 *     ?netsetupBuildStorePath@@YAXW4_NETSETUP_OBJECT_TYPE@@W4NetSetupStoreType@@PEA_W@Z @ 0x14015A564 (-netsetupBuildStorePath@@YAXW4_NETSETUP_OBJECT_TYPE@@W4NetSetupStoreType@@PEA_W@Z.c)
 *     ?Open@KRegKey@@QEAAJKPEB_WPEAX@Z @ 0x140168E70 (-Open@KRegKey@@QEAAJKPEB_WPEAX@Z.c)
 */

__int64 netsetupEnumerateObjectIds__lambda_4b6b787b7067933e1bc6a008e906fab6_()
{
  unsigned int v0; // ebx
  unsigned int v1; // eax
  ULONG i; // edi
  ...
  wchar_t pszSrc[256]; // [rsp+48h] [rbp-C0h] BYREF

  v0 = 0;
  Guid[0].m_ptr = 0LL;
  netsetupBuildStorePath(3LL, 0LL, pszSrc);
  v1 = KRegKey::Open(Guid, 8u, pszSrc, 0LL);
  if ( v1 == -1073741772 )
    goto LABEL_12;
  if ( v1 )
  {
...
LABEL_12:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    *(_OWORD *)&Guid[1].m_ptr = 0LL;
    ...
    {
      LwfById = ndisReadLwfById(0LL, &Guid[1]);
      if ( LwfById )
      {
        wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString>>::reset((void **)&GuidString, 0LL);
        wil::details::unique_storage<wil::details::resource_policy<void *,long (*)(void *),&long ZwClose(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::~unique_storage<wil::details::resource_policy<void *,long (*)(void *),&long ZwClose(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>(&Guid[0].m_ptr);
