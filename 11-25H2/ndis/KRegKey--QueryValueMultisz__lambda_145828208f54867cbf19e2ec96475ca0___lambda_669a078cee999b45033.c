/*
 * XREFs of KRegKey::QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f___ @ 0x14014F1B4
 * Callers:
...
LABEL_35:
  ...
  if ( !Rtl::KArray<Rtl::_KStringAtom *,1>::reserve((unsigned int *)qword_140127138 + 18, v13 + 4) )
  {
LABEL_29:
    if ( v5 )
      operator delete[](v5);
  ...
  while ( *v12 )
  {
    ...
    do
      ++v16;
    while ( *v16 );
    Atom = (PVOID)Rtl::KStringAtomTableBase<1>::GetAtom(qword_140127138, v12);
    if ( !Atom )
      goto LABEL_29;
    Rtl::KArray<Rtl::_KStringAtom *,1>::append((char *)qword_140127138 + 72, &Atom);
    v12 = v16 + 1;
  }
  if ( v5 )
    operator delete[](v5);
