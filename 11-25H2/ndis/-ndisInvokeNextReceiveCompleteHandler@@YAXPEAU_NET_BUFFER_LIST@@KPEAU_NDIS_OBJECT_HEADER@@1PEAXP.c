/*
 * XREFs of ?ndisInvokeNextReceiveCompleteHandler@@YAXPEAU_NET_BUFFER_LIST@@KPEAU_NDIS_OBJECT_HEADER@@1PEAXP6AX20K@Z@Z @ 0x14004C7D0
 * Callers:
...
LABEL_9:
  ...
  v13 = *(_QWORD *)(v12 + qword_1401270F8);
  LowLimit = v13;
  v14 = *(_QWORD *)(v12 + qword_1401270F0);
  HighLimit[0] = v14;
