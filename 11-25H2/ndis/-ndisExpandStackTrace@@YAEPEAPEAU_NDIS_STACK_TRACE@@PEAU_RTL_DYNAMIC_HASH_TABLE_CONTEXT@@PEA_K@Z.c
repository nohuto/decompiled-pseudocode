/*
 * XREFs of ?ndisExpandStackTrace@@YAEPEAPEAU_NDIS_STACK_TRACE@@PEAU_RTL_DYNAMIC_HASH_TABLE_CONTEXT@@PEA_K@Z @ 0x140071F90
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( LODWORD((*a1)[1].Linkage.Flink) >> 30 == 3
    || (Pool2 = ExAllocatePool2(64LL, 32 * ((LODWORD((*a1)[1].Linkage.Flink) >> 30) + 4), 1802716238),
