/*
 * XREFs of ?ndisStackExpansionInitializeSubsystem@@YAJXZ @ 0x1400CBB88
 * Callers:
        ...
        unsigned __int8 (*a3)(void *, const struct KnobDescriptor *, unsigned __int64 *))
{
  ...
  ndisRegisterKnobs(&stru_1400FDD60, 1uLL, a3, 0LL, v10);
  qword_1401270F8 = (__int64)ndisAllocatePerProcessorSlot(0x78457453u);
  qword_1401270F0 = (__int64)ndisAllocatePerProcessorSlot(0x78457453u);
  if ( !qword_1401270F0 )
    return 3221225626LL;
