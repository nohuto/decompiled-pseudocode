/*
 * XREFs of ?AzTelemetryWriteMiniportInitialize@@YAXPEBU_NDIS_MINIPORT_BLOCK@@HAEBVKStopwatch@@@Z @ 0x14008E680
 * Callers:
        ...
        const struct KStopwatch *a3)
{
  ...
  if ( (unsigned int)dword_1401247B0 > 5
    && (qword_1401247C0 & 0x200) != 0
    && (qword_1401247C8 & 0x200) == qword_1401247C8 )
  {
