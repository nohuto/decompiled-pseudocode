/*
 * XREFs of ?MakeOptionalFiltersMandatoryDuringBoot@BindRules@Ndis@@YAXPEAUBindStack@2@_N@Z @ 0x1401657E0
 * Callers:
...
LABEL_16:
  ...
  while ( v3 != v18 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v4 )
      {
        if ( Ndis::BindState::SetBinding(v20, v4, Reason_MissingOptionalFilter) && (unsigned __int8)byte_140126C63 >= 4u )
        {
