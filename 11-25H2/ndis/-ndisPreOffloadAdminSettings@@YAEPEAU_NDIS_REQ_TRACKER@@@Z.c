/*
 * XREFs of ?ndisPreOffloadAdminSettings@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400C4080
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
      ...
      *((_DWORD *)a1 + 10) = 0;
      if ( *(_BYTE *)Buffer != 0x80 || *((_BYTE *)Buffer + 1) < 2u )
        goto LABEL_39;
      v7 = Buffer[1] < 0x16u;
    }
    else if ( v6 == 3 )
    {
      ...
      *((_DWORD *)a1 + 10) = 0;
      if ( *(_BYTE *)Buffer != 0x80 || *((_BYTE *)Buffer + 1) < 3u )
        goto LABEL_39;
      v7 = Buffer[1] < 0x1Au;
    }
    else if ( v6 == 4 )
    {
      ...
      *((_DWORD *)a1 + 10) = 0;
      if ( *(_BYTE *)Buffer != 0x80 || *((_BYTE *)Buffer + 1) < 4u )
        goto LABEL_39;
      v7 = Buffer[1] < 0x20u;
    }
    else
    {
      ...
      *((_DWORD *)a1 + 10) = 0;
      if ( *(_BYTE *)Buffer != 0x80 || *((_BYTE *)Buffer + 1) < 5u )
        goto LABEL_39;
      v7 = Buffer[1] < 0x22u;
    }
LABEL_38:
  ...
  *((_DWORD *)a1 + 10) = 0;
  if ( *(_BYTE *)Buffer == 0x80 && *((_BYTE *)Buffer + 1) )
  {
    v7 = Buffer[1] < 0x14u;
    goto LABEL_38;
  }
