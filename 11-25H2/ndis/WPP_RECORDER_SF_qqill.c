/*
 * XREFs of WPP_RECORDER_SF_qqill @ 0x140069650
 * Callers:
 *     NdisSetCoalescableTimerObject @ 0x140095C00 (NdisSetCoalescableTimerObject.c)
 * Callees:
 *     ?ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ @ 0x1400270E0 (-ndisWppFastTraceMessage@@YAXPEBU_GUID@@GZZ.c)
 */

__int64 WPP_RECORDER_SF_qqill(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
