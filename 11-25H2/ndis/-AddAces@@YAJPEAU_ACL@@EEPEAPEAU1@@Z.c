/*
 * XREFs of ?AddAces@@YAJPEAU_ACL@@EEPEAPEAU1@@Z @ 0x140197C8C
 * Callers:
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x140197EF0 (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 * Callees:
...
__int64 __fastcall AddAces(PACL Acl, __int64 a2, char a3, struct _ACL **a4)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( !v14 )
  {
    ...
    v16 = (ACL *)ExAllocatePool2(256LL, v15, 1633895502);
    v5 = v16;
    if ( v16 )
    {
