/*
 * XREFs of ?ndisIfUpdateInterfaceIsolationNetworkIdLocked@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@E@Z @ 0x14004B900
 * Callers:
 ...
 *     ?NETWORKBLOCK_DECREMENT_REF@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x140088E90 (-NETWORKBLOCK_DECREMENT_REF@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@@Z.c)
...
{
  __int64 v6; // rax
  struct _NDIS_IF_NETWORK_BLOCK *Network; // r14
  ...
  if ( !a1->NetworkIdOverridden || a3 )
  {
    ...
    {
LABEL_12:
      if ( a1->ProviderHandle == qword_1401275E0 && (a1->Flags & 2) != 0 )
      {
        if ( a1->IsNdisFilter )
        {
