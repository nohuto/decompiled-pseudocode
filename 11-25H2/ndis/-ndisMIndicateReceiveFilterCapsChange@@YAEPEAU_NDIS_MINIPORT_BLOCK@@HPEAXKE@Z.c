/*
 * XREFs of ?ndisMIndicateReceiveFilterCapsChange@@YAEPEAU_NDIS_MINIPORT_BLOCK@@HPEAXKE@Z @ 0x1400A5F28
 * Callers:
...
LABEL_11:
  ...
  if ( !ReceiveFilterCurrentCapabilities )
  {
    ReceiveFilterCurrentCapabilities = (_NDIS_RECEIVE_FILTER_CAPABILITIES *)ExAllocatePool2(64LL, 84LL, 1718568014);
