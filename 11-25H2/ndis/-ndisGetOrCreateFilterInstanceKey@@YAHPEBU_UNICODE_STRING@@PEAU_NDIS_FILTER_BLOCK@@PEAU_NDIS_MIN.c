/*
 * XREFs of ?ndisGetOrCreateFilterInstanceKey@@YAHPEBU_UNICODE_STRING@@PEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@EPEAEPEAU1@@Z @ 0x1400871E0
 * Callers:
...
LABEL_17:
  ...
  Pool2 = (wchar_t *)ExAllocatePool2(64LL, (unsigned __int16)(String1.Length + 2), 538985550);
...
LABEL_40:
  v14 = (unsigned __int16 *)ExAllocatePool2(66LL, 536LL, 538985550);
  if ( !v14 )
  {
    v7 = -1073741670;
    goto LABEL_17;
  ...
  if ( !*v43 )
  {
    ...
    *(_DWORD *)&v37.Length = 655368;
    v37.Buffer = (wchar_t *)ExAllocatePool2(64LL, 10LL, 538985550);
    if ( !v37.Buffer )
    {
      v7 = -1073741670;
      goto LABEL_17;
...
LABEL_67:
  ...
  v28 = ExAllocatePool2(64LL, v27, 538985550);
  v10 = (int)a1;
