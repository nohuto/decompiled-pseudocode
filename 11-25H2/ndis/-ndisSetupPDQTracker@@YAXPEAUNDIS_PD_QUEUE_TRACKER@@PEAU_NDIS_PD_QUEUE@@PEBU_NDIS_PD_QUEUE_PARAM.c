/*
 * XREFs of ?ndisSetupPDQTracker@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@PEAU_NDIS_PD_QUEUE@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAUNDIS_PD_ASSOCIATION@@PEAUNDIS_PD_COUNTER@@EE@Z @ 0x140148F64
 * Callers:
 ...
 * Callees:
 *     ?ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1401477B8 (-ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z.c)
        ...
        unsigned __int8 a7)
{
  ...
  *((_DWORD *)DeferredContext + 68) = _InterlockedIncrement((volatile signed __int32 *)&qword_140127008[1029].m_Lock.Ptr + 1);
  if ( a7 )
    ndisInitPDQAWM(DeferredContext);
  v10 = qword_140127008;
  a2->PDPlatformReserved[0] = (void *)a2->Dispatch;
  a2->Dispatch = (const _NDIS_PD_QUEUE_DISPATCH *)&unk_1400FC350;
