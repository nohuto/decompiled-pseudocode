/*
 * XREFs of NdisAllocateSharedMemory @ 0x140077CD0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qL @ 0x14000EA50 (WPP_RECORDER_SF_qL.c)
 *     WPP_RECORDER_SF_d @ 0x140026510 (WPP_RECORDER_SF_d.c)
 *     ??0NdisAllocateSharedMemoryTelemetry@@QEAA@_NPEBU_NDIS_SHARED_MEMORY_PARAMETERS@@H@Z @ 0x140077F00 (--0NdisAllocateSharedMemoryTelemetry@@QEAA@_NPEBU_NDIS_SHARED_MEMORY_PARAMETERS@@H@Z.c)
 ...
 *     ??0NdisDmaAllocationHistogramStopwatch@@QEAA@XZ @ 0x140173280 (--0NdisDmaAllocationHistogramStopwatch@@QEAA@XZ.c)
 *     ?SetMacAddress@NdisDmaAllocationHistogramStopwatch@@QEAAXQEBE@Z @ 0x140174170 (-SetMacAddress@NdisDmaAllocationHistogramStopwatch@@QEAAXQEBE@Z.c)
 */
