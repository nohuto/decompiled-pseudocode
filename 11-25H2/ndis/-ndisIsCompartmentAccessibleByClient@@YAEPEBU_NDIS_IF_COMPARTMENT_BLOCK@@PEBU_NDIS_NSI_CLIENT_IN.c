/*
 * XREFs of ?ndisIsCompartmentAccessibleByClient@@YAEPEBU_NDIS_IF_COMPARTMENT_BLOCK@@PEBU_NDIS_NSI_CLIENT_INFO@@E@Z @ 0x1400604C0
 * Callers:
 *     ndisConvertIdentifierIsCompartmentVisibile @ 0x14009F14C (ndisConvertIdentifierIsCompartmentVisibile.c)
