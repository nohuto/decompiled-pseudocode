/*
 * XREFs of ?ndisNsiEnumerateAllCompartments@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1400D26E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisIsCompartmentAccessibleByClient@@YAEPEBU_NDIS_IF_COMPARTMENT_BLOCK@@PEBU_NDIS_NSI_CLIENT_INFO@@E@Z @ 0x1400604C0 (-ndisIsCompartmentAccessibleByClient@@YAEPEBU_NDIS_IF_COMPARTMENT_BLOCK@@PEBU_NDIS_NSI_CLIENT_IN.c)
...
__int64 __fastcall ndisNsiEnumerateAllCompartments(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( qword_140126AF0 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_140126AF0 )
  {
    ...
    while ( v3 != (const struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_140126AF0 );
    v5 = v19;
  }
  v10 = *((_DWORD *)a1 + 22);
  *((_DWORD *)a1 + 22) = v6;
  if ( v10 )
  {
    ...
    do
    {
      if ( v15 == (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_140126AF0 )
        break;
