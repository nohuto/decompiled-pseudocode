/*
 * XREFs of WPP_RECORDER_SF_qDd @ 0x140015640
 * Callers:
 ...
 *     ?ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x140079000 (-ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 ...
 *     ?ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1400CE6F0 (-ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 * Callees:
