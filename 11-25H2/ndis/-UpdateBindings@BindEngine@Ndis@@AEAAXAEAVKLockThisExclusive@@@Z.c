/*
 * XREFs of ?UpdateBindings@BindEngine@Ndis@@AEAAXAEAVKLockThisExclusive@@@Z @ 0x14015DC00
 * Callers:
 *     ?UpdateBindingsWorkItem@BindEngine@Ndis@@AEAAXXZ @ 0x14015D3E0 (-UpdateBindingsWorkItem@BindEngine@Ndis@@AEAAXXZ.c)
 ...
 *     ?SetIterations@UpdateBindings@BindingMetrics@@QEAAX_K@Z @ 0x14008B550 (-SetIterations@UpdateBindings@BindingMetrics@@QEAAX_K@Z.c)
...
{
  struct KLockThisExclusive *v2; // rdi
  __int64 v4; // rsi
