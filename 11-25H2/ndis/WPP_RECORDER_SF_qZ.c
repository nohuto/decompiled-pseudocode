/*
 * XREFs of WPP_RECORDER_SF_qZ @ 0x1400291D0
 * Callers:
 ...
 *     NdisIMCancelInitializeDeviceInstance @ 0x1400A2980 (NdisIMCancelInitializeDeviceInstance.c)
...
LABEL_11:
  ...
  if ( !a7 )
    v16 = L"\b";
  ndisWppFastTraceMessage(a5, a4, &a6, 8LL, v16, 2LL, v15, v14, 0LL);
LABEL_2:
  if ( !v7 )
    v7 = L"\b";
  LOWORD(v17) = a4;
