/*
 * XREFs of ndisImmediateReadWritePort @ 0x1400DC1C8
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1400DC510 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1400DC530 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1400DC550 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1400DC590 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1400DC5C0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1400DC5F0 (NdisImmediateWritePortUshort.c)
 * Callees:
