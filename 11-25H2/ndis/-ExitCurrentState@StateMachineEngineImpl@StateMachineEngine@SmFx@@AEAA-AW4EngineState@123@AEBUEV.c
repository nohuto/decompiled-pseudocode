/*
 * XREFs of ?ExitCurrentState@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAA?AW4EngineState@123@AEBUEVENT_ACTION@123@@Z @ 0x1400ED524
 * Callers:
 ...
 *     ?GetSlotIndexForSlotType@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAAIAEBUSTATE_SPECIFICATION@3@W4StateSlotType@3@@Z @ 0x1400ED684 (-GetSlotIndexForSlotType@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAAIAEBUSTATE_SPECIFIC.c)
