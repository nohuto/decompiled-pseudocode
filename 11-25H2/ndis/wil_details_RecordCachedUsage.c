/*
 * XREFs of wil_details_RecordCachedUsage @ 0x1400A0034
 * Callers:
 *     wil_details_OnFeatureUsageProviderFlushNotification @ 0x140142710 (wil_details_OnFeatureUsageProviderFlushNotification.c)
 * Callees:
 *     __security_check_cookie @ 0x1400EDF40 (__security_check_cookie.c)
 *     wil_details_RecordFeatureUsageCallback @ 0x140142764 (wil_details_RecordFeatureUsageCallback.c)
 */
...
_DWORD *__fastcall wil_details_RecordCachedUsage(int a1, __int64 a2)
{
  ...
  v8 = (v6 - (char *)v9) >> 3;
  if ( v8 > 0 )
    return (_DWORD *)wil_details_RecordFeatureUsageCallback(v9, v8);
  return result;
}
