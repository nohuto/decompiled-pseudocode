/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1400ECDD0
 * Callers:
 *     TlgAggregateAbsorbEvent @ 0x1400ED10C (TlgAggregateAbsorbEvent.c)
 * Callees:
 *     AggregateField @ 0x1400EC84C (AggregateField.c)
