/*
 * XREFs of ndisRegisterScatterGatherDmaForGenericObject @ 0x1401556E0
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_DMA_ADAPTER@@$$A6AXPEAU1@@Z$1?CloseDmaAdapter@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1400E10E0 (--1-$unique_storage@U-$resource_policy@PEAU_DMA_ADAPTER@@$$A6AXPEAU1@@Z$1-CloseDmaAdapter@@YAX0@.c)
 *     __security_check_cookie @ 0x1400EDF40 (__security_check_cookie.c)
 *     memset @ 0x1400EE380 (memset.c)
 */

__int64 __fastcall ndisRegisterScatterGatherDmaForGenericObject(__int64 a1, __int64 a2, PVOID *a3)
{
  int v6; // edx
  unsigned int v7; // edi
  _DEVICE_OBJECT *v8; // rcx
  int v9; // edx
  struct _DMA_ADAPTER *v10; // r14
  int v11; // edx
  PVOID v12; // rbx
  ...
  *(_WORD *)&DeviceDescription.Master = 257;
  ...
  if ( DmaAdapter )
  {
    MakePoolPtrNP<_NDIS_SG_DMA_BLOCK>((__int64)&P);
    v12 = P;
    if ( P )
    {
      *(_DWORD *)P = 11534607;
