/*
 * XREFs of ?ndisOidPrePMAddWOLPattern@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x14005CBB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    ...
    v15 = ndisSourcePreAddWoLPattern(v1, 0LL, (struct _NDIS_OID_REQUEST *)v5, &v21);
    v2 = v21;
    *((_DWORD *)a1 + 10) = v15;
    if ( v2 )
      return v2;
  ...
  if ( v13 && (*(_DWORD *)(v5 + 88) & 0x4000) == 0 )
  {
    ...
    v17 = ndisSourcePreAddWoLPattern(0LL, v13, (struct _NDIS_OID_REQUEST *)v5, &v21);
    v2 = v21;
    *((_DWORD *)a1 + 10) = v17;
    if ( v2 )
      return v2;
