/*
 * XREFs of ?AggregateEvent@NdisFreeSharedMemoryTelemetry@@AEBAXXZ @ 0x1400E3358
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::AggregateEvent(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  v24 = *((_DWORD *)this + 10);
  v25 = *((_DWORD *)this + 11);
  if ( (unsigned int)dword_1401247B0 > 4 && tlgKeywordOn((__int64)&dword_1401247B0, 2048LL) )
  {
    v21 = *(_DWORD *)(v2 + 192);
    v19 = &v24;
    v22 = *(_DWORD *)(v2 + 32);
