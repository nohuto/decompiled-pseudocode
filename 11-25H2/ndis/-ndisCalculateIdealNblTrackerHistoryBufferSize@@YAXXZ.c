/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1401434F0
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1401970B8 (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1400EDF40 (__security_check_cookie.c)
 *     memset @ 0x1400EE380 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x140197098 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
