/*
 * XREFs of WPP_RECORDER_SF_dL @ 0x1400816D0
 * Callers:
...
__int64 WPP_RECORDER_SF_dL(__int64 a1, unsigned __int8 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= a2 )
    ndisWppFastTraceMessage(&WPP_0ffebb44763b3fc5c7acd63373d92315_Traceguids, a4, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v9) = a4;
  return WppAutoLogTrace(a1, v7, 22LL, &WPP_0ffebb44763b3fc5c7acd63373d92315_Traceguids, v9, (__int64 *)va, 4LL, va1);
}
