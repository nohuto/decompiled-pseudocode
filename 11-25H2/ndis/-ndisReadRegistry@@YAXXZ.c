/*
 * XREFs of ?ndisReadRegistry@@YAXXZ @ 0x1400A2340
 * Callers:
...
void ndisReadRegistry(void)
{
  ...
  ndisRegisterKnobs(&stru_1400FD3C0, 0x27uLL, v0, 0LL, v3);
  ...
  if ( (unsigned int)(dword_140125508 - 1) > 0x1E )
    dword_140125508 = 8;
  ...
  if ( (unsigned int)Feature_NDPQualityWinter25__private_IsEnabledDeviceUsageNoInline() )
    ndisNDPQualityWinter25IsEnabled = 1;
}
