/*
 * XREFs of ndisBindBuilderLoadSettings @ 0x140198EB4
 * Callers:
...
LABEL_8:
  ...
  if ( !ValueString )
  {
    Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_140127138, v9[1]);
    *((_QWORD *)qword_140127138 + 11) = Atom;
    if ( Atom )
      goto LABEL_8;
    wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString>>::reset((void **)&v9, 0LL);
    v2 = -1073741670;
