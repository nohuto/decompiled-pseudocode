/*
 * XREFs of ??$TraceLoggingWriteOidRequestCompletedActivity@$01@@YAXPEBU_NDIS_REQ_TRACKER@@@Z @ 0x1400249B0
 * Callers:
...
__int64 __fastcall TraceLoggingWriteOidRequestCompletedActivity<2>(__int64 *a1)
{
  __int64 result; // rax
  void *v2; // r8
  __int64 v4; // rcx
