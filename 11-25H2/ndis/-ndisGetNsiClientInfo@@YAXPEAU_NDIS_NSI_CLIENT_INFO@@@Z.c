/*
 * XREFs of ?ndisGetNsiClientInfo@@YAXPEAU_NDIS_NSI_CLIENT_INFO@@@Z @ 0x14004A950
 * Callers:
...
LABEL_9:
          if ( v9 < dword_140126990 )
          {
            v21 = 0;
            v22 = KeAcquireSpinLockRaiseToDpc(&qword_1401269E0);
            if ( v9 < dword_140126990 )
              v21 = *((_DWORD *)qword_140126A30 + 6 * v9);
            KeReleaseSpinLock(&qword_1401269E0, v22);
            if ( !v21 )
              v21 = 1;
            v10 = v21;
          }
