/*
 * XREFs of KRegKey::QueryValueMultisz__lambda_e7cfcc3f3a6a3b9bada4f20c4517f5e3___lambda_d0aabbab13d03fe2b2b867a1fab03655___ @ 0x140169E80
 * Callers:
        ...
        Ndis::BindStack *a4)
{
  ...
  {
    Pool2 = (wchar_t *)ExAllocatePool2(256LL, ResultLength[0], 2052287565);
    v10 = Pool2;
    if ( !Pool2 )
      return -1073741670;
