/*
 * XREFs of ?NdisTraceLoggingDeviceAdded@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEBUNDIS_MINIPORT_CREATION_CONFIG@@JPEB_WE@Z @ 0x140068060
 * Callers:
  ...
  if ( a4 < 0 )
  {
      ...
      && (qword_140124800 & 0x400000000000LL) == qword_140124800 )
    {
      ...
      *(_DWORD *)&EventDescriptor.Level = 5;
      UserData.Ptr = (unsigned __int64)off_1401247F0;
      v36 = 8LL;
      v34 = 16LL;
      v32 = 4LL;
      v30 = 4LL;
      *(_DWORD *)&EventDescriptor.Id = 184549376;
      ...
      UserData.Size = *(unsigned __int16 *)off_1401247F0;
      v26 = &unk_14010B2A2;
      UserData.Reserved = 2;
      v27 = 101;
      v28 = 1;
