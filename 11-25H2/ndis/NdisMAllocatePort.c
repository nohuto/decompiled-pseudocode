/*
 * XREFs of NdisMAllocatePort @ 0x140080BE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAddPortToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PORT_BLOCK@@@Z @ 0x1400AFDE4 (-ndisAddPortToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PORT_BLOCK@@@Z.c)
...
LABEL_9:
  ...
  {
    v19 = (_BYTE *)ExAllocatePool2(66LL, v17, 1869628494);
    v20 = v19;
    if ( v19 )
    {
      if ( v9 )
