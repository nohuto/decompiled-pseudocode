/*
 * XREFs of ?ndisNblTrackerRecordEventInternal@@YAXPEAU_NET_BUFFER_LIST@@PEAUNDIS_NBL_TRACKER_HANDLE__@@KPEAXK@Z @ 0x14001F630
 * Callers:
 ...
 *     NdisNblTrackerRecordEvent @ 0x1400AA1C0 (NdisNblTrackerRecordEvent.c)
 ...
 *     ?ndisNblTrackerHitBreakNbl@@YAXPEAU_NET_BUFFER_LIST@@PEAXK@Z @ 0x1400A9C24 (-ndisNblTrackerHitBreakNbl@@YAXPEAU_NET_BUFFER_LIST@@PEAXK@Z.c)
