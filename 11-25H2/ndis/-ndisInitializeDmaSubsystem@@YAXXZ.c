/*
 * XREFs of ?ndisInitializeDmaSubsystem@@YAXXZ @ 0x1400E1218
 * Callers:
        ...
        unsigned __int8 (*a3)(void *, const struct KnobDescriptor *, unsigned __int64 *))
{
  ...
  ndisRegisterKnobs(&stru_1400FDE50, 1uLL, a3, 0LL, v4);
  KPushLockManualConstruct::Initialize((KPushLockManualConstruct *)&unk_140126BA8);
  ndisDmaTelemetryUpdateBucketSchema(0x4210900080204uLL);
  ndisRegisterKnobs(&stru_1400FDE80, 1uLL, v3, ndisDmaTelemetryKnobsUpdateRoutine, v5);
}
