/*
 * XREFs of ?ndisMQueueOidRequest@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x140060520
 * Callers:
...
LABEL_16:
        if ( *(_QWORD *)&a2->NdisReserved[24] )
          TraceLoggingWriteOidRequestQueuedActivity<0,_NDIS_MINIPORT_BLOCK>(a1, a2);
        else
          TraceLoggingWriteOidRequestQueuedActivity<1,_NDIS_MINIPORT_BLOCK>(a1, a2);
      }
    }
  }
LABEL_5:
