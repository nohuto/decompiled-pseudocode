/*
 * XREFs of McTemplateK0jqxz_EtwWriteTransfer @ 0x1400755B0
 * Callers:
        ...
        const wchar_t *a7)
{
  ...
  __int64 v8; // rax
  int v10; // eax
  _EVENT_DATA_DESCRIPTOR v12; // [rsp+30h] [rbp-68h] BYREF
  ...
  if ( !a7 )
    v7 = L"NULL";
  v19 = v7;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &CloseAdapter, a3, 5u, &v12);
}
