/*
 * XREFs of ?ndisSetEnableWakeUp@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400BD204
 * Callers:
 *     ?ndisOidPreEnableWakeUp@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400BB090 (-ndisOidPreEnableWakeUp@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
 ...
 *     ?ndisXlateWakeUpEnableToPMParametersOid@@YAHPEAU_NDIS_OID_REQUEST@@@Z @ 0x1400BE840 (-ndisXlateWakeUpEnableToPMParametersOid@@YAHPEAU_NDIS_OID_REQUEST@@@Z.c)
 *     McTemplateK0jqxtpp_EtwWriteTransfer @ 0x1400BEDC4 (McTemplateK0jqxtpp_EtwWriteTransfer.c)
 */

char __fastcall ndisSetEnableWakeUp(struct _NDIS_REQ_TRACKER *a1)
{
