/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x140146230
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIClearReceiveFilter(struct NDIS_PD_FILTER_HANDLE__ *a1)
{
  ...
  struct NDIS_PD_FILTER_HANDLE__ *v11; // r8
  struct NDIS_PD_FILTER_HANDLE__ **v12; // rdx
  KLockThisExclusive v13; // [rsp+30h] [rbp-38h] BYREF
  ...
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      (char)a1);
  KLockThisExclusive::KLockThisExclusive(&v13, qword_140127008);
...
LABEL_11:
  ...
  *((_QWORD *)a1 + 2) = 0LL;
  ...
  NDIS_PD_FILTER::`scalar deleting destructor'((NDIS_PD_FILTER *)a1);
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      4,
