/*
 * XREFs of ?ndisCreateThreadStateObjectType@@YAJXZ @ 0x1400EB938
 * Callers:
...
__int64 ndisCreateThreadStateObjectType(void)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0x200000LL;
  ...
  LODWORD(v3[1]) = 256;
  HIDWORD(v3[4]) = 512;
  *(_OWORD *)((char *)&v3[1] + 4) = xmmword_140107E40;
  HIDWORD(v3[3]) = 2031616;
  LODWORD(v3[5]) = 32;
  v3[9] = ndisThreadStateDelete;
  v0 = ObCreateObjectType(&DestinationString, v3, 0LL, &qword_140127858);
  if ( !v0 )
    return 0LL;
