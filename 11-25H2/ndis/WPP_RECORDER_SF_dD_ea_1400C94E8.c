/*
 * XREFs of WPP_RECORDER_SF_dD @ 0x1400C94E8
 * Callers:
...
__int64 WPP_RECORDER_SF_dD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_2fb632d9e69632cc5880b19a4ac60799_Traceguids, 0xFu, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v7) = 15;
  return WppAutoLogTrace(a1, 2LL, 12LL, &WPP_2fb632d9e69632cc5880b19a4ac60799_Traceguids, v7, (__int64 *)va, 4LL, va1);
}
