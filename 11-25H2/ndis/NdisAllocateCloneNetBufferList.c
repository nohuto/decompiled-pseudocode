/*
 * XREFs of NdisAllocateCloneNetBufferList @ 0x14001A7F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  if ( NetBufferList )
  {
    ...
    if ( Microsoft_Windows_Networking_CorrelationEnabled )
    {
      ...
      if ( (__int64)NetBufferList->NetBufferListInfo[13] > 0 )
      {
        ...
        if ( NetBufferList->Link.Alignment )
        {
          do
          {
            ...
            if ( !v38 || v38 < 0 )
            {
              CorrelationIds = (unsigned int)ndisGenerateCorrelationIds(1LL, v34);
      ...
      {
        v35 = _InterlockedExchangeAdd(&dword_140124F28, 1u);
        if ( v35 + 1 < v35 )
          v35 = _InterlockedExchangeAdd(&dword_140124F28, 1u);
        do
        {
