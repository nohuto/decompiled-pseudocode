/*
 * XREFs of McTemplateK0jqxptdq_EtwWriteTransfer @ 0x1400234F0
 * Callers:
...
__int64 McTemplateK0jqxptdq_EtwWriteTransfer(
        _DWORD a1,
        _DWORD a2,
        __int64 a3,
        __int64 a4,
        ...
        ...)
{
  _BYTE v9[16]; // [rsp+30h] [rbp-69h] BYREF
  ...
  v21 = 4LL;
  v23 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&NDIS_PROVIDER_ID_Context, &DoOidRequest, a3, 8LL, v9);
}
