/*
 * XREFs of ??1MiniportDevicePnPEventNotify@AzTelemetry@@UEAA@XZ @ 0x14008D950
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)this = &AzTelemetry::MiniportDevicePnPEventNotify::`vftable';
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1401247B0, 512LL, a3, a4) )
    {
