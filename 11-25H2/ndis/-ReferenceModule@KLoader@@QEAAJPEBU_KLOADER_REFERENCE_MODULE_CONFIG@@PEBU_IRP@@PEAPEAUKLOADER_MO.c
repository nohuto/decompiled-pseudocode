/*
 * XREFs of ?ReferenceModule@KLoader@@QEAAJPEBU_KLOADER_REFERENCE_MODULE_CONFIG@@PEBU_IRP@@PEAPEAUKLOADER_MODULE_REFERENCE__@@@Z @ 0x140141150
 * Callers:
        ...
        struct KLOADER_MODULE_REFERENCE__ **a4)
{
  ...
  v19 = this;
  v4 = *(_OWORD *)((char *)a2 + 8);
  v5 = (KLoader *)qword_140126BC8;
  v19 = 0LL;
  *(_OWORD *)&v18.m_State = v4;
  result = KLoader::ReferenceKModule((KLoader *)qword_140126BC8, (struct _GUID *)&v18, &v19);
  if ( !(_DWORD)result )
  {
