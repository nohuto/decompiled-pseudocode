/*
 * XREFs of ndisReadCtaPolicy @ 0x140142BD8
 * Callers:
 *     ndisHiveLoadCallback @ 0x140142BC0 (ndisHiveLoadCallback.c)
 * Callees:
 *     ??$WriteNoFence@EX@mem@@YAXPECEE@Z @ 0x14009A710 (--$WriteNoFence@EX@mem@@YAXPECEE@Z.c)
