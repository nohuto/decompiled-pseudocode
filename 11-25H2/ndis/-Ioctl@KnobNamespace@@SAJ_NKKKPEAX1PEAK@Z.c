/*
 * XREFs of ?Ioctl@KnobNamespace@@SAJ_NKKKPEAX1PEAK@Z @ 0x140153DD0
 * Callers:
 ...
 *     CopyKnobInformationToIoctl @ 0x140153BCC (CopyKnobInformationToIoctl.c)
 *     ?EnumerateKnobs@KnobNamespace@@AEAAXP6AXPEAXPEB_W@Z0@Z @ 0x140153C60 (-EnumerateKnobs@KnobNamespace@@AEAAXP6AXPEAXPEB_W@Z0@Z.c)
 *     ?FindById@KnobNamespace@@CAPEAV1@PEBU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x140153CF0 (-FindById@KnobNamespace@@CAPEAV1@PEBU_CONFIG_KNOB_NAMESPACE@@@Z.c)
      ...
      if ( v13 )
      {
        ...
        if ( a1 )
        {
          if ( a3 >= 0x2C && a4 >= 8 )
          {
            ...
            if ( *a5 == 1 )
            {
              KLockThisShared::KLockThisShared(&v37, &stru_140126B90);
...
LABEL_32:
  ...
  if ( a3 >= 0x18 && a4 >= 0xC )
  {
    ...
    if ( *a5 == 1 )
    {
      KLockThisShared::KLockThisShared((KLockThisShared *)&v38, &stru_140126B90);
