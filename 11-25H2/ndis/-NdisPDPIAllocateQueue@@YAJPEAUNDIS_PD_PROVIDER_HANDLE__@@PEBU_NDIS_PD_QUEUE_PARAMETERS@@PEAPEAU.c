/*
 * XREFs of ?NdisPDPIAllocateQueue@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@@Z @ 0x140146020
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ @ 0x1401443CC (--0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ.c)
