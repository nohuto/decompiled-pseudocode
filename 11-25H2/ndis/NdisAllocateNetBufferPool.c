/*
 * XREFs of NdisAllocateNetBufferPool @ 0x140070A50
 * Callers:
...
LABEL_14:
    ...
    if ( Pool )
    {
      ...
      *((_QWORD *)v2 + 2) = (char *)v2 + 16;
      v19 = KeAcquireSpinLockRaiseToDpc(&qword_140126980);
      v20 = qword_140127170;
      v21 = (_QWORD *)((char *)v2 + 64);
      if ( *(__int64 **)(qword_140127170 + 8) != &qword_140127170 )
        __fastfail(3u);
      *v21 = qword_140127170;
      *((_QWORD *)v2 + 9) = &qword_140127170;
      *(_QWORD *)(v20 + 8) = v21;
      qword_140127170 = (__int64)v2 + 64;
      KeReleaseSpinLock(&qword_140126980, v19);
      *((_QWORD *)v2 + 6) = v23;
    }
    goto LABEL_20;
  }
