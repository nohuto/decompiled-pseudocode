/*
 * XREFs of ?NdisTraceLoggingPowerOnStatistics@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x140098DD0
 * Callers:
 ...
 *     ?ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z @ 0x14008D700 (-ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z.c)
...
void __fastcall NdisTraceLoggingPowerOnStatistics(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  {
    v18.QuadPart = 0LL;
    ndisConvertInterruptTimeToLocalTime((__int64)a1, &v18);
    if ( (unsigned int)dword_1401247E8 > 5 && tlgKeywordOn((__int64)&dword_1401247E8, 0x400000000000LL) )
    {
      ...
      v20 = v7;
      v8 = *((_QWORD *)AoAc + 142);
      v9 = *((unsigned int *)AoAc + 282);
      v10 = *((_QWORD *)AoAc + 140);
      v11 = *((_QWORD *)AoAc + 139);
      v12 = *((_QWORD *)AoAc + 138);
      v13 = *((unsigned int *)AoAc + 272);
      v14 = v18;
