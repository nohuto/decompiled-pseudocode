/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x14015A0A8
 * Callers:
 ...
 *     DestroyAggregateSession @ 0x140159A48 (DestroyAggregateSession.c)
 */
...
__int64 TlgRegisterAggregateProviderEx()
{
  ...
  if ( !TlgAggregateSession )
    return TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((char *)&dword_1401247B0, 0LL, 0LL);
  TlgAggregateSession[41] = 0LL;
  TlgAggregateSession[42] = 0LL;
  TlgAggregateSession[43] = &dword_1401247B0;
  ...
  *((_DWORD *)TlgAggregateSession + 92) = ComputeFlushPeriod((unsigned __int64)TlgAggregateSession);
  ...
  {
    ExAcquirePushLockExclusiveEx(&unk_1401278E8, 0LL);
    if ( !qword_1401278E0 )
      TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(
        (char *)&dword_1401248D0,
        (__int64)TlgAggregateInternalProviderCallback,
        0LL);
    for ( i = &qword_1401278E0; ; i = (__int64 *)(v7 + 352) )
    {
      v7 = *i;
      if ( !*i )
        break;
      if ( *(int **)(v7 + 344) == &dword_1401247B0 )
        goto LABEL_11;
    }
    *i = (__int64)v1;
LABEL_11:
