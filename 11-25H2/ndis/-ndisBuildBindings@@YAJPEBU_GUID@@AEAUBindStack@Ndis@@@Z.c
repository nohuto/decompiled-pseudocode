/*
 * XREFs of ?ndisBuildBindings@@YAJPEBU_GUID@@AEAUBindStack@Ndis@@@Z @ 0x140150970
 * Callers:
 ...
 * Callees:
 *     ??1NetworkInterfaceBindProperties@@QEAA@XZ @ 0x1400CD744 (--1NetworkInterfaceBindProperties@@QEAA@XZ.c)
...
__int64 __fastcall ndisBuildBindings(const struct _GUID *a1, struct Ndis::BindStack *a2)
{
  ...
  v6 = 0LL;
  v7 = 0LL;
  v8 = *((unsigned int *)qword_140127138 + 7);
  while ( v6 != v8 )
  {
...
LABEL_2:
  ...
  else
  {
    ...
    v13 = 0LL;
    v14 = 0LL;
    v15 = *((unsigned int *)qword_140127138 + 11);
    v19 = v15;
    while ( v13 != v15 )
    {
