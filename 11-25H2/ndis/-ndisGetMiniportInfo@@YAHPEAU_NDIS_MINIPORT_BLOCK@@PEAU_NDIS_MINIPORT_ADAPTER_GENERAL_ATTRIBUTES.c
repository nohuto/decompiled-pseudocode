/*
 * XREFs of ?ndisGetMiniportInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES@@PEAJPEAE2@Z @ 0x14008B710
 * Callers:
        ...
        int *a5)
{
  ...
  struct _NDIS_PNP_CAPABILITIES v53; // [rsp+D0h] [rbp-30h] BYREF
  struct _NDIS_OID_REQUEST v54; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_20:
  ...
  v19 = a1->MediaType;
  if ( (unsigned int)v19 <= 0x13 && ndisMediaTypeCl[v19] || (_DWORD)v19 == 3 )
  {
...
LABEL_84:
      ...
      {
        v53 = 0LL;
        v36 = ndisMDoMiniportOp(a1, 1u, 0xFD010100, &v53, 16, 25, 0);
        *v47 = v36;
        if ( !v36 )
          ndisConvertPnpCapabilitiesToPM(&v53, v8->PowerManagementCapabilitiesEx);
      }
      ...
      *((_QWORD *)&v51 + 1) = a1;
      memset(&v54, 0, 248);
      if ( (((unsigned int)ndisQueryDeviceOid((struct _NDIS_USER_OPEN_CONTEXT *)&v51, &v54, 0x10101u, 0LL, 0)
           + 1073676268) & 0xFFFFFFFD) == 0 )
      {
        BytesNeeded = v54.DATA.QUERY_INFORMATION.BytesNeeded;
        Pool2 = (unsigned int *)ExAllocatePool2(64LL, v54.DATA.QUERY_INFORMATION.BytesNeeded, 538985550);
        v47 = Pool2;
        if ( Pool2 )
        {
