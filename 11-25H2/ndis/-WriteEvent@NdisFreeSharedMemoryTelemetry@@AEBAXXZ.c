/*
 * XREFs of ?WriteEvent@NdisFreeSharedMemoryTelemetry@@AEBAXXZ @ 0x1400E35F0
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::WriteEvent(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  if ( (unsigned int)dword_1401247B0 > 4 && tlgKeywordOn((__int64)&dword_1401247B0, 64LL) )
  {
    v18 = v10;
    v17 = v21;
    v12 = v11;
