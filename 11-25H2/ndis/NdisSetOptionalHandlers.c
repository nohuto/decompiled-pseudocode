/*
 * XREFs of NdisSetOptionalHandlers @ 0x14009DED0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x140148A5C (-ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 ...
 *     ?ndisSetNDKHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x14014B694 (-ndisSetNDKHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 *     ?ndisSetSSHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x14014C2CC (-ndisSetSSHandlers@@YAHPEAXPEAU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 */
...
LABEL_37:
      ...
      restarted = ndisFSetRestartAttributes(
                    ...
                    (struct _NDIS_FILTER_PARTIAL_CHARACTERISTICS *)v2);
LABEL_52:
      v4 = restarted;
      goto LABEL_87;
    }
...
LABEL_54:
  ...
  if ( Type != 176 )
  {
    ...
    if ( Revision == 2 )
    {
      v20 = v2->Header.Size < 0xF0u;
    }
    else
    {
      if ( Revision != 1 )
        goto LABEL_75;
      v20 = v2->Header.Size < 0x70u;
    }
    if ( v20 )
      goto LABEL_54;
LABEL_75:
