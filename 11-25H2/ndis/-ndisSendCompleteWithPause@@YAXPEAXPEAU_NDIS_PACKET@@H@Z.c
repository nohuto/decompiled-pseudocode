/*
 * XREFs of ?ndisSendCompleteWithPause@@YAXPEAXPEAU_NDIS_PACKET@@H@Z @ 0x14008A470
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisSendCompleteWithPause(__int64 a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  *(_DWORD *)v8 = 0;
  v9 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 624));
  v10 = *(_DWORD *)(a1 + 644) - 1;
  *(_BYTE *)(a1 + 632) = v9;
  v11 = *(_DWORD *)(a1 + 640) == 1;
  *(_DWORD *)(a1 + 644) = v10;
  if ( v11 )
    v5 = v10 == 0;
  KeReleaseSpinLock((PKSPIN_LOCK)(a1 + 624), v9);
