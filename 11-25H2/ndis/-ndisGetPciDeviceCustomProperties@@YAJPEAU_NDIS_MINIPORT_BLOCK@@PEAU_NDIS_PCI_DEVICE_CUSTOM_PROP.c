/*
 * XREFs of ?ndisGetPciDeviceCustomProperties@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PCI_DEVICE_CUSTOM_PROPERTIES@@@Z @ 0x14009B92C
 * Callers:
...
{
  struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES *v2; // rbx
  ...
  p_DeviceType = &v2->DeviceType;
  *(_OWORD *)&v2->Header.Type = 0LL;
  *(_OWORD *)&v2->MaxPayloadSize = 0LL;
  *(_OWORD *)&v2->MaxLinkSpeed = 0LL;
  v2->MaxInterruptMessages = 0;
  v2->Header = (_NDIS_OBJECT_HEADER)3408512;
