/*
 * XREFs of ?ndisPcwAddCounter@@YAJW4_NDIS_COUNTER_SET_ID@@PEAU_PCW_COUNTER_INFORMATION@@@Z @ 0x14014A348
 * Callers:
...
__int64 __fastcall ndisPcwAddCounter(unsigned int a1, __int64 a2)
{
  ...
  Pool2 = ExAllocatePool2(256LL, (unsigned int)(v4 + 56), 2002994254);
  v6 = (_QWORD *)Pool2;
  if ( Pool2 )
  {
