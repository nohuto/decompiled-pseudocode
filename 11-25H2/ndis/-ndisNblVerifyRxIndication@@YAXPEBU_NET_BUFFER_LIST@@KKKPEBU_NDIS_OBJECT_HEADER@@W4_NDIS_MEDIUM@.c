/*
 * XREFs of ?ndisNblVerifyRxIndication@@YAXPEBU_NET_BUFFER_LIST@@KKKPEBU_NDIS_OBJECT_HEADER@@W4_NDIS_MEDIUM@@@Z @ 0x140035040
 * Callers:
        ...
        enum _NDIS_MEDIUM a6)
{
  ...
  if ( v8 )
  {
    ...
    {
      ++v12;
      verifySingleRxNbl(Alignment, a5);
      v25 = 0;
      LOBYTE(v28) = 0;
      if ( ndisParseReceivedNBL(a6, Alignment, &v25, (unsigned __int8 *)&v28) && (_BYTE)v28 )
      {
        v13 |= v25;
        v14 |= ~v25;
      }
