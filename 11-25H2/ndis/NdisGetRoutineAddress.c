/*
 * XREFs of NdisGetRoutineAddress @ 0x1400CD470
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1400CD0A0 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1400CD374 (FindExportedRoutineByName.c)
