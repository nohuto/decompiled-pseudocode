/*
 * XREFs of ?ndisNetBufferToPacket@@YAHPEAU_NET_BUFFER@@EPEAPEAU_NDIS_PACKET@@@Z @ 0x14002FC30
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(struct _NET_BUFFER *a1, char a2, struct _NDIS_PACKET **a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rdx
  $DCC3A5A7E49E521B28EAF966F8F4EB58 *ProtocolReserved; // r10
  _MDL *CurrentMdl; // rax
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($DCC3A5A7E49E521B28EAF966F8F4EB58 *)v8->ProtocolReserved;
    if ( !a2 )
