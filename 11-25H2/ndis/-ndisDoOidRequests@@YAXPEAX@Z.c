/*
 * XREFs of ?ndisDoOidRequests@@YAXPEAX@Z @ 0x140015A90
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)v1 != 17 )
  {
    ...
    if ( KeExpandKernelStackAndCalloutEx(ndisFDoOidRequestInternal, (PVOID)v1, (unsigned int)Size, 0, 0LL) < 0 )
    {
      ...
      *(_BYTE *)(v1 + 232) = 1;
      ...
      {
        v28 = 0;
        ndisReferenceRefEx((PKSPIN_LOCK)(v1 + 72), 1u, (enum _NDIS_REFERENCE_STATUS *)&v28);
        *(_BYTE *)(v1 + 224) = 1;
...
LABEL_15:
  ...
  if ( *(_BYTE *)(v11 + 2) <= 0x47u )
    ndisBugCheckEx(0x1EuLL, 2uLL, v11, 0x47uLL);
  if ( *(_BYTE *)(v11 + 1) )
  {
    if ( *(_BYTE *)(v11 + 1) != 1 )
      goto LABEL_29;
...
LABEL_49:
    ndisReportRefcountImbalance(v11, 0x47u);
  }
  v13 = *(_QWORD *)(v11 + 8);
  if ( v13 )
  {
...
LABEL_28:
  if ( !_bittestandreset((signed __int32 *)(v11 + 24), 7u) )
    goto LABEL_49;
LABEL_29:
  v14 = *(_DWORD *)(v1 + 4440) - 1;
  *(_DWORD *)(v1 + 4440) = v14;
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    *(_DWORD *)v27 = *(_DWORD *)(v1 + 4440);
    WPP_RECORDER_SF_qL(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      4u,
      0x14u,
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)(v1 + 4432), v12);
  if ( !v14 )
  {
