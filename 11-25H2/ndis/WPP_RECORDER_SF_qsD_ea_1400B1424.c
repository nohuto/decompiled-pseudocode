/*
 * XREFs of WPP_RECORDER_SF_qsD @ 0x1400B1424
 * Callers:
...
__int64 WPP_RECORDER_SF_qsD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !v15 )
      v10 = "NULL";
    ndisWppFastTraceMessage(&WPP_4a94757187d03d50151c0070042f9279_Traceguids, 0x91u, va, 8LL, v10, v9, va1, 4LL, 0LL);
  }
  if ( v5 )
  {
    do
  ...
  if ( !v5 )
    v5 = "NULL";
  LOWORD(v12) = 145;
  return WppAutoLogTrace(a1, 2LL, 14LL, &WPP_4a94757187d03d50151c0070042f9279_Traceguids, v12, (__int64 *)va, 8LL, v5);
}
