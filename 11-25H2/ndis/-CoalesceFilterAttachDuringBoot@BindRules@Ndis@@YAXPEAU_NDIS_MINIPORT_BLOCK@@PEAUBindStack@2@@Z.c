/*
 * XREFs of ?CoalesceFilterAttachDuringBoot@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUBindStack@2@@Z @ 0x140165270
 * Callers:
        ...
        struct Ndis::BindStack *a3)
{
  ...
  __int64 v11; // rdx
  int SpinLock; // edx
  $4E30824A80479617F9AA9ECC46CB5756 *v13; // rsi
  $4E30824A80479617F9AA9ECC46CB5756 *v14; // r14
  bool v15; // cf
  __int64 v16; // rax
