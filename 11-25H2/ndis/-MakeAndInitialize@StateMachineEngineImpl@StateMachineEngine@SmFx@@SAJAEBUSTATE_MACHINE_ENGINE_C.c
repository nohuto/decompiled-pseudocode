/*
 * XREFs of ?MakeAndInitialize@StateMachineEngineImpl@StateMachineEngine@SmFx@@SAJAEBUSTATE_MACHINE_ENGINE_CONFIG@3@PEAPEAV123@@Z @ 0x1400ED90C
 * Callers:
        ...
        struct SmFx::StateMachineEngine::StateMachineEngineImpl **a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)v7 + 131) = a2;
    ...
    if ( v8 < 0 )
    {
      SmFx::StateMachineEngine::StateMachineEngineImpl::Destroy((SmFx::StateMachineEngine::StateMachineEngineImpl *)v7);
      *a2 = 0LL;
    }
    else
    {
