/*
 * XREFs of ?ndisReinitializeHistograms@@YAJXZ @ 0x140143CD8
 * Callers:
 ...
 *     ??3?$KALLOCATOR@$0GHGIEEEO@$00@@SAXPEAX@Z @ 0x140143788 (--3-$KALLOCATOR@$0GHGIEEEO@$00@@SAXPEAX@Z.c)
...
LABEL_8:
      ...
      KLockThisExclusive::KLockThisExclusive(&v11, &stru_140126928);
      if ( qword_140126FE8 )
      {
        ndisHistogramDeleteAllEntries();
        KALLOCATOR<1734886478,1>::operator delete(qword_140126FE8);
        qword_140126FE8 = 0LL;
      }
      v7 = v2;
      if ( v10 )
