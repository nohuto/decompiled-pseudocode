/*
 * XREFs of WPP_RECORDER_SF_ld @ 0x1400D31D4
 * Callers:
...
__int64 WPP_RECORDER_SF_ld(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_a2f9ce1be4323b4178fc783abbe12af0_Traceguids, 0x28u, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v7) = 40;
  return WppAutoLogTrace(a1, 2LL, 22LL, &WPP_a2f9ce1be4323b4178fc783abbe12af0_Traceguids, v7, (__int64 *)va, 4LL, va1);
}
