/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEBT_NET_LUID_LH@@PEBU_GUID@@PEBUNdisNetworkInterfacePersistedState@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x14016E8A0
 * Callers:
 ...
 *     ?ndisIfNdisProviderGetHandle@@YAPEAX_N@Z @ 0x14008C580 (-ndisIfNdisProviderGetHandle@@YAPEAX_N@Z.c)
...
LABEL_23:
          ...
          *(_OWORD *)(v13 + 52) = *((_OWORD *)a3 + 2);
          if ( v39 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1401271B2);
            ...
            *(_WORD *)(v13 + 48) = v40;
            RtlInitUnicodeString(&DestinationString, &xmmword_1401273C2);
            *(_DWORD *)&Destination.Length = 0x2000000;
