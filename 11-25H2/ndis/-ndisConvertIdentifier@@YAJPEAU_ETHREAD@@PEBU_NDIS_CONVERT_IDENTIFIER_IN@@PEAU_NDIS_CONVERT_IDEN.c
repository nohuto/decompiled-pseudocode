/*
 * XREFs of ?ndisConvertIdentifier@@YAJPEAU_ETHREAD@@PEBU_NDIS_CONVERT_IDENTIFIER_IN@@PEAU_NDIS_CONVERT_IDENTIFIER_OUT@@@Z @ 0x140142290
 * Callers:
 *     ndisFastIoDeviceControl @ 0x14006DA20 (ndisFastIoDeviceControl.c)
 * Callees:
 *     ?ndisGetNsiClientInfoForThread@@YAXPEAU_ETHREAD@@PEAU_NDIS_NSI_CLIENT_INFO@@@Z @ 0x14005FA50 (-ndisGetNsiClientInfoForThread@@YAXPEAU_ETHREAD@@PEAU_NDIS_NSI_CLIENT_INFO@@@Z.c)
        ...
        struct _NDIS_CONVERT_IDENTIFIER_OUT *a3)
{
  ...
  {
    ndisGetNsiClientInfoForThread(Thread, (struct _NDIS_NSI_CLIENT_INFO *)((char *)&v13 + 4));
  }
  if ( !v4 )
