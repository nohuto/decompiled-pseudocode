/*
 * XREFs of ?NdisReadConfigShimHook@@YAXPEAHPEAPEAU_NDIS_CONFIGURATION_PARAMETER@@PEAXPEAU_UNICODE_STRING@@W4_NDIS_PARAMETER_TYPE@@@Z @ 0x1400B6500
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _NDIS_PARAMETER_TYPE a5)
{
  ...
  {
    if ( RtlEqualUnicodeString(a4, &stru_1401246C0, 1u) )
    {
