/*
 * XREFs of ?ndisPostSetMiniportRSSParameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1400C3C34
 * Callers:
 ...
 *     ?ndisPcwGetCpu@@YAKPEAUNDIS_PCW_CONTEXT@@@Z @ 0x140061D30 (-ndisPcwGetCpu@@YAKPEAUNDIS_PCW_CONTEXT@@@Z.c)
...
void __fastcall ndisPostSetMiniportRSSParameters(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OID_REQUEST *a2, int a3)
{
  ...
  if ( !a3 && ndisShouldCacheRSSParameters(a2) )
  {
    ...
    else if ( (v11 & 4) == 0 )
    {
      ...
      if ( (v12 & v19) != 0 )
      {
        Cpu = ndisPcwGetCpu((struct NDIS_PCW_CONTEXT *)&v17);
        v14 = v17 + ndisPcwPerCpuDataStride * Cpu + ndisPcwOffsetToPerCpuData;
        v15 = __rdtsc();
