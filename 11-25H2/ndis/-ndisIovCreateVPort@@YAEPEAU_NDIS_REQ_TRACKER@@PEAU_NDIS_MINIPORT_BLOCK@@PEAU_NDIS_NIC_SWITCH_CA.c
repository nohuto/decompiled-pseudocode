/*
 * XREFs of ?ndisIovCreateVPort@@YAEPEAU_NDIS_REQ_TRACKER@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_CAPABILITIES@@@Z @ 0x1400E51B8
 * Callers:
        ...
        struct _NDIS_NIC_SWITCH_CAPABILITIES *a3)
{
  ...
  char v50[8]; // [rsp+28h] [rbp-70h]
  char v51; // [rsp+28h] [rbp-70h]
  __int64 v52; // [rsp+30h] [rbp-68h]
  _BYTE *v53; // [rsp+40h] [rbp-58h]
  int *v54; // [rsp+48h] [rbp-50h]
  struct _NDIS_OID_REQUEST *v55; // [rsp+50h] [rbp-48h]
...
LABEL_28:
          ...
          *(_QWORD *)(v4 + 872) = v4 + 872;
          ...
          {
LABEL_39:
            v41 = ExAllocatePool2(66LL, (unsigned int)(AllocatedVPortIndicesLength + 64), 1869169742);
            v42 = (_BYTE *)v41;
            if ( !v41 )
              goto LABEL_28;
...
LABEL_8:
  ...
  else
  {
    *((_DWORD *)a1 + 10) = -1073741811;
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      *(_DWORD *)v50 = *((unsigned __int16 *)InformationBuffer + 266);
      WPP_RECORDER_SF_D(
        *((_QWORD *)WPP_GLOBAL_Control + 8),
        2u,
        0x1Au,
