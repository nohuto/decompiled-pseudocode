/*
 * XREFs of ?ndisValidateProtocolDriverCharacteristicsHeader@@YAHPEBU_NDIS_PROTOCOL_DRIVER_CHARACTERISTICS@@PEAK@Z @ 0x140175860
 * Callers:
        ...
        unsigned int *a2)
{
  ...
  v3 = (const struct _GUID *)&unk_1401017A0;
