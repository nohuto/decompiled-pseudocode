/*
 * XREFs of Duplicate802_11AttachAttributesCommon @ 0x14006EED0
 * Callers:
 ...
 * Callees:
 *     NdisAllocateMemoryWithTag @ 0x14006F9E0 (NdisAllocateMemoryWithTag.c)
 *     PrivateULongMult @ 0x1400EBBF0 (PrivateULongMult.c)
