/*
 * XREFs of ?ndisMOpenAdapter@@YAXPEAHPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14018B420
 * Callers:
 ...
 *     NdisInitializeEvent @ 0x14006FAB0 (NdisInitializeEvent.c)
 ...
 *     ?ethAllocateOpenMulticastBuffer@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@@Z @ 0x140081140 (-ethAllocateOpenMulticastBuffer@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@@Z.c)
...
void __fastcall ndisMOpenAdapter(int *a1, struct _NDIS_OPEN_BLOCK *a2, struct _NDIS_MINIPORT_BLOCK *a3)
{
  ...
  int v22; // edx
  _NDIS_STATUS_UNBIND_WORKITEM *v23; // rax
  ...
  struct _GUID *v31; // [rsp+20h] [rbp-78h]
...
LABEL_30:
  v17 = a3->DriverHandle;
  if ( a3->MajorNdisVersion >= 6u )
    CancelSendPacketsHandler = v17->MiniportDriverCharacteristics.CancelSendHandler;
  else
    CancelSendPacketsHandler = v17->MiniportCharacteristics.CancelSendPacketsHandler;
  ...
  if ( a3->Miniport5InNdis6Mode || v20 )
  {
    ...
    if ( MiniportHandle->MediaType != NdisMediumWan || (MiniportHandle->Flags & 0x20000) != 0 )
    ...
    v23 = (_NDIS_STATUS_UNBIND_WORKITEM *)ExAllocatePool2(64LL, 88LL, 1769423950);
    a2->StatusUnbindWorkItem = v23;
    if ( !v23 )
      goto LABEL_86;
    v23->WorkItem.Context = a3;
...
LABEL_87:
  ...
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qq(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      (char)a2);
  v26 = KeAcquireSpinLockRaiseToDpc(&ProtocolHandle->Ref.SpinLock);
  ...
  KeReleaseSpinLock(&ProtocolHandle->Ref.SpinLock, v26);
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qql(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      4u,
