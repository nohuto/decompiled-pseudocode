/*
 * XREFs of ?ndisSetReceiveFilter@@YAEPEAU_NDIS_REQ_TRACKER@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_CAPABILITIES@@PEAU_NDIS_SRIOV_CAPABILITIES@@@Z @ 0x1400B31D0
 * Callers:
 ...
 *     ?ndisAddReceiveFilterToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_FILTER_BLOCK@@@Z @ 0x1400B1578 (-ndisAddReceiveFilterToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_FILTER_BLOCK@@@Z.c)
...
LABEL_18:
  ...
  if ( (unsigned int)NdisConvertNtStatusToNdisStatus(v24 >= 0xFFFFFF48 ? 0xC0000095 : 0) )
    goto LABEL_18;
  Pool2 = ExAllocatePool2(64LL, v22, 1718764622);
...
LABEL_56:
  ...
  {
LABEL_64:
    v45 = ExAllocatePool2(66LL, AllocatedReceiveFilterIndicesLength + 64, 1970357326);
    v46 = (_BYTE *)v45;
    if ( !v45 )
    {
      v38 = &a2->Lock;
