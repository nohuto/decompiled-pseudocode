/*
 * XREFs of ?ndisIovAddSwitchToList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_BLOCK@@@Z @ 0x1400E49C4
 * Callers:
...
__int64 __fastcall ndisIovAddSwitchToList(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_NIC_SWITCH_BLOCK *a2)
{
  ...
  {
    Flink_high = HIDWORD(i[2].Flink);
    if ( Flink_high == *((_DWORD *)a2 + 9) )
    {
      v3 = -1073741270;
      goto LABEL_10;
    }
