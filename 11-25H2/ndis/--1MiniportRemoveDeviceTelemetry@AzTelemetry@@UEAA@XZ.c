/*
 * XREFs of ??1MiniportRemoveDeviceTelemetry@AzTelemetry@@UEAA@XZ @ 0x1400E4598
 * Callers:
...
void __fastcall AzTelemetry::MiniportRemoveDeviceTelemetry::~MiniportRemoveDeviceTelemetry(LARGE_INTEGER *this)
{
  ...
  if ( (unsigned int)dword_1401247B0 > 5 && tlgKeywordOn((__int64)&dword_1401247B0, 512LL) )
  {
