/*
 * XREFs of ?ndisPDUpdateQDepthCounter@@YAXPEAUNDIS_PD_EC@@@Z @ 0x1400AC744
 * Callers:
...
void __fastcall ndisPDUpdateQDepthCounter(LARGE_INTEGER *a1)
{
  ...
  if ( !PerformanceFrequency.QuadPart )
  {
    ...
    qword_140126FF8 = PerformanceFrequency.QuadPart / 100;
  }
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  if ( PerformanceCounter.QuadPart - a1[18].QuadPart >= (unsigned __int64)qword_140126FF8 )
  {
