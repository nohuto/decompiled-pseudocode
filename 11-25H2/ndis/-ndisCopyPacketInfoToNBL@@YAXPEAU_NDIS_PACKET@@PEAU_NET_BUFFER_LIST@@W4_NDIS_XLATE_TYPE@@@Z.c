/*
 * XREFs of ?ndisCopyPacketInfoToNBL@@YAXPEAU_NDIS_PACKET@@PEAU_NET_BUFFER_LIST@@W4_NDIS_XLATE_TYPE@@@Z @ 0x140032400
 * Callers:
 ...
 * Callees:
 *     ndisIPsecPktInfoToNBLInfo @ 0x1400AAC34 (ndisIPsecPktInfoToNBLInfo.c)
 */
