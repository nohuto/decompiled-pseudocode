/*
 * XREFs of ?ndisGetFilterAltitude@@YAJAEAVNetSetupPropertyBag@@AEAK@Z @ 0x140150CD8
 * Callers:
...
LABEL_12:
  ...
  Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_140127138, *(_WORD **)(v10 + 8));
  if ( !Atom )
  {
    v3 = -1073741670;
    goto LABEL_12;
  ...
  v6 = 0;
  v7 = *((unsigned int *)qword_140127138 + 19);
  while ( v6 < (unsigned int)v7 )
  {
    ...
    if ( v6 >= v7 )
      __fastfail(5u);
    ++v6;
    if ( *(char **)(*((_QWORD *)qword_140127138 + 10) + 8 * v8) == Atom )
    {
      *a2 = v6;
      goto LABEL_12;
    }
