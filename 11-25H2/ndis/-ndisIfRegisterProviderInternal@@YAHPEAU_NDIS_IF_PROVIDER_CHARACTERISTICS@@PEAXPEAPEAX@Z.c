/*
 * XREFs of ?ndisIfRegisterProviderInternal@@YAHPEAU_NDIS_IF_PROVIDER_CHARACTERISTICS@@PEAXPEAPEAX@Z @ 0x14008E0E0
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v7 >= 0x58u && (Pool2 = (_WORD *)ExAllocatePool2(64LL, v7, 1718174798), (v9 = Pool2) != 0LL) )
  {
    ...
    *v12 = v12;
    ...
    v13 = KeAcquireSpinLockRaiseToDpc(&qword_140126AC8);
    v14 = qword_140126AB8;
    v15 = v9 + 1;
    if ( *(__int64 **)(qword_140126AB8 + 8) != &qword_140126AB8 )
      __fastfail(3u);
    *v15 = qword_140126AB8;
    v9[2] = &qword_140126AB8;
    *(_QWORD *)(v14 + 8) = v15;
    qword_140126AB8 = (__int64)(v9 + 1);
    KeReleaseSpinLock(&qword_140126AC8, v13);
    *a3 = v9;
  }
  else
  {
