/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1400CDA20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x140060310 (NetioCopyOpaqueNetBufferListInformation.c)
        ...
        ULONG AllocateReassembleFlags)
{
  ...
  const struct _GUID *v38; // [rsp+28h] [rbp-A0h]
  struct _MDL *v41; // [rsp+50h] [rbp-78h]
    ...
    while ( i )
    {
      ...
      if ( DataLength > v6 )
      {
        ...
        if ( Mdl )
        {
          ...
          v25 = Length[0] + FirstNetBuffer->DataLength;
          v27 = v16 - Length[0];
          v26 = v27 == 0;
          v41 = v24;
          while ( 1 )
          {
            FirstNetBuffer->DataLength = v25;
            if ( v26 )
              break;
            MdlChain = MdlChain->Next;
            if ( !MdlChain )
            ...
            **(_QWORD **)Length = 0LL;
            v33->Next = v32;
            LODWORD(v32) = FirstNetBuffer->DataLength;
            v25 = v29 + (_DWORD)v32;
            if ( v29 + (unsigned int)v32 < (unsigned int)v32 )
            {
...
LABEL_34:
    ...
    else if ( Microsoft_Windows_Networking_CorrelationEnabled )
    {
      ...
      v36 = (__int64)v10->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
      *(_OWORD *)Length = (unsigned __int64)VirtualAddress[0];
      *(_OWORD *)VirtualAddress = (unsigned __int64)v36;
    ...
    if ( *(int *)ndisNblTrackerMode >= 3 )
      ndisNblTrackerRecordEventInternal((unsigned __int64)v10, 0LL, 9u, FragmentNetBufferList, 0);
  }
  return v10;
}
