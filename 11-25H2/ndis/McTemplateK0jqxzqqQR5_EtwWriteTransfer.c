/*
 * XREFs of McTemplateK0jqxzqqQR5_EtwWriteTransfer @ 0x14006FEA0
 * Callers:
        ...
        __int64 a10)
{
  ...
  __int64 v11; // rax
  int v13; // eax
  _EVENT_DATA_DESCRIPTOR v15; // [rsp+30h] [rbp-69h] BYREF
  ...
  v28 = 4LL;
  v30 = 4 * a9;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &NdisErrorLogEntry, a3, 8u, &v15);
}
