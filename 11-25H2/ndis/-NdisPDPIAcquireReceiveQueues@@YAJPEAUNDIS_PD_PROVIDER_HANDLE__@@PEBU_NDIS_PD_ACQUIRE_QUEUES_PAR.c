/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x140145920
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a7)
{
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v31, qword_140127008);
...
LABEL_43:
  ...
  *((_BYTE *)a1 + 89) = 1;
  ...
  {
LABEL_42:
    KLockThisExclusive::KLockThisExclusive(&v32, qword_140127008);
    v17 = &v32;
    *((_BYTE *)a1 + 89) = 0;
    goto LABEL_43;
  }
