/*
 * XREFs of ?NdisClassifyNblChain2@@YAXPEAU_NET_BUFFER_LIST@@P6A_KPEAX0@Z1PEAUNBL_QUEUE_t@@3@Z @ 0x1400C9EAC
 * Callers:
 ...
 * Callees:
 *     ?NdisNblClassifierForCancelId@@YA_KPEAXPEAU_NET_BUFFER_LIST@@@Z @ 0x1400C9F60 (-NdisNblClassifierForCancelId@@YA_KPEAXPEAU_NET_BUFFER_LIST@@@Z.c)
 */
