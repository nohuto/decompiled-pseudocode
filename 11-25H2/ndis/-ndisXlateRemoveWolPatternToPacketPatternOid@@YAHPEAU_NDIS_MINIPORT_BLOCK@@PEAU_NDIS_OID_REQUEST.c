/*
 * XREFs of ?ndisXlateRemoveWolPatternToPacketPatternOid@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAE@Z @ 0x1400BE5CC
 * Callers:
        ...
        unsigned __int8 *a3)
{
  ...
  *(_DWORD *)(Pool2 + 16) = a2->DATA.QUERY_INFORMATION.InformationBufferLength;
  ...
  if ( !v12 )
  {
    ...
    v22 = (unsigned int *)ExAllocatePool2(64LL, v16, 2021082190);
    v18 = v22;
    if ( !v22 )
      goto LABEL_23;
...
LABEL_13:
  ...
  v17 = (unsigned int *)ExAllocatePool2(64LL, v16, 2021082190);
  v18 = v17;
  if ( v17 )
  {
