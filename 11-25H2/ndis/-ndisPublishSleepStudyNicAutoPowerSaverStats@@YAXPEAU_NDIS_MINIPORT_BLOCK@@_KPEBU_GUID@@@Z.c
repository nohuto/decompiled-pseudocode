/*
 * XREFs of ?ndisPublishSleepStudyNicAutoPowerSaverStats@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_KPEBU_GUID@@@Z @ 0x140175C00
 * Callers:
 ...
 *     ??$ReadAcquire@EX@mem@@YAEPEDE@Z @ 0x14009B068 (--$ReadAcquire@EX@mem@@YAEPEDE@Z.c)
 ...
 *     ndisPublishSleepStudyNicAutoPowerSaverCustomData @ 0x14016EDE0 (ndisPublishSleepStudyNicAutoPowerSaverCustomData.c)
 */
