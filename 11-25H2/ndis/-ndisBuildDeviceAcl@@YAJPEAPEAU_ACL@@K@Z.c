/*
 * XREFs of ?ndisBuildDeviceAcl@@YAJPEAPEAU_ACL@@K@Z @ 0x1400804B0
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x140149D7C (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 * Callees:
...
__int64 __fastcall ndisBuildDeviceAcl(struct _ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v8 = RtlLengthSid(&unk_140105268);
    v9 = RtlLengthSid(&unk_140105288) + v8;
    v10 = RtlLengthSid(&unk_1401052A8);
    v5 = v9 + v10 + v26 + 32;
  }
  v11 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
    ...
    Pool2 = (void *)ExAllocatePool2(64LL, v12, 1935885390);
    v28 = Pool2;
    v2 = Pool2;
    if ( !Pool2 )
      return 3221225626LL;
...
LABEL_45:
  ...
  if ( (a2 & 0x40) != 0 )
  {
    ...
    v19 = (void *)ExAllocatePool2(64LL, v18, 1819296846);
    Sid = v19;
    if ( !v19 )
    {
      Acl = -1073741670;
...
LABEL_43:
  ...
  v22 = a2 & 0x80;
  if ( v22 )
    v5 += RtlLengthSid(&unk_140105248) + 8;
  v23 = (ACL *)ExAllocatePool2(64LL, v5, 1702052942);
  v24 = v23;
  if ( v23 )
  {
    memset(v23, 0, v5);
    ...
    if ( Acl >= 0 )
    {
      ...
      if ( v7 )
      {
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_1401052A8);
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_140105288);
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_140105268);
      }
      if ( v11 )
      ...
      if ( v22 )
        RtlAddAccessAllowedAce(v24, 2u, AccessMask, &unk_140105248);
      Acl = 0;
      *v30 = v24;
    }
    else
