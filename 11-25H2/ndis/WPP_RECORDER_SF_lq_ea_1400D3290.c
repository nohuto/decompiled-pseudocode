/*
 * XREFs of WPP_RECORDER_SF_lq @ 0x1400D3290
 * Callers:
...
__int64 WPP_RECORDER_SF_lq(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_a2f9ce1be4323b4178fc783abbe12af0_Traceguids, a4, va, 4LL, va1, 8LL, 0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 2LL, 22LL, &WPP_a2f9ce1be4323b4178fc783abbe12af0_Traceguids, v8, (__int64 *)va, 4LL, va1);
}
