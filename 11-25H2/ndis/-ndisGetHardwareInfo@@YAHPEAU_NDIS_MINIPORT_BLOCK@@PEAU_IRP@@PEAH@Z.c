/*
 * XREFs of ?ndisGetHardwareInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x140090F20
 * Callers:
...
__int64 __fastcall ndisGetHardwareInfo(struct _NDIS_MINIPORT_BLOCK *a1, struct _IRP *a2, int *a3)
{
  ...
  $92989440FA389B31605626E6262FEA42 *v4; // rsi
  unsigned int v8; // ebp
  ...
  *(_DWORD *)&v10.MasterIrp->Type = 86508160;
      ...
      && (v13 |= 4u, *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber = v13, *((_BYTE *)InterruptEx + 193)) )
    {
      ...
      *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber = v13 | 8;
      if ( v4 )
      {
        ...
        for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v14 + 4); v14 = *((_QWORD *)InterruptEx + 15) )
        {
          v4[i] = *($92989440FA389B31605626E6262FEA42 *)(v14 + 48 * i + 16);
          i = (unsigned int)(i + 1);
        }
      }
      if ( a1->MsiXCaps.Header.CapabilityID == 17 )
      {
        v16 = *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber | 0x10;
        *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber = v16;
        ...
        if ( _bittest16((const signed __int16 *)&a1->MsiXCaps.MessageControl, 0xFu) )
          *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber = v16 | 0x20;
      }
    }
    else
    {
  ...
  {
    v17 = *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber;
    if ( a1->Interrupt )
      v18 = v17 | 2;
    else
      v18 = v17 | 1;
    *(_DWORD *)&v10.MasterIrp->AllocationProcessorNumber = v18;
  }
  ...
  *((_DWORD *)&v10.MasterIrp->Tail.CompletionKey + 17) = *(_DWORD *)&a1->RecvScaleCapabilities.NumberOfIndirectionTableEntries;
  if ( ndisIsRssEnabledForMiniport(a1) )
  {
    ...
    *(_QWORD *)&v10.MasterIrp[1].Flags = *(_QWORD *)&CombinedNdisRSSParameters->NumberOfProcessorMasks;
    ...
    {
      LODWORD(v10.MasterIrp[1].MdlAddress) = v8 - 192;
      memmove(
        (char *)v10.MasterIrp + v8,
      ...
      v20 = a1->CombinedNdisRSSParameters->HashSecretKeySize + v8;
      *(_DWORD *)&v10.MasterIrp[1].Type = v20 - 192;
      memmove(
        (char *)v10.MasterIrp + v20,
      ...
      v8 = a1->CombinedNdisRSSParameters->IndirectionTableSize + v20;
    }
  }
  else
  {
  ...
  v22 = (struct _NDIS_RSS_PROCESSOR_INFO *)ExAllocatePool3(66LL, Size, 538985550LL, &v29, 1);
  v23 = v22;
  if ( v22 )
  {
    ...
    if ( RssProcessorInformation >= 0 )
    {
      ...
      *(_OWORD *)&v10.MasterIrp[1].IoStatus.Information = v26;
      ...
      else
      {
        ...
        HIDWORD(v10.MasterIrp[1].IoStatus.Information) = v8 - 248;
        memmove((char *)v10.MasterIrp + v8, v28, v25);
        v8 += v25;
      }
    }
