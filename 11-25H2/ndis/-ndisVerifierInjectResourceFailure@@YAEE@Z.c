/*
 * XREFs of ?ndisVerifierInjectResourceFailure@@YAEE@Z @ 0x1400CD114
 * Callers:
 ...
 *     ?ndisVerifierAllocatePacketPool@@YAXPEAHPEAPEAXII@Z @ 0x1400CCEA0 (-ndisVerifierAllocatePacketPool@@YAXPEAHPEAPEAXII@Z.c)
