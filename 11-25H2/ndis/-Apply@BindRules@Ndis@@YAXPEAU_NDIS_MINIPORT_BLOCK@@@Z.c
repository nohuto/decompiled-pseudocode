/*
 * XREFs of ?Apply@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1401638C0
 * Callers:
 ...
 *     _lambda_1b37a015b038c0fb9460a3d4ca11395f_::operator_void_(__cdecl_)(void___KRef_NDIS_BIND_PROTOCOL_DRIVER_) @ 0x14014F1A4 (_lambda_1b37a015b038c0fb9460a3d4ca11395f_--operator_void_(__cdecl_)(void___KRef_NDIS_BIND_PROTOC.c)
...
void __fastcall Ndis::BindRules::Apply(struct _NDIS_MINIPORT_BLOCK *this, struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  void (__fastcall *v19)(__int64, volatile signed __int32 **); // rax

  if ( ndisMDoesMiniportNeedCoNdisNdProxy(this) )
  {
    v19 = (void (__fastcall *)(__int64, volatile signed __int32 **))lambda_1b37a015b038c0fb9460a3d4ca11395f_::operator_void____cdecl___void___KRef_NDIS_BIND_PROTOCOL_DRIVER__();
    ndisBindEnumerateProtocolDrivers(v19, (__int64)this);
  }
  ...
  Ndis::BindRules::PauseNeededForBind(this, (struct _NDIS_MINIPORT_BLOCK *)&this->Bindings, v17);
