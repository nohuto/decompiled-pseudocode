/*
 * XREFs of __std_find_trivial_8 @ 0x18009A690
 * Callers:
 *     ??$__std_find_trivial@PEAVCWindowData@@_K@@YAPEAPEAVCWindowData@@PEAPEAV0@0_K@Z @ 0x18009A5DC (--$__std_find_trivial@PEAVCWindowData@@_K@@YAPEAPEAVCWindowData@@PEAPEAV0@0_K@Z.c)
 * Callees:
 *     <none>
 */
