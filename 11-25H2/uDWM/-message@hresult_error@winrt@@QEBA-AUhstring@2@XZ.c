/*
 * XREFs of ?message@hresult_error@winrt@@QEBA?AUhstring@2@XZ @ 0x18009FA50
 * Callers:
 ...
 * Callees:
 *     FormatMessageW_0 @ 0x18009B824 (FormatMessageW_0.c)
 *     SysStringLen_0 @ 0x18009C949 (SysStringLen_0.c)
