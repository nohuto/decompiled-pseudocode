/*
 * XREFs of ??$try_as@UIUnknown@Foundation@Windows@winrt@@Utype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@impl@4@$0A@@impl@winrt@@YA?AUIUnknown@Foundation@Windows@1@PEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@01@@Z @ 0x18002A8D8
 * Callers:
...
_QWORD *__fastcall winrt::impl::try_as<winrt::Windows::Foundation::IUnknown,winrt::impl::abi<winrt::Windows::Foundation::IUnknown,void>::type,0>(
        _QWORD *a1,
        void (__fastcall ***a2)(_QWORD, __int64 *, __int64 *))
{
  ...
  if ( a2 )
  {
    v3 = *a2;
    v5 = 0LL;
    (*v3)(a2, &winrt::impl::guid_v<winrt::Windows::Foundation::IUnknown>, &v5);
