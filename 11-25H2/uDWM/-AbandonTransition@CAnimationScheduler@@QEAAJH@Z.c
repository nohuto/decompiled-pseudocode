/*
 * XREFs of ?AbandonTransition@CAnimationScheduler@@QEAAJH@Z @ 0x1800A7744
 * Callers:
 ...
 *     ?_WindowEnumCallback@CTDBN@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800CDDE0 (-_WindowEnumCallback@CTDBN@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z.c)
 * Callees:
...
__int64 __fastcall CAnimationScheduler::AbandonTransition(CAnimationScheduler *this, int a2)
{
  ...
  {
    v6 = *(__m128i **)(*((_QWORD *)this + 2) + 8 * v2);
    if ( v6[1].m128i_i32[2] == 3 && v6[4].m128i_i32[2] == a2 )
    {
