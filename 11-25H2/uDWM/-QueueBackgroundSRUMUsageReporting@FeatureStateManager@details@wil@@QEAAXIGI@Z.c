/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x18009E5D4
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_BYTE *)this )
  {
    if ( !wil::ProcessShutdownInProgress(this) )
    {
      ...
      v9 = a3;
      v11 = a4;
      wil::details_abi::heap_buffer::push_back((void **)this + 29, &v8, 0xCuLL);
