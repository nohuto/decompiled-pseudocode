/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800B42BC
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800B4190 (-OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
        ...
        CTimelineBase **this)
{
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 50, v2);
  if ( !*v6 )
  {
    v7 = -2147024882;
    v8 = 187LL;
