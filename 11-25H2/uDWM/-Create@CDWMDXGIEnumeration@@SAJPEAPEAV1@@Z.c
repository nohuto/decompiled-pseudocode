/*
 * XREFs of ?Create@CDWMDXGIEnumeration@@SAJPEAPEAV1@@Z @ 0x180066930
 * Callers:
...
__int64 __fastcall CDWMDXGIEnumeration::Create(struct CDWMDXGIEnumeration **a1)
{
  ...
  if ( v2 && (v5 = CDWMDXGIEnumeration::CDWMDXGIEnumeration(v2), (v6 = v5) != 0LL) )
  {
    ...
    if ( inited < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FAC18, 1LL, inited, 0x3Bu, 0LL);
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FAC18, 1LL, -2147024882, 0x37u, 0LL);
  }
  return v3;
}
