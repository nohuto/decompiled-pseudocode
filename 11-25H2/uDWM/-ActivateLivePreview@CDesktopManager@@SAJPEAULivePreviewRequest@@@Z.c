/*
 * XREFs of ?ActivateLivePreview@CDesktopManager@@SAJPEAULivePreviewRequest@@@Z @ 0x180045224
 * Callers:
...
__int64 __fastcall CDesktopManager::ActivateLivePreview(struct LivePreviewRequest *lpMem)
{
  ...
  if ( *(_DWORD *)lpMem )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0xAE3u, 0LL);
  }
  else
  {
    ...
    v5 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0xAE7u, 0LL);
  }
