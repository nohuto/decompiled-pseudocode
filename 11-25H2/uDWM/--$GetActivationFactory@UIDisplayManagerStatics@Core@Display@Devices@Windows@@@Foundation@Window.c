/*
 * XREFs of ??$GetActivationFactory@UIDisplayManagerStatics@Core@Display@Devices@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIDisplayManagerStatics@Core@Display@Devices@1@@Z @ 0x180071614
 * Callers:
