/*
 * XREFs of ?GetGlobalState@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_GETGLOBALSTATE@@@Z @ 0x1800E560C
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 1) == 16 )
  {
    ...
    if ( (*((_BYTE *)a2 + 8) & 1) != 0 )
    {
      if ( !CDesktopManager::IsFeatureEnabled(0)
        || (v4 = 1, *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 125)) )
      {
        v4 = 0;
      }
      *((_DWORD *)a2 + 3) = v4;
