/*
 * XREFs of ??0?$producers_base@UTransitionState@implementation@Transitions@Udwm@winrt@@V?$tuple@UTransitionState@Transitions@Udwm@winrt@@UITransitionStateNative@@UITransitionStateNativePrivate@@@std@@@impl@winrt@@QEAA@XZ @ 0x180095BF8
 * Callers:
 *     ??0TransitionState@implementation@Transitions@Udwm@winrt@@QEAA@XZ @ 0x180061874 (--0TransitionState@implementation@Transitions@Udwm@winrt@@QEAA@XZ.c)
 * Callees:
 *     ??0?$producer_convert@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@X@impl@winrt@@QEAA@XZ @ 0x18008CAF4 (--0-$producer_convert@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@X@impl@winrt.c)
 */
