/*
 * XREFs of ?Create@CDisplaySecondaryOnlyToExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B37C8
 * Callers:
        ...
        struct CDisplaySecondaryOnlyToExtendAnimatedVisual **a1)
{
  ...
  if ( a1 )
  {
    v3 = (CDisplaySecondaryOnlyToExtendAnimatedVisual *)DefaultHeap::AllocClear(0x1D8uLL);
    if ( v3 )
