/*
 * XREFs of ?HasChanged@CDisplayModeChangeHelper@@SA?AW4DisplayModeChangeResult@@PEAVCDWMDisplaySet@@0AEAV?$vector@PEBVCDWMDisplay@@V?$allocator@PEBVCDWMDisplay@@@std@@@std@@@Z @ 0x180065CCC
 * Callers:
 ...
 *     ?IsDisconnect@CDisplayModeChangeHelper@@CA?AW4DisplayModeChangeResult@@PEAVCDWMDisplaySet@@0@Z @ 0x180066008 (-IsDisconnect@CDisplayModeChangeHelper@@CA-AW4DisplayModeChangeResult@@PEAVCDWMDisplaySet@@0@Z.c)
...
__int64 __fastcall CDisplayModeChangeHelper::HasChanged(
        CDWMDisplaySet *this,
        CDWMDisplaySet *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (unsigned int)dword_180118130 > 5 && (byte_180118140 & 2) != 0 && (qword_180118148 & 2) == qword_180118148 )
  {
    ...
    v11[0] = 184549376;
    v12 = 2LL;
    v14 = *(unsigned __int16 *)off_180118138;
    v16 = &unk_1801047AC;
    v15 = 2;
    v17 = 72;
    v18 = 1;
    v9 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EtwEventWriteTransfer(qword_180118150, v11);
  }
