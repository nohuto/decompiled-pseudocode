/*
 * XREFs of ?CalculateOutsideMargins@CTopLevelWindow@@SAXPEAVCWindowData@@IPEAU_MARGINS@@@Z @ 0x18000DF90
 * Callers:
        ...
        struct _MARGINS *a3)
{
  ...
  *a3 = 0LL;
  if ( CTopLevelWindow::HasRenderedBorder(a2)
    ...
    && *((_DWORD *)this + 17) >= dword_180119834
    && *((_DWORD *)this + 18) >= dword_180119838
    && *((_DWORD *)this + 19) >= dword_18011983C
