/*
 * XREFs of ??$is_guid_of@UIUnknown@Foundation@Windows@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x180098858
 * Callers:
...
bool __fastcall winrt::is_guid_of<winrt::Windows::Foundation::IUnknown>(_QWORD *a1)
{
  __int64 v1; // rax

  v1 = *a1 - winrt::impl::guid_v<winrt::Windows::Foundation::IUnknown>;
  if ( *a1 == winrt::impl::guid_v<winrt::Windows::Foundation::IUnknown> )
