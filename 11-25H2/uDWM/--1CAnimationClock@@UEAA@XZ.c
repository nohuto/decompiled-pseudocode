/*
 * XREFs of ??1CAnimationClock@@UEAA@XZ @ 0x180071788
 * Callers:
 ...
 *     ?SetTimerCallback@CTimer@@QEAAJPEAUITimerCallbackListener@@@Z @ 0x180080568 (-SetTimerCallback@CTimer@@QEAAJPEAUITimerCallbackListener@@@Z.c)
