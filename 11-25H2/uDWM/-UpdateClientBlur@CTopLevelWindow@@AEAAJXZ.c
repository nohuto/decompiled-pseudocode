/*
 * XREFs of ?UpdateClientBlur@CTopLevelWindow@@AEAAJXZ @ 0x18003F870
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateClientBlur(CTopLevelWindow *this)
{
  ...
  if ( (*(_BYTE *)(v1 + 673) & 4) == 0 )
  {
    ...
    if ( v6 )
    {
      ...
      v3 = v43;
      if ( v43 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v43, 0xF70u, 0LL);
    }
    return v3;
  }
  if ( *(_QWORD *)(v1 + 424) )
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, RectangleGeometry, 0xF1Eu, 0LL);
      return v3;
    }
  }
  ...
  if ( !*((_QWORD *)this + 37) )
  {
    ...
    if ( v38 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v38, 0xF29u, 0LL);
      return v3;
    }
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0xF2Cu, 0LL);
      return v3;
    }
  ...
  if ( !*((_DWORD *)*v20 + 58) )
  {
    ...
    if ( v24 )
    {
      ...
      if ( v25 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0xF3Du, 0LL);
        return v3;
      }
      v23 = hrgn;
    }
    ...
    if ( v23 )
    {
      *(_QWORD *)&v48.r = 0LL;
      ...
      if ( v26 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0xF44u, 0LL);
        v4 = v44;
        goto LABEL_31;
      }
      v4 = v44;
      ...
      if ( v28 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v28, 0xF4Du, 0LL);
        goto LABEL_31;
      }
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SolidColorLegacyMilBrushProxy, 0xF59u, 0LL);
    }
    else
    {
...
LABEL_26:
        if ( !*((_DWORD *)*v20 + 58) )
        {
          ...
          if ( v31 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v31, 0xF66u, 0LL);
            v5 = v45;
          }
          else
          {
            ...
            v3 = v32;
            if ( v32 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v32, 0xF68u, 0LL);
          }
        }
        goto LABEL_31;
      }
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0xF5Bu, 0LL);
    }
LABEL_31:
    if ( v4 )
