/*
 * XREFs of ?_CreateAndAddCrossfadeAnimationComponent@CSSCrossFade@@MEAAJPEAVCWindowData@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800C9470
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  return CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v10, 0LL, 0LL, 0xFFFFFFFF, v8, a4);
}
