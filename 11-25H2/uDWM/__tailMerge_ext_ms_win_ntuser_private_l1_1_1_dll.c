/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_1_dll @ 0x18009BDBE
 * Callers:
 *     __imp_load_GetWindowBand @ 0x18009BE3D (__imp_load_GetWindowBand.c)
 *     __imp_load_CreateWindowInBand @ 0x18009BE4F (__imp_load_CreateWindowInBand.c)
 * Callees:
