/*
 * XREFs of ?SetGlassColorizationColorResource@CDesktopManager@@QEAAJPEAVCGlassColorizationResources@@U?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@M@Z @ 0x18000E950
 * Callers:
...
int __fastcall CDesktopManager::SetGlassColorizationColorResource(__int64 a1, CGlassColorizationResources *a2)
{
  ...
  if ( result < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, result, 0x3ACu, 0LL);
    return v6;
  }
  return result;
}
