/*
 * XREFs of ?InsertAt@?$DynArray@PEAUCAPTURE_FILTERED_WINDOW@CProjectionBorderManager@@$0A@@@QEAAJAEBQEAUCAPTURE_FILTERED_WINDOW@CProjectionBorderManager@@I@Z @ 0x1800BF9D8
 * Callers:
