/*
 * XREFs of ?_UpdateResourcesForMonitorHelper@CLivePreview@@AEAAJPEBVCTopLevelWindow@@PEAULivePreviewResource@@@Z @ 0x180023BC4
 * Callers:
        ...
        struct LivePreviewResource *a3)
{
  ...
  if ( v6 && (*((_BYTE *)CTopLevelWindow::GetWindowData(a2) + 675) & 1) == 0 )
    UnionRect((LPRECT)a3, (const RECT *)a3, &rcDst);
  if ( *((char *)CTopLevelWindow::GetWindowData(a2) + 674) >= 0
...
LABEL_13:
              ...
              else
              {
                ...
                if ( v5 >= 0 )
                  v5 = -2003304445;
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x48Eu, 0LL);
              }
            ...
            if ( v21 )
            {
              ...
              if ( v5 >= 0 )
                v5 = -2003304445;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x489u, 0LL);
            }
            else
            {
              v15 = GetLastError();
              ...
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x488u, 0LL);
            }
          }
          else
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x482u, 0LL);
          }
        }
      }
    }
