/*
 * XREFs of ?CleanupFinishedAnimations@CContactManager@@AEAAXXZ @ 0x18002B7AC
 * Callers:
 ...
 *     ?IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ @ 0x180085B80 (-IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ.c)
 *     ?RemoveAt@?$DynArray@UCStationaryAnimation@@$0A@@@QEAAJI@Z @ 0x180087500 (-RemoveAt@-$DynArray@UCStationaryAnimation@@$0A@@@QEAAJI@Z.c)
 *     ?IsOKToCleanup@CFlickVisual@@UEAA_NXZ @ 0x1800AAAF0 (-IsOKToCleanup@CFlickVisual@@UEAA_NXZ.c)
