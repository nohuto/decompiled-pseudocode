/*
 * XREFs of ?StartAnimationForMoveResizeTransition@CTopLevelWindow3D@@QEAAJW4WindowAnimationType@1@AEBUtagRECT@@@Z @ 0x180081D6C
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::StartAnimationForMoveResizeTransition(__int64 a1, unsigned int a2, int *a3)
{
  unsigned int v3; // eax
  int v4; // r10d
  __m128i v5; // xmm1
