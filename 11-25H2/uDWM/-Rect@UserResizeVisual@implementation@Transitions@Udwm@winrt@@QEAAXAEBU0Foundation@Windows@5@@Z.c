/*
 * XREFs of ?Rect@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAXAEBU0Foundation@Windows@5@@Z @ 0x1800E07BC
 * Callers:
 ...
 *     ?put_Rect@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x1800E0F30 (-put_Rect@-$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@.c)
 * Callees:
 ...
 *     ?WFRectToDpiScaledMarginRect@@YA?AUtagRECT@@URect@Foundation@Windows@winrt@@@Z @ 0x1800E0BC8 (-WFRectToDpiScaledMarginRect@@YA-AUtagRECT@@URect@Foundation@Windows@winrt@@@Z.c)
 */
