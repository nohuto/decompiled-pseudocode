/*
 * XREFs of ?GetOwnedInclusiveClipRect@CTransitionVisualController@@QEAAXPEAVCWindowData@@PEAUtagRECT@@@Z @ 0x1800D297C
 * Callers:
...
void __fastcall CTransitionVisualController::GetOwnedInclusiveClipRect(
        ...
        struct tagRECT *a3)
{
  struct tagRECT **v4; // [rsp+38h] [rbp+10h] BYREF
  struct tagRECT *v5; // [rsp+40h] [rbp+18h] BYREF

  v5 = a3;
  *a3 = a2[3];
  if ( *((_QWORD *)this + 12) != -1LL || (unsigned int)GetDesktopID(1LL) )
  {
    v4 = &v5;
    CTransitionVisualController::ForEachOwnedWindow__lambda_7821d6dce4a3388ce42fd2cdd0f5ae9d___((__int64)a2, &v4, 1);
  }
}
