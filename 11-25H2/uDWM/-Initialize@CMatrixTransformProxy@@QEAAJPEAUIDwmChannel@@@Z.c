/*
 * XREFs of ?Initialize@CMatrixTransformProxy@@QEAAJPEAUIDwmChannel@@@Z @ 0x18006FE78
 * Callers:
...
__int64 __fastcall CMatrixTransformProxy::Initialize(CMatrixTransformProxy *this, struct IDwmChannel *a2)
{
  int v2; // eax
  unsigned int v3; // ebx

  v2 = CResourceProxy::Initialize((__int64)this, 0x16u, (__int64)a2);
  v3 = v2;
  if ( v2 < 0 )
