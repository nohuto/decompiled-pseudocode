/*
 * XREFs of ??1StartWindowCapture@WindowFrameLoggingTelemetry@@QEAA@XZ @ 0x1800BDBB0
 * Callers:
 ...
 *     _CProjectionBorderManager::StartWindowCapture_::_1_::dtor$2 @ 0x1800ED16B (_CProjectionBorderManager--StartWindowCapture_--_1_--dtor$2.c)
 * Callees:
