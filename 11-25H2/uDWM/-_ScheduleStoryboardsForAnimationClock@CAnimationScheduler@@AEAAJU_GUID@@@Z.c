/*
 * XREFs of ?_ScheduleStoryboardsForAnimationClock@CAnimationScheduler@@AEAAJU_GUID@@@Z @ 0x18002B534
 * Callers:
 ...
 *     ?_GetStoryboardHighestPri@CAnimationScheduler@@AEAAHW4StoryboardState@@@Z @ 0x18002B6B0 (-_GetStoryboardHighestPri@CAnimationScheduler@@AEAAHW4StoryboardState@@@Z.c)
        ...
        struct _GUID *a2)
{
  ...
  do
  {
    ...
    v10 = *(__m128i **)(v9 + 8 * v6);
    if ( v10 )
      CMILRefCountBase::AddRef(*(CMILRefCountBase **)(v9 + 8 * v6));
...
LABEL_13:
  ...
  if ( v4 >= 0 && v5 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      v4 = started;
      if ( started < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x291u, 0LL);
      else
        CWindowList::UpdateScene(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 53));
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x28Eu, 0LL);
    }
  }
  return (unsigned int)v4;
}
