/*
 * XREFs of ?WindowCanHaveIconicBitmapChanged@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@@Z @ 0x180019984
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  *((_QWORD *)a2 + 54) = 0LL;
  ...
  v3 = v7;
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x38Eu, 0LL);
...
LABEL_7:
    ...
    if ( v9 && *(struct CWindowData **)(v9 + 72) == a2 )
    {
      ...
      *((_BYTE *)this + 88) = 0;
      ...
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x39Bu, 0LL);
      ...
      v3 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x39Du, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x392u, 0LL);
  }
  return v3;
}
