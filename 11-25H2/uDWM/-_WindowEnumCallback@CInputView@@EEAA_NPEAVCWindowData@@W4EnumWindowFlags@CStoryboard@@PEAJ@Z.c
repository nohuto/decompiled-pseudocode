/*
 * XREFs of ?_WindowEnumCallback@CInputView@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800432F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CInputView::_WindowEnumCallback(CSlide *a1, __int64 a2, char a3, int *a4)
{
  ...
  v8 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 2);
  if ( (*(_DWORD *)(a2 + 680) & 0xFFF) != 2 )
  {
    v9 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 3);
    if ( (*(_DWORD *)(a2 + 680) & 0xFFF) == 3
      || (v9 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 25), (*(_DWORD *)(a2 + 680) & 0xFFF) == 0x19) )
    {
    ...
    v8 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 26);
