/*
 * XREFs of ?UpdateAcrylicBlurBehind@CAccentAcrylicBlurBehind@@QEAAJAEBUACCENT_POLICY@@KPEBN@Z @ 0x1800A0530
 * Callers:
 ...
 *     ?GetLuminosityOpacity@TaskbarAcrylic@@YANK@Z @ 0x18007C3F0 (-GetLuminosityOpacity@TaskbarAcrylic@@YANK@Z.c)
