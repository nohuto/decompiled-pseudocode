/*
 * XREFs of ?CloneVisualTree@CAcrylicSystemBackdropVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x1800A1640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAcrylicSystemBackdropVisual::CloneVisualTree(__int64 a1, struct tagPOINT **a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // rdx
  ...
  *a2 = 0LL;
  v10 = 0LL;
  v4 = CSystemBackdropVisual::Create(3, (CSystemBackdropVisual **)&v10);
  v5 = v4;
  if ( v4 >= 0 )
  {
    v7 = v10;
...
LABEL_7:
  wil::com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>::~com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>((CBaseObject **)&v10);
  return v5;
}
