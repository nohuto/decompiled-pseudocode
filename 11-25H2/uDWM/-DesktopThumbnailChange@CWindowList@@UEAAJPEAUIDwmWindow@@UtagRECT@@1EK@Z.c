/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x1800E3C90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  *(_QWORD *)&rc.left = 0LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0x14CEu, 0LL);
    v10 = v24;
    goto LABEL_27;
  }
  v10 = v24;
...
LABEL_26:
  ...
  if ( v16 )
  {
    if ( v17 )
    {
      CContainerVisual::RemoveChild(*(CContainerVisual **)(v16 + 24), *(struct CVisualProxy ***)(v12 + 640));
  ...
  if ( !v17 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x14E7u, 0LL);
      v11 = v23;
      goto LABEL_27;
    }
    v11 = v23;
