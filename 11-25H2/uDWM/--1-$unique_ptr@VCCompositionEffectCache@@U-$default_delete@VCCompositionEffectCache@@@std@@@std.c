/*
 * XREFs of ??1?$unique_ptr@VCCompositionEffectCache@@U?$default_delete@VCCompositionEffectCache@@@std@@@std@@QEAA@XZ @ 0x18008A8D0
 * Callers:
 *     ??1CDesktopManager@@EEAA@XZ @ 0x1800AC090 (--1CDesktopManager@@EEAA@XZ.c)
 *     _CCompositionEffectCache::Create_::_1_::dtor$0 @ 0x1800EC54B (_CCompositionEffectCache--Create_--_1_--dtor$0.c)
 * Callees:
