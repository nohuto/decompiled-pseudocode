/*
 * XREFs of ?OnMonitorChangedNotification@CAnalogCompositorManager@@AEAAJXZ @ 0x1800A2C40
 * Callers:
 ...
 *     ?IsVirtualMonitorsInstalled@CAnalogCompositorManager@@SA_NXZ @ 0x1800A2A40 (-IsVirtualMonitorsInstalled@CAnalogCompositorManager@@SA_NXZ.c)
