/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayExtendToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800B21D4
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayExtendToDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800B2020 (-OnAnimationCompleteImpl@CDisplayExtendToDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 53, v2);
  if ( !*v6 )
  {
    v7 = -2147024882;
    v8 = 197LL;
