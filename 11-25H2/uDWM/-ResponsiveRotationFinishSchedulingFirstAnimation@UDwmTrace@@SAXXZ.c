/*
 * XREFs of ?ResponsiveRotationFinishSchedulingFirstAnimation@UDwmTrace@@SAXXZ @ 0x1800D64D8
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationFinishSchedulingFirstAnimation(__int64 a1)
{
