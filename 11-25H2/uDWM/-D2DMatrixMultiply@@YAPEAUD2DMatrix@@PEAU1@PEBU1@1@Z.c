/*
 * XREFs of ?D2DMatrixMultiply@@YAPEAUD2DMatrix@@PEAU1@PEBU1@1@Z @ 0x180018480
 * Callers:
        ...
        const struct D2DMatrix *a3)
{
  ...
  *v3 = (float)((float)((float)(*(float *)a2 * *(float *)a3) + (float)(*((float *)a3 + 4) * *((float *)a2 + 1)))
  ...
  v3[3] = (float)((float)((float)(*((float *)a2 + 1) * *((float *)a3 + 7)) + (float)(*((float *)a3 + 3) * *(float *)a2))
  ...
  v3[9] = (float)((float)((float)(*((float *)a3 + 5) * *((float *)a2 + 9))
  ...
  v3[11] = (float)((float)((float)(*((float *)a3 + 3) * *((float *)a2 + 8))
                         + (float)(*((float *)a3 + 7) * *((float *)a2 + 9)))
