/*
 * XREFs of ?ActivationChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800855D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ActivationChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( v8 )
  {
    *((_BYTE *)v5 + 672) ^= (*((_BYTE *)v5 + 672) ^ (2
                                                   * (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 136LL))(a2))) & 2;
    v6 = CWindowData::OnWindowStyleUpdated(v5);
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x15FCu, 0LL);
  }
