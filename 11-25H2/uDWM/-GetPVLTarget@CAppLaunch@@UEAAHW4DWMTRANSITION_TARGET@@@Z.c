/*
 * XREFs of ?GetPVLTarget@CAppLaunch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C6E60
 * Callers:
...
__int64 __fastcall CAppLaunch::GetPVLTarget(__int64 a1, int a2)
{
  unsigned int v2; // r9d
  int v3; // ecx
  unsigned int *v4; // r8
  ...
  v2 = -1;
  v3 = 0;
  v4 = `CAppLaunch::GetPVLTarget'::`2'::s_rgPVLTargetLookupTable;
