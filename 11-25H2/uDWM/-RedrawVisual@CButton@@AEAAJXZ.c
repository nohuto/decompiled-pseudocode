/*
 * XREFs of ?RedrawVisual@CButton@@AEAAJXZ @ 0x18001CF40
 * Callers:
...
__int64 __fastcall CButton::RedrawVisual(CButton *this)
{
  ...
  *v2 = v7;
  ...
  CButton::DrawStateW((__int64)this, *((CAtlasedImage **)this + 31), *v2);
  if ( (v3 != 1 || *v2) && (*v2 != 1 || v3) )
  {
  ...
  if ( v8 != *((CAtlasedRectsVisual **)v9 + 10) )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x146u, 0LL);
      return v4;
    }
  ...
  if ( v6 )
  {
    ...
    CButton::DrawStateW((__int64)this, *((CAtlasedImage **)this + 32), v3);
  ...
  else
  {
    ...
    CButton::DrawStateW((__int64)this, *((CAtlasedImage **)this + 32), 4u);
