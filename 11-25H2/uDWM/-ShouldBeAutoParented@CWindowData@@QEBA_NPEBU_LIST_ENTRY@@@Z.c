/*
 * XREFs of ?ShouldBeAutoParented@CWindowData@@QEBA_NPEBU_LIST_ENTRY@@@Z @ 0x180006EC0
 * Callers:
  ...
  if ( v4 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v4 + 432LL))(v4) )
    {
      if ( CWindowData::PropertiesAllowAutoParenting(this)
        && (*((_BYTE *)this + 677) & 0x10) == 0
        && !*((_QWORD *)this + 58)
        && (*((_BYTE *)this + 676) & 2) == 0 )
      {
        v6 = *((_QWORD *)this + 75);
        if ( (*(_BYTE *)(v6 + 672) & 1) != 0 && *(_QWORD *)(v6 + 440) && (*(_BYTE *)(v6 + 678) & 0x10) == 0 )
        {
