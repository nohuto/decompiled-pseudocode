/*
 * XREFs of ?_WindowEnumCallback@CInputView_SizeOrModeChangeBase@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800CCE70
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    {
      case 25:
        WPT = CStoryboard::_GetWPT((CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 25));
        ...
        break;
      case 26:
        v11 = CStoryboard::_GetWPT((CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 26));
