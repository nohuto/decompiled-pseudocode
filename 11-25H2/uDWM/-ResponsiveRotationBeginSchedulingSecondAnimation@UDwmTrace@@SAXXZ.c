/*
 * XREFs of ?ResponsiveRotationBeginSchedulingSecondAnimation@UDwmTrace@@SAXXZ @ 0x1800D6488
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationBeginSchedulingSecondAnimation(__int64 a1)
{
