/*
 * XREFs of _CWindowList::HandleScreenRotation_::_1_::catch$1 @ 0x1800EDBDE
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::HandleScreenRotation_::_1_::catch_1(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
