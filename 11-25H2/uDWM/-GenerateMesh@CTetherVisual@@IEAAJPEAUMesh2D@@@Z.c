/*
 * XREFs of ?GenerateMesh@CTetherVisual@@IEAAJPEAUMesh2D@@@Z @ 0x1800CE48C
 * Callers:
...
__int64 __fastcall CTetherVisual::GenerateMesh(CTetherVisual *this, struct Mesh2D *a2)
{
  ...
  *((_DWORD *)this + 74) = v14 + v7;
  ...
  v37 = v33;
  v39 = v35;
  v21 = DynArray<D2D_POINT_3F,0>::AddMultipleAndSet((__int64)a2, v40, 4u);
  v22 = v21;
  if ( v21 < 0 )
  {
    v30 = 189;
  ...
  {
    v21 = DynArray<D2D_POINT_2F,0>::AddMultipleAndSet((__int64)a2 + 32, &v32, 4u);
    v22 = v21;
    if ( v21 >= 0 )
    {
