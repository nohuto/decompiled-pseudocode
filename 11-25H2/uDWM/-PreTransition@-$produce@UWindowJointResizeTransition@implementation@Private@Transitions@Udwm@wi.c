/*
 * XREFs of ?PreTransition@?$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHHPEAX@Z @ 0x1800DA330
 * Callers:
 *     <none>
 * Callees:
