/*
 * XREFs of ?OnAnimationComplete@CAnimationScheduler@@UEAAJI@Z @ 0x180027E60
 * Callers:
 ...
 * Callees:
 *     ?_AreAllStoryboardsAbandoned@CAnimationScheduler@@AEAA_NXZ @ 0x180027EC4 (-_AreAllStoryboardsAbandoned@CAnimationScheduler@@AEAA_NXZ.c)
