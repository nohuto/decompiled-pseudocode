/*
 * XREFs of ?StopWindowCapture@CProjectionBorderManager@@UEAAJAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x180078530
 * Callers:
...
LABEL_19:
    ...
    v20 = 0LL;
    ProxyWindowHandle = CProjectionBorderManager::_GetProxyWindowHandle(v14, *v10, &v20);
    v12 = ProxyWindowHandle;
    if ( ProxyWindowHandle < 0 )
    {
      v13 = 472LL;
...
LABEL_20:
    ...
    CGenericTableMap<_LARGE_INTEGER,CProjectionBorderManager::CAPTURE_TAB_GROUP_MAP_ENTRY>::RemoveElement(
      this + 6,
      (CProjectionBorderManager::CAPTURE_TAB_GROUP_MAP_ENTRY *)v8);
