/*
 * XREFs of ?OnWindowTransformUpdated@CProjectionBorderManager@@UEAAJPEAVCWindowData@@@Z @ 0x1800752E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_UpdateCaptureControllerTransform@CProjectionBorderManager@@AEAAJPEAUHWND__@@@Z @ 0x1800C4D08 (-_UpdateCaptureControllerTransform@CProjectionBorderManager@@AEAAJPEAUHWND__@@@Z.c)
 */
