/*
 * XREFs of ?Rect@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAA?AU0Foundation@Windows@5@XZ @ 0x1800E07A8
 * Callers:
...
_OWORD *__fastcall winrt::Udwm::Transitions::implementation::UserResizeVisual::Rect(__int64 a1, _OWORD *a2)
{
  _OWORD *result; // rax
