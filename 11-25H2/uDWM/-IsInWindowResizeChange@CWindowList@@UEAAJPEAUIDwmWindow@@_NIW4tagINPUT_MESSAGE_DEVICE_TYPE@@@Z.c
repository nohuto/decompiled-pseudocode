/*
 * XREFs of ?IsInWindowResizeChange@CWindowList@@UEAAJPEAUIDwmWindow@@_NIW4tagINPUT_MESSAGE_DEVICE_TYPE@@@Z @ 0x1800E5DF0
 * Callers:
        ...
        enum tagINPUT_MESSAGE_DEVICE_TYPE a5)
{
  ...
  if ( !*(_QWORD *)v13 )
    goto LABEL_15;
  LOBYTE(v12) = *((_BYTE *)v10 + 677);
  if ( ((v12 & 0x20) != 0) == a3 && v11 )
  {
LABEL_16:
    if ( (*(_DWORD *)(v11 + 680) & 0xFFF) == 0x5E )
    {
      if ( *((_BYTE *)this + 688) )
      {
        ...
        *(_DWORD *)(v11 + 680) = *(_DWORD *)(v11 + 680) & 0x2000000 | 0xFFF;
        *((_BYTE *)this + 688) = 0;
      }
      else
      {
  ...
  *((_BYTE *)v10 + 677) = (32 * a3) | v12 & 0xDF;
  *(_DWORD *)(*(_QWORD *)v13 + 784LL) = a4;
