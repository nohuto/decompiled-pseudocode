/*
 * XREFs of ?BeginClip@AnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@QEAA?AURect@Foundation@Windows@5@XZ @ 0x1800D3768
 * Callers:
 ...
 *     ?GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z @ 0x1800A3AD0 (-GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z.c)
 */
