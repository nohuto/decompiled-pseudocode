/*
 * XREFs of ?NotifyTouchDragVisualComplete@CContactManager@@QEAAJPEBVCTouchDragVisual@@@Z @ 0x1800301C4
 * Callers:
        ...
        *(_QWORD *)(v13 + *((_QWORD *)this + 7) + 16) = *(_QWORD *)(v13 + *((_QWORD *)this + 7) + 8);
          ...
          && (*((_BYTE *)this + 324) || *(_DWORD *)(v13 + v7 + 40)) )
        {
          if ( !*(_QWORD *)(v13 + v7 + 48) )
          {
            ...
            if ( Touch < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, Touch, 0x427u, 0LL);
              break;
            }
