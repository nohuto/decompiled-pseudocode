/*
 * XREFs of ??1CLegacyNonClientBackground@@UEAA@XZ @ 0x180072C8C
 * Callers:
...
void __fastcall CLegacyNonClientBackground::~CLegacyNonClientBackground(CBaseObject **this)
{
  ...
  wil::com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>::~com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>(this + 31);
