/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x18009FBA0
 * Callers:
 *     ??0hstring@winrt@@QEAA@PEBGI@Z @ 0x180095678 (--0hstring@winrt@@QEAA@PEBGI@Z.c)
 *     ??$to_hstring@PEBD$0A@@winrt@@YA?AUhstring@0@AEBQEBD@Z @ 0x1800D343C (--$to_hstring@PEBD$0A@@winrt@@YA-AUhstring@0@AEBQEBD@Z.c)
 * Callees:
 *     WINRT_IMPL_HeapAlloc @ 0x18009B83C (WINRT_IMPL_HeapAlloc.c)
 *     WINRT_IMPL_GetProcessHeap @ 0x18009B848 (WINRT_IMPL_GetProcessHeap.c)
