/*
 * XREFs of ?_EnsureTransitionVisualRoot@CTransitionVisualController@@IEAAJXZ @ 0x1800285D8
 * Callers:
      ...
      if ( OverlayRootVisualForDesktop )
      {
        RenderTargetRootVisualForDesktop = CWindowList::GetRenderTargetRootVisualForDesktop(
                                             *((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 53),
                                             v15);
        v4 = v22;
        inserted = CContainerVisual::InsertChildBefore(RenderTargetRootVisualForDesktop, v22, v16);
        v3 = inserted;
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_14:
    if ( v4 )
    {
      ...
      v9 = CWindowList::GetRenderTargetRootVisualForDesktop(
             *((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 53),
             *((_QWORD *)this + 12));
      CContainerVisual::RemoveChild(v9, (struct CVisualProxy **)v4);
    }
    if ( v5 )
    {
      ...
      v10 = CWindowList::GetRenderTargetRootVisualForDesktop(
              *((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 53),
              *((_QWORD *)this + 12));
      CContainerVisual::RemoveChild(v10, *((struct CVisualProxy ***)this + 1));
    }
    goto LABEL_18;
  }
  v3 = -2147467259;
