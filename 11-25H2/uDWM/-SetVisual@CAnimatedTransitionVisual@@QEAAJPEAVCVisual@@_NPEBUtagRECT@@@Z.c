/*
 * XREFs of ?SetVisual@CAnimatedTransitionVisual@@QEAAJPEAVCVisual@@_NPEBUtagRECT@@@Z @ 0x180021818
 * Callers:
 ...
 *     ?GetMonitorRectFromRect@CTransitionVisualController@@SAXPEBUtagRECT@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800A3B68 (-GetMonitorRectFromRect@CTransitionVisualController@@SAXPEBUtagRECT@@PEAV-$TMilRect_@MUD2D_RECT_.c)
 */
        ...
        const struct tagRECT *a4)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x2C3u, 0LL);
    return v9;
  }
  *(_QWORD *)&v33 = 0LL;
  if ( a4 )
  {
    ...
    *(float *)&v33 = left;
    *((float *)&v33 + 1) = top;
    v13 = _mm_cvtsi32_si128(*((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 96));
    v14 = (float)*((int *)CDesktopManager::s_pDesktopManagerInstance + 97);
    *(float *)&v32 = (float)*((int *)CDesktopManager::s_pDesktopManagerInstance + 95);
    v15 = v14 + *(float *)&v32;
    ...
    if ( v10 >= 0 )
      v17 = v10;
    *((float *)&v32 + 2) = v15;
    *((float *)&v32 + 1) = _mm_cvtepi32_ps(v13).m128_f32[0];
    *((float *)&v32 + 3) = v16 + *((float *)&v32 + 1);
    v18 = (float)v17;
    v19 = TMilRect<float,D2D_RECT_F,RectUniqueness::NotNeeded>::Width((__int64)&v32);
    v20 = 0;
    v21 = fminf(v18, v19);
    if ( a4->bottom - a4->top >= 0 )
      v20 = a4->bottom - a4->top;
    *((float *)&v33 + 2) = v21 + left;
    v22 = (float)v20;
    v23 = TMilRect<float,D2D_RECT_F,RectUniqueness::NotNeeded>::Height(&v32);
    v25 = fminf(v22, v23) + v24;
    goto LABEL_8;
  }
  if ( *((int *)a2 + 18) > 0 && *((int *)a2 + 19) > 0 )
  {
    v25 = (float)*((int *)a2 + 19);
    *((float *)&v33 + 2) = (float)*((int *)a2 + 18);
LABEL_8:
    *((float *)&v33 + 3) = v25;
    goto LABEL_9;
  }
  CTransitionVisualController::GetMonitorRectFromRect(0LL, &v32);
  v33 = v32;
LABEL_9:
  v26 = *((_QWORD *)a2 + 2);
  v27 = (__int64)this[67];
  *(_QWORD *)&v32 = 0LL;
  v28 = CCachedVisualImageProxy::Update(v27, (__int64)&v33, (__int64)&v32, 0LL, 0LL, v26, 0);
  v9 = v28;
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v28, 0x2EDu, 0LL);
  }
  else if ( a3 && (v31 = CCachedVisualImageProxy::Freeze(this[67]), v9 = v31, v31 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v31, 0x2F3u, 0LL);
  }
  else
  {
    updated = CAnimatedTransitionVisual::_UpdateBrush((CAnimatedTransitionVisual *)this, this[67]);
    v9 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x2F7u, 0LL);
  }
  return v9;
}
