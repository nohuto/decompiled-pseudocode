/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayExtendAnimatedVisual@@AEAAJXZ @ 0x1800B1B88
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z @ 0x1800B1A00 (-OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayExtendAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
