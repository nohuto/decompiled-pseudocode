/*
 * XREFs of ?UpdateInfoIfTaskbar@CImmersiveState@@AEAA_NPEBVCWindowData@@@Z @ 0x18001C2F8
 * Callers:
 ...
 *     wcscmp_0 @ 0x1800EB0F4 (wcscmp_0.c)
 */
...
LABEL_9:
        ...
        if ( GetMonitorInfoW(v6, &mi) )
        {
          ...
          {
            v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 16, 24, 1, &v22);
            if ( v17 < 0 )
