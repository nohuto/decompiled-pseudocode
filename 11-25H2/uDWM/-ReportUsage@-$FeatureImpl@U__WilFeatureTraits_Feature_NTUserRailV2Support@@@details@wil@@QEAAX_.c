/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_NTUserRailV2Support@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800E7D5C
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_NTUserRailV2Support>::ReportUsage(
        int *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v9 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_NTUserRailV2Support>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v6);
    v4 = v9;
  }
