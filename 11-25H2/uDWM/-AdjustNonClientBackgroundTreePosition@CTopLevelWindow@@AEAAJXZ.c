/*
 * XREFs of ?AdjustNonClientBackgroundTreePosition@CTopLevelWindow@@AEAAJXZ @ 0x18006A304
 * Callers:
...
__int64 __fastcall CTopLevelWindow::AdjustNonClientBackgroundTreePosition(CTopLevelWindow *this)
{
  ...
  v3 = (struct CVisualProxy **)*((_QWORD *)this + 34);
  if ( **((struct CVisualProxy ****)v2 + 19) != v3 )
  {
