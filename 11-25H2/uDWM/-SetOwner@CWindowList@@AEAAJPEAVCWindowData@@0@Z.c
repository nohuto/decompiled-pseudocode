/*
 * XREFs of ?SetOwner@CWindowList@@AEAAJPEAVCWindowData@@0@Z @ 0x18001B438
 * Callers:
...
__int64 __fastcall CWindowList::SetOwner(CWindowList *this, struct CWindowData *a2, struct CWindowData *a3)
{
  ...
  struct CWindowData *v25; // [rsp+48h] [rbp+10h] BYREF
  ...
  *((_QWORD *)v6 + 75) = 0LL;
  if ( v3 )
  {
    ...
    {
      if ( v25 == *(struct CWindowData **)(v11 + 8 * v10) )
        break;
    }
    ...
    {
      if ( *(struct CWindowData **)(*(_QWORD *)(*(_QWORD *)(v3 + 496) + 8 * j) + 64LL) == i )
      {
...
LABEL_24:
  ...
  *((_QWORD *)i + 75) = a3;
  ...
  {
    v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)a3 + 608, 8, 1, &v25);
    v4 = v17;
    if ( v17 >= 0 )
      goto LABEL_17;
    v21 = 190;
LABEL_32:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, v21, 0LL);
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x1124u, 0LL);
    return v4;
  }
...
LABEL_17:
  ...
  if ( v18 < 0 )
  {
    v23 = 4393;
LABEL_19:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, v23, 0LL);
    return v4;
  }
LABEL_21:
  v14 = v25;
