/*
 * XREFs of ?InitializeVisualTreeClone@CButton@@QEAAJPEAV1@W4CloneOptions@@@Z @ 0x1800132B8
 * Callers:
...
__int64 __fastcall CButton::InitializeVisualTreeClone(float *a1, CButton *a2, __int64 a3)
{
  int v5; // eax
  unsigned int v6; // edi
  int v7; // eax
  ...
  v5 = CAtlasedRectsVisual::InitializeVisualTreeClone(a1, a2, a3);
  v6 = v5;
  if ( v5 < 0 )
  {
