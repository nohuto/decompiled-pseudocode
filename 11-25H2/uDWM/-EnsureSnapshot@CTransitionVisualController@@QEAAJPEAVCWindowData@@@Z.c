/*
 * XREFs of ?EnsureSnapshot@CTransitionVisualController@@QEAAJPEAVCWindowData@@@Z @ 0x1800033F8
 * Callers:
...
LABEL_4:
  ...
  {
    v11 = (const struct tagRECT *)(((unsigned __int64)a2 + 684) & -(__int64)((*((_DWORD *)a2 + 170) & 0x1000000) != 0));
