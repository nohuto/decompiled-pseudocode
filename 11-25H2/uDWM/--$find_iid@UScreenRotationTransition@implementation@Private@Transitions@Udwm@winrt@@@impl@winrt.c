/*
 * XREFs of ??$find_iid@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUScreenRotationTransition@implementation@Private@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x18008A2BC
 * Callers:
 *     ?find_interface@?$implements@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIScreenRotationTransition@3456@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x18009A460 (-find_interface@-$implements@UScreenRotationTransition@implementation@Private@Transitions@Udwm@w.c)
 * Callees:
