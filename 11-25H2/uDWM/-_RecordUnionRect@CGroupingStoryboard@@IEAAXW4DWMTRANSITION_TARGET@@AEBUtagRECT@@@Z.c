/*
 * XREFs of ?_RecordUnionRect@CGroupingStoryboard@@IEAAXW4DWMTRANSITION_TARGET@@AEBUtagRECT@@@Z @ 0x1800CA280
 * Callers:
...
char *__fastcall CGroupingStoryboard::_RecordUnionRect(char *a1, __int64 a2, RECT *a3)
{
  ...
  else
  {
    ...
    return std::vector<tagRECT>::emplace_back<tagRECT const &>(v8 + *v6 + 24LL, a3);
  }
  return result;
}
