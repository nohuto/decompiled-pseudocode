/*
 * XREFs of ?Reset@CAnimationClock@@QEAAJK@Z @ 0x180098B18
 * Callers:
 ...
 *     ?IsSet@CTimer@@QEAA_NXZ @ 0x18004D328 (-IsSet@CTimer@@QEAA_NXZ.c)
 *     ?Cancel@CTimer@@QEAAJXZ @ 0x18004D398 (-Cancel@CTimer@@QEAAJXZ.c)
...
LABEL_14:
      ...
      *((_DWORD *)this + 34) = a2;
      v6 = CAnimationClock::_SetTimer(this, (const struct std::nothrow_t *)a2);
    }
    v4 = v6;
    goto LABEL_14;
  }
