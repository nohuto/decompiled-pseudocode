/*
 * XREFs of ?InsertAt@?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@QEAAJAEBUTOUCH_DRAG_POINT@@I@Z @ 0x18002E36C
 * Callers:
...
__int64 __fastcall DynArray<TOUCH_DRAG_POINT,0>::InsertAt(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v15 = a2;
  v5 = DynArrayImpl<0>::Grow(a1, 0x1Cu, 1, a4, &v15);
  v6 = v5;
  if ( v5 < 0 )
  {
  ...
  else
  {
    ...
    *(_DWORD *)(a1 + 24) = v7 + 1;
    ...
    v9 = v15;
    if ( v15 >= v8 && v15 < v8 + 28LL * *(unsigned int *)(a1 + 24) - 28 )
      v9 = v15 + 28;
    *(_OWORD *)v8 = *(_OWORD *)v9;
