/*
 * XREFs of ?SendBoundsToSwapchainTarget@CTopLevelWindow@@AEAAJXZ @ 0x18000C4AC
 * Callers:
...
__int64 __fastcall CTopLevelWindow::SendBoundsToSwapchainTarget(CIndirectSwapchainRenderTargetProxy **this)
{
  ...
  if ( this[95] )
  {
    ...
    updated = CIndirectSwapchainRenderTargetProxy::UpdateTargetBounds(this[95], cxLeftWidth, cyTopHeight, v9, v10);
    v1 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x178Eu, 0LL);
  }
  return v1;
}
