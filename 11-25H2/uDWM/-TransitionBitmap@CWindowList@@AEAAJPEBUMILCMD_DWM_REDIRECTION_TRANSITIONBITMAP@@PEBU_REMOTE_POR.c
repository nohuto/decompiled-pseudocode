/*
 * XREFs of ?TransitionBitmap@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_TRANSITIONBITMAP@@PEBU_REMOTE_PORT_VIEW@@@Z @ 0x1800E88A8
 * Callers:
        ...
        if ( a3->ViewSize )
        {
          ...
          if ( ViewBase )
          {
            ...
            if ( (unsigned int)(v11 - 95) <= 7 )
            {
              ...
              v5 = v14;
              if ( v14 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x149Cu, 0LL);
            }
            else
            {
              ...
              v5 = v12;
              if ( v12 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x14A8u, 0LL);
            }
          }
        }
      }
