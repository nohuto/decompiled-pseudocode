/*
 * XREFs of ?InitializeVisualTreeClone@CAtlasedRectsVisual@@IEAAJPEAV1@W4CloneOptions@@@Z @ 0x180013D7C
 * Callers:
...
__int64 __fastcall CAtlasedRectsVisual::InitializeVisualTreeClone(__int64 a1, CAtlasedRectsVisual *a2, unsigned int a3)
{
  int v6; // eax
  unsigned int v7; // edi
...
LABEL_21:
        ...
        CAtlasedImage::SetOffset(
          (struct tagPOINT *)v20,
          (const struct tagPOINT *)(*(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * i) + 16LL));
        CAtlasedImage::SetSize(
          (struct tagSIZE *)v20,
          (const struct tagSIZE *)(*(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * i) + 24LL));
        CAtlasedImage::SetInsetFromParent(
          (struct _MARGINS *)v20,
          (const struct _MARGINS *)(*(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * i) + 32LL));
        CAtlasedImage::SetClip((RECT *)v20, (const struct tagRECT *)(*(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * i) + 48LL));
        CAtlasedImage::SetHiddenMargins(v20, *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * i) + 64LL));
