/*
 * XREFs of ??$find_iid@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x180099FCC
 * Callers:
 *     ?find_interface@?$implements@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x180098CC0 (-find_interface@-$implements@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transit.c)
 * Callees:
