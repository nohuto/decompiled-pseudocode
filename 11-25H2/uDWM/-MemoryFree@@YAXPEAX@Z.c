/*
 * XREFs of ?MemoryFree@@YAXPEAX@Z @ 0x180098240
 * Callers:
 ...
 *     ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x180082C0C (--1RawUsageIndex@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x180097794 (--1SubscriptionList@details_abi@wil@@QEAA@XZ.c)
