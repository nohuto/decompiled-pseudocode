/*
 * XREFs of ??1CDisplayExtendAnimatedVisual@@MEAA@XZ @ 0x1800B1560
 * Callers:
...
void __fastcall CDisplayExtendAnimatedVisual::~CDisplayExtendAnimatedVisual(CDisplayExtendAnimatedVisual *this)
{
  ...
  *((_QWORD *)this + 30) = &CDisplayExtendToDuplicateAnimatedVisual::`vftable'{for `IAnimationListener'};
  ...
  wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>::~com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>((__int64 *)this + 53);
