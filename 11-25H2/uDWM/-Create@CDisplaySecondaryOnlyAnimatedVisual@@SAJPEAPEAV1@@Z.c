/*
 * XREFs of ?Create@CDisplaySecondaryOnlyAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B3630
 * Callers:
...
__int64 __fastcall CDisplaySecondaryOnlyAnimatedVisual::Create(struct CDisplaySecondaryOnlyAnimatedVisual **a1)
{
  ...
  struct CDisplaySecondaryOnlyAnimatedVisual *v4; // rbx

  if ( a1 )
  {
    v3 = (CDisplaySecondaryOnlyAnimatedVisual *)DefaultHeap::AllocClear(0x1A0uLL);
    if ( v3 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x11u, 0LL);
    *a1 = 0LL;
    if ( v4 )
