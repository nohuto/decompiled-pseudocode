/*
 * XREFs of ??$find@U?$find_iid_traits@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@impl@winrt@@@?$interface_list@UScreenRotationTransition@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@2345@@impl@winrt@@SA?A_PAEBU?$find_iid_traits@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@12@@Z @ 0x1800D489C
 * Callers:
 *     ??$find_iid@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUScreenRotationTransition@implementation@Private@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x18008A2BC (--$find_iid@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@@impl@winrt.c)
 * Callees:
 ...
 *     ??$is_guid_of@UIScreenRotationTransition@Private@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x18008A428 (--$is_guid_of@UIScreenRotationTransition@Private@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@.c)
