/*
 * XREFs of ??$process@V?$nvp@AEAUansistring_tag@tson@@@tson@@V?$nvp@AEAI@2@V?$nvp@AEAUstring_tag@tson@@@2@V12@@output_archive@tson@@AEAAX$$QEAV?$nvp@AEAUansistring_tag@tson@@@1@$$QEAV?$nvp@AEAI@1@$$QEAV?$nvp@AEAUstring_tag@tson@@@1@0@Z @ 0x1800D4B2C
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *(_QWORD *)this = v10;
  ...
  if ( (unsigned __int8)tson::output_archive::write_type(this, v13, v9) )
    tson::write_buffer::push_back(*((void ***)this + 18), &v20, 4uLL);
  v15 = *a4;
