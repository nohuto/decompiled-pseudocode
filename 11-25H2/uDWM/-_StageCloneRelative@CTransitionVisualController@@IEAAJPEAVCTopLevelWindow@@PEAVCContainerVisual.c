/*
 * XREFs of ?_StageCloneRelative@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCContainerVisual@@_NPEAVCVisual@@22PEA_N@Z @ 0x1800829AC
 * Callers:
        ...
        bool *a8)
{
  ...
  v10 = 0;
  v31 = 0LL;
  if ( (*((_BYTE *)CTopLevelWindow::GetWindowData((CTopLevelWindow *)a2) + 672) & 4) != 0 )
    return v10;
  v15 = CTopLevelWindow::CloneVisualTreeForLivePreview(v14, 0, &v32);
  v16 = (struct tagPOINT *)v32;
  v10 = v15;
  if ( v15 < 0 )
  {
    v8 = v15;
  ...
  else
  {
    ...
    if ( a4 )
      CVisual::SetHitTestVisibility((CVisual *)v16, v19);
    if ( a6 )
    {
      inserted = CContainerVisual::InsertChildAfter(a3, (struct CVisual *)v16, a5);
      v10 = inserted;
      if ( inserted < 0 )
      {
        v8 = inserted;
...
LABEL_13:
      if ( a7
        && (!CTopLevelWindow::GetWindowData((CTopLevelWindow *)a2)
         || (*((_DWORD *)CTopLevelWindow::GetWindowData(v22) + 170) & 0x20000000) == 0) )
      {
      ...
      *(_WORD *)((char *)&v34 + 1) = 257;
      ...
      if ( (int)v25 + 1 < (unsigned int)v25 )
      {
        ...
        v8 = -2147024362;
LABEL_29:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, v27, 0LL);
        v21 = 180;
        goto LABEL_32;
      }
      if ( v26 > *((_DWORD *)this + 11) )
      {
        v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 24, 24, 1, &v33);
        v10 = v8;
        if ( v8 < 0 )
        {
          v27 = 190;
    ...
    v10 = CContainerVisual::InsertChildBefore(a3, (CMILRefCountBase ***)v16, (CMILRefCountBase ***)a5);
    v8 = v10;
    if ( (v10 & 0x80000000) == 0 )
    {
      v8 = 0;
...
LABEL_32:
  ...
  if ( v16 )
  {
    ...
    CContainerVisual::RemoveChild(a3, (struct CVisualProxy **)v16);
