/*
 * XREFs of ??$?RV?$nvp@AEAE@tson@@@output_archive@tson@@QEAAAEAV01@$$QEAV?$nvp@AEAE@1@@Z @ 0x1800D452C
 * Callers:
...
__int64 __fastcall tson::output_archive::operator()<tson::nvp<unsigned char &>>(__int64 a1, __int64 *a2, __int64 a3)
{
  ...
  *(_QWORD *)a1 = v4;
  ...
  if ( (unsigned __int8)tson::output_archive::write_type(a1, a2, a3) )
    tson::write_buffer::push_back<unsigned char>(*(tson::write_buffer **)(a1 + 144), &v8);
  return a1;
}
