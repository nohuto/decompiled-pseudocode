/*
 * XREFs of ?HasAnimatingOwnerWindow@CStoryboard@@QEAA_NPEAVCWindowData@@H@Z @ 0x1800C7B58
 * Callers:
...
char __fastcall CStoryboard::HasAnimatingOwnerWindow(CStoryboard *this, struct CWindowData *a2)
{
  ...
  {
    v5 = (HWND)*((_QWORD *)a2 + 5);
    if ( v5 && CAnimationScheduler::IsWindowCurrentlyAnimating(*((CAnimationScheduler **)v2 + 23), v5, 83, 0x10000000) )
      return 1;
