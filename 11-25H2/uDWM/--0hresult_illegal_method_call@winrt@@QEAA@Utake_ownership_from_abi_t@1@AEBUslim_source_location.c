/*
 * XREFs of ??0hresult_illegal_method_call@winrt@@QEAA@Utake_ownership_from_abi_t@1@AEBUslim_source_location@impl@1@@Z @ 0x1800D543C
 * Callers:
...
__int64 __fastcall winrt::hresult_illegal_method_call::hresult_illegal_method_call(
        __int64 a1,
        __int64 a2,
        unsigned int *a3)
{
  winrt::hresult_error::hresult_error(a1, winrt::impl::error_illegal_method_call, (__int64)a3, a3);
  return a1;
}
