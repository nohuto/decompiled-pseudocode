/*
 * XREFs of dllmain_crt_process_attach @ 0x18009C458
 * Callers:
 ...
 *     __scrt_dllmain_before_initialize_c @ 0x18009A890 (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x18009A9B4 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18009AA88 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18009AB28 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x18009B450 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18009C82C (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18009C854 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18009C878 (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x18009C888 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18009C90D (_initterm_0.c)
 *     _initterm_e_0 @ 0x18009C919 (_initterm_e_0.c)
