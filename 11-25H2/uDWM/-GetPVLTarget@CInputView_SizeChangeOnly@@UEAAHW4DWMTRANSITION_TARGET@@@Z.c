/*
 * XREFs of ?GetPVLTarget@CInputView_SizeChangeOnly@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C7020
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CInputView_SizeChangeOnly::GetPVLTarget(__int64 a1, int a2)
{
  ...
  v2 = -1;
  v3 = 0;
  v4 = `CInputView_SizeChangeOnly::GetPVLTarget'::`2'::s_rgPVLTargetLookupTable;
