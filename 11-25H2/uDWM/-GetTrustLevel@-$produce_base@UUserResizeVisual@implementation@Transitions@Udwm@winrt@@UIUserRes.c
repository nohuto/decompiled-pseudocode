/*
 * XREFs of ?GetTrustLevel@?$produce_base@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@X@impl@winrt@@UEAAHPEAW4TrustLevel@Foundation@Windows@3@@Z @ 0x1800D3B50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
