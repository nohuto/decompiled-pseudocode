/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x18007BC80
 * Callers:
 *     <none>
 * Callees:
  ...
  else if ( Msg != 31 )
  {
    if ( Msg == 71 )
    {
      ...
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, LastError, 0x9C1u, 0LL);
        v11 = 1;
      }
      goto LABEL_32;
    }
...
LABEL_6:
      ...
      else
      {
        ...
        if ( v13 >= 0 )
          v13 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x9ABu, 0LL);
        v7 = hWnd;
        if ( a3 == hWnd )
          v11 = 1;
      }
