/*
 * XREFs of ??$_Uninitialized_move@PEAUUserResizeVisual@Transitions@Udwm@winrt@@V?$allocator@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@@std@@YAPEAUUserResizeVisual@Transitions@Udwm@winrt@@QEAU1234@0PEAU1234@AEAV?$allocator@UUserResizeVisual@Transitions@Udwm@winrt@@@0@@Z @ 0x1800DCFA4
 * Callers:
...
winrt::Udwm::Transitions::AnimationCompletedHandler *__fastcall std::_Uninitialized_move<winrt::Udwm::Transitions::UserResizeVisual *>(
        __int64 *a1,
        __int64 *a2,
        winrt::Udwm::Transitions::AnimationCompletedHandler *a3)
{
  ...
  while ( a1 != a2 )
  {
    ...
    *a1 = 0LL;
    *(_QWORD *)a3 = v4;
    a3 = (winrt::Udwm::Transitions::AnimationCompletedHandler *)((char *)a3 + 8);
    ++a1;
  }
