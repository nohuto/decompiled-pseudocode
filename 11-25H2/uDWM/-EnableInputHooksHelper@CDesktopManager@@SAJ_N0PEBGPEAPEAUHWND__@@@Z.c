/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180045DC0
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( CDesktopManager::s_pDesktopManagerInstance )
  {
    if ( a1 )
    {
      ...
      if ( WindowInBand )
      {
        *a4 = WindowInBand;
        ...
        if ( a2 )
          return v6;
        *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 143) = ForegroundWindow;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FD9D8, 2LL, v16, v15, 0LL);
    ...
    if ( *a4 )
    {
      ...
      v14 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 143);
      if ( v14 )
      {
        if ( IsWindow(v14) )
          CDesktopManager::SetForegroundWindowAsync(
            *a4,
            *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 143),
            v18);
        *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 143) = 0LL;
      }
