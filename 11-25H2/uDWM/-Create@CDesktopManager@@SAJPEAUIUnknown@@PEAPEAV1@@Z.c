/*
 * XREFs of ?Create@CDesktopManager@@SAJPEAUIUnknown@@PEAPEAV1@@Z @ 0x1800812A8
 * Callers:
...
__int64 __fastcall CDesktopManager::Create(struct IUnknown *a1, struct CDesktopManager **a2)
{
  ...
  v3 = (CDesktopManager *)DefaultHeap::AllocClear(0x518uLL);
  if ( !v3 )
  {
    v5 = 0LL;
    goto LABEL_7;
...
LABEL_7:
  ...
  v8 = 1607;
LABEL_8:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FB5B8, 1LL, v6, v8, 0LL);
  if ( v5 )
