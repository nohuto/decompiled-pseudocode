/*
 * XREFs of ?Create@CTransitionWindowSnapshot@@SAJPEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@PEAPEAV1@@Z @ 0x180002D48
 * Callers:
        ...
        struct CTransitionWindowSnapshot **a4)
{
  ...
  tagRECT rc; // [rsp+38h] [rbp-40h] BYREF
  ...
  *a4 = 0LL;
  ...
  if ( v8 && (v9 = CTransitionWindowSnapshot::CTransitionWindowSnapshot(v8)) != 0LL )
  {
    ...
    {
      rc = (tagRECT)*((_OWORD *)CTopLevelWindow::GetWindowData(this) + 3);
    }
    v13 = CTransitionWindowSnapshot::Initialize(v9, this, a2, &rc);
    v14 = v13;
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F9240, 1u, v13, 0x2Fu, 0LL);
    }
    else
    {
      *a4 = v9;
  ...
  {
    v14 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F9240, 1u, -2147024882, 0x21u, 0LL);
  }
  return v14;
}
