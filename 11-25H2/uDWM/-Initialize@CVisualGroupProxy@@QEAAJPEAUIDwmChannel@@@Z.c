/*
 * XREFs of ?Initialize@CVisualGroupProxy@@QEAAJPEAUIDwmChannel@@@Z @ 0x1800E16C0
 * Callers:
...
__int64 __fastcall CVisualGroupProxy::Initialize(CVisualGroupProxy *this, struct IDwmChannel *a2)
{
  int v2; // eax
  unsigned int v3; // ebx

  v2 = CResourceProxy::Initialize((__int64)this, 0x29u, (__int64)a2);
  v3 = v2;
  if ( v2 < 0 )
