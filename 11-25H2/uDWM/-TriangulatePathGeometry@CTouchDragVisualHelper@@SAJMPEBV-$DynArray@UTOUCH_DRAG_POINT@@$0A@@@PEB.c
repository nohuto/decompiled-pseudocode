/*
 * XREFs of ?TriangulatePathGeometry@CTouchDragVisualHelper@@SAJMPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEBUtagRECT@@PEAV?$DynArray@UD2D_POINT_3F@@$0A@@@PEAV?$DynArray@UD2D_POINT_2F@@$0A@@@PEAV?$DynArray@I$0A@@@@Z @ 0x18002E8B0
 * Callers:
 ...
 *     ?Subtract@CTouchDragVisualHelper@@SA?AUD2D_VECTOR_3F@@PEBUD2D_POINT_3F@@0@Z @ 0x18002E4D4 (-Subtract@CTouchDragVisualHelper@@SA-AUD2D_VECTOR_3F@@PEBUD2D_POINT_3F@@0@Z.c)
 *     ?CrossProductZ@CTouchDragVisualHelper@@SAMPEBUD2D_VECTOR_3F@@0@Z @ 0x18002F3CC (-CrossProductZ@CTouchDragVisualHelper@@SAMPEBUD2D_VECTOR_3F@@0@Z.c)
        ...
        __int64 a6)
{
  ...
  void *v92[3]; // [rsp+E0h] [rbp-28h] BYREF
  ...
  v11 = -1;
  v78 = -1;
  DynArrayImpl<0>::DynArrayImpl<0>((__int64)v92, 0LL, 0);
  v77 = -1;
  v13 = 0;
  while ( 1 )
  {
    ...
    *((float *)&v84 + 2) = (float)v20[2];
    ...
    if ( (int)v14 + 2 < (unsigned int)v14 )
    {
      ...
      v45 = 179;
LABEL_44:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, v45, 0LL);
      v74 = 268;
      goto LABEL_38;
    }
    if ( v21 <= *(_DWORD *)(v6 + 20) )
    ...
    v26 = DynArrayImpl<0>::AddMultipleAndSet(v6, 12, 2, v133);
    v9 = v26;
    if ( v26 < 0 )
    {
      v45 = 190;
...
LABEL_12:
        ...
        if ( v11 >= 0 )
        {
          ...
          v112 = *((_DWORD *)v51 + 2);
          v93 = 0;
          DynArrayImpl<0>::ShrinkToSize((__int64)v92, 0xCu);
          for ( i = v11; ; ++i )
          {
            if ( i >= v13 )
              goto LABEL_13;
          ...
          else
          {
            ...
            if ( v61 >= 0 )
            {
              ...
              for ( j = 0LL; ; j = (unsigned int)(j + 1) )
              {
                ...
                if ( v66 > *(_DWORD *)(a6 + 20) )
                {
                  v26 = DynArrayImpl<0>::AddMultipleAndSet(a6, 4, 1, v64);
                  v9 = v26;
                  if ( v26 < 0 )
                  {
                    v73 = 190;
              ...
              v73 = 179;
LABEL_72:
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, v73, 0LL);
              v74 = 382;
              goto LABEL_38;
            }
            v74 = 370;
...
LABEL_13:
        if ( !v76 )
        {
          ...
          for ( k = 0LL; ; k = (unsigned int)(k + 1) )
          {
            ...
            if ( v38 > *(_DWORD *)(a6 + 20) )
            {
              v26 = DynArrayImpl<0>::AddMultipleAndSet(a6, 4, 1, v36);
              v9 = v26;
              if ( v26 < 0 )
              {
                v41 = 190;
LABEL_74:
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, v41, 0LL);
                v74 = 410;
                goto LABEL_38;
              }
            }
...
LABEL_29:
  ...
  v26 = DynArrayImpl<0>::AddMultipleAndSet(v19, 8, 2, &v84);
  v9 = v26;
  if ( v26 >= 0 )
    goto LABEL_9;
  v42 = 190;
LABEL_37:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, v42, 0LL);
  v74 = 269;
LABEL_38:
  v43 = v26;
LABEL_39:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v43, v74, 0LL);
LABEL_40:
