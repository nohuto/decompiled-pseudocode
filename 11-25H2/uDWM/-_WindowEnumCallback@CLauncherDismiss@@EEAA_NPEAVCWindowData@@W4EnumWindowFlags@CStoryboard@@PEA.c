/*
 * XREFs of ?_WindowEnumCallback@CLauncherDismiss@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180042A70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CLauncherDismiss@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x18008C820 (-GetPVLTarget@CLauncherDismiss@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
LABEL_28:
          ...
          if ( v32 )
          {
            if ( !v11 )
            {
              ...
              CAnimatedTransitionVisual::SetBeginRect(*((struct tagPOINT **)v29 + 5), &v36);
