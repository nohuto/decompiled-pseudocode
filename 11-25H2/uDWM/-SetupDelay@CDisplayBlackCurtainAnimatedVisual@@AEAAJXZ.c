/*
 * XREFs of ?SetupDelay@CDisplayBlackCurtainAnimatedVisual@@AEAAJXZ @ 0x1800B3A50
 * Callers:
...
__int64 __fastcall CDisplayBlackCurtainAnimatedVisual::SetupDelay(CTimelineBase **this)
{
