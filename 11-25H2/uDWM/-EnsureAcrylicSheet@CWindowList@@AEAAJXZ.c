/*
 * XREFs of ?EnsureAcrylicSheet@CWindowList@@AEAAJXZ @ 0x18007DFFC
 * Callers:
...
__int64 __fastcall CWindowList::EnsureAcrylicSheet(CWindowList *this)
{
  ...
  v3 = (struct CVisualProxy **)*((_QWORD *)this + 67);
  if ( v3 )
  {
    v4 = CContainerVisual::RemoveChild(v3[3], v3);
    if ( v4 < 0 )
    {
      v5 = 3199LL;
      goto LABEL_4;
