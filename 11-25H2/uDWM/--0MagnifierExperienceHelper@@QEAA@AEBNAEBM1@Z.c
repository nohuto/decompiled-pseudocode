/*
 * XREFs of ??0MagnifierExperienceHelper@@QEAA@AEBNAEBM1@Z @ 0x1800BB414
 * Callers:
 ...
 * Callees:
 *     ?UpdateDesktopAndMonitorTopologyInformation@MagnifierExperienceHelper@@QEAAXXZ @ 0x180086F68 (-UpdateDesktopAndMonitorTopologyInformation@MagnifierExperienceHelper@@QEAAXXZ.c)
 *     _anonymous_namespace_::clampFloat @ 0x18008B2AC (_anonymous_namespace_--clampFloat.c)
 */
