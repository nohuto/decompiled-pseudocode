/*
 * XREFs of ?CreateAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@_NHPEAVCStoryboard@@PEAUtagRECT@@4H2PEAPEAVCAnimationComponent@@@Z @ 0x180025F08
 * Callers:
 ...
 *     ?IsGhostWindow@CWindowData@@QEBA_NPEAPEAUHWND__@@@Z @ 0x1800270C4 (-IsGhostWindow@CWindowData@@QEBA_NPEAPEAUHWND__@@@Z.c)
  ...
  *(_QWORD *)&v113.left = 0LL;
                                              ...
                                              v117) )
  {
    ...
    DesktopAnimationComponent = CTransitionVisualController::CreateDesktopAnimationComponent(
                                  ...
                                  v47,
                                  0,
                                  (*((_DWORD *)WindowDataByHwnd + 170) & 0x4000000) != 0,
                                  a6,
                                  v111);
  ...
  v99 = 0;
  v94 = 0;
  v18 = *((_DWORD *)WindowDataByHwnd + 170);
...
LABEL_12:
  ...
  v90 = 0;
  if ( (*((_DWORD *)WindowDataByHwnd + 170) & 0x2000000) != 0 )
    goto LABEL_12;
  v92 = 1;
...
LABEL_13:
  ...
  v19 = *((_DWORD *)WindowDataByHwnd + 173) - *((_DWORD *)WindowDataByHwnd + 171);
  v20 = *((_DWORD *)WindowDataByHwnd + 181) - *((_DWORD *)WindowDataByHwnd + 179);
  v21 = 0;
  if ( v20 >= 0 )
    v21 = *((_DWORD *)WindowDataByHwnd + 181) - *((_DWORD *)WindowDataByHwnd + 179);
  v22 = 0;
  if ( v19 >= 0 )
    v22 = *((_DWORD *)WindowDataByHwnd + 173) - *((_DWORD *)WindowDataByHwnd + 171);
  if ( v22 > v21 )
  {
    v20 = 0;
    if ( v19 >= 0 )
      v20 = *((_DWORD *)WindowDataByHwnd + 173) - *((_DWORD *)WindowDataByHwnd + 171);
  }
  else if ( v20 < 0 )
  {
    v20 = 0;
  }
  v23 = (HWND *)(unsigned int)(*((_DWORD *)WindowDataByHwnd + 174) - *((_DWORD *)WindowDataByHwnd + 172));
  v24 = *((_DWORD *)WindowDataByHwnd + 182) - *((_DWORD *)WindowDataByHwnd + 180);
  v25 = 0;
  if ( v24 >= 0 )
    v25 = *((_DWORD *)WindowDataByHwnd + 182) - *((_DWORD *)WindowDataByHwnd + 180);
  v26 = 0;
  if ( (int)v23 >= 0 )
    v26 = *((_DWORD *)WindowDataByHwnd + 174) - *((_DWORD *)WindowDataByHwnd + 172);
  if ( v26 > v25 )
  {
    v24 = 0;
    if ( (int)v23 >= 0 )
      v24 = *((_DWORD *)WindowDataByHwnd + 174) - *((_DWORD *)WindowDataByHwnd + 172);
  }
  else if ( v24 < 0 )
  {
    v24 = 0;
  }
  if ( (*((_DWORD *)WindowDataByHwnd + 170) & 0x10000000) == 0
  ...
  if ( (*((_DWORD *)WindowDataByHwnd + 29) & 0x20000000) == 0
    && !*((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 508)
  ...
  if ( v44 < v24
    || (*((_DWORD *)WindowDataByHwnd + 170) & 0x1000000) != 0
    && (*((_DWORD *)WindowDataByHwnd + 171) || *((_DWORD *)WindowDataByHwnd + 172)) )
  {
LABEL_34:
    v28 = 0;
  }
  ...
  v91 = IsGhostWindow;
  v30 = *((_DWORD *)WindowDataByHwnd + 170);
  if ( (v30 & 0x200000) == 0 )
    goto LABEL_36;
  if ( (v30 & 0x10000000) != 0 )
  {
  ...
  if ( (*((_BYTE *)WindowDataByHwnd + 672) & 4) == 0
    && !IsGhostWindow
    && ((*((_DWORD *)WindowDataByHwnd + 170) & 0x1000000) == 0
     || !*((_DWORD *)WindowDataByHwnd + 171) && !*((_DWORD *)WindowDataByHwnd + 172)) )
  {
...
LABEL_37:
  ...
  if ( v31 == 1 && (v32 = **((_QWORD **)WindowDataByHwnd + 67), (*(_DWORD *)(v32 + 36) & 0x900000) == 0x900000) )
    ...
    v32 = 0LL;
  v33 = 0;
  if ( IsGhostWindow && !v17 && (*((_BYTE *)WindowDataByHwnd + 676) & 1) != 0 && v28 && v31 )
  {
    v66 = v16;
    if ( !v16 )
    ...
    if ( (int)CTransitionVisualController::GetSurfaceFromThumbnail(
                ...
                *((unsigned int *)WindowDataByHwnd + 170),
                v66,
                v93,
                &v108,
                &v109,
...
LABEL_62:
  ...
  if ( v17
    || CWindowData::IsImmersiveWindow(WindowDataByHwnd) && (*((_BYTE *)WindowDataByHwnd + 676) & 0x10) != 0 && v92 )
  {
    v67 = 8 * v17 + 2;
    v100 = v67;
    v37 = (CVisual *)v16;
...
LABEL_88:
      ...
      {
        v100 = 11;
        if ( *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 508) && v16 )
        {
              ...
              if ( v78 >= 0 )
              {
                ...
                else
                {
                  ...
                  if ( v80 >= 0 )
                  {
                    ...
                    if ( (*((_DWORD *)WindowDataByHwnd + 170) & 0x20000000) != 0 )
                    {
                      if ( v98 != v82 )
                        *((_BYTE *)v40 + 67) = 1;
                      if ( (*((_DWORD *)WindowDataByHwnd + 170) & 0x20000000) != 0 )
                    ...
                    v94 = (*((_DWORD *)WindowDataByHwnd + 170) & 0x80000) != 0
                       && (*((_BYTE *)WindowDataByHwnd + 673) & 0x20) != 0;
...
LABEL_111:
  ...
  if ( !IsRectEmpty((const RECT *)((char *)WindowDataByHwnd + 748)) )
  {
    *(_OWORD *)((char *)v40 + 104) = *(_OWORD *)((char *)WindowDataByHwnd + 748);
    *((_DWORD *)v40 + 17) = 2;
  }
  CTransitionVisualController::_StopAnimations(v51, WindowDataByHwnd);
...
LABEL_133:
      ...
      if ( v110 )
      {
        v112 = *(struct tagRECT *)((char *)WindowDataByHwnd + 684);
        v113 = *(struct tagRECT *)((char *)WindowDataByHwnd + 716);
