/*
 * XREFs of ?get_Target@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHPEAH@Z @ 0x1800E0EF0
 * Callers:
 *     <none>
 * Callees:
 *     ??$detach_from@I@impl@winrt@@YA?A_P$$QEAI@Z @ 0x1800DD1EC (--$detach_from@I@impl@winrt@@YA-A_P$$QEAI@Z.c)
 *     ?Target@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAHXZ @ 0x1800E0AA4 (-Target@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAHXZ.c)
 */
