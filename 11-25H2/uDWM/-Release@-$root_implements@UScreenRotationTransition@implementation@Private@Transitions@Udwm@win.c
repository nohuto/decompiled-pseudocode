/*
 * XREFs of ?Release@?$root_implements@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIScreenRotationTransition@3456@@impl@winrt@@QEAAIXZ @ 0x180034530
 * Callers:
 ...
 *     ?Release@?$produce_base@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@3456@X@impl@winrt@@UEAAIXZ @ 0x1800D63D0 (-Release@-$produce_base@UScreenRotationTransition@implementation@Private@Transition_ea_1800D63D0.c)
 * Callees:
