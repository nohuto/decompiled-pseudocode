/*
 * XREFs of ??0CAnimationComponent@@QEAA@PEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEAVCStoryboard@@@Z @ 0x180027618
 * Callers:
...
__int64 __fastcall CAnimationComponent::CAnimationComponent(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  *(_DWORD *)(a1 + 56) = 0;
  if ( a4 >= 0 )
  {
    ...
    v12 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 138);
    LODWORD(a5) = 0;
    v15 = 0;
