/*
 * XREFs of ?get@?$static_lazy@VFeatureLogging@details@wil@@@details@wil@@QEAAPEAVFeatureLogging@23@P6AXXZ@Z @ 0x18007D55C
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<wil::details::FeatureLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`wil::details::FeatureLogging::Instance'::`2'::wrapper, 0, &v8, (LPVOID *)&v10) && v8 )
  {
    ...
    dword_18011CB7C = 0;
    v10 = &qword_18011CB68;
    qword_18011CB68 = (__int64)&WindowFrameLogging::`vftable';
    v6 = &`wil::details::FeatureLogging::Instance'::`2'::wrapper;
    byte_18011CB78 = 0;
    qword_18011CB80 = (__int64)&`wil::details::FeatureLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
