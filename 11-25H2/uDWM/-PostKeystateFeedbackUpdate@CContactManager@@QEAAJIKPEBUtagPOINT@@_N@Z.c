/*
 * XREFs of ?PostKeystateFeedbackUpdate@CContactManager@@QEAAJIKPEBUtagPOINT@@_N@Z @ 0x18002D574
 * Callers:
        ...
        bool a5)
{
  ...
  v10[1] = a3;
  v12 = a3;
  DynArray<CPenContact,0>::AddMultipleAndSet((__int64)this + 216, (__int64)v10);
LABEL_10:
