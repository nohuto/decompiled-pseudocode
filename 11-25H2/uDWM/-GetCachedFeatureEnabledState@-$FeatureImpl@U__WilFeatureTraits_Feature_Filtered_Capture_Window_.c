/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Filtered_Capture_Window_Close@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800BE7E8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Filtered_Capture_Window_Close@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800C03A0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_Filtered_Capture_Window_Close@@@details@w.c)
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Filtered_Capture_Window_Close@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800BF47C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Filtered_Capture_Window.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Filtered_Capture_Window_Close>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Filtered_Capture_Window_Close>::GetCurrentFeatureEnabledState(
      v7,
      &v17,
      &v16);
