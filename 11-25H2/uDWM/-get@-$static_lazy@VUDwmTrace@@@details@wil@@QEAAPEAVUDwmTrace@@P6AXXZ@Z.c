/*
 * XREFs of ?get@?$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z @ 0x18004B830
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<UDwmTrace>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`UDwmTrace::Instance'::`2'::wrapper, 0, &v6, (LPVOID *)&v8) && v6 )
  {
    ...
    dword_18011978C = 0;
    v8 = &qword_180119778;
    qword_180119778 = (__int64)&WindowFrameLogging::`vftable';
    v4 = &`UDwmTrace::Instance'::`2'::wrapper;
    byte_180119788 = 0;
    qword_180119790 = (__int64)&`UDwmTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
