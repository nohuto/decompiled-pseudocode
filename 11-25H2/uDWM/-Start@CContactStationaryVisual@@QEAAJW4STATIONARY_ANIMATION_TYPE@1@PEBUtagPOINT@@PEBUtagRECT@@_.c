/*
 * XREFs of ?Start@CContactStationaryVisual@@QEAAJW4STATIONARY_ANIMATION_TYPE@1@PEBUtagPOINT@@PEBUtagRECT@@_N@Z @ 0x18002FCAC
 * Callers:
...
__int64 __fastcall CContactStationaryVisual::Start(__int64 a1, __int64 a2, struct tagPOINT *a3, _DWORD *a4, char a5)
{
  __int64 v6; // rax
  __int128 v9; // xmm1
  __int64 v10; // xmm0_8
  ...
  *(_DWORD *)(a1 + 308) = v6;
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0q_EtwEventWriteTransfer(&csadAnimData, &UdwmContactStationaryVisual_Start, (unsigned int)a2);
  v11 = *(unsigned int *)(a1 + 268);
  if ( *(_QWORD *)(a1 + 268) == 0x200000001LL )
  {
    a2 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 20);
    if ( *(_BYTE *)(a2 + 324) )
    {
      *(_DWORD *)(a1 + 272) = 7;
      *(_DWORD *)(a1 + 280) = 1;
  ...
  Theme = (void *)CDesktopManager::GetTheme(v11, a2);
