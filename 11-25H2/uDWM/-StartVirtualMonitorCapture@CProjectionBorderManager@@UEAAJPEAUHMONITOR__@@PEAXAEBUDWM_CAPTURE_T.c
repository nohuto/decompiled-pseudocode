/*
 * XREFs of ?StartVirtualMonitorCapture@CProjectionBorderManager@@UEAAJPEAUHMONITOR__@@PEAXAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800C1010
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  if ( v16 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x254u, 0LL);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopRootVisual, 0x256u, 0LL);
    }
    v7 = v17;
    goto LABEL_19;
  }
