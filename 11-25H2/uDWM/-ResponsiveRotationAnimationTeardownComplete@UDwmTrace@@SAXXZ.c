/*
 * XREFs of ?ResponsiveRotationAnimationTeardownComplete@UDwmTrace@@SAXXZ @ 0x1800D63E8
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationAnimationTeardownComplete(__int64 a1)
{
