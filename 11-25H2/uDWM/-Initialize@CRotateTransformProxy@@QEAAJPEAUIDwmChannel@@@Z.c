/*
 * XREFs of ?Initialize@CRotateTransformProxy@@QEAAJPEAUIDwmChannel@@@Z @ 0x18006FF10
 * Callers:
...
__int64 __fastcall CRotateTransformProxy::Initialize(CRotateTransformProxy *this, struct IDwmChannel *a2)
{
  int v2; // eax
  unsigned int v3; // ebx

  v2 = CResourceProxy::Initialize((__int64)this, 0x20u, (__int64)a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0;
  else
