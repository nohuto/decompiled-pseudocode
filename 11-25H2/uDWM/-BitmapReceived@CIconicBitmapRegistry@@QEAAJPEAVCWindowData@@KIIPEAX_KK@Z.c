/*
 * XREFs of ?BitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_KK@Z @ 0x180058610
 * Callers:
        ...
        char a8)
{
    ...
    && v14 )
  {
    ...
    if ( !IsWindowTab(a2) )
    {
      ...
      if ( !(unsigned int)DwmGetIdealIconicThumbnailSize(v21, &v31) )
      {
        ...
        v10 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, (const int *const)"W", 1LL, -2147467259, 0x296u, 0LL);
        return v10;
      }
      cx = v31.cx;
      cy = v31.cy;
    ...
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, (const int *const)"W", 1LL, v25, 0x2A5u, 0LL);
      v11 = v29;
    }
    else
    {
  ...
  else
  {
    ...
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, (const int *const)"W", 1LL, -2147024809, 0x284u, 0LL);
  }
  if ( v11 )
