/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Capture_uDWMFixMultipleWindowCaptures@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800C0318
 * Callers:
