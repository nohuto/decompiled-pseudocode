/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800E20D4
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v9;
  ...
  if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_GatePerf>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_GatePerf>::GetImpl'::`2'::impl) )
  {
