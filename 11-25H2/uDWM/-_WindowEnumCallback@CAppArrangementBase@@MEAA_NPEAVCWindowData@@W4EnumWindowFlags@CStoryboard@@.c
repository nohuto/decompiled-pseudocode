/*
 * XREFs of ?_WindowEnumCallback@CAppArrangementBase@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800CAA30
 * Callers:
...
char __fastcall CAppArrangementBase::_WindowEnumCallback(CAppArrangementBase *a1, __int64 a2, char a3, _DWORD *a4)
{
  ...
  if ( (a3 & 4) != 0 )
  {
    if ( (unsigned int)v8 > 0x34 || (v9 = 0x10080000400000LL, !_bittest64(&v9, v8)) )
    {
      ...
      if ( (*(_DWORD *)(a2 + 680) & 0x1800000) == 0 && *(_DWORD *)(a2 + 128) != 1 && (_DWORD)v8 != 68 )
