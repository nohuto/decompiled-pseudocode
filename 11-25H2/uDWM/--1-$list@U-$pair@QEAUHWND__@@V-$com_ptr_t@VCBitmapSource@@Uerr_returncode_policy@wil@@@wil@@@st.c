/*
 * XREFs of ??1?$list@U?$pair@QEAUHWND__@@V?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@QEAUHWND__@@V?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@@2@@std@@QEAA@XZ @ 0x1800D9E0C
 * Callers:
 *     _winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::WindowJointResizeTransition_::_1_::dtor$13 @ 0x1800EC013 (_winrt--Udwm--Transitions--Private--implementation--WindowJointResizeTransition--Wi_ea_1800EC013.c)
 * Callees:
