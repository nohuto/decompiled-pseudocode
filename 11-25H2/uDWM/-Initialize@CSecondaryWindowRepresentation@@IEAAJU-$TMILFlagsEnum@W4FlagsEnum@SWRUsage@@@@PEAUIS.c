/*
 * XREFs of ?Initialize@CSecondaryWindowRepresentation@@IEAAJU?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@PEAUISecondaryWindowRepresentationChangedListener@@PEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@@Z @ 0x18001E5DC
 * Callers:
        ...
        int a6)
{
  ...
  *((_QWORD *)this + 4) = a4;
  *((_QWORD *)this + 21) = a3;
  if ( (a2 & 1) != 0 && (v19 = CSecondaryWindowRepresentation::EnsureOwnedWindowVisual(this), v9 = v19, v19 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x8Du, 0LL);
  }
  else
  {
    v8 = CWindowData::AddSecondaryWindowRepresentationToPrimary(a4, this);
    v9 = v8;
    if ( v8 < 0 )
    {
    ...
    {
      *((_BYTE *)this + 160) = 1;
      v10 = CSecondaryWindowRepresentation::OnRepresentationUpdated(this);
      v9 = v10;
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x98u, 0LL);
      }
      else if ( (*((_DWORD *)this + 10) & 0x400) != 0 )
      {
                    ...
                    &v20) >= 0 )
        {
          if ( *((_BYTE *)v20 + 316) )
          {
            ...
            v13 = 0;
            v14 = *(_DWORD *)(*((_QWORD *)this + 4) + 56LL) - *(_DWORD *)(*((_QWORD *)this + 4) + 48LL);
            v15 = 0;
            if ( v14 >= 0 )
              v13 = *(_DWORD *)(*((_QWORD *)this + 4) + 56LL) - *(_DWORD *)(*((_QWORD *)this + 4) + 48LL);
            if ( v12 >= 0 )
