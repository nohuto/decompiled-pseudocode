/*
 * XREFs of ?Update@CBitmapSource@@AEAAJPEAUHICON__@@@Z @ 0x180031A64
 * Callers:
...
__int64 __fastcall CBitmapSource::Update(CBitmapSource *this, HICON a2)
{
  ...
  else
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      v5 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x19Au, 0LL);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x198u, 0LL);
    }
  }
  if ( v8 )
