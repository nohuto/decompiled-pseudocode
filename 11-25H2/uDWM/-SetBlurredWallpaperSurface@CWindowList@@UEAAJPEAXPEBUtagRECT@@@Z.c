/*
 * XREFs of ?SetBlurredWallpaperSurface@CWindowList@@UEAAJPEAXPEBUtagRECT@@@Z @ 0x180078BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::SetBlurredWallpaperSurface(CWindowList *this, void *a2, const struct tagRECT *a3)
{
  ...
  unsigned __int64 v17; // [rsp+88h] [rbp+48h]
  ...
  if ( a2 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x1243u, 0LL);
      Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease(&v16);
      goto LABEL_6;
    }
  ...
  *(struct tagRECT *)((char *)this + 104) = *a3;
  ...
  if ( RootVisualForDesktop )
  {
    ...
    v6 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x1254u, 0LL);
  }
LABEL_6:
