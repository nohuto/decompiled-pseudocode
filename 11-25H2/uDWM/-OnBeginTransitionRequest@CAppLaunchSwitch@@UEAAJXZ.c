/*
 * XREFs of ?OnBeginTransitionRequest@CAppLaunchSwitch@@UEAAJXZ @ 0x1800C7DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAppLaunchSwitch::OnBeginTransitionRequest(CAppLaunchSwitch *this)
{
  ...
  else
  {
    ...
    {
      v4 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FD9E0, 1LL, -2147467259, 0xA22u, 0LL);
      return v4;
    }
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FD9E0, 1LL, v5, 0xA24u, 0LL);
      v1 = v11;
      goto LABEL_14;
    }
    v1 = v11;
