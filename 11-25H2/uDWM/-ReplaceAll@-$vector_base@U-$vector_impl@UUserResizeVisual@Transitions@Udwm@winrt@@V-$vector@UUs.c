        ...
        winrt::impl::collection_version *a1)
{
  ...
  winrt::Udwm::Transitions::AnimationCompletedHandler *v5; // rsi
  __int64 v6; // rbx
  __int64 v7; // rcx
  ...
  if ( &v8 != (__int128 *)v3 )
  {
    v4 = *(winrt::Udwm::Transitions::AnimationCompletedHandler **)v3;
    *(_QWORD *)&v8 = *(_QWORD *)v3;
    *(_QWORD *)v3 = 0LL;
    v5 = *(winrt::Udwm::Transitions::AnimationCompletedHandler **)(v3 + 8);
    *((_QWORD *)&v8 + 1) = v5;
    *(_QWORD *)(v3 + 8) = 0LL;
    v6 = *(_QWORD *)(v3 + 16);
    v9 = v6;
  ...
  std::vector<winrt::Udwm::Transitions::UserResizeVisual>::_Assign_counted_range<winrt::Udwm::Transitions::UserResizeVisual const *>(
    v7,
    *(winrt::Windows::Foundation::IUnknown **)v1,
    *(unsigned int *)(v1 + 8));
  if ( v4 )
  {
    std::_Destroy_range<std::allocator<winrt::Udwm::Transitions::UserResizeVisual>>(v4, v5);
    std::_Deallocate<16,0>(v4, (const struct std::nothrow_t *)((v6 - (_QWORD)v4) & 0xFFFFFFFFFFFFFFF8uLL));
  }
}
