/*
 * XREFs of ?OnBeginTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAVCStoryboard@@PEAU2@@Z @ 0x180027B04
 * Callers:
 *     ?OnBeginTransitionRequest@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAU2@@Z @ 0x18007B6E8 (-OnBeginTransitionRequest@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAU2@@Z.c)
        ...
        struct _GUID *a5)
{
  ...
  if ( !v24[0] )
  {
    ...
    if ( v13 < 0 )
    {
      v23 = 215;
LABEL_28:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F9C80, 1LL, v13, v23, 0LL);
      goto LABEL_7;
    }
    if ( a3 )
...
LABEL_18:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F9C80, 1LL, v21, 0xE2u, 0LL);
    goto LABEL_7;
  }
  if ( v10 < 0 )
    goto LABEL_7;
