/*
 * XREFs of ??$UpdateCaptureControllerCaptureState@AEAPEAUHWND__@@AEA_N@WindowFrameLoggingTelemetry@@SAXAEAPEAUHWND__@@AEA_N@Z @ 0x1800BD764
 * Callers:
        ...
        char *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v16 = 1;
      v13 = 8;
      LOBYTE(v4) = tlgWriteTransfer_EtwEventWriteTransfer(v5, byte_180104C18, 0LL, 0LL, 4, (__int64)v11);
    }
  }
  return (char)v4;
}
