/*
 * XREFs of ?UpdateRemoteAppRenderTargetRoot@CTopLevelWindow@@QEAAJXZ @ 0x18008A490
 * Callers:
  ...
  if ( *((_QWORD *)this + 103) )
  {
    ...
    if ( v4 )
    {
      if ( *((int *)CDesktopManager::s_pDesktopManagerInstance + 8) >= 5 )
      {
        ...
        if ( v5 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x1861u, 0LL);
        }
        else
        {
          ...
          v1 = v6;
          if ( v6 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x1862u, 0LL);
        }
      }
    }
  }
