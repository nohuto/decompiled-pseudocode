/*
 * XREFs of ?OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x1800BA820
 * Callers:
 ...
 *     ?CreateColorTransformResourceProxy@CCompositor@@QEAAJPEAPEAVCColorTransformResourceProxy@@@Z @ 0x18009A394 (-CreateColorTransformResourceProxy@CCompositor@@QEAAJPEAPEAVCColorTransformResourceProxy@@@Z.c)
...
__int64 __fastcall CMagnifier::OnSetColorEffect(CMagnifier *this, const struct MilColorTransform *a2)
{
  ...
  if ( !memcmp_0(&g_MilColorTransfIdentity, a2, 0x64uLL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      *(_OWORD *)((char *)this + 84) = xmmword_1800FBAA0;
      *(_OWORD *)((char *)this + 100) = xmmword_1800FBAB0;
      *(_OWORD *)((char *)this + 116) = xmmword_1800FBAC0;
      *(_OWORD *)((char *)this + 132) = xmmword_1800FBAD0;
      *(_OWORD *)((char *)this + 148) = xmmword_1800FBAE0;
      v6 = 1065353216;
LABEL_12:
      *((_DWORD *)this + 41) = v6;
      return v3;
