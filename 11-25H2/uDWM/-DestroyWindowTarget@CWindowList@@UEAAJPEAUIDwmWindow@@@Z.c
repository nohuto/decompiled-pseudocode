/*
 * XREFs of ?DestroyWindowTarget@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800E4060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::DestroyWindowTarget(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( v8 && (v4 = (CTopLevelWindow *)*((_QWORD *)v8 + 55)) != 0LL )
  {
    ...
    v6 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0xA64u, 0LL);
  }
  else
  {
    v6 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0xA61u, 0LL);
  }
