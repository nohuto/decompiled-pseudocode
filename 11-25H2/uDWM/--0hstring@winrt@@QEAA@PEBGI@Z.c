/*
 * XREFs of ??0hstring@winrt@@QEAA@PEBGI@Z @ 0x180095678
 * Callers:
 ...
 *     ?trim_hresult_message@impl@winrt@@YA?AUhstring@2@QEBGI@Z @ 0x18009FD50 (-trim_hresult_message@impl@winrt@@YA-AUhstring@2@QEBGI@Z.c)
 * Callees:
