/*
 * XREFs of ?UnregisterGlobalTimeChanged@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@AEAAXXZ @ 0x1800D7044
 * Callers:
 ...
 *     ?ReleaseTransitionHandler@CGlobalTimeTrackVisual@@QEAAXXZ @ 0x1800E131C (-ReleaseTransitionHandler@CGlobalTimeTrackVisual@@QEAAXXZ.c)
 */
