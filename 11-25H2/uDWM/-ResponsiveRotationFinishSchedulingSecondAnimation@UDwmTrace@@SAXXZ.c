/*
 * XREFs of ?ResponsiveRotationFinishSchedulingSecondAnimation@UDwmTrace@@SAXXZ @ 0x1800D6578
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationFinishSchedulingSecondAnimation(__int64 a1)
{
