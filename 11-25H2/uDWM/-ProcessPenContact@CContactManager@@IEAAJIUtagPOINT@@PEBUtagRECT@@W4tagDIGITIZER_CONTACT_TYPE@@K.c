/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4tagDIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x18002CF14
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( (v12 & 0x80000000) != 0 )
  {
    ...
    v11 = started;
    if ( started < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x59Eu, 0LL);
    else
