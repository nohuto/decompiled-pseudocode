/*
 * XREFs of ?serialize_data@?$shared_data@$0A@$0A@$0A@@details@tip2@@AEAAPEBDAEAVwrite_buffer@tson@@W4serialize_options@23@@Z @ 0x180097020
 * Callers:
 ...
 *     ?finish@write_buffer@tson@@QEAAJXZ @ 0x1800D796C (-finish@write_buffer@tson@@QEAAJXZ.c)
