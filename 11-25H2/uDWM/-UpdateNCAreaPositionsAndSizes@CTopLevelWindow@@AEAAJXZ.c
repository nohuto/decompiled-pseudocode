/*
 * XREFs of ?UpdateNCAreaPositionsAndSizes@CTopLevelWindow@@AEAAJXZ @ 0x18000C8B0
 * Callers:
 ...
 *     ?_GetRightFrameThickness@CTopLevelWindow@@AEAAHXZ @ 0x180071194 (-_GetRightFrameThickness@CTopLevelWindow@@AEAAHXZ.c)
 *     ?ScaleForDpi@CWindowData@@QEBAII@Z @ 0x18008249C (-ScaleForDpi@CWindowData@@QEBAII@Z.c)
...
__int64 __fastcall CTopLevelWindow::UpdateNCAreaPositionsAndSizes(CTopLevelWindow *this)
{
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0xCFCu, 0LL);
  }
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0xCFDu, 0LL);
    }
    else
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0xCFEu, 0LL);
      }
      else
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0xCFFu, 0LL);
        }
        else
        {
          ...
          v13 = v24;
          if ( v24 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v24, 0xD27u, 0LL);
        }
      }
    }
  }
