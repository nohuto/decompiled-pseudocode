/*
 * XREFs of ?_HandleThumbnailTag@CAppArrangementImmediate@@AEAAJPEAVCWindowData@@_N@Z @ 0x1800C9D4C
 * Callers:
 ...
 *     ?GetPVLTarget@CAppArrangementImmediate@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C6E20 (-GetPVLTarget@CAppArrangementImmediate@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
 *     ?GetSpecialTargetInfo@CAppArrangementImmediate@@UEAA?AW4SpecialTargetInfo@@W4DWMTRANSITION_TARGET@@@Z @ 0x1800C73B0 (-GetSpecialTargetInfo@CAppArrangementImmediate@@UEAA-AW4SpecialTargetInfo@@W4DWMTRANSITION_TARGE.c)
...
LABEL_31:
  ...
  else
  {
    ...
    v20 = (struct tagRECT *)(((unsigned __int64)a2 + 684) & -(__int64)(v19 != 0));
  ...
  if ( (v23 & 0x800000) != 0 )
  {
    v31 = *(struct tagRECT *)((char *)a2 + 732);
  }
  else
  {
    v30 = 0LL;
  ...
  *(_BYTE *)(*(_QWORD *)&v24 + 73LL) = 0;
  if ( (CAppArrangementImmediate::GetSpecialTargetInfo((__int64)this, *((_DWORD *)a2 + 170) & 0xFFF) & 8) != 0 )
  {
