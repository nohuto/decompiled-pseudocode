/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ImplVal@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800BECA0
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ImplVal@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800C05B0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_ImplVal@@@details@wil@@QEAAX_NW4Reporting.c)
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_ImplVal@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800C5270 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_ImplVal@@@details@wil@@QEAA_NW4Re.c)
 * Callees:
