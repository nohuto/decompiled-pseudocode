/*
 * XREFs of ?QueryInterface@?$produce_base@UTransitionState@implementation@Transitions@Udwm@winrt@@UITransitionState@345@X@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x18008A0C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
