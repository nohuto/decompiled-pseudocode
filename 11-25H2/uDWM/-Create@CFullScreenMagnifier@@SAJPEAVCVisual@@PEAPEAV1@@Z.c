/*
 * XREFs of ?Create@CFullScreenMagnifier@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x1800882F8
 * Callers:
 ...
 *     ?Initialize@CFullScreenMagnifier@@AEAAJXZ @ 0x18007CAC8 (-Initialize@CFullScreenMagnifier@@AEAAJXZ.c)
