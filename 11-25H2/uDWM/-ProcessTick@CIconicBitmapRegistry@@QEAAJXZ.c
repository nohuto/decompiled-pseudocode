/*
 * XREFs of ?ProcessTick@CIconicBitmapRegistry@@QEAAJXZ @ 0x18005751C
 * Callers:
...
__int64 __fastcall CIconicBitmapRegistry::ProcessTick(CIconicBitmapRegistry *this)
{
    ...
    do
    {
      ...
      if ( !IsWindowTab(*(struct CWindowData **)(v5 + 16LL * v3 + 8)) )
      {
        ...
        if ( v7 )
        {
          ...
          if ( v8 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x3CFu, 0LL);
        }
      }
      ++v3;
    }
  ...
  v10 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x3D5u, 0LL);
  else
