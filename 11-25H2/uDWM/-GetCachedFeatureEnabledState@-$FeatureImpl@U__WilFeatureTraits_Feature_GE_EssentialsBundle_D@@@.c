/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_D@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800E4BB4
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_D@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800E9294 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_D@@@details@w.c)
 * Callees:
