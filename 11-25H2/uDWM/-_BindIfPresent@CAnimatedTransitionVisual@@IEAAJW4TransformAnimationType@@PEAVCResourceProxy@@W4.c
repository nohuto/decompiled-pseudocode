/*
 * XREFs of ?_BindIfPresent@CAnimatedTransitionVisual@@IEAAJW4TransformAnimationType@@PEAVCResourceProxy@@W4Enum@DwmResourceProperty@@@Z @ 0x180037640
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::_BindIfPresent(__int64 a1, int a2, __int64 a3, unsigned int a4)
{
  ...
  v4 = 0;
  v5 = *(_QWORD *)(a1 + 8LL * a2 + 568);
  if ( v5 )
  {
    v6 = CAnimationResource::AddBinding(v5, a3, a4);
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x79Fu, 0LL);
  }
  return v4;
}
