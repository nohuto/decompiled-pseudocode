/*
 * XREFs of ??$get_weak@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@@?$root_implements@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@@impl@winrt@@IEAA?AU?$weak_ref@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@@2@XZ @ 0x18006241C
 * Callers:
 ...
 *     ??$attach_abi@UIWeakReferenceSource@impl@winrt@@@winrt@@YAXAEAU?$com_ptr@UIWeakReferenceSource@impl@winrt@@@0@PEAUIWeakReferenceSource@impl@0@@Z @ 0x180094FFC (--$attach_abi@UIWeakReferenceSource@impl@winrt@@@winrt@@YAXAEAU-$com_ptr@UIWeakReferenceSource@i.c)
 *     ??0bad_alloc@stdext@@QEAA@XZ @ 0x18009A1D0 (--0bad_alloc@stdext@@QEAA@XZ.c)
        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  winrt::check_hresult(&v9, v5, &pExceptionObject);
  if ( v4 )
