/*
 * XREFs of ?RemoveAt@?$DynArray@PEAVCAnimationClock@@$0A@@@QEAAJI@Z @ 0x180050AB4
 * Callers:
...
__int64 __fastcall DynArray<CAnimationClock *,0>::RemoveAt(__int64 *a1, unsigned int a2)
{
  unsigned int v2; // r8d
  unsigned int v3; // ebx
  unsigned int v4; // r9d
