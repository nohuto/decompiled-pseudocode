/*
 * XREFs of ?Create@CBitmapSource@@SAJIIIIPEBXPEAPEAV1@@Z @ 0x180058914
 * Callers:
        ...
        struct CBitmapSource **a6)
{
  ...
  else
  {
    ...
    {
      v14 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0xE1u, 0LL);
      goto LABEL_23;
    }
    if ( a3 == a1 && a4 == a2 )
    {
LABEL_14:
    ...
    else
    {
      ...
      {
        v14 = -2147024890;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0xE9u, 0LL);
        goto LABEL_23;
      }
      ...
      else
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          {
            v14 = -2147024890;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0xEEu, 0LL);
            goto LABEL_23;
          }
          goto LABEL_14;
        }
...
LABEL_16:
  v16 = v12;
LABEL_22:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, v18, 0LL);
LABEL_23:
  if ( v19 )
