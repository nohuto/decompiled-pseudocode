/*
 * XREFs of ?QueryInterface@CAnimationResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A7560
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CAnimationResource@@UEAAKXZ @ 0x18008DBC0 (-AddRef@CAnimationResource@@UEAAKXZ.c)
 */
