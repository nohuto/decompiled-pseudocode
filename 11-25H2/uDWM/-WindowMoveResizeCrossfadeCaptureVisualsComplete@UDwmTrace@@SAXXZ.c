/*
 * XREFs of ?WindowMoveResizeCrossfadeCaptureVisualsComplete@UDwmTrace@@SAXXZ @ 0x18008E8A8
 * Callers:
...
void __fastcall UDwmTrace::WindowMoveResizeCrossfadeCaptureVisualsComplete(__int64 a1)
{
