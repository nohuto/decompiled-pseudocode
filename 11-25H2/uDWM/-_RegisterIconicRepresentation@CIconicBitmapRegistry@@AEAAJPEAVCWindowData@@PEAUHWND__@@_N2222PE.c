/*
 * XREFs of ?_RegisterIconicRepresentation@CIconicBitmapRegistry@@AEAAJPEAVCWindowData@@PEAUHWND__@@_N2222PEAW4IconicRepresentationType@@@Z @ 0x180055D8C
 * Callers:
  ...
  else
  {
    *(_DWORD *)a9 = 1;
    if ( !a7 )
    {
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0xBCu, 0LL);
        return v9;
      }
      goto LABEL_4;
    }
