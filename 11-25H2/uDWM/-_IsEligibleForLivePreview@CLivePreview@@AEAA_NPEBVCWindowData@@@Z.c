/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x180025DB8
 * Callers:
  ...
  if ( (*((_BYTE *)a2 + 674) & 0x40) == 0 )
  {
    if ( a2[55] )
    {
        ...
        && (*(_DWORD *)(v5 + 116) & 0x20000000) == 0 )
      {
        ...
        {
          v6 = *(HWND *)(v5 + 40);
          if ( v6 != GetDesktopWindow() && v6 != *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 142) )
          {
