/*
 * XREFs of ?StartImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJXZ @ 0x1800B4360
 * Callers:
 *     <none>
 * Callees:
        ...
        CDisplaySecondaryOnlyToDuplicateAnimatedVisual *this)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_180118130, 2LL) )
    {
      v15 = v2;
      v16 = v7;
      v17 = v6;
  ...
  v8 = (struct CAnimatedTransitionVisual **)((char *)this + 392);
  v9 = (struct CAnimatedTransitionVisual *)*((_QWORD *)this + 49);
  if ( !v9 )
  {
    *v8 = 0LL;
  ...
  updated = CDisplayAnimatedVisual::ScheduleAnimation(
              (CDisplaySecondaryOnlyToDuplicateAnimatedVisual *)((char *)this + 408),
              v9,
