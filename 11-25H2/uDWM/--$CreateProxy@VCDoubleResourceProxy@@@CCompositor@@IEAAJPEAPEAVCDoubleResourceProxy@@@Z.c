/*
 * XREFs of ??$CreateProxy@VCDoubleResourceProxy@@@CCompositor@@IEAAJPEAPEAVCDoubleResourceProxy@@@Z @ 0x18007E9AC
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CDoubleResourceProxy>(__int64 a1, CResourceProxy **a2)
{
  CResourceProxy *v4; // rbx
  CDoubleResourceProxy *v5; // rcx
  int v6; // eax
  unsigned int v7; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CDoubleResourceProxy::Initialize(v5, *(struct IDwmChannel **)(a1 + 24));
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v4;
