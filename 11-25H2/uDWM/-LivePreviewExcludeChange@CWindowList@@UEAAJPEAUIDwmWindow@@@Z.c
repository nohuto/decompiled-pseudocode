/*
 * XREFs of ?LivePreviewExcludeChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800E5FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::LivePreviewExcludeChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  v4 = v6;
  if ( v6 )
    *((_BYTE *)v4 + 674) ^= (*((_BYTE *)v4 + 674) ^ ((*(unsigned __int8 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 248LL))(a2) << 6)) & 0x40;
