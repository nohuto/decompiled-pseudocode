...
void __fastcall wil::event_watcher_t_wil::details::unique_storage_wil::details::resource_policy_wil::details::event_watcher_state___void____cdecl___wil::details::event_watcher_state_____wil::details::delete_event_watcher_state_wistd::integral_constant_unsigned___int64_2__wil::details::event_watcher_state___wil::details::event_watcher_state___0_std::nullptr_t____wil::err_returncode_policy_::create_take_hevent_ownership_::_1_::dtor_1(
        __int64 a1,
        __int64 a2)
{
  CDisplayBlackCurtainAnimatedVisual::operator delete(*(void **)(a2 + 88), (const struct std::nothrow_t *)&std::nothrow);
}
