/*
 * XREFs of ?get_local_iids@?$implements@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIScreenRotationTransition@3456@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800D7B10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
