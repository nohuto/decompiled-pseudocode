/*
 * XREFs of ?_ShouldMoveOriginalWindowOffscreenForClone@CTransitionVisualController@@IEAA_NPEAVCWindowData@@@Z @ 0x18008D754
 * Callers:
...
LABEL_7:
  ...
  if ( v2 && GetClassNameW(*v3, ClassName, 260) )
  {
    for ( i = 0LL; (unsigned int)i < 2; i = (unsigned int)(i + 1) )
    {
      ...
      do
      {
        v6 = *(WCHAR *)((char *)v5 + (char *)off_1800F6968[i] - (char *)ClassName);
        v7 = *v5 - v6;
        if ( v7 )
          break;
        ++v5;
