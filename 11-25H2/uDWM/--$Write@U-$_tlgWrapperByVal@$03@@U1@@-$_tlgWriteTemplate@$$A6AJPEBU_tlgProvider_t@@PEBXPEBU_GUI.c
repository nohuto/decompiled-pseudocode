/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3@Z @ 0x180065BF8
 * Callers:
        ...
        __int64 a6)
{
  ...
  v9 = 0;
  v8 = 4;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180118130, a2, 0LL, 0LL, 4, (__int64)v7);
}
