/*
 * XREFs of ?SetLinearGradientFill@CRectangleInstruction@@QEAAJ_NAEBU_D3DCOLORVALUE@@1N@Z @ 0x18006ADC8
 * Callers:
 ...
 *     ?CreateLinearGradientLegacyMilBrushProxy@CCompositor@@QEAAJPEAPEAVCLinearGradientLegacyMilBrushProxy@@@Z @ 0x180096AA4 (-CreateLinearGradientLegacyMilBrushProxy@CCompositor@@QEAAJPEAPEAVCLinearGradientLegacyMilBrushP.c)
        ...
        const struct _D3DCOLORVALUE *a4)
{
        ...
        LinearGradientLegacyMilBrushProxy >= 0) )
  {
    v9 = *v4;
    v11[0] = 0;
    v13 = xmmword_1800FACD8;
    v11[1] = 1065353216;
    v12[0] = 0LL;
    v12[1] = 0LL;
    v15 = xmmword_1800FACE8;
    v14 = DOUBLE_1_0;
