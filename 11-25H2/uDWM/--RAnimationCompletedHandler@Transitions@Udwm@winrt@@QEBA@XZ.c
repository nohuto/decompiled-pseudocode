/*
 * XREFs of ??RAnimationCompletedHandler@Transitions@Udwm@winrt@@QEBA@XZ @ 0x1800896D4
 * Callers:
 *     _lambda_98ec2fe7430b08c69dc947ab84cea740_::operator() @ 0x1800895DC (_lambda_98ec2fe7430b08c69dc947ab84cea740_--operator().c)
 *     ?_Do_call@?$_Func_impl_no_alloc@UUnloadDelegate@Transitions@Udwm@winrt@@X$$V@std@@EEAAXXZ @ 0x1800E0D30 (-_Do_call@-$_Func_impl_no_alloc@UUnloadDelegate@Transitions@Udwm@winrt@@X$$V@std@@EEAAXXZ.c)
 * Callees:
