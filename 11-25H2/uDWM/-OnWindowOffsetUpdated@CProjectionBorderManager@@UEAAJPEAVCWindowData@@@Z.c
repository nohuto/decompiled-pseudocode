/*
 * XREFs of ?OnWindowOffsetUpdated@CProjectionBorderManager@@UEAAJPEAVCWindowData@@@Z @ 0x1800240E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CWindowData *a2)
{
  ...
  if ( !*((_QWORD *)a2 + 81) && *((_DWORD *)a2 + 114) )
  {
    v7 = (HWND)*((_QWORD *)a2 + 5);
    *(_QWORD *)&v22.left = 0LL;
    HostWindowHandle = CProjectionBorderManager::_GetHostWindowHandle(
