/*
 * XREFs of ??$Write@U?$_tlgWrapSz@G@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@G@@@Z @ 0x1800683E4
 * Callers:
        ...
        void **a5)
{
  ...
  v10 = v5;
  v12 = 0;
  return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180118130, a2, 0LL, 0LL, 3, (__int64)v9);
}
