/*
 * XREFs of ??$_Reallocate_grow_by@V_lambda_b70241e9b5ebaad244db3e52d52cab17_@@_KG@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEAAAEAV01@_KV_lambda_b70241e9b5ebaad244db3e52d52cab17_@@_KG@Z @ 0x180063DC0
 * Callers:
        ...
        __int64 a4)
{
  ...
  *((_QWORD *)a1 + 3) = v9;
  ...
  {
    v14 = *(void **)a1;
    _lambda_b70241e9b5ebaad244db3e52d52cab17_::operator()(v11, v10, *(_QWORD *)a1, v4, a4);
