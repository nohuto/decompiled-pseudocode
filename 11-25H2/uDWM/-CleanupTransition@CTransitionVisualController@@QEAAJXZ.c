/*
 * XREFs of ?CleanupTransition@CTransitionVisualController@@QEAAJXZ @ 0x180029A54
 * Callers:
  ...
  if ( *((_QWORD *)this + 1) )
  {
    if ( *((_QWORD *)this + 2) )
    {
      while ( *((_DWORD *)this + 34) )
      {
        ...
        v18 = *(struct CVisualProxy ***)(v17 + 32);
        if ( v18 )
        {
          v19 = v18[3];
          if ( v19 )
        ...
        v20 = *(_QWORD *)(v17 + 40);
        if ( v20 )
          CContainerVisual::RemoveChild(*((CContainerVisual **)this + 2), (struct CVisualProxy **)(v20 + 8));
        CBaseObject::Release((CBaseObject *)v17);
        DynArray<CAnimationComponent *,0>::RemoveAt((char *)this + 112, (unsigned int)(*((_DWORD *)this + 34) - 1));
      }
      CContainerVisual::RemoveChild(*((CContainerVisual **)this + 1), *((struct CVisualProxy ***)this + 2));
    ...
    CContainerVisual::RemoveChild(
      *(CContainerVisual **)(*((_QWORD *)this + 1) + 24LL),
      *((struct CVisualProxy ***)this + 1));
  }
