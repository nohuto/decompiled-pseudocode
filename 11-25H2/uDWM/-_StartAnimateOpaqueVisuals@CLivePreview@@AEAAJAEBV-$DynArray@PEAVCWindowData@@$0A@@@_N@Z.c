/*
 * XREFs of ?_StartAnimateOpaqueVisuals@CLivePreview@@AEAAJAEBV?$DynArray@PEAVCWindowData@@$0A@@@_N@Z @ 0x180052518
 * Callers:
 ...
 *     ?_ContainsWindow@CLivePreview@@AEAA_NAEBV?$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z @ 0x180052760 (-_ContainsWindow@CLivePreview@@AEAA_NAEBV-$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z.c)
...
__int64 __fastcall CLivePreview::_StartAnimateOpaqueVisuals(CLivePreview *this, __int64 a2, char a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    do
    {
      MDIOwner = CWindowData::GetMDIOwner(*(CWindowData **)(*(_QWORD *)a2 + 8 * v8));
      v25 = MDIOwner;
      if ( MDIOwner )
      {
        v11 = v9 + 1;
