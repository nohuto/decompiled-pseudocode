/*
 * XREFs of ?_WindowEnumCallback@CGroupingStoryboard@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800CCAF0
 * Callers:
...
char __fastcall CGroupingStoryboard::_WindowEnumCallback(char *a1, __int64 a2, char a3, _DWORD *a4)
{
  ...
  if ( (a3 & 4) != 0
    && ((*(__int64 (__fastcall **)(char *, _QWORD))(*(_QWORD *)a1 + 120LL))(a1, *(_DWORD *)(a2 + 680) & 0xFFF) & 8) != 0 )
  {
