/*
 * XREFs of ??1CWindowList@@UEAA@XZ @ 0x1800E2728
 * Callers:
 ...
 *     ?IsEmpty@?$CGenericSet@PEAVCWindowData@@@@QEAA_NXZ @ 0x1800591C0 (-IsEmpty@-$CGenericSet@PEAVCWindowData@@@@QEAA_NXZ.c)
