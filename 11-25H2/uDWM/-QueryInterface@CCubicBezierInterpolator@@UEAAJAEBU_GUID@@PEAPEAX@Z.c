/*
 * XREFs of ?QueryInterface@CCubicBezierInterpolator@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800ABCD0
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CCubicBezierInterpolator@@UEAAKXZ @ 0x1800AB720 (-AddRef@CCubicBezierInterpolator@@UEAAKXZ.c)
 */
