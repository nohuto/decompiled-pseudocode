/*
 * XREFs of ?Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z @ 0x1800D1654
 * Callers:
 ...
 * Callees:
 *     ?UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ @ 0x1800D1714 (-UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ.c)
 */
