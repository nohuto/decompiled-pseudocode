/*
 * XREFs of ?RegisterWindowClass@CDesktopManager@@SAJPEBGP6A_JPEAUHWND__@@I_K_J@ZPEAG@Z @ 0x18008C5C4
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  *a3 = v6;
  if ( !v6 )
  {
    ...
    if ( v5 >= 0 )
      v5 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FD9E4, 1LL, v5, 0x7EEu, 0LL);
  }
  if ( v5 != -2147023486 )
