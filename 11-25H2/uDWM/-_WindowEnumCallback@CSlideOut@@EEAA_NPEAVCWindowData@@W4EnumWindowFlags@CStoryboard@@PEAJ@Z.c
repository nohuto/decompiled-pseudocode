/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800CD8B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CSlideOut::_WindowEnumCallback(CSlide *a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (v9 & 0xFFF) != 0 )
  {
    ...
    {
      WPT = CStoryboard::_GetWPT((CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 8));
    ...
    v10 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 24);
    if ( (*(_DWORD *)(a2 + 680) & 0xFFF) != 0x18 )
    {
      v10 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 42);
      if ( (*(_DWORD *)(a2 + 680) & 0xFFF) != 0x2A )
      {
        ...
        v10 = (CStoryboard *)((*(_DWORD *)(a2 + 680) & 0xFFFu) - 70);
...
LABEL_53:
    ...
    if ( CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(v11, *(HWND *)(a2 + 40), 1)
      || ((v12 = *(_DWORD *)(a2 + 680) & 0xFFF, v12 == 42) || v12 == 87)
      && !CTransitionVisualController::HasVisibleStyle(*(HWND *)(a2 + 40)) )
    {
      ...
      if ( WindowDataByHwnd )
      {
        *((_DWORD *)WindowDataByHwnd + 170) = *(_DWORD *)(a2 + 680) & 0xEBFFF000 | 0x1400002A;
        ...
        {
          v17 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(*(_QWORD *)a1 + 112LL))(a1, *(unsigned int *)(a2 + 680));
