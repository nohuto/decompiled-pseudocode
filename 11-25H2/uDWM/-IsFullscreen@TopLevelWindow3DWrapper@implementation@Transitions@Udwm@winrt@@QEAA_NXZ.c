/*
 * XREFs of ?IsFullscreen@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAA_NXZ @ 0x18007E870
 * Callers:
 *     ?get_IsFullscreen@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHPEA_N@Z @ 0x18007E830 (-get_IsFullscreen@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITo.c)
 * Callees:
