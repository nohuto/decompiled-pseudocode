/*
 * XREFs of ?CreateDisplayAnimatedVisual@CDisplayModeChangeHelper@@SAJW4DisplayModeChangeResult@@PEAPEAVCDisplayAnimatedVisual@@@Z @ 0x180037BD4
 * Callers:
...
__int64 __fastcall CDisplayModeChangeHelper::CreateDisplayAnimatedVisual(int a1, CBaseObject **a2)
{
  ...
  *a2 = 0LL;
  if ( !CDesktopManager::IsWindowAnimationEnabled() || CDesktopManager::CheckAnyPreference(0x10u) )
  {
    v28 = 0LL;
