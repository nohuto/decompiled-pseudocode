/*
 * XREFs of ?Initialize@CFlickVisual@@MEAAJXZ @ 0x1800B5430
 * Callers:
...
__int64 __fastcall CFlickVisual::Initialize(struct CContainerVisualProxy **this)
{
  int v2; // eax
  unsigned int v3; // edi
  int v4; // eax
  ...
  else
  {
    ...
    {
      v5 = CContainerVisual::AddChild((CContainerVisual *)this, this[36]);
      v3 = v5;
      if ( v5 < 0 )
      {
