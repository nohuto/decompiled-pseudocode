/*
 * XREFs of ?NotifyTouchDrag@CTouchDragVisual@@QEAAJPEBUtagPOINT@@@Z @ 0x18002D6B0
 * Callers:
 ...
 *     ?DotProduct@CTouchDragVisualHelper@@SAMPEBUD2D_VECTOR_3F@@0@Z @ 0x18002E4A8 (-DotProduct@CTouchDragVisualHelper@@SAMPEBUD2D_VECTOR_3F@@0@Z.c)
  ...
  if ( v7 )
  {
    ...
    if ( v35 > *((_DWORD *)this + 67) )
    {
      ...
      if ( v36 )
      {
        ...
        if ( v37 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v37, 0x69u, 0LL);
          goto LABEL_39;
        }
      }
      *((_DWORD *)this + 101) = 0;
...
LABEL_15:
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0xA3u, 0LL);
LABEL_39:
