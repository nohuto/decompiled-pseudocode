/*
 * XREFs of ?ResponsiveRotationBeginSchedulingFirstAnimation@UDwmTrace@@SAXXZ @ 0x180096D5C
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationBeginSchedulingFirstAnimation(__int64 a1)
{
