/*
 * XREFs of ?UpdateIconPosition@UserResizeVisual@implementation@Transitions@Udwm@winrt@@AEAAXXZ @ 0x1800E0B1C
 * Callers:
 ...
 *     ?GetMidpoint@UserResizeVisual@implementation@Transitions@Udwm@winrt@@AEAA?AUtagPOINT@@UtagRECT@@UtagSIZE@@H@Z @ 0x1800E0720 (-GetMidpoint@UserResizeVisual@implementation@Transitions@Udwm@winrt@@AEAA-AUtagPOINT@@UtagRECT@@.c)
