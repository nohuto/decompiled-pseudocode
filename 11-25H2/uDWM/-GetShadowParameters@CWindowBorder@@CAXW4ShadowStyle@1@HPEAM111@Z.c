/*
 * XREFs of ?GetShadowParameters@CWindowBorder@@CAXW4ShadowStyle@1@HPEAM111@Z @ 0x18003A9D0
 * Callers:
 *     ?GetShadowMargins@CWindowBorder@@QEAA?AU_MARGINS@@XZ @ 0x18003A938 (-GetShadowMargins@CWindowBorder@@QEAA-AU_MARGINS@@XZ.c)
