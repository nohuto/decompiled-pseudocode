/*
 * XREFs of ?get_local_iids@?$implements@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@U1345@UIUserResizeVisualNative@@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800DFF20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
