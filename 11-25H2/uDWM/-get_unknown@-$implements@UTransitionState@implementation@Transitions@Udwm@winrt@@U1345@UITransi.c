/*
 * XREFs of ?get_unknown@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@@UITransitionStateNativePrivate@@@winrt@@EEBAPEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@impl@2@XZ @ 0x1800DCA50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
