/*
 * XREFs of ?_Swap@?$_Func_class@J$$V@std@@IEAAXAEAV12@@Z @ 0x1800807B0
 * Callers:
...
__int64 __fastcall std::_Func_class<long,>::_Swap(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  __int64 result; // rax
  _BYTE *v6; // rdx
  ...
  if ( v4 == a1 || (result = *(_QWORD *)(a2 + 56), result == a2) )
  {
    ...
    result = std::_Func_class<long,>::_Reset_move(a2, v7);
    if ( v8 )
    {
      v6 = v7;
      LOBYTE(v6) = v8 != v7;
