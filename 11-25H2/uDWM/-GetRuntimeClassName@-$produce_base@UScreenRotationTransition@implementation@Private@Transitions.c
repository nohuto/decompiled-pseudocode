/*
 * XREFs of ?GetRuntimeClassName@?$produce_base@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@3456@X@impl@winrt@@UEAAHPEAPEAX@Z @ 0x1800D5FA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
