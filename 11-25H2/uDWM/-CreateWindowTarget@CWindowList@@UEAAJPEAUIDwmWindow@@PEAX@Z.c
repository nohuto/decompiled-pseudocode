/*
 * XREFs of ?CreateWindowTarget@CWindowList@@UEAAJPEAUIDwmWindow@@PEAX@Z @ 0x1800E3B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::CreateWindowTarget(CWindowList *this, struct IDwmWindow *a2, void *a3)
{
  ...
  if ( v11 && (v6 = (struct CWindowTarget **)*((_QWORD *)v11 + 55)) != 0LL )
  {
    ...
    v8 = WindowTarget;
    if ( WindowTarget < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, WindowTarget, 0xA52u, 0LL);
  }
  else
  {
    v8 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0xA4Fu, 0LL);
  }
