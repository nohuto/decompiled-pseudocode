/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z @ 0x180081384
 * Callers:
 ...
 *     ??0CIconicBitmapRegistry@@QEAA@XZ @ 0x180071EB0 (--0CIconicBitmapRegistry@@QEAA@XZ.c)
 *     ?SetWindowAnimation@CDesktopManager@@SAX_N@Z @ 0x180072DC4 (-SetWindowAnimation@CDesktopManager@@SAX_N@Z.c)
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x18007FDE4 (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 *     ?Create@CGraphicsDeviceManager@@SAJ_NPEAPEAV1@@Z @ 0x1800854C4 (-Create@CGraphicsDeviceManager@@SAJ_NPEAPEAV1@@Z.c)
 *     ?SetEventCallback@CAnimationClockCoordinator@@QEAAJPEAUIAnimationClockEventListener@@@Z @ 0x180085CE4 (-SetEventCallback@CAnimationClockCoordinator@@QEAAJPEAUIAnimationClockEventListener@@@Z.c)
 ...
 *     ??0CAnimationClockCoordinator@@QEAA@XZ @ 0x1800880B8 (--0CAnimationClockCoordinator@@QEAA@XZ.c)
 *     ??0CAnimationScheduler@@QEAA@XZ @ 0x180088498 (--0CAnimationScheduler@@QEAA@XZ.c)
 *     ?Init@CImmersiveIconicBitmapRegistry@@QEAAJXZ @ 0x18008A2E0 (-Init@CImmersiveIconicBitmapRegistry@@QEAAJXZ.c)
 *     ??1?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18008A6B8 (--1-$unique_storage@U-$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1-RegCloseKey@@YAJ0@ZU-$integral.c)
 ...
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x18009503C (--0CProjectionBorderManager@@QEAA@XZ.c)
 ...
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x180096CD0 (--0CTransitionVisualController@@QEAA@XZ.c)
 *     McTemplateU0q_EtwEventWriteTransfer @ 0x180097EBC (McTemplateU0q_EtwEventWriteTransfer.c)
 *     ??0CImmersiveIconicBitmapRegistry@@QEAA@XZ @ 0x180099084 (--0CImmersiveIconicBitmapRegistry@@QEAA@XZ.c)
          ...
          *((_QWORD *)this + 7) = 0LL;
          ...
          else
          {
            ...
            *((_QWORD *)this + 28) = v28;
            ...
            {
              v5 = -2147024882;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FB5B8, 1LL, -2147024882, 0x1AEu, 0LL);
              goto LABEL_103;
            }
            ...
            else
            {
              ...
              *((_QWORD *)this + 29) = v30;
              ...
              {
                v5 = -2147024882;
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FB5B8, 1LL, -2147024882, 0x1B2u, 0LL);
                goto LABEL_103;
              }
              ...
              else
              {
                ...
                *((_DWORD *)this + 118) = -1;
                ...
                else
                {
                  ...
                  {
                    LODWORD(Data) = 13;
                    Factory = CDesktopManager::UpdateSettings((CContactManager **)this, (unsigned int *)&Data);
                    v5 = Factory;
                    if ( Factory < 0 )
                    {
                      phkResulta = 468;
...
LABEL_79:
                          v37 = v5;
LABEL_102:
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FB5B8, 1LL, v37, phkResulta, 0LL);
LABEL_103:
...
LABEL_19:
  ...
  v5 = -2147024882;
LABEL_109:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800FB5B8, 1LL, v13, phkResult, 0LL);
LABEL_110:
  if ( v46 )
  {
