/*
 * XREFs of ?Append@?$consume_Windows_Foundation_Collections_IVector@U?$IVector@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@Windows@winrt@@UUserResizeVisual@Transitions@Udwm@5@@impl@winrt@@QEBA@AEBUUserResizeVisual@Transitions@Udwm@3@@Z @ 0x1800DDB08
 * Callers:
