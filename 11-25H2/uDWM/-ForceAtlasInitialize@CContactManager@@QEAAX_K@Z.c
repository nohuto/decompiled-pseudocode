/*
 * XREFs of ?ForceAtlasInitialize@CContactManager@@QEAAX_K@Z @ 0x180024B8C
 * Callers:
...
void __fastcall CContactManager::ForceAtlasInitialize(CContactManager *this, unsigned __int64 a2)
{
  ...
  CBaseObject *v17; // [rsp+88h] [rbp+48h]
  ...
  if ( v3 >= 0 )
  {
    ...
    v7 = v16;
    if ( v5 >= 0 && CContactManager::AddToTouchNode(v6, v15, v4) >= 0 )
    {
      CContainerVisual::AddChild(v4, v7);
      v14.x = -32000;
      v14.y = -32000;
      CVisual::SetOffset((struct tagPOINT *)v7, &v14);
      Touch = CreateTouchVisual<CDirectTouchVisual>(v15);
      v9 = (struct CVisualProxy **)v17;
      if ( Touch >= 0 )
      {
      ...
      CContainerVisual::RemoveChild(v4, (struct CVisualProxy **)v7);
