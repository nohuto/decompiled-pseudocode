/*
 * XREFs of ?MakeSourceHandleForTarget@CDDisplayManager@@QEAAJAEBVCDWMDisplay@@PEAPEAXPEAI@Z @ 0x1800809F0
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  __int64 v30; // rax
  __int64 v31; // r9
  __int64 (__fastcall *v32)(__int64, GUID *, __int64); // r10
  int v33; // eax
  __int64 v34; // rbx
  __int64 (__fastcall *v35)(__int64, HANDLE *); // rdi
  int v36; // eax
  HANDLE v37; // rax
  ...
  __int64 v51; // [rsp+78h] [rbp-8h] BYREF
  int v52; // [rsp+B0h] [rbp+30h] BYREF

  v50 = 0LL;
  v49 = 0LL;
  hObject = 0LL;
  v46 = 0;
  v8 = (*(__int64 (__fastcall **)(_QWORD, __int64 **))(**((_QWORD **)this + 2) + 48LL))(*((_QWORD *)this + 2), &v50);
  v9 = v8;
  if ( v8 < 0 )
  {
    v40 = 64;
  ...
  v8 = (*(__int64 (__fastcall **)(__int64 *, unsigned int *))(*v50 + 56))(v50, &v46);
  v9 = v8;
  if ( v8 < 0 )
  {
    v40 = 65;
LABEL_51:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, v40, 0LL);
    goto LABEL_52;
  }
  for ( i = 0; ; ++i )
  {
    ...
    v12 = *v50;
    v41 = 0LL;
    v13 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64 *))(v12 + 48))(v50, i, &v41);
    v9 = v13;
    if ( v13 < 0 )
    {
    ...
    v14 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v41 + 64LL))(v41, &v45);
    v9 = v14;
    if ( v14 < 0 )
    {
    ...
    v15 = v41;
    v16 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v41 + 48LL);
    v17 = v42;
    v42 = 0LL;
    if ( v17 )
    ...
    v19 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v42 + 48LL))(v42, &v51);
    v9 = v19;
    if ( v19 < 0 )
    {
    ...
    if ( *((_QWORD *)a2 + 21) == v51 && *((_DWORD *)a2 + 48) == v45 )
      break;
LABEL_27:
  ...
  v20 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v43 + 48LL))(v43, &v52);
  v9 = v20;
  if ( v20 < 0 )
  {
    v39 = 97;
  ...
  v24 = v43;
  v25 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v43 + 64LL);
  v26 = v49;
  v49 = 0LL;
  if ( v26 )
  ...
  if ( v20 < 0 )
  {
    v39 = 107;
LABEL_42:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, v39, 0LL);
    goto LABEL_43;
  }
  v27 = v49;
  v28 = *(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v49 + 120LL);
  v29 = v44;
  v44 = 0LL;
  if ( v29 )
  ...
  v47 = 0LL;
  v30 = winrt::to_abi<ITransitionAnimationVisualNative,winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper>((__int64)&v47);
  v33 = v32(v31, &GUID_a6ba4205_e59e_4e71_b25b_4e436d21ee3d, v30);
  v9 = v33;
  if ( v33 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v33, 0x73u, 0LL);
    goto LABEL_35;
  }
  v34 = v47;
  v35 = *(__int64 (__fastcall **)(__int64, HANDLE *))(*(_QWORD *)v47 + 24LL);
  ...
  if ( v36 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v36, 0x7Du, 0LL);
LABEL_35:
