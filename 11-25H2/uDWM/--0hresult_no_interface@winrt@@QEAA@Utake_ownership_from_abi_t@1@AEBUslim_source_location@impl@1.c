/*
 * XREFs of ??0hresult_no_interface@winrt@@QEAA@Utake_ownership_from_abi_t@1@AEBUslim_source_location@impl@1@@Z @ 0x1800D54B4
 * Callers:
...
__int64 __fastcall winrt::hresult_no_interface::hresult_no_interface(__int64 a1, __int64 a2, unsigned int *a3)
{
  winrt::hresult_error::hresult_error(a1, winrt::impl::error_no_interface, (__int64)a3, a3);
  return a1;
}
