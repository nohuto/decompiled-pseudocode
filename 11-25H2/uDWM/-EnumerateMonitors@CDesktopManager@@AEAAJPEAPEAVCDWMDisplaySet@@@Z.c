/*
 * XREFs of ?EnumerateMonitors@CDesktopManager@@AEAAJPEAPEAVCDWMDisplaySet@@@Z @ 0x1800666E0
 * Callers:
 ...
 *     ??0CDWMDisplaySet@@QEAA@XZ @ 0x180066A38 (--0CDWMDisplaySet@@QEAA@XZ.c)
...
LABEL_19:
        v2 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x449u, 0LL);
        goto LABEL_20;
      }
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x45Bu, 0LL);
    goto LABEL_20;
  }
  *((_DWORD *)this + 32) = 0;
...
LABEL_28:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x461u, 0LL);
LABEL_20:
