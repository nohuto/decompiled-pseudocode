/*
 * XREFs of ?LivePreviewAnimation_Flipped@CTopLevelWindow@@AEAAJXZ @ 0x180074FAC
 * Callers:
...
__int64 __fastcall CTopLevelWindow::LivePreviewAnimation_Flipped(CTopLevelWindow *this)
{
  ...
  if ( v1 == 1 )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x11ACu, 0LL);
      return v2;
    }
    goto LABEL_7;
  }
  if ( v1 == 2 )
  {
    ...
    if ( v4 )
    {
      if ( *(_BYTE *)(*(_QWORD *)(v4 + 392) + 72LL) )
      {
        ...
        if ( v7 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x11B4u, 0LL);
          return v2;
        }
LABEL_7:
