/*
 * XREFs of ?get@?$static_lazy@VWindowFrameLoggingTelemetry@@@details@wil@@QEAAPEAVWindowFrameLoggingTelemetry@@P6AXXZ@Z @ 0x1800BC148
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<WindowFrameLoggingTelemetry>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`WindowFrameLoggingTelemetry::Instance'::`2'::wrapper, 0, &v6, (LPVOID *)&v8) && v6 )
  {
    ...
    dword_18011CCC4 = 0;
    v8 = &qword_18011CCB0;
    qword_18011CCB0 = (__int64)&WindowFrameLogging::`vftable';
