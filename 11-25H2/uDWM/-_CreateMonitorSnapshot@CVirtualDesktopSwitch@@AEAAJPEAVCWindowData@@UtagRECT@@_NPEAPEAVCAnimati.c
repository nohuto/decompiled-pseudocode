/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800C997C
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  int v20; // eax
  int v21; // eax
  CAnimatedTransitionVisual *v23; // [rsp+38h] [rbp-50h] BYREF
  __int64 v24; // [rsp+40h] [rbp-48h]
  LPVOID v25; // [rsp+48h] [rbp-40h]
  ...
  if ( v14 )
  {
    v15 = CAnimationComponent::CAnimationComponent((__int64)v14, 0LL, *((_DWORD *)a2 + 170) & 0xFFF, 1, (__int64)this);
    if ( v15 )
    {
      v16 = CAnimatedTransitionVisual::Create(&v23);
      v11 = v23;
      v12 = v16;
      if ( v16 < 0 )
      {
      ...
      v17 = CAnimatedTransitionVisual::SetVisual((struct CBaseImageProxy **)v23, RootVisualForDesktop, 1, a3);
      v12 = v17;
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(
