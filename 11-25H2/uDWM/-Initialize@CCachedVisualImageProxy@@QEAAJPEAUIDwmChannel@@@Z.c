/*
 * XREFs of ?Initialize@CCachedVisualImageProxy@@QEAAJPEAUIDwmChannel@@@Z @ 0x18006B708
 * Callers:
...
__int64 __fastcall CCachedVisualImageProxy::Initialize(CCachedVisualImageProxy *this, struct IDwmChannel *a2)
{
  int v2; // eax
  unsigned int v3; // ebx

  v2 = CResourceProxy::Initialize((__int64)this, 5u, (__int64)a2);
  v3 = v2;
  if ( v2 < 0 )
