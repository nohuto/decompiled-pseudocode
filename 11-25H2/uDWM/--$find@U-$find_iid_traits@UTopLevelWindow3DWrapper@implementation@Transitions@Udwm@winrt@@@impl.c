/*
 * XREFs of ??$find@U?$find_iid_traits@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@@@?$interface_list@UTopLevelWindow3DWrapper@Transitions@Udwm@winrt@@UITransitionAnimationVisualNative@@@impl@winrt@@SA?A_PAEBU?$find_iid_traits@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@@12@@Z @ 0x1800DB3B0
 * Callers:
 *     ??$find_iid@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@@YA?A_PPEBUTopLevelWindow3DWrapper@implementation@Transitions@Udwm@1@AEBUguid@1@@Z @ 0x180088094 (--$find_iid@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@@impl@winrt@@YA-A_PP.c)
 * Callees:
 ...
 *     ??$is_guid_of@UITopLevelWindow3DWrapper@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x180087598 (--$is_guid_of@UITopLevelWindow3DWrapper@Transitions@Udwm@winrt@@@winrt@@YA_NAEBUguid@0@@Z.c)
