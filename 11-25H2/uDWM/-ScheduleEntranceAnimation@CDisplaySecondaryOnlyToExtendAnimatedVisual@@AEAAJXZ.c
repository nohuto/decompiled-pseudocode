/*
 * XREFs of ?ScheduleEntranceAnimation@CDisplaySecondaryOnlyToExtendAnimatedVisual@@AEAAJXZ @ 0x1800B4838
 * Callers:
...
LABEL_3:
  ...
  v10 = CContainerVisual::RemoveChild(
          this,
          (struct CVisualProxy **)((*((_QWORD *)this + 49) + 8LL) & ((unsigned __int128)-(__int128)*((unsigned __int64 *)this + 49) >> 64)));
  v11 = v10;
  if ( v10 >= 0 )
    return 0LL;
  wil::details::in1diag3::Return_Hr(
