/*
 * XREFs of ?CalculateBackgroundType@CTopLevelWindow@@AEBA?AW4BackgroundType@1@XZ @ 0x18000F5B8
 * Callers:
 ...
 *     ?IsFrameExtendedIntoClientAreaLRB@CWindowData@@QEBA_NXZ @ 0x180071EEC (-IsFrameExtendedIntoClientAreaLRB@CWindowData@@QEBA_NXZ.c)
 */
