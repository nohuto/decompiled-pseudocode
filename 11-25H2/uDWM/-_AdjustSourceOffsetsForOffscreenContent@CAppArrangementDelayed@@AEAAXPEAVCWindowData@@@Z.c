/*
 * XREFs of ?_AdjustSourceOffsetsForOffscreenContent@CAppArrangementDelayed@@AEAAXPEAVCWindowData@@@Z @ 0x1800C8D88
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  {
    v6 = *((_DWORD *)a2 + 183) - rc.left;
    v7 = *((_DWORD *)a2 + 184) - rc.top;
  }
  else
  {
  ...
  if ( (*((_DWORD *)a2 + 170) & 0x1000000) != 0 )
    OffsetRect((LPRECT)((char *)a2 + 684), v6 - *((_DWORD *)a2 + 171), v7 - *((_DWORD *)a2 + 172));
  if ( (*((_DWORD *)a2 + 170) & 0x800000) != 0 )
    OffsetRect((LPRECT)((char *)a2 + 716), v6 - *((_DWORD *)a2 + 179), v7 - *((_DWORD *)a2 + 180));
}
