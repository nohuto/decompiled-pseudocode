/*
 * XREFs of ?NotifyRedirectionShutdown@CDesktopManager@@QEAAJXZ @ 0x1800AD224
 * Callers:
...
__int64 __fastcall CDesktopManager::NotifyRedirectionShutdown(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 20) = 1;
  ...
  v4 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x231u, 0LL);
  ...
  {
    SetLastError(0);
    if ( PostThreadMessageW(*((_DWORD *)this + 280), 0x12u, 0LL, 0LL) )
    {
      if ( v4 >= 0 )
      {
        ...
        SetLastError(0);
        if ( WaitForSingleObject(*((HANDLE *)this + 141), 0xFFFFFFFF) )
        {
          ...
          if ( v3 >= 0 )
            v3 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x245u, 0LL);
        }
        else
        {
          v3 = v4;
    ...
    else
    {
      ...
      if ( v3 >= 0 )
        v3 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x23Du, 0LL);
    }
    *((_DWORD *)this + 280) = 0;
