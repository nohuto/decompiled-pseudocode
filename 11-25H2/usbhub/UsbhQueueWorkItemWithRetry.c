/*
 * XREFs of UsbhQueueWorkItemWithRetry @ 0x140016AA0
 * Callers:
 ...
 *     UsbhIsrRetryTimer @ 0x140047D60 (UsbhIsrRetryTimer.c)
 *     UsbhResetIrqPipeRetryTimer @ 0x1400484C0 (UsbhResetIrqPipeRetryTimer.c)
 ...
 *     UsbhIdleIrpRetryTimer @ 0x14005DDB0 (UsbhIdleIrpRetryTimer.c)
 *     UsbhSS_WakeIrpRetryTimer @ 0x14005E070 (UsbhSS_WakeIrpRetryTimer.c)
 * Callees:
