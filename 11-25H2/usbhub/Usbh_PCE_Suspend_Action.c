/*
 * XREFs of Usbh_PCE_Suspend_Action @ 0x1400275AC
 * Callers:
...
LABEL_74:
    ...
    if ( (_DWORD)v20 != 14 )
    {
      ...
      {
        case 0xF:
          Log(a1, 512, 825258081, v20, *(unsigned __int16 *)(a2 + 4));
          *(_QWORD *)(a2 + 736) = 0LL;
          UsbhFlushPortChangeQueue(a1, a2);
          v42 = 32LL * *(unsigned int *)(a2 + 2400);
          *(_DWORD *)(a2 + 12) = 15;
          *(_DWORD *)(v42 + a2 + 1384) = 15;
          break;
        case 0x10:
        case 0x11:
          goto LABEL_74;
        case 0x12:
          Log(a1, 512, 825258039, v20, *(unsigned __int16 *)(a2 + 4));
          UsbhSetPcqEventStatus(a1, a2, 1LL);
          UsbhUnlockPcqWithTag(a1, v47, v10, 0);
          UsbhWaitEventWithTimeoutEx(a1, a2 + 712, 660000LL, 825258039LL, 3, a2);
          v48 = *(unsigned __int16 *)(a2 + 4);
          *(_QWORD *)(a2 + 736) = 0LL;
          UsbhPCE_ResumeDone(a1, a2 + 24, v48);
          goto LABEL_37;
        case 0x14:
          break;
        default:
...
LABEL_72:
    ...
    LODWORD(v52) = 0x40000;
    *(_QWORD *)(a2 + 736) = 0LL;
    v5 = UsbhInsertQueuePortChangeObject(a1, v49, &v52, 0, 0LL);
    if ( v5 >= 0 )
    {
...
LABEL_50:
    ...
    case 1:
      UsbhiSignalSuspendEvent(a1, a2);
      Log(a1, 512, 825258038, v20, *(unsigned __int16 *)(a2 + 4));
      *(_QWORD *)(a2 + 736) = 0LL;
      goto LABEL_46;
    case 2:
      ...
      LODWORD(v52) = 0x40000;
      *(_QWORD *)(a2 + 736) = 0LL;
      v5 = UsbhInsertQueuePortChangeObject(a1, v27, &v52, 0, 0LL);
      if ( v5 >= 0 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
          WPP_RECORDER_SF_d(
    ...
    case 3:
      goto LABEL_72;
    case 4:
      Log(a1, 512, 825258036, v20, *(unsigned __int16 *)(a2 + 4));
      v43 = *(_WORD *)(a2 + 4);
      LODWORD(v52) = 0x40000;
      v5 = UsbhInsertQueuePortChangeObject(a1, v43, &v52, 0, 0LL);
      if ( v5 >= 0 )
      {
        v44 = 32LL * *(unsigned int *)(a2 + 2400);
        *(_DWORD *)(a2 + 12) = 9;
        *(_DWORD *)(v44 + a2 + 1384) = 9;
        goto LABEL_46;
      }
      goto LABEL_45;
    case 5:
      goto LABEL_74;
    case 6:
      Log(a1, 512, 825258034, v20, *(unsigned __int16 *)(a2 + 4));
      *(_QWORD *)(a2 + 736) = 0LL;
      UsbhFlushPortChangeQueue(a1, a2);
      ...
      *(_DWORD *)(v40 + a2 + 1384) = 11;
      UsbhUnlockPcqWithTag(a1, a2, v10, 0);
      *(_DWORD *)(a2 + 400) = UsbhHubSyncSuspendPortEvent(a1, v41, a2);
LABEL_54:
...
LABEL_37:
  ...
  if ( (v53[640] & 1) != 0 && *((_BYTE *)v53 + 5235) == 32 )
    UsbhWait(a1, 0xAu);
  _InterlockedDecrement((volatile signed __int32 *)(a3 + 144));
  *a4 = v5;
}
