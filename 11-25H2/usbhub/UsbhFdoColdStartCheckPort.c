/*
 * XREFs of UsbhFdoColdStartCheckPort @ 0x14002CFB0
 * Callers:
...
__int64 __fastcall UsbhFdoColdStartCheckPort(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0;
  FdoExt(a1);
  v5 = UsbhQueryPortState(a1, *(_WORD *)(a3 + 4), (__int64)&v16, &v17);
  ...
  if ( (v5 & 0xC0000000) == 0xC0000000 )
  {
    ...
    UsbhException(a1, *(_WORD *)(a3 + 4), 48, v10, (unsigned int)v10 & v12, v7, v17, usbfile_fdopwr_c, 3011, (char)v10);
  }
