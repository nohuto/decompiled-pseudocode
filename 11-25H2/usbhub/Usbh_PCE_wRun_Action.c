/*
 * XREFs of Usbh_PCE_wRun_Action @ 0x140023E60
 * Callers:
      ...
      switch ( (int)v19 )
      {
        ...
        case 9:
          ...
          *(_QWORD *)(a2 + 384) = KeGetCurrentThread();
          ...
          v51 = *(_DWORD *)(a2 + 12);
          v52 = 32 * (*(unsigned int *)(a2 + 2400) + 43LL);
          *(_DWORD *)(a2 + 448) = 0;
          *(_DWORD *)(v52 + a2 + 8) = v51;
          goto LABEL_38;
        case 10:
...
LABEL_38:
  KeReleaseSpinLock((PKSPIN_LOCK)(a2 + 440), v10);
LABEL_39:
  UsbhHubRunPortChangeQueue(a1, a2, a3, v42);
}
