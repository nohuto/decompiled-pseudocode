/*
 * XREFs of Usbh_PCE_Close_Action @ 0x14004509C
 * Callers:
 ...
 *     UsbhHubDereferenceProcessChangeWorkItem @ 0x140038DA8 (UsbhHubDereferenceProcessChangeWorkItem.c)
...
void __fastcall Usbh_PCE_Close_Action(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v8 = UsbhLockPcqWithTag(a1, a2, 22, &v22, 0);
  ...
  if ( v12 && (v13 = v12 - 5) != 0 && (v14 = v13 - 9) != 0 )
  {
    if ( (unsigned int)(v14 - 1) < 2 )
    {
      ...
      UsbhUnlockPcqWithTag(a1, v17, v22, 0);
