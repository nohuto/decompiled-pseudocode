/*
 * XREFs of UsbhPdoPower @ 0x1400355C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPower(ULONG_PTR a1, IRP *a2)
{
  ...
  {
    v6 = PdoExt(a1);
    v7 = Usbh_HubDeferIrpProcessing(*((_QWORD *)v6 + 148), a1, UsbhPdoPowerWorker, a2);
    v4 = v7;
    if ( v7 >= 0 )
    {
      return 259;
  ...
  {
    return (unsigned int)UsbhPdoPowerWorkerInternal(a1, (ULONG_PTR)a2);
  }
  return v4;
}
