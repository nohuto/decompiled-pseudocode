/*
 * XREFs of UsbhGetSerialNumber @ 0x14001A728
 * Callers:
...
__int64 __fastcall UsbhGetSerialNumber(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v6[358] & 0x800) == 0 && *((_BYTE *)v6 + 1416) )
  {
    ...
    if ( Pool2 )
    {
      ...
      {
        UsbhException(a1, *((_WORD *)v7 + 714), 89, v9, v23[0], StringFromDevice, v24, usbfile_idstring_c, 1592, 0);
      }
      else
      {
        v12 = v23[0];
        if ( (unsigned __int8)UsbhValidateStringDescriptor(3221225472LL, v9, v23[0], &v24) )
        {
          if ( *v9 >> 1 != 1 )
          {
            ...
            *(_QWORD *)(a3 + 8) = v9;
            ...
            {
              UsbhException(a1, *((_WORD *)v7 + 714), 37, v9, v12, v18, v24, usbfile_idstring_c, 1657, 0);
              UsbhFreeID(a3);
              if ( v28 )
              {
                v7[705] = 1073807369;
