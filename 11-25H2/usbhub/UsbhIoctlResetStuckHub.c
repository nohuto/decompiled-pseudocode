/*
 * XREFs of UsbhIoctlResetStuckHub @ 0x14004E5F8
 * Callers:
...
__int64 __fastcall UsbhIoctlResetStuckHub(__int64 a1, IRP *a2, __int64 a3)
{
  ...
  if ( v6 )
  {
    ...
    {
      UsbhException(a1, 0, 132, &IsAdmin, 1u, v7, 0, usbfile_ioctl_c, 452, 0);
  ...
  if ( (v7 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v7) )
    UsbhException(a1, 0, 91, &v13, 4u, v7, 0, usbfile_ioctl_c, 465, 0);
  if ( (_BYTE)v12 )
