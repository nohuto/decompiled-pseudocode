/*
 * XREFs of UsbhFdoSetPowerDx_Action @ 0x1400325B8
 * Callers:
...
__int64 __fastcall UsbhFdoSetPowerDx_Action(PDEVICE_OBJECT DeviceObject, __int64 a2, IRP *a3)
{
  ...
  *(_QWORD *)(a2 + 64) = a3;
  ...
  UsbhSyncBusPause(DeviceObject, v29, 3);
  ...
  *(_DWORD *)(a2 + 28) = LowPart;
  ...
  else
  {
    ...
    if ( dword_14006F55C )
    {
      if ( dword_14006F55C == 1 )
      {
        v4 = 1;
      }
      else if ( dword_14006F55C == 3 )
      {
        v4 = HIBYTE(v30[640]) & 1;
      }
    }
      ...
      do
      {
        ...
        if ( v22 )
        {
          ...
          if ( *((_BYTE *)PdoExt(v22) + 2740) )
            v6 = 1;
          if ( (unsigned __int8)UsbhPdoArmedForWake(v23) )
          {
