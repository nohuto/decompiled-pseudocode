/*
 * XREFs of UsbhGetRegUsbHubFlags @ 0x14005205C
 * Callers:
...
void __fastcall UsbhGetRegUsbHubFlags(unsigned __int16 *a1)
{
  ...
  wchar_t **v9; // rdi
  int v10; // eax
  void (__fastcall *SystemRoutineAddress)(__int64, void *, __int64 (__fastcall **)(__int64, int, __int64, unsigned int, __int64, __int64), unsigned __int16 *, _QWORD); // rax
  ...
  if ( Pool2 )
  {
    *(_OWORD *)Pool2 = *(_OWORD *)"u\x00s\x00b\x00f\x00l\x00a\x00g\x00s\x00\\\x00v\x00v\x00v\x00v\x00p\x00p\x00p\x00p\x00r\x00r\x00r\x00r";
    *(_OWORD *)(Pool2 + 16) = *(_OWORD *)"\\\x00v\x00v\x00v\x00v\x00p\x00p\x00p\x00p\x00r\x00r\x00r\x00r";
    *(_QWORD *)(Pool2 + 32) = *(_QWORD *)"p\x00r\x00r\x00r\x00r";
    *(_DWORD *)(Pool2 + 40) = *(_DWORD *)"r";
    v4 = a1[1274];
    v5 = a1[1275];
    v6 = a1[1276];
    v7 = a1[1274] & 0xF;
    ...
    *(_WORD *)(Pool2 + 40) = (unsigned __int8)Nibble[v6 & 0xF];
    ...
    while ( v8 )
    {
      ...
      SystemRoutineAddress = (void (__fastcall *)(__int64, void *, __int64 (__fastcall **)(__int64, int, __int64, unsigned int, __int64, __int64), unsigned __int16 *, _QWORD))MmGetSystemRoutineAddress(&DestinationString);
      if ( !SystemRoutineAddress )
        SystemRoutineAddress = (void (__fastcall *)(__int64, void *, __int64 (__fastcall **)(__int64, int, __int64, unsigned int, __int64, __int64), unsigned __int16 *, _QWORD))RtlQueryRegistryValues;
