/*
 * XREFs of UsbhBuildContainerID @ 0x1400599B0
 * Callers:
 ...
 *     RtlStringCopyWorkerW @ 0x14005947C (RtlStringCopyWorkerW.c)
 *     RtlStringLengthWorkerW @ 0x1400594D8 (RtlStringLengthWorkerW.c)
 */
