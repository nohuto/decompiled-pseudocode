/*
 * XREFs of UsbhGetRegUsbDeviceFlags @ 0x1400184C8
 * Callers:
...
__int64 __fastcall UsbhGetRegUsbDeviceFlags(__int64 a1, __int64 a2)
{
  ...
  if ( result )
  {
    *(_OWORD *)result = *(_OWORD *)"u\x00s\x00b\x00f\x00l\x00a\x00g\x00s\x00\\\x00v\x00v\x00v\x00v\x00p\x00p\x00p\x00p\x00r\x00r\x00r\x00r";
    *(_OWORD *)(result + 16) = *(_OWORD *)"\\\x00v\x00v\x00v\x00v\x00p\x00p\x00p\x00p\x00r\x00r\x00r\x00r";
    *(_QWORD *)(result + 32) = *(_QWORD *)"p\x00r\x00r\x00r\x00r";
    *(_DWORD *)(result + 40) = *(_DWORD *)"r";
    v7 = v3[704];
    v8 = v3[705];
    v9 = v3[706];
    v10 = v3[704] & 0xF;
