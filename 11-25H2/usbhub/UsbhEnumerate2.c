/*
 * XREFs of UsbhEnumerate2 @ 0x140036794
 * Callers:
...
__int64 __fastcall UsbhEnumerate2(__int64 a1, unsigned int a2, unsigned __int8 a3, __int64 a4, __int64 a5)
{
  ...
  if ( !v10 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140066828[2 * v25];
    goto LABEL_27;
  }
  v11 = v10 - 1;
  if ( !v11 )
  ...
  if ( !v12 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140069868[2 * v23];
    goto LABEL_27;
  }
  v13 = v12 - 4;
  if ( !v13 )
  ...
  if ( !v14 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140066A28[2 * a3];
LABEL_27:
    if ( v20 )
      return v20(a1, a4, a5);
    return v5;
