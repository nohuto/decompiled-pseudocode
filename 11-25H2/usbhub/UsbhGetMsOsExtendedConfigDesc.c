/*
 * XREFs of UsbhGetMsOsExtendedConfigDesc @ 0x140043178
 * Callers:
 ...
 *     USBD_ValidateExtendedConfigurationDescriptor @ 0x140042440 (USBD_ValidateExtendedConfigurationDescriptor.c)
