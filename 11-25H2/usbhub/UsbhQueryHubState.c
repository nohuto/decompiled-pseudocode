/*
 * XREFs of UsbhQueryHubState @ 0x140048174
 * Callers:
...
__int64 __fastcall UsbhQueryHubState(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  unsigned __int8 v17[2]; // [rsp+58h] [rbp-8h] BYREF
  ...
  if ( Pool2 )
  {
    ...
    *((_BYTE *)P + 8) = 0;
    ...
    v18 = 0;
    v19 = *((_WORD *)P + 2);
    v9 = UsbhSyncSendCommand(a1, v17, (__int64)P, (_WORD *)P + 2, v15, &v20);
    v10 = v20;
    v11 = v9;
    ...
    if ( v11 < 0 || *((_WORD *)P + 2) == 4 )
    {
      if ( (v11 & 0xC0000000) == 0xC0000000 && !Usb_Disconnected(v11) )
      {
        ...
        UsbhException(a1, 0, 8, &P, 0xAu, v11, v10, usbfile_bus_c, 1758, 0);
        v12 = (unsigned __int16 *)P;
      }
      if ( v11 >= 0 )
      {
    ...
    else
    {
      ...
      UsbhException(a1, 0, 9, &P, 0xAu, v11, v10, usbfile_bus_c, 1745, 0);
      if ( a3 )
        *a3 = v10;
      if ( P )
