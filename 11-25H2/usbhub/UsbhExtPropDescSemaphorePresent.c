/*
 * XREFs of UsbhExtPropDescSemaphorePresent @ 0x1400427B8
 * Callers:
 ...
 *     UsbhGetPdoRegistryParameter @ 0x140037970 (UsbhGetPdoRegistryParameter.c)
...
bool __fastcall UsbhExtPropDescSemaphorePresent(PDEVICE_OBJECT DeviceObject)
{
  ...
  if ( (v2[706] & 0x400) != 0 )
    ...
    v5 = 0;
  v13 = v5;
  return (int)UsbhSetPdoRegistryParameter(DeviceObject, v16, 4u, &v13, 4u) < 0;
}
