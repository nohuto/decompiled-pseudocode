/*
 * XREFs of UsbhArmHubForWakeDetect @ 0x14002A004
 * Callers:
...
LONG __fastcall UsbhArmHubForWakeDetect(PDEVICE_OBJECT DeviceObject)
{
  ...
  Irp = 0;
  Timeout = 0;
  UsbhEtwLogHubIrpEvent((__int64)DeviceObject, 0LL, 0LL, &USBHUB_ETW_EVENT_HUB_WAIT_WAKE_START, Timeout, Irp);
  while ( 1 )
  {
  ...
  {
    Log((__int64)DeviceObject, 16, 1463896944, v10, 0LL);
    v2[1221] = 1;
