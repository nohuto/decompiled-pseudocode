/*
 * XREFs of UsbhFdoColdStartPdo @ 0x14002CA60
 * Callers:
...
__int64 __fastcall UsbhFdoColdStartPdo(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v8 = FdoExt(a1);
  v9 = PdoExt(a3);
  v10 = UsbhQueryPortState(a1, *(_WORD *)(a4 + 4), (__int64)&v44, &v42);
  ...
  if ( (v10 & 0xC0000000) != 0xC0000000 )
  {
    if ( *((_BYTE *)v9 + 2740) )
    {
      ...
      v21 = UsbhQueryPortState(a1, *(_WORD *)(a4 + 4), (__int64)&v44, &v42);
      v13 = v21;
      if ( (v21 & 0xC0000000) == 0xC0000000 )
      {
        Log(a1, 16, 1668035397, 0LL, v21);
    ...
    if ( v29 >= 0 )
    {
      ...
      if ( (v30 & 0x8000000) == 0 )
      {
        ...
        if ( v31 )
        {
          ...
          UsbhException(a1, *(_WORD *)(a4 + 4), 114, 0LL, 0, v13, v42, usbfile_fdopwr_c, 3163, 0);
          v28[596] = v8[1054];
        }
        return v13;
      }
...
LABEL_17:
    ...
    v24 = 52;
LABEL_32:
    UsbhException(v18, *(_WORD *)(a4 + 4), v24, v23, 0, v13, v42, usbfile_fdopwr_c, v41, 0);
    return v13;
  }
  Log(a1, 16, 1668035141, 0LL, v10);
...
LABEL_8:
  ...
  UsbhException(a1, *(_WORD *)(a4 + 4), 48, v16, v17, v13, v42, usbfile_fdopwr_c, 3086, v17);
  return v13;
}
