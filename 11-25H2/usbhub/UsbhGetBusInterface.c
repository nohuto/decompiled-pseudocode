/*
 * XREFs of UsbhGetBusInterface @ 0x1400575D4
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  PIRP Irp; // rax
  IRP *v12; // rsi
  $3808100D3DDA3EDB12C8C5596A952CCA *v13; // rdi
  ...
  *(_WORD *)&v15[-1].MajorFunction = 2075;
  ...
  if ( Status >= 0 )
  {
    ...
    {
      Status = -1073741811;
      UsbhException((__int64)DeviceObject, 0, 25, Pool2, 0x20u, -1073741811, 0, usbfile_busif_c, 162, 0);
