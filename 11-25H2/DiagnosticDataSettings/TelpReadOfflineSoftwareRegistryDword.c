/*
 * XREFs of TelpReadOfflineSoftwareRegistryDword @ 0x180004E38
 * Callers:
...
__int64 __fastcall TelpReadOfflineSoftwareRegistryDword(LPCWSTR lpSubKey, LPCWSTR lpValue, _DWORD *pvData)
{
  ...
  LSTATUS KeyW; // eax
  LSTATUS ValueW; // eax
  DWORD v15; // [rsp+40h] [rbp-258h] BYREF
...
LABEL_18:
  ...
  *pvData = 0;
  v15 = 260;
  pcbData[0] = 4;
  v9 = TelpReadRegistryString(v8, L"Software\\Microsoft\\RecoveryEnvironment", L"TargetOS", File, &v15);
  v6 = v9;
  if ( v9 < 0 )
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x7E2, v11, (const char *)(unsigned int)v9);
    v7 = 2050LL;
    goto LABEL_18;
  }
