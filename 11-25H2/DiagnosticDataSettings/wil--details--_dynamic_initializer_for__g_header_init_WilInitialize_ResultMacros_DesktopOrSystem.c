...
void (__fastcall *wil::details::_dynamic_initializer_for__g_header_init_WilInitialize_ResultMacros_DesktopOrSystem__())(wil::details *__hidden this, struct wil::FailureInfo *)
{
  void (__fastcall *result)(wil::details *__hidden, struct wil::FailureInfo *); // rax
  ...
  result = wil::details::MicrosoftInternalNotifyFailure;
