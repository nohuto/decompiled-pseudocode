/*
 * XREFs of TelpReadUsersPolicySetting @ 0x1800051AC
 * Callers:
...
__int64 __fastcall TelpReadUsersPolicySetting(_DWORD *a1, int *a2, const WCHAR *a3)
{
  ...
  *v12 = 0;
  ...
  if ( !v8 )
    goto LABEL_32;
  v13 = StringCchCatW(SubKey, (__int64)v10, (char *)L"\\Users");
  if ( v13 < 0 )
    goto LABEL_32;
...
LABEL_32:
  ...
  if ( hKey )
    RegCloseKey(hKey);
  if ( v13 < 0 )
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x4E8, v8, (const char *)(unsigned int)v13);
