/*
 * XREFs of ?Dispose@CServerAudioSessionControl@@EEAAJXZ @ 0x180050AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CServerAudioSessionControl::Dispose(CServerAudioSessionControl *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_ab1375f163c73c4b99e57586ff560771_Traceguids);
  }
  v2 = 0LL;
