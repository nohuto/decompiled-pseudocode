/*
 * XREFs of ?TryGetResourceManagerService@CBluetoothAudioEndpointResourceManagerProvider@@UEAAJPEAVCEndpointCharacteristics@@AEBU_GUID@@PEAPEAX@Z @ 0x1800ED6C0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v14 = (_QWORD *)(*(__int64 (__fastcall **)(_QWORD, __m128i *))(*(_QWORD *)i[1] + 40LL))(i[1], &v35);
    v15 = *v14 - v34;
    if ( *v14 == (_QWORD)v34 )
  ...
  if ( v24 )
  {
    v26 = ((__int64 (__fastcall *)(_QWORD *, struct CEndpointCharacteristics *))v25[6])(v30, a2);
    v27 = v26;
    if ( v26 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
  ...
  {
    v28 = ((__int64 (__fastcall *)(_QWORD *, struct CEndpointCharacteristics *))v25[7])(v30, a2);
    v29 = v28;
    if ( v28 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
