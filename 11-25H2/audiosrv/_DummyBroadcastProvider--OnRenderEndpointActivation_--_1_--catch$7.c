/*
 * XREFs of _DummyBroadcastProvider::OnRenderEndpointActivation_::_1_::catch$7 @ 0x180166CD9
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DummyBroadcastProvider::OnRenderEndpointActivation_::_1_::catch_7(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
