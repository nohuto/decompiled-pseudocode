/*
 * XREFs of ?OnConnectedToStream@CSharedStreamGroupProxy@@IEAAXPEAUIAudioStreamInfo@@@Z @ 0x1800642F0
 * Callers:
...
void __fastcall CSharedStreamGroupProxy::OnConnectedToStream(
        ...
        struct IAudioStreamInfo *a2)
{
  ...
  CBaseStreamGroupProxy::AddStream(v5, a2);
}
