/*
 * XREFs of AudioSessionGetDisplayName @ 0x180071D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetDisplayName(__int64 *a1, __int64 a2)
{
  ...
  v13 = L"AudioSessionGetDisplayName";
  v14 = v4;
  v15 = 0;
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 184LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetDisplayName", 1838, v8);
