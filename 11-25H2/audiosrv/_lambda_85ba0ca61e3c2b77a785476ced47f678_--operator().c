/*
 * XREFs of _lambda_85ba0ca61e3c2b77a785476ced47f678_::operator() @ 0x1800D37D4
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_85ba0ca61e3c2b77a785476ced47f678__void_::_Do_call @ 0x1800DD570 (std--_Func_impl_no_alloc__lambda_85ba0ca61e3c2b77a785476ced47f678__void_--_Do_call.c)
 * Callees:
...
void __fastcall lambda_85ba0ca61e3c2b77a785476ced47f678_::operator()(_QWORD *a1)
{
  ...
  v7[1] = v4;
  v7[7] = v7;
  v6 = CSerialWorkQueue::QueueRecurringItem((__int64)SerialWorkQueue, 0x1388u, (__int64)off_180171FB8, v7, v5);
  if ( v6 < 0 )
