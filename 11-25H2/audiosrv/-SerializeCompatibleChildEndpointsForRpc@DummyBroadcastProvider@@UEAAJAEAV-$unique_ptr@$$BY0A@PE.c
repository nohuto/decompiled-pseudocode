/*
 * XREFs of ?SerializeCompatibleChildEndpointsForRpc@DummyBroadcastProvider@@UEAAJAEAV?$unique_ptr@$$BY0A@PEAGU?$function_deleter@P6AXPEAX@Z$1?MIDL_user_free@@YAX0@Z@wil@@@wistd@@PEAI@Z @ 0x1800F7F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DummyBroadcastProvider::SerializeCompatibleChildEndpointsForRpc(
        __int64 a1,
        void **a2,
        unsigned int *a3)
{
