/*
 * XREFs of ??0?$vector@IV?$allocator@I@std@@@std@@QEAA@AEBV01@@Z @ 0x1801282BC
 * Callers:
 ...
 *     ??1?$_Tidy_guard@V?$vector@IV?$allocator@I@std@@@std@@@std@@QEAA@XZ @ 0x1801285E0 (--1-$_Tidy_guard@V-$vector@IV-$allocator@I@std@@@std@@@std@@QEAA@XZ.c)
 *     ?_Buy_raw@?$vector@IV?$allocator@I@std@@@std@@AEAAX_K@Z @ 0x1801303B4 (-_Buy_raw@-$vector@IV-$allocator@I@std@@@std@@AEAAX_K@Z.c)
