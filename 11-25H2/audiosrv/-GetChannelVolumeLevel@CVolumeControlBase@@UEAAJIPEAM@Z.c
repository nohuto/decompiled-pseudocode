/*
 * XREFs of ?GetChannelVolumeLevel@CVolumeControlBase@@UEAAJIPEAM@Z @ 0x180061240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::GetChannelVolumeLevel(CVolumeControlBase *this, unsigned int a2, float *a3)
{
  ...
  if ( (unsigned int)v4 >= *((_DWORD *)this + 29) )
  {
    v8 = -2147024809;
LABEL_10:
    AudSrvTraceLoggingErrorHelper("CVolumeControlBase::GetChannelVolumeLevel", 570, v8);
    goto LABEL_5;
  }
  if ( !a3 )
  {
