/*
 * XREFs of ?ToMigratedString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18002A380
 * Callers:
...
__int64 __fastcall CAudioEndpointId::ToMigratedString(_QWORD *a1, __int64 *a2)
{
  ...
  unsigned __int16 *v30; // [rsp+80h] [rbp-39h] BYREF
...
LABEL_44:
  ...
  if ( v8 < 0 )
  {
    ...
    if ( *(_DWORD *)v18 > 4u )
    {
      ...
      EtwEventWriteTransfer(*(_QWORD *)(v18 + 32), v28, 0LL, 0LL, 5, &v30);
    }
  }
  if ( v26 )
