/*
 * XREFs of ?FreePrimaryProfileRenderSaDevicesAndSaveDisplacedStreamGroups@CBtAudioResourceManagerBase@@IEAAJPEAVCEndpointStore@@PEA_N@Z @ 0x1800D51F8
 * Callers:
  ...
  *(_OWORD *)v50 = 0LL;
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( *(_QWORD *)v50 != *(_QWORD *)&v50[2] )
    {
      do
      {
        v16 = *(unsigned __int8 (__fastcall **)(CBtAudioResourceManagerBase *, __int128 *))(*(_QWORD *)this + 144LL);
        v55 = *(_OWORD *)(*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)*v15 + 40LL))(*v15, v62);
        if ( !v16(this, &v55) )
        {
          if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)*v15 + 96LL))(*v15) == 1 )
    ...
    if ( v15 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v15, v14);
