/*
 * XREFs of ?RemoveStaleObjects@CDeviceGraphObjectsStore@@IEAAXXZ @ 0x1800244C8
 * Callers:
...
void __fastcall CDeviceGraphObjectsStore::RemoveStaleObjects(CDeviceGraphObjectsStore *this)
{
  ...
  do
  {
    ...
    for ( m = *(__int64 **)v12; m != v13 && !lambda_92c40f897d3a9c7e927f302002ea2ff3_::operator()(v6, (__int64)m); ++m )
      ;
    if ( m != v13 )
    {
      for ( n = m + 1; n != v13; ++n )
      {
        if ( !lambda_92c40f897d3a9c7e927f302002ea2ff3_::operator()(v6, (__int64)n) )
        {
          v23 = 0LL;
          if ( v26 != n )
          {
