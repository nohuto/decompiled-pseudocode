/*
 * XREFs of ?GetRawModePostMixEffect@EffectPack@@QEAAJHW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x1800810AC
 * Callers:
        ...
        struct IAudioProcessingObject **a5)
{
  ...
  if ( (unsigned int)EffectPack::EndpointConnectorSupportsProcessingModes(this, a3) )
  {
    ...
    if ( SystemEffectDescriptor::IsModeSupportedForStreaming((__int64)this + 2016, &v10, 1) )
    {
      v10 = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
