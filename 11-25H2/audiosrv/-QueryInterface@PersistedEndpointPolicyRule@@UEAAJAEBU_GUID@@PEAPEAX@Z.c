/*
 * XREFs of ?QueryInterface@PersistedEndpointPolicyRule@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011E680
 * Callers:
 *     ?QueryInterface@PersistedEndpointPolicyRule@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011E6F0 (-QueryInterface@PersistedEndpointPolicyRule@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
