/*
 * XREFs of _StreamGroupParams::Clone_::_1_::catch$21 @ 0x180160123
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall StreamGroupParams::Clone_::_1_::catch_21(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
