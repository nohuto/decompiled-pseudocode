/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIAudioResourceManager@@UIAudioResourceControl@@UIAudioRenderEndpointChangeDelegator@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800B8390
 * Callers:
 *     <none>
 * Callees:
