/*
 * XREFs of ??$query_to@UIPropertyValue@Foundation@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAUIPropertyValue@Foundation@Windows@@@Z @ 0x1800A6F40
 * Callers:
