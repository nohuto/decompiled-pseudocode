/*
 * XREFs of s_sndevtResolveSoundAlias @ 0x180041BD0
 * Callers:
 *     <none>
 * Callees:
    ...
    *a6 = v22;
    ...
    if ( v22 )
    {
      ...
      if ( v21 >> 1 )
      {
        ...
        {
          v25 = v21 >> 1;
          v26 = (char *)((char *)FileName - (char *)v22);
          v27 = v22;
          v28 = 0LL;
          do
          {
            if ( !(2147483646 - v24 + v25) )
              break;
            v29 = *(wchar_t *)((char *)v27 + (_QWORD)v26);
            if ( !v29 )
              break;
            *v27 = v29;
            ++v28;
          ...
          *v30 = 0;
          v32 = v24 - v31;
          v33 = v25 == 0 ? 0x8007007A : 0;
          if ( v25 )
          {
            v27 = (wchar_t *)(2 * v32);
            if ( (unsigned __int64)(2 * v32) > 2 )
              memset_0(&v23[v31 + 1], 0, (size_t)(v27 - 1));
          }
          if ( v33 < 0 && v21 )
