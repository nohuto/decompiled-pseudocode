/*
 * XREFs of ?GetInternalModePriorityList@@YAPEBUModeList@@W4SYSTEM_AUDIO_STREAM_TYPE@@KPEAVCEndpointCharacteristics@@H@Z @ 0x18003B118
 * Callers:
...
__int64 __fastcall GetInternalModePriorityList(int a1, int a2, __int64 a3, int a4)
{
  ...
  if ( a1 )
  {
    ...
    if ( a2 == 18 )
    {
      v7 = (unsigned __int64)&unk_18016D9C0;
    }
    else
    {
      if ( a2 != 3 )
        return 0LL;
      v7 = (unsigned __int64)&unk_180177AC0;
    }
    v8 = a4 != 0;
    return v7 & -(__int64)v8;
  }
  if ( dword_1801856A0[a2] )
  {
    v5 = 0;
    v10[0] = 0LL;
    v11 = 0;
    ...
    v7 = (unsigned __int64)&unk_18016D5D8;
    v8 = v5 != 0;
    return v7 & -(__int64)v8;
  }
  return 0LL;
