/*
 * XREFs of ?ServiceMain@@YAXKQEAPEAG@Z @ 0x180144FE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WppInitUm @ 0x180145448 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  if ( !hEventShutdown )
  {
    dword_1801CF490 = GetLastError();
    v6 = (unsigned int)dword_1801CF490;
LABEL_6:
    ReportStatusToSCMgr(1LL, v6, 0LL, v5);
    return;
  }
  dword_1801CF490 = (*((__int64 (__fastcall **)(HANDLE *, LPCWSTR, HANDLE, void (__fastcall *)(void *), _QWORD, int))gpSvchostSharedGlobals
                     + 24))(
                      &hEventShutdownWait,
                      *a2,
                      hEventShutdown,
...
LABEL_19:
  ...
  {
    dword_1801CF490 = GetLastError();
    v15 = (unsigned int)dword_1801CF490;
LABEL_20:
