/*
 * XREFs of _CExclusiveModeListener::OnHoloshellStateChange_::_1_::dtor$3 @ 0x180168C51
 * Callers:
 *     <none>
 * Callees:
 *     ??1HStringReference@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x1800A6F98 (--1HStringReference@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
 */
