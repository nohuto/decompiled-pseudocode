/*
 * XREFs of ??$_Construct_in_place@VEffectPack@@AEAPEBU_tlgProvider_t@@AEAPEAVCEndpointCharacteristics@@AEAV?$shared_ptr@$$CBUEffectPackConfiguration@@@std@@@std@@YAXAEAVEffectPack@@AEAPEBU_tlgProvider_t@@AEAPEAVCEndpointCharacteristics@@AEAV?$shared_ptr@$$CBUEffectPackConfiguration@@@0@@Z @ 0x1800A612C
 * Callers:
