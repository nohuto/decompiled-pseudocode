/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x18015E77C
 * Callers:
 *     <none>
 * Callees:
 *     __GSHandlerCheckCommon @ 0x1800A84C0 (__GSHandlerCheckCommon.c)
 *     __CxxFrameHandler4_0 @ 0x1800A8A3E (__CxxFrameHandler4_0.c)
 */
