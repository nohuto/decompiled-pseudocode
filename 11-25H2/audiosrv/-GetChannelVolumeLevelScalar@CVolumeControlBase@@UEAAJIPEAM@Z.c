/*
 * XREFs of ?GetChannelVolumeLevelScalar@CVolumeControlBase@@UEAAJIPEAM@Z @ 0x180052160
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( (unsigned int)v4 >= *((_DWORD *)this + 29) )
  {
    v7 = -2147024809;
LABEL_10:
    AudSrvTraceLoggingErrorHelper("CVolumeControlBase::GetChannelVolumeLevelScalar", 537, v7);
    goto LABEL_5;
  }
  if ( !a3 )
  {
