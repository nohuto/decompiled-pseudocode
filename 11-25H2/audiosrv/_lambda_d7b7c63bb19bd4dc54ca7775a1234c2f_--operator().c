/*
 * XREFs of _lambda_d7b7c63bb19bd4dc54ca7775a1234c2f_::operator() @ 0x1800EF510
 * Callers:
...
__int64 __fastcall lambda_d7b7c63bb19bd4dc54ca7775a1234c2f_::operator()(__int64 *a1)
{
  __int64 v2; // rsi
  HRESULT v3; // eax
  unsigned int v4; // ebx
