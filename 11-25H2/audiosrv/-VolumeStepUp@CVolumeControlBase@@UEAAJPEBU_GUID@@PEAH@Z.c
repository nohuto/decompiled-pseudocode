/*
 * XREFs of ?VolumeStepUp@CVolumeControlBase@@UEAAJPEBU_GUID@@PEAH@Z @ 0x1800813B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::VolumeStepUp(CVolumeControlBase *this, const struct _GUID *a2, int *a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids);
  }
  v6 = *(_QWORD *)this;
  v13 = 0.0;
