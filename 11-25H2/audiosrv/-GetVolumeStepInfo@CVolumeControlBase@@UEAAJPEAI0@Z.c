/*
 * XREFs of ?GetVolumeStepInfo@CVolumeControlBase@@UEAAJPEAI0@Z @ 0x180070420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::GetVolumeStepInfo(CVolumeControlBase *this, unsigned int *a2, unsigned int *a3)
{
  ...
  *a3 = *((_DWORD *)this + 12);
  ...
  {
LABEL_12:
    AudSrvTraceLoggingErrorHelper("CVolumeControlBase::GetVolumeStepInfo", 306, v5);
  ...
  {
    WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids);
  }
  v6 = *((_DWORD *)this + 12) - 1;
  ...
  *a2 = v7;
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids);
  }
  return (unsigned int)v5;
}
