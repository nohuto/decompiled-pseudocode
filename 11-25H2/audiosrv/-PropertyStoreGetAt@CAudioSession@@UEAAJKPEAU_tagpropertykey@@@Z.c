/*
 * XREFs of ?PropertyStoreGetAt@CAudioSession@@UEAAJKPEAU_tagpropertykey@@@Z @ 0x1800C3A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::PropertyStoreGetAt(CAudioSession *this, unsigned int a2, struct _tagpropertykey *a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x51u, (__int64)&WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, 0LL);
  }
