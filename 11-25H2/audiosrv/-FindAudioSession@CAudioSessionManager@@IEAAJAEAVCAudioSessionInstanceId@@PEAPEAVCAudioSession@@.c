/*
 * XREFs of ?FindAudioSession@CAudioSessionManager@@IEAAJAEAVCAudioSessionInstanceId@@PEAPEAVCAudioSession@@@Z @ 0x180019540
 * Callers:
  ...
  else
  {
    ...
    while ( 1 )
    {
      if ( !(unsigned int)_o__wcsicmp(*(_QWORD *)a2) )
      {
        ...
        {
          v17 = *((_DWORD *)a2 + 12);
          if ( v17 == *(_DWORD *)(v14 + 64) && (v17 || !(unsigned int)_o__wcsicmp(*((_QWORD *)a2 + 1))) )
          {
