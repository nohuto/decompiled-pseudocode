/*
 * XREFs of ??1?$CAutoPtr@UAuxiliaryInputDescriptor@@@ATL@@QEAA@XZ @ 0x1800A65E8
 * Callers:
 *     _CAudioResourceManager::UpdateAuxiliaryInputForStreamGroup_::_1_::dtor$8 @ 0x180164728 (_CAudioResourceManager--UpdateAuxiliaryInputForStreamGroup_--_1_--dtor$8.c)
 * Callees:
