/*
 * XREFs of CEndpointCharacteristics::GetDeviceFormatInternal__lambda_8e14c3ef8ca8112e9c42aed54b541fda___ @ 0x180045618
 * Callers:
        ...
        struct tWAVEFORMATEX **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( !a2 )
  {
    ...
    v12 = (*(__int64 (__fastcall **)(_QWORD, GUID *, struct tagPROPVARIANT *))(**((_QWORD **)this + 9) + 40LL))(
            *((_QWORD *)this + 9),
            &fmtid,
            &pvar);
    if ( v12 >= 0 )
    {
      if ( pvar.vt )
      {
        if ( pvar.vt == 65 )
        {
          ...
          {
            wil::details::in1diag3::Log_Win32(retaddr, (void *)0x199B, v13, v14, v22);
          }
        }
        else
        {
...
LABEL_18:
    ...
    updated = CEndpointCharacteristics::UpdateDeviceFormatEPProperty(this, v7, a4, v25);
    v10 = updated;
    if ( updated >= 0 )
    {
LABEL_26:
