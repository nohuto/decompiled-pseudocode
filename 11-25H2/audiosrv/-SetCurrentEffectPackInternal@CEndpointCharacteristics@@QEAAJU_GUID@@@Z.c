/*
 * XREFs of ?SetCurrentEffectPackInternal@CEndpointCharacteristics@@QEAAJU_GUID@@@Z @ 0x18012E6D0
 * Callers:
    ...
    if ( !v10 )
    {
      ...
      if ( v14 >= 0 )
      {
        *(_OWORD *)pvar = 0LL;
        ...
        v18 = CEndpointCharacteristics::SetCurrentEffectPackInternal((CEndpointCharacteristics *)this, &v23);
        if ( v18 < 0 )
          wil::details::in1diag3::_Log_Hr(
            retaddr,
            1592LL,
