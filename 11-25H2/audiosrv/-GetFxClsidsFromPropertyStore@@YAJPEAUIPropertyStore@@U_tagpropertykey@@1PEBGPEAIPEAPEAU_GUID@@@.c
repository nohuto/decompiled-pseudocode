/*
 * XREFs of ?GetFxClsidsFromPropertyStore@@YAJPEAUIPropertyStore@@U_tagpropertykey@@1PEBGPEAIPEAPEAU_GUID@@@Z @ 0x180092598
 * Callers:
 ...
 *     ?IsAPOClsidRegistered@@YA_NPEAUHKEY__@@U_GUID@@@Z @ 0x18004F8AC (-IsAPOClsidRegistered@@YA_NPEAUHKEY__@@U_GUID@@@Z.c)
...
LABEL_44:
  ...
  if ( !LOWORD(lpsz[0]) )
  {
    if ( (unsigned int)operator==((__int64)a3, (__int64)&unk_180186F60) )
      goto LABEL_30;
