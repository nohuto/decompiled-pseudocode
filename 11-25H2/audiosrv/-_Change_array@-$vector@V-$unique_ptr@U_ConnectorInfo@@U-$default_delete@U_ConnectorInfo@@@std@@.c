/*
 * XREFs of ?_Change_array@?$vector@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@V?$allocator@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@@2@@std@@AEAAXQEAV?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@2@_K1@Z @ 0x1800EAB60
 * Callers:
...
__int64 __fastcall std::vector<std::unique_ptr<_ConnectorInfo>>::_Change_array(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( v6 )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<_ConnectorInfo>>>((__int64)v6, *(_QWORD *)(a1 + 8));
