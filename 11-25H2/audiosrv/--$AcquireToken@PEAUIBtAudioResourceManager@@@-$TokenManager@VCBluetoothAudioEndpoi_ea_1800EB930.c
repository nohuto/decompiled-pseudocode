/*
 * XREFs of ??$AcquireToken@PEAUIBtAudioResourceManager@@@?$TokenManager@VCBluetoothAudioEndpointResourceManagerProvider@@@@QEAAJAEBQEAUIBtAudioResourceManager@@W4TOKEN_ACQUIRE_OPTION@@PEAPEAUIUnknown@@@Z @ 0x1800EB930
 * Callers:
 *     ?AcquireToken@CBluetoothAudioEndpointResourceManagerProvider@@UEAAJPEAUIBtAudioResourceManager@@W4TOKEN_ACQUIRE_OPTION@@PEAPEAUIUnknown@@@Z @ 0x1800ECC80 (-AcquireToken@CBluetoothAudioEndpointResourceManagerProvider@@UEAAJPEAUIBtAudioResourceManager@@.c)
 * Callees:
