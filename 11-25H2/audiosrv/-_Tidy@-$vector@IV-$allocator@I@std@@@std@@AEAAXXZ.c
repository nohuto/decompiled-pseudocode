/*
 * XREFs of ?_Tidy@?$vector@IV?$allocator@I@std@@@std@@AEAAXXZ @ 0x1801317B0
 * Callers:
 *     ??1?$_Bt_state_t@PEBG@std@@QEAA@XZ @ 0x1801284D8 (--1-$_Bt_state_t@PEBG@std@@QEAA@XZ.c)
 ...
 *     ??1?$_Vb_val@V?$allocator@_N@std@@@std@@QEAA@XZ @ 0x180128620 (--1-$_Vb_val@V-$allocator@_N@std@@@std@@QEAA@XZ.c)
 ...
 *     ??1?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@QEAA@XZ @ 0x18013B6BC (--1-$_Parser@PEBGGV-$regex_traits@G@std@@@std@@QEAA@XZ.c)
 *     _AtmosCheck::AtmosCheck_::_1_::dtor$8 @ 0x180162F1A (_AtmosCheck--AtmosCheck_--_1_--dtor$8.c)
 * Callees:
