/*
 * XREFs of AudioVolumeGetMasterVolumeLevelScalar @ 0x18000FD30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetMasterVolumeLevelScalar(_QWORD *a1, __int64 a2)
{
  ...
  v19 = 0;
  v14 = CurrentThreadId;
  v15 = L"AudioVolumeGetMasterVolumeLevelScalar";
  v16 = v2;
  v17 = 0;
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 80LL))(*a1, a2);
