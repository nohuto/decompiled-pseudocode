...
__int64 __fastcall std::_Uninitialized_move<std::unique_ptr<CAppSubmixClientContext> *,std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  std::_Destroy_range<std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(v4, v4);
  return v4;
}
