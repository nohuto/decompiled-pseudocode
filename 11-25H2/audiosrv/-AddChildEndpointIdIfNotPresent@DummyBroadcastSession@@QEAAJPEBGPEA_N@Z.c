/*
 * XREFs of ?AddChildEndpointIdIfNotPresent@DummyBroadcastSession@@QEAAJPEBGPEA_N@Z @ 0x1800F7230
 * Callers:
...
__int64 __fastcall DummyBroadcastSession::AddChildEndpointIdIfNotPresent(
