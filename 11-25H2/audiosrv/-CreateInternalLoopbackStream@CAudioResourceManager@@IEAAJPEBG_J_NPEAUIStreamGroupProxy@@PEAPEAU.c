/*
 * XREFs of ?CreateInternalLoopbackStream@CAudioResourceManager@@IEAAJPEBG_J_NPEAUIStreamGroupProxy@@PEAPEAUIBridgeStreamInstanceProxy@@@Z @ 0x1800B88DC
 * Callers:
...
LABEL_78:
  ...
  if ( v116 )
  {
    v76 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(void *, struct _RTL_CRITICAL_SECTION **))(*(_QWORD *)v116 + 96LL))(
                                             v116,
                                             &v155);
...
LABEL_84:
  ...
  v174[5] = &v143;
  v174[6] = &v135;
  v10 = lambda_baf91932bba23b188ac8d4bf8a9d39cd_::operator()(v174);
...
LABEL_98:
    ...
    if ( (Microsoft_Windows_AudioEnableBits & 0x20) != 0 )
      McGenEventWrite_EtwEventWriteTransfer(v93, (__int64)&AudioResourceManager_SaDevice_Created, v94, 1, (__int64)v204);
