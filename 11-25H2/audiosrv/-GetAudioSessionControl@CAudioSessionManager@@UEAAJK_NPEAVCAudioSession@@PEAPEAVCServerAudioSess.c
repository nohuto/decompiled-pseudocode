/*
 * XREFs of ?GetAudioSessionControl@CAudioSessionManager@@UEAAJK_NPEAVCAudioSession@@PEAPEAVCServerAudioSessionControl@@@Z @ 0x1800533D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CServerAudioSessionControl **a5)
{
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids, a2);
      v9 = WPP_GLOBAL_Control;
    }
    if ( v9 != &WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_S(v9[2], 14LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids);
        v9 = WPP_GLOBAL_Control;
      }
      if ( v9 != &WPP_GLOBAL_Control && (*((_BYTE *)v9 + 28) & 0x40) != 0 && *((_BYTE *)v9 + 25) >= 4u )
        WPP_SF_S(v9[2], 11LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids);
    }
  }
  ...
  {
LABEL_26:
    AudSrvTraceLoggingErrorHelper("CAudioSessionManager::CreateAudioSessionControl", 418, v13);
    goto LABEL_14;
  }
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
...
LABEL_14:
  ...
  if ( v13 )
  {
    ...
    *a5 = 0LL;
    if ( v13 < 0 )
      AudSrvTraceLoggingErrorHelper("CAudioSessionManager::GetAudioSessionControl", 470, v13);
  }
  else
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
