/*
 * XREFs of ??1?$unique_ptr@UCConnectorFormatCharacteristics@@U?$default_delete@UCConnectorFormatCharacteristics@@@std@@@std@@QEAA@XZ @ 0x1800257CC
 * Callers:
 ...
 *     _CConnectorProcessingModeCharacteristics::AddConnectorFormat_::_1_::dtor$0 @ 0x18016174D (_CConnectorProcessingModeCharacteristics--AddConnectorFormat_--_1_--dtor$0.c)
 * Callees:
