/*
 * XREFs of ?wait@?$event_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEBA_NKH@Z @ 0x1800CB2BC
 * Callers:
        ...
        DWORD a2)
{
  ...
  v5 = v2 == 0;
  if ( v2 )
    wil::details::in1diag3::FailFast_Unexpected(retaddr, 2772LL, v3, v4);
  return v5;
}
