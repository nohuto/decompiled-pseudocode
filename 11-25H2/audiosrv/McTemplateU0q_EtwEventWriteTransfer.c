/*
 * XREFs of McTemplateU0q_EtwEventWriteTransfer @ 0x18010BA50
 * Callers:
...
__int64 __fastcall McTemplateU0q_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v6 = 0;
  v5 = 4;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (__int64)&EVT_Po_AudioStandby_Request, a3, 2, (__int64)v4);
}
