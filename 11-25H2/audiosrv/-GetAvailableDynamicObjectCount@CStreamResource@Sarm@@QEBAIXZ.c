/*
 * XREFs of ?GetAvailableDynamicObjectCount@CStreamResource@Sarm@@QEBAIXZ @ 0x18011B768
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::GetAvailableDynamicObjectCount(Sarm::CEndpointResourcePool **this)
{
  ...
  if ( (unsigned int)dword_1801CC2B0 > 5 )
  {
    ...
    v12 = 16;
    v9 = 8;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801CC2B0, byte_1801A3647, 0LL, 0LL, 5u, &v7);
  }
  return v2;
}
