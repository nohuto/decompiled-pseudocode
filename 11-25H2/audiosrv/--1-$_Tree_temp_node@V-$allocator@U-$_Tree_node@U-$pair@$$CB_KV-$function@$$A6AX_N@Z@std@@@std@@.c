/*
 * XREFs of ??1?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CB_KV?$function@$$A6AX_N@Z@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800D3560
 * Callers:
        ...
        __int64 a2)
{
  ...
  v3 = *(_QWORD *)(a1 + 8);
  if ( v3 )
    std::_Func_class<void,IAudioStreamInfo *>::_Tidy(v3 + 40, a2);
