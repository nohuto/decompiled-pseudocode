/*
 * XREFs of ?move_from_blob@SystemAudioStream@@SAJPEAUCP_MEMORY_METADATA_BLOB@@KPEAPEAUICrossProcessMemory@@0@Z @ 0x180108A3C
 * Callers:
...
LABEL_7:
    ...
    v10 = ((__int64 (__fastcall *)(struct ICrossProcessMemory **, __int64 (__fastcall **)(), struct ICrossProcessMemory **, struct CP_MEMORY_METADATA_BLOB *))funcs_180108A83[a2])(
            a3,
            funcs_180108A83,
            a3,
            a4);
