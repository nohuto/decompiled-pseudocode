/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x1800ABC3E
 * Callers:
 *     __imp_load_GetStagedPackageOrigin @ 0x1800ABCBD (__imp_load_GetStagedPackageOrigin.c)
 * Callees:
