/*
 * XREFs of ?GetSpatialAudioPolicyFlags@SpatialAudioDevicePropertyReader@@UEAAJPEAW4SpatialAudioPolicyFlags@@@Z @ 0x180121130
 * Callers:
 *     <none>
 * Callees:
        ...
        enum SpatialAudioPolicyFlags *a2)
{
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1801CC2E8 > 2 )
    {
      v11 = 779;
LABEL_6:
      v12 = "SpatialAudioDevicePropertyReader::GetSpatialAudioPolicyFlags";
      v10 = v5;
