/*
 * XREFs of _lambda_fad069bbea6c73c856a21cdaadf497a4_::operator() @ 0x1800F4804
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_fad069bbea6c73c856a21cdaadf497a4__long_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&_::_Do_call @ 0x1800F5D00 (std--_Func_impl_no_alloc__lambda_fad069bbea6c73c856a21cdaadf497a4__long_wil--com_pt_ea_1800F5D00.c)
 * Callees:
...
LABEL_27:
            ...
            if ( (_QWORD)v16 )
            {
              std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
                (__int64 *)v16,
                *((__int64 **)&v16 + 1));
              std::_Deallocate<16,0>((char *)v16, (const struct std::nothrow_t *)((v17 - v16) & 0xFFFFFFFFFFFFFFF8uLL));
            }
