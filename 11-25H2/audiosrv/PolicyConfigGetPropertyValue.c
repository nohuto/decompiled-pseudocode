/*
 * XREFs of PolicyConfigGetPropertyValue @ 0x18000F870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigGetPropertyValue(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  v17 = L"PolicyConfigGetPropertyValue";
  v18 = v5;
  v19 = 0;
  ...
  v12 = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64, _QWORD, __int64, __int64))(*(_QWORD *)g_PolicyConfig + 88LL))(
          g_PolicyConfig,
          a2,
          a3,
          a4,
