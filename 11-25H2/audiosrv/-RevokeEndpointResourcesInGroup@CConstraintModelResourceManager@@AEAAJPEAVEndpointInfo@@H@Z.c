/*
 * XREFs of ?RevokeEndpointResourcesInGroup@CConstraintModelResourceManager@@AEAAJPEAVEndpointInfo@@H@Z @ 0x1800EA4AC
 * Callers:
        ...
        int a3)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    PrintableId = (unsigned int)EndpointInfo::GetPrintableId(v7);
