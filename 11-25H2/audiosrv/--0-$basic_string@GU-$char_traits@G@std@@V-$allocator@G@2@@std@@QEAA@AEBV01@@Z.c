/*
 * XREFs of ??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@AEBV01@@Z @ 0x180079BB8
 * Callers:
...
__int64 __fastcall std::wstring::wstring(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 24) = 0LL;
  ...
  std::wstring::_Construct<2,unsigned short const *>(a1, v3);
  return a1;
}
