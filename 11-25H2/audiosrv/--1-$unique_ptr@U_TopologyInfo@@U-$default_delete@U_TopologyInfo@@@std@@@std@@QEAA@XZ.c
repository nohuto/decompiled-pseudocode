/*
 * XREFs of ??1?$unique_ptr@U_TopologyInfo@@U?$default_delete@U_TopologyInfo@@@std@@@std@@QEAA@XZ @ 0x1800E65B0
 * Callers:
 ...
 *     _EndpointInfo::AddExtendedTopologyInfo_::_1_::dtor$0 @ 0x1801661EA (_EndpointInfo--AddExtendedTopologyInfo_--_1_--dtor$0.c)
 * Callees:
