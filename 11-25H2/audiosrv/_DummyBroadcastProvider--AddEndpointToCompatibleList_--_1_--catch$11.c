/*
 * XREFs of _DummyBroadcastProvider::AddEndpointToCompatibleList_::_1_::catch$11 @ 0x180166BE7
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DummyBroadcastProvider::AddEndpointToCompatibleList_::_1_::catch_11(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
