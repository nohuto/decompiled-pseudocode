/*
 * XREFs of dllmain_crt_process_attach @ 0x1800A7788
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x1800A7D4C (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800A7E20 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800A7EC0 (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800A8790 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800A87B8 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800A87DC (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x1800A87FC (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x1800A8964 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800A8A26 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800A8A32 (_initterm_e_0.c)
