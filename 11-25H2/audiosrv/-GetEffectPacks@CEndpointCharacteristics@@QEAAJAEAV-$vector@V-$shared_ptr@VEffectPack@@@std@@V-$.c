/*
 * XREFs of ?GetEffectPacks@CEndpointCharacteristics@@QEAAJAEAV?$vector@V?$shared_ptr@VEffectPack@@@std@@V?$allocator@V?$shared_ptr@VEffectPack@@@std@@@2@@std@@@Z @ 0x180042484
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::GetEffectPacks(__int64 a1, _QWORD *a2)
{
  ...
  if ( *a2 != v7 )
  {
    std::_Destroy_range<std::allocator<std::shared_ptr<EffectPack>>>(*a2, v7, v5, v6);
    a2[1] = *a2;
  }
  try
  {
    v8 = *(_QWORD *)(a1 + 360);
    if ( (*(_QWORD *)(a1 + 368) - v8) >> 4 )
