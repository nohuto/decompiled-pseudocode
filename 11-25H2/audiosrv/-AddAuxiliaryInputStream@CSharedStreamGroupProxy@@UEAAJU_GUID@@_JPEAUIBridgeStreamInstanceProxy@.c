/*
 * XREFs of ?AddAuxiliaryInputStream@CSharedStreamGroupProxy@@UEAAJU_GUID@@_JPEAUIBridgeStreamInstanceProxy@@PEBG@Z @ 0x1800EF8A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  v22 = (struct _RTL_CRITICAL_SECTION *)(this + 1744);
  v12 = *(_QWORD *)(this + 1736);
  *(_QWORD *)(this + 1736) = a4;
  if ( a4 )
