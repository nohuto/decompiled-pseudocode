/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800D65E0
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800DDB18 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_UxPerfImp@@@details@wil@@QEAA_NW4.c)
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_UxPerfImp>::GetCurrentFeatureEnabledState(v7, &v15, &v14);
