/*
 * XREFs of ??1EffectPack@@QEAA@XZ @ 0x180076920
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VEffectPack@@@std@@EEAAXXZ @ 0x1800A55C0 (-_Destroy@-$_Ref_count_obj2@VEffectPack@@@std@@EEAAXXZ.c)
 * Callees:
