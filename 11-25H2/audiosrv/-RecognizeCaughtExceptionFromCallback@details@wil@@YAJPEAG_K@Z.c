/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x1800AD218
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$5 @ 0x180165B3A (_wil--details--ResultFromCaughtException_CppWinRt_--_1_--catch$5.c)
 * Callees:
