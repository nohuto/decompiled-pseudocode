/*
 * XREFs of ?ReleaseSaDevices@CBtAudioResourceManagerBase@@IEAAJPEAVCEndpointStore@@AEAV?$forward_list@UDisplacedStreamGroup@@V?$allocator@UDisplacedStreamGroup@@@std@@@std@@@Z @ 0x1800DA5C8
 * Callers:
  ...
  *(_OWORD *)v47 = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( *(_QWORD *)v47 != *(_QWORD *)&v47[2] )
    {
      do
      {
        if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)*v13 + 96LL))(*v13) == 1 )
    ...
    if ( v13 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v13, v12);
