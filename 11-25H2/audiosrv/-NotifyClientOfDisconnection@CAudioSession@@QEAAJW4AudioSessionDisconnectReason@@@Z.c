/*
 * XREFs of ?NotifyClientOfDisconnection@CAudioSession@@QEAAJW4AudioSessionDisconnectReason@@@Z @ 0x180009E8C
 * Callers:
        ...
        enum AudioSessionDisconnectReason a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 41LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
  v4 = *((_QWORD *)this + 82);
  v5 = 2 * *(_DWORD *)(v4 - 16) + 2;
...
LABEL_13:
    AudSrvTraceLoggingErrorHelper("CAudioSession::NotifyClientOfDisconnection", 0x990u, MediaEvent);
  ...
  *((_DWORD *)v7 + 12) = a2;
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 42LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, v8);
  }
