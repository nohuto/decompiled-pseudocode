/*
 * XREFs of ??$MakeAndInitialize@V?$CCrossProcessClientMemory@UControlData_V0@@@@UICrossProcessMemory@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUICrossProcessMemory@@@Z @ 0x18015C9E0
 * Callers:
