/*
 * XREFs of ?_CharacterEscape@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEAA_NXZ @ 0x18013F0D0
 * Callers:
 ...
 *     ?_HexDigits@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEAAXH@Z @ 0x18013FFB4 (-_HexDigits@-$_Parser@PEBGGV-$regex_traits@G@std@@@std@@AEAAXH@Z.c)
 *     ?_IsIdentityEscape@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEBA_NXZ @ 0x1801400D0 (-_IsIdentityEscape@-$_Parser@PEBGGV-$regex_traits@G@std@@@std@@AEBA_NXZ.c)
