/*
 * XREFs of ?NewState@CAudioSession@@MEAAXW4_AudioSessionState@@@Z @ 0x18002AA90
 * Callers:
...
void __fastcall CAudioSession::NewState(CAudioSession *this, __int32 a2)
{
    ...
    if ( v4 == AudioSessionStateActive && !a2 )
    {
      ...
      *((_QWORD *)this + 40) = GetTickCount64();
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 58LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
      }
      *((_BYTE *)this + 904) = 0;
  ...
  else if ( a2 == 1 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 57LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
    }
    *((_BYTE *)this + 904) = 1;
  }
  *((_DWORD *)this + 84) = a2;
  ...
  if ( v4 != a2 )
  {
      ...
      && (*(_QWORD *)(v5 + 24) & 0x200LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      EtwEventWriteTransfer(*(_QWORD *)(v5 + 32), &v14, 0LL, 0LL, 5, &v18);
    }
