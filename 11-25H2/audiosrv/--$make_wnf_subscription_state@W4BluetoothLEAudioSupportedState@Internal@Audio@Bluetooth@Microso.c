/*
 * XREFs of ??$make_wnf_subscription_state@W4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBW4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@@Z@wistd@@KPEAPEAU?$wnf_subscription_state@W4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@@01@@Z @ 0x1800DEBA4
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v12 != -1 )
    goto LABEL_9;
  v9 = NtQueryWnfStateData(&WNF_BLTH_BLUETOOTH_LE_AUDIO_SUPPORTED_STATE, 0LL, 0LL, &v12) | 0x10000000;
