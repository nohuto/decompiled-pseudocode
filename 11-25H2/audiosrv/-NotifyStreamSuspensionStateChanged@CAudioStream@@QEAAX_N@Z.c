/*
 * XREFs of ?NotifyStreamSuspensionStateChanged@CAudioStream@@QEAAX_N@Z @ 0x18004CA60
 * Callers:
...
void __fastcall CAudioStream::NotifyStreamSuspensionStateChanged(CAudioStream *this, char a2)
{
  ...
  const WCHAR *v12; // [rsp+70h] [rbp+18h] BYREF
  __int64 v13; // [rsp+78h] [rbp+20h] BYREF

  if ( *((_BYTE *)this + 136) != a2 )
  {
      ...
      && (*(_QWORD *)(v4 + 24) & 0x200LL) == *(_QWORD *)(v4 + 24) )
    {
      ...
      v7 = *((_QWORD *)this + 8);
      v10 = v6;
      v12 = (const WCHAR *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v7 + 8) + 64LL))(v7 + 8);
