/*
 * XREFs of _lambda_401f33ed1035a8d15a958bb8e80586a7_::operator() @ 0x18012906C
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_401f33ed1035a8d15a958bb8e80586a7__long_SystemEffectDescriptor___SystemEffectChainDescriptor___::_Do_call @ 0x180130800 (std--_Func_impl_no_alloc__lambda_401f33ed1035a8d15a958bb8e80586a7__long_SystemEffec_ea_180130800.c)
 * Callees:
...
__int64 __fastcall lambda_401f33ed1035a8d15a958bb8e80586a7_::operator()(
        __int64 *a1,
        int *a2,
...
LABEL_6:
                       ...
                       &GUID_9e90ea20_b493_4fd1_a1a8_7e1361a956cf) == -1 )
  {
    if ( !v12 )
      goto LABEL_34;
    updated = lambda_0bf9917c90d271a840409fa4d6d2c2a6_::operator()((int *)a1 + 30);
    if ( updated < 0 )
    {
LABEL_16:
