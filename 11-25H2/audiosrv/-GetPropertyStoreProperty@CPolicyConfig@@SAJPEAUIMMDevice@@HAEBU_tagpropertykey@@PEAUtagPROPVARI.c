/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18005E790
 * Callers:
...
LABEL_17:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 2023, v6);
    goto LABEL_9;
  }
  *(_OWORD *)&a4->vt = 0LL;
