/*
 * XREFs of ?_Getcat@?$collate@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18013FE48
 * Callers:
 ...
 *     ??0?$collate@G@std@@QEAA@AEBV_Locinfo@1@_K@Z @ 0x18013B56C (--0-$collate@G@std@@QEAA@AEBV_Locinfo@1@_K@Z.c)
 *     ??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ @ 0x18013B71C (--1-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@std@@QEAA@XZ.c)
