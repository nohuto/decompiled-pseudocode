/*
 * XREFs of ??$_AllocString@VCTCoAllocPolicy@@@@YAJPEAXKPEBGPEAPEAG@Z @ 0x180020B2C
 * Callers:
 ...
 *     ?DevQueryResultCallback@@YAXPEAUHDEVQUERY__@@PEAXPEBU_DEV_QUERY_RESULT_ACTION_DATA@@@Z @ 0x1800E5210 (-DevQueryResultCallback@@YAXPEAUHDEVQUERY__@@PEAXPEBU_DEV_QUERY_RESULT_ACTION_DATA@@@Z.c)
...
__int64 __fastcall _AllocString<CTCoAllocPolicy>(__int64 a1, __int64 a2, const WCHAR *a3, _QWORD *a4)
{
  ...
  v7 = v4 + 1;
  *a4 = 0LL;
  if ( v4 + 1 >= v4 && (*a4 = 0LL, is_mul_ok(v7, 2uLL)) )
  {
    ...
    *a4 = v10;
    ...
    if ( v10 )
    {
      ...
      {
        v12 = &LocaleName;
        v13 = v4 & ((unsigned __int128)-(__int128)(unsigned __int64)a3 >> 64);
        v8 = 0;
        if ( a3 )
          v12 = a3;
        if ( v7 )
