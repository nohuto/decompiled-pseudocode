/*
 * XREFs of _std::vector_std::shared_ptr_EffectPack__std::allocator_std::shared_ptr_EffectPack_____::_Emplace_reallocate_std::shared_ptr_EffectPack__&__::_1_::catch$0 @ 0x180166D51
 * Callers:
 *     <none>
 * Callees:
