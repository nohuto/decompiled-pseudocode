/*
 * XREFs of ??$construct@V?$function@$$A6AX_N@Z@std@@V12@@?$_Default_allocator_traits@V?$allocator@V?$function@$$A6AX_N@Z@std@@@std@@@std@@SAXAEAV?$allocator@V?$function@$$A6AX_N@Z@std@@@1@QEAV?$function@$$A6AX_N@Z@1@$$QEAV31@@Z @ 0x1800D32EC
 * Callers:
...
{
  *(_QWORD *)(a2 + 56) = 0LL;
  return std::_Func_class<void,bool>::_Reset_move(a2, a3);
}
