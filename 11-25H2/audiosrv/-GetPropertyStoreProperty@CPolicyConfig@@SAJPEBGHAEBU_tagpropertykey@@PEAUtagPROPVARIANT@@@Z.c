/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x180100CE8
 * Callers:
        ...
        struct tagPROPVARIANT *a4)
{
  ...
  {
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 1980, PropertyStoreProperty);
  }
