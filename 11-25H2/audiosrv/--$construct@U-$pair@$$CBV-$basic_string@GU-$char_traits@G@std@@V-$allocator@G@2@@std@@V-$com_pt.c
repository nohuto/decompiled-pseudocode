...
__int64 __fastcall std::_Default_allocator_traits<std::allocator<std::_List_node<std::pair<std::wstring const,wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>>,void *>>>::construct<std::pair<std::wstring const,wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy>>,unsigned short const * &,wil::com_ptr_t<CEndpointCharacteristics,wil::err_returncode_policy> &>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        _QWORD *a4)
