/*
 * XREFs of ?RemoveClientReference@CAudioSession@@UEAAJ_N@Z @ 0x18001C240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::RemoveClientReference(CAudioSession *this, char a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)this + 82, 0xFFFFFFFF) == 1 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 60LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
    }
LABEL_7:
    if ( this )
