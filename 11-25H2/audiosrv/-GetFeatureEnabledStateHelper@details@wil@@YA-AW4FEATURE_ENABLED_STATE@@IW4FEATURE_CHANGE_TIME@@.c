/*
 * XREFs of ?GetFeatureEnabledStateHelper@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x1800BDE30
 * Callers:
 *     <none>
 * Callees:
 *     wil_HasFeatureTestState @ 0x1800C18AC (wil_HasFeatureTestState.c)
 */
