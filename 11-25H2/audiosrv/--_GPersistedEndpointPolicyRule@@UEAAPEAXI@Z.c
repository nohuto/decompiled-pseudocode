/*
 * XREFs of ??_GPersistedEndpointPolicyRule@@UEAAPEAXI@Z @ 0x18011D118
 * Callers:
 *     ??_EPersistedEndpointPolicyRule@@W7EAAPEAXI@Z @ 0x18011D070 (--_EPersistedEndpointPolicyRule@@W7EAAPEAXI@Z.c)
 * Callees:
