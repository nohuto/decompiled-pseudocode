/*
 * XREFs of ?CreatePowerReferenceSubBlocker@CSleepStudyPowerReferenceManager@@QEAAJPEAVCVADServer@@PEAV?$shared_ptr@VCSleepStudyPowerReference@@@std@@@Z @ 0x180015D2C
 * Callers:
 ...
 *     ??$make_shared@VCSleepStudyPowerReference@@$$V@std@@YA?AV?$shared_ptr@VCSleepStudyPowerReference@@@0@XZ @ 0x180015AE0 (--$make_shared@VCSleepStudyPowerReference@@$$V@std@@YA-AV-$shared_ptr@VCSleepStudyPowerReference.c)
