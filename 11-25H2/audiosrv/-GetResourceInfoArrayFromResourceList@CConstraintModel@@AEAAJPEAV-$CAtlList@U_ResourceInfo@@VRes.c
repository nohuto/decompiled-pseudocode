/*
 * XREFs of ?GetResourceInfoArrayFromResourceList@CConstraintModel@@AEAAJPEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@W4RmResourceType@@KPEAKPEAPEAU_ResourceInfo@@@Z @ 0x1800A5478
 * Callers:
 ...
 *     ?FindIndex@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEBAPEAU__POSITION@@_K@Z @ 0x180157E74 (-FindIndex@-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEBAPEAU__POSITION@@_K@Z.c)
 */
  ...
  if ( a2 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v9 )
      {
        ...
        {
          Index = ATL::CAtlList<_ResourceInfo,ResourceInfoTraits>::FindIndex(a2, v10, v9);
          if ( !Index )
