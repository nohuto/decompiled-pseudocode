/*
 * XREFs of ?DumpTraceWin32@@YAXPEBD00H@Z @ 0x180146238
 * Callers:
 *     ?IsValidMicArrayGeometry@@YAHPEBUKSAUDIO_MIC_ARRAY_GEOMETRY@@PEBGPEBH_NPEAI4PEAPEAUMicArrayElementErrorDetails@@@Z @ 0x18006B484 (-IsValidMicArrayGeometry@@YAHPEBUKSAUDIO_MIC_ARRAY_GEOMETRY@@PEBGPEBH_NPEAI4PEAPEAUMicArrayEleme.c)
 * Callees:
...
void __fastcall DumpTraceWin32(const char *a1, const char *a2, const char *a3, int a4)
{
  ...
  Buffer[511] = 0;
  NUIAudioTracing::NuiAudioTrace<char (&)[512]>(Buffer);
}
