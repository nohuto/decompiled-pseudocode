/*
 * XREFs of ?push_back@?$vector@UDummyBroadcastSession@@V?$allocator@UDummyBroadcastSession@@@std@@@std@@QEAAX$$QEAUDummyBroadcastSession@@@Z @ 0x1800E3BF0
 * Callers:
...
char *__fastcall std::vector<DummyBroadcastSession>::push_back(__int64 *a1, __int64 a2)
{
  __int64 v2; // r10
  __int64 v5; // rcx
  char *result; // rax
  ...
  v2 = a1[1];
  if ( v2 == a1[2] )
    return std::vector<DummyBroadcastSession>::_Emplace_reallocate<DummyBroadcastSession>(a1, a1[1], a2);
  *(_OWORD *)v2 = *(_OWORD *)a2;
