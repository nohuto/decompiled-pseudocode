/*
 * XREFs of _std::vector_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo____std::allocator_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo_______::_Emplace_reallocate_std::unique_ptr__ConnectorInfo_std::default_delete__ConnectorInfo______::_1_::catch$0 @ 0x18016607B
 * Callers:
 *     <none>
 * Callees:
