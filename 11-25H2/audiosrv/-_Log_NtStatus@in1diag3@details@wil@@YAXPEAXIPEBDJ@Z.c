/*
 * XREFs of ?_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1801043E0
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_NtStatus<2>((__int64)this, (unsigned int)a2, a3, (__int64)a4, v4, retaddr, v5);
}
