/*
 * XREFs of ?Term@CAtlComModule@ATL@@QEAAXXZ @ 0x18008889C
 * Callers:
 *     ??1?$CAtlExeModuleT@VCAudioServiceModule@@@ATL@@UEAA@XZ @ 0x1800CC088 (--1-$CAtlExeModuleT@VCAudioServiceModule@@@ATL@@UEAA@XZ.c)
 *     ATL::_dynamic_atexit_destructor_for___AtlComModule__ @ 0x1801698E0 (ATL--_dynamic_atexit_destructor_for___AtlComModule__.c)
 * Callees:
