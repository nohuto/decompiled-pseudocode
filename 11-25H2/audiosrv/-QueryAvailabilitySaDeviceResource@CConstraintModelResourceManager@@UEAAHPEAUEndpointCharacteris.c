/*
 * XREFs of ?QueryAvailabilitySaDeviceResource@CConstraintModelResourceManager@@UEAAHPEAUEndpointCharacteristicsDescriptor@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@K@Z @ 0x1800E9B10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( v36 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v29 = (unsigned __int8 *)&unk_1801A108C;
    }
    else
    {
      ...
      if ( **((_DWORD **)v25 + 1) <= 4u || !tlgKeywordOn(*((_QWORD *)v25 + 1), 512LL) )
        goto LABEL_27;
      v28 = *a2;
      v29 = (unsigned __int8 *)&unk_1801A117A;
      LODWORD(v37) = v6;
      v36 = a5;
