/*
 * XREFs of ??1?$_Matcher@PEBGGV?$regex_traits@G@std@@PEBG@std@@QEAA@XZ @ 0x18012853C
 * Callers:
 ...
 *     _std::_Regex_search2_unsigned_short_const___std::allocator_std::sub_match_unsigned_short_const______unsigned_short_std::regex_traits_unsigned_short__unsigned_short_const____::_1_::dtor$0 @ 0x1801680CE (_std--_Regex_search2_unsigned_short_const___std--allocator_std--sub_match_unsigned_short_const__.c)
 * Callees:
