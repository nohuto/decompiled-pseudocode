/*
 * XREFs of ?DestroyStream@CStreamInstanceProxyImpl@@IEAAJXZ @ 0x18000C038
 * Callers:
 *     ?DestroyStream@CStreamInstanceProxy@@UEAAJXZ @ 0x180081720 (-DestroyStream@CStreamInstanceProxy@@UEAAJXZ.c)
...
__int64 __fastcall CStreamInstanceProxyImpl::DestroyStream(CStreamInstanceProxyImpl *this)
{
  ...
  unsigned __int16 *v13; // [rsp+150h] [rbp+50h] BYREF
  ...
  *((_QWORD *)this + 2) = 0LL;
    ...
    && (*(_QWORD *)(v5 + 24) & 0x200LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v17 = 43;
    v18 = 1;
    EtwEventWriteTransfer(*(_QWORD *)(v5 + 32), v10, 0LL, 0LL, 4, &v13);
  }
