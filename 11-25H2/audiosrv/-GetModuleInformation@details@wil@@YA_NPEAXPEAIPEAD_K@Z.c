/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x1800ACBA8
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x18007D900 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x18004E7B0 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
...
char __fastcall wil::details::GetModuleInformation(LPCWSTR lpModuleName, _DWORD *a2, char *a3, char *a4)
{
  ...
  if ( a3 )
  {
    ...
    for ( i = &Filename[v10]; i > Filename && *(i - 1) != 92; --i )
      ;
    StringCchCopyA(a3, (__int64)a4, i);
  }
  return 1;
}
