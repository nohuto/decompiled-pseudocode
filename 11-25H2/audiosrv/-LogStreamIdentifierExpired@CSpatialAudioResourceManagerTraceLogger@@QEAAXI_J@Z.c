/*
 * XREFs of ?LogStreamIdentifierExpired@CSpatialAudioResourceManagerTraceLogger@@QEAAXI_J@Z @ 0x18011C77C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (unsigned int)dword_1801CC2B0 > 4 )
  {
    ...
    v3 = a2;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801CC2B0, byte_1801A38C4, 0LL, 0LL, 4u, &v5);
  }
}
