/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCVADServer@@V?$CElementTraits@PEAVCVADServer@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCVADServer@@@Z @ 0x18005D15C
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::AddHead(__int64 a1, __int64 *a2)
{
  ...
  v2 = (__int64 *)qword_1801CE720;
  v4 = g_VADServerList;
  if ( !qword_1801CE720 )
  {
    v7 = ATL::CAtlPlex::Create(&qword_1801CE718, (unsigned int)dword_1801CE728, 0x18uLL);
    if ( !v7 )
      ATL::AtlThrowImpl(-2147024882);
    v8 = (unsigned int)(dword_1801CE728 - 1);
    v9 = (__int64 *)((char *)v7 + 16 * v8 + 8 * v8 + 8);
    v2 = (__int64 *)qword_1801CE720;
    if ( (int)dword_1801CE728 - 1 >= 0 )
    {
      do
      {
        *v9 = (__int64)v2;
        v2 = v9;
        qword_1801CE720 = (__int64)v9;
        v9 -= 3;
        LODWORD(v8) = v8 - 1;
      }
      while ( (int)v8 >= 0 );
