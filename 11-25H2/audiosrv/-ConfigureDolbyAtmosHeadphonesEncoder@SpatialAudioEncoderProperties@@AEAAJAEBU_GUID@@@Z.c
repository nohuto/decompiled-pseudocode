/*
 * XREFs of ?ConfigureDolbyAtmosHeadphonesEncoder@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180121D20
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  *(_OWORD *)((char *)this + 726) = xmmword_1801917C0;
  *(_OWORD *)((char *)this + 742) = xmmword_1801917D0;
  *(_OWORD *)((char *)this + 758) = xmmword_1801917E0;
  *(_OWORD *)((char *)this + 774) = xmmword_1801917F0;
  *(_OWORD *)((char *)this + 790) = xmmword_180191800;
  *(_OWORD *)((char *)this + 806) = xmmword_180191810;
  *(_OWORD *)((char *)this + 822) = xmmword_180191820;
  ...
  *((_WORD *)this + 362) = GetOverrideMaxDynamicObjectCount(a2, MaxDynamicObjectCountPC);
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    ...
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(
                &DOLBY_ATMOS_HEADPHONES_SPATIAL_ENCODER,
                &v17,
                &v16) >= 0 )
    {
      *((_DWORD *)this + 179) = v17;
  ...
  *((_WORD *)this + 493) = v14;
  *(_OWORD *)((char *)this + 872) = xmmword_180191640;
  *(_OWORD *)((char *)this + 888) = xmmword_180191650;
  *(_OWORD *)((char *)this + 904) = xmmword_180191660;
  *(_OWORD *)((char *)this + 920) = xmmword_180191670;
  *(_OWORD *)((char *)this + 936) = xmmword_180191680;
  *(_OWORD *)((char *)this + 952) = xmmword_180191690;
  *(_OWORD *)((char *)this + 968) = xmmword_1801916A0;
  *((_DWORD *)this + 246) = 1;
  return 0LL;
}
