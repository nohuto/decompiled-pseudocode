/*
 * XREFs of ?ConfigureDtsxHeadphones@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180122460
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  *(_OWORD *)((char *)this + 726) = xmmword_180191740;
  *(_OWORD *)((char *)this + 742) = xmmword_180191750;
  *(_OWORD *)((char *)this + 758) = xmmword_180191760;
  *(_OWORD *)((char *)this + 774) = xmmword_180191770;
  *(_OWORD *)((char *)this + 790) = xmmword_180191780;
  *(_OWORD *)((char *)this + 806) = xmmword_180191790;
  *(_OWORD *)((char *)this + 822) = xmmword_1801917A0;
  ...
  *((_WORD *)this + 362) = GetOverrideMaxDynamicObjectCount(a2, MaxDynamicObjectCountPC);
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v17 = 0;
    v16 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_HEADPHONES_SPATIAL_ENCODER, &v17, &v16) >= 0 )
    {
      *((_DWORD *)this + 179) = v17;
      *((_WORD *)this + 362) = v16;
    }
