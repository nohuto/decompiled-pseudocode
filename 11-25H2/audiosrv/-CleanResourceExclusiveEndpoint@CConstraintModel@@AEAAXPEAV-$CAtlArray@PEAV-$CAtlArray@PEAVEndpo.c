/*
 * XREFs of ?CleanResourceExclusiveEndpoint@CConstraintModel@@AEAAXPEAV?$CAtlArray@PEAV?$CAtlArray@PEAVEndpointInfo@@V?$CElementTraits@PEAVEndpointInfo@@@ATL@@@ATL@@V?$CElementTraits@PEAV?$CAtlArray@PEAVEndpointInfo@@V?$CElementTraits@PEAVEndpointInfo@@@ATL@@@ATL@@@2@@ATL@@@Z @ 0x180157AE0
 * Callers:
    ...
    do
    {
      ...
      if ( *(_QWORD *)(v5 + 8) )
      {
        ...
        do
        {
          ...
          if ( v8 )
          {
            EndpointInfo::~EndpointInfo(*(EndpointInfo **)(*(_QWORD *)v5 + 8 * v7));
