/*
 * XREFs of CEndpointCharacteristics::GetDeviceFormatInternal__lambda_53e50f4d36d820af02fa3fa8c2905d02___ @ 0x180036840
 * Callers:
    ...
    if ( v13 >= 0 )
    {
      if ( LOWORD(pvar[0]) )
      {
        if ( LOWORD(pvar[0]) == 65 )
        {
          ...
          {
            wil::details::in1diag3::Log_Win32(retaddr, (void *)0x199B, v14, v15, v33);
          }
        }
        else
        {
