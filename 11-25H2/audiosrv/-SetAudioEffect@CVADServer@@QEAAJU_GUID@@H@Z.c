/*
 * XREFs of ?SetAudioEffect@CVADServer@@QEAAJU_GUID@@H@Z @ 0x180107670
 * Callers:
...
__int64 __fastcall CVADServer::SetAudioEffect(CVADServer *this, struct _GUID *a2, int a3)
{
  ...
  const WCHAR *v17; // [rsp+50h] [rbp-19h] BYREF
...
LABEL_5:
  ...
  if ( *v10 > 4u && tlgKeywordOn(*((_QWORD *)v9 + 1), 512LL) )
  {
    v15 = a3;
    v16 = a2;
    v17 = (const WCHAR *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)this + 18) + 8LL) + 64LL))(*((_QWORD *)this + 18) + 8LL);
