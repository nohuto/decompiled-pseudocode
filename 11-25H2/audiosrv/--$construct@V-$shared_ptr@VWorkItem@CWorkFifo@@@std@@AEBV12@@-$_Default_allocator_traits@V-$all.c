/*
 * XREFs of ??$construct@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@AEBV12@@?$_Default_allocator_traits@V?$allocator@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@@std@@@std@@SAXAEAV?$allocator@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@@1@QEAV?$shared_ptr@VWorkItem@CWorkFifo@@@1@AEBV31@@Z @ 0x180117C1C
 * Callers:
