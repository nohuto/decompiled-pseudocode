/*
 * XREFs of ??1CPdcTimerActivation@@QEAA@XZ @ 0x18001581C
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCPdcTimerActivation@@@std@@EEAAXXZ @ 0x180085CB0 (-_Destroy@-$_Ref_count_obj2@VCPdcTimerActivation@@@std@@EEAAXXZ.c)
 * Callees:
