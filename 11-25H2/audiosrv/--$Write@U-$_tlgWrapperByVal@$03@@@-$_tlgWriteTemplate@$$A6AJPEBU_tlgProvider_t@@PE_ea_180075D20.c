/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x180075D20
 * Callers:
        ...
        __int64 a5)
{
  ...
  unsigned __int16 *v10; // [rsp+48h] [rbp-38h] BYREF
  ...
  v12 = 2;
  v15 = 1;
  return EtwEventWriteTransfer(*(_QWORD *)(a1 + 32), v8, 0LL, 0LL, 3, &v10);
}
