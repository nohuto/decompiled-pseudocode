/*
 * XREFs of ?GetEncoderStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x180120AD0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  else
  {
    ...
    {
      v18 = -2147024809;
      v17 = "SpatialAudioDevicePropertyReader::GetEncoderStaticObjectPosition";
      v19 = 622;
