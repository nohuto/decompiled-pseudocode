/*
 * XREFs of ??1?$unique_ptr@UMODE_PARAMS@@U?$default_delete@UMODE_PARAMS@@@std@@@std@@QEAA@XZ @ 0x18002738C
 * Callers:
 ...
 *     _CAudioResourceManager::CreateInternalLoopbackStream_::_1_::dtor$9 @ 0x1801641C0 (_CAudioResourceManager--CreateInternalLoopbackStream_--_1_--dtor$9.c)
 *     _CAudioResourceManager::CreateStream_::_1_::dtor$10 @ 0x18016434C (_CAudioResourceManager--CreateStream_--_1_--dtor$10.c)
 *     _InitializeStreamAndModeDescriptors_::_1_::dtor$2 @ 0x180164581 (_InitializeStreamAndModeDescriptors_--_1_--dtor$2.c)
 * Callees:
