/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x1800AC774
 * Callers:
 ...
 *     ?create@?$semaphore_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEAAJJJPEBGKPEAU_SECURITY_ATTRIBUTES@@PEA_N@Z @ 0x1800ADEF8 (-create@-$semaphore_t@V-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@_E$1-CloseHandle@details.c)
 */
        ...
        unsigned __int64 a4)
{
  ...
  StringCchCatW(v13, 260LL, (char *)L"_p0");
  v6 = a4 >> 31;
  v7 = 1;
  v8 = a4 & 0x7FFFFFFF;
  v9 = 1LL;
...
LABEL_7:
  ...
  StringCchCatW(v13, 260LL, (char *)L"h");
  if ( (_DWORD)v6 )
    v7 = v6;
