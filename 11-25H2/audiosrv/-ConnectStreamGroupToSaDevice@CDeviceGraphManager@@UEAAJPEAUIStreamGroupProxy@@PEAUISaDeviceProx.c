/*
 * XREFs of ?ConnectStreamGroupToSaDevice@CDeviceGraphManager@@UEAAJPEAUIStreamGroupProxy@@PEAUISaDeviceProxy@@W4SUBMIX_CONNECT_OPTIONS@@PEAUSystemAudioStream@@@Z @ 0x180063E40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a5)
{
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64))(*(_QWORD *)a2 + 208LL))(a2, a3, a4, a5);
  v8 = v7;
  if ( v7 >= 0 )
  {
