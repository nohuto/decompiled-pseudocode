/*
 * XREFs of ?GetBTAudio_StreamContextFromStreamCounts@CBtAudioResourceManagerBase@@IEAA?AW4BTAudio_StreamContext@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x1800D5980
 * Callers:
...
__int64 __fastcall CBtAudioResourceManagerBase::GetBTAudio_StreamContextFromStreamCounts(__int64 a1, int a2)
{
  ...
  v2 = (struct _RTL_CRITICAL_SECTION *)(a1 + 240);
  v3 = a2;
  v5 = 0;
  EnterCriticalSection((LPCRITICAL_SECTION)(a1 + 240));
  v11 = v2;
  v6 = 24LL;
  v7 = (int *)(a1 + ((_DWORD)v3 != 0 ? 376LL : 280LL));
  v8 = 0LL;
  do
  {
    if ( *v7 > 0 )
      v5 |= dword_18018C8C0[v8 + v3];
    ++v7;
    v8 += 2LL;
    --v6;
  }
