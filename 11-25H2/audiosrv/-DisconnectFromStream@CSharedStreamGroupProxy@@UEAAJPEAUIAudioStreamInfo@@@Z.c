/*
 * XREFs of ?DisconnectFromStream@CSharedStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@@Z @ 0x180063AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::DisconnectFromStream(unsigned __int64 this, struct IAudioStreamInfo *a2)
{
...
LABEL_7:
  ...
  v10 = *(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))(this + 80);
  v11 = *v10;
  v21 = 0LL;
  v12 = (*v11)(v10, &GUID_c3876f08_e8f4_47e9_b42f_3bc3418c0675, &v21);
  v7 = v12;
  if ( v12 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
  ...
  CSharedStreamGroupProxy::OnDisconnectedFromStream((CSharedStreamGroupProxy *)(this - 8), a2);
