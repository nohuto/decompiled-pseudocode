/*
 * XREFs of ??4?$function@$$A6AX_N@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x1800D371C
 * Callers:
...
__int64 __fastcall std::function<void (bool)>::operator=(__int64 a1, __int64 a2)
{
  ...
  if ( v5 == v4 || (v6 = *(_QWORD *)(a1 + 56), v6 == a1) )
  {
    ...
    std::_Func_class<void,IAudioStreamInfo *>::_Tidy((__int64)v9, v7);
  }
  else
  {
    *(_QWORD *)(v4 + 56) = v6;
  ...
  std::_Func_class<void,IAudioStreamInfo *>::_Tidy((__int64)v11, v3);
  return a1;
}
