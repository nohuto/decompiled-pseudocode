/*
 * XREFs of ??$make_wnf_array_subscription_state@G@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXPEBG_K@Z@wistd@@KPEAPEAU?$wnf_array_subscription_state@G@01@@Z @ 0x180088680
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
                                                       ...
                                                       a2)) != 0LL )
  {
    ...
    if ( v13 == -1 )
    {
      v9 = NtQueryWnfStateData(&WNF_AUDC_RENDER, 0LL, 0LL, &v13) | 0x10000000;
