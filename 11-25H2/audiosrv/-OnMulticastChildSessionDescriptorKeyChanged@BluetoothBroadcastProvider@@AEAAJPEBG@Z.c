/*
 * XREFs of ?OnMulticastChildSessionDescriptorKeyChanged@BluetoothBroadcastProvider@@AEAAJPEBG@Z @ 0x1800E1D08
 * Callers:
        ...
        unsigned __int16 *a2)
{
  ...
  bool v18; // [rsp+20h] [rbp-48h] BYREF
  int v19; // [rsp+24h] [rbp-44h] BYREF
  struct IPropertyStore *v20; // [rsp+28h] [rbp-40h] BYREF
  struct _RTL_CRITICAL_SECTION *v21; // [rsp+30h] [rbp-38h] BYREF
  PROPVARIANT pvar[2]; // [rsp+38h] [rbp-30h] BYREF
  ...
  try
  {
    ...
    *(_OWORD *)pvar = 0LL;
    ...
    {
      v11 = v23;
      if ( *(_QWORD *)(v23 + 4) != (_QWORD)BLUETOOTH_AUDIO_BROADCAST_PROVIDER
        || *(_QWORD *)(v23 + 12) != _mm_srli_si128((__m128i)BLUETOOTH_AUDIO_BROADCAST_PROVIDER, 8).m128i_u64[0] )
      {
LABEL_21:
        PropVariantClear(pvar);
        wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>((__int64 *)&v20);
      ...
      BroadcastSession = (BluetoothBroadcastSession *)BluetoothBroadcastProvider::RetrieveBroadcastSession(
                                                        this,
                                                        v11 + 20);
      v14 = BluetoothBroadcastSession::AddChildEndpointIdIfNotPresent(BroadcastSession, (char *)a2, &v18, v13);
      v15 = v14;
      if ( v14 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
