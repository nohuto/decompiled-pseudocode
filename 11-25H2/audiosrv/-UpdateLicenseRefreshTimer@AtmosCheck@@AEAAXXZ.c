/*
 * XREFs of ?UpdateLicenseRefreshTimer@AtmosCheck@@AEAAXXZ @ 0x180081980
 * Callers:
 ...
 *     ?GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ @ 0x180147FAC (-GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ.c)
 */
