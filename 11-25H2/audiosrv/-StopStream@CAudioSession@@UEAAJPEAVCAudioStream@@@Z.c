/*
 * XREFs of ?StopStream@CAudioSession@@UEAAJPEAVCAudioStream@@@Z @ 0x180089300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::StopStream(CAudioSession *this, struct CAudioStream *a2)
{
  ...
  if ( i != *((__int64 **)this + 15) )
  {
    ...
    if ( v7 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 46LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, 0LL);
      }
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 47LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
  ...
  if ( j != v9 )
  {
    ...
    if ( v7 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 48LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, 0LL);
      }
      (*(void (__fastcall **)(CAudioSession *, _QWORD))(*(_QWORD *)this + 56LL))(this, 0LL);
    }
