/*
 * XREFs of ?ToString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18001C004
 * Callers:
...
__int64 __fastcall CAudioEndpointId::ToString(char **a1, __int64 *a2)
{
  unsigned int v3; // esi
  char *v4; // r14
