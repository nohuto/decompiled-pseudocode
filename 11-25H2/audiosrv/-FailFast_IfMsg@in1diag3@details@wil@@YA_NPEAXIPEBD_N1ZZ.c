/*
 * XREFs of ?FailFast_IfMsg@in1diag3@details@wil@@YA_NPEAXIPEBD_N1ZZ @ 0x18011B72C
 * Callers:
 *     ?DetachFromPool@CEndpointResourcePool@Sarm@@QEAAXXZ @ 0x18011B6E4 (-DetachFromPool@CEndpointResourcePool@Sarm@@QEAAXXZ.c)
 * Callees:
