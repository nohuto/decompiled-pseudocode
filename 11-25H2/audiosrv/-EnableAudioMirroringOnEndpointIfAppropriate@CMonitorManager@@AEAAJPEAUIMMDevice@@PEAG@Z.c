/*
 * XREFs of ?EnableAudioMirroringOnEndpointIfAppropriate@CMonitorManager@@AEAAJPEAUIMMDevice@@PEAG@Z @ 0x18002F168
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( a3 )
  {
    ...
    if ( v8 < 0 )
      goto LABEL_8;
    if ( (unsigned int)_o__wcsicmp(a3) )
    {
      ...
      if ( LOWORD(v11[0]) != 31 || !v11[1] || (unsigned int)_o__wcsicmp(a3) )
      {
        if ( (unsigned int)_o__wcsicmp(a3) )
        {
          if ( (unsigned int)_o__wcsicmp(a3) )
