/*
 * XREFs of ?Invoke@CAudioSessionManagerNotification@@UEAAJVCAudioSessionNotificationProcess@@@Z @ 0x18006ABD0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !v5 || v5 == (*(unsigned int (__fastcall **)(_QWORD))(*(_QWORD *)*a2 + 48LL))(*a2) )
  {
    ...
    if ( MediaEvent )
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 26LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids, v9);
      }
      if ( MediaEvent < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioSessionManagerNotification::Invoke", 784, MediaEvent);
           ...
           && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*a2 + 40LL))(*a2);
      WPP_SF_d(
