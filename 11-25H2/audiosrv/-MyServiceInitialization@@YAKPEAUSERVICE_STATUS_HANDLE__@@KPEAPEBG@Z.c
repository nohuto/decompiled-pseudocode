/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x1801455EC
 * Callers:
 ...
 *     McGenEventRegister_EtwEventRegister @ 0x180145AC4 (McGenEventRegister_EtwEventRegister.c)
