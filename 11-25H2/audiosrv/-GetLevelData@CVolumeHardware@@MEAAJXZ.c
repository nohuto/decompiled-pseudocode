/*
 * XREFs of ?GetLevelData@CVolumeHardware@@MEAAJXZ @ 0x18010C4C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qdggg @ 0x18010DEF8 (WPP_SF_qdggg.c)
 *     WPP_SF_qgg @ 0x18010E040 (WPP_SF_qgg.c)
...
LABEL_6:
    v2 = -2147418113;
LABEL_36:
    AudSrvTraceLoggingErrorHelper("CVolumeHardware::GetLevelData", 1306, v2);
