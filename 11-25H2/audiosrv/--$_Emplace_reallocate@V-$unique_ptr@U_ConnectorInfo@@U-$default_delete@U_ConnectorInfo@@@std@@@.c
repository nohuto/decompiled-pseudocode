  ...
  try
  {
    ...
    *(_QWORD *)v14 = v15;
    ...
    std::_Uninitialized_move<std::unique_ptr<_ConnectorInfo> *,std::allocator<std::unique_ptr<_ConnectorInfo>>>(
      ...
      v16,
      v17);
    std::vector<std::unique_ptr<_ConnectorInfo>>::_Change_array(a1, v13, v8, v7, v21);
    result = v14;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<_ConnectorInfo>>>(v23, (__int64)(v14 + 8));
