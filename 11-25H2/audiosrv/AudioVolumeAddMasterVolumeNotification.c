/*
 * XREFs of AudioVolumeAddMasterVolumeNotification @ 0x1800121A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeAddMasterVolumeNotification(__int64 *a1)
{
  ...
  v15 = L"AudioVolumeAddMasterVolumeNotification";
  v16 = v1;
  v17 = 0;
...
LABEL_8:
  ...
  v9 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v6 + 248LL))(v6, Pid);
  v8 = v9;
  if ( v9 < 0 )
  {
    v10 = (unsigned int)v9;
