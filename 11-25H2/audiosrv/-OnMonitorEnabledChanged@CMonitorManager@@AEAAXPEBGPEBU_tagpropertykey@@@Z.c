/*
 * XREFs of ?OnMonitorEnabledChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x180082C20
 * Callers:
        ...
        const struct _tagpropertykey *a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 39LL, &WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids);
  }
...
LABEL_28:
      if ( v7 != &WPP_GLOBAL_Control && (*((_DWORD *)v7 + 7) & 0x800000) != 0 && *((_BYTE *)v7 + 25) >= 4u )
        WPP_SF_S(v7[2], 42LL, &WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids);
      CMonitorManager::RemoveMonitor(this, v14, 1);
      CoTaskMemFree(v6);
      goto LABEL_33;
    }
LABEL_19:
    v9 = std::wstring::c_str((__int64)v14 + 168);
    v6 = pv;
