        ...
        _QWORD *a4)
{
  ...
  *(_QWORD *)(a3 + 8) = a4;
  v5 = qword_1801D0DB8;
  v6 = 2 * (a2 & qword_1801D0DD0);
  v7 = *(_QWORD *)(qword_1801D0DB8 + 16 * (a2 & qword_1801D0DD0));
  if ( v7 == qword_1801D0DA8 )
  {
    *(_QWORD *)(qword_1801D0DB8 + 8 * v6) = a4;
LABEL_6:
    *(_QWORD *)(v5 + 8 * v6 + 8) = a4;
    return a4;
  }
  ...
  else if ( *(_QWORD **)(qword_1801D0DB8 + 8 * v6 + 8) == v4 )
  {
    goto LABEL_6;
  }
  return a4;
