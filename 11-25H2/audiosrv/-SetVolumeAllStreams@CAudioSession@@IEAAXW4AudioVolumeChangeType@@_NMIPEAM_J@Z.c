/*
 * XREFs of ?SetVolumeAllStreams@CAudioSession@@IEAAXW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x18000F2C8
 * Callers:
 *     ?UpdateAudioVolume@CPerStreamVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x18000F290 (-UpdateAudioVolume@CPerStreamVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z.c)
...
void __fastcall CAudioSession::SetVolumeAllStreams(__int64 a1, int a2, char a3, float a4, unsigned int a5, float *a6)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 66LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, a1);
  }
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)v33 = 0LL;
      ...
      GetPolicyVolumeForAudioStream(
        ...
        (__int64 *)(((unsigned __int64)v13 + 16) & -(__int64)(v13 != 0LL)),
        *((unsigned int **)v14 + 1),
        &v37,
        (__int64 *)v33,
        0);
      ...
      {
        *(_QWORD *)v32 = *v9;
        WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 67LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, a1);
      }
      if ( a2 == 3 )
      {
