/*
 * XREFs of ?SendBtAudioStreamContext@CBtAudioResourceManager@@EEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4BTAudio_StreamContext@@@Z @ 0x1800D2B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBtAudioResourceManager::SendBtAudioStreamContext(__int64 a1, int a2, int a3)
{
  ...
  if ( *(_BYTE *)(a1 + 492) && !a2 )
  {
    FileW = CreateFileW(*(LPCWSTR *)(a1 + 504), 0xC0000000, 3u, 0LL, 3u, 0x80u, 0LL);
    v10 = FileW;
