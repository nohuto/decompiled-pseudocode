/*
 * XREFs of ?ClearPerProcessRouting@DynamicAudioEndpointManager@@AEAAJQEAY05_NK@Z @ 0x18011DCB4
 * Callers:
        ...
        unsigned int a3)
{
  ...
  LPVOID v16; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( 2 )
    {
      ...
      do
      {
        if ( *v9 )
        {
          v10 = PublishChangeNotification((unsigned int)v7, (unsigned int)v8, &LocaleName, a3, v13, v14);
          v11 = v10;
          if ( v10 < 0 )
          {
