/*
 * XREFs of ?GetCopyOfResourceTokens@CSaDeviceProxy@@UEAAJAEAV?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@Z @ 0x1800F1580
 * Callers:
 *     <none>
 * Callees:
