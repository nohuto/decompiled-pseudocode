/*
 * XREFs of _lambda_c1484885cbbce228ad1e61609886ff14_::operator() @ 0x1800C25D4
 * Callers:
 ...
 *     ?GetCurrentSessionGain@CAudioSession@@IEAAXPEA_NPEAMPEA_J@Z @ 0x18005FD54 (-GetCurrentSessionGain@CAudioSession@@IEAAXPEA_NPEAMPEA_J@Z.c)
 ...
 *     WPP_SF_S_guid_ @ 0x1800C4394 (WPP_SF_S_guid_.c)
 *     WPP_SF_Sg @ 0x1800C45C8 (WPP_SF_Sg.c)
 *     _alloca_probe @ 0x18015E810 (_alloca_probe.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x18016A010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall lambda_c1484885cbbce228ad1e61609886ff14_::operator()(CAudioSession **a1, __int64 a2, int a3)
{
  ...
  {
    v17 = *a1;
    v18 = *(void (__fastcall **)(CAudioSession *, __int64, __int64))(*(_QWORD *)*a1 + 416LL);
...
LABEL_30:
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
  {
    WPP_SF_S(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0x41u,
      (__int64)&WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids,
      *((const wchar_t **)*a1 + 82));
  }
