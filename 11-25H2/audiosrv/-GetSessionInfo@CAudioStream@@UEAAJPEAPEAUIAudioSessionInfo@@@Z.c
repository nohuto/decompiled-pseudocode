/*
 * XREFs of ?GetSessionInfo@CAudioStream@@UEAAJPEAPEAUIAudioSessionInfo@@@Z @ 0x1800668C0
 * Callers:
 *     ?GetSessionInfo@CAudioStream@@W7EAAJPEAPEAUIAudioSessionInfo@@@Z @ 0x180106920 (-GetSessionInfo@CAudioStream@@W7EAAJPEAPEAUIAudioSessionInfo@@@Z.c)
 * Callees:
