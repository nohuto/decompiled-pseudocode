/*
 * XREFs of ??1?$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800FC4C0
 * Callers:
 *     _dynamic_atexit_destructor_for__s_MulticastSessionManager__ @ 0x180169DD0 (_dynamic_atexit_destructor_for__s_MulticastSessionManager__.c)
 * Callees:
