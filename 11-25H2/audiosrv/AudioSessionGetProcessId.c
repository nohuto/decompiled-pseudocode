/*
 * XREFs of AudioSessionGetProcessId @ 0x18006D080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetProcessId(__int64 *a1, __int64 a2)
{
  ...
  v13 = L"AudioSessionGetProcessId";
  v14 = v4;
  v15 = 0;
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 136LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetProcessId", 1618, v8);
