/*
 * XREFs of ?CreateOverridingChain@SystemEffectDescriptor@@QEAAJAEAVCAudioSignalProcessingModeArray@@IPEBU_GUID@@W4SED_APOPLACEMENT@@W4ConnectorSupportsMode@@V?$function@$$A6AJPEAVSystemEffectDescriptor@@PEAVSystemEffectChainDescriptor@@@Z@std@@@Z @ 0x18003D98C
 * Callers:
    ...
    *(_OWORD *)v49 = 0LL;
    ...
    if ( v26 >= 0 )
    {
      ...
      if ( a7[7] )
      {
        ...
        v28 = SystemEffectChainDescriptor::MarkAsUnresolved(v49[0], v27);
        v29 = v28;
        if ( v28 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
...
LABEL_68:
  ...
  v45 = SystemEffectChainDescriptor::MarkAsUnresolved(v49[0], v44);
  v29 = v45;
  if ( v45 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
