/*
 * XREFs of ?GetDisplayName@CAudioSession@@UEAAJPEAPEAG@Z @ 0x180068AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetDisplayName(struct _RTL_CRITICAL_SECTION *this, unsigned __int16 **a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
  v4 = this + 7;
...
LABEL_23:
  ...
  v15 = -2147024882;
LABEL_24:
  AudSrvTraceLoggingErrorHelper("CAudioSession::GetDisplayName", 85, v15);
LABEL_13:
  if ( v4 )
