/*
 * XREFs of ?AddStream@CPerEndpointVolumeAudioSession@@EEAAJPEAVCAudioStream@@@Z @ 0x18007B9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CAudioStream *a2)
{
  ...
  *((_QWORD *)a2 + 8) = this;
  ...
  GetPolicyVolumeForAudioStream(
    ...
    (__int64 *)(((unsigned __int64)a2 + 16) & ((unsigned __int128)-(__int128)(unsigned __int64)a2 >> 64)),
    *((unsigned int **)v4 + 1),
    &v9,
    &v10,
    0);
