/*
 * XREFs of CEndpointCharacteristics::ForEachCandidateFormatForMode__lambda_5789e60fd85b99cd3c89d9f341e01d71___ @ 0x180043A2C
 * Callers:
 ...
 *     ?IsViableChannelCount@@YA_NIPEATKSDATAFORMAT@@IPEA_N@Z @ 0x18009F924 (-IsViableChannelCount@@YA_NIPEATKSDATAFORMAT@@IPEA_N@Z.c)
...
LABEL_74:
                    ...
                    *(GUID *)&v60.m256i_u64[1] = GUID_00000001_0000_0010_8000_00aa00389b71;
                    ...
                    WORD1(v59) = i;
                    DWORD1(v59) = v25;
                    WORD6(v59) = i * ((unsigned __int16)v38 >> 3);
                    DWORD2(v59) = v25 * WORD6(v59);
