/*
 * XREFs of ??1CBaseStreamGroupProxy@@MEAA@XZ @ 0x18002752C
 * Callers:
...
void __fastcall CBaseStreamGroupProxy::~CBaseStreamGroupProxy(CBaseStreamGroupProxy *this)
{
  ...
  *((_QWORD *)this + 1) = &CBaseStreamGroupProxy::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,IAudioGraphCallback>'};
  ...
  std::vector<wil::com_ptr_t<IAPOWrapperSrv,wil::err_returncode_policy>>::_Tidy((__int64)this + 240);
  std::vector<Microsoft::WRL::WeakRef>::_Tidy((__int64)this + 216);
  v4 = (char *)*((_QWORD *)this + 24);
  if ( v4 )
  {
    std::_Deallocate<16,0>(
      v4,
      (const struct std::nothrow_t *)((*((_QWORD *)this + 26) - (_QWORD)v4) & 0xFFFFFFFFFFFFFFF8uLL));
    *((_QWORD *)this + 24) = 0LL;
    *((_QWORD *)this + 25) = 0LL;
    *((_QWORD *)this + 26) = 0LL;
  }
  ...
  ATL::CAutoPtr<CResourcePriorityTracker>::Free((char *)this + 72);
