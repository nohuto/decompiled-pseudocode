/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2508@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800D5EC0
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2508@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800DAF2C (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2508@@@details@wil@@QEAAX_NW4Repor.c)
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2508>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2508>::GetCurrentFeatureEnabledState(v7, &v15, &v14);
