/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIMulticastSessionManager@@UIMulticastManagerNotificationClient@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x1800FD570
 * Callers:
 ...
 *     ??1?$ComPtr@VCMulticastSessionManager@@@WRL@Microsoft@@QEAA@XZ @ 0x1800FC49C (--1-$ComPtr@VCMulticastSessionManager@@@WRL@Microsoft@@QEAA@XZ.c)
 *     ??1?$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800FC4C0 (--1-$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
 ...
 *     ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIMulticastSessionManager@@UIMulticastManagerNotificationClient@@@Details@WRL@Microsoft@@W7EAAKXZ @ 0x1800FD5D0 (-Release@-$RuntimeClassImpl@U-$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIMu_ea_1800FD5D0.c)
 * Callees:
