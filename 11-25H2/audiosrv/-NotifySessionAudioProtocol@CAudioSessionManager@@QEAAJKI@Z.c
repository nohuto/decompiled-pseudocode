/*
 * XREFs of ?NotifySessionAudioProtocol@CAudioSessionManager@@QEAAJKI@Z @ 0x18001BC80
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_6f73e997589bdd5d65b7fde1db8b242b__long_wil::com_ptr_t_CEndpointStore_wil::err_returncode_policy__&_::_Do_call @ 0x18007E190 (std--_Func_impl_no_alloc__lambda_6f73e997589bdd5d65b7fde1db8b242b__long_wil--com_ptr_t_CEndpoint.c)
 * Callees:
        ...
        int a3)
{
  ...
  _QWORD **v23; // [rsp+38h] [rbp-29h]
  _QWORD *v24; // [rsp+40h] [rbp-21h]
  _BYTE v25[16]; // [rsp+48h] [rbp-19h] BYREF
  int v26; // [rsp+58h] [rbp-9h] BYREF
  _QWORD *v27; // [rsp+60h] [rbp-1h] BYREF
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 36LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids, a2);
  }
    ...
    for ( i = *v11; ; i = (_QWORD *)*i )
    {
      ...
      if ( !*((_QWORD *)&v22 + 1) )
      {
        ...
        std::_Default_allocator_traits<std::allocator<std::_List_node<std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>>,void *>>>::construct<std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>>,std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>> const &>(
          ...
          v14 + 2,
          i + 2);
        if ( (unsigned __int8)std::_Hash<std::_Umap_traits<CAudioSessionInstanceId,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>,std::_Uhash_compare<CAudioSessionInstanceId,std::hash<CAudioSessionInstanceId>,std::equal_to<CAudioSessionInstanceId>>,std::allocator<std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>>>,0>>::_Check_rehash_required_1(&v26) )
        {
          std::_Hash<std::_Umap_traits<CAudioSessionInstanceId,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>,std::_Uhash_compare<CAudioSessionInstanceId,std::hash<CAudioSessionInstanceId>,std::equal_to<CAudioSessionInstanceId>>,std::allocator<std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>>>,0>>::_Rehash_for_1(&v26);
          v22 = *(_OWORD *)std::_Hash<std::_Umap_traits<CAudioSessionInstanceId,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>,std::_Uhash_compare<CAudioSessionInstanceId,std::hash<CAudioSessionInstanceId>,std::equal_to<CAudioSessionInstanceId>>,std::allocator<std::pair<CAudioSessionInstanceId const,wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>>>,0>>::_Find_last<CAudioSessionInstanceId>(
                             &v26,
                             v25,
                             v14 + 2,
                             v13);
        ...
        *(_QWORD *)(v9 + 8) = v14;
        v17 = 2 * (v31 & v13);
        v18 = v29;
        v10 = *(_QWORD **)(v29 + 8 * v17);
        if ( v10 == v27 )
        {
          *(_QWORD *)(v29 + 8 * v17) = v14;
LABEL_22:
          *(_QWORD *)(v18 + 8 * v17 + 8) = v14;
          continue;
        }
        if ( v10 != (_QWORD *)v9 )
        {
          if ( *(_QWORD **)(v29 + 8 * v17 + 8) != v16 )
            continue;
          goto LABEL_22;
        }
        *(_QWORD *)(v29 + 8 * v17) = v14;
