 ...
 *     ?FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180110A98 (-FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
    ...
    else
    {
      if ( v5 != 811 )
      {
        if ( v5 != 1018 )
        {
          ...
          wil::details::in1diag3::FailFast_Hr(retaddr, v6, v7, (const char *)(unsigned int)v5, fAsynchronous);
        }
