/*
 * XREFs of ??$_Construct_in_place@V?$ComPtr@UIProcessSubmixProxy@@@WRL@Microsoft@@AEBV123@@std@@YAXAEAV?$ComPtr@UIProcessSubmixProxy@@@WRL@Microsoft@@AEBV123@@Z @ 0x1800EE0A0
 * Callers:
