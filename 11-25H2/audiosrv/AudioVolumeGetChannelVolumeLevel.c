/*
 * XREFs of AudioVolumeGetChannelVolumeLevel @ 0x180011D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelVolumeLevel(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  v14 = L"AudioVolumeGetChannelVolumeLevel";
  v15 = v3;
  v16 = 0;
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a1 + 104LL))(*a1, a2, a3);
