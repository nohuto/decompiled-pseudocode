/*
 * XREFs of ??1?$vector@V?$unique_ptr@$$BY0A@U_MulticastSessionConfiguration@@U?$function_deleter@P6AXPEAX@Z$1?MIDL_user_free@@YAX0@Z@wil@@@wistd@@V?$allocator@V?$unique_ptr@$$BY0A@U_MulticastSessionConfiguration@@U?$function_deleter@P6AXPEAX@Z$1?MIDL_user_free@@YAX0@Z@wil@@@wistd@@@std@@@std@@QEAA@XZ @ 0x1800FC4E0
 * Callers:
 *     _CMulticastSessionManager::GetMulticastSessions_::_1_::dtor$0 @ 0x180167088 (_CMulticastSessionManager--GetMulticastSessions_--_1_--dtor$0.c)
 * Callees:
