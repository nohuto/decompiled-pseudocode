/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x18007DBCC
 * Callers:
        ...
        __int64 a5)
{
  ...
  unsigned __int16 *v8; // [rsp+48h] [rbp-38h] BYREF
  ...
  v10 = 2;
  v13 = 1;
  return EtwEventWriteTransfer(*(_QWORD *)(a1 + 32), v6, 0LL, 0LL, 3, &v8);
}
