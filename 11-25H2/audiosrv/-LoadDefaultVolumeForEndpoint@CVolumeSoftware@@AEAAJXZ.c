/*
 * XREFs of ?LoadDefaultVolumeForEndpoint@CVolumeSoftware@@AEAAJXZ @ 0x180081A98
 * Callers:
 ...
 *     WPP_SF_qg @ 0x18010DF7C (WPP_SF_qg.c)
...
__int64 __fastcall CVolumeSoftware::LoadDefaultVolumeForEndpoint(CVolumeSoftware *this)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( v2 >= 0 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 47LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids, v1);
      }
  ...
  if ( v2 < 0 )
    AudSrvTraceLoggingErrorHelper("CVolumeSoftware::LoadDefaultVolumeForEndpoint", 1894, v2);
  if ( v16 )
