/*
 * XREFs of ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x180144780
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( *SpinCount > 5u )
  {
    ...
    v18 = 16;
    v15 = 4;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)SpinCount, byte_1801A777D, 0LL, 0LL, 5, (__int64)v13);
  }
  return 0LL;
}
