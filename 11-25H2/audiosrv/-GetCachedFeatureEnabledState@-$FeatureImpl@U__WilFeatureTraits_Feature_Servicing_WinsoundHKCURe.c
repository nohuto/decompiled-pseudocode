/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_WinsoundHKCURead@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180145EB4
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_WinsoundHKCURead@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180145F98 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_WinsoundHKCUR.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_WinsoundHKCURead>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_WinsoundHKCURead>::GetCurrentFeatureEnabledState(
      v7,
      &v15,
      &v14);
