/*
 * XREFs of ?GetPreferredFormat@CCompositeSystemEffect@@AEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z @ 0x180141C64
 * Callers:
 *     ?GetPreferredOutputFormat@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z @ 0x180141EC0 (-GetPreferredOutputFormat@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@@Z.c)
 * Callees:
