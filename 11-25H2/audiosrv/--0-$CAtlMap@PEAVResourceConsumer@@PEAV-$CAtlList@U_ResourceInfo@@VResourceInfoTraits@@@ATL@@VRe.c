/*
 * XREFs of ??0?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAA@IMMMI@Z @ 0x180117C48
 * Callers:
 *     ??0CSpatialAudioResourceManager@Sarm@@QEAA@XZ @ 0x180117CA4 (--0CSpatialAudioResourceManager@Sarm@@QEAA@XZ.c)
 *     ??0CConstraintModel@@QEAA@XZ @ 0x180157074 (--0CConstraintModel@@QEAA@XZ.c)
