/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@std@@@std@@YAXPEAV?$basic_regex@GV?$regex_traits@G@std@@@0@QEAV10@AEAV?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@0@@Z @ 0x18013A010
 * Callers:
 ...
 *     ??1?$vector@V?$basic_regex@GV?$regex_traits@G@std@@@std@@V?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@2@@std@@QEAA@XZ @ 0x18013B808 (--1-$vector@V-$basic_regex@GV-$regex_traits@G@std@@@std@@V-$allocator@V-$basic_regex@GV-$regex_t.c)
 *     ??1EffectPackConfiguration@@QEAA@XZ @ 0x18013B870 (--1EffectPackConfiguration@@QEAA@XZ.c)
 *     ?_Change_array@?$vector@V?$basic_regex@GV?$regex_traits@G@std@@@std@@V?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@2@@std@@AEAAXQEAV?$basic_regex@GV?$regex_traits@G@std@@@2@_K1@Z @ 0x18013EE78 (-_Change_array@-$vector@V-$basic_regex@GV-$regex_traits@G@std@@@std@@V-$allocator@V-$basic_regex.c)
 *     _std::vector_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short____std::allocator_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short_______::_Emplace_reallocate_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short____const_&__::_1_::catch$0 @ 0x1801686A5 (_std--vector_std--basic_regex_unsigned_short_std--regex_traits_unsigned_short____std--allocator_.c)
 * Callees:
