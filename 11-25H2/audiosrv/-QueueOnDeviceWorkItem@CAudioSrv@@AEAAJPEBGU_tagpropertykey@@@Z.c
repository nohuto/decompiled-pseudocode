/*
 * XREFs of ?QueueOnDeviceWorkItem@CAudioSrv@@AEAAJPEBGU_tagpropertykey@@@Z @ 0x180052D20
 * Callers:
 *     ?OnPropertyValueChanged@CAudioSrv@@UEAAJPEBGU_tagpropertykey@@@Z @ 0x180052CF0 (-OnPropertyValueChanged@CAudioSrv@@UEAAJPEBGU_tagpropertykey@@@Z.c)
 * Callees:
        ...
        struct _tagpropertykey *a3)
{
  ...
  struct _RTL_CRITICAL_SECTION *v26; // [rsp+28h] [rbp-40h] BYREF
...
LABEL_16:
  ...
  *(_QWORD *)&fmtid.Data1 = (char *)this + 112;
  ...
  v26 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 112);
  v10 = *((_QWORD *)this + 20);
  if ( *((_QWORD *)this + 23) )
  {
LABEL_12:
