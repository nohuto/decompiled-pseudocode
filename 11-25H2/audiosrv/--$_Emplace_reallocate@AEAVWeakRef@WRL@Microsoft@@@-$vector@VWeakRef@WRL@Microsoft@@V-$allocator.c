/*
 * XREFs of ??$_Emplace_reallocate@AEAVWeakRef@WRL@Microsoft@@@?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@AEAAPEAVWeakRef@WRL@Microsoft@@QEAV234@AEAV234@@Z @ 0x1800F4060
 * Callers:
        ...
        __int64 *a3)
{
  ...
  try
  {
    ...
    std::_Uninitialized_move<Microsoft::WRL::ComPtr<ISaDeviceProxy> *,std::allocator<Microsoft::WRL::ComPtr<ISaDeviceProxy>>>(
      ...
      v14,
      v15);
    std::vector<Microsoft::WRL::WeakRef>::_Change_array((__int64)a1, v12, v7, v8);
    result = v13;
  }
  catch ( ... )
  {
