/*
 * XREFs of ?StopStream@CSharedStreamGroupProxy@@UEAAJPEAUIStreamInstance@@@Z @ 0x18007EFA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::StopStream(CSharedStreamGroupProxy *this, struct IStreamInstance *a2)
{
