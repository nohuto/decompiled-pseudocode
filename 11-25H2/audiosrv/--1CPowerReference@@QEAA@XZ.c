/*
 * XREFs of ??1CPowerReference@@QEAA@XZ @ 0x180015C58
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ @ 0x180081230 (-_Destroy@-$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
