/*
 * XREFs of ?CacheMixFormat@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@_NPEBUtWAVEFORMATEX@@@Z @ 0x18007BD28
 * Callers:
        ...
        BYTE *a5)
{
  ...
  int v15; // eax
  __int64 v16; // rcx
  tagPROPVARIANT v17; // [rsp+20h] [rbp-50h] BYREF
...
LABEL_7:
    ...
    v16 = *((_QWORD *)this + 9);
    v20 = v12 + v15;
    v9 = (*(__int64 (__fastcall **)(__int64, __int128 *, tagPROPVARIANT *))(*(_QWORD *)v16 + 48LL))(v16, &v19, &v17);
    if ( v9 < 0 )
    {
      v10 = 8065LL;
      goto LABEL_5;
