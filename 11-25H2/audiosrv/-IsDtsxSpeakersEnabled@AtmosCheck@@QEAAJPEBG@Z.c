/*
 * XREFs of ?IsDtsxSpeakersEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180008E4C
 * Callers:
 *     ?GetTechnologyLicenseResult@CSpatialAudioDtsxStereo@@UEBAJPEBG@Z @ 0x180081240 (-GetTechnologyLicenseResult@CSpatialAudioDtsxStereo@@UEBAJPEBG@Z.c)
 * Callees:
