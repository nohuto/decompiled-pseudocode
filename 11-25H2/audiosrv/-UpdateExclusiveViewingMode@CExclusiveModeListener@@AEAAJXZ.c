/*
 * XREFs of ?UpdateExclusiveViewingMode@CExclusiveModeListener@@AEAAJXZ @ 0x180144884
 * Callers:
 ...
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$00@@U?$_tlgWrapSz@G@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$00@@AEBU?$_tlgWrapSz@G@@@Z @ 0x180007A38 (--$Write@U-$_tlgWrapperByVal@$00@@U-$_tlgWrapSz@G@@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t.c)
...
__int64 __fastcall CExclusiveModeListener::UpdateExclusiveViewingMode(CExclusiveModeListener *this)
{
  ...
  int v8; // eax
  __int64 v9; // rbx
  __int64 (__fastcall *v10)(__int64, const WCHAR **); // rdi
  __int64 v11; // rbx
  ...
  if ( *v3 > 5u )
  {
    ...
    v30 = (char *)this + 136;
    v31 = 16LL;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v3, byte_1801A7898, 0LL, 0LL, 7, (__int64)v29);
  }
  ...
  *((_DWORD *)this + 38) = v2;
  ...
  if ( v4 >= 0 )
  {
    for ( i = 0; i < v26; ++i )
    {
      ...
      v9 = v25;
      v10 = *(__int64 (__fastcall **)(__int64, const WCHAR **))(*(_QWORD *)v25 + 40LL);
