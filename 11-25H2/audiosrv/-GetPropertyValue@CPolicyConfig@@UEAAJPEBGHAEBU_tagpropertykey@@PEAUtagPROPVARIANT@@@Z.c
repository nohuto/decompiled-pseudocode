/*
 * XREFs of ?GetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18005E1B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 2023, v7);
    goto LABEL_13;
  }
  *(_OWORD *)&a5->vt = 0LL;
