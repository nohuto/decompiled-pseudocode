        ...
        __int64 a3)
{
  ...
  v4 = a2;
  v5 = *(_QWORD *)(qword_1801CF568 + 8);
  *((_DWORD *)a2 + 2) = 0;
  *a2 = v5;
  *((_DWORD *)a2 + 3) = 0;
  v6 = *a2;
  a2[2] = qword_1801CF568;
  while ( !*(_BYTE *)(v6 + 25) )
  {
    *v4 = v6;
    std::wstring::c_str(a3);
    v8 = *(_QWORD *)(v7 + 48);
    v9 = std::wstring::c_str(v7 + 32);
    v11 = *(_QWORD *)(a3 + 16);
    if ( v11 >= v8 )
      v11 = v8;
    v12 = std::_WChar_traits<unsigned short>::compare(v9, v10, v11);
    if ( v12 )
    {
      if ( v12 >= 0 )
        goto LABEL_6;
