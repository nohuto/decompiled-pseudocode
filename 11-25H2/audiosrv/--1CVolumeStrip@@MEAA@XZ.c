/*
 * XREFs of ??1CVolumeStrip@@MEAA@XZ @ 0x180079DBC
 * Callers:
 ...
 *     ??1?$CLockedList_UniqueValuesOnly@VCMasterVolumeNotificationProcess@@$0A@@@QEAA@XZ @ 0x180079E6C (--1-$CLockedList_UniqueValuesOnly@VCMasterVolumeNotificationProcess@@$0A@@@QEAA@XZ.c)
