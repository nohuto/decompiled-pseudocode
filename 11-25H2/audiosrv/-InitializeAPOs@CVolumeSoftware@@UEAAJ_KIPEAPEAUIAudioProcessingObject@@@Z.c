/*
 * XREFs of ?InitializeAPOs@CVolumeSoftware@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x18007C2C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 51LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids, this);
  }
  if ( a3 )
  {
...
LABEL_16:
          AudSrvTraceLoggingErrorHelper("CVolumeSoftware::InitializeAPOs", 2202, v7);
    ...
    if ( !*v11 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 52LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids);
      }
      v7 = -2147467262;
LABEL_24:
...
LABEL_25:
    ...
    LOBYTE(v9) = 1;
    v16 = (*(__int64 (__fastcall **)(CVolumeSoftware *, __int64 *))(*(_QWORD *)v6 + 240LL))(v6, v9);
    v7 = v16;
    if ( v16 < 0 )
      goto LABEL_16;
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_qD(*((_QWORD *)WPP_GLOBAL_Control + 2), 53LL, &WPP_39683fa90ec33421f15b53210ac19d77_Traceguids, v6, v16);
    }
  }
  else
  {
