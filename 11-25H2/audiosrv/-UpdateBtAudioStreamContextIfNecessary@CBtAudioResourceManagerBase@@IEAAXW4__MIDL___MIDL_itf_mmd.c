/*
 * XREFs of ?UpdateBtAudioStreamContextIfNecessary@CBtAudioResourceManagerBase@@IEAAXW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x1800DD238
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_bb5d36055978aeacbacf48ca24f21936__void_::_Do_call @ 0x1800DD580 (std--_Func_impl_no_alloc__lambda_bb5d36055978aeacbacf48ca24f21936__void_--_Do_call.c)
 * Callees:
        ...
        int a2)
{
  ...
  if ( (int)CEndpointStoreCache::GetEndpointStore(v5, this[7], &v12) >= 0 )
  {
    ...
    v8 = *this;
    v9 = (__int64 (__fastcall *)(const unsigned __int16 **, _QWORD, __int128 *))*((_QWORD *)*this + 19);
    if ( v7 )
      v10 = (__int128 *)(*((__int64 (__fastcall **)(const unsigned __int16 **, _BYTE *))v8 + 16))(this, v15);
    else
      v10 = (__int128 *)(*((__int64 (__fastcall **)(const unsigned __int16 **, _BYTE *))v8 + 15))(this, v16);
    v14 = *v10;
  ...
  if ( BTAudio_StreamContextFromStreamCounts != *((_DWORD *)this + v2 + 121) && *((_BYTE *)this + 492) )
  {
    v11 = (*((__int64 (__fastcall **)(const unsigned __int16 **, _QWORD, _QWORD))*this + 20))(
            this,
            (unsigned int)v2,
