/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_VoiceClarityEffectPack@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18012C2B8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_VoiceClarityEffectPack@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18012E254 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_VoiceClarityEffectPack@@@details@wil@@QEA.c)
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_VoiceClarityEffectPack>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_VoiceClarityEffectPack>::GetCurrentFeatureEnabledState(
      v7,
      &v15,
      &v14);
    ...
    if ( (i & 4) == 0 )
      wil::details::SubscribeFeatureStateCacheToConfigurationChanges((volatile signed __int32 *)a1, 1, v6);
    if ( (*(_DWORD *)a2 & 2) == 0 )
