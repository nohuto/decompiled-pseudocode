/*
 * XREFs of ?DisconnectSessionsForTsSession@AudioSessionManagerProvider@@YAXKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x180022654
 * Callers:
        ...
        enum __MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001 a3)
{
  ...
  *((_QWORD *)&v5 + 1) = &v4;
  ...
  v7 = v5;
  v8 = &v6;
  CEndpointStoreCache::ForEachEndpoint(this, (__int64)&v6);
  if ( v8 )
  {
    v3 = &v6;
    LOBYTE(v3) = v8 != &v6;
