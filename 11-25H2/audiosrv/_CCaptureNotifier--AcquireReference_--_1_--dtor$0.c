/*
 * XREFs of _CCaptureNotifier::AcquireReference_::_1_::dtor$0 @ 0x180162A7A
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureNotifier::AcquireReference_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  __int64 result; // rax
