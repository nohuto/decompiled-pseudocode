/*
 * XREFs of ?IsProcessAllowed@@YAHKPEBG@Z @ 0x18000DD7C
 * Callers:
...
__int64 __fastcall IsProcessAllowed(DWORD dwProcessId, const unsigned __int16 *a2)
{
  ...
  *(_OWORD *)v18 = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x22Au, v8);
      goto LABEL_16;
    }
  }
  v5 = 1;
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( pSessionId && v6 && pSessionId != v6 )
      {
        ...
        {
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_8bc7b28d8efe3d7b840b96e094d2bf56_Traceguids);
        }
        v4 = 0;
      }
      else
  ...
  if ( v5 )
  {
    ...
    if ( v9 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_8bc7b28d8efe3d7b840b96e094d2bf56_Traceguids, v9);
      }
    }
  }
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x27Cu, v8);
  if ( v12 )
