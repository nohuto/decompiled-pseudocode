/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00UIBtAudioResourceManager@@UISessionInternalEvents@@UIEndpointCustomFormatHandler@@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x1800ECDA8
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( InlineIsEqualGUID(a2, &GUID_107fde7c_f81d_4321_90b0_d0cbb8ba74a8) )
  {
    *v3 = v4;
    return 0LL;
  }
