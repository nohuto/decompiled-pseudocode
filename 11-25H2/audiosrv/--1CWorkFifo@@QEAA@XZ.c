/*
 * XREFs of ??1CWorkFifo@@QEAA@XZ @ 0x180118040
 * Callers:
 *     ??1CSpatialAudioResourceManager@Sarm@@UEAA@XZ @ 0x180117F78 (--1CSpatialAudioResourceManager@Sarm@@UEAA@XZ.c)
 *     _Sarm::CSpatialAudioResourceManager::CSpatialAudioResourceManager_::_1_::dtor$6 @ 0x180167C49 (_Sarm--CSpatialAudioResourceManager--CSpatialAudioResourceManager_--_1_--dtor$6.c)
 * Callees:
