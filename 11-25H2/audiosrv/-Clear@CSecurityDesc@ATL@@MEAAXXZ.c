/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x1800A3AB0
 * Callers:
 *     ?GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z @ 0x180057B28 (-GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x1800A6F60 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x1800AE550 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x18008759C (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
 */
