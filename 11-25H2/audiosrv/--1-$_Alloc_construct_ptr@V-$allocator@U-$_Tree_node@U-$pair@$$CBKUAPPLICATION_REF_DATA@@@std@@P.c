/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Tree_node@U?$pair@$$CBKUAPPLICATION_REF_DATA@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800D351C
 * Callers:
 ...
 *     _std::map___int64_Microsoft::WRL::ComPtr_IUnknown__std::less___int64__std::allocator_std::pair___int64_const__Microsoft::WRL::ComPtr_IUnknown_______::_Try_emplace___int64_const_&__::_1_::dtor$2 @ 0x180164F0F (_std--map___int64_Microsoft--WRL--ComPtr_IUnknown__std--less___int64__std--allocator_std--pair__.c)
 *     _std::_Tree_temp_node_std::allocator_std::_Tree_node_std::pair_unsigned_long_const__APPLICATION_REF_DATA__void_______::_Tree_temp_node_std::allocator_std::_Tree_node_std::pair_unsigned_long_const__APPLICATION_REF_DATA__void________std::piecewise_construct_t_const_&_std::tuple_unsigned_long_const_&__std::tuple_____::_1_::dtor$1 @ 0x18016720C (_std--_Tree_temp_node_std--allocator_std--_Tree_node_std--pair_unsigned_long_const__APPLICATION_.c)
 * Callees:
