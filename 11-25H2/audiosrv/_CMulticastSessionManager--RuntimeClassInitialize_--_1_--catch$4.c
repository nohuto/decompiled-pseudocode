/*
 * XREFs of _CMulticastSessionManager::RuntimeClassInitialize_::_1_::catch$4 @ 0x18016715A
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMulticastSessionManager::RuntimeClassInitialize_::_1_::catch_4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
