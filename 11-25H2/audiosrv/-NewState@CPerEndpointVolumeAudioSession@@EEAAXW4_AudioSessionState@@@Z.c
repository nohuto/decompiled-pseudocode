/*
 * XREFs of ?NewState@CPerEndpointVolumeAudioSession@@EEAAXW4_AudioSessionState@@@Z @ 0x1800806F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( v4 == 2 )
  {
    if ( v2 != 2 )
    {
      ...
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 53LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
      }
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 54LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
...
LABEL_20:
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 55LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, this);
  }
