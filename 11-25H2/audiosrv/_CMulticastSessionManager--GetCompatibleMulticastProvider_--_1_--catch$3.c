/*
 * XREFs of _CMulticastSessionManager::GetCompatibleMulticastProvider_::_1_::catch$3 @ 0x180167049
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMulticastSessionManager::GetCompatibleMulticastProvider_::_1_::catch_3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
