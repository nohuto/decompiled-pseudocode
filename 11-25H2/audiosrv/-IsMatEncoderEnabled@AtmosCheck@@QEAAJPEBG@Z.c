/*
 * XREFs of ?IsMatEncoderEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180008F1C
 * Callers:
 *     ?GetDeepLink@CSpatialAudioDolbyHeadphones@@UEBAPEBGPEBG@Z @ 0x180008CF0 (-GetDeepLink@CSpatialAudioDolbyHeadphones@@UEBAPEBGPEBG@Z.c)
 *     ?GetTechnologyLicenseResult@CSpatialAudioDolbyAtmosMAT@@UEBAJPEBG@Z @ 0x180139110 (-GetTechnologyLicenseResult@CSpatialAudioDolbyAtmosMAT@@UEBAJPEBG@Z.c)
 *     wistd::__function::__func__lambda_7ad38737e46e24cc28377d4c0faef1bb__long___cdecl(void)_::operator() @ 0x180147A60 (wistd--__function--__func__lambda_7ad38737e46e24cc28377d4c0faef1bb__long___cdecl(void)_--operato.c)
 * Callees:
