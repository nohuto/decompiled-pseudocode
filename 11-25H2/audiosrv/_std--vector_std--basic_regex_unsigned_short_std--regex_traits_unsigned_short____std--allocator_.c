/*
 * XREFs of _std::vector_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short____std::allocator_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short_______::_Emplace_reallocate_std::basic_regex_unsigned_short_std::regex_traits_unsigned_short____const_&__::_1_::catch$0 @ 0x1801686A5
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@std@@QEAAXQEAV?$basic_regex@GV?$regex_traits@G@std@@@2@_K@Z @ 0x180140B00 (-deallocate@-$allocator@V-$basic_regex@GV-$regex_traits@G@std@@@std@@@std@@QEAAXQEAV-$basic_rege.c)
