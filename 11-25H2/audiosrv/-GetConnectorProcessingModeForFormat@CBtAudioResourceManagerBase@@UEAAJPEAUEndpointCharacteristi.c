/*
 * XREFs of ?GetConnectorProcessingModeForFormat@CBtAudioResourceManagerBase@@UEAAJPEAUEndpointCharacteristicsDescriptor@@PEBUtWAVEFORMATEX@@PEAU_GUID@@@Z @ 0x1800D66D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a4)
{
  ...
  v15 = *(GUID *)(*(__int64 (__fastcall **)(CBtAudioResourceManagerBase *, _BYTE *))(*(_QWORD *)this + 120LL))(
                   this,
                   v16);
...
LABEL_5:
  ...
  v15 = *(GUID *)(*(__int64 (__fastcall **)(CBtAudioResourceManagerBase *, _BYTE *))(v10 + 128))(this, v16);
