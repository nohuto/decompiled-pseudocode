/*
 * XREFs of _lambda_ad0db6eea65a131797ab646398125e78_::operator() @ 0x1800B7CD4
 * Callers:
...
__int64 __fastcall lambda_ad0db6eea65a131797ab646398125e78_::operator()(__int64 a1)
{
...
LABEL_3:
  ...
  *v11 = 0LL;
  ...
  CEndpointCharacteristics::TryGetCustomResourceManagerService(v10, &GUID_4d3814ae_3db5_4fb3_819c_1493075ce6e3, v11);
  v13 = **(_QWORD **)(a1 + 64);
  if ( v13 )
  {
    v14 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(__int64, struct _RTL_CRITICAL_SECTION **))(*(_QWORD *)v13 + 96LL))(
                                             v13,
                                             &v27);
    wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::operator=(
