/*
 * XREFs of ?IsAudioFormatSupported@CAPOWrapperClient@@AEAAJW4__MIDL___MIDL_itf_audioenginepolicy_0000_0009_0001@@PEAUIAudioMediaType@@1PEAPEAU3@@Z @ 0x18000C790
 * Callers:
...
LABEL_23:
  ...
  *(_QWORD *)v21 = 0LL;
  v22 = 1;
  v12 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64, __int64))(v11 + 40))(v10, v6, v8, v9);
  v13 = pv;
  pv = *(LPVOID *)v21;
  if ( v13 )
    CoTaskMemFree(v13);
