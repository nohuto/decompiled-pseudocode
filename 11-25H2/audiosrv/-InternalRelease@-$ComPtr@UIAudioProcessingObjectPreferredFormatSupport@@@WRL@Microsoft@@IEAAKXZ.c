/*
 * XREFs of ?InternalRelease@?$ComPtr@UIAudioProcessingObjectPreferredFormatSupport@@@WRL@Microsoft@@IEAAKXZ @ 0x180141ED0
 * Callers:
 *     ??1?$ComPtr@UIAudioProcessingObjectPreferredFormatSupport@@@WRL@Microsoft@@QEAA@XZ @ 0x180141504 (--1-$ComPtr@UIAudioProcessingObjectPreferredFormatSupport@@@WRL@Microsoft@@QEAA@XZ.c)
