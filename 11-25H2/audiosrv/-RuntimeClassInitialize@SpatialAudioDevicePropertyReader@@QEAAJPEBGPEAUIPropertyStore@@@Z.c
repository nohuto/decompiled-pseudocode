/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyReader@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x18003BD30
 * Callers:
  ...
  if ( SpatialAudioDeviceStateReader < 0 )
  {
    if ( (unsigned int)dword_1801CC2E8 > 2 )
    {
      ...
      *(_DWORD *)&EventDescriptor.Level = 2;
      ...
      UserData.Ptr = (ULONGLONG)off_1801CC2F0;
      UserData.Size = *(unsigned __int16 *)off_1801CC2F0;
      UserData.Reserved = 2;
      *(_QWORD *)&v58 = &unk_1801A3DF4;
      *((_QWORD *)&v58 + 1) = 0x100000026LL;
      v53 = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
      EventWriteTransfer(qword_1801CC308, &EventDescriptor, 0LL, 0LL, 5u, &UserData);
    }
    return v9;
  }
  if ( a3 )
...
LABEL_56:
    ...
    if ( SpatialAudioPositionCalc >= 0 )
    {
      ...
      v9 = SpatialAudioPositionCalc;
      if ( SpatialAudioPositionCalc >= 0 || (unsigned int)dword_1801CC2E8 <= 2 )
        return v9;
      v52 = 249;
    }
    else
