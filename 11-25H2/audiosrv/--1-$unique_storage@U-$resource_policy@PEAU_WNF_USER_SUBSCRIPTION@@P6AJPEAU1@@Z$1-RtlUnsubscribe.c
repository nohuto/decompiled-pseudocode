/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAU_WNF_USER_SUBSCRIPTION@@P6AJPEAU1@@Z$1?RtlUnsubscribeWnfStateChangeNotification@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1800A6ED8
 * Callers:
 ...
 *     ??1wnf_subscription_state_base@details@wil@@UEAA@XZ @ 0x1800A70B0 (--1wnf_subscription_state_base@details@wil@@UEAA@XZ.c)
