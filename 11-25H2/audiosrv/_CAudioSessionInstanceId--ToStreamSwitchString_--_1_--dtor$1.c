/*
 * XREFs of _CAudioSessionInstanceId::ToStreamSwitchString_::_1_::dtor$1 @ 0x1801635B8
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::ToStreamSwitchString_::_1_::dtor_1(__int64 a1, __int64 a2)
{
