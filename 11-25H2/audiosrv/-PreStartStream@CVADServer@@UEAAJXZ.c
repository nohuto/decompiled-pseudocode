/*
 * XREFs of ?PreStartStream@CVADServer@@UEAAJXZ @ 0x180106EB0
 * Callers:
...
__int64 __fastcall CVADServer::PreStartStream(CVADServer *this)
{
  ...
  const WCHAR *v25; // [rsp+A8h] [rbp+50h] BYREF
    ...
    if ( *((_QWORD *)this + 18) )
    {
      ...
      if ( v5(v3 + 8, &v23) >= 0 )
      {
        ...
        if ( *v7 > 4u && tlgKeywordOn(*((_QWORD *)v6 + 1), 512LL) )
        {
          ...
          v9 = *((_QWORD *)this + 18);
          v22 = v8;
          v10 = (const WCHAR *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v9 + 8) + 64LL))(v9 + 8);
          v11 = *((_QWORD *)this + 22);
          v25 = v10;
