/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioTechHRTF@@UEBA_NPEAUIAudioEndpointInfo@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x180139A10
 * Callers:
 ...
 *     ?ChannelMaskFromChannelCount@SpatialAudio@@YAKK@Z @ 0x180138D54 (-ChannelMaskFromChannelCount@SpatialAudio@@YAKK@Z.c)
 *     FillHrtfDesiredFormat @ 0x180138DC0 (FillHrtfDesiredFormat.c)
 *     GetSupportedFormat @ 0x180138F60 (GetSupportedFormat.c)
 *     IsBitsPerSampleIncluded @ 0x180139254 (IsBitsPerSampleIncluded.c)
 *     IsSampleRateIncluded @ 0x180139290 (IsSampleRateIncluded.c)
...
LABEL_48:
      ...
      v35 = *((_DWORD *)&unk_180192A10 + v31 - 1);
      nSamplesPerSec = v35;
      v34 = v35;
LABEL_44:
