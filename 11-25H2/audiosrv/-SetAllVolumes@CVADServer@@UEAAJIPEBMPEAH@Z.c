/*
 * XREFs of ?SetAllVolumes@CVADServer@@UEAAJIPEBMPEAH@Z @ 0x18005D570
 * Callers:
        ...
        int *a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_8bc7b28d8efe3d7b840b96e094d2bf56_Traceguids, this);
  }
  v8 = this + 5;
