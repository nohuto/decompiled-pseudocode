/*
 * XREFs of std::find_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_ISaDeviceProxy_________lambda_e4c7d3c53d0b0ab1b1215ef3bd828cfb___ @ 0x1800B67CC
 * Callers:
