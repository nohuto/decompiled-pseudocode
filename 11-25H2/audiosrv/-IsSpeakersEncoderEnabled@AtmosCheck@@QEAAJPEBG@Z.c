/*
 * XREFs of ?IsSpeakersEncoderEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180008F84
 * Callers:
 *     ?GetTechnologyLicenseResult@CSpatialAudioDolbySpeakers@@UEBAJPEBG@Z @ 0x180139150 (-GetTechnologyLicenseResult@CSpatialAudioDolbySpeakers@@UEBAJPEBG@Z.c)
 * Callees:
...
__int64 __fastcall AtmosCheck::IsSpeakersEncoderEnabled(AtmosCheck *this, const unsigned __int16 *a2)
{
