/*
 * XREFs of ?NotifyClientOfGrant@CStreamResource@Sarm@@AEAAJI_J@Z @ 0x18011BC44
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::NotifyClientOfGrant(Sarm::CStreamResource *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v6 >= 0 )
  {
    if ( (unsigned int)dword_1801CC2B0 > 4 && tlgKeywordOn((__int64)&dword_1801CC2B0, 0x400000000000LL) )
    {
      v16 = *((_DWORD *)this + 13);
      v12 = (__int64)this + 16;
      v13[0] = *((_QWORD *)this + 5);
