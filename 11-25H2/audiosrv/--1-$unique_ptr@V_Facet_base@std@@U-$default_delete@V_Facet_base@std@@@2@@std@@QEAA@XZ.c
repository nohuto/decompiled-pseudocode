/*
 * XREFs of ??1?$unique_ptr@V_Facet_base@std@@U?$default_delete@V_Facet_base@std@@@2@@std@@QEAA@XZ @ 0x1800A6254
 * Callers:
 ...
 *     _std::use_facet_std::ctype_unsigned_short____::_1_::dtor$1 @ 0x180161B02 (_std--use_facet_std--ctype_unsigned_short____--_1_--dtor$1.c)
 *     _std::use_facet_std::collate_unsigned_short____::_1_::dtor$1 @ 0x180161BA6 (_std--use_facet_std--collate_unsigned_short____--_1_--dtor$1.c)
 *     _CAudioSrv::QueueOnDeviceWorkItem_::_1_::dtor$1_0 @ 0x180161C27 (_CAudioSrv--QueueOnDeviceWorkItem_--_1_--dtor$1_0.c)
 * Callees:
