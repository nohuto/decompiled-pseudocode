...
__int64 __fastcall DeviceGraphStore::GetSubmixesForApplication(__int64 a1, int a2, __int64 a3)
{
  unsigned int SubmixHelper; // ebx
  __int64 (__fastcall ***v5)(); // rdx
  __int128 v7; // [rsp+28h] [rbp-70h]
  ...
  *((_QWORD *)&v7 + 1) = &v11;
  ...
  v9 = v7;
  v10 = &v8;
  SubmixHelper = DeviceGraphStore::GetSubmixHelper(a3, (__int64)&v8);
  if ( v10 )
  {
    v5 = &v8;
    LOBYTE(v5) = v10 != &v8;
