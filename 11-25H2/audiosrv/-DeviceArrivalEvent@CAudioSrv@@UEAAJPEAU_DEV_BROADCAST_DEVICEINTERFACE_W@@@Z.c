/*
 * XREFs of ?DeviceArrivalEvent@CAudioSrv@@UEAAJPEAU_DEV_BROADCAST_DEVICEINTERFACE_W@@@Z @ 0x180077350
 * Callers:
 *     <none>
 * Callees:
 *     ?KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z @ 0x1800773C0 (-KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z.c)
 *     ?MME_AudioInterfaceArrival@@YAJPEBG@Z @ 0x1800774FC (-MME_AudioInterfaceArrival@@YAJPEBG@Z.c)
 */
