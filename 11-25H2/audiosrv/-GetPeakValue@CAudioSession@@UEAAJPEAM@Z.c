/*
 * XREFs of ?GetPeakValue@CAudioSession@@UEAAJPEAM@Z @ 0x18005C0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetPeakValue(CAudioSession *this, float *a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 26LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
    {
      WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 27LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
    }
    *a2 = v3;
  }
  else
