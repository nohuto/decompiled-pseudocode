/*
 * XREFs of ??$AsWeak@UIAudioModeEffectsWatcher@@@WRL@Microsoft@@YAJPEAUIAudioModeEffectsWatcher@@PEAVWeakRef@01@@Z @ 0x1800B4044
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<IAudioModeEffectsWatcher>(
