/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@@?$vector@U_GUID@@V?$allocator@U_GUID@@@std@@@std@@AEAAPEAU_GUID@@QEAU2@AEBU2@@Z @ 0x1800C89FC
 * Callers:
 ...
 *     ??$construct@U_GUID@@AEBU1@@?$_Default_allocator_traits@V?$allocator@U_GUID@@@std@@@std@@SAXAEAV?$allocator@U_GUID@@@1@QEAU_GUID@@AEBU3@@Z @ 0x1800C8EA4 (--$construct@U_GUID@@AEBU1@@-$_Default_allocator_traits@V-$allocator@U_GUID@@@std@@@std@@SAXAEAV.c)
