/*
 * XREFs of ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1800AAA14
 * Callers:
 ...
 * Callees:
 *     ?FormatTagFromWfx@@YAGPEBUtWAVEFORMATEX@@@Z @ 0x1800AA360 (-FormatTagFromWfx@@YAGPEBUtWAVEFORMATEX@@@Z.c)
 *     ?IsValidFloatWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1800AA720 (-IsValidFloatWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1800AA798 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 */
