/*
 * XREFs of ??$_Emplace_reallocate@AEBV?$ComPtr@UISaDeviceProxy@@@WRL@Microsoft@@@?$vector@V?$ComPtr@UISaDeviceProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UISaDeviceProxy@@@WRL@Microsoft@@@std@@@std@@AEAAPEAV?$ComPtr@UISaDeviceProxy@@@WRL@Microsoft@@QEAV234@AEBV234@@Z @ 0x1800F414C
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  __int64 v15; // r8
  __int64 v16; // rcx
  _QWORD *v18; // [rsp+70h] [rbp+8h] BYREF
  ...
  std::_Uninitialized_move<Microsoft::WRL::ComPtr<ISaDeviceProxy> *,std::allocator<Microsoft::WRL::ComPtr<ISaDeviceProxy>>>(
    ...
    v14,
    v15);
  std::vector<Microsoft::WRL::WeakRef>::_Change_array((__int64)a1, (__int64)v11, v8, v7);
  return v12;
}
