/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_ForEachStreamHang@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18010678C
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_ForEachStreamHang>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        int *a4)
...
LABEL_13:
  ...
  IsEnabled = wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2508>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_MediaQI2508>::GetImpl'::`2'::impl);
  v9 = *(_DWORD *)a2;
  if ( v11 && !IsEnabled )
    v9 &= ~0x400u;
