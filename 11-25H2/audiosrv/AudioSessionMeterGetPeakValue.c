/*
 * XREFs of AudioSessionMeterGetPeakValue @ 0x18000D920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetPeakValue(__int64 *a1, __int64 a2)
{
  ...
  v13 = L"AudioSessionMeterGetPeakValue";
  v14 = v4;
  v15 = 0;
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 232LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetPeakValue", 0x91Fu, v8);
