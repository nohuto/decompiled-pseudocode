/*
 * XREFs of ?IsAppPinningEnabled@CSpatialAudioResourceManager@Sarm@@AEAA_NXZ @ 0x18006D1B8
 * Callers:
...
bool __fastcall Sarm::CSpatialAudioResourceManager::IsAppPinningEnabled(Sarm::CSpatialAudioResourceManager *this)
{
  ...
  if ( (unsigned int)dword_1801CC2B0 > 4 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 4;
    UserData.Ptr = (ULONGLONG)off_1801CC2B8;
    UserData.Size = *(unsigned __int16 *)off_1801CC2B8;
    v6 = &unk_1801A344C;
    UserData.Reserved = 2;
    v7 = 29;
    v8 = 1;
    v3[1] = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EventWriteTransfer(qword_1801CC2D0, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
  }
  return v1;
}
