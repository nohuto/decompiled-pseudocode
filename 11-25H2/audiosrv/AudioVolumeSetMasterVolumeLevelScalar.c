/*
 * XREFs of AudioVolumeSetMasterVolumeLevelScalar @ 0x180048630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeSetMasterVolumeLevelScalar(_QWORD *a1, __int128 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  __int128 v12; // [rsp+78h] [rbp-50h] BYREF
  ...
  pftDueTime.dwLowDateTime = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, __int64))(*(_QWORD *)*a1 + 64LL))(
                               *a1,
                               v8,
                               a4,
                               a5);
