/*
 * XREFs of AudioSessionSetDisplayName @ 0x18006BB00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetDisplayName(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  v15 = L"AudioSessionSetDisplayName";
  v16 = v5;
  v17 = 0;
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v3 + 192LL))(v3, a2, a3);
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionSetDisplayName", 1857, v10);
