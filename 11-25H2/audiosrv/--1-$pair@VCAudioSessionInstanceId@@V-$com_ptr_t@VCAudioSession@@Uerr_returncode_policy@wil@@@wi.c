/*
 * XREFs of ??1?$pair@VCAudioSessionInstanceId@@V?$com_ptr_t@VCAudioSession@@Uerr_returncode_policy@wil@@@wil@@@std@@QEAA@XZ @ 0x1800671D8
 * Callers:
 ...
 *     _CAudioSessionManager::DisconnectAllStreamsOfType_::_1_::dtor$1 @ 0x1801648C1 (_CAudioSessionManager--DisconnectAllStreamsOfType_--_1_--dtor$1.c)
 * Callees:
