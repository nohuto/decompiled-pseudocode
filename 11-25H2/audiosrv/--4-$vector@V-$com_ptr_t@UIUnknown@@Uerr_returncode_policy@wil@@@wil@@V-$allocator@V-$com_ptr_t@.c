/*
 * XREFs of ??4?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAAEAV01@AEBV01@@Z @ 0x1800EEEE0
 * Callers:
 *     ?GetCopyOfResourceTokens@CSaDeviceProxy@@UEAAJAEAV?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@Z @ 0x1800F1580 (-GetCopyOfResourceTokens@CSaDeviceProxy@@UEAAJAEAV-$vector@V-$com_ptr_t@UIUnknown@@Uerr_returnco.c)
