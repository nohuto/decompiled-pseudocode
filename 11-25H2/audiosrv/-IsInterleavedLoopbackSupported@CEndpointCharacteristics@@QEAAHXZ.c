/*
 * XREFs of ?IsInterleavedLoopbackSupported@CEndpointCharacteristics@@QEAAHXZ @ 0x18012D398
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::IsInterleavedLoopbackSupported(CEndpointCharacteristics *this)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( (*(int (__fastcall **)(__int64, GUID *, __int64, _QWORD, __int64 *))(*(_QWORD *)v3 + 24LL))(
         ...
         0LL,
         &v8) >= 0
    && (*(int (__fastcall **)(__int64, GUID *, __int64, __int128 *, int, int *))(*(_QWORD *)v8 + 24LL))(
         v8,
         &v14,
         32LL,
         &v19,
