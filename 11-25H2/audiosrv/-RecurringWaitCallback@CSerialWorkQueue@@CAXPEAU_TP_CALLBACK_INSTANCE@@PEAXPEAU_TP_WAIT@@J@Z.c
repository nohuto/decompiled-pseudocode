/*
 * XREFs of ?RecurringWaitCallback@CSerialWorkQueue@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x1800B4F70
 * Callers:
 *     <none>
 * Callees:
        ...
        TP_WAIT_RESULT WaitResult)
{
  ...
  if ( !(unsigned __int8)std::_Atomic_storage<bool,1>::load(v6 + 80) )
  {
