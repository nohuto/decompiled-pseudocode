/*
 * XREFs of ?PublishAudioEffects@CAudioStream@@AEAAXXZ @ 0x1800C990C
 * Callers:
 *     wistd::__function::__func__lambda_6a6f76b54097c0dbebd0b6d97fee1068__void___cdecl(void)_::operator() @ 0x1800C8F30 (wistd--__function--__func__lambda_6a6f76b54097c0dbebd0b6d97fee1068__void___cdecl(void)_--operato.c)
...
void __fastcall CAudioStream::PublishAudioEffects(CAudioStream *this)
{
  ...
  v9 = 0LL;
  v10 = 0;
  wil::unique_any_array_ptr<unsigned char,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>,wil::empty_deleter>::~unique_any_array_ptr<unsigned char,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>,wil::empty_deleter>((__int64)&v8);
