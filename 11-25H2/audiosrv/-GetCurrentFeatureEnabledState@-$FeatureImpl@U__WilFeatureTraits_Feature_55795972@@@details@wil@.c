/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_55795972@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800D69F8
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v8;
  ...
  v10 = (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_UxLabTest>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_UxLabTest>::GetImpl'::`2'::impl)
     && (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_53100197>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_53100197>::GetImpl'::`2'::impl);
  if ( v12 && !v10 )
    *(_DWORD *)a2 &= ~0x400u;
LABEL_16:
