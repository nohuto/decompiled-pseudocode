/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_719944a900db145257baf03c12c806dc_@@JPEAUIAudioProcessingObject@@U_GUID@@I@std@@EEAAJ$$QEAPEAUIAudioProcessingObject@@$$QEAU_GUID@@$$QEAI@Z @ 0x180081810
 * Callers:
 *     <none>
 * Callees:
        ...
        ...)
{
  ...
  {
    v7 = 0LL;
    v5 = (**v4)(v4, &GUID_4ceb0aab_fa19_48ed_a857_87771ae1b768, (__int64 *)va) >= 0;
  }
  **(_BYTE **)(a1 + 8) = v5;
  if ( v7 )
