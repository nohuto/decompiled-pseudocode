/*
 * XREFs of _lambda_a5b05a19d77442a7b86c350de8e12946_::operator() @ 0x1800B7A24
 * Callers:
...
__int64 __fastcall lambda_a5b05a19d77442a7b86c350de8e12946_::operator()(__int64 a1)
{
  unsigned int v2; // edi
  ...
  const WCHAR *v20; // [rsp+48h] [rbp-8h] BYREF
