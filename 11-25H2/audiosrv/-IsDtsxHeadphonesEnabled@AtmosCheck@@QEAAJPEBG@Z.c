/*
 * XREFs of ?IsDtsxHeadphonesEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x180148494
 * Callers:
 *     ?GetDeepLink@CSpatialAudioDtsxHeadphones@@UEBAPEBGPEBG@Z @ 0x180084BB0 (-GetDeepLink@CSpatialAudioDtsxHeadphones@@UEBAPEBGPEBG@Z.c)
 *     ?GetTechnologyLicenseResult@CSpatialAudioDtsxHeadphones@@UEBAJPEBG@Z @ 0x180139220 (-GetTechnologyLicenseResult@CSpatialAudioDtsxHeadphones@@UEBAJPEBG@Z.c)
 * Callees:
...
__int64 __fastcall AtmosCheck::IsDtsxHeadphonesEnabled(AtmosCheck *this, const unsigned __int16 *a2)
{
