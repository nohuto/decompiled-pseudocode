/*
 * XREFs of ?FinalRelease@CServerAudioSessionControl@@UEAAXXZ @ 0x18005CD60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CServerAudioSessionControl::FinalRelease(CServerAudioSessionControl *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_ab1375f163c73c4b99e57586ff560771_Traceguids);
  }
