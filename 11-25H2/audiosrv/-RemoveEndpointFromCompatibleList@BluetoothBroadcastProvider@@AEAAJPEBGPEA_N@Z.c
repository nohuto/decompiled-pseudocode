/*
 * XREFs of ?RemoveEndpointFromCompatibleList@BluetoothBroadcastProvider@@AEAAJPEBGPEA_N@Z @ 0x1800E2574
 * Callers:
 ...
 *     _lambda_fb275ec9643d98a144c45029792f42ff_::operator() @ 0x1800E0528 (_lambda_fb275ec9643d98a144c45029792f42ff_--operator().c)
        ...
        bool *a3)
{
  ...
  v12 = a2;
  v11 = a2;
  while ( v8 != v7 && !lambda_fb275ec9643d98a144c45029792f42ff_::operator()((__int64)&v11, v8) )
    ++v8;
  if ( v8 != v7 )
  {
    for ( i = v8 + 1; i != v7; ++i )
    {
      if ( !lambda_fb275ec9643d98a144c45029792f42ff_::operator()((__int64)&v12, i) )
