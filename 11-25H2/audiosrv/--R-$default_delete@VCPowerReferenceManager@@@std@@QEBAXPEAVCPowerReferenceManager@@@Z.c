/*
 * XREFs of ??R?$default_delete@VCPowerReferenceManager@@@std@@QEBAXPEAVCPowerReferenceManager@@@Z @ 0x1800CC56C
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__g_powerReferenceManager___0 @ 0x180169DF0 (_dynamic_atexit_destructor_for__g_powerReferenceManager___0.c)
 * Callees:
