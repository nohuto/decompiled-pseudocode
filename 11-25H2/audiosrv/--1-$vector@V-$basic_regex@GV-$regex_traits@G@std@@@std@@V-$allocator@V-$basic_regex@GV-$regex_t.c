/*
 * XREFs of ??1?$vector@V?$basic_regex@GV?$regex_traits@G@std@@@std@@V?$allocator@V?$basic_regex@GV?$regex_traits@G@std@@@std@@@2@@std@@QEAA@XZ @ 0x18013B808
 * Callers:
 *     _EffectPackConfiguration::EffectPackConfiguration_::_1_::dtor$6 @ 0x1801688B4 (_EffectPackConfiguration--EffectPackConfiguration_--_1_--dtor$6.c)
 * Callees:
