/*
 * XREFs of ??$make_wnf_subscription_state@W4ShellState@Holographic@Shell@Internal@Windows@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBW4ShellState@Holographic@Shell@Internal@Windows@@@Z@wistd@@KPEAPEAU?$wnf_subscription_state@W4ShellState@Holographic@Shell@Internal@Windows@@@01@@Z @ 0x180142D50
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  unsigned int v9; // ebx
  int v10; // ebx
  void (__fastcall ***v12)(_QWORD, _QWORD); // [rsp+40h] [rbp-28h] BYREF
  ...
  *v6 = &wil::details::wnf_subscription_state<enum Microsoft::Bluetooth::Audio::Internal::BluetoothLEAudioSupportedState>::`vftable';
  ...
  if ( v16 != -1 )
    goto LABEL_11;
  v9 = NtQueryWnfStateData(&WNF_HOLO_SHELL_STATE_INTERACTIVE_USER, 0LL, 0LL, &v16) | 0x10000000;
