 ...
 *     ??1?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800A5BC4 (--1-$_Alloc_construct_ptr@V-$allocator@U-$_List_node@U-$pair@$$CBU_GUID@@W4ValidEffectPackConfig.c)
        ...
        unsigned int *a3)
{
  ...
  {
    if ( qword_1801D0DB0 == 0x666666666666666LL )
      std::_Xlength_error("unordered_map/set too long");
    v17[0] = &qword_1801D0DA8;
    ...
    std::_Default_allocator_traits<std::allocator<CProcessingModeParameters::AudioEffectState>>::construct<CProcessingModeParameters::AudioEffectState,CProcessingModeParameters::AudioEffectState const &>(
      ...
      (__int64)(v7 + 2),
      (__int64)a3);
    v9 = qword_1801D0DB0 + 1;
    if ( qword_1801D0DB0 + 1 < 0 )
      v10 = (float)(int)(v9 & 1 | (v9 >> 1)) + (float)(int)(v9 & 1 | (v9 >> 1));
    else
      v10 = (float)(int)v9;
    v11 = qword_1801D0DD8;
    if ( qword_1801D0DD8 < 0 )
    {
      v11 = qword_1801D0DD8 & 1;
      v12 = (float)(int)(v11 | ((unsigned __int64)qword_1801D0DD8 >> 1))
          + (float)(int)(v11 | ((unsigned __int64)qword_1801D0DD8 >> 1));
    }
    else
    {
      v12 = (float)(int)qword_1801D0DD8;
    }
    if ( (float)(v10 / v12) > *(float *)&dword_1801D0DA0 )
    {
