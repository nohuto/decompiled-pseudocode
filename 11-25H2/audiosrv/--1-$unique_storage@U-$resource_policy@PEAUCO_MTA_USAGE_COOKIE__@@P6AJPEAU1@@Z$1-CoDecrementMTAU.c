/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAUCO_MTA_USAGE_COOKIE__@@P6AJPEAU1@@Z$1?CoDecrementMTAUsage@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1800CC250
 * Callers:
 *     ??1ServiceModuleBase@Internal@Windows@@QEAA@XZ @ 0x1800CC4B4 (--1ServiceModuleBase@Internal@Windows@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
