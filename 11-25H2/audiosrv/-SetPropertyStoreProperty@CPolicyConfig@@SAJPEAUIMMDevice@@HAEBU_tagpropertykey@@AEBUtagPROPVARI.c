/*
 * XREFs of ?SetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x180065BD4
 * Callers:
...
LABEL_14:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyStoreProperty", 2066, v6);
LABEL_9:
  if ( v9 )
