/*
 * XREFs of ?StringCchPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGZZ @ 0x180043160
 * Callers:
 ...
 *     StringExValidateDestW @ 0x18012F7EC (StringExValidateDestW.c)
 *     StringExValidateSrcW @ 0x18012F82C (StringExValidateSrcW.c)
