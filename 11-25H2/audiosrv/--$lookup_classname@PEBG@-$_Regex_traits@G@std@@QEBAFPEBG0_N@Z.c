/*
 * XREFs of ??$lookup_classname@PEBG@?$_Regex_traits@G@std@@QEBAFPEBG0_N@Z @ 0x18013ACE8
 * Callers:
 ...
 * Callees:
 *     ??$equal@PEBGPEBGU?$_Cmp_icase@V?$_Regex_traits@G@std@@@std@@@std@@YA_NQEBG00U?$_Cmp_icase@V?$_Regex_traits@G@std@@@0@@Z @ 0x18013AC58 (--$equal@PEBGPEBGU-$_Cmp_icase@V-$_Regex_traits@G@std@@@std@@@std@@YA_NQEBG00U-$_Cmp_icase@V-$_R.c)
 */
