/*
 * XREFs of AudioSessionGetMute @ 0x180012AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetMute(__int64 *a1, __int64 a2)
{
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 304LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetMute", 0x829u, v8);
