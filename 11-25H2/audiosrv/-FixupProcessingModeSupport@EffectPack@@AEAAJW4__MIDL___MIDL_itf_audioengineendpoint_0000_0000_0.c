/*
 * XREFs of ?FixupProcessingModeSupport@EffectPack@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18003CD24
 * Callers:
...
LABEL_34:
      ...
      v40 = (SystemEffectDescriptor *)gsl::span<SystemEffectDescriptor,-1>::operator[]((char *)this + 1456, v6);
      ...
      if ( v41 >= 0 )
      {
        v43 = (SystemEffectDescriptor *)gsl::span<SystemEffectDescriptor,-1>::operator[]((char *)this + 1472, v6);
        v41 = SystemEffectDescriptor::SetDefaultEffectChain(
                v43,
...
LABEL_61:
          ...
          if ( *(int *)v56.Data4 > 0 )
          {
            v49 = gsl::span<SystemEffectDescriptor,-1>::operator[]((char *)this + 1456, v6);
            v58 = 0LL;
...
LABEL_68:
    ...
    __debugbreak();
    JUMPOUT(0x18003D2DALL);
  }
  if ( (_DWORD)a2 != 3
    && EffectPackConfiguration::AposRegisteredAsLfxGfx(*((EffectPackConfiguration **)this + 196))
    && !v8 )
  {
    v9 = (SystemEffectDescriptor *)gsl::span<SystemEffectDescriptor,-1>::operator[]((char *)this + 1440, v4);
    v10 = *((_QWORD *)this + 196);
...
LABEL_8:
    ...
    v14 = (SystemEffectDescriptor *)gsl::span<SystemEffectDescriptor,-1>::operator[]((char *)this + 1456, v6);
    v15 = *((_QWORD *)this + 196);
    v56 = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
    v11 = SystemEffectDescriptor::SetDefaultEffectChain(
            v14,
