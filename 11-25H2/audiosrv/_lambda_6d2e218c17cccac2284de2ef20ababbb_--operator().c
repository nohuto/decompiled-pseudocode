/*
 * XREFs of _lambda_6d2e218c17cccac2284de2ef20ababbb_::operator() @ 0x1800EF054
 * Callers:
...
struct AudioSrvTelemetryProvider *__fastcall lambda_6d2e218c17cccac2284de2ef20ababbb_::operator()(__int64 a1)
{
