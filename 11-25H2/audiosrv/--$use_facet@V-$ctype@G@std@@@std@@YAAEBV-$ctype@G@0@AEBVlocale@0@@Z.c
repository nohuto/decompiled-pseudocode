/*
 * XREFs of ??$use_facet@V?$ctype@G@std@@@std@@YAAEBV?$ctype@G@0@AEBVlocale@0@@Z @ 0x18013B278
 * Callers:
 ...
 *     ?_Facet_Register@std@@YAXPEAV_Facet_base@1@@Z @ 0x1800A764C (-_Facet_Register@std@@YAXPEAV_Facet_base@1@@Z.c)
 *     ?_Getfacet@locale@std@@QEBAPEBVfacet@12@_K@Z @ 0x18013FF4C (-_Getfacet@locale@std@@QEBAPEBVfacet@12@_K@Z.c)
