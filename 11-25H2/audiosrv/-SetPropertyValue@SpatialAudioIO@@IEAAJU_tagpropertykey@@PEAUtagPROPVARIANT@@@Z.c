/*
 * XREFs of ?SetPropertyValue@SpatialAudioIO@@IEAAJU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x1801245BC
 * Callers:
 *     ?Store@SpatialAudioStateIO@@IEAAJXZ @ 0x18012460C (-Store@SpatialAudioStateIO@@IEAAJXZ.c)
 *     ?SignalChange@SpatialAudioDeviceStateWriter@@UEAAJXZ @ 0x18015D5D0 (-SignalChange@SpatialAudioDeviceStateWriter@@UEAAJXZ.c)
 * Callees:
