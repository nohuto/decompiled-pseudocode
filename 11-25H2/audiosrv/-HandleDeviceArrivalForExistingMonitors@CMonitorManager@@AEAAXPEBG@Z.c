/*
 * XREFs of ?HandleDeviceArrivalForExistingMonitors@CMonitorManager@@AEAAXPEBG@Z @ 0x18002E7E4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  while ( v10 )
  {
    ...
    if ( CMonitorManager::CaptureMonitor::IsConnectedTo(v9, a2) )
    {
      ...
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 77LL, &WPP_2686b636a530381dd1b5bdfbdd777686_Traceguids);
      }
