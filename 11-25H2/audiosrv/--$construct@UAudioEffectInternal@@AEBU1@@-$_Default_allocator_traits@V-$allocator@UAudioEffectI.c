/*
 * XREFs of ??$construct@UAudioEffectInternal@@AEBU1@@?$_Default_allocator_traits@V?$allocator@UAudioEffectInternal@@@std@@@std@@SAXAEAV?$allocator@UAudioEffectInternal@@@1@QEAUAudioEffectInternal@@AEBU3@@Z @ 0x180022D30
 * Callers:
