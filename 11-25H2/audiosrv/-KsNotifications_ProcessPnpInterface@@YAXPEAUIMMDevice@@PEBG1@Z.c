/*
 * XREFs of ?KsNotifications_ProcessPnpInterface@@YAXPEAUIMMDevice@@PEBG1@Z @ 0x18008E130
 * Callers:
 ...
 *     ?GetNext@?$TList@VCKsNotificationsMonitor@@@@QEBAHAEAPEAXPEAPEAVCKsNotificationsMonitor@@@Z @ 0x180074F0C (-GetNext@-$TList@VCKsNotificationsMonitor@@@@QEBAHAEAPEAXPEAPEAVCKsNotificationsMonitor@@@Z.c)
 ...
 *     ?AddTail@?$TList@VCKsNotificationsMonitor@@@@QEAAPEAXPEAVCKsNotificationsMonitor@@@Z @ 0x180116764 (-AddTail@-$TList@VCKsNotificationsMonitor@@@@QEAAPEAXPEAVCKsNotificationsMonitor@@@Z.c)
