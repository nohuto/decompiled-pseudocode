/*
 * XREFs of ?DeriveConnectorFormatFromStreamFormat@@YAJPEAUEndpointCharacteristicsDescriptor@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@33HPEAPEAU3@@Z @ 0x18003366C
 * Callers:
        ...
        struct tWAVEFORMATEX **pAudioFormat)
{
  ...
  *pAudioFormat = 0LL;
  ...
  if ( v14 )
  {
    ...
    v43 = *a4;
    v16 = -2004287480;
    if ( (int)EffectPack::GetMixFormat(a1[1], a2, &v43, &v44) < 0 )
    {
    ...
    else
    {
      ...
      {
        v43 = *a6;
        if ( (int)GetDeviceDefaults((CEndpointCharacteristics ***)a1, a2, &v43, v12, 0LL, 0LL, 0LL) < 0 )
        {
          wil::details::in1diag3::Return_Hr(
            retaddr,
            (void *)0x295,
...
LABEL_25:
      ...
      v43 = *v19;
      if ( EffectPack::DeriveMixFormatFromDevicePipeFormat(
             a1[1],
             &v43,
             a2,
      ...
      if ( (unsigned int)IsStreamFormatSupportedForMixFormat(
                           ...
                           a2,
                           v29,
                           (const struct tWAVEFORMATEX *)v49,
                           0LL) )
      {
        v26 = 688LL;
        goto LABEL_22;
        ...
        *(_QWORD *)&v43.Data1 = 0LL;
        if ( (int)CloneWaveFormat((const struct tWAVEFORMATEX *)ppIAudioMediaType, (struct tWAVEFORMATEX **)&v43) >= 0 )
        {
          ...
          *(_DWORD *)(*(_QWORD *)&v43.Data1 + 4LL) = v35;
          ...
          v42 = *a6;
          if ( ConnectorSupportsFormat((struct EndpointCharacteristicsDescriptor *)a1, a2, v36, &v42) < 0 )
          {
            wil::details::in1diag3::Return_Hr(
              retaddr,
              (void *)0x2CA,
          ...
          else
          {
            ...
            *(_QWORD *)&v42.Data1 = 0LL;
            ...
            {
              v46 = *a5;
              if ( (int)EffectPack::DeriveDevicePipeFormatFromConnectorFormat(a1[1], &v46, a2, v49, &v40) >= 0 )
              {
                v46 = *a5;
                if ( EffectPack::DeriveMixFormatFromDevicePipeFormat(
                       a1[1],
