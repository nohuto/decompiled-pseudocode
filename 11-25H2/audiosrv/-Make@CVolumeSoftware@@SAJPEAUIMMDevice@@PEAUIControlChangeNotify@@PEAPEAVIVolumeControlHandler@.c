/*
 * XREFs of ?Make@CVolumeSoftware@@SAJPEAUIMMDevice@@PEAUIControlChangeNotify@@PEAPEAVIVolumeControlHandler@@@Z @ 0x18010CE88
 * Callers:
        ...
        struct IVolumeControlHandler **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *((_QWORD *)v7 + 38) = 0LL;
    v12 = v7;
    v8 = (*(__int64 (__fastcall **)(CVolumeControlBase *, struct IMMDevice *))(*(_QWORD *)v7 + 224LL))(v7, a1);
    v9 = v8;
    if ( v8 >= 0 )
    {
      *a3 = v12;
