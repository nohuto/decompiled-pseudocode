/*
 * XREFs of ?IsExclusiveModeSession@CAudioSession@@QEAAHXZ @ 0x1800C367C
 * Callers:
...
__int64 __fastcall CAudioSession::IsExclusiveModeSession(CAudioSession *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x59u, (__int64)&WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, 0LL);
  }
