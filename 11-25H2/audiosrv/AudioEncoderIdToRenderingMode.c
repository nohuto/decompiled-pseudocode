/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x180124330
 * Callers:
 ...
 *     ?GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x180121570 (-GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z.c)
 * Callees:
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 )
                {
                  ...
                  if ( v13 && (unsigned int)dword_1801CC2E8 > 2 )
                  {
                    v15 = -2147418113;
