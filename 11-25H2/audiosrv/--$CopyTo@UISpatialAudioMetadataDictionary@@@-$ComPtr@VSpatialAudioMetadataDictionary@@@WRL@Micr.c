/*
 * XREFs of ??$CopyTo@UISpatialAudioMetadataDictionary@@@?$ComPtr@VSpatialAudioMetadataDictionary@@@WRL@Microsoft@@QEBAJPEAPEAUISpatialAudioMetadataDictionary@@@Z @ 0x180124708
 * Callers:
