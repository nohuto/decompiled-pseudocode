/*
 * XREFs of ?ProviderFinalRelease@CVolumeStrip@@UEAAXXZ @ 0x18010E670
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::ProviderFinalRelease(unsigned __int64 this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_ffca69456fc43fc517c726147dcc355b_Traceguids);
  }
  v2 = *(_QWORD *)(this + 160);
  if ( v2 )
