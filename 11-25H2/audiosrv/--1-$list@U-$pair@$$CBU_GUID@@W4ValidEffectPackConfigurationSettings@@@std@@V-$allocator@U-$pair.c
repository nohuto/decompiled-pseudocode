/*
 * XREFs of ??1?$list@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@2@@std@@QEAA@XZ @ 0x1800A3C34
 * Callers:
 *     __dynamic_initializer_for__s_validSettingsForSchema___::_1_::dtor$1 @ 0x1801688DF (__dynamic_initializer_for__s_validSettingsForSchema___--_1_--dtor$1.c)
 * Callees:
