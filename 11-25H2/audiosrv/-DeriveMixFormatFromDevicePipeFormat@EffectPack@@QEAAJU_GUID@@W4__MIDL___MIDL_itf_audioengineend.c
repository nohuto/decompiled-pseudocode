/*
 * XREFs of ?DeriveMixFormatFromDevicePipeFormat@EffectPack@@QEAAJU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUIAudioMediaType@@PEAPEAU4@3@Z @ 0x1800497EC
 * Callers:
        ...
        struct IAudioMediaType **a6)
{
  ...
  v11 = 0LL;
  v32 = 0LL;
  if ( !(unsigned int)EffectPack::EndpointConnectorSupportsProcessingModes(this, (unsigned int)a3) )
  {
  ...
  v31 = 0LL;
  v35 = *a2;
  ModeEffect = EffectPack::GetModeEffect(this, &v35, 0, a3, 0LL, &v31, 0LL);
  v13 = ModeEffect;
  if ( ModeEffect >= 0 )
  {
    v14 = v31;
