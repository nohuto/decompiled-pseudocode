/*
 * XREFs of ?push_back@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAXG@Z @ 0x180131BD0
 * Callers:
...
const void **__fastcall std::wstring::push_back(__int64 a1, __int64 a2)
{
  ...
  if ( v2 >= *(_QWORD *)(a1 + 24) )
    return std::wstring::_Reallocate_grow_by<_lambda_3fdb14453883e86a37ebade6a7a0ebb0_,unsigned short>(
             ...
             a2);
  *(_QWORD *)(a1 + 16) = v2 + 1;
  result = (const void **)std::_String_val<std::_Simple_types<unsigned short>>::_Myptr(a1);
  *((_WORD *)result + v5) = v4;
  *((_WORD *)result + v5 + 1) = 0;
  return result;
}
