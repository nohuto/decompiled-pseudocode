/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_8e14c3ef8ca8112e9c42aed54b541fda___ @ 0x180125F1C
 * Callers:
      ...
      if ( !v9 && *a3 > 0x40 )
      {
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            {
              v16 = 0;
              lambda_5789e60fd85b99cd3c89d9f341e01d71_::operator()(a2, &v12->wFormatTag, &v16);
              if ( v16 )
