/*
 * XREFs of AudioSessionGetGroupingParam @ 0x180076370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetGroupingParam(__int64 *a1, __int64 a2)
{
  ...
  v13 = L"AudioSessionGetGroupingParam";
  v14 = v4;
  v15 = 0;
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 216LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetGroupingParam", 1958, v8);
