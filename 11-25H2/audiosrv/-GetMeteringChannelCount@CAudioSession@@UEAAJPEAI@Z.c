/*
 * XREFs of ?GetMeteringChannelCount@CAudioSession@@UEAAJPEAI@Z @ 0x18007D790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetMeteringChannelCount(CAudioSession *this, unsigned int *a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids);
  }
  v4 = 0;
  v5 = 0;
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 29LL, &WPP_6681b08aa41435022487e8d1ae4eb6cc_Traceguids, v5);
    }
    *a2 = v5;
  }
  else
