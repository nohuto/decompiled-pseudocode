/*
 * XREFs of HUBDESC_ValidateMSOSExtendedConfigDescriptorHeader @ 0x14003E044
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSExtendedConfigDescriptorHeader(int *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != 16 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x114u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, a2, 16);
...
LABEL_5:
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x115u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v9, 256);
    v10 = (void (__fastcall **)(_QWORD, __int64))(a3 + 24);
    v11 = (_QWORD *)(a3 + 40);
  ...
  if ( *((_WORD *)v6 + 3) != 4 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x116u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v15, v16);
  ...
  if ( (_BYTE)v13 != 1 )
  {
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_(a4, v12, 5, 279, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
      v10 = v17;
      v11 = v18;
    }
    (*v10)(*v11, 121LL);
  ...
  else
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LODWORD(v15) = *v6;
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x118u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v15, v16);
    }
    (*v17)(*v18, 127LL);
  }
LABEL_24:
  ...
  {
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_(a4, v8, 5, 281, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v7;
}
