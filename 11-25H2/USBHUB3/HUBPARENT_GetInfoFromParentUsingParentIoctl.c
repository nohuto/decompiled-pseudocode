/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x14000761C
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x140008F00 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
...
LABEL_8:
    ...
    return HUBSM_AddEvent(a1 + 1272, 2038LL);
  }
  v16[1] = a1 + 2456;
  LOBYTE(v16[0]) = 15;
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *))(WdfFunctions_01015 + 2016))(
    ...
    v10,
    v16);
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64 (__fastcall *)(), _QWORD))(WdfFunctions_01015 + 2080))(
    WdfDriverGlobals,
    v10,
