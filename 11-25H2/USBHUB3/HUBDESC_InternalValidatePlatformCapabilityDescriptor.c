/*
 * XREFs of HUBDESC_InternalValidatePlatformCapabilityDescriptor @ 0x1400396A0
 * Callers:
...
LABEL_9:
    if ( *v6 > v12 )
    {
      ...
      {
        LODWORD(v27) = v11;
        WPP_RECORDER_SF_d(v9, 2u, 5u, 0x90u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
      }
      v14 = 253LL;
      goto LABEL_16;
    }
    if ( v8[3] )
    {
      ...
      {
        LODWORD(v27) = v8[3];
        WPP_RECORDER_SF_d(v9, 2u, 5u, 0x91u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
      }
    ...
    if ( *(_QWORD *)(v8 + 4) == *(_QWORD *)&GUID_NULL.Data1 && *(_QWORD *)(v8 + 12) == *(_QWORD *)GUID_NULL.Data4 )
    {
      *v5 = 1;
      ...
      {
        LOBYTE(a2) = 2;
        WPP_RECORDER_SF_(v9, a2, 5, 146, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
      }
      v14 = 196LL;
      goto LABEL_16;
    }
      ...
      && *(_QWORD *)(v8 + 12) == *(_QWORD *)GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID.Data4 )
    {
      if ( *(_QWORD *)(*(_QWORD *)(v7 + 80) + 48LL) )
      {
        *v5 = 1;
        ...
        {
          LOBYTE(a2) = 2;
          WPP_RECORDER_SF_(v9, a2, 5, 147, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
        v14 = 197LL;
        goto LABEL_16;
      }
...
LABEL_40:
        LODWORD(v27) = *v8;
        WPP_RECORDER_SF_d(v9, 2u, 5u, v15, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
        goto LABEL_41;
      }
      v16 = *v8;
      if ( ((*v8 - 4) & 7) != 0 )
            ...
            if ( *(_DWORD *)v22 == *(_DWORD *)v28 )
            {
              ...
              *(_QWORD *)(*(_QWORD *)(v7 + 80) + 48LL) = 0LL;
              if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              {
                ...
                WPP_RECORDER_SF_d(v9, 2u, 5u, 0x96u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
              }
...
LABEL_62:
        ...
        {
          LOBYTE(a2) = 2;
          WPP_RECORDER_SF_(v9, a2, 5, 151, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
           ...
           && *(_QWORD *)(v8 + 12) == *(_QWORD *)GUID_USB_PLATFORM_FEATURES.Data4 )
    {
      if ( *v8 >= 0x1Au )
      {
        if ( v8[20] == 1 )
        {
          if ( *v8 != 26 )
          {
            *v5 = 1;
            ...
            {
              LODWORD(v27) = *v8;
              WPP_RECORDER_SF_d(v9, 2u, 5u, 0x99u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
            }
            v14 = 247LL;
            goto LABEL_16;
          }
        ...
        else if ( !v8[20] )
        {
          *v5 = 1;
          ...
          {
            LODWORD(v27) = v8[20];
            WPP_RECORDER_SF_d(v9, 2u, 5u, 0x9Au, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
          }
          v14 = 249LL;
          goto LABEL_16;
        }
        ...
        *v5 = 1;
        ...
        {
          LOBYTE(a2) = 2;
          WPP_RECORDER_SF_(v9, a2, 5, 155, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
        v14 = 248LL;
        goto LABEL_16;
      }
      *v5 = 1;
      ...
      {
        LODWORD(v27) = *v8;
        WPP_RECORDER_SF_d(v9, 2u, 5u, 0x98u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v27);
      }
      v14 = 250LL;
LABEL_16:
...
LABEL_85:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v9, 2u, v13, 0x8Fu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v11, *v8, 20);
    goto LABEL_85;
  }
LABEL_86:
  v10 = 0;
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(v9, a2, 5, 156, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v10;
}
