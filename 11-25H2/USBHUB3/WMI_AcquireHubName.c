/*
 * XREFs of WMI_AcquireHubName @ 0x14008F94C
 * Callers:
...
__int64 __fastcall WMI_AcquireHubName(__int64 a1, unsigned int a2, _DWORD *a3, __int64 a4)
{
  ...
  *a3 = 0;
  ...
  if ( a2 < 0xA || (v7 = *(unsigned int *)(a4 + 4), (unsigned int)v7 < 0xA) || (unsigned int)v7 > a2 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), a2, 3, 10, (__int64)&WPP_9d9b99bdbcfa37b3732b5a7eb5557008_Traceguids);
    }
  ...
  {
    v8 = v7 - 8;
    v9 = HUBMISC_StripSymbolicNamePrefix((unsigned __int16 *)(a1 + 2552), &v13);
