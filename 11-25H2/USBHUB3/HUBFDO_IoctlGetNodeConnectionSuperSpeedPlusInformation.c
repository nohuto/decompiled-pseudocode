/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionSuperSpeedPlusInformation @ 0x14007E900
 * Callers:
 ...
 *     HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher @ 0x140030C24 (HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher.c)
