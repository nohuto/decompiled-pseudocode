/*
 * XREFs of HUBMUX_AckStopAfterSuspend @ 0x140010650
 * Callers:
 *     HUBDSM_AckingStopAfterSuspendOnDetach @ 0x14001F860 (HUBDSM_AckingStopAfterSuspendOnDetach.c)
 * Callees:
