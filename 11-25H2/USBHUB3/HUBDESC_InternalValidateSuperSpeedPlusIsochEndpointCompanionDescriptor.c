/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusIsochEndpointCompanionDescriptor @ 0x14003BBE4
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v13;
  if ( !v12 || !*(_DWORD *)(a2 + 16) )
  {
    ...
    {
      v24 = v11;
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x61u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v24);
    }
...
LABEL_48:
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDDD(v10, 2u, 5u, 0x63u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  if ( *a1 > 8u )
  {
    if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationMutable(v8) )
      *a4 = 2;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDD(v10, 2u, v16, 0x64u, v17);
    (*(void (__fastcall **)(_QWORD, __int64))(v8 + 24))(*(_QWORD *)(v8 + 40), 207LL);
  }
  v18 = *(_DWORD *)(v8 + 256);
  if ( (v18 & 8) != 0 )
  {
    *(_DWORD *)(v8 + 256) = v18 & 0xFFFFFFD7 | 0x20;
    if ( *a3 <= v27 )
    {
      if ( *((_WORD *)a1 + 1) )
      {
        if ( *(_BYTE *)(v8 + 15) )
          *a4 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x67u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    ...
    else
    {
      ...
      {
        v23 = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x66u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v23);
      }
      v19 = 209LL;
    }
  ...
  {
    v22 = v11;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x65u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v22);
  }
...
LABEL_49:
  ...
  {
    LOBYTE(a2) = 2;
    return WPP_RECORDER_SF_(v10, a2, 5, 105, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return result;
}
