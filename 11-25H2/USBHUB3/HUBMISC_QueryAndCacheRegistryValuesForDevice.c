/*
 * XREFs of HUBMISC_QueryAndCacheRegistryValuesForDevice @ 0x140086FD8
 * Callers:
 *     HUBDSM_QueryingRegistryValuesForDevice @ 0x1400236A0 (HUBDSM_QueryingRegistryValuesForDevice.c)
 * Callees:
 *     McTemplateK0pq_EtwWriteTransfer @ 0x140001FE8 (McTemplateK0pq_EtwWriteTransfer.c)
 *     HUBMISC_ConvertUsbDeviceIdsToString @ 0x14002EEB0 (HUBMISC_ConvertUsbDeviceIdsToString.c)
