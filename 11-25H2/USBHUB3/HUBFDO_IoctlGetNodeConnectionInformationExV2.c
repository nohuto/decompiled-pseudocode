/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInformationExV2 @ 0x14007E100
 * Callers:
 ...
 *     HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher @ 0x140030CE4 (HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher.c)
        ...
        if ( (v11 & 4) != 0 )
        {
          ...
          *((_DWORD *)v31 + 1) = 16;
          (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 2200))(
            ...
            a2,
            16LL);
          for ( i = *(_QWORD **)(v9 + 2368); ; i = (_QWORD *)*i )
          {
            v13 = i - 31;
            if ( (_QWORD *)(v9 + 2368) == i )
              break;
            if ( *((_WORD *)v13 + 100) == (_WORD)v7 )
            {
              ...
              {
                *((_DWORD *)v31 + 2) |= 1u;
                if ( *(_DWORD *)(v9 + 256) == 2 || *(_DWORD *)(v9 + 2224) == 4 )
                  *((_DWORD *)v31 + 2) |= 2u;
              }
              else if ( v18 == 768 )
              {
