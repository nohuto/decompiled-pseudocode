/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpPnPPowerPreprocess @ 0x140016670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HUBREG_UpdateSqmEnumerationFailureCode @ 0x14008C914 (HUBREG_UpdateSqmEnumerationFailureCode.c)
 */
  ...
  if ( MinorFunction > 0xC )
  {
    ...
    if ( v15 )
    {
      if ( v15 == 2 )
      {
        ...
        {
          HUBPDO_CleanupIsTunneledUsb4DeviceProperty(v17);
          if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v17 + 24) + 8LL) + 204LL) & 0x800) != 0 )
            HUBPDO_AssignIsTunneledUsb4DeviceProperty(v17);
        }
