/*
 * XREFs of HUBPDO_EvtWorkItemDripsWatchDogCallback @ 0x140083DC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HUBPDO_EvtWorkItemDripsWatchDogCallback(__int64 a1)
{
  ...
  if ( (v6 & 2) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v7 = *(_QWORD *)(v5 + 8);
      LOBYTE(v5) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v7 + 1432), v5, 2, 178, (__int64)&WPP_31a10eb015d93b042fda7856b1df3354_Traceguids);
    }
    v8 = 1;
    goto LABEL_37;
  }
...
LABEL_37:
  ...
  {
    v21 = *(_QWORD *)(v4 + 24);
    LODWORD(v29) = *(unsigned __int16 *)(v21 + 2000);
    LODWORD(v28) = *(unsigned __int16 *)(v21 + 1998);
    LODWORD(v27) = *(unsigned __int16 *)(v21 + 1996);
    WPP_RECORDER_SF_DDDLd(
      *(_QWORD *)(*(_QWORD *)(v21 + 8) + 1432LL),
      v1,
      *(unsigned __int16 *)(v21 + 2000),
      *(unsigned __int16 *)(v21 + 1998),
      (int)Handle);
  }
LABEL_39:
  ...
  if ( v8 != 1 )
  {
    ...
    v24 = *(_QWORD *)(v4 + 24);
    LOWORD(v29) = *(_WORD *)(v24 + 2000);
    LOWORD(v28) = *(_WORD *)(v24 + 1998);
    LOWORD(v27) = *(_WORD *)(v24 + 1996);
    LODWORD(Handle) = v8;
    McTemplateK0pqhhh_EtwWriteTransfer(
      v6,
      v23,
