/*
 * XREFs of HUBPARENT_SetHubConfigurationComplete @ 0x140008640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPARENT_SetHubConfigurationComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v9 < 0 )
    goto LABEL_9;
  *(_QWORD *)(v8 + 1112) = *(_QWORD *)(a4 + 72);
  *(_QWORD *)(v8 + 80) = *(_QWORD *)(a4 + 32);
  v12 = *(unsigned __int16 *)(a4 + 64);
  *(_WORD *)(v11 + 88) = v12;
  if ( *(_WORD *)(v11 + 2466) >= 0x300u )
  {
    if ( v12 <= 2 )
    {
      if ( v12 == 2 )
...
LABEL_11:
  ...
  return HUBSM_AddEvent(v11 + 1272, ((v9 >> 31) & 0xFFFFFFFC) + 2010);
}
