/*
 * XREFs of HUBUCX_DeleteDeviceFromUCX @ 0x140026A4C
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend @ 0x140021B60 (HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend.c)
 * Callees:
