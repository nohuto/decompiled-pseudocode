/*
 * XREFs of HUBDESC_Validate20HubDescriptor @ 0x14003C5C4
 * Callers:
...
char __fastcall HUBDESC_Validate20HubDescriptor(unsigned __int8 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( a1 )
  {
    if ( !a1[2] )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(a4, 2u, 5u, 0x12Bu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, 0);
    ...
    if ( *a1 < v9 )
    {
      ...
      {
        LODWORD(v16) = *a1;
        WPP_RECORDER_SF_dD(v5, 2u, 5u, 0x12Cu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v16, v9);
      }
    ...
    if ( *a1 > v18 + v19 + 7 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LODWORD(v16) = *a1;
        WPP_RECORDER_SF_dD(v5, 2u, 5u, 0x12Du, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v16, v17);
      }
    ...
    if ( a1[1] != 41 )
    {
      ...
      {
        LODWORD(v16) = a1[1];
        WPP_RECORDER_SF_d(v5, 2u, 5u, 0x12Eu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v16);
      }
    ...
    if ( (v10 & 2) != 0 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(a4, 2u, 5u, 0x12Fu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v16);
      }
    ...
    if ( (v10 & 0xFF00) != 0 )
    {
      ...
      {
        LODWORD(v16) = v10;
        WPP_RECORDER_SF_d(a4, 2u, 5u, 0x130u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v16);
      }
      (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 9LL);
    }
    if ( (a1[7] & 1) != 0 )
    {
      if ( *(_BYTE *)(a3 + 15) )
        v4 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(a4, 2, 5, 305, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    ...
    if ( v12 != 0xFF && (v12 & a1[v19 + 6]) != 0 )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
        v4 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(a4, 2, 5, 306, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    ...
    for ( i = 0; i < v18; ++i )
    {
      if ( a1[i + 7 + v11] != 0xFF )
      {
        if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
          v4 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(a4, 2, 5, 307, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(a4, 2, 5, 297, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 2LL);
  }
  v14 = 0;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(v5, 2, 5, 308, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  return v14;
}
