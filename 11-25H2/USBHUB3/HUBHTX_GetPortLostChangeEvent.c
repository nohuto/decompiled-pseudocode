 ...
 * Callers:
 *     HUBPSM20_GettingPortLostChangesOnStart @ 0x1400129E0 (HUBPSM20_GettingPortLostChangesOnStart.c)
 * Callees:
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dDDD(
        *((_QWORD *)v5 + 179),
        ...
        v4,
        v7);
    if ( (*(_DWORD *)(*(_QWORD *)v5 + 2600LL) & 0x400) != 0 )
