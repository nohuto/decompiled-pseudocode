/*
 * XREFs of HUBCONNECTOR_MapRootHubPorts @ 0x140086298
 * Callers:
...
void __fastcall HUBCONNECTOR_MapRootHubPorts(__int64 a1)
{
  ...
  v1 = *(_WORD *)(a1 + 146);
  for ( i = (_QWORD **)(a1 + 2368); v1 <= *(_WORD *)(a1 + 148); ++v1 )
  {
    for ( j = *i; ; j = (_QWORD *)*j )
    {
      v5 = j - 31;
  ...
  if ( v10 <= v9 )
  {
    ...
    while ( 1 )
    {
      if ( v12 > v11 )
        return;
      v14 = (_QWORD *)(a1 + 2368);
      for ( n = *(_QWORD **)(a1 + 2368); ; n = (_QWORD *)*n )
      {
        v16 = n - 31;
        if ( v14 == n )
          goto LABEL_39;
          ...
          if ( v12 == v11 )
          {
            ...
            *((_WORD *)v16 + 107) = v9;
            while ( 2 )
            {
              if ( v10 <= v9 )
              {
                for ( ii = *(_QWORD **)(a1 + 2368); ; ii = (_QWORD *)*ii )
                {
                  v22 = ii - 31;
                  if ( v14 == ii )
                    goto LABEL_58;
...
LABEL_39:
    ...
    {
      for ( jj = *(_QWORD **)(a1 + 2368); ; jj = (_QWORD *)*jj )
      {
        v20 = jj - 31;
        if ( v14 == jj )
          goto LABEL_36;
