/*
 * XREFs of HUBDSM_ComputingU1U2TimeoutsAndExitLatency @ 0x1400214C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ComputingU1U2TimeoutsAndExitLatency(__int64 a1)
{
  ...
  if ( v6 || v5 )
  {
    ...
    if ( v9 > 0x834 )
      v11 = v9;
    v10 = *(unsigned __int16 *)(*(_QWORD *)v1 + 1196LL) + *(unsigned __int16 *)(*(_QWORD *)v1 + 2500LL);
    v4 = (v11
        + 2 * (v10 + *(unsigned __int16 *)(v1 + 2582) + 200)
        + (v11 + 2 * (v10 + *(unsigned __int16 *)(v1 + 2582) + 200))
        * (unsigned int)*(unsigned __int8 *)(v1 + 2206)
        / 0x64
        + 500)
       / 0x3E8;
  }
