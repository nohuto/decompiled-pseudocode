/*
 * XREFs of HUBDSM_SettingInterfaceInformationInClientRequest @ 0x140024790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_SettingInterfaceInformationInClientRequest(__int64 a1)
{
  ...
  if ( v5 != (_QWORD *)*v5 )
  {
    ...
    {
      v11 = (*(__int64 (__fastcall **)(_QWORD))(v3 + 480))(*(_QWORD *)(v7 + 72 * i + 40));
      ...
      *(_QWORD *)(v7 + 72 * i + 56) = v11;
      *(_QWORD *)(v6 + 24 * i + 32) = v11;
      (*(void (__fastcall **)(_QWORD))(v3 + 472))(*(_QWORD *)(v7 + 72 * i + 40));
    }
  }
  return 4077LL;
}
