/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x14003E3B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20CompatibleId(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  if ( (*(_BYTE *)v3 & 0x20) != 0 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(v3 + 96), a2, 5, 328, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
...
LABEL_21:
  v19 = v14;
LABEL_8:
  WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 96), 2u, 5u, v7, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v19);
LABEL_9:
  v8 = 167LL;
LABEL_10:
...
LABEL_11:
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v3 + 96), a2, 5, 334, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v4;
}
