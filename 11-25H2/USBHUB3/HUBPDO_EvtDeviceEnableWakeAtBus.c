/*
 * XREFs of HUBPDO_EvtDeviceEnableWakeAtBus @ 0x140016040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceEnableWakeAtBus(__int64 a1, int a2)
{
  ...
  if ( a2 == 1 || (v4 = *(unsigned int *)(*(_QWORD *)(v3 + 24) + 1632LL), (v4 & 2) == 0) )
  {
    v7 = *(_QWORD *)(v3 + 24);
    if ( (*(_DWORD *)(v7 + 1632) & 0x100) != 0 )
    {
      if ( (*(_DWORD *)(v3 + 32) & 0x10) == 0 )
      {
        if ( (*(_DWORD *)(v7 + 1456) & 0x800) != 0 )
        {
