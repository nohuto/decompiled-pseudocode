/*
 * XREFs of HUBFDO_EvtDeviceCleanupCallback @ 0x14000D180
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall HUBFDO_EvtDeviceCleanupCallback(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(v3 + 40) & 0x20) != 0 )
  {
    ...
    HUBSM_AddEvent(v3 + 1272, 2027);
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1632))(WdfDriverGlobals, v3);
    HUBMISC_WaitForSignal((PVOID)(v3 + 1160));
  }
  if ( *(_QWORD *)(v3 + 2264) )
  {
    (*(void (**)(void))(v3 + 528))();
    (*(void (__fastcall **)(_QWORD))(v3 + 512))(*(_QWORD *)(v3 + 2264));
    *(_QWORD *)(v3 + 2264) = 0LL;
  }
  v12 = *(void **)(v3 + 1264);
  if ( v12 )
    ExFreePoolWithTag(v12, 0x68334855u);
  result = imp_WppRecorderLogDelete(WPP_GLOBAL_Control, *(_QWORD *)(v3 + 2528));
