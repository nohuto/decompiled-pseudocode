/*
 * XREFs of TUNNEL_ReleaseUsb4HostPowerReferenceForPort @ 0x140093170
 * Callers:
...
void __fastcall TUNNEL_ReleaseUsb4HostPowerReferenceForPort(_QWORD **a1)
{
  ...
  if ( (*((_DWORD *)a1 + 51) & 0x800) != 0 )
  {
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD))(WdfFunctions_01015 + 2512))(WdfDriverGlobals, (*a1)[344]);
    if ( Usb4Host )
