/*
 * XREFs of HUBDESC_ParseConfigurationDescriptor @ 0x14003C35C
 * Callers:
...
LABEL_13:
        if ( v17 )
        {
          ...
          else
          {
            ...
            {
              LOBYTE(v15) = 2;
              WPP_RECORDER_SF_(a9, v15, 5, 12, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
            }
          }
        }
      }
...
LABEL_21:
        LOBYTE(v15) = 2;
        WPP_RECORDER_SF_(a9, v15, 5, v19, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
LABEL_22:
        v17 = 0LL;
      }
LABEL_40:
