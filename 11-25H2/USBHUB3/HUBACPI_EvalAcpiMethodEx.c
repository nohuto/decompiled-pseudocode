/*
 * XREFs of HUBACPI_EvalAcpiMethodEx @ 0x14008DA90
 * Callers:
...
__int64 __fastcall HUBACPI_EvalAcpiMethodEx(__int64 a1, unsigned __int16 *a2, int a3, __int64 a4)
{
  ...
  if ( (unsigned __int64)(v12 + 6) > 0x100 )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v9, 3, 23, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
    }
    goto LABEL_32;
  }
  ...
  *v18 = 0;
  ...
  {
    LOBYTE(v21) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v21, 3, 26, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
  }
...
LABEL_4:
  ...
  if ( *v22 != 1114596673 || !v22[2] )
  {
    ...
    {
      LOBYTE(v23) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v23, 3, 28, (__int64)&WPP_87abda6c49cb3f06b0a228f67f220255_Traceguids);
    }
    v10 = -1072431089;
  }
LABEL_32:
