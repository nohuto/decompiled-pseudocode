/*
 * XREFs of HUBMUX_QueuePowerUpEventToDSMs @ 0x1400116D4
 * Callers:
 *     HUBHSM_NotifyingHubResumeInS0ToDevices @ 0x1400098A0 (HUBHSM_NotifyingHubResumeInS0ToDevices.c)
 ...
 *     HUBHSM_WaitingForDevicesToAcquireReferenceOnStart @ 0x14000A420 (HUBHSM_WaitingForDevicesToAcquireReferenceOnStart.c)
 * Callees:
...
_QWORD *__fastcall HUBMUX_QueuePowerUpEventToDSMs(__int64 a1, int a2)
{
  ...
  *(_DWORD *)(v3 + 12) = v6;
  ...
  if ( !v6 )
    return (_QWORD *)HUBSM_AddEvent(a1 + 1272, 2014);
  v15 = v18 - 26;
  result = v18;
  for ( i = *v18 - 208LL; &v18 != result; i = *(_QWORD *)(i + 208) - 208LL )
  {
