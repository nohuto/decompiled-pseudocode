/*
 * XREFs of HUBFDO_IoctlGetHubInformationEx @ 0x14007D8A4
 * Callers:
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *((_WORD *)v20 + 2) = *(_WORD *)(v8 + 48);
      switch ( *(_DWORD *)(v8 + 2224) )
      {
        case 1:
          *(_DWORD *)v20 = 2;
          v12 = (char *)v20;
          *(_OWORD *)((char *)v20 + 6) = *(_OWORD *)(v8 + 1188);
          *(_OWORD *)(v12 + 22) = *(_OWORD *)(v8 + 1204);
          *(_OWORD *)(v12 + 38) = *(_OWORD *)(v8 + 1220);
          *(_OWORD *)(v12 + 54) = *(_OWORD *)(v8 + 1236);
          *(_DWORD *)(v12 + 70) = *(_DWORD *)(v8 + 1252);
          *((_WORD *)v12 + 37) = *(_WORD *)(v8 + 1256);
          v12[76] = *(_BYTE *)(v8 + 1258);
          break;
        case 2:
          *(_DWORD *)v20 = 3;
          v11 = (char *)v20;
          *(_QWORD *)((char *)v20 + 6) = *(_QWORD *)(v8 + 1188);
          *(_DWORD *)(v11 + 14) = *(_DWORD *)(v8 + 1196);
          break;
        case 4:
          *(_DWORD *)v20 = 1;
          break;
