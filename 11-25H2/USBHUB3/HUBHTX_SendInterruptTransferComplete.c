/*
 * XREFs of HUBHTX_SendInterruptTransferComplete @ 0x140005F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHTX_SendInterruptTransferComplete(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = *(unsigned __int16 *)(a4 + 1020);
  v6 = *(_DWORD *)(a3 + 8);
  v7 = *(_DWORD *)(a4 + 988);
  *(_WORD *)(a4 + 1138) = v4;
  *(_DWORD *)(a4 + 1144) = 8 * v4;
  *(_QWORD *)(a4 + 1152) = *(_QWORD *)(a4 + 1128);
  if ( v6 < 0 )
  {
    v8 = (__int64 *)(a4 + 2528);
    ...
    if ( v6 != -1073741536 )
    {
      ...
      if ( (*(_DWORD *)(a4 + 2600) & 4) != 0 )
        HUBMISC_VerifierDbgBreak("HubHwVerifierInterruptTransferFailure", a4 + 1272);
      *(_DWORD *)(a4 + 2604) = 1073872898;
  ...
  return HUBSM_AddEvent(a4 + 1272, ((v6 >> 31) & 0xFFFFFFFC) + 2034);
}
