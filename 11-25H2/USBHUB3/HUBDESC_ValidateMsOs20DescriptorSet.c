/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x14003E8A0
 * Callers:
...
LABEL_42:
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v5 + 96), a2, 5, v12, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    goto LABEL_43;
  }
  if ( (_WORD)a2 != 10 )
  {
...
LABEL_45:
  ...
  *(_DWORD *)v5 = 0;
  ...
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v5 + 96), v11, 5, 367, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v7;
}
