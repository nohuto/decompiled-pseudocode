/*
 * XREFs of HUBDTX_ValidateInterfaceStatusForRemoteWakeCapability @ 0x14002DDAC
 * Callers:
 *     HUBDSM_ValidatingInterfaceStatusForRemoteWake @ 0x140025550 (HUBDSM_ValidatingInterfaceStatusForRemoteWake.c)
 * Callees:
