...
_UNKNOWN **__fastcall HUBPARENT_SetHubConfiguration(__int64 a1)
{
  ...
  v4 = 0LL;
  v19 = 0LL;
  v5 = *(struct _USB_CONFIGURATION_DESCRIPTOR **)(a1 + 1264);
  v6 = v3 - 1;
  if ( v6 )
  {
    v7 = v6 - 1;
...
LABEL_9:
        ...
        {
          LOBYTE(v2) = 2;
          WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v2, 3, 12, (__int64)&WPP_7215ce29f44d3be25ae6d82bbfc5240b_Traceguids);
        }
        goto LABEL_23;
      }
    }
...
LABEL_23:
    ...
    return (_UNKNOWN **)HUBSM_AddEvent(a1 + 1272, 2006LL);
  }
  v25 = 0LL;
