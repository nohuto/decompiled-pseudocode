/*
 * XREFs of HUBDESC_ValidateBOSDescriptorSet @ 0x14003CE94
 * Callers:
  ...
  *(_QWORD *)&v37[80] = v20;
  if ( (unsigned int)v15 < 5 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(a14, 2u, 5u, 0xEBu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v15, 5);
...
LABEL_15:
  ...
  else
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      WPP_RECORDER_SF_Ddd(v23, v24, v26, 236);
      v27 = (unsigned __int16 *)(a2 + 2);
    }
    v25 = 0;
  }
  if ( (unsigned int)v15 > *(unsigned __int16 *)(a2 + 2) )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dD(v23, 2u, 5u, 0xEDu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v15, *v27);
  }
    ...
    while ( 1 )
    {
      ...
      else
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_dD(v23, 2u, 5u, 0xEEu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v35, v36);
        }
...
LABEL_38:
  if ( *(unsigned __int8 *)(a2 + 4) != v29 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LODWORD(v35) = v29;
      WPP_RECORDER_SF_dD(v23, 2u, 5u, 0xEFu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v35, v36);
    }
  ...
  else if ( *(_DWORD *)&v37[4] == 3 )
  {
    ...
    {
      LOBYTE(v24) = 2;
      WPP_RECORDER_SF_(v23, v24, 5, 240, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
...
LABEL_57:
    ...
    {
      LOBYTE(v24) = 2;
      WPP_RECORDER_SF_(v23, v24, 5, 241, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
  }
  return v25;
}
