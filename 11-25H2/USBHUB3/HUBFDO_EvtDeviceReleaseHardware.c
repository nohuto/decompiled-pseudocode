/*
 * XREFs of HUBFDO_EvtDeviceReleaseHardware @ 0x14007C460
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HUBCONNECTOR_UnMapHubPorts @ 0x140086A28 (HUBCONNECTOR_UnMapHubPorts.c)
 */
...
__int64 __fastcall HUBFDO_EvtDeviceReleaseHardware(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(v8 + 32),
    0LL);
  v9 = *(_QWORD *)(v2 + 2440);
  if ( *(_QWORD *)(v9 + 8) != v2 + 2440 || (v10 = *(_QWORD **)(v2 + 2448), *v10 != v2 + 2440) )
    __fastfail(3u);
  *v10 = v9;
  *(_QWORD *)(v9 + 8) = v10;
  ...
  RtlInitUnicodeString((PUNICODE_STRING)(v2 + 2552), 0LL);
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
  {
    LODWORD(v14) = v6;
