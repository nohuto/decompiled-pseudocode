/*
 * XREFs of HUBDESC_InternalValidateFirmwareStatusCapabilityDescriptor @ 0x14003870C
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( *a3 <= v17 )
  {
    if ( a1[3] )
    {
      if ( *((_DWORD *)a1 + 1) >= 4u )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_d(v14, 2u, 5u, 0xACu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v20);
        }
        result = (_BYTE *)(*(__int64 (__fastcall **)(_QWORD, __int64, void *))(a2 + 24))(
                            *(_QWORD *)(a2 + 40),
                            265LL,
    ...
    *v8 = 1;
    ...
    {
      LODWORD(v20) = a1[3];
      WPP_RECORDER_SF_d(v14, 2u, 5u, 0xABu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v20);
    }
    v19 = 265LL;
  }
  else
  {
    ...
    {
      LODWORD(v20) = v15;
      WPP_RECORDER_SF_d(v14, 2u, 5u, 0xAAu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v20);
    }
    v19 = 261LL;
  }
...
LABEL_45:
  if ( *v8 )
  {
    ...
    {
      LOBYTE(v16) = 2;
      return (_BYTE *)WPP_RECORDER_SF_(v14, v16, 5, 174, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
  }
  return result;
}
