/*
 * XREFs of HUBPARENT_ResetInterruptPipe @ 0x140007EDC
 * Callers:
 *     HUBHSM_ResettingInterruptPipeOnFailure @ 0x140009D60 (HUBHSM_ResettingInterruptPipeOnFailure.c)
 * Callees:
...
__int64 __fastcall HUBPARENT_ResetInterruptPipe(__int64 a1)
{
  ...
  *(_OWORD *)(a1 + 848) = 0LL;
  *(_QWORD *)(a1 + 864) = 0LL;
  *(_QWORD *)(a1 + 840) = *(_QWORD *)(a1 + 248);
  *(_DWORD *)(a1 + 832) = 1966120;
  *(_QWORD *)(a1 + 856) = *(_QWORD *)(a1 + 1112);
  ...
  if ( !(_BYTE)result )
  {
    ...
    {
      LOBYTE(v7) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v7, 3, 17, (__int64)&WPP_7215ce29f44d3be25ae6d82bbfc5240b_Traceguids);
    }
    result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2032))(WdfDriverGlobals, v4);
    if ( (int)result < 0 )
      return HUBSM_AddEvent(a1 + 1272, 2012LL);
  }
  return result;
}
