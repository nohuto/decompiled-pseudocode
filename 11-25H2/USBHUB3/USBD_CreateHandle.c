/*
 * XREFs of USBD_CreateHandle @ 0x140043628
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x14000EFF4 (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x140042DB0 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
