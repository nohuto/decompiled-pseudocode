/*
 * XREFs of HUBDTX_DisarmDeviceForWakeUsingControlTransfer @ 0x14002AF0C
 * Callers:
 *     HUBDSM_DisarmingDeviceForWakeOnD0Entry @ 0x140022180 (HUBDSM_DisarmingDeviceForWakeOnD0Entry.c)
 *     HUBDSM_DisarmingDeviceForWakeOnPortResumed @ 0x1400221B0 (HUBDSM_DisarmingDeviceForWakeOnPortResumed.c)
 * Callees:
