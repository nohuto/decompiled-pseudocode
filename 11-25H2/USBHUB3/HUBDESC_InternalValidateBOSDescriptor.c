/*
 * XREFs of HUBDESC_InternalValidateBOSDescriptor @ 0x140035E8C
 * Callers:
...
char __fastcall HUBDESC_InternalValidateBOSDescriptor(unsigned __int8 *a1, __int64 a2, _DWORD *a3, int *a4, __int64 a5)
{
  ...
  if ( a1 )
  {
    ...
    else
    {
      *v5 = 1;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_dD(v11, 2u, 5u, 0xE2u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
      v12 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v28 = (_QWORD *)(a2 + 40);
      v13 = *(_QWORD *)(a2 + 40);
    ...
    if ( a1[1] != 15 )
    {
      *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_dD(v11, 2u, 5u, 0xE3u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
      v12 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
      v28 = (_QWORD *)(a2 + 40);
      v15 = *(_QWORD *)(a2 + 40);
    ...
    if ( *a1 < 5u )
    {
      *v5 = 2;
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        WPP_RECORDER_SF_Ddd(v11, v9, (_DWORD)a3, 228, v25, *a1, 5, 5);
        v27 = (void (__fastcall **)(_QWORD, __int64))(a2 + 24);
        v28 = (_QWORD *)(a2 + 40);
      }
    ...
    if ( *a1 > 5u )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        WPP_RECORDER_SF_Ddd(v11, v9, (_DWORD)a3, 229, v25, *a1, 5, *a1);
        v17 = (unsigned __int16 *)(a1 + 2);
      }
      (*v27)(*v28, 20LL);
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0xE6u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_Ddd(v11, v9, (_DWORD)a3, 231, v25, v21, v20, v19);
      (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 29LL);
      *(_QWORD *)(a2 + 64) = *(_QWORD *)(a2 + 56) + *(unsigned int *)(a2 + 72);
      *v5 = 2;
    }
    if ( !a1[4] )
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_(v11, v9, 5, 232, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
      }
      if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
        *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_Ddd(v11, v22, v23, 233, v25, *((_WORD *)a1 + 1), v20, a1[4]);
      (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 29LL);
    }
    v10 = 1;
  }
  else
  {
    ...
    *v5 = 1;
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(a5, v9, 5, 225, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
  ...
  if ( *v5 )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(v11, v9, 5, 234, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
  }
  return v10;
}
