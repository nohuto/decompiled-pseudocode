/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x14007DB58
 * Callers:
...
LABEL_9:
  ...
  {
    v19 = v10;
    WPP_RECORDER_SF_d(v9[316], 2u, 3u, 0x42u, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids, v19);
  }
LABEL_10:
