/*
 * XREFs of HUBDESC_InternalValidateBillboardCapabilityDescriptor @ 0x1400362DC
 * Callers:
        ...
        __int64 a5)
{
  ...
  v9 = &WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids;
  v10 = a5;
  ...
  if ( v12 >= 0x30 )
  {
    ...
    if ( *a3 <= v12 )
    {
      ...
      if ( result )
      {
        if ( result <= 0x80u )
        {
          ...
          *v5 = 1;
          ...
          {
            LODWORD(v19) = a1[5];
            WPP_RECORDER_SF_d(v10, 2u, 5u, 0xA2u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v19);
          }
          v18 = 241LL;
        }
        else
        {
          *v5 = 1;
          ...
          {
            LODWORD(v19) = a1[4];
            WPP_RECORDER_SF_d(v10, 2u, 5u, 0xA1u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v19);
          }
          v18 = 239LL;
        }
      }
      else
      {
        *v5 = 1;
        ...
        {
          LOBYTE(v15) = 2;
          WPP_RECORDER_SF_(v10, v15, 5, 160, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
        v18 = 238LL;
      }
    }
    else
    {
      ...
      {
        LODWORD(v19) = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x9Fu, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v19);
      }
      v18 = 237LL;
    }
...
LABEL_37:
  if ( *v5 )
  {
    ...
    {
      LOBYTE(v15) = 2;
      return WPP_RECORDER_SF_(v10, v15, 5, 166, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
  }
  return result;
}
