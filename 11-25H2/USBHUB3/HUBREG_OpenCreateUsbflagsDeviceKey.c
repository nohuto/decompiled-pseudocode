/*
 * XREFs of HUBREG_OpenCreateUsbflagsDeviceKey @ 0x1400886B4
 * Callers:
 ...
 *     RtlUnicodeStringInit @ 0x140035980 (RtlUnicodeStringInit.c)
    ...
    if ( Pool2 )
    {
      ...
      if ( PersistedStateLocation < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_d(a8, 2u, 5u, 0xAu, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v17);
        }
LABEL_34:
...
LABEL_32:
        ...
        WPP_RECORDER_SF_d(a8, 2u, 5u, v14, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v18);
LABEL_33:
        if ( !v8 )
          goto LABEL_35;
        goto LABEL_34;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(a8, 2u, 5u, 0xBu, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v16);
  }
LABEL_35:
  if ( PersistedStateLocation >= 0 )
  {
