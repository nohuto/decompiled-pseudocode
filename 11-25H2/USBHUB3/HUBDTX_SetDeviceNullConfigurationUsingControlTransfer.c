/*
 * XREFs of HUBDTX_SetDeviceNullConfigurationUsingControlTransfer @ 0x14002BEE4
 * Callers:
 *     HUBDSM_DeConfiguringDeviceOnClientRequest @ 0x140021860 (HUBDSM_DeConfiguringDeviceOnClientRequest.c)
 * Callees:
