/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x140029918
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x14000A220 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
    ...
    if ( v3 >= 0 )
    {
      ...
      *(_DWORD *)(v14 + 24) = *(unsigned __int16 *)(a1 + 48);
      if ( *(_DWORD *)(a1 + 256) == 2 )
      {
        ...
        *(_DWORD *)(v14 + 32) = (*(unsigned __int16 *)(a1 + 1191) >> 5) & 3;
      }
...
LABEL_7:
    LODWORD(v8) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2528), 2u, 3u, v5, (__int64)&WPP_21d6231090f93e4afbb8b064742420ef_Traceguids, v8);
LABEL_17:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v8) = v4;
