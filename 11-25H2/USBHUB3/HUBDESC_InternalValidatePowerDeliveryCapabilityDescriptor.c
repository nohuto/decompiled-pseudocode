/*
 * XREFs of HUBDESC_InternalValidatePowerDeliveryCapabilityDescriptor @ 0x140039CB8
 * Callers:
...
LABEL_9:
    ...
    if ( *v25 <= v11 )
    {
      ...
      if ( (a1[4] & 0x20) != 0 )
      {
        *(_BYTE *)(*(_QWORD *)(v6 + 80) + 42LL) = 1;
        ...
        {
          LOBYTE(a2) = 4;
          WPP_RECORDER_SF_(v8, a2, 5, 140, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
      }
    }
    else
    {
      ...
      {
        LODWORD(v20) = v10;
        WPP_RECORDER_SF_d(v8, 2u, 5u, 0x8Au, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v20);
      }
...
LABEL_35:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v8, 2u, v12, 0x88u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v10, *a1, 18);
    goto LABEL_35;
  }
LABEL_36:
  v9 = 0;
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(v8, a2, 5, 141, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v9;
}
