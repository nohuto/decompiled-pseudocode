/*
 * XREFs of HUBUCX_PurgeDeviceIoUsingUCXIoctl @ 0x140028878
 * Callers:
 *     HUBDSM_PurgingDeviceIoOnDetachInConfigured @ 0x1400235A0 (HUBDSM_PurgingDeviceIoOnDetachInConfigured.c)
 *     HUBDSM_PurgingIoOnEnumAfterFailureInReEnumWithAddress0Ownership @ 0x140023640 (HUBDSM_PurgingIoOnEnumAfterFailureInReEnumWithAddress0Ownership.c)
 * Callees:
