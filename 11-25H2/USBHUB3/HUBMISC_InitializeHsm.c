/*
 * XREFs of HUBMISC_InitializeHsm @ 0x140086B6C
 * Callers:
  ...
  *(_QWORD *)(a1 + 2232) = a1;
  ...
  if ( v4 >= 0 )
  {
    ...
    *(_QWORD *)(a1 + 824) = v7;
    ...
    KeInitializeSpinLock((PKSPIN_LOCK)(a1 + 2112));
    KeInitializeEvent((PRKEVENT)(a1 + 1160), NotificationEvent, 0);
    *(_DWORD *)(a1 + 2152) = 0;
    v10 = *(_BYTE *)(a1 + 240) == 0;
    *(_DWORD *)(a1 + 2124) = 2000;
    if ( v10 )
    ...
    *(_DWORD *)(a1 + 2256) = 2000;
    *(_QWORD *)(a1 + 2248) = &HSMStateTable;
    *(_QWORD *)(a1 + 2304) = *(_QWORD *)(a1 + 248);
    *(_QWORD *)(a1 + 2272) = a1;
    Timer = ExAllocateTimer(HUBMISC_HubEventTimer, a1, 4LL);
    *(_QWORD *)(a1 + 2312) = Timer;
    if ( Timer )
    {
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v12, 3, 12, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids);
    }
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v6 = 10;
LABEL_4:
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2528), 2u, 3u, v6, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids, v4);
  }
  return v5;
}
