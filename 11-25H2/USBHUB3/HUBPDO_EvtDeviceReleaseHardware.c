/*
 * XREFs of HUBPDO_EvtDeviceReleaseHardware @ 0x1400837B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceReleaseHardware(const void *a1)
{
  ...
  GUID v17; // [rsp+38h] [rbp-30h] BYREF
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
    McTemplateK0p_EtwWriteTransfer(v4, &USBHUB3_ETW_EVENT_DEVICE_RELEASE_HARDWARE_START, &v17, *(_QWORD *)(v3 + 24));
  v5 = *(void **)(v2 + 392);
  if ( v5 )
  {
  ...
  *(_BYTE *)v6 = 1;
  ...
  (*(void (__fastcall **)(_QWORD, _BYTE *))(v7 + 568))(*(_QWORD *)(v7 + 248), v16);
  KeClearEvent((PRKEVENT)(v3 + 1584));
  HUBSM_AddDsmEvent(v3, 4099LL);
  HUBMISC_WaitForSignal((PVOID)(v3 + 1584), "Device PDORemoved", a1);
  v9 = *(_QWORD *)v3;
  (*(void (__fastcall **)(_QWORD, _BYTE *))(*(_QWORD *)v3 + 576LL))(*(_QWORD *)(*(_QWORD *)v3 + 248LL), v16);
  ...
  else
  {
    ...
    if ( _bittest((const signed __int32 *)(*(_QWORD *)(v3 + 8) + 204LL), 0xBu) )
    {
      if ( (unsigned int)Feature_UTSP__private_IsEnabledDeviceUsageNoInline()
         ? ((*(_DWORD *)(v3 + 2724) - 2) & 0xFFFFFFFD) == 0
         : (*(_DWORD *)(v3 + 1636) & 0x200000) == 0 )
      {
