/*
 * XREFs of FWUPDATE_CreateFirmwareUpdateDevice @ 0x140090AAC
 * Callers:
...
LABEL_39:
    ...
    else
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v9, 3, 36, (__int64)&WPP_2fd11ae104fa34a9334eddada324a17a_Traceguids);
      }
      updated = -1073741670;
    }
  }
