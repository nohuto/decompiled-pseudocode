/*
 * XREFs of FWUPDATE_AddIdsForFirmwareUpdateDevice @ 0x1400906DC
 * Callers:
...
__int64 __fastcall FWUPDATE_AddIdsForFirmwareUpdateDevice(__int64 a1, __int64 a2)
{
  ...
  v2 = *(unsigned __int16 *)(a1 + 2730);
  v3 = *(unsigned __int16 *)(a1 + 2728);
  ...
  *(_QWORD *)&DestinationString.Length = 11796480LL;
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      v13 = *(unsigned __int16 *)(a1 + 2734);
      v10 = *(unsigned __int16 *)(a1 + 2732);
      v6 = RtlUnicodeStringPrintf(
             &DestinationString,
             L"USB\\VID_%04X&PID_%04X&BCD_%04X&REV_%04X&GFU",
             *(unsigned __int16 *)(a1 + 2728),
             *(unsigned __int16 *)(a1 + 2730),
             v10,
             v13);
      v7 = v6;
      if ( v6 >= 0 )
      {
        ...
        if ( v6 >= 0 )
        {
          LODWORD(v11) = *(unsigned __int16 *)(a1 + 2732);
          v6 = RtlUnicodeStringPrintf(
                 &DestinationString,
