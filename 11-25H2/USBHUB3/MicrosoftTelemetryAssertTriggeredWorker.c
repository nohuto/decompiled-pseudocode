/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x140042754
 * Callers:
...
LABEL_55:
  ...
  KeReleaseSpinLock(&g_AssertSpinLock, v10);
  v27 = -1LL;
  if ( (unsigned int)dword_140077040 > 5
    && (qword_140077050 & 0x400000000000LL) != 0
    && (qword_140077058 & 0x400000000000LL) == qword_140077058 )
  {
    ...
    v76 = v32;
    v78 = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140077040, byte_140068025, 0LL, 0LL, 0xEu, v52);
  }
  if ( dword_140077078 && !v26 && !KeGetCurrentIrql() )
  {
      ...
      && (qword_140077058 & 0x400000000000LL) == qword_140077058 )
    {
      ...
      v73 = 4LL;
      v75 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140077040, byte_14006813C, 0LL, 0LL, 0xDu, v52);
    }
    if ( !v35 )
    {
