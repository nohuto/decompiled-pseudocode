/*
 * XREFs of HUBFDO_BuildUsb20HubDescriptor @ 0x14000CA58
 * Callers:
  ...
  if ( *(_BYTE *)(a1 + 240) )
  {
    if ( *(_DWORD *)(a1 + 256) == 1 || *(_DWORD *)(a1 + 256) == 2 )
    {
      *a2 = *(_OWORD *)(a1 + 1188);
      ...
      a2[2] = *(_OWORD *)(a1 + 1220);
      a2[3] = *(_OWORD *)(a1 + 1236);
      *((_DWORD *)a2 + 16) = *(_DWORD *)(a1 + 1252);
      *((_WORD *)a2 + 34) = *(_WORD *)(a1 + 1256);
      LOBYTE(v4) = *(_BYTE *)(a1 + 1258);
      *((_BYTE *)a2 + 70) = v4;
    }
    else if ( *(_DWORD *)(a1 + 256) == 3 )
    {
      ...
      *((_BYTE *)a2 + 2) = v7;
      v8 = v7;
      v9 = 0;
      *(_WORD *)((char *)a2 + 3) = *(_WORD *)(a1 + 1191) & 0x1F;
      *((_BYTE *)a2 + 5) = *(_BYTE *)(a1 + 1193);
      LOBYTE(v4) = *(_BYTE *)(a1 + 1194);
      *((_BYTE *)a2 + 6) = v4;
      v10 = (v8 >> 3) + 1;
      if ( v10 )
      {
