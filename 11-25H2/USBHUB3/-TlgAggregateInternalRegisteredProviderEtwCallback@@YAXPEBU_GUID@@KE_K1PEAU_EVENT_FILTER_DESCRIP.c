/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x140094790
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall @ 0x140045D00 (_guard_dispatch_icall.c)
 *     LookUpTableFlushComplete @ 0x140094200 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1400945E8 (LookUpTableFlushPartial.c)
 */
