/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x14007EFB4
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetPortConnectorProperties(__int64 a1, __int64 a2, size_t a3, int a4)
{
  ...
  if ( v10 >= 0 )
  {
    v10 = HUBFDO_IoctlValidateParameters((_DWORD)v9, 18, a4, (_DWORD)v31, 18LL, a3);
    if ( v10 < 0 )
      goto LABEL_11;
...
LABEL_9:
    ...
    else
    {
      ...
      if ( *((_WORD *)v31 + 6) <= 1u )
      {
        ...
        if ( CompanionPort )
        {
          v22 = (unsigned __int16 *)(*(_QWORD *)CompanionPort + 2552LL);
...
LABEL_33:
  ...
  {
    v30 = v10;
    WPP_RECORDER_SF_d(v9[316], 2u, 3u, 0x4Au, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids, v30);
  }
LABEL_11:
