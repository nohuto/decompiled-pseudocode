/*
 * XREFs of HUBPSM20_DisengagingSDM845HighSpeedWorkaround @ 0x1400127E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_DisengagingSDM845HighSpeedWorkaround(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v6 = v4;
    WPP_RECORDER_SF_d(v3[179], 4u, 5u, 0x7Fu, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids, v6);
  }
  return 3013LL;
}
