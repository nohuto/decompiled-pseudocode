/*
 * XREFs of HUBDTX_SetSelUsingControlTransfer @ 0x14002C08C
 * Callers:
 *     HUBDSM_SettingSEL @ 0x140024A50 (HUBDSM_SettingSEL.c)
 * Callees:
...
__int64 __fastcall HUBDTX_SetSelUsingControlTransfer(__int64 *a1)
{
  ...
  if ( v3 <= *(_WORD *)(*a1 + 2482) )
    v3 = *(_WORD *)(*a1 + 2482);
  v6 = *(_WORD *)(v1 + 2486) + (1000 * (v5 - *(unsigned __int8 *)(v1 + 2488)) + 500) / 1000;
  if ( v3 <= v6 )
  {
    *((_BYTE *)a1 + 2197) = v6;
  }
  ...
  v7 = *((_WORD *)a1 + 1097);
  *((_WORD *)a1 + 1101) = v3 + *(_WORD *)(v1 + 2494) + ((unsigned int)*(unsigned __int8 *)(*a1 + 1195) + 5) / 0xA;
  if ( v7 <= *(_WORD *)(v1 + 2484) )
    v7 = *(_WORD *)(v1 + 2484);
  v8 = *(_WORD *)(v1 + 2490) + (__int16)(1000 * (v5 - *(unsigned __int8 *)(v1 + 2492)) + 500) / 1000;
  if ( v7 <= v8 )
  {
    *((_WORD *)a1 + 1100) = v8;
  }
  ...
  *((_WORD *)a1 + 1102) = v7 + *(_WORD *)(v1 + 2496) + ((unsigned int)*(unsigned __int8 *)(*a1 + 1195) + 5) / 0xA;
