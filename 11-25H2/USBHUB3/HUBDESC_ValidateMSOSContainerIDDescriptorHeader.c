/*
 * XREFs of HUBDESC_ValidateMSOSContainerIDDescriptorHeader @ 0x14003DC9C
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSContainerIDDescriptorHeader(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 == 8 )
  {
    ...
    if ( *(_WORD *)(a1 + 6) != 6 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x109u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v12, v13);
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v13) = 24;
      LODWORD(v12) = *v10;
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x10Au, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v12, v13);
      v8 = v14;
      v9 = v15;
    }
    (*v8)(*v9, 118LL);
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a4, 2u, 5u, 0x107u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, a2);
...
LABEL_20:
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_(a4, v7, 5, 267, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v6;
}
