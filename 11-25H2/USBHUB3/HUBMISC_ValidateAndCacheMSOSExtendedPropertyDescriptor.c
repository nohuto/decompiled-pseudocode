/*
 * XREFs of HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor @ 0x140033A74
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedPropertyDescriptor @ 0x140025B00 (HUBDSM_ValidatingMSOSExtendedPropertyDescriptor.c)
 * Callees:
...
LABEL_29:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(v6 + 1432), 2, 5, v7, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids);
LABEL_31:
