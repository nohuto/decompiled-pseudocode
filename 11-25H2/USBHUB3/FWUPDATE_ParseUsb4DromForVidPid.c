/*
 * XREFs of FWUPDATE_ParseUsb4DromForVidPid @ 0x140041A60
 * Callers:
...
void __fastcall FWUPDATE_ParseUsb4DromForVidPid(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int64)v6 >= v3 + v1 )
    {
      ...
      v8 = 47;
LABEL_17:
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), 2, 3, v8, (__int64)&WPP_2fd11ae104fa34a9334eddada324a17a_Traceguids);
      return;
    }
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  ...
  *(_WORD *)(a1 + 2728) = *((_WORD *)v4 + 2);
  *(_WORD *)(a1 + 2730) = *((_WORD *)v4 + 3);
  *(_WORD *)(a1 + 2732) = *((_WORD *)v4 + 4);
  *(_WORD *)(a1 + 2734) = v4[14];
  *(_BYTE *)(a1 + 2736) = 1;
}
