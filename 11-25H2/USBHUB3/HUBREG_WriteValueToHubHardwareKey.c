/*
 * XREFs of HUBREG_WriteValueToHubHardwareKey @ 0x14008D55C
 * Callers:
...
LABEL_7:
    LODWORD(v9) = v5;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2528), 2u, 3u, v7, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v9);
  }
LABEL_8:
  if ( v10 )
