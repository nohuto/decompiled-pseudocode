/*
 * XREFs of McTemplateK0pqqhhhq_EtwWriteTransfer @ 0x14001D10C
 * Callers:
 *     EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x14001486C (EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup.c)
...
NTSTATUS McTemplateK0pqqhhhq_EtwWriteTransfer(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 2LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &USBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_V1, a3, 8u, &v4);
}
