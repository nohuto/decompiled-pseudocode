/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x14002C9E0
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x140025100 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheConfigDescriptor(__int64 a1)
{
  ...
  v1 = *(struct _USB_CONFIGURATION_DESCRIPTOR **)(a1 + 2016);
  v41 = 0;
  v3 = 4077;
  if ( !v1 )
    v1 = (struct _USB_CONFIGURATION_DESCRIPTOR *)(a1 + 1732);
  ...
  *(_WORD *)((char *)&v34 + 5) = (v6 & 0x20) != 0;
  ...
  if ( *(_BYTE *)(a1 + 2005) > 1u && v1->bNumInterfaces > 1u )
  {
    v14 = *(_BYTE *)(a1 + 1992);
...
LABEL_43:
  if ( (*(_DWORD *)(a1 + 1632) & 4) == 0 && *(_BYTE *)(a1 + 2005) == 1 && v1->bNumInterfaces > 1u )
  {
    v23 = *(_BYTE *)(a1 + 1992);
    if ( !v23 || v23 == -17 && *(_BYTE *)(a1 + 1993) == 2 && *(_BYTE *)(a1 + 1994) == 1 )
      _InterlockedOr((volatile signed __int32 *)(a1 + 1632), 4u);
  }
  if ( !*(_QWORD *)(a1 + 2016) )
  {
    ...
    else if ( (*(_DWORD *)(a1 + 1632) & 4) == 0 )
    {
      if ( (_BYTE)v11 == 1 )
      {
        ...
        if ( MidiInterfaceDescriptor )
          *(_QWORD *)(a1 + 2008) = MidiInterfaceDescriptor;
      }
      else if ( *(_WORD *)(a1 + 1990) > 0x200u && (*(_DWORD *)(a1 + 1644) & 0x800) == 0 )
      {
        v28 = *(_DWORD *)(a1 + 172);
        if ( v28 == 3 )
        {
          v11 = *(unsigned int *)(*(_QWORD *)a1 + 768LL);
          if ( (v11 & 1) == 0 )
            goto LABEL_71;
        }
        else if ( v28 != 2 )
