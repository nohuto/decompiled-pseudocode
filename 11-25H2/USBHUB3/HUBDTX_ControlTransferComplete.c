/*
 * XREFs of HUBDTX_ControlTransferComplete @ 0x14002A300
 * Callers:
 *     <none>
 * Callees:
...
LABEL_149:
    McTemplateK0pqqq_EtwWriteTransfer(v13, v15, (const GUID *)(v5 + 1516), *(_QWORD *)(v5 + 24), v30, v31, v32);
    goto LABEL_150;
  }
  if ( (_BYTE)v13 != 49 )
  {
    if ( !v25 )
    {
      ...
      {
LABEL_139:
        if ( (_BYTE)v13 == 3 && !*(_WORD *)(v5 + 402) && !*(_WORD *)(v5 + 404) )
          goto LABEL_150;
        goto LABEL_142;
      }
      if ( *(_WORD *)(v5 + 402) == 1 )
