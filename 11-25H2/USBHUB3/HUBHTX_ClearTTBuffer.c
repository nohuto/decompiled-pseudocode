/*
 * XREFs of HUBHTX_ClearTTBuffer @ 0x140002E70
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x1400024E8 (WPP_RECORDER_SF_d.c)
 *     HUBHTX_GetClearTtBufferInfoForEndpoint @ 0x1400045C4 (HUBHTX_GetClearTtBufferInfoForEndpoint.c)
 *     HUBMISC_ControlTransfer @ 0x14002EC7C (HUBMISC_ControlTransfer.c)
 *     _guard_dispatch_icall @ 0x140045D00 (_guard_dispatch_icall.c)
 */

__int64 __fastcall HUBHTX_ClearTTBuffer(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, __int16 a5)
{
  int v5; // r15d
  __int16 v8; // r14
  __int64 v11; // rdi
  ...
  if ( (v5 & 1) == 0 || !a2 || (v5 & 0x1000) != 0 )
    return (*(__int64 (__fastcall **)(_QWORD, __int64))(a1 + 536))(*(_QWORD *)(a1 + 384), a3);
  v12 = v5 & 0x800;
