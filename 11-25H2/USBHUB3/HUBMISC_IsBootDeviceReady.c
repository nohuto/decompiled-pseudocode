/*
 * XREFs of HUBMISC_IsBootDeviceReady @ 0x14003085C
 * Callers:
 *     HUBBOOT_IsBootDeviceReady @ 0x140040BC0 (HUBBOOT_IsBootDeviceReady.c)
 * Callees:
...
char __fastcall HUBMISC_IsBootDeviceReady(__int64 a1)
{
  ...
  v5 = (volatile __int32 *)(a1 + 2240);
  *(_DWORD *)(a1 + 2240) = 0;
  if ( (int)HUBHTX_GetPortStatusForBootDevice(a1, &v12) >= 0 )
  {
    if ( (*(_DWORD *)(a1 + 1636) & 0x400) != 0 && (v12 & 0x10000) == 0 )
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_31;
      v7 = 103;
...
LABEL_24:
        LOBYTE(v6) = 4;
        WPP_RECORDER_SF_(*(_QWORD *)(v8 + 1432), v6, 5, v10, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids);
      }
    }
    else
    {
      if ( (*(_DWORD *)(a1 + 1456) & 0x800) == 0 || (v12 & 0x1E0) != 0xC0 )
      {
...
LABEL_30:
  LOBYTE(v6) = 4;
  WPP_RECORDER_SF_(v9, v6, 5, v7, (__int64)&WPP_a8f221bb5af334040897444f02cc5603_Traceguids);
LABEL_31:
