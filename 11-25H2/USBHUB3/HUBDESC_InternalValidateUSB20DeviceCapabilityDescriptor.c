/*
 * XREFs of HUBDESC_InternalValidateUSB20DeviceCapabilityDescriptor @ 0x14003BF90
 * Callers:
        ...
        __int64 a6)
{
  ...
  v10 = *(_DWORD *)(a2 + 72);
  v11 = &WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids;
  v12 = a6;
    ...
    if ( *a3 <= v15 )
    {
      if ( (*(_DWORD *)(a1 + 3) & 0xFFFF00E1) != 0 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_d(v12, 2u, 5u, 0xD4u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v28);
        }
...
LABEL_51:
      ...
      {
        LODWORD(v28) = *(_DWORD *)(a1 + 3);
        WPP_RECORDER_SF_d(v12, 2u, 5u, 0xD6u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v28);
      }
      v17 = 150LL;
    }
    else
    {
      ...
      {
        LODWORD(v28) = v13;
        WPP_RECORDER_SF_d(v12, 2u, 5u, 0xD3u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v28);
      }
      v17 = 148LL;
    }
  ...
  *v6 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v12, 2u, v16, 0xD1u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v13, *a1, 7);
    goto LABEL_51;
  }
LABEL_52:
  v18 = 0;
  ...
  {
    LOBYTE(v14) = 2;
    WPP_RECORDER_SF_(v12, v14, 5, 215, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v18;
}
