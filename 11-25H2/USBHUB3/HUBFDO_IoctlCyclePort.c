/*
 * XREFs of HUBFDO_IoctlCyclePort @ 0x14007C9FC
 * Callers:
...
LABEL_15:
    ...
    IsAdmin = HUBMISC_VerifyCallerIsAdmin(v8[316]);
...
LABEL_4:
          LODWORD(v28) = IsAdmin;
          WPP_RECORDER_SF_d(v8[316], 2u, 3u, v13, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids, v28);
          goto LABEL_27;
        }
        goto LABEL_27;
      }
