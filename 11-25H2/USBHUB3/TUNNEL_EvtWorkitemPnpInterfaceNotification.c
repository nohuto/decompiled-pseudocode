/*
 * XREFs of TUNNEL_EvtWorkitemPnpInterfaceNotification @ 0x140092510
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    v21 = *(_QWORD *)(v5 + 32);
    v20 = *v9;
    WPP_RECORDER_SF_qqq(*(_QWORD *)(v3 + 2528), v7, v8, 0x11u, v19);
  }
  ...
  *((_QWORD *)&v24[1] + 1) = TUNNEL_EvtIoTargetRemoveComplete;
  ...
  if ( v10 < 0 )
  {
    ...
    {
      LOWORD(v22) = *(_WORD *)(v3 + 2476);
      LOWORD(v21) = *(_WORD *)(v3 + 2474);
      LOWORD(v20) = *(_WORD *)(v3 + 2472);
      LODWORD(v19) = v12;
  ...
  *(_QWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qqq(*(_QWORD *)(v3 + 2528), v15, v17, 0x13u, v19);
  return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1664))(WdfDriverGlobals, a1);
}
