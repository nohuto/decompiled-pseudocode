/*
 * XREFs of HUBDESC_InternalValidateStringDescriptor @ 0x140039FC4
 * Callers:
  ...
  if ( a2 < 2 )
  {
    *a3 = 0;
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF2u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, a2);
...
LABEL_27:
    ...
    {
      LOBYTE(v8) = 2;
      WPP_RECORDER_SF_(v7, v8, 5, 248, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    }
    return v15;
  }
  v9 = *a1;
  ...
  *a3 = v9;
  ...
  else
  {
    ...
    *a3 = a2;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_Ddd(a5, a2, (_DWORD)a3, 243);
    v10 = (void (__fastcall **)(_QWORD, __int64))(a6 + 24);
    v11 = (_QWORD *)(a6 + 40);
  ...
  if ( *a1 <= 2u )
  {
    ...
    *a3 = a2;
    ...
    {
      v20 = a2;
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF4u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v20);
  ...
  if ( v12[1] != 3 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v22 = 3;
      LODWORD(v18) = v12[1];
      WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xF5u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v18, v22);
      v10 = v13;
      v11 = v14;
    }
  ...
  if ( (v8 & 1) != 0 )
  {
    ...
    *v26 = v16;
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v21) = v16;
      LODWORD(v18) = v8;
      WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xF6u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v18, v21);
  ...
  if ( *v12 != a2 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v21) = a2;
      LODWORD(v18) = *v12;
      WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xF7u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v18, v21);
      v13 = v27;
      v14 = v23;
    }
    (*v13)(*v14, 134LL);
