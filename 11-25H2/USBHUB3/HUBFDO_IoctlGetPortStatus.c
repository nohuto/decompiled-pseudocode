/*
 * XREFs of HUBFDO_IoctlGetPortStatus @ 0x14007F384
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetPortStatus(__int64 a1, __int64 a2, size_t a3, int a4)
{
  ...
  if ( v9 < 0 )
  {
    ...
    {
      v14 = v9;
      WPP_RECORDER_SF_d(v8[316], 2u, 3u, 0x3Eu, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids, v14);
    }
  ...
  memset(v15, 0, a3);
  *(_DWORD *)v15 = v10;
  for ( i = (_QWORD *)v8[296]; ; i = (_QWORD *)*i )
  {
    v12 = i - 31;
    if ( v8 + 296 == i )
      goto LABEL_9;
