/*
 * XREFs of HUBACPI_ExecuteDSM @ 0x14008E7FC
 * Callers:
           ...
           &v19) >= 0 )
    {
      if ( v20 == 1114596673 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_q_guid_LLLLL(*(_QWORD *)(a1 + 2528), v12, WORD5(v21), DWORD1(v21), v16);
      }
      else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        WPP_RECORDER_SF_q_guid_L(*(_QWORD *)(a1 + 2528), v12, v13, v14, v16);
      }
    }
    else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      WPP_RECORDER_SF_q_guid_Ld(*(_QWORD *)(a1 + 2528), v12, v13, v14, v16);
    }
    ExFreePoolWithTag(v9, 0x70334855u);
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF__guid_d(*(_QWORD *)(a1 + 2528));
  }
  return v6;
}
