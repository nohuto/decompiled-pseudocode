 ...
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x14004265C (InitializeTelemetryAssertsKMWorkerInternal.c)
 ...
 *     KsPropertyHandleDrmSetContentId @ 0x14009358C (KsPropertyHandleDrmSetContentId.c)
