/*
 * XREFs of HUBDESC_InternalValidateContainerIDCapabilityDescriptor @ 0x140036BE0
 * Callers:
...
LABEL_9:
    ...
    if ( *v22 <= v11 )
    {
      if ( a1[3] )
      {
        ...
        {
          LODWORD(v18) = a1[3];
          WPP_RECORDER_SF_d(v8, 2u, 5u, 0x84u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v18);
        }
      ...
      if ( *(_QWORD *)(a1 + 4) == *(_QWORD *)&GUID_NULL.Data1 && *(_QWORD *)(a1 + 12) == *(_QWORD *)GUID_NULL.Data4 )
      {
        *(_BYTE *)(*(_QWORD *)(v6 + 80) + 41LL) = 1;
        ...
        {
          LOBYTE(a2) = 2;
          WPP_RECORDER_SF_(v8, a2, 5, 133, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
        }
    ...
    else
    {
      ...
      {
        LODWORD(v18) = v10;
        WPP_RECORDER_SF_d(v8, 2u, 5u, 0x83u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v18);
      }
...
LABEL_35:
  ...
  *v5 = 1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    WPP_RECORDER_SF_DDD(v8, 2u, v12, 0x81u, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids, v10, *a1, 20);
    goto LABEL_35;
  }
LABEL_36:
  v9 = 0;
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(v8, a2, 5, 134, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v9;
}
