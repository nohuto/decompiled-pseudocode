/*
 * XREFs of HUBFDO_EvtIoDeviceControl @ 0x14007C7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtIoDeviceControl(__int64 a1, __int64 a2, size_t a3, __int64 a4, unsigned int a5)
{
  ...
  if ( a5 > 0x220444 )
  {
    switch ( a5 )
    {
      ...
      case 0x220450u:
        return HUBFDO_IoctlGetHubCapsEx(a1, a2);
      case 0x220454u:
        return HUBFDO_IoctlGetHubInformationEx(a1, a2);
      case 0x220458u:
        return HUBFDO_IoctlGetPortConnectorProperties(a1, a2);
      case 0x22045Cu:
        return HUBFDO_IoctlGetNodeConnectionInformationExV2(a1, a2);
      case 0x220484u:
        return HUBFDO_IoctlGetNodeConnectionSuperSpeedPlusInformation(a1, a2);
      case 0x221000u:
  ...
  else
  {
    ...
    {
      case 0x220444u:
        return HUBFDO_IoctlCyclePort(a1, a2);
      case 0x220010u:
        return HUBFDO_IoctlGetPortStatus(a1, a2);
      case 0x220408u:
        return HUBFDO_IoctlGetNodeInformation(a1, a2);
      case 0x22040Cu:
        return HUBFDO_IoctlGetNodeConnectionInfo(a1, a2, a3, a4, 0);
      case 0x220410u:
        return HUBFDO_IoctlGetDescriptorFromNodeConnection(a1, a2);
      case 0x220414u:
        return HUBFDO_IoctlGetNodeConnectionName(a1, a2);
      case 0x220420u:
        return HUBFDO_IoctlGetNodeConnectionDriverKeyName(a1, a2);
      case 0x22043Cu:
        return HUBFDO_IoctlGetHubCaps(a1, a2);
      case 0x220440u:
        return HUBFDO_IoctlGetNodeConnectionAttributes(a1, a2);
    }
  }
  v11 = 0LL;
  v10[0] = 16;
