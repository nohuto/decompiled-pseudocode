/*
 * XREFs of HUBPDO_CompleteClientSerialRequestWithStatusFailed @ 0x140014D74
 * Callers:
 *     HUBDSM_CompletingClientRequestOnFailureInDisabled @ 0x140021350 (HUBDSM_CompletingClientRequestOnFailureInDisabled.c)
