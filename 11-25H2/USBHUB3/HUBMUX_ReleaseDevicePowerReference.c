/*
 * XREFs of HUBMUX_ReleaseDevicePowerReference @ 0x140011D8C
 * Callers:
 *     HUBDSM_FlushingHubPowerDownEventsForFailedDevice @ 0x140021400 (HUBDSM_FlushingHubPowerDownEventsForFailedDevice.c)
 *     HUBDSM_FailedDeviceHubSuspended @ 0x140021630 (HUBDSM_FailedDeviceHubSuspended.c)
 * Callees:
