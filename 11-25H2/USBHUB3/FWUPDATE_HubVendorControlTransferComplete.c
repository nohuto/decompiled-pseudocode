/*
 * XREFs of FWUPDATE_HubVendorControlTransferComplete @ 0x1400418E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FWUPDATE_HubVendorControlTransferComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v5 < 0 )
  {
    ...
    if ( (*(_DWORD *)(a4 + 2600) & 2) != 0 )
      HUBMISC_VerifierDbgBreak("HubHwVerifierControlTransferFailure", a4 + 1272);
  }
  return HUBSM_AddEvent(a4 + 1272, ((v5 >> 31) & 0xFFFFFFFC) + 2008);
}
