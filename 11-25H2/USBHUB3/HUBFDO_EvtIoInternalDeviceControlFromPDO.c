/*
 * XREFs of HUBFDO_EvtIoInternalDeviceControlFromPDO @ 0x14000DDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtIoInternalDeviceControlFromPDO(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( a5 == 2228243 )
  {
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int128 *))(WdfFunctions_01015 + 2128))(
      ...
      a2,
      &v10);
    v7[324] = *(_QWORD *)(*(_QWORD *)(v11 + 24) + 8LL);
    v7[317] = a2;
    return HUBSM_AddEvent((__int64)(v7 + 159), 2039);
  }
  else
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(v7[316], 2u, 3u, 0x39u, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids, a5);
