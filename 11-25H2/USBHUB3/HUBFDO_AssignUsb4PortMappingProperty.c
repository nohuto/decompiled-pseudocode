/*
 * XREFs of HUBFDO_AssignUsb4PortMappingProperty @ 0x14007A80C
 * Callers:
...
LABEL_35:
        LOBYTE(v7) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v7, 3, v12, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids);
        return v4;
      }
...
LABEL_24:
    ...
    *v14 = 0;
    ...
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2528), v10, 3, v25, (__int64)&WPP_15d974077bc73d0eebd93ea2bffbd60f_Traceguids);
    goto LABEL_32;
  }
  while ( 2 )
  {
...
LABEL_17:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_DZd(*(_QWORD *)(a1 + 2528), v10, v17, v18, dwFlags);
LABEL_32:
