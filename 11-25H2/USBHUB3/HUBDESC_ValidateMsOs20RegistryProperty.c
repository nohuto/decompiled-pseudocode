/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x14003F380
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20RegistryProperty(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  {
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v10, 5, 341, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v5;
}
