/*
 * XREFs of HUBFDO_SetupHubPostErrataQuery @ 0x14000EFF4
 * Callers:
  ...
  *(_QWORD *)&v34 = 0x200000002LL;
  ...
  if ( v15 < 0 )
  {
    ...
    if ( v18 == -1073741101 && *((_DWORD *)Context + 64) == 3 )
    {
      ...
      if ( (*((_DWORD *)Context + 650) & 8) != 0 )
        HUBMISC_VerifierDbgBreak("HubHwVerifierNoSelectiveSuspendSupport", Context + 1272);
