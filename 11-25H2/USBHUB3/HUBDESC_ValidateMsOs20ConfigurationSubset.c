/*
 * XREFs of HUBDESC_ValidateMsOs20ConfigurationSubset @ 0x14003E5B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
    ...
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v8, 5, v17, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
    goto LABEL_35;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_d(
...
LABEL_37:
  ...
  {
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v16, 5, 319, (__int64)&WPP_004a5b56b99f3284d00a1fabe3347bcb_Traceguids);
  }
  return v14;
}
