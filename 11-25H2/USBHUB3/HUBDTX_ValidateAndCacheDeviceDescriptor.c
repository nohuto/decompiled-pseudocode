/*
 * XREFs of HUBDTX_ValidateAndCacheDeviceDescriptor @ 0x14002D020
 * Callers:
 *     HUBDSM_ValidatingAlternateDeviceDescriptor @ 0x140025120 (HUBDSM_ValidatingAlternateDeviceDescriptor.c)
 * Callees:
...
LABEL_23:
  ...
  *(_OWORD *)((char *)a1 + 1988) = *(_OWORD *)v4;
  *((_WORD *)a1 + 1002) = v4[8];
  if ( v32 )
    _InterlockedOr((volatile signed __int32 *)a1 + 408, 0x20000u);
  return v5;
}
