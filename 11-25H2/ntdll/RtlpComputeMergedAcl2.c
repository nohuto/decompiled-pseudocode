/*
 * XREFs of RtlpComputeMergedAcl2 @ 0x1800657D4
 * Callers:
  ...
  *a11 = 1024;
  if ( (a4 & 0x1000) != 0 )
  {
    *v19 = 5120;
    ...
    if ( *a3 >= 2u )
      LOBYTE(v18) = *a3;
    v24 = RtlpCopyAces((__int64)a3, a7, 2, 16, 1, a5, a6, a5, a6, 1, 0, a8, &v30, v14);
    goto LABEL_19;
  }
  if ( (a2 & 0x1000) == 0 )
  {
    ...
    if ( a3 )
    {
      if ( *a3 >= 2u )
        v18 = *a3;
      v21 = RtlpCopyAces((__int64)a3, a7, 1, 0, 1, a5, a6, a5, a6, 1, 0, a8, &v30, v14);
      v16 = v21 == -1073741789;
      v22 = 0;
      if ( v21 != -1073741789 )
        v22 = v21;
...
LABEL_10:
      if ( a1 )
      {
        if ( v18 <= (unsigned __int8)*a1 )
          LOBYTE(v18) = *a1;
        result = RtlpCopyAces((__int64)a1, a7, 0, 0, 0, 0LL, 0LL, 0LL, 0LL, 1, 0, v20, v28, v14);
  ...
  if ( a3 )
  {
    if ( *a3 >= 2u )
      LOBYTE(v18) = *a3;
    v24 = RtlpCopyAces((__int64)a3, a7, 2, 0, 1, a5, a6, a5, a6, 1, 1, a8, &v30, v14);
LABEL_19:
    v25 = v24;
    result = 0LL;
    if ( v25 != -1073741789 )
