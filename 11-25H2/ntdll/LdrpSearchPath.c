        ...
        __int64 a9)
{
  ...
  Destination = 0LL;
  BaseAddress = 0LL;
  LdrpLogInternal("minkernel\\ldr\\ldrfind.c", 1212LL, "LdrpSearchPath", 3LL, "DLL name: %wZ\n", Source);
  LdrpLogInternal("minkernel\\ldr\\ldrfind.c", 1213LL, "LdrpSearchPath", 5LL, "%wZ\n", v12);
  if ( !*a2 )
  {
...
LABEL_38:
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  v29 = v48;
  if ( v48 && LdrpIsSecurityEtwLoggingEnabled() )
    LdrpSaveLocationsSearched(a2, v22, v29);
LABEL_47:
  LdrpLogInternal("minkernel\\ldr\\ldrfind.c", 1533LL, "LdrpSearchPath", 4LL, "Status: 0x%08lx\n", v19);
  LdrpLogInternal("minkernel\\ldr\\ldrfind.c", 1534LL, "LdrpSearchPath", 6LL, "%x\n", v19);
