/*
 * XREFs of AVrfpQueryProcessVerifierOptions @ 0x180099D74
 * Callers:
...
__int64 __fastcall AVrfpQueryProcessVerifierOptions(__int64 a1)
{
  ...
  if ( (NtCurrentPeb()->NtGlobalFlag & 0x2000100) == 0 )
    return 0LL;
  v2 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_1801CE628)(0LL, &v7, 0LL);
  if ( v2 == -1073741820 )
  {
    ...
    if ( DebugInfo )
    {
      ...
      DebugInfo[1] = 0;
      *DebugInfo = v5;
      v2 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, unsigned int *))qword_1801CE628)(0LL, &v8, DebugInfo);
      if ( v2 < 0 )
