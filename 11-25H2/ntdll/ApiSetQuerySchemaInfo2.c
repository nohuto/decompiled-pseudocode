/*
 * XREFs of ApiSetQuerySchemaInfo2 @ 0x1801369F0
 * Callers:
 *     ApiSetQuerySchema @ 0x18015F810 (ApiSetQuerySchema.c)
 * Callees:
 *     ApiSetpSearchForApiSetA @ 0x180136DC4 (ApiSetpSearchForApiSetA.c)
