/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x1800C345C
 * Callers:
 ...
 *     NormBuffer__RecheckStartCombinations @ 0x1800C3798 (NormBuffer__RecheckStartCombinations.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x18011BE28 (Normalization__CanCombineWithStartFirstPair.c)
 *     NormBuffer__LastStartBasePair @ 0x18011F4A4 (NormBuffer__LastStartBasePair.c)
 * Callees:
 *     <none>
 */
