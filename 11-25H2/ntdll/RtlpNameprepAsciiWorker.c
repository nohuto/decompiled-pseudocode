/*
 * XREFs of RtlpNameprepAsciiWorker @ 0x1800BED20
 * Callers:
 *     RtlIdnToNameprepUnicode @ 0x180147DF0 (RtlIdnToNameprepUnicode.c)
 * Callees:
        ...
        char a6)
{
  ...
  v11 = RtlAllocateHeap((char *)NtCurrentPeb()->ProcessHeap, 8u, 0x406uLL);
  v12 = v11;
  if ( Heap && v11 )
  {
