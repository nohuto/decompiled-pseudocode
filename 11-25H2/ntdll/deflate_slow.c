/*
 * XREFs of deflate_slow @ 0x180154DE0
 * Callers:
 *     <none>
 * Callees:
 *     fill_window @ 0x1801558A0 (fill_window.c)
 *     flush_pending @ 0x180155C08 (flush_pending.c)
 *     longest_match @ 0x180155D4C (longest_match.c)
 *     _tr_flush_block @ 0x180157070 (_tr_flush_block.c)
 */
    ...
    *((_DWORD *)a1 + 54) = 2;
    ...
    else
    {
      ...
      *(_BYTE *)((unsigned int)(*((_DWORD *)a1 + 1489))++ + a1[743]) = v22 - 3;
      v25 = v23 - 1;
      v26 = length_code[(unsigned __int8)(v22 - 3)];
      ++*((_WORD *)a1 + 2 * v26 + 648);
      v27 = v25;
      if ( v25 >= 0x100u )
      {
        v27 = (unsigned __int64)v25 >> 7;
        v28 = (unsigned __int8 *)&unk_18019BB40;
      }
      else
      {
        v28 = (unsigned __int8 *)&dist_code;
      }
      ++*((_WORD *)a1 + 2 * v28[v27] + 1280);
      v29 = *((_DWORD *)a1 + 60);
      *((_DWORD *)a1 + 59) += 1 - v29;
      v30 = *((_DWORD *)a1 + 1489);
      v31 = *((_DWORD *)a1 + 1490);
