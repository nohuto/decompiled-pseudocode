  ...
  *(_QWORD *)&ValueName.Length = 0x2000000LL;
  if ( qword_1801CF7B8 == -1 )
  {
    ...
    if ( Heap )
    {
      ...
      *Heap = Heap;
      v3 = qword_1801D43C0;
      KeyHandle = qword_1801D43C0;
      if ( !qword_1801D43C0 )
      {
        v4 = NtOpenKey(&KeyHandle, 1u, (POBJECT_ATTRIBUTES)&stru_180176D80);
        if ( v4 >= 0 )
        {
        ...
        v3 = (HANDLE)_InterlockedCompareExchange64((volatile signed __int64 *)&qword_1801D43C0, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose(KeyHandle);
      ...
      if ( v3 != (HANDLE)-1LL
        && NtQueryValueKey(v3, (PUNICODE_STRING)&stru_180176D40, KeyValuePartialInformation, &v20, 0x10u, ResultLength) >= 0
        && ResultLength[0] == 16
        && HIDWORD(v20) == 1
        || RtlQueryEnvironmentVariable_U(0LL, (PUNICODE_STRING)&stru_180176D60, &Value) >= 0
...
LABEL_30:
    ...
    v11 = _InterlockedCompareExchange64(&qword_1801CF7B8, (signed __int64)v2, -1LL);
    if ( v11 == -1 )
    {
      return (__int64)v2;
    }
