...
__int64 __fastcall RtlpLogHeapReuseThresholdActivate(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rcx
  ...
  v8 = a2;
  v6[1] = 0LL;
  if ( (unsigned int)RtlGetCurrentServiceSessionId(a1, a2, a3, a4, 0x103A000000000000LL, 0LL, 0LL) )
