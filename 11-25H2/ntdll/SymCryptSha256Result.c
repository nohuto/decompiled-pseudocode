/*
 * XREFs of SymCryptSha256Result @ 0x18015CBB4
 * Callers:
 *     SymCryptSha256 @ 0x18015B808 (SymCryptSha256.c)
 * Callees:
 *     SymCryptWipeAsm @ 0x180133070 (SymCryptWipeAsm.c)
 *     SymCryptSha256AppendBlocks_ul1 @ 0x18015B964 (SymCryptSha256AppendBlocks_ul1.c)
...
__int64 __fastcall SymCryptSha256Result(__m128i *a1, _QWORD *a2)
{
  ...
  a1[6] = (__m128i)xmmword_18019C560;
  a1[7] = (__m128i)xmmword_18019C570;
  return result;
}
