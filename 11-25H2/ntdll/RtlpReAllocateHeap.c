...
__int64 __fastcall RtlpReAllocateHeap(_WORD *Src, int a2, char *a3, unsigned __int64 a4)
{
  char *v7; // rsi
  ...
  if ( *((_BYTE *)Src + 418) == 2 && *((_QWORD *)Src + 51) && *(char *)(v9 + 15) < 0 )
  {
    if ( (a2 & 0x10) == 0 )
    {
      ...
      if ( v13 == 5 )
      {
        v14 = *(unsigned __int16 *)(v71 + 12) ^ (unsigned __int64)(unsigned __int16)Src[70];
      }
      else if ( (v13 & 0x40) != 0 )
      {
...
LABEL_203:
  ...
  else
  {
    ...
    if ( v28 == 5 )
    {
      v32 = *(unsigned __int16 *)(v8 + 12) ^ (unsigned __int64)(unsigned __int16)Src[70];
    }
    else if ( (v28 & 0x40) != 0 )
    {
    ...
    v77 = 16 * v31 - v32;
    if ( v31 < (unsigned __int16)Src[216] )
    {
      v74 = v75;
...
LABEL_73:
      ...
      if ( v83 != v74 )
      {
        ...
        if ( *(_BYTE *)(v8 + 15) == 4 )
        {
          ...
          v90 = 16 * v75 - v73;
          v88 = RtlpSecMemFreeVirtualMemory(v59, &v91, &v90, 0x4000LL);
          if ( v88 >= 0 )
          {
            *(_QWORD *)(v58 + 32) -= v90;
            v8 = v72;
        ...
        else
        {
          ...
          *v87 = v83;
          ...
          if ( v50 )
          {
            v51 = (v8 & 0xFFFF0000) - (v50 << 16) + 0x10000;
            v98 = (_WORD *)((v8 & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v50 << 16) + 0x10000);
          }
          else
          {
            v51 = (int)Src;
          ...
          RtlpCreateSplitBlock((_DWORD)Src, v51, v8 + 16 * v83, v47, v49 != 0, (_WORD)v83, v48);
        }
      }
      if ( *v35 != 4 )
      {
  ...
  if ( *v27 == 4 )
    goto LABEL_87;
  if ( !(unsigned __int8)RtlpGrowBlockInPlace((_DWORD)Src, v21, v8, a4, v73 >> 4) )
  {
    v27 = (_BYTE *)(v8 + 15);
LABEL_87:
    if ( (v21 & 0x10) != 0 )
    ...
    if ( *((_DWORD *)Src + 31) )
    {
      ...
      *(_DWORD *)(v41 + 8) = v42;
      if ( HIBYTE(v42) != ((unsigned __int8)v42 ^ (unsigned __int8)(BYTE1(v42) ^ BYTE2(v42))) )
        RtlpAnalyzeHeapFailure(Src, v41);
    }
    if ( (*(_BYTE *)(v41 + 10) & 2) != 0 )
    {
