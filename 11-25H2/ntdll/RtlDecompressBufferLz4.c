/*
 * XREFs of RtlDecompressBufferLz4 @ 0x180151BF0
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        else
        {
          if ( v26 != 4 )
          {
            ...
            {
              _mm_lfence();
              v33 = (unsigned int)dword_18019B900[v26];
              *v24 = *v27;
              v34 = &v27[v33];
              v24[1] = v27[1];
              v24[2] = v27[2];
      ...
      if ( v27 >= v8 )
      {
        ...
        else
        {
          *v24 = *v27;
          ...
          v24[2] = v27[2];
          v24[3] = v27[3];
          v56 = &v27[dword_18019B900[v26]];
          *((_DWORD *)v24 + 1) = *(_DWORD *)v56;
          v57 = (char *)&v56[-dword_18019B920[v26]];
        }
        v59 = v24 + 8;
