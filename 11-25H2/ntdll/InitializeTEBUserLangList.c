/*
 * XREFs of InitializeTEBUserLangList @ 0x18005D320
 * Callers:
...
LABEL_60:
                      ...
                      LanguageConfigList = RtlpUpdateTEBLanguage(LanguageList, 0LL, 4LL);
                      goto LABEL_69;
                    }
                  }
                }
LABEL_57:
              ...
              if ( !*UserPrefLanguages
                || (v21 = *(_QWORD *)(*UserPrefLanguages + 16LL)) == 0
                || *(_DWORD *)(v21 + 12) >= *(_DWORD *)(a2 + 12) )
              {
LABEL_41:
                if ( *UserPrefLanguages )
                {
                  v32 = *(_DWORD *)(*UserPrefLanguages + 40LL);
                  if ( a1 )
                  {
                    if ( (v32 & 0x20) != 0 )
                      return LanguageConfigList;
