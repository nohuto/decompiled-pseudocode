/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1800C219C
 * Callers:
 *     Normalization__Normalize @ 0x1800C1E20 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x1800C2AF4 (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x1800C2A28 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x1800C2A80 (NormBuffer__Append.c)
 *     Normalization__AppendDecomposedChar @ 0x1800C2AF4 (Normalization__AppendDecomposedChar.c)
 *     NormBuffer__GetLastChar @ 0x1800C31AC (NormBuffer__GetLastChar.c)
 *     NormBuffer__InsertAtBlockedLocation @ 0x1800C332C (NormBuffer__InsertAtBlockedLocation.c)
 *     NormBuffer__IsBlocked @ 0x1800C335C (NormBuffer__IsBlocked.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1800C35C4 (NormBuffer__RewindOutputCharacter.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x1800C3654 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1800C36D4 (NormBuffer__ReplaceLastStartBasePair.c)
 ...
 *     ComposeHangulLV @ 0x1801205FC (ComposeHangulLV.c)
 */
