...
LABEL_8:
          if ( !v11 )
          {
            ...
            v23->LastErrorValue = RtlNtStatusToDosErrorNoTeb(0xC000000D);
            return 0;
          }
          if ( (v10 & 1) == 0 )
          {
          ...
          if ( (v12 & 0x3F) != 0 )
          {
            if ( v12 >= 0 )
            {
              ...
              if ( (v11[10] & 2) != 0 )
              {
                *(_QWORD *)(RtlpGetExtraStuffPointer((__int64)v11) + 8) = a4;
                v8 = 1;
              }
              goto LABEL_20;
            }
          ...
          else
          {
            ...
            v13->LastErrorValue = RtlNtStatusToDosErrorNoTeb(0xC000000D);
            v9 = v25;
            v8 = 0;
          }
          v11 = 0LL;
LABEL_20:
  ...
  if ( !v17 )
  {
    ...
    v24->LastErrorValue = RtlNtStatusToDosErrorNoTeb(0xC000000D);
  }
  return v17;
}
