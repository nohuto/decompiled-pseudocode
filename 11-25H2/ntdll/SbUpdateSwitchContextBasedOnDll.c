/*
 * XREFs of SbUpdateSwitchContextBasedOnDll @ 0x1800719D0
 * Callers:
 ...
 *     SbGetContextDetailsById @ 0x1800F72D0 (SbGetContextDetailsById.c)
 */
...
__int64 __fastcall SbUpdateSwitchContextBasedOnDll(__int64 a1, __int64 a2)
{
  ...
  if ( CurrentSwitchContext != -64 )
  {
    ...
    {
      v13 = 32LL * i;
      v14 = *v11 - *(_QWORD *)((char *)&unk_1801752F4 + v13);
      if ( *v11 == *(_QWORD *)((char *)&unk_1801752F4 + v13) )
        v14 = v11[1] - *(_QWORD *)((char *)&unk_1801752FC + v13);
      if ( !v14 )
      {
  ...
  if ( v6 )
  {
    ...
    {
      v21 = 32LL * j;
      v22 = *v19 - *(_QWORD *)((char *)&unk_1801752F4 + v21);
      if ( *v19 == *(_QWORD *)((char *)&unk_1801752F4 + v21) )
        v22 = v19[1] - *(_QWORD *)((char *)&unk_1801752FC + v21);
      if ( !v22 )
      {
    ...
    for ( k = 0LL; k < 0x28; k += 8LL )
    {
      ...
      {
        if ( _InterlockedExchangeAdd(&dword_1801CF804[2 * v23], 0xFFFFFFFF) != 1 )
          return 1LL;
        v9 = v31;
        break;
      }
...
LABEL_50:
  ...
  *(_QWORD *)(a1 + 192) = v31 + 4;
  while ( v16 < 0x28 )
  {
    ...
    {
      _InterlockedIncrement(&dword_1801CF804[2 * v3]);
      v15 = v31;
      break;
    }
    ++v3;
