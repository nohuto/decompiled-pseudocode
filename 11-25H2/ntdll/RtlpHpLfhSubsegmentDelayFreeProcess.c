/*
 * XREFs of RtlpHpLfhSubsegmentDelayFreeProcess @ 0x180031BF0
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentDelayFreeProcess(_QWORD *a1, unsigned __int64 a2, int a3)
{
  __int64 result; // rax
  _WORD *v6; // rbp
  __int32 v7; // eax
  ...
  if ( (_WORD)result )
  {
    ...
    if ( a3 || (unsigned __int16)result >= *v6 )
    {
      ...
      v29 = a2 >> 12;
      v8 = (unsigned int)qword_1801CFEC8 ^ *(_DWORD *)(a2 + 40) ^ (unsigned int)(a2 >> 12);
      v9 = *(unsigned __int16 *)(a2 + 34);
      v10 = *(_BYTE *)(a2 + 51);
      v11 = (unsigned __int16)(qword_1801CFEC8 ^ *(_WORD *)(a2 + 40) ^ (a2 >> 12));
      v12 = v10 & 1;
      v13 = a2 + (v8 >> 16);
      v32 = HIWORD(v7);
      v31 = v11;
      ...
      if ( (_WORD)v7 )
      {
        ...
        do
        {
          ...
          if ( *(_DWORD *)(v16 + 8) != ((unsigned int)v16 ^ HIDWORD(a1[10]) ^ __ROL4__(
                                                                                ...
                                                                                *(_WORD *)v16)) )
          {
            RtlpLogHeapFailure(23, (_DWORD)a1, v16, a2, v15, 0LL);
            NT_ASSERT("0");
          }
          if ( !v12 && *(_BYTE *)(a2 + 39) > 1u )
          {
            ...
            v23 = &v20[2
                     * ((((_DWORD)v16
                        - (_DWORD)a2
                        + (*(unsigned __int16 *)(a2 + 40) ^ (unsigned __int16)v29 ^ (unsigned int)(unsigned __int16)qword_1801CFEC8)
                        - 1) >> 12 >> v17)
                      - (unsigned int)v18)
                     + 2];
            if ( v20 < v23 )
            {
              ...
              while ( v20 < v23 );
              if ( v22 )
                RtlpHpLfhContextUpdateFreeCommitCount((__int64)a1, a2, (v22 << 12 << *(_BYTE *)(a2 + 38)) / 4096);
              if ( (_DWORD)v21 != -1 )
