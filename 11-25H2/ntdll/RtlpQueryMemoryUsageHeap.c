/*
 * XREFs of RtlpQueryMemoryUsageHeap @ 0x1800F7AF4
 * Callers:
 *     RtlpQueryExtendedInformationHeap @ 0x18009BDD0 (RtlpQueryExtendedInformationHeap.c)
 *     RtlpHeapQueryTotalReserveSize @ 0x1800F7A60 (RtlpHeapQueryTotalReserveSize.c)
 * Callees:
 *     RtlpGetLowFragHeapMetadataSize @ 0x1800F7BE4 (RtlpGetLowFragHeapMetadataSize.c)
 */
