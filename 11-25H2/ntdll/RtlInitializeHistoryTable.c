/*
 * XREFs of RtlInitializeHistoryTable @ 0x1800F39BC
 * Callers:
 *     LdrpInitializeProcess @ 0x1800D29F4 (LdrpInitializeProcess.c)
 * Callees:
 *     LdrProtectMrdata @ 0x180020A50 (LdrProtectMrdata.c)
 *     RtlLookupFunctionEntry @ 0x180076C90 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x1800F3A7C (RtlpFunctionAddressTableEntry.c)
 */
...
void RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v3 + 8] = v2;
    if ( v4 < qword_1801E9348 )
      qword_1801E9348 = v4;
    if ( v5 > qword_1801E9350 )
      qword_1801E9350 = v5;
  }
