/*
 * XREFs of RtlpHpReallocComputeSizes @ 0x18002D720
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  *a5 = 0LL;
  ...
  else if ( (*(_BYTE *)(v15 + 24) & 0xC) == 8 )
  {
    ...
    v23 = qword_1801CFEC8 ^ v22 ^ (v21 >> 12);
    ...
    if ( v24 == (_DWORD)v25 * (unsigned __int16)v23 )
    {
      ...
      {
        v19 = (unsigned __int16)qword_1801CFEC8 ^ (unsigned int)(unsigned __int16)(v22 ^ (v21 >> 12));
