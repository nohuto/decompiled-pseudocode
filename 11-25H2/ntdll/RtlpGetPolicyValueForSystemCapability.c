/*
 * XREFs of RtlpGetPolicyValueForSystemCapability @ 0x180083D80
 * Callers:
...
LABEL_25:
  ...
  WORD1(v25) = v5;
  *((_QWORD *)&v25 + 1) = v7;
  if ( (unsigned int)(unsigned __int16)v25 + 54 > v5 )
  {
    v15 = -1073741789;
    goto LABEL_26;
  }
  v8 = &v7[2 * ((unsigned __int64)(unsigned __int16)v25 >> 1)];
  memmove(v8, L"Security-System-Capability-", 0x36uLL);
  v9 = WORD1(v25);
  v10 = v25 + 54;
  v11 = (unsigned __int16)(v25 + 54) + 1;
  LOWORD(v25) = v25 + 54;
  if ( v11 < WORD1(v25) )
  {
    *((_WORD *)v8 + 27) = 0;
  ...
  if ( (_WORD)v12 )
  {
    ...
    v13 = (void *)(*((_QWORD *)&v25 + 1) + 2 * ((unsigned __int64)v10 >> 1));
    memmove(v13, a1[1], *(unsigned __int16 *)a1);
    LOWORD(v25) = v12 + v25;
    if ( (unsigned int)(unsigned __int16)v25 + 1 < WORD1(v25) )
      *((_WORD *)v13 + ((unsigned __int64)v12 >> 1)) = 0;
  }
  v14 = ZwQueryLicenseValue(&v25, &v27, 0LL, 0LL, &Size);
  v15 = v14;
  if ( v14 != -1073741789 )
  {
    if ( v14 >= 0 )
  ...
  v16 = Size;
  v17 = Size;
  Heap = (const void *)RtlAllocateHeap((char *)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1310720, (unsigned int)Size);
  v15 = ZwQueryLicenseValue(&v25, &v27, Heap, v16, &Size);
  if ( v15 >= 0 )
  {
    if ( v27 == 1 && v16 && (v16 & 1) == 0 )
    {
      v18 = (_WORD *)RtlpAllocateAtom();
      v19 = v18;
      if ( v18 )
      {
...
LABEL_27:
  if ( Heap )
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (__int64)Heap, v20);
LABEL_29:
  if ( *((_QWORD *)&v25 + 1) )
    RtlpSysVolFree(*((__int64 *)&v25 + 1));
