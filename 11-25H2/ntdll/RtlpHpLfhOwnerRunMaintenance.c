/*
 * XREFs of RtlpHpLfhOwnerRunMaintenance @ 0x180032300
 * Callers:
...
void __fastcall RtlpHpLfhOwnerRunMaintenance(unsigned __int64 a1, __int64 a2, unsigned __int64 *a3, char a4)
{
  ...
  while ( v4 != v5 )
  {
      ...
      && *(_WORD *)(v10 + 18) )
    {
      ...
      v27 = HIWORD(v24);
      v66 = v10 >> 12;
      v28 = (unsigned __int16)(*(_WORD *)(v10 + 40) ^ qword_1801CFEC8 ^ (v10 >> 12));
      v29 = v10
          + ((unsigned __int64)(*(_DWORD *)(v10 + 40) ^ (unsigned int)qword_1801CFEC8 ^ (unsigned int)(v10 >> 12)) >> 16);
      v61 = HIWORD(v24);
      v60 = v28;
      if ( (_DWORD)v25 == HIWORD(v24) + *(unsigned __int16 *)(v10 + 32) )
      {
        if ( *(_BYTE *)(v10 + 39) != 1 )
          goto LABEL_36;
        RtlpHpLfhBlockBitmapInitialize(v10 + 64, v25);
        *(_WORD *)(v10 + 32) += v27;
        v8 = a2;
        v7 = a3;
        *(_BYTE *)(v10 + 36) = 0;
          ...
          if ( (_WORD)v64 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( *(_DWORD *)(v34 + 8) != ((unsigned int)v34 ^ HIDWORD(v9[10]) ^ __ROL4__(
                                                                                    ...
                                                                                    *(_WORD *)v34)) )
              {
                RtlpLogHeapFailure(23, (_DWORD)v9, v34, v10, v33, 0LL);
                NT_ASSERT("0");
              }
              if ( v26 )
                goto LABEL_55;
              ...
              v41 = &v38[2
                       * ((((_DWORD)v34
                          - (_DWORD)v10
                          + (v31 ^ *(unsigned __int16 *)(v10 + 40) ^ (unsigned int)(unsigned __int16)qword_1801CFEC8)
                          - 1) >> 12 >> v35)
                        - (unsigned int)v36)
                       + 2];
              if ( v38 >= v41 )
...
LABEL_55:
              ...
              else
              {
                v43 = v39;
                v44 = (_QWORD *)a1;
                RtlpHpLfhSubsegmentDecommitPages(a1, v10, v43, 2u);
              }
        ...
        RtlpHpLfhSubsegmentDelayFreeListBatch((_DWORD)v9, v10, v24, v29, v28);
        *(_WORD *)(v10 + 32) += v27;
        v8 = a2;
        v7 = a3;
      }
    ...
    else if ( (v6 & 4) != 0 && *(_BYTE *)(v10 + 39) == 1 )
    {
      ...
      if ( v13 )
      {
        if ( (*(_BYTE *)v8 & 1) != 0 || (*(_QWORD *)(v8 + 56) ^ v10) - 1 > 0xFFE )
        {
          ...
          {
            v15 = 2
                * ((unsigned __int16)qword_1801CFEC8 ^ *(unsigned __int16 *)(v10 + 40) ^ (unsigned __int16)(v10 >> 12));
            if ( ((v15 - 1) & v15) != 0 )
            {
          ...
          if ( v18 != *(unsigned __int8 *)(v10 + 38) )
          {
            ...
            if ( (unsigned int)v20 >= *(unsigned __int16 *)(v10 + 34) )
            {
              ...
              if ( (unsigned int)RtlpHpLfhSubsegmentReformatCheck(v20, v10, &v63, &v62) )
              {
                ...
                HIBYTE(v59) = v19;
                *(_WORD *)(v10 + 38) = v59;
                v21 = (_WORD *)(v10 + 8LL * *(unsigned __int8 *)(v10 + 24));
                memset_thunk_772440563353939046(v21, 0, 2LL * v19);
                RtlpHpLfhSubsegmentConstructCommitState(v22, v10, (_QWORD *)(v10 + 64), v21);
