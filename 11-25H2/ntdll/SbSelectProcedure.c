      ...
      if ( v16 )
      {
        ...
        if ( v17 )
        {
          if ( *((_DWORD *)v17 + 12) && *((_DWORD *)v17 + 3) )
          {
            ...
            if ( v22 )
              goto LABEL_35;
            v23 = EtwNotificationRegister((unsigned int)&MS_Windows_AeSwitchBack_Provider, 3, 0, 0, (__int64)&v62);
            if ( v23 )
            {
...
LABEL_35:
              ...
              *((_QWORD *)&v71 + 1) = v32;
              *(_QWORD *)&v70 = &v58;
              EtwpEventWriteFull(v22, (unsigned int)&AeSbCallEvent, 0, 0, 0, 0LL, 0LL, 5, (__int64)&v67);
            }
          }
        }
      }
      ...
      if ( v19 )
      {
        ...
        if ( v20 )
        {
          if ( *((_DWORD *)v20 + 12) && *((_DWORD *)v20 + 3) )
          {
            ...
            if ( v24 )
              goto LABEL_44;
            v25 = EtwNotificationRegister((unsigned int)&MS_Windows_AeSwitchBack_Provider, 3, 0, 0, (__int64)&v63);
            if ( v25 )
            {
...
LABEL_44:
              ...
              v78 = &v60;
              v82 = 0;
              EtwpEventWriteFull(v24, (unsigned int)&AeSbImplEvent, 0, 0, 0, 0LL, 0LL, 5, (__int64)v75);
            }
          }
        }
      }
