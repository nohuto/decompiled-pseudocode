/*
 * XREFs of _SafeReallocBlob @ 0x180116A54
 * Callers:
 *     RtlpMuiRegConfigListAddLanguage @ 0x1800F8B78 (RtlpMuiRegConfigListAddLanguage.c)
 *     RtlpMuiRegGrowLanguages @ 0x18014AF9C (RtlpMuiRegGrowLanguages.c)
 *     RtlpMuiRegResizeLanguageList @ 0x18014B034 (RtlpMuiRegResizeLanguageList.c)
 * Callees:
 *     <none>
 */
