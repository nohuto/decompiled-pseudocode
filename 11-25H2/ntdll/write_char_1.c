/*
 * XREFs of write_char_1 @ 0x180130868
 * Callers:
 *     _output_s @ 0x18012FDF0 (_output_s.c)
 *     write_multi_char_1 @ 0x1801308B8 (write_multi_char_1.c)
 *     write_string_1 @ 0x180130910 (write_string_1.c)
 * Callees:
 *     _flsbuf_s @ 0x180132F30 (_flsbuf_s.c)
 */
