        ...
        PULONG64 AttributesPresent)
{
  ...
  if ( AttributesPresent )
  {
    *AttributesPresent |= (2LL * v12) | 1;
    if ( ZwQuerySecurityAttributesToken(TokenHandle, (PUNICODE_STRING)&stru_1801759C8, 1u, 0LL, 0, &ReturnLength) == -1073741789 )
      *AttributesPresent |= 4uLL;
    v16 = ZwQuerySecurityAttributesToken(TokenHandle, (PUNICODE_STRING)&stru_1801759B8, 1u, 0LL, 0, &ReturnLength);
    v15 = v28;
    if ( v16 == -1073741789 )
