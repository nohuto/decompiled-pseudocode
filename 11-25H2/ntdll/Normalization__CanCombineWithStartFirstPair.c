/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x18011BE28
 * Callers:
 ...
 *     Normalization__GetFirstDecomposedCharPlane0 @ 0x1801485E8 (Normalization__GetFirstDecomposedCharPlane0.c)
