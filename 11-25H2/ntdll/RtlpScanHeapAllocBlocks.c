/*
 * XREFs of RtlpScanHeapAllocBlocks @ 0x180093C84
 * Callers:
...
char RtlpScanHeapAllocBlocks()
{
      ...
      if ( HeapBlock )
      {
        if ( !*(_DWORD *)(HeapBlock + 32) )
        {
          ...
          if ( *(_QWORD *)(*(_QWORD *)HeapBlock + 8LL) != HeapBlock
            ...
            || (*v13 = v12,
                *(_QWORD *)(v12 + 8) = v13,
                v14 = (__int64 *)qword_1801D5EE8,
                *(__int64 **)qword_1801D5EE8 != &RtlpBusyList) )
          {
            __fastfail(3u);
          }
  ...
  if ( *((_QWORD *)&xmmword_1801D6060 + 1) )
    (*((void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))&xmmword_1801D6060 + 1))(
      0LL,
      0LL,
      0LL,
      0LL,
