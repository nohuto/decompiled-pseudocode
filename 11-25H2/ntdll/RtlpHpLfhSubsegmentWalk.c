/*
 * XREFs of RtlpHpLfhSubsegmentWalk @ 0x1800D4910
 * Callers:
 *     RtlpHpSegWalk @ 0x18009B5D0 (RtlpHpSegWalk.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x1800D4AE0 (RtlpHpLfhSubsegmentSizeBlockInternal.c)
        ...
        __int64 a7)
{
  ...
  v8 = 0LL;
  v10 = qword_1801CFEC8 ^ *(_DWORD *)(a2 + 40) ^ (a2 >> 12);
  v24[0] = v10;
  if ( a3 == a2 )
  {
    v11 = 0;
