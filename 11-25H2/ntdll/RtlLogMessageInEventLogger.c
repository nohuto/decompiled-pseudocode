...
int __fastcall RtlLogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3, __int64 a4, unsigned __int16 a5)
{
  ...
  {
    LODWORD(v5) = LdrLoadDll(0LL, 0LL, (PUNICODE_STRING)&stru_180176EA8, &DllHandle);
    if ( (int)v5 >= 0 )
    {
      if ( LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180176E88, 0, &ProcedureAddress) >= 0
        && LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180176EC8, 0, &v16) >= 0
        && LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180176EB8, 0, &v15) >= 0 )
      {
