/*
 * XREFs of RtlCaptureContext2 @ 0x180122820
 * Callers:
 *     RtlUnwindEx @ 0x180077090 (RtlUnwindEx.c)
 * Callees:
 *     RtlpSanitizeContextFlags @ 0x1800D7FF0 (RtlpSanitizeContextFlags.c)
 *     RtlpMergeContextXState @ 0x1800DE670 (RtlpMergeContextXState.c)
 */
