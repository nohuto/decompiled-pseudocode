/*
 * XREFs of RtlpCombineAcls @ 0x1800631C0
 * Callers:
...
LABEL_25:
  ...
  v53 = v21 & 0xFFFFFFFC;
  Heap = RtlAllocateHeap((char *)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1310720, v21 & 0xFFFFFFFC);
  ...
  if ( Acl >= 0 )
  {
    ...
    for ( i = 0; ; ++i )
    {
      v26 = (unsigned __int64)v13 + v13[1];
      if ( i >= v13[2] )
        break;
