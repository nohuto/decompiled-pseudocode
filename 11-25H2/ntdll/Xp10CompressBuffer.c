/*
 * XREFs of Xp10CompressBuffer @ 0x18014FF20
 * Callers:
 *     RtlCompressBufferXp10 @ 0x18014E8F0 (RtlCompressBufferXp10.c)
 * Callees:
 *     Xp10ComputeAndWriteCrc @ 0x1801504E8 (Xp10ComputeAndWriteCrc.c)
 *     Xp10ExecuteHuffmanEncode @ 0x18015060C (Xp10ExecuteHuffmanEncode.c)
 *     Xp10ExecuteLz77PassMinMatchLen3 @ 0x180150AA0 (Xp10ExecuteLz77PassMinMatchLen3.c)
 *     Xp10ExecuteLz77PassMinMatchLen4 @ 0x1801511DC (Xp10ExecuteLz77PassMinMatchLen4.c)
 *     Xp10ValidateParametersAndFillFrameHeader @ 0x1801519DC (Xp10ValidateParametersAndFillFrameHeader.c)
...
LABEL_13:
    ...
    if ( v17 + 32 <= v18 || (v25 = v18 - v17, v18 != v17) )
    {
      ...
      if ( v29 >= v25 )
        v30 = v25;
      *v28 |= ((unsigned __int8)(v48.m128i_i8[8] - v17) & (unsigned __int8)byte_180188138[4 * v30]) << v27;
      ...
      if ( (_DWORD)v31 )
        *v33 |= (unsigned __int8)v32 & byte_180188138[4 * v31];
      v17 += v25;
    }
    v19 += v46;
    v16 = v48.m128i_u32[3];
  ...
  if ( v36 <= v18 || (v39 = v18 - v35, v18 != v35) )
  {
    ...
    *v37++ |= (byte_180188138[4 * v41] & 1) << v38;
    v43 = 1u >> v40;
    ...
    if ( (_DWORD)v42 )
      *v37 |= (unsigned __int8)v43 & byte_180188138[4 * v42];
  }
  DWORD2(v49) = 0;
  *(_QWORD *)&v49 = a2;
  HIDWORD(v49) = a3;
