/*
 * XREFs of CsrpConnectToServer @ 0x180035EC0
 * Callers:
 ...
 *     ZwConnectPort @ 0x180164690 (ZwConnectPort.c)
...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, _QWORD *a3, int a4, _DWORD *a5)
{
  ...
  *(_QWORD *)&v28 = 0LL;
  ...
  if ( (unsigned __int64)(2 * v9 + 28) > 0xFFFF )
    return 3221225734LL;
  word_1801D6EA2 = 2 * v9 + 28;
  Heap = (char *)RtlAllocateHeap((void *)CsrHeap);
  qword_1801D6EA8 = (__int64)Heap;
  v13 = Heap;
  if ( !Heap )
    return 3221225495LL;
  memmove(Heap, Src, v10);
  *(_WORD *)&v13[v10] = 92;
  v14 = (size_t)&v13[v10 + 2];
  *(_OWORD *)v14 = *(_OWORD *)L"SharedSection";
  *(_QWORD *)(v14 + 16) = *(_QWORD *)L"ction";
  *(_WORD *)(v14 + 24) = aSharedsection[12];
  v32[0] = 48;
  CsrPortName = v14 - qword_1801D6EA8 + 26;
  v34 = &CsrPortName;
  v33 = 0LL;
  v35 = 64;
  v37 = 0LL;
  ...
  if ( v15 >= 0 )
  {
    ...
    *(_DWORD *)(v14 + 8) = *(_DWORD *)L"ort";
    *(_WORD *)(v14 + 12) = aApiport[6];
    CsrPortName = v14 - qword_1801D6EA8 + 14;
    HIDWORD(v45) = 2;
    LOWORD(v46) = 257;
    v23 = 0x10000LL;
    v16 = NtCreateSection(&Handle, 983071LL, 0LL);
    if ( v16 < 0 )
      goto LABEL_24;
    *((_QWORD *)&v26 + 1) = Handle;
...
LABEL_24:
    ...
    else
    {
      ...
      *a5 = DWORD1(v40);
      ...
      if ( v16 >= 0 )
      {
        ...
        v42 = 4096LL;
        v43 = *((_QWORD *)&v27 + 1);
        CsrPortHeap = RtlpCreateHeap(0x8000, v28, DWORD2(v27), 1, 0LL, (__int64)v41, 0);
        if ( CsrPortHeap )
        {
          CsrPortBaseTag = 0;
          return 0LL;
    ...
    NtClose(v19);
LABEL_21:
    RtlFreeHeap(CsrHeap, 0LL, qword_1801D6EA8);
