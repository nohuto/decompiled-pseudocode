...
__int64 __fastcall RtlpHpExtrasSetPresent(__int64 a1, unsigned __int64 a2)
{
  ...
  {
    v15 = RtlCSparseBitmapBitmaskRead((__int64)&unk_1801D0980, 2 * ((a2 - qword_1801D0978) >> 20));
  ...
  else
  {
    ...
    if ( v11 == 8 )
    {
      ...
      result = (unsigned __int16)qword_1801CFEC8;
      *(_WORD *)(((unsigned __int16)qword_1801CFEC8 ^ v14 ^ v13) + a2 - 2) |= 0x4000u;
    }
    else
    {
      v17 = a2 - 16;
