/*
 * XREFs of RtlpQueryProcessMachine @ 0x180098084
 * Callers:
...
__int64 __fastcall RtlpQueryProcessMachine(__int64 a1, _WORD *a2)
{
  ...
  v12 = 20;
  v3 = (unsigned int *)v14;
  v4 = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, _BYTE *, int, unsigned int *))NtQuerySystemInformationEx)(
         230LL,
         &v13,
         8LL,
         v14,
  ...
  if ( v4 == -1073741789 )
  {
    ...
    v8 = alloca(v6);
    v3 = &v12;
    v4 = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, unsigned int *, unsigned int, unsigned int *))NtQuerySystemInformationEx)(
           230LL,
           &v13,
           8LL,
           &v12,
