/*
 * XREFs of LZ4HC_compress_generic_dictCtx @ 0x180100EFC
 * Callers:
 *     LZ4HC_compress_generic @ 0x1800FE55C (LZ4HC_compress_generic.c)
 * Callees:
 *     LZ4HC_countPattern @ 0x1800F9F7C (LZ4HC_countPattern.c)
 *     LZ4HC_reverseCountPattern @ 0x1800F9FD8 (LZ4HC_reverseCountPattern.c)
 *     LZ4HC_rotatePattern @ 0x180115818 (LZ4HC_rotatePattern.c)
 *     LZ4HC_setExternalDict @ 0x18011F224 (LZ4HC_setExternalDict.c)
