...
__int64 __fastcall RtlSetImageMitigationPolicy(const wchar_t *a1, int a2, char a3, _QWORD *a4, int a5)
{
  ...
  int v148; // [rsp+40h] [rbp-61h] BYREF
  __int128 v149; // [rsp+48h] [rbp-59h] BYREF
  __int128 v150; // [rsp+58h] [rbp-49h] BYREF
  __int128 v151; // [rsp+68h] [rbp-39h] BYREF
  __int128 v152; // [rsp+78h] [rbp-29h] BYREF
  unsigned __int64 v153; // [rsp+88h] [rbp-19h]
  char v154[8]; // [rsp+90h] [rbp-11h] BYREF
  ...
  v151 = 0LL;
  v152 = 0LL;
  inited = RtlInitUnicodeStringEx((__int64)&v150, v7);
  if ( inited >= 0 )
  {
    inited = RtlInitUnicodeStringEx((__int64)&v149, L"EAFModules");
    if ( inited >= 0 )
    {
      if ( (v9 || v8) && (a5 || a4) )
        goto LABEL_310;
      inited = RtlInitUnicodeStringEx((__int64)&v151, a1);
      if ( inited >= 0 )
      {
        v13 = a1
            ? RtlpOpenImageFileOptionsKeyEx((unsigned __int16 *)&v151, 0x2000Fu, v8 == 0, &Handle)
            : RtlpOpenSystemSessionKey(0x2000Fu, (__int64)&Handle);
        inited = v13;
        if ( v13 >= 0 )
        {
          v14 = NtQueryValueKey(Handle, &v150, 2LL, v154, 40, &v148);
          inited = v14;
          if ( v14 >= 0 )
          {
            if ( Size > 0x18 )
          ...
          if ( a2 <= 9 )
          {
            ...
            if ( !a2 )
            {
              if ( v9 )
              {
                *(_QWORD *)&v152 = v152 & 0xFFFFFFFFFFFFFFF0uLL;
                goto LABEL_309;
              }
              if ( a5 != 8 )
                goto LABEL_310;
              ...
              v46 = v152 & 0xFFFFFFFFFFFFFFF0uLL;
              goto LABEL_148;
            }
            v15 = a2 - 1;
            if ( v15 )
...
LABEL_32:
                          *(_QWORD *)&v152 = v21 & v152;
LABEL_309:
                          inited = ZwSetValueKey(Handle, &v150, 0LL, 3LL, &v152, 24);
                          goto LABEL_311;
                        }
                        if ( a5 == 16 )
                        {
                          ...
                          *(_QWORD *)&v152 = v152 & 0xFFFF0FFFFFFFFFFFuLL | v25;
                          v27 = v22 & 3;
                          if ( v27 )
                          {
                            if ( v27 == 2LL )
                      ...
                      if ( v9 )
                      {
                        v152 &= __PAIR128__(-3841LL, 0xFFFFF0FFFFFFFFFFuLL);
                        goto LABEL_309;
                      }
                      if ( a5 == 16 )
                      {
                        ...
                        if ( (*a4 & 3) != 0 )
                        {
                          if ( (*a4 & 3LL) == 2 )
                          {
                            v39 = v152 & 0xFFFFF0FFFFFFFFFFuLL | ((v36 != 0 ? 6LL : 2LL) << 40);
                            v38 = *((_QWORD *)&v152 + 1);
                            *(_QWORD *)&v152 = v39;
                          ...
                          if ( (*(_BYTE *)a4 & 8) != 0 )
                            ...
                            v40 = v36 != 0 ? 5LL : 1LL;
                          v38 = *((_QWORD *)&v152 + 1);
                          *(_QWORD *)&v152 = v152 & 0xFFFFF0FFFFFFFFFFuLL | (v40 << 40);
                          v41 = v34 & 3;
                          if ( v41 )
                          {
                            if ( v41 != 2LL )
                        ...
                        {
                          v37 = v152 & 0xFFFFF0FFFFFFFFFFuLL | -(__int64)(v36 != 0) & 0x40000000000LL;
                          v38 = *((_QWORD *)&v152 + 1);
                          *(_QWORD *)&v152 = v37;
                          if ( (v34 & 3) == 2 )
                          {
...
LABEL_310:
                  ...
                  if ( v9 )
                  {
                    *(_QWORD *)&v152 = v152 & 0xFFFFFFFF0FFFFFFFuLL;
                  ...
                  *(_QWORD *)&v152 = v152 & 0xFFFFFFFF0FFFFFFFuLL | v48;
                  v50 = a4[1] & 4LL;
                  if ( (a4[1] & 3) != 0 )
                  {
                    if ( (a4[1] & 3LL) == 2 )
...
LABEL_93:
                ...
                if ( v9 )
                {
                  *(_QWORD *)&v152 = v152 & 0xFFFFFFFFF0FFFFFFuLL;
                  goto LABEL_309;
                }
                if ( a5 != 8 )
                  goto LABEL_310;
                ...
                v46 = v152 & 0xFFFFFFFFF0FFFFFFuLL;
                goto LABEL_148;
              }
              if ( v9 )
              {
...
LABEL_76:
            ...
            if ( v9 )
            {
              *(_QWORD *)&v152 = v152 & 0xFFFFFFFFFF00F0FFuLL;
              goto LABEL_309;
            }
            if ( a5 != 24 )
              goto LABEL_310;
            ...
            v66 = v60 & 3;
            v67 = v152 & 0xFFFFFFFFFFF0F0FFuLL | v65 & 0xFFFFFFFFFFF0FFFFuLL;
            if ( v66 )
            {
              if ( v66 == 2 )
                v69 = v62 != 0 ? 6LL : 2LL;
...
LABEL_308:
          ...
          if ( !v77 )
          {
            if ( v9 )
            {
              *(_QWORD *)&v152 = v152 & 0xFFFFFFFFFFFFFLL;
              goto LABEL_309;
            }
            if ( a5 != 24 )
              goto LABEL_310;
            ...
            v140 = v133 & 3;
            v141 = v152 & 0xF00FFFFFFFFFFFFFuLL | v138 & 0xF0FFFFFFFFFFFFFFuLL;
            if ( v140 )
            {
              if ( v140 == 2 )
                v143 = v136 != 0 ? 6LL : 2LL;
              ...
              if ( v80 )
              {
                ...
                if ( v81 )
                {
                  ...
                  if ( !v82 )
                  {
                    if ( v9 )
                    {
                      *((_QWORD *)&v152 + 1) &= 0xFFFFFFFFFFFFFFFuLL;
                    ...
                    if ( a5 == 24 )
                    {
                      ...
                      *((_QWORD *)&v152 + 1) = *((_QWORD *)&v152 + 1) & 0xFFFFFFFFFFFFFFFLL | v91;
                      v93 = v87 & 3;
                      if ( v93 )
                      {
                        if ( v93 == 2LL )
                ...
                if ( v9 )
                {
                  *(_QWORD *)&v152 = v152 & 0xFFFFFFFFFFFF0FFFuLL;
                  goto LABEL_309;
                }
                if ( a5 != 8 )
                  goto LABEL_310;
                ...
                v46 = v152 & 0xFFFFFFFFFFFF0FFFuLL;
              }
              else
              {
                if ( v9 )
                {
                  *(_QWORD *)&v152 = v152 & 0xFFFFFFFFFFFFFF0FuLL;
                  goto LABEL_309;
                }
                if ( a5 != 8 )
                  goto LABEL_310;
                ...
                v46 = v152 & 0xFFFFFFFFFFFFFF0FuLL;
              }
LABEL_148:
              *(_QWORD *)&v152 = v46 | v43;
              goto LABEL_309;
            ...
            if ( v9 )
            {
              *((_QWORD *)&v152 + 1) &= 0xFFFFFF0FFFFFFFFFuLL;
              goto LABEL_309;
            }
            if ( a5 != 8 )
              goto LABEL_310;
            ...
            v32 = 0xFFFFFF0FFFFFFFFFuLL;
LABEL_49:
            v33 = v32 & *((_QWORD *)&v152 + 1);
LABEL_50:
            *((_QWORD *)&v152 + 1) = v33 | v31;
            goto LABEL_309;
          }
          if ( v9 )
          {
            *((_QWORD *)&v152 + 1) &= 0xFFFFF0F00000FFFFuLL;
            if ( !v10 )
              ZwDeleteValueKey(Handle, &v149);
            goto LABEL_309;
          }
          if ( a5 != 1072 )
            goto LABEL_310;
          if ( v10 || (inited = ZwSetValueKey(Handle, &v149, 0LL, 1LL, a4 + 6, 1024), inited >= 0) )
          {
            v102 = a4[3] & 4LL;
            if ( (a4[3] & 3) != 0 )
            {
            ...
            v105 = a4[4] & 4LL;
            v106 = a4[4] & 3LL;
            v107 = *((_QWORD *)&v152 + 1) & 0xFFFFFFFFFF00FFFFuLL | v103 & 0xFFFFFFFFFF0FFFFFuLL;
            if ( v106 )
            {
              if ( v106 == 2 )
                v109 = v105 != 0 ? 6LL : 2LL;
