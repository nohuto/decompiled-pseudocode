        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  while ( v12 < v10 )
  {
    ...
    if ( v12 == v10 - 1 && v9 )
      v16 |= byte_180181958[SizeOfBitMap & 7];
    if ( !v16 )
    {
      LODWORD(v13) = v13 + 8;
      goto LABEL_6;
...
LABEL_6:
  ...
  if ( (_DWORD)v13 )
  {
    if ( v11 >= v5 )
    {
      if ( v4[v11 - 1].NumberOfBits >= (unsigned int)v13 )
        return v11;
    }
    else
    {
    ...
    {
      v36 = v35;
      for ( n = &v4[v35 + 1]; v36 >= 0 && n[-1].NumberOfBits < (unsigned int)v13; --n )
      {
        --v35;
        --v36;
        *n = n[-1];
    ...
    v4[v35 + 1].NumberOfBits = v13;
    v4[v35 + 1].StartingIndex = v14;
  }
  return v11;
}
