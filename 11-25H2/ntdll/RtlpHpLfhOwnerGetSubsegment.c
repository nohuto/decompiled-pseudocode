/*
 * XREFs of RtlpHpLfhOwnerGetSubsegment @ 0x1800316D0
 * Callers:
...
unsigned __int64 __fastcall RtlpHpLfhOwnerGetSubsegment(_QWORD *a1, __int64 a2)
{
  __int64 v2; // rbx
  _QWORD *v3; // r8
  _QWORD *v4; // r9
...
LABEL_49:
  ...
  if ( v8 && v8 >= (unsigned __int16)v9 )
  {
    ...
    v14 = HIWORD(v11);
    v15 = (unsigned __int16)(qword_1801CFEC8 ^ *(_WORD *)(v7 + 40) ^ (v7 >> 12));
    v16 = v7
        + ((unsigned __int64)((unsigned int)qword_1801CFEC8 ^ *(_DWORD *)(v7 + 40) ^ (unsigned int)(v7 >> 12)) >> 16);
    v48 = HIWORD(v11);
    v47 = v15;
    v41 = v16;
...
LABEL_10:
      ...
      while ( 2 )
      {
        ...
        if ( *(_DWORD *)(v20 + 8) != ((unsigned int)v20 ^ HIDWORD(a1[10]) ^ __ROL4__(
                                                                              ...
                                                                              *(_WORD *)v20)) )
        {
          RtlpLogHeapFailure(23, (_DWORD)a1, v20, v7, v19, 0LL);
          NT_ASSERT("0");
        }
        if ( !v12 && *(_BYTE *)(v7 + 39) > 1u )
        {
          ...
          v26 = &v24[2
                   * ((((_DWORD)v20
                      - (_DWORD)v7
                      + (*(unsigned __int16 *)(v7 + 40) ^ (unsigned __int16)(v7 >> 12) ^ (unsigned int)(unsigned __int16)qword_1801CFEC8)
                      - 1) >> 12 >> v21)
                    - (unsigned int)v22)
                   + 2];
          if ( v24 >= v26 )
          ...
          while ( v24 < v26 );
          if ( v25 )
            RtlpHpLfhContextUpdateFreeCommitCount((__int64)a1, v7, (v25 << 12 << *(_BYTE *)(v7 + 38)) / 4096);
          if ( (_DWORD)v18 == -1 )
          {
            LODWORD(v18) = -1;
          }
