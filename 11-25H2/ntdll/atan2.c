...
LABEL_53:
  ...
  if ( v7 >= -28 || X < 0.0 )
  {
    ...
    else
    {
      ...
      v25 = qword_18018E0F0[v24];
      v26 = qword_18018D960[v24];
    ...
    if ( v20 )
    {
      v26 = *(double *)&qword_1801CEAD8 - v26;
      v22 = *(double *)&qword_1801CEAE0 - v22;
    }
    if ( X < 0.0 )
    {
      v26 = *(double *)&qword_1801CEAC8 - v26;
      v22 = *(double *)&qword_1801CEAD0 - v22;
    }
    v32 = v26 + v22;
    if ( v3 < 0.0 )
      *(_QWORD *)&v32 ^= _xmm;
