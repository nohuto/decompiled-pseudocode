/*
 * XREFs of RtlpHpLfhContextPrivateHeatMapCreate @ 0x180009B7C
 * Callers:
...
unsigned __int64 *__fastcall RtlpHpLfhContextPrivateHeatMapCreate(__int64 a1, __int64 a2)
{
  ...
  v5 = (unsigned __int64 *)RtlpHpLfhContextMetadataAllocate((_RTL_SRWLOCK *)a1, 1);
  v3 = v5;
  v6 = v5;
  if ( !v5 )
    return (unsigned __int64 *)(a1 + 192);
  ...
  *((_DWORD *)v3 + 63) = MEMORY[0x7FFE0008] >> 20;
  ...
  if ( (int)RtlpHpEnvTlsSetValue(*(unsigned int *)(a1 + 76), a2) < 0 )
  {
