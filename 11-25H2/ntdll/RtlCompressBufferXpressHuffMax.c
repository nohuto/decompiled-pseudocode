/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x1800C4ED0
 * Callers:
...
LABEL_88:
    ...
    do
    {
      v19 = (unsigned __int16)word_1801990E0[v17[2]] ^ (unsigned __int16)XpressHashFunction[*v17] ^ (unsigned __int64)(unsigned __int16)word_180198EE0[v17[1]];
      v20 = *(_QWORD *)&a6[8 * v19];
      *(_QWORD *)&a6[8 * v19] = v17++;
