...
NTSTATUS __cdecl RtlCopyContext(PCONTEXT Context, ULONG ContextFlags, PCONTEXT Source)
{
  int v3; // ebx
  PCONTEXT v4; // r10
  __int64 XmmRegisters; // r15
  bool v8; // cl
  NTSTATUS result; // eax
  int *p_ContextFlags; // r12
  int *v11; // rsi
  int v12; // r12d
  int v13; // esi
  ULONG v14; // r9d
  ...
  if ( (ContextFlags & 0x400020) != 0x400020 )
    v8 = (ContextFlags & 0x10040) != 65600 && (ContextFlags & 0x100040) != 1048640;
  if ( !v8 && !MEMORY[0x7FFE03D8] || (ContextFlags & 0x100080) == 0x100080 )
    return -1073741637;
...
LABEL_37:
  *v22 |= v12;
  if ( (v25 & 0xFFFFFFFE) != 0 )
  {
    ...
    {
      XmmRegisters = (__int64)&v4[1];
      v3 = (_DWORD)Context + 1232;
    }
    else if ( (ContextFlags & 0x200000) != 0 )
    {
      XmmRegisters = (__int64)v4->FltSave.XmmRegisters;
      v3 = (_DWORD)Context + 416;
    }
    else if ( (ContextFlags & 0x400000) != 0 )
    {
      XmmRegisters = (__int64)&v4->VectorRegister[9];
      v3 = (_DWORD)Context + 912;
    }
  }
  if ( (v19 & 2) == 0 )
    return v21;
  result = RtlpCopyXStateChunk(v20, v3, v3, XmmRegisters, XmmRegisters);
  v21 = result;
  if ( result >= 0 )
    return v21;
  return result;
