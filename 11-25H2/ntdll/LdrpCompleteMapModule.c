...
__int64 __fastcall LdrpCompleteMapModule(__int64 a1, __int64 a2, int a3)
{
  ...
  RtlImageNtHeaderEx(1, v10, 0LL, &v25);
  if ( !v25 )
  {
LABEL_13:
    if ( (*(_WORD *)(a2 + 22) & 0x2000) != 0 )
    {
      if ( *(char *)(a1 + 32) >= 0 || *(char *)(a2 + 94) < 0 )
      {
        if ( (*(_DWORD *)(v3 + 104) & 0x1000000) == 0 && (a3 == 1073741827 || a3 == 1073741878) )
        {
          ...
          if ( a3 == 1073741827 && (v23 = LdrpRelocateImage(*(_QWORD *)(v3 + 48)), v4 = v23, v23 < 0) )
          {
  ...
  if ( v11 == 267 )
  {
    if ( *(_DWORD *)(v25 + 116) > 0xEu )
    {
      v12 = *(unsigned int *)(v25 + 232);
      if ( (_DWORD)v12 )
        goto LABEL_8;
      v13 = -1073741822;
      goto LABEL_10;
...
LABEL_41:
  ...
  if ( v11 != 523 || *(_DWORD *)(v25 + 132) <= 0xEu )
    goto LABEL_41;
  v12 = *(unsigned int *)(v25 + 248);
  if ( (_DWORD)v12 )
  {
LABEL_8:
    if ( v9 || (unsigned int)v12 < *(_DWORD *)(v25 + 84) )
    {
      v5 = v10 + v12;
      v13 = 0;
    }
    ...
    {
      v5 = RtlAddressInSectionTable(v25, v10, v12);
      v16 = 0;
      if ( !v5 )
        v16 = -1073741811;
      v13 = v16;
