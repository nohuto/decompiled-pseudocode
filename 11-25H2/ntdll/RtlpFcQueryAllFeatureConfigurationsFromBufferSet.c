/*
 * XREFs of RtlpFcQueryAllFeatureConfigurationsFromBufferSet @ 0x18017360C
 * Callers:
 *     RtlQueryAllFeatureConfigurations @ 0x1800A02B0 (RtlQueryAllFeatureConfigurations.c)
 * Callees:
 *     RtlpFcValidateFeatureConfigurationType @ 0x1800F9B94 (RtlpFcValidateFeatureConfigurationType.c)
