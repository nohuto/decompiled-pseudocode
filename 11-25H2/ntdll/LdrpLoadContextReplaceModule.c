/*
 * XREFs of LdrpLoadContextReplaceModule @ 0x18006F2DC
 * Callers:
 ...
 *     LdrpDependencyExist @ 0x1800DDC40 (LdrpDependencyExist.c)
 */

__int64 __fastcall LdrpLoadContextReplaceModule(__int64 a1, __int64 a2)
{
  __int64 v4; // r8
  __int64 v5; // rdi
  int v6; // eax
