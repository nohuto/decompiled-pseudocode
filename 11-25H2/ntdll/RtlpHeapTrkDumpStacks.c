...
char RtlpHeapTrkDumpStacks()
{
  ...
  if ( !TrkContext )
    return 0;
  *(_DWORD *)(TrkContext + 64) = dword_1801D020C;
  if ( dword_1801D0830 )
  {
    v7 = 0LL;
    ...
    do
    {
      *(_QWORD *)(TrkContext + 72) += *(_QWORD *)(*(_QWORD *)(v7 + qword_1801D0880) + 16LL);
...
LABEL_5:
  if ( v2 < 0x1EEF )
  {
    ...
    if ( RtlTryAcquireSRWLockExclusive(*(volatile signed __int32 **)(qword_1801D0838 + 8 * v3)) )
    {
      while ( 1 )
      {
        if ( v5 == (__int64 *)(v4 + qword_1801D0288) )
        {
          RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_1801D0838 + 8 * v3));
          ++v2;
          goto LABEL_5;
        }
