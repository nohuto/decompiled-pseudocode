/*
 * XREFs of RtlpComputeLangListCheckSum @ 0x18005CCE0
 * Callers:
...
LABEL_8:
    ...
    if ( (__int16)v8 > 0 )
    {
      ...
      *(_OWORD *)v31 = 0LL;
      ...
      v19 = (const void *)(*(_QWORD *)(v17 + 24) + 2 * v18);
      v20 = 0;
      if ( v19 )
      {
        v21 = wcslen((const wchar_t *)(*(_QWORD *)(v17 + 24) + 2 * v18));
        if ( v21 > 0x7FFE )
          return -1073741562;
        v20 = 2 * v21;
      }
      ...
      if ( v20 > 0xAAu )
        v11 = 170LL;
      String.Length = v11;
      memmove(v34, v19, (unsigned int)v11);
      if ( (unsigned __int64)(v11 + 2) <= 0xAA )
        v34[(unsigned __int64)(unsigned int)v11 >> 1] = 0;
    }
    else
    {
...
LABEL_16:
        ...
        if ( qword_1801CF038 && (unsigned __int16)v14 >= 0xC0u )
        {
          v15 = *(_WORD *)(qword_1801CF038
                         + 2
                         * ((v14 & 0xF)
                          + *(unsigned __int16 *)(qword_1801CF038
                                                + 2LL
                                                * (((unsigned __int8)v14 >> 4)
                                                 + (unsigned int)*(unsigned __int16 *)(qword_1801CF038 + 2 * (v14 >> 8))))))
              + v14;
          LOWORD(v14) = v15;
          goto LABEL_16;
        }
