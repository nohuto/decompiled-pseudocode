/*
 * XREFs of WerEscalationLazyInit @ 0x1800DF9C0
 * Callers:
 *     WerReportSQMEvent @ 0x1800DF680 (WerReportSQMEvent.c)
 ...
 *     StringCchCopyW @ 0x1800E0668 (StringCchCopyW.c)
...
__int64 WerEscalationLazyInit()
{
  ...
  if ( appended >= 0 )
  {
    ...
    if ( v7 != (unsigned int)(i - Buffer) )
    {
      do
      {
        v20 = NLS_UPCASE(qword_1801CF038, *i);
        v21 = v10 * v9;
