/*
 * XREFs of RtlpHpExtrasGet @ 0x180055550
 * Callers:
 *     RtlpHpFreeHeapSlow @ 0x180054194 (RtlpHpFreeHeapSlow.c)
 *     RtlpHpGetUserInfo @ 0x180096238 (RtlpHpGetUserInfo.c)
        ...
        if ( v15 )
        {
          ...
          else
          {
            if ( (*(_BYTE *)(v15 + 24) & 0xC) == 8 )
            {
              ...
              v31 = (((unsigned int)a2
                    - (((unsigned int)qword_1801CFEC8 ^ v30 ^ (unsigned int)(v28 >> 12)) >> 16)
                    - (unsigned int)v28)
                   * (unsigned __int64)*(unsigned int *)(((unsigned __int64)*(unsigned __int16 *)(v28 + 44) << 6)
                                                       + v29
                                                       + 72)) >> 32;
              if ( (_DWORD)a2 - (((unsigned int)qword_1801CFEC8 ^ v30 ^ (unsigned int)(v28 >> 12)) >> 16) - (_DWORD)v28 == (_DWORD)v31 * (unsigned __int16)(qword_1801CFEC8 ^ v30 ^ (v28 >> 12)) )
              {
                v32 = 1LL << (v31 & 0x1F);
                v33 = (_QWORD *)(v28 + 8 * ((v31 >> 5) + 8));
                if ( (*(_DWORD *)v33 & (unsigned int)v32) != 0 )
                {
                  v34 = (unsigned __int16)qword_1801CFEC8 ^ (unsigned int)(unsigned __int16)((v28 >> 12) ^ v30);
