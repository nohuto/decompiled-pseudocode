/*
 * XREFs of TppIsWorkerThread @ 0x180008FC0
 * Callers:
...
bool __fastcall TppIsWorkerThread(__int64 a1)
{
  ...
  if ( (int)ZwDuplicateObject(-1LL, a1, -1LL, &Handle, 2072, 0, 0) < 0 )
    return 0;
  if ( (int)ZwQueryInformationThread(Handle, 0LL, &v6) >= 0 && v1->ClientId.UniqueProcess == (void *)v7 )
  {
    ...
    *((_QWORD *)&v5 + 1) = 0x800001778LL;
    if ( (int)ZwQueryInformationThread(Handle, 26LL, &v5) >= 0 )
    {
      v2 = v11 == 0;
LABEL_10:
      v3 = !v2;
