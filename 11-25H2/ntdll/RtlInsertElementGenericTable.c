/*
 * XREFs of RtlInsertElementGenericTable @ 0x1800C44D0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall RtlInsertElementGenericTable(__int64 a1, const void *a2, unsigned __int64 a3, bool *a4)
{
  ...
  int v11; // eax
  int v12; // ebp
  __int64 (__fastcall *v13)(char *, unsigned int, unsigned __int64); // rax
  _QWORD *v14; // rax
  _QWORD *v15; // r14
  _QWORD *v16; // rax
  _QWORD *v17; // r8
...
LABEL_5:
  ...
  {
    v13 = *(__int64 (__fastcall **)(char *, unsigned int, unsigned __int64))(a1 + 48);
    v14 = (_QWORD *)(v13 == RtlAllocateHeap
                   ? RtlAllocateHeap((char *)a1, (int)v6 + 40, a3)
