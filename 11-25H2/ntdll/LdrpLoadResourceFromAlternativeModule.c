/*
 * XREFs of LdrpLoadResourceFromAlternativeModule @ 0x18001B3A0
 * Callers:
...
LABEL_3:
  while ( 1 )
  {
    ...
    {
      v44[0] = 0;
      if ( !(unsigned __int8)LdrpSetThreadPreferredLangList(v26, v13, v10, 3072LL)
...
LABEL_41:
    ...
    else
    {
      ...
      else
      {
        if ( (v13 & 0x3FF) != 0 )
        {
          ParentLangId = LdrpGetParentLangId(v9, v44, v10, 3072LL);
          v6 = DllHandlea;
          v13 = v45;
          v12 = RcConfig;
          if ( ParentLangId >= 0 )
