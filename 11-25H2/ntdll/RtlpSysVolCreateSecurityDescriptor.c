/*
 * XREFs of RtlpSysVolCreateSecurityDescriptor @ 0x1800663F4
 * Callers:
 ...
 *     RtlSetControlSecurityDescriptor @ 0x180066580 (RtlSetControlSecurityDescriptor.c)
