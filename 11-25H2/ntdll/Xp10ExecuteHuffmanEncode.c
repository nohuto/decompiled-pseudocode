/*
 * XREFs of Xp10ExecuteHuffmanEncode @ 0x18015060C
 * Callers:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      *a7 = 1;
      if ( v13 + v22 > v23 )
        return 3221225507LL;
      v26 = (unsigned __int64)a4 + a5;
      a6 = v26;
      if ( (unsigned __int64)a4 >= v26 )
        return 0LL;
      while ( 1 )
      {
        v27 = *(_DWORD *)(v10 + 8);
        ...
        v32 = 8 - v30;
        v33 = *((_DWORD *)a1 + v28 + 7) & 0x1F;
        v34 = *((_DWORD *)a1 + v28 + 7) >> 5;
        if ( v27 + v33 <= v23 || (v33 = v23 - v27, v23 != v27) )
        {
          v35 = v32;
          if ( v32 >= v33 )
            v35 = v33;
          *v31 |= ((unsigned __int8)v34 & (unsigned __int8)byte_180188138[4 * v35]) << v30;
          ...
          if ( (_DWORD)v36 )
            *v38 |= (unsigned __int8)v37 & byte_180188138[4 * v36];
          v29 = a1;
          v27 += v33;
          *(_DWORD *)(v10 + 8) = v27;
        }
        ++a4;
        v40 = v27;
        if ( (unsigned __int16)v28 >= 0x100u && (v28 & 0xF) == 0xF )
        {
          v41 = *(unsigned __int8 *)a4;
          v42 = v27 & 7;
          v43 = (_BYTE *)(*(_QWORD *)v10 + ((unsigned __int64)v27 >> 3));
          v44 = 8 - v42;
          v45 = *((_DWORD *)v29 + v41 + 711) & 0x1F;
          v46 = *((_DWORD *)v29 + v41 + 711) >> 5;
          if ( v27 + v45 <= v23 || (v45 = v23 - v27, v23 != v27) )
          {
            v47 = v44;
            if ( v44 >= v45 )
              v47 = v45;
            *v43 |= ((unsigned __int8)v46 & (unsigned __int8)byte_180188138[4 * v47]) << v42;
            ...
            if ( (_DWORD)v48 )
              *v50 |= (unsigned __int8)v49 & byte_180188138[4 * v48];
            v40 = v27 + v45;
            *(_DWORD *)(v10 + 8) = v27 + v45;
          }
          ...
          if ( (unsigned __int8)v41 > 0xE8u )
          {
            v52 = *(_DWORD *)a4;
            v53 = v41 - 232;
            v54 = (_BYTE *)(*(_QWORD *)v10 + ((unsigned __int64)v40 >> 3));
            v55 = v40 & 7;
            v56 = 8 - v55;
            if ( v40 + (_DWORD)v41 - 232 <= v23 || (v53 = v23 - v40, v23 != v40) )
            {
              ...
              if ( v56 >= v53 )
                v57 = v53;
              *v54 |= ((unsigned __int8)v52 & (unsigned __int8)byte_180188138[4 * v57]) << v55;
              ...
              if ( (_DWORD)v58 )
                *v60 |= (unsigned __int8)v59 & byte_180188138[4 * v58];
              v40 += v53;
              *(_DWORD *)(v10 + 8) = v40;
            }
            a4 += 2;
        ...
        if ( (unsigned __int16)v28 > 0x14Fu )
        {
          v62 = *(_DWORD *)a4;
          v63 = (_BYTE *)(*(_QWORD *)v10 + ((unsigned __int64)v40 >> 3));
          v64 = v40 & 7;
          v65 = 8 - v64;
          v66 = ((int)v28 - 320) / 16;
          if ( v40 + v66 <= v23 || (v66 = v23 - v40, v23 != v40) )
          {
            ...
            if ( v65 >= v66 )
              v67 = v66;
            *v63 |= ((unsigned __int8)v62 & (unsigned __int8)byte_180188138[4 * v67]) << v64;
            ...
            if ( (_DWORD)v68 )
              *v70 |= (unsigned __int8)v69 & byte_180188138[4 * v68];
