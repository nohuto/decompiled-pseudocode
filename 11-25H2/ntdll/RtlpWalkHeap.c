/*
 * XREFs of RtlpWalkHeap @ 0x18009C880
 * Callers:
 ...
 *     RtlpSetHeapWalkEntryOverheadBytes @ 0x1800DDDB0 (RtlpSetHeapWalkEntryOverheadBytes.c)
 *     RtlpWalkLowFragHeapSegment @ 0x18010FA68 (RtlpWalkLowFragHeapSegment.c)
...
__int64 __fastcall RtlpWalkHeap(unsigned __int64 a1, __int64 a2, char a3)
{
  ...
  if ( (*(_DWORD *)(a1 + 116) & 0x1000000) != 0 )
    return ((__int64 (*)(void))qword_1801CE5C8)();
