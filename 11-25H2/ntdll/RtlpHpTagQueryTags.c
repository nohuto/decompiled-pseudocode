/*
 * XREFs of RtlpHpTagQueryTags @ 0x1800E0980
 * Callers:
 ...
 *     RtlpHpTagContextFindMapping @ 0x1800E0C60 (RtlpHpTagContextFindMapping.c)
    ...
    if ( (v8 & 1) != 0 )
    {
      ...
      *((_WORD *)a1 + 1) = v9;
      ...
      else
      {
        ...
        v12 = &v10[24 * v11];
        RtlAcquireSRWLockShared(&RtlpHpTagContext);
        if ( (unsigned int)dword_1801D5C88 > v11 )
        {
          v7 = -1073741789;
          *a3 = 8 * (3LL * (unsigned int)dword_1801D5C88 + 3);
          RtlReleaseSRWLockShared(&RtlpHpTagContext);
        }
        else
        {
          v13 = (__int64 *)qword_1801D5C90;
          v14 = qword_1801D5C90;
          if ( v10 < v12 )
          {
            while ( v14 )
...
LABEL_15:
            ...
            for ( ++v13;
                  (unsigned __int64)v13 < qword_1801D5C90 + 8 * ((unsigned __int64)(unsigned int)dword_1801D5C8C >> 5);
                  ++v13 )
            {
              v14 = *v13;
              if ( (*v13 & 1) == 0 )
