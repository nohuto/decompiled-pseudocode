/*
 * XREFs of RtlpFcHasEffectiveStateInGovernedFeatureInfoTable @ 0x1801730F0
 * Callers:
      ...
      if ( (v16 & 1) != 0 && *(_DWORD *)&v9[16 * (unsigned __int16)(v16 >> 7)] != *v12 )
      {
        ...
        *v17 = v11;
        ...
        if ( a4 == 1 )
          ...
          v22 = v15[2];
        v23 = a5;
        v17[1] = v21 ^ ((unsigned __int8)v21 ^ (unsigned __int8)((unsigned __int8)(v22 >> 23) << 6)) & 0x40;
        RtlpFcGetFeatureHasSubscriptionsFromBuffer(v11, v23, (__int64)v17, 12);
      }
    }
  }
  return v6;
