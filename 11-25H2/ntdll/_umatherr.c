/*
 * XREFs of _umatherr @ 0x18012CB20
 * Callers:
 ...
 *     _matherr @ 0x18012DFB0 (_matherr.c)
 */
...
double __fastcall umatherr(int a1, int a2, double a3, double a4, double a5, __int64 a6)
{
  ...
  *(_QWORD *)&Except.type = 0LL;
  ...
  while ( *v8 != a2 )
  {
    ++v7;
    v8 += 4;
    if ( (__int64)v8 >= (__int64)&RtlpMemoryZoneCriticalRoutines )
    {
      Except.name = 0LL;
LABEL_5:
      ctrlfp(a6, 65472LL);
  ...
  Except.name = (char *)*((_QWORD *)&unk_180176330 + 2 * v7 + 1);
  if ( !Except.name )
    goto LABEL_5;
  Except.retval = a5;
  Except.arg1 = a3;
