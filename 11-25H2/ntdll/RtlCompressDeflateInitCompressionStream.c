/*
 * XREFs of RtlCompressDeflateInitCompressionStream @ 0x180152924
 * Callers:
 *     RtlCompressBufferDeflateInternal @ 0x18014E374 (RtlCompressBufferDeflateInternal.c)
 * Callees:
 *     AlignWorkspace @ 0x180152908 (AlignWorkspace.c)
 */
...
__int64 __fastcall RtlCompressDeflateInitCompressionStream(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  a1[5] = a4;
  a1[6] = WinSqmCheckEscalationSetString;
  a1[7] = RtlEndStrongEnumerationHashTable;
  v22 = a4 + 6000;
  AlignWorkspace(&v22);
  *(_QWORD *)v4 = v5;
  *(_DWORD *)(v4 + 8) = 42;
