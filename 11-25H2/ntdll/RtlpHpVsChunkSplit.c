        ...
        __int64 a6)
{
  ...
  __int64 v76; // r13
  __int64 v77; // r10
  __int64 (__fastcall *v78)(__int64 *, __int64, unsigned int, _DWORD *); // rax
  __int64 v79; // r11
  __int64 v80; // r8
  ...
  *(_DWORD *)(a4 + 8) = v25;
  ...
  if ( v28 )
  {
    *(_DWORD *)(a4 + 8) = v25 | 0x200;
    ...
    v77 = *(_QWORD *)(a1 + 8) ^ a1;
    v78 = (__int64 (__fastcall *)(__int64 *, __int64, unsigned int, _DWORD *))(a1 ^ RtlpHpHeapGlobals ^ *(_QWORD *)(a1 + 32));
    if ( v78 != RtlpHpSegLfhVsCommit )
    {
      v86 = v78((__int64 *)(*(_QWORD *)(a1 + 8) ^ a1), v74, v121, 0LL);
      goto LABEL_73;
    }
    v79 = *(_QWORD *)v77;
    v80 = *(_QWORD *)v77;
...
LABEL_73:
    ...
    if ( (v87 & 1) == 0 )
    {
      v88 = (volatile signed __int32 *)(a2 + 8);
      *(_QWORD *)(a6 + 8) = a2 + 8;
      ...
      if ( SchedulerSharedDataSlot )
      {
        for ( i = 0; i < 8; ++i )
        {
          v91 = (volatile signed __int32 **)&SchedulerSharedDataSlot[8 * i];
          if ( !*v91 )
          {
            if ( v91 )
              *v91 = v88;
      ...
      if ( _interlockedbittestandset64(v88, 0LL) )
        RtlpAcquireSRWLockExclusiveContended(v88);
    }
    *(_DWORD *)(a4 + 8) &= ~0x200u;
  }
