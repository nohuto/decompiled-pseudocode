/*
 * XREFs of ApiSetpSearchForApiSetHost @ 0x1800DDA40
 * Callers:
    ...
    while ( v11 < &a2[v12] )
    {
      ...
      if ( (_WORD)v15 != (_WORD)v16 )
      {
        if ( (unsigned int)v15 >= 0x61 )
        {
          ...
          {
            if ( qword_1801CF038 && (unsigned __int16)v15 >= 0xC0u )
              LOWORD(v15) = *(_WORD *)(qword_1801CF038
                                     + 2
                                     * ((v15 & 0xF)
                                      + *(unsigned __int16 *)(qword_1801CF038
                                                            + 2LL
                                                            * (*(unsigned __int16 *)(qword_1801CF038 + 2 * (v15 >> 8))
              ...
              if ( (unsigned __int16)v16 >= 0xC0u )
                LOWORD(v16) = *(_WORD *)(qword_1801CF038
                                       ...
                                       * ((v16 & 0xF)
                                        + *(unsigned __int16 *)(qword_1801CF038
                                                              + 2LL
                                                              * (*(unsigned __int16 *)(qword_1801CF038 + 2 * (v16 >> 8))
