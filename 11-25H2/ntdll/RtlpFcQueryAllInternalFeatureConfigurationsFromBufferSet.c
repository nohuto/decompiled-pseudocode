/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x18015289C
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x18017347C (RtlpFcConfigurationTypeToBufferType.c)
 */
