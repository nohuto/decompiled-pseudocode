/*
 * XREFs of LdrpAddUnicodeStringToSnapsBuffer @ 0x18007BAE0
 * Callers:
  ...
  if ( (_WORD)v2 )
  {
    ...
    if ( v2 + (unsigned int)(unsigned __int16)LdrpSnapsUnicodeString > HIWORD(LdrpSnapsUnicodeString) )
    {
      ...
      if ( v18 > HIWORD(LdrpSnapsUnicodeString) )
        goto LABEL_5;
      v5 = (char *)qword_1801D47E8;
      v4 = *(unsigned __int16 *)a1;
      memmove(qword_1801D47E8, a1[1], v4);
      v3 = HIWORD(LdrpSnapsUnicodeString);
    ...
    {
      v4 = *(unsigned __int16 *)a1;
      v5 = (char *)qword_1801D47E8 + 2 * ((unsigned __int64)(unsigned __int16)LdrpSnapsUnicodeString >> 1);
      memmove(v5, a1[1], v4);
      v3 = HIWORD(LdrpSnapsUnicodeString);
...
LABEL_5:
  if ( v6 == v3 )
  {
    qword_1801D47D8 = (__int64)qword_1801D47E8;
