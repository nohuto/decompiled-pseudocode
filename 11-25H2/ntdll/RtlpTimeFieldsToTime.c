/*
 * XREFs of RtlpTimeFieldsToTime @ 0x1800BE380
 * Callers:
 *     RtlCutoverTimeToSystemTime @ 0x1800BDB10 (RtlCutoverTimeToSystemTime.c)
 *     RtlTimeFieldsToTime @ 0x1800F6310 (RtlTimeFieldsToTime.c)
 * Callees:
 *     RtlpTimeFieldsToTimeNoLeapSeconds @ 0x1800D59B0 (RtlpTimeFieldsToTimeNoLeapSeconds.c)
 */
