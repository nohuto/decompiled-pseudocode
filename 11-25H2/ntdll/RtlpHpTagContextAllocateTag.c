/*
 * XREFs of RtlpHpTagContextAllocateTag @ 0x18002DE84
 * Callers:
 ...
 *     RtlpHpTagContextFindFreeTag @ 0x18010E96C (RtlpHpTagContextFindFreeTag.c)
 */
...
__int64 __fastcall RtlpHpTagContextAllocateTag(__int64 a1, __int128 *a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v7 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _OWORD *))RtlpHpMetadataAlloc)(48LL, 48LL, 0LL, v21);
  v8 = v7;
  if ( v7 )
  {
    *(_OWORD *)v7 = 0LL;
    ...
    *(_OWORD *)(v7 + 16) = v9;
    ...
    else
    {
      ...
      {
        *(_WORD *)(v8 + 40) = FreeTag;
        *(_QWORD *)(qword_1801D5C98 + 8LL * FreeTag - 8) = v8;
        v13 = qword_1801D5C90;
        v22 = *(_QWORD *)(v8 + 8) & (-1LL << (dword_1801D5C8C & 0x1F));
        v14 = (37
             * (BYTE6(v22)
              + 37
              * (BYTE5(v22)
             ...
             + HIBYTE(v22)) & (((unsigned int)dword_1801D5C8C >> 5) - 1);
        v15 = (signed __int64 *)(qword_1801D5C90 + 8 * v14);
        _m_prefetchw(v15);
        v16 = *v15;
        *(_QWORD *)v8 = *v15;
        v18 = v16;
