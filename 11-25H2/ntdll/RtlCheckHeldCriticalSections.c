/*
 * XREFs of RtlCheckHeldCriticalSections @ 0x1800F4D10
 * Callers:
 *     RtlCheckForOrphanedCriticalSections @ 0x1800F4CE0 (RtlCheckForOrphanedCriticalSections.c)
 * Callees:
 *     RtlAcquireSRWLockShared @ 0x18004F0C0 (RtlAcquireSRWLockShared.c)
 *     RtlReleaseSRWLockShared @ 0x18004F120 (RtlReleaseSRWLockShared.c)
 *     RtlpGetStackTraceAddressEx @ 0x1800F7C20 (RtlpGetStackTraceAddressEx.c)
      ...
      if ( !result->Ldr->ShutdownInProgress )
      {
        ...
        else
        {
          ...
          *((_QWORD *)&v14 + 1) = 0x40000006CLL;
          result = (struct _PEB *)ZwQueryInformationThread(a1, 26LL, &v14);
          if ( (int)result < 0 )
            return result;
          if ( !v26 )
            return result;
          result = (struct _PEB *)ZwQueryInformationThread(a1, 0LL, &v22);
          if ( (int)result < 0 )
            return result;
