/*
 * XREFs of RtlpHpLfhSubsegmentSizeBlockInternal @ 0x1800D4AE0
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentSizeBlockInternal(unsigned __int64 a1, __int64 a2, unsigned int a3, int *a4)
{
  ...
  result = (unsigned __int16)qword_1801CFEC8 ^ *(unsigned __int16 *)(a1 + 40) ^ (unsigned int)(unsigned __int16)(a1 >> 12);
