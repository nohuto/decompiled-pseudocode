/*
 * XREFs of inflate_fast_chunk_ @ 0x1801563A4
 * Callers:
 *     inflate @ 0x180152C24 (inflate.c)
 * Callees:
 *     chunkcopy_core @ 0x180152A8C (chunkcopy_core.c)
 *     chunkset_core_0 @ 0x180156214 (chunkset_core_0.c)
 *     chunkunroll_relaxed @ 0x180156364 (chunkunroll_relaxed.c)
 */
