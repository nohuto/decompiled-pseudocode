/*
 * XREFs of RtlpHpSegReportPageRange @ 0x18011EB64
 * Callers:
 *     RtlpHpSegWalk @ 0x18009B5D0 (RtlpHpSegWalk.c)
 * Callees:
 *     RtlpHpVsChunkSize @ 0x18002DA90 (RtlpHpVsChunkSize.c)
 *     RtlpHpLfhSubsegmentSizeBlock @ 0x1800C3B90 (RtlpHpLfhSubsegmentSizeBlock.c)
 *     RtlpHpSegReportBusyBlock @ 0x1800F2664 (RtlpHpSegReportBusyBlock.c)
 */
