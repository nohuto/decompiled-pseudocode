...
BOOLEAN __cdecl RtlDispatchException(PEXCEPTION_RECORD ExceptionRecord, PCONTEXT ContextRecord)
{
  ...
  if ( (unsigned __int8)RtlpCallVectoredHandlers((__int64)ExceptionRecord, (__int64)ContextRecord, 0) )
  {
LABEL_9:
    v14 = 1;
  }
  else
  {
    ...
    if ( RtlpGetStackLimits(&v58, (void **)&v59) )
    {
      ...
      while ( 1 )
      {
        v25 = RtlLookupFunctionEntry(Rip, &ImageBase, p_HistoryTable);
        ...
        if ( v52 )
        {
          ...
          for ( i = 0; ; i = v68 )
          {
            ...
            v44 = RtlVirtualUnwind(1u, v26, Rip, v25, (PCONTEXT)&v50, &HandlerData, &EstablisherFrame, 0LL);
            v27 = v63;
            v52 = v44;
            EstablisherFrame = v63;
            if ( ((LdrSystemDllInitBlock.MitigationOptionsMap.Map[1] >> 12) & 3) == 1 )
            {
              v45 = RtlLookupFunctionEntry(Rip, &ImageBase, v56);
              v25 = v45;
...
LABEL_33:
  ...
  RtlpCallVectoredHandlers((__int64)ExceptionRecord, (__int64)ContextRecord, 1u);
  return v14;
}
