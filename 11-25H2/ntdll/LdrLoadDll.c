...
NTSTATUS __cdecl LdrLoadDll(PWSTR DllPath, PULONG DllCharacteristics, PUNICODE_STRING DllName, PVOID *DllHandle)
{
  ...
  LdrpLogInternal("minkernel\\ldr\\ldrapi.c", 1347LL, "LdrLoadDll", 3LL, "DLL name: %wZ\n", DllName);
  LdrpLogInternal("minkernel\\ldr\\ldrapi.c", 1348LL, "LdrLoadDll", 5LL, "%wZ\n", DllName);
  ...
  LdrpLogInternal("minkernel\\ldr\\ldrapi.c", 1405LL, "LdrLoadDll", 4LL, "Status: 0x%08lx\n", v14);
  LdrpLogInternal("minkernel\\ldr\\ldrapi.c", 1406LL, "LdrLoadDll", 6LL, "%x\n", v14);
  return v14;
}
