/*
 * XREFs of GetProcessIptTrace @ 0x18015E4D8
 * Callers:
...
NTSTATUS __fastcall GetProcessIptTrace(__int64 a1, void *a2, ULONG a3)
{
  ...
  if ( result >= 0 )
  {
    ...
    *((_QWORD *)&v15 + 1) = a1;
    ...
    NtClose(FileHandle);
    if ( v7 )
      RtlReleasePrivilege(v12, v9, v10, v11);
    return v8;
  }
  return result;
}
