...
_DWORD *__fastcall RtlpAllocateNTHeapInternal(_DWORD *Src, unsigned __int64 a2, int a3)
{
  int v3; // eax
...
LABEL_58:
    v38 = 0LL;
LABEL_51:
    v14 = RtlpAllocateHeap(Src, v5 | 2, v7, v8, v38, &v48);
    goto LABEL_9;
  }
  if ( v7 > RtlpLargestLfhBlock
    ...
    || (v12 = *((_QWORD *)Src + 53),
        v13 = *((_QWORD *)Src + 51),
        LODWORD(v48) = 2,
        (v14 = (_DWORD *)RtlpLowFragHeapAllocFromContext(v13, *(unsigned __int16 *)(v12 + 2 * v11), v7, v5)) == 0LL) )
  {
...
LABEL_9:
  if ( v14 )
  {
    ...
    v51 = v49;
    v50 = 0;
    v31 = (unsigned __int64)v14 + (unsigned __int16)v49;
    if ( v29 == 4 )
    {
      ...
      *((_BYTE *)v14 - 2) = v27 >> 4;
      if ( Src[31] )
      {
        *((_BYTE *)v14 - 5) = v43 ^ *((_BYTE *)v14 - 6) ^ HIBYTE(v43);
        *(v14 - 2) ^= Src[34];
      }
      *(_BYTE *)(v31 - 2) = v27 >> 4;
      *(_BYTE *)(v31 - 1) = 5;
    ...
    else
    {
      if ( v29 == 5 )
      {
        LOWORD(v32) = *((_WORD *)v14 - 2) ^ *((_WORD *)Src + 70);
      }
      else if ( (v29 & 0x40) != 0 )
      {
        LOWORD(v32) = v14[4 * (v29 & 0x3F) - 1];
      }
      else if ( (v29 & 0x3F) == 0x3F )
      {
        ...
        {
          v39 = *((_WORD *)v14 - 4) ^ (unsigned __int16)(RtlpLFHKey ^ (unsigned __int16)Src ^ (v28 >> 4))
              ? 0LL
              : *(_QWORD *)(v28
                          - ((unsigned __int64)(*(v14 - 2) ^ (unsigned int)RtlpLFHKey ^ (unsigned int)Src ^ (unsigned int)(v28 >> 4)) >> 12));
          LOWORD(v40) = *(_WORD *)(v39 + 36);
          v27 = v49;
        }
        v32 = *(_QWORD *)&v14[4 * (unsigned __int16)v40 - 4];
      }
      else
      {
        LOWORD(v32) = v29 & 0x3F;
      ...
      *(_BYTE *)(v31 - 2) = v41;
      *((_BYTE *)v14 - 1) &= 0xC0u;
      *((_BYTE *)v14 - 1) |= (unsigned __int8)v41 | 0x40;
      *(_BYTE *)(v31 - 1) = 5;
      *(_WORD *)(v31 - 4) = v32 + v30;
      *(_DWORD *)(v31 - 8) = v9;
    }
...
LABEL_16:
    ...
    && (_DWORD)v48 != 5 )
  {
    ...
    if ( ((v44[10] ^ (unsigned __int8)(*((_BYTE *)Src + 138) & (Src[31] >> 17))) & 8) == 0 )
LABEL_97:
      RtlpLogHeapAllocateEvent(Src, v14, v7, (unsigned int)v48);
  }
  if ( (dword_1801D0918 & 1) != 0
    && (dword_1801D0918 & 2) != 0
    && NtCurrentPeb()->ProcessHeap
    && Src != (_DWORD *)qword_1801D4208[2 * (unsigned int)dword_1801816F8[BYTE1(RtlpHpEnvHandle)]]
    && v14
    && (v5 & 0x10000000) == 0 )
  {
    RtlpHpStackTraceAddStack(Src, v14);
  }
  return v14;
}
