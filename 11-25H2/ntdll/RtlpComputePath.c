/*
 * XREFs of RtlpComputePath @ 0x1800ACAF0
 * Callers:
 ...
 *     RtlpGetDirPath @ 0x1800ABEE8 (RtlpGetDirPath.c)
 *     RtlQueryEnvironmentVariable @ 0x1800AD560 (RtlQueryEnvironmentVariable.c)
 *     RtlpAddForwarderPath @ 0x18011F148 (RtlpAddForwarderPath.c)
 *     LdrpIncludeAlternateForwarders @ 0x180120444 (LdrpIncludeAlternateForwarders.c)
 *     memmove @ 0x180168980 (memmove.c)
 */

__int64 __fastcall RtlpComputePath(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  v34 = a4;
  v33 = a1;
  v4 = ((unsigned __int64)xmmword_1801EC4E0 >> 60) & 3;
  Src = 0LL;
  Size[0] = 0LL;
  Size[1] = 0LL;
  v29[1] = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( (_DWORD)v11 == 3 )
    {
      ...
      {
        Heap = (const void *)RtlAllocateHeap((char *)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 1572864, 2LL * v29[0]);
        if ( !Heap )
        {
...
LABEL_8:
  ...
  {
    v12 = RtlAllocateHeap((char *)NtCurrentPeb()->ProcessHeap, 0, v7);
    v8 = v12;
    if ( v12 )
    {
      v13 = v30;
