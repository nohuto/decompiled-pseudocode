/*
 * XREFs of PssNtQuerySnapshot @ 0x1800C9560
 * Callers:
 *     <none>
 * Callees:
 *     PssNtValidateDescriptor @ 0x1800C9A80 (PssNtValidateDescriptor.c)
 *     PsspQueryInfoClass_PSS_QUERY_PROCESS_INFORMATION @ 0x1800CA7D8 (PsspQueryInfoClass_PSS_QUERY_PROCESS_INFORMATION.c)
 */
