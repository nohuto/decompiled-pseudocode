/*
 * XREFs of punycode_encode @ 0x1800C2C08
 * Callers:
 *     RtlpNameprepAsciiRealWorker @ 0x1800C00F0 (RtlpNameprepAsciiRealWorker.c)
 * Callees:
 *     adapt @ 0x1800C1DA8 (adapt.c)
 *     ValidateStd3Range @ 0x1800C20A0 (ValidateStd3Range.c)
 *     GetUTF32 @ 0x1800C317C (GetUTF32.c)
 *     FindLabelEnd @ 0x1800C3250 (FindLabelEnd.c)
 *     RtlStringCchCopyNExW @ 0x1800C328C (RtlStringCchCopyNExW.c)
