...
__int64 __fastcall RtlpHpSegMgrCommit(__int64 a1, unsigned __int64 a2, unsigned int a3, int a4, int a5, int a6, int a7)
{
  ...
  if ( (*(_BYTE *)(a1 + 13) & 7) != 0 )
  {
    ...
    v57 = 0LL;
    v58 = 0LL;
    RtlpHpVaMgrCtxQuery(&unk_1801D09C8, a2 & 0xFFFFFFFFFFE00000uLL, &v57);
    a2 = v64;
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( v23 + v25 != v41 )
    {
      RtlpHpVaMgrCtxFree(&unk_1801D09C8, &v47, &v48);
      v34 = 0;
LABEL_32:
...
LABEL_9:
      ...
      if ( v10 == 0x2000 )
      {
        ...
        v42 = RtlpHpVaMgrCtxAlloc(&unk_1801D09C8, &v49, 0LL, v54);
        v33 = v42;
        if ( !v42 )
        {
          v34 = -1073741670;
      ...
      else
      {
        ...
        {
          v34 = RtlpHpVaMgrCtxCommit(&unk_1801D09C8, v25, v32, v28);
          if ( v34 < 0 )
            goto LABEL_21;
          if ( (v10 & 0x40000000) != 0 )
            RtlHeapZero(v47, v49);
