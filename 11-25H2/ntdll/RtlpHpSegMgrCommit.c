/*
 * XREFs of RtlpHpSegMgrCommit @ 0x1800BADA0
 * Callers:
...
__int64 __fastcall RtlpHpSegMgrCommit(__int64 a1, unsigned __int64 a2, unsigned int a3, int a4, int a5, int a6, int a7)
{
  ...
  if ( a5 > 0 )
  {
    ...
    {
      v18 = *v16;
      if ( *v16 || (v18 = qword_1801CFED8, v16 = &qword_1801CFED8, qword_1801CFED8) )
      {
        if ( v17 + v15 > v18 )
        {
          v41 = v16[1];
  ...
  if ( (*(_BYTE *)(a1 + 13) & 7) != 0 )
  {
    ...
    v58 = 0LL;
    v59 = 0LL;
    RtlpHpVaMgrCtxQuery(&unk_1801D09C8, a2 & 0xFFFFFFFFFFE00000uLL, &v58);
    a2 = v65;
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( v10 != 0x8000 )
    {
      ...
      {
        RtlpHpVaMgrCtxDecommit(&unk_1801D09C8, v25, v23);
        v35 = 0;
      }
      else
      {
    ...
    if ( (void *)(v23 + v25) != v42 )
    {
      RtlpHpVaMgrCtxFree(&unk_1801D09C8, &BaseAddress, &RegionSize);
      v35 = 0;
LABEL_32:
...
LABEL_9:
      ...
      *(__m128i *)v52 = v27;
      ...
      if ( v10 == 0x2000 )
      {
        ...
        v43 = (void *)RtlpHpVaMgrCtxAlloc(&unk_1801D09C8, &v50, 0LL, v55);
        v34 = (int)v43;
        if ( !v43 )
        {
          v35 = -1073741670;
      ...
      else
      {
        ...
        {
          v35 = RtlpHpVaMgrCtxCommit(&unk_1801D09C8, v25, v33, v28);
          if ( v35 < 0 )
            goto LABEL_21;
          if ( (v10 & 0x40000000) != 0 )
