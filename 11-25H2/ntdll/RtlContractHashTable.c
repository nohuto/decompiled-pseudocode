/*
 * XREFs of RtlContractHashTable @ 0x1800E5250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  {
    v16 = *(_QWORD **)(a1 + 32);
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v16[v12], (__int64)v6);
    v16[v12] = 0LL;
    if ( *(_DWORD *)(a1 + 8) == 128 )
    {
      *(_QWORD *)(a1 + 32) = *v16;
      RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (__int64)v16, v17);
    }
  }
  return 1;
}
