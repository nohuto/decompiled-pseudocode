/*
 * XREFs of crc32_avx512_simd_ @ 0x18011D9E0
 * Callers:
...
__int64 __fastcall crc32_avx512_simd_(__int64 _RCX, __int64 a2, int _R8D)
{
  ...
  __asm
  {
    ...
    vmovdqu32 zmm3, zmmword ptr cs:byte_180182F00
  }
  ...
  __asm
  {
    vmovdqu32 zmm5, zmmword ptr cs:byte_180182E80
  ...
  __asm
  {
    vmovdqa xmm4, cs:xmmword_180182ED0
    vmovdqa xmm2, xmm6
    ...
    vpclmulqdq xmm1, xmm1, cs:xmmword_180182EC0, 10h
    vandps  xmm1, xmm1, xmm3
    vpclmulqdq xmm1, xmm1, cs:xmmword_180182EC0, 0
    vxorps  xmm1, xmm1, xmm2
    vpextrd rax, xmm1, 1
    vzeroupper
  }
