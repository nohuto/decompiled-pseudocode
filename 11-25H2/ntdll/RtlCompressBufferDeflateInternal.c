/*
 * XREFs of RtlCompressBufferDeflateInternal @ 0x18014E374
 * Callers:
 *     RtlCompressBufferDeflateRaw @ 0x18014E480 (RtlCompressBufferDeflateRaw.c)
 *     RtlCompressBufferDeflateZlib @ 0x18014E4D0 (RtlCompressBufferDeflateZlib.c)
 * Callees:
 *     RtlCompressDeflateInitCompressionStream @ 0x180152924 (RtlCompressDeflateInitCompressionStream.c)
        ...
        void *a9)
{
  ...
  memset_thunk_772440563353939046(a9, 0, 0x417ECuLL);
  v18 = a5;
  LOBYTE(v14) = a1;
  v16 = a3;
  v17 = a4;
