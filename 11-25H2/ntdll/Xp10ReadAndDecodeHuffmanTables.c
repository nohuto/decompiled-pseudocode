/*
 * XREFs of Xp10ReadAndDecodeHuffmanTables @ 0x18010A4EC
 * Callers:
 ...
 *     Xp10BuildHuffmanDecodeTable @ 0x18014F82C (Xp10BuildHuffmanDecodeTable.c)
 *     Xp10SortHuffmanSymbols @ 0x18015195C (Xp10SortHuffmanSymbols.c)
