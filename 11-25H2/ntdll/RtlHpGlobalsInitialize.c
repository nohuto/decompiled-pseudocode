/*
 * XREFs of RtlHpGlobalsInitialize @ 0x1800028B4
 * Callers:
...
__int64 RtlHpGlobalsInitialize()
{
  ...
  v1 = RtlRandomEx(&Seed);
  qword_1801CFF00 = (unsigned __int64)&RtlpHpHeapGlobals ^ (v0 | v1);
  ...
  do
  {
    ...
    v4 = v2;
    v2 = _InterlockedCompareExchange64(&qword_1801CFF00, v3, v2);
  }
  while ( v4 != v2 );
  v5 = qword_1801CFF00;
  ...
  do
  {
    ...
    v7 = v5;
    v5 = _InterlockedCompareExchange64(&qword_1801CFF00, v6, v5);
  }
  while ( v7 != v5 );
  qword_1801CFEC8 = 0x2545F4914F6CDD1DLL * v6;
  qword_1801CFED0 = (__int64)&RtlpHeapFailureInfo;
  if ( RtlIsProcessorFeaturePresent(0x2Au) )
    LODWORD(qword_1801CFEE8) = qword_1801CFEE8 | 2;
  v8 = RtlIsProcessorFeaturePresent(0x3Cu) == 0;
  v9 = qword_1801CFEE8;
  if ( !v8 )
    v9 = qword_1801CFEE8 | 4;
  result = v9 | 1u;
  LODWORD(qword_1801CFEE8) = result;
  return result;
}
