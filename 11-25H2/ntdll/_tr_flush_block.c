/*
 * XREFs of _tr_flush_block @ 0x180157070
 * Callers:
 ...
 *     bi_windup @ 0x1801574C8 (bi_windup.c)
 *     build_tree @ 0x180157528 (build_tree.c)
 *     compress_block @ 0x18015776C (compress_block.c)
 *     detect_data_type @ 0x180157B60 (detect_data_type.c)
 *     init_block @ 0x180157EA8 (init_block.c)
 *     scan_tree @ 0x180157FD8 (scan_tree.c)
 *     send_all_trees @ 0x1801580F4 (send_all_trees.c)
 */
...
LABEL_11:
  ...
  for ( i = 18LL; i >= 3; --i )
  {
    if ( *(_WORD *)(a1 + 4LL * byte_18019C490[i] + 2806) )
      break;
    LODWORD(v8) = v8 - 1;
  }
