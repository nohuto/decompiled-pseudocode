/*
 * XREFs of LdrpFindLoadedDllByNameLockHeld @ 0x18006E490
 * Callers:
              ...
              if ( (unsigned int)v16 >= 0x61 )
              {
                if ( (unsigned int)v16 > 0x7A )
                {
                  if ( qword_1801CF038 && (unsigned __int16)v16 >= 0xC0u )
                    LOWORD(v16) = *(_WORD *)(qword_1801CF038
                                           + 2
                                           * ((v16 & 0xF)
                ...
                if ( (unsigned int)v17 > 0x7A )
                {
                  if ( qword_1801CF038 )
                  {
                    if ( (unsigned __int16)v17 >= 0xC0u )
                      LOWORD(v17) = *(_WORD *)(qword_1801CF038
                                             + 2
                                             * ((v17 & 0xF)
                                              + *(unsigned __int16 *)(qword_1801CF038
                                                                    + 2LL
                                                                    * (((unsigned __int8)v17 >> 4)
                                                                     + (unsigned int)*(unsigned __int16 *)(qword_1801CF038 + 2 * (v17 >> 8))))))
                                  + v17;
                  }
                }
                else
