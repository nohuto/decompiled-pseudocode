/*
 * XREFs of RtlpHpRegisterEnvironment @ 0x1800B9BB8
 * Callers:
...
__int64 __fastcall RtlpHpRegisterEnvironment(__m128i *a1, int a2)
{
  ...
  if ( !a2 )
  {
    ...
    v11 = v8;
    RtlpHpVaMgrCtxAllocatorDereference((__int64)&unk_1801D09C8, (unsigned int *)&v10);
  ...
  if ( BYTE1(a1->m128i_i64[0]) == 5 )
  {
    ...
    result = RtlpHpCustomVaCallbacksRegistrarRegister(
               ...
               _mm_srli_si128(v2, 8).m128i_u64[0],
               &v12,
               &v10);
    if ( (int)result < 0 )
      return result;
  ...
  if ( (v2.m128i_i8[0] & 8) != 0 )
    v10.m128i_i32[3] = 1;
  v11 = v4;
  v5 = RtlpHpVaMgrCtxAllocatorReference(&unk_1801D09C8, &v10);
  if ( v5 != -1 )
  {
    v9.m128i_i8[3] = v5 + 1;
    *a1 = v9;
