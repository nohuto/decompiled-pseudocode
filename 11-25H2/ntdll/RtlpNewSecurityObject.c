...
LABEL_150:
                ...
                else
                {
                  ...
                  v110 = (unsigned __int8 *)v192;
                  if ( !(unsigned __int8)RtlpValidOwnerSubjectContext(v108, v192, v189, &v208) )
                  {
                    valid = v208;
                    ProcessHeap = HeapHandle;
                    v10 = BaseAddressa;
                    ...
                    *(_BYTE *)v14 = 1;
                    if ( (v107 & 0x10) != 0 && BaseAddressa )
                    {
                      ...
                      if ( (a7 & 0x4000) != 0 )
                      {
                        ...
                        if ( v168 )
                          v153 = 0LL;
                        RtlpNormalizeAcl(v117, BaseAddressa, v153);
                        if ( v117[2] )
                        {
                          v115 = v117[1];
                        }
                      ...
                      else
                      {
                        ...
                        if ( !v168 )
                          RtlpApplyAclToObject(v117, GenericMapping);
                        v140 = BaseAddressa[1];
                    ...
                    if ( (v107 & 4) != 0 )
                    {
                      if ( Src )
                      {
                        if ( (a7 & 0x4000) != 0 )
                        {
                          ...
                          if ( v169 )
                            v145 = 0LL;
                          RtlpNormalizeAcl(v117, Src, v145);
                          v116 = v117[1];
                        }
                        else
                        {
