/*
 * XREFs of RtlQueryInformationActivationContext @ 0x1800484F0
 * Callers:
 ...
 *     RtlQueryInformationActiveActivationContext @ 0x1800F72A0 (RtlQueryInformationActiveActivationContext.c)
 * Callees:
...
LABEL_48:
    ...
    {
      LoadedDllByHandle = LdrpFindLoadedDllByHandle(ActivationContext, &v28, &v26);
