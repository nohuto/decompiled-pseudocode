/*
 * XREFs of RtlpHpLfhSubsegmentInitialize @ 0x18000BC78
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentComputeCommitUnit @ 0x1800DF220 (RtlpHpLfhSubsegmentComputeCommitUnit.c)
        ...
        int a7)
{
  ...
  HIWORD(v41) = v20;
  LOWORD(v41) = v10;
  *(_DWORD *)(a1 + 40) = v41 ^ qword_1801CFEC8 ^ (a1 >> 12);
  ...
  *(_BYTE *)(a1 + 50) = v34;
  RtlpHpLfhBlockBitmapInitialize(a1 + 64, v22);
  if ( ((v10 - 1) & v10) == 0 )
  {
