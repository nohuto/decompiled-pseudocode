/*
 * XREFs of RtlpQueryEnvironmentHashTable @ 0x1800AE260
 * Callers:
        ...
        unsigned __int64 *a6)
{
  ...
  do
  {
    ...
    if ( qword_1801CF038 && (unsigned __int16)v13 >= 0xC0u )
    {
      v14 = *(_WORD *)(qword_1801CF038
                     + 2
                     * ((v13 & 0xF)
                      + *(unsigned __int16 *)(qword_1801CF038
                                            + 2LL
                                            * (((unsigned __int8)v13 >> 4)
                                             + (unsigned int)*(unsigned __int16 *)(qword_1801CF038 + 2 * (v13 >> 8))))))
          + v13;
      LOWORD(v13) = v14;
    }
    else
        ...
        while ( v21 < v23 )
        {
          ...
          if ( (_WORD)v24 != (_WORD)v25 )
          {
                                         ...
                                         * ((v24 & 0xF)
                                          + *(unsigned __int16 *)(qword_1801CF038
                                                                ...
                                                                * (((unsigned __int8)v24 >> 4)
                                                                 + (unsigned int)*(unsigned __int16 *)(qword_1801CF038 + 2 * (v24 >> 8))))))
                              + v24;
              }
              else
              {
            ...
            if ( (unsigned int)v25 >= 0x61 )
            {
              ...
              {
                if ( qword_1801CF038 && (unsigned __int16)v25 >= 0xC0u )
                                         ...
                                         * ((v25 & 0xF)
                                          + *(unsigned __int16 *)(qword_1801CF038
                                                                ...
                                                                * (((unsigned __int8)v25 >> 4)
                                                                 + (unsigned int)*(unsigned __int16 *)(qword_1801CF038 + 2 * (v25 >> 8))))))
                              + v25;
              }
              else
              {
