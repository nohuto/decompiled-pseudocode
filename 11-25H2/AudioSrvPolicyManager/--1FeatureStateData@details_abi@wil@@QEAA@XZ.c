/*
 * XREFs of ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x180022800
 * Callers:
 ...
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x1800246F4 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 */
