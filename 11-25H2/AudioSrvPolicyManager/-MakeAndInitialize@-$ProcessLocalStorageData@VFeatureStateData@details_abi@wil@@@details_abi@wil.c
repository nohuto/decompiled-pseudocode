 ...
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x18001EADC (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ??$?8XUprocess_heap_deleter@wil@@@wistd@@YA_NAEBV?$unique_ptr@XUprocess_heap_deleter@wil@@@0@$$T@Z @ 0x180021E2C (--$-8XUprocess_heap_deleter@wil@@@wistd@@YA_NAEBV-$unique_ptr@XUprocess_heap_deleter@wil@@@0@$$T.c)
  ...
  *a3 = 0LL;
  ...
  else
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      *((_QWORD *)&v17 + 1) = 0LL;
      v10[3] = v15;
      memset_0(v10 + 4, 0, 0x110uLL);
      v10[4] = 0LL;
      wil::details_abi::UsageIndexes::UsageIndexes((wil::details_abi::UsageIndexes *)(v10 + 5));
      wil::details_abi::SubscriptionList::SubscriptionList((struct _RTL_CRITICAL_SECTION *)(v10 + 29));
      *a3 = v10;
