/*
 * XREFs of __tailMerge_api_ms_win_appmodel_identity_l1_2_0_dll @ 0x180021774
 * Callers:
 *     __imp_load_AppContainerDeriveSidFromMoniker @ 0x1800217F3 (__imp_load_AppContainerDeriveSidFromMoniker.c)
 * Callees:
