/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@V?$allocator@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@@2@@std@@QEAA@XZ @ 0x180033068
 * Callers:
 *     _AudioStateMonitorManager::AudioStateMonitorManager_::_1_::dtor$4 @ 0x18004D47F (_AudioStateMonitorManager--AudioStateMonitorManager_--_1_--dtor$4.c)
 * Callees:
