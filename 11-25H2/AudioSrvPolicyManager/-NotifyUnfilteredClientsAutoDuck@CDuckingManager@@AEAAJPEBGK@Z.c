/*
 * XREFs of ?NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z @ 0x1800307EC
 * Callers:
    ...
    if ( v9 )
    {
      ...
      *((_DWORD *)v9 + 14) = a3;
      ...
      try
      {
        ...
        v13[2] = 0LL;
        v14 = 1;
        CLockedList_UniqueValuesOnly<CDuckingNotification,0>::ForEachEntry((__int64)v5, v13);
      }
