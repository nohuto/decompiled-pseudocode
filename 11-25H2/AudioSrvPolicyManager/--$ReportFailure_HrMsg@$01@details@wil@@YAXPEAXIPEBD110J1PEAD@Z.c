/*
 * XREFs of ??$ReportFailure_HrMsg@$01@details@wil@@YAXPEAXIPEBD110J1PEAD@Z @ 0x180045BB4
 * Callers:
 *     ?Log_HrMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ @ 0x180045DC8 (-Log_HrMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ.c)
        ...
        char *a9)
{
  ...
  return wil::details::ReportFailure_Msg<2>(v11, v10, v9, v10, v13, a6, (__int64)v14, a8, a9);
}
