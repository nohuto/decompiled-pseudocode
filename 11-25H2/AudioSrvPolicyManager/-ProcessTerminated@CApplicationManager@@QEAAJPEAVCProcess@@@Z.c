/*
 * XREFs of ?ProcessTerminated@CApplicationManager@@QEAAJPEAVCProcess@@@Z @ 0x18000E870
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_a57db9963e5a44e7e98dd749c7c1930c__void_::_Do_call @ 0x180037B40 (std--_Func_impl_no_alloc__lambda_a57db9963e5a44e7e98dd749c7c1930c__void_--_Do_call.c)
 * Callees:
...
LABEL_6:
  ...
  if ( trivial_4 != v19 )
  {
    ...
    {
      v11 = v24;
      CApplicationManager::UpdateVolumeForAllAppsInSession((__int64)v24, *((_DWORD *)a2 + 41), 3u);
      goto LABEL_17;
    }
  }
LABEL_16:
