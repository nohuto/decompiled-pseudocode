/*
 * XREFs of ??1?$com_ptr_t@VCApplication@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800282FC
 * Callers:
 ...
 *     _CWindowsPolicyManager::RuntimeClassInitialize_::_1_::dtor$0 @ 0x18004CDEC (_CWindowsPolicyManager--RuntimeClassInitialize_--_1_--dtor$0.c)
 *     _CApplicationManager::OnApplicationClosed_::_1_::dtor$0 @ 0x18004D8C9 (_CApplicationManager--OnApplicationClosed_--_1_--dtor$0.c)
 * Callees:
