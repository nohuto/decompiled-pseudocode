/*
 * XREFs of ?RecordFeatureUsage@FeatureStateManager@details@wil@@QEAAXIW4wil_details_ServiceReportingKind@@_K@Z @ 0x180024A74
 * Callers:
 *     ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800263A0 (-WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z.c)
 * Callees:
 ...
 *     ?RecordFeatureUsageUnderLock@FeatureStateData@details_abi@wil@@QEAA_NIW4wil_details_ServiceReportingKind@@_K@Z @ 0x180024B68 (-RecordFeatureUsageUnderLock@FeatureStateData@details_abi@wil@@QEAA_NIW4wil_details_ServiceRepor.c)
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180024C90 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 */
...
LABEL_10:
      if ( !wil::ProcessShutdownInProgress(v10) )
      {
        ...
        wil::details::EnsureCoalescedTimer<wil::details::FeatureStateManager>((struct _TP_TIMER **)a1 + 6, a1 + 65, a1);
