/*
 * XREFs of ?ReadBackgroundMediaRecordingCapability@CApplicationManager@@QEAAJPEAXPEAH@Z @ 0x18003B164
 * Callers:
        ...
        int *a3)
{
  ...
  *a3 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, v4);
  }
  if ( (_BYTE)v7 )
    *a3 = 1;
  return 0LL;
