/*
 * XREFs of ?RegisterAudioStateMonitor@AudioStateMonitorManager@@QEAAJPEAW4AUDIO_DIRECTION@@PEAW4_AUDIO_STREAM_CATEGORY@@PEBGPEA_K@Z @ 0x18004718C
 * Callers:
...
LABEL_33:
    ...
    if ( a4 )
    {
      ...
      do
        ++v18;
      while ( a4[v18] );
      v19 = _AllocStringWorker<CTCoAllocPolicy>(v17, v16, a4, v18, v30, (char **)(v11 + 16));
      v12 = v19;
      if ( v19 < 0 )
      {
...
LABEL_34:
        ...
        operator delete((void *)v11, (const struct std::nothrow_t *)0x20);
        goto LABEL_36;
      }
    }
    if ( a3 )
