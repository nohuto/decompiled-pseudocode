/*
 * XREFs of ??4?$com_ptr_t@UIAudioProcessNotification@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z @ 0x180033784
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<IAudioProcessNotification,wil::err_returncode_policy>::operator=(
        __int64 *a1,
        __int64 *a2)
{
  __int64 v3; // rcx
