/*
 * XREFs of ?UpdateState@ApplicationSpecificEndpointInfo@@AEAAJW4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@PEBG@Z @ 0x180048CC8
 * Callers:
  ...
  if ( a3 != 1 )
  {
    ...
    if ( a4 )
    {
      ...
      do
        ++v20;
      while ( a4[v20] );
      v14 = _AllocStringWorker<CTCoAllocPolicy>(v19, v18, a4, v20, v22, (char **)v17);
      v15 = v14;
      if ( v14 < 0 )
      {
        v16 = 508LL;
...
LABEL_17:
  ...
  do
    ++v13;
  while ( a4[v13] );
  v14 = _AllocStringWorker<CTCoAllocPolicy>(v12, v11, a4, v13, v22, (char **)v10);
  v15 = v14;
  if ( v14 >= 0 )
    goto LABEL_17;
  v16 = 495LL;
