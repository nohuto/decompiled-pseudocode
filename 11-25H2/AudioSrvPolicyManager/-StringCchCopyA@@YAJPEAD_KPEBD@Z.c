/*
 * XREFs of ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x180025BEC
 * Callers:
 *     ?LoadPropertyStore@CAudioSessionPropertyStore@@AEAAJXZ @ 0x1800169D0 (-LoadPropertyStore@CAudioSessionPropertyStore@@AEAAJXZ.c)
 *     ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x1800237F4 (-GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z.c)
