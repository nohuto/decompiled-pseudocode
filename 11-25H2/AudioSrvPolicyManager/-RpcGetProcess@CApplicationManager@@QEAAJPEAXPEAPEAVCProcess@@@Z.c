/*
 * XREFs of ?RpcGetProcess@CApplicationManager@@QEAAJPEAXPEAPEAVCProcess@@@Z @ 0x1800082D0
 * Callers:
...
__int64 __fastcall CApplicationManager::RpcGetProcess(CApplicationManager *this, void *a2, struct CProcess **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v19 )
  {
    ...
    {
LABEL_150:
      wil::com_ptr_t<CProcess,wil::err_returncode_policy>::~com_ptr_t<CProcess,wil::err_returncode_policy>((volatile signed __int32 **)&v99);
...
LABEL_64:
    ...
    AudPolicyLogError("GetProcessModuleNameAndAppId", 353, v31);
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x359,
      (int)"clientcore\\multimedia\\audiocore\\server\\audiosrv\\windowspolicymanager\\applicationmanager.cpp",
...
LABEL_165:
    p_Sid = (unsigned __int16 *)&SidSubAuthorityCount;
    v31 = _AllocStringWorker<CTCoAllocPolicy>(v25, v24, &unk_180056790, 0LL);
    if ( v31 >= 0 )
    {
      v28 = SidSubAuthorityCount;
      goto LABEL_167;
...
LABEL_170:
  ...
  v31 = _AllocStringWorker<CTCoAllocPolicy>(v60, v59, &unk_180056790, 0LL);
  if ( v31 >= 0 )
  {
    v61 = Sid;
    goto LABEL_170;
