/*
 * XREFs of ?ApplySessionMuteChanges@CApplicationManager@@QEAAJKK@Z @ 0x18003929C
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_62cd855da9b9fa3df701769829143d73__void_::_Do_call @ 0x180043610 (std--_Func_impl_no_alloc__lambda_62cd855da9b9fa3df701769829143d73__void_--_Do_call.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids);
  }
