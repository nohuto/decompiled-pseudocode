/*
 * XREFs of ?MakeAbsolute@CSecurityDesc@ATL@@QEAAXXZ @ 0x18004978C
 * Callers:
 ...
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x18001F994 (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
