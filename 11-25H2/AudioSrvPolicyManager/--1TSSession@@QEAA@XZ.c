/*
 * XREFs of ??1TSSession@@QEAA@XZ @ 0x18003FE30
 * Callers:
 ...
 *     ?clear@?$forward_list@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAXXZ @ 0x180038258 (-clear@-$forward_list@V-$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$.c)
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18003FDA0 (--1-$unique_storage@U-$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1-WTSFreeMemory@@YAX0@ZU-$integ.c)
 *     ??1CStreamClassPolicyGainsWrapper@@QEAA@XZ @ 0x18003FDD0 (--1CStreamClassPolicyGainsWrapper@@QEAA@XZ.c)
 *     ?UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ @ 0x180043354 (-UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ.c)
 */
