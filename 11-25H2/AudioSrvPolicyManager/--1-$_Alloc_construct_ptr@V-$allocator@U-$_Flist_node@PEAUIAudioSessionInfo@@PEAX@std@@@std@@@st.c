/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18001E578
 * Callers:
 ...
 *     _CDuckingManager::OnStateChanged_::_1_::dtor$5 @ 0x18004C450 (_CDuckingManager--OnStateChanged_--_1_--dtor$5.c)
 * Callees:
