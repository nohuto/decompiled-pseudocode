/*
 * XREFs of ?SendAppClosureNotification@CApplication@@QEAAXXZ @ 0x180036BC4
 * Callers:
 ...
 *     ?SendAppClosureNotification@CProcess@@QEAAJXZ @ 0x180036C88 (-SendAppClosureNotification@CProcess@@QEAAJXZ.c)
