/*
 * XREFs of ??1CDuckingManager@@UEAA@XZ @ 0x18002842C
 * Callers:
 ...
 *     ??1?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@QEAA@XZ @ 0x1800281E0 (--1-$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@QEAA@XZ.c)
 ...
 *     ??1CSerialWorkQueue@@QEAA@XZ @ 0x180028504 (--1CSerialWorkQueue@@QEAA@XZ.c)
 */
