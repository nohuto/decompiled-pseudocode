/*
 * XREFs of ?Shutdown@CWindowsPolicyManager@@UEAAXXZ @ 0x18002CFA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CWindowsPolicyManager::Shutdown(CWindowsPolicyManager *this)
{
  ...
  v11 = &stru_180067AF8;
  std::_Hash<std::_Umap_traits<unsigned long,std::unique_ptr<TSSession>,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,std::unique_ptr<TSSession>>>,0>>::clear(&dword_180067B20);
  ...
  v2 = g_DuckingManager;
  *((_BYTE *)g_DuckingManager + 408) = 1;
  std::_Mutex_base::lock((struct CDuckingManager *)((char *)v2 + 328));
  *((_BYTE *)v2 + 320) = 1;
  ...
  *((_QWORD *)this + 4) = 0LL;
  if ( v8 )
    Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,ISessionInternalEvents>::Release(
      v8,
      v5);
  CWindowsPolicyManager::Lock(v8, &v12);
  v9 = (struct _RTL_CRITICAL_SECTION *)*((_QWORD *)this + 5);
  *((_QWORD *)this + 5) = 0LL;
  v11 = v9;
  wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>(&v12);
  wil::com_ptr_t<CDuckingManager,wil::err_returncode_policy>::reset(&v11);
  ...
  wil::com_ptr_t<CDuckingManager,wil::err_returncode_policy>::~com_ptr_t<CDuckingManager,wil::err_returncode_policy>((__int64 *)&v11);
}
