/*
 * XREFs of ?SetDuckingGainForId@CWindowsPolicyManager@@UEAAJKPEBGM@Z @ 0x18000CDC0
 * Callers:
 ...
 *     ?GetUserPreferenceFromdB@CDuckingManager@@SA?AW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@M@Z @ 0x18000D064 (-GetUserPreferenceFromdB@CDuckingManager@@SA-AW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@M.c)
        ...
        float a4)
{
  ...
  try
  {
    v9 = 2 * (qword_180067B50 & v6);
    v10 = *(_QWORD *)(qword_180067B38 + 8 * v9 + 8);
...
LABEL_7:
    ...
    else
    {
      ...
      {
        if ( v10 == *(_QWORD *)(qword_180067B38 + 8 * v9) )
          goto LABEL_7;
        v10 = *(_QWORD *)(v10 + 8);
      }
    }
...
LABEL_17:
        ...
        v15 = (volatile signed __int32 *)HeapAlloc(ProcessHeap, 0, 0x30uLL);
        v16 = v15;
        v22[2] = v15;
        if ( v15 )
        {
          ...
          *((_DWORD *)v15 + 2) = 1;
          *((_DWORD *)v15 + 3) = 1;
          *(_QWORD *)v15 = &std::_Ref_count_obj2<std::wstring>::`vftable';
          std::_Construct_in_place<std::wstring,unsigned short const * &>(v15 + 4, &v31);
        }
        else
        {
          v16 = 0LL;
        ...
        v27 = a4;
        v28 = &v23;
        v17 = QueueGenericWorkItem((__int64 *)&v23);
        v19 = v17;
        if ( v17 >= 0 )
        {
          if ( v16 )
