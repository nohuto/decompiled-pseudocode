/*
 * XREFs of ?GetPLMExemptionStatus@CApplicationManager@@QEAA?AW4_PLM_EXEMPTION@@PEAVCApplication@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0004@@@Z @ 0x180002D90
 * Callers:
...
__int64 __fastcall CApplicationManager::GetPLMExemptionStatus(__int64 a1, __int64 a2, int a3)
{
  ...
  else
  {
    ...
    if ( dword_180056080[v6] && (unsigned int)CApplication::IsRestrictedBackgroundAudioCapable((CApplication *)a2) )
      goto LABEL_28;
    v7 = 1;
    if ( a3 )
    {
