/*
 * XREFs of std::function_void___cdecl(void)_::function_void___cdecl(void)___lambda_bc5d681da67d9384ebd56f302790ab0c__&_0_ @ 0x180038620
 * Callers:
...
__int64 __fastcall std::function_void___cdecl_void__::function_void___cdecl_void____lambda_bc5d681da67d9384ebd56f302790ab0c____0_(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  a1[7] = 0LL;
  *a1 = off_180054018;
  lambda_bc5d681da67d9384ebd56f302790ab0c_::_lambda_bc5d681da67d9384ebd56f302790ab0c_(a1 + 1, a2, a3, a1);
  result = v3;
  *(_QWORD *)(v3 + 56) = v3;
  return result;
}
