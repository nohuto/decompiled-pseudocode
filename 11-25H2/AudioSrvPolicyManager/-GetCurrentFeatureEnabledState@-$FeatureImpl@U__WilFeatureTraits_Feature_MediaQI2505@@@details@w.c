/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2505@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800399FC
 * Callers:
...
LABEL_13:
  ...
  IsEnabled = wil::details::FeatureImpl<__WilFeatureTraits_Feature_ImplVal>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_ImplVal>::GetImpl'::`2'::impl);
  v9 = *(_DWORD *)a2;
  if ( v11 && !IsEnabled )
    v9 &= ~0x400u;
