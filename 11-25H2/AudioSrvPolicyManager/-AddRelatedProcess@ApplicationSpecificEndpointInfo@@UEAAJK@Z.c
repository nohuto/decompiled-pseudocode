/*
 * XREFs of ?AddRelatedProcess@ApplicationSpecificEndpointInfo@@UEAAJK@Z @ 0x1800478F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ApplicationSpecificEndpointInfo::AddRelatedProcess(ApplicationSpecificEndpointInfo *this, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v5 == *((_BYTE **)this + 9) )
    {
      try
      {
        std::vector<unsigned long>::_Emplace_reallocate<unsigned long const &>((_QWORD *)this + 7, v5, &v10);
      }
      catch ( ... )
      {
