/*
 * XREFs of ?HasAccessibilityAudioStateChanged@CWindowsPolicyManager@@UEAA?AW4AccessibilityStateChange@@XZ @ 0x180007C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::HasAccessibilityAudioStateChanged(__int64 a1)
{
  ...
  if ( Process < 0 )
  {
    ...
    wil::com_ptr_t<CProcess,wil::err_returncode_policy>::~com_ptr_t<CProcess,wil::err_returncode_policy>((volatile signed __int32 **)&v38);
    goto LABEL_72;
  }
  v3 = v38;
  (*(void (__fastcall **)(struct CProcess *))(*(_QWORD *)v38 + 8LL))(v38);
  if ( v38 )
    Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IAudioProcess,IAudioProcessInternal>::Release(v38);
  ...
  v8 = *(_QWORD *)(qword_180067B38 + 16 * (qword_180067B50 & v7) + 8);
...
LABEL_24:
  ...
  EnterCriticalSection(&stru_180067AF8);
  EnterCriticalSection(&stru_180067AF8);
  v15 = (_QWORD *)(qword_180067B38 + 16 * (qword_180067B50 & v7));
  v16 = v15[1];
  if ( v16 == qword_180067B28 )
  {
LABEL_29:
    v16 = 0LL;
  }
  ...
  EnterCriticalSection(&stru_180067AF8);
  v20 = (_QWORD *)(qword_180067B38 + 16 * (qword_180067B50 & v7));
  v21 = v20[1];
  if ( v21 == qword_180067B28 )
  {
LABEL_39:
    v21 = 0LL;
  }
...
LABEL_57:
    ...
    v36 = 0LL;
    EnterCriticalSection(&stru_180067AF8);
    v28 = 2 * (qword_180067B50 & v7);
    v29 = *(_QWORD *)(qword_180067B38 + 8 * v28 + 8);
    if ( v29 == qword_180067B28 )
    {
LABEL_61:
      v29 = 0LL;
    }
    else
    {
      ...
      {
        if ( v29 == *(_QWORD *)(qword_180067B38 + 8 * v28) )
          goto LABEL_61;
        v29 = *(_QWORD *)(v29 + 8);
      }
    }
