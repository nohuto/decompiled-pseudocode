 ...
 *     ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18001E578 (--1-$_Alloc_construct_ptr@V-$allocator@U-$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@@st.c)
 *     ??1?$_Flist_insert_after_op2@V?$allocator@U?$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18002EC10 (--1-$_Flist_insert_after_op2@V-$allocator@U-$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@.c)
 */
        ...
        _QWORD *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !a1 )
    {
      ...
      std::_Alloc_construct_ptr<std::allocator<std::_Flist_node<IAudioSessionInfo *,void *>>>::~_Alloc_construct_ptr<std::allocator<std::_Flist_node<IAudioSessionInfo *,void *>>>((__int64)&v9);
      if ( v7 )
      {
        *v7 = *v4;
        *v4 = v6;
