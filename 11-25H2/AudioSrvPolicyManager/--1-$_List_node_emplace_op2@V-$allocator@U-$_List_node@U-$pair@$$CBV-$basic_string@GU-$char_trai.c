/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@UCRenderEndpointDuckingManagerContext@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18002EC4C
 * Callers:
        ...
        __int64 a4)
{
  ...
  v5 = *(_QWORD *)(a1 + 8);
  if ( v5 )
    std::wstring::~wstring(v5 + 16, a2, a3, a4);
