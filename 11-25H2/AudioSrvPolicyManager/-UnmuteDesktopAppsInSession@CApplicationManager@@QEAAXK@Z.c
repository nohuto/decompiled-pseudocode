/*
 * XREFs of ?UnmuteDesktopAppsInSession@CApplicationManager@@QEAAXK@Z @ 0x18003C014
 * Callers:
...
void __fastcall CApplicationManager::UnmuteDesktopAppsInSession(CApplicationManager *this, int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, a2);
  }
