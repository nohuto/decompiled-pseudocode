/*
 * XREFs of ?SilenceAndRevokePLMExemption@CApplicationManager@@QEAAXPEAVCApplication@@@Z @ 0x18003BF48
 * Callers:
 ...
 *     ?SilenceAndRevokePLMExemption@CProcess@@UEAAJXZ @ 0x180036FA0 (-SilenceAndRevokePLMExemption@CProcess@@UEAAJXZ.c)
