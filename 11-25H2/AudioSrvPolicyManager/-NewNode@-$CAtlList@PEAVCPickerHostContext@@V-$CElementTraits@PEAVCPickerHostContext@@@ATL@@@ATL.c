/*
 * XREFs of ?NewNode@?$CAtlList@PEAVCPickerHostContext@@V?$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCPickerHostContext@@PEAV312@1@Z @ 0x18003CCA0
 * Callers:
        ...
        __int64 a4)
{
  ...
  result = (__int64 *)qword_180066F18;
  if ( !qword_180066F18 )
  {
    v7 = ATL::CAtlPlex::Create(&qword_180066F10, (unsigned int)dword_180066F20, 0x18uLL);
    if ( !v7 )
      ATL::AtlThrowImpl(-2147024882);
    v8 = (unsigned int)(dword_180066F20 - 1);
    result = (__int64 *)qword_180066F18;
    for ( i = (__int64 *)((char *)v7 + 16 * v8 + 8 * v8 + 8); (int)v8 >= 0; LODWORD(v8) = v8 - 1 )
    {
      *i = (__int64)result;
      result = i;
      qword_180066F18 = (__int64)i;
      i -= 3;
    }
  }
  v10 = *result;
