/*
 * XREFs of ?TsSessionNewPrimaryConsoleAudioSession@@YAXPEAVTSSession@@@Z @ 0x180042AD8
 * Callers:
...
void __fastcall TsSessionNewPrimaryConsoleAudioSession(struct TSSession *a1)
{
  ...
  if ( !v2 )
  {
    for ( i = *(_QWORD **)qword_180067B28; ; i = (_QWORD *)*i )
    {
      if ( i == (_QWORD *)qword_180067B28 )
        goto LABEL_8;
      v4 = (_DWORD *)i[3];
      if ( *v4 )
      {
