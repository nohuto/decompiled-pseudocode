/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@IEAAX_K@Z @ 0x180043624
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,std::unique_ptr<TSSession>>>>>>>::_Assign_grow(
    (__int64)&qword_180067B38,
    2 * v5,
    qword_180067B28);
  v7 = v5 - 1;
  qword_180067B50 = v5 - 1;
  qword_180067B58 = v5;
  for ( i = *(_QWORD *)qword_180067B28; i != v3; i = v12 )
  {
    ...
    v13 = qword_180067B38;
    v14 = 2 * (v7 & v9);
    if ( *(_QWORD *)(qword_180067B38 + 16 * (v7 & v9)) == v3 )
    {
      *(_QWORD *)(qword_180067B38 + 16 * (v7 & v9)) = v11;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v11;
      goto LABEL_15;
    }
    v15 = *(__int64 **)(qword_180067B38 + 16 * (v7 & v9) + 8);
    v6 = *v10;
    ...
    {
      v19 = v15 + 1;
      if ( *(__int64 **)(qword_180067B38 + 8 * v14) == v15 )
        break;
      v15 = (__int64 *)*v19;
