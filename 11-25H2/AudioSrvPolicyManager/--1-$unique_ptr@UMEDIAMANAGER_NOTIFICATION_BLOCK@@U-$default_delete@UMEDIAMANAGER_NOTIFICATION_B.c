/*
 * XREFs of ??1?$unique_ptr@UMEDIAMANAGER_NOTIFICATION_BLOCK@@U?$default_delete@UMEDIAMANAGER_NOTIFICATION_BLOCK@@@std@@@std@@QEAA@XZ @ 0x18003FD18
 * Callers:
 ...
 *     _GenerateMediaManagerNotification_::_1_::dtor$0 @ 0x18004DC64 (_GenerateMediaManagerNotification_--_1_--dtor$0.c)
 *     _TsSessionSendAppManagerNotification_::_1_::dtor$1 @ 0x18004DDF3 (_TsSessionSendAppManagerNotification_--_1_--dtor$1.c)
 * Callees:
