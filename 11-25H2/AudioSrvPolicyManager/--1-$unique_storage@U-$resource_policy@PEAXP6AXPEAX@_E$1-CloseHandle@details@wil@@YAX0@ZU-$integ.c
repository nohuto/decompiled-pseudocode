/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1800227C0
 * Callers:
 *     ??1?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x180022618 (--1-$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ??1SemaphoreValue@details_abi@wil@@QEAA@XZ @ 0x180022898 (--1SemaphoreValue@details_abi@wil@@QEAA@XZ.c)
 ...
 * Callees:
 *     ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180022E94 (-CloseHandle@details@wil@@YAXPEAX@Z.c)
 */
