/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@VCGainStage@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x180017440
 * Callers:
        ...
        volatile signed __int32 *a1)
{
  ...
  for ( i = *((_DWORD *)a1 + 13); i != 0x7FFFFFFF; i = *((_DWORD *)a1 + 13) )
  {
    if ( i == _InterlockedCompareExchange(a1 + 13, i - 1, i) )
      break;
  }
  v2 = i - 1;
  if ( i == 1 )
