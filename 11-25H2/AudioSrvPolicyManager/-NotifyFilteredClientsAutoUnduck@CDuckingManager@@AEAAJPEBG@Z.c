/*
 * XREFs of ?NotifyFilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x180030664
 * Callers:
    ...
    if ( v7 )
    {
      ...
      *((_DWORD *)v7 + 14) = 0;
      ...
      try
      {
        ...
        v13[2] = 0LL;
        v14 = 256;
        CLockedList_UniqueValuesOnly<CDuckingNotification,0>::ForEachEntry((__int64)v15, v13);
      }
