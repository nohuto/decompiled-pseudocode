/*
 * XREFs of ?HandleMediaPlaybackRequestForApp@CApplicationManager@@QEAAJPEBG_KK@Z @ 0x18003A32C
 * Callers:
        ...
        DWORD a4)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, a2);
    v9 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
...
LABEL_24:
        ...
        if ( v14 )
        {
          ...
          if ( active < 0 )
          {
            ...
            AudPolicyLogError("CApplicationManager::HandleMediaPlaybackRequestForApp", 1504, active);
          }
          goto LABEL_17;
        }
      }
    ...
    if ( v9 != &WPP_GLOBAL_Control && (*((_DWORD *)v9 + 7) & 0x40000000) != 0 && *((_BYTE *)v9 + 25) >= 4u )
      WPP_SF_S((TRACEHANDLE)v9[2], 0x1Eu, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, a2);
LABEL_17:
    v11 = active;
    goto LABEL_18;
  }
