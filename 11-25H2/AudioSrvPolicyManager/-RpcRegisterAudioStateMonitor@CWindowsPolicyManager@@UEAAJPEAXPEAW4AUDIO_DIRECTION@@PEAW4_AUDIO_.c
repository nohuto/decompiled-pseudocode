/*
 * XREFs of ?RpcRegisterAudioStateMonitor@CWindowsPolicyManager@@UEAAJPEAXPEAW4AUDIO_DIRECTION@@PEAW4_AUDIO_STREAM_CATEGORY@@PEBGPEA_K@Z @ 0x18002C8A0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a6)
{
  ...
  CWindowsPolicyManager::Lock((__int64)this, v15);
  v14 = 0LL;
