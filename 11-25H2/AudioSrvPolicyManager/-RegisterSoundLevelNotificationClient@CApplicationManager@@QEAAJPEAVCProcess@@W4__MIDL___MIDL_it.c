/*
 * XREFs of ?RegisterSoundLevelNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0003@@@Z @ 0x18003B4D0
 * Callers:
        ...
        int a3)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, v7);
    }
    AudPolicyLogError("CApplicationManager::RegisterSoundLevelNotificationClient", 492, v7);
  }
  else
  {
