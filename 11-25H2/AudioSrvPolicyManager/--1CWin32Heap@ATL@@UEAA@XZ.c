/*
 * XREFs of ??1CWin32Heap@ATL@@UEAA@XZ @ 0x18001FA28
 * Callers:
 *     ??_ECWin32Heap@ATL@@UEAAPEAXI@Z @ 0x180049C40 (--_ECWin32Heap@ATL@@UEAAPEAXI@Z.c)
 *     ATL::_dynamic_atexit_destructor_for__g_strheap__ @ 0x18004E2D0 (ATL--_dynamic_atexit_destructor_for__g_strheap__.c)
 * Callees:
 *     <none>
 */
