/*
 * XREFs of Windows::Internal::AssignedAccess::AssignedAccessConfigurationHelper::FindUserInfoIf__lambda_661bc23c674c805837064d315685ee67___ @ 0x18004A978
 * Callers:
 ...
 *     ??Dvector_iterator_nothrow@?$vector_range_nothrow@U?$IVectorView@PEAVAssignedAccessUserInfo@AssignedAccess@Internal@Windows@@@Collections@Foundation@Windows@@@wil@@QEBAAEBV?$ComPtr@UIAssignedAccessUserInfo@AssignedAccess@Internal@Windows@@@WRL@Microsoft@@XZ @ 0x18004AB48 (--Dvector_iterator_nothrow@-$vector_range_nothrow@U-$IVectorView@PEAVAssignedAccessUserInfo@Assi.c)
 *     _lambda_661bc23c674c805837064d315685ee67_::operator() @ 0x18004AB58 (_lambda_661bc23c674c805837064d315685ee67_--operator().c)
 *     ??Yvector_iterator_nothrow@?$vector_range_nothrow@U?$IVectorView@PEAVAssignedAccessUserInfo@AssignedAccess@Internal@Windows@@@Collections@Foundation@Windows@@@wil@@QEAAAEAV012@H@Z @ 0x18004AC38 (--Yvector_iterator_nothrow@-$vector_range_nothrow@U-$IVectorView@PEAVAssignedAccessUserInfo@Assi.c)
 ...
 *     ?begin@?$vector_range_nothrow@U?$IVectorView@PEAVAssignedAccessUserInfo@AssignedAccess@Internal@Windows@@@Collections@Foundation@Windows@@@wil@@QEAA?AVvector_iterator_nothrow@12@XZ @ 0x18004AE18 (-begin@-$vector_range_nothrow@U-$IVectorView@PEAVAssignedAccessUserInfo@AssignedAccess@Internal@.c)
