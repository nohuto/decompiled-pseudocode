/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x18004B2C4
 * Callers:
 *     <none>
 * Callees:
 *     __GSHandlerCheckCommon @ 0x180020960 (__GSHandlerCheckCommon.c)
 *     __CxxFrameHandler4_0 @ 0x18002108E (__CxxFrameHandler4_0.c)
 */
