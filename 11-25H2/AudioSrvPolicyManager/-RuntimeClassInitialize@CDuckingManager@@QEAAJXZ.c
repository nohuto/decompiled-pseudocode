/*
 * XREFs of ?RuntimeClassInitialize@CDuckingManager@@QEAAJXZ @ 0x180030FAC
 * Callers:
 ...
 *     ?GetdBFromUserPreference@CDuckingManager@@CAMW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@@Z @ 0x1800142C0 (-GetdBFromUserPreference@CDuckingManager@@CAMW4__MIDL___MIDL_itf_audiopolicyp_0000_0000_0001@@@Z.c)
 ...
 *     ??$make_unique@VDuckingDescriptor@@MHH$0A@@std@@YA?AV?$unique_ptr@VDuckingDescriptor@@U?$default_delete@VDuckingDescriptor@@@std@@@0@$$QEAM$$QEAH1@Z @ 0x18002E950 (--$make_unique@VDuckingDescriptor@@MHH$0A@@std@@YA-AV-$unique_ptr@VDuckingDescriptor@@U-$default.c)
