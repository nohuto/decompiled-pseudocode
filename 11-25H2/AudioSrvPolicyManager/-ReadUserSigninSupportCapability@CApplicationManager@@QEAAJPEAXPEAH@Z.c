/*
 * XREFs of ?ReadUserSigninSupportCapability@CApplicationManager@@QEAAJPEAXPEAH@Z @ 0x18003B1FC
 * Callers:
...
__int64 __fastcall CApplicationManager::ReadUserSigninSupportCapability(CApplicationManager *this, void *a2, int *a3)
{
  ...
  *a3 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x17u, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, v5);
  }
