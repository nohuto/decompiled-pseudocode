/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x1800127C0
 * Callers:
 ...
 *     ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x180049708 (-Init@CNtDeleteKey@@QEAA_NXZ.c)
...
LABEL_8:
  ...
  v17 = (CNtDeleteKey *)*(unsigned int *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                        + 4LL);
  if ( dword_180067C78 > (int)v17 )
  {
    Init_thread_header(&dword_180067C78);
    if ( dword_180067C78 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_180067C78);
    }
  }
  if ( v13 == 5 || !v13 )
    goto LABEL_27;
  ...
  {
    if ( !CNtDeleteKey::Init(v17) || !qword_180067C88 || (unsigned int)qword_180067C88(hKey) )
    {
LABEL_27:
      if ( hKey )
        RegCloseKey(hKey);
