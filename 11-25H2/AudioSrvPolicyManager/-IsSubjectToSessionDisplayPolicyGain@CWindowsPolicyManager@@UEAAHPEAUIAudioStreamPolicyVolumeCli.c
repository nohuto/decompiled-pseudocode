/*
 * XREFs of ?IsSubjectToSessionDisplayPolicyGain@CWindowsPolicyManager@@UEAAHPEAUIAudioStreamPolicyVolumeClient@@@Z @ 0x18002A9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamPolicyVolumeClient *a2)
{
  ...
  if ( v8(a2, &v15) >= 0 )
  {
    ...
    if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_AudioOverLockScreen>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_AudioOverLockScreen>::GetImpl'::`2'::impl)
      && ((*((_BYTE *)this + 52) & 3) == 3
       || (*((_BYTE *)this + 52) & 1) != 0
