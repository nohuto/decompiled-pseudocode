/*
 * XREFs of ??1?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@QEAA@XZ @ 0x1800281E0
 * Callers:
 *     ??1CDuckingManager@@UEAA@XZ @ 0x18002842C (--1CDuckingManager@@UEAA@XZ.c)
 *     _CDuckingManager::CDuckingManager_::_1_::dtor$3 @ 0x18004CD6D (_CDuckingManager--CDuckingManager_--_1_--dtor$3.c)
 * Callees:
