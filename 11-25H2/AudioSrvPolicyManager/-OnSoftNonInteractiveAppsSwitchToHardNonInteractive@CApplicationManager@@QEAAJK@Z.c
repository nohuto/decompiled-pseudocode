/*
 * XREFs of ?OnSoftNonInteractiveAppsSwitchToHardNonInteractive@CApplicationManager@@QEAAJK@Z @ 0x180019F1C
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 54LL, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, a2);
  }
