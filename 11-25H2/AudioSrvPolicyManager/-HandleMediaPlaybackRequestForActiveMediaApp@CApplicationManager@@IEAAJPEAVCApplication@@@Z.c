/*
 * XREFs of ?HandleMediaPlaybackRequestForActiveMediaApp@CApplicationManager@@IEAAJPEAVCApplication@@@Z @ 0x18003A224
 * Callers:
...
LABEL_14:
  ...
  else
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      v9 = 33;
LABEL_18:
      WPP_SF_S(v8[2], v9, &WPP_7ac9f868b6f432f4e1ddc0ca024d1633_Traceguids, *((const wchar_t **)a2 + 3));
    }
  }
  return 0LL;
}
