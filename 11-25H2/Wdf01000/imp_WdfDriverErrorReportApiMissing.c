/*
 * XREFs of imp_WdfDriverErrorReportApiMissing @ 0x1400937D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FxVerifierDriverReportedBugcheck@@YAXPEAU_FX_DRIVER_GLOBALS@@K_K111@Z @ 0x140096D38 (-FxVerifierDriverReportedBugcheck@@YAXPEAU_FX_DRIVER_GLOBALS@@K_K111@Z.c)
 */
        ...
        unsigned __int8 DoesApiReturnNtstatus)
{
  ...
  if ( !DoesApiReturnNtstatus || v12->FxVerifierOn )
    FxVerifierDriverReportedBugcheck(v12, 0x10Du, 0x10uLL, (unsigned __int64)v14, (unsigned __int64)v13, v6);
  return 3221225594LL;
}
