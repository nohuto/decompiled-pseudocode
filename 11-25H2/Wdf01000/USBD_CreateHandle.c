/*
 * XREFs of USBD_CreateHandle @ 0x140075B08
 * Callers:
 *     ?InitDevice@FxUsbDevice@@QEAAJK@Z @ 0x14005A0DC (-InitDevice@FxUsbDevice@@QEAAJK@Z.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x140075F58 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
