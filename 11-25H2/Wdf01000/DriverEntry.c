/*
 * XREFs of DriverEntry @ 0x140085A60
 * Callers:
 *     GsDriverEntry @ 0x1400E5010 (GsDriverEntry.c)
 * Callees:
 *     ?FxLibraryCleanup@@YAXXZ @ 0x140085318 (-FxLibraryCleanup@@YAXXZ.c)
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x14008536C (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 *     ?WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x14008568C (-WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
