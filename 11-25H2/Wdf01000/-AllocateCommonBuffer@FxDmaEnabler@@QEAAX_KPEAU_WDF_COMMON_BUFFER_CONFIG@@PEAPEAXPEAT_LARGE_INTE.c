/*
 * XREFs of ?AllocateCommonBuffer@FxDmaEnabler@@QEAAX_KPEAU_WDF_COMMON_BUFFER_CONFIG@@PEAPEAXPEAT_LARGE_INTEGER@@@Z @ 0x1400895E8
 * Callers:
        ...
        _LARGE_INTEGER *BufferPA)
{
  ...
  __int64 v10; // r9
  _LARGE_INTEGER MinimumAddress; // rcx
