/*
 * XREFs of imp_WdfRequestGetFileObject @ 0x140039140
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( v8->FxVerifierIO != (_BYTE)v3 )
  {
    ...
    FxNonPagedObject::Unlock(flags, irql, v30);
    v3 = 0LL;
    if ( _a1 < 0 )
    {
LABEL_32:
...
LABEL_23:
  if ( !FsContext )
  {
    if ( Next >= 0 )
    {
      ...
      if ( _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(globals, v31, 9u) )
        FxVerifierDbgBreakPoint(m_DeviceBase->m_Globals);
    }
    goto LABEL_55;
  }
