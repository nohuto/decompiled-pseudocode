/*
 * XREFs of imp_WdfPdoInitAddHardwareID @ 0x140053940
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( DeviceInit->InitType == FxDeviceInitTypePdo )
      {
        ...
        if ( v10 )
        {
          ...
          if ( v13 )
          {
            ...
            if ( (v11 & 0x80000000) == 0 )
              v11 = FxCollectionInternal::Add(&DeviceInit->Pdo.HardwareIDs, v5, v14) == 0 ? 0xC0000001 : 0;
            v14->Release(v14, 0LL, 0, 0LL);
            return v11;
          }
        }
        v11 = -1073741670;
