/*
 * XREFs of ?_CreateCompletionRoutine2@FxPkgGeneral@@CAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z @ 0x1400AAC80
 * Callers:
 *     <none>
 * Callees:
 *     ?Complete@FxRequest@@QEAAJJ@Z @ 0x14000CFD0 (-Complete@FxRequest@@QEAAJJ@Z.c)
 *     ?PropagatePendingReturned@FxIrp@@QEAAXXZ @ 0x140060914 (-PropagatePendingReturned@FxIrp@@QEAAXXZ.c)
 */
