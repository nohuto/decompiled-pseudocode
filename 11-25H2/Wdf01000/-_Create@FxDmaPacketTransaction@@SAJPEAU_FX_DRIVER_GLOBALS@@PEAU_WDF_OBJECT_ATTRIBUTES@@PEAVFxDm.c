/*
 * XREFs of ?_Create@FxDmaPacketTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x140087A54
 * Callers:
        ...
        WDFDMATRANSACTION__ **Transaction)
{
  ...
  $606C41BA9BCC3D85D2F60B9807CEBB34 *v12; // rax
