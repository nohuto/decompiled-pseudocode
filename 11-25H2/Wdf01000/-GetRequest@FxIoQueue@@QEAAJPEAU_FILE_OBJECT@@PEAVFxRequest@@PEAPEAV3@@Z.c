/*
 * XREFs of ?GetRequest@FxIoQueue@@QEAAJPEAU_FILE_OBJECT@@PEAVFxRequest@@PEAPEAV3@@Z @ 0x140025360
 * Callers:
 ...
 *     ?RemoveIrpFromQueueByContext@FxIrpQueue@@AEAAPEAU_IRP@@PEAU_IO_CSQ_IRP_CONTEXT@@@Z @ 0x140048900 (-RemoveIrpFromQueueByContext@FxIrpQueue@@AEAAPEAU_IRP@@PEAU_IO_CSQ_IRP_CONTEXT@@@Z.c)
        ...
        FxRequest **pOutRequest)
{
  ...
  $296A67BADB4D0BFB9E59A0608284FDB2 *v13; // rdi
  ...
  _LIST_ENTRY *v19; // rcx
  _LIST_ENTRY *v20; // rax
  $296A67BADB4D0BFB9E59A0608284FDB2 *v21; // rdi
  _LIST_ENTRY *v22; // rax
  ...
  $296A67BADB4D0BFB9E59A0608284FDB2 *v55; // [rsp+48h] [rbp-40h]
  unsigned __int8 irql; // [rsp+90h] [rbp+8h] BYREF
  FxRequest **v57; // [rsp+A8h] [rbp+20h]
  ...
  else
  {
    ...
    if ( this->m_PowerState == FxIoQueuePowerOff )
    {
      ...
      FxNonPagedObject::Unlock(this, v10, v44);
      return -1071644157;
    }
    else
    {
      ...
      while ( 1 )
      {
        ...
        *((_QWORD *)i + 22) = i + 42;
        ...
        v13 = ($296A67BADB4D0BFB9E59A0608284FDB2 *)*((_QWORD *)i + 18);
...
LABEL_21:
        ...
        ((void (__fastcall *)($296A67BADB4D0BFB9E59A0608284FDB2 *, __int64, __int64, const char *))v22)(
          v21,
          1969583441LL,
          2102LL,
        ...
        if ( BYTE1(v21->m_CsqContext.Csq[5].CsqInsertIrp) )
        {
          ...
          {
            v46 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&v21[4].m_CsqContext.Csq);
            PreviousIrql[0] = v46;
          }
          FxRequest::VerifyRequestIsNotCompleted((FxRequest *)v21, (_FX_DRIVER_GLOBALS *)v21->m_CsqContext.Csq);
          FxNonPagedObject::Unlock((FxNonPagedObject *)v21, v46, v47);
        }
        ...
        if ( CurrentStackLocation->MajorFunction != 3 )
        {
          ...
          {
            FxNonPagedObject::Unlock(this, v10, v23);
            if ( m_Globals->FxVerboseOn )
            {
              ...
              if ( WORD1(v21->m_ListEntry.Blink) )
                v52 = (const void *)((unsigned __int64)v21 ^ 0xFFFFFFFFFFFFFFF8uLL);
              else
                v52 = 0LL;
              WPP_IFR_SF_qq(m_Globals, 5u, 0xDu, 0x1Eu, WPP_FxIoQueue_cpp_Traceguids, v52, v51);
            }
            FxRequest::CompleteWithInformation((FxRequest *)v21, 0, 0LL);
            ((void (__fastcall *)($296A67BADB4D0BFB9E59A0608284FDB2 *, __int64, __int64, const char *))v21->m_ListEntry.Flink[1].Flink)(
              v21,
              1886220099LL,
              1139LL,
              "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
            FxNonPagedObject::Lock(this, &irql, v53);
            v10 = irql;
            v13 = v55;
            continue;
          }
LABEL_25:
          ...
          if ( Blink->Flink == &this->m_DriverOwned )
          {
            ...
            {
              v48 = (const void *)((unsigned __int64)v21 ^ 0xFFFFFFFFFFFFFFF8uLL);
              if ( !WORD1(v21->m_ListEntry.Blink) )
                v48 = 0LL;
              WPP_IFR_SF_q(
            ...
            *((_BYTE *)&v21[14].m_ListEntry + 16) = 1;
            ((void (__fastcall *)($296A67BADB4D0BFB9E59A0608284FDB2 *, __int64, __int64, const char *))v30[1].Flink)(
              v21,
              1952543827LL,
              1193LL,
              "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
...
LABEL_82:
        ...
        ((void (__fastcall *)($296A67BADB4D0BFB9E59A0608284FDB2 *, __int64, __int64, const char *))v21->m_ListEntry.Flink[1].Flink)(
          ...
          "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
        if ( SLOBYTE(this->m_ObjectFlags) < 0
          && (v50 = *(FxVerifierLock **)&this[-1].m_PowerIdle.m_DbgFlagIsInitialized) != 0LL )
        {
          FxVerifierLock::Lock(v50, &irql, v38);
          v10 = irql;
          v13 = v55;
        }
        else
