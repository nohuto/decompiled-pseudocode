/*
 * XREFs of FxLibraryCommonRegisterClient @ 0x1400777A8
 * Callers:
 ...
 *     FxAllocateDriverGlobals @ 0x14007D4CC (FxAllocateDriverGlobals.c)
 ...
 *     ?IsClientInfoValid@@YAEPEAU_CLIENT_INFO@@@Z @ 0x14008E34C (-IsClientInfoValid@@YAEPEAU_CLIENT_INFO@@@Z.c)
 ...
 *     McGenEventRegister_EtwRegister @ 0x14008EB30 (McGenEventRegister_EtwRegister.c)
