/*
 * XREFs of ?ConfigureBusMasterAdapters@FxDmaEnabler@@AEAAJPEAU_DEVICE_DESCRIPTION@@PEAU_WDF_DMA_ENABLER_CONFIG@@@Z @ 0x140089724
 * Callers:
        ...
        _WDF_DMA_ENABLER_CONFIG *Config)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    {
      v3 = (v9 & 0x10) == 0;
      GetDmaAlignment = (void (*)(void))this->m_SimplexAdapterInfo.AdapterObject->DmaOperations->GetDmaAlignment;
      if ( v3 )
      {
        GetDmaAlignment();
