/*
 * XREFs of imp_WdfUsbTargetPipeConfigContinuousReader @ 0x14009BF40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z @ 0x140068384 (-IsType@FxUsbPipe@@QEAAEW4_WDF_USB_PIPE_TYPE@@@Z.c)
