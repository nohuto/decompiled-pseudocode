/*
 * XREFs of imp_WdfInterruptWdmGetInterrupt @ 0x14005F3A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetInterruptPtr@FxInterrupt@@QEAAPEAU_KINTERRUPT@@XZ @ 0x14005F3D8 (-GetInterruptPtr@FxInterrupt@@QEAAPEAU_KINTERRUPT@@XZ.c)
 */
