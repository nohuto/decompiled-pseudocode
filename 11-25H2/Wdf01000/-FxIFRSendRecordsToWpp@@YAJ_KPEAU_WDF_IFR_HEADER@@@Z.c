/*
 * XREFs of ?FxIFRSendRecordsToWpp@@YAJ_KPEAU_WDF_IFR_HEADER@@@Z @ 0x14008D14C
 * Callers:
 *     ?FxIFRReplay@@YAX_K@Z @ 0x14008CE0C (-FxIFRReplay@@YAX_K@Z.c)
 * Callees:
 *     FxWmiTraceMessage @ 0x140056368 (FxWmiTraceMessage.c)
 *     ?FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z @ 0x14008D388 (-FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z.c)
 */
