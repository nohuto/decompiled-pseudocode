/*
 * XREFs of ?InterruptEnableInvokeCallback@FxInterrupt@@AEAAJXZ @ 0x1400720D4
 * Callers:
 *     ?_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1400720B0 (-_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z.c)
 * Callees:
