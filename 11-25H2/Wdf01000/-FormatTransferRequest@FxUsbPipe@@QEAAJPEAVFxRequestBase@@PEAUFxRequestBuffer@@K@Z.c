/*
 * XREFs of ?FormatTransferRequest@FxUsbPipe@@QEAAJPEAVFxRequestBase@@PEAUFxRequestBuffer@@K@Z @ 0x14002D9BC
 * Callers:
        ...
        unsigned int TransferFlags)
{
  ...
  void *v19; // rax
  FxUsbPipeTransferContext *v20; // rax
  __int64 v21; // rax
  ...
  FxPoolTypeOrPoolFlags v47; // [rsp+40h] [rbp-38h] BYREF
...
LABEL_12:
  ...
  if ( !m_RequestContext || m_RequestContext->m_RequestType != 16 )
  {
    ...
    v18 = this->m_Globals;
    v19 = retaddr;
    *(_QWORD *)&v47.UsePoolType = 0LL;
    v47.u.PoolFlags = 64LL;
    if ( !v18->FxPoolTrackingOn )
      v19 = 0LL;
    v20 = (FxUsbPipeTransferContext *)FxPoolAllocator(v18, &v18->FxPoolFrameworks, &v47, 0x120uLL, v18->Tag, v19);
    if ( !v20 )
      return -1073741670;
    FxUsbPipeTransferContext::FxUsbPipeTransferContext(v20, v17);
