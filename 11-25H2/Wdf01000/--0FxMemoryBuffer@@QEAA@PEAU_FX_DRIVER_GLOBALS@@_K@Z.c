/*
 * XREFs of ??0FxMemoryBuffer@@QEAA@PEAU_FX_DRIVER_GLOBALS@@_K@Z @ 0x140038BD8
 * Callers:
...
void __fastcall FxMemoryBuffer::FxMemoryBuffer(
        FxMemoryBuffer *this,
        ...
        unsigned __int64 BufferSize)
{
  ...
  this->m_Type = 4096;
  this->FxMemoryObject::FxObject::__vftable = (FxMemoryBuffer_vtbl *)FxObject::`vftable';
  this->m_Globals = FxDriverGlobals;
  this->m_ObjectSize = ((BufferSize + 15) & 0xFFF0) + 128;
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  this->FxMemoryObject::FxObject::__vftable = (FxMemoryBuffer_vtbl *)FxMemoryObject::`vftable'{for `FxObject'};
