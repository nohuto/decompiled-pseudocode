/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1400AB7C0
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x14006DB24 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1400AC680 (_guard_dispatch_icall.c)
 *     WdmlibProcgrpInitialize @ 0x1400DB1FC (WdmlibProcgrpInitialize.c)
 */
