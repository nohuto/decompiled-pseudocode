/*
 * XREFs of ?_RequestCompletionRoutine@FxIoTarget@@KAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z @ 0x14001F370
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
  ...
  if ( ($296A67BADB4D0BFB9E59A0608284FDB2 *)Flink->Blink != &Context->120
  ...
  *(_QWORD *)&v14->Type = Flink;
  ...
  {
    v35 = 0;
    FxNonPagedObject::Lock(Context, &v35);
    v30 = v35;
