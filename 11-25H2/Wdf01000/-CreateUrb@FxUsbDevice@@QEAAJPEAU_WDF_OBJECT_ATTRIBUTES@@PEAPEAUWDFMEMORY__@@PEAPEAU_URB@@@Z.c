/*
 * XREFs of ?CreateUrb@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAPEAUWDFMEMORY__@@PEAPEAU_URB@@@Z @ 0x140023128
 * Callers:
...
LABEL_21:
  ...
  v14 = (FxUsbUrb *)FxObjectHandleAlloc2(m_Globals, v12, 0x88uLL, v13, Attributes, 0, FxObjectTypeExternal);
  if ( !v14 || (FxUsbUrb::FxUsbUrb(v14, m_Globals, this->m_USBDHandle, urbLocal, 0x98uLL), (v16 = v15) == 0LL) )
  {
    v10 = -1073741670;
    goto LABEL_21;
  }
