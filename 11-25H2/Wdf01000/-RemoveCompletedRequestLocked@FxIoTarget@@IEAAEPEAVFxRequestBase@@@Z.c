/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x140005240
 * Callers:
...
unsigned __int8 __fastcall FxIoTarget::RemoveCompletedRequestLocked(FxIoTarget *this, FxRequestBase *Request)
{
  ...
  $296A67BADB4D0BFB9E59A0608284FDB2 *v6; // rax
  _IRP *Irp; // rdx
  ...
  if ( ($296A67BADB4D0BFB9E59A0608284FDB2 *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($296A67BADB4D0BFB9E59A0608284FDB2 **)&Irp->Type != v6) )
  {
    __fastfail(3u);
  }
