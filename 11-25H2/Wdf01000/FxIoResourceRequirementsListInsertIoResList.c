/*
 * XREFs of FxIoResourceRequirementsListInsertIoResList @ 0x140098774
 * Callers:
 *     imp_WdfIoResourceRequirementsListAppendIoResList @ 0x140099020 (imp_WdfIoResourceRequirementsListAppendIoResList.c)
 *     imp_WdfIoResourceRequirementsListInsertIoResList @ 0x140099130 (imp_WdfIoResourceRequirementsListInsertIoResList.c)
 * Callees:
