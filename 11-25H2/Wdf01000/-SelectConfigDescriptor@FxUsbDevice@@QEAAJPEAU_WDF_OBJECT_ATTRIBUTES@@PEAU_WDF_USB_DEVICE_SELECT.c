/*
 * XREFs of ?SelectConfigDescriptor@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_USB_DEVICE_SELECT_CONFIG_PARAMS@@@Z @ 0x14009F3F4
 * Callers:
        ...
        _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS *Params)
{
  ...
  if ( v17 )
  {
    ...
    ConfigRequest = FxUsbDevice::CreateConfigRequest(this, ConfigurationDescriptor, v18);
    v24 = ConfigRequest;
    if ( ConfigRequest )
    {
