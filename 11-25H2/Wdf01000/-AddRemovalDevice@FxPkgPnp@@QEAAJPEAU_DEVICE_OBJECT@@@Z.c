/*
 * XREFs of ?AddRemovalDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1400A5B24
 * Callers:
 ...
 *     ??0FxRelatedDevice@@QEAA@PEAU_DEVICE_OBJECT@@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1400AC0C0 (--0FxRelatedDevice@@QEAA@PEAU_DEVICE_OBJECT@@PEAU_FX_DRIVER_GLOBALS@@@Z.c)
 */

__int64 __fastcall FxPkgPnp::AddRemovalDevice(
        FxPkgPnp *this,
...
LABEL_7:
  ...
  if ( !(_WORD)m_ObjectSize )
    _a1 = 0LL;
  WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x4Au, WPP_FxPkgPnp_cpp_Traceguids, _a1, -1073741670);
LABEL_8:
...
LABEL_13:
  ...
  if ( !v18 )
    return 3221225626LL;
  v20 = FxTransactionedList::Add(this->m_RemovalDeviceList, this->m_Globals, (FxTransactionedEntry *)(v18 + 104));
  if ( v20 < 0 )
