/*
 * XREFs of ?GetNextDevice@FxChildList@@QEAAJPEAPEAUWDFDEVICE__@@PEAU_WDF_CHILD_LIST_ITERATOR@@PEAU_WDF_CHILD_RETRIEVE_INFO@@@Z @ 0x140055650
 * Callers:
 *     imp_WdfChildListRetrieveNextDevice @ 0x140055470 (imp_WdfChildListRetrieveNextDevice.c)
 * Callees:
 *     WPP_IFR_SF_qd @ 0x140025B50 (WPP_IFR_SF_qd.c)
 *     ?MatchStateToFlags@FxDeviceDescriptionEntry@@QEAAEK@Z @ 0x140055954 (-MatchStateToFlags@FxDeviceDescriptionEntry@@QEAAEK@Z.c)
