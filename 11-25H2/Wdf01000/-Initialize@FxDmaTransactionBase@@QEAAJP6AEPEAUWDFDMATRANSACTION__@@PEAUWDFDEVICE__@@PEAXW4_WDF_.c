/*
 * XREFs of ?Initialize@FxDmaTransactionBase@@QEAAJP6AEPEAUWDFDMATRANSACTION__@@PEAUWDFDEVICE__@@PEAXW4_WDF_DMA_DIRECTION@@PEAU_SCATTER_GATHER_LIST@@@Z3PEAU_MDL@@_KK@Z @ 0x140063454
 * Callers:
        ...
        unsigned int Length)
{
  ...
  $606C41BA9BCC3D85D2F60B9807CEBB34 *v16; // rcx
  ...
  if ( m_DmaEnabler->m_SimplexAdapterInfo.DeviceDescription.Version == 3 )
  {
    if ( (*((_BYTE *)m_DmaEnabler + 380) & 0x10) != 0 )
      v16 = ($606C41BA9BCC3D85D2F60B9807CEBB34 *)((char *)&m_DmaEnabler->184 + 96 * v8);
