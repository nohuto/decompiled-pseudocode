/*
 * XREFs of ?InitDevice@FxUsbDevice@@QEAAJK@Z @ 0x14005A0DC
 * Callers:
...
LABEL_4:
  ...
  *(_DWORD *)((char *)&urb.UrbGetIsochPipeTransferPathDelays + 130) = 512;
  ...
  {
    v5 = -1073741823;
    WPP_IFR_SF_DDd(m_Globals, v9, 0xEu, 0xEu, WPP_FxusbDeviceKm_cpp_Traceguids, config.wTotalLength, 9u, -1073741823);
    goto $Done_22;
  }
  Tag = m_Globals->Tag;
  v13 = retaddr;
