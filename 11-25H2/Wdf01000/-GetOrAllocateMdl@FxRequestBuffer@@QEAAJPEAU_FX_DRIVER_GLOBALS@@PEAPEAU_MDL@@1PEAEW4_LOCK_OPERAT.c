/*
 * XREFs of ?GetOrAllocateMdl@FxRequestBuffer@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAU_MDL@@1PEAEW4_LOCK_OPERATION@@EPEA_K@Z @ 0x14002E170
 * Callers:
 ...
 *     FxProbeAndLockWithAccess @ 0x14002CC78 (FxProbeAndLockWithAccess.c)
