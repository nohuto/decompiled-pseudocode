/*
 * XREFs of FxRegistrySettingsInitialize @ 0x14006D2D4
 * Callers:
 ...
 *     ?SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z @ 0x14006E2DC (-SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z.c)
