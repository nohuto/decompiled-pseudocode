/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToService @ 0x14008AABC
 * Callers:
 ...
 *     wil_details_MapReportingKind @ 0x14008AF98 (wil_details_MapReportingKind.c)
        ...
        unsigned __int64 a4)
{
  ...
  {
    if ( WPP_GLOBAL_WDF_Control.Queue.Wcb.BufferChainingDpc )
      ((void (__fastcall *)(unsigned int, const FEATURE_LOGGED_TRAITS *, const FEATURE_ERROR *, int, const wil_ReportingKind *, const wil_VariantReportingKind *, unsigned __int8, unsigned __int64))WPP_GLOBAL_WDF_Control.Queue.Wcb.BufferChainingDpc)(
