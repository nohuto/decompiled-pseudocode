/*
 * XREFs of ?PowerPolicySetSxWakeSettings@FxPkgPnp@@QEAAJPEAU_WDF_DEVICE_POWER_POLICY_WAKE_SETTINGS@@EE@Z @ 0x1400767C0
 * Callers:
...
LABEL_8:
  ...
  if ( KeGetCurrentIrql() )
  {
    WPP_IFR_SF_(this->m_Globals, 3u, 0xCu, 0x3Au, WPP_FxPkgPnp_cpp_Traceguids);
  }
  else
  {
...
LABEL_9:
  ...
  if ( this->m_CapsQueried || KeGetCurrentIrql() || (result = FxPkgPnp::QueryForCapabilities(this), result >= 0) )
  {
    ...
    if ( DxState == PowerDeviceMaximum )
    {
      ...
      {
        WPP_IFR_SF_DD(this->m_Globals, _a2 - 2, 0xCu, 0x3Bu, WPP_FxPkgPnp_cpp_Traceguids, _a2, 0xC00002D3);
        return -1073741101;
      }
    }
    else if ( DxState > _a2 )
    {
      WPP_IFR_SF_LLd(this->m_Globals, v14, v15, 0x3Cu, traceGuid, DxState, _a2, enabled);
      return -1073741101;
    }
