/*
 * XREFs of ?Allocate@FxNPagedLookasideListFromPool@@UEAAJPEAPEAVFxMemoryObject@@@Z @ 0x140057080
 * Callers:
 *     <none>
 * Callees:
        ...
        FxMemoryBufferFromLookaside **PPMemory)
{
  ...
  v7 = FxAllocateFromNPagedLookasideList(&this->m_PoolLookaside, v6);
  if ( !v7 )
  {
  ...
  *(_OWORD *)&inited[1].m_Globals = 0LL;
  ...
  if ( inited )
  {
    ...
    inited[1].FxMemoryObject::FxObject::__vftable = (FxMemoryBufferFromLookaside_vtbl *)v7;
