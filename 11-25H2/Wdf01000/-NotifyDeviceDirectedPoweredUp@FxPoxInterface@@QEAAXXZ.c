/*
 * XREFs of ?NotifyDeviceDirectedPoweredUp@FxPoxInterface@@QEAAXXZ @ 0x14003BC74
 * Callers:
 ...
 *     ?PowerPolTimerExpiredWakeCompletedHardwareStarted@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1400A8BB0 (-PowerPolTimerExpiredWakeCompletedHardwareStarted@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE.c)
 * Callees:
