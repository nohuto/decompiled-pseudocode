/*
 * XREFs of ?PnpQueryCapabilities@FxPkgFdo@@AEAAJPEAVFxIrp@@@Z @ 0x1400646C8
 * Callers:
 *     ?_PnpQueryCapabilities@FxPkgFdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z @ 0x1400646B0 (-_PnpQueryCapabilities@FxPkgFdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z.c)
 * Callees:
