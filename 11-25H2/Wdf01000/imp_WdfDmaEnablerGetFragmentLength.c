/*
 * XREFs of imp_WdfDmaEnablerGetFragmentLength @ 0x1400A1E00
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 v4; // rbx
  $606C41BA9BCC3D85D2F60B9807CEBB34 *v6; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v6 = ($606C41BA9BCC3D85D2F60B9807CEBB34 *)&pDmaEnabler->m_DuplexAdapterInfo[1];
