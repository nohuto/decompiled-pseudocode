/*
 * XREFs of ?Close@FxIoTargetRemote@@QEAAXW4FxIoTargetRemoteCloseReason@@@Z @ 0x14001146C
 * Callers:
 *     imp_WdfIoTargetClose @ 0x1400111E0 (imp_WdfIoTargetClose.c)
 *     ?Remove@FxIoTargetRemote@@UEAAXXZ @ 0x140011380 (-Remove@FxIoTargetRemote@@UEAAXXZ.c)
