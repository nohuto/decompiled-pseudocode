/*
 * XREFs of FxIoTargetFormatIoctl @ 0x14002CC9C
 * Callers:
 *     imp_WdfIoTargetFormatRequestForInternalIoctl @ 0x14006A390 (imp_WdfIoTargetFormatRequestForInternalIoctl.c)
 *     imp_WdfIoTargetFormatRequestForIoctl @ 0x14006B720 (imp_WdfIoTargetFormatRequestForIoctl.c)
 * Callees:
        ...
        _WDFMEMORY_OFFSET *OutputBufferOffsets)
{
  ...
  __int16 v52; // [rsp+78h] [rbp-49h]
  __int16 v53; // [rsp+7Ah] [rbp-47h]
  int v54; // [rsp+7Ch] [rbp-45h]
  ...
  unsigned int v60; // [rsp+128h] [rbp+67h]
...
LABEL_22:
  v25 = FxIoTarget::FormatIoctlRequest(pTarget, pRequest, v60, Internal, &inputBuf, &outputBuf, level);
  if ( (v25 & 0x80000000) == 0 )
  {
    v26 = Internal != 0;
    Internal = -Internal;
    m_RequestContext = pRequest->m_RequestContext;
    m_RequestContext->m_CompletionParams.Parameters.Ioctl.IoControlCode = v60;
