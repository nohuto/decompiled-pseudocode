/*
 * XREFs of ?RequestCompletionRoutine@FxIoTarget@@IEAAXPEAVFxRequestBase@@@Z @ 0x14001EEA0
 * Callers:
...
void __fastcall FxIoTarget::RequestCompletionRoutine(FxIoTarget *this, FxRequestBase *Request, unsigned __int8 a3)
{
  ...
  $296A67BADB4D0BFB9E59A0608284FDB2 *v11; // rax
  _IRP *Irp; // rcx
...
LABEL_26:
  ...
  v11 = &Request->120;
  if ( ($296A67BADB4D0BFB9E59A0608284FDB2 *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($296A67BADB4D0BFB9E59A0608284FDB2 **)&Irp->Type != v11) )
  {
    __fastfail(3u);
  }
