/*
 * XREFs of imp_WdfRequestMarkCancelableEx @ 0x140022500
 * Callers:
 *     <none>
 * Callees:
        ...
        void (__fastcall *EvtRequestCancel)(WDFREQUEST__ *))
{
  ...
  _IRP *m_Irp; // rdx
  $296A67BADB4D0BFB9E59A0608284FDB2 *v16; // rcx
  _LIST_ENTRY *v17; // rax
...
LABEL_48:
          ...
          FxNonPagedObject::Unlock(m_IoQueue, v28, (unsigned __int8)p_ListEntry);
          if ( v9->FxVerifierOn )
