/*
 * XREFs of ?GetInformation@FxUsbPipe@@QEAAXPEAU_WDF_USB_PIPE_INFORMATION@@@Z @ 0x140067904
 * Callers:
 ...
 * Callees:
 *     ?GetMaxPacketSize@FxUsbPipe@@QEAAKXZ @ 0x14006796C (-GetMaxPacketSize@FxUsbPipe@@QEAAKXZ.c)
