/*
 * XREFs of ?_PowerPolicyWaitWakeCompletionRoutine@FxPkgPnp@@KAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX@Z @ 0x14003A180
 * Callers:
 *     <none>
 * Callees:
 *     WPP_IFR_SF_q @ 0x14001FA38 (WPP_IFR_SF_q.c)
 *     WPP_IFR_SF_qqqd @ 0x140039FFC (WPP_IFR_SF_qqqd.c)
 *     ?PowerPolicyUpdateSystemWakeSource@FxPkgPnp@@IEAAXPEAVFxIrp@@@Z @ 0x14003A304 (-PowerPolicyUpdateSystemWakeSource@FxPkgPnp@@IEAAXPEAVFxIrp@@@Z.c)
 */
        ...
        void *Context)
{
    ...
    || _InterlockedExchange((volatile __int32 *)(*((_QWORD *)Context + 111) + 944LL), 1) == 1 )
  {
    ...
    if ( v10->FxVerboseOn )
      WPP_IFR_SF_q(v10, 5u, 0xCu, 0x30u, WPP_PowerPolicyStateMachine_cpp_Traceguids, OriginalIrp);
    PoStartNextPowerIrp(OriginalIrp);
    IoReleaseRemoveLockEx((PIO_REMOVE_LOCK)&DeviceObject[1], OriginalIrp, 0x20u);
  }
  else
  {
    v12 = (_FX_DRIVER_GLOBALS *)*((_QWORD *)Context + 2);
    if ( v12->FxVerboseOn )
      WPP_IFR_SF_q(v12, 5u, 0xCu, 0x31u, WPP_PowerPolicyStateMachine_cpp_Traceguids, OriginalIrp);
