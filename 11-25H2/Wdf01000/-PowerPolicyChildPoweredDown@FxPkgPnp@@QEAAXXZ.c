/*
 * XREFs of ?PowerPolicyChildPoweredDown@FxPkgPnp@@QEAAXXZ @ 0x140018980
 * Callers:
 *     ?PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ @ 0x140018950 (-PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ.c)
 * Callees:
