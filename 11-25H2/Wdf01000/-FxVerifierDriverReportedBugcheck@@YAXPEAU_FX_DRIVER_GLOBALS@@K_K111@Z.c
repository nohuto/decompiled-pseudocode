/*
 * XREFs of ?FxVerifierDriverReportedBugcheck@@YAXPEAU_FX_DRIVER_GLOBALS@@K_K111@Z @ 0x140096D38
 * Callers:
 *     imp_WdfCxVerifierKeBugCheck @ 0x140092730 (imp_WdfCxVerifierKeBugCheck.c)
 *     imp_WdfVerifierKeBugCheck @ 0x140092810 (imp_WdfVerifierKeBugCheck.c)
