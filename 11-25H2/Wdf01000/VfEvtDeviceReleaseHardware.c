/*
 * XREFs of VfEvtDeviceReleaseHardware @ 0x1400E2A20
 * Callers:
 *     <none>
 * Callees:
 *     ?PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x14008F9B4 (-PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z.c)
