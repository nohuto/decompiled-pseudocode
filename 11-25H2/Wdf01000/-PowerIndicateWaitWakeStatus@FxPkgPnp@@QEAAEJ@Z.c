/*
 * XREFs of ?PowerIndicateWaitWakeStatus@FxPkgPnp@@QEAAEJ@Z @ 0x14006F17C
 * Callers:
 ...
 *     ?IndicateWakeStatus@FxChildList@@QEAAXJ@Z @ 0x14006EFBC (-IndicateWakeStatus@FxChildList@@QEAAXJ@Z.c)
 ...
 *     ?PowerMakeWakeRequestNonCancelable@FxPkgPnp@@IEAAEJ@Z @ 0x14006F1D4 (-PowerMakeWakeRequestNonCancelable@FxPkgPnp@@IEAAEJ@Z.c)
 */
