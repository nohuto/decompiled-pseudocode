/*
 * XREFs of ?Initialize@FxWorkItem@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_WORKITEM_CONFIG@@PEAVFxObject@@PEAPEAUWDFWORKITEM__@@@Z @ 0x140022EC4
 * Callers:
 ...
 *     ?IsPassiveCallbacks@FxObject@@QEAAEE@Z @ 0x1400505E0 (-IsPassiveCallbacks@FxObject@@QEAAEE@Z.c)
