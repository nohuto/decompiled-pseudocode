/*
 * XREFs of ?PnpProcessEventInner@FxPkgPnp@@IEAAXPEAUFxPostProcessInfo@@@Z @ 0x14003D2B0
 * Callers:
...
void __fastcall FxPkgPnp::PnpProcessEventInner(FxPkgPnp *this, FxPostProcessInfo *Info)
{
  ...
  while ( 1 )
  {
    ...
    if ( (_a4 & 0x3C3000) == 0 && (*(_DWORD *)&FxPkgPnp::m_WdfPnpStates[v6].StateInfo.Bits & 1) == 0 )
      goto LABEL_11;
    p_m_PnpMachine->m_QueueHead = ((unsigned int)p_m_PnpMachine->m_QueueHead + 1) % p_m_PnpMachine->m_QueueDepth;
