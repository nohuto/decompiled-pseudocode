/*
 * XREFs of ?Add@FxChildList@@QEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@PEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@PEAK@Z @ 0x1400181BC
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  FxDeviceDescriptionEntry *v17; // rax
  __int64 v18; // rax
  __int64 v19; // r14
  _LIST_ENTRY *v20; // rdx
  _LIST_ENTRY *v21; // rax
  ...
  FxPoolTypeOrPoolFlags v26; // [rsp+50h] [rbp-10h] BYREF
...
LABEL_25:
  ...
  if ( !m_Globals->FxPoolTrackingOn )
    v15 = 0LL;
  v17 = (FxDeviceDescriptionEntry *)FxPoolAllocator(
                                      m_Globals,
                                      &m_Globals->FxPoolFrameworks,
                                      &v26,
                                      m_TotalDescriptionSize,
                                      Tag,
                                      v15);
  if ( !v17
