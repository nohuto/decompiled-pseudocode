/*
 * XREFs of ?FormatRepeater@FxUsbPipeContinuousReader@@QEAAJPEAUFxUsbPipeRepeatReader@@@Z @ 0x14002CA9C
 * Callers:
  ...
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v13[1].m_CompletionParams.Size = v14;
      Request->m_CompletionRoutine.m_Completion = (void (__fastcall *)(WDFREQUEST__ *, WDFIOTARGET__ *, _WDF_REQUEST_COMPLETION_PARAMS *, void *))FxUsbPipeContinuousReader::_FxUsbPipeRequestComplete;
