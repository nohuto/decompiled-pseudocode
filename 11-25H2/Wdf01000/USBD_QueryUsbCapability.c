/*
 * XREFs of USBD_QueryUsbCapability @ 0x1400802C4
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1400AB000 (USBDInternal_BuildandSendIoctlSynchronously.c)
        ...
        unsigned int *ResultLength)
{
  ...
  else
  {
    ...
    *(_QWORD *)&usbCapability.Version = 2621441LL;
    ...
    v9 = USBDInternal_BuildandSendIoctlSynchronously(v13, v12, OutputBuffer, &usbCapability, v15);
