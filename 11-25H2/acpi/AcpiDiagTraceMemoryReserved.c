/*
 * XREFs of AcpiDiagTraceMemoryReserved @ 0x140098CF4
 * Callers:
...
char AcpiDiagTraceMemoryReserved(char a1, char a2, char a3, ...)
{
  ...
  {
    LOBYTE(v3) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_MEMORY_RESERVED);
    if ( (_BYTE)v3 )
    {
      UserData.Reserved = 0;
      v8 = 0;
