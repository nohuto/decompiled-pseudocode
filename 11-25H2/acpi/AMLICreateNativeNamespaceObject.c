/*
 * XREFs of AMLICreateNativeNamespaceObject @ 0x14006D5F4
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  Src = a2;
  v29 = 0;
  valid = AMLIGetValidNamespaceName((__int64)&Src, 0LL);
  if ( valid < 0 )
  ...
  if ( a1 == 8 )
  {
    if ( a4 > 7 || a5 > 1 )
      return (unsigned int)-1073741637;
    v12 = (_BYTE *)NewObjData(gpheapGlobal, (__int64)&v25);
    v9 = v12;
    if ( !v12 )
  ...
  *a6 = 0;
  ...
  if ( NameSpaceObject < 0 )
  {
    if ( NameSpaceObject != -1073741772 )
      goto LABEL_19;
    valid = CreateNameSpaceObject(gpheapGlobal, (__int64)&Src, v11, gpNativeNameSpaceOwner, &v23, 0x20000);
  }
  else
  {
