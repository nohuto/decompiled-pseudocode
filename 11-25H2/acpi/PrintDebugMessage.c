/*
 * XREFs of PrintDebugMessage @ 0x140010060
 * Callers:
 ...
 *     DebugHelp @ 0x14006DCA0 (DebugHelp.c)
 ...
 *     DebugStep @ 0x14006E3E0 (DebugStep.c)
 *     DebugTrace @ 0x14006E430 (DebugTrace.c)
...
void __fastcall PrintDebugMessage(unsigned int a1, const void *a2, const void *a3, const void *a4, const void *a5)
{
  ...
  {
    DbgPrintEx(0x19u, 0, (&off_140087128)[2 * a1], a2, a3, a4, a5);
