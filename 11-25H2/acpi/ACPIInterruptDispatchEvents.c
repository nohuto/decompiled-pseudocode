/*
 * XREFs of ACPIInterruptDispatchEvents @ 0x140022520
 * Callers:
...
LABEL_7:
      ...
      if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
        && EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_UNEXPECTED_GPE) )
      {
        UserData.Ptr = (unsigned __int64)&v15;
        *(_QWORD *)&UserData.Size = 4LL;
        v17 = v14;
        v18 = 1LL;
        EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_UNEXPECTED_GPE, 0LL, 2u, &UserData);
      }
      v14[0] = v7;
