...
LABEL_10:
  ...
  {
    v13 = (unsigned __int8)BYTE1(*(_OWORD *)i);
    v14 = *(_DWORD *)(a1 + 32);
    v30 = *(_OWORD *)i;
    v31 = *((_OWORD *)i + 1);
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  for ( j = (__int128 *)(v18 + 8); (unsigned __int64)j < v18 + 32 * (unsigned __int64)*(unsigned int *)(v18 + 4) + 8; j += 2 )
  {
    v20 = (unsigned __int8)BYTE1(*j);
    v21 = *(_DWORD *)(a1 + 32);
    v30 = *j;
    v31 = j[1];
    if ( v20 == v21 || (_BYTE)v20 == 7 && v21 == 3 )
    {
      v4 = (*(__int64 (__fastcall **)(__int128 *, unsigned __int64 *, unsigned __int64 *, __int64 *, __int64 *))(a1 + 120))(
             &v30,
             &v27,
