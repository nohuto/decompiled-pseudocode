...
__int64 __fastcall DebugNotify(__int64 a1, _BYTE *a2, int a3, int a4)
{
  ...
  if ( a2 )
  {
    ...
    {
      strupr_0(a2);
      if ( (unsigned int)GetNameSpaceObject(a2, 0LL, (__int64)&qword_140089378, 1u) )
      {
...
LABEL_10:
    ...
    ObjectPath = GetObjectPath(qword_140089378);
    v8 = byte_140075488;
    v9 = (void *)ObjectPath;
    if ( ObjectPath )
    ...
    ghNotify(2LL, (unsigned int)qword_140089370, qword_140089378 + 120, qword_140088EE8, DummyCallBack, 0LL);
  }
LABEL_17:
  if ( qword_140089378 )
    DereferenceObjectEx(qword_140089378);
  return v4;
}
