...
LABEL_26:
        ...
        qword_140089358 = GetBaseObject(v15);
    ...
    else
    {
      ...
      else
      {
        ...
        *(_OWORD *)((char *)&unk_140089240 + 8 * v6) = 0LL;
        *(_OWORD *)((char *)&unk_140089240 + 8 * v6 + 16) = 0LL;
        *((_QWORD *)&unk_140089240 + v6 + 4) = 0LL;
        if ( (unsigned __int8)IsNumber(a2, 0LL) )
        {
          v7 = 5LL * dword_14008846C;
          *((_QWORD *)&unk_140089240 + v7 + 2) = strtoui64_0(a2, 0LL, 16);
          ++dword_14008846C;
          *((_WORD *)&unk_140089240 + 4 * v7 + 1) = 1;
          return v2;
        }
...
LABEL_27:
  ...
  qword_140088B70 = 0LL;
  fRunningMethod = 1;
  xmmword_140088B50 = 0LL;
  xmmword_140088B60 = 0LL;
  v8 = AsyncEvalObject(
         qword_140089358,
         (__int64)&xmmword_140088B50,
         dword_14008846C,
         (__int64)&unk_140089240,
  ...
  if ( v8 == 32772 )
  {
    ObjectPath = GetObjectPath(qword_140089358);
    v11 = byte_140075488;
    v12 = (void *)ObjectPath;
    if ( ObjectPath )
  ...
  {
    RunMethodCallBack(qword_140089358 + 120, v8, &xmmword_140088B50, 0LL);
    v2 = v9 != 0 ? 0xFFFFFFFC : 0;
  }
  DereferenceObjectEx(qword_140089358);
  qword_140089358 = 0LL;
  dword_14008846C = -1;
  if ( v2 )
    goto LABEL_27;
