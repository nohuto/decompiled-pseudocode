/*
 * XREFs of ProcessorpIndexInstance @ 0x14009729C
 * Callers:
 *     ProcessorAddInstance @ 0x1400AA62C (ProcessorAddInstance.c)
 * Callees:
 *     ProcessorpIsPreferredInterruptTarget @ 0x1400AAA64 (ProcessorpIsPreferredInterruptTarget.c)
 */
...
__int64 __fastcall ProcessorpIndexInstance(unsigned int a1, __int64 a2)
{
  ...
  if ( !v5 )
  {
    ...
    *(_QWORD *)(Pool2 + 16) = Pool2 + 16;
    v7 = (__int64 *)qword_140089808;
    if ( *(__int64 **)qword_140089808 != &ProcessorGroupListHead )
      goto LABEL_22;
    *(_QWORD *)(v5 + 8) = qword_140089808;
