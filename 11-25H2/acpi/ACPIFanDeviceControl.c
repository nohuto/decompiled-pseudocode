/*
 * XREFs of ACPIFanDeviceControl @ 0x14002BA40
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_BYTE *)(a2 + 68) && _InterlockedExchange64((volatile __int64 *)(a2 + 104), 0LL) )
    {
      ...
      *(_DWORD *)(a2 + 48) = -1073741536;
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        v43 = 32;
LABEL_50:
        WPP_RECORDER_SF_qDDqss(WPP_GLOBAL_Control->DeviceExtension, v19, v20, v23, v39, a2, v7[6], v43, v44, v45, v46);
      }
    }
    else
    {
