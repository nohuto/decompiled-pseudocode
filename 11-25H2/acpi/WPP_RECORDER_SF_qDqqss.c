/*
 * XREFs of WPP_RECORDER_SF_qDqqss @ 0x14005D490
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum @ 0x14004F910 (ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum.c)
 * Callees:
        ...
        const char *a11)
{
  ...
  LOWORD(v24) = a4;
  return WppAutoLogTrace(a1, 4LL, 10LL, &WPP_2c64a3eb75823feba16c7995e2df05b8_Traceguids, v24, &a6, 8LL, &a7);
}
