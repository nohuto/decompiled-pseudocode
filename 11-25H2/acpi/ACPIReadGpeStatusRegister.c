/*
 * XREFs of ACPIReadGpeStatusRegister @ 0x140021DA0
 * Callers:
...
__int64 __fastcall ACPIReadGpeStatusRegister(unsigned int a1)
{
  unsigned int v1; // ebx
  ...
  if ( v2(6LL) >= 0 )
  {
    v3 = 6LL;
LABEL_4:
    (*(void (__fastcall **)(__int64, _QWORD, unsigned __int8 *, __int64, _QWORD))(PmHalDispatchTable + 128))(
      v3,
      v1,
      &v5,
      1LL,
