/*
 * XREFs of ACPIAddInitializationDependencies @ 0x140046D58
 * Callers:
...
__int64 __fastcall ACPIAddInitializationDependencies(__int64 a1)
{
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( _bittest64((const signed __int64 *)(a1 + 1120), 0x26u) && *(_QWORD *)(a1 + 968) )
  {
  ...
  if ( v3 )
LABEL_23:
    _InterlockedOr64((volatile signed __int64 *)(a1 + 1120), 0x40uLL);
