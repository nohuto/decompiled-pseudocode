...
void AMLIResumeInterpreter()
{
  ...
  if ( (gReadyQueue & 0xC) != 0 && !--dword_140088F98 )
  {
    ...
    if ( (gdwfAMLI & 4) != 0 )
    {
      while ( 1 )
      {
        v0 = (_QWORD *)qword_140088F58;
        if ( (__int64 *)qword_140088F58 == &qword_140088F58 )
          break;
        if ( *(__int64 **)(qword_140088F58 + 8) != &qword_140088F58 )
          goto LABEL_14;
        v1 = *(_QWORD *)qword_140088F58;
        if ( *(_QWORD *)(*(_QWORD *)qword_140088F58 + 8LL) != qword_140088F58 )
          goto LABEL_14;
        qword_140088F58 = *(_QWORD *)qword_140088F58;
        *(_QWORD *)(v1 + 8) = &qword_140088F58;
        v0[1] = v0;
        *v0 = v0;
...
LABEL_14:
            __fastfail(3u);
          *v0 = qword_140088F58;
          v0[1] = &qword_140088F58;
          *(_QWORD *)(v2 + 8) = v0;
          qword_140088F58 = (__int64)v0;
          break;
        }
      }
    }
