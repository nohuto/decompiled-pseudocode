...
__int64 __fastcall SyncEvalObject(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( !ThreadCurrentContext )
  {
    ...
    {
      v15 = 9LL * (_InterlockedExchangeAdd((_DWORD *)&qword_140089108 + 1, 1u) % (unsigned int)qword_140089108);
      *((_QWORD *)qword_140089110 + v15 + 1) = MEMORY[0xFFFFF78000000008];
      *((_DWORD *)qword_140089110 + 2 * v15) = 1398361667;
      *((_QWORD *)qword_140089110 + v15 + 2) = CurrentThread;
      *((_QWORD *)qword_140089110 + v15 + 3) = 0LL;
      *((_QWORD *)qword_140089110 + v15 + 4) = 0LL;
      *((_QWORD *)qword_140089110 + v15 + 5) = v14;
      *((_QWORD *)qword_140089110 + v15 + 6) = CurrentIrql;
      *((_QWORD *)qword_140089110 + v15 + 7) = a1;
      *((_QWORD *)qword_140089110 + v15 + 8) = 0LL;
    }
