/*
 * XREFs of ProcessorpSelectProcessorSetFromPartitions @ 0x1400BD3D0
 * Callers:
 *     ProcessorpFindIdtEntriesApic @ 0x1400C1580 (ProcessorpFindIdtEntriesApic.c)
 * Callees:
 *     IntPartAllocateAndZeroMemory @ 0x14004F030 (IntPartAllocateAndZeroMemory.c)
 *     IntPartArbInit @ 0x1400AC0E0 (IntPartArbInit.c)
 *     IntpArbGetNextAffinity @ 0x1400BD588 (IntpArbGetNextAffinity.c)
 */
...
LABEL_30:
  ...
  *(_QWORD *)(v9 + 8) = v10;
LABEL_12:
  a1 = (__int64 *)qword_140089808;
  if ( *(__int64 **)qword_140089808 != &ProcessorGroupListHead )
    goto LABEL_30;
