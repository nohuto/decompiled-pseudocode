/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1400A1BC0
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( Status >= 0 )
  {
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *(_QWORD *)&OutputBuffer[4] = *(_QWORD *)(RootDeviceExtension + 768);
      AcpiGetDriverProxyEndpoint((_QWORD *)&OutputBuffer[4] + 1, (__int64)AcpiReflectNativeObject);
      AcpiGetDriverProxyEndpoint(&OutputBuffer[5], (__int64)AcpiNativeNotifyEventHandler);
      AcpiGetDriverProxyEndpoint((_QWORD *)&OutputBuffer[5] + 1, (__int64)AcpiTranslatePepDeviceControlResources);
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_140089EB0 = OutputBuffer[1];
        unk_140089EC0 = OutputBuffer[2];
        xmmword_140089ED0 = OutputBuffer[3];
        xmmword_140089EE0 = OutputBuffer[4];
        xmmword_140089EF0 = OutputBuffer[5];
