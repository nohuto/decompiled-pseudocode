/*
 * XREFs of ACPIPepPowerSettingChangeCallback @ 0x1400BA1C0
 * Callers:
 *     <none>
 * Callees:
 *     PepPromoteNextNotificationState @ 0x1400BA32C (PepPromoteNextNotificationState.c)
...
LABEL_7:
  ...
  v12 = 1LL;
LABEL_8:
  if ( (unsigned __int8)PepPromoteNextNotificationState(a4, v12, v9, 0LL) )
