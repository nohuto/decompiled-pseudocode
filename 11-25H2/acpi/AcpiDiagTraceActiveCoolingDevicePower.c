/*
 * XREFs of AcpiDiagTraceActiveCoolingDevicePower @ 0x14004FF4C
 * Callers:
...
void __fastcall AcpiDiagTraceActiveCoolingDevicePower(__int64 a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  {
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_ACTIVE_COOLING_DEVICE_POWER) )
    {
