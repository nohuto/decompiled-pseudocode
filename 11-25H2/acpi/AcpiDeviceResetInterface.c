...
__int64 __fastcall AcpiDeviceResetInterface(__int64 a1, __int64 a2)
{
  ...
  v2 = a2;
  *(_QWORD *)&xmmword_140088AA0 = AcpiDeviceResetReference;
  *((_QWORD *)&xmmword_140088AA0 + 1) = AcpiDeviceResetDereference;
  xmmword_140088A90 = DeviceResetInterface;
  xmmword_140088AB0 = *(_OWORD *)&off_140074240;
  *(_QWORD *)&xmmword_140088AB0 = AcpiDeviceReset;
  xmmword_140088AC0 = unk_140074250;
  *((_QWORD *)&xmmword_140088AC0 + 1) = AcpiQueryBusSpecificResetInfo;
  *(_QWORD *)&xmmword_140088AD0 = AcpiDeviceBusSpecificReset;
  *((_QWORD *)&xmmword_140088AD0 + 1) = AcpiGetDeviceResetStatus;
  v3 = *(_QWORD *)(a2 + 184);
  v4 = *(_QWORD **)(a1 + 64);
  v5 = *(_WORD *)(v3 + 18);
  v6 = 1;
...
LABEL_31:
  ...
  *(_QWORD *)(Pool2 + 40) = 0LL;
  if ( v5 > 1u )
  {
    *(_OWORD *)v8 = xmmword_140088A90;
    *((_OWORD *)v8 + 1) = xmmword_140088AA0;
    *((_OWORD *)v8 + 2) = xmmword_140088AB0;
    *((_OWORD *)v8 + 3) = xmmword_140088AC0;
    if ( v5 == 2 )
    {
      *((_QWORD *)v8 + 8) = xmmword_140088AD0;
      *(_DWORD *)v8 = 131144;
    }
    else
    {
      *((_OWORD *)v8 + 4) = xmmword_140088AD0;
    }
  }
  else
  {
