/*
 * XREFs of AcpiPccInitType0Subspace @ 0x1400A0370
 * Callers:
...
char __fastcall AcpiPccInitType0Subspace(_DWORD *DeferredContext, char *a2, unsigned __int8 a3)
{
  int v3; // ebp
  char v6; // si
  char v7; // al
