/*
 * XREFs of ArbInitializeRangeList @ 0x1400AB2E0
 * Callers:
 *     <none>
 * Callees:
 *     RtlFreeRangeList_0 @ 0x14005671F (RtlFreeRangeList_0.c)
 *     RtlInitializeRangeList_0 @ 0x140056731 (RtlInitializeRangeList_0.c)
 *     RtlAddRange_0 @ 0x140056743 (RtlAddRange_0.c)
 *     RtlInvertRangeList_0 @ 0x140056755 (RtlInvertRangeList_0.c)
