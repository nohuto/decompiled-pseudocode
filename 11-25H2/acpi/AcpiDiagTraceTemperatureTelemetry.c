/*
 * XREFs of AcpiDiagTraceTemperatureTelemetry @ 0x140057534
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureTelemetry(__int64 a1)
{
  ...
  if ( LOBYTE(WPP_MAIN_CB.Queue.Wcb.DeviceRoutine) )
  {
      ...
      && tlgKeywordOn((__int64)&dword_140086930) )
    {
      ...
      v18 = 2;
      v10 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140086930, (unsigned __int8 *)dword_14007D0D2, v3, v4, 7u, &v8);
    }
  }
