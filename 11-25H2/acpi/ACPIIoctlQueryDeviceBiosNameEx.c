/*
 * XREFs of ACPIIoctlQueryDeviceBiosNameEx @ 0x140062684
 * Callers:
...
__int64 __fastcall ACPIIoctlQueryDeviceBiosNameEx(ULONG_PTR a1, IRP *a2, __int64 a3)
{
  bool v3; // cf
  int v6; // edi
  _IRP *MasterIrp; // rax
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        {
          v10 = v9;
          memmove(a2->AssociatedIrp.MasterIrp, Src.Buffer, v9);
