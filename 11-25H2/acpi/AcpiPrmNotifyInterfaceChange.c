/*
 * XREFs of AcpiPrmNotifyInterfaceChange @ 0x1400A3070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AcpiPrmNotifyInterfaceChange(char *NotificationStructure, PVOID Context)
{
  ...
  if ( v2 )
  {
    ...
    if ( !v4 )
    {
      ...
      {
        ExFreePoolWithTag(stru_140088C78.Buffer, 0x46706341u);
  ...
  {
    v3 = AcpiAcquirePrmInterface(*((UNICODE_STRING **)NotificationStructure + 5), 1, &unk_140088C38);
    if ( v3 >= 0 )
    {
