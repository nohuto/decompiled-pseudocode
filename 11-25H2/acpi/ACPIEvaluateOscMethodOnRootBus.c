/*
 * XREFs of ACPIEvaluateOscMethodOnRootBus @ 0x140098204
 * Callers:
...
__int64 __fastcall ACPIEvaluateOscMethodOnRootBus(__int64 a1, unsigned __int8 a2, int a3)
{
  __int64 v3; // rcx
  __int64 result; // rax
  ...
  v5 = SB_OSC_UUID;
  result = ACPIAmliEvaluateOsc(v3, (int)&v5, a3, 2, &v6);
  if ( (int)result >= 0 )
