...
__int64 __fastcall ACPIBusIrpQueryHardwareId(wchar_t **a1, size_t *a2, __int64 a3)
{
  ...
  *a1 = v8;
  ...
  if ( v16 && (unsigned int)AMLIGetNSObjectType(v16) == 12 )
  {
    ...
    if ( v9 < Size )
      goto LABEL_10;
    v7 = RtlStringCbPrintfExW(&v10[Size >> 1], v9 - Size, &ppszDestEnd, &pcbRemaining, 0, &word_140076618);
    goto LABEL_23;
  }
  v18 = *(_QWORD *)(a3 + 8);
...
LABEL_23:
      ...
      v30 = RtlStringCbPrintfExW(&v10[Size >> 1], v9 - Size, &ppszDestEnd, &pcbRemaining, 0, &word_140076618);
LABEL_69:
      v7 = v30;
      v17 = v30 < 0;
LABEL_70:
