/*
 * XREFs of ACPIProcessorContainerStartDeviceWorker @ 0x1400667D0
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall ACPIProcessorContainerStartDeviceWorker(__int64 a1)
{
  ...
  if ( !AcpiProcessorContainerHierarchyLocked )
  {
    ...
    {
      if ( _bittest64((const signed __int64 *)(i + 1120), 0x27u) )
      {
        v8 = i + 200;
        v9 = v4 + 23;
        v10 = *(_QWORD **)(v8 + 8);
...
LABEL_9:
    ...
    v11 = (_QWORD *)qword_140089DD8;
    v12 = v4 + 23;
    if ( *(__int64 **)qword_140089DD8 != &AcpiProcessorContainerRootList )
      goto LABEL_9;
    *v12 = &AcpiProcessorContainerRootList;
    v4[24] = v11;
    *v11 = v12;
    qword_140089DD8 = (__int64)(v4 + 23);
LABEL_11:
