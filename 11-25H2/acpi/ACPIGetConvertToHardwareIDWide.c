/*
 * XREFs of ACPIGetConvertToHardwareIDWide @ 0x14004DEF0
 * Callers:
...
__int64 __fastcall ACPIGetConvertToHardwareIDWide(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
...
LABEL_11:
    ...
    if ( *(_WORD *)(a3 + 2) == 1 )
    {
      v16 = a4 & 0x8000000;
      v15 = 8;
      v21 = ExAllocatePool2((-(__int64)((a4 & 0x8000000) != 0) & 0xFFFFFFFFFFFFFF40uLL) + 256, 8LL, 1399874369LL);
      v6 = (_BYTE *)v21;
      if ( !v21 )
        return (unsigned int)-1073741670;
      v7 = 1;
      ACPIAmliDoubleToName(v21, *(unsigned int *)(a3 + 16));
    }
    else
    {
      if ( *(_WORD *)(a3 + 2) != 2 )
...
LABEL_28:
  ...
  v11 = ACPIGetProcessorIDWide(a1, a2, a3, a4, &v24, &v25);
  if ( v11 >= 0 )
  {
    v12 = v24;
    v13 = v25;
