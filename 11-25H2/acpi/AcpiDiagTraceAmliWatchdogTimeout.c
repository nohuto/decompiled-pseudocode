/*
 * XREFs of AcpiDiagTraceAmliWatchdogTimeout @ 0x140056A30
 * Callers:
...
void AcpiDiagTraceAmliWatchdogTimeout()
{
  ...
  if ( (unsigned int)dword_140086930 > 5 && tlgKeywordOn((__int64)&dword_140086930) )
  {
    ...
    v11 = 4LL;
    v13 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140086930, (unsigned __int8 *)dword_14007D162, v0, v2, 6u, &v5);
  }
}
