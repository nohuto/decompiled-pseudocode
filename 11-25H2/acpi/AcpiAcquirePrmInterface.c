...
__int64 __fastcall AcpiAcquirePrmInterface(UNICODE_STRING *SourceString, char a2, void *a3)
{
  ...
  if ( DeviceObjectPointer >= 0 )
  {
    if ( a2 )
    {
      ...
      stru_140088C78.Buffer = (wchar_t *)ExAllocatePool2(64LL, v7, 1181770561LL);
      if ( !stru_140088C78.Buffer )
        return 3221225626LL;
      stru_140088C78.Length = 0;
      stru_140088C78.MaximumLength = v7;
      RtlCopyUnicodeString(&stru_140088C78, SourceString);
    }
  ...
  if ( DeviceObjectPointer < 0 )
  {
    if ( stru_140088C78.Buffer )
    {
      RtlFreeUnicodeString(&stru_140088C78);
      stru_140088C78.Buffer = 0LL;
      *(_DWORD *)&stru_140088C78.Length = 0;
    }
  }
