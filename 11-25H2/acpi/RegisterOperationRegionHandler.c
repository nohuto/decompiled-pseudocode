/*
 * XREFs of RegisterOperationRegionHandler @ 0x1400BFA6C
 * Callers:
        ...
        unsigned int **a6)
{
  ...
  _QWORD v22[10]; // [rsp+40h] [rbp-68h] BYREF
...
LABEL_23:
  ...
  *v17 = v13;
  ...
  else
  {
    ...
    {
      if ( (int)AMLIGetNameSpaceObject("_REG", a1, &v21, 1) >= 0 )
      {
        ...
        WORD1(v22[5]) = 1;
        v22[7] = 1LL;
        AMLIAsyncEvalObject(v21, 0LL, 2, (__int64)v22, 0LL, 0LL);
