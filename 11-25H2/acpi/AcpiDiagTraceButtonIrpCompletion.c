/*
 * XREFs of AcpiDiagTraceButtonIrpCompletion @ 0x1400246E0
 * Callers:
...
void __fastcall AcpiDiagTraceButtonIrpCompletion(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
    && EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_BUTTON_IRP_COMPLETION)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 760), &DestinationString, 1LL) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v13 = a3;
    v14 = 8LL;
    EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_BUTTON_IRP_COMPLETION, 0LL, 4u, &UserData);
  }
