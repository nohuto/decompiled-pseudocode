/*
 * XREFs of WPP_RECORDER_SF_sqqD @ 0x140065774
 * Callers:
        ...
        ...)
{
  ...
  if ( _bittest(&v12, ((_BYTE)a3 - 1) & 0x1F) && *((_BYTE *)&WPP_GLOBAL_Control->Timer + 80 * v10 + 1) >= 2u )
  {
    ...
    if ( !a6 )
      v15 = "NULL";
    ((void (__fastcall *)(_QWORD, __int64, void *, _QWORD, const char *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
  ...
  if ( !a6 )
    v7 = "NULL";
  LOWORD(v18) = a4;
  return WppAutoLogTrace(a1, 2LL, a3, &WPP_ddc14e6fd4133db509d0c44d0c15805e_Traceguids, v18, v7, v16, (__int64 *)va);
}
