/*
 * XREFs of AcpiDiagTraceThermalNotification @ 0x1400386B4
 * Callers:
...
void __fastcall AcpiDiagTraceThermalNotification(_DWORD *a1, __int64 a2, __int16 a3)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
    && (a3 != 128
     || EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_TEMPERATURE_NOTIFICATION))
    && (a3 != 129
     || EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_TRIP_POINT_NOTIFICATION))
    ...
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a2 + 760), &DestinationString_8, 1LL) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, v16, 0LL, 0x10u, &UserData);
  }
