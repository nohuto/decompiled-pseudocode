/*
 * XREFs of AcpiDiagTraceDeviceActiveCooling @ 0x140056C74
 * Callers:
...
void __fastcall AcpiDiagTraceDeviceActiveCooling(__int64 a1, char a2)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.DeviceContext
    && EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_DEVICE_ACTIVE_COOLING)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 760), (__int64)&DestinationString) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = &v5;
    v12 = 2LL;
    EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.Wcb.DeviceContext, &ACPI_ETW_EVENT_DEVICE_ACTIVE_COOLING, 0LL, 3u, &UserData);
  }
