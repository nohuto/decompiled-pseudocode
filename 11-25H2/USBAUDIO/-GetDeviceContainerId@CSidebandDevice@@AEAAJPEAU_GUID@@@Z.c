/*
 * XREFs of ?GetDeviceContainerId@CSidebandDevice@@AEAAJPEAU_GUID@@@Z @ 0x1400102B0
 * Callers:
...
LABEL_26:
        LOBYTE(v12) = v10;
        WPP_RECORDER_AND_TRACE_SF_d((_DWORD)AttachedDevice, v12, v6, (_DWORD)DeviceExtension);
        goto LABEL_50;
      }
    }
    else
