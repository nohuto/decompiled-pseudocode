/*
 * XREFs of PinDataFormatIntersection @ 0x14003AE70
 * Callers:
 *     <none>
 * Callees:
 *     IntersectFindDataRange @ 0x14003AF2C (IntersectFindDataRange.c)
 *     IntersectGetFormatSize @ 0x14003B10C (IntersectGetFormatSize.c)
 *     IntersectConvertDatarangeToFormat @ 0x14003B184 (IntersectConvertDatarangeToFormat.c)
 */
