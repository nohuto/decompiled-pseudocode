/*
 * XREFs of TopologyProcessFeatureUnit @ 0x14003FB10
 * Callers:
...
LABEL_55:
      ...
      *v16 = v17;
      ...
      v29 = (__int64 (__fastcall *)(int, int, int, int, int, int, __int64))USBCntrlGetSetDbLevel;
LABEL_33:
      *(_QWORD *)(v20 + 136) = v29;
      *(_QWORD *)(v20 + 160) = v28;
LABEL_34:
...
LABEL_48:
          ExFreePool(*(PVOID *)(168 * v46 + a3 + 128));
        }
        else
        {
LABEL_47:
