/*
 * XREFs of USBMidiInPipePrimer @ 0x140039F88
 * Callers:
 ...
 *     USBMidiInInitializeUrbAndIrp @ 0x140041970 (USBMidiInInitializeUrbAndIrp.c)
 */
...
__int64 __fastcall USBMidiInPipePrimer(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  *(_BYTE *)(v12 + v13 + 41) = 0;
  v7 = -1073741670;
  *(_BYTE *)(v12 + *(_QWORD *)(a2 + 40) + 72) = 0;
  *(_DWORD *)(v12 + *(_QWORD *)(a2 + 40) + 64) = 0;
  *(_DWORD *)(v12 + *(_QWORD *)(a2 + 40) + 68) = 0;
  *(_BYTE *)(v12 + *(_QWORD *)(a2 + 40) + 40) = 0;
  ...
  v14 = (_QWORD *)(v12 + *(_QWORD *)(a2 + 40) + 80LL);
  v14[1] = v14;
  *v14 = v14;
  if ( !a4 )
  {
  ...
  *(_QWORD *)(v12 + *(_QWORD *)(a2 + 40) + 96) = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 40));
  ...
  if ( MIDIStreamingEndpointDescriptor )
  {
    *(_QWORD *)(v17 + v12 + 32) = MIDIStreamingEndpointDescriptor + 4;
    v19 = *(unsigned __int8 *)(MIDIStreamingEndpointDescriptor + 3);
  }
  else
  {
  ...
  v7 = -1073741438;
  *(_DWORD *)(v12 + *(_QWORD *)(a2 + 40) + 24) = v19;
  if ( v19 )
  {
    v7 = USBHwAllocateAndBag(
           (PVOID *)(v12 + *(_QWORD *)(a2 + 40) + 160LL),
           16 * v19 * ((unsigned int)*(unsigned __int16 *)(v12 + *(_QWORD *)(a2 + 40)) + 192),
           64LL,
           *(void **)(a1 + 8));
    if ( v7 >= 0 )
    {
      _mm_lfence();
      v20 = 0;
      v21 = *(_QWORD *)(v12 + *(_QWORD *)(a2 + 40) + 160);
      ...
      if ( 16 * v19 )
      {
        ...
        do
        {
          ...
          *(_QWORD *)(v23 - 8) = v22 + v20 * *(unsigned __int16 *)(v12 + *(_QWORD *)(a2 + 40));
