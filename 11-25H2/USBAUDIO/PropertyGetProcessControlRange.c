/*
 * XREFs of PropertyGetProcessControlRange @ 0x140032DA4
 * Callers:
 *     TopologyPU3DExtender @ 0x140031110 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x140031200 (TopologyPUChorus.c)
 *     TopologyPUDynRangeCompressor @ 0x140031380 (TopologyPUDynRangeCompressor.c)
 *     TopologyPUReverb @ 0x140031700 (TopologyPUReverb.c)
 * Callees:
