/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x14000CE54
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x14000CDD0 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x14000CC50 (wil_details_FeatureReporting_RecordUsageInCache.c)
