/*
 * XREFs of PropertyAudioSignalProcessingBasicSupport @ 0x140032220
 * Callers:
 *     <none>
 * Callees:
 *     PropertyAudioSignalProcessingPinValidation @ 0x14003E5A4 (PropertyAudioSignalProcessingPinValidation.c)
 */
