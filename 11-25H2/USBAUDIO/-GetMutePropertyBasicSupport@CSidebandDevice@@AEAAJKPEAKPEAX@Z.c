/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x140011180
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x1400323C4 (PropertyGetBooleanBasicSupportSideband.c)
 */
