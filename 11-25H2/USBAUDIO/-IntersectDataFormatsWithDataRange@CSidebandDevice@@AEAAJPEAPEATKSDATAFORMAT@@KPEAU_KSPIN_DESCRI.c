/*
 * XREFs of ?IntersectDataFormatsWithDataRange@CSidebandDevice@@AEAAJPEAPEATKSDATAFORMAT@@KPEAU_KSPIN_DESCRIPTOR_EX@@PEAEPEAK3@Z @ 0x140005524
 * Callers:
...
LABEL_25:
  ...
  if ( (_BYTE)a2 || v10 )
  {
    v18 = &WPP_592256b5268d334857c14222035d4fc6_Traceguids;
    LOBYTE(v18) = v10;
