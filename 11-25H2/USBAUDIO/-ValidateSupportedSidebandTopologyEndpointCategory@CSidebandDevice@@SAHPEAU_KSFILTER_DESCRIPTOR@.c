/*
 * XREFs of ?ValidateSupportedSidebandTopologyEndpointCategory@CSidebandDevice@@SAHPEAU_KSFILTER_DESCRIPTOR@@K@Z @ 0x1400146E0
 * Callers:
        ...
        int a2)
{
  ...
  {
    v17 = &WPP_592256b5268d334857c14222035d4fc6_Traceguids;
    LOBYTE(v17) = v15;
