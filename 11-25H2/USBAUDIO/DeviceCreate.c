/*
 * XREFs of DeviceCreate @ 0x140008EF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     InitializeSidebandContext @ 0x14000B90C (InitializeSidebandContext.c)
 *     McGenEventRegister_EtwRegister @ 0x14000BD8C (McGenEventRegister_EtwRegister.c)
