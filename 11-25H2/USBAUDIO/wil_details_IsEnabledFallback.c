/*
 * XREFs of wil_details_IsEnabledFallback @ 0x14000D218
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x14000D054 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
