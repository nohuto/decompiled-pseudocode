/*
 * XREFs of InitializeSideband @ 0x14000EC3C
 * Callers:
 ...
 *     ??0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z @ 0x14000F16C (--0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z.c)
