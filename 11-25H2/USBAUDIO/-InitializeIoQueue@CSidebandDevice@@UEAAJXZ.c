/*
 * XREFs of ?InitializeIoQueue@CSidebandDevice@@UEAAJXZ @ 0x140012490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StartIoQueueThread@CSidebandDevice@@AEAAJXZ @ 0x140013924 (-StartIoQueueThread@CSidebandDevice@@AEAAJXZ.c)
...
__int64 __fastcall CSidebandDevice::InitializeIoQueue(CSidebandDevice *this)
{
  ...
  if ( (_BYTE)v5 || v2 )
  {
    v8 = &WPP_592256b5268d334857c14222035d4fc6_Traceguids;
    LOBYTE(v8) = v2;
