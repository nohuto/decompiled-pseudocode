/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x14001210C
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x140032664 (PropertyGetDbBasicSupportSideband.c)
 */
