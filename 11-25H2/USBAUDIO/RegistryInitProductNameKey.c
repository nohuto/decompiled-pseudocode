/*
 * XREFs of RegistryInitProductNameKey @ 0x14003465C
 * Callers:
 *     FilterInitComponentId @ 0x140030844 (FilterInitComponentId.c)
 * Callees:
 *     RegistryCreateMediaCategoriesKey @ 0x140033F04 (RegistryCreateMediaCategoriesKey.c)
 */
