/*
 * XREFs of ?GetVolumeImmediate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x14000A3DC
 * Callers:
 *     ?GetVolumeStatusUpdate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x14000A200 (-GetVolumeStatusUpdate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z.c)
 * Callees:
 ...
 *     PropertyGetDbLevelSideband @ 0x140032738 (PropertyGetDbLevelSideband.c)
 */
...
__int64 __fastcall CSidebandDevice::GetVolumeImmediate(CSidebandDevice *this, struct _IRP *a2)
{
  ...
  if ( PinFromEpIndex >= 0 )
  {
    ...
    if ( PinFromEpIndex >= 0 )
    {
      PinFromEpIndex = CSidebandDevice::GetNodeOfType(v28, v14, v4, &GUID_3a5acc00_c557_11d0_8a2b_00a0c9255ac1, &v29);
      if ( PinFromEpIndex >= 0 )
      {
        if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) == 0
