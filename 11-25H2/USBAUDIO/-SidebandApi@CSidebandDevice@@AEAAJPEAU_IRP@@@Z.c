/*
 * XREFs of ?SidebandApi@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1400092C8
 * Callers:
 ...
 *     ?IsPowerRequiredForIo@CSidebandDevice@@AEAA_NK@Z @ 0x140012D58 (-IsPowerRequiredForIo@CSidebandDevice@@AEAA_NK@Z.c)
...
LABEL_249:
  ...
  if ( (_BYTE)v10 || v5 )
  {
    v36 = &WPP_592256b5268d334857c14222035d4fc6_Traceguids;
    LOBYTE(v36) = v5;
