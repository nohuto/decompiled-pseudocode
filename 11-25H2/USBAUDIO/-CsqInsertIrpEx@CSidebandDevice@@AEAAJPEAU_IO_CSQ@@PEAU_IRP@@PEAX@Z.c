/*
 * XREFs of ?CsqInsertIrpEx@CSidebandDevice@@AEAAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z @ 0x14000BA00
 * Callers:
 *     ?staticCsqInsertIrpEx@CSidebandDevice@@SAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z @ 0x14000B9E0 (-staticCsqInsertIrpEx@CSidebandDevice@@SAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z.c)
 * Callees:
 *     <none>
 */
