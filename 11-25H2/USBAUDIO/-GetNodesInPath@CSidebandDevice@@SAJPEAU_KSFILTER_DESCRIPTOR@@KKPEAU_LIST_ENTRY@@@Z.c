/*
 * XREFs of ?GetNodesInPath@CSidebandDevice@@SAJPEAU_KSFILTER_DESCRIPTOR@@KKPEAU_LIST_ENTRY@@@Z @ 0x14000B154
 * Callers:
...
LABEL_26:
  ...
  if ( (_BYTE)a2 || v9 )
  {
    v15 = &WPP_592256b5268d334857c14222035d4fc6_Traceguids;
    LOBYTE(v15) = v9;
