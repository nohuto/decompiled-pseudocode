/*
 * XREFs of Feature_RSIdleRevoke__private_IsEnabledFallback @ 0x1405D2D94
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_RSIdleRevoke__private_descriptor);
}
