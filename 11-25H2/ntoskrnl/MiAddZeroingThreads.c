/*
 * XREFs of MiAddZeroingThreads @ 0x140437118
 * Callers:
 ...
 *     MiRestartZeroingPass @ 0x140437910 (MiRestartZeroingPass.c)
...
__int64 __fastcall MiAddZeroingThreads(__int64 a1, int a2, int *a3)
{
  ...
  *a3 = v9;
  ...
  v56 = v8;
  v57 = v9;
  v12 = *(_QWORD *)(384LL * *(unsigned int *)(a1 + 56) + qword_140E2D8B8 + 376);
  ...
  while ( 1 )
  {
    ...
    if ( v27 )
    {
      ...
      {
        v28 = *v25;
        v29 = *(_QWORD *)(384LL * *(unsigned int *)(*((_QWORD *)v25 + 22) + 56LL) + qword_140E2D8B8 + 376);
