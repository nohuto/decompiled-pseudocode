/*
 * XREFs of IvtInitializeIommu @ 0x140B41B90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IvtGetBlockedDomain @ 0x1404C75FC (IvtGetBlockedDomain.c)
 *     IvtBuildContextEntry @ 0x1404D9AC8 (IvtBuildContextEntry.c)
 *     IvtBuildScalableModeContextEntry @ 0x1404F6A2C (IvtBuildScalableModeContextEntry.c)
 *     IvtGetPasidGranularTranslationType @ 0x1404F8270 (IvtGetPasidGranularTranslationType.c)
 *     IvtGetContextEntryType @ 0x1404F84B0 (IvtGetContextEntryType.c)
 ...
 *     IvtGetIdentityMappedDomain @ 0x14056B4D8 (IvtGetIdentityMappedDomain.c)
 *     IvtInitializeIdentityMappings @ 0x14056BC28 (IvtInitializeIdentityMappings.c)
 *     IvtInitializeMTRR @ 0x14056BEBC (IvtInitializeMTRR.c)
 ...
 *     IvtLegacySetScalableModeContextEntry @ 0x14056DAF8 (IvtLegacySetScalableModeContextEntry.c)
 *     IvtSetScalableModeContextEntry @ 0x14056E194 (IvtSetScalableModeContextEntry.c)
...
LABEL_81:
      ...
      do
      {
        if ( v39 != 1 || v3 && *(_BYTE *)(a1 + 320) && *(_BYTE *)(a1 + 316) )
        {
          ...
          if ( !*v40 )
          {
            v43 = guard_dispatch_icall_no_overrides(-1LL);
            v40[1] = v43;
            if ( !v43 )
              return 3221225473LL;
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 8) + 144LL) = v45;
      ...
      if ( v62 )
      {
        ...
        else
        {
          ...
          v48 = guard_dispatch_icall_no_overrides(-1LL);
          *(_QWORD *)(a1 + 296) = v48;
          if ( !v48 )
            return 3221225473LL;
...
LABEL_62:
      if ( !*(_QWORD *)(a1 + 16) )
      {
        v30 = guard_dispatch_icall_no_overrides(-1LL);
        *(_QWORD *)(a1 + 24) = v30;
        if ( !v30 )
          return 3221225473LL;
      ...
      if ( !*(_QWORD *)(a1 + 32) )
      {
        v35 = guard_dispatch_icall_no_overrides(-1LL);
        if ( !v35 )
          return 3221225473LL;
    ...
    v12 = guard_dispatch_icall_no_overrides(-1LL);
    *(_QWORD *)(a1 + 48) = v12;
    if ( !v12 )
      return 3221225473LL;
    ...
    *(_QWORD *)(a1 + 40) = v13;
    ...
    {
      v16 = guard_dispatch_icall_no_overrides(-1LL);
