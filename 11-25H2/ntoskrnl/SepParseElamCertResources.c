/*
 * XREFs of SepParseElamCertResources @ 0x140A904FC
 * Callers:
...
__int64 __fastcall SepParseElamCertResources(unsigned __int16 *a1, __int64 a2)
{
  ...
  _WORD v48[252]; // [rsp+48h] [rbp-230h] BYREF
...
LABEL_50:
      ...
      if ( v34 )
      {
        ...
        do
        {
          ...
          if ( (unsigned __int64)(v36 - v13) >= 0x40 )
            return 3221225485LL;
          for ( j = 0; v13 != v36; v48[64 * (unsigned __int64)v35 + 60 + v40] = v39 )
          {
            v39 = *v13++;
            v40 = j++;
          }
          v41 = j;
          v42 = 2 * j;
          v48[64 * (unsigned __int64)v35 + 60 + v41] = 0;
          v43 = 2LL * v35;
          v48[4 * v43] = v42;
          v48[4 * v43 + 1] = v42 + 2;
          *(_QWORD *)&v48[4 * v43 + 4] = &v48[64 * (unsigned __int64)v35 + 60];
          if ( !*v36 )
            break;
          v44 = v36 + 1;
          if ( !*v44 )
      ...
      LOBYTE(v46) = 7;
      v2 = guard_dispatch_icall_no_overrides(v46);
      if ( v2 < 0 )
        return (unsigned int)v2;
      v3 = v47;
    }
