/*
 * XREFs of HalGetInterruptTargetInformation @ 0x1404B7D60
 * Callers:
      ...
      for ( i = 0; i < (unsigned int)HalpInterruptProcessorCount; ++i )
      {
        ...
        if ( *(_BYTE *)(v10 + 13) && *(_DWORD *)v10 == a2 )
        {
          ...
          *(_DWORD *)(a3 + 4) = *(_DWORD *)(v10 + 16);
          ...
          if ( v8 == 1
            || (v13 = HalpInterruptPhysicalTargets.Bitmap[*(unsigned __int16 *)(v10 + 16)],
                _bittest64((const __int64 *)&v13, *(unsigned __int8 *)(v10 + 18))) )
          {
            *(_DWORD *)(a3 + 12) = 0;
            *(_DWORD *)(a3 + 20) = 1;
          }
