/*
 * XREFs of _CmCreateInstallerClass @ 0x140807D74
 * Callers:
...
__int64 __fastcall CmCreateInstallerClass(__int64 a1, int a2, int a3, HANDLE *a4, _BYTE *a5, int a6)
{
  __int64 v10; // rsi
  int v11; // eax
  ...
  InstallerClassWorker = CmCreateInstallerClassWorker(a1, a2, v17, (unsigned int)&Handle, (__int64)v19, v20);
