/*
 * XREFs of DifZwSetEaFileWrapper @ 0x14063BE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetEaFileWrapper(void *a1, struct _IO_STATUS_BLOCK *a2, void *a3, ULONG a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(21);
  ...
  DWORD2(v18) = ZwSetEaFile(a1, a2, a3, a4);
  if ( v8 )
  {
