/*
 * XREFs of KiInsertQueueDpc @ 0x140252DA0
 * Callers:
      ...
      if ( v34 )
      {
        if ( CurrentPrcb->SchedulerAssist )
        {
          ...
          if ( (v37 & 0x100000) != 0 || v38 && (unsigned __int8)v37 < KiVpThreadSystemWorkPriority )
          {
            ...
            if ( v39 )
              LODWORD(v41) = (unsigned __int8)byte_140FCC261[2 * (unsigned int)v41] | ((unsigned __int8)HvlpVirtualProcessorMapping[2 * v41] << 6);
