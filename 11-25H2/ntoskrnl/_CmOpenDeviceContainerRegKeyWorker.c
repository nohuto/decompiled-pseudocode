/*
 * XREFs of _CmOpenDeviceContainerRegKeyWorker @ 0x14095B2D0
 * Callers:
...
LABEL_24:
  ...
  if ( a1 )
    ...
    v23 = 0LL;
  inited = SysCtxRegOpenCurrentUserKey(v23, 0, 0x2000000u, (__int64)&Handle);
  if ( inited < 0 )
    goto LABEL_19;
  v19 = Handle;
LABEL_16:
  if ( a6 )
  {
    Tree = PnpCtxRegCreateTree(a1, v19, v20, 0, a5, 0LL, a7, a8);
  }
  else
  {
    Tree = PnpCtxRegOpenKey(a1, (__int64)v19, (__int64)v20, 0, a5, (__int64)a7);
    if ( Tree >= 0 )
    {
      *a8 = 2;
      goto LABEL_19;
