/*
 * XREFs of CmpLightWeightPrepareSetSecDescUoW @ 0x1409D9BA8
 * Callers:
    ...
    if ( SecurityDescriptorNode >= 0 )
    {
      ...
      if ( SecurityDescriptorNode >= 0 )
      {
        ...
        if ( SecurityDescriptorNode >= 0 )
        {
          ...
          {
            if ( (*(_BYTE *)(v2 + 140) & 1) != 0 )
              HvpReleaseCellFlat(v2, &v24);
            else
              HvpReleaseCellPaged(v2, (unsigned int *)&v24);
            v15 = *v7;
...
LABEL_23:
    if ( (*(_BYTE *)(v2 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v2, &v19);
    else
      HvpReleaseCellPaged(v2, (unsigned int *)&v19);
  }
  if ( v4 )
  {
    if ( (*(_BYTE *)(v2 + 140) & 1) != 0 )
  ...
  {
    if ( (*(_BYTE *)(v2 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v2, v20);
    else
      HvpReleaseCellPaged(v2, (unsigned int *)v20);
  }
