/*
 * XREFs of EtwpTraceContextRegisters @ 0x140641088
 * Callers:
 *     EtwpContextRegisterTracingDispatcher @ 0x1404CEB00 (EtwpContextRegisterTracingDispatcher.c)
 *     EtwpContextRegisterTracingApc @ 0x140640790 (EtwpContextRegisterTracingApc.c)
 * Callees:
    ...
    if ( Pool2 )
    {
      *((_DWORD *)Pool2 + 12) = 1048579;
      if ( (int)PsGetUserContextThread(a3, Pool2) >= 0 )
      {
        ...
        *(_QWORD *)&v16 = v17;
        *((_QWORD *)&v16 + 1) = 144LL;
        EtwpLogKernelEvent((struct _KTHREAD *)&v16, v12, v11, 1u, 0xF7Au, a4 & 0xFFFFE600 | 2);
      }
      if ( v8 )
