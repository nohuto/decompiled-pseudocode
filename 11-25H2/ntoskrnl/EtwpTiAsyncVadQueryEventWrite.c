/*
 * XREFs of EtwpTiAsyncVadQueryEventWrite @ 0x1403BD46C
 * Callers:
 ...
 *     EtwpTiTestBloomFilter @ 0x1403BD810 (EtwpTiTestBloomFilter.c)
 */
        ...
        __int64 a7)
{
    ...
    && (int)EtwpTiAllocVadQueryEventWriteWorkItemContext(a1, a2, a3, a4, v9, a6, a7, v12, &WorkItem) >= 0 )
  {
    ...
    v14 = HIDWORD(v21);
    *(_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)(unsigned int)v21 >> 3)) |= 1 << (v21 & 7);
    v15 = (_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)v14 >> 3));
    v16 = (char)*v15 | (1 << (v14 & 7));
    v17 = v22;
    *v15 = v16;
    v18 = (_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)v17 >> 3));
