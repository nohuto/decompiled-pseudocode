/*
 * XREFs of NtSaveMergedKeys @ 0x1407C1980
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    v11 = CmObReferenceObjectByHandle(v27, 0, v14, v15, (__int64)&v24, 0LL);
    if ( v11 < 0 )
      goto LABEL_6;
    LOBYTE(v18) = PreviousMode;
    v11 = CmObReferenceObjectByHandle(v28, 0, v17, v18, (__int64)&v25, 0LL);
    if ( v11 < 0 )
      goto LABEL_6;
    if ( PreviousMode == 1 )
    {
      LOBYTE(v19) = 1;
      v11 = IoConvertFileHandleToKernelHandle(a3, v19, 2LL);
      if ( v11 < 0 )
        goto LABEL_6;
    }
    else
    ...
    if ( CmpCallBackCount && !CmpIsRegistryLockAcquired() )
    {
      ...
      *((_QWORD *)&v31 + 1) = v4;
      LOBYTE(v21) = 1;
      *((_QWORD *)&v30 + 1) = v23;
      v22 = CmpCallCallBacksEx(49, (unsigned int)&v30, 0, v21, 50, 0LL, (__int64)v26);
      if ( v22 < 0 )
      {
        v11 = 0;
        if ( v22 != -1073740541 )
...
LABEL_30:
    ...
    v11 = CmSaveMergedKeys((__int64)v3, (__int64)v4, v23);
    CmpDetachFromRegistryProcess(&ApcState);
    if ( v7 )
      v11 = CmPostCallbackNotificationEx(50, 0, v11, (unsigned int)&v30, 0LL, (__int64)v26);
    goto LABEL_30;
  }
LABEL_7:
