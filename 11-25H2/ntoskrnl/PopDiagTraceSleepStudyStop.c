/*
 * XREFs of PopDiagTraceSleepStudyStop @ 0x140AA2A3C
 * Callers:
...
void __fastcall PopDiagTraceSleepStudyStop(__int64 a1)
{
    ...
    && EtwEventEnabled(PopDiagSleepStudyHandle, &SLEEPSTUDY_EVT_SCENARIO_STOP_REASON) )
  {
    ...
    {
      v13 = 0;
      v14 = byte_140F0A028 & 1;
      v3 = byte_140F0A029 & 1;
      v15 = ((unsigned __int8)byte_140F0A029 >> 1) & 1;
      v11 = ((unsigned __int8)byte_140F0A029 >> 4) & 1;
      v10 = ((unsigned __int8)byte_140F0A029 >> 3) & 1;
      v9 = ((unsigned __int8)byte_140F0A029 >> 5) & 3;
      v7 = (unsigned __int8)byte_140F0A081;
      v5 = (unsigned __int8)byte_140F0A080;
      v6 = (unsigned __int8)byte_140F0A058;
      v8 = dword_140F09FD8;
      v4 = ((unsigned __int8)byte_140F0A029 >> 2) & 1;
      *(_QWORD *)UserData = &PopWdiScenarioStopEventData;
      *(_QWORD *)(UserData + 8) = 4LL;
      *(_QWORD *)(UserData + 16) = &unk_140F09FC8;
      *(_QWORD *)(UserData + 24) = 8LL;
      *(_QWORD *)(UserData + 32) = &v14;
      *(_QWORD *)(UserData + 40) = 4LL;
      *(_QWORD *)(UserData + 48) = &unk_140F0A030;
      *(_QWORD *)(UserData + 56) = 8LL;
      *(_QWORD *)(UserData + 64) = &unk_140F0A038;
      *(_QWORD *)(UserData + 72) = 8LL;
      *(_QWORD *)(UserData + 80) = &unk_140F0A040;
      *(_QWORD *)(UserData + 88) = 8LL;
      *(_QWORD *)(UserData + 96) = &unk_140F09FC0;
      *(_QWORD *)(UserData + 104) = 8LL;
      *(_QWORD *)(UserData + 112) = &unk_140F09FBC;
      *(_QWORD *)(UserData + 120) = 4LL;
      *(_QWORD *)(UserData + 128) = &unk_140F0A000;
      *(_QWORD *)(UserData + 136) = 8LL;
      *(_QWORD *)(UserData + 144) = &v13;
      *(_QWORD *)(UserData + 152) = 1LL;
      *(_QWORD *)(UserData + 160) = &unk_140F09FB8;
      *(_QWORD *)(UserData + 168) = 4LL;
      *(_QWORD *)(UserData + 176) = &unk_140F09FF8;
      *(_QWORD *)(UserData + 184) = 8LL;
      *(_QWORD *)(UserData + 192) = &unk_140F0A024;
      ...
      *(_QWORD *)(UserData + 240) = &unk_140F0A008;
      *(_QWORD *)(UserData + 256) = &v4;
      *(_QWORD *)(UserData + 264) = 4LL;
      *(_QWORD *)(UserData + 272) = &unk_140F0A050;
      *(_QWORD *)(UserData + 280) = 4LL;
      *(_QWORD *)(UserData + 288) = &unk_140F0A054;
      *(_QWORD *)(UserData + 296) = 4LL;
      *(_QWORD *)(UserData + 304) = &unk_140F0A05C;
      *(_QWORD *)(UserData + 312) = 4LL;
      *(_QWORD *)(UserData + 320) = &unk_140F0A068;
      *(_QWORD *)(UserData + 328) = 4LL;
      *(_QWORD *)(UserData + 336) = &unk_140F0A06C;
      *(_QWORD *)(UserData + 344) = 4LL;
      *(_QWORD *)(UserData + 352) = &unk_140F09FA8;
      *(_QWORD *)(UserData + 360) = 4LL;
      *(_QWORD *)(UserData + 368) = &unk_140F09FB0;
      *(_QWORD *)(UserData + 376) = 8LL;
      *(_QWORD *)(UserData + 384) = &unk_140F0A07C;
      *(_QWORD *)(UserData + 392) = 4LL;
      *(_QWORD *)(UserData + 400) = &v5;
      *(_QWORD *)(UserData + 408) = 4LL;
      *(_QWORD *)(UserData + 416) = &unk_140F0A084;
      *(_QWORD *)(UserData + 424) = 4LL;
      *(_QWORD *)(UserData + 432) = &unk_140F0A088;
      ...
      *(_QWORD *)(UserData + 496) = &unk_140F0A060;
      *(_QWORD *)(UserData + 504) = 4LL;
      *(_QWORD *)(UserData + 512) = &unk_140F0A064;
      ...
      *(_QWORD *)(UserData + 592) = &unk_140F0A018;
      *(_QWORD *)(UserData + 600) = 4LL;
      *(_QWORD *)(UserData + 608) = &unk_140F0A010;
      *(_QWORD *)(UserData + 616) = 8LL;
      *(_QWORD *)(UserData + 624) = &unk_140F0A0FC;
      *(_QWORD *)(UserData + 632) = 4LL;
      *(_QWORD *)(UserData + 640) = &unk_140F0A124;
      *(_QWORD *)(UserData + 648) = 1LL;
      *(_QWORD *)(UserData + 656) = &unk_140F0A128;
      *(_QWORD *)(UserData + 664) = 8LL;
      *(_QWORD *)(UserData + 680) = 8LL;
      *(_QWORD *)(UserData + 672) = &unk_140F0A130;
      *(_QWORD *)(UserData + 696) = 8LL;
      *(_QWORD *)(UserData + 688) = &unk_140F0A138;
      *(_QWORD *)(UserData + 712) = 8LL;
      *(_QWORD *)(UserData + 704) = &unk_140F0A140;
      *(_QWORD *)(UserData + 728) = 8LL;
      *(_QWORD *)(UserData + 720) = &unk_140F0A148;
      EtwWrite(
