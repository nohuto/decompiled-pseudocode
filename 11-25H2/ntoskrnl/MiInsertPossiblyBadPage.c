/*
 * XREFs of MiInsertPossiblyBadPage @ 0x140677C6C
 * Callers:
...
__int64 __fastcall MiInsertPossiblyBadPage(ULONG_PTR BugCheckParameter2, int a2)
{
  ...
  v6 = *(_QWORD *)(*((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v5 + 40) >> 43) & 0x3FFLL)) + 16LL)
     + 57216 * ((v4 >> 9) & 0x3F);
  v12 = 0;
