/*
 * XREFs of SeDuplicateTokenAndAddOriginClaim @ 0x140AA9BC4
 * Callers:
...
__int64 __fastcall SeDuplicateTokenAndAddOriginClaim(__int128 *a1, _DWORD *a2, int a3, PVOID *a4)
{
  int v7; // ebx
  PVOID v8; // rcx
  ...
  if ( v7 >= 0 )
  {
    v7 = SepAddTokenOriginClaim(a2, a3, (__int64)Object, 1);
    if ( v7 >= 0 )
    {
      *a4 = Object;
