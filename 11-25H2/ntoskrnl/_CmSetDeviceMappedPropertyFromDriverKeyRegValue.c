/*
 * XREFs of _CmSetDeviceMappedPropertyFromDriverKeyRegValue @ 0x14094F0B4
 * Callers:
 *     _CmSetDeviceMappedProperty @ 0x14094EA4C (_CmSetDeviceMappedProperty.c)
 * Callees:
 *     RtlUnalignedStringCchLengthW @ 0x140401C20 (RtlUnalignedStringCchLengthW.c)
...
LABEL_6:
  ...
  if ( v16 >= 0 )
  {
    v17 = PnpCtxRegSetValue(a6, Handle, v14[2], *((unsigned int *)v14 + 6), Time, a6);
    if ( v17 == -1073741444 )
    {
      v16 = -1073741772;
    }
    ...
    else if ( *(_DWORD *)(a3 + 16) == 2 )
    {
      ...
      if ( !v20 )
      {
        ...
        {
          PnpCtxRegSetValue(v21, Handle, L"DriverDate", 1LL, pszDest, 2 * (pcchLength + 1));
        }
      }
    }
  }
