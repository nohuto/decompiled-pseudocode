/*
 * XREFs of sub_1406EA460 @ 0x1406EA460
 * Callers:
...
__int64 __fastcall sub_1406EA460(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  unsigned int *v8; // rax
  unsigned int i; // edx
  ...
  if ( v4 && *(_DWORD *)a1 > 3u )
  {
    ...
    if ( *(_DWORD *)(a2 + 16) >= 0xFFFFEFC0
      || (v21 = *(_DWORD *)(a2 + 16) + 4164, v22 = v14, v21 < *(_DWORD *)(a2 + 16) + 4160) )
    {
      v14 = -1073741675;
      goto LABEL_88;
    }
...
LABEL_88:
    ...
    *(_DWORD *)(a4 + 4) = 4136;
    ...
    if ( v33 )
    {
      ...
      if ( v33 + 1 < v33 )
        goto LABEL_65;
      if ( (unsigned __int64)(v33 + 1027) > *(_QWORD *)(a4 + 8) + (unsigned __int64)*(unsigned int *)(a4 + 4) )
        goto LABEL_73;
      *v33 = 4104;
      memmove(v33 + 1, Pool2, 0x1008uLL);
LABEL_75:
      ++*(_DWORD *)a4;
      v37 = *(_DWORD **)(a4 + 8);
      if ( !v37 )
