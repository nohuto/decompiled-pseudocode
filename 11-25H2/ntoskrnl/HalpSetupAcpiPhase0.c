/*
 * XREFs of HalpSetupAcpiPhase0 @ 0x140C0276C
 * Callers:
 *     HalpAcpiInitDiscard @ 0x140BFE374 (HalpAcpiInitDiscard.c)
 * Callees:
...
__int64 __fastcall HalpSetupAcpiPhase0(__int64 a1)
{
  ...
  if ( !HalpProcessedACPIPhase0 )
  {
    ...
    if ( v7 )
    {
      ...
      {
        qword_140E114C0 = HalpMmAllocateMemoryInternal(136 * (int)v9, 1u);
        if ( qword_140E114C0 )
          PdttTable = v8;
      }
    }
    ...
    if ( !HalpLowStubPhysicalAddress )
    {
      ...
      if ( v11 )
        HalpLowStub = HalpMap((__int64)v11, 1u, 1u, 0, 4u, 0LL);
    }
    if ( (dword_140FC05B0 & 3) == 0 )
      HalpVirtAddrForFlush = HalpMap((__int64)HalpLowStubPhysicalAddress, 1u, 1u, 0, 4u, 0LL);
