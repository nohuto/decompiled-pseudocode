/*
 * XREFs of VfMiscPluginEntry @ 0x140B8E690
 * Callers:
 *     <none>
 * Callees:
 *     VfAvlInitializeTree @ 0x140604734 (VfAvlInitializeTree.c)
...
__int64 VfMiscPluginEntry()
{
  ...
  __int64 (__fastcall *v32)(__int64); // [rsp+F8h] [rbp-10h]
  ...
  LODWORD(v7) = 238;
  v9 = 0LL;
  qword_140F03628 = (__int64)VfMiscPluginUnload;
  ...
  v280 = 0LL;
  v281 = 0LL;
  v0 = DifRegisterPlugin((__int64)&v6, 0x45u, 0xBu, &ViMiscSetting);
  if ( v0 >= 0 )
  {
