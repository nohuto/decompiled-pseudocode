/*
 * XREFs of SshpSetCollectionActive @ 0x1404789B4
 * Callers:
 *     SshpPowerSettingCallback @ 0x140A855E0 (SshpPowerSettingCallback.c)
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x140A93750 (PdcPoSleepStudyHelperSetPhaseActive.c)
