/*
 * XREFs of IopLiveDumpCaptureMemoryPages @ 0x1405968CC
 * Callers:
...
__int64 __fastcall IopLiveDumpCaptureMemoryPages(__int64 a1)
{
  ...
  else
  {
    ...
    if ( HvlpOfflineDumpFeatureEnabled && qword_140F8D820 && *(_QWORD *)&HvlpLocalCrashdumpArea )
  ...
  if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_1400458DE,
      (const GUID *)(a1 + 968),
      (const GUID *)(a1 + 952),
      0xAu,
      &v16);
