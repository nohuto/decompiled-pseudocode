/*
 * XREFs of KseShimDatabaseBootInitialize @ 0x140C1AE74
 * Callers:
...
__int64 __fastcall KseShimDatabaseBootInitialize(void *Src, size_t Size, void *a3, unsigned int a4)
{
  ...
  if ( Src && v6 )
  {
    ...
    if ( v10 >= 0 )
    {
      if ( a3 && a4 )
      {
        if ( (int)KsepSdbBootInitialize(a3, a4, (__int64)qword_140F0F0F8) < 0 )
        {
        ...
        else if ( dword_140F0F0F0 >= (unsigned int)dword_140F0F128 )
        {
