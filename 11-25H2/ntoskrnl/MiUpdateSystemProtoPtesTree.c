/*
 * XREFs of MiUpdateSystemProtoPtesTree @ 0x1402A87DC
 * Callers:
...
void __fastcall MiUpdateSystemProtoPtesTree(__int64 a1, char a2)
{
  ...
  {
    v6 = 17;
    ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140E2D3D0);
  }
  else
  {
    v6 = ExAcquireSpinLockExclusive(&dword_140E2D3D0);
  }
  if ( (a2 & 1) == 0 )
  {
    RtlAvlRemoveNode(&qword_140E2D3C8, a1);
    *v2 &= ~8uLL;
    goto LABEL_22;
  }
  v7 = qword_140E2D3C8;
...
LABEL_46:
  ...
  v15 = RtlpTreeDoubleRotateNodes(&qword_140E2D3C8, v7, v11, v8);
  *v12 &= 0xFCu;
  v16 = *(_BYTE *)(v11 + 16);
...
LABEL_22:
  if ( v6 == 17 )
  {
    if ( (BYTE6(PerfGlobalGroupMask) & 1) == 0 || PopHibernateInProgress )
      ...
      ExpReleaseSpinLockExclusiveFromDpcLevelInstrumented(&dword_140E2D3D0, retaddr);
  }
  else
  {
    if ( (BYTE6(PerfGlobalGroupMask) & 1) == 0 || PopHibernateInProgress )
