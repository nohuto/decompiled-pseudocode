/*
 * XREFs of HalpDmaInitSystem @ 0x140B3D8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpDmaInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      ...
      qword_140FC0168 = (__int64)&HalpDmaControllers;
      HalpDmaControllers = (__int64)&HalpDmaControllers;
      qword_140FC2908 = (__int64)&HalpDmaHibernateAdapters;
      HalpDmaHibernateAdapters = (__int64)&HalpDmaHibernateAdapters;
      qword_140FC2918 = (__int64)&HalpDmaShadowDumpAdapters;
      HalpDmaShadowDumpAdapters = (__int64)&HalpDmaShadowDumpAdapters;
      qword_140FC28D8 = (__int64)&HalpDmaPdoList;
