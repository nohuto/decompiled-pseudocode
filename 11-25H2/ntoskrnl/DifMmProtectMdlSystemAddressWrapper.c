/*
 * XREFs of DifMmProtectMdlSystemAddressWrapper @ 0x140628740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmProtectMdlSystemAddressWrapper(PMDL MemoryDescriptorList, ULONG NewProtect)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = MemoryDescriptorList;
    DWORD2(v13) = NewProtect;
  ...
  DWORD2(v14) = MmProtectMdlSystemAddress(MemoryDescriptorList, NewProtect);
  if ( v5 )
  {
