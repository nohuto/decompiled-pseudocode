/*
 * XREFs of PnpTraceClearDevNodeProblem @ 0x1409AD48C
 * Callers:
...
void __fastcall PnpTraceClearDevNodeProblem(unsigned __int16 *a1, unsigned __int16 *a2, __int64 a3, int a4)
{
  ...
  if ( (_DWORD)a3 != 1 && (unsigned int)dword_140E06F70 > 5 )
  {
    if ( (qword_140E06F80 & 0x800000000000LL) == 0 || (v4 = 1, (qword_140E06F88 & 0x800000000000LL) != qword_140E06F88) )
      v4 = 0;
    if ( v4 )
    {
      v6 = a4;
      ...
      v20 = 4LL;
      v22 = 4LL;
      tlgWriteAgg((__int64)&dword_140E06F70, (unsigned __int8 *)byte_140046435, a3, 9u, (__int64)v8);
    }
  }
}
