/*
 * XREFs of PopPowerAggregatorDetermineTargetSystemPowerState @ 0x140A0FEC8
 * Callers:
 *     PopPowerAggregatorHandleResumeIntent @ 0x1405D2E40 (PopPowerAggregatorHandleResumeIntent.c)
 *     PopPowerAggregatorHandleSystemTransitionIntent @ 0x140A0FE50 (PopPowerAggregatorHandleSystemTransitionIntent.c)
 * Callees:
