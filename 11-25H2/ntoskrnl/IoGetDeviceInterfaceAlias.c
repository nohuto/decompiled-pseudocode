/*
 * XREFs of IoGetDeviceInterfaceAlias @ 0x140956090
 * Callers:
...
LABEL_42:
  ...
  ObjectProperty = PiPnpRtlApplyMandatoryFilters(*(__int64 *)&PiPnpRtlCtx, v6, 3, 0LL, &SubjectContext, &v30);
  ...
  if ( ObjectProperty >= 0 )
  {
    ...
    if ( ObjectProperty >= 0 )
    {
      ...
      if ( v15 )
      {
        ...
        if ( !v5 )
          goto LABEL_38;
        ObjectProperty = CmGetDeviceInterfaceReferenceString(v17, (__int64)v6, v5, 0x80u, &v31);
...
LABEL_21:
          ...
          ObjectProperty = CmGetDeviceInterfacePathFormat(v18, v6, (_BYTE *)&v30 + 1);
          if ( ObjectProperty >= 0 )
          {
            v31 = 512;
...
LABEL_30:
        ...
        if ( v5 )
        {
          ObjectProperty = CmGetDeviceInterfaceReferenceString(v25, (__int64)v6, v5, v31, &v31);
          goto LABEL_21;
        }
      }
LABEL_38:
