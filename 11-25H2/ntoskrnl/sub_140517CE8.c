/*
 * XREFs of sub_140517CE8 @ 0x140517CE8
 * Callers:
...
char __fastcall sub_140517CE8(__int64 a1, int *a2)
{
        ...
        *(_DWORD *)(a1 + 2524) &= ~0x200000u;
        if ( v35 != *(_QWORD *)(a1 + 2688) )
        {
          ...
          *(_DWORD *)(v39 + 16) = v38;
          ...
          LOBYTE(j) = sub_140BC7384(a1, 0LL, v35, 256LL);
        }
      }
    }
  }
LABEL_45:
  ...
  if ( !(_DWORD)v40 )
    return j;
  sub_140516AFC(a1, *((_QWORD *)a2 + 1), v40, (__int64)v64);
  v41 = 16;
  v42 = a2 + 6;
  v43 = v64;
  while ( 1 )
      ...
      *v46 &= ~0x200000u;
      if ( v57 != *(_QWORD *)(a1 + 2688) )
      {
        ...
        *(_DWORD *)(v62 + 16) = v61;
        ...
        LOBYTE(j) = sub_140BC7384(a1, 0LL, v57, 256LL);
      }
    }
  }
LABEL_74:
