/*
 * XREFs of EtwWmitraceWorker @ 0x14079D46C
 * Callers:
...
void EtwWmitraceWorker()
{
  ...
  if ( dword_140EFEFA4 )
  {
    SiloBySessionId = PsGetSiloBySessionId((unsigned int)dword_140EFEFA4, &v8);
  ...
  switch ( EtwWmitraceWork )
  {
    case 1:
      ...
      RtlInitAnsiString(&DestinationString, qword_140EFEFA8);
      ...
      if ( byte_140EFEFE9 )
      {
        RtlInitAnsiString(&DestinationString, &byte_140EFEFE9);
    ...
    default:
      ...
      if ( Trace >= 0 )
      {
        ...
        v4 = EtwEnableTrace(
               (unsigned int)&unk_140EFEFBC,
               0,
               EtwpWmitraceParams,
               v3,
               byte_140EFEFCC,
               *(__int64 *)qword_140EFEFA8,
               qword_140EFEFB0,
               dword_140EFEFB8);
        SiloBySessionId = v4;
        if ( v4 < 0 )
...
LABEL_34:
  dword_140EFF088 = SiloBySessionId;
  EtwWmitraceWork = 0;
}
