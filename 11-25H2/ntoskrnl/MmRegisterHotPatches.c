/*
 * XREFs of MmRegisterHotPatches @ 0x140C4599C
 * Callers:
...
__int64 __fastcall MmRegisterHotPatches(__int64 a1)
{
        ...
        i = (__int64 *)*i )
  {
    ...
    if ( (v6 & 1) != 0 )
    {
      ...
      if ( !HotPatchRecord )
        goto LABEL_14;
      if ( (unsigned int)MiInsertHotPatchRecord((unsigned __int64 *)&qword_140E37238, HotPatchRecord, 0) == 255 )
...
LABEL_15:
  ...
  for ( j = *(_QWORD **)&qword_140E37238; j; j = (_QWORD *)*j )
...
LABEL_60:
  ...
  while ( BugCheckParameter4 != *(_QWORD *)(a1 + 240) + 3784LL )
  {
    if ( (*(_DWORD *)(BugCheckParameter4 + 40) & 3) == 0 )
    {
      ...
      v29 = v20;
      v21 = MiFindHotPatchRecord((__int64 *)&qword_140E37238, 0, v28, v20, 0, 0LL, 0LL);
