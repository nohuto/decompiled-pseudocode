/*
 * XREFs of MiFindSuitableLookasideReplacement @ 0x140215040
 * Callers:
...
__int64 __fastcall MiFindSuitableLookasideReplacement(int a1, _QWORD *a2, __int64 a3, __int64 a4, int a5)
{
...
LABEL_6:
  ...
  if ( v11 < qword_140E358C0 || v11 >= qword_140E358C0 + 2048 )
  {
    ...
    if ( (*(_DWORD *)(v13 + 32) & 0x8000000) != 0 && (unsigned int)MiGetPfnSlabType(v13, 0xFFFFDE0000000000uLL, a3) == 9 )
    {
      v12 = 2;
      goto LABEL_7;
    }
...
LABEL_67:
      ...
      if ( v16 >= qword_140E358C0 && v16 < qword_140E358C0 + 2048 )
      {
        if ( !a5 || v14 > 1 )
        {
      ...
      if ( v16 < qword_140E358C0 || v16 >= qword_140E358C0 + 2048 )
      {
        ...
        if ( (*(_DWORD *)(v37 + 32) & 0x8000000) != 0 && (unsigned int)MiGetPfnSlabType(v37, v17, v14) == 9 )
          StandbyPageType = 2;
        else
          StandbyPageType = 0;
      }
    ...
    if ( !v9 && v16 >= qword_140E358C0 && v16 < qword_140E358C0 + 2048 )
    {
LABEL_75:
...
LABEL_39:
        v22 = a2[v45];
        a2[v45] = v16;
        if ( v22 == -1LL || v22 >= qword_140E358C0 && v22 < qword_140E358C0 + 2048 )
        {
        ...
        else
        {
          ...
          if ( v22 >= qword_140E358C0 && v22 < qword_140E358C0 + 2048 )
            v29 = 0xAAAAAAAAAAAAAAABuLL;
          else
            v29 = 0xAAAAAAAAAAAAAAABuLL;
          v30 = dword_140E2D884;
          if ( dword_140E2D880 > (unsigned int)dword_140E2D884
            || (v31 = (ULONG_PTR *)((char *)qword_140E2D8E0 + 16 * dword_140E2D880), v22 < *v31)
            || dword_140E2D880 != dword_140E2D884 && v22 >= v31[2] )
          {
            for ( i = 0; ; i = v33 + 1 )
            {
              while ( 1 )
              {
                ...
                v33 = (i + v30) >> 1;
                v34 = (ULONG_PTR *)((char *)qword_140E2D8E0 + 16 * v33);
                if ( v22 >= *v34 )
                  break;
                if ( !v33 )
                  KeBugCheckEx(0x1Au, 0x5180uLL, v22, (ULONG_PTR)qword_140E2D8E0, 0LL);
                v30 = v33 - 1;
              }
              if ( v33 == dword_140E2D884 || v22 < v34[2] )
                break;
            }
            dword_140E2D880 = (i + v30) >> 1;
          }
          v35 = *(_DWORD *)(v28 + 32);
          if ( (v35 & 0x8000000) != 0 && v28 >= 0xFFFFDE0000000000uLL && v28 < 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL )
          {
            v42 = 0xAAAAAAAAAAAAAAABuLL * (v24 >> 4);
            if ( (v42 < qword_140E358C0 || v42 >= qword_140E358C0 + 2048) && (BYTE2(v35) & 7) != 6 )
              MiGetPfnSlabType(v24 - 0x220000000000LL, v42, v22);
          }
          if ( qword_140E2D8E8 )
          {
        ...
        v10 = v16;
        if ( v16 != -1LL && (v16 < qword_140E358C0 || v16 >= qword_140E358C0 + 2048) )
        {
