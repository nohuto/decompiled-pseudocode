/*
 * XREFs of MiLockAndMapEntireDriver @ 0x1407E0A98
 * Callers:
...
__int64 __fastcall MiLockAndMapEntireDriver(__int64 a1, __int64 *a2, struct _MDL **a3)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( a3 )
    {
      ...
      if ( v11 )
      {
        if ( v11 < 2 || v7 <= &qword_140E370F8 && &v7[v11 - 1] >= &qword_140E370F8 )
          goto LABEL_12;
        v14 = v11 & 0xFFFFFFFE;
        do
          v13 = (unsigned int)(v13 + 2);
        while ( (unsigned int)v13 < (unsigned int)v14 );
        memset64(v7, qword_140E370F8, (2 * (v14 >> 1)) & 0x1FFFFFFFFFFFFFFFLL);
...
LABEL_12:
    ...
    v9 = MiLockDriverPageRange((__int64)a2, 0, v11 - 1, 2u, (__int64)v4);
    if ( v9 >= 0 && a3 )
    {
      v17 = MiReservePtes((__int64)&qword_140E37328, v11);
      if ( v17 )
      {
