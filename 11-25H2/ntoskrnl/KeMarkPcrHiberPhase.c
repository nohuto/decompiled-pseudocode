/*
 * XREFs of KeMarkPcrHiberPhase @ 0x140B453C0
 * Callers:
...
LABEL_29:
  ...
  if ( qword_140F0F978 )
    PoSetHiberRange(0LL, 0x10000u, qword_140F0F978, 16 * (unsigned int)(unsigned __int8)qword_140F0F968, 0x7272744Du);
  if ( qword_140F0F980 )
    PoSetHiberRange(0LL, 0x10000u, qword_140F0F980, 0x58uLL, 0x7272744Du);
  v19 = *(_QWORD **)(v1 + 8);
