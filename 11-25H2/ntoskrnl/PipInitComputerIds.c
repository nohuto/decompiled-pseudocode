/*
 * XREFs of PipInitComputerIds @ 0x140C52860
 * Callers:
 ...
 *     PipSmBiosFindStruct @ 0x140C111A8 (PipSmBiosFindStruct.c)
          ...
          *((_QWORD *)&v120 + 1) = v84;
          ...
          v98 = PiSwStartCreate(
                  ...
                  *((const wchar_t **)IopRootDeviceNode + 6),
                  ...
                  (__int64)&fmtid,
                  1);
          if ( v98 < 0 && (byte_140EEFA6C & 0x10) != 0 )
