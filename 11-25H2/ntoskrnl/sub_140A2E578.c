/*
 * XREFs of sub_140A2E578 @ 0x140A2E578
 * Callers:
...
__int64 __fastcall sub_140A2E578(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rsi
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
...
LABEL_125:
  ...
  if ( (_DWORD)v50 != 4 )
    goto LABEL_127;
  v52 = qword_140FD7378 ? guard_dispatch_icall_no_overrides(v21) : -1073700223;
  v53 = *(_DWORD *)(a2 + 32);
