/*
 * XREFs of PsInsertPermanentSiloContextEx @ 0x1409E3454
 * Callers:
 *     ObCreateSiloRootDirectory @ 0x14081AE94 (ObCreateSiloRootDirectory.c)
 *     PsInsertPermanentSiloContext @ 0x1409E3040 (PsInsertPermanentSiloContext.c)
 *     CmpAttachContextToSilo @ 0x1409E3428 (CmpAttachContextToSilo.c)
 * Callees:
