/*
 * XREFs of MiScrubProcessLargePage @ 0x1407EDCB0
 * Callers:
...
__int64 __fastcall MiScrubProcessLargePage(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v12 = 0LL;
  v6 = 0;
  if ( MiIdentifyPfnWrapper(48 * a2 - 0x220000000000LL, &v11) != MiPageSizes[a3] )
    return 0LL;
  if ( (v11 & 0x70) != 0x60 )
    return 0LL;
  if ( (v11 & 0xF) != 0xD )
  ...
  if ( !v7 )
    return 0LL;
  if ( MiIsVadLargePrivate(v7) && (*(_DWORD *)(v9 + 48) & 0x4200000) != 0x4200000 )
