/*
 * XREFs of MiGetHugeRange @ 0x1406645A4
 * Callers:
 ...
 *     MiInitializeGetPageChannels @ 0x1404420D0 (MiInitializeGetPageChannels.c)
...
__int64 __fastcall MiGetHugeRange(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v15 = (((__int64)BestHugeRangeFromNode - qword_140E2FD80) >> 3) & 0x3FFFFF;
  if ( (a3 & 0x20) != 0 && (*(_QWORD *)(qword_140E2FD80 + 8 * v15) & 0x10000LL) != 0 )
  {
    MiHugePageOperation(a1, ((((__int64)BestHugeRangeFromNode - qword_140E2FD80) >> 3) & 0x3FFFFF) << 18);
    if ( (a3 & 1) != 0 )
    {
      v16 = 17;
