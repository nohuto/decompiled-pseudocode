/*
 * XREFs of HalpCmosRangeHandler @ 0x14049F664
 * Callers:
 *     HalpcGetCmosDataByType @ 0x14049F640 (HalpcGetCmosDataByType.c)
 *     HalpcSetCmosDataByType @ 0x14055EE50 (HalpcSetCmosDataByType.c)
 * Callees:
