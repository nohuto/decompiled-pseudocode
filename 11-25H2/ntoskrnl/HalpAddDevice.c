/*
 * XREFs of HalpAddDevice @ 0x1406F2AF0
 * Callers:
 ...
 *     HalpAddChildPdo @ 0x1406F2AC8 (HalpAddChildPdo.c)
 *     IoRegisterPlugPlayNotification @ 0x14096BD60 (IoRegisterPlugPlayNotification.c)
 *     IoCreateDevice @ 0x14099E640 (IoCreateDevice.c)
 *     HalpInitializeSecondaryInterruptServices @ 0x140C000AC (HalpInitializeSecondaryInterruptServices.c)
 */
