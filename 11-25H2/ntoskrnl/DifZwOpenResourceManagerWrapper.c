/*
 * XREFs of DifZwOpenResourceManagerWrapper @ 0x1406366D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenResourceManagerWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        void *a3,
        GUID *a4,
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(76);
  ...
  LODWORD(v19) = ZwOpenResourceManager(a1, a2, a3, a4, ObjectAttributes);
  if ( v9 )
  {
