/*
 * XREFs of DifZwOpenDirectoryObjectWrapper @ 0x140635400
 * Callers:
 *     <none>
 * Callees:
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v17) = ZwOpenDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v7 )
  {
