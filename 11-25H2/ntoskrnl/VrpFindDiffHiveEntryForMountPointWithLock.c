/*
 * XREFs of VrpFindDiffHiveEntryForMountPointWithLock @ 0x140847024
 * Callers:
...
__int64 __fastcall VrpFindDiffHiveEntryForMountPointWithLock(PCUNICODE_STRING String1)
{
  ...
  v7 = -1LL << (dword_140EEFBF4 & 0x1F);
  v8 = v5 & v7;
  if ( !((unsigned int)dword_140EEFBF4 >> 5) )
    goto LABEL_12;
  v13 = v5 & v7;
  v9 = qword_140EEFBF8
     + 8LL
     * ((37
       * (BYTE6(v13)
       ...
       + HIBYTE(v13)) & (((unsigned int)dword_140EEFBF4 >> 5) - 1));
  do
  {
    v9 = *(_QWORD *)v9;
    if ( (v9 & 1) != 0 )
...
LABEL_8:
  while ( v9 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (v9 & 1) != 0 )
        break;
      if ( (v5 & (-1LL << (dword_140EEFBF4 & 0x1F))) == ((-1LL << (dword_140EEFBF4 & 0x1F)) & *(_QWORD *)(v9 + 8)) )
        goto LABEL_8;
    }
LABEL_12:
    v9 = 0LL;
