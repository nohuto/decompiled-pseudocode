/*
 * XREFs of ?StDmLazyRegionsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KPEAU_ST_WORK_ITEM@1@@Z @ 0x140495CA8
 * Callers:
 ...
 *     SmWorkQueueGetDepth @ 0x14044A2C0 (SmWorkQueueGetDepth.c)
