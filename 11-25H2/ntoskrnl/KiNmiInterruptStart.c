/*
 * XREFs of KiNmiInterruptStart @ 0x1406AB4C0
 * Callers:
 *     KiNmiInterruptShadow @ 0x140BAA240 (KiNmiInterruptShadow.c)
 * Callees:
 ...
 *     KiSetSpecCtrlNmi @ 0x1406A1300 (KiSetSpecCtrlNmi.c)
...
LABEL_8:
    ...
    v18 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (v20 | (unsigned int)v19))] - 384;
    goto LABEL_8;
  }
  if ( (KiKvaShadow & 1) == 0 )
    __asm { swapgs }
...
LABEL_20:
  ...
  v32 = _bittestandset16(MK_FP(__GS__, 34086LL), 0);
  if ( v32
    || (v61 & 1) == 0
