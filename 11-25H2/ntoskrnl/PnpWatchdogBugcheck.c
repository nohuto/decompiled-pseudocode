/*
 * XREFs of PnpWatchdogBugcheck @ 0x1405A1D24
 * Callers:
 *     PnpWatchdogSecondChanceCallback @ 0x1405A2080 (PnpWatchdogSecondChanceCallback.c)
 * Callees:
 *     IoAddTriageDumpDataBlock @ 0x14041F7F0 (IoAddTriageDumpDataBlock.c)
 *     PnpWatchdogExtractTriageInformation @ 0x1404CFE60 (PnpWatchdogExtractTriageInformation.c)
