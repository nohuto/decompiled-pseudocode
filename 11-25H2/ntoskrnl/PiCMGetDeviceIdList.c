/*
 * XREFs of PiCMGetDeviceIdList @ 0x14095ED28
 * Callers:
 ...
 *     PiCMConvertDeviceListFilters @ 0x14095F248 (PiCMConvertDeviceListFilters.c)
        ...
        _DWORD *a6)
{
  ...
  char (__fastcall *v19)(_QWORD *, const WCHAR *, int, struct _SECURITY_SUBJECT_CONTEXT *); // r9
  bool v20; // sf
  int v21; // edx
  int v22; // eax
