/*
 * XREFs of EtwpFlushActiveBuffers @ 0x14098F3D0
 * Callers:
 ...
 *     HvlQueryStartedProcessors @ 0x1404F8820 (HvlQueryStartedProcessors.c)
  ...
  if ( v8 - 1 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        {
          v13 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 4144) + v12) + 8LL * *a1);
        }
      }
...
LABEL_40:
    ...
    {
      _InterlockedAdd(&QuadPart[1].HighPart, -(i & 0xF));
    ...
    do
    {
      ...
      *((_WORD *)v36 + 26) = 0;
      if ( v38 )
        ...
        guard_dispatch_icall_no_overrides(v40);
      v23 = (_QWORD **)v34;
      if ( v34 )
        v34 = (_QWORD *)*v34;
