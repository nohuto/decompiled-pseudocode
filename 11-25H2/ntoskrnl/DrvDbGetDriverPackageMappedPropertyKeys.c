/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x140812314
 * Callers:
 *     DrvDbDispatchDriverPackage @ 0x1409303A0 (DrvDbDispatchDriverPackage.c)
 * Callees:
 *     ZwClose @ 0x14069B320 (ZwClose.c)
 *     DrvDbGetCompositeMappedPropertyKeys @ 0x140811ACC (DrvDbGetCompositeMappedPropertyKeys.c)
        ...
        unsigned int *a6)
{
  ...
  v11 = a5;
  *v6 = 0;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (__int64)&off_140E0A320, 0x10u, a4, v7, v36);
  ...
  for ( i = 0LL; (unsigned int)i < 2; i = (unsigned int)(i + 1) )
  {
    ...
    if ( DriverPackageMappedProperty != -1073741275 )
    {
      ...
      if ( v9 && v10 < v11 )
      {
        ...
        *(_DWORD *)(v9 + 4 * v21 + 16) = *(_DWORD *)(v19 + 16);
      }
      v22 = *v6 + 1;
      if ( v22 < *v6 )
      {
  ...
  for ( j = 0LL; (unsigned int)j < 0x26; j = (unsigned int)(j + 1) )
  {
    a5 = 0;
    v24 = Handle;
    v25 = (&off_14000C180)[5 * j];
    if ( a3 )
      v24 = a3;
    v39 = 5 * j;
