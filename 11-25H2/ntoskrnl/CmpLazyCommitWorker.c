/*
 * XREFs of CmpLazyCommitWorker @ 0x1407CE980
 * Callers:
 *     <none>
 * Callees:
...
_KAFFINITY_EX *CmpLazyCommitWorker()
{
  ...
  __int64 v6; // rcx
  _QWORD *v7; // rcx
  _QWORD **v9; // [rsp+30h] [rbp-20h] BYREF
...
LABEL_20:
      ...
      *(_QWORD *)(v2 + 8) = &CmpLazyCommitListHead;
      ...
      if ( (int)CmpTransMgrCommit(v3, v1 - 4, &v12) < 0 )
      {
        v4 = (__int64 **)v10;
        if ( (_QWORD ***)*v10 != &v9 )
          goto LABEL_20;
    ...
    if ( !v0 )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v6 + 8) = &v9;
        if ( v5 == &v9 )
          break;
        v7 = (_QWORD *)qword_140EF50A8;
        if ( *(__int64 **)qword_140EF50A8 != &CmpLazyCommitListHead )
          goto LABEL_20;
        *v5 = &CmpLazyCommitListHead;
        v5[1] = v7;
        *v7 = v5;
        qword_140EF50A8 = (__int64)v5;
      }
      ExReleaseFastMutexUnsafe(&CmpTransactionListLock);
      KeLeaveCriticalRegion();
