/*
 * XREFs of PopMarkHiberPhase @ 0x140B4D914
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0ADB0, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0AD78, (unsigned int)dword_140F0AD80, 0);
  v3 = (char *)(Address + 20);
