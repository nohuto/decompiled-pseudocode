/*
 * XREFs of KseDsCallbackHookIrpPowerFunction @ 0x1405C66B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KseDsCallbackHookIrpPowerFunction(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)(v7 - 2) <= 1 )
  {
    ...
    {
      if ( v3 == 1 )
        KsepDsEventDevicePowerIrp(*(_QWORD *)(a1 + 8), a1, v6, v7, 1, v5, v8);
    }
    else
    {
      KsepDsEventSystemPowerIrp(*(_QWORD *)(a1 + 8), a1, v6, v7, 0, v5, v8);
    }
  }
  return v9;
}
