/*
 * XREFs of DifObjTrkQeuryInvokeDeleteRange @ 0x14060BED0
 * Callers:
 ...
 *     DifAvlRealSuccessor @ 0x1404585AC (DifAvlRealSuccessor.c)
 *     RtlGetElementGenericTableAvl @ 0x14048BA10 (RtlGetElementGenericTableAvl.c)
 *     DifObjTrkGetPluginContext @ 0x14060BD10 (DifObjTrkGetPluginContext.c)
 *     DifObjTrkIsExceptionPluginId @ 0x14060BE9C (DifObjTrkIsExceptionPluginId.c)
 ...
 *     DifAvlRealPredecessor @ 0x14060DF4C (DifAvlRealPredecessor.c)
                  ...
                  if ( v11 )
                  {
                    ...
                    if ( v20 )
                    {
                      ...
                      do
                      {
                        ...
                        if ( v25 )
                        {
                          PluginContext = DifObjTrkGetPluginContext(*(_DWORD *)(v25 + 32));
                          if ( PluginContext )
                          {
                            if ( *(_QWORD *)(PluginContext + 8) )
                              guard_dispatch_icall_no_overrides(*(_QWORD *)(v25 + 40));
                          }
                        }
