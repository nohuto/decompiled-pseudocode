/*
 * XREFs of PpmEventParkNodeRecordedStats @ 0x1403B1B08
 * Callers:
    ...
    if ( PpmEtwHandle )
    {
        ...
        && (LOBYTE(v5) = EtwpLevelKeywordEnabled(*(_QWORD *)(v9 + 40) + 96LL, v6, v7), (_BYTE)v5) )
      {
        *(_QWORD *)&UserData.Size = v7;
        ...
        v24 = 1LL;
        v27 = (int)ActivityId;
        LOBYTE(v5) = EtwWriteEx(PpmEtwHandle, &PPM_ETW_PARK_NODE_STATS, 0LL, 0, ActivityId, ActivityId, 7u, &UserData);
      }
    }
  }
  return (char)v5;
