/*
 * XREFs of CmpLoadLayerVersion @ 0x1407C73C0
 * Callers:
  ...
  if ( result >= 0 )
  {
    ...
    *((_QWORD *)a1 + 3) = a1 + 28;
    ...
    if ( (((unsigned __int8)v7 | (unsigned __int8)v12) & 8) == 0 )
      return -2147483614;
    v13 = (~(unsigned int)CmpQueryLayerVersionUlong(a1 + 1, L"MinorVersion", KeyHandle) >> 27) & 0x10 | a1[200] & 0xFFFFFFEF;
    a1[200] = v13;
    ...
    if ( (int)CmpQueryLayerVersionUlong(a1 + 2, L"BuildNumber", KeyHandle) < 0 || (v14 = 32, !a1[2]) )
      v14 = 0;
    v15 = v14 | a1[200] & 0xFFFFFFDF;
    a1[200] = v15;
    if ( (((unsigned __int8)v7 | (unsigned __int8)v15) & 0x20) == 0 )
      return -2147483614;
    v16 = (~(unsigned int)CmpQueryLayerVersionUlong(a1 + 3, L"BuildQfe", KeyHandle) >> 25) & 0x40 | a1[200] & 0xFFFFFFBF;
    a1[200] = v16;
