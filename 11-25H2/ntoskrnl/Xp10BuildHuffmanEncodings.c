/*
 * XREFs of Xp10BuildHuffmanEncodings @ 0x14077A404
 * Callers:
          ...
          if ( *((unsigned __int8 *)a1 + m + 38176) == v47 )
          {
            ...
            if ( v47 > 8 )
            {
              ...
              do
              {
                ...
                v55 -= 8;
                v56 >>= 8;
                v54 = *((unsigned __int8 *)qword_1400330C0 + v58) | (v54 << 8);
                --v57;
              }
              while ( v57 );
              v52 = a5;
            ...
            if ( v55 )
              v54 = (*((unsigned __int8 *)qword_1400330C0 + (unsigned __int8)v56) | (v54 << 8)) >> (8 - v55);
            ++v51;
