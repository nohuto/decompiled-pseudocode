/*
 * XREFs of PopConfigureHeteroPolicies @ 0x140A20E1C
 * Callers:
 ...
 *     KeConfigureHeteroPolicy @ 0x140A2183C (KeConfigureHeteroPolicy.c)
 *     PpmHeteroComputeBias @ 0x140A219E0 (PpmHeteroComputeBias.c)
    ...
    switch ( (_DWORD)v15 )
    {
      ...
      case 3:
        if ( !PpmMultimediaQosProfile )
          goto LABEL_64;
        v17 = (__int64 *)(488LL * dword_140F0B70C + PpmMultimediaQosProfile + 40);
        v37 = *(_OWORD *)v17;
        break;
      case 4:
LABEL_64:
        v17 = &PpmCurrentProfile[0][61 * dword_140F0B70C + 5];
...
LABEL_18:
        ...
        {
LABEL_19:
          v17 = (__int64 *)(488LL * dword_140F0B70C + v16 + 40);
          v18 = *(_OWORD *)v17;
        }
        else
        {
...
LABEL_21:
  ...
  while ( v14 );
  v20 = v73;
  if ( LODWORD(PpmCurrentProfile[0][61 * dword_140F0B70C + 60]) )
    v20 = PpmCurrentProfile[0][61 * dword_140F0B70C + 60];
  v73 = v20;
  if ( a2 )
  {
    dword_140F07CA4 = -1;
    xmmword_140F07C64 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
    PopHeteroLegacyOverride = 5;
    xmmword_140F07C74 = xmmword_140F07C64;
    qword_140F07C9C = 0LL;
    xmmword_140F07C84 = xmmword_140F07C64;
    qword_140F07C94 = xmmword_140F07C64;
  ...
  do
  {
    ...
    do
    {
      v24 = *(_DWORD *)((char *)&xmmword_140F07C64 + v21 * 4);
      if ( v24 != 5 )
  ...
  v26 = v72;
  if ( (_DWORD)qword_140F07C9C )
    v26 = qword_140F07C9C;
  v72 = v26;
  v27 = v73;
  if ( HIDWORD(qword_140F07C9C) )
    v27 = HIDWORD(qword_140F07C9C);
  v67 = v25;
  v73 = v27;
  v28 = v74;
  if ( dword_140F07CA4 != -1 )
    v28 = dword_140F07CA4;
  v74 = v28;
