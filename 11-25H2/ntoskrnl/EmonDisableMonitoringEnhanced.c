/*
 * XREFs of EmonDisableMonitoringEnhanced @ 0x1405587C0
 * Callers:
 *     <none>
 * Callees:
 *     EmonConfigureCounter @ 0x140558610 (EmonConfigureCounter.c)
 *     EmonFindCounterToDisableEnhanced @ 0x140558DE0 (EmonFindCounterToDisableEnhanced.c)
 *     EmonFreeCounterEnhanced @ 0x140558EEC (EmonFreeCounterEnhanced.c)
 */
