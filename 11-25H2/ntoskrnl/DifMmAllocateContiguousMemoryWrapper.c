/*
 * XREFs of DifMmAllocateContiguousMemoryWrapper @ 0x140625F70
 * Callers:
 *     <none>
 * Callees:
        ...
        PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    *((PHYSICAL_ADDRESS *)&v13 + 1) = HighestAcceptableAddress;
  ...
  *((_QWORD *)&v14 + 1) = MmAllocateContiguousMemory(NumberOfBytes, HighestAcceptableAddress);
  if ( v5 )
  {
