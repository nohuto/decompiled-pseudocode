/*
 * XREFs of ExEnableHandleTracing @ 0x140AB59E8
 * Callers:
 ...
 *     MmGetMaximumNonPagedPoolInBytes @ 0x1404AEB18 (MmGetMaximumNonPagedPoolInBytes.c)
...
LABEL_29:
  ...
  *(_BYTE *)(a1 + 44) |= 2u;
  ...
  if ( v15 )
    ExDereferenceHandleDebugInfo(a1, v15);
  return 0LL;
}
