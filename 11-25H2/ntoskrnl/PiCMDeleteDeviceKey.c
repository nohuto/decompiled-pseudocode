/*
 * XREFs of PiCMDeleteDeviceKey @ 0x140AB8E44
 * Callers:
 ...
 *     PiCMConvertDeviceKeyType @ 0x14095BFF0 (PiCMConvertDeviceKeyType.c)
    ...
    if ( PiAuDoesClientHaveAccess(2u) )
    {
      if ( (_QWORD)v22 && DWORD2(v21) == 1 && a3 && a4 >= 8 )
      {
        ...
        if ( v10 >= 0 )
        {
          ...
          {
            if ( (int)PnpCtxGetCachedContextBaseKey(*(__int64 *)&PiPnpRtlCtx, 4, &Value[1]) >= 0 )
            {
              v12 = 0;
                          ...
                          (__int64)&Handle) >= 0 )
              {
                do
                {
                  ...
                  while ( 1 )
                  {
                    ...
                    if ( inited < 0 )
                      break;
                    v10 = CmDeleteDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, v22, v17, Value[0]);
                    if ( v10 != -1073741772 )
                      break;
                    v12 = v14 + 1;
                    v10 = 0;
          ...
          {
            v10 = CmDeleteDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, v22, v17, SHIDWORD(v22));
          }
        }
      }
      else
