...
__int64 __fastcall PerfDiagpUpdatePerfDiagLoggerEnableFlags(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  unsigned int v4; // ebx
  ULONG v5; // [rsp+20h] [rbp-79h]
  _DWORD v6[4]; // [rsp+30h] [rbp-69h] BYREF
  ...
  v10 = 3;
  LODWORD(Src[0]) = 48;
  result = RtlpQueryRegistryValues(2, (int)L"Diagnostics\\Performance\\BootCKCLSettings", (int)v7, 0, v5, 1);
  if ( (int)result >= 0 )
  {
    if ( DWORD1(Src[0]) == 3 )
    {
