/*
 * XREFs of RtlpFcQueryFeatureConfigurationFromBuffers @ 0x140AC8A30
 * Callers:
...
__int64 __fastcall RtlpFcQueryFeatureConfigurationFromBuffers(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    LowerBoundInSortedArray = (unsigned int *)RtlpFcLinearSearchInSortedArray((__int64)&v14, v11, v10);
    v8 = v14;
  }
