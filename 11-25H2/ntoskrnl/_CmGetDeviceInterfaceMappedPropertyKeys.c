/*
 * XREFs of _CmGetDeviceInterfaceMappedPropertyKeys @ 0x140955BD4
 * Callers:
    ...
    if ( v13 )
    {
      if ( a4
        || (DeviceInterfaceMappedPropertyFromRegValue = CmGetDeviceInterfaceMappedPropertyFromRegValue(
                                                          ...
                                                          a2,
                                                          a3,
                                                          (unsigned int)*(&off_140B2C130 + 2 * i),
                                                          (__int64)&a7,
                                                          0LL,
                                                          0,
                                                          (__int64)v25),
