/*
 * XREFs of IvtLegacyAllocateScalableModePasidTables @ 0x14056C4A0
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  _QWORD *v23; // rax
  __int64 v24; // rcx
  LARGE_INTEGER v26; // [rsp+30h] [rbp-58h] BYREF
...
LABEL_37:
  ...
  if ( v28 )
    IvtFreeScalableModePasidTables(a1, v28);
  if ( v13 >= 0 )
  {
    *a7 = v16;
