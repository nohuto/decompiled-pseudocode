/*
 * XREFs of PopPepIdleTimeoutRoutine @ 0x1403A5D50
 * Callers:
 *     <none>
 * Callees:
...
void PopPepIdleTimeoutRoutine()
{
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&PopPepDeviceListLock, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&PopPepDeviceListLock, 0, v2, (unsigned __int64)&PopPepDeviceListLock);
  if ( v2 )
    *((_BYTE *)v2 + 10) = 1;
