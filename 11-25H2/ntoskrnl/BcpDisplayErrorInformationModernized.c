/*
 * XREFs of BcpDisplayErrorInformationModernized @ 0x14068E104
 * Callers:
        ...
        char a6)
{
  ...
  *(_DWORD *)(&Source.MaximumLength + 1) = 0;
  v11 = (int *)((char *)&unk_140E0ECC0 + 84 * a1);
  v31 = dword_140EEF840;
  v28 = dword_140EEF840;
  Source.MaximumLength = 18;
  Source.Buffer = v37;
  Destination.Buffer = (wchar_t *)qword_140E3E868;
  if ( RtlAppendUnicodeStringToString(&Destination, &stru_140E3E7F0) >= 0
...
LABEL_15:
      if ( !a4
        || (*(_DWORD *)&v34.Length = 0x800000,
            ...
            *(_QWORD *)&v30.Length = 0LL,
            v30.MaximumLength = word_140E3E888,
            v30.Buffer = (wchar_t *)qword_140E3E880,
            RtlAppendUnicodeStringToString(&v30, &stru_140E3E7E0) >= 0)
        ...
        && RtlAppendUnicodeStringToString(&v30, &v34) >= 0 )
      {
        ...
        if ( a4 )
        {
          BcpSetCursorPosition((unsigned int)v27, (unsigned int)dword_140EEF840, 0LL);
          BcpDisplayCriticalStringCentered(&v30, v11[1], v18, a1);
        }
        v19 = (unsigned int)(v31 + v11[5] + v11[7] - dword_140EEF840);
        dword_140EEFD90 &= ~0x1000000u;
