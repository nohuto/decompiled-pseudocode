/*
 * XREFs of VmpLogPin @ 0x140790D10
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( a2 )
  {
    if ( **(_DWORD **)&VmpTraceLoggingProvider > 5u )
    {
      ...
      if ( (_BYTE)v8 )
      {
        ...
        v36 = 8LL;
        v38 = 4LL;
        LOBYTE(v8) = tlgWriteEx_EtwWriteEx(v9, (unsigned __int8 *)byte_140050879, v12, 0, v15, v16, 9u, v24);
      }
    }
  }
  else if ( **(_DWORD **)&VmpTraceLoggingProvider > 5u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v34 = 8LL;
      v36 = 4LL;
      LOBYTE(v8) = tlgWriteEx_EtwWriteEx(v9, (unsigned __int8 *)&byte_140050D01, v13, 0, v15, v16, 8u, v24);
    }
  }
  return (char)v8;
}
