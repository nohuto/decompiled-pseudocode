/*
 * XREFs of SdbGuestTargetPlatformFlagsToRuntimePlatformFlags @ 0x1407F6550
 * Callers:
...
__int64 __fastcall SdbGuestTargetPlatformFlagsToRuntimePlatformFlags(int a1)
{
  ...
  if ( (int)AslEnvGetProcessWowInfo(&v6, 0LL) >= 0 )
  {
    ...
    {
      if ( (*(_DWORD *)((_BYTE *)qword_14003CB20 + i) & 0x1F) != 0 )
      {
        v3 = *(_WORD *)&algn_14003CB12[i + 10];
        for ( j = 0LL; j < 0x80; j += 16LL )
        {
          if ( *(_WORD *)((char *)&unk_140E0A090 + j) == v6 && *(_WORD *)((char *)&unk_140E0A092 + j) == v3 )
          {
