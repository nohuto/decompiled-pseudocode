/*
 * XREFs of ViMiscCheckResourceRelease @ 0x140B8F424
 * Callers:
 *     VfMiscExReleaseResourceLite_Entry @ 0x140B8DA90 (VfMiscExReleaseResourceLite_Entry.c)
 *     VfMiscExReleaseResourceForThreadLite_Entry @ 0x140B8DAB0 (VfMiscExReleaseResourceForThreadLite_Entry.c)
 * Callees:
