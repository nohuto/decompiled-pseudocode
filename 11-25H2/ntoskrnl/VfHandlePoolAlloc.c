/*
 * XREFs of VfHandlePoolAlloc @ 0x140B98AC0
 * Callers:
 ...
 *     IovAllocateWorkItem @ 0x140B72490 (IovAllocateWorkItem.c)
 ...
 *     ViPostPoolAllocation @ 0x140B81910 (ViPostPoolAllocation.c)
...
LABEL_4:
  ...
  v39 = v9;
  v38 = v9;
  _InterlockedIncrement(&dword_140F03A90);
  v18 = v42;
...
LABEL_51:
  ...
  v28 = 0;
  _InterlockedIncrement(&dword_140F03A94);
  if ( (unsigned int)ExIsSpecialPoolAddress(PoolWithTagPriority) == 1 )
  {
    v28 = 1;
LABEL_70:
    _InterlockedIncrement(&dword_140F03A98);
    goto LABEL_71;
  }
  if ( v9 > 0xFE0 )
    goto LABEL_70;
