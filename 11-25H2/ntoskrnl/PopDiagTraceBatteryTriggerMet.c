/*
 * XREFs of PopDiagTraceBatteryTriggerMet @ 0x1407499AC
 * Callers:
...
char __fastcall PopDiagTraceBatteryTriggerMet(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned int)*a3 <= 1 )
  {
    ...
    v12 = *(_DWORD *)(a1 + 4);
    v8 = v4;
    v11 = xmmword_140F0AAE0 & 1;
    v6 = *(_BYTE *)a2 == 0;
    v13 = byte_140F0ABF8 != 0;
    v14 = !v6;
    v15 = *(_DWORD *)(a2 + 8);
    v16 = *(_DWORD *)(a2 + 4);
    v17 = *(_DWORD *)(a2 + 16);
    v18 = *(_DWORD *)(a2 + 20);
    LOBYTE(v3) = -45 * (dword_140F0AC84 - 12);
    v10 = (dword_140F0AC84 + 500) / 0x3E8u;
    ...
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)&word_140048D2E,
                       0LL,
                       0LL,
                       0xEu,
                       &v52);
