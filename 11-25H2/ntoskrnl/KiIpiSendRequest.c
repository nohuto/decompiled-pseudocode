/*
 * XREFs of KiIpiSendRequest @ 0x14032D550
 * Callers:
...
__int64 __fastcall KiIpiSendRequest(__int64 a1, int a2, char *a3, _OWORD *a4, __int64 a5)
{
  ...
  {
    v58 = 1;
    EtwGetKernelTraceTimestamp((LARGE_INTEGER *)v72, 0x40400000u);
  }
  else
  {
    v58 = 0;
    ...
    while ( 1 )
    {
      if ( v28 )
      {
        ...
        *((_QWORD *)&v67 + 1) = v28 & ~(1LL << v32);
        v33 = *((unsigned int *)qword_140F216A8 + 64 * v30 + (unsigned int)(unsigned __int8)v32);
    ...
    if ( (_DWORD)v20 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)&v64 + 1) = a1 + 12496;
        result = HalpInterruptSendIpi(&v64, 0xE1u);
        v55 = result;
        if ( (int)result >= 0 )
          goto LABEL_76;
      }
