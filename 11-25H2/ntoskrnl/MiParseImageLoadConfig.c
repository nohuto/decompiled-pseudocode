...
__int64 __fastcall MiParseImageLoadConfig(_QWORD *a1, void *a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  unsigned int v62; // [rsp+1F8h] [rbp-280h]
                    ...
                    RetpolineRelocationInformation >= 0) )
              {
                ...
                if ( v8 && v32[0] )
                {
                  ...
                  else
                  {
                    if ( v26 < 0 )
                      goto LABEL_37;
                    RetpolineRelocationInformation = MiCreateRetpolineRelocationInformation(v63, v62, a4, a5 + 16);
                    if ( RetpolineRelocationInformation < 0 )
                      goto LABEL_37;
                  }
                }
                if ( v23 == 523 && v32[0] )
                {
                  ...
                  {
                    v28 = RtlInitializeImageSystemOverride(v46, a4, (*(_DWORD *)a5 >> 3) & 1);
                    v47 = *(_OWORD *)v28;
                    v48 = *(_OWORD *)(v28 + 16);
                    v49 = *(_OWORD *)(v28 + 32);
                    v50 = *(_QWORD *)(v28 + 48);
