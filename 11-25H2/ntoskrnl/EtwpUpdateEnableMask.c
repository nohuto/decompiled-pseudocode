/*
 * XREFs of EtwpUpdateEnableMask @ 0x140896F0C
 * Callers:
...
char __fastcall EtwpUpdateEnableMask(__int64 a1, char a2, char a3, char a4, _BYTE *a5)
{
  char result; // al
  _DWORD *v6; // rsi
  unsigned int i; // r14d
      ...
      if ( !result || (*v6 & 0x400) != 0 )
      {
        ...
        if ( !a2 || (_DWORD)v10 == *(unsigned __int16 *)(a1 + 88) )
        {
          ...
          if ( (unsigned int)v10 < *(_DWORD *)(v12 + 16)
            && (*(_QWORD *)(*(_QWORD *)(v12 + 456) + 8 * v10) & 1) == 0
            && ExAcquireRundownProtectionCacheAwareEx(
                 *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v12 + 448) + 8 * v10),
                 1u) )
          {
            if ( (unsigned int)v10 >= *(_DWORD *)(v12 + 16)
              || (_mm_lfence(),
                  v14 = *(unsigned int **)(*(_QWORD *)(v12 + 456) + 8 * v10),
                  ((unsigned __int8)v14 & 1) != 0) )
            {
              ExReleaseRundownProtectionCacheAwareEx(
                *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v12 + 448) + 8 * v13),
                1u);
            }
            else if ( v14[80] )
            {
