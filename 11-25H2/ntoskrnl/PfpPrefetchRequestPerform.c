/*
 * XREFs of PfpPrefetchRequestPerform @ 0x1408EAE18
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x1408E9708 (PfpPrefetchRequestPatchOffsets.c)
...
__int64 __fastcall PfpPrefetchRequestPerform(__int64 a1)
{
  ...
  *(_QWORD *)(v31 + 24) = &v26;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v26 + 81) )
    {
      _InterlockedAdd((_DWORD *)&xmmword_140F0DD48 + 2, 1u);
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140E66BC0, 0);
      if ( v4 < 0 )
      {
LABEL_50:
        _InterlockedDecrement((_DWORD *)&xmmword_140F0DD48 + 2);
        PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140E66BC0, 0);
        goto LABEL_12;
      }
      if ( !*(_QWORD *)(v26 + 72) )
...
LABEL_10:
    ...
    PfpPrefetchRequestPatchOffsets((_DWORD *)a1);
...
LABEL_12:
  if ( P )
  {
    ...
    for ( m = 0; m < *(_DWORD *)(v13 + 12); ++m )
    {
      ...
      {
        PfpOpenHandleClose((__int64)v15, v31);
        v13 = v26;
      }
    }
