/*
 * XREFs of KiAttemptToScheduleThreadToBusyIsolationUnit @ 0x1403DD240
 * Callers:
    ...
    *(_DWORD *)&StaticRescheduleContext->LegacyNumber = v52;
    if ( v48 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v94 )
          break;
        v97 = (struct _KPRCB *)&StaticRescheduleContext->PrcbPad03[16 * v93 + 3];
        if ( (KiVelocityFlags & 0x200000) != 0 )
        {
          v97->CurrentThread = (_KTHREAD *)v94;
          *(_QWORD *)&v97->MxCsr = 0LL;
          v98 = (struct _KPRCB **)_InterlockedExchange64(v94, (__int64)v97);
          if ( v98 )
            KxWaitForLockOwnerShip(v97, v98);
        }
        else
        {
          v99 = 0;
...
LABEL_166:
                  ...
                  KiAddThreadToScbQueue(v103, v107);
