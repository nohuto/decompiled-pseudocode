/*
 * XREFs of ?SmStCompareRegionDataCallback@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU_SMKM_STORE_HELPER@@PEAXK@Z @ 0x14020A380
 * Callers:
        ...
        int a4)
{
  ...
  unsigned __int64 v24; // [rsp+78h] [rbp-70h] BYREF
  _QWORD v25[13]; // [rsp+80h] [rbp-68h]
  unsigned int v26; // [rsp+F0h] [rbp+8h]
...
LABEL_10:
          ...
          v25[0] = 0LL;
          v25[2] = 0LL;
          v24 = Buf2 & 0xFFFFFFFFFFFFF000uLL;
          v25[1] = (Buf2 & 0xFFFFFFFFFFFFF000uLL) + 4096;
          v26 = (*((unsigned __int16 *)v10 + 2) + 4095 + (Buf2 & 0xFFF)) >> 12;
          v18 = 16 * v26;
          if ( (int)MmQueryVirtualMemory(-1LL, 0LL, 4LL, &v24) < 0 )
          {
            v15 = 2;
          }
          else
          {
            for ( k = 0; ; ++k )
            {
              ...
              if ( (v25[2 * k] & 1) == 0 && (v25[2 * k] & 0xC00000LL) != 0x400000 )
                break;
            }
            v15 = 0;
          }
