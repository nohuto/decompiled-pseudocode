/*
 * XREFs of CmSelectQualifiedInstallLanguage @ 0x140C37164
 * Callers:
       ...
       : HvpGetCellPaged((ULONG_PTR)&CmControlHive, v9, &v36) )
    {
      ...
      if ( ValueByName != -1 )
      {
        ...
        if ( v13 )
        {
          ...
          if ( (byte_14100C65C & 1) != 0 )
            HvpReleaseCellFlat((__int64)&CmControlHive, &v38);
          else
            HvpReleaseCellPaged((__int64)&CmControlHive, (unsigned int *)&v38);
        }
      }
      if ( (byte_14100C65C & 1) != 0 )
        HvpReleaseCellFlat((__int64)&CmControlHive, &v36);
      else
        HvpReleaseCellPaged((__int64)&CmControlHive, (unsigned int *)&v36);
    }
  }
  v15 = CmpWalkPath((ULONG_PTR)&CmControlHive, a2, L"MUI\\UILanguages");
  if ( v15 == -1 )
    return v8;
  v16 = (byte_14100C65C & 1) != 0
...
LABEL_37:
  ...
  if ( (byte_14100C65C & 1) != 0 )
    HvpReleaseCellFlat((__int64)&CmControlHive, &v41);
  else
    HvpReleaseCellPaged((__int64)&CmControlHive, (unsigned int *)&v41);
  if ( v33 || v7 )
    v8 &= ~4u;
  if ( v34 )
  {
