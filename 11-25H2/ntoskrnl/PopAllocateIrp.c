/*
 * XREFs of PopAllocateIrp @ 0x140359E20
 * Callers:
        ...
        _QWORD *a11)
{
  ...
  *a11 = 0LL;
  ...
  DeviceAttachmentBaseRefWithTag = IoGetDeviceAttachmentBaseRefWithTag(a1, 1917415248LL);
  v37 = (void *)DeviceAttachmentBaseRefWithTag;
  v19 = (void *)DeviceAttachmentBaseRefWithTag;
  if ( DeviceAttachmentBaseRefWithTag )
  {
    v20 = *(_QWORD *)(*(_QWORD *)(DeviceAttachmentBaseRefWithTag + 312) + 40LL);
...
LABEL_11:
          ...
          *((_DWORD *)v36 + 53) = _InterlockedIncrement(&PopCurrentIrpSequenceID);
          ...
          v28 = (_QWORD *)qword_140F0B3F8;
          if ( *(__int64 **)qword_140F0B3F8 != &PopIrpList )
            __fastfail(3u);
          v32 = v36;
      ...
      else
      {
        ...
        if ( !a3 )
        {
          v16 = PopFxLockDevice(v20, 0LL, 0LL);
          v41 = v16 != 0;
        }
      }
      v29 = 0;
