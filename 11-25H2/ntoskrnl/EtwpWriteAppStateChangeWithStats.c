/*
 * XREFs of EtwpWriteAppStateChangeWithStats @ 0x140920B7C
 * Callers:
...
void __fastcall EtwpWriteAppStateChangeWithStats(__int64 a1, __int64 a2)
{
  ...
  {
    if ( (qword_140E09020 & 0x200000000003LL) == 0 || (v2 = 1, (qword_140E09028 & 0x200000000003LL) != qword_140E09028) )
      v2 = 0;
    if ( v2 )
    {
      v11 = *(_DWORD *)(a1 + 464);
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_14005120F,
        0LL,
        0LL,
        0xDu,
        &v16);
