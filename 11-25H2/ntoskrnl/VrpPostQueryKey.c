/*
 * XREFs of VrpPostQueryKey @ 0x140948380
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E0A400 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)word_1400577BA,
      &ActivityId,
      0LL,
      5u,
      &UserData);
...
LABEL_33:
      if ( (unsigned int)dword_140E0A400 > 2 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E0A400,
          (unsigned __int8 *)byte_140057755,
          &ActivityId,
          0LL,
          5u,
          &UserData);
  ...
  *(_DWORD *)(a1 + 24) = v6;
  ...
  if ( (unsigned int)dword_140E0A400 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EtwWriteTransfer(qword_140E0A420, &EventDescriptor, &ActivityId, 0LL, 6u, &UserData);
    v3 = v27;
    v7 = v28;
  }
LABEL_5:
