/*
 * XREFs of PpDevCfgInit @ 0x140C13F04
 * Callers:
 ...
 *     PiDrvDbEnumNodes @ 0x14072AB5C (PiDrvDbEnumNodes.c)
...
__int64 PpDevCfgInit()
{
  ...
  *(_DWORD *)(&v18.MaximumLength + 1) = 0;
  ...
  v30 = 17;
  v32 = 1;
  ObjectProperties = PiDevCfgQueryObjectProperties(v1, (int)L"SYSTEM", 7, 0LL, (__int64)&v19, 3u);
  if ( ObjectProperties >= 0 )
  {
    ...
    *(_DWORD *)((char *)&NlsMbCodePageTag + 7) = v11;
    PiDevCfgOptions = v13;
    if ( v11 )
    {
    ...
    if ( (PiDevCfgFlags & 1) != 0 )
    {
      if ( !RtlIsStateSeparationEnabled() || (ObjectProperties = PiDrvDbEnumNodes(), ObjectProperties >= 0) )
      {
        ObjectProperties = PiDmEnumObjectsWithCallback(
                             1u,
                             (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))PiDevCfgInitDeviceCallback,
                             0LL);
        if ( ObjectProperties >= 0 )
        {
          if ( (_BYTE)v9 == 0xFF )
