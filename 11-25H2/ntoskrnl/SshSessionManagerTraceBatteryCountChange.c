/*
 * XREFs of SshSessionManagerTraceBatteryCountChange @ 0x140756BA8
 * Callers:
...
__int64 __fastcall SshSessionManagerTraceBatteryCountChange(int a1, int a2, int a3, char a4)
{
  ...
  v5 = SLEEPSTUDY_EVT_BATTERY_COUNT_CHANGE_CONTROL_EVENT_V1;
  if ( !IsEnabledDeviceUsageNoInline )
    v5 = SLEEPSTUDY_EVT_BATTERY_COUNT_CHANGE_CONTROL_EVENT;
  return SshpSessionManagerSendControlEvent(v5, 4LL, &v7);
}
