/*
 * XREFs of DrvDbOpenContext @ 0x140813828
 * Callers:
 ...
 *     _PnpCtxSetObjectContext @ 0x140807C64 (_PnpCtxSetObjectContext.c)
 *     _PnpCtxSetObjectDispatchCallback @ 0x140807C90 (_PnpCtxSetObjectDispatchCallback.c)
