/*
 * XREFs of PfPrefetchRequestVerify @ 0x1408EA690
 * Callers:
 *     PfpPrefetchRequest @ 0x1408EA470 (PfpPrefetchRequest.c)
 * Callees:
 *     PfPrefetchRequestVerifyRanges @ 0x1408EA348 (PfPrefetchRequestVerifyRanges.c)
 *     PfPrefetchRequestVerifyPath @ 0x1408EAA38 (PfPrefetchRequestVerifyPath.c)
 *     PfPrefetchRequestPrepareForVerify @ 0x1408EAAC4 (PfPrefetchRequestPrepareForVerify.c)
 */
    ...
    else
    {
      ...
      while ( v8 < *(_DWORD *)(a1 + 8) )
      {
        ...
        for ( i = 0; i < *(_DWORD *)(v9 + 40LL * v8 + 12) >> 1; ++i )
        {
          ...
          result = PfPrefetchRequestVerifyRanges(a1, &v25, v19 + 4, (*v19 & 1) != 0 ? 512 : 4096);
          if ( (_DWORD)result )
            return result;
        }
        ++v8;
      ...
      else
      {
        ...
        {
          result = PfPrefetchRequestVerifyRanges(a1, &v25, (unsigned int *)(v23 + 8 * (j + 4LL * j + 3)), 4096);
          if ( (_DWORD)result )
            return result;
        }
        return 0LL;
