/*
 * XREFs of PspCopyAndFixupParameters @ 0x14083C570
 * Callers:
...
__int64 __fastcall PspCopyAndFixupParameters(int a1, unsigned int *a2, __int64 a3)
{
  unsigned int *v4; // rsi
  size_t v5; // r13
  ...
  {
    v23 = ObDuplicateObject(a1, *((_QWORD *)v4 + 2), (_DWORD)Process, (unsigned int)&v30, 0, 0, 6, PreviousMode);
    a1 = v28;
    LODWORD(Process) = (_DWORD)v31;
    PreviousMode = v29;
    if ( v23 >= 0 )
      *((_QWORD *)v4 + 2) = v30;
  }
  if ( a2 )
  {
    ...
    while ( (unsigned int)v25 < 3 )
    {
      ...
      if ( v26 )
      {
        ...
        {
          result = ObDuplicateObject(a1, v26, (_DWORD)Process, (unsigned int)&v30, 0, 0, 6, PreviousMode);
          v27 = v30;
        }
        if ( (int)result >= 0 )
        {
