/*
 * XREFs of PopDiagTraceBatteryAlarmStatus @ 0x140749560
 * Callers:
  ...
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v18 = *(_DWORD *)(v8 + 24);
        v47 = &v18;
        v19 = (unsigned __int8)byte_140F0ABF8;
        v49 = &v19;
        v20 = v9;
        v30 = 4LL;
        v32 = 4LL;
        ...
        LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_1400487F8,
                       0LL,
                       0LL,
                       0xFu,
                       v25);
    ...
    if ( (unsigned int)dword_140F0AAB4 > 1 )
    {
      v10 = qword_140F0AAD0;
      v3 = (unsigned __int64)&qword_140F0AAD0;
      while ( (__int64 *)v10 != &qword_140F0AAD0 )
      {
        ++v5;
        if ( *(_DWORD *)(v10 + 64) )
          v3 = (unsigned __int64)&qword_140F0AAD0;
        if ( (unsigned int)dword_140E07680 > 5 )
        {
          if ( tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140E07680,
              (unsigned __int8 *)word_140048932,
              0LL,
              0LL,
              8u,
              v25);
