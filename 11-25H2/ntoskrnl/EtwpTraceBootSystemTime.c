/*
 * XREFs of EtwpTraceBootSystemTime @ 0x140C2C6E4
 * Callers:
...
char EtwpTraceBootSystemTime()
{
  ...
  {
    LOBYTE(v0) = tlgKeywordOn((__int64)&dword_140E09048, 0x200000000000LL);
    if ( (_BYTE)v0 )
    {
      v7 = KeBootTimeInfo;
      v27 = 8LL;
      ...
      LOBYTE(v0) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&dword_140051A74,
                     0LL,
                     0LL,
                     0xAu,
                     &v25);
