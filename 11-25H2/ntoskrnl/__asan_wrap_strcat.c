/*
 * XREFs of __asan_wrap_strcat @ 0x1405A9DA0
 * Callers:
 *     <none>
 * Callees:
...
ULONG_PTR __fastcall _asan_wrap_strcat(ULONG_PTR BugCheckParameter1, const char *a2)
{
  ...
  do
  {
    if ( v3 == -1 )
      break;
    if ( byte_140FCDC6A && v7 >= 0xFFFF800000000000uLL )
    {
  ...
  do
  {
    if ( v2 == -1 )
      break;
    if ( byte_140FCDC6A && v10 >= 0xFFFF800000000000uLL )
    {
  ...
  v14 = v2 - 1;
  if ( byte_140FCDC6A && v13 >= 0xFFFF800000000000uLL )
  {
    if ( v14 )
    {
