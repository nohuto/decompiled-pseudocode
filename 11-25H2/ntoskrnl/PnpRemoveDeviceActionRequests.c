/*
 * XREFs of PnpRemoveDeviceActionRequests @ 0x14046DDC8
 * Callers:
    ...
    do
    {
      ...
      if ( v3[2] == a1 )
      {
        ...
        *v9 = v5;
        ...
        v13 = KeAcquireSpinLockRaiseToDpc(&qword_140F0D880);
        v14 = dword_140F0D888-- == 1;
        v15 = v13;
        if ( v14 )
          PopDirectedDripsClearDisengageReason(4LL);
        KeReleaseSpinLock(&qword_140F0D880, v15);
        v16 = KeAcquireSpinLockRaiseToDpc(&qword_140F06090);
        ...
        --dword_140F060A0[v12];
        KeReleaseSpinLock(&qword_140F06090, v16);
        v17 = P;
        if ( *(_QWORD ***)P != &v18 )
LABEL_22:
          __fastfail(3u);
