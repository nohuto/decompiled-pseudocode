...
__int64 __fastcall PspBuildCreateProcessContext(_QWORD *a1, char a2, int a3, char *a4)
{
  char v4; // r9
  char *v5; // r14
  char *v6; // r12
  ...
  struct _PROCESSOR_NUMBER *v57; // rax
  ...
  _QWORD *v103; // rax
  __int64 v104; // rdx
  unsigned __int64 *v105; // [rsp+48h] [rbp-220h]
  __int64 v106; // [rsp+58h] [rbp-210h]
  unsigned __int64 v107; // [rsp+58h] [rbp-210h]
  unsigned __int64 v108; // [rsp+58h] [rbp-210h]
  struct _PROCESSOR_NUMBER ProcNumber; // [rsp+60h] [rbp-208h] BYREF
  unsigned __int64 v110; // [rsp+68h] [rbp-200h]
  __int16 v111; // [rsp+70h] [rbp-1F8h]
  int v112; // [rsp+74h] [rbp-1F4h]
  int v113; // [rsp+78h] [rbp-1F0h]
  int v114; // [rsp+7Ch] [rbp-1ECh]
  char *v115; // [rsp+80h] [rbp-1E8h]
  char *v116; // [rsp+88h] [rbp-1E0h]
  char *v117; // [rsp+90h] [rbp-1D8h]
  __int64 v118; // [rsp+A0h] [rbp-1C8h]
  __int64 v119; // [rsp+A8h] [rbp-1C0h] BYREF
  char *v120; // [rsp+B0h] [rbp-1B8h]
  char *v121; // [rsp+B8h] [rbp-1B0h]
  const void *v122; // [rsp+C0h] [rbp-1A8h]
  __int64 v123; // [rsp+C8h] [rbp-1A0h]
  char *v124; // [rsp+D0h] [rbp-198h]
  _DWORD *v125; // [rsp+E0h] [rbp-188h]
  _BYTE *v126; // [rsp+E8h] [rbp-180h]
  char *v127; // [rsp+F0h] [rbp-178h]
  char *v128; // [rsp+F8h] [rbp-170h]
  unsigned __int64 v129; // [rsp+100h] [rbp-168h]
  unsigned __int64 v130; // [rsp+108h] [rbp-160h]
  unsigned __int64 v131; // [rsp+110h] [rbp-158h]
  _QWORD *v132; // [rsp+118h] [rbp-150h]
  _DWORD *v133; // [rsp+120h] [rbp-148h]
  _DWORD *v134; // [rsp+128h] [rbp-140h]
  unsigned __int64 v135; // [rsp+130h] [rbp-138h]
  char *v136; // [rsp+138h] [rbp-130h]
  unsigned __int16 *v137; // [rsp+140h] [rbp-128h]
  unsigned __int64 v138; // [rsp+148h] [rbp-120h]
  struct _PROCESSOR_NUMBER *v139; // [rsp+150h] [rbp-118h]
  _OWORD *v140; // [rsp+158h] [rbp-110h]
  unsigned __int64 v141; // [rsp+160h] [rbp-108h]
  _DWORD *v142; // [rsp+168h] [rbp-100h]
  const void *v143; // [rsp+170h] [rbp-F8h]
  char *v144; // [rsp+180h] [rbp-E8h]
  _QWORD *v145; // [rsp+188h] [rbp-E0h]
  unsigned __int64 v146; // [rsp+190h] [rbp-D8h]
  __int64 v147; // [rsp+198h] [rbp-D0h]
  void *v148; // [rsp+1A0h] [rbp-C8h]
  __int64 v149; // [rsp+1A8h] [rbp-C0h]
  __int128 v150; // [rsp+1B0h] [rbp-B8h] BYREF
  __int64 v151; // [rsp+1C0h] [rbp-A8h]
  __int128 v152; // [rsp+1D0h] [rbp-98h] BYREF
  __int64 v153; // [rsp+1E0h] [rbp-88h]
  __int128 v154; // [rsp+1F0h] [rbp-78h] BYREF
  __int64 v155; // [rsp+200h] [rbp-68h]
  __int128 v156; // [rsp+208h] [rbp-60h] BYREF
  __int64 v157; // [rsp+218h] [rbp-50h]
  int v159; // [rsp+280h] [rbp+18h]
...
LABEL_36:
  ...
  if ( *a1 < 0x28uLL )
    return 3221225485LL;
  if ( a2 && v106 != 40 && ((unsigned __int8)a1 & 3) != 0 )
    ExRaiseDatatypeMisalignment();
  v107 = v106 - 8;
  if ( (v107 & 0x1F) != 0 )
    return 3221225485LL;
  ...
  while ( 1 )
  {
    ...
    if ( a3 && (v8 & 0x10000) == 0
      || (v8 & 0x20000) != 0 && v7[3]
      || (v147 = 1LL << v8, v9 = *((_QWORD *)v5 + 1), (v9 & (1LL << v8)) != 0) )
    {
LABEL_47:
      v17 = -1073741811;
      goto LABEL_315;
    ...
    if ( v8 > 0x20016 )
    {
      if ( v8 <= 0x3001E )
      {
        if ( v8 == 196638 )
        {
          ...
          v104 = *v103;
          *((_QWORD *)v5 + 60) = *v103;
          v149 = MEMORY[0xFFFFF780000003D8] | MEMORY[0xFFFFF78000000708];
          if ( (~(MEMORY[0xFFFFF780000003D8] | MEMORY[0xFFFFF78000000708]) & v104) != 0 )
            goto LABEL_47;
          *((_QWORD *)v5 + 60) = v104 & 0x40000;
        }
        else
        {
          v36 = v8 - 131095;
          if ( !v36 )
          {
            ...
            v101 = (char *)v7[2];
            v144 = v101;
            if ( v4 && ((unsigned __int64)(v101 + 524) > 0x7FFFFFFF0000LL || v101 + 524 < v101) )
            {
              v7 = v105;
              v100 = 524LL;
              v101 = v144;
          ...
          if ( !v37 )
          {
            ...
            v86 = (void *)ExAllocatePool2(0x41uLL);
            *((_QWORD *)v5 + 51) = v86;
            if ( !v86 )
              goto LABEL_191;
            v113 = 0;
            ...
            *(_QWORD *)(*((_QWORD *)v5 + 51) + 24LL) = 0LL;
            ...
            if ( (_WORD)v91 )
            {
              if ( *(_WORD *)v88 > (unsigned __int16)v91
                || (((unsigned __int16)v91 | *(_WORD *)v88) & 1) != 0
                || (_WORD)v91 == 0xFFFF
                || !v89 )
              {
                goto LABEL_47;
            ...
            v93 = *(unsigned int *)(*((_QWORD *)v5 + 51) + 16LL);
            v94 = *((_QWORD *)v5 + 51);
            if ( (_DWORD)v93 )
            {
            ...
            v97 = 0LL;
            v124 = 0LL;
            if ( *(_WORD *)(v88 + 2) || *(_DWORD *)(v94 + 16) )
            {
              v97 = (char *)ExAllocatePool2(0x41uLL);
              v124 = v97;
            }
          ...
          if ( v38 )
          {
            ...
            if ( !v39 )
            {
              ...
              if ( v4 )
              {
                ...
                RtlCopyVolatileMemory(&v156, (const void *)v80, v79);
              }
              else
              {
                memmove(&v156, (const void *)v80, v79);
              }
              v81 = v156;
              v152 = v156;
              v82 = v157;
              v153 = v157;
              v17 = PspValidateMitigationAuditOptions(&v152);
              if ( v17 < 0 )
                goto LABEL_315;
              *((_OWORD *)v5 + 28) = v81;
              *((_QWORD *)v5 + 58) = v82;
            ...
            if ( v40 )
            {
              ...
              if ( v56 != 2 || !a3 || v7[1] != 4 )
                goto LABEL_47;
              v57 = (struct _PROCESSOR_NUMBER *)v7[2];
              v139 = v57;
              if ( v4 )
              {
          ...
          if ( v19 )
          {
            ...
            if ( v20 )
            {
              ...
              if ( v35 )
              {
                ...
                if ( v51 )
                {
                  if ( v51 != 3 || v7[1] != 4 || (v7[2] & 0xFFFFFFFFFFFFFFF8uLL) != 0 )
                    goto LABEL_47;
              ...
              else
              {
                if ( v7[1] != 1 )
                  goto LABEL_47;
                v5[17] = v5[17] & 0x7F | (v7[2] != 0 ? 0x80 : 0);
              }
            }
            else
            {
...
LABEL_68:
      ...
      if ( !v27 )
      {
        ...
        if ( v4 )
        {
          ...
          RtlCopyVolatileMemory(&v154, (const void *)v29, v28);
        }
        else
        {
          memmove(&v154, (const void *)v29, v28);
        }
        v30 = v154;
        v150 = v154;
        v31 = v155;
        v151 = v155;
        v17 = PspValidateMitigationOptions(&v150, 0LL);
        if ( v17 < 0 )
          goto LABEL_315;
        *((_OWORD *)v5 + 21) = v30;
        *((_QWORD *)v5 + 44) = v31;
      ...
      if ( !v46 )
      {
        ...
        *((_DWORD *)v5 + 95) = v47 >> 3;
        ...
        while ( v50 < *((unsigned int *)v5 + 95) )
        {
          ...
          if ( v17 < 0 )
            goto LABEL_315;
          *(_QWORD *)(*((_QWORD *)v5 + 46) + 8 * v50++) = v119;
          v135 = v50;
        }
        goto LABEL_130;
      }
...
LABEL_19:
  ...
  if ( v4 )
  {
    if ( (v75 & 3) != 0 )
      ExRaiseDatatypeMisalignment();
    if ( v75 + 8 > 0x7FFFFFFF0000LL || v75 + 8 < v75 )
    {
      v7 = v105;
      v75 = v138;
    }
  }
  v76 = (_QWORD *)ExAllocatePool2(0x41uLL);
  *((_QWORD *)v5 + 54) = v76;
  if ( v76 )
  {
    *v76 = *(_QWORD *)v75;
    v77 = (_DWORD *)*((_QWORD *)v5 + 54);
    if ( (*v77 & 3) == 0 || (unsigned int)(v77[1] - 1) > 5 )
      goto LABEL_47;
    goto LABEL_67;
  }
  v17 = -1073741801;
