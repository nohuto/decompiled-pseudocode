/*
 * XREFs of VmpFlushTb @ 0x14032CFF0
 * Callers:
...
unsigned __int64 __fastcall VmpFlushTb(PEX_SPIN_LOCK SpinLock, unsigned int a2, unsigned __int64 *a3)
{
  ...
  unsigned int v34; // [rsp+F8h] [rbp+6Fh] BYREF
  ...
  if ( !a2 )
  {
    ...
    v4 = (unsigned int *)((char *)KeGetCurrentPrcb()->VmInternal + 4608);
    ...
    do
    {
      ...
      if ( !*((_QWORD *)&v27 + 1) )
        break;
      VmpInsertInvalidateListRange((__int64)SpinLock, v4, v27, result, *((unsigned __int64 *)&v27 + 1), v34);
      result = VmpInvalidateOutstandingFaults((__int64)SpinLock, v10, v9);
      v5 += v9;
      if ( v5 >= 0x40000 )
      {
        if ( *((_QWORD *)v4 + 1) )
          VmpProcessInvalidateList((__int64)SpinLock, (__int64)v4);
        ...
        v4 = (unsigned int *)(*(_QWORD *)(result + 35664) + 4608LL);
      }
    }
    while ( v26 );
    goto LABEL_5;
      ...
      if ( (unsigned __int64)++a3 >= result )
      {
        if ( v12 )
        {
          ...
          do
          {
            ...
            if ( !*((_QWORD *)&v29 + 1) )
              break;
            VmpInsertInvalidateListRange((__int64)SpinLock, v4, v29, result, *((unsigned __int64 *)&v29 + 1), v34);
            result = VmpInvalidateOutstandingFaults((__int64)SpinLock, v18, v17);
            v5 += v17;
            if ( v5 >= 0x40000 )
            {
              if ( *((_QWORD *)v4 + 1) )
      ...
      *((_QWORD *)&v29 + 1) = v12;
      do
      {
        ...
        *(_QWORD *)&v27 = v19;
        if ( !*((_QWORD *)&v28 + 1) )
          break;
        VmpInsertInvalidateListRange((__int64)SpinLock, v4, v28, v19, *((unsigned __int64 *)&v28 + 1), v34);
        VmpInvalidateOutstandingFaults((__int64)SpinLock, v27, v20);
        v5 += v20;
        if ( v5 >= 0x40000 )
        {
          if ( *((_QWORD *)v4 + 1) )
