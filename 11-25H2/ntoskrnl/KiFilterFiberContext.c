/*
 * XREFs of KiFilterFiberContext @ 0x140BCE530
 * Callers:
...
_BOOL8 __fastcall KiFilterFiberContext(__int64 a1)
{
  ...
  if ( !*(_QWORD *)&MaxDataSize && !a1 && !__2c )
  {
    if ( PsIntegrityCheckEnabled )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      {
        ExNotifyCallback(CallbackObject, sub_140507C90, &__24);
        ObfDereferenceObject(CallbackObject);
        if ( __24 )
          __2c = 1;
        ExInitializeNPagedLookasideList(&stru_140E0F080, 0LL, 0LL, 0x200u, 0xB38uLL, 0x746E494Bu, 0);
      }
    }
  }
  v6 = __rdtsc();
  ...
  *(_QWORD *)&v7 = __rdtsc();
  ...
  Parameter[1] = v11;
  Parameter[0] = v9 % 0xD;
  v12 = KeExpandKernelStackAndCallout(sub_140BF7680, Parameter, 0xC000uLL);
  v13 = v31;
  if ( v12 < 0 )
    v13 = 0;
  v31 = v13;
  if ( v13 )
  {
    ...
    v34 = 0;
    v35 = 0;
    v19 = KeExpandKernelStackAndCallout(sub_140BF7680, v32, 0xC000uLL);
    v20 = v35;
    if ( v19 < 0 )
      v20 = 0;
    v35 = v20;
...
LABEL_30:
      ...
      v39 = 0;
      v38 = (v21 >> 31) & 8;
      v22 = KeExpandKernelStackAndCallout(sub_140BF7680, v36, 0xC000uLL);
      v23 = v39;
      if ( v22 < 0 )
        v23 = 0;
      v39 = v23;
