/*
 * XREFs of MiUpdateLargePageBitMap @ 0x14038D1D8
 * Callers:
 ...
 *     MiMarkLargePagePte @ 0x140C3EC50 (MiMarkLargePagePte.c)
...
LABEL_11:
        if ( v10 )
          MiReleaseSpinLockExclusive(&dword_140E2EB80, v53);
        return;
      }
...
LABEL_19:
      if ( !v10 )
      {
        v10 = 1;
        if ( (a4 & 4) != 0 )
          ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140E2EB80);
        else
          v53 = ExAcquireSpinLockExclusive(&dword_140E2EB80);
      }
      if ( v6 )
