/*
 * XREFs of DifZwCloseObjectAuditAlarmWrapper @ 0x140630E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCloseObjectAuditAlarmWrapper(
        ...
        BOOLEAN GenerateOnClose)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(130);
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = SubsystemName;
    *(_QWORD *)&v16 = HandleId;
    BYTE8(v15) = GenerateOnClose;
  ...
  LODWORD(v17) = ZwCloseObjectAuditAlarm(SubsystemName, HandleId, GenerateOnClose);
  if ( v7 )
  {
