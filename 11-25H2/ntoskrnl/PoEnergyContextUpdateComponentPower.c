/*
 * XREFs of PoEnergyContextUpdateComponentPower @ 0x140962FE8
 * Callers:
 ...
 *     RtlTimelineBitmapUpdate @ 0x1403F8D80 (RtlTimelineBitmapUpdate.c)
 ...
 *     RtlStateDurationUpdate @ 0x14048F250 (RtlStateDurationUpdate.c)
...
void *__fastcall PoEnergyContextUpdateComponentPower(signed __int64 *a1, int a2, __int64 a3)
{
      ...
      if ( v9 )
      {
        ...
        if ( v10 )
        {
          ...
          if ( !v24 )
          {
            v51[1] = HIDWORD(a3);
            v51[0] = v4;
            PopEtEnergyContextSetState((__int64)a1, v51);
            return (void *)PopReleaseRwLock(v8);
          }
          if ( v24 != 1 )
            return (void *)PopReleaseRwLock(v8);
        ...
        v30 = *(_WORD *)(v3 + 472);
        v31 = v28;
        v32 = (unsigned int *)(v3 + 312);
        if ( v4 )
        {
          *(_WORD *)(v3 + 472) = v30 | 2;
          v33 = v28;
LABEL_49:
          RtlTimelineBitmapUpdate(v32, v33);
LABEL_50:
          PopEtEnergyContextProcessStateUpdate(a1);
          return (void *)PopReleaseRwLock(v8);
        }
        *(_WORD *)(v3 + 472) = v30 & 0xFFFD;
        v43 = v28;
      }
      else
      {
        ...
        v43 = v34;
        *(_WORD *)(v3 + 472) = v35 & 0xFFFE;
        v31 = v34;
      }
      RtlTimelineBitmapUpdateRange((__int64 *)v32, v43 - (v29 >> 12), v31);
      goto LABEL_50;
    }
    v36 = v4 != 0;
    if ( a2 == 11 )
