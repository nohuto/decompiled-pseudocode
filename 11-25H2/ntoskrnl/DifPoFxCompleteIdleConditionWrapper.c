/*
 * XREFs of DifPoFxCompleteIdleConditionWrapper @ 0x14062B120
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxCompleteIdleConditionWrapper(_QWORD *BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
