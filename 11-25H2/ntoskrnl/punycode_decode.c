/*
 * XREFs of punycode_decode @ 0x1407755EC
 * Callers:
 *     RtlpIdnToUnicodeWorker @ 0x1405E261C (RtlpIdnToUnicodeWorker.c)
 * Callees:
 *     _wcsnicmp @ 0x1404FBD70 (_wcsnicmp.c)
 *     FindLabelEnd @ 0x1405E2584 (FindLabelEnd.c)
 *     InsertChar @ 0x1405E25F4 (InsertChar.c)
 *     ValidateStd3Range @ 0x1405E2C34 (ValidateStd3Range.c)
 *     adapt @ 0x1405E2C70 (adapt.c)
 */
