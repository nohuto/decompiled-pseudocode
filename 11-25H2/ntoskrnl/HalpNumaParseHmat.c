...
LABEL_8:
    ...
    while ( v13 + 8 <= v18 )
    {
      ...
      if ( (unsigned int)v21 < 8 || v13 + v21 > v18 )
        break;
      if ( *(_BYTE *)(v34 + 8) >= 2u || *(_WORD *)v13 > 1u )
      {
        if ( *(_WORD *)v13 )
        {
          if ( *(_WORD *)v13 == 1 )
          {
            v22 = *(_DWORD *)(v13 + 12);
            HIDWORD(Size) = *(_DWORD *)(v13 + 16);
            if ( (int)HalpNumaCalculateSllbiSize(v22, HIDWORD(Size), (int *)&v31) < 0 )
              goto LABEL_38;
            v24 = v31;
            *v16 = v31;
...
LABEL_38:
        ...
        else
        {
          ...
          v27 = *(_WORD *)v11;
          v29 = v17;
          *(_WORD *)v11 = v26 ^ (*(_WORD *)(v13 + 8) ^ v27) & 1;
          v11[1] = *(_DWORD *)(v13 + 12);
          v11[2] = *(_DWORD *)(v13 + 16);
          v11 += 3;
          v32 = v11;
