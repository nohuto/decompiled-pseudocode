/*
 * XREFs of PpmCheckSnapAllDeliveredPerformance @ 0x1403AFD80
 * Callers:
...
LABEL_14:
  ...
  while ( 1 )
  {
    if ( v10 )
    {
      ...
      v33 = v10 & ~(1LL << v12);
      v13 = *((unsigned int *)qword_140F216A8 + 64 * v35 + (unsigned __int8)v12);
  ...
  for ( m = 0; ; v22 = v38[m] )
  {
    while ( v22 )
    {
      ...
      v34 = v22 & ~(1LL << v23);
      Prcb = KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * m + (unsigned __int8)v23));
