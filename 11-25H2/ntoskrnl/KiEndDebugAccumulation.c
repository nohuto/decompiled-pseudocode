/*
 * XREFs of KiEndDebugAccumulation @ 0x1404F10F0
 * Callers:
 *     KeThawExecution @ 0x1404F0C00 (KeThawExecution.c)
 *     KiFreezeTargetExecution @ 0x1405BDC20 (KiFreezeTargetExecution.c)
 * Callees:
 *     KeQueryPerformanceCounter @ 0x14031B970 (KeQueryPerformanceCounter.c)
 *     KiAccumulateTicksFromCycles @ 0x1403DF0E0 (KiAccumulateTicksFromCycles.c)
 *     KiAccumulateProcessorCycleStats @ 0x1403EBBC0 (KiAccumulateProcessorCycleStats.c)
