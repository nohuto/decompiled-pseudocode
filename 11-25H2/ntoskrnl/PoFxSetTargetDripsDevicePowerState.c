/*
 * XREFs of PoFxSetTargetDripsDevicePowerState @ 0x140A6F990
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v15 = 0x1000000LL;
    v27 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_14004816D, 0LL, 0LL, 7u, &v17);
  }
  return (unsigned int)v6;
}
