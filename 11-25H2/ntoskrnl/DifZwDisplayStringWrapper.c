/*
 * XREFs of DifZwDisplayStringWrapper @ 0x140633260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDisplayStringWrapper(PUNICODE_STRING String)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(109);
  ...
  LODWORD(v12) = ZwDisplayString(String);
  if ( v3 )
  {
