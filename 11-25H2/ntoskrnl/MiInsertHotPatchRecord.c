/*
 * XREFs of MiInsertHotPatchRecord @ 0x1407E34B8
 * Callers:
...
__int64 __fastcall MiInsertHotPatchRecord(unsigned __int64 *a1, __int64 a2, int a3)
{
  ...
  else
  {
    ...
    v9 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140E37250, 0LL);
    v10 = v8;
    if ( v9 )
      ExfAcquirePushLockExclusiveEx(&qword_140E37250, v8, (__int64)&qword_140E37250);
    if ( v10 )
      *((_BYTE *)v10 + 10) = 1;
  }
  v11 = *a1;
