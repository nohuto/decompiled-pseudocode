/*
 * XREFs of MiInPageSingleKernelStack @ 0x14046BDAC
 * Callers:
...
_QWORD *__fastcall MiInPageSingleKernelStack(ULONG_PTR BugCheckParameter3, __int64 *a2)
{
  ...
  v7 = 0LL;
  v33 = (ULONG *)*((_QWORD *)qword_140E2FD48 + *(unsigned __int16 *)(*(_QWORD *)(v3 + 544) + 1198LL));
  ...
  if ( (unsigned __int64)v14 <= v6 )
  {
    ...
    v3 = BugCheckParameter3;
    if ( v7 > 1 )
      MiPrefetchVirtualMemory(v7, (__int64)&v42, 1LL, 45);
    v14 = (_QWORD *)v31;
  }
  v18 = 0LL;
  v43 = 4096LL;
      ...
      if ( v23 != 17 )
      {
        ...
        if ( v22 == *(_QWORD *)v6 )
        {
          ...
          *(_DWORD *)(v24 + 32) = v29;
          ...
          if ( v26 )
            MiReleasePageFileInfo((__int64)v33, v26, 0);
          v6 -= 8LL;
          v3 = BugCheckParameter3;
          v19 -= 4096LL;
          v14 = (_QWORD *)v31;
