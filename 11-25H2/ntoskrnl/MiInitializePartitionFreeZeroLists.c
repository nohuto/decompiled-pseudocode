/*
 * XREFs of MiInitializePartitionFreeZeroLists @ 0x1407DCF4C
 * Callers:
 ...
 *     MiColorSetHighLow @ 0x140462188 (MiColorSetHighLow.c)
 *     MiInitializeFreeZeroPfnListHead @ 0x140667854 (MiInitializeFreeZeroPfnListHead.c)
 */
...
__int64 __fastcall MiInitializePartitionFreeZeroLists(_QWORD *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v5 )
      break;
    v7 = (unsigned int)dword_140E2D98C;
    v8 = (_QWORD *)(v4 + 5120);
    v9 = 4LL;
    v10 = 8LL * (unsigned int)dword_140E2D98C;
    do
    {
      *v8 = v2;
      v2 += v10;
