/*
 * XREFs of DifZwQueryInformationEnlistmentWrapper @ 0x140638E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationEnlistmentWrapper(
        void *a1,
        ENLISTMENT_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(51);
  ...
  LODWORD(v19) = ZwQueryInformationEnlistment(a1, a2, a3, a4, ReturnLength);
  if ( v9 )
  {
