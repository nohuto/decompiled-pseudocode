/*
 * XREFs of PopFxStopDeviceAccounting @ 0x1404266B8
 * Callers:
...
void __fastcall PopFxStopDeviceAccounting(unsigned __int64 a1)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v29; // [rsp+D8h] [rbp-30h] BYREF
  ...
  if ( PopFxAccountingGroup )
  {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&PopFxDeviceListLock, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&PopFxDeviceListLock, 0, v4, (unsigned __int64)&PopFxDeviceListLock);
    if ( v4 )
      *((_BYTE *)v4 + 10) = 1;
    ...
    v14 = qword_140F0CE90;
    v15 = qword_140F0CE98;
    v42[0] = xmmword_140F0CEA0;
    v42[1] = xmmword_140F0CEB0;
    v43 = qword_140F0CEC0;
    v44[0] = xmmword_140F0CEC8;
    v44[1] = xmmword_140F0CED8;
    v45 = qword_140F0CEE8;
    KeReleaseSpinLock(&PopFxGlobalDeviceAccountingLock, v13);
    if ( (unsigned int)dword_140E076B8 > 5 && !PopDiagFxAccountingTelemetryDisabled )
    {
      if ( (qword_140E076C8 & 0x400000000000LL) == 0 || (qword_140E076D0 & 0x400000000000LL) != qword_140E076D0 )
        v2 = 0;
      if ( v2 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&word_140049A1E,
          0LL,
          0LL,
          8u,
          &v29);
