/*
 * XREFs of TtmiLogSessionMonitorControl @ 0x140A2DAA8
 * Callers:
...
void TtmiLogSessionMonitorControl()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v4 = v3;
    v5 = v2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&word_14004F06E, 0LL, 0LL, 6u, &v8);
  }
}
