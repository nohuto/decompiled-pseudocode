/*
 * XREFs of DifKeAcquireSpinLockRaiseToDpcWrapper @ 0x140620CE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeAcquireSpinLockRaiseToDpcWrapper(PKSPIN_LOCK SpinLock)
{
  ...
  LOBYTE(v12) = KeAcquireSpinLockRaiseToDpc(SpinLock);
  if ( v3 )
  {
