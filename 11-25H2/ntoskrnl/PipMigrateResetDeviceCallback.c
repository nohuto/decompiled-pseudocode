/*
 * XREFs of PipMigrateResetDeviceCallback @ 0x140C109C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall PipMigrateResetDeviceCallback(__int64 a1, const WCHAR *a2)
{
  int v4; // eax
  ...
  {
    v8 = 4;
    if ( (int)CmGetDeviceRegProp(a1, a2, 0LL, 0xBu, (__int64)&v7, (__int64)&v6, (__int64)&v8, 0) >= 0
      && v7 == 4
      && v8 == 4 )
    {
      v4 = v6;
