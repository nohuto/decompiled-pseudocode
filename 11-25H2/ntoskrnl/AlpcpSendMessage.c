/*
 * XREFs of AlpcpSendMessage @ 0x1408B0BA0
 * Callers:
...
LABEL_37:
  ...
  if ( !v18 )
  {
    ...
    *((_QWORD *)v40 + 3) = 1LL;
    ...
    if ( v40 == (char *)-48LL )
      return 3221225626LL;
    v42 = KeAbPreAcquire((__int64)(v40 + 32), 0LL);
    v43 = v42;
...
LABEL_72:
      ...
      if ( v69 != v6 )
      {
        ...
        {
          v76 = *(_QWORD **)(v36 + 16);
          v77 = KeAbPreAcquire((__int64)(v76 - 2), 0LL);
          if ( _InterlockedCompareExchange64(v76 - 2, 17LL, 0LL) )
            ExfAcquirePushLockSharedEx(v76 - 2, 0, v77, (unsigned __int64)(v76 - 2));
          if ( v77 )
            *((_BYTE *)v77 + 10) = 1;
          v37 = v86;
...
LABEL_73:
            if ( *(_QWORD *)(v28 + 32) )
            {
              ...
              if ( !*(_QWORD *)(v28 + 48) && (v83 & 0x30000) == 0 )
              {
                ...
                v34 = AlpcpChargePagedPoolQuota(KeGetCurrentThread()->ApcState.Process, v39);
                v82 = v34;
                if ( v34 < 0 )
                  goto LABEL_79;
...
LABEL_95:
              ...
              if ( v18 )
              {
                ...
                if ( (v60 & 0x280) != 0 )
                {
                  ...
                  if ( v48 )
                    AlpcpReleaseAttributes(v47);
                  AlpcpCancelMessage(v37, v28, 0x10000);
                  return v61;
                }
              }
              if ( v34 >= 0 )
                ...
                else
                {
                  *(_QWORD *)(v28 + 176) = v53;
                  ...
                  if ( v20 >= 0 )
                  {
                    v59 = v89;
                    *(_QWORD *)(v89 + 8) = v28;
                    *(_DWORD *)(v59 + 52) = *(__int32 *)((char *)v84.m256i_i32 + 2);
                    *(_WORD *)(v59 + 56) = v84.m256i_i16[3];
                    if ( !*(_QWORD *)(v28 + 24) )
                      return AlpcpDispatchNewMessage((__int64 *)v59);
                    if ( *(_QWORD *)(v28 + 32) )
                      return AlpcpDispatchReplyToWaitingThread();
                    return AlpcpDispatchReplyToPort(v59);
                  }
                }
                AlpcpUnlockMessage(v28);
