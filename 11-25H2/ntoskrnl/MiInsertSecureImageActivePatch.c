/*
 * XREFs of MiInsertSecureImageActivePatch @ 0x1407E3770
 * Callers:
...
LABEL_2:
  ...
  if ( qword_140E37248 )
  {
    while ( 1 )
    {
      ...
      if ( v5 <= 0 )
      {
        ...
        {
          v1 = v4;
          RtlAvlRemoveNode((unsigned __int64 *)&qword_140E37248, (__int64)v4);
          goto LABEL_2;
        }
        v6 = (_QWORD *)*v4;
        if ( !*v4 )
  ...
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140E37248, (unsigned __int64)v4, v3, a1);
  if ( v1 )
