/*
 * XREFs of MiIterateOverPartitions @ 0x140474618
 * Callers:
...
__int64 __fastcall MiIterateOverPartitions(__int64 a1, __int64 a2)
{
  ...
  while ( 2 )
  {
    v4 = qword_140E2FD28->SizeOfBitMap - 1;
    v5 = ((__int64)qword_140E2FD28->Buffer & 4) != 0LL ? 0x20 : 0;
    v6 = v2 < qword_140E2FD28->SizeOfBitMap ? v2 : 0;
    v7 = (char *)qword_140E2FD28->Buffer - (((__int64)qword_140E2FD28->Buffer & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v8 = v5 + v4;
      v9 = v5 + v6;
...
LABEL_17:
      if ( !v6 )
        goto LABEL_11;
      SizeOfBitMap = v2 + 1;
      if ( v2 + 1 > qword_140E2FD28->SizeOfBitMap )
...
LABEL_11:
    ...
    {
      v2 = v13 + 1;
      v14 = *((_QWORD *)qword_140E2FD48 + v13);
      if ( (*(_DWORD *)(v14 + 4) & 2) != 0 )
