/*
 * XREFs of Pdcv2ActivationClientRenewActivation @ 0x14077E860
 * Callers:
 ...
 *     Pdcv2EventWrite_ACTIVATION_CLIENT_RENEW_ACTIVATION @ 0x1405FBA60 (Pdcv2EventWrite_ACTIVATION_CLIENT_RENEW_ACTIVATION.c)
