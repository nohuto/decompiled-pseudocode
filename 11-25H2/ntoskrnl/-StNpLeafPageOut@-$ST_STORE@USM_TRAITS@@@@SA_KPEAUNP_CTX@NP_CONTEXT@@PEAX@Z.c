/*
 * XREFs of ?StNpLeafPageOut@?$ST_STORE@USM_TRAITS@@@@SA_KPEAUNP_CTX@NP_CONTEXT@@PEAX@Z @ 0x1406006A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StNpLeafPageOut(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(v4 + 56) & 1) == 0 )
    B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT,B_TREE_KEY_COMPARATOR<_SM_PAGE_KEY>>::BTreeSearchResultDeref(
      *(struct NP_CONTEXT ***)(*(_QWORD *)a1 + 128LL),
      v4 + 24);
  *(_DWORD *)(v4 + 56) |= 1u;
  do
  {
  ...
  v11 = 4 * v5;
  v13 = v7;
  if ( (int)ST_STORE<SM_TRAITS>::StDmpSinglePageAdd(v4, (int *)v10, 0LL, &v13) >= 0 )
    return 4 * v5;
  return v8;
}
