/*
 * XREFs of SLUpdateLicenseDataInternal @ 0x1407AAD54
 * Callers:
 ...
 *     ExpReducedLicenseData @ 0x140A9AB50 (ExpReducedLicenseData.c)
...
LABEL_150:
  ...
  *(_OWORD *)MappedBase = *(_OWORD *)a3;
  ...
  v64 = sub_1407A9D6C((__int64)v27, 1, 0LL, 0, (unsigned int *)&NumOfElements);
  if ( v64 != -1073741789 )
  {
    v7 = 0LL;
    goto LABEL_80;
...
LABEL_11:
  ...
  v64 = sub_1407A9D6C((__int64)MappedBase, 0, Pool2, NumOfElements, 0LL);
  if ( v64 >= 0 )
    qsort(v7, v32, 0x10uLL, (int (__cdecl *)(const void *, const void *))sub_1407A9880);
LABEL_80:
  if ( v64 < 0 )
  {
    v6 = v70;
  ...
  if ( !v76 )
  {
    ...
    {
      v37 = (char *)Src + 16 * v35;
      v38 = sub_1407A9880(v37, (_QWORD *)(a1 + 16LL * v36 + 24));
      v88 = v38;
      v39 = v37[1];
      v90 = v39;
