/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x140772A40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlpFcConvertFeatureConfigurationsInternalToExternal @ 0x1404F8D18 (RtlpFcConvertFeatureConfigurationsInternalToExternal.c)
 */
        ...
        PSIZE_T ConfigurationCount)
{
  ...
  RtlpFcBufferManagerReferenceBuffers((__int64)&unk_140EF6BE8, (__int64)v16, &v15);
...
LABEL_8:
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)&unk_140EF6BE8, v9);
  return v10;
}
