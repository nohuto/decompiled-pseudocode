/*
 * XREFs of DifRtlOemStringToCountedUnicodeStringWrapper @ 0x14062DDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlOemStringToCountedUnicodeStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(161);
  ...
  LODWORD(v17) = RtlOemStringToCountedUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
