/*
 * XREFs of PpmInfoAdjustSetting @ 0x140A2F07C
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x140965708 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x1404CA5D0 (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x140A2F130 (PpmInfoWriteData.c)
 */
