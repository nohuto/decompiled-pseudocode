/*
 * XREFs of MinCrypK_VerifySignedDataKModeEx @ 0x140816A74
 * Callers:
 ...
 *     MincryptIsTimestampBeforeRevocation @ 0x140815F64 (MincryptIsTimestampBeforeRevocation.c)
 ...
 *     I_MinCryptGetPlatformManifestBinaryIDAttribute @ 0x14081639C (I_MinCryptGetPlatformManifestBinaryIDAttribute.c)
 ...
 *     I_MinCryptBuildErrorPolicy @ 0x1408176F0 (I_MinCryptBuildErrorPolicy.c)
 *     I_MincryptFreeChainInfo @ 0x140817AE8 (I_MincryptFreeChainInfo.c)
 *     MinAsn1ExtractContent @ 0x1408184BC (MinAsn1ExtractContent.c)
 *     MinAsn1SignedDataGetContent @ 0x14081889C (MinAsn1SignedDataGetContent.c)
        ...
        char *a7)
{
  ...
  if ( (int)MinAsn1ParseSignedData(a1, a2, Pool2 + 2400) < 0 )
    goto LABEL_4;
  if ( *(_DWORD *)(v13 + 32) != 9 || RtlCompareMemory(qword_140B2C5A0, *(const void **)(v13 + 40), 9uLL) != 9 )
    goto LABEL_55;
  v14 = v30;
