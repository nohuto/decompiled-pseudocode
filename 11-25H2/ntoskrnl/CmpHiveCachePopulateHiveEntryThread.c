/*
 * XREFs of CmpHiveCachePopulateHiveEntryThread @ 0x1407D5AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CmpHiveCachePopulateHiveEntryThread(PPRIVILEGE_SET Privileges)
{
  ...
  char v25[7]; // [rsp+79h] [rbp-8h] BYREF
  __int64 v26; // [rsp+80h] [rbp-1h] BYREF
  ULONG PrivilegeCount; // [rsp+88h] [rbp+7h]
  int v28; // [rsp+8Ch] [rbp+Bh] BYREF
  PPRIVILEGE_SET v29; // [rsp+90h] [rbp+Fh]
  ULONG v30; // [rsp+98h] [rbp+17h]
  __int64 v31; // [rsp+A0h] [rbp+1Fh] BYREF
  __int128 v32; // [rsp+A8h] [rbp+27h] BYREF
