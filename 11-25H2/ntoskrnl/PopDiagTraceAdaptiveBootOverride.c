/*
 * XREFs of PopDiagTraceAdaptiveBootOverride @ 0x140C1E064
 * Callers:
...
void __fastcall PopDiagTraceAdaptiveBootOverride(int a1, char a2)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v6 = 0x1000000LL;
    v19 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)&word_14004ACCE, 0LL, 0LL, 5u, &v11);
  }
}
