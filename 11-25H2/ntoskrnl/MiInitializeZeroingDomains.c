/*
 * XREFs of MiInitializeZeroingDomains @ 0x1407EF6CC
 * Callers:
 ...
 *     MiGetProcessorDomain @ 0x1404DAD6C (MiGetProcessorDomain.c)
 *     MiGetEngineType @ 0x1404F5E7C (MiGetEngineType.c)
 *     MiGetNodeBaseDomain @ 0x14067A170 (MiGetNodeBaseDomain.c)
