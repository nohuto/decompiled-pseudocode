/*
 * XREFs of MiLogNonRetpolineImageLoadEvent @ 0x140A7F0B8
 * Callers:
...
void __fastcall MiLogNonRetpolineImageLoadEvent(unsigned __int16 *a1, int a2, __int64 a3)
{
  ...
  if ( **(_DWORD **)&qword_140E372D8 > 5u
    && (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 0x400000000000LL) != 0
    && (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) & 0x400000000000LL) == *(_QWORD *)(*(_QWORD *)&qword_140E372D8
                                                                                         + 24LL) )
  {
    v11 = 0;
    v14 = 0;
    ...
    v5 = a3;
    v24 = 8;
    tlgWriteAgg(*(__int64 *)&qword_140E372D8, (unsigned __int8 *)byte_1400555F8, a3, 8u, (__int64)v8);
  }
}
