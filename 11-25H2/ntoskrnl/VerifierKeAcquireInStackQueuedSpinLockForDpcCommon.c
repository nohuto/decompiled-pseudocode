/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockForDpcCommon @ 0x140B85130
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x140B85110 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 * Callees:
...
__int64 __fastcall VerifierKeAcquireInStackQueuedSpinLockForDpcCommon(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // r8
  __int64 v4; // r9
