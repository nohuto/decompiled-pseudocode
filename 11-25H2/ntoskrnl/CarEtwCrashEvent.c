/*
 * XREFs of CarEtwCrashEvent @ 0x140609830
 * Callers:
...
char CarEtwCrashEvent()
{
  ...
  v0 = dword_140E08F20;
  result = dword_140E08F20 && tlgKeywordOn((__int64)&dword_140E08F20, 0x800000000000LL);
  if ( CarLogInitialized && result && v0 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140E08F20, 0x800000000000LL);
    if ( result )
    {
      v8 = 0;
      v16 = 0;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)byte_140050253,
               0LL,
               0LL,
               0xBu,
               &v13);
