/*
 * XREFs of MiLogInsertSecureImageActivePatch @ 0x1407E5198
 * Callers:
...
void __fastcall MiLogInsertSecureImageActivePatch(int a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000020LL) )
  {
    v23 = 0;
    v26 = 0;
    v29 = 0;
    ...
    v16 = v7;
    v40 = 8;
    tlgWriteEx_EtwWriteEx(v9, (unsigned __int8 *)&unk_140055C70, v7, 1u, v11, v12, 9u, &v20);
  }
}
