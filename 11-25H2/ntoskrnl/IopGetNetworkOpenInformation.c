/*
 * XREFs of IopGetNetworkOpenInformation @ 0x140AAB068
 * Callers:
...
__int64 __fastcall IopGetNetworkOpenInformation(struct _FILE_OBJECT *BugCheckParameter2, __int64 a2)
{
  ...
  v8 = 0LL;
  *(_OWORD *)v10 = 0LL;
  v4 = IopQueryXxxInformation(BugCheckParameter2, 4, 0x28u, 0, (__int64)&v7, &v6, 1);
  if ( v4 >= 0 )
  {
    v4 = IopQueryXxxInformation(BugCheckParameter2, 5, 0x18u, 0, (__int64)v10, &v6, 1);
    if ( v4 >= 0 )
    {
