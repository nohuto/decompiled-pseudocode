/*
 * XREFs of ExAllocateContiguousHeapPool @ 0x1402F7F74
 * Callers:
...
ULONG_PTR ExAllocateContiguousHeapPool(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, ...)
{
  ...
  v6 = *((_QWORD *)&unk_140E6B988 + 1048 * (v5 < dword_140E6B950 ? v5 : 0));
  if ( a1 > *(_QWORD *)(*(_QWORD *)qword_140E2FD48 + 18496LL) )
    return 0LL;
  if ( a2 < *(_QWORD *)(*(_QWORD *)qword_140E2FD48 + 18504LL) )
    return 0LL;
  ...
  HeapBackend = RtlpHpAllocateHeapBackend(v6, v9, v9, 0x800000LL);
  v11 = HeapBackend;
  if ( !HeapBackend )
    return 0LL;
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v25 )
      {
        *(_DWORD *)v20 = v25;
        v17 = v31;
        v27 = *(_QWORD *)(PoolTrackTable + 80LL * v18 + 72);
        if ( v27 )
          *(_QWORD *)(v20 + 72) = v27;
      }
      else
