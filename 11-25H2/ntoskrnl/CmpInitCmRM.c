/*
 * XREFs of CmpInitCmRM @ 0x140AD3ED8
 * Callers:
...
LABEL_60:
  ...
  *(_WORD *)(v26 + 16) = TmContainerExt;
  memmove((void *)(v26 + 18), off_140E09ED8, (unsigned __int16)TmContainerExt);
...
LABEL_97:
  Pool2[10] = v37;
  LOCK_CM_RM_LIST();
  v42 = (_QWORD *)qword_140EF4F18;
  if ( *(__int64 **)qword_140EF4F18 != &CmpRmListHead )
    __fastfail(3u);
  *Pool2 = &CmpRmListHead;
  Pool2[1] = v42;
  *v42 = Pool2;
  qword_140EF4F18 = (__int64)Pool2;
