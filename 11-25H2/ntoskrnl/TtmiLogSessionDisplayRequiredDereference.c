/*
 * XREFs of TtmiLogSessionDisplayRequiredDereference @ 0x140A2DEEC
 * Callers:
...
void TtmiLogSessionDisplayRequiredDereference()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&byte_14004F5CF, 0LL, 0LL, 5u, &v6);
  }
}
