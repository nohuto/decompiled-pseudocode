/*
 * XREFs of HalpInterruptBuildStartupStub @ 0x1405566DC
 * Callers:
 ...
 *     HalpInterruptCreateGdtEntry32 @ 0x1405568E0 (HalpInterruptCreateGdtEntry32.c)
...
PVOID HalpInterruptBuildStartupStub()
{
  ...
  v3 = (int)v1;
  *v1 = HalpPMStub;
  v1[1] = xmmword_140024740;
  v1[2] = xmmword_140024750;
  v1[3] = xmmword_140024760;
  v1[4] = xmmword_140024770;
