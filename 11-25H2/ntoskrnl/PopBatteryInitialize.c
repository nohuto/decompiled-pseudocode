/*
 * XREFs of PopBatteryInitialize @ 0x140A68504
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v10 = (_QWORD *)(a1 + 64);
    v11 = (_QWORD *)qword_140F0AAD8;
    if ( *(__int64 **)qword_140F0AAD8 != &qword_140F0AAD0 )
      __fastfail(3u);
    v10[1] = qword_140F0AAD8;
    *v10 = &qword_140F0AAD0;
    *v11 = v10;
    ++dword_140F0AAB4;
    ++dword_140F0AB2C;
    result = 0;
    qword_140F0AAD8 = (__int64)v10;
    byte_140F0AAB8 = 1;
  }
  return result;
}
