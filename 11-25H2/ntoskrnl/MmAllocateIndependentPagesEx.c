/*
 * XREFs of MmAllocateIndependentPagesEx @ 0x140A8508C
 * Callers:
...
__int64 __fastcall MmAllocateIndependentPagesEx(unsigned __int64 a1, int a2, __int64 a3, unsigned int a4)
{
  ...
  v6 = (a1 >> 12) + ((a1 & 0xFFF) != 0);
  v22[0] = 0LL;
  v7 = MiReservePtes((__int64)&qword_140E37328, v6);
  if ( !v7 )
    return 0LL;
  if ( !(unsigned int)MiObtainPoolCharges(v6, 1) )
  {
    MiReleasePtes((__int64)&qword_140E37328, (unsigned __int64 *)v7, v6);
    return 0LL;
  }
  v23 = v5 && (dword_140E389C4 & 8) != 0 && ((MiFlags & 0x100000000LL) == 0 || (MiFlags & 0x200000000LL) != 0);
...
LABEL_27:
  ...
  while ( v6 );
  if ( v12 )
    MiReturnExcessPoolCharges(v12, 1);
  return v21;
}
