/*
 * XREFs of DifRtlOemStringToUnicodeStringWrapper @ 0x14062DF70
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v17) = RtlOemStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
