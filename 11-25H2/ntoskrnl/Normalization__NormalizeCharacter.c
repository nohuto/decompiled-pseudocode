/*
 * XREFs of Normalization__NormalizeCharacter @ 0x140777294
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x140776380 (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1407770D0 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1405E3204 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1405E3234 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1405E326C (IsHangulLV.c)
 *     NormBuffer__Append @ 0x1405E32A4 (NormBuffer__Append.c)
 *     NormBuffer__AppendEx @ 0x1405E3364 (NormBuffer__AppendEx.c)
 ...
 *     NormBuffer__LastStartBase @ 0x1405E3600 (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x1405E362C (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x1405E367C (NormBuffer__RecheckStartCombinations.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1405E38C0 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x140776380 (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x14077648C (Normalization__CanCombinableCharactersCombine.c)
 */
