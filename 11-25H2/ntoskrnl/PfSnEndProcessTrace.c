/*
 * XREFs of PfSnEndProcessTrace @ 0x14091D474
 * Callers:
...
__int64 __fastcall PfSnEndProcessTrace(__int64 a1, signed __int32 a2, unsigned __int64 a3)
{
  ...
  if ( (unsigned int)dword_140E074B8 > 4 && (byte_140E074C8 & 1) != 0 && (qword_140E074D0 & 1) == qword_140E074D0 )
  {
    ...
    v21 = a1;
    v43 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)byte_140047E13, 0LL, 0LL, 3u, &v41);
  }
  ...
  if ( (unsigned int)dword_140E074B8 > 4 )
  {
    ...
    if ( v6 )
    {
      ...
      tlgCreate1Sz_wchar_t(
        (__int64)v27,
        (const WCHAR *)((unsigned __int64)&v12[3] & -(__int64)(v9 != 0LL) & ((unsigned __int128)-(__int128)((unsigned __int64)&v12[3] & -(__int64)(v9 != 0LL)) >> 64)));
      if ( v9 && v13 )
        v15 = *(_DWORD *)(v13 + 60);
      else
        v15 = 0;
      ...
      v28 = &v18;
      v29 = v14;
      tlgCreate1Sz_wchar_t((__int64)v31, (const WCHAR *)(a3 & ((unsigned __int128)-(__int128)a3 >> 64)));
      if ( a3 )
        v17 = *(_DWORD *)(a3 + 60);
      else
        v17 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)word_140047DA2,
        0LL,
        0LL,
        9u,
        &v23);
