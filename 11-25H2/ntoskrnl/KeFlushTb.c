/*
 * XREFs of KeFlushTb @ 0x14026F7E0
 * Callers:
  ...
  if ( a1 == 1 )
  {
    if ( VmTbFlushEnabled )
    {
      ...
      if ( v11 )
      {
        ...
        {
          VmpLogTbFlushSlatFlushEntire(v23, *(_QWORD *)(v11 + 104));
        }
        v32 = 0;
        v28 = 0LL;
        v27 = 0LL;
        ...
        do
        {
          ...
          {
            if ( *((_QWORD *)v14 + 1) )
              VmpProcessInvalidateList(v11, (__int64)v14);
            v25 = *(_QWORD *)(v11 + 72);
            VmpProcessContextUnlockExclusive((volatile LONG *)v11, v13);
            v12 = 0LL;
            v13 = VmpProcessContextLockExclusive((PEX_SPIN_LOCK)v11);
        ...
        if ( v13 != -1 )
        {
          if ( *((_QWORD *)v14 + 1) )
            VmpProcessInvalidateList(v11, (__int64)v14);
          result = VmpProcessContextUnlockExclusive((volatile LONG *)v11, v13);
        }
      }
    }
  }
