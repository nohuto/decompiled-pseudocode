/*
 * XREFs of RtlpFcUpdateFeatureConfiguration @ 0x140AA0038
 * Callers:
 *     CmFcManagerUpdateFeatureConfigurations @ 0x140AD4F6C (CmFcManagerUpdateFeatureConfigurations.c)
 * Callees:
 *     qsort @ 0x1404FC5A0 (qsort.c)
 *     RtlpIsImmutableFeatureConfigurationPriority @ 0x1405E68B4 (RtlpIsImmutableFeatureConfigurationPriority.c)
 ...
 *     RtlpFcCompareFeatureToUpdate @ 0x140A931A4 (RtlpFcCompareFeatureToUpdate.c)
 */
