/*
 * XREFs of Amd64InitializeProfilingEnhanced @ 0x140B40EC8
 * Callers:
...
LABEL_34:
    ...
    do
    {
      ...
      if ( !v59 )
      {
        v61 = (__int64 *)qword_140FC16E8;
        v62 = (__int64 **)((char *)&unk_140E05538 + v58);
        if ( *(__int64 **)qword_140FC16E8 != v56 )
          __fastfail(3u);
        ++HalpProfileSourceDescriptorCount;
        *v62 = v56;
        v62[1] = v61;
        *v61 = (__int64)v62;
        qword_140FC16E8 = (__int64)&unk_140E05538 + v58;
      }
      ++v57;
    }
    while ( v57 < 0x12 );
