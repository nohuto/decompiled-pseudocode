/*
 * XREFs of MiIncrementAweMapCount @ 0x140676D40
 * Callers:
...
__int64 __fastcall MiIncrementAweMapCount(__int64 a1, unsigned __int64 a2, char a3, unsigned int a4, __int64 a5)
{
  ...
  while ( 1 )
  {
    ...
    if ( !DWORD2(v20) )
    {
      if ( a4 == 1 )
      {
        if ( (*(_QWORD *)v20 & 0x7FFFFE0000uLL) < 0xE0000 )
        {
          ...
          *(_QWORD *)v20 = ((*(_QWORD *)v20 & 0xFFFFFFFFFFFE0000uLL) + 0x20000) ^ (*(_QWORD *)v20 ^ ((*(_QWORD *)v20 & 0xFFFFFFFFFFFE0000uLL) + 0x20000)) & 0xFFFFFF800001FFFFuLL;
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140E2FD88 + 4 * ((((v19 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << (((v19 - qword_140E2FD80) >> 3) & 0x1F)));
          return 0LL;
        }
        v17 = 1 << ((((__int64)v20 - qword_140E2FD80) >> 3) & 0x1F);
        v18 = (((__int64)v20 - qword_140E2FD80) >> 3) & 0x3FFFFF;
      }
      else
      {
        v17 = 1 << ((((__int64)v20 - qword_140E2FD80) >> 3) & 0x1F);
      ...
      _InterlockedAnd((volatile signed __int32 *)(qword_140E2FD88 + 4 * (v18 >> 5)), ~v17);
      return 3221225496LL;
    }
    v10 = v20;
