/*
 * XREFs of PpmParkSteerInterrupts @ 0x1403AE8E0
 * Callers:
 *     <none>
 * Callees:
...
char PpmParkSteerInterrupts()
{
  ...
  struct _KAFFINITY_EX *v57; // [rsp+30h] [rbp-D0h]
  struct _KAFFINITY_EX *v58; // [rsp+38h] [rbp-C8h]
  int v59; // [rsp+50h] [rbp-B0h] BYREF
  __int128 v60; // [rsp+58h] [rbp-A8h] BYREF
  __int64 v61; // [rsp+68h] [rbp-98h] BYREF
  unsigned __int16 v62; // [rsp+70h] [rbp-90h] BYREF
  unsigned __int16 v63; // [rsp+72h] [rbp-8Eh]
  int v64; // [rsp+74h] [rbp-8Ch]
  _QWORD Src[33]; // [rsp+78h] [rbp-88h] BYREF
  struct _KAFFINITY_EX v66; // [rsp+180h] [rbp+80h] BYREF
  struct _KAFFINITY_EX v67; // [rsp+290h] [rbp+190h] BYREF
  unsigned __int16 v68; // [rsp+3A0h] [rbp+2A0h] BYREF
  unsigned __int16 v69; // [rsp+3A2h] [rbp+2A2h]
  int v70; // [rsp+3A4h] [rbp+2A4h]
  _QWORD v71[33]; // [rsp+3A8h] [rbp+2A8h] BYREF
  struct _KAFFINITY_EX v72; // [rsp+4B0h] [rbp+3B0h] BYREF
  struct _KAFFINITY_EX v73; // [rsp+5C0h] [rbp+4C0h] BYREF

  memset_0(v71, 0, 0x100uLL);
  *(_QWORD *)&v60 = 0LL;
  v61 = 0LL;
  ...
  if ( !PpmIntSteerTrigger )
  {
    ...
    PpmIntSteerTrigger = ExAllocatePool2(0x40uLL);
    if ( !PpmIntSteerTrigger )
      return 1;
  }
  v69 = 32;
  ...
  Count = v69;
  v70 = 0;
  if ( KeActiveProcessors.Count <= v69 )
    Count = KeActiveProcessors.Count;
  v68 = Count;
  if ( Count )
  {
    memmove(v71, &KeActiveProcessors.8, 8LL * Count);
    do
      ++v1;
    while ( v1 < Count );
    v0 = v69;
  ...
  KeIntSteerSnapPerf(v0, &v61, &v59, &v60);
  v63 = 32;
  memset_0(Src, 0, 0x100uLL);
  v4 = PpmPerfCoreParkingMask.Count;
  v5 = v63;
  if ( PpmPerfCoreParkingMask.Count > v63 )
    v4 = v63;
  v6 = 0;
  if ( v4 )
  {
  ...
  *(_QWORD *)&v67.Count = 2097153LL;
  ...
  while ( 1 )
  {
    while ( v17 )
    {
      ...
      v17 &= ~(1LL << v19);
      v20 = *((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v18 + (unsigned __int8)v19);
...
LABEL_37:
      ...
      else
      {
        ...
        if ( v26 - v27 >= (unsigned __int64)(10000 * PpmIntSteerTriggerMax) )
        {
          ...
          v29 = v28 & 0x3F;
          v30 = v28 >> 6;
          if ( v67.Count > (unsigned int)v30 )
            goto LABEL_32;
          if ( v67.Size > (unsigned int)v30 )
          {
            v67.Count = v30 + 1;
LABEL_32:
            v31 = &v67.Bitmap[v30];
  ...
  if ( !v16 )
  {
    ...
    {
      v60 = PpmCachedSystemAllowedCpuSet.Bitmap[0];
      LowestClassProcessorInMask = KiIntPartGetLowestClassProcessorInMask((__int64)&v60);
    }
    else
    {
      LowestClassProcessorInMask = 0;
    }
    KeAddProcessorAffinityEx(&v62, LowestClassProcessorInMask);
    v16 = 1;
  }
  if ( !v15 )
  {
  ...
  switch ( PpmIntSteerMode )
  {
    ...
    case 6:
      *(_QWORD *)&v66.Count = 2097153LL;
      ...
      if ( v66.Count > (unsigned int)v51 )
        goto LABEL_66;
      if ( v66.Size > (unsigned int)v51 )
      {
        v66.Count = v51 + 1;
LABEL_66:
        v52 = &v66.Bitmap[v51];
    ...
    default:
      ...
      v39 = (struct _KAFFINITY_EX *)&v62;
      v40 = 0LL;
      v41 = (PpmIntSteerLoadMax + v59) / (unsigned int)PpmIntSteerLoadMax;
      if ( v41 < v15 )
      {
        *(_QWORD *)&v66.Count = 2097153LL;
        memset_0(&v66.8, 0, sizeof(v66.8));
        ...
        if ( v42 <= v41 )
        {
          if ( v42 < v41 )
          {
            *(_QWORD *)&v72.Count = 2097153LL;
            ...
            KiSubtractAffinityEx(&v67, &v73, &v72, v72.Size);
            KiOrAffinityEx(&v66, &v72, &v66, v66.Size);
            v42 = 0;
            if ( v66.Count )
            {
              v45 = &v66.8;
...
LABEL_60:
      KeIntSteerPeriodic(v61, v40, v38, v39, v55, v56, v57, v58);
      break;
  }
  return 1;
}
