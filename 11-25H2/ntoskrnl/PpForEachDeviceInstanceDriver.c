/*
 * XREFs of PpForEachDeviceInstanceDriver @ 0x140A46EA4
 * Callers:
...
__int64 __fastcall PpForEachDeviceInstanceDriver(unsigned __int16 *a1, __int64 a2, __int64 a3)
{
  ...
  HANDLE v27; // [rsp+70h] [rbp-69h] BYREF
  HANDLE Handle; // [rsp+78h] [rbp-61h] BYREF
...
LABEL_12:
  DeviceRegProp = CmOpenDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, v7, 16, 0, 131097, 0, (__int64)&Handle, 0LL);
  if ( DeviceRegProp >= 0 )
  {
    v24 = 78;
    ...
    if ( DeviceRegProp >= 0 && v25 == 1 && v24 )
      DeviceRegProp = CmOpenCommonClassRegKey(*(_QWORD **)&PiPnpRtlCtx, v30, 32, 0, 131097, 0, (__int64)&v27, 0LL);
    v29[2] = a3;
    v29[0] = a1;
...
LABEL_18:
    ...
    for ( i = 0; ; ++i )
    {
      if ( i >= 5 )
        goto LABEL_19;
      v14 = 4LL * i;
      v15 = qword_140002EB0[v14 + 2];
      if ( !v15 || v27 )
        break;
LABEL_40:
      ;
    }
    v16 = qword_140002EB0[v14 + 1];
    v23 = v24;
    if ( v15 )
    {
      if ( v16 )
...
LABEL_38:
      ...
      else
      {
        if ( DeviceRegProp < 0 )
          goto LABEL_19;
        DeviceRegProp = PiForEachDriverQueryRoutine(v25, v5, v23, qword_140002EB0[4 * i + 3], v29);
        if ( DeviceRegProp < 0 )
          goto LABEL_19;
      }
      goto LABEL_40;
    ...
    if ( !v5 )
      goto LABEL_18;
    v18 = qword_140002EB0[v14 + 1];
    if ( LOBYTE(qword_140002EB0[4 * i + 2]) )
    {
      if ( !v18 )
      {
