/*
 * XREFs of MiSharedInsertPfnChainInList @ 0x14023EE90
 * Callers:
...
signed __int64 __fastcall MiSharedInsertPfnChainInList(__int64 a1, _QWORD *a2)
{
    ...
    if ( ((v11 >> 12) & 0xFFFFFFFFFFLL) == v12 )
    {
      ...
      if ( qword_140E2D940 )
      {
        ...
        if ( (qword_140E2D940 & v14) == 0 )
          v15 = qword_140E2D940 | ((*(_QWORD *)(a1 + 16) & 0xFFFFFFFFFFLL) << 12) | 0x880;
        v14 = v15;
      }
      *(_QWORD *)(v2 + 16) = v14;
    }
  ...
  if ( *(_DWORD *)(a1 + 12) == 2 )
  {
    ...
    v61 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v23 + 40) >> 43) & 0x3FFLL));
    v24 = (unsigned int)dword_140E2D884;
    if ( dword_140E2D880 > (unsigned int)dword_140E2D884
      || (v25 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, v21 < *(_QWORD *)v25)
      || dword_140E2D880 != dword_140E2D884 && v21 >= *((_QWORD *)v25 + 2) )
    {
      for ( j = 0; ; j = v27 + 1 )
      {
        while ( 1 )
        {
          ...
          v27 = (j + (int)v24) >> 1;
          v25 = (char *)qword_140E2D8E0 + 16 * v27;
          if ( v21 >= *(_QWORD *)v25 )
            break;
          if ( !v27 )
            KeBugCheckEx(0x1Au, 0x5180uLL, v21, (ULONG_PTR)qword_140E2D8E0, 0LL);
          v24 = (unsigned int)(v27 - 1);
        }
        if ( v27 == dword_140E2D884 || v21 < *((_QWORD *)v25 + 2) )
          break;
      }
      dword_140E2D880 = (j + (int)v24) >> 1;
    }
    v63 = *((_DWORD *)v25 + 2);
    if ( v2 )
    {
...
LABEL_35:
    ...
    {
      v29 = 0xAAAAAAAAAAAAAAABuLL;
      if ( v23 < 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL
        && !(unsigned int)MiIsDecayPfn(0xAAAAAAAAAAAAAAABuLL * (v22 >> 4), v24, 0xAAAAAAAAAAAAAAABuLL) )
      {
