/*
 * XREFs of DifIoIsWdmVersionAvailableWrapper @ 0x14061D790
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoIsWdmVersionAvailable @ 0x140A6E6B0 (IoIsWdmVersionAvailable.c)
 */
...
char __fastcall DifIoIsWdmVersionAvailableWrapper(UCHAR a1, UCHAR a2)
{
  ...
  BYTE10(v13[0]) = IoIsWdmVersionAvailable(a1, a2);
  if ( v5 )
  {
