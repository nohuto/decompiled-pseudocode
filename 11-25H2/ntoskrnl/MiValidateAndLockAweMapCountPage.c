/*
 * XREFs of MiValidateAndLockAweMapCountPage @ 0x1404B3F90
 * Callers:
...
__int64 __fastcall MiValidateAndLockAweMapCountPage(__int64 a1, unsigned __int64 a2, int a3, __int64 a4)
{
  ...
  *(_QWORD *)a4 = 0LL;
  ...
  {
    v12 = 0LL;
    v13 = qword_140E2FD80 + 8 * ((a2 >> 18) & 0x3FFFFF);
    v11 = 48 * a2;
  }
  else
  {
  ...
  if ( a3 )
  {
    ...
    if ( a2 <= qword_140E2D9A0 && ((*(_QWORD *)(v11 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
    {
      if ( !v12 )
        return 0LL;
      v16 = 0;
    ...
    if ( !_bittest64(v14, v9) )
    {
      if ( v12 )
        ...
        _InterlockedAnd(
          (volatile signed __int32 *)(qword_140E2FD88 + 4 * ((((v13 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
          ~(1 << (((v13 - qword_140E2FD80) >> 3) & 0x1F)));
      return 0LL;
    }
  }
  else if ( v12 )
