/*
 * XREFs of CmGetVisibleMaxValueNameLenAndDataLen @ 0x1409EB010
 * Callers:
  ...
  if ( CellFlat )
  {
    while ( 1 )
    {
      ...
      if ( (*(_BYTE *)(v15 + 140) & 1) != 0 )
        CellPaged = HvpGetCellFlat(v15, v16, &v25);
      else
        CellPaged = HvpGetCellPaged(v15, v16, &v25);
      v18 = CellPaged;
      if ( !CellPaged )
      {
        v23 = *(_QWORD *)(a1 + 32);
        if ( (*(_BYTE *)(v23 + 140) & 1) != 0 )
          ...
          HvpReleaseCellPaged(v23, (unsigned int *)&v24);
        return 3221225626LL;
      }
      ...
      if ( (*(_BYTE *)(v22 + 140) & 1) != 0 )
        ...
        HvpReleaseCellPaged(v22, (unsigned int *)&v25);
      v6 = (unsigned int)(v6 + 1);
    }
    if ( (*(_BYTE *)(v15 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v15, &v24);
    else
      HvpReleaseCellPaged(v15, (unsigned int *)&v24);
    return 0LL;
  }
  return 3221225626LL;
}
