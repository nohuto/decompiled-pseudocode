/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x1404D4FFC
 * Callers:
 ...
 *     PopDiagInterruptTimeToSystemTime @ 0x140B5EA84 (PopDiagInterruptTimeToSystemTime.c)
 */
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  v28[0] = 0LL;
  if ( qword_140F0AEE0 )
    PopDiagInterruptTimeToSystemTime(qword_140F0AEE0, &v25);
  if ( qword_140F0AEF8 )
    PopDiagInterruptTimeToSystemTime(qword_140F0AEF8, &v26);
  PopDiagInterruptTimeToSystemTime(qword_140F0AEB8, &v27);
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    if ( result )
    {
      ...
      result = tlgWriteTransfer_EtwWriteTransfer(
                 ...
                 (unsigned __int8 *)&word_140048716,
                 0LL,
                 0LL,
                 0x10u,
                 &v56);
