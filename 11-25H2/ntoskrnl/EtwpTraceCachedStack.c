/*
 * XREFs of EtwpTraceCachedStack @ 0x1403F63A0
 * Callers:
...
int __fastcall EtwpTraceCachedStack(__int64 a1, unsigned int a2, unsigned __int16 a3, __int64 a4)
{
  ...
  if ( a3 == 6180 )
    v10 = 5242882;
  return EtwpLogKernelEvent((struct _KTHREAD *)v12, a1, a2, v6, a3, v10);
}
