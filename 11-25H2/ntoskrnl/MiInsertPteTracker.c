/*
 * XREFs of MiInsertPteTracker @ 0x140685F74
 * Callers:
...
__int64 __fastcall MiInsertPteTracker(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( LOWORD(stru_140E35AC0.Alignment) >= 0xAu )
  {
    v10 = RtlpInterlockedFlushSList(&stru_140E35AC0);
    v8 = v10;
    if ( v10 )
    {
      Next = v10->Next;
  ...
  {
    v8 = RtlpInterlockedPopEntrySList(&stru_140E35AC0);
    if ( v8 )
      goto LABEL_8;
  }
...
LABEL_14:
  ...
  *((_QWORD *)&v8[3].Next + 1) = *(_QWORD *)(a1 + 48);
  ...
  {
    v22 = ExAcquireSpinLockExclusive(&dword_140E35AD0);
  }
  v23 = (char *)&unk_140E385B0 + 16 * (v21 & 0xF);
  v24 = *(_QWORD *)v23;
  ...
  *(_QWORD *)v23 = v8;
  qword_140E386B0 += v19;
  v25 = ++qword_140E386B8;
  if ( qword_140E386B8 > (unsigned __int64)qword_140E386C0 )
    qword_140E386C0 = v25;
  return MiReleaseSpinLockExclusive(&dword_140E35AD0, v22);
}
