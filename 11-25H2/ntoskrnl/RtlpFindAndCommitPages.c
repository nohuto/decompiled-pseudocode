/*
 * XREFs of RtlpFindAndCommitPages @ 0x1405E0484
 * Callers:
 ...
 *     RtlpUpdateHeapRates @ 0x1405E1780 (RtlpUpdateHeapRates.c)
...
__int64 __fastcall RtlpFindAndCommitPages(ULONG_PTR a1, ULONG_PTR *a2)
{
  ...
  {
    updated = guard_dispatch_icall_no_overrides(a1);
  }
  else
  {
  ...
  *(_QWORD *)(a1 + 576) += *(_QWORD *)(v5 + 40);
  ...
  v18 = *(_QWORD *)(v5 + 40);
  v19 = *a2;
  if ( v18 > *a2 || v18 + *(_QWORD *)(v5 + 32) == *(_QWORD *)(v9 + 72) )
  {
    RtlpCreateUCREntry(a1, v9, v19 - 48 + *(_QWORD *)(v5 + 32), v18 - v19, v5 - 16, (__int64 *)a2);
    *a2 *= 16LL;
  }
  else
  {
    *a2 = v19 + 16LL * *(unsigned __int16 *)(v16 + 8);
  }
  *(_BYTE *)(v16 + 11) = 0;
  v20 = *(_QWORD *)(v9 + 40);
  if ( v20 != v9 )
  {
    if ( ((unsigned __int64)(v16 - v9) >> 16) + 1 >= 0xFE )
      RtlpLogHeapFailure(3, v20, v5 - 16, v9, 0LL, 0LL);
