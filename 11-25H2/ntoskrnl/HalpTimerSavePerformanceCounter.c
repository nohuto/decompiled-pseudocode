/*
 * XREFs of HalpTimerSavePerformanceCounter @ 0x140290158
 * Callers:
...
__int64 HalpTimerSavePerformanceCounter()
{
  ...
  __int64 v8; // rdi
  __int64 v9; // rax
  __int64 (__fastcall *v10)(__int64, __int64); // rdx
  __int64 v11; // rax
  __int64 v12; // r14
  ...
  if ( *(_DWORD *)(HalpPerformanceCounter + 220) == 64 )
  {
    ...
    v3 = *(__int64 (__fastcall **)(__int64, __int64))(v0 + 112);
    if ( v3 == HalpHvCounterQueryCounter )
      Counter = HalpHvCounterQueryCounter(InternalData, (__int64)v3);
    else
  ...
  *(_QWORD *)(v0 + 16) = v5 + v6;
  ...
  if ( HalpAlwaysOnCounter )
  {
    if ( *(_DWORD *)(HalpAlwaysOnCounter + 220) == 64 )
    {
      ...
      v10 = *(__int64 (__fastcall **)(__int64, __int64))(v8 + 112);
      if ( v10 == HalpHvCounterQueryCounter )
        v11 = HalpHvCounterQueryCounter(v9, (__int64)v10);
      else
