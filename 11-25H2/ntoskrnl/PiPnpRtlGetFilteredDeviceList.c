/*
 * XREFs of PiPnpRtlGetFilteredDeviceList @ 0x14094FB0C
 * Callers:
...
__int64 __fastcall PiPnpRtlGetFilteredDeviceList(__int64 a1)
{
  ...
  unsigned int dwFlags; // [rsp+28h] [rbp-71h]
  ...
  if ( (v1 & 2) == 0 )
  {
    ...
    if ( v3 )
    {
      ...
      *(_WORD *)((char *)&v44 + 13) = 0;
      ...
      v43 = 1LL;
      v41 = PiPnpRtlEnumeratorFilterCallback;
      return (unsigned int)PiDmGetObjectConstraintList(4, v3, (__int64)v4, (__int64)&v41, v4, dwFlags, v7);
    }
    return (unsigned int)-1073741811;
  }
