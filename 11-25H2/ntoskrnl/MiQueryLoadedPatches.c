/*
 * XREFs of MiQueryLoadedPatches @ 0x140AA1218
 * Callers:
...
__int64 __fastcall MiQueryLoadedPatches(PSID SourceSid, _QWORD *a2, _DWORD *a3, __int64 a4, unsigned int a5)
{
  ...
  v10 = KeAbPreAcquire((__int64)&qword_140E37250, 0LL);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140E37250, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140E37250, 0, v10, (unsigned __int64)&qword_140E37250);
  if ( v10 )
    *((_BYTE *)v10 + 10) = 1;
  if ( SourceSid )
  {
