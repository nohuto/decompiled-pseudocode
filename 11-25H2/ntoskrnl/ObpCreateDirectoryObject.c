/*
 * XREFs of ObpCreateDirectoryObject @ 0x140A41B20
 * Callers:
 *     NtCreateDirectoryObject @ 0x140A41AE0 (NtCreateDirectoryObject.c)
 *     NtCreateDirectoryObjectEx @ 0x140A41B00 (NtCreateDirectoryObjectEx.c)
 * Callees:
    ...
    if ( inserted >= 0 )
    {
      ...
      *((_DWORD *)v10 + 85) = -1;
      ...
      if ( (a5 & 2) == 0 )
        v13 = v12;
      *((_DWORD *)v10 + 84) |= v13;
      inserted = ObInsertObjectEx((char *)v10, 0LL, a2, 0, 0, 0LL, (__int64)&v19);
      v18 = 0LL;
      *a1 = v19;
    }
  }
