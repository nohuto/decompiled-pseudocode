/*
 * XREFs of KiProcessControlProtection @ 0x14043E160
 * Callers:
 ...
 *     KiFixupControlProtectionUserModeReturnMismatch @ 0x140482B0C (KiFixupControlProtectionUserModeReturnMismatch.c)
