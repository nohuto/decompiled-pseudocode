/*
 * XREFs of ?StDmpSinglePageInsert@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_IO_PARAMS@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x140399A20
 * Callers:
...
LABEL_100:
    v71[1] += v69;
  if ( (dword_140E2859C & 0x10) != 0 )
    SmEtwLogStoreOp((unsigned int)&qword_140E28590, 0, (unsigned int)&v91, v69, *v62, v6, *((_BYTE *)v62 + 4), *v98 & 7);
  return 0LL;
}
