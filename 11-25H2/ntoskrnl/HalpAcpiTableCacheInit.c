/*
 * XREFs of HalpAcpiTableCacheInit @ 0x140C55BD8
 * Callers:
 ...
 *     HalpAcpiCalculateCacheSizeForOverrideTables @ 0x140BFC814 (HalpAcpiCalculateCacheSizeForOverrideTables.c)
...
__int64 __fastcall HalpAcpiTableCacheInit(__int64 a1)
{
  ...
  qword_140E0F288 = (__int64)&HalpAcpiTableCacheList;
  ...
  v17 = HalpMap(v11, (v15 + (unsigned __int64)(v11 & 0xFFF) + 4095) >> 12, 1u, 0, 4u, 0LL);
  v18 = v17;
  if ( !v17 )
  {
    if ( v3 )
