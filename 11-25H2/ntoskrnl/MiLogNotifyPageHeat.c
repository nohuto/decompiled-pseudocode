/*
 * XREFs of MiLogNotifyPageHeat @ 0x140679EF0
 * Callers:
...
char __fastcall MiLogNotifyPageHeat(_DWORD *a1)
{
  ...
  if ( !*(_QWORD *)&qword_140E372D8 )
    return (char)v1;
  if ( !**(_DWORD **)&qword_140E372D8 )
    return (char)v1;
  LOBYTE(v1) = tlgKeywordOn(*(__int64 *)&qword_140E372D8, 64LL);
  if ( !(_BYTE)v1 )
    return (char)v1;
  ...
  if ( (*a1 & 1) != 0 )
  {
    if ( **(_DWORD **)&qword_140E372D8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140E372D8, 64LL) )
      goto LABEL_18;
    v14 = *v3;
    v12 = (unsigned __int8 *)&word_14005653E;
    v21 = a1[1];
    v25 = &v21;
    v27 = &v23;
    v22 = v14 >> 12;
  ...
  else
  {
    if ( **(_DWORD **)&qword_140E372D8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140E372D8, 64LL) )
      goto LABEL_18;
    v11 = *v3;
    v12 = (unsigned __int8 *)&byte_1400564B7;
    v19 = a1[1];
    v25 = &v19;
    v27 = &v22;
    v23 = v11 >> 12;
