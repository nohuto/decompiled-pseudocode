/*
 * XREFs of GetOperandValue @ 0x1409EA0A4
 * Callers:
 ...
 *     GetBinaryOperandLen @ 0x140787BA8 (GetBinaryOperandLen.c)
        ...
        char a9)
{
  ...
  _QWORD *v55; // rax
  __int64 v56; // rcx
  _QWORD *v57; // [rsp+58h] [rbp-28h] BYREF
...
LABEL_41:
      ...
      *(_BYTE *)(*(unsigned int *)(v31 + 4) + v32) = *((_BYTE *)v57 + 1);
      if ( !v24 )
        *(_DWORD *)(*(unsigned int *)(v31 + 4) + *(_QWORD *)(v31 + 8) + 1LL) = *((_DWORD *)v57 + 1);
      memmove(
