/*
 * XREFs of KiSwInterruptDispatch @ 0x140506170
 * Callers:
 *     KiSwInterrupt @ 0x1406A60C0 (KiSwInterrupt.c)
 * Callees:
 *     KiGetTrapFrameMode @ 0x14044B6C0 (KiGetTrapFrameMode.c)
 *     KeExitRetpoline @ 0x14046112C (KeExitRetpoline.c)
 *     KiReadKernelDr7 @ 0x1405B38F8 (KiReadKernelDr7.c)
            ...
            *((_DWORD *)v5 + 639) &= ~0x200000u;
            if ( v30 != v5[340] )
            {
              ...
              *(_DWORD *)(v34 + 16) = v33;
              ...
              sub_140BC7384(v5 + 4, 0LL, v30, 256LL);
            }
          }
        }
      }
            ...
            *((_DWORD *)v6 + 631) &= ~0x200000u;
            if ( v141 != v6[336] )
            {
              ...
              *(_DWORD *)(v144 + 16) = v145;
              ...
              sub_140BC7384(v6, 0LL, v141, 256LL);
            }
          }
        }
        if ( *((_QWORD *)v43 + 3) != 1LL )
              ...
              *((_DWORD *)v6 + 631) &= ~0x200000u;
              if ( v120 != v6[336] )
              {
                ...
                *(_DWORD *)(v152 + 16) = v151;
                ...
                sub_140BC7384(v6, 0LL, v120, 256LL);
              }
            }
          }
        }
              ...
              *((_DWORD *)v6 + 631) &= ~0x200000u;
              if ( v59 != v6[336] )
              {
                ...
                *(_DWORD *)(v78 + 16) = v77;
                ...
                sub_140BC7384(v6, 0LL, v59, 256LL);
              }
            }
          }
        }
          ...
          *((_DWORD *)v6 + 631) &= ~0x200000u;
          if ( v96 != v6[336] )
          {
            ...
            *(_DWORD *)(v100 + 16) = v99;
            ...
            sub_140BC7384(v6, 0LL, v96, 256LL);
          }
        }
      }
      if ( *((_QWORD *)v43 + 3) != 1LL )
            ...
            *((_DWORD *)v6 + 631) &= ~0x200000u;
            if ( v104 != v6[336] )
            {
              ...
              *(_DWORD *)(v108 + 16) = v107;
              ...
              sub_140BC7384(v6, 0LL, v104, 256LL);
            }
          }
        }
      }
