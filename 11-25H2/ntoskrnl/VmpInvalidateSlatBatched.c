/*
 * XREFs of VmpInvalidateSlatBatched @ 0x140482874
 * Callers:
...
unsigned __int64 __fastcall VmpInvalidateSlatBatched(
...
LABEL_16:
    ...
    if ( !v6 )
      break;
    if ( *((_QWORD *)v12 + 1) )
      VmpProcessInvalidateList((__int64)SpinLock, (__int64)v12);
  ...
  if ( *((_QWORD *)v12 + 1) )
    return VmpProcessInvalidateList((__int64)SpinLock, (__int64)v12);
  return result;
}
