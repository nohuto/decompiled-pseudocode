/*
 * XREFs of EtwpRegisterPrivateSession @ 0x14079E05C
 * Callers:
...
LABEL_25:
          ...
          *((_WORD *)Object + 8) = a2;
          v20 = (_RTL_RB_TREE *)a1;
          WORD2(v25->ParentValue) = ++*(_WORD *)(a1 + 4104);
          ...
          inserted = ObInsertObjectEx(v24, 0LL, 0, (__int64)&v30, (__int64)&v29);
          if ( !inserted )
          {
            *a3 = v24[10];
            *a4 = v29;
