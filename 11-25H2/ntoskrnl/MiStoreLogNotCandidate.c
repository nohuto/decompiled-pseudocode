/*
 * XREFs of MiStoreLogNotCandidate @ 0x1402CC35C
 * Callers:
...
void __fastcall MiStoreLogNotCandidate(int a1)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 && a1 != -1073741401 && **(_DWORD **)&qword_140E372D8 > 5u )
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140E372D8, 0x400000000002LL) )
    {
      v10 = 0;
      v13 = 0;
      v8[4] = (__int64)&v6;
      ...
      v12 = 4;
      v7 = v3;
      tlgWriteEx_EtwWriteEx(v1, (int)&byte_140056AEB, v1, 1, v4, v5, 4u, (__int64)v8);
    }
  }
}
