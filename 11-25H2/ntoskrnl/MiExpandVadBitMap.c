/*
 * XREFs of MiExpandVadBitMap @ 0x140900244
 * Callers:
...
__int64 __fastcall MiExpandVadBitMap(unsigned __int64 *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v9 = v8 + ((-524288 * qword_140E2F048 + (v6 << 19)) >> 16);
  v22 = a1[5] - v9 + 1;
  v10 = v22;
  if ( a4 )
  {
    v19 = a1[6] - 1;
    v20 = (v8 + 8 * (v6 - qword_140E2F048)) << 16;
    if ( v19 > a4 )
      v19 = a4;
    if ( v19 + 0x10000 > v20 )
      v10 = ((v19 - v20) >> 16) + 1;
  ...
  v12 = (v8 + 8 * (v6 - qword_140E2F048)) << 16;
