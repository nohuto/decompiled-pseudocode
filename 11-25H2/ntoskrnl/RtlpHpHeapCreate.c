/*
 * XREFs of RtlpHpHeapCreate @ 0x1405F89CC
 * Callers:
 *     RtlpHpMetadataHeapCreate @ 0x1405F9070 (RtlpHpMetadataHeapCreate.c)
 *     ExCreateHeap @ 0x14064DE00 (ExCreateHeap.c)
...
__int64 __fastcall RtlpHpHeapCreate(int a1, __int64 a2, __int64 a3, __int128 *a4)
{
  ...
  {
    MaximumProcessorCount = dword_140E675D4;
    if ( !dword_140E675D4 )
    {
      MaximumProcessorCount = HalQueryMaximumProcessorCount();
      if ( !MaximumProcessorCount )
        MaximumProcessorCount = 1;
      v8 = _InterlockedCompareExchange(&dword_140E675D4, MaximumProcessorCount, 0);
      if ( v8 )
...
LABEL_22:
      ...
      *((_QWORD *)&v26 + 1) = RtlpHpSegLfhVsFree;
      ...
      v21 = (void *)guard_dispatch_icall_no_overrides(*v14);
      if ( v21
        && (memset_0(v21, 0, v20), (int)RtlpHpVsContextStart(v10 + 704) >= 0)
        && ((a1 & 0x400000) != 0 || (int)RtlpHpLfhContextEnable(v10 + 832, &unk_140E6B918) >= 0)
