/*
 * XREFs of KeSrcuAllocate @ 0x1405BC7C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KeSrcuAllocate(int a1)
{
  ...
  v3 = &byte_140F0F8C4;
  v4 = 0;
  v5 = (unsigned __int8)byte_140F0F8C1;
  v6 = byte_140F0F8C1 - 1;
  if ( byte_140F0F8C1 )
  {
    v7 = &byte_140F0F8C4;
    v8 = (unsigned __int8)byte_140F0F8C1;
    do
    {
  ...
  *(_QWORD *)(v15 + 32) = v17;
  ...
  v29 = 1;
  for ( *(_QWORD *)(*(_QWORD *)(v15 + 16) + 8LL) = qword_140F0F8D0; v29 < v2; ++v29 )
  {
    v30 = 0;
    v31 = 0;
  ...
  *(_QWORD *)(v15 + 152) = *(_QWORD *)(v15 + 8 * v11 + 16) + 56LL * *((unsigned __int8 *)&KiSrcuState[4] + v11 + 4);
  ...
  v41 = KeAcquireSpinLockRaiseToDpc(&qword_140F0F8B0);
  if ( !KiSrcuState[0] )
  {
    qword_140F0F8A8 = (__int64)KiSrcuState;
    KiSrcuState[0] = (__int64)KiSrcuState;
  }
  v42 = (__int64 *)qword_140F0F8A8;
  if ( *(__int64 **)qword_140F0F8A8 != KiSrcuState )
    __fastfail(3u);
  *(_QWORD *)(v15 + 8) = qword_140F0F8A8;
  *(_QWORD *)v15 = KiSrcuState;
  *v42 = v15;
  qword_140F0F8A8 = v15;
  KeReleaseSpinLock(&qword_140F0F8B0, v41);
  return v15;
}
