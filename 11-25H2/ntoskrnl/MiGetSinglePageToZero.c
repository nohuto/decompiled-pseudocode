/*
 * XREFs of MiGetSinglePageToZero @ 0x140210180
 * Callers:
...
__int64 __fastcall MiGetSinglePageToZero(__int64 a1, __int64 a2, volatile signed __int32 *a3, int a4)
{
  ...
  v9 = qword_140E389D0 + 57216LL * (unsigned int)v8;
...
LABEL_11:
  ...
  do
  {
    ...
    for ( i = 0; i <= 1; ++i )
    {
      ...
      v14 = 0;
      v15 = _InterlockedExchangeAdd(v5, 1u) % (unsigned int)dword_140E2D980[HIWORD(v12) & 3];
      ...
      if ( MmNumberOfChannels )
      {
        while ( 1 )
        {
          ...
          if ( v14 == 2 )
          {
            v20 = qword_140E389D0 + 57216 * ((v17 >> 9) & 0x3F);
