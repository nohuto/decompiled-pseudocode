/*
 * XREFs of CmpLogFailureToGetFileSize @ 0x1409FA084
 * Callers:
...
void CmpLogFailureToGetFileSize()
{
  ...
  if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 0x400000000000LL) )
  {
    ...
    v4 = 0x1000000LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09E08, (unsigned __int8 *)&dword_14005454C, 0LL, 0LL, 5u, &v5);
  }
}
