/*
 * XREFs of IoAddProcessesToDump @ 0x14059C980
 * Callers:
 *     IopLiveDumpAddProcesses @ 0x140594950 (IopLiveDumpAddProcesses.c)
...
__int64 __fastcall IoAddProcessesToDump(__int64 a1, __int64 a2)
{
  ...
  while ( v2 != &PsActiveProcessHead )
  {
    ...
    if ( v6 < 0
      || (v6 = MmAddRangeToCrashDump(a1, v2[33], 2000LL), v6 < 0)
      || a2 && (v6 = guard_dispatch_icall_no_overrides(a1), v6 < 0) )
    {
      if ( v6 == -1073741789 )
        return 0LL;
      v5 = v6;
