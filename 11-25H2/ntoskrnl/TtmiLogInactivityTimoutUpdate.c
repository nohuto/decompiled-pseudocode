/*
 * XREFs of TtmiLogInactivityTimoutUpdate @ 0x14075D81C
 * Callers:
...
void __fastcall TtmiLogInactivityTimoutUpdate(int a1)
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v9 = &v4;
    v4 = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&dword_14004E4CC, 0LL, 0LL, 4u, &v5);
  }
}
