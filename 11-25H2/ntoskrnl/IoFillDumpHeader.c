/*
 * XREFs of IoFillDumpHeader @ 0x14058D79C
 * Callers:
 ...
 *     KeInitializeCrashDumpHeader @ 0x140592310 (KeInitializeCrashDumpHeader.c)
 *     IopLiveDumpCollectPages @ 0x140596B54 (IopLiveDumpCollectPages.c)
 *     DbgkpTriageDumpFillHeaders @ 0x1406FD370 (DbgkpTriageDumpFillHeaders.c)
 * Callees:
 ...
 *     MmGetPhysicalMemoryRanges @ 0x1407DA6D0 (MmGetPhysicalMemoryRanges.c)
        ...
        __int64 a8)
{
  ...
  PPHYSICAL_MEMORY_RANGE v18; // rdi
  _LARGE_INTEGER NumberOfBytes; // rax
  unsigned int v20; // edx
  __int64 v21; // r8
  __int64 v22; // r9
  signed __int64 v23; // r8
  _LARGE_INTEGER *p_NumberOfBytes; // rcx
  ...
  *((_QWORD *)a1 + 16) = &KdDebuggerDataBlock;
  ...
  if ( KeGetCurrentIrql() > 1u )
  {
    ...
    if ( v16 > 0x2BC )
      v16 = 700LL;
    memmove(a1 + 34, MmPhysicalMemoryBlock, v16);
    goto LABEL_26;
  }
...
LABEL_25:
  ...
  {
    ++v20;
    v21 += (unsigned __int64)NumberOfBytes.QuadPart >> 12;
    NumberOfBytes = v18[v20].NumberOfBytes;
  }
  *((_QWORD *)a1 + 18) = v21;
  if ( 16 * ((unsigned __int64)(v20 - 1) + 2) > 0x2BC )
    v20 = 42;
  a1[34] = v20;
  if ( v20 )
  {
    v22 = v20;
    v23 = (char *)a1 - (char *)v18;
    p_NumberOfBytes = &v18->NumberOfBytes;
    do
    {
      *(LONGLONG *)((char *)&p_NumberOfBytes[18].QuadPart + v23) = (unsigned __int64)p_NumberOfBytes[-1].QuadPart >> 12;
      QuadPart = p_NumberOfBytes->QuadPart;
      p_NumberOfBytes += 2;
      *(LONGLONG *)((char *)&p_NumberOfBytes[17].QuadPart + v23) = QuadPart >> 12;
      --v22;
    }
    while ( v22 );
  }
...
LABEL_26:
  ...
  *((_QWORD *)a1 + 482) = 0LL;
  ...
  RtlGetNtProductType((PNT_PRODUCT_TYPE)a1 + 1040);
