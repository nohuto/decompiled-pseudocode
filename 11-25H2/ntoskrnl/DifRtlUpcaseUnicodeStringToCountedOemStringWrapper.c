/*
 * XREFs of DifRtlUpcaseUnicodeStringToCountedOemStringWrapper @ 0x14062EC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlUpcaseUnicodeStringToCountedOemStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(151);
  ...
  LODWORD(v17) = RtlUpcaseUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
