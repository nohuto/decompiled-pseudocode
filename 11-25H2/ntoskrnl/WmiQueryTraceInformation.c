/*
 * XREFs of WmiQueryTraceInformation @ 0x140ACE5F0
 * Callers:
  ...
  if ( v11 > 7 )
  {
    ...
    if ( !v33 )
    {
      ...
      for ( i = 0; i < v39; ++i )
      {
        ...
        if ( v41 == EtwpHostSiloState )
          ...
          v42 = *(_QWORD *)(v41 + 4144) + ((unsigned __int64)i << 6);
    ...
    if ( v34 )
    {
      ...
      if ( !v35 )
      {
        ...
        *(_OWORD *)(v9 + 16) = *(_OWORD *)off_140B2FAE0;
        *(_OWORD *)(v9 + 32) = *(_OWORD *)&off_140B2FAF0;
        *(_OWORD *)(v9 + 48) = *(_OWORD *)&off_140B2FB00;
        *(_OWORD *)(v9 + 64) = *(_OWORD *)off_140B2FB10;
        *(_OWORD *)(v9 + 80) = *(_OWORD *)&off_140B2FB20;
        *(_OWORD *)(v9 + 96) = *(_OWORD *)off_140B2FB30;
