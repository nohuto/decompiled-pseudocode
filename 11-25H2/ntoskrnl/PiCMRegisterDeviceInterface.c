/*
 * XREFs of PiCMRegisterDeviceInterface @ 0x14095DC04
 * Callers:
...
LABEL_4:
  ...
  if ( !*((_QWORD *)&v24 + 1)
    || DWORD1(v23)
    || (v15 = (const wchar_t *)*((_QWORD *)&v25 + 1)) != 0LL && (unsigned int)v26 < 2
    || !a3
    || a4 < 0x14
    || a4 - 20 < 2 )
  {
  ...
  if ( v12 >= 0 )
  {
    v17 = IopRegisterDeviceInterface(v16, (int *)&v23 + 2, v15, 1, (PVOID *)&v22, 0LL);
    v9 = v22;
    v12 = v17;
    if ( v17 >= 0 )
    {
