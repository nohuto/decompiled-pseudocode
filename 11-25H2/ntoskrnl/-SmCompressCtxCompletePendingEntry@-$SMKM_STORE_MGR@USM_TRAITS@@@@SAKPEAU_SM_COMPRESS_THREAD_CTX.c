/*
 * XREFs of ?SmCompressCtxCompletePendingEntry@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU_SM_COMPRESS_THREAD_CTX@1@@Z @ 0x14049B3B8
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxCompletePendingEntry(__int64 a1)
{
  ...
  *v2 = *(_QWORD *)*v2 & 0xFFFFFFFFFFFFFFF8uLL;
  ...
  SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxCompleteEntry((_QWORD *)a1, v5, v9, v8, v6);
