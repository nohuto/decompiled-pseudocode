/*
 * XREFs of FsRtlAddBaseMcbEntryEx @ 0x1403D28E0
 * Callers:
          ...
          if ( v6 && (!PairCount || *((_DWORD *)Mcb->Mapping + 2 * PairCount - 2) != v6) )
          {
            if ( (unsigned __int8)FsRtlAddEntry(Mcb, PairCount, 2LL) )
            {
              ...
              *(_DWORD *)((char *)Mcb->Mapping + v35) = v6;
              v28 = 8LL * (PairCount + 1);
              *(_DWORD *)((char *)Mcb->Mapping + v28 + 4) = v5;
LABEL_34:
              *(_DWORD *)((char *)Mcb->Mapping + v28) = v6 + v4;
              return 0;
            }
            return -1073741670;
          }
...
LABEL_31:
          ...
          v50 = 2 * MaximumPairCount;
          if ( MaximumPairCount >= 0x800 )
            v50 = MaximumPairCount + 2048;
          v51 = 8LL * v50;
          v52 = v50;
          if ( v51 <= 0xFFFFFFFF )
          {
            PoolWithTag = (char *)ExAllocatePoolWithTag((POOL_TYPE)Mcb->PoolType, (unsigned int)v51, 0x6D695346u);
            v26 = PoolWithTag;
            if ( PoolWithTag )
            {
        ...
        v21 = v6 + v4;
        v22 = v6 + v4 - 1;
        if ( v36[(unsigned __int64)v20 / 4 + 1] == -1 )
        {
          v45 = v40 - 1;
          if ( !v40 || v36[2 * v45] <= v6 )
          {
            ...
            if ( v22 <= v46 )
            {
              ...
              if ( v48 < v6 && v22 < v46 )
              {
                if ( (unsigned __int8)FsRtlAddEntry(Mcb, v40, 2LL) )
                {
                  ...
                  *(_DWORD *)((char *)Mcb->Mapping + v20 + 4) = -1;
                  *(_DWORD *)((char *)Mcb->Mapping + v20) = v6;
                  *((_DWORD *)Mcb->Mapping + 2 * v49 + 1) = v79;
                  *((_DWORD *)Mcb->Mapping + 2 * v49) = v21;
                  return 0;
                }
                return -1073741670;
              }
              ...
              if ( v56 == v6 && v22 < v46 )
              {
                ...
                {
                  *(_DWORD *)((char *)Mcb->Mapping + v20 + 4) = v79;
                  *(_DWORD *)((char *)Mcb->Mapping + v20) = v21;
                  return 0;
                }
                return -1073741670;
              }
