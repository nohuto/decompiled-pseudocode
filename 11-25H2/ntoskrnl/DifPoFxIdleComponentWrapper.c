/*
 * XREFs of DifPoFxIdleComponentWrapper @ 0x14062B400
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxIdleComponentWrapper(ULONG_PTR a1, unsigned int a2, unsigned int a3)
{
