/*
 * XREFs of DbgkCaptureLiveDump @ 0x1406FBB5C
 * Callers:
 ...
 *     DbgkpLkmdSnapThread @ 0x14057B6A4 (DbgkpLkmdSnapThread.c)
 ...
 *     DbgkpLkmdSqmStatus @ 0x1406FC80C (DbgkpLkmdSqmStatus.c)
...
__int64 __fastcall DbgkCaptureLiveDump(__int64 a1, void *a2, unsigned int a3, __int64 a4)
{
  ...
  if ( v12 < 0 )
    goto LABEL_49;
  v12 = guard_dispatch_icall_no_overrides(v11 + 2048);
  if ( v12 < 0 )
    goto LABEL_49;
...
LABEL_33:
  ...
  if ( !v6 )
  {
    ...
    if ( v20 )
    {
      ...
      DbgkpLkmdSnapDataEx((__int64)v11);
    }
  }
...
LABEL_44:
  ...
  if ( (int)DbgkpLkmdSnapDataEx((__int64)v11) >= 0 )
    *v32 = &v30;
  v12 = guard_dispatch_icall_no_overrides(v11 + 2048);
LABEL_45:
  if ( v6 )
