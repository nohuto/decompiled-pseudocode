/*
 * XREFs of IopDeleteIoCompletionInternal @ 0x14041E268
 * Callers:
 *     IopCloseIoCompletion @ 0x140A35AF0 (IopCloseIoCompletion.c)
 *     IopDeleteIoCompletion @ 0x140A48340 (IopDeleteIoCompletion.c)
 * Callees:
