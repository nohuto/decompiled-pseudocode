/*
 * XREFs of KsepGetShimCallbacksForDriver @ 0x140A50334
 * Callers:
...
__int64 __fastcall KsepGetShimCallbacksForDriver(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a2 )
  {
    ...
    dword_140F0ECA4[2 * v6] = -1073740768;
    KsepHistoryErrors[2 * v6] = 459519;
    if ( (KsepDebugFlag & 4) != 0 )
      RtlAssert("IoCallbacks != NULL", "minkernel\\ntos\\kshim\\kseloader.c", 0x2FFu, 0LL);
  }
    ...
    while ( 1 )
    {
      if ( (*(_DWORD *)(*(_QWORD *)v9 + 28LL) & 4) == 0 )
      {
        ...
        if ( !v11 )
        {
          ...
          dword_140F0ECA4[2 * v12] = -1073740768;
          KsepHistoryErrors[2 * v12] = 459572;
          if ( (KsepDebugFlag & 4) != 0 )
          {
            RtlAssert("CurrentShim != NULL", "minkernel\\ntos\\kshim\\kseloader.c", 0x334u, 0LL);
            v10 = v25;
          }
        }
        v13 = *(_DWORD **)(v11 + 48);
      ...
      switch ( *(_DWORD *)(v18 + v19 + 8) )
      {
        case 1:
          if ( *a2 )
          {
            ...
            KsepHistoryErrors[2 * (unsigned int)v21] = 459600;
            goto LABEL_40;
          }
        ...
        case 2:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&KsepHistoryErrorsIndex, 1u) + 1) & 0x3F;
            KsepHistoryErrors[2 * (unsigned int)v21] = 459615;
            goto LABEL_40;
          }
        ...
        case 3:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&KsepHistoryErrorsIndex, 1u) + 1) & 0x3F;
            KsepHistoryErrors[2 * (unsigned int)v21] = 459630;
            goto LABEL_40;
          }
        ...
        case 4:
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&KsepHistoryErrorsIndex, 1u) + 1) & 0x3F;
            KsepHistoryErrors[2 * (unsigned int)v21] = 459645;
            goto LABEL_40;
          }
        ...
        default:
          ...
          if ( (unsigned int)v20 > 0x1B )
          {
            ...
            dword_140F0ECA4[2 * v22] = -1073741811;
            KsepHistoryErrors[2 * v22] = 459676;
            if ( (KsepDebugFlag & 2) != 0 )
              KsepDebugPrint(9LL, (int)"KSE: Invalid callback code encountered: %u\n", *(unsigned int *)(v18 + v19 + 8));
          ...
          {
            v21 = ((unsigned __int8)_InterlockedExchangeAdd(&KsepHistoryErrorsIndex, 1u) + 1) & 0x3F;
            KsepHistoryErrors[2 * (unsigned int)v21] = 459663;
LABEL_40:
            dword_140F0ECA4[2 * v21] = -1073741823;
            if ( (KsepDebugFlag & 2) != 0 )
...
LABEL_49:
  KsepHistoryMessages[((unsigned __int8)_InterlockedExchangeAdd(&KsepHistoryMessagesIndex, 1u) + 1) & 0x3F] = 459696LL;
