/*
 * XREFs of CmFcInitSystem3 @ 0x140C4DE90
 * Callers:
...
CCHAR CmFcInitSystem3()
{
  volatile CCHAR result; // al
  char *v1; // r8
  ...
  TlgRegisterAggregateProvider((__int64)&dword_140E09DD0);
  result = KeNumberProcessorsGroup0[1];
  if ( (unsigned int)dword_140E09DD0 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140E09DD0, 0x400000000000LL);
    if ( result )
    {
      v2 = *v1;
      v13 = 1LL;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)byte_1400531B1,
               0LL,
               0LL,
               0xBu,
               &v11);
