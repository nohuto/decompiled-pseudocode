/*
 * XREFs of TtmiLogSessionPowerControlStart @ 0x14075E510
 * Callers:
...
void __fastcall TtmiLogSessionPowerControlStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v13 = 1;
    v7 = a2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&dword_14004E544, 0LL, 0LL, 5u, &v8);
  }
}
