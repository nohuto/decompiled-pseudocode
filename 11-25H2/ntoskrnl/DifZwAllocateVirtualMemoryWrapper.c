/*
 * XREFs of DifZwAllocateVirtualMemoryWrapper @ 0x14062F8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAllocateVirtualMemoryWrapper(
        void *a1,
        PVOID *a2,
        ULONG_PTR a3,
        ULONG_PTR *a4,
        ...
        ULONG Protect)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(144);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v19 + 1) = a1;
    *((_QWORD *)&v17 + 1) = __PAIR64__(AllocationType, Protect);
    *(_QWORD *)&v19 = a2;
    *((_QWORD *)&v18 + 1) = a3;
    *(_QWORD *)&v18 = a4;
  ...
  LODWORD(v20) = ZwAllocateVirtualMemory(a1, a2, a3, a4, AllocationType, Protect);
  if ( v10 )
  {
