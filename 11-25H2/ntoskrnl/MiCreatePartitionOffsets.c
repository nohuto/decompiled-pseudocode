/*
 * XREFs of MiCreatePartitionOffsets @ 0x1407DC65C
 * Callers:
 *     MmCreatePartition @ 0x1407ECA7C (MmCreatePartition.c)
 *     MiCreatePfnDatabase @ 0x140C3DC60 (MiCreatePfnDatabase.c)
 * Callees:
 *     MiComputePartitionHugeIoSpaceSize @ 0x140664028 (MiComputePartitionHugeIoSpaceSize.c)
 *     MiFreeCachedKernelShadowStackEntryCount @ 0x140674630 (MiFreeCachedKernelShadowStackEntryCount.c)
 */
...
__int64 __fastcall MiCreatePartitionOffsets(_QWORD *a1, __int64 a2)
{
  ...
  v5 = dword_140E2D98C * (unsigned __int16)KeNumberNodes;
  if ( a1 )
    a1[891] = a2;
