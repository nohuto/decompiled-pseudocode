/*
 * XREFs of CcInitializePartition @ 0x140579A18
 * Callers:
...
char __fastcall CcInitializePartition(char *StartContext, _QWORD *a2)
{
  ...
  *((_WORD *)StartContext + 520) = 0;
  v9 = *((_QWORD *)StartContext + 1);
  StartContext[1048] = 1;
  NumberOfPhysicalPagesForPartitionObject = MmGetNumberOfPhysicalPagesForPartitionObject(v9);
  v13 = NumberOfPhysicalPagesForPartitionObject;
  if ( (_BYTE)dword_140FC420C )
  {
    v14 = NumberOfPhysicalPagesForPartitionObject >> 1;
    v12 = StartContext;
    if ( (unsigned int)CcAzure_TopBottomDPTEqual < 2 )
      v11 = v14;
    else
      v11 = v13 >> 3;
    *((_QWORD *)StartContext + 136) = v14;
    *((_QWORD *)StartContext + 137) = v11;
    *((_QWORD *)StartContext + 135) = v14;
    v15 = ExCriticalWorkerThreads - 1;
  }
  else
  {
    v16 = NumberOfPhysicalPagesForPartitionObject >> 3;
    *((_QWORD *)StartContext + 135) = v16;
    *((_QWORD *)StartContext + 137) = v16;
    *((_QWORD *)StartContext + 136) = v16;
    v15 = 1;
  }
  *((_DWORD *)StartContext + 216) = v15;
  *((_DWORD *)StartContext + 282) = 10;
  *((_QWORD *)StartContext + 139) = 10 * v13;
  v17 = ExCriticalWorkerThreads - 1;
  *((_QWORD *)StartContext + 140) = 0LL;
  *((_DWORD *)StartContext + 210) = v17;
  *((_DWORD *)StartContext + 217) = CcMaxCachemapUninitWorkerThreads;
  v18 = (*((_QWORD *)StartContext + 135) >> 1) + (*((_QWORD *)StartContext + 135) >> 2);
  if ( CcAzure_LazyWriterPercentageOfNumProcs )
  {
    v13 = CcAzure_LazyWriterPercentageOfNumProcs * KeQueryActiveProcessorCountEx(0xFFFFu) / 0x64;
    if ( *((_DWORD *)StartContext + 210) < (unsigned int)v13 )
      *((_DWORD *)StartContext + 210) = v13;
  }
  StartContext[1294] = 0;
  ...
  *((_QWORD *)StartContext + 152) = 0LL;
  if ( v18 > 0xFFFFFFFF )
    LODWORD(v18) = -1;
  v19 = CcEnablePerVolumeLazyWriter == 0;
  *((_DWORD *)StartContext + 276) = v18;
  ...
  *((_QWORD *)StartContext + 182) = 0LL;
  if ( v19 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    {
      if ( !(unsigned __int8)CcInitializeNumaNode(StartContext, &v22[400 * i], v11, i) )
        goto LABEL_28;
      v4 = 0LL;
    }
  }
  if ( (unsigned __int8)CcInitializePartitionVacbs(StartContext, v13, v11, v12) )
  {
    v24 = ExAllocatePoolWithTag((POOL_TYPE)1536, 8LL * (unsigned int)(*((_DWORD *)StartContext + 216) + 1), 0x70546343u);
    if ( v24 )
    {
      v19 = CcEnablePerVolumeLazyWriter == 0;
      *((_QWORD *)StartContext + 142) = v24;
      if ( v19 )
      {
      ...
      PoolWithTagFromNode = ExAllocatePoolWithTagFromNode(v25, 0x50uLL, 0x71576343uLL, 0x80000000uLL);
      ...
      *(_QWORD *)PoolWithTagFromNode = 0LL;
      v27 = (__int64 *)*((_QWORD *)StartContext + 13);
      if ( (char *)*v27 == v6 )
      {
        *(_QWORD *)PoolWithTagFromNode = v6;
        *(_QWORD *)(PoolWithTagFromNode + 8) = v27;
        *v27 = PoolWithTagFromNode;
