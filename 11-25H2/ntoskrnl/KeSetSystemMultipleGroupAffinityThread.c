/*
 * XREFs of KeSetSystemMultipleGroupAffinityThread @ 0x1404C641C
 * Callers:
 *     PsSetSystemMultipleGroupAffinityThread @ 0x1405D9640 (PsSetSystemMultipleGroupAffinityThread.c)
...
LABEL_35:
    ...
    KiSetSystemAffinityThread(CurrentPrcb, *(char **)(a3 + 24), 0LL, 0x800u, (__int64)&v25);
