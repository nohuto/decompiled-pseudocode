/*
 * XREFs of TtmiLogDeviceFromTerminalRemoved @ 0x14075CE40
 * Callers:
...
char __fastcall TtmiLogDeviceFromTerminalRemoved(int a1, int a2, __int64 a3, int a4)
{
  ...
  v4 = &retaddr;
  if ( (unsigned int)dword_140FD78E8 > 5 )
  {
    LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140FD78E8, 1LL);
    if ( (_BYTE)v4 )
    {
      ...
      LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                     (__int64)&dword_140FD78E8,
                     (unsigned __int8 *)&word_14004E6A6,
                     0LL,
                     0LL,
                     7u,
                     &v16);
