/*
 * XREFs of sub_140A3DFCC @ 0x140A3DFCC
 * Callers:
...
__int64 __fastcall sub_140A3DFCC(__int64 a1, __int64 a2)
{
  ...
  for ( i = 0; i < *(_DWORD *)(a1 + 140); ++i )
  {
    ...
    if ( v11 )
    {
      if ( *(_QWORD *)(v11 + 32) == a2 )
      {
        v6 = sub_140A3E0E8((int)a1 + 136, 0, 0, i, 0LL);
        if ( v6 >= 0 )
        {
          sub_1409E1224((volatile signed __int64 *)v11);
          --i;
        }
      }
    }
