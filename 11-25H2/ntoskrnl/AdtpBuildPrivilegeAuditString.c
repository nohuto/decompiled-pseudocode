/*
 * XREFs of AdtpBuildPrivilegeAuditString @ 0x140A4C4BC
 * Callers:
 ...
 *     AdtpLookupKnownPrivilegeNameQuickly @ 0x1404A375C (AdtpLookupKnownPrivilegeNameQuickly.c)
