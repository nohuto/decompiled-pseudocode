/*
 * XREFs of EmonEnableMonitoringEnhanced @ 0x140558960
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EmonConfigureCounter @ 0x140558610 (EmonConfigureCounter.c)
 */

__int64 __fastcall EmonEnableMonitoringEnhanced(int a1, int a2, _DWORD *a3, int *a4, int *a5, int *a6)
{
  ...
  if ( ProfileDescriptor >= 0 )
  {
    ...
    {
      ProfileDescriptor = EmonAllocateCounterEnhanced(a1, v12, a2, &v20, a6);
      if ( ProfileDescriptor >= 0 )
      {
        v16 = v20;
        v17 = v20;
  ...
  HalpReleaseHighLevelLock((__int64)&HalpProfileSourceDescriptorListLock, v8);
