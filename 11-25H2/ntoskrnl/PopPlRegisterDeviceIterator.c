/*
 * XREFs of PopPlRegisterDeviceIterator @ 0x1405D7BA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopPlCalculateDevicePowerDraw @ 0x1405D76B4 (PopPlCalculateDevicePowerDraw.c)
...
char __fastcall PopPlRegisterDeviceIterator(__int64 a1, _DWORD *a2, __int64 a3)
{
  ...
  {
    for ( i = 0LL; i < *(unsigned int *)(v3 + 868); PopPlRegisterComponent(*(_QWORD *)(*(_QWORD *)(v3 + 872) + 8 * i++)) )
      ;
    v15 = 0;
    v6 = *(_QWORD *)(v3 + 1224);
    v16 = 1;
    ...
    *(_DWORD *)(v6 + 32) = v7;
    ...
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      ...
      v39 = 4;
      v38 = &v19;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140E07680, (unsigned __int8 *)&byte_14004D4D0, v8, 1u, v13, v14, 9u, &v20);
    }
    *a2 += *(_DWORD *)(v6 + 32);
  }
  return 1;
