/*
 * XREFs of MiObtainDynamicVa @ 0x14038EB7C
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x140390714 (MiFindNextAlignedForwardRunClearEx.c)
 */
...
LABEL_39:
  ...
  if ( v7 == &qword_140E2ED40 )
  {
    qword_140E2EB88 -= v28 << 21;
    if ( (unsigned __int64)qword_140E2EB88 <= 0x8000000 )
      KeSetEvent(&Event, 0, 0);
  }
  _InterlockedAdd64(&qword_140E386C8[v33], v28);
  MiReleaseSpinLockExclusive(v11, v100);
