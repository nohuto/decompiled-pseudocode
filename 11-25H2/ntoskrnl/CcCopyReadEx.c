/*
 * XREFs of CcCopyReadEx @ 0x1404DC880
 * Callers:
 *     FsRtlCopyRead @ 0x140A1D340 (FsRtlCopyRead.c)
 *     CcCopyRead @ 0x140A4AB20 (CcCopyRead.c)
 *     CcFastCopyRead @ 0x140A75A00 (CcFastCopyRead.c)
 * Callees:
        ...
        struct _KTHREAD *a7)
{
  ...
  if ( !byte_140F8DD41 )
  {
    ...
    if ( v30 )
    {
      ...
      if ( v32 )
      {
        v26 = 1000000 * (*(_QWORD *)&KeQueryPerformanceCounter(0LL) - v25) / stru_140F8DD08.QuadPart;
        v37 = v26;
      }
      else
      {
