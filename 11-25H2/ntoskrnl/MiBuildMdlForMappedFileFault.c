/*
 * XREFs of MiBuildMdlForMappedFileFault @ 0x140339828
 * Callers:
        ...
        __int64 a10)
{
  ...
  *(&BitMapHeader.SizeOfBitMap + 1) = 0;
  ...
  else
  {
    ...
    if ( (v14 & 0x400) == 0 )
    {
      if ( qword_140E2D940 && (v14 & 0x10) == 0 )
        v24 = v14 & ~qword_140E2D940;
      v68 = 48 * ((v24 >> 12) & 0xFFFFFFFFFFLL) - 0x220000000000LL;
      v24 = *(_QWORD *)(v68 + 16);
    }
    v25 = v67;
    MiGetHardFaultPages((__int64)&v60, v19, a4, v67, a9, v63, v24, a10);
    v20 = v61;
  }
  v66 = v20;
  v26 = v20;
  if ( (_DWORD)v20 != v15 )
  {
    ...
    v58 = v15 - MiReduceMappedFileReadBehind(&BitMapHeader, v57);
    if ( (_DWORD)v20 != v58 )
...
LABEL_32:
      ...
      if ( v29 )
      {
        ...
        {
          if ( v54 < 2
            || v31 <= (unsigned __int64 *)&qword_140E370F8 && &v31[v54 - 1] >= (unsigned __int64 *)&qword_140E370F8 )
          {
            goto LABEL_58;
          }
          v55 = v54 & 0xFFFFFFFE;
          ...
          memset64(v31, qword_140E370F8, v54 & 0xFFFFFFFE);
          v31 += v55;
          if ( v53 < v54 )
          {
LABEL_58:
