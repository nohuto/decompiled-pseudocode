/*
 * XREFs of WheapExecuteRowFailureCheck @ 0x1407B9718
 * Callers:
...
char __fastcall WheapExecuteRowFailureCheck(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v32 = 0LL;
  v33 = 0LL;
  if ( *(_BYTE *)off_140E09698 )
  {
    v8 = (PVOID *)WheapPfaList;
    v9 = 1;
    v10 = a1;
    v11 = a1;
    v12 = *(_DWORD *)off_140E096B8;
    v13 = *(unsigned int *)off_140E09678;
    v14 = a1 - v13;
    if ( a1 < v13 )
      v14 = 0LL;
    v15 = v13 + a1;
...
LABEL_40:
    ...
    else
    {
      ...
      *((_QWORD *)&v33 + 1) = v11;
      ...
      if ( WheaGetNotifyAllOfflinesPolicy() && *(_BYTE *)off_140E096F8 )
      {
