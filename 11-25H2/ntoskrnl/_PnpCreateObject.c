/*
 * XREFs of _PnpCreateObject @ 0x14080AA5C
 * Callers:
...
__int64 __fastcall PnpCreateObject(__int64 a1, int a2, int a3, int a4, HANDLE *a5)
{
  __int64 v5; // r14
  __int64 v9; // rsi
  int v10; // eax
  ...
  if ( v9 )
  {
    v10 = guard_dispatch_icall_no_overrides(v5);
    if ( v10 == -1073741822 )
    {
      v9 = 0LL;
    }
  ...
  if ( v9 )
  {
    ...
    v13 = guard_dispatch_icall_no_overrides(v5);
    if ( v13 != -1073741822 )
    {
      if ( v13 != -1073741536 )
      {
