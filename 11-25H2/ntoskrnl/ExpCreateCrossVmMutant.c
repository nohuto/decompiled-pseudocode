/*
 * XREFs of ExpCreateCrossVmMutant @ 0x1407B5C58
 * Callers:
 *     NtCreateCrossVmMutant @ 0x1407B5670 (NtCreateCrossVmMutant.c)
 * Callees:
...
__int64 __fastcall ExpCreateCrossVmMutant(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
