/*
 * XREFs of MiProcessLargeCoalesceBitmapCandidates @ 0x14034F7E0
 * Callers:
        ...
        __int64 a8)
{
  ...
  while ( (unsigned __int64)a4 <= a5 )
  {
    ...
    {
      v15 = MiCoalesceFreeLargePages(v12, a2, (unsigned int)(v13 + 1), (unsigned __int8)v10);
    }
    else
    {
      v15 = 0;
      if ( (_BYTE)v10 == 2 )
        v16 = MiSafeLockPageAtDpc(a2, v10, 0x140000000LL);
      else
      ...
      v28 = v18;
      if ( *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v18 + 40) >> 43) & 0x3FFLL)) == a1 )
      {
