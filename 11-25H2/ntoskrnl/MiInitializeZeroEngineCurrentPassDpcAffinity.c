/*
 * XREFs of MiInitializeZeroEngineCurrentPassDpcAffinity @ 0x140688294
 * Callers:
        ...
        if ( *((_WORD *)v6 + 8) )
        {
          do
          {
            ...
            while ( v13 )
            {
              ...
              v15 = *(_DWORD *)(v14 + 36408);
              if ( *(_BYTE *)(a1 + 25) )
                v15 += *(_DWORD *)(*(_QWORD *)(qword_140E2D8B8 + 384LL * *(unsigned int *)(v14 + 34644) + 376) + 12LL);
