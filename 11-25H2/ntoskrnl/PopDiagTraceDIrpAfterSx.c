/*
 * XREFs of PopDiagTraceDIrpAfterSx @ 0x1403565F8
 * Callers:
...
char __fastcall PopDiagTraceDIrpAfterSx(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v13[4] = (__int64)&v11;
      v13[5] = 4LL;
      tlgCreate1Sz_wchar_t(v14, v6);
      v12 = 0x1000000LL;
      v15 = &v12;
      v16 = 8LL;
      LOBYTE(v5) = tlgWriteEx_EtwWriteEx((int)&dword_140E07680, (int)&word_14004B19A, v7, 1, v9, v10, 5u, (__int64)v13);
    }
  }
  return v5;
}
