/*
 * XREFs of CmpFinishSystemHivesLoad @ 0x1407BAA30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlUnicodeStringCopyString @ 0x140466D10 (RtlUnicodeStringCopyString.c)
...
_KAFFINITY_EX *__fastcall CmpFinishSystemHivesLoad(PRKEVENT Event)
{
  ...
  if ( !Event )
  {
    KeWaitForSingleObject(&stru_140E099D0, Executive, 0, 0, 0LL);
    KeSetEvent(&stru_140E099D0, 0, 0);
    KiStackAttachProcess(PsInitialSystemProcess, 0, (__int64)&v77.StaticBitmap[1]);
    LOBYTE(v9) = CmpInitRmLogOnLoad;
    CmpInitCmRM(0LL, v9);
    KiUnstackDetachProcess((__int64)&v77.StaticBitmap[1], 0LL);
    if ( CmRmSystem )
    {
          ...
          do
          {
            if ( *((_DWORD *)v52 - 17) && !*((_BYTE *)v52 - 80) )
            {
              ...
              if ( _interlockedbittestandset64((volatile signed __int32 *)v52, 0LL) )
                ExfAcquirePushLockExclusiveEx(v52, v53, (__int64)v52);
              if ( v54 )
                *((_BYTE *)v54 + 10) = 1;
  ...
  if ( Event )
  {
    ...
    do
    {
      ...
      if ( _interlockedbittestandset64((volatile signed __int32 *)v60, 0LL) )
        ExfAcquirePushLockExclusiveEx(v60, v61, (__int64)v60);
      if ( v62 )
        *((_BYTE *)v62 + 10) = 1;
...
LABEL_132:
  ...
  CmSiFreeMemory(Pool);
  return CmCleanupThreadInfo((_KAFFINITY_EX **)&v77);
}
