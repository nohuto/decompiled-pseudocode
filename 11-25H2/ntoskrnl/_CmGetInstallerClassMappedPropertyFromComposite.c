/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromComposite @ 0x1409AB44C
 * Callers:
  ...
  else
  {
    if ( v16 != 4 )
    {
      if ( v16 == 20 )
      {
        ...
        if ( !v17 )
          return (unsigned int)CmGetInstallerClassCompoundFilters(v13, (__int64)v8, v11, v15, (__int64)v9);
      }
      if ( v16 == 21 )
      {
