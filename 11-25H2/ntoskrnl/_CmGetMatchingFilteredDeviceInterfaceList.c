/*
 * XREFs of _CmGetMatchingFilteredDeviceInterfaceList @ 0x1409A013C
 * Callers:
...
{
  _QWORD *v13; // rcx
  __int64 (__fastcall *v14)(void *, PCWSTR, unsigned int, int, int, __int64); // r10
  int v15; // eax
  unsigned int v16; // ebx
  __int64 (__fastcall *v18)(void *, PCWSTR, unsigned int, int, int, __int64); // rdi
  unsigned int MatchingFilteredDeviceInterfaceListWorker; // eax
  int v20; // eax
  int v21; // ecx
  unsigned int v22; // eax
  __int64 (__fastcall *v24)(void *, PCWSTR, unsigned int, int, int, __int64); // [rsp+58h] [rbp-79h]
  ...
  v33 = a9;
  v32 = a8;
  v14 = (__int64 (__fastcall *)(void *, PCWSTR, unsigned int, int, int, __int64))a1[63];
  v26 = a2;
  v27 = a3;
  v29 = a5;
  v24 = v14;
  ...
  if ( v14 )
  {
    if ( v14 == PiPnpRtlCmActionCallback )
      v15 = PiPnpRtlCmActionCallback(a1, 0LL, 3u, 17, 1, (__int64)v25);
    else
  ...
  if ( v18 )
  {
    ...
    v20 = guard_dispatch_icall_no_overrides(a1);
    v21 = v20;
    if ( v20 != -1073741822 )
    {
      if ( v20 == -1073741536 )
