/*
 * XREFs of KeSetUserCetAppcompatOptions @ 0x1405C2610
 * Callers:
 *     KseUserCetBasicModeAllowRetTargetNotCetCompatHookDriverTargeted @ 0x1405C7CB0 (KseUserCetBasicModeAllowRetTargetNotCetCompatHookDriverTargeted.c)
 * Callees:
...
void KeSetUserCetAppcompatOptions()
{
    ...
    && tlgKeywordOn((__int64)&dword_140E070B8, 0x400000000000LL) )
  {
    ...
    v1 = 0x1000000LL;
    v7 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E070B8, (unsigned __int8 *)word_1400479BA, 0LL, 0LL, 4u, &v2);
  }
}
