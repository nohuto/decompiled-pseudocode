/*
 * XREFs of RtlpHpHeapAllocate @ 0x1405F8788
 * Callers:
 ...
 *     RtlpHpLfhContextMaximumExtension @ 0x1405FA460 (RtlpHpLfhContextMaximumExtension.c)
 *     memset_0 @ 0x1406B4D40 (memset_0.c)
 */

unsigned __int64 __fastcall RtlpHpHeapAllocate(int a1, unsigned int a2, __int128 *a3)
{
  unsigned int v6; // eax
  __int128 v7; // xmm0
  ...
  int v22[4]; // [rsp+60h] [rbp-10h] BYREF
  unsigned __int64 v23; // [rsp+C0h] [rbp+50h] BYREF
    ...
    || (v20 & 6) != 6 && (unsigned __int8)(BYTE1(v20) - 2) > 2u )
  {
    ...
    *(_OWORD *)v22 = v7;
    if ( (int)RtlpHpAllocVA(&v23, (__int64 *)&v19, 0LL, 0x2000, v17, v22) < 0
      || (LODWORD(v18) = (a1 & 0x40000000) != 0 ? 64 : 4,
          *(_OWORD *)v21 = *a3,
          (int)RtlpHpAllocVA(&v23, (__int64 *)&v24, 0LL, 4096, v18, v21) < 0) )
    {
      v15 = 0LL;
      goto LABEL_13;
    }
...
LABEL_13:
  ...
  {
    *(_OWORD *)v22 = *a3;
    RtlpHpFreeVA(&v23, &v19, 0x8000LL, v22);
  }
  return v15;
}
