/*
 * XREFs of MiLogHotPatchManagement @ 0x140AD5BD4
 * Callers:
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    if ( a1 )
    {
      if ( a1 == 3 )
      {
        ...
        {
          LOBYTE(CurrentThread) = tlgKeywordOn(*(__int64 *)&qword_140E372D8, 32LL);
          if ( (_BYTE)CurrentThread )
          {
            ProcessId = (unsigned int)PsGetProcessId(Process);
            v11 = (unsigned __int8 *)&unk_140055EE8;
            v25 = 4LL;
...
LABEL_15:
            v29 = 4LL;
            LOBYTE(CurrentThread) = tlgWriteEx_EtwWriteEx(v9, v11, v10, 1u, v14, v15, v16, &v23);
          }
        }
      }
      else if ( a1 == 7 )
      {
        ...
        if ( **(_DWORD **)&qword_140E372D8 > 5u )
        {
          ...
          {
            ProcessId = (unsigned int)PsGetProcessId(Process);
            v11 = (unsigned __int8 *)&unk_140056098;
            v19 = a4;
            v31 = 8LL;
            p_ProcessId = &ProcessId;
            v26 = &v19;
    ...
    else
    {
      ...
      if ( **(_DWORD **)&qword_140E372D8 > 5u )
      {
        ...
        if ( (_BYTE)CurrentThread )
        {
          ...
          v11 = (unsigned __int8 *)&unk_140055F68;
          v18 = a4;
