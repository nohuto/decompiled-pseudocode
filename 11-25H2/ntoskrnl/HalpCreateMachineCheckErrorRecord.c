/*
 * XREFs of HalpCreateMachineCheckErrorRecord @ 0x14053C6C0
 * Callers:
 *     HalpCreateErrorRecord @ 0x14053C670 (HalpCreateErrorRecord.c)
 * Callees:
 ...
 *     HalpMcaAMDIsMemoryError @ 0x140540F38 (HalpMcaAMDIsMemoryError.c)
