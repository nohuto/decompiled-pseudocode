/*
 * XREFs of DifRtlUpcaseUnicodeStringToOemStringWrapper @ 0x14062ED80
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v17) = RtlUpcaseUnicodeStringToOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
