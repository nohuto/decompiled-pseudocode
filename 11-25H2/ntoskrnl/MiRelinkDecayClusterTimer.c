/*
 * XREFs of MiRelinkDecayClusterTimer @ 0x14021C10C
 * Callers:
...
unsigned __int64 __fastcall MiRelinkDecayClusterTimer(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(a1 + 32) = v10;
  ...
  v5 = 0xAAAAAAAAAAAAAAABuLL * ((a1 + 0x220000000000LL) >> 4) - qword_140E358C0;
  v6 = v4 >> 1;
  *(_QWORD *)(a1 + 8) = (unsigned int)v4 & 0xFFFFFFFE | 0xFFFFFFFE00000000uLL;
  ...
  else
  {
    ...
    *(_QWORD *)(48 * (v6 + qword_140E358C0) - 0x220000000000LL + 8) = v7 | *(_QWORD *)(48 * (v6 + qword_140E358C0)
                                                                                     - 0x220000000000LL
                                                                                     + 8) & 0x1FFFFFFFFLL;
  }
  v8 = v4 ^ (2 * v5);
