/*
 * XREFs of Amd64InitializeProfilingOriginal @ 0x140B41488
 * Callers:
 ...
 *     Amd64FreeCounter @ 0x140567EA4 (Amd64FreeCounter.c)
 *     Amd64GetGenericPerfEvent @ 0x1405680FC (Amd64GetGenericPerfEvent.c)
  ...
  if ( !Number )
  {
    ...
    if ( (_RCX & 0x1000000) != 0 && (_RCX & 0x400000) != 0 )
    {
      ...
      *(__int128 *)((char *)&Amd64EventSelectRegisters + 4 * v11) = (__int128)_mm_load_si128((const __m128i *)&_xmm_c0010246c0010244c0010242c0010240);
      qword_140F8E338 = (__int64)&Amd64DataFabricStatusHead;
    ...
    if ( (_RCX & 0x10000000) != 0 && (_RCX & 0x400000) != 0 )
    {
      ...
      while ( v18 );
      qword_140F8E3A8 = (__int64)&Amd64CacheStatusHead;
    ...
    qword_140FC16E8 = (__int64)&HalpProfileSourceDescriptorListHead;
    v55 = 0;
    ...
    do
    {
      ...
      if ( !v57 )
      {
        ...
        v60 = (__int64 *)qword_140FC16E8;
        if ( *(__int64 **)qword_140FC16E8 != v54 )
          __fastfail(3u);
        ++HalpProfileSourceDescriptorCount;
        *v59 = v54;
        v59[1] = v60;
        *v60 = (__int64)v59;
        qword_140FC16E8 = (__int64)&unk_140E05538 + 320 * v55;
      }
      ++v55;
    }
    while ( v55 < 0x12 );
