/*
 * XREFs of RtlFindNextClearRunUlong @ 0x1403DB068
 * Callers:
 *     MiRescanPagefileBitmaps @ 0x1403D965C (MiRescanPagefileBitmaps.c)
 *     MiFindFreePageFileSpaceForward @ 0x1403DA484 (MiFindFreePageFileSpaceForward.c)
...
__int64 __fastcall RtlFindNextClearRunUlong(unsigned int *a1, unsigned int a2, __int64 a3, unsigned int a4, _DWORD *a5)
{
  ...
  if ( !v10 )
    v12 = v8 + 4 * v9;
  v13 = *v11 | *((_DWORD *)qword_1400122D0 + (a2 & 0x1F));
  v14 = 0;
  do
  {
    while ( 1 )
...
LABEL_13:
    v18 = v14 & 0x1F;
    v19 = 0;
    v13 &= ~*((_DWORD *)qword_1400122D0 + v18);
    if ( (unsigned __int64)v11 <= v12 )
    {
      v20 = 0;
      while ( !v13 )
...
LABEL_14:
      ...
      if ( !v19 )
        v11 = v21;
      v13 |= ~*((_DWORD *)qword_1400122D0 + (v7 & 0x1F));
    }
    v22 = -1;
