/*
 * XREFs of DifExEnterPriorityRegionAndAcquireResourceExclusiveWrapper @ 0x140612170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExEnterPriorityRegionAndAcquireResourceExclusiveWrapper(PERESOURCE Resource)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(403);
  ...
  v12 = ExEnterPriorityRegionAndAcquireResourceExclusive(Resource);
  if ( v3 )
  {
