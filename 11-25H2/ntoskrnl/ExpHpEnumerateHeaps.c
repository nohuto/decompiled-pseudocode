/*
 * XREFs of ExpHpEnumerateHeaps @ 0x140487E44
 * Callers:
 *     ExpHpCompactionRoutine @ 0x140487E00 (ExpHpCompactionRoutine.c)
...
__int64 __fastcall ExpHpEnumerateHeaps(int a1)
{
  ...
  {
    v4 = v2;
    if ( v1 >= dword_140E6B950 )
      break;
    while ( v4 <= v3 )
    {
      v5 = *((_QWORD *)&unk_140E6B980 + 1048 * v1 + v4);
      if ( v5 )
      {
