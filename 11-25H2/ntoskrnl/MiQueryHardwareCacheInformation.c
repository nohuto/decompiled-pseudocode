/*
 * XREFs of MiQueryHardwareCacheInformation @ 0x140C48E04
 * Callers:
...
__int64 MiQueryHardwareCacheInformation()
{
  ...
  if ( (unsigned int)dword_140E2D8F4 < 0x4000 )
    dword_140E2D8F4 = 0x4000;
  dword_140E2D91C = 256;
  SecondLevelCacheSize = KeGetPcr()->SecondLevelCacheSize;
  dword_140E2D8F0 = SecondLevelCacheSize;
  ...
  result = guard_dispatch_icall_no_overrides(50LL);
  if ( (int)result >= 0 )
  {
  ...
  dword_140E2D98C = SecondLevelCacheSize;
  HIDWORD(qword_140E2D984) = SecondLevelCacheSize >> 4;
  return result;
}
