/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x1404810EC
 * Callers:
...
__int64 __fastcall GxpWriteFrameBufferPixels(__int64 a1, _DWORD *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( !(_BYTE)BgInternal )
    {
      ...
      v16 = ((__int64 (__fastcall *)(_DWORD *, _DWORD *, _QWORD))qword_140EEFD40)(v38, v2, 0LL);
      if ( v24 && v24 != v44 )
    ...
    v7 = BitsPerPixel >> 3;
    v8 = v7 * v37;
    v9 = (char *)qword_140EEFD40 + v7 * (*v2 + v2[1] * v33);
    v34 = v7 * v37;
    if ( !BYTE2(BgInternal) )
      goto LABEL_12;
...
LABEL_29:
              memmove((char *)qword_140EEFD40 + v7 * (*v2 + v33 * ((_DWORD)v19 + v2[1]) + (_DWORD)v20), v17, v7);
              v17 = (char *)(v7 + v31);
            }
            v8 = v34;
          }
