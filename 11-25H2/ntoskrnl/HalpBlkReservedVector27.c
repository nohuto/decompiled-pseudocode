/*
 * XREFs of HalpBlkReservedVector27 @ 0x140BCB600
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn HalpBlkReservedVector27(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  __int64 v5; // r10
  __int64 v6; // r11
  ...
  v27 = v11;
  v28 = v12;
  _InterlockedIncrement64(MK_FP(__GS__, 384LL));
  HalpBlkFatalErrorHalt(0x1Bu, (unsigned __int64)v14);
}
