/*
 * XREFs of MiUnlinkSecondaryListStandbyPage @ 0x140215A30
 * Callers:
...
__int64 __fastcall MiUnlinkSecondaryListStandbyPage(__int64 a1, int a2)
{
  ...
  v32 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v5 - 0x220000000000LL + 40) >> 43) & 0x3FFLL));
  v7 = dword_140E2D884;
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (v8 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, v4 < *(_QWORD *)v8)
    || dword_140E2D880 != dword_140E2D884 && v4 >= *((_QWORD *)v8 + 2) )
  {
    for ( i = 0; ; i = v10 + 1 )
    {
      while ( 1 )
      {
        ...
        v10 = (i + v7) >> 1;
        v8 = (char *)qword_140E2D8E0 + 16 * v10;
        if ( v4 >= *(_QWORD *)v8 )
          break;
        if ( !v10 )
          KeBugCheckEx(0x1Au, 0x5180uLL, v4, (ULONG_PTR)qword_140E2D8E0, 0LL);
        v7 = v10 - 1;
      }
      if ( v10 == dword_140E2D884 || v4 < *((_QWORD *)v8 + 2) )
        break;
    }
    dword_140E2D880 = (i + v7) >> 1;
  }
  v34 = *((_DWORD *)v8 + 2);
  v11 = *(_DWORD *)(v6 + 32);
  if ( (v11 & 0x8000000) == 0
    ...
    && ((v29 = 0xAAAAAAAAAAAAAAABuLL * (v5 >> 4), v29 < qword_140E358C0) || v29 >= qword_140E358C0 + 2048)
    && ((BYTE2(v11) & 7) == 6
     || byte_140E3C8A6
     && (v30 = v29 >> 9, *(_BYTE *)(qword_140E3CF00 + 2 * v30))
     && *(_BYTE *)(qword_140E3CF00 + 2 * v30) != 10) )
  {
    v12 = HIBYTE(v11) & 7;
  }
  else
  ...
  {
    if ( (_DWORD)v2 == 8 )
      v31 = *(_BYTE *)(qword_140E3CF00 + 2 * ((0xAAAAAAAAAAAAAAABuLL * ((__int64)(v6 + 0x220000000000LL) >> 4)) >> 9) + 1) & 0x7F;
    else
      v31 = 0;
