/*
 * XREFs of CarEtwWriteLiveDumpEvent @ 0x140609D08
 * Callers:
...
void __fastcall CarEtwWriteLiveDumpEvent(int *a1, int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140E08F20 > 5 && tlgKeywordOn((__int64)&dword_140E08F20, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_1400503C9,
        0LL,
        0LL,
        9u,
        &v12);
