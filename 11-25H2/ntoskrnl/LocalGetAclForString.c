...
__int64 __fastcall LocalGetAclForString(wchar_t *Str1, char a2, const void **a3, wchar_t **a4)
{
  ...
  _WORD *v112; // [rsp+78h] [rbp-88h] BYREF
...
LABEL_131:
      ...
      *(_QWORD *)v119 = 0LL;
      ...
      v63 = (const wchar_t **)&unk_140E08958;
      v64 = 0;
      v23 = v110;
      while ( 1 )
      {
...
LABEL_207:
                    ...
                    {
                      AceListLength = 0LL;
                      ConditionForString = LocalGetConditionForString(n, &v112, &Src, &Size);
                      v38 = Sid;
                ...
                switch ( v45 )
                {
                  ...
                  case 0xDu:
                    ...
                    *(_WORD *)(v73 + 2) = v47;
                    ...
                    RtlCopySid(v75, (PSID)(v74 + 8), Sid);
                    if ( (_DWORD)Size )
                    {
                      v76 = Size;
                      v77 = RtlLengthSid(Sid);
                      memmove((void *)(v74 + v77 + 8LL), Src, v76);
                    }
                    v6 = a3;
                    v20 = RtlAddAce((PACL)*a3, 2u, 0xFFFFFFFF, (PVOID)v74, v47);
                    ...
                    else
                    {
                      ...
                      if ( v92 )
                      {
                        ...
                        *(_WORD *)(v92 + 2) = v47;
                        ...
                        RtlCopySid(v94, (PSID)(v93 + 8), Sid);
                        if ( HIDWORD(Size) )
                        {
                          v95 = HIDWORD(Size);
                          v96 = RtlLengthSid(Sid);
                          memmove((void *)(v93 + v96 + 8LL), P, v95);
                        }
                        v6 = a3;
                        v20 = RtlAddAce((PACL)*a3, 2u, 0xFFFFFFFF, (PVOID)v93, v47);
...
LABEL_114:
            ...
            {
              v112 -= 2;
              v72 = LocalpConvertStringSidToSid(v32, &v122, &v112);
              if ( v72 < 0 )
              {
