/*
 * XREFs of LocalGetAclForString @ 0x140917620
 * Callers:
...
__int64 __fastcall LocalGetAclForString(wchar_t *Str1, char a2, const void **a3, wchar_t **a4)
{
  ...
  _WORD *v111; // [rsp+78h] [rbp-88h] BYREF
...
LABEL_131:
      ...
      v62 = (const wchar_t **)&unk_140E08958;
      v63 = 0;
      v23 = v109;
      while ( 1 )
      {
...
LABEL_26:
            ...
            while ( *v27 != 59 )
            {
              for ( ; *v27 == 32; ++v27 )
                ;
              v28 = (const wchar_t **)&unk_140E08AF8;
              v29 = v23;
              if ( (_BYTE)v68 == 17 )
                v29 = 4;
              v30 = 0;
...
LABEL_207:
                    ...
                    {
                      AceListLength = 0;
                      ConditionForString = LocalGetConditionForString(m, &v111, &Src, &Size);
                      v38 = Sid;
              ...
              if ( v45 )
              {
                ...
                switch ( v45 )
                {
                  ...
                  case 0xDu:
                    ...
                    *(_BYTE *)v72 = v105;
                    *(_BYTE *)(v72 + 1) = v104;
                    *(_DWORD *)(v72 + 4) = AccessMask;
                    *(_WORD *)(v72 + 2) = v47;
                    v74 = RtlLengthSid(Sid);
                    RtlCopySid(v74, (PSID)(v73 + 8), Sid);
                    if ( (_DWORD)Size )
                    {
                      v75 = Size;
                      v76 = RtlLengthSid(Sid);
                      memmove((void *)(v73 + v76 + 8LL), Src, v75);
                    }
                    v6 = a3;
                    v20 = RtlAddAce((PACL)*a3, 2u, 0xFFFFFFFF, (PVOID)v73, v47);
                    ...
                    else
                    {
                      ...
                      if ( v91 )
                      {
                        ...
                        *(_WORD *)(v91 + 2) = v47;
                        ...
                        RtlCopySid(v93, (PSID)(v92 + 8), Sid);
                        if ( HIDWORD(Size) )
                        {
                          v94 = HIDWORD(Size);
                          v95 = RtlLengthSid(Sid);
                          memmove((void *)(v92 + v95 + 8LL), P, v94);
                        }
                        v6 = a3;
                        v20 = RtlAddAce((PACL)*a3, 2u, 0xFFFFFFFF, (PVOID)v92, v47);
                        ExFreePoolWithTag((PVOID)v92, 0);
                        v56 = v103;
                        v53 = Sid;
                        goto LABEL_116;
                      }
...
LABEL_114:
            ...
            {
              v111 -= 2;
              v71 = LocalpConvertStringSidToSid(v32, &v121, &v111);
              if ( v71 < 0 )
              {
