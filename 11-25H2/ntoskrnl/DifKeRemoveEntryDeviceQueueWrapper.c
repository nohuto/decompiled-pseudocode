/*
 * XREFs of DifKeRemoveEntryDeviceQueueWrapper @ 0x140624230
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeRemoveEntryDeviceQueueWrapper(PKDEVICE_QUEUE DeviceQueue, PKDEVICE_QUEUE_ENTRY DeviceQueueEntry)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(254);
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = DeviceQueue;
    *((_QWORD *)&v13 + 1) = DeviceQueueEntry;
  ...
  BYTE8(v14) = KeRemoveEntryDeviceQueue(DeviceQueue, DeviceQueueEntry);
  if ( v5 )
  {
