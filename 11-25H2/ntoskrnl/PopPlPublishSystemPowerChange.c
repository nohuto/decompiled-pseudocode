/*
 * XREFs of PopPlPublishSystemPowerChange @ 0x1405D7A8C
 * Callers:
...
__int64 __fastcall PopPlPublishSystemPowerChange(unsigned __int16 *a1, int a2, __int64 a3)
{
  ...
  if ( a2 )
  {
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      ...
      v20 = 4LL;
      v22 = 4LL;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140E07680, (unsigned __int8 *)&byte_14004D8D1, a3, 1u, v7, v8, 7u, &v12);
    }
    *((_DWORD *)a1 + 7) += a2;
    return guard_dispatch_icall_no_overrides(*((_QWORD *)a1 + 4));
  }
  return result;
}
