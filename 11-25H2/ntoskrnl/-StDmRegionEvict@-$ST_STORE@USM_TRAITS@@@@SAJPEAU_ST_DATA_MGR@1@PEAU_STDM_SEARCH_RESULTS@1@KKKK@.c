/*
 * XREFs of ?StDmRegionEvict@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_SEARCH_RESULTS@1@KKKK@Z @ 0x1405FFF10
 * Callers:
...
LABEL_7:
  ...
  Keys = ST_STORE<SM_TRAITS>::StDmRegionGetKeys(a1, v8, v5, 0, a5, (__int64)Base, (__int64)&NumOfElements);
