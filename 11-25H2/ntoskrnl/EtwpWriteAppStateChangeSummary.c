/*
 * XREFs of EtwpWriteAppStateChangeSummary @ 0x140920364
 * Callers:
        ...
        unsigned __int16 *a6)
{
  ...
  memset(v62, 0, 29);
  if ( dword_140E09010
    && (qword_140E09020 & 0x200000000000LL) != 0
    && (qword_140E09028 & 0x200000000000LL) == qword_140E09028 )
  {
    v8 = *(_QWORD *)&v62[0] | 1LL;
    *(_QWORD *)&v62[0] |= 1uLL;
  }
...
LABEL_9:
  ...
  {
    if ( (qword_140E09020 & 0x400000000000LL) == 0
      || (LOBYTE(v12) = 1, (qword_140E09028 & 0x400000000000LL) != qword_140E09028) )
    {
      LOBYTE(v12) = 0;
    }
    if ( (_BYTE)v12 )
    {
      ...
      v61 = 50331648LL;
      v129 = 8LL;
      LOBYTE(v12) = tlgWriteAgg((__int64)&dword_140E09010, (unsigned __int8 *)&byte_140051447, v33, 0x24u, (__int64)v63);
    }
  }
  return v12;
}
