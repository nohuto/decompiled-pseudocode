/*
 * XREFs of HvlQueryMinrootInfo @ 0x14057FD90
 * Callers:
  ...
  if ( a2 >= 0x4298 )
  {
    ...
    *a1 = KeHypervisorNumprocSpecified;
    ...
    if ( v7 )
    {
      ...
      *(_OWORD *)(a1 + 7) = xmmword_140FC66A0;
      *(_OWORD *)(a1 + 11) = xmmword_140FC66B0;
      *(_OWORD *)(a1 + 15) = xmmword_140FC66C0;
      *(_OWORD *)(a1 + 19) = xmmword_140FC66D0;
      *(_OWORD *)(a1 + 23) = xmmword_140FC66E0;
      *(_OWORD *)(a1 + 27) = xmmword_140FC66F0;
      *(_OWORD *)(a1 + 31) = xmmword_140FC6700;
    }
