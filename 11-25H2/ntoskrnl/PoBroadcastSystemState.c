...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v34; // r9
  __int64 v35; // r10
  char v36; // [rsp+30h] [rbp-30h]
  LARGE_INTEGER Interval; // [rsp+38h] [rbp-28h] BYREF
  unsigned int *v38; // [rsp+40h] [rbp-20h]
...
LABEL_3:
  ...
  v29 = DWORD1(PopCurrentBroadcast) | ((*(_DWORD *)(a1 + 4) & 0xF) << 12);
  DWORD1(PopCurrentBroadcast) = v29;
  if ( *v5 == 5 )
  {
    v10 = (PopKsrPrepared != 0 ? 0x400000 : 0) | v29;
    goto LABEL_3;
  }
LABEL_4:
  v11 = *v5;
...
LABEL_45:
      ...
      for ( i = 4LL; ; --i )
      {
        ...
        if ( v24 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v13 )
        {
          ...
          if ( *(_BYTE *)(a1 + 24) )
          {
            ...
            {
              LOBYTE(v30) = 1;
              IoConfigureCrashDump(0LL, (__int64)v30, v31, (__int64)v32);
            }
            if ( (PopShutdownCleanly & 0x10) != 0 )
              ObShutdownSystem((PVOID *)1, v30, v31, v32);
            MmShutdownSystem(1);
          }
          else
          {
        ...
        LOBYTE(v20) = *v7;
        LOBYTE(v21) = 1;
        PopDiagTraceDevicesLevel((unsigned int)v24, 0LL, v20, v21);
        if ( *v25 )
        {
          if ( *(int *)(a1 + 20) < 0 )
            **((_QWORD **)v7 + 7) = 0LL;
          PopSleepDeviceList((__int64)v7, (__int64)&v7[64 * v24 + 64 + 8 * v24], v27, v28);
        }
        LOBYTE(v27) = *v7;
        PopDiagTraceDevicesLevel((unsigned int)v24, 0LL, v27, 0LL);
        if ( *((int *)v7 + 112) < 0 )
          break;
        --v24;
        v25 -= 18;
      ...
      if ( !*((_QWORD *)v7 + 57) || *(_DWORD *)(a1 + 12) != 1 )
        goto LABEL_97;
      v33 = PopMapInternalActionToIrpAction(*v38, *((_DWORD *)v7 + 1), 0);
      if ( v33 == 7 )
      {
        v34 = **((_QWORD **)v7 + 7);
      }
...
LABEL_55:
      ...
      IoNotifyPowerOperationVetoed(v33, v34, v35);
      goto LABEL_97;
    }
LABEL_62:
    v23 = 0LL;
...
LABEL_14:
  ...
  *((_DWORD *)v7 + 1) = 1;
  ...
  while ( v14 <= 4 )
  {
    ...
    if ( v15[1] < *v15 )
      PopWakeDeviceList(v7, &v7[64 * v14 + 64 + 8 * v14], v16, v17);
    LOBYTE(v16) = *v7;
