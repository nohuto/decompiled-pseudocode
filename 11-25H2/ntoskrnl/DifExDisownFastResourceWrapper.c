/*
 * XREFs of DifExDisownFastResourceWrapper @ 0x140611BB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExDisownFastResourceWrapper(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  v12 = 0LL;
  v13 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(453);
  ...
  if ( APIThunkContextById )
  {
    ...
    *((_QWORD *)&v12 + 1) = BugCheckParameter3;
  ...
  ExDisownFastResource(BugCheckParameter2, BugCheckParameter3);
  if ( v5 )
  {
