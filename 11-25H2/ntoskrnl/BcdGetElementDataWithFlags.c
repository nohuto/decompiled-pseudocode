...
__int64 __fastcall BcdGetElementDataWithFlags(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  __int64 v20; // rcx
  __int64 v21; // [rsp+20h] [rbp-A1h]
  char IsOfflineHandle; // [rsp+40h] [rbp-81h]
  unsigned int v24; // [rsp+48h] [rbp-79h] BYREF
  ...
  _DWORD *v30; // [rsp+80h] [rbp-41h]
  __int64 v31; // [rsp+88h] [rbp-39h]
  __int128 v32; // [rsp+90h] [rbp-31h] BYREF
  ...
  else
  {
    ...
    {
      v10 = RtlStringFromGUIDEx((unsigned int *)&v32, (__int64)&DestinationString, 1);
      Buffer = DestinationString.Buffer;
      if ( v10 >= 0 )
        v9 = DestinationString.Buffer;
    }
    v12 = BiOpenKey(a1, L"Elements", 0x20019u, &v25);
    v13 = v12;
    if ( v12 < 0 )
    {
      BiLogMessage(
    ...
    else
    {
      ...
      {
        v15 = BiConvertElementFormatToValueType(HIBYTE(a2) & 0xF);
        v8 = v27;
        v26 = v15;
        RegistryValue = BiGetRegistryValue((__int64)v27, L"Element", 0LL, v15, &P, &v24);
        v17 = P;
        v13 = RegistryValue;
        if ( RegistryValue < 0 )
        {
        ...
        {
          v13 = BiConvertRegistryDataToElement(a1, P, v24, a2, 0, v31, v30);
        }
        if ( v17 )
