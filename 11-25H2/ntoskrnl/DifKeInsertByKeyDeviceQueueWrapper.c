/*
 * XREFs of DifKeInsertByKeyDeviceQueueWrapper @ 0x140622130
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG SortKey)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = DeviceQueue;
    *(_QWORD *)&v16 = DeviceQueueEntry;
    DWORD2(v15) = SortKey;
  ...
  LOBYTE(v17) = KeInsertByKeyDeviceQueue(DeviceQueue, DeviceQueueEntry, SortKey);
  if ( v7 )
  {
