/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x140716108
 * Callers:
 ...
 *     IopSaveRestoreConfiguration @ 0x1407159CC (IopSaveRestoreConfiguration.c)
 *     IopSelectNextConfiguration @ 0x140715B54 (IopSelectNextConfiguration.c)
 *     IopTestConfiguration @ 0x140715C2C (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x1407162A4 (PnpSelectFirstConfiguration.c)
