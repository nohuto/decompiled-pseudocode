/*
 * XREFs of DifZwUnloadDriverWrapper @ 0x14063D930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnloadDriverWrapper(PUNICODE_STRING DriverServiceName)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    else if ( ((unsigned __int8)v5 & v3) != 0 )
    {
      *(_QWORD *)&v12 = DifGetReturnAddressForWrappers();
    }
    v6 = 0;
    *((_QWORD *)&v12 + 1) = DriverServiceName;
  ...
  LODWORD(v13) = ZwUnloadDriver(DriverServiceName);
  if ( v4 )
  {
