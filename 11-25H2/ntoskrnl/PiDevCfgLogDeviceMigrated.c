/*
 * XREFs of PiDevCfgLogDeviceMigrated @ 0x1406ED37C
 * Callers:
...
char __fastcall PiDevCfgLogDeviceMigrated(__int64 a1, __int64 a2, int a3)
{
  ...
  result = byte_140EEFA6A;
  if ( (byte_140EEFA6A & 0x10) != 0 && (byte_140EEFA6A & 0x40) != 0 && (byte_140EEFA6A & 0x20) != 0 )
  {
    v6 = (const wchar_t *)&dword_140B349B4;
    v7 = a2 + 80;
    if ( a3 < 0 )
    {
      v8 = *(_QWORD *)(a2 + 152);
