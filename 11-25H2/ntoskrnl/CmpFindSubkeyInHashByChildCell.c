/*
 * XREFs of CmpFindSubkeyInHashByChildCell @ 0x1408471B0
 * Callers:
 ...
 *     CmpIsKcbLockAllowed @ 0x140A08688 (CmpIsKcbLockAllowed.c)
...
LABEL_22:
  ...
  if ( _InterlockedCompareExchange64(v23, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx(v23, 0, v24, (unsigned __int64)v23);
  if ( v24 )
    *((_BYTE *)v24 + 10) = 1;
