/*
 * XREFs of IopRecordIoAttribution @ 0x14034E818
 * Callers:
...
__int64 __fastcall IopRecordIoAttribution(unsigned __int64 *a1, __int64 a2, char a3)
{
  ...
  if ( (a3 & 2) == 0 )
  {
    ...
    {
      v14 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)a1 + 5, (__int64)&LockHandle);
      if ( !v14 )
      {
LABEL_8:
        v12 = 0LL;
    ...
    {
      KiAcquireQueuedSpinLockInstrumented((__int64)&LockHandle, (volatile __int64 *)a1 + 5);
    }
    v6 = 1;
    goto LABEL_8;
  }
