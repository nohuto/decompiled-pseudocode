/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x14058C870
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgConvertResources @ 0x140BA05CC (BgConvertResources.c)
 *     BgGetDisplayContext @ 0x140BA06F4 (BgGetDisplayContext.c)
 *     BgGetIsColorOverridden @ 0x140BA0704 (BgGetIsColorOverridden.c)
