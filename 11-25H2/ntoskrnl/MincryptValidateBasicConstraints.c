/*
 * XREFs of MincryptValidateBasicConstraints @ 0x140816080
 * Callers:
...
__int64 __fastcall MincryptValidateBasicConstraints(_DWORD *a1, int a2, char a3, _DWORD *a4)
{
  ...
  if ( !*a1 )
    goto LABEL_14;
  if ( (int)MinAsn1ParseSingleExtensionValue(&qword_140B2CB58, a1, v9, &v11) <= 0 )
    goto LABEL_15;
  if ( !v9[0] )
  {
LABEL_14:
...
LABEL_15:
  ...
  LODWORD(v10) = 3;
  if ( (int)MinAsn1ExtractValues(DWORD2(v11), v11, (unsigned int)&v10, (unsigned int)&qword_14000CBF0, 3, (__int64)&v12) <= 0
    || v12 <= 0
    || !DWORD2(v13)
    || !*(_BYTE *)v14 )
  {
