/*
 * XREFs of DifKeInsertQueueDpcWrapper @ 0x140622420
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeInsertQueueDpcWrapper(PRKDPC Dpc, PVOID SystemArgument1, PVOID SystemArgument2)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = Dpc;
    *(_QWORD *)&v16 = SystemArgument1;
    *((_QWORD *)&v15 + 1) = SystemArgument2;
  ...
  LOBYTE(v17) = KeInsertQueueDpc(Dpc, SystemArgument1, SystemArgument2);
  if ( v7 )
  {
