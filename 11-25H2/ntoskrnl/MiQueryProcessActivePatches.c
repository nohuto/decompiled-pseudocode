/*
 * XREFs of MiQueryProcessActivePatches @ 0x140AA8E54
 * Callers:
        ...
        int a7)
{
  ...
  ULONG_PTR v83; // [rsp+B8h] [rbp-48h]
  _QWORD *v84; // [rsp+C0h] [rbp-40h]
  _DWORD *v85; // [rsp+C8h] [rbp-38h]
  __int64 v86; // [rsp+D0h] [rbp-30h]
  _OWORD v87[3]; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_49:
  ...
  if ( v26 < 0 )
    goto LABEL_102;
  v29 = ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)Object + 61) & 1;
  v11 = 2 * v29;
  if ( v29 )
  {
    KiStackAttachProcess((_KPROCESS *)v27, 0, (__int64)v87);
    v30 = *((_QWORD *)v27 + 46);
    v11 |= 4u;
    v75 = v11;
    if ( (v30 & 1) == 0 )
    ...
    active = VslQueryActiveSecurePatches(v30, (struct _MDL **)&P, &v72);
    v14 = 0LL;
    v28 = active;
    if ( active >= 0 )
    {
      ...
      if ( !v47 )
      {
        ...
        for ( k = (PVOID *)PsLoadedModuleList; k != &PsLoadedModuleList; k = (PVOID *)*k )
        {
          if ( (unsigned int)MiIsActiveSystemHotPatch((__int64)k) )
          {
            ...
            v71 = *(_DWORD *)(BaseLoaderPortion + 272);
            LODWORD(v74) = *(_DWORD *)(v64 + 120);
            HIDWORD(v74) = *(_DWORD *)(v64 + 156);
            MiFillActivePatchesQueryBuffer(
              (__int64)v46,
              v64,
              v65,
...
LABEL_89:
  ...
  if ( (v11 & 1) != 0 )
  {
    ...
    v69 = v68->SpecialApcDisable++ == -1;
    if ( v69 && ($727077A9B6E167EAE1398C74674DC5A5 *)v68->ApcState.ApcListHead[0].Flink != &v68->152 )
