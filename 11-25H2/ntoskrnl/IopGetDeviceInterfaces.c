/*
 * XREFs of IopGetDeviceInterfaces @ 0x1409572B8
 * Callers:
...
__int64 __fastcall IopGetDeviceInterfaces(int *a1, const UNICODE_STRING *a2, int a3, char a4, wchar_t **a5, _DWORD *a6)
{
  ...
  _QWORD *v14; // rsi
  __int64 (__fastcall *v15)(void *, PCWSTR, unsigned int, int, int, __int64); // rdi
  int v16; // eax
  NTSTATUS v17; // eax
  ...
  wchar_t *v26; // r15
  _QWORD *v27; // r13
  __int64 (__fastcall *v28)(void *, PCWSTR, unsigned int, int, int, __int64); // r12
  int v29; // eax
  ...
  unsigned int v55[3]; // [rsp+74h] [rbp-8Ch] BYREF
  ...
  char (__fastcall *v75)(int, const WCHAR *, int, __int64); // [rsp+158h] [rbp+58h] BYREF
  ...
  *a5 = 0LL;
  ...
  v15 = (__int64 (__fastcall *)(void *, PCWSTR, unsigned int, int, int, __int64))v14[63];
  p_Handle = &Handle;
  v72 = 64LL;
  LODWORD(v73) = 983103;
  BYTE4(v73) = 0;
  if ( v15 )
  {
    if ( v15 == PiPnpRtlCmActionCallback )
      v16 = PiPnpRtlCmActionCallback(v14, v81, 4u, 11, 1, (__int64)v71);
    else
  ...
  {
    v71[0] = v17;
    v45 = guard_dispatch_icall_no_overrides(v14);
    if ( v45 != -1073741822 )
    {
      if ( v45 == -1073741536 )
      {
...
LABEL_140:
      ...
      v48 = PiPnpRtlApplyMandatoryFilters(*(__int64 *)&PiPnpRtlCtx, v8, 3, v59, &SubjectSecurityContext, &cchDest_5);
...
LABEL_26:
    ...
    ppszDestEnd = v26;
    memset_0(v71, 0, 0x58uLL);
    v28 = (__int64 (__fastcall *)(void *, PCWSTR, unsigned int, int, int, __int64))v27[63];
    v72 = (__int64)v81;
    v73 = *(_QWORD *)&v55[1];
    v78 = v25;
    v77 = v26;
    ...
    if ( v28 )
    {
      if ( v28 == PiPnpRtlCmActionCallback )
        v29 = PiPnpRtlCmActionCallback(v27, 0LL, 3u, 17, 1, (__int64)v71);
      else
        v29 = guard_dispatch_icall_no_overrides(v27);
      if ( v29 == -1073741822 )
      {
        v28 = 0LL;
      }
    ...
    if ( v28 )
    {
      ...
      v44 = guard_dispatch_icall_no_overrides(v27);
      if ( v44 != -1073741822 )
      {
        if ( v44 == -1073741536 )
        {
