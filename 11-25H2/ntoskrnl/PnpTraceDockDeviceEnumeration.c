/*
 * XREFs of PnpTraceDockDeviceEnumeration @ 0x140726548
 * Callers:
...
void PnpTraceDockDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140E06FA8 > 5 && tlgKeywordOn((__int64)&dword_140E06FA8, 0x400000000000LL) )
  {
    ...
    v13 = 4LL;
    v15 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06FA8, (unsigned __int8 *)byte_14004678B, 0LL, 0LL, 7u, &v5);
  }
}
