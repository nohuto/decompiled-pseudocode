/*
 * XREFs of SymCryptModExpWindowed @ 0x140535128
 * Callers:
 *     SymCryptModExpGeneric @ 0x140534F90 (SymCryptModExpGeneric.c)
 * Callees:
 *     MiWriteCloneFlags @ 0x14047F50C (MiWriteCloneFlags.c)
 ...
 *     SymCryptScsTableInit @ 0x140536B58 (SymCryptScsTableInit.c)
 *     SymCryptScsTableLoad @ 0x140536B9C (SymCryptScsTableLoad.c)
 *     SymCryptScsTableStore @ 0x140536F98 (SymCryptScsTableStore.c)
        ...
        __int64 a7)
{
  ...
  do
  {
    if ( *((_DWORD *)&qword_140020200 + v12) >= v7 )
      break;
    ++v11;
