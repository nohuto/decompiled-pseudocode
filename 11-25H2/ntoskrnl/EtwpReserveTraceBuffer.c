/*
 * XREFs of EtwpReserveTraceBuffer @ 0x14030C840
 * Callers:
...
LABEL_85:
  ...
  for ( i = v8; ; v8 = i )
  {
    ...
    {
      v14 = (_QWORD *)(*(_QWORD *)(v11 + 4144) + (Number << 6));
    }
    ...
    {
      EtwpLockBufferList(a1, &v56, 3LL, KiProcessorBlock);
...
LABEL_69:
    ...
    v39 = EtwpSwitchBuffer((_DWORD)a1, v18, (_DWORD)v15, Number, a5);
    if ( (a1[3] & 0x4000000) != 0 )
    {
...
LABEL_64:
  ...
  LoggerTimeStamp = EtwpGetLoggerTimeStamp(a1, 0LL, 3LL, v9);
  v31 = i;
