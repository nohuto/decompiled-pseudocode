/*
 * XREFs of MmIdentifyPhysicalMemory @ 0x1407DBCA8
 * Callers:
...
LABEL_19:
        if ( (!v12 || (v14 & 0x70) == 0x60) && v13 )
        {
          ...
          do
          {
            *(_QWORD *)&v32 = &v23;
            *((_QWORD *)&v32 + 1) = 24LL;
            EtwTraceSiloDcEvent((struct _KTHREAD *)&v32, 1u, v15, v17, a3, 0x501804u);
            ++*((_QWORD *)&v23 + 1);
            if ( (v23 & 0xF) == 2 )
            {
              v24 += 8;
...
LABEL_33:
  ...
  if ( (v7 & 1) == 0 )
  {
    ...
    *(_QWORD *)&v32 = &v29;
    *((_QWORD *)&v32 + 1) = 24LL;
    EtwTraceSiloDcEvent((struct _KTHREAD *)&v32, 1u, v5, v4, 0x27Bu, 0x501804u);
  }
  if ( v6 )
