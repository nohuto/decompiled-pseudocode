/*
 * XREFs of MfgInitSystem @ 0x140BFACB0
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_OWORD *)&KeyHandle_8.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_140EFE830, WORD5(ExpManufacturingInformation));
    if ( inited < 0 )
      goto LABEL_21;
