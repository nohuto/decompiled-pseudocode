/*
 * XREFs of KeFindConfigurationNextEntry @ 0x140C18260
 * Callers:
 *     HalpAcpiFindRsdp @ 0x140BFC868 (HalpAcpiFindRsdp.c)
 *     KeFindConfigurationEntry @ 0x140C18230 (KeFindConfigurationEntry.c)
 *     KeFindConfigurationNextEntry @ 0x140C18260 (KeFindConfigurationNextEntry.c)
 * Callees:
 *     KeFindConfigurationNextEntry @ 0x140C18260 (KeFindConfigurationNextEntry.c)
 */
