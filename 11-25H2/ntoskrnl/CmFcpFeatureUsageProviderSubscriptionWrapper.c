/*
 * XREFs of CmFcpFeatureUsageProviderSubscriptionWrapper @ 0x1406F0440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CmFcpFeatureUsageProviderSubscriptionWrapper(_QWORD *a1)
{
  ...
  result = (unsigned int)_InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 1788), 0xFFFFFFFF);
  if ( (_DWORD)result == 1 )
  {
    _InterlockedOr(v5, 0);
    if ( *(_QWORD *)(v1 + 1376) )
      return ExfUnblockPushLock(v1 + 1376, 0LL);
  }
  return result;
}
