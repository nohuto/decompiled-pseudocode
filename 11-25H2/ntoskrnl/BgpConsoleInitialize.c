/*
 * XREFs of BgpConsoleInitialize @ 0x140BA10B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgpConsoleGetFontName @ 0x140C5EA90 (BgpConsoleGetFontName.c)
 */
...
__int64 __fastcall BgpConsoleInitialize(unsigned int a1, unsigned int a2, unsigned int a3)
{
  ...
  qword_140EEF810 = (__int64)Memory;
  v9 = Memory;
  if ( !Memory )
  {
  ...
  *(_DWORD *)(v12 + 52) = 22;
  ...
  BgpConsoleGetFontName((unsigned int)dword_140EEFEF8, &Str2);
  FontHandle = BgpFoGetFontHandle(Str2);
  if ( FontHandle < 0
    || (FontHandle = BgpConsoleSetPointSize(
                       *(_DWORD *)(qword_140EEF810 + 4),
                       *(_DWORD *)qword_140EEF810,
                       *(_DWORD *)(qword_140EEF810 + 24),
                       *(_DWORD *)(qword_140EEF810 + 20),
                       (__int64)v26,
                       (__int64)&v23),
        FontHandle < 0) )
  {
    v9 = (unsigned int *)qword_140EEF810;
LABEL_15:
    if ( v9 )
    {
