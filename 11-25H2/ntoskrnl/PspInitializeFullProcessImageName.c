/*
 * XREFs of PspInitializeFullProcessImageName @ 0x140A2F378
 * Callers:
...
__int64 __fastcall PspInitializeFullProcessImageName(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    FileObjectForSection = *(char **)(a1 + 184);
  }
  else
  {
    v11 = *(_QWORD *)(a2 + 680);
    if ( !v11 )
      goto LABEL_16;
    FileObjectForSection = (char *)MmGetFileObjectForSection(v11);
  }
