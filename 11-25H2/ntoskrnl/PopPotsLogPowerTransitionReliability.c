/*
 * XREFs of PopPotsLogPowerTransitionReliability @ 0x140A91E9C
 * Callers:
...
char __fastcall PopPotsLogPowerTransitionReliability(int a1, int a2, int a3)
{
  ...
  if ( PotsPowerTransitionsHandleRegistered && (unsigned int)dword_140E08220 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140E08220, 0x400000000000LL);
    if ( result )
    {
      v29 = 4LL;
      v28 = &v20;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)&word_14004DFB6,
               0LL,
               0LL,
               0xDu,
               &v27);
