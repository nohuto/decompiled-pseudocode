/*
 * XREFs of CmpReportAuditVirtualizationEvent @ 0x1407CE0A8
 * Callers:
 ...
 *     SeSetAuditParameter @ 0x14043F8E0 (SeSetAuditParameter.c)
 ...
 *     CmpEffectiveTokenForSubject @ 0x1409C2FF0 (CmpEffectiveTokenForSubject.c)
