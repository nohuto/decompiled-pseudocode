/*
 * XREFs of PrpWriteTraceLoggingEvent @ 0x140658924
 * Callers:
...
void PrpWriteTraceLoggingEvent()
{
  ...
  if ( (unsigned int)dword_140E09710 > 5 && tlgKeywordOn((__int64)&dword_140E09710, 0x800000000000LL) )
  {
    v2 = *v0;
    v22 = &v6;
    v14 = &v2;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140E09710,
      (unsigned __int8 *)&byte_140052F37,
      0LL,
      0LL,
      0xEu,
      &v13);
