/*
 * XREFs of TtmiLogTerminalHandleClosed @ 0x14075F250
 * Callers:
...
void TtmiLogTerminalHandleClosed()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v5 = v4;
    v6 = v3;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)byte_14004F6BB, 0LL, 0LL, 6u, &v9);
  }
}
