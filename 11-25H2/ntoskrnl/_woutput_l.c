/*
 * XREFs of _woutput_l @ 0x1404FE4EC
 * Callers:
 ...
 *     _safecrt_mbtowc @ 0x1404FC490 (_safecrt_mbtowc.c)
 ...
 *     _get_printf_count_output @ 0x140500044 (_get_printf_count_output.c)
    ...
    if ( v10 )
    {
      do
      {
        ...
        if ( (unsigned __int16)(v10 - 32) > 0x5Au )
          ...
          v15 = *((_BYTE *)&_lookuptable[-4] + v10) & 0xF;
        v13 = *((char *)&_lookuptable[v15] + v13) >> 4;
        v53 = v13;
        switch ( v13 )
        {
          case 0:
...
LABEL_116:
                        v34 = v56 - v12 - v33;
                        if ( (v5 & 0xC) == 0 )
                          write_multi_char(32LL, v34, v59, &v48);
                        write_string(v55, v33, v59, &v48);
                        v35 = v59;
                        if ( (v5 & 0xC) == 8 )
                          write_multi_char(48LL, v34, v59, &v48);
                        if ( v52 || (int)v12 <= 0 )
                        {
                          write_string(v7, (unsigned int)v12, v35, &v48);
LABEL_128:
                          v11 = v48;
                        }
                        else
                        {
                          ...
                          while ( 1 )
                          {
                            v38 = safecrt_mbtowc(&v51, v36, _mb_cur_max);
                            v39 = v38;
                            v37 -= (v38 == 2) + 1;
                            if ( v38 <= 0 )
                              break;
                            write_char(v51, v59, &v48);
                            v36 += v39;
                            if ( v37 <= 0 )
                            {
                              a2 = v61;
                        ...
                        if ( v11 < 0 || (v5 & 4) == 0 )
                          goto LABEL_141;
                        write_multi_char(32LL, v34, v35, &v48);
                        v6 = v50;
                        goto LABEL_132;
                      }
                      if ( (v5 & 2) != 0 )
