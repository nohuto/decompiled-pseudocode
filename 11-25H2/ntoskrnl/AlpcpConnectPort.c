/*
 * XREFs of AlpcpConnectPort @ 0x140916470
 * Callers:
 *     NtAlpcConnectPort @ 0x140914F60 (NtAlpcConnectPort.c)
 *     NtAlpcConnectPortEx @ 0x140A2E0B0 (NtAlpcConnectPortEx.c)
 * Callees:
        ...
        LARGE_INTEGER *a13)
{
  ...
  LARGE_INTEGER *v30; // [rsp+B0h] [rbp-C8h]
