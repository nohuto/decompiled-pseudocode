/*
 * XREFs of SeSetSessionIdTokenWithLinked @ 0x140780630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SeSetSessionIdTokenWithLinked(void *a1, ULONG a2, __int64 a3, int a4)
{
  ...
  else
  {
    ...
    v6 = SepReferenceLogonSessionSilo(&v8[27]->SystemResourcesList.Blink, *(_QWORD *)&v8[27][1].OwnerEntry.0, &v12);
    if ( v6 >= 0 )
    {
      v9 = v8[27];
      v10 = (void *)v12[6];
      ...
      if ( OwnerTable )
      {
        v6 = SepReferenceLogonSessionSilo(&OwnerTable, *(_QWORD *)&v9[1].OwnerEntry.0, &v13);
        if ( v6 < 0 )
          goto LABEL_13;
        v5 = (void *)v13[6];
      }
