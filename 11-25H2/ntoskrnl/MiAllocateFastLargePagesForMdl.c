...
__int64 __fastcall MiAllocateFastLargePagesForMdl(__int64 *a1, unsigned int a2, char a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v39 )
      return result;
    if ( v14 == qword_140E2E9B0 )
    {
      v19 = 0LL;
      v20 = 4;
      v21 = (unsigned int *)(*(_QWORD *)(384 * v4 + qword_140E2D8B8 + 376) + 128LL);
      while ( 1 )
      {
