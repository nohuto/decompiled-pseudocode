/*
 * XREFs of KiRescheduleThreadAfterAffinityChange @ 0x140270C08
 * Callers:
        ...
        struct _SINGLE_LIST_ENTRY *a9)
{
  ...
  {
    v35 = *(char *)(a1 + 195);
    KiRemoveThreadFromAnyReadyQueue(a5, a7, a1, v35);
    KiPrepareReadyThreadForRescheduling(a1, v35, a9);
LABEL_35:
    CurrentPrcb = v42;
    goto LABEL_36;
  }
  if ( a4 == 2 )
  {
    if ( a2 )
    {
      v17 = *((_DWORD *)KiGlobalState + *(unsigned int *)(a5 + 36));
      v18 = *a2;
      v19 = v17 >> 6;
  ...
  {
    v16 = (unsigned int)KeCheckProcessorAffinityEx(a2, *(_DWORD *)(a5 + 36)) == 0;
LABEL_11:
    if ( !v16 )
      goto LABEL_36;
    ...
    if ( StaticRescheduleContext->ProcessorCount )
    {
      while ( 1 )
      {
        v22 = &StaticRescheduleContext->ProcessorCount + 40 * v21;
        if ( *((_QWORD *)v22 + 2) == a5 )
          break;
  ...
  if ( (KiVelocityFlags & 0x200000) != 0 )
  {
    ...
    if ( !*v11 )
    {
      if ( v11 == (volatile signed __int64 **)_InterlockedCompareExchange64(v11[1], 0LL, (signed __int64)v11) )
        goto LABEL_51;
      v40 = KxWaitForLockChainValid(v11);
    }
    *v11 = 0LL;
    v41 = (__int64)v11[1];
