/*
 * XREFs of DifIoDeleteSymbolicLinkWrapper @ 0x14061BDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoDeleteSymbolicLinkWrapper(PUNICODE_STRING SymbolicLinkName)
{
  ...
  LODWORD(v12) = IoDeleteSymbolicLink(SymbolicLinkName);
  if ( v3 )
  {
