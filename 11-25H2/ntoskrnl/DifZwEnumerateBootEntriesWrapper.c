/*
 * XREFs of DifZwEnumerateBootEntriesWrapper @ 0x140633740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateBootEntriesWrapper(PVOID Buffer, PULONG BufferLength)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(106);
  ...
  DWORD2(v14) = ZwEnumerateBootEntries(Buffer, BufferLength);
  if ( v5 )
  {
