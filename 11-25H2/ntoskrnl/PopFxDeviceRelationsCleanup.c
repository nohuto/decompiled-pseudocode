/*
 * XREFs of PopFxDeviceRelationsCleanup @ 0x1405CC710
 * Callers:
...
void __fastcall PopFxDeviceRelationsCleanup(__int64 a1)
{
  ...
  while ( PopFxNextParentRelationSafe(v2, 0LL, &P) )
  {
    ...
    if ( (v5 & 2) != 0 )
    {
      PopFxIdleComponent(*(_QWORD *)(v6 + 80), *(unsigned int *)(v6 + 16), 2, 0LL);
      *((_DWORD *)v4 + 4) &= ~2u;
      v5 = *((_DWORD *)v4 + 4);
    }
...
LABEL_14:
    ...
    *v7 = v7;
    if ( KxTryToAcquireSpinLock((volatile signed __int32 *)(v6 + 128)) )
    {
      ...
      *((_QWORD *)v4 + 5) = v4 + 32;
      *v10 = v10;
      KxReleaseSpinLock((volatile signed __int64 *)(v6 + 128));
      v13 = 1;
    }
    else
    {
