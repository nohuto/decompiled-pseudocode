/*
 * XREFs of HalpIommuLogEarlyFault @ 0x140551900
 * Callers:
 *     HalpIommuEarlyFaultDpcRoutine @ 0x1405513A0 (HalpIommuEarlyFaultDpcRoutine.c)
    ...
    if ( EtwEventEnabled(HalpDiagnosticEventHandle, &HAL_ETW_EVENT_IOMMU_FAULT_INIT) )
    {
      ...
      if ( EtwEventEnabled(HalpDiagnosticEventHandle, &HAL_ETW_EVENT_IOMMU_FAULT) )
      {
        ...
        if ( (HalpIommuEarlyFaultRecords & 1) != 0 )
        {
          ...
          v7 = 0;
          v10 = 0;
          UserData.Ptr = (ULONGLONG)&qword_140FC0148;
          v2 = &qword_140FC0150;
          v5 = &dword_140FC0144;
          UserData.Size = 8;
          v8 = &qword_140FC0158;
