/*
 * XREFs of ExpQuerySystemPerformanceInformation @ 0x140AD1640
 * Callers:
 *     ExpQuerySystemInformation @ 0x1409DB5B0 (ExpQuerySystemInformation.c)
 * Callees:
 *     MmGetNumberOfFreeSystemPtes @ 0x1403F4B78 (MmGetNumberOfFreeSystemPtes.c)
 ...
 *     MiMaximumCommitmentAvailable @ 0x140467298 (MiMaximumCommitmentAvailable.c)
 *     MmGetSharedCommit @ 0x1404717D4 (MmGetSharedCommit.c)
 *     MmGetProcessPartitionId @ 0x140471A98 (MmGetProcessPartitionId.c)
 *     ExQueryPoolUsage @ 0x1404728F0 (ExQueryPoolUsage.c)
 *     MmGetWorkingSetLeafSize @ 0x140473450 (MmGetWorkingSetLeafSize.c)
 *     MmGetSystemPageCounts @ 0x140495688 (MmGetSystemPageCounts.c)
 *     MmGetMdlPagesAllocated @ 0x14049DE2C (MmGetMdlPagesAllocated.c)
 *     MmGetPfnDatabaseCommit @ 0x14049F3A0 (MmGetPfnDatabaseCommit.c)
 *     MmGetSystemPageTableCommit @ 0x14049F434 (MmGetSystemPageTableCommit.c)
 *     MmGetContiguousPagesAllocated @ 0x14049FE70 (MmGetContiguousPagesAllocated.c)
