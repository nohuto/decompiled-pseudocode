/*
 * XREFs of HalpInitializeInterruptRemappingBspLate @ 0x1406F5198
 * Callers:
...
__int64 HalpInitializeInterruptRemappingBspLate()
{
  ...
  if ( DeviceAperture >= 0 )
  {
    ...
    v8 = 0;
    qword_140F8F188 = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
    HalpIrtAllocatedDeviceAperturesHead = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
    qword_140F8F3B8 = (__int64)&HalpIrtFreeDeviceAperturesHead;
