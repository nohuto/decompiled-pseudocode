/*
 * XREFs of EtwpOpenLogger @ 0x140257A00
 * Callers:
...
LABEL_8:
  ...
  if ( (result & 1) != 0 )
  {
    if ( !v13 )
      return 0LL;
    ExReleaseRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(a2 + 448) + 8 * v8), 1u);
LABEL_11:
