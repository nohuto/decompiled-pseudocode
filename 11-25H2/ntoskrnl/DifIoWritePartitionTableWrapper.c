/*
 * XREFs of DifIoWritePartitionTableWrapper @ 0x14061FB80
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DRIVE_LAYOUT_INFORMATION *PartitionBuffer)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v11 = 0;
    *(_QWORD *)&v19 = a1;
    *((_QWORD *)&v17 + 1) = PartitionBuffer;
    *(_QWORD *)((char *)&v18 + 4) = __PAIR64__(a2, a3);
    LODWORD(v18) = a4;
  ...
  DWORD2(v19) = IoWritePartitionTable(a1, a2, a3, a4, PartitionBuffer);
  if ( v9 )
  {
