/*
 * XREFs of EtwTiLogInsertQueueUserApc @ 0x1403BD008
 * Callers:
...
void EtwTiLogInsertQueueUserApc(char a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( EtwProviderEnabled(EtwThreatIntProvRegHandle, 0, 0x3000uLL) )
  {
    ...
    if ( v9 )
    {
      ...
      {
        Pool2 = (struct _EVENT_DATA_DESCRIPTOR *)ExAllocatePool2(0x40uLL);
        v13 = Pool2;
        if ( Pool2 )
        {
          v14 = EtwpTiFillProcessIdentity(Pool2, (__int64)Process, &v37);
          ...
          *v17 = (char *)CurrentThread + 1296;
          ...
          v17[3] = 8LL;
          v18 = EtwpTiFillProcessIdentity(&v13[v14 + 2].Ptr, v6, &v38) + v14 + 2;
          v19 = v18;
          v18 += 2;
          v20 = &v13[v19];
          v20->Ptr = a2 + 1296;
          ...
          *(_QWORD *)&v20[1].Size = 8LL;
          v21 = EtwpTiFillProcessIdentity(&v13[v18].Ptr, (__int64)v8, &v39);
