/*
 * XREFs of BcpDisplayCriticalStringCentered @ 0x14068DAE0
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalStringCentered(_WORD *a1, int a2, unsigned int a3, int a4)
{
  ...
  v46 = 0;
  v41 = 0;
  v5 = *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 16);
  if ( BcpTextBoxLeftEdgeOverride )
  {
    v6 = *(_DWORD *)BcpTextBoxLeftEdgeOverride;
    v7 = *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 80);
  }
  else
  {
    v7 = *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 80);
  ...
  if ( BcpTextBoxRightEdgeOverride )
    ...
    v8 = v7 + v5 + *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 24);
  v9 = *(&BcpCursor + 1);
  v10 = BcpCursor;
  v11 = dword_140EEF840;
  ...
  *(_DWORD *)(qword_140E3E860 + 8) = a2;
  v13 = *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 80) + *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 16);
    ...
    *(_QWORD *)pulResult = a1 + 4;
    while ( 1 )
    {
        ...
        while ( 1 )
        {
          ...
          if ( v8 < v13 + v28 )
          {
            ...
            if ( v19 )
            {
              if ( v13 < v8 )
              {
                LODWORD(v26) = BcpPrintSpaces(qword_140E3E860, v13, v8, v9, v41, (__int64)&v46);
                if ( (int)v26 < 0 )
                  goto LABEL_43;
                if ( v19 < v46 )
                  v19 = v46;
              ...
              v13 = v40;
              v31 = v19 + *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 40);
              v19 = 0;
              v9 += v31;
              break;
            }
      ...
      *(_QWORD *)pulResult = v22 + 4;
      ...
      if ( v13 < v8 )
      {
        v33 = BcpPrintSpaces(qword_140E3E860, v13, v8, v9, v41, (__int64)&v46);
        v21 = 0;
        if ( v33 < 0 )
          goto LABEL_43;
        if ( v19 < v46 )
      ...
      v13 = v40;
      v9 += v19 + *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 40);
      v19 = 0;
