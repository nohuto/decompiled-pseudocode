/*
 * XREFs of HalpAcpiAccessSecureAddress @ 0x1402AB1B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpAcpiAccessSecureAddress(char a1, void *a2, char *a3, unsigned int a4, unsigned int *a5)
{
  __int16 v8; // di
