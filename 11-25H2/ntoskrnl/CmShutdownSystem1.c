/*
 * XREFs of CmShutdownSystem1 @ 0x14065C0A4
 * Callers:
 ...
 *     CmCloseRmHandle @ 0x1406EDA60 (CmCloseRmHandle.c)
 *     CmCloseTmHandle @ 0x1406EDA84 (CmCloseTmHandle.c)
