/*
 * XREFs of PnpTraceSecureDeviceEnumeration @ 0x140AAD390
 * Callers:
...
void PnpTraceSecureDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140E06FA8 > 5 && tlgKeywordOn((__int64)&dword_140E06FA8, 0x400000000000LL) )
  {
    ...
    v14 = 4LL;
    v16 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06FA8, (unsigned __int8 *)byte_140046600, 0LL, 0LL, 7u, &v6);
  }
}
