/*
 * XREFs of ?SmFeAddComplete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KKK@Z @ 0x1403D5360
 * Callers:
        ...
        char a5)
{
  ...
  if ( (a5 & 2) == 0 )
  {
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 440), 0LL) )
      result = ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 440), (__int64 *)result, a1 + 440);
    if ( v12 )
      *(_BYTE *)(v12 + 10) = 1;
  }
  v13 = v31;
...
LABEL_12:
    ...
    if ( !v18
      ...
      || (unsigned int)SmArrayGrow(v17, v16, &v36, (const void **)&v33) )
    {
      v20 = v33;
      goto LABEL_12;
    }
