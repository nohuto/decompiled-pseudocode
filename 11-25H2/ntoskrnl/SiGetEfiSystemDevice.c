...
__int64 __fastcall SiGetEfiSystemDevice(unsigned int a1, __int64 a2, wchar_t **a3)
{
  ...
  if ( (int)SiDisambiguateSystemDevice(&v32, &v29, v8, v9) >= 0 )
  {
    v14 = v29;
    goto LABEL_46;
  }
...
LABEL_43:
  ...
  do
  {
    ...
    {
      RtlStringCbPrintfW(v10, 0x6AuLL, L"\\Device\\%s\\Partition%lu", *v15, 0LL, v26, v27);
      v42 = 0LL;
      v41 = 0LL;
      if ( (int)SiIssueSynchronousIoctl(v10, 0x700010u, 0LL, 0, &v41, 0x18u) < 0 || DWORD1(v41) != 2 )
      {
        *(_QWORD *)((char *)v40 + 4) = 0LL;
        ...
        v43 = 0LL;
        v44 = 0LL;
        if ( (int)SiIssueSynchronousIoctl(v10, 0x2D1400u, v40, 0xCu, &v43, 0x20u) >= 0 )
        {
          if ( BYTE8(v44) == 15 )
            goto LABEL_36;
          v16 = BYTE8(v44) == 16;
...
LABEL_46:
    v22 = v30 != 0;
    v30 = -v30;
    LODWORD(v25) = v22 ? v14 : 0;
    if ( v4 )
      v23 = RtlStringCbPrintfW(v10, 0x6AuLL, L"\\Device\\%s\\Partition%lu", v4, v25);
    else
      v23 = RtlStringCbPrintfW(v10, 0x6AuLL, L"\\Device\\Harddisk%lu\\Partition%lu", (unsigned int)v32, v25);
    EspFromFirmware = v23;
    if ( v23 >= 0 )
    {
      *v3 = v10;
...
LABEL_50:
  ...
  EspFromFirmware = SiGetEspFromFirmware(v30, v10, 0LL, 1LL, v25);
  if ( EspFromFirmware < 0 )
  {
