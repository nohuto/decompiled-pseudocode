/*
 * XREFs of KiEpfStart @ 0x1405BF494
 * Callers:
...
LABEL_14:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140F0F7F0);
    v9 = _InterlockedIncrement(&dword_140F0F7F4);
    do
      v10 = dword_140F0F7F8;
    while ( dword_140F0F7F8 < v9 && v10 != _InterlockedCompareExchange(&dword_140F0F7F8, v9, dword_140F0F7F8) );
    v11 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v15, 39, 0);
    result = KeSetKernelStackSwapEnable(v11);
    _InterlockedDecrement(&dword_140F0F7F4);
  }
  return result;
}
