/*
 * XREFs of PiControlGetDeviceInterfaceEnabled @ 0x1408CD7B0
 * Callers:
...
LABEL_52:
    ...
    if ( v15 < 0 || dword_140F8A330 == 3 && v16 <= 8u )
      goto LABEL_50;
    ...
    i = v18;
    v24 = (unsigned __int64 *)RtlLookupElementGenericTableAvl(&Table, &Buffer);
    if ( v24 && (v25 = *v24) != 0 )
    {
