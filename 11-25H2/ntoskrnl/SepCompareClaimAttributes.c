/*
 * XREFs of SepCompareClaimAttributes @ 0x140A19210
 * Callers:
...
bool __fastcall SepCompareClaimAttributes(unsigned int *a1, unsigned int *a2)
{
  ...
  return v6 == v7
      ...
      && v10 == v11
      && (!v6
       || (!v8 || AuthzBasepCompareSecurityAttributesInformation(*((_QWORD *)a1 + 72), *((_DWORD **)a2 + 72)))
       && (!v9 || AuthzBasepCompareSecurityAttributesInformation(*((_QWORD *)a1 + 73), *((_DWORD **)a2 + 73)))
