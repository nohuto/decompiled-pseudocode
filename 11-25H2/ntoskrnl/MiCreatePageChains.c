/*
 * XREFs of MiCreatePageChains @ 0x14038D9F0
 * Callers:
...
__int64 __fastcall MiCreatePageChains(__int64 a1, unsigned int a2, int a3, __int64 a4)
{
  ...
  v30 = 0LL;
  v31 = 0;
  v8 = *(_QWORD *)(qword_140E2D8B8 + 384LL * a2 + 376);
  if ( (*(_DWORD *)(v8 + 36) & 1) != 0 )
  {
    v9 = 0;
    v10 = 1;
    for ( i = &unk_140E2D8B2; (__int64)i < (__int64)&word_140E2D8B6; ++i )
    {
  ...
  else
  {
    ...
    v24 = (unsigned int *)(qword_140E2D890 + 4 * v23);
...
LABEL_14:
    if ( v24 < v25 )
    {
      v6 = *v24;
      v26 = 0LL;
      for ( j = (_WORD *)(*(_QWORD *)(qword_140E2D8B8 + 384 * v6 + 376) + 24LL); ; ++j )
      {
        if ( v26 >= 3 )
        {
          ++v24;
    ...
    v9 = *(_WORD *)(*(_QWORD *)(384LL * (unsigned int)v6 + qword_140E2D8B8 + 376) + 16LL);
  }
