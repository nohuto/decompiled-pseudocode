/*
 * XREFs of ?BTreeSearchResultDeref@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAXPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14039B6F0
 * Callers:
  ...
  else
  {
    ...
    else
    {
      if ( v5 > 1 )
      {
        ...
        if ( v20 <= v23 )
          v22 = v24;
        NP_CONTEXT::NpLeafDerefInternal(v2, v22);
      }
      *(_DWORD *)(a2 + 24) = 0;
    }
  }
