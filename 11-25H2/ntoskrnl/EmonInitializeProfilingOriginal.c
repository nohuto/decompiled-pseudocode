/*
 * XREFs of EmonInitializeProfilingOriginal @ 0x140B3F1E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EmonFreeCounterOriginal @ 0x140558F5C (EmonFreeCounterOriginal.c)
...
LABEL_24:
    ...
    qword_140F8E888 = (__int64)&EmonReservedResourcesList;
    ...
    if ( !v2 )
    {
      ...
      do
      {
        if ( !*((_BYTE *)&unk_140E03C8D + 320 * v26) )
        {
          ...
          v28 = (_QWORD *)qword_140FC16E8;
          if ( *(__int64 **)qword_140FC16E8 != &HalpProfileSourceDescriptorListHead )
            __fastfail(3u);
          ++HalpProfileSourceDescriptorCount;
          *v27 = &HalpProfileSourceDescriptorListHead;
          v27[1] = v28;
          *v28 = v27;
          qword_140FC16E8 = (__int64)&unk_140E03C78 + 320 * v26;
        }
