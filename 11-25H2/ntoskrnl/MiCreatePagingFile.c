/*
 * XREFs of MiCreatePagingFile @ 0x1407DE4C4
 * Callers:
 *     NtCreatePagingFile @ 0x1407DFD70 (NtCreatePagingFile.c)
...
LABEL_92:
  ...
  if ( inserted >= 0 )
  {
    if ( v28 == &MiSystemPartition && !byte_140E2FE00 && (v30[172] & 0x10) == 0 )
    {
      v66 = *((_OWORD *)v30 + 4);
      byte_140E2FE00 = IoInitializeCrashDump(Handle);
    }
    return 0LL;
  }
  else
