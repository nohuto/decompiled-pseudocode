/*
 * XREFs of _CmGetDeviceParent @ 0x1409322F8
 * Callers:
...
__int64 __fastcall CmGetDeviceParent(_QWORD *a1, const WCHAR *a2, wchar_t *a3, unsigned int *a4)
{
  size_t v4; // rdi
  ...
  _WORD v20[200]; // [rsp+80h] [rbp-80h] BYREF
