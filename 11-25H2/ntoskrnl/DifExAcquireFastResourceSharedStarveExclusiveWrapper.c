/*
 * XREFs of DifExAcquireFastResourceSharedStarveExclusiveWrapper @ 0x14060F910
 * Callers:
 *     <none>
 * Callees:
        ...
        char a3)
{
  ...
  LOBYTE(v17) = ExAcquireFastResourceSharedStarveExclusive(BugCheckParameter2, a2, a3);
  if ( v7 )
  {
