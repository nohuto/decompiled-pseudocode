/*
 * XREFs of MiSkipStandbyEntries @ 0x1403EDC90
 * Callers:
...
__int64 __fastcall MiSkipStandbyEntries(__int64 a1, __int64 a2, int a3, int a4, unsigned __int64 a5)
{
  ...
  if ( a2 != 0x3FFFFFFFFFLL )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a4 )
        goto LABEL_26;
      if ( v7 >= qword_140E358C0 )
      {
        v14 = qword_140E358C0 + 2048;
        if ( a3 == 2 || v7 >= v14 )
        {
          v9 = 0xFFFFFFFFFFLL;
        }
...
LABEL_16:
      ...
      {
        if ( a4 || v7 == 0x3FFFFFFFFFLL || v7 < qword_140E358C0 || v7 >= qword_140E358C0 + 2048 )
          return v7;
        v8 = v10;
      }
    }
