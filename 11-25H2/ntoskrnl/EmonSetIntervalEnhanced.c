/*
 * XREFs of EmonSetIntervalEnhanced @ 0x14055BE30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpGetProfileDescriptor @ 0x1404AFFE0 (HalpGetProfileDescriptor.c)
 *     HalpTimerSetProfilingTarget @ 0x1404C0B34 (HalpTimerSetProfilingTarget.c)
 *     EmonSetIntervalInternalEnhanced @ 0x14055BF24 (EmonSetIntervalInternalEnhanced.c)
 */

__int64 __fastcall EmonSetIntervalEnhanced(unsigned int a1, unsigned int *a2)
{
  __int64 v4; // rdx
  ...
  if ( ProfileDescriptor >= 0 )
  {
    ...
    *(_DWORD *)(v8 + 24) = v9;
    HalpReleaseHighLevelLock((__int64)&HalpProfileSourceDescriptorListLock, v6);
    if ( !a1 )
      HalpTimerSetProfilingTarget();
    Number = KeGetPcr()->Prcb.Number;
    EmonSetIntervalInternalEnhanced(a1, *a2, v13, Number);
    EmonSetIntervalInternalEnhanced(a1, *a2, v15, Number);
    return 0LL;
  }
  else
  {
