/*
 * XREFs of KeSetSchedulingGroupCpuRates @ 0x1402F5B44
 * Callers:
...
void __fastcall KeSetSchedulingGroupCpuRates(__int64 a1, struct _KSCHEDULING_GROUP **a2, _KSCHEDULING_GROUP_POLICY *a3)
{
  ...
  if ( (AllFlags & 1) == 0 )
  {
    ...
    do
    {
      p_Blink = (struct _KSCHEDULING_GROUP *)&v17[-4].Blink;
      if ( (HIDWORD(v17[-4].Blink) & 1) == 0 )
      {
...
LABEL_24:
  ...
  {
    v24 = v19;
    if ( (HIDWORD(v22[-4].Blink) & 1) != 0 )
    {
      v19 = LOWORD(v22[-4].Blink);
      ++v23;
      if ( v19 >= v24 )
        v19 = v24;
    }
  ...
  do
  {
    if ( (HIDWORD(v27[-4].Blink) & 1) != 0 )
      LODWORD(v27[-3].Flink) = (LOWORD(v27[-4].Blink) << 7) / ChildMinRate;
    v27 = v27->Flink;
  }
  while ( v27 != v5 );
