/*
 * XREFs of IopAllocateIrpPrivate @ 0x140253800
 * Callers:
...
__int64 __fastcall IopAllocateIrpPrivate(__int64 a1, char a2, char a3)
{
  ...
  _GENERAL_LOOKASIDE *v22; // [rsp+88h] [rbp+20h]
  ...
  if ( v5 <= (char)IopLargeIrpStackLocations && (!a3 || CurrentPrcb->LookasideIrpFloat > 0) )
  {
    ...
    v22 = *(_GENERAL_LOOKASIDE **)((char *)&CurrentPrcb->MxCsr + v12);
    ++v22->TotalAllocates;
    v9 = RtlpInterlockedPopEntrySList(&v22->ListHead);
    if ( v9 )
    {
      v13 = v22;
    }
    ...
    {
      ++v22->AllocateMisses;
      L = CurrentPrcb->PPLookasideList[v20].L;
      ++L->TotalAllocates;
