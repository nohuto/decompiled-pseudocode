/*
 * XREFs of RtlStringCbCopyExA @ 0x14053780C
 * Callers:
 *     InitBootProcessor @ 0x140BF9C88 (InitBootProcessor.c)
 * Callees:
 *     RtlStringCopyWorkerA @ 0x140441860 (RtlStringCopyWorkerA.c)
        ...
        ULONG dwFlags)
{
  ...
  else
  {
    ...
    v6 = RtlStringCopyWorkerA(v8, 0x100uLL, &pcchNewDestLength, &byte_140C57130, v10);
