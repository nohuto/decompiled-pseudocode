/*
 * XREFs of PnpTraceIommuDeviceProperties @ 0x140726740
 * Callers:
...
void PnpTraceIommuDeviceProperties()
{
  ...
  if ( (unsigned int)dword_140E06FA8 > 5 && tlgKeywordOn((__int64)&dword_140E06FA8, 0x400000000000LL) )
  {
    ...
    v8 = 2LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06FA8, (unsigned __int8 *)byte_140046503, 0LL, 0LL, 6u, &v4);
  }
}
