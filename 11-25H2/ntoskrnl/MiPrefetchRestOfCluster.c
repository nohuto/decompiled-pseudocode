/*
 * XREFs of MiPrefetchRestOfCluster @ 0x1403791B8
 * Callers:
  ...
  if ( v2 < a2[2] )
  {
    ...
    if ( v4 >= *v3 )
    {
      ...
      if ( v4 < v6 + v5 )
      {
        v11 = v4;
        v12 = v5 + v6 - v4;
        EffectivePagePriorityThread = MiGetEffectivePagePriorityThread(KeGetCurrentThread(), v12, v5);
        v9 = 1LL;
        ...
        MiPrefetchVirtualMemory(
          ...
          &v11,
          v9,
          EffectivePagePriorityThread & 7 | (8 * (EffectivePagePriorityThread & 7 | 0x8000u)));
      }
    }
  }
}
