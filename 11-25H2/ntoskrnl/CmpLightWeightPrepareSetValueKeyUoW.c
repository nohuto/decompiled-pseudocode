/*
 * XREFs of CmpLightWeightPrepareSetValueKeyUoW @ 0x1408864B8
 * Callers:
...
__int64 __fastcall CmpLightWeightPrepareSetValueKeyUoW(__int64 a1)
{
  ...
  ULONG_PTR v41; // [rsp+100h] [rbp+77h] BYREF
