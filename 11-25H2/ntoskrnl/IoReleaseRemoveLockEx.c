/*
 * XREFs of IoReleaseRemoveLockEx @ 0x140306440
 * Callers:
 ...
 *     ViFilterGenericCompletionRoutine @ 0x140B8D460 (ViFilterGenericCompletionRoutine.c)
 *     ViFilterStartCompletionRoutine @ 0x140B8D560 (ViFilterStartCompletionRoutine.c)
 * Callees:
