/*
 * XREFs of PopTraceThermalStandbyComplete @ 0x1405D1C10
 * Callers:
...
void PopTraceThermalStandbyComplete()
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)&byte_14004946F, 0LL, 0LL, 5u, &v6);
  }
}
