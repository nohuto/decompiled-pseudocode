/*
 * XREFs of EmonSaveProfilingContextInternalOriginal @ 0x14055BD64
 * Callers:
 *     EmonSaveProfilingContextOriginal @ 0x140B3F6F0 (EmonSaveProfilingContextOriginal.c)
 * Callees:
 *     EmonReadCounter @ 0x14055AEC4 (EmonReadCounter.c)
 */
