...
LABEL_10:
    ...
    {
      v25 = a5;
      v38 = (*(_DWORD *)(a4 + 20) >> 1) & 0x7F;
      v51 = 0;
      v27 = !_BitScanReverse(&v39, v38);
      if ( v27 || (_BitScanReverse(&v40, a5), v51 = v40, v39 <= v40) )
      {
LABEL_17:
        *(_DWORD *)(v18 + 48) |= 2u;
LABEL_18:
...
LABEL_19:
      ...
      *v61 = v30;
      ...
      v58 = v32;
      if ( v27 || (_BitScanReverse(&v33, v25), v59 = v33, v32 <= v33) )
      {
        LODWORD(v61) = 0;
        v27 = !_BitScanReverse(&v34, (unsigned __int8)v31 >> 1);
        v60 = v34;
        if ( v27 || (_BitScanReverse(&v35, v25), LODWORD(v61) = v35, v34 <= v35) )
        {
...
LABEL_29:
      ...
      *(_QWORD *)(v18 + 40) = Object;
      ...
      if ( !v27 )
      {
        ...
        if ( v28 > v29 )
        {
          ...
          v44 = v26 >> 8;
          v57 = 0;
          v27 = !_BitScanReverse(&v45, v44 & 0x7F);
          v56 = v45;
          if ( v27 || (_BitScanReverse(&v46, a5), v57 = v46, v45 <= v46) )
          {
            if ( ((unsigned __int8)a5 & (unsigned __int8)v44 & 0x7F) == 0 )
              goto LABEL_19;
          }
        }
      }
    ...
    *(_QWORD *)(v18 + 32) = Object;
    v41 = (*(_DWORD *)(a4 + 20) >> 8) & 0x7F;
    v53 = 0;
    v27 = !_BitScanReverse(&v42, v41);
    v52 = v42;
    if ( v27 || (_BitScanReverse(&v43, a5), v53 = v43, v42 <= v43) )
    {
      *(_DWORD *)(v18 + 48) |= 1u;
      goto LABEL_18;
    }
  ...
  {
    v27 = *(_QWORD *)(a4 + 24) == 0LL;
    v71 = *(_QWORD *)(a4 + 24);
    v70 = 0x100000003uLL;
    if ( !v27 )
      PfSnPrefetchFileMetadata(a1, *(_QWORD *)(a2 + 32), &v70);
  }
...
LABEL_31:
  if ( (BugCheckParameter2.m256i_i64[3] & 0x400000000LL) != 0 )
  {
    ...
    {
      *(_OWORD *)&v68[8] = *(_OWORD *)BugCheckParameter2.m256i_i8;
      v69 = BugCheckParameter2.m256i_i64[2];
      *(_QWORD *)v68 = v36 + 40;
      _InterlockedIncrement((volatile signed __int32 *)(v36 + 84));
      guard_dispatch_icall_no_overrides(v68);
    }
  }
