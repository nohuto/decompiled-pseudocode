/*
 * XREFs of MiReduceZeroingThreads @ 0x140437994
 * Callers:
 ...
 *     MiFindReductionContendingThread @ 0x1404809B0 (MiFindReductionContendingThread.c)
...
__int64 __fastcall MiReduceZeroingThreads(unsigned int *a1, int a2, __int64 a3)
{
  ...
  *(_DWORD *)a3 = v5;
  ...
  if ( *((_BYTE *)a1 + 36) )
    ...
    v10 = *(void ***)(384LL * *(unsigned int *)(v8 + 56) + qword_140E2D8B8 + 376);
  v11 = *((_DWORD *)v10 + 2);
  v12 = 0;
  if ( (_DWORD)v5 )
  {
