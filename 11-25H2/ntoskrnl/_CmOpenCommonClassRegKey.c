/*
 * XREFs of _CmOpenCommonClassRegKey @ 0x1408CA33C
 * Callers:
 ...
 *     _CmOpenInterfaceClassRegKey @ 0x140A1B224 (_CmOpenInterfaceClassRegKey.c)
        ...
        _DWORD *a8)
{
  ...
  __int64 (__fastcall *v13)(void *, PCWSTR, unsigned int, int, int, __int64); // rdi
  int v14; // eax
  int v15; // eax
  int v16; // ebx
  int v18; // eax
  ...
  v13 = (__int64 (__fastcall *)(void *, PCWSTR, unsigned int, int, int, __int64))a1[63];
  v22 = a5;
  v23 = a6;
  v21 = a4;
  v24 = a7;
