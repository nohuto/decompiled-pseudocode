/*
 * XREFs of MiLogCreateImageFileMapFailure @ 0x1407DC1AC
 * Callers:
...
void MiLogCreateImageFileMapFailure()
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    && **(_DWORD **)&qword_140E372D8 > 2u
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000004000LL) )
  {
    ...
    v6 = v2;
    v8 = 0x1000000LL;
    tlgWriteEx_EtwWriteEx(v3, (unsigned __int8 *)&byte_140055001, v2, 1u, v4, v5, 8u, &v9);
  }
}
