/*
 * XREFs of PopEndMirroring @ 0x140B54550
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  else
  {
    ...
    *(_DWORD *)&Affinity.Group = (unsigned __int16)(v4 >> 6);
    ...
    dword_140E273B0 = KeNumberProcessors_0;
    dword_140E273BC = KeNumberProcessors_0;
    dword_140E273B8 = 1;
    if ( ((unsigned __int8)&stru_140E273C0 & 0xF) != 0 )
    ...
    while ( 1 )
    {
      while ( v7 )
      {
        ...
        v7 &= ~(1LL << v8);
        *((_QWORD *)&v14 + 1) = v7;
        v9 = *((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v15 + (unsigned __int8)v8);
        if ( v9 )
        {
          v10 = dword_140E273B4;
          if ( !Dpc.DpcData )
