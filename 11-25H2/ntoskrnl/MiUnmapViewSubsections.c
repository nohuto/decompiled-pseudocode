/*
 * XREFs of MiUnmapViewSubsections @ 0x14022EE90
 * Callers:
...
__int64 __fastcall MiUnmapViewSubsections(__int64 a1, ULONG_PTR a2, __int64 a3)
{
    ...
    do
    {
      if ( *(_QWORD *)(a2 + 8) )
      {
          ...
          && (*(_QWORD *)(v16 + 64) || (*(_DWORD *)(v16 + 92) & 0x10000) == 0) )
        {
          ...
          if ( v19 != *((ULONG **)qword_140E2FD48 + (*(_WORD *)(v16 + 60) & 0x3FF)) )
          {
  ...
  *(__m128i *)(a1 + 40) = _mm_add_epi64(
  ...
  v25 = *((_QWORD *)qword_140E2FD48 + (*(_WORD *)(a1 + 60) & 0x3FF));
  MiCheckControlArea(a1, CurrentIrql);
  return MiReturnCrossPartitionSectionCharges(v25, v7, v3);
}
