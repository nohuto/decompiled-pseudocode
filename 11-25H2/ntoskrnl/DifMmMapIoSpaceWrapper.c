/*
 * XREFs of DifMmMapIoSpaceWrapper @ 0x140627C10
 * Callers:
 *     <none>
 * Callees:
        ...
        MEMORY_CACHING_TYPE CacheType)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((PHYSICAL_ADDRESS *)&v16 + 1) = PhysicalAddress;
    *(_QWORD *)&v16 = NumberOfBytes;
    DWORD2(v15) = CacheType;
  ...
  v17 = MmMapIoSpace(PhysicalAddress, NumberOfBytes, CacheType);
  if ( v7 )
  {
