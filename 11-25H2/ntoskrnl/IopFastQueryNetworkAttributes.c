/*
 * XREFs of IopFastQueryNetworkAttributes @ 0x140AA0AB0
 * Callers:
 *     IoFastQueryNetworkAttributes @ 0x140AA0A70 (IoFastQueryNetworkAttributes.c)
 * Callees:
...
char __fastcall IopFastQueryNetworkAttributes(__int64 a1, int a2, char a3, int a4, __int64 a5, __int64 a6)
{
  ...
  v10 = ObOpenObjectByNameEx(a1, (__int64)IoFileObjectType, a3, 0LL, a2, (int)v13, CurrentSilo, Handle);
  if ( *((_QWORD *)&v25 + 1) )
