/*
 * XREFs of IopSendMessageToTrackService @ 0x140AA324C
 * Callers:
  ...
  while ( 1 )
  {
    if ( !IopLinkTrackingServiceObject )
    {
      ...
      else
      {
        ...
        KeResetEvent(&stru_140F8C120);
        ExQueueWorkItem(&IopLinkTrackingPacket, DelayedWorkQueue);
        v9 = KeWaitForSingleObject(&stru_140F8C120, Executive, PreviousMode, 0, 0LL);
        v10 = v9;
        if ( v9 != 192 && v9 != 257 && dword_140F8C138 < 0 )
          v10 = dword_140F8C138;
        KeSetEvent(&IopLinkTrackingPortObject, 0, 0);
        if ( v10 )
          return v10;
