/*
 * XREFs of EtwTraceSystemTimeChange @ 0x140B5DDB4
 * Callers:
...
char __fastcall EtwTraceSystemTimeChange(_QWORD *a1, _QWORD *a2, int a3, _QWORD *a4, int a5, int a6, int a7)
{
  ...
  {
    LOBYTE(v13) = tlgKeywordOn((__int64)&dword_140E09048, 0x400000000000LL);
    if ( (_BYTE)v13 )
    {
      v27 = v15;
      v53 = &v27;
      ...
      LOBYTE(v13) = tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)byte_140051B03,
                      0LL,
                      0LL,
                      0xDu,
                      &v52);
