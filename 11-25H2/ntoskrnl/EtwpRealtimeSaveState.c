/*
 * XREFs of EtwpRealtimeSaveState @ 0x140AA5500
 * Callers:
...
__int64 __fastcall EtwpRealtimeSaveState(__int64 a1)
{
  ...
  v2 = ZwWriteFile(v7, 0LL, 0LL, 0LL, &IoStatusBlock, Buffer, 0x48u, &ByteOffset, 0LL);
  if ( v2 < 0 )
  {
LABEL_5:
...
LABEL_6:
    v8 = *(void **)(a1 + 360);
    FileInformation[0] = 1;
    ZwSetInformationFile(v8, &IoStatusBlock, FileInformation, 1u, FileDispositionInformation);
  }
