/*
 * XREFs of ViFilterDispatchPnp @ 0x140B8D0D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViFilterYieldInitialization @ 0x140608DB0 (ViFilterYieldInitialization.c)
 */
...
NTSTATUS __fastcall ViFilterDispatchPnp(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  v5 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)DeviceExtension + 1, v4, &byte_140B9B280, 1u, 0x20u);
  v6 = v5;
  if ( v5 < 0 )
  {
