/*
 * XREFs of MiGetSingleHugeRangeToZero @ 0x14041CAF8
 * Callers:
...
unsigned __int64 __fastcall MiGetSingleHugeRangeToZero(__int64 a1, __int64 a2, volatile signed __int32 *a3)
{
  __int16 *v3; // rax
  ...
  v9 = 0;
  v26 = dword_140E2D980[0];
  v10 = _InterlockedExchangeAdd(a3, 1u);
  v21 = (*((_QWORD *)&v22 + 1) >> 16) & 3LL;
  v11 = v10 % dword_140E2D980[v21];
  ColorHeadHugeRangeBase = MiGetColorHeadHugeRangeBase(a2, DWORD2(v22) ^ (v10 % dword_140E2D980[v21]), 1LL);
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( !v13
        && ((*(int *)(qword_140E2FD88 + 4 * ((((__int64)(8 * v16) >> 3) & 0x3FFFFFuLL) >> 5)) >> (((__int64)(8 * v16) >> 3) & 0x1F)) & 1) != 0 )
      {
        v9 = 1;
LABEL_8:
        v11 = _InterlockedExchangeAdd(a3, 1u) % (unsigned int)dword_140E2D980[v21];
        ++v14;
        goto LABEL_9;
      }
      ...
      {
        if ( (v18 & 0x800000000000000LL) == 0 && (unsigned int)MiBeginPageAccessor(a1, 0LL, v17, 1LL) )
        {
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140E2FD88
                                      + 4 * (((((__int64)v17 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << ((((__int64)v17 - qword_140E2FD80) >> 3) & 0x1F)));
          return v6;
        }
        _InterlockedAnd(
          (volatile signed __int32 *)(qword_140E2FD88
      ...
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140E2FD88 + 4 * (((((__int64)v17 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v17 - qword_140E2FD80) >> 3) & 0x1F)));
LABEL_9:
