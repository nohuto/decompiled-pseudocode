/*
 * XREFs of DifPoFxStartDevicePowerManagementWrapper @ 0x14062C180
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxStartDevicePowerManagementWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  v10 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(180);
  ...
  if ( APIThunkContextById )
  {
    ...
    v5 = 0;
    *((_QWORD *)&v10 + 1) = BugCheckParameter2;
