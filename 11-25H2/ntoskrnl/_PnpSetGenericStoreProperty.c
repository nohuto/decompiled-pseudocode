/*
 * XREFs of _PnpSetGenericStoreProperty @ 0x140953DB4
 * Callers:
...
__int64 __fastcall PnpSetGenericStoreProperty(int a1, int a2, _WORD *a3, __int64 a4, int a5, __int64 a6, int a7)
{
