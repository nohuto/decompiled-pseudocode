/*
 * XREFs of PnpQueuePendingSurpriseRemoval @ 0x140830954
 * Callers:
...
LABEL_4:
  ...
  v16 = (__int64 *)qword_140F8B098;
  if ( *(PVOID **)qword_140F8B098 != &IopPendingSurpriseRemovals )
LABEL_6:
    __fastfail(3u);
  *(_QWORD *)Pool2 = &IopPendingSurpriseRemovals;
  *(_QWORD *)(Pool2 + 8) = v16;
  *v16 = Pool2;
  qword_140F8B098 = Pool2;
LABEL_13:
  v22 = 0LL;
  while ( 1 )
  {
