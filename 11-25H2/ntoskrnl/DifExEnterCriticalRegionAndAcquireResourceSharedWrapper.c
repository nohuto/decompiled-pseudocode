/*
 * XREFs of DifExEnterCriticalRegionAndAcquireResourceSharedWrapper @ 0x140611E90
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifExEnterCriticalRegionAndAcquireResourceSharedWrapper(PERESOURCE Resource)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(405);
  ...
  v12 = ExEnterCriticalRegionAndAcquireResourceShared(Resource);
  if ( v3 )
  {
