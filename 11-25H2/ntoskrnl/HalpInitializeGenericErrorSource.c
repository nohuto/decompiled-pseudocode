/*
 * XREFs of HalpInitializeGenericErrorSource @ 0x140B3E2D4
 * Callers:
  ...
  switch ( *(_BYTE *)(a2 + 64) )
  {
    case 0:
      ...
      *((_QWORD *)P + 2) = MEMORY[0xFFFFF78000000320];
      if ( inited < 0 )
        return v5;
      v21 = (_QWORD *)qword_140FBFFF8;
      if ( *(__int64 **)qword_140FBFFF8 == &HalpGenericPolledErrorSourceListHead )
      {
        v22 = HalpGenericPollingInitDone == 0;
        *v20 = &HalpGenericPolledErrorSourceListHead;
        v20[1] = v21;
        *v21 = v20;
        qword_140FBFFF8 = (__int64)v20;
        if ( v22 )
        {
    ...
    case 4:
      ...
      if ( v14 >= 0 )
      {
        ...
        v18 = (_QWORD *)qword_140FC0118;
        if ( *(__int64 **)qword_140FC0118 != &HalpGenericNmiErrorSourceListHead )
          goto LABEL_56;
        *v15 = &HalpGenericNmiErrorSourceListHead;
        v15[1] = v18;
        *v18 = v15;
        qword_140FC0118 = (__int64)v15;
      }
    ...
    case 8:
      ...
      if ( v11 >= 0 )
      {
        v12 = (_QWORD *)qword_140FBFFE8;
        if ( *(__int64 **)qword_140FBFFE8 != &HalpGenericSeaErrorSourceListHead )
          goto LABEL_56;
        v13 = P;
        *(_QWORD *)P = &HalpGenericSeaErrorSourceListHead;
        v13[1] = v12;
        *v12 = v13;
        qword_140FBFFE8 = (__int64)v13;
      }
    ...
    case 9:
      ...
      if ( v8 >= 0 )
      {
        v9 = (_QWORD *)qword_140FBFFD8;
        if ( *(__int64 **)qword_140FBFFD8 != &HalpGenericSeiErrorSourceListHead )
          goto LABEL_56;
        v10 = P;
        *(_QWORD *)P = &HalpGenericSeiErrorSourceListHead;
        v10[1] = v9;
        *v9 = v10;
        qword_140FBFFD8 = (__int64)v10;
      }
    ...
    case 0xA:
      ...
      if ( (v5 & 0x80000000) != 0 )
        return v5;
      v7 = (_QWORD *)qword_140FBFFC8;
      if ( *(__int64 **)qword_140FBFFC8 == &HalpGenericPeiErrorSourceListHead )
      {
        *v6 = &HalpGenericPeiErrorSourceListHead;
        v6[1] = v7;
        *v7 = v6;
        qword_140FBFFC8 = (__int64)v6;
LABEL_59:
