/*
 * XREFs of PnpDeviceActionWorker @ 0x14046E540
 * Callers:
...
LABEL_6:
    ...
    if ( v5 )
    {
      ...
      v18 = *(_DWORD *)(v5 + 24);
      v19 = KeAcquireSpinLockRaiseToDpc(&qword_140F0D880);
      KeReleaseSpinLock(&qword_140F0D880, v19);
      v20 = KeAcquireSpinLockRaiseToDpc(&qword_140F06090);
      dword_140F0609C = v18;
      if ( byte_140F06110 )
        qword_140F06128 = MEMORY[0xFFFFF78000000008];
      KeReleaseSpinLock(&qword_140F06090, v20);
      *(_QWORD *)(v5 + 8) = v5;
      *(_QWORD *)v5 = v5;
...
LABEL_41:
      ...
      v33 = KeAcquireSpinLockRaiseToDpc(&qword_140F0D880);
      KeReleaseSpinLock(&qword_140F0D880, v33);
      v34 = KeAcquireSpinLockRaiseToDpc(&qword_140F06090);
      if ( byte_140F06110 )
      {
      ...
      dword_140F0609C = 28;
      KeReleaseSpinLock(&qword_140F06090, v34);
      do
      {
        v35 = *(unsigned int ***)v5;
        ...
        *((_QWORD *)v36 + 1) = v5;
        ...
        v38 = KeAcquireSpinLockRaiseToDpc(&qword_140F0D880);
        v39 = dword_140F0D888-- == 1;
        v40 = v38;
        if ( v39 )
          PopDirectedDripsClearDisengageReason(4);
        KeReleaseSpinLock(&qword_140F0D880, v40);
        v41 = KeAcquireSpinLockRaiseToDpc(&qword_140F06090);
        ...
        KeReleaseSpinLock(&qword_140F06090, v41);
        v42 = v35[7];
        if ( v42 )
          *v42 = v3;
