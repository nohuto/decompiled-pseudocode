/*
 * XREFs of RtlpCreateHashTable @ 0x1404805A0
 * Callers:
 *     RtlCreateHashTable @ 0x140480580 (RtlCreateHashTable.c)
 *     RtlCreateHashTableEx @ 0x1405DE200 (RtlCreateHashTableEx.c)
 ...
 *     RtlpInitializeSecondLevelDir @ 0x1404806EC (RtlpInitializeSecondLevelDir.c)
