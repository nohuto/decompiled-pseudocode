 ...
 *     chunkset_core @ 0x1405E7B08 (chunkset_core.c)
...
LABEL_84:
              while ( 1 )
              {
                ...
                v41 = v11 & 7;
                v11 >>= 3;
                *(_WORD *)&v5[2 * *((unsigned __int16 *)qword_140034BB0 + (unsigned int)(*((_DWORD *)v5 + 33))++) + 144] = v41;
                v12 -= 3;
              }
              while ( (unsigned int)v40 < 0x13 )
              {
                *(_WORD *)&v5[2 * *((unsigned __int16 *)qword_140034BB0 + v40) + 144] = 0;
            ...
            *((_DWORD *)v5 + 3) = v22 & 1;
            if ( (v23 & 3) != 0 )
            {
              switch ( v23 & 3 )
              {
                case 1u:
                  *v14 = 9;
                  *((_QWORD *)v5 + 12) = qword_140034330;
                  *((_QWORD *)v5 + 13) = qword_140034B30;
                  *v13 = 5;
                  *((_DWORD *)v5 + 2) = 16199;
                  break;
                case 2u:
