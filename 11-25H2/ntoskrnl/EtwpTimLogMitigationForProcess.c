/*
 * XREFs of EtwpTimLogMitigationForProcess @ 0x140904814
 * Callers:
 ...
 *     Feature_ThreatintDeadlockFix__private_IsEnabledDeviceUsageNoInline @ 0x140643F68 (Feature_ThreatintDeadlockFix__private_IsEnabledDeviceUsageNoInline.c)
...
void __fastcall EtwpTimLogMitigationForProcess(int a1, int a2, const EVENT_DESCRIPTOR *a3, __int64 a4, char a5)
{
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  if ( (unsigned int)dword_140E09048 > 5 && tlgKeywordOn((__int64)&dword_140E09048, 0x200000000000LL) )
  {
    ...
    v39[1] = 0;
    v41 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09048, (unsigned __int8 *)&word_140051F0E, 0LL, 0LL, 9u, &v27);
  }
  if ( v19 )
