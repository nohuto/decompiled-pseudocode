/*
 * XREFs of KiSrcuInitializeTopology @ 0x1405BCF88
 * Callers:
...
__int64 KiSrcuInitializeTopology()
{
  ...
  v4 = KeAcquireSpinLockRaiseToDpc(&qword_140F0F8B8);
  if ( !byte_140F0F8C0 )
  {
    if ( !Pool2 )
    {
    ...
    qword_140F0F8C8 = (__int64)Pool2;
    qword_140F0F8D0 = (__int64)Pool2 + 8 * v0;
    Pool2 = 0LL;
    qword_140F0F8D8 = qword_140F0F8D0 + 16;
    if ( v1 > 1u )
    {
      v6 = &byte_140F0F8C5;
      v7 = &qword_140F0F8D8;
    ...
    v25 = 0;
    v15 = (unsigned __int8)byte_140F0F8C1[v1];
    if ( (_DWORD)v0 )
    {
      v16 = 0LL;
      v17 = 0;
      ...
      do
      {
        *(_QWORD *)(v16 + qword_140F0F8C8) = 1LL << (v17 % v15);
        v17 = v18 + 1;
        v16 += 8LL;
        v18 = v17;
      }
