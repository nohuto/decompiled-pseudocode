/*
 * XREFs of MiOrderTrimList @ 0x14043CA00
 * Callers:
 *     MiProcessWorkingSets @ 0x1403C24F0 (MiProcessWorkingSets.c)
 * Callees:
 *     MiIsStoreProcess @ 0x140239E20 (MiIsStoreProcess.c)
 *     MiUpdateClaimDistribution @ 0x14043CC90 (MiUpdateClaimDistribution.c)
 *     MiWorkingSetVeryLarge @ 0x14043CCF0 (MiWorkingSetVeryLarge.c)
