/*
 * XREFs of RtlCompressBufferDeflateInternal @ 0x1405E5FC4
 * Callers:
 *     RtlCompressBufferDeflateRaw @ 0x1405E60D0 (RtlCompressBufferDeflateRaw.c)
 *     RtlCompressBufferDeflateZlib @ 0x1405E6120 (RtlCompressBufferDeflateZlib.c)
 * Callees:
