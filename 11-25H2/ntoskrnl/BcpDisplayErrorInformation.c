/*
 * XREFs of BcpDisplayErrorInformation @ 0x14068DE9C
 * Callers:
 *     BgpFwDisplayBugCheckScreen @ 0x14068F010 (BgpFwDisplayBugCheckScreen.c)
 * Callees:
 *     BcpConvertBugDataToString @ 0x14068D50C (BcpConvertBugDataToString.c)
 ...
 *     BcpSanitizeDriverName @ 0x14068ECC4 (BcpSanitizeDriverName.c)
...
__int64 __fastcall BcpDisplayErrorInformation(unsigned int a1, int a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  ...
  v34 = a2;
  v33 = BcpCursor;
  v9 = (int *)((char *)&unk_140E0ECC0 + 84 * a1);
  BcpTextBoxLeftEdgeOverride = (__int64)&v33;
  BcpDisplayCriticalString(&stru_140E3E800, v9[1], a3, a1);
  BcpDisplayCriticalString(&stru_140E3E810, v9[1], v10, a1);
  v11 = v9[11];
  v12 = (unsigned int)(v11 + dword_140EEF840);
  v13 = v12 + v11;
  v32 = v12 + v11;
  BcpSetCursorPosition(v6, v12, &v32);
  BcpDisplayCriticalString(&stru_140E3E750, *v9, v14, a1);
  v15 = v13 + v9[11];
  v32 = v15;
  BcpSetCursorPosition(v6, v13, &v32);
  BcpDisplayCriticalString(&stru_140E3E7F0, *v9, v16, a1);
  ...
  if ( v39 )
  {
    ...
    BcpDisplayCriticalString(&stru_140E3E7E0, *v9, v21, a1);
  ...
  do
  {
    ...
    if ( BcpDisplayParameters || (a6 & 8) != 0 && v34 == 317 )
    {
      ...
      BcpSetCursorPosition(0LL, (unsigned int)dword_140EEF840, 0LL);
    }
    v26 += 16LL;
    ++v7;
    --v28;
