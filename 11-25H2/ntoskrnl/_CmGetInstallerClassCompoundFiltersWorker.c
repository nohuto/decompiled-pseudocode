/*
 * XREFs of _CmGetInstallerClassCompoundFiltersWorker @ 0x14080E910
 * Callers:
...
LABEL_8:
    ...
    && HIDWORD(v28) == 8210 )
  {
    ...
    ObjectProperty = PnpGetObjectProperty(a1, a2, 2, a3, 0LL, v31, (__int64)&v28 + 4, Pool2, v28, (__int64)&v28, 0);
    if ( ObjectProperty < 0 )
      goto LABEL_48;
    v22 = a3;
    goto LABEL_15;
...
LABEL_44:
    ...
    if ( ObjectProperty < 0 )
      goto LABEL_44;
    v22 = a3;
    PnpSetObjectProperty(a1, a2, 2, 0LL, v31, 8210, (__int64)v14, v28, 0);
LABEL_15:
