/*
 * XREFs of KseDriverUnloadImage @ 0x140A4FCB0
 * Callers:
...
__int64 __fastcall KseDriverUnloadImage(__int64 a1)
{
  ...
  if ( (unsigned int)KsepIsModuleShimmed(&KseEngine, *(_QWORD *)(a1 + 48), &v29) && v29 )
  {
    ...
    v4 = KeAbPreAcquire((__int64)&qword_140E66840, 0LL);
    v5 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140E66840, 0LL);
    v6 = v4;
    if ( v5 )
      ExfAcquirePushLockExclusiveEx(&qword_140E66840, v4, (__int64)&qword_140E66840);
    if ( v6 )
      *((_BYTE *)v6 + 10) = 1;
    v7 = (_QWORD *)v29;
    v8 = 0LL;
    ...
    if ( v10 )
    {
      do
      {
        ...
        if ( (*(_DWORD *)(v11 + 28) & 4) == 0 && *(_QWORD *)(*(_QWORD *)(v11 + 16) + 32LL) )
          guard_dispatch_icall_no_overrides(*(_QWORD *)(a1 + 48));
        v10 = *v9;
    ...
    if ( v10 )
    {
      do
      {
        ...
        if ( !*((_DWORD *)v13 + 6) )
        {
          ...
          dword_140F0ECA4[2 * v14] = -1073740768;
