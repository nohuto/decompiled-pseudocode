/*
 * XREFs of PopVerifySystemPowerPolicy @ 0x140A102AC
 * Callers:
...
__int64 __fastcall PopVerifySystemPowerPolicy(_OWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 224) = *((_QWORD *)v4 + 12);
  ...
  else if ( (_BYTE)word_140F0B8C4 )
  {
    *(_DWORD *)(a2 + 72) = 3;
  }
  else if ( byte_140F0B8C3 )
  {
    *(_DWORD *)(a2 + 72) = 2;
  }
  v5 = (int *)(a2 + 68);
  ...
  v9 = *(_DWORD *)(a2 + 212);
  if ( v9 < (unsigned int)qword_140F0B790 )
  {
    *(_DWORD *)(a2 + 212) = qword_140F0B790;
    v9 = qword_140F0B790;
  }
  if ( v9 > HIDWORD(qword_140F0B790) )
    *(_DWORD *)(a2 + 212) = HIDWORD(qword_140F0B790);
