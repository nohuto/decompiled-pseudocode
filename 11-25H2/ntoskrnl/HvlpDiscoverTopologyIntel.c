/*
 * XREFs of HvlpDiscoverTopologyIntel @ 0x140C08718
 * Callers:
...
LABEL_11:
    HvlpLpCpuid(a1, 4u, 0, &v13);
    _BitScanReverse(&v9, 2 * ((unsigned int)v13 >> 26) + 1);
    v10 = 1 << v9;
LABEL_13:
    HvlpLpCpuid(a1, 1u, 0, &v13);
  ...
  HvlpLpCpuid(a1, 0xBu, 0, &v13);
  if ( !DWORD1(v13) )
    goto LABEL_11;
  v7 = 0;
  do
  {
    HvlpLpCpuid(a1, 0xBu, v7++, &v13);
