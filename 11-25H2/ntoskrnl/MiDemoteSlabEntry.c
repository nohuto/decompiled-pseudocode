/*
 * XREFs of MiDemoteSlabEntry @ 0x1403B7C60
 * Callers:
...
__int64 __fastcall MiDemoteSlabEntry(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v9 = *(_QWORD *)(a3 + 40);
  v10 = v8;
  v11 = qword_140E3CF00 + 2 * ((v6 + v9 - 1) >> 9);
  for ( i = (_WORD *)(qword_140E3CF00 + 2 * (v9 >> 9)); (unsigned __int64)i <= v11; ++i )
    *i = 0;
