/*
 * XREFs of VrpPreLoadKey @ 0x140A71EB8
 * Callers:
...
__int64 __fastcall VrpPreLoadKey(_QWORD *a1, GUID *a2)
{
  ...
  __int128 v53; // [rsp+138h] [rbp-170h] BYREF
  __int128 v54; // [rsp+148h] [rbp-160h]
  __int128 v55; // [rsp+158h] [rbp-150h]
  __int128 v56; // [rsp+168h] [rbp-140h] BYREF
  ...
  *(_QWORD *)&String1.Length = 0LL;
  ...
  if ( (unsigned int)dword_140E0A400 > 5 )
  {
    ...
    v64 = v14;
    v65 = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E0A400, (unsigned __int8 *)byte_1400578FD, &v59, 0LL, 4u, v60);
  }
  v6 = 0;
  String1.Length = 0;
  v7 = 0LL;
                    ...
                    if ( NamespaceNodePlaceholderKey >= 0 )
                    {
                      ...
                      if ( (unsigned int)dword_140E0A400 > 5 )
                      {
                        ...
                        tlgWriteTransfer_EtwWriteTransfer(
                          ...
                          (unsigned __int8 *)&word_1400579F6,
                          &v59,
                          0LL,
                          7u,
                          v60);
...
LABEL_21:
  ...
  if ( ((NamespaceNodePlaceholderKey + 0x80000000) & 0x80000000) == 0
    && NamespaceNodePlaceholderKey != -1073740541
    && (unsigned int)dword_140E0A400 > 2 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140E0A400,
      (unsigned __int8 *)&qword_140057790,
      &v59,
      0LL,
      3u,
      v60);
