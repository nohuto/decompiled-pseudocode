/*
 * XREFs of BgpTxtDisplayCharacter @ 0x140473A88
 * Callers:
 ...
 *     TxtpGetCacheEntry @ 0x14049DD8C (TxtpGetCacheEntry.c)
 ...
 *     TxtpJustifyRectangle @ 0x140BA2DD4 (TxtpJustifyRectangle.c)
...
LABEL_21:
      ...
      if ( (a3 & 1) != 0 || (dword_140EEFD90 & 0x1000000) != 0 || (v14 = BgpGxDrawRectangle(v7, &v24), v14 >= 0) )
      {
        if ( v15 )
