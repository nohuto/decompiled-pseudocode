/*
 * XREFs of PiDqOpenUserObjectRegKey @ 0x14083E2D0
 * Callers:
  ...
  if ( RelativeObjectRegPath >= 0 )
  {
    ...
    else
    {
      if ( *(_QWORD *)&PiPnpRtlCtx && (v17 = *(_QWORD *)(*(_QWORD *)&PiPnpRtlCtx + 224LL)) != 0 )
        ...
        v18 = 0LL;
      v9 = P;
      RelativeObjectRegPath = RegRtlOpenKeyTransacted(0LL, P, 0LL, 4LL, &Handle, v18);
      if ( RelativeObjectRegPath >= 0 )
      {
        ...
        else
        {
          ...
          else
          {
            v10 = (wchar_t *)pszSrc;
            v25 = 2;
            v19 = PnpCtxRegOpenKey(PiPnpRtlCtx, (_DWORD)Handle, (_DWORD)pszSrc, 0, a3, (__int64)KeyHandle);
          }
