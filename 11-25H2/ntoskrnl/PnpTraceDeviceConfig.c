/*
 * XREFs of PnpTraceDeviceConfig @ 0x1406EC454
 * Callers:
        ...
        int *a28)
{
  ...
  const WCHAR *v43; // [rsp+68h] [rbp-98h]
  const WCHAR *v44; // [rsp+70h] [rbp-90h]
  const WCHAR *v45; // [rsp+78h] [rbp-88h]
  const WCHAR *v46; // [rsp+80h] [rbp-80h]
  const WCHAR *v47; // [rsp+88h] [rbp-78h]
  ...
  const WCHAR **v95; // [rsp+290h] [rbp+190h]
  ...
  if ( (unsigned int)dword_140E06F38 > 5 )
  {
    ...
    if ( (_BYTE)v28 )
    {
      ...
      LOBYTE(v28) = tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)byte_1400461B5,
                      0LL,
                      0LL,
                      0x23u,
                      &v48);
