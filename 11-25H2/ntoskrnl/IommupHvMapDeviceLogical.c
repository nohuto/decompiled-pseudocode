/*
 * XREFs of IommupHvMapDeviceLogical @ 0x14026DF34
 * Callers:
...
__int64 __fastcall IommupHvMapDeviceLogical(ULONG_PTR BugCheckParameter3, __int64 a2, int a3, _QWORD *a4, ULONG_PTR a5)
{
  ...
  BYTE4(v12) = 0;
  if ( (__int64 (__fastcall *)(_DWORD, _DWORD, _DWORD, _DWORD, __int64, char))qword_140FC08C8 == HvlDmaMapDeviceLogicalRange )
