        ...
        unsigned int *a9)
{
  ...
  _QWORD v53[6]; // [rsp+130h] [rbp-98h] BYREF
...
LABEL_24:
  ...
  P = Src;
  v22 = PreviousMode;
  if ( !Src || (v23 = SeCaptureSid(Src, PreviousMode, v11, v12, v31, 1, &P), v35 = v23, v23 >= 0) )
  {
LABEL_39:
    ...
    if ( v23 >= 0 )
    {
      ...
      if ( v23 >= 0 )
      {
        ...
        v53[1] = v26;
        v54 = 0x20000;
        v28 = AlpcpDispatchConnectionRequest((__int64)v53);
        v23 = v28;
        if ( v28 < 0 )
        {
          if ( AlpcpLogEnabled )
