/*
 * XREFs of MiEmptyPageAccessLog @ 0x140322FE0
 * Callers:
    ...
    if ( v4 > 1 )
    {
      do
      {
        ...
        if ( v15 )
        {
          ...
          {
            v26 = *((_QWORD *)v3[6] - (*v10 & 0x1FF));
            v27 = *(_DWORD *)(*(_QWORD *)v26 + 56LL);
...
LABEL_28:
  ...
  if ( (unsigned __int64)v19 <= v18 )
  {
    ...
    {
      v20 = **v19;
      v21 = MiReferenceControlAreaFileWithTag(v20, 1666411853LL, v40);
      v22 = *(__int64 **)(v21 + 24);
      ObFastDereferenceObjectDeferDelete((__int64 *)(v20 + 64), v21, 1666411853LL);
      *v19++ = v22;
    }
