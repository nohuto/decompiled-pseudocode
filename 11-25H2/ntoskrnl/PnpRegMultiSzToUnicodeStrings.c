/*
 * XREFs of PnpRegMultiSzToUnicodeStrings @ 0x140C150B0
 * Callers:
...
__int64 __fastcall PnpRegMultiSzToUnicodeStrings(_DWORD *a1, ULONG_PTR *a2, unsigned int *a3)
{
  ...
  if ( v6 != v7 )
    v10 = v8;
  v24 = v10;
  Pool2 = ExAllocatePool2(0x100uLL, 16LL * v10, 0x75737050uLL);
  *v3 = Pool2;
  if ( !Pool2 )
    return 3221225626LL;
  v12 = 0;
  ...
  while ( v13 != v7 )
  {
    if ( !*v13 )
    {
      ...
      v17 = (void *)ExAllocatePool2(0x100uLL, v16, 0x75737050uLL);
      v18 = (PVOID *)*v3;
      v19 = 2LL * v12;
      v18[2 * v12 + 1] = v17;
      if ( !v17 )
...
LABEL_22:
  ...
  v22 = (void *)ExAllocatePool2(0x100uLL, v21 + 2LL, 0x75737050uLL);
  v23 = (PVOID *)*v3;
