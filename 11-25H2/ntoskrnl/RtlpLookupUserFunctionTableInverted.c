/*
 * XREFs of RtlpLookupUserFunctionTableInverted @ 0x14025ACD0
 * Callers:
...
__int64 __fastcall RtlpLookupUserFunctionTableInverted(unsigned __int64 a1, __int64 a2)
{
  ...
  v3 = qword_140FC64D8;
  v17 = *(_DWORD *)(qword_140FC64D8 + 8);
  v14 = 0;
  v15 = 0;
  v4 = qword_140FC64D8 + 16;
  v5 = *(_QWORD *)(qword_140FC64D8 + 24);
  if ( a1 < v5 || a1 >= v5 + *(unsigned int *)(qword_140FC64D8 + 32) )
  {
    v6 = *(_DWORD *)qword_140FC64D8 - 1;
    if ( (unsigned int)v6 <= 0x200 && *(_DWORD *)qword_140FC64D8 != 1 )
    {
      v7 = 1;
      v15 = 1;
      v14 = v6;
