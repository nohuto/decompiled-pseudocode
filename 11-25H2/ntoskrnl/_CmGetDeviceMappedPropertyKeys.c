/*
 * XREFs of _CmGetDeviceMappedPropertyKeys @ 0x1409A8830
 * Callers:
...
LABEL_11:
  ...
  {
    v21 = 32LL * j;
    v22 = *(__int64 *)((char *)&off_140B2C660 + v21);
    if ( v22 )
    {
      if ( a4
        || (DeviceMappedPropertyFromInstanceKeyRegValue = CmGetDeviceMappedPropertyFromInstanceKeyRegValue(
                                                            ...
                                                            a2,
                                                            a3,
                                                            (unsigned int)*(DEVPROPKEY **)((char *)&off_140B2C660 + v21),
                                                            (__int64)v33,
                                                            0LL,
                                                            0,
                                                            (__int64)&a7),
