/*
 * XREFs of ViPostPoolAllocation @ 0x140B81910
 * Callers:
  ...
  *a1 = v2;
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v10 > *(_DWORD *)(v5 + 120) )
      *(_DWORD *)(v5 + 120) = v10;
    v11 = v6 + _InterlockedExchangeAdd64(&qword_140F03AD8, v6);
    if ( v11 > qword_140F03AE8 )
      qword_140F03AE8 = v11;
    v12 = _InterlockedIncrement(&dword_140F03AC4);
    if ( v12 > dword_140F03ACC )
      dword_140F03ACC = v12;
  }
  else
  {
    ...
    if ( v14 > *(_DWORD *)(v5 + 124) )
      *(_DWORD *)(v5 + 124) = v14;
    v15 = v6 + _InterlockedExchangeAdd64(&qword_140F03AE0, v6);
    if ( v15 > qword_140F03AF0 )
      qword_140F03AF0 = v15;
    v16 = _InterlockedIncrement(&dword_140F03AC8);
    if ( v16 > dword_140F03AD0 )
      dword_140F03AD0 = v16;
  }
  result = v2;
  *v7 = a1;
