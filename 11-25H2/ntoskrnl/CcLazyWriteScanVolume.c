/*
 * XREFs of CcLazyWriteScanVolume @ 0x1404B5AC0
 * Callers:
      ...
      if ( v42 + 568 != a1 + 640 )
      {
        ...
        if ( CcShouldLazyWriteCacheMap(v42, 0LL, a1, v93, *(_QWORD *)(v42 + 96) & 0xFFFFFFFFFFFFFFF0uLL, v89) )
        {
          ...
          *(_DWORD *)(v42 + 152) |= 0x20u;
          ...
          ++P->TotalAllocates;
          v60 = (unsigned __int64)RtlpInterlockedPopEntrySList(&P->ListHead);
          if ( v60 )
            goto LABEL_88;
          ++P->AllocateMisses;
          L = CurrentPrcb->PPLookasideList[6].L;
          ++L->TotalAllocates;
          v60 = (unsigned __int64)RtlpInterlockedPopEntrySList(&L->ListHead);
          if ( v60
            || (Size = L->Size,
...
LABEL_88:
          ...
          *(_DWORD *)(v60 + 128) = 2;
          ...
          {
            v68 = (struct _KPRCB **)_InterlockedExchange64(v66, (__int64)&LockHandle);
            if ( v68 )
              KxWaitForLockOwnerShip((struct _KPRCB *)&LockHandle, v68);
          }
          else
          {
...
LABEL_104:
            if ( *(_QWORD *)(v60 + 152) + 120LL == v71 )
              ...
              CcPostWorkQueueRegular((__int64)v72, v71, v61, v62);
          }
          v41 = v100;
          v43 = (KSPIN_LOCK *)(v7 + 768);
          v101 = 1;
  ...
  while ( (_QWORD **)v79 != &v94 )
  {
    ...
    else
    {
      ...
      if ( v82 + 120 == v82 + 104 )
        ...
        CcPostWorkQueueRegular(v79, v83, v82, v30);
      v79 = (__int64)v94;
    }
  }
