/*
 * XREFs of sub_140BC7DF0 @ 0x140BC7DF0
 * Callers:
...
__int64 __fastcall sub_140BC7DF0(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 v3; // rdx
  __int64 v4; // r8
          ...
          *(_DWORD *)(v2 + 2524) &= ~0x200000u;
          if ( v28 != *(_QWORD *)(v2 + 2688) )
          {
            ...
            *(_DWORD *)(v32 + 16) = v31;
            ...
            sub_140BC7384(v2, 0LL, v28, 256LL);
          }
        }
      }
    }
              ...
              *(_DWORD *)(v2 + 2524) &= ~0x200000u;
              if ( v72 != *(_QWORD *)(v2 + 2688) )
              {
                ...
                *(_DWORD *)(v76 + 16) = v75;
                ...
                sub_140BC7384(v2, 0LL, v72, 256LL);
              }
            }
          }
        }
