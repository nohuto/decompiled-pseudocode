/*
 * XREFs of MiAllocateEnclaveVad @ 0x1407E6EB0
 * Callers:
...
__int64 __fastcall MiAllocateEnclaveVad(int a1, unsigned __int64 a2, unsigned __int64 a3, __int64 a4, __int64 *a5)
{
  ...
  {
    *(_DWORD *)(Pool + 64) |= 1u;
    v17 = MiReservePtes((__int64)&qword_140E37328, 1u);
    *(_QWORD *)(v15 + 80) = v17;
    if ( !v17
      || a1 == 2
      && (*(_DWORD *)(v15 + 72) |= 1u,
...
LABEL_25:
      if ( (*(_DWORD *)(v15 + 64) & 1) != 0 )
      {
        ...
        v22 = *(unsigned __int64 **)(v15 + 80);
        if ( v22 )
          MiReleasePtes((__int64)&qword_140E37328, v22, 1u);
      }
...
LABEL_24:
  ...
  {
    inserted = MiSelectUserAddress(0, 0, UserReservationHighestAddress, a2, v11, 0LL, 6, 0, (__int64)v28, (__int64)&v29);
    if ( inserted < 0 )
      goto LABEL_24;
    v5 = v29;
    v24 = v29 + a2 - 1;
