/*
 * XREFs of CmpTransWriteLog @ 0x1408667CC
 * Callers:
...
__int64 __fastcall CmpTransWriteLog(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4, PCLFS_LSN plsnFinish)
{
  ...
  for ( i = a4; ; i = v25 )
  {
    ...
    if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 1LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_1400543EE,
        0LL,
        0LL,
        v19 + 3,
        v27);
    ...
    && v23 >= 0x50 )
  {
    ...
    if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 1LL) )
    {
      ...
      v29 = 4;
      v32 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09E08, (unsigned __int8 *)byte_1400543BB, 0LL, 0LL, 4u, v27);
    }
  }
