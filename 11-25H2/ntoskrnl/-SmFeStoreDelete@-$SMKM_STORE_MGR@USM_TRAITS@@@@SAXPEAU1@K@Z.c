/*
 * XREFs of ?SmFeStoreDelete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@K@Z @ 0x1403D3F50
 * Callers:
  ...
  while ( v6 )
  {
    ...
    *((_QWORD *)&v12 + 1) = v7;
    ...
    if ( *(unsigned __int16 *)(v9 + 4) != a2 )
      goto LABEL_2;
    *(_BYTE *)(v9 + 6) = 0;
    SMKM_STORE_MGR<SM_TRAITS>::SmFeDeleteEntry(a1, v13, &v12);
LABEL_9:
  ...
  StLockReleaseExclusive(a1 + 440, v7);
}
