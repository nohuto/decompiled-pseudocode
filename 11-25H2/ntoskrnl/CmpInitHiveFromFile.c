/*
 * XREFs of CmpInitHiveFromFile @ 0x14090E4F0
 * Callers:
        ...
        void *a10)
{
  ...
  ULONG_PTR v28; // [rsp+78h] [rbp-88h] BYREF
  ...
  *(_OWORD *)Handle = 0LL;
  *(_OWORD *)v36 = 0LL;
  if ( (unsigned int)dword_140E09E08 > 4 && (qword_140E09E18 & 8) != 0 && (qword_140E09E20 & 8) == qword_140E09E20 )
  {
    v14 = *((_QWORD *)a1 + 1);
    v15 = *a1;
    v50 = 0;
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EtwWriteTransfer(qword_140E09E28, &EventDescriptor, 0LL, 0LL, 4u, &UserData);
    a2 = v29;
    v12 = v33;
    a4 = v32;
  }
...
LABEL_10:
  ...
  if ( (unsigned int)dword_140E09E08 > 4 && (qword_140E09E18 & 8) != 0 && (qword_140E09E20 & 8) == qword_140E09E20 )
  {
    ...
    *(_DWORD *)&v34.Id = 184549376;
    ...
    EtwWriteTransfer(qword_140E09E28, &v34, 0LL, 0LL, 3u, &UserData);
  }
  return v19;
}
