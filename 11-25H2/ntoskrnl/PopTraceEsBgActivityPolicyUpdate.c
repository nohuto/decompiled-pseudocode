/*
 * XREFs of PopTraceEsBgActivityPolicyUpdate @ 0x14074C4F8
 * Callers:
...
void __fastcall PopTraceEsBgActivityPolicyUpdate(int a1)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v12 = 4;
    v15 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_140049253, 0LL, 0LL, 4u, &v10);
  }
