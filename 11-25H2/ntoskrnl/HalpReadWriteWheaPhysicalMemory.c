/*
 * XREFs of HalpReadWriteWheaPhysicalMemory @ 0x140560980
 * Callers:
 *     HalpReadWheaPhysicalMemory @ 0x140560960 (HalpReadWheaPhysicalMemory.c)
 *     HalpWriteWheaPhysicalMemory @ 0x140560B10 (HalpWriteWheaPhysicalMemory.c)
 * Callees:
