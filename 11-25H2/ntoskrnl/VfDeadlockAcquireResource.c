/*
 * XREFs of VfDeadlockAcquireResource @ 0x140B983E4
 * Callers:
 *     ViDeadlockExAcquireFastMutexUnsafe_Exit @ 0x140B893F0 (ViDeadlockExAcquireFastMutexUnsafe_Exit.c)
 *     ViDeadlockExAcquireFastMutex_Exit @ 0x140B89430 (ViDeadlockExAcquireFastMutex_Exit.c)
 *     ViDeadlockExAcquireSharedStarveExclusive_Exit @ 0x140B89470 (ViDeadlockExAcquireSharedStarveExclusive_Exit.c)
 *     ViDeadlockExEnterCriticalRegionAndAcquireResourceExclusive_Exit @ 0x140B894B0 (ViDeadlockExEnterCriticalRegionAndAcquireResourceExclusive_Exit.c)
 *     ViDeadlockExTryToAcquireFastMutex_Exit @ 0x140B89550 (ViDeadlockExTryToAcquireFastMutex_Exit.c)
 *     ViDeadlockKeAcquireInStackQueuedSpinLockRaiseToSynch_Exit @ 0x140B896F0 (ViDeadlockKeAcquireInStackQueuedSpinLockRaiseToSynch_Exit.c)
 *     ViDeadlockKeInitializeMutant_Exit @ 0x140B89730 (ViDeadlockKeInitializeMutant_Exit.c)
 *     ViDeadlockKeTryToAcquireSpinLockAtDpcLevel_Exit @ 0x140B89870 (ViDeadlockKeTryToAcquireSpinLockAtDpcLevel_Exit.c)
 *     ViDeadlockObjectAcquired @ 0x140B89B04 (ViDeadlockObjectAcquired.c)
 *     ViDeadlockKeAcquireSpinLockRaiseToDpc_Exit @ 0x140B983B0 (ViDeadlockKeAcquireSpinLockRaiseToDpc_Exit.c)
 * Callees:
 ...
 *     ViDeadlockAddThread @ 0x140B88AE8 (ViDeadlockAddThread.c)
 ...
 *     ViDeadlockSearchResource @ 0x140B8A100 (ViDeadlockSearchResource.c)
 *     ViDeadlockSearchThread @ 0x140B8A1DC (ViDeadlockSearchThread.c)
 *     ViDeadlockSimilarNode @ 0x140B8A278 (ViDeadlockSimilarNode.c)
 *     ViDeadlockUpdateChildrenCount @ 0x140B8A2C4 (ViDeadlockUpdateChildrenCount.c)
      ...
      if ( (_DWORD)v18 != (_DWORD)v6 )
      {
          ...
          && ((_DWORD)v18 != 7 || (unsigned int)(v6 - 5) > 1) )
        {
          ViDeadlockPreprocessOptions(
            ...
            v18,
            v6);
          VfReportIssueWithOptions(0xC4u, 0x1008uLL, (ULONG_PTR)a1, *(int *)v17, v6, byte_140E0E7A4);
LABEL_36:
          v15 = v41;
          v16 = 0;
          goto LABEL_77;
      ...
      if ( v19 )
      {
        if ( v21 > 1u )
        {
          ...
          ViDeadlockPreprocessOptions(
            ...
            (__int64)v17,
            (__int64)v9);
          VfReportIssueWithOptions(0xC4u, 0x1000uLL, (ULONG_PTR)a1, (ULONG_PTR)v17, (ULONG_PTR)v9, &dword_140E0E7B4);
          goto LABEL_36;
        }
        v22 = a4;
        v23 = v19 + 8;
