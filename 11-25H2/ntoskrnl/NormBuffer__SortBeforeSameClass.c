/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x1405E3904
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x1405E3308 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x1405E33AC (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x140777AD0 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x140777AE8 (Normalization__TableLookup.c)
 */
