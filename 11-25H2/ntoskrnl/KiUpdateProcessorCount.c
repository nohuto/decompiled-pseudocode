/*
 * XREFs of KiUpdateProcessorCount @ 0x140B458D8
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x140B47800 (KiUpdateNumberProcessorsIpi.c)
 ...
 *     KiGetCurrentGroupCount @ 0x1405B78D0 (KiGetCurrentGroupCount.c)
 */
