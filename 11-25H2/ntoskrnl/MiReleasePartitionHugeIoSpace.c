/*
 * XREFs of MiReleasePartitionHugeIoSpace @ 0x140665D54
 * Callers:
...
__int64 __fastcall MiReleasePartitionHugeIoSpace(ULONG_PTR BugCheckParameter2)
{
  ...
  do
  {
    ...
    v4 = ExAcquireSpinLockShared(&dword_140E2FC90);
    v5 = (_QWORD *)qword_140E2FCE0;
    v6 = v4;
    i = 0LL;
    while ( v5 )
    {
    ...
    while ( i )
    {
      ...
      if ( ((*(_QWORD *)(qword_140E2FD80 + 8LL * (v9[3] & 0x3FFFFF)) >> 4) & 0x7FFLL) == *(_WORD *)BugCheckParameter2 )
      {
        MiReleaseSpinLockShared(&dword_140E2FC90, v6);
        MiMoveBadHugeRangeCrossPartition(v9[3], (_WORD *)BugCheckParameter2, v2);
        v6 = ExAcquireSpinLockShared(&dword_140E2FC90);
        i = 0LL;
        for ( j = (_QWORD *)qword_140E2FCE0; j; j = (_QWORD *)*j )
          i = j;
      }
    }
    v13 = *(_QWORD *)(BugCheckParameter2 + 16664);
    result = MiReleaseSpinLockShared(&dword_140E2FC90, v6);
  }
  while ( v13 );
