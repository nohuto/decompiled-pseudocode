/*
 * XREFs of FsRtlpRemoveAndCompleteReadOnlyIrp @ 0x1404A9C7C
 * Callers:
...
void __fastcall FsRtlpRemoveAndCompleteReadOnlyIrp(_QWORD *a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_140E06C30 > 5 )
  {
    ...
    v17 = a3;
    v28 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06C30, (unsigned __int8 *)&byte_140043CDF, 0LL, 0LL, 6u, v20);
  }
  v9 = (IRP *)(a1 - 21);
  v10 = a1[2];
  ...
  *(_QWORD *)(v11 + 8) = v12;
  ...
  if ( (unsigned int)dword_140E06C30 > 5 )
  {
    ...
    v24 = 8LL;
    v26 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06C30, (unsigned __int8 *)byte_140043C7B, 0LL, 0LL, 5u, v20);
  }
}
