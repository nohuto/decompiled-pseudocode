/*
 * XREFs of UcpLogUnexpectedCodePathEvent @ 0x1406896E0
 * Callers:
...
void UcpLogUnexpectedCodePathEvent()
{
  ...
  if ( (unsigned int)dword_140E09F40 > 4 && tlgKeywordOn((__int64)&dword_140E09F40, 0x400000000000LL) )
  {
    ...
    v18 = &v7;
    v19 = v2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09F40, (unsigned __int8 *)word_14005763A, 0LL, 0LL, 7u, &v9);
  }
}
