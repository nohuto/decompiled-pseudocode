/*
 * XREFs of CmpSortedValueEnumStackAdvanceInternal @ 0x140977850
 * Callers:
 *     CmpSortedValueEnumStackAdvance @ 0x140977820 (CmpSortedValueEnumStackAdvance.c)
 * Callees:
...
__int64 __fastcall CmpSortedValueEnumStackAdvanceInternal(__int16 *a1)
{
  ...
  if ( *((_BYTE *)a1 + 10) )
  {
    ...
    for ( i = 0; i <= a1[4]; ++i )
    {
      EntryAtLayerHeight = CmpValueEnumStackGetEntryAtLayerHeight((__int64)a1, i);
  ...
  for ( j = 0LL; v5 >= 0; --v5 )
  {
    v7 = CmpValueEnumStackGetEntryAtLayerHeight((__int64)a1, v5);
