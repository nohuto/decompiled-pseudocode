/*
 * XREFs of PopDirectedDripsDiagRundownDevices @ 0x140A66D78
 * Callers:
 ...
 *     PopDirectedDripsDiagExtractDeviceDescription @ 0x140754898 (PopDirectedDripsDiagExtractDeviceDescription.c)
...
void PopDirectedDripsDiagRundownDevices()
{
  ...
  {
    v0 = qword_140F06070;
    if ( qword_140F06070 == &qword_140F06070 )
      break;
    if ( *((PVOID **)qword_140F06070 + 1) != &qword_140F06070
      || (v1 = *(_QWORD *)qword_140F06070, *(PVOID *)(*(_QWORD *)qword_140F06070 + 8LL) != qword_140F06070) )
    {
      __fastfail(3u);
    }
    qword_140F06070 = *(PVOID *)qword_140F06070;
    *(_QWORD *)(v1 + 8) = &qword_140F06070;
    v2 = 0;
    v36 = 0;
    v3 = 0;
    v4 = v0[39];
    ...
    if ( (*v6 & 0x40000) != 0 )
    {
      PopDirectedDripsDiagExtractDeviceDescription((UNICODE_STRING *)v0, &v49, &v52, &v47, &v48, &v50, &v51);
      PopDirectedDripsDiagSanitizeHardwareId(v0 + 16);
      v7 = v47;
      v8 = v48;
      v9 = v49;
      if ( (unsigned int)dword_140FD7920 > 5 && tlgKeywordOn((__int64)&dword_140FD7920, 0x400000000000LL) )
      {
        LOBYTE(v37) = v35[0];
        v57 = &v37;
        v58 = 1LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_14004D215,
          0LL,
          0LL,
          0x16u,
          &v56);
      ...
      if ( PopDiagHandleRegistered && EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_DEVICE_STATS) )
      {
        ...
        *(_QWORD *)&PopDirectedDripsDiagEventData.Size = 1LL;
        qword_140F062B0 = (__int64)(v0 + 4);
        qword_140F062B8 = 8LL;
        v38 = v9->Length >> 1;
        qword_140F062C0 = (__int64)&v38;
        qword_140F062C8 = 4LL;
        v18 = v9->Length;
        qword_140F062D0 = (__int64)v9->Buffer;
        dword_140F062D8 = v18;
        dword_140F062DC = 0;
        v39 = v52->Length >> 1;
        qword_140F062E0 = (__int64)&v39;
        qword_140F062E8 = 4LL;
        v19 = v52->Length;
        qword_140F062F0 = (__int64)v52->Buffer;
        dword_140F062F8 = v19;
        dword_140F062FC = 0;
        v40 = v7->Length >> 1;
        qword_140F06300 = (__int64)&v40;
        qword_140F06308 = 4LL;
        v20 = v7->Length;
        qword_140F06310 = (__int64)v7->Buffer;
        dword_140F06318 = v20;
        dword_140F0631C = 0;
        v41 = v8->Length >> 1;
        qword_140F06320 = (__int64)&v41;
        qword_140F06328 = 4LL;
        v21 = v8->Length;
        qword_140F06330 = (__int64)v8->Buffer;
        dword_140F06338 = v21;
        qword_140F06340 = (__int64)(v0 + 37);
        dword_140F0633C = 0;
        qword_140F06348 = 4LL;
        qword_140F06350 = (__int64)(v0 + 39);
        qword_140F06358 = 4LL;
        qword_140F06360 = (__int64)(v0 + 40);
        qword_140F06368 = 4LL;
        qword_140F06370 = (__int64)(v0 + 38);
        qword_140F06378 = 4LL;
    ...
    if ( PopDiagSleepStudyHandleRegistered && v2 )
    {
      ...
      do
      {
        ...
        *(&PopDirectedDripsDiagEventData.Ptr + v26) = (ULONGLONG)(v0 + 8);
