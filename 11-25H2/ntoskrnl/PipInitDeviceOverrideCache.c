/*
 * XREFs of PipInitDeviceOverrideCache @ 0x140C0FF48
 * Callers:
...
LABEL_2:
      ...
      for ( i = 0; i < 3; ++i )
      {
        if ( HIDWORD(KeyInformation_8[2]) < 3 * *((_DWORD *)qword_1400271A0 + i) )
        {
          PnpDeviceOverrideHashListSize = *((_DWORD *)qword_1400271A0 + i);
          break;
        }
      }
