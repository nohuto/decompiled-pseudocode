/*
 * XREFs of sub_140ABEAF8 @ 0x140ABEAF8
 * Callers:
...
__int64 __fastcall sub_140ABEAF8(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // r8d
  unsigned int *v8; // rdx
  unsigned int *v9; // rax
  ...
  v7 = guard_dispatch_icall_no_overrides(v19);
  if ( (v7 & 0x80000000) == 0 )
  {
    v27 = *(_DWORD *)(a2 + 32);
