/*
 * XREFs of VfBuildScatterGatherListEx @ 0x140B75DD0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( AdapterInformationInternal )
  {
    ...
    if ( v11 )
    {
      ...
      ViHalPreprocessOptions(
        ...
        0LL,
        0LL);
      VfReportIssueWithOptions(0xE6u, 0x24uLL, v12, 0LL, 0LL, byte_140E0E6FC);
    }
  }
  v13 = guard_dispatch_icall_no_overrides(RealDmaAdapter);
  v14 = v13;
  if ( AdapterInformationInternal )
  {
    if ( v13 < 0 )
