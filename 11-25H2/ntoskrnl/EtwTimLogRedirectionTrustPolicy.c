/*
 * XREFs of EtwTimLogRedirectionTrustPolicy @ 0x140A9CEE8
 * Callers:
...
LABEL_33:
      ...
      *(&UserData.Ptr + v48) = (ULONGLONG)&v75;
      ...
      if ( v7 )
      {
        if ( (unsigned int)dword_140E09048 > 5 && tlgKeywordOn((__int64)&dword_140E09048, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14005219D,
            0LL,
            0LL,
            0x18u,
            &v90);
      ...
      else if ( (unsigned int)dword_140E09048 > 5 && tlgKeywordOn((__int64)&dword_140E09048, 0x400000000000LL) )
      {
        v78 = 0x2000000LL;
        v136 = &v78;
        v73 = v159;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E09048,
          (unsigned __int8 *)byte_140052268,
          0LL,
          0LL,
          8u,
          &v135);
