/*
 * XREFs of RtlpHpVsContextMultiAlloc @ 0x14043C778
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  v18 = 0LL;
  if ( v10 )
    RtlpHpAcquireQueuedLockExclusive(v9 + 2, (unsigned __int8)a1[3], (__int64)&v17);
  v11 = 0LL;
  v12 = 0LL;
  for ( i = 0; i < a3; ++i )
  {
    v14 = RtlpHpVsSlotAllocate((_DWORD)a1, (_DWORD)v9, v6 + 1, (v6 + 1) << 16, (__int64)&v17);
    if ( !v14 )
      goto LABEL_11;
