/*
 * XREFs of UcpFindOrCreateTelemetryRecord @ 0x1406894A0
 * Callers:
...
__int64 __fastcall UcpFindOrCreateTelemetryRecord(__int64 a1)
{
  ...
  {
    if ( (unsigned int)dword_140E09F40 > 4 && tlgKeywordOn((__int64)&dword_140E09F40, 0x400000000000LL) )
    {
      v13 = 0;
      v11 = &v9;
      v9 = v4;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140E09F40,
        (unsigned __int8 *)byte_1400575DB,
        0LL,
        0LL,
        3u,
        &v10);
