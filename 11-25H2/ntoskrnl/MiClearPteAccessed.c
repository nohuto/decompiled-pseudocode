/*
 * XREFs of MiClearPteAccessed @ 0x1402493D0
 * Callers:
...
LABEL_7:
      ...
      if ( v42 )
      {
        v39 = ExAcquireSpinLockExclusive(&dword_140E37180);
        a2 = v44;
        v48 = v39;
      }
      goto LABEL_60;
...
LABEL_81:
    ...
    || (*(_DWORD *)(a1 + 184) & 0xF) != 0 && (unsigned __int16)*(_DWORD *)(a2 + 32) > 1u )
  {
    ...
    if ( v42 )
      MiReleaseSpinLockExclusive(&dword_140E37180, v48);
    if ( v13 )
      MiUnlockPageTable(a1, a3);
    return 0LL;
  }
LABEL_8:
  if ( !v9 )
