/*
 * XREFs of PpmEventTraceHeteroResponse @ 0x140409318
 * Callers:
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v39 = 1LL;
      v41 = 4LL;
      LOBYTE(v3) = EtwWriteEx(PpmEtwHandle, &PPM_ETW_HETERO_RESPONSE, 0LL, 0, 0LL, 0LL, 0xBu, &UserData);
    }
  }
  return (char)v3;
}
