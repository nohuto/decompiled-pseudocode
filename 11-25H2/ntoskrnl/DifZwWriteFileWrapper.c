/*
 * XREFs of DifZwWriteFileWrapper @ 0x14063DF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWriteFileWrapper(
        void *a1,
        void *a2,
        ...
        ULONG *Key)
{
  ...
  unsigned int v30; // [rsp+A8h] [rbp-1h]
...
LABEL_17:
  v30 = ZwWriteFile(a1, a2, a3, a4, IoStatusBlock, Buffer, Length, ByteOffset, Key);
  if ( v13 )
  {
