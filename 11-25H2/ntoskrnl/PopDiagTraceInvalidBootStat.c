/*
 * XREFs of PopDiagTraceInvalidBootStat @ 0x140C1ED78
 * Callers:
...
void __fastcall PopDiagTraceInvalidBootStat(int a1)
{
    ...
    && tlgKeywordOn((__int64)&dword_140E07680, v2) )
  {
    ...
    v11 = 0x1000000LL;
    v26 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_14004A2B0, 0LL, 0LL, 7u, &v12);
  }
}
