/*
 * XREFs of WheapPfaMemoryCheck @ 0x1407B9A54
 * Callers:
...
void __fastcall WheapPfaMemoryCheck(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  ...
  v18 = a1;
  if ( !*(_BYTE *)off_140E09498 && (*(_BYTE *)a2 & 2) != 0 )
  {
    v4 = *(_QWORD *)(a2 + 16);
    v18 = v4;
...
LABEL_23:
        ...
        if ( v11 >= *(_DWORD *)off_140E094B8 )
        {
          Pool2 = (PVOID *)qword_140EEF530;
          v14 = *(_QWORD *)qword_140EEF530;
          if ( *(_QWORD *)(*(_QWORD *)qword_140EEF530 + 8LL) != qword_140EEF530 )
            goto LABEL_23;
          v15 = *(_QWORD **)(qword_140EEF530 + 8);
          if ( *v15 != qword_140EEF530 )
            goto LABEL_23;
          *v15 = v14;
          *(_QWORD *)(v14 + 8) = v15;
