/*
 * XREFs of PpmEnterCoordinatedIdle @ 0x1404AF304
 * Callers:
...
unsigned int __fastcall PpmEnterCoordinatedIdle(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  if ( a3 != -1 )
  {
    ...
    if ( !qword_140E27B40 && a3 == dword_140E27B80 )
      _InterlockedCompareExchange64(&qword_140E27B40, MEMORY[0xFFFFF78000000008], 0LL);
    a1 = a5;
    if ( a5 )
    {
