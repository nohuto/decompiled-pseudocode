/*
 * XREFs of MiSetProbePagesAhead @ 0x1402AE4D0
 * Callers:
...
char __fastcall MiSetProbePagesAhead(__int64 a1)
{
  ...
  if ( (_BYTE)PageTablePfnBuddyRaw == 1 )
  {
    ...
    if ( PageTablePfnBuddyRaw > (unsigned __int64)qword_140E2D9A0 )
    {
      v6 = 0;
    }
    else
    ...
    if ( v7 != 3 )
    {
      ...
      for ( i = 0LL; ; ++i )
      {
        ...
        if ( v13 <= qword_140E2D9A0
          && (v14 = 48 * v13, PageTablePfnBuddyRaw = *(_QWORD *)(v14 + v5), (PageTablePfnBuddyRaw & v4) != 0) )
        {
          if ( !v6 )
            goto LABEL_18;
          v24 = v14 - 0x220000000000LL;
          PageTablePfnBuddyRaw = qword_140E37278;
          if ( qword_140E37278 && ((*(_QWORD *)(v24 + 40) >> 60) & 7) == 1 )
          {
          ...
          if ( PageTablePfnBuddyRaw >= 0 )
          {
            ...
            {
              v19 = (__int64)(*(_QWORD *)(v24 + 8) << 25) >> 16;
...
LABEL_18:
      ...
      if ( i )
      {
        v17 = (__int64)((*(_QWORD *)(a1 + 24) << 25) - (v11 << 25)) >> 16;
        *(_QWORD *)(a1 + 152) = v17;
        *(_QWORD *)(a1 + 168) = -1LL;
