/*
 * XREFs of EtwTraceReadyThread @ 0x140288F70
 * Callers:
...
int __fastcall EtwTraceReadyThread(__int64 a1, char a2, char a3, char a4)
{
  ...
  {
    v11 &= v11 - 1;
    ServerSiloGlobals = EtwpHostSiloState + 32 * v13 + 4284;
  ...
  if ( v10 )
  {
    ...
    if ( v14 )
    {
      ...
      {
        v15 &= v15 - 1;
        ServerSiloGlobals = v14 + 32 * v16 + 4284;
        if ( ServerSiloGlobals && (*(_DWORD *)(ServerSiloGlobals + 4) & 0x200) != 0 )
          LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                         (struct _KTHREAD *)v23,
                                         v14,
                                         *(unsigned __int8 *)(v14 + 2 * v16 + 4232),
                                         1u,
                                         0x532u,
                                         v5);
      }
