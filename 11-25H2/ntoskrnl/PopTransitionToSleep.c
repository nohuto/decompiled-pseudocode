/*
 * XREFs of PopTransitionToSleep @ 0x140B55320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopEnlargeHiberFile @ 0x140746360 (PopEnlargeHiberFile.c)
...
LONG __fastcall PopTransitionToSleep(struct _KEVENT *a1)
{
  ...
  v12 = 0LL;
  v13 = 0LL;
  qword_140F0AE40 = (__int64)KeGetCurrentThread();
  if ( Lock == 3 || Lock == 6 )
  {
    ...
    *(_QWORD *)&v13 = PopMirrorPhysicalMemory;
    ...
    else if ( (dword_140F0AE6C & 0x20) != 0 && PopEnableMinimalHiberFile || PopForceMinimalHiberFile )
    {
      MmEmptyAllWorkingSets();
      v9 = 1;
      v11 = v14 | 4;
...
LABEL_4:
  v4 = v3;
LABEL_5:
  qword_140F0B1E8 = *(_QWORD *)&KeQueryPerformanceCounter(0LL) - qword_140F06530;
