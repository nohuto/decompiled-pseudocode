/*
 * XREFs of PopDirectedDripsDiagNotifySessionStop @ 0x140A66A3C
 * Callers:
...
__int64 __fastcall PopDirectedDripsDiagNotifySessionStop(__int64 a1, int a2, int a3)
{
  ...
  if ( (result & 1) != 0 )
  {
    ...
    if ( v11 )
      *((_BYTE *)v11 + 10) = 1;
    if ( (unsigned int)dword_140FD7920 > 5 && PopDirectedDripsDiagTraceHandleRegistered )
    {
      if ( (qword_140FD7930 & 0x400000000000LL) == 0 || (qword_140FD7938 & 0x400000000000LL) != qword_140FD7938 )
        v8 = 0;
      if ( v8 )
      {
        v22 = 0;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&word_14004CFC6,
          0LL,
          0LL,
          0xAu,
          &v19);
