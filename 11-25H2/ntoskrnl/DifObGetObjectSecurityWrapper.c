/*
 * XREFs of DifObGetObjectSecurityWrapper @ 0x140629EF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PBOOLEAN MemoryAllocated)
{
  ...
  LODWORD(v17) = ObGetObjectSecurity(Object, SecurityDescriptor, MemoryAllocated);
  if ( v7 )
  {
