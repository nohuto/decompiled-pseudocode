/*
 * XREFs of MiReadImageHeaders @ 0x1409413C0
 * Callers:
 *     MiCreateImageFileMap @ 0x14093F578 (MiCreateImageFileMap.c)
 * Callees:
 *     KeWaitForSingleObject @ 0x14029C6A0 (KeWaitForSingleObject.c)
 *     MiPageRead @ 0x14035C4D4 (MiPageRead.c)
 *     MiIsRetryIoStatus @ 0x1403BF170 (MiIsRetryIoStatus.c)
 *     KeInitializeEvent @ 0x140401B80 (KeInitializeEvent.c)
 *     memmove @ 0x1406B4940 (memmove.c)
 *     memset_0 @ 0x1406B4D40 (memset_0.c)
 *     MiCopyFromDirectMapExtent @ 0x1407E01F4 (MiCopyFromDirectMapExtent.c)
 */

__int64 __fastcall MiReadImageHeaders(struct _FILE_OBJECT *a1, char *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r10
  ...
  *(_QWORD *)(a4 + 8) = 0LL;
  ...
  if ( a2 )
  {
    v11 = MiCopyFromDirectMapExtent(a2, a3, (ULONG_PTR *)&v24, a4);
  }
  else
  {
  ...
  else
  {
    v12 = *(_QWORD *)(a4 + 8);
    if ( v12 != v8 << 12 )
      memset_0((void *)(*(_QWORD *)(a3 + 24) + v12), 0, (v8 << 12) - v12);
