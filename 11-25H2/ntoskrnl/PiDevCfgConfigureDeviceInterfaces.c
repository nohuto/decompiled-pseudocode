/*
 * XREFs of PiDevCfgConfigureDeviceInterfaces @ 0x140A75EEC
 * Callers:
...
__int64 __fastcall PiDevCfgConfigureDeviceInterfaces(__int64 a1, void *a2, __int64 a3)
{
  ...
  UNICODE_STRING *v28; // [rsp+90h] [rbp-70h] BYREF
  const wchar_t *v29; // [rsp+98h] [rbp-68h] BYREF
...
LABEL_22:
      ...
      *(_QWORD *)&ObjectAttributes.Attributes = 576LL;
        ...
        && PiDevCfgParseVariableName(DestinationString.Buffer, (UNICODE_STRING *)&v35, &v28) )
      {
        ...
        if ( v18 >= 0 )
        {
          v19 = *(_DWORD *)&v28[2].Length;
          if ( (unsigned int)(v19 - 1) <= 1 )
          {
            Buffer = v28[2].Buffer;
            MaximumLength = *(&v28[2].MaximumLength + 1);
            ...
            if ( v12 )
            {
              if ( *v12 )
              {
                while ( 1 )
                {
                  ...
                  v20 = PiDevCfgParseInterfaceKeyName((__int64)&v27, &Guid, (__int64 *)&v29);
                  v5 = v29;
                  if ( v20 )
                  {
                    MatchingFilteredDeviceInterfaceList = IopRegisterDeviceInterface(v31, (int *)&Guid, v29, 1, &P, 0LL);
                    if ( MatchingFilteredDeviceInterfaceList < 0 )
                      break;
...
LABEL_18:
      ...
      else
      {
        ...
        if ( v16 >= 0 )
        {
          ...
          if ( v17 == 35 )
          {
            v5 = (const wchar_t *)((unsigned __int64)(Buffer + 39) & -(__int64)(Buffer[39] != 0));
            v29 = v5;
          }
          else if ( v17 )
          {
      ...
      if ( v16 >= 0 )
      {
        MatchingFilteredDeviceInterfaceList = IopRegisterDeviceInterface(v31, (int *)&Guid, v5, 1, &P, 0LL);
        if ( MatchingFilteredDeviceInterfaceList < 0 )
          goto LABEL_29;
        MatchingFilteredDeviceInterfaceList = PiDevCfgConfigureDeviceInterface((__int64)P, Handle, a3);
        ExFreePoolWithTag(P, 0);
