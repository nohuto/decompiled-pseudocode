/*
 * XREFs of PspReadUserQuotaLimits @ 0x140A311BC
 * Callers:
  ...
  *a2 = 1;
  ...
  if ( !PspQuotaDatabaseKey )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    v3 = (HANDLE)_InterlockedCompareExchange64(&PspQuotaDatabaseKey, v11, 0LL);
    if ( v3 )
    {
      if ( Handle != (HANDLE)1 )
        ZwClose(Handle);
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v7 >= 0 )
    {
      ...
      while ( v4 < 4 )
      {
        ...
        {
          v12 = *(unsigned int *)((char *)v10 + (char *)PspDefaultResourceLimits - (char *)a3);
          ++v9;
        }
        else
        {
