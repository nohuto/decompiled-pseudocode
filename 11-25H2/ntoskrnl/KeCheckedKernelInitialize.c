/*
 * XREFs of KeCheckedKernelInitialize @ 0x140BCE44C
 * Callers:
 ...
 *     sub_140BF7E1C @ 0x140BF7E1C (sub_140BF7E1C.c)
  ...
  if ( result >= 0 && !*(_QWORD *)&MaxDataSize )
  {
    ...
    if ( result )
    {
      ...
      if ( result )
      {
        ...
        v9 = v5;
        v10 = 0;
        result = KeExpandKernelStackAndCallout(sub_140BF7680, Parameter, 0xC000uLL);
        if ( v6 >= 0 )
