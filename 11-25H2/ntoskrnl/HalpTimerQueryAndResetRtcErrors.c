/*
 * XREFs of HalpTimerQueryAndResetRtcErrors @ 0x1404D02F0
 * Callers:
...
__int64 __fastcall HalpTimerQueryAndResetRtcErrors(char a1, char a2)
{
  ...
  if ( a2 )
  {
    if ( (unsigned int)dword_140E03B08 <= 5 || !tlgKeywordOn((__int64)&dword_140E03B08, 0x200000000000LL) )
      goto LABEL_14;
    v4 = (unsigned __int8 *)byte_14004285D;
LABEL_13:
    v12 = &v10;
    v10 = v2;
    v13 = 4LL;
...
LABEL_14:
  ...
  if ( !a1 )
  {
    if ( (unsigned int)dword_140E03B08 <= 5 || !tlgKeywordOn((__int64)&dword_140E03B08, 0x400000000000LL) )
      goto LABEL_14;
    v4 = (unsigned __int8 *)&word_140042822;
    goto LABEL_13;
  }
  if ( (unsigned int)dword_140E03B08 > 5 && tlgKeywordOn((__int64)&dword_140E03B08, 0x400000000000LL) )
  {
    ...
    v12 = &v10;
    v13 = 4LL;
    tlgWriteEx_EtwWriteEx((__int64)&dword_140E03B08, (unsigned __int8 *)&byte_1400427E8, v5, 1u, v8, v9, 3u, v11);
  }
  v6 = 9;
  return v2 & (unsigned int)v6;
}
