/*
 * XREFs of MiValidateControlAreaPartition @ 0x14044C964
 * Callers:
...
__int64 __fastcall MiValidateControlAreaPartition(__int64 a1, __int64 a2)
{
  ...
  v2 = (ULONG *)*((_QWORD *)qword_140E2FD48 + (*(_WORD *)(a2 + 60) & 0x3FF));
  v3 = *(ULONG ***)(a1 + 176);
  if ( !v3 )
  {
    if ( (*(_BYTE *)(a2 + 62) & 1) != 0 )
    {
      if ( v2 == *((ULONG **)qword_140E2FD48 + HIWORD(KeGetCurrentThread()->ApcState.Process[2].ProcessListEntry.Blink)) )
        return 0LL;
      if ( (*(_DWORD *)a1 & 1) == 0 )
      {
