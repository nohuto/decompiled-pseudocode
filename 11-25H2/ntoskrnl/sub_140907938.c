/*
 * XREFs of sub_140907938 @ 0x140907938
 * Callers:
...
__int64 __fastcall sub_140907938(__int64 a1, __int64 a2)
{
  int v3; // eax
  int v4; // r9d
  __int64 v5; // rbx
...
LABEL_11:
  if ( v5 )
  {
    ...
    {
      v19 = (void **)v22;
      if ( (int)sub_140907700(a1, v22, -1) >= 0 )
      {
        SddlpFree(v19[3]);
        SddlpFree(v19);
      }
