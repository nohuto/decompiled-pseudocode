/*
 * XREFs of RtlpHpMetadataFree @ 0x1403CB6C4
 * Callers:
...
__int64 __fastcall RtlpHpMetadataFree(ULONG_PTR a1, _QWORD *a2)
{
  ...
  v16 = 0;
  v5 = qword_140E6B8D8[2 * (unsigned int)dword_14001E630[v3]];
  if ( (_WORD)a1 )
  {
    v7 = 0;
  }
  ...
  {
    v6 = RtlCSparseBitmapBitmaskRead((__int64)&dword_140E68050, 2 * ((a1 - qword_140E68048) >> 20));
  ...
  if ( (RtlpHpHeapGlobals ^ *(_QWORD *)(v10 + 0x10) ^ v10) == v9 )
  {
    ...
    {
      RtlpHpSegFreeInternal(v9, a1, v13, &v16);
      v2 = v16;
    }
  }
  else
