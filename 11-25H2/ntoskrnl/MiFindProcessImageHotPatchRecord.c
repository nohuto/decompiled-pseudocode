/*
 * XREFs of MiFindProcessImageHotPatchRecord @ 0x140A1DD10
 * Callers:
...
__int64 __fastcall MiFindProcessImageHotPatchRecord(__int64 a1, int a2, int a3, int a4, PUNICODE_STRING StringOut)
{
  ...
  _BYTE v26[80]; // [rsp+90h] [rbp-88h] BYREF
  ...
  if ( !a4 )
  {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140E37250, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140E37250, 0, v11, (unsigned __int64)&qword_140E37250);
    if ( v11 )
      *((_BYTE *)v11 + 10) = 1;
  }
