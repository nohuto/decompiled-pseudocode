/*
 * XREFs of KiMcheckFastForward @ 0x1405C5A30
 * Callers:
...
char __fastcall KiMcheckFastForward(ULONG_PTR BugCheckParameter4, char a2)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter4 + 368) & 1) == 0 )
  {
    ...
    {
      v4 |= 2u;
      _InterlockedAdd(&dword_140F0F1A4, 1u);
    }
    ...
    {
      v4 |= 4u;
      _InterlockedAdd(&dword_140F0F1A8, 1u);
    }
    ...
    if ( KiKvaShadow )
    {
      ...
      {
        v4 |= 4u;
        _InterlockedAdd(&dword_140F0F1AC, 1u);
      }
      if ( KiKvaShadow
  ...
  if ( a2 || (v4 & 1) != 0 )
  {
    _InterlockedAdd(&dword_140F0F1B8, 1u);
    if ( (v4 & 1) != 0 )
      _InterlockedAdd(&dword_140F0F1C0, 1u);
    v9 = 1;
  }
  else
  {
    _InterlockedAdd(&dword_140F0F1BC, 1u);
    v9 = 0;
  }
  if ( KiKvaShadow )
  {
...
LABEL_36:
  ...
  if ( (v4 & 4) != 0 )
  {
    _InterlockedAdd(&dword_140F0F1C4, 1u);
    ...
    if ( KiKvaShadow )
    {
      ...
      *(_QWORD *)(v11 + 24) = McheckContext->Cr3;
      ...
      {
        _InterlockedAdd(&dword_140F0F1C8, 1u);
    ...
    *(_QWORD *)(BugCheckParameter4 + 64) = Rdx;
    _InterlockedAdd(&dword_140F0F1B4, 1u);
    McheckContext->MachineFrame.SegCs = 0;
  }
  if ( !a2 )
  {
    _InterlockedAdd(&dword_140F0F1B0, 1u);
