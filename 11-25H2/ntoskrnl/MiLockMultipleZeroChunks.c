/*
 * XREFs of MiLockMultipleZeroChunks @ 0x14020F970
 * Callers:
...
LABEL_15:
    ...
    {
      v14 = qword_140E2FD80 + 8 * ((v10 >> 12) & 0x3FFFFF);
      v3 = v19;
    }
    else
    {
    ...
    if ( *(_DWORD *)(a1 + 8) )
    {
      result = MiSafeTryLockNestedPageAtDpc(v13, v5);
      if ( !(_DWORD)result )
        return result;
      v16 = *(_QWORD *)(v11 + 24);
      if ( (v16 & 1) != 0 )
    ...
    else
    {
      ...
      {
        MiLockHugePfnInternal(v14);
        v16 = *(_QWORD *)(v11 + 24);
        if ( (v16 & 1) != 0 )
        {
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140E2FD88 + 4 * ((((v14 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << (((v14 - qword_140E2FD80) >> 3) & 0x1F)));
          result = MiReleaseSpinLockExclusive(v8 + 15224, *(unsigned __int8 *)(a1 + 1));
          goto LABEL_14;
        }
      }
