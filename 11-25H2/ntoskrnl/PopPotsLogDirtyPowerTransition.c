/*
 * XREFs of PopPotsLogDirtyPowerTransition @ 0x140C227FC
 * Callers:
...
void __fastcall PopPotsLogDirtyPowerTransition(int a1, unsigned int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( (unsigned int)dword_140E08220 > 5 && tlgKeywordOn((__int64)&dword_140E08220, 0x400000000000LL) )
      {
        v14 = 0;
        v17 = 0;
        v12 = &v7;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E08220,
          (unsigned __int8 *)byte_14004D93D,
          0LL,
          0LL,
          7u,
          &v11);
