/*
 * XREFs of DifZwSetSecurityObjectWrapper @ 0x14063CE20
 * Callers:
 *     <none>
 * Callees:
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = Handle;
    LODWORD(v16) = SecurityInformation;
    *((_QWORD *)&v15 + 1) = SecurityDescriptor;
  ...
  LODWORD(v17) = ZwSetSecurityObject(Handle, SecurityInformation, SecurityDescriptor);
  if ( v7 )
  {
