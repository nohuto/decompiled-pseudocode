/*
 * XREFs of PiDmObjectUpdateCachedObjectProperty @ 0x14096AA90
 * Callers:
...
LABEL_4:
        ...
        if ( (int)PiDmGetObject(a1, a2, &P) < 0 )
          return;
        v16 = (signed __int64 *)P;
        KsepCacheLock((unsigned __int64 *)P);
        v17 = 3LL * i;
        v18 = (unsigned int *)&v16[3 * i + 14];
        v19 = *v18;
        v30 = v18;
        if ( v19 > 1 )
        {
...
LABEL_27:
        KsepCacheLock((unsigned __int64 *)v16);
