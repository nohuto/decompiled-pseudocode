/*
 * XREFs of _RtlpMuiRegPopulateBaseLanguages @ 0x14081E0AC
 * Callers:
...
NTSTATUS __fastcall RtlpMuiRegPopulateBaseLanguages(__int64 a1, __int64 a2, _WORD *a3, __int64 a4)
{
  ...
  *(_DWORD *)(v4 + 40) = 0;
  *(_OWORD *)(v4 + 24) = 0LL;
  memset_0((void *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 64), 0, 0xAAuLL);
  memset_0((void *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 768), 0, 0xAAuLL);
  memset_0((void *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 944), 0, 0xAAuLL);
  *(_WORD *)v4 = 0;
  v8 = 0;
      ...
      *(_WORD *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x1A) = 170;
      if ( RtlLCIDToCultureName(v13, (PUNICODE_STRING)(v4 + 24)) )
      {
          ...
          && (int)RtlpMuiRegAddBaseLanguage((__int64 *)a1, a3, 0, v4 + 256, (wchar_t *)(v4 + 944)) >= 0 )
        {
          ...
          do
            ++v9;
          while ( *(_WORD *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x300 + 2 * v9) );
        }
      }
    }
  }
...
LABEL_42:
  ...
  v20 = *(unsigned int **)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
  if ( v20 )
    *v20 = v11;
  return 0;
}
