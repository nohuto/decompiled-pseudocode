/*
 * XREFs of KiSelectIdleProcessor @ 0x1403F74D0
 * Callers:
...
__int64 __fastcall KiSelectIdleProcessor(_WORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char *a6)
{
  ...
  if ( v24 )
  {
    ...
    v6 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + 64 * (_DWORD)v21 + (((_BYTE)v25 + v27) & 0x3Fu))];
LABEL_2:
    ...
    if ( v14 )
    {
      if ( (*(_BYTE *)(a4 + 184) & 1) == 0 )
        goto LABEL_6;
      if ( *a6 && (unsigned __int8)KiFindRankBiasedIdleSmtSet(a4, v32) )
      {
        v14 = v32[0];
LABEL_6:
        ...
        return KiProcessorBlock[*((unsigned int *)qword_140F216A8
