/*
 * XREFs of IopAttachDeviceToDeviceStackSafe @ 0x1402A1BDC
 * Callers:
 *     IoAttachDeviceToDeviceStackSafe @ 0x1402A1EB0 (IoAttachDeviceToDeviceStackSafe.c)
 *     IoAttachDeviceToDeviceStack @ 0x1402A1FB0 (IoAttachDeviceToDeviceStack.c)
 *     IoAttachDeviceByPointer @ 0x140593220 (IoAttachDeviceByPointer.c)
 * Callees:
 ...
 *     IovAttachDeviceToDeviceStack @ 0x140B72514 (IovAttachDeviceToDeviceStack.c)
 */
...
PDEVICE_OBJECT __fastcall IopAttachDeviceToDeviceStackSafe(__int64 a1, struct _DEVICE_OBJECT *a2, PDEVICE_OBJECT *a3)
{
  ...
  v9 = 0;
  DeviceAttachmentBase = (struct _DEVICE_OBJECT *)IopGetDeviceAttachmentBase(a2);
