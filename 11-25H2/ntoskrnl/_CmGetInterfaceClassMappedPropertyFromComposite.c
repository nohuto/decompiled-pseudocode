/*
 * XREFs of _CmGetInterfaceClassMappedPropertyFromComposite @ 0x14080F344
 * Callers:
 *     _CmGetInterfaceClassMappedPropertyKeys @ 0x14080F44C (_CmGetInterfaceClassMappedPropertyKeys.c)
