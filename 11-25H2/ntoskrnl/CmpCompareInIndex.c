/*
 * XREFs of CmpCompareInIndex @ 0x14087A510
 * Callers:
...
LABEL_55:
  ...
  while ( 1 )
  {
    ...
    if ( v22 >= 0x61 )
    {
      ...
      {
        v27 = PsGetCurrentServerSiloGlobals()[75].Flink;
        if ( v27 && (unsigned __int16)v26 >= 0xC0u )
          LOWORD(v26) = *((_WORD *)&v27->Flink
                        + (v26 & 0xF)
                        + *((unsigned __int16 *)&v27->Flink + LOWORD(v27->Flink) + (v26 >> 4)))
                      + v26;
