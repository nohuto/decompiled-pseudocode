/*
 * XREFs of RtlpIcDecodeModRmOperand @ 0x140BA739C
 * Callers:
...
__int64 __fastcall RtlpIcDecodeModRmOperand(__int64 a1, __int64 a2, __int64 *a3, _BYTE *a4, _BYTE *a5)
{
  ...
  *a5 = 0;
  ...
  else if ( (v7 & 7) == 4 )
  {
    ...
    {
      LOBYTE(a4) = *(_BYTE *)(v6 + 25) & 1;
      RegisterAddressByIndex = *(_QWORD *)RtlpIcGetRegisterAddressByIndex(v6, a2, v12 & 7, (_DWORD)a4, 0);
    }
    if ( (v12 & 0x38) != 0x20 || (*(_BYTE *)(v6 + 25) & 2) != 0 )
    {
      LOBYTE(a4) = (*(_BYTE *)(v6 + 25) & 2) != 0;
      v5 = *(_QWORD *)RtlpIcGetRegisterAddressByIndex(v6, v10, ((unsigned int)v12 >> 3) & 7, (_DWORD)a4, 0) << (v12 >> 6);
    }
  }
