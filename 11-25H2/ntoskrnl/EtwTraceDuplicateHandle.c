/*
 * XREFs of EtwTraceDuplicateHandle @ 0x140A422FC
 * Callers:
...
int __fastcall EtwTraceDuplicateHandle(__int64 a1, unsigned int a2, __int64 a3, int a4, int a5, __int64 a6)
{
  ...
  if ( !v13 )
  {
    ...
    {
      v12 &= v12 - 1;
      v8 = 32LL * (unsigned int)v14 + EtwpHostSiloState + 4284;
      if ( v8 )
      {
    ...
    if ( v7 )
    {
      ...
      *(_DWORD *)((char *)&v22 + 6) = a4;
      v25 = 26;
      LODWORD(v8) = EtwpTraceKernelEventWithFilter((struct _KTHREAD *)&v24, 1u, v7, 0x1122u, 0x10601903u);
    }
  }
  return v8;
}
