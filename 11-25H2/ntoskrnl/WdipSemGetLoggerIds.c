/*
 * XREFs of WdipSemGetLoggerIds @ 0x140A43EA4
 * Callers:
...
LABEL_5:
  ...
  ExReleaseRundownProtectionCacheAwareEx(
    *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(*((_QWORD *)v3 + 170) + 448LL) + 8 * v10),
    1u);
  v5 = v11;
  v4 = 0;
LABEL_6:
...
LABEL_9:
  ...
  if ( (_DWORD)v12 )
    v1 = *(_WORD *)v7;
  ExReleaseRundownProtectionCacheAwareEx(
    *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(*((_QWORD *)v7 + 170) + 448LL) + 8 * v12),
    1u);
  v8 = v1;
  v0 = 0;
LABEL_10:
