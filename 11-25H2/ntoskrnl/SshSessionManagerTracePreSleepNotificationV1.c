/*
 * XREFs of SshSessionManagerTracePreSleepNotificationV1 @ 0x1407575A4
 * Callers:
...
__int64 __fastcall SshSessionManagerTracePreSleepNotificationV1(
        int a1,
        int a2,
        int a3,
        int a4,
        ...
        char a8)
{
  ...
  v19 = 0;
  v21 = 1LL;
  return SshpSessionManagerSendControlEvent(SLEEPSTUDY_EVT_PRE_SLEEP_NOTIFICATION_CONTROL_EVENT, 12LL, v17);
}
