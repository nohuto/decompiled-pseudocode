/*
 * XREFs of _CmDeleteCommonClassRegKey @ 0x140807F8C
 * Callers:
 *     _CmDeleteInstallerClassRegKey @ 0x140808C44 (_CmDeleteInstallerClassRegKey.c)
 *     _CmDeleteInterfaceClassRegKey @ 0x140808FEC (_CmDeleteInterfaceClassRegKey.c)
 * Callees:
...
__int64 __fastcall CmDeleteCommonClassRegKey(__int64 a1, int a2, int a3)
{
  __int64 v6; // rdi
  int v7; // eax
  unsigned int v8; // eax
