/*
 * XREFs of HalDmaAllocateCrashDumpRegistersEx @ 0x14053B280
 * Callers:
...
LABEL_44:
      ...
      v33 = (_QWORD *)qword_140FC2908;
      v34 = (_QWORD *)(v14 + 288);
      if ( *(__int64 **)qword_140FC2908 == &HalpDmaHibernateAdapters )
      {
        *v34 = &HalpDmaHibernateAdapters;
        v34[1] = v33;
        *v33 = v34;
        qword_140FC2908 = (__int64)v34;
LABEL_54:
        if ( !CurrentIrql )
        ...
        v36 = (_QWORD *)qword_140FC2918;
        v37 = v8 + 4;
        if ( *(__int64 **)qword_140FC2918 == &HalpDmaShadowDumpAdapters )
        {
          *v37 = &HalpDmaShadowDumpAdapters;
          v8[5] = (__int64)v36;
          *v36 = v37;
          qword_140FC2918 = (__int64)(v8 + 4);
LABEL_65:
          if ( !CurrentIrql )
...
LABEL_43:
    ...
    if ( (unsigned int)v5 <= *(_DWORD *)(v9 + 232) )
    {
      ...
      *(_DWORD *)(v14 + 4 * v15 + 272) = v5;
      if ( *(_DWORD *)(v14 + 520) == 3 )
      {
        v39 = guard_dispatch_icall_no_overrides(*(_QWORD *)(*(_QWORD *)(v14 + 512) + 40LL));
        if ( v39 < 0 )
        {
LABEL_24:
        ...
        if ( HalpIsHvPresent() )
        {
          ...
          while ( v24 );
          v39 = guard_dispatch_icall_no_overrides(*(_QWORD *)(v18 + 24));
