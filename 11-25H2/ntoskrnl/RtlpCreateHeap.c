/*
 * XREFs of RtlpCreateHeap @ 0x1404D8494
 * Callers:
 *     RtlCreateHeap @ 0x140773FA0 (RtlCreateHeap.c)
 * Callees:
  ...
  else
  {
    ...
    if ( !*((_QWORD *)&v70 + 1) )
    {
      ...
      do
      {
        ...
        v40 = v38;
        v38 = _InterlockedCompareExchange64(&qword_140E28000, v39, v38);
      }
      while ( v40 != v38 );
