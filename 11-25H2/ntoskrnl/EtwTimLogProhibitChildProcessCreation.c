/*
 * XREFs of EtwTimLogProhibitChildProcessCreation @ 0x140A0D588
 * Callers:
...
void __fastcall EtwTimLogProhibitChildProcessCreation(int a1, __int64 a2, UNICODE_STRING *a3, UNICODE_STRING *a4)
{
  ...
  if ( (unsigned int)dword_140E09010 > 5 && v43 == 2 )
  {
    if ( (qword_140E09020 & 0x200000000001LL) == 0 || (v37 = 1, (qword_140E09028 & 0x200000000001LL) != qword_140E09028) )
      v37 = 0;
    if ( v37 )
    {
      v51 = 2LL;
  ...
  *(ULONG *)((char *)&UserData.Reserved + v32) = 0;
  ...
  {
    if ( (qword_140E09058 & 0x400000000000LL) == 0 || (qword_140E09060 & 0x400000000000LL) != qword_140E09060 )
      v27 = 0;
    if ( v27 )
    {
      v43 = v34;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140051E0D,
        0LL,
        0LL,
        0xCu,
        v49);
