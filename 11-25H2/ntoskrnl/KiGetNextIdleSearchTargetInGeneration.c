/*
 * XREFs of KiGetNextIdleSearchTargetInGeneration @ 0x1403D01D0
 * Callers:
...
LABEL_14:
      ...
      v25 = v22 - 1;
      v26 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + 64 * *(unsigned __int16 *)(v16 + 136) + v25)];
...
LABEL_7:
  ...
  if ( !_interlockedbittestandreset64((volatile signed __int32 *)v13, v21) )
    goto LABEL_10;
  if ( !KiProcessorBlock[*((unsigned int *)qword_140F216A8 + 64 * *(unsigned __int16 *)(v16 + 136) + v21)] )
    KeBugCheckEx(
      0x200u,
      2uLL,
      v21 | ((unsigned __int64)*(unsigned __int16 *)(v16 + 136) << 8),
      *((unsigned int *)qword_140F216A8 + 64 * *(unsigned __int16 *)(v16 + 136) + v21),
      0LL);
  v27 = 0LL;
  v28 = 1;
  v10 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + 64 * *(unsigned __int16 *)(v16 + 136) + v21)];
LABEL_19:
  *a4 = v11;
  *a5 = v10;
  *a6 = v27;
