/*
 * XREFs of CcReEngageWorkerThreads @ 0x1404DBB10
 * Callers:
...
LABEL_14:
      ...
      *v14 = 0LL;
      result = (_UNKNOWN **)ExQueueWorkItemToPartition(v14, 0, *(_DWORD *)(a2 + 24), *(_QWORD *)(a1 + 8));
      ++v6;
    }
    while ( v6 < a3 );
  }
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      *v16 = v18;
      ...
      CcReferencePartitionAndPrivateVolumeCacheMap(a1, v5);
      *v19 = 0LL;
      result = (_UNKNOWN **)ExQueueWorkItemToPartition(v19, 0, *(_DWORD *)(a2 + 24), *(_QWORD *)(a1 + 8));
      ++v15;
    }
    while ( v15 < a4 );
  }
