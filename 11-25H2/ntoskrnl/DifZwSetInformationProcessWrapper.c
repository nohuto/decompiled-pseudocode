/*
 * XREFs of DifZwSetInformationProcessWrapper @ 0x14063C970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationProcessWrapper(void *a1, PROCESSINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(14);
  ...
  DWORD2(v18) = ZwSetInformationProcess(a1, a2, a3, a4);
  if ( v8 )
  {
