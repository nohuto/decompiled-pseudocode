/*
 * XREFs of SleepstudyHelperBuildBlocker @ 0x140A19C50
 * Callers:
    ...
    else
    {
        ...
        || (v12 = *(_DWORD *)(v7 + 40), v12 >= SleepstudyHelperBlockerLibraryLimit) )
      {
        ...
        if ( SshpTelemetryHandleRegistered
          && (unsigned int)dword_140E08410 > 5
          && tlgKeywordOn((__int64)&dword_140E08410, 0x400000000000LL) )
        {
          v41 = 0;
          v44 = 0;
          v39 = &v31;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14004E408,
            0LL,
            0LL,
            0xAu,
            &v38);
                ...
                RtlInsertElementGenericTableAvl((PRTL_AVL_TABLE)(v7 + 48), Buffer, 0x10u, NewElement)) )
          {
            ...
            *(_QWORD *)(v16 + 8) = v4;
            ...
            if ( _interlockedbittestandset64((volatile signed __int32 *)v6, 0LL) )
              ExfAcquirePushLockExclusiveEx(v6, v18, (__int64)v6);
            v11 = 0;
            if ( v19 )
              *((_BYTE *)v19 + 10) = 1;
            v20 = v4 + 2;
