/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStop @ 0x14075D9E0
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStop(int a1)
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v9 = &v4;
    v4 = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&unk_14004EB98, 0LL, 0LL, 4u, &v5);
  }
}
