/*
 * XREFs of CmpFindSubKeyByNumberFromMergedView @ 0x140A9B4D4
 * Callers:
        ...
        _DWORD *a9)
{
  ...
  unsigned int BugCheckParameter4; // [rsp+80h] [rbp-39h] BYREF
  unsigned int BugCheckParameter4_4; // [rsp+84h] [rbp-35h]
...
LABEL_85:
    ...
    {
      v24 = *(_QWORD *)(a2 + 32);
      v25 = (*(_BYTE *)(v24 + 140) & 1) != 0 ? HvpGetCellFlat(v24, v14, &v44) : HvpGetCellPaged(v24, v14, &v44);
      v51 = v25;
      if ( !v25 )
      {
LABEL_35:
...
LABEL_37:
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(v26 + 140) & 1) != 0 )
        ...
        CellFlat = HvpGetCellPaged(v26, v13, &v45);
      v50 = CellFlat;
      v28 = CellFlat;
      if ( !CellFlat )
        goto LABEL_35;
...
LABEL_75:
    if ( v28 )
    {
      ...
      if ( (*(_BYTE *)(v37 + 140) & 1) != 0 )
        HvpReleaseCellFlat(v37, &v45);
      else
        HvpReleaseCellPaged(v37, (unsigned int *)&v45);
      v50 = 0LL;
    }
    v11 = v41;
    v9 = a3;
...
LABEL_38:
  ...
  if ( v51 )
  {
    ...
    if ( (*(_BYTE *)(v29 + 140) & 1) != 0 )
      ...
      HvpReleaseCellPaged(v29, (unsigned int *)&v44);
  }
  if ( v50 )
  {
    v39 = *(_QWORD *)(v17 + 32);
    if ( (*(_BYTE *)(v39 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v39, &v45);
    else
      HvpReleaseCellPaged(v39, (unsigned int *)&v45);
  }
  *a9 = v11 != 0 ? v12 + 1 : 0;
  return v10;
}
