/*
 * XREFs of PopRequestWrite @ 0x140B4DFC0
 * Callers:
 *     PopCompressCallback @ 0x140B4C5E0 (PopCompressCallback.c)
  ...
  *(_QWORD *)MaxDataSize = 0LL;
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( (_DWORD)v8 == 1 )
      {
        BugCheckParameter4 = (int)guard_dispatch_icall_no_overrides(2LL);
        v14 = __rdtsc();
        qword_140F0B0E0 += (((unsigned __int64)HIDWORD(v14) << 32) | (unsigned int)v14) - v10;
      ...
      {
        qword_140F0B0D8 += v9 - *(_QWORD *)(v7 + 368);
        ProducerConsumerBufferComplete(v6, v6 + 48, *(_QWORD *)(v7 + 416), *(unsigned int *)(v7 + 392));
        v11 = __rdtsc();
        qword_140F0B108 += (((unsigned __int64)HIDWORD(v11) << 32) | (unsigned int)v11) - v10;
        qword_140F0B2B0 += *(_QWORD *)(v7 + 392);
        dword_140F0B2B8 += (unsigned __int64)(*(_QWORD *)(v7 + 384) + 4095LL) >> 12;
        v12 = *(_QWORD *)(v7 + 384);
        *(_QWORD *)(v7 + 408) += v12;
        *(_QWORD *)(v7 + 376) += v12;
        *(_QWORD *)(v7 + 384) = 0LL;
    ...
    *(_QWORD *)(v7 + 392) = v23;
    if ( v22 + v19 > qword_140F0AD70 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0);
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140F0AD70, *(unsigned int *)(v7 + 200), RemainingHibernateRangeDataSize);
    }
    ...
    *(_QWORD *)(v7 + 384) = v19;
    if ( !*(_BYTE *)(v7 + 424) )
      goto LABEL_25;
    v28 = __rdtsc();
    v29 = (int)guard_dispatch_icall_no_overrides(1LL);
    v30 = __rdtsc();
    qword_140F0B0E0 += (((unsigned __int64)HIDWORD(v30) << 32) | (unsigned int)v30) - v28;
...
LABEL_25:
      v28 = __rdtsc();
      v31 = (int)guard_dispatch_icall_no_overrides(v7 + 400);
      v32 = __rdtsc();
      qword_140F0B0E0 += (((unsigned __int64)HIDWORD(v32) << 32) | (unsigned int)v32) - v28;
