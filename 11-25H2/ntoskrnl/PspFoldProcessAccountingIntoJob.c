/*
 * XREFs of PspFoldProcessAccountingIntoJob @ 0x1409F043C
 * Callers:
 ...
 *     PspUpdateJobPeakProcessMemory @ 0x1409F05DC (PspUpdateJobPeakProcessMemory.c)
 */
...
char __fastcall PspFoldProcessAccountingIntoJob(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  *(__m128i *)(a1 + 1816) = _mm_add_epi64(_mm_loadu_si128((const __m128i *)(a3 + 11)), v10);
  ...
  if ( result )
  {
    PsQueryProcessEnergyValues((signed __int64 *)a2, v14);
