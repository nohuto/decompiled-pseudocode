/*
 * XREFs of PiCMGetRelatedDeviceInstance @ 0x1409342F0
 * Callers:
...
LABEL_34:
      if ( inited >= 0 )
      {
        v21 = PiCMReturnBufferResultData(inited, 2 * v9, 0, Pool2, 2 * v9, v39, v6, a4, a6);
        goto LABEL_36;
      }
    }
  }
LABEL_27:
  v21 = PiCMReturnBufferResultData(inited, 2 * v9, 0, 0LL, 0, v39, a3, a4, a6);
LABEL_36:
  inited = v21;
  if ( Pool2 )
