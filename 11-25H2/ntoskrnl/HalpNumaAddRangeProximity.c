/*
 * XREFs of HalpNumaAddRangeProximity @ 0x140555180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpNumaAddRangeProximity(unsigned __int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned int)dword_140E03B08 > 5 && tlgKeywordOn((__int64)&dword_140E03B08, 0x400000000000LL) )
  {
    ...
    v24 = &v20;
    v25 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E03B08, (unsigned __int8 *)&byte_1400429AF, 0LL, 0LL, 3u, v23);
  }
...
LABEL_13:
      if ( (unsigned int)dword_140E03B08 > 5 && tlgKeywordOn((__int64)&dword_140E03B08, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&dword_1400428EC,
          0LL,
          0LL,
          6u,
          v23);
