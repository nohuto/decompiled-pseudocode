/*
 * XREFs of PfSnBeginAppLaunch @ 0x1408261B4
 * Callers:
...
__int64 __fastcall PfSnBeginAppLaunch(ULONG_PTR a1, unsigned __int16 *a2, int a3)
{
  ...
  if ( !a2 )
  {
    v9 = PfCalculateProcessHash(a1, &v21);
    v6 = v21;
    v8 = v9;
    if ( v9 < 0 )
    {
...
LABEL_25:
  ...
  v27 = 0LL;
  v26 = v24;
  PfSnGetAppVersion(a1, (__int64)&v27);
  *(_OWORD *)Str2 = *(_OWORD *)SubStr;
  v34 = v30;
  v35 = v31;
  v36 = v32;
  v37 = v18;
  PfLockSharedAcquire((volatile signed __int64 *)&qword_140E66E78);
  ...
  PfLockSharedRelease((volatile signed __int64 *)&qword_140E66E78);
  HIDWORD(v32) += a3;
  if ( (dword_140E66E50 & 0x20) != 0 || v25 == 2 )
    v7 |= 2u;
  v8 = PfSnBeginScenario(a1, (unsigned int)SubStr, 0, v7, (__int64)&v28, (__int64)&v26);
  if ( v8 >= 0 )
    v8 = 0;
LABEL_22:
  if ( v6 )
