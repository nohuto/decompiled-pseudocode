/*
 * XREFs of EtwpGetAutoLoggerProviderFilter @ 0x140A787C8
 * Callers:
        ...
        if ( v28 )
        {
          ...
          *v46 = v54;
          if ( v49 )
          {
            ...
            while ( v40 );
            v24 = v44;
            EtwpGetAutoLoggerEventNameFilter(Pool2, v14, L"EventNameFilter", v61, v44);
            v23 = v45;
            EtwpGetAutoLoggerEventNameFilter(Pool2, v14, L"StackNameFilter", v62, v45);
            EtwpGetAutoLoggerLevelKwFilter(Pool2, v14, v63);
            v19 = 2LL;
            goto LABEL_15;
          }
          do
