/*
 * XREFs of DrvDbSetDeviceIdMappedProperty @ 0x14092EE30
 * Callers:
...
LABEL_37:
      if ( a3 )
        v7 = a3;
      v24 = DrvDbSetRegValueMappedProperty(v19, (__int64)v7, (__int64)v17, v20, a6, a7);
    }
    else
    {
      if ( v20 == 8210 )
...
LABEL_30:
      ...
      if ( a3 )
        v7 = a3;
      v24 = DrvDbSetDeviceIdDriverInfMatches(v19, v7, v23);
    }
    v7 = Handle;
    v14 = v24;
  }
