/*
 * XREFs of SdbpCheckApplicationTypeAttributes @ 0x14068ACD4
 * Callers:
 ...
 *     AslStringPatternMatchW @ 0x140824AD0 (AslStringPatternMatchW.c)
...
__int64 __fastcall SdbpCheckApplicationTypeAttributes(int *a1, __int64 a2, unsigned int a3, _QWORD *a4)
{
  ...
  *a1 = 0;
  ...
  {
    FirstTag = SdbFindFirstTag(a2, a3, *(unsigned __int16 *)((char *)&unk_140E0EA70 + i));
    if ( !FirstTag )
      continue;
    v13 = a4[2];
    v14 = 0LL;
    ...
    while ( 1 )
    {
      ...
      if ( *(_WORD *)v15 == *(_WORD *)((char *)&unk_140E0EA70 + i + 2) )
        break;
      v13 = a4[2];
      if ( ++v14 >= v13 )
        goto LABEL_13;
    ...
    {
LABEL_13:
      if ( *(_WORD *)((char *)&unk_140E0EA70 + i) == 24577 )
        continue;
...
LABEL_15:
    ...
    v18 = *(unsigned __int16 *)((char *)&unk_140E0EA70 + i);
    if ( v18 > 0x6011 )
    {
      v33 = v18 - 24617;
      if ( !v33 )
