/*
 * XREFs of VrpCreateNamespaceNode @ 0x140949EA0
 * Callers:
 ...
 *     VrpFindBestMatchNamespaceNode @ 0x140947478 (VrpFindBestMatchNamespaceNode.c)
 *     VrpBuildKeyPath @ 0x1409490E8 (VrpBuildKeyPath.c)
 *     VrpCountPathComponents @ 0x140949C70 (VrpCountPathComponents.c)
 *     VrpGetNextToken @ 0x14094A160 (VrpGetNextToken.c)
 *     VrpStripTrailingCharacters @ 0x14094A220 (VrpStripTrailingCharacters.c)
  ...
  *(_QWORD *)(v14 + 8) = v16;
  ...
  if ( v16 )
  {
    ...
    *(_QWORD *)(v14 + 32) = v20;
    ...
    {
      v21 = *(_WORD *)a4;
      *(_WORD *)(v14 + 24) = *(_WORD *)a4;
      *(_WORD *)(v14 + 26) = v21;
      memmove(v20, a4[1], *(unsigned __int16 *)a4);
      *(_WORD *)(v14 + 64) = VrpCountPathComponents((unsigned __int16 *)v14);
      *(_WORD *)(v14 + 66) = VrpCountPathComponents((unsigned __int16 *)(v14 + 24));
      VrpGetNextToken(a2, &v36, &String1);
      if ( !String1.Length )
      {
LABEL_16:
      ...
      BestMatchNamespaceNode = VrpFindBestMatchNamespaceNode(v11, v14, (__int64)&v33);
      ...
      else
      {
        ...
        *(_DWORD *)(v14 + 56) |= v24 & 2;
        ...
        if ( v25 )
        {
          do
          {
            VrpGetNextToken(v14, &v36, &String1);
            --v25;
          }
          while ( v25 );
          v26 = v36;
