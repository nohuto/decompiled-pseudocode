/*
 * XREFs of FsRtlpOplockPerfInitializeLatencyInfo @ 0x1406FFD54
 * Callers:
...
__int64 FsRtlpOplockPerfInitializeLatencyInfo()
{
  ...
  v1 = 16LL;
  qword_140E65A70 = v4.QuadPart;
  do
  {
    v2 = g_OplockPerfLatencyLevelsNs[v0];
    *(_QWORD *)((char *)&unk_140E659F0 + v0 * 8) = v2;
    if ( v2 == 0x7FFFFFFFFFFFFFFFLL )
      result = 0x7FFFFFFFFFFFFFFFLL;
    else
      result = FsRtlpComputeLargeRatio(v2, qword_140E65A70, 1000000000LL);
