/*
 * XREFs of SepAdtCloseObjectAuditAlarm @ 0x140985C34
 * Callers:
 *     SeCloseObjectAuditAlarmForNonObObject @ 0x140783560 (SeCloseObjectAuditAlarmForNonObObject.c)
        ...
        char a5)
{
  ...
  P = 0LL;
  v21 = 0;
  if ( SepAdtAuditObjectAccessWithContext(a4, a1, 1u, 0, a3, a5, &v21)
    && SepAdtAuditThisEventWithContext(124LL, 1, 0, a3) )
  {
