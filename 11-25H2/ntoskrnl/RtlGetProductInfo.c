        ...
        PULONG ReturnedProductType)
{
  ...
  if ( ReturnedProductType )
  {
    *ReturnedProductType = 0;
    ...
    v18 = xmmword_14002FDD8;
    v17[2] = SpMajorVersion;
    v17[3] = SpMinorVersion;
    if ( (int)CompareVersions(v17, &v18) >= 0 )
    {
      if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_14000B258, &Type, &Data, 4u, &ResultDataSize) < 0
        || Type != 4
        || ResultDataSize != 4 )
      {
      ...
      if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_14000B268, &Type, v19, 0xC8u, &ResultDataSize) < 0 )
      {
LABEL_8:
