/*
 * XREFs of MiExtendSection @ 0x14093B140
 * Callers:
 ...
 *     Mi4KStartForSubsection @ 0x1404645D4 (Mi4KStartForSubsection.c)
...
LABEL_44:
  ...
  *(_DWORD *)(v26 + 32) = *(_DWORD *)(v26 + 32) & 0xFFFFF | (*(unsigned __int16 *)a2 << 20);
  ...
  v29 = BugCheckParameter2;
LABEL_14:
  appended = MiAppendSubsectionChain((__int64 *)a1, (__int64)&v48, v19);
  if ( !appended )
  {
    v31 = *(_WORD *)(v47 + 12);
  ...
  while ( 1 )
  {
    ...
    if ( SubsectionCharges < 0 )
      break;
    if ( (int)MiIncrementSubsectionViewCount((__int64 *)v40, 56) <= 1 )
    {
      v18 += v41;
      break;
    }
