/*
 * XREFs of MiProbeUnlockPage @ 0x1402CB9A0
 * Callers:
...
void __fastcall MiProbeUnlockPage(__int64 a1, __int16 a2, __int64 *a3, int *a4)
{
  ...
  if ( (a2 & 0x80u) != 0 )
  {
    if ( !v13 )
    {
      if ( (*(_DWORD *)(v7 + 16) & 0x400LL) == 0 && (*(_BYTE *)(v7 + 34) & 8) == 0 )
      {
        ...
        {
          *(_QWORD *)(v7 + 16) &= ~4uLL;
          MiClearPageFileReservation(&v21);
          v14 = v21;
        }
        else
        {
  ...
  MiRemoveLockedPageChargeAndDecRef(v7, v8, (__int64)a3, (unsigned __int64)a4);
  ...
  if ( v14 )
    MiReleasePageFileInfo(v16, v14, 1);
  if ( v11 )
    MiFinishLargePageFree(v11, 1LL, 1LL, 16LL);
  if ( v12 )
