/*
 * XREFs of MiInitializePartitionSpecialPurposeMemory @ 0x1407EE544
 * Callers:
 *     MiInitializePartitionSpecialPurposeMemoryCallout @ 0x140682F30 (MiInitializePartitionSpecialPurposeMemoryCallout.c)
...
LABEL_25:
  ...
  if ( Pool )
  {
    ...
    *((_QWORD *)Pool + 2) = _InterlockedIncrement64(&qword_140E2EB38);
    v16 = Handle;
    *(_OWORD *)(Pool + 24) = *a2;
    v17 = a2[1];
    *((_QWORD *)Pool + 7) = v16;
