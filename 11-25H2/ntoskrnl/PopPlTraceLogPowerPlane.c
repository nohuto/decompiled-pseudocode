/*
 * XREFs of PopPlTraceLogPowerPlane @ 0x1405D7D34
 * Callers:
...
int __fastcall PopPlTraceLogPowerPlane(unsigned __int16 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    v28 = 4LL;
    v30 = 4LL;
    tlgWriteEx_EtwWriteEx((__int64)&dword_140E07680, (unsigned __int8 *)&word_14004D302, a3, 1u, v14, v15, 7u, v20);
  }
  v5 = *(_QWORD *)v3;
  v6 = 0LL;
  if ( *(_QWORD *)v3 )
    ...
    do
    {
      ...
      if ( (unsigned int)dword_140E07680 > 5 )
      {
        ...
        tlgWriteEx_EtwWriteEx(
          ...
          (unsigned __int8 *)&byte_14004D360,
          a3,
          1u,
          v14,
          v15,
        ...
        do
        {
          ...
          if ( (unsigned int)dword_140E07680 > 5 )
          {
            ...
            LODWORD(v5) = tlgWriteEx_EtwWriteEx(
                            (__int64)&dword_140E07680,
                            (unsigned __int8 *)&byte_14004D3F8,
                            a3,
                            1u,
                            v14,
                            v15,
