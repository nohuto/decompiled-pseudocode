/*
 * XREFs of PspGetContext @ 0x1409A5DB0
 * Callers:
 *     PspGetSetContextInternal @ 0x1409A5700 (PspGetSetContextInternal.c)
 * Callees:
 *     RtlCopyXStateArea @ 0x140263F70 (RtlCopyXStateArea.c)
 *     KeCopyLastBranchInformation @ 0x14043B810 (KeCopyLastBranchInformation.c)
 *     RtlXSaveS @ 0x14043B8FC (RtlXSaveS.c)
 *     KiGetAllocatedXSaveArea @ 0x140443040 (KiGetAllocatedXSaveArea.c)
 */
