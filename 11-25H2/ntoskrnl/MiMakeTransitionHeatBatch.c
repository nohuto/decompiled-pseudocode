/*
 * XREFs of MiMakeTransitionHeatBatch @ 0x1404F4FB0
 * Callers:
    ...
    if ( *(__int64 *)(a1 + 40) < 0 )
    {
      ...
      if ( PrototypePteBoundaries )
      {
        ...
        if ( v18 >= v16 )
          v18 = v16 - 8;
LABEL_19:
        TransitionPageHeatList = (unsigned int *)MiGetTransitionPageHeatList(v17, v16, v9, v12);
            ...
            while ( 1 )
            {
              ...
              if ( (MI_READ_PTE_LOCK_FREE((unsigned __int64)v27) & 0xC01) == 0x800 )
              {
                ...
                else
                {
                  ...
                  MiSetActivePfnHeat(v28, 0);
                  _InterlockedAnd64((volatile signed __int64 *)(v28 + 24), 0x7FFFFFFFFFFFFFFFuLL);
                  v30 = v33;
                }
                if ( (unsigned int)MiAddPageToHeatRanges(v7, 0xAAAAAAAAAAAAAAABuLL * ((v30 + 0x220000000000LL) >> 4), 3) )
                  return v7;
              }
LABEL_34:
              ++v27;
