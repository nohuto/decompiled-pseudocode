/*
 * XREFs of AdtpObjsInitialize @ 0x140801948
 * Callers:
...
NTSTATUS AdtpObjsInitialize()
{
  ...
  *(_QWORD *)&v29 = 0LL;
  ...
  {
    v5 = 16LL * i;
    *(_WORD *)((char *)&unk_140EF0302 + v5) = 24;
    *(_WORD *)((char *)&AdtpEventIdStringStandard + v5) = 0;
    *(_QWORD *)((char *)&unk_140EF0308 + v5) = (char *)&AdtpAccessIdsStringBuffer + 2 * v3;
  ...
  {
    v8 = 16LL * j;
    *(_WORD *)((char *)&unk_140EEFFC2 + v8) = 24;
    *(_WORD *)((char *)&AdtpEventIdStringSpecific + v8) = 0;
    *(_QWORD *)((char *)&unk_140EEFFC8 + v8) = (char *)&AdtpAccessIdsStringBuffer + 2 * v3;
    ...
    if ( v9 == -1073741789 )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        *((_QWORD *)&v27 + 1) = v33;
        ...
        v29 = 0LL;
        *(_QWORD *)&v28 = v1 + 1;
        result = NtOpenKey(&Handle, 131097LL, &v27);
        if ( result < 0 )
          return result;
