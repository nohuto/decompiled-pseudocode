/*
 * XREFs of EtwTraceObject @ 0x14079A4F4
 * Callers:
...
int __fastcall EtwTraceObject(unsigned __int16 a1, __int64 a2)
{
  ...
  if ( !v9 )
  {
    ...
    {
      v8 &= v8 - 1;
      v7 = 32LL * (unsigned int)v10 + EtwpHostSiloState + 4284;
      if ( v7 )
      {
    ...
    if ( v2 )
    {
      ...
      *(_QWORD *)&v17 = a2 + 48;
      ...
      v19 = 16;
      v18 = &v17;
      LODWORD(v7) = EtwpTraceKernelEventWithFilter((struct _KTHREAD *)&v18, 1u, v2, a1, 0x10601902u);
    }
  }
  return v7;
}
