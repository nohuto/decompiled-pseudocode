/*
 * XREFs of CmpTransSearchAddLightWeightTrans @ 0x1408705D4
 * Callers:
 ...
 *     CmpBindHiveToTrans @ 0x140885E94 (CmpBindHiveToTrans.c)
 *     CmpTransAllocateTrans @ 0x140A842D8 (CmpTransAllocateTrans.c)
 *     ExFreePoolWithTag @ 0x140B62CD0 (ExFreePoolWithTag.c)
 */

__int64 __fastcall CmpTransSearchAddLightWeightTrans(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  v6 = a3;
  v9 = 0;
  v10 = CmpTransReferenceTransaction(a1, a2, a3);
  if ( (v10 & 0x80000000) != 0 )
    return v10;
  v11 = *(_QWORD *)(v5 + 16);
  if ( v11 )
...
LABEL_19:
  ...
  *((_DWORD *)v14 + 12) = 128;
  v16 = (_QWORD *)qword_140EF5078;
  if ( *(__int64 **)qword_140EF5078 != &CmpLightTransactionList )
    __fastfail(3u);
  *v14 = &CmpLightTransactionList;
  v14[1] = v16;
  *v16 = v14;
  qword_140EF5078 = (__int64)v14;
  ExReleaseFastMutexUnsafe(&CmpTransactionListLock);
  KeLeaveCriticalRegion();
  v10 = 0;
  *a4 = v14;
