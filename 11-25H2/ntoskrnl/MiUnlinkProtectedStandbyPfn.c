/*
 * XREFs of MiUnlinkProtectedStandbyPfn @ 0x14021BE10
 * Callers:
...
__int64 __fastcall MiUnlinkProtectedStandbyPfn(_QWORD *a1)
{
  ...
  v4 = 0;
  if ( (v1 & 0xFFFFFFFFFFuLL) >= qword_140E358C0 && v3 < qword_140E358C0 + 2048 )
    v4 = v2 == v3;
  ...
  else
  {
    ...
    {
      v7 = (v2 << 12) | 0x890;
      if ( (qword_140E2D940 & v6) == 0 )
        v7 = qword_140E2D940 | (v2 << 12) | 0x880;
      v6 = v7;
    }
    v5[2] = v6;
  }
  v8 = 48 * v2 - 0x220000000000LL;
  if ( v2 >= qword_140E358C0 && v2 < qword_140E358C0 + 2048 )
  {
    v9 = *(_QWORD *)(v8 + 40);
