/*
 * XREFs of EtwpTraceHandle @ 0x140850E08
 * Callers:
...
void __fastcall EtwpTraceHandle(unsigned __int16 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  unsigned __int16 v29; // [rsp+34h] [rbp-CCh]
  ...
  if ( !v10 )
  {
    ...
    {
      v8 &= v8 - 1;
      v13 = 32LL * (unsigned int)v11 + EtwpHostSiloState + 4284;
...
LABEL_19:
      ...
      *(&v34 + 2 * v23) = 2;
      EtwpTraceKernelEventWithFilter((struct _KTHREAD *)&v33, v12 + 1, v5, v22, 0x10601902u);
      if ( Pool2 )
      {
        if ( Pool2 != (_WORD *)P )
          ExFreePoolWithTag(Pool2, 0);
