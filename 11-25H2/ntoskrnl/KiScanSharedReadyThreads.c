/*
 * XREFs of KiScanSharedReadyThreads @ 0x140466DC8
 * Callers:
...
char __fastcall KiScanSharedReadyThreads(struct _KPRCB *a1, __int64 a2, char a3)
{
  ...
  _DWORD v48[2]; // [rsp+74h] [rbp-Dh] BYREF
  int v49; // [rsp+7Ch] [rbp-5h]
  unsigned __int64 v50; // [rsp+80h] [rbp-1h]
  int v51[20]; // [rsp+88h] [rbp+7h] BYREF
  ...
  if ( !(_BYTE)v3 )
  {
    ...
    if ( _bittest(&KiVelocityFlags, 0x15u) )
    {
      *((_QWORD *)&v39 + 1) = a2;
      *(_QWORD *)&v39 = 0LL;
      v14 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)a2, (__int64)&v39);
      if ( !v14 )
        goto LABEL_24;
      LOBYTE(v3) = KxWaitForLockOwnerShip((struct _KPRCB *)&v39, v14);
    }
    else
    {
      v48[0] = 0;
...
LABEL_29:
  ...
  *((_QWORD *)&v39 + 1) = a2;
  *(_QWORD *)&v39 = 0LL;
  v9 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)a2, (__int64)&v39);
  if ( v9 )
  {
    LOBYTE(v3) = KxWaitForLockOwnerShip((struct _KPRCB *)&v39, v9);
LABEL_10:
    v4 = v5 + 64;
  }
...
LABEL_60:
  ...
  if ( v46 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(v34 + 64) = 0LL;
      if ( (_BYTE)v55 && (BYTE8(PerfGlobalGroupMask) & 1) != 0 )
