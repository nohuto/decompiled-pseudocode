/*
 * XREFs of ?SmStMapVirtualRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z @ 0x14020C270
 * Callers:
        ...
        int a5)
{
  ...
  if ( (a5 & 0x40) != 0 )
  {
    v15 = (volatile signed __int64 *)(a1 + 6840);
    v6 = 1;
  ...
  else
  {
    ...
    else if ( (a5 & 2) == 0 )
    {
      while ( (v10 & 0x1FFF) != 0x1FFF )
      {
        ...
        if ( v12 )
        {
          SmAcquireReleaseCharges(*(_QWORD *)(a1 + 7576), v9, 1LL, 1LL);
          v9 = v23;
          LOWORD(v10) = v14;
        }
        else
