/*
 * XREFs of KiAssignProcessorNumberToPrcb @ 0x1405B72D0
 * Callers:
 ...
 *     KiFindSubNodeForProcessorNumber @ 0x1405B7764 (KiFindSubNodeForProcessorNumber.c)
 */
...
unsigned __int64 __fastcall KiAssignProcessorNumberToPrcb(__int64 a1, char *a2, int a3)
{
  ...
  *((_DWORD *)KiGlobalState + v10) = v11;
  result = (unsigned __int64)qword_140F216A8;
  *((_DWORD *)qword_140F216A8 + v11) = v10;
