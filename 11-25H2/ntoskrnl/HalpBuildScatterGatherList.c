/*
 * XREFs of HalpBuildScatterGatherList @ 0x140332DE0
 * Callers:
 *     HalBuildScatterGatherListEx @ 0x1403316B0 (HalBuildScatterGatherListEx.c)
 *     HalBuildScatterGatherListV3 @ 0x140331940 (HalBuildScatterGatherListV3.c)
 *     HalGetScatterGatherList @ 0x140337120 (HalGetScatterGatherList.c)
 *     HalGetScatterGatherListEx @ 0x14054C1F0 (HalGetScatterGatherListEx.c)
 * Callees:
        ...
        _QWORD *a15)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(_DWORD *)(v22 + 44) = 1;
    if ( a8 )
    {
      AdapterChannel = HalpAllocateAdapterChannel(a1, (__int64)v24, 1u, 0, v21, (__int64)HalpAllocateAdapterCallbackV3);
    }
    else
    {
      AdapterChannel = HalpAllocateAdapterChannel(a1, (__int64)v24, 1u, 0, v21, 0LL);
      if ( !AdapterChannel )
      {
