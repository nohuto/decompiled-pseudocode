/*
 * XREFs of KiComputeNumaCosts @ 0x140C1681C
 * Callers:
 ...
 *     KiGetHalNumaConversionFactor @ 0x140C16FC8 (KiGetHalNumaConversionFactor.c)
 */
  ...
  if ( Pool2 )
  {
    ...
    if ( KeNumberNodes )
    {
      while ( 1 )
      {
        ...
        if ( *v5 != v5[1] )
          goto LABEL_41;
        if ( !KeIsEmptyGroupMask((__int64)(v5 + 8)) )
          break;
        v8 = 0;
        for ( i = *v5; v8 < (unsigned __int16)KeNumberNodes; ++v8 )
        {
          v5 = (__int16 *)KeNodeBlock[v8];
          if ( v5[1] == i && !KeIsEmptyGroupMask((__int64)(v5 + 8)) )
            break;
        }
        v2 = KeNumberNodes;
...
LABEL_41:
      ...
      v8 = v4;
LABEL_24:
      NodePrimarySubNode = KeGetNodePrimarySubNode((__int64)v5);
