/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x1404D4110
 * Callers:
...
void *__fastcall PopTraceThermalZonePassiveHistogram(__int64 a1)
{
  ...
  if ( result )
  {
      ...
      && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
    {
      ...
      v13 = 84;
      v16 = 21;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)word_1400494CA, 0LL, 0LL, 7u, &v6);
    }
