/*
 * XREFs of HalpCalculateScatterGatherListSize @ 0x140334C80
 * Callers:
 *     HalBuildScatterGatherListV2 @ 0x1403346B0 (HalBuildScatterGatherListV2.c)
 *     HalCalculateScatterGatherListSizeV2 @ 0x1404A7CB0 (HalCalculateScatterGatherListSizeV2.c)
 * Callees:
 *     <none>
 */
...
LABEL_9:
    ++v7;
LABEL_10:
  if ( (unsigned int)v19 > *(_DWORD *)(a1 + 232) )
    return 3221225626LL;
  v21 = 24 * v19 + 16;
