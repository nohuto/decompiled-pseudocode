/*
 * XREFs of HvpDetermineLogFileApplicationOrder @ 0x1409FAC08
 * Callers:
...
LABEL_9:
    ...
    else if ( !v9 && (unsigned int)dword_140E09E08 > 5 )
    {
      LOBYTE(v7) = tlgKeywordOn((__int64)&dword_140E09E08, 0x400000000000LL);
      if ( (_BYTE)v7 )
      {
        v17 = 0;
        v15 = &v13;
        ...
        LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_1400548AD,
                       0LL,
                       0LL,
                       3u,
                       &v14);
