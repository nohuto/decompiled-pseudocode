/*
 * XREFs of PipFindDependencyNodePath @ 0x1404817DC
 * Callers:
 *     IoTestDependency @ 0x140481780 (IoTestDependency.c)
 * Callees:
 *     KeAcquireSpinLockRaiseToDpc @ 0x1402535A0 (KeAcquireSpinLockRaiseToDpc.c)
 *     KeReleaseSpinLock @ 0x1402EA780 (KeReleaseSpinLock.c)
 *     PipDependencyGraphDepthFirstSearch @ 0x140481870 (PipDependencyGraphDepthFirstSearch.c)
 */
