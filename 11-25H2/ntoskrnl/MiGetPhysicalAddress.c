/*
 * XREFs of MiGetPhysicalAddress @ 0x1402ABF00
 * Callers:
...
__int64 __fastcall MiGetPhysicalAddress(unsigned __int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  {
    v15 = MiVaToPfnEx(a1);
    v16 = (MI_READ_PTE_LOCK_FREE(*(&v24 + v8)) & 0x800) == 0;
  }
  else
  {
    v9 = 4LL;
    ...
    {
      v4 = byte_140E38768[((a1 >> 39) & 0x1FF) - 256];
      if ( v4 == 11 )
        MiQueuePinDriverAddressLog(a1, *(_QWORD *)v24, 0);
    }
    if ( (v12 & 1) == 0 )
      return 0LL;
    if ( v4 == 4 )
    {
      v13 = (volatile signed __int64 *)v24;
      v14 = *(_QWORD *)v24;
      if ( (*(_QWORD *)v24 & 0x200LL) == 0 )
      {
        do
        {
          if ( (MiFlags & 0x2000000) != 0 )
            _mm_lfence();
          v22 = v14;
          v14 = _InterlockedCompareExchange64(v13, v14 | 0x220, v14);
        }
        while ( v22 != v14 && (v14 & 0x200) == 0 );
      }
      v12 = *(_QWORD *)v24;
    }
  ...
  if ( !v16 )
    *a3 = 1;
  result = 1LL;
  *a2 = __PAIR64__(v15 >> 20, ((_DWORD)v15 << 12) + (unsigned int)(a1 & 0xFFF));
  return result;
}
