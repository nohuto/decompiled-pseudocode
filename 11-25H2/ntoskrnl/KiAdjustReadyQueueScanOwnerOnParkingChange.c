/*
 * XREFs of KiAdjustReadyQueueScanOwnerOnParkingChange @ 0x140313D98
 * Callers:
...
void __fastcall KiAdjustReadyQueueScanOwnerOnParkingChange(__int64 a1, __int64 a2, char *a3)
{
  ...
  if ( v8 )
  {
    if ( v8 == v5 )
    {
      *(_DWORD *)(KiProcessorBlock[*((unsigned int *)qword_140F216A8
  ...
  *(_DWORD *)(v3 + 36432) = 0;
  ...
  v12 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + 64 * *(unsigned __int8 *)(v3 + 208) + (unsigned int)v8)];
  *(_DWORD *)(v12 + 36432) = 1;
  v13 = *(_BYTE *)(v12 + 209);
LABEL_15:
  *(_BYTE *)(v7 + 709) = v13;
