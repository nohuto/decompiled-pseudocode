/*
 * XREFs of MiAllocateLargeProcessPagesFromCache @ 0x14068651C
 * Callers:
...
LABEL_9:
  ...
  v20 = *((_QWORD *)qword_140E2FD48 + Blink_high);
  v75 = v20;
...
LABEL_41:
    ...
    if ( v22 )
    {
      ...
      while ( 1 )
      {
        v57 = (_QWORD *)(48 * MiPopLargePfnList((__int64)v81, 2u) - 0x220000000000LL);
        v58 = (_QWORD *)a6[7];
        if ( (_QWORD *)*v58 != v56 )
          break;
        v57[1] = v58;
