/*
 * XREFs of EtwTraceLeapSecondDataParseFailure @ 0x14079A2C0
 * Callers:
...
void __fastcall EtwTraceLeapSecondDataParseFailure(int a1)
{
  ...
  if ( (unsigned int)dword_140E09048 > 5 && tlgKeywordOn((__int64)&dword_140E09048, 0x400000000000LL) )
  {
    ...
    v2 = v1;
    v6 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09048, (unsigned __int8 *)word_1400518EA, 0LL, 0LL, 3u, &v4);
  }
