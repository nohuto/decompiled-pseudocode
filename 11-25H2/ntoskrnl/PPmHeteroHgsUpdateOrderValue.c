/*
 * XREFs of PPmHeteroHgsUpdateOrderValue @ 0x140268694
 * Callers:
  ...
  if ( (unsigned int)KeIsEmptyAffinityEx(a1) )
  {
    ...
    while ( 1 )
    {
      while ( v15 )
      {
        ...
        v15 &= ~(1LL << v37);
        v38 = *(_QWORD *)(KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v16
                                                                      + (unsigned __int8)v37))
                        + 35408);
        if ( a4 )
        {
...
LABEL_3:
    ...
    while ( 1 )
    {
      if ( v10 )
      {
        ...
        v10 &= ~(1LL << v13);
        v14 = *(_QWORD *)(KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v11
                                                                      + (unsigned __int8)v13))
                        + 35408);
        if ( a4 )
        {
...
LABEL_23:
          ...
          v17 &= ~(1LL << v20);
          Prcb = KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v18 + (unsigned __int8)v20));
          if ( *(_BYTE *)(Prcb + 35404) )
          {
            v5 = 1;
            *(_BYTE *)(Prcb + 35404) = 0;
...
LABEL_34:
          ...
          v23 &= ~(1LL << v28);
          v29 = *(_QWORD *)(KeGetPrcb(*((unsigned int *)qword_140F216A8
...
LABEL_50:
          ...
          v31 &= ~(1LL << v34);
          v35 = *(_QWORD *)(KeGetPrcb(*((unsigned int *)qword_140F216A8
