/*
 * XREFs of PpmHeteroDetectHgsCores @ 0x140483158
 * Callers:
...
LABEL_4:
  ...
  while ( 1 )
  {
    if ( v5 )
    {
      ...
      v5 &= ~(1LL << v9);
      v48 = *((_DWORD *)qword_140F216A8 + 64 * v6 + (unsigned __int8)v9);
      ...
      *((_QWORD *)&v46 + 1) = PpmCheckRegistered.Bitmap[0];
      ...
      while ( !(unsigned int)KeEnumerateNextProcessor(&v48, (unsigned __int16 **)&v46) )
      {
        ...
        *(_BYTE *)(v39 + *(_QWORD *)(a1 + 8)) = *(_BYTE *)(Prcb + 35405) != v8;
        v41 = 0LL;
        for ( i = PpmHeteroCapability; (unsigned int)v41 < *(_DWORD *)(i + 4); v41 = (unsigned int)(v41 + 1) )
        {
  ...
  do
  {
    ...
    while ( 1 )
    {
      while ( v14 )
      {
        ...
        v45 = v14 & ~(1LL << v19);
        v20 = *(_QWORD *)(KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * v17 + (unsigned __int8)v19)) + 35408);
        v21 = v49;
...
LABEL_38:
    ...
    while ( 1 )
    {
      if ( v30 )
      {
        ...
        v50 = v30 & ~(1LL << v33);
        v48 = *((_DWORD *)qword_140F216A8 + 64 * v31 + (unsigned __int8)v33);
        v34 = KeGetPrcb(v48);
        v35 = v48;
