/*
 * XREFs of _CmGetDeviceInterfaceMappedPropertyFromRegValue @ 0x1409565C8
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  __int64 v28; // rdx
  int v29; // eax
  __int64 (__fastcall *v30)(__int64, void *, const WCHAR *, int *, void *, ULONG *, bool *); // rax
  int v31; // eax
  int v32; // edi
  _DWORD *v33; // rax
  __int64 v34; // rax
  ...
  bool v43; // [rsp+D8h] [rbp+58h] BYREF
      ...
      if ( !v23 )
      {
        ...
        *v11 = 17;
        if ( v15 )
        {
          ...
          {
            if ( a1[36] )
              inited = guard_dispatch_icall_no_overrides(a1);
            else
              inited = -1073741822;
          }
          if ( inited >= 0 )
...
LABEL_67:
  ...
  if ( a1 && (v27 = a1[28]) != 0 )
    ...
    v28 = 0LL;
  v29 = RegRtlOpenKeyTransacted((__int64)v26, L"Device Parameters", 0, 1u, &v38, v28);
  if ( v29 == -1073741772 || v29 == -1073741444 )
    goto LABEL_63;
  if ( v29 >= 0 )
  {
    v30 = (__int64 (__fastcall *)(__int64, void *, const WCHAR *, int *, void *, ULONG *, bool *))a1[65];
    v36 = v15;
    if ( !v30 || v30 == PnpRegQueryValueIndirect )
      v31 = PnpRegQueryValueIndirect((__int64)a1, v38, L"FriendlyName", &v37, v14, &v36, &v43);
    else
