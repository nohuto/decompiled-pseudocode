/*
 * XREFs of sub_140BCE96C @ 0x140BCE96C
 * Callers:
...
__int64 __fastcall sub_140BCE96C(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // rax
  __int64 v6; // r13
        ...
        *((_DWORD *)v3 + 631) &= ~0x200000u;
        if ( v198 != *((_QWORD *)v3 + 336) )
        {
          ...
          *(_DWORD *)(v202 + 16) = v203;
          ...
          sub_140BC7384((__int64)v3, 0LL, v198, 256LL);
        }
      }
    }
    return 3221225595LL;
...
LABEL_161:
    ...
    if ( (_DWORD)v116 )
    {
      ...
      else
      {
        ...
        do
        {
          ...
          v120 = v232;
          sub_140516B60((__int64)v21, v232, v121);
          v138 = v242;
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    if ( v215 )
    {
      ...
      {
        v169 = sub_140BC6AF8(v21, v168, *((_DWORD *)v21 + 593));
        if ( !v169 )
          return 3221225626LL;
        v171 = *((_DWORD *)v21 + 630);
        if ( (v171 & 2) == 0 )
      ...
      *(_DWORD *)(v169 + 2120) += v166;
      ...
      {
        if ( (_DWORD)v166 )
          sub_140516AFC(v169, (__int64)v221, v166, v177 + 28);
      }
      *(_DWORD *)(v177 + 24) = 1;
      *(_QWORD *)a1 = v169;
    }
