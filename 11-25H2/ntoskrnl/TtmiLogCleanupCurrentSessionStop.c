/*
 * XREFs of TtmiLogCleanupCurrentSessionStop @ 0x140AA80FC
 * Callers:
...
void TtmiLogCleanupCurrentSessionStop()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v4 = 4;
    v3 = &v1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&unk_14004F3F8, 0LL, 0LL, 3u, &v2);
  }
}
