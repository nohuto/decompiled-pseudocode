/*
 * XREFs of DifKeSynchronizeExecutionWrapper @ 0x140624DF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SynchronizeContext)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = Interrupt;
    *(_QWORD *)&v16 = SynchronizeRoutine;
    *((_QWORD *)&v15 + 1) = SynchronizeContext;
  ...
  LOBYTE(v17) = KeSynchronizeExecution(Interrupt, SynchronizeRoutine, SynchronizeContext);
  if ( v7 )
  {
