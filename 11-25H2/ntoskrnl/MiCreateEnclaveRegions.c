/*
 * XREFs of MiCreateEnclaveRegions @ 0x140C46BFC
 * Callers:
...
__int64 __fastcall MiCreateEnclaveRegions(__int64 a1)
{
  ...
  v1 = 0LL;
  qword_140E372B0 = 0LL;
  stru_140E372B8.Count = 0LL;
  qword_140E372A8 = (__int64)&qword_140E372A0;
  qword_140E372A0 = (__int64)&qword_140E372A0;
  v2 = *(_QWORD *)(a1 + 360);
  if ( (v2 & 1) != 0 )
  {
    if ( v2 == 1 )
...
LABEL_17:
    ...
    v8 = 1;
LABEL_19:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140E37278, (unsigned __int64)v9, v8, v1);
LABEL_20:
