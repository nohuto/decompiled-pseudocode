/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140C03BA8
 * Callers:
 ...
 *     HalpValidateMpns @ 0x1406F838C (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140C03FB8 (HalpSelectFeasibleLowPowerState.c)
 */
