/*
 * XREFs of Amd64AddProfileSource @ 0x1405670A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Amd64GetEventSelectDef @ 0x140567FE0 (Amd64GetEventSelectDef.c)
...
__int64 __fastcall Amd64AddProfileSource(__int64 a1, _DWORD *a2)
{
  ...
  *(_QWORD *)(v15 + 296) = v11;
  ...
  if ( HalpInsertProfileSource(v15, v19, 34, &v23) )
  {
    ...
    if ( a2 )
      *a2 = *(_DWORD *)v15;
    HalpReleaseHighLevelLock((__int64)&HalpProfileSourceDescriptorListLock, v18);
    return 0LL;
  }
  else
  {
