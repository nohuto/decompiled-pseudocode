/*
 * XREFs of MiLogContinueTrim @ 0x1404B99E0
 * Callers:
...
void MiLogContinueTrim()
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 1LL) )
  {
    v5 = *v2;
    ...
    v13 = 4LL;
    v15 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v3, (unsigned __int8 *)word_1400552F2, 0LL, 0LL, v17, &v11);
  }
}
