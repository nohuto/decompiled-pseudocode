/*
 * XREFs of PnpGetServiceStartType @ 0x1409ADE64
 * Callers:
...
__int64 __fastcall PnpGetServiceStartType(__int64 a1, void *a2, _DWORD *a3)
{
  ...
  *a3 = 4;
  if ( (ExpManufacturingInformation & 1) != 0 )
  {
    ...
    v10 = (void *)qword_140E65F50;
    if ( qword_140E65F50 )
    {
      if ( qword_140E65F50 == -1 )
        goto LABEL_2;
    }
    else
    {
