/*
 * XREFs of HalpTscAdvSynchLeader @ 0x140546670
 * Callers:
 *     HalpTscSynchronizationWorker @ 0x140547070 (HalpTscSynchronizationWorker.c)
 * Callees:
 *     HalpTscAdvSynchToLeader @ 0x140488E6C (HalpTscAdvSynchToLeader.c)
 *     HalpFindTimer @ 0x1405448B0 (HalpFindTimer.c)
 *     HalpTscAdvSynchCalculateRemoteDeltas @ 0x140546590 (HalpTscAdvSynchCalculateRemoteDeltas.c)
 *     HalpTscAdvSynchReadTimeStamp @ 0x14054689C (HalpTscAdvSynchReadTimeStamp.c)
 *     HalpTscAdvSynchToTarget @ 0x140546958 (HalpTscAdvSynchToTarget.c)
