/*
 * XREFs of MiPrepareDriverForHotPatch @ 0x1407E5584
 * Callers:
 ...
 *     RtlDetermineHotPatchUndoExtent @ 0x14081F1FC (RtlDetermineHotPatchUndoExtent.c)
 */
...
__int64 __fastcall MiPrepareDriverForHotPatch(__int64 a1)
{
  ...
  if ( v11 )
  {
    ...
    {
      result = MiLockDriverPageRange(v12, v15, v14, 1u, 0LL);
      if ( (int)result < 0 )
        return result;
    }
  }
