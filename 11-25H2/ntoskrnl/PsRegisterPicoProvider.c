/*
 * XREFs of PsRegisterPicoProvider @ 0x14076A090
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140F05390 = *(_OWORD *)(a1 + 16);
  xmmword_140F053A0 = *(_OWORD *)(a1 + 32);
  xmmword_140F053B0 = *(_OWORD *)(a1 + 48);
  xmmword_140F053C0 = *(_OWORD *)(a1 + 64);
  qword_140F053D0 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140F053B0, 8).m128i_u64[0];
