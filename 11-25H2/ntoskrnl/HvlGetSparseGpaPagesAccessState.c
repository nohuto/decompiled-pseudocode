/*
 * XREFs of HvlGetSparseGpaPagesAccessState @ 0x14026CB84
 * Callers:
        ...
        __int64 a6)
{
  ...
  {
    LODWORD(v24) = 4;
    BYTE8(v24) = KeDisableInterrupts(a1, a2, a3);
    HIDWORD(v24) = 1;
  ...
  *HypercallCachedPages = v30;
  ...
  while ( 1 )
  {
    ...
    HIDWORD(v30) = v17;
    v21 = HvcallInitiateHypercall(v30, v26, v16);
    if ( (_WORD)v21 )
      break;
    v22 = WORD2(v21) & 0xFFF;
