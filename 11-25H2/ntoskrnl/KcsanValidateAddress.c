/*
 * XREFs of KcsanValidateAddress @ 0x1405AAC50
 * Callers:
...
struct _KTHREAD *__fastcall KcsanValidateAddress(struct _LIST_ENTRY *a1, __int64 a2, char a3, char a4, __int64 a5)
{
  ...
  {
    v8 = 0LL;
    for ( result = (struct _KTHREAD *)(qword_140FCDC70 + 8);
          v8 < *(_QWORD *)qword_140FCDC70 && (unsigned __int64)a1 >= *(_QWORD *)&result->Header.Lock;
    ...
    *(_QWORD *)&v18[1] = a2;
    ...
    if ( (((_WORD)KcsanThread + 1) & 0x3FF) == 0 )
    {
      ...
      if ( !_interlockedbittestandset(&result->ThreadFlags2, 0) )
      {
        ...
        v16 = (char *)&unk_140E3EB00 + 64 * (unsigned __int64)KeGetCurrentPrcb()->Number;
