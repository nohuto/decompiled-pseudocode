/*
 * XREFs of Amd64RestartProfilingInternal @ 0x140B419BC
 * Callers:
 *     Amd64RestartProfiling @ 0x140B41980 (Amd64RestartProfiling.c)
 * Callees:
 *     Amd64ConfigureCounter @ 0x1405677D8 (Amd64ConfigureCounter.c)
 */
...
LABEL_23:
          result = 0LL;
          __writemsr(*((_DWORD *)&Amd64EventSelectRegisters + (unsigned int)(v10 + v8)), 0LL);
          goto LABEL_24;
        }
