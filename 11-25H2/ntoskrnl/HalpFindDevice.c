/*
 * XREFs of HalpFindDevice @ 0x140B65770
 * Callers:
 *     HalpKdReleaseDebuggingDevice @ 0x140B65A20 (HalpKdReleaseDebuggingDevice.c)
 *     HalpKdSetupDebuggingDevice @ 0x140B65A80 (HalpKdSetupDebuggingDevice.c)
...
__int64 *__fastcall HalpFindDevice(__int64 a1)
{
  ...
  v1 = (__int64 *)qword_140F8E5E8;
  v2 = 0LL;
  v3 = 0LL;
  v4 = 0;
  while ( v1 != &qword_140F8E5E8 )
  {
    v6 = v1[2];
    v3 = v1;
    v7 = *(_DWORD *)(a1 + 220);
