/*
 * XREFs of sub_140BC9550 @ 0x140BC9550
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall sub_140BC9550(__int64 a1, __int64 a2, __int64 a3)
{
    ...
    *(_DWORD *)(a3 + 2328) = 1;
    if ( (v5 & 0x20000000) == 0 && (*(_DWORD *)(a3 + 2524) & 0x200000) != 0 && (v5 & 1) != 0 )
    {
      ...
      while ( v8 != v10 )
      {
        *v8 ^= v9;
        result = v7 ^ *v8;
        v9 = (result + __ROR8__(v9, v9 & 0x3F)) ^ 0xEFA;
        ++v8;
      }
      *(_DWORD *)(a3 + 2524) &= ~0x200000u;
      if ( v9 != *(_QWORD *)(a3 + 2688) )
      {
        ...
        *(_DWORD *)(v12 + 16) = v11;
        ...
        return sub_140BC7384(a3, 0LL, v9, 256LL);
      }
    }
  }
  return result;
