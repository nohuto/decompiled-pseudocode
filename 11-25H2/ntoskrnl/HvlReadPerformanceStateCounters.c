/*
 * XREFs of HvlReadPerformanceStateCounters @ 0x140448160
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_5:
        _mm_lfence();
        v6 = *((_QWORD *)v5 + 3);
        v7 = *((unsigned int *)&xmmword_140E3EA90 + 2 * v4 + 7);
        *a3 = *(_QWORD *)(v6 + 8LL * *((unsigned int *)&xmmword_140E3EA90 + 2 * v4 + 6));
        *a4 = *(_QWORD *)(v6 + 8 * v7);
        return;
      }
    }
