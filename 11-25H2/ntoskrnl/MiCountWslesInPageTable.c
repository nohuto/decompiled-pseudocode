/*
 * XREFs of MiCountWslesInPageTable @ 0x140385BC0
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( ((v8 >> 9) & 0x7FFFFFFFF8LL) == 0x7B7DBEDF68LL )
  {
    MiCountWslesInPageTableRange(
      a1,
      8 * (((unsigned __int64)qword_140E2F040 >> 39) & 0x1FF) + 2109657088,
      ((__int64)(8 * (((unsigned __int64)qword_140E2F050 >> 39) & 0x1FF)
               - 8 * (((unsigned __int64)qword_140E2F040 >> 39) & 0x1FF)) >> 3)
    + 1,
      v5,
      a4);
    v6 = 256;
