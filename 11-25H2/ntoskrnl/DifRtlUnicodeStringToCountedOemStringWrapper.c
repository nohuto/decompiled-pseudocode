/*
 * XREFs of DifRtlUnicodeStringToCountedOemStringWrapper @ 0x14062E780
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v17) = RtlUnicodeStringToCountedOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
