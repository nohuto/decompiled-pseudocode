/*
 * XREFs of PoFxRegisterDebugger @ 0x140C21F30
 * Callers:
...
void PoFxRegisterDebugger()
{
  ...
  __int64 DestinationString; // [rsp+58h] [rbp-B0h]
  ...
  if ( (unsigned int)guard_dispatch_icall_no_overrides(33LL) == -2147483643 )
  {
    Pool2 = (_DWORD *)ExAllocatePool2(0x40uLL, 0LL, 0x4D584650uLL);
    if ( Pool2 )
    {
      if ( (int)guard_dispatch_icall_no_overrides(33LL) >= 0 )
      {
        v2 = 0;
        v3 = Pool2 + 1;
        v4 = 0;
...
LABEL_13:
              ...
              v10 = *(_DWORD *)(BugCheckParameter2 + 864) | 2;
              DestinationString = 0LL;
              *(_DWORD *)(BugCheckParameter2 + 864) = v10;
              if ( *(_QWORD *)(v9 + 64) )
              {
                DestinationString = *(_QWORD *)(v9 + 72);
                guard_dispatch_icall_no_overrides(21LL);
              }
          ...
          if ( KeGetCurrentPrcb()->CpuVendor == 2 )
          {
            ...
            v7 = (wchar_t *)ExAllocatePool2(0x40uLL, v6, 0x4D584650uLL);
            v0 = v7;
            if ( !v7 )
              goto LABEL_18;
