/*
 * XREFs of CmpDoFileRead @ 0x140478FE0
 * Callers:
 *     CmpFileRead @ 0x140A51870 (CmpFileRead.c)
 * Callees:
    ...
    while ( a5 )
    {
      ...
      if ( Status >= 0 || v9 <= 0x10000 )
      {
        ...
        if ( Status < 0 )
        {
          ...
          CmRegistryIODebug = 1;
          qword_140FD8F00 = (__int64)FileHandle;
          dword_140FD8F08 = Status;
          goto LABEL_17;
        }
        if ( IoStatusBlock.Information != Length )
        {
          ...
          CmRegistryIODebug = 1;
          dword_140FD8F08 = Information - Length;
          result = 3221225489LL;
          qword_140FD8F00 = (__int64)FileHandle;
          return result;
        }
