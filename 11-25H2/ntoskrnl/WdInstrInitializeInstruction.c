/*
 * XREFs of WdInstrInitializeInstruction @ 0x1405699F4
 * Callers:
 *     HalpWdatExecuteActionBeforeInitialize @ 0x14055CCC8 (HalpWdatExecuteActionBeforeInitialize.c)
 *     HalpWdatInitializeWdat @ 0x14055CEA8 (HalpWdatInitializeWdat.c)
 *     HalpWdatInitializeWdrt @ 0x14055CF3C (HalpWdatInitializeWdrt.c)
 * Callees:
