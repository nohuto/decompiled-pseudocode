/*
 * XREFs of PopPowerButtonSuppressionInit @ 0x140C1F5E0
 * Callers:
...
__int64 PopPowerButtonSuppressionInit()
{
  ...
  if ( PopPlatformAoAcCapabilityInitialized && PopPlatformAoAc )
  {
    ...
    if ( (int)ExSubscribeWnfStateChange((__int64)&qword_140F07D70, (__int64)&WNF_PO_INPUT_SUPPRESS_NOTIFICATION_EX) < 0 )
    {
      qword_140F07D70 = 0LL;
      v5 |= 0x10u;
      PopPowerButtonSuppression = 0;
