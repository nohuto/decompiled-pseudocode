/*
 * XREFs of PnpNotifyDriverCallback @ 0x14096D2C0
 * Callers:
 ...
 *     PnpExtractNotificationSpecificData @ 0x140714520 (PnpExtractNotificationSpecificData.c)
 */
...
__int64 __fastcall PnpNotifyDriverCallback(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  v9 = guard_dispatch_icall_no_overrides(a2);
  ...
  if ( (v10 - v7) / 10000 > (unsigned __int16)PiNotifyLongRunningMs && (byte_140EEFA6C & 2) != 0 )
  {
    v23 = 0LL;
    v22 = 0LL;
    v20 = 0LL;
