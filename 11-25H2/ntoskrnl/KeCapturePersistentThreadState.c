/*
 * XREFs of KeCapturePersistentThreadState @ 0x1402AA100
 * Callers:
 ...
 *     IopValidateSectionSize @ 0x1404D9174 (IopValidateSectionSize.c)
        ...
        size_t Size)
{
  ...
  if ( ForceDumpDisabled || !AllowCrashDump || byte_140E65E04 && SecureDmpEncryptionContext == 2 )
    return 0LL;
