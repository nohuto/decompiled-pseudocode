/*
 * XREFs of CmpAddDriverToList @ 0x140C3996C
 * Callers:
        ...
        char a7)
{
  ...
  __int16 v55; // [rsp+E8h] [rbp+4Fh] BYREF
  ...
  if ( RtlInitUnicodeStringEx(&DestinationString, NodeName) < 0
    || (v17 = (char *)guard_dispatch_icall_no_overrides(144LL), (v11 = v17) == 0LL) )
  {
  ...
  *((_WORD *)v11 + 61) = v18;
  ...
  if ( ValueByName == -1 )
  {
    ...
    Destination.Buffer = (wchar_t *)guard_dispatch_icall_no_overrides(v22);
  ...
  else
  {
    ...
    v29 = (wchar_t *)guard_dispatch_icall_no_overrides((unsigned int)Size);
  ...
  v53.Buffer = (wchar_t *)guard_dispatch_icall_no_overrides(v53.MaximumLength);
  if ( !v53.Buffer
...
LABEL_14:
  if ( Destination.Buffer )
    guard_dispatch_icall_no_overrides(Destination.Buffer);
  if ( v53.Buffer )
    guard_dispatch_icall_no_overrides(v53.Buffer);
  if ( v10 )
  {
    v23 = *((_QWORD *)v10 + 3);
    if ( v23 )
