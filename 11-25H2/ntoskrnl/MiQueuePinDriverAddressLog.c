/*
 * XREFs of MiQueuePinDriverAddressLog @ 0x1402ABB78
 * Callers:
...
void __fastcall MiQueuePinDriverAddressLog(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v8 = -1;
  if ( (word_140EF4912 & 1) == 0 )
  {
LABEL_20:
    v18 = (char *)&unk_140EF48B8;
    if ( !(_BYTE)KdDebuggerEnabled )
      v18 = (char *)&unk_140EF48B0;
...
LABEL_17:
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    v24 = ((unsigned __int64)a2 >> 12) & 0xFFFFFFFFFFLL;
