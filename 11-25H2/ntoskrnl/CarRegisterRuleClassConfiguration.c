/*
 * XREFs of CarRegisterRuleClassConfiguration @ 0x14060AF80
 * Callers:
 *     CarRegisterDefaultRuleClassConfiguration @ 0x14060AF30 (CarRegisterDefaultRuleClassConfiguration.c)
 * Callees:
...
__int64 __fastcall CarRegisterRuleClassConfiguration(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *((_QWORD *)v4 + 9) = v4 + 72;
      v5 = v4 + 88;
      v6 = (_QWORD *)qword_140F035E8;
      if ( *(__int64 **)qword_140F035E8 != &CarConfigurationEntries )
        __fastfail(3u);
      *v5 = &CarConfigurationEntries;
      *((_QWORD *)v4 + 12) = v6;
      *v6 = v5;
      qword_140F035E8 = (__int64)(v4 + 88);
    }
    else
    {
