/*
 * XREFs of CmEnumerateValueKeyFromMergedView @ 0x140A639DC
 * Callers:
...
LABEL_51:
                if ( v68 )
                {
                  ...
                  if ( (*(_BYTE *)(*v22 + 140) & 1) != 0 )
                    HvpReleaseCellFlat(v47, &v62);
                  else
                    HvpReleaseCellPaged(v47, (unsigned int *)&v62);
                }
                if ( v69 )
                {
                  v48 = *(_QWORD *)i;
                  if ( (*(_BYTE *)(*(_QWORD *)i + 140LL) & 1) != 0 )
                    HvpReleaseCellFlat(v48, &v63);
                  else
                    HvpReleaseCellPaged(v48, (unsigned int *)&v63);
                }
                goto LABEL_53;
              }
            ...
            for ( i = *(_QWORD *)v60 + 32LL; ; i = v70 )
            {
              ...
              if ( !v14 )
              {
                v35 = *v22;
                v36 = v67[1];
                v37 = (*(_BYTE *)(*v22 + 140) & 1) != 0
                    ? HvpGetCellFlat(v35, v36, &v57)
                    : HvpGetCellPaged(v35, v36, &v57);
                v56 = v37;
                v14 = v37;
                if ( !v37 )
                {
...
LABEL_96:
              ...
              if ( v56 )
              {
                v34 = *v22;
                if ( (*(_BYTE *)(*v22 + 140) & 1) != 0 )
                  HvpReleaseCellFlat(v34, &v57);
                else
                  HvpReleaseCellPaged(v34, (unsigned int *)&v57);
                v14 = 0LL;
                v56 = 0LL;
              }
            }
...
LABEL_48:
            if ( v14 )
            {
              v45 = *v22;
              if ( (*(_BYTE *)(*v22 + 140) & 1) != 0 )
                HvpReleaseCellFlat(v45, &v57);
              else
                HvpReleaseCellPaged(v45, (unsigned int *)&v57);
            }
            if ( v23 )
            {
              v46 = *(_QWORD *)i;
              if ( (*(_BYTE *)(*(_QWORD *)i + 140LL) & 1) != 0 )
                HvpReleaseCellFlat(v46, &v61);
              else
                HvpReleaseCellPaged(v46, (unsigned int *)&v61);
            }
LABEL_50:
            v18 = *(_QWORD *)v60;
            v17 = v58;
