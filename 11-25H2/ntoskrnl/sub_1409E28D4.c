/*
 * XREFs of sub_1409E28D4 @ 0x1409E28D4
 * Callers:
...
__int64 __fastcall sub_1409E28D4(int *a1, __int64 a2, __int64 a3)
{
  int v5; // r8d
  ...
  *(_DWORD *)(a3 + 52) = a1[1];
  v11 = (void **)(a3 + 56);
  v8 = sub_1409E2BE8(v10, a3 + 56);
  if ( v8 >= 0 )
  {
    memmove(*v11, *(const void **)(a2 + 8), 0LL);
    v8 = sub_1409E1F40(*(PVOID *)(a2 + 8), 0, 1);
    if ( v8 >= 0 )
    {
      v8 = sub_140907180((UCHAR *)*v11, 0);
      if ( v8 >= 0 )
      {
