/*
 * XREFs of CcScheduleReadAheadNuma @ 0x140499150
 * Callers:
 *     CcAsyncCopyRead @ 0x1403AAC00 (CcAsyncCopyRead.c)
 *     CcAsyncReadPrefetch @ 0x1404627C8 (CcAsyncReadPrefetch.c)
 *     CcScheduleReadAheadEx @ 0x140499130 (CcScheduleReadAheadEx.c)
 *     CcCopyReadEx @ 0x1404DC880 (CcCopyReadEx.c)
 *     CcScheduleReadAhead @ 0x1405783C0 (CcScheduleReadAhead.c)
 * Callees:
        ...
        __int64 a5)
{
  ...
  _SLIST_ENTRY *v46; // [rsp+58h] [rbp-70h]
...
LABEL_60:
    ...
    if ( (v23 & 0x100000) == 0 )
    {
      if ( *((_DWORD *)v50 + 1) == *((_DWORD *)&Next[2].Next + 3) )
      {
      ...
      if ( *v50 - (unsigned __int64)Next[2].Next == v26 )
      {
        v19 = 3;
        v31 = v51;
        v45 = 2LL * *v50 - (unsigned __int64)Next[2].Next;
        if ( v45 < 0 )
          goto LABEL_61;
        v35 = v45;
...
LABEL_49:
        ...
        if ( ((__int64)Next->Next & 0x10000) == 0 )
        {
          ...
          if ( (int)CcAllocateWorkQueueEntry(v43, v46, v6, (PSLIST_ENTRY *)&v44) >= 0 )
          {
            ...
            *(_DWORD *)(v12 + 152) |= 0x4000u;
            ...
            v39 = (PSLIST_ENTRY)v44;
            Next[7].Next = (_SLIST_ENTRY *)v44;
            ...
            *((_QWORD *)&v39[1].Next + 1) = 0LL;
            ...
            CcPostWorkQueue((__int64)v39, v6 + 88);
            return;
          }
          v40 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&Next[5]);
          LODWORD(Next->Next) &= ~0x10000u;
          v41 = (KSPIN_LOCK *)&Next[5];
          v42 = v40;
LABEL_64:
