/*
 * XREFs of PiUEventMovePendingEventToSynchronousQueue @ 0x140718B54
 * Callers:
...
__int64 __fastcall PiUEventMovePendingEventToSynchronousQueue(__int64 a1, __int64 *a2)
{
  ...
  __int64 result; // rax
  __int64 **v9; // rcx
  const WCHAR *v10; // [rsp+80h] [rbp+37h] BYREF
  ...
  *(_QWORD *)(v3 + 8) = v5;
  ...
  if ( (byte_140EEFA6D & 1) != 0 )
  {
    ...
    {
      PiUEventGatherEventData(a2[3], &v10, (__int64)&v13, (__int64)&v12);
      PiUEventGetProcessImagePath(*(void **)(a1 + 48), &v11);
      if ( (byte_140EEFA6D & 1) != 0 )
