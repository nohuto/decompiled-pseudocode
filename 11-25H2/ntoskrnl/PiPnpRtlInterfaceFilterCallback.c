/*
 * XREFs of PiPnpRtlInterfaceFilterCallback @ 0x1408CE630
 * Callers:
...
__int64 __fastcall PiPnpRtlInterfaceFilterCallback(__int64 a1, const WCHAR *a2, unsigned int a3, __int64 a4)
{
  ...
  __int64 v14; // r13
  __int64 (__fastcall *v15)(PVOID, const WCHAR *, int, int, int, __int64); // rax
  int v16; // eax
  ...
  __int64 (__fastcall *v25)(PVOID, const WCHAR *, int, int, int, __int64); // [rsp+70h] [rbp-90h]
  ...
  if ( *(_QWORD *)a4 )
  {
    ...
    v30 = &v23;
    v31 = &v35;
    v15 = *(__int64 (__fastcall **)(PVOID, const WCHAR *, int, int, int, __int64))(*(_QWORD *)&PiPnpRtlCtx + 488LL);
    v33 = &v24;
    *(_QWORD *)&DestinationString.Length = *(_QWORD *)&PiPnpRtlCtx;
    ...
    if ( v15 )
    {
      ...
      {
        v16 = PiPnpRtlObjectActionCallback(*(PVOID *)&PiPnpRtlCtx, a2, 3, 8, 1, (__int64)v27);
      }
      else
      {
        v22 = v27;
        v21 = 1;
        v16 = guard_dispatch_icall_no_overrides(*(_QWORD *)&PiPnpRtlCtx);
      }
      if ( v16 == -1073741822 )
      {
        v25 = 0LL;
    ...
    if ( v25 )
    {
      ...
      {
        v19 = PiPnpRtlObjectActionCallback(*(PVOID *)&DestinationString.Length, a2, 3, 8, 2, (__int64)v27);
      }
      else
      {
        v22 = v27;
        v21 = 2;
        v19 = guard_dispatch_icall_no_overrides(*(_QWORD *)&DestinationString.Length);
      }
      if ( v19 != -1073741822 )
      {
        if ( v19 == -1073741536 )
