/*
 * XREFs of KdpSearchPhysicalPageRange @ 0x140B682F4
 * Callers:
 *     KdpSysCheckLowMemory @ 0x140B684F0 (KdpSysCheckLowMemory.c)
 * Callees:
 *     KdpSearchPhysicalPage @ 0x140B680E8 (KdpSearchPhysicalPage.c)
 */
