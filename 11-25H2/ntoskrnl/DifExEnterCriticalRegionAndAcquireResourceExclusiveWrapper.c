/*
 * XREFs of DifExEnterCriticalRegionAndAcquireResourceExclusiveWrapper @ 0x140611D20
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifExEnterCriticalRegionAndAcquireResourceExclusiveWrapper(PERESOURCE Resource)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(406);
  ...
  v12 = ExEnterCriticalRegionAndAcquireResourceExclusive(Resource);
  if ( v3 )
  {
