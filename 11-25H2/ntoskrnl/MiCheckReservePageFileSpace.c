/*
 * XREFs of MiCheckReservePageFileSpace @ 0x1402480F0
 * Callers:
...
char __fastcall MiCheckReservePageFileSpace(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  if ( (_BYTE)v5 != 4 )
  {
    ...
    if ( (v6 & 1) == 0 )
    {
      if ( !v6 || (LOBYTE(v5) = qword_140E2D940, !qword_140E2D940) || (qword_140E2D940 & v6) != 0 )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          if ( (v6 & 2) == 0 )
          {
            if ( (*(_DWORD *)(a3 + 184) & 0xF) != 0
              || ((*(_DWORD *)(a3 + 184) & 0xF) != 1 ? (v8 = (__int64 *)(a3 + 216)) : (v8 = (__int64 *)&unk_140E38518),
                  (v5 = *v8) == 0) )
            {
