/*
 * XREFs of SepMandatoryIntegrityCheck @ 0x140296910
 * Callers:
        ...
        __int64 a6)
{
  ...
  unsigned __int16 v42; // [rsp+30h] [rbp-58h]
...
LABEL_5:
    if ( a5 )
    {
      ...
      v15 = v14[13];
      if ( (v15 & 0x41) == 1 )
        KeBugCheckEx(0x1C6u, 0xFuLL, (ULONG_PTR)v14, 0LL, 0LL);
      if ( (v15 & 1) != 0 )
      {
        ...
        if ( !CurrentIrql && (v41->MiscFlags & 0x400) == 0 && !v41->WaitBlock[3].SpareLong )
          KeBugCheckEx(0x1C6u, 7uLL, 0LL, 0LL, 0LL);
        P = (PVOID)ExpAllocateOwnerEntryForLegacyShim();
        if ( !ExAcquireFastResourceShared(v14, (ULONG_PTR)P, 1) || ExIsFastResourceHeldExclusive((ULONG_PTR)v14) )
...
LABEL_35:
        ...
        if ( _bittest64((const signed __int64 *)(v45 + 72), 0x20u) )
          v10 |= 0x80000u;
        goto LABEL_27;
      }
    }
