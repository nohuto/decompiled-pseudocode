/*
 * XREFs of PerfInfoLogIpiSend @ 0x1404AC520
 * Callers:
...
int __fastcall PerfInfoLogIpiSend(__int64 a1, int a2, __int64 a3, int a4, unsigned __int16 *a5)
{
  ...
  {
    v8 &= v8 - 1;
    v7 = EtwpHostSiloState + 32LL * (unsigned int)v11 + 4284;
    if ( v7 )
    {
      if ( (*(_DWORD *)(v7 + 8) & 0x400000) != 0 )
      {
        v9 = *(unsigned __int8 *)(EtwpHostSiloState + 2 * v11 + 4233);
        v19 = 0;
        v18 = 8;
        v17 = a1 + 8 * (v9 - 1);
        LODWORD(v7) = EtwpLogKernelEvent(
                        (struct _KTHREAD *)&v17,
                        EtwpHostSiloState,
                        *(unsigned __int8 *)(EtwpHostSiloState + 2LL * (unsigned int)v11 + 4232),
                        3u,
                        0xF70u,
                        0x501A02u);
      }
