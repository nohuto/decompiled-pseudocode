/*
 * XREFs of KiPerformExplicitGroupAssignment @ 0x140C17ADC
 * Callers:
...
char __fastcall KiPerformExplicitGroupAssignment(_DWORD *a1, int a2)
{
  ...
  __int64 v20; // rdx
  _BYTE *v21; // rcx
  _DWORD v23[32]; // [rsp+30h] [rbp-A8h] BYREF
  ...
  {
    --v2;
    if ( (unsigned int)KiQueryProximityNode((unsigned int)v3[1]) )
      return 0;
    v3 += 2;
    ...
    if ( KiSubNodeCount )
    {
      ...
      do
      {
        if ( !*(_WORD *)(KeNodeBlock[*(unsigned __int16 *)(v8 - 3)] + 2) )
        {
          v9 = *(_WORD *)v3;
          *(_BYTE *)v8 |= 1u;
          *(_WORD *)(v8 + 1) = v9;
