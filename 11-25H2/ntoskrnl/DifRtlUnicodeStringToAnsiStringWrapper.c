/*
 * XREFs of DifRtlUnicodeStringToAnsiStringWrapper @ 0x14062E600
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v17) = RtlUnicodeStringToAnsiString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
