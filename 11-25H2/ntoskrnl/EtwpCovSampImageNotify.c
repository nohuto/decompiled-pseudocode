/*
 * XREFs of EtwpCovSampImageNotify @ 0x14090C0A0
 * Callers:
 ...
 *     EtwpCovSampEnumerateDriver @ 0x140A9DA40 (EtwpCovSampEnumerateDriver.c)
 * Callees:
