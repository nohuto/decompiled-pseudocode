/*
 * XREFs of RtlScrubMemory @ 0x1403F1124
 * Callers:
 *     MiScrubPage @ 0x1403F0F94 (MiScrubPage.c)
 * Callees:
 *     RtlpGenericMATSPlusWorker @ 0x1403F1260 (RtlpGenericMATSPlusWorker.c)
 *     RtlpGenericInverseCouplingWorker @ 0x1403F1370 (RtlpGenericInverseCouplingWorker.c)
 *     RtlpGenericStrideWorker @ 0x1403F1690 (RtlpGenericStrideWorker.c)
 *     RtlpGenericRandomPatternWorker @ 0x1403F1910 (RtlpGenericRandomPatternWorker.c)
