/*
 * XREFs of DifExAllocatePoolWithTagPriorityWrapper @ 0x140610A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExAllocatePoolWithTagPriorityWrapper(
        unsigned int a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a8)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(415);
