/*
 * XREFs of LdrpVerifyAlternateResourceModuleEx @ 0x1405DBC64
 * Callers:
...
char __fastcall LdrpVerifyAlternateResourceModuleEx(__int64 a1, __int64 a2, __int64 a3, const wchar_t *a4, int a5)
{
  ...
  if ( (a5 & 0x1000) != 0 )
  {
    RCConfig = LdrResGetRCConfig(a1, 0, (unsigned int)&v14, 4096, 1);
    if ( RCConfig < 0 )
    {
  ...
  v12 = *(_QWORD *)(v9 + 11) - *(_QWORD *)(v10 + 11);
  if ( !v12 )
    v12 = *(_QWORD *)(v9 + 13) - *(_QWORD *)(v10 + 13);
  if ( v12 )
    return 0;
  if ( (a5 & 0x1000000) != 0 )
    return 1;
  if ( !a4 )
    return 0;
  return wcsicmp(a4, (const wchar_t *)((char *)v10 + (unsigned int)v10[29])) == 0;
}
