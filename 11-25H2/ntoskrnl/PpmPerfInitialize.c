/*
 * XREFs of PpmPerfInitialize @ 0x140C1D610
 * Callers:
...
__int64 PpmPerfInitialize()
{
  ...
  qword_140FC5BB0 = (__int64)&PpmPerfDomainHead;
  v0 = 2LL;
  ...
  stru_140F0CCB0.Parameter = 0LL;
  stru_140F0CCB0.List.Flink = 0LL;
  ...
  stru_140F0CCB0.WorkerRoutine = (void (__fastcall *)(void *))PpmMediaBufferingWorker;
