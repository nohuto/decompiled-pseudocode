/*
 * XREFs of KsepDsEventPnpStopDevice @ 0x1405C749C
 * Callers:
 *     KseDsCompletionHookForStopDevice @ 0x1405C6810 (KseDsCompletionHookForStopDevice.c)
 * Callees:
...
char __fastcall KsepDsEventPnpStopDevice(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v13 = &v20;
      v14 = 4;
      LOBYTE(v4) = EtwWriteEx(KseEtwHandle, &KseDsEventStopDevice, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
