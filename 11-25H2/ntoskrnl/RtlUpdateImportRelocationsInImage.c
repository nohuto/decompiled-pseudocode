        ...
        char a8)
{
  ...
  if ( a7 )
  {
    if ( !DWORD1(v26) )
      return 0;
    *(_QWORD *)&v28 = a2;
    *((_QWORD *)&v27 + 1) = a1 + DWORD1(v26);
    *((_QWORD *)&v28 + 1) = a4;
  }
  else
  {
    v14 = RtlCaptureRetpolineImportRvas(a1, a2, v8, a4, 0LL, &v23);
    v13 = v14;
    if ( v14 >= 0 )
    ...
    v13 = RtlCaptureRetpolineImportRvas(a1, a2, v8, a4, Pool2, &v23);
    if ( v13 < 0 )
    {
LABEL_28:
  ...
  v13 = RtlpCaptureDynamicRelocationTableRva(a1, v8, &v24);
  if ( v13 >= 0 )
  {
    v15 = a1 + (unsigned int)v24 + 8LL;
    v16 = v15 + *(unsigned int *)((unsigned int)v24 + a1 + 4);
    if ( *(_DWORD *)((unsigned int)v24 + a1) == 1 )
    {
      while ( v15 < v16 )
      {
        if ( *(_QWORD *)v15 == 3LL )
        {
          v17 = v15 + 12;
          v18 = v15 + 12 + *(unsigned int *)(v15 + 8);
          v24 = v18;
          if ( v15 + 12 < v18 )
          {
            do
            {
              v19 = v17 + *(unsigned int *)(v17 + 4);
              ...
              if ( v17 + 8 < v19 )
              {
                do
                {
                  if ( (*v20 & 0xFFF) == 0 && v20 != (unsigned int *)(v17 + 8) )
                    break;
                  RtlApplyImportRelocationToImage(a1, a3, (__int64)&v26, a6, *(_DWORD *)v17, v20++, v22, a8);
                }
