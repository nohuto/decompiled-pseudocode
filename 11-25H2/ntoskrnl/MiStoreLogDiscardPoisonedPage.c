/*
 * XREFs of MiStoreLogDiscardPoisonedPage @ 0x140680C30
 * Callers:
...
void __fastcall MiStoreLogDiscardPoisonedPage(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000002LL) )
  {
    v21 = 0;
    v24 = 0;
    v27 = 0;
    ...
    v16 = a3;
    v17 = 0x1000000LL;
    tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&byte_140056A75, v6, 1u, v10, v11, 8u, &v18);
  }
}
