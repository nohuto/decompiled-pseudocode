/*
 * XREFs of IommuMapLogicalRangeEx @ 0x14026DCF0
 * Callers:
 *     <none>
 * Callees:
 *     HalpIommuDomainFreeLogicalAddressRange @ 0x14026D92C (HalpIommuDomainFreeLogicalAddressRange.c)
 *     HalpIommuDomainMapLogical @ 0x14026DEDC (HalpIommuDomainMapLogical.c)
        ...
        ULONG_PTR *a7)
{
  ...
  __int64 (__fastcall ***v15)(_DWORD, _DWORD, _DWORD, _DWORD, __int64, __int64); // r10
  ULONG_PTR v16; // rax
  int LogicalAddress; // eax
  unsigned int v18; // edi
  int v19; // eax
  __int64 v21; // rcx
  ULONG_PTR v22; // [rsp+70h] [rbp+8h] BYREF
  ...
  if ( !v14 )
    return (unsigned int)-1073741583;
  v15 = *(__int64 (__fastcall ****)(_DWORD, _DWORD, _DWORD, _DWORD, __int64, __int64))(a1 + 64);
  if ( !v15 )
  {
    if ( !v10 )
