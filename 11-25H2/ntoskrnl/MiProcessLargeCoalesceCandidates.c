/*
 * XREFs of MiProcessLargeCoalesceCandidates @ 0x14034F1EC
 * Callers:
 ...
 *     MiCheckLargePagesExist @ 0x14034FF40 (MiCheckLargePagesExist.c)
...
__int64 __fastcall MiProcessLargeCoalesceCandidates(_QWORD *a1, unsigned int a2, unsigned int *a3)
{
  ...
  char CurrentIrql; // [rsp+90h] [rbp-88h]
  unsigned __int64 v67; // [rsp+98h] [rbp-80h]
...
LABEL_44:
              ...
              v51 = MiProcessLargeCoalesceBitmapCandidates((_DWORD)a1, v46, a2, v45, v48, v11, CurrentIrql, v3);
              v14 = v51;
              if ( v3 )
              {
                if ( v51 == -1073741267 )
    ...
    *(_DWORD *)(*(_QWORD *)(v3 + 32) + 4 * v6) = *(_DWORD *)(v3 + 12);
    ...
    else
    {
      v55 = MiProcessLargeCoalesceBitmapCandidates(
              ...
              a2,
              (int)v58 + (int)v11 * (int)v10 * (int)v54,
