/*
 * XREFs of IommuEnableDevicePasid @ 0x140561280
 * Callers:
...
__int64 __fastcall IommuEnableDevicePasid(__int64 a1, __int64 a2)
{
  ...
  if ( v15 )
  {
    ...
    v11 = guard_dispatch_icall_no_overrides(*(_QWORD *)(v6 + 16));
    if ( v11 < 0 )
      goto LABEL_3;
    guard_dispatch_icall_no_overrides(*(_QWORD *)(v6 + 16));
  }
  else
  {
    v11 = guard_dispatch_icall_no_overrides(*(_QWORD *)(v2 + 40));
    if ( v11 < 0 )
      goto LABEL_3;
  }
