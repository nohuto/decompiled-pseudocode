/*
 * XREFs of KeQuerySpeculationControlInformation @ 0x140AC0980
 * Callers:
 ...
 *     HvlQueryL1tfMitigationInformation @ 0x1404A9FC8 (HvlQueryL1tfMitigationInformation.c)
 *     SpcIsFbClearSupported @ 0x14069569C (SpcIsFbClearSupported.c)
