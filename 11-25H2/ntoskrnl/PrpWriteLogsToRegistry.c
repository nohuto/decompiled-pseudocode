/*
 * XREFs of PrpWriteLogsToRegistry @ 0x1404C1DC4
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, &xmmword_140EF74B0, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, (char *)&xmmword_140EF74B0 + 4, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, (char *)&xmmword_140EF74B0 + 8, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, (char *)&xmmword_140EF74B0 + 12, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, &qword_140EF74C0, 1u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, (char *)&qword_140EF74C0 + 4, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 4u, &dword_140EF74C8, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 3u, (char *)&xmmword_140EF74B0 + 8, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
    ...
    ZwSetValueKey(KeyHandle, &DestinationString, 0, 3u, (char *)&xmmword_140EF74B0 + 4, 4u);
    *(_QWORD *)&DestinationString.Length = 0LL;
