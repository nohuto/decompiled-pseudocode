/*
 * XREFs of MiComputeMemoryNodeProcessorAssignments @ 0x140C471C0
 * Callers:
...
__int64 MiComputeMemoryNodeProcessorAssignments()
{
  ...
  for ( i = 0; ; v0 = i < v24 )
  {
    ...
    LOWORD(v33) = 0;
    LOWORD(Count) = 0;
    v4 = *(_QWORD *)(384LL * i + qword_140E2D8B8 + 376);
...
LABEL_26:
  ...
  dword_140E2D8A0 = v2;
  qword_140E2D898 = (void *)MiAllocatePool(0x40uLL, 16LL * (unsigned __int16)word_140E2D8A8, 1632069965);
  if ( !qword_140E2D898 )
  ...
  if ( KeNumberNodes )
  {
    ...
    do
    {
      v28 = *(_QWORD *)(v26 + qword_140E2D8B8 + 376);
      memmove((char *)qword_140E2D898 + 16 * v25, *(const void **)v28, 16LL * *(unsigned __int16 *)(v28 + 16));
      v26 += 384LL;
