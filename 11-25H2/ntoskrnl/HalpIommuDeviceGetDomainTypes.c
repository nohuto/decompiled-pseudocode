/*
 * XREFs of HalpIommuDeviceGetDomainTypes @ 0x14054B4C8
 * Callers:
 *     HalpIommuInvokeInterfaceStateChangeCallbacks @ 0x1404D0120 (HalpIommuInvokeInterfaceStateChangeCallbacks.c)
 *     IommuDeviceQueryDomainTypes @ 0x140563B00 (IommuDeviceQueryDomainTypes.c)
...
__int64 __fastcall HalpIommuDeviceGetDomainTypes(__int64 a1)
{
  ...
  if ( *v6 == 1 && (int)guard_dispatch_icall_no_overrides(v6) >= 0 )
  {
    if ( !v5 )
    {
      if ( (v12 & 0x10) != 0 )
