/*
 * XREFs of PspInitializeSiloStructures @ 0x140C246E8
 * Callers:
 ...
 *     PspSiloInitializeSharedUserSessionId @ 0x140763918 (PspSiloInitializeSharedUserSessionId.c)
...
LABEL_6:
  ...
  qword_140FD9080 = (__int64)&PspSiloMonitorList;
...
LABEL_13:
  ...
  if ( (int)PspAllocStorage(&qword_140FCEEB0) < 0 )
  {
