/*
 * XREFs of DifIoCreateSymbolicLinkWrapper @ 0x14061B6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoCreateSymbolicLinkWrapper(PUNICODE_STRING SymbolicLinkName, PUNICODE_STRING DeviceName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(350);
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = SymbolicLinkName;
    *((_QWORD *)&v13 + 1) = DeviceName;
  ...
  DWORD2(v14) = IoCreateSymbolicLink(SymbolicLinkName, DeviceName);
  if ( v5 )
  {
