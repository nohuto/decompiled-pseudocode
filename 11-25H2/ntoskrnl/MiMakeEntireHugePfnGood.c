/*
 * XREFs of MiMakeEntireHugePfnGood @ 0x140665344
 * Callers:
...
_QWORD *__fastcall MiMakeEntireHugePfnGood(int a1)
{
  ...
  v2 = a1 & 0x3FFFFF;
  v9 = 0LL;
  v3 = (__int64 *)(qword_140E2FD80 + 8 * v2);
  v4 = *v3;
  ...
  *((_QWORD *)&v9 + 1) = v6[4];
  *(_QWORD *)&v9 = 0x40000LL;
  qword_140E2FCE8 -= RtlNumberOfSetBitsEx((__int64 *)&v9);
  RtlAvlRemoveNode((unsigned __int64 *)&qword_140E2FCE0, (__int64)v6);
