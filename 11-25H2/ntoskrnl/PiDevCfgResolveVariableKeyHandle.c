/*
 * XREFs of PiDevCfgResolveVariableKeyHandle @ 0x140A968D4
 * Callers:
        ...
        else
        {
          ...
          if ( v22 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( *v25 == 36 )
              {
                v30 = (UNICODE_STRING **)((char *)Pool2 + 8 * v24);
                ...
                {
                  v32 = *v30;
                  if ( *(_DWORD *)&(*v30)[2].Length == 1 || *(_DWORD *)&(*v30)[2].Length == 2 )
                  {
                    v29 = *(_DWORD *)(&v32[2].MaximumLength + 1) - 2;
                  }
                  else if ( *(_DWORD *)&(*v30)[2].Length == 7 )
                  {
                    v33 = -1LL;
                    do
                      ++v33;
                    while ( v32[2].Buffer[v33] );
                    v29 = 2 * v33;
                  }
                }
                LOWORD(v23) = v63.MaximumLength;
