        ...
        PVOID *TokenInformation)
{
  ...
  switch ( TokenInformationClass )
  {
    ...
    case TokenPrivileges:
      ...
      if ( !v31 )
        goto LABEL_3;
      SepConvertTokenPrivileges(v6, v31);
      goto LABEL_7;
    case TokenOwner:
...
LABEL_94:
      ...
      v287 = v138;
LABEL_95:
      v142 = v286 + v277 + v133 + v282[0] + LODWORD(Sid[0]) + v138 + v289 + 904;
...
LABEL_4:
          ...
          **(_DWORD **)v282 = *(_DWORD *)(v6 + 192);
          *(_OWORD *)Sid = 0LL;
          *((_DWORD *)v163 + 1) = SepGetTokenElevation(v6);
          *((_DWORD *)v163 + 2) = SepGetTokenElevationType(v6);
          *((_DWORD *)v163 + 3) = *(_DWORD *)(v6 + 196);
          v163[7] = *(_QWORD *)(v6 + 24);
          *((_DWORD *)v163 + 12) = *(_DWORD *)(v6 + 120);
          v164 = *(_QWORD *)(v6 + 1080);
          if ( v164 )
            v165 = *(_DWORD *)(v164 + 40);
          else
          ...
          *((_DWORD *)v163 + 4) = v168;
          v169 = (char *)(v163 + 10);
          v170 = *(_QWORD *)(v6 + 152) - (_QWORD)(v163 + 3);
          v287 = 0;
          *(_QWORD *)v281 = v170;
          v171 = v163 + 4;
          v172 = 0;
          ...
          v10 = *(_QWORD **)v282;
          *(_DWORD *)(*(_QWORD *)v282 + 64LL) = *(_DWORD *)(v6 + 124);
          *((_DWORD *)v10 + 17) = v181;
          v10[9] = v180;
LABEL_7:
          ExReleaseResourceLite(*(PERESOURCE *)(v6 + 48));
