/*
 * XREFs of PiPnpRtlInit @ 0x14071ACC4
 * Callers:
 ...
 *     _PnpCtxSetNtPlugPlayRoutine @ 0x140807C34 (_PnpCtxSetNtPlugPlayRoutine.c)
...
__int64 __fastcall PiPnpRtlInit(unsigned int a1)
{
  ...
  qword_140F8A428 = (__int64)&PiPnpRtlActiveOperations;
