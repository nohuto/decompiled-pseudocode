/*
 * XREFs of DifZwQuerySymbolicLinkObjectWrapper @ 0x14063A770
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnedLength)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = LinkHandle;
    *(_QWORD *)&v16 = LinkTarget;
    *((_QWORD *)&v15 + 1) = ReturnedLength;
  ...
  LODWORD(v17) = ZwQuerySymbolicLinkObject(LinkHandle, LinkTarget, ReturnedLength);
  if ( v7 )
  {
