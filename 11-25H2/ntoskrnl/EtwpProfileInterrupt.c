/*
 * XREFs of EtwpProfileInterrupt @ 0x140642600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( SchedulingGroup )
  {
    ...
    while ( *((_DWORD *)v11 + 31) <= 0xFFu )
    {
      LOBYTE(SchedulingGroup) = v11[124];
      if ( !(_BYTE)SchedulingGroup )
      {
        v11 = (char *)*((_QWORD *)v11 + 52);
        if ( v11 )
          continue;
      }
      goto LABEL_16;
...
LABEL_16:
  ...
  v17 = &v12;
  v18 = 16;
  EtwTraceSiloKernelEvent(Process[3].ActiveGroupsMask.Masks[0], (struct _KTHREAD *)&v17, 1u, 0x20000002u, 0xF2Eu, v3);
}
