/*
 * XREFs of CcCopyWriteEx @ 0x1404A2430
 * Callers:
 *     CcCopyWrite @ 0x1404A2400 (CcCopyWrite.c)
 *     CcFastCopyWrite @ 0x140578020 (CcFastCopyWrite.c)
...
char __fastcall CcCopyWriteEx(PFILE_OBJECT FileObject, __int64 *a2, unsigned int a3, char a4, int a5, __int64 a6)
{
  ...
  *(_QWORD *)v32 = 0LL;
  ...
  ++qword_140F8DD70;
  if ( !byte_140F8DD41 && CcTelemetryGlobalData && !dword_140F8DE60 && !dword_140F8DE64 )
  ...
  *(_QWORD *)v32 = v17;
  ...
  if ( !byte_140F8DD41 )
  {
    ...
    if ( v27 )
    {
      if ( v29 )
      {
        v23 = 1000000 * (*(_QWORD *)&KeQueryPerformanceCounter(0LL) - v29) / stru_140F8DD08.QuadPart;
        v28 = v23;
      }
      else
      {
