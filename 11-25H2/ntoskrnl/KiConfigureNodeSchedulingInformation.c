/*
 * XREFs of KiConfigureNodeSchedulingInformation @ 0x1405B2B5C
 * Callers:
...
__int64 __fastcall KiConfigureNodeSchedulingInformation(__int64 a1)
{
  ...
  for ( i = 4LL * *(unsigned __int16 *)(a1 + 136); v2; v2 &= ~v9 )
  {
    ...
    v8 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)((v1 << 6) + v7))];
    if ( v3 )
    {
      v9 = *(_QWORD *)(v8 + 36448);
      if ( v9 != *(_QWORD *)(v8 + 200) )
  ...
  for ( j = 0LL;
        v11;
        v11 &= ~*(_QWORD *)(KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)((v1 << 6) + v13))]
                          + 36464) )
  {
  ...
  for ( k = 0LL; v14; v14 &= ~v17 & ~(1LL << v16) )
  {
    ...
    v17 = *(_QWORD *)(KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)((v1 << 6) + v16))] + 36416);
    k |= v17;
  }
