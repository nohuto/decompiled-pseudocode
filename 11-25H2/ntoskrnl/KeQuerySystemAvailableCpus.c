/*
 * XREFs of KeQuerySystemAvailableCpus @ 0x1405B447C
 * Callers:
 *     PsQuerySystemAvailableCpus @ 0x1405D95B0 (PsQuerySystemAvailableCpus.c)
 *     PsQuerySystemAvailableCpusCount @ 0x1405D95F0 (PsQuerySystemAvailableCpusCount.c)
 * Callees:
