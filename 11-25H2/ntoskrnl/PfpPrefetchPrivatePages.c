/*
 * XREFs of PfpPrefetchPrivatePages @ 0x1409C6B5C
 * Callers:
...
LABEL_37:
    ...
    v13 = (int *)(*(_QWORD *)(v1 + 56) + 40 * v10);
    if ( (int)PfpSourceBuildVaArray((__int64)v13, (unsigned int *)P) < 0
      || (int)PfpSourceGetPrefetchSupport(v13, (__int64)Handle) < 0 )
    {
      v5 = P[1];
      goto LABEL_37;
    }
