/*
 * XREFs of LocalConvertAclToString @ 0x1409E6840
 * Callers:
        ...
        char a9)
{
  ...
  _DWORD *v161; // [rsp+98h] [rbp-19h]
  int v162; // [rsp+A0h] [rbp-11h]
  unsigned int *v163; // [rsp+A8h] [rbp-9h]
  _BYTE *v164; // [rsp+B0h] [rbp-1h]
  unsigned int v167; // [rsp+130h] [rbp+7Fh]
...
LABEL_156:
  ...
  v15 = 2 - (a3 != 0);
  v167 = v15;
  v155 = (char *)SddlpAlloc(8LL * *(unsigned __int16 *)(a1 + 4));
  if ( !v155 )
    return 8LL;
  v164 = (_BYTE *)SddlpAlloc(*(unsigned __int16 *)(v10 + 4));
  if ( !v164 )
  {
    v119 = v155;
    goto LABEL_161;
  }
  v161 = (_DWORD *)SddlpAlloc(4LL * *(unsigned __int16 *)(v10 + 4));
  if ( !v161 )
  {
    SddlpFree(v155);
    v119 = v164;
LABEL_161:
  ...
  while ( v17 < *(unsigned __int16 *)(v10 + 4) )
  {
    ...
    if ( v20 >= 0x11 )
      goto LABEL_39;
    v21 = (__int64 *)(0x140000000LL + 24LL * v20 + 14715216);
    if ( !v21 )
      goto LABEL_39;
    v22 = *v21;
    v23 = -1LL;
...
LABEL_54:
      ...
      while ( v135 < 0x1C );
      if ( v135 < 0x1C && (v137 = &(&off_140E08AF0)[3 * v135]) != 0LL )
      {
        v141[v31] = 1;
        v138 = -1LL;
        do
      ...
      else
      {
        for ( j = 0; j < 0x20; ++j )
        {
          if ( (v45 & (1 << j)) != 0 )
          {
            ...
            do
            {
              if ( ((unsigned int)v122 & v121[1]) == (_DWORD)v122 && (v45 & (1 << j)) == *v121 )
                break;
              v123 = (unsigned int)(v123 + 1);
              v121 += 6;
            }
            while ( (unsigned int)v123 < 0x1C );
            if ( (unsigned int)v123 >= 0x1C || (v124 = &(&off_140E08AF0)[3 * v123]) == 0LL )
            {
              v127 = 20;
              v161[v31] = 2;
              break;
      ...
      v12 = v127 + v153 + 6;
      v151 = v12;
      v128 = LookupSidInTable(0LL, v46, a6, v122, (int)&v153, a9, &v159);
