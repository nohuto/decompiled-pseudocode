/*
 * XREFs of ExpWorkerInitialization @ 0x140C31C34
 * Callers:
 ...
 *     ExpLegacyWorkerInitialization @ 0x14064C514 (ExpLegacyWorkerInitialization.c)
...
__int64 ExpWorkerInitialization()
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v6 = __rdtsc();
        qword_140E621F0 = (41929663 * (unsigned int)((((unsigned __int64)HIDWORD(v6) << 32) | (unsigned int)v6) >> 4)) ^ 0xB96LL;
        if ( !qword_140E621F0 )
          qword_140E621F0 = 1LL;
        v7 = __rdtsc();
        qword_140E621F8 = (41929663 * (unsigned int)((((unsigned __int64)HIDWORD(v7) << 32) | (unsigned int)v7) >> 4)) ^ 0x5CBLL;
        ...
        while ( v8 < v10 )
        {
          ...
          if ( (*(_BYTE *)(v11 + 66) & 0x40) != 0 )
            _bittestandset64(qword_140E62210, v8);
          ++v8;
        }
        ObpUnlockObjectType((__int64)ObpTypeObjectType);
        if ( v10 )
        {
          qword_140E62230 = ObpObjectTypes[41929663 * (__rdtsc() >> 4) % v10];
          v12 = (_QWORD *)(qword_140E62230 + 112);
          v13 = (const char *)(qword_140E62230 + 112);
          if ( qword_140E62230 + 112 < (unsigned __int64)(qword_140E62230 + 176) )
          {
            ...
            while ( (unsigned __int64)v13 < qword_140E62230 + 176 );
          }
          v14 = qword_140E621F0;
          v15 = 8LL;
          do
          {
            v14 = __ROR8__(v14 - *v12++, qword_140E621F8);
            v9 -= 8;
            --v15;
          }
          while ( v15 );
          for ( ; v9; --v9 )
          {
            ...
            v14 = __ROR8__(v14 - v16, qword_140E621F8);
          }
          qword_140E62238 = v14;
          qword_140E62200 = KiQueryUnbiasedInterruptTime()
