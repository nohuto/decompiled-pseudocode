/*
 * XREFs of MiSnapThunk @ 0x140A12C8C
 * Callers:
    ...
    if ( *((unsigned __int16 *)v31 + 44) >= (unsigned int)DestinationString.Length )
    {
      ...
      *(_QWORD *)Size = v35;
      while ( Buffer < v35 )
      {
        ...
        if ( *(_BYTE *)Buffer != *v34 )
        {
          v36 = RtlUpperChar(*v34);
          if ( RtlUpperChar(Character) != v36 )
            goto LABEL_52;
          v35 = *(wchar_t **)Size;
        }
      ...
      v37 = -1LL;
      v38 = &v29[(unsigned __int16)v44];
      do
        ++v37;
      while ( v38[v37] );
      Pool = MiAllocatePool(0x100uLL, v37 + 5, 538996045);
      v40 = (_WORD *)Pool;
      if ( Pool )
      {
        memmove((void *)(Pool + 2), v38, v37 + 1);
        *v40 = 0;
        v41 = v31[6];
        *(_QWORD *)Size = 0LL;
        v32 = MiSnapThunk((_DWORD)v41, v47, (unsigned int)Size, (unsigned int)Size, (__int64)v40);
