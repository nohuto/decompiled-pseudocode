/*
 * XREFs of SepAdtPrivilegeObjectAuditAlarm @ 0x140854390
 * Callers:
 *     ObpCreateHandle @ 0x1408518D0 (ObpCreateHandle.c)
 *     SePrivilegeObjectAuditAlarm @ 0x1408BA300 (SePrivilegeObjectAuditAlarm.c)
 ...
 *     SepAdtCheckPrivilegeForSensitivity @ 0x14047EDE8 (SepAdtCheckPrivilegeForSensitivity.c)
 ...
 *     ObNormalizeHandleValue @ 0x140984D80 (ObNormalizeHandleValue.c)
        ...
        unsigned __int8 a10)
{
  ...
  if ( a5 )
    v17 = *(unsigned __int8 ***)(a5 + 152);
  else
    v17 = *(unsigned __int8 ***)(a6 + 152);
  v33 = *v17;
