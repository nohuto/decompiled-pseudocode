/*
 * XREFs of __asan_loadN @ 0x1405A8560
 * Callers:
 *     <none>
 * Callees:
...
signed __int8 __fastcall _asan_loadN(ULONG_PTR BugCheckParameter1, ULONG_PTR BugCheckParameter2)
{
...
LABEL_12:
      ...
      if ( KcsaniValidationEnabled )
        return KcsanValidateAddress(BugCheckParameter1, BugCheckParameter2, 0, 0, retaddr);
    }
  }
  return result;
}
