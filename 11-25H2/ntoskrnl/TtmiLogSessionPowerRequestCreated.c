/*
 * XREFs of TtmiLogSessionPowerRequestCreated @ 0x14075E7FC
 * Callers:
 *     TtmNotifySessionPowerRequestCreated @ 0x14075A1B8 (TtmNotifySessionPowerRequestCreated.c)
 * Callees:
...
void TtmiLogSessionPowerRequestCreated()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)byte_14004F019, 0LL, 0LL, 5u, &v7);
  }
}
