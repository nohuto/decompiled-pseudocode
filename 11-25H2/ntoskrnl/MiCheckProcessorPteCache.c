/*
 * XREFs of MiCheckProcessorPteCache @ 0x1403F4DB0
 * Callers:
...
LABEL_7:
    while ( 2 )
    {
      v7 = (unsigned __int64 *)&qword_140E37328;
      while ( qword_140E37370 )
      {
        if ( qword_140E37328 >= (unsigned __int64)qword_140E37370 )
        {
          v7 = (unsigned __int64 *)&v44;
          *(_QWORD *)&v44 = qword_140E37328 - qword_140E37370;
          *((_QWORD *)&v44 + 1) = qword_140E37330 + 8 * ((unsigned __int64)qword_140E37370 >> 6);
          if ( v4 )
            v4 -= qword_140E37370;
          break;
        }
        v42 = ExAcquireSpinLockExclusive(dword_140E3735C);
        MiReleaseSpinLockExclusive(dword_140E3735C, v42);
      }
      v8 = *v7;
      v9 = 0LL;
      v10 = v7[1];
...
LABEL_39:
        if ( !v9 )
        {
          result = MiEmptyPteBins(&qword_140E37328, 0LL, 2LL);
          if ( !result )
            return result;
          v4 = 0LL;
          goto LABEL_7;
      ...
      v33 = (v26 + qword_140E37370) & 0xFFFFFFFFFFFFFFC0uLL;
      v34 = *(_QWORD *)(qword_140E37330 + 8 * (v33 >> 6));
      v35 = (volatile signed __int64 *)(qword_140E37330 + 8 * (v33 >> 6));
      if ( v34 == -1LL )
      {
LABEL_80:
        v4 = v33 + 64;
    ...
    if ( CurrentPrcb->PteBitCache == -1LL )
    {
      ...
      _InterlockedAdd64(&qword_140E37380, -(__int64)(unsigned int)__popcnt(~v34));
      qword_140E37368 = v33 + 64;
    }
    else
    {
    ...
    if ( a1 > 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v16 == p_PteBitCache )
          goto LABEL_27;
        v29 = !_BitScanReverse64((unsigned __int64 *)&v43, v15);
        v15 = v16[1];
        if ( v29 )
        {
          ++v16;
...
LABEL_27:
  if ( v6 != -1LL )
  {
    ...
    if ( v21 + a1 > 8 )
    {
      ...
      if ( !a1 )
        goto LABEL_31;
      v23 = byte_14002B070[a1];
    }
    else
    {
      v5 = v6;
      v23 = byte_14002B070[a1] << v21;
    }
    *v22 |= v23;
LABEL_31:
    v5 = qword_140E37348 + 8 * (v5 + CurrentPrcb->PteBitOffset);
  }
  if ( KiIrqlFlags )
    KiLowerIrqlProcessIrqlFlags(KeGetCurrentIrql(), CurrentIrql);
  __writecr8(CurrentIrql);
