/*
 * XREFs of RtlDetectProcessorFeatures @ 0x140B50140
 * Callers:
 ...
 *     RtlpGetSpecificProcessorFlags @ 0x140B50B30 (RtlpGetSpecificProcessorFlags.c)
 */
...
__int64 __fastcall RtlDetectProcessorFeatures(int a1, __int64 *a2, __int64 *a3, _DWORD *a4)
{
  ...
  BOOL v55; // [rsp+34h] [rbp-104h]
  __int128 v56; // [rsp+38h] [rbp-100h] BYREF
  __int64 v57; // [rsp+48h] [rbp-F0h] BYREF
  int v58; // [rsp+50h] [rbp-E8h]
  unsigned int v59; // [rsp+54h] [rbp-E4h]
  __int64 *v60; // [rsp+58h] [rbp-E0h]
  unsigned int v61; // [rsp+60h] [rbp-D8h]
  int v62; // [rsp+68h] [rbp-D0h]
  __int64 v63; // [rsp+70h] [rbp-C8h]
  __int64 v64; // [rsp+78h] [rbp-C0h]
  __int64 *v65; // [rsp+80h] [rbp-B8h]
  __int64 *v66; // [rsp+88h] [rbp-B0h]
  _DWORD *v67; // [rsp+90h] [rbp-A8h]
  unsigned __int64 v68; // [rsp+98h] [rbp-A0h]
  __int64 *v69; // [rsp+A0h] [rbp-98h]
  __int64 *v70; // [rsp+A8h] [rbp-90h]
  _DWORD *v71; // [rsp+B0h] [rbp-88h]
  __int128 v72; // [rsp+C0h] [rbp-78h] BYREF
  __int64 v73; // [rsp+D0h] [rbp-68h]
  __int128 v74; // [rsp+E0h] [rbp-58h]
  ...
  v57 = 0LL;
  LODWORD(v56) = a1;
  ProcessorSignature = RtlGetProcessorSignature((char *)&v56 + 4, (char *)&v56 + 8, (char *)&v56 + 12, &v57);
  v61 = ProcessorSignature;
  HIDWORD(v57) = ProcessorSignature;
  _RAX = 0x80000000LL;
  __asm { cpuid }
  ...
  v59 = _RAX;
  *(_QWORD *)&v74 = __PAIR64__(_RBX, _RAX);
  *((_QWORD *)&v74 + 1) = __PAIR64__(_RDX, _RCX);
  v17 = 0LL;
  v63 = 0LL;
  v18 = 0LL;
  v64 = 0LL;
    ...
    if ( (v24 & 2) == 0 )
    {
      ...
      if ( !v25 || _bittest((const int *)&v25, v22) )
      {
        ...
        if ( *(_QWORD *)(v23 + 7) )
        {
          v72 = v56;
          v73 = v57;
          guard_dispatch_icall_no_overrides(&v72);
          v31 = v54;
          v16 = v59;
...
LABEL_40:
  ...
  for ( i = 0LL; (unsigned int)i < 2; i = (unsigned int)(i + 1) )
  {
    ...
    {
      v22 = HIBYTE(v37);
      if ( !(_DWORD)v22 || _bittest((const int *)&v22, BYTE4(v56)) )
      {
        if ( (v37 & 8) != 0 )
        {
          v38 = v17;
