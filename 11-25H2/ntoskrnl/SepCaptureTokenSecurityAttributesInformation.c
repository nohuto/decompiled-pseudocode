/*
 * XREFs of SepCaptureTokenSecurityAttributesInformation @ 0x140868404
 * Callers:
  ...
  while ( v21 < *((_DWORD *)v11 + 1) )
  {
    ...
    if ( v23 )
    {
      switch ( LOWORD(v7[5 * v21 + 2]) )
      {
        ...
        case 2:
LABEL_45:
          v24 = SepCaptureInt64Array(v7[5 * v21 + 4], v23, v16, &P);
          break;
        case 3:
          LOBYTE(v16) = 1;
          v24 = SepCaptureUnicodeStringArray((__int64)v7[5 * v21 + 4], v23, v16, &P);
          break;
        case 4:
