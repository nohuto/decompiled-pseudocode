/*
 * XREFs of sub_140A54400 @ 0x140A54400
 * Callers:
...
__int64 __fastcall sub_140A54400(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  unsigned int i; // r9d
  ...
  if ( (_DWORD)v17 )
    v19 = v18;
  v20 = qword_140FD73E8 ? guard_dispatch_icall_no_overrides(v19) : -1073741637;
  v21 = *(_DWORD *)(a2 + 32);
