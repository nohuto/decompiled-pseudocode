/*
 * XREFs of RtlDeleteRange @ 0x14076DFA0
 * Callers:
 *     ArbBacktrackAllocation @ 0x1406F8C80 (ArbBacktrackAllocation.c)
 *     IopPortBacktrackAllocation @ 0x140719F80 (IopPortBacktrackAllocation.c)
 * Callees:
