/*
 * XREFs of SepLogUnmatchedSessionFlagImpersonationAttempt @ 0x1404CEC80
 * Callers:
...
{
  unsigned __int16 *LastRebalanceQpc; // rdi
  ...
  *(_OWORD *)P = 0LL;
  ...
  v6 = P[1];
  if ( (unsigned int)dword_140E087A8 > 5 && tlgKeywordOn((__int64)&dword_140E087A8, 0x400000000000LL) )
  {
    ...
    v17 = &v11;
    v19 = v22;
    v21 = *((_QWORD *)LastRebalanceQpc + 1);
    v22[0] = *LastRebalanceQpc;
    v23 = v26;
    v26[0] = LOWORD(P[0]);
    v11 = v9;
    v18 = 4LL;
    ...
    v25 = v6;
    v26[1] = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E087A8, (unsigned __int8 *)byte_1400501BB, 0LL, 0LL, 8u, &v14);
  }
  if ( v6 )
