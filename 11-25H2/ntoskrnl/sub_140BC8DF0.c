/*
 * XREFs of sub_140BC8DF0 @ 0x140BC8DF0
 * Callers:
 *     <none>
 * Callees:
 *     sub_140BC7384 @ 0x140BC7384 (sub_140BC7384.c)
 *     KeGuardDispatchICall @ 0x140BC9A60 (KeGuardDispatchICall.c)
 *     RtlMinimalBarrier @ 0x140BC9BE4 (RtlMinimalBarrier.c)
 */

__int64 __fastcall sub_140BC8DF0(__int64 a1)
{
  _DWORD *v2; // rcx
  char *v3; // rax
  int v4; // ecx
