/*
 * XREFs of HalpInterruptUnmap @ 0x1406F1C38
 * Callers:
 *     HalpTimerUnmapInterrupt @ 0x140546120 (HalpTimerUnmapInterrupt.c)
 *     HaliRemoveInterruptRemapping @ 0x1406F1C10 (HaliRemoveInterruptRemapping.c)
 * Callees:
 ...
 *     HalpInterruptIsHvMsiRemappingSupported @ 0x1404A6514 (HalpInterruptIsHvMsiRemappingSupported.c)
