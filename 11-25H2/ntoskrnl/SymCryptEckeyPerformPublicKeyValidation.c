/*
 * XREFs of SymCryptEckeyPerformPublicKeyValidation @ 0x140520678
 * Callers:
 ...
 *     SymCryptEcpointIsZero @ 0x14052BFEC (SymCryptEcpointIsZero.c)
 *     SymCryptEcpointOnCurve @ 0x14052C0B4 (SymCryptEcpointOnCurve.c)
