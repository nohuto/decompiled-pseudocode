/*
 * XREFs of RtlpCopyRangeListEntry @ 0x140A4EAC0
 * Callers:
...
char *__fastcall RtlpCopyRangeListEntry(__int64 a1)
{
  ...
  v2 = (char *)ExAllocateFromPagedLookasideList(&RtlpRangeListEntryLookasideList);
  v3 = v2;
  if ( v2 )
  {
    v4 = v2 + 16;
    ...
    if ( (*(_BYTE *)(a1 + 34) & 1) != 0 )
    {
      ...
      *(_QWORD *)v4 = v4;
      for ( i = *(_QWORD *)(a1 + 16); ; i = *(_QWORD *)(v8 + 40) )
      {
        ...
        if ( v6 == v8 + 40 )
          break;
        v9 = ExAllocateFromPagedLookasideList(&RtlpRangeListEntryLookasideList);
        v10 = v9;
        if ( !v9 )
        {
