/*
 * XREFs of _CmGetInstallerClassRegProp @ 0x1409AC648
 * Callers:
...
__int64 __fastcall CmGetInstallerClassRegProp(
        ...
        __int64 a7)
{
  __int64 (__fastcall *v10)(void *, PCWSTR, unsigned int, int, int, __int64); // r12
  int v11; // eax
  ...
  v10 = (__int64 (__fastcall *)(void *, PCWSTR, unsigned int, int, int, __int64))a1[63];
  v25 = 0;
  v24 = a7;
  v20 = a3;
  v21 = a4;
  ...
  if ( v10 )
  {
    if ( v10 == PiPnpRtlCmActionCallback )
      v11 = PiPnpRtlCmActionCallback(a1, a2, 2u, 9, 1, (__int64)v19);
    else
  ...
  v14 = v10 == PiPnpRtlCmActionCallback
      ? PiPnpRtlCmActionCallback(a1, a2, 2u, 9, 2, (__int64)v19)
