/*
 * XREFs of MiSearchNumaNodeTable @ 0x1403FA4B0
 * Callers:
...
_QWORD *__fastcall MiSearchNumaNodeTable(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (result = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, BugCheckParameter2 < *result)
    || dword_140E2D880 != dword_140E2D884 && BugCheckParameter2 >= result[2] )
  {
    for ( i = 0; ; i = v4 + 1 )
    {
      while ( 1 )
      ...
      if ( v4 == dword_140E2D884 || BugCheckParameter2 < v5[2] )
        break;
    }
    dword_140E2D880 = (i + v1) >> 1;
    return (char *)qword_140E2D8E0 + 16 * v4;
  }
  return result;
}
