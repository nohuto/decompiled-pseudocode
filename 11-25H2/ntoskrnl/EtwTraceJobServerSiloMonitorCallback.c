/*
 * XREFs of EtwTraceJobServerSiloMonitorCallback @ 0x140641A64
 * Callers:
 ...
 *     EtwpCopyJobIdSafe @ 0x140A64D74 (EtwpCopyJobIdSafe.c)
 *     EtwpCopyJobGuidSafe @ 0x140A6A00C (EtwpCopyJobGuidSafe.c)
 */
