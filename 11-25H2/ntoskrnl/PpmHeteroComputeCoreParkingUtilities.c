/*
 * XREFs of PpmHeteroComputeCoreParkingUtilities @ 0x140408264
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  *a5 = 0LL;
  ...
  do
  {
    ...
    v11 &= ~(1LL << v14);
    v15 = *((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v10 + (unsigned __int8)v14);
...
LABEL_8:
  ...
  while ( 1 )
  {
    if ( v17 )
    {
      ...
      v17 &= ~(1LL << v19);
      Prcb = KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v16 + (unsigned __int8)v19));
