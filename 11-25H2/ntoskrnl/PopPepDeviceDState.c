/*
 * XREFs of PopPepDeviceDState @ 0x140357170
 * Callers:
...
void __fastcall PopPepDeviceDState(__int64 a1, int a2, __int64 a3, int a4)
{
  unsigned int v4; // ebp
  __int64 v5; // r14
  int v6; // ebx
  ...
  if ( *(_BYTE *)(a1 + 124) )
  {
    ...
    v24 = v6 == 1;
    v21 = *(_QWORD *)(v14 + 72);
    guard_dispatch_icall_no_overrides(5LL, &v21);
  }
  if ( v7 )
  {
    if ( *(_DWORD *)(a1 + 168) != (_DWORD)v5 )
    {
      ...
      if ( *(_DWORD *)(a1 + 168) == 1 && *(_DWORD *)(a1 + 180) )
      {
        do
        {
          v15 = 208LL * v4;
          PopPepUpdateIdleStateRefCount(
            *(unsigned int *)(*(_QWORD *)(v15 + a1 + 392) + 24LL * *(unsigned int *)(v15 + a1 + 368) + 16),
            0LL,
            0LL,
            v15 + a1 + 384);
          PopFxUpdateComponentAccountingEnhanced(
            *(_QWORD *)(a1 + 32),
            *(unsigned int *)(v15 + a1 + 200),
            (unsigned int)(*(_DWORD *)(v15 + a1 + 380) - 1),
            1LL);
          ++v4;
        }
      ...
      PopFxUpdateDeviceAccountingEnhanced(*(_QWORD *)(a1 + 32), (unsigned int)v5, 1LL);
    }
LABEL_24:
    v13 = *(_DWORD *)(a1 + 168);
    if ( v13 != (_DWORD)v5 )
