/*
 * XREFs of IvtCheckForReservedRegion @ 0x1406F87D0
 * Callers:
 *     <none>
 * Callees:
 *     HalpIvtCheckIdPathMatch @ 0x1404F714C (HalpIvtCheckIdPathMatch.c)
 *     DmrGetNextDeviceScope @ 0x140576440 (DmrGetNextDeviceScope.c)
 *     DmrGetNextRemappingStructure @ 0x140576488 (DmrGetNextRemappingStructure.c)
 */
...
char __fastcall IvtCheckForReservedRegion(_DWORD *a1)
{
  ...
  if ( *a1 == 1 && qword_140E65750 )
  {
    for ( i = 0LL; ; i = (__int64)v4 )
    {
      NextRemappingStructure = (_WORD *)DmrGetNextRemappingStructure(qword_140E65750, i);
