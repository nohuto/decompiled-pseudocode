/*
 * XREFs of Feature_AggressiveInputSuppression__private_IsEnabledPreCheck @ 0x1404F6FA0
 * Callers:
...
__int64 Feature_AggressiveInputSuppression__private_IsEnabledPreCheck()
{
  ...
  if ( (Feature_AggressiveInputSuppression__private_featureState & 0x10) == 0 )
  {
    ...
    wil_details_FeatureReporting_ReportUsageToService(&Feature_AggressiveInputSuppression__private_descriptor, v1, 3LL);
