/*
 * XREFs of AslpEnvResolveVars @ 0x1407FC608
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  while ( v12 < 4 )
  {
    if ( v7 )
      goto LABEL_38;
    v15 = dword_140E0A040[6 * v12];
    if ( a2 > v15 )
    {
      if ( !wcsnicmp(v14, off_140E0A030[3 * v12], v15) )
      {
        v16 = 3 * v12;
        v10 = a2 + dword_140E0A044[6 * v12] - dword_140E0A040[6 * v12];
        ...
        else
        {
          ...
          {
            if ( *(_WORD *)((char *)&unk_140E0A090 + i * 8) == a5 && *(_WORD *)((char *)&unk_140E0A092 + i * 8) == a6 )
            {
              ...
              v18 = RtlStringCchCatW(a3, v8, (&off_140E0A098)[i]);
              if ( v18 < 0 )
              {
              ...
              v18 = RtlStringCchCatW(a3, v8, &pszSrc[dword_140E0A040[0]]);
              if ( v18 < 0 )
              {
                v20 = "RtlStringCchCatW failed [%x]";
                v21 = 952;
          ...
          v16 = 0LL;
LABEL_20:
          v18 = RtlStringCchCopyW(a3, v8, (&off_140E0A038)[v16]);
          if ( v18 < 0 )
          {
            v21 = 980;
LABEL_28:
...
LABEL_29:
          ...
          v18 = RtlStringCchCatW(a3, v8, &pszSrc[dword_140E0A040[2 * v19]]);
          if ( v18 < 0 )
          {
            v20 = "RtlStringCchCatW failed [%x]";
            v21 = 986;
