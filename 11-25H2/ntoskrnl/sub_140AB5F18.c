/*
 * XREFs of sub_140AB5F18 @ 0x140AB5F18
 * Callers:
...
__int64 __fastcall sub_140AB5F18(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // r8d
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
  ...
  v7 = guard_dispatch_icall_no_overrides(v18);
  if ( (v7 & 0x80000000) == 0 )
  {
    v19 = *(_DWORD *)(a2 + 32);
