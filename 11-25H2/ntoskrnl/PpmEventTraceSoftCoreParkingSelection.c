/*
 * XREFs of PpmEventTraceSoftCoreParkingSelection @ 0x14047322C
 * Callers:
        ...
        char a11)
{
  ...
  if ( PpmEtwRegistered )
  {
    if ( EtwEventEnabled(PpmEtwHandle, &PPM_ETW_SOFT_PARKING_SELECTION) )
    {
      v13 = a1[4];
      v14 = a1[25] + 104 * v11;
      v15 = *(_QWORD *)(v14 + 16);
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v52 = 1LL;
      v54 = 1LL;
      EtwWriteEx(PpmEtwHandle, &PPM_ETW_SOFT_PARKING_SELECTION, 0LL, 0, 0LL, 0LL, 0x11u, &UserData);
    }
  }
}
