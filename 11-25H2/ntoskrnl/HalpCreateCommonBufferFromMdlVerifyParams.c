/*
 * XREFs of HalpCreateCommonBufferFromMdlVerifyParams @ 0x14054C298
 * Callers:
 ...
 * Callees:
 *     HalpParseCommonBufferExtendedConfigurations @ 0x14054C39C (HalpParseCommonBufferExtendedConfigurations.c)
 */
