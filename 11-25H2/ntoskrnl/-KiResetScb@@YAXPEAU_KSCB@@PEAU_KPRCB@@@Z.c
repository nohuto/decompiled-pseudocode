/*
 * XREFs of ?KiResetScb@@YAXPEAU_KSCB@@PEAU_KPRCB@@@Z @ 0x1402F6460
 * Callers:
...
void __fastcall KiResetScb(struct _KSCB *a1, struct _KPRCB *a2)
{
  ...
  if ( a1->ReadySummary )
  {
    ...
    if ( !Rank )
      v6 = a2;
    KiMoveScbThreadsToNewReadylist(v4, (struct _LIST_ENTRY *)((unsigned __int64)a1 & -(__int64)(Rank != 0)), v6, 0LL);
    if ( (*(_BYTE *)&v4->0 & 1) != 0 )
    {
