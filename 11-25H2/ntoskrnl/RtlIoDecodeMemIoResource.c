/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x1405DD990
 * Callers:
 *     IopGenericScoreRequirement @ 0x140719990 (IopGenericScoreRequirement.c)
 *     IopGenericUnpackRequirement @ 0x140719AC0 (IopGenericUnpackRequirement.c)
