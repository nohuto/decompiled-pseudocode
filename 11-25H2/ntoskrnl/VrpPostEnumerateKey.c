/*
 * XREFs of VrpPostEnumerateKey @ 0x140948938
 * Callers:
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( (unsigned int)dword_140E0A400 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_1400579A6,
      &ActivityId,
      0LL,
      5u,
      &v76);
...
LABEL_31:
  if ( v42 )
    VrpUnlockJobContextShared(a2);
  if ( v8 < 0 && (unsigned int)dword_140E0A400 > 2 )
  {
    v45 = *(_DWORD *)(v4 + 12);
    v64 = &v45;
    v65 = 4LL;
    ...
    *(_DWORD *)&EventDescriptor.Level = 2;
    ...
    UserData.Ptr = (ULONGLONG)off_140E0A408;
    UserData.Size = *(unsigned __int16 *)off_140E0A408;
    UserData.Reserved = 2;
    v61 = byte_140057931;
    v62 = 116;
    v63 = 1;
    EtwWriteTransfer(qword_140E0A420, &EventDescriptor, &ActivityId, 0LL, 8u, &UserData);
  }
  if ( Handle )
    ZwClose(Handle);
  if ( KeyHandle )
