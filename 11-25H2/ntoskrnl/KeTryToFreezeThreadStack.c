/*
 * XREFs of KeTryToFreezeThreadStack @ 0x1404AA4CC
 * Callers:
 ...
 *     KiIsKernelStackSwappable @ 0x140406970 (KiIsKernelStackSwappable.c)
 */
...
LABEL_47:
    ...
    if ( (KiVelocityFlags & 0x200000) != 0 )
    {
      ...
      *(_QWORD *)&v19 = 0LL;
      v14 = (struct _KPRCB **)_InterlockedExchange64(v7, (__int64)&v19);
      if ( v14 )
        KxWaitForLockOwnerShip((struct _KPRCB *)&v19, v14);
    }
    else
    {
      v20 = 0;
