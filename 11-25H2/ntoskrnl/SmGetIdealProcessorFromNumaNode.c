/*
 * XREFs of SmGetIdealProcessorFromNumaNode @ 0x140393E88
 * Callers:
...
__int64 __fastcall SmGetIdealProcessorFromNumaNode(__int64 a1, unsigned int a2)
{
  return SMKM_STORE_MGR<SM_TRAITS>::SmCompressManagerGetIdealProcessor(a1 + 1264, a2, 0);
}
