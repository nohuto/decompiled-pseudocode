/*
 * XREFs of PfPowerActionNotify @ 0x140B5C910
 * Callers:
      ...
      if ( v5 )
      {
        if ( v5 == 5 && (unsigned int)(a3 - 2) <= 2 )
        {
          ...
          *(_QWORD *)&v13 = 0x200000001LL;
          DWORD2(v13) = 1;
          HIDWORD(v13) = dword_140E66BF4;
          PfpPartitionIterate((__int64)PfpLogScenarioEventCallback, 0, (__int64)&v13);
        }
LABEL_7:
...
LABEL_8:
        LODWORD(v11) = 28;
        *((_QWORD *)&v11 + 1) = 8LL;
        DWORD1(v11) = dword_140E66BBC
                    + ((((MEMORY[0xFFFFF78000000004] * HIDWORD(MEMORY[0xFFFFF78000000320])) << 8)
                      + ((MEMORY[0xFFFFF78000000004] * (unsigned __int64)MEMORY[0xFFFFF78000000320]) >> 24)) >> 10);
        v12 = &v10;
        return PfpPartitionIterate((__int64)PfpPartitionLogEventCallback, 0, (__int64)&v11);
      }
      PfpPartitionIterate((__int64)PfpPowerActionStartScenarioTracingCallback, 4, (__int64)&qword_140E66BC0);
      if ( dword_140E66BF0 == 5 )
    ...
    else
    {
      ...
      {
        PfpPartitionIterate((__int64)PfpPowerActionSleepSystemPhaseCallback, 4, (__int64)&v9);
        if ( v9 )
        {
          v7 = 5;
          if ( a3 == 5 )
          {
            v8 = HIDWORD(qword_140E669F4);
            if ( dword_140E66BF0 == 5 )
              v8 = dword_140E669FC;
            else
              v7 = 2;
          ...
          HIDWORD(v10) = PfpScenCtxPrefetchWait((ULONG_PTR)&qword_140E66BC0, v7, v8);
        }
  ...
  else
  {
    ...
    if ( (unsigned int)result <= 2 || a3 == 5 )
      return PfpScenCtxScenarioSet((ULONG_PTR)&qword_140E66BC0);
  }
  return result;
}
