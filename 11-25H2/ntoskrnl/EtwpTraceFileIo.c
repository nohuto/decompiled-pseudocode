/*
 * XREFs of EtwpTraceFileIo @ 0x140310FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    if ( EtwpFileProvRegHandle
      && (EtwpLevelKeywordEnabled(*(_QWORD *)(EtwpFileProvRegHandle + 32) + 96LL, *((_BYTE *)v10 + 4), v10[1])
       || *(_BYTE *)(v11 + 101) && EtwpLevelKeywordEnabled(*(_QWORD *)(v11 + 40) + 96LL, v13->Level, v13->Keyword)) )
    {
      ...
      if ( v19 )
      {
        ...
        if ( ((unsigned int)v6 & *(_DWORD *)(v19 + 4 * (v6 >> 29)) & 0x1FFFFFFF) != 0 )
          LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                         (struct _KTHREAD *)a2,
                                         EtwpHostSiloState,
                                         *(unsigned __int8 *)(EtwpHostSiloState + 2 * v18 + 4232),
                                         a3,
                                         a5,
                                         0x601903u);
      }
          ...
          if ( v24 )
          {
            ...
            if ( ((unsigned int)v6 & *(_DWORD *)(v24 + 4 * (v6 >> 29)) & 0x1FFFFFFF) != 0 )
              LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                             (struct _KTHREAD *)a2,
                                             v20,
                                             *(unsigned __int8 *)(v20 + 2 * v23 + 4232),
                                             a3,
                                             a5,
                                             0x601903u);
          }
