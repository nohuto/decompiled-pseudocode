/*
 * XREFs of __asan_store16_volatile @ 0x1405A8F50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store16_volatile(ULONG_PTR BugCheckParameter1)
{
  ULONG_PTR v1; // rdi
  ULONG_PTR v3; // rax
  int v4; // r9d
...
LABEL_50:
  ...
  {
    LOBYTE(v4) = 1;
    LOBYTE(v3) = KcsanValidateAddress(BugCheckParameter1, 16, 1, v4, v1);
  }
  return v3;
}
