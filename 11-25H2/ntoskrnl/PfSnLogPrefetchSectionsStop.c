/*
 * XREFs of PfSnLogPrefetchSectionsStop @ 0x1409C82B4
 * Callers:
...
void __fastcall PfSnLogPrefetchSectionsStop(__int64 a1, int a2, int a3, __int64 a4, __int64 a5, char a6)
{
  ...
  if ( a1 )
  {
    ...
    if ( qword_140E66E48 )
    {
      if ( EtwEventEnabled(qword_140E66E48, &PfSnEvt_PrefetchSections_Stop) )
      {
        v7 = -1LL;
        do
          ++v7;
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v26 = 8LL;
        v28 = 4LL;
        EtwWrite(qword_140E66E48, &PfSnEvt_PrefetchSections_Stop, 0LL, 9u, &UserData);
      }
    }
  }
}
