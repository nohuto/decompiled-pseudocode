/*
 * XREFs of MiLogStrongCodeDriverLoadFailure @ 0x140AA5D1C
 * Callers:
...
void __fastcall MiLogStrongCodeDriverLoadFailure(const CHAR *Src, __int64 a2)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    if ( **(_DWORD **)&qword_140E372D8 > 2u && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000004000LL) )
    {
      ...
      v30 = 8;
      v19 = 2;
      tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&byte_140054DC1, v4, 1u, v11, v12, 8u, &v16);
    }
  }
  else
  {
    ...
    if ( Pool )
    {
      ...
      *(_DWORD *)(v7 + 44) = *(_DWORD *)(a2 + 156);
      ...
      v10 = (__int64 *)qword_140E2D5F8;
      if ( *(PVOID **)qword_140E2D5F8 != &qword_140E2D5F0 )
        __fastfail(3u);
      *(_QWORD *)(v7 + 8) = qword_140E2D5F8;
      *(_QWORD *)v7 = &qword_140E2D5F0;
      *v10 = v7;
      qword_140E2D5F8 = v7;
