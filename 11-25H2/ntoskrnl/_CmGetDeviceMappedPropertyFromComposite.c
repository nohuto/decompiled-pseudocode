/*
 * XREFs of _CmGetDeviceMappedPropertyFromComposite @ 0x1409A913C
 * Callers:
        ...
        int a9)
{
  ...
  char v87[8]; // [rsp+60h] [rbp-A0h] BYREF
  ...
  *a8 = 0;
  ...
  if ( v17 != 256 )
  {
    if ( v17 == 2 )
    {
      ...
      {
LABEL_92:
        DeviceStatus = CmGetDeviceStatus((__int64)a1, v13, (__int64)v96, &v92, &v93, &v94, v85);
...
LABEL_241:
      ...
      if ( v47 )
      {
        ...
        *v84 = 13;
        if ( a7 >= *a8 )
        {
          DeviceStatus = CmGetDeviceContainerIdFromBase(a1, (__int64)v88, Str2, SourceString);
          if ( (DeviceStatus & 0x80000000) == 0 )
          {
            DeviceStatus = RtlInitUnicodeStringEx(&DestinationString, SourceString);
            if ( (DeviceStatus & 0x80000000) == 0 )
              DeviceStatus = RtlGUIDFromString(&DestinationString, v9);
          }
          goto LABEL_30;
        }
        return (unsigned int)-1073741789;
      ...
      *a5 = 17;
      if ( v16 < *a8 )
        return (unsigned int)-1073741789;
      v29 = -CmIsDeviceSafeRemovalRequired(a1, v13, a3);
    }
    else
    {
      if ( v17 == 3 )
              ...
              case 8u:
                ...
                if ( v34 )
                {
                  ...
                  *a8 = 4;
                  ...
                  if ( a1[32] )
                  {
                    v49 = guard_dispatch_icall_no_overrides(a1);
                    DeviceStatus = v49;
                    if ( v49 == -1073741772 )
                      return (unsigned int)-1073741275;
                    if ( v49 == -2147483643 )
...
LABEL_117:
                ...
                v91 = v16 >> 1;
                DeviceParent = CmGetDeviceParent(a1, v13, (wchar_t *)v9, &v91);
...
LABEL_166:
                ...
                goto LABEL_225;
              case 0xFu:
                v67 = *(_QWORD *)a4 - DEVPKEY_Device_IsConnected;
                if ( *(_QWORD *)a4 == DEVPKEY_Device_IsConnected )
                  v67 = *(_QWORD *)(a4 + 8) - 0x293B573F92A15394LL;
                if ( v67 )
                  return DeviceStatus;
                *a5 = 17;
                *a8 = 1;
                ...
                if ( !a1[33] )
                  return (unsigned int)-1073741822;
                v68 = guard_dispatch_icall_no_overrides(a1);
                if ( v68 == -2147483643 )
                  return (unsigned int)-1073741789;
                if ( v68 == -1073741810 )
                  return 0;
                DeviceStatus = v68;
                if ( v68 < 0 || (v92 & 0x2000000) != 0 )
                  return DeviceStatus;
                v69 = PnpGetObjectProperty(
                        a1,
                        v88,
                        1u,
                        0LL,
                ...
                if ( v69 != -1073741275 && v69 != -1073741789 )
                  goto LABEL_30;
                DeviceStatus = 0;
                goto LABEL_145;
              case 0x10u:
                v64 = *(_QWORD *)a4 - *(_QWORD *)&DEVPKEY_Device_IsRebootRequired.fmtid.Data1;
                if ( *(_QWORD *)a4 == *(_QWORD *)&DEVPKEY_Device_IsRebootRequired.fmtid.Data1 )
                  v64 = *(_QWORD *)(a4 + 8) - *(_QWORD *)DEVPKEY_Device_IsRebootRequired.fmtid.Data4;
                if ( v64 )
                  return DeviceStatus;
                *a5 = 17;
                *a8 = 1;
                ...
                if ( a1[33] )
                {
                  v65 = guard_dispatch_icall_no_overrides(a1);
                  if ( v65 == -1073741810 )
                    return 0;
                  if ( v65 != -2147483643 )
                  {
...
LABEL_114:
          ...
          if ( v51 )
          {
            ...
            *a8 = 1;
            ...
            if ( !a1[33] )
              return (unsigned int)-1073741822;
            v53 = guard_dispatch_icall_no_overrides(a1);
            if ( v53 == -2147483643 )
              return (unsigned int)-1073741789;
            if ( v53 == -1073741810 )
              return 0;
...
LABEL_168:
  ...
  if ( v23 )
  {
    ...
    *a5 = 18;
    if ( v16 >= *a8 )
    {
      v24 = RtlStringCbCopyExW((NTSTRSAFE_PWSTR)v9, (unsigned int)*a8, v13, 0LL, 0LL, 0x900u);
      v13 = v88;
      DeviceStatus = v24;
      if ( v24 < 0 )
      {
...
LABEL_31:
  ...
  {
    DeviceStatus = CmOpenDeviceRegKey((__int64)a1, v13, 16, 0, 1, 0, (__int64)&Handle, 0LL);
    if ( !DeviceStatus )
    {
      ZwClose(Handle);
      return (unsigned int)-1073741275;
