/*
 * XREFs of TtmiLogSessionDisplayRequiredReference @ 0x140A2DFB0
 * Callers:
...
void TtmiLogSessionDisplayRequiredReference()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)qword_14004F580, 0LL, 0LL, 5u, &v6);
  }
}
