/*
 * XREFs of PopFxDirectedWorkOrderWatchdog @ 0x1405CC8D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn PopFxDirectedWorkOrderWatchdog(__int64 a1, __int64 a2)
{
  ...
  v6 = 0;
  BugCheckParameter4[1] = (ULONG_PTR)&PopIrpList;
  BugCheckParameter4[0] = 98309LL;
  BugCheckParameter4[2] = (ULONG_PTR)&PopIrpThreadList;
  BugCheckParameter4[3] = ExWorkerQueue;
  BugCheckParameter4[4] = IoWorkerQueue;
  v9 = *(_DWORD *)(v2 + 32);
  v3 = *(_QWORD *)(v2 + 96);
  v10 = *(_DWORD *)(v2 + 1200);
  v5 = *(_DWORD *)(v2 + 956);
