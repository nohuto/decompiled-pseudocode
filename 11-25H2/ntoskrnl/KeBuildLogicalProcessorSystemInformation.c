/*
 * XREFs of KeBuildLogicalProcessorSystemInformation @ 0x140A0F334
 * Callers:
 *     ExpQuerySystemInformation @ 0x1409DB5B0 (ExpQuerySystemInformation.c)
 * Callees:
 *     KiGetSubNodeForGroup @ 0x14044CA74 (KiGetSubNodeForGroup.c)
 */
    ...
    while ( 1 )
    {
      ...
      if ( (_WORD)v11 == (_WORD)v4 )
      {
        ...
        if ( v12 )
        {
          ...
          v15 = *((_DWORD *)qword_140F216A8 + (unsigned int)((v13 << 6) + v14));
        }
        else
        {
          v15 = -1;
        ...
        if ( v17 )
        {
          ...
          v19 = *((_DWORD *)qword_140F216A8 + (unsigned int)(v18 + (v13 << 6)));
        }
        else
        {
          v19 = -1;
...
LABEL_16:
    ...
    while ( 1 )
    {
      ...
      v25 = *((_DWORD *)qword_140F216A8 + (unsigned int)(((_DWORD)v4 << 6) + v24));
LABEL_14:
