/*
 * XREFs of IopLiveDumpFreeIoSpaceRanges @ 0x140597714
 * Callers:
 ...
 * Callees:
 *     IopLiveDumpUnpackMemoryRun @ 0x14059AE1C (IopLiveDumpUnpackMemoryRun.c)
 *     MmFreeMemoryRanges @ 0x1407DB4F0 (MmFreeMemoryRanges.c)
