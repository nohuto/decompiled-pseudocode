/*
 * XREFs of MiLogSlabEntriesDemote @ 0x14067CCEC
 * Callers:
...
unsigned __int64 __fastcall MiLogSlabEntriesDemote(unsigned __int16 **a1, unsigned int a2)
{
  ...
  if ( !v7 )
  {
    ...
    for ( i = 0; i < 9; ++i )
    {
      if ( *v18 && **(_DWORD **)&qword_140E372D8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000400LL) )
      {
        v30 = v21;
        v34 = &v30;
        v35 = 8LL;
        ...
        v31 = 0x1000000LL;
        v43 = 8LL;
        tlgWriteAgg(v20, (unsigned __int8 *)&word_140056906, v20, 7u, (__int64)v33);
      }
      ++v18;
    }
    LOBYTE(CurrentIrql) = (_BYTE)v32;
    if ( **(_DWORD **)&qword_140E372D8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000400LL) )
      goto LABEL_19;
    v12 = 6;
    v13 = (unsigned __int8 *)&unk_140056980;
    v32 = a1[10];
    v34 = (__int64 *)&v32;
    v24 = *a1;
    v35 = 8LL;
  ...
  if ( a1[*((unsigned int *)v7 + 32) + 1]
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000400LL) )
  {
    v28 = v9;
    v34 = &v31;
    v12 = 8;
    v31 = v11;
    v36 = &v28;
    v13 = (unsigned __int8 *)byte_140056871;
    v35 = 8LL;
    v37 = 4LL;
    v29 = *(_DWORD *)(v8 + 132);
    v38 = (int *)&v29;
