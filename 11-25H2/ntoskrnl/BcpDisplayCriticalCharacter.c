/*
 * XREFs of BcpDisplayCriticalCharacter @ 0x14068D6A0
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalCharacter(__int16 a1, int a2, int a3)
{
  ...
  v5 = *(&BcpCursor + 1);
  v6 = *(&BcpCursor + 1);
  v7 = *(_QWORD *)(qword_140E3E860 + 24);
  v13 = 0;
  v12 = 0;
  v8 = dword_140EEF840;
  *(_DWORD *)(v7 + 56) = a2;
  *(_DWORD *)(qword_140E3E860 + 8) = a2;
  result = BgpDisplayCharacterEx(0x20u, (__int64 *)qword_140E3E860, v4, v6, *(_DWORD *)(v7 + 40), -1, &v13, &v12, v10);
  if ( (int)result >= 0 )
  {
    if ( v8 < v5 + v12 )
      v8 = v5 + v12;
