/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1405D71D0
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1404C9940 (PoFxPlatformRequestHandler.c)
 * Callees:
 *     PopFxAcpiValidateParameters @ 0x1404C14D4 (PopFxAcpiValidateParameters.c)
