/*
 * XREFs of _CmDeleteDeviceMappedPropertyFromDriverKeyRegValue @ 0x14080E124
 * Callers:
...
__int64 __fastcall CmDeleteDeviceMappedPropertyFromDriverKeyRegValue(int a1, __int64 a2, __int64 a3)
{
  int v4; // r11d
  unsigned int v5; // r9d
  DEVPROPKEY **v7; // r8
  ...
  v12 = CmOpenDeviceRegKey(a1, 2, 0, (__int64)&Handle, 0LL);
  v11 = v12;
  if ( v12 == -1073741772 )
  {
    v11 = 0;
