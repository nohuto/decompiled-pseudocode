/*
 * XREFs of MiLockImageSection @ 0x140A44E7C
 * Callers:
...
LABEL_2:
  ...
  do
  {
    ...
    if ( v6 == 1 )
    {
      ExBlockOnAddressPushLock(&qword_140E2D638, v3, &v11, 4LL, 0LL);
      goto LABEL_2;
    }
  ...
  if ( v6 < 2 )
  {
    ...
    MiLockCode(a1, (volatile signed __int64 *)(PteAddress + 8LL * *a2), PteAddress + 8LL * a2[1], 1);
    _InterlockedIncrement(v3);
    _InterlockedOr(v10, 0);
    if ( qword_140E2D638 )
      ExfUnblockPushLock((__int64)&qword_140E2D638, 0LL);
  }
