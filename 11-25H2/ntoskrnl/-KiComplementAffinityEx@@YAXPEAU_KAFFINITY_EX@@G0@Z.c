/*
 * XREFs of ?KiComplementAffinityEx@@YAXPEAU_KAFFINITY_EX@@G0@Z @ 0x1402673B0
 * Callers:
 *     KiGetDeepIdleProcessors @ 0x1402671F0 (KiGetDeepIdleProcessors.c)
 *     KeComplementAffinityEx2 @ 0x140267390 (KeComplementAffinityEx2.c)
 *     KiForwardTick @ 0x140274A70 (KiForwardTick.c)
 *     KeComplementAffinityEx @ 0x1405B4280 (KeComplementAffinityEx.c)
 * Callees:
 *     <none>
 */
