/*
 * XREFs of EtwTraceSiloTimedEvent @ 0x140479DB8
 * Callers:
        ...
        __int64 a7)
{
  ...
  while ( 1 )
  {
    ...
    if ( v11 )
      break;
    v10 &= v10 - 1;
    ServerSiloGlobals = (_QWORD *)(EtwpHostSiloState + 32LL * (unsigned int)v12 + 4284);
    if ( ServerSiloGlobals )
    {
      if ( (*(_DWORD *)ServerSiloGlobals & 0x2000) != 0 )
      {
        v13 = *(unsigned __int8 *)(EtwpHostSiloState + 2 * v12 + 4233);
        v21 = 0;
        v20 = 8;
        v19 = a7 + 8 * (v13 - 1);
        LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                       (struct _KTHREAD *)&v19,
                                       EtwpHostSiloState,
                                       *(unsigned __int8 *)(EtwpHostSiloState + 2LL * (unsigned int)v12 + 4232),
                                       2u,
                                       a2,
                                       0x501802u);
      }
    ...
    if ( v14 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v11 )
          break;
        v15 &= v15 - 1;
        ServerSiloGlobals = (_QWORD *)(v14 + 32LL * (unsigned int)v17 + 4284);
        if ( ServerSiloGlobals && (*(_DWORD *)ServerSiloGlobals & 0x2000) != 0 )
        {
          v16 = *(unsigned __int8 *)(v14 + 2 * v17 + 4233);
          v21 = 0;
          v20 = 8;
          v19 = a7 + 8 * (v16 - 1);
          LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                         (struct _KTHREAD *)&v19,
                                         v14,
                                         *(unsigned __int8 *)(v14 + 2LL * (unsigned int)v17 + 4232),
                                         2u,
                                         a2,
                                         0x501802u);
        }
