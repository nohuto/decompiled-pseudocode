/*
 * XREFs of NtQueryVolumeInformationFile @ 0x140936F60
 * Callers:
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  if ( PreviousMode )
  {
    ...
    *(_DWORD *)v11 = *(_DWORD *)v11;
    ...
    {
      v14 = (unsigned __int64)FsInformation;
      if ( ((*((unsigned __int8 *)IopQuerySetFsAlignmentRequirement + (int)FsInformationClass) - 1) & (unsigned int)FsInformation) != 0 )
        ExRaiseDatatypeMisalignment();
      v15 = (unsigned __int64)FsInformation + Length - 1;
      if ( v15 >= 0x7FFFFFFF0000LL || (unsigned __int64)FsInformation > v15 )
