/*
 * XREFs of HvlpGetEncryptedDataFromHypervisor @ 0x140587074
 * Callers:
 *     HvlGetEncryptedData @ 0x140586DC0 (HvlGetEncryptedData.c)
 * Callees:
 *     HvlpGetPageList @ 0x140588D18 (HvlpGetPageList.c)
 *     HvlpGetPageListIterator @ 0x140588DD0 (HvlpGetPageListIterator.c)
...
__int64 __fastcall HvlpGetEncryptedDataFromHypervisor(__int64 a1, char *a2, unsigned int a3, _QWORD *a4, _DWORD *a5)
{
  ...
  *a5 = 0;
  ...
  if ( (_DWORD)v13 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(8 * (((unsigned __int64)qword_140F8D838 >> 12) & 0xFFFFFFFFFLL) - 0x98000000000LL) = v20;
      v16 = __readcr4();
      if ( (v16 & 0x20080) != 0 )
      {
        __writecr4(v16 ^ 0x80);
      ...
      memmove(a2, qword_140F8D838, 0x1000uLL);
      *a4 = v15;
      a2 += 4096;
      v14 += 4096LL;
      ++a4;
  ...
  *((_QWORD *)&HvlpCrashdumpIterationState + 1) = v13 + v11;
  result = 0LL;
  LODWORD(xmmword_140F8D850) = v9 - v13;
  return result;
}
