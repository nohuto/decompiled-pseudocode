/*
 * XREFs of HalpInterruptSetDestinationInternal @ 0x140446EB8
 * Callers:
...
__int64 __fastcall HalpInterruptSetDestinationInternal(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    {
LABEL_17:
      HalpInterruptSetProblemEx(v7, 18, 0, (__int64)"minkernel\\hals\\lib\\interrupts\\common\\connect.c", 0x42Fu);
      return (unsigned int)-1073741275;
    }
    if ( *(_BYTE *)(v9[6] + 16LL * v11) )
    {
      HalpInterruptSetProblemEx(v7, 19, 0, (__int64)"minkernel\\hals\\lib\\interrupts\\common\\connect.c", 0x43Cu);
    ...
    *(_QWORD *)&v14 = *(_QWORD *)(v13 + 48);
    ...
    v16 = (_DWORD *)(v13 + 16);
    HalpInterruptFindBestRouting((unsigned int *)&v27, *(_QWORD *)a3);
    _InterlockedOr(v22, 0);
    v17 = HalpInterruptSetLineStateInternal(v7, (__int64)&v27, v13);
    if ( v17 < 0 )
    {
      HalpInterruptSetProblemEx(v7, 7, v17, (__int64)"minkernel\\hals\\lib\\interrupts\\common\\connect.c", 0x463u);
      v19 = v9[5];
      v20 = v24;
      *(_OWORD *)(v19 + v12) = v23;
      v21 = v25;
