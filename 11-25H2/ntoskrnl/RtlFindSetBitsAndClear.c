/*
 * XREFs of RtlFindSetBitsAndClear @ 0x1404AFC00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
            ...
            if ( v31 + (int)v33 >= NumberToFind )
            {
              LODWORD(v36) = -v31;
LABEL_70:
              v9 = ((unsigned int)((v19 - v15) >> 3) << 6) + v36;
              v43 = v9 <= v16;
              goto LABEL_71;
            }
            v34 = NumberToFind;
        ...
        v9 = v44 + ((unsigned int)((v19 - v15) >> 3) << 6);
        v43 = v9 <= v16;
LABEL_71:
        if ( !v43 )
          goto LABEL_72;
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( v23 )
            ...
            v38 = 63 - v37;
          v9 = (((unsigned int)((v19 - v15) >> 3) + 1) << 6) - v38;
          if ( v9 > v16 )
            goto LABEL_72;
