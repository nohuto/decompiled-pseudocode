/*
 * XREFs of PsCreateCpuPartition @ 0x140766A6C
 * Callers:
    ...
    if ( CpuPartition >= 0 )
    {
      ...
      if ( CpuPartition >= 0 )
      {
        ...
        if ( CpuPartition >= 0 )
        {
          ...
          if ( v16 )
            *((_BYTE *)v16 + 10) = 1;
          if ( *(__int64 **)qword_140FD9408 != &PspCpuPartitionListHead )
            __fastfail(3u);
          MEMORY[0x10] = &PspCpuPartitionListHead;
          MEMORY[0x18] = qword_140FD9408;
          *(_QWORD *)qword_140FD9408 = 16LL;
          qword_140FD9408 = 16LL;
          ...
          if ( a6 == &PspSystemCpuPartition
            || (CpuPartition = ObInsertObjectEx(0LL, 0LL, 0, 0LL, (__int64)&Handle), CpuPartition >= 0) )
          {
            *a6 = 0LL;
            if ( a7 )
            {
