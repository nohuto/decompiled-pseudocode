/*
 * XREFs of KiRemoveProcessorFromCoreControlBlock @ 0x1405B7BAC
 * Callers:
...
char __fastcall KiRemoveProcessorFromCoreControlBlock(__int64 a1)
{
  ...
  *v1 = v7;
  if ( !v6 )
    qsort(v1 + 8, v7, 8uLL, (int (__cdecl *)(const void *, const void *))HalpNodeCostSort);
  --*(_BYTE *)(v4 + 24);
  v8 = 0;
  LOBYTE(v9) = *v1;
  if ( *v1 )
