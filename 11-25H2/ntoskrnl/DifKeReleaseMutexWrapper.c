/*
 * XREFs of DifKeReleaseMutexWrapper @ 0x140623990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeReleaseMutexWrapper(PRKMUTANT Mutant, BOOLEAN a2)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(260);
  ...
  DWORD2(v14) = KeReleaseMutant(Mutant, 1, 0, a2);
  if ( v5 )
  {
