/*
 * XREFs of HalpTimerSelectRoles @ 0x140539098
 * Callers:
 ...
 *     HalpTimerFindIdealClockSource @ 0x14053829C (HalpTimerFindIdealClockSource.c)
 *     HalpTimerFindIdealPerformanceCounterSource @ 0x140538500 (HalpTimerFindIdealPerformanceCounterSource.c)
 *     HalpTimerFindIdealScalingSource @ 0x140538650 (HalpTimerFindIdealScalingSource.c)
 *     HalpTimerFindIdealWatchdog @ 0x140538730 (HalpTimerFindIdealWatchdog.c)
 ...
 *     HalpTimerFindBestAlwaysOnTimer @ 0x1405451D8 (HalpTimerFindBestAlwaysOnTimer.c)
...
LABEL_17:
  ...
  if ( (*(_DWORD *)(HalpClockTimer + 224) & 1) == 0 )
  {
    ...
    HalpTimerSetProblemEx(v15, 20, 1, (__int64)"minkernel\\hals\\lib\\timers\\common\\timer.c", 0xD26u);
    return (unsigned int)-1073741823;
  }
LABEL_39:
