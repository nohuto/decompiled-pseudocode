/*
 * XREFs of MiCreatePagingFileMap @ 0x14093E008
 * Callers:
 ...
 *     MiValidateUserPhysicalExternalFlags @ 0x1407E9C98 (MiValidateUserPhysicalExternalFlags.c)
...
LABEL_5:
  ...
  if ( v2 < 0 )
  {
    ...
    v79 = v6;
    v87 = v91;
    v47 = (int *)(qword_140E2D890 + 4LL * v40 * (unsigned int)(unsigned __int16)KeNumberNodes);
    v80 = 512LL;
...
LABEL_32:
  ...
  if ( (v2 & 0x8000000) != 0 )
  {
    ...
    {
      ExfAcquirePushLockExclusiveEx(v12 + 5, v23, (__int64)(v12 + 5));
      v23 = v71;
    }
    if ( v23 )
      *((_BYTE *)v23 + 10) = 1;
