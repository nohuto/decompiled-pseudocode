/*
 * XREFs of DifZwRenameKeyWrapper @ 0x14063B170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRenameKeyWrapper(HANDLE KeyHandle, PUNICODE_STRING NewName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(30);
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = KeyHandle;
    *((_QWORD *)&v13 + 1) = NewName;
  ...
  DWORD2(v14) = ZwRenameKey(KeyHandle, NewName);
  if ( v5 )
  {
