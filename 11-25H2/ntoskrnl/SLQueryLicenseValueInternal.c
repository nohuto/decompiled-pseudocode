/*
 * XREFs of SLQueryLicenseValueInternal @ 0x1407AA53C
 * Callers:
        ...
        if ( a2->Length >= 2u )
        {
          ...
          *((_QWORD *)&v53 + 1) = a2;
          ...
          for ( i = 0; i < 0xE; ++i )
          {
            ...
            v11 = *((unsigned __int16 *)&off_140B2BA00 + 20 * i + 4);
            if ( (_WORD)v10 == (_WORD)v11 )
            {
              ...
              if ( !memcmp(Buf1, *(&off_140B2BA00 + 5 * i), v11) )
              {
                v16 = (__int64)*(&off_140B2BA00 + 5 * i + 2);
                v49 = v16;
                LOBYTE(v7) = *((_BYTE *)&off_140B2BA00 + 40 * i + 32);
                goto LABEL_18;
              }
              v8 = v43;
            }
...
LABEL_18:
          ...
          if ( v47 < 0 )
            goto LABEL_30;
          v21 = sub_1404AEFE0(v20, (__int64)&qword_140B2C478, 0LL, (__int64)&v44, 4, (__int64)&v48);
          ...
          if ( v19 )
          {
            ...
            v26 = a6;
            v27 = guard_dispatch_icall_no_overrides(P);
...
LABEL_54:
              if ( v28 )
              {
                v21 = sub_1404AEFE0(v20, (__int64)&v53, v46, v45, a5, v26);
                if ( v21 == -1073741762 )
                {
              ...
              for ( k = 0; k < 0xE; ++k )
              {
                ...
                v36 = *((unsigned __int16 *)&off_140B2BA00 + 20 * k + 4);
                if ( (_WORD)v35 == (_WORD)v36 )
                {
                  ...
                  if ( !memcmp(Buf1, *(&off_140B2BA00 + 5 * k), v36) )
                  {
                    v32 = (__int64)*(&off_140B2BA00 + 5 * k + 3);
                    break;
                  }
                }
                else
              ...
              if ( v32 && (v21 >= 0 || v21 == -1073741772 || v21 == -1073741275) )
                guard_dispatch_icall_no_overrides(a1);
LABEL_30:
              v7 = (wchar_t *)v41;
              goto LABEL_31;
