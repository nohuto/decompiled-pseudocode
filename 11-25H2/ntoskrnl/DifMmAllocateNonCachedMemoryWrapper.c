/*
 * XREFs of DifMmAllocateNonCachedMemoryWrapper @ 0x140626750
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifMmAllocateNonCachedMemoryWrapper(SIZE_T NumberOfBytes)
{
  ...
  PVOID NonCachedMemory; // [rsp+30h] [rbp-18h]
  ...
  NonCachedMemory = MmAllocateNonCachedMemory(NumberOfBytes);
  if ( v3 )
  {
