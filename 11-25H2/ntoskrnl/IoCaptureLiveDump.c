/*
 * XREFs of IoCaptureLiveDump @ 0x1404D7188
 * Callers:
...
LABEL_40:
            ...
            else
            {
              ...
              if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
              {
                ...
                tlgWriteTransfer_EtwWriteTransfer(
                  ...
                  (unsigned __int8 *)byte_1400456B8,
                  (const GUID *)(v10 + 968),
                  (const GUID *)(v10 + 952),
                  5u,
                  v55);
      ...
      if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E06E80,
          (unsigned __int8 *)word_1400455B2,
          v38,
          v37,
          0xEu,
          &v62);
    ...
    *(_QWORD *)(v10 + 1200) = v10 + 1200;
    ...
    if ( AllowLiveDump && ((*(_DWORD *)(v10 + 80) & 0x200) == 0 || *(_QWORD *)(v10 + 1144)) )
    {
      ...
      if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E06E80,
          (unsigned __int8 *)&byte_14004557F,
          (const GUID *)(v10 + 968),
          (const GUID *)(v10 + 952),
          3u,
          v55);
      ...
      if ( SecureDumpSettings < 0 )
        goto LABEL_39;
      if ( (unsigned int)Feature_Livedump_PPL_UM_Fix__private_IsEnabledDeviceUsageNoInline() )
      {
        if ( (*(_DWORD *)(v10 + 40) & 4) != 0 )
          *(_DWORD *)(v10 + 80) |= 0x18000u;
        *(_QWORD *)(v10 + 1208) = v10 + 1200;
        *(_QWORD *)(v10 + 1200) = v10 + 1200;
      }
      if ( (*(_DWORD *)(v10 + 40) & 8) == 0 || a7 )
      {
