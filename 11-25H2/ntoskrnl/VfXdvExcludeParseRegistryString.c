/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140C2AC20
 * Callers:
...
int VfXdvExcludeParseRegistryString()
{
  ...
  else
  {
    ...
    v2 = 0x100002601LL;
    v3 = (__int64 *)((char *)VfXdvSuppressDriversBuffer + 2 * Entry);
    while ( v1 < v3 )
    {
      v4 = *(unsigned __int16 *)v1;
      if ( (unsigned int)v4 <= 0x20 && _bittest64(&v2, v4) || (_WORD)v4 == 12288 )
      {
...
LABEL_19:
        ...
        if ( v7 )
        {
          ...
          *((_QWORD *)&v11 + 1) = v1;
          ...
          {
            VfDriverLock();
            v9 = (_QWORD *)qword_140F03E38;
            if ( *(__int64 **)qword_140F03E38 != &VfXdvExcludedDriversList )
              __fastfail(3u);
            *v8 = &VfXdvExcludedDriversList;
            v8[1] = v9;
            *v9 = v8;
            qword_140F03E38 = (__int64)v8;
