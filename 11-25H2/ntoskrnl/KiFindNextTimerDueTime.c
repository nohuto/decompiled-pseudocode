/*
 * XREFs of KiFindNextTimerDueTime @ 0x1405C0638
 * Callers:
...
LABEL_68:
    ...
    while ( 2 )
    {
            ...
            k = 0LL )
      {
        ...
        v22 = (_QWORD *)(qword_140FC7528[0] + 8 * (k >> 6));
        for ( m = ((1LL << (k & 0x3F)) - 1) | ~*v22; m == -1; m = ~*v22 )
        {
          if ( (unsigned __int64)++v22 > qword_140FC7528[0] + 8 * (v19 >> 6) )
            goto LABEL_17;
        }
        _BitScanForward64((unsigned __int64 *)&m, ~m);
        v21 = m + (((__int64)v22 - qword_140FC7528[0]) >> 3 << 6);
        if ( v21 > v19 )
        {
LABEL_17:
          LODWORD(v21) = -1;
