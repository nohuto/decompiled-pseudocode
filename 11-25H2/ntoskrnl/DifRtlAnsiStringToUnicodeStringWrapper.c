/*
 * XREFs of DifRtlAnsiStringToUnicodeStringWrapper @ 0x14062D230
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v17) = RtlAnsiStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v7 )
  {
