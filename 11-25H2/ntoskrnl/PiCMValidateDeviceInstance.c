/*
 * XREFs of PiCMValidateDeviceInstance @ 0x140933E98
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  *(_OWORD *)SourceString = 0LL;
  ...
  v13 = PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, (__int64)SourceString[0], 1, 1, 0, (__int64)&Handle);
  if ( v13 >= 0 )
  {
    if ( v12 == 2 && (unsigned __int8)PiAuDoesClientHaveAccess(2u) )
    {
LABEL_46:
      AccessStatus = 4;
      if ( (int)PnpCtxRegQueryValue(v22, Handle, L"Phantom", &v32, &v33, &AccessStatus) >= 0
        && v32 == 4
        && AccessStatus == 4 )
      {
        v28 = v13;
      ...
      if ( v13 >= 0 )
      {
        if ( v8 )
        {
          ...
          if ( RtlInitUnicodeStringEx(&DestinationString, v10) >= 0
            && *(_QWORD *)(v25 + 264)
            && (int)guard_dispatch_icall_no_overrides(v25) >= 0 )
          {
            v33 = 4;
