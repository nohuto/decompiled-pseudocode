/*
 * XREFs of HalpApicRegisterIoUnit @ 0x1405662D8
 * Callers:
...
NTSTATUS __fastcall HalpApicRegisterIoUnit(LARGE_INTEGER PhysicalAddress, int a2, int a3)
{
  ...
  __int64 (__fastcall *v12)(__int64, __int64, __int64, __int64, int, unsigned int *); // [rsp+58h] [rbp-A8h]
  ...
  if ( HalpApicX2Mode )
  {
    ...
    if ( !HalpApicGuestX2Mode )
      v6 = v33 | 0x100;
    HalpApicGetCpuInfo((__int64)&v38);
  }
  else
  {
    v35 = 4;
