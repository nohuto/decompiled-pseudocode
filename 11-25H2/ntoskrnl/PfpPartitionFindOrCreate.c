/*
 * XREFs of PfpPartitionFindOrCreate @ 0x14073B3C0
 * Callers:
...
__int64 __fastcall PfpPartitionFindOrCreate(PEX_RUNDOWN_REF_CACHE_AWARE **a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)dword_140E074B8 > 4 && tlgKeywordOn((__int64)&dword_140E074B8, 1LL) )
  {
    ...
    v16 = 4;
    v15 = &v12;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)&dword_140047CC4, 0LL, 0LL, 3u, v14);
  }
...
LABEL_9:
  if ( (unsigned int)dword_140E074B8 > 4 && tlgKeywordOn((__int64)&dword_140E074B8, 1LL) )
  {
    ...
    v18 = &v13;
    v19 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)word_140047C52, 0LL, 0LL, 4u, v14);
  }
