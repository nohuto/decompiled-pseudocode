/*
 * XREFs of DrvDbGetDriverDatabaseCompositeMappedPropertyKeys @ 0x140811C2C
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  {
    result = DrvDbGetDriverDatabaseMappedProperty(a1, a2, a3, off_140E0A2E0[i], &v19, 0LL, 0, &a5);
