/*
 * XREFs of IvtInitializeIdentityMappings @ 0x14056BC28
 * Callers:
 ...
 *     IvtInitializeLargePagePte @ 0x14056BE0C (IvtInitializeLargePagePte.c)
...
__int64 __fastcall IvtInitializeIdentityMappings(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 336) = v5;
  ...
  else
  {
    ...
    {
      v7 = *(_QWORD *)(a1 + 336);
      v8 = guard_dispatch_icall_no_overrides(-1LL);
      v9 = v8;
      if ( !v8 )
        return 3221225473LL;
