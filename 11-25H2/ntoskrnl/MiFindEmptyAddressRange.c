/*
 * XREFs of MiFindEmptyAddressRange @ 0x1408FFD20
 * Callers:
 ...
 *     MiFindClearVadBitsAligned @ 0x1409E09F0 (MiFindClearVadBitsAligned.c)
 *     MiFindEmptyAddressRangeInTree @ 0x140A15654 (MiFindEmptyAddressRangeInTree.c)
 */
...
LABEL_27:
    ...
    {
      v27 = (ClearBits + 8 * (v20 - qword_140E2F048)) << 16;
