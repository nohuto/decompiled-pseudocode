/*
 * XREFs of ViDeadlockAddResource @ 0x140B888A0
 * Callers:
 ...
 *     VfUtilAddressRangeAdd @ 0x140B73138 (VfUtilAddressRangeAdd.c)
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      ViDeadlockPreprocessOptions(byte_140E0E79C, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 0LL, byte_140E0E79C);
    }
    if ( *(_QWORD *)(v11 + 16) )
    {
      ViDeadlockPreprocessOptions(byte_140E0E7A8, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 1uLL, byte_140E0E7A8);
    }
