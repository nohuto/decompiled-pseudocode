/*
 * XREFs of HalpTimerQueryHostPerformanceCounter @ 0x140538EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpTimerQueryHostPerformanceCounter(_QWORD *a1, __int64 a2)
{
  ...
  if ( !HalpPerformanceCounter || *(_DWORD *)(HalpPerformanceCounter + 228) != 8 || !qword_140FC0890 || !qword_140FC0728 )
    return 3221225659LL;
