/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x140792E50
 * Callers:
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(_QWORD *a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140F01500 < 0x400 )
    {
      ...
      if ( v7 )
      {
        ...
        *v8 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140F01500++] = v8;
        a1[5] = v8;
      }
      else
      {
