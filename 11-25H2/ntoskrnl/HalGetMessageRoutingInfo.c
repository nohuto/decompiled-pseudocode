/*
 * XREFs of HalGetMessageRoutingInfo @ 0x140200F50
 * Callers:
 *     IopConnectMessageBasedInterrupt @ 0x1409A30BC (IopConnectMessageBasedInterrupt.c)
 * Callees:
 *     HalpInterruptAffinityIsSteerable @ 0x14020153C (HalpInterruptAffinityIsSteerable.c)
  ...
  *(_QWORD *)&v32 = 0LL;
  if ( v8 == 1 )
  {
    ...
    *((_QWORD *)&v32 + 1) = v5 & ~(1LL << v11);
    v13 = *((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v11);
    v36 = *((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v11);
    if ( v35 )
    {
      while ( (int)v12 >= 0 )
      {
...
LABEL_24:
      ...
      v5 &= ~(1LL << v17);
      v18 = *((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v17);
      v36 = *((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v17);
    }
  }
  if ( HalpInterruptClusterModeEnabled )
  {
...
LABEL_48:
    ...
    v5 &= ~(1LL << v25);
    v26 = *((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v25);
    v36 = *((_DWORD *)qword_140F216A8 + 64 * (unsigned __int16)v9 + (unsigned __int8)v25);
  }
  if ( !DWORD2(v34) )
    return 3221225485LL;
LABEL_12:
