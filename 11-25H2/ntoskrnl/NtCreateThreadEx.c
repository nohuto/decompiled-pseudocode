/*
 * XREFs of NtCreateThreadEx @ 0x1408EFF10
 * Callers:
 *     <none>
 * Callees:
        ...
        (int)result >= 0) )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (*((_BYTE *)Object + 368) & 1) == 0 )
      {
        ...
        v37 = qword_140FC6480;
        RtlGetExtendedContextLength2((int)Object, &v31, (unsigned int)v20);
        v21 = v31 + 15LL;
        if ( v21 <= v31 )
        ...
        v15 = v24;
        memset_0(v24, 0, v31);
        RtlInitializeExtendedContext2((__int64)v24, (int)Object, &v36, v20);
        v42 = v37;
        v33 = v35;
