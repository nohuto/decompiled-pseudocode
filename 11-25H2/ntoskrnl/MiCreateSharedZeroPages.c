/*
 * XREFs of MiCreateSharedZeroPages @ 0x14023B000
 * Callers:
...
__int64 __fastcall MiCreateSharedZeroPages(__int64 a1, __int64 *a2)
{
  ...
  char v37[8]; // [rsp+88h] [rbp-21h] BYREF
  ...
  if ( !v4 )
  {
    ...
    v9 = MiSharedVaToPartition(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 56LL), v7, *(_QWORD *)(a1 + 24));
    v10 = *(_QWORD *)(a1 + 8);
    v11 = *(_DWORD *)(a1 + 48);
    v12 = *a2;
    v31 = v9;
    ...
    v33 = v7;
    v34 = v11;
    MiInitializePageColorBase(v32, 3, v11, (__int64)v37);
...
LABEL_8:
  ...
  for ( i = v7 & 0xFFFFFFFFFFFFF000uLL; v46 < (unsigned __int64)*a2; ++v46 )
  {
    ...
    v21 = 0xAAAAAAAAAAAAAAABuLL * ((__int64)(v20 + 0x220000000000LL) >> 4);
    if ( (MiFlags & 0x80u) != 0LL && (++dword_140E2FF28 & MmPageValidationFrequency) == 0 )
    {
      MiArePageContentsZero(0xAAAAAAAAAAAAAAABuLL * ((__int64)(v20 + 0x220000000000LL) >> 4));
    ...
    if ( (*(_DWORD *)a1 & 2) != 0 || (((_DWORD)v22 - 4) & 0xFFFFFFFD) != 0 )
      v18 |= 0x20u;
    MiInitializePfn(v20, v2, (unsigned int)v22, v18);
