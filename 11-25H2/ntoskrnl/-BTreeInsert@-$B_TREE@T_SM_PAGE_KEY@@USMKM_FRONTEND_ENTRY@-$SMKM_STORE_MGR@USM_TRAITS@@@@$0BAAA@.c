/*
 * XREFs of ?BTreeInsert@?$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@$0BAAA@UB_TREE_DUMMY_NODE_POOL@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAJPEAU1@PEAUSMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@PEAUSEARCH_RESULT@1@@Z @ 0x1403D4730
 * Callers:
...
LABEL_6:
  ...
  *(_DWORD *)(a3 + 24) = 0;
  ...
  if ( *v11 >= v10 || (unsigned int)SmArrayGrow(v10, (__int64)a2, v11, (const void **)a3) )
  {
    v4 = *(_QWORD **)a3;
    goto LABEL_6;
  }
