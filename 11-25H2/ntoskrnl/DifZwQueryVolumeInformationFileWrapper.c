/*
 * XREFs of DifZwQueryVolumeInformationFileWrapper @ 0x14063AC30
 * Callers:
 *     <none>
 * Callees:
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v11 = 0;
    *(_QWORD *)&v19 = a1;
    *((_QWORD *)&v17 + 1) = __PAIR64__(a4, FsInformationClass);
    *((_QWORD *)&v18 + 1) = a2;
    *(_QWORD *)&v18 = a3;
  ...
  DWORD2(v19) = ZwQueryVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v9 )
  {
