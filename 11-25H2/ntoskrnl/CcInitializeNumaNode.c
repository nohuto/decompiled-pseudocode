/*
 * XREFs of CcInitializeNumaNode @ 0x14057A7DC
 * Callers:
...
char __fastcall CcInitializeNumaNode(__int64 a1, _DWORD *a2, __int64 a3, unsigned int a4)
{
  ...
  *((_QWORD *)a2 + 20) = a2 + 40;
  ...
  {
    PoolWithTagFromNode = ExAllocatePoolWithTagFromNode((__int64)v7, 0x50uLL, 0x71576343uLL, v13);
...
LABEL_16:
  ...
  {
    v16 = ExAllocatePoolWithTagFromNode((__int64)v7, 0x50uLL, 0x71576343uLL, v13);
    if ( !v16 )
      goto LABEL_16;
    *(_DWORD *)(v16 + 36) = -1;
    *(_DWORD *)(v16 + 32) = 2;
  ...
  {
    v18 = ExAllocatePoolWithTagFromNode((__int64)v7, 0x50uLL, 0x71576343uLL, v13);
    if ( !v18 )
      goto LABEL_16;
    *(_DWORD *)(v18 + 36) = -1;
    *(_DWORD *)(v18 + 32) = 5;
