/*
 * XREFs of MiValidateMdlAllocationRequest @ 0x140415AF4
 * Callers:
...
LABEL_15:
  ...
  if ( (v14 & 0x40) != 0 )
  {
    if ( (v17 & 0xFFFFFFFFFFEFFFFFuLL) != 0 || v18 < *(_QWORD *)(a2 + 18504) )
      return 3221225485LL;
    v26 = 0;
    v27 = MiPageSizes;
    while ( v19 != *v27 )
  ...
  *((_QWORD *)a1 + 5) = (~*(_DWORD *)(a2 + 4) & 0x10LL) << 6;
  v23 = *(_QWORD *)(a2 + 18752) - *((_QWORD *)a1 + 5);
  if ( (__int64)v23 <= 0 )
    return 3221225485LL;
  if ( v22 > v23 )
  {
...
LABEL_20:
  ...
  *((_QWORD *)a1 + 4) = v23;
  ...
  if ( KeGetCurrentIrql() == 2 )
    a1[37] = v24 | 4;
  if ( (v14 & 0x40) != 0 )
    MiInitializeDemandCoalesceContext((_QWORD *)a1 + 10, v19, v23 / v19, 1);
  return 0LL;
}
