/*
 * XREFs of _CmGetMatchingFilteredDeviceListWorker @ 0x14095F4C0
 * Callers:
...
__int64 __fastcall CmGetMatchingFilteredDeviceListWorker(
        ...
        const wchar_t *a2,
        int a3,
        char (__fastcall *a4)(__int64 a1, int a2, __int64 a3, __int64 a4),
        _QWORD *a5,
        _WORD *a6,
        unsigned int a7,
        _DWORD *a8,
        __int16 a9)
{
  char (__fastcall *v9)(__int64, int, __int64, __int64); // rdi
  ...
  char (__fastcall *v21)(__int64, int, __int64, __int64); // [rsp+70h] [rbp-10h]
