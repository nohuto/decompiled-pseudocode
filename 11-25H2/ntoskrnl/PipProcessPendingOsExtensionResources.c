/*
 * XREFs of PipProcessPendingOsExtensionResources @ 0x140C14EB4
 * Callers:
...
__int64 PipProcessPendingOsExtensionResources()
{
  ...
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    {
      CachedContextBaseKey = PipProcessPendingObjects(v5, 0LL, v3, (__int64)PipCommitPendingOsExtensionResource);
    }
  }
  if ( v5 )
