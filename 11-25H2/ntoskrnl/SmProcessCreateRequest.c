/*
 * XREFs of SmProcessCreateRequest @ 0x1409C16A4
 * Callers:
...
__int64 __fastcall SmProcessCreateRequest(struct _SM_PARTITION *a1, unsigned __int64 a2, int a3, KPROCESSOR_MODE a4)
{
  ...
  __int64 v31[2]; // [rsp+70h] [rbp-F8h] BYREF
...
LABEL_14:
  if ( TimeInit < 0 )
    goto LABEL_31;
  v15 = *(_DWORD *)v31[0];
  if ( (*(_DWORD *)v31[0] & 0x200FF) != 0x20000 || (v15 & 0x300) != 0 )
    goto LABEL_41;
  ...
  if ( !(unsigned __int8)*(_DWORD *)v31[0] && (*(_DWORD *)v31[0] & 0x20000) != 0 && *(_DWORD *)(v31[0] + 8) > 0x20000u )
  {
LABEL_41:
    TimeInit = -1073741637;
    goto LABEL_31;
  ...
  if ( v17 )
  {
    ...
    TimeInit = SmFirstTimeInit(a1, *(_DWORD *)(v31[0] + 8));
    if ( TimeInit >= 0 )
    {
      v34 = a1;
      v35 = *((_QWORD *)a1 + 271);
