/*
 * XREFs of sub_140A3626C @ 0x140A3626C
 * Callers:
...
__int64 __fastcall sub_140A3626C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rdx
  unsigned int *v8; // rax
  unsigned int i; // r9d
  ...
  v12 = guard_dispatch_icall_no_overrides(v20);
  if ( (v12 & 0x80000000) != 0 )
    return v12;
  v28 = *(_DWORD *)(a2 + 32);
