/*
 * XREFs of MmEnumerateBadPages @ 0x1407DD2F8
 * Callers:
...
__int64 __fastcall MmEnumerateBadPages(_QWORD *a1)
{
  ...
  *a1 = 0LL;
  ...
  v6 = KeAbPreAcquire((__int64)&qword_140E2FD08, 0LL);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140E2FD08, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140E2FD08, 0, v6, (unsigned __int64)&qword_140E2FD08);
  if ( v6 )
    *((_BYTE *)v6 + 10) = 1;
