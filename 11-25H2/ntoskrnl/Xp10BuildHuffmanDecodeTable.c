/*
 * XREFs of Xp10BuildHuffmanDecodeTable @ 0x14077A160
 * Callers:
            ...
            do
            {
              ...
              if ( v40 > 8 )
              {
                ...
                do
                {
                  ...
                  v30 -= 8;
                  v31 >>= 8;
                  v32 = *((unsigned __int8 *)qword_1400330C0 + v33) | (v32 << 8);
                  --v24;
                }
                while ( v24 );
              }
              if ( v30 )
                v32 = (*((unsigned __int8 *)qword_1400330C0 + (unsigned __int8)v31) | (v32 << 8)) >> (8 - v30);
