/*
 * XREFs of EmonOverflowHandlerInternalV1Original @ 0x140559D58
 * Callers:
 *     EmonOverflowHandlerOriginal @ 0x14055AAE0 (EmonOverflowHandlerOriginal.c)
 * Callees:
 *     KeQueryPerformanceCounter @ 0x14031B970 (KeQueryPerformanceCounter.c)
 *     KeProfileInterruptWithSource @ 0x140498550 (KeProfileInterruptWithSource.c)
 *     EmonIsModifiedByBadActorInternalOriginal @ 0x1404F1C8C (EmonIsModifiedByBadActorInternalOriginal.c)
 *     PoGetProcessorIdleAccounting @ 0x1404F80C0 (PoGetProcessorIdleAccounting.c)
