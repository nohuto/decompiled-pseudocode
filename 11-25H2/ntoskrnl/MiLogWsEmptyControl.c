/*
 * XREFs of MiLogWsEmptyControl @ 0x1404AE0C0
 * Callers:
...
void __fastcall MiLogWsEmptyControl(__int64 a1)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    if ( **(_DWORD **)&qword_140E372D8 > 5u
      && (*(_BYTE *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 0x10) != 0
      && (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) & 0x10LL) == *(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) )
    {
      v3 = *(_DWORD *)(a1 + 184);
      v15 = 0;
      v9 = v3 & 0xF;
      ...
      v10 = v4;
      v11 = v5;
      tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&word_140056466, v6, 1u, v7, v8, 6u, &v12);
    }
  }
}
