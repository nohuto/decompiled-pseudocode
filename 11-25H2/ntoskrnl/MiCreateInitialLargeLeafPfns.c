/*
 * XREFs of MiCreateInitialLargeLeafPfns @ 0x140443314
 * Callers:
 ...
 * Callees:
 *     MiInitializePfnEntriesRaw @ 0x140443488 (MiInitializePfnEntriesRaw.c)
 */
        ...
        int a6)
{
  ...
  do
  {
    *(_QWORD *)((char *)&v15 + v7) = *(_QWORD *)((char *)&unk_140E2FC00 + v7);
    v7 += 8LL;
    --v9;
  }
  while ( v9 );
