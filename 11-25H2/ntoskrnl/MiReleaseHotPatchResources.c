/*
 * XREFs of MiReleaseHotPatchResources @ 0x140AAF5C8
 * Callers:
...
void __fastcall MiReleaseHotPatchResources(__int64 a1)
{
  ...
  if ( v2 )
  {
    PteAddress = (unsigned __int64 *)MiGetPteAddress(*(_QWORD *)(v2 + 24));
    MiReleasePtes((__int64)&qword_140E37328, PteAddress, v4);
