/*
 * XREFs of PspCopyNodeRelativeMaskToAffinityEx @ 0x140C239E8
 * Callers:
  ...
  *a3 = 1;
  ...
  if ( !(_DWORD)result )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_DWORD)result )
        break;
      if ( ((*(char *)(((unsigned __int64)*(unsigned int *)(KiProcessorBlock[v8] + 36396) >> 3) + *(_QWORD *)(a2 + 8)) >> (*(_DWORD *)(KiProcessorBlock[v8] + 36396) & 7)) & 1) != 0 )
