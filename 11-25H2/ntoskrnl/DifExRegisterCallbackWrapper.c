/*
 * XREFs of DifExRegisterCallbackWrapper @ 0x140613D40
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID CallbackContext)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = CallbackObject;
    *(_QWORD *)&v16 = CallbackFunction;
    *((_QWORD *)&v15 + 1) = CallbackContext;
  ...
  v17 = ExRegisterCallback(CallbackObject, CallbackFunction, CallbackContext);
  if ( v7 )
  {
