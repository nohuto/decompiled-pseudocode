...
_OWORD *__fastcall MiProtectSystemImage(__int64 a1, int a2)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( v2 == v5 || v2 == PsHalImageBase )
      return (_OWORD *)MiActOnLargeKernelHalPages(v2);
  }
  else
  {
    ...
    v8 = (_OWORD *)(v6 + *(unsigned __int16 *)(v6 + 20) + 24LL);
    ...
    while ( v9 )
    {
      ...
      if ( *v10 < *(v10 - 2) )
        v12 = *(v10 - 2);
      --v9;
      result = (_OWORD *)(-(__int64)*(unsigned int *)(v6 + 56) & (v11 + *(unsigned int *)(v6 + 56) + v12 - 1LL));
      v10 += 10;
    }
    v37 = -1073741824;
    v43 = (char *)v8 + 40 * v7 - 1;
    ...
    do
    {
      ...
      if ( v25 == v37 && (v26 = *(_DWORD *)(v42 + 56), v26 <= 0x1000) )
      {
        v27 = v26;
      }
      else
      {
        ...
        PteAddress = v18;
        v37 = v25;
        v27 = *(unsigned int *)(v42 + 56);
      }
      v8 = (_OWORD *)((char *)v8 + 40);
      result = (_OWORD *)(v27 + v35);
      v13 = (-v27 & ((unsigned __int64)result + v39 - 1)) - 1;
      v43 = (char *)v13;
      --v17;
    }
    while ( v17 );
