/*
 * XREFs of PopDiagTracePerfTrackData @ 0x140A598C4
 * Callers:
...
char __fastcall PopDiagTracePerfTrackData(__int16 a1)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      ...
      v38 = PopQpcTimeInMs(&qword_140F0B0C0, &qword_140F0B0C8);
      v37 = PopQpcTimeInMs(&qword_140F0B0B0, &qword_140F0B0B8);
      if ( qword_140F0B0A8 )
      {
        v36 = 0LL;
        v33 = PopQpcTimeInMs(&v36, &qword_140F0B0A8);
        v18 = PopQpcTimeInMs(&qword_140F0B088, &qword_140F0B090);
        v17 = (const EVENT_DESCRIPTOR *)POP_ETW_EVENT_PERFTRACK_STANDBY;
        v31 = v33 + v18;
        v13 = 5;
        *(_QWORD *)&UserData.Size = 4LL;
        UserData.Ptr = (ULONGLONG)&qword_140F0B270;
        v45 = &v31;
        v47 = &v33;
        v49 = &v37;
        v51 = &v38;
      ...
      result = dword_140F0B2B8;
      if ( !dword_140F0B2B8 )
        return result;
      v4 = qword_140F0B120;
      v34 = (4 * dword_140F0B2B8) & 0x3FFFFF;
      v40 = qword_140F0B120;
      v35 = qword_140F0B0F0 / v3;
      result = qword_140F0B2C8;
      v31 = qword_140F0B2C8;
      if ( (a1 & 8) != 0 )
      {
        if ( !PopShutdownButtonPressTime )
          return result;
        v32 = PopQpcTimeInMs(&PopShutdownButtonPressTime, &qword_140F0B068) + v4;
        if ( (int)PopReadRegKeyValue(
          ...
          v5 = PopQpcTimeInMs(&v36, &qword_140F0B128);
        v39 = v5;
        *(_QWORD *)&UserData.Size = 4LL;
        ...
        PopComputeDerivedHiberStats(&qword_140F0B0D8, v3, &v41);
        LODWORD(v42) = v31;
        v6 = (unsigned __int64)qword_140F0B2A0 >> 8;
        WORD3(v42) = -1;
        if ( (unsigned __int64)qword_140F0B2A0 >> 8 > 0x7FFF )
          LOWORD(v6) = 0x7FFF;
        WORD2(v42) = v6 & 0x7FFF;
        if ( (unsigned __int64)qword_140F0B2A8 >> 8 <= 0xFFFF )
          WORD3(v42) = (unsigned int)qword_140F0B2A8 >> 8;
        WORD4(v42) = -1;
        if ( 1000 * qword_140F0B140 / PopQpcFrequency <= 0xFFFF )
          WORD4(v42) = 1000 * qword_140F0B140 / PopQpcFrequency;
        WORD5(v42) = -1;
        if ( qword_140F0B230 / v3 <= 0xFFFF )
          WORD5(v42) = qword_140F0B230 / v3;
        WORD6(v42) = -1;
        if ( (unsigned int)qword_140F0B130 <= 0xFFFF )
          WORD6(v42) = qword_140F0B130;
        HIWORD(v42) = -1;
        if ( (unsigned int)qword_140F0B270 <= 0xFFFF )
          HIWORD(v42) = qword_140F0B270;
        v7 = WORD2(v41);
        v8 = HIDWORD(v41);
        HIWORD(v43) = -1;
        if ( DWORD1(v41) > 0x3FF )
        ...
        if ( HIDWORD(v41) > 0x1FF )
          v8 = 511;
        v10 = 1000 * (qword_140F0B1C0 - qword_140F0B1F8) / PopQpcFrequency;
        v11 = v9 ^ (v9 ^ (v8 << 10)) & 0x7FC00;
        if ( v10 > 0x1FFF )
          LODWORD(v10) = 0x1FFF;
        LODWORD(v43) = v11 & 0x7FFFF | ((_DWORD)v10 << 19);
        v12 = (unsigned __int64)qword_140F0B280 >> 8;
        if ( (unsigned __int64)qword_140F0B280 >> 8 > 0x7FFF )
          LOWORD(v12) = 0x7FFF;
        WORD2(v43) = v12 & 0x7FFF;
        if ( (unsigned __int64)qword_140F0B288 >> 8 <= 0xFFFF )
          HIWORD(v43) = (unsigned int)qword_140F0B288 >> 8;
        v13 = 6;
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v19 = qword_140F0B130;
      if ( (_DWORD)qword_140F0B130 )
      {
        PopComputeDerivedHiberStats(&qword_140F0B0D8, v3, &v41);
        LODWORD(v42) = v31;
        v20 = (unsigned __int64)qword_140F0B2A0 >> 8;
        if ( (unsigned __int64)qword_140F0B2A0 >> 8 > 0x7FFF )
          LOWORD(v20) = 0x7FFF;
        ...
        if ( HIDWORD(v41) > 0x1FF )
          v22 = 511;
        v24 = 1000 * (qword_140F0B1C0 - qword_140F0B1F8) / PopQpcFrequency;
        v25 = v23 ^ (v23 ^ (v22 << 10)) & 0x7FC00;
        if ( v24 > 0x1FFF )
          LODWORD(v24) = 0x1FFF;
        LODWORD(v43) = v25 & 0x7FFFF | ((_DWORD)v24 << 19);
        v26 = (unsigned __int64)qword_140F0B280 >> 8;
        if ( (unsigned __int64)qword_140F0B280 >> 8 > 0x7FFF )
          LOWORD(v26) = 0x7FFF;
