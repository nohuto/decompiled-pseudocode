/*
 * XREFs of MiMapNewPfns @ 0x1407D97EC
 * Callers:
...
__int64 __fastcall MiMapNewPfns(__int64 a1)
{
  ...
  v21 = v7;
  v22 = v7 + v8 - 1;
  result = MiCreateIoPageExclusion(&v19, (v11 >> 1) & 1);
  if ( (int)result >= 0 )
  {
    if ( v8 >= 0x40000 && qword_140E3D210 >= 0x200000 )
    {
    ...
    MiRemoveIoPageExclusion((__int64)&v19);
    return v3;
  }
  return result;
}
