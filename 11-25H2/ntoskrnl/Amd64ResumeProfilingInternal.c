/*
 * XREFs of Amd64ResumeProfilingInternal @ 0x1405693CC
 * Callers:
 *     Amd64ResumeProfiling @ 0x140569390 (Amd64ResumeProfiling.c)
 * Callees:
 *     <none>
 */

unsigned __int64 __fastcall Amd64ResumeProfilingInternal(int a1, unsigned int a2)
{
  __int64 v2; // r10
...
LABEL_23:
    ...
    if ( *(_DWORD *)v4 != 1 )
    {
      if ( *(_DWORD *)v4 != 100 )
      {
        ...
        {
LABEL_22:
          v11 = *((_DWORD *)&Amd64EventSelectRegisters + (unsigned int)(v8 + v7));
          v12 = __readmsr(v11);
          result = (unsigned int)v12 | 0x400000LL;
