/*
 * XREFs of HvlpInitializePowerStatistics @ 0x140586330
 * Callers:
...
__int64 HvlpInitializePowerStatistics()
{
  ...
  if ( (HvlEnlightenments & 0x400) != 0 )
  {
    ...
    *(_DWORD *)v1 = 4;
    ...
    if ( !v3 )
    {
      xmmword_140E3EA90 = *(_OWORD *)v2;
      xmmword_140E3EAA0 = *((_OWORD *)v2 + 1);
      unk_140E3EAB0 = *((_OWORD *)v2 + 2);
      qword_140E3EAC0 = v2[6];
    }
