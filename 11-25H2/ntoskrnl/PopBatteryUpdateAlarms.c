/*
 * XREFs of PopBatteryUpdateAlarms @ 0x140A0F870
 * Callers:
  ...
  if ( (unsigned int)a2 < v18 )
  {
    ...
    do
    {
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_ACTION + v21),
                  a2,
                  v2,
                  &v28,
                  4u,
      ...
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_LEVEL + v21),
                  v22,
                  v2,
                  &v28,
                  4u,
      ...
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_FLAGS + v21),
                  v23,
                  v2,
                  &v28,
                  4u,
