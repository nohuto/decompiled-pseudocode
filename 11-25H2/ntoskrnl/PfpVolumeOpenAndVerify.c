/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x1408E9330
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x1408EAE18 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x1404BDA14 (PfVolumeSupportedForPrefetch.c)
  ...
  *(_QWORD *)v28 = 48LL;
  ...
  if ( File >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      ...
      NtClose(FileHandle);
      FileHandle = 0LL;
      DevicePowerState = PfpOpenHandleCreate((__int64)&v24, a1, (__int64)&v18, 0LL, 1048960, 32, 0, 0LL);
      if ( DevicePowerState < 0 )
        goto LABEL_13;
...
LABEL_10:
        ...
        if ( Pool2 )
        {
          ...
          *((_WORD *)P + ((unsigned __int64)(unsigned __int16)v22 >> 1)) = 0;
          DevicePowerState = PfpOpenHandleCreate((__int64)&v26, a1, (__int64)&v22, 0LL, 1179785, 33, 128, (__int64)&v24);
          if ( DevicePowerState >= 0 )
          {
...
LABEL_13:
  ...
  if ( (v7 & 0x400000000LL) != 0 )
    PfpOpenHandleClose((__int64)&v26, a1);
