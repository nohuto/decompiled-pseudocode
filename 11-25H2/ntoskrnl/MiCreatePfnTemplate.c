/*
 * XREFs of MiCreatePfnTemplate @ 0x1406609D0
 * Callers:
...
LABEL_5:
  ...
  if ( (a2 & 2) != 0 )
  {
    *(_QWORD *)(a1 + 40) |= 0x20000000000000uLL;
    if ( (a2 & 4) != 0 )
    {
      HIWORD(v10) = HIWORD(*(_DWORD *)(a1 + 32));
      LOWORD(v10) = 1;
      *(_DWORD *)(a1 + 32) = v10;
  ...
  *(_QWORD *)(a1 + 40) = (v3 << 43) ^ (*(_QWORD *)(a1 + 40) ^ (v3 << 43)) & 0xFFE007FFFFFFFFFFuLL;
  if ( (a2 & 0x180) != 0 )
  {
    ...
    *(_QWORD *)(a1 + 16) = DemandZeroPte;
    ...
    HIWORD(v12) = HIWORD(*(_DWORD *)(a1 + 32));
    LOWORD(v12) = 2;
    *(_DWORD *)(a1 + 32) = v12;
