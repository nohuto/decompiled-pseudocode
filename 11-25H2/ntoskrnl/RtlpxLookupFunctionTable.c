      ...
      if ( *((_BYTE *)RtlpInvertedFunctionTable + 12) )
      {
        ...
        if ( PsLoadedModuleList )
        {
          while ( v27 != &PsLoadedModuleList )
          {
            ...
            v30 = *(_QWORD *)&KeNumberProcessorsGroup0[9];
            if ( v29 == v30 || v29 == PsHalImageBase )
              v31 = dword_140E3726C;
            else
...
LABEL_78:
              v37 = v29 + *((unsigned int *)v27 + 16);
            if ( a1 < v37 && a1 >= v29 )
            {
              v25 = v27[2];
              *(_QWORD *)a2 = v25;
              *(_DWORD *)(a2 + 16) = v37 - v29;
              *(_QWORD *)(a2 + 8) = v29;
            ...
            {
              if ( a1 >= v37 && a1 < v37 + v28 )
              {
                v43 = *(_QWORD *)&KeNumberProcessorsGroup0[9];
                if ( v29 != v43 && v29 != PsHalImageBase )
                {
                  *(_QWORD *)(a2 + 8) = v37;
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        if ( v19 < v5 )
          goto LABEL_44;
        v20 = (v5 + v19) >> 1;
        v21 = *(_QWORD *)&RtlpInvertedFunctionTable[6 * v20 + 6];
...
LABEL_35:
      ...
      if ( a1 < v23 + v18 )
      {
        v26 = *(_QWORD *)&KeNumberProcessorsGroup0[9];
        if ( v21 != v26 )
          break;
      }
LABEL_31:
...
LABEL_12:
    ...
    if ( a1 < v13 + v8 )
    {
      v16 = *(_QWORD *)&KeNumberProcessorsGroup0[9];
      if ( v11 != v16 )
        break;
    }
LABEL_9:
