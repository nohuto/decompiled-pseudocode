/*
 * XREFs of ExLogTimeZoneInformation @ 0x1404DA5AC
 * Callers:
...
int ExLogTimeZoneInformation()
{
  ...
  if ( (unsigned int)dword_140E09230 > 5 )
  {
    ...
    v28 = 1;
    v31 = 8;
    tlgCreate1Sz_wchar_t((__int64)v33, (const WCHAR *)&Blink[10].Blink + 2);
    v4 = *((_BYTE *)v3 + 428);
    v36 = 0;
    v39 = 0;
    v42 = 0;
    ...
    LODWORD(CurrentServerSiloGlobals) = tlgWriteTransfer_EtwWriteTransfer(
                                          (__int64)&dword_140E09230,
                                          (unsigned __int8 *)byte_140052740,
                                          0LL,
                                          0LL,
                                          0xEu,
                                          &v17);
