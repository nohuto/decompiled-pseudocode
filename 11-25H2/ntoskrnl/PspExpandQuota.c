/*
 * XREFs of PspExpandQuota @ 0x1403C6748
 * Callers:
 ...
 *     MmRaisePoolQuota @ 0x1403C68D0 (MmRaisePoolQuota.c)
...
char __fastcall PspExpandQuota(unsigned int a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 *a5)
{
  ...
  if ( *((__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))v7 + 3) == MmRaisePoolQuota )
    ...
    v13 = guard_dispatch_icall_no_overrides(a1, v12);
  if ( v13 || PspReleaseReturnedQuota(a1, v7) && (unsigned __int8)guard_dispatch_icall_no_overrides(a1, v11) )
  {
    v15 = v20 - v11;
