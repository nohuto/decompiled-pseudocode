/*
 * XREFs of ViDeadlockAnalyze @ 0x140B88C04
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x140B8886C (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x140B88C04 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x140B88E68 (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_140E0E7A0);
      return 0LL;
    }
    v8 = 0;
  }
