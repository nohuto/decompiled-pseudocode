/*
 * XREFs of ExpSetBootEntry @ 0x1407ACEAC
 * Callers:
 *     NtAddBootEntry @ 0x1407AE080 (NtAddBootEntry.c)
 *     NtModifyBootEntry @ 0x1407AEAB0 (NtModifyBootEntry.c)
 * Callees:
...
LABEL_88:
    ...
    else
    {
      ...
      if ( EnvironmentVariable != -1073741789 )
        goto LABEL_88;
      v28 = (_FILE_PATH *)ExAllocatePool2(0x40uLL);
      v41 = v28;
      if ( !v28 )
      {
...
LABEL_56:
      ...
      v32 = (_WORD *)ExAllocatePool2(0x40uLL);
      v33 = v32;
      P = v32;
      if ( v32 )
      {
