/*
 * XREFs of KiRcuProcessorInitialize @ 0x1404D6218
 * Callers:
...
__int64 __fastcall KiRcuProcessorInitialize(__int64 a1, unsigned int a2)
{
  ...
  v3 = *(_DWORD *)(a1 + 36) / (unsigned int)(unsigned __int8)byte_140F20481;
  v5 = 0;
  v6 = (char *)&KiRcuData + 32 * *(unsigned int *)(a1 + 36);
  v7 = *(_DWORD *)(a1 + 36) % (unsigned int)(unsigned __int8)byte_140F20481;
  v8 = 9 * v3;
  v9 = qword_140F20490;
  *((_QWORD *)v6 + 2) = a1;
  v10 = (_QWORD *)(v9 + 8 * v8);
