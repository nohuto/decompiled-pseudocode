/*
 * XREFs of MiPfnToStandbyLookaside @ 0x140216480
 * Callers:
...
__int64 __fastcall MiPfnToStandbyLookaside(ULONG_PTR BugCheckParameter2, int *a2, __int64 a3, __int64 *a4)
{
  ...
  else if ( BugCheckParameter2 >= qword_140E358C0 && BugCheckParameter2 < qword_140E358C0 + 2048 )
  {
    v9 = 9;
  }
  else if ( byte_140E3C8A6 )
  {
    ...
    if ( *(_BYTE *)(qword_140E3CF00 + 2 * v22) )
      v9 = *(unsigned __int8 *)(qword_140E3CF00 + 2 * v22) - 1;
    else
      v9 = 9;
  }
  else
  ...
  a4[1] = v8;
  *a4 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v8 + 40) >> 43) & 0x3FFLL));
  v10 = dword_140E2D884;
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (v11 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, BugCheckParameter2 < *(_QWORD *)v11)
    || dword_140E2D880 != dword_140E2D884 && BugCheckParameter2 >= *((_QWORD *)v11 + 2) )
  {
    for ( i = 0; ; i = v13 + 1 )
    {
      while ( 1 )
      ...
      if ( v13 == dword_140E2D884 || BugCheckParameter2 < *((_QWORD *)v11 + 2) )
        break;
    }
    dword_140E2D880 = (i + v10) >> 1;
  }
  *((_DWORD *)a4 + 6) = *((_DWORD *)v11 + 2);
  ...
  else
  {
    ...
    if ( (v14 & 0x8000000) == 0
      ...
      && ((v23 = 0xAAAAAAAAAAAAAAABuLL * (v5 >> 4), v23 < qword_140E358C0) || v23 >= qword_140E358C0 + 2048)
      && ((BYTE2(v14) & 7) == 6
       || byte_140E3C8A6
       && (v24 = v23 >> 9, *(_BYTE *)(qword_140E3CF00 + 2 * v24))
       && *(_BYTE *)(qword_140E3CF00 + 2 * v24) != 10) )
    {
      v15 = HIBYTE(v14) & 7;
    }
    else
  ...
  *((_DWORD *)a4 + 9) = v9;
  ...
  {
    if ( v9 == 8 )
      v25 = *(_BYTE *)(qword_140E3CF00 + 2 * ((0xAAAAAAAAAAAAAAABuLL * ((__int64)(v8 + 0x220000000000LL) >> 4)) >> 9) + 1) & 0x7F;
    else
      v25 = 0;
    *((_BYTE *)a4 + 40) = v25;
    result = v9;
