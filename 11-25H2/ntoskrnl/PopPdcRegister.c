/*
 * XREFs of PopPdcRegister @ 0x140AAE3F4
 * Callers:
 *     PopPdcInvocation @ 0x140AAE3A4 (PopPdcInvocation.c)
 * Callees:
 *     PopIsPlatformAoAcCapableInitialized @ 0x14048BD24 (PopIsPlatformAoAcCapableInitialized.c)
...
__int64 __fastcall PopPdcRegister(__int64 a1, __int64 (__fastcall **a2)(int a1, __int64 a2, unsigned int a3))
{
  ...
  if ( a2 )
  {
    ...
    *a2 = PdcPoResiliencyClient;
    ...
    {
      PopReleasePolicyLock(v6, v5, v7, v8, v16);
    }
  }
  else
  {
