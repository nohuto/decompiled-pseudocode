/*
 * XREFs of ExRegisterExtension @ 0x1407B0CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExRegisterExtension(__int64 *a1, int a2, unsigned __int16 *a3)
{
  ...
  if ( a2 == 65537 && (*((_QWORD *)a3 + 1) || !a3[3]) )
  {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&ExpHostListLock, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&ExpHostListLock, 0, v7, (unsigned __int64)&ExpHostListLock);
    if ( v7 )
      *((_BYTE *)v7 + 10) = 1;
    v23 = *(_DWORD *)(a3 + 1);
    Host = ExpFindHost(*a3);
...
LABEL_17:
    ...
    else if ( !*(_QWORD *)(v11 + 64) || (v15 = guard_dispatch_icall_no_overrides(0LL), v15 >= 0) )
    {
      ...
      *(_QWORD *)(v11 + 56) = v5;
      ...
      if ( *(_QWORD *)(v11 + 64) )
      {
        v20 = guard_dispatch_icall_no_overrides(1LL);
