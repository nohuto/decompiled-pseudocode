/*
 * XREFs of DifMmFreeMappingAddressWrapper @ 0x140627380
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmFreeMappingAddressWrapper(PVOID BaseAddress, ULONG PoolTag)
{
  ...
  PVOID v13; // [rsp+30h] [rbp-28h]
  _UNKNOWN *retaddr; // [rsp+58h] [rbp+0h]

  v12 = 0LL;
  v13 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(466);
