...
void RotBarUpdate()
{
  ...
  if ( PltRotBarStatus )
  {
    ...
    v0 = (unsigned int)(PltRotBarStatus - 2);
...
LABEL_21:
        if ( ++AnimBarPos > 17 )
          AnimBarPos = 0;
LABEL_25:
        if ( !(unsigned int)InbvGetDisplayState(v0) )
