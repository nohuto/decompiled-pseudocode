/*
 * XREFs of PopBatteryCheckCompositeCapacity @ 0x140A6AF48
 * Callers:
...
__int64 __fastcall PopBatteryCheckCompositeCapacity(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  LODWORD(v7) = 100000;
  if ( HIDWORD(qword_140F0AB14) > (unsigned int)v6 )
  {
    if ( HIDWORD(qword_140F0AB14) )
      v7 = 100000 * v6 / (unsigned __int64)HIDWORD(qword_140F0AB14);
    else
      LODWORD(v7) = 0;
  }
  v8 = 0;
  if ( dword_140F0AC84 != -1 )
    v8 = v7 - dword_140F0AC84;
  v9 = ((int)v7 + 500) / 0x3E8u;
  a2 = (dword_140F0AC84 + 500) / 0x3E8u;
  if ( v9 != (_DWORD)a2 )
    *a3 = v9 - a2;
  LOBYTE(a2) = byte_140F0AC80;
  dword_140F0AC84 = v7;
  if ( v5 == 1 )
  {
    LOBYTE(a2) = 1;
...
LABEL_20:
  ...
  v10 = dword_140F0AC90;
  if ( dword_140F0AC90 < (unsigned int)v7 )
  {
    v10 = v7;
    dword_140F0AC90 = v7;
  }
  ...
  HIDWORD(qword_140F0AC94) += v8;
  v11 = -HIDWORD(qword_140F0AC94);
  if ( SHIDWORD(qword_140F0AC94) > 0 )
    v11 = HIDWORD(qword_140F0AC94);
  if ( v11 >= BatteryChargeTrajectoryThresholdMilliPercent )
  {
    a2 = HIDWORD(qword_140F0AC94) >> 31;
LABEL_21:
    HIDWORD(qword_140F0AC94) = 0;
  }
