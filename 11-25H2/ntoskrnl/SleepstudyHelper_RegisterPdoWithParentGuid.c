/*
 * XREFs of SleepstudyHelper_RegisterPdoWithParentGuid @ 0x140757FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SleepstudyHelper_RegisterPdoWithParentGuid(__int64 a1, __int128 *a2, __int64 a3, KSPIN_LOCK **a4)
{
  KSPIN_LOCK *v4; // rsi
  __int64 v5; // rdi
  int v7; // eax
