/*
 * XREFs of EtwpCoverageRecord @ 0x140A57C90
 * Callers:
...
void __fastcall EtwpCoverageRecord(int **a1, __int64 a2)
{
  ...
  if ( (unsigned int)EtwpCoverageValidateCP((char **)a2, &v23) )
  {
    ...
    v8 = KeAbPreAcquire((__int64)&EtwpCoverageLock, 0LL);
    v9 = v8;
...
LABEL_8:
  ...
  if ( !v4 && v5 && (unsigned int)dword_140E090B0 > 5 && tlgKeywordOn((__int64)&dword_140E090B0, 2LL) )
  {
    v18 = *a1;
    v19 = *(const CHAR **)a2;
    v25 = **a1;
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E090B0, (unsigned __int8 *)&word_140051C66, 0LL, 0LL, 7u, v36);
  }
    ...
    && tlgKeywordOn((__int64)&dword_140E090B0, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E090B0, (unsigned __int8 *)byte_140051CC7, 0LL, 0LL, 9u, v36);
  }
}
