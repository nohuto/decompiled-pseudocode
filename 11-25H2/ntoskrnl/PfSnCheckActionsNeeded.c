/*
 * XREFs of PfSnCheckActionsNeeded @ 0x140826AA8
 * Callers:
 ...
 *     MmQueryTransitionPagesMadeColdCount @ 0x140492694 (MmQueryTransitionPagesMadeColdCount.c)
...
__int64 __fastcall PfSnCheckActionsNeeded(unsigned __int8 *a1, int a2, __int64 a3, int *a4, int *a5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      PfResourceExclusiveAcquire(&stru_140E66DE0);
      v35 = PfSnPrefetchCacheEntryGet(&unk_140E66DB8, v47, v46, &v42);
      v36 = (_DWORD *)v35;
      if ( v35 )
      {
        if ( v42 )
      ...
      ExReleaseResourceLite(&stru_140E66DE0);
