/*
 * XREFs of DifExAcquireSharedStarveExclusiveWrapper @ 0x14060FEF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireSharedStarveExclusiveWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(421);
  ...
  BYTE8(v14) = ExAcquireSharedStarveExclusive(Resource, a2);
  if ( v5 )
  {
