/*
 * XREFs of ?KiSelectIdealProcessorSetForGroup@@YAXPEAU_GROUP_AFFINITY@@GK_KPEA_KPEAU_KI_IDEAL_PROCESSOR_SET_BREAKPOINTS@@@Z @ 0x140269B98
 * Callers:
...
LABEL_30:
    ...
    if ( v15 == (unsigned __int16)KeNumberNodes )
      ...
      v16 = *(_DWORD *)(qword_140E2D890 + 4LL * (v15 + v14 * (unsigned int)(unsigned __int16)KeNumberNodes));
  }
  if ( v16 == v14 )
