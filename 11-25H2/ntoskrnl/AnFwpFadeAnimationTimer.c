/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x140BA2F50
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140EEF830 )
  {
    ...
    qword_140E64DD0 = qword_140EEF888;
    ...
    v11 = byte_140E0EC22;
    v12 = qword_140E0EC98;
    qword_140EEF888 = PerformanceCounter.QuadPart;
    qword_140E64DC0 = PerformanceCounter.QuadPart;
    v73 = qword_140E0EC18;
    v70 = dword_140E0EC14;
    v71 = (int *)qword_140E0EC58;
    v74.QuadPart = qword_140E0EC68;
    v72 = qword_140E0ECA0;
    v13 = 10 * (dword_140E0EC10 - dword_140E0EC10 / (unsigned int)(dword_140EEFD94 - dword_140E0EC14));
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      ...
      if ( !v11 )
      {
        ...
        v55 = 0;
        v56 = *(_QWORD *)(v8 + 24);
        for ( i = *(_QWORD *)(qword_140E0EC60 + 24); v55 < *(_DWORD *)(v54 + 12); ++v55 )
        {
    ...
    else
    {
      ...
      if ( !v11 )
      {
        ...
        v44 = 0LL;
        v45 = *(_QWORD *)(v8 + 24);
        for ( m = *(_QWORD *)(qword_140E0EC60 + 24);
    ...
    qword_140EEF888 = BgpFwQueryPerformanceCounter(0LL).QuadPart;
    v30 = *(_QWORD *)&BgpFwQueryPerformanceCounter(0LL) - qword_140E64DC0;
    qword_140EEF8C0 += v30;
    qword_140EEF8E0 = v30;
    qword_140EEF888 = BgpFwQueryPerformanceCounter(0LL).QuadPart;
    qword_140E64DB8 = qword_140EEF888;
    if ( !v11 )
    {
    ...
    if ( !v9 )
    {
      if ( !v70 && !v18 || (BgpGxDrawRectangle(v71, (__int64)&xmmword_140E0EC30), !v18) )
        v9 = 1;
    }
    if ( !v10 )
    {
      if ( !v70 && !v4 || (BgpGxDrawRectangle((int *)v72, (__int64)&xmmword_140E0EC70), !v4) )
        v10 = 1;
    }
    qword_140EEF888 = BgpFwQueryPerformanceCounter(0LL).QuadPart;
    v31 = *(_QWORD *)&BgpFwQueryPerformanceCounter(0LL) - qword_140E64DB8;
    qword_140EEF8B8 += v31;
    qword_140EEF8E0 = v31;
    qword_140EEF888 = BgpFwQueryPerformanceCounter(&v74).QuadPart;
    v32.QuadPart = *(_QWORD *)&BgpFwQueryPerformanceCounter(0LL) - qword_140E64DD0;
    qword_140EEF8E0 = v32.QuadPart;
    if ( v32.QuadPart < qword_140E0EE78 )
      qword_140E0EE78 = v32.QuadPart;
    if ( v32.QuadPart > qword_140EEF8A8 )
      qword_140EEF8A8 = v32.QuadPart;
    qword_140EEF878 += v32.QuadPart;
    qword_140EEF868 += v32.QuadPart;
    ++dword_140EEF8B0;
    if ( v17 || v4 || v18 )
    {
      byte_140E0EC20 = v9;
      byte_140E0EC21 = v10;
      v5 = v13 / 0xA;
      dword_140E0EC10 = v13 / 0xA;
      dword_140E0EC14 = v70 + 1;
      byte_140E0EC22 = v11;
    }
    else
    {
      byte_140EEF830 = 0;
      KeCancelTimer(&stru_140E64D00);
      KeSetEvent(&stru_140E64D80, 0, 0);
    }
  }
