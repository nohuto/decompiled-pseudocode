/*
 * XREFs of MiCreateLargePfnList @ 0x140405A3C
 * Callers:
        ...
        __int64 a9)
{
  ...
  v31 = v14;
  v16 = (ULONG *)*((_QWORD *)qword_140E2FD48 + HIWORD(Process[2].ProcessListEntry.Blink));
  if ( v12 )
  {
    if ( a7 )
    {
...
LABEL_27:
        MiReturnCrossPartitionCharges((__int64)v16, 2u, 1);
        return CrossPartitionCharges;
      }
      v13 = 3;
    }
...
LABEL_7:
    ...
    v38 = a3;
    v41 = v20;
    v24 = (int *)(qword_140E2D890 + 4LL * v21 * (unsigned int)(unsigned __int16)KeNumberNodes);
    v44 = a2;
    ...
    v45 = v48;
    MiAllocateLargeZeroPages((unsigned int *)v37);
    v26 = v46;
    v27 = v38;
    if ( v46 != v38 )
    {
      ...
      if ( v26 != v27 )
      {
        MiFreeLargeZeroPages((__int64)v16, a9, (LODWORD(v37[0]) >> 2) & 1);
LABEL_43:
