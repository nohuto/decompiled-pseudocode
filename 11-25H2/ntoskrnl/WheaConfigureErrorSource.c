/*
 * XREFs of WheaConfigureErrorSource @ 0x140B51AB0
 * Callers:
...
__int64 __fastcall WheaConfigureErrorSource(signed int a1, __int64 a2)
{
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&WheapConfigTableLock, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&WheapConfigTableLock, 0, v7, (unsigned __int64)&WheapConfigTableLock);
  if ( v7 )
    *((_BYTE *)v7 + 10) = 1;
