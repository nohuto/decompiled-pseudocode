/*
 * XREFs of MiAllocateAcceleratorDescriptor @ 0x1406854B4
 * Callers:
...
__int64 __fastcall MiAllocateAcceleratorDescriptor(__int64 a1, int a2, int a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v19 = ExAcquireSpinLockExclusive(&dword_140E37228);
  }
  for ( i = qword_140E37200; (__int64 *)i != &qword_140E37200; i = v20 )
  {
    v20 = *(_QWORD *)i;
    if ( *(_DWORD *)(i + 24) == a2 && (*(_DWORD *)(i + 52) & 1) == 0 && !byte_140E37214 )
    {
      if ( !a1 )
        goto LABEL_15;
...
LABEL_21:
  ...
  MiReleaseSpinLockExclusive(&dword_140E37228, v19);
  if ( (v8 || a1) && v9 )
  {
    result = 1LL;
    *a4 = v4;
