/*
 * XREFs of WheaFlushETWEventsAddWorkRtn @ 0x140651E4C
 * Callers:
...
void WheaFlushETWEventsAddWorkRtn()
{
  ...
  ProcNumber = 0;
  _InterlockedAdd(&dword_140EF76A0, 1u);
  if ( dword_140EF76A0 <= 1 )
  {
    ...
    else
    {
      ...
      KeSetTargetProcessorDpcEx((PKDPC)&WheapDispatchPtr.DeviceLock, &ProcNumber);
      KeInsertQueueDpc((PRKDPC)&WheapDispatchPtr.DeviceLock, 0LL, 0LL);
    }
  }
}
