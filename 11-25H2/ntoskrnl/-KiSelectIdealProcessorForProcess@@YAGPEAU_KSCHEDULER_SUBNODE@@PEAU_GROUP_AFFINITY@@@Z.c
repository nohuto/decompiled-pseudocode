/*
 * XREFs of ?KiSelectIdealProcessorForProcess@@YAGPEAU_KSCHEDULER_SUBNODE@@PEAU_GROUP_AFFINITY@@@Z @ 0x140268CF0
 * Callers:
...
__int64 __fastcall KiSelectIdealProcessorForProcess(struct _KSCHEDULER_SUBNODE *a1, struct _GROUP_AFFINITY *a2)
{
  ...
  if ( LLCLeaders )
  {
    ...
    do
    {
      ...
      v10 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)((Group << 6) + v7))];
    }
  ...
  return *((unsigned __int16 *)qword_140F216A8 + 2 * (unsigned int)(v6 + (Group << 6)));
}
