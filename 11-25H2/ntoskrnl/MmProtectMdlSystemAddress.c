/*
 * XREFs of MmProtectMdlSystemAddress @ 0x1404107F0
 * Callers:
 ...
 *     MiMappingHasIoTracker @ 0x140410B00 (MiMappingHasIoTracker.c)
...
NTSTATUS __stdcall MmProtectMdlSystemAddress(PMDL MemoryDescriptorList, ULONG NewProtect)
{
  ...
  MiInitializeTbFlushList((__int64)v23, (__int64)&unk_140E37EC0, 20, 0, 1);
  HasIoTracker = 0;
  v11 = v8;
  while ( v9 )
  {
