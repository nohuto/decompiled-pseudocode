/*
 * XREFs of IopRaiseHardError @ 0x140A4B9B0
 * Callers:
...
void __fastcall IopRaiseHardError(PIRP Irp, __int64 a2, char *a3)
{
  ...
  _OWORD v19[3]; // [rsp+48h] [rbp-31h] BYREF
  UNICODE_STRING *p_DestinationString; // [rsp+78h] [rbp-1h] BYREF
  struct _LIST_ENTRY *v21; // [rsp+80h] [rbp+7h]
...
LABEL_34:
      ...
      v13 = 1LL;
      v21 = KeGetCurrentThread()->ApcState.Process[1].Header.WaitListHead.Flink;
      break;
    default:
      v12 = 0;
      v13 = 0LL;
  ...
  guard_dispatch_icall_no_overrides(Irp->Tail.Overlay.CurrentStackLocation->DeviceObject);
}
