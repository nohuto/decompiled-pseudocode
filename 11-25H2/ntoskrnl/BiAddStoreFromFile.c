/*
 * XREFs of BiAddStoreFromFile @ 0x140A25948
 * Callers:
...
LABEL_24:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( (Hive & 0x80000000) == 0 )
    {
      ...
      {
LABEL_6:
        v9 = BiOpenKey(0LL, L"Description", 0x2001Fu, &v21);
        v10 = v21;
        Hive = v9;
        if ( v9 < 0 )
        {
      ...
      v13 = BiCreateKey(0LL, L"Objects", 131097LL, 0LL, &v20, 0LL);
      Hive = v13;
      if ( v13 >= 0 )
      {
        BiCloseKey(v20);
        v20 = 0LL;
        v13 = BiCreateKey(0LL, L"Description", 131097LL, 0LL, &v20, 0LL);
        Hive = v13;
        if ( v13 >= 0 )
          goto LABEL_6;
