/*
 * XREFs of PopInitializePowerSettings @ 0x140C1D950
 * Callers:
...
const WNF_STATE_NAME *PopInitializePowerSettings()
{
  ...
  qword_140F0BB58 = (__int64)&PopRegisteredPowerSettingCallbacks;
  PopRegisteredPowerSettingCallbacks = (__int64)&PopRegisteredPowerSettingCallbacks;
  qword_140F0BB48 = (__int64)&PopPowerSettings;
