/*
 * XREFs of Amd64ConfigureCounter @ 0x1405677D8
 * Callers:
  ...
  if ( !*(_DWORD *)v16 && *(_BYTE *)(*(_QWORD *)(v17 + 48LL * a1 + 16) + 8LL) )
  {
    if ( a3 )
    {
      ...
      if ( a6 )
        ...
        v19 = 0LL;
      __writemsr(*((_DWORD *)&Amd64PerfCounterRegisters + a1 + 1), v19);
      v20 = 0;
      if ( *(_DWORD *)v16 != 1 )
      {
        if ( *(_DWORD *)v16 != 100 )
        {
          ...
          {
LABEL_30:
            __writemsr(*((_DWORD *)&Amd64EventSelectRegisters + v20 + a1 + 1), v18);
            goto LABEL_38;
          }
    ...
    __writemsr(*((_DWORD *)&Amd64EventSelectRegisters + a1 + 1), 0LL);
LABEL_32:
    v24 = 0;
    if ( *(_DWORD *)v16 != 1 )
    {
...
LABEL_38:
  ...
  v27 += v30;
LABEL_54:
  __writemsr(*((_DWORD *)&Amd64PerfCounterRegisters + v27 + a1), -v25);
  v24 = 0;
  if ( *(_DWORD *)v16 != 1 )
  {
    if ( *(_DWORD *)v16 != 100 )
...
LABEL_77:
  result = v26;
  __writemsr(*((_DWORD *)&Amd64EventSelectRegisters + v24 + a1), v26);
  return result;
}
