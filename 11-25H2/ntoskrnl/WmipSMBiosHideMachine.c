/*
 * XREFs of WmipSMBiosHideMachine @ 0x1407957BC
 * Callers:
 *     WmipGetSMBiosTableData @ 0x140A3D178 (WmipGetSMBiosTableData.c)
 * Callees:
 *     WmipSMBiosFindStringAndZero @ 0x1407956B0 (WmipSMBiosFindStringAndZero.c)
 *     WmipSMBiosFindStructure @ 0x140795734 (WmipSMBiosFindStructure.c)
 */
