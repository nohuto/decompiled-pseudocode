/*
 * XREFs of CmpPerformUnloadKey @ 0x140864C24
 * Callers:
...
__int64 __fastcall CmpPerformUnloadKey(__int64 a1, char a2, char a3, __int64 a4)
{
  ...
  *(_OWORD *)Privileges = 0LL;
  ...
  if ( (int)CmpStartKcbStackForTopLayerKcb(&v55, v10) < 0 )
  {
    v12 = -1073741670;
    goto LABEL_41;
  }
  ...
  CmpReportNotifyHelper((unsigned int)&v55, *(_QWORD *)&v14[1].Privilege[0].Luid.HighPart, 0, 4, (__int64)v54);
  v16 = CmpMasterHive;
  if ( *(_QWORD *)&v14[1].Privilege[0].Luid.HighPart != CmpMasterHive )
    CmpReportNotifyHelper((unsigned int)&v55, CmpMasterHive, 0, 4, (__int64)v54);
  v17 = *(_QWORD *)(a1 + 16);
  if ( v17 )
  {
    if ( *(_QWORD *)(v17 + 16) != v17 + 16 )
      CmpPostNotify(v17, v16, v15, 267, 0, 0LL, (__int64)v54);
    v18 = *(char **)(a1 + 16);
    if ( v18 )
    {
...
LABEL_64:
  ...
  LOBYTE(v16) = 1;
  v26 = CmpTryAcquireKcbIXLocks(v10, v16, v15, &v53);
  v12 = v26;
  if ( v26 != -1073741267 )
  {
    if ( v26 < 0 )
    ...
    if ( v28 != -1073741267 )
    {
      ...
      CmpFlushNotifiesOnKeyBodyList(v10, 1LL, &v57);
      goto LABEL_23;
    }
