/*
 * XREFs of IopSetEaOrQuotaInformationFile @ 0x1407068A0
 * Callers:
 *     NtSetQuotaInformationFile @ 0x14070C260 (NtSetQuotaInformationFile.c)
 * Callees:
...
__int64 __fastcall IopSetEaOrQuotaInformationFile(void *a1, unsigned __int64 a2, void *a3, ULONG a4, char a5)
{
  ...
  KPROCESSOR_MODE v36; // [rsp+40h] [rbp-78h]
        ...
        *(_QWORD *)(v28 + 48) = v13;
        ...
        else if ( (Flags & 0x10) != 0 )
        {
          if ( (_DWORD)v5 )
          {
            ...
            IopProbeAndLockPages_1(Mdl, v36, IoReadAccess, (__int64)RelatedDeviceObject, *(unsigned __int8 *)v39);
            v28 = (__int64)v39;
          }
          goto LABEL_39;
        }
