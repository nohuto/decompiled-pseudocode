/*
 * XREFs of PspCaptureUserProcessParameters @ 0x1409BD530
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1409BDD9C (PspCaptureAndValidateUnicodeString.c)
 *     PspCopyUnicodeString @ 0x1409BDE08 (PspCopyUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x1409BDE80 (PspValidateEnvironmentBlock.c)
