/*
 * XREFs of MiUnmapFrameBuffer @ 0x140391878
 * Callers:
...
unsigned __int64 __fastcall MiUnmapFrameBuffer(__int64 a1, ULONG_PTR a2, int a3)
{
  ...
  if ( (*(_QWORD *)a2 & 0x42) != 0 )
  {
    ...
    if ( (v6 & 0x600000) == 0x600000 && (v6 & 4) == 0 )
      MiCaptureWriteWatchDirtyBit((__int64)KeGetCurrentThread()->ApcState.Process, (__int64)(a2 << 25) >> 16, a1);
  }
  v7 = (v3 >> 12) & 0xFFFFFFFFFFLL;
  if ( v7 <= qword_140E2D9A0 )
  {
    v8 = 1;
