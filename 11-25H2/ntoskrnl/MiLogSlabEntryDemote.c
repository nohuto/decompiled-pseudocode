/*
 * XREFs of MiLogSlabEntryDemote @ 0x1404CC160
 * Callers:
...
void MiLogSlabEntryDemote()
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 1024LL) )
  {
    v3 = *(_QWORD *)(v2 + 56);
    v7 = *(_BYTE *)(v3 + 128);
    v14 = &v7;
    ...
    v25 = 8LL;
    v17 = 4LL;
    tlgWriteEx_EtwWriteEx(v0, (unsigned __int8 *)&dword_14005671C, v0, 1u, v5, v6, 8u, &v13);
  }
}
