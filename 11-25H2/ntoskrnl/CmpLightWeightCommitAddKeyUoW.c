/*
 * XREFs of CmpLightWeightCommitAddKeyUoW @ 0x1409DA778
 * Callers:
...
__int64 __fastcall CmpLightWeightCommitAddKeyUoW(__int64 a1, _QWORD *a2)
{
  ...
  if ( (*(_BYTE *)(v6 + 140) & 1) != 0 )
    CellFlat = HvpGetCellFlat(v6, v7, &v23);
  else
    CellFlat = HvpGetCellPaged(v6, v7, &v23);
  v20 = 0;
  v9 = CellFlat;
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 72LL) + 168LL) = *v3;
  ...
  if ( (*(_BYTE *)(v6 + 140) & 1) != 0 )
    HvpReleaseCellFlat(v6, &v22);
  else
    HvpReleaseCellPaged(v6, (unsigned int *)&v22);
  if ( (*(_BYTE *)(v6 + 140) & 1) != 0 )
    HvpReleaseCellFlat(v6, &v23);
  else
    HvpReleaseCellPaged(v6, (unsigned int *)&v23);
