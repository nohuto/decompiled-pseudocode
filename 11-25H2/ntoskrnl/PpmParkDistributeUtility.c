/*
 * XREFs of PpmParkDistributeUtility @ 0x1404088A0
 * Callers:
 *     PpmHeteroDistributeUtility @ 0x140408490 (PpmHeteroDistributeUtility.c)
 *     PpmParkDistributeAllUtility @ 0x140408810 (PpmParkDistributeAllUtility.c)
 * Callees:
 *     KeGetPrcb @ 0x1403B0CC0 (KeGetPrcb.c)
 *     PpmHeteroUtilityToNormalizedUtility @ 0x140408E54 (PpmHeteroUtilityToNormalizedUtility.c)
 */
...
LABEL_2:
  ...
  while ( 1 )
  {
    if ( v12 )
    {
      ...
      v12 &= ~(1LL << v18);
      v19 = *((unsigned int *)qword_140F216A8 + 64 * v15 + (unsigned int)(unsigned __int8)v18);
...
LABEL_15:
  ...
  while ( 1 )
  {
    if ( v25 )
    {
      ...
      v25 &= ~(1LL << v27);
      Prcb = (_DWORD *)KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * v24 + (unsigned int)(unsigned __int8)v27));
  ...
  if ( v10 && v80 )
  {
    ...
    while ( 1 )
    {
      ...
      v59 &= ~(1LL << v61);
      v62 = KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * v58 + (unsigned int)(unsigned __int8)v61));
      v14 ^= *(_QWORD *)(v62 + 200);
...
LABEL_31:
  ...
  while ( 1 )
  {
    if ( v38 )
    {
      ...
      v38 &= ~(1LL << v41);
      v42 = *((unsigned int *)qword_140F216A8 + 64 * v39 + (unsigned int)(unsigned __int8)v41);
...
LABEL_50:
  ...
  while ( 1 )
  {
    if ( v14 )
    {
      ...
      v14 &= ~(1LL << v53);
      v54 = *((unsigned int *)qword_140F216A8 + 64 * v50 + (unsigned int)(unsigned __int8)v53);
...
LABEL_81:
    ...
    while ( 1 )
    {
      if ( v67 )
      {
        ...
        v67 &= ~(1LL << v71);
        result = KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * v69 + (unsigned int)(unsigned __int8)v71));
  ...
  if ( a5 )
  {
    ...
    while ( 1 )
    {
      ...
      v73 &= ~(1LL << v75);
      result = KeGetPrcb(*((_DWORD *)qword_140F216A8 + 64 * v49 + (unsigned int)(unsigned __int8)v75));
      v49 = v47;
