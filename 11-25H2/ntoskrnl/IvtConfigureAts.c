/*
 * XREFs of IvtConfigureAts @ 0x14056AB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IvtConfigureAts(__int64 a1, __int64 a2, char a3)
{
  ...
  int v19; // [rsp+78h] [rbp-39h] BYREF
  int v20; // [rsp+7Ch] [rbp-35h]
  int BlockedDomain; // [rsp+A8h] [rbp-9h]
  unsigned __int64 v22; // [rsp+118h] [rbp+67h] BYREF
  ...
  {
    v20 = 1;
    BlockedDomain = IvtGetBlockedDomain(a1, 0LL, &v22);
  }
  else
  {
    if ( v8 != 1 )
  ...
  result = IvtAllocateTranslationStructures(a1, a2, &v19);
  v7 = result;
  if ( (int)result >= 0 )
  {
LABEL_7:
    ...
    *(_DWORD *)(a2 + 80) = v6;
    IvtUpdateScalableModeContextEntry(a1, v15, v14, v6, 0, v16, v17, 0, DomainId);
