/*
 * XREFs of KiDisarmForceParkDutyCyclingIfNecessary @ 0x1404F6E00
 * Callers:
 ...
 *     KiShouldSearchSharedReadyQueue @ 0x140439910 (KiShouldSearchSharedReadyQueue.c)
 */
    ...
    *(_BYTE *)(a1 + 35) |= 0x20u;
    if ( v3 )
    {
      ...
      if ( (KiVelocityFlags & 0x200000) != 0 )
      {
        *((_QWORD *)&v9 + 1) = v3;
        *(_QWORD *)&v9 = 0LL;
        v5 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)v3, (__int64)&v9);
        if ( v5 )
          KxWaitForLockOwnerShip((struct _KPRCB *)&v9, v5);
      }
      else
      {
        v10 = 0;
