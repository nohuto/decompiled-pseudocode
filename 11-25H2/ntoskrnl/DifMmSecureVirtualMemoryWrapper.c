/*
 * XREFs of DifMmSecureVirtualMemoryWrapper @ 0x140628A10
 * Callers:
 *     <none>
 * Callees:
...
HANDLE __fastcall DifMmSecureVirtualMemoryWrapper(PVOID Address, SIZE_T Size, ULONG ProbeMode)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = Address;
    *(_QWORD *)&v16 = Size;
    DWORD2(v15) = ProbeMode;
  ...
  v17 = MmSecureVirtualMemory(Address, Size, ProbeMode);
  if ( v7 )
  {
