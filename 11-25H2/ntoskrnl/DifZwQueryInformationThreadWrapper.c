/*
 * XREFs of DifZwQueryInformationThreadWrapper @ 0x1406396D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationThreadWrapper(
        void *a1,
        THREADINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v19) = ZwQueryInformationThread(a1, a2, a3, a4, ReturnLength);
  if ( v9 )
  {
