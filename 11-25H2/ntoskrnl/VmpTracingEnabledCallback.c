/*
 * XREFs of VmpTracingEnabledCallback @ 0x140A80370
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
      ...
      if ( **(_DWORD **)&VmpTraceLoggingProvider > 5u && tlgKeywordOn(*(__int64 *)&VmpTraceLoggingProvider, 128LL) )
      {
        ...
        v31 = v9;
        v45 = 8LL;
        tlgWriteEx_EtwWriteEx(v8, (unsigned __int8 *)&word_140050CB6, v10, 0, v28, v29, 5u, v39);
      }
      v11 = *(_QWORD *)(v7 + 32);
      if ( (v11 & 1) != 0 )
      {
        ...
        {
LABEL_33:
          PfLockSharedRelease((volatile signed __int64 *)(v7 + 120));
          goto LABEL_34;
        }
        j = v11 ^ ((v7 + 24) | 1);
      }
      ...
      if ( j )
      {
        do
        {
          ...
          if ( **(_DWORD **)&VmpTraceLoggingProvider > 5u && tlgKeywordOn(*(__int64 *)&VmpTraceLoggingProvider, 128LL) )
          {
            ...
            v51 = 4LL;
            v53 = 8LL;
            tlgWriteEx_EtwWriteEx(v13, (unsigned __int8 *)&byte_14005068F, v17, 0, v28, v29, 9u, v39);
          }
          for ( i = *(__int64 **)(j + 40); i != (__int64 *)(j + 40); i = (__int64 *)*i )
          {
            ...
            if ( **(_DWORD **)&VmpTraceLoggingProvider > 5u && tlgKeywordOn(*(__int64 *)&VmpTraceLoggingProvider, 128LL) )
            {
              ...
              v53 = 4LL;
              v55 = 8LL;
              tlgWriteEx_EtwWriteEx(v19, (unsigned __int8 *)&byte_1400505CD, v24, 0, v28, v29, 0xAu, v39);
            }
          }
          v25 = *(_QWORD ***)(j + 8);
          v26 = j;
