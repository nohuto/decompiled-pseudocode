/*
 * XREFs of EtwpPsProvTraceProcess @ 0x140921388
 * Callers:
 ...
 *     EtwpQueryProcessEnabledSecurityMitigations @ 0x14049170C (EtwpQueryProcessEnabledSecurityMitigations.c)
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  if ( ((a5 - 769) & 0xFFFD) != 0 )
  {
    if ( a5 == 770 )
    {
      ...
      ObFastDereferenceObject((__int64 *)(a1 + 584), (ULONG_PTR)v19, 1953261124LL);
      if ( TokenInformation )
  ...
  else
  {
    ...
    ObFastDereferenceObject((__int64 *)(a1 + 584), (ULONG_PTR)v14, 1953261124LL);
