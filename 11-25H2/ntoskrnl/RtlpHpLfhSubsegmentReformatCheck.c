/*
 * XREFs of RtlpHpLfhSubsegmentReformatCheck @ 0x140450260
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentCountAllocatedBlocks @ 0x1404503D0 (RtlpHpLfhSubsegmentCountAllocatedBlocks.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentReformatCheck(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  RtlpHpReleaseLockShared((volatile LONG *)(a2 + 56), *(unsigned __int8 *)(a1 + 65), v15);
  if ( v13 >= v14 )
  {
    *a3 = v11;
    *a4 = v12;
