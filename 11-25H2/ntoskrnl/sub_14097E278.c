/*
 * XREFs of sub_14097E278 @ 0x14097E278
 * Callers:
...
__int64 __fastcall sub_14097E278(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  unsigned int v6; // r8d
  unsigned int *v7; // rax
  unsigned int i; // edx
  ...
  if ( (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, __int64))qword_140FD7438 == ntoskrnl_27 )
    ...
    v13 = guard_dispatch_icall_no_overrides(&DestinationString);
  v6 = v13;
  if ( v13 != -1073741772 )
  {
    if ( v13 < 0 )
  ...
  do
  {
    v14 = KeWaitForSingleObject(&stru_140EF0700, UserRequest, 1, 1u, 0LL);
    v15 = v14;
  }
  while ( v14 == 257 );
  if ( v14 >= 0 && v14 != 192 )
