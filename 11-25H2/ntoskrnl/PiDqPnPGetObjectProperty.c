/*
 * XREFs of PiDqPnPGetObjectProperty @ 0x1408D28C0
 * Callers:
        ...
        __int64 a7)
{
  ...
  __int16 v21; // cx
  void *v22; // rdi
  __int64 (__fastcall *v23)(PVOID, const WCHAR *, int, int, int, __int64); // rbx
  int v24; // eax
...
LABEL_18:
  ...
  do
  {
    ...
    if ( a2 )
    {
      ...
      v32[1] = 0LL;
      v39 = 0;
      v23 = *(__int64 (__fastcall **)(PVOID, const WCHAR *, int, int, int, __int64))(*(_QWORD *)&PiPnpRtlCtx + 488LL);
      v36 = v31;
      v40 = &v30;
      v41 = 0LL;
      v37 = v10;
      ...
      if ( v23 )
      {
        if ( v23 == PiPnpRtlObjectActionCallback )
          ...
          v24 = guard_dispatch_icall_no_overrides(*(_QWORD *)&PiPnpRtlCtx);
        if ( v24 == -1073741822 )
        {
          v23 = 0LL;
        }
