/*
 * XREFs of ExtEnvSetVpptTarget @ 0x140444404
 * Callers:
...
__int64 __fastcall ExtEnvSetVpptTarget(__int64 a1, unsigned int a2)
{
  ...
  *(_QWORD *)&v26 = 1LL << (v4 & 0x3F);
  ...
  HalpReleaseHighLevelLock((__int64)&HalpInterruptOverridesLock, v12);
  if ( !v11 && *(_DWORD *)(HalpInterruptController + 240) == 2 && v8 - 45056 <= 1 )
  {
    v15 = v7;
    if ( v8 == 45057 )
      v15 = v7 + 8;
    v16 = (_DWORD *)HalpInterruptFindLinesForGsiRange(v15, v15 + 1);
    if ( v16 )
    {
      v8 = v16[4];
      v7 = v15 + v16[5] - v16[7];
  ...
  while ( v21 > v7 || v20[6] <= v7 );
  v22 = v7 - v21;
  if ( !v20 || (v23 = v20[7], v23 == -1) )
LABEL_28:
    KeBugCheckEx(0x5Cu, 0x114uLL, (ULONG_PTR)v3, 0xFFFFFFFFC000000DuLL, 3uLL);
  v27 = 0;
  LODWORD(v25) = v22 + v23;
  v34 = v22 + v23;
  result = HalpInterruptSetDestination(&v27, &v26, &v25);
  if ( (int)result < 0 )
