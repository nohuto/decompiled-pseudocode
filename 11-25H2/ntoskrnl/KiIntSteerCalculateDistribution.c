/*
 * XREFs of KiIntSteerCalculateDistribution @ 0x1403AF6B0
 * Callers:
 ...
 *     KiIntSteerCalculateUniformDistribution @ 0x140492770 (KiIntSteerCalculateUniformDistribution.c)
 *     KiIntSteerComputeCpuSet @ 0x1404A631C (KiIntSteerComputeCpuSet.c)
 */
...
LABEL_19:
    ...
    if ( v25 != &v25 )
    {
      ...
      *(_QWORD *)&v27 = v16;
      KiIntSteerCalculatePriorityDistribution(a1, &v25, (__int64 *)a2, (__int64 *)&v28, (__int64 *)&v27);
      if ( v25 != &v25 )
      {
        ...
        if ( v25 != &v25 )
        {
          while ( v22 != &v25 )
          {
            ...
            v25 = *v22;
            v23[1] = &v25;
            v24 = *((_DWORD *)KiGlobalState + (unsigned int)KiIntPartGetLowestClassProcessorInMask((__int64)(v22 - 18)));
            *(_DWORD *)((char *)v22 - 22) = 0;
            *((_WORD *)v22 - 9) = 0;
            *((_WORD *)v22 - 12) = v24 >> 6;
            *(v22 - 4) = (_QWORD *)(1LL << (v24 & 0x3F));
            v22 = (_QWORD **)v25;
          }
        }
      }
