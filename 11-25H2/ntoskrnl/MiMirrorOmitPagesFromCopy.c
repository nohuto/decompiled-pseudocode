/*
 * XREFs of MiMirrorOmitPagesFromCopy @ 0x140430070
 * Callers:
 ...
 *     MiMirrorRemoveBlackChildPartitionPages @ 0x1406672C0 (MiMirrorRemoveBlackChildPartitionPages.c)
...
__int64 __fastcall MiMirrorOmitPagesFromCopy(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v5 = a3;
  v6 = a2;
  v7 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140E2FE60 + 1) + 4 * (a2 >> 5));
  v8 = a2 & 0x1F;
  if ( v8 + v4 > 0x20 )
  {
    if ( (a2 & 0x1F) != 0 )
...
LABEL_5:
  if ( *(_QWORD *)(a1 + 24) )
    RtlClearBitsEx((__int64)&xmmword_140E2FE50, v6, v5);
