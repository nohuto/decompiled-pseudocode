/*
 * XREFs of TtmiLogSessionDisplayRequiredPowerRequestUpdated @ 0x14075E450
 * Callers:
...
void TtmiLogSessionDisplayRequiredPowerRequestUpdated()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)byte_14004E78B, 0LL, 0LL, 5u, &v7);
  }
}
