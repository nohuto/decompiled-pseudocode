/*
 * XREFs of HalpIommuAllocateDmaDomain @ 0x140550BC4
 * Callers:
 *     HalpIommuInitializeDmar @ 0x1405516DC (HalpIommuInitializeDmar.c)
 *     IommuDomainCreate @ 0x1406F7D90 (IommuDomainCreate.c)
 *     IommuDomainCreateEx @ 0x1406F7DC0 (IommuDomainCreateEx.c)
 * Callees:
            ...
            if ( v10 != 3 )
            {
              ...
              *(_DWORD *)(v9 + 48) = v17;
              if ( !v10 )
              {
                ...
                v33 = a2 < 0;
                PageTableType = guard_dispatch_icall_no_overrides(&v31);
                if ( PageTableType < 0 )
                  goto LABEL_64;
                v10 = v25;
              }
...
LABEL_58:
              ...
              while ( 1 )
              {
                ...
                if ( v20 )
                {
                  PageTableType = guard_dispatch_icall_no_overrides(v20);
                  if ( PageTableType < 0 )
                    break;
                }
                if ( *((_BYTE *)v19 + 24) )
              ...
              while ( a4 != v19 )
              {
                if ( *((_BYTE *)a4 + 24) )
                {
                  ...
                  v29 = (_DWORD *)(a4[2] << 12);
                  HalpIommuDomainUnmapLogicalRange(v9, v23, (__int64 *)&v29, 0);
                }
                a4 = (__int64 *)*a4;
              }
LABEL_64:
