/*
 * XREFs of FsRtlNotifyFilterReportChangeLiteEx @ 0x140A03080
 * Callers:
 *     FsRtlNotifyFilterReportChangeLite @ 0x140701CC0 (FsRtlNotifyFilterReportChangeLite.c)
 * Callees:
        ...
        __int64 a10)
{
  ...
  while ( 1 )
  {
    ...
    if ( (*((_DWORD *)v13 + 11) & a5) == 0
      || (a9 & 1) == 0 && ((v15[9] & 1) == 0 || v15[2] && !(unsigned __int8)guard_dispatch_icall_no_overrides(v15[1]))
      || v15[8] && a8 && !(unsigned __int8)guard_dispatch_icall_no_overrides(v15[1]) )
    {
      goto LABEL_9;
    }
    if ( (v15[9] & 2) == 0 )
