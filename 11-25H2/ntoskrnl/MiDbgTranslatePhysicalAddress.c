/*
 * XREFs of MiDbgTranslatePhysicalAddress @ 0x1406739D0
 * Callers:
...
LABEL_23:
  ...
  if ( *(_QWORD *)v22 )
    v24 = (*(_DWORD *)(*(_QWORD *)v22
                     + 4
                     * ((unsigned __int64)(2
                                         * (((unsigned int)v33 & ((unsigned int)(1LL << ((unsigned __int8)dword_140E2D8F8
                                                                                       - 12))
                                                                - 1))
                                          - *(_DWORD *)(*(_QWORD *)v22 + 24LL))) >> 5)
                     + 44) >> ((2
                              * ((v33 & ((1LL << ((unsigned __int8)dword_140E2D8F8 - 12)) - 1))
