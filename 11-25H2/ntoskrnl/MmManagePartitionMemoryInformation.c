/*
 * XREFs of MmManagePartitionMemoryInformation @ 0x14093BA7C
 * Callers:
 ...
 *     MiQueryMemoryListInformation @ 0x1403BE4DC (MiQueryMemoryListInformation.c)
 *     MiGetNodeHugeRangeCounts @ 0x14066472C (MiGetNodeHugeRangeCounts.c)
