/*
 * XREFs of PiPnpRtlServiceFilterCallback @ 0x140A00B50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall PiPnpRtlServiceFilterCallback(_QWORD *a1, const WCHAR *a2, __int64 a3, __int64 a4)
{
  char v7; // di
