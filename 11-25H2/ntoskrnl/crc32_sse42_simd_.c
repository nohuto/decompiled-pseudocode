/*
 * XREFs of crc32_sse42_simd_ @ 0x1404F1534
 * Callers:
...
__int64 __fastcall crc32_sse42_simd_(const __m128i *a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v4 >= 0x40 )
  {
    _XMM4 = _mm_load_si128((const __m128i *)&xmmword_140019470);
    v11 = v4 >> 6;
    v4 += -64LL * (v4 >> 6);
    do
    {
  ...
  _XMM4 = _mm_load_si128((const __m128i *)&xmmword_140019460);
  _XMM1 = _XMM2;
  __asm
  {
    pclmulqdq xmm2, xmm4, 0
  ...
  _XMM1 = _XMM2;
  _XMM0 = _mm_loadl_epi64((const __m128i *)&qword_140019450);
  ...
  __asm { pclmulqdq xmm1, cs:xmmword_140019440, 10h }
  _XMM1 = _mm_and_ps(_XMM1, si128);
  __asm { pclmulqdq xmm1, cs:xmmword_140019440, 0 }
