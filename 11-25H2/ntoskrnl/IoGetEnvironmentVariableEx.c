/*
 * XREFs of IoGetEnvironmentVariableEx @ 0x1408224D8
 * Callers:
...
__int64 __fastcall IoGetEnvironmentVariableEx(const WCHAR *a1, __int64 a2, __int64 a3, int *a4, _DWORD *a5)
{
  int v8; // edi
  PVOID v9; // rbx
  int v12; // eax
    ...
    && (qword_140E06ED0 & 0x200000000000LL) == qword_140E06ED0 )
  {
    ...
    v19 = 16;
    LODWORD(v15) = v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E06EB8, (unsigned __int8 *)&word_140045CEE, 0LL, 0LL, 7u, &v16);
  }
