/*
 * XREFs of PopReadPagesFromHiberFile @ 0x140AABC80
 * Callers:
 ...
 *     IoPageRead @ 0x1404F8AB0 (IoPageRead.c)
 *     RtlLongLongAdd @ 0x1405CEEC0 (RtlLongLongAdd.c)
...
__int64 __fastcall PopReadPagesFromHiberFile(unsigned int a1, unsigned int a2, PVOID *a3)
{
  ...
  if ( !byte_140F0B8C8
    ...
    || (v6 = qword_140F0AD70, qword_140F0AD70 < 0x1000) )
  {
    Status = -1073741637;
    goto LABEL_26;
  }
