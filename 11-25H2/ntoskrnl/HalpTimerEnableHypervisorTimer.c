/*
 * XREFs of HalpTimerEnableHypervisorTimer @ 0x1404CD4C8
 * Callers:
  ...
  if ( HalpHypervisorHpet )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      else
      {
        ...
        if ( (v8 & 0x200) != 0 )
        {
          result = HalpInterruptGsiToLine(*(unsigned int *)(v2 + 88), &v13);
          if ( (int)result < 0 )
            return result;
        }
        else if ( (v8 & 0x100) != 0 )
        ...
        v11 = HalpInterruptSetLineState(
                ...
                *(_DWORD *)(v2 + 92),
                ...
                (__int64)v14,
                v12);
        result = HalpReleaseHighLevelLock((__int64)&HalpInterruptLock, v10);
        v7 = v11 < 0;
      }
      if ( !v7 )
