/*
 * XREFs of Pdcv2ActivationClientActivate @ 0x14096C430
 * Callers:
 *     PiPdcActivate @ 0x14096C3B4 (PiPdcActivate.c)
 *     PopWin32kActivatorWorker @ 0x14096C8E0 (PopWin32kActivatorWorker.c)
 * Callees:
 *     KeWaitForSingleObject @ 0x14029C6A0 (KeWaitForSingleObject.c)
 *     KeReleaseMutex @ 0x1402F0970 (KeReleaseMutex.c)
 *     Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE @ 0x140424AF4 (Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE.c)
 ...
 *     Pdcv2pValidateExtraActivationParameters @ 0x1404A22E4 (Pdcv2pValidateExtraActivationParameters.c)
 *     PdcpResizeDiagnosticContext @ 0x1405FB280 (PdcpResizeDiagnosticContext.c)
 *     memset_0 @ 0x1406B4D40 (memset_0.c)
 *     Pdcv2pValidateActivationParameters @ 0x14096C884 (Pdcv2pValidateActivationParameters.c)
...
LABEL_55:
  ...
  if ( !pszSrc )
  {
    v26 = -1073741581;
LABEL_34:
    Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE(0LL, (_DWORD *)v12, v26);
    if ( !v11 )
  ...
  *((_DWORD *)v15 + 13) = v16;
  ...
  if ( v18 )
    RtlStringCchCopyW((NTSTRSAFE_PWSTR)v15 + 164, v17, v18);
  v19 = v43;
  v40 = *(_QWORD *)(a2 + 8);
  v20 = v17;
  v42 = *(_DWORD *)(a2 + 4);
  ...
  *v22 = 0;
  ...
  v25 = *(char **)(a2 + 24);
  if ( v25 )
    PdcpResizeDiagnosticContext(v25, v45);
  v26 = PdcPortSendMessageSynchronously(*(struct _EX_RUNDOWN_REF **)(a1 + 40), (__int64)v34);
  if ( v26 < 0 )
  {
...
LABEL_33:
  ...
  *QuadPart = v37;
  if ( v26 >= 0 && v27 != 300 )
  {
    ...
    *(_QWORD *)(a1 + 88) = v15;
    *a7 = v15;
    Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE((__int64)v15, (_DWORD *)a1, v26);
    goto LABEL_35;
  }
  ExFreePoolWithTag(v15, 0);
  if ( v26 < 0 )
