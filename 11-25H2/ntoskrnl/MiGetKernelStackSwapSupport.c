/*
 * XREFs of MiGetKernelStackSwapSupport @ 0x1403D9714
 * Callers:
...
__int64 __fastcall MiGetKernelStackSwapSupport(__int64 a1, __int64 a2)
{
  ...
  v2 = -1;
  v3 = 0;
  v6 = *((_QWORD *)qword_140E2FD48 + *(unsigned __int16 *)(a2 + 1198));
  v7 = *(_DWORD *)(v6 + 18520);
  if ( !v7 )
    return 3221225799LL;
  v8 = (_QWORD *)(v6 + 18528);
    ...
    if ( (*(_BYTE *)(*v8 + 172LL) & 0x50) == 0 )
    {
      if ( v2 == -1
        || (v15 = MiPageFileLargestBitmapsRun(*v8),
            v15 > (unsigned int)MiPageFileLargestBitmapsRun(*(_QWORD *)(v6 + 8LL * v2 + 18528))) )
      {
        v2 = v3;
      }
    }
