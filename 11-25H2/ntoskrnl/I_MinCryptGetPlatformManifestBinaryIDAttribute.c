/*
 * XREFs of I_MinCryptGetPlatformManifestBinaryIDAttribute @ 0x14081639C
 * Callers:
 *     MinCrypK_VerifySignedDataKModeEx @ 0x140816A74 (MinCrypK_VerifySignedDataKModeEx.c)
 * Callees:
 *     I_Base64Decode @ 0x1408161B8 (I_Base64Decode.c)
...
__int64 __fastcall I_MinCryptGetPlatformManifestBinaryIDAttribute(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)(v3 + 88) = 0LL;
  v7 = 0LL;
  if ( (unsigned __int8)I_MinAsn1ParseSingleAttribute(&qword_140B2CB38, a1, a3, &v7)
