/*
 * XREFs of HalpInterruptRemap @ 0x14053E694
 * Callers:
 ...
 *     HaliAddInterruptRemapping @ 0x1406F1BC0 (HaliAddInterruptRemapping.c)
 * Callees:
 ...
 *     HalpInterruptRemapUpdateDeliveryMode @ 0x1404A7B10 (HalpInterruptRemapUpdateDeliveryMode.c)
  ...
  if ( !v17 )
  {
    ...
    if ( (int)HalpInterruptGsiToLine(v28, &a5) >= 0 )
    {
      ...
      if ( v30 )
      {
        ...
        BestRouting = HalpInterruptFindBestRouting((unsigned int *)&a5, v39);
        if ( BestRouting < 0 )
