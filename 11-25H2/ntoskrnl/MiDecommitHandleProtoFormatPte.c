/*
 * XREFs of MiDecommitHandleProtoFormatPte @ 0x140382C60
 * Callers:
                ...
                if ( (*(_DWORD *)(v18 + 32) & 0x20000) != 0 && (*(_DWORD *)(v15 + 56) & 0x8000000) != 0 )
                {
                  if ( (BYTE6(PerfGlobalGroupMask) & 0x21) == 0 || PopHibernateInProgress )
                  {
                    ...
                    if ( v22 != v21 )
                    {
                      ...
                      ExpWaitForSpinLockSharedAndAcquire((signed __int32 *)(v15 + 72), 0xFFu);
                    }
                  }
                  else
                  {
...
LABEL_60:
                  ...
                  {
                    v25 = v24[9];
                    if ( v7 >= v25 && v7 < v25 + 8LL * *(unsigned int *)(v18 + 44) )
                      break;
                  }
                }
                v18 = *(_QWORD *)(v18 + 16);
      ...
      if ( !Process[1].IdealProcessorAssignmentBlock || MiIsPrototypePteVadLookup(a2) )
        goto LABEL_77;
      do
      {
        if ( v7 <= v14[4] )
