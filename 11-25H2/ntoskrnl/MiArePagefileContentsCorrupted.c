/*
 * XREFs of MiArePagefileContentsCorrupted @ 0x140226808
 * Callers:
...
__int64 __fastcall MiArePagefileContentsCorrupted(__int64 a1, __int128 *a2)
{
  ...
  v5 = *(_QWORD *)(v4 + 16);
  v6 = *(_QWORD *)(*((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v4 + 40) >> 43) & 0x3FFLL))
  ...
  if ( (unsigned int)(*(_DWORD *)a2 - 2) <= 1 )
    return 0LL;
  if ( !*(_DWORD *)a2 && (dword_140FC41F0 & 1) == 0 && (_DWORD)v9 != 31 )
  {
