/*
 * XREFs of IopTrackLink @ 0x140A23294
 * Callers:
 ...
 *     IoGetTransactionParameterBlock @ 0x14040A9A0 (IoGetTransactionParameterBlock.c)
        ...
        KPROCESSOR_MODE AccessMode)
{
  ...
  if ( AccessMode )
  {
    Pool2 = (unsigned int *)ExAllocatePool2(0x123uLL);
    P = Pool2;
    memmove(Pool2, a3, v6);
  }
  else
