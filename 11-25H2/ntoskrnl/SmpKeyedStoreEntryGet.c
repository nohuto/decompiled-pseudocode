/*
 * XREFs of SmpKeyedStoreEntryGet @ 0x1403243B0
 * Callers:
...
__int64 __fastcall SmpKeyedStoreEntryGet(ULONG_PTR BugCheckParameter2, _QWORD *a2, int a3, int a4)
{
  ...
  if ( !a4 )
  {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)BugCheckParameter2, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)BugCheckParameter2, 0, v13, BugCheckParameter2);
    if ( v14 )
      *((_BYTE *)v14 + 10) = 1;
  }
  if ( !a3 )
...
LABEL_13:
  ...
  if ( *(_DWORD *)(BugCheckParameter2 + 8) >= (unsigned int)v17 )
  {
    if ( (unsigned int)v17 < 4 )
      v17 = 4LL;
    v20 = (char *)SmAllocEx(8LL * (unsigned int)v17, 1414032755LL, 0xFFFFFFFFLL);
    if ( v20 )
    {
                  ...
                  * ((HIBYTE(v33)
                    ...
                    * (BYTE6(v33)
                     ...
                     * (BYTE5(v33)
                      ...
                      * (BYTE4(v33)
                       + 37
                       * (BYTE3(v33) + 37 * (BYTE2(v33) + 37 * (BYTE1(v33) + 37 * ((unsigned __int8)v33 + 11623883)))))))) & ((v18 >> 5) - 1)));
  *(_QWORD *)v8 = *v19;
  *v19 = v8;
  ++*(_DWORD *)v16;
