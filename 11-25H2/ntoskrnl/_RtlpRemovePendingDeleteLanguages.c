/*
 * XREFs of _RtlpRemovePendingDeleteLanguages @ 0x140697730
 * Callers:
 ...
 *     RtlpMuiRegGetInstalledLanguageIndexByName @ 0x14081C8C8 (RtlpMuiRegGetInstalledLanguageIndexByName.c)
...
__int64 __fastcall RtlpRemovePendingDeleteLanguages(__int64 a1, __int16 a2)
{
  ...
  *((_OWORD *)v2 + 1) = 0LL;
  ...
  if ( (int)LdrpOpenKey(v2 + 8, 0LL, v6, v2 + 4) >= 0 )
  {
    v7 = 0;
    do
    {
