/*
 * XREFs of EmpParseTargetRules @ 0x140C06A68
 * Callers:
 ...
 *     EmpInfParseGetSectionLineCount @ 0x140C05250 (EmpInfParseGetSectionLineCount.c)
 *     EmpParseTargetRuleStringIndexList @ 0x140C0674C (EmpParseTargetRuleStringIndexList.c)
 *     CmpGetKeyName @ 0x140C0717C (CmpGetKeyName.c)
 *     CmpGetSectionLineIndex @ 0x140C071B4 (CmpGetSectionLineIndex.c)
 *     CmpGetSectionLineIndexValueCount @ 0x140C0722C (CmpGetSectionLineIndexValueCount.c)
 */
