/*
 * XREFs of VslSecurePoolAllocate @ 0x14058AC4C
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  v16 = a3;
  v20 = a2;
  v11 = VslpLockPagesForTransfer((__int64)v13, a4, a3, IoReadAccess, 0);
  if ( v11 >= 0 )
  {
    v17 = v13[0];
    v18 = v13[7];
    v11 = VslpEnterIumSecureMode(2u, 0x55u, 0, (__int64)v14);
    if ( v11 >= 0 )
      *a7 = v16;
  }
  if ( v13[0] )
