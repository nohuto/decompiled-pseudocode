/*
 * XREFs of DifZwResetEventWrapper @ 0x14063B5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwResetEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(27);
  ...
  DWORD2(v14) = ZwResetEvent(EventHandle, PreviousState);
  if ( v5 )
  {
