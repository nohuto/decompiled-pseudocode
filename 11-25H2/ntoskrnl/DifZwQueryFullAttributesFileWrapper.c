/*
 * XREFs of DifZwQueryFullAttributesFileWrapper @ 0x140638D00
 * Callers:
 *     <none>
 * Callees:
        ...
        PFILE_NETWORK_OPEN_INFORMATION FileInformation)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = ObjectAttributes;
    *((_QWORD *)&v13 + 1) = FileInformation;
  ...
  DWORD2(v14) = ZwQueryFullAttributesFile(ObjectAttributes, FileInformation);
  if ( v5 )
  {
