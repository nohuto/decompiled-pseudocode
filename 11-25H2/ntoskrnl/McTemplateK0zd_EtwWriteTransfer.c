/*
 * XREFs of McTemplateK0zd_EtwWriteTransfer @ 0x140423368
 * Callers:
...
__int64 __fastcall McTemplateK0zd_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, const wchar_t *a4, char a5)
{
  __int64 v5; // rax
  int v6; // eax
  ...
  v9 = a4;
  v12 = &a5;
  return McGenEventWrite_EtwWriteTransfer(&MS_KernelPnP_Provider_Context, a2, 0LL, 3LL, v8);
}
