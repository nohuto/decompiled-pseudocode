/*
 * XREFs of MiGetListOfPendingBadPages @ 0x140668070
 * Callers:
...
LABEL_2:
  while ( 2 )
  {
    if ( qword_140E2FC88 + qword_140E2FCE8 < (unsigned __int64)qword_140E2FC88 )
      return 3221225626LL;
    v2 = qword_140E2FCE8 + qword_140E2FC88;
    if ( !(qword_140E2FCE8 + qword_140E2FC88) )
      return 0LL;
    ...
    *(_QWORD *)(Pool + 24) = Pool + 32;
    if ( !qword_140E2FC98 )
    {
      v7 = ExAcquireSpinLockShared(&dword_140E2FC90);
      v8 = v7;
      if ( qword_140E2FC98 || v2 < qword_140E2FCE8 + qword_140E2FC88 )
      {
        MiReleaseSpinLockShared(&dword_140E2FC90, v7);
        ExFreePoolWithTag(v5, 0);
        continue;
      }
      v5[2] += MiEnumerateBadHugeRangePages(v6, v2, 2);
      v17 = (_QWORD *)qword_140E2FC80;
      i = 0LL;
      while ( v17 )
      {
        i = v17;
      ...
      MiReleaseSpinLockShared(&dword_140E2FC90, v8);
LABEL_45:
      v23 = v5[2];
      if ( v23 )
      {
  ...
  if ( v9 )
  {
    v10 = ExAcquireSpinLockShared(&dword_140E2FC90);
    v11 = MiEnumerateBadHugeRangePages(v6, v2, 2);
    MiReleaseSpinLockShared(&dword_140E2FC90, v10);
    v12 = v11 + v5[2];
    v5[2] = v12;
    if ( v12 != v2 )
    {
