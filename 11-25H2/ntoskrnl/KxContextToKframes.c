/*
 * XREFs of KxContextToKframes @ 0x140263370
 * Callers:
...
LABEL_15:
    ...
    if ( v30 != _R8 || (*(_BYTE *)(v29 + 1250) & 2) != 0 )
    {
      ...
      else
      {
        if ( (v31 & 2) != 0 )
          ...
          LODWORD(v32) = 0;
        VslKernelShadowStackAssist(3, (_DWORD)_RDX, 0, v32, _R8, 4);
      }
    }
  }
  ...
  if ( a5 )
  {
    *(_QWORD *)(a1 + 216) = v18 > 0x7FFFFFFEFFFFLL ? 0LL : v18;
    v24 = *(_QWORD *)(a3 + 80);
    *(_QWORD *)(a1 + 224) = v24 > 0x7FFFFFFEFFFFLL ? 0LL : v24;
    v25 = *(_QWORD *)(a3 + 88);
    *(_QWORD *)(a1 + 232) = v25 > 0x7FFFFFFEFFFFLL ? 0LL : v25;
    v19 = 0LL;
