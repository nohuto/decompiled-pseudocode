/*
 * XREFs of KiMcheckAbort @ 0x1406AF7C0
 * Callers:
 *     KiMcheckAbortShadow @ 0x140BAA9C0 (KiMcheckAbortShadow.c)
 * Callees:
...
LABEL_8:
    ...
    v17 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (v19 | (unsigned int)v18))] - 384;
    goto LABEL_8;
  }
  if ( (KiKvaShadow & 1) == 0 )
    __asm { swapgs }
