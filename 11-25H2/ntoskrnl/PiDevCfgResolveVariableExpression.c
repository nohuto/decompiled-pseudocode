/*
 * XREFs of PiDevCfgResolveVariableExpression @ 0x140A8C530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiDevCfgResolveVariableExpression(__int64 a1, void *a2, __int64 a3)
{
  ...
  UNICODE_STRING *v161; // [rsp+68h] [rbp-21h] BYREF
  ...
  if ( !PnpValidateRegistryMultiSz(P) )
    goto LABEL_357;
  v8 = (UNICODE_STRING *)(v6 + *(unsigned int *)(v6 + 8));
  v161 = v8;
  v9 = v8;
  if ( v8->Length == (_WORD)v7 )
    goto LABEL_357;
  do
  {
    v3 += v7 + 1;
    ...
    do
      ++v10;
    while ( *(&v9->Length + v10) != (_WORD)v7 );
    v9 = (UNICODE_STRING *)((char *)v9 + 2 * v10 + 2);
  }
  while ( v9->Length != (_WORD)v7 );
  v11 = v163;
  v162 = v3;
  if ( !v3 )
  {
LABEL_357:
  ...
  while ( 1 )
  {
    ...
    if ( v8->MaximumLength && *(&v8->MaximumLength + 1) )
      goto LABEL_323;
    for ( i = 1; ; ++i )
    {
      if ( i >= 0x1B )
        goto LABEL_323;
      if ( *(_DWORD *)&v8->Length == *(_DWORD *)qword_140B31DE0[3 * i + 1] )
        break;
    }
    v15 = &qword_140B31DE0[3 * i];
    if ( !v15 )
    {
LABEL_323:
      ...
      {
        v161 = 0LL;
        v142 = PiDevCfgResolveVariable(v11, &v8->Length, &v161);
        RegistryValue = v142;
        if ( v142 >= 0 )
        {
          v12[(unsigned int)v4] = (__int64)v161;
          goto LABEL_320;
        }
        if ( v142 == -1073741772 )
LABEL_352:
...
LABEL_296:
    ...
    *(_QWORD *)(v131 + 24) = 0LL;
    ...
    else
    {
      v132 = 4;
      LODWORD(v19) = 4;
      v136 = (_DWORD *)ExAllocatePool2(0x100uLL);
      v22 = v136;
      if ( !v136 )
      {
LABEL_331:
...
LABEL_320:
    ...
    do
      ++v141;
    while ( *(&v8->Length + v141) );
    v8 = (UNICODE_STRING *)((char *)v8 + 2 * v141 + 2);
    LODWORD(v4) = v4 + 1;
    v161 = v8;
    v158 = v4;
  }
...
LABEL_142:
            if ( !*v67 || v68 <= 2 )
              goto LABEL_146;
            v155 = v68;
            v71 = (void *)ExAllocatePool2(0x100uLL);
            v157 = (__int64)v71;
            if ( !v71 )
              goto LABEL_328;
            memmove(v71, v67, v68);
...
LABEL_163:
            ...
            v152 = v75 + v72;
            v155 = v75 + v72;
            v81 = (void *)ExAllocatePool2(0x100uLL);
            v157 = (__int64)v81;
            if ( !v81 )
              goto LABEL_328;
          ...
          if ( !v77 )
            goto LABEL_246;
          v152 = v72 - v75;
          v78 = (char *)ExAllocatePool2(0x100uLL);
          v157 = (__int64)v78;
          if ( !v78 )
            goto LABEL_328;
          v79 = v77 - v74;
...
LABEL_110:
          ...
          if ( *v42 )
          {
            if ( (unsigned __int64)(unsigned int)(v19 + v41) - 2 > 0xFFFE )
              goto LABEL_330;
            v152 = v19 + v41 - 2;
            v55 = (char *)ExAllocatePool2(0x100uLL);
            v157 = (__int64)v55;
            v56 = v55;
            if ( !v55 )
              goto LABEL_328;
...
LABEL_227:
  ...
  if ( (unsigned int)(v105 - 1) <= 1 )
  {
    ...
    if ( !v117 )
    {
      ...
      v152 = v113 + v115;
      v155 = v115 + v111;
      v127 = (char *)ExAllocatePool2(0x100uLL);
      v157 = (__int64)v127;
      v128 = v127;
      if ( !v127 )
      {
...
LABEL_238:
      if ( (unsigned int)(v19 + v106) > 0xFFFE )
        goto LABEL_330;
      v152 = v19 + v106;
      v109 = (char *)ExAllocatePool2(0x100uLL);
      v157 = (__int64)v109;
      v110 = v109;
      if ( !v109 )
        goto LABEL_328;
