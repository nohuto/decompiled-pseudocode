/*
 * XREFs of VmpPinMemoryRange @ 0x14063ED00
 * Callers:
 ...
 *     VmpCountNewPinnedRangesNeeded @ 0x14063E65C (VmpCountNewPinnedRangesNeeded.c)
 ...
 *     VmpCheckPinTooLate @ 0x14078FE00 (VmpCheckPinTooLate.c)
