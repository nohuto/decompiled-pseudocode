/*
 * XREFs of PspSetCreateProcessNotifyRoutine @ 0x140A8B2EC
 * Callers:
 *     PsSetCreateProcessNotifyRoutine @ 0x14076A560 (PsSetCreateProcessNotifyRoutine.c)
 *     PsSetCreateProcessNotifyRoutineEx @ 0x14076A580 (PsSetCreateProcessNotifyRoutineEx.c)
 *     PsSetCreateProcessNotifyRoutineEx2 @ 0x14076A5A0 (PsSetCreateProcessNotifyRoutineEx2.c)
 * Callees:
