/*
 * XREFs of SecureDump_PrepareForInit @ 0x14059E99C
 * Callers:
...
void __fastcall SecureDump_PrepareForInit(__int64 a1, _BYTE *a2)
{
  ...
  *(_OWORD *)&dwFlags = 0LL;
  ...
  {
    LODWORD(xmmword_140E65E08) = *(_DWORD *)P;
    ExFreePoolWithTag(P, 0);
    P = 0LL;
    if ( (_DWORD)xmmword_140E65E08 )
      goto LABEL_16;
  }
  ...
  {
    DWORD1(xmmword_140E65E08) = *(_DWORD *)P;
    ExFreePoolWithTag(P, 0);
    P = 0LL;
      ...
      *a2 = 1;
      ...
      if ( SecureDmpLoadCertificate
        || (int)SecureDump_ReadRegistry(
                  ...
                  3,
                  (unsigned int)&xmmword_140E65E08 + 8,
                  (__int64)&dwFlags) >= 0
        && (int)SecureDump_ReadRegistry(
                  (unsigned int)v9,
