/*
 * XREFs of MiCopyMemoryPagefileData @ 0x140682A90
 * Callers:
...
char __fastcall MiCopyMemoryPagefileData(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( a2 && (v9 = MiReservePtes((__int64)&qword_140E37328, a4), (v10 = v9) != 0) )
  {
    ...
    LOBYTE(v14) = MiReleasePtes((__int64)&qword_140E37328, (unsigned __int64 *)v10, a4);
  }
  else
  {
    v14 = &a1[a4];
    ...
    if ( a1 < v14 )
    {
      ...
      do
      {
        MiGetPteMappingSet(0, 2LL, (__int64)&v34);
        v17 = (_QWORD *)BugCheckParameter2;
        v18 = 48LL * *a1 - 0x220000000000LL;
        v19 = 1;
        ...
        *(_QWORD *)v24 = v27;
        ...
        KeCopyPage(v28, v30, v37);
        *(_QWORD *)BugCheckParameter2 = CLFS_LSN_NULL_EXT;
        *(_QWORD *)(BugCheckParameter2 + 8) = CLFS_LSN_NULL_EXT;
        LOBYTE(v14) = (unsigned __int8)MiReturnPteMappingSet((__int64)&v34);
        LOBYTE(v15) = v32;
        ++a1;
        ++a3;
        v16 += 48LL;
      }
      while ( (unsigned __int64)a1 < v33 );
    }
  }
  return (char)v14;
}
