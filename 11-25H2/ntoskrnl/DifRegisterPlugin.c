/*
 * XREFs of DifRegisterPlugin @ 0x14060CC10
 * Callers:
 ...
 *     VfBindDifCallbackWrappers @ 0x140B79F60 (VfBindDifCallbackWrappers.c)
 *     VfBindDifDDIWrappers @ 0x140B79FA0 (VfBindDifDDIWrappers.c)
...
LABEL_38:
      ...
      v24 = (_QWORD *)qword_140F034E8;
      v25 = (_QWORD *)(v15 + 16);
      if ( *(__int64 **)qword_140F034E8 != &DifAPIThunkContextHead )
        goto LABEL_41;
      *v25 = &DifAPIThunkContextHead;
      *(_QWORD *)(v15 + 24) = v24;
      *v24 = v25;
      qword_140F034E8 = v15 + 16;
