/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x1408AABCC
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x140736B00 (AlpcpAllocateSnapshotMessageLog.c)
