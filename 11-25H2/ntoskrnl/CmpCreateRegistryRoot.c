/*
 * XREFs of CmpCreateRegistryRoot @ 0x140C35AB8
 * Callers:
 ...
 *     EnlistKeyBodyWithKCB @ 0x1409A6E20 (EnlistKeyBodyWithKCB.c)
...
__int64 __fastcall CmpCreateRegistryRoot(__int64 a1, __int64 a2)
{
  ...
  if ( inserted >= 0 )
  {
    ...
    v16 = v3;
    v17 = 0LL;
    inserted = ObCreateObject(0, CmKeyObjectType, (int)v11, 0, 0, 112, 0, 0, &Object);
    ExFreePoolWithTag(v3, 0);
    if ( inserted >= 0 )
    {
      RtlInitUnicodeString(&DestinationString, L"REGISTRY");
      v4 = CmpHashUnicodeComponent((__int128 *)&DestinationString);
