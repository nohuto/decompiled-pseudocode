/*
 * XREFs of MmManageFaultRange @ 0x140674D44
 * Callers:
 *     RtlpEnvRegisterFaultRange @ 0x1405FB258 (RtlpEnvRegisterFaultRange.c)
 * Callees:
...
LABEL_12:
  v12 = ExAcquireSpinLockExclusive(&dword_140E2C830);
  if ( !v9 )
  {
    v16 = qword_140E2C838[0];
    while ( v16 )
    {
    ...
    RtlAvlRemoveNode(qword_140E2C838, v16);
    goto LABEL_31;
  }
  v13 = (_QWORD *)qword_140E2C838[0];
  v14 = 0;
  if ( !qword_140E2C838[0] )
    goto LABEL_21;
...
LABEL_19:
  ...
  v14 = 1;
LABEL_21:
  RtlAvlInsertNodeEx(qword_140E2C838, (unsigned __int64)v13, v14, v8);
  v16 = 0LL;
LABEL_31:
  MiReleaseSpinLockExclusive(&dword_140E2C830, v12);
  if ( v16 )
  {
    while ( v4 < 2 )
    {
