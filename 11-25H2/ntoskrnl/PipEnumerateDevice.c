/*
 * XREFs of PipEnumerateDevice @ 0x1408353E4
 * Callers:
...
__int64 __fastcall PipEnumerateDevice(__int64 a1, int a2, int a3)
{
    ...
    || (v5 = PnpDeviceCompletionRequestCreate(a1, 783, 0LL)) == 0 )
  {
    ...
    PnpPoFxActivateDevice(a1, 128);
    DeviceRelations = PnpQueryDeviceRelations(*(_QWORD *)(a1 + 32), 0, 0LL, a1 + 528);
  ...
  else
  {
    ...
    *(_DWORD *)(a1 + 392) = 259;
    ...
    PipClearDevNodeFlags(a1, 8);
    PnpPoFxActivateDevice(a1, 128);
    v7 = PnpQueryDeviceRelations(*(_QWORD *)(a1 + 32), 0, (__int64)PnpDeviceCompletionRoutine, v5);
    v9 = v7;
    if ( v7 == 259 )
    {
