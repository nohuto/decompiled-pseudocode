/*
 * XREFs of KiProcessDeferredDpcWatchdogViolation @ 0x140279214
 * Callers:
...
void (__fastcall __noreturn *__fastcall KiProcessDeferredDpcWatchdogViolation(__int64 a1))()
{
  ...
  xmmword_140F0F4D0 = 0LL;
  xmmword_140F0F4E0 = 0LL;
  LOWORD(xmmword_140F0F4E0) = *(_WORD *)(a1 + 392);
  *((_QWORD *)&xmmword_140F0F4D0 + 1) = *(_QWORD *)(a1 + 384);
  LODWORD(xmmword_140F0F4D0) = *(_DWORD *)(a1 + 376);
  WORD4(KiInjectedMachineFrame) = *(_WORD *)(a1 + 368);
  *(_QWORD *)&KiInjectedMachineFrame = *(_QWORD *)(a1 + 360);
  *((_QWORD *)&xmmword_140F0F4E0 + 1) = *(_QWORD *)(a1 + 56);
