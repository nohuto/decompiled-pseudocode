/*
 * XREFs of ValidFilter @ 0x14083A17C
 * Callers:
...
__int64 __fastcall ValidFilter(unsigned int a1, _DWORD *a2)
{
  ...
  if ( !a1 )
    return 0LL;
  v4 = (*a2 & 0xFF00000) != 0
     ? FilterEvalStrict((unsigned int)GetPropertyFromPropArray, (unsigned int)v8, a1, (_DWORD)a2, (__int64)&v7)
     : FilterEvalImpliedAnd((unsigned int)GetPropertyFromPropArray, (unsigned int)v8, a1, (_DWORD)a2, (__int64)&v7);
  if ( v4 == -1073741811 )
    return 0LL;
  for ( i = 0; i < a1; ++i )
  {
