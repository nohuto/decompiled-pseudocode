/*
 * XREFs of MiInitializeKernelScp @ 0x140C44578
 * Callers:
...
__int64 MiInitializeKernelScp()
{
  ...
  KernelScpFunctionTable = RtlCreateKernelScpFunctionTable((unsigned int)v0, Base, dword_140E2D4FC << 12);
  if ( KernelScpFunctionTable < 0 )
  {
    BugCheckParameter4 = 167LL;
    goto LABEL_9;
  }
  KernelScpFunctionTable = dword_140E2D508;
  if ( dword_140E2D508 >= 0 )
  {
