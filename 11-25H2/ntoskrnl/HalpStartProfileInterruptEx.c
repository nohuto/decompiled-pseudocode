/*
 * XREFs of HalpStartProfileInterruptEx @ 0x140543820
 * Callers:
 *     HalStartProfileInterrupt @ 0x140542740 (HalStartProfileInterrupt.c)
 * Callees:
 *     _guard_dispatch_icall_no_overrides @ 0x1406A8B20 (_guard_dispatch_icall_no_overrides.c)
 */

__int64 __fastcall HalpStartProfileInterruptEx(int a1, _DWORD *a2, unsigned int *a3, _DWORD *a4, _QWORD *a5)
{
  __int64 v5; // r12
  _DWORD *v10; // rbx
  int v11; // r9d
...
LABEL_8:
  ...
  v11 = guard_dispatch_icall_no_overrides(0LL);
  if ( v11 < 0 )
