/*
 * XREFs of PopDirectedDripsInitializeBroadcast @ 0x140A3B9D4
 * Callers:
 ...
 *     PopDirectedDripsDiagTraceTransition @ 0x140754BEC (PopDirectedDripsDiagTraceTransition.c)
 ...
 *     PopDirectedDripsInitializeDeviceTree @ 0x140A3BC00 (PopDirectedDripsInitializeDeviceTree.c)
...
__int64 __fastcall PopDirectedDripsInitializeBroadcast(volatile signed __int32 *a1)
{
  ...
  v5 = dword_140F0D670 & 1;
  if ( (dword_140F0D670 & 2) != 0 )
    v5 |= 2u;
