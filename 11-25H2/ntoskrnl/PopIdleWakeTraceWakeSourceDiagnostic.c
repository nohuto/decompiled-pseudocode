/*
 * XREFs of PopIdleWakeTraceWakeSourceDiagnostic @ 0x140A6A2F4
 * Callers:
 ...
 *     PopIdleWakeCalculateConvergedBuckets @ 0x140752174 (PopIdleWakeCalculateConvergedBuckets.c)
...
char __fastcall PopIdleWakeTraceWakeSourceDiagnostic(__int64 a1, __int64 a2)
{
  ...
  if ( PopDiagSleepStudyHandleRegistered )
  {
    ...
    if ( result )
    {
      PopIdleWakeCalculateConvergedBuckets(a2, (__int64)v18);
