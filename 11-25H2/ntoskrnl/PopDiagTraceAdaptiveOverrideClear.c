/*
 * XREFs of PopDiagTraceAdaptiveOverrideClear @ 0x140749358
 * Callers:
...
void PopDiagTraceAdaptiveOverrideClear()
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v4 = 0x1000000LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_14004AD8B, 0LL, 0LL, 5u, &v5);
  }
}
