/*
 * XREFs of SshSessionManagerTraceCsExitReasonV1 @ 0x1407570F8
 * Callers:
...
__int64 __fastcall SshSessionManagerTraceCsExitReasonV1(__int64 a1, __int64 a2, __int64 a3)
{
  int v4; // eax
  ...
  _QWORD v22[44]; // [rsp+60h] [rbp-A0h] BYREF
  ...
  v22[30] = &v20;
  v22[32] = a3 + 57;
  v16 = *(unsigned __int8 *)(a3 + 61);
  v22[34] = &v16;
  v17 = *(unsigned __int8 *)(a3 + 62);
  v22[36] = &v17;
  ...
  v22[41] = 4LL;
  v22[43] = 1LL;
  return SshpSessionManagerSendControlEvent(SLEEPSTUDY_EVT_CS_EXIT_REASON_CONTROL_EVENT, 22LL, v22);
}
