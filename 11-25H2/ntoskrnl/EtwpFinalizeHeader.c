/*
 * XREFs of EtwpFinalizeHeader @ 0x140992E74
 * Callers:
 ...
 *     EtwpIsListEmptyRaw @ 0x1406443DC (EtwpIsListEmptyRaw.c)
    ...
    if ( !a2 )
    {
      ...
      *(_DWORD *)(Buffer + 152) += *(_DWORD *)(a1 + 240);
      ...
      if ( (unsigned __int8)EtwpIsWow64Logger(a1) )
        *(_DWORD *)(Buffer + 372) += v12;
      else
        *(_DWORD *)(Buffer + 380) += v12;
...
LABEL_22:
        ...
        if ( !a2 && v15 >= 0 )
        {
          ...
          if ( (v16 & 0x20) != 0 )
          {
            ...
            v26 = 0LL;
            if ( (v16 & 0x4000000) != 0 && (v16 & 1) != 0 )
              v18 = *(_QWORD *)(a1 + 216);
            else
              v18 = *(unsigned int *)(a1 + 4) * (unsigned __int64)*(unsigned int *)(a1 + 248);
            if ( v18 < v17 )
            {
              v20 = *(void **)(a1 + 800);
              FileInformation = v18;
...
LABEL_25:
      ...
      v10 = ZwReadFile(
              *(HANDLE *)(a1 + 800),
              ...
              FileInformation & (v19 - v11.LowPart + v23 - 1),
              &ByteOffset,
              0LL);
      if ( v10 < 0 )
        goto LABEL_25;
