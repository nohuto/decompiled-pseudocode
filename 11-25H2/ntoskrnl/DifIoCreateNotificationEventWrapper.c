/*
 * XREFs of DifIoCreateNotificationEventWrapper @ 0x14061B530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoCreateNotificationEventWrapper(PUNICODE_STRING EventName, PHANDLE EventHandle)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = EventName;
    *((_QWORD *)&v13 + 1) = EventHandle;
  ...
  *((_QWORD *)&v14 + 1) = IoCreateNotificationEvent(EventName, EventHandle);
  if ( v5 )
  {
