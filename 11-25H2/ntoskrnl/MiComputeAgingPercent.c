/*
 * XREFs of MiComputeAgingPercent @ 0x1403C1EA4
 * Callers:
...
__int64 __fastcall MiComputeAgingPercent(__int64 a1)
{
  ...
  v3 = 0;
  v4 = AvailablePagesForTrimPass;
  v5 = 0LL;
  v6 = (unsigned __int64 *)(v2 + 200);
  v7 = 8LL;
  do
  {
    v8 = *v6;
  ...
  while ( v7 );
  v9 = v5 >> 3;
  *(_QWORD *)(v2 + 264) = (v4 + 7 * v9) >> 3;
  *(_QWORD *)(v2 + 8LL * ((*(_DWORD *)(v2 + 120))++ & 7) + 200) = v4;
  if ( v4 >= v9 )
  {
    result = 3600LL;
    goto LABEL_15;
