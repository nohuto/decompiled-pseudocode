/*
 * XREFs of ExpMoveSharedFastResourceOwnershipWithFlags @ 0x140406C0C
 * Callers:
 *     ExMoveFastResourceOwnershipWithFlags @ 0x140406BE0 (ExMoveFastResourceOwnershipWithFlags.c)
 * Callees:
...
char __fastcall ExpMoveSharedFastResourceOwnershipWithFlags(
...
LABEL_34:
    ...
    *v25 = a3;
    LOBYTE(v20) = KxReleaseSpinLock((volatile signed __int64 *)(CurrentThread + 1736));
  }
  else
  {
    v20 = (unsigned __int64 *)(CurrentThread + 1720);
  ...
  if ( SchedulerAssist )
  {
    ...
    LODWORD(v20) = *SchedulerAssist;
    do
    {
      v24 = (int)v20;
      LODWORD(v20) = _InterlockedCompareExchange(SchedulerAssist, (unsigned int)v20 & 0xFFDFFFFF, (signed __int32)v20);
    }
    while ( v24 != (_DWORD)v20 );
    if ( ((unsigned int)v20 & 0x200000) != 0 )
      LOBYTE(v20) = KiRemoveSystemWorkPriorityKick((__int64)CurrentPrcb);
  }
  _enable();
  *(_DWORD *)(a2 + 32) = 0;
  *(_BYTE *)(a2 + 36) = 0;
  *(_QWORD *)(a2 + 24) = 0LL;
  if ( v19 )
    LOBYTE(v20) = KeAbMarkCrossThreadReleasable((__int64)CurrentPrcb, (__int64 *)v19);
  if ( v18 )
    LOBYTE(v20) = ObfReferenceObjectWithTag((PVOID)CurrentThread, 0x746C6644u);
  return (char)v20;
}
