/*
 * XREFs of KseUnregisterShim @ 0x140732F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KseUnregisterShim(__int64 a1)
{
  ...
  v5 = KeAbPreAcquire((__int64)&qword_140E66840, 0LL);
  v7 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140E66840, 0LL);
  v8 = v5;
  if ( v7 )
    ExfAcquirePushLockExclusiveEx(&qword_140E66840, v5, (__int64)&qword_140E66840);
  if ( v8 )
    *((_BYTE *)v8 + 10) = 1;
  if ( (unsigned int)KsepIsShimRegistered(&KseEngine, *(_QWORD *)(a1 + 8), v6, &v16) )
  {
    if ( *((_DWORD *)v16 + 6) )
    {
      ...
      dword_140F0ECA4[2 * v11] = -1073741790;
  ...
  else
  {
    ...
    dword_140F0ECA4[2 * v15] = -1073741772;
