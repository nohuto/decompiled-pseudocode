/*
 * XREFs of DifPoFxReportDevicePoweredOnWrapper @ 0x14062BA30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxReportDevicePoweredOnWrapper(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v5 = 0;
    *((_QWORD *)&v10 + 1) = BugCheckParameter3;
  ...
  PopFxHandleReportDevicePoweredOn(BugCheckParameter3);
  if ( v3 )
  {
