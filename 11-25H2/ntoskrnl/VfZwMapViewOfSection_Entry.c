/*
 * XREFs of VfZwMapViewOfSection_Entry @ 0x140B845D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VfZwMapViewOfSection_Entry(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  if ( (_DWORD)result )
  {
    ...
    return ViZwCheckVirtualAddress(*(_QWORD *)(a1 + 24), *(_QWORD *)a1);
  }
  return result;
}
