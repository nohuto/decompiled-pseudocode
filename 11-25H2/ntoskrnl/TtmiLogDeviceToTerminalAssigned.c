/*
 * XREFs of TtmiLogDeviceToTerminalAssigned @ 0x14075D348
 * Callers:
...
void __fastcall TtmiLogDeviceToTerminalAssigned(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v6 = a1;
    v7 = a2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&word_14004F356, 0LL, 0LL, 5u, &v8);
  }
}
