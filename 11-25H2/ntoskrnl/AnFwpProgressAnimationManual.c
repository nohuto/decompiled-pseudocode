/*
 * XREFs of AnFwpProgressAnimationManual @ 0x140BA227C
 * Callers:
...
LONGLONG AnFwpProgressAnimationManual()
{
  ...
  result = qword_140EEF828;
  if ( v0.QuadPart + v2 >= qword_140EEF828 + v9.QuadPart / 33 )
  {
    v4 = word_140E0ECB0;
    v5 = word_140E0ECAC;
    if ( word_140E0ECB0 != word_140E0ECAC && (qword_140EEF828 - v0.QuadPart - v2) / v1 >= 2 )
      v4 = ++word_140E0ECB0;
    v6 = word_140E0ECA8;
    if ( v4 >= (unsigned __int16)word_140E0ECA8 )
    {
      if ( v4 > (unsigned __int16)word_140E0ECAC )
        goto LABEL_10;
      LogFwStat(1LL, 1LL);
