/*
 * XREFs of CmpFindSubKeyInLeafWithStatus @ 0x140877170
 * Callers:
...
LABEL_89:
    ...
    while ( 1 )
    {
      ...
      if ( v20 >= 0x61 )
      {
        ...
        {
          v25 = PsGetCurrentServerSiloGlobals()[75].Flink;
          if ( v25 && (unsigned __int16)v24 >= 0xC0u )
            LOWORD(v24) = *((_WORD *)&v25->Flink
                          + (v24 & 0xF)
                          + *((unsigned __int16 *)&v25->Flink + LOWORD(v25->Flink) + (v24 >> 4)))
                        + v24;
