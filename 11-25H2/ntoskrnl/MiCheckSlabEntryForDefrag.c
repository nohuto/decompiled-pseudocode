/*
 * XREFs of MiCheckSlabEntryForDefrag @ 0x14067B014
 * Callers:
 *     MiFindDefragmentSlabEntriesHelper @ 0x14067C3D0 (MiFindDefragmentSlabEntriesHelper.c)
 *     MiFindDefragmentSlabEntriesHelperByIdentity @ 0x14067C470 (MiFindDefragmentSlabEntriesHelperByIdentity.c)
 * Callees:
 *     <none>
 */
