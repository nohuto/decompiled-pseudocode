/*
 * XREFs of EtwpBuildNotificationPacket @ 0x1409EF2A0
 * Callers:
...
__int64 __fastcall EtwpBuildNotificationPacket(__int64 a1, _OWORD *a2, unsigned __int8 a3, __int64 *a4)
{
  __int64 v4; // r11
  unsigned int v5; // ebx
  int v10; // esi
  ...
  do
  {
    if ( *v12 && *(_QWORD *)v13 && ((unsigned __int8)(1 << v11) & a3) != 0 )
...
LABEL_6:
  ...
  *a4 = v19;
  EtwpCopySchematizedFilters((char *)(v19 + 136), a1, a3);
  return v5;
}
