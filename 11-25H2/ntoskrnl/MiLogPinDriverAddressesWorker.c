/*
 * XREFs of MiLogPinDriverAddressesWorker @ 0x140A2F6F0
 * Callers:
 *     <none>
 * Callees:
 *     _tlgWriteAgg @ 0x1403BAC2C (_tlgWriteAgg.c)
 *     _tlgKeywordOn @ 0x14042F500 (_tlgKeywordOn.c)
 *     RtlInterlockedClearBitRun @ 0x14045E050 (RtlInterlockedClearBitRun.c)
    ...
    for ( i = 0; i < 2; ++i )
    {
      for ( j = 0; j < 2; ++j )
      {
        ...
        if ( v7 != *v4 )
        {
          ...
          {
            LOBYTE(v2) = tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000000LL);
            if ( (_BYTE)v2 )
            {
              v19 = 8LL;
              v12 = v3;
              ...
              v24 = &v14;
              v26 = &v16;
              LOBYTE(v2) = tlgWriteAgg(v8, (unsigned __int8 *)byte_140057225, v8, 7u, (__int64)v17);
            }
          }
          *v4 = v7;
        }
