/*
 * XREFs of MiAllocateUserPhysicalPages @ 0x1407E8638
 * Callers:
 *     NtAllocateUserPhysicalPages @ 0x1407E9D00 (NtAllocateUserPhysicalPages.c)
 *     NtAllocateUserPhysicalPagesEx @ 0x1407E9D20 (NtAllocateUserPhysicalPagesEx.c)
 * Callees:
...
LABEL_168:
              if ( (v7 & 1) != 0 )
              {
                KiUnstackDetachProcess((__int64)v121, 0LL);
                LOBYTE(v7) = v7 & 0xFE;
              }
              if ( CrossPartitionCharges < 0 )
              {
