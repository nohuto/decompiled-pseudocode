/*
 * XREFs of sub_140AB6360 @ 0x140AB6360
 * Callers:
...
__int64 __fastcall sub_140AB6360(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  void *v5; // r13
  unsigned int *v8; // rax
  ...
  if ( qword_140FD73C8 )
    v30 = guard_dispatch_icall_no_overrides(v18);
  else
    v30 = -1073741637;
