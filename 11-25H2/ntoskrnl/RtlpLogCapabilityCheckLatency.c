/*
 * XREFs of RtlpLogCapabilityCheckLatency @ 0x140A81324
 * Callers:
      ...
      if ( RtlpPerformanceCounterFrequency.QuadPart )
      {
        if ( *a1 )
        {
          if ( *a2 )
          {
            ...
            if ( !result )
            {
              if ( (unsigned int)dword_140E086C0 > 5 && tlgKeywordOn((__int64)&dword_140E086C0, 0x200000000000LL) )
              {
                v12 = 1000000LL * (*a2 - *a1);
                v20 = 8LL;
                v13 = a3;
                ...
                tlgWriteTransfer_EtwWriteTransfer(
                  (__int64)&dword_140E086C0,
                  (unsigned __int8 *)&word_14004FE5E,
                  v11,
                  0LL,
                  7u,
                  &v18);
