/*
 * XREFs of CcSetLogHandleForFileEx @ 0x140448570
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CcSetLogHandleForFileEx(__int64 a1, __int64 a2, __int64 a3, __int64 a4, PVOID Object)
{
  ...
  *(_QWORD *)&v37.OldIrql = &CcMasterLock;
  ...
  {
    v13 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)&CcMasterLock, (__int64)&v37.LockQueue.Lock);
    if ( v13 )
      KxWaitForLockOwnerShip((struct _KPRCB *)&v37.LockQueue.Lock, v13);
  }
  else
  {
  ...
  if ( (BYTE6(PerfGlobalGroupMask) & 0x21) == 0 || PopHibernateInProgress )
  {
    v14 = (struct _KPRCB **)_InterlockedExchange64(v10 + 96, (__int64)&LockHandle);
    if ( v14 )
