/*
 * XREFs of SepAccessCheck @ 0x1403662B0
 * Callers:
...
LABEL_34:
  ...
  if ( (a5 & 0x2000000) == 0 && !a14 )
  {
    ...
    *(_DWORD *)(v109 + 12) = *((_DWORD *)a6 + 6);
    ...
    {
      if ( (v34 & 8) != 0 )
        v60 = v112[1] & ~(*v112 | v112[2]) | 0x10D0000;
      else
        v60 = v112[3] | 0x1FFFFF;
      v35 = a5;
      if ( (v60 & a5) == 0 )
...
LABEL_28:
          ...
          if ( (v37 & 0x4000) != 0 )
          {
            v62 = (*(_DWORD *)v32 | v61) & ~(*(_DWORD *)(v32 + 4) | *(_DWORD *)(v32 + 8));
            if ( v62 && !v36 && (v37 & 0x3000000) == 0x3000000 )
            {
              *(_BYTE *)(v32 + 23) = 1;
              v62 = 0;
            }
          ...
          else
          {
            ...
            v62 = ~*(_DWORD *)(v32 + 4) & (*(_DWORD *)v32 | v61);
          }
          *((_DWORD *)a6 + 6) = v62;
          if ( v62 )
          {
...
LABEL_52:
      ...
      SepNormalAccessCheck(v106 & v60, v116, v115, v26, v28, v114, v113, v108, (__int64)a6, a7, 1, a15, v32);
      v33 = v116;
      v32 = v109;
    }
    v35 = a5;
  ...
  SepMaximumAccessCheck(v20, v115, v26, v28, v114, v113, v31, (__int64)a6, a7, 0, 0, a15, v109);
  v46 = v116;
  v47 = *(_DWORD *)(v116 + 200);
  if ( (v47 & 0x10) != 0 )
  {
    if ( (v47 & 8) != 0 )
      ...
      v66 = v112[3] | 0x1FFFFF;
    SepMaximumAccessCheck(v116, v115, v26, v28, v114, v113, v108, (__int64)a6, a7, v66, 1, a15, v109);
    v46 = v116;
  }
  v48 = *(_DWORD *)(v46 + 200);
  v49 = *((_DWORD *)a6 + 7);
