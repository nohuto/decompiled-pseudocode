/*
 * XREFs of PopUsbErrorWNFNotificationCallback @ 0x14074F7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopUsbErrorWNFNotificationCallback(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v23 = 1;
    v28 = 0x1000000LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)&word_14004BEC6, 0LL, 0LL, 8u, &v9);
  }
