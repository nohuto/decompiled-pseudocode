/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromRegValue @ 0x1409ABB18
 * Callers:
 *     _CmGetInstallerClassMappedPropertyKeys @ 0x14080EEE0 (_CmGetInstallerClassMappedPropertyKeys.c)
 *     _CmGetInstallerClassMappedProperty @ 0x1409AB224 (_CmGetInstallerClassMappedProperty.c)
 * Callees:
...
LABEL_94:
    ...
    if ( !v22 || v22 == PnpRegQueryValueIndirect )
      ...
      v23 = guard_dispatch_icall_no_overrides(v53);
