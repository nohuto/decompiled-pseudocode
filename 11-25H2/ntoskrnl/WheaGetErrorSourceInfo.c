/*
 * XREFs of WheaGetErrorSourceInfo @ 0x1407B7C20
 * Callers:
...
__int64 __fastcall WheaGetErrorSourceInfo(int a1, unsigned int *a2, __int64 *a3)
{
  ...
  *a2 = 0;
  ...
  v10 = 0;
  v11 = 0;
  if ( dword_140EEEA44 && (__int64 *)v3 != &qword_140EEEA50 )
  {
    do
    {
      if ( v9 >= dword_140EEEA44 )
        break;
      ++v9;
      v12 = *(_DWORD *)(v3 + 40);
      v13 = v10 + 1;
    ...
    while ( (__int64 *)v3 != &qword_140EEEA50 );
    if ( v10 )
    {
      ...
      {
        v14 = qword_140EEEA50;
        for ( i = 0; (__int64 *)v14 != &qword_140EEEA50 && i < dword_140EEEA44 && v4 < v10; ++i )
        {
          if ( *(_DWORD *)(v14 + 40) == a1 )
          {
            v16 = v4++;
