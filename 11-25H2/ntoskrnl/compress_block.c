/*
 * XREFs of compress_block @ 0x1405F6BE8
 * Callers:
 *     _tr_flush_block @ 0x1405F64E8 (_tr_flush_block.c)
 * Callees:
 *     <none>
 */
...
char __fastcall compress_block(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v65; // edx
  __int16 v66; // r9
  _DWORD *v67; // [rsp+8h] [rbp-50h]
  _DWORD *v68; // [rsp+60h] [rbp+8h]
  __int64 *v69; // [rsp+68h] [rbp+10h]
  _DWORD *v71; // [rsp+78h] [rbp+20h]
  ...
  if ( *(_DWORD *)(a1 + 5956) )
  {
    do
    {
      ...
      {
        v23 = *((unsigned __int8 *)length_code + v13);
        v24 = *(_WORD *)(a1 + 5980);
        ...
        *v4 = v32;
        ...
        if ( (unsigned int)v38 >= 0x100 )
          v39 = *((_BYTE *)&dist_code[32] + ((unsigned int)v38 >> 7));
        else
        ...
        *(_WORD *)(a1 + 5980) = v51;
        *v4 = v50;
        v52 = dword_1400351B0[v40];
        if ( v52 )
        {
          v53 = v38 - dword_140035730[v40];
          *(_WORD *)(a1 + 5980) = v51 | ((_WORD)v53 << v50);
          ...
          else
          {
            v8 = (__int64 *)(a1 + 16);
            v17 = v68;
            *(_BYTE *)(*v49 + *v69) = *(_BYTE *)(a1 + 5980);
            v54 = *v69;
            *(_BYTE *)((unsigned int)++*v71 + v54) = *(_BYTE *)(a1 + 5981);
