/*
 * XREFs of ?BTreeDeleteEx@?$B_TREE@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_HASH_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14039C5C0
 * Callers:
        ...
        __int64 a2)
{
  ...
  else
  {
    ...
    {
      v15 = B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_HASH_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_HASH_ENTRY_COMPARATOR>::BTreeRedistribute(
              a1,
              a2);
      if ( !v15 )
        return 3221225478LL;
      ...
      else
      {
        ...
        {
          v17 = (__int64)*(v4 - 2);
          v18 = (unsigned __int64)*(v4 - 1) + 32 * !(v15 & 1) - 16;
          if ( v18 <= v17 + 16 )
            v19 = (void **)(v17 + 8);
          else
            v19 = (void **)(v18 - 8);
          if ( **(_DWORD **)(a1 + 16) != -1 )
            NP_CONTEXT::NpLeafDerefInternal((struct NP_CONTEXT::NP_CTX *)(a1 + 16), v19);
        }
      }
    }
    v13 = v4[1];
