/*
 * XREFs of PopTraceStandbyConnectivityUpdate @ 0x140ABB7D0
 * Callers:
...
void __fastcall PopTraceStandbyConnectivityUpdate(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v6 = 0x1000000LL;
    v19 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_140049208, 0LL, 0LL, 5u, &v11);
  }
