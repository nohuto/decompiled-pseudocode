/*
 * XREFs of PfSnLogPrefetchSectionsStart @ 0x1409C851C
 * Callers:
...
void __fastcall PfSnLogPrefetchSectionsStart(__int64 a1, int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( qword_140E66E48 )
    {
      if ( EtwEventEnabled(qword_140E66E48, &PfSnEvt_PrefetchSections_Start) )
      {
        v4 = -1LL;
        do
          ++v4;
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v18 = 4LL;
        v20 = 1LL;
        EtwWrite(qword_140E66E48, &PfSnEvt_PrefetchSections_Start, 0LL, 7u, &UserData);
      }
    }
  }
}
