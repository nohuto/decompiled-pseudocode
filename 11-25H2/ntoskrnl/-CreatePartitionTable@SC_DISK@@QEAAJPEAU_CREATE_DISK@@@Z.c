/*
 * XREFs of ?CreatePartitionTable@SC_DISK@@QEAAJPEAU_CREATE_DISK@@@Z @ 0x140692308
 * Callers:
 ...
 *     ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x140692F68 (-Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z.c)
