/*
 * XREFs of DifZwRequestWaitReplyPortWrapper @ 0x14063B460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRequestWaitReplyPortWrapper(
        HANDLE PortHandle,
        ...
        PPORT_MESSAGE ReplyMessage)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(28);
  ...
  if ( APIThunkContextById )
  {
    ...
    *(_QWORD *)&v16 = RequestMessage;
    *((_QWORD *)&v15 + 1) = ReplyMessage;
  ...
  LODWORD(v17) = ZwRequestWaitReplyPort(PortHandle, RequestMessage, ReplyMessage);
  if ( v7 )
  {
