/*
 * XREFs of MiAssignTopLevelRanges @ 0x140C435B0
 * Callers:
...
__int64 __fastcall MiAssignTopLevelRanges(unsigned int a1, __int64 a2)
{
  ...
  *(_QWORD *)&Base[8 * v31 - 8] = v14;
  ...
  do
  {
    ...
    v37 += 6;
    v39 *= 2LL;
    qword_140E38868[v39] = v38;
    qword_140E38870[v39] = *((_QWORD *)v37 - 1);
    --v33;
  }
  while ( v33 );
  qword_140E388F0 -= 0x10000000000LL;
  qword_140E38918 = qword_140E388E8;
  qword_140E38920 = 0x10000000000LL;
  qword_140E388E8 += 0x10000000000LL;
  qword_140E2F058 = qword_140E38918 + 0x8000000000LL;
