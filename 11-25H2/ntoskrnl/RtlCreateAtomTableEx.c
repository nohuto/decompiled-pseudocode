/*
 * XREFs of RtlCreateAtomTableEx @ 0x1404969B0
 * Callers:
 *     RtlCreateAtomTable @ 0x140A7CEA0 (RtlCreateAtomTable.c)
 * Callees:
 ...
 *     RtlpInitializeLockAtomTable @ 0x140A93030 (RtlpInitializeLockAtomTable.c)
 */
