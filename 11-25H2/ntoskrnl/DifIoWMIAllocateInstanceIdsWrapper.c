/*
 * XREFs of DifIoWMIAllocateInstanceIdsWrapper @ 0x14061F730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoWMIAllocateInstanceIdsWrapper(LPCGUID Guid, ULONG InstanceCount, ULONG *FirstInstanceId)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = Guid;
    LODWORD(v16) = InstanceCount;
    *((_QWORD *)&v15 + 1) = FirstInstanceId;
  ...
  LODWORD(v17) = IoWMIAllocateInstanceIds(Guid, InstanceCount, FirstInstanceId);
  if ( v7 )
  {
