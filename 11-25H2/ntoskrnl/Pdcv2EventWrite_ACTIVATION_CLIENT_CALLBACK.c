/*
 * XREFs of Pdcv2EventWrite_ACTIVATION_CLIENT_CALLBACK @ 0x1405FB770
 * Callers:
...
NTSTATUS __fastcall Pdcv2EventWrite_ACTIVATION_CLIENT_CALLBACK(__int64 a1, _DWORD *a2, unsigned int a3, int a4)
{
  ...
  {
    v13 = *(_DWORD *)(a1 + 64);
    v15 = (const WCHAR *)(a1 + 72);
    v21 = v13;
    v14 = (const WCHAR *)(a1 + 328);
    v11 = *(_DWORD *)(a1 + 584);
    result = 0;
  ...
  if ( (unsigned int)dword_140E08758 > 5 )
  {
    v30 = 4LL;
    v29 = &v19;
    ...
    return tlgWriteTransfer_EtwWriteTransfer(
             (__int64)&dword_140E08758,
             (unsigned __int8 *)&word_1400500EE,
             0LL,
             0LL,
             0xEu,
             &v28);
