/*
 * XREFs of HsaSetPasidAddressSpace @ 0x1405705C0
 * Callers:
 *     <none>
 * Callees:
 *     KeBugCheckEx @ 0x1404F9280 (KeBugCheckEx.c)
 *     HsaEnsureNoPendingFaults @ 0x14056F738 (HsaEnsureNoPendingFaults.c)
 */
...
__int64 __fastcall HsaSetPasidAddressSpace(__int64 *a1, __int64 a2, unsigned int a3, __int64 a4, char *a5)
{
  ...
  v5 = 1;
  v6 = a3 & 0x1FF;
  v7 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 48) + 48LL) + 8 * ((unsigned __int64)a3 >> 9) + 4096);
