/*
 * XREFs of MiMapContiguousMemoryLarge @ 0x14038FD94
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  *a5 = 0;
  ...
  {
    if ( (unsigned __int64)v14 + a1 <= qword_140E2D9A0 && ((*v11 >> 54) & 1) != 0 )
    {
  ...
  if ( v14 == (unsigned __int64 *)a2 )
  {
    ...
    {
      MiMapWithLargePages((unsigned int)&unk_140E37EC0, PageTablesForLargeMap, a1, a2, 1, v20, v13);
      if ( v18 )
        *a5 |= 1u;
      return v7;
    }
