/*
 * XREFs of KiEnableKvaShadowing @ 0x140B4A90C
 * Callers:
 ...
 *     HvlRescindEnlightenments @ 0x14058836C (HvlRescindEnlightenments.c)
 *     KiIsKvaShadowDisabled @ 0x1405BA0D8 (KiIsKvaShadowDisabled.c)
 *     KiInitializeDescriptorIst @ 0x1405BF7B8 (KiInitializeDescriptorIst.c)
 *     SpcIsKvaLeakageSimulated @ 0x140695770 (SpcIsKvaLeakageSimulated.c)
 *     SpcQueryKvaLeakagePresent @ 0x140695780 (SpcQueryKvaLeakagePresent.c)
    ...
    if ( (unsigned int)SpcQueryKvaLeakagePresent() || SpcIsKvaLeakageSimulated() )
    {
      ...
      *(_QWORD *)(v9 + 4100) = v9 + 16896;
      ...
      else
      {
        ...
        byte_140FCF0E0 = 1;
        _InterlockedOr(dword_140FCF57C, 0x4000u);
        KiSetAddressPolicy(1LL, v10);
        v11 = _bittest64((const signed __int64 *)(a1 + 36768), 0x2Au);
        *(_WORD *)(a1 + 44714) = 24;
        if ( v11 )
        {
          v12 = __readcr4();
