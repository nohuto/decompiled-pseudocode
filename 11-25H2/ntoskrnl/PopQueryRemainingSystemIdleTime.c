/*
 * XREFs of PopQueryRemainingSystemIdleTime @ 0x140AA8DA0
 * Callers:
  ...
  *a2 = dword_140E0B504;
  if ( dword_140E0B508 )
  {
    ...
    do
    {
      ...
      {
        v7 = v6 - *(_QWORD *)v4;
        if ( v7 <= (unsigned int)dword_140E0B508 )
        {
          v8 = *a1;
          if ( *a1 <= (unsigned int)(dword_140E0B508 - v7) )
            v8 = dword_140E0B508 - v7;
          *a1 = v8;
        }
      }
      v4 += 56;
