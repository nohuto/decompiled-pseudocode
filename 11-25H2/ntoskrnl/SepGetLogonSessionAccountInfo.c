/*
 * XREFs of SepGetLogonSessionAccountInfo @ 0x140A4671C
 * Callers:
...
__int64 __fastcall SepGetLogonSessionAccountInfo(_DWORD *a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  v14 = 0LL;
  *(_OWORD *)a2 = *(_OWORD *)(i + 7);
  *(_OWORD *)a3 = *(_OWORD *)(i + 9);
  *(_QWORD *)(a2 + 8) = 0LL;
  *(_QWORD *)(a3 + 8) = 0LL;
  if ( i[8] && (v15 = ExAllocatePool2(0x100uLL), (*(_QWORD *)(a2 + 8) = v15) == 0LL) )
  {
    v10 = -1073741670;
  }
  else if ( i[10] )
...
LABEL_20:
  ...
  memmove(*(void **)(a2 + 8), (const void *)i[8], *((unsigned __int16 *)i + 29));
  memmove(*(void **)(a3 + 8), (const void *)i[10], *((unsigned __int16 *)i + 37));
  if ( v14 )
  {
