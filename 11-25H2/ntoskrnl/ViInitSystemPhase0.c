/*
 * XREFs of ViInitSystemPhase0 @ 0x140C2A404
 * Callers:
 ...
 *     ViDisableVerification @ 0x140B73B2C (ViDisableVerification.c)
...
void __fastcall ViInitSystemPhase0(__int64 a1)
{
  ...
  dword_140E67BF8 = 32;
  KiInitializeMutant(&ViDriversLoadLock, 0, 1u, 0);
  qword_140F041D8 = (__int64)&VfSuspectDriversList;
  VfSuspectDriversList = (__int64)&VfSuspectDriversList;
  qword_140F03E28 = (__int64)&VfExcludedDriversList;
  VfExcludedDriversList = (__int64)&VfExcludedDriversList;
  qword_140F03E38 = (__int64)&VfXdvExcludedDriversList;
  VfXdvExcludedDriversList = (__int64)&VfXdvExcludedDriversList;
  if ( VfVerifyMode == -1 )
  {
    VfVerifyMode = (VfRuleClasses & 0x400000) != 0 ? 2 : 4;
    dword_140F03B04 = VfVerifyMode;
  }
  ...
  if ( !v4 && v3 )
  {
    *(_QWORD *)&VfBugcheckTmpData = *(unsigned int *)(v3 + 56);
    ...
    qword_140FFCA40 = *(_QWORD *)(v3 + 72);
    *(_OWORD *)&xmmword_140FFCA48 = *(_OWORD *)(v3 + 80);
  }
