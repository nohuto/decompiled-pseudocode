/*
 * XREFs of KeAddSystemServiceTable @ 0x140A9C5C0
 * Callers:
 *     <none>
 * Callees:
  ...
  else if ( a5 == 2 )
  {
    ...
    if ( !(_QWORD)xmmword_140FC63E0 )
    {
      ...
      *((_QWORD *)&KeServiceDescriptorTableFilter[3] + 1) = a4;
      v6 = (int *)xmmword_140FC63E0;
      v7 = (unsigned int)&xmmword_140FC63E0 + xmmword_140FC63E0 + KiTableInformation;
      if ( (_DWORD)xmmword_140FC63F0 )
      {
        do
        {
          v8 = *v6;
          v9 = *v6++;
          v7 = ++v5 * ((v8 + *(_DWORD *)((v9 >> 4) + xmmword_140FC63E0)) ^ v7);
        }
        while ( v5 < (unsigned int)xmmword_140FC63F0 );
      }
