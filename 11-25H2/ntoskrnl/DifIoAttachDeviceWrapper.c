/*
 * XREFs of DifIoAttachDeviceWrapper @ 0x140619EE0
 * Callers:
 *     <none>
 * Callees:
        ...
        PDEVICE_OBJECT *AttachedDevice)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = SourceDevice;
    *(_QWORD *)&v16 = TargetDevice;
    *((_QWORD *)&v15 + 1) = AttachedDevice;
  ...
  LODWORD(v17) = IoAttachDevice(SourceDevice, TargetDevice, AttachedDevice);
  if ( v7 )
  {
