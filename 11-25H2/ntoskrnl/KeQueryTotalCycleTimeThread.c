/*
 * XREFs of KeQueryTotalCycleTimeThread @ 0x1403E5570
 * Callers:
...
LABEL_29:
    ...
    if ( (Size & 0xBE) != 0 )
    {
      ...
      if ( KiHgsPlusEnabled )
        KiUpdateThreadHgsFeedback((__int64)CurrentPrcb, (__int64)Thread, v6, 0);
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( (int)NextProcessor >= 0 )
          {
            ...
            while ( _interlockedbittestandset64((volatile signed __int32 *)(v80 + 48), 0LL) )
            {
              do
              {
                if ( (++v100 & HvlLongSpinCountMask) == 0
        ...
        if ( (int)v84 >= 0 )
        {
          ...
          v86 = 0LL;
          v87 = 0;
          v88 = v108 & 0xFFFFFFFFFFFFFFFEuLL;
...
LABEL_155:
          ...
          if ( (v108 & 1) == 1 )
          {
            v86 = (unsigned __int64 *)(*(_QWORD *)(v88 + 36440) + 8LL);
            v87 = **(unsigned __int8 **)(v88 + 36440);
          }
          if ( v87 )
            goto LABEL_155;
LABEL_156:
      ...
      v89 = Thread->NextProcessor;
      if ( (int)v89 < 0 )
        break;
      v80 = KiProcessorBlock[v89];
      KiAcquirePrcbLocksForIsolationUnit(v80, 0, &v108);
      if ( Thread->WaitBlockFill6[68] == 1 && Thread->NextProcessor == (_DWORD)v89 )
        goto LABEL_205;
      v96 = 0LL;
      v97 = 0;
      v98 = v108 & 0xFFFFFFFFFFFFFFFEuLL;
...
LABEL_187:
      ...
      if ( (v108 & 1) == 1 )
      {
        v96 = (unsigned __int64 *)(*(_QWORD *)(v98 + 36440) + 8LL);
        v97 = **(unsigned __int8 **)(v98 + 36440);
      }
      if ( v97 )
        goto LABEL_187;
LABEL_188:
    ...
    v91 = KiProcessorBlock[v90];
    v81 = *(volatile __int64 **)(v91 + 36424);
    if ( (KiVelocityFlags & 0x200000) != 0 )
    {
      *((_QWORD *)&v109 + 1) = *(_QWORD *)(v91 + 36424);
      *(_QWORD *)&v109 = 0LL;
      v92 = (struct _KPRCB **)_InterlockedExchange64(v81, (__int64)&v109);
      if ( v92 )
        KxWaitForLockOwnerShip((struct _KPRCB *)&v109, v92);
    }
    else
    {
      v93 = 0;
...
LABEL_176:
        *(_QWORD *)&v109 = 0LL;
        v95 = BYTE8(v109);
        if ( ((v95 ^ (unsigned __int8)_InterlockedExchange64((volatile __int64 *)(v94 + 8), *((__int64 *)&v109 + 1))) & 4) != 0 )
          KeWakeAddressAll(v94 + 8, (__int64)KiProcessorBlock);
      }
      ...
      {
        v94 = KxWaitForLockChainValid((__int64 *)&v109);
        goto LABEL_176;
      }
    }
    else
