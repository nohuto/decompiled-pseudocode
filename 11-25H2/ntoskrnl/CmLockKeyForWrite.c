/*
 * XREFs of CmLockKeyForWrite @ 0x1409E3164
 * Callers:
 ...
 *     CmpPerformSiloKeyLockTrackerEnabledCheck @ 0x1406EF71C (CmpPerformSiloKeyLockTrackerEnabledCheck.c)
...
__int64 __fastcall CmLockKeyForWrite(__int64 a1)
{
  ...
  if ( ContextForSiloNoRef )
  {
    ...
    if ( _InterlockedCompareExchange64(ContextForSiloNoRef, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx(ContextForSiloNoRef, 0, v9, (unsigned __int64)ContextForSiloNoRef);
    if ( v9 )
      *((_BYTE *)v9 + 10) = 1;
