/*
 * XREFs of _PnpSetPropertyWorker @ 0x140953DFC
 * Callers:
...
__int64 __fastcall PnpSetPropertyWorker(__int64 a1, void *a2, _WORD *a3, __int64 a4, int a5, __int64 a6, ULONG a7)
{
  signed int v10; // ebx
  HANDLE v11; // rsi
  __int64 v12; // rax
  ...
  v10 = PnpOpenPropertiesKey(a1, (__int64)v27, 0LL, 4u, 1, (__int64)pszFormat, &v30);
  if ( v10 < 0 )
  {
    v30 = 0LL;
    goto LABEL_19;
  ...
  {
    inited = RegRtlCreateKeyTransacted(v30, pszDest, 0, 4u, 0LL, 0, &KeyHandle, &Disposition, *(_QWORD *)(v12 + 8));
  }
  else
  {
    v27 = 0LL;
    ...
    if ( !RegRtlIsPredefinedKey((__int64)v30) || (inited = RegRtlOpenPredefinedKey(v20, (__int64)&v27), inited >= 0) )
    {
  ...
  {
    v17 = RegRtlCreateKeyTransacted(KeyHandle, Dst, 0, 0x10006u, 0LL, 0, &Handle, &v25, *(_QWORD *)(v15 + 8));
  }
  else
  {
    v27 = 0LL;
    memset(&ObjectAttributes, 0, 44);
    DestinationString = 0LL;
    if ( !RegRtlIsPredefinedKey((__int64)KeyHandle) || (v17 = RegRtlOpenPredefinedKey(v21, (__int64)&v27), v17 >= 0) )
    {
...
LABEL_19:
    if ( Handle )
    {
      ZwClose(Handle);
      if ( v10 < 0 && v25 == 1 )
        PnpCtxRegDeleteTree(a1, (__int64)KeyHandle, (__int64)Dst);
    }
    goto LABEL_21;
  }
  if ( v17 >= 0 )
  {
    v18 = PnpCtxRegSetValue((__int64)v16, Handle, (__int64)a3, (unsigned __int16)a5 | 0xFFFF0000, v33, a7);
    if ( v18 != -1073741444 )
    {
      if ( v18 < 0 )
        v10 = v18;
...
LABEL_21:
  if ( KeyHandle )
  {
    ...
    if ( v10 < 0 && Disposition == 1 )
      PnpCtxRegDeleteTree(a1, (__int64)v30, (__int64)pszDest);
  }
  if ( v30 )
    ZwClose(v30);
  return (unsigned int)v10;
