/*
 * XREFs of RtlFindClearRunsEx @ 0x1404CC600
 * Callers:
...
LABEL_17:
    ...
    v17 = *((_BYTE *)qword_140012800 - v7) | byte_14002B070[v12] | v11;
    while ( 1 )
    {
      v18 = v5;
      if ( v17 == 0xFF )
      ...
      v20 = *v19;
      v21 = 0;
      for ( k = byte_14002B070[v20]; ((unsigned __int8)k & v17) != 0; k *= 2 )
        ++v21;
      ++v5;
      if ( v18 )
        v5 = v18;
