/*
 * XREFs of VrpLoadDifferencingHive @ 0x14094AFAC
 * Callers:
        ...
        void *a8)
{
  ...
  __int128 v22; // [rsp+E8h] [rbp-18h] BYREF
  __int128 v23; // [rsp+F8h] [rbp-8h]
  __int128 v24; // [rsp+108h] [rbp+8h]
  __int128 v25; // [rsp+118h] [rbp+18h] BYREF
  ...
  *(_QWORD *)&v27 = 0LL;
  ...
  if ( DiffHiveEntryForMountPoint >= 0 )
  {
    ...
    for ( i = 0; i < 2; ++i )
    {
      if ( (*((_DWORD *)P + 14) & 1) != 0 )
        break;
      v9 = VrpBecomeDiffHiveEntryTransitionOwner((__int64)P);
      if ( v9 )
        goto LABEL_12;
...
LABEL_28:
      VrpDecrementDiffHiveEntryHardRefCount((__int64)v11);
      goto LABEL_24;
    }
LABEL_12:
    if ( (*((_DWORD *)P + 14) & 1) != 0 )
...
LABEL_21:
      ...
      if ( v14 )
        goto LABEL_28;
LABEL_24:
      VrpUnlockDiffHiveEntry((__int64)v11);
      goto LABEL_3;
    }
    VrpUnlockDiffHiveEntry((__int64)P);
    if ( a7 )
    {
