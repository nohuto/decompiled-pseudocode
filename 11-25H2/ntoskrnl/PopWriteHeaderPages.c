/*
 * XREFs of PopWriteHeaderPages @ 0x140B4E604
 * Callers:
...
__int64 __fastcall PopWriteHeaderPages(__int64 a1, _DWORD *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 272) )
  {
    ...
    *v2 = 1;
    ...
    if ( v11 != v10 )
    {
      ...
      KeBugCheckEx(0xA0u, 3uLL, (unsigned int)a2[279], v12, 0x2216uLL);
    }
  }
  ...
  *v2 = 2;
  ...
  if ( v15 != v14 )
  {
    ...
    KeBugCheckEx(0xA0u, 3uLL, (unsigned int)a2[20], v16, 0x222CuLL);
  }
  ...
  if ( v18 != v17 )
  {
    ...
    KeBugCheckEx(0xA0u, 4uLL, (unsigned int)a2[20], v19, 0x2233uLL);
  }
  return 0LL;
}
