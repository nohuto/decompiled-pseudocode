/*
 * XREFs of MiLogOutswappedProcessCommitRelease @ 0x14065E558
 * Callers:
...
void MiLogOutswappedProcessCommitRelease()
{
  ...
  if ( *(_QWORD *)&qword_140E372D8
    ...
    && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 4LL) )
  {
    ...
    v9 = v3;
    v10 = v4;
    tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&dword_140054D5C, v4, 1u, v6, v7, 6u, &v11);
  }
}
