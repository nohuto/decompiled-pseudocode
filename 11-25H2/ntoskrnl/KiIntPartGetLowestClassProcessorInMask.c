/*
 * XREFs of KiIntPartGetLowestClassProcessorInMask @ 0x1403AE2A4
 * Callers:
...
LABEL_10:
  ...
  result = *((unsigned int *)qword_140F216A8 + (unsigned int)((v1 << 6) + v6));
  if ( (_DWORD)result == -1 )
  {
LABEL_24:
    if ( *(_QWORD *)a1 )
    {
      ...
      return *((unsigned int *)qword_140F216A8 + (unsigned int)((v1 << 6) + v3));
    }
    else
    {
      return 0xFFFFFFFFLL;
