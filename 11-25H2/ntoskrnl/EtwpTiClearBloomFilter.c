/*
 * XREFs of EtwpTiClearBloomFilter @ 0x1403BD328
 * Callers:
...
int __fastcall EtwpTiClearBloomFilter(__int64 a1, __int64 a2)
{
  ...
  v2 = HIDWORD(v8);
  *(_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)(unsigned int)v8 >> 3)) &= ~(1 << (v8 & 7));
  v3 = (_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)v2 >> 3));
  v4 = (char)*v3 & ~(1 << (v2 & 7));
  v5 = v9;
  *v3 = v4;
  v6 = (_BYTE *)(qword_140EFE8C8 + ((unsigned __int64)v5 >> 3));
