/*
 * XREFs of DifIoRegisterDeviceInterfaceWrapper @ 0x14061E240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoRegisterDeviceInterfaceWrapper(
        ...
        UNICODE_STRING *a4)
{
  ...
  DWORD2(v18) = IoRegisterDeviceInterface(a1, a2, a3, a4);
  if ( v8 )
  {
