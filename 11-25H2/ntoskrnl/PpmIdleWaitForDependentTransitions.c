/*
 * XREFs of PpmIdleWaitForDependentTransitions @ 0x1405CA858
 * Callers:
...
__int64 __fastcall PpmIdleWaitForDependentTransitions(__int64 a1)
{
  ...
  while ( !(unsigned int)KeEnumerateNextProcessor(&v13, v7) )
  {
    ...
    *(_QWORD *)&v12 = Prcb;
    ...
    while ( !(unsigned __int8)guard_dispatch_icall_no_overrides(*(_QWORD *)(v5 + 664)) )
    {
      if ( (*(_DWORD *)(v4 + 34956) & 0xFF000000) != 0x5000000 )
