/*
 * XREFs of DifZwCreateTimerWrapper @ 0x140632590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateTimerWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, TIMER_TYPE a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(117);
  ...
  DWORD2(v18) = ZwCreateTimer(a1, a2, a3, a4);
  if ( v8 )
  {
