/*
 * XREFs of CcAdjustWriteBehindThreadPoolIfNeeded @ 0x1404A10F8
 * Callers:
 ...
 *     CcGetCurrentNumaNode @ 0x14048B9BC (CcGetCurrentNumaNode.c)
...
void __fastcall CcAdjustWriteBehindThreadPoolIfNeeded(__int64 a1, char a2)
{
  ...
  if ( CcEnablePerVolumeLazyWriter || (unsigned int)CcNumberNumaNodes > 1 || (_BYTE)dword_140FC420C )
    return;
