/*
 * XREFs of PipCreateComputerId @ 0x140C0F270
 * Callers:
...
__int64 __fastcall PipCreateComputerId(void *a1, void *a2, unsigned __int16 **a3, unsigned int a4, int *a5)
{
  ...
  {
    v14 = v9 + 2;
    Pool2 = ExAllocatePool2(0x100uLL, v14, 0x6E697050uLL);
    Data = (UCHAR *)Pool2;
    if ( Pool2 )
    {
      v18 = (_WORD *)Pool2;
      ...
      *v18 = 0;
      DataSize = v14;
      Class5Guid = RtlGenerateClass5Guid((__int64)qword_140027180, Data, (unsigned int)v14 - 2, (__int64)a5);
      if ( Class5Guid >= 0 )
      {
