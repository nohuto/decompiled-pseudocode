/*
 * XREFs of _CmOpenDeviceRegKeyWorker @ 0x1408C8BA0
 * Callers:
...
LABEL_22:
    ...
    if ( (unsigned __int8)a3 != 16 )
    {
      if ( (unsigned __int8)a3 == 18 )
      {
        ...
        DeviceSoftwareKeyPath = CmGetDeviceSoftwareKeyPath((__int64)a1, (__int64)a2, a3, a4, a6, Pool2, cchDest, &v68);
        v10 = v68;
        goto LABEL_69;
      }
