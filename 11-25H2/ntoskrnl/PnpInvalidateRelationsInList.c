/*
 * XREFs of PnpInvalidateRelationsInList @ 0x1408307A0
 * Callers:
    ...
    if ( v12 < *(_DWORD *)*a1 )
    {
      ...
      if ( v17 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            if ( v14 )
              IopAddRelationToList(RelationList, (__int64)v14, 2u, 0);
            goto LABEL_5;
          }
          v18 = v14[39];
          v19 = *(_QWORD *)(v18 + 40);
          if ( a4 )
          {
            PipClearDevNodeFlags(*(_QWORD *)(v18 + 40), 0x80000LL);
            v25 = *(_DWORD *)(v19 + 396);
            if ( (v25 & 0x10) != 0 )
            {
...
LABEL_14:
  ...
  for ( j = 0; ; ++j )
  {
    v22 = (PVOID *)*RelationList;
    if ( j >= *(_DWORD *)*RelationList || !v22 )
      break;
    v23 = j;
    PnpRequestDeviceAction(v22[3 * v23 + 2], 9u, 0, 0LL, 0LL, 0LL, 0LL);
  }
