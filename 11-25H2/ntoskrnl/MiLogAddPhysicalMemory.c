/*
 * XREFs of MiLogAddPhysicalMemory @ 0x140662354
 * Callers:
 *     MiAddPhysicalMemory @ 0x1407D87AC (MiAddPhysicalMemory.c)
 *     MiValidateAddPhysicalMemoryParameters @ 0x1407DA34C (MiValidateAddPhysicalMemoryParameters.c)
 * Callees:
...
void __fastcall MiLogAddPhysicalMemory(unsigned __int16 *a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    if ( a5 )
    {
      if ( **(_DWORD **)&qword_140E372D8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 256LL) )
      {
        v16 = *a1;
        v12 = 4;
        v28 = 0;
        ...
        v30 = 8;
        v33 = 8;
        v13 = (unsigned __int8 *)&byte_140054E8B;
        v19 = 7;
        v20 = v14;
        v39 = 4;
        goto LABEL_9;
    ...
    else if ( **(_DWORD **)&qword_140E372D8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 256LL) )
    {
      v11 = *a1;
      v12 = v10 + 4;
      v28 &= v10;
      ...
      v30 = v10 + 8;
      v33 = v10 + 8;
      v13 = (unsigned __int8 *)byte_140054EEB;
      v19 = 6;
      v21 = v8;
LABEL_9:
      v31 = 0;
