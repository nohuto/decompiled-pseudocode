/*
 * XREFs of HvAnalyzeLogFiles @ 0x1409F9BC4
 * Callers:
 ...
 *     HvpCompareLogSequenceNumbers @ 0x1407D6420 (HvpCompareLogSequenceNumbers.c)
 ...
 *     HvpDetermineResultingLoggingState @ 0x1409FAB44 (HvpDetermineResultingLoggingState.c)
        ...
        __int64 a7)
{
  ...
  {
    v11 = guard_dispatch_icall_no_overrides(*(_QWORD *)&v7[6 * i + 4]);
    v12 = v11;
    if ( v11 >= 0 )
    {
      v7 = v52;
...
LABEL_11:
    ...
    {
      if ( (qword_140E09E18 & 8) != 0 && (qword_140E09E20 & 8) == qword_140E09E20 )
      {
        *(_QWORD *)&v57 = &v51;
        v51 = 0x1000000LL;
        *((_QWORD *)&v57 + 1) = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_140054879,
          0LL,
          0LL,
          3u,
          v56);
      ...
      if ( v23 > 5 && (qword_140E09E18 & 0x400000000008LL) != 0 && (v24 & 0x400000000008LL) == v24 )
      {
        *(_QWORD *)&v57 = &v51;
        v51 = 1LL;
        *(_QWORD *)&v58 = &v54;
        *((_QWORD *)&v57 + 1) = 8LL;
        v54 = 0x1000000LL;
        *((_QWORD *)&v58 + 1) = 8LL;
        tlgWriteAgg((__int64)&dword_140E09E08, (unsigned __int8 *)byte_14005482F, v9, 4u, (__int64)v56);
      }
    }
    return 3221225804LL;
  }
...
LABEL_9:
  ...
  if ( !v29 )
  {
    if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 0x400000000008LL) )
    {
      ...
      *((_QWORD *)&v57 + 1) = 8LL;
      v51 = 0x1000000LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09E08, (unsigned __int8 *)byte_1400547FD, 0LL, 0LL, 3u, v56);
    }
    return 3221225804LL;
  }
  if ( (unsigned int)dword_140E09E08 > 5 && (qword_140E09E18 & 8) != 0 && (qword_140E09E20 & 8) == qword_140E09E20 )
  {
    v65 = 0;
    v68 = 0;
    v71 = 0;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140E09E08,
      (unsigned __int8 *)&dword_140054A4C,
      0LL,
      0LL,
      7u,
      &v62);
