/*
 * XREFs of FsRtlNotifyFilterReportChange @ 0x140A02350
 * Callers:
 *     FsRtlNotifyReportChange @ 0x140701D20 (FsRtlNotifyReportChange.c)
 *     FsRtlNotifyFullReportChange @ 0x140A022F0 (FsRtlNotifyFullReportChange.c)
 * Callees:
...
LABEL_26:
              if ( !memcmp(v24[1], v21->Buffer, v25)
                && (v20 || !v17[2] || (unsigned __int8)guard_dispatch_icall_no_overrides(v17[1]))
                && (!v17[8] || !FilterContext || (unsigned __int8)guard_dispatch_icall_no_overrides(v17[1])) )
              {
                v19 = v62;
LABEL_36:
                v29 = *((_WORD *)v17 + 36);
