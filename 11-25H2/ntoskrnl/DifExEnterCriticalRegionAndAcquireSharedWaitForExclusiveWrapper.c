/*
 * XREFs of DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper @ 0x140612000
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper(PERESOURCE Resource)
{
  ...
  PVOID v12; // [rsp+30h] [rbp-18h]
  _UNKNOWN *retaddr; // [rsp+48h] [rbp+0h]

  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(404);
  ...
  v12 = ExEnterCriticalRegionAndAcquireSharedWaitForExclusive(Resource);
  if ( v3 )
  {
