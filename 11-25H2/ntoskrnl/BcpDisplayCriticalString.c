/*
 * XREFs of BcpDisplayCriticalString @ 0x14068D77C
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalString(_WORD *a1, int a2, __int64 a3, int a4)
{
  ...
  v38 = 0;
  v34 = v4;
  v6 = (char *)&unk_140E0ECC0 + v4;
  v7 = (char *)&unk_140E0ECC0 + v4;
  ...
  if ( BcpTextBoxRightEdgeOverride )
    ...
    v9 = *((_DWORD *)v7 + 4) + *((_DWORD *)v6 + 8) + *(_DWORD *)((char *)&unk_140E0ECC0 + v4 + 24);
  v10 = BcpCursor;
  v11 = *(&BcpCursor + 1);
  v12 = dword_140EEF840;
  v13 = *(_QWORD *)(qword_140E3E860 + 24);
  v31 = 0;
  *(_DWORD *)(v13 + 56) = a2;
  v14 = (int *)(v13 + 40);
  v33 = v13 + 40;
  *(_DWORD *)(qword_140E3E860 + 8) = a2;
  ...
  if ( (*a1 & 0xFFFE) != 0 )
  {
    ...
    while ( 1 )
    {
        ...
        while ( 1 )
        {
          ...
          if ( v9 < v22 + v10 )
          {
            ...
            if ( v15 )
            {
              if ( v10 < v9 )
              {
                LODWORD(v20) = BcpPrintSpaces(qword_140E3E860, v10, v9, v11, v30, (__int64)&v37);
                if ( (int)v20 < 0 )
                  goto LABEL_40;
                if ( v15 < v37 )
                  v15 = v37;
              ...
              v10 = v8;
              v25 = v15 + *(_DWORD *)((char *)&unk_140E0ECC0 + v34 + 40);
              v15 = 0;
              v11 += v25;
              break;
            }
      ...
      if ( v10 < v9 )
      {
        if ( (int)BcpPrintSpaces(qword_140E3E860, v10, v9, v11, v30, (__int64)&v37) < 0 )
          goto LABEL_40;
        if ( v15 < v37 )
          v15 = v37;
      }
      v10 = v8;
      v11 += v15 + *(_DWORD *)((char *)&unk_140E0ECC0 + v34 + 40);
      v15 = 0;
