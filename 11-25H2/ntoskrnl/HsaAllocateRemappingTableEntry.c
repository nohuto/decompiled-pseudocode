/*
 * XREFs of HsaAllocateRemappingTableEntry @ 0x14056F1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a9)
{
  ...
  if ( a3 && ((a3 - 1) & a3) == 0 )
  {
    ...
    *(_OWORD *)&Size[8] = 0LL;
    ...
    {
      v17 = HIWORD(a2);
      if ( (unsigned int)v17 >= 0x20 || a2 >> 9 >= HsaTotalDeviceApertures || a3 + (a2 & 0x1FF) > 0x200 )
      {
            ...
            *(_QWORD *)Size = 0x20000002000LL;
            ...
            if ( PhysicalMemory >= 0 )
            {
              ...
              *(_QWORD *)&Size[16] = v29;
              ...
              {
                HsaDeviceApertureRanges[v17] = v12;
...
LABEL_28:
                if ( v31[1] )
                  ExtEnvFreePhysicalMemory(v21, v31[1], *(unsigned int *)Size, 1u);
                if ( v29 )
