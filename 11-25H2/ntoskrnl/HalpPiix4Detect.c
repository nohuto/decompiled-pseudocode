/*
 * XREFs of HalpPiix4Detect @ 0x140B5AF1C
 * Callers:
 ...
 *     HalpInterruptSetMsiOverride @ 0x140540258 (HalpInterruptSetMsiOverride.c)
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    v11 = 1;
    v12 = v30;
    if ( v9 == 1 && !v5 && !v8 && !v1 && v30 == 4358 && (unsigned __int8)v32 < 0x80u )
...
LABEL_78:
    ...
    if ( KeyHandle )
      ZwClose(KeyHandle);
    LOBYTE(BusData) = KeSetEvent(&HalpPiix4Detected, 0, 0);
  }
  return BusData;
}
