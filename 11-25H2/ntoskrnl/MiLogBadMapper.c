/*
 * XREFs of MiLogBadMapper @ 0x1403BB168
 * Callers:
...
char __fastcall MiLogBadMapper(__int64 a1, int a2, EVENT_DESCRIPTOR *a3)
{
  ...
  {
    LOBYTE(v3) = *(char *)(*(_QWORD *)&qword_140E372D8 + 16LL) < 0
              && (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) & 0x80LL) == *(_QWORD *)(*(_QWORD *)&qword_140E372D8
                                                                                         + 24LL);
    if ( (_BYTE)v3 )
    {
      v26 = 0;
  ...
  v7 = *(_QWORD *)&qword_140E372D8;
  if ( **(_DWORD **)&qword_140E372D8 > 5u )
  {
    LOBYTE(v3) = (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 0x400000000080LL) != 0
              && (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) & 0x400000000080LL) == *(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL);
    if ( (_BYTE)v3 )
    {
