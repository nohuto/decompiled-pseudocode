/*
 * XREFs of _CmSetInstallerClassRegProp @ 0x140809270
 * Callers:
...
__int64 __fastcall CmSetInstallerClassRegProp(__int64 a1, int a2, __int64 a3, int a4, int a5, __int64 a6, ULONG a7)
{
  __int64 v11; // r14
  int v12; // eax
