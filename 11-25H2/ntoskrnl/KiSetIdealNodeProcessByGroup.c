/*
 * XREFs of KiSetIdealNodeProcessByGroup @ 0x140268C58
 * Callers:
 ...
 * Callees:
 *     ?KiSelectIdealProcessorForProcess@@YAGPEAU_KSCHEDULER_SUBNODE@@PEAU_GROUP_AFFINITY@@@Z @ 0x140268CF0 (-KiSelectIdealProcessorForProcess@@YAGPEAU_KSCHEDULER_SUBNODE@@PEAU_GROUP_AFFINITY@@@Z.c)
