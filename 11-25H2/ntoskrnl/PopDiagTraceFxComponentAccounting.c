/*
 * XREFs of PopDiagTraceFxComponentAccounting @ 0x140A5BC1C
 * Callers:
        ...
        char a6)
{
  ...
  RtlInitUnicodeString(&v20, &word_140AD8570);
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      if ( a6 )
      {
        if ( !PopDiagFxAccountingTelemetryDisabled )
        {
          ...
          if ( (unsigned int)dword_140E076B8 > 5 && tlgKeywordOn((__int64)&dword_140E076B8, 0x400000000000LL) )
          {
            ...
            *(_QWORD *)&DestinationString.Length = 0x1000000LL;
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)&dword_140049E9C,
              0LL,
              0LL,
              0x11u,
              &v33);
