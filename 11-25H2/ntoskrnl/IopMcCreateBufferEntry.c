/*
 * XREFs of IopMcCreateBufferEntry @ 0x14059F37C
 * Callers:
...
__int64 __fastcall IopMcCreateBufferEntry(__int64 a1, unsigned int a2, char a3, __int64 *a4)
{
  ...
  *v12 = v12;
  ...
  v15 = KeAcquireSpinLockRaiseToDpc(&qword_140F8BB08);
  v16 = (_QWORD *)qword_140F8BB18;
  v17 = (_QWORD *)(v10 + 16);
  if ( *(__int64 **)qword_140F8BB18 != &qword_140F8BB10 )
    __fastfail(3u);
  *(_QWORD *)(v10 + 24) = qword_140F8BB18;
  *v17 = &qword_140F8BB10;
  *v16 = v17;
  qword_140F8BB18 = v10 + 16;
  KeReleaseSpinLock(&qword_140F8BB08, v15);
  result = 0LL;
  *a4 = v10;
  return result;
}
