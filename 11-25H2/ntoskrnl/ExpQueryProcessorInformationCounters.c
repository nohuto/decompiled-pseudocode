/*
 * XREFs of ExpQueryProcessorInformationCounters @ 0x1409FC018
 * Callers:
...
__int64 __fastcall ExpQueryProcessorInformationCounters(__int64 a1, char a2, char a3, char a4, __int64 a5)
{
  ...
  if ( a2 )
  {
    ...
    *(_QWORD *)(a5 + 88) = v13;
    v19 = v18 - v17;
    *(_QWORD *)(a5 + 112) = v14;
    v20 = v17 + v16 * *(unsigned int *)(a1 + 34412);
  }
  else
  {
    *(_QWORD *)a5 = 0LL;
  ...
  *(_QWORD *)(a5 + 24) = v19;
  ...
  v22 = (unsigned int)KeMaximumIncrement * (unsigned __int64)*(unsigned int *)(a1 + 34376);
  v27 = 0LL;
  v28 = 0LL;
  v30 = 0LL;
  *(_QWORD *)(a5 + 16) = v22;
  *(_DWORD *)(a5 + 32) = *(_DWORD *)(a1 + 34368);
  v23 = v21 * *(unsigned int *)(a1 + 34384);
  v31 = 0LL;
  *(_QWORD *)(a5 + 48) = v23;
  *(_DWORD *)(a5 + 60) = *(_DWORD *)(a1 + 14428);
  *(_DWORD *)(a5 + 64) = *(_DWORD *)(a1 + 14508);
  *(_QWORD *)(a5 + 40) = v21 * *(unsigned int *)(a1 + 34380);
  *(_DWORD *)(a5 + 56) = *(_DWORD *)(a1 + 14532);
  *(_QWORD *)(a5 + 168) = v13 + v11 + v9;
  *(_QWORD *)(a5 + 176) = v14 + v10 + v12;
