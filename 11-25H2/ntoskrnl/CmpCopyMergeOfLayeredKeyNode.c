/*
 * XREFs of CmpCopyMergeOfLayeredKeyNode @ 0x14097497C
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  else
  {
    ...
    *((_WORD *)v20 + 1) = v22;
    ...
    Src = (void *)(v25 + 20);
    v27 = v42;
    SecurityDescriptorNode = CmpGetSecurityDescriptorNodeEx(a2, (unsigned int)v42, Src, 0, (__int64)(v20 + 44));
    CmUnlockHiveSecurity(a2);
    if ( (*(_BYTE *)(v23 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v23, &v37);
    else
