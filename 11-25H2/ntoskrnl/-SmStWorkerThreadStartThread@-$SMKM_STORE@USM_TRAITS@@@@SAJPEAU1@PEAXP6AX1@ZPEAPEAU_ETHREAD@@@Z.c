/*
 * XREFs of ?SmStWorkerThreadStartThread@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@PEAXP6AX1@ZPEAPEAU_ETHREAD@@@Z @ 0x140393F74
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStWorkerThreadStartThread(__int64 a1, __int64 a2, __int64 a3, PVOID *a4)
{
  ...
  if ( v5 )
  {
    LODWORD(Object) = SmGetIdealProcessorFromNumaNode(*(_QWORD *)(a1 + 7576), v5 - 1);
    p_Object = &Object;
  }
  else
  {
  ...
  {
    Object = 0LL;
    v11 = ObReferenceObjectByHandle(Handle, 0x1FFFFFu, 0LL, 0, &Object, 0LL);
    v12 = Handle;
    v9 = v11;
    *a4 = Object;
    ObCloseHandle(v12, 0);
