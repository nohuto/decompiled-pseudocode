/*
 * XREFs of MiRescanPageFileBitmapPortion @ 0x1403DADC8
 * Callers:
 ...
 *     RtlFindNextClearRunUlong @ 0x1403DB068 (RtlFindNextClearRunUlong.c)
 */
  ...
  if ( (_DWORD)result )
  {
    ...
    do
    {
      ...
      if ( v13 > v15 )
      {
        ...
        {
          v21 = a1 + 112;
          RtlRbRemoveNode(a1 + 112, (unsigned __int64 *)v9);
          RtlRbRemoveNode(a1 + 128, (unsigned __int64 *)(v9 + 24));
          v22 = *(_DWORD *)(a1 + 108);
          if ( v22 <= *(_DWORD *)(v9 + 52) )
            v22 = *(_DWORD *)(v9 + 52);
          *(_DWORD *)(a1 + 108) = v22;
        ...
        {
          v19 = *(_QWORD *)v9;
          if ( *(_QWORD *)(*(_QWORD *)v9 + 8LL) != v9 || (v20 = *(unsigned __int64 **)(v9 + 8), *v20 != v9) )
            __fastfail(3u);
          *v20 = v19;
          v21 = a1 + 112;
          *(_QWORD *)(v19 + 8) = v20;
...
LABEL_26:
        ...
        RtlRbInsertNodeEx((__int64 *)v21, v23, v24, v9);
        v26 = *(_QWORD *)(a1 + 128);
...
LABEL_32:
        ...
        RtlRbInsertNodeEx((__int64 *)(a1 + 128), v26, v27, v9 + 24);
        ++*(_DWORD *)(a1 + 96);
        v9 = *(_QWORD *)(a1 + 144);
        if ( v9 == a1 + 144 )
        {
