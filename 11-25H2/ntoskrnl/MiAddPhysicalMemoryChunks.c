/*
 * XREFs of MiAddPhysicalMemoryChunks @ 0x1407D8A84
 * Callers:
 *     MiActOnPartitionNodePages @ 0x14067D694 (MiActOnPartitionNodePages.c)
 *     MmAddPhysicalMemory @ 0x1407DA610 (MmAddPhysicalMemory.c)
 ...
 *     MiNodeLargeFreeZeroPages2 @ 0x140678B7C (MiNodeLargeFreeZeroPages2.c)
        ...
        int a6)
{
  ...
  while ( 1 )
  {
    ...
    v22 = qword_140E389D0 + 57216LL * (unsigned int)(ClosestImplicitNode - v21);
    v51 = v22;
    if ( v16 >= 0 )
    {
      v17 = 0;
