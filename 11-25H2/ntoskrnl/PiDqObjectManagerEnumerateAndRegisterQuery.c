/*
 * XREFs of PiDqObjectManagerEnumerateAndRegisterQuery @ 0x140839434
 * Callers:
...
__int64 __fastcall PiDqObjectManagerEnumerateAndRegisterQuery(PERESOURCE Resource, KSPIN_LOCK a2)
{
  ...
  _OWORD v35[2]; // [rsp+40h] [rbp-99h] BYREF
  __int128 v36; // [rsp+60h] [rbp-79h]
  _BYTE *v37; // [rsp+70h] [rbp-69h]
  __int128 v38; // [rsp+78h] [rbp-61h] BYREF
  __int128 v39; // [rsp+88h] [rbp-51h]
  _BYTE v40[80]; // [rsp+A0h] [rbp-39h] BYREF
    ...
    else
    {
      ...
      for ( j = 0; j < 6; ++j )
      {
        ...
        if ( *(_DWORD *)v14 == *(_DWORD *)&Resource[2].ActiveCount )
        {
          ...
          v38 = v20;
          EnumObject = ConstraintEval(v22, v21, &v38, v19, v35);
      ...
      if ( EnumObject >= 0 )
      {
        if ( DWORD2(v36) != *((_DWORD *)v16 + 5) )
          goto LABEL_10;
        if ( DWORD2(v36) == 13 )
        {
          EnumObject = PnpStringFromGuid(v37, v40);
          if ( EnumObject < 0 )
            goto LABEL_12;
          v6 = v40;
        }
        else if ( DWORD2(v36) == 18 )
        {
          v6 = v37;
        }
