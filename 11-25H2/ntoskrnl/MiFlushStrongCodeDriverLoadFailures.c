/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x140C3F6D0
 * Callers:
...
_UNKNOWN **MiFlushStrongCodeDriverLoadFailures()
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    while ( 1 )
    {
      v2 = (const CHAR **)qword_140E2D5F0;
      if ( qword_140E2D5F0 == &qword_140E2D5F0 )
        break;
      if ( *((PVOID **)qword_140E2D5F0 + 1) != &qword_140E2D5F0
        || (v3 = *(_QWORD *)qword_140E2D5F0, *(PVOID *)(*(_QWORD *)qword_140E2D5F0 + 8LL) != qword_140E2D5F0) )
      {
        __fastfail(3u);
      }
      qword_140E2D5F0 = *(PVOID *)qword_140E2D5F0;
      *(_QWORD *)(v3 + 8) = &qword_140E2D5F0;
      if ( **(_DWORD **)&qword_140E372D8 > 2u && tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000004000LL) )
      {
        ...
        v9 = 0x1000000LL;
        v24 = 8;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&word_140054E22, v4, 1u, v5, v6, 8u, &v10);
      }
