/*
 * XREFs of McTemplateK0xxxqq_EtwWriteTransfer @ 0x14057E40C
 * Callers:
 *     FsRtlDedupChangeLogWrite @ 0x140700B60 (FsRtlDedupChangeLogWrite.c)
 *     FsRtlHeatLogIo @ 0x140701670 (FsRtlHeatLogIo.c)
 * Callees:
