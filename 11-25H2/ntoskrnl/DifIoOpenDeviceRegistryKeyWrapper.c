/*
 * XREFs of DifIoOpenDeviceRegistryKeyWrapper @ 0x14061DA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoOpenDeviceRegistryKeyWrapper(struct _DEVICE_OBJECT *a1, ULONG a2, ACCESS_MASK a3, HANDLE *a4)
{
  ...
  LODWORD(v17) = IoOpenDeviceRegistryKey(a1, a2, a3, a4);
  if ( v8 )
  {
