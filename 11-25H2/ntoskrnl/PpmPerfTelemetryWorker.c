/*
 * XREFs of PpmPerfTelemetryWorker @ 0x140743C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PpmPerfTelemetryWorker(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v3 = &unk_140FC6780;
  v4 = v23;
  v5 = qword_140FC6718 - qword_140FC6720;
  qword_140FC6720 = qword_140FC6718;
  v6 = 9LL;
  v7 = v5 / 0x989680;
  v8 = qword_140FC6728 - qword_140FC6730;
  qword_140FC6730 = qword_140FC6728;
  do
  {
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_140048294,
      0LL,
      0LL,
      6u,
      &v14);
  }
  return PopOkayToQueueNextWorkItem((__int64)&unk_140F0CDE8);
}
