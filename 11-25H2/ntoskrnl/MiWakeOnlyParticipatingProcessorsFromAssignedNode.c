/*
 * XREFs of MiWakeOnlyParticipatingProcessorsFromAssignedNode @ 0x1406886A4
 * Callers:
...
PSLIST_ENTRY __fastcall MiWakeOnlyParticipatingProcessorsFromAssignedNode(__int64 a1)
{
  ...
  if ( *v2 )
  {
    ...
    {
      result = (PSLIST_ENTRY)qword_140E2D8B8;
      v12 = *(void ***)(384LL * *(unsigned int *)(a1 + 268) + qword_140E2D8B8 + 376);
    }
    v13 = 0;
    if ( *((_WORD *)v12 + 8) )
    {
