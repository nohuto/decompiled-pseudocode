/*
 * XREFs of KiOpGetPciConfigSpaceAccessInfoFromPhysicalAddress @ 0x1404B8010
 * Callers:
 *     KiOpCheckUnhandledSecurePciAccessViolation @ 0x1405C0DC0 (KiOpCheckUnhandledSecurePciAccessViolation.c)
