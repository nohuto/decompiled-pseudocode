/*
 * XREFs of ExpSvmReferenceAsid @ 0x14064DA00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExpSvmReferenceAsid(ULONG_PTR BugCheckParameter1)
{
  ...
  v4 = 0LL;
  v5 = v2;
  if ( (unsigned int)v1 >= (unsigned int)dword_140EFA064 )
  {
    BugCheckParameter4 = 0LL;
LABEL_10:
    if ( (unsigned int)v1 < (unsigned int)dword_140EFA064 )
      v4 = *((_QWORD *)qword_140EFA070 + 3 * v1);
    KeBugCheckEx(0x158u, v1, (unsigned int)dword_140EFA064, v4, BugCheckParameter4);
  }
  v6 = *((_QWORD *)qword_140EFA070 + 3 * v1);
  v7 = (char *)qword_140EFA070 + 24 * v1;
