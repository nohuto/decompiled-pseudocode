/*
 * XREFs of HalpTscAdvSynchTarget @ 0x140487468
 * Callers:
 *     HalpTscSynchronizationWorker @ 0x140547070 (HalpTscSynchronizationWorker.c)
 * Callees:
 *     HalpTscAdvSynchComputeMinimumDeltaAlternate @ 0x1404891A4 (HalpTscAdvSynchComputeMinimumDeltaAlternate.c)
 *     HalpTscAdvSynchSkewCounter @ 0x140546930 (HalpTscAdvSynchSkewCounter.c)
 */
