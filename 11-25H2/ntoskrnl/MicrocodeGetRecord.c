/*
 * XREFs of MicrocodeGetRecord @ 0x140658220
 * Callers:
 ...
 *     IntelMicrocodeMetaDataCheck @ 0x140658B70 (IntelMicrocodeMetaDataCheck.c)
...
LABEL_27:
        if ( PatchConfigFound )
        {
          ...
          *a4 = v16;
          *a5 = v20;
          HIDWORD(xmmword_140EF74B0) = v15[2];
          LOBYTE(qword_140EF74C0) = 1;
          *a6 = HIDWORD(xmmword_140EF74B0);
          return 0LL;
        }
        v19 = *(_BYTE *)(v16 + 4);
        if ( !SelfhostEnabled )
