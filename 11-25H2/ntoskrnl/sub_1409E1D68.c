/*
 * XREFs of sub_1409E1D68 @ 0x1409E1D68
 * Callers:
 *     sub_1409E1CD0 @ 0x1409E1CD0 (sub_1409E1CD0.c)
 * Callees:
...
__int64 __fastcall sub_1409E1D68(__int64 a1, unsigned int *a2)
{
  unsigned int v2; // edi
  _BYTE *v5; // rdi
  ...
  Mdl[0] = 0LL;
  UserDataPagesKernelWritable = sub_1409E1F40(v5);
...
LABEL_7:
      ...
      v33 = v18;
      v34 = v19;
      sub_140402470((__int64)&v24, v5, v22, v10 & 0xFFFFFFF, v12, v9 & 0xFFFFFFF, v21);
