/*
 * XREFs of EtwTraceWin32kFreezeChangeNotifyStart @ 0x14079A760
 * Callers:
...
void EtwTraceWin32kFreezeChangeNotifyStart()
{
  ...
  if ( (unsigned int)dword_140E09010 > 5 && tlgKeywordOn((__int64)&dword_140E09010, 4LL) )
  {
    ...
    v3 = v1;
    v10 = 2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09010, (unsigned __int8 *)word_140051082, 0LL, 0LL, v0, &v5);
  }
}
