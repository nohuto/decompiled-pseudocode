/*
 * XREFs of BgpFwLibraryEnable @ 0x14068CDB4
 * Callers:
...
__int64 __fastcall BgpFwLibraryEnable(__int64 a1)
{
  ...
  v2 = dword_140EEFD90 & 0xC00;
  if ( (dword_140EEFD90 & 2) == 0 || v2 == 3072 )
  {
    v3 = 0LL;
...
LABEL_28:
        ...
        xmmword_140EEFD30 = *(_OWORD *)(a1 + 16);
        qword_140EEFD40 = *(PVOID *)(a1 + 32);
        if ( v12 == 1 )
        {
          dword_140EEFD90 |= 8u;
    ...
    else
    {
      if ( v2 == 3072 )
      {
        if ( !(_BYTE)xmmword_140EEFD48
          || !BYTE1(xmmword_140EEFD48)
          || *(_DWORD *)(a1 + 16) != (_DWORD)xmmword_140EEFD58
          || *(_QWORD *)(a1 + 4) != *(_QWORD *)((char *)&xmmword_140EEFD48 + 4)
          || *(_DWORD *)(a1 + 12) != HIDWORD(xmmword_140EEFD48)
      ...
      *(_BYTE *)(a1 + 1) = 1;
      if ( (_BYTE)xmmword_140EEFD48 && BYTE1(xmmword_140EEFD48) )
      {
        v11 = DWORD1(xmmword_140EEFD48);
        if ( ((BYTE2(xmmword_140EEFD48) - 1) & 0xFD) == 0 )
          v11 = DWORD2(xmmword_140EEFD48);
        LOBYTE(v3) = (_DWORD)xmmword_140EEFD58 != 4;
        MiUnmapContiguousMemory(
          (unsigned __int64)BaseAddress,
          (unsigned int)(HIDWORD(xmmword_140EEFD48) * v11) * (v3 + 3),
          1);
      }
      xmmword_140EEFD48 = *(_OWORD *)a1;
      xmmword_140EEFD58 = *(_OWORD *)(a1 + 16);
