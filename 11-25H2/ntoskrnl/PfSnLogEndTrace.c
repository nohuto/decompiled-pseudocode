/*
 * XREFs of PfSnLogEndTrace @ 0x140989AD0
 * Callers:
...
void __fastcall PfSnLogEndTrace(__int64 a1)
{
  ...
  if ( a1 && qword_140E66E48 && EtwEventEnabled(qword_140E66E48, &PfSnEvt_EndTrace_Info) )
  {
    v2 = -1LL;
    do
      ++v2;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = 4LL;
    v13 = 4LL;
    EtwWrite(qword_140E66E48, &PfSnEvt_EndTrace_Info, 0LL, 5u, &UserData);
  }
}
