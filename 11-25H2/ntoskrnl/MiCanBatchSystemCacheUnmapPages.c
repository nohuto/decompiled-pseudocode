/*
 * XREFs of MiCanBatchSystemCacheUnmapPages @ 0x14023C510
 * Callers:
...
__int64 __fastcall MiCanBatchSystemCacheUnmapPages(_BYTE *a1, __int64 a2)
{
  ...
  if ( _bittest64((const signed __int64 *)(v2 + 40), 0x35u) && (*(_BYTE *)(v2 + 34) & 0x10) != 0 && byte_140E2D900 )
  {
    v15 = *(_DWORD *)(v2 + 32);
    if ( (v15 & 0x80000) != 0
      && (unsigned int)MiCanPfnOriginalPteBeLost(v2)
  ...
  if ( byte_140E3C8A6 )
  {
    v4 = *(_BYTE *)(qword_140E3CF00 + 2 * ((0xAAAAAAAAAAAAAAABuLL * ((v2 + 0x220000000000LL) >> 4)) >> 9));
    if ( v4 )
    {
      if ( v4 != 10 )
        return 2LL;
