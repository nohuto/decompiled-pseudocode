/*
 * XREFs of CmpFindPathByNameEx @ 0x14083F1D0
 * Callers:
  ...
  *a6 = 0LL;
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      {
        v22 = *(_DWORD *)(CellFlat + 28);
        v23 = v16;
        v16 = *(_QWORD *)(CellFlat + 36);
        if ( (*(_BYTE *)(v23 + 140) & 1) != 0 )
          HvpReleaseCellFlat(v23, &v27);
        else
          HvpReleaseCellPaged(v23, &v27);
        if ( v16 != CmpMasterHive && v29 && (v29 & *(_DWORD *)(v16 + 4112)) == 0 )
          return 0;
        if ( !((*(_BYTE *)(v16 + 140) & 1) != 0 ? HvpGetCellFlat(v16, v22) : HvpGetCellPaged(v16)) )
          return 0;
        v6 = a5;
      }
