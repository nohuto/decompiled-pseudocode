/*
 * XREFs of MiCreateTopLevelUltraMappings @ 0x140C4B004
 * Callers:
...
__int64 MiCreateTopLevelUltraMappings()
{
  ...
  if ( !(unsigned int)MiMakeZeroedPageTables(
                        (unsigned int)((unsigned __int64)qword_140E388C8 >> 9) & 0xFFFFFFF8,
                        (((unsigned __int64)qword_140E388C8 >> 9) & 0xFFFFFFF8)
                      + 8 * (((unsigned __int64)qword_140E388D0 >> 12) - 1),
                        6,
                        8) )
    return 0LL;
  if ( !(unsigned int)MiInitializeUltraSpace(&dword_140E35CA0, v0, v1) )
    return 0LL;
  qword_140E35CF0 = ((v0 >> 27) & 0x1FFFF8) - 0x90482600000LL;
  qword_140E35CF8 = (((v0 + v1 - 1) >> 27) & 0x1FFFF8) - 0x90482600000LL;
