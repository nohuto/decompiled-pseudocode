/*
 * XREFs of IopLiveDumpEstimateMemoryPages @ 0x1405972B0
 * Callers:
 ...
 *     HvlCalculateLivedumpSize @ 0x140586A70 (HvlCalculateLivedumpSize.c)
...
__int64 __fastcall IopLiveDumpEstimateMemoryPages(__int64 a1)
{
        ...
        *(_DWORD *)(a1 + 80) |= 0x10u;
        ...
        if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)word_14004577A,
            (const GUID *)(a1 + 968),
            (const GUID *)(a1 + 952),
            5u,
            v24);
  ...
  *(_DWORD *)(a1 + 80) &= ~1u;
  if ( (unsigned int)dword_140E06E80 > 5 && tlgKeywordOn((__int64)&dword_140E06E80, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140E06E80,
      (unsigned __int8 *)&word_1400457D6,
      (const GUID *)(a1 + 968),
      (const GUID *)(a1 + 952),
      9u,
      v24);
