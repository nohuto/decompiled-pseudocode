/*
 * XREFs of AslpFileGetCrcChecksumBoot @ 0x1407FD7D4
 * Callers:
 *     AslpFileGetChecksumAttributes @ 0x1407FD130 (AslpFileGetChecksumAttributes.c)
 * Callees:
 *     AslpMemoryRangeCheckBounds @ 0x14068B734 (AslpMemoryRangeCheckBounds.c)
 *     AslComputeCrc32 @ 0x1407F8AFC (AslComputeCrc32.c)
