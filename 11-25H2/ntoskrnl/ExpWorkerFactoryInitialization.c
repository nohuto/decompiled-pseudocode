/*
 * XREFs of ExpWorkerFactoryInitialization @ 0x140C324E4
 * Callers:
...
__int64 ExpWorkerFactoryInitialization()
{
  ...
  *(_QWORD *)&ExpWorkerFactoryThreadCreationTimer.Header.Lock = 9LL;
  ...
  v7 = 983295;
  v1 = ObCreateObjectType((const UNICODE_STRING *)&qword_140C60A10, &v4, 0LL, (__int64)&ExpWorkerFactoryObjectType);
  if ( v1 >= 0 )
  {
