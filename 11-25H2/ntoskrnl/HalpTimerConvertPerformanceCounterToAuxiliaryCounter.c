/*
 * XREFs of HalpTimerConvertPerformanceCounterToAuxiliaryCounter @ 0x140538160
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpTimerConvertAuxiliaryCounter @ 0x1404931B0 (HalpTimerConvertAuxiliaryCounter.c)
 */
