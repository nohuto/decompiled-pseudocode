/*
 * XREFs of ObpInitStackTrace @ 0x140C1B5BC
 * Callers:
...
int ObpInitStackTrace()
{
  ...
  memset_0(&ObpRegTracePoolTags, 0, 0x40uLL);
  LODWORD(Pool2) = (unsigned int)memset_0(&ObpRuntimeTracePoolTags, 0, 0x40uLL);
  v2 = -1LL;
  ...
  if ( ObpTraceProcessNameBuffer[0] )
  {
    ...
    v4 = 2 * v3;
    Pool2 = ExAllocatePool2(0x40uLL, v4 + 2LL, 0x7452624FuLL);
