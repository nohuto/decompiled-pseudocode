/*
 * XREFs of PfSnPrefetchCacheEntryUpdate @ 0x140828764
 * Callers:
...
void __fastcall PfSnPrefetchCacheEntryUpdate(__int64 a1)
{
  ...
  v7 = qword_140E66DD0 - 16;
  if ( !memcmp((const void *)(qword_140E66DD0 - 16 + 32), v1, 0x40uLL)
    || (v7 = PfSnPrefetchCacheEntryGet((__int64)&unk_140E66DB8, v1, v4, 0LL)) != 0 )
  {
