/*
 * XREFs of EtwTraceWin32kFreezeChangeNotifyStop @ 0x14079A81C
 * Callers:
...
void __fastcall EtwTraceWin32kFreezeChangeNotifyStop(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  if ( (unsigned int)dword_140E09010 > 5 && tlgKeywordOn((__int64)&dword_140E09010, 4LL) )
  {
    ...
    v17 = v5;
    v21 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09010, (unsigned __int8 *)&word_1400511BE, 0LL, 0LL, 7u, &v10);
  }
}
