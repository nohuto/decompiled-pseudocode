/*
 * XREFs of KiInitializeKernel @ 0x140B48920
 * Callers:
 *     KiSystemStartup @ 0x140B3B3A0 (KiSystemStartup.c)
 * Callees:
 *     HvlNotifyLongSpinWait @ 0x14032DED0 (HvlNotifyLongSpinWait.c)
 *     KiCheckVpBackingLongSpinWaitHypercall @ 0x14032DF00 (KiCheckVpBackingLongSpinWaitHypercall.c)
 *     KeHaltOnAddress @ 0x1404B3F5C (KeHaltOnAddress.c)
 ...
 *     KiStartPrcbThreads @ 0x1405B3710 (KiStartPrcbThreads.c)
 *     KeGetTopologyIdForProcessor @ 0x1405B6B2C (KeGetTopologyIdForProcessor.c)
 ...
 *     RtlGetXSaveFeatureFlags @ 0x1405DC9D0 (RtlGetXSaveFeatureFlags.c)
 ...
 *     KiDetectFpuLeakage @ 0x140B3B680 (KiDetectFpuLeakage.c)
 ...
 *     KiIsKernelCfgActive @ 0x140C15BA4 (KiIsKernelCfgActive.c)
        ...
        __int64 a6)
{
  ...
  else
  {
    ...
    if ( !(unsigned int)Feature_IdleSearchImprovements__private_IsEnabledNoReportingNoInline() )
      KiConfigureInitialNodes((__int64)a4);
