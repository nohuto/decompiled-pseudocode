/*
 * XREFs of EtwpUpdateSelectedGroupMasks @ 0x1404904F4
 * Callers:
...
__int64 __fastcall EtwpUpdateSelectedGroupMasks(int *a1, _DWORD *a2, _DWORD *a3)
{
  ...
  if ( (v14 & 4) == 0 && (v14 & 0x100) == 0 )
    goto LABEL_19;
  v15 = 32 * v13 + *((_QWORD *)a1 + 170) + 4284LL;
...
LABEL_19:
      ...
      do
      {
        v26 = *(_DWORD *)((char *)v19 + (_QWORD)v20 - 4284);
        v27 = *v19 & ~v26 & *(_DWORD *)((_BYTE *)v19 + (_QWORD)v21 - 4284);
        *(_DWORD *)((char *)v19 + (_QWORD)v22 - 4284) = v27;
        v28 = v26 & ~*v19;
        *(_DWORD *)((char *)v19 + (_QWORD)v23 - 4284) = v28;
        v29 = *v19++ | v28;
        *(_DWORD *)((char *)v19 + (_QWORD)v25 - 4288) = ~v27 & v29;
        --v24;
      }
      while ( v24 );
      EtwpLogGroupMask(v4, v3, 32 * v13 + *((_QWORD *)a1 + 170) + 4284LL, 32LL);
      v30 = a1[3] & 0x400;
      ...
      v32 = 32 * v13;
      v33 = v42;
      *(_OWORD *)(v32 + v31 + 4284) = v41;
      *(_OWORD *)(v32 + v31 + 4300) = v33;
  ...
  if ( (v17 & 0x100) == 0 )
    goto LABEL_19;
  v38 = 32 * v13 + *((_QWORD *)a1 + 170) + 4284LL;
  if ( v38 )
  {
    v39 = *(_DWORD *)(v38 + 4);
