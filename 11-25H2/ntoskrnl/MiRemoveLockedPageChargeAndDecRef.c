/*
 * XREFs of MiRemoveLockedPageChargeAndDecRef @ 0x140234CD0
 * Callers:
...
__int64 __fastcall MiRemoveLockedPageChargeAndDecRef(ULONG_PTR a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ULONG_PTR v4; // rbx
  __int16 v5; // di
  int v6; // edx
  ...
  *(_DWORD *)(a1 + 32) = v41;
  if ( v5 || (*(_QWORD *)(a1 + 40) & 0x20000000000000LL) == 0 )
  {
    ...
    v11 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v4 + 40) >> 43) & 0x3FFLL));
...
LABEL_34:
  ...
  if ( (*(_QWORD *)(v4 + 24) & 0x4000000000000000LL) != 0 )
  {
    ...
    v31 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
    v43 = *(_QWORD *)(v4 + 16);
    if ( (v43 & 0x400) == 0 && ((v43 & 4) != 0 || (v43 & 2) != 0) && v43 )
      MiReleasePageFileInfo(v31, v43, 1);
    MiInsertPageInFreeOrZeroedList(0xAAAAAAAAAAAAAAABuLL * ((__int64)(v4 + 0x220000000000LL) >> 4));
    return 1LL;
  }
  v16 = *(_QWORD *)(v4 + 16);
  v17 = v4 + 16;
  if ( v4 + 16 >= 0xFFFFF6FB7DBED000uLL && v17 <= 0xFFFFF6FB7DBED7F8uLL && (v16 & 1) != 0 )
  {
  ...
  *(_QWORD *)v17 = v16 & v18;
  ...
  {
    MiInsertPageInList(v4, 8u);
    return 1LL;
  }
  MiInsertPageInList(v4, 4u);
  return 1LL;
}
