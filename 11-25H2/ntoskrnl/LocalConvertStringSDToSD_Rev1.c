        ...
        _DWORD *a6)
{
  ...
  _DWORD Size[3]; // [rsp+54h] [rbp-4Dh] BYREF
...
LABEL_13:
          ...
          v36 = 0;
          AclForString = LocalGetAclForString(v12, 1, (const void **)&v42, &v37);
          if ( AclForString )
            goto LABEL_48;
          v6 = v37;
          v10 = 1;
...
LABEL_81:
          ...
          v37 = v24 + 2;
          v25 = LookupSidInTable(v24, 0LL, 0LL, (__int64)&ControlLookup, v36, 0, &v41);
          if ( v25 )
          {
            v8 = *(void **)(v25 + 16);
LABEL_69:
...
LABEL_70:
        ...
        case 'O':
          ...
          v37 = v21 + 2;
          v22 = LookupSidInTable(v21, 0LL, 0LL, (__int64)&ControlLookup, v36, 0, &v41);
          if ( v22 )
          {
            v7 = *(void **)(v22 + 16);
            v23 = 0;
...
LABEL_31:
          ...
          v36 = 0;
          AclForString = LocalGetAclForString(v16, 0, (const void **)&v43, &v37);
          if ( AclForString )
            goto LABEL_48;
          v6 = v37;
          v47 = 1;
  ...
  if ( v28 < 0 || (unsigned int)RtlMakeSelfRelativeSD(&v44, *a5, Size) != -1073741789 )
  {
    AclForString = 122;
    goto LABEL_48;
  }
  AclForString = 0;
  v34 = SddlpAlloc(Size[0]);
  *a5 = (void *)v34;
  if ( !v34 )
  {
    AclForString = 8;
  ...
  SelfRelativeSD = RtlMakeSelfRelativeSD(&v44, v34, Size);
  if ( SelfRelativeSD < 0 )
  {
LABEL_104:
