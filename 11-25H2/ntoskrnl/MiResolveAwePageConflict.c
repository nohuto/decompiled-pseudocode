/*
 * XREFs of MiResolveAwePageConflict @ 0x1406776E8
 * Callers:
...
__int64 __fastcall MiResolveAwePageConflict(__int64 a1, unsigned __int64 a2, int a3, unsigned __int8 a4)
{
  bool v5; // zf
  int v9; // edx
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 80) = v15;
    ...
    MiUnlockPage(a2, a4);
    KeWaitForGate((__int64)&v16, 18, 0);
