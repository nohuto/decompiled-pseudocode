/*
 * XREFs of CcSetParallelFlushFile @ 0x1404438A0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall CcSetParallelFlushFile(PFILE_OBJECT FileObject, BOOLEAN EnableParallelFlush)
{
  ...
  if ( KiIrqlFlags )
  {
    ...
    KiRaiseIrqlProcessIrqlFlags(FileObject);
  }
  LockHandle.OldIrql = CurrentIrql;
  if ( (BYTE6(PerfGlobalGroupMask) & 0x21) == 0 || PopHibernateInProgress )
  {
    v6 = (struct _KPRCB **)_InterlockedExchange64((volatile __int64 *)v4, (__int64)&LockHandle);
    if ( v6 )
