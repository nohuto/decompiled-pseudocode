/*
 * XREFs of XmSubOperands @ 0x140469C70
 * Callers:
 *     XmSubOp @ 0x140469C30 (XmSubOp.c)
 *     XmDecOp @ 0x140469C50 (XmDecOp.c)
 *     XmCmpxchgOp @ 0x1405726C0 (XmCmpxchgOp.c)
 *     XmNegOp @ 0x140572730 (XmNegOp.c)
 *     XmSbbOp @ 0x140572760 (XmSbbOp.c)
 * Callees:
