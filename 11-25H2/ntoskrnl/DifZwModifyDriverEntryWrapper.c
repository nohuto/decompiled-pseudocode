/*
 * XREFs of DifZwModifyDriverEntryWrapper @ 0x1406350A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwModifyDriverEntryWrapper(PEFI_DRIVER_ENTRY DriverEntry)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(90);
  ...
  LODWORD(v12) = ZwModifyDriverEntry(DriverEntry);
  if ( v3 )
  {
