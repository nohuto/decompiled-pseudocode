/*
 * XREFs of DifMmAllocateMappingAddressWrapper @ 0x140626420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmAllocateMappingAddressWrapper(SIZE_T NumberOfBytes, ULONG PoolTag)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(233);
  ...
  *((_QWORD *)&v14 + 1) = MmAllocateMappingAddress(NumberOfBytes, PoolTag);
  if ( v5 )
  {
