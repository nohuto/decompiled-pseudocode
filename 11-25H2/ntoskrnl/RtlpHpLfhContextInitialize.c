/*
 * XREFs of RtlpHpLfhContextInitialize @ 0x1405FA284
 * Callers:
        ...
        __int16 a6)
{
  ...
  *(_OWORD *)(a1 + 40) = v11;
  ...
  do
  {
    ...
    v17 = v15;
    v15 = _InterlockedCompareExchange64(&qword_140E28000, v16, v15);
  }
  while ( v17 != v15 );
  ...
  *(_BYTE *)(a1 + 64) = v18;
  if ( v18 > 1u )
    *(_QWORD *)(a1 + 56) = (char *)qword_1400358C0
  ...
  *(_WORD *)(a1 + 68) = 0;
  ...
  do
  {
    result = qword_140E28000;
    do
    {
      v22 = ((((result ^ (result >> 12)) << 25) ^ result ^ (result >> 12)) >> 27) ^ ((result ^ (result >> 12)) << 25) ^ result ^ (result >> 12);
      v23 = result;
      result = _InterlockedCompareExchange64(&qword_140E28000, v22, result);
    }
    while ( v23 != result );
