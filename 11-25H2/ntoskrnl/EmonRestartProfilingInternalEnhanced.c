/*
 * XREFs of EmonRestartProfilingInternalEnhanced @ 0x14055B7E0
 * Callers:
 *     EmonRestartProfilingEnhanced @ 0x140B3F600 (EmonRestartProfilingEnhanced.c)
 * Callees:
 *     EmonConfigureCounter @ 0x140558610 (EmonConfigureCounter.c)
 *     EmonWriteCounter @ 0x14055C124 (EmonWriteCounter.c)
 */
