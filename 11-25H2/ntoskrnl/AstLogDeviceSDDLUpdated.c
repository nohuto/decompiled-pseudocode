/*
 * XREFs of AstLogDeviceSDDLUpdated @ 0x14099D0F8
 * Callers:
...
void __fastcall AstLogDeviceSDDLUpdated(__int64 a1)
{
  ...
  if ( (unsigned __int8)AstIsRecording() )
  {
    ...
    Pool3 = 0LL;
    v5 = 1;
    if ( (unsigned int)ObQuerySecurityObject(v2, 0xFFFFFFFFLL, 0LL, 0, &v7) == -1073741789 )
    {
      v12 = 0;
      v11 = 0;
      v10 = 1LL;
      ...
      if ( Pool3 )
      {
        if ( (int)ObQuerySecurityObject(a1, 0xFFFFFFFFLL, (__int64)Pool3, v7, &v7) < 0 )
        {
          v6 = L"Query failed";
        }
        else
    ...
    if ( (unsigned int)dword_140E06EF0 > 5 )
    {
      ...
      if ( v5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_140045E8A,
          0LL,
          0LL,
          6u,
          &v13);
