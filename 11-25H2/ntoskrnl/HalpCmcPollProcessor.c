/*
 * XREFs of HalpCmcPollProcessor @ 0x14047C42C
 * Callers:
 *     HalpCmciPollProcessor @ 0x14047C788 (HalpCmciPollProcessor.c)
 *     HalpCmcWorkerRoutine @ 0x140A4B1B0 (HalpCmcWorkerRoutine.c)
 * Callees:
 *     KeQueryDpcWatchdogInformation @ 0x140401900 (KeQueryDpcWatchdogInformation.c)
 ...
 *     HalpCmcIsDpcTimeRunningLow @ 0x14053C594 (HalpCmcIsDpcTimeRunningLow.c)
