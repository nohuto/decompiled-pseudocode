/*
 * XREFs of HalpRegisterKdSupportFunctions @ 0x140C0368C
 * Callers:
...
__int64 *HalpRegisterKdSupportFunctions()
{
  ...
  result = &qword_140F8E5E8;
  qword_140F8E5F0 = (__int64)&qword_140F8E5E8;
  qword_140F8E5E8 = (__int64)&qword_140F8E5E8;
