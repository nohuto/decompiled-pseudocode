/*
 * XREFs of HvlpComputeLpComparisonMetrics @ 0x1405807F4
 * Callers:
      ...
      if ( v6 != (_DWORD)v4 )
      {
        ...
        if ( *(_BYTE *)(v15 - 3) )
        {
          ...
          if ( (unsigned __int16)(*(_DWORD *)v15 >> 4) == v12 )
            ++*(_DWORD *)(a2 + 40 * v4 + 32);
          v16 = *(unsigned __int16 *)(a2 + 40 * v4 + 10);
          if ( *(_WORD *)(v15 + 6) == (_WORD)v16 || !HvlpQueryNodeDistance )
          {
            v13 = v20;
            v12 = v19;
          }
          else
          {
            ...
            if ( v17 >= 0 )
            {
              if ( *(_DWORD *)(a2 + 40 * v4 + 20) )
                *(_DWORD *)(a2 + 40 * v4 + 20) = 0;
            }
          }
        }
        result = a1;
