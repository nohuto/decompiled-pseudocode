/*
 * XREFs of FsRtlpOplockPerfSendData @ 0x1406FFED4
 * Callers:
    ...
    if ( (*v2 & 1) != 0 )
    {
      if ( (unsigned int)dword_140E06C30 > 5 )
      {
        ...
        if ( (_BYTE)v1 )
        {
          ...
          v14 = 0x1000000LL;
          v65 = 8LL;
          LOBYTE(v1) = tlgWriteAgg((__int64)&dword_140E06C30, (unsigned __int8 *)byte_1400433E5, v5, 5u, (__int64)v59);
        }
      }
LABEL_15:
      v2 = v4;
      ...
      if ( (__int64)v1 >= *(_QWORD *)(g_OplockPerfData + 24) )
      {
          ...
          && FsRtlpOplockPerfPrepareToSendData() )
        {
          ...
          if ( (unsigned int)dword_140E06C30 > 5 && tlgKeywordOn((__int64)&dword_140E06C30, 0x200000000000LL) )
          {
            ...
            v47 = &unk_140E659F0;
            v49 = &v9;
            v51 = xmmword_140E658F0;
            v52 = 8 * (unsigned __int16)word_140E65910;
            v54 = &v10;
            v56 = *((_QWORD *)&xmmword_140E658F0 + 1);
            v57 = 8 * (unsigned __int16)word_140E65912;
            v15 = 0x1000000LL;
            v26 = 8LL;
            LODWORD(v12) = 2;
            v28 = 4LL;
            ...
            v50 = 2LL;
            v53 = 0;
            LOWORD(v10) = word_140E65912;
            v55 = 2LL;
            v58 = 0;
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140E06C30,
              (unsigned __int8 *)byte_14004322B,
              0LL,
              0LL,
              0x12u,
              &v24);
