/*
 * XREFs of EtwpLogTxREvent @ 0x14079AABC
 * Callers:
 *     EtwpTraceRegistryTransaction @ 0x140AA49E0 (EtwpTraceRegistryTransaction.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  *(&v22 + 2 * v13) = 0;
  (&v20)[v13] = &EtwpNull;
  *(&v21 + 2 * v13) = 2;
  return EtwpLogKernelEvent((struct _KTHREAD *)&v20, EtwpHostSiloState, a1, v9 + 1, a2 | 0x900, 0x601902u);
}
