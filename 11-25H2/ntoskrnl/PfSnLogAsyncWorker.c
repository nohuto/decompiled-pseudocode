/*
 * XREFs of PfSnLogAsyncWorker @ 0x1408EC59C
 * Callers:
...
void __fastcall PfSnLogAsyncWorker(__int64 a1, __int64 *a2)
{
  ...
  if ( a1 && qword_140E66E48 && EtwEventEnabled(qword_140E66E48, (PCEVENT_DESCRIPTOR)a2) )
  {
    v4 = -1LL;
    do
      ++v4;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    EtwWrite(qword_140E66E48, (PCEVENT_DESCRIPTOR)a2, 0LL, v5, &UserData);
  }
}
