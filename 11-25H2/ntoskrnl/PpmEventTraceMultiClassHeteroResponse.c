/*
 * XREFs of PpmEventTraceMultiClassHeteroResponse @ 0x140407B74
 * Callers:
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v10 )
    {
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      v38 = 1LL;
      v40 = 8LL;
      LOBYTE(v10) = EtwWriteEx(PpmEtwHandle, &PPM_ETW_MULTI_CLASS_HETERO_RESPONSE, 0LL, 0, 0LL, 0LL, 0xCu, &UserData);
    }
  }
  return (char)v10;
}
