/*
 * XREFs of PiCMCreateDevice @ 0x140AAF980
 * Callers:
...
LABEL_24:
    ...
    inited = CmOpenDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, v8, 16, 0, 131103, 0, (__int64)&v43, 0LL);
...
LABEL_33:
      ...
      v39[0] = 0;
      v9 = 1;
      inited = CmCreateDevice(*(__int64 *)&PiPnpRtlCtx, (int)v8, 131078, &Handle, v39, 0);
      if ( inited >= 0 )
      {
        if ( !v39[0] )
        {
...
LABEL_105:
    ...
    else
    {
      ...
      v39[0] = 0;
      v9 = 1;
      inited = CmCreateDevice(*(__int64 *)&PiPnpRtlCtx, (int)v8, 131103, &v43, v39, 0);
      if ( inited < 0 )
        goto LABEL_105;
      ExReleaseResourceLite(&PnpRegistryDeviceResource);
      KeLeaveCriticalRegion();
