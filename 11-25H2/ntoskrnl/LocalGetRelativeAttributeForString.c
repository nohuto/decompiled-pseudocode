/*
 * XREFs of LocalGetRelativeAttributeForString @ 0x140AAA33C
 * Callers:
 ...
 *     GetDigitFromChar @ 0x140787C04 (GetDigitFromChar.c)
 *     GetFlags @ 0x140787C84 (GetFlags.c)
 *     GetValueType @ 0x140787D94 (GetValueType.c)
 *     IsLegalAttributeChar2 @ 0x140787F3C (IsLegalAttributeChar2.c)
        ...
        char a8)
{
  ...
  *a4 = 0;
  ...
  if ( v18 != 34 || !v10 )
    return 1336;
  v19 = j + 1;
  ValueType = DecodeAttributeName(v16, 2 * v10, &Src);
  if ( !ValueType )
  {
    v20 = -1LL;
    do
      ...
      if ( a7 == 5 )
      {
        while ( 1 )
        {
          ...
          for ( n = *v26; iswspace(n); n = *v26 )
            ++v26;
          ValueType = LocalGetSidForString(v26, &Sid, &EndPointer, &v101);
          if ( ValueType )
            goto LABEL_129;
          v40 = Sid;
          if ( !Sid )
...
LABEL_184:
                ...
                while ( 1 )
                {
                  ...
                  for ( mm = *v25; iswspace(mm); mm = *v25 )
                    ++v25;
                  ValueType = LocalGetSidForString(v25, &Sid, &EndPointer, &v101);
                  if ( ValueType )
                    goto LABEL_25;
                  v79 = Sid;
                  if ( !Sid )
