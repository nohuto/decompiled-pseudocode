/*
 * XREFs of LocalConvertSDToStringSD_Rev1 @ 0x1409E8690
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  void *v43; // [rsp+58h] [rbp-39h]
  _WORD *v44; // [rsp+68h] [rbp-29h] BYREF
  _WORD *v45; // [rsp+70h] [rbp-21h] BYREF
...
LABEL_69:
      ...
      if ( (_BYTE)v50 )
      {
        StringForSid = LocalConvertAclToString(v12, v50, 0, (void **)&v46, (unsigned int *)&Size, 0LL, 0LL, 0, 1);
        if ( StringForSid )
          goto LABEL_29;
        v9 = Size;
      }
