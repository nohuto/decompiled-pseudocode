/*
 * XREFs of IopEnumerateEnvironmentVariablesTrEE @ 0x14070CBD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IopEfiStatusToNTSTATUS @ 0x14070C960 (IopEfiStatusToNTSTATUS.c)
    ...
    *a6 = 0;
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(v17 + 2 * ((unsigned __int64)*((unsigned int *)v13 + 6) >> 1) + 16) = 0;
      ...
      if ( !a4 || (unsigned __int8)guard_dispatch_icall_no_overrides(v13 + 1) )
      {
        if ( a3 == 2 )
        {
          *v8 = *(_OWORD *)(v13 + 1);
