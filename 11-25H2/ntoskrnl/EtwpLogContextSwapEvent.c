/*
 * XREFs of EtwpLogContextSwapEvent @ 0x14042A060
 * Callers:
...
char __fastcall EtwpLogContextSwapEvent(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v7 )
  {
    ...
    {
      v3 &= v3 - 1;
      CurrentPrcb = v6 + 32LL * (unsigned int)a1 + 4284;
      if ( CurrentPrcb )
      {
        LODWORD(CurrentPrcb) = *(_DWORD *)(CurrentPrcb + 4);
        if ( (CurrentPrcb & 4) != 0 )
        {
          LODWORD(CurrentPrcb) = *(unsigned __int8 *)(v6 + 2 * a1 + 4232);
          if ( (unsigned int)CurrentPrcb < *(_DWORD *)(v6 + 16) )
          {
            _mm_lfence();
            CurrentPrcb = *(_QWORD *)(v6 + 456);
            v11 = *(_QWORD *)(CurrentPrcb + 8LL * *(unsigned __int8 *)(v6 + 2 * a1 + 4232));
            if ( (v11 & 1) == 0 )
              break;
          }
        }
...
LABEL_73:
        if ( EtwpEventTracingProvRegHandle )
        {
          if ( (v32 = *(_QWORD *)(EtwpEventTracingProvRegHandle + 32), *(_DWORD *)(v32 + 96))
            ...
            || *(_BYTE *)(EtwpEventTracingProvRegHandle + 101)
