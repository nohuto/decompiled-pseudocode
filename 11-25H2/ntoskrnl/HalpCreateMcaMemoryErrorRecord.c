/*
 * XREFs of HalpCreateMcaMemoryErrorRecord @ 0x14053C828
 * Callers:
 ...
 *     HalpAddMcaToProcessorGenericSection @ 0x14053BE04 (HalpAddMcaToProcessorGenericSection.c)
 ...
 *     HalpAddErrorEntryToPacket @ 0x140551CCC (HalpAddErrorEntryToPacket.c)
...
LABEL_10:
  ...
  *(_DWORD *)(a3 + 176) = *(_DWORD *)(a2 + 20);
  if ( v10 + 192 > a4 )
    return (unsigned int)-1073741789;
  guard_dispatch_icall_no_overrides(a3 + 200);
