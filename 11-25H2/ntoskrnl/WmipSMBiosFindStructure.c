/*
 * XREFs of WmipSMBiosFindStructure @ 0x140795734
 * Callers:
 *     WmipSMBiosHideMachine @ 0x1407957BC (WmipSMBiosHideMachine.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall WmipSMBiosFindStructure(char a1, unsigned int a2, _QWORD *a3, _DWORD *a4, _BYTE *a5, int a6)
{
  ...
  v10 = &v6[(unsigned __int8)v6[1]];
  *a3 = v6;
  while ( (unsigned __int64)v10 < v7 && *v10 )
    v10 = (_WORD *)((char *)v10 + 1);
  *a4 = (_DWORD)v10 - (_DWORD)v6 + 2;
  return 0LL;
}
