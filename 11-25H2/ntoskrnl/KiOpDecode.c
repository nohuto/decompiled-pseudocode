/*
 * XREFs of KiOpDecode @ 0x14025F540
 * Callers:
  ...
  *(_BYTE *)(v7 + 97) = 0;
  ...
  do
  {
    ...
    else
    {
      ...
      {
        v17 = 6LL * (unsigned int)i;
        if ( LOBYTE(KiOpPrefixTable[v17]) == v35 )
        {
          v14 = *(_DWORD *)&KiOpPrefixTable[v17 + 2];
          v15 = *(_DWORD *)&KiOpPrefixTable[v17 + 4];
          break;
        }
      }
    }
...
LABEL_16:
    ...
    *(_BYTE *)(v7 + 56) = v16;
    if ( (a4 & 0x8000000) == 0 )
    {
      ...
      v19 = &qword_140001198;
      if ( v18 )
        v19 = (__int64 *)HalpPciMmConfigWriteHandlers;
