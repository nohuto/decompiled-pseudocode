/*
 * XREFs of MiMakeZeroedPageTablesEx @ 0x14038F57C
 * Callers:
...
__int64 __fastcall MiMakeZeroedPageTablesEx(__int64 a1, __int64 a2, int a3, int a4, unsigned int a5)
{
  ...
  char v45[8]; // [rsp+1B8h] [rbp+B8h] BYREF
...
LABEL_7:
  ...
  v24 = *((_QWORD *)qword_140E2FD48 + *((unsigned __int16 *)AnyMultiplexedVm + 87));
  v38 = v24;
  v15 = -1LL;
  v42 = a3;
  v41 = a5;
  ...
  else if ( v13 >= 0xFFFFDE0000000000uLL && v13 < 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL || a4 == 19 )
  {
    v47 = 0LL;
  }
...
LABEL_15:
  ...
  if ( v44 >= 0 )
    return 1LL;
  if ( (a3 & 0x200) == 0 )
    MiDeleteSystemPageTables((_DWORD)AnyMultiplexedVm, a4, v13, v27, 0);
  return 0LL;
}
