/*
 * XREFs of MxCreatePfnsForPtes @ 0x140C41600
 * Callers:
  ...
  if ( (*a2 & 1) != 0 )
  {
    ...
    if ( !(_DWORD)v5 || (v10 & 0x80u) != 0LL )
    {
      if ( v8 )
      {
        ...
        if ( (v14 & 0x20) != 0 )
          v6 = v14;
        if ( ((v6 >> 8) & 1) != (unsigned __int8)word_140E2EB44 )
          v6 = ((unsigned __int64)(unsigned __int8)word_140E2EB44 << 8) ^ (((unsigned __int64)(unsigned __int8)word_140E2EB44 << 8) ^ v6) & 0xFFFFFFFFFFFFFEFFuLL;
        if ( v6 != v10 )
        {
