/*
 * XREFs of DifIoAllocateErrorLogEntryWrapper @ 0x1406196F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoAllocateErrorLogEntry @ 0x1404A2CA0 (IoAllocateErrorLogEntry.c)
 *     DifGetReturnAddressForWrappers @ 0x1404C9840 (DifGetReturnAddressForWrappers.c)
 *     _guard_dispatch_icall_no_overrides @ 0x1406A8B20 (_guard_dispatch_icall_no_overrides.c)
 */

__int64 __fastcall DifIoAllocateErrorLogEntryWrapper(PVOID IoObject, UCHAR a2)
{
  ...
  *((_QWORD *)&v14 + 1) = IoAllocateErrorLogEntry(IoObject, a2);
  if ( v5 )
  {
