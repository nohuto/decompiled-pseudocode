/*
 * XREFs of PfSnEndTrace @ 0x140989508
 * Callers:
 *     PfSnEndTraceWorkerThreadRoutine @ 0x1409894F0 (PfSnEndTraceWorkerThreadRoutine.c)
 * Callees:
...
__int64 __fastcall PfSnEndTrace(char *P)
{
  ...
  if ( (unsigned int)dword_140E074B8 > 4 && (byte_140E074C8 & 1) != 0 && (qword_140E074D0 & 1) == qword_140E074D0 )
  {
    ...
    v34 = (int *)&v30;
    v35 = 8;
    tlgCreate1Sz_wchar_t((__int64)v37, (const WCHAR *)v31);
    v40 = 0;
    v43 = 0;
    v46 = 0;
    v38 = &v26;
    ...
    v42 = v23;
    v45 = 1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)&word_140047D16, 0LL, 0LL, 7u, v33);
  }
...
LABEL_12:
        __fastfail(3u);
      v13[1] = qword_140E66D60;
      *v13 = &qword_140E66D58;
      *v16 = v13;
      v18 = dword_140E66DA0 + 1;
      qword_140E66D60 = v13;
      while ( 1 )
      {
        dword_140E66DA0 = v18;
        if ( v18 <= dword_140E66A2C )
          break;
        v20 = qword_140E66D58;
        if ( qword_140E66D58 == &qword_140E66D58 )
          break;
        if ( *((PVOID **)qword_140E66D58 + 1) != &qword_140E66D58 )
          goto LABEL_12;
        v21 = *(_QWORD *)qword_140E66D58;
        if ( *(PVOID *)(*(_QWORD *)qword_140E66D58 + 8LL) != qword_140E66D58 )
          goto LABEL_12;
        qword_140E66D58 = *(PVOID *)qword_140E66D58;
        *(_QWORD *)(v21 + 8) = &qword_140E66D58;
  ...
  if ( (unsigned int)dword_140E074B8 > 4 )
  {
    ...
    if ( v2 )
    {
      ...
      v26 = HIDWORD(v32);
      v39 = v24;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)byte_140047D65, 0LL, 0LL, 5u, v33);
    }
  }
