/*
 * XREFs of EtwpReferenceLoggerSecurityDescriptor @ 0x140897194
 * Callers:
...
unsigned __int64 __fastcall EtwpReferenceLoggerSecurityDescriptor(__int64 a1)
{
  ...
  else
  {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&EtwpSecurityLock, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&EtwpSecurityLock, 0, v8, (unsigned __int64)&EtwpSecurityLock);
    if ( v8 )
      *((_BYTE *)v8 + 10) = 1;
