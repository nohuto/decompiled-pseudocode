/*
 * XREFs of PopSpoilBatteryEstimate @ 0x140A1E050
 * Callers:
 *     PopSpoilEstimatesOnPowerStateTransitionWorker @ 0x140749110 (PopSpoilEstimatesOnPowerStateTransitionWorker.c)
...
NTSTATUS __fastcall PopSpoilBatteryEstimate(int a1, unsigned __int8 a2)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    return tlgWriteTransfer_EtwWriteTransfer(
             ...
             (unsigned __int8 *)byte_14004BE7D,
             0LL,
             0LL,
             4u,
             &v9);
