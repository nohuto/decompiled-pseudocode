/*
 * XREFs of IpmiHwpParseSpmiTable @ 0x140694464
 * Callers:
...
__int64 __fastcall IpmiHwpParseSpmiTable(__int64 a1, __int64 a2)
{
  ...
  BYTE8(xmmword_140EF9890) = *(_BYTE *)(a2 + 48);
  v3 = *(_QWORD *)(a2 + 52);
  if ( BYTE8(xmmword_140EF9890) == 4 )
    v3 = *(_QWORD *)(a2 + 52) & 0xFELL;
  *(_QWORD *)&xmmword_140EF9890 = v3;
  v4 = 0;
  if ( *(_BYTE *)(a2 + 51) )
  {
    switch ( *(_BYTE *)(a2 + 51) )
