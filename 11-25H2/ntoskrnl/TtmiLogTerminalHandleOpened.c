/*
 * XREFs of TtmiLogTerminalHandleOpened @ 0x14075F32C
 * Callers:
...
void TtmiLogTerminalHandleOpened()
{
  ...
  if ( (unsigned int)dword_140FD78E8 > 5 && tlgKeywordOn((__int64)&dword_140FD78E8, 1LL) )
  {
    ...
    v5 = v2;
    v16 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD78E8, (unsigned __int8 *)&dword_14004F4A4, 0LL, 0LL, 6u, &v8);
  }
}
