/*
 * XREFs of FsRtlOplockBreakH2 @ 0x140A2FA90
 * Callers:
 *     FsRtlOplockBreakH @ 0x1406FF520 (FsRtlOplockBreakH.c)
 * Callees:
        ...
        unsigned __int16 *a8)
{
  ...
  __int64 v14; // r12
  __int64 v15; // r13
  char v16; // [rsp+D0h] [rbp+8h] BYREF
  char v17; // [rsp+D8h] [rbp+10h] BYREF
  unsigned int v18; // [rsp+E0h] [rbp+18h]
