/*
 * XREFs of HalpAllocateCommonBufferVectorInternal @ 0x140412974
 * Callers:
 *     HalAllocateCommonBufferVector @ 0x14054BF80 (HalAllocateCommonBufferVector.c)
 * Callees:
...
LABEL_57:
  ...
  *(_QWORD *)(v19 + 40) = v12;
  ...
  if ( v49 == 3 )
  {
    v17 = guard_dispatch_icall_no_overrides(v51[5], 3LL);
    if ( v17 >= 0 )
    {
      if ( a7 )
      {
