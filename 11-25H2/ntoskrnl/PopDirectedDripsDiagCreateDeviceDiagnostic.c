/*
 * XREFs of PopDirectedDripsDiagCreateDeviceDiagnostic @ 0x1407547F4
 * Callers:
...
_QWORD *__fastcall PopDirectedDripsDiagCreateDeviceDiagnostic(__int64 a1)
{
  ...
  {
    *(_QWORD *)(Pool2 + 16) = a1;
    *(_DWORD *)(Pool2 + 24) = dword_140F06280++;
    *(_DWORD *)(Pool2 + 148) = -1;
    ...
    {
      *(_QWORD *)(a1 + 776) = v3;
      v4 = (_QWORD *)qword_140F06078;
      if ( *(PVOID **)qword_140F06078 != &qword_140F06070 )
        __fastfail(3u);
      *v3 = &qword_140F06070;
      v3[1] = v4;
      *v4 = v3;
      qword_140F06078 = (__int64)v3;
    }
  }
  return v3;
}
