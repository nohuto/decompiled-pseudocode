/*
 * XREFs of DifExAcquireFastResourceSharedWrapper @ 0x14060FA90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireFastResourceSharedWrapper(_WORD *BugCheckParameter2, ULONG_PTR a2, char a3)
{
  ...
  LOBYTE(v17) = ExAcquireFastResourceShared(BugCheckParameter2, a2, a3);
  if ( v7 )
  {
