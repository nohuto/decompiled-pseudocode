/*
 * XREFs of PopQueryPowerButtonConfiguration @ 0x1404C039C
 * Callers:
  ...
  *(_DWORD *)(&v16.MaximumLength + 1) = 0;
  ...
  if ( v9 < 0 || *(_QWORD *)((char *)&KeyValueInformation + 4) != 0x400000004LL )
  {
    ...
    *a2 = 1;
    ...
    {
      HIDWORD(qword_140F071F0) = 2;
      goto LABEL_18;
    }
    HIDWORD(qword_140F071F0) = 1;
LABEL_20:
  ...
  *a2 = 1;
  if ( !HIDWORD(KeyValueInformation) )
  {
    LODWORD(qword_140F071F0) = 1;
    goto LABEL_20;
  }
  LODWORD(qword_140F071F0) = 2;
LABEL_18:
...
LABEL_22:
  ...
  if ( v10 >= 0 && *(_QWORD *)((char *)&KeyValueInformation + 4) == 0x400000004LL )
  {
    ...
    HIBYTE(word_140F071F8) = 1;
    dword_140F071FC = v4;
  }
  else
  {
    HIBYTE(word_140F071F8) = 0;
    dword_140F071FC = 0;
    ...
    if ( v10 < 0 || *(_QWORD *)((char *)&KeyValueInformation + 4) != 0x400000004LL )
    {
      byte_140F07200 = 0;
      v10 = -1073741823;
      LODWORD(qword_140F07204) = 0;
      goto LABEL_30;
    }
    v4 = WORD6(KeyValueInformation) & 0x1FF;
    byte_140F07200 = 1;
    LODWORD(qword_140F07204) = v4;
  }
  *a2 = 1;
LABEL_30:
  ...
  DbgPrintEx(
    ...
    dword_140F071FC,
    qword_140F07204);
  if ( (dword_140F071FC & 1) != 0 && !(_DWORD)qword_140F071F0 && PopPowerButtonBugcheckConfig == 2 )
    PopPowerButtonBugcheckConfig = 1;
  DbgPrintEx(
    0x92u,
    2u,
