/*
 * XREFs of PopTraceHibernatePolicyUpdate @ 0x14074C628
 * Callers:
...
void PopTraceHibernatePolicyUpdate()
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v4 = 0x1000000LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)&word_140048FF6, 0LL, 0LL, 5u, &v5);
  }
}
