/*
 * XREFs of PopDiagTraceMonitorOnWithLidClosed @ 0x140A31E58
 * Callers:
...
void PopDiagTraceMonitorOnWithLidClosed()
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v19 = 4;
    v7 = v0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)byte_140048C88, 0LL, 0LL, 8u, &v11);
  }
}
