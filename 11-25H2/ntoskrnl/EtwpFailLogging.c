/*
 * XREFs of EtwpFailLogging @ 0x1403F83E0
 * Callers:
    ...
    do
    {
      ...
      if ( a9 )
        ExReleaseRundownProtectionCacheAwareEx(
          *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v12 + 448) + 8LL * *v23),
          1u);
      v20 = ++v14;
    }
...
LABEL_21:
    ...
    if ( a9 )
    {
      v29 = ExAcquireRundownProtectionCacheAwareEx(
              *(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v12 + 448) + 8 * v25),
              1u);
      v16 = a1;
      if ( !v29 )
        goto LABEL_21;
    ...
    if ( (unsigned int)v25 >= *(_DWORD *)(v12 + 16)
      || (v28 = *(_QWORD *)(v27 + *(_QWORD *)(v12 + 456)), v33 = v28, (v28 & 1) != 0) )
    {
      if ( !a9 )
        goto LABEL_21;
    }
    ...
    ExReleaseRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v12 + 448) + v27), 1u);
LABEL_20:
    v16 = a1;
    goto LABEL_21;
  }
