/*
 * XREFs of sub_140BF7E44 @ 0x140BF7E44
 * Callers:
...
__int64 __fastcall sub_140BF7E44(__int64 a1, int a2, __int64 a3, int a4)
{
  ...
  *(_DWORD *)(a1 + 2260) = KeIstStackSize;
  if ( (_DWORD)qword_1410075E8 != 8 )
    KeBugCheckEx(__ROL4__(-402653175, 101), 4uLL, 0LL, qword_1410075E8, 8uLL);
...
LABEL_116:
                ...
                if ( v67 )
                {
                  ...
                  v71 = (unsigned __int64 *)qword_141007080;
                  *(_QWORD *)(qword_141007080 + 5144) = (unsigned __int64)PhysicalAddress.QuadPart >> 12;
                  v72 = 512;
                  v73 = 512;
                  v74 = IdtBase;
                  v75 = IdtBase;
                  ...
                  v77 = (unsigned __int64 *)(qword_141007080 + 512);
                  do
                  {
                    *v77++ = v74->Alignment;
                  ...
                  v54 = qword_141007080;
                  *(_WORD *)(qword_141007080 + 68) &= ~0x8000u;
                  *(_WORD *)(v54 + 64) = v54;
