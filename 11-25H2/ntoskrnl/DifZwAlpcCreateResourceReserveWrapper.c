/*
 * XREFs of DifZwAlpcCreateResourceReserveWrapper @ 0x1406301B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcCreateResourceReserveWrapper(void *a1, ULONG a2, SIZE_T a3, HANDLE *a4)
{
  ...
  DWORD2(v18) = ZwAlpcCreateResourceReserve(a1, a2, a3, a4);
  if ( v8 )
  {
