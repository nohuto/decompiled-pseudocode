/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x1406536BC
 * Callers:
 ...
 *     WheapGetAllPolicyBufferSize @ 0x1407B94CC (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x1407B94DC (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x1407B9520 (WheapGetPolicyValue.c)
