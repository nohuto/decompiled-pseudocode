/*
 * XREFs of inflate_fast_chunk_ @ 0x1405F583C
 * Callers:
 *     inflate @ 0x1405E7C68 (inflate.c)
 * Callees:
 *     chunkcopy_core @ 0x1405E7AC4 (chunkcopy_core.c)
 *     chunkcopy_lapped_relaxed @ 0x1405F567C (chunkcopy_lapped_relaxed.c)
 *     chunkunroll_relaxed @ 0x1405F57FC (chunkunroll_relaxed.c)
 */
