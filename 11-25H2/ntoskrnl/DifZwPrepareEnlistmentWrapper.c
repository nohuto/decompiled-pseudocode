/*
 * XREFs of DifZwPrepareEnlistmentWrapper @ 0x1406379A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(64);
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = EnlistmentHandle;
    *((_QWORD *)&v13 + 1) = TmVirtualClock;
  ...
  DWORD2(v14) = ZwPrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v5 )
  {
