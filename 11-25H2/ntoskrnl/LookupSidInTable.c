/*
 * XREFs of LookupSidInTable @ 0x140918AA0
 * Callers:
...
LABEL_32:
        v22 = 104 * v14;
        return (__int64)&unk_140E0CB60 + v22;
      }
    }
    else
    {
      v14 = v12;
      v15 = (const wchar_t *)((char *)&unk_140E0CB60 + 104 * v12);
  ...
  if ( v11 && a6 && !a3 && v27 < 0x43 )
  {
    ...
    {
      v17 = (char *)&unk_140E0CB60 + 104 * v27;
      v18 = (void *)*((_QWORD *)v17 + 2);
      if ( v18 )
      {
        v19 = RtlLengthSid(v18);
        v20 = (void *)SddlpAlloc(v19 + 1);
        *a7 = v20;
        if ( v20 )
        {
          _mm_lfence();
