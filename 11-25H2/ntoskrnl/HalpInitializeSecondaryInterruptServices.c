/*
 * XREFs of HalpInitializeSecondaryInterruptServices @ 0x140C000AC
 * Callers:
 *     HalpAddDevice @ 0x1406F2AF0 (HalpAddDevice.c)
 * Callees:
 *     HalpCheckSecondaryInterruptSupported @ 0x1406F4F10 (HalpCheckSecondaryInterruptSupported.c)
 *     HalpRecordSecondaryGsivRange @ 0x1406F4F88 (HalpRecordSecondaryGsivRange.c)
 *     HalpQueryMaximumGsiv @ 0x1406F5A38 (HalpQueryMaximumGsiv.c)
 */
...
__int64 HalpInitializeSecondaryInterruptServices()
{
  ...
  v3 = 0;
  qword_140F8F438 = (__int64)&SecondaryIcList;
  ...
  if ( HalpCheckSecondaryInterruptSupported() )
  {
    ...
    qword_140F8F498 = (__int64)&SecondarySignalList;
