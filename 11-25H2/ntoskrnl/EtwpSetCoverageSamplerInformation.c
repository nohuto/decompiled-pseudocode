/*
 * XREFs of EtwpSetCoverageSamplerInformation @ 0x1407A3C94
 * Callers:
 ...
 *     EtwpCovSampApplyBounds @ 0x1407A2A34 (EtwpCovSampApplyBounds.c)
      ...
      *((HANDLE *)v6 + 209) = Handle[0];
      if ( inserted >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          inserted = ObInsertObjectEx(v6, 0LL, 0, 0LL, (__int64)&v51);
          if ( inserted >= 0 )
          {
            v63 = v51;
            v62[6] = 0;
