/*
 * XREFs of MiUpdateCfgSystemWideBitmap @ 0x1409416C0
 * Callers:
...
__int64 __fastcall MiUpdateCfgSystemWideBitmap(__int64 *a1, unsigned __int64 a2, __int64 a3)
{
  ...
  {
    v8 = (unsigned int)dword_140E2D570;
  ...
  do
  {
    LODWORD(v12) = qword_140E2D4C0;
    if ( !v10 && *(__int16 *)(v3 + 12) < 0 )
      v12 = *((_QWORD *)&unk_140E2D458 + 8 * (unsigned __int64)(unsigned int)MiGetImageWowSubsystemIndex(v3, v8, v6));
