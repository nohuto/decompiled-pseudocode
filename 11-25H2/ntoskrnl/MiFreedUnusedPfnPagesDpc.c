/*
 * XREFs of MiFreedUnusedPfnPagesDpc @ 0x140661528
 * Callers:
...
void __fastcall MiFreedUnusedPfnPagesDpc(__int64 a1)
{
  ...
  while ( v1 != qword_140E2D9A0 + 1 )
  {
    ...
    v5 = qword_140E2D9A0 - v1 + 1;
    if ( qword_140E2D9A0 - v1 == -1LL )
      break;
LABEL_12:
  ...
  MiReleaseSpinLockExclusive(&dword_140E38A88, 0x11u);
