/*
 * XREFs of ViDifCaptureIoCallbacks @ 0x140B7A778
 * Callers:
 *     VfDifCaptureIoCallbacks @ 0x14049F4E8 (VfDifCaptureIoCallbacks.c)
 * Callees:
 *     ViDifFindIoCallbackContext @ 0x140B7A8E4 (ViDifFindIoCallbackContext.c)
 */
...
void __fastcall ViDifCaptureIoCallbacks(__int64 a1)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 48) + 64LL) )
  {
    ...
    v5 = ViDifFindIoCallbackContext(268435487LL, v2);
    if ( v5 )
    {
      if ( (*(_DWORD *)(v5 + 8) & 1) != 0 )
      {
    ...
    v9 = ViDifFindIoCallbackContext(268435486LL, v6);
    if ( v9 )
    {
      if ( (*(_DWORD *)(v9 + 8) & 1) != 0 )
      {
