/*
 * XREFs of KeInitializeInterruptEx @ 0x14047DDDC
 * Callers:
 *     HalpCreateInterrupt @ 0x140557A80 (HalpCreateInterrupt.c)
 *     KeInitializeInterrupt @ 0x1405B92D0 (KeInitializeInterrupt.c)
 *     IopConnectInterrupt @ 0x1409A29B0 (IopConnectInterrupt.c)
 * Callees:
 *     KiInitializeInterrupt @ 0x14047DF10 (KiInitializeInterrupt.c)
