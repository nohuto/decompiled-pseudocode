/*
 * XREFs of DifRtlCreateSystemVolumeInformationFolderWrapper @ 0x14062D690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlCreateSystemVolumeInformationFolderWrapper(PCUNICODE_STRING VolumeRootPath)
{
  ...
  LODWORD(v12) = RtlCreateSystemVolumeInformationFolder(VolumeRootPath);
  if ( v3 )
  {
