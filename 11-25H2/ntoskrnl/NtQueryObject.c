/*
 * XREFs of NtQueryObject @ 0x1408BFD10
 * Callers:
        ...
        PULONG ReturnLength)
{
  ...
  __int64 *v47; // rcx
  volatile signed __int64 *v48; // r10
  char *v49; // rcx
  char *v50; // rdx
  ULONG_PTR v51; // rcx
  ...
  else
  {
    if ( ObjectInformationClass == ObjectBasicInformation )
    {
      ...
      if ( _InterlockedCompareExchange64(v34, 17LL, 0LL) )
        ExfAcquirePushLockSharedEx(v34, 0, v35, (unsigned __int64)v34);
      if ( v35 )
        *((_BYTE *)v35 + 10) = 1;
      v36 = v69;
      if ( (*((_BYTE *)v69 + 26) & 2) != 0 )
      ...
      if ( v37 && (v41 = *v37, (v70 = v41) != 0LL) )
      {
        PsReferenceSiloContext(v41);
        v42 = (signed __int64 *)(v36 + 2);
        ...
        while ( 1 )
        {
          ...
          BugCheckParameter2 = (ULONG_PTR)(v43 - 32);
          v47 = KeAbPreAcquire(BugCheckParameter2, 0LL);
          v62 = v47;
          v48 = (volatile signed __int64 *)BugCheckParameter2;
          if ( _InterlockedCompareExchange64((volatile signed __int64 *)BugCheckParameter2, 17LL, 0LL) )
          {
            ExfAcquirePushLockSharedEx((signed __int64 *)BugCheckParameter2, 0, v47, BugCheckParameter2);
            v48 = (volatile signed __int64 *)BugCheckParameter2;
            v47 = v62;
          }
          if ( v47 )
            *((_BYTE *)v47 + 10) = 1;
          v49 = (v71[26] & 2) != 0 ? &v71[-ObpInfoMaskToOffset[v71[26] & 3]] : 0LL;
          if ( !v49 )
            break;
          v50 = *(char **)v49;
          if ( !*(_QWORD *)v49 )
            break;
          v44 += *((unsigned __int16 *)v49 + 4) + 2;
          v43 = *(char **)v49;
          v70 = *(PVOID *)v49;
          PsReferenceSiloContext(v50);
        ...
        LODWORD(v62) = v44;
        v52 = _InterlockedCompareExchange64(v48, 0LL, 17LL);
        v6 = (char *)ObjectInformation;
        v9 = ReturnLength;
        v36 = v69;
        if ( v52 != 17 )
    ...
    if ( v26 )
    {
      ...
      if ( v39 )
      {
        ...
        {
          *v6 = 0;
          v40 = HandleInformation.HandleAttributes;
