/*
 * XREFs of DrvDbGetDriverDatabaseMappedProperty @ 0x14092EF8C
 * Callers:
 *     DrvDbGetDriverDatabaseCompositeMappedPropertyKeys @ 0x140811C2C (DrvDbGetDriverDatabaseCompositeMappedPropertyKeys.c)
