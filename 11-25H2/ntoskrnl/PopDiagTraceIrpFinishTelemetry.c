/*
 * XREFs of PopDiagTraceIrpFinishTelemetry @ 0x140359318
 * Callers:
...
void __fastcall PopDiagTraceIrpFinishTelemetry(__int64 a1)
{
  ...
  _BYTE v26[32]; // [rsp+68h] [rbp-A0h] BYREF
  ...
  wchar_t v44[64]; // [rsp+118h] [rbp+10h] BYREF
  ...
  if ( v7 )
  {
    ...
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_140E07680, 0x400000000000LL) )
      {
        ...
        v25 = 0x1000000LL;
        v43 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(&dword_140E07680, &dword_14004B1F4, 0LL, 0LL, 11, v26);
      }
    }
  }
}
