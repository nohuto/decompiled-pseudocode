/*
 * XREFs of MiLocateSharedPageViews @ 0x14066D834
 * Callers:
...
__int64 __fastcall MiLocateSharedPageViews(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rbx
  char v6; // r15
