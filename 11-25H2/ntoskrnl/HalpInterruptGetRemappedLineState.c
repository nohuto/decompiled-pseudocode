/*
 * XREFs of HalpInterruptGetRemappedLineState @ 0x140446B40
 * Callers:
...
__int64 __fastcall HalpInterruptGetRemappedLineState(unsigned int *a1, _DWORD *a2, __int64 *a3, __int64 a4)
{
  int v5; // eax
  __int64 result; // rax
  _OWORD *v7; // rcx
  ...
  {
    result = HalpInterruptFindControllerAndLineState(*a1, a3, (__int64 *)&v8);
    if ( (int)result >= 0 )
    {
      v7 = v8;
      *(_OWORD *)a4 = *v8;
