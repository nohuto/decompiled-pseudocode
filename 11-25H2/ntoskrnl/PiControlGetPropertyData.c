/*
 * XREFs of PiControlGetPropertyData @ 0x140834060
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
      ...
      if ( (unsigned int)(DeviceNode[75] - 789) <= 1 )
      {
      ...
      if ( v14 > 8 )
      {
        ...
        else
        {
          ...
          {
            PpHotSwapGetDevnodeRemovalPolicy(DeviceNode, 0LL, Pool2);
            DeviceDependencyList = 0;
          }
          *v12 = 4;
        }
