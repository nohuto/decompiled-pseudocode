/*
 * XREFs of PopSetBatteryDischargingState @ 0x140A6B0FC
 * Callers:
  ...
  if ( byte_140F0AC80 != a2 )
  {
    ...
    if ( (unsigned int)dword_140E07680 > 5 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        v39 = &v28;
        v5 = (*a1 & 1) == 0;
        v27 = (unsigned __int8)byte_140F0AC80;
        if ( v5 )
          v4 = "DC Power";
        v38 = 4LL;
        v40 = 4LL;
        ...
        if ( HIDWORD(qword_140F0AB14) )
          v23 = ((HIDWORD(qword_140F0AB14) >> 1) + 100 * v22) / HIDWORD(qword_140F0AB14);
        else
          v23 = 0;
        v29 = v23;
        v50 = &v29;
        v51 = 4LL;
        if ( HIDWORD(qword_140F0AB14) )
          v24 = 100000 * (unsigned __int64)v22 / HIDWORD(qword_140F0AB14);
        else
          LODWORD(v24) = 0;
        v30 = v24;
        v31 = v22;
        v52 = &v30;
        v32 = HIDWORD(qword_140F0AB14);
        v54 = (int *)&v31;
        v53 = 4LL;
        v56 = &v32;
        v33 = a1[2];
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_14004BC93,
                       0LL,
                       0LL,
                       0x14u,
                       &v36);
