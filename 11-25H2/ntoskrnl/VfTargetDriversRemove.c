/*
 * XREFs of VfTargetDriversRemove @ 0x1403EB31C
 * Callers:
  ...
  if ( !VfSafeMode )
  {
    ...
    if ( ViTargetInitialized )
    {
      ...
      if ( v5 )
      {
        ...
        Buffer = v3;
        v15 = 1LL;
        if ( dword_140F04178 == 1 )
          v12 = 0LL;
        else
          v12 = (v3 >> 12) % (unsigned int)dword_140F04178;
        ViAvlRaiseIrqlSafe(&v16);
        v13 = 192 * v12;
        ViAvlAcquireTableLockAtDpcLevelSafe(v13 + qword_140F04170, &v16);
        RtlDeleteElementGenericTableAvl((PRTL_AVL_TABLE)(v13 + qword_140F04170), &Buffer);
        _InterlockedDecrement64(&qword_140F04168);
        v4 = *(_QWORD *)(v13 + qword_140F04170 + 112);
        *(_QWORD *)(v13 + qword_140F04170 + 112) = 0LL;
        ViAvlReleaseTableLockFromDpcLevel(v13 + qword_140F04170, &v16);
      }
