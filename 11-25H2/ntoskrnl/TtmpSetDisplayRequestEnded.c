/*
 * XREFs of TtmpSetDisplayRequestEnded @ 0x14075B504
 * Callers:
 ...
 *     TtmiGetTerminalById @ 0x14075FDE4 (TtmiGetTerminalById.c)
...
void __fastcall TtmpSetDisplayRequestEnded(__int64 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    *v4 = v6;
    ...
    if ( TerminalById < 0 )
    {
      TtmiLogError("TtmpSetDisplayRequestEnded", 737LL, (unsigned int)TerminalById, 0xFFFFFFFFLL);
      goto LABEL_13;
    }
    v9 = v13;
...
LABEL_13:
    ...
    {
      TtmiLogError("TtmpSetDisplayRequestEnded", 719LL, 3221225485LL, 0xFFFFFFFFLL);
    }
  }
  if ( v3 )
