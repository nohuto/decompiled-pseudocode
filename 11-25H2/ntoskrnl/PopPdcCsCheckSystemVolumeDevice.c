/*
 * XREFs of PopPdcCsCheckSystemVolumeDevice @ 0x140C217E0
 * Callers:
 ...
 *     PopNetIsDisconnectStandbyActive @ 0x140A95020 (PopNetIsDisconnectStandbyActive.c)
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  if ( PopPlatformAoAcCapabilityInitialized && PopPlatformAoAc )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    byte_140F0B8D7 = (unsigned int)(v0 - 3) > 1;
