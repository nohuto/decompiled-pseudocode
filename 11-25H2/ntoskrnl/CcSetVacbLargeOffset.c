/*
 * XREFs of CcSetVacbLargeOffset @ 0x1403B4820
 * Callers:
    ...
    *((_QWORD *)v42 + v15) = v7;
    ...
    if ( !VacbLevel )
    {
      ...
      if ( !a4 )
      {
        ...
        *(_QWORD *)&v38 = &v38;
        LOBYTE(v14) = v28 != 0;
        if ( !(unsigned __int8)CcAllocateVacbLevels(v13, v14, &v38) )
          return 0;
        a4 = &v38;
        v37 = &v38;
      }
      ...
      if ( v35 )
      {
        BcbListHeadLargeOffset = CcGetBcbListHeadLargeOffset(a1, v40, 0LL, v30);
      ...
      v7[v41] = VacbLevel;
      v31 = (_DWORD *)VacbLevelReference(a1, v7, v36);
      a4 = v37;
      ++*v31;
    }
    v17 = 1LL << v12;
