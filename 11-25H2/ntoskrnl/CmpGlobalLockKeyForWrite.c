/*
 * XREFs of CmpGlobalLockKeyForWrite @ 0x140A63F1C
 * Callers:
...
__int64 __fastcall CmpGlobalLockKeyForWrite(ULONG_PTR a1, __int64 *a2)
{
  ...
  v4 = (__int64 *)qword_140EF5188;
  v5 = 0;
  GlobalKeyLockEntry = 0LL;
  while ( v4 != &qword_140EF5188 )
  {
    if ( v4[3] == a1 )
    {
  ...
  else
  {
    ...
    *(_WORD *)(a1 + 8) |= 0x80u;
    ...
    v8 = (__int64 *)qword_140EF5190;
    if ( *(__int64 **)qword_140EF5190 != &qword_140EF5188 )
      __fastfail(3u);
    *(_QWORD *)GlobalKeyLockEntry = &qword_140EF5188;
    *(_QWORD *)(GlobalKeyLockEntry + 8) = v8;
    *v8 = GlobalKeyLockEntry;
    qword_140EF5190 = GlobalKeyLockEntry;
  }
