/*
 * XREFs of RtlpHpVsChunkSplit @ 0x1402E3A80
 * Callers:
  ...
  *(_DWORD *)(a4 + 8) = v106;
  ...
  if ( v28 )
  {
    *(_DWORD *)(a4 + 8) = v106 | 0x200;
    ...
    v102 = v89;
    v104 = 0LL;
    v91 = (unsigned int)(((_DWORD)v90 + 1) << 12);
    v116 = ((_DWORD)v90 + 1) << 12;
    ...
    if ( (*v110 & 1) == 0 )
    {
      RtlpHpReleaseQueuedLockExclusive(*(unsigned __int8 *)(a1 + 3), &v104);
      v97 = *v95;
    }
    v24 = v112;
    v115 = v101;
  ...
  for ( i = 0; ; i = v35 )
  {
    ...
    *(_BYTE *)(v30 + 6) = BYTE6(RtlpHpHeapGlobals) ^ BYTE6(v30);
    if ( (_DWORD)v33 )
    {
      ...
      {
        RtlRbRemoveNode(a2 + 16, (unsigned __int64 *)(v36 + 8));
        v38 = *(__int16 *)(a1 + 6);
    ...
    if ( v43 < v32 + 16 * (unsigned __int64)v42 )
    {
      ...
      {
        RtlRbRemoveNode(a2 + 16, (unsigned __int64 *)(v43 + 8));
        v44 = *(__int16 *)(a1 + 6);
    ...
    if ( (*(_BYTE *)(a1 + 4) & 1) != 0 )
    {
      ...
      if ( v48 < v32 + 16 * (unsigned __int64)v42 )
      {
        ...
        {
          RtlRbRemoveNode(a2 + 16, (unsigned __int64 *)(v48 + 8));
...
LABEL_61:
    ...
    v70 = 0;
LABEL_62:
    RtlRbInsertNodeEx((__int64 *)(a2 + 16), v68, v70, v54 + 8);
  }
  else
  {
LABEL_63:
...
LABEL_69:
    ...
    while ( 1 )
    {
      if ( ((unsigned int)RtlpHpHeapGlobals ^ *(_DWORD *)v30 ^ (unsigned int)v30) < ((unsigned int)RtlpHpHeapGlobals ^ *(_DWORD *)(v81 - 8) ^ ((_DWORD)v81 - 8)) )
      {
        v83 = *(_QWORD *)v81;
        if ( (*(_QWORD *)(v65 + 24) & 1) != 0 )
        {
...
LABEL_127:
  v82 = 0;
LABEL_74:
  RtlRbInsertNodeEx((__int64 *)(v65 + 16), v81, v82, v30 + 8);
  return v115;
}
