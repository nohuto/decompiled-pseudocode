/*
 * XREFs of ?KiAdvanceReadyQueueEnumeratorToNextList@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z @ 0x140352F90
 * Callers:
 ...
 * Callees:
 *     ?KiAdvanceReadyQueueEnumeratorToNextPhase@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z @ 0x1403530B0 (-KiAdvanceReadyQueueEnumeratorToNextPhase@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z.c)
 *     ?KiAdvanceReadyQueueEnumeratorToNextProcessor@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z @ 0x1403534FC (-KiAdvanceReadyQueueEnumeratorToNextProcessor@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z.c)
...
__int64 __fastcall KiAdvanceReadyQueueEnumeratorToNextList(struct _KI_READY_QUEUE_ENUMERATOR *a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( !v4 )
    {
      ...
      *((_BYTE *)a1 + 8) = v15;
      v12 = *((_QWORD *)a1 + 2) + 16 * ((unsigned __int8)v15 + 9LL);
      goto LABEL_14;
    }
    if ( v4 != 1 )
      return 2147483674LL;
