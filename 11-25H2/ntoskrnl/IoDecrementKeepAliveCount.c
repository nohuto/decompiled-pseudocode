/*
 * XREFs of IoDecrementKeepAliveCount @ 0x14047CFB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
    ...
    if ( v5 >= 0 && !v3 )
    {
      v11 = KeAcquireSpinLockRaiseToDpc(&qword_140F8C190);
      ...
      *(_QWORD *)(v4 + 48) = v12 + v13;
      if ( v14 )
      {
        v16 = (__int64 *)qword_140F8C188;
        if ( *(PVOID **)qword_140F8C188 != &qword_140F8C180 )
          __fastfail(3u);
        *(_QWORD *)v4 = &qword_140F8C180;
        *(_QWORD *)(v4 + 8) = v16;
        *v16 = v4;
        qword_140F8C188 = v4;
        *(_BYTE *)(v4 + 16) = 1;
      ...
      else if ( qword_140F8C1C0 )
      {
        KeAlertThread(qword_140F8C1C0, 0LL);
      }
      KeReleaseSpinLock(&qword_140F8C190, v11);
    }
  }
  else
  {
