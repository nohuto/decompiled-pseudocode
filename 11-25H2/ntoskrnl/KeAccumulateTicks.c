/*
 * XREFs of KeAccumulateTicks @ 0x140273800
 * Callers:
 ...
 *     KiDeferDpcWatchdogViolation @ 0x14044A274 (KiDeferDpcWatchdogViolation.c)
 *     KiResetGlobalDpcWatchdogProfiler @ 0x1404F7118 (KiResetGlobalDpcWatchdogProfiler.c)
  ...
  *(_DWORD *)(a1 + 14528) = a3;
  ...
  if ( *(_BYTE *)(a1 + 33) )
  {
    if ( !--KiClockPollCycle )
    {
      ...
      v42 = (unsigned int)(unsigned __int8)KiClockCheckSlot + 1;
      if ( (unsigned int)v42 < (unsigned int)KeNumberProcessors_0 )
        v39 = (unsigned __int8)(KiClockCheckSlot + 1);
      KiClockCheckSlot = v39;
      if ( KiCheckKeepAlive(v41, v39, v42) )
      {
              ...
              KeInsertQueueDpc(
                ...
                *(PVOID *)(a1 + 8),
                (PVOID)(0x7E35C6C7F3DD7277LL
                      * (KiWaitNever ^ __ROR8__(*v45 ^ _byteswap_uint64(KiWaitAlways ^ v44), KiWaitNever))));
              v29 = (unsigned int *)(a1 + 34396);
            }
          }
        }
...
LABEL_79:
    ...
    if ( KeEnableWatchdogTimeout )
    {
      ...
      {
        if ( !v49 || KiRecoveryCallbackCount <= 0 )
