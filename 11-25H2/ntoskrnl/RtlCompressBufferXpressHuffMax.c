/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x140499C20
 * Callers:
...
LABEL_14:
    ...
    do
    {
      v56 = (unsigned __int16)word_1400134B0[v23[2]] ^ (unsigned __int16)XpressHashFunction[*v23] ^ (unsigned __int64)(unsigned __int16)word_1400132B0[v23[1]];
      v57 = *(_QWORD *)&a6[8 * v56];
      *(_QWORD *)&a6[8 * v56] = v23++;
