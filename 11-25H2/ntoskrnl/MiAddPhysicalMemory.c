/*
 * XREFs of MiAddPhysicalMemory @ 0x1407D87AC
 * Callers:
...
LABEL_36:
    ...
    if ( (v24 & 0x80000) == 0 )
    {
      if ( qword_140E2D908 == qword_140E3D210 )
      {
LABEL_20:
        v14 = -1073741637;
        goto LABEL_8;
      }
      if ( v23 > qword_140E2D908 - qword_140E3D210 )
      {
        if ( (v24 & 0x200000) != 0 )
        {
          v14 = -1073741585;
        ...
        v18 = (qword_140E2D908 - qword_140E3D210) & v17;
        v23 = v18;
        if ( !v18 )
          goto LABEL_20;
        v22 = v16 + v18;
