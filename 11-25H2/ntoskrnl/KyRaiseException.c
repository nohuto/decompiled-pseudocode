...
int __fastcall KyRaiseException(__int64 a1, CONTEXT_CHUNK *a2, __int64 a3, __int64 a4)
{
...
LABEL_11:
          ...
          if ( PreviousMode )
          {
            ...
            {
              ContextEx = 0LL;
              if ( (int)KeVerifyContextXStateCetU((__int64)CurrentThread, p_XState, (unsigned __int64 *)&ContextEx) < 0
                || (v31 = 0LL,
                    v32 = 0LL,
                    (int)KeVerifyContextRecord(
