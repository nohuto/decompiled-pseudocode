/*
 * XREFs of PnpSetPlugPlayEvent @ 0x14083327C
 * Callers:
...
void __fastcall PnpSetPlugPlayEvent(__int128 *a1, _QWORD *a2)
{
  ...
  if ( !PnpShutdownEvent.Header.SignalState )
  {
    ...
    if ( v4 )
    {
      ...
      {
        v8 = *a1;
        *(_DWORD *)(DeviceEventEntry + 156) = v5;
        v9 = (void *)(DeviceEventEntry + 168);
        *(_OWORD *)(DeviceEventEntry + 120) = v8;
        ...
        *(_WORD *)(v7 + 2 * ((unsigned __int64)*(unsigned __int16 *)(v4 + 40) >> 1) + 168) = 0;
