/*
 * XREFs of KiDoubleFaultAbort @ 0x1406AD2C0
 * Callers:
 *     KiDoubleFaultAbortShadow @ 0x140BAA540 (KiDoubleFaultAbortShadow.c)
 * Callees:
...
void __fastcall __noreturn KiDoubleFaultAbort(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v39 & 1) != 0 )
  {
    ...
    v17 = *(_QWORD *)&CurrentThread->Process[4].ProcessLock;
    __writegsqword(0x850u, v17);
    LOWORD(v17) = KeGetPcr()->Prcb.BpbRetpolineExitSpecCtrl;
    __writegsword(0x864u, v17);
    LOBYTE(v17) = KeGetPcr()->Prcb.PrcbPad12a[1];
    __writegsbyte(0x85Au, v17);
