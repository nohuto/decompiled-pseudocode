/*
 * XREFs of MiValidateSectionCreate @ 0x140945124
 * Callers:
 ...
 *     MiRevertRelocations @ 0x140945E00 (MiRevertRelocations.c)
        ...
        char a7)
{
  ...
  unsigned __int64 v97[2]; // [rsp+1B0h] [rbp-98h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      v71 = CurrentThread;
      v14 = PsSetSystemPagePriorityThread((__int64)CurrentThread, 1);
      v63 = v14;
      if ( (*v85 & 0x8000000) != 0 )
      {
        PerSessionProtos = MiCreatePerSessionProtos((_QWORD *)a2, 0xFFFFFFFF);
        if ( PerSessionProtos < 0 )
        {
          PsRevertToUserPagePriorityThread((__int64)CurrentThread, v14);
    ...
    v15 = MiMapImageInSystemSpace((__int64 *)a2, v9, (__int64)v97);
    if ( v15 < 0 )
    {
      if ( v13 )
...
LABEL_18:
    ...
    if ( v22 && *(_QWORD *)(v22 + 40) != *(_QWORD *)(v22 + 48) )
    {
      if ( v53 != 2 )
      {
        v19 = (*(_DWORD *)(*(_QWORD *)(v16 + 56) + 64LL) >> 12)
      ...
      if ( Pool )
      {
        ...
        MiRevertRelocations(v26, a2, v19);
      }
      else
      {
        v15 = -1073741670;
    ...
    if ( qword_140F044C0 )
    {
      v50 = (unsigned __int64)&v75 & -(__int64)(dword_140E677C0 != 0);
      LOBYTE(v49) = a7;
      LOBYTE(v48) = a6;
      v29 = v67;
      v47 = v67;
      ...
      v30 = guard_dispatch_icall_no_overrides(BugCheckParameter2);
      v15 = v30;
      v31 = v75;
      if ( v75 )
      {
...
LABEL_23:
  ...
  if ( v18 <= 1 )
  {
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        v37 = _InterlockedCompareExchange64(v35, v33, v17);
        v36 = v17 == v37;
        v17 = v37;
        if ( v36 )
          goto LABEL_62;
    ...
    if ( qword_140F04580 )
    {
      v15 = guard_dispatch_icall_no_overrides(v37 & 0xFFFFFFFFFFFFFFF8uLL);
      v43 = v52;
    }
    else
    {
...
LABEL_62:
  ...
  v34 = v74;
  if ( v18 <= 3 )
    v52 = v52 & 0xFFFFFFFFFFFFFFFCuLL | v17 & 3;
LABEL_63:
  if ( (v52 & 3) == 0 )
  {
LABEL_64:
  ...
  else
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      _InterlockedCompareExchange64(v96, v40, v17);
      goto LABEL_64;
    }
    dword_140E2D4B8 = 119;
  }
