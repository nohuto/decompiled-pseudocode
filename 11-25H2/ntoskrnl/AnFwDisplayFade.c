/*
 * XREFs of AnFwDisplayFade @ 0x140BA36EC
 * Callers:
 ...
 *     GxpBitsToBytes @ 0x1404BD330 (GxpBitsToBytes.c)
...
__int64 AnFwDisplayFade()
{
  ...
  if ( (dword_140EEFD90 & 0x2000) != 0 )
    return (unsigned int)SubRectangle;
  if ( (dword_140EEFD90 & 0x200000) == 0 )
  {
    RegionContext = BgpTxtGetRegionContext(qword_140EEFE50);
    v7 = BgpTxtGetRegionContext(qword_140EEFE58);
    v8 = v7;
    if ( !RegionContext || !v7 )
    {
LABEL_57:
    ...
    xmmword_140E0EC30 = *(_OWORD *)RegionContext;
    xmmword_140E0EC40 = *(_OWORD *)(RegionContext + 16);
    dword_140E0EC50 = *(_DWORD *)(RegionContext + 32);
    xmmword_140E0EC70 = *(_OWORD *)v7;
    xmmword_140E0EC80 = *(_OWORD *)(v7 + 16);
    dword_140E0EC90 = *(_DWORD *)(v7 + 32);
    ...
    qword_140E64DC8 = qword_140EEF888;
    if ( !qword_140EEFDD8 )
    {
      v42 = 1;
LABEL_61:
...
LABEL_13:
      ...
      v21 = qword_140EEFDEC;
      v22 = HIDWORD(qword_140EEFF10);
      v43 = (int *)qword_140EEFDEC;
      if ( !v42 )
      {
        SubRectangle = BgpGxFindSubRectangle(
                         (_DWORD)v1,
                         HIDWORD(qword_140EEFF10),
                         (unsigned int)&v49,
                         (unsigned int)&v46,
                         (__int64)&v39);
        if ( SubRectangle >= 0 )
      ...
      if ( !v40 )
      {
        ...
        if ( SubRectangle >= 0 )
        {
          ...
          *((_QWORD *)v57 + v44) = v47;
          ...
          {
            v47 = v49;
            LODWORD(xmmword_140E0EC30) = v46 + xmmword_140E0EC30;
            DWORD1(xmmword_140E0EC30) += HIDWORD(v46);
          }
        }
      }
      if ( !v41 )
      {
        ...
        if ( SubRectangle >= 0 )
        {
          ...
          *((_QWORD *)v57 + v44) = v2;
          ...
          {
            LODWORD(xmmword_140E0EC70) = v46 + xmmword_140E0EC70;
            DWORD1(xmmword_140E0EC70) += HIDWORD(v46);
            v2 = v49;
          }
        }
      }
      ...
      qword_140E0EC18 = v21;
      qword_140E0EC28 = v0;
      qword_140E0EC60 = (__int64)v1;
      qword_140E0EC98 = (__int64)v2;
      KeResetEvent(&stru_140E64D80);
      KeInitializeTimer(&stru_140E64D00);
      KeInitializeDpc(&stru_140E64C40, (PKDEFERRED_ROUTINE)AnFwpFadeAnimationTimer, 0LL);
      byte_140EEF830 = 1;
      LogFwStat(1LL, 7LL);
      KeSetCoalescableTimer(&stru_140E64D00, 0LL, 0x1Eu, 0, &stru_140E64C40);
...
LABEL_29:
    ...
    v42 = 0;
    v11 = BgpGxParseBitmap((__int64)qword_140EEFDD8, &v43);
    v1 = v43;
    SubRectangle = v11;
    if ( v11 < 0 )
      goto LABEL_29;
    ...
    v15 = qword_140EEFDEC + dword_140EEFDF4;
    v10.QuadPart = (unsigned int)(HIDWORD(qword_140EEFDEC) + dword_140EEFDF8);
    v16 = xmmword_140E0EC30 + DWORD2(xmmword_140E0EC30);
    v45 = qword_140EEFDEC;
    v5 += ((v14 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v14 + 15) & 0xFFFFFFF0) + 32);
    v17 = DWORD1(xmmword_140E0EC30) + HIDWORD(xmmword_140E0EC30);
    if ( (unsigned int)xmmword_140E0EC30 >= (unsigned int)qword_140EEFDEC
      && (unsigned int)xmmword_140E0EC30 <= v15
      && DWORD1(xmmword_140E0EC30) >= HIDWORD(qword_140EEFDEC)
      && DWORD1(xmmword_140E0EC30) <= v10.LowPart )
    {
      if ( v16 < (unsigned int)qword_140EEFDEC || v16 > v15 || v17 < HIDWORD(qword_140EEFDEC) || v17 > v10.LowPart )
        goto LABEL_60;
      v40 = 1;
    }
    LODWORD(v43) = xmmword_140E0EC70 + DWORD2(xmmword_140E0EC70);
    v18 = DWORD1(xmmword_140E0EC70) + HIDWORD(xmmword_140E0EC70);
    if ( (unsigned int)xmmword_140E0EC70 < v45
      || (unsigned int)xmmword_140E0EC70 > v15
      || DWORD1(xmmword_140E0EC70) < HIDWORD(qword_140EEFDEC)
      || DWORD1(xmmword_140E0EC70) > v10.LowPart )
    {
LABEL_12:
      if ( v40 )
        goto LABEL_13;
    ...
    if ( (unsigned int)v43 >= v45 && (unsigned int)v43 <= v15 && v18 >= HIDWORD(qword_140EEFDEC) && v18 <= v10.LowPart )
    {
      v41 = 1;
      goto LABEL_12;
    }
