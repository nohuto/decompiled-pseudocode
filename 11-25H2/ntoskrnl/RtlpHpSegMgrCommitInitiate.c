/*
 * XREFs of RtlpHpSegMgrCommitInitiate @ 0x1402FA074
 * Callers:
 ...
 *     RtlpHpSegMgrApplyLargePagePolicy @ 0x140480838 (RtlpHpSegMgrApplyLargePagePolicy.c)
 */
...
LABEL_2:
  ...
  while ( 1 )
  {
    ...
    if ( a3 > 0 )
    {
      ...
      if ( (v12 & 0x7FF) == 0 )
      {
        v19 = (v11 & 3) != 0 ? (v11 & 2) == 0 : (unsigned int)RtlpHpSegMgrApplyLargePagePolicy(v8, 0LL, 2047LL) == 0;
        if ( !v19 )
          v14 = v12 | 0x4000;
      }
LABEL_6:
