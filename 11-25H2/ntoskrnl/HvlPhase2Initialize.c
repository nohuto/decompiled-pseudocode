/*
 * XREFs of HvlPhase2Initialize @ 0x14057F3D0
 * Callers:
...
LABEL_24:
      ...
      qword_140F8D8B0 = IoCreateNotificationEvent(&EventName, &EventHandle);
      if ( *(_DWORD *)(*(_QWORD *)(a1 + 240) + 2552LL) )
      {
        byte_140F8D8A8 = 1;
        qword_140F8D8C0 = (PVOID)ExAllocatePool2(0x100uLL);
        if ( !qword_140F8D8C0 )
          return -1073741670;
        v16 = *(_DWORD *)(*(_QWORD *)(a1 + 240) + 2552LL);
        *(_DWORD *)qword_140F8D8C0 = v16;
        memmove((char *)qword_140F8D8C0 + 8, *(const void **)(*(_QWORD *)(a1 + 240) + 2544LL), 8LL * v16);
        KeResetEvent(qword_140F8D8B0);
      }
      return 0;
    }
  }
