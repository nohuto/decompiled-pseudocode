/*
 * XREFs of KeSetSchedulingGroupRankBias @ 0x1402F6544
 * Callers:
...
char __fastcall KeSetSchedulingGroupRankBias(__int64 a1, char a2)
{
  __int64 v3; // rbp
  ...
  if ( KeMaximumProcessors )
  {
    while ( 1 )
    {
      ...
      v7 = v3 + 440LL * v5 + 128;
      if ( v6 )
        KiAcquirePrcbLocksForIsolationUnit(KiProcessorBlock[v5], 0LL, &v21);
...
LABEL_9:
        ...
        KiMoveScbThreadsToNewReadylist((struct _KSCB *)(v3 + 440LL * v5 + 128), (struct _LIST_ENTRY *)v15, 0LL, v18);
        v19 = *(_QWORD *)(v7 + 400);
        if ( (*(_BYTE *)(v7 + 408) & 1) != 0 )
        {
          if ( v19 )
...
LABEL_35:
        ...
        KiRemoveSchedulingGroupQueue(v6, (struct _KSCB *)(v3 + 440LL * v5 + 128), 1u);
        goto LABEL_17;
      }
LABEL_10:
...
LABEL_12:
  *(_DWORD *)(v3 + 4) ^= ((unsigned __int8)*(_DWORD *)(v3 + 4) ^ (unsigned __int8)(4 * a2)) & 4;
