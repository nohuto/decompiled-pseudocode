/*
 * XREFs of KiPopulateSubNodes @ 0x140C180B0
 * Callers:
...
ULONG_PTR KiPopulateSubNodes()
{
  ...
  Pool2 = ExAllocatePool2(0x48uLL, 24LL * v0, 0x414E534BuLL);
  if ( !Pool2 || (result = ExAllocatePool2(0x48uLL, 8LL * v0, 0x414E534BuLL)) == 0 )
