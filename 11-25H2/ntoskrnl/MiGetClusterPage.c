/*
 * XREFs of MiGetClusterPage @ 0x1404D2FFC
 * Callers:
  ...
  *(_OWORD *)a8 = 0LL;
  ...
  if ( v27 )
  {
    ...
    if ( v17 < v20 || ProtoPteAddress - v23 + 128 > v22 )
      return 0LL;
    v18 = (unsigned __int64 *)(((v44[0] >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
    v14 = 1LL;
  ...
  v24 = *(_QWORD *)(*((_QWORD *)qword_140E2FD48 + v16) + 16LL);
  v41 = (unsigned __int64 *)*((_QWORD *)qword_140E2FD48 + v16);
