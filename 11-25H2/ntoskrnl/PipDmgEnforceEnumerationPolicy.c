/*
 * XREFs of PipDmgEnforceEnumerationPolicy @ 0x140725974
 * Callers:
 ...
 *     PiIommuIsPassthroughAllowedWhileConsoleLocked @ 0x140729D74 (PiIommuIsPassthroughAllowedWhileConsoleLocked.c)
