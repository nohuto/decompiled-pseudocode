/*
 * XREFs of PopModernStandbyNotificationCallback @ 0x140751FA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  else
  {
    ...
    v10 = *Value;
    dword_140F06EB8 = *Value;
  }
  if ( !dword_140F06EB4 && dword_140F06EB8 == 2 )
    v6 = 1;
  v12 = 1;
LABEL_25:
  if ( v6 )
  ...
  v4 = v13;
LABEL_32:
  PopDiagTraceModernStandbyStateNotification(v11, dword_140F06EB0, v4, v6, (__int64)SettingGuid, v10);
