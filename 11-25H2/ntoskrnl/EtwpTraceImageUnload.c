/*
 * XREFs of EtwpTraceImageUnload @ 0x140447EF8
 * Callers:
    ...
    if ( a2 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v16 )
          break;
        v15 &= v15 - 1;
        v18 = (_DWORD *)(EtwpHostSiloState + 32LL * (unsigned int)v17 + 4284);
        if ( v18 )
        {
          if ( (*v18 & 4) != 0 )
            EtwpLogKernelEvent(
              (struct _KTHREAD *)v32,
              EtwpHostSiloState,
              *(unsigned __int8 *)(EtwpHostSiloState + 2 * v17 + 4232),
              3u,
              0x1402u,
              v13);
        }
        ...
        if ( v19 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( v16 )
              break;
            v20 &= v20 - 1;
            v22 = (_DWORD *)(v19 + 32LL * (unsigned int)v21 + 4284);
            if ( v22 && (*v22 & 4) != 0 )
              EtwpLogKernelEvent(
                (struct _KTHREAD *)v32,
                v19,
                *(unsigned __int8 *)(v19 + 2 * v21 + 4232),
                3u,
                0x1402u,
                v13);
          }
