/*
 * XREFs of GxpReadFrameBufferPixels @ 0x140BA3F2C
 * Callers:
 *     BgpGxReadRectangle @ 0x140BA3D18 (BgpGxReadRectangle.c)
 * Callees:
 *     BgpGetBitsPerPixel @ 0x140481498 (BgpGetBitsPerPixel.c)
 *     GxpAdjustRectangleToFrameBuffer @ 0x1404814C0 (GxpAdjustRectangleToFrameBuffer.c)
 *     GxpGetRotatedPixelOffset @ 0x140489B64 (GxpGetRotatedPixelOffset.c)
...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, unsigned int *a2)
{
  ...
  unsigned __int64 v25; // [rsp+68h] [rbp-41h] BYREF
  __int64 v26; // [rsp+70h] [rbp-39h] BYREF
  int v27; // [rsp+78h] [rbp-31h]
  char *v28; // [rsp+80h] [rbp-29h]
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (_BYTE)BgInternal )
    {
      ...
      {
        v16 = (char *)qword_140EEFD40 + v5 * (*v3 + v3[1] * v22);
        if ( v15 )
        {
          v17 = *(_DWORD *)(a1 + 4) * v5;
          v18 = v5 * v22;
    ...
    else
    {
      ...
      v31[1] = *(_DWORD *)(a1 + 4);
      v31[3] = *(_DWORD *)(a1 + 12);
      v31[2] = xmmword_140EEFD30;
      v32 = *(_QWORD *)(a1 + 24);
      if ( qword_140EEFD40 )
      {
        LOBYTE(v12) = 1;
        RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_140EEFD40)(v31, v3, v12);
      }
      else
      {
