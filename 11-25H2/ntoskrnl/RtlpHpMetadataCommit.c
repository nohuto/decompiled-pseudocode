/*
 * XREFs of RtlpHpMetadataCommit @ 0x1405F8F30
 * Callers:
...
__int64 __fastcall RtlpHpMetadataCommit(__int64 a1, int a2, unsigned __int64 a3, _QWORD *a4, int a5)
{
  ...
  v8 = &qword_140E6B8D8[2 * (unsigned int)dword_14001E630[(unsigned __int8)BYTE1(*a4)]];
  if ( (_WORD)a1 )
  {
    v10 = 0;
  }
  ...
  {
    v9 = RtlCSparseBitmapBitmaskRead((__int64)&dword_140E68050, 2 * ((unsigned __int64)(a1 - qword_140E68048) >> 20));
    if ( v9 )
      v10 = v9 - 1;
    else
      v10 = 2;
