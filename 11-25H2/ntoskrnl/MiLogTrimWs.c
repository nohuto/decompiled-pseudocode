/*
 * XREFs of MiLogTrimWs @ 0x1403C4A28
 * Callers:
...
char __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, int a7)
{
  ...
  {
    v12 = *((_QWORD *)qword_140E2FD48 + *(unsigned __int16 *)(a1 + 174));
    ...
    if ( **(_DWORD **)&qword_140E372D8 > 5u )
    {
      ...
      if ( (_BYTE)v7 )
      {
        ...
        v64 = 4LL;
        v66 = 4LL;
        LOBYTE(v7) = tlgWriteEx_EtwWriteEx(v21, (int)&byte_1400551FF, v21, 1, v23, v24, 0x11u, (__int64)v39);
      }
    }
  }
  return (char)v7;
