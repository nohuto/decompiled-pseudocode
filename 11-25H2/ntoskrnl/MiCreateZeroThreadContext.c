/*
 * XREFs of MiCreateZeroThreadContext @ 0x1407EF3FC
 * Callers:
 ...
 *     MiSetZeroThreadState @ 0x1404A9100 (MiSetZeroThreadState.c)
...
__int64 __fastcall MiCreateZeroThreadContext(__int64 a1)
{
  ...
  while ( v12 );
  if ( !(unsigned int)MiCreateUltraThreadContext(v6 + 448, v6 + 608, 14, 8LL) )
  {
