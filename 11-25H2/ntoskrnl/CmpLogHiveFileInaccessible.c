/*
 * XREFs of CmpLogHiveFileInaccessible @ 0x14091005C
 * Callers:
...
void __fastcall CmpLogHiveFileInaccessible(UNICODE_STRING *a1, int a2, ULONG a3, ULONG a4)
{
  ...
  if ( v22 == -1073741790 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( (unsigned int)dword_140E09E08 > 3 )
    {
      if ( (qword_140E09E18 & 0x200000000008LL) == 0 || (qword_140E09E20 & 0x200000000008LL) != qword_140E09E20 )
        v17 = 0;
      if ( v17 )
      {
        v37 = 0;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_1400541DB,
          0LL,
          0LL,
          6u,
          v34);
  ...
  if ( (unsigned int)dword_140E09E08 > 3 )
  {
    if ( (qword_140E09E18 & 0x200000000008LL) != 0 && (qword_140E09E20 & 0x200000000008LL) == qword_140E09E20 )
    {
      ...
      *(_QWORD *)&EventDescriptor.Id = 0x1000000LL;
      ...
      tlgWriteAgg(
        (__int64)&dword_140E09E08,
        (unsigned __int8 *)byte_140054183,
        (unsigned int)dword_140E09E08,
        5u,
        (__int64)v34);
      v13 = qword_140E09E20;
      v12 = dword_140E09E08;
    ...
    if ( v12 > 3 && (qword_140E09E18 & 8) != 0 && (v13 & 8) == v13 )
    {
      v33 = 0;
      v31 = &v20;
      *(_DWORD *)&EventDescriptor.Level = 3;
      UserData.ClientToken = off_140E09E10;
      v20 = v7;
      v32 = 4;
      *(_DWORD *)&EventDescriptor.Id = 184549376;
      EventDescriptor.Keyword = 8LL;
      UserData.ImpersonationLevel = *(unsigned __int16 *)off_140E09E10;
      UserData.PrimaryToken = &byte_140054157;
      *((_DWORD *)&UserData.ImpersonationLevel + 1) = 2;
      ...
      EtwWriteTransfer(qword_140E09E28, &EventDescriptor, 0LL, 0LL, 3u, (PEVENT_DATA_DESCRIPTOR)&UserData);
      v10 = Privileges;
      v11 = (WCHAR *)P;
LABEL_21:
      if ( v10 )
