/*
 * XREFs of KiPreprocessFault @ 0x14025EAD0
 * Callers:
 *     KiDispatchException @ 0x14025DD90 (KiDispatchException.c)
 * Callees:
 *     KiOpDecode @ 0x14025F540 (KiOpDecode.c)
 *     KiOp_Mov @ 0x14025F910 (KiOp_Mov.c)
 *     KiOp_Priv @ 0x140260CD0 (KiOp_Priv.c)
 *     KiOp_SLDTSTRSMSW @ 0x140474E10 (KiOp_SLDTSTRSMSW.c)
 *     KiCheckForAtlThunk @ 0x14048D5DC (KiCheckForAtlThunk.c)
...
LABEL_8:
    ...
    else
    {
      ...
      if ( *((_QWORD *)&v26 + 1) )
      {
        ...
        else if ( v16 == KiOp_SLDTSTRSMSW )
        {
          v13 = KiOp_SLDTSTRSMSW(v23);
        }
        else
        {
...
LABEL_2:
  ...
  else
  {
    if ( v8 != 51 )
      goto LABEL_6;
    v9 = (void *)qword_140FC64C0;
    v10 = (void *)qword_140FC64C8;
  }
