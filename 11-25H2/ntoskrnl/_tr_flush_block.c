/*
 * XREFs of _tr_flush_block @ 0x1405F64E8
 * Callers:
 ...
 *     bi_windup @ 0x1405F6940 (bi_windup.c)
 *     build_tree @ 0x1405F69A0 (build_tree.c)
 *     compress_block @ 0x1405F6BE8 (compress_block.c)
 *     detect_data_type @ 0x1405F6FE4 (detect_data_type.c)
 *     init_block @ 0x1405F732C (init_block.c)
 *     scan_tree @ 0x1405F7464 (scan_tree.c)
 *     send_all_trees @ 0x1405F7580 (send_all_trees.c)
 */
...
LABEL_11:
  ...
  for ( i = 18LL; i >= 3; --i )
  {
    if ( *(_WORD *)(a1 + 4LL * *((unsigned __int8 *)qword_1400350C0 + i) + 2806) )
      break;
    LODWORD(v8) = v8 - 1;
  }
