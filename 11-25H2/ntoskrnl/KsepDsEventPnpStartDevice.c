/*
 * XREFs of KsepDsEventPnpStartDevice @ 0x1405C73B8
 * Callers:
 *     KseDsCompletionHookForStartDevice @ 0x1405C67E0 (KseDsCompletionHookForStartDevice.c)
 * Callees:
...
char __fastcall KsepDsEventPnpStartDevice(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( KseEtwHandle )
  {
    LOBYTE(v4) = EtwEventEnabled(KseEtwHandle, &KseDsEventStartDevice);
    if ( (_BYTE)v4 )
    {
      UserData.Reserved = 0;
      v9 = 0;
      ...
      v13 = &v20;
      v14 = 4;
      LOBYTE(v4) = EtwWriteEx(KseEtwHandle, &KseDsEventStartDevice, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
