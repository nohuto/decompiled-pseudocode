/*
 * XREFs of PoRegisterPowerSettingCallback @ 0x140A686B0
 * Callers:
  ...
  if ( Callback )
  {
    ...
    if ( !v10 )
    {
      *(_QWORD *)&v25.Length = 34078720LL;
      ...
      if ( (int)RtlPcToFileName((__int64)Callback, &v25) >= 0 )
      {
        DWORD2(v27) = 16;
        *(_QWORD *)&v27 = &v25;
        v24 = &v27;
...
LABEL_19:
    ...
    {
      v18 = (_QWORD *)qword_140F0BB58;
      if ( *(__int64 **)qword_140F0BB58 != &PopRegisteredPowerSettingCallbacks )
        goto LABEL_19;
      *(_QWORD *)v12 = &PopRegisteredPowerSettingCallbacks;
      *((_QWORD *)v12 + 1) = v18;
      *v18 = v12;
      qword_140F0BB58 = (__int64)v12;
    }
    v19 = 0;
