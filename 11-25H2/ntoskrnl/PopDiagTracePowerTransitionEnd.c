/*
 * XREFs of PopDiagTracePowerTransitionEnd @ 0x140AB51C8
 * Callers:
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    *(_QWORD *)&v15.Size = 4LL;
    ...
    v35 = v14[1];
    v37 = 0;
    EtwWriteEndScenario((PVOID *)PopDiagHandle, &POP_ETW_EVENT_POWERTRANSITION_END, &PopDiagActivityId, 0xAu, &v15);
    if ( LOBYTE(v3[0]) )
