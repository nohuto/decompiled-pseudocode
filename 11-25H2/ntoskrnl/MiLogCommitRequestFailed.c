/*
 * XREFs of MiLogCommitRequestFailed @ 0x140AA6FF0
 * Callers:
...
char __fastcall MiLogCommitRequestFailed(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    if ( (ProcessPartition & 0x400) == 0 )
    {
      ...
      {
        LOBYTE(ProcessPartition) = tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000001000LL);
        if ( (_BYTE)ProcessPartition )
        {
          ...
          LOBYTE(ProcessPartition) = tlgWriteEx_EtwWriteEx(
                                       v15,
                                       (unsigned __int8 *)&dword_1400565C4,
                                       v15,
                                       1u,
                                       v20,
                                       v21,
