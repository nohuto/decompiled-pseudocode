/*
 * XREFs of ViAllocateMapRegistersFromFile @ 0x140B780D8
 * Callers:
 ...
 *     ViTagBuffer @ 0x140B79F34 (ViTagBuffer.c)
 */
...
__int64 __fastcall ViAllocateMapRegistersFromFile(__int64 a1, ULONG_PTR a2, unsigned int a3, char a4, _DWORD *a5)
{
      ...
      do
      {
        ...
        if ( *v14 && v17 >= v9 && v17 < (unsigned __int64)v16 )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)v9,
            v16);
          VfReportIssueWithOptions(0xE6u, 0x1DuLL, v9, (ULONG_PTR)v16, *v14, byte_140E0E724);
        }
        v14 += 4;
      }
      while ( v14 < v15 );
  ...
  while ( v11 < (unsigned int)v12 )
  {
    if ( v10 == *(_DWORD *)(v7 + 28) )
    {
      ViHalPreprocessOptions(byte_140E0E728, "Map registers needed: %x available: %x", 0x10000000, 2);
      VfReportIssueWithOptions(0xE6u, 0LL, 2uLL, (unsigned int)v12, v11, byte_140E0E728);
      goto LABEL_28;
    }
    v19 = *v6;
    v20 = v11 + 1;
