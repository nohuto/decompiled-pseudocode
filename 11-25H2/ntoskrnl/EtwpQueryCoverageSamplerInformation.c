/*
 * XREFs of EtwpQueryCoverageSamplerInformation @ 0x140824848
 * Callers:
 *     EtwQueryPerformanceTraceInformation @ 0x14082425C (EtwQueryPerformanceTraceInformation.c)
 * Callees:
 *     ObfDereferenceObject @ 0x140309490 (ObfDereferenceObject.c)
 *     EtwpCoverageSamplerQueryStatusInformation @ 0x1407A3788 (EtwpCoverageSamplerQueryStatusInformation.c)
