/*
 * XREFs of IopMcFindNextTableEntryForUnlock @ 0x14043D130
 * Callers:
...
ULONG_PTR __fastcall IopMcFindNextTableEntryForUnlock(__int64 *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  if ( *((_BYTE *)a1 + 16) )
    return 0LL;
  v6 = ExAcquireSpinLockShared(&dword_140F8BB24);
  v7 = qword_140F8BB28;
  v8 = 0LL;
  v9 = v6;
  if ( qword_140F8BB28 )
  ...
  {
    _InterlockedAnd(&dword_140F8BB24, 0xBFFFFFFF);
    _InterlockedDecrement(&dword_140F8BB24);
  }
  else
  {
    ExpReleaseSpinLockSharedFromDpcLevelInstrumented(&dword_140F8BB24, retaddr);
  }
  if ( KiIrqlFlags )
