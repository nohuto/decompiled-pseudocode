/*
 * XREFs of HalGetAdapterV3 @ 0x1406F42C8
 * Callers:
 ...
 *     HalpFindDmaControllerByRequestLine @ 0x1405507D4 (HalpFindDmaControllerByRequestLine.c)
...
__int64 __fastcall HalGetAdapterV3(__int64 a1, __int64 a2, int a3, int *a4)
{
  ...
  else
  {
    ...
    if ( !AdapterByRequestLine && !HalpDmaControllerValidateRequestLineBinding(v13) )
      return 0LL;
    v4 = a2;
  }
  v14 = *(_BYTE *)(a1 + 4);
...
LABEL_70:
  v32 = v42;
  if ( HalpDmaCvmConfiguration && v42 < dword_140FC0344 )
  {
    v32 = dword_140FC0344;
    v42 = dword_140FC0344;
  }
