/*
 * XREFs of PfpPfnPrioRequest @ 0x140933094
 * Callers:
    ...
    if ( v7 >= 0xD8 )
    {
      ...
      if ( PfnList >= 0 )
      {
        ...
        if ( PfnList >= 0 && (*((_DWORD *)v6 + 1) & 1) != 0 )
          MmQueryMemoryListInformation((ULONG **)0xFFFFFFFFFFFFFFFFLL, v6 + 1, 0xB0u, v9, &v15);
        if ( a2 )
  ...
  if ( *(_DWORD *)(a1 + 8) == 7 || *(_DWORD *)(a1 + 8) == 22 || *(_DWORD *)(a1 + 8) == 29 )
  {
    ...
    if ( v12 >= 0xD8 )
    {
      ...
      if ( PfnList >= 0 )
      {
        ...
        {
          v6 = Src;
          v14 = MmSetPfnListInfo(*((_QWORD *)Src + 1), (_QWORD *)Src + 24, v13 == 29);
        }
        else
        {
          v6 = Src;
