/*
 * XREFs of DifMmAllocateContiguousMemorySpecifyCacheNodeWrapper @ 0x140625C10
 * Callers:
 *     <none>
 * Callees:
        ...
        NODE_REQUIREMENT PreferredNode)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v19 + 1) = a1;
    *((_QWORD *)&v17 + 1) = __PAIR64__(CacheType, PreferredNode);
    *(PHYSICAL_ADDRESS *)&v19 = a2;
    *((PHYSICAL_ADDRESS *)&v18 + 1) = a3;
    *(PHYSICAL_ADDRESS *)&v18 = a4;
