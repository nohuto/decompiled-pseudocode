/*
 * XREFs of ApiSetCompose_ProcessV7Extension_Phase0 @ 0x1406557CC
 * Callers:
...
__int64 __fastcall ApiSetCompose_ProcessV7Extension_Phase0(__int64 a1, __int64 a2)
{
  ...
  while ( v5 )
  {
    ...
    if ( !(unsigned __int8)ApiSetpGetContractKeyInfo(
                             a1 + *(unsigned int *)(v19 + 20LL * v6),
                             *(unsigned __int16 *)(v19 + 20LL * v6 + 8),
                             0LL,
                             &v17)
...
LABEL_15:
    v12 = 0;
    for ( i = v19; v12 < *(unsigned __int16 *)(v19 + 20LL * v6 + 10); i = v19 )
    {
