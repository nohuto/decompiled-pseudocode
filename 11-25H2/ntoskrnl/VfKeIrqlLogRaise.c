/*
 * XREFs of VfKeIrqlLogRaise @ 0x140B98000
 * Callers:
 *     ViIrqlExAcquireFastMutex_Exit @ 0x140B8D5B0 (ViIrqlExAcquireFastMutex_Exit.c)
 *     ViIrqlExTryToAcquireFastMutex_Exit @ 0x140B8D5D0 (ViIrqlExTryToAcquireFastMutex_Exit.c)
