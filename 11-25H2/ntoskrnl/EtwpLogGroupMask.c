/*
 * XREFs of EtwpLogGroupMask @ 0x140A11EC8
 * Callers:
...
int __fastcall EtwpLogGroupMask(__int64 a1, unsigned int a2, __int128 *a3, unsigned __int16 a4)
{
  __int128 v4; // xmm1
  __int128 v5; // xmm0
  ...
  *(_OWORD *)&v8.m256i_u64[2] = v4;
  return EtwpLogKernelEvent((struct _KTHREAD *)v7, a1, a2, 1u, a4, 0x501802u);
}
