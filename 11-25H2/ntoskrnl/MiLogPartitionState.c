/*
 * XREFs of MiLogPartitionState @ 0x1403C3BC4
 * Callers:
...
char __fastcall MiLogPartitionState(__int16 *a1)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    {
      if ( (*(_DWORD *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 0x800LL) == 0
        || (LOBYTE(v1) = 1,
            (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL) & 0x800LL) != *(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 24LL)) )
      {
        LOBYTE(v1) = 0;
      }
      if ( (_BYTE)v1 )
