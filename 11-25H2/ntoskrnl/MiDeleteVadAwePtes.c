/*
 * XREFs of MiDeleteVadAwePtes @ 0x1403FB8D8
 * Callers:
  ...
  *(_DWORD *)(a1 + 12) = v9 * v19 - 1;
  ...
  if ( (_QWORD)v27 )
  {
    if ( (*(_DWORD *)(v7 + 8) & 8) != 0 )
    {
      ...
      if ( v22 )
      {
        v24 = ((v22 - qword_140E2FD80) >> 3 << 17) ^ (((v22 - qword_140E2FD80) >> 3 << 17) ^ v23) & 0xFFFFFF800001FFFFuLL;
      }
      else
      {
        *(_QWORD *)(v3 + 104) = v21;
      ...
      *v21 = v24;
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140E2FD88 + 4 * (((((__int64)v21 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v21 - qword_140E2FD80) >> 3) & 0x1F)));
    }
    else
    {
      v25 = *(_QWORD *)(v3 + 96);
