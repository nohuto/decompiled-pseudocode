/*
 * XREFs of PopCreateHiberFile @ 0x140745C64
 * Callers:
 ...
 *     Feature_Servicing_HiberFileSizeFix__private_IsEnabledDeviceUsageNoInline @ 0x1405CE944 (Feature_Servicing_HiberFileSizeFix__private_IsEnabledDeviceUsageNoInline.c)
...
LABEL_10:
  ...
  if ( Status >= 0 )
  {
    ...
    if ( Status < 0 )
      goto LABEL_34;
    if ( !(unsigned int)Feature_Servicing_HiberFileSizeFix__private_IsEnabledDeviceUsageNoInline() )
      goto LABEL_16;
    v17 = v13;
