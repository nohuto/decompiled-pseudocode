/*
 * XREFs of RtlpFcQueryAllInternalFeatureConfigurationsFromBufferSet @ 0x1405E66C8
 * Callers:
 ...
 *     RtlpFcConfigurationTypeToBufferType @ 0x140A9A830 (RtlpFcConfigurationTypeToBufferType.c)
 */
