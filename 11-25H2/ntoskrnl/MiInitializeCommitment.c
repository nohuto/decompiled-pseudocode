/*
 * XREFs of MiInitializeCommitment @ 0x14067AAA8
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(__int64 a1)
{
  ...
  if ( KeNumberNodes )
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ( dword_140E2D98C )
        {
          v9 = (unsigned int)dword_140E2D98C;
          do
          {
            v10 = *v8;
            v8 += 8;
  ...
  *(_QWORD *)(a1 + 18752) = v3;
  ...
  if ( (ULONG *)a1 == &MiSystemPartition )
  {
    result = *(_QWORD *)(a1 + 19264) - qword_140E373B8 - qword_140E3D680;
    qword_140E37398 = result;
  }
  return result;
}
