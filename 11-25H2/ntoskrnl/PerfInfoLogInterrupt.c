/*
 * XREFs of PerfInfoLogInterrupt @ 0x140257560
 * Callers:
...
int __fastcall PerfInfoLogInterrupt(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v7 &= v7 - 1;
    v6 = (__int64 *)(EtwpHostSiloState + 32LL * (unsigned int)v9 + 4284);
    if ( v6 && (*((_DWORD *)v6 + 1) & 0x4000) != 0 )
    {
      v10 = *(unsigned __int8 *)(EtwpHostSiloState + 2 * v9 + 4233) - 1LL;
      v15[1] = 8LL;
      v15[0] = a3 + 8 * v10;
      LODWORD(v6) = EtwpLogKernelEvent(
                      (struct _KTHREAD *)v15,
                      EtwpHostSiloState,
                      *(unsigned __int8 *)(EtwpHostSiloState + 2LL * (unsigned int)v9 + 4232),
                      2u,
                      v5,
                      0x500A02u);
    }
