/*
 * XREFs of IvtLegacySetScalableModePasidTableEntry @ 0x1404F2A20
 * Callers:
...
__int64 __fastcall IvtLegacySetScalableModePasidTableEntry(__int64 a1, __int64 a2, unsigned int a3, signed __int64 *a4)
{
  ...
  v4 = *a4;
  v5 = (volatile signed __int64 *)(*(_QWORD *)(a2 + 8LL * ((a3 >> 6) & 0x3FFF) + 64)
