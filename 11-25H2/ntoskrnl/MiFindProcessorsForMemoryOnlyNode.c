/*
 * XREFs of MiFindProcessorsForMemoryOnlyNode @ 0x140C47530
 * Callers:
 *     MiReassignProcessorsToMemoryOnlyNodes @ 0x140C478AC (MiReassignProcessorsToMemoryOnlyNodes.c)
 * Callees:
...
__int64 __fastcall MiFindProcessorsForMemoryOnlyNode(unsigned int a1, unsigned int a2)
{
  ...
  v30 = *(_DWORD **)(384LL * a1 + qword_140E2D8B8 + 376);
  v3 = qword_140E2D890 + 4LL * (unsigned __int16)KeNumberNodes * a1;
...
LABEL_2:
  ...
  v35 = *v5;
  v34 = 1;
  v7 = *(_QWORD **)(384LL * *v5 + qword_140E2D8B8 + 376);
  v8 = 1LL;
  v25 = v7;
  for ( i = (_WORD *)v7 + 13; ; ++i )
  {
