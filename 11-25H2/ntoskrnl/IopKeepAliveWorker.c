/*
 * XREFs of IopKeepAliveWorker @ 0x140489720
 * Callers:
 *     <none>
 * Callees:
...
void IopKeepAliveWorker()
{
  ...
  v0 = KeAcquireSpinLockRaiseToDpc(&qword_140F8C190);
  qword_140F8C1C0 = (__int64)KeGetCurrentThread();
LABEL_2:
  v1 = v0;
  while ( 1 )
  {
    v2 = qword_140F8C180;
    if ( qword_140F8C180 == &qword_140F8C180 )
      break;
    v3 = *((_DWORD *)qword_140F8C180 + 8);
    *((_DWORD *)qword_140F8C180 + 8) = 0;
    if ( v3 )
    {
      KeReleaseSpinLock(&qword_140F8C190, v1);
      if ( v3 > 0 )
      {
        do
        {
      ...
      if ( (v8 & 0x7FFFFFFF) == 1 )
      {
        v9 = KeAcquireSpinLockRaiseToDpc(&qword_140F8C190);
        if ( MEMORY[0xFFFFF78000000014] < *((_QWORD *)v2 + 6) )
        {
          --*((_DWORD *)v2 + 8);
          KeReleaseSpinLock(&qword_140F8C190, v9);
