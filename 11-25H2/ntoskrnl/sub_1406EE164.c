/*
 * XREFs of sub_1406EE164 @ 0x1406EE164
 * Callers:
...
__int64 __fastcall sub_1406EE164(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // edx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
  ...
  if ( (_DWORD)v16 )
    v18 = v17;
  v19 = qword_140FD7330 ? guard_dispatch_icall_no_overrides(v18) : -1073741637;
  v20 = *(_DWORD *)(a2 + 32);
