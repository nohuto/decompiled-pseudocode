/*
 * XREFs of DifZwOpenSymbolicLinkObjectWrapper @ 0x140636A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSymbolicLinkObjectWrapper(
        PHANDLE LinkHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(74);
  ...
  LODWORD(v17) = ZwOpenSymbolicLinkObject(LinkHandle, DesiredAccess, ObjectAttributes);
  if ( v7 )
  {
