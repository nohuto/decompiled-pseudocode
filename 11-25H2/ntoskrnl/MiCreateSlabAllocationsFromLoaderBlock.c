/*
 * XREFs of MiCreateSlabAllocationsFromLoaderBlock @ 0x140C480EC
 * Callers:
...
__int64 __fastcall MiCreateSlabAllocationsFromLoaderBlock(__int64 a1)
{
    ...
    while ( i )
    {
      ...
      if ( v3 == 29 || v3 == 36 )
      {
        ...
        while ( v4 )
        {
          ...
          BootSlabEntries = MiCreateBootSlabEntries(qword_140E389D0 + 16160 + 57216LL * v10, v5, v9, 0);
  ...
  if ( (MiFlags & 0x4000) != 0 )
  {
    v15 = (unsigned int)dword_140E389C4;
