/*
 * XREFs of EtwpTraceMessageVa @ 0x14030B270
 * Callers:
 *     NtTraceEvent @ 0x14030A680 (NtTraceEvent.c)
 *     WmiTraceMessage @ 0x14030D020 (WmiTraceMessage.c)
 *     WmiTraceMessageVa @ 0x1404B8150 (WmiTraceMessageVa.c)
 * Callees:
...
LABEL_6:
  ...
  if ( a6 == 1 || KeAreInterruptsEnabled() && KeGetCurrentIrql() < 2u )
  {
    ...
    v17 = *(_QWORD *)(*(_QWORD *)(v13 + 448) + 8 * v14);
  ...
  v21 = 8 * v14;
  v83 = 8 * v14;
  v22 = *(_QWORD *)(8 * v14 + *(_QWORD *)(v13 + 456));
  v98 = v22;
  if ( (v22 & 1) != 0 )
  {
    if ( v15 )
    {
      ExReleaseRundownProtectionCacheAwareEx(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*(_QWORD *)(v13 + 448) + v21), 1u);
LABEL_115:
  ...
  if ( v8 > v34 )
  {
    ...
    if ( EtwpEventTracingProvRegHandle
      && (EtwpLevelKeywordEnabled(*(_QWORD *)(EtwpEventTracingProvRegHandle + 32) + 96LL, 2u, 64LL)
       || *(_BYTE *)(v59 + 101) && EtwpLevelKeywordEnabled(*(_QWORD *)(v59 + 40) + 96LL, v56, v57)) )
    {
      v90 = v58;
  ...
  if ( !v35 )
  {
    ...
    if ( EtwpEventTracingProvRegHandle
      && (EtwpLevelKeywordEnabled(*(_QWORD *)(EtwpEventTracingProvRegHandle + 32) + 96LL, 2u, 64LL)
       || *(_BYTE *)(v65 + 101) && EtwpLevelKeywordEnabled(*(_QWORD *)(v65 + 40) + 96LL, v61, v62)) )
    {
      v91 = v64;
      v79 = v77;
...
LABEL_86:
  ...
  if ( v49 >= 0 )
  {
    ...
    if ( *(_QWORD *)(v50 + 1552) )
    {
      ...
      if ( (_DWORD)v55 )
      {
        if ( (unsigned int)v100 >= 0x48 && (unsigned int)v100 < (unsigned __int64)(v55 - 4) )
        {
...
LABEL_158:
              ...
              if ( v73 < (unsigned int)v55
                && (unsigned int)v100 + v73 <= (unsigned int)v55
                && v71
          ...
          else if ( v70 == -1073741824 )
          {
            ...
            switch ( BYTE2(v69) )
            {
              case 1:
              case 2:
                if ( (unsigned int)v100 < (unsigned __int64)(v55 - 8) )
                {
  ...
  v51 = (signed __int64 *)*((_QWORD *)&v99 + 1);
  _m_prefetchw(*((const void **)&v99 + 1));
  v52 = *v51;
  while ( (v52 ^ (unsigned __int64)v99) < 0xF )
  {
    v53 = v52;
    v52 = _InterlockedCompareExchange64(*((volatile signed __int64 **)&v99 + 1), v52 + 1, v52);
    if ( v53 == v52 )
      goto LABEL_92;
  }
