/*
 * XREFs of KiInitDpcThresholds @ 0x140C17060
 * Callers:
 *     KeInitSystem @ 0x140C4FA10 (KeInitSystem.c)
 * Callees:
 *     KiInitializeLegacyWatchdogProfileThresholds @ 0x140C174CC (KiInitializeLegacyWatchdogProfileThresholds.c)
 */
