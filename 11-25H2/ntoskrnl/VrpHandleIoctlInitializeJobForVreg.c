/*
 * XREFs of VrpHandleIoctlInitializeJobForVreg @ 0x14094B860
 * Callers:
    ...
    if ( JobSilo >= 0 )
    {
      ...
      if ( !IsThreadInSilo )
      {
        ...
        *(_OWORD *)Object = *(_OWORD *)(v11 + 1472);
        ...
        JobSilo = CmInitSiloNamespace(v11);
        if ( JobSilo >= 0 )
        {
          JobSilo = PsInsertSiloContext(v11, (unsigned int)VrpSiloContextSlot, v8);
          if ( JobSilo >= 0 )
          {
            v26 = 1;
            RootKeyObjectForSilo = (void *)CmGetRootKeyObjectForSilo(v11, v22, v23, 0LL);
