/*
 * XREFs of DifHalAllocateCrashDumpRegistersWrapper @ 0x1406161F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifHalAllocateCrashDumpRegistersWrapper(PADAPTER_OBJECT AdapterObject, PULONG NumberOfMapRegisters)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = AdapterObject;
    *((_QWORD *)&v13 + 1) = NumberOfMapRegisters;
  ...
  *((_QWORD *)&v14 + 1) = HalAllocateCrashDumpRegisters(AdapterObject, NumberOfMapRegisters);
  if ( v5 )
  {
