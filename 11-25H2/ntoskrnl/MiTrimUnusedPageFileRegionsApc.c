/*
 * XREFs of MiTrimUnusedPageFileRegionsApc @ 0x1403DB600
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall MiTrimUnusedPageFileRegionsApc(PRKEVENT Event)
{
  ...
  if ( FreePageFileSpace >= HIDWORD(Event[1].Header.WaitListHead.Flink) )
  {
    ...
    HIDWORD(Event[1].Header.WaitListHead.Blink) = v8 + MiFindFreePageFileSpace(v1, (__int64 *)&v15, v12, 0x6Bu);
  }
