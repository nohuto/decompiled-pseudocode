/*
 * XREFs of SmKmKeyGenStart @ 0x14078B00C
 * Callers:
 *     SmcCacheManagerStart @ 0x14078DDC8 (SmcCacheManagerStart.c)
 * Callees:
 *     SmAllocEx @ 0x14039350C (SmAllocEx.c)
 *     ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x140601210 (-RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
 */
