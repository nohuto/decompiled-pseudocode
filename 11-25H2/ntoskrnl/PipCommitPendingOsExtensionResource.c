/*
 * XREFs of PipCommitPendingOsExtensionResource @ 0x140C146B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PipCommitPendingOsExtensionResource(__int64 a1, void *a2, void *a3)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  CachedContextBaseKey = PnpCtxGetCachedContextBaseKey(*(__int64 *)&PiPnpRtlCtx, 4, &v10);
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    if ( CachedContextBaseKey >= 0 )
    {
      CachedContextBaseKey = PnpCtxRegCreateKey(*(__int64 *)&PiPnpRtlCtx, (int)v12, a1, 0, 131078, 0LL);
      if ( CachedContextBaseKey >= 0 )
      {
