/*
 * XREFs of EtwTiLogImpersonateClient @ 0x1408A5C84
 * Callers:
...
__int64 __fastcall EtwTiLogImpersonateClient(__int64 a1, __int64 a2, void *a3, void *a4)
{
  ...
  {
    if ( a3 )
      return ObFastDereferenceObject((__int64 *)(a1 + 584), (ULONG_PTR)a3, 1953261124LL);
  }
  return result;
}
