/*
 * XREFs of HaliInitializePlatformDebugTriggers @ 0x140566C10
 * Callers:
 *     <none>
 * Callees:
...
void HaliInitializePlatformDebugTriggers()
{
  ...
  if ( PdttTable )
  {
    ...
    if ( *(_BYTE *)(PdttTable + 36) )
    {
      ...
      {
        v4 = v2++;
        *(_QWORD *)(136 * v4 + qword_140E114C0) = v3;
        v3 += 2LL;
      ...
      if ( (_BYTE)v5 )
      {
        ...
        {
          v6 = 136LL * v1;
          v7 = *(_BYTE **)(v6 + qword_140E114C0);
          LOBYTE(v7) = *v7;
          HalpAcquirePccInterface(v7, &DestinationString, v6 + qword_140E114C0 + 8);
          ++v1;
        }
