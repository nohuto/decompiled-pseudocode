/*
 * XREFs of HalpLbrConfigurationWorker @ 0x1406F8498
 * Callers:
 *     HalpLbrConfigureRecording @ 0x1406F85A0 (HalpLbrConfigureRecording.c)
 *     HalpLbrStartRecording @ 0x1406F85E0 (HalpLbrStartRecording.c)
 *     HalpLbrStopRecording @ 0x1406F86F0 (HalpLbrStopRecording.c)
 * Callees:
