/*
 * XREFs of RtlpHpVaMgrRangeCoalesce @ 0x1403CC730
 * Callers:
...
__int64 __fastcall RtlpHpVaMgrRangeCoalesce(__int64 a1, unsigned __int64 a2)
{
  ...
  *(_BYTE *)a2 &= ~1u;
  ...
  {
    RtlRbRemoveNode(a1 + 8, (unsigned __int64 *)(a2 - v7));
  ...
  {
    RtlRbRemoveNode(a1 + 8, (unsigned __int64 *)(v3 + 32LL * *(unsigned __int16 *)(v3 + 24)));
