/*
 * XREFs of EtwpTracingProvEnableCallback @ 0x140AA5760
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONGLONG MatchAnyKeyword)
{
  ...
  if ( ControlCode == 2 )
  {
    ...
    for ( j = 0LL; ; j = (_DWORD *)v23 )
    {
      ...
      v12 = (volatile signed __int32 *)(NextGuidEntry + 51);
      --CurrentThread->KernelApcDisable;
      v13 = KeAbPreAcquire((__int64)(NextGuidEntry + 51), 0LL);
      v14 = v13;
      if ( _interlockedbittestandset64(v12, 0LL) )
        ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(v23 + 408), v13, v23 + 408);
      if ( v14 )
        *((_BYTE *)v14 + 10) = 1;
      *(_QWORD *)(v23 + 416) = KeGetCurrentThread();
      ...
      *(_QWORD *)(v23 + 416) = 0LL;
      ...
      {
        ExfReleasePushLock((_QWORD *)(v23 + 408));
      }
      KeAbPostRelease(v23 + 408);
    ...
    for ( k = 0LL; ; k = v39 )
    {
      ...
      if ( v25 )
      {
        ...
        v27 = KeAbPreAcquire((__int64)(v39 + 51), 0LL);
        v28 = v27;
        if ( _interlockedbittestandset64((volatile signed __int32 *)v39 + 102, 0LL) )
          ExfAcquirePushLockExclusiveEx(v39 + 51, v27, (__int64)(v39 + 51));
        if ( v28 )
          *((_BYTE *)v28 + 10) = 1;
        v5 = 1;
        v39[52] = KeGetCurrentThread();
      }
      ...
      if ( v5 )
      {
        ...
        if ( (v35 & 0xFFFFFFFFFFFFFFF0uLL) <= 0x10 )
          v36 = 0LL;
        if ( (v35 & 2) != 0 || (v37 = v39[51], v37 != _InterlockedCompareExchange64(v39 + 51, v36, v35)) )
          ExfReleasePushLock(v39 + 51);
        KeAbPostRelease((ULONG_PTR)(v39 + 51));
        KeLeaveCriticalRegion();
        v5 = 0;
      }
    }
