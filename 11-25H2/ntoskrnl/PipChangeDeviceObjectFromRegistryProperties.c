/*
 * XREFs of PipChangeDeviceObjectFromRegistryProperties @ 0x1409ABF7C
 * Callers:
...
LABEL_6:
  ...
  RegistrySecurityWithFallback = PipGetRegistrySecurityWithFallback(
                                   ...
                                   v47 & -(__int64)(v14 != 0));
  v25 = v43;
  v26 = (UNICODE_STRING *)RegistrySecurityWithFallback;
  if ( !RegistrySecurityWithFallback )
  {
    ...
    v26 = (UNICODE_STRING *)IopCreateDefaultDeviceSecurityDescriptor(v43, v23, 0, v48, (ACL **)&P, (__int64)&v44, &v40);
    if ( !v26 )
    {
      v11 = v44;
...
LABEL_45:
  ...
  if ( v27 >= 0 )
  {
    v31 = *(char **)&v26[1].Length;
  }
  else
  {
    Buffer_low = LODWORD(v26->Buffer);
    if ( !(_DWORD)Buffer_low )
      goto LABEL_18;
    v31 = (char *)v26 + Buffer_low;
  }
  if ( v31 )
    v21 |= 2u;
LABEL_18:
