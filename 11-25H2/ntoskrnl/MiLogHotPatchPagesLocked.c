/*
 * XREFs of MiLogHotPatchPagesLocked @ 0x1407E4494
 * Callers:
...
char __fastcall MiLogHotPatchPagesLocked(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    ...
    v10 = *(_QWORD *)&qword_140E372D8;
    Process = CurrentThread->ApcState.Process;
    if ( **(_DWORD **)&qword_140E372D8 > 5u )
    {
      LOBYTE(CurrentThread) = tlgKeywordOn(*(__int64 *)&qword_140E372D8, 0x400000000020LL);
