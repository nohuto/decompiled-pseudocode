/*
 * XREFs of DifExInitializeFastOwnerEntryWrapper @ 0x140612720
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExInitializeFastOwnerEntryWrapper(__int64 a1)
{
  ...
  v10 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(445);
