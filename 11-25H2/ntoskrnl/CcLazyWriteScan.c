/*
 * XREFs of CcLazyWriteScan @ 0x1404BE770
 * Callers:
 ...
 *     CcAdjustThrottleForPartition @ 0x140576ECC (CcAdjustThrottleForPartition.c)
 */

void __fastcall CcLazyWriteScan(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  int v8; // r12d
...
LABEL_77:
  ...
  *(_QWORD *)(a2 + 216) = MEMORY[0xFFFFF78000000014];
  ...
  while ( v31 != v32 && v31 + 136 != v30 )
  {
    ...
    if ( CcShouldLazyWriteCacheMap(v31, a1, 0LL, v29, *(_QWORD *)(v31 + 96) & 0xFFFFFFFFFFFFFFF0uLL, v62) )
    {
      ...
      *(_DWORD *)(v31 + 152) |= 0x20u;
      ++*(_DWORD *)(v31 + 112);
      KeReleaseInStackQueuedSpinLock(&LockHandle);
      WorkQueueEntry = CcAllocateWorkQueueEntry(a1, 0LL, v34, (PSLIST_ENTRY *)&v70);
  ...
  v61 = 0LL;
  v73 = 0LL;
  if ( !(_BYTE)dword_140FC420C && !v59 && *(_QWORD *)(a1 + 1168) == a1 + 1168 )
  {
