/*
 * XREFs of CmpCreateRootNode @ 0x140C35CA4
 * Callers:
...
__int64 __fastcall CmpCreateRootNode(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  v6 = HvAllocateCell(v3, (unsigned int)v5 + 76, 0, &v14, &v13, (__int64)&v16);
  if ( v6 < 0 )
  {
    v7 = v13;
  }
  else
  {
    ...
    *(_BYTE *)(v7 + 55) = 0;
    *(_DWORD *)(v7 + 56) = 0;
    v8 = CmpCopyName((_BYTE *)(v7 + 76), (const void **)&DestinationString);
    *(_WORD *)(v7 + 72) = v8;
