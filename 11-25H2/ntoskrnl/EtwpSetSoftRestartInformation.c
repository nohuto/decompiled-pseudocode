/*
 * XREFs of EtwpSetSoftRestartInformation @ 0x140A3FC08
 * Callers:
...
__int64 __fastcall EtwpSetSoftRestartInformation(__int64 a1, unsigned int a2)
{
  ...
  *((_QWORD *)&v14 + 1) = a1 + 18;
  ...
  if ( (_WORD)a2 == 18 || (result = EtwpCaptureString((unsigned __int16 *)&v14, &DestinationString), (int)result >= 0) )
  {
    ...
    v7 = EtwpAcquireLoggerContextByLoggerId(EtwpHostSiloState, v5, 1u);
    v8 = v7;
    if ( !v7 )
    {
      v9 = -1073741162;
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( !v12 )
      {
        if ( v10 && *(_BYTE *)(v10 + 32) )
        {
          ...
          RtlFreeAnsiString((PUNICODE_STRING)(v10 + 16));
          *(_BYTE *)(v10 + 32) = 0;
          v9 = 0;
        }
        else
