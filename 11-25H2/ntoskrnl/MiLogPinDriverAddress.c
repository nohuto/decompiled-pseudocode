/*
 * XREFs of MiLogPinDriverAddress @ 0x140A2F7F4
 * Callers:
...
void __fastcall MiLogPinDriverAddress(_QWORD *a1)
{
  ...
  {
    if ( (*(_QWORD *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 0x400000000000LL) == 0
      || (v8 = 1,
    ...
    if ( v8 )
    {
      ...
      *(_QWORD *)&DestinationString.Length = 2164260864LL;
      ...
      v50 = 8LL;
      tlgWriteAgg(
        *(__int64 *)&qword_140E372D8,
        (unsigned __int8 *)byte_14005729B,
        *(__int64 *)&qword_140E372D8,
        0x10u,
        (__int64)v22);
    }
