/*
 * XREFs of MiLogSlabEntryAllocateFailure @ 0x1403BC0C0
 * Callers:
 ...
 *     MiNodeAvailablePages @ 0x1403BC440 (MiNodeAvailablePages.c)
...
void __fastcall MiLogSlabEntryAllocateFailure(__int64 a1, int a2, int a3, int a4, char a5)
{
  ...
  {
    v8 = (unsigned __int64)qword_140E373C0;
    v12 = qword_140E373C0[v9];
    if ( v11 <= v12 )
    {
      v11 = 0LL;
      goto LABEL_27;
