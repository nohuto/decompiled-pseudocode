/*
 * XREFs of _CmGetDeviceCompoundFiltersWorker @ 0x140A7D238
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  const WCHAR *v37; // [rsp+F0h] [rbp+57h]
...
LABEL_8:
    ...
    && v31 == 8210 )
  {
    ...
    ObjectProperty = PnpGetObjectProperty(a1, v37, 1u, a3, 0LL, v34, &v31, Pool2, v36, (__int64)&v36, 0);
    if ( ObjectProperty < 0 )
      goto LABEL_48;
    v22 = (__int64)v38;
    goto LABEL_15;
...
LABEL_53:
  ...
  ObjectProperty = PnpGetObjectProperty(a1, v37, 1u, v26, 0LL, (__int64)v32, &v31, v27, v36, (__int64)&v36, 0);
  if ( ObjectProperty >= 0 )
  {
LABEL_29:
...
LABEL_44:
    ...
    if ( ObjectProperty < 0 )
      goto LABEL_44;
    v22 = (__int64)v38;
    PnpSetObjectProperty((__int64)a1, (__int64)v37, 1, (__int64)v38, 0LL, v34, 8210, (__int64)v14, v36, 0);
LABEL_15:
