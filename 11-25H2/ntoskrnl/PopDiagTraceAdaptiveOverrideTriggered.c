/*
 * XREFs of PopDiagTraceAdaptiveOverrideTriggered @ 0x140749428
 * Callers:
...
void PopDiagTraceAdaptiveOverrideTriggered()
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v9 = 0x1000000LL;
    v27 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)&word_14004ADDE, 0LL, 0LL, 8u, &v10);
  }
}
