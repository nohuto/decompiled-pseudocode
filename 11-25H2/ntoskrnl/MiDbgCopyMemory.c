/*
 * XREFs of MiDbgCopyMemory @ 0x140672C90
 * Callers:
 ...
 *     MiAllocateDbgPatches @ 0x1406725E8 (MiAllocateDbgPatches.c)
 ...
 *     MiDbgPatchIdentity @ 0x1406736E0 (MiDbgPatchIdentity.c)
 ...
 *     MiFillDbgPatches @ 0x1406741AC (MiFillDbgPatches.c)
...
LABEL_57:
  ...
  if ( MmIsAddressValidEx((__int64)a1) )
  {
    if ( (a5 & 0x41) != 0 && (MiFlags & 0x10000000) != 0 )
    {
      ...
      v15 = 6 * v14.QuadPart;
      if ( v14.QuadPart <= (unsigned __int64)qword_140E2D9A0 )
