/*
 * XREFs of MiInitializeDynamicBitmap @ 0x14066DC0C
 * Callers:
...
__int64 __fastcall MiInitializeDynamicBitmap(__int64 a1, unsigned __int64 a2, __int64 a3, char a4)
{
  ...
  bool v26; // zf
  __int64 v27; // rax
  unsigned __int8 v28; // [rsp+30h] [rbp-98h] BYREF
  unsigned __int8 v29; // [rsp+31h] [rbp-97h]
  ...
  *(_OWORD *)a1 = 0LL;
  ...
  if ( (a4 & 2) != 0 )
  {
    v8 = qword_140E37100[0];
    v9 = qword_140E37130;
  }
  else
  {
    v8 = (PVOID)qword_140E37138;
    v9 = qword_140E37168;
  }
  v10 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( (v5 & 0xFFF) == 0 && (a4 & 4) != 0 && v6 - v12 >= 0x200 )
    {
      ...
      v19 = MiLockWorkingSetOptimal((__int64)v17, v18, &v28, (__int64)v17);
      v20 = *(_QWORD *)v18;
      v21 = v19;
      ...
      v13 = (char *)qword_140E2FD48;
      v33 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v22 + 40) >> 43) & 0x3FFLL));
      v15 = v28;
      v29 = v28;
    ...
    v23 = MiLockWorkingSetOptimal((__int64)v17, v5, &v28, (__int64)v17);
    LOBYTE(v14) = v28;
    v16 = v23;
    v29 = v28;
LABEL_18:
