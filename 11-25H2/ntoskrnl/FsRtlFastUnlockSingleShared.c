        ...
        char a9)
{
  ...
  RTL_SPLAY_LINKS *v21; // rsi
  _SLIST_ENTRY *Next; // rdi
  __int64 v23; // rdx
  RTL_SPLAY_LINKS *v24; // r15
  struct _SLIST_ENTRY **p_Next; // r14
  struct _SLIST_ENTRY *v26; // r12
  ...
  struct _SLIST_ENTRY *v38; // rdi
  unsigned __int64 v39; // rax
  _SLIST_ENTRY *v40; // rax
  KIRQL v41; // di
  ULONG_PTR v42; // r9
  __int64 v43; // r8
  RTL_SPLAY_LINKS *v45; // rcx
  size_t v46; // r8
  size_t v47; // r8
  ...
  struct _SLIST_ENTRY **v57; // [rsp+40h] [rbp-48h]
...
LABEL_86:
  ...
  v23 = a5;
  v24 = v21 - 1;
  p_Next = (struct _SLIST_ENTRY **)&v21[-1];
  while ( 1 )
  {
    v26 = *p_Next;
    if ( !*p_Next )
...
LABEL_66:
  ...
  if ( *(struct _SLIST_ENTRY **)(a2 + 120) == (struct _SLIST_ENTRY *)(&v26->Next + 1) )
    *(_QWORD *)(a2 + 120) = 0LL;
  if ( *p_Next == (struct _SLIST_ENTRY *)v21[1].Parent )
    v21[1].Parent = (_RTL_SPLAY_LINKS *)p_Next;
  *p_Next = v26->Next;
  v27 = CmSiFreeMemory;
  v28 = 0xFFFF800000000000uLL;
  v29 = 0x800000000000LL;
  if ( p_Next == (struct _SLIST_ENTRY **)v24 )
  {
    if ( v24->Parent )
    {
      v30 = SpinLock;
    ...
    else
    {
      ...
      else
      {
        if ( (void (__stdcall *)(PPRIVILEGE_SET))FsRtlLockTreeNodeLookasideList.L.FreeEx == CmSiFreeMemory )
        {
          ...
          if ( byte_140FCDC68 )
          {
            ...
            if ( p_LeftChild + v33 < p_LeftChild )
              KeBugCheckEx(0x1F1u, 2uLL, 3uLL, p_LeftChild, FsRtlLockTreeNodeLookasideList.L.Size - 8LL);
        ...
        RtlpInterlockedPushEntrySList(&FsRtlLockTreeNodeLookasideList.L.ListHead, (PSLIST_ENTRY)&v21[-1]);
      }
      v24 = 0LL;
      v27 = CmSiFreeMemory;
      v28 = 0xFFFF800000000000uLL;
  ...
  if ( LOBYTE(v24->LeftChild) )
  {
    ...
    p_Next = (struct _SLIST_ENTRY **)v24;
  ...
  while ( 1 )
  {
    ...
    if ( !*p_Next )
      break;
    if ( (struct _SLIST_ENTRY *)v24->Parent != v38 )
    {
      v39 = *((_QWORD *)&v38->Next + 1);
      if ( v39 <= (unsigned __int64)v34 || !v38[1].Next && v39 == v35 )
        goto LABEL_41;
      v48 = (_RTL_SPLAY_LINKS *)ExAllocateFromNPagedLookasideList(&FsRtlLockTreeNodeLookasideList);
      v57 = (struct _SLIST_ENTRY **)v48;
      v49 = (struct _SLIST_ENTRY **)v48;
      if ( v48 )
      {
        v51 = v48 + 1;
        v48[1].LeftChild = 0LL;
        ...
        v51->Parent = v52;
        v38 = (struct _SLIST_ENTRY *)v49;
        *v49 = *p_Next;
        *p_Next = 0LL;
        v49[6] = (struct _SLIST_ENTRY *)v24[2].Parent;
        v53 = (struct _SLIST_ENTRY *)v24->RightChild;
...
LABEL_46:
  ...
  else
  {
    if ( (void (__stdcall *)(PPRIVILEGE_SET))FsRtlSharedLockLookasideList.L.FreeEx == v27 )
    {
      ...
      v43 = FsRtlSharedLockLookasideList.L.Size - 8LL;
      if ( byte_140FCDC68 )
      {
        if ( v42 < v28 )
        ...
        if ( v42 + v43 < v42 )
          KeBugCheckEx(0x1F1u, 2uLL, 3uLL, v42, FsRtlSharedLockLookasideList.L.Size - 8LL);
        v46 = (v43 - (unsigned __int64)((LOBYTE(FsRtlSharedLockLookasideList.L.Size) - 9) & 7) + 7) >> 3;
        if ( v46 )
        {
          LOBYTE(v23) = -116;
    ...
    RtlpInterlockedPushEntrySList(&FsRtlSharedLockLookasideList.L.ListHead, v26);
  }
  if ( a9 && v30[3] )
