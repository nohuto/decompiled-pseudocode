/*
 * XREFs of EtwpUpdateGlobalGroupMasks @ 0x1408DBCB4
 * Callers:
...
LABEL_11:
          ...
          if ( v16 )
          {
            ...
            do
            {
              *(_DWORD *)v29 |= *(_DWORD *)((char *)v29 + v28 + 4252);
...
LABEL_16:
    ...
    do
    {
      *(_DWORD *)v19 |= *(_DWORD *)((char *)v19 + v18 + 4252);
    ...
    if ( v25 < 0 )
    {
      do
      {
        v30 = ~*(_DWORD *)((char *)v12 + (_QWORD)&v33 - a1 - 4252);
        *v12 &= v30;
        v12[8 * v3 + 8] &= v30;
        *(_DWORD *)((char *)v12++ + (_QWORD)&v31 - a1 - 4252) &= v30;
        --v6;
      }
      while ( v6 );
    }
