/*
 * XREFs of MiFindPageFileWriteCluster @ 0x1403D9914
 * Callers:
 ...
 *     RtlFindLongestRunClearCapped @ 0x1403DB380 (RtlFindLongestRunClearCapped.c)
...
unsigned int *__fastcall MiFindPageFileWriteCluster(__int64 a1, unsigned int *a2, unsigned int *a3, int a4)
{
  ...
  else
  {
    ...
    else
    {
      v20 = *(_DWORD *)(a1 + 96);
      v19 = *(_DWORD *)(a1 + 92);
      if ( v19 < dword_140FC41FC && *(_DWORD *)(a1 + 100) != v20 )
      {
        if ( v19 >= (unsigned int)dword_140FC41FC >> 3 )
        {
          v24 = v19 + (v19 >> 1);
          v19 = dword_140FC41FC;
          if ( v24 < dword_140FC41FC )
            v19 = v24;
        }
        else
        {
