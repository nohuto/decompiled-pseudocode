/*
 * XREFs of IopCompleteIoRingEntry @ 0x1402A2AE0
 * Callers:
...
LONG __fastcall IopCompleteIoRingEntry(__int64 a1, __int64 a2, _OWORD *a3, KPRIORITY a4)
{
  int *v4; // r14
  ...
  result = KxReleaseSpinLock(a1 + 104);
  if ( v14 )
