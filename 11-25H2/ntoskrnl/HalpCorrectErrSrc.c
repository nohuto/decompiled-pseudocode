/*
 * XREFs of HalpCorrectErrSrc @ 0x140B3B800
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpCorrectNMIErrSrc @ 0x140541490 (HalpCorrectNMIErrSrc.c)
 *     HalpCorrectGenericErrSrc @ 0x140551DD0 (HalpCorrectGenericErrSrc.c)
