/*
 * XREFs of HalpSetWakeAlarm @ 0x14042D9F8
 * Callers:
...
__int64 __fastcall HalpSetWakeAlarm(__int64 a1, unsigned __int8 *a2)
{
  ...
  if ( (unsigned __int8)byte_140FC05AA > 9u )
  {
    v10 = a2[4];
    __outbyte(0x70u, byte_140FC05AA);
    v6 = v10 / 0xA;
    v7 = v10 % 0xA;
    __outbyte(0x71u, v7 + 16 * v6);
    if ( (unsigned __int8)byte_140FC05AB > 9u )
    {
      v11 = a2[2];
      __outbyte(0x70u, byte_140FC05AB);
      v6 = v11 / 0xA;
      v7 = v11 % 0xA;
      __outbyte(0x71u, v7 + 16 * v6);
    }
