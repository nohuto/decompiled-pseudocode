/*
 * XREFs of PopTracePowerButtonSuppressionOptedIn @ 0x140C1EEA8
 * Callers:
...
void __fastcall PopTracePowerButtonSuppressionOptedIn(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
  {
    ...
    v24 = 4LL;
    v13 = 0x1000000LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07680, (unsigned __int8 *)word_140048EEA, 0LL, 0LL, 8u, &v14);
  }
}
