...
char __fastcall EtwTimLogControlProtectionKernelModeReturnMismatch(int a1, __int64 a2)
{
  ...
  unsigned __int64 v22; // [rsp+78h] [rbp+18h] BYREF
  unsigned __int64 v23; // [rsp+80h] [rbp+20h] BYREF
  ...
  __int64 v33; // [rsp+D0h] [rbp+70h] BYREF
  ...
  if ( a1 == 1 )
  {
    ...
    v31.Buffer = v17;
    Length = 0;
    if ( (int)RtlPcToFileName(v22, &v31) >= 0 )
      Length = v31.Length;
    Buffer = v31.Buffer;
    v6 = 6;
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = 0;
    if ( (int)RtlPcToFileName(v23, &v32) >= 0 )
      v11 = v32.Length;
    v42 = &v18;
    v43 = 2LL;
    if ( v11 )
