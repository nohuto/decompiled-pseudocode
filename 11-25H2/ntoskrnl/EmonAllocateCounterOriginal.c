/*
 * XREFs of EmonAllocateCounterOriginal @ 0x1405582CC
 * Callers:
 *     EmonEnableMonitoringOriginal @ 0x140558AC0 (EmonEnableMonitoringOriginal.c)
 * Callees:
 *     HalpAllocateHalCounters @ 0x14053BB38 (HalpAllocateHalCounters.c)
 *     EmonAllocateCounterInternal @ 0x140558210 (EmonAllocateCounterInternal.c)
 *     EmonFindCounterToAllocateOriginal @ 0x140558D24 (EmonFindCounterToAllocateOriginal.c)
 */
