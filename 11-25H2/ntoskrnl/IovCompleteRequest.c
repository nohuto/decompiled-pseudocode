/*
 * XREFs of IovCompleteRequest @ 0x140B96788
 * Callers:
...
void __fastcall IovCompleteRequest(IRP *BugCheckParameter3, CCHAR a2)
{
  __int64 v4; // rdx
  ...
  __int128 v11; // [rsp+48h] [rbp-51h]
  __int64 v12; // [rsp+58h] [rbp-41h]
  void *v13; // [rsp+60h] [rbp-39h]
  _QWORD v14[3]; // [rsp+68h] [rbp-31h] BYREF
  ...
  LOBYTE(v4) = a2;
  v13 = retaddr;
  IovpCompleteRequest1(BugCheckParameter3, v4, &v10);
  if ( (!IovpDisabledWithoutReboot || v10) && BugCheckParameter3->CurrentLocation <= BugCheckParameter3->StackCount )
  {
...
LABEL_13:
  if ( (IopFunctionPointerMask & 2) != 0 )
    IopPerfCompleteRequest((__int64)BugCheckParameter3, a2, v7);
  else
    IopfCompleteRequest(BugCheckParameter3, a2, v7);
}
