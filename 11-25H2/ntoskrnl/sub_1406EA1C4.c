/*
 * XREFs of sub_1406EA1C4 @ 0x1406EA1C4
 * Callers:
...
__int64 __fastcall sub_1406EA1C4(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // rax
  unsigned int i; // edx
  __int64 v8; // r8
  ...
  v12 = guard_dispatch_icall_no_overrides(v9);
  if ( (v12 & 0x80000000) != 0 )
    return v12;
  v13 = *(_DWORD *)(a2 + 32);
