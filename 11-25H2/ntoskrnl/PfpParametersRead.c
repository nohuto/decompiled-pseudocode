/*
 * XREFs of PfpParametersRead @ 0x14073C2B4
 * Callers:
...
__int64 __fastcall PfpParametersRead(__int64 a1)
{
  ...
  LODWORD(v14) = 4;
  PfpGetParameter(v2, L"SavedPageAccessTracesMax", 4, (char *)&v15 + 12, (unsigned int *)&v14);
  v6 = *(void **)(a1 + 8);
  LODWORD(v14) = 4;
  PfpGetParameter(v6, L"PrefetchTimeoutStandby", 4, &v16, (unsigned int *)&v14);
  v7 = *(void **)(a1 + 8);
  LODWORD(v14) = 4;
  PfpGetParameter(v7, L"PrefetchTimeoutHibernate", 4, (char *)&v16 + 4, (unsigned int *)&v14);
  v8 = *(void **)(a1 + 8);
  LODWORD(v14) = 4;
  PfpGetParameter(v8, L"PrefetchTimeoutHiberBoot", 4, &v17, (unsigned int *)&v14);
  if ( (int)v15 >= 0 )
    v9 = (v15 & 0xFFFFFFFC) == 0;
  else
