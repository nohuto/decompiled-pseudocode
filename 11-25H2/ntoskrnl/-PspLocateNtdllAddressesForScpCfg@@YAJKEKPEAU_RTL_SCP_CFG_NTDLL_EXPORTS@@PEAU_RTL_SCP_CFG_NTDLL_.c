/*
 * XREFs of ?PspLocateNtdllAddressesForScpCfg@@YAJKEKPEAU_RTL_SCP_CFG_NTDLL_EXPORTS@@PEAU_RTL_SCP_CFG_NTDLL_EXPORTS_ARM64EC@@@Z @ 0x140C25084
 * Callers:
 ...
 *     MmGetScpCfgFunctionOffset @ 0x140A6A10C (MmGetScpCfgFunctionOffset.c)
