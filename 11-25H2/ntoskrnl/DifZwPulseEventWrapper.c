/*
 * XREFs of DifZwPulseEventWrapper @ 0x140637CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPulseEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(62);
  ...
  if ( APIThunkContextById )
  {
    ...
    v7 = 0;
    *(_QWORD *)&v14 = EventHandle;
    *((_QWORD *)&v13 + 1) = PreviousState;
  ...
  DWORD2(v14) = ZwPulseEvent(EventHandle, PreviousState);
  if ( v5 )
  {
