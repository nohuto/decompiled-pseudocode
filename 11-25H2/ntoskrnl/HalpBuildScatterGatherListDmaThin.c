/*
 * XREFs of HalpBuildScatterGatherListDmaThin @ 0x1403E5120
 * Callers:
 *     HalBuildScatterGatherListDmaThinEx @ 0x1403E5070 (HalBuildScatterGatherListDmaThinEx.c)
 *     HalGetScatterGatherListDmaThinEx @ 0x14054ED40 (HalGetScatterGatherListDmaThinEx.c)
 * Callees:
...
LABEL_35:
        *(_DWORD *)v33 = v36;
        ...
        if ( v41 )
          guard_dispatch_icall_no_overrides(*((_QWORD *)v32 + 4), *((_QWORD *)v32 + 5));
        if ( v16 >= 0 )
        {
          if ( a13 )
            *a13 = P;
