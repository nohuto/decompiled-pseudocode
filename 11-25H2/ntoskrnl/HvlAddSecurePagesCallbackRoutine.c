/*
 * XREFs of HvlAddSecurePagesCallbackRoutine @ 0x1405867B8
 * Callers:
 ...
 * Callees:
 *     HvlpAddCrashdumpAreaPages @ 0x140587004 (HvlpAddCrashdumpAreaPages.c)
...
__int64 __fastcall HvlAddSecurePagesCallbackRoutine(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(a4 + 8) = 0;
  ...
  xmmword_140F8D850 = 0LL;
  xmmword_140F8D860 = 0LL;
  result = HvlpStartSecurePageListIteration(1LL, v4, 0LL, 0LL, 0, &v15);
  if ( (int)result < 0 )
    return result;
  *((_QWORD *)&xmmword_140F8D860 + 1) = v15;
      ...
      || (LOBYTE(v8) = 1, result = HvlpAddCrashdumpAreaPages(a4, v8), !(_BYTE)result) )
    {
      if ( BYTE2(HvlpCrashdumpIterationState) || (result = HvlpAddCrashdumpAreaPages(a4, 0LL), !(_BYTE)result) )
      {
        if ( !v9 || v6 == 2 || v6 == 8 || (v6 == 1 || v6 == 16) && *(_DWORD *)(a4 + 12) == 395 )
        {
          do
          {
            while ( !(_DWORD)xmmword_140F8D860 )
            {
              LOBYTE(v14) = 0;
              if ( (int)VslGetSecurePageList(0LL, 0LL, 0LL, &v14) < 0 )
                goto LABEL_27;
              LODWORD(xmmword_140F8D860) = *(unsigned __int16 *)(*((_QWORD *)&xmmword_140F8D860 + 1) + 8LL);
              *((_QWORD *)&xmmword_140F8D850 + 1) = *((_QWORD *)&xmmword_140F8D860 + 1) + 16LL;
            }
            *(_QWORD *)(a4 + 24) = (**((_QWORD **)&xmmword_140F8D850 + 1) >> 40) + 1LL;
            result = 0xFFFFFFFFFFLL;
            *(_QWORD *)(a4 + 16) = **((_QWORD **)&xmmword_140F8D850 + 1) & 0xFFFFFFFFFFLL;
            *((_QWORD *)&xmmword_140F8D850 + 1) += 8LL;
            LODWORD(xmmword_140F8D860) = xmmword_140F8D860 - 1;
          }
          while ( !*(_QWORD *)(a4 + 24) );
