/*
 * XREFs of KeInitThread @ 0x140B59400
 * Callers:
 ...
 *     KeAbInitializeThreadState @ 0x1404506D4 (KeAbInitializeThreadState.c)
 *     KeInitializeTimer @ 0x140454D20 (KeInitializeTimer.c)
 *     KiGetIdealNodeProcessByGroup @ 0x14048C11C (KiGetIdealNodeProcessByGroup.c)
...
__int64 __fastcall KeInitThread(__int64 a1, __int64 a2)
{
  ...
  _DWORD v29[2]; // [rsp+98h] [rbp-70h] BYREF
...
LABEL_25:
  if ( KernelStack < 0 )
  {
    if ( v34 )
    {
      ...
      v32 = *(_QWORD *)(a1 + 56);
      v31 = a1;
      MmDeleteKernelStack((__int64)v29);
      *(_QWORD *)(a1 + 40) = 0LL;
    }
    if ( (*v7 & 0x800000) != 0 )
