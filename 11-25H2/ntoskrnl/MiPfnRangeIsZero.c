/*
 * XREFs of MiPfnRangeIsZero @ 0x14066276C
 * Callers:
...
LABEL_37:
      ...
      if ( a1 >= a2 )
      {
        MiFreeLargeZeroPages((__int64)&MiSystemPartition, (__int64)v26, 0);
        MiReleaseNonPagedResources((__int64)&MiSystemPartition, v6);
        _InterlockedAdd64(&qword_140E373B8, -(__int64)v6);
        return;
      }
    }
    if ( (*(_QWORD *)v9 & 0x20) != 0 && ((unsigned __int8)(1 << v7) & (unsigned __int8)byte_140E2D889) != 0 )
    {
    ...
    v15 = v8;
    v25 = v8;
    v16 = (__int64 *)&qword_140E37100[v8];
LABEL_21:
    if ( (int)v8 < 3 )
    {
      v17 = *(_QWORD *)v9;
      if ( (_DWORD)v8 != v15 && (v17 & 0x20) != 0 && ((unsigned __int8)(1 << v8) & (unsigned __int8)byte_140E2D889) != 0 )
        MiClearSystemAccessBits(v9);
