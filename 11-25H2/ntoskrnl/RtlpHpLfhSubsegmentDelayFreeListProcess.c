/*
 * XREFs of RtlpHpLfhSubsegmentDelayFreeListProcess @ 0x1403C7060
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentSetWitheldBlocks @ 0x1402F739C (RtlpHpLfhSubsegmentSetWitheldBlocks.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentDelayFreeListProcess(ULONG_PTR *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  __int16 v34; // [rsp+98h] [rbp+20h]

  v4 = a2 >> 12;
  v6 = a3 >> 16;
  v7 = *(_BYTE *)(a2 + 51) & 1;
  v8 = *(unsigned __int16 *)(a2 + 34);
  v9 = *(_DWORD *)(a2 + 40) ^ (unsigned int)qword_140E27FC8 ^ (unsigned int)(a2 >> 12);
  ...
  if ( v8 != (_DWORD)result )
  {
    if ( *(_BYTE *)(a2 + 39) == 1 && !v7 )
    {
      ...
      {
        result = RtlpHpLfhSubsegmentDelayFreeListBatch((_DWORD)a1, a2, a3, v12, v10);
LABEL_22:
        *(_WORD *)(a2 + 32) += v6;
        return result;
      }
...
LABEL_3:
    ...
    if ( (_WORD)a3 )
    {
      do
      {
        ...
        if ( !v7 && *(_BYTE *)(a2 + 39) > 1u )
        {
          ...
          LODWORD(v4) = -1;
          v22 = *(unsigned __int16 *)(a2 + 40) ^ v21 ^ (unsigned __int16)qword_140E27FC8;
          v23 = 0;
  ...
  if ( *(_BYTE *)(a2 + 39) != 1 )
    goto LABEL_3;
  RtlpHpLfhBlockBitmapInitialize((void *)(a2 + 64), v8 + *(unsigned __int8 *)(a2 + 37));
  v30 = *(_BYTE *)(a2 + 37) == 0;
  *(_BYTE *)(a2 + 36) = 0;
  if ( !v30 )
