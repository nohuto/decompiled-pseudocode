/*
 * XREFs of PfGetCompletedTrace @ 0x14093A5D4
 * Callers:
 ...
 *     PfpPartitionRundownProtectionRelease @ 0x140471A7C (PfpPartitionRundownProtectionRelease.c)
...
__int64 __fastcall PfGetCompletedTrace(_QWORD *a1, unsigned int a2, char a3, unsigned int *a4)
{
  ...
  else
  {
    ...
    if ( v7 )
    {
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)byte_140047B71, 0LL, 0LL, 2u, v35);
      a1 = Address;
      a4 = v26;
      a3 = v21;
    }
      ...
      if ( v9 >= 0 )
      {
        ...
        if ( v6 )
        {
          ...
          *(_OWORD *)Address = 0LL;
          v18[2] = 0LL;
          *(_DWORD *)v18 = 1572866;
          v30 = (_QWORD *)qword_140E66CC8;
          v18[1] = ((MEMORY[0xFFFFF78000000004] * HIDWORD(qword_140E66CC8)) << 8)
                 + ((MEMORY[0xFFFFF78000000004] * (unsigned __int64)(unsigned int)qword_140E66CC8) >> 24);
          v18[2] = v34;
...
LABEL_29:
  ...
  if ( (unsigned int)dword_140E074B8 > 4 )
  {
    ...
    if ( v8 )
    {
      ...
      v40 = 4;
      v41 = 0;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)byte_140047AD3, 0LL, 0LL, 4u, v35);
    }
  }
  if ( v5 )
