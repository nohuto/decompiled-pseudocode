/*
 * XREFs of AlpcpReplyLegacySynchronousRequest @ 0x1409F1EF0
 * Callers:
    ...
    if ( v11 != v4 )
    {
      if ( (v10 & 7) == 0 )
      {
        ...
        if ( !v12 )
          goto LABEL_63;
        v13 = *(_QWORD **)(v12 + 16);
        v14 = KeAbPreAcquire((__int64)(v13 - 2), 0LL);
        v37 = v14;
        if ( _InterlockedCompareExchange64(v13 - 2, 17LL, 0LL) )
        {
          ExfAcquirePushLockSharedEx(v13 - 2, 0, v14, (unsigned __int64)(v13 - 2));
          v14 = v37;
        }
        if ( v14 )
          *((_BYTE *)v14 + 10) = 1;
      ...
      if ( v7 >= 0 )
      {
        ...
        *(_DWORD *)(v22 + 40) |= 0x1000u;
        ...
        if ( (v19[6] & 4) != 0 )
          ...
          KeReleaseSemaphoreEx((volatile signed __int32 *)(v28 + 1304), 1, 1, v29, 0, 0LL);
        return v32;
      }
      else
      {
