/*
 * XREFs of PiQueryRemovableDeviceOverride @ 0x14082E4B8
 * Callers:
...
LABEL_23:
  ...
  *(_BYTE *)(a1 + 680) = v11 | 1;
  ...
  LODWORD(v30) = 2490404;
  *((_QWORD *)&v30 + 1) = L"ChildLocationPaths";
  DeviceRegProp = PnpDeviceObjectToDeviceInstance(*(_QWORD *)(v17 + 32), &v35, 131097LL);
  if ( DeviceRegProp < 0 )
    return (unsigned int)DeviceRegProp;
  v37[0] = 2;
  v18 = v37;
...
LABEL_44:
    ...
    if ( LODWORD(Handle[1]) != 1
      || (*(_DWORD *)&ValueName.Length = 262146,
          ...
          DeviceRegProp < 0) )
    {
      DeviceRegProp = PnpGetDeviceLocationStrings((PVOID *)a1, &P, &v33);
      if ( DeviceRegProp < 0
