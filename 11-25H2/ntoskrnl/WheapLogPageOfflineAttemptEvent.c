/*
 * XREFs of WheapLogPageOfflineAttemptEvent @ 0x1407B8DC0
 * Callers:
...
NTSTATUS __fastcall WheapLogPageOfflineAttemptEvent(__int64 a1, char a2, char a3, char a4, char a5)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v20 = &v12;
  v12 = a4 != 0;
  return EtwWrite((REGHANDLE)WheapDispatchPtr.Dpc.DeferredRoutine, &EVENT_WHEA_MEMORY_OFFLINE, 0LL, 5u, &UserData);
}
