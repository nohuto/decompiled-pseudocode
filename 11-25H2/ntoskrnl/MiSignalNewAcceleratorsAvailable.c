/*
 * XREFs of MiSignalNewAcceleratorsAvailable @ 0x140685874
 * Callers:
...
void __fastcall MiSignalNewAcceleratorsAvailable(__int64 *a1)
{
  ...
  if ( !byte_140E37214 )
  {
    ...
    {
      v4 = *a1;
      if ( (__int64 *)*a1 == a1 || word_140E2D8AA == -1 )
        break;
      if ( *(__int64 **)(v4 + 8) != a1 )
        goto LABEL_17;
      v5 = *(_QWORD *)v4;
      ...
      *(_QWORD *)(v5 + 8) = a1;
      ...
      v7 = *(_QWORD *)(384 * v6 + qword_140E2D8B8 + 376);
...
LABEL_17:
      ...
      *((_BYTE *)&v30 + (v6 >> 3)) |= 1 << (v6 & 7);
      v8 = (__int64 *)qword_140E37208;
      if ( *(__int64 **)qword_140E37208 != &qword_140E37200 )
        goto LABEL_17;
      *(_QWORD *)(v4 + 8) = qword_140E37208;
      *(_QWORD *)v4 = &qword_140E37200;
      *v8 = v4;
      qword_140E37208 = v4;
      ++dword_140E37210;
      ++*(_WORD *)(v7 + 18);
  ...
  MiReleaseSpinLockExclusive(&dword_140E37228, v3);
  while ( 1 )
  {
    v10 = (__int64 *)*a1;
    if ( (__int64 *)*a1 == a1 )
