/*
 * XREFs of KiConfigureCooperativeIdleSearchContextTargets @ 0x1405B2998
 * Callers:
 ...
 *     KiAddSubNodeToIdleSearchContextTargets @ 0x1405B19DC (KiAddSubNodeToIdleSearchContextTargets.c)
