/*
 * XREFs of KiComputeCpuSetAffinity @ 0x1402724D0
 * Callers:
 ...
 *     KiCopyGroupMasksToAffinityEx @ 0x140405EA0 (KiCopyGroupMasksToAffinityEx.c)
...
LABEL_68:
  ...
  if ( (unsigned int)KiAndAffinityEx(&v56, a2, a2, a2->Size) )
      ...
      *((_QWORD *)v48 + 1) = 0LL;
      ...
      if ( v49 )
      {
        ...
        do
        {
          ...
          v50 |= *((_QWORD *)KiCpuSetAffinities + 64 * v47 + (unsigned int)v51);
