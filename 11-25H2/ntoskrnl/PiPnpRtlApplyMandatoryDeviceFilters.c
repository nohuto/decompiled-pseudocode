/*
 * XREFs of PiPnpRtlApplyMandatoryDeviceFilters @ 0x1408CF5C0
 * Callers:
 ...
 *     PiPnpRtlApplyMandatoryDeviceContainerFiltersCallback @ 0x140A5C790 (PiPnpRtlApplyMandatoryDeviceContainerFiltersCallback.c)
 * Callees:
        ...
        _BYTE *a5)
{
  ...
  const WCHAR *v15; // r13
  __int64 v16; // rbx
  __int64 (__fastcall *v17)(PVOID, const WCHAR *, int, int, int, __int64); // r12
  int v18; // eax
  int v19; // r14d
  _QWORD *SessionById; // rax
  __int64 v22; // rdi
  __int64 (__fastcall *v23)(PVOID, const WCHAR *, int, int, int, __int64); // rdi
  int v24; // eax
  int v25; // eax
  int v26; // eax
...
LABEL_5:
  ...
  v32 = 0LL;
  v33 = 0LL;
  v23 = (__int64 (__fastcall *)(PVOID, const WCHAR *, int, int, int, __int64))a1[61];
  v38 = &v30;
  v40 = (ULONG *)&v31;
  v39 = 4LL;
  v41 = 0LL;
  ...
  if ( v23 )
  {
    if ( v23 == PiPnpRtlObjectActionCallback )
      v24 = PiPnpRtlObjectActionCallback(a1, a2, 1, 8, 1, (__int64)&v32);
    else
...
LABEL_59:
  ...
  if ( v23 )
  {
    ...
    v28 = v23 == PiPnpRtlObjectActionCallback
        ? PiPnpRtlObjectActionCallback(a1, a2, 1, 8, 2, (__int64)&v32)
...
LABEL_6:
  ...
  *a5 = 0;
  while ( 1 )
  {
    ...
    v34 = v42;
    v29 = 0;
    v17 = *(__int64 (__fastcall **)(PVOID, const WCHAR *, int, int, int, __int64))(*(_QWORD *)&PiPnpRtlCtx + 488LL);
    v37 = &v30;
    v40 = (ULONG *)&v29;
    ...
    if ( v17 )
    {
      if ( v17 == PiPnpRtlObjectActionCallback )
        v18 = PiPnpRtlObjectActionCallback(*(PVOID *)&PiPnpRtlCtx, v15, 1, 8, 1, (__int64)&v32);
      else
        v18 = guard_dispatch_icall_no_overrides(*(_QWORD *)&PiPnpRtlCtx);
      if ( v18 == -1073741822 )
      {
        v17 = 0LL;
      }
    ...
    v25 = PnpGetObjectPropertyWorker(v16, (__int64)v15, 1, v34, v35, (__int64)v36, v37, v38, v39, v40, v41);
    v11 = v25;
    if ( v17 )
    {
      LODWORD(v32) = v25;
      v26 = v17 == PiPnpRtlObjectActionCallback
          ? PiPnpRtlObjectActionCallback(v31, v15, 1, 8, 2, (__int64)&v32)
