/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x140701350
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x140701350 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
        ...
        BOOLEAN LeadingBackslashPermissible)
{
  ...
  __m128i v12; // xmm1
  unsigned int i; // r8d
  STRING FirstName; // [rsp+20h] [rbp-38h] BYREF
  STRING RemainingName; // [rsp+30h] [rbp-28h] BYREF
    ...
    for ( i = 0; i < Length; ++i )
    {
      ...
      if ( (unsigned __int8)v7 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && *((_WORD *)NlsOemLeadByteInfo + v7) )
      {
        ...
        ++i;
             ...
             && ((unsigned __int8)(WildCardsPermissible != 0 ? 10 : 2) & *((_BYTE *)qword_140013DE0 + v7)) == 0 )
      {
        return 0;
      }
    }
