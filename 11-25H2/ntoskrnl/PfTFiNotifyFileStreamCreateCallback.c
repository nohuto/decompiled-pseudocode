/*
 * XREFs of PfTFiNotifyFileStreamCreateCallback @ 0x140470850
 * Callers:
...
__int64 __fastcall PfTFiNotifyFileStreamCreateCallback(__int64 a1, __int64 a2)
{
  ...
  v9 = PfFbLogEntryReserve(a1, a1 + 288, (PSLIST_ENTRY *)&v17, &v18, v8);
  if ( v9 < 0 )
  {
    v15 = (PSLIST_ENTRY)v17;
  }
  else
  {
    v11 = v18;
  ...
  if ( v15 )
    PfFbLogEntryComplete(a1, (__int64)v15, v10, 0);
  if ( v9 < 0 )
    ++*(_DWORD *)(a1 + 708);
