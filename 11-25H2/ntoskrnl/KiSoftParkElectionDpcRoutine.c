/*
 * XREFs of KiSoftParkElectionDpcRoutine @ 0x1403137E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiShouldSoftParkElectionBePerformed @ 0x1403139A0 (KiShouldSoftParkElectionBePerformed.c)
...
void __fastcall KiSoftParkElectionDpcRoutine(__int64 a1, __int64 a2)
{
  ...
  v4 = *(_QWORD *)(KiProcessorBlock[*((unsigned int *)qword_140F216A8
  ...
  *(_BYTE *)(a2 + 788) = 0;
        ...
        v7) )
  {
    ...
    KiProcessDeferredReadyList(CurrentPrcb, &v9, 2u);
  }
  else
  {
    _InterlockedAnd64((volatile signed __int64 *)(a2 + 768), 0LL);
