/*
 * XREFs of KiAdjustUserIsolationDomainThread @ 0x1405BE5D0
 * Callers:
...
LABEL_47:
    ...
    if ( (KiVelocityFlags & 0x200000) != 0 )
    {
      ...
      *(_QWORD *)&v25 = 0LL;
      v17 = (struct _KPRCB **)_InterlockedExchange64(v9, (__int64)&v25);
      if ( v17 )
        KxWaitForLockOwnerShip((struct _KPRCB *)&v25, v17);
    }
    else
    {
      v27[0] = 0;
