/*
 * XREFs of MiObtainSectionForDriver @ 0x140A13124
 * Callers:
...
LABEL_2:
  ...
  while ( 1 )
  {
    if ( v5 < 2 )
    {
      v12 = (__int64 *)qword_140E2D648;
      v7 = 0LL;
      if ( v5 )
        v11 = &qword_140E2D648;
      else
        v12 = (__int64 *)PsLoadedModuleList;
      if ( v12 != v11 )
      {
        while ( 1 )
        {
          v7 = (__int64)v12;
          if ( RtlEqualUnicodeString(a1, (PCUNICODE_STRING)(v12 + 9), 1u) )
            break;
          if ( (a4 & 0x40000000) == 0 || !v10 || (v22 = v12[14]) == 0 || v10 != MiSectionControlArea(v22) )
          {
            v12 = (__int64 *)*v12;
            a1 = v24;
            if ( v12 != v11 )
...
LABEL_41:
    ...
    if ( TempLoaderEntry )
    {
      ...
      MiUpdateDriverLoadInProgress(v15, 0LL, 0, 0);
        ...
        && *(_QWORD *)(*(_QWORD *)v10 + 32LL) )
      {
        ...
        {
          v17 = (__int64)i[14];
          if ( v17 && v10 == MiSectionControlArea(v17) )
          {
            if ( i )
