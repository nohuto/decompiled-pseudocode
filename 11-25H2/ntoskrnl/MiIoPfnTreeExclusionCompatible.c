/*
 * XREFs of MiIoPfnTreeExclusionCompatible @ 0x14066A53C
 * Callers:
...
__int64 __fastcall MiIoPfnTreeExclusionCompatible(int a1, __int64 a2)
{
  ...
  v6 = 0LL;
  v7 = 0LL;
  v8 = (_QWORD *)qword_140E36F40[8 * v3];
  v9 = v4 & ((1LL << ((unsigned __int8)dword_140E2D8F8 - 12)) - 1);
  if ( !v8 )
    return 0LL;
  i = 0LL;
  do
...
LABEL_32:
    ...
    else
    {
      ...
      while ( !*v19 )
      {
        v20 = (*((_DWORD *)i
               + ((unsigned __int64)(2
                                   * (((unsigned int)v9 & ((unsigned int)(1LL << ((unsigned __int8)dword_140E2D8F8 - 12))
                                                         - 1))
                                    - *((_DWORD *)i + 6))) >> 5)
               + 11) >> ((2 * ((v9 & ((1LL << ((unsigned __int8)dword_140E2D8F8 - 12)) - 1)) - *((_BYTE *)i + 24))) & 0x1F)) & 3;
        v29 = v20;
        if ( v20 != 3 )
        {
          if ( !v17 )
          ...
          v22 = (unsigned __int64)(2
                                 * (((unsigned int)v9 & ((unsigned int)(1LL << ((unsigned __int8)dword_140E2D8F8 - 12))
                                                       - 1))
                                  - *((_DWORD *)i + 6))) >> 5;
          v23 = (2 * ((v9 & ((1LL << ((unsigned __int8)dword_140E2D8F8 - 12)) - 1)) - *((_BYTE *)i + 24))) & 0x1F;
          v17 = v28;
