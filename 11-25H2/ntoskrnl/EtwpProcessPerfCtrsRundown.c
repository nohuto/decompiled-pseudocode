/*
 * XREFs of EtwpProcessPerfCtrsRundown @ 0x1408BED48
 * Callers:
...
int __fastcall EtwpProcessPerfCtrsRundown(__int64 a1, __int64 a2)
{
  ...
  v8[3] = 0;
  v8[0] = *(_DWORD *)(a1 + 464);
  v8[2] = ObGetProcessHandleCount(a1, 0LL);
  v8[1] = *(_DWORD *)(a1 + 1028);
  v14 = *(_QWORD *)(a1 + 552);
  v9 = *(_QWORD *)(a1 + 544);
  ...
  v20 = v8;
  v21 = 104;
  return EtwpLogKernelEvent((struct _KTHREAD *)&v20, v6, v5, 1u, 0x321u, 0x501802u);
}
