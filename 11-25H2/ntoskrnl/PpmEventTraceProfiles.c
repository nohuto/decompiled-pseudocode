/*
 * XREFs of PpmEventTraceProfiles @ 0x140A3E7F4
 * Callers:
...
char __fastcall PpmEventTraceProfiles(char a1)
{
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( a1 )
      v3 = (const EVENT_DESCRIPTOR *)PPM_ETW_PROCESSOR_PROFILE_RUNDOWN;
...
LABEL_17:
        ...
        v33 = &v16;
        v16 = v11 / 0xA;
        v12 = (const EVENT_DESCRIPTOR *)PPM_ETW_PROCESSOR_PROFILE_RUNDOWN;
        v30 = 8LL;
        v32 = 8LL;
        v34 = 8LL;
        if ( !a1 )
