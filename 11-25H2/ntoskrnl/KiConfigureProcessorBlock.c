/*
 * XREFs of KiConfigureProcessorBlock @ 0x140B46004
 * Callers:
...
__int64 __fastcall KiConfigureProcessorBlock(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 176) = *((_DWORD *)qword_140F216A8 + 64 * v4 + (unsigned int)v3);
  result = v5 - 1;
  *(_DWORD *)(v1 + 180) = *((_DWORD *)qword_140F216A8 + 64 * v4 + (unsigned int)v6);
  if ( ((v5 - 1) & v5) == 0 )
  {
    v8 = *(unsigned __int16 *)(v1 + 138);
    v9 = KeNodeBlock;
    v10 = KeNodeBlock[v8];
    if ( KeIsEmptyGroupMask(v10 + 16) )
      *(_BYTE *)(v10 + 12) = v4;
