/*
 * XREFs of HalpMceRecoveryMemoryErrorIntel @ 0x1405523F8
 * Callers:
 *     HalpMceRecoveryMemoryError @ 0x1405522C0 (HalpMceRecoveryMemoryError.c)
 * Callees:
 *     HalpHvMceConsumedMemoryErrorRecovery @ 0x1405482F0 (HalpHvMceConsumedMemoryErrorRecovery.c)
 *     HalpMceMemoryErrorRecovery @ 0x140552030 (HalpMceMemoryErrorRecovery.c)
 */
