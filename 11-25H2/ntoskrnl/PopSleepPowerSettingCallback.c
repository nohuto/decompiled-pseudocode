/*
 * XREFs of PopSleepPowerSettingCallback @ 0x140A0FC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopSleepPowerSettingCallback(__int64 *a1, _DWORD *a2, int a3)
{
  ...
  if ( !v22 && a3 == 4 && a2 )
  {
    v23 = (unsigned int)*a2;
    HIDWORD(v31) = *a2;
    if ( byte_140F0B8C3 || __PAIR16__(word_140F0B8C4, 0) != HIBYTE(word_140F0B8C4) )
      LODWORD(v31) = 2;
    v6 = 0;
  }
  else
  ...
  if ( !v24 && a3 == 4 && a2 )
  {
    v25 = *a2;
    DWORD2(v33) = *a2;
    if ( !(_DWORD)v23 && v25 && byte_140F0B8C6 && byte_140F0B8C7 )
      LODWORD(v31) = 3;
  }
  else if ( v6 < 0 )
  {
