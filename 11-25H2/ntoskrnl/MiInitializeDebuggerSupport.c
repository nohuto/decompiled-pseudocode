/*
 * XREFs of MiInitializeDebuggerSupport @ 0x1406742CC
 * Callers:
...
__int64 MiInitializeDebuggerSupport()
{
  ...
  v0 = (_QWORD *)MiReservePtes((__int64)&qword_140E37328, 2u);
  v1 = 0;
  qword_140E2FF88 = (__int64)v0;
  if ( !v0 )
    MxInstallMoreMemory(3);
  v2 = (unsigned int *)&unk_140E318E0;
  *v0 = CLFS_LSN_NULL_EXT;
  qword_140E2FF90 = qword_140E2FF88 + 8;
  *(_QWORD *)(qword_140E2FF88 + 8) = CLFS_LSN_NULL_EXT;
  do
  {
