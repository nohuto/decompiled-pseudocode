/*
 * XREFs of DifZwSetInformationTransactionWrapper @ 0x14063CC90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationTransactionWrapper(
        void *a1,
        TRANSACTION_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(12);
  ...
  DWORD2(v18) = ZwSetInformationTransaction(a1, a2, a3, a4);
  if ( v8 )
  {
