/*
 * XREFs of MiRemoveViewsFromSectionWithPfn @ 0x14035AC94
 * Callers:
...
void __fastcall MiRemoveViewsFromSectionWithPfn(__int64 *BugCheckParameter2, unsigned __int64 a2, char a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( (a3 & 0xC) == 8 && !(unsigned int)MiControlAreaExemptFromCrossPartitionCharges(v9) )
    {
      ...
      if ( v15 != *((ULONG **)qword_140E2FD48 + (*(_WORD *)(v9 + 60) & 0x3FF)) )
      {
  ...
  if ( v10 )
    MiReturnCrossPartitionSectionCharges(*((_QWORD *)qword_140E2FD48 + (*(_WORD *)(v3 + 60) & 0x3FF)), v23, v10);
}
