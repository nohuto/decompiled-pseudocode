/*
 * XREFs of IopCreateSecureDeviceClassSettings @ 0x14099CB48
 * Callers:
...
__int64 __fastcall IopCreateSecureDeviceClassSettings(PGUID Guid, __int64 a2, _BYTE *a3)
{
  ...
  *(_QWORD *)&String2.Length = 7471216LL;
  ...
  if ( SecureDeviceClassState < 0
    || (SecureDeviceClassState = IopOpenRegistryKeyEx(&KeyHandle, v16, &DestinationString, 131097LL),
  ...
  if ( v22 == 2 )
  {
    ...
    RtlInitUnicodeString(&String1, L"Properties");
    v12 = IopOpenRegistryKeyEx(&Handle, KeyHandle, &String1, 131097LL);
