        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  _IMAGE_RUNTIME_FUNCTION_ENTRY *v13; // r11
  int v14; // r8d
  int i; // esi
  int v16; // edx
...
LABEL_2:
    ...
    {
      v6 = (unsigned int *)RtlpxLookupFunctionTable(ControlPc, (__int64)&v32);
    }
    else
    {
    ...
    *ImageBase = *((_QWORD *)&v32 + 1);
    ...
    if ( (_DWORD)v10 )
    {
      ...
      v13 = (_IMAGE_RUNTIME_FUNCTION_ENTRY *)&v6[3 * (unsigned int)(v10 - 1)];
      if ( v11 < v12 )
      {
        v14 = v10 - 2;
        ...
        {
          v16 = (i + v14) >> 1;
          v13 = (_IMAGE_RUNTIME_FUNCTION_ENTRY *)&v6[3 * v16];
