/*
 * XREFs of MiLogWsAging @ 0x140449E2C
 * Callers:
...
void __fastcall MiLogWsAging(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140E372D8 )
  {
    v4 = *(_QWORD *)(a1 + 144);
    v5 = *(_QWORD *)(a1 + 152);
    v6 = (*(_DWORD *)(a1 + 184) & 0xF) != 0 ? 0LL : (const CHAR *)(a1 - 200);
    if ( **(_DWORD **)&qword_140E372D8 > 5u )
    {
      if ( (*(_BYTE *)(*(_QWORD *)&qword_140E372D8 + 16LL) & 1) == 0
        || (v7 = 1,
      ...
      if ( v7 )
      {
        ...
        v15 = v8;
        v27[4] = (__int64)&v15;
        tlgCreate1Sz_char((__int64)v28, v6);
        v16 = v9;
        v29 = &v16;
        v30 = 4LL;
        v31 = &v20;
        ...
        v50 = 64LL;
        v52 = 4LL;
        tlgWriteEx_EtwWriteEx(v12, (int)&byte_140055127, v12, 1, v13, v14, 0x10u, (__int64)v27);
      }
    }
  }
}
