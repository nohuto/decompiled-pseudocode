/*
 * XREFs of PfpPartitionFindByHandle @ 0x14093AACC
 * Callers:
...
__int64 __fastcall PfpPartitionFindByHandle(__int64 *a1, __int64 *a2, __int64 a3, char a4)
{
  ...
  if ( (unsigned int)dword_140E074B8 > 4 && (byte_140E074C8 & 1) != 0 && (qword_140E074D0 & 1) == qword_140E074D0 )
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E074B8, (unsigned __int8 *)&byte_140047CF7, 0LL, 0LL, 2u, v19);
  LOBYTE(a3) = a4;
  ...
  if ( (unsigned int)dword_140E074B8 > 4 )
  {
    ...
    if ( v8 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_140047C1E,
        0LL,
        0LL,
        4u,
        v19);
