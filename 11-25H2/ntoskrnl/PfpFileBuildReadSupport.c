/*
 * XREFs of PfpFileBuildReadSupport @ 0x1409C7864
 * Callers:
...
__int64 __fastcall PfpFileBuildReadSupport(_QWORD *a1, __int64 a2, unsigned int a3, char a4, __int64 a5)
{
  ...
  *(_QWORD *)&v39[2] = v21;
  DWORD2(v40) = 576;
  v41 = 0LL;
  List = PfpOpenHandleCreate((__int64)&v38, v22, (__int64)v37, v21, v13, v35, 128, v19 + v20);
  if ( List < 0 )
    goto LABEL_15;
...
LABEL_17:
  ...
  if ( (v26 & 0x400000000LL) != 0 )
    PfpOpenHandleClose((__int64)&v38, a1[5]);
  if ( v6 )
