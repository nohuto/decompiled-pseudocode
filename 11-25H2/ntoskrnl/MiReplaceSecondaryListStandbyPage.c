/*
 * XREFs of MiReplaceSecondaryListStandbyPage @ 0x14023C950
 * Callers:
...
unsigned __int64 __fastcall MiReplaceSecondaryListStandbyPage(__int64 a1, __int64 a2, int a3, int a4, _BYTE *a5)
{
    ...
    || dword_140E2D880 != dword_140E2D884 && v10 >= *((_QWORD *)v11 + 2) )
  {
    for ( i = 0; ; i = a2 + 1 )
    {
      while ( 1 )
      {
        ...
        v11 = (char *)qword_140E2D8E0 + 16 * (int)a2;
        if ( v10 >= *(_QWORD *)v11 )
          break;
        if ( !(_DWORD)a2 )
      ...
      if ( (_DWORD)a2 == dword_140E2D884 || v10 < *((_QWORD *)v11 + 2) )
        break;
    }
  ...
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (v16 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, v15 < *(_QWORD *)v16)
    || dword_140E2D880 != dword_140E2D884 && v15 >= *((_QWORD *)v16 + 2) )
  {
    for ( j = 0; ; j = a2 + 1 )
    {
      while ( 1 )
      {
        ...
        v16 = (char *)qword_140E2D8E0 + 16 * (int)a2;
        if ( v15 >= *(_QWORD *)v16 )
          break;
        if ( !(_DWORD)a2 )
          KeBugCheckEx(0x1Au, 0x5180uLL, v15, (ULONG_PTR)qword_140E2D8E0, 0LL);
        v14 = a2 - 1;
      }
      if ( (_DWORD)a2 == dword_140E2D884 || v15 < *((_QWORD *)v16 + 2) )
        break;
    }
    dword_140E2D880 = (j + v14) >> 1;
  }
  v18 = *((_DWORD *)v16 + 2);
  if ( qword_140E2D8E8 )
  {
  ...
  if ( v13 != v18
    ...
    || a3 != (_DWORD)v5
    || byte_140E3C8A6
    && (v20 = v10 >> 9, *(_BYTE *)(qword_140E3CF00 + 2 * v20))
    && *(_BYTE *)(qword_140E3CF00 + 2 * v20) == 9
    && (*(_BYTE *)(qword_140E3CF00 + 2 * v20 + 1) & 0x7F) != (*(_BYTE *)(qword_140E3CF00 + 2 * (v15 >> 9) + 1) & 0x7F) )
  {
    MiUnlinkSecondaryListStandbyPage(a1, a3);
    v55 = (unsigned __int64)a5;
    if ( !*a5 )
      v55 = 0LL;
  ...
  v56 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v21 - 0x220000000000LL + 40) >> 43) & 0x3FFLL));
  k = dword_140E2D880;
  v24 = dword_140E2D884;
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (v25 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, v15 < *(_QWORD *)v25)
    || dword_140E2D880 != dword_140E2D884 && v15 >= *((_QWORD *)v25 + 2) )
  {
    for ( k = 0LL; ; k = (unsigned int)(v26 + 1) )
    {
      while ( 1 )
      {
        if ( v24 < (int)k )
          KeBugCheckEx(0x1Au, 0x5180uLL, v15, 0LL, 0LL);
        v26 = ((int)k + v24) >> 1;
        v25 = (char *)qword_140E2D8E0 + 16 * v26;
        if ( v15 >= *(_QWORD *)v25 )
          break;
        if ( !v26 )
          KeBugCheckEx(0x1Au, 0x5180uLL, v15, (ULONG_PTR)qword_140E2D8E0, 0LL);
      ...
      if ( v26 == dword_140E2D884 || v15 < *((_QWORD *)v25 + 2) )
        break;
    }
    dword_140E2D880 = ((int)k + v24) >> 1;
  }
  v58 = *((_DWORD *)v25 + 2);
  v60 = *(_DWORD *)(v22 + 32);
  if ( (v60 & 0x8000000) != 0 )
  {
    if ( v22 >= 0xFFFFDE0000000000uLL )
    {
      ...
      if ( v22 < 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL
        && !(unsigned int)MiIsDecayPfn(0xAAAAAAAAAAAAAAABuLL * (v21 >> 4), k, *(unsigned int *)(v22 + 32)) )
      {
...
LABEL_40:
  ...
  {
    if ( (_DWORD)v5 == 8 )
      v54 = *(_BYTE *)(qword_140E3CF00 + 2 * ((0xAAAAAAAAAAAAAAABuLL * ((__int64)(v22 - v8) >> 4)) >> 9) + 1) & 0x7F;
    else
      v54 = 0;
