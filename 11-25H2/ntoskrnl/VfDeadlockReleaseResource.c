/*
 * XREFs of VfDeadlockReleaseResource @ 0x140B975CC
 * Callers:
 *     ViDeadlockExReleaseFastMutexUnsafe_Entry @ 0x140B894F0 (ViDeadlockExReleaseFastMutexUnsafe_Entry.c)
 *     ViDeadlockExReleaseFastMutex_Entry @ 0x140B89520 (ViDeadlockExReleaseFastMutex_Entry.c)
 *     ViDeadlockKeReleaseInStackQueuedSpinLockForDpc_Entry @ 0x140B897A0 (ViDeadlockKeReleaseInStackQueuedSpinLockForDpc_Entry.c)
 *     ViDeadlockKeReleaseMutant_Entry @ 0x140B897E0 (ViDeadlockKeReleaseMutant_Entry.c)
 *     ViDeadlockKeReleaseMutex_Entry @ 0x140B89810 (ViDeadlockKeReleaseMutex_Entry.c)
 *     ViDeadlockKeReleaseSpinLockFromDpcLevel_Entry @ 0x140B89840 (ViDeadlockKeReleaseSpinLockFromDpcLevel_Entry.c)
 *     ViDeadlockKeReleaseSpinLock_Entry @ 0x140B975A0 (ViDeadlockKeReleaseSpinLock_Entry.c)
 * Callees:
...
LABEL_57:
      ...
      else if ( !*((_DWORD *)ViDeadlockGlobals + 8196) && *((int *)ViDeadlockGlobals + 8282) <= 1024 )
      {
        ...
        VfReportIssueWithOptions(0xC4u, 0x1007uLL, (ULONG_PTR)a1, (ULONG_PTR)v17, (ULONG_PTR)v21, &dword_140E0E7AC);
      }
      goto LABEL_58;
    }
    ViDeadlockPreprocessOptions(
      ...
      v18,
      v4);
    VfReportIssueWithOptions(0xC4u, 0x1009uLL, (ULONG_PTR)a1, *v17, v4, byte_140E0E7B8);
LABEL_58:
