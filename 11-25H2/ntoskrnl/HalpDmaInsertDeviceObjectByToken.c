/*
 * XREFs of HalpDmaInsertDeviceObjectByToken @ 0x14053BA5C
 * Callers:
 *     HalpDmaCheckAdapterToken @ 0x14053B7F0 (HalpDmaCheckAdapterToken.c)
 *     HalpDmaLinkDeviceObjectByToken @ 0x1406F17A0 (HalpDmaLinkDeviceObjectByToken.c)
 * Callees:
...
__int64 __fastcall HalpDmaInsertDeviceObjectByToken(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 24) = a2;
    *(_BYTE *)(Pool2 + 32) = a3;
    v10 = (__int64 *)qword_140FC28D8;
    if ( *(__int64 **)qword_140FC28D8 != &HalpDmaPdoList )
      __fastfail(3u);
    *(_QWORD *)Pool2 = &HalpDmaPdoList;
    *(_QWORD *)(Pool2 + 8) = v10;
    *v10 = Pool2;
    qword_140FC28D8 = Pool2;
  }
  else
  {
    v4 = -1073741670;
