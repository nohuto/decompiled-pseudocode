/*
 * XREFs of PnprMirrorMarkedPages @ 0x140B443CC
 * Callers:
 ...
 *     RtlFindFirstRunClear @ 0x1404601C0 (RtlFindFirstRunClear.c)
    ...
    do
    {
      for ( i = *(_RTL_BITMAP **)(v2 + 152); ; i = *(_RTL_BITMAP **)&i->SizeOfBitMap )
      {
                                                                       ...
                                                                       &StartingIndex) )
        {
          ...
          if ( !v7 )
            break;
          v8 = guard_dispatch_icall_no_overrides(*(_QWORD *)(PnprContext + 33184));
          v9 = PnprContext;
          v1 = v8;
          if ( v8 < 0 )
          {
