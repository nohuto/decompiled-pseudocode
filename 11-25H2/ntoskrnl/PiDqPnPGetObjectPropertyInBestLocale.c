/*
 * XREFs of PiDqPnPGetObjectPropertyInBestLocale @ 0x1408D2170
 * Callers:
...
__int64 PiDqPnPGetObjectPropertyInBestLocale(const WCHAR *a1, int a2, void *a3, __int64 a4, int a5, ...)
{
  __int64 v5; // rsi
  const WCHAR *v6; // r12
  __int64 v7; // r14
  ...
  _WORD *v23; // rax
  void *v24; // r14
  __int64 (__fastcall *v25)(PVOID, const WCHAR *, int, int, int, __int64); // rdi
  int v26; // eax
  void *v27; // rcx
  void *v28; // rcx
  __int64 v29; // rax
...
LABEL_19:
    ...
    do
    {
      ...
      if ( a2 )
      {
        v24 = *(void **)&PiPnpRtlCtx;
        v45 = 0LL;
        v37 = a3;
        v25 = *(__int64 (__fastcall **)(PVOID, const WCHAR *, int, int, int, __int64))(*(_QWORD *)&PiPnpRtlCtx + 488LL);
        v39 = a4;
        v40 = v35;
