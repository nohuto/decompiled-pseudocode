/*
 * XREFs of MiRegisterForHardwareAcceleratorChanges @ 0x140C4ADB8
 * Callers:
...
__int64 MiRegisterForHardwareAcceleratorChanges()
{
  ...
  v5 = PnpDriverObject;
  v1[0] = 2097153;
  result = AccelInitializeOffloadWorkspace(v1, &qword_140E37220);
  if ( (int)result >= 0 )
  {
    v11 = 0LL;
    v9 = 0LL;
    ...
    if ( (int)result < 0 )
    {
      result = AccelDestroyOffloadWorkspace(qword_140E37220);
      qword_140E37220 = 0LL;
    }
  }
  return result;
