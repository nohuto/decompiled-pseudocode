/*
 * XREFs of MiGetNextAffinityWalker @ 0x140418ACC
 * Callers:
    ...
    if ( v10 )
    {
      ...
      while ( 1 )
      {
        ...
        while ( v17 )
        {
          ...
          v19 = *((unsigned int *)qword_140F216A8 + 64 * epi16 + (int)v18);
          v20 = KiProcessorBlock[v19];
          if ( v11 != -1 )
          {
            v47 = *(_DWORD *)(v20 + 36408);
            if ( *(_BYTE *)(v3 + 8) )
              v47 += *(_DWORD *)(*(_QWORD *)(384LL * *(unsigned int *)(v20 + 34644) + qword_140E2D8B8 + 376) + 12LL);
          ...
          if ( (v23 & v40) != 0 )
          {
            ...
            else
            {
              ...
              if ( v24 )
              {
                ...
                LODWORD(v19) = *((_DWORD *)qword_140F216A8 + 64 * v15.m128i_u16[4] + (int)v46);
              }
              else
              {
                LODWORD(v19) = -1;
