/*
 * XREFs of ExpAllocatePoolWithQuotaTag @ 0x140B62670
 * Callers:
...
ULONG_PTR __fastcall ExpAllocatePoolWithQuotaTag(ULONG_PTR BugCheckParameter3, size_t a2, ULONG_PTR a3, int a4)
{
  ...
  if ( ExpSpecialAllocations )
  {
    ...
    {
      v37 = RtlCSparseBitmapBitmaskRead((__int64)&dword_140E68050, 2 * ((PoolWithTagFromNode - qword_140E68048) >> 20));
      if ( !v37 || (v25 = v37 - 1, v25 == 2) )
      {
        v51 = 0LL;
        v52 = 0LL;
        RtlpHpVaMgrCtxQuery((__int64)&unk_140E68098, PoolWithTagFromNode, (__int64)&v51);
        v27 = *(_QWORD *)v52;
LABEL_29:
        if ( !v27 )
