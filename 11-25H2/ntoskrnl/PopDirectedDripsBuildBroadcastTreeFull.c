/*
 * XREFs of PopDirectedDripsBuildBroadcastTreeFull @ 0x140755090
 * Callers:
 *     PopDirectedDripsBuildBroadcastTreePartial @ 0x1407552B0 (PopDirectedDripsBuildBroadcastTreePartial.c)
 * Callees:
 *     PopFxIsDirectedPowerTransitionSupported @ 0x1405CCE88 (PopFxIsDirectedPowerTransitionSupported.c)
 ...
 *     PopDirectedDripsFlushDeviceQueue @ 0x140755524 (PopDirectedDripsFlushDeviceQueue.c)
 *     PopDirectedDripsInsertQueueDevice @ 0x140755548 (PopDirectedDripsInsertQueueDevice.c)
 *     PopDirectedDripsIsLikelySpecialDevice @ 0x140755588 (PopDirectedDripsIsLikelySpecialDevice.c)
 *     PopDirectedDripsRemoveQueueDevice @ 0x1407555D0 (PopDirectedDripsRemoveQueueDevice.c)
 *     PopDirectedDripsMarkDfxDevice @ 0x140A90AD4 (PopDirectedDripsMarkDfxDevice.c)
 */
