/*
 * XREFs of VrpHandleIoctlCreateNamespaceNode @ 0x14094A72C
 * Callers:
        ...
        size_t *a6)
{
  ...
  void *v22; // [rsp+48h] [rbp-28h] BYREF
    ...
    if ( JobSilo >= 0 )
    {
      ...
      *((_QWORD *)&v23 + 1) = a1 + 2 * ((v16 >> 1) + 10);
      ...
      if ( JobSilo >= 0 )
      {
        ...
        {
          v22 = 0LL;
          VRegEnabledInJob((unsigned __int64 *)&v22);
          ...
          else
          {
            ...
            v9 = 1;
            v19 = VrpCreateNamespaceNode((__int64)v8, (const void **)&v24, v22, (const void **)&v23, v15, v17, &v25);
            v10 = v25;
            JobSilo = v19;
            if ( v19 >= 0 )
            {
