/*
 * XREFs of HvlpLogGuestStateScrubbingStatus @ 0x140587B7C
 * Callers:
...
__int64 HvlpLogGuestStateScrubbingStatus()
{
  ...
  _BYTE v40[2064]; // [rsp+178h] [rbp+70h] BYREF
  ...
  v0 = HvlpAcquireHypercallPage((__int64)&v15.m256i_i64[1], 1, (__int64)v39, 16LL);
  v1 = (int *)HvlpAcquireHypercallPage((__int64)&v14.m256i_i64[1], 2, (__int64)v40, 1032LL);
  *(_DWORD *)v0 = 25;
  if ( !(unsigned __int16)HvcallInitiateHypercall(123) )
    HvlpGuestStateScrubbingStatus = *v1;
  HvlpReleaseHypercallPage(&v14.m256i_u32[2]);
  result = HvlpReleaseHypercallPage(&v15.m256i_u32[2]);
