/*
 * XREFs of FsRtlProcessFileLock @ 0x140376870
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( CurrentStackLocation->MinorFunction != 1 )
  {
    switch ( CurrentStackLocation->MinorFunction )
    {
      case 2u:
        ...
        break;
      case 3u:
        v16 = (unsigned int)IoGetRequestorProcess(Irp);
        v14 = FsRtlPrivateFastUnlockAll((_DWORD)FileLock, CurrentStackLocation->FileObject, v16, 0, 0, (__int64)Context);
        break;
      case 4u:
        v17 = (unsigned int)IoGetRequestorProcess(Irp);
