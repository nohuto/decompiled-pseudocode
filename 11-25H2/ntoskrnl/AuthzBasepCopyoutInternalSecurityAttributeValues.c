/*
 * XREFs of AuthzBasepCopyoutInternalSecurityAttributeValues @ 0x14036C898
 * Callers:
      ...
      for ( i = v9 + 40; ; i += 64LL )
      {
        ...
        *(_DWORD *)(i - 8) = 0;
        ...
        else
        {
          ...
          v16 = (wchar_t *)((char *)v10 + v18);
          if ( (unsigned __int64)v10 + v18 > v6 )
            return (unsigned int)-2147483643;
          *(_DWORD *)(i + 8) = v18;
          *(_QWORD *)i = v10;
          memmove(v10, (const void *)v12[5], v18);
        }
        v10 = v16;
LABEL_12:
