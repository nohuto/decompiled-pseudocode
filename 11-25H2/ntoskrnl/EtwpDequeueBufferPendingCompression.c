/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x140645298
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x140645398 (EtwpDequeueBufferPendingCompressionFromQueue.c)
