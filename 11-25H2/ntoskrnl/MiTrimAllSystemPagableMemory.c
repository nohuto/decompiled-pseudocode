/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x14066D43C
 * Callers:
 *     MmTrimAllSystemPagableMemory @ 0x14066D5F0 (MmTrimAllSystemPagableMemory.c)
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1)
{
  ...
  if ( v7 + _InterlockedExchangeAdd(&dword_140E37184, v7) == v7 )
  {
    v11 = v7;
    _InterlockedExchange64(&qword_140E371D0, (__int64)KeGetCurrentThread());
    v12 = 0;
    do
    {
    ...
    _InterlockedExchange64(&qword_140E371D0, 0LL);
  }
  _InterlockedDecrement(&dword_140E37184);
