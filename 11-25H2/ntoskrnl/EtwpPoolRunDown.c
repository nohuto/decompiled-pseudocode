/*
 * XREFs of EtwpPoolRunDown @ 0x1407A1D70
 * Callers:
...
void __fastcall EtwpPoolRunDown(__int64 a1, char a2)
{
  ...
  for ( i = 48; ; v4 = i )
  {
    ...
    if ( !Pool2 )
      break;
    PoolTagInfo = ExGetPoolTagInfo(Pool2, v4, &i);
      ...
      if ( PoolTagInfo >= 0 )
      {
        ...
        if ( *v2 )
        {
          do
          {
            ...
            v24 = v13;
            v30 = 40 * v13;
            EtwpLogKernelEvent((struct _KTHREAD *)&v26, v12, v11, 2u, v5, 0x501802u);
            v10 += 10 * v24;
            v9 -= v24;
          }
          while ( v9 );
  ...
  while ( 1 )
  {
    ...
    if ( !v16 )
      break;
    BigPoolInfo = ExGetBigPoolInfo(0, v16, v14, &i);
    if ( BigPoolInfo != -1073741820 )
    {
      if ( BigPoolInfo >= 0 )
      {
        ...
        for ( j = v2 + 2; v18; v18 -= v24 )
        {
          ...
          v24 = v22;
          v30 = 24 * v22;
          EtwpLogKernelEvent((struct _KTHREAD *)&v26, v21, v20, 2u, v15, 0x501802u);
          j += 6 * v24;
        }
      }
      ExFreePoolWithTag(v2, 0);
