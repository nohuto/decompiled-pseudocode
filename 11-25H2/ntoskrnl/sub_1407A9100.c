/*
 * XREFs of sub_1407A9100 @ 0x1407A9100
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpLicUpdateChecksum @ 0x140649A0C (ExpLicUpdateChecksum.c)
...
__int64 __fastcall sub_1407A9100(__int64 a1, _DWORD *a2, _DWORD *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  _DWORD *v8; // rbx
  ...
  if ( !*(_QWORD *)a1 && *(_QWORD *)(a1 + 46832) )
  {
    ...
    v11 = KeAbPreAcquire(a1 + 47024, 0LL);
...
LABEL_16:
    ...
    if ( *(_QWORD *)a1 || !*(_QWORD *)(a1 + 46832) )
      goto LABEL_44;
    v17 = KeAbPreAcquire((__int64)v10, 0LL);
    v18 = v17;
...
LABEL_37:
      ...
      v36 = v33;
      v37 = v34;
      if ( !v27 && (int)ntoskrnl_21(a1, v38) >= 0 )
      {
...
LABEL_45:
  ...
  if ( v39 )
  {
    v30 = a5;
    *a6 = 1;
    return (unsigned int)sub_1407A8E3C(v8, a3, a4, v30, 0);
  }
  else
  {
    v29 = -1073741772;
