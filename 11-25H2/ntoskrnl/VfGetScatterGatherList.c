/*
 * XREFs of VfGetScatterGatherList @ 0x140B76C00
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_DWORD *)(v8 + 224) == 3 )
  {
    ...
    if ( v11 )
    {
      ...
      ViHalPreprocessOptions(
        ...
        0LL,
        0LL);
      VfReportIssueWithOptions(0xE6u, 0x24uLL, v12, 0LL, 0LL, byte_140E0E764);
    }
  }
...
LABEL_16:
  ...
  *v26 = v25;
  ...
  v5 = v24;
LABEL_19:
  v27 = guard_dispatch_icall_no_overrides(RealDmaAdapter);
  v28 = v27;
  if ( v8 && v27 < 0 )
  {
    DECREMENT_SCATTER_GATHER_LISTS(v8);
