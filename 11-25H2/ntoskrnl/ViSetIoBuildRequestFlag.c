/*
 * XREFs of ViSetIoBuildRequestFlag @ 0x140698EB0
 * Callers:
 *     ViIovIoBuildDeviceIoControlRequest_Exit @ 0x140698E20 (ViIovIoBuildDeviceIoControlRequest_Exit.c)
 *     ViIovIoBuildSynchronousFsdRequest_Exit @ 0x140698E40 (ViIovIoBuildSynchronousFsdRequest_Exit.c)
 *     ViIovIoBuildAsynchronousFsdRequest_Exit @ 0x140B952F0 (ViIovIoBuildAsynchronousFsdRequest_Exit.c)
 * Callees:
