/*
 * XREFs of PiDcResetChildDeviceContainers @ 0x14071BC50
 * Callers:
...
__int64 __fastcall PiDcResetChildDeviceContainers(__int64 a1, const wchar_t *a2)
{
  ...
  if ( wcsicmp(a2, L"{00000000-0000-0000-FFFF-FFFFFFFFFFFF}") )
  {
    ...
    {
      v9 = 78;
      DeviceRegProp = CmGetDeviceRegProp(PiPnpRtlCtx, (int)v4 + 16, 0, 37, (__int64)&v10, (__int64)v13, (__int64)&v9, 0);
      v3 = DeviceRegProp;
      ...
      if ( v3 < 0 )
        break;
      v6 = CmSetDeviceRegProp(PiPnpRtlCtx, (int)v4 + 16, 0, 37, 1, 0LL, 0, 0);
      v3 = v6;
      if ( v6 == -1073741275 )
      {
LABEL_11:
