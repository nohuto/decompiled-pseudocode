/*
 * XREFs of DifKeAcquireInStackQueuedSpinLockForDpcWrapper @ 0x140620450
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeAcquireInStackQueuedSpinLockForDpcWrapper(PKSPIN_LOCK SpinLock, PKLOCK_QUEUE_HANDLE LockHandle)
{
  ...
  PKSPIN_LOCK v13; // [rsp+30h] [rbp-28h]
