/*
 * XREFs of PpmParkReportParkedCores @ 0x1403AD8E0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)&v44.Count = 2097153LL;
  ...
  while ( 1 )
  {
    while ( v31 )
    {
      ...
      v31 &= ~(1LL << v33);
      Prcb = KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v32 + (unsigned __int8)v33));
  ...
  while ( 1 )
  {
    while ( v35 )
    {
      ...
      v35 &= ~(1LL << v37);
      v38 = KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v36 + (unsigned __int8)v37));
      PpmPerfQueueAction(v38, 5LL);
    }
  ...
  while ( 1 )
  {
    while ( v39 )
    {
      ...
      v39 &= ~(1LL << v41);
      v42 = KeGetPrcb(*((unsigned int *)qword_140F216A8 + 64 * (unsigned __int16)v40 + (unsigned __int8)v41));
      PpmPerfQueueAction(v42, 4LL);
    }
