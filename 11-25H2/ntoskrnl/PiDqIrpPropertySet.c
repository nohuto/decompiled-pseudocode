/*
 * XREFs of PiDqIrpPropertySet @ 0x14095E610
 * Callers:
...
__int64 __fastcall PiDqIrpPropertySet(PIRP Irp)
{
  ...
  if ( v6 < 0 )
    goto LABEL_29;
  NdrMesTypeDecode3(v20, "TP 3\a", &off_1400018C0, &off_140E06FE0, 2, &P);
  if ( !P
    || !*((_QWORD *)P + 1)
    || !*((_QWORD *)P + 3)
    || !*((_DWORD *)P + 4)
...
LABEL_28:
  ...
  v6 = PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, v7, PnpObjectType, 7, 0, (__int64)&Handle);
  if ( v6 < 0 )
    goto LABEL_29;
  v9 = *((_DWORD *)P + 4);
  if ( v9 )
  ...
  if ( v4 )
  {
    ...
    {
      v6 = PiDqOpenObjectRegKey(1, *((_QWORD *)P + 1), PnpObjectType, 7LL, 1, 0LL, &v19);
      if ( v6 < 0 )
        goto LABEL_29;
      goto LABEL_19;
    }
