/*
 * XREFs of PipProcessRestartPhase2 @ 0x14072A3D8
 * Callers:
...
__int64 __fastcall PipProcessRestartPhase2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (byte_140EEFA6B & 0x20) != 0 )
    McTemplateK0dz_EtwWriteTransfer(a1, (__int64)KMPnPEvt_ProcessDeviceRestart_Start, a3, 2, *v3);
  v5 = *(_DWORD *)(a1 + 392);
  if ( v5 >= 0 )
  {
  ...
  if ( (byte_140EEFA6B & 0x20) != 0 )
    McTemplateK0dz_EtwWriteTransfer((__int64)*v3, (__int64)KMPnPEvt_ProcessDeviceRestart_Stop, v7, 2, *v3);
