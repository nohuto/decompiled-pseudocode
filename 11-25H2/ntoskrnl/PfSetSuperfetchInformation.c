/*
 * XREFs of PfSetSuperfetchInformation @ 0x1408E9C54
 * Callers:
...
LABEL_31:
      ...
      case 0xD:
        ...
        if ( (_WORD)v47 != 1 || (unsigned int)(HIDWORD(v47) - 1) > 4 )
          goto LABEL_103;
        v17 = PfpScenCtxPrefetchStateSet((ULONG_PTR)&qword_140E66BC0);
LABEL_102:
        LODWORD(v12) = v17;
        goto LABEL_13;
      default:
        ...
        if ( (int)v12 >= 0 )
        {
          ...
          if ( (int)v12 >= 0 )
          {
            ...
            if ( (int)v12 >= 0 )
            {
              ...
              PfpScenCtxServiceThreadSet((ULONG_PTR)&qword_140E66BC0);
              if ( v36 )
