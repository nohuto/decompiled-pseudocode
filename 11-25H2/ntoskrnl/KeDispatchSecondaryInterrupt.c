/*
 * XREFs of KeDispatchSecondaryInterrupt @ 0x1404742F0
 * Callers:
 *     HalpInvokeIsrForGsiv @ 0x1404742A0 (HalpInvokeIsrForGsiv.c)
 * Callees:
  ...
  if ( CurrentIrql )
  {
    ...
    if ( *(__int128 **)v4 != v4 )
    {
      ...
      if ( *(__int64 **)(KiSecondarySignalList + 8) != &KiSecondarySignalList
        || *(__int64 **)qword_140F0FB08 != &KiSecondarySignalList
      ...
      *(_QWORD *)qword_140F0FB08 = v4;
      qword_140F0FB08 = *((_QWORD *)v4 + 1);
      *(_QWORD *)qword_140F0FB08 = &KiSecondarySignalList;
      *((_QWORD *)v4 + 1) = v8;
      if ( v9 )
      {
