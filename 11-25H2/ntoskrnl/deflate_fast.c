  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      *(_BYTE *)(*((unsigned int *)a1 + 1489) + a1[743]) = v18;
      v19 -= 3;
      *(_BYTE *)((unsigned int)++*((_DWORD *)a1 + 1489) + a1[743]) = HIBYTE(v18);
      *(_BYTE *)((unsigned int)++*((_DWORD *)a1 + 1489) + a1[743]) = v19;
      ...
      ++*((_WORD *)a1 + 2 * *((unsigned __int8 *)v22 + v21) + 1280);
      v23 = *((_DWORD *)a1 + 54);
      v24 = *((_DWORD *)a1 + 1489) == *((_DWORD *)a1 + 1490);
