/*
 * XREFs of ExAcquireFastResourceSharedStarveExclusive @ 0x14048A060
 * Callers:
  ...
  if ( !v16 || (v13 & 4) != 0 )
  {
    ...
    do
    {
      ...
      if ( (*BugCheckParameter2 & 1) != 0 )
        return ExpAcquireFastResourceSharedSlow(
    ...
    *(_QWORD *)(a2 + 16) = v17 | (v22 != 0);
    ...
    if ( v22 )
    {
      ...
      v32 = *(struct _LIST_ENTRY **)(v17 + 1744);
      if ( v32->Blink != (struct _LIST_ENTRY *)(v17 + 1744) )
LABEL_34:
        __fastfail(3u);
      *(_QWORD *)a2 = v32;
      *(_QWORD *)(a2 + 8) = v31;
      v32->Blink = (struct _LIST_ENTRY *)a2;
      *v31 = a2;
      KxReleaseSpinLock((volatile signed __int64 *)(v17 + 1736));
    }
    else
    {
      v25 = (unsigned __int64 *)(v17 + 1720);
    ...
    {
      if ( v23 && v18 )
        KeAbMarkCrossThreadReleasable((__int64)CurrentPrcb, v18);
