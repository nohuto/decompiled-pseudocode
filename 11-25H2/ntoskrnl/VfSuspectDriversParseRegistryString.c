/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140C2AA74
 * Callers:
 ...
 *     VfSuspectDriversInsert @ 0x140B8AB28 (VfSuspectDriversInsert.c)
      ...
      if ( v8 )
      {
        ...
        *((_QWORD *)&v13[0] + 1) = v0;
        ...
        else
        {
          ...
          {
            VfDriverLock();
            v11 = (_QWORD *)qword_140F03E28;
            if ( *(__int64 **)qword_140F03E28 != &VfExcludedDriversList )
              __fastfail(3u);
            *v10 = &VfExcludedDriversList;
            v10[1] = v11;
            *v11 = v10;
            qword_140F03E28 = (__int64)v10;
LABEL_26:
