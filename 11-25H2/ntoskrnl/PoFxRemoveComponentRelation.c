/*
 * XREFs of PoFxRemoveComponentRelation @ 0x1405CBD40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PoFxRemoveComponentRelation(ULONG_PTR BugCheckParameter2, unsigned int a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( v15 )
  {
    ...
    if ( v20 )
    {
      ...
      PopFxIdleComponent(v10, *((unsigned int *)v15 + 4), 2, 0LL);
    }
    else
    {
      v4 = -1073741811;
    }
    PopFxIdleComponent(BugCheckParameter2, *(unsigned int *)(v27 + 16), 2, 0LL);
  }
  else
  {
LABEL_31:
