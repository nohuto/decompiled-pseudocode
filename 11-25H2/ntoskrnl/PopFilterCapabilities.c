/*
 * XREFs of PopFilterCapabilities @ 0x140A10C3C
 * Callers:
 ...
 *     PopCheckDisabledState @ 0x140A11004 (PopCheckDisabledState.c)
...
__int64 __fastcall PopFilterCapabilities(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 72) = *(_DWORD *)(a1 + 72);
  ...
  v25 = &v28;
  v26 = &v27;
  IopGetLegacyVetoListDrivers((__int64)&p_P);
  v7 = v27;
  if ( v27 < 0 )
    goto LABEL_42;
  if ( !v28 )
