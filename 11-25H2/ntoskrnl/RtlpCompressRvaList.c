/*
 * XREFs of RtlpCompressRvaList @ 0x140944740
 * Callers:
 *     RtlCreateRvaList @ 0x140944580 (RtlCreateRvaList.c)
 * Callees:
 *     _guard_dispatch_icall_no_overrides @ 0x1406A8B20 (_guard_dispatch_icall_no_overrides.c)
 *     MiQueryFlagsForRvaEntry @ 0x140944DB0 (MiQueryFlagsForRvaEntry.c)
 *     MiImageGetRawRvaState @ 0x140944E50 (MiImageGetRawRvaState.c)
 *     RtlpSetRvaListRvaStateBits @ 0x140944EC0 (RtlpSetRvaListRvaStateBits.c)
 */
        ...
        int *a7)
{
  ...
  v14 = 0;
  v47 = v8;
  v15 = guard_dispatch_icall_no_overrides(a2);
  v43 = v15;
  v16 = v15;
  if ( !v15 )
  {
...
LABEL_22:
      ...
      {
        v25 = guard_dispatch_icall_no_overrides(v20);
      }
LABEL_23:
      v20 = a2;
      goto LABEL_24;
...
LABEL_30:
  ...
  {
    v18 = guard_dispatch_icall_no_overrides(v10);
  }
  if ( !v18 )
    goto LABEL_58;
  if ( v18 > v19 )
