/*
 * XREFs of EtwpTrackProviderBinary @ 0x140894358
 * Callers:
...
NTSTATUS __fastcall EtwpTrackProviderBinary(__int64 a1, void **a2)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( *(_QWORD *)(*((_QWORD *)Object + 4) + 400LL) )
    {
      ...
      v23 = (unsigned __int64 *)(*(_QWORD *)(v6[4] + 400LL) + 408LL);
    ...
    --v7->KernelApcDisable;
    v8 = (unsigned __int64 *)(v6[4] + 408LL);
    ...
    *(_QWORD *)(v6[4] + 416LL) = 0LL;
    ...
    v20 = Object;
    v21 = *(_QWORD *)(*((_QWORD *)Object + 4) + 400LL);
    if ( v21 )
    {
      *(_QWORD *)(v21 + 416) = 0LL;
      v32 = (__int64 *)(*(_QWORD *)(v20[4] + 400LL) + 408LL);
      _m_prefetchw(v32);
      v33 = *v32;
      v34 = *v32 - 16;
