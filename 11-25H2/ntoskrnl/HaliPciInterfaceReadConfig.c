/*
 * XREFs of HaliPciInterfaceReadConfig @ 0x140281470
 * Callers:
 *     HaliHandlePCIConfigSpaceAccess @ 0x14055F1E0 (HaliHandlePCIConfigSpaceAccess.c)
 *     HalpKdReadPCIConfig @ 0x14056A1D0 (HalpKdReadPCIConfig.c)
 * Callees:
 ...
 *     HalpPciAccessIoConfigSpace @ 0x14054FC08 (HalpPciAccessIoConfigSpace.c)
...
LABEL_6:
    ...
    {
      LODWORD(v18) = Size;
      if ( (__int64 (__fastcall *)(int, int, int, int, int, int, size_t, void *))qword_140FC07E8 == VslAccessPciDevice )
