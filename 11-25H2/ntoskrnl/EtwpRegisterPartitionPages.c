/*
 * XREFs of EtwpRegisterPartitionPages @ 0x140644650
 * Callers:
...
char __fastcall EtwpRegisterPartitionPages(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  Pool2[2] = a2;
  Pool2[3] = a1;
  v9 = ExAcquireSpinLockExclusive(&dword_140EFE850);
  v10 = 2 * ((unsigned int)dword_140EFE844 >> 5);
  ...
  if ( v11 )
  {
    ...
    v14 = dword_140EFE844;
    v15 = 0;
    v16 = -1LL << (dword_140EFE844 & 0x1F);
    if ( (dword_140EFE844 & 0xFFFFFFE0) != 0 )
    {
      do
      {
        v17 = qword_140EFE848;
      ...
      while ( v15 < (unsigned int)dword_140EFE844 >> 5 );
    }
    v20 = qword_140EFE848;
    qword_140EFE848 = v11;
    dword_140EFE844 = (32 * v10) | v14 & 0x1F;
    if ( v20 )
...
LABEL_24:
    v21 = qword_140EFE848;
    v25 = v8[1] & (-1LL << (dword_140EFE844 & 0x1F));
    v22 = (37
         * (BYTE6(v25)
          + 37
          * (BYTE5(v25)
         ...
         + HIBYTE(v25)) & (((unsigned int)dword_140EFE844 >> 5) - 1);
    *v8 = *((_QWORD *)qword_140EFE848 + v22);
    v21[v22] = v8;
    v6 = 1;
    ++EtwpMdlTable;
  }
  ExReleaseSpinLockExclusive(&dword_140EFE850, v9);
  if ( !v6 )
