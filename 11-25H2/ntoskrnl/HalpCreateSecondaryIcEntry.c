/*
 * XREFs of HalpCreateSecondaryIcEntry @ 0x14055300C
 * Callers:
 *     HalpRegisterSecondaryIcInterface @ 0x1405534BC (HalpRegisterSecondaryIcInterface.c)
 * Callees:
...
__int64 __fastcall HalpCreateSecondaryIcEntry(__int64 a1)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(v4 + 128) = v4 + 128;
    ...
    v6 = (__int64 *)qword_140F8F438;
    if ( *(__int64 **)qword_140F8F438 != &SecondaryIcList )
      __fastfail(3u);
    *(_QWORD *)v4 = &SecondaryIcList;
    *(_QWORD *)(v4 + 8) = v6;
    *v6 = v4;
    qword_140F8F438 = v4;
    HalpReleaseHighLevelLock((__int64)&SecondaryIcListSpinLock, v5);
  }
  else
  {
