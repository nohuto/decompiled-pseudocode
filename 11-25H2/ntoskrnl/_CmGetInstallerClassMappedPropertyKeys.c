/*
 * XREFs of _CmGetInstallerClassMappedPropertyKeys @ 0x14080EEE0
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  *v7 = 0;
  ...
  {
    v19 = 32LL * j;
    v20 = *(__int64 *)((char *)&off_140B2E270 + v19);
    if ( v20 )
    {
      if ( a4
        || (InstallerClassMappedPropertyFromRegValue = CmGetInstallerClassMappedPropertyFromRegValue(
                                                         ...
                                                         a2,
                                                         a3,
                                                         (unsigned int)*(DEVPROPKEY **)((char *)&off_140B2E270 + v19),
                                                         (__int64)v35,
                                                         0LL,
                                                         0,
                                                         (__int64)&a7),
