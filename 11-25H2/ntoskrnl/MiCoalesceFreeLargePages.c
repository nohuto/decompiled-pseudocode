/*
 * XREFs of MiCoalesceFreeLargePages @ 0x14034FBA4
 * Callers:
...
__int64 __fastcall MiCoalesceFreeLargePages(__int64 a1, ULONG_PTR a2, unsigned int a3, unsigned __int8 a4)
{
  ...
  if ( v11 )
  {
    ...
    do
    {
      if ( !(unsigned int)MiLargePfnPromoteCandidate(v44, v13, a3) )
        break;
...
LABEL_27:
    ...
    if ( MiSafeLockPageAtDpc(v23, v24, v16) == 17 )
    {
LABEL_26:
      v29 = 0;
      goto LABEL_27;
...
LABEL_23:
    ++v27;
    if ( !(unsigned int)MiLargePfnPromoteCandidate(v44, v25, a3) )
      goto LABEL_26;
