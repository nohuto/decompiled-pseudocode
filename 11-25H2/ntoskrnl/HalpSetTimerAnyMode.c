/*
 * XREFs of HalpSetTimerAnyMode @ 0x14044710C
 * Callers:
 ...
 *     HalpTimerClearProblem @ 0x1404471B4 (HalpTimerClearProblem.c)
 */
...
__int64 __fastcall HalpSetTimerAnyMode(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 *a4)
{
  ...
  v8 = (unsigned int)v7;
  if ( v7 >= 0
    || (v13 = HalpSetTimer(a1, 2u, a2, 1, a4), v8 = (unsigned int)v13, v13 >= 0)
    || (v12 = HalpSetTimer(a1, 1u, a2, 1, a4), v8 = (unsigned int)v12, v12 >= 0) )
  {
