/*
 * XREFs of NtSetEventEx @ 0x140995350
 * Callers:
 ...
 *     KeAbIsValidUserModeLockAddress @ 0x140430DD0 (KeAbIsValidUserModeLockAddress.c)
...
__int64 __fastcall NtSetEventEx(HANDLE Handle, _DWORD *a2, __int64 a3)
{
  ...
  else
  {
    if ( KeAbIsValidUserModeLockAddress(a3) )
    {
      ...
      v11 = KeSetEventBoostPriorityEx((volatile signed __int32 *)SystemArgument1, &v16, &Priority, a3, 0, 1);
    }
    else
    {
