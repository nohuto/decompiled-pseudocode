/*
 * XREFs of MiInitializeWorkingSetManagerParameters @ 0x14066D024
 * Callers:
  ...
  *(_QWORD *)(v1 + 56) = v16;
  if ( v6 )
  {
    ...
    *(_QWORD *)(v1 + 104) = v1 + 104;
    if ( (ULONG *)a1 == &MiSystemPartition )
    {
      LOWORD(stru_140E37188.Header.Lock) = 0;
      stru_140E37188.Header.SignalState = 0;
      stru_140E37188.Header.WaitListHead.Blink = &stru_140E37188.Header.WaitListHead;
      stru_140E37188.Header.WaitListHead.Flink = &stru_140E37188.Header.WaitListHead;
      stru_140E37188.Header.Size = 6;
    }
  }
  if ( !v9 )
  {
