/*
 * XREFs of EtwTraceEvent @ 0x14030FA90
 * Callers:
...
__int64 __fastcall EtwTraceEvent(
        unsigned __int16 a1,
        unsigned __int16 *a2,
        unsigned int a3,
        int a4,
        unsigned __int8 a5)
{
  ...
  struct _LIST_ENTRY *v46; // [rsp+60h] [rbp-198h]
  ...
  v46 = Flink;
  if ( (unsigned int)v8 >= LODWORD(Flink[1].Flink) )
    return (unsigned int)-1073741816;
  v10 = 0;
  if ( a5 == 1 || ObGetCurrentIrql() < 2u )
  {
    _mm_lfence();
    CurrentThread = KeGetCurrentThread();
    --CurrentThread->KernelApcDisable;
    v12 = *((_QWORD *)&Flink[28].Flink->Flink + v8);
...
LABEL_10:
  _mm_lfence();
  v16 = *((_QWORD *)&Flink[28].Blink->Flink + v8);
  if ( (v16 & 1) != 0 )
  {
    EtwpCloseLogger(v45, (__int64)Flink, v10);
    return (unsigned int)-1073741816;
  }
  v52 = v16;
  if ( !v16 )
...
LABEL_69:
  if ( v10 )
  {
    ExReleaseRundownProtectionCacheAwareEx(*((PEX_RUNDOWN_REF_CACHE_AWARE *)&Flink[28].Flink->Flink + v45), 1u);
    KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
  }
  return v40;
}
