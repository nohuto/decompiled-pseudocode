/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x140992AEC
 * Callers:
 *     ExInitializeUtcTimeZoneBias @ 0x1407A697C (ExInitializeUtcTimeZoneBias.c)
 *     EtwpAddLogHeader @ 0x140992044 (EtwpAddLogHeader.c)
 *     RtlQueryTimeZoneInformation @ 0x1409936D0 (RtlQueryTimeZoneInformation.c)
 *     ExpRefreshTimeZoneInformation @ 0x140993940 (ExpRefreshTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x140994130 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall RtlpQueryTimeZoneInformationWorker(char *a1, size_t Size)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_DWORD *)a1 + 38) = -16;
    ...
    RegistryValues = RtlpQueryRegistryValues(0x40000000, (int)Handle, (int)v14, 0, v6, 1);
