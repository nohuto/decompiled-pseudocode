/*
 * XREFs of _CmEnumDevicesInContainerWithCallback @ 0x140809D18
 * Callers:
 *     PiDcResetChildDeviceContainers @ 0x14071BC50 (PiDcResetChildDeviceContainers.c)
 *     _CmGetContainerBooleanProperty @ 0x14080A0C4 (_CmGetContainerBooleanProperty.c)
 * Callees:
...
__int64 __fastcall CmEnumDevicesInContainerWithCallback(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v9; // r14
  int v10; // eax
