/*
 * XREFs of EtwpUpdateGuidFilterData @ 0x1409E5684
 * Callers:
...
LABEL_7:
    ...
    if ( (v15 & 0x80000004) == 0x80000004 || (v4 & 0x80000004) == 0x80000004 )
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(v14 + *(_QWORD *)(a1 + 384) + 8LL), (__int64 *)(a4 + 8));
    if ( (v15 & 0x80000008) == 0x80000008 || (v4 & 0x80000008) == 0x80000008 )
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(v14 + *(_QWORD *)(a1 + 384) + 16LL), (__int64 *)(a4 + 16));
    if ( (v15 & 0x80000010) == 0x80000010 || (v4 & 0x80000010) == 0x80000010 )
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(v14 + *(_QWORD *)(a1 + 384) + 24LL), (__int64 *)(a4 + 24));
    if ( (v15 & 0x80000020) == 0x80000020 || (v4 & 0x80000020) == 0x80000020 )
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(v14 + *(_QWORD *)(a1 + 384) + 32LL), (__int64 *)(a4 + 32));
    if ( (v15 & 0x80008000) == 0x80008000 || (v4 & 0x80008000) == 0x80008000 )
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(v14 + *(_QWORD *)(a1 + 384) + 40LL), (__int64 *)(a4 + 40));
    if ( (v15 & 0x80001000) == 0x80001000 || (v4 & 0x80001000) == 0x80001000 )
    {
      v20 = (PVOID)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 48), *(_QWORD *)(a4 + 48));
      *(_QWORD *)(a4 + 48) = 0LL;
    }
    if ( (v15 & 0x80000200) == 0x80000200 || (v4 & 0x80000200) == 0x80000200 )
    {
      P = (PVOID)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 72), *(_QWORD *)(a4 + 72));
      *(_QWORD *)(a4 + 72) = 0LL;
    }
    if ( (v15 & 0x80000400) == 0x80000400 || (v4 & 0x80000400) == 0x80000400 )
    {
      v23 = (PVOID)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 96), *(_QWORD *)(a4 + 96));
      *(_QWORD *)(a4 + 96) = 0LL;
    }
    if ( (v15 & 0x80002000) == 0x80002000 || (v4 & 0x80002000) == 0x80002000 )
    {
      v10 = (void *)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 56), *(_QWORD *)(a4 + 56));
      *(_QWORD *)(a4 + 56) = 0LL;
    }
    if ( (v15 & 0x80004000) == 0x80004000 || (v4 & 0x80004000) == 0x80004000 )
    {
      v21 = (PVOID)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 64), *(_QWORD *)(a4 + 64));
      *(_QWORD *)(a4 + 64) = 0LL;
    }
    if ( (v15 & 0x80000100) == 0x80000100 || (v4 & 0x80000100) == 0x80000100 )
    {
      v11 = (void *)_InterlockedExchange64((volatile __int64 *)(*(_QWORD *)(a1 + 384) + v14 + 80), *(_QWORD *)(a4 + 80));
      *(_QWORD *)(a4 + 80) = 0LL;
    }
    v16 = (__int64 *)(a4 + 88);
    if ( *(_QWORD *)(*(_QWORD *)(a1 + 384) + v14 + 88) || *v16 )
    {
      v17 = a2;
      if ( *v16 )
        *(_QWORD *)(*v16 + 8) = 1LL << a2;
      EtwpUpdateEventFilterAndFree((volatile __int64 *)(*(_QWORD *)(a1 + 384) + 88LL + 104LL * a2), v16);
    }
    else
    {
      v17 = a2;
    }
    _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(a1 + 384) + 104LL * v17), v4);
