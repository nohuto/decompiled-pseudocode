/*
 * XREFs of MiMarkHotPatchesForHiberPhase @ 0x140B53300
 * Callers:
...
__int64 __fastcall MiMarkHotPatchesForHiberPhase(__int64 a1)
{
  ...
  result = MiEnumerateBasePatches(v1);
  if ( qword_140E37260 == v1 )
    return MiMarkHotPatchForHiberPhase(qword_140E37258);
  return result;
}
