/*
 * XREFs of KiUpdateHgsScores @ 0x140428B78
 * Callers:
 *     KeConfigureHeteroProcessors @ 0x14042819C (KeConfigureHeteroProcessors.c)
 * Callees:
 *     KiComputeHgsScore @ 0x140428DC0 (KiComputeHgsScore.c)
 */
...
__int64 __fastcall KiUpdateHgsScores(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v5 = 0;
  v6 = 0;
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v4 + 24); word_140FC441C[v28] = v26 )
  {
    v8 = 0;
    v9 = 0;
    v10 = 0;
    ...
    LOBYTE(a2) = v8;
    LOBYTE(a1) = v9;
    byte_140FC43FC[(unsigned int)i] = v8;
    byte_140FC43FC[(unsigned int)i + 8] = v10;
    v19 = KiComputeHgsScore(a1, a2, i, a4);
    word_140FC440C[v25] = v19;
    if ( v19 > v5 )
    {
      v5 = v19;
      v6 = v23;
  ...
  for ( result = (unsigned int)KeNumberProcessors_0; v29 < (unsigned int)KeNumberProcessors_0; ++v29 )
  {
    ...
    for ( j = KiProcessorBlock[v29]; (unsigned int)v31 < *(_DWORD *)(v4 + 24); *(_WORD *)(j + 2 * v44 + 34508) = v42 )
    {
      ...
      if ( v33 )
        ...
        v35 = 0;
      LOBYTE(i) = byte_140FC43FC[(unsigned int)v31 + 8];
      LOBYTE(v33) = v34;
      LOBYTE(a2) = byte_140FC43FC[(unsigned int)v31];
