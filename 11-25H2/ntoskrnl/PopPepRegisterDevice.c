/*
 * XREFs of PopPepRegisterDevice @ 0x140A929B0
 * Callers:
 ...
 *     PopPepComponentGetLatencyIdleState @ 0x1404585F0 (PopPepComponentGetLatencyIdleState.c)
  ...
  if ( v9 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *(_BYTE *)(v16 + 136) = 1;
      ...
      while ( (__int64)v20 < (__int64)RtlWorkSpaceProcs );
      *(_QWORD *)(v16 + 16) |= 1uLL;
      v22 = 0;
LABEL_16:
      if ( v22 >= v9 )
      ...
      else
      {
        ...
        *(_DWORD *)(v27 + 4) = 3;
        ...
        while ( (__int64)v26 < (__int64)RtlWorkSpaceProcs );
