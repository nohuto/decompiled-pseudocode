/*
 * XREFs of MiReplaceStandbyLookaside @ 0x140214750
 * Callers:
...
ULONG_PTR __fastcall MiReplaceStandbyLookaside(ULONG_PTR BugCheckParameter2, ULONG_PTR a2, int a3, int a4)
{
  ...
  v46 = v8;
  if ( BugCheckParameter2 < qword_140E358C0 || BugCheckParameter2 >= qword_140E358C0 + 2048 )
  {
  ...
  if ( dword_140E2D880 > (unsigned int)dword_140E2D884
    || (v12 = (char *)qword_140E2D8E0 + 16 * dword_140E2D880, BugCheckParameter2 < *(_QWORD *)v12)
    || dword_140E2D880 != dword_140E2D884 && BugCheckParameter2 >= *((_QWORD *)v12 + 2) )
  {
    for ( i = 0; ; i = v14 + 1 )
    {
      while ( 1 )
      {
        ...
        v14 = (i + v11) >> 1;
        v12 = (char *)qword_140E2D8E0 + 16 * v14;
      ...
      if ( v14 == dword_140E2D884 || BugCheckParameter2 < *((_QWORD *)v12 + 2) )
        break;
    }
  ...
  if ( (v15 & 0x8000000) != 0
    && (v8 < 0xFFFFDE0000000000uLL
     || v8 >= 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL
     || (v44 = 0xAAAAAAAAAAAAAAABuLL * (v6 >> 4), v44 >= qword_140E358C0) && v44 < qword_140E358C0 + 2048
     || (BYTE2(v15) & 7) != 6 && (unsigned int)MiGetPfnSlabType(v8, v44, 0xFFFFDE0000000030uLL) == 9) )
  {
    v16 = 5;
  }
  else
  ...
  {
    if ( v4 == 8 )
      BYTE8(v50) = *(_BYTE *)(qword_140E3CF00
  ...
  while ( 2 )
  {
    ...
    if ( v5 != -1LL || (result = MiFindSuitableLookasideReplacement(v19, v24, v25, v8, a4), !(_DWORD)result) )
    {
      ...
      *(_QWORD *)(v24 + 8 * v25) = v5;
      if ( v27 != -1LL )
      {
        if ( v27 < qword_140E358C0 || (result = qword_140E358C0 + 2048, v27 >= qword_140E358C0 + 2048) )
        {
          v28 = 48 * v27;
          ...
          v34 = dword_140E2D884;
          if ( dword_140E2D880 > (unsigned int)dword_140E2D884
            || (v35 = (ULONG_PTR *)((char *)qword_140E2D8E0 + 16 * dword_140E2D880), v27 < *v35)
            || dword_140E2D880 != dword_140E2D884 && v27 >= v35[2] )
          {
            for ( j = 0; ; j = v37 + 1 )
            {
              while ( 1 )
              {
                ...
                v37 = (j + v34) >> 1;
                v38 = (ULONG_PTR *)((char *)qword_140E2D8E0 + 16 * v37);
                if ( v27 >= *v38 )
                  break;
                if ( !v37 )
              ...
              if ( v37 == dword_140E2D884 || v27 < v38[2] )
                break;
            }
            dword_140E2D880 = (j + v34) >> 1;
          }
          v39 = *(_DWORD *)(v33 + 32);
          if ( (v39 & 0x8000000) != 0 && v33 >= 0xFFFFDE0000000000uLL && v33 < 48 * qword_140E2D9A0 - 0x21FFFFFFFFD0LL )
          {
            v43 = 0xAAAAAAAAAAAAAAABuLL * (v28 >> 4);
            if ( (v43 < qword_140E358C0 || v43 >= qword_140E358C0 + 2048) && (BYTE2(v39) & 7) != 6 )
              MiGetPfnSlabType(v28 - 0x220000000000LL, v43, v27);
          }
          if ( qword_140E2D8E8 )
      ...
      if ( v5 != -1LL )
      {
        if ( v5 < qword_140E358C0 || (result = qword_140E358C0 + 2048, v5 >= qword_140E358C0 + 2048) )
        {
