/*
 * XREFs of HalpTimerInitializeSystemWatchdog @ 0x14054856C
 * Callers:
...
LABEL_7:
    _InterlockedOr(v7, 0);
    off_140E00B08[0] = HalpTimerWatchdogStop;
    off_140E00AF8[0] = HalpTimerWatchdogStart;
    off_140E00B10[0] = HalpTimerWatchdogGeneratedLastReset;
    off_140E00B18[0] = (__int64 (__fastcall *)())HalpTimerWatchdogTriggerSystemReset;
    off_140E00BA8[0] = HalpTimerWatchdogQueryDueTime;
    _InterlockedOr(v7, 0);
    HalpTimerWatchdogStart();
    _InterlockedOr(v7, 0);
    off_140E00B00[0] = HalpTimerWatchdogResetCountdown;
    return 0;
  }
  return result;
}
