/*
 * XREFs of PnpProcessRelation @ 0x14082E994
 * Callers:
 *     PnpProcessRelation @ 0x14082E994 (PnpProcessRelation.c)
 *     PnpProcessBusRelations @ 0x14082ECEC (PnpProcessBusRelations.c)
 ...
 *     PnpProcessRelation @ 0x14082E994 (PnpProcessRelation.c)
 *     IopAddRelationToList @ 0x14082EC4C (IopAddRelationToList.c)
 *     PnpProcessBusRelations @ 0x14082ECEC (PnpProcessBusRelations.c)
 *     PnpProcessDependencyRelations @ 0x14082F9A8 (PnpProcessDependencyRelations.c)
...
LABEL_3:
  ...
  if ( v12 )
  {
    ...
    else if ( v12 != -1073741670 )
    {
      if ( *v11 )
      {
        IoAddTriageDumpDataBlock(*v11, (PVOID)*(unsigned __int16 *)(*v11 + 2LL));
        v64 = (__int64 *)(a1 + 32);
        v65 = *(_QWORD *)(*v11 + 8LL);
        if ( v65 )
        {
          IoAddTriageDumpDataBlock(*(_QWORD *)(*v11 + 8LL), (PVOID)(unsigned int)*(__int16 *)(v65 + 2));
          v64 = (__int64 *)(a1 + 32);
          v66 = *(_QWORD *)(*v11 + 8LL);
          if ( *(_WORD *)(v66 + 56) )
          {
            ...
            IoAddTriageDumpDataBlock(
              *(_QWORD *)(*(_QWORD *)(*v11 + 8LL) + 64LL),
              (PVOID)*(unsigned __int16 *)(*(_QWORD *)(*v11 + 8LL) + 56LL));
            v64 = (__int64 *)(a1 + 32);
          }
        }
        v67 = *v64;
...
LABEL_8:
  if ( ((unsigned int)(v15 - 777) <= 1 || (unsigned int)(v15 - 780) <= 1)
    && (int)PnpQueryDeviceRelations(*v11, 3LL, 0LL, P) >= 0 )
  {
...
LABEL_30:
  ...
  if ( a2 )
  {
    if ( a2 - 5 > 1 && (int)PnpQueryDeviceRelations(*(_QWORD *)(a1 + 32), 1LL, 0LL, P) >= 0 )
    {
      v16 = (unsigned int *)P[0];
      if ( P[0] )
      {
