/*
 * XREFs of Xp10CompressBuffer @ 0x14077A854
 * Callers:
 *     RtlCompressBufferXp10 @ 0x140778E60 (RtlCompressBufferXp10.c)
 * Callees:
 *     memset_0 @ 0x1406B4D40 (memset_0.c)
 *     Xp10ComputeAndWriteCrc @ 0x14077AE04 (Xp10ComputeAndWriteCrc.c)
 *     Xp10ExecuteHuffmanEncode @ 0x14077B660 (Xp10ExecuteHuffmanEncode.c)
 *     Xp10ExecuteLz77PassMinMatchLen3 @ 0x14077BAFC (Xp10ExecuteLz77PassMinMatchLen3.c)
 *     Xp10ExecuteLz77PassMinMatchLen4 @ 0x14077C254 (Xp10ExecuteLz77PassMinMatchLen4.c)
 *     Xp10ValidateParametersAndFillFrameHeader @ 0x14077D9C4 (Xp10ValidateParametersAndFillFrameHeader.c)
 */
...
LABEL_13:
      ...
      || (v24 = HIDWORD(v49) - DWORD2(v49), HIDWORD(v49) != DWORD2(v49)) )
    {
      ...
      if ( v27 >= v24 )
        v29 = v24;
      *v28 |= ((unsigned __int8)(BYTE8(v47) - BYTE8(v49)) & (unsigned __int8)byte_1400331C0[4 * v29]) << v25;
      ...
      if ( (_DWORD)v30 )
        *v32 |= (unsigned __int8)v31 & byte_1400331C0[4 * v30];
      v17 += v24;
    }
    v19 += v45;
    v16 = HIDWORD(v47);
  ...
  if ( v35 <= v18 || (v38 = v18 - v34, v18 != v34) )
  {
    ...
    *v36++ |= (byte_1400331C0[4 * v40] & 1) << v37;
    v42 = 1u >> v39;
    ...
    if ( (_DWORD)v41 )
      *v36 |= (unsigned __int8)v42 & byte_1400331C0[4 * v41];
  }
  DWORD2(v48) = 0;
  *(_QWORD *)&v48 = a2;
  HIDWORD(v48) = a3;
