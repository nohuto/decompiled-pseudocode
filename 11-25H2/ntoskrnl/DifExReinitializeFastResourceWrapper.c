/*
 * XREFs of DifExReinitializeFastResourceWrapper @ 0x140613EC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReinitializeFastResourceWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  ExReinitializeFastResource(BugCheckParameter2);
  if ( v3 )
  {
