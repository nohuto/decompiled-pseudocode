/*
 * XREFs of PopPlRegisterComponent @ 0x1404A0EC4
 * Callers:
 ...
 *     PopPlLookupComponentPowerProfile @ 0x1405D7800 (PopPlLookupComponentPowerProfile.c)
...
void __fastcall PopPlRegisterComponent(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E07680 > 5 )
  {
    ...
    v29[0] = v4;
    v26 = 2;
    tlgWriteEx_EtwWriteEx((int)&dword_140E07680, (int)&byte_14004D645, 2, 1, v8, v9, 8u, (__int64)v13);
  }
}
