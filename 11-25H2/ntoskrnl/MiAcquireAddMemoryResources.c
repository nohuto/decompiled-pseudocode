/*
 * XREFs of MiAcquireAddMemoryResources @ 0x1407D86E8
 * Callers:
 *     MiAddPhysicalMemory @ 0x1407D87AC (MiAddPhysicalMemory.c)
 * Callees:
 *     MiIsAnyPartOfRangeInHugePfn @ 0x1406651B8 (MiIsAnyPartOfRangeInHugePfn.c)
 *     MiAddRangeToPartitionTree @ 0x14067E0AC (MiAddRangeToPartitionTree.c)
 *     MiSplitPfnBitMapsForPartitionHierarchy @ 0x14067FC04 (MiSplitPfnBitMapsForPartitionHierarchy.c)
