/*
 * XREFs of CmpIsLoadType @ 0x140C3AE0C
 * Callers:
        ...
        ...)
{
  ...
  __int64 v38; // [rsp+D8h] [rbp+88h] BYREF
  ...
  {
    NodeName = CmpGetNodeName(BugCheckParameter3, CellPaged, (unsigned __int16 *)&v32);
    v15 = NodeName;
    if ( NodeName )
    {
      if ( RtlInitUnicodeStringEx(&DestinationString, NodeName) >= 0 )
      {
        ...
        if ( SubKeyByName != -1 )
        {
             ...
             : HvpGetCellPaged(v13, SubKeyByName, &v31) )
          {
            ...
            if ( (*(_BYTE *)(v13 + 140) & 1) != 0 )
              HvpReleaseCellFlat(v13, &v31);
            else
              HvpReleaseCellPaged(v13, (unsigned int *)&v31);
          }
        }
      }
    ...
    if ( !v20 )
      goto LABEL_58;
    v21 = CmpValueToData(BugCheckParameter3, v19, v20, (__int64)&v33, (__int64)&v29);
...
LABEL_42:
    ...
    if ( CellFlat )
    {
      v26 = CmpValueToData(v10, ValueByName, CellFlat, (__int64)&v33, (__int64)&a5);
      if ( (*(_BYTE *)(v10 + 140) & 1) != 0 )
