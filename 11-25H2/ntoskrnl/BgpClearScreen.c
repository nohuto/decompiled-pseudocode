/*
 * XREFs of BgpClearScreen @ 0x14068CAD8
 * Callers:
 ...
 * Callees:
 *     BgpGxFillRectangle @ 0x140474170 (BgpGxFillRectangle.c)
...
__int64 __fastcall BgpClearScreen(unsigned int a1)
{
  ...
  result = BgpGxInitializeRectangle(&v13, BitsPerPixel, dword_140E623C0, 0x2000LL);
  if ( (int)result >= 0 )
  {
    BgpGxFillRectangle((__int64)dword_140E623C0, a1);
    v12 = 0;
    for ( i = 0; v12 < v4; i = v12 )
    {
      ...
      if ( v3 )
      {
        do
        {
          BgpGxDrawRectangle(dword_140E623C0, (__int64)&v16);
          if ( (byte_140E623D0 & 0x10) != 0 )
            BgpGxFillRectangle((__int64)dword_140E623C0, a1);
          v16 += v9;
        }
        while ( v16 < v3 );
