/*
 * XREFs of MiMapMdlCommon @ 0x1404ECDC4
 * Callers:
...
__int64 __fastcall MiMapMdlCommon(char *a1, unsigned __int64 a2, __int64 a3, char a4, int a5)
{
  ...
  if ( v11 )
  {
    ...
    {
      v20 = v19[1];
      if ( v20 <= qword_140E2D9A0 )
      {
        if ( ((*(_QWORD *)(48 * v20 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
        {
          v21 = 48 * v20 - 0x220000000000LL;
          if ( !(unsigned __int16)*(_DWORD *)(v21 + 32) && dword_140E2FE0C == (_DWORD)v12 )
      ...
      if ( v11 - v17 > 1 )
      {
        ...
        if ( v25 != 1 )
        {
          do
          {
            ...
            if ( *v27 != *(v27 - 1) + 1
              || (v28 & 0x1FF) == 0
              || v28 <= qword_140E2D9A0 && ((*(_QWORD *)(48 * v28 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
            {
              break;
            }
            ++v14;
...
LABEL_41:
        v15 = (*(_DWORD *)(v54
                         + 4
                         * ((unsigned __int64)(2
                                             * (((unsigned int)v20 & ((unsigned int)(1LL << ((unsigned __int8)dword_140E2D8F8
                                                                                           - 12))
                                                                    - 1))
                                              - *(_DWORD *)(v54 + 24))) >> 5)
                         + 44) >> ((2
                                  * ((v20 & ((1LL << ((unsigned __int8)dword_140E2D8F8 - 12)) - 1))
                                   - *(_BYTE *)(v54 + 24))) & 0x1F)) & 3;
      }
      else
      {
  ...
  do
  {
    if ( v33 )
    {
      ...
      if ( ((unsigned __int16)v34 & 0xFFF) == 0 )
      {
        ...
        MiUnlockPageTable(v58, v31);
LABEL_73:
        v31 = (((unsigned __int64)v34 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
        MiLockNestedPageTable(v58, v31, a3, v11);
        LODWORD(v12) = 0;
      }
    }
    v36 = *(_QWORD *)&v34[v35 + 48];
    v37 = (int)v12;
    if ( v36 <= qword_140E2D9A0 )
    {
      CurrentIrql = 6 * v36;
