/*
 * XREFs of MiInsertPreviouslyRegisteredHotPatchRecord @ 0x1407E3654
 * Callers:
...
LABEL_27:
  ...
  LOBYTE(v2) = 1;
LABEL_24:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140E37240, (unsigned __int64)v9, v2, (_QWORD *)a1);
  return 1;
}
