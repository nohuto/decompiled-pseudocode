/*
 * XREFs of EtwpTraceFileName @ 0x1403D6EB0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall EtwpTraceFileName(
        __int64 a1,
        __int64 a2,
        unsigned __int16 *a3,
        __int64 a4,
        ...
        unsigned __int16 a6)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v27 = 0;
  v29 = 2LL;
  ServerSiloGlobals = (_QWORD *)(EtwpHostSiloState + 4540);
  if ( EtwpHostSiloState != -4540 && (*(_DWORD *)ServerSiloGlobals & 0x200) != 0 )
  {
    if ( a6 == 1056 )
    {
...
LABEL_8:
    ...
    v12 = *(_DWORD *)(EtwpHostSiloState + 4248);
    while ( 1 )
    {
      ...
      if ( v18 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v13 )
            break;
          v19 &= v19 - 1;
          ServerSiloGlobals = (_QWORD *)(v18 + 32LL * (unsigned int)v20 + 4284);
          if ( ServerSiloGlobals && (*(_DWORD *)ServerSiloGlobals & 0x200) != 0 )
            LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent(
                                           (struct _KTHREAD *)&UserData,
                                           v18,
                                           *(unsigned __int8 *)(v18 + 2 * v20 + 4232),
                                           3u,
                                           a6,
                                           0x501802u);
        }
  ...
  if ( !a4 || a4 == CurrentServerSilo )
  {
    ...
    if ( v17 )
      LODWORD(ServerSiloGlobals) = EtwpLogKernelEvent((struct _KTHREAD *)&UserData, v17, a5, 3u, v16, 0x501802u);
  }
  return (int)ServerSiloGlobals;
}
