/*
 * XREFs of KiAttemptBugcheckRecovery @ 0x1405C13E4
 * Callers:
 ...
 *     KiIsRecoveryPossibleOnCurrentStack @ 0x1405C20B4 (KiIsRecoveryPossibleOnCurrentStack.c)
...
LABEL_28:
  ...
  if ( (int)KiUpdateBugcheckRecoveryProgress(v9) < 0
    ...
    || (KiInvokeBugCheckEntryCallbacks(0x3FFu),
        v6[1] = (unsigned __int8)byte_140F0F347,
        v6[2] = dword_140F0F388,
        v6[0] = 1,
...
LABEL_27:
  ...
  if ( !byte_140F0F355 )
    v3 = 0LL;
  KiBugcheckRecoveryDumpPolicy = dword_140F0F388;
  if ( KiBugCheckShouldEnterPostBugCheckDebugger(dword_140F0F364, (__int64)v3) )
  {
    DbgPrintEx(
      0x65u,
      0,
    ...
    DbgPrintEx(
      ...
      "     Parameter 4: 0x%p\n",
      dword_140F0F364,
      (const void *)qword_140F0F368,
      (const void *)qword_140F0F370,
      (const void *)qword_140F0F378,
      (const void *)qword_140F0F380);
    DbgPrintEx(
      0x65u,
      0,
      "\n"
