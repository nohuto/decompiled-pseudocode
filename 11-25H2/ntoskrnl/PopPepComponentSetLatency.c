/*
 * XREFs of PopPepComponentSetLatency @ 0x1402C0F08
 * Callers:
  ...
  *(_QWORD *)(v5 + 112) = a3;
  if ( *(_DWORD *)(v5 + 156) != v6 )
  {
    *(_DWORD *)(v5 + 156) = v6;
    ...
    ComponentPreferedIdleState = PopPepGetComponentPreferedIdleState((_DWORD *)v5);
    if ( ComponentPreferedIdleState != *(_DWORD *)(v5 + 176) )
      PopPepTriggerActivity(a1, v5, 1, ComponentPreferedIdleState | 0x80000000);
    PopPepPromoteActivities(a1, v5, 2);
