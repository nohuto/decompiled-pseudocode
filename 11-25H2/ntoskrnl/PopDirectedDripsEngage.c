/*
 * XREFs of PopDirectedDripsEngage @ 0x14048D3F8
 * Callers:
...
__int64 __fastcall PopDirectedDripsEngage(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( a2 )
  {
    ...
    LOBYTE(a3) = 1;
    return PopDirectedDripsNotifyAppsAndServices(&PopDirectedDripsState, &dword_140F0D678, a3);
  }
  else
  {
    ...
    result = (unsigned int)dword_140F0D670;
    if ( (dword_140F0D670 & 4) != 0 )
