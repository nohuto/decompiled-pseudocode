/*
 * XREFs of MiGetCcAccessLog @ 0x1409CA6E0
 * Callers:
 ...
 *     MiInitializePageAccessLogging @ 0x140470C50 (MiInitializePageAccessLogging.c)
 */
...
__int64 __fastcall MiGetCcAccessLog(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( qword_140E3CDC0 )
  {
    v5 = _InterlockedExchange64(&qword_140E3CDC0, 0LL);
    if ( v5 )
    {
      v6 = *(_QWORD *)(v5 + 40);
