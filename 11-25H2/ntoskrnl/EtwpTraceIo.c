/*
 * XREFs of EtwpTraceIo @ 0x140310890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  {
    v17 &= v17 - 1;
    v20 = (_DWORD *)(EtwpHostSiloState + 32LL * (unsigned int)v19 + 4284);
    if ( v20 && (*v20 & 0x100) != 0 )
      EtwpLogKernelEvent(
        (struct _KTHREAD *)&v39,
        EtwpHostSiloState,
        *(unsigned __int8 *)(EtwpHostSiloState + 2 * v19 + 4232),
        1u,
        v16,
        0x501803u);
  }
  if ( ThreadServerSilo )
  {
    ...
    if ( v29 )
    {
      ...
      {
        v30 &= v30 - 1;
        v32 = (_DWORD *)(v29 + 32 * v31 + 4284);
        if ( v32 && (*v32 & 0x100) != 0 )
          EtwpLogKernelEvent(
            (struct _KTHREAD *)&v39,
            v29,
            *(unsigned __int8 *)(v29 + 2 * v31 + 4232),
            1u,
            v16,
            0x501803u);
      }
