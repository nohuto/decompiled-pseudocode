/*
 * XREFs of MiCreatePfnBitMaps @ 0x1407EA93C
 * Callers:
...
__int64 __fastcall MiCreatePfnBitMaps(__int64 a1, unsigned int *a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < 2; i = (unsigned int)(i + 1) )
  {
    ...
    v8 = MiReservePtes((__int64)&qword_140E37328, v7);
    if ( !v8 )
      goto LABEL_8;
  ...
  {
    v12 = MiReservePtes((__int64)&qword_140E37328, (2 * ((v2 >> 4) + ((v2 & 0xF) != 0)) + 4095) >> 12);
...
LABEL_14:
      v10 = v13;
LABEL_7:
      MiReleasePtes((__int64)&qword_140E37328, v10, v9);
      goto LABEL_8;
    }
    *(_QWORD *)(a1 + 16376) = v14;
  }
  v15 = ((v2 & 0x1FF) != 0) + (v2 >> 9);
  v16 = (2 * v15 + 4095) >> 12;
  v17 = MiReservePtes((__int64)&qword_140E37328, v16);
...
LABEL_8:
  ...
  *(_QWORD *)(a1 + 0x4000) = v19;
  for ( j = 0LL; (unsigned int)j < 3; j = (unsigned int)(j + 1) )
  {
    ...
    v23 = MiReservePtes((__int64)&qword_140E37328, v22);
  ...
  v25 = (v24 + 4095) >> 12;
  v26 = MiReservePtes((__int64)&qword_140E37328, v25);
  v13 = (unsigned __int64 *)v26;
  if ( !v26 )
    goto LABEL_8;
  v27 = v26 << 25 >> 16;
  ...
  *(_QWORD *)(a1 + 16440) = v27;
  if ( (ULONG *)a1 == &MiSystemPartition )
  {
    v29 = MiReservePtes((__int64)&qword_140E37328, v16);
