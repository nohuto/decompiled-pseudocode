/*
 * XREFs of MiChangeSlabIdentitiesDpc @ 0x14067ADB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiChangeSlabIdentitiesDpc(__int64 a1, __int64 a2, volatile signed __int32 *a3, unsigned __int64 a4)
{
  ...
  int v22; // esi
  __int32 v23[14]; // [rsp+30h] [rbp-38h] BYREF
  __int32 v24; // [rsp+88h] [rbp+20h] BYREF
  ...
  {
    v23[0] = _InterlockedExchange((volatile __int32 *)a4, *(_DWORD *)(a4 + 4) | v16);
    if ( (v23[0] & 0x40000000) != 0 )
