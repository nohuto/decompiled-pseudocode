/*
 * XREFs of PopBatteryTraceSystemBatteryStatusV1 @ 0x1405D318C
 * Callers:
...
char __fastcall PopBatteryTraceSystemBatteryStatusV1(char a1)
{
  ...
  if ( PopBatteryEtwRegistered )
  {
    ...
    if ( (_BYTE)v1 )
    {
      if ( BYTE1(xmmword_140F0ACC0) )
      {
        v14 = xmmword_140F0AAE0;
        v13 = 1;
        if ( DWORD2(xmmword_140F0ACC0) )
          v11 = 100000 * (unsigned __int64)HIDWORD(xmmword_140F0ACC0) / DWORD2(xmmword_140F0ACC0);
        else
          LODWORD(v11) = 0;
        v4 = DWORD1(xmmword_140F0ACF0);
        v5 = xmmword_140F0ACF0;
        v6 = HIDWORD(xmmword_140F0ACE0);
        v7 = DWORD2(xmmword_140F0ACE0);
        v8 = DWORD1(xmmword_140F0ACE0);
        v9 = xmmword_140F0ACE0;
        v10 = xmmword_140F0ACD0;
        v15 = v11;
        v3 = DWORD2(xmmword_140F0ACF0);
      }
      else
      {
        v3 = -1;
