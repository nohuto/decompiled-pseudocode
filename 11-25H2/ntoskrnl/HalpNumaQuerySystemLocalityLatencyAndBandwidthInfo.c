/*
 * XREFs of HalpNumaQuerySystemLocalityLatencyAndBandwidthInfo @ 0x140555AA0
 * Callers:
 *     <none>
 * Callees:
 *     HalpNumaQueryProximityId @ 0x140555A10 (HalpNumaQueryProximityId.c)
 *     HalpNumaQueryProximityNode @ 0x140555A50 (HalpNumaQueryProximityNode.c)
 *     HalpNumaSystemLocalityInfoFindInitiatorIndex @ 0x14055624C (HalpNumaSystemLocalityInfoFindInitiatorIndex.c)
 *     HalpNumaSystemLocalityInfoFindTargetIndex @ 0x14055629C (HalpNumaSystemLocalityInfoFindTargetIndex.c)
 *     HalpNumaSystemLocalityInfoIncludeQueryDataType @ 0x1405562F4 (HalpNumaSystemLocalityInfoIncludeQueryDataType.c)
