...
LABEL_19:
      ...
      if ( v18 >= 0 )
      {
        ...
        v18 = 0;
        guard_dispatch_icall_no_overrides(a4);
        if ( v19 )
      ...
      {
        v21 = (__int64 *)&unk_140E35B40;
        if ( (ProtectionMask & 0x18) == 0 )
          v21 = &qword_140E37328;
        MiReleasePtes((__int64)v21, (unsigned __int64 *)v15, v10);
      }
