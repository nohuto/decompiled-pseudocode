/*
 * XREFs of IovUtilMarkStack @ 0x1404ABDD4
 * Callers:
 *     PipCallDriverAddDevice @ 0x1409ACAC0 (PipCallDriverAddDevice.c)
 * Callees:
 *     IovUtilMarkDeviceObject @ 0x1404ABE50 (IovUtilMarkDeviceObject.c)
 *     VfDevObjAdjustFdoForVerifierFilters @ 0x140B82224 (VfDevObjAdjustFdoForVerifierFilters.c)
 */
