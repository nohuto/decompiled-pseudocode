/*
 * XREFs of EtwpCoverageSamplerStart @ 0x1407A3978
 * Callers:
...
__int64 __fastcall EtwpCoverageSamplerStart(ULONG_PTR a1)
{
  ...
  *(_QWORD *)(a1 + 1688) = Table;
  ...
  v10 = KeAbPreAcquire((__int64)&EtwpCovSampGlobals, 0LL);
  v11 = v10;
  ...
  if ( ImageNotifyRoutine >= 0 )
  {
    ...
    qword_140EFE8F8 = a1;
    _InterlockedExchange64((volatile __int64 *)&stru_140EFE900, 0LL);
    *(_DWORD *)(a1 + 1660) |= 1u;
