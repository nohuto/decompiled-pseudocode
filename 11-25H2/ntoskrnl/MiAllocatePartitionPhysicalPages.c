/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x1407EB814
 * Callers:
 ...
 *     MiHugeRangeIsZeroed @ 0x1406650C4 (MiHugeRangeIsZeroed.c)
 *     MiHugePageOperation @ 0x14067A330 (MiHugePageOperation.c)
 *     MiAddMdlToPartitionTree @ 0x14067DFC0 (MiAddMdlToPartitionTree.c)
...
__int64 __fastcall MiAllocatePartitionPhysicalPages(ULONG *a1, __int64 a2, unsigned __int64 a3, int a4, __int16 a5)
{
  ...
  if ( (a5 & 1) != 0 )
  {
    v15 = (unsigned int *)(qword_140E2D890 + 4LL * a4 * (unsigned int)(unsigned __int16)KeNumberNodes);
...
LABEL_53:
    ...
    {
      v54 = (v5 & 0x580) == 0;
      for ( j = MiFindLargeNodePage((__int64)v6, v14, v22, v54, v11, 1, v71);
            ;
            j = MiFindLargeNodePage((__int64)v6, *v15, v50, v54, v11, 1, v71) )
      {
        v59 = j;
        v32 = j;
        if ( j )
