/*
 * XREFs of PopPolicyDeviceHandleWakeAlarmNotification @ 0x14074E1A4
 * Callers:
...
LABEL_11:
    ...
    if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x400000000000LL) )
    {
      ...
      *(_QWORD *)&Event.Header.Lock = 0x1000000LL;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_14004B30B,
        0LL,
        0LL,
        0xEu,
        &v31);
  ...
  if ( !v10 || v4 )
  {
    PopChangeCapability(&byte_140F0B8D3, 0LL);
    v15 = 0LL;
    v16 = 0;
  }
  else
  {
    LOBYTE(v9) = 1;
    PopChangeCapability(&byte_140F0B8D3, v9);
    v15 = v29;
    v16 = v30;
  }
  dword_140F07C50 = v16;
