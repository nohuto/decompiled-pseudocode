/*
 * XREFs of MiUnlinkHugeRange @ 0x1404ED7BC
 * Callers:
...
unsigned __int64 __fastcall MiUnlinkHugeRange(__int64 a1, int a2)
{
  ...
  v23 = dword_140E2D980[0];
  v3 = a2 & 0x3FFFFF;
  v4 = v3 << 18;
  v21 = MiPageToChannel(v3 << 18);
  v6 = (unsigned int)MiPageToNode(v3 << 18);
  v22 = 0;
  v7 = (unsigned __int64 *)(qword_140E2FD80 + 8 * v3);
  v8 = *v7;
  v9 = *v7 & 7;
  if ( v9 == 2 )
  {
    if ( (v8 & 0x800000000000000LL) != 0 )
      MiPageListCollision(qword_140E2FD80 + 8 * v3);
    v10 = 1;
  }
  else if ( v9 == 1 )
  {
  ...
  if ( ((v12 >> 37) & 0x3FFFFF) != 0 )
    *(_QWORD *)(qword_140E2FD80 + 8 * ((v12 >> 37) & 0x3FFFFF)) = v15 ^ (*(_QWORD *)(qword_140E2FD80
  ...
  {
    v18 = v21;
    *(_QWORD *)(qword_140E2FD80 + 8 * v16) = (v14 << 37) ^ (*(_QWORD *)(qword_140E2FD80 + 8 * v16) ^ (v14 << 37)) & 0xF800001FFFFFFFFFuLL;
  }
  else
  {
    if ( v10 == 5 )
    ...
    else
    {
      ...
      MiUpdateHugeRangeZeroFreeBitmap(
        v11,
        (unsigned int)(v4 >> 18) % dword_140E2D980[0],
        (unsigned __int8)((unsigned int)(v4 >> 18) % dword_140E2D980[0]) | ((v21 & 1 | (2 * (v17 | 0x200u))) << 8),
        0LL);
    }
