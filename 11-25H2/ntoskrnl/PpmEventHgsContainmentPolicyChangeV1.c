/*
 * XREFs of PpmEventHgsContainmentPolicyChangeV1 @ 0x1405D4A3C
 * Callers:
...
char __fastcall PpmEventHgsContainmentPolicyChangeV1(__int64 a1, __int64 a2, __int64 a3, char a4, char a5, char a6)
{
  char v6; // si
