/*
 * XREFs of SymCryptEcpointAdd @ 0x14052BED8
 * Callers:
...
{
  return ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64, int, __int64, __int64))qword_140006CA0[16 * (unsigned __int64)(*(_DWORD *)(a1 + 4) & 7)])(
           a1,
           a2,
           a3,
           a4,
