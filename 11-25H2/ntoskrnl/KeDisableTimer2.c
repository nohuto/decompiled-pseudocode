/*
 * XREFs of KeDisableTimer2 @ 0x14036F62C
 * Callers:
 ...
 *     ExpDeleteTimer2 @ 0x140A42920 (ExpDeleteTimer2.c)
 * Callees:
...
LABEL_20:
  if ( v12 && !v29 )
  {
    ...
    if ( updated )
    {
      EtwTraceTimedEvent(0xF6Bu, 0x40020000u, (__int64)&v31, 32, 0x500E02u, (__int64)v35);
    }
    else
    {
      LOBYTE(v34) = v25 | 4;
      EtwTraceTimedEvent(0xF6Bu, 0x40020000u, (__int64)&v31, 32, 0x602u, (__int64)v35);
    }
  }
  return v26;
}
