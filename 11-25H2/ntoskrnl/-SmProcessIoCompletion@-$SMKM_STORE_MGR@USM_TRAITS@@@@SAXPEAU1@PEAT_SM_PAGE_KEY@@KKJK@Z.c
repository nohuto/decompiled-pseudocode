/*
 * XREFs of ?SmProcessIoCompletion@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KKJK@Z @ 0x1403D57A0
 * Callers:
        ...
        int a6)
{
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 440), 0LL) )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)(a1 + 440), v12, a1 + 440);
  if ( v14 )
    *((_BYTE *)v14 + 10) = 1;
  v15 = *((_QWORD *)&v33 + 1);
  v16 = v33;
...
LABEL_12:
    ...
    if ( !v19
      ...
      || (unsigned int)SmArrayGrow(v18, v17, (unsigned int *)v37 + 1, (const void **)&v35) )
    {
      v21 = v35;
      goto LABEL_12;
    }
