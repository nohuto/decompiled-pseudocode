/*
 * XREFs of VfFlushAdapterBuffers @ 0x140B76250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViGetMapRegisterFile @ 0x140B78FD0 (ViGetMapRegisterFile.c)
...
char __fastcall VfFlushAdapterBuffers(int a1, ULONG_PTR a2, const void *a3, const void *a4, int a5, char a6)
{
    ...
    && (MapRegisterFile = ViGetMapRegisterFile(a3)) != 0 )
  {
    ...
    {
      v14 = guard_dispatch_icall_no_overrides(RealDmaAdapter);
    ...
    else
    {
      if ( a5 )
      {
        ViHalPreprocessOptions(
          ...
          a3,
          a4);
        VfReportIssueWithOptions(0xE6u, 0x20uLL, (ULONG_PTR)a3, (ULONG_PTR)a4, a2, byte_140E0E790);
      }
      return 0;
    }
  }
