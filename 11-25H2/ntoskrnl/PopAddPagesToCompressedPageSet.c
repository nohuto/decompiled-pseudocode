/*
 * XREFs of PopAddPagesToCompressedPageSet @ 0x140B4C3C0
 * Callers:
        ...
        __int64 a7)
{
  ...
  v13 = (UCHAR *)a4;
  v15 = *(_DWORD *)(a2 + 160);
  v16 = *((_QWORD *)qword_140F0AE08 + 5) - *((_QWORD *)qword_140F0AE08 + 7);
  if ( !v15 || (v17 = *(_DWORD *)(a2 + 164), (int)(100 * v17 / v15) > dword_140F0ADA4) )
  {
    if ( v16 >= (__int64)((unsigned __int64)*((unsigned int *)qword_140F0AE08 + 2) >> 1) )
    {
      v12 = 1;
      goto LABEL_11;
    }
