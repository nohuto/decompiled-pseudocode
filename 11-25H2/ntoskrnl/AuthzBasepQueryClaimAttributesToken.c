/*
 * XREFs of AuthzBasepQueryClaimAttributesToken @ 0x140A05194
 * Callers:
 ...
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140A05248 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
