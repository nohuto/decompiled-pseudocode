/*
 * XREFs of PpmIdleCheckCoordinatedDependencies @ 0x1405C9818
 * Callers:
 ...
 *     PpmIdleCheckCoordinatedDependency @ 0x1405C998C (PpmIdleCheckCoordinatedDependency.c)
 *     PpmIdleCheckCoordinatedProcessorDependency @ 0x1405C9C94 (PpmIdleCheckCoordinatedProcessorDependency.c)
