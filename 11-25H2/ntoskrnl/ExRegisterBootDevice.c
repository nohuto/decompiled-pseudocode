/*
 * XREFs of ExRegisterBootDevice @ 0x140649CF0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_DWORD *)a1 == 1 && *(_QWORD *)(a1 + 8) && !*(_DWORD *)(a1 + 4) && *(_QWORD *)(a1 + 24) )
    {
      ...
      if ( Pool2 )
      {
        ...
        *(_QWORD *)(Pool2 + 56) = *(_QWORD *)(a1 + 32);
        ...
        v8 = (_QWORD *)qword_140EFA3C8;
        v9 = (_QWORD *)(Pool2 + 8);
        if ( *(__int64 **)qword_140EFA3C8 != &ExBootDeviceList )
          __fastfail(3u);
        *(_QWORD *)(Pool2 + 16) = qword_140EFA3C8;
        *v9 = &ExBootDeviceList;
        *v8 = v9;
        qword_140EFA3C8 = Pool2 + 8;
