/*
 * XREFs of PnpIsDeviceInstanceEnabled @ 0x140A5BF4C
 * Callers:
...
__int64 __fastcall PnpIsDeviceInstanceEnabled(void *a1, unsigned __int16 *a2, int a3)
{
  ...
  int v25[3]; // [rsp+44h] [rbp-Ch] BYREF
...
LABEL_29:
    ...
    if ( (int)CmOpenDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, v3, 16, 0, 131097, 0, (__int64)&Handle, 0LL) >= 0 )
    {
      v17 = Handle;
      v7 = 1;
      goto LABEL_16;
