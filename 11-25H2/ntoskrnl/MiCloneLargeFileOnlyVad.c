/*
 * XREFs of MiCloneLargeFileOnlyVad @ 0x1407DFF34
 * Callers:
...
__int64 __fastcall MiCloneLargeFileOnlyVad(__int64 a1)
{
  ...
  v4 = v7;
  v5 = 0LL;
  while ( (unsigned int)MiIncrementLargeSubsections((__int64 *)v4, *((unsigned int *)v4 + 11)) != -1 )
  {
    if ( v4 == v8 )
      return 0LL;
    v5 = (__int64 *)v4;
  ...
  if ( v5 )
    MiDecrementLargeSubsections((__int64 *)v7, v5);
  return 3221225626LL;
}
