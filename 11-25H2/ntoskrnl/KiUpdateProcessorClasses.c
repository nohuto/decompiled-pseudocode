/*
 * XREFs of KiUpdateProcessorClasses @ 0x140428894
 * Callers:
...
LABEL_7:
          ...
          while ( 1 )
          {
            if ( v7 )
            {
              ...
              v7 &= ~(1LL << v12);
              v13 = *((unsigned int *)qword_140F216A8 + 64 * v9 + (unsigned int)(unsigned __int8)v12);
              ...
              *(_BYTE *)(v14 + 35337) = *(_BYTE *)(v3 + 4LL * (unsigned int)v15 + 25);
              v17 = (_QWORD *)((char *)&unk_140FC7828 + 32 * *(unsigned __int8 *)(v14 + 208));
              v23 = v8;
          ...
          ++v5;
          v20 = v26 + 32 * v19;
          *(_BYTE *)(v20 + v27 + 564) = v10;
          *(_BYTE *)(v20 + v27 + 308) = v23;
          v3 = i;
        }
