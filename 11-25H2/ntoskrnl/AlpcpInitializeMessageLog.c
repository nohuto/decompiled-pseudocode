/*
 * XREFs of AlpcpInitializeMessageLog @ 0x140736C10
 * Callers:
...
__int64 __fastcall AlpcpInitializeMessageLog(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  qword_140F0EB88 = (__int64)&AlpcpMessageLogListHead;
  AlpcpMessageLogListHead = (__int64)&AlpcpMessageLogListHead;
  qword_140F0EB78 = (__int64)&AlpcpFreeMessageLogListHead;
  AlpcpFreeMessageLogListHead = (__int64)&AlpcpFreeMessageLogListHead;
  qword_140F0EBA8 = (__int64)&AlpcpFreeMessageSnapshotListHead;
...
LABEL_9:
    ...
    if ( a1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13[7] = v13 + 6;
        v13[6] = v13 + 6;
        v14 = (_QWORD *)qword_140F0EB78;
        if ( *(__int64 **)qword_140F0EB78 != &AlpcpFreeMessageLogListHead )
          break;
        v13[1] = qword_140F0EB78;
        ++v11;
        *v13 = &AlpcpFreeMessageLogListHead;
        *v14 = v13;
        v12 = v11;
        qword_140F0EB78 = (__int64)v13;
        if ( v11 >= a1 )
          goto LABEL_16;
      }
LABEL_21:
...
LABEL_16:
    if ( a2 )
    {
      ...
      while ( 1 )
      {
        v16 = (_QWORD *)qword_140F0EBA8;
        v17 = (_QWORD *)(v10 + 120 * v15);
        if ( *(__int64 **)qword_140F0EBA8 != &AlpcpFreeMessageSnapshotListHead )
          break;
        *v17 = &AlpcpFreeMessageSnapshotListHead;
        ++v2;
        v17[1] = v16;
        *v16 = v17;
        qword_140F0EBA8 = (__int64)v17;
        v15 = v2;
        if ( v2 >= a2 )
          return 0LL;
      }
