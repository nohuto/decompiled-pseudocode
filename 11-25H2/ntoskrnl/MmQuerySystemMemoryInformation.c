/*
 * XREFs of MmQuerySystemMemoryInformation @ 0x1403BDCA8
 * Callers:
...
__int64 __fastcall MmQuerySystemMemoryInformation(_OWORD *a1)
{
  ...
  *(_QWORD *)&v2 = qword_140E37310;
  *((_QWORD *)&v2 + 1) = qword_140E2C808;
  *(_QWORD *)&v3 = qword_140E3D680;
  *((_QWORD *)&v3 + 1) = qword_140E3D500;
  result = 0LL;
  *a1 = v2;
  a1[1] = v3;
  return result;
