/*
 * XREFs of PspSelectMachineForProcess @ 0x140A09390
 * Callers:
 ...
 *     PsGetProcessMachine @ 0x140A094F0 (PsGetProcessMachine.c)
...
__int64 __fastcall PspSelectMachineForProcess(__int64 a1, __int64 a2, __int16 *a3)
{
  ...
  {
    ProcessMachine = PsGetProcessMachine(a1, 34404LL, 1LL);
    v12 = -31132;
  ...
  if ( !v5 )
  {
    ...
    if ( v9 )
      v14 = v9;
    v9 = v14;
    if ( v14 != v3 && !(unsigned int)PdcCreateWatchdogAroundClientCall() )
    {
      if ( v10 )
        return 3221225595LL;
      v9 = v3;
