/*
 * XREFs of PopTransitionTelemetryOsState @ 0x140A81BA4
 * Callers:
...
LABEL_32:
      ...
      case 6:
        ...
        goto LABEL_34;
      default:
        if ( a2 == 8 && (unsigned int)dword_140E0756C < MEMORY[0xFFFFF7800000037C] )
        {
          if ( !dword_140E07568 )
...
LABEL_14:
  ...
  v4 = dword_140F0A1A8;
  if ( a1 != 5 || dword_140F0A170 == 1 || (unsigned int)(dword_140F0A170 - 4) <= 1 )
  {
    v8 = MEMORY[0xFFFFF78000000008] - qword_140F0A188 - MEMORY[0xFFFFF780000003B0];
    v9 = v8 / 0x2710 - qword_140F0A198;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_140F0A180) / 0x2710uLL;
    qword_140F0A198 = v8 / 0x2710;
    v11 = v10 - qword_140F0A190;
    qword_140F0A190 = v10;
    v12 = v11;
    if ( v9 <= v11 )
      v12 = v9;
    ...
    v39 = (__m128i)xmmword_140F0ACC0;
    v46 = xmmword_140F0ACC0;
    ...
    if ( (unsigned int)dword_140E07680 > 5 && tlgKeywordOn((__int64)&dword_140E07680, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140049803,
        0LL,
        0LL,
        0x16u,
        &v47);
