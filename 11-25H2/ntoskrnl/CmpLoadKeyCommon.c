/*
 * XREFs of CmpLoadKeyCommon @ 0x140465264
 * Callers:
 ...
 *     CmpSetGlobalQuotaAllowed @ 0x1407C2C80 (CmpSetGlobalQuotaAllowed.c)
        ...
        __int64 a11)
{
  ...
  *(_DWORD *)(a1 + 4112) |= 1u;
  ...
  if ( a4 && !v15 )
  {
    ...
    LOBYTE(v31) = a7;
    v26 = CmpJoinClassOfTrust(a1, *(_QWORD *)(*(_QWORD *)(a4 + 8) + 32LL), v31);
    v20 = v26;
    if ( v26 < 0 )
    {
      v33 = 32;
...
LABEL_20:
  ...
  *v23 = v24;
  ...
  if ( v30 )
  {
    TmEnableCallbacks(*(PKRESOURCEMANAGER *)(v30 + 56), CmKtmNotification, *(PVOID *)(a1 + 4152));
