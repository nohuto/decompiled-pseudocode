/*
 * XREFs of ?SmCompressCtxCompleteEntry@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU_SM_COMPRESS_THREAD_CTX@1@PEAU_SM_WORK_ITEM@1@KKJ@Z @ 0x1403A142C
 * Callers:
        ...
        int a5)
{
  ...
  *(_QWORD *)(v5 + 128) = a2;
  if ( !*(_DWORD *)(v5 + 140) && (*(_QWORD *)a2 & 0xFFFFFFFFFFFFFFF8uLL) >= 0x80 )
  {
    LOBYTE(v16) = v15;
    *(_DWORD *)(v5 + 140) = 1;
    SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxProcessReadyQueue(v5, *a1, v16);
  }
  ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(v5 + 136), v15);
}
