/*
 * XREFs of MiFindEmptyAddressRangeInTree @ 0x140A15654
 * Callers:
 *     MiFindEmptyAddressRange @ 0x1408FFD20 (MiFindEmptyAddressRange.c)
 * Callees:
 *     MiHonorRangeStraddleRequirement @ 0x14045A84C (MiHonorRangeStraddleRequirement.c)
 */
        ...
        _QWORD *a7)
{
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      v26 = MiHonorRangeStraddleRequirement(v24, v11, v9, 0);
      v7 = v29;
      v24 = v26;
    }
    if ( v24 > v15 )
      return (unsigned int)-1073741801;
    v25 = *(unsigned int *)(i + 24) | ((unsigned __int64)*(unsigned __int8 *)(i + 32) << 32);
    if ( v25 > v24 && v11 <= v25 - v24 && v11 <= v15 - v24 + 1 )
    {
      *a7 = v24 << 12;
      return v8;
    }
