/*
 * XREFs of HalGetScatterGatherListDmarThin @ 0x14045F870
 * Callers:
 *     <none>
 * Callees:
 *     HalpGetNumberOfSGElementsDmarThin @ 0x14045FB64 (HalpGetNumberOfSGElementsDmarThin.c)
        ...
        __int64 a7)
{
  ...
  if ( v7 )
  {
    ...
    if ( Pool2 )
    {
      ...
      *(_DWORD *)(v15 + 32) = 1;
      *(_BYTE *)(v15 + 114) = 0;
      v17 = HalpConstructScatterGatherListDmarThin(v15 + 16);
      if ( v17 < 0 && *(_BYTE *)(v15 + 113) )
