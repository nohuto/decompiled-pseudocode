/*
 * XREFs of KiFindRankBiasedIdleSmtSet @ 0x1403F777C
 * Callers:
...
char __fastcall KiFindRankBiasedIdleSmtSet(__int64 a1, _QWORD *a2)
{
  ...
  do
  {
    ...
    v6 = 1LL << v5;
    v3 ^= 1LL << v5;
    v7 = KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)(v4 + v5))];
    ...
    else
    {
      ...
      if ( (*(_DWORD *)(KiProcessorBlock[*((unsigned int *)qword_140F216A8 + (unsigned int)(v4 + v9))] + 236) & 0x200) != 0 )
        v2 |= v6;
    }
  }
  while ( v3 );
