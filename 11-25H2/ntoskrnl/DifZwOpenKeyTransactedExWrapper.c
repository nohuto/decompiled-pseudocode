/*
 * XREFs of DifZwOpenKeyTransactedExWrapper @ 0x140635D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenKeyTransactedExWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        HANDLE TransactionHandle)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v11 = 0;
    *((_QWORD *)&v18 + 1) = a1;
    *((_QWORD *)&v16 + 1) = TransactionHandle;
    LODWORD(v18) = a2;
    *((_QWORD *)&v17 + 1) = a3;
    LODWORD(v17) = a4;
  ...
  LODWORD(v19) = ZwOpenKeyTransactedEx(a1, a2, a3, a4, TransactionHandle);
  if ( v9 )
  {
