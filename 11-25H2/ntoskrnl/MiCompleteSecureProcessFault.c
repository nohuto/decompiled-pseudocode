/*
 * XREFs of MiCompleteSecureProcessFault @ 0x1403F3164
 * Callers:
...
__int64 __fastcall MiCompleteSecureProcessFault(__int64 *a1, __int64 *a2, __int64 a3)
{
  ...
  v7 = *((_QWORD *)qword_140E2FD48 + ((*(_QWORD *)(v3 + 40) >> 43) & 0x3FFLL));
...
LABEL_6:
    ...
    if ( SlabPage != -1 )
    {
      ...
      if ( (unsigned int)MiTradeActivePage(v3, 48 * (int)SlabPage, v9, 0, 0) )
      {
