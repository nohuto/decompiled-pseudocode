/*
 * XREFs of PfSnLogScenarioDecision @ 0x14082682C
 * Callers:
        ...
        __int64 a8)
{
  ...
  _BYTE v33[4]; // [rsp+70h] [rbp-90h] BYREF
  ...
  const WCHAR *v39; // [rsp+E0h] [rbp-20h]
  int v40; // [rsp+E8h] [rbp-18h]
  int v41; // [rsp+ECh] [rbp-14h]
  const WCHAR *v42; // [rsp+F0h] [rbp-10h]
  ...
  v22 = 0;
  v28 = 0;
  if ( qword_140E66E48 && EtwEventEnabled(qword_140E66E48, &PfSnEvt_ScenarioDecision_Info) )
  {
    v16 = -1LL;
    do
      ++v16;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v55 = 4LL;
    v54 = &v28;
    EtwWrite(qword_140E66E48, &PfSnEvt_ScenarioDecision_Info, 0LL, 9u, &UserData);
  }
  ProcessTelemetryInfo = EtwQueryProcessTelemetryInfo(BugCheckParameter1, v33, 0x60uLL, 0LL);
  v15 = 0;
  ...
  if ( (unsigned int)dword_140E074B8 > 4 )
  {
    ...
    if ( (_BYTE)ProcessTelemetryInfo )
    {
      ...
      LOBYTE(ProcessTelemetryInfo) = tlgWriteTransfer_EtwWriteTransfer(
                                       ...
                                       (unsigned __int8 *)byte_140047E41,
                                       0LL,
                                       0LL,
                                       0xAu,
                                       &v56);
