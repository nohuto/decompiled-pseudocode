/*
 * XREFs of FsRtlpCancelOplockRHIrp @ 0x14041B390
 * Callers:
...
void __fastcall FsRtlpCancelOplockRHIrp(__int64 a1, char a2, char a3)
{
  ...
  char v20[32]; // [rsp+70h] [rbp-F8h] BYREF
  ...
  char v29[32]; // [rsp+D0h] [rbp-98h] BYREF
  ...
  if ( (unsigned int)dword_140E06C30 > 5 )
  {
    ...
    v34 = &v15;
    v35 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(&dword_140E06C30, byte_1400434A5, 0LL, 0LL, 5, v29);
  }
  v6 = 0;
  v12 = 0;
  if ( !a2 )
  ...
  if ( (unsigned int)dword_140E06C30 > 5 )
  {
    ...
    v27 = &v14;
    v28 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(&dword_140E06C30, byte_14004343B, 0LL, 0LL, 6, v20);
  }
}
