/*
 * XREFs of DifIoOpenDeviceInterfaceRegistryKeyWrapper @ 0x14061D900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoOpenDeviceInterfaceRegistryKeyWrapper(
        ...
        PHANDLE DeviceInterfaceRegKey)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v9 = 0;
    *((_QWORD *)&v16 + 1) = SymbolicLinkName;
    LODWORD(v16) = DesiredAccess;
    *((_QWORD *)&v15 + 1) = DeviceInterfaceRegKey;
  ...
  LODWORD(v17) = IoOpenDeviceInterfaceRegistryKey(SymbolicLinkName, DesiredAccess, DeviceInterfaceRegKey);
  if ( v7 )
  {
