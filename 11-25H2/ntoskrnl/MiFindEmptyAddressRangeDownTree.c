/*
 * XREFs of MiFindEmptyAddressRangeDownTree @ 0x140900480
 * Callers:
...
LABEL_22:
    ...
    if ( v12 )
    {
      v37 = MiHonorRangeStraddleRequirement(v30, v44, v12, 0);
      v14 = a6 >> 12;
      v30 = v37;
      v13 = v38;
    }
    if ( v30 <= v17 )
    {
      v32 = (unsigned __int8)v23[32];
      v33 = *((unsigned int *)v23 + 6);
      v34 = v14;
      v35 = v33 | (v32 << 32);
      if ( v35 <= v14 )
        v34 = v35;
      if ( v34 > v30 && v13 <= v34 - v30 )
        break;
    }
    if ( v21 == v41 )
      return 3221225495LL;
  ...
  v36 = v29 & (v34 - v13);
  if ( v12 )
    v36 = v29 & MiHonorRangeStraddleRequirement(v36, v44, v12, 1);
  *a7 = v36 << 12;
  return 0LL;
}
