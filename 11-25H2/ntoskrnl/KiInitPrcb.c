/*
 * XREFs of KiInitPrcb @ 0x140B46260
 * Callers:
 ...
 *     KiIntSteerInitPrcb @ 0x1405C0234 (KiIntSteerInitPrcb.c)
 *     KiInitializeBugcheckRecoveryProcessor @ 0x1405C2028 (KiInitializeBugcheckRecoveryProcessor.c)
