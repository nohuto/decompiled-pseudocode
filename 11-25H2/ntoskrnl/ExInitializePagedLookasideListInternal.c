/*
 * XREFs of ExInitializePagedLookasideListInternal @ 0x140460340
 * Callers:
...
LABEL_8:
  v16 = (_QWORD *)qword_140EFA338;
  v17 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_140EFA338 != &ExPagedLookasideListHead )
    __fastfail(3u);
  *v17 = &ExPagedLookasideListHead;
  v17[1] = v16;
  *v16 = v17;
  qword_140EFA338 = (__int64)v17;
