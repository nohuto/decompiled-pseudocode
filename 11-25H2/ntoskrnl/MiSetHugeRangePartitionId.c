/*
 * XREFs of MiSetHugeRangePartitionId @ 0x140666100
 * Callers:
...
__int64 __fastcall MiSetHugeRangePartitionId(__int16 *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  v6 = (a3 >> 18) & 0x3FFFFF;
  v8 = a4 >> 18;
  v9 = (unsigned __int64 *)(qword_140E2FD80 + 8 * v6);
  ...
  if ( v8 )
  {
    ...
    do
    {
      ...
      *v9 = v12 | *v9 & 0xFFFFFFFFFFFF800BuLL | 3;
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140E2FD88 + 4 * (((((__int64)v9 - qword_140E2FD80) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v9 - qword_140E2FD80) >> 3) & 0x1F)));
