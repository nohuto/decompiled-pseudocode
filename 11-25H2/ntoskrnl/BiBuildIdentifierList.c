/*
 * XREFs of BiBuildIdentifierList @ 0x140A27590
 * Callers:
...
__int64 __fastcall BiBuildIdentifierList(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  _QWORD *v51; // rax
  _QWORD *v52; // rax
  __int16 v53[2]; // [rsp+20h] [rbp-79h] BYREF
  ...
  __int64 v65; // [rsp+78h] [rbp-21h] BYREF
  ...
  *a3 = a3;
  ...
  v63 = 0LL;
  v61 = 0LL;
  v7 = BiOpenKey(a1, L"Objects", 0x20019u, &v63);
  if ( v7 < 0 )
    goto LABEL_55;
  ...
  for ( i = 0; i < v62; ++i )
  {
    ...
    if ( RtlGUIDFromString(&DestinationString, &Guid) >= 0 && (int)BcdOpenObject(a1, &Guid.Data1, &v65) >= 0 )
    {
      v10 = v65;
      if ( (int)BiGetObjectDescription(v65, &v66) >= 0 )
      {
...
LABEL_36:
        ...
        v64 = 2;
        v3 = 0;
        if ( (int)BcdGetElementData(v10, 0x16000082u, (__int64)v53, &v64) >= 0 && LOBYTE(v53[0]) )
          *(_DWORD *)(v13 + 48) |= 0x10u;
  ...
  {
    v21 = 0LL;
    for ( j = (unsigned int *)v68; (char *)j - v20 < (unsigned __int64)v54; j = (unsigned int *)((char *)j + v36) )
    {
...
LABEL_32:
      ...
      v33 = (_DWORD *)ExAllocatePool2(0x102uLL);
      v34 = v33;
      if ( !v33 )
      {
LABEL_51:
      ...
      *(_QWORD *)(v21 + 40) = v34;
      *(_DWORD *)(v21 + 32) = v34[2];
      v35 = v3 | *(_DWORD *)(v21 + 48) & 0xFFFFFFDF;
      v3 = 0;
      *(_DWORD *)(v21 + 48) = v35 | 1;
      v36 = *j;
      if ( !(_DWORD)v36 )
