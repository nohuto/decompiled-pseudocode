/*
 * XREFs of ApiSetpInsertHashEntry @ 0x1406575D8
 * Callers:
 ...
 *     ApiSetpFindHashInsertionPoint_V7 @ 0x1406574D8 (ApiSetpFindHashInsertionPoint_V7.c)
...
__int64 __fastcall ApiSetpInsertHashEntry(__int64 a1, unsigned int *a2, unsigned __int16 a3, __int64 a4)
{
  ...
  if ( a3 == (_WORD)v6 )
  {
    SearchKeyHash = ApiSetpGetSearchKeyHash((__int64)a2, a4);
    v27 = 0;
    v10 = SearchKeyHash;
