/*
 * XREFs of RtlpFcUpdateUsageTriggers @ 0x140A30228
 * Callers:
 *     CmFcManagerUpdateFeatureUsageSubscriptions @ 0x140A2FF84 (CmFcManagerUpdateFeatureUsageSubscriptions.c)
 * Callees:
 *     RtlpFcCompareUsageSubscriptionToUsageSubscription @ 0x1404A49CC (RtlpFcCompareUsageSubscriptionToUsageSubscription.c)
 *     qsort @ 0x1404FC5A0 (qsort.c)
 *     RtlpFcAddUsageSubscriptionFromUpdate @ 0x14077DB74 (RtlpFcAddUsageSubscriptionFromUpdate.c)
