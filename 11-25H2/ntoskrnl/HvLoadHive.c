/*
 * XREFs of HvLoadHive @ 0x1409F8C4C
 * Callers:
 ...
 *     CmpInitializeActualFileSizes @ 0x1409F9414 (CmpInitializeActualFileSizes.c)
...
LABEL_92:
  ...
  if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 0x200000000000LL) )
  {
    v51 = &v38;
    v52 = v35;
    v53 = &v40;
    ...
    v40 = 0x1000000LL;
    v54 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09E08, (unsigned __int8 *)byte_1400542A8, 0LL, 0LL, v35, v50);
  }
  v6 = 0;
LABEL_7:
  v13 = v12;
  ...
  *(_DWORD *)(BugCheckParameter2 + 220) = *(_DWORD *)(v13 + 24) - 4096 + (*(_DWORD *)(v13 + 20) << 12);
  ...
  if ( v39 < (int)v19 + 4096 && (v41 & 0x20000) == 0 && (BYTE2(NlsMbOemCodePageTag) || (CmpBootType & 6) != 0) )
  {
    if ( (unsigned int)dword_140E09E08 > 5 && tlgKeywordOn((__int64)&dword_140E09E08, 0x200000000000LL) )
    {
      ...
      v55 = &v40;
      v56 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09E08, (unsigned __int8 *)word_140054242, 0LL, v16, 5u, v50);
    }
...
LABEL_45:
  ...
  inited = HvpRemapAndEnlistHiveBins(BugCheckParameter2, v41, a4);
  v17 = inited;
