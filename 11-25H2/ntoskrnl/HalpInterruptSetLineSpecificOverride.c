/*
 * XREFs of HalpInterruptSetLineSpecificOverride @ 0x14054019C
 * Callers:
...
__int64 __fastcall HalpInterruptSetLineSpecificOverride(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(v4 + 32) = 1;
    ...
    v8 = (__int64 *)qword_140F8F108;
    if ( *(__int64 **)qword_140F8F108 != &HalpInterruptOverrides )
      __fastfail(3u);
    *(_QWORD *)v4 = &HalpInterruptOverrides;
    *(_QWORD *)(v4 + 8) = v8;
    *v8 = v4;
    qword_140F8F108 = v4;
    HalpReleaseHighLevelLock((__int64)&HalpInterruptOverridesLock, v7);
  }
