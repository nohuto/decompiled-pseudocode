/*
 * XREFs of _CmDeleteInstallerClassMappedPropertyFromRegValue @ 0x14080E350
 * Callers:
...
LABEL_22:
    ...
    PnpCtxRegDeleteValue(v19, v5, &word_140AD8570);
    goto LABEL_29;
  }
  v6 = CmOpenInstallerClassRegKey(v12, a2, v10, (_DWORD)v9, 2, 0, (__int64)&v23, 0LL);
  if ( v6 >= 0 )
  {
    v5 = v23;
    goto LABEL_12;
