/*
 * XREFs of Controller_TelemetryReportWorker @ 0x140042BA0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Controller_TelemetryReportWorker(__int64 a1)
{
  ...
  {
    LOBYTE(v5) = 4;
    WPP_RECORDER_SF_(v4[9], v5, 4, 240, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
  }
  ...
  *(_DWORD *)(v6 + 80) = 0;
  ...
  if ( v10 == -1073741789 )
  {
    ...
    if ( Pool2 )
    {
      ...
      {
        LOBYTE(v16) = 2;
        WPP_RECORDER_SF_d(v4[9], v16, 4, 243, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v15);
      }
      v18 = v14;
      goto LABEL_21;
    }
    ...
    {
      LOBYTE(v13) = 2;
      WPP_RECORDER_SF_(v4[9], v13, 4, 242, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
    }
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(v4[9], v11, 4, 241, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v10);
  }
  while ( 1 )
  {
