/*
 * XREFs of Controller_WdfEvtPreprocessSetPowerIrp @ 0x140039090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Crashdump_ProcessSystemPowerAction @ 0x1400513B4 (Crashdump_ProcessSystemPowerAction.c)
...
__int64 __fastcall Controller_WdfEvtPreprocessSetPowerIrp(__int64 a1, __int64 a2)
{
  ...
  v5 = *(_QWORD *)(a2 + 184);
  v6 = v4;
  v7 = &WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids;
  v8 = *(_QWORD *)(v4 + 8);
  if ( !*(_DWORD *)(v5 + 16) )
  {
    v9 = *(_DWORD *)(v5 + 8);
