/*
 * XREFs of Controller_RetrieveAcpiData @ 0x14007810C
 * Callers:
...
__int64 __fastcall Controller_RetrieveAcpiData(__int64 a1, int a2, char *a3)
{
  ...
  if ( v6 == -2147483643 )
  {
    ...
    if ( Pool2 )
    {
      ...
      else
      {
        ...
        {
          LOBYTE(v14) = 2;
          WPP_RECORDER_SF_d(a2, (_DWORD)v14, 4, 147, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v13);
        }
      }
    ...
    else
    {
      ...
      {
        LOBYTE(v12) = 2;
        WPP_RECORDER_SF_d(a2, (_DWORD)v12, 4, 146, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v9);
      }
  ...
  else
  {
    ...
    {
      LOBYTE(v8) = 2;
      WPP_RECORDER_SF_d(a2, (_DWORD)v8, 4, 145, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v6);
    }
  }
  return v7;
}
