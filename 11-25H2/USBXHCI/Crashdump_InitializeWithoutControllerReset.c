/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x140051180
 * Callers:
 *     Crashdump_Initialize @ 0x140050A40 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1400520C4 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x140052FB0 (Crashdump_EventRing_PrepareForHibernate.c)
 *     Crashdump_Command_PrepareForDump @ 0x140053128 (Crashdump_Command_PrepareForDump.c)
 *     Crashdump_Command_TestCommandRingOperation @ 0x1400535AC (Crashdump_Command_TestCommandRingOperation.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(char *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x508uLL, 0x43434858u);
