/*
 * XREFs of Bulk_DoesStageContainDequeuePointer @ 0x1400163C0
 * Callers:
 *     Bulk_FindStage @ 0x140016194 (Bulk_FindStage.c)
 * Callees:
 *     TR_DoesSegmentContainDequeuePointer @ 0x14002A494 (TR_DoesSegmentContainDequeuePointer.c)
 */
...
char __fastcall Bulk_DoesStageContainDequeuePointer(__int64 a1, signed __int64 a2)
{
  ...
  while ( v2 != v4 )
  {
    if ( (unsigned __int8)TR_DoesSegmentContainDequeuePointer(v4, v6, 0xFFFFFFFFLL, v3) )
      return 1;
    v4 = (_QWORD *)*v4;
    v6 = 0LL;
  }
