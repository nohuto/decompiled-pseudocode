/*
 * XREFs of Controller_WdfEvtDevicePrepareHardware @ 0x140079ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDevicePrepareHardware(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0x2000000LL;
  ...
  {
    LOBYTE(v6) = 4;
    WPP_RECORDER_SF_q(*(_QWORD *)(v5 + 72), v6, 4, 48, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, a1);
  }
  if ( *(_DWORD *)(v5 + 1280) != KeQueryActiveProcessorCountEx(0xFFFFu) )
  {
  ...
  *(_DWORD *)(v5 + 820) = 0;
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(*(_QWORD *)(v5 + 72), 2, 4, 49, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v9);
    v12 = 1LL;
    goto LABEL_54;
  }
  v12 = 2LL;
