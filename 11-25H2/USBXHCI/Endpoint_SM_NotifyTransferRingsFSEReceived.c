/*
 * XREFs of Endpoint_SM_NotifyTransferRingsFSEReceived @ 0x14000E754
 * Callers:
 *     ESM_NotifyingTransferRingsFSEReceived @ 0x14000E730 (ESM_NotifyingTransferRingsFSEReceived.c)
 * Callees:
