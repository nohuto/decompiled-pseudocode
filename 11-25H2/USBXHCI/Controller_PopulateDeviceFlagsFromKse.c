/*
 * XREFs of Controller_PopulateDeviceFlagsFromKse @ 0x1400418B0
 * Callers:
...
__int64 __fastcall Controller_PopulateDeviceFlagsFromKse(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_MAIN_CB.Queue.Wcb.CurrentIrp )
  {
    ...
    do
    {
      ...
      if ( ((int (__fastcall *)(wchar_t *, __int64, __int64 *))WPP_MAIN_CB.Queue.Wcb.CurrentIrp)(pszDest, v9, &v22) >= 0 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v10, v11, 0x9Eu, v20, v6, v22, pszDest);
        *v8 |= v22;
      }
      if ( *(_DWORD *)(a1 + 644) == 1 )
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v12, v13, 0x9Fu, v20, v6, v23, pszDest);
        v5 = 1;
        *v8 |= v23;
      }
      if ( *(_DWORD *)(a1 + 644) == 1 )
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v14, v15, 0xA0u, v21, v6, v24, pszDest);
        v5 = 1;
        *v8 |= v24;
      }
      if ( *(_DWORD *)(a1 + 644) == 1 )
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v16, a3, 0xA1u, v20, v6, v25, pszDest);
        v5 = 1;
        *v8 |= v25;
      }
      v17 = *(_QWORD *)(a1 + 728);
      if ( v17 != -1 )
      {
        ...
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v17, a3, 0xA2u, v20, v6, v26, pszDest);
          v5 = 1;
          *v8 |= v26;
        }
      }
      if ( *(_DWORD *)(a1 + 644) == 1 )
      {
        ...
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v17, a3, 0xA3u, v20, v6, v27, pszDest);
          v5 = 1;
          *v8 |= v27;
        }
        if ( *(_DWORD *)(a1 + 644) == 1 )
        {
          ...
          {
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              WPP_RECORDER_SF_diS(*(_QWORD *)(a1 + 72), v17, a3, 0xA4u, v20, v6, v28, pszDest);
            v5 = 1;
            *v8 |= v28;
          }
        }
    ...
    else
    {
      ...
      {
        LOBYTE(v17) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v17, 4, 165, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
      }
...
LABEL_54:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    return WPP_RECORDER_SF_S(*(_QWORD *)(a1 + 72), 3, a3, 166, v20, (__int64)pszDest);
  return result;
}
