/*
 * XREFs of InitializeTelemetryAssertsKMByDriverObject @ 0x140057780
 * Callers:
 *     DriverEntry @ 0x14007AA30 (DriverEntry.c)
 * Callees:
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x140057884 (InitializeTelemetryAssertsKMWorkerInternal.c)
 */
