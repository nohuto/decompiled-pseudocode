/*
 * XREFs of Crashdump_Endpoint_PrepareForHibernate @ 0x140053810
 * Callers:
 *     Crashdump_UsbDevice_PrepareForHibernate @ 0x140054DB0 (Crashdump_UsbDevice_PrepareForHibernate.c)
 * Callees:
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x140053F0C (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x140053FD8 (Crashdump_Endpoint_StopEndpoint.c)
