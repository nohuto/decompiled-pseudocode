/*
 * XREFs of Crashdump_UsbDevice_SendEnableSlotCommand @ 0x140055584
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x140054EB0 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 * Callees:
