/*
 * XREFs of Isoch_Stage_EstimateRequiredSegments @ 0x140024120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Isoch_Stage_EstimateRequiredSegments(__int64 a1, __int64 a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 56);
  v3 = *(_QWORD *)(a1 + 40);
  v4 = (((unsigned __int64)*(unsigned int *)(v2 + 152) + 8190) >> 12) + 1;
  if ( !_bittest64((const signed __int64 *)(v3 + 736), 0x2Fu)
    || (v10 = *(_QWORD *)(a1 + 48), *(_DWORD *)(v10 + 20) != 1)
    || !*(_DWORD *)(v10 + 40) )
  {
    v4 = ((unsigned __int64)*(unsigned int *)(v2 + 152) + 8190) >> 12;
  }
  v5 = v4 + 1;
