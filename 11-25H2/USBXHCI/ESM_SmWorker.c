/*
 * XREFs of ESM_SmWorker @ 0x140055A10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ESM_SmWorker(PDEVICE_OBJECT DeviceObject, _QWORD *Context)
{
  ...
  v7 = Context[120];
  NewIrql = v6;
  v8 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01033 + 1632))(WdfDriverGlobals, v7);
  ...
  v9 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD))(WdfFunctions_01033 + 1632))(
         WdfDriverGlobals,
         Context[120]);
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, const char *, __int64, const char *))(WdfFunctions_01033 + 1648))(
    WdfDriverGlobals,
    v9,
    "State Machine Tag",
    902LL,
