/*
 * XREFs of Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x140055004
 * Callers:
 *     Crashdump_ResetDevice @ 0x140051430 (Crashdump_ResetDevice.c)
 * Callees:
 *     Crashdump_UsbDevice_Configure @ 0x1400542FC (Crashdump_UsbDevice_Configure.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x140055640 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 */
