/*
 * XREFs of Crashdump_Endpoint_SendControlTransfer @ 0x140053BE8
 * Callers:
 *     Crashdump_SendUrb @ 0x1400515B0 (Crashdump_SendUrb.c)
 *     Crashdump_SendUrbAsync @ 0x1400516A0 (Crashdump_SendUrbAsync.c)
 *     Crashdump_UsbDevice_ChangePortFeature @ 0x14005412C (Crashdump_UsbDevice_ChangePortFeature.c)
 *     Crashdump_UsbDevice_Configure @ 0x1400542FC (Crashdump_UsbDevice_Configure.c)
 ...
 *     Crashdump_UsbDevice_SuspendPort @ 0x1400557C0 (Crashdump_UsbDevice_SuspendPort.c)
 * Callees:
