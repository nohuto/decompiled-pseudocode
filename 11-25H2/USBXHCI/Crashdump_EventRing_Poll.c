/*
 * XREFs of Crashdump_EventRing_Poll @ 0x140052BB4
 * Callers:
 *     Crashdump_Command_SendCommand @ 0x14005323C (Crashdump_Command_SendCommand.c)
 *     Crashdump_Command_Stop @ 0x1400533D4 (Crashdump_Command_Stop.c)
 *     Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x140053DCC (Crashdump_Endpoint_SendTransferAndPollForCompletion.c)
 * Callees:
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1400530AC (Crashdump_EventRing_UpdateDequeuePointer.c)
  ...
  while ( 1 )
  {
    ...
    while ( (_BYTE)v25 )
    {
      ...
      if ( (_DWORD)v16 == a2 )
      {
        ...
        if ( v17 < 0 )
        {
          LODWORD(v24) = (unsigned __int8)v25;
          DbgPrintEx(
            0x93u,
            3u,
      ...
      {
        LODWORD(v24) = *(unsigned __int8 *)(v11 + 11);
