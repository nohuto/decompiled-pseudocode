/*
 * XREFs of Crashdump_CommonBufferAcquire @ 0x1400507A4
 * Callers:
 *     Crashdump_UcxEvtGetDumpData @ 0x1400518F0 (Crashdump_UcxEvtGetDumpData.c)
 *     Crashdump_EventRing_InitializeForDump @ 0x140052B20 (Crashdump_EventRing_InitializeForDump.c)
 *     Crashdump_Endpoint_Initialize @ 0x1400536D4 (Crashdump_Endpoint_Initialize.c)
 *     Crashdump_UsbDevice_Initialize @ 0x140054D00 (Crashdump_UsbDevice_Initialize.c)
 * Callees:
