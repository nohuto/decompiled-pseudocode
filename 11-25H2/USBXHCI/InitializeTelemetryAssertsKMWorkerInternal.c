/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x140057884
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
  ...
  if ( Pool2 )
  {
    ...
    qword_14006BE68 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140073040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140073008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140073078);
