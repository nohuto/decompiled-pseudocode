/*
 * XREFs of UsbDevice_UcxEvtDeviceAdd @ 0x1400817A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_UcxEvtDeviceAdd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  ((void (__fastcall *)(__int64, __int64, _QWORD *))qword_14006BDC0)(UcxDriverGlobals, v16, v25);
  v18 = 0;
  v20 = 0LL;
  v23 = 0LL;
  ...
  v6 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, int *, __int64 *))qword_14006BDB8)(
         UcxDriverGlobals,
         a1,
         &v16,
         &v17,
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v5 + 72), v7, 12, 10, (__int64)&WPP_222713be4b65397e827dad6cd239c0b0_Traceguids, v6);
  }
