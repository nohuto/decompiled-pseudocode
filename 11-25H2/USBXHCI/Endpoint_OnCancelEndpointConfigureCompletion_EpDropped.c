/*
 * XREFs of Endpoint_OnCancelEndpointConfigureCompletion_EpDropped @ 0x14000D8E0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_BYTE *)(a1 + 60) == 1 )
    {
      ...
      Endpoint_SetUpConfigureEndpointCommand(
        ...
        *(_QWORD *)(v2 + 264),
        ...
        (void *)(v2 + 160));
      if ( *(_BYTE *)(v2 + 37) )
        DequeuePointer = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 136) + 32LL) + 24LL);
      else
        DequeuePointer = TR_GetDequeuePointer(*(_QWORD *)(v2 + 88));
      *(_QWORD *)(v6 + 8) = DequeuePointer;
