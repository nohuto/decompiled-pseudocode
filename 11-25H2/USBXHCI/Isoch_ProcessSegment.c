/*
 * XREFs of Isoch_ProcessSegment @ 0x14002A064
 * Callers:
...
LABEL_25:
              for ( j = i; j < v16; j += 16LL )
              {
                  ...
                  && (unsigned __int8)HIBYTE(*(_WORD *)(j + 12)) >> 2 != 5 )
                {
                  ...
                  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                  {
                    v27 = *(unsigned __int8 *)(a1[6] + 135LL);
                    LOBYTE(v27) = 2;
                    WPP_RECORDER_SF_DDL(
                      *(_QWORD *)(a1[7] + 80LL),
                      v27,
...
LABEL_23:
            ...
            if ( (*(_DWORD *)(i + 8) & 0x1FFFFu) < v21
              && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              WPP_RECORDER_SF_DDDDL(*(_QWORD *)(a1[7] + 80LL), *(unsigned __int8 *)(a1[6] + 135LL), v20, v21);
            }
          }
      ...
      default:
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v25 = *(unsigned __int8 *)(a1[6] + 135LL);
          LOBYTE(v25) = 2;
