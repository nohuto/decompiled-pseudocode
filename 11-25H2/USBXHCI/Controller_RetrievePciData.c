/*
 * XREFs of Controller_RetrievePciData @ 0x14007835C
 * Callers:
...
__int64 __fastcall Controller_RetrievePciData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    LOBYTE(v9) = 2;
    WPP_RECORDER_SF_d(a2, v9, 4, 138, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v8);
  }
...
LABEL_7:
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(a2, v11, 4, v13, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v10);
  }
  return v12;
}
