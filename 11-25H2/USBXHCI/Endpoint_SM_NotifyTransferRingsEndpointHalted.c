/*
 * XREFs of Endpoint_SM_NotifyTransferRingsEndpointHalted @ 0x14002FF24
 * Callers:
 *     ESM_NotifyingTransferRingsEndpointHalted @ 0x14002FF00 (ESM_NotifyingTransferRingsEndpointHalted.c)
 * Callees:
