/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x140078F88
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x14003CCF8 (XilDeviceSlot_GetNumberOfDeviceSlots.c)
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  v20 = 0LL;
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x508u),
