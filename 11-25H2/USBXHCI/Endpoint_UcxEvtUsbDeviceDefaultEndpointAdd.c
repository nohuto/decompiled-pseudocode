/*
 * XREFs of Endpoint_UcxEvtUsbDeviceDefaultEndpointAdd @ 0x140080930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtUsbDeviceDefaultEndpointAdd(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  ((void (__fastcall *)(__int64, __int64, _QWORD *))qword_14006BDF0)(UcxDriverGlobals, a4, v22);
  v9 = Endpoint_Create(a1, a2, a4, (unsigned int)&v19, 0LL, 0LL);
