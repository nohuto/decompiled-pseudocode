/*
 * XREFs of TR_EnsureSegments @ 0x14001F530
 * Callers:
 *     UsbDevice_HandleAddAndDropEndpointsState @ 0x14003ABC0 (UsbDevice_HandleAddAndDropEndpointsState.c)
 *     Bulk_EP_EnableForwardProgress @ 0x14004D820 (Bulk_EP_EnableForwardProgress.c)
  ...
  *(_BYTE *)(a1 + 104) = v9;
  ...
  if ( v14 < 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LODWORD(v20) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 144LL);
