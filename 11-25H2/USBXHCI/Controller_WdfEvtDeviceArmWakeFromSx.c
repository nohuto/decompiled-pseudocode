/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromSx @ 0x14002CDE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromSx(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 4;
    WPP_RECORDER_SF_q(*(_QWORD *)(v3 + 72), v2, 4, 93, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v1);
  }
  *(_BYTE *)(v3 + 868) = 1;
  return 0LL;
}
