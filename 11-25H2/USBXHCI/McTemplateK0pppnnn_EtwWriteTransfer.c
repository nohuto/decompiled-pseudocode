/*
 * XREFs of McTemplateK0pppnnn_EtwWriteTransfer @ 0x140003138
 * Callers:
...
__int64 McTemplateK0pppnnn_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, ...)
{
  _BYTE v6[16]; // [rsp+30h] [rbp-69h] BYREF
  ...
  v16 = 6LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, a3, 7LL, v6);
}
