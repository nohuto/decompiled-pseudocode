/*
 * XREFs of ?FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z @ 0x1400568C4
 * Callers:
 *     FxDriverEntryWorker @ 0x140056704 (FxDriverEntryWorker.c)
 * Callees:
 *     FxGetNextClassBindInfo @ 0x140056AE4 (FxGetNextClassBindInfo.c)
...
__int64 __fastcall FxStubBindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  if ( &__KMDF_CLASS_BIND_START <= &__KMDF_CLASS_BIND_END )
  {
    for ( i = (char *)&Ucx_BIND_INFO; ; i = (char *)v4 + *v4 )
    {
      ...
      {
        v1 = WdfVersionBindClass(&unk_14006B6B0, WdfDriverGlobals, v4);
        if ( (v1 & 0x80000000) != 0 )
        {
          DbgPrintEx(
            0x4Du,
