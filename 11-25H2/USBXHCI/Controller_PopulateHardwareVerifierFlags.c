/*
 * XREFs of Controller_PopulateHardwareVerifierFlags @ 0x140077520
 * Callers:
...
LABEL_10:
  ...
  else
  {
    if ( result != 2 )
    {
      ...
      {
        LOBYTE(v6) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v6, 4, 227, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
        v8 = (_QWORD *)(a1 + 848);
        v9 = (_QWORD *)(a1 + 848);
        goto LABEL_60;
      }
