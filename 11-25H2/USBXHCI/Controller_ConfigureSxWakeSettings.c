/*
 * XREFs of Controller_ConfigureSxWakeSettings @ 0x140074C58
 * Callers:
...
__int64 __fastcall Controller_ConfigureSxWakeSettings(__int64 *a1)
{
  ...
  {
    LOBYTE(v4) = 2;
    return WPP_RECORDER_SF_d(a1[9], v4, 4, 34, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, result);
  }
  return result;
}
