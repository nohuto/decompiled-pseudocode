/*
 * XREFs of Endpoint_SM_WasDoorbellRungSinceMappingStart @ 0x14002FA8C
 * Callers:
 *     ESM_CheckingIfEndpointShouldBeStopped @ 0x14002FA70 (ESM_CheckingIfEndpointShouldBeStopped.c)
 * Callees:
