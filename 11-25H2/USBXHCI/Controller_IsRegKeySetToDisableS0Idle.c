/*
 * XREFs of Controller_IsRegKeySetToDisableS0Idle @ 0x1400412DC
 * Callers:
...
bool __fastcall Controller_IsRegKeySetToDisableS0Idle(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = 3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 72), v3, 4, 22, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v2);
  }
  if ( v6 )
