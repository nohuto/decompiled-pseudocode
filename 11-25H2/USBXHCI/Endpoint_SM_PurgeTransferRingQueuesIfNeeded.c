/*
 * XREFs of Endpoint_SM_PurgeTransferRingQueuesIfNeeded @ 0x1400342B4
 * Callers:
 *     ESM_PurgingTransferRingQueuesIfNeeded @ 0x140034290 (ESM_PurgingTransferRingQueuesIfNeeded.c)
 * Callees:
