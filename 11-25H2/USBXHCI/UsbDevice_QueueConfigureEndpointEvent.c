/*
 * XREFs of UsbDevice_QueueConfigureEndpointEvent @ 0x14002AB24
 * Callers:
  ...
  if ( v3 <= 7 )
  {
    if ( v3 != 7 )
    {
      if ( v3 )
      {
        ...
        if ( !v18 )
        {
          LOBYTE(v5) = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 1044LL) != 2;
...
LABEL_28:
        ...
        v29 = UsbDevice_InitializeInputContextForAddDropEndpoints(a1, v4, 1u);
        v30 = a1;
        if ( v29 < 0 )
        {
LABEL_80:
...
LABEL_47:
  ...
  if ( !v12 )
  {
    v29 = UsbDevice_InitializeInputContextForAddDropEndpoints(a1, v4, 2u);
    v30 = a1;
    if ( v29 >= 0 )
    {
      v31 = 2LL;
