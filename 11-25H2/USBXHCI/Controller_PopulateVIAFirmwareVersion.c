/*
 * XREFs of Controller_PopulateVIAFirmwareVersion @ 0x140077F00
 * Callers:
 *     Controller_PopulatePciDeviceInformation @ 0x140077C88 (Controller_PopulatePciDeviceInformation.c)
 * Callees:
...
LABEL_13:
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_d(a1, v10, 4, v11, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v17);
      return;
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_d(a1, v10, 4, 260, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v20[0]);
    }
    *a4 = v20[0];
  }
}
