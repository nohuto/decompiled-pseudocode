/*
 * XREFs of WerKernelSubmitReport @ 0x1400587BC
 * Callers:
 *     TelemetryData_SubmitReport @ 0x14007FAA8 (TelemetryData_SubmitReport.c)
 * Callees:
 *     RtlStringCchCopyNW @ 0x14005847C (RtlStringCchCopyNW.c)
 *     WerStartSystemErrorHandler @ 0x140058D5C (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x140058E94 (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x140058F68 (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1400591C4 (WerpFreeMem.c)
 *     WerpGetRegistryKey @ 0x1400591E8 (WerpGetRegistryKey.c)
 *     WerpParseKeyName @ 0x140059304 (WerpParseKeyName.c)
