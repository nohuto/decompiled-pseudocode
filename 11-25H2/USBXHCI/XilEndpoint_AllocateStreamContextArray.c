/*
 * XREFs of XilEndpoint_AllocateStreamContextArray @ 0x140036AE4
 * Callers:
          ...
          if ( v16 == 3 )
          {
            ...
            if ( !v5 )
            {
              if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              {
                v17 = 16;
                v22 = *(_DWORD *)(v4 + 144);
                v21 = *(unsigned __int8 *)(*(_QWORD *)(v4 + 16) + 135LL);
LABEL_20:
                WPP_RECORDER_SF_dD(
                  *(_QWORD *)(v4 + 80),
                  2u,
...
LABEL_22:
        ...
        if ( Pool2 )
        {
          ...
          *(_QWORD *)(Pool2 + 72) = v4;
          *(_DWORD *)(Pool2 + 80) = 2;
          v12 = XilEndpoint_SendRequestToAllocateSecureStreamContextArray(v4 + 1320, v9, &v24, &v23);
          if ( v12 < 0 )
          {
