/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsEnable @ 0x140034F50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_ddL(
      ...
      *(unsigned __int8 *)(*(_QWORD *)v10 + 135LL),
      *v9,
      *v8);
  ...
  if ( v25 || v24 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v19 = *(unsigned __int8 *)(*(_QWORD *)v10 + 135LL);
      LOBYTE(v19) = 2;
  ...
  if ( !*v8 || *v8 > *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v7 + 88LL) + 116LL) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v23) = *v8;
      LODWORD(v22) = *v9;
      LODWORD(v21) = *(unsigned __int8 *)(*(_QWORD *)v10 + 135LL);
      WPP_RECORDER_SF_ddL(
        *v11,
        2u,
        0xDu,
...
LABEL_14:
  ...
  *(_QWORD *)(v7 + 136) = v6;
  if ( *v8 )
  {
    while ( 1 )
    {
      StreamContextArray = TR_Enable_Internal(*(_QWORD **)(104LL * (v14 - 1) + *(_QWORD *)(v7 + 136) + 48));
      if ( StreamContextArray < 0 )
        break;
      DequeuePointer = Endpoint_GetDequeuePointer(v7, v14);
      v17 = v14++;
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 136) + 32LL) + 16LL) + 16 * v17) = DequeuePointer;
      if ( v14 > *v8 )
        goto LABEL_18;
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
