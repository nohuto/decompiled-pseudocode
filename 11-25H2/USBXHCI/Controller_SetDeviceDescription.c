/*
 * XREFs of Controller_SetDeviceDescription @ 0x14007887C
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x14004499C (RtlUnalignedStringCbLengthW.c)
 *     RootHub_GetHighestUsbVersionSupported @ 0x140049EA8 (RootHub_GetHighestUsbVersionSupported.c)
...
LABEL_16:
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_(a1[9], v9, 4, v10, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
      return;
    }
    return;
  }
...
LABEL_34:
        LOBYTE(v18) = 2;
        WPP_RECORDER_SF_(a1[9], v18, 4, v20, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
        goto LABEL_35;
      }
    ...
    else
    {
      ...
      {
        LOBYTE(v11) = 4;
        WPP_RECORDER_SF_(a1[9], v11, 4, 153, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
      }
      if ( RtlFindMessage(
             *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
             0xBu,
      ...
      if ( v36 >= 4 && *(_WORD *)&v2[2 * (v36 >> 1) - 2] == 10 )
      {
        ...
        if ( *(_WORD *)&v2[2 * MaxCount] == 13 )
        {
          ...
          if ( !v22 )
          {
            ...
            {
              LOBYTE(v23) = 2;
              WPP_RECORDER_SF_(a1[9], v23, 4, 156, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids);
            }
            v21 = P;
            goto LABEL_57;
          }
      ...
      && RtlUnalignedStringCbLengthW((STRSAFE_PCUNZWCH)v19, pcbLength, &pcbLength) >= 0 )
    {
      ...
      {
        LOBYTE(v26) = 3;
        WPP_RECORDER_SF_d(a1[9], v26, 4, 157, (__int64)&WPP_e3ec626fc5bc373e46c859b185ef609a_Traceguids, v25);
      }
    }
LABEL_57:
