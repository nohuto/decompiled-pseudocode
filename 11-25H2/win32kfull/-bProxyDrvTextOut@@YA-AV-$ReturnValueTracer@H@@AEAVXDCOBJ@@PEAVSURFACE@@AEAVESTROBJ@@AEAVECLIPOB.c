/*
 * XREFs of ?bProxyDrvTextOut@@YA?AV?$ReturnValueTracer@H@@AEAVXDCOBJ@@PEAVSURFACE@@AEAVESTROBJ@@AEAVECLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@AEAVRFONTOBJ@@PEAUHDEV__@@K4@Z @ 0x1400D9D50
 * Callers:
 ...
 *     ?pfnTextOut@SURFACE@@QEAAP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@ZXZ @ 0x1400DA700 (-pfnTextOut@SURFACE@@QEAAP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@.c)
 *     ?bSupportsClearTypeAlways@PDEVOBJ@@SA_NP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z@Z @ 0x1400DA724 (-bSupportsClearTypeAlways@PDEVOBJ@@SA_NP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ.c)
        ...
        LONG *a14)
{
  ...
  _DWORD *v77; // [rsp+70h] [rbp-90h] BYREF
  SURFACE *v78; // [rsp+78h] [rbp-88h]
  XFORMOBJ *v79; // [rsp+80h] [rbp-80h]
  int v80; // [rsp+88h] [rbp-78h]
  int v81; // [rsp+8Ch] [rbp-74h]
  struct RFONTOBJ *v82; // [rsp+90h] [rbp-70h]
  int *v83; // [rsp+98h] [rbp-68h] BYREF
  struct _POINTL *v84; // [rsp+A0h] [rbp-60h]
  CLIPOBJ *pco; // [rsp+A8h] [rbp-58h]
  struct _POINTL v86; // [rsp+B0h] [rbp-50h] BYREF
  BRUSHOBJ *v87; // [rsp+B8h] [rbp-48h]
  _BOOL8 v88; // [rsp+C0h] [rbp-40h]
  _WORD *v89; // [rsp+C8h] [rbp-38h]
  HDEV v90; // [rsp+D0h] [rbp-30h]
  struct XDCOBJ *v91; // [rsp+D8h] [rbp-28h]
  struct _BRUSHOBJ *v92; // [rsp+E0h] [rbp-20h]
  int v93; // [rsp+E8h] [rbp-18h] BYREF
  _WORD *v94; // [rsp+F0h] [rbp-10h]
  __int64 v95; // [rsp+F8h] [rbp-8h]
  _DWORD *v96; // [rsp+100h] [rbp+0h]
  __int64 v97; // [rsp+108h] [rbp+8h]
  struct _LINEATTRS v98; // [rsp+110h] [rbp+10h] BYREF
  _BYTE v99[4]; // [rsp+140h] [rbp+40h] BYREF
  unsigned int v100; // [rsp+144h] [rbp+44h]
  __int64 v101; // [rsp+148h] [rbp+48h]
  int v102[10]; // [rsp+1C0h] [rbp+C0h] BYREF
  int v103[10]; // [rsp+1E8h] [rbp+E8h] BYREF
      ...
      else
      {
        ...
        if ( v34 == v81 )
        {
          ...
          if ( v19->rclBounds.left < v19->rclBounds.right && v19->rclBounds.top < v19->rclBounds.bottom && v20 )
          {
            v38 = v84;
            ++*((_DWORD *)v16 + 23);
            TextOutBitBlt(v16, v15, v27, pvBits_low, v19, (struct _XLATEOBJ *)pxo, v20, v71, v72, v92, v38);
          }
      ...
      *a4 = v40;
      ...
      if ( v26 )
      {
        ...
        if ( *(_DWORD *)(*(_QWORD *)v15 + 308LL) - *(_DWORD *)(*(_QWORD *)v15 + 312LL) == hsurf[77] - hsurf[78] )
        {
          ...
          v86.y = v58;
          if ( v58 || v57 )
            ESTROBJ::ptlBaseLineAdjustSet((ESTROBJ *)a4, &v86);
        }
      }
      v42 = *(_OWORD *)(a4 + 3);
      *((_QWORD *)a4 + 7) = v50;
      *(_OWORD *)(a4 + 45) = v42;
      if ( (*(_DWORD *)(*(_QWORD *)v50 + 88LL) & 2) == 0 )
      {
        if ( !(unsigned int)bOutOfBounds((STROBJ *)a4) )
        {
          ...
          {
            if ( (v44 & 0x10010000) != 0 )
              SURFACE::pdcoAA(v16, v91);
          }
          else if ( (v44 & 0x10000) != 0
                 && ((*(_DWORD *)(*(_QWORD *)v91 + 72LL) & 0x1000000) == 0 || (v44 & 0x10000000) != 0) )
          {
            if ( v43 != EngTextOut )
              SURFACE::pdcoAA(v16, v91);
          ...
          v75 = 0;
          v83 = v103;
          if ( v50 != v82 && (*(_DWORD *)(v46 + 40) & 0x8000) != 0 )
          {
            v56 = UMPDReleaseRFONTSem(v82, 0LL, &v76, &v75, &v83);
            v47 = v76;
            v28 = v56;
            v48 = v75;
            v45 = v83;
          ...
          if ( v80 != v81 )
            v49 = 0LL;
          v72 = v84;
          v71 = (struct _POINTL *)v92;
          pxo = v79;
          v74 = ((unsigned int (__fastcall *)(char *, int *, _QWORD, CLIPOBJ *, __int64))v43)(
                  (char *)v78 + 24,
                  a4,
                  *(_QWORD *)v50,
                  pco,
          ...
          if ( v28 )
          {
            UMPDAcquireRFONTSem(v82, 0LL, v47, v48, v45);
            v28 = 0;
            if ( v45 && v45 != v103 )
              Win32FreePool(v45);
          }
      ...
      PATHMEMOBJ::PATHMEMOBJ((PATHMEMOBJ *)v99);
      if ( v101 )
        break;
      EngSetLastError(8u);
      v74 = 0;
...
LABEL_11:
    ...
    v76 = 0;
    v62 = 0;
    v74 = ESTROBJ::bTextToPathWorkhorse((STROBJ *)a4, (struct EPATHOBJ *)v99);
    if ( !v74 )
    {
      v15 = v82;
      goto LABEL_95;
    ...
    if ( !v63 )
    {
      v64 = UMPDReleaseRFONTSem(v82, 0LL, &v75, &v76, &v83);
      v61 = v75;
      v28 = v64;
      v62 = v76;
      v60 = v83;
    ...
    if ( (*(_DWORD *)(*(_QWORD *)v50 + 724LL) & 0x8000) != 0 )
    {
      if ( v100 <= 1 )
        goto LABEL_94;
      v65 = *EPATHOBJ_bSimpleFill(&v93, (__int64)v99, a13, (__int64)v90, (__int64)v78, pco, v87, v84, 0xD0Du, 2u);
    }
    else
    {
      *(_OWORD *)&v98.fl = glaSimpleStroke;
      memset(&v98.eMiterLimit, 0, 24);
      v65 = EPATHOBJ_bSimpleStroke((struct EPATHOBJ *)v99, a13, v90, v78, pco, 0LL, v87, v84, &v98, 0xD0Du);
    }
    v74 = v65;
LABEL_94:
    if ( v28 )
