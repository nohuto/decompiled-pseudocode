/*
 * XREFs of _NotifyOverlayWindow @ 0x1402920A4
 * Callers:
...
__int64 __fastcall NotifyOverlayWindow(struct tagWND *a1, __int64 a2)
{
  ...
  v7 = 0;
  v8 = 0LL;
  v9 = *(_DWORD *)(UserSessionState + 63416);
  ...
  if ( !v3 )
  {
    ...
    v18 = *(_DWORD *)(W32GetUserSessionState(v17, v16) + 63416);
    if ( v18 )
    {
      v2 = 1;
      *(_DWORD *)(v11 + 63416) = v18 - 1;
...
LABEL_11:
  ...
  v11 = W32GetUserSessionState(0LL, v6);
  v14 = *(_DWORD *)(W32GetUserSessionState(v13, v12) + 63416);
  if ( v14 + 1 < v14 )
    goto LABEL_11;
  *(_DWORD *)(v11 + 63416) = v14 + 1;
  v2 = 1;
  *((_DWORD *)a1 + 95) |= 0x10000u;
  v15 = v9 == 0;
LABEL_10:
