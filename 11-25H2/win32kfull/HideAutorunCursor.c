/*
 * XREFs of HideAutorunCursor @ 0x140273F80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HideAutorunCursor(__int64 a1, __int64 a2)
{
  ...
  FindTimer(0LL, *(_QWORD *)(UserSessionState + 62712), 4u, 1, 0LL);
  *(_QWORD *)(W32GetUserSessionState(v4, v3) + 62712) = 0LL;
  v7 = PtiCurrent(v6, v5);
  if ( v7 != *(struct tagTHREADINFO **)(W32GetUserSessionState(v9, v8) + 18648) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 969);
  v13[0] = 0;
  v14 = 0LL;
