/*
 * XREFs of ?AddSelfAndOwnees@@YAPEAUtagSMWP@@PEAU1@PEAUtagWND@@11HI@Z @ 0x1400659C0
 * Callers:
...
LABEL_5:
  ...
  result = (struct tagSMWP *)_DeferWindowPos((__int64)v8, (__int64)a2, 0LL, 0, 0, 0, 0, a6 | 0x13, 0);
  if ( !result )
    return 0LL;
  v14 = *((int *)result + 7);
  if ( a5 != (_DWORD)v14 - 1 )
