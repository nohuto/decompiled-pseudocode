/*
 * XREFs of ?UMPDDrvTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1400D16D0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  char Src; // [rsp+90h] [rbp-70h] BYREF
...
LABEL_5:
  ...
  v58 = a1;
  if ( v11
    && (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 80), &v58, v41[0])
    && (unsigned int)UMPDOBJ::pstro(v14, &v59)
    && (unsigned int)UMPDOBJ::pfo(v14, &v60)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 128), &v61, 0x18u, 0LL)
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v62, v16)
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v63, 0x10u)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 160), &v64, 0x18u, 0LL)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 176), &v65, 0x18u, 0LL)
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v66, 8u) )
  {
    *(_QWORD *)v41 = v43;
    UMPDReleaseRFONTSem((struct RFONTOBJ *)v41, v14, 0LL, 0LL, 0LL);
    LODWORD(Sizea) = 4;
    v18 = UMPDOBJ::Thunk(v14, &Src, 0x68u, &v42, Sizea);
    v11 = v42;
    if ( v18 == -1 )
      v11 = 0;
