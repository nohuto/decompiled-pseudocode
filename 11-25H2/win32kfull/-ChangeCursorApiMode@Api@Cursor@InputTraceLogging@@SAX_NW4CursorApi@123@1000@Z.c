/*
 * XREFs of ?ChangeCursorApiMode@Api@Cursor@InputTraceLogging@@SAX_NW4CursorApi@123@1000@Z @ 0x140221338
 * Callers:
 ...
 *     ?CursorApiToString@Api@Cursor@InputTraceLogging@@SAPEBDW4CursorApi@123@@Z @ 0x1402DB650 (-CursorApiToString@Api@Cursor@InputTraceLogging@@SAPEBDW4CursorApi@123@@Z.c)
 */
...
void __fastcall InputTraceLogging::Cursor::Api::ChangeCursorApiMode(char a1)
{
  ...
  if ( (unsigned int)dword_14039BB50 > 4 && tlgKeywordOn((__int64)&dword_14039BB50, 8LL) )
  {
    v3 = "ShapeChange";
    if ( !a1 )
      v3 = "Move";
