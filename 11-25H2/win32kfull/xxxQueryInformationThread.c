/*
 * XREFs of xxxQueryInformationThread @ 0x14002C784
 * Callers:
 ...
 *     ?IsProcessUserService@@YA_NPEAU_EPROCESS@@PEAX@Z @ 0x1401EE514 (-IsProcessUserService@@YA_NPEAU_EPROCESS@@PEAX@Z.c)
 *     ?AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValue@@PEAU_PS_PKG_CLAIM@@PEA_K@Z @ 0x1401FC7CC (-AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValu.c)
