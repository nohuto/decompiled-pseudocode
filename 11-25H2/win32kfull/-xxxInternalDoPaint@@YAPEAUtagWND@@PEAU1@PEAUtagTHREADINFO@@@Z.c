/*
 * XREFs of ?xxxInternalDoPaint@@YAPEAUtagWND@@PEAU1@PEAUtagTHREADINFO@@@Z @ 0x140051900
 * Callers:
            ...
            if ( *((struct tagTHREADINFO **)v3 + 2) == a2 )
            {
              ...
              if ( (*(_QWORD *)(v7 + 136) || (*(_BYTE *)(v7 + 17) & 0x10) != 0) && (*(_BYTE *)(v7 + 24) & 0x20) == 0 )
              {
                if ( BugCheckParameter3 != -1LL )
                {
                  ...
                  if ( v9 )
                    v6 = *v9;
                  Win32HM_UnlockFromThread<1>(v6, &BugCheckParameter3);
                }
                return v3;
              }
            }
...
LABEL_7:
      ...
      if ( v7 )
      {
        ...
        if ( v12 )
        {
          if ( v12 == v3 )
          {
            v13 = Win32HMThreadLockBase<tagCURSOR,1,1>::ManualUnlock<void>(&BugCheckParameter3, v5);
          ...
          else
          {
            ...
            if ( v14 )
              ...
              v15 = 0LL;
            Win32HM_UnlockFromThread<1>(v15, &BugCheckParameter3);
            v18 = -1LL;
            v21 = 0LL;
  ...
  if ( v11 )
    v6 = *v11;
  return (struct tagWND *)Win32HM_UnlockFromThread<1>(v6, &BugCheckParameter3);
}
