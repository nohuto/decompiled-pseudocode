/*
 * XREFs of ?UMPDDrvIcmCreateColorTransform@@YAPEAXPEAUDHPDEV__@@PEAUtagLOGCOLORSPACEW@@PEAXK2K2KK@Z @ 0x140335AB0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  _DWORD Src[4]; // [rsp+50h] [rbp-71h] BYREF
    ...
    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v23, 0x148u) )
    {
      if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v14, (const void **)&v24, a4) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v14, (const void **)&v26, a6) )
        {
          ...
          {
            LODWORD(Size) = 8;
            if ( (unsigned int)UMPDOBJ::Thunk(v14, Src, 0x58u, &v17, Size) != -1 )
              v10 = v17;
          }
        }
      }
