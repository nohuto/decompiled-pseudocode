/*
 * XREFs of ?UMPDDrvQueryPerBandInfo@@YAKPEAU_SURFOBJ@@PEAU_PERBANDINFO@@@Z @ 0x1400CE860
 * Callers:
 *     <none>
 * Callees:
      ...
      || (v13 = 72, v10 = UMPDOBJ::bThunkLargeBitmap(v18, a1, &v17, &v16, &v15, &v14, &v13), v4 = v14, (v13 = v10) != 0) )
    {
      ...
      if ( (unsigned int)UMPDOBJ::pso(v6, (UMPDOBJ *)((char *)v6 + 80), &v20[1], v4) )
      {
        ...
        if ( v7 )
        {
          if ( a2 )
          {
            KernelPtr = UMPDOBJ::GetKernelPtr(v6, v7);
            *(_OWORD *)KernelPtr = *(_OWORD *)&a2->bRepeatThisBand;
            KernelPtr[4] = a2->ulVertRes;
          }
          LODWORD(Size) = 4;
          if ( UMPDOBJ::Thunk(v6, &Src, 0x28u, &v13, Size) != -1 && a2 )
          {
            v11 = UMPDOBJ::GetKernelPtr(v6, v21);
