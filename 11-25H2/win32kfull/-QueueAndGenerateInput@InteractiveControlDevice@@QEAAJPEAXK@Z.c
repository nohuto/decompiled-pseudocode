/*
 * XREFs of ?QueueAndGenerateInput@InteractiveControlDevice@@QEAAJPEAXK@Z @ 0x14021E508
 * Callers:
 ...
 *     ??_GInteractiveControlInput@@QEAAPEAXI@Z @ 0x1402ECEBC (--_GInteractiveControlInput@@QEAAPEAXI@Z.c)
