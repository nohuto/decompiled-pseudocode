/*
 * XREFs of xxxClientLoadStringW @ 0x140148EF0
 * Callers:
...
unsigned __int8 *__fastcall xxxClientLoadStringW(unsigned int a1, __int64 a2, int a3)
{
  ...
  v25[0] = 0;
  v25[1] = 2;
  result = (unsigned __int8 *)AllocCallbackMessage(0x40u, 1u, (unsigned int)(2 * a3), v34, 0, 0x200uLL);
  v10 = result;
...
LABEL_11:
      ...
      RegionSize[0] = v19;
      CopyOutputString((volatile void **)&v31, (struct _LARGE_STRING *)v25, a3, 0);
    }
    if ( v10 != v33 && v10 != v34 )
    {
      v20 = (PVOID *)(v10 + 32);
