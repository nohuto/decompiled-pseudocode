/*
 * XREFs of ?hCreateHatchBrushInternal@@YAPEAUHBRUSH__@@KKH@Z @ 0x1400E40C8
 * Callers:
 *     GreExtCreatePen @ 0x1400E35BC (GreExtCreatePen.c)
 *     NtGdiCreateHatchBrushInternal @ 0x1400E44C0 (NtGdiCreateHatchBrushInternal.c)
 * Callees:
 *     ??1BRUSHMEMOBJ@@QEAA@XZ @ 0x1400E4404 (--1BRUSHMEMOBJ@@QEAA@XZ.c)
 */
