/*
 * XREFs of ?MirrorWindowOrg@DC@@QEAAXXZ @ 0x1401D0228
 * Callers:
 ...
 *     NtGdiScaleViewportExtEx @ 0x1401D0050 (NtGdiScaleViewportExtEx.c)
 *     NtGdiMirrorWindowOrg @ 0x1401D01E0 (NtGdiMirrorWindowOrg.c)
 * Callees:
 *     <none>
 */
