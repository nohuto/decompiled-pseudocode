/*
 * XREFs of NtUserMagSetContextInformation @ 0x14024AE10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v37 == 4 )
  {
    ...
    v20 = *(_QWORD *)(W32GetUserSessionState(v19, v18) + 19144);
...
LABEL_19:
    ...
    if ( (unsigned int)Feature_UIPIAlwaysOn__private_IsEnabledDeviceUsageNoInline(v20) )
    {
      v22 = *((_QWORD *)v17 + 58);
      if ( *(int *)(v22 + 12) >= 0 )
      {
