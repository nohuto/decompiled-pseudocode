/*
 * XREFs of ?vFillGRectDIB16Bitfields@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x14031AE90
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( v3 < *((_DWORD *)v2 + 11) + v3 )
  {
    ...
    do
    {
      ...
      if ( v20 < v20 + 2LL * *((int *)v2 + 10) )
      {
        ...
        do
        {
          *v22 = XEPALOBJ::ulDispatchGFPEFunction(v31, *(unsigned int *)(*(_QWORD *)v31 + 100LL));
          v15 += v39;
          v16 += v24;
          v17 += v25;
          ++v22;
