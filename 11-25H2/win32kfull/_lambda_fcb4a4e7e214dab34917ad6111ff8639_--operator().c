/*
 * XREFs of _lambda_fcb4a4e7e214dab34917ad6111ff8639_::operator() @ 0x14014C81C
 * Callers:
 ...
 *     _lambda_fcb4a4e7e214dab34917ad6111ff8639_::_lambda_invoker_cdecl_ @ 0x14014C800 (_lambda_fcb4a4e7e214dab34917ad6111ff8639_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     <none>
 */
...
bool __fastcall lambda_fcb4a4e7e214dab34917ad6111ff8639_::operator()(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v4 <= *(_DWORD *)(v6 + 144) )
  {
    ...
    if ( (unsigned __int8)v4 <= *(_BYTE *)(v3 + v8 + 12)
      && (unsigned __int8)v4 >= *(_BYTE *)(v3 + *(_QWORD *)(W32GetUserSessionState(v8, v7) + 63448)) )
    {
      return 1;
    }
  }
