/*
 * XREFs of ?vPatXorRect8@@YAXPEAU_PATBLTFRAME@@@Z @ 0x1401A8970
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndMerge @ 0x1401A8C8C (vFetchAndMerge.c)
 *     vFetchShiftAndMerge @ 0x1403208C8 (vFetchShiftAndMerge.c)
 */
...
void __fastcall vPatXorRect8(struct _PATBLTFRAME *a1)
{
  ...
  v13 = v8 - *((_DWORD *)a1 + 8);
  v38 = 0LL;
  v14 = dword_140355968[v11];
  v15 = ~dword_140355968[v9];
  v41 = v15;
  if ( v12 )
    v16 = v6 - ~v13 % v6 - 1;
  else
