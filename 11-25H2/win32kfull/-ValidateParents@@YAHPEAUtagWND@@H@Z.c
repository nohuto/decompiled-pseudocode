/*
 * XREFs of ?ValidateParents@@YAHPEAUtagWND@@H@Z @ 0x140050078
 * Callers:
...
__int64 __fastcall ValidateParents(struct tagWND *a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v5 )
    {
      ...
      SetRectRgnIndirect(*(_QWORD *)(UserSessionState + 63368), &v26);
      v15 = *(_QWORD *)(*((_QWORD *)a1 + 5) + 168LL);
      if ( v15 )
      {
        v21 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 63368);
        v24 = W32GetUserSessionState(v23, v22);
        if ( !(unsigned int)GreCombineRgn(*(_QWORD *)(v24 + 63368), v21, v15, 1LL) )
          return 1LL;
      }
    }
    ...
    if ( !(unsigned int)IntersectWithParents((__int64)v7, &v27.left) )
      return 1LL;
    v25 = *(HRGN *)(W32GetUserSessionState(v17, v16) + 63368);
    v18 = LogicalToPhysicalInPlaceRgnWorker(a1, &v25, 0LL);
    v19 = v25;
    v20 = v18;
    InternalInvalidate2(v7, v25, v25, (__int64)&v27, 0x8048u);
    if ( v20 )
      GreDeleteObject(v19);
  }
  return 0LL;
