/*
 * XREFs of NtUserGetClassName @ 0x140297450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetClassName(__int64 a1, int a2, ULONG64 a3)
{
  ...
  if ( v8 )
  {
    ...
    if ( a2 )
    {
      ...
      {
        if ( v12 == 672 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10233);
        if ( v12 == 694 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10234);
        v13 = v12 - 666;
        if ( v13 < 0x1F )
        {
          _mm_lfence();
          v14 = byte_14035C2A8[v13];
          if ( (unsigned __int8)v14 > 0x19u || (v11 = 38797312LL, !_bittest((const int *)&v11, v14)) )
          {
            v19 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19872);
