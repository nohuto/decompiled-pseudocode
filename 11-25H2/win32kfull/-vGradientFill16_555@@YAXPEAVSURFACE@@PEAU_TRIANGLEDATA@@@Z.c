/*
 * XREFs of ?vGradientFill16_555@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x14031C530
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    do
    {
      ...
      if ( *((_QWORD *)v3 + 9) <= (unsigned __int64)(v15 + v7) && v15 < v10 )
      {
        ...
        if ( (unsigned __int64)v17 < v18 )
        {
          ...
          {
            v21 = v19++;
            v22 = *(_DWORD *)(0x140000000LL + 16LL * (v9 & 3) + 3556032 + 4LL * (v21 & 3));
            v23 = HIDWORD(v14);
            v14 += v30;
            v24 = byte_140364180[(unsigned __int64)(v22 + ((unsigned int)v23 >> 11)) >> 16];
            v25 = HIDWORD(v13);
            v13 += v31;
            v26 = byte_140364180[(unsigned __int64)(v22 + ((unsigned int)v25 >> 11)) >> 16] | (unsigned __int16)(32 * v24);
            v27 = HIDWORD(v12);
            v12 += v32;
            *v17++ = byte_140364180[(unsigned __int64)(v22 + ((unsigned int)v27 >> 11)) >> 16] | (unsigned __int16)(32 * v26);
          }
