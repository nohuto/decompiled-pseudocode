/*
 * XREFs of ?SendDeviceHapticsOutput@InteractiveControlManager@@QEAAJKAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x1402E09E0
 * Callers:
        ...
        __int64 a4)
{
  ...
  do
  {
    ...
    if ( *v8 && (!a2 || a2 == *((_DWORD *)v10 + 2)) )
    {
      ...
      if ( v4 < 0 && (unsigned int)dword_14039BBF8 > 2 )
      {
