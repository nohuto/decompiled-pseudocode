/*
 * XREFs of _lambda_315ad92e5be98155a16179dc024b8a3c_::operator() @ 0x14014C890
 * Callers:
 ...
 *     _lambda_315ad92e5be98155a16179dc024b8a3c_::_lambda_invoker_cdecl_ @ 0x1402DDF50 (_lambda_315ad92e5be98155a16179dc024b8a3c_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     <none>
 */
  ...
  if ( v4 <= *(_DWORD *)(v6 + 144) )
  {
    ...
    if ( (unsigned __int8)v4 >= *(_BYTE *)(v3 + v8) )
    {
      ...
      if ( (unsigned __int8)v4 <= *(_BYTE *)(v3 + v10 + 12)
        && (unsigned __int8)v4 <= *(_BYTE *)(v3 + *(_QWORD *)(W32GetUserSessionState(v10, v9) + 63448) + 20) )
      {
        return 1;
      }
    }
