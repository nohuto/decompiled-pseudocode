/*
 * XREFs of McTemplateK0qqzz_EtwWriteTransfer @ 0x14028D7B8
 * Callers:
 *     EtwTraceLayoutChangeStop @ 0x1400239A8 (EtwTraceLayoutChangeStop.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14028D74C (McGenEventWrite_EtwWriteTransfer.c)
        ...
        const char *a7)
{
  ...
  v23 = v8;
  v25 = 0;
  return McGenEventWrite_EtwWriteTransfer((__int64)v8, v12, (__int64)v7, v10, &v15);
}
