/*
 * XREFs of ?AddEllipsisAndDrawLine@@YAHPEAUHDC__@@HPEAGHKPEAUDRAWTEXTDATA@@H@Z @ 0x1400C2CF0
 * Callers:
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  if ( (a5 & 0x8000) == 0 )
    goto LABEL_6;
  if ( !(unsigned int)NeedsEndEllipsis(v8, a3, (unsigned int *)&v22, a6, a5, a6) )
  {
    v6 = v22;
    goto LABEL_6;
  }
...
LABEL_5:
    ...
    a3 = v11;
    *(__int64 *)((char *)v11->m128i_i64 + 2 * v10) = 0x2E002E002ELL;
    v6 = v10 + 3;
    v8 = (HDC)v26;
LABEL_6:
