/*
 * XREFs of SfnOUTLPSCROLLBARINFO @ 0x1401EE6D0
 * Callers:
        ...
        __int64 a8)
{
  ...
  __int64 v24; // rcx
  void *v25; // rdx
  _DWORD v27[6]; // [rsp+30h] [rbp-178h] BYREF
  void *Src; // [rsp+48h] [rbp-160h] BYREF
  __int64 v29; // [rsp+50h] [rbp-158h] BYREF
  _BYTE v30[8]; // [rsp+60h] [rbp-148h] BYREF
  __int128 v31; // [rsp+68h] [rbp-140h]
  __int64 v32; // [rsp+78h] [rbp-130h]
  ULONG_PTR BugCheckParameter3[2]; // [rsp+80h] [rbp-128h] BYREF
  __int128 v34; // [rsp+90h] [rbp-118h] BYREF
  __int128 v35; // [rsp+A0h] [rbp-108h]
  __int128 v36; // [rsp+B0h] [rbp-F8h]
  __int64 v37; // [rsp+C0h] [rbp-E8h]
  int v38; // [rsp+C8h] [rbp-E0h]
  __int64 v39; // [rsp+D0h] [rbp-D8h]
  __int64 v40; // [rsp+100h] [rbp-A8h] BYREF
  int v41; // [rsp+108h] [rbp-A0h]
  __int64 v42; // [rsp+110h] [rbp-98h]
  __int128 v43; // [rsp+118h] [rbp-90h]
  __int128 v44; // [rsp+128h] [rbp-80h]
  __int128 v45; // [rsp+138h] [rbp-70h]
  __int64 v46; // [rsp+148h] [rbp-60h]
  int v47; // [rsp+150h] [rbp-58h]
  __int64 v48; // [rsp+158h] [rbp-50h]
  __int64 v49; // [rsp+160h] [rbp-48h]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 65) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(105LL, &v40, 104LL, &Src, v27);
  ...
  *(_QWORD *)(v20 + 80) = v32;
  if ( v18 >= 0 && v27[0] == 24 )
  {
    ...
    if ( !v24 || (*(_DWORD *)(v24 + 84) & 1) == 0 || *(__int128 **)(v24 + 96) != a4 )
    {
      ...
      v37 = 0LL;
      v38 = 0;
      RtlCopyFromUser(&v34, v25, 0x3CuLL);
      *a4 = v34;
      a4[1] = v35;
      a4[2] = v36;
      *((_QWORD *)a4 + 6) = v37;
