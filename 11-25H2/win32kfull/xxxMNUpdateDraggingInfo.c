/*
 * XREFs of xxxMNUpdateDraggingInfo @ 0x1402E9B84
 * Callers:
...
__int64 __fastcall xxxMNUpdateDraggingInfo(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 92) = 0;
  ...
  if ( v15 )
  {
    ...
    v23 = (unsigned int)(v21 + *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(*v19, v22) + 19872) + 2172LL));
    if ( v20 > (int)v23 )
    {
      v24 = *(_DWORD *)(*(_QWORD *)v17 + 68LL);
      v25 = *(_DWORD *)(*(_QWORD *)v17 + 76LL);
      if ( v20 >= v24 + v25 - *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v23, v16) + 19872) + 2172LL) )
        *(_DWORD *)(a1 + 92) = 2;
    }
    else
    {
