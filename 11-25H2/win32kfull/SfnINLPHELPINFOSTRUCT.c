/*
 * XREFs of SfnINLPHELPINFOSTRUCT @ 0x140210940
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v14 = 0LL;
  result = AllocCallbackMessage(88, 1u, *a4, v40, 1, 0x200uLL);
  v18 = result;
  ...
  if ( result )
  {
    ...
    *((_QWORD *)v18 + 7) = a3;
    a4[3] = 0;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v18, a4, *a4, (void **)v18 + 8) < 0 )
      goto LABEL_18;
    *((_QWORD *)v18 + 9) = a5;
    *((_QWORD *)v18 + 10) = a6;
    ...
    *((_QWORD *)v18 + 2) = 0LL;
    v25 = KeUserModeCallback(13LL, v18, *(unsigned int *)v18, &Src, &v30);
