/*
 * XREFs of NtUserDrawCaptionTemp @ 0x140295B70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  *(_OWORD *)v32 = *a3;
  ...
  if ( v19 )
  {
    ...
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11107);
LABEL_26:
    ExRaiseAccessViolation();
  }
LABEL_22:
  ...
  v14 = xxxDrawCaptionTemp(
          v16,
          v28,
          (struct tagRECT *)v32,
          v27,
          v17,
          (unsigned __int64)v26 & -(__int64)(v26[1] != 0LL),
          a7);
