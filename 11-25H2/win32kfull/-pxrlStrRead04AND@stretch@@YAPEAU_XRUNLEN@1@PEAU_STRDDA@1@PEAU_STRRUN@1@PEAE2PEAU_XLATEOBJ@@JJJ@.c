/*
 * XREFs of ?pxrlStrRead04AND@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1401EF700
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *((_DWORD *)a2 + 3) = *((_DWORD *)this + 2) - v11;
  if ( (int)a6 < a7 )
  {
    ...
    if ( a5 )
    {
      ...
      while ( 1 )
      {
        v18 = *(_DWORD *)(*((_QWORD *)a5 + 2)
                        + 4 * ((unsigned __int64)(v15 & (unsigned int)dword_140363A68[v17]) >> dword_140363A48[v17]));
    ...
    else
    {
      ...
      while ( 1 )
      {
        v29 = (v15 & (unsigned int)dword_140363A68[v27]) >> dword_140363A48[v27];
        v30 = *v28++;
        if ( (_DWORD)v30 )
        {
          v13 += v30;
