/*
 * XREFs of ?DoesPointSnapToTopLevelWindow@@YAHPEAUtagWND@@0PEAUtagTOUCHTARGETINGCONTACT@@UtagPOINT@@@Z @ 0x1401C23C0
 * Callers:
 ...
 *     ?TouchTargetingIsSpecialTarget@@YAHPEAUtagWND@@0@Z @ 0x1402A4D04 (-TouchTargetingIsSpecialTarget@@YAHPEAUtagWND@@0@Z.c)
 */
