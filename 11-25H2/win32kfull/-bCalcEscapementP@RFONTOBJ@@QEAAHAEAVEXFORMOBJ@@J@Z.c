/*
 * XREFs of ?bCalcEscapementP@RFONTOBJ@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1400ADD90
 * Callers:
 ...
 *     ?bCalcEscapement@RFONTOBJ@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x140215F1C (-bCalcEscapement@RFONTOBJ@@QEAAHAEAVEXFORMOBJ@@J@Z.c)
 * Callees:
