/*
 * XREFs of ?ArrangementHotKey@NotifyShell@@YAXW4ARRANGEMENT_HOTKEY_DISAMBIGUATION@@_J@Z @ 0x1402C1A38
 * Callers:
...
__int64 __fastcall NotifyShell::ArrangementHotKey(int a1, __int64 a2)
{
  ...
  if ( (_BYTE)result )
  {
    if ( !a1 )
    {
      Thread = ShellWindowManagement::GetThread(v5, v4);
