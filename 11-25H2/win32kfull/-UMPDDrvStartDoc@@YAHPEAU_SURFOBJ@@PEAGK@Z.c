/*
 * XREFs of ?UMPDDrvStartDoc@@YAHPEAU_SURFOBJ@@PEAGK@Z @ 0x140336FB0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall UMPDDrvStartDoc(struct _SURFOBJ *a1, unsigned __int16 *a2, int a3)
{
  ...
  __int128 Src; // [rsp+70h] [rbp-19h] BYREF
...
LABEL_10:
  if ( v9 )
  {
    ...
    LODWORD(v25[1]) = v18;
    v25[0] = a2;
    if ( (unsigned int)UMPDOBJ::pso(v7, (UMPDOBJ *)((char *)v7 + 80), &v24[1]) )
    {
      if ( (unsigned int)UMPDOBJ::ThunkStringW(v7, v25) )
      {
        LODWORD(Size) = 4;
        if ( (unsigned int)UMPDOBJ::Thunk(v7, &Src, 0x30u, &v15, Size) != -1 )
          v10 = v15 != 0;
      }
    }
    v3 = v10;
