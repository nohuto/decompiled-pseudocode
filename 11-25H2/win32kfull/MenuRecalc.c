/*
 * XREFs of MenuRecalc @ 0x14021D558
 * Callers:
...
_QWORD *__fastcall MenuRecalc(__int64 a1, __int64 a2)
{
  ...
  v4 = *(__int64 **)(W32GetUserSessionState(v3, v2) + 19832);
  v7 = 0;
  v8 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 19888);
  ...
  while ( v7 <= *(_DWORD *)(W32GetUserSessionState(i, v11) + 19816) );
