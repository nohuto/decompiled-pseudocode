/*
 * XREFs of NtUserNavigateFocus @ 0x14029B410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserNavigateFocus(__int64 a1)
{
  ...
  ULONG_PTR v32[3]; // [rsp+40h] [rbp-18h] BYREF
  ...
  if ( *(_QWORD *)(v11 + 472) == *(_QWORD *)(W32GetUserSessionState(v13, v12) + 18888) )
  {
    if ( *(_QWORD *)(v11 + 712) )
      goto LABEL_5;
  }
...
LABEL_19:
      ...
      if ( *(_QWORD *)(W32GetUserSessionState(v22, v21) + 18888)
        && (v26 = *(_QWORD *)(W32GetUserSessionState(v24, v23) + 18888),
      ...
      {
        Win32HMThreadLockBase<tagWND,1,0>::Win32HMThreadLockBase<tagWND,1,0>(v32, (__int64)TopLevelWindow);
        xxxForceForegroundWindowNoRestoreFocus((__int64)TopLevelWindow, 8);
        Win32HMThreadLock<tagCURSOR>::~Win32HMThreadLock<tagCURSOR>((ULONG_PTR)v32, v29);
      }
      goto LABEL_6;
    }
  }
