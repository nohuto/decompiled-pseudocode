/*
 * XREFs of ?PanEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x14030ABA0
 * Callers:
 *     <none>
 * Callees:
 *     ?bCreateSemaphores@@YAHPEAU_PANDEV@@@Z @ 0x14030BBCC (-bCreateSemaphores@@YAHPEAU_PANDEV@@@Z.c)
 *     ?vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z @ 0x14030BF94 (-vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z.c)
