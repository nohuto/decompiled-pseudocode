/*
 * XREFs of ?SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ @ 0x14026CB58
 * Callers:
 *     ?UmfdSessionInitialize@@YAJXZ @ 0x14010B620 (-UmfdSessionInitialize@@YAJXZ.c)
 * Callees:
 *     ?InitializeMaxCrashCount@UmfdHostLifeTimeManager@@SAXXZ @ 0x140225B84 (-InitializeMaxCrashCount@UmfdHostLifeTimeManager@@SAXXZ.c)
 */
...
char __fastcall UmfdHostLifeTimeManager::SessionInitialize(int a1, __int64 a2)
{
  ...
  *(_QWORD *)(v2 + 24240) = v6;
  ...
  GreInitializePushLock((struct W32_PUSH_LOCK *)(v2 + 24264));
  GreInitializePushLock((struct W32_PUSH_LOCK *)(v2 + 24272));
  KeInitializeEvent(*(PRKEVENT *)(v2 + 24216), SynchronizationEvent, 0);
  KeInitializeEvent(*(PRKEVENT *)(v2 + 24224), NotificationEvent, 0);
  KeInitializeEvent(*(PRKEVENT *)(v2 + 24232), NotificationEvent, 0);
  KeInitializeEvent(*(PRKEVENT *)(v2 + 24240), NotificationEvent, 0);
