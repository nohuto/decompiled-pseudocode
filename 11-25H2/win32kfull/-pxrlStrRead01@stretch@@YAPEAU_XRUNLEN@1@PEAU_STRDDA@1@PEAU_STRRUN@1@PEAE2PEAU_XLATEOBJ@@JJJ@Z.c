/*
 * XREFs of ?pxrlStrRead01@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x14011B6C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      {
        v50 = v34;
        if ( (v32 & dword_140355080[v34]) != 0 )
        {
          v36 = (unsigned int)*v33;
          if ( (dword_140355080[v14] & v52) != 0 )
          {
            if ( (_DWORD)v36 )
            {
