/*
 * XREFs of vIFIMetricsToEnumLogFontExDvW @ 0x140102118
 * Callers:
 *     bInitSystemFont @ 0x1403EC64C (bInitSystemFont.c)
 *     bInitOneStockFontInternal @ 0x1403ED6C8 (bInitOneStockFontInternal.c)
 * Callees:
 *     ?IsVariableFont@@YA_NPEAU_IFIMETRICS@@@Z @ 0x1401020D0 (-IsVariableFont@@YA_NPEAU_IFIMETRICS@@@Z.c)
 *     ?vLookupScript@@YAXKPEAGK@Z @ 0x1401021B4 (-vLookupScript@@YAXKPEAGK@Z.c)
 *     ?vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z @ 0x140102C80 (-vIFIMetricsToEnumLogFontW@@YAXPEAUtagENUMLOGFONTW@@PEAU_IFIMETRICS@@@Z.c)
