/*
 * XREFs of ?xxxMigrate@CRecalcState@@QEAAXPEAUtagWND@@PEAUtagRECT@@PEAVCMonitorTopology@@PEAVCRecalcContext@@@Z @ 0x1402C7E98
 * Callers:
        ...
        struct CRecalcContext *a5)
{
  ...
  if ( MigrateMonitor )
  {
    v19 = *((_QWORD *)this + 2);
    v20 = v16;
    if ( (*(_DWORD *)(W32GetUserSessionState(v18, v17) + 66800) & 0x10000) != 0
      && !*((_DWORD *)this + 16)
      && !*((_DWORD *)a5 + 8) )
    {
    ...
    if ( (AdvancedWindowPos::xxxMigrateWindow(a2, MigrateMonitor, v19, a3, a4, v20, (char *)a5 + 4, *((_QWORD *)a5 + 3)) & 1) != 0 )
    {
      *((_BYTE *)a5 + 8) = 1;
      ...
      if ( v35 || v7 )
      {
        v36 = W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v34);
        LOBYTE(v37) = v7;
        LOBYTE(v38) = v35;
        WPP_RECORDER_AND_TRACE_SF_(
          *(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 24LL),
