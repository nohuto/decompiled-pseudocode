/*
 * XREFs of ?_StoreGestureConfig@@YAHPEAUtagWND@@IPEAUtagGESTURECONFIG@@@Z @ 0x1401BE2C8
 * Callers:
 *     SetGestureConfigSettings @ 0x1401BDD88 (SetGestureConfigSettings.c)
 * Callees:
 *     UserSetLastError @ 0x14001A2B4 (UserSetLastError.c)
 *     ?IsBitSet@@YAHPEAEI@Z @ 0x1401BE4E0 (-IsBitSet@@YAHPEAEI@Z.c)
 *     ?SetBitMask@@YAXPEAUtagWND@@IH@Z @ 0x1401BE510 (-SetBitMask@@YAXPEAUtagWND@@IH@Z.c)
 *     ?GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z @ 0x1401BE558 (-GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z.c)
 *     ?GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z @ 0x1401BE5BC (-GetWindowGCList@@YAPEAPEAXPEAUtagWND@@@Z.c)
 *     ?GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z @ 0x1402B99F8 (-GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z.c)
...
LABEL_4:
  ...
  for ( i = 0LL; (unsigned int)i < a2; i = (unsigned int)(i + 1) )
  {
    ...
    if ( (v13 & v14) != 0
      ...
      || (v16 = ~dword_140356DE0[v15], (v16 & v14) != 0)
      || (v13 & v16) != 0 )
    {
      v10 = 87;
      goto LABEL_4;
