/*
 * XREFs of ?DCEIsWindowHit@@YAHPEAUtagWND@@PEAUtagPOINT@@PEBU_SUBPIXELS@@@Z @ 0x1401549DC
 * Callers:
...
__int64 __fastcall DCEIsWindowHit(struct tagWND *a1, struct tagPOINT *a2, const struct _SUBPIXELS *a3)
{
  ...
  if ( v10
    || *((_QWORD *)a1 + 3)
    && *(_DWORD *)(W32GetUserSessionState(v9, a2) + 66092)
    && *(_QWORD *)(W32GetUserSessionState(v12, v11) + 62976) != *((_QWORD *)a1 + 3)
...
LABEL_14:
  ...
  if ( v15 && !(unsigned int)GrePtInRegion(v15, (unsigned int)v3.x) )
    return 0LL;
  v16 = *((_QWORD *)a1 + 5);
