/*
 * XREFs of ?bBrushPath@@YAHPEAVSURFACE@@PEAU_PATHOBJ@@PEAU_RECTL@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x140224434
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( y < 0 )
    v24 = v15 - (-1 - y) % v15 - 1;
  v18 = a6 + 3 * v13;
  v19[0] = qword_14034DA50[v18];
  v19[1] = qword_14034DB80[v18];
