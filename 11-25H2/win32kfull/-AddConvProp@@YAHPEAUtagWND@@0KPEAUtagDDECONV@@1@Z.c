/*
 * XREFs of ?AddConvProp@@YAHPEAUtagWND@@0KPEAUtagDDECONV@@1@Z @ 0x1402B1150
 * Callers:
        ...
        struct tagDDECONV *a5)
{
  ...
  v7 = a2;
  v9 = *(unsigned __int16 *)(W32GetUserSessionState(a1, a2) + 41336);
  v18 = (char *)a4 + 24;
  ...
  *((_DWORD *)a4 + 20) = a3;
  ...
  if ( (a3 & 1) == 0 )
    v7 = a1;
  v13 = GetProp((__int64)v7, *(unsigned __int16 *)(UserSessionState + 41340), 1u);
  if ( v13 )
    ++*(_WORD *)(v13 + 90);
  *((_QWORD *)a4 + 11) = v13;
  HMLockObject(a4);
  v16 = W32GetUserSessionState(v15, v14);
  InternalSetProp((__int64)a1, *(unsigned __int16 *)(v16 + 41336), (__int64)a4, 1u);
  return 1LL;
}
