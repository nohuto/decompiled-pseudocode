/*
 * XREFs of ?CreateTopologySnapshot@CMonitorTopology@@SAPEAV1@XZ @ 0x1402547D4
 * Callers:
...
struct CMonitorTopology *__fastcall CMonitorTopology::CreateTopologySnapshot(__int64 a1, __int64 a2)
{
  ...
  if ( !v5 )
  {
    ...
    v7 = (int *)**v3;
    v72 = *v7;
    v10 = *(_QWORD *)(W32GetUserSessionState(v7, v4) + 69160);
    v70 = 11;
LABEL_50:
    LOBYTE(v9) = v6;
    LOBYTE(v8) = v2;
  ...
  if ( !v74 )
  {
    ...
    v72 = *v32;
    v70 = 14;
    v10 = *(_QWORD *)(W32GetUserSessionState(v32, v31) + 69160);
    goto LABEL_50;
  }
  *v74 = 1;
  if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
  ...
  while ( v47 )
  {
    ...
    if ( (*(_DWORD *)(v48 + 24) & 1) != 0 )
    {
      ...
      *((_QWORD *)v43 + 6) = v46;
      ...
      if ( v47 == *(_QWORD **)(GetDispInfo(v50) + 104) )
        *((_DWORD *)v28 + 2) = v44;
