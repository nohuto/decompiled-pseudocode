/*
 * XREFs of ?RealizePendingRecreateTouchInjectionDevices@@YAHPEAUtagPROCESSINFO@@H@Z @ 0x14027A704
 * Callers:
...
__int64 __fastcall RealizePendingRecreateTouchInjectionDevices(struct tagPROCESSINFO *a1, int a2)
{
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v7, v6) + 19264) )
  {
    if ( v2 )
    {
      if ( !a2 && !*(_DWORD *)(v2 + 52) )
    ...
    if ( a2 )
    {
      v10 = *(_QWORD **)(W32GetUserSessionState(v9, v8) + 19264);
      if ( v10 )
      {
        do
        {
