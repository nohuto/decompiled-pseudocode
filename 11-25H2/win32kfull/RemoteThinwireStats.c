/*
 * XREFs of RemoteThinwireStats @ 0x14026F4A0
 * Callers:
 *     NtUserRemoteThinwireStats @ 0x14029D700 (NtUserRemoteThinwireStats.c)
 * Callees:
...
__int64 __fastcall RemoteThinwireStats(_OWORD *a1, __int64 a2)
{
  ...
  if ( PsGetCurrentProcess(v9) != v8 )
    return 3221225506LL;
  if ( !*(_QWORD *)(W32GetUserSessionState(v11, v10) + 68928) )
    return 3221225486LL;
  ProbeForWrite(a1, 0x54uLL, 1u);
  v15 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 68928);
  *a1 = *(_OWORD *)v15;
  a1[1] = *(_OWORD *)(v15 + 16);
  a1[2] = *(_OWORD *)(v15 + 32);
  a1[3] = *(_OWORD *)(v15 + 48);
