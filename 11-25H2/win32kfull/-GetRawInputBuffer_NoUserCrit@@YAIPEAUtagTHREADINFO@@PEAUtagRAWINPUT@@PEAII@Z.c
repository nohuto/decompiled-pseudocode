/*
 * XREFs of ?GetRawInputBuffer_NoUserCrit@@YAIPEAUtagTHREADINFO@@PEAUtagRAWINPUT@@PEAII@Z @ 0x1401D0484
 * Callers:
 ...
 *     ?ReverseHidDataList@@YAPEAUtagHIDDATA@@PEAU_SLIST_ENTRY@@@Z @ 0x140189470 (-ReverseHidDataList@@YAPEAUtagHIDDATA@@PEAU_SLIST_ENTRY@@@Z.c)
        ...
        unsigned int a4)
{
  ...
  if ( SLODWORD(a1[74].Alignment) > 500 )
  {
    ...
    {
      LODWORD(v23) = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 16718LL);
    }
  }
