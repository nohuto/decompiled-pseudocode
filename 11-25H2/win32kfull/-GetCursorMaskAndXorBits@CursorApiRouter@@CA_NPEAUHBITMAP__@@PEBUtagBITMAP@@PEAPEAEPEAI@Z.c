/*
 * XREFs of ?GetCursorMaskAndXorBits@CursorApiRouter@@CA_NPEAUHBITMAP__@@PEBUtagBITMAP@@PEAPEAEPEAI@Z @ 0x1402DB9C4
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = 0;
  ...
  {
    v15 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1186);
  }
  return 0;
}
