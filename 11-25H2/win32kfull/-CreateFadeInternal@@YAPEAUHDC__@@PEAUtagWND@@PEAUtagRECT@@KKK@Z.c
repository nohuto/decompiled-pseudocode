/*
 * XREFs of ?CreateFadeInternal@@YAPEAUHDC__@@PEAUtagWND@@PEAUtagRECT@@KKK@Z @ 0x1401F46B0
 * Callers:
...
HDC __fastcall CreateFadeInternal(struct tagWND *this, struct tagRECT *a2, int a3, int a4, unsigned int a5)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 43000) )
    return 0LL;
  if ( *(_QWORD *)(UserSessionState + 42992) )
  {
    GreCleanDC();
    GreSetLayout(*(_QWORD *)(v10 + 42992), 0xFFFFFFFFLL, 0LL);
  }
  else
  {
    v35 = W32GetUserSessionState(0LL, v9);
    CompatibleDC = GreCreateCompatibleDC(*(_QWORD *)(*(_QWORD *)(v35 + 56968) + 64LL));
    *(_QWORD *)(v10 + 42992) = CompatibleDC;
    if ( !CompatibleDC )
      return 0LL;
    GreSetDCOwnerEx(CompatibleDC, 0LL, 0LL, 0LL);
  }
  if ( this )
    v6 = (struct tagRECT *)(*((_QWORD *)this + 5) + 88LL);
  v55[0] = 96;
  if ( this )
  {
    *(_DWORD *)(v10 + 43032) |= 8u;
    *(_QWORD *)(v10 + 42984) = *(_QWORD *)this;
    ...
    xxxSetLayeredWindow(this, 0, 0LL);
  ...
  else
  {
    ...
    *(_DWORD *)(v10 + 43032) &= ~8u;
    if ( (a4 & 0x100) != 0 )
    {
      ...
      v62[0] = v61;
      v62[1] = v61;
      v27 = **(__int64 ***)(*(_QWORD *)(W32GetUserSessionState(v26, v25) + 19144) + 8LL);
      v63 = *v27;
    ...
    else
    {
      ...
      SpriteInternal = (HSPRITE)GreCreateSprite(
                                  *(Gre::Base **)(*(_QWORD *)(v34 + 56968) + 48LL),
                                  0LL,
                                  v6,
                                  0LL,
                                  0x9900u,
    ...
    *(_QWORD *)(v10 + 42984) = SpriteInternal;
    if ( SpriteInternal )
    {
      v33 = W32GetUserSessionState(v16, v15);
      GreDwmNotifySpriteMonitorChange(*(Gre::Base **)(*(_QWORD *)(v33 + 56968) + 48LL), 0LL, SpriteInternal);
    }
  }
  if ( !*(_QWORD *)(v10 + 42984) )
    return 0LL;
  ...
  CompatibleBitmap = GreCreateCompatibleBitmapEx(*(HDC *)(*(_QWORD *)(v19 + 56968) + 64LL), v17, v18, 0, 0LL, v55);
  *(_QWORD *)(v10 + 43000) = CompatibleBitmap;
  if ( !CompatibleBitmap )
  {
    DeleteFadeSprite();
    return 0LL;
  }
  GreSelectBitmap(*(_QWORD *)(v10 + 42992), CompatibleBitmap);
  if ( this )
  {
    if ( (*(_BYTE *)(*((_QWORD *)this + 5) + 26LL) & 0x40) != 0 )
      GreSetLayout(*(_QWORD *)(v10 + 42992), 0xFFFFFFFFLL, 1LL);
  }
  GreSetDCOwnerEx(*(_QWORD *)(v10 + 42992), 2147483650LL, 0LL, 1LL);
  *(_DWORD *)(v10 + 43008) = v6->left;
  v54 = v6->top;
  *(_DWORD *)(v10 + 43032) |= a4;
  *(_DWORD *)(v10 + 43012) = v54;
  *(_DWORD *)(v10 + 43024) = v57;
  LOBYTE(v54) = *(_DWORD *)(v10 + 43032) & 0x40;
  *(_DWORD *)(v10 + 43016) = v17;
  *(_DWORD *)(v10 + 43020) = v18;
  *(_DWORD *)(v10 + 43036) = (_BYTE)v54 != 0 ? 0xFF00FF : 0;
  return *(HDC *)(v10 + 42992);
}
