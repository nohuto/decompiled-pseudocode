/*
 * XREFs of ?SHData_SetCustomDockTargetWindow@MOVESIZEDATA@@QEAA_NPEBUtagWND@@@Z @ 0x14014C920
 * Callers:
...
bool __fastcall MOVESIZEDATA::SHData_SetCustomDockTargetWindow(MOVESIZEDATA *this, struct tagTHREADINFO **a2)
{
  ...
  if ( !(unsigned int)IsMessageOnlyWindow(a2) )
  {
    ...
    if ( !v6 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v10 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v4) + 69160);
    v36 = 16;
    goto LABEL_84;
  }
  ...
  if ( v13 != v11 )
  {
    ...
    if ( !v6 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v10 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v12) + 69160);
    v36 = 17;
    goto LABEL_84;
  }
  v14 = *((_DWORD *)a2[5] + 72);
