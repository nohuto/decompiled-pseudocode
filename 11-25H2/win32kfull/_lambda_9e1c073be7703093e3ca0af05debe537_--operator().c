/*
 * XREFs of _lambda_9e1c073be7703093e3ca0af05debe537_::operator() @ 0x140023EC0
 * Callers:
 *     _lambda_9e1c073be7703093e3ca0af05debe537_::_lambda_invoker_cdecl_ @ 0x140024270 (_lambda_9e1c073be7703093e3ca0af05debe537_--_lambda_invoker_cdecl_.c)
 * Callees:
...
bool __fastcall lambda_9e1c073be7703093e3ca0af05debe537_::operator()(__int64 a1, __int64 a2, _OWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  v8 = (const struct tagWND **)((char *)TopWindow + 200);
  if ( !IsWindowActivateable(*((const struct tagWND **)TopWindow + 25)) || (v7 = *v8) != 0LL )
  {
    *(_QWORD *)&v10 = v7;
    *((_QWORD *)&v10 + 1) = 3LL;
    *a3 = v10;
