/*
 * XREFs of ?IsPumpingInputMsgs@@YA_NPEBUtagWND@@@Z @ 0x14014BD00
 * Callers:
...
char __fastcall IsPumpingInputMsgs(const struct tagWND *a1, __int64 a2)
{
  ...
  for ( i = *(__int64 **)(v2 + 1288); i; i = (__int64 *)*i )
  {
    ...
    {
      if ( !v10 || (unsigned int)(v5 - *((_DWORD *)i + 4)) <= *(_DWORD *)(W32GetUserSessionState(v7, v6) + 69112) )
        return 1;
      return v4;
    }
    if ( v10 )
    {
      v7 = *(unsigned int *)(W32GetUserSessionState(v7, v6) + 69112);
