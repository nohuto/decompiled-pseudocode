/*
 * XREFs of ?xxxRefreshDisplayOrientation@CRotationMgr@@UEAAXXZ @ 0x140272FB8
 * Callers:
...
void __fastcall CRotationMgr::xxxRefreshDisplayOrientation(CRotationMgr *this, __int64 a2)
{
  ...
  CRotationMgr::xxxSetAutoRotationConvertible(
    this,
    (*(_DWORD *)(*(_QWORD *)(UserSessionState + 19872) + 2236LL) >> 3) & 1);
  v10 = W32GetUserSessionState(v9, v8);
  CRotationMgr::xxxSetAutoRotationDocked(this, (*(_DWORD *)(*(_QWORD *)(v10 + 19872) + 2236LL) >> 4) & 1);
