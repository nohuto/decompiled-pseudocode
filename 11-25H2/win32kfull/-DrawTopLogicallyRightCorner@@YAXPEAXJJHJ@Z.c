/*
 * XREFs of ?DrawTopLogicallyRightCorner@@YAXPEAXJJHJ@Z @ 0x140227F64
 * Callers:
...
void __fastcall DrawTopLogicallyRightCorner(_DWORD *a1, int a2, int a3, int a4, int a5)
{
  ...
  if ( a4 )
  {
    ...
    while ( (__int64)v7 < (__int64)&dword_140359B04 );
  }
  else
  {
    v13 = a2 * (a3 - 5);
    ...
    while ( (__int64)v14 < (__int64)&dword_140359AF4 );
  }
}
