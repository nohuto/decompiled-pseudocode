/*
 * XREFs of ?OnDaemonTimer@ShellForegroundBoost@@YAXXZ @ 0x1401C4B70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ShellForegroundBoost::OnDaemonTimer(ShellForegroundBoost *this, __int64 a2)
{
  ...
  CShellForegroundBoost::DeBoostIfTime(*(CShellForegroundBoost **)(UserSessionState + 18880), v2 - 50000000);
}
