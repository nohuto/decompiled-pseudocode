/*
 * XREFs of MNPositionSysMenu @ 0x140209594
 * Callers:
...
__int64 __fastcall MNPositionSysMenu(__int64 a1, _QWORD *a2)
{
  ...
  if ( *(char *)(v5 + 24) >= 0 )
  {
    ...
    else if ( (*(_DWORD *)(v5 + 232) & 0x400) != 0 )
    {
      WindowDpiLastNotify = GetWindowDpiLastNotify(a1);
           ...
           && (v19 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 496LL)) != 0
    ...
    {
      v15 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 464LL) + 272LL);
    }
    v17 = 13;
  }
  else
  {
    ...
    {
      v9 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 464LL) + 272LL);
    }
  ...
  if ( (*(_BYTE *)(v25 + 31) & 0x20) == 0 )
  {
    ...
    else if ( (*(_DWORD *)(v25 + 232) & 0x400) != 0 )
    {
      v28 = GetWindowDpiLastNotify(a1);
           ...
           && (v29 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 496LL)) != 0
    ...
    {
      v28 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 464LL) + 272LL);
    }
    result = GetWindowBordersForDpi(*(_DWORD *)(v25 + 28), *(unsigned int *)(v25 + 24), v25, v24, v28);
    v13 += result;
    v6 = result;
    v26 += result;
  }
