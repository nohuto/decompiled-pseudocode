/*
 * XREFs of ?xxxGetDummyText@@YAPEAXPEAUtagWINDOWSTATION@@IPEAUtagGETCLIPBDATA@@@Z @ 0x1402B448C
 * Callers:
...
__int64 __fastcall xxxGetDummyText(struct tagTHREADINFO **a1, int a2, struct tagGETCLIPBDATA *a3)
{
  int v5; // r15d
  int v6; // edx
  int v7; // edx
  ...
  v9 = 7;
LABEL_8:
  ClipFormat = FindClipFormat((unsigned __int64)a1, v8, 1);
  v11 = 0LL;
  if ( !ClipFormat )
    return 0LL;
  v12 = a1;
  ...
  {
    v14 = FindClipFormat((unsigned __int64)a1, v9, 1);
...
LABEL_14:
  ...
  if ( !v5 )
    v8 = v9;
  v15 = FindClipFormat((unsigned __int64)a1, v8, 1);
  if ( !v15 )
    return 0LL;
  *(_DWORD *)a3 = *(_DWORD *)v15;
  v16 = *((_QWORD *)v15 + 1);
  v17 = FindClipFormat((unsigned __int64)a1, 0x10u, 1);
  if ( v17 )
    v11 = *((_QWORD *)v17 + 1);
  *((_QWORD *)a3 + 1) = v11;
  return v16;
