/*
 * XREFs of ?Restore@CHECKPOINT@@SAPEAU1@PEAUtagWND@@AEBUtagRECT@@@Z @ 0x14026B5C0
 * Callers:
...
struct CHECKPOINT *__fastcall CHECKPOINT::Restore(struct tagWND *a1, const struct tagRECT *a2)
{
  ...
  if ( !v6 )
  {
    ...
    if ( !(unsigned int)InternalSetProp((__int64)a1, *(unsigned __int16 *)(v16 + 41334), (__int64)v6, 9u) )
    {
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
        || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 8) == 0
        || *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) < 2u )
