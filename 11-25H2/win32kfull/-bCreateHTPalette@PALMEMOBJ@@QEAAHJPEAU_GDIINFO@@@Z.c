/*
 * XREFs of ?bCreateHTPalette@PALMEMOBJ@@QEAAHJPEAU_GDIINFO@@@Z @ 0x1400FDB28
 * Callers:
...
_BOOL8 __fastcall PALMEMOBJ::bCreateHTPalette(PALMEMOBJ *this, int a2, struct _GDIINFO *a3)
{
  ...
  if ( (unsigned int)(a2 - 5) > 2 )
  {
    ...
    if ( !a2 )
    {
      v6 = (struct tagPALETTEENTRY *)&unk_1403533A8;
      v7 = 2;
    ...
    if ( v9 )
    {
      ...
      {
        v7 = 16;
        v6 = (struct tagPALETTEENTRY *)&unk_1403639C0;
        goto LABEL_5;
      }
      if ( v10 == 1 )
      {
...
LABEL_5:
    ...
    v7 = 8;
    v6 = (struct tagPALETTEENTRY *)v26;
    v26[0] = xmmword_140353418;
    v26[1] = xmmword_140353428;
