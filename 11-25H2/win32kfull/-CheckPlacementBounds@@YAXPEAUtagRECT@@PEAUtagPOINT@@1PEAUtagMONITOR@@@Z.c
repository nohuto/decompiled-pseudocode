/*
 * XREFs of ?CheckPlacementBounds@@YAXPEAUtagRECT@@PEAUtagPOINT@@1PEAUtagMONITOR@@@Z @ 0x1401EE244
 * Callers:
        ...
        struct tagMONITOR *a4)
{
  ...
  CurrentThreadCompositedDpiContext = GetCurrentThreadCompositedDpiContext((__int64)a1);
...
LABEL_38:
  ...
  if ( a2->x != -1 )
  {
    v22 = *(_QWORD *)(W32GetUserSessionState(bottom, right) + 19872);
    v23 = *(_DWORD *)(v22 + 2084);
    v25 = *(_QWORD *)(W32GetUserSessionState(v22, v24) + 19872);
    y = a2->y;
    v27 = y >= v21 ? y > v20 : -1;
