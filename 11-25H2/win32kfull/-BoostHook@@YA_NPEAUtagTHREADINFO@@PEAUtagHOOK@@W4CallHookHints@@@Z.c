/*
 * XREFs of ?BoostHook@@YA_NPEAUtagTHREADINFO@@PEAUtagHOOK@@W4CallHookHints@@@Z @ 0x140286198
 * Callers:
...
char __fastcall BoostHook(__int64 a1, __int64 a2)
{
  ...
  v2 = *(_QWORD *)(a2 + 16);
  if ( (dword_140355994[*(int *)(a2 + 48)] & 0x20) == 0 )
    return 0;
  ...
  if ( (*(_DWORD *)(a2 + 64) & 0x2000) != 0 )
  {
    if ( !(unsigned __int8)tagTHREADINFO::IsPriorityFloorSet(v2, v7) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1243);
    if ( *(_BYTE *)(a2 + 96) == 0xFF )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1244);
    ++*(_BYTE *)(a2 + 96);
    if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
      || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 0x10) == 0
  ...
  {
    if ( *(_BYTE *)(a2 + 96) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1190);
    if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
      || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 0x10) == 0
