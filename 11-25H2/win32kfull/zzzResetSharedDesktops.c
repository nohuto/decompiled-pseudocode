/*
 * XREFs of zzzResetSharedDesktops @ 0x1402557F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall zzzResetSharedDesktops(__int64 a1, __int64 a2, unsigned int a3, int a4)
{
  ...
  GreSelectVisRgn(*(_QWORD *)(*(_QWORD *)(v23 + 56968) + 64LL), v20, 1LL);
  ...
  CCursorClip::ClearClip(*(CCursorClip **)(v29 + 36240));
  if ( (unsigned int)Feature_DispBrokerOptimizations__private_IsEnabledDeviceUsageNoInline(v30)
    ...
    && (v33 = W32GetUserSessionState(v32, v31),
        MonitorFromPoint(*(_QWORD *)(*(_QWORD *)(v33 + 19872) + 4960LL), 0, 0x12u)) )
  {
    v35 = *(_QWORD *)(W32GetUserSessionState(v32, v31) + 19872);
    v40 = *(_QWORD *)(v35 + 4960);
    v36 = v40;
  }
  else
  {
    v35 = *(_QWORD *)(W32GetUserSessionState(v32, v31) + 56968);
  ...
  *(_QWORD *)(W32GetUserSessionState(v35, v34) + 36224) = v40;
