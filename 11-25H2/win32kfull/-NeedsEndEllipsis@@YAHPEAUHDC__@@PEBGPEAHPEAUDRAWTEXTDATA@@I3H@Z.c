/*
 * XREFs of ?NeedsEndEllipsis@@YAHPEAUHDC__@@PEBGPEAHPEAUDRAWTEXTDATA@@I3H@Z @ 0x1400C29A4
 * Callers:
 ...
 *     ?DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z @ 0x1400C35B0 (-DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z.c)
 */
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  if ( (int)DT_GetExtentMinusPrefixes(a1, a2, v6, a5, v17, a6, -1) <= v11
    || !(unsigned int)GreGetTextExtentW(a1, (__m128i *)L"...", 3LL, &v19) )
  {
    return 0LL;
  }
  v13 = v12 - v19.cx + v11;
  ...
  *a3 = DT_AdjustBreakForSurrogatesAndVariationSelectors((const unsigned __int16 *)a2, v14, v6);
  return 1LL;
}
