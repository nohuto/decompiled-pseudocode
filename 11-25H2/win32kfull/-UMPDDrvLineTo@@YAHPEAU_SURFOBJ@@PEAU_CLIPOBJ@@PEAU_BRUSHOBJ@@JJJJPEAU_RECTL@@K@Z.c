/*
 * XREFs of ?UMPDDrvLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x140335CE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  if ( v23 )
  {
    ...
    if ( v16 )
    {
      ...
      v39 = a9;
      v31 = a1;
      if ( (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 80), &v31) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 128), (const void **)&v32, 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 160), (const void **)&v33, 0x18u, 0LL) )
          {
            ...
            {
              LODWORD(Size) = 4;
              if ( (unsigned int)UMPDOBJ::Thunk(v14, Src, 0x50u, &v19, Size) != -1 )
                v17 = v19 != 0;
            }
          }
        }
