/*
 * XREFs of ?MmUnmapViewOfSection@UmfdHostLifeTimeManager@@SAJPEAX_K@Z @ 0x1401CA248
 * Callers:
 *     UmfdHostLifeTimeManager_MmUnmapViewOfSection @ 0x1401CA230 (UmfdHostLifeTimeManager_MmUnmapViewOfSection.c)
 * Callees:
 *     <none>
 */
