/*
 * XREFs of ?BasicTargetingHitTest@@YAHPEAUtagWND@@PEAUtagTOUCHTARGETINGCONTACT@@UtagPOINT@@PEAGPEAU3@HPEAUtagRECT@@W4tagTARGETING_PROPERTY@@HKH@Z @ 0x1401C16C0
 * Callers:
 ...
 *     ?TouchTargetingLayerHitTest@@YAHPEAUtagWND@@UtagPOINT@@HPEBUtagTOUCHTARGETINGCONTACT@@PEAUtagRECT@@PEAGPEAU2@W4tagTARGETING_PROPERTY@@@Z @ 0x140229998 (-TouchTargetingLayerHitTest@@YAHPEAUtagWND@@UtagPOINT@@HPEBUtagTOUCHTARGETINGCONTACT@@PEAUtagREC.c)
 *     TouchTargetingRankForRegion @ 0x1402F3750 (TouchTargetingRankForRegion.c)
        ...
        int a11)
{
  ...
  *(_QWORD *)a5 = 0LL;
  ...
  if ( v16
    || v35 < v18.m128i_i32[0]
    || (v21 = _mm_srli_si128(v18, 8).m128i_u64[0], v35 >= (int)v21)
  ...
  v22 = *(_QWORD *)(a1 + 40);
  v23 = *(_QWORD *)(v22 + 168);
  if ( v23 && (v16 || !(unsigned int)GrePtInRegion(*(_QWORD *)(v22 + 168), (unsigned int)(*a5 + v35))) )
  {
    if ( v30 && (*(_BYTE *)(*(_QWORD *)(a1 + 40) + 30LL) & 4) == 0 )
      return 0LL;
    v25 = a2;
    v33 = *(__m128i *)(*(_QWORD *)(a1 + 40) + 88LL);
    v29 = TouchTargetingRankForRegion(v23, (unsigned int)&v33, (_DWORD)a2, (_DWORD)a5, v36);
    v24 = a4;
    *a4 = v29;
    if ( v29 > 0xFFDu )
      return 0LL;
