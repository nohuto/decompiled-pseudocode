/*
 * XREFs of SfnNCDESTROY @ 0x140194180
 * Callers:
...
__int64 __fastcall SfnNCDESTROY(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // r12d
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 65) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(3LL, &v23, 48LL, &Src, &v32);
