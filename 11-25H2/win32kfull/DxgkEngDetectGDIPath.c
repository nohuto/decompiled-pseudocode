/*
 * XREFs of DxgkEngDetectGDIPath @ 0x1403264B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z @ 0x1403261EC (-OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z.c)
 *     ?StateFlags@PDEVOBJ@@QEBAKXZ @ 0x1403262C0 (-StateFlags@PDEVOBJ@@QEBAKXZ.c)
 */
