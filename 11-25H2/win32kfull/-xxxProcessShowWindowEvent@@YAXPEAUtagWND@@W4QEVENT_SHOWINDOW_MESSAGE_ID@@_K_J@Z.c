/*
 * XREFs of ?xxxProcessShowWindowEvent@@YAXPEAUtagWND@@W4QEVENT_SHOWINDOW_MESSAGE_ID@@_K_J@Z @ 0x14016FFF4
 * Callers:
 ...
 *     WPUpdateCheckPointSettings @ 0x1402ACAF4 (WPUpdateCheckPointSettings.c)
 */
