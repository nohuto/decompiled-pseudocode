/*
 * XREFs of ?OnDeviceClosed@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1402EBEDC
 * Callers:
 ...
 *     ?OnDeviceClosed@RimBackedDeviceBase@@UEAAXXZ @ 0x1402EF210 (-OnDeviceClosed@RimBackedDeviceBase@@UEAAXXZ.c)
 */
