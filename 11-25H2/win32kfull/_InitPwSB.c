/*
 * XREFs of _InitPwSB @ 0x1402E19AC
 * Callers:
 ...
 *     ??4?$SharedPointerFieldpSBInfo@UtagSBINFO@@@tagWND@@QEAAPEAUtagSBINFO@@PEAU2@@Z @ 0x1401E6F10 (--4-$SharedPointerFieldpSBInfo@UtagSBINFO@@@tagWND@@QEAAPEAUtagSBINFO@@PEAU2@@Z.c)
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x14026E830 (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     GetFnidString @ 0x1402E1758 (GetFnidString.c)
 */
...
__int64 __fastcall InitPwSB(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !result )
  {
    if ( (*(_WORD *)(a1[5] + 42) & 0x2FFF) == 0x29C )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000, 271);
    ...
    if ( v7 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_AND_TRACE_SF_qs(
        ...
        *(_QWORD *)(UserSessionState + 69160),
        ...
        9,
        10,
        (__int64)&WPP_d837b21e8f0430db6c1d6bedfc022fd5_Traceguids,
        v10,
        v11);
    }
