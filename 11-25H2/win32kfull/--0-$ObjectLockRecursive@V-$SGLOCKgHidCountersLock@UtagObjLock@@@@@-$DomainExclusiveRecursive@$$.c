/*
 * XREFs of ??0?$ObjectLockRecursive@V?$SGLOCKgHidCountersLock@UtagObjLock@@@@@?$DomainExclusiveRecursive@$$V@?$DomainSharedRecursive@$$V@@QEAA@AEAV?$SGLOCKgHidCountersLock@UtagObjLock@@@@@Z @ 0x14011CFE8
 * Callers:
 ...
 * Callees:
 *     ?lock@?$ObjectLockRecursive@V?$SGLOCKgHidCountersLock@UtagObjLock@@@@@?$DomainExclusiveRecursive@$$V@?$DomainSharedRecursive@$$V@@AEAAXXZ @ 0x14026E344 (-lock@-$ObjectLockRecursive@V-$SGLOCKgHidCountersLock@UtagObjLock@@@@@-$DomainExclusiveRecursive.c)
 */
        ...
        __int64 a2)
{
  ...
  *(_BYTE *)(a1 + 32) = 0;
  ...
  if ( v7 != W32GetUserSessionState(v9, v8) - 24 )
    v4 = W32GetUserSessionState(v11, v10) + 42480;
  *(_QWORD *)(a1 + 16) = v4;
