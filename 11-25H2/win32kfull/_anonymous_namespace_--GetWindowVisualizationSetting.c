/*
 * XREFs of _anonymous_namespace_::GetWindowVisualizationSetting @ 0x1401972D4
 * Callers:
        ...
        if ( a1 )
        {
          ...
          if ( v18 )
          {
            while ( 1 )
            {
              ...
              Prop = GetProp(v18, *(unsigned __int16 *)(UserSessionState + 41350), 1u);
              if ( (Prop & 0x20000) != 0 )
                break;
...
LABEL_20:
  ...
  if ( (v8 & 0x40000) != 0 )
  {
    ...
    CTouchProcessor::SetPointerVisualization(*(CTouchProcessor **)(v17 + 3256), *(_WORD *)(v6 + 4), 1, 0LL, 0);
  }
  else
  {
    PointerVisualization = a2 == 0;
