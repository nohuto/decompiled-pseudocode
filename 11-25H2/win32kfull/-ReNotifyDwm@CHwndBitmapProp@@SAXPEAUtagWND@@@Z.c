/*
 * XREFs of ?ReNotifyDwm@CHwndBitmapProp@@SAXPEAUtagWND@@@Z @ 0x140172168
 * Callers:
 ...
 *     DwmAsyncCreateDCompositionVisualBitmapForHwnd @ 0x140214E4C (DwmAsyncCreateDCompositionVisualBitmapForHwnd.c)
 */
