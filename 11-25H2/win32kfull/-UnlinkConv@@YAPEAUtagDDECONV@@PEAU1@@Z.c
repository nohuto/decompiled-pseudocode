/*
 * XREFs of ?UnlinkConv@@YAPEAUtagDDECONV@@PEAU1@@Z @ 0x1402B183C
 * Callers:
...
struct tagDDECONV *__fastcall UnlinkConv(struct tagDDECONV *a1, __int64 a2)
{
  ...
  *((_DWORD *)a1 + 20) |= 0x1000u;
  ...
  Prop = GetProp(*((_QWORD *)a1 + 5), *(unsigned __int16 *)(UserSessionState + 41336), 1u);
  if ( !Prop )
    return 0LL;
  v6 = 0LL;
