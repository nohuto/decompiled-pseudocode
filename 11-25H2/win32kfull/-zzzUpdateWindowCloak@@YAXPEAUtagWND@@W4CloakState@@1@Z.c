/*
 * XREFs of ?zzzUpdateWindowCloak@@YAXPEAUtagWND@@W4CloakState@@1@Z @ 0x14025C124
 * Callers:
...
void __fastcall zzzUpdateWindowCloak(__int64 a1, __int64 a2, int a3)
{
  ...
  int v9; // r9d
  __int64 v10; // rcx
  struct tagSHADOW *ShadowWindow; // rax
  __int64 v12; // rdx
  __int64 v13; // rcx
  __int64 v14; // rax
  __int64 v15; // rdi
  ...
  v5 = (_DWORD)a2 != 0;
  v6 = a3 != 0;
  v7 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19144) + 48LL) & 0x400;
  if ( v5 != v6 || (v8 = 0, v7) )
    v8 = 1;
  ...
  if ( v5 != v6 )
  {
    ...
    {
      ShadowWindow = FindShadowWindow((struct tagWND *)a1);
      if ( ShadowWindow )
...
LABEL_20:
    ...
    {
      DecCloakWindows(*(struct tagPROCESSINFO **)(v14 + 464));
