/*
 * XREFs of ?DrawGroove@@YAXPEAUHDC__@@PEAUHBRUSH__@@PEAUtagRECT@@H@Z @ 0x1402E2C74
 * Callers:
...
void __fastcall DrawGroove(HDC a1, HBRUSH a2, __m128i *a3, int a4)
{
  ...
  v14 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872);
  if ( a2 == *(HBRUSH *)(v14 + 4856)
    || a2 == *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 19872) + 4944LL) )
  {
    v15 = a3;
  }
  else
