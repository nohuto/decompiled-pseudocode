/*
 * XREFs of ?xxxWindowHitTestWithTargeting@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@UtagRECT@@W4tagTARGETING_PROPERTY@@@Z @ 0x1401C1988
 * Callers:
  ...
  if ( v5 && !v11 )
  {
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)(a3 + 88) != (_DWORD)v20 || v16 )
      {
        ...
        Prop = GetProp(v5, *(unsigned __int16 *)(UserSessionState + 41348), 1u);
        v20 = 0LL;
      }
      else
      {
