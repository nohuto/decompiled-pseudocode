/*
 * XREFs of ?bPartialQuadrantArc@@YAHW4PARTIALARC@@AEAVEPATHOBJ@@AEAVEBOX@@AEAVEPOINTFL@@AEAVEFLOAT@@34@Z @ 0x1400A87E8
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  float v36; // [rsp+40h] [rbp-69h] BYREF
  float v37; // [rsp+44h] [rbp-65h]
  unsigned __int64 v38; // [rsp+48h] [rbp-61h] BYREF
  ...
  if ( !a1 )
    goto LABEL_10;
  EBOX::ptlXform(a3, (struct EPOINTFL *)v32, (float *)&v34);
  v18 = a1 - 1;
  if ( v18 )
  {
    if ( v18 != 1 )
    {
LABEL_10:
      v43[0] = **(_QWORD **)&EBOX::ptlXform(a3, (struct EPOINTFL *)v32, (float *)&v35);
      v43[1] = **(_QWORD **)&EBOX::ptlXform(a3, (struct EPOINTFL *)v32, &v36);
      v20 = (_QWORD *)EBOX::ptlXform(a3, (struct EPOINTFL *)v32, (float *)&v38);
      v41 = 0LL;
      v43[2] = *v20;
      v42 = 0;
      v39 = v43;
