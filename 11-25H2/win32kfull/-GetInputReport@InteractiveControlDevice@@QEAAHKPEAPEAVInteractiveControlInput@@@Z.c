/*
 * XREFs of ?GetInputReport@InteractiveControlDevice@@QEAAHKPEAPEAVInteractiveControlInput@@@Z @ 0x1402ED5D0
 * Callers:
        ...
        struct InteractiveControlInput **a3)
{
  ...
  for ( i = *v3; i != (struct InteractiveControlInput *)v3; i = *(struct InteractiveControlInput **)i )
  {
    if ( *((_DWORD *)i + 8) == a2 )
    {
      *a3 = i;
