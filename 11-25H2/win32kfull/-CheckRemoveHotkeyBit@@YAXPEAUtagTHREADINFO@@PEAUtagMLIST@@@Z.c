/*
 * XREFs of ?CheckRemoveHotkeyBit@@YAXPEAUtagTHREADINFO@@PEAUtagMLIST@@@Z @ 0x140212058
 * Callers:
...
void __fastcall CheckRemoveHotkeyBit(struct tagTHREADINFO *a1, __int64 **a2)
{
  ...
  {
LABEL_6:
    _InterlockedAnd((volatile signed __int32 *)(*((_QWORD *)a1 + 61) + 8LL), 0xFFFFFF7F);
    _InterlockedAnd((volatile signed __int32 *)(*((_QWORD *)a1 + 61) + 4LL), 0xFFFFFF7F);
  }
}
