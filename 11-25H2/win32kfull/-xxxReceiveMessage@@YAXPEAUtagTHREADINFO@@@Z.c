/*
 * XREFs of ?xxxReceiveMessage@@YAXPEAUtagTHREADINFO@@@Z @ 0x14016A55C
 * Callers:
...
void __fastcall xxxReceiveMessage(struct tagTHREADINFO *a1)
{
  ...
  __int64 v131; // r8
  __int64 v132; // r9
  char v133; // [rsp+50h] [rbp-178h]
  bool v134; // [rsp+58h] [rbp-170h]
  __int64 v135; // [rsp+60h] [rbp-168h] BYREF
  PVOID *v136; // [rsp+68h] [rbp-160h]
  __int64 v137; // [rsp+70h] [rbp-158h]
  struct tagTHREADINFO *v138; // [rsp+78h] [rbp-150h]
  struct tagHOOK *v139; // [rsp+80h] [rbp-148h]
  __int64 *v140; // [rsp+88h] [rbp-140h]
  struct tagSMS *v141; // [rsp+90h] [rbp-138h]
  int v142; // [rsp+98h] [rbp-130h]
  __int64 v143; // [rsp+A0h] [rbp-128h]
  __int64 v144; // [rsp+A8h] [rbp-120h]
  ULONG_PTR BugCheckParameter3[2]; // [rsp+B0h] [rbp-118h] BYREF
  ULONG_PTR v146[2]; // [rsp+C0h] [rbp-108h] BYREF
  __int64 v147; // [rsp+D0h] [rbp-F8h]
  __int128 v148; // [rsp+E0h] [rbp-E8h] BYREF
  __int64 v149; // [rsp+F0h] [rbp-D8h]
  int v150; // [rsp+F8h] [rbp-D0h]
  __int64 v151; // [rsp+100h] [rbp-C8h]
  struct tagTHREADINFO *v152; // [rsp+108h] [rbp-C0h]
  ULONG_PTR v153[2]; // [rsp+118h] [rbp-B0h] BYREF
  __int64 v154[2]; // [rsp+128h] [rbp-A0h] BYREF
  __int128 v155; // [rsp+138h] [rbp-90h]
  __int128 v156; // [rsp+148h] [rbp-80h]
  _BYTE v157[56]; // [rsp+158h] [rbp-70h] BYREF
    ...
    **((_DWORD **)a1 + 61) |= 8u;
    ...
    if ( *((_DWORD *)v3 + 22) != 788 )
    {
      ...
      *((_DWORD *)PtiCurrent(v76, v75) + 401) = v74;
      ...
      v82 = *(_QWORD *)(W32GetUserSessionState(v78, v63) + 19872);
      if ( (unsigned __int64)(unsigned __int16)v137 >= *(_QWORD *)(v82 + 8)
        || (v83 = W32GetUserSessionState(v82, v81),
            v86 = *(_DWORD *)(W32GetUserSessionState(v85, v84) + 19896) * (unsigned __int16)v137,
            v80 = v86 + *(_QWORD *)(v83 + 19888),
            v88 = W32GetUserSessionState(v86, v87),
            v89 = v3[12],
            *(_QWORD *)(*(_QWORD *)(v88 + 19832) + 40LL * (unsigned __int16)v137) != v89)
        || *(_BYTE *)(v80 + 24) != 1 )
      {
        ...
        if ( *((_DWORD *)v3 + 22) == 255 )
        {
          ...
          if ( v119 )
          {
            if ( *(struct tagTHREADINFO **)(v119 + 16) == a1 )
            {
              ...
              if ( !v120 )
                MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 4419LL);
              FreeHidData((__int64)v120);
            }
            else
            {
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 4424LL);
            }
          }
        }
      }
          ...
          *(_QWORD *)&v155 = *(_QWORD *)(v37 + 16);
          if ( *((_DWORD *)v36 + 7) != -1
            && !UIPrivilegeIsolation::CheckAccess(
                  ...
                  (const struct tagUIPI_INFO *)(*((_QWORD *)a1 + 58) + 864LL),
                  v45) )
          {
            LODWORD(v154[1]) |= 2u;
          }
