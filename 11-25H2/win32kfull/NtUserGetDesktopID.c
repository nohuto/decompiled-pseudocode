/*
 * XREFs of NtUserGetDesktopID @ 0x14019D2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetDesktopID(int a1, void *a2)
{
  ...
  if ( (unsigned int)IsCurrentProcessDwm() )
  {
    ...
    if ( v8 )
    {
      ...
      {
        if ( v9 == 2 )
          v5 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 62976);
      }
      else
      {
        v5 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 62840);
      }
    }
    else
    {
      v5 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 19144);
    }
    if ( v5 )
    {
      Src = ***(_QWORD ***)(v5 + 8);
