/*
 * XREFs of ?DCEChildTreeSpeedHitTest@@YAPEAUtagWND@@PEAU1@UtagPOINT@@PEAU2@PEBU_SUBPIXELS@@@Z @ 0x14008CCB4
 * Callers:
        ...
        const struct _SUBPIXELS *a4)
{
  ...
  struct tagPOINT v25; // [rsp+70h] [rbp+8h] BYREF
  struct _SUBPIXELS *v26; // [rsp+88h] [rbp+20h]
  ...
  while ( 1 )
  {
    ...
    {
      v11 = *(_QWORD *)(v9 + 168);
      if ( !v11 || (unsigned int)GrePtInRegion(v11, (unsigned int)v10.x) )
      {
        v12 = *(_BYTE **)(v4 + 40);
        v13 = v12[26];
        if ( (v13 & 8) == 0
          ...
          && ((v13 & v12[27] & 0x20) != 0
           || (v19 = IsWindowDesktopComposed(v4),
               ...
               (unsigned int)GrePtInSprite(*(HDEV *)(*(_QWORD *)(UserSessionState + 56968) + 48LL), v20 >= 0x602u, v21))) )
        {
          v5 = v26;
          goto LABEL_12;
        }
...
LABEL_25:
  ...
  v25 = a2;
  if ( !(unsigned int)DCEIsWindowHit((struct tagWND *)v4, &v25, v5) )
    goto LABEL_25;
  *a3 = v25;
LABEL_12:
  if ( *(_QWORD *)(v4 + 112) )
