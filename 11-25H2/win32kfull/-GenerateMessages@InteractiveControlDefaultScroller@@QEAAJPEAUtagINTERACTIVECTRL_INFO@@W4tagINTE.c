/*
 * XREFs of ?GenerateMessages@InteractiveControlDefaultScroller@@QEAAJPEAUtagINTERACTIVECTRL_INFO@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x14012F240
 * Callers:
 ...
 *     ?UpdateWindow@InteractiveControlDefaultScroller@@AEAAJPEAPEAUtagWND@@@Z @ 0x14026C9C8 (-UpdateWindow@InteractiveControlDefaultScroller@@AEAAJPEAPEAUtagWND@@@Z.c)
        ...
        *((_DWORD *)a1 + 15) = v9;
        ...
        if ( updated >= 0 )
        {
          ...
          if ( updated >= 0 )
          {
            ...
            v6 = updated;
            if ( updated >= 0 || (unsigned int)dword_14039BBF8 <= 2 )
              return v6;
          }
