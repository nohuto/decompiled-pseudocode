/*
 * XREFs of DpiRectIntersectsRectWithSubpixel @ 0x1400344D4
 * Callers:
 ...
 *     ?RectIntersectsRect@@YAHMMMMMMMM@Z @ 0x1401FB754 (-RectIntersectsRect@@YAHMMMMMMMM@Z.c)
 */
        ...
        struct tagWND *a6)
{
  ...
  return RectIntersectsRect(v15, v14, v13, v12, v11, v10, v9, v8);
}
