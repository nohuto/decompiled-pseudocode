/*
 * XREFs of ?ShouldReceiveTouchpadMessages@@YA_NPEBUtagTHREADINFO@@PEAUHWND__@@@Z @ 0x1402475D0
 * Callers:
...
char __fastcall ShouldReceiveTouchpadMessages(const struct tagTHREADINFO *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = 0;
  if ( (unsigned int)Feature_TouchpadPublicApis__private_IsEnabledDeviceUsageNoInline(a1, a2, a3, a4) )
