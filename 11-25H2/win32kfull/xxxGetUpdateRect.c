/*
 * XREFs of xxxGetUpdateRect @ 0x140051110
 * Callers:
...
LABEL_17:
    ...
    if ( (unsigned int)IntersectWithParents((__int64)a1, (int *)v31) )
    {
      ...
      if ( (*(_BYTE *)(v19 + 8) & 0x20) != 0 )
      {
        ...
        v27 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 56968);
        for ( i = *(__int64 **)(v27 + 24); ; i = (__int64 *)*i )
        {
          v27 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 56968) + 24LL;
          if ( i == (__int64 *)v27 )
            break;
