/*
 * XREFs of ?UMPDDrvStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1400CE390
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  _BYTE Src[4]; // [rsp+A0h] [rbp-60h] BYREF
  int v33; // [rsp+A4h] [rbp-5Ch]
  __int64 v34; // [rsp+B0h] [rbp-50h]
  struct _SURFOBJ *v35; // [rsp+B8h] [rbp-48h] BYREF
  void *v36; // [rsp+C0h] [rbp-40h] BYREF
  void *v37; // [rsp+C8h] [rbp-38h] BYREF
  void *v38; // [rsp+D0h] [rbp-30h] BYREF
  void *v39; // [rsp+D8h] [rbp-28h] BYREF
  void *v40; // [rsp+E0h] [rbp-20h] BYREF
  struct _LINEATTRS *v41; // [rsp+E8h] [rbp-18h] BYREF
  void *v42; // [rsp+F0h] [rbp-10h] BYREF
  unsigned int v43; // [rsp+F8h] [rbp-8h]
  unsigned int v44; // [rsp+FCh] [rbp-4h]
  ...
  if ( v23 )
  {
    ...
    if ( v16 )
    {
      ...
      v35 = a1;
      v41 = a6;
      if ( (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 80), &v35, v13) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 240), &v36, 8u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 128), &v37, 0x18u, 0LL) )
          {
            if ( !v38
              || (v21 = 0, (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 288), &v38, 4u, &v21)) )
            {
              if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 160), &v39, 0x18u, 0LL) )
              {
                if ( (unsigned int)UMPDOBJ::ThunkLINEATTRS(v14, &v41) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 176), &v42, 0x18u, 0LL) )
                  {
                    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v40, 8u) )
                    {
                      LODWORD(Size) = 4;
                      if ( UMPDOBJ::Thunk(v14, Src, 0x60u, &v20, Size) != -1 )
                      {
                        if ( v20 )
                          v17 = 1;
                      }
