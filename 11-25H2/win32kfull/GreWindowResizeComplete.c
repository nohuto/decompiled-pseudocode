/*
 * XREFs of GreWindowResizeComplete @ 0x1401F855C
 * Callers:
 ...
 *     ?AdapterLuid@SFMLOGICALSURFACE@@QEAA?AU_LUID@@XZ @ 0x1401A5EF8 (-AdapterLuid@SFMLOGICALSURFACE@@QEAA-AU_LUID@@XZ.c)
 *     ?vDeviceBitmapAdapterHint@PDEVOBJ@@QEAAXPEAU_LUID@@@Z @ 0x140217DA8 (-vDeviceBitmapAdapterHint@PDEVOBJ@@QEAAXPEAU_LUID@@@Z.c)
...
__int64 __fastcall GreWindowResizeComplete(__int64 a1, HWND a2)
{
  ...
  _BYTE v19[144]; // [rsp+70h] [rbp-59h] BYREF
