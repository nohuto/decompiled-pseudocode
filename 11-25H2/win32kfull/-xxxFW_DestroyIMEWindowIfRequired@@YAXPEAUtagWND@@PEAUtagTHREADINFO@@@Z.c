/*
 * XREFs of ?xxxFW_DestroyIMEWindowIfRequired@@YAXPEAUtagWND@@PEAUtagTHREADINFO@@@Z @ 0x1402B5EDC
 * Callers:
...
void __fastcall xxxFW_DestroyIMEWindowIfRequired(struct tagWND *a1, struct tagTHREADINFO *a2)
{
  ...
  v7 = *(_DWORD **)(W32GetUserSessionState(v6, v5) + 19872);
  if ( (*v7 & 4) == 0
    ...
    || (UserSessionState = W32GetUserSessionState(v8, v7),
        v11 = *(_WORD **)(v9 + 8),
        *v11 == *(_WORD *)(*(_QWORD *)(UserSessionState + 19872) + 898LL)) )
  {
    if ( v4 )
      return;
    goto LABEL_15;
