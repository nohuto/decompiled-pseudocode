/*
 * XREFs of ?GetDefaultWallpaperName@@YAXPEAGI@Z @ 0x1402B75AC
 * Callers:
 ...
 *     ?RtlStringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1402678F4 (-RtlStringCchCatW@@YAJPEAG_KPEBG@Z.c)
 */
...
void __fastcall GetDefaultWallpaperName(char *a1, unsigned int a2)
{
  ...
  if ( *(unsigned __int8 *)(v8 + 7003)
     * (unsigned int)*(unsigned __int8 *)(*(_QWORD *)(W32GetUserSessionState(v10, v9) + 19872) + 7002LL) > 4 )
