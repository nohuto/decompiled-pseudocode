/*
 * XREFs of ?xxxMNGetBitmapSize@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@PEAUtagWND@@HPEAUHDC__@@@Z @ 0x1400416A8
 * Callers:
...
__int64 __fastcall xxxMNGetBitmapSize(struct tagMENU ***a1, __int64 *a2, struct tagWND *a3, int a4, __int64 a5)
{
  __int64 v9; // rax
  int v10; // eax
  __int64 v11; // rcx
