/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x1403D3BC8
 * Callers:
...
__int64 TlgRegisterAggregateProviderEx()
{
  ...
  if ( !TlgAggregateSession )
    return TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((char *)&dword_14039BB88, 0LL, 0LL);
  TlgAggregateSession[41] = 0LL;
  TlgAggregateSession[42] = 0LL;
  TlgAggregateSession[43] = &dword_14039BB88;
  *((_BYTE *)TlgAggregateSession + 373) = 1;
  v4 = TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(
         (char *)&dword_14039BB88,
  ...
  else
  {
    ...
    if ( !qword_14039C3F0 )
      TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(
        (char *)&dword_14039BCA0,
        (__int64)TlgAggregateInternalProviderCallback,
        0LL);
    for ( i = &qword_14039C3F0; ; i = (__int64 *)(v7 + 352) )
    {
      v7 = *i;
      if ( !*i )
        break;
      if ( *(int **)(v7 + 344) == &dword_14039BB88 )
        goto LABEL_11;
    }
    *i = (__int64)v1;
LABEL_11:
