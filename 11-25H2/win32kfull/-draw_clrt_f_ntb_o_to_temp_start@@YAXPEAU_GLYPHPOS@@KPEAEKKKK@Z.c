/*
 * XREFs of ?draw_clrt_f_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x140300310
 * Callers:
 *     <none>
 * Callees:
 *     ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x14030048C (-vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z.c)
 */
