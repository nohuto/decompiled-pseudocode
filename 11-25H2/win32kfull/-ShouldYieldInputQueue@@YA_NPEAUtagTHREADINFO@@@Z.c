/*
 * XREFs of ?ShouldYieldInputQueue@@YA_NPEAUtagTHREADINFO@@@Z @ 0x14027CD60
 * Callers:
  ...
  if ( (*(_DWORD *)(v4 + 412) & 0x1000) != 0 )
  {
    ...
    if ( v6 )
    {
      while ( (*((_DWORD *)v6 + 25) & 0x10000000) == 0 )
      {
        ...
        if ( v7 == 512 )
        {
          v8 = *(unsigned int *)(*((_QWORD *)a1 + 59) + 520LL);
          v9 = (v8 & 1) == 0;
        }
        else
        {
...
LABEL_27:
        ...
        if ( !(_BYTE)a2 )
        {
          ...
          if ( Variant == 2 )
          {
            a2 = *(unsigned int *)(v11 + 412);
            a3 = 412LL;
            if ( (*(_DWORD *)(v11 + 412) & 0x2000) != 0 )
              v5 = 1;
            LODWORD(a2) = a2 | 0x2000;
            if ( (*(_DWORD *)(v11 + 412) & 0x2000) != 0 )
              a2 = *(_DWORD *)(v11 + 412) & 0xFFFFEFFF;
            *(_DWORD *)(v11 + 412) = a2;
          }
          else
          {
            if ( !*(_WORD *)(v11 + 524) )
              *(LARGE_INTEGER *)(*((_QWORD *)a1 + 59) + 528LL) = KeQueryPerformanceCounter(0LL);
            ++*(_WORD *)(*((_QWORD *)a1 + 59) + 524LL);
        ...
        if ( !v5 )
        {
          *((_DWORD *)v6 + 25) |= 0x10000000u;
          if ( *((_DWORD *)v6 + 6) == 512 )
            *(_DWORD *)(*((_QWORD *)a1 + 59) + 520LL) |= 1u;
          if ( *((_DWORD *)v6 + 6) == 255 )
            *(_DWORD *)(*((_QWORD *)a1 + 59) + 520LL) |= 2u;
        }
        v6 = (__int64 *)*v6;
        if ( !v6 )
          return v5;
  ...
  else
  {
    ...
    {
      *(_DWORD *)(v4 + 520) = 0;
      *(_DWORD *)(*((_QWORD *)a1 + 59) + 412LL) &= ~0x2000u;
      *(_WORD *)(*((_QWORD *)a1 + 59) + 524LL) = 0;
      *(_WORD *)(*((_QWORD *)a1 + 59) + 526LL) = 0;
      *(_QWORD *)(*((_QWORD *)a1 + 59) + 528LL) = 0LL;
      v13 = *(__int64 **)(v4 + 24);
      if ( v13 )
      {
        while ( 1 )
