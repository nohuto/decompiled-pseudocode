/*
 * XREFs of WriteTiltCalibrationData @ 0x140271AA4
 * Callers:
 ...
 *     ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x140145BB8 (-RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z.c)
  ...
  if ( TiltKeyName >= 0 )
  {
    ...
    *(_QWORD *)&v12.Length = 91750400LL;
    ...
    TiltKeyName = RtlUnicodeStringCopy(
                    &v12,
                    (const struct _UNICODE_STRING *)(*(_QWORD *)(UserSessionState + 63520) + 200LL));
    if ( TiltKeyName >= 0 )
    {
      TiltKeyName = RtlUnicodeStringCatString(&v12, off_14034ECD8[v4]);
      if ( TiltKeyName >= 0 )
      {
        Disposition = 0;
