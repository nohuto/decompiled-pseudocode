/*
 * XREFs of NtGdiSetPUMPDOBJ @ 0x140265370
 * Callers:
 *     <none>
 * Callees:
 *     ?GreGetCurrentThread@@YAPEAU_GRETHREAD@@XZ @ 0x14001B014 (-GreGetCurrentThread@@YAPEAU_GRETHREAD@@XZ.c)
 *     ?PushThreadUMPDObj@UMPDOBJ@@QEAAXPEAU_GRETHREAD@@@Z @ 0x1400D3244 (-PushThreadUMPDObj@UMPDOBJ@@QEAAXPEAU_GRETHREAD@@@Z.c)
...
__int64 __fastcall NtGdiSetPUMPDOBJ(__int64 a1, __int64 a2, _QWORD *a3, _DWORD *a4)
{
  ...
  {
    LOBYTE(a2) = 17;
    v7 = (UMPDOBJ *)HmgShareLock(a1, a2, a3, a4);
  }
  else
  {
    v7 = 0LL;
