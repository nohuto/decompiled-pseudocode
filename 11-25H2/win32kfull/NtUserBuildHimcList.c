/*
 * XREFs of NtUserBuildHimcList @ 0x140210ED0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_BuildHimcList@@YAIPEBUtagTHREADINFO@@IPECREAUHIMC__@@@Z @ 0x1402824C4 (-_BuildHimcList@@YAIPEBUtagTHREADINFO@@IPECREAUHIMC__@@@Z.c)
