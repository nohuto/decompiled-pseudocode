/*
 * XREFs of ?_GetSendMessageReceiver@@YAPEAUtagWND@@K@Z @ 0x1402939F4
 * Callers:
...
struct tagWND *__fastcall _GetSendMessageReceiver(__int64 a1, __int64 a2)
{
  ...
  {
    if ( v8[191] != *(_DWORD *)(v7 + 764) || v8[192] != *(_DWORD *)(v7 + 768) )
      goto LABEL_5;
LABEL_8:
    v10 = *(_QWORD *)(v5 + 544);
    if ( !v10 )
  ...
  if ( UIPrivilegeIsolation::CheckAccess(
         (UIPrivilegeIsolation *)(v8 + 216),
         (const struct tagUIPI_INFO *)(v7 + 864),
         v9) )
  {
    goto LABEL_8;
  }
