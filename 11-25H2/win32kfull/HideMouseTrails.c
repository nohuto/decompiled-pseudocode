/*
 * XREFs of HideMouseTrails @ 0x1401CA390
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HideMouseTrails(__int64 a1, __int64 a2)
{
  ...
  if ( *(int *)(W32GetUserSessionState(a1, a2) + 16300) > 0 )
  {
    ...
    if ( (int)v8 <= (int)v7 )
    {
      v9 = *(CursorApiRouter **)(W32GetUserSessionState(v8, v7) + 36304);
      v12 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19872);
      v13 = *(_DWORD *)(v12 + 4964);
      v15 = *(_QWORD *)(W32GetUserSessionState(v14, v12) + 19872);
      v16 = *(_DWORD *)(v15 + 4960);
      v18 = W32GetUserSessionState(v17, v15);
      CursorApiRouter::MovePointerAsync(v9, *(HDEV *)(*(_QWORD *)(v18 + 56968) + 48LL), v16, v13, 1u);
    }
  }
}
