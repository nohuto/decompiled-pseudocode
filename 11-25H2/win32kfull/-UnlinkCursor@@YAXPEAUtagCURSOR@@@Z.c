...
LABEL_3:
  ...
  v4 = 1;
  for ( i = (struct tagCURSOR **)(W32GetUserSessionState(a1, 0LL) + 36280);
        ;
        i = (struct tagCURSOR **)(W32GetUserSessionState(a1, i) + 36280) )
  {
LABEL_4:
    while ( 1 )
    {
...
LABEL_8:
  ...
  v8 = *(_QWORD *)(UserSessionState + 19888);
  v11 = v8 + 32LL * *(unsigned int *)(W32GetUserSessionState(v10, v9) + 19816);
  v14 = *(_QWORD **)(W32GetUserSessionState(v13, v12) + 19832);
  for ( j = *(_QWORD *)(UserSessionState + 19888); j <= v11; j += 32LL )
  {
    if ( *(_BYTE *)(j + 24) == 3 )
    {
