/*
 * XREFs of ?SetPreviewInsertAfter@DWM_ARRANGEMENT_DATA@@QEAAXPEAUHWND__@@PEBUMOVESIZEDATA@@@Z @ 0x14018CCC0
 * Callers:
 ...
 *     DwmAsyncSendSnapPreviewInsertAfter @ 0x14018CDBC (DwmAsyncSendSnapPreviewInsertAfter.c)
 */
