/*
 * XREFs of ?vClearTypeLookupTableLoop@@YAXKPEAVSURFACE@@PEAUBLENDINFO@@KK@Z @ 0x1400F2D90
 * Callers:
  ...
  *(_QWORD *)(v9 + 5336) = v11;
  ...
  do
  {
    ...
    v22 = *((_DWORD *)a3 + 6) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v14
                                                                                  + ((dword_140351920[*v19] * v15
                                                                                    + 0x80000) >> 20))
                                                                   + v21) << *((_DWORD *)a3 + 1)) >> *(_DWORD *)a3) | *((_DWORD *)a3 + 8) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v24 + ((dword_140351920[v19[2]] * v18 + 0x80000) >> 20)) + v21) << *((_DWORD *)a3 + 5)) >> *((_DWORD *)a3 + 4)) | *((_DWORD *)a3 + 7) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v16 + ((dword_140351920[v19[1]] * v17 + 0x80000) >> 20)) + v21) << *((_DWORD *)a3 + 3)) >> *((_DWORD *)a3 + 2));
    if ( v23 == 2 )
      *v10 = v22;
    else
      *v20 = v22;
