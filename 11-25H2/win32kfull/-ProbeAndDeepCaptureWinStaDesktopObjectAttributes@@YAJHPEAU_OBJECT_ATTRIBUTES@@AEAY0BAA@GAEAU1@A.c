/*
 * XREFs of ?ProbeAndDeepCaptureWinStaDesktopObjectAttributes@@YAJHPEAU_OBJECT_ATTRIBUTES@@AEAY0BAA@GAEAU1@AEAU_SECURITY_QUALITY_OF_SERVICE@@AEAPEAXAEAU_UNICODE_STRING@@AEAPEAG@Z @ 0x14028C768
 * Callers:
...
LABEL_26:
  ...
  *(_DWORD *)&DestinationString->Length = *(_DWORD *)ObjectName;
  ...
  {
LABEL_23:
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1749);
LABEL_24:
    ExRaiseAccessViolation();
  }
