/*
 * XREFs of ?InitMapSharedSection@@YAJPEAU_EPROCESS@@PEAU_USERCONNECT@@@Z @ 0x1400D949C
 * Callers:
...
__int64 __fastcall InitMapSharedSection(struct _EPROCESS *a1, struct _USERCONNECT *a2)
{
  ...
  *((_QWORD *)a2 + 5) = v69;
  ...
  v27 = *(_QWORD *)(W32GetUserSessionState(v26, v25) + 19864);
  *((_QWORD *)a2 + 1) = v69 + *(_QWORD *)(v24 + 19880) - v27;
  v29 = W32GetUserSessionState(v27, v28);
  v32 = *(_QWORD *)(W32GetUserSessionState(v31, v30) + 19856);
  *((_QWORD *)a2 + 2) = v70 + *(_QWORD *)(v29 + 19888) - v32;
  v34 = W32GetUserSessionState(v32, v33);
  v35 = v34 + 19880;
  v36 = *(unsigned int *)(v34 + 19896);
  *((_DWORD *)a2 + 6) = v36;
  v38 = W32GetUserSessionState(v36, v37);
  v41 = W32GetUserSessionState(v40, v39);
  v42 = v69 + *(_QWORD *)(v38 + 19904) - *(_QWORD *)(v41 + 19864);
  *((_QWORD *)a2 + 4) = v42;
  *((_DWORD *)a2 + 136) = *(_DWORD *)(v35 + 536);
  v44 = W32GetUserSessionState(v43, v42);
  v47 = *(_QWORD *)(W32GetUserSessionState(v46, v45) + 19864);
  *((_QWORD *)a2 + 69) = v69 + *(_QWORD *)(v44 + 20424) - v47;
  *((_DWORD *)a2 + 140) = *(_DWORD *)(v35 + 552);
  v49 = W32GetUserSessionState(v47, v48);
  v52 = v35 - (_QWORD)a2;
  v53 = 31LL;
  v55 = *(_QWORD *)(W32GetUserSessionState(v51, v50) + 19864);
  v56 = (char *)a2 + 48;
  *((_QWORD *)a2 + 71) = v69 + *(_QWORD *)(v49 + 20440) - v55;
  v57 = 192LL - (_QWORD)a2;
  do
  {
    *(_DWORD *)v56 = *(_DWORD *)&v56[v52 - 8];
    if ( *(_QWORD *)&v56[v52] )
    {
      ...
      v55 = v59 + v57;
      v54 = v69 + *(_QWORD *)&v56[v59 + 19688 + v57] - *(_QWORD *)(v62 + 19864);
    }
    else
    {
      v54 = 0LL;
  ...
  while ( v53 );
  v58 = *(_DWORD *)(W32GetUserSessionState(v55, v54) + 71176);
  result = 0LL;
  *((_DWORD *)a2 + 144) = v58;
  return result;
}
