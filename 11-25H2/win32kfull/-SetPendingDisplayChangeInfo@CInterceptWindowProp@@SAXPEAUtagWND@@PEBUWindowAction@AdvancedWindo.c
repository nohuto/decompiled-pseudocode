/*
 * XREFs of ?SetPendingDisplayChangeInfo@CInterceptWindowProp@@SAXPEAUtagWND@@PEBUWindowAction@AdvancedWindowPos@@@Z @ 0x1402CCCB8
 * Callers:
        ...
        const struct AdvancedWindowPos::WindowAction *a2)
{
  ...
  if ( v3 )
  {
    ...
    v6 = (volatile signed __int32 *)*((_QWORD *)a2 + 19);
    *((_QWORD *)v4 + 8) = v6;
