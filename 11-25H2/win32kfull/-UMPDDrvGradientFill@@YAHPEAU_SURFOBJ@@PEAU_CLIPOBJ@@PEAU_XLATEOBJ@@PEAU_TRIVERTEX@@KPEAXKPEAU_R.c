/*
 * XREFs of ?UMPDDrvGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1403355A0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  _DWORD Src[4]; // [rsp+80h] [rbp-80h] BYREF
...
LABEL_18:
    v25 = 0;
    if ( (unsigned int)UMPDOBJ::pso(v15, (UMPDOBJ *)((char *)v15 + 80), &v40) )
    {
          ...
          if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v15, (const void **)&v43, 16 * a5) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v15, (const void **)&v45, v17) )
            {
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v15, (const void **)&v47, 0x10u) )
              {
                ...
                {
                  LODWORD(Size) = 4;
                  if ( (unsigned int)UMPDOBJ::Thunk(v15, Src, 0x68u, &v29, Size) != -1 )
                  {
                    if ( v29 )
                      v25 = 1;
                  }
