/*
 * XREFs of ?_SwapMouseButton@@YAHH@Z @ 0x140203DD0
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x140197AB8 (xxxSystemParametersInfoWorker.c)
 *     NtUserSwapMouseButton @ 0x140203D90 (NtUserSwapMouseButton.c)
 * Callees:
...
__int64 __fastcall _SwapMouseButton(__int64 a1)
{
  ...
  if ( !(unsigned int)CheckGrantedAccess(*(_DWORD *)(v3 + 664), 0x12u) )
    return 0LL;
