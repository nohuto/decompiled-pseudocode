/*
 * XREFs of Feature_TouchpadHaptics__private_IsEnabledFallback @ 0x140294530
 * Callers:
 *     Feature_TouchpadHaptics__private_IsEnabledDeviceUsageNoInline @ 0x1402944F8 (Feature_TouchpadHaptics__private_IsEnabledDeviceUsageNoInline.c)
 * Callees:
