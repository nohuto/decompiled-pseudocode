/*
 * XREFs of ?bTriangleMesh@@YAHPEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAU_GRADIENT_TRIANGLE@@KKPEAU_RECTL@@4PEAU_POINTL@@@Z @ 0x1400F7C94
 * Callers:
 ...
 *     ?bIsTriangleInBounds@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x14021B6A8 (-bIsTriangleInBounds@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
...
LABEL_31:
        ...
        v45 = &v29[Vertex2];
        v46 = &v29[Vertex1];
        if ( !(unsigned int)bIsTriangleInBounds(v46, v45, v44, (struct _TRIANGLEDATA *)v16) )
          goto LABEL_25;
