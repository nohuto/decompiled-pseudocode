/*
 * XREFs of NtUserRegisterForCustomDockTargets @ 0x14024C3D0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtUserRegisterForCustomDockTargets(__int64 a1)
{
  ...
  if ( !*(_QWORD *)(W32GetUserSessionState(v19, v18) + 18888)
    || (v28 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 18888), !*(_QWORD *)(v28 + 128)) )
  {
...
LABEL_52:
  ...
  v30 = *(MOVESIZEDATA **)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v28, v26) + 18888) + 128LL) + 16LL)
                         + 712LL);
  if ( !v30 )
  {
    v31 = *(unsigned int **)&WPP_GLOBAL_Control != &WPP_GLOBAL_Control
