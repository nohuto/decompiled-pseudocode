/*
 * XREFs of ?bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z @ 0x140338AB8
 * Callers:
...
LABEL_10:
    ...
    GreAcquireSemaphore<17,>(v9 + 4872);
    v10 = *(_QWORD *)(v9 + 20408);
    v11 = *(_QWORD *)(*v4 + 136LL);
    --*(_DWORD *)(*v4 + 64LL);
    v15[0] = v11;
    ...
    if ( v11 != v10 )
      v12 = 32;
    PFTOBJ::bUnloadWorkhorse((PFTOBJ *)v15, (struct PFF *)*v4, 0LL, v12);
    v13 = v4[1];
