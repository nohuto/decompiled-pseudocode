/*
 * XREFs of xxxWindowFromPoint @ 0x14002E584
 * Callers:
 *     NtUserWindowFromPoint @ 0x14002D200 (NtUserWindowFromPoint.c)
 * Callees:
...
struct tagWND *__fastcall xxxWindowFromPoint(struct tagPOINT a1, __int64 a2)
{
  ...
  ULONG_PTR v40[2]; // [rsp+50h] [rbp-28h] BYREF
  struct tagPOINT v41; // [rsp+80h] [rbp+8h] BYREF
  ...
  *(_QWORD *)(v10 + 456) = v40;
  ...
  {
    v16 = xxxWindowHitTest2(v8, a1, 0LL, 1u);
  }
  ...
  if ( v23 )
    ...
    v24 = 0LL;
  Win32HM_UnlockFromThread<1>(v24, (ULONG_PTR)v40);
  W32GetCurrentThreadNonPaged(v26, v25);
  v30 = *(_QWORD *)(W32GetUserSessionState(v28, v27) + 19872);
  if ( (unsigned __int64)(unsigned __int16)v16 < *(_QWORD *)(v30 + 8) )
  {
    UserSessionState = W32GetUserSessionState(v30, v29);
    v34 = *(_DWORD *)(W32GetUserSessionState(v33, v32) + 19896) * (unsigned int)(unsigned __int16)v16
        + *(_QWORD *)(UserSessionState + 19888);
    v37 = (struct tagWND **)HMPkheFromPhe(v34);
    LOWORD(v16) = HIWORD(v16) & 0x7FFF;
    if ( ((HIWORD(v16) & 0x7FFF) == *(_WORD *)(v34 + 26)
       || (_WORD)v16 == 0x7FFF
       || !(_WORD)v16 && PsGetCurrentProcessWow64Process(v36, v35))
      && (*(_BYTE *)(v34 + 25) & 1) == 0
      && *(_BYTE *)(v34 + 24) == 1 )
    {
      v6 = *v37;
  ...
  InputTraceLogging::Win32k::WindowFromPoint(&v41, v6);
  return v6;
}
