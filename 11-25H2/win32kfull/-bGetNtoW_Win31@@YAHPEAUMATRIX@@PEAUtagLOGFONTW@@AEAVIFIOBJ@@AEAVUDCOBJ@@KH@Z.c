/*
 * XREFs of ?bGetNtoW_Win31@@YAHPEAUMATRIX@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@AEAVUDCOBJ@@KH@Z @ 0x1400BA6C0
 * Callers:
        ...
        int a6)
{
  ...
  v6 = *(_QWORD *)a4;
  v11 = *(float *)(*(_QWORD *)a4 + 452LL) != 0.0 && !EFLOAT::bIsZero((EFLOAT *)(v6 + 456));
  v67 = v11;
