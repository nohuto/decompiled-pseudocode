/*
 * XREFs of wil_details_GetCurrentFeatureEnabledState @ 0x140270F84
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureStateCache_GetCachedFeatureEnabledState @ 0x140270E40 (wil_details_FeatureStateCache_GetCachedFeatureEnabledState.c)
