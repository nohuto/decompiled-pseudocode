/*
 * XREFs of xxxRemoteConsoleShadowStop @ 0x1402B91E4
 * Callers:
 *     NtUserRemoteConsoleShadowStop @ 0x14029D300 (NtUserRemoteConsoleShadowStop.c)
 * Callees:
...
__int64 xxxRemoteConsoleShadowStop()
{
  ...
  {
    v15 = *(_QWORD *)(UserSessionState + 68808);
    if ( v15 )
    {
      bDrvDisconnect(v15, *(_QWORD *)(UserSessionState + 68800), *(_QWORD *)(UserSessionState + 68832));
      DrvGetHdevName(*(_QWORD *)(UserSessionState + 68808), SourceString);
      RtlInitUnicodeString(&DestinationString_8, SourceString);
      DrvReleaseHDEV(*(_QWORD *)(UserSessionState + 68808));
      *(_DWORD *)(UserSessionState + 68764) = 0;
      v35 = 220;
      v36 = 1572896;
      if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
      ...
      v25 = *(void **)(UserSessionState + 68824);
      ...
      v26 = *(void **)(UserSessionState + 68832);
      if ( v26 )
      {
        ObfDereferenceObject(v26);
        *(_QWORD *)(UserSessionState + 68832) = 0LL;
      }
      v27 = *(void **)(UserSessionState + 68784);
      if ( v27 )
      {
        ObfDereferenceObject(v27);
        *(_QWORD *)(UserSessionState + 68784) = 0LL;
      }
      v28 = *(void **)(UserSessionState + 68816);
      if ( v28 )
      {
