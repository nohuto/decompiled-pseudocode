/*
 * XREFs of ?DecTimerCountAndClearReadyFlag@@YAXPEAUtagTIMER@@@Z @ 0x14028BB5C
 * Callers:
...
void __fastcall DecTimerCountAndClearReadyFlag(struct tagTIMER *a1)
{
  ...
  *((_DWORD *)a1 + 12) &= ~1u;
  ...
  v3 = *((_QWORD *)a1 + 3);
  if ( *(char **)v1 == v1 || *v2 == v1 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000, 4531);
  v4 = *(_QWORD *)v1;
  ...
  *(_QWORD *)v1 = v1;
  if ( (*(_DWORD *)(v3 + 644))-- == 1 )
    _InterlockedAnd((volatile signed __int32 *)(*(_QWORD *)(v3 + 488) + 8LL), 0xFFFFFFEF);
}
