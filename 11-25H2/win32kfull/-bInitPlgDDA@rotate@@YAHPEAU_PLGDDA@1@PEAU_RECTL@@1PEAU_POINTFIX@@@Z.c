/*
 * XREFs of ?bInitPlgDDA@rotate@@YAHPEAU_PLGDDA@1@PEAU_RECTL@@1PEAU_POINTFIX@@@Z @ 0x1400EA4A0
 * Callers:
 *     EngPlgBlt @ 0x1400E89F0 (EngPlgBlt.c)
 * Callees:
 *     ?bAddOverflow@@YAH_J0@Z @ 0x1400EBA94 (-bAddOverflow@@YAH_J0@Z.c)
 *     ?bSubOverflow@@YAH_J0@Z @ 0x1400EBAE0 (-bSubOverflow@@YAH_J0@Z.c)
 *     ?bMulOverflow@@YAH_J0@Z @ 0x1400EBB2C (-bMulOverflow@@YAH_J0@Z.c)
 *     rotate::bScalePlgDDALToPlgDDA @ 0x1400EBBB4 (rotate--bScalePlgDDALToPlgDDA.c)
 *     rotate::ROT_DIV @ 0x1400EC8C4 (rotate--ROT_DIV.c)
 *     ?bSubOverflow@@YAHJJ@Z @ 0x1401A16E8 (-bSubOverflow@@YAHJJ@Z.c)
 *     rotate::QDIV @ 0x14021E8A4 (rotate--QDIV.c)
...
LABEL_43:
        ...
        v29 = *(int *)a2;
        v30 = 3 * v27;
        v31 = dword_140364394[6 * v27];
        v32 = dword_14036439C[6 * v27];
        v27 *= 2LL;
        v33 = dword_1403643A0[2 * v30];
        v34 = dword_140364390[2 * v30];
        v35 = (v26 - 1) * dword_140364398[2 * v30];
        v266 = v32;
        v272 = v33;
        v267 = v31;
        v265 = v34;
        v263 = v31 * v28 + v34 * v29 + v35;
        v36 = dword_140364310[2 * v27];
        v37 = v32 * v29 + (v25 - 1) * dword_1403643A4[2 * v30];
        v38 = dword_140364314[2 * v27];
        v271 = v33 * v28 + v37;
        v39 = SLODWORD(v280[v36]);
        v40 = SHIDWORD(v280[v36]);
        v41 = dword_140364318[2 * v27];
