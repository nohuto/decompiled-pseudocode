/*
 * XREFs of ?ArrangementParameterInfo@WindowArrangementSPI@@YA?AW4ParamInfoResult@1@IKPEAX_N1@Z @ 0x14014C274
 * Callers:
 ...
 *     _lambda_2b89108f8e380a56e0b1b303a75ceab9_::operator() @ 0x14014C780 (_lambda_2b89108f8e380a56e0b1b303a75ceab9_--operator().c)
 *     _lambda_fcb4a4e7e214dab34917ad6111ff8639_::operator() @ 0x14014C81C (_lambda_fcb4a4e7e214dab34917ad6111ff8639_--operator().c)
 ...
 *     _lambda_23cd897c47050bff0d2fbbbc5d471d8f_::operator() @ 0x14021E814 (_lambda_23cd897c47050bff0d2fbbbc5d471d8f_--operator().c)
        ...
        bool a5)
{
  ...
  if ( (unsigned int)a1 <= 0x88 )
  {
    if ( (_DWORD)a1 == 136 )
    {
      v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(a1, 2LL) + 63448) + 17LL);
      goto LABEL_66;
    }
    if ( (unsigned int)a1 > 0x83 )
    {
      ...
      if ( (_DWORD)v28 )
      {
        ...
        if ( !v29 )
        {
                                ...
                                lambda_fcb4a4e7e214dab34917ad6111ff8639_::_lambda_invoker_cdecl_) )
          {
            ...
            if ( (unsigned __int8)lambda_fcb4a4e7e214dab34917ad6111ff8639_::operator()(v37, v36, 1LL) )
            {
              ...
              if ( a5 )
              {
                v40 = *(_BYTE **)(W32GetUserSessionState(v39, v38) + 63448);
                v40[8] = a2;
                v40[9] = a2;
                v40[10] = a2;
                v40[11] = a2;
        ...
        if ( (_DWORD)v30 )
        {
                                ...
                                lambda_2b89108f8e380a56e0b1b303a75ceab9_::_lambda_invoker_cdecl_) )
          {
            ...
            if ( (unsigned __int8)lambda_2b89108f8e380a56e0b1b303a75ceab9_::operator()(v32, v31, 1LL) )
            {
              ...
              if ( a5 )
              {
                v35 = *(_BYTE **)(W32GetUserSessionState(v34, v33) + 63448);
                v35[12] = a2;
                v35[13] = a2;
                v35[14] = a2;
                v35[15] = a2;
        ...
        v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v30, 2LL) + 63448) + 13LL);
      }
      else
      {
        v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v28, 2LL) + 63448) + 9LL);
      }
      goto LABEL_66;
    }
    if ( (_DWORD)a1 == 131 )
    ...
    if ( !(_DWORD)v21 )
    {
      v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v21, 2LL) + 63448) + 1LL);
      goto LABEL_66;
    }
    v22 = v21 - 1;
    if ( v22 )
        ...
        if ( !v24 )
        {
                                ...
                                lambda_315ad92e5be98155a16179dc024b8a3c_::_lambda_invoker_cdecl_) )
          {
            ...
            if ( (unsigned __int8)lambda_315ad92e5be98155a16179dc024b8a3c_::operator()(v42, v41, 1LL) )
            {
              ...
              if ( a5 )
              {
                v45 = *(_BYTE **)(W32GetUserSessionState(v44, v43) + 63448);
                v45[4] = a2;
                v45[5] = a2;
                v45[6] = a2;
                v45[7] = a2;
...
LABEL_25:
      ...
      v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v23, 2LL) + 63448) + 5LL);
LABEL_66:
      *(_BYTE *)a3 = v52;
      goto LABEL_25;
    }
...
LABEL_79:
  ...
  if ( !(_DWORD)v14 )
  {
    v52 = *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v14, 2LL) + 63448) + 21LL);
    goto LABEL_66;
  }
  v15 = v14 - 1;
  if ( !v15 )
...
LABEL_30:
        if ( a5 )
        {
          v27 = *(_QWORD *)(W32GetUserSessionState(v12, v11) + 63448);
          if ( a2 )
            *(_DWORD *)(v27 + 28) |= v10;
          else
            *(_DWORD *)(v27 + 28) &= ~v10;
