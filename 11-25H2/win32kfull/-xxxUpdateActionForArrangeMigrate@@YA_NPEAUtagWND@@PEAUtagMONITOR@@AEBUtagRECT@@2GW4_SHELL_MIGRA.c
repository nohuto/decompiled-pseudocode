/*
 * XREFs of ?xxxUpdateActionForArrangeMigrate@@YA_NPEAUtagWND@@PEAUtagMONITOR@@AEBUtagRECT@@2GW4_SHELL_MIGRATE_WINDOW_REASON@@U3@PEAKPEAU_WINDOW_ACTION@@@Z @ 0x1402D2F90
 * Callers:
  ...
  if ( result )
  {
    ...
    if ( a6 == 2 )
    {
      if ( v11 )
      {
        ...
        {
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2111);
        }
      }
      else
      {
