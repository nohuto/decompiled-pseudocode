/*
 * XREFs of xxxUpdateSystemIconsFromRegistry @ 0x140125CF4
 * Callers:
  ...
  do
  {
    while ( 1 )
    {
      ...
      FastGetProfileStringFromIDW(
        v3,
        5LL,
        *(unsigned __int16 *)(UserSessionState + v4 + 32362),
        &pszFormat,
        SourceString,
        260,
        0);
      ...
      if ( Image )
      {
        ...
        if ( (a1 & 0x40) == 0 )
        {
          ...
          zzzSetSystemImage(v9, *(struct tagCURSOR **)(v10 + v4 + 32368));
        }
      }
      if ( v2 != 5 )
        break;
      v11 = W32GetUserSessionState(a1, a2);
      v12 = (struct tagCURSOR *)_HMObjectFromHandle(*(_QWORD *)(*(_QWORD *)(v11 + 19872) + 6968LL));
      if ( !v12 )
        break;
      DpiForSystem = GetDpiForSystem();
      DpiDependentMetric = GetDpiDependentMetric(21, DpiForSystem);
      v15 = GetDpiForSystem();
      v16 = GetDpiDependentMetric(20, v15);
      v18 = xxxClientLoadImage((void **)&DestinationString, v17, 1u, v16, DpiDependentMetric, v7);
      if ( !v18 )
        break;
      a1 = *((unsigned int *)v18 + 20);
      if ( (a1 & 0x40) != 0 )
        break;
      zzzSetSystemImage((struct tagCURSOR *)v18, v12);
      v2 = 6;
    }
    ++v2;
  }
