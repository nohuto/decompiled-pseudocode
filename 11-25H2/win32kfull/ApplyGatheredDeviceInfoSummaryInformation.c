/*
 * XREFs of ApplyGatheredDeviceInfoSummaryInformation @ 0x1401F18C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    if ( a2 )
    {
      if ( !*(_DWORD *)(UserSessionState + 16320) )
      {
        ...
        *(_DWORD *)(v24 + 68448) |= 1u;
        *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v26, v25) + 19872) + 1972LL) = 1;
        SetGlobalCursorLevel(0);
        v29 = *(CursorApiRouter **)(W32GetUserSessionState(v28, v27) + 36304);
        v32 = *(_QWORD *)(W32GetUserSessionState(v31, v30) + 19872);
        v33 = *(_DWORD *)(v32 + 4964);
        v35 = *(_QWORD *)(W32GetUserSessionState(v34, v32) + 19872);
        v36 = *(_DWORD *)(v35 + 4960);
        v38 = W32GetUserSessionState(v37, v35);
        CursorApiRouter::MovePointerAsync(v29, *(HDEV *)(*(_QWORD *)(v38 + 56968) + 48LL), v36, v33, 1u);
      }
    }
    else if ( *(_DWORD *)(UserSessionState + 16320) )
    {
      ...
      *(_DWORD *)(v17 + 68448) &= ~1u;
      *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v19, v18) + 19872) + 1972LL) = 0;
    ...
    {
      LOBYTE(v6) = a4 != 0;
      v20 = *(_QWORD *)(W32GetUserSessionState(v16, v15) + 19872);
      *(_DWORD *)(v20 + 2068) = a3;
      v22 = *(_QWORD *)(W32GetUserSessionState(v20, v21) + 19872);
      *(_DWORD *)(v22 + 2196) = v6;
      v16 = *(_QWORD *)(W32GetUserSessionState(v22, v23) + 19872);
      *(_DWORD *)(v16 + 2260) = a5;
    }
