/*
 * XREFs of xxxValidateClassAndSize @ 0x140242488
 * Callers:
  ...
  *a7 = 0LL;
  ...
  if ( v9 != a5 )
  {
    ...
    *(_WORD *)(v8 + 42) = 4096;
    ...
    v13 = *(unsigned __int16 *)(W32GetUserSessionState(53248LL, a2) + 71180);
    v16 = (a5 & 0x2FFFu) - 666;
    v18 = *(unsigned __int16 *)(*(_QWORD *)(W32GetUserSessionState(v15, v14) + 19872) + 2 * v16 + 328);
...
LABEL_40:
    ...
    else
    {
      ...
      v20 = *(_DWORD *)(v19 + 248);
      v21 = *(_DWORD *)(v19 + 200);
      v22 = v20 + v21 + *(unsigned __int16 *)(W32GetUserSessionState(v18, v17) + 71180);
      v26 = *(_QWORD *)(W32GetUserSessionState(v24, v23) + 19872);
      if ( v22 < *(unsigned __int16 *)(v26 + 2 * v16 + 328) )
        goto LABEL_12;
      v27 = *(_QWORD *)(W32GetUserSessionState(v26, v25) + 19872);
      v30 = *(unsigned __int16 *)(v27 + 2 * v16 + 328) - *(unsigned __int16 *)(W32GetUserSessionState(v29, v28) + 71180);
