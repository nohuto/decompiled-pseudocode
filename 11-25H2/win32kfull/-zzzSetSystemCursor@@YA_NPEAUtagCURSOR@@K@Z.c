/*
 * XREFs of ?zzzSetSystemCursor@@YA_NPEAUtagCURSOR@@K@Z @ 0x140273DD8
 * Callers:
...
char __fastcall zzzSetSystemCursor(struct tagCURSOR *a1, __int64 a2)
{
  ...
  do
  {
    if ( *(_WORD *)(W32GetUserSessionState(a1, a2) + v4 + 21872) == v2 )
      goto LABEL_5;
    ++v3;
    v4 += 552LL;
  }
...
LABEL_5:
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1842);
    return 0;
  }
  v9 = *((_QWORD *)a1 + 6);
  v10 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 552LL * v3 + 21880);
