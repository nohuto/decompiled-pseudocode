/*
 * XREFs of ?Destroy@CPointerHashTable@NSInstrumentation@@SAXPEAV12@@Z @ 0x140340E74
 * Callers:
 ...
 *     ?FreeSessionGlobalsArea@Full@Gre@@YAXXZ @ 0x1402FB810 (-FreeSessionGlobalsArea@Full@Gre@@YAXXZ.c)
 * Callees:
 *     <none>
 */
