/*
 * XREFs of _ChangeWindowMessageFilter @ 0x1401E35BC
 * Callers:
 *     NtUserChangeWindowMessageFilter @ 0x1401E3570 (NtUserChangeWindowMessageFilter.c)
 * Callees:
...
__int64 __fastcall ChangeWindowMessageFilter(__int64 a1, int a2)
{
  ...
  if ( !(unsigned int)Feature_UIPIAlwaysOn__private_IsEnabledDeviceUsageNoInline(v6)
