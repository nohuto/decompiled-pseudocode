/*
 * XREFs of ?PatchArgbCursorWithMask@CursorApiRouter@@CA_NPEAUHBITMAP__@@IPEAKUtagSIZE@@_N@Z @ 0x1402DBF98
 * Callers:
        ...
        bool a5)
{
  ...
  v10 = 0LL;
  if ( !(unsigned int)GreExtGetObjectW(a1, 32LL, &v24, *(_QWORD *)&a4) )
    return 0;
...
LABEL_17:
      ...
      v22 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1140);
    }
  }
  v7 = 0;
LABEL_21:
