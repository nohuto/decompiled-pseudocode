/*
 * XREFs of LogicalToPhysicalInPlaceRgnWorker @ 0x1401A96B0
 * Callers:
 ...
 *     ?TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z @ 0x1401A97BC (-TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z.c)
