/*
 * XREFs of ?vAddRoundEndCap@WIDEPENOBJ@pathwide@@QEAAXAEAVWIDENER@2@AEAVLINEDATA@2@HH@Z @ 0x1400A695C
 * Callers:
        ...
        int a5)
{
  ...
  struct pathwide::LINEDATA *v29; // [rsp+70h] [rbp+50h] BYREF
...
LABEL_26:
    ...
    if ( v8 )
    {
      ...
      v19 = -*((_DWORD *)v16 + 1);
      v29 = (struct pathwide::LINEDATA *)__PAIR64__(v19, (unsigned int)v18);
      v17 = 0;
    }
    else
    {
...
LABEL_31:
  if ( !a5 && *((_QWORD *)v5 + 3) > *((_QWORD *)v5 + 4) )
    pathwide::vAddNice(v14, (struct pathwide::WIDEPATHOBJ *)v13, i, (struct EVECTORFX *)v8, savedregs);
}
