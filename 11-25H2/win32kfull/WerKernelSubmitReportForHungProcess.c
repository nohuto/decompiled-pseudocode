/*
 * XREFs of WerKernelSubmitReportForHungProcess @ 0x1402F3CA4
 * Callers:
 *     _lambda_ee4856d16542b31eb6609ee4cd7f16f7_::_lambda_invoker_cdecl_ @ 0x1402C19A0 (_lambda_ee4856d16542b31eb6609ee4cd7f16f7_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     WerStartSystemErrorHandler @ 0x1402F4014 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1402F414C (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x1402F4220 (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1402F4344 (WerpFreeMem.c)
...
__int64 __fastcall WerKernelSubmitReportForHungProcess(int a1, int a2, int a3)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  v29 = 1400LL;
  v6 = WerpAllocateAndInitializeSid(&IdentifierAuthority, v12, v14, v15, v16, v17, v18, (__int64)&v19);
  if ( v6 >= 0 )
  {
...
LABEL_4:
    ...
    *(_QWORD *)&v24 = 0LL;
    v25 = 0LL;
    started = ZwAlpcConnectPort(&Handle, &DestinationString, &v23, v28, 0x20000, v19, 0LL, 0LL, 0LL, 0LL, 0LL);
    v6 = started;
    if ( started < 0 )
    {
      v8 = 1421LL;
