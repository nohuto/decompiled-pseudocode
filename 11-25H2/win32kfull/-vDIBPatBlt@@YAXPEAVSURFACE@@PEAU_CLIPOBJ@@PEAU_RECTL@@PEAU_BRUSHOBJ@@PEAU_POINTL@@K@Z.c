/*
 * XREFs of ?vDIBPatBlt@@YAXPEAVSURFACE@@PEAU_CLIPOBJ@@PEAU_RECTL@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x1401B1B34
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v12 = (void (__fastcall *)(_QWORD))qword_14034DA50[3 * v11 + a6];
  v37 = v12;
  v13 = dword_140363B10[v11];
  v34 = v13;
  if ( a2 )
  {
