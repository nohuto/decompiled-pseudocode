/*
 * XREFs of ??4?$SGRDPgbFreezeScreenUpdates@H@@QEAAAEAHAEBH@Z @ 0x14026EA80
 * Callers:
...
__int64 __fastcall SGRDPgbFreezeScreenUpdates<int>::operator=(__int64 a1, int *a2)
{
  ...
  v2 = *a2;
  *(_DWORD *)(W32GetUserSessionState(a1, a2) + 68860) = v2;
  return W32GetUserSessionState(v4, v3) + 68860;
}
