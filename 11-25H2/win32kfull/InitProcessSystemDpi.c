/*
 * XREFs of InitProcessSystemDpi @ 0x140245550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitProcessSystemDpi(__int64 a1)
{
  ...
  if ( v8 )
  {
    v9 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(GetDispInfo(v7) + 104) + 40LL) + 64LL);
    *(_WORD *)(a1 + 272) = v9;
    return GetDPIServerInfoForDpi(v9, v10);
  }
  else
  {
    result = *(unsigned __int16 *)(*(_QWORD *)(W32GetUserSessionState(v7, v6) + 19872) + 6998LL);
    *(_WORD *)(a1 + 272) = result;
  }
  return result;
}
