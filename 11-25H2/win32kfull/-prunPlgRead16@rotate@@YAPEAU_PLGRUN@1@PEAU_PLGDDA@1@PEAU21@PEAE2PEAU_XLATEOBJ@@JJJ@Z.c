/*
 * XREFs of ?prunPlgRead16@rotate@@YAPEAU_PLGRUN@1@PEAU_PLGDDA@1@PEAU21@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x14031E960
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( (_DWORD)a6 != a7 )
    {
      ...
      if ( pxlo )
      {
        v24 = (struct rotate::_PLGDDA *)dword_140355080;
        do
        {
          v25 = v18 + 4;
          if ( v20 >= 32 )
