/*
 * XREFs of NtUserUpdateDefaultDesktopThumbnail @ 0x1402A3000
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtUserUpdateDefaultDesktopThumbnail(__int64 a1, __int64 a2, __int64 a3, char a4, int a5)
{
  ...
  if ( !v9 || IsTopLevelWindow(v9) && (unsigned int)IsWindowDesktopComposed(v9) )
  {
    ...
    v8 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 62840);
    if ( *((_QWORD *)v12 + 62) == v8
      && (!v9 || (v8 = *(_QWORD *)(W32GetUserSessionState(v8, v15) + 62840), *(_QWORD *)(v9 + 24) == v8)) )
    {
