/*
 * XREFs of ?vPlgWriteAND@rotate@@YAXPEAU_PLGRUN@1@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x14031FD10
 * Callers:
        ...
        do
        {
          ...
          for ( i = v24 == 0; ; i = v24 == 0 )
          {
            ...
            if ( v23 >= si128.top && v23 < si128.bottom )
            {
              ...
              v31 = *((_BYTE *)&dword_140364300 + (*(_DWORD *)v7 & 7));
              if ( *(int *)v7 < 0
                || v27 >= *((_DWORD *)a3 + 14)
                ...
                do
                {
                  ...
                  if ( !v31 )
                  {
                    if ( v33 )
                      *v30 = v32;
                    ++v30;
                    v31 = *((_BYTE *)&dword_140364300 + (v27 & 7));
                    if ( v27 < 0
                      || v27 >= *((_DWORD *)a3 + 14)
                      || (unsigned __int64)v30 < v8
    ...
    else if ( this < a2 )
    {
      ...
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v12; v11; --v11 )
        {
          ...
          v18 = *((_BYTE *)&dword_140364300 + (*(_DWORD *)v7 & 7));
              ...
              if ( !v18 )
              {
                *v17++ = v19;
                if ( (unsigned __int64)v17 < v8 || (unsigned __int64)v17 > v9 )
                  ...
                  v19 = *v17;
                v18 = *((_BYTE *)&dword_140364300 + (v15 & 7));
              }
              if ( v16 < 0 )
                goto LABEL_23;
            }
