/*
 * XREFs of xxxDragObject @ 0x1402E1078
 * Callers:
...
__int64 __fastcall xxxDragObject(struct tagWND *a1, struct tagWND *a2, int a3, __int64 a4, struct tagCURSOR *a5)
{
  ...
  ULONG_PTR v80[2]; // [rsp+B8h] [rbp-11h] BYREF
  ...
  *(_QWORD *)(v14 + 24) = a4;
  if ( a5 )
    ...
    v18 = *(struct tagCURSOR **)(*((_QWORD *)v10 + 59) + 400LL);
  v73 = v18;
  v19 = PtiCurrent((__int64)v16, v15);
  Win32HM_LockIntoThread<1>((__int64)v19, (__int64)v18, (__int64 *)v80);
  if ( a2 )
  {
  ...
  {
    v27 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 18888);
    if ( *(_QWORD *)(v27 + 120) )
    {
      v29 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 18888);
      if ( v29 == *((_QWORD *)v10 + 59) )
      {
        v31 = 33;
        if ( *(struct tagTHREADINFO **)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v29, v28) + 18888) + 120LL) + 16LL) != v10 )
          v31 = 49;
        v33 = *(_QWORD *)(W32GetUserSessionState(49LL, v30) + 18888);
        if ( *(struct tagTHREADINFO **)(*(_QWORD *)(v33 + 120) + 16LL) == v10 )
          v34 = a2;
        else
          v34 = *(struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(v33, v32) + 18888) + 120LL);
  ...
  while ( v37 && *(struct tagWND **)(*((_QWORD *)v10 + 59) + 112LL) == a2 )
  {
    ...
    if ( *(struct tagWND **)(*((_QWORD *)v10 + 59) + 112LL) != a2 || DWORD2(v76) == 256 && (_QWORD)v77 == 27LL )
    {
      ...
      v6 = *(struct tagCURSOR **)(UserSessionState + 27400);
      if ( v6 )
        zzzSetCursor(*(struct tagCURSOR **)(UserSessionState + 27400), v36);
      break;
    }
    v42 = *(_OWORD *)(v14 + 16);
    ...
    *(_QWORD *)(v14 + 32) = *(_QWORD *)((char *)&v78 + 4);
    ...
    if ( !DropObject )
    {
      v6 = *(struct tagCURSOR **)(W32GetUserSessionState(v46, v45) + 27400);
      *(_QWORD *)(v14 + 8) = 0LL;
      goto LABEL_36;
    }
...
LABEL_48:
  ...
  if ( v37 )
    v6 = *(struct tagCURSOR **)(W32GetUserSessionState(v51, v50) + 27400);
  xxxReleaseCapture(v51, v50);
  zzzShowCursor(0);
  zzzSetCursor(v73, v52);
  Win32HMThreadLockBase<tagCURSOR,1,1>::ManualUnlock<void>(v80, v53);
  if ( v6 == *(struct tagCURSOR **)(W32GetUserSessionState(v55, v54) + 27400)
    || (v58 = ValidateHwnd(*(_QWORD *)(v14 + 8)), (v59 = (struct tagWND *)v58) == 0LL) )
  {
    v60 = BugCheckParameter3[0];
  }
  else
  {
    Win32HM_LockIntoThread<0>((__int64)v10, v58, BugCheckParameter3);
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v57, v56) + 18888) )
  {
    v65 = *(_QWORD *)(W32GetUserSessionState(v63, v62) + 18888);
    if ( *(_QWORD *)(v65 + 120) )
    {
      v67 = *(_QWORD *)(W32GetUserSessionState(v65, v64) + 18888);
      if ( v67 == *((_QWORD *)v10 + 59) )
      {
        v68 = W32GetUserSessionState(v67, v66);
        xxxWindowEvent(0x80000005, *(struct tagWND **)(*(_QWORD *)(v68 + 18888) + 120LL), 0, 4u, 33);
      }
    }
  }
  ...
  v5 = v60;
LABEL_64:
  Win32HMOptionalThreadLock<tagHOOK>::~Win32HMOptionalThreadLock<tagHOOK>(v80, v39);
