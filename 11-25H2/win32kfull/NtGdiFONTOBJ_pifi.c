/*
 * XREFs of NtGdiFONTOBJ_pifi @ 0x1400D4710
 * Callers:
 *     <none>
 * Callees:
 ...
 *     FONTOBJ_pifi @ 0x1400D5DA0 (FONTOBJ_pifi.c)
...
IFIMETRICS *__fastcall NtGdiFONTOBJ_pifi(__int64 a1, __int64 a2)
{
  ...
  UMPDOBJ *v12; // [rsp+50h] [rbp-58h]
  char v13; // [rsp+B8h] [rbp+10h] BYREF
  UMPDOBJ *v14; // [rsp+C0h] [rbp+18h]
  ...
  if ( v12 )
  {
    v6 = (struct PFT *)UMPDOBJ::GetDDIOBJ<_FONTOBJ>((__int64)v12, a1);
    v7 = (FONTOBJ *)v6;
    if ( v6 )
    {
