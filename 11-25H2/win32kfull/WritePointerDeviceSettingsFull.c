/*
 * XREFs of WritePointerDeviceSettingsFull @ 0x1402AE5EC
 * Callers:
    ...
    if ( v12 )
    {
      ...
      if ( v14 == 2 )
      {
        ...
        if ( v15 <= 0x3C )
        {
          ...
          *(_DWORD *)(W32GetUserSessionState(v9, v8) + 18928) = v15;
        }
        v16 = *(_DWORD *)(a2 + 8);
        if ( v16 <= 0x3C )
        {
          *((_DWORD *)v10 + 4627) = v16;
          *(_DWORD *)(W32GetUserSessionState(v9, v8) + 18932) = v16;
        }
        v17 = *(_DWORD *)(a2 + 12);
        *((_DWORD *)v10 + 4631) = v17;
        v6 = 1;
        *(_DWORD *)(W32GetUserSessionState(v9, v8) + 18936) = v17;
        if ( a3 )
