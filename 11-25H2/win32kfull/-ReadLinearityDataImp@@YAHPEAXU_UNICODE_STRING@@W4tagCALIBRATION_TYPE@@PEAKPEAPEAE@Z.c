/*
 * XREFs of ?ReadLinearityDataImp@@YAHPEAXU_UNICODE_STRING@@W4tagCALIBRATION_TYPE@@PEAKPEAPEAE@Z @ 0x140206CF0
 * Callers:
 ...
 * Callees:
 *     ValidateCalibrationData @ 0x140271950 (ValidateCalibrationData.c)
