/*
 * XREFs of ??0EBOX@@QEAA@AEAVXDCOBJ@@AEAU_RECTL@@PEAU_LINEATTRS@@H@Z @ 0x1400E7B68
 * Callers:
...
EBOX *__fastcall EBOX::EBOX(EBOX *this, struct XDCOBJ *a2, struct _RECTL *a3, struct _LINEATTRS *a4, int a5)
{
  ...
  float v53; // xmm4_4
  int v54; // ecx
  _DWORD *v55; // [rsp+20h] [rbp-50h]
  struct XDCOBJ *v56; // [rsp+28h] [rbp-48h] BYREF
  int v57; // [rsp+30h] [rbp-40h]
  int v58; // [rsp+34h] [rbp-3Ch]
  __int64 v59; // [rsp+38h] [rbp-38h] BYREF
  bool v60; // [rsp+40h] [rbp-30h]
  __int64 v61; // [rsp+48h] [rbp-28h] BYREF
  struct _LINEATTRS *v62; // [rsp+50h] [rbp-20h]
  struct _POINTFIX v63; // [rsp+58h] [rbp-18h] BYREF
  FIX v64; // [rsp+60h] [rbp-10h]
  FIX v65; // [rsp+64h] [rbp-Ch]
...
LABEL_8:
  ...
  if ( (v55[42] & 1) != 0 )
    v49 = FP_0_5 + v49;
  efHalfDiff(v63.x, v64);
  LODWORD(v52) = efHalfDiff(v50, v51);
  if ( v53 < 0.0 )
    LODWORD(v53) ^= _xmm;
  if ( v52 < 0.0 )
    LODWORD(v52) ^= _xmm;
  ...
  if ( *(_DWORD *)(v24 + 208) == 2 || v23 || *((_DWORD *)this + 1) || (*(_DWORD *)(v24 + 340) & 0x20) != 0 )
  {
    ...
    *((_DWORD *)this + 7) = v20;
    ...
    if ( v23 )
    {
      ...
      HIDWORD(v56) = v37;
      LODWORD(v56) = -v40;
      EXFORMOBJ::bXform((EXFORMOBJ *)&v59, (const struct _VECTORL *)&v56, (struct _VECTORFX *)&v56, 2uLL);
      v41 = v57;
      v42 = HIDWORD(v56) + 1;
      v43 = ((int)v56 + 1) >> 1;
      *((_DWORD *)this + 2) += v43;
