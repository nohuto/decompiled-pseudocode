/*
 * XREFs of xxxSetWindowData @ 0x1402DE828
 * Callers:
...
LABEL_51:
      ...
      if ( !v32
        || (UserSessionState = W32GetUserSessionState(v35, v34),
            !GetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 41354), 1u))
        && (v27 != v28 || (v39 = W32GetUserSessionState(v38, v37), !GetProp(v32, *(unsigned __int16 *)(v39 + 41354), 1u)))
