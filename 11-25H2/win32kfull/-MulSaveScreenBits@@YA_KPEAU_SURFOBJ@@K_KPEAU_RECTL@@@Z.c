/*
 * XREFs of ?MulSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1403336A0
 * Callers:
...
unsigned __int64 __fastcall MulSaveScreenBits(struct _SURFOBJ *a1, unsigned int a2, _QWORD *a3, struct _RECTL *a4)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      if ( v22 )
      {
        ...
        if ( v20 != 2
          || (v16 = *(unsigned __int64 (**)(struct _SURFOBJ *, unsigned int, unsigned __int64, struct _RECTL *))(v14 + 3000)) == 0LL )
        {
        ...
        {
          a4 = (struct _RECTL *)&stru_140365148;
          v5 = 0LL;
          v18 = (struct _RECTL *)&stru_140365148;
          v8 = 2;
        }
      }
      v7 = (__int64 *)*v7;
  ...
  while ( 1 )
  {
    ...
    if ( bIntersect(a4, (const struct _RECTL *)((char *)v7 + 28), &v23) )
    {
      ...
      v23.bottom -= *((_DWORD *)v7 + 8);
      if ( *(_QWORD *)(v7[6] + 3000) )
        v6 = *(unsigned __int64 (**)(struct _SURFOBJ *, unsigned int, unsigned __int64, struct _RECTL *))(v7[6] + 3000);
  ...
  MulSaveScreenBits(a1, 2u, v5, (struct _RECTL *)&stru_140365148);
  return 0LL;
}
