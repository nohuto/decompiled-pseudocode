/*
 * XREFs of ?vProcessCursorShape@@YAXPEAUHDEV__@@HHPEAU_SURFOBJ@@1PEAVPALETTE@@PEAU_RECTL@@PEAPEAUHBITMAP__@@@Z @ 0x140094F18
 * Callers:
 ...
 *     ?vCalculateCursorBounds@@YAXPEAU_SURFOBJ@@0PEAU_RECTL@@@Z @ 0x140175940 (-vCalculateCursorBounds@@YAXPEAU_SURFOBJ@@0PEAU_RECTL@@@Z.c)
        ...
        HBITMAP *a8)
{
  ...
  *(_QWORD *)&prcl.left = 0LL;
  ...
  if ( SURFMEM::bCreateDIB((SURFMEM *)&v29, (struct _DEVBITMAPINFO *)v36, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0, 0) )
  {
    ...
    v19 = *(_QWORD *)(*(_QWORD *)&pptlSrc + 3768LL);
    v20 = 0LL;
    v21 = *(_QWORD *)(*(_QWORD *)&pptlSrc + 3776LL);
    v22 = *(_QWORD *)(*(_QWORD *)&pptlSrc + 3800LL);
    pxlo = 0LL;
    v34 = 0LL;
