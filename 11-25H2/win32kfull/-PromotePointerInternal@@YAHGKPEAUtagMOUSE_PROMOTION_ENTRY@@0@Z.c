/*
 * XREFs of ?PromotePointerInternal@@YAHGKPEAUtagMOUSE_PROMOTION_ENTRY@@0@Z @ 0x14013A028
 * Callers:
        ...
        struct tagMOUSE_PROMOTION_ENTRY *a4)
{
  ...
  v6 = a2;
  v7 = a1;
  v8 = W32GetUserSessionState(a1, a2) + 16416;
  CacheById = FindCacheById(v7, &v36);
  v13 = *(unsigned int *)(W32GetUserSessionState(v11, v10) + 16680);
  if ( (v13 & 8) != 0
    && CacheById == (struct tagMOUSE_PROMOTION_CACHE *)(W32GetUserSessionState(v13, v12) + 16424)
  ...
  else
  {
    ...
    if ( !a4 )
    {
      ...
      v24 = *(_DWORD *)(v23 + 16680);
      v25 = v24 | 4;
      v21 = v24 & 0xFFFFFFFB;
      if ( !v31 )
        v25 = v21;
      v20 = v25 & 0xFFFFFFEF;
      *(_DWORD *)(v23 + 16680) = v20 | (16 * v15) | 2;
    }
  }
  if ( v32 )
  {
    *(_QWORD *)(v8 + 192) = PtiCurrent(v21, v20);
    *(_WORD *)(v8 + 200) = v34;
    *(_DWORD *)(v8 + 212) = v33;
    *(_QWORD *)(v8 + 204) = v17;
    *(_DWORD *)(v8 + 216) = v14;
