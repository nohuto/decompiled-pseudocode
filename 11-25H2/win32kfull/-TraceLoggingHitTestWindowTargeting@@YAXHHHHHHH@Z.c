/*
 * XREFs of ?TraceLoggingHitTestWindowTargeting@@YAXHHHHHHH@Z @ 0x1401C29B8
 * Callers:
...
void __fastcall TraceLoggingHitTestWindowTargeting(__int64 a1)
{
