/*
 * XREFs of DrawFrame @ 0x1401F0710
 * Callers:
...
__int64 __fastcall DrawFrame(HDC a1, int *a2, int a3, int a4)
{
  ...
  if ( (a4 & 0xFFFFFFF8) == 0xF8 )
    v9 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872) + 4944LL);
  else
    v9 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872) + 8 * ((__int64)a4 >> 3) + 4696);
  v16 = v5 + a3;
  v22 = v11;
  v26 = v12;
  v15 = v9;
  ...
  v28 = a3;
  v29 = v11 - v6;
  GrePolyPatBlt(a1, v8 + 15728673, (struct _POLYPATBLT *)v14, 4u);
  return 1LL;
}
