/*
 * XREFs of ?vSrcCopyS32D8@@YAXPEAUBLTINFO@@@Z @ 0x1400CEA30
 * Callers:
  ...
  if ( Xlate555 )
  {
    while ( 1 )
    {
      ...
      if ( v24 )
      {
        ...
        do
        {
          v15 = v1(v4, Xlate555, v13[3]);
          v16 = v1(v26, Xlate555, v13[2]);
          v17 = v1(v26, Xlate555, v13[1]);
          v18 = v1(v26, Xlate555, *v13);
          v19 = v15;
          v4 = v26;
          v13 += 4;
          *(_DWORD *)v12 = ((v17 | ((v16 | (v19 << 8)) << 8)) << 8) | v18;
          v12 += 4;
          --v14;
        }
        while ( v14 );
