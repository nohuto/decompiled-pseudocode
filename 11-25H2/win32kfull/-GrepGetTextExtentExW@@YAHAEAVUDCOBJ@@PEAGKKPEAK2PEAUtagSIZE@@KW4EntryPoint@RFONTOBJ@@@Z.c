/*
 * XREFs of ?GrepGetTextExtentExW@@YAHAEAVUDCOBJ@@PEAGKKPEAK2PEAUtagSIZE@@KW4EntryPoint@RFONTOBJ@@@Z @ 0x1400AB1B4
 * Callers:
        ...
        int a9)
{
  ...
  if ( (a2 || !a3) && a7 )
  {
    if ( a3 )
    {
      ...
      v47 = 0LL;
      if ( (unsigned int)RFONTOBJ::bInit((RFONTOBJ *)&v47, a1, 0, 2 * (a8 & 1u) + 2, (const struct RFONTOBJ::Tag *)v50) )
