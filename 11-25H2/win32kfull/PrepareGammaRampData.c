/*
 * XREFs of PrepareGammaRampData @ 0x140159580
 * Callers:
...
__int64 __fastcall PrepareGammaRampData(unsigned int *a1, unsigned int **a2, _DWORD *a3)
{
  ...
  *a1 = DeviceCaps;
  ...
  v16 = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v15, v14) + 56968) + 112LL);
  while ( v16 )
  {
    v17 = *(_QWORD *)(v16 + 40);
    v16 = *(_QWORD *)(v16 + 56);
  ...
  if ( v20 > 0xFFFFFFFF || (v25 = (unsigned int)(v20 + 1544), (unsigned int)v25 < 0x608) )
  {
    ...
    GreUnlockVisRgn(*(_QWORD *)(*(_QWORD *)(v23 + 56968) + 48LL));
    return 3221225621LL;
  }
  ...
  if ( !v26 )
  {
    ...
    GreUnlockVisRgn(*(_QWORD *)(*(_QWORD *)(v32 + 56968) + 48LL));
    return 3221225495LL;
  }
  *v26 = v6;
  if ( !IsRemoteConnection(v28, v27) )
  {
    v34 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 56968);
