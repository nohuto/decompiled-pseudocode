/*
 * XREFs of _BlockInput @ 0x1401FF6F0
 * Callers:
...
__int64 __fastcall BlockInput(__int64 a1, __int64 a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( PsGetCurrentProcess(v7) != v6
      && (*((_QWORD *)v4 + 62) != *(_QWORD *)(W32GetUserSessionState(v9, v8) + 19144)
  ...
  if ( v2 )
  {
    ...
    {
      *(_QWORD *)(W32GetUserSessionState(v14, v13) + 18944) = v4;
      return 1LL;
    }
    return 0LL;
  }
  if ( *(struct tagTHREADINFO **)(UserSessionState + 18944) != v4 )
    return 0LL;
  *(_QWORD *)(W32GetUserSessionState(v14, v13) + 18944) = 0LL;
  return 1LL;
}
