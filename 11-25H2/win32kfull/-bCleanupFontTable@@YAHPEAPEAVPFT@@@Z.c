/*
 * XREFs of ?bCleanupFontTable@@YAHPEAPEAVPFT@@@Z @ 0x14010FB1C
 * Callers:
 *     GdiMultiUserFontCleanup @ 0x14010FE40 (GdiMultiUserFontCleanup.c)
 * Callees:
 *     ?bUnloadAllButPermanentFonts@PFTOBJ@@QEAAHH@Z @ 0x14010FBC0 (-bUnloadAllButPermanentFonts@PFTOBJ@@QEAAHH@Z.c)
 *     ?bCleanupFontHash@@YAHPEAPEAU_FONTHASH@@@Z @ 0x14010FE00 (-bCleanupFontHash@@YAHPEAPEAU_FONTHASH@@@Z.c)
 */
