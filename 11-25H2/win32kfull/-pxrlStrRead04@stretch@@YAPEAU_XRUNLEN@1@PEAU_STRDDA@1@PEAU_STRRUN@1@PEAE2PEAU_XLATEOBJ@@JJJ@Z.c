/*
 * XREFs of ?pxrlStrRead04@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140193510
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v47 = (v43 & (unsigned int)dword_140363A68[v45]) >> dword_140363A48[v63];
        if ( a5 )
          LODWORD(v47) = *(_DWORD *)(*((_QWORD *)a5 + 2) + 4 * v47);
        if ( (v42 & dword_140355080[v46]) != 0 )
        {
    ...
    *((_DWORD *)a2 + 3) = *((_DWORD *)this + 2) - v10;
    if ( (int)a6 < a7 )
    {
        ...
        while ( 1 )
        {
          ...
          if ( (_DWORD)v28 )
          {
            v36 = *(_DWORD *)(*((_QWORD *)v15 + 2)
                            + 4 * ((unsigned __int64)(v17 & (unsigned int)dword_140363A68[v19]) >> dword_140363A48[v19]));
            v37 = &v9[v18 + 2];
            for ( i = v28; i; --i )
              *v37++ = v36;
            v15 = a5;
      ...
      else
      {
        ...
        {
          v20 = *v16++;
          v21 = (v17 & (unsigned int)dword_140363A68[v19]) >> dword_140363A48[v19];
          if ( (_DWORD)v20 )
          {
            v34 = &v9[v18 + 2];
            v35 = v20;
