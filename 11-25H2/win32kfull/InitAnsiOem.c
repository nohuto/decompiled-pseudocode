/*
 * XREFs of InitAnsiOem @ 0x140285624
 * Callers:
 *     NtUserInitAnsiOem @ 0x140299FC0 (NtUserInitAnsiOem.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitAnsiOem(_OWORD *a1, ULONG64 a2)
{
  ...
  v3 = a1;
  v4 = (_OWORD *)(*(_QWORD *)(UserSessionState + 19872) + 1380LL);
  v5 = 2LL;
  v6 = 2LL;
  do
  {
  ...
  v8 = v12;
  v9 = (_OWORD *)(*(_QWORD *)(v7 + 19872) + 1636LL);
  do
  {
    *v9 = *v8;
    v9[1] = v8[1];
