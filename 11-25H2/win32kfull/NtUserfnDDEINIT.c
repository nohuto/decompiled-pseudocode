/*
 * XREFs of NtUserfnDDEINIT @ 0x1401E2A50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserfnDDEINIT(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  ...
  if ( v11 )
  {
    ...
    Prop = (_WORD *)GetProp((__int64)v13, *(unsigned __int16 *)(UserSessionState + 41340), 1u);
    if ( !Prop )
    {
      v18 = v13[5];
      ...
      else
      {
        ...
        if ( Prop )
        {
          ...
          *(_QWORD *)Prop = *(_QWORD *)(v21 + 36412);
          *((_DWORD *)Prop + 2) = *(_DWORD *)(v21 + 36420);
          if ( SeCreateClientSecurity(
                 KeGetCurrentThread(),
                 (PSECURITY_QUALITY_OF_SERVICE)(v21 + 36412),
                 0,
                 (PSECURITY_CLIENT_CONTEXT)(Prop + 8)) >= 0 )
          {
            *((_DWORD *)Prop + 22) = 0;
            v24 = W32GetUserSessionState(v23, v22);
            if ( (unsigned int)InternalSetProp((__int64)v13, *(unsigned __int16 *)(v24 + 41340), (__int64)Prop, 1u) )
            {
              v9 = a1;
              goto LABEL_9;
            }
...
LABEL_9:
    ...
    *(_OWORD *)BugCheckParameter2 = 0LL;
    ...
    else
    {
      ...
      v12 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64, __int64))(v28 + 8LL * ((a6 + 6) & 0x1F) + 70920))(
              v9,
              v8,
              a3,
              a4,
