/*
 * XREFs of EditionHandleMoveSizeDataOnDestroyMonitor @ 0x1402AC190
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EditionHandleMoveSizeDataOnDestroyMonitor(__int64 a1, __int64 a2)
{
  ...
  v3 = (_QWORD *)(W32GetUserSessionState(a1, a2) + 63392);
  v4 = (_QWORD *)*v3;
  v7 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 56968);
  v8 = *(_QWORD *)(v7 + 104);
  if ( !*(_DWORD *)(W32GetUserSessionState(v9, v7) + 36392) && !v8 )
