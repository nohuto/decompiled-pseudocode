/*
 * XREFs of ZombieCursor @ 0x14028C6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ZombieCursor(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 80) & 8) != 0 )
  {
    ...
    if ( *(int *)(a1 + 88) > 0 )
    {
      ...
      do
      {
        ...
        HMChangeOwnerProcessWorker(*(_QWORD *)(*(_QWORD *)(a1 + 96) + v4), *(_QWORD *)(UserSessionState + 18648));
        ++v3;
        v4 += 8LL;
      }
  ...
  return HMChangeOwnerProcessWorker(a1, *(_QWORD *)(v6 + 18648));
}
