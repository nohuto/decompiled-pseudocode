/*
 * XREFs of ?pxrlStrRead32OR@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140314310
 * Callers:
 *     <none>
 * Callees:
...
struct stretch::_XRUNLEN *__fastcall stretch::pxrlStrRead32OR(
        stretch *this,
