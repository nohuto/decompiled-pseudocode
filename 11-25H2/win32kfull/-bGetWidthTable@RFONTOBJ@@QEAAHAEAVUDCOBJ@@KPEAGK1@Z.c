/*
 * XREFs of ?bGetWidthTable@RFONTOBJ@@QEAAHAEAVUDCOBJ@@KPEAGK1@Z @ 0x1400BE658
 * Callers:
      ...
      if ( v21 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( *v29 == (_DWORD)v30 )
          {
            ...
            {
              if ( v54 != 2
                && ((unsigned int)RFONTOBJ::bIsLinkedGlyph(v15, (unsigned __int16)v12)
