/*
 * XREFs of xxxCsEvent @ 0x1402DD438
 * Callers:
 *     xxxChangeMonitorFlags @ 0x14017E61C (xxxChangeMonitorFlags.c)
 *     NtUserEvent @ 0x140296770 (NtUserEvent.c)
...
__int64 __fastcall xxxCsEvent(const void *a1, __int64 a2)
{
  ...
  v5[3] = v2;
  v7 = 0;
  v10 = *(_QWORD *)(W32GetUserSessionState(v9, v8) + 66680);
  if ( v10 )
  {
    v11 = *(_DWORD *)v5;
    do
  ...
  *v12 = v7;
  v16 = 0;
  for ( i = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 66680); i && v16 < *v15; i = *(_QWORD *)(i + 24) )
  {
