/*
 * XREFs of ?MakeITable@@YAHPEAEPEAURGBX@@H@Z @ 0x1400CD87C
 * Callers:
 ...
 *     ?inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z @ 0x1400CDA78 (-inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z.c)
 *     ??0?$SEMOBJ@$0N@@@QEAA@AEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x1400D7D10 (--0-$SEMOBJ@$0N@@@QEAA@AEAUSESSION_GLOBALS@Base@Gre@@@Z.c)
 *     ?MakeITableMono@@YAHPEAE@Z @ 0x14026F3D4 (-MakeITableMono@@YAHPEAE@Z.c)
 *     ?MakeITable256@@YAHPEAE@Z @ 0x14030CAAC (-MakeITable256@@YAHPEAE@Z.c)
 *     ?MakeITableVGA@@YAHPEAE@Z @ 0x14030CB04 (-MakeITableVGA@@YAHPEAE@Z.c)
