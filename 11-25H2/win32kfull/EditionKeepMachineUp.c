/*
 * XREFs of EditionKeepMachineUp @ 0x14016C7F0
 * Callers:
 *     <none>
 * Callees:
 *     ?KeepMachineUp@@YAXW4POWER_MONITOR_REQUEST_REASON@@@Z @ 0x14016C8D4 (-KeepMachineUp@@YAXW4POWER_MONITOR_REQUEST_REASON@@@Z.c)
 *     ?MapInputToMonitorOnReason@@YA?AW4POWER_MONITOR_REQUEST_REASON@@W4_LINP_SOURCE@@@Z @ 0x14016CA24 (-MapInputToMonitorOnReason@@YA-AW4POWER_MONITOR_REQUEST_REASON@@W4_LINP_SOURCE@@@Z.c)
 */
...
__int64 __fastcall EditionKeepMachineUp(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  v5 = a2;
  if ( !*(_DWORD *)(W32GetUserSessionState(a1, a2) + 19072) || (a4 & 8) == 0 )
  {
    v7 = *(_DWORD **)(W32GetUserSessionState(v7, v6) + 19872);
  ...
  if ( *(_DWORD *)(UserSessionState + 2744)
    && ((**(_DWORD **)(W32GetUserSessionState(v10, v9) + 19872) & 0x4000) == 0 || (a4 & 2) != 0) )
  {
