/*
 * XREFs of ?ParseInputReport@InteractiveControlParser@@SAJPEAVInteractiveControlDevice@@PEAEKPEAUtagINTERACTIVECTRL_INFO@@@Z @ 0x140222F60
 * Callers:
...
LABEL_17:
    ...
    {
      if ( ScaledUsageValue != -2146369535 && (unsigned int)dword_14039BBF8 > 2 )
      {
