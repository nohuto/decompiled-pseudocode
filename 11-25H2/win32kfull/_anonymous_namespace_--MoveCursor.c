/*
 * XREFs of _anonymous_namespace_::MoveCursor @ 0x14005EEF0
 * Callers:
...
void __fastcall anonymous_namespace_::MoveCursor(struct tagPOINT *a1, __int64 a2)
{
  ...
  y = a1->y;
  x = a1->x;
  v6 = *(CursorApiRouter **)(UserSessionState + 36304);
  v9 = W32GetUserSessionState(v8, v7);
  CursorApiRouter::MovePointerAsync(v6, *(HDEV *)(*(_QWORD *)(v9 + 56968) + 48LL), x, y, 8u);
  v12 = W32GetUserSessionState(v11, v10);
  CCursorSizes::zzzUpdateGlobalCursorSize(*(CCursorSizes **)(v12 + 36344), a1, 0);
}
