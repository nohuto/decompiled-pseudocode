/*
 * XREFs of ?vSrcOpaqCopyS1D8@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x140307A80
 * Callers:
        ...
        unsigned int a10)
{
  ...
  {
    v41 = dword_140363330[2 * (v10 & 3)] & dword_1403632B0[2 * (v11 & 3)];
  ...
  {
    v47 = &v46[v17];
    v48 = dword_1403632B0[2 * (v11 & 7)] & dword_140363330[2 * v38];
    v49 = dword_1403632B4[2 * (v11 & 7)] & dword_140363334[2 * v38];
    v50 = ~(dword_1403632B0[2 * v37] & dword_140363330[2 * v38]);
    do
    {
      v51 = *v40;
      v40 += v12;
