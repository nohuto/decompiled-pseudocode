/*
 * XREFs of ?TraceLoggingShowWindowShellCalloutResult@@YAXPEBUtagWND@@_KHIW4SHELL_SPECIFIED_SHOW_COMMAND@@@Z @ 0x1402B8264
 * Callers:
...
char __fastcall TraceLoggingShowWindowShellCalloutResult(int *a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  {
    result = tlgKeywordOn((__int64)&dword_14039BBC0, 0x400000000000LL);
    if ( result )
    {
      v11 = *v9;
      v19 = 0x1000000LL;
