/*
 * XREFs of ?lSizeDDA@rotate@@YAJPEAU_PLGDDA@1@@Z @ 0x1400EA3E0
 * Callers:
 *     EngPlgBlt @ 0x1400E89F0 (EngPlgBlt.c)
 * Callees:
 *     ?bSubOverflow@@YAHJJ@Z @ 0x1401A16E8 (-bSubOverflow@@YAHJJ@Z.c)
 *     ?bAddOverflow@@YAHJJ@Z @ 0x14031E8D4 (-bAddOverflow@@YAHJJ@Z.c)
 *     ?bMulOverflow@@YAHJJ@Z @ 0x14031E8F8 (-bMulOverflow@@YAHJJ@Z.c)
