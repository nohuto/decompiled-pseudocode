/*
 * XREFs of ?vStrMirror04@stretch@@YAXPEAVSURFACE@@@Z @ 0x140314430
 * Callers:
  ...
  for ( i = 0; v5 < *((_DWORD *)v3 + 15); v20 = v2 )
  {
    ...
    if ( v6 > 0 )
    {
      ...
      do
      {
        if ( v10 == v8 )
        {
          v7 = ((v7 & dword_140363A68[v9]) >> dword_140363A48[v9] << dword_140363A48[v15]) | ~dword_140363A68[v15] & (v7 & ~dword_140363A68[v9] | ((v7 & dword_140363A68[v15]) >> dword_140363A48[v15] << dword_140363A48[v9]));
        }
        else
        {
          v16 = dword_140363A68[v9];
          v17 = (v7 & v16) >> dword_140363A48[v9];
          v7 = v7 & ~v16 | ((v14 & (unsigned int)dword_140363A68[v15]) >> dword_140363A48[v15] << dword_140363A48[v9]);
          v14 = (v17 << dword_140363A48[v15]) | ~dword_140363A68[v15] & v14;
        }
        --v11;
        v9 = v18 + 1;
        ++v22;
