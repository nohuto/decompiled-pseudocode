/*
 * XREFs of xxxWindowEvent @ 0x14002EAB0
 * Callers:
...
void __fastcall xxxWindowEvent(unsigned int a1, struct tagWND *a2, int a3, unsigned int a4, int a5)
{
  ...
  v101 = 0;
  v9 = &v99;
  v100 = W32GetUserSessionState(v8, v7) + 42360;
  v11 = 0LL;
  v102 = 0LL;
  v12 = 0;
  v103 = 0;
...
LABEL_217:
  ...
  v81 = 4096;
LABEL_16:
  v16 = *(_QWORD *)(W32GetUserSessionState(1LL, v10) + 19872);
  if ( a1 != 32779 )
  {
    if ( a1 <= 0x800A )
    {
...
LABEL_93:
    ...
    v31 = W32GetUserSessionState(v28, v27) + 70584;
    v94 = v31;
    if ( (v80 & 0x20) != 0 )
    {
    ...
    *(_QWORD *)(v33 + 384) = &v89;
    ...
    if ( (v80 & 2) == 0 )
    {
      ...
      v41 = (__int64 *)(W32GetUserSessionState(v40, v39) + 70608);
      v35 = *v41;
    ...
    if ( v86 )
    {
      v35 = *(unsigned int *)(*((_QWORD *)v34 + 58) + 808LL);
      if ( (v35 & 0x1000000) != 0 )
        xxxDoLocalTSFWork(a1, a2, a3, a4, v36, v15, v34, v88);
    }
    if ( v14 )
    {
      v78 = *(_QWORD *)(W32GetUserSessionState(v35, v36) + 36368);
      v87 = v78;
      if ( v78 )
      {
        do
        {
          if ( (*(_DWORD *)(v78 + 808) & 0x1000000) != 0 )
          {
            v79 = *(struct tagTHREADINFO **)(v78 + 320);
            if ( v79 )
            {
              do
              {
    ...
    v43 = *(_QWORD *)(W32GetUserSessionState(v35, v36) + 19872);
    if ( a1 == 32779 )
    {
      v44 = 64LL;
      goto LABEL_48;
                ...
                if ( (v44 & 4) == 0 || (v43 = v96, v96 != *(_QWORD *)(*(_QWORD *)(v45 + 16) + 464LL)) )
                {
                  ...
                  if ( (!v49 || v49 == (_DWORD)v97) && ((v44 & 2) == 0 || v82 != *(struct tagTHREADINFO **)(v45 + 16)) )
                  {
                      ...
                      || v44 == *((_QWORD *)v82 + 62) && a1 + 2147483646 <= 1 )
                    {
                      ...
                      if ( ExIsResourceAcquiredExclusiveLite(*(PERESOURCE *)(v60 + 42320)) != 1 )
                        __int2c();
