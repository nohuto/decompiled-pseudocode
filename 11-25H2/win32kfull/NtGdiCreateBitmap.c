/*
 * XREFs of NtGdiCreateBitmap @ 0x1400921E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiCreateBitmap(unsigned int a1, unsigned int a2, unsigned int a3, unsigned int a4, __int64 a5)
{
  __int64 v5; // rbx
  ...
  if ( v11 <= 0xFFFFFFFF )
  {
    ...
    if ( v12 <= 0xFFFFFFFF )
    {
      if ( (_DWORD)v12 )
      {
        inited = umptr_r<unsigned char>::init_probe(v18, a5, (int)v12, 1LL);
        v14 = *(_QWORD *)inited;
        v15 = *(_QWORD *)(inited + 8);
