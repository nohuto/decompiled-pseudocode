/*
 * XREFs of ?ProcessInertia@Edgy@@YAXPEBUINERTIA_INFO_INTERNAL@@@Z @ 0x14020D788
 * Callers:
 *     EditionEdgyProcessInertia @ 0x14020D770 (EditionEdgyProcessInertia.c)
 * Callees:
...
void __fastcall Edgy::ProcessInertia(Edgy *this, const struct INERTIA_INFO_INTERNAL *a2)
{
  ...
  v3 = *(_QWORD *)(W32GetUserSessionState(this, a2) + 19144);
  v4 = *(_QWORD *)(v3 + 248);
  if ( v4
    && (*((_DWORD *)this + 46) & 8) != 0
    && *((float *)this + 5) > 0.0
