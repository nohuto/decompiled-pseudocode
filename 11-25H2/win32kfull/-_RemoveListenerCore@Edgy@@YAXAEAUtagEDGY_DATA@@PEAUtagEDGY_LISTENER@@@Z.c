/*
 * XREFs of ?_RemoveListenerCore@Edgy@@YAXAEAUtagEDGY_DATA@@PEAUtagEDGY_LISTENER@@@Z @ 0x1402A647C
 * Callers:
 *     EdgyUnregisterListener @ 0x140220BB0 (EdgyUnregisterListener.c)
 *     ?_RemoveListenersForDevice@Edgy@@YAXAEAUtagEDGY_DATA@@PEAX@Z @ 0x1402A64E4 (-_RemoveListenersForDevice@Edgy@@YAXAEAUtagEDGY_DATA@@PEAX@Z.c)
 * Callees:
