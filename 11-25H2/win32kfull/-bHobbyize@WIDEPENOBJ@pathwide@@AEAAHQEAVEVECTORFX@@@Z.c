/*
 * XREFs of ?bHobbyize@WIDEPENOBJ@pathwide@@AEAAHQEAVEVECTORFX@@@Z @ 0x1400A4FB4
 * Callers:
...
__int64 __fastcall pathwide::WIDEPENOBJ::bHobbyize(struct _POINTFIX **this, struct EVECTORFX *const a2)
{
  ...
  if ( v3 >= 576 )
  {
    if ( v3 >= 1600 )
    {
      if ( v3 < 3136 )
      {
        v4 = (const struct _POINTFIX **)&off_14034BAE0;
        v5 = (unsigned int *)&unk_14034BAE8;
      }
      else if ( v3 >= 5184 )
      {
        if ( v3 < 7744 )
        {
          v4 = (const struct _POINTFIX **)&off_14034BB00;
          v5 = (unsigned int *)&unk_14034BB08;
        }
        else
        {
          v4 = (const struct _POINTFIX **)&off_14034BB10;
          v5 = (unsigned int *)&unk_14034BB18;
        }
      }
      else
      {
        v4 = (const struct _POINTFIX **)&off_14034BAF0;
        v5 = (unsigned int *)&unk_14034BAF8;
      }
    }
    else
    {
      v4 = (const struct _POINTFIX **)&off_14034BAD0;
      v5 = (unsigned int *)&unk_14034BAD8;
    }
  }
  else
  {
    v4 = (const struct _POINTFIX **)&off_14034BAC0;
    v5 = (unsigned int *)&unk_14034BAC8;
  }
