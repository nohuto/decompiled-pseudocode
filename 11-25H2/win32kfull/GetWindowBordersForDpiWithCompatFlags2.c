/*
 * XREFs of GetWindowBordersForDpiWithCompatFlags2 @ 0x140049D18
 * Callers:
        ...
        unsigned int a6)
{
  ...
  else
  {
    ...
    {
      v11 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 19872) + 2400LL);
    }
    else if ( a5 == 96 )
    {
      v11 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 19872) + 2520LL);
    }
    else
    {
