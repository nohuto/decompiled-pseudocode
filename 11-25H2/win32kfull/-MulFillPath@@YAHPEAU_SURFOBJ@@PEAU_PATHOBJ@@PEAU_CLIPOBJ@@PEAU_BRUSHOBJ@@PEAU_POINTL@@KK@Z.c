/*
 * XREFs of ?MulFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1403332F0
 * Callers:
 *     <none>
 * Callees:
        ...
        FLONG flOptions)
{
  ...
  for ( i = MSURF::bFindSurface((MSURF *)v18, a1, a3, &v26); i; i = MSURF::bNextSurface((MSURF *)v18) )
  {
    ...
    if ( (*(_DWORD *)(v20 + 88) & 0x40) != 0 )
      v16 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*((_QWORD *)v19 + 7) + 2800LL);
    else
      v16 = EngFillPath;
