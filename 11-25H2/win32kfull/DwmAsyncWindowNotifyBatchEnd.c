/*
 * XREFs of DwmAsyncWindowNotifyBatchEnd @ 0x1403254E8
 * Callers:
 *     ?DecrementCounter@CDwmWindowNotifyBatchProp@@QEAAXXZ @ 0x1402D347C (-DecrementCounter@CDwmWindowNotifyBatchProp@@QEAAXXZ.c)
 * Callees:
