/*
 * XREFs of ?PrepareForMasterInputThreadTakingOver@@YAXPEAVLegacyInputDispatcher@@@Z @ 0x140217664
 * Callers:
...
void __fastcall PrepareForMasterInputThreadTakingOver(struct LegacyInputDispatcher *a1)
{
  ...
  EnterCrit(1LL, 0LL);
  SetThreadPriority();
  if ( *(_QWORD *)(W32GetUserSessionState(v3, v2) + 18824) )
  {
    UserSessionState = W32GetUserSessionState(v5, v4);
    SetThreadBasePriority(**(_QWORD **)(UserSessionState + 18824), 16LL);
  }
  EditionPrepareHidForInputThreadMigration();
  EtwTraceRitDisEngaged();
  v9 = W32GetUserSessionState(v8, v7);
  ZwSetEvent(*(HANDLE *)(v9 + 18696), 0LL);
  ...
  *(_DWORD *)(W32GetUserSessionState(v14, v13) + 18744) = 1;
