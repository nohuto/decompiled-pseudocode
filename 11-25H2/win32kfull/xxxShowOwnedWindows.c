/*
 * XREFs of xxxShowOwnedWindows @ 0x14018786C
 * Callers:
    ...
    if ( v6 )
    {
      ...
      if ( v11 != 1 )
      {
        while ( 1 )
        {
          ...
          v8 = *(_QWORD **)(W32GetUserSessionState(v14, v13) + 19872);
          if ( (unsigned __int64)(unsigned __int16)v11 < v8[1] )
          {
            UserSessionState = W32GetUserSessionState(v8, v7);
            v19 = *(_DWORD *)(W32GetUserSessionState(v18, v17) + 19896) * (unsigned int)(unsigned __int16)v11
