/*
 * XREFs of ?vSrcTranCopyS8D32Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1400F2680
 * Callers:
        ...
        else
        {
          ...
          else
          {
            ...
            v31 = DWORD2(v36) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v30
                                                                                  + ((dword_140351920[*(unsigned __int8 *)(v29 + v28)]
                                                                                    * (DWORD1(v37) - v30)
                                                                                    + 0x80000) >> 20))
            ...
            v33 = HIDWORD(v36) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v32
                                                                                   + ((dword_140351920[*(unsigned __int8 *)(v29 + v28 + 1)]
                                                                                     * (DWORD2(v37) - v32)
                                                                                     + 0x80000) >> 20))
            ...
            v22 = (unsigned int)v37 & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v34
                                                                                        + ((dword_140351920[*(unsigned __int8 *)(v29 + v28 + 2)]
                                                                                          * (HIDWORD(v37) - v34)
                                                                                          + 0x80000) >> 20))
