/*
 * XREFs of xxxBroadcastModernAppRedraw @ 0x1402AF380
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall xxxBroadcastModernAppRedraw(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 19144) )
  {
    ...
    xxxBroadcastDisplaySettingsChange(*(_QWORD *)(v5 + 19144), 0, 0, 0);
    v8 = W32GetUserSessionState(v7, v6);
    LOBYTE(UserSessionState) = HandleDisplayChangeForInactiveDesktops(*(_QWORD *)(v8 + 19144), 0LL, 0);
  }
