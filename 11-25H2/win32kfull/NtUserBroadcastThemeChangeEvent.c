/*
 * XREFs of NtUserBroadcastThemeChangeEvent @ 0x140129150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserBroadcastThemeChangeEvent(unsigned __int64 a1, __int64 a2)
{
  ...
  for ( i = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 36368); i; i = *(_QWORD *)(i + 360) )
  {
    for ( j = *(_QWORD *)(i + 320); j; j = *(_QWORD *)(j + 704) )
    {
      if ( *(_DWORD *)(j + 944) )
      {
