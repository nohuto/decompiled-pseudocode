/*
 * XREFs of ?GrepExtEscape@@YAHAEAVXDCOBJ@@HHPEADH1AEBUTag@RFONTOBJ@@@Z @ 0x1401D371C
 * Callers:
 ...
 *     ?bPrinter@XDCOBJ@@QEBAHXZ @ 0x1401D3FF0 (-bPrinter@XDCOBJ@@QEBAHXZ.c)
        ...
        const struct RFONTOBJ::Tag *a7)
{
  ...
  _BYTE v44[144]; // [rsp+F0h] [rbp-158h] BYREF
