/*
 * XREFs of FreeThreadsWinEvents @ 0x1400CA1C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FreeThreadsWinEvents(__int64 a1)
{
  ...
  v7 = *(__int64 **)(UserSessionState + 70608);
  if ( v7 != (__int64 *)(UserSessionState + 70608) )
  {
    do
    {
      v8 = (__int64 *)*v7;
    ...
    while ( v8 != (__int64 *)(UserSessionState + 70608) );
  }
  v10 = *(_QWORD *)(UserSessionState + 70592);
  if ( v10 )
  {
    do
    {
