/*
 * XREFs of _anonymous_namespace_::xxxLocalActivateWindow @ 0x14023ABE8
 * Callers:
...
bool __fastcall anonymous_namespace_::xxxLocalActivateWindow(struct tagWND *a1, __int64 a2, __int16 a3)
{
  ...
  ULONG_PTR v109[2]; // [rsp+C0h] [rbp-40h] BYREF
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  if ( *(struct tagWND **)(*((_QWORD *)a1 + 2) + 472LL) == v15 )
  {
    ...
    else if ( (*(_BYTE *)(v13 + 18) & 0x10) == 0 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v7 + 472) + 412LL) &= ~0x8000u;
      v18 = *(tagQ **)(v7 + 472);
      v19 = *((_QWORD *)v18 + 16);
      ...
      if ( v22 )
      {
        ...
        v26 = *(_QWORD *)(v7 + 472);
        if ( v26 == *(_QWORD *)(v23 + 18888) )
          *(_QWORD *)(W32GetUserSessionState(v25, v24) + 18896) = v26;
        Win32HM_LockIntoThread<0>(v7, (__int64)v22, BugCheckParameter3);
        v27 = (unsigned __int64)(*(_BYTE *)(*((_QWORD *)v22 + 5) + 31LL) & 0x20) << 16;
        if ( !anonymous_namespace_::xxxSendNCActivateMessage(v22, v27) )
        {
          Win32HMThreadLockAlways<tagWND>::~Win32HMThreadLockAlways<tagWND>((ULONG_PTR)BugCheckParameter3, v28);
          goto LABEL_123;
        }
        ...
        Win32HMThreadLockAlways<tagWND>::~Win32HMThreadLockAlways<tagWND>((ULONG_PTR)BugCheckParameter3, v29);
        v8 = a3 & 2;
      }
      v30 = *(_QWORD *)(v7 + 472);
      ...
      Win32HM_LockIntoThread<1>(v7, (__int64)v35, (__int64 *)v109);
      v38 = W32GetUserSessionState(v37, v36);
      v40 = 1LL;
      if ( (*(_DWORD *)(*(_QWORD *)(v38 + 19872) + 7004LL) & 1) != 0
      ...
      if ( !v8 && (*(_BYTE *)(*((_QWORD *)a1 + 5) + 31LL) & 0x40) == 0 )
      {
        ...
        {
          if ( (a3 & 4) == 0
            || (v40 = *(_QWORD *)(W32GetUserSessionState(v40, v39) + 18888), v40 == *(_QWORD *)(v7 + 472)) )
          {
            v42 = 19;
            if ( a1 != i )
              v42 = 3;
      ...
      if ( v35 )
        v49 = *v35;
      v50 = *(_QWORD *)(*((_QWORD *)a1 + 2) + 472LL) == *(_QWORD *)(W32GetUserSessionState(v40, v39) + 18888);
      ...
      Win32HMThreadLock<tagCURSOR>::~Win32HMThreadLock<tagCURSOR>((ULONG_PTR)v109, v54);
      SetOrClrWF(0, a1, 0x101u, 1);
      if ( v102 )
      {
        v56 = *(_QWORD *)(v7 + 472);
        if ( (*(_DWORD *)(v56 + 412) & 0x800) == 0 )
        {
      ...
      *(_DWORD *)(*(_QWORD *)(v7 + 472) + 412LL) |= 0x40u;
      if ( *(_QWORD *)(W32GetUserSessionState(v56, v55) + 62824) )
      {
        v69 = *(_QWORD *)(W32GetUserSessionState(v62, v61) + 62824);
        if ( *(_QWORD *)(*((_QWORD *)a1 + 2) + 464LL) != v69 )
        {
           ...
           * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64,
            8LL);
          v73 = *(_QWORD *)(W32GetUserSessionState(v72, v71) + 62824);
          *(_DWORD *)(v73 + 12) &= ~0x400000u;
          v76 = *(_QWORD *)(W32GetUserSessionState(v73, v74) + 62824);
          if ( *(_QWORD *)(v76 + 328) )
          {
            v77 = W32GetUserSessionState(v76, v75);
            ForegroundBoost::SetForegroundPriority(*(_QWORD *)(*(_QWORD *)(v77 + 62824) + 328LL), 1LL, 8LL);
          }
        }
      }
      else
      {
        v64 = *(_QWORD *)(W32GetUserSessionState(v62, v61) + 19144);
        if ( *(_QWORD *)(v7 + 496) == v64 && !*(_DWORD *)(W32GetUserSessionState(v64, v63) + 19072) )
        {
...
LABEL_108:
      ...
      {
        v94 = *(_QWORD *)(W32GetUserSessionState(v85, v15) + 19144);
        if ( (*(_DWORD *)(v94 + 48) & 0x400) != 0 )
        {
          v95 = *(_QWORD *)(W32GetUserSessionState(v94, v15) + 18888);
...
LABEL_103:
    *(_DWORD *)(*(_QWORD *)(v7 + 472) + 412LL) &= ~0x8000u;
    if ( (*(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v78, v16) + 19872) + 7004LL) & 1) != 0
      && xxxSendTransformableMessageTimeout((struct tagTHREADINFO **)a1, 783LL, 0LL, 0LL, 0, 0, 0LL, 1, 1) )
    {
      if ( !v6 )
