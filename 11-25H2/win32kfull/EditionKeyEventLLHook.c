/*
 * XREFs of EditionKeyEventLLHook @ 0x14024FFF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HandleLowLevelHooks@Keyboard@InputTraceLogging@@SAXK_K@Z @ 0x1401DF1FC (-HandleLowLevelHooks@Keyboard@InputTraceLogging@@SAXK_K@Z.c)
        ...
        __int64 a12)
{
  ...
  if ( !Valid )
    return 0LL;
  v19 = *(_QWORD *)(W32GetUserSessionState(v17, v16) + 18888);
  if ( !v19 )
    goto LABEL_9;
  v22 = PtiKbdFromQ(v19);
  v23 = v22;
  ...
  if ( *(_QWORD *)(v22 + 464) != v25 )
    goto LABEL_9;
  v26 = *(_QWORD *)(W32GetUserSessionState(v24, v25) + 19144);
  if ( v26 != *(_QWORD *)(W32GetUserSessionState(v28, v27) + 62976)
    && (unsigned int)HasHidTable(v23)
    && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v23 + 464) + 824LL) + 100LL) & 0x10) != 0 )
  {
    return 0LL;
  }
  v13 = v60;
    ...
    if ( v36 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_AND_TRACE_SF_(
        ...
        *(_QWORD *)(UserSessionState + 69160),
        ...
        6,
        10,
        (__int64)&WPP_778d4d30a2e936405dd5209869c14452_Traceguids);
    }
LABEL_24:
    v47 = v60;
    v48 = v62;
