/*
 * XREFs of ?fxFastX@EXFORMOBJ@@QEBAJJ@Z @ 0x1400E81AC
 * Callers:
...
__int64 __fastcall EXFORMOBJ::fxFastX(EXFORMOBJ *this, int a2)
{
  int v2; // r8d
  __m128i v3; // xmm0
  int v4; // r9d
  ...
  *(float *)v3.m128i_i32 = *(float *)v3.m128i_i32 * **(float **)this;
  ...
  return (unsigned int)(v2 + *(_DWORD *)(*(_QWORD *)this + 24LL));
}
