/*
 * XREFs of ?xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z @ 0x14027ADF8
 * Callers:
...
void __fastcall xxxSendToTouchStack(struct DEVICEINFO *a1, unsigned int a2, struct tagPOINTER_TOUCH_INFO *a3, int a4)
{
  __int64 v4; // rax
  unsigned int v9; // edi
  int v10; // eax
  ...
  *((_DWORD *)a1 + 60) = 0;
  ...
  for ( *((_QWORD *)a1 + 31) = *(unsigned __int16 *)(v4 + 44); v9 < a2; v9 += 4 )
  {
    ...
    if ( v9 )
      v10 = 0;
    CreateTouchInputBuffer(a1, a2, a3, v9, v10);
