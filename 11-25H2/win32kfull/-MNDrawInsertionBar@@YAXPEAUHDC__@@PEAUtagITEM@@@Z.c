/*
 * XREFs of ?MNDrawInsertionBar@@YAXPEAUHDC__@@PEAUtagITEM@@@Z @ 0x140040284
 * Callers:
...
void __fastcall MNDrawInsertionBar(HDC a1, struct tagITEM *a2)
{
  ...
  if ( v3 < 0 || (v3 & 0x40000000) != 0 )
  {
    ...
    v36[0] = v4 + *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872) + 2168LL);
    v6 = *(_QWORD *)(W32GetUserSessionState(v36[0], v5) + 19872);
    v7 = *(_DWORD *)(v6 + 2168);
    v36[2] = v7;
    v10 = *(_QWORD *)(W32GetUserSessionState(v6, v8) + 19872);
    v11 = *(_QWORD *)a2;
    v12 = *(_DWORD *)(v10 + 2172);
    v36[3] = v12;
    if ( v3 >= 0 )
    ...
    v37 = v15;
    v18 = (unsigned int)(v16 + 2 * *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v17) + 19872) + 2168LL));
    v19 = *(_QWORD *)a2;
    v38 = v18;
    v20 = *(_DWORD *)(v19 + 72);
    v22 = *(_QWORD *)(W32GetUserSessionState(v18, v21) + 19872);
    v40 = v20 - 4 * *(_DWORD *)(v22 + 2168);
    UserSessionState = W32GetUserSessionState(v22, v23);
    v25 = *(_DWORD **)a2;
    v26 = *(int *)(*(_QWORD *)(UserSessionState + 19872) + 2172LL) >> 31;
    LODWORD(UserSessionState) = *(_DWORD *)(*(_QWORD *)(UserSessionState + 19872) + 2172LL);
    v28 = v26;
    ...
    v45 = v7;
    v46 = v12;
    v34 = *(_QWORD *)(W32GetUserSessionState(v30, v28) + 19872);
    v44 = v13;
    v47 = v15;
    v43 = v32 + v33 - 2 * *(_DWORD *)(v34 + 2168);
    GrePolyPatBlt(a1, 0xF00021u, (struct _POLYPATBLT *)v36, 3u);
  }
}
