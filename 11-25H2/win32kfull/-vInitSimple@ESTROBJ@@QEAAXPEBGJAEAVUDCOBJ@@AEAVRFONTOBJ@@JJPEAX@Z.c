/*
 * XREFs of ?vInitSimple@ESTROBJ@@QEAAXPEBGJAEAVUDCOBJ@@AEAVRFONTOBJ@@JJPEAX@Z @ 0x140216C14
 * Callers:
 ...
 *     ?GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z @ 0x140312678 (-GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z.c)
 */
  ...
  *((_QWORD *)this + 5) = a2;
  ...
  if ( v10 )
  {
    ...
    *((_QWORD *)this + 8) = v10;
    v12 = *(_QWORD *)v5;
    v19 = 0;
    *((_DWORD *)this + 1) = *(_DWORD *)(v12 + 268) & 0x71 | 2;
    if ( (unsigned int)RFONTOBJ::bGetGlyphMetricsPlus(v5, (struct RFONTOBJ *)1, v10, a2, &v19, a4, this) )
    {
      ...
      v11->ptl.x = 0;
      v11->ptl.y = *(_DWORD *)(*(_QWORD *)v5 + 344LL);
      v14 = (*((_DWORD *)this + 58) & 0x1400) == 0;
      v15 = *(_DWORD *)(*(_QWORD *)v5 + 304LL);
      *((_DWORD *)this + 2) = v15;
      if ( v14 && v15 )
      {
        *((_DWORD *)this + 3) = 0;
      ...
      {
        *((_DWORD *)this + 2) = 0;
        v11->ptl.y = *((_DWORD *)ESTROBJ::GetLinkedRfontOnIndex(this, 0, v5) + 86);
