/*
 * XREFs of ?SetupFakeMDIAppStuff@@YAXAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z @ 0x1402CA2C4
 * Callers:
 ...
 *     ?FindFakeMDIChild@@YAPEAUtagWND@@PEAU1@@Z @ 0x1402CA26C (-FindFakeMDIChild@@YAPEAUtagWND@@PEAU1@@Z.c)
 */
