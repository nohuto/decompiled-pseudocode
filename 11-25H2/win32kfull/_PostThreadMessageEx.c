/*
 * XREFs of _PostThreadMessageEx @ 0x1401AAC9C
 * Callers:
...
LABEL_41:
  ...
  if ( a2 != 188 )
    goto LABEL_23;
LABEL_36:
  if ( !(unsigned int)Feature_UIPIAlwaysOn__private_IsEnabledDeviceUsageNoInline(v13)
    && (!UIPrivilegeIsolation::Enforced(v25) || *(_QWORD *)v11 == *(_QWORD *)(W32GetUserGdiSessionState(v26) + 40))
    && (*(_DWORD *)(v11 + 764) != *(_DWORD *)(v14 + 764) || *(_DWORD *)(v11 + 768) != *(_DWORD *)(v14 + 768)) )
  {
    goto LABEL_41;
  }
LABEL_23:
