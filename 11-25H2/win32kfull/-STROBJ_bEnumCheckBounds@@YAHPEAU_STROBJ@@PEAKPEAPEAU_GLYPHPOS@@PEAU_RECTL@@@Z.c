/*
 * XREFs of ?STROBJ_bEnumCheckBounds@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@PEAU_RECTL@@@Z @ 0x1400A9A18
 * Callers:
 *     EngTextOut @ 0x140012BD0 (EngTextOut.c)
 * Callees:
 *     ?bGlyphOutOfBounds@@YAHPEAVESTROBJ@@PEAU_GLYPHPOS@@PEAU_RECTL@@K@Z @ 0x1400A90EC (-bGlyphOutOfBounds@@YAHPEAVESTROBJ@@PEAU_GLYPHPOS@@PEAU_RECTL@@K@Z.c)
...
__int64 __fastcall STROBJ_bEnumCheckBounds(struct _STROBJ *a1, ULONG *pc, PGLYPHPOS *ppgpos, struct _RECTL *a4)
{
  ...
  if ( (unsigned int)v16 < v11 )
  {
    ...
    do
    {
      if ( (unsigned int)bGlyphOutOfBounds((struct ESTROBJ *)a1, &v19[v16], v18, (unsigned int)v16 + cGlyphs) )
        break;
      ++v8;
