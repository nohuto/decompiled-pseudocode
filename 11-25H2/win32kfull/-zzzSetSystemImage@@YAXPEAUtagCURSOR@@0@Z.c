/*
 * XREFs of ?zzzSetSystemImage@@YAXPEAUtagCURSOR@@0@Z @ 0x140125EE8
 * Callers:
  ...
  if ( *((_QWORD *)a1 + 3) )
  {
    ...
    do
    {
      if ( (*((_DWORD *)v19 + 20) & 8) != 0 )
      {
        ...
        if ( *((int *)v19 + 22) > 0 )
        {
          ...
          do
          {
            ...
            HMChangeOwnerProcess(v39, *(_QWORD *)(UserSessionState + 18648));
            *(_QWORD *)(v39 + 24) = 0LL;
            v38 += 8LL;
            ++v37;
          }
      ...
      if ( v19 == a1 )
      {
        if ( (*((_DWORD *)a1 + 20) & 8) == 0 )
        {
          if ( *((_QWORD *)v19 + 11) )
          {
            ...
            GreIncQuotaCount(*(_QWORD *)(*(_QWORD *)(v22 + 18648) + 464LL));
          }
          if ( *((_QWORD *)v19 + 12) )
          {
            GreDecQuotaCount(*((_QWORD *)v19 + 3));
            v25 = W32GetUserSessionState(v24, v23);
            GreIncQuotaCount(*(_QWORD *)(*(_QWORD *)(v25 + 18648) + 464LL));
          }
          if ( *((_QWORD *)v19 + 16) )
          {
            GreDecQuotaCount(*((_QWORD *)v19 + 3));
            v28 = W32GetUserSessionState(v27, v26);
            GreIncQuotaCount(*(_QWORD *)(*(_QWORD *)(v28 + 18648) + 464LL));
          }
        }
      }
      else
      {
        ...
        HMChangeOwnerProcess(v19, *(_QWORD *)(v29 + 18648));
        *((_QWORD *)v19 + 3) = 0LL;
      }
      ...
      if ( v15 == a1 )
      {
        if ( (*((_DWORD *)a1 + 20) & 8) == 0 )
        {
          if ( *((_QWORD *)v15 + 11) )
          {
            ...
            GreDecQuotaCount(*(_QWORD *)(*(_QWORD *)(v16 + 18648) + 464LL));
            GreIncQuotaCount(*((_QWORD *)v15 + 3));
          }
          if ( *((_QWORD *)v15 + 12) )
          {
            v17 = W32GetUserSessionState(v12, v10);
            GreDecQuotaCount(*(_QWORD *)(*(_QWORD *)(v17 + 18648) + 464LL));
            GreIncQuotaCount(*((_QWORD *)v15 + 3));
          }
          if ( *((_QWORD *)v15 + 16) )
          {
            v18 = W32GetUserSessionState(v12, v10);
            GreDecQuotaCount(*(_QWORD *)(*(_QWORD *)(v18 + 18648) + 464LL));
            GreIncQuotaCount(*((_QWORD *)v15 + 3));
          }
        }
      }
