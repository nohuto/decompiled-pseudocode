/*
 * XREFs of ?greenloop@INVCMAP@@QEAAHH@Z @ 0x1400CDDBC
 * Callers:
 *     ?redloop@INVCMAP@@QEAAHXZ @ 0x1400CDC78 (-redloop@INVCMAP@@QEAAHXZ.c)
 * Callees:
 *     ?blueloop@INVCMAP@@QEAAHH@Z @ 0x1400CDFD0 (-blueloop@INVCMAP@@QEAAHH@Z.c)
 */
