/*
 * XREFs of ?OnRapidHpdTimeout@DesktopRecalc@@YAXPEAVCMonitorTopology@@AEBU_GUID@@@Z @ 0x1402C4C9C
 * Callers:
...
void __fastcall DesktopRecalc::OnRapidHpdTimeout(DesktopRecalc *this, const struct _GUID *a2, const struct _GUID *a3)
{
  ...
  DesktopRecalc::StartRecalc(*(DesktopRecalc **)(*(_QWORD *)(v10 + 19144) + 40LL), this, a2, v11);
}
