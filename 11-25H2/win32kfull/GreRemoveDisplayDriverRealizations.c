/*
 * XREFs of GreRemoveDisplayDriverRealizations @ 0x140122EA8
 * Callers:
  ...
  if ( a1 )
  {
    ...
    if ( v8 )
      GreReleaseSemaphoreCommon<1,void (*)(HSEMAPHORE__ *)>(
        (__int64 (__fastcall *)(__int64))GreReleaseSemaphoreExclusiveInternal,
        v8);
    GrepReleasePushLockCommon<0,1,void (*)(W32_PUSH_LOCK *,unsigned long)>(v13, (struct W32_PUSH_LOCK *)(v21 + 8624));
  }
}
