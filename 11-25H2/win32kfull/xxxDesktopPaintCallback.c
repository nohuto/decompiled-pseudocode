/*
 * XREFs of xxxDesktopPaintCallback @ 0x140200ED0
 * Callers:
...
_BOOL8 __fastcall xxxDesktopPaintCallback(__int64 a1, HDC a2, const RECT *a3, __int64 a4)
{
  ...
  if ( a2 )
  {
    ...
    GreUnlockVisRgn(*(_QWORD *)(*(_QWORD *)(v20 + 56968) + 48LL));
    if ( StyleWindow )
    {
  ...
  v22 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19872);
  if ( *(_DWORD *)(v22 + 2164) || v5 )
  {
    ...
    v27 = FillRect(a2, a3, *(HBRUSH *)(v26 + 43056));
    LeaveRenderCrit(v28);
  ...
  else if ( *(_DWORD *)(W32GetUserSessionState(v22, v21) + 62832) )
  {
    v32 = 0;
  }
  else
  {
    ...
    v38 = FillRect(a2, a3, *(HBRUSH *)(*(_QWORD *)(v37 + 19872) + 4704LL));
    LeaveRenderCrit(v39);
    UserSessionSwitchLeaveCrit(v40);
    LeaveEnterCrit::~LeaveEnterCrit((LeaveEnterCrit *)&v49);
    v32 = v38 != 0;
  }
  v44 = *(_QWORD *)(W32GetUserSessionState(v31, v30) + 19872);
  if ( *(_DWORD *)(v44 + 2164) )
  {
