/*
 * XREFs of xxxPerformTargetingWithinPwnd @ 0x1401BFCF0
 * Callers:
 *     PerformTargetingWithinPwnd @ 0x1401BF700 (PerformTargetingWithinPwnd.c)
 * Callees:
...
__int64 __fastcall xxxPerformTargetingWithinPwnd(struct tagTHREADINFO **a1, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  result = GetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 41348), 1u);
  if ( (result & 0xFFFD) != 0 )
  {
