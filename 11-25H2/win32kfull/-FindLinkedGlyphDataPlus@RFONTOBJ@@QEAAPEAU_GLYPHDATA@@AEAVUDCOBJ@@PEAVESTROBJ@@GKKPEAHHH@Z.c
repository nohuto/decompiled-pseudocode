/*
 * XREFs of ?FindLinkedGlyphDataPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@AEAVUDCOBJ@@PEAVESTROBJ@@GKKPEAHHH@Z @ 0x1400AD7F0
 * Callers:
 ...
 *     ?bIsSystemTTGlyph@RFONTOBJ@@QEBAHG@Z @ 0x14019FD2C (-bIsSystemTTGlyph@RFONTOBJ@@QEBAHG@Z.c)
 */
        ...
        int a9)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 304LL) && a8 && (unsigned int)RFONTOBJ::bIsSystemTTGlyph(this, a4) )
  {
    if ( *(_QWORD *)(*(_QWORD *)this + 728LL) )
    {
      ...
      if ( v50
        && (!a9
          ? (EudcMetrics = RFONTOBJ::pgdGetEudcMetrics((RFONTOBJ *)&v50, (struct RFONTOBJ *)(unsigned __int16)v9, a3))
...
LABEL_83:
      ...
      {
        v24 = RFONTOBJ::pgdDefault(this, a2);
      }
      goto LABEL_84;
    }
    ...
    if ( v17 )
    {
      ...
      if ( (v18 & 8) != 0 && (v18 & 2) == 0 )
      {
        ...
        v48 = a9
            ...
            : RFONTOBJ::pgdGetEudcMetrics((RFONTOBJ *)&v51, (struct RFONTOBJ *)(unsigned __int16)v9, a3);
        v24 = v48;
        if ( v48 )
        {
          if ( v48->fxD )
...
LABEL_61:
  ...
  if ( !a9 )
  {
    v27 = RFONTOBJ::pgdGetEudcMetrics((RFONTOBJ *)&v51, (struct RFONTOBJ *)(unsigned __int16)v9, a3);
LABEL_20:
    v24 = v27;
    goto LABEL_21;
  }
  ...
  if ( !*v20 )
  {
    v27 = RFONTOBJ::pgdDefault((RFONTOBJ *)&v51, a2);
    goto LABEL_20;
  }
...
LABEL_23:
  for ( i = 0LL; ; i = (unsigned int)(i + 1) )
  {
    ...
    if ( !a9 )
    {
      v41 = RFONTOBJ::pgdGetEudcMetrics((RFONTOBJ *)&v51, (struct RFONTOBJ *)(unsigned __int16)v9, v34);
      goto LABEL_39;
    }
    ...
    if ( !*v35 )
    {
      v41 = RFONTOBJ::pgdDefault((RFONTOBJ *)&v51, v33);
LABEL_39:
      v24 = v41;
LABEL_40:
      if ( !v24 )
...
LABEL_42:
  ...
  if ( a9 )
    ...
    EudcMetricsPlus = RFONTOBJ::pgdGetEudcMetrics((RFONTOBJ *)&v50, (struct RFONTOBJ *)(unsigned __int16)v9, a3);
  v24 = EudcMetricsPlus;
