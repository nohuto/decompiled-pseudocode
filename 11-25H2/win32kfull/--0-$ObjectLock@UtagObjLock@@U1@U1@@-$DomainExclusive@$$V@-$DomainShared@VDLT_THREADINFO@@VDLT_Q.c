/*
 * XREFs of ??0?$ObjectLock@UtagObjLock@@U1@U1@@?$DomainExclusive@$$V@?$DomainShared@VDLT_THREADINFO@@VDLT_QUEUE@@VDLT_POST@@@@QEAA@AEAUtagObjLock@@00@Z @ 0x1401103E4
 * Callers:
        ...
        tagObjLock *a4)
{
  ...
  *((_QWORD *)Base + 6) = UserSessionState + 42360;
  *((_OWORD *)Base + 4) = 0LL;
  *((_OWORD *)Base + 5) = 0LL;
  Base[96] = 0;
