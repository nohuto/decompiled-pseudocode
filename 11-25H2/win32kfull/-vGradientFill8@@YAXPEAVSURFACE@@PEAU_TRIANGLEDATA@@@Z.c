/*
 * XREFs of ?vGradientFill8@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x14031D780
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vGradientFill8(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
  ...
  v40 = *((_QWORD *)v2 + 3);
  v41 = *((_QWORD *)v2 + 4);
  v11 = (unsigned __int8 *)&unk_140363E80;
  v52 = v5;
  v43 = (char *)v2 + 168;
  ...
  v46 = v11;
  if ( (v14 & 0x100000) == 0 )
    v6 = (char *)&unk_140364000;
  v15 = *(_DWORD *)(v9 + 76);
  v49 = v6;
  if ( (v15 & 0x800) != 0 )
  {
    if ( v13 == *((_QWORD *)v10 + 471) )
    {
      v16 = &unk_140363A04;
    }
    else
