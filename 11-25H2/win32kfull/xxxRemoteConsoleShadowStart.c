/*
 * XREFs of xxxRemoteConsoleShadowStart @ 0x1402B8C40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreConsoleShadowStart @ 0x14033F224 (GreConsoleShadowStart.c)
...
__int64 __fastcall xxxRemoteConsoleShadowStart(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&SourceString = a2;
  ...
  if ( *(_DWORD *)(UserSessionState + 68756) && !IsRemoteConnection(v8, v10) )
  {
    *(_DWORD *)(UserSessionState + 68764) = 0;
    *(_QWORD *)(UserSessionState + 68808) = 0LL;
    *(_QWORD *)(UserSessionState + 68768) = *(_QWORD *)(a1 + 32);
    *(_QWORD *)(UserSessionState + 68776) = *(_QWORD *)(a1 + 40);
    *(_QWORD *)(UserSessionState + 68792) = *(_QWORD *)(a1 + 56);
    *(_QWORD *)(UserSessionState + 68800) = *(_QWORD *)(a1 + 64);
    *(_QWORD *)(UserSessionState + 68840) = *(_QWORD *)(a1 + 268);
    *(_DWORD *)(UserSessionState + 68848) = *(_DWORD *)(a1 + 276);
    v19 = *(_DWORD *)(a1 + 240);
    ...
    *(_QWORD *)(UserSessionState + 68816) = Object;
    if ( MirrorDriver < 0 )
      goto LABEL_24;
    v24 = *(void **)(UserSessionState + 68768);
    Object = 0LL;
...
LABEL_24:
        ...
        && !(unsigned int)xxxUserChangeDisplaySettings(0LL, 0LL, 0LL, 0LL, 0LL, 0, a3) )
      {
        ...
        *(_QWORD *)(UserSessionState + 68808) = HDEV;
        if ( HDEV )
        {
          v45 = *(_QWORD *)(UserSessionState + 68832);
          v46 = *(_QWORD *)(UserSessionState + 68800);
          *(_DWORD *)(UserSessionState + 68764) = 1;
          if ( (unsigned int)bDrvReconnect(HDEV, v46, v45, 0) )
          {
            HDXDrvEscape(*(_QWORD *)(UserSessionState + 68808), 2LL, *(_QWORD *)(UserSessionState + 68944), 8LL);
            return (unsigned int)MirrorDriver;
          }
        }
      }
