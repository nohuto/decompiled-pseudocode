/*
 * XREFs of ?xxxSendShutdownData@@YA_JPEAUHWND__@@_K@Z @ 0x1401303C4
 * Callers:
...
__int64 __fastcall xxxSendShutdownData(HWND a1, __int64 a2)
{
  ...
  v35 = 0;
  if ( *(_QWORD *)(W32GetUserSessionState(v5, v4) + 63472) )
  {
    if ( a1 == (HWND)0xFFFF )
    {
LABEL_13:
      ...
      v33 = 0LL;
      v34 = 1064;
      v19 = *(_QWORD *)(W32GetUserSessionState(v7, Prop) + 19872);
      v20 = *(_QWORD *)(v19 + 752);
      v22 = *(_QWORD *)(W32GetUserSessionState(v19, v21) + 63472);
      v23 = *(_QWORD *)(*(_QWORD *)(v22 + 40) + 120LL);
      UserSessionState = W32GetUserSessionState(v22, v24);
      SfnCOPYDATA(*(_QWORD *)(UserSessionState + 63472), 809, a2, (unsigned int)&v33, v23, v20);
      return 0LL;
    }
    ...
    if ( v8 )
    {
      v11 = 1;
      v12 = v8 + 40;
      if ( *(_QWORD *)v8 == *(_QWORD *)(W32GetUserSessionState(v7, Prop) + 19120) )
      {
        LODWORD(a2) = 2;
        goto LABEL_7;
      }
...
LABEL_7:
        *(_DWORD *)(v9 + 380) |= 0x400000u;
        ...
        Prop = GetProp(v9, *(unsigned __int16 *)(v18 + 41352), 1u);
        if ( Prop )
        {
          Prop -= (__int64)v38;
          v7 = v38;
