/*
 * XREFs of EditionNonDwmTouchHitTest @ 0x1402A4E60
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall EditionNonDwmTouchHitTest(_OWORD *a1, __int64 a2, struct tagTOUCHTARGETINGCONTACT *a3, _DWORD *a4)
{
  ...
  v9 = INPUTDEST_FROM_PWND(v47, *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(UserSessionState + 19144) + 8LL) + 24LL));
  ...
  *a1 = *v9;
  ...
  {
    v48 = 0LL;
    v29 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19144);
    v30 = *(struct tagWND **)(*(_QWORD *)(v29 + 8) + 24LL);
    v32 = *(_QWORD **)(*(_QWORD *)(W32GetUserSessionState(v29, v31) + 19144) + 8LL);
    v33 = *(_DWORD *)(*v32 + 64LL) & 1;
    v35 = W32GetUserSessionState(*v32, v34);
    v38 = TopLevelTouchTarget(
            *(struct tagWND **)(*(_QWORD *)(*(_QWORD *)(v35 + 19144) + 8LL) + 24LL),
            a3,
            v12,
            &v48,
            v33);
  ...
  else if ( !*(_DWORD *)(a2 + 68) )
  {
    ...
    v20 = TopLevelSpeedHitTest(*(struct tagDESKTOP **)(v19 + 19144), (struct tagPOINT *)(a2 + 20), 0LL);
    if ( v20 )
    {
