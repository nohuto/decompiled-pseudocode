/*
 * XREFs of _UnregisterClass @ 0x140242308
 * Callers:
...
__int64 __fastcall UnregisterClass(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( (a1 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    if ( (int)RtlStringCchCopyW((char *)(UserSessionState + 41716), 256LL, (char *)a1) < 0 )
    {
      v11 = 0;
      goto LABEL_7;
    }
...
LABEL_7:
  ...
  v12 = *((_QWORD *)v6 + 58);
  ClassPtr = InnerGetClassPtr(v11, (__int64 *)(v12 + 344), a2);
  if ( !ClassPtr )
  {
    ClassPtr = InnerGetClassPtr(v11, (__int64 *)(v12 + 352), 0LL);
    if ( !ClassPtr )
    {
      v14 = 1411;
LABEL_10:
