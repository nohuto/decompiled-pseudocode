/*
 * XREFs of ?RemoveComponentInternal@CoreWindowProp@@KAJPEAUtagWND@@0@Z @ 0x1402C9F70
 * Callers:
 *     ?Delete@CoreWindowProp@@UEAAXXZ @ 0x1402C9DA0 (-Delete@CoreWindowProp@@UEAAXXZ.c)
