/*
 * XREFs of ?xxxDeactivate@@YAXPEAUtagTHREADINFO@@KW4DeactivateOption@@@Z @ 0x14023A4E0
 * Callers:
...
void __fastcall xxxDeactivate(__int64 a1, __int64 a2, char a3)
{
  ...
  ULONG_PTR v34[2]; // [rsp+A0h] [rbp-60h] BYREF
...
LABEL_20:
    ...
    if ( *((_QWORD *)*v6 + 16) == v11 )
    {
      Win32HM_LockIntoThread<1>(v7, v11, (__int64 *)v34);
      if ( !v13 && !anonymous_namespace_::xxxSendNCActivateMessage((struct tagWND *)v11, 0LL) )
      {
        Win32HMThreadLock<tagCURSOR>::~Win32HMThreadLock<tagCURSOR>((ULONG_PTR)v34, v19);
        goto LABEL_35;
      }
      xxxSendTransformableMessageTimeout((struct tagTHREADINFO **)v11, 6LL, 0LL, 0LL, 0, 0, 0LL, 1, 1);
      Win32HMThreadLock<tagCURSOR>::~Win32HMThreadLock<tagCURSOR>((ULONG_PTR)v34, v20);
      v21 = *v6;
      if ( *((_QWORD *)*v6 + 16) == v11 )
      {
        v35[1] = *((_QWORD *)*v6 + 16);
