/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x140269FB0
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x14027A684 (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
  ...
  if ( v3 != 2 )
  {
    if ( v3 )
    {
      ...
      if ( (unsigned int)dword_14039BB50 <= 4 )
        return v3;
      LOBYTE(v3) = tlgKeywordOn((__int64)&dword_14039BB50, 256LL);
      if ( !(_BYTE)v3 )
        return v3;
      v19 = &unk_140366EF4;
    }
