/*
 * XREFs of ??$GetProp@VCDwmWindowNotifyBatchProp@@@CWindowProp@@SAHPEBUtagWND@@PEAPEAVCDwmWindowNotifyBatchProp@@@Z @ 0x1402D33DC
 * Callers:
...
_BOOL8 __fastcall CWindowProp::GetProp<CDwmWindowNotifyBatchProp>(__int64 a1, __int64 *a2)
{
  ...
  Prop = GetProp(a1, *(unsigned __int16 *)(UserSessionState + 42262), 1u);
  *a2 = Prop;
  return Prop != 0;
}
