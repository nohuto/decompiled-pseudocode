/*
 * XREFs of NtUserEnableSoftwareCursorForScreenCapture @ 0x14019CEA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserEnableSoftwareCursorForScreenCapture(unsigned int a1)
{
  ...
  {
    if ( a1 != *(_DWORD *)(W32GetUserSessionState(v4, v3) + 36296) )
    {
      ChangeComposableCursor(a1);
      *(_DWORD *)(W32GetUserSessionState(v6, v5) + 36296) = a1;
    }
    v2 = 1LL;
  }
