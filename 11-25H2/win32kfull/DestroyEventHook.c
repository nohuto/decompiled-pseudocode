/*
 * XREFs of DestroyEventHook @ 0x1400C9C20
 * Callers:
...
void __fastcall DestroyEventHook(struct _HEAD *a1, __int64 a2)
{
  ...
  *((_DWORD *)a1 + 10) |= 1u;
  ...
  if ( (unsigned int)HMMarkObjectDestroy(a1) )
  {
    ...
    for ( i = (struct _HEAD **)(v7 + 70592); ; i = (struct _HEAD **)((char *)v9 + 24) )
    {
      v9 = *i;
      if ( !*i )
        break;
    ...
    while ( v10 )
    {
      ...
      do
      {
        if ( *(v15 - 1) > *(_DWORD *)(v10 + 36) )
          break;
        i = (struct _HEAD **)++v17;
        if ( (unsigned int)(*((_DWORD *)&unk_140351390 + 2 * v17) - 1) >= *(_DWORD *)(v10 + 32) )
          v16 |= *v15;
        v15 += 2;
      }
      while ( v17 < 0xF );
    ...
    *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(i, 0LL) + 19872) + 1892LL) = v3;
    v18 = *((_DWORD *)a1 + 18);
    if ( v18 >= 0 )
    ...
    if ( v19[0] )
      *(_QWORD *)(W32GetUserSessionState(v14, v13) + 19768) = 0LL;
  }
  else
  {
    DomainShared<>::DomainExclusive<DLT_HOOK>::ObjectLock<>::~ObjectLock<>((__int64)&v20);
    if ( v19[0] )
      *(_QWORD *)(W32GetUserSessionState(v12, v11) + 19768) = 0LL;
  }
}
