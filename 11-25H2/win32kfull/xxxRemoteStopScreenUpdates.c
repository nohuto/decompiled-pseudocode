/*
 * XREFs of xxxRemoteStopScreenUpdates @ 0x140126958
 * Callers:
 *     xxxRemoteDisconnect @ 0x1401263A8 (xxxRemoteDisconnect.c)
 *     xxxRemoteReconnect @ 0x1402573C0 (xxxRemoteReconnect.c)
 *     NtUserRemoteStopScreenUpdates @ 0x14029D680 (NtUserRemoteStopScreenUpdates.c)
...
__int64 __fastcall xxxRemoteStopScreenUpdates(__int64 a1, __int64 a2)
{
  ...
  if ( !*(_DWORD *)(W32GetUserSessionState(v10, v9) + 68860) )
  {
    ...
    else
    {
      ...
      KeSetEvent(*(PRKEVENT *)(v20 + 68440), 1, 0);
    }
    if ( *(_QWORD *)(W32GetUserSessionState(v19, v18) + 62984) )
    {
      v22 = *(_WORD *)(v8 + 20604);
      v23 = v22 & ~*(_WORD *)(v8 + 20606);
      v24 = v23 ^ v22;
      v25 = v24 & 1 | 2;
      if ( (v24 & 2) == 0 )
        v25 = v24 & 1;
      ...
      *(_WORD *)(v8 + 20604) = v23;
      ...
      v35 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 62984);
      v38 = W32GetUserSessionState(v37, v36);
      RemoteDisableScreen(*(_QWORD *)(v38 + 19144), v35, v32 + 19152, v29 + 62832);
      v41 = 1;
