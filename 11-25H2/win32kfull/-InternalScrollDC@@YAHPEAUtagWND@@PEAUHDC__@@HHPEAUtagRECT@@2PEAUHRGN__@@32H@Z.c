/*
 * XREFs of ?InternalScrollDC@@YAHPEAUtagWND@@PEAUHDC__@@HHPEAUtagRECT@@2PEAUHRGN__@@32H@Z @ 0x140156C38
 * Callers:
        ...
        int a10)
{
  ...
  *(_OWORD *)&v96[0].x = 0LL;
  ...
  if ( !(unsigned int)GreLockVisRgnSharedOrExclusive(
                        *(_QWORD *)(*(_QWORD *)(UserSessionState + 56968) + 48LL),
                        a2,
                        &v84) )
    return 0LL;
...
LABEL_136:
            ...
            if ( v84 )
            {
              ...
              GreUnlockVisRgnShared(*(_QWORD *)(*(_QWORD *)(v61 + 56968) + 48LL));
            }
            else
            {
...
LABEL_28:
              if ( v84 )
              {
                ...
                GreUnlockVisRgnShared(*(_QWORD *)(*(_QWORD *)(v41 + 56968) + 48LL));
              }
              else
              {
                v62 = W32GetUserSessionState(v16, v15);
                GreUnlockVisRgn(*(_QWORD *)(*(_QWORD *)(v62 + 56968) + 48LL));
              }
              GreDeleteObject(v11);
              GreDeleteObject(v40);
              GreDeleteObject(v39);
...
LABEL_45:
  ...
  if ( v84 )
  {
    ...
    GreUnlockVisRgnShared(*(_QWORD *)(*(_QWORD *)(v44 + 56968) + 48LL));
  }
  else
  {
    v64 = W32GetUserSessionState(v16, v15);
    GreUnlockVisRgn(*(_QWORD *)(*(_QWORD *)(v64 + 56968) + 48LL));
  }
  GreDeleteObject(v11);
  GreDeleteObject(v40);
  GreDeleteObject(0LL);
