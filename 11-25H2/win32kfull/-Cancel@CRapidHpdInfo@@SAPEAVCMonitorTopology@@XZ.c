/*
 * XREFs of ?Cancel@CRapidHpdInfo@@SAPEAVCMonitorTopology@@XZ @ 0x140028494
 * Callers:
...
struct CMonitorTopology *__fastcall CRapidHpdInfo::Cancel(__int64 a1, __int64 a2)
{
  ...
  v4 = *(_QWORD *)(UserSessionState + 71248);
  if ( v4 )
  {
    ...
    v2 = *(volatile signed __int32 **)(*(_QWORD *)(UserSessionState + 71248) + 40LL);
