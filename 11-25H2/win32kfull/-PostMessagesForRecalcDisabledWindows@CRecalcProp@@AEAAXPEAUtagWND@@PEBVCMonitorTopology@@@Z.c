/*
 * XREFs of ?PostMessagesForRecalcDisabledWindows@CRecalcProp@@AEAAXPEAUtagWND@@PEBVCMonitorTopology@@@Z @ 0x1402C4D80
 * Callers:
        ...
        const struct CMonitorTopology *a3)
{
  ...
  if ( (v4 & 0xFFFFFFEF) != 0 )
  {
    ...
    if ( v8 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      LOBYTE(v13) = v9;
      LOBYTE(v14) = v8;
      v15 = *(_QWORD *)(UserSessionState + 69160);
      v16 = "has";
      if ( (v10 & 0x10) == 0 )
        v16 = "had";
    ...
    PostEventMessageEx(
      ...
      *(struct tagQ **)(*((_QWORD *)a2 + 2) + 472LL),
      ...
      (LARGE_INTEGER *)a2,
      0x7Eu,
      (LARGE_INTEGER)*(unsigned __int16 *)(*(_QWORD *)(v20 + 19872) + 6996LL),
