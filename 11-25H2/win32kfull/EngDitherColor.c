/*
 * XREFs of EngDitherColor @ 0x140303920
 * Callers:
 ...
 * Callees:
 *     ?vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z @ 0x1403030DC (-vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z.c)
 *     ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x140303370 (-vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 *     ?vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x140303668 (-vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
...
ULONG __stdcall EngDitherColor(HDEV hdev, ULONG iMode, ULONG rgb, ULONG *pul)
{
  ...
  v6 = 0;
  if ( *((_WORD *)hdev + 1048) == 8 && *((_WORD *)hdev + 1049) == 8 )
  {
    if ( iMode == 2 )
    {
      *(_OWORD *)pul = 0LL;
      *((_OWORD *)pul + 1) = 0LL;
      ...
      if ( v10 )
      {
        ...
        do
        {
          v12 = byte_140362DFF[v11];
          pul[v12] |= byte_140362DFF[--v11 + 65];
          --v10;
        }
        while ( v10 );
      }
