/*
 * XREFs of NtGdiSwapBuffers @ 0x14033EEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiSwapBuffers(HDC a1)
{
  ...
  _BYTE v17[144]; // [rsp+A8h] [rbp-60h] BYREF
  struct EWNDOBJ *v18; // [rsp+138h] [rbp+30h]
...
LABEL_8:
    ...
    if ( (v17[32] & 1) != 0 )
    {
      ...
      if ( ERECTL::bEmpty((struct EWNDOBJ *)((char *)v18 + 4)) )
      {
LABEL_12:
        DEVLOCKOBJ_WNDOBJ::~DEVLOCKOBJ_WNDOBJ((DEVLOCKOBJ_WNDOBJ *)v17);
        goto LABEL_8;
      }
      ...
      if ( (*(_DWORD *)(v8 + 40) & 0x20000) != 0 )
      {
        ...
        *(_OWORD *)&v15[1] = *(_OWORD *)(v16[0] + 1032LL);
        DeviceHdev = hdevFindDeviceHdev(v11, (struct _RECTL *)&v15[1], v18);
        v6 = DeviceHdev;
        v10 = v9;
        if ( DeviceHdev )
        {
