/*
 * XREFs of ?UMPDDrvEndDoc@@YAHPEAU_SURFOBJ@@K@Z @ 0x140335100
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)v20 = 0LL;
  if ( v16 )
  {
    ...
    if ( v9 )
    {
      ...
      v20[1] = a1;
      v10 = 0;
      if ( (unsigned int)UMPDOBJ::pso(v6, (UMPDOBJ *)((char *)v6 + 80), &v20[1]) )
      {
        LODWORD(Size) = 4;
        if ( (unsigned int)UMPDOBJ::Thunk(v6, &Src, 0x28u, &v12, Size) != -1 )
        {
          if ( v12 )
            v10 = 1;
        }
