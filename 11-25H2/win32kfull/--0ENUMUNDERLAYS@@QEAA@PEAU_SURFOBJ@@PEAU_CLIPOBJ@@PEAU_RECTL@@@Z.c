/*
 * XREFs of ??0ENUMUNDERLAYS@@QEAA@PEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@@Z @ 0x140011E3C
 * Callers:
        ...
        struct _RECTL *a4)
{
  ...
  _QWORD v43[2]; // [rsp+48h] [rbp-21h] BYREF
  ...
  *((_DWORD *)this + 20) = 1;
  if ( a3 && a3->iDComplexity )
  {
    ...
    *(_QWORD *)v12 = a3;
    ...
    {
      *((_QWORD *)this + 34) = v40;
      *v28 = (struct _RECTL)xmmword_140365120;
      return this;
    }
  ...
  v43[0] = v32;
  v42 = XDCOBJ::prgnEffRao((XDCOBJ *)v43);
  if ( !RGNOBJ::bCopy((RGNOBJ *)&v38, (struct RGNOBJ *)&v42) )
    goto LABEL_18;
  v33 = v38;
  *((_QWORD *)this + 33) = v38;
  if ( (*(_DWORD *)(*(_QWORD *)(v32 + 48) + 40LL) & 0x20000) != 0 )
  {
