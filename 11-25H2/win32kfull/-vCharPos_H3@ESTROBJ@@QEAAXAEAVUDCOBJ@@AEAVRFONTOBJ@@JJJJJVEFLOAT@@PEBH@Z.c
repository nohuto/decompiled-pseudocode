/*
 * XREFs of ?vCharPos_H3@ESTROBJ@@QEAAXAEAVUDCOBJ@@AEAVRFONTOBJ@@JJJJJVEFLOAT@@PEBH@Z @ 0x1400ACAC0
 * Callers:
        ...
        int *a10)
{
  ...
  unsigned __int16 *v66; // [rsp+50h] [rbp-58h]
  struct RFONTOBJ *v67; // [rsp+58h] [rbp-50h]
  int v71; // [rsp+C8h] [rbp+20h] BYREF
  ...
  if ( a7 | a6 )
  {
    ...
    *(_DWORD *)(a1 + 4) = v59;
    if ( v10 )
    {
      *(_QWORD *)&v60 = COERCE_UNSIGNED_INT((float)v10);
      v71 = 0;
      *(float *)&v60 = *(float *)&v60 * *(float *)v58.m128i_i32;
      bFToL(v60, &v71, 0);
      v61 = v71;
      *(_DWORD *)(v15 + 116) = v71;
      if ( v61 > 0 )
    ...
    if ( (unsigned __int8)bCalcBreakExtra((unsigned int)_mm_cvtsi128_si32(v58), v12, a8, v15 + 120) )
    {
      ...
      if ( v63 + v62 + *(_DWORD *)(v15 + 120) < 0 )
        *(_DWORD *)(v15 + 120) = -(v62 + v63);
      v64 = *(_DWORD *)(*(_QWORD *)a3 + 460LL);
...
LABEL_12:
    ...
    if ( v25 )
    {
      ...
      do
      {
        ...
        *((_QWORD *)v26 + 1) = RFONTOBJ::pgdDefault(a3, v16);
        v26 = (struct RFONTOBJ *)((char *)v26 + 24);
        --v48;
      }
      while ( v48 );
...
LABEL_18:
  ...
  {
    v21 = v49 + *(_DWORD *)(*((_QWORD *)v67 + 1) + 12LL);
    v50 = *(_DWORD *)v15 - 1;
    if ( *(_DWORD *)v15 != 1 )
    {
      v51 = v71;
