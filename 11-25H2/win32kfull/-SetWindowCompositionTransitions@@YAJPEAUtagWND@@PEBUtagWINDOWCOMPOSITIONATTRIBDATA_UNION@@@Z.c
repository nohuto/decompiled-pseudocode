/*
 * XREFs of ?SetWindowCompositionTransitions@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1401FE494
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v6[0], 7) == v3 )
    {
      return 0;
    }
    else
    {
      LODWORD(v6[0]) = v6[0] & 0xFFFFFFBF | (v3 << 6);
