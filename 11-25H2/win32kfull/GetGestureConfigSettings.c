/*
 * XREFs of GetGestureConfigSettings @ 0x1401BE040
 * Callers:
 ...
 *     ?FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z @ 0x140216BB8 (-FindGID@@YAHPEAPEAUtagGESTURECONFIGLIST@@I0@Z.c)
 */
      ...
      if ( GCData )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            ...
            {
              *(v23 - 1) = ~*v23 & dword_140356DE0[v24];
            }
            else if ( *((_DWORD *)GCData + 3) )
            {
              *v23 = ~*(v23 - 1) & dword_140356DE0[v24];
            }
            else if ( !v20 )
            {
              break;
