/*
 * XREFs of NtUserMagGetContextInformation @ 0x1401D9680
 * Callers:
 *     <none>
 * Callees:
...
LABEL_65:
  ...
  LensContextInformation = MagGetLensContextInformation(UserSessionState + 66040, v21, v31, (unsigned int)a2, v7, &Size);
