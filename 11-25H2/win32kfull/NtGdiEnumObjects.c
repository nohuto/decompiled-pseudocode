/*
 * XREFs of NtGdiEnumObjects @ 0x140217A90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
      ...
      else
      {
        ...
        if ( v12 )
        {
          if ( v12 == 1 )
          {
            for ( i = (char *)dword_1403638F0; i < v11; i += 4 )
            {
              v22 = 0LL;
              LODWORD(v22) = 0;
              DWORD1(v22) = *(_DWORD *)i;
            ...
            for ( j = (unsigned int *)&unk_1403638D8; j < dword_1403638F0; ++j )
            {
              for ( k = (char *)dword_1403638F0; k < v11; k += 4 )
              {
                v21 = 0LL;
                LODWORD(v21) = 2;
                DWORD1(v21) = *(_DWORD *)k;
        ...
        {
          for ( m = &unk_140363940; m < &dword_140363954; ++m )
          {
            for ( n = (char *)dword_1403638F0; n < v11; n += 4 )
            {
              LODWORD(v23) = *m;
