/*
 * XREFs of NtUserGetClipboardData @ 0x140248F00
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall NtUserGetClipboardData(unsigned int a1, void *a2)
{
  ...
  UserSetLastError(0);
  v6 = PtiCurrent(v5, v4);
  v7 = (const wchar_t *)(*((_QWORD *)v6 + 58) + 976LL);
  v45 = v7;
  ...
  else
  {
    if ( (_InterlockedCompareExchange((volatile signed __int32 *)v6 + 132, 0, 0) & 0x20000000) != 0 )
      v18 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v6 + 58) + 752LL) + 24LL) & 2;
    else
      v18 = 0;
    HasUILimit = v18 != 0;
  }
...
LABEL_9:
  ...
  if ( !*(_DWORD *)(*((_QWORD *)v6 + 58) + 868LL)
    || (unsigned int)InForegroundQueue((__int64 **)v6, 1u) && (a1 == 1 || a1 == 13) )
  {
    ...
    if ( !ClipboardData )
    {
      ...
      if ( v29 > 0 )
        v30 = 1;
      if ( v30 && (unsigned int)dword_14039BBC0 > 5 && tlgKeywordOn((__int64)&dword_14039BBC0, 1LL) )
      {
        v45 = v7;
