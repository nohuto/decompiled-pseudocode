/*
 * XREFs of ?xxxProcessPositionEvent@ShellWindowPos@@YAXPEAUtagQMSG@@@Z @ 0x1402C2E94
 * Callers:
 ...
 *     ShellWindowPos::_anonymous_namespace_::AWPSOptionFromShellRequest @ 0x1402C19D4 (ShellWindowPos--_anonymous_namespace_--AWPSOptionFromShellRequest.c)
      ...
      if ( v8 == 1 )
      {
        ...
        if ( v57 )
        {
          ...
          if ( v24 )
          {
            ...
            {
              LODWORD(v57) = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1405);
            }
            CThreadLockedCurrentMonitorTopologyPtr::~CThreadLockedCurrentMonitorTopologyPtr(
              (CThreadLockedCurrentMonitorTopologyPtr *)v64,
              v43);
