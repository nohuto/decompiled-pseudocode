/*
 * XREFs of ?bStretch@BLTRECORD@@QEAAHAEAVSURFMEM@@K@Z @ 0x140307288
 * Callers:
 ...
 *     ?vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1401B0C90 (-vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 *     ?vAltUnlockFast@SURFACE@@QEAAXXZ @ 0x1401E4DB8 (-vAltUnlockFast@SURFACE@@QEAAXXZ.c)
...
__int64 __fastcall BLTRECORD::bStretch(BLTRECORD *this, struct SURFMEM *a2, ULONG a3)
{
  ...
  v15 = 1;
  v16 = 0LL;
  v6 = *((_DWORD *)this + 35) - *((_DWORD *)this + 33);
  LODWORD(v16) = *((_DWORD *)this + 34) - *((_DWORD *)this + 32);
  HIDWORD(v16) = v6;
  v17 = 0;
  v20 = 0;
  v18 = 0LL;
  ...
  *((_DWORD *)this + 49) &= ~0x20000u;
  v12 = (SURFACE *)*((_QWORD *)this + 8);
  *((_DWORD *)this + 42) = 0;
  *((_DWORD *)this + 43) = 0;
  SURFACE::vAltUnlockFast(v12);
  result = 1LL;
