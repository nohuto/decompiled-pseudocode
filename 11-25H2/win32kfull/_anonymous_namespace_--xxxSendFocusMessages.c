/*
 * XREFs of _anonymous_namespace_::xxxSendFocusMessages @ 0x140278CB0
 * Callers:
...
__int64 __fastcall anonymous_namespace_::xxxSendFocusMessages(__int64 a1, __int64 *a2)
{
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 472) + 412LL) &= ~0x800u;
  if ( !a2 )
  {
    v4 = *(_QWORD *)(a1 + 472);
    if ( *(_QWORD *)(v4 + 128) )
      *(_DWORD *)(v4 + 412) |= 0x800u;
  }
  ...
  if ( a2 )
  {
    v11 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 18888);
    ...
    v15 = *(_DWORD **)(W32GetUserSessionState(v11, v10) + 18888);
    if ( (*(_DWORD **)(a1 + 472) == v15 || (unsigned __int8)IsKeyboardDelegationTarget(a1))
      && a2 == *(__int64 **)(*(_QWORD *)(a1 + 472) + 120LL) )
    {
      v15 = (_DWORD *)*(unsigned int *)(W32GetUserSessionState(v15, v6) + 66808);
      if ( (char)v15 >= 0 )
        xxxApplyGlobalInputSettings();
    }
    if ( v5 )
    {
      if ( *(_QWORD *)(a1 + 472) == *(_QWORD *)(W32GetUserSessionState(v15, v6) + 18888) )
      {
      ...
      v15 = *(_DWORD **)(W32GetUserSessionState(v17, v16) + 19872);
      if ( (*v15 & 4) != 0 )
        xxxFocusSetInputContext((struct tagWND *)v5, 0LL, 0);
    }
    if ( a2 == *(__int64 **)(*(_QWORD *)(a1 + 472) + 120LL) )
    {
      if ( (**(_DWORD **)(W32GetUserSessionState(v15, v6) + 19872) & 4) != 0 )
      ...
      if ( *(_QWORD *)(W32GetUserSessionState(v22, v21) + 18888)
        && (v26 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 18888), *(__int64 **)(v26 + 120) == a2) )
      {
  ...
  {
    if ( *(_QWORD *)(a1 + 472) == *(_QWORD *)(W32GetUserSessionState(v7, v6) + 18888) )
    {
    ...
    v6 = *(_DWORD **)(W32GetUserSessionState(v9, v8) + 19872);
    if ( (*v6 & 4) != 0 )
      xxxFocusSetInputContext((struct tagWND *)v5, 0LL, 0);
  }
