/*
 * XREFs of ?vSaveAccumBoundsAndDisableSpriteUpdates@DWMSCREENREADMODIFYWRITEASSIST@@QEAAXXZ @ 0x14032287C
 * Callers:
    ...
    *((_DWORD *)this + 8) = *(unsigned __int8 *)(*(_QWORD *)(*v5 + 976LL) + 212LL);
    ...
    if ( (*(_DWORD *)(v6 + 152) & 0x1000) != 0 )
    {
      *((_QWORD *)this + 5) = *(_QWORD *)(v6 + 160);
      GreDCSelectBrush(*v5, *(_QWORD *)(*((_QWORD *)v2 + 376) + 40LL));
    }
    else
    {
      *((_QWORD *)this + 5) = GreDCSelectBrush(*v5, *(_QWORD *)(*((_QWORD *)v2 + 376) + 40LL));
    }
