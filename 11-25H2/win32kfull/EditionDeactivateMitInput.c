/*
 * XREFs of EditionDeactivateMitInput @ 0x140247350
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CleanupMitIocpSupport@@YAX_N@Z @ 0x14026DDC8 (-CleanupMitIocpSupport@@YAX_N@Z.c)
 *     ??4?$SGWINEVENTgdwDeferWinEvent@K@@QEAAAEAKAEBK@Z @ 0x14026EBF0 (--4-$SGWINEVENTgdwDeferWinEvent@K@@QEAAAEAKAEBK@Z.c)
  ...
  if ( *(_DWORD *)(W32GetUserSessionState(v1, v0) + 18744) )
  {
    if ( (unsigned int)Feature_EliminateMitRitHandoff2__private_IsEnabledDeviceUsageNoInline() )
    {
      *(_DWORD *)(W32GetUserSessionState(v3, v2) + 18744) = 0;
      ...
      if ( *(_BYTE *)(W32GetUserSessionState(v5, v4) + 19232) )
      {
        UserSessionState = W32GetUserSessionState(v7, v6);
        KeSetEvent(*(PRKEVENT *)(UserSessionState + 19256), 1, 0);
      }
      if ( *(_BYTE *)(W32GetUserSessionState(v7, v6) + 18788) )
      {
        v11 = W32GetUserSessionState(v10, v9);
        KeSetEvent(*(PRKEVENT *)(v11 + 18800), 1, 0);
      }
      v35 = 0;
    ...
    else
    {
      ...
      *(_DWORD *)(W32GetUserSessionState(v13, v2) + 18728) = 1;
      _InterlockedExchange((volatile __int32 *)(W32GetUserSessionState(v20, v19) + 16340), 0);
      MasterInputThreadPrepareForRitTakeover();
      *(_DWORD *)(W32GetUserSessionState(v22, v21) + 18744) = 0;
      if ( *(_BYTE *)(W32GetUserSessionState(v24, v23) + 19232) )
      {
        v27 = W32GetUserSessionState(v26, v25);
        KeSetEvent(*(PRKEVENT *)(v27 + 19256), 1, 0);
      }
      if ( *(_BYTE *)(W32GetUserSessionState(v26, v25) + 18788) )
      {
        v30 = W32GetUserSessionState(v29, v28);
        KeSetEvent(*(PRKEVENT *)(v30 + 18800), 1, 0);
      }
      v35 = 0;
      ...
      *(_DWORD *)(W32GetUserSessionState(v34, v33) + 18728) = 0;
