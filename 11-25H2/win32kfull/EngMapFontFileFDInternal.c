/*
 * XREFs of EngMapFontFileFDInternal @ 0x1400B2070
 * Callers:
 ...
 *     EngMapFontFileFD @ 0x1403046D0 (EngMapFontFileFD.c)
 * Callees:
 ...
 *     ?bMapRoutine@@YAHPEAUFONTFILEVIEW@@PEAUFILEVIEW@@W4_MAP_MODE@@@Z @ 0x1401BD240 (-bMapRoutine@@YAHPEAUFONTFILEVIEW@@PEAUFILEVIEW@@W4_MAP_MODE@@@Z.c)
 *     ?MapViewOfSectionToFontDriverProcess@@YA_NPEAUFILEVIEW@@@Z @ 0x1401C752C (-MapViewOfSectionToFontDriverProcess@@YA_NPEAUFILEVIEW@@@Z.c)
