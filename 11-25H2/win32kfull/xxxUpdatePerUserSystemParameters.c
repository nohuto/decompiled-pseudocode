/*
 * XREFs of xxxUpdatePerUserSystemParameters @ 0x140212E60
 * Callers:
 ...
 *     ?CalcScreenSaverTimeout@@YAXPEAU_UNICODE_STRING@@K@Z @ 0x1401EDB0C (-CalcScreenSaverTimeout@@YAXPEAU_UNICODE_STRING@@K@Z.c)
...
__int64 __fastcall xxxUpdatePerUserSystemParameters(int a1, __int64 a2)
{
  ...
  v5 = 0;
  v194 = 0;
  v6 = *(_DWORD *)(W32GetUserSessionState(v4, v3) + 66800);
  v211 = 0LL;
  v7 = v6 & 0x100000;
  v205 = 0LL;
  v202 = v7;
  ...
  v214 = 4;
  v216 = 112LL;
  v10 = *(_DWORD *)(UserSessionState + 66800) & 0x10000;
  v203 = 0;
  v201 = v10;
  v199 = 1;
  v217 = 4;
  ...
  v336 = 159LL;
  v337 = 3;
  v338 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 19872) + 4996LL;
  v339 = 4;
  v340 = 160LL;
  v341 = 3;
  v16 = *(_QWORD *)(W32GetUserSessionState(v338, v15) + 19872);
  v346 = &v196;
  v342 = v16 + 5000;
  v343 = 4;
  v345 = 0;
  ...
  if ( (v2 & 0x10) != 0 )
  {
    v35 = *(HANDLE *)(W32GetUserSessionState(v32, v31) + 63544);
...
LABEL_31:
  ...
  else
  {
    if ( (v2 & 2) == 0 )
    {
      v52 = *(HANDLE *)(W32GetUserSessionState(v32, v31) + 63544);
...
LABEL_32:
    ...
    if ( *(_QWORD *)(W32GetUserSessionState(v54, v53) + 63520) )
    {
      v57 = *(_QWORD *)(W32GetUserSessionState(v38, v56) + 63520);
      v58 = *(void **)(v57 + 208);
      if ( v58 )
        Win32FreePool(v58);
    ...
    FastGetProfileValue(v55, 4LL, 607LL, &v190, v64 + 64200, 4, v63);
    if ( *(int *)(W32GetUserSessionState(v66, v65) + 64200) > 0 )
    {
      v72 = 1000;
      if ( *(int *)(W32GetUserSessionState(v68, v67) + 64200) < 1000 )
        v72 = *(_DWORD *)(W32GetUserSessionState(v74, v73) + 64200);
    ...
    *(_DWORD *)(v69 + 64200) = v72;
    v75 = W32GetUserSessionState(v71, v70);
    v78 = v75;
    if ( v34 )
    {
      if ( !*(_DWORD *)(v75 + 66264) && !(unsigned int)UserRemoteConnectedSessionUsingWddm() )
      {
        v189 = &v195;
        LODWORD(v188) = v63;
    ...
    CInputGlobals::UpdateWakeOnInputDeviceTypesFromRegistry(*(CInputGlobals **)(v83 + 3056));
    ...
    if ( !v33 )
    {
      ...
      ZwQueryDefaultUILanguage((LANGID *)(*(_QWORD *)(v89 + 19872) + 7012LL));
      xxxLoadSomeStrings(v91, v90);
      if ( *(_QWORD *)(W32GetUserSessionState(v93, v92) + 63520) )
      {
        SmartObjStackRef<tagMENU>::SmartObjStackRef<tagMENU>(v207, v94);
        for ( i = *(_QWORD **)(*(_QWORD *)(W32GetUserSessionState(v97, v96) + 63520) + 16LL); i; i = (_QWORD *)i[4] )
        {
          v100 = i[7];
          if ( v100 )
          {
      ...
      CCursorSizes::zzzRefreshSizes(*(CCursorSizes **)(v103 + 36344));
    ...
    if ( v200 )
    {
      v116 = *(volatile signed __int32 **)(W32GetUserSessionState(v114, v113) + 19872);
    ...
    if ( v201 )
    {
      ...
      *(_DWORD *)(v117 + 66800) |= 0x10000u;
    }
    else
    {
      v120 = W32GetUserSessionState(v116, v115);
      *(_DWORD *)(v120 + 66800) &= ~0x10000u;
    }
    if ( v202 == 2 )
    {
      v121 = W32GetUserSessionState(v119, v118);
      if ( (unsigned int)GreGetDeviceCaps(*(_QWORD *)(*(_QWORD *)(v121 + 56968) + 64LL), 119LL) )
      {
        v127 = W32GetUserSessionState(v123, v122);
        *(_DWORD *)(v127 + 66800) &= ~0x100000u;
      }
      else
      {
        v124 = W32GetUserSessionState(v123, v122);
        *(_DWORD *)(v124 + 66800) |= 0x100000u;
      }
      if ( v34 )
      {
        v128 = W32GetUserSessionState(v126, v125);
        RtlStringCchPrintfW(v363, 40LL, L"%d", (*(_DWORD *)(v128 + 66800) >> 20) & 1);
    ...
    else if ( v202 )
    {
      ...
      *(_DWORD *)(v129 + 66800) |= 0x100000u;
    }
    else
    {
      v130 = W32GetUserSessionState(v119, v118);
      *(_DWORD *)(v130 + 66800) &= ~0x100000u;
    }
    v190 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v126, v125) + 19872) + 4984LL);
    ...
    if ( v164 )
    {
      *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v163, v162) + 19872) + 2148LL) = 1;
      ZwClose(v164);
    }
    v165 = *(_QWORD *)(W32GetUserSessionState(v163, v162) + 19872);
    *(_DWORD *)(v165 + 2148) |= 2u;
    ...
    *(_DWORD *)(*(_QWORD *)(W32GetSessionState(v170, v169) + 96) + 13456LL) = v171;
    ...
    v175 = *(_DWORD *)(W32GetUserSessionState(v174, v173) + 66808) & 0x400;
    ...
    *(_DWORD *)(v179 + 24320) = v175;
    ...
    if ( v203 )
      *(_DWORD *)(W32GetUserSessionState(v181, v180) + 18852) = 1;
    if ( v34 )
    {
    ...
    if ( *(_DWORD *)(W32GetUserSessionState(v181, v180) + 62936) == 1 )
    {
      v197 = 0;
      *(_DWORD *)(W32GetUserSessionState(v183, v182) + 62936) = 0;
    ...
    if ( v34 )
    {
      ...
      _InterlockedOr(*(volatile signed __int32 **)(W32GetUserSessionState(v187, v186) + 19872), 0x400u);
    }
  }
  if ( v206 != -1 )
