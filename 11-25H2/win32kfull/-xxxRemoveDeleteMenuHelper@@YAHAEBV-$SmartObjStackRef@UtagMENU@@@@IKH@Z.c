/*
 * XREFs of ?xxxRemoveDeleteMenuHelper@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@IKH@Z @ 0x140046AC4
 * Callers:
 ...
 *     MNGetpItemIndex @ 0x1401AA82C (MNGetpItemIndex.c)
 *     ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1402E2310 (-MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V-$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z.c)
...
__int64 __fastcall xxxRemoveDeleteMenuHelper(__int64 **a1, unsigned int a2, __int16 a3, unsigned int a4)
{
  ...
  *((_QWORD *)v10 + 209) = &v36;
  ...
  {
    v39 = v41;
    SmartObjStackRefBase<tagMENU>::operator=(v38, *(_QWORD *)v40[0]);
    v29 = v39;
    if ( v39 )
    {
      v30 = v39;
