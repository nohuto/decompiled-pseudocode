/*
 * XREFs of EnableFlushTimer @ 0x1402F2A8C
 * Callers:
 *     InsertEventEntryInLookUpTable @ 0x14002BC8C (InsertEventEntryInLookUpTable.c)
 *     ?TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1402F2AF0 (-TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
