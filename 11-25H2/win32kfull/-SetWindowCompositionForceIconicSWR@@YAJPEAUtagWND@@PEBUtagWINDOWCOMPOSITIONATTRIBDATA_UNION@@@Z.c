/*
 * XREFs of ?SetWindowCompositionForceIconicSWR@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x140208248
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v6[0], 4) == v3 )
    {
      return 0;
    }
    else
    {
      LODWORD(v6[0]) = v6[0] & 0xFFFFFFF7 | (8 * v3);
