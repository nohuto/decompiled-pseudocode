/*
 * XREFs of xxxSetModernAppWindow @ 0x140254280
 * Callers:
...
__int64 __fastcall xxxSetModernAppWindow(struct tagWND *a1, __int64 a2)
{
  ...
  if ( (struct tagTHREADINFO *)v2 == PtiCurrent((__int64)a1, a2) )
  {
    ...
    {
LABEL_17:
      if ( *(_QWORD *)(W32GetUserSessionState(v10, v9) + 18888)
        && v7
        && (v14 = *(_QWORD *)(W32GetUserSessionState(v14, v13) + 18888), v15 = *(_QWORD *)(v2 + 472), v14 == v15)
        && (v16 = *(_QWORD *)(v7 + 16), *(_QWORD *)(v16 + 472) == v15)
        && *(_QWORD *)(W32GetUserSessionState(v14, v13) + 18904) == v16 )
      {
        v38 = 1;
      }
      else if ( *(_QWORD *)(W32GetUserSessionState(v14, v13) + 18888) != *(_QWORD *)(v2 + 472) )
      {
        v17 = 1;
            ...
            if ( *(struct tagWND **)(v7 + 104) == a1 )
            {
              ...
              if ( *(_QWORD *)(v18 + 472) == *(_QWORD *)(v2 + 472) )
              {
                ...
                LockQCursor(
                  ...
                  *(struct tagCURSOR **)(UserSessionState + 21880));
                if ( v38 )
                {
                  v27 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 18904);
                  if ( v27 == *(_QWORD *)(v7 + 16) )
                  {
                    v29 = *(_QWORD *)(W32GetUserSessionState(v27, v26) + 18888);
                    if ( *(_QWORD *)(v2 + 472) == v29 )
                    {
                      if ( *(_QWORD *)(v2 + 480) != *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v29, v28) + 18904)
                                                              + 480LL) )
                        AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)&v33);
