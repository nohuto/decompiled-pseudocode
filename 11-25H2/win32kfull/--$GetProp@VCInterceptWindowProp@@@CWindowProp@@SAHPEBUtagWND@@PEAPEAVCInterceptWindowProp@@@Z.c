/*
 * XREFs of ??$GetProp@VCInterceptWindowProp@@@CWindowProp@@SAHPEBUtagWND@@PEAPEAVCInterceptWindowProp@@@Z @ 0x1402CA8E8
 * Callers:
...
_BOOL8 __fastcall CWindowProp::GetProp<CInterceptWindowProp>(__int64 a1, __int64 *a2)
{
  ...
  Prop = GetProp(a1, *(unsigned __int16 *)(UserSessionState + 42264), 1u);
  *a2 = Prop;
  return Prop != 0;
}
