/*
 * XREFs of ?DeferNotifyDelegateCapture@@YAHPEAUtagTHREADINPUTPOINTERLIST@@GKPEAUtagWND@@@Z @ 0x14013863C
 * Callers:
...
__int64 __fastcall DeferNotifyDelegateCapture(struct _LIST_ENTRY *a1, unsigned __int16 a2, int a3, struct tagWND *a4)
{
  ...
  if ( a3 != CTouchProcessor::GetPointerDownFrame(*(CTouchProcessor **)(v15 + 3256), *((_QWORD *)ThreadPointerData + 3)) )
    return 0LL;
