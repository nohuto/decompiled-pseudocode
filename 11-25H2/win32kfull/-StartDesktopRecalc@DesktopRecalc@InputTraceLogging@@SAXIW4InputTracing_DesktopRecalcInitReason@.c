/*
 * XREFs of ?StartDesktopRecalc@DesktopRecalc@InputTraceLogging@@SAXIW4InputTracing_DesktopRecalcInitReason@@@Z @ 0x140028ADC
 * Callers:
...
void InputTraceLogging::DesktopRecalc::StartDesktopRecalc()
{
  ...
  if ( (unsigned int)dword_14039BB50 > 4 && (unsigned __int8)tlgKeywordOn(&dword_14039BB50, 0x80000LL) )
  {
    if ( (_DWORD)v1 )
    {
      if ( (_DWORD)v1 == 1 )
