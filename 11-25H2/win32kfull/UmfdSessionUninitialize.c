/*
 * XREFs of UmfdSessionUninitialize @ 0x14010B400
 * Callers:
 *     <none>
 * Callees:
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x14010B4B8 (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
 *     ?UmfdCallSessionUninitialize@@YAXXZ @ 0x14010B560 (-UmfdCallSessionUninitialize@@YAXXZ.c)
 *     ?Uninitialize@UmfdReliabilityManager@@YAXXZ @ 0x14010B5BC (-Uninitialize@UmfdReliabilityManager@@YAXXZ.c)
