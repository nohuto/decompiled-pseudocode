/*
 * XREFs of ?xxxApplyActionOld@WindowActions@@YAKPEAUtagWND@@_NPEAU_WINDOW_ACTION@@@Z @ 0x1402CE998
 * Callers:
 ...
 *     ?RestorePendingDisplayChangeInfoOld@CInterceptWindowProp@@SAXPEAUtagWND@@PEAUWindowAction@AdvancedWindowPos@@@Z @ 0x1402CC6C8 (-RestorePendingDisplayChangeInfoOld@CInterceptWindowProp@@SAXPEAUtagWND@@PEAUWindowAction@Advanc.c)
        ...
        struct _WINDOW_ACTION *a4)
{
  ...
  _BYTE v37[44]; // [rsp+11Ch] [rbp+1Ch] BYREF
  unsigned int *v38; // [rsp+148h] [rbp+48h]
...
LABEL_40:
  ...
  {
    LODWORD(v32) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3896);
  }
  return 5023LL;
}
