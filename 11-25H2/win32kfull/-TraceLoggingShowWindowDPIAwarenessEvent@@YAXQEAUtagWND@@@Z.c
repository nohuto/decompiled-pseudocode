/*
 * XREFs of ?TraceLoggingShowWindowDPIAwarenessEvent@@YAXQEAUtagWND@@@Z @ 0x1401CBF08
 * Callers:
...
void __fastcall TraceLoggingShowWindowDPIAwarenessEvent(struct tagWND *const a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872) + 2236LL) & 0x20) == 0 )
  {
    ...
    if ( (v3 & 0xF) == 2 )
    {
      ...
      v6 = *(_QWORD *)(CurrentProcessWin32Process + 320);
      while ( v6 )
      {
