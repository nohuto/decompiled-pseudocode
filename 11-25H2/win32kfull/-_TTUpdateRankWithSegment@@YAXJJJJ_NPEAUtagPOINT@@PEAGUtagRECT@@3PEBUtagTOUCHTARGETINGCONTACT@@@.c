/*
 * XREFs of ?_TTUpdateRankWithSegment@@YAXJJJJ_NPEAUtagPOINT@@PEAGUtagRECT@@3PEBUtagTOUCHTARGETINGCONTACT@@@Z @ 0x1402F3288
 * Callers:
 *     TouchTargetingRankForRect @ 0x1401C0930 (TouchTargetingRankForRect.c)
 * Callees:
 *     TouchTargetingRank @ 0x14022F234 (TouchTargetingRank.c)
 *     TouchTargetingIntersectSegment @ 0x1402F35A8 (TouchTargetingIntersectSegment.c)
...
LABEL_78:
    ...
    if ( *a7 == 4094 || v11 != *a6 )
    {
      ...
      v37 = TouchTargetingRank(*((_QWORD *)a10 + 4), v11, &v42, (__int64)v44);
      if ( v35 == 4094 || v37 < v35 )
      {
        *a6 = (struct tagPOINT)v11;
        *a7 = v37;
      }
    }
    return;
