/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@AEAVUDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1400BA178
 * Callers:
 ...
 *     ?bParityViolatingXform@@YAHAEBVUDCOBJ@@@Z @ 0x1401F5B7C (-bParityViolatingXform@@YAHAEBVUDCOBJ@@@Z.c)
        ...
        int a7)
{
    ...
    if ( (v12 & 0x3000010) == 0 )
    {
            ...
            v25) )
      {
        ...
        if ( !v30 )
        {
          ...
          a1->eXX = 0.0;
          a1->eYY = 0.0;
          LODWORD(a1->eYX) = dword_1403644E8[x];
          LODWORD(a1->eXY) = dword_1403644E8[a6->y];
          return 1LL;
        }
        v31 = v30 - 1;
        if ( v31 )
        {
          if ( v31 == 1 )
          {
            ...
            a1->eXX = 0.0;
            a1->eYY = 0.0;
            LODWORD(a1->eXY) = dword_140364510[y];
            LODWORD(a1->eYX) = dword_140364510[a6->x];
          }
          return 1LL;
        }
        v34 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_1403644E8[v34];
        v27 = dword_140364510[a6->y];
      }
      else
      {
        v26 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_140364510[v26];
        v27 = dword_1403644E8[a6->y];
      }
      LODWORD(a1->eYY) = v27;
      return 1LL;
    }
  ...
  if ( (v17 & 4) == 0 )
  {
    ...
    if ( v21 != v23 )
    {
      ...
      v47 = v39;
      v45 = v38;
      if ( EFLOAT::bIsZero((EFLOAT *)((char *)&v45 + 4)) && EFLOAT::bIsZero((EFLOAT *)((char *)&v45 + 8)) )
      {
