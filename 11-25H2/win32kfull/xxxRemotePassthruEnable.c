/*
 * XREFs of xxxRemotePassthruEnable @ 0x1402B95D8
 * Callers:
 *     NtUserRemotePassthruEnable @ 0x14029D380 (NtUserRemotePassthruEnable.c)
 * Callees:
...
__int64 xxxRemotePassthruEnable()
{
  ...
  if ( PsGetCurrentProcess(v11) != v10 )
    return 3221225506LL;
  *(_DWORD *)(UserSessionState + 69052) = *(_QWORD *)(W32GetUserSessionState(v13, v12) + 13976) != gapulCvt_VK_84;
  ZwDeviceIoControlFile(
    *(HANDLE *)(UserSessionState + 68656),
    0LL,
    0LL,
    0LL,
    &IoStatusBlock,
    0x38080Fu,
    (PVOID)(UserSessionState + 69052),
    4u,
    0LL,
    0);
  ...
  if ( *(_DWORD *)(UserSessionState + 68764) )
    bDrvDisconnect(
      *(_QWORD *)(UserSessionState + 68808),
      *(_QWORD *)(UserSessionState + 68800),
      *(_QWORD *)(UserSessionState + 68832));
  else
