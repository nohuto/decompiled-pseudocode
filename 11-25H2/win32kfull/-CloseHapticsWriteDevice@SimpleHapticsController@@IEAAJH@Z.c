/*
 * XREFs of ?CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z @ 0x1402F0630
 * Callers:
...
__int64 __fastcall SimpleHapticsController::CloseHapticsWriteDevice(SimpleHapticsController *this, int a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 && (unsigned int)dword_14039BC30 > 2 )
    {
      v16 = v6;
      v15 = "Function failed.";
    ...
    v2 = v9;
    if ( v9 < 0 && (unsigned int)dword_14039BC30 > 2 )
    {
      v16 = v9;
      v15 = "Function failed.";
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
