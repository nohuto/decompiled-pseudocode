/*
 * XREFs of GetDpiSettingWithNoDefault @ 0x1402F3AF0
 * Callers:
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x140285204 (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 *     GetDpiSetting @ 0x1402F3AD0 (GetDpiSetting.c)
 * Callees:
