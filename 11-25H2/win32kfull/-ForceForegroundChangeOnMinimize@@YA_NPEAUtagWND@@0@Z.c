/*
 * XREFs of ?ForceForegroundChangeOnMinimize@@YA_NPEAUtagWND@@0@Z @ 0x1402DEF64
 * Callers:
...
bool __fastcall ForceForegroundChangeOnMinimize(struct tagWND *a1, struct tagWND *a2)
{
  ...
  result = (*(_DWORD *)(v2 + 1360) & 0x40000LL) != 0
        ...
        && (v7 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 18888), v8 = *(_QWORD *)(v2 + 472), v8 == v7)
        && *(struct tagWND **)(v8 + 128) == a1
        && *(_QWORD *)(v2 + 1592)
        && (v9 = *(_QWORD *)(W32GetUserSessionState(v6, v5) + 18904), *(_QWORD *)(*(_QWORD *)(v2 + 1592) + 16LL) == v9)
        && (v11 = *(_QWORD *)(W32GetUserSessionState(v10, v9) + 18888), *(_QWORD *)(*((_QWORD *)a2 + 2) + 472LL) != v11)
