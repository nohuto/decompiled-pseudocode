/*
 * XREFs of ?bModifyWorldTransform@XDCOBJ@@QEAAHPEBU_XFORML@@K@Z @ 0x14017C6E8
 * Callers:
 *     NtGdiModifyWorldTransform @ 0x14017C610 (NtGdiModifyWorldTransform.c)
 * Callees:
 *     ?bWorldXformIdentity@@YAHPEBU_XFORML@@@Z @ 0x14017C9BC (-bWorldXformIdentity@@YAHPEBU_XFORML@@@Z.c)
...
LABEL_6:
      ...
      {
        *(_OWORD *)(v8 + 392) = xmmword_1403559D0;
        *(_OWORD *)(v8 + 408) = xmmword_1403559E0;
        v9 = *(_QWORD *)(*(_QWORD *)this + 976LL);
        *(_OWORD *)(v9 + 356) = xmmword_1403559D0;
        *(_OWORD *)(v9 + 372) = xmmword_1403559E0;
...
LABEL_26:
          if ( (unsigned int)bWorldMatrixInRange((struct MATRIX *)&Buf1) )
          {
            ...
            *(_OWORD *)(v16 + 372) = v25;
            v17 = *(_QWORD *)this;
            v18 = memcmp(&Buf1, &xmmword_1403559D0, 0x20uLL) == 0;
            v19 = *(_QWORD *)(v17 + 976);
            if ( v18 )
            {
