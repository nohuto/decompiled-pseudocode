/*
 * XREFs of _UnregisterDManipHook @ 0x1402872E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UnregisterDManipHook(__int64 a1, __int64 a2)
{
  ...
  v2 = W32GetUserSessionState(a1, a2) + 64184;
  ...
  if ( CurrentProcessWin32Process == *(_QWORD *)v2 )
  {
    *(_QWORD *)v2 = 0LL;
    ...
    _InterlockedAnd(*(volatile signed __int32 **)(W32GetUserSessionState(v7, v5) + 19872), 0xFFFFFFEF);
    return 1LL;
  }
  else
  {
