/*
 * XREFs of ?OnDwmWindowNotificationClientRegistered@@YAJH@Z @ 0x1402B4C40
 * Callers:
...
__int64 __fastcall OnDwmWindowNotificationClientRegistered(__int64 a1, __int64 a2)
{
  ...
  if ( (_DWORD)a1 )
  {
    v2 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19144);
    *(_DWORD *)(v2 + 48) |= 0x400u;
    if ( *(_QWORD *)(W32GetUserSessionState(v2, v3) + 18888) )
    {
      v5 = *(_QWORD *)(W32GetUserSessionState(v5, v4) + 18888);
      if ( *(_QWORD *)(v5 + 128) )
      {
        UserSessionState = W32GetUserSessionState(v5, v4);
        v8 = (void *)ReferenceDwmApiPort(*(_QWORD *)(UserSessionState + 18888), v7);
        DwmAsyncNotifyForegroundChange(v8);
      }
    }
    v10 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v5, v4) + 19144) + 8LL) + 24LL);
  ...
  else
  {
    ...
    *(_DWORD *)(*(_QWORD *)(v23 + 19144) + 48LL) &= ~0x400u;
  }
  return 0LL;
}
