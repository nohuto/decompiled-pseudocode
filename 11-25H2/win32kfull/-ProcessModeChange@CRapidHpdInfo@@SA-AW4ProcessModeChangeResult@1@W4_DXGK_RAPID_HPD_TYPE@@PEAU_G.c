/*
 * XREFs of ?ProcessModeChange@CRapidHpdInfo@@SA?AW4ProcessModeChangeResult@1@W4_DXGK_RAPID_HPD_TYPE@@PEAU_GUID@@PEAVCMonitorTopology@@@Z @ 0x1402EC9CC
 * Callers:
...
__int64 __fastcall CRapidHpdInfo::ProcessModeChange(__int64 a1, const struct _GUID *a2, struct CMonitorTopology *a3)
{
  ...
  v8 = 0LL;
  v9 = UserSessionState + 71240;
  if ( !*(_BYTE *)(UserSessionState + 71256) )
  {
    FastGetProfileDword(0LL, 2LL, L"RapidHpdTimeoutMs", 5000LL, UserSessionState + 71240);
    *(_BYTE *)(v9 + 16) = 1;
  }
  if ( !v5 )
    return 0LL;
