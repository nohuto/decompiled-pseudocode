/*
 * XREFs of ?xxxProcessPointerInputAsMouse@PointerPromotion@@YAXAEBUtagPOINTER_INFO@@GG@Z @ 0x1401398E8
 * Callers:
 *     EditionProcessPointerInputAsMouse @ 0x1401398D0 (EditionProcessPointerInputAsMouse.c)
 * Callees:
 ...
 *     ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x140139C78 (-CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z.c)
 ...
 *     ?HandleLossOfPrimary@@YAHAEAUtagPOINTER_INFO@@@Z @ 0x14026EDB4 (-HandleLossOfPrimary@@YAHAEAUtagPOINTER_INFO@@@Z.c)
