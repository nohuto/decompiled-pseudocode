/*
 * XREFs of ?GrepCreateDIBitmapReal@@YAPEAUHBITMAP__@@AEAVOPTAPIDCOBJ@@KAEAV?$umptr_r@E@@PEAUtagBITMAPINFO@@KIPEAXK3K_KPEAPEAX@Z @ 0x14007C874
 * Callers:
        ...
        _QWORD *a12)
{
  ...
  if ( v20 )
  {
    ...
    if ( v20 != 10 || !OPTAPIDCOBJ::bValid(a1) )
      goto LABEL_122;
    APIDCOBJ::APIDCOBJ((APIDCOBJ *)v75, a1);
...
LABEL_45:
  ...
  *(_QWORD *)&v68[4] = *(_QWORD *)v63;
  ...
  else if ( *((_QWORD *)a1 + 13) && OPTAPIDCOBJ::bValid(a1) )
  {
    APIDCOBJ::APIDCOBJ((APIDCOBJ *)v75, a1);
    ...
    if ( v43 <= 0xFFFFFFFF && v35 >= v43 )
    {
      if ( OPTAPIDCOBJ::bValid(a1) )
      {
        ...
        if ( v44 )
        {
          ...
          FreeTmpBuffer(v45);
          GreReleaseSemaphoreCommon<1,void (*)(HSEMAPHORE__ *)>(GreReleaseSemaphoreSharedInternal, v59);
          APIDCOBJ::~APIDCOBJ((APIDCOBJ *)v75);
          goto LABEL_68;
        }
...
LABEL_39:
  ...
  *(_DWORD *)(v31 + 112) |= 0x4000000u;
  v61 |= 1u;
  v64 = 1;
  if ( (a10 & 0x10) != 0 && OPTAPIDCOBJ::bValid(a1) )
  {
    APIDCOBJ::APIDCOBJ((APIDCOBJ *)v75, a1);
