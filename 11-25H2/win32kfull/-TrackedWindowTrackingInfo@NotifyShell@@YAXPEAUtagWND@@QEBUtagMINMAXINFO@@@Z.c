/*
 * XREFs of ?TrackedWindowTrackingInfo@NotifyShell@@YAXPEAUtagWND@@QEBUtagMINMAXINFO@@@Z @ 0x1402C2A9C
 * Callers:
        ...
        const struct tagMINMAXINFO *const a3)
{
  ...
  v7 = *(_QWORD *)this;
  v8 = 1;
  ((void (__fastcall *)(NotifyShell *, __int64 *, __int64 *, _QWORD))ShellWindowManagement::TransformWindowTrackInfo)(
    this,
    &v5,
    &v6,
    0LL);
  ...
  anonymous_namespace_::NotifyIAMWindowManagementEvent((__int64)&v7, 0);
}
