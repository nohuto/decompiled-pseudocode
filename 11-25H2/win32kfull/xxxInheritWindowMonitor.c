/*
 * XREFs of xxxInheritWindowMonitor @ 0x140064724
 * Callers:
...
__int64 __fastcall xxxInheritWindowMonitor(struct tagWND *a1, struct tagWND *a2, int a3)
{
  ...
  v7 = ValidateHmonitorNoRip(*(_QWORD *)(v4 + 256), a2);
  ...
  if ( a3 )
  {
    if ( a2 )
    {
      ...
      v49 = InternalSetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 41362), v42, 1u);
    }
    else
    {
      v44 = W32GetUserSessionState(v9, v8);
      InternalRemoveProp((__int64)a1, *(unsigned __int16 *)(v44 + 41362), 1u);
    }
  }
  v51 = 0LL;
  v12 = 0LL;
  ...
  if ( !v12
    ...
    || (NewMonitor = ValidateHmonitorNoRip(*(_QWORD *)(*((_QWORD *)v12 + 5) + 256LL), v12)) == 0 )
  {
  ...
  if ( v20 )
  {
    v25 = *(_QWORD *)(W32GetUserSessionState(v22, v21) + 63440);
    if ( v25 )
    {
      *(_QWORD *)(W32GetUserSessionState(v24, v23) + 63440) = 0LL;
    }
    else
    {
    ...
    *(_QWORD *)(v25 + 8) = v25 + 32;
    ...
    else
    {
      ...
      *((_QWORD *)v28 + 3) = PtiCurrent(v31, v30);
      v34 = *(_QWORD *)(W32GetUserSessionState(v33, v32) + 63248);
      *(_QWORD *)v28 = v34;
      *(_QWORD *)(W32GetUserSessionState(v34, v35) + 63248) = v28;
