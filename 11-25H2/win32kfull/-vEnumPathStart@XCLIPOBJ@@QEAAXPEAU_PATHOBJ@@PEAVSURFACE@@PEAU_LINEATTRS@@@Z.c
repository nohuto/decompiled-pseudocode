/*
 * XREFs of ?vEnumPathStart@XCLIPOBJ@@QEAAXPEAU_PATHOBJ@@PEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1401CDB68
 * Callers:
        ...
        struct _LINEATTRS *a4)
{
  ...
  *(_DWORD *)(*((_QWORD *)this + 18) + 200LL) = 1;
  ...
  else if ( a4->pstyle )
  {
    ...
    if ( v8 )
    {
      *(_DWORD *)(v9 + 192) = v8[549];
      *(_DWORD *)(*((_QWORD *)this + 18) + 196LL) = v8[550];
      *(_DWORD *)(*((_QWORD *)this + 18) + 200LL) = v8[551];
    }
    else
    {
      *(_DWORD *)(v9 + 200) = 3;
