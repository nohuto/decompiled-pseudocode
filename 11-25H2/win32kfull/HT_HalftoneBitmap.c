/*
 * XREFs of HT_HalftoneBitmap @ 0x14013D908
 * Callers:
 *     EngHTBlt @ 0x14006F20C (EngHTBlt.c)
 * Callees:
 *     AAHalftoneBitmap @ 0x14013B328 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x14013DCBC (pDCIAdjClr.c)
 *     SanityCheckDimension @ 0x1401BA2F8 (SanityCheckDimension.c)
 *     CheckABInfo @ 0x14026E668 (CheckABInfo.c)
 */
