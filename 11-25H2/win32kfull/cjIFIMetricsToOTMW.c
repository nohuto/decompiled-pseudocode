/*
 * XREFs of cjIFIMetricsToOTMW @ 0x1400BB8C0
 * Callers:
        ...
        int a6)
{
  ...
  int v213[3]; // [rsp+24h] [rbp-84h] BYREF
  ...
  if ( !v13 )
  {
    ...
    if ( v198 <= 0 || *(_DWORD *)(v11 + 136) )
    {
      v212 = 0.0;
      vArctan(
        _mm_cvtsi128_si32((__m128i)COERCE_UNSIGNED_INT((float)v198)),
        _mm_cvtsi128_si32((__m128i)COERCE_UNSIGNED_INT((float)-*(_DWORD *)(v11 + 136))),
        &v212,
        v213);
