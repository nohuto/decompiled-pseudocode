/*
 * XREFs of _anonymous_namespace_::NotifyPartEnter @ 0x140259630
 * Callers:
...
__int64 __fastcall anonymous_namespace_::NotifyPartEnter(__int64 a1, unsigned __int16 a2, _WORD *a3)
{
  ...
  if ( result )
  {
    v10 = *(_QWORD *)(W32GetUserSessionState(v8, v7) + 19872);
    v13 = *(unsigned __int16 *)(v10 + 4960) | (*(unsigned __int16 *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 19872)
                                                                   + 4964LL) << 16);
    v14 = *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 472LL) + 260LL);
    v15 = v14 & 1;
    LOWORD(v15) = 4 * v15;
    ...
    if ( (v14 & 4) == 0 )
      v17 = v16;
    v18 = v17 | 0x8000;
    if ( *(_QWORD *)(W32GetUserSessionState(v15, v16) + 18888)
      && *(const struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(v20, v19) + 18888) + 128LL) == v9 )
    {
      v18 |= 0x200u;
    }
