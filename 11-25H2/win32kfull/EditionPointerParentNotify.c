/*
 * XREFs of EditionPointerParentNotify @ 0x140136C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EditionPointerParentNotify(__int64 a1, void *a2, int a3)
{
  __int64 v3; // rbx
  __int64 result; // rax
  __int64 v7; // rdx
    ...
    if ( (*(_BYTE *)(result + 24) & 4) == 0 )
    {
      ...
      *((_QWORD *)v9 + 57) = BugCheckParameter3;
      ...
      do
      {
        ...
        xxxSendPointerMessageWorker(v3, 528, a3, 0, 0LL, 689);
