/*
 * XREFs of ?_TTUpdateBestTarget@@YAXPEAUtagPNTRWINDOWHITTTESTARGS@@PEAUtagWND@@IPEBUtagPOINT@@PEAUtagRECT@@HU4@K@Z @ 0x1402A4D34
 * Callers:
        ...
        __int16 a8)
{
  ...
  *((_DWORD *)a1 + 44) = v14;
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2236);
  }
  if ( *((_DWORD *)a1 + 21) )
  {
