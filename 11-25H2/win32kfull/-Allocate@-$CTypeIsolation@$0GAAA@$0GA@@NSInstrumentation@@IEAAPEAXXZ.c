/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0GAAA@$0GA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1402086BC
 * Callers:
...
PVOID __fastcall NSInstrumentation::CTypeIsolation<24576,96>::Allocate(__int64 *a1)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v5 = NSInstrumentation::CSectionEntry<24576,96>::Create();
      v6 = (_QWORD *)v5;
      if ( v5 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<24576,96>::Allocate(*(_QWORD *)(v5 + 32));
        if ( v2 )
        {
