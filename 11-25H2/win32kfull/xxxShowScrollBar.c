/*
 * XREFs of xxxShowScrollBar @ 0x1401D4208
 * Callers:
...
__int64 __fastcall xxxShowScrollBar(struct tagWND *a1, __int64 a2, int a3)
{
  ...
  if ( v10 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    ...
    GetScrollbarTypeString(v7, v12, v13, *(_QWORD *)(UserSessionState + 69160));
    LOBYTE(v14) = v10;
    LOBYTE(v15) = v29;
    v4 = a3;
  ...
  if ( v7 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( !v19 )
      {
        ...
        LOBYTE(v3) = v4 != 0;
        xxxShowWindowEx(a1, v3 | *(_DWORD *)(v20 + 66800) & 0x10000u, v3 & 0x10000 | *(_DWORD *)(v20 + 66800) & 0x10000);
        return 1LL;
      }
      if ( v19 == 1 )
        v6 = 3145728;
