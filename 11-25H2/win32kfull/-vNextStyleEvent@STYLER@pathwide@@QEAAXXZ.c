/*
 * XREFs of ?vNextStyleEvent@STYLER@pathwide@@QEAAXXZ @ 0x1400A5EEC
 * Callers:
 ...
 *     ?ptfxFraction@pathwide@@YA?AU_POINTFIX@@U2@PEAVLINEDATA@1@AEAVEFLOAT@@2@Z @ 0x1400A649C (-ptfxFraction@pathwide@@YA-AU_POINTFIX@@U2@PEAVLINEDATA@1@AEAVEFLOAT@@2@Z.c)
...
void __fastcall pathwide::STYLER::vNextStyleEvent(pathwide::STYLER *this)
{
    ...
    if ( *v3 == 5 )
    {
      ...
      while ( 1 )
      {
        ...
        *((_DWORD *)this + 188) = FP_0_0;
        v39 = *(_DWORD *)pathwide::STYLER::efWorldLength(this, &v46, *(_QWORD *)(v38 + 40));
  ...
  v42 = *((_QWORD *)this + 89);
  *((_DWORD *)this + 188) = FP_0_0;
  v43 = *(_DWORD *)pathwide::STYLER::efWorldLength(this, &v46, *(_QWORD *)(v42 + 40));
