/*
 * XREFs of ?xxxTrackInitSize@@YAHPEAUtagWND@@I_K_JPEAUMOVESIZEDATA@@@Z @ 0x14022F508
 * Callers:
  ...
  if ( v7 == 512 )
  {
    if ( a3 != 1 )
    {
      ...
      else
      {
        ...
        zzzSetCursor(*(struct tagCURSOR **)(v63 + 26848), v64);
      }
      return 1LL;
    }
LABEL_44:
    ...
    else if ( (unsigned int)(v16 - 10) <= 7 )
    {
      xxxSendMessage((struct tagWND *)a1, 0x20u);
      *((_DWORD *)a5 + 50) &= ~1u;
      v50 = dword_14035C75C[v16];
      v51 = *(_DWORD *)&aRight[4 * v16];
      *((_DWORD *)a5 + 46) = v51;
      *((_DWORD *)a5 + 45) = v50;
      v52 = v51 + v50;
      *((_DWORD *)a5 + 44) = v51 + v50;
      v53 = dword_14035C7C0[v51 + v50];
      v54 = *((_DWORD *)a5 + dword_14035C7F0[v52] + 30) - v21;
      *((_DWORD *)a5 + 42) = v54;
...
LABEL_28:
  ...
  bSetDevDragRect(*(Gre::Base **)(*(_QWORD *)(v34 + 56968) + 48LL), 0LL, 0LL, 0);
  ...
  *((_DWORD *)a5 + 50) &= ~1u;
  ...
  CCursorClip::ClearClip(*(CCursorClip **)(v37 + 36240));
