/*
 * XREFs of ?CopyFontFilesIntoPoolMem@UmfdHostLifeTimeManager@@SAPEAPEAXPEAPEAUFONTFILEVIEW@@KPEAK@Z @ 0x14033839C
 * Callers:
 *     ?CaptureLiveDumpWithFontFiles@UmfdHostLifeTimeManager@@SAXPEAUExtendedContext@1@@Z @ 0x1403382E8 (-CaptureLiveDumpWithFontFiles@UmfdHostLifeTimeManager@@SAXPEAUExtendedContext@1@@Z.c)
 * Callees:
 *     PALLOCMEM @ 0x140108044 (PALLOCMEM.c)
 *     ComputeFileviewCheckSum @ 0x14010E970 (ComputeFileviewCheckSum.c)
 *     EngMapFile @ 0x140306070 (EngMapFile.c)
