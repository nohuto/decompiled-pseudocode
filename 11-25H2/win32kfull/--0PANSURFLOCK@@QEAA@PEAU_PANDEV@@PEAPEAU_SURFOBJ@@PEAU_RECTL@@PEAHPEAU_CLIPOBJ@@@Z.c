/*
 * XREFs of ??0PANSURFLOCK@@QEAA@PEAU_PANDEV@@PEAPEAU_SURFOBJ@@PEAU_RECTL@@PEAHPEAU_CLIPOBJ@@@Z @ 0x14030A458
 * Callers:
 ...
 *     ?vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ @ 0x14030C218 (-vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ.c)
 */
