/*
 * XREFs of ?CaptureUsermodeParameters@QueryFontRequest@@UEAAXPEAX@Z @ 0x14010A880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z @ 0x14010A9D4 (-ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z.c)
