/*
 * XREFs of ??0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z @ 0x14026954C
 * Callers:
 ...
 *     ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x140334128 (-vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z.c)
 */
        ...
        int a4)
{
  ...
  v8 = PALLOCNOZ(16 * *((_DWORD *)a2 + 4), 1869835591LL);
  v9 = 0;
  *(_QWORD *)this = v8;
  *((_QWORD *)this + 2) = 0LL;
