/*
 * XREFs of ?bLines@@YAHPEBU_BMINFO@@PEAU_POINTFIX@@1PEAU_RUN@@KPEAU_LINESTATE@@PEAU_RECTL@@PEBQ6AXPEAU_STRIP@@03@ZKPEAKJPEAU_W32KCDD_ENG_CALLBACKS@@@Z @ 0x14006B840
 * Callers:
        ...
        struct _W32KCDD_ENG_CALLBACKS *a12)
{
  ...
  v12 = a3;
  v95 = a3;
  if ( a1 <= (const struct _BMINFO *)&off_14034B1C0 || !(unsigned int)bUMPDSecurityGateEx() )
  {
    v97 = &v12[a5];
    v89 = 0;
    v91 = 0;
