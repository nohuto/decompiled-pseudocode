/*
 * XREFs of GreGetDIBColorTable @ 0x140176390
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z @ 0x140176508 (-vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z.c)
 */
...
__int64 __fastcall GreGetDIBColorTable(HDC a1, unsigned int a2, int a3, struct tagRGBQUAD *a4)
{
  ...
  _BYTE v18[144]; // [rsp+90h] [rbp-70h] BYREF
