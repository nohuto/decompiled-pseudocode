/*
 * XREFs of ?UMPDDrvQueryDeviceSupport@@YAHPEAU_SURFOBJ@@PEAU_XLATEOBJ@@PEAU_XFORMOBJ@@KKPEAXK3@Z @ 0x140336740
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a8)
{
  ...
  _DWORD Src[4]; // [rsp+90h] [rbp-98h] BYREF
...
LABEL_14:
  if ( v12 )
  {
    ...
    if ( (!v14 || (unsigned int)UMPDOBJ::ThunkMemBlock(v11, (const void **)&v44, v14))
      ...
      && (unsigned int)UMPDOBJ::pso(v11, (UMPDOBJ *)((char *)v11 + 80), &v39)
      && (unsigned int)UMPDOBJ::pxlo(v11, &v40)
      && (unsigned int)UMPDOBJ::pxo(v11, &v41)
      && (LODWORD(v25) = 4, (unsigned int)UMPDOBJ::Thunk(v11, Src, 0x50u, &v26, v25) != -1) )
    {
      if ( Size )
      {
        v22 = (char *)v46;
