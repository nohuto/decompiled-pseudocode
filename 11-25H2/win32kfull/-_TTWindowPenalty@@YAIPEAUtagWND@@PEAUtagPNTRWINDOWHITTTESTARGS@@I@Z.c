/*
 * XREFs of ?_TTWindowPenalty@@YAIPEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@I@Z @ 0x1401C1E94
 * Callers:
...
__int64 __fastcall _TTWindowPenalty(struct tagWND *a1, struct tagPNTRWINDOWHITTTESTARGS *a2, int a3)
{
  ...
  if ( !a3 )
  {
    ...
    if ( (unsigned int)TouchTargetingBigTargetWindow(&v12, v6) )
    {
      ...
      Prop = GetProp((__int64)a1, *(unsigned __int16 *)(UserSessionState + 41348), 1u);
