/*
 * XREFs of WakeRITForShutdown @ 0x140223A10
 * Callers:
 *     NtUserWakeRITForShutdown @ 0x1402A3510 (NtUserWakeRITForShutdown.c)
 * Callees:
...
__int64 __fastcall WakeRITForShutdown(__int64 a1)
{
  ...
  if ( PsGetCurrentProcess(v2) != v1 || !*(_QWORD *)(W32GetUserSessionState(v4, v3) + 18680) )
    return 3221225473LL;
