/*
 * XREFs of ApiSetpResolveHost @ 0x1403419BC
 * Callers:
 *     ApiSetResolveToHost @ 0x14034188C (ApiSetResolveToHost.c)
 * Callees:
 *     ApiSetpGetContractKeyInfo @ 0x140341CEC (ApiSetpGetContractKeyInfo.c)
 *     ApiSetpSearchForSectionIndex_V7 @ 0x140341E94 (ApiSetpSearchForSectionIndex_V7.c)
