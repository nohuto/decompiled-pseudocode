/*
 * XREFs of _SetMagnificationInputTransform @ 0x140203308
 * Callers:
 ...
 *     ?ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z @ 0x1402AF88C (-ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z.c)
...
LABEL_18:
  ...
  if ( v7 != *(struct tagTHREADINFO **)(v11 + 32)
    && v7 != *(struct tagTHREADINFO **)(W32GetUserSessionState(v5, v4) + 18648) )
  {
    goto LABEL_17;
  }
