/*
 * XREFs of PostPointerEventMessage @ 0x14011BED0
 * Callers:
 *     PostPointerDeviceInRangeMessage @ 0x14011BE90 (PostPointerDeviceInRangeMessage.c)
 *     PostPointerDeviceOutOfRangeMessage @ 0x14011BEB0 (PostPointerDeviceOutOfRangeMessage.c)
...
__int64 __fastcall PostPointerEventMessage(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  InputTransform *v23; // [rsp+A0h] [rbp+1Fh] BYREF
  ...
  if ( v12 != v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *((_DWORD *)v12 - 2) )
      {
        v10 = *(_QWORD *)(W32GetUserSessionState(v10, v9) + 19144);
        if ( *((_QWORD *)v14 + 62) == v10 )
        {
          IsEnabledDeviceUsageNoInline = Feature_TouchpadPublicApis__private_IsEnabledDeviceUsageNoInline(
                                           v10,
                                           v9,
                                           v16,
                                           v17);
...
LABEL_25:
    ...
    {
      v9 = *(_QWORD *)(W32GetUserSessionState(v10, v9) + 19144);
      if ( *((_QWORD *)v14 + 62) != v9 )
        goto LABEL_25;
    }
    if ( *(_DWORD *)(a1 + 24) != 7 )
