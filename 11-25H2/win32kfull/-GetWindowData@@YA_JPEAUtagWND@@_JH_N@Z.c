/*
 * XREFs of ?GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z @ 0x1401F1814
 * Callers:
...
__int64 __fastcall GetWindowData(struct tagWND *a1, __int64 a2, int a3, char a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( v8 )
    {
      ...
      v11 = (unsigned __int64)(unsigned int)v6 + 4 <= v9;
    }
    else
    {
      v11 = (unsigned __int64)(unsigned int)v6 + 4 <= *(unsigned int *)(v4 + 200);
    }
    if ( v11 )
