/*
 * XREFs of ??$GrepAcquireLockValidate@$05@@YAXXZ @ 0x14008E7A8
 * Callers:
...
__int64 GrepAcquireLockValidate<6>()
{
  ...
  {
    v5 = *v4;
    if ( (*v4 & 0xFFFFFFFFFFFFFFC0uLL) != 0 && (v5 & 0x40) == 0 )
    {
      v8 = 0LL;
      v9 = 37;
      do
    ...
    LOBYTE(v5) = *(_BYTE *)(((v1 + 8) & -(__int64)(v1 != 0)) + 0xE);
    result = (unsigned int)(v5 + 1);
    *(_BYTE *)(((v1 + 8) & -(__int64)(v1 != 0)) + 0xE) = v5 + 1;
    if ( !(_BYTE)v5 )
      *v4 |= 0x40uLL;
  }
  return result;
