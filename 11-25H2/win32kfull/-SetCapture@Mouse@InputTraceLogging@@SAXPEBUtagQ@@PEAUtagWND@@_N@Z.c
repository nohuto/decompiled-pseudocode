/*
 * XREFs of ?SetCapture@Mouse@InputTraceLogging@@SAXPEBUtagQ@@PEAUtagWND@@_N@Z @ 0x140121EA8
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::SetCapture(const struct tagQ *a1, struct tagWND *a2, unsigned __int8 a3)
{
  ...
  v4 = a3;
  v6 = 0LL;
  if ( (unsigned __int8)InputTraceLogging::Enabled(64LL, 0LL) )
  {
    WindowDetails = InputTraceLogging::GetWindowDetails((__int64)v22, (__int64)a2);
