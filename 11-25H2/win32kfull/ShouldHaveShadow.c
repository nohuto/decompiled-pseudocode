/*
 * XREFs of ShouldHaveShadow @ 0x1401D159C
 * Callers:
...
__int64 __fastcall ShouldHaveShadow(_QWORD *a1)
{
  ...
  if ( IsTopLevelWindow((__int64)a1)
    ...
    && !*(_DWORD *)(W32GetUserSessionState(v6, v5) + 63416)
    && (*(_DWORD *)(W32GetUserSessionState(v8, v7) + 66804) & 0x80040000) == 0x80040000
    && (*(_BYTE *)(*(_QWORD *)(a1[17] + 8LL) + 10LL) & 2) != 0 )
  {
    ...
    if ( *(_DWORD *)(v11 + 672) > 0x9900u || (*(_DWORD *)(v11 + 688) & 0x400000) == 0 )
    {
      ...
      if ( !v12 || *(int *)(v12 + 32) <= 1 )
      {
        ...
        {
          v15 = *(_DWORD *)(W32GetUserSessionState(v15, v14) + 66804) & 0x80000200;
          if ( (_DWORD)v15 == -2147483136 )
            return 1;
        }
        if ( (*(_DWORD *)(W32GetUserSessionState(v15, v14) + 66804) & 0x80000002) != 0x80000002 )
          return 1;
      }
    }
  }
