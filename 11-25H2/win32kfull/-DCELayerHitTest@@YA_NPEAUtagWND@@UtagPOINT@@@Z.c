/*
 * XREFs of ?DCELayerHitTest@@YA_NPEAUtagWND@@UtagPOINT@@@Z @ 0x14008CBCC
 * Callers:
...
bool __fastcall DCELayerHitTest(struct tagWND *a1, struct tagPOINT a2)
{
  ...
  return (unsigned int)GrePtInSprite(*(HDEV *)(*(_QWORD *)(UserSessionState + 56968) + 48LL), v6 >= 0x602u, v7) != 0;
}
