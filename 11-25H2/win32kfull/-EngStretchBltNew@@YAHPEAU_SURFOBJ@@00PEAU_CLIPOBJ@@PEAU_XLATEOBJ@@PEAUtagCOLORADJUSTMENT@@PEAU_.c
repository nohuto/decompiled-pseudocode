/*
 * XREFs of ?EngStretchBltNew@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x140133474
 * Callers:
 ...
 *     ?pxrlStrRead01AND@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140135550 (-pxrlStrRead01AND@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@.c)
        ...
        if ( v150 || *(_WORD *)(v19 + 100) || (unsigned int)(*(_DWORD *)(v19 + 96) - 7) <= 1 )
        {
          ...
          *(_QWORD *)&v216.left = 0LL;
          ...
          if ( (v150 & 1) != 0 )
          {
            ...
            if ( v112 - 1 > 5 )
              goto LABEL_173;
            ((void (__fastcall *)(stretch *))funcs_1400753A4[v112 - 1])(v110);
          }
        }
        else
        {
