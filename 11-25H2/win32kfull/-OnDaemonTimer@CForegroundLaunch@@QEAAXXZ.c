/*
 * XREFs of ?OnDaemonTimer@CForegroundLaunch@@QEAAXXZ @ 0x1401C82E8
 * Callers:
 *     ?OnDaemonTimer@ForegroundLaunch@@YAXXZ @ 0x1401C82C0 (-OnDaemonTimer@ForegroundLaunch@@YAXXZ.c)
 * Callees:
...
void __fastcall CForegroundLaunch::OnDaemonTimer(CForegroundLaunch *this)
{
  ...
  v11 = v5 - (unsigned int)(*(_DWORD *)(UserSessionState + 69112) + 300000000);
