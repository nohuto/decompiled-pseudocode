/*
 * XREFs of NtUserRegisterClassExWOW @ 0x14029C000
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    *((_QWORD *)&v57 + 1) = v42;
    ...
    if ( ((unsigned __int64)v17 & 0xFFFFFFFFFFFF0000uLL) != 0 )
    {
      ...
      {
        if ( (v16 & 1) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10453);
        ExRaiseAccessViolation();
      }
    }
    else
    ...
    if ( (v19 & 0xFFFFFFFFFFFF0000uLL) != 0 )
    {
      ...
      {
        if ( (v18 & 1) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10475);
        ExRaiseAccessViolation();
      }
    }
    if ( (v19 & 0xFFFFFFFFFFFF0000uLL) != 0 )
    ...
    if ( (v42 & 0xFFFFFFFFFFFF0000uLL) != 0 )
    {
      ...
      {
        if ( (v37 & 1) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10497);
        ExRaiseAccessViolation();
      }
    }
    *(_QWORD *)&v54 = Str1_8;
...
LABEL_65:
    ...
    {
      v32 = 0;
      v33 = (unsigned __int16 *)&unk_14034EDA6;
      while ( 1 )
      {
        v30 = *(_QWORD *)(W32GetUserSessionState(v30, v28) + 19872);
