/*
 * XREFs of GreTransferSpriteStateToDwmState @ 0x140172718
 * Callers:
 ...
 *     UserGetMiniWinInfo @ 0x140220998 (UserGetMiniWinInfo.c)
...
__int64 __fastcall GreTransferSpriteStateToDwmState(Gre::Base *a1, unsigned __int64 a2)
{
  ...
  struct W32_PUSH_LOCK *v67; // [rsp+A0h] [rbp-60h] BYREF
      ...
      if ( v77 )
      {
        ...
        *((_DWORD *)v14 + 35) = v21 | *((_DWORD *)v14 + 35) & 0xFFFFFFFE;
        ...
        if ( v4 )
        {
          ...
          v57 = 39168;
          v67 = (struct DWMSPRITE *)((char *)v14 + 88);
    ...
    if ( v53 )
    {
      do
      {
        ...
        if ( v54 && (unsigned int)UserIsWindowOnDesktopAndComposed(v54, v2) )
        {
          ...
          GdiDeleteSprite((Gre::Base *)v3, *(HWND *)(v53 + 72), (_QWORD *)v53);
        }
        v53 = v55;
      }
      while ( v55 );
