/*
 * XREFs of ?GrepGetAppClipBox@@YAHAEAVXDCOBJ@@PEAUtagRECT@@@Z @ 0x140099794
 * Callers:
...
LABEL_13:
  ...
  *p_top = v12;
  ...
  {
    v14 = *(_QWORD *)this;
    if ( (*(_BYTE *)(v5 + 32) & 0x43) == 0x43 || (unsigned int)bCvtPts1(v5, a2, 2LL, v10) )
    {
  ...
  else
  {
    ...
    v50 = v10;
    v52 = v11;
    EXFORMOBJ::bXform((EXFORMOBJ *)&v41, &v47, 4uLL);
    v19 = v48;
    v20 = v48;
    x = v47.x;
    v22 = v50;
