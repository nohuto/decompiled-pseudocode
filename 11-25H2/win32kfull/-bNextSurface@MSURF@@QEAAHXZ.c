/*
 * XREFs of ?bNextSurface@MSURF@@QEAAHXZ @ 0x14000D764
 * Callers:
  ...
  if ( v1 )
  {
    ...
    for ( i = (__int64 **)**((_QWORD **)this + 7); ; i = (__int64 **)*i )
    {
      *((_QWORD *)this + 7) = i;
      if ( !i )
        break;
      v4 = *(_QWORD *)(*(_QWORD *)(v1 + 8) + 8LL * *((unsigned int *)i + 4));
      if ( v4 && (_bittest((const signed __int32 *)i[7] + 528, 0xFu) || (*((_DWORD *)this + 12) & 1) == 0) )
      {
        *((_QWORD *)this + 8) = v4;
...
LABEL_14:
  ...
  v6 = *v5;
  for ( *((_QWORD *)this + 7) = *v5; ; *((_QWORD *)this + 7) = *v8 )
  {
    if ( !v6 )
    {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v6 + 56) + 40LL) & 0x400) == 0 )
      break;
LABEL_23:
  ...
  if ( !*((_BYTE *)this + 88)
    && *((_DWORD *)this + 8) >= *(_DWORD *)(v6 + 28)
    && *((_DWORD *)this + 9) >= *(_DWORD *)(v6 + 32)
    && *((_DWORD *)this + 10) <= *(_DWORD *)(v6 + 36)
    && *((_DWORD *)this + 11) <= *(_DWORD *)(v6 + 40) )
  {
  ...
  if ( *((_BYTE *)this + 88) )
    v9 = *((_BYTE *)this + 88);
  *(_BYTE *)(*((_QWORD *)this + 9) + 20LL) = v9;
LABEL_32:
  v10 = *((_QWORD *)this + 7);
  *((_QWORD *)this + 8) = *(_QWORD *)(v10 + 64);
  *((_QWORD *)this + 10) = v10 + 72;
  return 1LL;
}
