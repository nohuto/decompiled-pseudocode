/*
 * XREFs of UnlinkSendListSms @ 0x14016F354
 * Callers:
...
LABEL_18:
      ...
      CTouchProcessor::UnreferenceMsgDataExternal(*(_QWORD *)(UserSessionState + 3256), v11, 6LL, a1);
    }
  }
LABEL_10:
  v5 = (__int64 *)*a1;
  ...
  *v6 = v5;
  ...
  return Win32FreeToPagedLookasideList(*(_QWORD *)(v9 + 69088), a1);
}
