/*
 * XREFs of NtUserfnINLPHELPINFOSTRUCT @ 0x1402A38A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserfnINLPHELPINFOSTRUCT(__int64 a1, __int64 a2, __int64 a3, ULONG64 a4, __int64 a5, char a6)
{
  unsigned int v8; // esi
  __int64 v10; // rdx
  __int64 v11; // rbx
