/*
 * XREFs of ?_ShellHandwritingDelegationReassignInputMessage@@YAXPEAUtagTHREADINFO@@0PEAUtagQMSG@@@Z @ 0x140063928
 * Callers:
 ...
 *     ?ShellHandwritingDelegationReassignMessage@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1401E1140 (-ShellHandwritingDelegationReassignMessage@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@@Z.c)
 *     DelegateChainingResetAndCoalescePointerMessage @ 0x1401FCD4C (DelegateChainingResetAndCoalescePointerMessage.c)
