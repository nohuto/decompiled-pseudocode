/*
 * XREFs of NtUserfnGETWINDOWDATA @ 0x14024F780
 * Callers:
 *     <none>
 * Callees:
 *     ?PtiCurrent@@YAPEAUtagTHREADINFO@@XZ @ 0x140036850 (-PtiCurrent@@YAPEAUtagTHREADINFO@@XZ.c)
 *     ?GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z @ 0x1401F1814 (-GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z.c)
  ...
  if ( a6 == 689 && a4 < 3 )
  {
    ...
    else
    {
      ...
      if ( (v21 & 0xFFFF2FFF) != 0 )
      {
        ...
        WindowData = (*(__int64 (__fastcall **)(struct tagWND *, _QWORD, __int64, __int64, ULONG64))(UserSessionState + 71104))(
                       a1,
                       v8,
                       a3,
                       a4,
        ...
        if ( a4 == 2 )
        {
          ...
          if ( (*(_DWORD *)(v24 + 12) & 0x80u) != 0 )
          {
            ...
            return ((*(__int64 (__fastcall **)(struct tagWND *, _QWORD, __int64, __int64, ULONG64))(v26 + 71104))(
                      a1,
                      v8,
                      v25,
                      2LL,
