/*
 * XREFs of DestroyClass @ 0x1400B2E28
 * Callers:
 ...
 *     DestroyProcessesClasses @ 0x1401CE940 (DestroyProcessesClasses.c)
 ...
 *     ?UnlockAndFreeCPDs@@YAXPEAPEAU_CALLPROCDATA@@@Z @ 0x1402108CC (-UnlockAndFreeCPDs@@YAXPEAPEAU_CALLPROCDATA@@@Z.c)
 */
