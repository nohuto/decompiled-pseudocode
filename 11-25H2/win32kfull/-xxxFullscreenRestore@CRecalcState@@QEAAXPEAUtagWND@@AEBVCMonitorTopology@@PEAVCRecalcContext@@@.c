/*
 * XREFs of ?xxxFullscreenRestore@CRecalcState@@QEAAXPEAUtagWND@@AEBVCMonitorTopology@@PEAVCRecalcContext@@@Z @ 0x1402C7654
 * Callers:
        ...
        struct CRecalcContext *a4)
{
  ...
  else
  {
    ...
    v15 = 1;
    Prop = GetProp((__int64)a2, *(unsigned __int16 *)(v23 + 41334), 1u);
    v25 = 0;
