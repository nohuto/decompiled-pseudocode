/*
 * XREFs of ?QueryFonts@PUBLIC_PFTOBJ@@QEAAHPEAU_UNIVERSAL_FONT_ID@@KPEAT_LARGE_INTEGER@@@Z @ 0x1402610C4
 * Callers:
        ...
        union _LARGE_INTEGER *a4)
{
  ...
  __int64 v13; // rcx
  struct PFF *v14; // rax
  HSEMAPHORE v16; // [rsp+40h] [rbp+8h] BYREF
  ...
  *a4 = *(union _LARGE_INTEGER *)((char *)this + 8);
  ...
  if ( a2 && a3 )
  {
    SEMOBJ<17>::SEMOBJ<17>(&v16, v9 + 4872);
