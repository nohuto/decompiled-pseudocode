/*
 * XREFs of ReadPointerDeviceSettingsFull @ 0x14025517C
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettingsFull(__int64 a1, __int64 a2)
{
  ...
  if ( v13 == 2 )
  {
    ...
    if ( *(_DWORD *)(v9 + 18528) == 1 )
    {
      ...
      *(_DWORD *)(a2 + 4) = v19;
      *(_DWORD *)(W32GetUserSessionState(v16, v15) + 18928) = v19;
      v22 = *(_DWORD *)(v14 + 28);
      if ( v22 == -1 )
      {
        v18 = *(_DWORD *)(v14 + 24);
      ...
      *(_DWORD *)(a2 + 8) = v18;
      *(_DWORD *)(W32GetUserSessionState(v21, v20) + 18932) = v18;
      v25 = *(_DWORD *)(v14 + 44);
      if ( v25 == -1 )
        v25 = *(_DWORD *)(v14 + 40);
      *(_DWORD *)(a2 + 12) = v25;
      *(_DWORD *)(W32GetUserSessionState(v24, v23) + 18936) = v25;
      return 1;
    }
  }
  return v4;
