/*
 * XREFs of ?CanCoalesceRawInputPayload@@YA_NPEAUtagPROCESS_HID_TABLE@@PEAXPEBUtagRAWMOUSE@@@Z @ 0x140275804
 * Callers:
...
char __fastcall CanCoalesceRawInputPayload(struct tagPROCESS_HID_TABLE *a1, void *a2, const struct tagRAWMOUSE *a3)
{
  ...
  if ( *((_DWORD *)a1 + 28) != 2 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 381);
