/*
 * XREFs of ?SecondaryHitTest@Mouse@InputTraceLogging@@SAXPEBUtagQMSG@@AEBUtagPOINT@@PEAUtagWND@@@Z @ 0x140069B40
 * Callers:
        ...
        struct tagWND *a3)
{
  ...
  if ( dword_14039BB50 )
  {
    if ( (qword_14039BB60 & 0x40) != 0 && (qword_14039BB68 & 0x40) == qword_14039BB68 )
    {
      ...
      if ( (unsigned int)dword_14039BB50 > 4
        && (qword_14039BB60 & 0x40) != 0
        && (qword_14039BB68 & 0x40) == qword_14039BB68 )
      {
        y = a2->y;
        x = a2->x;
        v12 = *((_DWORD *)a1 + 21);
