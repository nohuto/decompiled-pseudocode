/*
 * XREFs of ?InternalInvalidate2@@YAHPEAUtagWND@@PEAUHRGN__@@1PEAUtagRECT@@K@Z @ 0x140030E90
 * Callers:
...
__int64 __fastcall InternalInvalidate2(struct tagWND *a1, HRGN a2, HRGN a3, __int64 a4, unsigned int a5)
{
  unsigned int v5; // edi
  HRGN v6; // rbx
  __int64 right; // rdx
  ...
  if ( (unsigned __int64)v6 > 1 )
  {
    ...
    if ( v24 )
    {
      ...
      else if ( (v9 & 0x8000) != 0 )
      {
        ...
        SetRectRgnIndirect(*(_QWORD *)(UserSessionState + 63376), &v88);
        v28 = 0LL;
        v29 = v10;
        do
        {
          ...
          if ( v30 )
          {
            ...
            v48 = *(_QWORD *)(W32GetUserSessionState(v28, v27) + 63376);
            v51 = W32GetUserSessionState(v50, v49);
            GreCombineRgn(*(_QWORD *)(v51 + 63376), v48, v30, 1LL);
            if ( v47 )
              GreDeleteObject(v30);
          }
          v28 = v29;
        ...
        while ( v29 );
        v31 = *(_QWORD *)(W32GetUserSessionState(v28, v27) + 63376);
        v34 = W32GetUserSessionState(v33, v32);
        v35 = (unsigned int)GreCombineRgn(*(_QWORD *)(v34 + 63376), v31, v85, 1LL) == 1;
        v9 = v81;
        if ( v35 )
          return 1LL;
        v6 = v85;
...
LABEL_25:
  if ( (*(_BYTE *)(*((_QWORD *)v10 + 5) + 27LL) & 0x10) != 0 )
  {
    ...
    Prop = GetProp((__int64)v10, *(unsigned __int16 *)(v69 + 41358), 1u);
    v72 = Prop;
    if ( Prop )
    {
      ...
      SetRectRgnIndirect(*(_QWORD *)(v74 + 63376), &v88);
      if ( EmptyRgnPublic != 1 )
      {
        v78 = W32GetUserSessionState(v76, v75);
        GreCombineRgn(EmptyRgnPublic, EmptyRgnPublic, *(_QWORD *)(v78 + 63376), 2LL);
      }
      *(_QWORD *)(v72 + 40) = EmptyRgnPublic;
      v77 = W32GetUserSessionState(v76, v75);
      return (unsigned int)GreCombineRgn(v8, v8, *(_QWORD *)(v77 + 63376), 4LL) != 1;
    }
  }
LABEL_26:
  if ( (*(_BYTE *)(*((_QWORD *)v10 + 5) + 31LL) & 2) == 0 )
    InternalInvalidate3(v10, v6, v9, a4);
...
LABEL_48:
  ...
  if ( (*(_BYTE *)(*((_QWORD *)v10 + 5) + 31LL) & 2) != 0 )
    InternalInvalidate3(v10, v6, v16, a4);
  if ( (v16 & 0x2000) == 0 )
    return 1LL;
  ...
  SetRectRgnIndirect(*(_QWORD *)(v40 + 63376), &v88);
  if ( (v16 & 0x8000) != 0 )
  {
    v42 = 0LL;
    do
    {
      ...
      if ( v62 )
      {
        ...
        v65 = *(_QWORD *)(W32GetUserSessionState(v42, v41) + 63376);
        v68 = W32GetUserSessionState(v67, v66);
        GreCombineRgn(*(_QWORD *)(v68 + 63376), v65, v62, 1LL);
        if ( v64 )
          GreDeleteObject(v62);
      }
      v42 = v10;
  ...
  LOBYTE(v5) = (unsigned int)GreCombineRgn(v83, v83, *(_QWORD *)(v43 + 63376), 4LL) != 1;
  return v5;
}
