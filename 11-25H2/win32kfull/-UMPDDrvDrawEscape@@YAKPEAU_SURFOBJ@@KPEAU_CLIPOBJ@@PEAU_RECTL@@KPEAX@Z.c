/*
 * XREFs of ?UMPDDrvDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x140334EF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a6)
{
  ...
  _DWORD Src[4]; // [rsp+80h] [rbp-59h] BYREF
        ...
        || (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v31, a5) )
      {
        if ( (unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 80), &v26) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v10, (UMPDOBJ *)((char *)v10 + 128), (const void **)&v28, 0x18u, 0LL) )
          {
            ...
            {
              LODWORD(Size) = 4;
              if ( (unsigned int)UMPDOBJ::Thunk(v10, Src, 0x48u, &v16, Size) != -1 )
                v7 = v16;
            }
          }
        }
