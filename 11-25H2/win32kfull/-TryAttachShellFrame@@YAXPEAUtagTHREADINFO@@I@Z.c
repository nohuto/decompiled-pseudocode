/*
 * XREFs of ?TryAttachShellFrame@@YAXPEAUtagTHREADINFO@@I@Z @ 0x14019612C
 * Callers:
      ...
      if ( (_InterlockedCompareExchange((volatile signed __int32 *)(ShellFrameThreadFromAssociation + 528), 0, 0) & 1) == 0 )
      {
        ...
        if ( !v4 || (*(_DWORD *)(v4 + 200) & 0x8000) == 0 )
        {
          ...
          *(_DWORD *)(*((_QWORD *)v1 + 59) + 444LL) = v30;
          ...
          v34 = *(_QWORD *)(W32GetUserSessionState(v33, v32) + 18888);
          if ( v34 == *((_QWORD *)v1 + 59) )
          {
            v34 = *(_QWORD *)(W32GetUserSessionState(v35, v34) + 18888);
            if ( *(_QWORD *)(v34 + 120) )
