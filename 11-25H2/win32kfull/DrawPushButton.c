/*
 * XREFs of DrawPushButton @ 0x140055100
 * Callers:
...
int __fastcall DrawPushButton(HDC a1, RECT *a2, __int16 a3, __int16 a4)
{
  ...
  if ( (a3 & 0x400) != 0 )
  {
    if ( *(_WORD *)(v12 + 6996) < 8u
      || (v12 = *(_QWORD *)(W32GetUserSessionState(v12, v11) + 19872), *(_DWORD *)(v12 + 4648) == 0xFFFFFF) )
    {
    ...
    {
      v13 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 19872) + 4856LL);
    }
  }
  else
  {
