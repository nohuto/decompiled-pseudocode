/*
 * XREFs of GreDeleteWnd @ 0x140302960
 * Callers:
 ...
 *     EngDeleteWnd @ 0x140302820 (EngDeleteWnd.c)
 ...
 *     ?vDelete@EWNDOBJ@@QEAAXXZ @ 0x140301A30 (-vDelete@EWNDOBJ@@QEAAXXZ.c)
...
void __fastcall GreDeleteWnd(struct EWNDOBJ *a1)
{
  ...
  _BYTE v23[152]; // [rsp+20h] [rbp-98h] BYREF
