/*
 * XREFs of ?DeBoostIfTime@CShellForegroundBoost@@QEAAX_J@Z @ 0x1401C4BB0
 * Callers:
 *     ?OnDaemonTimer@ShellForegroundBoost@@YAXXZ @ 0x1401C4B70 (-OnDaemonTimer@ShellForegroundBoost@@YAXXZ.c)
 * Callees:
