/*
 * XREFs of zzzSetDesktop @ 0x140244CA0
 * Callers:
...
__int64 __fastcall zzzSetDesktop(__int64 a1, unsigned int *a2, void *a3)
{
  ...
  if ( a2
    ...
    && a1 != *(_QWORD *)(W32GetUserSessionState(a1, a2) + 68480) )
  {
    return 3221225506LL;
  }
  if ( !(unsigned int)Feature_UIPIAlwaysOn__private_IsEnabledDeviceUsageNoInline(a1) )
  ...
  *(_QWORD *)(a1 + 632) = a3;
        ...
        ObReferenceObjectByHandle(a3, 0, (POBJECT_TYPE)ExDesktopObjectType, 1, &Object, &HandleInformation) >= 0) )
  {
    ...
    *(_DWORD *)(a1 + 936) = HandleInformation.GrantedAccess;
    if ( !(unsigned int)Feature_UIPIAlwaysOn__private_IsEnabledDeviceUsageNoInline(v7)
...
LABEL_26:
  ...
  {
    *(_QWORD *)(a1 + 504) = *(_QWORD *)(W32GetUserSessionState(v15, v14) + 62920);
    v20 = (_OWORD *)(a1 + 1096);
    *v10 = a1 + 1096;
    v22 = (_OWORD *)(a1 + 1096);
  }
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a1 + 520) + 40LL) = 0LL;
    v25 = (*(_DWORD *)(W32GetUserSessionState(v22, v21) + 68448) & 1) - 1;
    *(_DWORD *)(a1 + 792) = v25;
    v26 = *(_QWORD *)(a1 + 472);
    if ( v26 )
      *(_DWORD *)(v26 + 408) = v25;
