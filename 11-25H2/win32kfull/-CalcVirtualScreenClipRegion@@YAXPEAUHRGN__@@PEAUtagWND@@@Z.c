/*
 * XREFs of ?CalcVirtualScreenClipRegion@@YAXPEAUHRGN__@@PEAUtagWND@@@Z @ 0x1401DE6E0
 * Callers:
...
void __fastcall CalcVirtualScreenClipRegion(HRGN a1, struct tagWND *a2)
{
    ...
    || (v5 = (*(_DWORD *)(*((_QWORD *)a2 + 5) + 288LL) >> 8) & 0x1FF) == 0 )
  {
    ...
    GreCombineRgn(v3, *(_QWORD *)(*(_QWORD *)(UserSessionState + 56968) + 128LL), 0LL, 5LL);
    return;
  }
  SetEmptyRgn(v3);
  v10 = *(_DWORD ***)(W32GetUserSessionState(v8, v7) + 56968);
  if ( **v10 == 1 )
  {
    DispInfo = GetDispInfo(v10);
...
LABEL_14:
  ...
  for ( i = *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 56968) + 112LL); i; i = *(_QWORD *)(i + 56) )
  {
