/*
 * XREFs of NtUserSetWindowsHookEx @ 0x1402A0F50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
      if ( a6 && (a6 & 0xFFFFFFBD) != 0 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3571);
    ...
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3559);
LABEL_24:
    ExRaiseAccessViolation();
  }
  UserSetLastError(87);
