/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAU_tagOEMBITMAPSET@@I@Z @ 0x140192AB4
 * Callers:
 ...
 *     ?ArrangeFrameControls@@YAFHHPEAU_tagOEMBITMAPSET@@@Z @ 0x140192DF4 (-ArrangeFrameControls@@YAFHHPEAU_tagOEMBITMAPSET@@@Z.c)
 */
