/*
 * XREFs of ?CreateAndSendSuperWetInkPayloadForCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXIM@Z @ 0x1402EE9A0
 * Callers:
 ...
 *     ?PopulatePayloadReport@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBUUsageValueInfo@@PEBXKPEAXK@Z @ 0x1402EC398 (-PopulatePayloadReport@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBUUsageValueInfo@@PEBXKPE.c)
    ...
    if ( v10 >= 0 )
    {
      v10 = RimBackedDeviceBase::SendSynchronousIoControl(
              ...
              *((unsigned __int16 *)HidDesc + 23),
              ...
              0,
              0LL);
      if ( v10 >= 0 && (unsigned int)dword_14039BC68 > 4 )
      {
        v19 = 72;
        v18[1] = v20;
        v15 = 0;
