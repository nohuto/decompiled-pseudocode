/*
 * XREFs of ?SetLPITEMInfoNoRedraw@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@PEAUtagMENUITEMINFOW@@PEAU_UNICODE_STRING@@PEAH@Z @ 0x140048FE0
 * Callers:
 ...
 *     ?UnlockSubMenu@@YAPEAUtagMENU@@AEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z @ 0x1401AD4F4 (-UnlockSubMenu@@YAPEAUtagMENU@@AEBV-$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z.c)
 ...
 *     ?RemoveParentMenu@@YAXAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z @ 0x1401CDDA4 (-RemoveParentMenu@@YAXAEBV-$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z.c)
        ...
        _DWORD *a5)
{
  ...
  __int64 v35; // rdx
  struct _HEAD *v36; // rcx
  _QWORD v37[2]; // [rsp+30h] [rbp-68h] BYREF
  __int64 v38[2]; // [rsp+40h] [rbp-58h] BYREF
  struct _HEAD *v39; // [rsp+50h] [rbp-48h]
  __int64 v40[3]; // [rsp+58h] [rbp-40h] BYREF
  ...
  *a5 = 0;
  ...
  if ( (*(_DWORD *)(a3 + 4) & 4) == 0 )
    goto LABEL_37;
  SmartObjStackRef<tagMENU>::SmartObjStackRef<tagMENU>(v38, 0LL);
  v19 = *(_QWORD *)(a3 + 24);
  if ( v19 )
  {
  ...
  v21 = a2 + 2;
  v22 = a2[2];
  if ( v22 != *(struct _HEAD **)v38[0] )
  {
    if ( v22 )
    {
      SmartObjStackRef<tagMENU>::SmartObjStackRef<tagMENU>(v40, (__int64)v18);
      RemoveParentMenu(a1, a2);
      DestroyMenu(*v21);
      SmartObjStackRef<tagMENU>::~SmartObjStackRef<tagMENU>(v40, v35);
    }
    if ( v39 )
      v26 = 0;
    else
      v26 = *(_QWORD *)v38[0] == 0LL;
    if ( v26 )
    {
      UnlockSubMenu(a1, a2);
LABEL_64:
    ...
    if ( v39 )
    {
      if ( v39 == (struct _HEAD *)a1[2] )
      {
LABEL_78:
        Menu = InternalCreateMenu(0);
        v39 = 0LL;
        SmartObjStackRefBase<tagMENU>::operator=(v38, Menu);
        if ( !v39 && !*(_QWORD *)v38[0] )
        {
LABEL_67:
          SmartObjStackRef<tagMENU>::~SmartObjStackRef<tagMENU>(v38, v33);
          return 0LL;
        }
        v27 = 1;
LABEL_55:
        ...
        *(_DWORD *)(*((_QWORD *)*v21 + 5) + 40LL) |= 1u;
        MenuDepth = GetMenuDepth(v38, 25LL);
        if ( (unsigned int)GetMenuAncestors(a1) + MenuDepth < 0x19 )
        {
          ...
          if ( v18 )
          {
            ...
            if ( !v32 )
              v32 = **a1;
            v18[1] = v32;
            *v18 = *(_QWORD *)(*(_QWORD *)v38[0] + 104LL);
            *(_QWORD *)(*(_QWORD *)v38[0] + 104LL) = v18;
            goto LABEL_64;
          }
        }
        *(_DWORD *)(*((_QWORD *)*v21 + 5) + 40LL) &= ~1u;
...
LABEL_36:
  SmartObjStackRef<tagMENU>::~SmartObjStackRef<tagMENU>(v38, (__int64)v18);
  v9 = BaseAddress;
LABEL_37:
  v23 = *a2;
