/*
 * XREFs of ?BltMe4Times@@YAXIHHPEAUHDC__@@PEAUtagCURSOR@@I@Z @ 0x140192F6C
 * Callers:
...
void __fastcall BltMe4Times(unsigned int a1, int a2, int a3, HDC a4, struct tagCURSOR *a5, char a6)
{
  ...
  v6 = a1;
  v9 = 1;
  v12 = (HDC)PrepareHDCBITSBitmap(0LL);
  if ( v12 )
  {
    v31 = a6 & 0x10;
    if ( v31 )
      v13 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v11, v10) + 19872) + 4856LL);
    else
      v13 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v11, v10) + 19872) + 4712LL);
    v26 = 2LL;
    v25 = (a2 - a3) / 2;
    do
    {
      ...
      while ( v21 );
      v6 = ++v28;
      v24 = *(_QWORD *)(W32GetUserSessionState(v23, v22) + 19872);
      if ( v31 )
        v13 = *(HBRUSH *)(v24 + 4816);
      else
        v13 = *(HBRUSH *)(v24 + 4720);
