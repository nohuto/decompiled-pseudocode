/*
 * XREFs of ?HandleIntObjUsageTelemetry@@YAXPEAURawInputManagerDeviceObject@@PEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x14021A3F4
 * Callers:
 ...
 * Callees:
 *     ?UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@_K@Z @ 0x140267D3C (-UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYP.c)
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v15, v14) + 18904) )
  {
    ...
    if ( *(_QWORD *)(v17 + 464) )
    {
      ...
      v11 = *(__m128i *)ProcessGetAppSessionGuid(
                          (struct _GUID *)&v56[1],
                          *(struct tagPROCESSINFO **)(*(_QWORD *)(UserSessionState + 18904) + 464LL));
    }
  }
  if ( a2 )
  {
