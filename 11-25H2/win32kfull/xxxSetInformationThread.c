/*
 * XREFs of xxxSetInformationThread @ 0x140114240
 * Callers:
    ...
    if ( a2 > 10 )
    {
      if ( a2 == 12 )
      {
        ...
        if ( !v48 || !*(_QWORD *)(v48 + 496) )
          goto LABEL_45;
        v49 = *a3;
        *(_QWORD *)(W32GetUserSessionState(v47, v46) + 19120) = v49;
      ...
      else
      {
        ...
        if ( a2 == 13 )
        {
          ...
          {
            if ( *(_QWORD *)(W32GetUserSessionState(v24, v12) + 63472) )
            {
              v28 = PtiCurrent(v27, v26);
              *(_QWORD *)(W32GetUserSessionState(v30, v29) + 69040) = v28;
          ...
          if ( i > 0 )
          {
            ...
            TraceLoggingBSDRRaceConditionEvent(***(_DWORD ***)(UserSessionState + 56968), i);
          }
          goto LABEL_15;
        }
        if ( a2 == 14 )
        {
          ...
          *(_QWORD *)(W32GetUserSessionState(v40, v39) + 69040) = 0LL;
          W32GetUserSessionState(v42, v41);
          *(_QWORD *)(W32GetUserSessionState(v44, v43) + 19120) = 0LL;
        }
        else
        {
          ...
          if ( a2 == 15 )
          {
            if ( v54 )
            {
              ...
              *(_DWORD *)(*(_QWORD *)(v55 + 19872) + 2236LL) |= 8u;
            }
            else
            {
              v58 = W32GetUserSessionState(v53, v12);
              *(_DWORD *)(*(_QWORD *)(v58 + 19872) + 2236LL) &= ~8u;
            }
          ...
          else
          {
            if ( v54 )
            {
              ...
              *(_DWORD *)(*(_QWORD *)(v60 + 19872) + 2236LL) |= 0x10u;
            }
            else
            {
              v61 = W32GetUserSessionState(v53, v12);
              *(_DWORD *)(*(_QWORD *)(v61 + 19872) + 2236LL) &= ~0x10u;
            }
...
LABEL_15:
            ...
            v51 = 0LL;
            v52 = *(_QWORD *)(W32GetUserSessionState(ThreadWin32Thread, v12) + 63520);
            if ( v52 )
            {
              while ( !v51 )
              {
...
LABEL_79:
        ...
        if ( *(_QWORD *)(W32GetUserSessionState(ThreadWin32Thread, v12) + 19144) )
        {
          v23 = W32GetUserSessionState(v22, v21);
          v20 = xxxSetCsrssThreadDesktop(*(PVOID *)(v23 + 19144));
          goto LABEL_14;
        }
LABEL_19:
        v10 = -1073741816;
