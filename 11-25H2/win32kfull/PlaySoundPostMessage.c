/*
 * XREFs of PlaySoundPostMessage @ 0x1403D3E00
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1400D8B20 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x1401D8584 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1401DF160 (PlaySndClient_midl_user_allocate.c)
 *     ??$_lambda_invoker_cdecl_@PEAX@_lambda_2_@?N@??Initialize@?$CTypeIsolation@$0DKAAA@$0DKA@@NSInstrumentation@@IEAA_NXZ@SA?A_PPEAX@Z @ 0x14026E810 (--$_lambda_invoker_cdecl_@PEAX@_lambda_2_@-N@--Initialize@-$CTypeIsolation@$0DKAAA@$0DKA@@NSInst.c)
 */
