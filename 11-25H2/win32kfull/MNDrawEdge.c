/*
 * XREFs of MNDrawEdge @ 0x14021227C
 * Callers:
...
void __fastcall MNDrawEdge(__int64 a1, HDC a2, _DWORD *a3, int a4)
{
  ...
  DrawOutline(a2, 0, 0, v6, v8, 1, *(HBRUSH *)(*(_QWORD *)(UserSessionState + 19872) + 4824LL));
  v12 = *(HBRUSH *)(*(_QWORD *)(a1 + 40) + 24LL);
  if ( !v12 )
    v12 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(0LL, v11) + 19872) + 4728LL);
