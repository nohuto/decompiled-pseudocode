/*
 * XREFs of NtUserShellMigrateWindow @ 0x1402A14B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_68:
  ...
  if ( v21[2] == PtiCurrent(v27, v26) )
  {
    ...
    if ( !v5 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      goto LABEL_19;
    v46 = a1;
    v25 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v28) + 69160);
    v44 = 84;
    goto LABEL_18;
  }
  if ( IsHungWindow(v21) )
  {
    ...
    if ( !v5 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      goto LABEL_45;
    v47 = a1;
    v33 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v29) + 69160);
    v45 = 85;
LABEL_44:
    LOBYTE(v32) = v30;
    LOBYTE(v31) = v5;
