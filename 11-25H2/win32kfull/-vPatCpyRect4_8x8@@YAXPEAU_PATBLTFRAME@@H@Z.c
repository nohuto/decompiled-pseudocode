/*
 * XREFs of ?vPatCpyRect4_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x140315ED0
 * Callers:
 *     ?vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x14031ADC0 (-vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
 *     ?vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z @ 0x140316F68 (-vPatternCopyLoop@@YAXPEAU_RECTL@@PEAKPEAU_PATBLTFRAME@@HKKKKJJJPEBK3@Z.c)
...
void __fastcall vPatCpyRect4_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  do
  {
    v13 = dword_140363B30[v3->left & 7];
    v14 = ~v13;
    v15 = dword_140363B30[v3->right & 7];
    if ( !v15 )
      v15 = -1;
