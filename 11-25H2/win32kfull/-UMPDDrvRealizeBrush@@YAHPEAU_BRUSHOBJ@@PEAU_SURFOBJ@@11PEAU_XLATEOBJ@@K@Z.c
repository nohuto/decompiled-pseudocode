/*
 * XREFs of ?UMPDDrvRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x140336AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  _DWORD Src[4]; // [rsp+110h] [rbp+0h] BYREF
  ...
  {
    if ( (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 80), &v38) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 96), &v39) )
      {
        if ( (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 112), &v40) )
        {
