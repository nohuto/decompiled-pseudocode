...
__int64 __fastcall DrawEdge(HDC a1, __m128i *a2, unsigned int a3, int a4)
{
  ...
  v15 = *(_WORD *)(*(_QWORD *)(UserSessionState + 19872) + 6996LL) == 1;
  ...
  while ( 1 )
  {
    if ( (v20 & 0x4000) != 0 )
    {
      ...
      if ( (v20 & 0x8000) != 0 )
        v28 = v43
            ? *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872) + 4744LL)
            : *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872) + 4736LL);
      else
        v28 = v43
            ? *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872) + 4824LL)
            : *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872) + 4816LL);
      v27 = v28;
    }
    else
    {
      ...
      if ( v22 )
      {
        ...
        if ( v23 )
        {
          ...
          if ( v24 )
          {
            if ( v24 != 4 )
              return 0LL;
            v40 = *(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872);
            v27 = (v20 & 0x1000) != 0 ? *(HBRUSH *)(v40 + 4824) : *(HBRUSH *)(v40 + 4864);
            v28 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v40, v39) + 19872) + 4872LL);
          }
          else
          {
            v26 = *(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872);
            v27 = (v20 & 0x1000) != 0 ? *(HBRUSH *)(v26 + 4872) : *(HBRUSH *)(v26 + 4856);
            v28 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v26, v25) + 19872) + 4824LL);
          }
        }
        else
        {
          v42 = *(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872);
          v27 = (v20 & 0x1000) != 0 ? *(HBRUSH *)(v42 + 4864) : *(HBRUSH *)(v42 + 4824);
          v28 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v42, v41) + 19872) + 4856LL);
        }
      }
      else
      {
        v38 = *(_QWORD *)(W32GetUserSessionState(4096LL, 0x8000LL) + 19872);
        v27 = (v20 & 0x1000) != 0 ? *(HBRUSH *)(v38 + 4856) : *(HBRUSH *)(v38 + 4872);
        v28 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v38, v37) + 19872) + 4864LL);
      }
    }
    if ( (v20 & 0x10) != 0 )
    {
...
LABEL_24:
  ...
  if ( (v20 & 0x800) != 0 )
  {
    ...
    {
      if ( (v20 & 0x8000) != 0 )
        v44 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v48, 0x8000LL) + 19872) + 4736LL);
      else
        v44 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v48, 0x8000LL) + 19872) + 4816LL);
    ...
    {
      if ( (v20 & 0x8000) != 0 )
        v46 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v48, 0x8000LL) + 19872) + 4736LL);
      else
        v46 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v48, 0x8000LL) + 19872) + 4816LL);
