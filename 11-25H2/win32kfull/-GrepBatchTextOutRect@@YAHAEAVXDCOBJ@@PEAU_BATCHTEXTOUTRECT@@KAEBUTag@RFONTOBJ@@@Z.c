/*
 * XREFs of ?GrepBatchTextOutRect@@YAHAEAVXDCOBJ@@PEAU_BATCHTEXTOUTRECT@@KAEBUTag@RFONTOBJ@@@Z @ 0x140077BC0
 * Callers:
        ...
        const struct RFONTOBJ::Tag *a4)
{
  ...
  if ( v7 != *(_DWORD *)&v15[4] )
  {
    ...
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 180LL) = *(_DWORD *)&v15[36];
  ...
  if ( v10 != *(_QWORD *)&v15[28] )
  {
    ...
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 328LL) = *(_DWORD *)&v15[32];
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 340LL) |= 0x2010u;
  }
  ExtTextOutRect(&v14, a1, (unsigned int *)&v15[12], a4);
  v11 = *((_QWORD *)*a1 + 122);
  if ( *(_DWORD *)(v11 + 176) != v7 )
  {
    *(_DWORD *)(v11 + 176) = v7;
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 180LL) = v8;
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 152LL) |= 0xBu;
  }
  v12 = *((_QWORD *)*a1 + 122);
  ...
  {
    *(_DWORD *)(v12 + 324) = v10;
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 328LL) = HIDWORD(v10);
    *(_DWORD *)(*((_QWORD *)*a1 + 122) + 340LL) |= 0x2010u;
  }
  return 1LL;
}
