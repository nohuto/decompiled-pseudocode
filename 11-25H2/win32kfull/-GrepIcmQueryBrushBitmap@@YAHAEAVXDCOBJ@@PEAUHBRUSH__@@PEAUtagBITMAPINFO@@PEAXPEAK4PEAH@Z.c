/*
 * XREFs of ?GrepIcmQueryBrushBitmap@@YAHAEAVXDCOBJ@@PEAUHBRUSH__@@PEAUtagBITMAPINFO@@PEAXPEAK4PEAH@Z @ 0x14033D6B4
 * Callers:
        ...
        int *a7)
{
  ...
  if ( (*((_DWORD *)*a1 + 30) & 1) != 0 )
  {
    BRUSHSELOBJ::BRUSHSELOBJ((BRUSHSELOBJ *)v22, a2, (__int64)a3, a4);
    if ( v22[0] )
    {
