/*
 * XREFs of ?EncodeRLE4@@YAHPEAE0III@Z @ 0x140231554
 * Callers:
 ...
 * Callees:
 *     ?WriteEncoded8@@YAHEPEAEIPEBE@Z @ 0x1403187C8 (-WriteEncoded8@@YAHEPEAEIPEBE@Z.c)
 *     ?WriteAbsolute4@@YAHPEBEPEAEH0@Z @ 0x1403198A4 (-WriteAbsolute4@@YAHPEBEPEAEH0@Z.c)
 */

__int64 __fastcall EncodeRLE4(unsigned __int8 *a1, unsigned __int8 *a2, int a3, unsigned int a4, unsigned int a5)
{
  ...
  const unsigned __int8 *v27; // [rsp+28h] [rbp-40h]
