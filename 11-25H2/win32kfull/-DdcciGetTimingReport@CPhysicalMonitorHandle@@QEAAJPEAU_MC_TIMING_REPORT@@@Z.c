/*
 * XREFs of ?DdcciGetTimingReport@CPhysicalMonitorHandle@@QEAAJPEAU_MC_TIMING_REPORT@@@Z @ 0x140323694
 * Callers:
        ...
        struct _MC_TIMING_REPORT *a2)
{
  ...
  v11 = 0;
  v9 = 491857;
  v4 = CPhysicalMonitorHandle::DdcciSendDataToMonitorDevice(this, -500000LL, &v9, 4);
  if ( v4 >= 0 )
  {
