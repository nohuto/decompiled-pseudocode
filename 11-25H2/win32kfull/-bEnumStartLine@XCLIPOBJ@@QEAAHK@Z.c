/*
 * XREFs of ?bEnumStartLine@XCLIPOBJ@@QEAAHK@Z @ 0x14006B1D8
 * Callers:
 *     ?bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z @ 0x14006C3C4 (-bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z.c)
 * Callees:
 *     ?vUpdateStyleState@XCLIPOBJ@@QEAAXXZ @ 0x14006A230 (-vUpdateStyleState@XCLIPOBJ@@QEAAXXZ.c)
 *     ?bInit@DDA_CLIPLINE@@QEAAHPEBU_POINTFIX@@0@Z @ 0x14006B334 (-bInit@DDA_CLIPLINE@@QEAAHPEBU_POINTFIX@@0@Z.c)
 */
