/*
 * XREFs of xxxActivateDebugger @ 0x14025E0C0
 * Callers:
...
_BOOL8 __fastcall xxxActivateDebugger(char a1)
{
  ...
  else
  {
    ...
    ProcessId = PsGetThreadProcessId(**(PETHREAD **)(*(_QWORD *)(UserSessionState + 18888) + 104LL));
    v17 = W32GetUserSessionState(v16, v15);
    ThreadId = PsGetThreadId(**(PETHREAD **)(*(_QWORD *)(v17 + 18888) + 104LL));
    if ( (unsigned int)Feature_ResponsiblePid__private_IsEnabledDeviceUsageNoInline(v18) )
    {
      v21 = W32GetUserSessionState(v20, v19);
      ThreadProcess = PsGetThreadProcess(**(PETHREAD **)(*(_QWORD *)(v21 + 18888) + 104LL));
  ...
  if ( *(_QWORD *)(W32GetUserSessionState(v9, v8) + 71288) )
  {
    v31[1] = 0;
    v32 = 0LL;
    v31[0] = 5242920;
    ...
    LpcRequestPort(*(_QWORD *)(v27 + 71288), v31);
