/*
 * XREFs of ?TraceLoggingWinPHotKeyEvent@@YAXXZ @ 0x1402B83F4
 * Callers:
 *     ?WinlogonHotkeyCallback@@YA?AW4tagHotKeyCallBackResult@@_K_J@Z @ 0x140275FA0 (-WinlogonHotkeyCallback@@YA-AW4tagHotKeyCallBackResult@@_K_J@Z.c)
 * Callees:
