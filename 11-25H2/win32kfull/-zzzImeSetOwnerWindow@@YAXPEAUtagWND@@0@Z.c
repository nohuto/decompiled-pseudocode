/*
 * XREFs of ?zzzImeSetOwnerWindow@@YAXPEAUtagWND@@0@Z @ 0x14005E600
 * Callers:
...
void __fastcall zzzImeSetOwnerWindow(struct tagWND *a1, struct tagWND *a2)
{
  ...
  {
    v5 = *v4;
    if ( v5 != *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872) + 898LL) )
    {
      ...
      while ( NonChildAncestor )
      {
        ...
        v10 = *(__int16 **)(v9 + 8);
        v11 = *v10;
        if ( v11 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v9, v10) + 19872) + 898LL) )
        {
          v7 = 0LL;
          break;
        }
