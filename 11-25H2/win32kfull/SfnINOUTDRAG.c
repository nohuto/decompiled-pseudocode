/*
 * XREFs of SfnINOUTDRAG @ 0x1402BB250
 * Callers:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 65) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(5LL, &v34, 88LL, &Src, &v43);
  ...
  *(_QWORD *)(v20 + 80) = v28;
  if ( v18 >= 0 && v43 == 24 )
  {
    ...
    if ( !v24 || (*(_DWORD *)(v24 + 84) & 1) == 0 || *(__int128 **)(v24 + 96) != a4 )
    {
      ...
      v31 = 0LL;
      v32 = 0LL;
      RtlCopyFromUser(&v30, v25, 0x30uLL);
      *a4 = v30;
      a4[1] = v31;
      a4[2] = v32;
      return v23;
