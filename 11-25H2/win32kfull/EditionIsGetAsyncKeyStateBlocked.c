/*
 * XREFs of EditionIsGetAsyncKeyStateBlocked @ 0x14016EE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EditionIsGetAsyncKeyStateBlocked(__int64 a1, __int64 a2)
{
  ...
  if ( CurrentThreadNonPaged )
    ...
    v6 = 0LL;
  v8 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 19144);
  if ( *(_QWORD *)(v6 + 496) != v8 )
    return 1LL;
  if ( *(_QWORD *)(W32GetUserSessionState(v8, v7) + 18904) )
  {
    ...
    if ( v13 == *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v12, v11) + 18904) + 464LL) )
      return 0LL;
  }
