/*
 * XREFs of ??1APIDCOBJ@@QEAA@XZ @ 0x140084B40
 * Callers:
 ...
 *     NtGdiSelectBitmap @ 0x140084960 (NtGdiSelectBitmap.c)
 ...
 *     DxgkEngWatchVisRgnChange @ 0x1401A0950 (DxgkEngWatchVisRgnChange.c)
 ...
 *     NtGdiSetFontXform @ 0x1401C7920 (NtGdiSetFontXform.c)
 *     NtGdiEndPath @ 0x1401CB520 (NtGdiEndPath.c)
 ...
 *     NtGdiGetDeviceWidth @ 0x1401D3540 (NtGdiGetDeviceWidth.c)
 ...
 *     NtGdiComputeXformCoefficients @ 0x1401DF190 (NtGdiComputeXformCoefficients.c)
 *     GrePolylineTo @ 0x1401DFD20 (GrePolylineTo.c)
 *     NtGdiSetMiterLimit @ 0x1401E5510 (NtGdiSetMiterLimit.c)
 ...
 *     NtGdiSetSizeDevice @ 0x1401F78B0 (NtGdiSetSizeDevice.c)
 *     NtGdiSetVirtualResolution @ 0x1401F7940 (NtGdiSetVirtualResolution.c)
 ...
 *     NtGdiGetMiterLimit @ 0x140202CA0 (NtGdiGetMiterLimit.c)
 ...
 *     NtGdiMakeInfoDC @ 0x1402270B0 (NtGdiMakeInfoDC.c)
 ...
 *     NtGdiSelectBrush @ 0x14033A640 (NtGdiSelectBrush.c)
 *     NtGdiSelectPen @ 0x14033A6B0 (NtGdiSelectPen.c)
 *     NtGdiSetColorAdjustment @ 0x14033A720 (NtGdiSetColorAdjustment.c)
 *     NtGdiSetSystemPaletteUse @ 0x14033A920 (NtGdiSetSystemPaletteUse.c)
 ...
 *     NtGdiUpdateTransform @ 0x14033E800 (NtGdiUpdateTransform.c)
...
void __fastcall APIDCOBJ::~APIDCOBJ(APIDCOBJ *this)
{
  ...
  if ( *((_BYTE *)this + 104) && *(_QWORD *)this )
  {
    ...
    if ( (unsigned int)Feature_GDI_GlobalsOptimization__private_IsEnabledDeviceUsageNoInline() )
      ...
      HmgDecrementExclusiveReferenceCountEx(*(_QWORD *)this, *((unsigned int *)this + 8), &v6);
    if ( v6 )
