/*
 * XREFs of ?vSrcTranCopyS1D8@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1401A6F20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int8 a9)
{
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v29 = 0x101010101010101LL * a9;
        v32 = dword_140355C00[(unsigned __int64)(unsigned __int8)(v45 & *v20) >> 4] | ((unsigned __int64)dword_140355C00[(unsigned __int8)v45 & *v20 & 0xF] << 32);
      ...
      if ( v34 != (unsigned __int64 *)v31 )
      {
        do
        {
          if ( *v33 )
          {
            v35 = dword_140355C00[(unsigned __int64)(unsigned __int8)*v33 >> 4] | ((unsigned __int64)dword_140355C00[*v33 & 0xF] << 32);
            *v34 = v29 & v35 | *v34 & ~v35;
          }
          ++v33;
          ++v34;
