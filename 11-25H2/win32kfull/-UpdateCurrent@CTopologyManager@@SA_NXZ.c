/*
 * XREFs of ?UpdateCurrent@CTopologyManager@@SA_NXZ @ 0x14021E9D8
 * Callers:
 ...
 *     EditionUpdateCurrentMonitorTopology @ 0x14021E9C0 (EditionUpdateCurrentMonitorTopology.c)
 * Callees:
...
char CTopologyManager::UpdateCurrent(void)
{
  ...
  if ( TopologySnapshot )
  {
    ...
    v10 = *(CMonitorTopology **)(UserSessionState + 71224);
    *(_QWORD *)(UserSessionState + 71224) = TopologySnapshot;
