/*
 * XREFs of ?CreateMoveSizeData@MOVESIZEDATA@@SAPEAU1@PEAUtagWND@@@Z @ 0x14025D700
 * Callers:
...
struct MOVESIZEDATA *__fastcall MOVESIZEDATA::CreateMoveSizeData(struct tagWND *a1, __int64 a2)
{
  ...
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)PtiCurrent((__int64)a1, a2) + 132, 0, 0) & 1) != 0 )
    return 0LL;
  v6 = Win32AllocPoolWithQuotaZInit(352LL, 1936552789LL);
  if ( v6 )
  {
    v11[1] = a1;
    v11[0] = v6 + 16;
    ...
    *(_DWORD *)(v6 + 200) |= 0x8000u;
    v9 = W32GetUserSessionState(v8, v7) + 63392;
    v10 = *(_QWORD *)v9;
