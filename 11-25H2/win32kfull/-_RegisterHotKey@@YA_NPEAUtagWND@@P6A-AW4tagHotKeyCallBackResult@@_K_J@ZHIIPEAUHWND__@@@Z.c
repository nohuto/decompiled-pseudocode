/*
 * XREFs of ?_RegisterHotKey@@YA_NPEAUtagWND@@P6A?AW4tagHotKeyCallBackResult@@_K_J@ZHIIPEAUHWND__@@@Z @ 0x14028ACB4
 * Callers:
 ...
 *     ?HKInsertHashElement@@YAXPEAUtagHOTKEY@@@Z @ 0x1401E74D4 (-HKInsertHashElement@@YAXPEAUtagHOTKEY@@@Z.c)
 ...
 *     ?AddSasKey@@YAHII@Z @ 0x1402700A8 (-AddSasKey@@YAHII@Z.c)
        ...
        HWND a6)
{
  ...
  if ( PsGetCurrentProcess(v11) != v10
    && *(_QWORD *)(W32GetUserSessionState(v13, v12) + 63520)
  ...
  if ( (unsigned __int64)a1 >= 2 && a1[2] != v8 )
  {
    v22 = 1408;
LABEL_17:
  ...
  if ( (v21 & 0x200) != 0 && (v17 || a1 == (struct tagTHREADINFO **)1) )
    return 0;
  v39 = 0LL;
