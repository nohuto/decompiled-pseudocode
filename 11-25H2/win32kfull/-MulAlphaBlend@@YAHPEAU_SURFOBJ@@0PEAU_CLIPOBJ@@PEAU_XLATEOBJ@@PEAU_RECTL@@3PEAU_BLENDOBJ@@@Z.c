/*
 * XREFs of ?MulAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x14000BA90
 * Callers:
 *     <none>
 * Callees:
        ...
        BLENDOBJ *pBlendObj)
{
  ...
  if ( v18 )
  {
    do
    {
      ...
      v33 = (struct PALETTE *)*((_QWORD *)v21 + 471);
...
LABEL_37:
        ...
        {
          v33 = *(struct PALETTE **)&a4[2].iSrcType;
          if ( !v33 )
            goto LABEL_61;
...
LABEL_43:
      ...
      if ( !(unsigned int)EXLATEOBJ::bInitXlateObj(
                            ...
                            *((_QWORD *)v46 + 471),
                            ...
                            v36)
        || (*(_QWORD *)&v76.left = v54,
            !(unsigned int)EXLATEOBJ::bInitXlateObj(&v53, 0LL, 0LL, *v55, v23, v33, v33, v47, v39, v45, 0))
        || (*(_QWORD *)&pBlendObj[4].BlendFunction.BlendOp = v53,
            !(unsigned int)EXLATEOBJ::bInitXlateObj(&v52, 0LL, 0LL, v23, *v55, v33, v33, v47, v39, v45, 0)) )
      {
        v21 = v46;
LABEL_61:
        v7 = pBlendObj;
      ...
      *(_QWORD *)&pBlendObj[6].BlendFunction.BlendOp = v52;
      ...
      inited = EXLATEOBJ::bInitXlateObj(&v51, 0LL, 0LL, v49[16], v23, *((_QWORD *)v46 + 471), v33, v47, v39, v45, 0);
      v7 = pBlendObj;
      v21 = v46;
      if ( inited )
      {
