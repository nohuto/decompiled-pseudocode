/*
 * XREFs of QueryRegistryFontSubstituteListRoutine @ 0x1403ED820
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a5)
{
  ...
  if ( (int)vProcessEntry(a3, v14, 0LL) >= 0 && (int)vProcessEntry(a1, Str1, v11) >= 0 && v13 == v15 && v13 != 2 )
  {
    ...
    if ( !v13 )
      ++*(_DWORD *)(v9 + 19704);
    if ( !*(_DWORD *)(v9 + 19708) && !_wcsicmp(Str1, L"MS Shell Dlg") && !_wcsicmp(v14, L"Microsoft Sans Serif") )
      *(_DWORD *)(v9 + 19708) = 1;
  }
  return 0LL;
}
