/*
 * XREFs of ?AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1403415D0
 * Callers:
 *     ?CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z @ 0x1401541F4 (-CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z.c)
 * Callees:
 *     ?AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z @ 0x14021F550 (-AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z.c)
 */
