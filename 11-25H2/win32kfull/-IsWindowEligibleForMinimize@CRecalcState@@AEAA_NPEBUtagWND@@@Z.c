/*
 * XREFs of ?IsWindowEligibleForMinimize@CRecalcState@@AEAA_NPEBUtagWND@@@Z @ 0x14026B178
 * Callers:
...
char __fastcall CRecalcState::IsWindowEligibleForMinimize(CRecalcState *this, const struct tagWND *a2)
{
  ...
  if ( (*(_BYTE *)(v2 + 30) & 2) == 0 )
  {
    ...
    if ( !v4 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v13 = *(_QWORD *)a2;
    v8 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, a2) + 69160);
    v12 = 42;
LABEL_37:
    LOBYTE(v7) = v5;
    LOBYTE(v6) = v4;
  ...
  if ( IsForegroundWindow(a2, (__int64)a2) )
  {
    ...
    if ( !v4 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      return 0;
    v13 = *(_QWORD *)a2;
    v8 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, v10) + 69160);
    v12 = 45;
    goto LABEL_37;
  }
  return 1;
