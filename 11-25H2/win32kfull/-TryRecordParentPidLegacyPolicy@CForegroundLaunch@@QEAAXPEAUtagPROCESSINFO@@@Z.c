/*
 * XREFs of ?TryRecordParentPidLegacyPolicy@CForegroundLaunch@@QEAAXPEAUtagPROCESSINFO@@@Z @ 0x14028F334
 * Callers:
 *     EditionPushExitingAppForegroundPolicy @ 0x1401E7120 (EditionPushExitingAppForegroundPolicy.c)
 * Callees:
