/*
 * XREFs of ?SaveShellRequestedOperationData@@YA_NPEAUtagWND@@AEBUtagRECT@@W4State@AdvancedWindowPos@@K@Z @ 0x1402CC850
 * Callers:
...
bool __fastcall SaveShellRequestedOperationData(struct tagWND *a1, __int128 *a2, int a3, int a4)
{
  __int128 v4; // xmm0
