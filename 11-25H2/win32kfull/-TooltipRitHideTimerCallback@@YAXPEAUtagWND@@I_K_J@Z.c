/*
 * XREFs of ?TooltipRitHideTimerCallback@@YAXPEAUtagWND@@I_K_J@Z @ 0x1402DD0F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall TooltipRitHideTimerCallback(struct tagWND *a1, __int64 a2)
{
  __int64 v2; // rbx
  ...
  *(_QWORD *)(v2 + 120) = 0LL;
  if ( v3 )
    PostEventMessageWindow(v3, 0x1Au, (LARGE_INTEGER)*(int *)(v2 + 200), 1LL);
}
