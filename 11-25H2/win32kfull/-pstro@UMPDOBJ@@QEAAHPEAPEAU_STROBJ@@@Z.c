/*
 * XREFs of ?pstro@UMPDOBJ@@QEAAHPEAPEAU_STROBJ@@@Z @ 0x1400D1438
 * Callers:
...
__int64 __fastcall UMPDOBJ::pstro(UMPDOBJ *this, struct _STROBJ **a2)
{
  ...
  if ( *a2 )
  {
    ...
    if ( v6 )
    {
      if ( !(unsigned int)UMPDOBJ::ThunkMemBlock(this, &v13, 2 * *(_DWORD *)v2) )
        return 0LL;
      v6 = v13;
    }
    v7 = (void *)v2[4];
...
LABEL_9:
      ...
      v16 = v6;
      v15 = v7;
      LOBYTE(v3) = (unsigned int)UMPDOBJ::ThunkDDIOBJ(this, (UMPDOBJ *)((char *)this + 208), (void **)a2, 0x30u, v14) != 0;
      return v3;
    }
    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(this, &v13, 24 * *(_DWORD *)v2) )
    {
      v7 = v13;
      KernelPtr = UMPDOBJ::GetKernelPtr(this, v13);
      for ( i = 0; i < *(_DWORD *)v2; KernelPtr[3 * v10 + 1] = 0LL )
        v10 = i++;
      goto LABEL_9;
    }
    return 0LL;
