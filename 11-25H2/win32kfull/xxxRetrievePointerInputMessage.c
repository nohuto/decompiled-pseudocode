/*
 * XREFs of xxxRetrievePointerInputMessage @ 0x1401C51F8
 * Callers:
...
LABEL_108:
    ...
    if ( ((v104 + 2) & 0xFFFFFFFD) == 0 )
    {
      ...
      v102 = BYTE2(v17);
      v101 = v17;
      v64 = *(_QWORD *)(W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, 0LL) + 69160);
      v100 = v18;
      v99 = v60;
      v97 = 18;
      goto LABEL_188;
  ...
  {
    ThreadPointerData = FindThreadPointerData((struct _LIST_ENTRY *)(v16 + 1208), v17);
