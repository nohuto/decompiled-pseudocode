/*
 * XREFs of RemoveProcessFromJob @ 0x1401C3830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RemoveProcessFromJob(__int64 a1)
{
  ...
  {
    if ( (unsigned int)i >= *(_DWORD *)(v1 + 28) )
    {
    ...
    if ( a1 == *(_QWORD *)(*(_QWORD *)(v1 + 40) + 8 * i) )
      break;
  }
  *(_QWORD *)(a1 + 752) = 0LL;
  memmove(
    (void *)(*(_QWORD *)(v1 + 40) + 8 * i),
    (const void *)(*(_QWORD *)(v1 + 40) + 8 * i + 8),
    8LL * (unsigned int)(*(_DWORD *)(v1 + 28) - i - 1));
  if ( (*(_DWORD *)(v1 + 28))-- == 1 )
  {
