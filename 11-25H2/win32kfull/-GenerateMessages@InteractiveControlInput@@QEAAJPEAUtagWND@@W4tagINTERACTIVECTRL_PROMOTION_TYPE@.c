/*
 * XREFs of ?GenerateMessages@InteractiveControlInput@@QEAAJPEAUtagWND@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@@I@Z @ 0x14021A32C
 * Callers:
 ...
 *     ?FlushBufferedInput@InteractiveControlDevice@@QEAAXI@Z @ 0x1402ED520 (-FlushBufferedInput@InteractiveControlDevice@@QEAAXI@Z.c)
 ...
 *     ?GenerateCtrlInputMessages@InteractiveControlInput@@IEAAJPEAUtagWND@@I@Z @ 0x1402EE158 (-GenerateCtrlInputMessages@InteractiveControlInput@@IEAAJPEAUtagWND@@I@Z.c)
 */
