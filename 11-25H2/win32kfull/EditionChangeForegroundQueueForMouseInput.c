/*
 * XREFs of EditionChangeForegroundQueueForMouseInput @ 0x140238340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Feature_Bugfix_57240160__private_IsEnabledDeviceUsageNoInline @ 0x140276FA8 (Feature_Bugfix_57240160__private_IsEnabledDeviceUsageNoInline.c)
 */
...
__int64 __fastcall EditionChangeForegroundQueueForMouseInput(__int64 a1, UIPrivilegeIsolation *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( !UIPrivilegeIsolation::CheckAccess(
            a2,
            (const struct tagUIPI_INFO *)(*(_QWORD *)(*((_QWORD *)v6 + 2) + 472LL) + 448LL),
            v5) )
    {
      v9 = *((_QWORD *)v6 + 2);
      v10 = *(_QWORD *)(v9 + 472);
      v11 = *(_DWORD *)(v10 + 456);
      BugCheckParameter3 = *(_QWORD *)(v10 + 448);
      LODWORD(v30) = v11;
  ...
  if ( (*((_DWORD *)CompositionInputWindowUIOwner + 95) & 0x2000) == 0 )
  {
    ...
    if ( (*(_BYTE *)(*(_QWORD *)(NonChildAncestor + 40) + 27LL) & 8) != 0
      || (v17 = *(_QWORD *)(NonChildAncestor + 136),
          v18 = *(__int16 **)(v17 + 8),
          v19 = *v18,
          v19 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v17, v18) + 19872) + 898LL))
