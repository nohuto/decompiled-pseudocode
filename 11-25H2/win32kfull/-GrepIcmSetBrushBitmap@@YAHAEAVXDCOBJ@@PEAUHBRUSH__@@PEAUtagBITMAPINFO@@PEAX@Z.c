/*
 * XREFs of ?GrepIcmSetBrushBitmap@@YAHAEAVXDCOBJ@@PEAUHBRUSH__@@PEAUtagBITMAPINFO@@PEAX@Z @ 0x14033D8F8
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (*((_DWORD *)*a1 + 30) & 1) != 0 )
  {
    BRUSHSELOBJ::BRUSHSELOBJ((BRUSHSELOBJ *)v13, a2, (__int64)a3, a4);
    v8 = (BRUSH *)v13[0];
