/*
 * XREFs of ?DDEImpDecRefInitWorker@@YAXPEAX@Z @ 0x140201A40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DDEImpDecRefInitWorker(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    Prop = GetProp(v4, *(unsigned __int16 *)(UserSessionState + 41340), 1u);
    v9 = (_WORD *)Prop;
    if ( Prop )
    {
      if ( (*(_WORD *)(Prop + 88))-- == 1 )
      {
        ...
        InternalRemoveProp(v4, *(unsigned __int16 *)(v11 + 41340), 1u);
        if ( !v9[45] )
        {
