/*
 * XREFs of ?InsertTooltipRegistration@TooltipDismiss@@YA_NPEAUHWND__@@@Z @ 0x1402DF9F0
 * Callers:
...
char __fastcall TooltipDismiss::InsertTooltipRegistration(TooltipDismiss *this, HWND a2)
{
  ...
  for ( i = *(_QWORD *)(W32GetUserSessionState(this, a2) + 71200); i; i = *(_QWORD *)(i + 8) )
  {
  ...
  *v5 = this;
  v8 = *(_QWORD *)(W32GetUserSessionState(v7, v6) + 71200);
  v5[1] = v8;
  *(_QWORD *)(W32GetUserSessionState(v8, v9) + 71200) = v5;
  return 1;
}
