/*
 * XREFs of ?vFillGRectDIB8@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x14031BF30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vFillGRectDIB8(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  v5 = *((_DWORD *)v2 + 9);
  v6 = (unsigned __int8 *)&unk_140364000;
  v7 = byte_140363D00;
  v8 = v4;
  v49 = v5;
  v9 = (unsigned __int8 *)&unk_140363E80;
  v37 = *((_DWORD *)a1 + 22);
  v10 = (unsigned __int8 *)&unk_1403641C0;
  v51 = v5 + *((_DWORD *)v2 + 11);
  v35 = (unsigned __int8 *)&unk_140364000;
  ...
  {
    v9 = byte_140363D00;
    v10 = (unsigned __int8 *)&unk_140364000;
  }
