/*
 * XREFs of SetGestureConfigSettings @ 0x1401BDD88
 * Callers:
 ...
 *     ?SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z @ 0x1401BDEF0 (-SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z.c)
 ...
 *     ?GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z @ 0x1401BE558 (-GetGCData@@YAPEAUtagVWPLGESTUREDATA@@PEAUtagWND@@@Z.c)
...
LABEL_5:
    ...
    *v11 = 0;
    v8[2] = 0LL;
    VWPLAddBase(
      (struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 464LL) + 856LL),
      (unsigned __int64)v8,
      a1,
      5u,
      v19);
