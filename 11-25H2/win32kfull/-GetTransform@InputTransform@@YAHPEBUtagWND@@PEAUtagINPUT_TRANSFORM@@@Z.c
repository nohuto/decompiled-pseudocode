/*
 * XREFs of ?GetTransform@InputTransform@@YAHPEBUtagWND@@PEAUtagINPUT_TRANSFORM@@@Z @ 0x140185698
 * Callers:
 *     EditionGetInputTransform @ 0x140223610 (EditionGetInputTransform.c)
 * Callees:
        ...
        struct tagINPUT_TRANSFORM *a3)
{
  ...
  if ( !(unsigned __int8)IsInputThread(this, a2, a3) )
  {
    ...
    if ( v10 != *(struct tagTHREADINFO **)(W32GetUserSessionState(v12, v11) + 18824) )
      return 0LL;
  }
  v7 = *((_QWORD *)this + 34);
  if ( !v7 )
