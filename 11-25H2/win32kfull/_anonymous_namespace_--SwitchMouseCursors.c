/*
 * XREFs of _anonymous_namespace_::SwitchMouseCursors @ 0x1402A5508
 * Callers:
...
void __fastcall anonymous_namespace_::SwitchMouseCursors(int a1, __int64 a2)
{
  ...
  if ( (_DWORD)v3 )
  {
    ...
    {
      if ( (_DWORD)v4 == 1 )
        _InterlockedOr((volatile signed __int32 *)(*(_QWORD *)(W32GetUserSessionState(v4, a2) + 36312) + 100LL), 1u);
      else
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 457);
    }
    else
    {
      v5 = *(_QWORD *)(W32GetUserSessionState(v4, a2) + 36312);
      _InterlockedAnd((volatile signed __int32 *)(v5 + 100), 0xFFFFF8FF);
      _InterlockedOr((volatile signed __int32 *)(*(_QWORD *)(W32GetUserSessionState(v5, v6) + 36312) + 100LL), 0x100u);
    }
  }
  else
  {
    v7 = *(_QWORD *)(W32GetUserSessionState(v3, a2) + 36312);
    _InterlockedAnd((volatile signed __int32 *)(v7 + 100), 0xFFFFF8FF);
    _InterlockedOr(
      (volatile signed __int32 *)(*(_QWORD *)(W32GetUserSessionState(v7, v8) + 36312) + 100LL),
      (v2 + 1) << 9);
  }
}
