/*
 * XREFs of ?IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z @ 0x1401BEE4C
 * Callers:
 *     ?ProbeAndReadIFIMETRICS@@YAPEAU_IFIMETRICS@@PEAU1@H_K@Z @ 0x1401BED10 (-ProbeAndReadIFIMETRICS@@YAPEAU_IFIMETRICS@@PEAU1@H_K@Z.c)
 * Callees:
 *     ?IsValidString@@YA_NPEBXKJ@Z @ 0x1401BEFE8 (-IsValidString@@YA_NPEBXKJ@Z.c)
 *     ?IsValidFONTSIM@@YA_NPEBXKJ@Z @ 0x1401BF02C (-IsValidFONTSIM@@YA_NPEBXKJ@Z.c)
 *     ?IsValidAXESLISTW@@YA_NPEBXKJ@Z @ 0x140334804 (-IsValidAXESLISTW@@YA_NPEBXKJ@Z.c)
 *     ?IsValidDESIGNVECTOR@@YA_NPEBXKJ@Z @ 0x140334858 (-IsValidDESIGNVECTOR@@YA_NPEBXKJ@Z.c)
 */
