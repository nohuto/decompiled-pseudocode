/*
 * XREFs of UserGetHwnd @ 0x140287EEC
 * Callers:
 ...
 *     ?PwndFromHDC@@YAPEBUtagWND@@QEAUHDC__@@@Z @ 0x14014FF10 (-PwndFromHDC@@YAPEBUtagWND@@QEAUHDC__@@@Z.c)
 */
...
__int64 __fastcall UserGetHwnd(HDC a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( v9 )
  {
    ...
    *a2 = *(_QWORD *)v9;
    ...
    v6 = 1;
    *a3 = GetProp(v12, *(unsigned __int16 *)(v14 + 41342), 1u);
  }
