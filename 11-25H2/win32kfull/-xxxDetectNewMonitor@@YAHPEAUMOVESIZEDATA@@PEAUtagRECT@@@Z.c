/*
 * XREFs of ?xxxDetectNewMonitor@@YAHPEAUMOVESIZEDATA@@PEAUtagRECT@@@Z @ 0x14028373C
 * Callers:
...
__int64 __fastcall xxxDetectNewMonitor(struct MOVESIZEDATA *this, struct tagRECT *a2)
{
  ...
  if ( v98 && v7 && v98 != v7 )
  {
    ...
    if ( (unsigned int)(*((_DWORD *)this + 44) - 9) <= 1 )
    {
      ...
      v91 = *(_QWORD *)((char *)this + 260);
      v53 = *(_QWORD *)(v98 + 40);
      v54 = *(_WORD *)(*(_QWORD *)(v14 + 40) + 60LL);
      v103 = 0LL;
      TransformRectAroundPoint(&v105, *(_WORD *)(v53 + 60), v12, &v103, v54, v91);
        ...
        *(_QWORD *)&v104.left = v99;
        ...
        else
        {
          *(_QWORD *)&v103.left = v96;
          ...
          right = LOBYTE(v101.right) + v61 - LOBYTE(v101.left);
          v65 = v101.bottom + HIDWORD(BugCheckParameter3) + *((_DWORD *)this + 43) - v101.top;
          v104.bottom = v65;
          v104.left = v61;
          v104.top = v60;
          v104.right = v101.right + v61 - v101.left;
        }
        *v3 = v104;
        if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
          || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 1) == 0
    ...
    else
    {
      ...
      if ( v103.right - v103.left <= *((_DWORD *)this + 26) )
        v38 = *((_DWORD *)this + 26);
      v39 = *(_QWORD *)(*(_QWORD *)(v35 + 19872) + 4960LL);
...
LABEL_76:
  ...
  *((_QWORD *)this + 27) = v7;
  if ( v98 )
  {
    if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
      || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 1) == 0
      || (v71 = 1, *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) < 4u) )
    {
      v71 = 0;
    }
    v95 = v71;
    ...
    if ( v71 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      v79 = v76[8];
      v80 = v76[7];
      v81 = W32GetUserSessionState(v76, &WPP_RECORDER_INITIALIZED);
      LOBYTE(v82) = v97;
      LOBYTE(v83) = v95;
      v94 = v74;
      v10 = 1;
  ...
  if ( v10 || v8 )
  {
    ...
    v86 = v3->right;
    left = v3->left;
    v88 = W32GetUserSessionState(*(_QWORD *)&WPP_GLOBAL_Control, &WPP_RECORDER_INITIALIZED);
    LOBYTE(v89) = v8;
    LOBYTE(v90) = v10;
    WPP_RECORDER_AND_TRACE_SF_dddddd(
      *(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 24LL),
