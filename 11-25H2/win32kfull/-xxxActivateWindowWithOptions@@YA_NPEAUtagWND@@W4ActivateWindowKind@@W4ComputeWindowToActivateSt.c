/*
 * XREFs of ?xxxActivateWindowWithOptions@@YA_NPEAUtagWND@@W4ActivateWindowKind@@W4ComputeWindowToActivateStrategy@@W4WindowActivateReason@@W4LocalActivationOptions@@@Z @ 0x1401BB244
 * Callers:
...
LABEL_174:
  ...
  if ( v6 )
  {
    ...
    {
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3978LL);
      v29 = (struct tagWND *)v119;
      v28 = DWORD2(v119);
    }
    v30 = v121 == v29;
  ...
  {
    if ( a3 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3966LL);
    v27 = 0;
    v28 = 1;
    v116 = v20 == 1;
  }
...
LABEL_166:
  ...
  if ( !v28 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3997LL);
  if ( v27 )
    Win32HM_LockIntoThread<0>((__int64)v118, v22, BugCheckParameter3);
  v31 = a5;
  if ( (a5 & 0x100) != 0 && *(struct tagTHREADINFO **)(v22 + 16) != v118 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 4006LL);
  ...
  if ( *((_QWORD *)v32 + 59) != *((_QWORD *)v118 + 59) )
  {
    ...
    else
    {
      if ( v28 != 6 )
      {
        v71 = *(_QWORD *)(W32GetUserSessionState((unsigned int)(v28 - 5), &WPP_RECORDER_INITIALIZED) + 18888);
        if ( v71 != *((_QWORD *)v118 + 59) && *(_QWORD *)(W32GetUserSessionState(v71, v7) + 18888) )
        {
          v56 = 0;
          goto LABEL_175;
        }
...
LABEL_125:
        ...
        v98 = v57 | 4;
        v100 = *(_QWORD *)(W32GetUserSessionState(v92, v64) + 18888);
        if ( *(_QWORD *)(*((_QWORD *)v121 + 2) + 472LL) == v100
          && *(_QWORD *)(W32GetUserSessionState(v100, v99) + 18888) == *((_QWORD *)v118 + 59) )
        {
        ...
        if ( (v31 & 2) == 0 )
          v106 = v31 & 0x100;
        v56 = xxxSetForegroundWindowWithOptions(v121, v98, v106);
        if ( *(unsigned int **)&WPP_GLOBAL_Control == &WPP_GLOBAL_Control
          || (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 44LL) & 2) == 0
          || *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control + 41LL) < 4u )
        {
...
LABEL_124:
  ...
  if ( v33 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v38) = v34;
    LOBYTE(v39) = v33;
    WPP_RECORDER_AND_TRACE_SF_dq(*(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 24LL), v39, v38, *(_QWORD *)(v37 + 69160));
    v22 = (__int64)v121;
  }
