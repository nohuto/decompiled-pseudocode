/*
 * XREFs of ?pxrlStrRead08@stretch@@YAPEAU_XRUNLEN@1@PEAU_STRDDA@1@PEAU_STRRUN@1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1401A38A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v27 = *v10++;
        if ( a5 )
          LODWORD(v27) = *(_DWORD *)(*((_QWORD *)a5 + 2) + 4 * v27);
        if ( (dword_140355080[v25] & v39) != 0 )
        {
  ...
  else
  {
    ...
    *((_DWORD *)a2 + 3) = *((_DWORD *)this + 2) - *(_DWORD *)this;
      ...
      if ( a5 )
      {
        ...
        do
        {
          ...
          if ( (_DWORD)v16 )
          {
            ...
            do
            {
              *v17++ = *(_DWORD *)(*((_QWORD *)a5 + 2) + 4LL * *v10);
              LODWORD(v16) = v16 - 1;
            }
            while ( (_DWORD)v16 );
          }
    ...
    return (struct stretch::_XRUNLEN *)&v9[(int)a4 + 2];
  }
}
