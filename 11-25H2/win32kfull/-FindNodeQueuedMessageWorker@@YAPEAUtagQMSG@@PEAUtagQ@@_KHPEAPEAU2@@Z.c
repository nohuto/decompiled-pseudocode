/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x140068900
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1400688D0 (EditionFindNodeQueuedMessage.c)
 * Callees:
...
struct tagQMSG *__fastcall FindNodeQueuedMessageWorker(struct tagQ *a1, __int64 a2, __int64 a3, struct tagQ **a4)
{
  ...
  if ( v4 )
  {
    do
    {
      if ( (unsigned int)IsPointerInputMessage(*(_DWORD *)(v4 + 24))
        && *(_QWORD *)(v4 + 40) == v9
