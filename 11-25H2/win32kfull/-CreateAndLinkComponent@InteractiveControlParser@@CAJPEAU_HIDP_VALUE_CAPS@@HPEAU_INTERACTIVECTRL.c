/*
 * XREFs of ?CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@@Z @ 0x1402F23D4
 * Callers:
 ...
 * Callees:
 *     ?GetComponentMultiplier@InteractiveControlParser@@SAXPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@PEAJ1@Z @ 0x1402F285C (-GetComponentMultiplier@InteractiveControlParser@@SAXPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@PEA.c)
 *     ?GetComponentType@InteractiveControlParser@@CA?AW4_INTERACTIVECTRL_COMPONENT_TYPE@@GG@Z @ 0x1402F2914 (-GetComponentType@InteractiveControlParser@@CA-AW4_INTERACTIVECTRL_COMPONENT_TYPE@@GG@Z.c)
