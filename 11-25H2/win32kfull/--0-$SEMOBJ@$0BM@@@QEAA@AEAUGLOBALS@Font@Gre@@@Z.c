/*
 * XREFs of ??0?$SEMOBJ@$0BM@@@QEAA@AEAUGLOBALS@Font@Gre@@@Z @ 0x140109010
 * Callers:
...
HSEMAPHORE *__fastcall SEMOBJ<28>::SEMOBJ<28>(HSEMAPHORE *a1, __int64 a2)
{
  HSEMAPHORE v3; // rcx
  ...
  *a1 = v3;
  ...
  {
    v7 = *(_QWORD *)v4;
    if ( (*(_QWORD *)v4 & 0xFFFFFFFFF0000000uLL) != 0 && (v7 & 0x10000000) == 0 )
    {
      v9 = 37;
      do
      {
