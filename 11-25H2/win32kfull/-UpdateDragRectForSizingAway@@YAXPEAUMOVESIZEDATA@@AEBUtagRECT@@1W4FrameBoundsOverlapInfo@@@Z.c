/*
 * XREFs of ?UpdateDragRectForSizingAway@@YAXPEAUMOVESIZEDATA@@AEBUtagRECT@@1W4FrameBoundsOverlapInfo@@@Z @ 0x1402A81F8
 * Callers:
...
__int64 __fastcall UpdateDragRectForSizingAway(__int64 a1, _DWORD *a2, _DWORD *a3, char a4)
{
  ...
  struct tagRECT v41; // [rsp+70h] [rbp-28h] BYREF
...
LABEL_33:
  ...
  else
  {
    ...
    FrameBoundsOverlapInfo = GetFrameBoundsOverlapInfo(a2, &v41, 0);
...
LABEL_65:
  ...
  if ( v31 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v38) = v32;
    LOBYTE(v39) = v31;
    return WPP_RECORDER_AND_TRACE_SF_dddddd(
             *(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control + 24LL),
             v39,
             v38,
             *(_QWORD *)(v37 + 69160),
             ...
             v35,
             v33,
             (unsigned __int8)v35 - (unsigned __int8)v36,
             (unsigned __int8)v33 - (unsigned __int8)v34);
  }
  return result;
}
