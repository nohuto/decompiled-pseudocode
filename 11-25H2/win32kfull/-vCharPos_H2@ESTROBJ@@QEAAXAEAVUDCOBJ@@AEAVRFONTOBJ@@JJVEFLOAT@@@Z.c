/*
 * XREFs of ?vCharPos_H2@ESTROBJ@@QEAAXAEAVUDCOBJ@@AEAVRFONTOBJ@@JJVEFLOAT@@@Z @ 0x1401CE6D0
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    else
    {
      ...
      {
        a1[25] = -*(_DWORD *)(v22 + 312);
        result = *(_QWORD *)a3;
        v23 = -*(_DWORD *)(*(_QWORD *)a3 + 308LL);
      }
      else
      {
        a1[25] = *(_DWORD *)(v22 + 308);
        result = *(_QWORD *)a3;
        v23 = *(_DWORD *)(*(_QWORD *)a3 + 312LL);
      }
      a1[27] = v23;
      a1[21] = 0;
      a1[20] = v16;
