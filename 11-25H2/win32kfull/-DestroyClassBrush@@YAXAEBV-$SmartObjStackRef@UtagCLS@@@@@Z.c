/*
 * XREFs of ?DestroyClassBrush@@YAXAEBV?$SmartObjStackRef@UtagCLS@@@@@Z @ 0x1400B379C
 * Callers:
  ...
  *((_QWORD *)v6 + 209) = &v15;
  if ( *(_QWORD *)(*(_QWORD *)(**a1 + 8) + 72LL) > 0x1FuLL )
  {
    for ( i = 0LL; (unsigned int)i < 0x1F; i = (unsigned int)(i + 1) )
    {
      ...
      if ( v11 == *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(v10, v7) + 19872) + 8 * i + 4696) )
        return SmartObjStackRefBase<tagCLS>::~SmartObjStackRefBase<tagCLS>((__int64 *)&v14, (__int64)v7);
    }
    for ( j = *(_QWORD *)(v5 + 352); ; j = **v14 )
    {
