/*
 * XREFs of xxxRemoteShadowSetup @ 0x1402B9814
 * Callers:
 *     NtUserRemoteShadowSetup @ 0x14029D5B0 (NtUserRemoteShadowSetup.c)
 * Callees:
...
__int64 __fastcall xxxRemoteShadowSetup(__int64 a1, __int64 a2)
{
  ...
  if ( PsGetCurrentProcess(v9) != v8 )
    return 3221225506LL;
  if ( *(_DWORD *)(W32GetUserSessionState(v11, v10) + 68904) || *(_DWORD *)(W32GetUserSessionState(v14, v13) + 68756) )
