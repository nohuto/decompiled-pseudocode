/*
 * XREFs of ?ClassicIsWindowHit@@YAHPEAUtagWND@@UtagPOINT@@@Z @ 0x14008CAA0
 * Callers:
...
_BOOL8 __fastcall ClassicIsWindowHit(struct tagWND *a1, struct tagPOINT a2)
{
  ...
  {
    v5 = *(_QWORD *)(v4 + 168);
    if ( !v5 || (unsigned int)GrePtInRegion(v5, (unsigned int)a2.x) )
    {
      ...
      if ( (v6[24] & 0x20) == 0 )
      {
        ...
        if ( (unsigned int)GrePtInSprite(*(HDEV *)(*(_QWORD *)(UserSessionState + 56968) + 48LL), v10 >= 0x602u, v11) )
          return 1;
      }
    }
  }
