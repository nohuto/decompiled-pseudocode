/*
 * XREFs of ?SmuggleHidData@RawInput@InputTraceLogging@@SAXPEAX_NKK11@Z @ 0x14022BFA4
 * Callers:
        ...
        bool a6)
{
  ...
  if ( (unsigned int)dword_14039BB50 > 5 && tlgKeywordOn((__int64)&dword_14039BB50, 0x40000LL) )
  {
    v11 = "Posted";
    v13 = v8;
    if ( !a6 )
