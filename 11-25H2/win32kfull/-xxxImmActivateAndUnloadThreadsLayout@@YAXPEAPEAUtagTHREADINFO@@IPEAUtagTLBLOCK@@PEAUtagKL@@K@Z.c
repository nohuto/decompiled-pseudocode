/*
 * XREFs of ?xxxImmActivateAndUnloadThreadsLayout@@YAXPEAPEAUtagTHREADINFO@@IPEAUtagTLBLOCK@@PEAUtagKL@@K@Z @ 0x140282610
 * Callers:
 ...
 *     EditionImmActivateAndUnloadThreadsLayout @ 0x1402A6710 (EditionImmActivateAndUnloadThreadsLayout.c)
 * Callees:
    ...
    if ( *(_QWORD *)(*v14 + 824) )
    {
      ...
      if ( v17 )
      {
        if ( (a5 != 1
           ...
           || (**(_DWORD **)(W32GetUserSessionState(57344LL, v10) + 19872) & 4) != 0)
          && v13 != -65536 )
        {
          v13 |= 2u;
        }
