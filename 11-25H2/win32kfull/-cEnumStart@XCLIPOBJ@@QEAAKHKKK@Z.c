/*
 * XREFs of ?cEnumStart@XCLIPOBJ@@QEAAKHKKK@Z @ 0x1400F596C
 * Callers:
 ...
 *     CLIPOBJ_cEnumStart @ 0x1400F5140 (CLIPOBJ_cEnumStart.c)
 ...
 *     WNDOBJ_cEnumStart @ 0x140303090 (WNDOBJ_cEnumStart.c)
