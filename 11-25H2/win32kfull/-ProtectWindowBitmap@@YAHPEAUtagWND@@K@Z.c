/*
 * XREFs of ?ProtectWindowBitmap@@YAHPEAUtagWND@@K@Z @ 0x1402DDFCC
 * Callers:
...
__int64 __fastcall ProtectWindowBitmap(struct tagWND *a1, char a2)
{
  ...
  v4 = a2 & 1;
  if ( (a2 & 1) != 0 )
    v5 = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 464LL) + 56LL);
  else
    v5 = 0LL;
  ...
  if ( v6 )
  {
    if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 26LL) & 8) != 0 )
    {
      ...
      v6 = GreProtectSpriteContent(*(_QWORD *)(*(_QWORD *)(UserSessionState + 56968) + 48LL), v8, v9, a2);
      if ( !v6 )
      {
        if ( v4 )
