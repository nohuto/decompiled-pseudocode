/*
 * XREFs of ?Cleanup@ThreadLockedPerfRegion@InputTraceLogging@@AEAAXXZ @ 0x14026DC34
 * Callers:
 ...
 *     ?_lambda_invoker_cdecl_@_lambda_d164783eb83be554e1610dcbf87b8416_@@CA@PEAX@Z @ 0x1402743A0 (-_lambda_invoker_cdecl_@_lambda_d164783eb83be554e1610dcbf87b8416_@@CA@PEAX@Z.c)
 * Callees:
...
void __fastcall InputTraceLogging::ThreadLockedPerfRegion::Cleanup(void ***this, __int64 a2)
{
  ...
  if ( (unsigned int)dword_14039BB50 > 6 && tlgKeywordOn((__int64)&dword_14039BB50, 1LL) )
  {
  ...
  Win32FreeToPagedLookasideList(*(_QWORD *)(UserSessionState + 19344), v5);
}
