/*
 * XREFs of ?CreateDesktopNotificationEvent@@YAJPEAX@Z @ 0x1402156F4
 * Callers:
...
__int64 __fastcall CreateDesktopNotificationEvent(void *a1, __int64 a2)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  if ( *(_DWORD *)(W32GetUserSessionState(a1, a2) + 68612) )
  {
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v6 = v10;
      *(PVOID *)(UserSessionState + 62968) = DestinationString[0];
      if ( v10 >= 0 )
      {
        UserGdiSessionState = W32GetUserGdiSessionState(v11);
        KeAttachProcess(*(PRKPROCESS *)(UserGdiSessionState + 40));
        Handle = (void **)(W32GetUserSessionState(v14, v13) + 62960);
        v18 = W32GetUserSessionState(v17, v16);
        v6 = ObOpenObjectByPointer(*(PVOID *)(v18 + 62968), 0, 0LL, 0x1F0003u, 0LL, 0, Handle);
        KeDetachProcess();
      }
      ZwClose(EventHandle);
    }
