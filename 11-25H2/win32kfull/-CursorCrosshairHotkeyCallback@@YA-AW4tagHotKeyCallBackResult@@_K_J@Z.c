/*
 * XREFs of ?CursorCrosshairHotkeyCallback@@YA?AW4tagHotKeyCallBackResult@@_K_J@Z @ 0x14028D8A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CursorCrosshairHotkeyCallback(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19144) + 40LL) )
  {
    v10 = 0;
    if ( (unsigned int)xxxSystemParametersInfo(8244LL, 0LL, &v10, 0LL) )
    {
      ...
      if ( (unsigned int)xxxSystemParametersInfo(8245LL, 0LL, v2, 2LL) )
      {
        ...
        FastWriteProfileValue(*(_QWORD *)(*(_QWORD *)(UserSessionState + 19144) + 40LL) + 200LL, v5, v4, 4LL, &v10, 4);
      }
    }
  }
  return 0LL;
