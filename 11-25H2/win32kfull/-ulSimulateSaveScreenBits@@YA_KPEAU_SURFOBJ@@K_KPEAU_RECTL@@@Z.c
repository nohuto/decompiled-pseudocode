/*
 * XREFs of ?ulSimulateSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x140333F90
 * Callers:
  ...
  else
  {
    ...
    if ( v12 )
    {
      ...
      if ( ((__int64)v12[1].hsurf & 0x400) != 0 )
        (*((void (__fastcall **)(SURFOBJ *, struct _SURFOBJ *, _QWORD, _QWORD, _DWORD *, struct _RECTL *))hdev + 354))(
          v12,
          a1,
          0LL,
          0LL,
