/*
 * XREFs of EditionUpdateInputTransformFromHitTest @ 0x140119B20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InitInputTransformList@@YAPEAUtagINPUTTRANSFORMLIST@@PEAUtagWND@@@Z @ 0x14011ACEC (-InitInputTransformList@@YAPEAUtagINPUTTRANSFORMLIST@@PEAUtagWND@@@Z.c)
