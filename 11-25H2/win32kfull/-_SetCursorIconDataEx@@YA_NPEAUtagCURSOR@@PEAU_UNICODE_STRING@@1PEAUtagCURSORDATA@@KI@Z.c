/*
 * XREFs of ?_SetCursorIconDataEx@@YA_NPEAUtagCURSOR@@PEAU_UNICODE_STRING@@1PEAUtagCURSORDATA@@KI@Z @ 0x140131284
 * Callers:
        ...
        unsigned int a6)
{
  ...
  __int64 v61; // rdx
  HSURF v63; // rcx
  _QWORD v64[4]; // [rsp+30h] [rbp-B8h] BYREF
  _OWORD v65[2]; // [rsp+50h] [rbp-98h] BYREF
  _DWORD v66[12]; // [rsp+70h] [rbp-78h] BYREF
  _BYTE v67[72]; // [rsp+A0h] [rbp-48h] BYREF
  struct _UNICODE_STRING *v69; // [rsp+100h] [rbp+18h]
...
LABEL_13:
    if ( a2->Buffer )
    {
      ...
      *((_WORD *)a1 + 36) = (int)RtlStringCchCopyW((char *)(UserSessionState + 41716), 256LL, (char *)a2->Buffer) < 0
                          ? 0
                          : UserAddAtomEx(v20, 0LL, 2LL);
      AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)v67);
      if ( !*((_WORD *)a1 + 36) )
      {
        if ( (v13 & 8) == 0 )
        {
...
LABEL_81:
      *((_QWORD *)a1 + 6) = a1;
      ...
      if ( (v58 & 0x40) == 0 )
      {
        ...
        if ( !v59 )
        {
          v60 = *(_QWORD *)(W32GetUserSessionState(v58, v32) + 36280);
          *((_QWORD *)a1 + 4) = v60;
          *(_QWORD *)(W32GetUserSessionState(v60, v61) + 36280) = a1;
LABEL_86:
          *((_DWORD *)a1 + 20) |= 0x100u;
          return 1;
        }
    ...
    v47 = *((_QWORD *)_GetCurrentLogicalCursorThread(v24, (__int64)a2) + 58);
    *((_QWORD *)a4 + 6) = 0LL;
    ...
    *((_QWORD *)a1 + 11) = 0LL;
    *((_QWORD *)a1 + 12) = 0LL;
    v48 = (HSURF *)((char *)a4 + 32);
    v49 = (HSURF)*((_QWORD *)a4 + 4);
    v50 = (Gre::Base **)((char *)a4 + 32);
    if ( v49 )
    {
      if ( (int)GreReferenceObject(v49) < 0 )
      {
        GreDeleteObject(*v48);
        v51 = *((_QWORD *)a4 + 5);
        if ( v51 )
      ...
      v50 = (Gre::Base **)(v64[0] + 32LL);
    }
    v52 = (HSURF)*((_QWORD *)a4 + 5);
    if ( v52 && (int)GreReferenceObject(v52) < 0 )
    {
    ...
    else
    {
      if ( *((_DWORD *)a1 + 35)
        ...
        && *v50
        && (!*((_QWORD *)a4 + 5)
         || (unsigned int)GreExtGetObjectW(*v50, 32LL, v65, v46)
         && (unsigned int)GreExtGetObjectW(*((Gre::Base **)a4 + 5), 32LL, v66, v54)
         && (v66[2] == SDWORD2(v65[0]) >> 1 || v66[2] == DWORD2(v65[0]))
         && v66[1] >= SDWORD1(v65[0])) )
      {
        *((_QWORD *)a1 + 11) = *((_QWORD *)a4 + 4);
        v55 = (HSURF)*((_QWORD *)a4 + 5);
        *((_QWORD *)a1 + 12) = v55;
        *((_QWORD *)a1 + 16) = ProcessAlphaBitmap(v55);
        GreSetBitmapOwner(*((_QWORD *)a1 + 11), 0LL);
        GreIncQuotaCount(v47);
        v56 = *((_QWORD *)a1 + 12);
        if ( v56 )
        {
          GreSetBitmapOwner(v56, 0LL);
          GreIncQuotaCount(v47);
        }
        v57 = *((_QWORD *)a1 + 16);
        if ( v57 )
        {
          GreSetBitmapOwner(v57, 0LL);
          GreIncQuotaCount(v47);
        }
        goto LABEL_81;
      }
