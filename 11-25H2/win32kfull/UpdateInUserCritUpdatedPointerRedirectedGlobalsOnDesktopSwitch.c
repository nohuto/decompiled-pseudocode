/*
 * XREFs of UpdateInUserCritUpdatedPointerRedirectedGlobalsOnDesktopSwitch @ 0x1401AA87C
 * Callers:
...
__int64 __fastcall UpdateInUserCritUpdatedPointerRedirectedGlobalsOnDesktopSwitch(__int64 a1, __int64 a2)
{
  ...
  UpdatePointerRedirIsAlive(*(_QWORD *)(*(_QWORD *)(UserSessionState + 19144) + 8LL));
  v5 = 0;
  v7 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 19144);
