/*
 * XREFs of ?vNextPoint@LINER@pathwide@@AEAAXXZ @ 0x1400A7190
 * Callers:
 *     ?vNextEvent@LINER@pathwide@@QEAAXXZ @ 0x1400A7690 (-vNextEvent@LINER@pathwide@@QEAAXXZ.c)
 * Callees:
 ...
 *     ?bNext@BEZIER@@QEAAHPEAU_POINTFIX@@@Z @ 0x1400A7A58 (-bNext@BEZIER@@QEAAHPEAU_POINTFIX@@@Z.c)
