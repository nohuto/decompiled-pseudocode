/*
 * XREFs of ?UpdateTrackerRegion@CVisRgnTrackerProp@@AEAAXKI@Z @ 0x1400381B0
 * Callers:
...
void __fastcall CVisRgnTrackerProp::UpdateTrackerRegion(CVisRgnTrackerProp *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  void *v37; // rax
  unsigned int v38; // [rsp+30h] [rbp-288h]
  HRGN v39; // [rsp+38h] [rbp-280h]
  __int64 v40; // [rsp+40h] [rbp-278h]
  char v41[8]; // [rsp+50h] [rbp-268h] BYREF
  int v42; // [rsp+58h] [rbp-260h]
  __int128 v43; // [rsp+70h] [rbp-248h]
...
LABEL_20:
  if ( !VisRgn )
  {
    ...
    if ( RegionData <= 0x220 )
    {
      if ( RegionData )
      {
        if ( (unsigned int)GreGetRegionData(v11, RegionData, v41) )
        {
          if ( !v42 )
          {
            v43 = 0LL;
...
LABEL_33:
    ...
    v34 = CreateEmptyRgn(v30, v29, v31, v32);
