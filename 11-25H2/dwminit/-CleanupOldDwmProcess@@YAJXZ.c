/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x18000AAF8
 * Callers:
 ...
 *     IsEnumDisplayDevicesWPresent @ 0x1800033A0 (IsEnumDisplayDevicesWPresent.c)
 ...
 *     ?ShouldRestartSession@@YA_NU_FILETIME@@@Z @ 0x18000CA7C (-ShouldRestartSession@@YA_NU_FILETIME@@@Z.c)
...
__int64 CleanupOldDwmProcess(void)
{
  ...
  DWORD i; // edx
  DWORD v13; // eax
  _unnamed_type_gDwmInitTelemetryAggregator_ *v14; // rcx
  __int64 v15; // r8
  __int64 v16; // r9
  ...
  if ( v0 < 0 )
  {
    DoStackCaptureDirect(v0, 0x437u);
LABEL_27:
    DwmpSignalSessionShutdown();
    v1 = -2147467259;
    ++HIDWORD(qword_180019E14);
    ++HIDWORD(qword_180019E1C);
    if ( SHIDWORD(qword_180019E1C) > 10 )
    {
      _unnamed_type_gDwmInitTelemetryAggregator_::ReportAggregatedValues(v14);
