/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180009840
 * Callers:
 *     <none>
 * Callees:
...
LABEL_19:
  ...
  {
    wil::details_abi::SubscriptionList::OnSignaled((LPCRITICAL_SECTION)&qword_1800190C0[25], qword_1800190C0);
    wil::details_abi::FeatureStateData::RecordUsage(qword_1800190C0);
  }
}
