/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_HangDetectionOnLogonUICallouts2@@@details@wil@@QEAA_NXZ @ 0x18000D0E0
 * Callers:
        ...
        wil::details *a1)
{
  ...
  v5 = 0;
  v6 = 1;
  wil::details::ReportUsageToService((__int64)a1 + 8, 0x36B7403u, (v2 >> 10) & 1, (v2 >> 11) & 1, (__int64)&v5, v3, 3);
  return v3;
}
