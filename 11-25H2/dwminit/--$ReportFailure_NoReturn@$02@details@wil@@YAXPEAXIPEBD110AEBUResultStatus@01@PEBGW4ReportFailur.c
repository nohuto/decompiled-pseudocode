/*
 * XREFs of ??$ReportFailure_NoReturn@$02@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180004094
 * Callers:
 ...
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180007870 (-RecordFailFast@details@wil@@YAHJ@Z.c)
