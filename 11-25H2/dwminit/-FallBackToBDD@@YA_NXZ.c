/*
 * XREFs of ?FallBackToBDD@@YA_NXZ @ 0x18000B410
 * Callers:
...
bool FallBackToBDD(void)
{
  ...
  if ( LibraryW )
  {
    ...
    if ( ProcAddress )
    {
      ...
      if ( v0 >= 0 )
      {
        LODWORD(qword_180019E14) = qword_180019E14 + 1;
        v6 = (unsigned int)(HIDWORD(qword_180019E1C) + 1);
        HIDWORD(qword_180019E1C) = v6;
        if ( (int)v6 > 10 )
        {
