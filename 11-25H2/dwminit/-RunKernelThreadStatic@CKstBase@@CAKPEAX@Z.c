/*
 * XREFs of ?RunKernelThreadStatic@CKstBase@@CAKPEAX@Z @ 0x180010100
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Log_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180010620 (-_Log_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
