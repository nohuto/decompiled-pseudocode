/*
 * XREFs of ?ReportUsageToServiceDirect@details@wil@@YAHPEAUwil_details_FeatureReportingCache@@IHHW4wil_details_ServiceReportingKind@@I_KE@Z @ 0x18000C888
 * Callers:
 ...
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x18000E238 (wil_details_FeatureReporting_RecordUsageInCache.c)
        ...
        char a8)
{
  ...
  if ( !(_DWORD)v15 && wil::details::g_enabledStateManager )
  {
    ...
    if ( !qword_1800193C0 )
    {
      ...
      {
        v18(&qword_1800193C0, _lambda_aa194dc0bf891154933407eb98fb868a_::_lambda_invoker_cdecl_, -1LL);
      }
    }
