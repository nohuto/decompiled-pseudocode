/*
 * XREFs of __scrt_release_startup_lock @ 0x1800024D8
 * Callers:
 *     dllmain_crt_process_attach @ 0x180003748 (dllmain_crt_process_attach.c)
 *     dllmain_crt_process_detach @ 0x180003860 (dllmain_crt_process_detach.c)
 * Callees:
 *     __scrt_is_ucrt_dll_in_use @ 0x180002C60 (__scrt_is_ucrt_dll_in_use.c)
 */
