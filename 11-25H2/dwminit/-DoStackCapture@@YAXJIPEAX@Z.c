/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x18000E520
 * Callers:
 ...
 * Callees:
 *     __std_find_trivial_8 @ 0x180002040 (__std_find_trivial_8.c)
...
void __fastcall DoStackCapture(int a1, int a2, unsigned __int64 a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_180019E24, 1, 0) )
  {
