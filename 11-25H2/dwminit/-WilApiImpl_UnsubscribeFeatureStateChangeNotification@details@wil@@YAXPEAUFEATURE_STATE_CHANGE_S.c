/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x1800099C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_1800190C8, v2);
}
