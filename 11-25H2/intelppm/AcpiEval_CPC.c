/*
 * XREFs of AcpiEval_CPC @ 0x140031088
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  v29 = AcpiParseULong;
  v31 = 0x80000;
  v33 = AcpiParseStaticRegister;
  v34 = 2;
  v35 = 524290;
  v37 = AcpiParseRegister;
  v38 = 3;
  v39 = 0x200000;
  v41 = AcpiParseStaticRegister;
  v42 = 3;
  v43 = 2097154;
  v45 = AcpiParseRegister;
  v46 = 4;
  v47 = 3670016;
  v49 = AcpiParseStaticRegister;
  v50 = 4;
  v51 = 3670018;
  v53 = AcpiParseRegister;
  v54 = 5;
  v55 = 5242880;
  v57 = AcpiParseStaticRegister;
  v58 = 5;
  v59 = 5242882;
  ...
  v130 = 21;
  v131 = 30408704;
  v133 = AcpiParseStaticRegister;
  v134 = 21;
  v135 = 30408706;
  v137 = AcpiParseRegister;
  v138 = 22;
  v139 = 31981568;
  v141 = AcpiParseStaticRegister;
  v142 = 22;
  v143 = 31981570;
  v145 = AcpiParseRegister;
  v146 = 23;
  v147 = 33554434;
  v148 = "OSPMNominalPerformance";
  Pool2 = 0LL;
  v149 = AcpiParseRegister;
  v152 = "ResourcePriorities";
  v153 = AcpiParseCpcResourcePriorities;
  v150 = 24;
  v151 = 35127299;
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1108), 0x40000u);
  v7 = AcpiEvaluateMethod(a1, 1129333599, 0, (unsigned int)&P, (__int64)&v18);
  if ( v7 < 0 )
    goto LABEL_30;
...
LABEL_11:
  ...
  v14 = 0;
LABEL_20:
  v7 = AcpiParseCore((unsigned int)v22, v4, (int)v8 + 12, v8[1] - 12, (__int64)Pool2, 544, (__int64)"_CPC", v14);
  if ( v7 < 0 )
  {
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_30;
  ...
  GetCpcRegisterDefinitionTable((__int64)Pool2, &v21, &v19);
  if ( v19 )
  {
    v15 = v21;
    v16 = v19;
    do
    {
      AcpiTranslateAccessSize((char *)Pool2 + *v15);
      v15 += 6;
      --v16;
    }
    while ( v16 );
