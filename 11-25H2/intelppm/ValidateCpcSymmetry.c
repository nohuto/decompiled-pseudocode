/*
 * XREFs of ValidateCpcSymmetry @ 0x14002EE80
 * Callers:
 ...
 *     ValidateRegisterSymmetry @ 0x14002FC38 (ValidateRegisterSymmetry.c)
 */
...
__int64 __fastcall ValidateCpcSymmetry(const wchar_t *a1, __int64 a2, const wchar_t *a3, __int64 a4)
{
  ...
  if ( v4 == (_DWORD)v8 )
  {
    ...
    return ValidateCpcResourcePrioritiesSymmetry(a1, *(unsigned int **)(a2 + 536), (__int64)a3, *(_DWORD **)(a4 + 536));
  }
  else
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_SSdd((__int64)WPP_GLOBAL_Control->DeviceExtension, v8, (__int64)a3, 0x4Du, v16, a1, a3);
    return 3221225473LL;
  }
}
