/*
 * XREFs of GetHwDebugRegisters @ 0x14002B330
 * Callers:
 *     <none>
 * Callees:
 *     __report_rangecheckfailure @ 0x140006890 (__report_rangecheckfailure.c)
...
__int64 __fastcall GetHwDebugRegisters(__int64 a1)
{
  ...
  *(_BYTE *)a1 = 0;
  ...
  for ( i = 0; i < 2; ++i )
  {
    ...
    v29[i] = 0;
    v11 = (char *)&IntelModelSpecificHwDebugRegisters + 56 * i;
    if ( *(_WORD *)v11 == v6 )
    {
      v12 = *((_WORD *)v11 + 1);
      v13 = 0;
