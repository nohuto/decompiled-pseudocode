/*
 * XREFs of InitEnergyCountersMsrEx @ 0x14002A5D0
 * Callers:
 *     InitEnergyCounters @ 0x14002A400 (InitEnergyCounters.c)
 * Callees:
 *     ActivateFixedFunctionCounters @ 0x140006A28 (ActivateFixedFunctionCounters.c)
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_140019960[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_140019958[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
