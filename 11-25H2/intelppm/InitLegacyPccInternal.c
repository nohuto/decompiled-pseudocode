/*
 * XREFs of InitLegacyPccInternal @ 0x14000D764
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x14000DC10 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x140030B70 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1400197F0 )
  {
    ...
    if ( Pool2 && (inited = AllocateAndInitKernelPerfStatesRegistration(a1, PerfDomain, 1LL), (v4 = inited) != 0) )
    {
      ...
      *(_QWORD *)(v4 + 400) = a1[45];
      if ( dword_14001976C )
      {
        v12 = 0x989680 % ((unsigned int)dword_14001976C >> 1);
        *(_DWORD *)(v4 + 40) = 0x989680 / ((unsigned int)dword_14001976C >> 1);
      }
      v14 = *(_QWORD *)(v4 + 560);
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v24, &v27) )
        {
          ...
          do
          {
            *(_QWORD *)(v27 + 240) = v20 - 5;
            v21 = (_QWORD *)qword_140019210;
            if ( *(__int64 **)qword_140019210 != &qword_140019208 )
              __fastfail(3u);
            *v20 = &qword_140019208;
            v20[1] = v21;
            *v21 = v20;
            qword_140019210 = (__int64)v20;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64 *)v24, &v27) );
        }
