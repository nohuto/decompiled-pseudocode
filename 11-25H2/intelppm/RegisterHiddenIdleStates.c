/*
 * XREFs of RegisterHiddenIdleStates @ 0x1400379D0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( HalPrivateDispatchTable[147] )
    {
          ...
          if ( v5 )
          {
            for ( i = (unsigned int)(v5 - 1); (_DWORD)i; i = (unsigned int)(i - 1) )
            {
              if ( (*(_DWORD *)(80 * i + v4 + 32) & 1) != 0 )
              {
                ...
                if ( !v7 )
                  return v2;
                v8 = DecodeAcpiIdleState(a1, (int)v7 + 24, -1, *(_DWORD *)(v7 + 12), (__int64)&v11, 0LL, 0LL, 0LL);
                goto LABEL_18;
              }
            }
          }
      ...
      else if ( (v3 & 0x7F077) != 0 )
      {
        ...
        if ( v9 )
        {
          if ( *v9 )
          {
            v8 = DecodeAcpi2CState(a1, (int)v9 + 4 * (*v9 + 4 * (*v9 - 1)), (unsigned int)&v11, 0, 0LL);
LABEL_18:
            v2 = v8;
            if ( v8 >= 0 && v11 )
