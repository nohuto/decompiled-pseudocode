/*
 * XREFs of RegisterHvCStates @ 0x140030378
 * Callers:
      ...
      *(_DWORD *)Pool2 = 1;
      if ( *(_BYTE *)(v1 + 16) != 1 )
      {
        ...
        *((_DWORD *)Pool2 + 8) = 0;
        ...
        HIWORD(v17) = 0;
        v18 = 0;
        DecodeAcpi2CState(a1, (unsigned int)&v17, (_DWORD)Pool2 + 8, 0, 0LL);
        ++*((_DWORD *)Pool2 + 1);
      }
      v6 = *(_DWORD *)v1;
      for ( i = 0; i < *(_DWORD *)v1; ++v5 )
      {
        ...
        if ( v8 == v5 )
        {
          ...
          *((_DWORD *)v11 + 4) = *(_DWORD *)(v12 + 16);
          if ( (int)DecodeAcpi2CState(a1, v12, (_DWORD)v11, 0, 0LL) < 0 )
