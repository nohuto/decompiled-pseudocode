/*
 * XREFs of PccInitiateExecuteCallback @ 0x14000F920
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    v3 = qword_140019208;
    v4 = 0;
    while ( (__int64 *)v3 != &qword_140019208 )
    {
    ...
    if ( v4 )
    {
      LOBYTE(word_1400197FC) = 1;
      if ( !HIBYTE(word_1400197FC) )
      {
        HIBYTE(word_1400197FC) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1400197E8);
    if ( v11 )
      IoQueueWorkItem(qword_1400197F0, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
