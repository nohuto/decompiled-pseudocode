/*
 * XREFs of InitAcpi1CStates @ 0x14002D824
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 272) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_140019B0C)
  ...
  if ( (*(_BYTE *)(a1 + 280) & 4) != 0
    && (unsigned __int16)word_140019AF2 <= 0x3E8u
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_140019B24)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_140019AF4)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_140019B0C)
    && (unsigned __int8)IsValidAcpiGenericAddress(a1 + 184)
    && dword_140019184 == 1 )
  {
  ...
  if ( Pool2 )
  {
    ...
    *v8 = v9;
    ...
    {
      LOBYTE(v8[5 * v9 + 4]) = 3;
      HIWORD(v8[5 * *v8 + 4]) = word_140019AF2;
      v8[5 * *v8 + 5] = 0;
      if ( *(_DWORD *)(a1 + 188) != -5 )
      {
        LOBYTE(v8[5 * *v8 + 1]) = 1;
