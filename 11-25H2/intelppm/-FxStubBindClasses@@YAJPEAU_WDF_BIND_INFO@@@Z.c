/*
 * XREFs of ?FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z @ 0x1400084B4
 * Callers:
 *     FxDriverEntryWorker @ 0x1400082F4 (FxDriverEntryWorker.c)
 * Callees:
 *     FxGetNextClassBindInfo @ 0x1400086D0 (FxGetNextClassBindInfo.c)
  ...
  if ( &__KMDF_CLASS_BIND_START <= &__KMDF_CLASS_BIND_END )
  {
    for ( i = (char *)&__KMDF_CLASS_BIND_END; ; i = (char *)v4 + *v4 )
    {
      ...
      if ( NextClassBindInfo >= (unsigned __int64)&__KMDF_CLASS_BIND_END )
        return v1;
      off_140018E58 = (_UNKNOWN *)NextClassBindInfo;
