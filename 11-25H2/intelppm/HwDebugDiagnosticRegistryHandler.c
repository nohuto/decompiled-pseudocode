/*
 * XREFs of HwDebugDiagnosticRegistryHandler @ 0x140005630
 * Callers:
 *     HwDebugRegistryHandlerWrapper @ 0x14000EAC0 (HwDebugRegistryHandlerWrapper.c)
 * Callees:
...
__int64 HwDebugDiagnosticRegistryHandler()
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1400191A0,
    0LL);
  KeInitializeEnumerationContext(&v14, &unk_1400195B0);
  ...
  while ( (__int64 *)qword_1400191B8 != &qword_1400191B8 )
  {
    v4 = P;
    if ( *(__int64 **)P != &qword_1400191B8 || (v5 = (PVOID *)*((_QWORD *)P + 1), *v5 != P) )
      __fastfail(3u);
    P = (PVOID)*((_QWORD *)P + 1);
    *v5 = &qword_1400191B8;
  ...
  if ( byte_140019AA8 )
  {
    ...
    do
    {
      v7 = (PVOID *)qword_140019AB0;
      v8 = 0;
      v9 = (char *)qword_140019AB0 + 40 * v6;
      if ( v9[16] )
      {
        do
    ...
    while ( (unsigned int)v6 < (unsigned __int8)byte_140019AA8 );
    ExFreePoolWithTag(qword_140019AB0, (ULONG)1919119952);
    byte_140019AA8 = 0;
  }
  ...
  while ( !(unsigned int)KeEnumerateNextProcessor(&v13, &v14) )
  {
    v10 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Flink->Flink + v13);
    v11 = *(_QWORD *)(v10 + 216);
    if ( v11 )
