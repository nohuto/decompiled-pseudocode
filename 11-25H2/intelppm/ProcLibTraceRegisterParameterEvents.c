/*
 * XREFs of ProcLibTraceRegisterParameterEvents @ 0x14000430C
 * Callers:
...
char __fastcall ProcLibTraceRegisterParameterEvents(__int64 *a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( a2 != 1 )
      v2 = &PPM_ETW_HARDWARE_DEBUG_PARAMETER_RUNDOWN;
  }
  else
  {
    v2 = (const EVENT_DESCRIPTOR *)&PPM_ETW_HARDWARE_DEBUG_PARAMETER_ALLOC;
  }
