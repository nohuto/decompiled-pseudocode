/*
 * XREFs of AcpiParseProcessorContainer @ 0x14003372C
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1400326D4 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x140008974 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x14000C744 (RtlUnicodeStringCopyString.c)
      ...
      if ( v15 )
      {
        ...
        *(_QWORD *)(a3 + 32) = v16;
        ...
        while ( v17 < a1[2 * v5 + 6] )
        {
          ...
          {
            if ( dword_140019A8C <= (unsigned int)dword_140019184 )
              return -1073741275;
