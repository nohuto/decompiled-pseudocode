/*
 * XREFs of DeactivateFixedFunctionCounters @ 0x140007194
 * Callers:
 *     SnapEnergyCounters @ 0x140007200 (SnapEnergyCounters.c)
 *     UnInitEnergyCounters @ 0x14002A950 (UnInitEnergyCounters.c)
 * Callees:
 *     <none>
 */
