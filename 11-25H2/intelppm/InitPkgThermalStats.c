/*
 * XREFs of InitPkgThermalStats @ 0x14002BA60
 * Callers:
 *     InitMeasRegisters @ 0x14002B700 (InitMeasRegisters.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x14000FF90 (_guard_dispatch_icall.c)
 *     GetPkgThermalRegisterDefinition @ 0x14002B990 (GetPkgThermalRegisterDefinition.c)
 */
...
__int64 InitPkgThermalStats()
{
  ...
  if ( (qword_140019AB8 & 0x200000000LL) != 0 )
  ...
  *(_DWORD *)(Pool2 + 24) = 2;
  ...
  {
    PkgThermalRegisterDefinition = GetPkgThermalRegisterDefinition((__int64 *)&P);
    if ( PkgThermalRegisterDefinition < 0 )
    {
      v0 = P;
    }
          ...
          *(_QWORD *)(v5 + 40) = v24;
          if ( v24 )
          {
            ...
            *(_QWORD *)(v3 + 40) = QueryPkgThermalMSRValues;
            v32 = (__int64 *)qword_140019AC8;
            if ( *(__int64 **)qword_140019AC8 != &qword_140019AC0 )
              __fastfail(3u);
            *(_QWORD *)v3 = &qword_140019AC0;
            *(_QWORD *)(v3 + 8) = v32;
            *v32 = v3;
