/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x140007E0C
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x140006050 (wil_details_IsEnabledFallback.c)
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140007F68 (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140007F68 (wil_details_GetCurrentFeatureEnabledState.c)
