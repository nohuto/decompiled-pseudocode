/*
 * XREFs of InitEnergyCounters @ 0x14002A400
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ProbeMsr @ 0x14002A78C (ProbeMsr.c)
  ...
  *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type = IntelEsuType & 1;
  ...
  if ( (unsigned __int8)ProbeMsr(&WPP_MAIN_CB.Dpc.DeferredContext) )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type = *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type & 0xFFFFFFC1 | ((unsigned int)v5 >> 7) & 0x3E;
    LOBYTE(word_140019A68) = BYTE1(v5) & 0x1F;
    if ( IntelEsuType )
    {
      HIBYTE(word_140019A68) = 1;
      if ( IntelEsuType == 1 )
      {
...
LABEL_17:
    ...
    else if ( !Number )
    {
      *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type &= ~0x40u;
      qword_140019960[0] = 0LL;
      qword_140019958[0] = (__int64)ComputeProcessorEnergyMsr;
    }
    return 0;
  }
  return v1;
