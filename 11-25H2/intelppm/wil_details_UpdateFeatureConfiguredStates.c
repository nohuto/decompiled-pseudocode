/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x14002D02C
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x14002D010 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x140008CAC (wil_details_FeatureDescriptors_SkipPadding.c)
 *     __security_check_cookie @ 0x14000FEF0 (__security_check_cookie.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x14002CD80 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
