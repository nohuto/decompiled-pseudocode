/*
 * XREFs of DriverEntry @ 0x14004214C
 * Callers:
 *     FxDriverEntryWorker @ 0x140004554 (FxDriverEntryWorker.c)
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x140003B54 (WPP_RECORDER_SF_d.c)
 *     _guard_dispatch_icall @ 0x14000D700 (_guard_dispatch_icall.c)
 *     ProcLibDriverCleanup @ 0x140023B7C (ProcLibDriverCleanup.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( v5 >= 0 )
  {
    KeInitializeAffinityEx2(&unk_140014638, 32LL);
    dword_1400145A4 = KeQueryActiveProcessorAffinity2(&unk_140014638);
    KeInitializeAffinityEx2(&unk_1400149D0, 32LL);
