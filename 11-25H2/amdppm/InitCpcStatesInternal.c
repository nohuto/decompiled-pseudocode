/*
 * XREFs of InitCpcStatesInternal @ 0x140032190
 * Callers:
 *     RegisterHvCpcCounters @ 0x140025F50 (RegisterHvCpcCounters.c)
 *     RegisterKernelCpc @ 0x140034BA0 (RegisterKernelCpc.c)
 * Callees:
 ...
 *     ClearEnumerationContext @ 0x140004A40 (ClearEnumerationContext.c)
 *     CpcFindResourcePriorityDescriptor @ 0x140005880 (CpcFindResourcePriorityDescriptor.c)
 ...
 *     GetPackageAffinity @ 0x140031EF0 (GetPackageAffinity.c)
...
__int64 __fastcall InitCpcStatesInternal(__int64 a1, __int64 (__fastcall *a2)(__int64))
{
  ...
  *(_OWORD *)v181 = 0LL;
  ...
  v170 = 0LL;
  v9(WdfDriverGlobals, qword_1400145A8, 0LL);
...
LABEL_6:
  ...
  while ( 1 )
  {
    ...
    *(_BYTE *)(v16 + 5) = v27;
    ...
    if ( qword_1400147E8 )
    {
      if ( (unsigned __int8)qword_1400147E8(v20, &v167) )
      {
        *(_BYTE *)(v16 + 1224) = 1;
        v30 = v167;
    ...
    *(_QWORD *)(v16 + 1212) = CpcFindResourcePriorityDescriptor(*(_DWORD **)(v20 + 536));
    if ( qword_1400147E0 )
      v34 = (__int64 (__fastcall *)(__int64, __int64, __int64 *, __int64 *))qword_1400147E0(v20, 0LL);
    else
      v34 = v170;
    if ( !v34 )
      v34 = GetCpcDifferentialFeedback;
    v35 = (unsigned __int8)v154;
    if ( v34 == (__int64 (__fastcall *)(__int64, __int64, __int64 *, __int64 *))qword_1400147B8 )
      v35 = 0;
    v170 = v34;
    v154 = v35;
    if ( !qword_1400147F0 || !(unsigned __int8)qword_1400147F0(v20, 0LL) )
      v141 = 0;
    v36 = v136;
    v37 = 0LL;
...
LABEL_79:
    if ( qword_140014808 )
    {
      ...
      v132 = &v169;
      v131 = &v174;
      v48 = qword_140014808(DeferredContext, v16 - 124, &v168, &v173);
    ...
    do
    {
        ...
        && !ReadGenAddrHiddenEx(*((unsigned int *)DeferredContext + 21), (unsigned __int8 *)(v62 + 32)) )
      {
        ...
        if ( !CpcHiddenProcessorMitigationReported )
        {
          ...
          if ( (unsigned int)dword_1400140F8 > 5 && tlgKeywordOn((__int64)&dword_1400140F8, 0x400000000000LL) )
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_1400140F8,
              (unsigned __int8 *)dword_140011603,
              v64,
              v65,
              (ULONG)2,
              ...
              if ( v136 )
              {
                ...
                else
                {
                  *(_QWORD *)(inited + 464) = PerfControlCpc;
                  v96 = (void *)qword_1400147A8;
                  if ( !qword_1400147A8 || !CpcHiddenProcessorMitigationReported )
