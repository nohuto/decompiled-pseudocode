/*
 * XREFs of PepParkPreference @ 0x14000CA80
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  v21 = 0LL;
  result = (unsigned int)dword_140014C18;
  v20 = 0LL;
  v19 = 0;
  v26 = 0;
  v27 = 0;
  v28 = 0;
  if ( dword_140014C18 >= (unsigned int)dword_1400145A4 )
  {
      ...
      if ( a3 > (unsigned int)result && a3 < v11 )
      {
        ...
        if ( !(_DWORD)result )
        {
          ...
          if ( v13 && v12 )
          {
            ...
            v22[0] = a3;
            v23 = PepParkLists;
            result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_140014930)(*(_QWORD *)(v12 + 1120), v22);
            if ( (int)result < 0 )
            {
            ...
            while ( 1 )
            {
              ...
              if ( (_DWORD)result || v17 >= v11 )
                return result;
              if ( PepParkLists[16 * v17 + 9] == 1 )
              {
                v18 = a7;
              }
              else
              {
                if ( PepParkLists[16 * v17 + 9] != 2 )
                  goto LABEL_32;
                v18 = a8;
              }
