/*
 * XREFs of ValidatePerfDomainSymmetry @ 0x140030F30
 * Callers:
 ...
 *     ValidatePssSymmetry @ 0x140031590 (ValidatePssSymmetry.c)
 *     ValidateTssSymmetry @ 0x1400316CC (ValidateTssSymmetry.c)
...
__int64 __fastcall ValidatePerfDomainSymmetry(__int64 a1)
{
  ...
  v3(WdfDriverGlobals, qword_1400145A8, 0LL);
