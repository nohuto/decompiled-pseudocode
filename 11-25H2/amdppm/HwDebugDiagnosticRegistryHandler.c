/*
 * XREFs of HwDebugDiagnosticRegistryHandler @ 0x14000BAE0
 * Callers:
 *     HwDebugRegistryHandlerWrapper @ 0x14000BDE0 (HwDebugRegistryHandlerWrapper.c)
 * Callees:
...
__int64 HwDebugDiagnosticRegistryHandler()
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1400145C0,
    0LL);
  KeInitializeEnumerationContext(&v14, &unk_1400149D0);
  ...
  while ( (__int64 *)qword_1400145D8 != &qword_1400145D8 )
  {
    v4 = P;
    if ( *(__int64 **)P != &qword_1400145D8 || (v5 = (PVOID *)*((_QWORD *)P + 1), *v5 != P) )
      __fastfail(3u);
    P = (PVOID)*((_QWORD *)P + 1);
    *v5 = &qword_1400145D8;
  ...
  if ( byte_140014EC8 )
  {
    ...
    do
    {
      v7 = (PVOID *)qword_140014ED0;
      v8 = 0;
      v9 = (char *)qword_140014ED0 + 40 * v6;
      if ( v9[16] )
      {
        do
    ...
    while ( (unsigned int)v6 < (unsigned __int8)byte_140014EC8 );
    ExFreePoolWithTag(qword_140014ED0, (ULONG)1919119952);
    byte_140014EC8 = 0;
  }
