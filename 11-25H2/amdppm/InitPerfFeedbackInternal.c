/*
 * XREFs of InitPerfFeedbackInternal @ 0x14003385C
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x140026950 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x140035DC0 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
        ...
        (v4 = (_QWORD *)inited) != 0LL) )
  {
    ...
    *(_WORD *)(inited + 6) = 1;
    *(_BYTE *)(inited + 52) = 2;
    *(_BYTE *)(inited + 14) = byte_140014B30;
