/*
 * XREFs of RegisterKernelIdleStates @ 0x140034BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelIdleStates(__int64 a1)
{
  ...
  v1 = 0LL;
  if ( *(_DWORD *)(a1 + 80) )
    return (unsigned int)((__int64 (*)(void))qword_140014B20)();
  ...
  if ( !v7 )
    return (unsigned int)-1073741823;
LABEL_17:
  Pool2 = (_DWORD *)ExAllocatePool2(64LL, (unsigned int)(88 * v7 + 48), 1919119952LL);
  if ( !Pool2 )
  ...
  if ( v10 )
  {
    ...
    *v11 = (struct _PROCESSOR_NUMBER)82;
...
LABEL_30:
    ...
    v23 = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1400148D8)(v11);
