/*
 * XREFs of AcpiParseProcessorContainer @ 0x14002ADEC
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x140029AC8 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x140004A54 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x140006FA4 (RtlUnicodeStringCopyString.c)
      ...
      if ( v15 )
      {
        ...
        *(_QWORD *)(a3 + 32) = v16;
        ...
        while ( v17 < a1[2 * v5 + 6] )
        {
          ...
          {
            if ( dword_140014EAC <= (unsigned int)dword_1400145A4 )
              return -1073741275;
