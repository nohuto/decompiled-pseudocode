/*
 * XREFs of FxDriverEntryWorker @ 0x140004554
 * Callers:
 *     FxDriverEntry @ 0x140004520 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_140014310;
...
LABEL_10:
    ...
    if ( v8 < 0 )
    {
      ...
      if ( off_140014298 != &__KMDF_CLASS_BIND_START )
      {
        memset(v11, 0, 12);
    ...
    if ( WdfDriverGlobals->DisplaceDriverUnload )
    {
      if ( DriverObject->DriverUnload )
        qword_140014518 = (__int64)DriverObject->DriverUnload;
