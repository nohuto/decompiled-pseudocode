...
__int64 __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification )
  {
    ...
    {
      memset(&PepParkLists, 0, (unsigned int)(16 * dword_1400145A4));
      v5 = 0;
      KeInitializeEnumerationContext(&v11, &unk_1400149D0);
      ...
      if ( !(_DWORD)result )
      {
        ...
        if ( v5 )
        {
          ...
          v8[0] = v5;
          v10 = &PepParkLists;
          result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_140014938)(*(_QWORD *)(v6 + 1120), v8);
          if ( (int)result < 0 )
          {
