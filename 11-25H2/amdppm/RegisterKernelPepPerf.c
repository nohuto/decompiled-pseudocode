/*
 * XREFs of RegisterKernelPepPerf @ 0x140035840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepTranslateLimitReason @ 0x14003B428 (PepTranslateLimitReason.c)
...
__int64 __fastcall RegisterKernelPepPerf(__int64 a1)
{
  ...
  v47 = 0;
  memset(v45, 0, 32);
  v2(WdfDriverGlobals, qword_1400145A8, 0LL);
  v4 = *(_QWORD *)(a1 + 1184);
  v5 = 0LL;
  Pool2 = 0LL;
  v44 = v4;
  ...
  if ( v42 )
  {
    ...
    if ( inited )
    {
      ...
      *(_BYTE *)(v5 + 15) = v28;
      v7 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qword_1400148C0)(v5, v34, v33, v32);
      if ( v7 >= 0 )
      {
        ResetEnumerationContext((__int64 *)v45);
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v45, &v43) )
