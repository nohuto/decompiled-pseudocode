/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x14003C88C
 * Callers:
 ...
 *     ValidateCoordinatedLpiStates @ 0x140030020 (ValidateCoordinatedLpiStates.c)
...
__int64 __fastcall LpiTranslateCoordinatedIdleStates(__int64 a1, _DWORD *a2, unsigned int **a3, PVOID *a4, _QWORD *a5)
{
  ...
  unsigned __int64 v45; // [rsp+A0h] [rbp-49h] BYREF
  ...
  v45 = 0LL;
  v43 = 0LL;
  v6 = ValidateCoordinatedLpiStates((_DWORD *)qword_140014C68, 0LL);
  if ( v6 < 0 )
      ...
      while ( (unsigned int)v22 < *(_DWORD *)(v21 + 16) )
      {
        ...
        *(_QWORD *)(v25 + 280) = *(_QWORD *)(v21 + 8);
        ...
        if ( v6 < 0 )
          goto LABEL_18;
        v28 = (char *)(v41 + 304);
        if ( (unsigned int)KeIsEqualAffinityEx(v41, &unk_1400149D0) )
          *v28 = 1;
        v29 = v44;
        v24[48] = *v28;
        v30 = (char *)(v21 + v29 + 48);
        *((_QWORD *)v24 + 4) = *(_QWORD *)(v29 + v21 + 52);
        if ( *v30 != 126 )
        {
          v6 = DecodeAcpiIdleState(a1, v30, 0xFFFFFFFF, *(unsigned int *)(v29 + v21 + 36), &v45, 0LL, 0LL, (__int64)v46);
          if ( v6 < 0 )
            goto LABEL_18;
