/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x140024F58
 * Callers:
 *     CpcNativeInterruptWorker @ 0x140025440 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x140027510 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
 *     ReadGenAddrMaybeHiddenEx @ 0x1400025A4 (ReadGenAddrMaybeHiddenEx.c)
 *     ProcLibTracePccCapChange @ 0x140004B98 (ProcLibTracePccCapChange.c)
