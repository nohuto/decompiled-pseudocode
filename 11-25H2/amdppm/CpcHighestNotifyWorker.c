/*
 * XREFs of CpcHighestNotifyWorker @ 0x140040828
 * Callers:
 *     CpcNativeInterruptWorker @ 0x140025440 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x140027530 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
...
LABEL_12:
      ...
      *(_DWORD *)(v6 + 100) = v15;
      ...
      {
        if ( !byte_140014B28 || (v17 = *(_QWORD *)(v5 + 1080)) == 0 || *(_DWORD *)(v17 + 36) <= 1u )
        {
...
LABEL_39:
          ...
          ((void (__fastcall *)(__int64 *))qword_1400148C8)(&v22);
