/*
 * XREFs of ProcLibTraceInvalidPowerCurve @ 0x14004203C
 * Callers:
...
char __fastcall ProcLibTraceInvalidPowerCurve(char a1, unsigned int a2, const void *a3)
{
  ...
  if ( (unsigned int)dword_1400140F8 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_1400140F8, 0x400000000000LL);
    if ( result )
    {
      v14 = 0;
      v17 = 0;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)dword_140011591,
               v6,
               v7,
               (ULONG)6,
               &v11);
