 ...
 *     PerfControlCpcHidden @ 0x140005C50 (PerfControlCpcHidden.c)
 *     PerfControlCpcSingleRegister @ 0x140005D80 (PerfControlCpcSingleRegister.c)
 *     PerfControlCpcSingleRegisterHidden @ 0x140006010 (PerfControlCpcSingleRegisterHidden.c)
 * Callees:
 *     <none>
 */
