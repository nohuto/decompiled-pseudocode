/*
 * XREFs of InitLegacyPccInternal @ 0x14000A0F0
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x14000A750 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1400264B0 (RegisterHvLegacyPccCounters.c)
 * Callees:
 ...
 *     AllocateAndInitKernelPerfStatesRegistration @ 0x140031954 (AllocateAndInitKernelPerfStatesRegistration.c)
...
__int64 __fastcall InitLegacyPccInternal(_QWORD *a1, __int64 (__fastcall *a2)(__int64))
{
  ...
  if ( qword_140014C10 )
  {
    ...
    if ( Pool2 && (inited = AllocateAndInitKernelPerfStatesRegistration(a1, PerfDomain, 1LL), (v4 = inited) != 0) )
    {
      ...
      *(_BYTE *)(inited + 52) = 0;
      *(_QWORD *)(inited + 464) = PerfControlLegacyPcc;
      *(_QWORD *)(inited + 472) = PerfControlLegacyPcc;
      *(_QWORD *)(inited + 448) = PerfSelectionLegacyPcc;
      *(_QWORD *)(inited + 488) = PerfInitiateLegacyPcc;
      *(_QWORD *)(inited + 504) = PerfCommitLegacyPcc;
      v9 = v2[7];
      *(_DWORD *)(inited + 20) = v9;
      ...
      *(_QWORD *)(v4 + 400) = a1[45];
      if ( dword_140014B8C )
      {
        v12 = 0x989680 % ((unsigned int)dword_140014B8C >> 1);
        *(_DWORD *)(v4 + 40) = 0x989680 / ((unsigned int)dword_140014B8C >> 1);
      }
      v14 = *(_QWORD *)(v4 + 560);
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v25, &v28) )
        {
          ...
          do
          {
            *(_QWORD *)(v28 + 240) = v20 - 5;
            v22 = (__int64 *)qword_140014630;
            if ( *(__int64 **)qword_140014630 != v21 )
              __fastfail(3u);
            *v20 = v21;
            v20[1] = v22;
            *v22 = (__int64)v20;
            qword_140014630 = (__int64)v20;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64 *)v25, &v28) );
        }
