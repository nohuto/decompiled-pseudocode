/*
 * XREFs of ValidateAcpiCStates @ 0x14002F468
 * Callers:
...
__int64 __fastcall ValidateAcpiCStates(unsigned int *a1, const wchar_t *a2)
{
  ...
  for ( j = 0; ; ++j )
  {
    ...
    if ( LOBYTE(v4[5 * j + 4]) == 2 )
      break;
    if ( !IsValidAcpiGenericAddress((__int64)&dword_140014574)
      || !IsValidAcpiGenericAddress((__int64)&dword_140014544)
      || !IsValidAcpiGenericAddress((__int64)&dword_14001455C) )
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        return (unsigned int)-1073741823;
      v10 = 27;
