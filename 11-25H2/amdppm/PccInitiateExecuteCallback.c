/*
 * XREFs of PccInitiateExecuteCallback @ 0x14000D030
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    v3 = qword_140014628;
    v4 = 0;
    while ( (__int64 *)v3 != &qword_140014628 )
    {
    ...
    if ( v4 )
    {
      LOBYTE(word_140014C1C) = 1;
      if ( !HIBYTE(word_140014C1C) )
      {
        HIBYTE(word_140014C1C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_140014C08);
    if ( v11 )
      IoQueueWorkItem(qword_140014C10, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
