/*
 * XREFs of pre_c_initialization @ 0x140004C40
 * Callers:
 *     <none>
 * Callees:
 *     __scrt_initialize_onexit_tables @ 0x140004F84 (__scrt_initialize_onexit_tables.c)
 *     atexit @ 0x140005154 (atexit.c)
 *     _get_startup_argv_mode @ 0x14000540C (_get_startup_argv_mode.c)
 *     __scrt_initialize_winrt @ 0x140005418 (__scrt_initialize_winrt.c)
 *     _get_startup_file_mode @ 0x140005424 (_get_startup_file_mode.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x140005430 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_stub_for_acrt_uninitialize @ 0x140005444 (__scrt_stub_for_acrt_uninitialize.c)
 *     _guard_check_icall_nop @ 0x140005450 (_guard_check_icall_nop.c)
 *     __scrt_fastfail @ 0x1400054B0 (__scrt_fastfail.c)
 *     __scrt_initialize_mta @ 0x140005658 (__scrt_initialize_mta.c)
 *     _RTC_Initialize @ 0x140005734 (_RTC_Initialize.c)
 *     __p__commode @ 0x140005C3C (__p__commode.c)
 *     _configthreadlocale @ 0x140005C84 (_configthreadlocale.c)
 *     _o__configure_wide_argv_0 @ 0x140005C90 (_o__configure_wide_argv_0.c)
 *     _o__initialize_wide_environment_0 @ 0x140005CCC (_o__initialize_wide_environment_0.c)
 *     _set_app_type @ 0x140005D14 (_set_app_type.c)
 *     _o__set_fmode_0 @ 0x140005D20 (_o__set_fmode_0.c)
 */
