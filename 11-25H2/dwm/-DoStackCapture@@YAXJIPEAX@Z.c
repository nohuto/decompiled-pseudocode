/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x1400105D0
 * Callers:
 ...
 *     __std_find_trivial_8 @ 0x1400063D0 (__std_find_trivial_8.c)
...
void __fastcall DoStackCapture(int a1, int a2, unsigned __int64 a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_140019C28, 1, 0) )
  {
