/*
 * XREFs of __security_check_cookie @ 0x140004EE0
 * Callers:
 ...
 *     __GSHandlerCheckCommon @ 0x1400064C8 (__GSHandlerCheckCommon.c)
 ...
 *     ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x1400087CC (-GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z.c)
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x140009E44 (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
 ...
 *     ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x14000B5BC (-TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z.c)
 ...
 *     wil_details_RecordCachedUsage @ 0x14000C834 (wil_details_RecordCachedUsage.c)
 ...
 *     ?GetFloat@CSettingsManager@@AEAAJPEBGPEAM@Z @ 0x14000E498 (-GetFloat@CSettingsManager@@AEAAJPEBGPEAM@Z.c)
