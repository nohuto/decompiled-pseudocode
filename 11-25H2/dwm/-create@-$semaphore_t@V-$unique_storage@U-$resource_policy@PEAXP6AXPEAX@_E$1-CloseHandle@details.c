/*
 * XREFs of ?create@?$semaphore_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEAAJJJPEBGKPEAU_SECURITY_ATTRIBUTES@@PEA_N@Z @ 0x14000BEBC
 * Callers:
 ...
 * Callees:
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x140008798 (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
