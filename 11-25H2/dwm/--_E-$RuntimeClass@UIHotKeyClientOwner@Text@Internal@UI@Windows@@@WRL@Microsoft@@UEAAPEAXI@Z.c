/*
 * XREFs of ??_E?$RuntimeClass@UIHotKeyClientOwner@Text@Internal@UI@Windows@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x14000CE40
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAX_K@Z @ 0x140005174 (--3@YAXPEAX_K@Z.c)
 *     ??1?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIHotKeyClientOwner@Text@Internal@UI@Windows@@@Details@WRL@Microsoft@@UEAA@XZ @ 0x14000CD94 (--1-$RuntimeClassImpl@U-$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIHotKeyClientOwner@Text.c)
 */
