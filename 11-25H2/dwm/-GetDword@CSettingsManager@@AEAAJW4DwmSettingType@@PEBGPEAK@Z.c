/*
 * XREFs of ?GetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGPEAK@Z @ 0x14000263C
 * Callers:
 *     ?ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z @ 0x140002440 (-ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z.c)
 ...
 *     ?GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x140003FF0 (-GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 *     ?GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x14000E5D0 (-GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 * Callees:
 *     <none>
 */
