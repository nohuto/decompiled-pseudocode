/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x140008E6C
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x14000B8A0 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 * Callees:
  ...
  if ( !v18 && (v14 & 4) == 0 && wil::details::g_enabledStateManager )
  {
    ...
    if ( !v11
      ...
      || (v16[1] = 0,
          v16[0] = 0,
          v17 = v7,
          !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_1400192E8, v16, 0x10uLL)) )
    {
