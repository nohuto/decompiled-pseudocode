/*
 * XREFs of ?DoDisplayModeReset@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAXAEBU_GUID@@@Z @ 0x14000F0F4
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    if ( (unsigned int)dword_1400190D8 > 5 && tlgKeywordOn((__int64)&dword_1400190D8, 0x800000000000LL) )
    {
      ...
      v14 = 16;
      v11 = 8;
      tlgWriteTransfer_EventWriteTransfer(v3, byte_140014ECC, 0LL, 0LL, 5u, &v9);
    }
    LOBYTE(v3) = 1;
