/*
 * XREFs of ?PropagateUserLogon@CSettingsManager@@QEAAXPEAUHKEY__@@00_N@Z @ 0x1400022B8
 * Callers:
 ...
 *     ?AcquireExclusive@CReadWriteLock@@QEAAXXZ @ 0x140002400 (-AcquireExclusive@CReadWriteLock@@QEAAXXZ.c)
