/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x1400077E4
 * Callers:
 ...
 * Callees:
 *     ?_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x14000BDF4 (-_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
