/*
 * XREFs of ?CreatePhysicalAllocation@VIDMM_PHYSICAL_ADAPTER@@QEAAPEAUVIDMM_PHYSICAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@_K11IKKU_D3DDDI_SEGMENTPREFERENCE@@@Z @ 0x1400F6424
 * Callers:
        ...
        struct _D3DDDI_SEGMENTPREFERENCE a9)
{
  ...
  {
    _InterlockedAdd(dword_14008181C, 1u);
