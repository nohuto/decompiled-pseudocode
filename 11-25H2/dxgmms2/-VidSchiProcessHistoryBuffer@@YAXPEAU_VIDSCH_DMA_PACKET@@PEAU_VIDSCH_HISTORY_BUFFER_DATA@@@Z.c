/*
 * XREFs of ?VidSchiProcessHistoryBuffer@@YAXPEAU_VIDSCH_DMA_PACKET@@PEAU_VIDSCH_HISTORY_BUFFER_DATA@@@Z @ 0x14004201C
 * Callers:
...
void __fastcall VidSchiProcessHistoryBuffer(struct _VIDSCH_DMA_PACKET *a1, struct _VIDSCH_HISTORY_BUFFER_DATA *a2)
{
    ...
    && (qword_140081010 & 0x4000) != 0 )
  {
    ...
    if ( v11 < v3 || v11 > v10 )
    {
      ...
      WdLogGlobalForLineNumber = 11770;
LABEL_24:
    ...
    if ( v13 )
    {
      ...
      WdLogGlobalForLineNumber = 11811;
      goto LABEL_24;
    }
        ...
        if ( HIDWORD(v38) )
        {
          ...
          else
          {
            if ( v39 != 64 )
            {
              ...
              WdLogGlobalForLineNumber = 11900;
              goto LABEL_43;
            }
            v27 = 8;
          }
          ...
          if ( v28 > 0xFC00 )
          {
            ...
            v29 = HIDWORD(v38);
            WdLogGlobalForLineNumber = 11910;
            goto LABEL_43;
          }
          if ( (byte_140081242 & 1) != 0 )
            McTemplateK0pqqqqUR4_EtwWriteTransfer(
