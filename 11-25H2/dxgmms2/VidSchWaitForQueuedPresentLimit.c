/*
 * XREFs of VidSchWaitForQueuedPresentLimit @ 0x1400F5710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchWaitForQueuedPresentLimit(__int64 a1, unsigned int a2, char a3)
{
  ...
  if ( *(_DWORD *)(a1 + 4LL * a2 + 1700) < *(_DWORD *)(a1 + 244) )
    return v3;
  if ( a3 )
  {
    ...
    if ( *(_DWORD *)(a1 + 4 * v4 + 1700) >= *(_DWORD *)(a1 + 244) )
      v3 = VidSchWaitForCompletionEvent(v6, (__int64)v9, 2);
    VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v6 + 2000), v9, 0LL);
    return v3;
  }
  return 3223191810LL;
}
