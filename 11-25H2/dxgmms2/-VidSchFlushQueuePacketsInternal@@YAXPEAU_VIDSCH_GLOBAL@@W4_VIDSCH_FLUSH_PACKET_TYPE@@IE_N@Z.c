/*
 * XREFs of ?VidSchFlushQueuePacketsInternal@@YAXPEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_PACKET_TYPE@@IE_N@Z @ 0x1400287EC
 * Callers:
 *     VidSchFlushQueuePackets @ 0x1400287D0 (VidSchFlushQueuePackets.c)
 ...
 *     ?VidSchiAbortMmIoFlipPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@PEAU_VIDSCH_DEVICE@@I@Z @ 0x140028E00 (-VidSchiAbortMmIoFlipPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@PEAU_VIDSCH_DEVICE@@I@Z.c)
        ...
        if ( v43 != kk + 80 )
        {
          ...
          do
          {
            if ( !v45 )
            {
              ...
              {
                VidSchiSubmitPresentHistoryToken((struct HwQueueStagingList *)&v54, v43 - 4, 0LL, 0LL, 0LL);
                v43[16] = 0LL;
              }
              v45 = a2;
            }
          ...
          if ( v49 != nn + 19 )
          {
            ...
            do
            {
              if ( !v50 )
              {
                ...
                {
                  VidSchiSubmitPresentHistoryToken((struct HwQueueStagingList *)&v54, v49 - 4, 0LL, 0LL, 0LL);
                  v48 = (__int64 **)(nn + 19);
                  v49[16] = 0LL;
                }
                v50 = a2;
