/*
 * XREFs of VidSchiFillSubmitCommandData @ 0x14003F090
 * Callers:
...
__int64 __fastcall VidSchiFillSubmitCommandData(__int64 a1, _QWORD *a2)
{
  ...
  *((_DWORD *)a2 + 18) = v10;
  ...
  else
  {
    *a2 = *(_QWORD *)(v2 + 64);
    if ( (*(_DWORD *)(a1 + 92) & 0x10) != 0 )
    {
      v10 |= 0x30u;
      *((_DWORD *)a2 + 18) = v10;
      *((_DWORD *)a2 + 17) = *(_DWORD *)(*(_QWORD *)v7 + 876LL);
  ...
  if ( v12 )
  {
    ...
    *((_DWORD *)a2 + 12) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 128LL) + 72LL);
  }
