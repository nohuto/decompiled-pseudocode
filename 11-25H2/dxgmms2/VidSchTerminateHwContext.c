/*
 * XREFs of VidSchTerminateHwContext @ 0x1400291F0
 * Callers:
 ...
 * Callees:
 *     ?VidSchiDecrementHwContextReference@@YAXPEAUVIDSCH_HW_CONTEXT@@H@Z @ 0x14002AC38 (-VidSchiDecrementHwContextReference@@YAXPEAUVIDSCH_HW_CONTEXT@@H@Z.c)
...
void __fastcall VidSchTerminateHwContext(PVOID P)
{
  ...
  _InterlockedCompareExchange((volatile signed __int32 *)P + 77, 1, 0);
  ...
  *(_QWORD *)(*((_QWORD *)P + 4) + 8LL) = 0LL;
  ...
  VidSchiDecrementHwContextReference(P, 0);
}
