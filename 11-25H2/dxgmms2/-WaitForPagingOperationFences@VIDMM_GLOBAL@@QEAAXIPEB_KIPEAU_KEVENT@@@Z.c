/*
 * XREFs of ?WaitForPagingOperationFences@VIDMM_GLOBAL@@QEAAXIPEB_KIPEAU_KEVENT@@@Z @ 0x140096B48
 * Callers:
 *     VidMmWaitForPagingOperationFences @ 0x14004C9D0 (VidMmWaitForPagingOperationFences.c)
 * Callees:
