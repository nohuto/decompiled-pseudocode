/*
 * XREFs of ?CleanupPrimaryAllocation@VIDMM_GLOBAL@@QEAAEPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x14011144C
 * Callers:
    ...
    if ( *(char **)v9 != v9 )
    {
      do
      {
        ...
        if ( (*((_DWORD *)v11 + 7) & 3) != 0 )
        {
          ...
          _InterlockedDecrement((volatile signed __int32 *)(*((_QWORD *)a2 + 47) + 16LL));
        }
      }
      while ( v10 != v9 );
      v7 = v13;
