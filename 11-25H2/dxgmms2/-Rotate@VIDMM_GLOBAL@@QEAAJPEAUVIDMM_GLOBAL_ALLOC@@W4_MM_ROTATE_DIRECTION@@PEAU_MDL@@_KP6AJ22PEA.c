/*
 * XREFs of ?Rotate@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_GLOBAL_ALLOC@@W4_MM_ROTATE_DIRECTION@@PEAU_MDL@@_KP6AJ22PEAX@Z4TVIDMM_ROTATE_FLAGS@@PEAUVIDMM_PHYSICAL_ALLOC@@@Z @ 0x140103C94
 * Callers:
        ...
        __int64 a9)
{
  ...
  result = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int64, __int64, __int64, __int64, int))(**(_QWORD **)(a2 + 224) + 48LL))(
             *(_QWORD *)(a2 + 224),
             a1,
             *(_QWORD *)(a2 + 232),
             a3,
