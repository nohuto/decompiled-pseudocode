/*
 * XREFs of ?VidMmGetAllocationHint@@YAPEBU_DXGK_ALLOCATIONUSAGEHINT@@PEBUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400F77C0
 * Callers:
...
const struct _DXGK_ALLOCATIONUSAGEHINT *__fastcall VidMmGetAllocationHint(const struct VIDMM_GLOBAL_ALLOC *a1)
{
  ...
  v1 = *((_QWORD *)a1 + 1);
  result = (const struct _DXGK_ALLOCATIONUSAGEHINT *)&unk_14005E100;
  if ( v1 )
  {
    v3 = *(_QWORD *)(v1 + 24);
    if ( v3 )
