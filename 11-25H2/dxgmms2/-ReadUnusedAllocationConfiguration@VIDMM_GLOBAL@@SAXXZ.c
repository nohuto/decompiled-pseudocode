/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x14010BADC
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1400813B0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1400813D0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1400813C0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1400813F0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v6 = 1000000;
  v11 = 1000000;
  xmmword_1400813E0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v1 = 1;
  v3 = 15;
  v8 = 1;
  v12 = 15;
  v13 = 15;
  qword_1400813A8 = 1LL;
  xmmword_140081480 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v2 = 0;
  v4 = 45;
  v5 = 120;
  v7 = 0;
  ...
  v14 = 30;
  v15 = 30;
  xmmword_140081470 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  ...
  v16[3] = &qword_1400813A8;
  v16[5] = &v1;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = &xmmword_1400813B0;
  v16[12] = &v2;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = (char *)&xmmword_1400813B0 + 8;
  v16[19] = &v3;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = &xmmword_1400813C0;
  v16[26] = &v4;
  LODWORD(v16[8]) = 288;
  ...
  qword_1400813A8 *= 10000000LL;
  *(_QWORD *)&xmmword_1400813B0 = 10000000 * xmmword_1400813B0;
  *((_QWORD *)&xmmword_1400813B0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1400813C0 = 10000000 * xmmword_1400813C0;
  *((_QWORD *)&xmmword_1400813C0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1400813D0 = 10000000 * xmmword_1400813D0;
  *((_QWORD *)&xmmword_1400813D0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1400813E0 = 10000000 * xmmword_1400813E0;
  *((_QWORD *)&xmmword_1400813E0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1400813F0 = 10000000 * xmmword_1400813F0;
  *((_QWORD *)&xmmword_1400813F0 + 1) *= 10000000LL;
  do
  {
    *(_QWORD *)v0 *= 10000000LL;
    v0 = (__int128 *)((char *)v0 + 8);
  }
  while ( (__int64)v0 < (__int64)&qword_140081490 );
}
