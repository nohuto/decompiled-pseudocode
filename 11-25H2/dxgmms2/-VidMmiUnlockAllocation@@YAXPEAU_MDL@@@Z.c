/*
 * XREFs of ?VidMmiUnlockAllocation@@YAXPEAU_MDL@@@Z @ 0x1400E61FC
 * Callers:
 *     ?UnlockHeapAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAUVIDMM_HEAP_ALLOC@@_K1E@Z @ 0x1400A29F0 (-UnlockHeapAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAUVIDMM_HEAP_ALLOC@@_K1E@Z.c)
