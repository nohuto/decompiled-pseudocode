/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_DEMOTED_CONTENT_BY_FREE_MEMORY@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1401024E8
 * Callers:
        ...
        struct DXGADAPTER *a3)
{
  ...
  if ( *((_BYTE *)this + 348) && (unsigned int)dword_140081048 > 5 )
  {
