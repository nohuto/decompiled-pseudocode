/*
 * XREFs of ?EvictResource@VIDMM_MEMORY_SEGMENT@@UEAA_NPEAUVIDMM_PHYSICAL_ALLOC@@EEEPEAUVIDMM_LOCAL_ALLOC@@@Z @ 0x1400AA9F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct VIDMM_LOCAL_ALLOC *a6)
{
  ...
  if ( (*(_DWORD *)(v6 + 6984) & 0x10) == 0
    && _InterlockedCompareExchange16((volatile signed __int16 *)(*(_QWORD *)(v8 + 376) + 8LL), 3, 2) == 2 )
  {
