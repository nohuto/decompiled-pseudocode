/*
 * XREFs of ?QueryProcessSegmentGroupStatistics@VIDMM_GLOBAL@@QEAAJGW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_GROUP_INFORMATION@@@Z @ 0x1400990D0
 * Callers:
 *     VidMmQueryProcessSegmentGroupStatistics @ 0x14004C830 (VidMmQueryProcessSegmentGroupStatistics.c)
 * Callees:
