/*
 * XREFs of ?QuerySegmentDirtyBitTrackingCaps@VIDMM_GLOBAL@@QEAAJGIPEAU_DXGK_DIRTY_BIT_TRACKING_SEGMENT_CAPS@@@Z @ 0x1400991C8
 * Callers:
 *     VidMmQuerySegmentDirtyBitTrackingCaps @ 0x14004C850 (VidMmQuerySegmentDirtyBitTrackingCaps.c)
 * Callees:
 *     ?DriverSegmentIdToAdapterSegmentIndex@VIDMM_GLOBAL@@QEBAIII@Z @ 0x14003E330 (-DriverSegmentIdToAdapterSegmentIndex@VIDMM_GLOBAL@@QEBAIII@Z.c)
 */
