/*
 * XREFs of ?VidSchiCreateHwContextInternal@@YAPEAUVIDSCH_HW_CONTEXT@@PEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_CONTEXT_DATA@@PEAVDXGCONTEXT@@@Z @ 0x140031674
 * Callers:
        ...
        struct DXGCONTEXT *a3)
{
  ...
  v3 = *((_QWORD *)a1 + 4);
  Pool2 = ExAllocatePool2(64LL, 416LL, 1667328342LL);
  v8 = 0;
  v9 = Pool2;
  if ( !Pool2 )
  {
  ...
  *(_OWORD *)(v9 + 368) = 0LL;
  *(_QWORD *)(v9 + 384) = 0LL;
  KeInitializeEvent((PRKEVENT)(v9 + 336), SynchronizationEvent, 0);
  *(_QWORD *)(v9 + 400) = v9 + 392;
  *(_QWORD *)(v9 + 392) = v9 + 392;
