/*
 * XREFs of wil_details_FeatureDescriptors_SkipPadding @ 0x14004C194
 * Callers:
 *     wil_details_EvaluateFeatureDependencies @ 0x140091BFC (wil_details_EvaluateFeatureDependencies.c)
 *     wil_details_OnFeatureUsageProviderFlushNotification @ 0x140091DC0 (wil_details_OnFeatureUsageProviderFlushNotification.c)
