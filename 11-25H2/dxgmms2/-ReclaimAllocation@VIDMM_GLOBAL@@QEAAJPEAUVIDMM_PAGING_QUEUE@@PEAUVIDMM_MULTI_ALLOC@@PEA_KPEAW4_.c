/*
 * XREFs of ?ReclaimAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_PAGING_QUEUE@@PEAUVIDMM_MULTI_ALLOC@@PEA_KPEAW4_D3DDDI_RECLAIM_RESULT@@@Z @ 0x1400F3900
 * Callers:
 *     VidMmReclaimAllocation @ 0x14003CC20 (VidMmReclaimAllocation.c)
 * Callees:
