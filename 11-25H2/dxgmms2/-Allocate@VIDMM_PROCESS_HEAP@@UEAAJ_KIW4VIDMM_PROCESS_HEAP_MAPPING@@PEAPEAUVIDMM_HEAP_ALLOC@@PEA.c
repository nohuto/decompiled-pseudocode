/*
 * XREFs of ?Allocate@VIDMM_PROCESS_HEAP@@UEAAJ_KIW4VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAUVIDMM_HEAP_ALLOC@@PEAPEAX3PEAEEE@Z @ 0x1400A00F0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a9)
{
  ...
  char v52; // [rsp+78h] [rbp-21h]
  HANDLE v53; // [rsp+80h] [rbp-19h] BYREF
  HANDLE v54; // [rsp+88h] [rbp-11h]
  SIZE_T v55; // [rsp+90h] [rbp-9h] BYREF
  PPAGED_LOOKASIDE_LIST Lookaside; // [rsp+98h] [rbp-1h]
  int v57; // [rsp+E0h] [rbp+47h]
  ...
  *v15 = 0LL;
  *v16 = 0;
  if ( v17 < (unsigned int)dword_140081438 )
  {
...
LABEL_34:
      v55 = Size;
      LODWORD(v22) = MmCreateSection(&Object, 0LL, 0LL, &v55, 4, v32, -1LL, 0LL);
      if ( (int)v22 < 0 )
      {
        Object = 0LL;
      ...
      inserted = ObInsertObject(Object, 0LL, 0, 0, 0LL, &v53);
      v22 = inserted;
      if ( inserted < 0 )
      {
...
LABEL_54:
        ...
        if ( Object )
        {
          if ( v53 )
          {
            ObCloseHandle(v53, ((unsigned __int64)v53 & 0xFFFFFFFF80000000uLL) == 0);
            v37 = Object;
          }
...
LABEL_33:
  ...
  if ( (*(int (__fastcall **)(__int64, PVOID *, _QWORD, SIZE_T *, int, int))v27)(-1LL, &Address, 0LL, &Size, v25, v57) < 0 )
  {
    v49 = 12288;
...
LABEL_31:
  ...
  v54 = MmSecureVirtualMemory(Address, Size, 4u);
  if ( !v54 )
  {
    LODWORD(v22) = -1073741801;
    _InterlockedIncrement(&dword_14008177C);
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 144LL) += Size;
  ...
  if ( (byte_140081242 & 4) != 0 )
  {
    ...
    if ( a4 - 3 <= 3 )
      v41 = Object;
    LODWORD(Handlea) = a4;
    LODWORD(v45) = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 8LL);
