/*
 * XREFs of McTemplateK0qpxxtqqq_EtwWriteTransfer @ 0x14003CF68
 * Callers:
        ...
        char a10)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, (const EVENT_DESCRIPTOR *)"C", 0LL, 9u, &v15);
}
