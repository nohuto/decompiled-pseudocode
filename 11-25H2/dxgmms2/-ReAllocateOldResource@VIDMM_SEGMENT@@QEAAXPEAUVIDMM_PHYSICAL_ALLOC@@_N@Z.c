/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAUVIDMM_PHYSICAL_ALLOC@@_N@Z @ 0x1400D1E54
 * Callers:
 ...
 *     ?IncrementBytesCommitted@VIDMM_SEGMENT@@QEAAXPEAUVIDMM_PARTITION@@_K@Z @ 0x1400D24BC (-IncrementBytesCommitted@VIDMM_SEGMENT@@QEAAXPEAUVIDMM_PARTITION@@_K@Z.c)
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct VIDMM_PHYSICAL_ALLOC *a2)
{
  ...
  VIDMM_SEGMENT::IncrementBytesResident(
    this,
    **(struct VIDMM_PARTITION ***)(v3 + 336),
    *((_QWORD *)a2 + 2),
    (*(_DWORD *)(v3 + 24) & 0x200) != 0);
  VIDMM_SEGMENT::IncrementBytesCommitted(this, **(struct VIDMM_PARTITION ***)(v3 + 336), *((_QWORD *)a2 + 2));
  ++*((_DWORD *)this + 90);
  ++*((_DWORD *)this + 91);
  ...
  if ( (*((_DWORD *)this + 26) & 0x1001) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      {
        _InterlockedAdd64((volatile signed __int64 *)(**(_QWORD **)(v3 + 336) + 56LL), *v6);
        v7 = (int *)((char *)this + 104);
      }
      if ( _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v3 + 344) + 40LL)) == 1 )
        _InterlockedAdd64((volatile signed __int64 *)(**(_QWORD **)(v3 + 336) + 64LL), *v6);
      v6 = (unsigned __int64 *)((char *)a2 + 16);
    }
    else
    {
  ...
  v14 = (VIDMM_SEGMENT *)(v3 + 248);
  v15 = *(VIDMM_SEGMENT **)(v3 + 248);
  if ( *((_QWORD *)v15 + 1) != v3 + 248
    || (v16 = *(VIDMM_SEGMENT ***)(v3 + 256), *v16 != v14)
    || (*v16 = v15,
        *((_QWORD *)v15 + 1) = v16,
