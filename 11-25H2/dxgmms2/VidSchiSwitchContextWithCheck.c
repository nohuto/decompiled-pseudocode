/*
 * XREFs of VidSchiSwitchContextWithCheck @ 0x140024800
 * Callers:
...
__int64 __fastcall VidSchiSwitchContextWithCheck(unsigned __int64 a1)
{
  ...
  if ( (unsigned __int8)VidSchiBlockContextOnPendingFlips(*(_QWORD *)(a1 + 648)) )
  {
    ...
    VidSchiUpdateContextStatus(v2, 3LL, 16642LL);
    return 3LL;
  }
  v5 = *(_DWORD *)(v1 + 16520);
  v6 = *(_DWORD *)(v2 + 644);
  ...
  if ( !(unsigned int)VidSchiCheckPreemptionPolicy(v2, &v39) )
  {
    ...
    if ( v39 != -1 )
    {
      ...
      *(_QWORD *)(v1 + 136) = v13;
      ...
      WdLogGlobalForLineNumber = 16692;
    }
...
LABEL_80:
  ...
  VidSchiUpdateContextStatus(v2, 8LL, 16810LL);
  return 3LL;
}
