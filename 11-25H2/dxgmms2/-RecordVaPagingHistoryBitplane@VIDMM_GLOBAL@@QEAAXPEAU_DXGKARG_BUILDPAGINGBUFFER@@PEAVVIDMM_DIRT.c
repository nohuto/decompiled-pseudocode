/*
 * XREFs of ?RecordVaPagingHistoryBitplane@VIDMM_GLOBAL@@QEAAXPEAU_DXGKARG_BUILDPAGINGBUFFER@@PEAVVIDMM_DIRTY_BITPLANE@@W4_DXGK_GPUP_MIGRATIONTYPE@@@Z @ 0x140099F58
 * Callers:
