/*
 * XREFs of ?ChangeVideoMemoryReservation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@_K@Z @ 0x140092CD0
 * Callers:
 *     VidMmChangeVideoMemoryReservation @ 0x14004C460 (VidMmChangeVideoMemoryReservation.c)
 * Callees:
        ...
        unsigned __int64 a5)
{
  ...
  else
  {
    ...
    result = 3221225485LL;
    WdLogGlobalForLineNumber = 25898;
  }
  return result;
}
