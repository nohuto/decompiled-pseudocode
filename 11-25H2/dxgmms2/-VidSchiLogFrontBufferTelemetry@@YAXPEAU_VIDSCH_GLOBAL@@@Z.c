/*
 * XREFs of ?VidSchiLogFrontBufferTelemetry@@YAXPEAU_VIDSCH_GLOBAL@@@Z @ 0x14004F56C
 * Callers:
...
void __fastcall VidSchiLogFrontBufferTelemetry(struct _VIDSCH_GLOBAL *a1)
{
  ...
  if ( *((_QWORD *)a1 + 884) > *((_QWORD *)a1 + 885) )
  {
