/*
 * XREFs of ?SelectTask@VIDMM_SCHCLASS_PAGING@@UEAAPEAUVIDMM_TASK@@PEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK_CONTEXT@@@Z @ 0x1400A4D10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        struct VIDMM_TASK_CONTEXT *a3)
{
  ...
  while ( v3 );
  *((_QWORD *)a3 + 1) = *((_QWORD *)a2 + 673) + 10000000LL;
