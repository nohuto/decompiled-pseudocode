/*
 * XREFs of ?AssignBudgetsWithinBand@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@W4VIDMM_BUDGET_PRIORITY_BAND@@_K@Z @ 0x1400DBD24
 * Callers:
  ...
  if ( v7 )
  {
    ...
    while ( 1 )
    {
      ...
      do
      {
        ...
        v24 = (int **)v19;
        v19 = *(int **)v19;
        v62 = dword_14005CAF8[*((unsigned __int8 *)v23 - 8)];
        v25 = v21 * v62;
