/*
 * XREFs of ?VidMmQueueAsyncOperation@@YAHPEAU_VIDMM_ASYNC_OPERATION@@@Z @ 0x1400C0AE4
 * Callers:
...
__int64 __fastcall VidMmQueueAsyncOperation(struct _VIDMM_ASYNC_OPERATION *a1)
{
  ...
  if ( v3 == 2 )
  {
    v8 = *((_QWORD *)a1 + 8);
    if ( v8 )
      _InterlockedIncrement((volatile signed __int32 *)(v8 + 428));
  }
  else if ( v3 == 3 )
  {
