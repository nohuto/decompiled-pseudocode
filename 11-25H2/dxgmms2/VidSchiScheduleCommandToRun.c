/*
 * XREFs of VidSchiScheduleCommandToRun @ 0x140023BF0
 * Callers:
 ...
 *     ?VidSchiSelectReadyNode@@YAPEAU_VIDSCH_NODE@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x140022600 (-VidSchiSelectReadyNode@@YAPEAU_VIDSCH_NODE@@PEAU_VIDSCH_GLOBAL@@@Z.c)
 ...
 *     ?VidSchiCheckOutstandingControlEvent@@YAHPEAU_VIDSCH_GLOBAL@@@Z @ 0x140024350 (-VidSchiCheckOutstandingControlEvent@@YAHPEAU_VIDSCH_GLOBAL@@@Z.c)
  ...
  while ( 1 )
  {
    ...
    if ( v7 != (struct _VIDSCH_GLOBAL *)((char *)a1 + 2048) )
    {
      do
      {
        ...
        if ( (unsigned int)VidSchiCheckConditionDeviceCommand(v6, (char *)v7 - 200) )
        {
          v42 = *v41;
          ...
          *v43 = v42;
          *(_QWORD *)(v42 + 8) = v43;
          VidMmAddPendingTermination((struct VIDMM_ALLOC *)(v41 - 25));
        }
        v7 = v40;
      }
              ...
              else
              {
                ...
                if ( !*(_QWORD *)(v19 + 2120) )
                {
                  ...
                  if ( !(_DWORD)v48 )
                  {
                    ...
                    v48 = 16LL;
                    WdLogGlobalForLineNumber = 18827;
                  }
        ...
        if ( (v25 & 1) != 0 )
        {
          ...
          if ( v5 )
          {
            ...
            if ( v27 == (struct _VIDSCH_CONTEXT *)((char *)v16 + 664) )
            {
              ...
              *((_QWORD *)v16 + 81) = 0LL;
              VidSchiUpdateContextStatus(v16, 1LL, 19098LL);
            }
            else
            {
