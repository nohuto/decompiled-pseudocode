/*
 * XREFs of ?EnqueueTask@VIDMM_SCHCLASS_TIMER@@UEAAXPEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK@@@Z @ 0x1400A4C70
 * Callers:
 *     <none>
 * Callees:
 *     CompareTaskExpiration @ 0x1400A4A40 (CompareTaskExpiration.c)
 */
