/*
 * XREFs of ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAUVIDMM_MULTI_ALLOC@@PEAI@Z @ 0x140103830
 * Callers:
 *     VidMmIsAllocationInPresentQueue @ 0x140045ED0 (VidMmIsAllocationInPresentQueue.c)
 * Callees:
