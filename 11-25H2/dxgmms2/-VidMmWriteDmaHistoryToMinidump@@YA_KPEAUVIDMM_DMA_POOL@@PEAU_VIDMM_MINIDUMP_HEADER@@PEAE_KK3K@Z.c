/*
 * XREFs of ?VidMmWriteDmaHistoryToMinidump@@YA_KPEAUVIDMM_DMA_POOL@@PEAU_VIDMM_MINIDUMP_HEADER@@PEAE_KK3K@Z @ 0x1401120F8
 * Callers:
 ...
 *     CheckIfDmaInformationPresent @ 0x14009732C (CheckIfDmaInformationPresent.c)
 *     SearchDmaBufferInAllPool @ 0x1400973F4 (SearchDmaBufferInAllPool.c)
