/*
 * XREFs of ?IsNonOverlappingResourceCB@VIDMM_SEGMENT@@SA_NPEBUVIDMM_PHYSICAL_ALLOC@@@Z @ 0x14009CEB0
 * Callers:
...
char __fastcall VIDMM_SEGMENT::IsNonOverlappingResourceCB(const struct VIDMM_PHYSICAL_ALLOC *a1)
{
  ...
  if ( VIDMM_GLOBAL_ALLOC_NONPAGED::HasOutstandingPresentReferences(*(VIDMM_GLOBAL_ALLOC_NONPAGED **)(*(_QWORD *)a1 + 376LL)) )
    return 1;
  v2 = (_QWORD **)(v1 + 112);
  v3 = *v2;
  while ( 1 )
