/*
 * XREFs of ?SubmitRenderToHwQueue@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@PEAPEAUVIDSCH_HW_QUEUE@@PEAU_KLOCK_QUEUE_HANDLE@@@Z @ 0x140019D10
 * Callers:
        ...
        struct _KLOCK_QUEUE_HANDLE *a4)
{
    ...
    || *(_BYTE *)(v4.QuadPart + 145) )
  {
    ...
    *(_DWORD *)(v31 + 196) = (*(_DWORD *)(v31 + 196) + 1) & (*(_DWORD *)(v31 + 192) - 1);
    ...
    VidSchiCompleteHwQueuePacket((struct HwQueueStagingList ***)a1, (struct _VIDSCH_QUEUE_PACKET *)a2, 0);
  }
  else
  {
