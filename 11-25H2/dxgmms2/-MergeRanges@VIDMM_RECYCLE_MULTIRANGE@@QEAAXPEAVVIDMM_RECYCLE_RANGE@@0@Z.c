/*
 * XREFs of ?MergeRanges@VIDMM_RECYCLE_MULTIRANGE@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@0@Z @ 0x1400C8210
 * Callers:
 ...
 *     ?AddToDecommitDebounce@VIDMM_RECYCLE_HEAP_MGR@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1400C7304 (-AddToDecommitDebounce@VIDMM_RECYCLE_HEAP_MGR@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@@Z.c)
...
LABEL_12:
      ...
      if ( (_DWORD)v25 == 2 )
      {
        if ( dword_1400814E0 && !v13 )
          goto LABEL_104;
        goto LABEL_35;
      }
      if ( !(_DWORD)v25 )
      {
        if ( dword_1400814E0 && v13 && g_IsInternalRelease )
        {
...
LABEL_95:
    ...
    *((_QWORD *)v6 + 12) = *(_QWORD *)(v35 + 1576) + (unsigned int)dword_1400814CC;
