/*
 * XREFs of ?GetAllocationPhysicalAddress@VIDMM_PHYSICAL_ADAPTER@@QEBA_NPEBUVIDMM_PHYSICAL_ALLOC@@PEAIPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1400F8FD4
 * Callers:
 *     VidMmGetPinnedAllocationInfo @ 0x1400F8F10 (VidMmGetPinnedAllocationInfo.c)
