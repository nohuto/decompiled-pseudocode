/*
 * XREFs of ?WaitForFences@VIDMM_GLOBAL@@QEAAXPEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI1PEAU_KEVENT@@@Z @ 0x1400ABC80
 * Callers:
 ...
 *     VidMmWaitForFences @ 0x140045310 (VidMmWaitForFences.c)
...
LABEL_38:
    ...
    HIDWORD(v31) = 0;
    HIDWORD(v30) = 0;
    WdLogGlobalForLineNumber = 15719;
    ...
    if ( v14 && !VidSchIsMonitoredFenceSignaled(v14, v10[i]) )
    {
      ...
      else
      {
        ...
        if ( v15 < 0 )
        {
          ...
          HIDWORD(v31) = 0;
          HIDWORD(v30) = 0;
          WdLogGlobalForLineNumber = 15805;
