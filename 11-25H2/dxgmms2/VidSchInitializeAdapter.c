/*
 * XREFs of VidSchInitializeAdapter @ 0x140115D50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0_VIDSCH_GLOBAL@@QEAA@XZ @ 0x14004B2A4 (--0_VIDSCH_GLOBAL@@QEAA@XZ.c)
 ...
 *     Feature_Servicing_NonVolatileReadInVidSch__private_IsEnabledDeviceUsageNoInline @ 0x14005108C (Feature_Servicing_NonVolatileReadInVidSch__private_IsEnabledDeviceUsageNoInline.c)
...
_VIDSCH_GLOBAL *__fastcall VidSchInitializeAdapter(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = *(_QWORD *)(a1 + 16);
  v109 = v7;
  Pool2 = (_VIDSCH_GLOBAL *)ExAllocatePool2(64LL, 7088LL, 811690326LL);
  if ( !Pool2 )
  {
...
LABEL_134:
  ...
  *((_BYTE *)v9 + 7068) = (unsigned int)Feature_CompositionSwapchainAdvancedSyncSupport__private_IsEnabledDeviceUsageNoInline() != 0;
  IsEnabledDeviceUsageNoInline = Feature_Servicing_NonVolatileReadInVidSch__private_IsEnabledDeviceUsageNoInline();
  v40 = *((_DWORD *)v9 + 10);
  *((_BYTE *)v9 + 7058) = 1;
  v41 = 0;
  *((_BYTE *)v9 + 7069) = IsEnabledDeviceUsageNoInline != 0;
  if ( v40 )
  {
    while ( 1 )
    {
...
LABEL_67:
      ...
      *((_QWORD *)v9 + v41 + 839) = v47;
      ...
      do
      {
        *(_DWORD *)(v48 + *((_QWORD *)v9 + v41 + 429) + 44864) = 929130838;
      ...
      *(_WORD *)(*((_QWORD *)v9 + v41 + 429) + 83088LL) = 0;
      ...
      do
      {
        *(_DWORD *)(v53 + *((_QWORD *)v9 + v41 + 429) + 78992) = 1650551126;
...
LABEL_120:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  v89 = (_QWORD *)qword_1400818A0;
  v90 = (_QWORD *)((char *)v9 + 3792);
  if ( *(PVOID **)qword_1400818A0 != &gAdapterListHead )
    __fastfail(3u);
  *((_QWORD *)v9 + 475) = qword_1400818A0;
  *v90 = &gAdapterListHead;
  *v89 = v90;
  qword_1400818A0 = (__int64)v9 + 3792;
