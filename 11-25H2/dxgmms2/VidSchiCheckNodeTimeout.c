/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1400ADC80
 * Callers:
 *     VidSchiCheckGPUTimeout @ 0x1400AD7D0 (VidSchiCheckGPUTimeout.c)
 *     VidSchiCheckHwProgress @ 0x1400AD870 (VidSchiCheckHwProgress.c)
 * Callees:
 *     ?VidSchiCheckHwSchNodeProgress@@YAEPEAU_VIDSCH_NODE@@_N@Z @ 0x14002F260 (-VidSchiCheckHwSchNodeProgress@@YAEPEAU_VIDSCH_NODE@@_N@Z.c)
 ...
 *     ?VidSchiStartHwSchNodeProgressMonitoring@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x140038CCC (-VidSchiStartHwSchNodeProgressMonitoring@@YAXPEAU_VIDSCH_NODE@@@Z.c)
 *     VidSchiRunningDeviceAllowsLongRunningPackets @ 0x14004316C (VidSchiRunningDeviceAllowsLongRunningPackets.c)
 *     VidSchiSkipXboxNodeTimeout @ 0x1400432C8 (VidSchiSkipXboxNodeTimeout.c)
