/*
 * XREFs of ?MemoryTransferUsingGpuVaWorker@VIDMM_GLOBAL@@QEAAXKPEAUVIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@1PEAU_MDL@@2131U_DXGK_TRANSFERFLAGS@@1@Z @ 0x1400A804C
 * Callers:
...
LABEL_11:
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v24) + 24) = a3;
    WdLogGlobalForLineNumber = 13821;
    v28 = (_QWORD *)WdLogNewEntry5_WdTrace(v27);
    v28[3] = v87;
    v28[4] = a5;
    v28[5] = v22;
    WdLogGlobalForLineNumber = 13823;
    v29 = (_QWORD *)WdLogNewEntry5_WdTrace(a5);
    v30 = v99;
    v29[3] = v99;
    v29[4] = a7;
    v29[5] = a8;
    WdLogGlobalForLineNumber = 13825;
    v31 = (_QWORD *)WdLogNewEntry5_WdTrace(v30);
    v31[3] = v100;
    v31[5] = a11;
    v31[4] = a10;
    WdLogGlobalForLineNumber = 13827;
    a4 = v87;
    v32 = a5;
    v33 = a8;
    v25 = v83;
    ...
    do
    {
      ...
      while ( 1 )
      {
        ...
        if ( v33 )
        {
          v41 = v40[168]
              ...
              : VidMmiGetLogicalAddress(a3[44], v32);
      ...
      while ( 1 )
      {
        ...
        if ( a11 )
        {
          v44 = v40[168]
              ? SysMmGetLogicalAddress(*(void *const *)(*((_QWORD *)v40 + 18) + 528LL))
              : VidMmiGetLogicalAddress(a3[44], a5);
          VidMmiInitializeAdlForPfnArray(
      ...
      do
      {
        ...
        v105.UpdateContextAllocation.ContextAllocation = *((_QWORD *)a3[47] + 6);
