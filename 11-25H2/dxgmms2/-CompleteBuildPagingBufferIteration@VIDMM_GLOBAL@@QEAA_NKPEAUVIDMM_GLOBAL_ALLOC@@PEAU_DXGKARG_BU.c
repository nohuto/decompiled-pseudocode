/*
 * XREFs of ?CompleteBuildPagingBufferIteration@VIDMM_GLOBAL@@QEAA_NKPEAUVIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@JHPEA_KPEAX@Z @ 0x1400BC5E0
 * Callers:
        ...
        void *a8)
{
  ...
  v12 = 0;
  *a7 = -1LL;
  if ( a3 && (**((_DWORD **)a3 + 47) & 0x10000000) != 0 )
    goto LABEL_6;
  v15 = a2;
  ...
  if ( a5 < 0 )
  {
    if ( a5 == -1071775743 )
    {
      if ( g_IsInternalReleaseOrDbg )
      {
        ...
        WdLogGlobalForLineNumber = 18649;
      }
