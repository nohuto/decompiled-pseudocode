/*
 * XREFs of ?CheckFreeVPRReserve@VIDMM_SEGMENT@@QEAA_NPEAU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x14009C764
 * Callers:
...
char __fastcall VIDMM_SEGMENT::CheckFreeVPRReserve(VIDMM_SEGMENT *this, struct _DXGKARG_SETVIDEOPROTECTEDREGION *a2)
{
  ...
  if ( !*((_QWORD *)this + 62) )
    return 0;
  if ( *((_QWORD *)this + 57) + *((_QWORD *)this + 63) == *((_QWORD *)this + 58) )
  {
    v6 = (VIDMM_GLOBAL *)*((_QWORD *)this + 3);
    if ( KeGetCurrentThread() == *(struct _KTHREAD **)(*(_QWORD *)v6 + 8LL) )
    {
      VIDMM_SEGMENT::FreeVPRReserve((VIDMM_LINEAR_POOL **)this);
    }
    else
    {
      memset(v7, 0, 0x58uLL);
    ...
    a2->NewSize = 0LL;
    a2->NewStartOffset = *((_QWORD *)this + 58);
  }
  return v2;
}
