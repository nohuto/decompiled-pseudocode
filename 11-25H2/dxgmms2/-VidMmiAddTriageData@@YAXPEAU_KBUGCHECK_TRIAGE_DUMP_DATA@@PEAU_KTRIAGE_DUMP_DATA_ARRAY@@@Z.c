/*
 * XREFs of ?VidMmiAddTriageData@@YAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@PEAU_KTRIAGE_DUMP_DATA_ARRAY@@@Z @ 0x14004D82C
 * Callers:
 *     DxgMmsDbgTriageDumpCallback @ 0x14004C3A0 (DxgMmsDbgTriageDumpCallback.c)
 * Callees:
 *     <none>
 */
