/*
 * XREFs of VidSchiResetHwEngine @ 0x140052D48
 * Callers:
...
bool __fastcall VidSchiResetHwEngine(struct _VIDSCH_NODE *a1, __int64 a2)
{
  ...
  _BYTE v82[88]; // [rsp+188h] [rbp+88h] BYREF
  char v83; // [rsp+1F0h] [rbp+F0h] BYREF
  bool v84; // [rsp+200h] [rbp+100h]
  __int16 v85; // [rsp+208h] [rbp+108h] BYREF
  ...
  if ( *(struct _VIDSCH_NODE **)(v2 + 3256) == a1 )
  {
    ...
    *(_QWORD *)(v2 + 3248) = RecoveryContext;
    ...
    if ( RecoveryContext )
    {
      ...
      *((_DWORD *)v7 + 14) = *(unsigned __int16 *)(*(_QWORD *)(v2 + 3256) + 4LL);
      ...
      *((_QWORD *)v7 + 13) = DbgOwnerTag;
      ...
      TdrCollectDbgInfoStage1(*(struct _TDR_RECOVERY_CONTEXT **)(v2 + 3248), 1, v14, v13);
    }
  }
  ...
  *((_QWORD *)a1 + 222) = 0LL;
  ...
  if ( !v23 )
  {
    AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v82, (unsigned __int64 *)(v2 + 1984), 1, 0);
          ...
          i = *(struct _VIDSCH_NODE **)i )
    {
      ...
      if ( v27 != v28 )
      {
        ...
        WdLogSingleEntry5(0LL, 281LL, 40960LL, v29, v27, v28);
