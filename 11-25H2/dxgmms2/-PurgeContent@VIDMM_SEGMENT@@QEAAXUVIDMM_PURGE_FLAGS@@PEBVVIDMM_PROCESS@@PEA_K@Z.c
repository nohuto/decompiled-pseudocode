/*
 * XREFs of ?PurgeContent@VIDMM_SEGMENT@@QEAAXUVIDMM_PURGE_FLAGS@@PEBVVIDMM_PROCESS@@PEA_K@Z @ 0x1400E119C
 * Callers:
...
LABEL_14:
              v9 = a2 & 8;
              v13 = v41;
              if ( (**(_DWORD **)(v16 + 376) & 0x10000000) == 0 && (*(_DWORD *)(v16 + 24) & 0x100) == 0 )
              {
                v13 = v41;
                if ( (v15[7] & 3) != 0 )
                {
  ...
  while ( 1 )
  {
    ...
    if ( (*(_DWORD *)v20[16] & 0x10000000) == 0
      ...
      && (v21[3] & 0x100) == 0
      && ((a2 & 4) == 0 || *(_QWORD *)(*(v20 - 31) + 16) + *(_QWORD *)(*(v20 - 31) + 72) > *(_QWORD *)(a1 + 184))
      && !*((_DWORD *)v21 + 19) )
    {
  ...
  while ( 1 )
  {
    ...
    if ( (*(_DWORD *)v31[16] & 0x10000000) == 0
      ...
      && ((a2 & 4) == 0
       ...
       || *(_QWORD *)(*(v31 - 31) + 16) + *(_QWORD *)(*(v31 - 31) + 72) > *(_QWORD *)(a1 + 184))
      && !*((_DWORD *)v32 + 19) )
    {
