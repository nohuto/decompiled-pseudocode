/*
 * XREFs of McTemplateK0pptpqqx_EtwWriteTransfer @ 0x1400425E8
 * Callers:
...
NTSTATUS McTemplateK0pptpqqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, (const EVENT_DESCRIPTOR *)"7", a3, 8u, &v4);
}
