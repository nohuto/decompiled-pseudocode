/*
 * XREFs of ?FlushTemporaryResources@VIDMM_PHYSICAL_ADAPTER@@QEAAX_N0@Z @ 0x1400AB9CC
 * Callers:
...
void __fastcall VIDMM_PHYSICAL_ADAPTER::FlushTemporaryResources(VIDMM_GLOBAL **this, unsigned __int8 a2, char a3)
{
  ...
  if ( a3 || (dword_14008161C & 1) == 0 && (*((_DWORD *)this[6] + 1746) & 0x100000) == 0 )
  {
    if ( a2 )
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)v7 = 0LL;
      *((_QWORD *)v7 + 1) = 0LL;
      VIDMM_PHYSICAL_ADAPTER::ReleaseTemporaryResourcesForAllocation(this, v8);
    }
  }
}
