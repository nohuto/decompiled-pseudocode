/*
 * XREFs of VidSchiUpdateFlipQueueEntriesForMove @ 0x1400508D8
 * Callers:
...
void __fastcall VidSchiUpdateFlipQueueEntriesForMove(__int64 a1, __int64 a2, int a3, __int64 a4, __int64 a5)
{
  ...
  struct _KSPIN_LOCK_QUEUE *volatile Next; // r9
  __int64 v19; // rsi
  __int64 v20; // r8
  __int64 v21; // rcx
  __int64 v22; // rax
  ...
  *(_OWORD *)&LockHandle.LockQueue.Lock = 0LL;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 1984), (PKLOCK_QUEUE_HANDLE)&LockHandle.LockQueue.Lock);
  for ( i = 0; i < *(_DWORD *)(v5 + 40); ++i )
  {
    v7 = *(_QWORD *)(v5 + 8LL * i + 3432);
    if ( v7 )
    {
      ...
      while ( (_WORD)v8 )
      {
        ...
        while ( v11 < v9 )
        {
          ...
          if ( *(_QWORD *)((((__int64)LockHandle.LockQueue.Next + v11) << 6) + v7 + 3344) == a2 )
          {
            ...
            v28[0] = v5;
            LODWORD(v28[1]) = i;
            HIDWORD(v28[1]) = *(unsigned __int16 *)(v7 + v15 + 3368);
            v28[3] = *(_QWORD *)(v7 + v15 + 3336);
            if ( v11 )
              v16 = (__int64 *)(v7 + v15 + 3360);
            else
              v16 = &v25;
            v28[2] = *v16;
            v17 = 0;
