/*
 * XREFs of ?ResetBackingStore@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400C2ADC
 * Callers:
...
LABEL_18:
        if ( (*(_DWORD *)v7 & 0x20000000) != 0 )
        {
          if ( (*((_DWORD *)a2 + 7) & 0x80u) != 0 )
          {
            ...
            if ( v13 >= 0 )
            {
              VidMmiSetPriorityForMemoryPages(BaseAddress, NumberOfBytesToUnlock, v9);
              if ( v10 )
        ...
        {
          LOBYTE(v8) = v10;
          v15 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(**((_QWORD **)a2 + 28) + 112LL))(
                  *((_QWORD *)a2 + 28),
                  *((_QWORD *)a2 + 29),
                  v9,
                  v8);
