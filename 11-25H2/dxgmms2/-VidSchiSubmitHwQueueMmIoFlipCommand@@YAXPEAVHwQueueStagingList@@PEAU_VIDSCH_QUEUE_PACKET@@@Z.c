/*
 * XREFs of ?VidSchiSubmitHwQueueMmIoFlipCommand@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1400118F0
 * Callers:
...
void __fastcall VidSchiSubmitHwQueueMmIoFlipCommand(struct HwQueueStagingList *a1, struct _VIDSCH_QUEUE_PACKET *a2)
{
  ...
  int v98; // ecx
  __int64 *v99; // rax
  unsigned int v100; // [rsp+20h] [rbp-89h]
...
LABEL_65:
  *((_DWORD *)v19 + 319) = v56;
  ...
  while ( v60 || v61 )
  {
    ...
    VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::operator++(v109);
    v67 = v114;
    v61 = v111;
    v60 = v110;
    v66 = v113;
...
LABEL_84:
  *((_DWORD *)a2 + 16) |= 2u;
  if ( v117 )
    VidSchiCompletePendingFlipOnPlane((_DWORD)a1, v9, v101, (_DWORD)v105, 9);
LABEL_86:
