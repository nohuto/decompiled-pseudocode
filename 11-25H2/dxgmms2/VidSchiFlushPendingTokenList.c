/*
 * XREFs of VidSchiFlushPendingTokenList @ 0x14002906C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  v6 = *(int *)(*((_QWORD *)a2 + a3 + 429) + 304LL * a4 + 188);
  if ( (int)v6 <= -1 )
    v7 = 0LL;
  else
    v7 = *((_QWORD *)a2 + 445) + 160 * v6;
  v8 = (void **)(v7 + 120);
  v9 = *(_DWORD *)(v7 + 112) == 3;
  while ( 1 )
  {
    ...
    *v8 = v11;
    ...
    WdLogGlobalForLineNumber = 13433;
    ...
    {
      --*(_DWORD *)(v15 + 1832);
      VidSchiSignalRegisteredEvent(a2, *((_QWORD *)v10 + 5) + 136LL);
    }
    VidSchiSignalRegisteredEvent(a2, (char *)a2 + 1928);
