/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEBU_D3DKMT_FREEGPUVIRTUALADDRESS@@_N@Z @ 0x1400B46FC
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1400414A0 (VidMmFreeGpuVirtualAddress.c)
        ...
        char a4)
{
  ...
  if ( VirtualAddressAllocator )
  {
    ...
    WdLogGlobalForLineNumber = 19139;
  }
  return 3221225485LL;
}
