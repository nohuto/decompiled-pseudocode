/*
 * XREFs of ?InitializeProcessAdapterInfo@VIDMM_PROCESS@@IEAAPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAVVIDMM_GLOBAL@@@Z @ 0x1400B1FC4
 * Callers:
        ...
        struct VIDMM_GLOBAL *a2)
{
  ...
  *((_QWORD *)v5 + 2) = v11;
  if ( !v11 )
  {
    _InterlockedAdd(&dword_140081700, 1u);
    WdLogSingleEntry0(6LL);
    v14 = 666;
LABEL_12:
    v15 = 262145LL;
