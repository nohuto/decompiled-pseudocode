/*
 * XREFs of ?VidSchiCollectTdrPayloadEngineTimeout@@YAXPEAU_VIDSCH_NODE@@PEAU_DXGK_TDR_PAYLOAD_ENGINE_TIMEOUT@@@Z @ 0x140051FA0
 * Callers:
        ...
        struct _DXGK_TDR_PAYLOAD_ENGINE_TIMEOUT *a2)
{
  ...
  v4 = *((_QWORD *)a1 + 3);
  v6 = *(_QWORD *)(v4 + 688);
  if ( (unsigned int)v2 < *(_DWORD *)(v4 + 760) )
    v6 += 8 * v2;
  *((_DWORD *)a2 + 1) = *(unsigned __int16 *)(*(_QWORD *)v6 + 6LL);
  v7 = *((unsigned __int16 *)a1 + 2);
  v8 = *(_QWORD *)(v4 + 688);
  if ( (unsigned int)v7 < *(_DWORD *)(v4 + 760) )
    v8 += 8 * v7;
  *(_DWORD *)a2 = *(unsigned __int16 *)(*(_QWORD *)v8 + 8LL);
  AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v23, (unsigned __int64 *)(v4 + 1984), 1, 0);
  if ( (*((_DWORD *)a1 + 3) & 2) != 0 )
  {
    v9 = 0LL;
    ...
    *((_DWORD *)a2 + 7) = v10;
    ...
    while ( 1 )
    {
      ...
      if ( *(v12 - 5) == *(v12 - 6) )
      {
        if ( *((_DWORD *)v13 + 76) )
        {
          for ( i = (__int64 *)v13[36]; i != v13 + 36; i = (__int64 *)*i )
          {
            if ( *((_DWORD *)i + 36) )
              goto LABEL_13;
          }
...
LABEL_13:
      if ( !v9 )
        goto LABEL_30;
      v15 = v9[1];
      if ( *(_BYTE *)(*(_QWORD *)(v15 + 40) + 2632LL) || (v17 = *(_DWORD *)(v15 + 48), (v17 & 8) != 0) )
        v16 = 1;
      else
        v16 = v17 & 1;
      v18 = v13[1];
      if ( *(_BYTE *)(*(_QWORD *)(v18 + 40) + 2632LL) || (v20 = *(_DWORD *)(v18 + 48), (v20 & 8) != 0) )
        v19 = 1;
      else
        v19 = v20 & 1;
      if ( v16 )
