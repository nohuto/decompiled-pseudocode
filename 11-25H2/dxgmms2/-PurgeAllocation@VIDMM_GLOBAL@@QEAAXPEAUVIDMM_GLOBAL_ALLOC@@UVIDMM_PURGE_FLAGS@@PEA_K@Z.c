/*
 * XREFs of ?PurgeAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@UVIDMM_PURGE_FLAGS@@PEA_K@Z @ 0x1400E1624
 * Callers:
...
void __fastcall VIDMM_GLOBAL::PurgeAllocation(VIDMM_GLOBAL *a1, _DWORD *a2, char a3, _QWORD *a4)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1) + 24) = a2;
    WdLogGlobalForLineNumber = 17617;
  }
  v8 = a2[6] & 0x3F;
  ...
  if ( !a2[19] )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)a2 + 56LL) & 1) != 0 )
    {
      if ( g_IsInternalReleaseOrDbg )
      {
        ...
        WdLogGlobalForLineNumber = 17633;
      }
