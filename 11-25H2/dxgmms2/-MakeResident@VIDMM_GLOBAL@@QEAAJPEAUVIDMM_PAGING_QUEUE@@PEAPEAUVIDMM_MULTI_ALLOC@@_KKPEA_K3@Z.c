/*
 * XREFs of ?MakeResident@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_PAGING_QUEUE@@PEAPEAUVIDMM_MULTI_ALLOC@@_KKPEA_K3@Z @ 0x1400B1014
 * Callers:
 *     VidMmMakeResident @ 0x140039800 (VidMmMakeResident.c)
 ...
 *     VidMmiShouldChargeAllocationAgainstBudget @ 0x1400E5728 (VidMmiShouldChargeAllocationAgainstBudget.c)
 ...
 *     ?CommitProjectedMemoryUsage@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1400F7B5C (-CommitProjectedMemoryUsage@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ.c)
 */
        ...
        unsigned __int64 *a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( (a5 & 2) != 0 )
    VidSchMarkDeviceAsError(*(_QWORD *)(v10 + 32), 12);
  return 3221225495LL;
}
