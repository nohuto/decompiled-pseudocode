/*
 * XREFs of VidSchiOpenProcessAdapterInfo @ 0x1400D8678
 * Callers:
 ...
 *     ??_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z @ 0x140042A28 (--_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z.c)
...
LABEL_3:
  ...
  if ( !Pool2 )
  {
    ...
    WdLogGlobalForLineNumber = 28950;
    ExReleasePushLockExclusiveEx(v3, 0LL);
    return 3221225495LL;
  }
...
LABEL_32:
        ...
        WdLogSingleEntry0(3LL);
        WdLogGlobalForLineNumber = 28993;
        v10 = -1073741801;
LABEL_33:
      ...
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 28980;
      DxgkLogInternalTriageEvent(v37, 0x40000LL);
    }
    else
    {
      WdLogSingleEntry0(3LL);
      WdLogGlobalForLineNumber = 28969;
    }
LABEL_40:
    v10 = -1073741801;
  }
