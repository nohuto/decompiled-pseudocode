/*
 * XREFs of ?InitializeAndMapTransportBuffer@VIDMM_GLOBAL@@QEAAJPEAPEAVVIDMM_TRANSPORT_BUFFER@@_KPEAPEAX@Z @ 0x140094D18
 * Callers:
 *     VidMmInitializeAndMapTransportBuffer @ 0x14004C670 (VidMmInitializeAndMapTransportBuffer.c)
 * Callees:
