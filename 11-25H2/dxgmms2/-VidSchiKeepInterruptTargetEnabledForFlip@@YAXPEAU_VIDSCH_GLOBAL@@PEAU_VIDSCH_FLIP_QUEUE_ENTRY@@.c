/*
 * XREFs of ?VidSchiKeepInterruptTargetEnabledForFlip@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_PRESENT_INFO@@@Z @ 0x14004A75C
 * Callers:
        ...
        struct _VIDSCH_PRESENT_INFO *a3)
{
  ...
  while ( v7 || v9 )
  {
    if ( v15 < v16 )
      v16 = v15;
    v17 = *(_QWORD *)(v10 * ((8 * *(_DWORD *)(*((_QWORD *)a2 + 149) + 8LL) + 231) & 0xFFFFFFF8)
                    + *((_QWORD *)a2 + 149)
                    + 24LL);
    if ( v17 )
    {
