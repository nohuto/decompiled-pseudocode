/*
 * XREFs of VidSchiSetFlipDevice @ 0x140029540
 * Callers:
 ...
 *     ?IsMockDriverStateEnabled@DXGADAPTER@@QEAA_NXZ @ 0x140028140 (-IsMockDriverStateEnabled@DXGADAPTER@@QEAA_NXZ.c)
 *     ??_GVIDSCH_FLIP_QUEUE@@QEAAPEAXI@Z @ 0x140028578 (--_GVIDSCH_FLIP_QUEUE@@QEAAPEAXI@Z.c)
 *     ?InitializeFlipQueueEntry@_VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z @ 0x14002A124 (-InitializeFlipQueueEntry@_VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z.c)
 ...
 *     ?GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ @ 0x140044170 (-GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ.c)
        ...
        char a7)
{
  ...
  unsigned int v57; // [rsp+44h] [rbp-7Dh]
  ...
  WdLogGlobalForLineNumber = 23158;
  if ( (_DWORD)v7 )
  {
...
LABEL_75:
  ...
  if ( !a3 || a3 == *(struct _VIDSCH_DEVICE **)(v12 + 16) )
  {
    ...
    v70[0] = v70;
    v72 = 2;
    VidSchiCompletePendingFlip((struct HwQueueStagingList *)&v69, (__int64)a1, v75, a5);
    if ( !v71 && v72 )
