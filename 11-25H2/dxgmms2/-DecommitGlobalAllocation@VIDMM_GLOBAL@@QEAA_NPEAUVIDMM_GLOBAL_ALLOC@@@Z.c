/*
 * XREFs of ?DecommitGlobalAllocation@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400FDCE0
 * Callers:
...
char __fastcall VIDMM_GLOBAL::DecommitGlobalAllocation(VIDMM_GLOBAL *this, struct VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v4) + 24) = a2;
    WdLogGlobalForLineNumber = 26762;
  }
  v7 = 0;
  DXGFASTMUTEX::Acquire((struct VIDMM_GLOBAL_ALLOC *)((char *)a2 + 136));
  v8 = 1;
  if ( *(_WORD *)(*((_QWORD *)a2 + 47) + 8LL) == 2 && (*((_DWORD *)a2 + 8) & 0x40) != 0 )
  {
    *((_DWORD *)a2 + 7) |= 0x40u;
    v7 = 1;
  }
  ...
  else
  {
    v8 = 0;
    WdLogSingleEntry1(3LL, a2);
    WdLogGlobalForLineNumber = 26895;
  }
  DXGFASTMUTEX::Release((struct _KTHREAD **)a2 + 17);
  return v8;
}
