/*
 * XREFs of ?VidMmPrepareDmaBuffer@@YAJPEBVVIDMM_GLOBAL@@PEBUVIDMM_DMA_BUFFER@@IPEAIPEAT_LARGE_INTEGER@@@Z @ 0x1400AFDD0
 * Callers:
 ...
 *     ReferenceAllocationForSubmission @ 0x1400AFF0C (ReferenceAllocationForSubmission.c)
