/*
 * XREFs of ?UnlockAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_LOCAL_ALLOC@@_K1EE@Z @ 0x1400E604C
 * Callers:
        ...
        char a6)
{
  ...
  if ( (v16 & 0x4000) == 0 )
  {
    ...
    else
    {
      ...
      if ( v17 )
      {
        (*(void (__fastcall **)(_QWORD, __int64, unsigned __int64, unsigned __int64, char))(**(_QWORD **)(v15 + 224)
                                                                                          + 40LL))(
          *(_QWORD *)(v15 + 224),
          v17,
          a3,
