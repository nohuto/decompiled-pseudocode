/*
 * XREFs of VidSchiCompletePendingFlipOnPlane @ 0x140027538
 * Callers:
      ...
      if ( (int)v9 > -1 )
      {
        ...
        if ( v10 )
        {
          if ( (unsigned int)(*(_DWORD *)(v10 + 112) - 1) <= 1 )
          {
            ...
            v17 = 0;
            v15 = 0;
            ((void (__fastcall *)(struct HwQueueStagingList *, __int64, __int64, __int64, _DWORD, char, char *, _QWORD *))VidSchExitIndependentFlipInternal)(
              a1,
              a2,
              v10,
              v14,
