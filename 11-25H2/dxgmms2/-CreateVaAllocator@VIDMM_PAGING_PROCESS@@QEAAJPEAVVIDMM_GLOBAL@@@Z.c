/*
 * XREFs of ?CreateVaAllocator@VIDMM_PAGING_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x14009952C
 * Callers:
    ...
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)a2 + 1736); i = (unsigned int)(i + 1) )
    {
      if ( (*(_BYTE *)(*(_QWORD *)(*((_QWORD *)a2 + 5029) + 8 * i) + 476LL) & 0xD) != 0 )
      {
        ...
        *((_QWORD *)this + i + 4) = v6;
        if ( !v6 )
        {
          _InterlockedIncrement(&dword_14008184C);
          WdLogSingleEntry0(6LL);
          WdLogGlobalForLineNumber = 8990;
