/*
 * XREFs of ?Init@VIDMM_PROCESS@@QEAAJPEAVDXGPROCESS@@@Z @ 0x1400FAE10
 * Callers:
 ...
 *     ??0VIDMM_PROCESS_HEAP@@QEAA@XZ @ 0x14009FE2C (--0VIDMM_PROCESS_HEAP@@QEAA@XZ.c)
 ...
 *     ??0VIDMM_RECYCLE_HEAP_MGR@@QEAA@XZ @ 0x1400FB678 (--0VIDMM_RECYCLE_HEAP_MGR@@QEAA@XZ.c)
 */
...
LABEL_15:
  ...
  if ( !v17 )
  {
    _InterlockedIncrement(&dword_1400816F8);
    WdLogSingleEntry0(6LL);
    v21 = 307;
LABEL_24:
