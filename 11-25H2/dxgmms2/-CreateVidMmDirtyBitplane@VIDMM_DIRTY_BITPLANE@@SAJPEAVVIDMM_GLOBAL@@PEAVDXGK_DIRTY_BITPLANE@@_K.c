/*
 * XREFs of ?CreateVidMmDirtyBitplane@VIDMM_DIRTY_BITPLANE@@SAJPEAVVIDMM_GLOBAL@@PEAVDXGK_DIRTY_BITPLANE@@_KPEAPEAV1@@Z @ 0x14004E8D8
 * Callers:
 *     ?CreateDirtyBitplane@VIDMM_GLOBAL@@QEAAJPEAVDXGK_DIRTY_BITPLANE@@_KPEAPEAVVIDMM_DIRTY_BITPLANE@@@Z @ 0x140092DC4 (-CreateDirtyBitplane@VIDMM_GLOBAL@@QEAAJPEAVDXGK_DIRTY_BITPLANE@@_KPEAPEAVVIDMM_DIRTY_BITPLANE@@.c)
 * Callees:
        ...
        struct VIDMM_DIRTY_BITPLANE **a4)
{
  ...
  _QWORD v37[19]; // [rsp+80h] [rbp-98h] BYREF
  __int64 StartingRunIndex; // [rsp+130h] [rbp+18h] BYREF
  struct VIDMM_DIRTY_BITPLANE **v39; // [rsp+138h] [rbp+20h]
