/*
 * XREFs of ?IteratePhysicalMemoryRanges@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAUVIDMM_PHYSICAL_ALLOC@@P6AJPEAU1@0PEBUVIDMM_ITERATE_PHYSICAL_MEMORY_RANGE_DESC@@PEAX@Z3II@Z @ 0x1400BDF30
 * Callers:
  ...
  if ( (*((_DWORD *)v7 + 26) & 0x1001) != 0 )
  {
    ...
    if ( !v8 )
    {
      ...
      else
      {
        v11 = *(_QWORD *)(v10 + 232);
        v8 = v11
           ? (*(__int64 (__fastcall **)(_QWORD, __int64, int (*)(struct VIDMM_PHYSICAL_ADAPTER *, struct VIDMM_PHYSICAL_ALLOC *, const struct VIDMM_ITERATE_PHYSICAL_MEMORY_RANGE_DESC *, void *)))(**(_QWORD **)(v10 + 224) + 88LL))(
               *(_QWORD *)(v10 + 224),
               v11,
               a3)
