/*
 * XREFs of ?InvalidateCache@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAUVIDMM_MULTI_GLOBAL_ALLOC@@PEAUVIDMM_MULTI_ALLOC@@_K3@Z @ 0x1400955CC
 * Callers:
 *     VidMmInvalidateCache @ 0x14004C710 (VidMmInvalidateCache.c)
 * Callees:
        ...
        unsigned __int64 Length)
{
  ...
  if ( !*((_BYTE *)this + 7018) && (!a2 || (*(_DWORD *)(*((_QWORD *)a2 + 4) + 408LL) & 0x1000) == 0) )
  {
    ...
    WdLogGlobalForLineNumber = 25670;
...
LABEL_14:
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    v19[4] = a5;
    v19[5] = Length;
    WdLogGlobalForLineNumber = 25728;
  }
  if ( !Length )
    v18 = *(_QWORD *)(v14 + 16);
  v20 = *(_QWORD *)(v14 + 16);
  if ( a5 >= v20 )
  {
    ...
    WdLogGlobalForLineNumber = 25741;
    goto LABEL_14;
  }
  if ( v18 > v20 - a5 )
  {
    WdLogSingleEntry1(1LL, v20);
    WdLogGlobalForLineNumber = 25749;
    goto LABEL_14;
  }
  ...
  else if ( (**((_DWORD **)v8 + 47) & 8) != 0 )
  {
    v21 = (struct VIDMM_MULTI_GLOBAL_ALLOC *)*((_QWORD *)v8 + 27);
  }
  else
  {
    v21 = v10[2];
  ...
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 25777;
