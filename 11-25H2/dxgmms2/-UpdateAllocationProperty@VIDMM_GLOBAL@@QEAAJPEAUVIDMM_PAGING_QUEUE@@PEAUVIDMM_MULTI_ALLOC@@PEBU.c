/*
 * XREFs of ?UpdateAllocationProperty@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_PAGING_QUEUE@@PEAUVIDMM_MULTI_ALLOC@@PEBUVIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x14010EF94
 * Callers:
 *     VidMmUpdateAllocationProperty @ 0x1400462F0 (VidMmUpdateAllocationProperty.c)
 * Callees:
...
LABEL_4:
    ...
    v17 = *((_DWORD *)v10 + 6);
    v18 = (struct _DXGK_ALLOCATIONINFOFLAGS_WDDM2_0 *)v10[47];
    v25 = 0;
  ...
  if ( (v19 & 1) != 0 && (*(_DWORD *)v10[47] & 0x8000) != 0 )
  {
