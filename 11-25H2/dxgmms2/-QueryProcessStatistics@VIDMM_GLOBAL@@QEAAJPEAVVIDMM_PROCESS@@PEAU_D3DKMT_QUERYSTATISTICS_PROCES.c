/*
 * XREFs of ?QueryProcessStatistics@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_INFORMATION@@@Z @ 0x140103D38
 * Callers:
 *     VidMmQueryProcessStatistics @ 0x140043580 (VidMmQueryProcessStatistics.c)
 * Callees:
 *     <none>
 */
