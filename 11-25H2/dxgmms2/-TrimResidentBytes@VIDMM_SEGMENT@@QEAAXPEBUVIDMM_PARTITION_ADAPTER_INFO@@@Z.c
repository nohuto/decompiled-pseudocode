/*
 * XREFs of ?TrimResidentBytes@VIDMM_SEGMENT@@QEAAXPEBUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x1400F8594
 * Callers:
  ...
  if ( ((_DWORD)this[13] & 0x1001) != 0 && *(_QWORD *)(*(_QWORD *)a2 + 64LL) > *((_QWORD *)a2 + 2) )
  {
    if ( g_IsInternalReleaseOrDbg )
    {
      ...
      *(_QWORD *)(v7 + 32) = *(_QWORD *)(*(_QWORD *)a2 + 64LL);
      WdLogGlobalForLineNumber = 25924;
    }
    v5 = this[27];
    while ( v5 != (VIDMM_SEGMENT *)(this + 27) )
    {
      v4 = (struct VIDMM_PHYSICAL_ALLOC **)((char *)v5 - 248);
      v5 = *(VIDMM_SEGMENT **)v5;
      v6 = v4[42];
      if ( v6 == a2 )
      {
