/*
 * XREFs of VidSchiWaitForEmptyHwQueue @ 0x140112850
 * Callers:
  ...
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 80); i = (unsigned int)(i + 1) )
  {
    ...
    *(_QWORD *)(v4 + 280) = MEMORY[0xFFFFF78000000320];
    ...
    while ( 1 )
    {
      ...
      if ( !(_DWORD)result )
        break;
      VidSchiProfilePerformanceTick(16, a1, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL);
      VidSchWaitForCompletionEvent(a1, (__int64)v6, -1);
      VidSchiProfilePerformanceTick(17, a1, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL);
    }
  }
  return result;
}
