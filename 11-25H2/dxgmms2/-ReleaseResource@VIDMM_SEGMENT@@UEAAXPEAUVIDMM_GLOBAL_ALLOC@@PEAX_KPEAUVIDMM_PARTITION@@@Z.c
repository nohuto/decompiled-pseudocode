/*
 * XREFs of ?ReleaseResource@VIDMM_SEGMENT@@UEAAXPEAUVIDMM_GLOBAL_ALLOC@@PEAX_KPEAUVIDMM_PARTITION@@@Z @ 0x1400D5120
 * Callers:
 *     <none>
 * Callees:
        ...
        struct VIDMM_PARTITION *a5)
{
  ...
  if ( a2 )
  {
    ...
    {
      v51 = *a2;
      VIDMM_SEGMENT::DecrementBytesCommitted(v8, *a2[42], (unsigned __int64)(*a2)[2]);
      --*((_DWORD *)v8 + 90);
      if ( (*((_DWORD *)v8 + 26) & 0x1001) != 0 )
      {
        this = (VIDMM_SEGMENT *)a2[43];
...
LABEL_37:
  ...
  *((_QWORD *)v8 + 33) -= a4;
  if ( *((_DWORD *)v8 + 102) != -1 && !(_BYTE)v25 )
  {
    ...
    v36 = *((_QWORD *)v8 + 34) - a4;
    *((_QWORD *)v8 + 34) = v36;
    if ( v36 <= qword_1400815A8 && v34 > qword_1400815A8 )
  ...
  *(_QWORD *)(v31 + 128) -= a4;
  ...
  if ( (*((_DWORD *)v8 + 26) & 0x1001) != 0 )
  {
    ...
    if ( (!v32 || _InterlockedExchangeAdd((volatile signed __int32 *)v32 + 10, 0xFFFFFFFF) == 1)
      && _InterlockedExchangeAdd64((volatile signed __int64 *)*a2[42] + 8, -(__int64)a4) < a4 )
    {
      WdLogSingleEntry0(1LL);
