/*
 * XREFs of ?InitializeSegmentPowerManagement@VIDMM_GLOBAL@@QEAAJIIIW4_DXGK_POWER_COMPONENT_TYPE@@@Z @ 0x140095488
 * Callers:
 *     VidMmInitializeSegmentPowerManagement @ 0x14004C6B0 (VidMmInitializeSegmentPowerManagement.c)
 * Callees:
