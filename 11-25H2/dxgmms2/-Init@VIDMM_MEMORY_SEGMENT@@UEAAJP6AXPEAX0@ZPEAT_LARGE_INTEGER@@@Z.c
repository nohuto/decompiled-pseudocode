/*
 * XREFs of ?Init@VIDMM_MEMORY_SEGMENT@@UEAAJP6AXPEAX0@ZPEAT_LARGE_INTEGER@@@Z @ 0x14010D360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?BlockRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z @ 0x1400A2C5C (-BlockRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z.c)
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  *((_DWORD *)this + 26) = v10;
  if ( (v10 & 0x40) == 0 )
    goto LABEL_13;
  if ( *((_QWORD *)this + 11) > (unsigned __int64)(qword_140081600 - 0x800000) )
  {
    ...
    *((_QWORD *)this + 31) = *((_QWORD *)this + 9);
    if ( !v13 )
    {
      ...
      *((_QWORD *)this + 69) = v14;
      if ( !v14 )
      {
        _InterlockedIncrement(&dword_1400817B0);
