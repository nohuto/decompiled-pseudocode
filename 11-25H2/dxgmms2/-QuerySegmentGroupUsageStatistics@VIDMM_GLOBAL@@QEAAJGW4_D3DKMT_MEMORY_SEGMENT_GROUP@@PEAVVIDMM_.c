/*
 * XREFs of ?QuerySegmentGroupUsageStatistics@VIDMM_GLOBAL@@QEAAJGW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_MEMORY_USAGE@@@Z @ 0x140099284
 * Callers:
 *     VidMmQuerySegmentGroupUsageStatistics @ 0x14004C870 (VidMmQuerySegmentGroupUsageStatistics.c)
 * Callees:
