/*
 * XREFs of ?PageInFaultedAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@_NPEA_NPEAPEAU2@@Z @ 0x1400E27E4
 * Callers:
...
LABEL_10:
    ...
    WdLogGlobalForLineNumber = 17176;
  }
  return (unsigned int)v8;
}
