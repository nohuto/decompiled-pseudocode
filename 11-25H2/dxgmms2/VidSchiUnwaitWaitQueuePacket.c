/*
 * XREFs of VidSchiUnwaitWaitQueuePacket @ 0x14002FA0C
 * Callers:
 ...
 *     ?VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x14004ABD4 (-VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
 ...
 *     ?RemoveEntryListInstrumented@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_LIST_ENTRY@@1@Z @ 0x140038ACC (-RemoveEntryListInstrumented@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_LIST_ENTRY@@1@Z.c)
 */
        ...
        struct VIDSCH_HW_QUEUE **a4)
{
  ...
  if ( (byte_140081241 & 1) != 0 )
  {
    if ( v6 )
    {
      v12 = *(struct VIDSCH_HW_QUEUE **)(v6 + 56);
      if ( !v12 || (*(_DWORD *)(v6 + 112) & 0x40) != 0 )
        v12 = (struct VIDSCH_HW_QUEUE *)v6;
    }
    else
    {
      v12 = (struct VIDSCH_HW_QUEUE *)*((_QWORD *)*v9 + 6);
      if ( !v12 )
        v12 = *v9;
    }
  ...
  if ( *(_BYTE *)(v11 + 7059) )
  {
    RemoveEntryListInstrumented(
      (struct _VIDSCH_GLOBAL *)v11,
      (struct _LIST_ENTRY *)(a2 + 768),
      (struct _LIST_ENTRY *)(a2 + 176));
  }
  else
  {
    v14 = *v13;
  ...
  if ( (v20 & 0x10) != 0 )
  {
    ...
    if ( *(_QWORD *)(v22 + 8) == a2 + 32 )
    {
      ...
      if ( (_QWORD *)*v23 == v21 )
      {
        ...
        *(_DWORD *)(a2 + 64) &= ~0x10u;
        VidSchiFreeQueuePacket(*(_QWORD *)(a2 + 88));
        return;
      }
    }
LABEL_41:
  ...
  if ( v24 )
  {
    if ( (*(_DWORD *)(v24 + 184) & 0x20) != 0 )
    {
      *(_DWORD *)(*(_QWORD *)(a2 + 88) + 184LL) &= ~0x20u;
      if ( VidSchiUnwaitContext(*(_QWORD *)(a2 + 88), 0x6959u) )
      {
