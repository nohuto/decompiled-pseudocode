/*
 * XREFs of ?TransferOwnershipToSystemProcess@VIDMM_GLOBAL@@QEAAPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@PEAU2@@Z @ 0x1400E62B4
 * Callers:
        ...
        struct VIDMM_LOCAL_ALLOC *a3)
{
  ...
  if ( (int)VIDMM_GLOBAL::OpenOneAllocation(this, v7, a2, 0LL, 0, 0LL, &v16, &v15) < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 28722;
  ...
  if ( *((int *)a2 + 47) > 0 )
  {
    ...
    if ( v12 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 28750;
