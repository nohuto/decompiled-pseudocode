/*
 * XREFs of VidSchiSwitchContext @ 0x14002A380
 * Callers:
...
void __fastcall VidSchiSwitchContext(__int64 a1)
{
  ...
  if ( v3 != a1 )
  {
    ...
    *(_QWORD *)(v8 + 8) = v9;
    while ( 1 )
    {
      v10 = VidSchiInterlockedRemoveHeadListIfExist(v1, v3 + 712, v3 + 728);
      if ( !v10 )
        break;
...
LABEL_19:
      ...
      v12 = *(_QWORD *)(v3 + 104);
      if ( _InterlockedExchangeAdd64((volatile signed __int64 *)(v12 + 24), v2) != 1 )
        goto LABEL_24;
      v13 = *(_QWORD *)(v12 + 104);
...
LABEL_29:
    while ( 1 )
    {
      v15 = VidSchiInterlockedRemoveHeadListIfExist(v1, v3 + 736, v3 + 752);
      if ( !v15 )
        break;
