/*
 * XREFs of ?UnmapAllocationFromIoMmu@VIDMM_SEGMENT@@IEAAXPEAUVIDMM_GLOBAL_ALLOC@@PEAUVIDMM_LOCAL_ALLOC@@@Z @ 0x1400FF4B0
 * Callers:
...
void __fastcall VIDMM_SEGMENT::UnmapAllocationFromIoMmu(VIDMM_SEGMENT *this, void **a2, struct VIDMM_LOCAL_ALLOC *a3)
{
  ...
  if ( (*((_DWORD *)a2 + 7) & 0x800) == 0 )
  {
    ...
    v6 = *(_DWORD *)a2[47];
    LogicalAddress = VidMmiGetLogicalAddress(a2[44], 0LL);
