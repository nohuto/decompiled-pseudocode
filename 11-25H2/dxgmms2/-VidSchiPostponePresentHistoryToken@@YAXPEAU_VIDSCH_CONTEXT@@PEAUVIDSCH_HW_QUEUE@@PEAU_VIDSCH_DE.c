/*
 * XREFs of ?VidSchiPostponePresentHistoryToken@@YAXPEAU_VIDSCH_CONTEXT@@PEAUVIDSCH_HW_QUEUE@@PEAU_VIDSCH_DEVICE@@PEAUVIDSCH_SUBMIT_DATA2@@T_ULARGE_INTEGER@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x1400148EC
 * Callers:
 ...
 *     ?VidSchiReleasePrivateDataReference@@YAXPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@@@Z @ 0x140035EE0 (-VidSchiReleasePrivateDataReference@@YAXPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@.c)
        ...
        struct _VIDSCH_GLOBAL *a6)
{
  ...
  if ( Pool2 )
  {
    ...
    VidSchiReleasePrivateDataReference(v17, v6);
    v18 = *(_QWORD *)(Pool2 + 80);
    if ( v18 )
    ...
    *(_QWORD *)(Pool2 + 40) = a3;
    if ( a3 )
      ++*((_DWORD *)a3 + 458);
    ++*((_DWORD *)a6 + 215);
    v19 = *(int *)(*((_QWORD *)a6 + v22 + 429) + 304LL * v23 + 188);
    if ( (int)v19 > -1 )
      v8 = *((_QWORD *)a6 + 445) + 160 * v19;
    v20 = v8 + 120;
    v21 = *(__int64 **)(v20 + 8);
    if ( *v21 != v20 )
      __fastfail(3u);
