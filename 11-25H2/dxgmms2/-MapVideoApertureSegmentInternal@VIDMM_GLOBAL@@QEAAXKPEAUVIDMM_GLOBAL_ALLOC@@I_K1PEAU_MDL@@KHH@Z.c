/*
 * XREFs of ?MapVideoApertureSegmentInternal@VIDMM_GLOBAL@@QEAAXKPEAUVIDMM_GLOBAL_ALLOC@@I_K1PEAU_MDL@@KHH@Z @ 0x1400BC1BC
 * Callers:
...
LABEL_18:
    ...
    {
      LogicalAddress = VidMmiGetLogicalAddress(*((void **)a3 + 44), 0LL);
      v30 = *(_DWORD **)v24;
      v31 = LogicalAddress;
