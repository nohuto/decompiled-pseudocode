/*
 * XREFs of ?CreatePageDirectory@@YAPEAVVIDMM_PAGE_DIRECTORY@@PEAVCVirtualAddressAllocator@@II@Z @ 0x1400E68BC
 * Callers:
 ...
 *     ??0VIDMM_PAGE_DIRECTORY@@QEAA@III@Z @ 0x1400E69F4 (--0VIDMM_PAGE_DIRECTORY@@QEAA@III@Z.c)
        ...
        unsigned int a3)
{
  ...
  v6 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 11) + 40232LL) + 8LL * a2);
  v7 = (VIDMM_PAGE_DIRECTORY *)operator new(56LL, 0x36356956u, 256LL);
  if ( v7 && (v8 = VIDMM_PAGE_DIRECTORY::VIDMM_PAGE_DIRECTORY(v7, a2, *(_DWORD *)(v6 + 468), a3), (v9 = v8) != 0LL) )
  {
    ...
    VIDMM_PAGE_DIRECTORY::DestroyPageDirectory(v9, (PRKPROCESS **)a1, 0LL);
  }
  else
  {
