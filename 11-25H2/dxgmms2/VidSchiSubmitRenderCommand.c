/*
 * XREFs of VidSchiSubmitRenderCommand @ 0x1400AEEB8
 * Callers:
 ...
 *     ?VidMmIsDmaBufferPrepatched@@YA_NPEBUVIDMM_DMA_BUFFER@@@Z @ 0x1400B0018 (-VidMmIsDmaBufferPrepatched@@YA_NPEBUVIDMM_DMA_BUFFER@@@Z.c)
...
LABEL_17:
  ...
  if ( *(_DWORD *)(*(_QWORD *)(v2.QuadPart + 128) + 32LL) )
    DmaPacket = *(union _LARGE_INTEGER **)(*(_QWORD *)(v2.QuadPart + 48) + 216LL);
  else
