/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x14010AD08
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  v1 = v0;
LABEL_6:
  qword_140081548 = 10000LL * v3;
  qword_140081550 = 10000LL * v4;
  qword_140081558 = 10000LL * v5;
  qword_140081560 = 10000LL * v6;
  qword_140081580 = v35;
  dword_140081588 = v9;
  qword_140081568 = 10000LL * v0;
  qword_140081570 = (unsigned int)(10000 * v7);
  qword_1400815B0 = (unsigned __int64)v10 << 20;
  dword_1400814BC = v11;
  dword_140081590 = v12;
  dword_140081594 = v13;
  dword_140081618 = v14;
  dword_14008161C = v15;
  qword_140081578 = (unsigned int)(10000 * v8);
  if ( (unsigned int)Feature_Servicing_GraphicsKernel_PromotionRegistryKey__private_IsEnabledDeviceUsageNoInline() )
    byte_14008158C = v16 != 0;
}
