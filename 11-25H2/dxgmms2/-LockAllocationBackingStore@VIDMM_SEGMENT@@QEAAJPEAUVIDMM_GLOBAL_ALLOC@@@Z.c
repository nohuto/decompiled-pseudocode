/*
 * XREFs of ?LockAllocationBackingStore@VIDMM_SEGMENT@@QEAAJPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400C2360
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::LockAllocationBackingStore(VIDMM_SEGMENT *this, struct VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(v2 + 24) + 444LL) & 4) != 0 && (**((_DWORD **)a2 + 47) & 0x4000) == 0
    || (v6 = *((_DWORD *)a2 + 7), (v6 & 0x4000) != 0) )
  {
    if ( *((_QWORD *)a2 + 29) )
    {
      ...
      (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)a2 + 28) + 144LL))(
        *((_QWORD *)a2 + 28),
        *((_QWORD *)a2 + 29));
...
LABEL_21:
  ...
  if ( (v6 & 0x10000) == 0 )
  {
    ...
    if ( v15 )
    {
      v16 = (*(__int64 (__fastcall **)(_QWORD, __int64, struct VIDMM_GLOBAL_ALLOC *, _QWORD, unsigned __int64, int, VIDMM_SEGMENT *, _BYTE))(**((_QWORD **)a2 + 28) + 32LL))(
              *((_QWORD *)a2 + 28),
              v15,
              a2,
              0LL,
