/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJ_NPEAVVIDMM_PROCESS@@@Z @ 0x1400B1854
 * Callers:
 *     VidMmInitDevice @ 0x140043150 (VidMmInitDevice.c)
...
__int64 __fastcall VIDMM_DEVICE::Init(VIDMM_DEVICE *this, char a2, struct VIDMM_PROCESS *a3)
{
  ...
  *((_QWORD *)this + 5) = v10;
  if ( !v10 )
  {
    _InterlockedAdd(&dword_140081840, 1u);
    WdLogSingleEntry0(6LL);
    v32 = 448;
    goto LABEL_46;
  }
...
LABEL_26:
  ...
  _InterlockedAdd(&dword_140081844, 1u);
  WdLogSingleEntry0(6LL);
  v32 = 458;
LABEL_46:
  v33 = 262145LL;
