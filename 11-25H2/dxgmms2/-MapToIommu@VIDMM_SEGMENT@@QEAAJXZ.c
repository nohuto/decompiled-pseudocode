/*
 * XREFs of ?MapToIommu@VIDMM_SEGMENT@@QEAAJXZ @ 0x14010F404
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::MapToIommu(VIDMM_SEGMENT *this)
{
  ...
  if ( (v1 & 0x40) == 0 )
  {
    if ( (v1 & 0x1001) != 0 )
    {
      ...
      {
        v10 = VIDMM_SEGMENT::MapAllocationToIoMmu(this, (struct VIDMM_GLOBAL_ALLOC *)(i - 248));
        v11 = v10;
        if ( v10 < 0 )
        {
          WdLogSingleEntry2(3LL, i - 248, v10);
      ...
      for ( j = (VIDMM_SEGMENT *)*((_QWORD *)this + 27);
            ...
            j = *(VIDMM_SEGMENT **)j )
      {
        v14 = VIDMM_SEGMENT::MapAllocationToIoMmu(this, (VIDMM_SEGMENT *)((char *)j - 248));
        v11 = v14;
        if ( v14 < 0 )
        {
          WdLogSingleEntry2(3LL, (char *)j - 248, v14);
