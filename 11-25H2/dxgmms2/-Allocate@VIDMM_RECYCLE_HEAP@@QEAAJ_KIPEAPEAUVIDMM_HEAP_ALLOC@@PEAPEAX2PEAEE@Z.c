/*
 * XREFs of ?Allocate@VIDMM_RECYCLE_HEAP@@QEAAJ_KIPEAPEAUVIDMM_HEAP_ALLOC@@PEAPEAX2PEAEE@Z @ 0x1400EC7AC
 * Callers:
 ...
 *     ?SplitAt@VIDMM_RECYCLE_MULTIRANGE@@QEAAX_K@Z @ 0x1400C9478 (-SplitAt@VIDMM_RECYCLE_MULTIRANGE@@QEAAX_K@Z.c)
 ...
 *     ?Zeroed@VIDMM_RECYCLE_MULTIRANGE@@QEAAEXZ @ 0x1400ECD90 (-Zeroed@VIDMM_RECYCLE_MULTIRANGE@@QEAAEXZ.c)
