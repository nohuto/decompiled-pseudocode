/*
 * XREFs of ?QueryAdapterStatistics@VIDMM_GLOBAL@@QEAAJGPEAU_D3DKMT_QUERYSTATISTICS_ADAPTER_INFORMATION@@@Z @ 0x140113C9C
 * Callers:
 *     VidMmQueryAdapterStatistics @ 0x140041790 (VidMmQueryAdapterStatistics.c)
 * Callees:
