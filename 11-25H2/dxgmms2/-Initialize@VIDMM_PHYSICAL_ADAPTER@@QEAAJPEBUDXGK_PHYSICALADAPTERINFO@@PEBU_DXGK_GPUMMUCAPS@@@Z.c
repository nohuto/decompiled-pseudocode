/*
 * XREFs of ?Initialize@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEBUDXGK_PHYSICALADAPTERINFO@@PEBU_DXGK_GPUMMUCAPS@@@Z @ 0x14009B888
 * Callers:
        ...
        const struct _DXGK_GPUMMUCAPS *a3)
{
  ...
  *((_BYTE *)this + 552) = v13;
  if ( (v11 & 0x40) != 0 )
  {
    *((_DWORD *)this + 134) = dword_140081520;
    ...
    *((_DWORD *)this + 140) = v14;
    ...
    if ( v17 >= 0 )
    {
      ...
      if ( v17 >= 0 )
        goto LABEL_11;
      _InterlockedIncrement(&dword_140081850);
...
LABEL_14:
  ...
  if ( (*(_DWORD *)(*((_QWORD *)v21 + 3) + 444LL) & 8) != 0 )
    ...
    v22 = *((_QWORD *)v21 + 884) >= (unsigned __int64)qword_1400812D0;
  *((_BYTE *)v21 + 7081) = v22;
  return 0LL;
}
