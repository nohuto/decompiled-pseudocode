/*
 * XREFs of ?VidSchiGpuPerfTracing@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x14004F364
 * Callers:
 *     ?VidSchiNodePerfTracingThread@@YAXPEAX@Z @ 0x14004F650 (-VidSchiNodePerfTracingThread@@YAXPEAX@Z.c)
 * Callees:
