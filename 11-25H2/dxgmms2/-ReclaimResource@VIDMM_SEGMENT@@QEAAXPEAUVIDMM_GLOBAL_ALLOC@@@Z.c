/*
 * XREFs of ?ReclaimResource@VIDMM_SEGMENT@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400DA9C0
 * Callers:
  ...
  *(_QWORD *)(v20 + 120) += v15;
  ...
  if ( (*((_DWORD *)this + 26) & 0x1001) != 0 )
  {
    ...
    if ( !v21 || _InterlockedIncrement((volatile signed __int32 *)v21 + 11) == 1 )
      _InterlockedAdd64((volatile signed __int64 *)(*a2[42] + 56), v3[2]);
  }
  v22 = (char *)(a2 + 31);
  v23 = a2[31];
  if ( (unsigned __int64 **)v23[1] != a2 + 31 )
    goto LABEL_20;
  v24 = a2[32];
  if ( (char *)*v24 != v22 )
    goto LABEL_20;
