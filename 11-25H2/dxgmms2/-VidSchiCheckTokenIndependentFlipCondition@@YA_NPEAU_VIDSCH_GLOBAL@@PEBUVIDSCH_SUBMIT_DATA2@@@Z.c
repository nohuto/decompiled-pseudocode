/*
 * XREFs of ?VidSchiCheckTokenIndependentFlipCondition@@YA_NPEAU_VIDSCH_GLOBAL@@PEBUVIDSCH_SUBMIT_DATA2@@@Z @ 0x1400147C0
 * Callers:
        ...
        const struct VIDSCH_SUBMIT_DATA2 *a2)
{
  ...
  else
  {
    ...
    if ( v7 != -1 )
      v8 = v7;
    v9 = *(int *)(304LL * (unsigned int)v8 + *((_QWORD *)a1 + v4 + 429) + 188);
    if ( (int)v9 > -1 )
    {
      v10 = (_QWORD *)(*((_QWORD *)a1 + 445) + 160 * v9);
      if ( v10 )
      {
