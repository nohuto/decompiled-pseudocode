/*
 * XREFs of ?ReserveResource@VIDMM_SEGMENT@@UEAAJPEAUVIDMM_PHYSICAL_ALLOC@@EEEW4VIDMM_PLACEMENT_RESTRICTION@@_K@Z @ 0x1400D2B70
 * Callers:
...
LABEL_57:
    ...
    while ( 1 )
    {
      ...
      else if ( (**(_DWORD **)(v8 + 376) & 0x20000) == 0 && *(_DWORD *)(a1 + 452) == 1 && *(_QWORD *)(a1 + 472) )
      {
        if ( v46 )
        {
          if ( v18 )
  ...
  *(_QWORD *)(a1 + 264) += v28;
  ...
  if ( (_DWORD)v29 != -1 && !v31 )
  {
    ...
    *(_QWORD *)(a1 + 272) = v28 + v49;
    if ( v28 + v49 > qword_1400815A8 && v49 <= qword_1400815A8 )
  ...
  *(_QWORD *)(v43 + 120) += v38;
  ...
  if ( v44 )
  {
    if ( _InterlockedIncrement((volatile signed __int32 *)(v44 + 44)) == 1 )
      _InterlockedAdd64((volatile signed __int64 *)(**(_QWORD **)(v8 + 336) + 56LL), *(_QWORD *)(a2 + 16));
    if ( _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v8 + 344) + 40LL)) != 1 )
      goto LABEL_40;
  }
  else
  {
  ...
  _InterlockedAdd64((volatile signed __int64 *)(**(_QWORD **)(v8 + 336) + 64LL), *(_QWORD *)(a2 + 16));
LABEL_40:
  v43 = *(_QWORD *)(a1 + 24);
