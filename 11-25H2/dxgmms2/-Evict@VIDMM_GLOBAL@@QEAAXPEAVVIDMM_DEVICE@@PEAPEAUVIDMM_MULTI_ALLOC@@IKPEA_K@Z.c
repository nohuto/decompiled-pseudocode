/*
 * XREFs of ?Evict@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAPEAUVIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1400F58C4
 * Callers:
 *     VidMmEvict @ 0x14003CC40 (VidMmEvict.c)
        ...
        unsigned __int64 *a6)
{
  ...
  struct VIDMM_MULTI_ALLOC **i; // rdi
  ...
  {
    v17 = *i;
    if ( *((_DWORD *)*i + 38) == ((*(_DWORD *)(**(_QWORD **)*i + 28LL) >> 5) & 1) )
    {
  ...
  for ( ; a3 != v15; ++a3 )
  {
    ...
    if ( !VIDMM_ALLOC::HasAnyResidencyReferences(v22) && !*((_DWORD *)v22 + 39) )
    {
      _InterlockedIncrement((volatile signed __int32 *)v22 + 41);
      memset(v28, 0, 0x58uLL);
      LODWORD(v28[0]) = 207;
      v28[2] = v22;
      LODWORD(v28[4]) = a5;
      v24 = dword_140081594 || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)v22 + 1) + 8LL) + 112LL) & 1) != 0;
