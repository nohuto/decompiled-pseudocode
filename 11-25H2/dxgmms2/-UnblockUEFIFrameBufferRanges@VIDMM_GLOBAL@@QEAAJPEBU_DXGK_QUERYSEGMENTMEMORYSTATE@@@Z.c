/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1400963BC
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x14004C940 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
        ...
        const struct _DXGK_QUERYSEGMENTMEMORYSTATE *a2)
{
  ...
  if ( KeGetCurrentThread() == *(struct _KTHREAD **)(*(_QWORD *)this + 8LL) )
  {
    ...
    WdLogGlobalForLineNumber = 29038;
  }
  ...
  if ( NumInvalidMemoryRanges == 1 )
  {
    ...
    v8 = *(_QWORD *)(*((_QWORD *)this + 5029) + 8 * PhysicalAdapterIndex);
    if ( (unsigned int)DriverSegmentId < *(_DWORD *)(v8 + 64) )
    {
      v9 = *(_QWORD *)(*(_QWORD *)(v8 + 1648) + 8 * DriverSegmentId);
      if ( v9 )
    ...
    WdLogGlobalForLineNumber = 29054;
  }
  else
  {
    WdLogSingleEntry1(1LL, NumInvalidMemoryRanges);
    WdLogGlobalForLineNumber = 29044;
  }
