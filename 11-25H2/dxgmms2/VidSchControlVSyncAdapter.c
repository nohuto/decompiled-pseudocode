/*
 * XREFs of VidSchControlVSyncAdapter @ 0x1400D92A0
 * Callers:
 ...
 *     ?DerementRequestVSyncReasonAdapter@@YAXW4_VIDSCH_VSYNC_REASON_ADAPTER@@PEAU_VIDSCH_GLOBAL@@I@Z @ 0x140043400 (-DerementRequestVSyncReasonAdapter@@YAXW4_VIDSCH_VSYNC_REASON_ADAPTER@@PEAU_VIDSCH_GLOBAL@@I@Z.c)
 *     ?IncrementRequestVSyncReasonAdapter@@YAXW4_VIDSCH_VSYNC_REASON_ADAPTER@@PEAU_VIDSCH_GLOBAL@@I@Z @ 0x140043AF8 (-IncrementRequestVSyncReasonAdapter@@YAXW4_VIDSCH_VSYNC_REASON_ADAPTER@@PEAU_VIDSCH_GLOBAL@@I@Z.c)
...
__int64 __fastcall VidSchControlVSyncAdapter(struct _VIDSCH_GLOBAL *a1, unsigned int a2, char a3, unsigned int a4)
{
  ...
  if ( !a1 )
  {
    ...
    WdLogGlobalForLineNumber = 10324;
    goto LABEL_16;
  }
  ...
  if ( a4 >= (unsigned int)v10 )
  {
    ...
    WdLogGlobalForLineNumber = 10332;
LABEL_16:
