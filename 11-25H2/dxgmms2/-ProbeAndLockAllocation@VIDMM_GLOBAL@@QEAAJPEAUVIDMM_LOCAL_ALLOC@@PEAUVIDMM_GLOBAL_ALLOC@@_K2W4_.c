/*
 * XREFs of ?ProbeAndLockAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_LOCAL_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@_K2W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@E@Z @ 0x1400C33E4
 * Callers:
        ...
        unsigned __int8 a8)
{
  ...
  if ( v17 )
  {
    v18 = (*(__int64 (__fastcall **)(_QWORD, __int64, struct VIDMM_GLOBAL_ALLOC *, unsigned __int64, unsigned __int64, int, struct VIDMM_SEGMENT *, unsigned __int8))(**((_QWORD **)a3 + 28) + 32LL))(
            *((_QWORD *)a3 + 28),
            v17,
            a3,
            a4,
