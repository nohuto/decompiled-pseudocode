/*
 * XREFs of VidSchiFlushPendingFlips @ 0x14010845C
 * Callers:
...
__int64 __fastcall VidSchiFlushPendingFlips(struct _VIDSCH_GLOBAL *a1, __int64 a2, unsigned int a3)
{
  ...
  if ( *(_DWORD *)(a2 + 3240) )
  {
    ...
    VidSchiWaitFlushCompletion((__int64)a1, (__int64)v9, 0x17u);
    if ( *((_BYTE *)a1 + 59) )
  ...
  if ( (_DWORD)result )
  {
    if ( !*((_BYTE *)a1 + 3240) )
    {
      ...
      LODWORD(v9[2]) = 1;
      v9[5] = a2 + 3244;
      return VidSchiWaitFlushCompletion((__int64)a1, (__int64)v9, 0x17u);
    }
  }
  return result;
}
