/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1400269F0
 * Callers:
...
__int64 __fastcall VidSchiCompleteRewindPacket(__int64 a1, int a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 184) & 8) == 0 )
  {
    *(_DWORD *)(a1 + 184) &= ~4u;
    ...
    v7 = *(_QWORD *)(a1 + 656);
    WdLogGlobalForLineNumber = 15878;
    if ( v7 )
    {
      v8 = *(_QWORD *)(a1 + 648);
      if ( v8 )
    ...
    *(_QWORD *)(a1 + 656) = 0LL;
    if ( (v21 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 184) >> 9) | *(_BYTE *)(a1 + 184)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, 10, 16041LL);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, 5, 16054LL);
    }
  }
  return v3;
}
