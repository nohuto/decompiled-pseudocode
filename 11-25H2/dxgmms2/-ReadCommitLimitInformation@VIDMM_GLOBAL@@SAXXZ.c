/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@SAXXZ @ 0x14010B360
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_140081608 = v1;
  dword_14008160C = v6 << 20;
  dword_140081610 = v2;
  dword_140081614 = v3;
  if ( !v0 )
    qword_1400812F0 = (unsigned __int64)qword_1400812D8 >> 3;
}
