/*
 * XREFs of ?ReportProcessAdapterBudget@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x1400B25D0
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReportProcessAdapterBudget(VIDMM_GLOBAL *this, struct _KTHREAD **a2)
{
  ...
  {
    DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v17, a2 + 6);
    for ( i = 0; (unsigned int)i < *((_DWORD *)this + 1736); ++i )
    {
      v7 = 0;
      v8 = 552LL;
      v9 = (__int64)a2[2] + 304 * i;
      v10 = (__int64 *)(v9 + 144);
      do
      {
        v11 = *(_QWORD *)(*((_QWORD *)this + 5029) + 8LL * i);
        if ( (*(_BYTE *)(v8 + v11) & 2) != 0 )
        {
          v5 = *v10;
          LOBYTE(v11) = *((_BYTE *)a2 + 82);
          v18 = *v10;
          v19 = v10[8];
          if ( (byte_140081241 & 0x20) != 0 )
          {
      ...
      while ( v7 < 2u );
      if ( *(_QWORD *)(v9 + 160) && (byte_140081241 & 0x20) != 0 )
