/*
 * XREFs of ?VidSchiSubmitNextFlipQueueEntryRange@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEA_NIPEAUVIDSCH_FLIP_QUEUE@@@Z @ 0x14002D1F4
 * Callers:
        ...
        struct VIDSCH_FLIP_QUEUE *a5)
{
  ...
  v10 = (struct _VIDSCH_PRESENT_INFO *)*((_QWORD *)a2 + a4 + 429);
  v26 = v10;
  ...
  if ( *((_DWORD *)v10 + 809) )
  {
    ...
    if ( v12 != (_DWORD)v9 )
    {
      v13 = (struct _VIDSCH_PRESENT_INFO *)*((_QWORD *)a2 + a4 + 429);
      do
      {
        v14 = (char *)v5 + 1400 * v12;
        v15 = *((_DWORD *)v14 + 293);
        if ( (unsigned int)(v15 - 2) > 1 && v15 != 14
          || VidSchiCheckPendingFlipsForThisEntry(a2, v13, (unsigned int **)v14 + 15, v5) )
        {
          break;
        }
        if ( v14[1196] )
      ...
      || v11[1076] && VidSchiIsPendingFlipReadyToBeSubmitted(a2, v10, v5, (struct _VIDSCH_FLIP_QUEUE_ENTRY *)v11) )
    {
      ...
      *((_DWORD *)v11 + 263) = 4;
      v28 = 0;
      VidSchiExecuteMmIoFlip(v8, (__int64)a2, a4, v5, v9, a3, &v28);
      if ( v28 )
        VidSchiExecuteMmIoFlip(v8, (__int64)a2, a4, v5, v9, a3, &v28);
    }
    else
    {
      ...
      {
        v16 = *((_DWORD *)v11 + 263);
        if ( ((unsigned int)(v16 - 2) <= 1 || v16 == 14)
          && !VidSchiCheckPendingFlipsForThisEntry(a2, v10, (unsigned int **)v11, v5) )
        {
          v17 = *((_DWORD *)v11 + 288);
          if ( (v17 & 0x2000) == 0 )
          {
            if ( (v17 & 0x80u) != 0 )
            {
              for ( i = *((_DWORD *)v5 + 16) + 1; ; i = v20 + 1 )
              {
                ...
                if ( v20 == *((_DWORD *)v5 + 16) )
                  break;
                v21 = (char *)v5 + 1400 * v20;
                v22 = *((_DWORD *)v21 + 293);
                if ( v22 != 2 && v22 != 14 )
                  break;
                if ( VidSchiCheckPendingFlipsForThisEntry(a2, v26, (unsigned int **)v21 + 15, v5) )
                  break;
                v23 = *((_DWORD *)v21 + 318);
                v11 = v21 + 120;
                LODWORD(v9) = v20;
        ...
        if ( *((_DWORD *)v11 + 263) != 4 )
          break;
        v28 = 0;
        v18 = VidSchiExecuteMmIoFlip(v8, (__int64)a2, a4, v5, v9, a3, &v28);
        if ( v28 )
          v18 = VidSchiExecuteMmIoFlip(v8, (__int64)a2, a4, v5, v9, a3, &v28);
        if ( v18 )
          break;
