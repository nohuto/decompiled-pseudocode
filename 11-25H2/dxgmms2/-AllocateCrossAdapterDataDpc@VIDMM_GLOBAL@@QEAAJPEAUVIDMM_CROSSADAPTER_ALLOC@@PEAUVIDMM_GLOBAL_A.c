/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_CROSSADAPTER_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x1400272A0
 * Callers:
        ...
        struct VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  {
    _InterlockedIncrement(&dword_1400817FC);
    WdLogSingleEntry0(6LL);
    WdLogGlobalForLineNumber = 30651;
