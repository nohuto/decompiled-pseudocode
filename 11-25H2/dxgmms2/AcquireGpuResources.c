/*
 * XREFs of AcquireGpuResources @ 0x1400EAC50
 * Callers:
...
__int64 __fastcall AcquireGpuResources(__int64 a1, __int64 *a2, _QWORD *a3, __int64 a4, int a5, __int64 a6)
{
  ...
  if ( v8 )
  {
    ...
    v27 = (((_DWORD)a3 - 3) & 0xFFFFFFFA) == 0
       && (_DWORD)a3 != 8
       && ((v39 = **(_DWORD **)(v6 + 376), (v39 & 0x20000000) == 0) || v39 >= 0)
       && (v39 & 0x80000) == 0;
    ...
    while ( 1 )
    {
      ...
      if ( v7 != 2 || (*(_DWORD *)(v33 + 104) & 0x1001) != 0 )
      {
        ...
        if ( _bittest(&v34, v31) )
        {
          ...
          {
            v6 = v51;
            if ( (v37[26] & 1) != 0 && (**(_DWORD **)(v51 + 376) & 0x8000) == 0 )
            {
...
LABEL_8:
  ...
  if ( (v19 & 0x10) == 0 && (v19 & 2) == 0 || (v20[26] & 1) == 0 || (**(_DWORD **)(v11 + 376) & 0x8000) != 0 )
  {
    if ( (_DWORD)v12 != *(unsigned __int16 *)(v10 + 68) || (**(_DWORD **)(v11 + 376) & 0x8000) == 0 )
      goto LABEL_12;
    v13 = -1071775488;
LABEL_28:
...
LABEL_12:
  v22 = ((v7 - 3) & 0xFFFFFFFA) == 0
     && v7 != 8
     && ((v21 = **(_DWORD **)(v11 + 376), (v21 & 0x20000000) == 0) || v21 >= 0)
     && (v21 & 0x80000) == 0;
  LOBYTE(v11) = 1;
  LOBYTE(v49) = v22;
