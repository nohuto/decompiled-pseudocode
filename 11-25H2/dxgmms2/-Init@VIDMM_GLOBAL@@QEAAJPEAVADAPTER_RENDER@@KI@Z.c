/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@KI@Z @ 0x140093E90
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::Init(VIDMM_GLOBAL *this, struct ADAPTER_RENDER *a2, unsigned int a3, char a4)
{
  ...
  *((_DWORD *)this + 8) = a3;
  VaAllocator = 0;
  byte_1400815FC |= (*(_DWORD *)(v5 + 444) & 0x200) != 0;
  v10 = *((_QWORD *)this + 3);
  if ( a3 >= 0x6000 )
    *v4 |= 2u;
...
LABEL_5:
  ...
  *((_QWORD *)this + 5029) = v20;
  if ( !v20 )
  {
    _InterlockedIncrement(&dword_140081838);
  ...
  for ( i = 0; ; ++i )
  {
    if ( i >= v95 )
    {
      ...
      *((_BYTE *)this + 40937) ^= (*((_BYTE *)this + 40937) ^ (8 * (*(_DWORD *)(v10 + 2468) >> 14))) & 8;
      ...
      if ( dword_140081460 == 2 )
        v42 = (*(_DWORD *)(*((_QWORD *)this + 3) + 2452LL) & 4) != 0;
      else
        v42 = dword_140081460 == 1;
      *((_BYTE *)this + 7080) = v42;
      *((_QWORD *)this + 5586) = qword_140081570;
      v43 = dword_14008141C;
      if ( dword_14008141C )
      {
        v44 = 360LL * (unsigned int)dword_14008141C;
        if ( !is_mul_ok((unsigned int)dword_14008141C, 0x168uLL) )
          v44 = -1LL;
...
LABEL_63:
      ...
      if ( VaAllocator < 0 )
        goto LABEL_127;
      v55 = *((_QWORD *)this + 5553) + qword_1400812D8;
      ...
      *((_BYTE *)this + 40104) = v55 < *(_QWORD *)(*((_QWORD *)this + 3) + 3024LL);
      if ( !v56 )
      {
        if ( dword_1400814AC )
        {
          ...
          {
            if ( (unsigned int)dword_1400814AC <= 0x10000 )
              v57 = 64LL;
            DXGK_LOG::Initialize(
              (__int64)this + 41032,
              v55,
              v57,
              (unsigned int)dword_1400814AC,
              (unsigned int)dword_1400814B0);
          }
          else
          {
            v60 = (unsigned int)dword_1400814AC;
            v61 = 24LL * (unsigned int)dword_1400814AC;
            if ( !is_mul_ok((unsigned int)dword_1400814AC, 0x18uLL) )
              v61 = -1LL;
            ...
            *((_QWORD *)this + 5124) = v65;
            if ( !v65 )
            {
              _InterlockedAdd(&dword_140081854, 1u);
              WdLogSingleEntry0(6LL);
              v48 = 1611;
              goto LABEL_54;
            }
          }
          v58 = 48LL * (unsigned int)dword_1400814B4;
          if ( !is_mul_ok((unsigned int)dword_1400814B4, 0x30uLL) )
            v58 = -1LL;
      ...
      if ( DXGADAPTER::IsGpuVaIoMmuGlobalSupported(*((DXGADAPTER **)this + 3)) )
      {
        ...
        *((_QWORD *)this + 5563) = v73;
        if ( !v73 )
        {
          _InterlockedAdd(&dword_14008184C, 1u);
          WdLogSingleEntry0(6LL);
          v48 = 1685;
          goto LABEL_54;
        }
...
LABEL_105:
      ...
      if ( VaAllocator >= 0 )
      {
        ...
        *((_QWORD *)this + 981) = MEMORY[0xFFFFF78000000014];
        ...
        v85 = (_QWORD *)qword_1400812B8;
        v86 = (_QWORD *)((char *)this + 44792);
        if ( *(PVOID **)qword_1400812B8 != &VIDMM_GLOBAL::_AdapterListHead )
          __fastfail(3u);
        *v86 = &VIDMM_GLOBAL::_AdapterListHead;
        v86[1] = v85;
        *v85 = v86;
        qword_1400812B8 = (__int64)v86;
