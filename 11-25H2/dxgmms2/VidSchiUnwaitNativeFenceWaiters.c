/*
 * XREFs of VidSchiUnwaitNativeFenceWaiters @ 0x1400476A8
 * Callers:
        ...
        struct VIDSCH_HW_QUEUE **a4)
{
  ...
  struct VIDSCH_HW_QUEUE **v20; // [rsp+78h] [rbp+20h]
...
LABEL_13:
      ...
      VidSchiUnwaitWaitQueuePacket(a1, v12, 0LL, v20);
...
LABEL_20:
  ...
  else
  {
    ...
    if ( v7 > *(_QWORD *)result )
    {
      ...
      WdLogGlobalForLineNumber = 27400;
    }
  }
  return result;
}
