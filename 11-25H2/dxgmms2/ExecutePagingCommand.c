/*
 * XREFs of ExecutePagingCommand @ 0x14009F260
 * Callers:
 *     ?Execute@VIDMM_TASK_DEVICE_RESUME@@UEAAJPEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK_CONTEXT@@@Z @ 0x14009EDB0 (-Execute@VIDMM_TASK_DEVICE_RESUME@@UEAAJPEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK_CONTEXT@@@Z.c)
...
void __fastcall ExecutePagingCommand(
        VIDMM_GLOBAL **a1,
        VIDMM_DEVICE *this,
        ...
        struct VIDMM_PAGING_QUEUE_PACKET *a4)
{
  ...
  while ( 1 )
  {
    *(_OWORD *)v15 = 0LL;
    if ( a3 )
      break;
    if ( (int)VIDMM_DEVICE::Resume(this, 1, (bool *)&v15[1], v15) >= 0 )
      return;
    v14 = (char)v15[1];
LABEL_15:
    if ( !v14 )
  ...
  v8 = (struct VIDMM_PAGING_QUEUE_PACKET *)((char *)a4 + 48);
  v9 = *a1;
  v10 = *((_QWORD *)a4 + 4);
  v11 = *((_BYTE *)a4 + 25);
  if ( *((_BYTE *)a4 + 24) )
  ...
  if ( v12 != -1071775232 )
  {
    if ( (v14 = (char)v15[1], !*((_BYTE *)a4 + 24)) || LOBYTE(v15[1]) && !*((_BYTE *)a4 + 128) || !*((_QWORD *)a4 + 9) )
    {
      if ( (int)v13 < 0 )
        goto LABEL_15;
    }
  }
  VidMmReclaimPagingQueuePacket((struct VIDMM_WORKER_THREAD *)a1, (struct VIDMM_PAGING_QUEUE *)a3, a4);
}
