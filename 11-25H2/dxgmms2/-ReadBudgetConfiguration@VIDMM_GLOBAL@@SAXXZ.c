/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x14010895C
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v28;
  v5 = 10000 * v26;
  dword_14008151C = 10000 * v28;
  dword_140081510 = 10000 * v3;
  dword_140081518 = 10000 * v26;
  dword_140081514 = 10000 * v1;
  if ( 10000 * v26 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
