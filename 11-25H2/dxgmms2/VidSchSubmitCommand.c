/*
 * XREFs of VidSchSubmitCommand @ 0x1400D6BF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiConvertDeferredWaits @ 0x1400392C8 (VidSchiConvertDeferredWaits.c)
    ...
    *((_QWORD *)Pool2 + 137) = v42;
    if ( v42 )
    {
      ...
      *((_QWORD *)Pool2 + 137) = 0LL;
      _InterlockedIncrement(&dword_14008188C);
      WdLogSingleEntry1(6LL, 11718LL);
      WdLogGlobalForLineNumber = 11718;
    }
    else
    {
      _InterlockedIncrement(&dword_140081888);
      WdLogSingleEntry1(6LL, 11705LL);
