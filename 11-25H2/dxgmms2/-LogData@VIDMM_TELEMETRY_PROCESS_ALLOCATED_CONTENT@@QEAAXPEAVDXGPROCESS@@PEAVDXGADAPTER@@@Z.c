/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_ALLOCATED_CONTENT@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1401023D4
 * Callers:
        ...
        __int64 a4)
{
    ...
    && (qword_140081060 & 0x400000000008LL) == qword_140081060 )
  {
    ...
    v7 = (unsigned __int16 *)*((_QWORD *)a3 + 241);
    v4 = *((_QWORD *)a2 + 8);
    v11 = 176;
    v13 = 88;
    v5 = *(_OWORD *)(v4 + 140);
