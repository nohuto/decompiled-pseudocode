/*
 * XREFs of ?SignalMonitoredFence@VIDMM_GLOBAL@@QEAAXIPEAU_VIDSCH_SYNC_OBJECT@@_KPEA_N@Z @ 0x140111EAC
 * Callers:
 ...
 *     VidSchGetDriverPagingHwQueue @ 0x140051664 (VidSchGetDriverPagingHwQueue.c)
