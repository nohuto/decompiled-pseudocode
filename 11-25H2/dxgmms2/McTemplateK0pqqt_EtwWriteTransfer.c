/*
 * XREFs of McTemplateK0pqqt_EtwWriteTransfer @ 0x14003F394
 * Callers:
...
NTSTATUS McTemplateK0pqqt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v17; // [rsp+D8h] [rbp+77h] BYREF
  ...
  v13 = 4LL;
  va_copy(v12, va2);
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventUnreset, a3, 5u, &v5);
}
