/*
 * XREFs of ?RollbackPlacementOfPendingResources@VIDMM_LINEAR_POOL@@QEAAX_K0W4VIDMM_DEFRAGMENT_DIRECTION@@P6A_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z@Z @ 0x14009EAC4
 * Callers:
 ...
 * Callees:
 *     ?RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z @ 0x14009D02C (-RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAUVIDMM_PHYSICAL_ALLOC@@PEA_K@Z.c)
        ...
        int a4)
{
  ...
  struct VIDMM_PHYSICAL_ALLOC *v12; // rcx
  ...
  while ( v8 != v4 )
  {
    ...
    if ( v11 > a2 )
    {
      if ( *v10 < a3 )
      {
        ...
        {
          v12 = (struct VIDMM_PHYSICAL_ALLOC *)v10[2];
          v23 = 0LL;
