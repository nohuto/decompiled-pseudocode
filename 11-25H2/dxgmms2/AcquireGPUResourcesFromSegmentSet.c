/*
 * XREFs of AcquireGPUResourcesFromSegmentSet @ 0x1400A6F90
 * Callers:
...
LABEL_7:
            ...
            if ( _bittest(&v15, v7) )
            {
              ...
              {
                if ( a4 && ((dword_14008161C & 2) != 0 || (*(_DWORD *)(*(_QWORD *)(v10 + 48) + 6984LL) & 0x200000) != 0) )
                  goto LABEL_47;
                if ( (**(_DWORD **)(v6 + 376) & 0x8000) == 0 )
                  goto LABEL_46;
                if ( !a4 )
                  goto LABEL_13;
                if ( (v17 & 0x20) != 0 )
...
LABEL_12:
                ...
                {
LABEL_13:
                  if ( (_DWORD)v12 == *(unsigned __int16 *)(v10 + 68) && (**(_DWORD **)(v6 + 376) & 0x8000) != 0 )
                  {
LABEL_31:
                    v11 = -1071775488;
LABEL_28:
                  ...
                  v20 = ((a3 - 3) & 0xFFFFFFFA) == 0
                     && a3 != 8
                     && ((v19 = **(_DWORD **)(v6 + 376), (v19 & 0x20000000) == 0) || v19 >= 0)
                     && (v19 & 0x80000) == 0;
                  LOBYTE(v16) = 1;
                  LOBYTE(v28) = v20;
