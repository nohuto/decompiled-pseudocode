/*
 * XREFs of ?VidMmReserveGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAUVIDMM_PAGING_QUEUE@@PEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1400B445C
 * Callers:
 *     VidMmReserveGpuVirtualAddress @ 0x1400419F0 (VidMmReserveGpuVirtualAddress.c)
 * Callees:
        ...
        struct D3DDDI_RESERVEGPUVIRTUALADDRESS *a4)
{
  ...
  if ( (*((_BYTE *)this + 40936) & 0x10) == 0 )
  {
    ...
    WdLogGlobalForLineNumber = 19513;
    return 3221225485LL;
  }
  ...
  if ( (Size & 0xFFF) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 19528;
    return 3221225485LL;
  }
  ...
  if ( !VirtualAddressAllocator )
  {
    ...
    WdLogGlobalForLineNumber = 19535;
    return 3221225485LL;
  }
  v11 = 0x10000;
  ...
  if ( v14 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 19574;
  }
  else
  {
    ...
    if ( a4->Reserved0 == 1 )
    {
      ...
      if ( v14 < 0 )
      {
        ...
        v16 = a4->BaseAddress;
        WdLogGlobalForLineNumber = 19602;
        CVirtualAddressAllocator::FreeVirtualAddressRange(VirtualAddressAllocator, v16);
      }
    }
  }
