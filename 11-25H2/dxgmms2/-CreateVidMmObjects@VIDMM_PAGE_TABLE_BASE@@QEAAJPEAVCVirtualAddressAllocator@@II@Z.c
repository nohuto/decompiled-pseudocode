/*
 * XREFs of ?CreateVidMmObjects@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@II@Z @ 0x1400E86FC
 * Callers:
        ...
        struct CVirtualAddressAllocator *a2)
{
  ...
  if ( OneAllocation < 0 )
  {
    _InterlockedIncrement(&dword_1400816B8);
  ...
  else
  {
    ...
    if ( (int)v9 >= 0 )
      return 0LL;
    _InterlockedIncrement(&dword_1400816BC);
