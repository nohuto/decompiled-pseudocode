/*
 * XREFs of ?RequestNewBudget@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1400DB1D0
 * Callers:
 ...
 *     ?NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ @ 0x1400DB1B0 (-NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ.c)
