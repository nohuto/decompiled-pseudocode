/*
 * XREFs of McGenControlCallbackV2 @ 0x1400438F0
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x140056780 (memset.c)
 *     ?DxgkEtwEnableCallback@@YAXKK_K@Z @ 0x1401107A0 (-DxgkEtwEnableCallback@@YAXKK_K@Z.c)
 */
        ...
        *((_DWORD *)CallbackContext + 9) = 1;
        if ( *((_WORD *)CallbackContext + 21) )
        {
          do
          {
            ...
            v11 = (ULONG *)(*((_QWORD *)CallbackContext + 6) + 4LL * (_QWORD)SourceId);
            v12 = *v11;
            if ( v9 )
              ControlCode = v12 | v10;
            else
