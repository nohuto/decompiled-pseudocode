/*
 * XREFs of RemoveDmaBufferFromPool @ 0x1400AF894
 * Callers:
...
void __fastcall RemoveDmaBufferFromPool(_QWORD *a1, unsigned int *a2)
{
  ...
  *((_DWORD *)a1 + 30) += -24 * a2[11];
  ...
  _InterlockedAdd64(&qword_140081978, -(__int64)(unsigned int)*v8);
  _InterlockedAdd64(&qword_140081948, -24LL * a2[10]);
  _InterlockedAdd64(&qword_140081918, -24LL * a2[11]);
  operator delete(a2);
}
