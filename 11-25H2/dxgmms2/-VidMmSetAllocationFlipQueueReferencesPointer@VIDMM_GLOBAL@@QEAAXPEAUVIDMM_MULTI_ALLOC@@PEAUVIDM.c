/*
 * XREFs of ?VidMmSetAllocationFlipQueueReferencesPointer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_FLIP_QUEUE_REFERENCES@@@Z @ 0x14010C7D0
 * Callers:
 *     VidMmSetAllocationFlipQueueReferencesPointer @ 0x140045FC0 (VidMmSetAllocationFlipQueueReferencesPointer.c)
 * Callees:
