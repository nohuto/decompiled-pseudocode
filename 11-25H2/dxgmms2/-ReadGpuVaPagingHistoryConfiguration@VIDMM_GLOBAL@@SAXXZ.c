/*
 * XREFs of ?ReadGpuVaPagingHistoryConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x14010A910
 * Callers:
...
void VIDMM_GLOBAL::ReadGpuVaPagingHistoryConfiguration(void)
{
  ...
  v11 = 0LL;
  v12 = 0;
  v18 = (unsigned __int64)qword_1400812D8 > 0x53333333 ? 0x400 : 0;
  ...
  if ( v18 >= 0x7FFFFFFF / v5 )
    dword_1400814B4 = 0x7FFFFFFF;
  else
    dword_1400814B4 = v18 * v5;
}
