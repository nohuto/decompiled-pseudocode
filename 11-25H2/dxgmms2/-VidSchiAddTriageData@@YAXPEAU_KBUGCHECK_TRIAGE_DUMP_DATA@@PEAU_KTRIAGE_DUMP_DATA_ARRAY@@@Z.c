/*
 * XREFs of ?VidSchiAddTriageData@@YAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@PEAU_KTRIAGE_DUMP_DATA_ARRAY@@@Z @ 0x14005380C
 * Callers:
...
void __fastcall VidSchiAddTriageData(struct _KBUGCHECK_TRIAGE_DUMP_DATA *a1, struct _KTRIAGE_DUMP_DATA_ARRAY *a2)
{
  ...
  if ( MmIsAddressValid(&gAdapterListHead) )
  {
    for ( i = (PVOID *)gAdapterListHead; i != &gAdapterListHead; i = (PVOID *)*i )
    {
      ...
      {
        v10 = KeAddTriageDumpDataBlock(a2, (_DWORD)i - 3792, (PVOID)0x1BB0, v5);
        if ( v10 < 0 )
        {
          WdLogSingleEntry3(3LL, i - 474, 7088LL, v10);
            ...
            if ( MmIsAddressValid(v26) )
            {
              ...
              if ( v29 )
              {
                ...
                if ( MmIsAddressValid(v29) )
                {
                  ...
                  if ( v32 )
                  {
                    v33 = KeAddTriageDumpDataBlock(a2, (ULONG)v32, (PVOID)0x1BB0, v31);
                    if ( v33 < 0 )
                    {
                      WdLogSingleEntry3(3LL, v32, 7088LL, v33);
                      WdLogGlobalForLineNumber = 3274;
                    }
