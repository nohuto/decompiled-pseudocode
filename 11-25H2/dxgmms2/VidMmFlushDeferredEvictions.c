/*
 * XREFs of VidMmFlushDeferredEvictions @ 0x1400DEEE0
 * Callers:
 ...
 *     ?GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z @ 0x140036AA0 (-GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z.c)
...
char __fastcall VidMmFlushDeferredEvictions(struct VIDMM_WORKER_THREAD *a1, __int64 a2)
{
  ...
  *((_QWORD *)v10 + 1) = 0LL;
  ...
  v16 = v6 | v14 | VidMmProcessFrozenProcesses(a1, a2);
