/*
 * XREFs of ??1VIDMM_RECYCLE_HEAP@@QEAA@XZ @ 0x1400C35A8
 * Callers:
 *     ??1VIDMM_RECYCLE_HEAP_MGR@@UEAA@XZ @ 0x1400C4010 (--1VIDMM_RECYCLE_HEAP_MGR@@UEAA@XZ.c)
 * Callees:
 *     ?OnEnqueue@VIDMM_TASK_IDLE@@UEAAXPEAUVIDMM_WORKER_THREAD2@@@Z @ 0x1400C36A0 (-OnEnqueue@VIDMM_TASK_IDLE@@UEAAXPEAUVIDMM_WORKER_THREAD2@@@Z.c)
 */
