/*
 * XREFs of ?VidSchiExecuteMmIoFlipMultiPlaneOverlay3@@YAXPEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@AEAU_VIDSCH_CALL_EXECUTE_FLIP@@PEAW4_VIDSCH_FLIP_STATUS@@K@Z @ 0x140014B1C
 * Callers:
  ...
  *((LARGE_INTEGER *)a3 + 12) = v12;
  ...
  if ( !*((_DWORD *)v11 + 5) )
  {
    *((_DWORD *)v11 + 530) = 0;
    ...
    WdLogGlobalForLineNumber = 21522;
    goto LABEL_24;
  }
  if ( (v10[159].LowPart & 0x1000) != 0 )
  {
    *((_DWORD *)v11 + 530) = 0;
    ...
    WdLogGlobalForLineNumber = 21529;
    goto LABEL_24;
  }
