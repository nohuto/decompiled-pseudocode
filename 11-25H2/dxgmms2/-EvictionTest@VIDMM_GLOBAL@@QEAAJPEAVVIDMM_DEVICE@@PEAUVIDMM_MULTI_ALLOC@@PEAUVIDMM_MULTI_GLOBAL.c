/*
 * XREFs of ?EvictionTest@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x140093A74
 * Callers:
 *     VidMmEvictionTest @ 0x14004C590 (VidMmEvictionTest.c)
 * Callees:
