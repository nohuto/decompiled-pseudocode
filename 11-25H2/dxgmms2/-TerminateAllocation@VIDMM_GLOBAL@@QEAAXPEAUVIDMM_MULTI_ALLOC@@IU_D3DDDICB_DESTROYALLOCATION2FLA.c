/*
 * XREFs of ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1400FDAD8
 * Callers:
 *     VidMmTerminateAllocation @ 0x14003C620 (VidMmTerminateAllocation.c)
 * Callees:
