/*
 * XREFs of ?VidSchQueryLastCompletedPresentIdDWMInternal@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_DEVICE@@IIPEAU_D3DKMT_PRESENT_STATS_DWM2@@@Z @ 0x140017030
 * Callers:
 ...
 *     ?floor@@YANN@Z @ 0x14001835C (-floor@@YANN@Z.c)
 ...
 *     ?VidSchiConvertTicksToSchedulerUnitsDelta@@YA_J_J_K@Z @ 0x14003C594 (-VidSchiConvertTicksToSchedulerUnitsDelta@@YA_J_J_K@Z.c)
 */
        ...
        unsigned __int64 a5)
{
  ...
  unsigned __int64 v94; // [rsp+1A0h] [rbp+A0h] BYREF
  ULONGLONG pullResult; // [rsp+1A8h] [rbp+A8h] BYREF
  int v96; // [rsp+1B0h] [rbp+B0h]
  unsigned int v97; // [rsp+1B8h] [rbp+B8h]
  ...
  if ( !a2 )
  {
    ...
    *((_DWORD *)v9 + 17) = *(_DWORD *)(v8 + 44360);
    ...
    if ( *(_DWORD *)(v56 + 3192) != -1 )
    {
      ...
      {
        v81 = *(unsigned int *)(v56 + 3192);
        goto LABEL_150;
      }
      if ( *(_DWORD *)(v56 + 83096) )
      {
        v81 = *(unsigned int *)(v56 + 83096);
LABEL_150:
        if ( is_mul_ok(v81, *((_QWORD *)a1 + 359)) )
          v57 = v81 * *((_QWORD *)a1 + 359) / 0x989680;
        else
          v57 = *((_QWORD *)a1 + 359) * (v81 / 0x989680) + *((_QWORD *)a1 + 359) * (v81 % 0x989680) / 0x989680;
LABEL_82:
        v87 = *(_QWORD *)(v8 + 44408);
        v94 = v57;
        ...
        SmoothenedFrameTimeQpc = (unsigned int)(int)floor(
                                                      (double)((int)v54 - *(_DWORD *)(v87 + 40)) * *(double *)(v87 + 24)
                                                    + (double)(int)*(_QWORD *)(v87 + 48)
                                                    + *(double *)(v87 + 16)
                                                    + 0.5);
        ...
        if ( v62 > v61 >> 1 )
        {
          ...
          if ( (v94 & 0x8000000000000000uLL) != 0LL )
            v63 = (double)(int)(v94 & 1 | (v94 >> 1)) + (double)(int)(v94 & 1 | (v94 >> 1));
          else
            v63 = (double)(int)v94;
          *(double *)(v60 + 32) = v63;
...
LABEL_27:
  ...
  if ( (byte_140081244 & 4) != 0 )
  {
    ...
    if ( (byte_140081244 & 4) != 0 )
    {
      LODWORD(v84) = *(_DWORD *)(*(_QWORD *)(v8 + 44408) + 8LL);
      McTemplateK0qxxxxiq_EtwWriteTransfer(
        v84,
        v71,
...
LABEL_101:
  ...
  else
  {
    ...
    v94 = 0LL;
    if ( v22
      || (int)VIDSCH_VSYNC_SMOOTHER::GetSmoothenedDurationQpc(*(VIDSCH_VSYNC_SMOOTHER **)(v36 + 44408), v45, &v94) < 0 )
    {
      v94 = v45;
    }
    else if ( (byte_140081244 & 4) != 0 )
  ...
  if ( !v22 && v45 != 0xFFFFFFFF )
  {
    ...
    if ( v48 > 0x989680 )
    {
      ...
      if ( RtlULongLongMult(v45, 0x989680uLL, &pullResult) >= 0 )
        ...
        v83 = 10000000 * (v45 / v82) + 10000000 * (v45 % v82) / v82;
      g_DxgMmsBugcheckExportIndex = 1;
      WdLogSingleEntry5(0LL, 281LL, 260LL, v83, 0LL, 0LL);
      WdLogGlobalForLineNumber = 906;
      JUMPOUT(0x1400181EALL);
    }
  }
