/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEBU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1400993F8
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x14004C8C0 (VidMmSetWorkingSetInformation.c)
 * Callees:
