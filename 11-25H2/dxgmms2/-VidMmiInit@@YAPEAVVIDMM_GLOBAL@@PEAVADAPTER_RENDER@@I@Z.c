/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@I@Z @ 0x14009817C
 * Callers:
 *     VidMmInitializeAdapter @ 0x14004C630 (VidMmInitializeAdapter.c)
 * Callees:
...
LABEL_13:
  ...
  v9 = (VIDMM_GLOBAL *)operator new(44992LL, 0x35316956u, 64LL);
  ...
  _InterlockedIncrement(&dword_1400816E0);
