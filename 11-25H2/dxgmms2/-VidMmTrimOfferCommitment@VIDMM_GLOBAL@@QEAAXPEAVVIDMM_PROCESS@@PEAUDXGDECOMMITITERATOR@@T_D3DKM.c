/*
 * XREFs of ?VidMmTrimOfferCommitment@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@_KPEA_K@Z @ 0x140107EC4
 * Callers:
 *     VidMmTrimOfferCommitment @ 0x140045FE0 (VidMmTrimOfferCommitment.c)
 * Callees:
