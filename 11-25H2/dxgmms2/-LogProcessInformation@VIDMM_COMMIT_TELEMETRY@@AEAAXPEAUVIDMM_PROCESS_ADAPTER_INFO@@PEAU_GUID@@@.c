/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1400DA434
 * Callers:
 ...
 *     ?GetProcessStatus@VIDMM_COMMIT_TELEMETRY@@AEAAPEBDPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x14009A3DC (-GetProcessStatus@VIDMM_COMMIT_TELEMETRY@@AEAAPEBDPEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z.c)
  ...
  if ( *((_BYTE *)this + 24) )
  {
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(*(_QWORD *)this + 6944LL) )
      {
        ...
        do
        {
          v8 = (_QWORD *)(*((_QWORD *)a2 + 2) + 304LL * (unsigned __int16)v6);
          if ( (unsigned int)dword_140081048 > 5 && (qword_140081058 & 0x10000) != 0 && (v7 & 0x10000) == v7 )
          {
            v27 = v8[5];
            v14 = v8[19];
            v15 = v8[11];
        ...
        while ( v6 < *(_DWORD *)(*(_QWORD *)this + 6944LL) );
      }
    }
  }
}
