/*
 * XREFs of ?Unlock1@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@K@Z @ 0x1400EEAF4
 * Callers:
 *     VidMmEndCPUAccess @ 0x140040F10 (VidMmEndCPUAccess.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::Unlock1(VIDMM_GLOBAL *this, struct VIDMM_ALLOC *a2, unsigned int a3)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    *(_QWORD *)(v7 + 24) = a2;
    *(_QWORD *)(v7 + 32) = v4;
    WdLogGlobalForLineNumber = 22197;
  }
  if ( (v4 & 0xFFFFFFFE) != 0 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 22205;
