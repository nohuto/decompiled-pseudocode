/*
 * XREFs of AddDmaBufferToPool @ 0x1400B05D8
 * Callers:
...
__int64 __fastcall AddDmaBufferToPool(_QWORD *a1, unsigned int a2, int a3, unsigned int a4)
{
  ...
  unsigned __int64 v56; // [rsp+A0h] [rbp-58h] BYREF
  unsigned __int64 v57; // [rsp+A8h] [rbp-50h] BYREF
  struct VIDMM_MULTI_ALLOC *v58; // [rsp+B0h] [rbp-48h] BYREF
  unsigned __int8 v59; // [rsp+100h] [rbp+8h] BYREF
  SIZE_T NumberOfBytes; // [rsp+108h] [rbp+10h]
  unsigned int v61; // [rsp+118h] [rbp+20h]
  ...
  if ( *((_DWORD *)a1 + 19) <= (unsigned int)dword_140081990
    || (v51 = a1[1]) != 0
    && ((v52 = *(_QWORD *)(v51 + 24), *(_DWORD *)(v52 + 464) == 2)
     || (*(_DWORD *)(*(_QWORD *)(v52 + 40) + 408LL) & 4) != 0)
    || qword_140081978 <= qword_140081970 && qword_140081948 <= qword_140081940 && qword_140081918 <= qword_140081910 )
  {
    ...
    if ( !v9 )
    {
      _InterlockedAdd(&dword_1400816B0, 1u);
    ...
    if ( !*((_DWORD *)a1 + 8) )
    {
      ...
      *((_QWORD *)v9 + 8) = ContiguousNodeMemory;
      ...
      {
        _InterlockedAdd(&dword_1400816C4, 1u);
        WdLogSingleEntry0(6LL);
        v46 = 614;
        goto LABEL_52;
      }
        ...
        if ( !v25 || (v26 = operator new[](v25, 0x32336956u, 64LL), (*((_QWORD *)v9 + 15) = v26) != 0LL) )
        {
          ...
          *((_QWORD *)v9 + 19) = 0LL;
          if ( (*((_DWORD *)a1 + 7) & 0x10) != 0 )
          {
            if ( *(_BYTE *)(a1[2] + 431LL) )
            {
              *((_QWORD *)v9 + 11) = *(_QWORD *)(*((_QWORD *)v9 + 7) + 144LL);
            }
            else
            {
...
LABEL_53:
              ...
              v28 = (_QWORD *)CVirtualAddressAllocator::MapVirtualAddressRange(
              ...
              *((_QWORD *)v9 + 11) = v28[13];
              OneAllocation = VIDMM_GLOBAL::CommitVirtualAddressRange(
                                ...
                                *(struct VIDMM_PAGING_QUEUE **)(32LL * *((unsigned int *)a1 + 6)
                                ...
                                (const struct _DXGK_ADL *)&xmmword_140059C70,
                                0LL,
                                0LL);
          ...
          *((_DWORD *)a1 + 30) += 24 * v9[11];
          ...
          _InterlockedAdd64(&qword_140081978, v9[9]);
          _InterlockedAdd64(&qword_140081948, 24LL * v9[10]);
          _InterlockedAdd64(&qword_140081918, 24LL * v9[11]);
          v32 = Resource;
          ++*((_DWORD *)a1 + 19);
      ...
      {
        _InterlockedAdd(&dword_1400816CC, 1u);
        WdLogSingleEntry0(6LL);
        v46 = 670;
      }
LABEL_52:
    ...
    else
    {
      ...
      v59 = 0;
      OneAllocation = VIDMM_GLOBAL::OpenOneAllocation(v10, v13, v11, 0LL, 0, 0LL, (struct VIDMM_ALLOC **)v9 + 7, &v59);
      if ( OneAllocation >= 0 )
      {
        if ( (*((_DWORD *)*v12 + 7) & 3) != 0 )
        {
LABEL_14:
        ...
        v18 = (VIDMM_GLOBAL *)*a1;
        v57 = 0LL;
        Resident = VIDMM_GLOBAL::MakeResident(v18, (struct VIDMM_PAGING_QUEUE *)v17, &v58, 1uLL, 3u, &v56, &v57);
        OneAllocation = Resident;
        if ( Resident == 259 )
        {
          VIDMM_GLOBAL::WaitForFence((VIDMM_GLOBAL *)*a1, v17[11], v56);
          OneAllocation = 0;
          goto LABEL_14;
        }
        if ( Resident >= 0 )
...
LABEL_39:
  ...
  _InterlockedAdd(&dword_140081754, 1u);
  WdLogSingleEntry0(6LL);
  v54 = 445;
LABEL_71:
