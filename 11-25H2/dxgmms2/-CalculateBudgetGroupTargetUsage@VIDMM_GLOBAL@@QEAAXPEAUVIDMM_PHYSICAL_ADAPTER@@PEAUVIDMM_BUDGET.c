/*
 * XREFs of ?CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1400DC46C
 * Callers:
        ...
        struct VIDMM_SEGMENT_GROUP_STATE *a4)
{
  ...
  {
    v5 = dword_1400815E4;
    v6 = (unsigned int)dword_1400815E8;
LABEL_4:
    v7 = *((_QWORD *)a4 + 2);
  ...
  {
    v5 = dword_1400815EC;
    v6 = (unsigned int)dword_1400815F0;
    goto LABEL_4;
  }
  if ( (_DWORD)v4 == 1 )
  {
    v5 = dword_1400815F4;
    v6 = (unsigned int)dword_1400815F8;
    goto LABEL_4;
  }
