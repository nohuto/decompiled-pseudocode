/*
 * XREFs of ?OfferOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_OFFER_FLAGS@@@Z @ 0x1400FCE00
 * Callers:
 ...
 *     VidMmAddOfferReference @ 0x14003CBFC (VidMmAddOfferReference.c)
        ...
        struct _D3DKMT_OFFER_FLAGS a4)
{
  ...
  *(_QWORD *)v43 = *(_QWORD *)v9;
  ...
  ExAcquirePushLockExclusiveEx(v9 + 312, 0LL);
  ...
  *(_QWORD *)(v9 + 320) = KeGetCurrentThread();
  if ( *(_DWORD *)(v9 + 184) )
  {
    if ( (*((_BYTE *)this + 40936) & 0x20) == 0 )
    {
      ...
      if ( DxgkVidMmAllowFailOnOfferReclaimErrors() )
      {
        Feature_Servicing_GraphicsKernel_VolatileAccessorUpdate__private_IsEnabledDeviceUsageNoInline();
        *(_QWORD *)(v9 + 320) = 0LL;
        ExReleasePushLockExclusiveEx(v9 + 312, 0LL);
  ...
  if ( v11 )
  {
    ...
    if ( v12 )
    {
      ...
      {
        if ( v13 == 1 )
          *(_DWORD *)(v9 + 296) = *(_DWORD *)(*(_QWORD *)v9 + 48LL) < 0xA0000000 ? 2 : 4;
      }
      else
      {
        *(_DWORD *)(v9 + 296) = 3;
