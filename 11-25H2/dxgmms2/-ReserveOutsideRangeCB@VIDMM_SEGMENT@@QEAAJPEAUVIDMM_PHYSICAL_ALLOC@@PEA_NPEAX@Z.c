/*
 * XREFs of ?ReserveOutsideRangeCB@VIDMM_SEGMENT@@QEAAJPEAUVIDMM_PHYSICAL_ALLOC@@PEA_NPEAX@Z @ 0x14009D060
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( VIDMM_SEGMENT::IsMovableResourceCB(a2) )
  {
          ...
          v10 >= 0) )
    {
      ...
      *((_BYTE *)this + 512) = 1;
      if ( VIDMM_GLOBAL_ALLOC_NONPAGED::HasOutstandingPresentReferences(*(VIDMM_GLOBAL_ALLOC_NONPAGED **)(*(_QWORD *)a2 + 376LL)) )
