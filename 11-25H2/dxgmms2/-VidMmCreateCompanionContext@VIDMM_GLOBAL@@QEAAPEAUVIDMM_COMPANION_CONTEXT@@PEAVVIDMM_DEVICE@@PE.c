/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1400966BC
 * Callers:
 *     VidMmCreateCompanionContext @ 0x14004C480 (VidMmCreateCompanionContext.c)
 * Callees:
