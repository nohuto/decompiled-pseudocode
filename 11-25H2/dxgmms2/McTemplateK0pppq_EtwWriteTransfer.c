/*
 * XREFs of McTemplateK0pppq_EtwWriteTransfer @ 0x140043A58
 * Callers:
...
NTSTATUS McTemplateK0pppq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventCreateVidMmPagingQueue, a3, 5u, &v4);
}
