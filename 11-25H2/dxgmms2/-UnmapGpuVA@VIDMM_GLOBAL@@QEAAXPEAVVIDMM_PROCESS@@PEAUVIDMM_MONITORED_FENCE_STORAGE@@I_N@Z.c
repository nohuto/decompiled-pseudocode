/*
 * XREFs of ?UnmapGpuVA@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@I_N@Z @ 0x1400B3BA4
 * Callers:
 *     VidMmUnmapGpuVA @ 0x140041480 (VidMmUnmapGpuVA.c)
 *     VidMmUnmapPagingProcessGpuVA @ 0x140045E80 (VidMmUnmapPagingProcessGpuVA.c)
