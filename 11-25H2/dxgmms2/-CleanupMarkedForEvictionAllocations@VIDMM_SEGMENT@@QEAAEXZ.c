/*
 * XREFs of ?CleanupMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAEXZ @ 0x1400BBBB8
 * Callers:
...
char __fastcall VIDMM_SEGMENT::CleanupMarkedForEvictionAllocations(VIDMM_GLOBAL **this)
{
  ...
  while ( 1 )
  {
    ...
    if ( !VIDMM_GLOBAL::UnderCleanupLimit(this[3]) )
      return v3;
    VIDMM_PHYSICAL_ADAPTER::EvictResources(this[4], (struct VIDMM_PHYSICAL_ALLOC *)*(v4 - 31), 1, 0, 0, 0LL);
    v5 = this[3];
    *((_QWORD *)v5 + 886) += *(_QWORD *)(*(v4 - 31) + 16LL);
    ++*((_DWORD *)v5 + 1774);
  }
  return 0;
}
