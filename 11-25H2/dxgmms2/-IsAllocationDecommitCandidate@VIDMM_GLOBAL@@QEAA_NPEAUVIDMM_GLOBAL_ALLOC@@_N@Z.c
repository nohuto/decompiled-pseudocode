/*
 * XREFs of ?IsAllocationDecommitCandidate@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_GLOBAL_ALLOC@@_N@Z @ 0x140108070
 * Callers:
...
char __fastcall VIDMM_GLOBAL::IsAllocationDecommitCandidate(VIDMM_GLOBAL *this, struct VIDMM_GLOBAL_ALLOC *a2, char a3)
{
  ...
  if ( *(_WORD *)(v3 + 8) < 2u )
  {
    ...
    WdLogGlobalForLineNumber = 26711;
    return 0;
  }
  if ( (*((_DWORD *)a2 + 8) & 0x40) == 0 )
  {
    WdLogSingleEntry1(3LL, 2LL);
    WdLogGlobalForLineNumber = 26720;
    return 0;
  }
  if ( (*(_DWORD *)v3 & 0x30) != 0 )
  {
    WdLogSingleEntry1(3LL, 3LL);
    WdLogGlobalForLineNumber = 26731;
    return 0;
  }
  if ( a3 && !VIDMM_GLOBAL::IsAllocationRepurposed(this, a2) )
  {
    if ( g_IsInternalReleaseOrDbg )
    {
      *(_QWORD *)(WdLogNewEntry5_WdTrace(v4) + 24) = 5LL;
      WdLogGlobalForLineNumber = 26741;
    }
    return 0;
  }
  return 1;
