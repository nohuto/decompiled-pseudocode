/*
 * XREFs of ?VidSchiStartHwSchNodeProgressMonitoring@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x140038CCC
 * Callers:
...
void __fastcall VidSchiStartHwSchNodeProgressMonitoring(struct _VIDSCH_NODE *a1)
{
  ...
  v4 = 0;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*((_QWORD *)a1 + 3) + 1984LL), &LockHandle);
  v2 = *((_DWORD *)a1 + 432);
  LOBYTE(v4) = 1;
  if ( v2 || *((_DWORD *)a1 + 434) )
    *((_DWORD *)a1 + 110) = 1;
