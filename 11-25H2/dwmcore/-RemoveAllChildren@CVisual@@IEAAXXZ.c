/*
 * XREFs of ?RemoveAllChildren@CVisual@@IEAAXXZ @ 0x18010A1B4
 * Callers:
 *     ??1CVisual@@MEAA@XZ @ 0x180108F2C (--1CVisual@@MEAA@XZ.c)
 *     ?ProcessRemoveAllChildren@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_REMOVEALLCHILDREN@@@Z @ 0x18010A19C (-ProcessRemoveAllChildren@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_REMOVEALLCHILDR.c)
 * Callees:
...
void __fastcall CVisual::RemoveAllChildren(CVisual *this)
{
  ...
  _QWORD *v19; // rdi
  __int64 v20; // rax
  struct CProcessAttribution *(__fastcall *v21)(CResource *); // rax
  struct CProcessAttribution *ProcessAttributionNoRef; // rax
  struct CProcessAttribution *v23; // rsi
  _QWORD *v24; // rdi
  __int64 v25; // rax
  struct CProcessAttribution *(__fastcall *v26)(CWindowNode *); // rax
  ...
  _DWORD *v35; // rcx
  void (__fastcall *v36)(_QWORD, _QWORD, _QWORD); // rax
  unsigned __int64 v37; // rbp
  __int64 v38; // r14
  __int64 v39; // rsi
  unsigned __int64 Count; // rax
  _DWORD *v41; // rcx
  void (__fastcall *v42)(_QWORD, _QWORD, _QWORD); // rax
  CVisual *v43; // rax
  CVisual *v44; // rcx
    ...
    do
    {
      ...
      if ( v5 < v10 )
      {
        ...
        if ( v9 )
        {
          ...
          {
            CVisual::DirtyForInvisibleChild((CComposition **)this, (struct CVisual *)v9);
            v4 += *(_DWORD *)(v9 + 268);
          ...
          v12 = *(_QWORD *)v9;
          *(_QWORD *)(v9 + 88) = 0LL;
          v13 = *(__int64 (__fastcall **)(CResource *))(v12 + 16);
          if ( v13 == CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease )
            CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalRelease((CResource *)v9);
          else
            v13((CResource *)v9);
          v14 = *((_QWORD *)this + 10);
          ...
          if ( v5 >= v16 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x126u, 0LL);
          }
          else if ( v16 == 1 )
          {
            *((_QWORD *)this + 10) = 1LL;
  ...
  if ( (_DWORD)v1 )
  {
    ...
    if ( (_DWORD)v20 )
    {
      ...
      do
      {
        ...
        {
          v41 = (_DWORD *)(*v19 & 0xFFFFFFFFFFFFFFFCuLL);
        }
        else
        {
          _mm_lfence();
          v41 = *(_DWORD **)((*v19 & 0xFFFFFFFFFFFFFFFCuLL) + v39);
        }
        if ( v41 != *((_DWORD **)this + 11) )
        {
          v42 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)v41 + 80LL);
          if ( (char *)v42 == (char *)CCachedVisualImage::NotifyOnChanged )
          {
            CCachedVisualImage::NotifyOnChanged(v41, 0, (__int64)this);
          }
          else if ( (char *)v42 == (char *)CVisualSurface::NotifyOnChanged )
          {
            CVisualSurface::NotifyOnChanged((__int64)v41, 0, (__int64)this);
          }
          else
          {
            v42(v41, 0LL, this);
    ...
    v21 = *(struct CProcessAttribution *(__fastcall **)(CResource *))(*(_QWORD *)this + 160LL);
        ...
        *((_BYTE *)v24 + 96) |= 0x91u;
        ...
        if ( (_DWORD)v25 )
        {
          ...
          do
          {
            ...
            {
              v35 = (_DWORD *)(v33 & 0xFFFFFFFFFFFFFFFCuLL);
            }
            else
            {
              _mm_lfence();
              v35 = *(_DWORD **)((v24[4] & 0xFFFFFFFFFFFFFFFCuLL) + v32);
            }
            if ( v35 != (_DWORD *)v24[11] )
            {
              v36 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)v35 + 80LL);
              if ( (char *)v36 == (char *)CCachedVisualImage::NotifyOnChanged )
              {
                CCachedVisualImage::NotifyOnChanged(v35, 0, (__int64)v24);
              }
              else if ( (char *)v36 == (char *)CVisualSurface::NotifyOnChanged )
              {
                CVisualSurface::NotifyOnChanged((__int64)v35, 0, (__int64)v24);
              }
              else
              {
                v36(v35, 0LL, v24);
        ...
        v26 = *(struct CProcessAttribution *(__fastcall **)(CWindowNode *))(*v24 + 160LL);
