/*
 * XREFs of ?BuildFromRectFs@CShape@@SAJPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@IPEAPEAV1@@Z @ 0x1802639EC
 * Callers:
    ...
    if ( !IsPixelAligned(a1) )
    {
      ...
      if ( v8 )
      {
        ...
        *v8 = &CRectanglesShape::`vftable';
        ...
        v8[4] = v8 + 7;
        v8[7] = 0LL;
        CRectanglesShape::BuildFromRectFs(v8, (unsigned __int64)a1, 1u);
LABEL_10:
        *a3 = v9;
        goto LABEL_13;
      }
