/*
 * XREFs of ?EnsureRealizationInternal@CCachedImageProducer@@IEAAJPEAVCDrawingContext@@PEAPEBVCCachedRealization@1@@Z @ 0x1801DB664
 * Callers:
        ...
        const struct CCachedImageProducer::CCachedRealization **a3)
{
  ...
  __int64 v21; // rdx
  bool (__fastcall *v22)(CDeviceTextureTarget *); // rdx
  ...
  LOBYTE(v38) = *((_BYTE *)g_pComposition + 6490);
  ...
  while ( v8 != *((CRenderTargetBitmap ****)this + 5) )
  {
    ...
    if ( IsValid < 0 )
      goto LABEL_6;
    v15 = (__int64)*v10;
    v16 = *(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)*v10 + 88LL);
    if ( v16 == CRenderTargetBitmap::GetRenderTargetInfo )
      RenderTargetInfo = (float *)CRenderTargetBitmap::GetRenderTargetInfo(v15, (__int64)&v34);
    else
      RenderTargetInfo = (float *)v16(v15, (__int64)&v34);
      ...
      && (!*((_BYTE *)v18 + 20) || *(_BYTE *)(v9 + 20)) )
    {
      ...
      if ( (_BYTE)v38 )
      {
        v22 = *(bool (__fastcall **)(CDeviceTextureTarget *))(v21 + 160);
        v23 = v20;
      ...
      {
        v22 = *(bool (__fastcall **)(CDeviceTextureTarget *))(v21 + 176);
        v23 = v20;
...
LABEL_17:
      if ( IsProtected )
        goto LABEL_37;
      v25 = (__int64)*v10;
      v26 = *(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)*v10 + 88LL);
      if ( v26 == CRenderTargetBitmap::GetRenderTargetInfo )
        v27 = CRenderTargetBitmap::GetRenderTargetInfo(v25, (__int64)&v34);
      else
        v27 = v26(v25, (__int64)&v34);
