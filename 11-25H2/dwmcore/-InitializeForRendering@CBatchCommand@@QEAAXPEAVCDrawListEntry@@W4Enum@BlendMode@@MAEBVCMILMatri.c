/*
 * XREFs of ?InitializeForRendering@CBatchCommand@@QEAAXPEAVCDrawListEntry@@W4Enum@BlendMode@@MAEBVCMILMatrix@@_N@Z @ 0x1800927D0
 * Callers:
        ...
        char a6)
{
  ...
  __int128 v34; // xmm0
  __int128 v35; // xmm1
  unsigned int (__fastcall *v36)(CMILRefCountImpl *__hidden); // rdx
  int v37; // et0
  float v38; // xmm1_4
  float v39; // xmm3_4
  float v40; // xmm4_4
