/*
 * XREFs of ?SetRelativeOffset@CVisual@@QEAAXMMM@Z @ 0x1801A46C8
 * Callers:
 ...
 *     ?ProcessSetRelativeOffset@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETRELATIVEOFFSET@@@Z @ 0x1801A469C (-ProcessSetRelativeOffset@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETRELATIVEOFFS.c)
 * Callees:
        ...
        double a4)
{
  ...
  if ( v6.x != a2 || v6.y != a3 || v6.z != *(float *)&a4 )
  {
    *(_QWORD *)&v6.x = __PAIR64__(LODWORD(a3), LODWORD(a2));
    ...
    CResource::InvalidateAnimationSources((CResource *)this, 30LL);
  }
}
