/*
 * XREFs of McTemplateU0ppffff_EventWriteTransfer @ 0x18002B738
 * Callers:
...
__int64 McTemplateU0ppffff_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v13 = 4LL;
  v15 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &EVTDESC_ETWGUID_PRIMITIVE_GROUP_DRAW, v17, 7LL, v3);
}
