/*
 * XREFs of ?UpdateMmcssPartners@CComposition@@QEAAJXZ @ 0x180100010
 * Callers:
...
__int64 __fastcall CComposition::UpdateMmcssPartners(CComposition *this)
{
  ...
  v3 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v2, 0x2F2u, 0LL);
  v4 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 80) + 48LL))(*((_QWORD *)this + 80));
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x2F4u, 0LL);
  if ( !v3 || v3 >= 0 && v5 < 0 )
    v3 = v5;
  v6 = CSurfaceManager::ResetTokenThread(*((CSurfaceManager **)this + 78));
  v7 = v6;
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x2F6u, 0LL);
  if ( !v3 || v3 >= 0 && v7 < 0 )
