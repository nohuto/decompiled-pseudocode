/*
 * XREFs of ?HrFindInterface@CCachedImageProducer@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180292270
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CCachedImageProducer::HrFindInterface(CCachedImageProducer *this, const struct _GUID *a2, void **a3)
{
  __int64 result; // rax
