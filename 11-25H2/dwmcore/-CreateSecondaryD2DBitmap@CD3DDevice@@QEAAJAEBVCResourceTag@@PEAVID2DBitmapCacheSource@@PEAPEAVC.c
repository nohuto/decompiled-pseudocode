/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDevice@@QEAAJAEBVCResourceTag@@PEAVID2DBitmapCacheSource@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x1802C5FAC
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDevice@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x1802138C0 (-GetCompatibleTextureFormat@CD3DDevice@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
 *     ??1?$out_param_t@V?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@@details@wil@@QEAA@XZ @ 0x18025B43C (--1-$out_param_t@V-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-C.c)
    ...
    *a4 = 0LL;
    if ( v33 && HIDWORD(v52) )
    {
      if ( !*((_DWORD *)this + 278) )
      {
        ...
        v35 = v45;
LABEL_64:
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v35, v48, 0LL);
        goto LABEL_65;
      }
      v35 = -2003304307;
      v48 = 1503;
  ...
  *a4 = 0LL;
  ...
  if ( v14 )
  {
    ...
    {
      v50 = 0LL;
      wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset(&v50);
      Device = CDeviceManager::GetDevice((CDeviceManager *)&g_DeviceManager, v53, &v50);
      v17 = Device;
      if ( Device < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, Device, 0x544u, 0LL);
  ...
  if ( !*((_DWORD *)this + 278) )
  {
    ...
    if ( v10 )
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v17, 0x598u, 0LL);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v31, 0x59Cu, 0LL);
      }
      wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::~unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>((void **)&v50);
      goto LABEL_13;
    }
...
LABEL_10:
  v17 = v20;
LABEL_11:
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v20, v47, 0LL);
LABEL_13:
