/*
 * XREFs of ?HandleDDAArrivalOrDeparture@CRenderTargetManager@@QEAAJXZ @ 0x180234BB8
 * Callers:
 *     ?OnReevaluateDDA@CChannelContext@@QEAAXXZ @ 0x1802576B0 (-OnReevaluateDDA@CChannelContext@@QEAAXXZ.c)
 * Callees:
