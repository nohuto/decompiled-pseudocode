/*
 * XREFs of ?HrInit@CBitmapLock@@QEAAJPEAVIBitmapUnlock@@IIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@_NPEAUIUnknown@@@Z @ 0x1801884D4
 * Callers:
...
LABEL_5:
      v11 = v20;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, v19, 0LL);
      v21 = 1678;
LABEL_6:
