/*
 * XREFs of ?CalcDeviceTransformDelta@CTreeEffectLayer@@EEAAJPEAVCDrawingContext@@PEAVCMILMatrix@@@Z @ 0x18002BB30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILMatrix *a3)
{
  ...
  if ( v8 )
  {
    ...
    else
    {
      ...
      if ( *(_BYTE *)(*((_QWORD *)this + 32) + 697LL) )
        CDrawingContext::CalcLocalSpaceClippedBounds(a2, &v29, v10);
      else
  ...
  if ( CLayerVisual::IsAutomaticBoundsToLocalSpaceEnabled(*((CLayerVisual **)this + 32)) )
  {
    ...
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x275u, 0LL);
    }
    else
    {
