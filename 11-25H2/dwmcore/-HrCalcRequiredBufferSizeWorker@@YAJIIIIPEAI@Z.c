/*
 * XREFs of ?HrCalcRequiredBufferSizeWorker@@YAJIIIIPEAI@Z @ 0x180188E64
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( v9 <= 0xFFFFFFFF )
  {
    ...
    {
      v7 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x666u, 0LL);
      return v7;
    }
    v12 = v6 * v8;
    if ( v12 > 0xFFFFFFFF )
...
LABEL_4:
  v7 = -2147024362;
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, v13, 0LL);
  return v7;
}
