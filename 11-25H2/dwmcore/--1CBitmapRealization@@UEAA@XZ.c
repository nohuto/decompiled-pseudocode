/*
 * XREFs of ??1CBitmapRealization@@UEAA@XZ @ 0x18020D64C
 * Callers:
 *     ??1CSectionBitmapRealization@@MEAA@XZ @ 0x1801FA74C (--1CSectionBitmapRealization@@MEAA@XZ.c)
 *     ??1?$CDeviceResourceT@V?$IBitmapRealizationMethodsT@VCBitmapRealization@@VIYUVSwapChainRealization@@@@@@MEAA@XZ @ 0x180212AAC (--1-$CDeviceResourceT@V-$IBitmapRealizationMethodsT@VCBitmapRealization@@VIYUVSwapChainRealizati.c)
