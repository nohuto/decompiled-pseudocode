/*
 * XREFs of ?GetBoundsWithEffects@CLayerVisual@@UEBAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x1800264C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLayerVisual::GetBoundsWithEffects(CVisual *this, _OWORD *a2, __int128 *a3)
{
    ...
    *(_QWORD *)v18 = *((_QWORD *)v9 + 12);
    ...
    if ( MaskForLayerVisualNoRef )
    {
      ...
      if ( !CVisual::GetEffectiveSize(this, v16, &v17) )
        return v6;
      v14 = *(__int64 (__fastcall **)(__int64, float *, __int128 *))(*(_QWORD *)v13 + 184LL);
      v16[1] = v17;
      v15 = v14(v13, v16, &v19);
      v6 = v15;
      if ( v15 < 0 )
