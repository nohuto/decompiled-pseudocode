/*
 * XREFs of ?GetSpectreTexture@CSceneResourceManager@@QEAAJPEAVCResource@@PEAPEAUISpectreTexture@@@Z @ 0x1802694D8
 * Callers:
        ...
        struct ISpectreTexture **a3)
{
  ...
  v32 = a2;
  v5 = 0;
  if ( (*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 188LL) )
  {
    v6 = v32;
    v33 = 0LL;
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(CVisualSurface *, __int64))(*(_QWORD *)v32 + 64LL))(v32, 37LL) )
    return v5;
  result = 0LL;
