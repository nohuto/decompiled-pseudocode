/*
 * XREFs of ?ProcessSetMask@CMaskBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MASKBRUSH_SETMASK@@@Z @ 0x1801F7414
 * Callers:
        ...
        const struct tagMILCMD_MASKBRUSH_SETMASK *a3)
{
  ...
  if ( v3 && v3 < *((_DWORD *)a2 + 7) && (v5 = *((_QWORD *)a2 + 5), *(_DWORD *)(*((_DWORD *)a2 + 6) * v3 + v5)) )
    ...
    v6 = 0LL;
  v7 = (struct CResource **)((char *)this + 112);
  if ( v6 != *((const struct CResource **)this + 14) )
  {
    v8 = (const struct CResource **)((char *)this + 112);
    if ( v6 )
    {
