/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18027A170
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v7, 2LL, 7LL, 10, &unk_18038ED05, a2, v6, v7[0]);
  if ( v4 < 0 )
