/*
 * XREFs of ?Channel_BeginDuplicateResource@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_BEGINDUPLICATERESOURCE@@@Z @ 0x1801EFFA0
 * Callers:
 ...
 *     ??$_Emplace_reallocate@U?$pair@PEAVCResource@@W4MIL_RESOURCE_TYPE@@@std@@@?$vector@U?$pair@PEAVCResource@@W4MIL_RESOURCE_TYPE@@@std@@V?$allocator@U?$pair@PEAVCResource@@W4MIL_RESOURCE_TYPE@@@std@@@2@@std@@AEAAPEAU?$pair@PEAVCResource@@W4MIL_RESOURCE_TYPE@@@1@QEAU21@$$QEAU21@@Z @ 0x1801F01FC (--$_Emplace_reallocate@U-$pair@PEAVCResource@@W4MIL_RESOURCE_TYPE@@@std@@@-$vector@U-$pair@PEAVC.c)
        ...
        const struct tagMILCMD_CHANNEL_BEGINDUPLICATERESOURCE *a4)
{
    ...
    && (v10 = *(_QWORD *)(*((_DWORD *)a3 + 6) * v4 + v8 + 8)) != 0 )
  {
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x51Au, 0LL);
  ...
  {
    v5 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0x515u, 0LL);
  }
  return v5;
}
