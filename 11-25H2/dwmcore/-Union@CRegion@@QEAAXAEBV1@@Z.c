/*
 * XREFs of ?Union@CRegion@@QEAAXAEBV1@@Z @ 0x1800996C0
 * Callers:
 ...
 *     ?RetireTransientRegion@CSwapChainBuffer@@UEAAXXZ @ 0x18020D1B0 (-RetireTransientRegion@CSwapChainBuffer@@UEAAXXZ.c)
