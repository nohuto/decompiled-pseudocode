/*
 * XREFs of ?Alloc@?$CThreadLocalObjectCache@VCDrawListEntry@@V1@@@SAPEAX_K@Z @ 0x1800471A4
 * Callers:
...
_QWORD *CThreadLocalObjectCache<CDrawListEntry,CDrawListEntry>::Alloc()
{
  _DWORD *Value; // rbx
  int v1; // edx
  _QWORD *v2; // rcx
  ...
  if ( !v2 )
  {
    ...
    return HeapAlloc(ProcessHeap, 0, 0x50uLL);
  }
  return v2;
}
