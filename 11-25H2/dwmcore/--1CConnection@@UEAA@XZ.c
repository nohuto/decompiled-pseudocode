/*
 * XREFs of ??1CConnection@@UEAA@XZ @ 0x180266F34
 * Callers:
...
void __fastcall CConnection::~CConnection(void **this)
{
  ...
  *this = &CConnection::`vftable';
  ...
  wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::~unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>(this + 4);
}
