/*
 * XREFs of ?RectangleGeometrySetRectangle@CChannel@@UEAAJIMMMMMMMMMMMM_N@Z @ 0x1801825D0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool a15)
{
  ...
  if ( !(_DWORD)v17 || v17 > (__int64)(*((_QWORD *)this + 3) - *((_QWORD *)this + 2)) >> 4 || !*v19 || !v19[1] )
LABEL_9:
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v18);
  for ( i = (unsigned int)v19[1]; ; LODWORD(i) = dword_1803A0BA0[i] )
  {
