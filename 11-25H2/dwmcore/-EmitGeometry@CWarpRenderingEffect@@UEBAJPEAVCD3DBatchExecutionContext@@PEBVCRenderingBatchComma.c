/*
 * XREFs of ?EmitGeometry@CWarpRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEBVCRenderingBatchCommand@@@Z @ 0x180162780
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
      ...
      else
      {
        ...
        v65 = v64;
        if ( v64 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v64, 0xA0Du, 0LL);
      }
      if ( !*(_DWORD *)(v61 + 1112)
...
LABEL_51:
          ...
          if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v65, 0, &v176) )
          {
            ...
            if ( v102 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v102, 0xB4Du, v66);
              v66 = 0LL;
            }
          }
          v17 = v65;
...
LABEL_119:
    ...
    else
    {
      ...
      v94 = v93;
      if ( v93 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v93, 0xA0Du, 0LL);
    }
    if ( !*(_DWORD *)(v90 + 1112)
...
LABEL_93:
        ...
        if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v94, 0, &v176) )
        {
          ...
          if ( v103 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v103, 0xB4Du, v95);
            v95 = 0LL;
          }
        }
        v4 = v94;
