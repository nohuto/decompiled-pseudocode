/*
 * XREFs of ?DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z @ 0x18010ABE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDrawingContext::DrawVisual(CDrawingContext *this, struct CVisual *a2)
{
  ...
  else
  {
    ...
    v7 = v13;
    v8 = CDrawingContext::DrawSubVisualTree((__int64)this - 16, v13, (__int64)v13 + 80, (CMILMatrix *)v10);
    if ( v7 )
