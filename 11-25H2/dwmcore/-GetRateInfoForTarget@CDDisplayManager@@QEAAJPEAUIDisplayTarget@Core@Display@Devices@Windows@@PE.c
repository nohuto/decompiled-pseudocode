/*
 * XREFs of ?GetRateInfoForTarget@CDDisplayManager@@QEAAJPEAUIDisplayTarget@Core@Display@Devices@Windows@@PEAVRefreshRateInfo@@@Z @ 0x18023087C
 * Callers:
 ...
 *     ??0RefreshRateInfo@@QEAA@URational@Numerics@Foundation@Windows@@00I@Z @ 0x18023AEBC (--0RefreshRateInfo@@QEAA@URational@Numerics@Foundation@Windows@@00I@Z.c)
