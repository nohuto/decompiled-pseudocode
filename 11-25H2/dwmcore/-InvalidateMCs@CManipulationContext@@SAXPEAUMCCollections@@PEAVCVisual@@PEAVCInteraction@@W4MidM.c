/*
 * XREFs of ?InvalidateMCs@CManipulationContext@@SAXPEAUMCCollections@@PEAVCVisual@@PEAVCInteraction@@W4MidManipulationUpdateType@@PEAI@Z @ 0x18022E788
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  int *v14; // r8
  char v15; // cl
  struct CManipulationContext *v16; // rsi
  const struct CInteraction *v17; // rdi
  bool *v18; // rdx
