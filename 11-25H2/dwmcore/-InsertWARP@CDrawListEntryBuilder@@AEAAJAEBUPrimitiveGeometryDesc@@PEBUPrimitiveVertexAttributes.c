/*
 * XREFs of ?InsertWARP@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@_N@Z @ 0x180196748
 * Callers:
        ...
        char a4)
{
  ...
  if ( *((float *)&v19 + 2) > *(float *)&v19 && *((float *)&v19 + 3) > *((float *)&v19 + 1) )
  {
      ...
      && (float)((float)(*((float *)&v19 + 3) - *((float *)&v19 + 1)) * (float)(*((float *)&v19 + 2) - *(float *)&v19)) >= (float)CCommonRegistryData::MegaRectSize )
    {
      ...
      {
        v17 = CDrawListEntryBuilder::AppendReconstructableEntry((unsigned int *)this, &v19, v8, 0, 1, a3, 1024);
        v4 = v17;
        if ( v17 < 0 )
        {
