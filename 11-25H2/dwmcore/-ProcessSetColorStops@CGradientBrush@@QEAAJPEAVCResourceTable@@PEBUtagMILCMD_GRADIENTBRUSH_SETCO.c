/*
 * XREFs of ?ProcessSetColorStops@CGradientBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GRADIENTBRUSH_SETCOLORSTOPS@@PEBXI@Z @ 0x180130DD0
 * Callers:
 ...
 *     ?IsOfType@CColorGradientStop@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180130FC0 (-IsOfType@CColorGradientStop@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z.c)
