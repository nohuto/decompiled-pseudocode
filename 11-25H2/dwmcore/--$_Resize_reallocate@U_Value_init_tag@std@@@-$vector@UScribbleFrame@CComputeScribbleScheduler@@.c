/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UScribbleFrame@CComputeScribbleScheduler@@V?$allocator@UScribbleFrame@CComputeScribbleScheduler@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x180292D74
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( *a1 )
    std::_Deallocate<16,0>(*a1, ((_BYTE *)a1[2] - (_BYTE *)*a1) & 0xFFFFFFFFFFFFFFE0uLL);
  *a1 = v10;
  a1[1] = &v10[32 * a2];
  a1[2] = &v10[32 * v2];
}
