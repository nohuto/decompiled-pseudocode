/*
 * XREFs of ??$emplace@U?$pair@W4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@@std@@@?$_Hash@V?$_Umap_traits@W4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@V?$_Uhash_compare@W4ShaderLinkingArgument@@U?$hash@W4ShaderLinkingArgument@@@std@@U?$equal_to@W4ShaderLinkingArgument@@@3@@std@@V?$allocator@U?$pair@$$CBW4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@@std@@@5@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBW4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@@std@@@std@@@std@@@std@@_N@1@$$QEAU?$pair@W4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@@1@@Z @ 0x1801D35E0
 * Callers:
 ...
 *     ?_Insert_new_node_before@?$_Hash@V?$_Umap_traits@PEAVCVisual@@VCPreWalkVisual@@V?$_Uhash_compare@PEAVCVisual@@U?$hash@PEAVCVisual@@@std@@U?$equal_to@PEAVCVisual@@@3@@std@@V?$allocator@U?$pair@QEAVCVisual@@VCPreWalkVisual@@@std@@@4@$0A@@std@@@std@@IEAAPEAU?$_List_node@U?$pair@QEAVCVisual@@VCPreWalkVisual@@@std@@PEAX@2@_KQEAU32@1@Z @ 0x1800C14D4 (-_Insert_new_node_before@-$_Hash@V-$_Umap_traits@PEAVCVisual@@VCPreWalkVisual@@V-$_Uhash_compare.c)
        ...
        __int64 a3)
{
  ...
  v7 = std::_Uhash_compare<enum ShaderLinkingArgument,std::hash<enum ShaderLinkingArgument>,std::equal_to<enum ShaderLinkingArgument>>::operator()<enum ShaderLinkingArgument>(
         (__int64)a1,
         a3);
  v8 = a1[1];
  v9 = a1[3];
  v10 = *(_QWORD *)(v9 + 16 * (v7 & a1[6]) + 8);
  if ( v10 == v8 )
    goto LABEL_6;
  v11 = *(_QWORD *)(v9 + 16 * (v7 & a1[6]));
  while ( 1 )
  {
    if ( *v6 == *(_WORD *)(v10 + 16) )
    {
...
LABEL_6:
    ...
    *(_BYTE *)(v12 + 32) = *(_BYTE *)(a3 + 16);
    *(_DWORD *)(v12 + 33) = *(_DWORD *)(a3 + 17);
    *(_BYTE *)(v12 + 37) = *(_BYTE *)(a3 + 21);
