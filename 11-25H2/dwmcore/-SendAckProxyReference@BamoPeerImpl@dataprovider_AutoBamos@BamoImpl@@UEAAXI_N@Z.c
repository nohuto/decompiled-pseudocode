/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x180228E10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  LODWORD(v7) = a3;
  v5 = CoreUICallSend(v4, v8, 2LL, 7LL, 6, &unk_18038ED11, a2, v7, v8[0]);
  if ( v5 < 0 )
