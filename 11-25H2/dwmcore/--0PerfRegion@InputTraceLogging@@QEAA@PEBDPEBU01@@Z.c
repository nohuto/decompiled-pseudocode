/*
 * XREFs of ??0PerfRegion@InputTraceLogging@@QEAA@PEBDPEBU01@@Z @ 0x180136020
 * Callers:
        ...
        const struct InputTraceLogging::PerfRegion *a3)
{
  ...
  *((_QWORD *)this + 6) = 0LL;
    ...
    && (_DWORD)fPending )
  {
    ...
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_180406C90, qword_180406CA8, v10);
