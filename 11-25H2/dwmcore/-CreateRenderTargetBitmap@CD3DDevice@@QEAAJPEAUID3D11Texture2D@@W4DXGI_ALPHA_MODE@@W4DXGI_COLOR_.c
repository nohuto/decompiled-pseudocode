/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x180220E44
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( (v30 & 0x20) != 0 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v19, 0x477u, 0LL);
      v9 = v21[0];
    }
    else
    {
      ...
      v14 = v20;
      if ( v20 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v20, 0x47Bu, 0LL);
    }
  }
  else
  {
    v14 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, -2147024809, 0x460u, 0LL);
  }
