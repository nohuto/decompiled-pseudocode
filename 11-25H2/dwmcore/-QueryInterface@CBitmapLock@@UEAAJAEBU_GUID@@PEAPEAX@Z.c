/*
 * XREFs of ?QueryInterface@CBitmapLock@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18021BC90
 * Callers:
 *     ?QueryInterface@CBitmapLock@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802615F0 (-QueryInterface@CBitmapLock@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
