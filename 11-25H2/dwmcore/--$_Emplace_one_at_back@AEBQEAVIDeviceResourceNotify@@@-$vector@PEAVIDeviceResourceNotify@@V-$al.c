/*
 * XREFs of ??$_Emplace_one_at_back@AEBQEAVIDeviceResourceNotify@@@?$vector@PEAVIDeviceResourceNotify@@V?$allocator@PEAVIDeviceResourceNotify@@@std@@@std@@AEAAAEAPEAVIDeviceResourceNotify@@AEBQEAV2@@Z @ 0x18006D62C
 * Callers:
 *     ?AddResourceNotifier@?$IDeviceResourceMethodsT@VCD2DResource@@VID2DBitmap@@@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x18006DC30 (-AddResourceNotifier@-$IDeviceResourceMethodsT@VCD2DResource@@VID2DBitmap@@@@UEAAXPEAVIDeviceRes.c)
 ...
 *     ?AddResourceNotifier@?$CDeviceResourceT@V?$CMILCOMBaseT@VILegacyRemotingSwapChain@@VIDeviceResource@@VCMilObjectDeleter@@@@@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x18021C0F0 (-AddResourceNotifier@-$CDeviceResourceT@V-$CMILCOMBaseT@VILegacyRemotingSwapChain@@VIDeviceResou.c)
 *     ?AddResourceNotifier@?$CDeviceResourceT@VIOverlaySwapChain@@@@UEAAXPEAVIDeviceResourceNotify@@@Z @ 0x18021CE10 (-AddResourceNotifier@-$CDeviceResourceT@VIOverlaySwapChain@@@@UEAAXPEAVIDeviceResourceNotify@@@Z.c)
