/*
 * XREFs of ?ProcessKernelTokens@CGlobalSurfaceManager@@AEAAJXZ @ 0x1800FF800
 * Callers:
 *     ?s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z @ 0x180239610 (-s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CGlobalSurfaceManager::ProcessKernelTokens(CGlobalSurfaceManager *this)
{
  ...
  while ( !*((_BYTE *)this + 144) )
  {
    ...
    if ( *((_BYTE *)this + 144) )
      return v2;
    CMmcssTask::Clone((LPCRITICAL_SECTION)((char *)g_pComposition + 736), (CGlobalSurfaceManager *)((char *)this + 408));
