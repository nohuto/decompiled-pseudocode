/*
 * XREFs of ?UpdateValueWithChaining@CScrollAnimation@@IEAAMMMW4Boundary@@@Z @ 0x1800F3724
 * Callers:
...
__m128 __fastcall CScrollAnimation::UpdateValueWithChaining(__int64 a1, double a2, float a3, unsigned int a4)
{
  ...
  unsigned int v64; // [rsp+94h] [rbp-7Ch]
  ...
  __int64 v77; // [rsp+D0h] [rbp-40h] BYREF
...
LABEL_29:
          *(double *)&v4 = CInteractionTracker::ClampValueToBoundary(
                             InteractionTracker,
                             *(unsigned int *)(a1 + 324),
                             v23);
          v6 = v4;
LABEL_18:
        ...
        if ( (*(_BYTE *)(a1 + 436) & 1) == 0 )
        {
          ...
          if ( *(float *)&v4 != 0.0 )
          {
            ...
            if ( (float)(int)v23 != *(float *)&v4 && v31 != 0.0 )
            {
              v62 = 3LL * *(int *)(a1 + 324);
