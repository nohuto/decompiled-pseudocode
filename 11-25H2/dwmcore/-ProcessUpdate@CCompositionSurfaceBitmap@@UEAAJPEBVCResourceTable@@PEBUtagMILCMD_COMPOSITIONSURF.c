/*
 * XREFs of ?ProcessUpdate@CCompositionSurfaceBitmap@@UEAAJPEBVCResourceTable@@PEBUtagMILCMD_COMPOSITIONSURFACEBITMAP@@@Z @ 0x180103B80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  v5 = v13;
LABEL_5:
  TranslateDXGIorD3DErrorInContext(v4, 10LL, &v12);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
    McGenEventWrite_EventWriteTransfer(
      &Microsoft_Windows_Dwm_Core_Provider_Context,
