/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@stdext@@_J@Z @ 0x1802C1994
 * Callers:
 *     ??$move@V?$move_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@std@@V?$checked_array_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@stdext@@V?$move_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@0@0V12@@Z @ 0x1802C1A8C (--$move@V-$move_iterator@PEAVPlaneInfo@CBetterCheckMPOCache@@@std@@V-$checked_array_iterator@PEA.c)
