        ...
        _QWORD *a4)
{
  ...
  while ( v4 != v6 )
  {
    v8 = detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::reserve_region(
           a4,
           0x8F5C28F5C28F5C29uLL * ((__int64)(a4[1] - *a4) >> 4),
           1LL);
