/*
 * XREFs of ??0CVisualTree@@IEAA@PEAVCComposition@@PEAVCVisual@@@Z @ 0x180205AE0
 * Callers:
 ...
 * Callees:
 *     ??0CTreeDirty@@QEAA@PEAVCVisualTree@@@Z @ 0x18024FA2C (--0CTreeDirty@@QEAA@PEAVCVisualTree@@@Z.c)
 */
