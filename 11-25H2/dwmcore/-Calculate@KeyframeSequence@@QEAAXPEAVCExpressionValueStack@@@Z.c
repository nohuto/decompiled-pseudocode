/*
 * XREFs of ?Calculate@KeyframeSequence@@QEAAXPEAVCExpressionValueStack@@@Z @ 0x1800D18A0
 * Callers:
 ...
 *     ?EvaluateCurveAndDerivative@CubicBezierInterpolation@@IEAAXNNNPEAN0@Z @ 0x1800D22F0 (-EvaluateCurveAndDerivative@CubicBezierInterpolation@@IEAAXNNNPEAN0@Z.c)
...
void __fastcall KeyframeSequence::Calculate(KeyframeSequence *this, struct CExpressionValueStack *a2)
{
  ...
  float *v28; // rdi
  __int64 (__fastcall *v29)(__int64, float, unsigned int, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *); // rdx
...
LABEL_39:
  v28 = *(float **)(v21 + 16);
  v29 = *(__int64 (__fastcall **)(__int64, float, unsigned int, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *))(*(_QWORD *)v28 + 32LL);
  v30 = *(_DWORD *)(*(_QWORD *)(v22 + 8) + 16LL);
  if ( v29 == CubicBezierInterpolation::Compute )
  {
    v31 = 0;
    v32 = 0LL;
    *(double *)&v32 = v9;
  ...
  {
    ((void (__fastcall *)(float *, __int64 (__fastcall *)(__int64, float, unsigned int, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *, struct _D3DCOLORVALUE *), _QWORD, _OWORD *, _OWORD *, __int128 *))v29)(
      v28,
      v29,
      v30,
      v90,
