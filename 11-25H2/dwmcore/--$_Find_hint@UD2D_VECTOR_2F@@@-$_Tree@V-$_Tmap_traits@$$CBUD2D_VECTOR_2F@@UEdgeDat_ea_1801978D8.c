/*
 * XREFs of ??$_Find_hint@UD2D_VECTOR_2F@@@?$_Tree@V?$_Tmap_traits@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@UCompareEdgeDirection@3@V?$allocator@U?$pair@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@@std@@@std@@$0A@@std@@@std@@IEBA?AU?$_Tree_find_hint_result@PEAU?$_Tree_node@U?$pair@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@@std@@PEAX@std@@@1@QEAU?$_Tree_node@U?$pair@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@@std@@PEAX@1@AEBUD2D_VECTOR_2F@@@Z @ 0x1801978D8
 * Callers:
 ...
 *     ??F?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUD2D_VECTOR_2F@@UEdgeData@?$CConvexPolygonEdgeMap@I@@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x180294034 (--F-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@U-$pair@$$CBUD2D_VECTOR_2.c)
 */
        ...
        float *a4)
{
  ...
  if ( *(_BYTE *)(a3 + 25) )
  {
    v9 = v4 + 2;
    if ( *(_BYTE *)(v4[1] + 25LL)
      || CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection::operator()((__int64)a1, (float *)(*v9 + 28LL), a4) )
    {
      *(_QWORD *)a2 = *v9;
      *(_BYTE *)(a2 + 16) = 0;
LABEL_25:
  ...
  if ( a3 != *v4 )
  {
    if ( CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection::operator()((__int64)a1, a4, v11) )
    {
      v23 = a3;
      v13 = *(_QWORD *)std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<D2D_VECTOR_2F const,CConvexPolygonEdgeMap<unsigned int>::EdgeData>>>,std::_Iterator_base0>::operator--(&v23);
      if ( !CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection::operator()(v14, (float *)(v13 + 28), a4) )
        goto LABEL_18;
      v15 = *(_BYTE *)(*(_QWORD *)(v13 + 16) + 25LL) == 0;
      *(_BYTE *)(a2 + 16) = 0;
      if ( !v15 )
      {
        *(_QWORD *)a2 = v13;
...
LABEL_14:
    ...
    if ( CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection::operator()(v12, v10, a4) )
    {
      v23 = a3;
      v17 = *std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<CProjectedShadowCaster * const,wil::com_ptr_t<CProjectedShadow,wil::err_returncode_policy>>>>,std::_Iterator_base0>::operator++(&v23);
      if ( !*(_BYTE *)(v17 + 25)
        && !CConvexPolygonEdgeMap<unsigned int>::CompareEdgeDirection::operator()(v16, a4, (float *)(v17 + 28)) )
      {
        goto LABEL_18;
      }
      v15 = *(_BYTE *)(*(_QWORD *)(a3 + 16) + 25LL) == 0;
      *(_BYTE *)(a2 + 16) = 0;
      if ( v15 )
      {
        *(_QWORD *)a2 = v17;
