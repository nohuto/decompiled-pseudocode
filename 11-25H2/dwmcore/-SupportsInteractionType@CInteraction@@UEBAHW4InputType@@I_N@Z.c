/*
 * XREFs of ?SupportsInteractionType@CInteraction@@UEBAHW4InputType@@I_N@Z @ 0x1801DE070
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::GetTemporaryConfigWithMask @ 0x1801E5174 (_anonymous_namespace_--GetTemporaryConfigWithMask.c)
 *     ?ConfigurationListContainsType@?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@QEBAHIU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@0@Z @ 0x180262ED8 (-ConfigurationListContainsType@-$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive.c)
 */
