/*
 * XREFs of ??$InteractionConfigurationUpdate@UDwmTouchpadInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x1801C95D0
 * Callers:
        ...
        unsigned int *a1)
{
  ...
  int v58; // r8d
  int v59; // r9d
  BOOL v61; // [rsp+130h] [rbp-80h] BYREF
  int v62; // [rsp+134h] [rbp-7Ch] BYREF
  int v63; // [rsp+138h] [rbp-78h] BYREF
  BOOL v64; // [rsp+13Ch] [rbp-74h] BYREF
  void *InputHandle; // [rsp+140h] [rbp-70h] BYREF
  unsigned int v66; // [rsp+148h] [rbp-68h] BYREF
  unsigned int v67; // [rsp+14Ch] [rbp-64h] BYREF
  BOOL v68; // [rsp+150h] [rbp-60h] BYREF
  __int64 v69; // [rsp+158h] [rbp-58h] BYREF
  __int64 v70; // [rsp+160h] [rbp-50h] BYREF
  __int64 v71; // [rsp+168h] [rbp-48h] BYREF
  const char *v72; // [rsp+170h] [rbp-40h] BYREF
  const char *v73; // [rsp+178h] [rbp-38h] BYREF
  __int64 v74; // [rsp+180h] [rbp-30h] BYREF
  __int64 v75; // [rsp+188h] [rbp-28h] BYREF
  __int64 v76; // [rsp+190h] [rbp-20h] BYREF
  const char *v77; // [rsp+198h] [rbp-18h] BYREF
  const char *v78; // [rsp+1A0h] [rbp-10h] BYREF
  const char *v79; // [rsp+1A8h] [rbp-8h] BYREF
  const char *v80; // [rsp+1B0h] [rbp+0h] BYREF
  const char *v81; // [rsp+1B8h] [rbp+8h] BYREF
  const char *v82; // [rsp+1C0h] [rbp+10h] BYREF
  const char *v83; // [rsp+1C8h] [rbp+18h] BYREF
  const char *v84; // [rsp+1D0h] [rbp+20h] BYREF
  const char *v85; // [rsp+1D8h] [rbp+28h] BYREF
  const char *v86; // [rsp+1E0h] [rbp+30h] BYREF
  const char *v87; // [rsp+1E8h] [rbp+38h] BYREF
  const char *v88; // [rsp+1F0h] [rbp+40h] BYREF
  const char *v89; // [rsp+1F8h] [rbp+48h] BYREF
  const char *v90; // [rsp+200h] [rbp+50h] BYREF
  int v91; // [rsp+258h] [rbp+A8h] BYREF
  unsigned int v92; // [rsp+260h] [rbp+B0h] BYREF
  int v93; // [rsp+268h] [rbp+B8h] BYREF
  ...
  if ( (_BYTE)v2 )
  {
    ...
    if ( a1[12] )
    {
      ...
      do
      {
          ...
          && (*((_QWORD *)v2 + 3) & 0x800LL) == *((_QWORD *)v2 + 3) )
        {
          ...
          v92 = *(_DWORD *)(v4 + 12LL * v5 + 4);
          v8 = a1[11];
          v93 = *(_DWORD *)(v4 + 12LL * v5);
          v9 = "StopInertia";
          if ( (v7 & 0x20000000) == 0 )
            v9 = word_180336D88;
          v77 = v9;
          ...
          if ( v28 )
            ...
            v29 = 0LL;
          v71 = v29;
          v68 = InputTraceLogging::InteractionHoverSource(v28);
          v61 = InputTraceLogging::InteractionInputTransparency(v30);
          v62 = InputTraceLogging::InteractionFurtherProcessingForInput(v31);
          if ( v32 )
            v33 = *(_BYTE *)(v32 + 200) & 1;
          else
            v33 = 0;
          ...
          v64 = v34;
          v72 = InputTraceLogging::InteractionDefaultToString((const struct CInteraction *)v32);
          v36 = InputTraceLogging::InteractionSourceTypeToString(v35);
          v37 = *a1;
          v73 = v36;
          v74 = v38;
          v75 = v38;
          v76 = InputTraceLogging::MidManipulationUpdateTypeToString(v37);
    ...
    else
    {
        ...
        && (*((_QWORD *)v2 + 3) & 0x800LL) == *((_QWORD *)v2 + 3) )
      {
        v42 = a1[11];
        v92 = a1[12];
        v43 = InputTraceLogging::InteractionInputTypeToString(v42, v41, v2);
        v44 = a1[10];
        v76 = v43;
        v47 = InputTraceLogging::InteractionConfigurationUpdateTypeToString(v44, v45, v46);
        ...
        if ( v48 )
          ...
          v49 = 0LL;
        v74 = v49;
        v93 = InputTraceLogging::InteractionHoverSource(v48);
        v64 = InputTraceLogging::InteractionInputTransparency(v50);
        v63 = InputTraceLogging::InteractionFurtherProcessingForInput(v51);
        if ( v52 )
          v53 = *(_BYTE *)(v52 + 200) & 1;
        else
          v53 = 0;
        ...
        {
          v91 = *(_DWORD *)(v52 + 196);
          InputHandle = CInteraction::GetInputHandle((CInteraction *)v52);
          v3 = *(_DWORD *)(v52 + 1720);
        }
        else
        {
        ...
        v61 = v3;
        v73 = InputTraceLogging::InteractionDefaultToString((const struct CInteraction *)v52);
        v55 = InputTraceLogging::InteractionSourceTypeToString(v54);
        v56 = *a1;
        v72 = v55;
        v71 = v57;
        v70 = v57;
        v69 = InputTraceLogging::MidManipulationUpdateTypeToString(v56);
