/*
 * XREFs of ?Create@CD3DSurface@@SAJPEAVCD3DResourceManager@@AEBVDWM_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAPEAV1@@Z @ 0x1802D1A0C
 * Callers:
        ...
        struct CD3DSurface **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ED30, 0xAu, v6, 0x47u, 0LL);
  }
  else
  {
    ...
    v9 = ViewOfTexture;
    if ( ViewOfTexture < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ED30, 0xAu, ViewOfTexture, 0x4Du, 0LL);
  }
