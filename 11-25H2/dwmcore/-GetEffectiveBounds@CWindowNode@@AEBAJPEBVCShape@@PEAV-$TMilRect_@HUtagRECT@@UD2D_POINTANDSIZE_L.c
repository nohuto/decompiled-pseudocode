/*
 * XREFs of ?GetEffectiveBounds@CWindowNode@@AEBAJPEBVCShape@@PEAV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEA_N@Z @ 0x180057A60
 * Callers:
...
__int64 __fastcall CWindowNode::GetEffectiveBounds(__int64 a1, __int64 *a2, int *a3, char *a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  if ( (char *)v11 != (char *)CRegionShape::GetTightBounds )
  {
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x1B2u, 0LL);
      return v8;
    }
    goto LABEL_44;
  }
