/*
 * XREFs of ?AddCpuClipAntialiasDrawList@CDrawingContext@@QEAAJPEAVCDrawListEntry@@@Z @ 0x180095260
 * Callers:
...
LABEL_21:
  ...
  if ( v35 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x3DFu, 0LL);
    return v90;
  }
  v36 = *((_QWORD *)this + 413);
  v96 = 0LL;
