/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAUEffectInput@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAUEffectInput@@@stdext@@_J@Z @ 0x180255E94
 * Callers:
