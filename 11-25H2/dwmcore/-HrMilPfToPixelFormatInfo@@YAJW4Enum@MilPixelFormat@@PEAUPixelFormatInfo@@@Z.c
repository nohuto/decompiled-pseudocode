/*
 * XREFs of ?HrMilPfToPixelFormatInfo@@YAJW4Enum@MilPixelFormat@@PEAUPixelFormatInfo@@@Z @ 0x1801DD250
 * Callers:
 ...
 *     ?PixelFormatToDXGIFormat@@YA?AW4DXGI_FORMAT@@W4Enum@MilPixelFormat@@PEA_N@Z @ 0x1801DD378 (-PixelFormatToDXGIFormat@@YA-AW4DXGI_FORMAT@@W4Enum@MilPixelFormat@@PEA_N@Z.c)
 *     ?GetPixelFormatColorSpace@@YAJW4Enum@MilPixelFormat@@PEAW4ColorSpace@@@Z @ 0x1801DD3CC (-GetPixelFormatColorSpace@@YAJW4Enum@MilPixelFormat@@PEAW4ColorSpace@@@Z.c)
 *     ?HasAlphaChannel@@YAHW4Enum@MilPixelFormat@@@Z @ 0x1801DD448 (-HasAlphaChannel@@YAHW4Enum@MilPixelFormat@@@Z.c)
 */
