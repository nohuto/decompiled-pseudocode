/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAURampEntry@CoordMap@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAURampEntry@CoordMap@@@stdext@@_J@Z @ 0x180125180
 * Callers:
