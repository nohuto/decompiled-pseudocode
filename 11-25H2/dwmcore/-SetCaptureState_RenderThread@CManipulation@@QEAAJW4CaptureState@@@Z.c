/*
 * XREFs of ?SetCaptureState_RenderThread@CManipulation@@QEAAJW4CaptureState@@@Z @ 0x1801BC7BC
 * Callers:
...
__int64 __fastcall CManipulation::SetCaptureState_RenderThread(CManipulation *a1, int a2)
{
  ...
  else
  {
    ...
    LODWORD(v9) = a2;
    v11 = a1;
    v7 = CoreUICallSend(v5, &v12, 1LL, 9LL, 1, &unk_180336E89, (unsigned int)&v11, v9, v10);
    v6 = v7;
    if ( v7 < 0 )
