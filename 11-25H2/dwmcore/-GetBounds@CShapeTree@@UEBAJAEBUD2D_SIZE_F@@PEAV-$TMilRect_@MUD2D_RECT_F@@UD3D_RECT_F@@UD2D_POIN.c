/*
 * XREFs of ?GetBounds@CShapeTree@@UEBAJAEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18007A280
 * Callers:
...
__int64 __fastcall CShapeTree::GetBounds(__int64 a1, float *a2, float *a3)
{
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x2Fu, 0LL);
      operator delete(v21);
      return v6;
    }
    operator delete(v21);
