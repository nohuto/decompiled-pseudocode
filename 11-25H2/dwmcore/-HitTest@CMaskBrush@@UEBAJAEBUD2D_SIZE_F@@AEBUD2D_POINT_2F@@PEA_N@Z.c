/*
 * XREFs of ?HitTest@CMaskBrush@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x18007B640
 * Callers:
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v7 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xD6u, 0LL);
    }
    else if ( *((_QWORD *)this + 14) && *a4 )
    {
      *a4 = 0;
      ...
      v4 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0xDCu, 0LL);
    }
  }
  return v4;
}
