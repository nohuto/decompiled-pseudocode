        ...
        _QWORD *a3)
{
  ...
  std::_Destroy_range<std::allocator<std::unique_ptr<CD2DBitmapCache::CCachedBitmap>>>((__int64)a3, (__int64)a3);
  return a3;
}
