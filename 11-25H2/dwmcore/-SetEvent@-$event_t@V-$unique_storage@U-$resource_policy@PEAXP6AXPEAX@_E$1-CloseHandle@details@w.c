/*
 * XREFs of ?SetEvent@?$event_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEBAXXZ @ 0x1800ADF5C
 * Callers:
 ...
 *     ?ResetMmcss@CGlobalMit@@UEAAJXZ @ 0x18022D590 (-ResetMmcss@CGlobalMit@@UEAAJXZ.c)
