/*
 * XREFs of ?ProcessUpdate@CCompiledEffectTemplate@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPILEDEFFECTTEMPLATE@@@Z @ 0x18013B3FC
 * Callers:
        ...
        const struct tagMILCMD_COMPILEDEFFECTTEMPLATE *a3)
{
  ...
  if ( this[10] )
  {
    ...
    v17 = 36;
  ...
  else if ( HANDLE_TABLE::ValidEntry((struct CResourceTable *)((char *)a2 + 16), *((_DWORD *)a3 + 2))
         ...
         && ((v10 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v9 + 64LL), v10 == CKeyframeAnimation::IsOfType)
           ? (v11 = CKeyframeAnimation::IsOfType(v9, 156))
           : v10 != CVisual::IsOfType
           ? (v10 != CSharedSection::IsOfType
            ? (v11 = v10(v9, 156))
            : (v11 = CSharedSection::IsOfType(v9, 156)))
           : (v11 = CVisual::IsOfType(v9, 156)),
  ...
  {
    v18 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this[3] + 802) + 72LL))(
            *((_QWORD *)this[3] + 802),
            5LL);
    if ( v18 )
    {
      ...
      v22 = CoreUICallSend(v18, v23, 2LL, 5LL, 1, &unk_180336E5D, v19, v21, ChannelCallbackId);
      v14 = v22;
      if ( v22 < 0 )
