        ...
        _QWORD *a3)
{
  ...
  {
    std::_Hash<std::_Uset_traits<CBaseExpression *,std::_Uhash_compare<CBaseExpression *,std::hash<CBaseExpression *>,std::equal_to<CBaseExpression *>>,std::allocator<CBaseExpression *>,0>>::_Check_max_size((__int64)a1);
    v9 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x18uLL);
    v9[2] = *a3;
