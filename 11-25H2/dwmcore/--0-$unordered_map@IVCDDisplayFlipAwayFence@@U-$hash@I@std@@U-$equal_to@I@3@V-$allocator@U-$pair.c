/*
 * XREFs of ??0?$unordered_map@IVCDDisplayFlipAwayFence@@U?$hash@I@std@@U?$equal_to@I@3@V?$allocator@U?$pair@$$CBIVCDDisplayFlipAwayFence@@@std@@@3@@std@@QEAA@XZ @ 0x1802CA498
 * Callers:
