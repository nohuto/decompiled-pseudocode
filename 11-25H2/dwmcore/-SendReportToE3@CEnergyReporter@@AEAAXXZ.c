/*
 * XREFs of ?SendReportToE3@CEnergyReporter@@AEAAXXZ @ 0x18018086C
 * Callers:
...
void __fastcall CEnergyReporter::SendReportToE3(CEnergyReporter *this)
{
  ...
  if ( *((_DWORD *)this + 10) )
  {
    ...
    if ( *((_BYTE *)this + 80) )
    {
      if ( *((_BYTE *)this + 81) )
      {
        if ( (unsigned int)dword_180404C34 < MEMORY[0x7FFE037C] && !(unsigned __int8)EtwCheckCoverage(&off_180404C28) )
          NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_180404C28, 0x18u);
      }
    ...
    *((_DWORD *)this + 16) = 0;
    ...
    if ( v5 < 0
      && (unsigned int)dword_180404C4C < MEMORY[0x7FFE037C]
      && !(unsigned __int8)EtwCheckCoverage(&off_180404C40) )
    {
      NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_180404C40, 0x18u);
    }
    *((_DWORD *)this + 10) = 0;
  }
}
