/*
 * XREFs of ?CreateHitTestRegions@CPrimitiveGroup@@AEBAJXZ @ 0x180079314
 * Callers:
 ...
 *     ?Transform2DBounds@MILMatrix3x2@@QEBAXAEBUD2D_RECT_F@@AEAU2@@Z @ 0x180077D8C (-Transform2DBounds@MILMatrix3x2@@QEBAXAEBUD2D_RECT_F@@AEAU2@@Z.c)
 *     ?IsPixelAligned@@YA_NAEBUD2D_RECT_F@@@Z @ 0x180077EC4 (-IsPixelAligned@@YA_NAEBUD2D_RECT_F@@@Z.c)
 *     ?Is2DAxisAlignedPreservingApprox@MILMatrix3x2@@QEBA_NXZ @ 0x180077FA0 (-Is2DAxisAlignedPreservingApprox@MILMatrix3x2@@QEBA_NXZ.c)
 ...
 *     ?CurrentItem@?$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEAAPEBUD2D1_COMPOSITOR_DRAWING_STATE@@XZ @ 0x1802AB6B0 (-CurrentItem@-$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEAAPEBUD.c)
 *     ?HasMore@?$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEBA_NXZ @ 0x1802AB890 (-HasMore@-$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEBA_NXZ.c)
 *     ?HasMore@?$DataIterator@$$CBUD2D1_COMPOSITOR_PRIMITIVE_DRAWING_STATE@@$0JE@@CPrimitiveGroup@@QEBA_NXZ @ 0x1802AB8A8 (-HasMore@-$DataIterator@$$CBUD2D1_COMPOSITOR_PRIMITIVE_DRAWING_STATE@@$0JE@@CPrimitiveGroup@@QEB.c)
 *     ?Step@?$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEAAXXZ @ 0x1802AB98C (-Step@-$DataIterator@$$CBUD2D1_COMPOSITOR_DRAWING_STATE@@$0JA@@CPrimitiveGroup@@QEAAXXZ.c)
 *     ?Step@?$DataIterator@$$CBUD2D1_COMPOSITOR_PRIMITIVE_DRAWING_STATE@@$0JE@@CPrimitiveGroup@@QEAAXXZ @ 0x1802AB99C (-Step@-$DataIterator@$$CBUD2D1_COMPOSITOR_PRIMITIVE_DRAWING_STATE@@$0JE@@CPrimitiveGroup@@QEAAXX.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x180301010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

// local variable allocation has failed, the output may be wrong!
__int64 __fastcall CPrimitiveGroup::CreateHitTestRegions(CResource **this, __int64 a2, double a3)
{
  char v4; // r12
  unsigned int v5; // ebx
  CResource *v6; // rsi
  ...
  CGlobalDrawingContext *v92; // [rsp+50h] [rbp-B8h] BYREF
  ...
  _QWORD v97[3]; // [rsp+A8h] [rbp-60h] BYREF
  ...
  v4 = 0;
  v5 = 0;
  DynArrayIA<TMilRect_<int,tagRECT,D2D_POINTANDSIZE_L,Mil3DRectL,RectUniqueness::_CMilRectL_>,16,0>::DynArrayIA<TMilRect_<int,tagRECT,D2D_POINTANDSIZE_L,Mil3DRectL,RectUniqueness::_CMilRectL_>,16,0>(v100);
  v92 = 0LL;
  v93 = 0LL;
  ReleaseInterface<ID2D1Geometry>(this + 11);
  ReleaseInterface<ID2D1Geometry>(this + 12);
  v6 = this[63];
  v7 = (CResource *)((char *)this[64] + (_QWORD)v6);
  while ( v6 < v7 )
  {
    v40 = (CResource *)((char *)v6 + 16);
    v41 = (const struct D2D_RECT_F *)v6;
    v6 = (CResource *)((char *)v6 + 17);
    if ( v40 > v7 || v6 > v7 )
    {
      v89 = 865;
      goto LABEL_20;
...
LABEL_58:
      ...
      *((_QWORD *)&v95 + 1) = __PAIR64__(v50, v78);
      ...
      v86 = DynArrayImpl<0>::AddMultipleAndSet(v100, 16LL, 1LL, &v95);
      v29 = v86;
      v5 = v86;
      if ( v86 < 0 )
      {
        ...
        v88 = 192;
LABEL_118:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v87, v88, 0LL);
        v89 = 946;
        goto LABEL_54;
      }
      goto LABEL_91;
...
LABEL_88:
      ...
      v68 = DynArrayImpl<0>::AddMultipleAndSet(v100, 16LL, 1LL, v96);
      v29 = v68;
      v5 = v68;
      if ( v68 < 0 )
      {
...
LABEL_95:
      if ( !v92 )
      {
        v52 = (*(__int64 (__fastcall **)(__int64, CGlobalDrawingContext **))(*(_QWORD *)g_DeviceManager + 80LL))(
                g_DeviceManager,
                &v92);
        v5 = v52;
        if ( v52 < 0 )
        ...
        v52 = (*(__int64 (__fastcall **)(CGlobalDrawingContext *, struct ID2D1GeometrySink **))(*(_QWORD *)v92 + 136LL))(
                v92,
                &v93);
        v5 = v52;
        if ( v52 < 0 )
...
LABEL_53:
            ...
            if ( v28 > v101 )
            {
              v51 = DynArrayImpl<0>::AddMultipleAndSet(v100, 16LL, 1LL, &v95);
              v29 = v51;
              v5 = v51;
              if ( v51 < 0 )
              {
...
LABEL_122:
          v18 = v52;
LABEL_21:
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, v89, 0LL);
          goto LABEL_16;
        }
        v52 = (*(__int64 (__fastcall **)(CGlobalDrawingContext *, struct ID2D1GeometrySink **))(*(_QWORD *)v92 + 136LL))(
                v92,
...
LABEL_8:
  ...
  if ( v102 )
  {
    v97[0] = &CRegionShape::`vftable';
    v97[1] = 0LL;
    v97[2] = &v98;
    v98 = 0;
    v99 = 0LL;
    CRegionShape::BuildFromRects((__int64)v97, v100[0], v102);
    D2DGeometry = CRegionShape::GetD2DGeometry((CRegionShape *)v97, 0LL, this + 11);
    v5 = D2DGeometry;
    if ( D2DGeometry < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D2DGeometry, 0x471u, 0LL);
...
LABEL_16:
  ...
  DynArrayImpl<0>::~DynArrayImpl<0>(v100);
  return v5;
}
