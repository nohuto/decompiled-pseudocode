/*
 * XREFs of ??0?$_Hash@V?$_Uset_traits@PEAVIBatchProcessingCompleteListener@@V?$_Uhash_compare@PEAVIBatchProcessingCompleteListener@@U?$hash@PEAVIBatchProcessingCompleteListener@@@std@@U?$equal_to@PEAVIBatchProcessingCompleteListener@@@3@@std@@V?$allocator@PEAVIBatchProcessingCompleteListener@@@3@$0A@@std@@@std@@IEAA@AEBV?$_Uhash_compare@PEAVIBatchProcessingCompleteListener@@U?$hash@PEAVIBatchProcessingCompleteListener@@@std@@U?$equal_to@PEAVIBatchProcessingCompleteListener@@@3@@1@AEBV?$allocator@PEAVIBatchProcessingCompleteListener@@@1@@Z @ 0x1800FD480
 * Callers:
 *     ??0CExpressionManager@@AEAA@XZ @ 0x1800FD27C (--0CExpressionManager@@AEAA@XZ.c)
 *     ??0CAnimationTrigger@@QEAA@PEAVCComposition@@@Z @ 0x18020189C (--0CAnimationTrigger@@QEAA@PEAVCComposition@@@Z.c)
 *     ?TransitionTrue@CAnimationTrigger@@AEAAXXZ @ 0x18022C09C (-TransitionTrue@CAnimationTrigger@@AEAAXXZ.c)
 *     ??0?$unordered_set@PEAVCBaseExpression@@U?$hash@PEAVCBaseExpression@@@std@@U?$equal_to@PEAVCBaseExpression@@@3@V?$allocator@PEAVCBaseExpression@@@3@@std@@QEAA@XZ @ 0x180259F08 (--0-$unordered_set@PEAVCBaseExpression@@U-$hash@PEAVCBaseExpression@@@std@@U-$equal_to@PEAVCBase.c)
 * Callees:
 ...
 *     ??0?$list@PEAVIBatchProcessingCompleteListener@@V?$allocator@PEAVIBatchProcessingCompleteListener@@@std@@@std@@QEAA@AEBV?$allocator@PEAVIBatchProcessingCompleteListener@@@1@@Z @ 0x1800FD4E4 (--0-$list@PEAVIBatchProcessingCompleteListener@@V-$allocator@PEAVIBatchProcessingCompleteListene.c)
 */
