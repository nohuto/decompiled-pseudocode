/*
 * XREFs of ?Channel_CreateResource@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_CREATERESOURCE@@@Z @ 0x180110380
 * Callers:
...
LABEL_13:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x5D4u, 0LL);
    goto LABEL_33;
  }
  *((_QWORD *)v24 + 1) = v33;
