/*
 * XREFs of ?QueryInterface@CChannel@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18026E9F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::QueryInterface(CChannel *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( !v4 )
      goto LABEL_13;
    v5 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_60238e60_16c7_4f55_ad9f_e880756c1c41.Data1;
    if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_60238e60_16c7_4f55_ad9f_e880756c1c41.Data1 )
      v5 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_60238e60_16c7_4f55_ad9f_e880756c1c41.Data4;
    if ( !v5 )
      goto LABEL_13;
