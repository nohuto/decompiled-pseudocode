/*
 * XREFs of ?RenderLayer@CTreeEffectLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x1800298B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z @ 0x18002900C (-IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z.c)
...
__int64 __fastcall CTreeEffectLayer::RenderLayer(CTreeEffectLayer *this, struct CDrawingContext *a2)
{
  ...
  v90 = 0;
  v5 = 0;
  if ( !v2 || (v6 = *(CDropShadow **)(v2 + 672), (*(_QWORD *)&v100.left = v6) == 0LL) )
  {
    top = *((float *)this + 58);
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x209u, 0LL);
      return v19;
    }
LABEL_16:
    if ( !v5 )
  ...
  if ( !CDrawingContext::IsSurfaceSizeValid(a2, (int)v26, (int)v28) )
  {
    ...
    if ( v65 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v65, 0x12Cu, 0LL);
      return v19;
    }
...
LABEL_22:
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x132u, 0LL);
      if ( v81 )
    ...
    if ( MaskForLayerVisualNoRef )
    {
      ...
      if ( *(float *)(v34 + 144) != 0.0 && v40 != 0.0 )
      {
        ...
        if ( v73 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v73, 0x142u, 0LL);
LABEL_26:
          if ( v81 )
            (*(void (__fastcall **)(struct IRenderTargetBitmap *))(*(_QWORD *)v81 + 16LL))(v81);
          goto LABEL_28;
        ...
        *(_OWORD *)v91 = _xmm;
        ...
        if ( v77 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v77, 0x156u, 0LL);
        }
        else
        {
          v5 = 2;
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v78, 0x15Bu, 0LL);
        }
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v81);
        do
        {
...
LABEL_65:
    ...
    else
    {
      ...
      *(_OWORD *)v91 = _xmm;
      ...
      if ( v39 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v39, 0x181u, 0LL);
        goto LABEL_26;
      }
    }
LABEL_33:
    ...
    if ( v46 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v46, 0x196u, 0LL);
      Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v81);
      return v19;
    }
    v47 = v81;
    ...
    if ( v48 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v48, 0x1A2u, 0LL);
    }
    else
    {
      v90 = 10666;
      ...
      if ( MaskForLayerVisualNoRef )
      {
        ...
        if ( *(_BYTE *)(v55 + 697) )
        {
          ...
          if ( v80 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v80, 0x1BEu, 0LL);
            Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v81);
LABEL_70:
            v32 = 0;
            goto LABEL_28;
        ...
        if ( v64 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v64, 0x1D2u, 0LL);
          Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v81);
          goto LABEL_16;
        }
        goto LABEL_43;
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v49, 0x1E3u, 0LL);
      }
      else
      {
        v5 = 2;
...
LABEL_43:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v50, 0x1E6u, 0LL);
      }
    }
    if ( v47 )
      (*(void (__fastcall **)(struct IRenderTargetBitmap *))(*(_QWORD *)v47 + 16LL))(v47);
...
LABEL_21:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v79, 0x122u, 0LL);
  if ( v81 )
    (*(void (__fastcall **)(struct IRenderTargetBitmap *))(*(_QWORD *)v81 + 16LL))(v81);
  return v19;
}
