/*
 * XREFs of ?OpenIndirectSwapchain@CD3DDevice@@QEAAJPEAX0W4DXGI_INTERNAL_INDIRECT_SWAP_CHAIN_FLAG@@KPEAPEAUIDXGIIndirectSwapChain@@@Z @ 0x1802C3E94
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  *a6 = 0LL;
  if ( !*(_DWORD *)(a1 + 1112) )
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(**(_QWORD **)(a1 + 536) + 56LL))(*(_QWORD *)(a1 + 536), &v16);
    v9 = v10;
    if ( v10 < 0 )
    {
      v15 = 875;
  ...
  v9 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304307, 0x369u, 0LL);
LABEL_12:
