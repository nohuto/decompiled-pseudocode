/*
 * XREFs of ?CleanTreeState@CManipulationContext@@SAXPEAVCInteraction@@PEAV1@PEAVCComposition@@_NW4InputType@@@Z @ 0x1800FA6AC
 * Callers:
...
void __fastcall CManipulationContext::CleanTreeState(CInteraction *a1, __int64 a2, __int64 a3, char a4, int a5)
{
  CInteraction *v9; // rbx
  char v10; // bp
  __int64 v11; // rsi
  ...
  v10 = 1;
  if ( !a4 )
    CTreeLock::AcquireShared((CTreeLock *)(a3 + 5704));
  v11 = a5;
  while ( v9 )
  {
    v13 = *((_QWORD *)v9 + 28);
    ...
    if ( (unsigned int)(v11 - 1) > 5 )
      v14 = 0LL;
    --*((_DWORD *)v9 + v14 + 64);
    if ( !CInteraction::GetTotalNumContacts(v9) )
    {
    ...
    Microsoft::WRL::ComPtr<CVisual>::operator=(&v18, v13);
    v9 = v18;
  }
  v12 = v19;
  if ( a1 )
  ...
  if ( !v12 )
    CTreeLock::ReleaseShared((CTreeLock *)(a3 + 5704));
}
