/*
 * XREFs of ?GetSize@CWICBitmapWrapper@@UEBA?AUD2D_SIZE_U@@XZ @ 0x18018BEC0
 * Callers:
 ...
 * Callees:
 *     ?GetSize@CCompressedSourceBitmap@@WCA@EAAJPEAI0@Z @ 0x180260DF0 (-GetSize@CCompressedSourceBitmap@@WCA@EAAJPEAI0@Z.c)
