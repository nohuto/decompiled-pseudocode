/*
 * XREFs of ?Grow@?$CWatermarkStack@PEAX$01$01$09@@AEAAJ_KIIPEAPEAX@Z @ 0x180185C98
 * Callers:
...
__int64 __fastcall CWatermarkStack<void *,2,2,10>::Grow(__int64 a1, void *a2, __int64 a3, __int64 a4, const void **a5)
{
...
LABEL_4:
  ...
  v15 = 0LL;
  v8 = HrMalloc(8uLL, (unsigned int)v6, &v15);
  if ( v8 < 0 )
  {
    v7 = 104LL;
    goto LABEL_4;
