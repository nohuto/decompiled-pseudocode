/*
 * XREFs of ?EnsureStrokeStyleForRender@CSpriteVectorShape@@AEAAJXZ @ 0x18005AFDC
 * Callers:
...
__int64 __fastcall CSpriteVectorShape::EnsureStrokeStyleForRender(CSpriteVectorShape *this)
{
  ...
  if ( !*((_QWORD *)this + 17) )
  {
    ...
    *(_QWORD *)v18 = v6;
    ...
    gsl::details::extent_type<-1>::extent_type<-1>(v18, ((__int64)v10 - v12) >> 2);
    ...
    v1 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x1FFu, 0LL);
    if ( v12 )
      std::_Deallocate<16,0>(v12, ((unsigned __int64)v5 - v12) & 0xFFFFFFFFFFFFFFFCuLL);
  }
  return v1;
}
