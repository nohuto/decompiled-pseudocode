/*
 * XREFs of ?GetD2DBrush@CLinearGradientBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_RECT_F@@PEAPEAUID2D1Brush@@@Z @ 0x180012CD0
 * Callers:
...
LABEL_9:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x1DDu, 0LL);
  v16 = v29;
LABEL_10:
  if ( v16 )
  {
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xD3u, 0LL);
    if ( v9 )
