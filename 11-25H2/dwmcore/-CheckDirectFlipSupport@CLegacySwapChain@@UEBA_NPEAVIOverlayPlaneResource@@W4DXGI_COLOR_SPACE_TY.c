/*
 * XREFs of ?CheckDirectFlipSupport@CLegacySwapChain@@UEBA_NPEAVIOverlayPlaneResource@@W4DXGI_COLOR_SPACE_TYPE@@AEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@2@Z @ 0x18002DCE0
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  int v10; // r15d
  char v11; // r12
  struct IDeviceTarget *(__fastcall *v12)(CLegacySwapChain *__hidden); // rax
  struct IDeviceTarget *BackBuffer; // rax
  struct IDeviceTarget *v14; // rcx
  void (__fastcall *v15)(struct IDeviceTarget *, int *); // rax
  struct IDeviceTarget *(__fastcall *v16)(CLegacySwapChain *__hidden); // rax
  ...
  if ( *((_DWORD *)this + 16) == 2 || (v11 = 0, v10) )
    v11 = 1;
  v12 = *(struct IDeviceTarget *(__fastcall **)(CLegacySwapChain *__hidden))(*(_QWORD *)this + 104LL);
  ...
  if ( *a4 || a4[1] || a4[2] - *a4 != v31 || a4[3] - a4[1] != v32 )
    goto LABEL_27;
  v16 = *(struct IDeviceTarget *(__fastcall **)(CLegacySwapChain *__hidden))(*(_QWORD *)this + 104LL);
