/*
 * XREFs of ?Partition_SetCurrentMmTask@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_SETCURRENTMMTASK@@@Z @ 0x1800FEACC
 * Callers:
        ...
        const struct tagMILCMD_PARTITION_SETCURRENTMMTASK *a4)
{
  ...
  v15[8] = v11;
  v12 = CMmcssTask::Set((CComposition *)((char *)this + 736), (const struct DWM_MMTASK *)v15, 1);
  v13 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x43Au, 0LL);
  else
