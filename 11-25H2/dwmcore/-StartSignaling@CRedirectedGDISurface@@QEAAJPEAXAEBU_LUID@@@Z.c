/*
 * XREFs of ?StartSignaling@CRedirectedGDISurface@@QEAAJPEAXAEBU_LUID@@@Z @ 0x1801039D4
 * Callers:
...
__int64 __fastcall CRedirectedGDISurface::StartSignaling(CRedirectedGDISurface *this, void *a2, const struct _LUID *a3)
{
  ...
  if ( !(unsigned int)DwmHLSurfSetSignalOnDirty(*((_QWORD *)this + 3), a2, *a3, 1LL) )
  {
    ...
    if ( v6 >= 0 )
      v6 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803D12F8, 2u, v6, 0x100u, 0LL);
  }
