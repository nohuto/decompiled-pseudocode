/*
 * XREFs of ?CreateDDASwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCDDASwapChain@@@Z @ 0x1802C2C2C
 * Callers:
        ...
        struct CDDASwapChain **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( !*((_DWORD *)this + 278) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v14, v21, 0LL);
    goto LABEL_16;
  }
  v9 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, -2003304307, 0x2C1u, 0LL);
LABEL_16:
