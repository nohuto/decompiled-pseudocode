/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DisableInkInVRR@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18026A3BC
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DisableInkInVRR@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18026BFE8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_DisableInkInVRR@@@details@wil@@QEAAX_NW4R.c)
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisableInkInVRR>::GetCurrentFeatureEnabledState(v7, &v17, &v16);
