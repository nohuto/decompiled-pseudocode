/*
 * XREFs of ?ComputeBounds@CSpriteVectorShape@@QEAAXXZ @ 0x18007AC1C
 * Callers:
...
void __fastcall CSpriteVectorShape::ComputeBounds(CSpriteVectorShape *this)
{
  ...
  CRoundedRectangleShape *v16; // [rsp+30h] [rbp-28h] BYREF
  ...
  *((_WORD *)this + 48) = 0;
  ...
  v17 = 0;
  if ( v2 )
    CGeometry::GetShapeData(v2, 0LL, (struct CShapePtr *)&v16);
  if ( !CShapePtr::IsEmpty(&v16) )
  {
    ...
    if ( *((_QWORD *)this + 14) && (int)CSpriteVectorShape::EnsureStrokeStyleForBounds(this) >= 0 )
    {
      ...
      if ( v16 )
      {
        ...
        v14 = WidenedBounds;
        if ( WidenedBounds < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, WidenedBounds, 0x150u, 0LL);
      }
      *((_BYTE *)this + 97) = v14 >= 0;
    }
    if ( *((_BYTE *)this + 97)
      ...
      && (v4 = (int)CShapePtr::GetTightBounds(&v16, (__int64)this + 80, 0LL) >= 0, (*((_BYTE *)this + 97) = v4) != 0) )
    {
      ...
      *((float *)this + 23) = v12;
      if ( v16 )
      {
        ...
        v3 = v13;
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x150u, 0LL);
      }
      *((_BYTE *)this + 97) = v3 >= 0;
    }
  }
