/*
 * XREFs of ?SetTarget@CBaseExpression@@QEAAJIPEAVCResource@@IW4DCOMPOSITION_EXPRESSION_TYPE@@W4SubchannelMaskType@@E_K@Z @ 0x18005FFF0
 * Callers:
 ...
 *     ?SetOutputType@CBaseExpression@@MEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180060CF0 (-SetOutputType@CBaseExpression@@MEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@@Z.c)
        ...
        __int64 a8)
{
  ...
  if ( !a3 )
  {
    if ( (*(_BYTE *)(a1 + 224) & 2) != 0 )
    {
      ...
      if ( v29 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x81u, 0LL);
        return v20;
      }
    }
    else
    {
      ...
      if ( v30 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x85u, 0LL);
        return v20;
      }
    }
  }
  ...
  *(_BYTE *)(a1 + 224) = *(_BYTE *)(a1 + 224) & 0xFD | (v16 ? 2 : 0);
  if ( v17 )
  {
    ...
    {
      v20 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x2ADu, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x9Bu, 0LL);
      goto LABEL_23;
    }
  }
  else
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x9Cu, 0LL);
  }
  else
  {
    v21 = *(void **)(a1 + 200);
...
LABEL_20:
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0xB7u, 0LL);
      }
      goto LABEL_23;
    }
    if ( a6 == 2 )
    ...
    v20 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0xB1u, 0LL);
  }
LABEL_23:
  if ( v13 )
  {
