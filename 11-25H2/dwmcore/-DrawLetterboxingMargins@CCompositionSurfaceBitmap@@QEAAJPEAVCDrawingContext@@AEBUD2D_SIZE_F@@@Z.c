/*
 * XREFs of ?DrawLetterboxingMargins@CCompositionSurfaceBitmap@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x18021E6CC
 * Callers:
        ...
        struct D2D_SIZE_F *a3)
{
  ...
  if ( *((float *)&v10 + 2) > *(float *)&v10 && *((float *)&v10 + 3) > *((float *)&v10 + 1) )
  {
    ...
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x2CCu, 0LL);
  }
  return v4;
}
