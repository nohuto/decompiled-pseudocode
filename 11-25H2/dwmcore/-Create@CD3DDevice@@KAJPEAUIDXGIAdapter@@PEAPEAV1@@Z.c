/*
 * XREFs of ?Create@CD3DDevice@@KAJPEAUIDXGIAdapter@@PEAPEAV1@@Z @ 0x1801980A0
 * Callers:
 ...
 *     ??0CD3DDevice@@AEAA@_NW4D3D_FEATURE_LEVEL@@W4_QAI_DRIVERVERSION@@T_LARGE_INTEGER@@@Z @ 0x180251E4C (--0CD3DDevice@@AEAA@_NW4D3D_FEATURE_LEVEL@@W4_QAI_DRIVERVERSION@@T_LARGE_INTEGER@@@Z.c)
...
__int64 __fastcall CD3DDevice::Create(struct IDXGIAdapter *a1, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 < 0 )
  {
    v6 = 401;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v5, v6, 0LL);
    v5 = -2003304307;
    goto LABEL_4;
  }
