/*
 * XREFs of ?RenderAndPresent@CRenderTargetManager@@QEAAJXZ @ 0x18013EEDC
 * Callers:
 ...
 *     ?IsRemoteRendering@CGlobalComposition@@UEBA_NXZ @ 0x18013F1F0 (-IsRemoteRendering@CGlobalComposition@@UEBA_NXZ.c)
 ...
 *     ??1?$vector_facade@VCSortedMonitorTarget@CRenderTargetManager@@V?$buffer_impl@VCSortedMonitorTarget@CRenderTargetManager@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA@XZ @ 0x1801DEDCC (--1-$vector_facade@VCSortedMonitorTarget@CRenderTargetManager@@V-$buffer_impl@VCSortedMonitorTar.c)
...
__int64 __fastcall CRenderTargetManager::RenderAndPresent(CRenderTargetManager *this)
{
  ...
  v3 = (CParallelModeGroup **)xmmword_180406940;
  ...
  *((_BYTE *)this + 744) = 1;
  ...
  else
  {
    if ( g_pComposition && *((_BYTE *)g_pComposition + 6496) )
      v13 = *((_DWORD *)g_pComposition + 1621);
    else
      v13 = 0;
    if ( v13 )
    {
      ...
      v1 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180336AF8, 3u, v14, 0xB4u, 0LL);
      v24 = v27;
      v25 = v27;
      ...
      while ( v15 != v16 )
      {
        ...
        v21 = v20;
        if ( v20 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180336AF8, 3u, v20, 0xBEu, 0LL);
        if ( !v1 || v1 >= 0 && v21 < 0 )
          v1 = v21;
        v15 += 2;
      }
  ...
  if ( !*((_BYTE *)this + 753) )
  {
    ...
    while ( v9 != v10 )
    {
      ...
      v12 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180336AF8, 3u, v11, 0xCCu, 0LL);
      if ( !v1 || v1 >= 0 && v12 < 0 )
        v1 = v12;
      ++v9;
    }
