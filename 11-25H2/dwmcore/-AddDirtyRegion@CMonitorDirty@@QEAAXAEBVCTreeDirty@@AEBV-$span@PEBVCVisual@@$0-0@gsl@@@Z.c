/*
 * XREFs of ?AddDirtyRegion@CMonitorDirty@@QEAAXAEBVCTreeDirty@@AEBV?$span@PEBVCVisual@@$0?0@gsl@@@Z @ 0x1800C9C3C
 * Callers:
 ...
 *     ?GetTreeBounds@CLegacyRenderTarget@@UEBAAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@XZ @ 0x1800CAE30 (-GetTreeBounds@CLegacyRenderTarget@@UEBAAEBV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTAND.c)
 ...
 *     ?GetRectCount@CTreeDirty@@QEBAIXZ @ 0x1801FBA30 (-GetRectCount@CTreeDirty@@QEBAIXZ.c)
 *     ?UseSuperSample@CDDisplayRenderTarget@@UEBA_NXZ @ 0x1801FD290 (-UseSuperSample@CDDisplayRenderTarget@@UEBA_NXZ.c)
 *     ?GetDeviceTransform@CDDisplayRenderTarget@@UEBAAEBVCMILMatrix@@XZ @ 0x180200AC0 (-GetDeviceTransform@CDDisplayRenderTarget@@UEBAAEBVCMILMatrix@@XZ.c)
 *     ?GetTreeBounds@CDDisplayRenderTarget@@UEBAAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@XZ @ 0x180208710 (-GetTreeBounds@CDDisplayRenderTarget@@UEBAAEBV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTA.c)
