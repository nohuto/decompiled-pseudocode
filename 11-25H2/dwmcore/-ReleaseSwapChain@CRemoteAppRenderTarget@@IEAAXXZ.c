/*
 * XREFs of ?ReleaseSwapChain@CRemoteAppRenderTarget@@IEAAXXZ @ 0x18028C21C
 * Callers:
 *     ??1CRemoteAppRenderTarget@@MEAA@XZ @ 0x18027FA30 (--1CRemoteAppRenderTarget@@MEAA@XZ.c)
 *     ?NotifyInvalidResource@CRemoteAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z @ 0x180282920 (-NotifyInvalidResource@CRemoteAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z.c)
