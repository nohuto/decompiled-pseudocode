/*
 * XREFs of ?DrawCommandAsLegacy@CRenderData@@AEAAJPEAUIDrawingContext@@W4DrawPass@1@IV?$span@$$CBE$0?0@gsl@@@Z @ 0x18000E28C
 * Callers:
          ...
          if ( v12 )
          {
            ...
            if ( v13 )
            {
              ...
              else
              {
                ...
                v5 = v20;
                if ( v20 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x36Bu, 0LL);
              }
            }
            else
            {
              ...
              v5 = v23;
              if ( v23 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x361u, 0LL);
            }
          }
          else
          {
            ...
            v5 = v27;
            if ( v27 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x358u, 0LL);
          }
        }
        else
        {
          ...
          v5 = v28;
          if ( v28 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x394u, 0LL);
        }
      }
      else
      {
        ...
        v5 = v29;
        if ( v29 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x375u, 0LL);
      }
    }
    else
    {
      ...
      v5 = v30;
      if ( v30 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x389u, 0LL);
    }
  }
  else
  {
    ...
    v5 = v31;
    if ( v31 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, 0x37Eu, 0LL);
  }
  return v5;
}
