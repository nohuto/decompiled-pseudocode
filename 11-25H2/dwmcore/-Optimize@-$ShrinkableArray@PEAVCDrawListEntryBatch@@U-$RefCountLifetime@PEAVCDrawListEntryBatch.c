/*
 * XREFs of ?Optimize@?$ShrinkableArray@PEAVCDrawListEntryBatch@@U?$RefCountLifetime@PEAVCDrawListEntryBatch@@@@@@QEAAXXZ @ 0x1800DA920
 * Callers:
    ...
    if ( (int)DynArrayImpl<0>::Grow((__int64)v11, 8u, v4, 1, 0LL) >= 0 )
    {
      ...
      if ( v3 > v4 )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            CMILRefCountBaseT<ID2D1PrivateCompositorRenderer,CMilObjectDeleter>::InternalRelease(*(void **)(v7 + *(_QWORD *)a1));
            v7 += 8LL;
            --v8;
          }
          while ( v8 );
