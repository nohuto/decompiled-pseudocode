/*
 * XREFs of ?NotifyOnChanged@CGradientBrush@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x180132580
 * Callers:
 ...
 *     ?UpdateStop@CGradientBrush@@AEAAXPEBUIUnknown@@@Z @ 0x180132654 (-UpdateStop@CGradientBrush@@AEAAXPEBUIUnknown@@@Z.c)
