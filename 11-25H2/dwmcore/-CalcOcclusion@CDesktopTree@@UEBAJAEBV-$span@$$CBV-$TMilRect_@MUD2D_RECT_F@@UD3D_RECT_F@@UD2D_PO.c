/*
 * XREFs of ?CalcOcclusion@CDesktopTree@@UEBAJAEBV?$span@$$CBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@$0?0@gsl@@PEAVCOcclusionContext@@M@Z @ 0x180082900
 * Callers:
...
{
  struct CVisualTree *v3; // r10
  struct COcclusionContext *v4; // r11
  int v5; // eax
  unsigned int v6; // ebx
  _QWORD v8[3]; // [rsp+30h] [rbp-18h] BYREF

  detail::vector_facade<CVIRenderList,detail::buffer_impl<CVIRenderList,16,1,detail::liberal_expansion_policy>>::clear(
    a1 + 4560,
    a2,
    a3,
    a2);
  v8[0] = 0LL;
  v8[1] = 0LL;
  v5 = COcclusionContext::Compute(v4, v3, (__int64)v8);
  v6 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x153u, 0LL);
  return v6;
}
