/*
 * XREFs of ?EnsureOverlaySwapChainWeakRef@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJPEAVIOverlaySwapChain@@@Z @ 0x1801E8D3C
 * Callers:
        ...
        struct IOverlaySwapChain *a2)
{
  ...
  if ( !*((_QWORD *)this + 24) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x77Au, 0LL);
    }
    else
    {
      v8 = v12;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x77Cu, 0LL);
        wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>(&v12);
        return v2;
      }
      *((_QWORD *)this + 25) = *(_QWORD *)(*(__int64 (__fastcall **)(struct IOverlaySwapChain *, char *))(*(_QWORD *)a2 + 216LL))(
                                            a2,
                                            &v13);
      *((_DWORD *)this + 52) = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 224LL))(a2);
    }
    if ( v12 )
