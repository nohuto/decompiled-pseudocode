/*
 * XREFs of ?GetPrimaryAdapter@CDisplayManager@@QEAAJPEAPEAUIDXGIAdapter1@@@Z @ 0x18003EBE0
 * Callers:
...
__int64 __fastcall CDisplayManager::GetPrimaryAdapter(CDisplayManager *this, struct IDXGIAdapter1 **a2)
{
  ...
  *a2 = 0LL;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1803363E8, 2u, v5, v7, 0LL);
  TranslateDXGIorD3DErrorInContext(v5, 4LL, &v8);
  v5 = (unsigned int)v8;
LABEL_3:
  if ( v4 )
