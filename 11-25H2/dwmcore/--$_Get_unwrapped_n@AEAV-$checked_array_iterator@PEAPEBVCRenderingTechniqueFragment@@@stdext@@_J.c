/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAPEBVCRenderingTechniqueFragment@@@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAPEBVCRenderingTechniqueFragment@@@stdext@@_J@Z @ 0x18006EB14
 * Callers:
