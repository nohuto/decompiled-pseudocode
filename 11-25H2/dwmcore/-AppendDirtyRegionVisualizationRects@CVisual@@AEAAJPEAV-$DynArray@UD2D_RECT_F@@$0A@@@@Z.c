/*
 * XREFs of ?AppendDirtyRegionVisualizationRects@CVisual@@AEAAJPEAV?$DynArray@UD2D_RECT_F@@$0A@@@@Z @ 0x180296AA8
 * Callers:
...
__int64 __fastcall CVisual::AppendDirtyRegionVisualizationRects(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x15F1u, 0LL);
      goto LABEL_25;
    }
    v35 = _xmm;
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0x15F3u, 0LL);
      goto LABEL_25;
    }
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x15F6u, 0LL);
      goto LABEL_25;
    }
    *v9 = 0LL;
    *((_DWORD *)v9 + 6) = 3;
    ...
    *((_OWORD *)v9 + 5) = v33;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x1603u, 0LL);
LABEL_23:
      operator delete(v10);
      goto LABEL_25;
    }
