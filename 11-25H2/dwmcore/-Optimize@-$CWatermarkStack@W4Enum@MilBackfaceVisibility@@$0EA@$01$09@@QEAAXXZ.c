/*
 * XREFs of ?Optimize@?$CWatermarkStack@W4Enum@MilBackfaceVisibility@@$0EA@$01$09@@QEAAXXZ @ 0x1800974CC
 * Callers:
...
void __fastcall CWatermarkStack<enum MilBackfaceVisibility::Enum,64,2,10>::Optimize(__int64 a1)
{
  int v1; // edi
  int v3; // edi
  __int64 v4; // rsi
  ...
  if ( v1 == 10 )
  {
    ...
    else if ( (unsigned int)(3 * v4) <= *(_DWORD *)(a1 + 12) )
    {
      ...
      {
        v5 = MIDL_user_allocate(4LL * (unsigned int)v4);
        if ( v5 )
        {
