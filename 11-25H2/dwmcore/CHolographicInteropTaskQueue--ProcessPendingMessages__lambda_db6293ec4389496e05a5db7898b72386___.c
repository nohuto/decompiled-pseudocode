/*
 * XREFs of CHolographicInteropTaskQueue::ProcessPendingMessages__lambda_db6293ec4389496e05a5db7898b72386___ @ 0x1802D7434
 * Callers:
  ...
  if ( result )
  {
    ...
    do
    {
      ...
      if ( *((_DWORD *)v11 + 2) == 19 )
      {
        ...
        HIDWORD(v13) = *((_DWORD *)v11 + 6);
        if ( __PAIR64__(HIDWORD(v13), (unsigned int)v7) != *(_QWORD *)(v10 + 68) )
        {
