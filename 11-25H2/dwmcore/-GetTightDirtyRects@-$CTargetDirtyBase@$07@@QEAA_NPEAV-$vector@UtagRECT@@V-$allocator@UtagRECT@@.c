/*
 * XREFs of ?GetTightDirtyRects@?$CTargetDirtyBase@$07@@QEAA_NPEAV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x180068A60
 * Callers:
...
char __fastcall CTargetDirtyBase<8>::GetTightDirtyRects(__int64 a1, _QWORD *a2)
{
  ...
  if ( **v2 )
  {
    ...
    if ( (_DWORD)v8 )
    {
      v9 = (__int64)(a2[1] - *a2) >> 4;
      v10 = v9 + (unsigned int)v8;
      if ( v10 > (__int64)(a2[2] - *a2) >> 4 )
      {
        ...
        memmove_0(v12, (const void *)*a2, a2[1] - *a2);
        if ( *a2 )
          std::_Deallocate<16,0>(*a2, (a2[2] - *a2) & 0xFFFFFFFFFFFFFFF0uLL);
        *a2 = v12;
        a2[1] = &v12[16 * v9];
        a2[2] = &v12[16 * v10];
      }
