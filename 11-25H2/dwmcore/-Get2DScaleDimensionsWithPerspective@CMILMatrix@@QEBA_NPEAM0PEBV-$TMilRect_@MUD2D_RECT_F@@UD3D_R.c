/*
 * XREFs of ?Get2DScaleDimensionsWithPerspective@CMILMatrix@@QEBA_NPEAM0PEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18016EEC0
 * Callers:
...
LABEL_4:
  ...
  else
  {
    ...
    *(float *)&v21[4] = v10;
    v21[8] = v20;
    return Matrix3x3::Get2DScaleDimensionsWithPerspective((__int64)v21, a2, a3, a4);
  }
  return result;
}
