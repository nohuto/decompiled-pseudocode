/*
 * XREFs of ?CalcContentOnTopRect@COcclusionContext@@AEBA?AV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x18009F2FC
 * Callers:
...
int *__fastcall COcclusionContext::CalcContentOnTopRect(__int64 a1, int *a2, __int64 a3)
{
  ...
  {
    v15.m128i_i32[0] = *(_DWORD *)(a1 + 600);
    *(float *)v4.m128i_i32 = v6;
  }
  v7 = *(float *)&v15.m128i_i32[1];
  v8 = *(float *)(a1 + 604);
  v9 = *(float *)&v15.m128i_i32[1];
  if ( v8 > *(float *)&v15.m128i_i32[1] )
  {
    v15.m128i_i32[1] = *(_DWORD *)(a1 + 604);
    v7 = v8;
    v9 = v8;
  }
  *(_QWORD *)&v10 = *(unsigned int *)(a1 + 608);
  *(_QWORD *)&v11 = v15.m128i_u32[2];
  if ( *(float *)&v15.m128i_i32[2] > *(float *)&v10 )
  {
    v15.m128i_i32[2] = *(_DWORD *)(a1 + 608);
    v11 = v10;
  }
  v12 = *(float *)(a1 + 612);
  v13 = *(float *)&v15.m128i_i32[3];
  if ( *(float *)&v15.m128i_i32[3] > v12 )
  {
    v15.m128i_i32[3] = *(_DWORD *)(a1 + 612);
    v13 = v12;
  }
  ...
  {
    CMILMatrix::Transform2DBoundsHelper<0>(a3, &v15, &v15);
