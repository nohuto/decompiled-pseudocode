/*
 * XREFs of ?GetHandoffData@CAnimation@@UEAA_NPEAW4Enum@DwmAnimationHandoffType@@PEAMPEA_K@Z @ 0x1801B4F60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    *a4 = *((_QWORD *)this + 12);
    ...
    {
      v14 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this - 12) + 6416LL) + 72LL))(
              *(_QWORD *)(*((_QWORD *)this - 12) + 6416LL),
              1LL);
      if ( v14 )
      {
        v15 = *((_DWORD *)this + 40);
        ...
        CoreUICallSend(v14, v17, 2LL, 1LL, 1, &unk_180336E50, v15, v16, v17[0]);
        v10 = (char *)this + 178;
      }
      *v10 = 1;
    }
