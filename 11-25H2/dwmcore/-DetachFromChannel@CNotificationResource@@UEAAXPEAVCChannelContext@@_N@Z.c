/*
 * XREFs of ?DetachFromChannel@CNotificationResource@@UEAAXPEAVCChannelContext@@_N@Z @ 0x180199220
 * Callers:
 ...
 *     ?DetachFromChannel@CCaptureRenderTarget@@UEAAXPEAVCChannelContext@@_N@Z @ 0x18022AD10 (-DetachFromChannel@CCaptureRenderTarget@@UEAAXPEAVCChannelContext@@_N@Z.c)
 *     ?DetachFromChannel@CInteractionTracker@@UEAAXPEAVCChannelContext@@_N@Z @ 0x18022D150 (-DetachFromChannel@CInteractionTracker@@UEAAXPEAVCChannelContext@@_N@Z.c)
...
void __fastcall CNotificationResource::DetachFromChannel(CNotificationResource *this, struct CChannelContext *a2)
{
  ...
  if ( v3 == (unsigned int *)a2 )
  {
    if ( v3 && v3[27] && (v5 = (_DWORD *)((char *)this + 72), *((_DWORD *)this + 18)) )
    {
      v6 = v3[27];
      v7 = (unsigned int)*v5;
      v8 = *(_QWORD ***)(*((_QWORD *)this + 3) + 6416LL);
      ...
      if ( v9 == CMessageConversationHost::FlushCallbackId )
        ...
        v9(*(CMessageConversationHost **)(*((_QWORD *)this + 3) + 6416LL), v6, v7);
    }
    else
    {
