/*
 * XREFs of ?GetNextRunningEffect@CBrushRenderingEffect@@UEAA?AV?$com_ptr_t@VCRenderingEffect@@Uerr_returncode_policy@wil@@@wil@@PEAVCRenderingEffect@@PEA_N@Z @ 0x18010DA80
 * Callers:
 ...
 *     ??9CDrawListBitmap@@QEBA_NAEBV0@@Z @ 0x1801D9800 (--9CDrawListBitmap@@QEBA_NAEBV0@@Z.c)
