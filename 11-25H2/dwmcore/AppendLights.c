/*
 * XREFs of AppendLights @ 0x180236874
 * Callers:
...
__int64 __fastcall AppendLights(__int16 a1, CShaderLinkingGraphBuilder *a2, _DWORD *a3, int a4)
{
  ...
  if ( !qword_180407248 )
  {
    v8 = D3DLoadModule(&unk_18038F3F0, 0xEE3DuLL, &qword_180407248);
    v9 = v8;
    if ( v8 < 0 )
    {
  ...
  *((_DWORD *)a2 + 20) = v15;
  if ( a4 >= 0 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v30 = 2LL;
      WORD1(v29[0]) = v16;
      v22 = LinkLightShader((_DWORD)a2, (_DWORD)a3, (_DWORD)qword_180407248, (unsigned int)&v30, 1, (__int64)v28);
      v9 = v22;
      if ( v22 < 0 )
      {
  ...
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v30 = 1LL;
      v28[0] = 0;
      LOWORD(v29[0]) = v16;
      v18 = LinkLightShader((_DWORD)a2, (_DWORD)a3, (_DWORD)qword_180407248, (unsigned int)&v30, 0, (__int64)v28);
      v9 = v18;
      if ( v18 < 0 )
      {
