/*
 * XREFs of ?GetSourceInputBoundsUnion@CEffectBrush@@QEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@PEAV2@@Z @ 0x18025A544
 * Callers:
...
__int64 __fastcall CEffectBrush::GetSourceInputBoundsUnion(__int64 a1, const __m128i *a2, __int64 a3, float *a4)
{
  ...
  *(_OWORD *)a4 = DirectX::g_XMZero;
  if ( *(_QWORD *)(a1 + 128) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, SourceInputBounds, 0x29Eu, 0LL);
    }
    else if ( v14 )
    {
      v7 = (float *)v11;
