/*
 * XREFs of ?TransformCoordinateSpace@CInteractionContextTransformHelper@@SAJPEBUtagRECT@@0PEAUINTERACTION_UPDATE@@1@Z @ 0x18017864C
 * Callers:
 ...
 * Callees:
 *     TransformPoint @ 0x180178794 (TransformPoint.c)
 */
