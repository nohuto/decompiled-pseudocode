/*
 * XREFs of ??4OverlayPlaneInfo@COverlayContext@@QEAAAEAV01@$$QEAV01@@Z @ 0x18002F5D8
 * Callers:
...
__int64 __fastcall COverlayContext::OverlayPlaneInfo::operator=(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 8) = *(_QWORD *)(a2 + 8);
  wil::com_ptr_t<IBitmapRealization,wil::err_returncode_policy>::operator=(a1 + 16, a2 + 16);
