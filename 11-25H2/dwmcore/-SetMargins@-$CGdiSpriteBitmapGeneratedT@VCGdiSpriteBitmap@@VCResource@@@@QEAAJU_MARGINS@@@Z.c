/*
 * XREFs of ?SetMargins@?$CGdiSpriteBitmapGeneratedT@VCGdiSpriteBitmap@@VCResource@@@@QEAAJU_MARGINS@@@Z @ 0x180104220
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmapGeneratedT<CGdiSpriteBitmap,CResource>::SetMargins(__int64 a1, __m128i *a2)
{
    ...
    || v3 < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0x4B9u, 0LL);
