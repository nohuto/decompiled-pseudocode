        ...
        __int64 **a2)
{
  ...
  __int64 v6; // rax
  __int64 *v7; // r10
  detail::liberal_expansion_policy *v8; // rdx
  __int64 *v9; // rbx
  __int64 *v10; // rax
  detail::liberal_expansion_policy **v11; // rcx
  detail::liberal_expansion_policy *v13; // [rsp+50h] [rbp+28h] BYREF
  __int64 *v14; // [rsp+58h] [rbp+30h] BYREF
  detail::liberal_expansion_policy *v15; // [rsp+60h] [rbp+38h] BYREF
  ...
  v7 = (__int64 *)a1[1];
  v8 = *a1;
  if ( 0xCCCCCCCCCCCCCCCDuLL * (((char *)v7 - (char *)*a1) >> 3) <= 0xCCCCCCCCCCCCCCCDuLL * (v6 >> 3) )
  {
    v13 = (detail::liberal_expansion_policy *)v4;
    v15 = v8;
    v14 = v7;
    std::_Swap_ranges_unchecked<detail::basic_iterator<CCpuClipAntialiasSinkContext::SinkRenderParameters>,detail::basic_iterator<CCpuClipAntialiasSinkContext::SinkRenderParameters>>(
      ...
      (__int64 **)&v13);
    v9 = v16;
    v13 = (detail::liberal_expansion_policy *)a2[1];
    v14 = v16;
    std::move<std::move_iterator<detail::basic_iterator<CCpuClipAntialiasSinkContext::SinkRenderParameters>>,detail::back_insert_iterator_unchecked<detail::vector_facade<CCpuClipAntialiasSinkContext::SinkRenderParameters,detail::buffer_impl<CCpuClipAntialiasSinkContext::SinkRenderParameters,10,1,detail::liberal_expansion_policy>>>>(
      ...
      (detail::liberal_expansion_policy *)a1);
    v10 = a2[1];
    v11 = (detail::liberal_expansion_policy **)a2;
  }
  else
  {
    v13 = *a1;
    v14 = v2;
    v15 = (detail::liberal_expansion_policy *)v4;
    std::_Swap_ranges_unchecked<detail::basic_iterator<CCpuClipAntialiasSinkContext::SinkRenderParameters>,detail::basic_iterator<CCpuClipAntialiasSinkContext::SinkRenderParameters>>(
      &v16,
      (__int64 *)&v15,
      &v14,
  ...
  v13 = (detail::liberal_expansion_policy *)v10;
  v14 = v9;
