/*
 * XREFs of ?ShouldRealizeCpuClipOnGpu@CCpuClippingData@@SA_NPEBVCShape@@AEBVCMILMatrix@@@Z @ 0x18008B0E0
 * Callers:
...
{
  __int64 v2; // rax
  char (__fastcall *v5)(CRoundedRectangleShape *, unsigned int *); // rax
  ...
  v2 = *(_QWORD *)this;
  v18 = 0;
  v5 = *(char (__fastcall **)(CRoundedRectangleShape *, unsigned int *))(v2 + 64);
  ...
  {
    if ( (char *)v5 == (char *)CRectanglesShape::IsRectangles )
    {
      IsRectangles = CRectanglesShape::IsRectangles(this, &v18);
    }
    else if ( (char *)v5 == (char *)CRegionShape::IsRectangles )
    {
...
LABEL_10:
  ...
  if ( (char *)v10 == (char *)CRectanglesShape::GetTightBounds )
  {
    ...
    if ( v12 )
    {
      ...
      if ( v12 > 1 )
      {
        ...
        do
        {
          TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::UnionUnsafe(&v19, &v11[v17]);
          v11 = (__int128 *)*((_QWORD *)this + 2);
          ++v17;
          ++v13;
        }
      ...
      if ( !CMILMatrix::IsIdentity<0>((__int64)a2) )
  ...
  else
  {
    if ( (char *)v10 == (char *)CRegionShape::GetTightBounds )
      TightBounds = CRegionShape::GetTightBounds((__int64)this, (__int64)&v19, (__int64)a2);
    else
