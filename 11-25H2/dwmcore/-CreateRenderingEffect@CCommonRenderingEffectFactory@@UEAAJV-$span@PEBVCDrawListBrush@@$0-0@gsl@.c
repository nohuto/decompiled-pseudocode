/*
 * XREFs of ?CreateRenderingEffect@CCommonRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x18010F900
 * Callers:
      ...
      if ( v18 )
      {
        ...
        *(_QWORD *)&v9[24 * v3 + 24] = v23;
        if ( v23 )
        {
          ...
          {
            CGDISectionBitmapRealization::AddRef(v23);
          }
          else
          {
            ((void (__fastcall *)(volatile signed __int32 *, __int64 (__fastcall *)(_QWORD), __int64 (__fastcall *)(CEffectIntermediateProducer *)))v25)(
              v23,
