/*
 * XREFs of ?SetViewbox@?$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@QEAAJUD2D_RECT_F@@@Z @ 0x180211130
 * Callers:
        ...
        const __m128i *a2)
{
  ...
  v2 = (__m128)_mm_loadu_si128(a1 + 8);
