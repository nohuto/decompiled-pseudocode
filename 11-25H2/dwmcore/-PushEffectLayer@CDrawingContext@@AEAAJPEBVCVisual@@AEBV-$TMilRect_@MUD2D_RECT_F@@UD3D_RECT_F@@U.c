/*
 * XREFs of ?PushEffectLayer@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@11PEAVCResource@@PEA_N@Z @ 0x180028A60
 * Callers:
 ...
 * Callees:
 *     ?RoundOffLayerSize@CTreeEffectLayer@@SA?AUD2D_POINTANDSIZE_L@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180028EF4 (-RoundOffLayerSize@CTreeEffectLayer@@SA-AUD2D_POINTANDSIZE_L@@AEBV-$TMilRect_@MUD2D_RECT_F@@UD3D.c)
        ...
        char *a7)
{
  ...
  *((float *)&v45 + 1) = v27;
  ...
  if ( a6 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(CEffectBrush *, __int64))(*(_QWORD *)a6 + 64LL))(a6, 60LL) )
    {
      if ( CDrawingContext::IsSurfaceSizeValid((CDrawingContext *)this, v26, _mm_cvtsi128_si32(_mm_srli_si128(v16, 12))) )
      {
        ...
        if ( v34 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0xEF8u, 0LL);
          v10 = v40[0];
          goto LABEL_18;
        }
        v10 = v40[0];
...
LABEL_27:
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(CEffectBrush *, __int64))(*(_QWORD *)a6 + 64LL))(a6, 56LL) )
    {
      v31 = -2147024809;
      v33 = -2147024809;
      v36 = 3888;
LABEL_25:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, v36, 0LL);
      goto LABEL_18;
    }
  }
  *(__m128i *)v40 = v16;
...
LABEL_17:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0xF1Du, 0LL);
  v11 = v39;
LABEL_18:
  if ( v10 )
  {
