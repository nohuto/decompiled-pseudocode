/*
 * XREFs of ?reserve_region@?$vector_facade@UD2D_RECT_F@@V?$buffer_impl@UD2D_RECT_F@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAUD2D_RECT_F@@_K0@Z @ 0x180125680
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  detail::buffer_impl<D2D_RECT_F,3,1,detail::liberal_expansion_policy>::ensure_extra_capacity((__int64)a1, a3);
  v6 = *a1;
  v7 = (_OWORD *)a1[1];
  v8 = ((__int64)v7 - *a1) >> 4;
  v9 = v8 - a2;
