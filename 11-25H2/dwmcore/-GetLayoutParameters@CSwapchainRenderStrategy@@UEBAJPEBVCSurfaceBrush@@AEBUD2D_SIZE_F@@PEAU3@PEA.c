/*
 * XREFs of ?GetLayoutParameters@CSwapchainRenderStrategy@@UEBAJPEBVCSurfaceBrush@@AEBUD2D_SIZE_F@@PEAU3@PEAUD2D_RECT_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801B3DE0
 * Callers:
 ...
 *     ?PrependTranslate@CMILMatrix@@QEAAXMMM@Z @ 0x1801B4040 (-PrependTranslate@CMILMatrix@@QEAAXMMM@Z.c)
