/*
 * XREFs of ??$SetProperty@UD2DQuaternion@@@DataSourcePropertySet@@QEAAJIPEBUD2DQuaternion@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18027BB30
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DQuaternion>(__int64 a1, int a2, __m128i *a3)
{
  ...
  if ( v14 == *(_QWORD *)(a1 + 8) )
  {
    v7 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DQuaternion>(v6, 71, a3, &v16);
    if ( v7 < 0 )
    {
      v8 = 37LL;
LABEL_4:
  ...
  {
    v10 = *(_DWORD *)(v14 + 20);
    if ( (unsigned int)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::GetDataType(v6, v10) != 71 )
    {
      v7 = -2147024809;
      v8 = 48LL;
      goto LABEL_4;
