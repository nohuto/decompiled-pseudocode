/*
 * XREFs of ?NotifyPropertyChanged@CPropertyChangeResource@@IEBAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1801A56D0
 * Callers:
        ...
        bool *a3)
{
      ...
      if ( v18 )
      {
        if ( *(_DWORD *)(v18 + 108) )
        {
          if ( *((_DWORD *)this + 18) )
          {
            ...
            if ( _bittest(&v38, v19) )
            {
              v39 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6416LL) + 72LL))(
              ...
              if ( v39 )
              {
                ...
                v42 = CoreUICallSend(v39, &v45, 2LL, 11LL, 0, &unk_180336EAA, v19, v20, v43);
                if ( v42 != -2018375675 )
                  v6 = v42;
                if ( v6 < 0 )
          ...
          if ( *((_DWORD *)this + 18) )
          {
            ...
            if ( _bittest(&v9, v8) )
            {
              ...
              if ( v10 )
              {
                ...
                v46 = *((unsigned int *)this + 18);
                v48 = v13;
                v14 = CoreUICallSend(v10, &v45, 2LL, 11LL, 2, &unk_180336EB2, v8, &v48, v43);
                if ( v14 != -2018375675 )
                  v6 = v14;
                if ( v6 >= 0 )
    ...
    else
    {
      switch ( v3 )
      {
        ...
        case 52:
          ...
          if ( !_bittest(&v23, v22) )
            goto LABEL_17;
          v24 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6416LL) + 72LL))(
                  *(_QWORD *)(*((_QWORD *)this + 3) + 6416LL),
                  11LL);
          if ( !v24 )
            goto LABEL_17;
          ...
          v45 = v26;
          v46 = *((unsigned int *)this + 18);
          v28 = CoreUICallSend(v24, &v45, 2LL, 11LL, 3, &unk_180336EB8, v22, &v43, v27);
          if ( v28 != -2018375675 )
            v6 = v28;
          if ( v6 >= 0 )
            return (unsigned int)v6;
  ...
  if ( !v15
    ...
    || (v30 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6416LL) + 72LL))(
                *(_QWORD *)(*((_QWORD *)this + 3) + 6416LL),
                11LL)) == 0 )
  {
LABEL_17:
...
LABEL_54:
  ...
  v47[2] = v35;
  v47[3] = v36;
  v37 = CoreUICallSend(v30, &v45, 2LL, 11LL, 8, &unk_180336ED6, v16, v47, v43);
  if ( v37 != -2018375675 )
    v6 = v37;
  if ( v6 < 0 )
  {
