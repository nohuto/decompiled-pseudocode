/*
 * XREFs of ?Accelerate@CGravityBounceAccelerator@@UEAAMPEAUIntegrationState@@M@Z @ 0x1802B9D20
 * Callers:
 *     <none>
 * Callees:
        ...
        float a3)
{
  ...
  if ( *((_DWORD *)this + 12) && (unsigned int)dword_180404D18 > 4 && tlgKeywordOn((__int64)&dword_180404D18, 4LL) )
