/*
 * XREFs of ?RenderAndPresent@CHolographicInteropTarget@@UEAAJPEAVCDrawingContext@@@Z @ 0x1802D9830
 * Callers:
 *     ?RenderAndPresent@CHolographicInteropTarget@@WEI@EAAJPEAVCDrawingContext@@@Z @ 0x180282E10 (-RenderAndPresent@CHolographicInteropTarget@@WEI@EAAJPEAVCDrawingContext@@@Z.c)
 *     ?RenderAndPresent@CHolographicInteropTarget@@WFA@EAAJPEAVCDrawingContext@@@Z @ 0x180282E20 (-RenderAndPresent@CHolographicInteropTarget@@WFA@EAAJPEAVCDrawingContext@@@Z.c)
 * Callees:
 ...
 *     ?GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z @ 0x1802D8894 (-GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z.c)
        ...
        struct CDrawingContext *a2)
{
  ...
  LOBYTE(v2) = 0;
  v3 = qword_18040AC10 + 1;
  v4 = 0;
  ++qword_18040AC10;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) != 0 )
  {
    McTemplateU0xx_EventWriteTransfer((__int64)this, &EVTDESC_HOLOGRAPHICINTEROPTARGET_RENDER, v3, qword_18040AC18);
    LODWORD(v3) = qword_18040AC10;
  }
