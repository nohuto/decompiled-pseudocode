/*
 * XREFs of ?_UpdateInteractionOutput@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@PEAUInteractionOutput@@@Z @ 0x1801792B4
 * Callers:
        ...
        int a4)
{
  ...
  float v26; // [rsp+D4h] [rbp-64h] BYREF
  float v27; // [rsp+D8h] [rbp-60h] BYREF
  ...
  __int128 v38; // [rsp+118h] [rbp-20h] BYREF
  __int128 v39; // [rsp+128h] [rbp-10h]
  ...
  *((_DWORD *)a3 + 11) = *((_DWORD *)a2 + 4);
  v8 = *(_DWORD *)a2;
  if ( ((*(_DWORD *)a2 - 1) & 0xFFFFFFFC) == 0 && v8 != 3 )
  {
    *(_DWORD *)a3 = v8;
  ...
  {
    v12 = CPointerDeviceCache::Query(*((void **)this + 30));
    ...
    {
      v14 = 1000 * (__int64)v39 / *((_QWORD *)&v39 + 1);
      v15 = 1000 * (__int64)v38 / *((_QWORD *)&v39 + 1);
      if ( *(_DWORD *)a2 == 1 && (v14 || v15 || 1000 * v40 / *((_QWORD *)&v39 + 1)) )
      {
        v16 = OutputPredictionInteractionContext(
                *((_QWORD *)this + 2),
                1000LL,
                v14,
                v15,
                1000 * v40 / *((_QWORD *)&v39 + 1),
                &v36);
