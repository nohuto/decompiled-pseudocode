/*
 * XREFs of ?OnPropertyValueChanged@CEffectBrush@@EEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801EEF60
 * Callers:
 ...
 *     ??0CEffectPropertyChangeNotification@@QEAA@PEAUIEffectInstance@Composition@UI@Windows@@I@Z @ 0x1801EF0D8 (--0CEffectPropertyChangeNotification@@QEAA@PEAUIEffectInstance@Composition@UI@Windows@@I@Z.c)
...
__int64 __fastcall CEffectBrush::OnPropertyValueChanged(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  {
    v12 = -2147483634;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147483634, 0x352u, 0LL);
    return v12;
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x361u, 0LL);
    return v12;
  }
  v13 = 1;
  if ( v21 )
