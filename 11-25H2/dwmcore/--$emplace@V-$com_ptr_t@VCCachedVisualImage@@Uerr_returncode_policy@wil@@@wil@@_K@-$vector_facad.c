...
_QWORD *__fastcall detail::vector_facade<CVisualSurface::SourceCVI,detail::buffer_impl<CVisualSurface::SourceCVI,4,1,detail::liberal_expansion_policy>>::emplace<wil::com_ptr_t<CCachedVisualImage,wil::err_returncode_policy>,unsigned __int64>(
        __int64 *a1,
        _QWORD *a2,
        _QWORD *a3,
        __int64 *a4,
        __int64 a5)
{
  ...
  v7 = (*a3 - *a1) >> 4;
  v9 = detail::vector_facade<CVisualSurface::SourceCVI,detail::buffer_impl<CVisualSurface::SourceCVI,4,1,detail::liberal_expansion_policy>>::reserve_region(
         a1,
         v7);
  v10 = *a4;
  *a4 = 0LL;
