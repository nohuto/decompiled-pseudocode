/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@$07$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x1801DD6F4
 * Callers:
...
void __fastcall detail::buffer_impl<wil::com_ptr_t<IUnknown,wil::err_returncode_policy>,8,1,detail::liberal_expansion_policy>::ensure_extra_capacity(
        __int64 **a1,
        unsigned __int64 a2)
{
  __int64 *v3; // rcx
  ...
  if ( v3 - v4 < a2 )
  {
    ...
    if ( v5 + a2 < v5 )
    {
      ...
      __debugbreak();
      JUMPOUT(0x1801DD75ELL);
    }
    v6 = detail::liberal_expansion_policy::expand((detail::liberal_expansion_policy *)(v3 - *a1), v3 - *a1, v5 + a2);
    v7 = (__int64 *)operator new[](saturated_mul(v6, 8uLL));
    v8 = a1[1];
    v9 = *a1;
    *(_QWORD *)&v14 = v7;
    *((_QWORD *)&v14 + 1) = v5;
    ...
    v16 = v14;
    v17 = 0LL;
    ((void (__fastcall *)(__int128 *, __int64 *, __int64 *, __int128 *))std::uninitialized_move<std::move_iterator<wil::com_ptr_t<IUnknown,wil::err_returncode_policy> *>,stdext::checked_array_iterator<wil::com_ptr_t<IUnknown,wil::err_returncode_policy> *>>)(
      &v14,
      v9,
      v8,
      &v16);
