/*
 * XREFs of ??0CDDisplaySwapChain@@IEAA@AEAV?$com_ptr_t@VCD3DDevice@@Uerr_returncode_policy@wil@@@wil@@AEAUDDisplayTaskPoolResources@@AEAUDDisplayTargetResources@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@AEBVRefreshRateInfo@@IUD2D_SIZE_U@@@Z @ 0x1802CA50C
 * Callers:
 ...
 *     ??0DDisplayTargetResources@@QEAA@$$QEAU0@@Z @ 0x1802CA77C (--0DDisplayTargetResources@@QEAA@$$QEAU0@@Z.c)
 */
        ...
        __int64 a9)
{
  ...
  *(_BYTE *)(a1 + 666) = 0;
  ...
  if ( qword_180406BF0 == qword_180406BF8 )
  {
    std::vector<Microsoft::BamoImpl::BamoPrincipalImpl *>::_Emplace_reallocate<Microsoft::BamoImpl::BamoPrincipalImpl * const &>(
      (const void **)&qword_180406BE8,
      (_BYTE *)qword_180406BF0,
      &a6);
  }
  else
  {
    *(_QWORD *)qword_180406BF0 = a1 + 288;
    qword_180406BF0 += 8LL;
  }
  result = a1;
  *(_DWORD *)(a1 + 88) = 2;
