/*
 * XREFs of ?GetWarpDevice@CDeviceManager@@QEAAJPEAPEAVCD3DDevice@@@Z @ 0x1802C108C
 * Callers:
...
__int64 __fastcall CDeviceManager::GetWarpDevice(CDeviceManager *this, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  v8 = Device;
  if ( Device < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, Device, 0x13Eu, 0LL);
  v2 = v8;
LABEL_10:
