/*
 * XREFs of ?DisableIndependentFlip@CGlobalCompositionSurfaceInfo@@UEAAJ_K@Z @ 0x1801E86D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  if ( a2 == *((_QWORD *)this + 17) && *((_BYTE *)this + 292) )
  {
    ...
    v2 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x20Eu, 0LL);
  }
  else
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x212u, 0LL);
  }
  return v2;
}
