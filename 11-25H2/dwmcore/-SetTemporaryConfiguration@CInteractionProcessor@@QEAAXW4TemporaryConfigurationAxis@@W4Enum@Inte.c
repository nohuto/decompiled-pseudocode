/*
 * XREFs of ?SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x180134A48
 * Callers:
        ...
        int a5)
{
  ...
  result = a5 | ~v11;
  if ( v9 == -1
    || *(_BYTE *)(v10 + 12LL * v9) == a4 && (!a4 || *(_DWORD *)(v10 + 12LL * v9 + 4) == result)
    || (*(_BYTE *)(v10 + 12LL * v9) = a4,
        *(_DWORD *)(v10 + 12LL * v9 + 4) = result,
        *(_DWORD *)(v10 + 12LL * v9 + 8) = v11,
        a3) )
  {
    if ( a3 == 1 )
    {
  ...
  if ( (unsigned int)dword_180404D18 > 4 && (byte_180404D28 & 2) != 0 && (qword_180404D30 & 2) == qword_180404D30 )
  {
    ...
    v27 = v9;
    v28 = a3;
    v16 = *(_DWORD *)(v10 + 12LL * v9 + 4);
    v25 = *(unsigned __int8 *)(v10 + 12LL * v9);
    v56 = &v20;
    v54 = &v21;
    v52 = &v22;
    v50 = &v23;
