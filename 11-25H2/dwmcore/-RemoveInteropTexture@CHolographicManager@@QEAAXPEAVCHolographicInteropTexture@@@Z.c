/*
 * XREFs of ?RemoveInteropTexture@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x1802D90CC
 * Callers:
  ...
  for ( i = (struct CHolographicInteropTexture **)this[18].Ptr; i != this[19].Ptr; ++i )
  {
    if ( *i == a2 )
    {
      ...
      if ( CompositorTracing::IsEnabled() )
      {
        ...
        CompositorTracing::DwmHolographicInteropTextureRemove_(v8, v7);
      }
