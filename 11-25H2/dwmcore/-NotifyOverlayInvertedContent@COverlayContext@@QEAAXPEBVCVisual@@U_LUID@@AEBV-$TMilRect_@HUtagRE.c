/*
 * XREFs of ?NotifyOverlayInvertedContent@COverlayContext@@QEAAXPEBVCVisual@@U_LUID@@AEBV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18024FF6C
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  if ( (_DWORD)result != -1 )
  {
    v7 = *(_QWORD *)(v6 + 12936) + 400LL * (int)result;
