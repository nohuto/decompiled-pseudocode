/*
 * XREFs of ?CopyShape@CShape@@QEBAJPEBVCMILMatrix@@PEAPEAV1@@Z @ 0x18004C4F0
 * Callers:
 ...
 *     ?FlattenToLineSegments@CRegionShape@@UEBAJMPEAPEAVCShape@@@Z @ 0x180263E20 (-FlattenToLineSegments@CRegionShape@@UEBAJMPEAPEAVCShape@@@Z.c)
...
__int64 __fastcall CShape::CopyShape(CShape *this, const struct CMILMatrix *a2, struct CShape **a3)
{
  ...
  float v42; // xmm9_4
  char v43; // al
  detail::liberal_expansion_policy *v44; // rcx
...
LABEL_49:
    v44 = (detail::liberal_expansion_policy *)CRectanglesShape::IsRectangles;
    v45 = *(bool (__fastcall **)(CRectanglesShape *__hidden, unsigned int *))(*(_QWORD *)v6 + 64LL);
    ...
    if ( *((char *)a2 + 64) >> 6 < 0 )
      goto LABEL_53;
    v114 = *((_BYTE *)a2 + 65);
    v44 = (detail::liberal_expansion_policy *)v114;
...
LABEL_53:
    ...
    if ( v47 > 0xA )
    {
      v94 = detail::liberal_expansion_policy::expand(v44, 0xAuLL, v47);
      v96 = 16 * v94;
    ...
    *v48 = 0LL;
    ...
    v55 = *(__int64 (__fastcall **)())(*(_QWORD *)v6 + 80LL);
...
LABEL_72:
          ...
          && CMILMatrix::Is2DAxisAlignedIntegerPreserving(a2) )
        {
          ...
          {
            v35 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x11Bu, 0LL);
          ...
          *((_QWORD *)v166 + 11) = 0LL;
          ...
          {
            CMilRectLFromD2D_RECT_F(&v183.left, (__int64)lpMem + 16 * v167);
            v168 = CRegion::TryAddRectangle((CRegion *)v188, &v183);
            v181 = v168;
            v35 = v168;
            if ( v168 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v168, 0x121u, 0LL);
              FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)v188);
              detail::vector_facade<CVisualTreePath::VisualTreePathUnit,detail::buffer_impl<CVisualTreePath::VisualTreePathUnit,2,1,detail::liberal_expansion_policy>>::~vector_facade<CVisualTreePath::VisualTreePathUnit,detail::buffer_impl<CVisualTreePath::VisualTreePathUnit,2,1,detail::liberal_expansion_policy>>((__int64)&lpMem);
              CRegionShape::`vector deleting destructor'((CRegionShape *)v166, 1u);
              goto LABEL_37;
            }
            ++v167;
          }
        ...
        if ( !v66 )
        {
          ...
          {
            v35 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x12Du, 0LL);
            v149 = lpMem;
...
LABEL_101:
    ...
    {
      ((void (__fastcall *)(__int64, LPVOID, _QWORD))v55)(v6, lpMem, (unsigned int)v175);
    }
    v56 = v175;
    goto LABEL_68;
  }
        ...
        else
        {
          ...
          if ( v108 )
          {
            ...
            *v108 = &CPolygonShape::`vftable';
            ...
            if ( v92 == CMILRefCountImpl::AddReference )
            {
...
LABEL_237:
      v35 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, v174, 0LL);
      goto LABEL_37;
    }
LABEL_130:
    ...
    if ( !v87 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x28u, v3);
        ModuleFailFastForHRESULT(-2147024882, retaddr);
      }
...
LABEL_35:
  ...
  if ( v35 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x14Fu, 0LL);
    goto LABEL_37;
  }
