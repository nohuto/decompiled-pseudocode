/*
 * XREFs of ?EnsurePositionIsLessThanOrEqualToMax@CInteractionTracker@@AEAAXW4PropertyValueMask@1@@Z @ 0x18003BC90
 * Callers:
...
__int64 __fastcall CInteractionTracker::EnsurePositionIsLessThanOrEqualToMax(__int64 a1, char a2)
{
  ...
  if ( !*(_DWORD *)(a1 + 184) && (*(_BYTE *)(a1 + 540) & 0x20) == 0 )
  {
    ...
    v5 = v2;
    if ( (a2 & 1) != 0 )
      LODWORD(v4) = fminf(*(float *)(a1 + 88), *(float *)(a1 + 112));
    if ( (a2 & 2) != 0 )
      HIDWORD(v4) = fminf(*(float *)(a1 + 92), *(float *)(a1 + 116));
    v5 = 0;
