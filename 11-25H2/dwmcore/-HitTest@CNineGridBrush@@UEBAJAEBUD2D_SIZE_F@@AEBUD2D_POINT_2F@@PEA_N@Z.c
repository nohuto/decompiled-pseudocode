/*
 * XREFs of ?HitTest@CNineGridBrush@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x18007BFF0
 * Callers:
        ...
        bool *a4)
{
  ...
  float y; // xmm1_4
  CSurfaceBrush *v13; // rcx
  __int64 (__fastcall *v14)(CSurfaceBrush *, __int64); // rax
  char v15; // al
  ...
  *a4 = 0;
  v8 = (__int64 (__fastcall *)(CNineGridBrush *, const struct D2D_SIZE_F *, __int128 *))*((_QWORD *)*this + 23);
  v25 = 0LL;
  if ( (char *)v8 == (char *)CNineGridBrush::GetBounds )
    Bounds = CNineGridBrush::GetBounds(this, a2, &v25);
  else
    Bounds = v8((CNineGridBrush *)this, a2, &v25);
  v10 = Bounds;
  if ( Bounds < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Bounds, 0x89u, 0LL);
  }
  else if ( a3->x >= *(float *)&v25 && *((float *)&v25 + 2) > a3->x )
  {
    ...
    if ( y >= *((float *)&v25 + 1) && *((float *)&v25 + 3) > y )
    {
      *a4 = 1;
      ...
      {
        v13 = this[13];
        v14 = *(__int64 (__fastcall **)(CSurfaceBrush *, __int64))(*(_QWORD *)v13 + 64LL);
        if ( (char *)v14 == (char *)CSurfaceBrush::IsOfType )
        {
          v15 = CSurfaceBrush::IsOfType(v13, 167LL);
        }
        else if ( (char *)v14 == (char *)CColorBrush::IsOfType )
        {
          v15 = CColorBrush::IsOfType(v13, 167LL);
        }
        else
        {
          v15 = v14(v13, 167LL);
        ...
        if ( v15 )
        {
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x99u, 0LL);
            return v10;
          }
