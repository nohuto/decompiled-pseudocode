/*
 * XREFs of ?AddNonIntersectedD2DGeometry@CRoundedRectangleShape@@AEBAXPEAUID2D1GeometrySink@@@Z @ 0x18006A5F0
 * Callers:
 ...
 *     ?HalveTheStep@?$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ @ 0x1801C4E38 (-HalveTheStep@-$CBezierFlattener@MVCMilPoint2F@@@@IEAAXXZ.c)
  ...
  if ( *(_QWORD *)(v2 + 80) == v5 )
  {
    ...
    do
    {
      ...
      if ( *v17 <= 0.0 || v17[1] <= 0.0 )
        v18 = dword_18031F2D8[v15];
      else
        v18 = *((_DWORD *)&unk_18031F2F0 + 4 * v15);
      v19 = v18;
      if ( v16 )
        v20 = (float *)(v13 + 32);
      else
      ...
      {
        v21 = (int *)((char *)&unk_18031F2F0 + 16 * v14);
        v22 = v21[3];
        v23 = *v21;
        v24 = v21[1];
        v25 = v21[2];
...
LABEL_63:
  ...
  if ( *(void (__fastcall **)(CPolygonBuilder *, struct D2D_POINT_2F, enum D2D1_FIGURE_BEGIN))(*(_QWORD *)v3 + 40LL) == CPolygonBuilder::BeginFigure )
  {
    v121 = v77;
  ...
  v80 = v78 + 8;
  if ( *(void (__fastcall **)(CPolygonBuilder *, const struct D2D_POINT_2F *, unsigned int))(*(_QWORD *)v3 + 48LL) == CPolygonBuilder::AddLines )
  {
    v121 = *((_QWORD *)v3 + 3);
