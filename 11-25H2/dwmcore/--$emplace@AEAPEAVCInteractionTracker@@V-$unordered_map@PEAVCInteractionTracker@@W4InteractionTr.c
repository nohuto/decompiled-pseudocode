        ...
        __int64 a4)
{
  ...
  v10 = *((_QWORD *)a1 + 3);
  v11 = *((_QWORD *)a1 + 1);
  v12 = *(__int64 **)(v10 + 16 * (v8 & *((_QWORD *)a1 + 6)) + 8);
  if ( v12 == (__int64 *)v11 )
    goto LABEL_7;
  v13 = *(__int64 **)(v10 + 16 * (v8 & *((_QWORD *)a1 + 6)));
  while ( *a3 != v12[2] )
  {
    if ( v12 == v13 )
    {
...
LABEL_7:
    ...
    v14 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x58uLL);
    v14[2] = *a3;
    ...
    if ( v17 < 0 )
    {
      v21 = *((_QWORD *)a1 + 7) & 1LL | (*((_QWORD *)a1 + 7) >> 1);
    ...
    if ( (float)(v16 / v18) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<CInteractionTracker *,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>>,0>>::_Forced_rehash(
        a1,
        v19);
      v11 = *std::_Hash<std::_Umap_traits<CInteractionTracker *,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>>,0>>::_Find_last<CInteractionTracker *>(
               a1,
               v22,
               v14 + 2,
               v9);
