/*
 * XREFs of ?Init@CVisualDepthGeometry@@AEAAXAEBUfloat2@Numerics@Foundation@Windows@@AEBVCMILMatrix@@@Z @ 0x18011E960
 * Callers:
 ...
 *     ??0CVisualDepthGeometry@@QEAA@PEAVCVisual@@AEBVCMILMatrix@@@Z @ 0x18011D140 (--0CVisualDepthGeometry@@QEAA@PEAVCVisual@@AEBVCMILMatrix@@@Z.c)
 * Callees:
        ...
        const struct CMILMatrix *a3)
{
  ...
  D2D_VECTOR_4F v45; // [rsp+78h] [rbp-39h] BYREF
