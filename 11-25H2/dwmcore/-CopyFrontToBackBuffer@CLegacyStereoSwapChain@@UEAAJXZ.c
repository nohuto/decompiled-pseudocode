/*
 * XREFs of ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ @ 0x1802D3930
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPhysicalFrontBuffer@CLegacySwapChain@@UEBAPEAVISwapChainBuffer@@XZ @ 0x1801F5FA0 (-GetPhysicalFrontBuffer@CLegacySwapChain@@UEBAPEAVISwapChainBuffer@@XZ.c)
...
__int64 __fastcall CLegacyStereoSwapChain::CopyFrontToBackBuffer(CLegacyStereoSwapChain *this)
{
  ...
  if ( **v3 )
  {
    ...
    v5 = (*(__int64 (__fastcall **)(struct ISwapChainBuffer *))(*(_QWORD *)v4 + 136LL))(v4);
    PhysicalFrontBuffer = CLegacySwapChain::GetPhysicalFrontBuffer(this);
    v7 = (*(__int64 (__fastcall **)(struct ISwapChainBuffer *))(*(_QWORD *)PhysicalFrontBuffer + 136LL))(PhysicalFrontBuffer);
