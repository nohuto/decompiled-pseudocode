/*
 * XREFs of ?DuplicateScopeToClipStack@CScopedClipStack@@QEBAXPEAV1@AEBVCMILMatrix@@@Z @ 0x180081C70
 * Callers:
  ...
  *(_QWORD *)(v5 - 160) = *(_QWORD *)(v6 - 160);
  ...
  if ( v10 < v9 )
  {
    ...
    do
    {
      ...
      detail::vector_facade<CScopedClipStack::CpuClipStackState,detail::buffer_impl<CScopedClipStack::CpuClipStackState,10,1,detail::liberal_expansion_policy>>::emplace_back<>((char *)a2 + 1944);
      v17 = *((_QWORD *)a2 + 244);
