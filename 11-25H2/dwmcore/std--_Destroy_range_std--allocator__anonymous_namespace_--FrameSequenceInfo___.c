/*
 * XREFs of std::_Destroy_range_std::allocator__anonymous_namespace_::FrameSequenceInfo___ @ 0x180269C08
 * Callers:
 *     _anonymous_namespace_::FramesReport::_FramesReport @ 0x180269DA8 (_anonymous_namespace_--FramesReport--_FramesReport.c)
 * Callees:
 *     _anonymous_namespace_::FrameSequenceInfo::_FrameSequenceInfo @ 0x1801CD600 (_anonymous_namespace_--FrameSequenceInfo--_FrameSequenceInfo.c)
 */
