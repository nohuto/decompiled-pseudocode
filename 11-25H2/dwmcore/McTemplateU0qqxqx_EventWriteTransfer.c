/*
 * XREFs of McTemplateU0qqxqx_EventWriteTransfer @ 0x1801AFD14
 * Callers:
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, a2, a3, 6u, &v8);
}
