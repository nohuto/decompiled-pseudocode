/*
 * XREFs of ?SetOriginOffsetProperty@CRadialGradientBrush@@AEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1802ACCBC
 * Callers:
 *     _lambda_1a2fa90059404db64fcd2839aa350a87_::_lambda_invoker_cdecl_ @ 0x1802AC660 (_lambda_1a2fa90059404db64fcd2839aa350a87_--_lambda_invoker_cdecl_.c)
 * Callees:
