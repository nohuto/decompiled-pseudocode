/*
 * XREFs of ?HrCheckBufferSize@@YAJW4DXGI_FORMAT@@IIII@Z @ 0x1801886C8
 * Callers:
...
LABEL_5:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x68Eu, 0LL);
      return v5;
    }
  ...
  {
    v5 = -2003292276;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292276, 0x692u, 0LL);
  }
  return v5;
}
