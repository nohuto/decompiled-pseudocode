/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_EffectHash@@@details@wil@@QEAA_NXZ @ 0x18024A934
 * Callers:
...
unsigned __int8 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_EffectHash>::__private_IsEnabled(
        volatile signed __int32 *a1)
{
  ...
  if ( (*(_BYTE *)a1 & 6) != 6 )
  {
    ...
    LODWORD(v23) = 0;
    v4 = v3;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_EffectHash>::GetCurrentFeatureEnabledState(v5, &v27, &v23);
    for ( i = v1; ; i = v7 )
    {
      v1 = i;
      if ( (_DWORD)v23 && (i & 2) == 0 )
  ...
  if ( (*a1 & 4) == 0 )
  {
    v23 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_EffectHash>::GetCachedFeatureEnabledState(
                       a1,
                       &v24);
    LOWORD(v8) = v23;
  }
  ...
  if ( (v8 & 0x400) != 0 )
  {
    ...
    wil::details::WilApi_RecordFeatureUsage((wil::details *)0x3301E13, v16, 0LL);
  }
  if ( !v15 )
  {
    ...
    {
      LOBYTE(v14) = 2;
      g_wil_details_realtimeFeatureUsageHook(53485075LL, v10, v14);
    }
    if ( g_wil_details_pfnFeatureLoggingHook )
    {
      ...
      if ( (char *)g_wil_details_pfnFeatureLoggingHook == (char *)wil::details::FeatureLoggingHook )
        ...
        g_wil_details_pfnFeatureLoggingHook(53485075LL, &v25, 0LL, v9, &v24, 0LL, 0, 1LL);
    }
  }
  return v9;
}
