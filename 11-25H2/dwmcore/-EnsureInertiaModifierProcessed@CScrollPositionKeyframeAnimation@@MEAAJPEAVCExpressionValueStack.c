/*
 * XREFs of ?EnsureInertiaModifierProcessed@CScrollPositionKeyframeAnimation@@MEAAJPEAVCExpressionValueStack@@_K@Z @ 0x180221C00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
    ...
    {
      CScrollPositionKeyframeAnimation::GetNaturalEndpoint(this, &v18);
      if ( HasValue && v8 == 18 )
      {
        v15 = v23[0];
        *((_BYTE *)this + 712) |= 8u;
