/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_D3D11ShaderAccessRestrictedResource@@@details@wil@@QEAA_NXZ @ 0x18024C1AC
 * Callers:
 ...
 *     ?IsOverlayRequired@CDxHandleYUVBitmapRealization@@UEBA_NXZ @ 0x18022DE80 (-IsOverlayRequired@CDxHandleYUVBitmapRealization@@UEBA_NXZ.c)
 * Callees:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_D3D11ShaderAccessRestrictedResource@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18024C24C (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_D3D11ShaderAccessRestric.c)
 */
