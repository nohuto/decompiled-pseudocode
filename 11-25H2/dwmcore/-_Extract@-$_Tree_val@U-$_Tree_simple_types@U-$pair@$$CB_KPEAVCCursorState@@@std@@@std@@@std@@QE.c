/*
 * XREFs of ?_Extract@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KPEAVCCursorState@@@std@@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CB_KPEAVCCursorState@@@std@@PEAX@2@V?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KPEAVCCursorState@@@std@@@std@@@std@@U_Iterator_base0@2@@2@@Z @ 0x1801FA304
 * Callers:
