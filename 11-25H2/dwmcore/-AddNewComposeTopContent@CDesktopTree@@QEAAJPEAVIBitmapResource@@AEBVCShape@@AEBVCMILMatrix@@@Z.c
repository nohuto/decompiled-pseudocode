/*
 * XREFs of ?AddNewComposeTopContent@CDesktopTree@@QEAAJPEAVIBitmapResource@@AEBVCShape@@AEBVCMILMatrix@@@Z @ 0x180075EAC
 * Callers:
 ...
 *     ??$make_unique@VCComposeTop@@$$V$0A@@std@@YA?AV?$unique_ptr@VCComposeTop@@U?$default_delete@VCComposeTop@@@std@@@0@XZ @ 0x180295E10 (--$make_unique@VCComposeTop@@$$V$0A@@std@@YA-AV-$unique_ptr@VCComposeTop@@U-$default_delete@VCCo.c)
 */
...
LABEL_6:
    ...
    v12 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x4Au, 0LL);
  }
  else
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x45u, 0LL);
  }
  return v12;
}
