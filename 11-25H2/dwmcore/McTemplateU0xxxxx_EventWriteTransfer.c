/*
 * XREFs of McTemplateU0xxxxx_EventWriteTransfer @ 0x180225A10
 * Callers:
...
ULONG McTemplateU0xxxxx_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  return McGenEventWrite_EventWriteTransfer(
           ...
           &EVTDESC_BIND_GDISPRITEBITMAP_FIRST_TOKEN,
           v15,
           6u,
           &v3);
}
