/*
 * XREFs of ?ConfigureIntermediateFromInput@CBrushRenderingGraph@@IEBAXAEBUIntermediateConfigurationInputs@1@PEAUIntermediateConfigurationOutputs@1@@Z @ 0x18019E848
 * Callers:
        ...
        struct CBrushRenderingGraph::IntermediateConfigurationOutputs *a3)
{
  ...
  float v25[10]; // [rsp+40h] [rbp-21h] BYREF
  ...
  if ( v9 )
  {
    ...
    CSurfaceDrawListBrush::ComputeLocalToSourceTransform(*(CSurfaceDrawListBrush **)(v5 + 56), (struct Matrix3x3 *)v25);
  }
  else
  {
    CDrawListBitmap::GetSize((CDrawListBitmap *)v5, &v24, (__int64)a3);
    v26.top = 0.0;
    v26.right = 0.0;
    v26.left = (float)(int)v24;
    v26.bottom = (float)SHIDWORD(v24);
    v27 = 0.0 - (float)((float)(int)v24 * 0.0);
    v28 = 0.0 - (float)((float)SHIDWORD(v24) * 0.0);
    Matrix3x3::operator*((float *)(v5 + 48), v25, &v26.left);
  }
  v10 = v4 + 1;
  Matrix3x3::Get2DScaleDimensionsWithPerspective((__int64)v25, v4, v4 + 1, &v23.left);
LABEL_4:
  v12 = fminf(a2[2], *v4);
  v13 = *((float *)a3 + 4);
  v14 = *((float *)a3 + 5);
