/*
 * XREFs of ?GetBounds@CFilterEffect@@QEAAJPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18002723C
 * Callers:
...
__int64 __fastcall CFilterEffect::GetBounds(__int64 a1, const __m128i *a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 40) = v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6;
  ...
  if ( (((unsigned __int8)v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6) & 6) != 2 )
  {
    ...
    v9 = -2147467259;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, v29, 0LL);
    goto LABEL_31;
  }
  if ( !*(_DWORD *)(a1 + 152) )
  {
    ...
    *(_DWORD *)v36 = 0;
    *(__m128i *)&v36[4] = v10;
    v11 = DynArrayImpl<0>::AddMultipleAndSet(&v30, 20LL, 1LL, v36);
    v8 = v11;
    if ( v11 >= 0 )
      goto LABEL_30;
...
LABEL_18:
    ...
    *(__m128i *)&v36[4] = v20;
    ...
    if ( v23 > v32 )
    {
      v24 = DynArrayImpl<0>::AddMultipleAndSet(&v30, 20LL, 1LL, v36);
      v8 = v24;
      if ( v24 < 0 )
      {
        v27 = 192;
LABEL_28:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, v27, 0LL);
        v9 = v24;
        v29 = 265;
        goto LABEL_3;
      }
