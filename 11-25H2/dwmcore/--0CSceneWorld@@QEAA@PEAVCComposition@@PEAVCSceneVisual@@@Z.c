/*
 * XREFs of ??0CSceneWorld@@QEAA@PEAVCComposition@@PEAVCSceneVisual@@@Z @ 0x1802B4848
 * Callers:
 ...
 *     ??0CCompositionLight@@QEAA@PEAVCComposition@@_N@Z @ 0x180228610 (--0CCompositionLight@@QEAA@PEAVCComposition@@_N@Z.c)
...
CSceneWorld *__fastcall CSceneWorld::CSceneWorld(CSceneWorld *this, struct CComposition *a2, struct CSceneVisual *a3)
{
  ...
  *(_OWORD *)(v11 + 260) = xmmword_1803C7970;
  *(_OWORD *)(v11 + 276) = xmmword_1803C7980;
  *(_OWORD *)(v11 + 292) = xmmword_1803C7990;
  *(_OWORD *)(v11 + 308) = xmmword_1803C79A0;
  *(_OWORD *)(v11 + 324) = xmmword_1803C79B0;
  *(_OWORD *)(v11 + 340) = xmmword_1803C79C0;
