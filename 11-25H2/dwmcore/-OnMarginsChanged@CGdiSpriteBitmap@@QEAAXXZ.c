/*
 * XREFs of ?OnMarginsChanged@CGdiSpriteBitmap@@QEAAXXZ @ 0x180104764
 * Callers:
  ...
  if ( v2 )
  {
    ...
    while ( v4 != v5 )
    {
      ...
      *(_QWORD *)&v10.cxLeftWidth = 0LL;
      ...
      wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset((__int64 *)&v10.cxLeftWidth);
      if ( v7(v6 + 72, &v10) >= 0 )
      {
      ...
      wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v10.cxLeftWidth);
      ++v4;
    }
  }
}
