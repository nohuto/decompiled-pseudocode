/*
 * XREFs of ?GenerateMaskIntermediate@ShadowHelpers@@YAJAEBVCResourceTag@@PEAVCDrawingContext@@PEBUD2D_SIZE_F@@AEBU4@PEAVCBrush@@PEBVCShape@@_NAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180118F44
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  else
  {
    ...
    *(_QWORD *)&v9 = (unsigned int)`CVisual::SetOpacityInternal'::`2'::sc_defaultValue;
    ...
    TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::Inflate(&v29, a2, 0LL, a4);
    PixelAlign(
      (int *)&v31,
      (unsigned int *)&v29,
  ...
  v43 = 0LL;
  wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset(&v43);
...
LABEL_34:
              ...
              if ( v22 )
              {
                v28 = CDrawingContext::PushClipShapeForCurrentNode((struct CDrawingContext *)a2);
                v17 = v28;
                if ( v28 < 0 )
                {
