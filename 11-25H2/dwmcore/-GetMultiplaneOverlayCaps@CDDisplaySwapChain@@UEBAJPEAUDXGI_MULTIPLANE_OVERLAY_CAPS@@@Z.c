/*
 * XREFs of ?GetMultiplaneOverlayCaps@CDDisplaySwapChain@@UEBAJPEAUDXGI_MULTIPLANE_OVERLAY_CAPS@@@Z @ 0x180246AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_MULTIPLANE_OVERLAY_CAPS *a2)
{
  ...
  *((_DWORD *)a2 + 10) = 0;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x117u, 0LL);
  }
  else
  {
    v34 = 0.0;
    ...
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x11Fu, 0LL);
      }
      else
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x120u, 0LL);
        }
        else
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x121u, 0LL);
          }
          else
          {
            v13 = v32;
            *((float *)a2 + 4) = v34;
            ...
            if ( v14 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x123u, 0LL);
            }
            else
            {
              v15 = v32;
              ...
              *((float *)a2 + 5) = v35;
              ...
              if ( v16 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0x12Au, 0LL);
              }
              else
              {
                ...
                if ( v17 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x12Bu, 0LL);
                }
                else
                {
                  ...
                  if ( v18 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0x12Cu, 0LL);
                  }
                  else
                  {
                    v42 = 0;
                    *((_DWORD *)a2 + 3) |= (v41 != 0 ? 4 : 0) | (v39 != 0) | (v40 != 0 ? 2 : 0);
                    ...
                    if ( v19 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v19, 0x133u, 0LL);
                    }
                    else
                    {
                      v29 = 0;
                      ...
                      *((_DWORD *)a2 + 3) |= v42 != 0 ? 0x40000 : 0;
                      ...
                      if ( v20 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0x13Au, 0LL);
                      }
                      else
                      {
                        ...
                        if ( v21 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x13Bu, 0LL);
                        }
                        else
                        {
                          ...
                          if ( v22 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0x13Cu, 0LL);
                          }
                          else
                          {
                            ...
                            if ( v23 < 0 )
                            {
                              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0x13Eu, 0LL);
                            }
                            else
                            {
                              ...
                              if ( v24 < 0 )
                              {
                                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v24, 0x13Fu, 0LL);
                              }
                              else
                              {
                                v25 = *((_DWORD *)a2 + 1) <= 1u;
                                *((_DWORD *)a2 + 8) |= (v31[0] != 0 ? 4 : 0) | (v29 != 0) | (v30 != 0 ? 2 : 0);
                                if ( !v25 )
                                  *((_DWORD *)a2 + 3) |= 0x20u;
                                if ( *((_DWORD *)a2 + 2) )
                                  *((_DWORD *)a2 + 3) |= 0x40u;
