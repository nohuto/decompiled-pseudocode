/*
 * XREFs of ?GetIntersectingMonitorTargets@CDesktopTree@@QEAAXAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAV?$vector@PEAVIMonitorTarget@@V?$allocator@PEAVIMonitorTarget@@@std@@@std@@@Z @ 0x1802962B0
 * Callers:
...
void __fastcall CDesktopTree::GetIntersectingMonitorTargets(__int64 a1, const struct D2D_RECT_F *a2, __int64 a3)
{
  _QWORD *v3; // rbx
  _QWORD *v5; // r14
