/*
 * XREFs of ?AddOrUpdateTrackerBindings@CInteractionTrackerBindingManager@@AEAAXPEAVCInteractionTracker@@0W4InteractionTrackerBindingModeFlags@@@Z @ 0x1800F7E3C
 * Callers:
 ...
 *     ?_Alloc_sentinel_and_proxy@?$list@U?$pair@QEAVCInteractionTracker@@W4InteractionTrackerBindingModeFlags@@@std@@V?$allocator@U?$pair@QEAVCInteractionTracker@@W4InteractionTrackerBindingModeFlags@@@std@@@2@@std@@AEAAXXZ @ 0x1800F6F8C (-_Alloc_sentinel_and_proxy@-$list@U-$pair@QEAVCInteractionTracker@@W4InteractionTrackerBindingMo.c)
...
{
  float *v4; // rsi
  struct CInteractionTracker *v6; // r15
  _DWORD *v7; // r12
  _QWORD *v9; // r14
  _QWORD *v10; // rbx
  _QWORD *v11; // rdi
  ...
  __int64 v28; // rax
  __int64 v29; // rbx
  int v30; // [rsp+28h] [rbp-79h]
  _QWORD *v31[2]; // [rsp+38h] [rbp-69h] BYREF
  _QWORD *v32[2]; // [rsp+48h] [rbp-59h] BYREF
  __int64 v33; // [rsp+58h] [rbp-49h] BYREF
  __int64 v34[2]; // [rsp+60h] [rbp-41h] BYREF
  ...
  __int64 v40; // [rsp+108h] [rbp+67h] BYREF
  _QWORD *v41; // [rsp+110h] [rbp+6Fh] BYREF
  ...
  if ( v40 == *((_QWORD *)a1 + 11) )
  {
    ...
    v34[0] = 0LL;
    v34[1] = 0LL;
    std::list<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>::_Alloc_sentinel_and_proxy(v34);
    v35 = 0LL;
    v36 = 0LL;
    v37 = 7LL;
    v38 = 8LL;
    ...
    std::_Hash<std::_Umap_traits<CInteractionTracker *,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>>,0>>::emplace<CInteractionTracker * &,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>(
      ...
      (__int64)&v33);
    v6 = v42;
    if ( *((CInteractionTrackerBindingManager **)v42 + 80) != a1 )
    {
    ...
    (*(void (__fastcall **)(struct CInteractionTracker *))(*(_QWORD *)v6 + 8LL))(v6);
    v9 = (_QWORD *)*std::_Hash<std::_Umap_traits<CInteractionTracker *,enum InteractionTrackerBindingModeFlags,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>,0>>::find<void>(
                      v4,
                      &v40,
                      &v42);
    std::_Hash<std::_Umap_traits<CChannelContext *,CAnimationGlobalConfiguration *,std::_Uhash_compare<CChannelContext *,std::hash<CChannelContext *>,std::equal_to<CChannelContext *>>,std::allocator<std::pair<CChannelContext * const,CAnimationGlobalConfiguration *>>,0>>::~_Hash<std::_Umap_traits<CChannelContext *,CAnimationGlobalConfiguration *,std::_Uhash_compare<CChannelContext *,std::hash<CChannelContext *>,std::equal_to<CChannelContext *>>,std::allocator<std::pair<CChannelContext * const,CAnimationGlobalConfiguration *>>,0>>(&v33);
  }
  v10 = v31[0];
  if ( v31[0] == *((_QWORD **)a1 + 11) )
  {
    if ( !a4 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
    ...
    std::_Hash<std::_Umap_traits<CInteractionTracker *,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>>,0>>::emplace<CInteractionTracker * &,std::unordered_map<CInteractionTracker *,enum InteractionTrackerBindingModeFlags>>(
      ...
      (__int64)&v33);
    v7 = v41;
    if ( (CInteractionTrackerBindingManager *)v41[80] != a1 )
    {
      (*(void (__fastcall **)(CInteractionTrackerBindingManager *))(*(_QWORD *)a1 + 8LL))(a1);
      v20 = *((_QWORD *)v7 + 80);
      *((_QWORD *)v7 + 80) = a1;
    ...
    v10 = (_QWORD *)*std::_Hash<std::_Umap_traits<CInteractionTracker *,enum InteractionTrackerBindingModeFlags,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>,0>>::find<void>(
                       v4,
                       &v40,
                       &v41);
    std::_Hash<std::_Umap_traits<CChannelContext *,CAnimationGlobalConfiguration *,std::_Uhash_compare<CChannelContext *,std::hash<CChannelContext *>,std::equal_to<CChannelContext *>>,std::allocator<std::pair<CChannelContext * const,CAnimationGlobalConfiguration *>>,0>>::~_Hash<std::_Umap_traits<CChannelContext *,CAnimationGlobalConfiguration *,std::_Uhash_compare<CChannelContext *,std::hash<CChannelContext *>,std::equal_to<CChannelContext *>>,std::allocator<std::pair<CChannelContext * const,CAnimationGlobalConfiguration *>>,0>>(&v33);
  ...
  v11 = v31[0];
  v12 = v40;
  if ( v31[0] == (_QWORD *)v10[4] || v40 == v9[4] )
  {
    if ( !v43 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
    ...
    *(_WORD *)(v13 + 24) = 257;
    ...
    if ( *((_BYTE *)v15 + 25) || (unsigned __int64)v6 < v15[4] )
      v15 = v31[0];
    if ( v15 == v31[0] && v40 )
    {
      v24 = *(_QWORD *)(*((_QWORD *)a1 + 3) + 824LL);
      WeakRefToSelf = CInteractionTracker::GetWeakRefToSelf(v40);
      v26 = CExpressionManager::LookupExpressionsForTarget(v24, WeakRefToSelf, 1LL);
      v27 = *(_QWORD *)(*((_QWORD *)a1 + 3) + 824LL);
      v28 = CInteractionTracker::GetWeakRefToSelf(v40);
      v29 = CExpressionManager::LookupExpressionsForTarget(v27, v28, 2LL);
      while ( v26 )
      {
        CInteractionTrackerBindingManager::RegisterIndirectTargetsForBoundTrackers(a1, v6, *(_QWORD *)(v26 + 8), 1LL);
        v26 = *(_QWORD *)(v26 + 16);
      }
      while ( v29 )
      {
        CInteractionTrackerBindingManager::RegisterIndirectTargetsForBoundTrackers(a1, v6, *(_QWORD *)(v29 + 8), 2LL);
        v29 = *(_QWORD *)(v29 + 16);
      }
      v14 = v31[0];
    }
    if ( v11 == *((_QWORD **)v32[0] + 1) )
    {
      std::_Hash<std::_Umap_traits<CInteractionTracker *,enum InteractionTrackerBindingModeFlags,std::_Uhash_compare<CInteractionTracker *,std::hash<CInteractionTracker *>,std::equal_to<CInteractionTracker *>>,std::allocator<std::pair<CInteractionTracker * const,enum InteractionTrackerBindingModeFlags>>,0>>::emplace<CInteractionTracker * &,enum InteractionTrackerBindingModeFlags &>(
        ...
        &v42,
        &v43);
      (*(void (__fastcall **)(struct CInteractionTracker *))(*(_QWORD *)v42 + 8LL))(v42);
      v14 = v31[0];
    }
    if ( v12 == v9[4] )
    {
    ...
    std::_Tree_val<std::_Tree_simple_types<CInteractionTracker *>>::_Erase_tree<std::allocator<std::_Tree_node<CInteractionTracker *,void *>>>(
      ...
      v31,
      v14[1]);
    std::_Deallocate<16,0>(v31[0], 0x28uLL);
  }
  else
  {
    v17 = v43;
