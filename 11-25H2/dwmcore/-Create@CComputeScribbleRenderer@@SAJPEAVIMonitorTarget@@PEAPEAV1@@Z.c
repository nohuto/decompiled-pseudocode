/*
 * XREFs of ?Create@CComputeScribbleRenderer@@SAJPEAVIMonitorTarget@@PEAPEAV1@@Z @ 0x1802907AC
 * Callers:
        ...
        struct CComputeScribbleRenderer **a2)
{
  ...
  CGlobalDrawingContext *v12; // [rsp+40h] [rbp+8h] BYREF
