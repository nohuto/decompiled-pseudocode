/*
 * XREFs of ?IsCandidateOverlayCompatible@COverlayContext@@AEBA_NPEAVCVisual@@PEBVCCompositionSurfaceInfo@@PEAVISwapChainRealization@@AEAUDXGI_MULTIPLANE_OVERLAY_ATTRIBUTES@@W4OverlaySize@@_NI5@Z @ 0x180276E90
 * Callers:
        ...
        char a9)
{
    ...
    && !IsRectEmpty((const RECT *)(a5 + 36)) )
  {
    ...
    {
      if ( a9 && *((_BYTE *)a1 + 19777) || *((_BYTE *)a1 + 19768) || a8 > 2 )
        return 1;
    }
