/*
 * XREFs of ?Copy@CEdgeFlagsMap@@QEAAXAEBV1@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x180196524
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  std::_Variant_base<std::monostate,CEdgeFlagsMap::CRectangleMapStrategy,CEdgeFlagsMap::CPolygonMapStrategy>::_Reset();
  ...
  if ( v7 )
  {
    ...
    CEdgeFlagsMap::AddEdgeFlags(
      ...
      &v17,
      v14,
      (unsigned __int64)v16 & -(__int64)(a3 != 0LL),
