/*
 * XREFs of ?Clear@CMatrixStack2D@@QEAAXXZ @ 0x1800147D4
 * Callers:
  ...
  if ( v9 > 1 )
  {
    if ( !v8 || v1 && v8 >= 0 )
    {
      *((_QWORD *)&v22 + 1) = v8;
      v23 = v8;
      *(_QWORD *)&v22 = v1;
      ((void (__fastcall *)(__int128 *, unsigned __int64, __int64, __int128 *))std::move_backward<std::move_iterator<D2D1::Matrix3x2F *>,stdext::checked_array_iterator<D2D1::Matrix3x2F *>>)(
        &v24,
        v1 + 24 * v6,
        v1 + 24 * (v8 - 1),
        &v22);
