/*
 * XREFs of ??0CSpectreCallbackRenderer@@AEAA@PEAUISpectreWorld@@AEBUD2D_MATRIX_4X4_F@@AEBUD2D_VECTOR_3F@@MMV?$span@PEAVCCompositionLight@@$0?0@gsl@@@Z @ 0x180290F94
 * Callers:
        ...
        __int64 *a7)
{
  ...
  *(_DWORD *)(a1 + 112) = a6;
  ...
  v13 = v12.m128i_i64[1];
  v14 = v12;
  std::vector<CCompositionLight *>::vector<CCompositionLight *>((_QWORD *)(a1 + 120), &v14, &v12);
  return a1;
}
