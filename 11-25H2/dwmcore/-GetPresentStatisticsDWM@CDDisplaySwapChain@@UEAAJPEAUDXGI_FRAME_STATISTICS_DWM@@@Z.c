/*
 * XREFs of ?GetPresentStatisticsDWM@CDDisplaySwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@@Z @ 0x180140880
 * Callers:
        ...
        struct DXGI_FRAME_STATISTICS_DWM *a2)
{
  ...
  {
    v8 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304442, 0x104u, 0LL);
    return v8;
  }
  v19 = 0LL;
  v21 = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0xDCu, 0LL);
    }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0xDAu, 0LL);
LABEL_4:
  if ( v19 )
    (*(void (__fastcall **)(__int64))(*(_QWORD *)v19 + 16LL))(v19);
  if ( v20 )
