/*
 * XREFs of ?CleanTreeAndLockForRead@CDesktopTree@@QEAAJXZ @ 0x180135730
 * Callers:
...
__int64 __fastcall CDesktopTree::CleanTreeAndLockForRead(CDesktopTree *this)
{
  ...
  for ( i = (RTL_SRWLOCK *)*((_QWORD *)this + 3); ; i = (RTL_SRWLOCK *)*((_QWORD *)this + 3) )
  {
    ...
    CTreeLock::ReleaseShared((CTreeLock *)(*((_QWORD *)this + 3) + 5704LL));
    _wait___event_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEBA_NKH_Z(*((_QWORD *)this + 3) + 6432LL);
  }
  return v2;
}
