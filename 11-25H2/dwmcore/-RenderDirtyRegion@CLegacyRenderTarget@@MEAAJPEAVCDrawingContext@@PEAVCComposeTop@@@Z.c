/*
 * XREFs of ?RenderDirtyRegion@CLegacyRenderTarget@@MEAAJPEAVCDrawingContext@@PEAVCComposeTop@@@Z @ 0x180052B90
 * Callers:
        ...
        struct CComposeTop *a3)
{
  ...
  int v26; // eax
  __int64 v27; // rax
  const struct CMILMatrix *(__fastcall *v28)(CLegacyRenderTarget *__hidden); // rax
  ...
  struct D2D_POINT_2F v91; // [rsp+F0h] [rbp-10h] BYREF
  ...
  v74 = 0;
  v6 = a2;
  OcclusionContext = CMonitorDirty::GetOcclusionContext((CLegacyRenderTarget *)((char *)this + 31152));
  *((_DWORD *)OcclusionContext + 390) = 0x7FFFFFFF;
  if ( !*((_BYTE *)this + 31608) )
    CMergedRectBase<8>::Optimize((char *)this + 31168);
  v8 = *((unsigned int *)this + 7792);
  if ( this == (CLegacyRenderTarget *)-31172LL && MEMORY[0xFFFFFFFFFFFFFFFC] )
  {
  ...
  v10 = (CDrawingContext **)*((_QWORD *)this + 4188);
  v88 = *((_OWORD *)this + 2093);
  v89 = v10;
  CDesktopTree::UpdateCVIRenderTargets(v9);
  v11 = (CDirectFlipInfo *)*((_QWORD *)this + 2495);
  if ( !v11 )
    goto LABEL_7;
  v62 = *((_DWORD *)v11 + 13);
  ...
  if ( !v63 )
  {
    if ( !CDirectFlipInfo::PresentNeeded(*((CDirectFlipInfo **)this + 2495)) )
      return v5;
LABEL_7:
    if ( *((_BYTE *)this + 19689) || !*((_BYTE *)this + 31145) )
    {
LABEL_9:
      v12 = *(__int64 (__fastcall **)(CLegacyRenderTarget *))(*(_QWORD *)this + 208LL);
      if ( (char *)v12 == (char *)&CLegacyRenderTarget::GetClearMode )
      {
        v13 = (CDirectFlipInfo *)*((_QWORD *)this + 2495);
        v14 = 0;
        if ( v13 )
        {
          v14 = *((_DWORD *)v13 + 13);
      ...
      if ( v15 == CLegacyRenderTarget::UseSuperSample )
        ...
        v17 = v15(v16);
      v19 = (float *)((char *)this + 31180);
      v20 = (float *)((char *)this + 16 * v8 + 31172);
      v73 = v17;
      while ( 1 )
      {
        v21 = v19 - 2;
        ...
        v23 = v19[1] - *(v19 - 1);
        v87 = 0LL;
        dword_1804067C8 += (int)(float)(v22 * v23);
        v24 = *((_DWORD *)v19 - 1);
        v25 = (CVisualTree *)*((_QWORD *)this + 14);
        *(float *)&v86 = *v21;
        ...
        *((float *)&v86 + 3) = v19[1];
        ...
        if ( v26 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x303u, 0LL);
          goto LABEL_47;
        }
        v27 = *((_QWORD *)this + 11);
        *(_OWORD *)v85 = 0LL;
        v86 = 0LL;
        v28 = *(const struct CMILMatrix *(__fastcall **)(CLegacyRenderTarget *__hidden))(v27 + 64);
        if ( v28 == CLegacyRenderTarget::GetDeviceTransform )
          Transform = CMonitorTransform::GetTransform(
                        (CLegacyRenderTarget *)((char *)this + 30888),
                        *((_BYTE *)this + 19689));
        else
        ...
        {
          CMILMatrix::Transform2DRectToPerspective((CMILMatrix *)v31, (const struct D2D_RECT_F *)(v19 - 2), &v91);
          *(_QWORD *)&v88 = 4LL;
          *((_QWORD *)&v88 + 1) = &v91;
        ...
        *((_BYTE *)this + 33896) = 1;
        if ( v51 )
        {
          ...
          if ( v60 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v60, 0x30Bu, 0LL);
            goto LABEL_47;
          }
        }
        v19 += 4;
...
LABEL_47:
    ...
    *((float *)&v86 + 3) = v54;
    ...
    if ( v55 >= 0 )
    {
      v5 = (**((__int64 (__fastcall ***)(__int64, __int128 *))v6 + 2))((__int64)v6 + 16, &v88);
      ...
      if ( (v5 & 0x80000000) == 0 )
      {
        (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*((_QWORD *)this + 25) + 24LL) + 112LL))(
          *((_QWORD *)this + 25) + 24LL,
          0LL);
        *((_BYTE *)this + 33896) = 1;
        CMonitorDirty::SetFullTightDirtyRegion((CLegacyRenderTarget *)((char *)this + 31152));
        *((_BYTE *)this + 31145) = 0;
        goto LABEL_9;
      }
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x2E5u, 0LL);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v55, 0x2DDu, 0LL);
    }
LABEL_48:
    if ( v74 )
      CDrawingContext::PopRenderTargetInternal(v6, 0);
    return v5;
  }
  v64 = v63 - 1;
  if ( !v64 )
...
LABEL_88:
  ...
  if ( (unsigned int)(v64 - 1) > 1 )
    goto LABEL_7;
  v65 = (CDirectFlipInfo *)*((_QWORD *)this + 2495);
  if ( *((int *)v65 + 13) < 3 )
  {
    v69 = 0x7FFFFFFF;
  }
  ...
  *((_DWORD *)OcclusionContext + 390) = v69;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v71, 0x2C8u, 0LL);
  if ( v85[0] )
    (*(void (__fastcall **)(struct IDeviceTarget *))(*(_QWORD *)v85[0] + 16LL))(v85[0]);
  return v5;
}
