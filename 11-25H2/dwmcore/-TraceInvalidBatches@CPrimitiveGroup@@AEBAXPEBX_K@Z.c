/*
 * XREFs of ?TraceInvalidBatches@CPrimitiveGroup@@AEBAXPEBX_K@Z @ 0x1802AB9AC
 * Callers:
...
void __fastcall CPrimitiveGroup::TraceInvalidBatches(CPrimitiveGroup *this, char *a2, unsigned int a3)
{
  ...
  for ( i = 0; i + 144 <= a3; i += 144 )
  {
    ...
    {
      if ( (unsigned int)dword_180404D18 > 4 && tlgKeywordOn((__int64)&dword_180404D18, 16LL) )
      {
        v10 = *(_DWORD *)(v7 + 4);
        v11 = *(_DWORD *)(v7 + 12);
        v21 = &v10;
        ...
        v18 = 8LL;
        v16 = v9;
        tlgWriteTransfer_EventWriteTransfer(v6, byte_1803D9CAC, 0LL, 0LL, 6u, &v14);
      }
      return;
    }
  }
