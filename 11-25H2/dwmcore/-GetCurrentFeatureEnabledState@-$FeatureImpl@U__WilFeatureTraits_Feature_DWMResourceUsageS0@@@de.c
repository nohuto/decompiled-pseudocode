/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DWMResourceUsageS0@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180289720
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DWMResourceUsageS0>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        int *a4)
{
  ...
  *(_DWORD *)a2 = v9;
  ...
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_CadBugs>::ReportUsage(
      `wil::Feature<__WilFeatureTraits_Feature_CadBugs>::GetImpl'::`2'::impl,
      v9,
      3072LL,
      v6);
    v10 = 1;
