/*
 * XREFs of ?UpdateAttributes@CDxHandleBitmapRealization@@UEAAXAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x180062D30
 * Callers:
...
LABEL_24:
  if ( (v30 > v27 && v31 > v29 || !TMilRect<int,tagRECT,D2D_POINTANDSIZE_L,RectUniqueness::_CMilRectL_>::IsEmpty(v28))
    && ((v27 != 0x80000000 || v30 != 0x7FFFFFFF) && (v29 != 0x80000000 || v31 != 0x7FFFFFFF)
     || !(unsigned __int8)TMilRect<int,tagRECT,D2D_POINTANDSIZE_L,RectUniqueness::_CMilRectL_>::IsInfinite()) )
  {
    *((_BYTE *)this - 8) = 0;
  }
}
