/*
 * XREFs of ?TransitionToInertia@CInteractionTracker@@AEAA_NW4InertiaReason@1@@Z @ 0x1800EFE88
 * Callers:
...
LABEL_9:
  ...
  else if ( !a2 )
  {
    ...
    *(_DWORD *)(v11 + 528) = v13;
    ...
    do
    {
      ...
      CScrollAnimation::StartInertia(v17, *(float *)&CurrentValue, 0);
      *((_BYTE *)v17 + 380) |= 1u;
      ++v12;
    }
    while ( v12 != v27 );
  ...
  CInteractionTracker::SetState(a1, 2LL, 0LL);
  return v6;
}
