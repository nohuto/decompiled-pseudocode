/*
 * XREFs of ?reserve_region@?$vector_facade@UCachedBlur@CBlurredBackdropCache@@V?$buffer_impl@UCachedBlur@CBlurredBackdropCache@@$01$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAUCachedBlur@CBlurredBackdropCache@@_K0@Z @ 0x18003FDE4
 * Callers:
  ...
  *(_QWORD *)&v18 = v8;
  ...
  if ( v6 != (_QWORD *)((char *)v6 - v10) )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(v17 - 16) = *v6;
      *(_QWORD *)(v17 - 8) = v6[1];
      detail::construct<EffectInput,EffectInput>(v17, v6 + 2);
    }
    while ( v6 != v23 );
    v8 = (CBlurredBackdropCache::CachedBlur *)(v5 + (v7 << 7));
  }
