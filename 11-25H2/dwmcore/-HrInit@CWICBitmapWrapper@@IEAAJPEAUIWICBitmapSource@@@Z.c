/*
 * XREFs of ?HrInit@CWICBitmapWrapper@@IEAAJPEAUIWICBitmapSource@@@Z @ 0x1801DCCF8
 * Callers:
 ...
 *     ?HrWicPfToMil@@YAJAEBU_GUID@@PEAW4Enum@MilPixelFormat@@@Z @ 0x1801DCE68 (-HrWicPfToMil@@YAJAEBU_GUID@@PEAW4Enum@MilPixelFormat@@@Z.c)
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            *((float *)this + 24) = v15;
            *((float *)this + 25) = v12;
            wil::com_ptr_t<ID3D12CommandQueue,wil::err_returncode_policy>::operator=((char *)this + 136, a2);
          }
        }
      }
    }
