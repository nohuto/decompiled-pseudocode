/*
 * XREFs of ??$MakeAndInitialize@V?$ValueReference@I@@U?$IReference@I@Foundation@Windows@@AEAI@Details@WRL@Microsoft@@YAJPEAPEAU?$IReference@I@Foundation@Windows@@AEAI@Z @ 0x180234EAC
 * Callers:
 ...
 *     ??0?$IIterable@PEAU?$IKeyValuePair@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1802CA00C (--0-$IIterable@PEAU-$IKeyValuePair@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@@C.c)
