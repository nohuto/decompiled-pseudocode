/*
 * XREFs of ?OpenSharedSurfaceRenderTarget@CMagnifierRenderTarget@@AEAAJPEAXU_LUID@@PEAUHMONITOR__@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18028F1B0
 * Callers:
        ...
        struct IRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  if ( a4 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v10, 0x1DBu, 0LL);
      goto LABEL_9;
    }
  }
  else
  ...
  if ( Device < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, Device, 0x1E3u, 0LL);
  }
  else
  {
    ...
    if ( RenderTargetBitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, RenderTargetBitmap, 0x1EBu, 0LL);
  }
LABEL_9:
