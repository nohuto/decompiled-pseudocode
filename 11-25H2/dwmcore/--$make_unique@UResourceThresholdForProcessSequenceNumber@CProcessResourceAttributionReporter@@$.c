/*
 * XREFs of ??$make_unique@UResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@$$V$0A@@std@@YA?AV?$unique_ptr@UResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@U?$default_delete@UResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@@std@@@0@XZ @ 0x180237E14
 * Callers:
