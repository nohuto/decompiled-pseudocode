/*
 * XREFs of ?CalcPresentMode@CConversionSwapChain@@IEAAJPEAI@Z @ 0x1801731D8
 * Callers:
...
__int64 __fastcall CConversionSwapChain::CalcPresentMode(CConversionSwapChain *this, unsigned int *a2)
{
  ...
  int v20[6]; // [rsp+40h] [rbp-18h] BYREF
  ...
  *a2 = v5;
  ...
  if ( v10 )
  {
    ...
    {
      v4 = -2003292412;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x243u, 0LL);
    }
  }
  else
  {
          ...
          if ( v16 >= 0 )
          {
            ...
            if ( v17 >= 0 && *(_DWORD *)((char *)this + v14 + 612) == 1 )
            {
              ...
              v2 = CLegacySwapChain::CheckDirectFlipSupport(
                     ...
                     v18,
                     *(enum DXGI_COLOR_SPACE_TYPE *)((char *)this + v14 + 636),
                     v20,
                     v19);
            }
          }
