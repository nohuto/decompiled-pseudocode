/*
 * XREFs of ?GetBits@COffScreenRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x18028AAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IBitmapDest *a3)
{
  ...
  if ( **((_QWORD **)this + 330) )
  {
    ...
    if ( TMilRect<int,tagRECT,D2D_POINTANDSIZE_L,RectUniqueness::_CMilRectL_>::IntersectUnsafe(v10, (int *)&v9) )
    {
      ...
      v6 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x1ECu, 0LL);
    }
  }
  else
  {
    v6 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304442, 0x1E4u, 0LL);
  }
  return v6;
}
