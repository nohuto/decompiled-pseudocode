/*
 * XREFs of ?CreateRenderDataBuilder@CChannel@@UEAAJPEAPEAUIRenderDataBuilder@@@Z @ 0x1801FF5C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CRenderDataBuilder@@AEAA@XZ @ 0x1801FF64C (--0CRenderDataBuilder@@AEAA@XZ.c)
