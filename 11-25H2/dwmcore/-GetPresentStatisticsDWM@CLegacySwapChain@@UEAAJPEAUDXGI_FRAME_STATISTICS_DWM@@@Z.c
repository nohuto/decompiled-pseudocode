/*
 * XREFs of ?GetPresentStatisticsDWM@CLegacySwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@@Z @ 0x180141F70
 * Callers:
...
__int64 __fastcall CLegacySwapChain::GetPresentStatisticsDWM(union _LARGE_INTEGER *this, union _LARGE_INTEGER *a2)
{
  ...
  if ( v4.QuadPart )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180337F68, 3u, v5, 0xF1u, 0LL);
    }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180337F68, 3u, -2003304307, 0x128u, 0LL);
    return 2291662989LL;
  }
}
