/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCCompositionLight@@@?$vector@PEAVCCompositionLight@@V?$allocator@PEAVCCompositionLight@@@std@@@std@@AEAAPEAPEAVCCompositionLight@@QEAPEAV2@AEBQEAV2@@Z @ 0x1800C179C
 * Callers:
...
char *__fastcall std::vector<CCompositionLight *>::_Emplace_reallocate<CCompositionLight * const &>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
