/*
 * XREFs of ?Map@CD3DDevice@@QEAAJPEAUID3D11Resource@@IW4D3D11_MAP@@IPEAUD3D11_MAPPED_SUBRESOURCE@@@Z @ 0x180142820
 * Callers:
        ...
        struct D3D11_MAPPED_SUBRESOURCE *a6)
{
  ...
  else
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0xA0Du, 0LL);
  }
  if ( *((_DWORD *)this + 278)
...
LABEL_9:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v8, 0LL, &v13) )
  {
    ...
    v8 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0xB4Du, 0LL);
  }
