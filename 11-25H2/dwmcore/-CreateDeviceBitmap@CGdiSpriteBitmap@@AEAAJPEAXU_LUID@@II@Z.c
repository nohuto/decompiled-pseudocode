/*
 * XREFs of ?CreateDeviceBitmap@CGdiSpriteBitmap@@AEAAJPEAXU_LUID@@II@Z @ 0x180104D8C
 * Callers:
 ...
 *     ?RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ @ 0x18021491C (-RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ.c)
        ...
        unsigned int a5)
{
  ...
  int v11; // eax
  struct IGDIBitmapRealization *v12; // rdi
  int v13; // eax
  __int64 v14; // rcx
...
LABEL_9:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x5Au, 0LL);
  if ( v19 )
...
LABEL_10:
  ...
  {
    v16 = CGdiSpriteBitmap::RegisterWithSurfaceManager(this);
    v15 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0x7Au, 0LL);
  }
  else
  {
