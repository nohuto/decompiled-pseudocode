/*
 * XREFs of ?EmitGeometry@CMegaRectBatchCommand@@QEBAJPEAVCD3DBatchExecutionContext@@@Z @ 0x180163A80
 * Callers:
...
LABEL_64:
    ...
    else
    {
      ...
      v126 = v125;
      if ( v125 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v125, 0xA0Du, 0LL);
    }
    if ( !*(_DWORD *)(v123 + 1112)
...
LABEL_126:
      *(float *)&m21_low = 0.0;
      if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext(v126, 0, &m21_low) )
      {
        ...
        if ( v134 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v134, 0xB4Du, v127);
          v127 = 0LL;
        }
      }
      v93 = v126;
