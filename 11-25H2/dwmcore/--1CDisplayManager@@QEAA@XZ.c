/*
 * XREFs of ??1CDisplayManager@@QEAA@XZ @ 0x1802573A8
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DisplayManager__ @ 0x1802E8F80 (_dynamic_atexit_destructor_for__g_DisplayManager__.c)
 * Callees:
...
void __fastcall CDisplayManager::~CDisplayManager(CDisplayManager *this)
{
  ...
  wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::~unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>((void **)this + 8);
