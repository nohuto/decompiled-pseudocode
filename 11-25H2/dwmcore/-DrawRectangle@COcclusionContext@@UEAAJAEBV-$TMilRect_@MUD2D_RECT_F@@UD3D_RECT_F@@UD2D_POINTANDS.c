/*
 * XREFs of ?DrawRectangle@COcclusionContext@@UEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAVCLegacyMilBrush@@@Z @ 0x1801EDED0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsConstantOpaque@CSolidColorLegacyMilBrush@@UEBA_NXZ @ 0x1801EE000 (-IsConstantOpaque@CSolidColorLegacyMilBrush@@UEBA_NXZ.c)
...
__int64 __fastcall COcclusionContext::DrawRectangle(__int64 a1, __int64 a2, CSolidColorLegacyMilBrush *a3)
{
  ...
  if ( (char *)v10 == (char *)CSolidColorLegacyMilBrushGeneratedT<CSolidColorLegacyMilBrush,CLegacyMilBrush>::IsOfType )
    v11 = CSolidColorLegacyMilBrushGeneratedT<CSolidColorLegacyMilBrush,CLegacyMilBrush>::IsOfType(a3, 83LL);
  else
    v11 = v10(a3, 83LL);
  if ( v11 )
  {
