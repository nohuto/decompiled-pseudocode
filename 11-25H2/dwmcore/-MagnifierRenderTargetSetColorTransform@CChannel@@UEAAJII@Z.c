/*
 * XREFs of ?MagnifierRenderTargetSetColorTransform@CChannel@@UEAAJII@Z @ 0x18026E470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetColorTransform(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 26);
  v8[0] = 226;
  v8[1] = a2;
  v8[2] = a3;
