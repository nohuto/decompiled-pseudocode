/*
 * XREFs of ?GetWorldBounds@CRenderingBatchCommand@@QEBAXPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18009F580
 * Callers:
...
void __fastcall CRenderingBatchCommand::GetWorldBounds(__int64 a1, __m128 *a2)
{
  int v4; // ecx
  __int64 v5; // rax
  float *v6; // rcx
  ...
  if ( !v4 )
  {
    ...
    if ( (_DWORD)v13 )
    {
      ...
      v72.top = v14;
      *a2 = _mm_mul_ps(_mm_cvtepi32_ps(_mm_loadu_si128((const __m128i *)&v72)), (__m128)_xmm);
    }
    else
    {
      a2->m128_u64[1] = 0LL;
  ...
  if ( v4 != 1 )
  {
    ...
    else
    {
      ...
      {
LABEL_5:
        a2->m128_f32[0] = v7 + *(float *)(a1 + 64);
        a2->m128_f32[1] = v8 + *(float *)(a1 + 68);
        a2->m128_f32[2] = v9 + *(float *)(a1 + 64);
        a2->m128_f32[3] = v10 + *(float *)(a1 + 68);
        return;
      }
...
LABEL_31:
  ...
  if ( !(_DWORD)v22 && *(float *)(a1 + 104) == *(float *)(v5 + 100) && *(float *)(a1 + 108) == *(float *)(v5 + 104) )
  {
    ...
    CMILMatrix::Transform2DBoundsHelper<0>(a1 + 16, &v72, a2);
    return;
  }
  v23 = *(float *)(a1 + 104);
  v24 = *(float *)(a1 + 108);
...
LABEL_45:
  ...
  {
    a2->m128_f32[0] = v41 + v49[12];
    a2->m128_f32[1] = v43 + v49[13];
    a2->m128_f32[2] = v42 + v49[12];
    a2->m128_f32[3] = v44 + v49[13];
  }
