/*
 * XREFs of ?EnableDirectFlip@CGlobalCompositionSurfaceInfo@@UEAAJ_K_NPEAVIOverlaySwapChain@@@Z @ 0x180234990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IOverlaySwapChain *a4)
{
  ...
  else
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x126u, 0LL);
  }
  return v5;
}
