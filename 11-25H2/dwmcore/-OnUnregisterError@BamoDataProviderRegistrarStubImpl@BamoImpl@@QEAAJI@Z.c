/*
 * XREFs of ?OnUnregisterError@BamoDataProviderRegistrarStubImpl@BamoImpl@@QEAAJI@Z @ 0x18027B1CC
 * Callers:
...
LABEL_7:
  ...
  v10[1] = v13;
  return CoreUICallSend(v14, v10, 2LL, 3LL, 1, &unk_18038ED05, a2, v9, v12);
}
