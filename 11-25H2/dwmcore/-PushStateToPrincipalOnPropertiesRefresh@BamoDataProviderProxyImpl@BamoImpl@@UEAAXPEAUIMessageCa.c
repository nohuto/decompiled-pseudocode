/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoDataProviderProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x180288400
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BaseBamoPeerImpl *a3)
{
  ...
  v6 = CoreUICallSend(a2, &v14, 2LL, 7LL, 14, &unk_18038ED05, v10, v12, v14);
  if ( v6 < 0 )
  ...
  v14 = *((unsigned int *)a3 + 9);
  v15 = *((unsigned int *)a3 + 10);
  v7 = CoreUICallSend(a2, &v14, 2LL, 7LL, 13, &unk_18038ED05, v11, v13, v14);
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x2AAA,
