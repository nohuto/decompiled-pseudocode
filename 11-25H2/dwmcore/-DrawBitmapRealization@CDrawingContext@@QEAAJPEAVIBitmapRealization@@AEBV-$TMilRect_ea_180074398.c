/*
 * XREFs of ?DrawBitmapRealization@CDrawingContext@@QEAAJPEAVIBitmapRealization@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@1_NHM@Z @ 0x180074398
 * Callers:
 ...
 *     ?InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x180074420 (-InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSI.c)
        ...
        int a7)
{
  ...
  v10 = CDrawingContext::DrawBitmapRealization(v9, v8, v7, (const struct D2D1::Matrix3x2F *)v14, a5, a6, a7);
  v11 = v10;
  if ( v10 >= 0 )
    return 0LL;
