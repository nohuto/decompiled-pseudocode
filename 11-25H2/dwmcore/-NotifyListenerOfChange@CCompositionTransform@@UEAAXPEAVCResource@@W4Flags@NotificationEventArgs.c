/*
 * XREFs of ?NotifyListenerOfChange@CCompositionTransform@@UEAAXPEAVCResource@@W4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1801FA650
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CCompositionTransform::NotifyListenerOfChange(__int64 a1, _DWORD *a2)
{
  ...
  {
    CResource::NotifyOnChanged(a2, 2u, a1);
  }
