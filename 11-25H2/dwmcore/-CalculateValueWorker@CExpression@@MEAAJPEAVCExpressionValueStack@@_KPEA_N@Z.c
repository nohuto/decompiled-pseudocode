/*
 * XREFs of ?CalculateValueWorker@CExpression@@MEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1802404F0
 * Callers:
 ...
 *     ??H?$checked_array_iterator@PEAUNodesDataBookmark@CExpression@@@stdext@@QEBA?AV01@_J@Z @ 0x1802A432C (--H-$checked_array_iterator@PEAUNodesDataBookmark@CExpression@@@stdext@@QEBA-AV01@_J@Z.c)
 ...
 *     asinf_0 @ 0x1802E8848 (asinf_0.c)
 *     atan2f_0 @ 0x1802E8854 (atan2f_0.c)
 *     atanf_0 @ 0x1802E8860 (atanf_0.c)
        ...
        *((_DWORD *)a2 + 2) = v56 + 1;
        ...
        else
        {
          if ( *(_DWORD *)(v59 + 8) != 2 )
          {
            ...
            v27 = -2147418113;
LABEL_528:
            MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803C7480, 2u, v60, v61, 0LL);
            v28 = 613;
            goto LABEL_710;
          }
      ...
      case 0x11:
        ...
        else
        {
          ...
          else
          {
            ...
            xmmword_1804069C0 = 0LL;
            xmmword_1804069D0 = 0LL;
            xmmword_1804069E0 = 0LL;
            v591 = 0LL;
            qword_1804069F0 = 0LL;
            if ( v76 )
            {
...
LABEL_709:
        ...
        v28 = 1033;
LABEL_710:
        MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803C7480, 2u, v27, v28, 0LL);
        if ( (*(_DWORD *)(*((_QWORD *)this + 39) + 4LL) & 0x40000000) != 0 )
        {
          ...
          if ( (unsigned int)v516 >= 4
            ...
            && (byte_180404D28 & 4) != 0
            && (qword_180404D30 & 4) == qword_180404D30 )
          {
            v529 = v27;
            v532 = *(_DWORD *)(v520 + i);
            ...
            tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180404D18, byte_1803D8E8F, 0LL, 0LL, 5u, &v637);
          }
        }
        v259 = v625;
        v260 = Src;
