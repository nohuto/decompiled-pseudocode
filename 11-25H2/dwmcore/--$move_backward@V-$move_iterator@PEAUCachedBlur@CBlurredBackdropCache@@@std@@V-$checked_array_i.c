/*
 * XREFs of ??$move_backward@V?$move_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@std@@V?$checked_array_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@stdext@@V?$move_iterator@PEAUCachedBlur@CBlurredBackdropCache@@@0@0V12@@Z @ 0x1802B4F70
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  while ( a2 != v7 )
  {
    ...
    *v8 = *(_QWORD *)v7;
    v8[1] = *((_QWORD *)v7 + 1);
    EffectInput::operator=((__int64)(v8 + 2), (__int64)(v7 + 16));
  }
  result = a1;
