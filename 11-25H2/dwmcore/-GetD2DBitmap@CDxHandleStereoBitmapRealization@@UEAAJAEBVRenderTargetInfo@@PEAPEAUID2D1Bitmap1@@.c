/*
 * XREFs of ?GetD2DBitmap@CDxHandleStereoBitmapRealization@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802E1F10
 * Callers:
 *     ?GetD2DBitmap@CDxHandleStereoBitmapRealization@@WBAA@EAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802E1FF0 (-GetD2DBitmap@CDxHandleStereoBitmapRealization@@WBAA@EAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitma.c)
 * Callees:
        ...
        char a4)
{
  ...
  *a3 = 0LL;
  v4 = (CD2DBitmapCache *)(this - 10);
  v9 = CDxHandleStereoBitmapRealization::EnsureD2DBitmap((CDxHandleStereoBitmapRealization *)(this - 10));
  v10 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x69u, 0LL);
  }
  ...
  {
    v12 = CD2DBitmapCache::GetCachedBitmap(this[41], a2, a3, a4);
    v10 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x75u, 0LL);
  }
  return v10;
}
