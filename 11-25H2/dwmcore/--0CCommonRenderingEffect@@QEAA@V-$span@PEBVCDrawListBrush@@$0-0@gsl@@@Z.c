/*
 * XREFs of ??0CCommonRenderingEffect@@QEAA@V?$span@PEBVCDrawListBrush@@$0?0@gsl@@@Z @ 0x18010F630
 * Callers:
    ...
    if ( v11 )
    {
      ...
      *(_QWORD *)(a1 + 24 * v4 + 24) = v16;
      if ( v16 )
      {
        ...
        {
          CGDISectionBitmapRealization::AddRef(v16);
        }
        else
        {
          ((void (__fastcall *)(volatile signed __int32 *, __int64 (__fastcall *)(_QWORD), __int64 (__fastcall *)(CEffectIntermediateProducer *)))v18)(
            v16,
