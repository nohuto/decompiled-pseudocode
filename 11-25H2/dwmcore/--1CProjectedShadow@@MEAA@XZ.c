/*
 * XREFs of ??1CProjectedShadow@@MEAA@XZ @ 0x1801E34FC
 * Callers:
...
void __fastcall CProjectedShadow::~CProjectedShadow(CProjectedShadow *this)
{
  ...
  *(_QWORD *)this = &CProjectedShadow::`vftable';
  ...
  wil::com_ptr_t<IBitmapResource,wil::err_returncode_policy>::~com_ptr_t<IBitmapResource,wil::err_returncode_policy>((CResource **)this + 43);
