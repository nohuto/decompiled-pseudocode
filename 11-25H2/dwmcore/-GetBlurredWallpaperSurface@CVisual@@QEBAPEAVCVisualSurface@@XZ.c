/*
 * XREFs of ?GetBlurredWallpaperSurface@CVisual@@QEBAPEAVCVisualSurface@@XZ @ 0x18016FE94
 * Callers:
...
struct CVisualSurface *__fastcall CVisual::GetBlurredWallpaperSurface(CVisual *this)
{
  ...
  if ( (**((_DWORD **)this + 29) & 0x10000) == 0 )
    return 0LL;
  Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(*((_QWORD *)this + 29), 16LL);
  if ( Slot >= *(_DWORD *)(v2 + 4) )
    v3 = 0LL;
  else
