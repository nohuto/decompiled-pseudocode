/*
 * XREFs of ?AddBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x18006FF08
 * Callers:
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  v4 = *(_QWORD *)a2;
  v18 = 0LL;
  if ( (*(unsigned __int8 (__fastcall **)(struct CBrush *, __int64))(v4 + 64))(a2, 56LL) )
  {
    v16 = 0LL;
    v15 = &v18;
    v17 = 1;
...
LABEL_16:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CBrush *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 106LL) )
  {
    v16 = 0LL;
    v15 = &v18;
    v17 = 1;
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CBrush *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 125LL) )
  {
    v16 = 0LL;
    v15 = &v18;
    v17 = 1;
  ...
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct CBrush *, __int64))(*(_QWORD *)a2 + 64LL))(a2, 112LL) )
    {
      v9 = -2147467263;
      v14 = 180;
      goto LABEL_16;
