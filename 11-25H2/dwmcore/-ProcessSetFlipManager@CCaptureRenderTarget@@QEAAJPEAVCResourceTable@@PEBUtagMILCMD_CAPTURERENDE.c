/*
 * XREFs of ?ProcessSetFlipManager@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURERENDERTARGET_SETFLIPMANAGER@@@Z @ 0x1800FEDF8
 * Callers:
        ...
        const struct tagMILCMD_CAPTURERENDERTARGET_SETFLIPMANAGER *a3)
{
  ...
  v5 = OpenFlipProducer(*((_QWORD *)a3 + 1), (char *)this + 3024, (char *)this + 3040);
  if ( v5 >= 0 )
  {
    v7 = *((_QWORD *)this + 378);
    ...
    v9 = v8(v7, 0LL, 0LL, (char *)this + 3032);
    v6 = v9;
    if ( v9 < 0 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0x2Bu, 0LL);
    return 0;
  }
  return v6;
}
