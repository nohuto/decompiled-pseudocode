/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@M@@QEAAJPEAVCD3DDevice@@W4D3D11_USAGE@@@Z @ 0x18018E7B8
 * Callers:
  ...
  if ( !*a1 )
  {
    ...
    *a1 = 0LL;
    ...
    else
    {
      ...
      v5 = v6;
      if ( v6 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x69Fu, 0LL);
    }
