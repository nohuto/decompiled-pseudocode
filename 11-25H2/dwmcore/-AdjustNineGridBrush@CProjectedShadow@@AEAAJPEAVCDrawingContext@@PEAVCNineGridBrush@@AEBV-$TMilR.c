/*
 * XREFs of ?AdjustNineGridBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVCNineGridBrush@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801A00FC
 * Callers:
...
__int64 __fastcall CProjectedShadow::AdjustNineGridBrush(__int64 a1, __int64 a2, __int64 a3, float *a4)
{
  ...
  *(float *)&v25[1] = (float)(v10 + 128.0) / v16;
  ...
  {
    v21 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x42Eu, 0LL);
    return v21;
  }
  v19 = *(_QWORD *)(a1 + 24);
  *((_DWORD *)v17 + 2) = 0;
  ...
  *(_QWORD *)(v17 + 212) = 0LL;
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0x430u, 0LL);
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0x431u, 0LL);
    goto LABEL_14;
  }
  v23 = CSurfaceBrush::SetTransform(*(CSurfaceBrush **)(a3 + 104), v18);
  v21 = v23;
  if ( v23 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0x434u, 0LL);
LABEL_14:
