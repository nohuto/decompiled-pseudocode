/*
 * XREFs of ?ClearAllBackdropVisualImages@CVisual@@AEAAXXZ @ 0x180108464
 * Callers:
  ...
  if ( *(int *)v1 < 0 )
  {
    ...
    if ( v7 )
    {
      for ( j = *v7; j != v7; j = (_QWORD *)*j )
        detail::vector_facade<wil::com_ptr_t<CBackdropVisualImage,wil::err_returncode_policy>,detail::buffer_impl<wil::com_ptr_t<CBackdropVisualImage,wil::err_returncode_policy>,1,1,detail::liberal_expansion_policy>>::clear(j - 25);
    }
  }
  v8 = *((_QWORD *)this + 59);
