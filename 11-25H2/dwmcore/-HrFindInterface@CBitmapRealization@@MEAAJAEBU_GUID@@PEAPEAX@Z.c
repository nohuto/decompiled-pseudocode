/*
 * XREFs of ?HrFindInterface@CBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E84F0
 * Callers:
 *     ?HrFindInterface@CSectionBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E8460 (-HrFindInterface@CSectionBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall CBitmapRealization::HrFindInterface(CBitmapRealization *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v7 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_18796b33_81ab_4872_b4f0_9cbcccf6c8d1.Data1;
      if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_18796b33_81ab_4872_b4f0_9cbcccf6c8d1.Data1 )
        v7 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_18796b33_81ab_4872_b4f0_9cbcccf6c8d1.Data4;
      if ( v7 )
