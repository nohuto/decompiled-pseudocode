/*
 * XREFs of ?UpdateKeyframeAnimations@CAnimationController@@AEAAXXZ @ 0x1800ADA40
 * Callers:
 *     ?NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ @ 0x1800ACB50 (-NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ.c)
