/*
 * XREFs of ?Present@CDDASwapChain@@QEAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x1800C5D54
 * Callers:
...
__int64 __fastcall CDDASwapChain::Present(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
        ...
        (v8 = (CD3DDevice *)Device) != 0LL) )
  {
    ...
    v13 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x63u, 0LL);
  }
  else
  {
    v13 = -2003304307;
