/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x1801BA33C
 * Callers:
...
LABEL_17:
  ...
  v69[10] = v24;
  v70 = v25;
  v26 = CoreUICallSend(v31, &v30, 1LL, 9LL, 0, &unk_180336E81, (unsigned int)v68, v69, v29);
  v13 = v26;
  if ( v26 < 0 )
