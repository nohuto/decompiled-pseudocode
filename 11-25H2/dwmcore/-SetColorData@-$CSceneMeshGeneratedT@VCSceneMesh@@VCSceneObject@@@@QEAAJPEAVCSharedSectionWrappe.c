/*
 * XREFs of ?SetColorData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1802832B0
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[18] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xE56u, 0LL);
    }
    else
    {
