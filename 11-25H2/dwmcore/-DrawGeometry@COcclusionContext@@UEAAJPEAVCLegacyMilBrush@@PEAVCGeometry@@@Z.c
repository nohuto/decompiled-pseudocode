/*
 * XREFs of ?DrawGeometry@COcclusionContext@@UEAAJPEAVCLegacyMilBrush@@PEAVCGeometry@@@Z @ 0x1801EE040
 * Callers:
 *     <none>
 * Callees:
 *     ?IsOfType@?$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1801EE120 (-IsOfType@-$CImageLegacyMilBrushGeneratedT@VCImageLegacyMilBrush@@VCLegacyMilBrush@@@@UEBA_NW4MI.c)
 *     ?IsOfType@?$CSolidColorLegacyMilBrushGeneratedT@VCSolidColorLegacyMilBrush@@VCLegacyMilBrush@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1801EE140 (-IsOfType@-$CSolidColorLegacyMilBrushGeneratedT@VCSolidColorLegacyMilBrush@@VCLegacyMilBrush@@@@.c)
        ...
        struct CGeometry *a3)
{
  ...
  {
    v6 = CImageLegacyMilBrushGeneratedT<CImageLegacyMilBrush,CLegacyMilBrush>::IsOfType(a2, 83LL, a3);
  }
  else if ( (char *)v5 == (char *)CSolidColorLegacyMilBrushGeneratedT<CSolidColorLegacyMilBrush,CLegacyMilBrush>::IsOfType )
  {
    v6 = CSolidColorLegacyMilBrushGeneratedT<CSolidColorLegacyMilBrush,CLegacyMilBrush>::IsOfType(a2, 83LL);
  }
  else
  {
    v6 = v5(a2, 83LL, a3);
