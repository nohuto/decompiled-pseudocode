/*
 * XREFs of ?AddDirtyRegion@CGdiSpriteBitmap@@AEAAXAEAVCRegion@@_N@Z @ 0x180105228
 * Callers:
...
void __fastcall CGdiSpriteBitmap::AddDirtyRegion(CGdiSpriteBitmap *this, struct CRegion *a2, char a3)
{
  ...
  FastRegion::CRegion *v92; // [rsp+C0h] [rbp-40h] BYREF
  ...
  if ( !*((_QWORD *)this + 45) && *((_BYTE *)this + 152) )
  {
    ...
    if ( !(unsigned int)DwmHLSurfGetDirtyRgn(*(_QWORD *)(v7 + 24), 0LL, 0LL, &ho, 0LL, 0LL, 0LL, 0LL, 0LL) )
    {
      ...
      if ( v8 >= 0 )
        v8 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803D12E8, 4u, v8, 0xD6u, 0LL);
    }
    if ( ho )
    {
      ...
      if ( *(_DWORD *)v96 )
      {
        if ( v97 == v96 )
        {
          ...
          if ( v18 < v17 )
          {
            ...
            FastRegion::CRegion::FreeMemory((FastRegion::CRegion **)a2);
            *(_QWORD *)a2 = v14;
            *v16 = v17;
          }
          v19 = *v12;
...
LABEL_64:
    ...
    if ( v57 )
    {
      ...
      while ( v59 != v60 )
      {
        ...
        wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&ho);
        ++v59;
      }
    }
    if ( *((_BYTE *)this + 149) )
    ...
    *((_BYTE *)this + 148) = 1;
    if ( a3 )
    {
      for ( k = 0; ; ++k )
      {
        ...
        if ( (char *)v69 == (char *)CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType )
          v70 = CWindowNodeGeneratedT<CWindowNode,CVisual>::IsOfType(v67, 190LL, k);
        else
          v70 = v69(v67, 190LL);
        if ( v70 )
        {
