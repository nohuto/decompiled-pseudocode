/*
 * XREFs of ?EndFrame@CDrawingContext@@QEAAJXZ @ 0x1800D9780
 * Callers:
...
__int64 __fastcall CDrawingContext::EndFrame(CD3DDevice **this)
{
  ...
  bool (__fastcall *v22)(CDeviceTextureTarget *); // rax
  char v23; // al
  int v24; // eax
  int v25; // r14d
  CD3DDevice *v26; // rcx
  ...
  else
  {
    if ( *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 32LL) - *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 24LL) == 8LL
      && ((v20 = *(_BYTE **)(v11 + 24),
           ...
           v22 = *(bool (__fastcall **)(CDeviceTextureTarget *))(*(_QWORD *)v20 + 128LL),
...
LABEL_27:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v25, 0LL, &v40) )
  {
    ...
    v25 = Ptr;
    if ( Ptr < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Ptr, 0xB4Du, 0LL);
  }
  v2 = v25;
  if ( v25 < 0 )
    goto LABEL_29;
    ...
    if ( MonitorTarget )
    {
      ...
      if ( v37 )
      {
        ...
        if ( (*v39)(v38, &GUID_78f95c0d_ffd7_47bf_b918_8d28789a139f, &v40) >= 0 )
          (*(void (__fastcall **)(ULONGLONG, char *))(*(_QWORD *)v40.Ptr + 96LL))(v40.Ptr, (char *)this + 7992);
        if ( v40.Ptr )
