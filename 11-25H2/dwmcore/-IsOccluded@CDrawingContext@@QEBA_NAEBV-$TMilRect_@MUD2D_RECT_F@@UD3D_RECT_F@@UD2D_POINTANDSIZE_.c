/*
 * XREFs of ?IsOccluded@CDrawingContext@@QEBA_NAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@H@Z @ 0x180073D90
 * Callers:
...
char __fastcall CDrawingContext::IsOccluded(__int64 a1, float *a2, unsigned int a3)
{
  int v3; // eax
  float *v5; // r10
  float *v7; // r9
...
LABEL_6:
    ...
    if ( (unsigned __int8)CMILMatrix::IsTranslateAndScaleIgnoreZ<1>(v7)
    ...
    if ( v10 > v9 && v12 > v11 )
    {
      if ( a3 )
      {
        ...
        *((_QWORD *)&v52 + 1) = __PAIR64__(LODWORD(v12), LODWORD(v10));
        return CArrayBasedCoverageSet::IsCovered(v35 + 616, &v52, a3);
      }
      return 0;
    }
  }
