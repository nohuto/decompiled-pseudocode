/*
 * XREFs of ?BeginAppend@CD3DDynamicAppendBuffer@@QEAAJII@Z @ 0x180142590
 * Callers:
...
__int64 __fastcall CD3DDynamicAppendBuffer::BeginAppend(CD3DDynamicAppendBuffer *this, unsigned int a2, int a3)
{
  ...
  else
  {
    ...
    v11 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0xA0Du, 0LL);
  }
  if ( *(_DWORD *)(v5 + 1112)
...
LABEL_9:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v11, 0LL, &v17) )
  {
    ...
    v11 = v15;
    if ( v15 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0xB4Du, 0LL);
  }
  v7 = v11;
  if ( v11 < 0 )
    goto LABEL_21;
