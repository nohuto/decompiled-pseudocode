/*
 * XREFs of ?CreateConversionSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVCLegacySwapChain@@@Z @ 0x1802C2624
 * Callers:
...
LABEL_3:
    v12 = v11;
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18038F3B8, 3u, v12, v18, 0LL);
    goto LABEL_27;
  }
  if ( *((_BYTE *)this + 1500) )
