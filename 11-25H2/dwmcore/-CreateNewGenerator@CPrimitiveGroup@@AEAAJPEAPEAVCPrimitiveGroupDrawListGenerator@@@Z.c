/*
 * XREFs of ?CreateNewGenerator@CPrimitiveGroup@@AEAAJPEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x180044C6C
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x242u, 0LL);
    goto LABEL_31;
  }
  ...
  *v12 = v15;
  if ( v18 >= v16 )
    v18 = v16;
  *((_DWORD *)this + 104) = v18;
  v19 = DynArrayImpl<0>::Grow((int)this + 264, 8, v15 + v13, 1, 0LL);
  v9 = v19;
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x24Fu, 0LL);
    goto LABEL_42;
  }
  *((_DWORD *)this + 72) = *((_DWORD *)this + 102) + *v12;
  v20 = DynArrayImpl<0>::Grow((int)this + 328, 8, *((_DWORD *)this + 104), 1, 0LL);
  v9 = v20;
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x252u, 0LL);
LABEL_42:
    v6 = v56;
    goto LABEL_31;
  }
  ...
  if ( v36 )
  {
    ...
    if ( v41 >= 0 )
    {
      ...
      *(_QWORD *)v36 = v43;
      ...
      v48 = -2147024882;
LABEL_46:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v48, v52, 0LL);
      goto LABEL_25;
    }
    v52 = 164;
LABEL_49:
...
LABEL_29:
  ...
  if ( v38 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, 0x281u, 0LL);
    goto LABEL_31;
  }
LABEL_30:
  *v57 = v4;
