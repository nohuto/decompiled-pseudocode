/*
 * XREFs of ?DrawSolidRectangle@CDrawingContext@@UEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x1800744F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDrawingContext::DrawSolidRectangle(__int64 a1, struct CShape *a2, __int128 *a3)
{
  ...
  CRectanglesShape *v17; // [rsp+38h] [rbp-C8h] BYREF
  ...
  if ( COERCE_FLOAT(HIDWORD(v21) & _xmm) >= 0.0000011920929 && !IsEmpty((const struct D2D_RECT_F *)a2) )
  {
    ...
    if ( UnOccludedWorldShape >= 0 )
    {
      ...
      else
      {
        ...
        v18 = a1 - 16;
        LOBYTE(v19) = 1;
        (*(void (__fastcall **)(CRectanglesShape *, unsigned int *))(*(_QWORD *)v17 + 64LL))(v17, &v16);
        v23[0] = v24;
        v23[1] = v24;
        v23[2] = &v25;
        detail::vector_facade<TMilRect_<float,D2D_RECT_F,D3D_RECT_F,D2D_POINTANDSIZE_F,RectUniqueness::NotNeeded>,detail::buffer_impl<TMilRect_<float,D2D_RECT_F,D3D_RECT_F,D2D_POINTANDSIZE_F,RectUniqueness::NotNeeded>,4,1,detail::liberal_expansion_policy>>::resize(
          v23,
          v16);
        (*(void (__fastcall **)(CRectanglesShape *, _QWORD, _QWORD))(*(_QWORD *)v17 + 80LL))(v17, v23[0], v16);
        v14 = v23[0];
        ...
        v15 = CDrawingContext::FillRectanglesWithSolidColor((struct CDrawingContext *)(a1 - 16));
        v4 = v15;
        if ( v15 < 0 )
    ...
    else
    {
      ...
      v11 = CDrawingContext::FillRectanglesWithSolidColor((struct CDrawingContext *)(a1 - 16));
      v4 = v11;
      if ( v11 < 0 )
