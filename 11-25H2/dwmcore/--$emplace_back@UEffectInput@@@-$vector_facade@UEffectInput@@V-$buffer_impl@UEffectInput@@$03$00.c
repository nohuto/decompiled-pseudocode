/*
 * XREFs of ??$emplace_back@UEffectInput@@@?$vector_facade@UEffectInput@@V?$buffer_impl@UEffectInput@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXUEffectInput@@@Z @ 0x18007F7BC
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( v5 )
  {
    v9 = *(unsigned int (__fastcall **)(CMILRefCountImpl *__hidden))(*(_QWORD *)v5 + 8LL);
...
LABEL_15:
  ...
  *((_QWORD *)v3 + 14 * v18) = v5;
  if ( v5 )
  {
    v29 = *(unsigned int (__fastcall **)(CMILRefCountImpl *__hidden))(*(_QWORD *)v5 + 8LL);
