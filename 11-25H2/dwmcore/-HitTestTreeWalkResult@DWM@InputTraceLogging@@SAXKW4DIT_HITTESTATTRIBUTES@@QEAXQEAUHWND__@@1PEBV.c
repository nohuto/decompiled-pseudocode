/*
 * XREFs of ?HitTestTreeWalkResult@DWM@InputTraceLogging@@SAXKW4DIT_HITTESTATTRIBUTES@@QEAXQEAUHWND__@@1PEBVCInteraction@@@Z @ 0x180137020
 * Callers:
        ...
        __int64 fPending)
{
  ...
  {
    qword_180406C98 = 0LL;
    Context = &qword_180406C90;
    qword_180406C90 = &CompositorTracing::`vftable';
    byte_180406CA0 = 0;
    dword_180406CA4 = 0;
    qword_180406CA8 = (struct _tlgProvider_t *)&`InputTraceLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(_lambda_a8e7baa2fca040c17c3e795f3590cb07_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_180406C90, qword_180406CA8, v27);
    InitOnceComplete(&`InputTraceLogging::Instance'::`2'::wrapper, 0, &qword_180406C90);
  }
  ...
  if ( *(_DWORD *)v11 > 4u && (*(_BYTE *)(v11 + 16) & 2) != 0 && (*(_QWORD *)(v11 + 24) & 2LL) == *(_QWORD *)(v11 + 24) )
  {
    ...
    v15 = L"HasCapture";
    if ( (a2 & 0x200) == 0 )
      v15 = (const wchar_t *)&unk_18038C548;
    v34 = a2;
    v45 = v15;
    v16 = L"ControlDown";
    if ( (a2 & 0x100) == 0 )
      v16 = (const wchar_t *)&unk_18038C548;
    v46 = v16;
    v17 = L"EraserDown";
    if ( (a2 & 0x80u) == 0 )
      v17 = (const wchar_t *)&unk_18038C548;
    v47 = v17;
    v18 = L"BarrelButtonDown";
    if ( (a2 & 0x40) == 0 )
      v18 = (const wchar_t *)&unk_18038C548;
    v48 = v18;
    v19 = L"NoHoverPointer";
    if ( (a2 & 0x20) == 0 )
      v19 = (const wchar_t *)&unk_18038C548;
    v49 = v19;
    v20 = L"TouchTargeting";
    if ( (a2 & 0x10) == 0 )
      v20 = (const wchar_t *)&unk_18038C548;
    v50 = v20;
    v21 = L"ButtonDown";
    if ( (a2 & 8) == 0 )
      v21 = (const wchar_t *)&unk_18038C548;
    v51 = v21;
    v22 = L"WheelHorizontal";
    if ( (a2 & 4) == 0 )
      v22 = (const wchar_t *)&unk_18038C548;
    v52 = v22;
    v23 = L"WheelIncreasing";
    if ( (a2 & 2) == 0 )
      v23 = (const wchar_t *)&unk_18038C548;
    v53 = v23;
    v24 = L"MouseWheel";
    if ( (a2 & 1) == 0 )
      v24 = (const wchar_t *)&unk_18038C548;
    v54 = v24;
