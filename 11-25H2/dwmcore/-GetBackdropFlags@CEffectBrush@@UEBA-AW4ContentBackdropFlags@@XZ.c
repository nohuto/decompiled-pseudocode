/*
 * XREFs of ?GetBackdropFlags@CEffectBrush@@UEBA?AW4ContentBackdropFlags@@XZ @ 0x1801C3000
 * Callers:
 ...
 *     ?GetBackdropFlags@CEffectBrush@@UEBA?AW4ContentBackdropFlags@@XZ @ 0x1801C3000 (-GetBackdropFlags@CEffectBrush@@UEBA-AW4ContentBackdropFlags@@XZ.c)
 *     ?GetBackdropFlags@CBlurredWallpaperBackdropBrush@@UEBA?AW4ContentBackdropFlags@@XZ @ 0x1801C30E0 (-GetBackdropFlags@CBlurredWallpaperBackdropBrush@@UEBA-AW4ContentBackdropFlags@@XZ.c)
 *     ?GetBackdropFlags@CWindowBackdropBrush@@UEBA?AW4ContentBackdropFlags@@XZ @ 0x1802300F0 (-GetBackdropFlags@CWindowBackdropBrush@@UEBA-AW4ContentBackdropFlags@@XZ.c)
