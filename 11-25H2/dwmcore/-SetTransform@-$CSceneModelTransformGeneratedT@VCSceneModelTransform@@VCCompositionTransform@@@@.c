/*
 * XREFs of ?SetTransform@?$CSceneModelTransformGeneratedT@VCSceneModelTransform@@VCCompositionTransform@@@@QEAAJPEAVCComponentTransform3D@@@Z @ 0x180284FDC
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[9] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xD29u, 0LL);
    }
    else
    {
