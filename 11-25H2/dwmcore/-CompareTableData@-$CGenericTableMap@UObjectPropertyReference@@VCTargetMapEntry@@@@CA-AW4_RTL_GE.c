/*
 * XREFs of ?CompareTableData@?$CGenericTableMap@UObjectPropertyReference@@VCTargetMapEntry@@@@CA?AW4_RTL_GENERIC_COMPARE_RESULTS@@PEAU_RTL_GENERIC_TABLE@@PEAX1@Z @ 0x180195950
 * Callers:
 *     <none>
 * Callees:
 *     <none>
