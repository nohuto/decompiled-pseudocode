/*
 * XREFs of ??1CDDisplaySwapChain@@MEAA@XZ @ 0x1802C7940
 * Callers:
 ...
 *     ??1?$_Hash@V?$_Umap_traits@IVCDDisplayFlipAwayFence@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIVCDDisplayFlipAwayFence@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x1802C7894 (--1-$_Hash@V-$_Umap_traits@IVCDDisplayFlipAwayFence@@V-$_Uhash_compare@IU-$hash@I@std@@U-$equal_.c)
...
void __fastcall CDDisplaySwapChain::~CDDisplaySwapChain(CDDisplaySwapChain *this)
{
  ...
  *((_QWORD *)this + 36) = &CDDisplaySwapChain::`vftable'{for `IDDisplayEventListener'};
  ...
  trivial_8 = (__m128i *)_std_find_trivial_8(
                           (const __m128i *)qword_180406BE8,
                           (const __m128i *)qword_180406BF0,
                           v2 & -(__int64)(this != 0LL));
  memmove_0(trivial_8, &trivial_8->m128i_u64[1], qword_180406BF0 - (_QWORD)&trivial_8->m128i_i64[1]);
  qword_180406BF0 -= 8LL;
