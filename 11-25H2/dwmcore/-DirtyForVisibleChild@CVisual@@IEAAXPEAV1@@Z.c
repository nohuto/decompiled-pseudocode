/*
 * XREFs of ?DirtyForVisibleChild@CVisual@@IEAAXPEAV1@@Z @ 0x1800E3DC0
 * Callers:
...
void __fastcall CVisual::DirtyForVisibleChild(CVisual *this, struct CVisual *a2)
{
  ...
  _QWORD *v6; // rbx
  __int64 v7; // rax
  struct CProcessAttribution *(__fastcall *v8)(CResource *__hidden); // rax
  _QWORD *v9; // rax
  __int64 v10; // rax
  ...
  if ( (*((_BYTE *)v4 + 106) & 0x40) != 0 )
  {
    do
    {
      ...
      *((_BYTE *)v6 + 96) |= 0x11u;
      ...
      v8 = *(struct CProcessAttribution *(__fastcall **)(CResource *__hidden))(*v6 + 160LL);
  ...
  *((_BYTE *)v3 + 96) |= 4u;
  ...
  if ( (*((_BYTE *)v3 + 106) & 0x40) != 0 )
  {
    do
    {
      ...
      *((_BYTE *)v14 + 96) = v15 | 0x80;
      ...
      v17 = *(struct CProcessAttribution *(__fastcall **)(CResource *__hidden))(*v14 + 160LL);
  ...
  if ( (*((_BYTE *)v3 + 105) & 0x20) != 0 )
  {
    ...
    if ( ManipulationManager >= 0 )
      CManipulationManager::QueueMidManipulationUpdate(v51, 2LL, v3);
    if ( v22 )
