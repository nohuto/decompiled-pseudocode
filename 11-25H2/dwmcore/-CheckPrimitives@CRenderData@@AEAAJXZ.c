/*
 * XREFs of ?CheckPrimitives@CRenderData@@AEAAJXZ @ 0x180184404
 * Callers:
 ...
 *     ?GetFirstItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEBX0@Z @ 0x1801E0F7C (-GetFirstItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEBX0@Z.c)
 *     ?GetNextItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEBX0@Z @ 0x1801E36FC (-GetNextItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEBX0@Z.c)
...
__int64 __fastcall CRenderData::CheckPrimitives(CRenderData *this)
{
        ...
        i = CDataBlockReader::GetNextItemSafe((CDataBlockReader *)v9, &v12, (const void **)&v15, &v13) )
  {
    ...
    if ( v12 <= 0x1A9 )
    {
      if ( v12 != 425 && v12 != 419 && v12 != 420 && v12 != 422 && v12 - 423 > 1 )
LABEL_22:
