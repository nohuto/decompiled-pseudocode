        ...
        unsigned int a2)
{
  ...
  if ( *(_QWORD *)(a1 + 8) )
  {
    v7 = MIDL_user_allocate(saturated_mul(v3, 8uLL));
    v8 = v7;
    if ( !v7 )
      return 2147942414LL;
    if ( v3 > 0x1FFFFFFF )
