/*
 * XREFs of ?Initialize@CHolographicFrameProcessor@@AEAAJPEAVCComposition@@IPEAXW4DXGI_FORMAT@@II@Z @ 0x1802DF4F0
 * Callers:
 ...
 *     ?AddWin32kInteropTexture@CHolographicManager@@QEAA_NPEAUIHolographicWin32kInteropTexture@@PEAX@Z @ 0x1802D7F14 (-AddWin32kInteropTexture@CHolographicManager@@QEAA_NPEAUIHolographicWin32kInteropTexture@@PEAX@Z.c)
 */
        ...
        unsigned int a7)
{
  ...
  *((_DWORD *)this + 28) = a3;
  ...
  if ( *((_QWORD *)this + 6) != v10 )
  {
    ...
    *((_QWORD *)this + 6) = v10;
    if ( v11 )
      CMILRefCountBaseT<IMILRefCount,CMilObjectDeleter>::Release((CDrawListCache *)(v11 + 8));
  }
  ...
  {
    v7 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147418113, 0x39u, 0LL);
  }
