/*
 * XREFs of ?FlushOcclusionRects@COcclusionContext@@QEAAJXZ @ 0x1800555A0
 * Callers:
...
__int64 __fastcall COcclusionContext::FlushOcclusionRects(COcclusionContext *this)
{
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_DWM_MPO_Enhancement>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_DWM_MPO_Enhancement>::GetImpl'::`2'::impl) )
  {
    ...
    if ( (_DWORD)v4 )
    {
      while ( 1 )
      {
        ...
        *((_DWORD *)this + 427) = v5 + 2;
        ...
        if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
        {
          ...
          v57 = 4LL;
          v59 = 4LL;
          McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, ",", v3, 7LL, v47);
        }
        if ( *(_BYTE *)(v7 + 16) )
          v12 = *((_QWORD *)this + 193);
        else
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x346u, 0LL);
    }
  }
  else
  {
    ...
    if ( (_DWORD)v15 )
    {
      ...
      while ( 1 )
      {
        ...
        *((_QWORD *)&v45 + 1) = 0LL;
        ...
        {
          v43 = &v44;
          v29 = DynArrayImpl<0>::Grow((int)this + 616, 48, 1, 0, (__int64)&v43);
          v2 = v29;
          if ( v29 < 0 )
          {
            v33 = v29;
          ...
          *(_OWORD *)(v32 + v30) = *v43;
          *(_OWORD *)(v32 + v30 + 16) = v31[1];
          *(_OWORD *)(v32 + v30 + 32) = v31[2];
          ++*((_DWORD *)this + 160);
        }
        else
        {
      ...
      v2 = -2147024362;
LABEL_29:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, v35, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x27u, 0LL);
      v2 = v34;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x359u, 0LL);
    }
  }
LABEL_30:
