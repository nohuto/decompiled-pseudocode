/*
 * XREFs of ?ProcessSetHoverSource@CInteraction@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTION_SETHOVERSOURCE@@@Z @ 0x18022777C
 * Callers:
        ...
        const struct tagMILCMD_INTERACTION_SETHOVERSOURCE *a3)
{
  ...
  if ( v5 )
  {
    Resource = CResourceTable::GetResource((__int64)a2, v5, 0x51u);
