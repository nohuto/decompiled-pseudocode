/*
 * XREFs of ?UpdateTransformAndTreeBounds@CVirtualMonitorCaptureRenderTarget@@MEAAXXZ @ 0x18028E770
 * Callers:
 *     <none>
 * Callees:
        ...
        CVirtualMonitorCaptureRenderTarget *this)
{
  ...
  CMILMatrix::Translate(
    v2,
    COERCE_FLOAT(COERCE_UNSIGNED_INT((float)*((int *)this + 799)) ^ _xmm),
    COERCE_FLOAT(COERCE_UNSIGNED_INT((float)*((int *)this + 800)) ^ _xmm));
