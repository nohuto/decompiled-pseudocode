/*
 * XREFs of ??1CComputeScribbleFramebuffer@@UEAA@XZ @ 0x180293B4C
 * Callers:
...
void __fastcall CComputeScribbleFramebuffer::~CComputeScribbleFramebuffer(CComputeScribbleFramebuffer *this)
{
  ...
  FastRegion::CRegion::FreeMemory((FastRegion::CRegion **)this + 12);
  ...
  wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::~com_ptr_t<CD3DDevice,wil::err_returncode_policy>((CD3DDevice **)this + 2);
}
