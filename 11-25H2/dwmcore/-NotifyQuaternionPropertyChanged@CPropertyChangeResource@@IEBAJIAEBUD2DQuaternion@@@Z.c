/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x18029DCCC
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
         ...
         11LL) )
  {
    ...
    v14 = v9;
    v11 = CoreUICallSend(v10, v13, 2LL, 11LL, 6, &unk_180336ECA, a2, &v14, ChannelCallbackId);
    if ( v11 != -2018375675 )
      v6 = v11;
    if ( v6 < 0 )
