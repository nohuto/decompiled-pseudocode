/*
 * XREFs of ?NotifyScalarPropertyChanged@CPropertyChangeResource@@IEBAJIM@Z @ 0x1801DAAF0
 * Callers:
        ...
        float a3)
{
  ...
  if ( !_bittest(&v7, a2) )
    return 0LL;
  v8 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 3) + 6416LL) + 72LL))(
  ...
  v11 = CoreUICallSend(v8, v13, 2LL, 11LL, 0, &unk_180336EAA, a2, a3, v10);
  v12 = 0;
  if ( v11 != -2018375675 )
    v12 = v11;
  if ( v12 < 0 )
