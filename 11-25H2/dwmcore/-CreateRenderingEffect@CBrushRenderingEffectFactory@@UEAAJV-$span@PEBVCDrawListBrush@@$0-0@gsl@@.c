/*
 * XREFs of ?CreateRenderingEffect@CBrushRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x180128F70
 * Callers:
        ...
        _QWORD *a3)
{
        ...
        if ( v25 )
        {
          ...
          *(_OWORD *)v19 = v34;
          ...
          if ( v35 )
          {
            ...
            {
              Size = (__int64 *)CDxHandleBitmapRealization::GetSize(v35, v43, v26);
            }
            else
            {
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x4Au, 0LL);
  }
  return v5;
}
