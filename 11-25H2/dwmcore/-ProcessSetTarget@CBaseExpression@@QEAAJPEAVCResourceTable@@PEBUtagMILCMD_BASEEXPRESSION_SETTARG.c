/*
 * XREFs of ?ProcessSetTarget@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETTARGET@@@Z @ 0x18005FF24
 * Callers:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETTARGET *a3)
{
  ...
  *((_DWORD *)this + 55) = *((_DWORD *)a3 + 2);
  ...
  v7 = v6;
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x5Bu, 0LL);
  else
    return 0;
  return v7;
}
