/*
 * XREFs of ?OnSceneFrameTick@CSceneMesh@@EEAAJPEAUISpectreRenderer@@_K@Z @ 0x1802AD450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSceneMesh::OnSceneFrameTick(CSceneMesh *this, struct ISpectreRenderer *a2)
{
  ...
  {
LABEL_59:
    gsl::final_action__lambda_a6cadc748e29644dcd3cf84dc08806d7___::_final_action__lambda_a6cadc748e29644dcd3cf84dc08806d7___(v29);
  ...
  if ( *((_DWORD *)this - 20) == 6 )
  {
    ...
    if ( v9 )
    {
      ...
      v37 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v10, *((_QWORD *)this - 7), *((_DWORD *)this - 21));
    }
    v11 = *((_QWORD *)this - 5);
    if ( v11 )
    {
      ...
      v12 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v9, v11, 6);
      if ( v32 > v12 )
      {
        v28 = 119;
        goto LABEL_5;
    ...
    if ( v13 )
    {
      ...
      v14 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v9, v13, 2);
      if ( v32 > v14 )
      {
        v28 = 130;
        goto LABEL_5;
    ...
    if ( v15 )
    {
      ...
      v16 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v9, v15, 42);
      if ( v32 > v16 )
      {
        v28 = 141;
        goto LABEL_5;
    ...
    if ( v17 )
    {
      ...
      v18 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v9, v17, 16);
      if ( v32 > v18 )
      {
        v28 = 152;
        goto LABEL_5;
    ...
    if ( v19 )
    {
      ...
      v20 = lambda_05398b4549421d065ab404e0dbeea144_::operator()(v9, v19, 16);
      if ( v32 > v20 )
      {
        v28 = 163;
        goto LABEL_5;
