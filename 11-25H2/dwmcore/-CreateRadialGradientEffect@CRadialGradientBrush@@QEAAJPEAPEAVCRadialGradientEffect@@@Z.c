/*
 * XREFs of ?CreateRadialGradientEffect@CRadialGradientBrush@@QEAAJPEAPEAVCRadialGradientEffect@@@Z @ 0x1802AC6B4
 * Callers:
 ...
 *     ?IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ @ 0x1802ACC34 (-IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ.c)
