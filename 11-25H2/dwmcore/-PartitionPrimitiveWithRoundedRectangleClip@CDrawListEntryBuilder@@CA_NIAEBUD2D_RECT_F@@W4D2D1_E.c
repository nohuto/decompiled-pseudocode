        ...
        _QWORD *a5)
{
  ...
  void *v126; // rbx
  _DWORD *v127; // rcx
  __int64 v128; // [rsp+28h] [rbp-E0h]
  unsigned int v129; // [rsp+38h] [rbp-D0h]
  float v130; // [rsp+3Ch] [rbp-CCh]
  __m128 v131; // [rsp+48h] [rbp-C0h] BYREF
  signed __int64 v132; // [rsp+58h] [rbp-B0h]
  int v133; // [rsp+68h] [rbp-A0h]
  __m128 v134; // [rsp+78h] [rbp-90h] BYREF
  __int64 v135; // [rsp+88h] [rbp-80h]
  __m128 v136; // [rsp+98h] [rbp-70h] BYREF
  __int64 v137; // [rsp+A8h] [rbp-60h]
  unsigned int v138; // [rsp+B8h] [rbp-50h]
  unsigned int v139; // [rsp+BCh] [rbp-4Ch]
  __m128 v140; // [rsp+C8h] [rbp-40h] BYREF
  ...
  {
    v25.m128_i32[0] = v141.m128_i32[0];
    v30 = v140.m128_f32[1];
  }
  if ( (_BYTE)v11 )
    v31 = (float *)(a4 + 16);
  ...
  {
    v34 = v141.m128_f32[2];
    v130 = v141.m128_f32[2];
  }
  else
  {
    v34 = v141.m128_f32[2];
    v130 = v141.m128_f32[2];
    if ( v33 <= v141.m128_f32[2] )
    {
      v130 = v12 - *v31;
      v34 = v130;
    }
  ...
  v41 = v140.m128_u32[2];
  v42 = v140.m128_i32[0];
  if ( v140.m128_f32[2] < v140.m128_f32[0] || v38 < v30 )
    v43 = 0.0;
  else
    v43 = (float)(v140.m128_f32[2] - v140.m128_f32[0]) * (float)(v38 - v30);
  if ( v36 >= v25.m128_f32[0] && v141.m128_f32[3] >= v141.m128_f32[1] )
    v22 = (float)(v141.m128_f32[3] - v141.m128_f32[1]) * (float)(v36 - v25.m128_f32[0]);
  if ( v43 < v22 )
  {
    if ( v24 > v22 )
      return 0;
...
LABEL_69:
      ...
      if ( v71 <= v130
        || (v72 = *((_DWORD *)a2 + 3),
            v73 = v7 & 0xFCFFFFFF,
            v140.m128_u64[0] = __PAIR64__(*((_DWORD *)a2 + 1), LODWORD(v130)),
            v140.m128_u64[1] = __PAIR64__(v72, LODWORD(v71)),
            v129 = v59 & 0xFFFFFCFF,
...
LABEL_78:
        ...
        v140.m128_u64[0] = __PAIR64__(v141.m128_u32[1], v25.m128_u32[0]);
        v140.m128_u64[1] = __PAIR64__(v141.m128_u32[3], LODWORD(v130));
...
LABEL_83:
            if ( v88 > 1 )
            {
              ...
              v131.m128_u64[1] = v87;
              v132 = v87;
              v131.m128_u64[0] = (unsigned __int64)v48;
          ...
          v124 = a5[1];
          v125 = (_DWORD *)*a5;
          v131.m128_u64[0] = (unsigned __int64)v123;
          v131.m128_u64[1] = v49;
          v126 = v123;
          v132 = 0LL;
          v136 = v131;
      ...
      if ( !(0xAAAAAAAAAAAAAAABuLL * ((v75 - v74) >> 3)) )
      {
        ...
        v118 = a5[1];
        v119 = (_DWORD *)*a5;
        v131.m128_u64[0] = (unsigned __int64)v117;
        v131.m128_u64[1] = v77;
        v120 = v117;
        v132 = 0LL;
        v136 = v131;
...
LABEL_77:
        ...
        if ( !v78 || v76 && v78 >= 0 )
        {
          v131.m128_u64[1] = v78;
          v132 = v78;
          v131.m128_u64[0] = (unsigned __int64)v76;
          std::move_backward<std::move_iterator<D2D1::Matrix3x2F *>,stdext::checked_array_iterator<D2D1::Matrix3x2F *>>(
            &v136,
            &v76[6 * v77],
            &v76[6 * v78 - 6],
...
LABEL_128:
    ...
    v59 = a3 & 0xFCFFFFFF;
    v140.m128_u64[1] = __PAIR64__(LODWORD(v18), v25.m128_u32[0]);
    v129 = a3 & 0xFCFFFFFF;
    v138 = a3 & 0xFFFFFCFF;
...
LABEL_68:
    ...
    if ( !(0xAAAAAAAAAAAAAAABuLL * ((v61 - v60) >> 3)) )
    {
      ...
      v111 = a5[1];
      v112 = (_DWORD *)*a5;
      v131.m128_u64[0] = (unsigned __int64)v110;
      v113 = v110;
      v131.m128_u64[1] = v63;
      v132 = 0LL;
      v136 = v131;
...
LABEL_67:
      ...
      if ( !v64 || v62 && v64 >= 0 )
      {
        v131.m128_u64[1] = v64;
        v132 = v64;
        v131.m128_u64[0] = (unsigned __int64)v62;
        std::move_backward<std::move_iterator<D2D1::Matrix3x2F *>,stdext::checked_array_iterator<D2D1::Matrix3x2F *>>(
          &v136,
          &v62[6 * v63],
          &v62[6 * v64 - 6],
...
LABEL_125:
  ...
  if ( v24 <= v43 )
  {
    ...
    if ( v30 > v17 )
    {
      v141.m128_u64[0] = __PAIR64__(LODWORD(v17), LODWORD(v14));
      v97 = a3 & 0xFFFCFFFF;
      v141.m128_u64[1] = __PAIR64__(LODWORD(v30), LODWORD(v15));
      v44 = a3 & 0xFFFFFFFC;
      if ( !(unsigned __int8)CDrawListEntryBuilder::PartitionPrimitiveWithRoundedRectangleClip(
                               a1,
                               (unsigned int)&v141,
    ...
    if ( v45 > v38 )
    {
      ...
      v94 = v7 & 0xFFFFFFFC;
      v140.m128_f32[0] = *a2;
      *(unsigned __int64 *)((char *)v140.m128_u64 + 4) = __PAIR64__(v93, LODWORD(v38));
      v140.m128_f32[3] = v45;
    ...
    v47 = a5[2];
    v48 = (_DWORD *)*a5;
    v141.m128_u64[0] = __PAIR64__(LODWORD(v30), v42);
    v49 = 0xAAAAAAAAAAAAAAABuLL * ((v46 - (__int64)v48) >> 3);
    v141.m128_u64[1] = __PAIR64__(LODWORD(v38), v41);
    v129 = v44;
    ...
    if ( v49 + 1 >= v49 )
    {
      ...
      v103 = a5[1];
      v104 = (_DWORD *)*a5;
      v134.m128_u64[0] = (unsigned __int64)v102;
      v134.m128_u64[1] = v49;
      v105 = v102;
      v135 = 0LL;
      v131 = v134;
