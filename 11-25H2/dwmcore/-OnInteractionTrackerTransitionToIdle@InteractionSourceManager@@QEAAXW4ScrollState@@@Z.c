/*
 * XREFs of ?OnInteractionTrackerTransitionToIdle@InteractionSourceManager@@QEAAXW4ScrollState@@@Z @ 0x1800F9864
 * Callers:
...
void __fastcall InteractionSourceManager::OnInteractionTrackerTransitionToIdle(InteractionSourceManager *a1)
{
  ...
  if ( InteractionSourceManager::HasActiveManipulation(a1) )
  {
    if ( v3 == 2 )
    {
      ...
      while ( v4 != v5 )
      {
        v6 = (__int64 *)(*(_QWORD *)(*((_QWORD *)a1 + 10) + 8 * ((*((_QWORD *)a1 + 11) - 1LL) & (v4 >> 1)))
                       + 8 * (v4 & 1));
