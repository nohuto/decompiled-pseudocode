/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1802922A8
 * Callers:
        ...
        float *a2)
{
  ...
  for ( i = result; v6 < v5; *(_DWORD *)(v13 + 12) = result )
  {
    ...
    VertexTransfer::CGeneral3DOperator<Vertex_UVxN<VertexXYW_ColorDW>>::Transform(
      (__int64)v14,
      (float *)v12,
      (float *)(*(_QWORD *)(a1 + 24) + (int)(*(_DWORD *)(a1 + 32) * v6)),
      *(_DWORD *)(a1 + 40),
      (__int64)a2,
      v13);
