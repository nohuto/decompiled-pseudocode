/*
 * XREFs of ?LockForRead@CWICBitmapWrapper@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x1802613D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWICBitmapWrapper::LockForRead(__int64 a1, INT *a2, struct IBitmapLock **a3)
{
  ...
  v7.Y = v3;
  v7.Height = v5 - v3;
  return CWICBitmapWrapper::Lock((CWICBitmapWrapper *)(a1 - 104), (__m128i *)&v7, WICBitmapLockRead, a3);
}
