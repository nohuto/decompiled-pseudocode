/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderProxyImpl@BamoImpl@@QEAAJXZ @ 0x18027D740
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v9, &v11, 2LL, 0LL, 2, &unk_18038ED03, v14, v15, savedregs[0]);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
