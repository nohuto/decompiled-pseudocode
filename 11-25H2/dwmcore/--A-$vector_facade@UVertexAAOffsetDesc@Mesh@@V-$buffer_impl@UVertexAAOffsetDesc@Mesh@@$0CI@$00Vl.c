/*
 * XREFs of ??A?$vector_facade@UVertexAAOffsetDesc@Mesh@@V?$buffer_impl@UVertexAAOffsetDesc@Mesh@@$0CI@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAAEAUVertexAAOffsetDesc@Mesh@@_K@Z @ 0x18022F0D4
 * Callers:
