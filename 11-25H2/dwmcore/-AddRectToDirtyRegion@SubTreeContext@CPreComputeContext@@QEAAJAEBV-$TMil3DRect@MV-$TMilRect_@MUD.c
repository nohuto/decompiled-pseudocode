/*
 * XREFs of ?AddRectToDirtyRegion@SubTreeContext@CPreComputeContext@@QEAAJAEBV?$TMil3DRect@MV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@UD3D_RECT_F@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCVisual@@@Z @ 0x18009B3F0
 * Callers:
...
__int64 __fastcall CPreComputeContext::SubTreeContext::AddRectToDirtyRegion(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // eax
  void *v6; // rcx
  float right; // xmm4_4
  ...
  CMILMatrix::Transform3DBoundsHelper<1>(v6, a2, &v27);
  right = v27.right;
  left = v27.left;
  bottom = v27.bottom;
  top = v27.top;
  ...
  if ( IsEmpty(&v27) )
  {
    if ( TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsWellOrdered(&v27.left) )
      goto LABEL_31;
  ...
  {
    if ( TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsInfinite(&v27.left) )
    {
