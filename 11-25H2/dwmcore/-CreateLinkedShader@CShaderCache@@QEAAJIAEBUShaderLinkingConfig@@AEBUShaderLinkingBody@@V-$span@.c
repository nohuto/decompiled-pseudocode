/*
 * XREFs of ?CreateLinkedShader@CShaderCache@@QEAAJIAEBUShaderLinkingConfig@@AEBUShaderLinkingBody@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAPEAVCLinkedShader@@@Z @ 0x18006CBB0
 * Callers:
...
LABEL_24:
    ...
    *(_QWORD *)&v35 = 0LL;
    v34[0] = v16;
    Microsoft::WRL::ComPtr<CLinkedShader>::InternalRelease((volatile signed __int32 **)&v35);
LABEL_15:
