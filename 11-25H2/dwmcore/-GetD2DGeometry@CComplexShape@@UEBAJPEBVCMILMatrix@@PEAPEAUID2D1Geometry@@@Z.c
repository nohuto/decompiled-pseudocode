/*
 * XREFs of ?GetD2DGeometry@CComplexShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x1802641E0
 * Callers:
        ...
        __int64 a4)
{
  ...
  v4 = CTransformedGeometryHelper::TransformGeometry(a2, this[2], a3, a4);
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x15u, 0LL);
  return v5;
}
