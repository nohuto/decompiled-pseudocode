/*
 * XREFs of ?GetPresentStatistics@CRemoteAppRenderTarget@@UEBAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x18028BD40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  if ( *(_DWORD *)(*((_QWORD *)this - 18) + 6288LL) == 7 && (v2 = (CCompSwapChain *)*((_QWORD *)this + 1)) != 0LL )
  {
