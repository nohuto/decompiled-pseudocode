/*
 * XREFs of ?HrCheckPixelRect@CBitmap@@IEAAJPEBUWICRect@@PEAV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180187F24
 * Callers:
...
__int64 __fastcall CBitmap::HrCheckPixelRect(__int64 a1, int *a2, __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 12) = v5;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x173u, 0LL);
    return (unsigned int)-2147024362;
  }
  v10 = a2[2];
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x174u, 0LL);
    return (unsigned int)-2147024362;
  }
  v11 = v10 + v7;
  if ( v10 + v7 < (unsigned int)v7 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x175u, 0LL);
    return (unsigned int)-2147024362;
  }
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x178u, 0LL);
    return (unsigned int)-2147024362;
  }
  v12 = a2[3];
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x179u, 0LL);
    return (unsigned int)-2147024362;
  }
  v13 = v8 + v12;
  if ( v13 < v8 )
  ...
  if ( v13 > 0x7FFFFFFF )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024362, 0x17Bu, 0LL);
    return (unsigned int)-2147024362;
  }
  v14 = 0;
  if ( v7 > 0 )
