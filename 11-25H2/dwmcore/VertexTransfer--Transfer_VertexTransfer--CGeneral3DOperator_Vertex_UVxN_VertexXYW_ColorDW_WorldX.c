/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x18011E260
 * Callers:
        ...
        CMILMatrix *a3)
{
  ...
  if ( v15 && v8 )
  {
    result = CalculateTBNFrameFrom3Vertices((unsigned int)&v18, (_DWORD)v3, (int)a1 + 8, (_DWORD)a3, v8);
    v7 = a2;
    v18 = *(_OWORD *)result;
  }
  if ( v9 )
