/*
 * XREFs of ??$Walk@VCShapeBoundingContext@@@CShapeTreeIterator@@QEAAJPEAVCVectorShape@@PEAVCShapeBoundingContext@@@Z @ 0x18007A3C8
 * Callers:
 ...
 *     ?GetChildrenCount@CContainerVectorShape@@UEBAIXZ @ 0x18007A950 (-GetChildrenCount@CContainerVectorShape@@UEBAIXZ.c)
 ...
 *     ?GetChildAt@CContainerVectorShape@@UEBAPEAVCVectorShape@@I@Z @ 0x18007A990 (-GetChildAt@CContainerVectorShape@@UEBAPEAVCVectorShape@@I@Z.c)
...
LABEL_2:
    ...
    *(_BYTE *)(a3 + 64) = 0;
    if ( !*((_BYTE *)v6 + 96) )
      break;
    *(_BYTE *)(a3 + 64) = 1;
    v7 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v6 + 64LL);
    if ( (char *)v7 == (char *)CContainerVectorShape::IsOfType )
    {
      v8 = CContainerVectorShape::IsOfType(v6, 163LL);
    }
    else if ( v7 == CSpriteVectorShape::IsOfType )
    {
      v8 = CSpriteVectorShape::IsOfType((__int64)v6, 163);
    }
    else
    {
      v8 = v7((__int64)v6, 163);
    }
    if ( v8 )
    {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x34u, 0LL);
LABEL_35:
  *(_DWORD *)(a1 + 4) = 0;
  *(_QWORD *)(a1 + 8) = 0LL;
  *(_QWORD *)(a1 + 16) = 0LL;
