/*
 * XREFs of McTemplateU0xqqxqx_EventWriteTransfer @ 0x1802C6D5C
 * Callers:
...
ULONG __fastcall McTemplateU0xqqxqx_EventWriteTransfer(
        __int64 a1,
        ...
        char a8)
{
  ...
  v19 = 4LL;
  v21 = 8LL;
  return McGenEventWrite_EventWriteTransfer(Microsoft_Windows_Dwm_Compositor_Context, a2, a3, 7u, &v9);
}
