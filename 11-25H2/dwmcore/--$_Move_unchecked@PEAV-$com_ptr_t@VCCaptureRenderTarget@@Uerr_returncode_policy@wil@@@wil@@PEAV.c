/*
 * XREFs of ??$_Move_unchecked@PEAV?$com_ptr_t@VCCaptureRenderTarget@@Uerr_returncode_policy@wil@@@wil@@PEAV12@@std@@YAPEAV?$com_ptr_t@VCCaptureRenderTarget@@Uerr_returncode_policy@wil@@@wil@@PEAV12@00@Z @ 0x1801F935C
 * Callers:
