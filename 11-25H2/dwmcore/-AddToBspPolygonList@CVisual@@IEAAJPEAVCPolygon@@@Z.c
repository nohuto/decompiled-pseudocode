/*
 * XREFs of ?AddToBspPolygonList@CVisual@@IEAAJPEAVCPolygon@@@Z @ 0x180216968
 * Callers:
...
__int64 __fastcall CVisual::AddToBspPolygonList(CVisual *this, struct CPolygon *a2)
{
  ...
  if ( !BspPolygonList )
  {
    ...
    {
      v9 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x1727u, 0LL);
      return v9;
    }
    *v5 = 0LL;
    v5[1] = 0LL;
...
LABEL_13:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0x172Bu, 0LL);
    return v9;
  }
  v8 = 0;
