/*
 * XREFs of ?_Tidy@?$vector@UFragmentStackEntry@CFragmentIterator@@V?$allocator@UFragmentStackEntry@CFragmentIterator@@@std@@@std@@AEAAXXZ @ 0x18006CB44
 * Callers:
...
void __fastcall std::vector<CFragmentIterator::FragmentStackEntry>::_Tidy(__int64 a1)
{
  _QWORD *v2; // rcx
  ...
  if ( v2 )
  {
    v3 = (*(_QWORD *)(a1 + 16) - (_QWORD)v2) & 0xFFFFFFFFFFFFFFF0uLL;
    if ( v3 >= 0x1000 )
    {
      v3 += 39LL;
