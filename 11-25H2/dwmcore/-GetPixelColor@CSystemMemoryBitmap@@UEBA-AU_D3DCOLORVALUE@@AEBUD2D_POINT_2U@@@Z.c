/*
 * XREFs of ?GetPixelColor@CSystemMemoryBitmap@@UEBA?AU_D3DCOLORVALUE@@AEBUD2D_POINT_2U@@@Z @ 0x180040A40
 * Callers:
        ...
        const struct D2D_POINT_2U *a3)
{
  ...
  *(_OWORD *)&retstr->r = 0LL;
  ...
  {
    v4 = *((_DWORD *)this - 6);
    if ( (unsigned int)(v4 - 87) <= 1 && a3->x < *((_DWORD *)this - 10) )
    {
      y = a3->y;
      if ( y < *((_DWORD *)this - 9) )
      {
