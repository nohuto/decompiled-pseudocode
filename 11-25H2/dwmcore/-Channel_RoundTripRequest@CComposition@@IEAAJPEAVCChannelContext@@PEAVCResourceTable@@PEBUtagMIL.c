/*
 * XREFs of ?Channel_RoundTripRequest@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_ROUNDTRIPREQUEST@@@Z @ 0x1801E4044
 * Callers:
...
LABEL_10:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x581u, 0LL);
