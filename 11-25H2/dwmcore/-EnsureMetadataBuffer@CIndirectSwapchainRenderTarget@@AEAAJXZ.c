/*
 * XREFs of ?EnsureMetadataBuffer@CIndirectSwapchainRenderTarget@@AEAAJXZ @ 0x1801AA26C
 * Callers:
...
__int64 __fastcall CIndirectSwapchainRenderTarget::EnsureMetadataBuffer(CIndirectSwapchainRenderTarget *this)
{
  ...
  *((_DWORD *)this + 698) = 0;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x1F3u, 0LL);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x1F4u, 0LL);
    }
           ...
           || (v12 = 2, v9 = DynArray<unsigned char,0>::AddMultipleAndSet(v1, &v12, 4LL), v5 = v9, v9 >= 0) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x206u, 0LL);
      }
      else if ( *((_BYTE *)this + 2801) )
      {
        ...
        v5 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0x20Cu, 0LL);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x200u, 0LL);
    }
  }
  return v5;
}
