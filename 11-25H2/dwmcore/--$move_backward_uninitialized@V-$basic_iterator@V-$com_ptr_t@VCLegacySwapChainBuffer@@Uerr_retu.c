...
__int64 __fastcall detail::move_backward_uninitialized<detail::basic_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy>>,stdext::checked_array_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy> *>>(
        _QWORD *a1,
        __int64 *a2,
        __int64 *a3)
{
