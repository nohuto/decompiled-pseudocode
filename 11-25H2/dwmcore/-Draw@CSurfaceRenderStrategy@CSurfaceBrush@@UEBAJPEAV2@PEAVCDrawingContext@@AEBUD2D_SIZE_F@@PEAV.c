/*
 * XREFs of ?Draw@CSurfaceRenderStrategy@CSurfaceBrush@@UEBAJPEAV2@PEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180072230
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
      ...
      if ( (char *)v12 == (char *)CEffectBrush::IsReadyToDraw )
