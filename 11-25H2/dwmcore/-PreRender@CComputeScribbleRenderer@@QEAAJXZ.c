/*
 * XREFs of ?PreRender@CComputeScribbleRenderer@@QEAAJXZ @ 0x180173CD0
 * Callers:
 ...
 *     ?SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z @ 0x180293708 (-SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z.c)
...
__int64 __fastcall CComputeScribbleRenderer::PreRender(CComputeScribbleRenderer *this)
{
  ...
  v6 = (CComputeScribbleFramebuffer *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 184LL))(v4);
