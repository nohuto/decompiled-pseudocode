/*
 * XREFs of ?GetBitmapInternal@CD2DBitmapCache@@IEAAJU_LUID@@VDisplayId@@_NPEAPEAVID2DBitmap@@PEA_N@Z @ 0x18018B7A0
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  *a6 = 0;
  ...
  LowPart = a2.LowPart;
  if ( (*(unsigned __int8 (**)(void))(*(_QWORD *)v11 + 56LL))() && *((_BYTE *)g_pComposition + 6490) )
    goto LABEL_14;
  v14 = *((_QWORD *)a1 + 4);
  if ( v14
