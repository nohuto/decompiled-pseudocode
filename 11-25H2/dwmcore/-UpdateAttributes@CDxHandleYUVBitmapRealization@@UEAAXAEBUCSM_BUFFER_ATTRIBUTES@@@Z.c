/*
 * XREFs of ?UpdateAttributes@CDxHandleYUVBitmapRealization@@UEAAXAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x180173580
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalcDisplayRestriction@CBitmapRealization@@KA?AVDisplayId@@_NPEAUHMONITOR__@@@Z @ 0x1801737A0 (-CalcDisplayRestriction@CBitmapRealization@@KA-AVDisplayId@@_NPEAUHMONITOR__@@@Z.c)
 */
        ...
        const struct CSM_BUFFER_ATTRIBUTES *a2)
{
  ...
  *v7 = *(_OWORD *)v2;
  ...
  v7[7] = *((_OWORD *)v2 + 7);
  v7[8] = *((_OWORD *)v2 + 8);
  if ( !(unsigned __int8)TMilRect<int,tagRECT,D2D_POINTANDSIZE_L,RectUniqueness::_CMilRectL_>::IsEquivalentTo(
                           &v12,
                           (char *)v6 - 172) )
  {
    *(_BYTE *)(v8 - 8) = 0;
