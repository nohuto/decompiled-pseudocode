        ...
        __int64 a8)
{
  ...
  __int32 v39; // [rsp+E0h] [rbp-20h]
  __int32 v40; // [rsp+E4h] [rbp-1Ch]
  __int128 v41; // [rsp+E8h] [rbp-18h] BYREF
  __int32 v42; // [rsp+F8h] [rbp-8h]
  __int32 v43; // [rsp+FCh] [rbp-4h]
  ...
  if ( !*(_QWORD *)(a1 + 128) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x330u, 0LL);
    return 0;
  }
  v39 = 0;
  v40 = 0;
...
LABEL_11:
  ...
  SourceInputBounds = (*(__int64 (__fastcall **)(_QWORD, __int128 *, const __m128i *, _QWORD, int, __int128 *, __int128 *))(**(_QWORD **)(a1 + 128) + 96LL))(
                        *(_QWORD *)(a1 + 128),
                        &v50,
                        a2,
                        v31,
...
LABEL_14:
  ...
  else
  {
    ...
    v42 = v17;
    v43 = v18;
    CMILMatrix::Transform3DBoundsHelper<1>(a4, &v38, &v44);
    CMILMatrix::Transform3DBoundsHelper<1>(a4, &v41, &v47);
    v16 = v44;
    v19 = v47;
  }
  *(_OWORD *)a7 = v16;
