/*
 * XREFs of ??$destruct_range@V?$com_ptr_t@VCD3DConstantBuffer@@Uerr_returncode_policy@wil@@@wil@@@detail@@YAXPEAV?$com_ptr_t@VCD3DConstantBuffer@@Uerr_returncode_policy@wil@@@wil@@0@Z @ 0x180202D04
 * Callers:
        ...
        struct CMILPoolResource **a2)
{
  ...
  if ( a1 != a2 )
  {
    v3 = a1;
    do
      result = wil::com_ptr_t<CD3DVidMemOnlyTexture,wil::err_returncode_policy>::~com_ptr_t<CD3DVidMemOnlyTexture,wil::err_returncode_policy>(v3++);
    while ( v3 != a2 );
  }
  return result;
}
