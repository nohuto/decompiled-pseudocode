/*
 * XREFs of ?HrCreateBitmapFromMemoryEx@@YAJIIAEBUPixelFormatInfo@@IIPEAEPEAUIUnknown@@PEAPEAVIBitmapSource@@@Z @ 0x1801875C8
 * Callers:
...
LABEL_11:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0x26u, 0LL);
