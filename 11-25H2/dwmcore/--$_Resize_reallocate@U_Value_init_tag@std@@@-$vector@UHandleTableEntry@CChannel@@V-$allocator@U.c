/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UHandleTableEntry@CChannel@@V?$allocator@UHandleTableEntry@CChannel@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801DD7E0
 * Callers:
...
void __fastcall std::vector<CChannel::HandleTableEntry>::_Resize_reallocate<std::_Value_init_tag>(
        __int64 *a1,
        unsigned __int64 a2)
{
  ...
  std::vector<CChannel::HandleTableEntry>::_Change_array(a1, v10, a2, v2);
}
