/*
 * XREFs of ?StartInertia@CMotion@@IEAAXMM_N0@Z @ 0x1800F11BC
 * Callers:
...
void __fastcall CMotion::StartInertia(CMotion *this, float a2, float a3, char a4, int a5)
{
  ...
  CMotion *v22; // [rsp+78h] [rbp+1Fh] BYREF
  ...
  *((_DWORD *)this + 10) = 2;
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_180404D18, 2LL, v14, v15) )
    {
