/*
 * XREFs of ?NotifyAnimationStateChanged@CBaseExpression@@AEAAJW4AnimationEventType@@@Z @ 0x18003C07C
 * Callers:
      ...
      && a2 != 16 )
    {
      ...
      if ( v9 )
      {
        ...
        if ( Property >= 0 )
        {
          ...
          v8 = v51;
LABEL_17:
          v15 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(a1 + 24) + 6416LL) + 72LL))(
            ...
            if ( v55 != 69 )
            {
              switch ( v55 )
              {
                case 11:
                  ...
                  *((_QWORD *)&v43 + 1) = *(unsigned int *)(a1 + 72);
                  *(_QWORD *)&v43 = v30;
                  v20 = CoreUICallSend(v33, &v43, 2LL, 0LL, 9, &unk_180336E42, a2, v32, v31);
LABEL_30:
                  v4 = v20;
...
LABEL_29:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18031EC40, 2u, Property, v35, 0LL);
    }
    v53[0] = 0;
    LODWORD(v47) = 0;
    a2 = 16;
