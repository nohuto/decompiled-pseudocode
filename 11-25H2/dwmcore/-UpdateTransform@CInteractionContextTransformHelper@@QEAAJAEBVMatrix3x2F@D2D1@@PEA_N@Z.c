/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x180215DE4
 * Callers:
 ...
 * Callees:
 *     IsEqualMatrix @ 0x1802160C8 (IsEqualMatrix.c)
 *     GetIndividualScales @ 0x180216124 (GetIndividualScales.c)
 *     GetInverse @ 0x1802161F8 (GetInverse.c)
 */
