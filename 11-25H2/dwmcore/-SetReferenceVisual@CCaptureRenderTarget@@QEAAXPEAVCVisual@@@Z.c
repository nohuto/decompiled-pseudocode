/*
 * XREFs of ?SetReferenceVisual@CCaptureRenderTarget@@QEAAXPEAVCVisual@@@Z @ 0x1801F93C0
 * Callers:
...
void __fastcall CCaptureRenderTarget::SetReferenceVisual(struct CMILPoolResource **this, struct CVisual *a2)
{
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::operator=(this + 370, a2);
