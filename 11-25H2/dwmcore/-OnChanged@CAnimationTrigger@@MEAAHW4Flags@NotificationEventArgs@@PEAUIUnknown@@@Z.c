/*
 * XREFs of ?OnChanged@CAnimationTrigger@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18022C310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAnimationTrigger::OnChanged(struct CResource *a1, __int64 a2, __int64 a3)
{
    ...
    if ( (unsigned int)(v4 - 8) <= 1 && v6 )
    {
      ...
      if ( !*((_QWORD *)a1 + 19) )
      {
        ...
        DataProviderManager::TryNotify(
          *(DataProviderManager **)(*((_QWORD *)a1 + 3) + 6424LL),
          a1,
          *((_QWORD *)a1 + 10),
          *((_QWORD *)a1 + 11),
          1u);
  ...
  else if ( (unsigned int)dword_180404D18 > 5 && tlgKeywordOn((__int64)&dword_180404D18, 4LL) )
  {
    v19 = a1;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>>(
      (__int64)&v19,
