/*
 * XREFs of ?ComputeOverlayConfigurationForAdapter@COverlayContext@@CAJAEBV?$span@PEAVCOverlayContext@@$0?0@gsl@@@Z @ 0x18002CA40
 * Callers:
  ...
  while ( v1 != v4 )
  {
    if ( COverlayContext::HaveOverlayCandidatesChanged(*v1) )
    {
      ...
      while ( v13 != v14 )
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x903u, 0LL);
          break;
        }
        ++v13;
      }
