/*
 * XREFs of ?push_back@?$vector_facade@PEBVCVisualTree@@V?$buffer_impl@PEBVCVisualTree@@$07$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXAEBQEBVCVisualTree@@@Z @ 0x1800207A0
 * Callers:
 ...
 *     ??Y?$checked_array_iterator@PEAPEBVCVisualTree@@@stdext@@QEAAAEAV01@_J@Z @ 0x180196260 (--Y-$checked_array_iterator@PEAPEBVCVisualTree@@@stdext@@QEAAAEAV01@_J@Z.c)
