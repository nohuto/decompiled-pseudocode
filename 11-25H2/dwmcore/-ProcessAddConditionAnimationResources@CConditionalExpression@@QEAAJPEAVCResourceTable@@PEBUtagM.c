/*
 * XREFs of ?ProcessAddConditionAnimationResources@CConditionalExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CONDITIONALEXPRESSION_ADDCONDITIONANIMATIONRESOURCES@@PEBXI@Z @ 0x1801B9184
 * Callers:
...
LABEL_17:
    ...
    *(_QWORD *)&v23 = v11;
    ...
    v14 = v13;
    if ( !v13
      || !(*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)v13 + 64LL))(v13, 59LL)
      && !(*(unsigned __int8 (__fastcall **)(struct CResource *, __int64))(*(_QWORD *)v14 + 64LL))(v14, 111LL) )
    {
      v17 = -2003303421;
