/*
 * XREFs of ?ProcessVailPerFrameDataBuffer@CGenericInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GENERICINK_VAILPERFRAMEDATABUFFER@@@Z @ 0x18023A854
 * Callers:
        ...
        const struct tagMILCMD_GENERICINK_VAILPERFRAMEDATABUFFER *a3)
{
  ...
  if ( v5 )
  {
    Resource = (struct CCrossContainerGuestReadWriteSharedSection *)CResourceTable::GetResource((__int64)a2, v5, 0x2Fu);
    if ( !Resource )
    {
