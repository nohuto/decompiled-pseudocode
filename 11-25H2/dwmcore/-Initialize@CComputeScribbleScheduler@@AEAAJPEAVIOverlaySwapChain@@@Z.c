/*
 * XREFs of ?Initialize@CComputeScribbleScheduler@@AEAAJPEAVIOverlaySwapChain@@@Z @ 0x1802932E0
 * Callers:
 ...
 *     ??$_Emplace_reallocate@PEAVCComputeScribbleFramebuffer@@@?$vector@PEAVCComputeScribbleFramebuffer@@V?$allocator@PEAVCComputeScribbleFramebuffer@@@std@@@std@@AEAAPEAPEAVCComputeScribbleFramebuffer@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18022D1A4 (--$_Emplace_reallocate@PEAVCComputeScribbleFramebuffer@@@-$vector@PEAVCComputeScribbleFramebuffe.c)
...
__int64 __fastcall CComputeScribbleScheduler::Initialize(CComputeScribbleScheduler *this, struct IOverlaySwapChain *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 232LL))(a2);
  v5 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 104LL))(a2);
  ...
  if ( CCommonRegistryData::ConservativeInk )
  {
    ...
    {
      v6 = *(_BYTE *)((*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 40LL))(a2) + 1496);
      goto LABEL_7;
    }
  }
  v6 = 0;
LABEL_7:
  ...
  *((_DWORD *)this + 11) = v36[1];
  v12 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 256LL))(a2);
...
LABEL_14:
  ...
  *((double *)this + 1) = v22;
  ...
  for ( i = 0; ; ++i )
  {
    v25 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)a2 + 88LL))(a2);
    v26 = *(__int64 (__fastcall ***)(struct IOverlaySwapChain *, GUID *, __int64 *))a2;
    if ( i >= v25 )
      break;
    v27 = ((__int64 (__fastcall *)(struct IOverlaySwapChain *, _QWORD))v26[26])(a2, i);
    v28 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v27 + 176LL))(v27, v23);
    v29 = v28;
    if ( v28 < 0 )
    {
    ...
    v30 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v27 + 184LL))(v27);
    v31 = (_BYTE *)*((_QWORD *)this + 17);
    v37 = v30;
    if ( v31 == *((_BYTE **)this + 18) )
    {
  ...
  v32 = ((__int64 (__fastcall *)(struct IOverlaySwapChain *))v26[11])(a2);
