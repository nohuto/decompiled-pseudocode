/*
 * XREFs of ?CreatePrimaryDescription@CDDisplayManager@@QEAAJAEBUPixelFormatInfo@@AEBUD2D_SIZE_U@@IPEAPEAUIDisplayPrimaryDescription@Core@Display@Devices@Windows@@@Z @ 0x1801C5760
 * Callers:
...
LABEL_8:
    v16 = qword_180406BD8;
    v17 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, int, char, __int64, struct Windows::Devices::Display::Core::IDisplayPrimaryDescription **))(*(_QWORD *)qword_180406BD8 + 48LL);
    if ( v6 )
