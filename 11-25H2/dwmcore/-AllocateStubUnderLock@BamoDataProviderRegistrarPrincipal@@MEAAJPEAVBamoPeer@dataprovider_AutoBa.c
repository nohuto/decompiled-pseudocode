/*
 * XREFs of ?AllocateStubUnderLock@BamoDataProviderRegistrarPrincipal@@MEAAJPEAVBamoPeer@dataprovider_AutoBamos@@PEAPEAVBamoDataProviderRegistrarStub@@@Z @ 0x18022D5E0
 * Callers:
 *     <none>
 * Callees:
