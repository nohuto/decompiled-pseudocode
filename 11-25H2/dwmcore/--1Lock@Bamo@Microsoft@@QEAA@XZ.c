/*
 * XREFs of ??1Lock@Bamo@Microsoft@@QEAA@XZ @ 0x1801D0E10
 * Callers:
...
void __fastcall Microsoft::Bamo::Lock::~Lock(Microsoft::Bamo::Lock *this)
{
  ...
  wil::com_ptr_t<Microsoft::BamoImpl::ConnectionIndirector,wil::err_returncode_policy>::~com_ptr_t<Microsoft::BamoImpl::ConnectionIndirector,wil::err_returncode_policy>((Microsoft::BamoImpl::BamoImplObject **)this);
}
