/*
 * XREFs of ?Initialize@CDeviceTextureTarget@@MEAAJXZ @ 0x1800429C0
 * Callers:
...
__int64 __fastcall CDeviceTextureTarget::Initialize(CDeviceTextureTarget *this)
{
  ...
  *v1 = 0LL;
  ...
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304307, 0x6DFu, 0LL);
  }
  else
  {
    ...
    v6 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x6E3u, 0LL);
  }
