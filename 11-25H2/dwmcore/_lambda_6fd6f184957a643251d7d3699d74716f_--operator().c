/*
 * XREFs of _lambda_6fd6f184957a643251d7d3699d74716f_::operator() @ 0x180180ED4
 * Callers:
...
LABEL_12:
  ...
  *(_DWORD *)(v6 + 24) = v8;
LABEL_4:
  if ( (unsigned int)dword_180404CA8 > 5 && (qword_180404CB8 & 1) != 0 )
  {
    result = qword_180404CC0 & 1;
    if ( result == qword_180404CC0 )
