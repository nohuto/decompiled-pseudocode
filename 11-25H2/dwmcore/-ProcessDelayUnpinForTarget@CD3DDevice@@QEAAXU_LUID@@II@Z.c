/*
 * XREFs of ?ProcessDelayUnpinForTarget@CD3DDevice@@QEAAXU_LUID@@II@Z @ 0x1802C42B8
 * Callers:
 *     ?ProcessDelayUnpin@CLegacyRenderTarget@@UEAAXXZ @ 0x180289A20 (-ProcessDelayUnpin@CLegacyRenderTarget@@UEAAXXZ.c)
 *     ?ProcessDelayUnpin@CDDisplayRenderTarget@@UEAAXXZ @ 0x18028A360 (-ProcessDelayUnpin@CDDisplayRenderTarget@@UEAAXXZ.c)
        ...
        unsigned int a4)
{
  ...
  if ( (_QWORD)v17 != *((_QWORD *)&v17 + 1) )
  {
    ...
    v12 = v11;
    if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 2) != 0 )
      McTemplateU0t_EventWriteTransfer((__int64)Microsoft_Windows_Dwm_Compositor_Context, (__int64)&UnPinning_Stop, v11);
    if ( v12 < 0 )
  ...
  std::vector<wil::com_ptr_t<CWeakReference<CGdiSpriteBitmap>,wil::err_returncode_policy>>::_Tidy((__int64)&v15);
