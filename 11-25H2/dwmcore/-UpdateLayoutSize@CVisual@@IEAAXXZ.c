/*
 * XREFs of ?UpdateLayoutSize@CVisual@@IEAAXXZ @ 0x180168E00
 * Callers:
...
void __fastcall CVisual::UpdateLayoutSize(CVisual *this)
{
  ...
  if ( !v1 || (*(_BYTE *)(v1 + 96) & 1) != 0 )
  {
    ...
    v11 = (float)(*(float *)&v36 * v3) + *((float *)this + 29);
    v12 = (float)(*((float *)&v36 + 1) * v4) + *((float *)this + 30);
    *((float *)this + 32) = v11;
    *((float *)this + 33) = v12;
    ...
    *((float *)this + 36) = v16;
    ...
    else
    {
      ...
      if ( v32 && *(_BYTE *)(v32 + 132) )
        CVisual::OnClipChanged(this, v10);
      CVisual::OnLayoutChanged(this, v10);
    }
    if ( v17 )
    {
      *((_QWORD *)this + 69) = 0LL;
      ...
      if ( *(int *)v19 < 0 )
      {
        ...
        v21 = (_BYTE *)(v19 + 8);
        for ( j = 0LL; (unsigned int)j < (unsigned int)v20; ++v21 )
        {
          if ( *v21 == 1 )
            break;
          j = (unsigned int)(j + 1);
        }
        if ( (unsigned int)j >= (unsigned int)v20 )
          v23 = 0LL;
        else
          v23 = (_QWORD ***)(v20 + 15 + v19 + 8 * j - (((_BYTE)v20 + 15) & 7));
        v24 = *v23;
        if ( v24 )
        {
