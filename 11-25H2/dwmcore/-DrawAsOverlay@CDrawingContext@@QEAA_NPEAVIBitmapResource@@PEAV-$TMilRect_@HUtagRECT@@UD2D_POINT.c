/*
 * XREFs of ?DrawAsOverlay@CDrawingContext@@QEAA_NPEAVIBitmapResource@@PEAV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18024BB4C
 * Callers:
 ...
 *     ?IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ @ 0x1801D8770 (-IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ.c)
 *     ?FindOverlayPlaneIndex@COverlayContext@@AEBAHPEBVCVisual@@U_LUID@@@Z @ 0x1801FAD98 (-FindOverlayPlaneIndex@COverlayContext@@AEBAHPEBVCVisual@@U_LUID@@@Z.c)
 ...
 *     ??1CSetOverlayColorRenderStateScope@CDrawingContext@@QEAA@XZ @ 0x18021EB10 (--1CSetOverlayColorRenderStateScope@CDrawingContext@@QEAA@XZ.c)
...
char __fastcall CDrawingContext::DrawAsOverlay(COverlayContext **this, CCompositionSurfaceBitmap *a2, _QWORD *a3)
{
  ...
  CGDISectionBitmapRealization *v56; // [rsp+60h] [rbp-A8h] BYREF
      ...
      if ( v10 >= 0 )
      {
           ...
           || (*(unsigned __int8 (__fastcall **)(char *))(*(_QWORD *)v54 + 152LL))(v54)) )
        {
          ...
          *(_OWORD *)v55 = 0LL;
          ...
          {
            v6 = 1;
            v18 = *((_QWORD *)v12 + 1617) + 400LL * OverlayPlaneIndex;
            v13 = *(__m128i *)(v18 + 68);
            v19 = *(_OWORD *)(v18 + 244);
            v14 = *(__m128i *)(v18 + 52);
            *(__m128i *)v55 = v13;
...
LABEL_56:
  ...
  if ( v56 )
    (*(void (__fastcall **)(CGDISectionBitmapRealization *))(*(_QWORD *)v56 + 16LL))(v56);
  return v6;
}
