/*
 * XREFs of ?CalcEyePointOrVector@CCompositionLight@@IEBA?AUfloat4@Numerics@Foundation@Windows@@PEAVCVisual@@@Z @ 0x18011D484
 * Callers:
...
__int64 __fastcall CCompositionLight::CalcEyePointOrVector(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v10 = Windows::Foundation::Numerics::invert(
          (Windows::Foundation::Numerics *)&v44,
          (const struct Windows::Foundation::Numerics::float4x4 *)&v44,
          v9);
