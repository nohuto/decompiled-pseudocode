/*
 * XREFs of ?ProcessSetPathData@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETPATHDATA@@PEBXI@Z @ 0x180139F24
 * Callers:
...
LABEL_33:
  ...
  else
  {
    ...
    for ( i = 0; ; ++i )
    {
      if ( i >= v8 )
        return 0;
      if ( !(unsigned int)HANDLE_TABLE::ValidEntry((struct CResourceTable *)((char *)v6 + 16), a4[3 * i])
