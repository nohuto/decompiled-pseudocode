/*
 * XREFs of ??$WalkSubtree@VCBspPolygonListBuilder@@@CBspTreeIterator@@AEAAJPEAVCBspNode@@0PEAVCBspPolygonListBuilder@@W4WalkDirection@@@Z @ 0x18010B864
 * Callers:
 ...
 *     ?GotoParent@?$CGraphWalker@VCBspNode@@@@QEAAXPEAPEAVCBspNode@@@Z @ 0x180223EB8 (-GotoParent@-$CGraphWalker@VCBspNode@@@@QEAAXPEAPEAVCBspNode@@@Z.c)
        ...
        __int64 a4)
{
  ...
  *(_DWORD *)(a1 + 28) = v7;
  ...
  if ( v16 )
  {
    v13 = CBspTreeIterator::WalkSubtree<CBspPolygonListBuilder>(a1, v16, a2, a4, 0);
    v9 = v13;
    if ( v13 < 0 )
    {
  ...
  else
  {
    ...
    {
      v14 = CBspTreeIterator::WalkSubtree<CBspPolygonListBuilder>(a1, v15, a2, a4, 0);
      v9 = v14;
      if ( v14 < 0 )
