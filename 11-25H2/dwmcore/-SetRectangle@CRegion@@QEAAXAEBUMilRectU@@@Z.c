/*
 * XREFs of ?SetRectangle@CRegion@@QEAAXAEBUMilRectU@@@Z @ 0x180042640
 * Callers:
 ...
 *     ?MarkFullInvalid@CSwapChainBuffer@@UEAAXXZ @ 0x180233EE0 (-MarkFullInvalid@CSwapChainBuffer@@UEAAXXZ.c)
 * Callees:
 *     <none>
 */
