/*
 * XREFs of ??1CDeviceManager@@QEAA@XZ @ 0x180253FE0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DeviceManager__ @ 0x1802E8F60 (_dynamic_atexit_destructor_for__g_DeviceManager__.c)
 * Callees:
