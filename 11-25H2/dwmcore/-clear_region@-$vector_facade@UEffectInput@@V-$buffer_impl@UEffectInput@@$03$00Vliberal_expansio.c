/*
 * XREFs of ?clear_region@?$vector_facade@UEffectInput@@V?$buffer_impl@UEffectInput@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x180080308
 * Callers:
...
LABEL_5:
  ...
  {
    EffectInput::operator=(v10 + v3, v3);
    v3 += 112LL;
  }
LABEL_7:
