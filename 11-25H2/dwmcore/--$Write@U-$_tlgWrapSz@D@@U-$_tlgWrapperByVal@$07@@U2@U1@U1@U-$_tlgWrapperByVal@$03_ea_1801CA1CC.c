        ...
        __int64 a37)
{
  ...
  const char *v93; // r8
  int v94; // edx
  struct _EVENT_DATA_DESCRIPTOR v96; // [rsp+30h] [rbp-D0h] BYREF
  const char *v97; // [rsp+50h] [rbp-B0h]
  ...
  const char *v104; // [rsp+80h] [rbp-80h]
  int v105; // [rsp+88h] [rbp-78h]
  int v106; // [rsp+8Ch] [rbp-74h]
  const char *v107; // [rsp+90h] [rbp-70h]
  ...
  v98 = v94;
  v99 = 0;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 0x23u, &v96);
}
