/*
 * XREFs of ?GetBounds@CCompositionSurfaceBitmap@@UEBAJAEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800A1B60
 * Callers:
...
__int64 __fastcall CCompositionSurfaceBitmap::GetBounds(CCompositionSurfaceBitmap *this, float *a2, __int64 a3)
{
  ...
  struct IBitmapRealization *(__fastcall *v7)(CGlobalCompositionSurfaceInfo *__hidden); // rax
  __int64 v8; // rax
  __int64 *v9; // rbx
  __int64 v10; // rax
  char v11; // al
  ...
  if ( !v3 )
    goto LABEL_25;
  v7 = *(struct IBitmapRealization *(__fastcall **)(CGlobalCompositionSurfaceInfo *__hidden))(*(_QWORD *)v3 + 48LL);
