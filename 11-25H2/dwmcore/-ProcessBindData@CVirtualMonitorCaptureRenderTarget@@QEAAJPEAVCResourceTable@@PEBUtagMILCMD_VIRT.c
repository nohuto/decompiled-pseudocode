/*
 * XREFs of ?ProcessBindData@CVirtualMonitorCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VIRTUALMONITORCAPTURERENDERTARGET_BINDDATA@@@Z @ 0x18028E558
 * Callers:
        ...
        const struct tagMILCMD_VIRTUALMONITORCAPTURERENDERTARGET_BINDDATA *a3)
{
  ...
  v13 = a2;
  *((_QWORD *)this + 396) = *((_QWORD *)a3 + 1);
  v5 = 0;
  *((_BYTE *)this + 3176) = *((_BYTE *)a3 + 32);
  *((_DWORD *)this + 795) = *((_DWORD *)a3 + 12) - *((_DWORD *)a3 + 10);
  *((_DWORD *)this + 796) = *((_DWORD *)a3 + 13) - *((_DWORD *)a3 + 11);
  *((_DWORD *)this + 797) = *((_DWORD *)a3 + 6) - *((_DWORD *)a3 + 4);
  *((_DWORD *)this + 798) = *((_DWORD *)a3 + 7) - *((_DWORD *)a3 + 5);
  *((_DWORD *)this + 799) = *((_DWORD *)a3 + 4);
  *((_DWORD *)this + 800) = *((_DWORD *)a3 + 5);
