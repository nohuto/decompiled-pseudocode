/*
 * XREFs of ?UpdateExpressionsWorker@CExpressionManager@@AEAAX_N@Z @ 0x180038450
 * Callers:
  ...
  *(_QWORD *)((char *)this + 444) = 0LL;
  if ( *((_DWORD *)this + 8 * v5 + 46) )
  {
    while ( 1 )
    {
      ...
      {
        if ( (unsigned __int8)CBaseExpression::IsOfType(v7, 91LL) )
          goto LABEL_6;
      }
      else
      {
        if ( (char *)v8 == (char *)CKeyframeAnimation::IsOfType )
          v25 = CKeyframeAnimation::IsOfType(v7, 91LL);
        else
          v25 = v8(v7, 91LL);
        if ( v25 )
        {
