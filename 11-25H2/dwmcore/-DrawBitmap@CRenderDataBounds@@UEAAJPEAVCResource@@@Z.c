/*
 * XREFs of ?DrawBitmap@CRenderDataBounds@@UEAAJPEAVCResource@@@Z @ 0x1801EE1C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsOfType@CCachedVisualImage@@MEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1801EE2E0 (-IsOfType@CCachedVisualImage@@MEBA_NW4MIL_RESOURCE_TYPE@@@Z.c)
...
__int64 __fastcall CRenderDataBounds::DrawBitmap(CRenderDataBounds *this, struct CResource *a2)
{
  ...
  if ( (char *)v4 == (char *)CCachedVisualImage::IsOfType )
    v5 = CCachedVisualImage::IsOfType(a2, 84LL);
  else
    v5 = v4(a2, 84LL);
  if ( v5 )
  {
