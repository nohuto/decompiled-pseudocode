/*
 * XREFs of ?GetSize@CSectionBitmapRealization@@UEBA?AUD2D_SIZE_U@@XZ @ 0x1801FCE20
 * Callers:
 ...
 *     ?GetSize@?$IBitmapRealizationMethodsT@VCSectionBitmapRealization@@VIGDIBitmapRealization@@@@WPI@EBA?AUD2D_SIZE_U@@XZ @ 0x1802DFF80 (-GetSize@-$IBitmapRealizationMethodsT@VCSectionBitmapRealization@@VIGDIBitmapRealization@@@@WPI@.c)
 * Callees:
 *     <none>
 */
