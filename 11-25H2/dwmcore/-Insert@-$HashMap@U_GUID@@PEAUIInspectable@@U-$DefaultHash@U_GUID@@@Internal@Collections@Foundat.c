        ...
        _BYTE *a4)
{
  ...
  __int64 v17; // rdx
  __int64 v18; // r9
  _BYTE v20[8]; // [rsp+30h] [rbp-49h] BYREF
  int v21[4]; // [rsp+38h] [rbp-41h] BYREF
  __int128 v22; // [rsp+48h] [rbp-31h] BYREF
  RTL_SRWLOCK *v23; // [rsp+58h] [rbp-21h] BYREF
