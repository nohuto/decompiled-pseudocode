/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18027DD7C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v13[1] = v16;
      return CoreUICallSend(v10, v13, 2LL, 0LL, 4, &unk_18038ED05, a2, v12, v15);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
