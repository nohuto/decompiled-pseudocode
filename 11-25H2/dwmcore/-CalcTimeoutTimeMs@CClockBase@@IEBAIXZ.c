/*
 * XREFs of ?CalcTimeoutTimeMs@CClockBase@@IEBAIXZ @ 0x1801C1168
 * Callers:
 *     ?WaitForNextTick@CClockBase@@UEAA?AW4WaitResult@ICompositorClock@@PEAX@Z @ 0x1801BF390 (-WaitForNextTick@CClockBase@@UEAA-AW4WaitResult@ICompositorClock@@PEAX@Z.c)
