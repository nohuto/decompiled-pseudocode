/*
 * XREFs of ?InitializeQueueInfo@CInputSinkStruct@@AEAAJAEAUInputQueueInfo@1@@Z @ 0x18013B8FC
 * Callers:
 *     ?InitializeQueues@CInputSinkStruct@@AEAAXXZ @ 0x18013B888 (-InitializeQueues@CInputSinkStruct@@AEAAXXZ.c)
 * Callees:
