/*
 * XREFs of std::_Make_heap_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_4f96f9abf6f4efc73c76f9e3716c5312_____ @ 0x1802BA910
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( v6 > 0 )
  {
    v7 = (std::_Ref_count_base **)(a1 + 16 * v6 - 8);
    do
    {
      v8 = (__int64)*(v7 - 1);
      *(v7 - 1) = 0LL;
