/*
 * XREFs of ?GetBrushParameters@CBlurredWallpaperBackdropBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x18029EED0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBrushDrawListGenerator *a2)
{
  ...
  v14 = 0LL;
  v18[0] = 0LL;
  EffectInput::Reset((struct EffectInput *)&v14);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, BlurredWallpaperEffectInput, 0x30u, 0LL);
    goto LABEL_8;
  }
  if ( v17 )
  {
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x3Du, 0LL);
