/*
 * XREFs of ?SetNormalData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180283954
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[15] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xDF0u, 0LL);
    }
    else
    {
