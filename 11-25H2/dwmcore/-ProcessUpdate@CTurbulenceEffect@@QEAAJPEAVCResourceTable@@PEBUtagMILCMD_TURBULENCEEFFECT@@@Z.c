/*
 * XREFs of ?ProcessUpdate@CTurbulenceEffect@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_TURBULENCEEFFECT@@@Z @ 0x1802A0500
 * Callers:
        ...
        const struct tagMILCMD_TURBULENCEEFFECT *a3)
{
  ...
  *((_DWORD *)this + 53) = *((_DWORD *)a3 + 11);
  (*(void (__fastcall **)(CTurbulenceEffect *, _QWORD, _QWORD))(*(_QWORD *)this + 80LL))(this, 0LL, 0LL);
  return 0LL;
}
