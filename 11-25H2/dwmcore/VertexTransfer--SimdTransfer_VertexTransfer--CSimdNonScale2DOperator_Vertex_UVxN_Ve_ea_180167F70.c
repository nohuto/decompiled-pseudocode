/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x180167F70
 * Callers:
...
unsigned __int64 __fastcall VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___(
        __int64 a1,
        unsigned __int64 *a2)
{
    ...
    do
    {
      ...
      v17 = _mm_cvttps_epi32(
              _mm_mul_ps(
                _mm_mul_ps(
                  ...
                  g_NormalizeA8R8G8B8),
                _mm_or_ps(
                  _mm_andnot_ps((__m128)`DirectX::Internal::PermuteHelper<228,1,1,1,0>::Permute'::`2'::selectMask, v9),
                  _mm_and_ps(
      ...
      *v15 = _mm_or_ps(
      ...
      if ( v8 )
      {
        ...
        do
        {
          *(_OWORD *)result = *(_OWORD *)(result + v24);
          result += 16LL;
          --v23;
        }
        while ( v23 );
