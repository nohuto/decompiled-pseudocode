/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIDwmMessageConversationHost@@VCMilObjectDeleter@@@@IEAAKXZ @ 0x18025A6C8
 * Callers:
 *     ?Release@?$CMILCOMBaseT@UIDwmMessageConversationHost@@U1@VCMilObjectDeleter@@@@UEAAKXZ @ 0x1802286D0 (-Release@-$CMILCOMBaseT@UIDwmMessageConversationHost@@U1@VCMilObjectDeleter@@@@UEAAKXZ.c)
 * Callees:
