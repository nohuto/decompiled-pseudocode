/*
 * XREFs of ?EnableIndependentFlip@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJI@Z @ 0x180215348
 * Callers:
        ...
        int a2)
{
  ...
  {
    v5 = v6 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6 | 0x10000000, 0x4F7u, 0LL);
  }
  return v5;
}
