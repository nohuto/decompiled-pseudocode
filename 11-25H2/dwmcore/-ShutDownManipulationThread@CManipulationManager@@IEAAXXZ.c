/*
 * XREFs of ?ShutDownManipulationThread@CManipulationManager@@IEAAXXZ @ 0x180261EF8
 * Callers:
...
void __fastcall CManipulationManager::ShutDownManipulationThread(CManipulationManager *this)
{
  ...
  (*(void (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 5688LL) + 168LL))(
    *(_QWORD *)(*((_QWORD *)this + 2) + 5688LL),
    *((_QWORD *)this + 7));
