/*
 * XREFs of ?PostSubgraph@CShapeBoundingContext@@QEAAJPEA_N@Z @ 0x18007A614
 * Callers:
...
__int64 __fastcall CShapeBoundingContext::PostSubgraph(CShapeBoundingContext *this, bool *a2)
{
  ...
  __int64 v11; // rax
  void (__fastcall *v12)(CComponentTransform2D *, const struct D2D_SIZE_F *, struct D2D_MATRIX_3X2_F *); // rax
  float *v13; // rax
  __int32 v14; // xmm2_4
  int v15; // ecx
  __int32 v16; // xmm1_4
  ...
  float v31; // xmm3_4
  BOOL v32; // eax
  struct D2D_SIZE_F v33[2]; // [rsp+28h] [rbp-29h] BYREF
  ...
  if ( v3[6].m128i_i8[1] )
  {
    ...
    if ( *((_BYTE *)this + 64) && v6 )
    {
      if ( v5 )
        ...
        v10 = *((_QWORD *)this + 7);
      v33[0] = (struct D2D_SIZE_F)v10;
      v11 = *(_QWORD *)v6;
      memset(&v34, 0, sizeof(v34));
      v12 = *(void (__fastcall **)(CComponentTransform2D *, const struct D2D_SIZE_F *, struct D2D_MATRIX_3X2_F *))(v11 + 208);
