/*
 * XREFs of ??$_Emplace_reallocate@UCursorVisualData@CComposition@@@?$vector@UCursorVisualData@CComposition@@V?$allocator@UCursorVisualData@CComposition@@@std@@@std@@AEAAPEAUCursorVisualData@CComposition@@QEAU23@$$QEAU23@@Z @ 0x1802646BC
 * Callers:
...
unsigned __int64 __fastcall std::vector<CComposition::CursorVisualData>::_Emplace_reallocate<CComposition::CursorVisualData>(
        __int64 *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  v15 = v13;
  CComposition::CursorVisualData::CursorVisualData(v14, a3);
  v16 = a1[1];
  v17 = v15;
  v18 = *a1;
  if ( a2 != v16 )
  {
    std::_Uninitialized_move<CComposition::CursorVisualData *>(v18, a2, v15);
    v16 = a1[1];
    v17 = v14 + 32;
    v18 = a2;
  }
  std::_Uninitialized_move<CComposition::CursorVisualData *>(v18, v16, v17);
  std::vector<CComposition::CursorVisualData>::_Change_array(a1, v15, v9, v3);
  return v14;
}
