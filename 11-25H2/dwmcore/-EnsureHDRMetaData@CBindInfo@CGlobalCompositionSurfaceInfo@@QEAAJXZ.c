/*
 * XREFs of ?EnsureHDRMetaData@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJXZ @ 0x1801023FC
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( CompositionSurfaceHDRMetaData < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, CompositionSurfaceHDRMetaData | 0x10000000, 0x759u, 0LL);
    if ( v2 < 0 )
      *v1 = 0;
  }
