/*
 * XREFs of ?reserve_region@?$vector_facade@VOverlayPlaneInfo@COverlayContext@@V?$buffer_impl@VOverlayPlaneInfo@COverlayContext@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAVOverlayPlaneInfo@COverlayContext@@_K0@Z @ 0x18002F1D0
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  char v44[16]; // [rsp+60h] [rbp-20h] BYREF
  unsigned __int64 v45; // [rsp+70h] [rbp-10h]
  __int64 v46; // [rsp+B0h] [rbp+30h] BYREF

  v5 = a1[1];
  if ( 0x8F5C28F5C28F5C29uLL * ((a1[2] - v5) >> 4) >= a3 )
  {
LABEL_2:
    v3 = *a1;
    v9 = a1[1];
    v10 = 0x8F5C28F5C28F5C29uLL * ((v9 - *a1) >> 4);
    v45 = 0LL;
    *((_QWORD *)&v40 + 1) = a3;
    v11 = 400 * v10;
    v12 = v10 - a2;
  ...
  v26 = 0x8F5C28F5C28F5C29uLL * ((v5 - *a1) >> 4);
  v27 = v26 + a3;
  if ( v27 >= v26 )
  {
    v33 = detail::liberal_expansion_policy::expand(
            (detail::liberal_expansion_policy *)0x8F5C28F5C28F5C29LL,
            0x8F5C28F5C28F5C29uLL * ((__int64)(a1[2] - *a1) >> 4),
            v27);
    v34 = operator new[](saturated_mul(v33, 0x190uLL));
    v35 = a1[1];
    v36 = *a1;
    *(_QWORD *)&v41 = v34;
    v37 = v34;
    *((_QWORD *)&v41 + 1) = v26;
    ...
    std::uninitialized_move<std::move_iterator<COverlayContext::OverlayPlaneInfo *>,stdext::checked_array_iterator<COverlayContext::OverlayPlaneInfo *>>(
      ...
      v26,
      0LL);
    detail::destruct_range<COverlayContext::OverlayPlaneInfo>(*a1, a1[1]);
    v38 = (void *)*a1;
    v39 = *a1 == (_QWORD)(a1 + 3);
    v46 = 0LL;
    *a1 = v37;
    ...
    a1[1] = *a1 + 400 * v26;
    a1[2] = *a1 + 400 * v33;
    std::unique_ptr<detail::aligned_storage_for<EffectInput> [0],std::default_delete<detail::aligned_storage_for<EffectInput> [0]>>::~unique_ptr<detail::aligned_storage_for<EffectInput> [0],std::default_delete<detail::aligned_storage_for<EffectInput> [0]>>(&v46);
    goto LABEL_2;
  }
...
LABEL_5:
  ...
  if ( v9 != v9 - v15 )
  {
    ...
    do
    {
      ...
      if ( v32 >= *((_QWORD *)&v42 + 1) )
        goto LABEL_17;
      COverlayContext::OverlayPlaneInfo::OverlayPlaneInfo(v28 + 400 * v32, v31);
    }
    while ( v9 != v16 );
    v13 = v40;
  }
  ...
  v17 = 400 * a2;
  v23 = v3 + v11 - 400 * a3;
  v24 = 0x70A3D70A3D70A3D7LL * ((__int64)(v11 - 400 * a3 - 400 * a2) >> 4);
  if ( v24 >= 0 )
  {
    if ( v24 <= 0 )
      goto LABEL_23;
LABEL_17:
  ...
  if ( v10 < 0x8F5C28F5C28F5C29uLL * ((__int64)(v11 - 400 * a3 - 400 * a2) >> 4) )
    goto LABEL_17;
LABEL_23:
  v25 = 400 * a3;
  v46 = 400 * a3;
  ...
  {
    v23 -= 400LL;
    COverlayContext::OverlayPlaneInfo::operator=(v25 + v23, v23);
    v25 = v46;
  }
  v13 = v40;
LABEL_10:
