/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180255DB4
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(struct CDrawingContext *a1, __int64 a2)
{
  ...
  v3 = (char *)&unk_18039EE80 + 16 * g_DirtyRegionColor;
  if ( !v8 )
  {
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4, 0x184Au, 0LL);
  return v5;
}
