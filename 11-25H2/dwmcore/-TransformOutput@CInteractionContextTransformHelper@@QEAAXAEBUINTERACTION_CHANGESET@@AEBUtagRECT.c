/*
 * XREFs of ?TransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUINTERACTION_CHANGESET@@AEBUtagRECT@@1K_NPEAU2@@Z @ 0x1801789E8
 * Callers:
 ...
 * Callees:
 *     ?HimetricToScreen@CInteractionContextTransformHelper@@SAXAEBUtagRECT@@0PEAUINTERACTION_UPDATE@@PEAUINTERACTION_VELOCITY@@1121@Z @ 0x180178C30 (-HimetricToScreen@CInteractionContextTransformHelper@@SAXAEBUtagRECT@@0PEAUINTERACTION_UPDATE@@P.c)
  ...
  *((_OWORD *)a7 + 6) = v14;
  ...
  if ( !D2D1::Matrix3x2F::IsIdentity(this) )
  {
    ...
    if ( v18 )
    {
      if ( v15 )
      {
        v22 = (float)((float)(*(float *)v15 * *((float *)this + 25))
                    + (float)(*((float *)v15 + 1) * *((float *)this + 27)))
            + *((float *)this + 29);
        *(float *)v15 = (float)((float)(*(float *)v15 * *((float *)this + 24))
                              + (float)(*((float *)v15 + 1) * *((float *)this + 26)))
                      + *((float *)this + 28);
        *((float *)v15 + 1) = v22;
        v23 = (float)((float)(*(float *)v16 * *((float *)this + 25))
        ...
        *(float *)(v16 + 4) = v23;
        if ( a5 != 5 )
        {
          v24 = (float)((float)(*((float *)v15 + 5) * v21[3]) + (float)(*((float *)v15 + 4) * v21[1])) + v21[5];
          *((float *)v15 + 4) = (float)((float)(*((float *)v15 + 5) * v21[2]) + (float)(*((float *)v15 + 4) * *v21))
                              + v21[4];
          *((float *)v15 + 5) = v24;
        }
      }
  ...
  if ( (*((_BYTE *)a7 + 84) & 2) != 0 && v15 )
  {
    v25 = *((float *)v15 + 7);
    if ( v25 != 0.0 )
      *((double *)this + 21) = (float)((float)(*((float *)v15 + 6) - 1.0) / v25);
    if ( v16 )
