/*
 * XREFs of ?GetPresentStatistics@CDummyRemotingSwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x1802CFE70
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, PresentStatisticsDWM, 0xA2u, 0LL);
  }
  else
  {
    v6 = v8[0];
