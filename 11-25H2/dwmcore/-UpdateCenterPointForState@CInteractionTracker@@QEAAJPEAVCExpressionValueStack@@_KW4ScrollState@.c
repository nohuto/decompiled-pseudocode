/*
 * XREFs of ?UpdateCenterPointForState@CInteractionTracker@@QEAAJPEAVCExpressionValueStack@@_KW4ScrollState@@@Z @ 0x1800F1550
 * Callers:
...
__int64 __fastcall CInteractionTracker::UpdateCenterPointForState(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0x171Bu, 0LL);
  }
  else
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x171Du, 0LL);
    }
    else if ( a4 == 1 )
    {
      *v6 = *v7;
