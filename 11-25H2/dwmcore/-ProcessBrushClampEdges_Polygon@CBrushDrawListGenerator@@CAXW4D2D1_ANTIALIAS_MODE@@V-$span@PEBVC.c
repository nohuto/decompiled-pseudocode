/*
 * XREFs of ?ProcessBrushClampEdges_Polygon@CBrushDrawListGenerator@@CAXW4D2D1_ANTIALIAS_MODE@@V?$span@PEBVCDrawListBrush@@$0?0@gsl@@KAEBVMatrix3x3@@PEAVCEdgeFlagsMap@@@Z @ 0x18022F178
 * Callers:
    ...
    if ( v11 && *((_BYTE *)v11 + 52) )
    {
      ...
      else
      {
        ...
        *(_QWORD *)((char *)&v26 + 4) = LODWORD(v13);
        ...
        v23 = *((_DWORD *)v11 + 6);
        *(_QWORD *)&v27 = v22;
        *((_QWORD *)&v27 + 1) = __PAIR64__(*((_DWORD *)v11 + 7), v23);
        v28 = 1065353216;
      }
      if ( a1 == 1 )
        v24 = 0;
        ...
        v24 = *((_DWORD *)v11 + 12);
      LOBYTE(v5) = CEdgeFlagsMap::AddEdgeFlags(a5, (FLOAT *)v11 + 8, v24, (FLOAT *)&v26, SLODWORD(FLOAT_0_000081380211));
    }
  }
  return (char)v5;
}
