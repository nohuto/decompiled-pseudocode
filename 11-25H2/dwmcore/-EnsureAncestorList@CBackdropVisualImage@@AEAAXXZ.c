/*
 * XREFs of ?EnsureAncestorList@CBackdropVisualImage@@AEAAXXZ @ 0x180008F30
 * Callers:
 ...
 *     ?clear@?$vector@U?$pair@PEBVCVisual@@$$CBVCVisualTreePath@@@std@@V?$allocator@U?$pair@PEBVCVisual@@$$CBVCVisualTreePath@@@std@@@2@@std@@QEAAXXZ @ 0x180009CC0 (-clear@-$vector@U-$pair@PEBVCVisual@@$$CBVCVisualTreePath@@@std@@V-$allocator@U-$pair@PEBVCVisua.c)
