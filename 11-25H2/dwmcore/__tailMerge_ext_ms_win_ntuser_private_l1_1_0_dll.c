/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_0_dll @ 0x18025D83B
 * Callers:
 *     __imp_load_UpdateWindowInputSinkHints @ 0x18025D8BA (__imp_load_UpdateWindowInputSinkHints.c)
 * Callees:
