/*
 * XREFs of ?ProcessUpdate@CGeometryGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GEOMETRYGROUP@@PEBXI@Z @ 0x1802A023C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  else
  {
    ...
    v9 = *((_DWORD *)a3 + 2);
    v16 = 0LL;
    v10 = CResource::UnmarshalResourceArray(a4, a5, v9, 0x42u, (unsigned int *)this + 40, (void **)&v16, (__int64)a2, 0);
    v11 = v16;
    v12 = v10;
    *((_QWORD *)this + 21) = v16;
    if ( v10 < 0 )
