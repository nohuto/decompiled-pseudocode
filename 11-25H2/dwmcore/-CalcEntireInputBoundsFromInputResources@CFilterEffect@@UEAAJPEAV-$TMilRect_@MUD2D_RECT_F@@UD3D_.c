/*
 * XREFs of ?CalcEntireInputBoundsFromInputResources@CFilterEffect@@UEAAJPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x180223F70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (((unsigned __int8)v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6) & 6) == 2 )
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      for ( i = *(int *)(a1 + 152); ; v7 = i )
      {
        ...
        if ( v12 )
        {
          v13 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 64LL))(v12, 60LL);
          v14 = *(_OWORD **)(v11 + 24);
          v15 = v13 == 0;
          v16 = *(_QWORD *)v14;
          if ( v15 )
          {
            if ( !(*(unsigned __int8 (__fastcall **)(_OWORD *, __int64))(v16 + 64))(v14, 41LL) )
            {
              v10 = -2147467263;
              v38 = 573;
              goto LABEL_9;
