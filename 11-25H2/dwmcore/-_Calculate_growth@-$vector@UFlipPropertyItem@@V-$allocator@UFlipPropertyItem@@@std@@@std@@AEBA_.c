/*
 * XREFs of ?_Calculate_growth@?$vector@UFlipPropertyItem@@V?$allocator@UFlipPropertyItem@@@std@@@std@@AEBA_K_K@Z @ 0x1800C28A0
 * Callers:
...
__int64 __fastcall std::vector<FlipPropertyItem>::_Calculate_growth(_QWORD *a1, unsigned __int64 a2)
{
  __int64 result; // rax
