/*
 * XREFs of ?CheckForBufferedDescendant@CManipulationManager@@IEBA_NPEAVCManipulationFrame@@K@Z @ 0x18017FE14
 * Callers:
        ...
        unsigned int a3)
{
  ...
  CResource *v25; // [rsp+98h] [rbp+50h] BYREF
...
LABEL_4:
    ...
    else
    {
      while ( v25 && !v6 )
      {
        v17 = (*(__int64 (__fastcall **)(CResource *, __int64, CManipulationManager *))(*(_QWORD *)v25 + 64LL))(
                v25,
                v11,
                v9);
        v18 = (*(__int64 (__fastcall **)(CResource *))(*(_QWORD *)v25 + 96LL))(v25);
        Microsoft::WRL::ComPtr<IInteractionResource>::operator=(&v25, v18);
        v6 = v17 == i;
      }
      Microsoft::WRL::ComPtr<CRenderingEffect>::InternalRelease(&v27);
    }
    Microsoft::WRL::ComPtr<IInteractionResource>::InternalRelease(&v25);
    v9 = this;
  }
  return v6;
}
