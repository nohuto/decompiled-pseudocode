/*
 * XREFs of ?GetOverlayMonitorTarget@CComputeScribbleRenderer@@QEAAJPEAPEAVIOverlayMonitorTarget@@@Z @ 0x180174298
 * Callers:
...
{
  CMILCOMWeakRef *v3; // rcx
  struct IOverlayMonitorTarget *v5; // [rsp+30h] [rbp+8h] BYREF

  *a2 = 0LL;
  if ( !*((_BYTE *)this + 48) )
    return 2291662987LL;
  v3 = (CMILCOMWeakRef *)*((_QWORD *)this + 2);
  v5 = 0LL;
  if ( (int)IUnknownWeakRef::Resolve<IOverlayMonitorTarget>(v3, (void **)&v5) < 0 )
  {
