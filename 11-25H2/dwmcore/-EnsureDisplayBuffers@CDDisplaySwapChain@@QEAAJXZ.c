/*
 * XREFs of ?EnsureDisplayBuffers@CDDisplaySwapChain@@QEAAJXZ @ 0x1801C5270
 * Callers:
 ...
 *     ?IsDriverWhitelisted@CComputeScribbleRenderer@@SA_NPEBVCD3DDevice@@@Z @ 0x18023673C (-IsDriverWhitelisted@CComputeScribbleRenderer@@SA_NPEBVCD3DDevice@@@Z.c)
...
__int64 __fastcall CDDisplaySwapChain::EnsureDisplayBuffers(CDDisplaySwapChain *this)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v7, 0x366u, 0LL);
    if ( v35 )
    {
      v8 = *(_QWORD *)v35;
LABEL_8:
        ...
        *((_DWORD *)this + 68) = 0;
        if ( CD3DDevice::IsFrontBufferRenderingSupported(v17, v16) )
        {
          ...
          else if ( *(int *)(v18 + 620) >= 2600 )
          {
            ...
            if ( v24 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v24, 0x3A2u, 0LL);
            }
            else
            {
              if ( v34 )
              ...
              MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v29, 0x3ADu, 0LL);
            }
            wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v34);
            wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v37);
            goto LABEL_36;
...
LABEL_36:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v12, 0x378u, 0LL);
  if ( v34 )
    CMILRefCountBaseT<ISwapChainBuffer,CMilObjectDeleter>::InternalRelease();
  if ( v9 )
  {
