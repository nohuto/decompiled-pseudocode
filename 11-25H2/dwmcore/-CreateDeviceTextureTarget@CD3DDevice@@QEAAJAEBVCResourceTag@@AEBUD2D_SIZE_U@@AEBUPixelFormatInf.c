/*
 * XREFs of ?CreateDeviceTextureTarget@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVIDeviceTextureTarget@@@Z @ 0x1800408A0
 * Callers:
        ...
        struct IDeviceTextureTarget **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v11 >= 0 )
  {
    ...
    v23 = 1119879168;
    v24 = 1;
    v18 = CDeviceTextureTarget::Create(v17, v12, &pSysMem, &v21, v15, v19, v16, 0, a6);
    v13 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18031ECF8, 2u, v18, 0x4E0u, 0LL);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18031ECF8, 2u, v11, 0x4CFu, 0LL);
  }
  if ( v12 )
