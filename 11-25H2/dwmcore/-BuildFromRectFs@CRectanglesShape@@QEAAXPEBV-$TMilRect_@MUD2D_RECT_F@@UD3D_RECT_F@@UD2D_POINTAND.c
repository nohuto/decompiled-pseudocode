/*
 * XREFs of ?BuildFromRectFs@CRectanglesShape@@QEAAXPEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@I@Z @ 0x180191DC0
 * Callers:
...
CResource *__fastcall CRectanglesShape::BuildFromRectFs(_QWORD *a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  CResource *v38; // [rsp+30h] [rbp-78h]
  __int128 v39; // [rsp+40h] [rbp-68h]
  CResource *v40; // [rsp+50h] [rbp-58h]
  ...
  {
LABEL_25:
    ((void (__fastcall *)(CResource *, unsigned __int64))`gsl::details::get_terminate_handler'::`2'::handler)(v8, a2);
    __debugbreak();
  }
  v11 = a1[4];
  v12 = a1[2];
  v13 = (_OWORD *)a1[3];
  v14 = (CResource *)(v6 + 16 * v4);
...
LABEL_15:
  ...
  a1[3] += 16 * v10;
  v37 = v23;
  v8 = (CResource *)*((_QWORD *)&v23 + 1);
  a2 = v23;
  v38 = v24;
  v25 = (_OWORD *)(v12 + 16 * v15);
  for ( result = v24; ; result = (CResource *)((char *)result + 16) )
  {
    if ( v8 != v14 || a2 != v6 )
      goto LABEL_25;
    if ( result == v14 )
