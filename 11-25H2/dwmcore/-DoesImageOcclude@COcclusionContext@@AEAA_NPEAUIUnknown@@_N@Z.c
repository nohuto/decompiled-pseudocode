/*
 * XREFs of ?DoesImageOcclude@COcclusionContext@@AEAA_NPEAUIUnknown@@_N@Z @ 0x1800CF250
 * Callers:
 ...
 *     ?IsOpaque@CGdiSpriteBitmap@@UEBA_NXZ @ 0x1801E7F90 (-IsOpaque@CGdiSpriteBitmap@@UEBA_NXZ.c)
