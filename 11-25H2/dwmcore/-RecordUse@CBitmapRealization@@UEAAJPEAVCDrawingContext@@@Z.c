/*
 * XREFs of ?RecordUse@CBitmapRealization@@UEAAJPEAVCDrawingContext@@@Z @ 0x18018ACE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBitmapRealization::RecordUse(CBitmapRealization *this, struct CDrawingContext *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)a2 + 3) + 16LL))((char *)a2 + 24);
  v5 = *(_QWORD *)this;
  ...
  if ( (char *)v7 != (char *)CDxHandleBitmapRealization::GetDeviceTexture )
  {
    ...
    else
    {
      ...
      DeviceTexture = ((__int64 (__fastcall *)(CBitmapRealization *, const struct RenderTargetInfo *, struct IDeviceTexture **))v7)(
                        this,
                        v6,
                        &v17);
    }
  ...
  v9 = (CBitmapRealization *)((char *)this - 80);
  ...
  if ( v10 >= 0 )
  {
    CachedTexture = CD2DBitmapCache::GetCachedTexture((CBitmapRealization *)((char *)this - 80), v6, &v17);
    v11 = CachedTexture;
    if ( CachedTexture < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, CachedTexture, 0xA3u, 0LL);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0xA1u, 0LL);
  }
LABEL_6:
  if ( v11 < 0 )
  {
  ...
  {
    (*(void (__fastcall **)(CBitmapRealization *, int *))(*(_QWORD *)this + 48LL))(this, &v18);
    ...
    if ( (*(unsigned __int8 (__fastcall **)(CBitmapRealization *))(*(_QWORD *)this + 56LL))(this) )
    {
