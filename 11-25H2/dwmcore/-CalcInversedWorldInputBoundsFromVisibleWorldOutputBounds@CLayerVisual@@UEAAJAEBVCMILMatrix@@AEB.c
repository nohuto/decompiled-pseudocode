        ...
        _OWORD *a6)
{
  ...
  if ( v6 )
  {
    ...
    if ( BoundsWithLayerEffect >= 0 )
    {
      ...
      v27 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(a1, a2, v70, a4, a5, a6);
      v12 = v27;
      if ( v27 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x11Bu, 0LL);
    }
    else
    {
  ...
  *(_OWORD *)v70 = 0LL;
  ...
  v66.left = 0.0;
LABEL_41:
  TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::UnionUnsafe(&v59, &v66);
  TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::UnionUnsafe(v70, &v66);
  ...
  else
  {
    ...
    *(_OWORD *)v70 = v59;
    if ( *(_BYTE *)(a1 + 697) )
    {
      ...
      v12 = v50;
      if ( v50 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v50, 0x18Du, 0LL);
    }
    else
    {
      v47 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(a1, a2, v70, a4, a5, a6);
      v12 = v47;
      if ( v47 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v47, 0x19Au, 0LL);
    }
  }
  return v12;
}
