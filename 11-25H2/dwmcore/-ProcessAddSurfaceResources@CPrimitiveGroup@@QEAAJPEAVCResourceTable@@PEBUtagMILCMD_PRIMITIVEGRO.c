/*
 * XREFs of ?ProcessAddSurfaceResources@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PRIMITIVEGROUP_ADDSURFACERESOURCES@@PEBXI@Z @ 0x18012F5F0
 * Callers:
...
LABEL_7:
    ...
    if ( !((char *)v16 == (char *)CCompositionSurfaceBitmap::IsOfType
         ? CCompositionSurfaceBitmap::IsOfType(v15, 41LL)
         : (unsigned __int8)v16(v15, 41LL)) )
      goto LABEL_7;
