/*
 * XREFs of ?GetGradientColorData@CGradientLegacyMilBrush@@IEAAXPEAVCGradientColorData@@@Z @ 0x1801ED3BC
 * Callers:
 ...
 * Callees:
 *     ?Clear@CGradientColorData@@QEAAXXZ @ 0x1801ED704 (-Clear@CGradientColorData@@QEAAXXZ.c)
