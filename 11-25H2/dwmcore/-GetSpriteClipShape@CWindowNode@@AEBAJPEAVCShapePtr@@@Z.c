/*
 * XREFs of ?GetSpriteClipShape@CWindowNode@@AEBAJPEAVCShapePtr@@@Z @ 0x18005E280
 * Callers:
...
__int64 __fastcall CWindowNode::GetSpriteClipShape(CWindowNode *this, struct CShapePtr *a2)
{
  ...
  struct CShape *v16; // [rsp+30h] [rbp-69h] BYREF
  CShape *v17; // [rsp+38h] [rbp-61h] BYREF
  ...
  if ( ShapeData < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ShapeData, 0x627u, 0LL);
  ...
  v11 = v17;
  v16 = 0LL;
  v13 = CShape::TryOptimizedCombinePaths(v17, 0LL, (char *)v20, 0LL, 1, &v16);
  if ( v13 < 0 )
  {
    v15 = 456;
    goto LABEL_15;
  ...
  if ( !v16 )
  {
    v13 = CShape::D2DCombine(v11, v12, (CRoundedRectangleShape *)v20, 0LL, 1, &v16);
    if ( v13 >= 0 )
    {
      v14 = v16;
      goto LABEL_9;
...
LABEL_15:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x62Du, 0LL);
    CShapePtr::~CShapePtr((CShapePtr *)&v17);
    CRegionShape::~CRegionShape((CRegionShape *)v20);
