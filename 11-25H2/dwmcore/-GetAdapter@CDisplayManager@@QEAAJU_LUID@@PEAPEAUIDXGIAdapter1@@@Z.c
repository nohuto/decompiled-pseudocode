/*
 * XREFs of ?GetAdapter@CDisplayManager@@QEAAJU_LUID@@PEAPEAUIDXGIAdapter1@@@Z @ 0x18020A27C
 * Callers:
...
__int64 __fastcall CDisplayManager::GetAdapter(CDisplayManager *this, struct _LUID a2, struct IDXGIAdapter1 **a3)
{
  ...
  if ( Adapter < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803363E8, 2u, Adapter, 0x4Au, 0LL);
