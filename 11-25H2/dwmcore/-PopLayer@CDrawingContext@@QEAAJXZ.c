/*
 * XREFs of ?PopLayer@CDrawingContext@@QEAAJXZ @ 0x180085F60
 * Callers:
...
__int64 __fastcall CDrawingContext::PopLayer(CDrawingContext *this)
{
  ...
  if ( v5 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x1060u, 0LL);
      return 2291674884LL;
    }
  }
  else
  {
    ...
    *((_DWORD *)this + 96) = v7;
    ...
    else
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x10ACu, 0LL);
      }
      else
      {
        v16 = *(__int64 (**)())(*(_QWORD *)v9 + 8LL);
        if ( (char *)v16 != (char *)&COffScreenRenderingLayer::GetType )
        {
          v17 = v16 == CResampleLayer::GetType
              ? CResampleLayer::GetType()
              : ((__int64 (__fastcall *)(CD2DLayer *))v16)(v9);
          if ( v17 == 1 )
            *((_BYTE *)this + 8065) = 1;
        }
      }
    ...
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1058u, 0LL);
