/*
 * XREFs of ?AddRenderingCommand@CBatchOptimizer@@QEAA_N$$QEAV?$unique_ptr@VCBatchCommand@@U?$default_delete@VCBatchCommand@@@std@@@std@@@Z @ 0x180295158
 * Callers:
 ...
 *     ?CanTunnelToLayer@CBatchOptimizer@@AEBA_NAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@HPEAH@Z @ 0x1801B6B40 (-CanTunnelToLayer@CBatchOptimizer@@AEBA_NAEBV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTAN.c)
 ...
 *     ?MatchStateToHomogeneousLayer@CBatchOptimizer@@CA_NAEBUSharedStateLayer@@AEBUStateBlock@2@@Z @ 0x1801C2C50 (-MatchStateToHomogeneousLayer@CBatchOptimizer@@CA_NAEBUSharedStateLayer@@AEBUStateBlock@2@@Z.c)
 ...
 *     ?GetRenderingEffect@CRenderingBatchCommand@@QEBAPEAVCRenderingEffect@@XZ @ 0x1801D6630 (-GetRenderingEffect@CRenderingBatchCommand@@QEBAPEAVCRenderingEffect@@XZ.c)
 *     ?SkipContinuations@CBatchOptimizer@@AEBAHH@Z @ 0x1801D7450 (-SkipContinuations@CBatchOptimizer@@AEBAHH@Z.c)
...
char __fastcall CBatchOptimizer::AddRenderingCommand(CBatchOptimizer *this, int **a2, __int64 a3, __int64 a4)
{
  ...
  __m128 v21; // [rsp+48h] [rbp-18h] BYREF
  ...
  v8 = *a2;
  v21 = 0LL;
  CRenderingBatchCommand::GetWorldBounds((__int64)v8, &v21);
  v9 = *((_DWORD *)this + 8);
  v10 = 0;
  if ( !v9 )
    goto LABEL_23;
  while ( 1 )
  {
           ...
           (CBatchOptimizer *)((char *)this + 16)) )
    {
      if ( v12 )
      {
        if ( !CBatchOptimizer::CanTunnelToLayer((__int64)this, v21.m128_f32, v9, &v18) )
        {
          v13 = *((_DWORD *)this + 8);
          v10 = v18;
          if ( v18 == v13 - 1
