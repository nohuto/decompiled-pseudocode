/*
 * XREFs of ??1CBackdropVisualImage@@UEAA@XZ @ 0x18021CF7C
 * Callers:
  ...
  *((_QWORD *)this + 11) = &CCachedVisualImage::`vftable'{for `IDeviceResourceNotify'};
  if ( detail::vector_facade<CBlurredBackdropCache *,detail::pointer_buffer_impl<CBlurredBackdropCache *>>::size((__int64)this + 2160) )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v3);
  v4 = (void **)DwmDbg::DbgString::DbgString(&v8, word_180336D88);
  ...
  detail::vector_facade<CBlurredBackdropCache *,detail::pointer_buffer_impl<CBlurredBackdropCache *>>::~vector_facade<CBlurredBackdropCache *,detail::pointer_buffer_impl<CBlurredBackdropCache *>>(v2);
