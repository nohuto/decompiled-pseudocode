/*
 * XREFs of ?Create@CCompositionSurfaceBitmap@@SAJPEAVCComposition@@PEAVCCompositionSurfaceInfo@@PEAPEAV1@@Z @ 0x180113370
 * Callers:
        ...
        struct CCompositionSurfaceBitmap **a3)
{
  ...
  *a3 = 0LL;
  v10 = 0LL;
  v7 = CSolidColorLegacyMilBrush::operator new();
  if ( v7 )
  {
    v7[2] = 0;
    *((_QWORD *)v7 + 2) = 0LL;
