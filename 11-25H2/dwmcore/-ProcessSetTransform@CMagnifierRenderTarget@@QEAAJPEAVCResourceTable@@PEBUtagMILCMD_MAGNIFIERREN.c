/*
 * XREFs of ?ProcessSetTransform@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MAGNIFIERRENDERTARGET_SETTRANSFORM@@@Z @ 0x18022B450
 * Callers:
        ...
        const struct tagMILCMD_MAGNIFIERRENDERTARGET_SETTRANSFORM *a3)
{
  ...
  v5 = *((_DWORD *)a3 + 2);
  Resource = 0LL;
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0xACu)) != 0LL )
  {
    if ( Resource != this[25] )
    {
