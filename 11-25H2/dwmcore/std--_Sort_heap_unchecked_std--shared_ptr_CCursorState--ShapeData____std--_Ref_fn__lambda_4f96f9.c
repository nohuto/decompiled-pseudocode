/*
 * XREFs of std::_Sort_heap_unchecked_std::shared_ptr_CCursorState::ShapeData____std::_Ref_fn__lambda_4f96f9abf6f4efc73c76f9e3716c5312_____ @ 0x1802BAF04
 * Callers:
  ...
  if ( result >= 32 )
  {
    ...
    do
    {
      ...
      *v6 = 0LL;
      ...
      v6[1] = 0LL;
      v12 = v10;
      std::shared_ptr<CCursorState::ShapeData>::operator=(v6, a1);
