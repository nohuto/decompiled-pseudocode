/*
 * XREFs of ?CreateShaderBodies@CBrushRenderingGraphBuilder@@IEAAJXZ @ 0x18006F2A4
 * Callers:
...
__int64 __fastcall CBrushRenderingGraphBuilder::CreateShaderBodies(CBrushRenderingGraphBuilder *this)
{
  ...
  while ( (unsigned int)v3 < v4 )
  {
    ...
    if ( (*((_DWORD *)v5 + 66) & 1) == 0 )
    {
      ...
      if ( ShaderBodies < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ShaderBodies, 0x2C2u, 0LL);
        return v2;
      }
    }
