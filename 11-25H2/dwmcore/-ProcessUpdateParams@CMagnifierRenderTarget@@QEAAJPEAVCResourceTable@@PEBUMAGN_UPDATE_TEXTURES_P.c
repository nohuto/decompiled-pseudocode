/*
 * XREFs of ?ProcessUpdateParams@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMAGN_UPDATE_TEXTURES_PARAM@@@Z @ 0x1801AB054
 * Callers:
        ...
        const struct MAGN_UPDATE_TEXTURES_PARAM *a3)
{
  ...
  if ( memcmp_0((char *)this + 2944, a3, 0x28uLL) )
  {
    ...
    *((float *)this + 53) = (float)*((int *)a3 + 1);
    if ( v8 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v8 + 64LL))(v8, 108LL) )
      {
        v10 = *((double *)a3 + 2);
