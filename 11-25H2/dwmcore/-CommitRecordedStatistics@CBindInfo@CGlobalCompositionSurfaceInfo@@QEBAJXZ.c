/*
 * XREFs of ?CommitRecordedStatistics@CBindInfo@CGlobalCompositionSurfaceInfo@@QEBAJXZ @ 0x18029C5F0
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0x817u, 0LL);
