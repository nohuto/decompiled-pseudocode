/*
 * XREFs of ?GetWindowBackgroundTreatmentEffectInput@CDrawingContext@@QEBAJAEBUD2D_SIZE_F@@PEAUEffectInput@@@Z @ 0x180023C04
 * Callers:
 ...
 *     ?GetCachedWindowBackgroundTreatment@CVisual@@QEBAPEAVCCachedWindowBackgroundTreatment@@XZ @ 0x180170E2C (-GetCachedWindowBackgroundTreatment@CVisual@@QEBAPEAVCCachedWindowBackgroundTreatment@@XZ.c)
        ...
        struct EffectInput *a3)
{
  ...
  unsigned __int64 v81; // [rsp+B8h] [rbp-50h] BYREF
  __int32 v82; // [rsp+C0h] [rbp-48h]
  ...
  *(_OWORD *)v74 = 0LL;
  ...
  while ( (**((_DWORD **)CurrentVisual + 29) & 0x400000) == 0 )
  {
    ...
    CMILMatrix::Multiply((__m128 *)&v76, (const struct CMILMatrix *)v88, (struct CMILMatrix *)&v76);
    v19 = this[993];
    ...
    p_Blink = (struct _LIST_ENTRY **)((char *)CurrentVisual + 328);
LABEL_16:
    if ( p_Blink )
    {
      v21 = *v3;
          ...
          else
          {
            ...
            if ( v40 )
            {
              for ( k = v40->Flink; k != v40; k = k->Flink )
              {
                ...
                {
                  TreeData = (struct CTreeData *)&k[-22].Blink;
                  goto LABEL_29;
                }
              }
            }
...
LABEL_37:
  ...
  if ( !CMILMatrix::Invert((CMILMatrix *)v88) )
    goto LABEL_70;
  v70 = (__m128 *)CMatrixStack::GetTopByReference((CMatrixStack *)(this + 36));
