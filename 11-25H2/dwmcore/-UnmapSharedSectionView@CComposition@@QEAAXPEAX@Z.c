/*
 * XREFs of ?UnmapSharedSectionView@CComposition@@QEAAXPEAX@Z @ 0x18003EA94
 * Callers:
...
void __fastcall CComposition::UnmapSharedSectionView(CComposition *this, void *a2)
{
  ...
  if ( v2 + 1 < v2 )
  {
    ...
    v5 = 181;
LABEL_6:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, v5, 0LL);
  ...
  v4 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 5976, 8LL, 1LL, &lpBaseAddress);
  if ( v4 < 0 )
  {
    v5 = 192;
    goto LABEL_6;
