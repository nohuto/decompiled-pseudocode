/*
 * XREFs of ?GetD2DGeometry@CPathSegmentsShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x180089900
 * Callers:
        ...
        struct ID2D1Geometry **a3)
{
  ...
  __int64 (__fastcall *v10)(CResource *); // r8
  __int64 *v11; // r12
  CResource *v12; // rbx
  CResource *v13; // rcx
  __int64 (__fastcall *v14)(CResource *); // rax
  struct ID2D1Geometry *v15; // rax
  __int64 v17; // rax
  __int64 (__fastcall *v18)(__int64 *, CResource **); // rbx
  int v19; // eax
  CResource *v20; // rbx
  __int64 (__fastcall *v21)(CResource *, struct ID2D1GeometrySink **); // rdi
  int v22; // eax
  int v23; // eax
  int v24; // eax
  ...
  int (__fastcall **v32)(CResource *, GUID *, __int64 *); // rax
  int (__fastcall *v33)(CResource *, GUID *, __int64 *); // rax
  unsigned int v34; // xmm0_4
  __int64 v35; // rbx
  void (__fastcall *v36)(__int64, CResource **); // r14
  int v37; // eax
  __int64 v38; // rcx
  __int64 v39; // rcx
  struct ID2D1GeometrySink *v40; // [rsp+38h] [rbp-69h] BYREF
  CResource *v41; // [rsp+40h] [rbp-61h] BYREF
  struct ID2D1Geometry *v42; // [rsp+48h] [rbp-59h] BYREF
  __int64 v43; // [rsp+50h] [rbp-51h] BYREF
  CResource *v44; // [rsp+58h] [rbp-49h] BYREF
  ...
  if ( *(_QWORD *)(v8 + 56) )
  {
    ...
    if ( v41 != v12 )
    {
      if ( v12 )
      {
        (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(CGlobalDrawingContext *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))(*(_QWORD *)v12 + 8LL))(
          *(_QWORD *)(v8 + 56),
...
LABEL_6:
  ...
  v17 = *v11;
  v40 = 0LL;
  v18 = *(__int64 (__fastcall **)(__int64 *, CResource **))(v17 + 80);
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x67u, 0LL);
  }
  else
  {
    v20 = v41;
    v21 = *(__int64 (__fastcall **)(CResource *, struct ID2D1GeometrySink **))(*(_QWORD *)v41 + 136LL);
    ...
    {
      v4 = 0LL;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x68u, 0LL);
    }
    else
    {
      ...
      {
        v4 = 0LL;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x6Au, 0LL);
      }
      else
      {
        ...
        if ( v24 >= 0 )
        {
          if ( v11 == *(__int64 **)(v8 + 40) )
          {
            if ( _InterlockedCompareExchange64((volatile signed __int64 *)(v8 + 56), (signed __int64)v41, 0LL) )
              Microsoft::WRL::ComPtr<ID2D1PathGeometry>::operator=(&v41, *(_QWORD *)(v8 + 56));
            else
          ...
          {
            v40 = 0LL;
            (*(void (__fastcall **)(struct ID2D1GeometrySink *, __int64 (__fastcall *)(CGlobalDrawingContext *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))(*(_QWORD *)v25 + 16LL))(
              v25,
              v9,
              v10,
              v3);
        ...
        v4 = 0LL;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x6Cu, 0LL);
      }
    }
    v30 = v40;
    if ( v40 )
...
LABEL_7:
  ...
  {
    v41 = 0LL;
    v14 = *(__int64 (__fastcall **)(CResource *))(*(_QWORD *)v13 + 16LL);
    ...
    else if ( v14 == CMILRefCountBaseT<IDeviceResource,CMilObjectDeleter>::InternalRelease )
    {
      CMILRefCountBaseT<IDeviceResource,CMilObjectDeleter>::InternalRelease(v13);
    }
    else
    {
      ((void (__fastcall *)(CResource *, __int64 (__fastcall *)(struct CMILPoolResource *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))v14)(
        v13,
        CMILRefCountBaseT<IDeviceResource,CMilObjectDeleter>::InternalRelease,
        v10,
        v3);
  ...
  if ( v5 )
  {
    ...
    {
      LOBYTE(v9) = 1;
      if ( (unsigned __int8)CMILMatrix::Is2DAffine<1>(a2, v9, v10, v3) )
      {
        v44 = v5;
        ...
        v31 = *((_DWORD *)a2 + 1);
        v32 = *(int (__fastcall ***)(CResource *, GUID *, __int64 *))v5;
        ...
        *(_QWORD *)((char *)&v49 + 4) = __PAIR64__(*((_DWORD *)a2 + 4), v31);
        ...
        {
          v35 = v43;
          v36 = *(void (__fastcall **)(__int64, CResource **))(*(_QWORD *)v43 + 136LL);
        ...
        v45 = 0LL;
        v37 = (*(__int64 (__fastcall **)(__int64, CResource *, __int128 *, __int64 *))(*(_QWORD *)g_DeviceManager + 72LL))(
                g_DeviceManager,
                v44,
                &v49,
                &v45);
        ...
        if ( v37 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v37, 0x2Eu, 0LL);
          v39 = v43;
          if ( v43 )
          {
            v43 = 0LL;
    ...
    {
      (*(void (__fastcall **)(CResource *, __int64 (__fastcall *)(CGlobalDrawingContext *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))(*(_QWORD *)v5 + 8LL))(
        v5,
        v9,
        v10,
        v3);
...
LABEL_17:
  if ( v4 )
    (*(void (__fastcall **)(struct ID2D1Geometry *, __int64 (__fastcall *)(CGlobalDrawingContext *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))(*(_QWORD *)v4 + 16LL))(
      v4,
      v9,
      v10,
      v3);
  if ( v6 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x1Cu, 0LL);
LABEL_21:
  if ( v5 )
    (*(void (__fastcall **)(CResource *, __int64 (__fastcall *)(CGlobalDrawingContext *), __int64 (__fastcall *)(CResource *), __int64 (__fastcall *)(struct CMILPoolResource *)))(*(_QWORD *)v5 + 16LL))(
      v5,
      v9,
      v10,
      v3);
