/*
 * XREFs of ?CleanStaleFork@CManipulationContext@@AEAAXW4InputType@@PEAVCInteraction@@@Z @ 0x1802626A0
 * Callers:
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( (unsigned int)dword_180404D18 > 4 && tlgKeywordOn((__int64)&dword_180404D18, 2LL) )
      {
        ...
        v20 = 8;
        v17 = 8;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180404D18, byte_1803D633D, 0LL, 0LL, 6u, &v15);
      }
      (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(v4 + 72) + 56LL))(v4 + 72, (unsigned int)v3);
      v10 = v3 - 1;
      if ( v6 >= 6 )
        v10 = 0LL;
      --*(_DWORD *)(v4 + 4 * v10 + 256);
