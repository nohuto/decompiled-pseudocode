/*
 * XREFs of ?ValidateNodes@CExpression@@AEAAJIPEBEPEAI@Z @ 0x1802A521C
 * Callers:
 ...
 *     ??$emplace_back@II@?$vector_facade@UNodesDataBookmark@CExpression@@V?$buffer_impl@UNodesDataBookmark@CExpression@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXII@Z @ 0x1802A41AC (--$emplace_back@II@-$vector_facade@UNodesDataBookmark@CExpression@@V-$buffer_impl@UNodesDataBook.c)
 ...
 *     ?clear_region@?$vector_facade@UNodesDataBookmark@CExpression@@V?$buffer_impl@UNodesDataBookmark@CExpression@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1802A56E4 (-clear_region@-$vector_facade@UNodesDataBookmark@CExpression@@V-$buffer_impl@UNodesDataBookmark@.c)
 */
