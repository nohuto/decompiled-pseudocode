/*
 * XREFs of ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x18003E2B8
 * Callers:
...
char __fastcall CInteractionTracker::SendValuesChangedCallbackIfNecessary(__int64 a1, __int64 *a2, float a3)
{
  ...
  if ( !v13 && *(float *)(a1 + 524) == a3 )
    return 0;
LABEL_14:
  if ( (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*(_QWORD *)(a1 + 24) + 6416LL) + 72LL))(
         ...
         8LL) )
  {
    ...
    CoreUICallSend(v10, v17, 2LL, 8LL, 0, &unk_180336E64, (unsigned int)&v15, a3, v14);
  }
  v11 = *((_DWORD *)a2 + 2);
  *(_QWORD *)(a1 + 512) = *a2;
  *(_DWORD *)(a1 + 520) = v11;
