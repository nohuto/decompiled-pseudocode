/*
 * XREFs of ?DoesContain@?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@QEBA_NAEBV1@@Z @ 0x180186A8C
 * Callers:
        ...
        unsigned int *a2)
{
  ...
  v2 = a2[2];
  return v2 <= *a2 || a2[3] <= a2[1] || *a2 >= *a1 && a2[1] >= a1[1] && v2 <= a1[2] && a2[3] <= a1[3];
}
