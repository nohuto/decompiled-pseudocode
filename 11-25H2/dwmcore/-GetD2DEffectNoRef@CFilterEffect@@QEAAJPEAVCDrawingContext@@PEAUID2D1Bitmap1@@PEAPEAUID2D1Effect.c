/*
 * XREFs of ?GetD2DEffectNoRef@CFilterEffect@@QEAAJPEAVCDrawingContext@@PEAUID2D1Bitmap1@@PEAPEAUID2D1Effect@@@Z @ 0x180224EEC
 * Callers:
...
LABEL_28:
  ...
  if ( (_DWORD)v14 )
  {
    ...
    for ( i = 0LL; i < v14; ++i )
    {
      ...
      if ( v17 )
      {
        v19 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v17 + 64LL))(v17, 60LL);
        ...
        {
          if ( !(*(unsigned __int8 (__fastcall **)(CFilterEffect *, __int64))(*(_QWORD *)v20 + 64LL))(v20, 41LL) )
          {
            v10 = -2147467263;
            v23 = 82;
            goto LABEL_3;
