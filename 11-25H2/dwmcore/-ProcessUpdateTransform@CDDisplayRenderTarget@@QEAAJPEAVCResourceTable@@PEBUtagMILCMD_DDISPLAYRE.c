/*
 * XREFs of ?ProcessUpdateTransform@CDDisplayRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_DDISPLAYRENDERTARGET_UPDATETRANSFORM@@@Z @ 0x18028A4B8
 * Callers:
        ...
        const struct tagMILCMD_DDISPLAYRENDERTARGET_UPDATETRANSFORM *a3)
{
  ...
  if ( v13 )
    CDDARenderTarget::UpdateTransform(v13, (CDDisplayRenderTarget *)((char *)this + 30896), v10, v11);
  v14 = *((_QWORD *)this + 25);
  if ( v14 )
  {
    memset_0(v18, 0, 0xC8uLL);
    if ( (*(int (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v14 + 32LL))(v14, v18) >= 0 )
      *((_BYTE *)this + 33905) = (v18[108] & 8) != 0;
  }
  result = 0LL;
