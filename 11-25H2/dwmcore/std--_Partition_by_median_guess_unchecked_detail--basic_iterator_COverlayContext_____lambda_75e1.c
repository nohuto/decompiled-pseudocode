/*
 * XREFs of std::_Partition_by_median_guess_unchecked_detail::basic_iterator_COverlayContext_____lambda_75e1476dc5068012ea3e1cac136e32a1___ @ 0x180273548
 * Callers:
...
_QWORD *__fastcall std::_Partition_by_median_guess_unchecked_detail::basic_iterator_COverlayContext_____lambda_75e1476dc5068012ea3e1cac136e32a1___(
        _QWORD *a1,
        __int64 *a2,
        _QWORD *a3)
{
  ...
  v55 = v6;
  v54 = v3 - 8;
  std::_Guess_median_unchecked_detail::basic_iterator_COverlayContext_____lambda_75e1476dc5068012ea3e1cac136e32a1___(
    v56,
    (__int64 *)&v55,
    &v54);
  v8 = v6 + 1;
