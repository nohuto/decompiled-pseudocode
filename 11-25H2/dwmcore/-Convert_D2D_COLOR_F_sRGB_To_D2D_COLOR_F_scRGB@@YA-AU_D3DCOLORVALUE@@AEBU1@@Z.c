/*
 * XREFs of ?Convert_D2D_COLOR_F_sRGB_To_D2D_COLOR_F_scRGB@@YA?AU_D3DCOLORVALUE@@AEBU1@@Z @ 0x1802BE34C
 * Callers:
...
struct _D3DCOLORVALUE *__fastcall Convert_D2D_COLOR_F_sRGB_To_D2D_COLOR_F_scRGB(
