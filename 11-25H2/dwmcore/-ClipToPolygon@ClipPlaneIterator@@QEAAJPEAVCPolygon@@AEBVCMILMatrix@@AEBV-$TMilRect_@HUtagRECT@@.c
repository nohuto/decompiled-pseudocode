/*
 * XREFs of ?ClipToPolygon@ClipPlaneIterator@@QEAAJPEAVCPolygon@@AEBVCMILMatrix@@AEBV?$TMilRect_@HUtagRECT@@UD2D_POINTANDSIZE_L@@U_CMILSurfaceRect_@RectUniqueness@@UNotNeeded@4@@@@Z @ 0x180201220
 * Callers:
 ...
 *     ?ResetToStart@ClipPlaneIterator@@AEAAXXZ @ 0x18020149C (-ResetToStart@ClipPlaneIterator@@AEAAXXZ.c)
        ...
        _DWORD *a4)
{
  ...
  struct _D3DMATRIX v31; // [rsp+50h] [rbp-88h] BYREF
  ...
  if ( v10 )
  {
    ...
    {
      v28 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x27Au, 0LL);
    }
    operator delete(v10);
    if ( v11 )
      operator delete(v11);
  ...
  {
    v28 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x277u, 0LL);
  }
  return v28;
}
