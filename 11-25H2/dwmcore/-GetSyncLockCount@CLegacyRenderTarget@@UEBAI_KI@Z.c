/*
 * XREFs of ?GetSyncLockCount@CLegacyRenderTarget@@UEBAI_KI@Z @ 0x1801E1040
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( v7 || *((_DWORD *)this + 8348) != 1 )
  {
    OutstandingPresents = CTargetStats::GetOutstandingPresents((CLegacyRenderTarget *)((char *)this + 33352), a2);
    if ( a3 > OutstandingPresents
      && (v7 || (unsigned __int8)CTreeDirty::DoesIntersect(*((_QWORD *)this + 3) + 112LL, (char *)this + 30736)) )
    {
