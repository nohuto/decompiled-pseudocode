/*
 * XREFs of ??0CCustomKernelEffect@@AEAA@W4D3DShaderProfileVersion@@W4Enum@ExtendMode@@AEBV?$span@$$CBUKernelTap@@$0?0@gsl@@@Z @ 0x18006F750
 * Callers:
  ...
  *(_BYTE *)(a1 + 244) = a3;
  ...
  if ( (unsigned __int64)((v4[1] - *v4) >> 4) <= 8 )
  {
    ...
    *(_QWORD *)(a1 + 192) = (-(__int64)(v12 < 2u) & 0xFFFFFFFFFFFF922FuLL) + 60969;
    ...
    v9 = a1 + 224;
    *(_QWORD *)(a1 + 200) = v13;
    *(_OWORD *)(a1 + 224) = xmmword_18032E220;
    v14 = *(_QWORD *)(a1 + 32) - v8;
    *(_BYTE *)(a1 + 241) = 0;
