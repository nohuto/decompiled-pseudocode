/*
 * XREFs of ??$UnmarshalResourceArray@VCGeometry2D@@@CResource@@SAJPEBXIIW4MIL_RESOURCE_TYPE@@PEAIPEAPEAPEAVCGeometry2D@@PEAVCResourceTable@@_N@Z @ 0x180221220
 * Callers:
        ...
        __int64 a7)
{
  ...
  v8 = 0LL;
  result = CResource::UnmarshalResourceArray(a1, a2, a3, 0x43u, a5, &v8, a7, 1);
  *a6 = v8;
  return result;
}
