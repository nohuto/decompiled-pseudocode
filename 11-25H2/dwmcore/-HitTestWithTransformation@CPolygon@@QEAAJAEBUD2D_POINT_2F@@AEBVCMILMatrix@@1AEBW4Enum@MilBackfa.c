/*
 * XREFs of ?HitTestWithTransformation@CPolygon@@QEAAJAEBUD2D_POINT_2F@@AEBVCMILMatrix@@1AEBW4Enum@MilBackfaceVisibility@@PEA_N@Z @ 0x1801F3018
 * Callers:
 ...
 *     ?XMMatrixInverse@DirectX@@YQ?AUXMMATRIX@1@PEAT__m128@@U21@@Z @ 0x1801F32A4 (-XMMatrixInverse@DirectX@@YQ-AUXMMATRIX@1@PEAT__m128@@U21@@Z.c)
 *     ?IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z @ 0x1801F3590 (-IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z.c)
      ...
      if ( IsPointInPolygon )
      {
        ...
        if ( v22 )
        {
          if ( *(char *)(v21 + 105) >= 0 )
          {
            v28.m128_u64[0] = 0LL;
            v28.m128_i8[8] = 0;
            ShapeData = CGeometry::GetShapeData(v22, (const struct D2D_SIZE_F *)(v21 + 144), (struct CShapePtr *)&v28);
            v8 = ShapeData;
            if ( ShapeData < 0 )
            {
