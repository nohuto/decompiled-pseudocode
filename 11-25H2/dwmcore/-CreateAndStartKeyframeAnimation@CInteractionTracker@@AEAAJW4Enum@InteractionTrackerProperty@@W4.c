/*
 * XREFs of ?CreateAndStartKeyframeAnimation@CInteractionTracker@@AEAAJW4Enum@InteractionTrackerProperty@@W4DCOMPOSITION_EXPRESSION_TYPE@@AEBUD2DVector4@@MPEAPEAVCScrollKeyframeAnimation@@@Z @ 0x180237A34
 * Callers:
        ...
        __int64 *a6)
{
  ...
  else
  {
    ...
    if ( v10 )
    {
      CScrollKeyframeAnimation::CScrollKeyframeAnimation(v10, a1[3], (struct CInteractionTracker *)a1);
  ...
  if ( v20[0] )
  {
    ...
    if ( v16 >= 0 )
    {
      v18 = CInteractionTracker::RegisterIndirectTargetsForBoundTrackers((__int64)a1, v13, a2);
      v19 = v18;
      if ( v18 >= 0 )
      {
        *a6 = v13;
