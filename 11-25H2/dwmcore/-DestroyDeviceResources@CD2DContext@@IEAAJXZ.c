/*
 * XREFs of ?DestroyDeviceResources@CD2DContext@@IEAAJXZ @ 0x1801D8AC4
 * Callers:
...
__int64 __fastcall CD2DContext::DestroyDeviceResources(CD2DContext *this)
{
  ...
  *((_DWORD *)this + 76) = 0;
  CDrawListBatchManager::DestroyDeviceResources((CDrawListEntryBatch::CSharedDirect3DResources **)this + 1);
  return 0LL;
}
