/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x180226980
 * Callers:
        ...
        __int64 a5)
{
  ...
  v7 = a5;
  v8 = 8;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180404D18, a2, 0LL, 0LL, 3u, &v6);
}
