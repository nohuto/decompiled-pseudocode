/*
 * XREFs of ?ProcessSetPropertyValue@CPropertySet@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBXI@Z @ 0x1801A29B8
 * Callers:
...
LABEL_19:
    ...
    case 0x47:
      ...
      updated = CPropertySet::AddOrUpdateProperty<D2DQuaternion>(this, (__int64)a3, a4);
      v6 = updated;
      if ( updated >= 0 )
        return 0;
      v9 = 120;
