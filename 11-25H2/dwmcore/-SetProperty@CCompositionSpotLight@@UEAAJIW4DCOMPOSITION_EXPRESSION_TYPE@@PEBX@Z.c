/*
 * XREFs of ?SetProperty@CCompositionSpotLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180204770
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  v5 = 0LL;
  for ( i = (void **)&CCompositionSpotLight::k_rgAnimDef;
        i != &CGeometry2DGroup::`vftable'{for `CGeometry2DGroupGeneratedT<CGeometry2DGroup,CGeometry2D>'};
        ++i )
  {
