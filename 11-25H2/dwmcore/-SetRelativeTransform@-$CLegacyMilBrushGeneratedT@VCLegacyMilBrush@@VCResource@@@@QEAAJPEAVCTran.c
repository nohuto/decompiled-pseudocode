/*
 * XREFs of ?SetRelativeTransform@?$CLegacyMilBrushGeneratedT@VCLegacyMilBrush@@VCResource@@@@QEAAJPEAVCTransform@@@Z @ 0x180213E50
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[12] )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x660u, 0LL);
    }
    else
    {
