/*
 * XREFs of McTemplateU0qqpq_EventWriteTransfer @ 0x1801FC490
 * Callers:
...
ULONG __fastcall McTemplateU0qqpq_EventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
