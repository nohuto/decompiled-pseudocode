/*
 * XREFs of ?FillContainsRect@CRoundedRectangleGeometryData@@QEBA_NAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x18008A030
 * Callers:
...
char __fastcall CRoundedRectangleGeometryData::FillContainsRect(__int64 a1, struct D2D_RECT_F *a2, __int64 a3)
{
  float v6; // xmm14_4
  float v7; // xmm15_4
  float v8; // xmm13_4
  ...
  struct D2D_RECT_F v79; // [rsp+30h] [rbp-D0h] BYREF
...
LABEL_2:
  ...
  if ( a3 )
  {
    ...
    if ( (unsigned __int8)CMILMatrix::IsTranslateAndScaleIgnoreZ<1>(a3) )
    {
      ...
      v67 = v66 * a2->bottom;
      top = (float)(v66 * a2->top) + *(float *)(a3 + 52);
      LODWORD(v79.left) = v15.m128_i32[0];
      v68 = v15.m128_f32[0];
      bottom = v67 + *(float *)(a3 + 52);
      v69 = right;
      v79.right = right;
      v75 = right;
      v79.top = top;
    ...
    else
    {
      ...
      v69 = 0.0;
      top = v79.top;
      v15.m128_i32[0] = LODWORD(v79.left);
    }
  ...
  else
  {
    v10 = *a2;
    v79 = *a2;
    if ( v79.left <= -3.4028235e38 )
      v11 = FLOAT_N3_4028235e38;
    else
      v11 = v10.left + -0.015625;
    if ( v79.top <= -3.4028235e38 )
      v12 = FLOAT_N3_4028235e38;
    else
      v12 = v79.top + -0.015625;
    if ( v79.right >= 3.4028235e38 )
      v13 = FLOAT_3_4028235e38;
    else
      v13 = v79.right + 0.015625;
    if ( v79.bottom >= 3.4028235e38 )
      v14 = FLOAT_3_4028235e38;
    else
      v14 = v79.bottom + 0.015625;
...
LABEL_20:
  ...
  if ( *(_BYTE *)(a1 + 52) )
  {
    ...
    *(_QWORD *)&v79.left = v27.m128_u64[0];
    v25 = v27.m128_f32[0];
    v28 = *(float *)&v84;
  ...
  *(FLOAT *)&v84 = v31;
  ...
  if ( (v36 || v21 < v37 || v39 < v22 || v38 < v22)
    && (v20 < *(float *)&v84 || v20 < v79.left || v76 < v19 || v33 < v19) )
  {
    v87 = v28;
    v40 = a2->top;
    ...
    *(float *)&v85 = v78;
    ...
    v83 = v43;
    if ( a3 )
      CMILMatrix::Transform((CMILMatrix *)a3, (const struct D2D_POINT_2F *)&v79, (struct D2D_POINT_2F *)&v79, 4u);
    for ( i = 0LL; (unsigned int)i < 4; i = (unsigned int)(i + 1) )
    {
      ...
      if ( *v45 > 0.0 && v45[1] > 0.0 )
      {
        if ( a3 )
        {
          ...
          {
            v47 = (float)(*(&v79.left + 2 * j) - *(&v90.x + 2 * i)) / *((float *)&v84 + 2 * i);
            if ( v47 > 0.0 )
            {
              v48 = (float)(*(&v79.top + 2 * j) - *(&v90.y + 2 * i)) / *((float *)&v84 + 2 * i + 1);
        ...
        {
          v56 = (float)(*(&v79.left + 2 * i) - *(&v90.x + 2 * i)) / *((float *)&v84 + 2 * i);
          if ( v56 > 0.0 )
          {
            v57 = (float)(*(&v79.top + 2 * i) - *(&v90.y + 2 * i)) / *((float *)&v84 + 2 * i + 1);
