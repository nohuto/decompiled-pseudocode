/*
 * XREFs of ?ProcessSetStretch@CViewBox@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VIEWBOX_SETSTRETCH@@@Z @ 0x1802B1F58
 * Callers:
        ...
        const struct tagMILCMD_VIEWBOX_SETSTRETCH *a3)
{
  ...
  {
    *((_DWORD *)this + 62) = v3;
    CResource::NotifyOnChanged(this, 2u, (__int64)this);
  }
  return 0LL;
}
