/*
 * XREFs of ?GetLightInfo@CCompositionSpotLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x18011D1E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TransformAttenuation@CCompositionLight@@IEBAXAEBUfloat3@Numerics@Foundation@Windows@@AEBUfloat2@345@PEAULightInfo@@@Z @ 0x18011E098 (-TransformAttenuation@CCompositionLight@@IEBAXAEBUfloat3@Numerics@Foundation@Windows@@AEBUfloat2.c)
 *     cosf_0 @ 0x1802E8878 (cosf_0.c)
 */
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 3;
  ...
  if ( v12 >= 0 )
  {
    *((_OWORD *)a4 + 5) = *(_OWORD *)CCompositionLight::CalcEyePointOrVector(v13, v21, *((_QWORD *)this + 38));
    ...
    *((_DWORD *)a4 + 14) = *((_DWORD *)this + 94);
    ...
    if ( v17 < 0.0 )
      ...
      v19 = fminf(1.5707964, v17);
    *((float *)a4 + 18) = cosf_0(v19);
    v20 = *((float *)this + 96);
    if ( v20 >= 0.0 )
      v18 = fminf(1.5707964, v20);
    *((float *)a4 + 19) = cosf_0(v18);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x64u, 0LL);
  }
  return v14;
}
