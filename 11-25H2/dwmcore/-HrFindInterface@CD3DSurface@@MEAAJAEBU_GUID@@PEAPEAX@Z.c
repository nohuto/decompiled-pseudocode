/*
 * XREFs of ?HrFindInterface@CD3DSurface@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802D1CD0
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802C15B0 (-HrFindInterface@CD3DResource@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
