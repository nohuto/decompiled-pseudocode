/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x1801B0AF0
 * Callers:
...
__int64 __fastcall CD3DDevice::GenerateShaders(CD3DDevice *this)
{
  ...
  while ( (unsigned int)v4 < 0x10 )
  {
    ...
    {
      v7 = *((__m128i *)&unk_18030D890 + v6);
      v8 = *((_QWORD *)&unk_18030D890 + 2 * v6);
      if ( v8 )
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x221u, 0LL);
          if ( v69 )
...
LABEL_60:
  ...
  while ( v17 < 4 )
  {
    ...
    {
      v23 = *((__m128i *)&unk_18030D890 + (unsigned int)v22);
      v24 = *((_QWORD *)&unk_18030D890 + 2 * (unsigned int)v22);
      if ( v24 )
      {
        v25 = (__int64 *)*((_QWORD *)this + 69);
        v26 = *((__m128i *)&unk_18030DD70 + (int)v18);
        v27 = *v25;
  ...
  while ( v32 < 0x18 )
  {
    ...
    *((_QWORD *)v38 + 197) = 0LL;
    ...
    CommonRenderingShaderInternalNoRef = v37(v36, &byte_180339040[264 * (int)v34], v38 + 1576, v16);
    v3 = CommonRenderingShaderInternalNoRef;
    if ( CommonRenderingShaderInternalNoRef < 0 )
    {
      v61 = 604;
  ...
  while ( !v41 )
  {
    ...
    *((_QWORD *)v47 + 269) = 0LL;
    ...
    CommonRenderingShaderInternalNoRef = v46(v45, &byte_18038F170[40 * (int)v43], v47 + 2152);
    v3 = CommonRenderingShaderInternalNoRef;
    if ( CommonRenderingShaderInternalNoRef < 0 )
    {
      v61 = 610;
  ...
  while ( v50 < 4 )
  {
    ...
    *((_QWORD *)v56 + 270) = 0LL;
    ...
    CommonRenderingShaderInternalNoRef = v55(v54, &byte_18033A940[52 * (int)v52], v56 + 2160, v16);
    v3 = CommonRenderingShaderInternalNoRef;
    if ( CommonRenderingShaderInternalNoRef < 0 )
    {
      v61 = 616;
  ...
  if ( v68 >= 37632 )
  {
    ...
    if ( (v3 & 0x80000000) != 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0x26Fu, 0LL);
  }
  return v3;
}
