/*
 * XREFs of ?GetD2DBitmap@CRenderTargetBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802E0970
 * Callers:
 *     ?GetD2DBitmap@CDecodeBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802E0E90 (-GetD2DBitmap@CDecodeBitmap@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z.c)
        ...
        char a4)
{
  ...
  *a3 = 0LL;
         ...
         && *((_BYTE *)g_pComposition + 6490) )
  {
    ...
    {
      LOBYTE(v16) = a4;
      v17 = (*(__int64 (__fastcall **)(__int64, const struct RenderTargetInfo *, struct ID2D1Bitmap1 **, __int64))(*(_QWORD *)v21 + 112LL))(
              v21,
              a2,
              a3,
              v16);
