/*
 * XREFs of ?ProcessSetClip@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETCLIP@@@Z @ 0x18012EF68
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETCLIP *a3)
{
  ...
  if ( !v3
    ...
    && ((v13 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v12 + 64LL), v13 == CKeyframeAnimation::IsOfType)
      ? (v8 = CKeyframeAnimation::IsOfType(v12, 66))
      : v13 != CVisual::IsOfType
      ? (v13 != CSharedSection::IsOfType
       ? (v8 = v13(v12, 66))
       : (v8 = CSharedSection::IsOfType(v12, 66)))
      : (v8 = CVisual::IsOfType(v12, 66)),
  ...
  {
    v7 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0xA64u, 0LL);
  }
  return v7;
}
