/*
 * XREFs of ?Lock@CSystemMemoryBitmap@@UEAAJPEBUWICRect@@W4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180187A60
 * Callers:
        ...
        struct IBitmapLock **a4)
{
  ...
  if ( (((_BYTE)v41 * PixelFormatSize) & 7) != 0 )
  {
    ...
    v9 = v35;
    if ( v35 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v35, 0x8Fu, 0LL);
    goto LABEL_34;
  }
  if ( (a3 & 2) == 0 )
  {
...
LABEL_33:
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x7Bu, 0LL);
      goto LABEL_34;
    }
    ...
    v36 = 423;
LABEL_43:
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, v36, 0LL);
    goto LABEL_33;
  }
