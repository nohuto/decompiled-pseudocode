/*
 * XREFs of ?InteractionContextCallback@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x180179090
 * Callers:
 *     ?s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x180229950 (-s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@.c)
 * Callees:
  ...
  if ( (_DWORD)v23 == 1 )
  {
    ...
    *((_BYTE *)this + 148) = 1;
    if ( (unsigned int)dword_180404D18 <= 4 )
      return;
    if ( (byte_180404D28 & 2) != 0 && (qword_180404D30 & 2) == qword_180404D30 )
    {
      v15 = *((_DWORD *)this + 11);
      v16 = HIDWORD(v27);
      v17 = v26;
