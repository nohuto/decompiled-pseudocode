/*
 * XREFs of ?Init@CD3DDevice@@AEAAJPEAUIDXGIAdapter@@PEAUID3D11Device1@@@Z @ 0x1801B1DA0
 * Callers:
...
__int64 __fastcall CD3DDevice::Init(CD3DDevice *this, struct IDXGIAdapter *a2, struct ID3D11Device1 *a3)
{
  ...
  else
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x1C2u, 0LL);
    }
    else
    {
      ...
      *((_QWORD *)this + 69) = 0LL;
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x1CEu, 0LL);
      }
      else
      {
        ...
        *((_QWORD *)this + 67) = 0LL;
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x1CFu, 0LL);
        }
        else
        {
          ...
          *((_QWORD *)this + 70) = 0LL;
          ...
          if ( v21 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x1D4u, 0LL);
          }
          else
          {
            ...
            if ( WarpExtension < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, WarpExtension, 0x1D6u, 0LL);
            }
            else
            {
              ...
              if ( v23 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0x1DCu, 0LL);
              }
              else
              {
                ...
                *((_BYTE *)this + 1497) = IsShaderLinkingBlacklistedGpu;
                ...
                if ( v26 >= 0 )
                {
                  ...
                  if ( Shaders < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, Shaders, 0x1E4u, 0LL);
                  }
                  else
                  {
                    ...
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, RenderingResources, 0x1E6u, 0LL);
                    }
                    else
                    {
                      ...
                      v8 = inited;
                      if ( inited < 0 )
                        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, inited, 0x1E8u, 0LL);
                    }
                  }
                }
                else
                {
                  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v26, 0x1E2u, 0LL);
                }
              }
            }
          }
