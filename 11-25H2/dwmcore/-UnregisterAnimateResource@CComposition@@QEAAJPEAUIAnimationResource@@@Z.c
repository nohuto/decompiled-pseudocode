/*
 * XREFs of ?UnregisterAnimateResource@CComposition@@QEAAJPEAUIAnimationResource@@@Z @ 0x180207CB8
 * Callers:
...
__int64 __fastcall CComposition::UnregisterAnimateResource(CComposition *this, struct IAnimationResource *a2)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x701u, 0LL);
  }
  return v3;
}
