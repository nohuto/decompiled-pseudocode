/*
 * XREFs of ?AddEdgeFlags@CEdgeFlagsMap@@QEAAXAEBUD2D_RECT_F@@W4D2D1_EDGE_FLAGS@@PEBVMatrix3x3@@M@Z @ 0x180196DBC
 * Callers:
 ...
 *     ?ClipRectAndEdgeFlags@@YA?AW4D2D1_EDGE_FLAGS@@AEBUD2D_RECT_F@@W41@01PEAU2@PEAW41@@Z @ 0x180197A90 (-ClipRectAndEdgeFlags@@YA-AW4D2D1_EDGE_FLAGS@@AEBUD2D_RECT_F@@W41@01PEAU2@PEAW41@@Z.c)
 ...
 *     ??$_Emplace_valueless@$0A@$$V@?$variant@Umonostate@std@@VCRectangleMapStrategy@CEdgeFlagsMap@@VCPolygonMapStrategy@4@@std@@AEAAAEAUmonostate@1@XZ @ 0x18025BB84 (--$_Emplace_valueless@$0A@$$V@-$variant@Umonostate@std@@VCRectangleMapStrategy@CEdgeFlagsMap@@VC.c)
