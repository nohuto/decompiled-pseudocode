/*
 * XREFs of ?AdjustContentWorldBounds@CVisual@@AEBA_NPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18012D730
 * Callers:
...
{
  char (__fastcall *v4)(CSpriteVisual *); // rax
  ...
  char result; // al
  float v14; // xmm0_4
  unsigned __int8 (__fastcall *v15)(__int64, __int64); // rax
  CMaskBrush *v16; // rcx
  ...
  if ( a2[2] <= *a2 || a2[3] <= a2[1] )
    return 0;
  v4 = *(char (__fastcall **)(CSpriteVisual *))(*(_QWORD *)this + 352LL);
  if ( (char *)v4 == (char *)CVisual::HasAntialiasedContent )
  {
  ...
  if ( v7 )
  {
    v15 = *(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v7 + 64LL);
    if ( (char *)v15 == (char *)CColorBrush::IsOfType )
    {
