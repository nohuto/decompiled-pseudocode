/*
 * XREFs of ?AddBoundsToDirtyRegion@CVisual@@UEAAJAEAVSubTreeContext@CPreComputeContext@@@Z @ 0x18009B700
 * Callers:
...
__int64 __fastcall CVisual::AddBoundsToDirtyRegion(CVisual *this, struct CPreComputeContext::SubTreeContext *a2)
{
  ...
  if ( IsEmpty(&v28) )
  {
    if ( TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsWellOrdered(&v28.left) )
      goto LABEL_33;
  ...
  {
    if ( TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsInfinite(&v28.left) )
    {
...
LABEL_34:
  if ( (v25 & 0x80000000) != 0 )
  {
    ...
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0xC9,
      (unsigned int)"onecoreuap\\windows\\DWM\\dwmcore\\resources\\Visual.h",
      (const char *)v25,
      SLODWORD(v28.left));
    return v25;
  }
