/*
 * XREFs of ?TransitionToIdle@CInteractionTracker@@AEAAXXZ @ 0x18003DCF4
 * Callers:
...
void __fastcall CInteractionTracker::TransitionToIdle(CInteractionTracker *this)
{
  ...
  {
    v3 = CInteractionTracker::CalculateInertiaCallbackValues(this, v4);
  ...
  CInteractionTracker::SetState(this, 0LL, 0LL);
}
