/*
 * XREFs of ?CreateFence@CD3DDevice@@QEAAJAEBVCResourceTag@@_KPEAPEAUID3D11Fence@@@Z @ 0x1800C24D8
 * Callers:
        ...
        struct ID3D11Fence **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x773u, 0LL);
    v11 = v14;
  }
  if ( v11 )
