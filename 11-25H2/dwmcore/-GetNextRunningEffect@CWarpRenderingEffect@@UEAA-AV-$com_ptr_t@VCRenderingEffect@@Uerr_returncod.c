/*
 * XREFs of ?GetNextRunningEffect@CWarpRenderingEffect@@UEAA?AV?$com_ptr_t@VCRenderingEffect@@Uerr_returncode_policy@wil@@@wil@@PEAVCRenderingEffect@@PEA_N@Z @ 0x1801D6740
 * Callers:
 *     <none>
 * Callees:
