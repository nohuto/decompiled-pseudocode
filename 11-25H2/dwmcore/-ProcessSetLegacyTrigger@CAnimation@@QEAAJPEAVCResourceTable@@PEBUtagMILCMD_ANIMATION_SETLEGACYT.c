/*
 * XREFs of ?ProcessSetLegacyTrigger@CAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATION_SETLEGACYTRIGGER@@@Z @ 0x18029EA3C
 * Callers:
        ...
        const struct tagMILCMD_ANIMATION_SETLEGACYTRIGGER *a3)
{
  ...
  Resource = CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 2), 0x5Du);
