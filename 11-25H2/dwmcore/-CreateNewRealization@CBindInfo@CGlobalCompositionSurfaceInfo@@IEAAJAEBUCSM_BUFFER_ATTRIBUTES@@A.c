/*
 * XREFs of ?CreateNewRealization@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@_NPEAPEAVISwapChainRealization@@@Z @ 0x180101BC0
 * Callers:
...
LABEL_19:
      v16 = SubResource;
LABEL_20:
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803374A8, 3u, v16, v19, 0LL);
