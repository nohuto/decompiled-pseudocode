/*
 * XREFs of ?SetProperty@CSurfaceBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1802B07E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSurfaceBrush::SetProperty(__int64 a1, int a2, int a3)
{
  ...
  v9[0] = 4LL;
  v9[1] = &CSurfaceBrush::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v7 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x9Cu, 0LL);
  }
  else
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0xA0u, 0LL);
  }
  return v7;
}
