/*
 * XREFs of ?PresentMPO@CConversionSwapChain@@UEAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBUDWM_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x1801714A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !v19 )
  {
    ...
    v14 = CLegacySwapChain::PresentDFlip(
            ...
            *(struct IOverlayPlaneResource **)((char *)this + v24 + 528),
            (DXGI_COLOR_SPACE_TYPE)*(_DWORD *)((char *)this + v24 + 612),
            a4,
            (__int64)a5,
            (__int64)&v32,
            (__int64)&v29);
...
LABEL_30:
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0x199u, 0LL);
  }
  else
  {
...
LABEL_18:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x19Eu, 0LL);
  }
  FastRegion::CRegion::FreeMemory((FastRegion::CRegion **)&v35);
LABEL_19:
  if ( (_QWORD)v27 )
