/*
 * XREFs of ?CalcInversedOffsetInputBoundsFromVisibleWorldOutputBounds@CLayerVisual@@AEAAXAEBVCMILMatrix@@AEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@1PEAV3@2@Z @ 0x180027EE4
 * Callers:
        ...
        struct D2D_RECT_F *a6)
{
  ...
  *(_QWORD *)v20 = v10;
  ...
  v22[0] = v11;
  v22[2] = *(_OWORD *)(a2 + 32);
  if ( CMILMatrix::Get2DBoundsUsing2DInverse((CMILMatrix *)v22, a3, &v21.left) )
  {
