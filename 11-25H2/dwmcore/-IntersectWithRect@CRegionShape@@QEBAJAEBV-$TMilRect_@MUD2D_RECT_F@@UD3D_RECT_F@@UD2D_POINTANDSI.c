/*
 * XREFs of ?IntersectWithRect@CRegionShape@@QEBAJAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@PEAPEAVCShape@@@Z @ 0x1801951D4
 * Callers:
...
__int64 __fastcall CRegionShape::IntersectWithRect(__int64 a1, float *a2, char *a3)
{
  ...
  *(_QWORD *)a3 = 0LL;
  v4 = CThreadLocalObjectCache<CRectanglesShape,CRectanglesShape>::Alloc();
  v5 = v4;
  if ( v4 )
  {
    v4[1] = 0LL;
