/*
 * XREFs of ?SetVBlankDuration@CDDisplaySwapChain@@UEAA_NI_K@Z @ 0x1802186A0
 * Callers:
 *     ?BoostFrameRate@CDDisplayRenderTarget@@UEAA_N_N@Z @ 0x180218640 (-BoostFrameRate@CDDisplayRenderTarget@@UEAA_N_N@Z.c)
 * Callees:
 *     ?SetVBlankDuration@RefreshRateInfo@@QEAA_NI_K@Z @ 0x180218738 (-SetVBlankDuration@RefreshRateInfo@@QEAA_NI_K@Z.c)
