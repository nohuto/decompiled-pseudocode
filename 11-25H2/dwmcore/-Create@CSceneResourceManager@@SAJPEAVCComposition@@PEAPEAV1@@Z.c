/*
 * XREFs of ?Create@CSceneResourceManager@@SAJPEAVCComposition@@PEAPEAV1@@Z @ 0x18022C864
 * Callers:
 ...
 *     ??0CSceneResourceManager@@AEAA@PEAVCComposition@@@Z @ 0x180256050 (--0CSceneResourceManager@@AEAA@PEAVCComposition@@@Z.c)
 */
