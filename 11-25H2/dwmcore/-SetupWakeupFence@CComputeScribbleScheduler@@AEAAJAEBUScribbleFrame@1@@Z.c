/*
 * XREFs of ?SetupWakeupFence@CComputeScribbleScheduler@@AEAAJAEBUScribbleFrame@1@@Z @ 0x180175150
 * Callers:
 ...
 *     ?RequiresNewWakeupFence@CComputeScribbleScheduler@@AEBA_NAEBUScribbleFrame@1@@Z @ 0x18025B408 (-RequiresNewWakeupFence@CComputeScribbleScheduler@@AEBA_NAEBUScribbleFrame@1@@Z.c)
 */
        ...
        const struct CComputeScribbleScheduler::ScribbleFrame *a2)
{
  ...
  if ( v5 >= 0 )
  {
    wil::com_ptr_t<IBitmapRealization,wil::err_returncode_policy>::operator=(
      (char *)this + (this[14] != 0LL ? 120LL : 112LL),
      &v8);
