/*
 * XREFs of ??$UnmarshalResourceArray@VCSceneNode@@@CResource@@SAJPEBXIIW4MIL_RESOURCE_TYPE@@PEAIPEAPEAPEAVCSceneNode@@PEAVCResourceTable@@_N@Z @ 0x18027E6B8
 * Callers:
        ...
        __int64 a7)
{
  ...
  v8 = 0LL;
  result = CResource::UnmarshalResourceArray(a1, a2, a3, 0x94u, a5, &v8, a7, 0);
  *a6 = v8;
  return result;
}
