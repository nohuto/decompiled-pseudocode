/*
 * XREFs of ??1CDDisplayManager@@QEAA@XZ @ 0x1801F5EF0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DDisplayManager__ @ 0x1802E8FC0 (_dynamic_atexit_destructor_for__g_DDisplayManager__.c)
 * Callees:
