/*
 * XREFs of ?ContainEffectInChainInputs@CFilterEffect@@QEAAJW4MIL_RESOURCE_TYPE@@@Z @ 0x18022E12C
 * Callers:
    ...
    else
    {
      ...
      if ( *(int *)(a1 + 152) > 0 )
      {
        ...
        do
        {
          ...
          if ( v9 )
          {
            if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v9 + 64LL))(v9, 60LL) )
            {
              v10 = *(_QWORD *)(v8 + 24);
              if ( v10 )
              {
