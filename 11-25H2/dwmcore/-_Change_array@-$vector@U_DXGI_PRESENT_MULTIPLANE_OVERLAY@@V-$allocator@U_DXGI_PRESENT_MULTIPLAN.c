/*
 * XREFs of ?_Change_array@?$vector@U_DXGI_PRESENT_MULTIPLANE_OVERLAY@@V?$allocator@U_DXGI_PRESENT_MULTIPLANE_OVERLAY@@@std@@@std@@AEAAXQEAU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@_K1@Z @ 0x1801E24BC
 * Callers:
