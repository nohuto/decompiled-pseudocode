/*
 * XREFs of PubSebRegisterRpc @ 0x180221740
 * Callers:
 ...
 * Callees:
 *     ?PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z @ 0x180221870 (-PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z.c)
 *     CSebiUnregisterPublisher @ 0x180221910 (CSebiUnregisterPublisher.c)
 *     ?Insert@ContextTable@@QEAAKPEAU_SEB_RPC_PUBLISH_DATA@@PEAX@Z @ 0x180221944 (-Insert@ContextTable@@QEAAKPEAU_SEB_RPC_PUBLISH_DATA@@PEAX@Z.c)
