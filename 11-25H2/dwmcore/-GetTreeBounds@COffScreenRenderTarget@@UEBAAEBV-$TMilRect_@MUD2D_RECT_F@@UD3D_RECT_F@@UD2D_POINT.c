/*
 * XREFs of ?GetTreeBounds@COffScreenRenderTarget@@UEBAAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@XZ @ 0x1800C3E80
 * Callers:
...
__int64 __fastcall COffScreenRenderTarget::GetTreeBounds(__int64 a1)
{
  return a1 + 196;
}
