/*
 * XREFs of __tailMerge_api_ms_win_security_lsalookup_l2_1_0_dll @ 0x18025DEA6
 * Callers:
 *     __imp_load_LookupPrivilegeValueW @ 0x18025DF25 (__imp_load_LookupPrivilegeValueW.c)
 * Callees:
