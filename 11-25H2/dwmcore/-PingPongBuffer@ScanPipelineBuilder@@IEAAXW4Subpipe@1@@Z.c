/*
 * XREFs of ?PingPongBuffer@ScanPipelineBuilder@@IEAAXW4Subpipe@1@@Z @ 0x1802E6D5C
 * Callers:
 ...
 * Callees:
 *     ?GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA?AW4BufferLocation@@XZ @ 0x1802E6D34 (-GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA-AW4BufferLocation@@XZ.c)
 */
