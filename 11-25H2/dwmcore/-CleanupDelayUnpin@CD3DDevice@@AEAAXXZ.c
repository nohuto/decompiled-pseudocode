/*
 * XREFs of ?CleanupDelayUnpin@CD3DDevice@@AEAAXXZ @ 0x1802C24D4
 * Callers:
...
void __fastcall CD3DDevice::CleanupDelayUnpin(CD3DDevice *this)
{
  ...
  if ( (_QWORD)v10 != *((_QWORD *)&v10 + 1) )
  {
    ...
    v7 = v6;
    if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 2) != 0 )
      McTemplateU0t_EventWriteTransfer((__int64)Microsoft_Windows_Dwm_Compositor_Context, (__int64)&UnPinning_Stop, v6);
    if ( v7 < 0 )
