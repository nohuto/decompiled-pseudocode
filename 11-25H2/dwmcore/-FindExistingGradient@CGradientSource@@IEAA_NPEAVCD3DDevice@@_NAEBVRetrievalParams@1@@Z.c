/*
 * XREFs of ?FindExistingGradient@CGradientSource@@IEAA_NPEAVCD3DDevice@@_NAEBVRetrievalParams@1@@Z @ 0x180013040
 * Callers:
        ...
        const struct CGradientSource::RetrievalParams *a4)
{
  ...
  if ( a3 )
  {
    ...
    {
      *(_QWORD *)(v15 + 32) = 0LL;
      wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset((char *)this + 16);
    }
