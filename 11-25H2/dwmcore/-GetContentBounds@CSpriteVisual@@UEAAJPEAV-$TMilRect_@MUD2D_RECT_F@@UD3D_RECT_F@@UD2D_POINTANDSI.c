/*
 * XREFs of ?GetContentBounds@CSpriteVisual@@UEAAJPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18007C4A0
 * Callers:
 ...
 * Callees:
 *     ?ShouldHitTest@CWindowNode@@MEBA_NXZ @ 0x18007C760 (-ShouldHitTest@CWindowNode@@MEBA_NXZ.c)
...
__int64 __fastcall CSpriteVisual::GetContentBounds(CSpriteVisual *this, struct D2D_RECT_F *a2, __int64 a3, __int64 a4)
{
  ...
  else if ( (**((_DWORD **)this + 29) & 0x20000) != 0 )
  {
    ...
    v4 = v23;
    if ( v23 >= 0 )
      TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::UnionUnsafe(a2, &v24);
    else
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0xC9u, 0LL);
  }
