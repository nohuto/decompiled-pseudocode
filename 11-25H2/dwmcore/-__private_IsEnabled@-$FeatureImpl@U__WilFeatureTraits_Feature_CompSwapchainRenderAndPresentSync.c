/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_CompSwapchainRenderAndPresentSync@@@details@wil@@QEAA_NXZ @ 0x18024B1A0
 * Callers:
 ...
 *     ?NotifyInvalidResource@CDDisplaySwapChain@@UEAAXPEBVIDeviceResource@@@Z @ 0x1802C8B40 (-NotifyInvalidResource@CDDisplaySwapChain@@UEAAXPEBVIDeviceResource@@@Z.c)
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CompSwapchainRenderAndPresentSync@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18024B434 (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_CompSwapchainRenderAndPr.c)
...
unsigned __int8 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_CompSwapchainRenderAndPresentSync>::__private_IsEnabled(
        volatile signed __int32 *a1)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v23 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_CompSwapchainRenderAndPresentSync>::GetCachedFeatureEnabledState(
                       a1,
                       &v24);
    LOWORD(v8) = v23;
  }
  ...
  if ( (v8 & 0x400) != 0 )
  {
    ...
    wil::details::WilApi_RecordFeatureUsage((wil::details *)0x337E4AF, v16, 0LL);
  }
  if ( !v15 )
  {
    ...
    {
      LOBYTE(v14) = 1;
      g_wil_details_realtimeFeatureUsageHook(53994671LL, v10, v14);
    }
    if ( g_wil_details_pfnFeatureLoggingHook )
    {
      ...
      if ( (char *)g_wil_details_pfnFeatureLoggingHook == (char *)wil::details::FeatureLoggingHook )
        ...
        g_wil_details_pfnFeatureLoggingHook(53994671LL, &v25, 0LL, v9, &v24, 0LL, 0, 1LL);
    }
  }
  return v9;
}
