/*
 * XREFs of ?EnsureTreeData@CVisual@@QEAAPEAVCTreeData@@PEBVCVisualTree@@@Z @ 0x1800B7830
 * Callers:
...
void ***__fastcall CVisual::EnsureTreeData(CVisual *this, void **a2)
{
  ...
  void ****v22; // rbx
  void **v23; // rax
  void (__fastcall *v24)(CVisualTreeData *__hidden, struct CVisualTree *, struct CVisual *); // rax
...
LABEL_30:
    ...
    v26 = (CTreeData *)HeapAlloc(ProcessHeap, 0, 0x180uLL);
    v6 = (void ***)v26;
    if ( !v26 )
  ...
  v24 = (void (__fastcall *)(CVisualTreeData *__hidden, struct CVisualTree *, struct CVisual *))v23[1];
