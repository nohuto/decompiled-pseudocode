/*
 * XREFs of ?_Change_array@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@AEAAXQEAUEffectInput@@_K1@Z @ 0x1801EE5E4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v6 )
  {
    detail::destruct_range<EffectInput>(v6);
