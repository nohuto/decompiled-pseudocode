/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DWMResourceUsageS0@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1801EDC00
 * Callers:
    ...
    if ( (i & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v7
        ...
        || (v14[1] = 0,
            v14[0] = 0,
            v15 = a1,
            !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_180405898, v14, 0x10uLL)) )
      {
