/*
 * XREFs of ?GetDirtyRegion@CMaskBrush@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z @ 0x1801911E0
 * Callers:
 *     <none>
 * Callees:
...
{
  CMaskBrush *v3; // rcx
  __int64 (__fastcall **v6)(CMaskBrush *, const struct _GUID *, void **); // rax
  __int64 (__fastcall *v7)(CMaskBrush *, const struct _GUID *, void **); // rax
  int Interface; // eax
  bool (__fastcall *v9)(CSurfaceBrush *__hidden, const struct D2D_SIZE_F *, struct CRectanglesShape *); // rax
  bool DirtyRegion; // al
  bool v11; // bl
  __int64 (__fastcall *v12)(CResource *); // rdx
  __int64 (__fastcall *v13)(CResource *); // rdx
  CResource *v15; // [rsp+30h] [rbp+8h] BYREF

  v3 = (CMaskBrush *)*((_QWORD *)this - 2);
  if ( !v3 )
    return 0;
  v6 = *(__int64 (__fastcall ***)(CMaskBrush *, const struct _GUID *, void **))v3;
  v15 = 0LL;
  v7 = *v6;
  if ( v7 == CMILCOMBaseWeakRefSource<CResourceDeleter>::InternalQueryInterface )
    ...
    Interface = v7(v3, &GUID_c155b649_2c5b_416a_b836_bbda56b2ec27, (void **)&v15);
  if ( Interface < 0 )
  {
    if ( v15 )
    {
      v13 = *(__int64 (__fastcall **)(CResource *))(*(_QWORD *)v15 + 16LL);
      ...
      {
        (*(void (__fastcall **)(CResource *))(*(_QWORD *)v15 + 16LL))(v15);
      }
    }
    return 0;
  }
  v9 = *(bool (__fastcall **)(CSurfaceBrush *__hidden, const struct D2D_SIZE_F *, struct CRectanglesShape *))(*(_QWORD *)v15 + 24LL);
  ...
  if ( v15 )
  {
    v12 = *(__int64 (__fastcall **)(CResource *))(*(_QWORD *)v15 + 16LL);
