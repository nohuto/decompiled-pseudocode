/*
 * XREFs of ??$Transform3DBoundsHelper@$0A@@CMILMatrix@@AEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@UD3D_RECT_F@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAV1@@Z @ 0x18009EB10
 * Callers:
 ...
 *     ?Transform3DBounds@CMILMatrix@@QEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@UD3D_RECT_F@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAV2@@Z @ 0x1801FE5BC (-Transform3DBounds@CMILMatrix@@QEBAXAEBV-$TMil3DRect@MV-$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD.c)
 ...
 *     ?Transform3DRectToPerspective@CMILMatrix@@QEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@UD3D_RECT_F@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@QEAUD2D_POINT_3F@@@Z @ 0x18009E29C (-Transform3DRectToPerspective@CMILMatrix@@QEBAXAEBV-$TMil3DRect@MV-$TMilRect_@MUD2D_RECT_F@@UD3D.c)
...
void __fastcall CMILMatrix::Transform3DBoundsHelper<0>(__int64 a1, float *a2, float *a3)
{
  __int64 v3; // r11
  char v5; // cl
  int v7; // xmm5_4
...
LABEL_36:
  ...
  {
    if ( !CMILMatrix::IsTranslateAndScaleIgnoreZ<1>(v3)
...
LABEL_11:
  if ( (unsigned __int8)CMILMatrix::IsTranslateAndScale<1>(v3) )
  {
  ...
  else if ( (unsigned __int8)CMILMatrix::IsPure2DUniformZ<1>(v9) )
  {
    v54 = 0LL;
    v53 = *(_OWORD *)a2;
    CMILMatrix::Transform2DBoundsHelper<0>(v17, &v53, &v54);
    v19 = *(float *)(v18 + 40);
  ...
  {
    CMILMatrix::Transform3DRectToPerspective(v17, a2, &v55);
    *a3 = 3.4028235e38;
    a3[1] = 3.4028235e38;
    a3[2] = -3.4028235e38;
    a3[3] = -3.4028235e38;
