/*
 * XREFs of _anonymous_namespace_::ScreenOnStudySessionStateTracker::WnfCallback @ 0x1802275D0
 * Callers:
 *     <none>
 * Callees:
...
{
  bool v5; // zf
  void (__fastcall *v8)(__int128 *); // rax
  __int128 *v9; // rcx
  ...
  {
    v8 = *(void (__fastcall **)(__int128 *))(a4 + 8);
    if ( *a5 )
    {
      v9 = (__int128 *)(a5 + 4);
    }
