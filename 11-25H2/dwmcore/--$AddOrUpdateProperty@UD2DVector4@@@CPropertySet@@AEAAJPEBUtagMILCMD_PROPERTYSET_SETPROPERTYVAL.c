/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector4@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector4@@@Z @ 0x1801A2230
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DVector4>(CPropertySet *a1, __int64 a2, _OWORD *a3)
{
  int updated; // eax
  unsigned int v7; // ebx
