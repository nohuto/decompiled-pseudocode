/*
 * XREFs of ?SetTexCoord0Data@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180284CA8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[16] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xE12u, 0LL);
    }
    else
    {
