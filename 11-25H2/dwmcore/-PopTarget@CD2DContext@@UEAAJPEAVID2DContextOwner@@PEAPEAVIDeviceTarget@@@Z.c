/*
 * XREFs of ?PopTarget@CD2DContext@@UEAAJPEAVID2DContextOwner@@PEAPEAVIDeviceTarget@@@Z @ 0x1800D8170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DContext::PopTarget(CD2DContext *this, struct ID2DContextOwner *a2, struct IDeviceTarget **a3)
{
  ...
  _BYTE *v14; // rcx
  bool (__fastcall *v15)(CDeviceTextureTarget *); // rax
  char v16; // al
  int v17; // eax
  int v18; // edi
  __int64 v19; // rsi
  ...
  *((_DWORD *)this + 88) = v9;
  ...
  else
  {
    if ( *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 32LL) - *(_QWORD *)(*((_QWORD *)g_pComposition + 77) + 24LL) == 8LL
      && ((v14 = *(_BYTE **)(v8 + 24),
           v15 = *(bool (__fastcall **)(CDeviceTextureTarget *))(*(_QWORD *)v14 + 128LL),
