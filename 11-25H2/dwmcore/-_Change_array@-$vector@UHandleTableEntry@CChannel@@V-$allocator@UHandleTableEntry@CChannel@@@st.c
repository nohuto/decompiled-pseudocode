/*
 * XREFs of ?_Change_array@?$vector@UHandleTableEntry@CChannel@@V?$allocator@UHandleTableEntry@CChannel@@@std@@@std@@AEAAXQEAUHandleTableEntry@CChannel@@_K1@Z @ 0x1801DD764
 * Callers:
