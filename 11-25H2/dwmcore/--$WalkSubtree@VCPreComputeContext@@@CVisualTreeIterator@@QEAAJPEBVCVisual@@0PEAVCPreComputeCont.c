/*
 * XREFs of ??$WalkSubtree@VCPreComputeContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@0PEAVCPreComputeContext@@W4WalkReason@@@Z @ 0x1800BA8B0
 * Callers:
...
LABEL_118:
          ...
          v83 = (CTreeData *)HeapAlloc(ProcessHeap, 0, 0x180uLL);
          if ( !v83 )
...
LABEL_16:
      ...
      while ( 2 )
      {
        ...
        if ( (v18[106] & 0x40) != 0 || v18 == v8 )
        {
          ...
          if ( v27 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x11Cu, 0LL);
            goto LABEL_123;
          }
          v26 = v107;
        }
...
LABEL_135:
  ...
  if ( !v92 )
  {
    v5 = v41;
LABEL_152:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v33, 0x11Eu, 0LL);
    goto LABEL_135;
  }
  v103 = *(void **)(a1 + 32);
  if ( v103 )
