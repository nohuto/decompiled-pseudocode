/*
 * XREFs of ?ComputeCachedHdrMetadata@CDDisplaySwapChain@@IEAAJW4DXGI_HDR_METADATA_TYPE@@PEBX@Z @ 0x1801FF4A4
 * Callers:
...
LABEL_6:
  ...
  *((_QWORD *)this + 74) = 0LL;
  ...
  v3 = HdrMetadata;
  if ( HdrMetadata < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, HdrMetadata, 0x33Fu, 0LL);
  return v3;
}
