/*
 * XREFs of ?SetD2DEffectProperties@CArithmeticCompositeEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1802B38A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Effect *a2)
{
  ...
  else
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x14u, 0LL);
  }
  return v5;
}
