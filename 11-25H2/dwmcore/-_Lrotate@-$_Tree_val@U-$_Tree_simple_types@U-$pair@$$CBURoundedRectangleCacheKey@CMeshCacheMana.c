 ...
 *     ?_Insert_node@?$_Tree_val@U?$_Tree_simple_types@PEAVCInteractionTracker@@@std@@@std@@QEAAPEAU?$_Tree_node@PEAVCInteractionTracker@@PEAX@2@U?$_Tree_id@PEAU?$_Tree_node@PEAVCInteractionTracker@@PEAX@std@@@2@QEAU32@@Z @ 0x1800F9554 (-_Insert_node@-$_Tree_val@U-$_Tree_simple_types@PEAVCInteractionTracker@@@std@@@std@@QEAAPEAU-$_.c)
