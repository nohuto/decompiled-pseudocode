/*
 * XREFs of ??2CHolographicExclusiveView@@CAPEAX_K@Z @ 0x18027FCC4
 * Callers:
...
LPVOID __fastcall CHolographicExclusiveView::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x1A8uLL);
  if ( !result )
