/*
 * XREFs of ?CalcImageTransform@CCompositionSurfaceBitmap@@QEBA_NAEBUD2D_SIZE_F@@PEAVCMILMatrix@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800A1E00
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  struct IBitmapRealization *(__fastcall *v10)(CGlobalCompositionSurfaceInfo *__hidden); // rax
  __int64 v11; // rax
  __int64 v12; // rbx
  ...
  if ( !v4 )
    goto LABEL_50;
  v10 = *(struct IBitmapRealization *(__fastcall **)(CGlobalCompositionSurfaceInfo *__hidden))(*(_QWORD *)v4 + 48LL);
