/*
 * XREFs of ?SetState@CHolographicComposition@@UEAAJJ@Z @ 0x1802DA290
 * Callers:
...
__int64 __fastcall CHolographicComposition::SetState(CHolographicComposition *this, int a2)
{
  ...
  {
    if ( (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 1) + 6416LL) + 72LL))(
           *(_QWORD *)(*((_QWORD *)this + 1) + 6416LL),
           6LL) )
    {
      ...
      v6 = CoreUICallSend(v5, v10, 2LL, 6LL, 0, &unk_180336E61, a2, v9, ChannelCallbackId);
      if ( v6 < 0 )
