/*
 * XREFs of ?AttachInput@CBrushDrawListGenerator@@QEAAXI$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@@Z @ 0x1800DEC4C
 * Callers:
...
__int64 __fastcall CBrushDrawListGenerator::AttachInput(__int64 a1, unsigned int a2, __int64 *a3)
{
  ...
  CSurfaceDrawListBrush *(__fastcall *v7)(CSurfaceDrawListBrush *, char); // rax
  __int64 result; // rax
  ...
  *(_QWORD *)(a1 + 8LL * a2 + 8) = v3;
  if ( v6 )
  {
    v7 = **(CSurfaceDrawListBrush *(__fastcall ***)(CSurfaceDrawListBrush *, char))v6;
    if ( v7 == CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
    {
      CMultiPrimitiveDrawListBrush::`vector deleting destructor'(v6, 1);
    }
