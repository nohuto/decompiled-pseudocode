/*
 * XREFs of ?ProduceRealization@CWindowBackgroundBitmapProducer@@UEBAJPEAVCDrawingContext@@PEAPEAVCCachedRealization@CCachedImageProducer@@@Z @ 0x180116CF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     gsl::final_action__lambda_7c326dd339b6b31d734cab6f1173b304___::_final_action__lambda_7c326dd339b6b31d734cab6f1173b304___ @ 0x18021AEE8 (gsl--final_action__lambda_7c326dd339b6b31d734cab6f1173b304___--_final_action__lambda_7c326dd339b.c)
        ...
        struct CCachedImageProducer::CCachedRealization **a3)
{
  ...
  v13 = CDrawingContext::ValidateBVIEffectInputForRender((__int64)a2, (struct IRenderTargetBitmap *)&v47, 0LL);
  if ( (v13 & 0x80000000) != 0 )
  {
    v36 = 432LL;
LABEL_31:
  ...
  EffectInput::operator=(v16, (__int64)EffectInput);
  if ( v4 )
    CDrawListBitmap::~CDrawListBitmap((CDrawListBitmap *)&v52);
  if ( v19 )
...
LABEL_15:
  ...
  *(_QWORD *)&v47 = "DWM Window Background Treatment";
  v24 = CDrawingContext::PushOffScreenRenderingLayer(
          (__int64)a2,
          (struct CResourceTag *)&v47,
          v49,
          *(_DWORD *)(v23 + 8),
          4,
          (CMILRefCountImpl **)&v46);
  v13 = v24;
  if ( v24 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
  ...
  *(_QWORD *)&v47 = a2;
  BYTE8(v47) = 1;
  v25 = CDrawingContext::PushTransformInternal((const void **)a2, 0LL, (__m128 *)&CMILMatrix::Identity, 0, 1);
  v13 = v25;
  if ( v25 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
  ...
  v26 = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext *, unsigned int *, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 9) + 72LL)
                                                                                            + 200LL))(
