/*
 * XREFs of ?AddToMagnifierList@CComposition@@QEAAJPEAVCVisual@@@Z @ 0x1802657E8
 * Callers:
...
__int64 __fastcall CComposition::AddToMagnifierList(CComposition *this, struct CVisual *a2)
{
  ...
  v2 = (CResource **)((char *)this + 6208);
  v4 = (CVisualGroup *)*((_QWORD *)this + 776);
  if ( v4 )
    goto LABEL_6;
...
LABEL_6:
    ...
    v7 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0xAF0u, 0LL);
  }
  else
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0xAEDu, 0LL);
  }
  return v7;
}
