/*
 * XREFs of ?DisableIndependentFlip@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJXZ @ 0x1801E89B0
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  {
    v3 = v4 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v4 | 0x10000000, 0x597u, 0LL);
  }
