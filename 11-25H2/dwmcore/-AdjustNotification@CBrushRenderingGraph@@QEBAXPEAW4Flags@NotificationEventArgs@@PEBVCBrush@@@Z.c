/*
 * XREFs of ?AdjustNotification@CBrushRenderingGraph@@QEBAXPEAW4Flags@NotificationEventArgs@@PEBVCBrush@@@Z @ 0x1801326D4
 * Callers:
 ...
 *     ?ContainsEffectSubgraph@CRenderingTechniqueFragment@@QEBA_NPEAUIEffectInstance@Composition@UI@Windows@@I@Z @ 0x1801328D0 (-ContainsEffectSubgraph@CRenderingTechniqueFragment@@QEBA_NPEAUIEffectInstance@Composition@UI@Wi.c)
