/*
 * XREFs of ?GetDXGIOutput@CDisplayManager@@QEAAJU_LUID@@0IPEAPEAUIDXGIOutputDWM@@@Z @ 0x18020A2E0
 * Callers:
        ...
        struct IDXGIAdapter1 *a5)
{
  ...
  *v5 = 0LL;
  ...
  if ( Adapter < 0 )
  {
    ...
    v13 = 109;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803363E8, 2u, v12, v13, 0LL);
