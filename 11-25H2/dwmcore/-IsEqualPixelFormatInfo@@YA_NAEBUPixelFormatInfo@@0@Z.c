/*
 * XREFs of ?IsEqualPixelFormatInfo@@YA_NAEBUPixelFormatInfo@@0@Z @ 0x180186B38
 * Callers:
...
bool __fastcall IsEqualPixelFormatInfo(const struct PixelFormatInfo *a1, enum DXGI_FORMAT *a2)
{
  ...
  v5 = 1;
  if ( *(_DWORD *)a1 == *a2
    || IsNoAlphaFormOf((enum DXGI_FORMAT)*(_DWORD *)a1, v2) && *((_DWORD *)v3 + 1) == 3
    || IsNoAlphaFormOf(v2, (enum DXGI_FORMAT)*(_DWORD *)v4) && *((_DWORD *)v4 + 1) == 3 )
  {
    v6 = v5;
  }
