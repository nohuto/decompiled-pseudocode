/*
 * XREFs of McTemplateU0xqxt_EventWriteTransfer @ 0x1802E185C
 * Callers:
 *     ?NotifyPinned@CDxHandleBitmapRealization@@UEAAXXZ @ 0x1802E12F0 (-NotifyPinned@CDxHandleBitmapRealization@@UEAAXXZ.c)
 *     ?NotifyPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ @ 0x1802E26B0 (-NotifyPinned@CDxHandleYUVBitmapRealization@@UEAAXXZ.c)
 * Callees:
