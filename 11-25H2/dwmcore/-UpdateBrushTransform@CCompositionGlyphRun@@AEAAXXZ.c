/*
 * XREFs of ?UpdateBrushTransform@CCompositionGlyphRun@@AEAAXXZ @ 0x1802A12E0
 * Callers:
...
void __fastcall CCompositionGlyphRun::UpdateBrushTransform(CCompositionGlyphRun *this)
{
  ...
  if ( v2 )
  {
    v3 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 64LL))(v2, 106LL);
    v4 = (_QWORD *)*((_QWORD *)this + 11);
    if ( v3 )
    {
      v5 = v4[14];
      if ( !v5 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 64LL))(v5, 167LL) )
        return;
      v6 = v4[14];
    }
    else
    {
      if ( !(*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*v4 + 64LL))(*((_QWORD *)this + 11), 167LL) )
        return;
      v6 = *((_QWORD *)this + 11);
    }
    if ( v6 )
