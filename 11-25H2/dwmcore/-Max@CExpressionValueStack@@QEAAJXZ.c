/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x18020C324
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  if ( v4 != 18 )
  {
    ...
    {
      case '#':
        v10 = fmaxf(*(float *)v2, *(float *)v3);
        v11 = fmaxf(*((float *)v2 + 1), *((float *)v3 + 1));
        *((_DWORD *)v2 + 18) = 35;
        *(float *)v2 = v10;
        *((float *)v2 + 1) = v11;
        goto LABEL_5;
      case '4':
        ...
        v8 = *(_QWORD *)v3;
        v9 = *((float *)v3 + 2);
        *(float *)&v8 = fmaxf(COERCE_FLOAT(*(_QWORD *)v2), *(float *)&v8);
        *((_DWORD *)v2 + 18) = 52;
        *(_DWORD *)v2 = v8;
        *((float *)v2 + 1) = fmaxf(*((float *)&v15 + 1), *((float *)&v8 + 1));
        *((float *)v2 + 2) = fmaxf(*((float *)v2 + 2), v9);
        goto LABEL_5;
      case 'E':
        ...
        *(_QWORD *)&v16 = __PAIR64__(
                            COERCE_UNSIGNED_INT(fmaxf(_mm_shuffle_ps(v13, v13, 85).m128_f32[0], _mm_shuffle_ps(
                                                                                                  v12,
                                                                                                  v12,
                                                                                                  85).m128_f32[0])),
                            COERCE_UNSIGNED_INT(fmaxf(v13.m128_f32[0], v12.m128_f32[0])));
