/*
 * XREFs of ?TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@IPEBX@Z @ 0x180138DE8
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v9 )
        {
          if ( v9 == 1 && (Microsoft_Windows_Dwm_CoreEnableBits & 0x4000) != 0 )
