/*
 * XREFs of ?SyncLegacyVisualCaptureRenderTargetCaptureBits@CChannel@@UEAAJIIMHHHH_KPEAW4DXGI_FORMAT@@PEAPEAX@Z @ 0x180220A90
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a11)
{
  ...
  CChannel::CheckHandle((__int64)this, a2, 97);
  CChannel::CheckHandle((__int64)this, a3, 182);
  v21[0] = 219;
  v23 = 0;
  v24 = 0;
  v21[4] = a5;
