/*
 * XREFs of ?GetCurrentVelocity@CInteractionTracker@@QEBAMW4ScrollAxis@@@Z @ 0x1800F286C
 * Callers:
...
float __fastcall CInteractionTracker::GetCurrentVelocity(CInteractionTracker *a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      v9 = *(_QWORD *)(v7 + 464);
      if ( v9 )
        return *(float *)(CScrollPositionKeyframeAnimation::GetPositionVelocity(v9, v11) + 4);
    }
  }
  else
  {
    ...
    v10 = *(_QWORD *)(v8 + 464);
    if ( v10 )
      return *(float *)CScrollPositionKeyframeAnimation::GetPositionVelocity(v10, v11);
  }
  return result;
}
