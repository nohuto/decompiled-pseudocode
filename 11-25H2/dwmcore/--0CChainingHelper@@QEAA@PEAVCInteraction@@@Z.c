/*
 * XREFs of ??0CChainingHelper@@QEAA@PEAVCInteraction@@@Z @ 0x1801B77C0
 * Callers:
 ...
 *     ??0RequestedConfigForAxis@CChainingHelper@@QEAA@XZ @ 0x18022BEE0 (--0RequestedConfigForAxis@CChainingHelper@@QEAA@XZ.c)
