/*
 * XREFs of ?PushColorSpaceLayer@CDrawingContext@@AEAAJPEBVCVisual@@W4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x180271910
 * Callers:
        ...
        enum DXGI_COLOR_SPACE_TYPE a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0xE66u, 0LL);
  }
  else
  {
    v9 = CColorSpaceLayer::Create(this[4], (const struct D2D_POINTANDSIZE_L *)v12, a3, &v13);
    v8 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0xE6Bu, 0LL);
      v4 = v13;
    }
    else
    {
      ...
      v8 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0xE71u, 0LL);
      else
        v4 = 0LL;
    }
  }
