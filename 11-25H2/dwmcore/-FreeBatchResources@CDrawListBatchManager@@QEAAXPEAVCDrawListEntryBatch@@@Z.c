/*
 * XREFs of ?FreeBatchResources@CDrawListBatchManager@@QEAAXPEAVCDrawListEntryBatch@@@Z @ 0x18000DDB0
 * Callers:
...
LABEL_3:
      *v5 = 0;
      ...
      {
        v20 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 40, 8LL, 1LL, &v23);
        if ( v20 < 0 )
        {
          v21 = 192;
LABEL_29:
