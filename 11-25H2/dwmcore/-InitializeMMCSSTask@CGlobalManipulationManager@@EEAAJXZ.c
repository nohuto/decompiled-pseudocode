/*
 * XREFs of ?InitializeMMCSSTask@CGlobalManipulationManager@@EEAAJXZ @ 0x1800FE190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGlobalManipulationManager::InitializeMMCSSTask(CGlobalManipulationManager *this)
{
  ...
  *v5 = 0;
  v10 = 1;
  v6 = CMmcssTask::Set((CGlobalManipulationManager *)((char *)this + 312), (const struct DWM_MMTASK *)v9, 0);
  v7 = v6;
  if ( v6 < 0 )
