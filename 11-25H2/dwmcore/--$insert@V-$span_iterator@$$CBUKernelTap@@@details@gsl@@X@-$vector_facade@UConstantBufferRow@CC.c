...
LABEL_5:
  ...
  v11 = a4->m128i_u64[1];
  v12 = a4->m128i_i64[0];
  v16 = a5[1].m128i_i64[0];
  for ( i = a4[1].m128i_u64[0]; ; i += 12LL )
  {
    if ( __PAIR128__(v11, v12) != *(_OWORD *)&v15 )
      goto LABEL_5;
    if ( i == v16 )
      break;
    if ( !v12 || !v11 || v12 > i || i >= v11 )
      goto LABEL_5;
    *a2 = *(_QWORD *)i;
    v13 = *(_DWORD *)(i + 8);
    a2[1] = v13;
