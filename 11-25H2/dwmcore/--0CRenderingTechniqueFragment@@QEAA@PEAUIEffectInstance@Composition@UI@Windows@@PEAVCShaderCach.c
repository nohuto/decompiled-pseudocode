/*
 * XREFs of ??0CRenderingTechniqueFragment@@QEAA@PEAUIEffectInstance@Composition@UI@Windows@@PEAVCShaderCache@@IW4Enum@CompiledEffectSubgraphFlags@234@_N@Z @ 0x180070CA4
 * Callers:
 ...
 * Callees:
 *     ?GetConstantBufferSize@CCustomKernelEffect@@UEBAII@Z @ 0x180070D80 (-GetConstantBufferSize@CCustomKernelEffect@@UEBAII@Z.c)
