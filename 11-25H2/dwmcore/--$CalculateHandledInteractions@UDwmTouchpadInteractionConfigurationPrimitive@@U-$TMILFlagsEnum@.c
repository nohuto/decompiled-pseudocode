        ...
        _OWORD *a10)
{
  ...
  struct D2DMatrix *v26[2]; // [rsp+40h] [rbp-C8h] BYREF
  __int128 *v27; // [rsp+50h] [rbp-B8h]
  _OWORD *v28; // [rsp+58h] [rbp-B0h]
  int v29[16]; // [rsp+68h] [rbp-A0h] BYREF
  ...
  *a10 = xmmword_1803D3A10;
  ...
  {
LABEL_6:
    if ( v31 == 1 && !*(_BYTE *)(a4 + 1) && !*(_BYTE *)a4 )
    {
      CInteractionProcessor::ConstructLocalToGlobalTransform((__int64 *)a1, v29, (__int64 *)(a4 + 8));
      CInteractionProcessor::ConvertGlobalMotionToLocalMotion(
        ...
        a8,
        v26[0]);
      *(_OWORD *)a7 = *(_OWORD *)CInteractionProcessor::ComputeHandledInteractionsFromLocal(
                                   a1,
                                   (__int64)&v30,
                                   (__int64)v26,
                                   (__int64)v28);
      if ( anonymous_namespace_::AxisContainsMotion((float *)a7) )
        *a6 = 2;
    }
    return v25;
  }
