/*
 * XREFs of ?Initialize@CManipulationManager@@IEAAJXZ @ 0x1801BC51C
 * Callers:
 ...
 *     ?ClearWaitHandles@CManipulationManager@@KAXXZ @ 0x180261B9C (-ClearWaitHandles@CManipulationManager@@KAXXZ.c)
 */
