/*
 * XREFs of ?OnPeerConnected@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJIIIPEAPEAX@Z @ 0x1801CF268
 * Callers:
        ...
        void **a5)
{
  ...
  *a5 = 0LL;
  ...
  v15 = Microsoft::BamoImpl::BaseBamoConnectionImpl::TrackError(this, -2018375668, 0);
  v16 = v15;
  if ( v15 < 0 )
