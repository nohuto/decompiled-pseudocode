/*
 * XREFs of ?UpdateFromVisualSurface@CCachedVisualImage@@IEAAJPEAVCVisualTree@@AEBUD2D_VECTOR_2F@@11W4Enum@MilStretch@@@Z @ 0x18016F3DC
 * Callers:
        ...
        int a6)
{
  ...
  __int64 v16; // rax
  float v17; // xmm6_4
  __int64 (__fastcall *v18)(_DWORD *, unsigned int, __int64); // rax
  __int64 v20; // rax
  int v21; // eax
  int v22; // eax
  ...
  {
    if ( v16 )
      (*(void (__fastcall **)(_DWORD *))(*(_QWORD *)a1 + 192LL))(a1);
    v20 = *(_QWORD *)a1;
    *((_WORD *)a1 + 1028) = 0;
    *((_QWORD *)a1 + 17) = v9;
    v21 = (*(__int64 (__fastcall **)(_DWORD *))(v20 + 184))(a1);
    v6 = v21;
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v21, 0x220u, 0LL);
      return v6;
    }
    v22 = (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)a1 + 224LL))(a1);
    v6 = v22;
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0x222u, 0LL);
      return v6;
    }
    v7 = 1;
  }
  ...
  v18 = *(__int64 (__fastcall **)(_DWORD *, unsigned int, __int64))(*(_QWORD *)a1 + 80LL);
