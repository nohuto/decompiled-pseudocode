/*
 * XREFs of ?EnsureCursorState@CCursorManager@@AEAAJ_KPEAPEAVCCursorState@@@Z @ 0x1802BA070
 * Callers:
 ...
 *     ??0CCursorState@@QEAA@XZ @ 0x1802BB2EC (--0CCursorState@@QEAA@XZ.c)
 */
        ...
        struct CCursorState **a3)
{
  ...
  if ( a2 )
  {
    std::_Tree<std::_Tmap_traits<unsigned __int64,CCursorState *,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,CCursorState *>>,0>>::_Find_lower_bound<unsigned __int64>(
      (__int64 *)&xmmword_180406AB8,
      v11,
      &v15);
    v6 = v12;
    if ( *(_BYTE *)(v12 + 25) || a2 < *(_QWORD *)(v12 + 32) )
      v6 = xmmword_180406AB8;
    if ( v6 == (_QWORD)xmmword_180406AB8 )
    {
