/*
 * XREFs of ?InsertWorker@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@@Z @ 0x180090AD0
 * Callers:
        ...
        const struct PrimitiveVertexAttributesDesc *a3)
{
  ...
  struct D2D_RECT_F v20; // [rsp+38h] [rbp-C8h] BYREF
...
LABEL_2:
  ...
  if ( !*((_BYTE *)this + 4489) )
    v14 = 0LL;
  v20 = *v10;
  if ( CCpuClip::FullyContains(v11, &v20, v14) )
  {
LABEL_8:
    v12 = 0;
    goto LABEL_9;
  ...
  {
LABEL_9:
    v13 = CDrawListEntryBuilder::InsertWARP((CDrawListEntryBuilder *)this, a2, a3, v12);
    v7 = v13;
    if ( v13 < 0 )
