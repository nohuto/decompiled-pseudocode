/*
 * XREFs of ?ResetBuffers@CLegacySwapChain@@MEAAJXZ @ 0x1801C6190
 * Callers:
...
__int64 __fastcall CLegacySwapChain::ResetBuffers(__int64 **this)
{
  ...
  *((_BYTE *)this + 277) = 0;
  ...
  {
    v2 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, -2003304307, 0x38Au, 0LL);
    return v2;
  }
  for ( i = 0; ; ++i )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v6, 0x376u, 0LL);
      goto LABEL_15;
    }
    if ( !i )
    {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, v10, 0x382u, 0LL);
...
LABEL_15:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_18031ECF8, 2u, BackBuffer, 0x37Bu, 0LL);
  if ( v17 )
    ((void (__fastcall *)(struct ID3D11Texture2D *))v17->lpVtbl->Release)(v17);
  return v2;
}
