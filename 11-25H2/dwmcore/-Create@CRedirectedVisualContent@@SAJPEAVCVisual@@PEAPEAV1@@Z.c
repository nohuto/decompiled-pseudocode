/*
 * XREFs of ?Create@CRedirectedVisualContent@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x1800C08D4
 * Callers:
 ...
 *     ??0CRedirectedVisualContent@@IEAA@PEAVCVisual@@@Z @ 0x1800C09A4 (--0CRedirectedVisualContent@@IEAA@PEAVCVisual@@@Z.c)
...
__int64 __fastcall CRedirectedVisualContent::Create(struct CVisual *a1, struct CRedirectedVisualContent **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v4 && (v5 = CRedirectedVisualContent::CRedirectedVisualContent(v4, a1), (v6 = v5) != 0LL) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x16u, 0LL);
