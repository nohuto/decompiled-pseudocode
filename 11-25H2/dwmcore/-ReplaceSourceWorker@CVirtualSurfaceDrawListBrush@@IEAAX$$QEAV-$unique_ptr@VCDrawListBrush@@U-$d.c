/*
 * XREFs of ?ReplaceSourceWorker@CVirtualSurfaceDrawListBrush@@IEAAX$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@PEAV23@@Z @ 0x1802E4D80
 * Callers:
 *     ?ReplaceSource@CNineGridDrawListBrush@@UEAAX$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@@Z @ 0x1802E4D70 (-ReplaceSource@CNineGridDrawListBrush@@UEAAX$$QEAV-$unique_ptr@VCDrawListBrush@@U-$default_delet.c)
 * Callees:
