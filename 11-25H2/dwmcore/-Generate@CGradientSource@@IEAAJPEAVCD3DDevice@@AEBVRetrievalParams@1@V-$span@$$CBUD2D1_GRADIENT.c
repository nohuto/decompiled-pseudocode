/*
 * XREFs of ?Generate@CGradientSource@@IEAAJPEAVCD3DDevice@@AEBVRetrievalParams@1@V?$span@$$CBUD2D1_GRADIENT_STOP@@$0?0@gsl@@_N33W4D2D1_EXTEND_MODE@@@Z @ 0x18019DCC8
 * Callers:
...
LABEL_12:
  ...
  v16 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, int, unsigned int, int, int, _DWORD, int, struct CD2DBrush *, int))(*(_QWORD *)qword_180406B08 + 40LL))(
          qword_180406B08,
          *((_QWORD *)v9 + 1),
          *v9,
          a7 ^ 1u,
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v16, 0xA4u, 0LL);
    operator delete(v32);
    goto LABEL_26;
  }
  ...
  *((_QWORD *)&v35 + 1) = v32;
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v19, 0xA7u, 0LL);
    goto LABEL_12;
  }
  wil::com_ptr_t<CCompositionEnvironmentLight,wil::err_returncode_policy>::operator=((__int64 *)(a1 + 16), (__int64)v18);
  **(_QWORD **)a3 = v18;
  operator delete(v15);
...
LABEL_9:
  ...
  if ( GradientStopCollection >= 0 )
  {
    ...
    if ( a7 )
    {
      ...
      if ( v24 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v24, 0xCAu, 0LL);
        goto LABEL_18;
      }
    }
    else
    {
      ...
      if ( v25 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v25, 0xD7u, 0LL);
LABEL_18:
        if ( v32 )
    ...
    if ( v29 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v29, 0xDCu, 0LL);
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, GradientStopCollection, 0xBEu, 0LL);
LABEL_26:
  if ( v33 )
