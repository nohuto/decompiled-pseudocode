/*
 * XREFs of ?Grow@?$CWatermarkStack@M$01$01$09@@AEAAJ_KIIPEAPEAX@Z @ 0x1801DC2F4
 * Callers:
...
__int64 __fastcall CWatermarkStack<float,2,2,10>::Grow(__int64 a1, void *a2, __int64 a3, __int64 a4, const void **a5)
{
