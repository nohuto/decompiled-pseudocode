/*
 * XREFs of ?UpdateMaskIntermediate@CProjectedShadowCaster@@QEAAJPEAVCDrawingContext@@@Z @ 0x18029BA48
 * Callers:
        ...
        struct CDrawingContext *a2)
{
  ...
  if ( !*(_QWORD *)(v5 + 80) )
  {
    ...
    if ( v8 )
    {
      ShapeData = CGeometry::GetShapeData(v8, (const struct D2D_SIZE_F *)(v7 + 144), (struct CShapePtr *)&v16);
      v4 = ShapeData;
      if ( ShapeData < 0 )
      {
        v15 = 381;
