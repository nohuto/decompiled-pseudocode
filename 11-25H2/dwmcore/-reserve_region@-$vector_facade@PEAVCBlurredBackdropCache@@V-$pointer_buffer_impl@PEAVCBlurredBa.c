/*
 * XREFs of ?reserve_region@?$vector_facade@PEAVCBlurredBackdropCache@@V?$pointer_buffer_impl@PEAVCBlurredBackdropCache@@@detail@@@detail@@IEAAPEAPEAVCBlurredBackdropCache@@_K0@Z @ 0x180040364
 * Callers:
        ...
        __int64 a2)
{
  ...
  detail::pointer_buffer_impl<CBlurredBackdropCache *>::ensure_extra_capacity(a1, 1LL);
...
LABEL_10:
  ...
  if ( (*(_DWORD *)a1 & 3) != 0 )
  {
    ...
    else if ( (unsigned __int64)(*(_DWORD *)a1 & 3) - 2 > 1 )
    {
