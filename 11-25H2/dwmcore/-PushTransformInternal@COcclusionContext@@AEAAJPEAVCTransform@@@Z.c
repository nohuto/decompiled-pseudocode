/*
 * XREFs of ?PushTransformInternal@COcclusionContext@@AEAAJPEAVCTransform@@@Z @ 0x18002682C
 * Callers:
...
__int64 __fastcall COcclusionContext::PushTransformInternal(COcclusionContext *this, struct CTransform *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x5FCu, 0LL);
  }
  else
  {
    v8 = 1;
    v6 = CWatermarkStack<enum COcclusionContext::StackStateType,64,2,10>::Push((char *)this + 1752, &v8);
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x5FDu, 0LL);
  }
  return v5;
}
