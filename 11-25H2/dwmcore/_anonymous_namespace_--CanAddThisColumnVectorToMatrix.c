/*
 * XREFs of _anonymous_namespace_::CanAddThisColumnVectorToMatrix @ 0x18017DFE8
 * Callers:
 ...
 * Callees:
 *     ?D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z @ 0x18017E23C (-D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z.c)
