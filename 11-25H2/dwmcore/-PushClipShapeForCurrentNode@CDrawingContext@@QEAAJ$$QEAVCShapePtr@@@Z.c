/*
 * XREFs of ?PushClipShapeForCurrentNode@CDrawingContext@@QEAAJ$$QEAVCShapePtr@@@Z @ 0x180271824
 * Callers:
 ...
 *     ??0NodeEffects@CDrawingContext@@QEAA@XZ @ 0x180195B70 (--0NodeEffects@CDrawingContext@@QEAA@XZ.c)
 */
...
__int64 __fastcall CDrawingContext::PushClipShapeForCurrentNode(struct CDrawingContext *a1, __int64 a2)
{
  ...
  *(_QWORD *)a2 = 0LL;
  *(_BYTE *)(a2 + 8) = 0;
  TopByReference = CMatrixStack::GetTopByReference((struct CDrawingContext *)((char *)a1 + 288));
  v20 = 0;
  ...
  v9 = CDrawingContext::PushLocalSpaceClipAndAlphaInternal(
         a1,
         0LL,
         (__int64)&v12,
         (bool (__fastcall *)(CRegionShape *__hidden, unsigned int *))&v20);
  v10 = v9;
  if ( v9 < 0 )
