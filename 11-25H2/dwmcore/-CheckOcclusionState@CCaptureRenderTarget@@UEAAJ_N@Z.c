/*
 * XREFs of ?CheckOcclusionState@CCaptureRenderTarget@@UEAAJ_N@Z @ 0x1800C3760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureRenderTarget::CheckOcclusionState(CCaptureRenderTarget *this)
{
  ...
  {
    if ( !*((_BYTE *)this + 3064) || (v4 = 1, *((_DWORD *)g_pComposition + 1621)) )
      v4 = 0;
    ...
    if ( !v4 )
    {
      ...
      if ( v6 )
      {
        if ( (*(int (__fastcall **)(__int64, char *))(*(_QWORD *)v6 + 24LL))(v6, &v8) >= 0
          ...
          && *((_QWORD *)this + 366)
          && *((_BYTE *)this + 2845)
          && CCaptureRenderTarget::EnsureResources((CCaptureRenderTarget *)((char *)this - 96), D3DDeviceNoRef) >= 0
