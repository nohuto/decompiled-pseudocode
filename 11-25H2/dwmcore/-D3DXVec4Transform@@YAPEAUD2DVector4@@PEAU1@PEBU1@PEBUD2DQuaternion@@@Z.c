/*
 * XREFs of ?D3DXVec4Transform@@YAPEAUD2DVector4@@PEAU1@PEBU1@PEBUD2DQuaternion@@@Z @ 0x1802BEEA8
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  *((_DWORD *)a1 + 3) = *((_DWORD *)a2 + 3);
  ...
  v20 = (float)((float)((float)((float)(1.0 - v16) - v12) * *(float *)a2)
              + (float)((float)((float)(v5 * v11) - v9) * *((float *)a2 + 1)))
  ...
  v25 = (float)(v21 * *((float *)a2 + 1)) + (float)((float)(v18 + v9) * *(float *)a2);
  *(float *)a1 = v20;
  *((float *)a1 + 2) = v23 + v24;
  *((float *)a1 + 1) = v25 + v22;
  return result;
