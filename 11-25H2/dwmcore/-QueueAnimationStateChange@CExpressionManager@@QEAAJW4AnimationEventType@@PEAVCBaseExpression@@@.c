/*
 * XREFs of ?QueueAnimationStateChange@CExpressionManager@@QEAAJW4AnimationEventType@@PEAVCBaseExpression@@@Z @ 0x18003AEA8
 * Callers:
...
LABEL_12:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x27Bu, 0LL);
    return v9;
  }
  if ( v7 <= *(_DWORD *)(a1 + 244) )
  {
...
LABEL_5:
  v8 = *(unsigned int (__fastcall **)(CMILRefCountImpl *__hidden))(*(_QWORD *)a3 + 8LL);
