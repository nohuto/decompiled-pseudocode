/*
 * XREFs of ?ComputeEffectiveAlpha@CProjectedShadowCaster@@AEBAMPEBVCVisualTree@@PEA_N@Z @ 0x18012E520
 * Callers:
...
float __fastcall CProjectedShadowCaster::ComputeEffectiveAlpha(CProjectedShadowCaster *this, CVisual **a2, bool *a3)
{
  ...
  *a3 = 0;
  ...
  if ( v13 || (*(unsigned __int8 (__fastcall **)(CVisual *, __int64))(*(_QWORD *)v3 + 64LL))(v3, 92LL) )
    v4 = 1;
  result = v12;
  *a3 = v4;
  return result;
