/*
 * XREFs of ?ProcessSetHeatMapMode@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETHEATMAPMODE@@@Z @ 0x180297184
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETHEATMAPMODE *a3)
{
  ...
  else if ( (*((_BYTE *)this + 105) & 8) != 0 )
  {
    --*(_DWORD *)(*((_QWORD *)this + 3) + 6408LL);
    *((_BYTE *)this + 105) &= ~8u;
  }
  v6 = *((_BYTE *)this + 105);
  if ( *((_DWORD *)a3 + 6) == 1 )
