/*
 * XREFs of ??$Transform2DBoundsHelper@$0A@@CMILMatrix@@AEBAXAEBUD2D_RECT_F@@AEAU1@@Z @ 0x1800A0250
 * Callers:
...
float __fastcall CMILMatrix::Transform2DBoundsHelper<0>(__int64 a1, const struct D2D_RECT_F *a2, float *a3)
{
  char v5; // dl
  float result; // xmm0_4
  int v7; // xmm2_4
  ...
  float v20; // xmm3_4
  char v21; // r8
  struct D2D_POINT_2F v22[4]; // [rsp+20h] [rbp-48h] BYREF
  ...
  if ( (char)(4 * v5) >> 6 == 1 )
  {
    ...
    v10 = FLOAT_0_000081380211;
    goto LABEL_6;
  }
  if ( (char)(4 * v5) >> 6 < 0 )
  {
LABEL_3:
    *a3 = *(float *)(a1 + 48) + a2->left;
    a3[1] = a2->top + *(float *)(a1 + 52);
    result = a2->right + *(float *)(a1 + 48);
    a3[2] = result;
    a3[3] = a2->bottom + *(float *)(a1 + 52);
    return result;
  }
  v7 = _xmm;
  v8 = FLOAT_61440_0;
...
LABEL_15:
    ...
    if ( (char)(4 * v21) >> 6 != 1 )
    {
      if ( (char)(4 * v21) >> 6 >= 0 )
      {
        ...
        {
          *(_BYTE *)(a1 + 65) = v21 & 0xCF | 0x10;
          v5 = v5 & 0x3F | 0x40;
          goto LABEL_16;
        }
        *(_BYTE *)(a1 + 65) = v21 | 0x30;
      }
...
LABEL_6:
  ...
  if ( v5 >> 6 >= 0 )
  {
    ...
    if ( (char)(4 * v15) >> 6 != 1 )
    {
      ...
      {
LABEL_19:
        if ( v10 > COERCE_FLOAT(COERCE_UNSIGNED_INT(*(float *)(a1 + 4) - 0.0) & v7)
          && v10 > COERCE_FLOAT(COERCE_UNSIGNED_INT(*(float *)(a1 + 16) - 0.0) & v7) )
        {
          *(_BYTE *)(a1 + 64) = v5 | 0xC0;
          goto LABEL_8;
        }
      ...
      if ( v10 > COERCE_FLOAT(COERCE_UNSIGNED_INT(
                                (float)((float)((float)(COERCE_FLOAT(*(_DWORD *)(a1 + 28) & v7) * v8)
                                              + (float)(COERCE_FLOAT(*(_DWORD *)(a1 + 12) & v7) * v8))
                                      + COERCE_FLOAT(*(_DWORD *)(a1 + 60) & v7))
                              - v9) & v7) )
      {
        *(_BYTE *)(a1 + 65) = v15 | 0x30;
        goto LABEL_19;
      }
      *(_BYTE *)(a1 + 65) = v15 & 0xCF | 0x10;
    }
LABEL_20:
    *(_BYTE *)(a1 + 64) = v5 & 0x3F | 0x40;
LABEL_21:
    CMILMatrix::Transform2DRectToPerspective((CMILMatrix *)a1, a2, v22);
    result = v22[0].x;
    v17 = 1LL;
    y = v22[0].y;
    x = v22[0].x;
    *v16 = v22[0].x;
    ...
    do
    {
      result = fminf(result, v22[v17].x);
      *v16 = result;
      y = fminf(y, v22[v17].y);
      v16[1] = y;
      x = fmaxf(x, v22[v17].x);
      v16[2] = x;
      v20 = fmaxf(v20, v22[v17++].y);
      v16[3] = v20;
    }
    while ( v17 < 4 );
    return result;
...
LABEL_8:
  v11 = (float)(*(float *)a1 * a2->left) + *(float *)(a1 + 48);
  *a3 = v11;
  v12 = (float)(a2->top * *(float *)(a1 + 20)) + *(float *)(a1 + 52);
  a3[1] = v12;
  v13 = (float)(a2->right * *(float *)a1) + *(float *)(a1 + 48);
  a3[2] = v13;
  v14 = (float)(a2->bottom * *(float *)(a1 + 20)) + *(float *)(a1 + 52);
  a3[3] = v14;
  result = *(float *)a1;
  if ( *(float *)a1 <= 0.0 || (result = *(float *)(a1 + 20), result <= 0.0) )
  {
    if ( v11 > v13 )
    {
      *a3 = v13;
