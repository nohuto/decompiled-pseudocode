/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmTouchpadInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmTouchpadInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801F2308
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U1@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3333AEBU?$_tlgWrapperByVal@$03@@44444444444444444444@Z @ 0x1801F2B64 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U1@U1@U1@U-$_tlgWrapperByVal@$03@@U2@U2@U2@U2@_ea_1801F2B64.c)
 *     _anonymous_namespace_::AxisContainsInteraction @ 0x1801F2DE8 (_anonymous_namespace_--AxisContainsInteraction.c)
 */
  ...
  do
  {
    ...
    if ( v11 >= *(_DWORD *)(*a2 + 12 * v9) && v11 <= *(_DWORD *)(v10 + 12 * v9 + 4) )
    {
      if ( (*(_BYTE *)(v10 + 12 * v9 + 8) & 0x40) != 0 )
        *a3 = 0;
      if ( *(char *)(*a2 + 12 * v9 + 8) < 0 )
        a3[1] = 0;
      v12 = (int)`CVisual::SetOpacityInternal'::`2'::sc_defaultValue;
      v13 = *a2;
      ...
      v56 = 1065353216;
      if ( (v16 & 1) != 0 && *((float *)a3 + 1) > 0.0 )
      {
        v45[0] = 0;
        v15 = 0;
      }
      if ( (v16 & 2) != 0 && *((float *)a3 + 1) < 0.0 )
      {
        v45[0] = 0;
        v15 = 0;
      }
      if ( (v16 & 4) != 0 && *((float *)a3 + 2) > 0.0 )
      {
        v46 = 0;
        v14 = 0;
      }
      if ( (v16 & 8) != 0 && *((float *)a3 + 2) < 0.0 )
      {
        v46 = 0;
        v14 = 0;
      }
      if ( (v16 & 0x10) != 0 && *((float *)a3 + 3) < 0.0 )
      {
        v51 = 0;
        v12 = 0;
      }
      if ( (v16 & 0x20) != 0 && *((float *)a3 + 3) > 0.0 )
      {
        v51 = 0;
        v12 = 0;
      }
      ...
      *((_DWORD *)a3 + 3) = v18;
      ...
      if ( (unsigned int)dword_180404D18 > 4 && (byte_180404D28 & 2) != 0 && (qword_180404D30 & 2) == qword_180404D30 )
      {
        ...
        v29 = 0;
        v30 = v15;
        v36 = *(_DWORD *)(v21 + 4 * v20 + 8);
        v37 = *(_DWORD *)(v21 + 4 * v20 + 4);
        v38 = *(_DWORD *)(v21 + 4 * v20);
        v40 = v8;
        v41 = *((_DWORD *)a1 + 198);
        v42 = *((_DWORD *)a1 + 197);
        v57 = a1[60];
