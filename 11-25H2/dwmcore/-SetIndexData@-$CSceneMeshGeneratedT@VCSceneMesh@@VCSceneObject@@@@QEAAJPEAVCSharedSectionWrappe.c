/*
 * XREFs of ?SetIndexData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180283604
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[13] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5, 0xDACu, 0LL);
    }
    else
    {
