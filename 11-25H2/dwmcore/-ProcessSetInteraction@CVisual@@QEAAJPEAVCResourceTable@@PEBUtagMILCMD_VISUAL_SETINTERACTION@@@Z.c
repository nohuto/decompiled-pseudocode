/*
 * XREFs of ?ProcessSetInteraction@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETINTERACTION@@@Z @ 0x180139C8C
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETINTERACTION *a3)
{
      ...
      && ((v12 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v11 + 64LL), v12 != CKeyframeAnimation::IsOfType)
        ? (v12 != CVisual::IsOfType
         ? (v12 != CSharedSection::IsOfType
          ? (v13 = v12(v11, 88))
          : (v13 = CSharedSection::IsOfType(v11, 88)))
         : (v13 = CVisual::IsOfType(v11, 88)))
        : (v13 = CKeyframeAnimation::IsOfType(v11, 88)),
          v13) )
    {
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0xD18u, 0LL);
  }
