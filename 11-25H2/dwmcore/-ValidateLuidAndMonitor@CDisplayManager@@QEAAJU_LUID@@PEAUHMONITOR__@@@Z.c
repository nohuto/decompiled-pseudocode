/*
 * XREFs of ?ValidateLuidAndMonitor@CDisplayManager@@QEAAJU_LUID@@PEAUHMONITOR__@@@Z @ 0x1802C9644
 * Callers:
...
__int64 __fastcall CDisplayManager::ValidateLuidAndMonitor(CDisplayManager *this, struct _LUID a2, HMONITOR a3)
{
  ...
  if ( Adapter < 0 )
  {
    ...
    v8 = 24;
LABEL_5:
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803363E8, 2u, v7, v8, 0LL);
