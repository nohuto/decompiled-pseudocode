/*
 * XREFs of ??1?$CQueue@PEAVCResource@@@@QEAA@XZ @ 0x18020CF5C
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CManipulationManager::s_InteractionUpdateQueue__ @ 0x1802E8FA0 (_dynamic_atexit_destructor_for__CManipulationManager--s_InteractionUpdateQueue__.c)
 * Callees:
