/*
 * XREFs of ?GetStats@CDDisplayRenderTarget@@UEAA_N_KPEAUtagCOMPOSITION_TARGET_STATS_2@@@Z @ 0x1801E1B80
 * Callers:
        ...
        struct tagCOMPOSITION_TARGET_STATS_2 *a3)
{
  ...
  v3 = (char *)this + 33368;
  v5 = a2;
  CTargetStats::Update((CDDisplayRenderTarget *)((char *)this + 33368), a2);
  v6 = 0LL;
  v7 = g_pComposition;
