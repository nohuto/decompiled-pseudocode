/*
 * XREFs of ?AddAdditionalDirtyRect@CVisual@@QEAAXAEBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@_N@Z @ 0x180106E70
 * Callers:
 ...
 *     ??0CMergedDirtyRect@@QEAA@XZ @ 0x18012A0DC (--0CMergedDirtyRect@@QEAA@XZ.c)
...
void __fastcall CVisual::AddAdditionalDirtyRect(__int64 a1, const struct D2D_RECT_F *a2, char a3)
{
  ...
  __int64 v19; // rax
  __int64 (__fastcall *v20)(_DWORD *, unsigned int, __int64); // r9
  __int64 (__fastcall *v21)(__int64, unsigned int, __int64); // r8
  struct CProcessAttribution *(__fastcall *v22)(CResource *); // rax
  __int64 v23; // rax
  __int64 v24; // rsi
  __int64 v25; // rbx
  char v26; // al
  __int64 v27; // rax
  struct CProcessAttribution *(__fastcall *v28)(CResource *); // rax
  __int64 v29; // rax
  __int64 v30; // rax
  __int64 v31; // rax
  __int64 v32; // rbp
  ...
  void (__fastcall *v37)(unsigned __int64, __int64, __int64, __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)); // rax
  ...
  _BYTE *v68; // rax
  void (__fastcall *v69)(unsigned __int64, __int64, __int64, __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)); // rax
...
LABEL_24:
  ...
  if ( (_DWORD)v19 )
  {
    ...
    do
    {
      ...
      if ( v61 != *(_QWORD *)(a1 + 88) )
      {
        v69 = *(void (__fastcall **)(unsigned __int64, __int64, __int64, __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)))(*(_QWORD *)v61 + 80LL);
        if ( (char *)v69 == (char *)CCachedVisualImage::NotifyOnChanged )
        {
          CResource::NotifyOnChanged((_DWORD *)v61, 6u, a1);
        }
        else if ( (char *)v69 == (char *)CVisualSurface::NotifyOnChanged )
        {
          ...
          if ( a1 != *(_QWORD *)(v61 + 72) )
            v70 = 1;
          CResource::NotifyOnChanged((_DWORD *)v61, v70, a1);
        }
        else
        {
  ...
  v22 = *(struct CProcessAttribution *(__fastcall **)(CResource *))(*(_QWORD *)a1 + 160LL);
  ...
  {
    v24 = ((__int64 (__fastcall *)(__int64, unsigned __int64, __int64 (__fastcall *)(__int64, unsigned int, __int64), __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)))v22)(
            a1,
            v16,
      ...
      *(_BYTE *)(v25 + 96) = v26 | 0x80;
      ...
      if ( (_DWORD)v27 )
      {
        ...
        do
        {
          ...
          {
            v37 = *(void (__fastcall **)(unsigned __int64, __int64, __int64, __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)))(*(_QWORD *)v36 + 80LL);
            if ( (char *)v37 == (char *)CCachedVisualImage::NotifyOnChanged )
            {
              CResource::NotifyOnChanged((_DWORD *)v36, 6u, v25);
            }
            else if ( (char *)v37 == (char *)CVisualSurface::NotifyOnChanged )
            {
              v38 = 6;
              if ( v25 != *(_QWORD *)(v36 + 72) )
                v38 = 1;
              CResource::NotifyOnChanged((_DWORD *)v36, v38, v25);
            }
            else
            {
              v37(v36, 1LL, v25, v20);
      ...
      v28 = *(struct CProcessAttribution *(__fastcall **)(CResource *))(*(_QWORD *)v25 + 160LL);
...
LABEL_44:
    ...
    if ( v28 == CWindowNode::GetProcessAttributionNoRef )
      ...
      v30 = ((__int64 (__fastcall *)(__int64, unsigned __int64, __int64 (__fastcall *)(__int64, unsigned int, __int64), __int64 (__fastcall *)(_DWORD *, unsigned int, __int64)))v28)(
              v25,
              v16,
              v21,
              v20);
