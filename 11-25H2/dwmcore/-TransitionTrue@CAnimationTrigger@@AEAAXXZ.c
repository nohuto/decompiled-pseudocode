/*
 * XREFs of ?TransitionTrue@CAnimationTrigger@@AEAAXXZ @ 0x18022C09C
 * Callers:
 ...
 *     ?ShouldSendAnimationNotification@CAnimationTrigger@@AEBA_NXZ @ 0x18022C450 (-ShouldSendAnimationNotification@CAnimationTrigger@@AEBA_NXZ.c)
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@333@Z @ 0x18022C474 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U1@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPE.c)
 ...
 *     ?swap@?$_Uhash_compare@PEAUIUnknown@@U?$hash@PEAUIUnknown@@@std@@U?$equal_to@PEAUIUnknown@@@3@@std@@QEAAXAEAV12@@Z @ 0x18029EEB0 (-swap@-$_Uhash_compare@PEAUIUnknown@@U-$hash@PEAUIUnknown@@@std@@U-$equal_to@PEAUIUnknown@@@3@@s.c)
...
void __fastcall CAnimationTrigger::TransitionTrue(CAnimationTrigger *this)
{
  ...
  if ( CNotificationResource::ShouldNotify(this) )
  {
           ...
           2LL) )
    {
      ...
      CoreUICallSend(v8, v24, 2LL, 2LL, 0, &unk_180336E53, v22, v23, ChannelCallbackId);
    }
    if ( CAnimationTrigger::ShouldSendAnimationNotification(this) )
    {
      ...
      if ( *((_QWORD *)this + 19) )
      {
        if ( (unsigned int)dword_180404D18 > 5 && tlgKeywordOn((__int64)&dword_180404D18, 4LL) )
        {
          v33 = this;
