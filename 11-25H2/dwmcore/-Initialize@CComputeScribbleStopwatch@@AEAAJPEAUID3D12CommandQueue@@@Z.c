/*
 * XREFs of ?Initialize@CComputeScribbleStopwatch@@AEAAJPEAUID3D12CommandQueue@@@Z @ 0x180294F64
 * Callers:
...
__int64 __fastcall CComputeScribbleStopwatch::Initialize(CMILRefCountImpl **this, struct ID3D12CommandQueue *a2)
{
  ...
  _QWORD *v10; // rbx
  __int64 v11; // rax
  __int64 (__fastcall *v12)(_QWORD *, _DWORD *, GUID *, CMILRefCountImpl **); // r14
  CMILRefCountImpl *v13; // rcx
  _QWORD *v14; // rbx
  __int64 v15; // rax
  __int64 (__fastcall *v16)(_QWORD *, int *, _QWORD, int *, int, _QWORD, GUID *, CMILRefCountImpl **); // r14
  ...
  if ( v6 >= 0 )
  {
    wil::com_ptr_t<ID3D12CommandQueue,wil::err_returncode_policy>::operator=(this, (CMILRefCountImpl *)a2);
    v20[2] = 0;
    v9 = this[4];
    v10 = v18;
    v20[1] = 1;
    ...
    v11 = *v18;
    this[4] = 0LL;
    v12 = *(__int64 (__fastcall **)(_QWORD *, _DWORD *, GUID *, CMILRefCountImpl **))(v11 + 312);
    if ( v9 )
      (*(void (__fastcall **)(CMILRefCountImpl *))(*(_QWORD *)v9 + 16LL))(v9);
    v6 = v12(v10, v20, &GUID_0d9658ae_ed45_469e_a61d_970ec583cab4, this + 4);
    v7 = v6;
    if ( v6 >= 0 )
    {
      v22 = 0LL;
      ...
      v15 = *v18;
      this[5] = 0LL;
      v16 = *(__int64 (__fastcall **)(_QWORD *, int *, _QWORD, int *, int, _QWORD, GUID *, CMILRefCountImpl **))(v15 + 216);
      if ( v13 )
        (*(void (__fastcall **)(CMILRefCountImpl *))(*(_QWORD *)v13 + 16LL))(v13);
      v6 = v16(v14, &v32, 0LL, &v21, 1024, 0LL, &GUID_696442be_a72e_4059_bc79_5b5c98040fad, this + 5);
      v7 = v6;
      if ( v6 >= 0 )
      {
