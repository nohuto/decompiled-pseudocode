/*
 * XREFs of ?SetProperty@CArithmeticCompositeEffect@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1802B3960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  if ( *v9 != v4 )
  {
    v10 = *a1;
    *v9 = v4;
    (*(void (__fastcall **)(__int64 *, _QWORD, _QWORD))(v10 + 80))(a1, 0LL, 0LL);
  }
