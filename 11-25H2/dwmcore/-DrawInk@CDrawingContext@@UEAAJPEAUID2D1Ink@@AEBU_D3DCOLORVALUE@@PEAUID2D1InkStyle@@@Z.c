/*
 * XREFs of ?DrawInk@CDrawingContext@@UEAAJPEAUID2D1Ink@@AEBU_D3DCOLORVALUE@@PEAUID2D1InkStyle@@@Z @ 0x180270770
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1InkStyle *a4)
{
  ...
  *(struct _D3DCOLORVALUE *)&v21.r = 0LL;
  ...
  if ( CScopedClipStack::HasDeferredD2DLayers((CDrawingContext *)((char *)this + 728)) )
  {
    ...
    v24 = 0;
    v22 = v20;
    v11 = CDrawingContext::CTryIgnoreCpuClippingScope::Enter(&v19, v4, (__int64)&v22, 0LL);
    v9 = v11;
    if ( v11 < 0 )
    {
      v18 = 752;
