/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x18017A664
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18017A740 (s_TransformPointByMatrix.c)
 */
