/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18022D3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataProviderRegistrarPrincipalImpl::AllocateStubUnderLockThunk(
