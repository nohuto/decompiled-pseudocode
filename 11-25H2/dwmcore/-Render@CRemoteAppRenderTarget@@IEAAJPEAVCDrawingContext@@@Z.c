/*
 * XREFs of ?Render@CRemoteAppRenderTarget@@IEAAJPEAVCDrawingContext@@@Z @ 0x18028C274
 * Callers:
 ...
 *     ?CalcVailAlphaMode@CRemoteAppRenderTarget@@IEBAXPEAW4DXGI_ALPHA_MODE@@PEAU_D3DCOLORVALUE@@@Z @ 0x18028BAAC (-CalcVailAlphaMode@CRemoteAppRenderTarget@@IEBAXPEAW4DXGI_ALPHA_MODE@@PEAU_D3DCOLORVALUE@@@Z.c)
...
LABEL_31:
  ...
  if ( *(_DWORD *)(*((_QWORD *)this + 3) + 6288LL) == 7 && *((_QWORD *)this + 14) )
  {
