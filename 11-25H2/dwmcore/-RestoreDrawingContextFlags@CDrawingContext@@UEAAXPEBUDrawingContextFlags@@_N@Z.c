/*
 * XREFs of ?RestoreDrawingContextFlags@CDrawingContext@@UEAAXPEBUDrawingContextFlags@@_N@Z @ 0x1800D85F0
 * Callers:
 ...
 * Callees:
 *     ?IsIntermediate@CDeviceTextureTarget@@UEBA_NXZ @ 0x1801FE3C0 (-IsIntermediate@CDeviceTextureTarget@@UEBA_NXZ.c)
 *     ?SetBlackedOutForReadback@CDeviceTextureTarget@@UEAAX_N@Z @ 0x180209700 (-SetBlackedOutForReadback@CDeviceTextureTarget@@UEAAX_N@Z.c)
 *     ?SetProtected@CDeviceTextureTarget@@UEAAX_N@Z @ 0x180209850 (-SetProtected@CDeviceTextureTarget@@UEAAX_N@Z.c)
 *     ?SetBlackedOutForMonitor@CDeviceTextureTarget@@UEAAX_N@Z @ 0x18020A9C0 (-SetBlackedOutForMonitor@CDeviceTextureTarget@@UEAAX_N@Z.c)
        ...
        char a3)
{
  ...
  _BYTE *v7; // r9
  bool (__fastcall *v8)(CDeviceTextureTarget *); // rax
  char v9; // al
  ...
  v8 = *(bool (__fastcall **)(CDeviceTextureTarget *))(*(_QWORD *)v7 + 128LL);
