/*
 * XREFs of ?ProcessSetDesktopTree@CRemoteRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_REMOTERENDERTARGET_SETDESKTOPTREE@@@Z @ 0x18028B304
 * Callers:
        ...
        const struct tagMILCMD_REMOTERENDERTARGET_SETDESKTOPTREE *a3)
{
  ...
  {
    wil::com_ptr_t<CDesktopTree,wil::err_returncode_policy>::operator=(this + 26, (__int64)Resource);
    CRenderTarget::SetVisualTree((CRenderTarget *)this, Resource);
  }
  else
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003303421, 0x29u, 0LL);
  }
  return v4;
}
