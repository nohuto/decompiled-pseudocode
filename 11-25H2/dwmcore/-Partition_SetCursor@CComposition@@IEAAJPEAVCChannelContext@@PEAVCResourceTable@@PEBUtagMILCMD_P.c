/*
 * XREFs of ?Partition_SetCursor@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_SETCURSOR@@@Z @ 0x1801985F0
 * Callers:
        ...
        const struct tagMILCMD_PARTITION_SETCURSOR *a4)
{
  ...
  if ( *((_BYTE *)a4 + 8) )
  {
    ...
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x496u, 0LL);
  }
  else
  {
