/*
 * XREFs of ?ProcessRenderCommands_RenderPass@CCpuClipAntialiasSinkContext@@AEBAJPEAVCDrawingContext@@IPEAV?$list@USinkRenderCommand@CCpuClipAntialiasSinkContext@@V?$allocator@USinkRenderCommand@CCpuClipAntialiasSinkContext@@@std@@@std@@@Z @ 0x180085700
 * Callers:
        ...
        __int64 **a4)
{
  ...
  _DWORD *v40; // [rsp+40h] [rbp-58h] BYREF
  ...
  while ( 1 )
  {
    do
    {
      ...
      {
        updated = CCommonRenderingEffect::UpdateBitmaps(v11, a2);
      }
      else if ( v12 == CBrushRenderingEffect::UpdateBitmaps )
      {
        updated = CBrushRenderingEffect::UpdateBitmaps(v11, a2);
      }
      else
      {
        updated = v12(v11, a2);
    ...
    if ( !*(_DWORD *)(v15 + 24) )
    {
      v32 = MIDL_user_allocate(0xB8uLL);
      v33 = v32;
      if ( !v32 )
      {
        v16 = -2147024882;
      ...
      *v32 = 0;
      v40 = v32;
      v34 = DynArray<CBatchCommand *,0>::AddMultipleAndSet(v15, &v40, 1LL);
      v16 = v34;
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x160u, 0LL);
        std::default_delete<CBatchCommand>::operator()(v35, v33);
        goto LABEL_12;
      }
    }
    v18 = *(_DWORD *)(v15 + 32);
...
LABEL_12:
    ...
    *((_DWORD *)v22 + 44) = *(_DWORD *)(a1 + 968);
    ...
    CD2DContext::EnsureBeginDraw((CD2DContext *)(v23 + 16));
    appended = CD2DContext::EnsureDrawListBatch((CD2DContext *)(v23 + 16), v25, v24);
    if ( appended < 0 )
    {
      v30 = 519;
LABEL_27:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, appended, v30, 0LL);
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x218,
        (unsigned int)"onecoreuap\\windows\\dwm\\dwmcore\\rendering\\cpuclipantialiassinkcontext.cpp",
        ...
        v37);
      if ( v45 )
        std::default_delete<CBatchCommand>::operator()(v31, v45);
    ...
    if ( v45 )
      CBatchCommand::`scalar deleting destructor'(v45, v27);
    v7 = v39;
    v4 = v23;
  }
  wil::details::in1diag3::Return_Hr(
