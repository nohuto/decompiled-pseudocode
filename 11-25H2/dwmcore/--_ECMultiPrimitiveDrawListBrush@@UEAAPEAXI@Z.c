/*
 * XREFs of ??_ECMultiPrimitiveDrawListBrush@@UEAAPEAXI@Z @ 0x1800CCF70
 * Callers:
        ...
        char a2)
{
  ...
  v4 = (CMultiPrimitiveDrawListBrush *)*((_QWORD *)this + 9);
  if ( v4 )
  {
    v5 = **(CSurfaceDrawListBrush *(__fastcall ***)(CSurfaceDrawListBrush *, char))v4;
    if ( (char *)v5 == (char *)CMultiPrimitiveDrawListBrush::`vector deleting destructor' )
    {
