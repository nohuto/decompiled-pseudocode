/*
 * XREFs of ?GetRemotingDXGIOutput@CDisplayManager@@QEAAJPEAUHMONITOR__@@PEAPEAUIDXGIOutputDWM@@@Z @ 0x1802C947C
 * Callers:
        ...
        struct IDXGIOutputDWM **a3)
{
  ...
  if ( DXGIOutput < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803363E8, 2u, DXGIOutput, 0x8Eu, 0LL);
