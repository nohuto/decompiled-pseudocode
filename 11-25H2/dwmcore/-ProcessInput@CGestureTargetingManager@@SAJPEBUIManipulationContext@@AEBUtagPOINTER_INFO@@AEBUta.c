/*
 * XREFs of ?ProcessInput@CGestureTargetingManager@@SAJPEBUIManipulationContext@@AEBUtagPOINTER_INFO@@AEBUtagPOINTER_INFO_UNION@@@Z @ 0x180262C60
 * Callers:
        ...
        const struct tagPOINTER_INFO_UNION *a3)
{
  ...
  _BYTE v25[120]; // [rsp+40h] [rbp-78h] BYREF
  ...
  else
  {
    ...
    if ( v12 )
    {
      while ( v11 >= 0 )
      {
        v26 = 0;
        v13 = *(_QWORD *)v12;
        v14 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v12 + 176LL))(v12, v25);
...
LABEL_10:
      v18 = *(_QWORD *)a1;
      v26 = 0;
      v27 = (__int64 *)(*(__int64 (__fastcall **)(const struct IManipulationContext *))(v18 + 112))(a1);
      v19 = v27;
      Microsoft::WRL::ComPtr<IInteractionContextWrapper>::InternalAddRef((__int64 (__fastcall ****)(_QWORD))&v27);
      v20 = *v19;
      v21 = (*(__int64 (__fastcall **)(__int64 *, _BYTE *))(*v19 + 176))(v19, v25);
      ...
      v11 = (*(__int64 (__fastcall **)(__int64 *, const struct tagPOINTER_INFO *, const struct tagPOINTER_INFO_UNION *, _QWORD, __int64, char *))(v20 + 16))(
              ...
              v21,
              &v26);
      Microsoft::WRL::ComPtr<IInteractionResource>::InternalRelease((CResource **)&v27);
    }
    return (unsigned int)v11;
  }
}
