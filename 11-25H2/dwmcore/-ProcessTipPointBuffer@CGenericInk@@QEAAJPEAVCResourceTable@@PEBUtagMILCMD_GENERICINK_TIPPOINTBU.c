/*
 * XREFs of ?ProcessTipPointBuffer@CGenericInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GENERICINK_TIPPOINTBUFFER@@@Z @ 0x1801FDF1C
 * Callers:
        ...
        const struct tagMILCMD_GENERICINK_TIPPOINTBUFFER *a3)
{
  ...
  if ( v7 )
  {
    Resource = (struct CSharedSectionBase *)CResourceTable::GetResource((__int64)a2, v7, 0x9Du);
    if ( Resource )
    {
