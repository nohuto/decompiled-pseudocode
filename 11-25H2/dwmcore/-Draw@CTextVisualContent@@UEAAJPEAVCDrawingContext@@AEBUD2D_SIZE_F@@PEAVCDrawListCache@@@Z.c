/*
 * XREFs of ?Draw@CTextVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1802B6C10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
    ...
    v26 = *((_QWORD *)this + 9);
    v27 = *(CCompositionTextLine ***)(v26 + 696);
    v28 = *(CCompositionTextLine ***)(v26 + 704);
    while ( v27 != v28 )
    {
      v29 = *v27;
      v33 = 0LL;
