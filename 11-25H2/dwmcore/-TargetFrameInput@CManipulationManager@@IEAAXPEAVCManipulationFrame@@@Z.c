/*
 * XREFs of ?TargetFrameInput@CManipulationManager@@IEAAXPEAVCManipulationFrame@@@Z @ 0x1801AE950
 * Callers:
 ...
 *     ?TargetBufferedFrames@CManipulationManager@@IEAAXIPEAXK@Z @ 0x1801AF790 (-TargetBufferedFrames@CManipulationManager@@IEAAXIPEAXK@Z.c)
...
void __fastcall CManipulationManager::TargetFrameInput(CManipulationManager *this, struct CManipulationFrame *a2)
{
  ...
  for ( i = 0LL; v2 < *((_DWORD *)a2 + 4); ++v2 )
  {
    ...
    if ( (*((_BYTE *)a2 + 176) & 2) == 0 || *(_QWORD *)((char *)a2 + v7 + 392) == -1LL )
    {
      ...
      {
        Microsoft::WRL::ComPtr<CManipulationContext>::operator=((__int64 *)&v19, (_QWORD *)this + 30);
        v12 = v19;
      }
      v14 = 0LL;
      v20 = 0LL;
