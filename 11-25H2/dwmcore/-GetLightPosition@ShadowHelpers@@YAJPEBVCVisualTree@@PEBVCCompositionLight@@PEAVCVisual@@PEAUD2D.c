/*
 * XREFs of ?GetLightPosition@ShadowHelpers@@YAJPEBVCVisualTree@@PEBVCCompositionLight@@PEAVCVisual@@PEAUD2D_VECTOR_3F@@@Z @ 0x1801E9A84
 * Callers:
        ...
        FLOAT *a4)
{
  ...
  else
  {
    ...
    *(_QWORD *)&v29.z = &v35;
    v36 = v9;
    *(_QWORD *)&v28.z = &v36;
    v25 = CVisual::CalcSrcToDestVisualTransform(v4, v10, (unsigned int)&v28, (_DWORD)a3, (__int64)&v29);
    v8 = v25;
    if ( v25 < 0 )
    {
  ...
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v29.z = &v35;
      *(_QWORD *)&v28.z = &v36;
      v13 = CVisual::CalcSrcToDestVisualTransform(v4, v12, (unsigned int)&v28, (_DWORD)v11, (__int64)&v29);
      v8 = v13;
      if ( v13 < 0 )
      {
