/*
 * XREFs of ?ProcessCaptureBits@CLegacyVisualCaptureRenderTarget@@QEAAJPEAVCChannelContext@@PEBUtagMILCMD_LEGACYVISUALCAPTURERENDERTARGET_CAPTUREBITS@@@Z @ 0x1801EFC38
 * Callers:
...
LABEL_3:
  ...
  if ( !HANDLE_TABLE::ValidEntry((HANDLE_TABLE *)(*((_QWORD *)a2 + 6) + 16LL), v5)
    ...
    || ((v13 = *(bool (__fastcall **)(__int64, int))(*(_QWORD *)v12 + 64LL), v13 == CKeyframeAnimation::IsOfType)
      ? (v14 = CKeyframeAnimation::IsOfType(v12, 182))
      : v13 != CVisual::IsOfType
      ? (v13 != CSharedSection::IsOfType
       ? (v14 = v13(v12, 182))
       : (v14 = CSharedSection::IsOfType(v12, 182)))
      : (v14 = CVisual::IsOfType(v12, 182)),
