/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VILegacyRemotingSwapChain@@VIDeviceResource@@VCMilObjectDeleter@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802D02F4
 * Callers:
 *     ?QueryInterface@CLegacyRemotingSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802D0650 (-QueryInterface@CLegacyRemotingSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a1 + 256LL))(a1);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
