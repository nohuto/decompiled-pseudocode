/*
 * XREFs of ?GetTargetId@?$IRenderTargetMethodsT@VCRenderTarget@@VIMonitorTarget@@VICapabilitiesContributorTarget@@@@WEI@EBAAEBUtagCOMPOSITION_TARGET_ID@@XZ @ 0x180281D50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
