/*
 * XREFs of ?GetBounds@CDropShadow@@UEBAJAEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180119C60
 * Callers:
...
__int64 __fastcall CDropShadow::GetBounds(CDropShadow *this, float *a2, float *a3)
{
  ...
  else
  {
    ...
    *a3 = v9 + 0.0;
    ...
    TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::Inflate(a3, v11, v12, v13);
  }
  return 0LL;
}
