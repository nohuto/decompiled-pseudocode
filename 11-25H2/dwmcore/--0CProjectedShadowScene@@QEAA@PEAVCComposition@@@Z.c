/*
 * XREFs of ??0CProjectedShadowScene@@QEAA@PEAVCComposition@@@Z @ 0x180237860
 * Callers:
 ...
 * Callees:
 *     ??0?$list@UReceiverEntry@CProjectedShadowScene@@V?$allocator@UReceiverEntry@CProjectedShadowScene@@@std@@@std@@QEAA@XZ @ 0x180257ED4 (--0-$list@UReceiverEntry@CProjectedShadowScene@@V-$allocator@UReceiverEntry@CProjectedShadowScen.c)
 *     ??0?$list@UCasterEntry@CProjectedShadowScene@@V?$allocator@UCasterEntry@CProjectedShadowScene@@@std@@@std@@QEAA@XZ @ 0x180257F0C (--0-$list@UCasterEntry@CProjectedShadowScene@@V-$allocator@UCasterEntry@CProjectedShadowScene@@@.c)
 */
