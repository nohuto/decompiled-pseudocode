/*
 * XREFs of ?AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z @ 0x1800F4020
 * Callers:
 ...
 * Callees:
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x1800F4358 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
