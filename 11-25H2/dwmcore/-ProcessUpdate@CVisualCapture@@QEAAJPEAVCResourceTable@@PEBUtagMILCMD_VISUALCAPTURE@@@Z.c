/*
 * XREFs of ?ProcessUpdate@CVisualCapture@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALCAPTURE@@@Z @ 0x180233590
 * Callers:
...
LABEL_27:
  ...
  if ( v15 )
  {
    Resource = CResourceTable::GetResource((__int64)a2, v15, 0xB6u);
  ...
  if ( (_DWORD)v17 )
  {
    v18 = CResourceTable::GetResource((__int64)a2, (unsigned int)v17, 0x29u);
    *((_QWORD *)this + 344) = v18;
    if ( !v18 )
    {
      v13 = -2003303421;
