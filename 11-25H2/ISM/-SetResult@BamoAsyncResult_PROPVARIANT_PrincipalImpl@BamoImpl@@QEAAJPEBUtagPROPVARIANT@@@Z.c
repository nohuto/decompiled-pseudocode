/*
 * XREFs of ?SetResult@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJPEBUtagPROPVARIANT@@@Z @ 0x1801729F0
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180172AF0 (-Thunk_SetResult_0@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Pri.c)
 * Callees:
        ...
        const struct tagPROPVARIANT *a2)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *, __int64, const struct tagPROPVARIANT *))(*((_QWORD *)this - 2) + 80LL))(
           (char *)this - 16,
           v6,
           a2);
    v4 = v9;
