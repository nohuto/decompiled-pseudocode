/*
 * XREFs of ?LogSendRegisterOverride@BamoControllerNavigationManagerProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180119A10
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationManagerProxyImpl::LogSendRegisterOverride(
