/*
 * XREFs of ?UpdateFocusedInputTarget3D@MPCInputRouter@@AEAAXPEAUIInputTarget@@@Z @ 0x1800FD014
 * Callers:
        ...
        __int64 (__fastcall ***a2)(struct IInputTarget *, GUID *, __int64 *))
{
  ...
  if ( a2 && MPCInputRouter::IsTargetHolographic(this, a2) )
  {
    ...
    if ( v13
      ...
      && (v15 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 82) + 88LL))(*((_QWORD *)this + 82)), v39 == v15) )
    {
      v16 = 1;
    }
    else
    ...
    v28 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 82) + 32LL))(*((_QWORD *)this + 82));
    v29 = (struct IMPCTarget *)*((_QWORD *)this + 82);
  ...
  {
    MPCInputRouter::Set3DFocusTarget(this, *((struct IMPCFocusTarget **)this + 84));
  }
}
