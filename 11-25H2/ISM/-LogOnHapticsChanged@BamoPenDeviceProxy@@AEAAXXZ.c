/*
 * XREFs of ?LogOnHapticsChanged@BamoPenDeviceProxy@@AEAAXXZ @ 0x180116A14
 * Callers:
...
void __fastcall BamoPenDeviceProxy::LogOnHapticsChanged(BamoPenDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
