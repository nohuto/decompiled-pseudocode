/*
 * XREFs of ?LogOnResizeContextualProcessorChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180117BEC
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnResizeContextualProcessorChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
