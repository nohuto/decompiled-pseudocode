/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoTouchGesture@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180159A10
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoTouchGesture@@@details@wil@@QEAA_NXZ @ 0x180159CA0 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoTouchGesture@@@details@w.c)
 * Callees:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoTouchGesture>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v4 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoTouchGesture>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            v7);
    v10 = v4;
  }
