/*
 * XREFs of ?QueryInterface@LightDismissProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800680C0
 * Callers:
 *     ?QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015C0A0 (-QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
