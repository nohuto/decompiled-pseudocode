/*
 * XREFs of ?OnMessage@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18013BCB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSpacePayloadPrincipalImpl::OnMessage(
