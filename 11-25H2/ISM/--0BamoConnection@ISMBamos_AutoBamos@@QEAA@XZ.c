/*
 * XREFs of ??0BamoConnection@ISMBamos_AutoBamos@@QEAA@XZ @ 0x18009762C
 * Callers:
 ...
 *     ??0InputSystemInternalClientConnection@@IEAA@XZ @ 0x18012BB10 (--0InputSystemInternalClientConnection@@IEAA@XZ.c)
 * Callees:
