/*
 * XREFs of ?ForwardInputReport@MouseProcessor@@UEAAJPEBUMouseProcessorState@@PEAUInputInfo@@@Z @ 0x180191D70
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  if ( *((_BYTE *)this + 128) )
  {
    ...
    *((_DWORD *)a3 + 29) = 4;
    ...
    v19 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**((_QWORD **)this + 13) + 80LL))(
            *((_QWORD *)this + 13),
            **((unsigned int **)this + 6),
            1LL);
    if ( v19 < 0 )
