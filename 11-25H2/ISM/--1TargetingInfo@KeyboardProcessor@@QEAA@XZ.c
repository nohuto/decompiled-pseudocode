/*
 * XREFs of ??1TargetingInfo@KeyboardProcessor@@QEAA@XZ @ 0x18002C544
 * Callers:
 ...
 *     _KeyboardProcessor::OnInputReport_::_1_::dtor$5 @ 0x1801C9CCE (_KeyboardProcessor--OnInputReport_--_1_--dtor$5.c)
 * Callees:
