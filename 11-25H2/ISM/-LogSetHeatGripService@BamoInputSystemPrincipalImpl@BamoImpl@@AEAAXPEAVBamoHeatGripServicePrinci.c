/*
 * XREFs of ?LogSetHeatGripService@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoHeatGripServicePrincipal@@@Z @ 0x1800915A8
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetHeatGripService(
