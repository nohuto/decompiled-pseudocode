/*
 * XREFs of ?LogOnIsPlayDurationSupportedChanging@BamoSimpleHapticsControllerProxy@@AEAAX_N@Z @ 0x18011752C
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsPlayDurationSupportedChanging(
