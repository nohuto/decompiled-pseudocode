/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YA?AUResultStatus@12@PEAG_KPEA_N@Z @ 0x1800A1480
 * Callers:
 *     <none>
 * Callees:
...
int *__fastcall wil::details::ResultFromCaughtExceptionInternal(int *a1, _WORD *a2, __int64 a3, _BYTE *a4)
{
  ...
  const std::bad_alloc *v19; // [rsp+28h] [rbp-60h] BYREF
  const wil::ResultException *v20; // [rsp+30h] [rbp-58h] BYREF
  const std::bad_alloc *v21; // [rsp+38h] [rbp-50h] BYREF
  std::exception *v22; // [rsp+40h] [rbp-48h] BYREF
  ...
  const struct std::exception *v28; // [rsp+98h] [rbp+10h]
  const struct wil::ResultException *v29; // [rsp+98h] [rbp+10h]
  const struct std::exception *v30; // [rsp+98h] [rbp+10h]
  const struct std::exception *v31; // [rsp+98h] [rbp+10h]
...
LABEL_5:
  ...
  if ( wil::g_pfnResultFromCaughtException )
  {
    ...
    catch ( const wil::ResultException *v18 )
    {
      *v37 = 1;
      ...
      v23 = *((_QWORD *)v12 + 4);
      v24 = (unsigned __int8)(*((_BYTE *)v12 + 28) & 8) >> 3;
      result = v25;
      *(_QWORD *)v25 = v23;
      v25[2] = v24;
      return result;
  ...
  catch ( const wil::ResultException *v20 )
  {
    *v38 = 1;
    ...
    v23 = *((_QWORD *)v15 + 4);
    v24 = (unsigned __int8)(*((_BYTE *)v15 + 28) & 8) >> 3;
    result = v25;
    *(_QWORD *)v25 = v23;
    v25[2] = v24;
    return result;
