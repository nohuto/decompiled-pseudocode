/*
 * XREFs of ?OnNotify@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x1801011BC
 * Callers:
 *     ?Thunk_OnNotify_8@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180103C60 (-Thunk_OnNotify_8@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SA.c)
 * Callees:
