/*
 * XREFs of ?reserve@?$vector_nothrow@VStoredFailureInfo@wil@@@tip2@@QEAA_N_K@Z @ 0x180107024
 * Callers:
 ...
 * Callees:
 *     ??_GStoredFailureInfo@wil@@QEAAPEAXI@Z @ 0x1800A45FC (--_GStoredFailureInfo@wil@@QEAAPEAXI@Z.c)
 */
