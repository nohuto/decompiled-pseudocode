/*
 * XREFs of ?OnForegroundTransferFromHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJAEBUTransferForegroundInfo@@@Z @ 0x180130020
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogSendOnForegroundTransferFromHost(this, a2);
      v12 = *(_OWORD *)a2;
      v17 = *((_DWORD *)a2 + 8);
      v13 = *((_OWORD *)a2 + 1);
      v14[0] = v19;
