/*
 * XREFs of ??$_Erase@_K@?$_Hash@V?$_Umap_traits@_KPEAUIMPCTarget@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@3@$0A@@std@@@std@@AEAA_KAEB_K@Z @ 0x1800FA614
 * Callers:
 *     ?RemoveMPCTargetForWindowId@MPCInputRouter@@UEAAX_K@Z @ 0x1800FCB20 (-RemoveMPCTargetForWindowId@MPCInputRouter@@UEAAX_K@Z.c)
 * Callees:
...
__int64 __fastcall std::_Hash<std::_Umap_traits<unsigned __int64,IMPCTarget *,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,IMPCTarget *>>,0>>::_Erase<unsigned __int64>(
        _QWORD *a1,
        __int64 a2)
{
  __int64 v3; // rdi
