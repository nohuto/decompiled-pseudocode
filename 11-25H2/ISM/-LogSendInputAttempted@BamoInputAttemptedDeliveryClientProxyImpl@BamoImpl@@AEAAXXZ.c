/*
 * XREFs of ?LogSendInputAttempted@BamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@AEAAXXZ @ 0x18015C350
 * Callers:
...
void __fastcall BamoImpl::BamoInputAttemptedDeliveryClientProxyImpl::LogSendInputAttempted(
