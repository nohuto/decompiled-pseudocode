/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_KM@Z @ 0x180123510
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      BamoImpl::BamoSystemCursorControllerProxyImpl::LogSendSetCursorShellMagnification(this, a2, a3);
