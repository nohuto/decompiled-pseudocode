/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x18013EDB0
 * Callers:
 *     <none>
 * Callees:
