/*
 * XREFs of ?UpdateId@BamoAnimationTargetClientProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x1800987EC
 * Callers:
 *     ?Thunk_UpdateId_0@?$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800906A0 (-Thunk_UpdateId_0@-$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@Bamo.c)
