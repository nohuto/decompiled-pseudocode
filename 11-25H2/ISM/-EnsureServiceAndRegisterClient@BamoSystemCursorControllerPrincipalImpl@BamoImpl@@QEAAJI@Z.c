/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800F5470
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_8@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6490 (-Thunk_EnsureServiceAndRegisterClient_8@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCu.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoSystemCursorControllerClientProxy *v10; // rbp
  ...
  BamoImpl::BamoSystemCursorControllerPrincipalImpl::LogReceiveEnsureServiceAndRegisterClient(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoSystemCursorControllerClientProxy *))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v6,
            v10);
    v4 = v17;
