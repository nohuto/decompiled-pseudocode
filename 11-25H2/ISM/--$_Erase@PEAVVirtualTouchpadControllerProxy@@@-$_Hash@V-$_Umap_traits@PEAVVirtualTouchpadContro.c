        ...
        const unsigned __int8 *a2)
{
  ...
  if ( !v5 )
    return 0LL;
  v7 = qword_180246EF8;
  v8 = 2 * (v6 & qword_180246F10);
  if ( *(__int64 **)(qword_180246EF8 + 16 * (v6 & qword_180246F10) + 8) == v5 )
  {
    if ( *(__int64 **)(qword_180246EF8 + 16 * (v6 & qword_180246F10)) == v5 )
    {
      v9 = qword_180246EE8;
      *(_QWORD *)(qword_180246EF8 + 16 * (v6 & qword_180246F10)) = qword_180246EE8;
    }
    else
    {
      v9 = v5[1];
  ...
  else if ( *(__int64 **)(qword_180246EF8 + 16 * (v6 & qword_180246F10)) == v5 )
  {
    *(_QWORD *)(qword_180246EF8 + 16 * (v6 & qword_180246F10)) = *v5;
  }
  v10 = *v5;
  --qword_180246EF0;
  *(_QWORD *)v5[1] = v10;
