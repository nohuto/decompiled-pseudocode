/*
 * XREFs of ?LogOnGamepadInterceptionEnabledChanged@BamoInputDelegationInputObjectProxy@@AEAAXXZ @ 0x180130EF0
 * Callers:
...
void __fastcall BamoInputDelegationInputObjectProxy::LogOnGamepadInterceptionEnabledChanged(
