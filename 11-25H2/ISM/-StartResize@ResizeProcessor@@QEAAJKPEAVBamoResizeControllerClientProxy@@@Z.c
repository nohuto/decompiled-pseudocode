/*
 * XREFs of ?StartResize@ResizeProcessor@@QEAAJKPEAVBamoResizeControllerClientProxy@@@Z @ 0x180150524
 * Callers:
 *     ?StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014D7F0 (-StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeCo.c)
 * Callees:
 ...
 *     ??$_Try_emplace@AEBK$$V@?$_Hash@V?$_Umap_traits@KUMessageInfo@ResizeProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@PEAU?$_List_node@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@PEAX@std@@_N@1@AEBK@Z @ 0x18014DC80 (--$_Try_emplace@AEBK$$V@-$_Hash@V-$_Umap_traits@KUMessageInfo@ResizeProcessor@@V-$_Uhash_compare.c)
        ...
        struct BamoResizeControllerClientProxy *a3)
{
  ...
  struct tagPOINT v17; // [rsp+40h] [rbp-30h] BYREF
  __int64 (__fastcall ***v18)(_QWORD); // [rsp+48h] [rbp-28h] BYREF
  DragGestureTracker *v19[2]; // [rsp+50h] [rbp-20h] BYREF
  char v20[16]; // [rsp+60h] [rbp-10h] BYREF
  struct tagPOINT *v21; // [rsp+A0h] [rbp+30h] BYREF
  unsigned int v22; // [rsp+A8h] [rbp+38h] BYREF
  struct InputSite *v23; // [rsp+B0h] [rbp+40h] BYREF
  struct tagPOINT v24; // [rsp+B8h] [rbp+48h] BYREF

  v22 = a2;
  InputETW::Resize::StartResize(a2);
  v18 = (__int64 (__fastcall ***)(_QWORD))a3;
  Microsoft::WRL::ComPtr<BamoDragSourceClientProxy>::InternalAddRef(&v18);
  std::_Hash<std::_Umap_traits<unsigned long,EdgyProcessor::PointerCache,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,EdgyProcessor::PointerCache>>,0>>::find<void>(
    (__int64)this + 88,
    (__int64)&v21,
    &v22);
  v5 = v21;
  v6 = v21 == *((struct tagPOINT **)this + 12);
  ResizeProcessor::GetResizeControllerInputSite(v7, (__int64 *)&v23, (__int64 *)a3);
  v10 = 1;
  if ( v23 )
    v10 = v6;
  v17.x = 0;
  ...
  if ( v10 )
  {
    InputETW::Resize::ResizeCancelled(v22, v8, v9, &v17, &v24);
  ...
  else
  {
    ...
    *(struct tagPOINT *)(*(_QWORD *)std::_Hash<std::_Umap_traits<unsigned long,tagPOINTF,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,tagPOINTF>>,0>>::_Try_emplace<unsigned long const &,>(
                                      ...
                                      &v22)
                       + 20LL) = v12;
    ResizeProcessor::CreatePointerInfoAndUpdatePositionData(this, v22, v12, v23, &v17, &v24);
    InputETW::Resize::ResizeStarted(v22, 0, x, &v17, &v24);
           ...
           &v24) >= 0 )
    {
      v13 = *(_QWORD *)std::_Hash<std::_Umap_traits<unsigned long,ResizeProcessor::MessageInfo,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,ResizeProcessor::MessageInfo>>,0>>::_Try_emplace<unsigned long const &,>(
                         ...
                         (__int64)v20,
                         &v22);
      Microsoft::WRL::ComPtr<BamoDragManagerClientProxy>::operator=((__int64 (__fastcall ****)(_QWORD))(v13 + 24), &v18);
      Microsoft::WRL::ComPtr<IMPCFocusTarget>::operator=((__int64 *)(v13 + 40), &v23);
      LOBYTE(v21) = 0;
      v14 = (__int64 *)std::make_unique<DragGestureTracker,bool,0>(v19, (char *)&v21);
      std::unique_ptr<DragGestureTracker>::operator=<std::default_delete<DragGestureTracker>,0>(
        (__int64 *)(v13 + 48),
        v14);
      std::unique_ptr<DragGestureTracker>::~unique_ptr<DragGestureTracker>(v19);
      **(_DWORD **)(v13 + 48) = 4;
    }
  }
  v15 = v23;
