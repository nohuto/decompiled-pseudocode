/*
 * XREFs of ?OnResizeAreaClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18003A250
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIResizeAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003A2C8 (--$RemoveObject@UIResizeAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
