    ...
    if ( v27 )
    {
      ...
      if ( v26 != a1[5] )
      {
        ...
        **((_QWORD **)v28[0] + 1) = 0LL;
        ...
        std::_Deallocate<16,0>((char *)v28[0], (const struct std::nothrow_t *)0x20);
      }
    }
    if ( v25 )
    {
      if ( (unsigned int)dword_180244328 > 5 && tlgKeywordOn((__int64)&dword_180244328, 0x20000LL) )
      {
        ...
        v34 = 8LL;
        v32 = 4LL;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180244328, byte_18021DC0B, 0LL, 0LL, 6u, &v30);
      }
