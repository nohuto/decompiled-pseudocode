/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_I@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180111C34
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_I@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1801125CC (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_I@@@details@w.c)
 * Callees:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_GE_EssentialsBundle_I>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_GE_EssentialsBundle_I>::GetCurrentFeatureEnabledState(
      v7,
      &v17,
      &v16);
