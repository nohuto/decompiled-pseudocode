/*
 * XREFs of ?Thresholds@ShellGestures@InputTraceLogging@@SAX_J00000@Z @ 0x180159B14
 * Callers:
 *     ?TraceCurrentThresholds@ShellGesturesRecognizer@@SAXXZ @ 0x180159BE0 (-TraceCurrentThresholds@ShellGesturesRecognizer@@SAXXZ.c)
 * Callees:
