/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GE_EssentialsBundle_F@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18019373C
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_GE_EssentialsBundle_F>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_GE_EssentialsBundle_F>::GetCurrentFeatureEnabledState(
      v7,
      &v17,
      &v16);
