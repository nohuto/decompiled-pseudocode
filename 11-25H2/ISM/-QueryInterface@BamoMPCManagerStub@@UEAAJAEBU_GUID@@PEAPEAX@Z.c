/*
 * XREFs of ?QueryInterface@BamoMPCManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BA300
 * Callers:
 *     ?QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BA390 (-QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
