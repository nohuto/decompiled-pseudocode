/*
 * XREFs of ?QueryInterface@BamoDockDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F170
 * Callers:
 *     ?QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F200 (-QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
