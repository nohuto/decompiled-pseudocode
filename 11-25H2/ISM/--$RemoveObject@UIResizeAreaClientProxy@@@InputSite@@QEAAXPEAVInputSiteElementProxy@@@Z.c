/*
 * XREFs of ??$RemoveObject@UIResizeAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003A2C8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IResizeAreaClientProxy>(__int64 a1, __int64 a2)
{
  __int64 v4; // r15
  __int64 *v5; // r14
  __int64 *v6; // r12
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_adc8aaff_4aab_c8d1_611e_7727c2749347, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
