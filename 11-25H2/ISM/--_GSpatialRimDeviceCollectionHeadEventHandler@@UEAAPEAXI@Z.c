/*
 * XREFs of ??_GSpatialRimDeviceCollectionHeadEventHandler@@UEAAPEAXI@Z @ 0x1800D2610
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009D588 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1SpatialRimDeviceCollectionHeadEventHandler@@UEAA@XZ @ 0x1800D2410 (--1SpatialRimDeviceCollectionHeadEventHandler@@UEAA@XZ.c)
 */
