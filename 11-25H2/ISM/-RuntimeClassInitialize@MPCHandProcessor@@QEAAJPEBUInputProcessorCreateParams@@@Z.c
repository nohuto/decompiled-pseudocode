/*
 * XREFs of ?RuntimeClassInitialize@MPCHandProcessor@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x1800C32B8
 * Callers:
 ...
 *     ?InitializeConstants@MPCHandProcessor@@AEAAXXZ @ 0x1800C22F8 (-InitializeConstants@MPCHandProcessor@@AEAAXXZ.c)
 */
        ...
        const char *a4)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    *((_QWORD *)this + 1244) = 1000 * qword_180246DE8 / 1000;
    return 0LL;
  }
  else
  {
