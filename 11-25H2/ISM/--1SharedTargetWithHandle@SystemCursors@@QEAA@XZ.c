/*
 * XREFs of ??1SharedTargetWithHandle@SystemCursors@@QEAA@XZ @ 0x1800F734C
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSharedTargetWithHandle@SystemCursors@@@std@@EEAAXXZ @ 0x1800F9A90 (-_Destroy@-$_Ref_count_obj2@VSharedTargetWithHandle@SystemCursors@@@std@@EEAAXXZ.c)
 * Callees:
