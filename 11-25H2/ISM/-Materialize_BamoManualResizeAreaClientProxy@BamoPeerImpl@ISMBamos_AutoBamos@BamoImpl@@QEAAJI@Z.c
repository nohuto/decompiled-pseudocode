/*
 * XREFs of ?Materialize_BamoManualResizeAreaClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011C760
 * Callers:
 *     ?Thunk_Materialize_BamoManualResizeAreaClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124510 (-Thunk_Materialize_BamoManualResizeAreaClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
