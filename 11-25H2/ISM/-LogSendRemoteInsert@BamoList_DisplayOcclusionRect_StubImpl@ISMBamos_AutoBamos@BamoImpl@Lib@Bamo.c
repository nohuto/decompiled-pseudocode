/*
 * XREFs of ?LogSendRemoteInsert@BamoList_DisplayOcclusionRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXIAEBUDisplayOcclusionRect@@@Z @ 0x18013B6A0
 * Callers:
