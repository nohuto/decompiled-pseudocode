/*
 * XREFs of ?LogOnScaleOverrideChanged@BamoSystemCursorControllerClientProxy@@AEAAXXZ @ 0x180117D60
 * Callers:
...
void __fastcall BamoSystemCursorControllerClientProxy::LogOnScaleOverrideChanged(
