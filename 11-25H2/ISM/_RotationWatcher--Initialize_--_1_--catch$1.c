/*
 * XREFs of _RotationWatcher::Initialize_::_1_::catch$1 @ 0x1801CF779
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RotationWatcher::Initialize_::_1_::catch_1(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
