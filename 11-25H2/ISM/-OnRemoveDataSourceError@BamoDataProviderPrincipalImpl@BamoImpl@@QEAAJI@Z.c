/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801014EC
 * Callers:
 *     ?Thunk_OnRemoveDataSourceError_5@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180103D30 (-Thunk_OnRemoveDataSourceError_5@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl.c)
 * Callees:
