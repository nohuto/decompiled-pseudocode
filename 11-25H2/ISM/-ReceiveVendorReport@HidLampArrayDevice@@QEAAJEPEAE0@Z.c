/*
 * XREFs of ?ReceiveVendorReport@HidLampArrayDevice@@QEAAJEPEAE0@Z @ 0x1800E9CC4
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  __int64 v22; // r8
  __int64 v23; // r9
  const char *v24; // [rsp+30h] [rbp-38h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+0h]
  void *v26; // [rsp+70h] [rbp+8h] BYREF
  const char *v27; // [rsp+80h] [rbp+18h] BYREF
...
LABEL_20:
    VariableSizedPayloadStorage<InputInfo>::~VariableSizedPayloadStorage<InputInfo>(&v26, v15);
    return v14;
  }
  memset_0(v12, 0, v11);
  *v13 = a2;
