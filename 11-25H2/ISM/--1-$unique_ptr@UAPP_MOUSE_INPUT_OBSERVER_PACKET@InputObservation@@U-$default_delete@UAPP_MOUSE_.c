/*
 * XREFs of ??1?$unique_ptr@UAPP_MOUSE_INPUT_OBSERVER_PACKET@InputObservation@@U?$default_delete@UAPP_MOUSE_INPUT_OBSERVER_PACKET@InputObservation@@@std@@@std@@QEAA@XZ @ 0x1800E57E4
 * Callers:
 ...
 *     _CPointerInputObserverServer_11_::OnInputGenerated_::_1_::dtor$1 @ 0x1801CFA2A (_CPointerInputObserverServer_11_--OnInputGenerated_--_1_--dtor$1.c)
 * Callees:
