/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoInputSpacePayloadStubImpl@BamoImpl@@UEAAJXZ @ 0x18008CA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSpacePayloadStubImpl::OnConnectedUnderLockThunk(
