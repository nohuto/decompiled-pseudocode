/*
 * XREFs of ?message@hresult_error@winrt@@QEBA?AUhstring@2@XZ @ 0x1800DC1C8
 * Callers:
 ...
 * Callees:
 *     FormatMessageW_0 @ 0x18009DC5D (FormatMessageW_0.c)
 *     SysStringLen_0 @ 0x18009F001 (SysStringLen_0.c)
 ...
 *     ?trim_hresult_message@impl@winrt@@YA?AUhstring@2@QEBGI@Z @ 0x1800A9840 (-trim_hresult_message@impl@winrt@@YA-AUhstring@2@QEBGI@Z.c)
