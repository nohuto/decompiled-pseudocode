/*
 * XREFs of ?Thunk_UpdateRoutingMode_16@?$IEdgyNotificationSourceClientProxy_Receive@VBamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124DA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
