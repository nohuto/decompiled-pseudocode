/*
 * XREFs of ?InitializeForCurrentProcess@SipcPrivateNamespaceAttributes@@QEAAJXZ @ 0x18010D5F8
 * Callers:
...
__int64 __fastcall SipcPrivateNamespaceAttributes::InitializeForCurrentProcess(PUCHAR pbBuffer)
{
  __int64 result; // rax
  NTSTATUS v3; // ecx
  int v4; // ecx
