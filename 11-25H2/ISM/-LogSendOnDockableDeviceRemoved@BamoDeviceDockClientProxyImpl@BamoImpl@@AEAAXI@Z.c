/*
 * XREFs of ?LogSendOnDockableDeviceRemoved@BamoDeviceDockClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180180FD8
 * Callers:
...
void __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockableDeviceRemoved(
