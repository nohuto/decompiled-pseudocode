/*
 * XREFs of ?OnMPCInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005FB50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIMPCInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005FBC8 (--$RemoveObject@UIMPCInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
