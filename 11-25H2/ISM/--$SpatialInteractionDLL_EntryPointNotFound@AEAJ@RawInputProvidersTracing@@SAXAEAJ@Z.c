/*
 * XREFs of ??$SpatialInteractionDLL_EntryPointNotFound@AEAJ@RawInputProvidersTracing@@SAXAEAJ@Z @ 0x1800D146C
 * Callers:
...
char __fastcall RawInputProvidersTracing::SpatialInteractionDLL_EntryPointNotFound<long &>(int *a1)
{
