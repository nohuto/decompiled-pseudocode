/*
 * XREFs of ??0?$unordered_map@_K_KU?$hash@_K@std@@U?$equal_to@_K@2@V?$allocator@U?$pair@$$CB_K_K@std@@@2@@std@@QEAA@XZ @ 0x1800A7EF4
 * Callers:
 ...
 *     ??0SystemCursorService2@@QEAA@PEAVSystemCursorController2@@@Z @ 0x1800F7150 (--0SystemCursorService2@@QEAA@PEAVSystemCursorController2@@@Z.c)
 * Callees:
