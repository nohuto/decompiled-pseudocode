/*
 * XREFs of ?OnIrButton@GameControllerRawInputProvider@@UEAAXI_K0W4GipIrCode@@W4GipIrStatus@@@Z @ 0x1800CB9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a6)
{
  ...
  if ( a6 == 1 )
  {
    ...
    v11 = operator new(0xBC0uLL, (const struct std::nothrow_t *)&std::nothrow);
    v14 = v11;
    if ( v11 )
    {
      ...
      *((_BYTE *)v14 + 68) = 1;
      ...
      v15 = (*(__int64 (__fastcall **)(_QWORD, __int64 (__fastcall *)(void *), _DWORD *, __int64))(**(_QWORD **)(a1 + 40)
                                                                                                 + 152LL))(
              *(_QWORD *)(a1 + 40),
      ...
      if ( v15 < 0 )
      {
        ...
        operator delete(v14, (const struct std::nothrow_t *)0xBC0);
      }
    }
    else
    {
      wil::details::in1diag3::_Log_NullAlloc(retaddr, (void *)0x1FD, v12, v13);
    }
  }
}
