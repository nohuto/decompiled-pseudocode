/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoActivatableEntityStubImpl@BamoImpl@@UEAAJXZ @ 0x180065C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivatableEntityStubImpl::InitializeProxyUnderLockThunk(
