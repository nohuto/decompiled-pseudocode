/*
 * XREFs of ?EnsureEdgeMetricsForDisplay@EdgyLegacyProcessor@@IEAAXPEBUHitTestInfo@@@Z @ 0x1801A1158
 * Callers:
...
void __fastcall EdgyLegacyProcessor::EnsureEdgeMetricsForDisplay(
        struct D2D_VECTOR_2F *this,
        const struct HitTestInfo *a2)
{
  __int64 v3; // rcx
  const char *v4; // r9
  int v5; // eax
