/*
 * XREFs of ?LogSendResizeInProgress@BamoResizeControllerClientProxyImpl@BamoImpl@@AEAAXIAEBUtagPOINT@@0@Z @ 0x180119D38
 * Callers:
...
void __fastcall BamoImpl::BamoResizeControllerClientProxyImpl::LogSendResizeInProgress(
