/*
 * XREFs of ?UpdateActivationController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180041214
 * Callers:
 *     ?Thunk_UpdateActivationController_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072C90 (-Thunk_UpdateActivationController_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
