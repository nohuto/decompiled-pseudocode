/*
 * XREFs of ?UpdateInputDeliveryServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180127F54
 * Callers:
 *     ?Thunk_UpdateInputDeliveryServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124B70 (-Thunk_UpdateInputDeliveryServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
