/*
 * XREFs of ?MPCManager_SetConvertGraspToSystemGesture_@ISMTracing@@QEAAX_NI@Z @ 0x1800B9200
 * Callers:
...
void __fastcall ISMTracing::MPCManager_SetConvertGraspToSystemGesture_(ISMTracing *this, char a2, int a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && tlgKeywordOn((__int64)v5, 1LL) )
  {
    ...
    v10 = a3;
    v9 = a2;
    tlgWriteTransfer_EventWriteTransfer(v7, byte_180206D4F, 0LL, 0LL, v8, &v11);
  }
}
