/*
 * XREFs of ?LogOnIsShellChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x18018F454
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnIsShellChanging(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
