/*
 * XREFs of ?ReceivedCursorPosCallback@Win32kInterop@InputETW@@SAXK@Z @ 0x1800F0330
 * Callers:
...
void __fastcall InputETW::Win32kInterop::ReceivedCursorPosCallback(unsigned int a1)
{
  __int64 v1; // rbx
