/*
 * XREFs of ?clear@?$_Hash@V?$_Umap_traits@KGV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKG@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x180018A70
 * Callers:
 *     ?EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z @ 0x1801BE960 (-EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z.c)
 * Callees:
