/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x1800B8A10
 * Callers:
 *     ?Thunk_ForcePrimaryInputType_5@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BB090 (-Thunk_ForcePrimaryInputType_5@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerPrincipalImpl::ForcePrimaryInputType(int *a1, unsigned int a2)
{
  int v4; // edi
  ...
  if ( a1[2] > 0 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(int *, __int64, _QWORD))(*((_QWORD *)a1 - 2) + 120LL))(a1 - 4, v6, a2);
    v4 = v9;
    if ( v9 == -2018375668 )
    {
