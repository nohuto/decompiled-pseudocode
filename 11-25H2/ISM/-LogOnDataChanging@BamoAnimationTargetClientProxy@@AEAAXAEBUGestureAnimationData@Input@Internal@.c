/*
 * XREFs of ?LogOnDataChanging@BamoAnimationTargetClientProxy@@AEAAXAEBUGestureAnimationData@Input@Internal@UI@Windows@@@Z @ 0x180143E38
 * Callers:
...
void __fastcall BamoAnimationTargetClientProxy::LogOnDataChanging(
        ...
        const struct Windows::UI::Internal::Input::GestureAnimationData *a2)
{
  ...
  __int64 v3; // r8
  __int64 v4; // r9
  const struct Windows::UI::Internal::Input::GestureAnimationData *v5; // [rsp+48h] [rbp+10h] BYREF
