/*
 * XREFs of ?Materialize_BamoInputInjectionClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011BE88
 * Callers:
 *     ?Thunk_Materialize_BamoInputInjectionClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124450 (-Thunk_Materialize_BamoInputInjectionClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v11[1] = &BamoInputInjectionClientProxy::`vftable'{for `IInputInjectionClientProxy'};
  *((_DWORD *)v11 + 6) = 0;
  v11[4] = 0LL;
  *((_DWORD *)v11 + 10) = 0;
  *((_DWORD *)v11 + 11) = 0;
  v11[2] = &BamoImpl::BamoInputInjectionClientProxyImpl::`vftable';
  v11[6] = 0LL;
  *v11 = &InputInjectionClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v11[1] = &BamoInputInjectionClientProxy::`vftable'{for `IInputInjectionClientProxy'};
  *((_BYTE *)v11 + 56) = 0;
