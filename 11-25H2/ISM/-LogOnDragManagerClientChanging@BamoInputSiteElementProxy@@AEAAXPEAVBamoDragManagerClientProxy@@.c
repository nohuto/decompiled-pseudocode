/*
 * XREFs of ?LogOnDragManagerClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoDragManagerClientProxy@@@Z @ 0x18008C948
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnDragManagerClientChanging(
        BamoInputSiteElementProxy *this,
        struct BamoDragManagerClientProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
