/*
 * XREFs of ?UpdateOcclusionRects@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800ACC00
 * Callers:
 *     ?Thunk_UpdateOcclusionRects_8@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ACBE0 (-Thunk_UpdateOcclusionRects_8@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpoi.c)
 * Callees:
