/*
 * XREFs of ?increment_reference@implements_delegate_base@impl@winrt@@QEAAIXZ @ 0x1800A9174
 * Callers:
 *     ?AddRef@?$implements_delegate@U?$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UIInspectable@Foundation@56@@Foundation@Windows@winrt@@V_lambda_60bc5d93aa36c864d5d47e476cd7d1f3_@@@impl@winrt@@UEAAIXZ @ 0x180063AF0 (-AddRef@-$implements_delegate@U-$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationMo.c)
