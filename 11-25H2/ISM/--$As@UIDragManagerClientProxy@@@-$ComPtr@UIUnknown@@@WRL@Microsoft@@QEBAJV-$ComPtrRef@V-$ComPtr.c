/*
 * XREFs of ??$As@UIDragManagerClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDragManagerClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005FDD4
 * Callers:
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_5c15ce6c_0db0_fad1_7819_fe909f528890, a2);
}
