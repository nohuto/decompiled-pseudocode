/*
 * XREFs of ?RegisterGestureDragClient@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJ_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@4567@I@Z @ 0x18004087C
 * Callers:
 *     ?Thunk_RegisterGestureDragClient_225@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141A70 (-Thunk_RegisterGestureDragClient_225@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPri.c)
 * Callees:
