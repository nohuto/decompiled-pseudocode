/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1801734A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncHRESULTPrincipalImpl::AllocateStubUnderLockThunk(
