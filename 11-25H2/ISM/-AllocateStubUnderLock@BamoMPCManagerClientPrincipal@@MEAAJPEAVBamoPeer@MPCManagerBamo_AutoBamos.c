/*
 * XREFs of ?AllocateStubUnderLock@BamoMPCManagerClientPrincipal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoMPCManagerClientStub@@@Z @ 0x180166F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCManagerClientPrincipal::AllocateStubUnderLock(
