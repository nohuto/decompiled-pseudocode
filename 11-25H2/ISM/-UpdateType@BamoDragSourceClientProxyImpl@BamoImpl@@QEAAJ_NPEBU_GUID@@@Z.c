/*
 * XREFs of ?UpdateType@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x18012B140
 * Callers:
 *     ?Thunk_UpdateType_47@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124ED0 (-Thunk_UpdateType_47@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@.c)
