/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoActivatableEntityStubImpl@BamoImpl@@UEAAJXZ @ 0x180065BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivatableEntityStubImpl::OnConnectedUnderLockThunk(
