/*
 * XREFs of ?QueryInterface@TipToGlassProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180083140
 * Callers:
 *     ?QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AAD20 (-QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
