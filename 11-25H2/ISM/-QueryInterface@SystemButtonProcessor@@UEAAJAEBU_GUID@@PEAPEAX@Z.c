/*
 * XREFs of ?QueryInterface@SystemButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180083460
 * Callers:
 *     ?QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AB780 (-QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(SystemButtonProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (SystemButtonProcessor *)(((unsigned __int64)v4 + 8) & -(__int64)(v4 != 0LL));
    goto LABEL_11;
  }
  return 2147500034LL;
}
