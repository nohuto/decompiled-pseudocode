/*
 * XREFs of ?LogOnEnabledChanging@BamoDelegatedInkCanvasInputObjectProxy@@AEAAX_N@Z @ 0x1801162E8
 * Callers:
...
void __fastcall BamoDelegatedInkCanvasInputObjectProxy::LogOnEnabledChanging(
