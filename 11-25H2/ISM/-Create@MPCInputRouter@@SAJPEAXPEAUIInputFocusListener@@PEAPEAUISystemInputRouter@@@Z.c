/*
 * XREFs of ?Create@MPCInputRouter@@SAJPEAXPEAUIInputFocusListener@@PEAPEAUISystemInputRouter@@@Z @ 0x180034474
 * Callers:
 ...
 *     WaitForDebuggerIfRegistryKeyIsSet @ 0x18009936C (WaitForDebuggerIfRegistryKeyIsSet.c)
