/*
 * XREFs of ?RuntimeClassInitialize@PTPProcessor@@QEAAJPEAUDeviceInfo@@PEAUIInputProcessorHost@@@Z @ 0x1801BE4F8
 * Callers:
 *     ??$MakeAndInitialize@VPTPProcessor@@V1@AEAPEAUDeviceInfo@@AEAPEAUIInputProcessorHost@@@Details@WRL@Microsoft@@YAJPEAPEAVPTPProcessor@@AEAPEAUDeviceInfo@@AEAPEAUIInputProcessorHost@@@Z @ 0x1801BE1D0 (--$MakeAndInitialize@VPTPProcessor@@V1@AEAPEAUDeviceInfo@@AEAPEAUIInputProcessorHost@@@Details@W.c)
 * Callees:
        ...
        struct IInputProcessorHost *a3)
{
  ...
  *((_DWORD *)a2 + 1) |= 6u;
  ...
  ChildInputProcessor = CreateChildInputProcessor(2u, v7, (__int64)this + 16);
...
LABEL_3:
  ...
  ChildInputProcessor = CreateChildInputProcessor(4u, v7, (__int64)this + 24);
  if ( ChildInputProcessor < 0 )
  {
    v5 = 60LL;
    goto LABEL_3;
