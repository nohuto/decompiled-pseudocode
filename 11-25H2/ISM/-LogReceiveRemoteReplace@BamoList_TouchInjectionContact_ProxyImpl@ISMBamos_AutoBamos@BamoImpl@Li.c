/*
 * XREFs of ?LogReceiveRemoteReplace@BamoList_TouchInjectionContact_ProxyImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXIAEBUTouchInjectionContact@Input@Internal@UI@Windows@@@Z @ 0x1801954E8
 * Callers:
