/*
 * XREFs of ??1?$_TlgActivityBase@V?$TraceLoggingThreadActivity@$1?g_hMinInputTraceLoggingProvider@@3QEBU_tlgProvider_t@@EB$0A@$04U_TlgReflectorTag_Param0IsHProvider@@@@$0A@$04@@IEAA@XZ @ 0x180075EE4
 * Callers:
 *     ??1?$TraceLoggingThreadActivity@$1?g_hMinInputTraceLoggingProvider@@3QEBU_tlgProvider_t@@EB$0A@$04U_TlgReflectorTag_Param0IsHProvider@@@@QEAA@XZ @ 0x18007FF58 (--1-$TraceLoggingThreadActivity@$1-g_hMinInputTraceLoggingProvider@@3QEBU_tlgProvider_t@@EB$0A@$.c)
        ...
        __int64 a1)
{
  ...
  if ( *(_DWORD *)a1 == 1 )
  {
    ...
    *(_DWORD *)a1 = 2;
    result = _tlgWriteActivityAutoStop<0,5>(&dword_180244248, a1 + 8);
  }
  *(_DWORD *)a1 = 3;
  return result;
}
