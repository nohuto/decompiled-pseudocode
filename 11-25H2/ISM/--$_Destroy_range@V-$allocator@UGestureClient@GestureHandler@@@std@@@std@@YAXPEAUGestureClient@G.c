/*
 * XREFs of ??$_Destroy_range@V?$allocator@UGestureClient@GestureHandler@@@std@@@std@@YAXPEAUGestureClient@GestureHandler@@QEAU12@AEAV?$allocator@UGestureClient@GestureHandler@@@0@@Z @ 0x18013F2C0
 * Callers:
 *     ??1GestureHandler@@QEAA@XZ @ 0x18013FA38 (--1GestureHandler@@QEAA@XZ.c)
 ...
 *     _std::vector_GestureHandler::GestureClient_std::allocator_GestureHandler::GestureClient___::_Emplace_reallocate_GestureHandler::GestureClient__::_1_::catch$0 @ 0x1801CFCCC (_std--vector_GestureHandler--GestureClient_std--allocator_GestureHandler--GestureClient___--_Emp.c)
 * Callees:
