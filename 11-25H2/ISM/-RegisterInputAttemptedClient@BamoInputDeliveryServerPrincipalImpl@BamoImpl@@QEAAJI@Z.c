/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015CA40
 * Callers:
 *     ?Thunk_RegisterInputAttemptedClient_8@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015CC30 (-Thunk_RegisterInputAttemptedClient_8@-$IInputDeliveryServerPrincipal_Receive@VBamoInputDelivery.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoInputAttemptedDeliveryClientProxy *v10; // rbp
  ...
  BamoImpl::BamoInputDeliveryServerPrincipalImpl::LogReceiveRegisterInputAttemptedClient(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoInputAttemptedDeliveryClientProxy *))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v6,
            v10);
    v4 = v17;
