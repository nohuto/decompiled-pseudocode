/*
 * XREFs of ?RegisterCanvas@OneCoreUAPInputHost@@UEAAJPEAX@Z @ 0x1800A3220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall OneCoreUAPInputHost::RegisterCanvas(OneCoreUAPInputHost *this, void *a2)
{
  unsigned int v2; // ebx
  ...
  if ( a2 )
  {
    ...
    DelegatedInkCanvasProcessor::s_inkCanvasContext = a2;
