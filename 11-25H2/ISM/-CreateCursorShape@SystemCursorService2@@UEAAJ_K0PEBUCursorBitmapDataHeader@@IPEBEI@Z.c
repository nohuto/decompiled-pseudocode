/*
 * XREFs of ?CreateCursorShape@SystemCursorService2@@UEAAJ_K0PEBUCursorBitmapDataHeader@@IPEBEI@Z @ 0x1800F7E10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_shared@VCursorBitmapData@SystemCursors@@$$V@std@@YA?AV?$shared_ptr@VCursorBitmapData@SystemCursors@@@0@XZ @ 0x1800F6D80 (--$make_shared@VCursorBitmapData@SystemCursors@@$$V@std@@YA-AV-$shared_ptr@VCursorBitmapData@Sys.c)
