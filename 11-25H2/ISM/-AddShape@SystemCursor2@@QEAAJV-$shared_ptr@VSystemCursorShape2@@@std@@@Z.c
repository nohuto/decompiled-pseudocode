/*
 * XREFs of ?AddShape@SystemCursor2@@QEAAJV?$shared_ptr@VSystemCursorShape2@@@std@@@Z @ 0x1800F77DC
 * Callers:
...
__int64 __fastcall SystemCursor2::AddShape(float *a1, _QWORD *a2)
{
  __int64 *v4; // rax
  __int64 v5; // rdx
  __int64 v6; // r8
  ...
  *(_QWORD *)(v6 + 32) = v7;
  ...
  InputTraceLogging::Cursor::AddShapeToCursor(a1, v17);
  if ( (*((_QWORD *)a1 + 6) == v17 || *((_QWORD *)a1 + 5) == v17)
    && (v8 = SystemCursor2::SetShape((SystemCursor2 *)a1, v17, 0), v9 = v8, v8 < 0) )
  {
