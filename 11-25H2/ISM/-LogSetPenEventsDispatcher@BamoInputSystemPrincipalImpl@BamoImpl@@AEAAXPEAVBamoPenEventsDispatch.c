/*
 * XREFs of ?LogSetPenEventsDispatcher@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoPenEventsDispatcherPrincipal@@@Z @ 0x1800918E8
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetPenEventsDispatcher(
