/*
 * XREFs of ??$make_unique@VSpeechRuntimeListener@@AEAPEAVMPCRawInputProvider@@AEAK$0A@@std@@YA?AV?$unique_ptr@VSpeechRuntimeListener@@U?$default_delete@VSpeechRuntimeListener@@@std@@@0@AEAPEAVMPCRawInputProvider@@AEAK@Z @ 0x1800CDACC
 * Callers:
