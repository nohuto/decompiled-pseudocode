/*
 * XREFs of ?QueryInterface@BamoGestureServicesProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011FF00
 * Callers:
 *     ?QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011FF90 (-QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
