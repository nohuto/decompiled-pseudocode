/*
 * XREFs of ?OnMessage@BamoEdgyControllerServerProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18011E170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoEdgyControllerServerProxyImpl::OnMessage(
