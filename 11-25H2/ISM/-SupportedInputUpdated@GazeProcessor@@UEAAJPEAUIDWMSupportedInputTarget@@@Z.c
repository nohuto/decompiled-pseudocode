/*
 * XREFs of ?SupportedInputUpdated@GazeProcessor@@UEAAJPEAUIDWMSupportedInputTarget@@@Z @ 0x1801B1650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace@AEBQEAUIDWMSupportedInputTarget@@@?$list@PEAUIDWMSupportedInputTarget@@V?$allocator@PEAUIDWMSupportedInputTarget@@@std@@@std@@QEAAPEAU?$_List_node@PEAUIDWMSupportedInputTarget@@PEAX@1@QEAU21@AEBQEAUIDWMSupportedInputTarget@@@Z @ 0x1801B09B0 (--$_Emplace@AEBQEAUIDWMSupportedInputTarget@@@-$list@PEAUIDWMSupportedInputTarget@@V-$allocator@.c)
      ...
      if ( (v15 & 0x4000) == 0 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)i + 8LL) = *((_QWORD *)i + 1);
        ...
        if ( !*((_QWORD *)this + 43) )
        {
          ...
          DWORD2(v16) = 0;
          LODWORD(v16) = 3;
          v10 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int128 *))(*(_QWORD *)v8 + 72LL))(v8, *v9, &v16);
          if ( v10 < 0 )
          {
            v11 = 386LL;
LABEL_15:
  ...
  if ( (v15 & 0x4000) != 0 )
  {
    ...
    if ( *((_QWORD *)this + 43) == 1LL )
    {
      ...
      LODWORD(v16) = 3;
      DWORD2(v16) = 1;
      v10 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int128 *))(*(_QWORD *)v12 + 72LL))(v12, *v13, &v16);
      if ( v10 < 0 )
      {
        v11 = 372LL;
        goto LABEL_15;
