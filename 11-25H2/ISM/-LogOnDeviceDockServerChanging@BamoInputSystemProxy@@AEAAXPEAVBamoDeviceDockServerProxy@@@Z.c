/*
 * XREFs of ?LogOnDeviceDockServerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoDeviceDockServerProxy@@@Z @ 0x180115D48
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnDeviceDockServerChanging(
        BamoInputSystemProxy *this,
        struct BamoDeviceDockServerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
