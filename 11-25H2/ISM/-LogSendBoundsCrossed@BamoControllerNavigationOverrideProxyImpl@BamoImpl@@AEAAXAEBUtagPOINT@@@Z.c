/*
 * XREFs of ?LogSendBoundsCrossed@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@AEAAXAEBUtagPOINT@@@Z @ 0x1801769B0
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationOverrideProxyImpl::LogSendBoundsCrossed(
