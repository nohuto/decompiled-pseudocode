        ...
        _DWORD *a3)
{
  ...
  if ( *(_BYTE *)(v12 + 25) || *v6 < *(_DWORD *)(v12 + 32) )
  {
    ...
    *((_QWORD *)&v10 + 1) = v8;
    v8[8] = *a3;
    std::list<std::pair<unsigned long const,InputInfoValidator *>>::list<std::pair<unsigned long const,InputInfoValidator *>>((_QWORD *)v8 + 5);
    *(_QWORD *)v8 = v7;
    *((_QWORD *)v8 + 1) = v7;
    *((_QWORD *)v8 + 2) = v7;
    *((_WORD *)v8 + 12) = 0;
