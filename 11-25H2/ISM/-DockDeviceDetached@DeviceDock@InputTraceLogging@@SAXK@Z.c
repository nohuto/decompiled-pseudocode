/*
 * XREFs of ?DockDeviceDetached@DeviceDock@InputTraceLogging@@SAXK@Z @ 0x1800DA3A0
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::DockDeviceDetached(int a1)
{
