/*
 * XREFs of ?LogOnTypeChanged@BamoManualDragAreaClientProxy@@AEAAXXZ @ 0x18014624C
 * Callers:
...
void __fastcall BamoManualDragAreaClientProxy::LogOnTypeChanged(BamoManualDragAreaClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
