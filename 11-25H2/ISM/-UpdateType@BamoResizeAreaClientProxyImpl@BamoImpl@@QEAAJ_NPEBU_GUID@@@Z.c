/*
 * XREFs of ?UpdateType@BamoResizeAreaClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x18012B5D0
 * Callers:
 *     ?Thunk_UpdateType_47@?$IResizeAreaClientProxy_Receive@VBamoResizeAreaClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124F10 (-Thunk_UpdateType_47@-$IResizeAreaClientProxy_Receive@VBamoResizeAreaClientProxyImpl@BamoImpl@@@.c)
