/*
 * XREFs of ?LogReceiveRegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemContextEndpointProxy@@@Z @ 0x18013B518
 * Callers:
...
void __fastcall BamoImpl::BamoSystemContextManagerPrincipalImpl::LogReceiveRegisterSystemContextEndpoint(
