/*
 * XREFs of ?ProcessInteropMessage@ShellGesturesProcessor@@SAXPEBU_MIT_PTP_INTEROP_MESSAGE@@@Z @ 0x180158118
 * Callers:
...
LABEL_23:
  ...
  while ( v12 != v13 )
  {
    v14 = *(ShellGesturesClientProxy **)(*((_QWORD *)Src + ((qword_180246F30 - 1) & (v12 >> 1))) + 8 * (v12 & 1));
