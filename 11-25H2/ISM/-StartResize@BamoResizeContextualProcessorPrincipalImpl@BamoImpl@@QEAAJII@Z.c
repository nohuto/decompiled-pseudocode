/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x18014D664
 * Callers:
 *     ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014D860 (-Thunk_StartResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcess.c)
 * Callees:
