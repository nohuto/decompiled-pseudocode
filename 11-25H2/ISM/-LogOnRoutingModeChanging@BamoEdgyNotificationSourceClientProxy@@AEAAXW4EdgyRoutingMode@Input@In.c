/*
 * XREFs of ?LogOnRoutingModeChanging@BamoEdgyNotificationSourceClientProxy@@AEAAXW4EdgyRoutingMode@Input@Internal@UI@Windows@@@Z @ 0x180117CFC
 * Callers:
