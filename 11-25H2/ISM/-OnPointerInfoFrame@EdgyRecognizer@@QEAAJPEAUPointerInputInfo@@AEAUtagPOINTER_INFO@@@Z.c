/*
 * XREFs of ?OnPointerInfoFrame@EdgyRecognizer@@QEAAJPEAUPointerInputInfo@@AEAUtagPOINTER_INFO@@@Z @ 0x180153C9C
 * Callers:
 ...
 *     ?WithinAngle@EdgyRecognizer@@AEAA_NUtagPOINT@@0UVector2@Numerics@Foundation@Windows@@M@Z @ 0x180153EB0 (-WithinAngle@EdgyRecognizer@@AEAA_NUtagPOINT@@0UVector2@Numerics@Foundation@Windows@@M@Z.c)
        ...
        struct tagPOINTER_INFO *a3)
{
  ...
  if ( !*((_QWORD *)this + 6) )
  {
    ...
    *((float *)this + 8) = v9;
    ...
    v12 = *((_QWORD *)this + 2);
    *((_DWORD *)this + 9) = v11;
    *((_QWORD *)this + 5) = (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)(v12 + 8) + 48LL))(v12 + 8);
