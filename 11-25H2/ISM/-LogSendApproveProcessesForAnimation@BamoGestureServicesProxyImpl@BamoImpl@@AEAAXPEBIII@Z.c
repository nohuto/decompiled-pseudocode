/*
 * XREFs of ?LogSendApproveProcessesForAnimation@BamoGestureServicesProxyImpl@BamoImpl@@AEAAXPEBIII@Z @ 0x180118BA0
 * Callers:
...
void __fastcall BamoImpl::BamoGestureServicesProxyImpl::LogSendApproveProcessesForAnimation(
