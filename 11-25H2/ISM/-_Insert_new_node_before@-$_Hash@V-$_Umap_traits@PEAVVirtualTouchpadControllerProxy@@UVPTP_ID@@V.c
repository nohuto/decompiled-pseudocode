        ...
        _QWORD *a4)
{
  ...
  *(_QWORD *)(a3 + 8) = a4;
  v5 = qword_180246EF8;
  v6 = 2 * (a2 & qword_180246F10);
  v7 = *(_QWORD *)(qword_180246EF8 + 16 * (a2 & qword_180246F10));
  if ( v7 == qword_180246EE8 )
  {
    *(_QWORD *)(qword_180246EF8 + 8 * v6) = a4;
LABEL_6:
    *(_QWORD *)(v5 + 8 * v6 + 8) = a4;
    return a4;
  }
  ...
  else if ( *(_QWORD **)(qword_180246EF8 + 8 * v6 + 8) == v4 )
  {
    goto LABEL_6;
  }
  return a4;
