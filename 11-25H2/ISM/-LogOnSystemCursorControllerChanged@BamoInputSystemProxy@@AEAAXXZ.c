/*
 * XREFs of ?LogOnSystemCursorControllerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x1801181B4
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnSystemCursorControllerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
