/*
 * XREFs of ?StartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x18014D4B0
 * Callers:
 *     ?Thunk_StartAnimation_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014D840 (-Thunk_StartAnimation_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProc.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  BamoImpl::BamoResizeContextualProcessorPrincipalImpl::LogReceiveStartAnimation(this, a2, v11);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v9,
      (__int64)this);
    v18 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, struct BamoResizeControllerClientProxy *))(*((_QWORD *)this - 2) + 128LL))(
            (char *)this - 16,
            v22,
            a2,
            v11);
