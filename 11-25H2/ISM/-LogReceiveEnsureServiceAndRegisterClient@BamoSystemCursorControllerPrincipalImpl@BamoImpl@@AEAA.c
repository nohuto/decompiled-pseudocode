/*
 * XREFs of ?LogReceiveEnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemCursorControllerClientProxy@@@Z @ 0x1800F5B1C
 * Callers:
...
void __fastcall BamoImpl::BamoSystemCursorControllerPrincipalImpl::LogReceiveEnsureServiceAndRegisterClient(
        BamoImpl::BamoSystemCursorControllerPrincipalImpl *this,
        struct BamoSystemCursorControllerClientProxy *a2)
{
  __int64 v2; // rbx
  int v3; // r8d
  __int64 v4; // r9
