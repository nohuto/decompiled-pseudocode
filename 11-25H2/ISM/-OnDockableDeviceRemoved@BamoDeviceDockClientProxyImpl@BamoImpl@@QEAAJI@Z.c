/*
 * XREFs of ?OnDockableDeviceRemoved@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1801818B0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::OnDockableDeviceRemoved(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockableDeviceRemoved(this);
      v11[0] = v13;
      v11[1] = v14;
