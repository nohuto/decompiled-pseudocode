/*
 * XREFs of ?UpdateUIAHitTest@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012B818
 * Callers:
 *     ?Thunk_UpdateUIAHitTest_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124F30 (-Thunk_UpdateUIAHitTest_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJP.c)
