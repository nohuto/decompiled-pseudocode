/*
 * XREFs of ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F810
 * Callers:
 *     ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F8A0 (-QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
