/*
 * XREFs of ??$_Construct_n@PEBU?$pair@G_N@std@@PEBU12@@?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@AEAAX_K$$QEAPEBU?$pair@G_N@1@1@Z @ 0x180096D60
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( a2 )
  {
    ...
    std::vector<std::pair<unsigned short,bool>>::_Buy_raw(&qword_180246FB0);
    v6 = *a4 - (_QWORD)*a3;
    v7 = qword_180246FB0;
    memmove_0(qword_180246FB0, *a3, v6);
    v9 = 0LL;
    qword_180246FB8 = (__int64)v7 + 4 * (v6 >> 2);
