/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x18008E69C
 * Callers:
  ...
  *a2 = 0LL;
  ...
  else
  {
    wil::details::in1diag3::Return_Hr(
      ...
      v8);
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6D, (unsigned int)"wil", (const char *)v6, v9);
    return v6;
  }
}
