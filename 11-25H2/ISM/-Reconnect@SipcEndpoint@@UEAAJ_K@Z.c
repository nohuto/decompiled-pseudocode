/*
 * XREFs of ?Reconnect@SipcEndpoint@@UEAAJ_K@Z @ 0x18010E020
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Create@SipcPrivateNamespace@@QEAAJXZ @ 0x18010BEF8 (-Create@SipcPrivateNamespace@@QEAAJXZ.c)
 ...
 *     ?DisableSectionEvents@SipcPort@@QEAAXXZ @ 0x18010CBC0 (-DisableSectionEvents@SipcPort@@QEAAXXZ.c)
 *     ?IncreaseSectionEventCount@SipcPort@@AEAAXI@Z @ 0x18010D5B0 (-IncreaseSectionEventCount@SipcPort@@AEAAXI@Z.c)
 *     ?PopFront@?$NtList@VSipcSection@@@@QEAAPEAVSipcSection@@XZ @ 0x18010DCB0 (-PopFront@-$NtList@VSipcSection@@@@QEAAPEAVSipcSection@@XZ.c)
 *     ?PushBack@?$NtList@VSipcSection@@@@QEAAXPEAVSipcSection@@@Z @ 0x18010DE10 (-PushBack@-$NtList@VSipcSection@@@@QEAAXPEAVSipcSection@@@Z.c)
