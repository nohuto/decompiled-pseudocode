/*
 * XREFs of ?OnTouchSessionBegin@EdgyProcessorTarget@@AEAAJAEBUTouchInfo@@@Z @ 0x1801A4730
 * Callers:
 ...
 *     ?Configure@InteractionContext@EdgyProcessorTarget@@QEAAXXZ @ 0x1801A37F0 (-Configure@InteractionContext@EdgyProcessorTarget@@QEAAXXZ.c)
