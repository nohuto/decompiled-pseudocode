/*
 * XREFs of ?QueryInterface@TouchInfoAdapter@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801BF210
 * Callers:
 *     ?QueryInterface@TouchInfoAdapter@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801BF2A0 (-QueryInterface@TouchInfoAdapter@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
