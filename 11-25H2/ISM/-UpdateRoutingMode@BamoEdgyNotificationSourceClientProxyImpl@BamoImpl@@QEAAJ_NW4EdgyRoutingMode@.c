/*
 * XREFs of ?UpdateRoutingMode@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@QEAAJ_NW4EdgyRoutingMode@Input@Internal@UI@Windows@@@Z @ 0x180129A3C
 * Callers:
 *     ?Thunk_UpdateRoutingMode_16@?$IEdgyNotificationSourceClientProxy_Receive@VBamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124DA0 (-Thunk_UpdateRoutingMode_16@-$IEdgyNotificationSourceClientProxy_Receive@VBamoEdgyNotificationSo.c)
