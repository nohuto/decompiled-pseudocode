/*
 * XREFs of ??0SpatialInputTelemetryProperties@RawInputProvidersTracing@@QEAA@QEBG@Z @ 0x1800D1CAC
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x1800D3E20 (DevicePropertyHelpers--MapCrToHResult.c)
 */
