/*
 * XREFs of ?LogSendOnMouseInputGenerated@BamoInputObserverClientProxyImpl@BamoImpl@@AEAAXAEBUAPP_MOUSE_INPUT_OBSERVER_PACKET@InputObservation@@@Z @ 0x180135EEC
 * Callers:
