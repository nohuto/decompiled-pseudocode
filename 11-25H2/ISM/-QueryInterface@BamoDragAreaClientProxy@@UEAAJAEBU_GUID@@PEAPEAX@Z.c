/*
 * XREFs of ?QueryInterface@BamoDragAreaClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011FB30
 * Callers:
 *     ?QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011FBC0 (-QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
