/*
 * XREFs of ?LogOnMagnifierControllerChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoMagnifierControllerProxy@@@Z @ 0x18008BB90
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnMagnifierControllerChanging(
        BamoInputSiteElementProxy *this,
        struct BamoMagnifierControllerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
