/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerProxyImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x180121BE0
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a3)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoInputObserverManagerProxyImpl::LogSendRegisterObserverClientOfType();
