/*
 * XREFs of ?CreateDevice@DockDeviceCollection@@MEAAJPEAX0KKPEAPEAVRIMDevice@@@Z @ 0x1800DA1F0
 * Callers:
 *     <none>
 * Callees:
 *     memset_0 @ 0x18009D3C8 (memset_0.c)
 *     ??2@YAPEAX_K@Z @ 0x18009D5CC (--2@YAPEAX_K@Z.c)
 *     ??1?$unique_ptr@VDockDevice@@U?$default_delete@VDockDevice@@@std@@@std@@QEAA@XZ @ 0x1800D9F98 (--1-$unique_ptr@VDockDevice@@U-$default_delete@VDockDevice@@@std@@@std@@QEAA@XZ.c)
 */
