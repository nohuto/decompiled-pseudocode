/*
 * XREFs of ?LogOnTouchpadEnabledChanging@BamoShellGesturesClientProxy@@AEAAX_N@Z @ 0x18015A0F0
 * Callers:
...
void __fastcall BamoShellGesturesClientProxy::LogOnTouchpadEnabledChanging(BamoShellGesturesClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
