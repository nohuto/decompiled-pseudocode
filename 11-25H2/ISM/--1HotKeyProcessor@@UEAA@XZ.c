/*
 * XREFs of ??1HotKeyProcessor@@UEAA@XZ @ 0x1801C2B50
 * Callers:
...
void __fastcall HotKeyProcessor::~HotKeyProcessor(HotKeyProcessor *this)
{
  ...
  **(_QWORD **)(v3 + 8) = 0LL;
  ...
  std::_Deallocate<16,0>(*((char **)this + 3), (const struct std::nothrow_t *)0x18);
