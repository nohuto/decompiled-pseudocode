/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIContextualProcessor@@UIShellHandwritingHostServerOwner@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800EE960
 * Callers:
 *     <none>
 * Callees:
