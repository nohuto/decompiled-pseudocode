/*
 * XREFs of ??$StateChange@AEAY07$$CBG@TestCursorTraceLogging@@SAXAEAY07$$CBG@Z @ 0x180144EDC
 * Callers:
...
int __fastcall TestCursorTraceLogging::StateChange<unsigned short const (&)[8]>(const WCHAR *a1)
{
