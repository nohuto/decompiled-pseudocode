/*
 * XREFs of ?CreateAndInitializeOutputBuffer@HidLampRangeUpdateReportParser@@QEAAJPEBULampRangeUpdateDeviceReport@@AEAV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@PEAI@Z @ 0x180064DE0
 * Callers:
 ...
 *     ?ValidateReportData@HidLampRangeUpdateReportParser@@AEAAJPEBULampRangeUpdateDeviceReport@@@Z @ 0x1800ED96C (-ValidateReportData@HidLampRangeUpdateReportParser@@AEAAJPEBULampRangeUpdateDeviceReport@@@Z.c)
 */
        ...
        _DWORD *a4)
{
  ...
  int v23[2]; // [rsp+20h] [rbp-28h] BYREF
...
LABEL_24:
    wil::details::in1diag3::Return_Hr(
      ...
      (const char *)v15,
      v23[0]);
    VariableSizedPayloadStorage<InputInfo>::~VariableSizedPayloadStorage<InputInfo>((void **)v23, v20);
    return v13;
  }
