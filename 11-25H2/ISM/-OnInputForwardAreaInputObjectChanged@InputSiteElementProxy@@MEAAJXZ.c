/*
 * XREFs of ?OnInputForwardAreaInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005EAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIInputForwardAreaInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005EB48 (--$RemoveObject@UIInputForwardAreaInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@.c)
