/*
 * XREFs of ?RegisterShellHandwritingHostClient@ShellHandwritingHostServer@@UEAAJPEAVBamoShellHandwritingHostServerStub@@PEAVBamoShellHandwritingHostClientProxy@@@Z @ 0x18015AFE0
 * Callers:
 *     <none>
 * Callees:
