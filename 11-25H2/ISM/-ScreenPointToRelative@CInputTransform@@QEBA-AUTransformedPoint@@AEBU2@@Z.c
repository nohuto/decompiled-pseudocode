/*
 * XREFs of ?ScreenPointToRelative@CInputTransform@@QEBA?AUTransformedPoint@@AEBU2@@Z @ 0x180085870
 * Callers:
 ...
 *     ?ScreenRectToRelative@CInputTransform@@QEAA?AUTransformedRect@@AEBU2@@Z @ 0x180134334 (-ScreenRectToRelative@CInputTransform@@QEAA-AUTransformedRect@@AEBU2@@Z.c)
 * Callees:
 *     <none>
 */
