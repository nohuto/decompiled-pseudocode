/*
 * XREFs of ?LogOnSupportedFeedbackChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x180117F80
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnSupportedFeedbackChanged(BamoSimpleHapticsControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
