/*
 * XREFs of ?GetRunState@BamoEdgyControllerClientProxy@@UEAAIXZ @ 0x1801544F0
 * Callers:
 *     ?OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x180154C20 (-OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
