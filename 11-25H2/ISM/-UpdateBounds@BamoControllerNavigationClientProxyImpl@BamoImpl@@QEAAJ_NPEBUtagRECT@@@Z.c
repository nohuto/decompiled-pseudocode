/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x180176EB4
 * Callers:
 *     ?Thunk_UpdateBounds_57@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180176DC0 (-Thunk_UpdateBounds_57@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClien.c)
