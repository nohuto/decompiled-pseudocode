/*
 * XREFs of ?NotifyProxyDisposed@DWMInputRouter@@UEAAJII@Z @ 0x180197C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::NotifyProxyDisposed(DWMInputRouter *this, int a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v3 + 16) == a2 && *(_DWORD *)(v3 + 20) == a3 )
      v3 = DWMInputRouter::RemoveTarget((__int64)this - 40, (__int64)&v9, v3);
  }
  i = *((_QWORD *)this + 67);
LABEL_7:
  for ( i = *(_QWORD *)i;
              ...
              i) )
  {
    if ( *(_DWORD *)(i + 16) != a2 || *(_DWORD *)(i + 20) != a3 )
      goto LABEL_7;
    Microsoft::WRL::ComPtr<Windows::Foundation::Collections::IVector<HSTRING__ *>>::InternalRelease((__int64 *)(i + 56));
  }
  return 0LL;
}
