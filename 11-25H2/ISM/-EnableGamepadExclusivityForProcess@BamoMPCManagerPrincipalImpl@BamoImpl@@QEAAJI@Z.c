/*
 * XREFs of ?EnableGamepadExclusivityForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800B8920
 * Callers:
 *     ?Thunk_EnableGamepadExclusivityForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BB080 (-Thunk_EnableGamepadExclusivityForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
