/*
 * XREFs of ??$_Free_non_head@V?$allocator@U?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@@std@@@?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@std@@@1@PEAU01@@Z @ 0x180092EE8
 * Callers:
 *     CallOnThreadExit::_dynamic_atexit_destructor_for__s_callbacks__ @ 0x1801D25F0 (CallOnThreadExit--_dynamic_atexit_destructor_for__s_callbacks__.c)
 * Callees:
