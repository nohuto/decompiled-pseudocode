/*
 * XREFs of ?Create@EdgyProcessorTarget@@SAJPEAVEdgyLegacyProcessor@@AEBUEdgyPointerInfo@@UtagMsgRoutingInfo@@PEAXPEAPEAV1@@Z @ 0x1801A3B04
 * Callers:
 ...
 *     ??0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z @ 0x1801A360C (--0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z.c)
