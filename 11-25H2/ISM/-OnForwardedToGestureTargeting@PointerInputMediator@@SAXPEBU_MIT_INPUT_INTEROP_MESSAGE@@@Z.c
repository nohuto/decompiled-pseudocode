/*
 * XREFs of ?OnForwardedToGestureTargeting@PointerInputMediator@@SAXPEBU_MIT_INPUT_INTEROP_MESSAGE@@@Z @ 0x18003054C
 * Callers:
...
void __fastcall PointerInputMediator::OnForwardedToGestureTargeting(const struct _MIT_INPUT_INTEROP_MESSAGE *a1)
{
  ...
  if ( v9 != qword_180246E80 + qword_180246E78 )
  {
    v2 = v8;
    if ( v8 )
      v2 = (_QWORD *)*v8;
