/*
 * XREFs of ??1?$function@$$A6AXW4RegistryChangeKind@wil@@@Z@wistd@@QEAA@XZ @ 0x18009F4D0
 * Callers:
 ...
 *     ??1?$wnf_subscription_state@Uempty_wnf_state@details@wil@@@details@wil@@UEAA@XZ @ 0x180109644 (--1-$wnf_subscription_state@Uempty_wnf_state@details@wil@@@details@wil@@UEAA@XZ.c)
 ...
 *     _wil::details_abi::RawUsageIndex::Iterate_::_1_::dtor$0 @ 0x1801CCC53 (_wil--details_abi--RawUsageIndex--Iterate_--_1_--dtor$0.c)
 *     _MPCHeadUpdateListener::Initialize_::_1_::dtor$0 @ 0x1801CE0DF (_MPCHeadUpdateListener--Initialize_--_1_--dtor$0.c)
 *     _RotationWatcher::RotationWatcher_::_1_::dtor$3 @ 0x1801CF755 (_RotationWatcher--RotationWatcher_--_1_--dtor$3.c)
 * Callees:
