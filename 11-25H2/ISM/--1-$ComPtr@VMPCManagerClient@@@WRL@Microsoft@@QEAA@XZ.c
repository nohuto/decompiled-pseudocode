/*
 * XREFs of ??1?$ComPtr@VMPCManagerClient@@@WRL@Microsoft@@QEAA@XZ @ 0x18016039C
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_MPCManagerClient_Windows::Internal::Input::MPCManager::IMPCManagerClient__::_1_::dtor$2 @ 0x1801D07A6 (_Microsoft--WRL--Details--MakeAndInitialize_MPCManagerClient_Windows--Internal--Input--MPCManage.c)
 * Callees:
