/*
 * XREFs of ?QueryInterface@VirtualTouchpadControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133E30
 * Callers:
 *     ?QueryInterface@VirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133F10 (-QueryInterface@VirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@VirtualTouchpadControllerProxy@@WIA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133F20 (-QueryInterface@VirtualTouchpadControllerProxy@@WIA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@VirtualTouchpadControllerProxy@@WII@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133F40 (-QueryInterface@VirtualTouchpadControllerProxy@@WII@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
