/*
 * XREFs of ?GetPoints@MPCSixDofProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801B4410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSixDofProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&v21 = v6;
  ...
  v41 = v18;
  v42 = v19;
  return std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v21);
}
