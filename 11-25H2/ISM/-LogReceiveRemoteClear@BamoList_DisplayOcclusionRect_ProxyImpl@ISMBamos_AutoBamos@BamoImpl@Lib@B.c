/*
 * XREFs of ?LogReceiveRemoteClear@BamoList_DisplayOcclusionRect_ProxyImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXXZ @ 0x180137F34
 * Callers:
