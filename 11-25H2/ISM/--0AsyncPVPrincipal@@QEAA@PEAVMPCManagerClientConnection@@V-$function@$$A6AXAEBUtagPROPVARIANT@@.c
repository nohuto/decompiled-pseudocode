/*
 * XREFs of ??0AsyncPVPrincipal@@QEAA@PEAVMPCManagerClientConnection@@V?$function@$$A6AXAEBUtagPROPVARIANT@@@Z@std@@V?$function@$$A6AXJ@Z@3@@Z @ 0x180172230
 * Callers:
 ...
 *     ??0?$function@$$A6AXJ@Z@std@@QEAA@AEBV01@@Z @ 0x1801721F0 (--0-$function@$$A6AXJ@Z@std@@QEAA@AEBV01@@Z.c)
