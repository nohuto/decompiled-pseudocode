/*
 * XREFs of ?OnInputReport@GazeProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801B1200
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ConvertDisplayRelativeMicrometersToScreen@GazeProcessor@@IEAAJUtagPOINT@@PEAU2@1@Z @ 0x1801B0CF0 (-ConvertDisplayRelativeMicrometersToScreen@GazeProcessor@@IEAAJUtagPOINT@@PEAU2@1@Z.c)
...
__int64 __fastcall GazeProcessor::OnInputReport(GazeProcessor *this, struct InputInfo *a2)
{
  ...
  _DWORD v19[11]; // [rsp+50h] [rbp-9h] BYREF
  struct tagPOINT v20; // [rsp+7Ch] [rbp+23h]
  char v21; // [rsp+89h] [rbp+30h]
...
LABEL_18:
    ...
    else
    {
      ...
      {
        *((_DWORD *)a2 + 10) = 2;
        v5 = (*(__int64 (__fastcall **)(_QWORD, struct InputInfo *))(**((_QWORD **)this + 38) + 24LL))(
               *((_QWORD *)this + 38),
               a2);
        if ( v5 < 0 )
        {
