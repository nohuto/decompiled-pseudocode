/*
 * XREFs of ?LogOnEdgyControllerServerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoEdgyControllerServerProxy@@@Z @ 0x1801160C0
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnEdgyControllerServerChanging(
        BamoInputSystemProxy *this,
        struct BamoEdgyControllerServerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
