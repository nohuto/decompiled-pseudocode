/*
 * XREFs of ?LogOnTypeChanging@BamoWindowsMessageDeliveryProxy@@AEAAXW4WindowsMessageDeliveryType@Input@Internal@UI@Windows@@@Z @ 0x180135D1C
 * Callers:
