/*
 * XREFs of ?QueryInterface@BamoTestCommandsStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019AFB0
 * Callers:
 *     ?QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019B040 (-QueryInterface@BamoTestCommandsStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
