/*
 * XREFs of ?ProcessCursorData@MPCHolographicInputManager@@AEAAXPEAUIMPCInputProviderBase@@AEBUHitTestResult3D@@W4MPCCursorId@@AEAUCursor3DHitData@@@Z @ 0x180013E84
 * Callers:
  ...
  *(_BYTE *)(a5 + 160) = v10;
  ...
  if ( v14 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v27);
  _Mtx_unlock(v13);
  v15 = (__m128)*(unsigned int *)(a3 + 52);
  v16 = (__m128)*(unsigned int *)(a3 + 56);
  v17 = *(_DWORD *)(a3 + 60);
  v29 = 0LL;
  v30 = 0;
  ...
  {
    v15 = (__m128)(unsigned int)v29;
    v16 = (__m128)HIDWORD(v29);
    v17 = v30;
  }
  *(_QWORD *)(a1 + 240) = _mm_unpacklo_ps(v15, v16).m128_u64[0];
  *(_DWORD *)(a1 + 248) = v17;
