/*
 * XREFs of ??$_Try_emplace@AEBI$$V@?$map@IV?$function@$$A6AX_N@Z@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@PEAX@std@@_N@1@AEBI@Z @ 0x180032D94
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  if ( *((_BYTE *)v6 + 25) || *a3 < *((_DWORD *)v6 + 8) )
  {
    ...
    *(_QWORD *)(v9 + 8) = 0LL;
    if ( v14 )
    {
      std::_Func_class<void,_MIT_KEYBOARD_INPUT_MESSAGE const *>::_Tidy((__int64)(v14 + 40), v10);
      if ( v14 )
