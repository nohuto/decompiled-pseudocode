/*
 * XREFs of ?LogSendOnAugmentedInputEvent@BamoMPCInputObjectProxyImpl@BamoImpl@@AEAAXAEBUMPCTraceInfo@@W4InputEventType@Internal@Spatial@Input@UI@Windows@@AEBUAugmentedInputDataMsg@56789@_JAEBUHitObjectMsg@56789@@Z @ 0x180119224
 * Callers:
        ...
        __int64 a5)
{
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    v22 = v5 + 3;
    v19 = v5 + 3;
    tlgWriteTransfer_EventWriteTransfer(v8, byte_18020C094, 0LL, 0LL, 7u, &v17);
  }
}
