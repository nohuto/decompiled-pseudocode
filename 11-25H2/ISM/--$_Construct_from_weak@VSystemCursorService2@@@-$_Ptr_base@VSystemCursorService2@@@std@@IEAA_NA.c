/*
 * XREFs of ??$_Construct_from_weak@VSystemCursorService2@@@?$_Ptr_base@VSystemCursorService2@@@std@@IEAA_NAEBV?$weak_ptr@VSystemCursorService2@@@1@@Z @ 0x180058514
 * Callers:
 ...
 * Callees:
 *     ?_Incref_nz@_Ref_count_base@std@@QEAA_NXZ @ 0x180058D38 (-_Incref_nz@_Ref_count_base@std@@QEAA_NXZ.c)
 */
