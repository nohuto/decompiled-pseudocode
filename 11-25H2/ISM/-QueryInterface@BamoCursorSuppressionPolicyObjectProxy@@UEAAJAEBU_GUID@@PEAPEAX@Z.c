/*
 * XREFs of ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F770
 * Callers:
 *     ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F800 (-QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
