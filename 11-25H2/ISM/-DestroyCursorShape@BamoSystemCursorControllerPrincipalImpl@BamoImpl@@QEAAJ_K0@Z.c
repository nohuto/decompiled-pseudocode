/*
 * XREFs of ?DestroyCursorShape@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800F50C0
 * Callers:
 *     ?Thunk_DestroyCursorShape_404@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6470 (-Thunk_DestroyCursorShape_404@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorContro.c)
 * Callees:
