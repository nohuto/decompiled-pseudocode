/*
 * XREFs of ?ServerDestroyed@VirtualTouchpad@InputTraceLogging@@SAXPEBX@Z @ 0x1801346CC
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerDestroyed(const void *a1)
{
