/*
 * XREFs of ?OnInputSinkDataChanged@ShellGesturesClientProxy@@MEAAJXZ @ 0x18002DCF0
 * Callers:
 ...
 *     IsGetRoutingInfoForWindowHandlePresent @ 0x18009EC58 (IsGetRoutingInfoForWindowHandlePresent.c)
 */
