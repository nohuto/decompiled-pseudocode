/*
 * XREFs of ?PopulateTargetingData@MPCHandProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1800C2920
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a3 + 20) = v5;
  if ( *((_BYTE *)a3 + 996) && *((_BYTE *)a3 + 997) )
  {
    ...
    *(_DWORD *)(v12 + 9920) = (_DWORD)v11;
    ...
    v27 = -1082130432;
    v29 = v13;
    Windows::Foundation::Numerics::transform(v28, (float *)&v26, (float *)&v29);
    v14 = *((_OWORD *)a3 + 138);
    v30 = *((_OWORD *)a3 + 137);
    v15 = *((_OWORD *)a3 + 139);
    v31 = v14;
