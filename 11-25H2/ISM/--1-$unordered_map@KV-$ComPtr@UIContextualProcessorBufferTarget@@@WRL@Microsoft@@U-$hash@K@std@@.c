/*
 * XREFs of ??1?$unordered_map@KV?$ComPtr@UIContextualProcessorBufferTarget@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@UIContextualProcessorBufferTarget@@@WRL@Microsoft@@@std@@@5@@std@@QEAA@XZ @ 0x1800EE5C8
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$10 @ 0x1801CC350 (_Win32kInterop--Win32kInterop_--_1_--dtor$10.c)
 * Callees:
 *     <none>
 */
