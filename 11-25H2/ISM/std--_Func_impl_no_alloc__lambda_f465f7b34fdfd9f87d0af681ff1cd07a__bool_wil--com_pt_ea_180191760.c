/*
 * XREFs of std::_Func_impl_no_alloc__lambda_f465f7b34fdfd9f87d0af681ff1cd07a__bool_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy__bool_::_Do_call @ 0x180191760
 * Callers:
 *     <none>
 * Callees:
