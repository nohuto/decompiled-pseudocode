/*
 * XREFs of ?StartOperation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJI_N_K1IW4GestureProcessorType@@@Z @ 0x1801416F0
 * Callers:
 *     ?Thunk_StartOperation_198@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141B10 (-Thunk_StartOperation_198@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@.c)
 * Callees:
        ...
        int a7)
{
  ...
  __int64 v11; // r8
  Microsoft::BamoImpl::BaseBamoPeerImpl *v12; // rsi
