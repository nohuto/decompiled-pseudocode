/*
 * XREFs of ?Add@FlickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1801AC560
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x1801AC794 (-CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z.c)
