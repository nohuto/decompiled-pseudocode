/*
 * XREFs of ??$EnumerateStubs@P6AJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGUtagPROPVARIANT@@3@ZW42@PEBGU3@U3@@BamoPrincipalImpl@BamoImpl@Microsoft@@QEAAJP6AJPEAVBamoStubImpl@12@P6AJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGUtagPROPVARIANT@@4@Z2344@Z_N52344@Z @ 0x1800B4D88
 * Callers:
        ...
        __int128 *a8)
{
  ...
  for ( i = *(_QWORD *)(a1 + 32); i; i = *(_QWORD *)(i + 40) )
  {
    if ( *(_BYTE *)(i + 56) )
    {
      ...
      *(_OWORD *)v18 = v11;
      v19 = v12;
      v13 = a2(i, StubCallback, a5, a6, v18, &v16);
      v14 = v13;
      if ( v13 < 0 )
      {
