/*
 * XREFs of ?LogSendActivationRequested@BamoActivationWatcherStubImpl@BamoImpl@@AEAAXII@Z @ 0x1800B196C
 * Callers:
...
void __fastcall BamoImpl::BamoActivationWatcherStubImpl::LogSendActivationRequested(
