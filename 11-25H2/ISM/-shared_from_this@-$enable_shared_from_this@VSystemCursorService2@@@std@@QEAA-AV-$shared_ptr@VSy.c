/*
 * XREFs of ?shared_from_this@?$enable_shared_from_this@VSystemCursorService2@@@std@@QEAA?AV?$shared_ptr@VSystemCursorService2@@@2@XZ @ 0x1800908B4
 * Callers:
 ...
 *     ?_Throw_bad_weak_ptr@std@@YAXXZ @ 0x1800908EC (-_Throw_bad_weak_ptr@std@@YAXXZ.c)
 */
