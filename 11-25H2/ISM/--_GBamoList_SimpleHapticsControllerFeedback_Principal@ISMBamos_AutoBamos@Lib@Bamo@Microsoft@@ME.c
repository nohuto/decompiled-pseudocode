/*
 * XREFs of ??_GBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAPEAXI@Z @ 0x1800ABD40
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int32 **__fastcall Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Principal::`scalar deleting destructor'(
