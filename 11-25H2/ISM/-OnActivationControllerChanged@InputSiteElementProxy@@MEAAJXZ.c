/*
 * XREFs of ?OnActivationControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180057240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800572B4 (--$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IActivationControllerProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 48LL))((char *)this + 8);
