/*
 * XREFs of ?LogOnResizeContextualProcessorChanging@BamoInputSystemProxy@@AEAAXPEAVBamoResizeContextualProcessorProxy@@@Z @ 0x180117C3C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnResizeContextualProcessorChanging(
        BamoInputSystemProxy *this,
        struct BamoResizeContextualProcessorProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
