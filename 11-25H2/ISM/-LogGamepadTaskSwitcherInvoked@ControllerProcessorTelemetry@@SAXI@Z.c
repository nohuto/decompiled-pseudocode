/*
 * XREFs of ?LogGamepadTaskSwitcherInvoked@ControllerProcessorTelemetry@@SAXI@Z @ 0x18017C948
 * Callers:
...
void __fastcall ControllerProcessorTelemetry::LogGamepadTaskSwitcherInvoked(int a1)
{
