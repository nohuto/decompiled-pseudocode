/*
 * XREFs of ?UpdateDeviceType@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NW4DockableDeviceObjectType@@@Z @ 0x18012620C
 * Callers:
 *     ?Thunk_UpdateDeviceType_16@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801248E0 (-Thunk_UpdateDeviceType_16@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@.c)
...
__int64 __fastcall BamoImpl::BamoDockableDeviceProxyImpl::UpdateDeviceType(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v3 = a3;
  v4 = a2;
  v6 = (BamoDockableDeviceProxy *)(a1 - 16);
  if ( *(_BYTE *)(a1 + 28) )
  {
    BamoDockableDeviceProxy::LogOnDeviceTypeChanging();
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL),
      ...
      1);
    v7 = (*(__int64 (__fastcall **)(BamoDockableDeviceProxy *, _QWORD))(*(_QWORD *)v6 + 136LL))(v6, v3);
    if ( v7 < 0 )
  ...
  *(_DWORD *)(a1 + 56) = v3;
  if ( *(_BYTE *)(a1 + 28) )
  {
    BamoDockableDeviceProxy::LogOnDeviceTypeChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))a1,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoDockableDeviceProxy *))(*(_QWORD *)v6 + 144LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0xB1EC,
