/*
 * XREFs of ?LogOnPeerDisconnected@BamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@AEAAXPEAVBamoPeer@2@@Z @ 0x18008F31C
 * Callers:
...
void __fastcall BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::LogOnPeerDisconnected(
