/*
 * XREFs of ?QueryInterface@InjectionRawInputProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DF940
 * Callers:
 *     ?QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DF9F0 (-QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
