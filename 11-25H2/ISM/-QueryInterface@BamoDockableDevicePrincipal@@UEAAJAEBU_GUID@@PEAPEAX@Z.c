/*
 * XREFs of ?QueryInterface@BamoDockableDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F210
 * Callers:
 *     ?QueryInterface@BamoDockableDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F2A0 (-QueryInterface@BamoDockableDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
