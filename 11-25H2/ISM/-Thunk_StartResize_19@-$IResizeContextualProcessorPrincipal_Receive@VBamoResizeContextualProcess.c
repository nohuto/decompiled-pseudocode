/*
 * XREFs of ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014D860
 * Callers:
 *     <none>
 * Callees:
 *     <none>
