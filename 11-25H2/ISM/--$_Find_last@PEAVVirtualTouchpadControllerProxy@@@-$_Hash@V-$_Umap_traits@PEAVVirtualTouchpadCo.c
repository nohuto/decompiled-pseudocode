        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_180246EF8 + 16 * (a4 & qword_180246F10) + 8);
  if ( v4 == (_QWORD *)qword_180246EE8 )
  {
    *a2 = qword_180246EE8;
LABEL_3:
    a2[1] = 0LL;
  ...
  else
  {
    while ( *a3 != v4[2] )
    {
      if ( v4 == *(_QWORD **)(qword_180246EF8 + 16 * (a4 & qword_180246F10)) )
      {
        *a2 = v4;
        goto LABEL_3;
      }
