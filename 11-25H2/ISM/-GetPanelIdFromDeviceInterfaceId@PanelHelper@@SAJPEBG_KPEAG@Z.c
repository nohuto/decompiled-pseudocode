/*
 * XREFs of ?GetPanelIdFromDeviceInterfaceId@PanelHelper@@SAJPEBG_KPEAG@Z @ 0x180107F6C
 * Callers:
...
__int64 __fastcall PanelHelper::GetPanelIdFromDeviceInterfaceId(const unsigned __int16 *a1, __int64 a2, char *a3)
{
  ...
  if ( dword_180247E18 > *(_DWORD *)(v5 + 32) )
  {
    Init_thread_header(&dword_180247E18);
    if ( dword_180247E18 == -1 )
    {
      dword_1802478EC = 0;
      qword_1802478F0 = 0LL;
      *(DEVPROPKEY *)&byte_1802478D8 = DEVPKEY_Device_InstanceId;
      Init_thread_footer(&dword_180247E18);
    }
  }
  LODWORD(v20) = 0;
  ...
  if ( ObjectProperties >= 0 )
  {
    ...
    if ( dword_180247E1C > *(_DWORD *)(v5 + 32) )
    {
      Init_thread_header(&dword_180247E1C);
      if ( dword_180247E1C == -1 )
      {
        dword_1802478CC = 0;
        qword_1802478D0 = 0LL;
        *(_OWORD *)&xmmword_1802478B8 = DEVPKEY_Device_PanelId;
        dword_1802478C8 = 2;
        Init_thread_footer(&dword_180247E1C);
      }
    }
    v21 = 0;
