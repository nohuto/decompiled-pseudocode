/*
 * XREFs of ?LogOnPanelIdChanged@BamoDockDeviceProxy@@AEAAXXZ @ 0x1801176F4
 * Callers:
...
void __fastcall BamoDockDeviceProxy::LogOnPanelIdChanged(BamoDockDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
