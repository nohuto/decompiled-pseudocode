/*
 * XREFs of ??1?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1801C2ACC
 * Callers:
 *     _HotKeyProcessor::FindRegisteredHotKey_::_1_::dtor$1 @ 0x1801D2228 (_HotKeyProcessor--FindRegisteredHotKey_--_1_--dtor$1.c)
 *     _HotKeyProcessor::RegisterHotKey_::_1_::dtor$1 @ 0x1801D225E (_HotKeyProcessor--RegisterHotKey_--_1_--dtor$1.c)
 * Callees:
