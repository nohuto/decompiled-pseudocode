/*
 * XREFs of ?QueryInterface@BamoSystemContextManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801209A0
 * Callers:
 *     ?QueryInterface@BamoSystemContextManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180120A30 (-QueryInterface@BamoSystemContextManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
