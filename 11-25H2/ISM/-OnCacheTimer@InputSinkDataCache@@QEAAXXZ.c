/*
 * XREFs of ?OnCacheTimer@InputSinkDataCache@@QEAAXXZ @ 0x18005D828
 * Callers:
 *     ?Initialize@OneCoreUAPInputHost@@IEAAJPEAX@Z @ 0x18005C55C (-Initialize@OneCoreUAPInputHost@@IEAAJPEAX@Z.c)
 *     ?OnCacheTimerStatic@InputSinkDataCache@@SAJPEAX@Z @ 0x18005D810 (-OnCacheTimerStatic@InputSinkDataCache@@SAJPEAX@Z.c)
 * Callees:
