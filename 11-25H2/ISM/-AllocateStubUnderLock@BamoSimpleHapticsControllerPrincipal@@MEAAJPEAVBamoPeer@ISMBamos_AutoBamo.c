/*
 * XREFs of ?AllocateStubUnderLock@BamoSimpleHapticsControllerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSimpleHapticsControllerStub@@@Z @ 0x18018BFD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoSimpleHapticsControllerPrincipal::AllocateStubUnderLock(
