/*
 * XREFs of ?LogOnLightDismissClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoLightDismissClientProxy@@@Z @ 0x18008B1B0
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnLightDismissClientChanging(
        BamoInputSiteElementProxy *this,
        struct BamoLightDismissClientProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
