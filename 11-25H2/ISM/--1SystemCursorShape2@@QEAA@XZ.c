/*
 * XREFs of ??1SystemCursorShape2@@QEAA@XZ @ 0x1800F7458
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSystemCursorShape2@@@std@@EEAAXXZ @ 0x1800F9AB0 (-_Destroy@-$_Ref_count_obj2@VSystemCursorShape2@@@std@@EEAAXXZ.c)
 * Callees:
