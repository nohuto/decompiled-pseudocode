/*
 * XREFs of ??1?$unique_ptr@VGestureTracker@@U?$default_delete@VGestureTracker@@@std@@@std@@QEAA@XZ @ 0x180156F84
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAUHINTERACTIONCONTEXT__@@P6AJPEAU1@@Z$1?DestroyInteractionContext@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x180156FB8 (--1-$unique_storage@U-$resource_policy@PEAUHINTERACTIONCONTEXT__@@P6AJPEAU1@@Z$1-DestroyInteract.c)
 */
