/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180187130
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::PushStateToProxyOnOutboundMessagesResumed(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v9);
  BamoImpl::BamoHapticDeviceManagerPrincipalImpl::UpdatePenDevicesRemoteCache(this, a3);
  Microsoft::BamoImpl::BamoPrincipalImpl::GetItemId(this);
  v10 = *(unsigned int *)(v3 + 36);
  v11 = *(unsigned int *)(v3 + 40);
  LOWORD(v9) = 88;
