/*
 * XREFs of ?AllocateStubUnderLock@BamoAsyncResult_string_Principal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncResult_string_Stub@@@Z @ 0x180172C00
 * Callers:
 *     <none>
 * Callees:
