/*
 * XREFs of ?GetPoints@MPCMouseProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801BAB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCMouseProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *((_QWORD *)&v16 + 1) = v5 | 0x200000000LL;
  ...
  v25 = 0;
  v32 = v14;
  return std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v16);
}
