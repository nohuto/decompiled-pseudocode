/*
 * XREFs of ?UpdateType@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x180146B9C
 * Callers:
 *     ?Thunk_UpdateType_47@?$IManualDragAreaClientProxy_Receive@VBamoManualDragAreaClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180146A20 (-Thunk_UpdateType_47@-$IManualDragAreaClientProxy_Receive@VBamoManualDragAreaClientProxyImpl@Bam.c)
