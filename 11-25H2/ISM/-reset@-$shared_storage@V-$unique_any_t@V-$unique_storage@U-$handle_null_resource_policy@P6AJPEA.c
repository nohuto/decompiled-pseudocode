/*
 * XREFs of ?reset@?$shared_storage@V?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@details@wil@@QEAAXPEAX@Z @ 0x180095558
 * Callers:
 ...
 *     ?OnDisconnected@ShellGesturesClientProxy@@MEAAJXZ @ 0x1800825C0 (-OnDisconnected@ShellGesturesClientProxy@@MEAAJXZ.c)
 * Callees:
