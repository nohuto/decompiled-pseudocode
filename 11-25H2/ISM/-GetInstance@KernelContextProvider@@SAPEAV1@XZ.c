/*
 * XREFs of ?GetInstance@KernelContextProvider@@SAPEAV1@XZ @ 0x18000CDE4
 * Callers:
...
struct KernelContextProvider *KernelContextProvider::GetInstance(void)
{
  ...
  v1 = 32LL;
  if ( dword_180247E38 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 32LL) )
  {
    Init_thread_header(&dword_180247E38);
    if ( dword_180247E38 == -1 )
    {
      atexit(KernelContextProvider::GetInstance_::_2_::_dynamic_atexit_destructor_for__s_instance__);
      Init_thread_footer(&dword_180247E38);
    }
  }
  v6 = 0;
