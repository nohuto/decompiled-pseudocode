/*
 * XREFs of ?OnInput@InputForwardProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801A00F0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a4 + 2) = 4;
  ...
  if ( *((_DWORD *)a2 + 79) )
  {
    ...
    do
    {
      ...
      v9 = v18;
      v19 = v18;
      v10 = std::_Uhash_compare<IInputTarget *,std::hash<IInputTarget *>,std::equal_to<IInputTarget *>>::operator()<IInputTarget *>(
              (__int64)this,
              (__int64)&v19);
      ...
      if ( this != *((InputForwardProcessor **)v6 + 5) )
      {
        ...
        v11 = std::_Hash<std::_Umap_traits<unsigned long,Microsoft::WRL::ComPtr<IInputTarget>,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,Microsoft::WRL::ComPtr<IInputTarget>>>,0>>::_Try_emplace<unsigned long const &,>(
                ...
                (__int64)v16,
                &v18);
        Microsoft::WRL::ComPtr<IMPCFocusTarget>::operator=((__int64 *)(*(_QWORD *)v11 + 24LL), &v19);
