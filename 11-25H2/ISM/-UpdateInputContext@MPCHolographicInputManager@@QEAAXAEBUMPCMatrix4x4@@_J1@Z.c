/*
 * XREFs of ?UpdateInputContext@MPCHolographicInputManager@@QEAAXAEBUMPCMatrix4x4@@_J1@Z @ 0x1800BDA78
 * Callers:
 *     ?UpdateInputContext@SpatialRimDeviceCollection@@UEAAJAEAUMPCMatrix4x4@@_J1@Z @ 0x1800D6450 (-UpdateInputContext@SpatialRimDeviceCollection@@UEAAJAEAUMPCMatrix4x4@@_J1@Z.c)
 * Callees:
 ...
 *     ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x1800BDF2C (-invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z.c)
 */
        ...
        __int64 a3)
{
  ...
  *(_DWORD *)(v9 + 164) = -1082130432;
  v10 = Windows::Foundation::Numerics::transform(v16, (float *)(v9 + 144), v7);
  *(_QWORD *)(v11 + 168) = *(_QWORD *)v10;
  *(float *)(v11 + 176) = v10[2];
  v14 = Windows::Foundation::Numerics::transform_normal(v16, v13, v12);
