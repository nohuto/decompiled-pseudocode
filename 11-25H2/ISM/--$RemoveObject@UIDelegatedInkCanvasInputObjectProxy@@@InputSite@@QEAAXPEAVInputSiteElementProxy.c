/*
 * XREFs of ??$RemoveObject@UIDelegatedInkCanvasInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003C388
 * Callers:
...
void __fastcall InputSite::RemoveObject<IDelegatedInkCanvasInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_f3c15157_1e3a_b150_6025_65bc9f45acb5, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
