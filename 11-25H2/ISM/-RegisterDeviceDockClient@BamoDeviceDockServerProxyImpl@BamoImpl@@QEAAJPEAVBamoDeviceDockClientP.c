/*
 * XREFs of ?RegisterDeviceDockClient@BamoDeviceDockServerProxyImpl@BamoImpl@@QEAAJPEAVBamoDeviceDockClientPrincipal@@W4DockWatcherRoutingPolicy@Input@Internal@UI@Windows@@@Z @ 0x180120EE0
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a2)
{
  ...
  Microsoft::BamoImpl::BufferingMessageCallHost *v10; // rcx
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 31) )
      {
        v10 = (struct IMessageCallSendHost *)((char *)v11[0] - 16);
        if ( !v11[0] )
          v10 = 0LL;
        *((_BYTE *)v10 + 72) = 1;
