/*
 * XREFs of ?UpdateEventSubscriptions@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180126BCC
 * Callers:
 *     ?Thunk_UpdateEventSubscriptions_8@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801249C0 (-Thunk_UpdateEventSubscriptions_8@-$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@Ba.c)
