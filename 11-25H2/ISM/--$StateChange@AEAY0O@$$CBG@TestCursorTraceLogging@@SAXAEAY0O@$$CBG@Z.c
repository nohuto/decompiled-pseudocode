/*
 * XREFs of ??$StateChange@AEAY0O@$$CBG@TestCursorTraceLogging@@SAXAEAY0O@$$CBG@Z @ 0x180144FA8
 * Callers:
...
int __fastcall TestCursorTraceLogging::StateChange<unsigned short const (&)[14]>(const WCHAR *a1)
{
