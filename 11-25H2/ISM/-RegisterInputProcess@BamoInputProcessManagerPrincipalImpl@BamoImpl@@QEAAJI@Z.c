/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180193FF0
 * Callers:
 *     ?Thunk_RegisterInputProcess_8@?$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180194A70 (-Thunk_RegisterInputProcess_8@-$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPr.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoInputProcessProxy *v10; // rbp
  ...
  BamoImpl::BamoInputProcessManagerPrincipalImpl::LogReceiveRegisterInputProcess(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoInputProcessProxy *))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v6,
            v10);
    v4 = v17;
