/*
 * XREFs of ?AllocateStubUnderLock@BamoDockableDevicePrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoDockableDeviceStub@@@Z @ 0x18017D7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDockableDevicePrincipal::AllocateStubUnderLock(
