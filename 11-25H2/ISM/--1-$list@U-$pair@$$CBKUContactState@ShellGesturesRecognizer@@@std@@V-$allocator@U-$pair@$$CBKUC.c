/*
 * XREFs of ??1?$list@U?$pair@$$CBKUContactState@ShellGesturesRecognizer@@@std@@V?$allocator@U?$pair@$$CBKUContactState@ShellGesturesRecognizer@@@std@@@2@@std@@QEAA@XZ @ 0x18009B760
 * Callers:
 *     _ShellGesturesRecognizer::ShellGesturesRecognizer_::_1_::dtor$3 @ 0x1801CB323 (_ShellGesturesRecognizer--ShellGesturesRecognizer_--_1_--dtor$3.c)
 * Callees:
