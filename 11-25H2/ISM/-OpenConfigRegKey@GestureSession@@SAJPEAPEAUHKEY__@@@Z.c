/*
 * XREFs of ?OpenConfigRegKey@GestureSession@@SAJPEAPEAUHKEY__@@@Z @ 0x1801ABCA4
 * Callers:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x1801AE844 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 * Callees:
 *     memset_0 @ 0x18009D3C8 (memset_0.c)
 *     __security_check_cookie @ 0x18009D480 (__security_check_cookie.c)
 *     ?RefreshScreenSize@GestureSession@@SAJXZ @ 0x1801AC08C (-RefreshScreenSize@GestureSession@@SAJXZ.c)
 */
