/*
 * XREFs of ?QueryInterface@BamoResizeControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801207C0
 * Callers:
 *     ?QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180120850 (-QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
