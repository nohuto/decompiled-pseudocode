/*
 * XREFs of ?Materialize_BamoLightDismissClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002D4AC
 * Callers:
 *     ?Thunk_Materialize_BamoLightDismissClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801244D0 (-Thunk_Materialize_BamoLightDismissClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
...
__int64 __fastcall BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::Materialize_BamoLightDismissClientProxy(
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v12 = 0LL;
  v5 = (unsigned int)a2;
  BamoImpl::CreateLightDismissClientProxy(
