/*
 * XREFs of ?UpdateInputProcessManager@BamoInputSystemInternalProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801282EC
 * Callers:
 *     ?Thunk_UpdateInputProcessManager_8@?$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124BB0 (-Thunk_UpdateInputProcessManager_8@-$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalP.c)
