/*
 * XREFs of ?QueryInterface@KeyboardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006A850
 * Callers:
 *     ?QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801919C0 (-QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
