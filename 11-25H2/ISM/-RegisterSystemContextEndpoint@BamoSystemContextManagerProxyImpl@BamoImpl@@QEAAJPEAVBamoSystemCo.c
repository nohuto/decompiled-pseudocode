/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoSystemContextEndpointPrincipal@@@Z @ 0x180122130
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoSystemContextManagerProxyImpl::LogSendRegisterSystemContextEndpoint(this);
      v12[0] = v14;
      v12[1] = v15;
