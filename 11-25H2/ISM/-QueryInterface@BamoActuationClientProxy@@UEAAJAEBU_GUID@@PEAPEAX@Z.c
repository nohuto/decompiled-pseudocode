/*
 * XREFs of ?QueryInterface@BamoActuationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F4E0
 * Callers:
 *     ?QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F570 (-QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
