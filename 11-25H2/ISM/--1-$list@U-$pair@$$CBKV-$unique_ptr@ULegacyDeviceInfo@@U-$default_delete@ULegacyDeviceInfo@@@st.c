/*
 * XREFs of ??1?$list@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@V?$allocator@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800DED58
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$30 @ 0x1801CC3E6 (_Win32kInterop--Win32kInterop_--_1_--dtor$30.c)
 *     _InjectionRawInputProvider::InjectionRawInputProvider_::_1_::dtor$6 @ 0x1801CE9B9 (_InjectionRawInputProvider--InjectionRawInputProvider_--_1_--dtor$6.c)
 * Callees:
