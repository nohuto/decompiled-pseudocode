/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAUregistry_watcher_state@details@wil@@P6AXPEAU123@@Z$1?delete_registry_watcher_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18009B090
 * Callers:
 *     _lambda_2ab80ba63dcc212dafbb4e4695138308_::operator() @ 0x1801B3E54 (_lambda_2ab80ba63dcc212dafbb4e4695138308_--operator().c)
 *     _dynamic_atexit_destructor_for__MPCSixDofProcessor::s_registryWatcher__ @ 0x1801D27A0 (_dynamic_atexit_destructor_for__MPCSixDofProcessor--s_registryWatcher__.c)
 * Callees:
