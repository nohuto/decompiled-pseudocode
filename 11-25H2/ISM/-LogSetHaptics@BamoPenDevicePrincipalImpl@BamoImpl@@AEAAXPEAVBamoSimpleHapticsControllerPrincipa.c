/*
 * XREFs of ?LogSetHaptics@BamoPenDevicePrincipalImpl@BamoImpl@@AEAAXPEAVBamoSimpleHapticsControllerPrincipal@@@Z @ 0x180189298
 * Callers:
...
void __fastcall BamoImpl::BamoPenDevicePrincipalImpl::LogSetHaptics(
