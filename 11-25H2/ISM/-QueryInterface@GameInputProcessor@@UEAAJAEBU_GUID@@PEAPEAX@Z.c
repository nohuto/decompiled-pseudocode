/*
 * XREFs of ?QueryInterface@GameInputProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069840
 * Callers:
 *     ?Initialize@DWMInputRouter@@IEAAJXZ @ 0x180034634 (-Initialize@DWMInputRouter@@IEAAJXZ.c)
 *     ?QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A5520 (-QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
        ...
        GameInputProcessor **a3)
{
  ...
  if ( !v3 )
  {
    v6 = (GameInputProcessor *)(((unsigned __int64)this + 8) & ((unsigned __int128)-(__int128)(unsigned __int64)this >> 64));
    goto LABEL_12;
  }
