/*
 * XREFs of ?QueryInterface@BamoShellHandwritingHostServerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015ADD0
 * Callers:
 *     ?QueryInterface@BamoShellHandwritingHostServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015AE60 (-QueryInterface@BamoShellHandwritingHostServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
