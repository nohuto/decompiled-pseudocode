/*
 * XREFs of ?Make@PointerMetadata@@YAXPEAUInputInfo@@AEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@@Z @ 0x18019C4A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PointerMetadata::Make(__int64 a1, _QWORD *a2)
{
  __int64 i; // rdi
