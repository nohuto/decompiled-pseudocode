/*
 * XREFs of ?FreePrincipalItem@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAXI@Z @ 0x180071C94
 * Callers:
 ...
 *     ?RemoveItemIdFromConversation@BaseBamoConnectionImpl@BamoImpl@Microsoft@@AEAAXI@Z @ 0x180071DE0 (-RemoveItemIdFromConversation@BaseBamoConnectionImpl@BamoImpl@Microsoft@@AEAAXI@Z.c)
...
void __fastcall Microsoft::BamoImpl::BaseBamoConnectionImpl::FreePrincipalItem(const void **this, unsigned int a2)
{
  ...
  else
  {
    try
    {
      ...
      if ( v5 == this[26] )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>(this + 24, v5, &v9, (__int64)v4);
      }
      else
      {
        *(_DWORD *)v5 = a2;
