/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_GlobalTouchGesturesTelemetry@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180157AF0
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800A5C20 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@QEAAX_NW4Repor.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_GlobalTouchGesturesTelemetry>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        int *a4)
{
  ...
  *(_DWORD *)a2 = v9;
  ...
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestConfNum>::ReportUsage(
