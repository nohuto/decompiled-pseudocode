/*
 * XREFs of ?OnSessionStatusNotification@InputProviderManager@@QEAAJII@Z @ 0x180061578
 * Callers:
 *     ?OnSessionStatusNotification@OneCoreUAPInputHost@@UEAAJII@Z @ 0x1800A3030 (-OnSessionStatusNotification@OneCoreUAPInputHost@@UEAAJII@Z.c)
 * Callees:
