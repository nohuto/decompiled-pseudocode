/*
 * XREFs of ?TailButtonClicked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180190890
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonClicked(this);
      v11[0] = v13;
      v11[1] = v14;
