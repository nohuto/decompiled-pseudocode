/*
 * XREFs of ?OnDeviceInput@GameControllerRawInputProvider@@UEAAXI_K0MW4GameInputKind@@PEBUGameInputRoutedInputBuffer@@PEBUGameInputGamepadState@@PEBUGameInputUiNavigationState@@@Z @ 0x180086420
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a9)
{
  ...
  *(_BYTE *)(v10 + 80) = (a6 & 0x10F0000) == 0x1000000;
  if ( !(unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_RestrictHIDGamepadDelegation>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_RestrictHIDGamepadDelegation>::GetImpl'::`2'::impl)
