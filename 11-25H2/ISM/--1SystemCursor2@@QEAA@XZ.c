/*
 * XREFs of ??1SystemCursor2@@QEAA@XZ @ 0x1800F7374
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ @ 0x1800F9AA0 (-_Destroy@-$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ.c)
 * Callees:
