/*
 * XREFs of ?CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z @ 0x1800D29A8
 * Callers:
 ...
 *     ?CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z @ 0x1800D29A8 (-CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z.c)
 *     ?try_get_parent_path_range@wil@@YA_NPEBGPEA_K@Z @ 0x1800D6640 (-try_get_parent_path_range@wil@@YA_NPEBGPEA_K@Z.c)
 */
