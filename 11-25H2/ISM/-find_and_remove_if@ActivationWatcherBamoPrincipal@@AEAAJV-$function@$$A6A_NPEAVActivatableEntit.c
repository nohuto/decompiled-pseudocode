/*
 * XREFs of ?find_and_remove_if@ActivationWatcherBamoPrincipal@@AEAAJV?$function@$$A6A_NPEAVActivatableEntityBamoPrincipal@@@Z@std@@@Z @ 0x180022EB4
 * Callers:
...
__int64 __fastcall ActivationWatcherBamoPrincipal::find_and_remove_if(__int64 a1, __int64 *a2)
{
  ...
  v18 = a2;
  v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 + 8) + 32LL))(a1 + 8);
