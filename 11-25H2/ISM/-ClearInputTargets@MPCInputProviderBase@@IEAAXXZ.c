/*
 * XREFs of ?ClearInputTargets@MPCInputProviderBase@@IEAAXXZ @ 0x1800C6E08
 * Callers:
 ...
 *     ?Uninitialize3DComponents@MPCInputProviderBase@@UEAAXXZ @ 0x1800C8080 (-Uninitialize3DComponents@MPCInputProviderBase@@UEAAXXZ.c)
