/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoSystemContextManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18013B2E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextManagerStubImpl::InitializeProxyUnderLockThunk(
