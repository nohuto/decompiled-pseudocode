/*
 * XREFs of ?LogSetThreadId@BamoActivatableEntityPrincipalImpl@BamoImpl@@AEAAXI@Z @ 0x180094560
 * Callers:
...
void __fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::LogSetThreadId(
