/*
 * XREFs of ?RegisterGestureDragClient@BamoGestureServicesProxy@@UEAAJ_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@3456@PEAVBamoDragManagerClientPrincipal@@@Z @ 0x180121240
 * Callers:
 *     <none>
 * Callees:
