/*
 * XREFs of ?Materialize_BamoAsyncHRESULTProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B93E4
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncHRESULTProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BB0D0 (-Thunk_Materialize_BamoAsyncHRESULTProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPe.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v11 = &BamoAsyncHRESULTProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v11[1] = &BamoAsyncHRESULTProxy::`vftable'{for `IAsyncHRESULTProxy'};
  *((_DWORD *)v11 + 6) = 0;
  v11[4] = 0LL;
  *((_DWORD *)v11 + 10) = 0;
  *((_DWORD *)v11 + 11) = 0;
  v11[2] = &BamoImpl::BamoAsyncHRESULTProxyImpl::`vftable';
