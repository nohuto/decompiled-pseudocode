/*
 * XREFs of ?UpdateUseInputSiteCoordinateSpace@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801567A8
 * Callers:
 *     ?Thunk_UpdateUseInputSiteCoordinateSpace_11@?$IMagnifierControllerProxy_Receive@VBamoMagnifierControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180156360 (-Thunk_UpdateUseInputSiteCoordinateSpace_11@-$IMagnifierControllerProxy_Receive@VBamoMagnifierCo.c)
