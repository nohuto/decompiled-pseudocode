/*
 * XREFs of ?ParseInputBufferForReport@HidLampAttributesResponseReportParser@@QEAAJPEBEIPEAULampAttributesResponseDeviceReport@@@Z @ 0x180085CF0
 * Callers:
 ...
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z @ 0x18009AECC (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z.c)
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800EDF38 (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z.c)
 */
