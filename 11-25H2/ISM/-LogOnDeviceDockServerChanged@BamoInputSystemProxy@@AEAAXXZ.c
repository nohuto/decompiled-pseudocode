/*
 * XREFs of ?LogOnDeviceDockServerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180115CF8
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnDeviceDockServerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
