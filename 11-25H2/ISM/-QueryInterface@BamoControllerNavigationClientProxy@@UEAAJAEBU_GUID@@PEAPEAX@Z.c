/*
 * XREFs of ?QueryInterface@BamoControllerNavigationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180176C80
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180176D10 (-QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
