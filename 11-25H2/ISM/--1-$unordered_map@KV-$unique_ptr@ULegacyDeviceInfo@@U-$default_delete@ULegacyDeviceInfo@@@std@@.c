/*
 * XREFs of ??1?$unordered_map@KV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@U?$hash@K@2@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800DEDDC
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$4 @ 0x1801CC2BD (_Win32kInterop--Win32kInterop_--_1_--dtor$4.c)
 *     _InjectionRawInputProvider::InjectionRawInputProvider_::_1_::dtor$3 @ 0x1801CE9A3 (_InjectionRawInputProvider--InjectionRawInputProvider_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
