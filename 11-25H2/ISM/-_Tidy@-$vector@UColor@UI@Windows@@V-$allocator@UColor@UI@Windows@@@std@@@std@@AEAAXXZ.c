/*
 * XREFs of ?_Tidy@?$vector@UColor@UI@Windows@@V?$allocator@UColor@UI@Windows@@@std@@@std@@AEAAXXZ @ 0x180015AA8
 * Callers:
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x180084EE4 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@QEAXV-$vector@IV-$allocator@I@std.c)
 ...
 *     ?_Destroy@?$_Ref_count_obj2@VCursorBitmapData@SystemCursors@@@std@@EEAAXXZ @ 0x1800F9A80 (-_Destroy@-$_Ref_count_obj2@VCursorBitmapData@SystemCursors@@@std@@EEAAXXZ.c)
 *     ?Update3DFocusWNF@MPCInputRouter@@AEAAXXZ @ 0x1800FCE0C (-Update3DFocusWNF@MPCInputRouter@@AEAAXXZ.c)
 *     ??1?$ListPrincipalCommon@VBamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@I@Bamo@Microsoft@@UEAA@XZ @ 0x1800FEBB4 (--1-$ListPrincipalCommon@VBamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@VBa.c)
 ...
 *     ??1ButtonRecognizer@@MEAA@XZ @ 0x18019E500 (--1ButtonRecognizer@@MEAA@XZ.c)
 *     ??1ComboButtonRegistration@@QEAA@XZ @ 0x18019E5B4 (--1ComboButtonRegistration@@QEAA@XZ.c)
