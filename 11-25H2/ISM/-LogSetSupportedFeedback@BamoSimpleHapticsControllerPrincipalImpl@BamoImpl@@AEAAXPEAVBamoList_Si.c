/*
 * XREFs of ?LogSetSupportedFeedback@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x18008D984
 * Callers:
 *     ?SetSupportedFeedback@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAXPEAVBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x18008D8EC (-SetSupportedFeedback@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAXPEAVBamoList_Simpl.c)
 * Callees:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetSupportedFeedback(
