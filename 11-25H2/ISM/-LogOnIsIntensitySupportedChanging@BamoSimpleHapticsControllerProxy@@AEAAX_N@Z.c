/*
 * XREFs of ?LogOnIsIntensitySupportedChanging@BamoSimpleHapticsControllerProxy@@AEAAX_N@Z @ 0x1801173C4
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsIntensitySupportedChanging(
