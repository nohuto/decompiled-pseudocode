/*
 * XREFs of ?StopProcess@BamoInputProcessPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1800CA6B4
 * Callers:
 *     ?Thunk_StopProcess_14@?$IInputProcessPrincipal_Receive@VBamoInputProcessPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800CA800 (-Thunk_StopProcess_14@-$IInputProcessPrincipal_Receive@VBamoInputProcessPrincipalImpl@BamoImpl@@.c)
 * Callees:
