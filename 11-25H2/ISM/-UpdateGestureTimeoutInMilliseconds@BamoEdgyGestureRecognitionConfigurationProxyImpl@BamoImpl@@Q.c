/*
 * XREFs of ?UpdateGestureTimeoutInMilliseconds@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012743C
 * Callers:
 *     ?Thunk_UpdateGestureTimeoutInMilliseconds_8@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124A70 (-Thunk_UpdateGestureTimeoutInMilliseconds_8@-$IEdgyGestureRecognitionConfigurationProxy_Receive@.c)
