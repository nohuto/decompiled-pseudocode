/*
 * XREFs of ?UpdateInputSiteManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801284B4
 * Callers:
 *     ?Thunk_UpdateInputSiteManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124BD0 (-Thunk_UpdateInputSiteManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
