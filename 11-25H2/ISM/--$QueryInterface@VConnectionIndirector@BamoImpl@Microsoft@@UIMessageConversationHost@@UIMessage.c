/*
 * XREFs of ??$QueryInterface@VConnectionIndirector@BamoImpl@Microsoft@@UIMessageConversationHost@@UIMessageConversationBouncer@@@Util@BamoImpl@Microsoft@@YAJPEAVConnectionIndirector@12@AEBU_GUID@@PEAPEAX@Z @ 0x18007E848
 * Callers:
 *     ?QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009BF90 (-QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
