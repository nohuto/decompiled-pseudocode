/*
 * XREFs of ??_GHotKeyInfo@@QEAAPEAXI@Z @ 0x1801C31AC
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ @ 0x1801C5870 (-_Destroy@-$_Ref_count_obj2@UHotKeyInfo@@@std@@EEAAXXZ.c)
 * Callees:
...
HotKeyInfo *__fastcall HotKeyInfo::`scalar deleting destructor'(HotKeyInfo *this)
{
  ...
  **(_QWORD **)(v1 + 8) = 0LL;
  ...
  std::_Deallocate<16,0>(*((char **)this + 5), (const struct std::nothrow_t *)0x20);
  return this;
}
