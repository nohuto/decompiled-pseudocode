/*
 * XREFs of ?UpdateTipToGlassEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18009817C
 * Callers:
 *     ?Thunk_UpdateTipToGlassEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180090700 (-Thunk_UpdateTipToGlassEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientPro.c)
