/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18013A0D0
 * Callers:
 *     <none>
 * Callees:
