        ...
        __int64 *a3)
{
  ...
  try
  {
    ...
    std::_Uninitialized_move<wil::com_ptr_t<PenHapticInterface,wil::err_exception_policy> *,std::allocator<wil::com_ptr_t<PenHapticInterface,wil::err_exception_policy>>>(
      ...
      v15,
      v16);
    std::vector<wil::com_ptr_t<PenHapticInterface,wil::err_exception_policy>>::_Change_array(a1, v13, v8, v7, v20);
    result = v14;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<wil::com_ptr_t<PenHapticInterface,wil::err_exception_policy>>>(v22, v14 + 1);
