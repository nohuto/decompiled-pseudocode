/*
 * XREFs of ?UpdateIsShell@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180191064
 * Callers:
 *     ?Thunk_UpdateIsShell_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180190D00 (-Thunk_UpdateIsShell_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@.c)
