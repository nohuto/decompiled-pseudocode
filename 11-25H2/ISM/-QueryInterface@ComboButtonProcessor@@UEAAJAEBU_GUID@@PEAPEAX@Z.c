/*
 * XREFs of ?QueryInterface@ComboButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019D810
 * Callers:
 *     ?QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019D8D0 (-QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
