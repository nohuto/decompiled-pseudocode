/*
 * XREFs of ?UnsubscribeProcessWideUsageFlush@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x1800A20C8
 * Callers:
  ...
  if ( this )
  {
    if ( qword_180244708 )
      wil::details_abi::SubscriptionList::Unsubscribe(
        (struct _RTL_CRITICAL_SECTION *)qword_180244708 + 5,
        (RTL_SRWLOCK *)qword_180244708,
        this);
  }
}
