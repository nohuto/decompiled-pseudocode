/*
 * XREFs of ?MicrosoftInternalNotifyFailure@details@wil@@YAXPEAUFailureInfo@2@@Z @ 0x18007A340
 * Callers:
 *     <none>
 * Callees:
 *     ?wil_details_GetKernelBaseProcAddress@@YAP6A_JXZPEBD@Z @ 0x18009A718 (-wil_details_GetKernelBaseProcAddress@@YAP6A_JXZPEBD@Z.c)
