/*
 * XREFs of ?UpdateControlPoints@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@I@Z @ 0x180125A2C
 * Callers:
 *     ?Thunk_UpdateControlPoints_156@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124850 (-Thunk_UpdateControlPoints_156@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@B.c)
