/*
 * XREFs of ??1PerfRegion@InputTraceLogging@@QEAA@XZ @ 0x180019F70
 * Callers:
 ...
 *     _Win32kInterop::s_DeviceNotificationsCallback_::_1_::dtor$1 @ 0x1801C801C (_Win32kInterop--s_DeviceNotificationsCallback_--_1_--dtor$1.c)
 *     _ContextualProcessorManager::OnFocusRequest_::_1_::dtor$0 @ 0x1801C8A2A (_ContextualProcessorManager--OnFocusRequest_--_1_--dtor$0.c)
 *     _ContextualProcessorManager::OnFocusRequest_::_1_::dtor$5 @ 0x1801C8A4E (_ContextualProcessorManager--OnFocusRequest_--_1_--dtor$5.c)
 *     _HitTestHelper::HitTestRequestWithRetry_::_1_::dtor$0 @ 0x1801C8C90 (_HitTestHelper--HitTestRequestWithRetry_--_1_--dtor$0.c)
 *     _ContextualProcessorManager::OnHitTest_::_1_::dtor$0 @ 0x1801C8D30 (_ContextualProcessorManager--OnHitTest_--_1_--dtor$0.c)
 *     _ContextualProcessorManager::OnHitTest_::_1_::dtor$7 @ 0x1801C8D70 (_ContextualProcessorManager--OnHitTest_--_1_--dtor$7.c)
 *     _KernelInputConnection__MIT_POINTER_INPUT_DOWN_MESSAGE_::s_OnKernelInputEventStatic_::_1_::dtor$0 @ 0x1801CB1D0 (_KernelInputConnection__MIT_POINTER_INPUT_DOWN_MESSAGE_--s_OnKernelInputEventStatic_--_1_--dtor$.c)
 * Callees:
