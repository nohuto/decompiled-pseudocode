/*
 * XREFs of ?OnAttachableInputObjectSampleChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18003C4F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003C564 (--$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@.c)
