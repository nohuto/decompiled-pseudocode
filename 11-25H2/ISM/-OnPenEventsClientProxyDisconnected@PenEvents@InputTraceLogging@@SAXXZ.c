/*
 * XREFs of ?OnPenEventsClientProxyDisconnected@PenEvents@InputTraceLogging@@SAXXZ @ 0x180080338
 * Callers:
...
void InputTraceLogging::PenEvents::OnPenEventsClientProxyDisconnected(void)
{
