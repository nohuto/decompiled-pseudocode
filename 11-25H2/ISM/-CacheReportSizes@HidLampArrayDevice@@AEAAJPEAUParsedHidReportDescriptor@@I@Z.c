/*
 * XREFs of ?CacheReportSizes@HidLampArrayDevice@@AEAAJPEAUParsedHidReportDescriptor@@I@Z @ 0x1800E8590
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *((_QWORD *)this + 79) = v8;
  ...
  if ( v12 )
  {
    memset_0(v12, 0, 8LL * *((unsigned int *)this + 160));
    if ( a3 )
    {
      v14 = (_DWORD *)((char *)a2 + 8);
      do
      {
        *(_BYTE *)(v11 + *((_QWORD *)this + 79)) = *((_BYTE *)v14 - 4);
        v11 += 8LL;
        v15 = *v14;
        v14 += 6;
        *(_DWORD *)(v11 + *((_QWORD *)this + 79) - 4) = (unsigned int)(*(_DWORD *)(*((_QWORD *)v14 - 2)
                                                                                 + 72LL * (unsigned int)(v15 - 1)
                                                                                 + 4)
                                                                     + *(_DWORD *)(*((_QWORD *)v14 - 2)
                                                                                 + 72LL * (unsigned int)(v15 - 1))
                                                                     + 7) >> 3;
