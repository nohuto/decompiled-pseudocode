/*
 * XREFs of ?LogSendEdgyRecognized@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@AEAAXAEBUPoint@Foundation@Windows@@@Z @ 0x180119140
 * Callers:
...
void __fastcall BamoImpl::BamoEdgyNotificationSourceClientProxyImpl::LogSendEdgyRecognized(
