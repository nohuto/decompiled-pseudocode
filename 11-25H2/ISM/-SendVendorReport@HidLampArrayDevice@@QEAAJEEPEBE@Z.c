/*
 * XREFs of ?SendVendorReport@HidLampArrayDevice@@QEAAJEEPEBE@Z @ 0x1800EA0D4
 * Callers:
        ...
        const unsigned __int8 *a4)
{
  ...
  const char *v25; // [rsp+38h] [rbp-30h] BYREF
...
LABEL_21:
  ...
  *v14 = a2;
  ...
  VariableSizedPayloadStorage<InputInfo>::~VariableSizedPayloadStorage<InputInfo>(&v27, v18);
  return 0LL;
}
