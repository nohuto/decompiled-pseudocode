/*
 * XREFs of ?OnMessage@BamoShellHandwritingHostServerProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18011EB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoShellHandwritingHostServerProxyImpl::OnMessage(
