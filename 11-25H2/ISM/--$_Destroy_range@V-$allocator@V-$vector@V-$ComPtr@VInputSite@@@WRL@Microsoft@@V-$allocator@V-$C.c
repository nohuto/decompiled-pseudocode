 ...
 *     _std::vector_std::vector_Microsoft::WRL::ComPtr_InputSite__std::allocator_Microsoft::WRL::ComPtr_InputSite______std::allocator_std::vector_Microsoft::WRL::ComPtr_InputSite__std::allocator_Microsoft::WRL::ComPtr_InputSite_________::_Emplace_reallocate_std::vector_Microsoft::WRL::ComPtr_InputSite__std::allocator_Microsoft::WRL::ComPtr_InputSite________::_1_::catch$1 @ 0x1801C8E70 (_std--vector_std--vector_Microsoft--WRL--ComPtr_InputSite__std--allocator_Microsoft--WRL--ComPtr.c)
 * Callees:
