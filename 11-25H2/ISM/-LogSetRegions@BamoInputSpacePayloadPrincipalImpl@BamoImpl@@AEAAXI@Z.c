/*
 * XREFs of ?LogSetRegions@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@AEAAXI@Z @ 0x18013BA5C
 * Callers:
...
void __fastcall BamoImpl::BamoInputSpacePayloadPrincipalImpl::LogSetRegions(
