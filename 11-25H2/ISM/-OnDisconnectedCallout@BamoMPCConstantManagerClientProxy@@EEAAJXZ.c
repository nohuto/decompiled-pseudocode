/*
 * XREFs of ?OnDisconnectedCallout@BamoMPCConstantManagerClientProxy@@EEAAJXZ @ 0x180100FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCConstantManagerClientProxy::OnDisconnectedCallout(BamoMPCConstantManagerClientProxy *this)
{
  BamoMPCConstantManagerClientProxy *v1; // rbx
  ...
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoMPCConstantManagerClientProxy *))(*(_QWORD *)v1 + 40LL))(v1);
