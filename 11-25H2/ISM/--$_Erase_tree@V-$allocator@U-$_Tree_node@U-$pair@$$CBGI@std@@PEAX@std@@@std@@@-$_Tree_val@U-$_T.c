/*
 * XREFs of ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBGI@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@@Z @ 0x180093CF8
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__c_handedModifierMapping__ @ 0x1801D2620 (_dynamic_atexit_destructor_for__c_handedModifierMapping__.c)
 * Callees:
