/*
 * XREFs of ??$RemoveObject@UIWindowsMessageDeliveryProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180056F18
 * Callers:
...
void __fastcall InputSite::RemoveObject<IWindowsMessageDeliveryProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_d3573f80_52a7_d2c9_ece4_38e96aede26c, &v14) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
