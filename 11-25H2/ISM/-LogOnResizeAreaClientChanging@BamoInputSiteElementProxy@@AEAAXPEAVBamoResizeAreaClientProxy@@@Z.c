/*
 * XREFs of ?LogOnResizeAreaClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoResizeAreaClientProxy@@@Z @ 0x18008BA40
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnResizeAreaClientChanging(
        BamoInputSiteElementProxy *this,
        struct BamoResizeAreaClientProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
