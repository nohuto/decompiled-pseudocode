/*
 * XREFs of ?OnCUIComponentInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005F050
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UICUIComponentInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005F0C4 (--$RemoveObject@UICUIComponentInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
