/*
 * XREFs of ?StartAnimation@BamoGestureServicesProxyImpl@BamoImpl@@QEAAJIPEBQEAVBamoAnimationTargetClientPrincipal@@IPEAVBamoDragManagerClientPrincipal@@W4GestureProcessorType@@@Z @ 0x180123A20
 * Callers:
...
{
  __int64 v6; // r12
  Microsoft::BamoImpl::BufferingMessageCallHost *v9; // rbx
  __int64 v10; // r10
  ...
  else
  {
    ...
    if ( v18 >= 0 )
    {
      ...
      {
        if ( v25[0] )
          v9 = (struct IMessageCallSendHost *)((char *)v25[0] - 16);
        *((_BYTE *)v9 + 72) = 1;
