/*
 * XREFs of ?LogSendRemoteReplace@BamoList_VirtualTouchpadRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXIAEBUVirtualTouchpadRect@@@Z @ 0x18013B968
 * Callers:
