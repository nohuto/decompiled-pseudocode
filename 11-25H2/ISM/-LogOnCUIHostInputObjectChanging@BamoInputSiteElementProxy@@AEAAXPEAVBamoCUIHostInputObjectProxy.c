/*
 * XREFs of ?LogOnCUIHostInputObjectChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoCUIHostInputObjectProxy@@@Z @ 0x18008E550
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnCUIHostInputObjectChanging(
        BamoInputSiteElementProxy *this,
        struct BamoCUIHostInputObjectProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
