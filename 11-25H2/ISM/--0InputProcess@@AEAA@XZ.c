/*
 * XREFs of ??0InputProcess@@AEAA@XZ @ 0x1800C9A10
 * Callers:
 ...
 *     ?InternalAddRef@?$ComPtr@VInputProcess@@@WRL@Microsoft@@IEBAXXZ @ 0x180083518 (-InternalAddRef@-$ComPtr@VInputProcess@@@WRL@Microsoft@@IEBAXXZ.c)
