/*
 * XREFs of ??_GHidLampMultiUpdateReportParser@@UEAAPEAXI@Z @ 0x1800EC9E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1HidLampMultiUpdateReportParser@@UEAA@XZ @ 0x1800EC854 (--1HidLampMultiUpdateReportParser@@UEAA@XZ.c)
 */
