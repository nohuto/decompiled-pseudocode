/*
 * XREFs of ?AllocateStubUnderLock@BamoAsyncResult_PROPVARIANT_Principal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncResult_PROPVARIANT_Stub@@@Z @ 0x180172410
 * Callers:
 *     <none>
 * Callees:
