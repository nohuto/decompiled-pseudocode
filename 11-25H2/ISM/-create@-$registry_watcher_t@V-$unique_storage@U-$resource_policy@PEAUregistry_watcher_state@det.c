        ...
        __int64 a5)
{
  ...
  __int64 v7; // r8
  signed int v8; // ebx
  HKEY v10; // [rsp+70h] [rbp+18h] BYREF

  v10 = 0LL;
  v6 = RegCreateKeyExW(HKEY_LOCAL_MACHINE, L"Software\\Microsoft\\Windows\\ISM\\6dof", 0, 0LL, 0, 0x10u, 0LL, &v10, 0LL);
  v8 = v6;
  if ( v6 > 0 )
