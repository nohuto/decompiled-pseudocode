/*
 * XREFs of ?MPCSixDofProcessor_HomePressedEvent_@ISMTracing@@QEAAXK_NKMMMMMMMMMMMMMMMMMMK@Z @ 0x1801B4F68
 * Callers:
        ...
        unsigned int a23)
{
  ...
  v51 = this;
  v26 = ISMTracing::Provider();
  if ( *(_DWORD *)v26 > 5u && tlgKeywordOn((__int64)v26, 1LL) )
  {
    v32 = a21;
    v33 = a20;
    v34 = a19;
