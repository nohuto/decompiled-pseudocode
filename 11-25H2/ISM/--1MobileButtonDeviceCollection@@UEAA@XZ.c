/*
 * XREFs of ??1MobileButtonDeviceCollection@@UEAA@XZ @ 0x1800D6D48
 * Callers:
...
void __fastcall MobileButtonDeviceCollection::~MobileButtonDeviceCollection(MobileButtonDeviceCollection *this)
{
  ...
  *(_QWORD *)this = &MobileButtonDeviceCollection::`vftable';
  ...
  std::_Hash<std::_Uset_traits<unsigned __int64,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<unsigned __int64>,0>>::~_Hash<std::_Uset_traits<unsigned __int64,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<unsigned __int64>,0>>((__int64)this + 2824);
