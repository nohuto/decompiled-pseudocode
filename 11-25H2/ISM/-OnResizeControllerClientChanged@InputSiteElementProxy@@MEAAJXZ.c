/*
 * XREFs of ?OnResizeControllerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005EE70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIResizeControllerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005EEE8 (--$RemoveObject@UIResizeControllerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
