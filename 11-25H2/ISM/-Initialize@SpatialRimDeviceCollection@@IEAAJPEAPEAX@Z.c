/*
 * XREFs of ?Initialize@SpatialRimDeviceCollection@@IEAAJPEAPEAX@Z @ 0x1800D38B8
 * Callers:
...
__int64 __fastcall SpatialRimDeviceCollection::Initialize(SpatialRimDeviceCollection *this, void **a2)
{
  ...
  *((_DWORD *)this + 710) = CurrentThreadId;
  try
  {
    ...
    if ( v5 >= 0 )
    {
      v11 = HIDDeviceCollection::Initialize(this, v6, (struct _RIM_USAGE_ANDPAGE *const)&unk_180245F44, v7, 0x1Du, a2);
      v12 = v11;
      if ( v11 >= 0 )
      {
  ...
  catch ( ... )
  {
    LODWORD(v23) = wil::details::in1diag3::Return_CaughtException(
                     retaddr,
                     (void *)0x1D2,
                     (unsigned int)"onecoreuap\\windows\\moderncore\\inputv2\\rawinputproviders\\rim\\lib\\spatialrimdevi"
                                   "cecollection.cpp",
                     v9);
