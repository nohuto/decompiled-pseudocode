/*
 * XREFs of ?TryCreateAndInitialize@HidLampMultiUpdateReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800ECDE0
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportParser@@AEAA@XZ @ 0x1800948A0 (--0HidLampMultiUpdateReportParser@@AEAA@XZ.c)
