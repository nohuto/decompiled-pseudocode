/*
 * XREFs of ?UpdateGestureDirection@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NPEBUVector2@Numerics@Foundation@Windows@@@Z @ 0x180126CEC
 * Callers:
 *     ?Thunk_UpdateGestureDirection_185@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801249E0 (-Thunk_UpdateGestureDirection_185@-$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyG.c)
        ...
        const struct Windows::Foundation::Numerics::Vector2 *a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoEdgyGestureRecognitionConfigurationProxy::LogOnGestureDirectionChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    v7 = (*(__int64 (__fastcall **)(BamoEdgyGestureRecognitionConfigurationProxy *, const struct Windows::Foundation::Numerics::Vector2 *))(*(_QWORD *)v6 + 104LL))(
           v6,
           a3);
    if ( v7 < 0 )
  ...
  *((_QWORD *)this + 4) = *(_QWORD *)a3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoEdgyGestureRecognitionConfigurationProxy::LogOnGestureDirectionChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoEdgyGestureRecognitionConfigurationProxy *))(*(_QWORD *)v6 + 112LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0xD6A2,
