/*
 * XREFs of ?OnPeerDisconnected@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJIPEAX_N@Z @ 0x18006DDFC
 * Callers:
        ...
        const char *a4)
{
  ...
  if ( this[8] )
  {
    Microsoft::BamoImpl::BaseBamoPeerImpl::OnDisconnected(a3, a2, (__int64)a3, a4);
    LOBYTE(v7) = v4;
