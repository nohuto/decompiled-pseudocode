/*
 * XREFs of ?OnMessage@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180163B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCConstantManagerClientProxyImpl::OnMessage(
