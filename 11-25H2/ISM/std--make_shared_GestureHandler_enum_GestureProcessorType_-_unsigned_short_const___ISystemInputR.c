/*
 * XREFs of std::make_shared_GestureHandler_enum_GestureProcessorType_&_unsigned_short_const___ISystemInputRouterHitTest____lambda_80df7c2b76f58973f9ddec3659020abd__&_ @ 0x180093E8C
 * Callers:
 ...
 *     std::_Ref_count_obj2_GestureHandler_::_Ref_count_obj2_GestureHandler__enum_GestureProcessorType_&_unsigned_short_const___ISystemInputRouterHitTest____lambda_80df7c2b76f58973f9ddec3659020abd__&_ @ 0x180093F80 (std--_Ref_count_obj2_GestureHandler_--_Ref_count_obj2_GestureHandler__enum_GestureProcessorType_.c)
        ...
        __int64 a5)
{
  ...
  v20 = (unsigned int)operator new(0x120uLL);
  ...
  *a1 = v9 + 16;
  ...
  if ( v9 != -16 )
  {
    ...
    if ( !v10 || !*(_DWORD *)(v10 + 8) )
    {
      ...
      v17[1] = v11;
      v12 = (__int64 *)std::weak_ptr<SystemCursorService2>::weak_ptr<SystemCursorService2>(v18, v17);
      v13 = *v12;
      *v12 = *v14;
      *v14 = v13;
      v15 = v12[1];
