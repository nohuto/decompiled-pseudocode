/*
 * XREFs of ?OnActuationClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005D8F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActuationClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D964 (--$RemoveObject@UIActuationClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
