/*
 * XREFs of ?InitializeProxyUnderLock@?$ListPrincipalSimpleCommon@VBamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@VBamoList_uint_Stub@2345@II@Bamo@Microsoft@@MEAAJPEAVBamoList_uint_Stub@dataprovider_AutoBamos@Lib@23@@Z @ 0x180100C70
 * Callers:
 *     <none>
 * Callees:
