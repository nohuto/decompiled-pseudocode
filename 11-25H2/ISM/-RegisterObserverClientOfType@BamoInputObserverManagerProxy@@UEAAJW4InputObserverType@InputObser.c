/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerProxy@@UEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x180121B80
 * Callers:
 *     <none>
 * Callees:
