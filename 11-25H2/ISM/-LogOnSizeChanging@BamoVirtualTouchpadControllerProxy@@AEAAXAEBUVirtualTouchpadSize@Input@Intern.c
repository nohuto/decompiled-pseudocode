/*
 * XREFs of ?LogOnSizeChanging@BamoVirtualTouchpadControllerProxy@@AEAAXAEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x180133648
 * Callers:
