/*
 * XREFs of ??1GestureHandler@@QEAA@XZ @ 0x18013FA38
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VGestureHandler@@@std@@EEAAXXZ @ 0x180141C70 (-_Destroy@-$_Ref_count_obj2@VGestureHandler@@@std@@EEAAXXZ.c)
 * Callees:
