/*
 * XREFs of ?LogSendStopProcess@BamoInputProcessProxyImpl@BamoImpl@@AEAAXXZ @ 0x18019307C
 * Callers:
...
void __fastcall BamoImpl::BamoInputProcessProxyImpl::LogSendStopProcess(BamoImpl::BamoInputProcessProxyImpl *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
