/*
 * XREFs of ?LogOnScaleOverrideChanging@BamoSystemCursorControllerClientProxy@@AEAAXM@Z @ 0x180117E00
 * Callers:
...
void __fastcall BamoSystemCursorControllerClientProxy::LogOnScaleOverrideChanging(
