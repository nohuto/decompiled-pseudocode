/*
 * XREFs of ??$EnumerateStubs@W4InputType@@PEBGUtagPROPVARIANT@@U2@@BamoMPCConstantManagerClientPrincipal@@QEAAJP6AJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGUtagPROPVARIANT@@3@Z_N1233@Z @ 0x1800B4E7C
 * Callers:
 *     ?OnConstantChanged@MPCConstantManager@@QEAAXW4InputType@@PEBGAEBUtagPROPVARIANT@@2@Z @ 0x1800B67E4 (-OnConstantChanged@MPCConstantManager@@QEAAXW4InputType@@PEBGAEBUtagPROPVARIANT@@2@Z.c)
 * Callees:
 ...
 *     ?CurrentThreadIsDispatcher@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEBA_NXZ @ 0x180071D58 (-CurrentThreadIsDispatcher@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEBA_NXZ.c)
        ...
        __int64 a7)
{
  ...
  v11 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<long (*)(BamoMPCConstantManagerClientStub *,enum InputType,unsigned short const *,tagPROPVARIANT,tagPROPVARIANT),enum InputType,unsigned short const *,tagPROPVARIANT,tagPROPVARIANT>(
          a1 + 16,
          (__int64 (__fastcall *)(__int64, __int64 (__fastcall *)(int, int, int, int, __int64), _QWORD, __int64, int *, __int128 *))_lambda_ae73f6d5338a09a55b227f0119131a75_::_lambda_invoker_cdecl_,
          v9,
          (__int64)v10,
          a4,
          a5,
