/*
 * XREFs of ?evaluate_and_report@?$shared_data@$0A@$0A@$00@details@tip2@@AEAAX_J@Z @ 0x180106904
 * Callers:
...
LABEL_12:
  ...
  if ( v10 )
    ...
    v26 = 0;
  error = tip2::test_state::last_error((tip2::test_state *)(a1 + 1));
  if ( error )
  {
    v22 = *((_DWORD *)error + 2);
    v23 = *((_QWORD *)error + 7);
  ...
  (*(void (__fastcall **)(_QWORD, int *))(*(_QWORD *)*a1 + 24LL))(*a1, &v12);
