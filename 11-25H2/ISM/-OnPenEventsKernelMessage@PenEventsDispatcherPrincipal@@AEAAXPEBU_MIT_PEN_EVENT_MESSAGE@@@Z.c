/*
 * XREFs of ?OnPenEventsKernelMessage@PenEventsDispatcherPrincipal@@AEAAXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z @ 0x18018FF20
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_169f4db4f162cf2479feb08acf74ea7d__void__MIT_PEN_EVENT_MESSAGE_const___::_Do_call @ 0x180191590 (std--_Func_impl_no_alloc__lambda_169f4db4f162cf2479feb08acf74ea7d__void__MIT_PEN_EV_ea_180191590.c)
 * Callees:
 ...
 *     ?OnDock@PenEventsDispatcherPrincipal@@AEAAXXZ @ 0x18018FD54 (-OnDock@PenEventsDispatcherPrincipal@@AEAAXXZ.c)
 ...
 *     ?OnUndock@PenEventsDispatcherPrincipal@@AEAAXXZ @ 0x180190144 (-OnUndock@PenEventsDispatcherPrincipal@@AEAAXXZ.c)
