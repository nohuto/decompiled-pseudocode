/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800660BC
 * Callers:
 ...
 *     _ContextualProcessorBuffer::ProcessContextualProcessorDecision_::_1_::dtor$8 @ 0x1801C90F5 (_ContextualProcessorBuffer--ProcessContextualProcessorDecision_--_1_--dtor$8.c)
 *     _std::unordered_map_unsigned_long_Microsoft::WRL::ComPtr_IInputTarget__std::hash_unsigned_long__std::equal_to_unsigned_long__std::allocator_std::pair_unsigned_long_const__Microsoft::WRL::ComPtr_IInputTarget_______::operator[]_::_1_::dtor$0 @ 0x1801C92C2 (_std--unordered_map_unsigned_long_Microsoft--WRL--ComPtr_IInputTarget__std--hash_unsigned_long__.c)
 *     _ContextualProcessorBuffer::DeliverInputToTarget_::_1_::dtor$6 @ 0x1801C9358 (_ContextualProcessorBuffer--DeliverInputToTarget_--_1_--dtor$6.c)
 * Callees:
