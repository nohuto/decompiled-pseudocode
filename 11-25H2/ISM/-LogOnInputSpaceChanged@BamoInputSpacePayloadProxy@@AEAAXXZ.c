/*
 * XREFs of ?LogOnInputSpaceChanged@BamoInputSpacePayloadProxy@@AEAAXXZ @ 0x180117218
 * Callers:
...
void __fastcall BamoInputSpacePayloadProxy::LogOnInputSpaceChanged(BamoInputSpacePayloadProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
