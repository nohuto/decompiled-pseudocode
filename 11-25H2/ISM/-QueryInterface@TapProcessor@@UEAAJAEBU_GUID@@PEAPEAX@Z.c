/*
 * XREFs of ?QueryInterface@TapProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AA9F0
 * Callers:
 *     ?QueryInterface@TapProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AAAB0 (-QueryInterface@TapProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@TapProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AAAC0 (-QueryInterface@TapProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x18008EFF4 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1801D3010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

__int64 __fastcall TapProcessor::QueryInterface(TapProcessor *this, const struct _GUID *a2, TapProcessor **a3)
{
  TapProcessor *v4; // rbx
  __int64 v6; // rax
  __int64 v7; // rax
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(TapProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (TapProcessor *)(((unsigned __int64)v4 + 16) & -(__int64)(v4 != 0LL));
    goto LABEL_11;
  }
  return 2147500034LL;
}
