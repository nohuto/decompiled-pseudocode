/*
 * XREFs of ?CreateLightDismissClientProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x1800949AC
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *v7 = 0LL;
  v7[1] = 0LL;
  v7[2] = 0LL;
  *((_QWORD *)v7 + 1) = &BamoLightDismissClientProxy::`vftable'{for `ILightDismissClientProxy'};
  *((_DWORD *)v7 + 6) = 0;
  *((_QWORD *)v7 + 4) = 0LL;
  *((_DWORD *)v7 + 10) = 0;
  *((_DWORD *)v7 + 11) = 0;
