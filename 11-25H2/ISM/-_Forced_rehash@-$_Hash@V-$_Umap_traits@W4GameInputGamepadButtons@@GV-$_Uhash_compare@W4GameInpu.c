/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAAX_K@Z @ 0x18017BB04
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,ResizeProcessor::MessageInfo>>>>>>::_Assign_grow(
    (__int64)&qword_180246F88,
    2 * v5,
    qword_180246F78);
  v7 = v5 - 1;
  qword_180246FA0 = v5 - 1;
  qword_180246FA8 = v5;
  for ( i = *(_QWORD *)qword_180246F78; i != v3; i = v12 )
  {
    ...
    v13 = qword_180246F88;
    v14 = 2 * (v7 & v9);
    if ( *(_QWORD *)(qword_180246F88 + 16 * (v7 & v9)) == v3 )
    {
      *(_QWORD *)(qword_180246F88 + 16 * (v7 & v9)) = v11;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v11;
      goto LABEL_15;
    }
    v15 = *(__int64 **)(qword_180246F88 + 16 * (v7 & v9) + 8);
    v6 = *v10;
    ...
    {
      v19 = v15 + 1;
      if ( *(__int64 **)(qword_180246F88 + 8 * v14) == v15 )
        break;
      v15 = (__int64 *)*v19;
