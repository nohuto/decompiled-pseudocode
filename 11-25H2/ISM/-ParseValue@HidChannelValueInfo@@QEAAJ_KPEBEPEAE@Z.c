/*
 * XREFs of ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800EDF38
 * Callers:
 ...
 * Callees:
 *     ?InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z @ 0x180081828 (-InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z.c)
 */
