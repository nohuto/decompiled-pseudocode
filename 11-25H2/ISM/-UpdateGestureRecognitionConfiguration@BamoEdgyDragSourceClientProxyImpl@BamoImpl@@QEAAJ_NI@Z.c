/*
 * XREFs of ?UpdateGestureRecognitionConfiguration@BamoEdgyDragSourceClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180126F34
 * Callers:
 *     ?Thunk_UpdateGestureRecognitionConfiguration_8@?$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124A10 (-Thunk_UpdateGestureRecognitionConfiguration_8@-$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDra.c)
