/*
 * XREFs of ?LoadGameInput@GameInputServerProxy@@AEAAJXZ @ 0x1800716B0
 * Callers:
 ...
 *     ?OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z @ 0x18010A4C0 (-OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z.c)
 * Callees:
 ...
 *     ?CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z @ 0x1800719F0 (-CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z.c)
