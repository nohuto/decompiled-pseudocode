/*
 * XREFs of ?LogOnOcclusionRectsChanged@BamoSystemContextEndpointPrincipal@@AEAAXPEAVBamoSystemContextEndpointStub@@@Z @ 0x1800AC178
 * Callers:
...
void __fastcall BamoSystemContextEndpointPrincipal::LogOnOcclusionRectsChanged(
