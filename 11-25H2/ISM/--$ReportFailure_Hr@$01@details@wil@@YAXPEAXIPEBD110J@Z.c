/*
 * XREFs of ??$ReportFailure_Hr@$01@details@wil@@YAXPEAXIPEBD110J@Z @ 0x18007D0EC
 * Callers:
 ...
 *     ?winrt_throw_hresult@wil@@YAXIPEBD0PEAXUhresult@winrt@@@Z @ 0x1800DC320 (-winrt_throw_hresult@wil@@YAXIPEBD0PEAXUhresult@winrt@@@Z.c)
 * Callees:
