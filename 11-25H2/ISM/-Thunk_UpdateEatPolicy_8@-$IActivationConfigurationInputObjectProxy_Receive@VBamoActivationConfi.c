/*
 * XREFs of ?Thunk_UpdateEatPolicy_8@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800801A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
