/*
 * XREFs of ?GetWIDOfTarget@ISMTracing@@SA_KPEAUIInputTarget@@@Z @ 0x1800FB6D0
 * Callers:
...
__int64 __fastcall ISMTracing::GetWIDOfTarget(struct IInputTarget *a1)
{
  ...
  __int64 (__fastcall ***v4)(_QWORD, GUID *, __int64 *); // [rsp+38h] [rbp+10h] BYREF
  ...
  if ( a1 )
  {
    ...
    wil::com_ptr_t<AsyncHRESULTPrincipal,wil::err_exception_policy>::~com_ptr_t<AsyncHRESULTPrincipal,wil::err_exception_policy>((__int64 *)&v4);
    v3 = 0LL;
    if ( (int)Microsoft::WRL::ComPtr<IInputTarget>::As<IFocusInputTarget>(&v4, &v3) >= 0 && v3 )
      (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v3 + 64LL))(v3, &v5);
