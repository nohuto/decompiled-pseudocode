/*
 * XREFs of ?LogOnHitTestConfigurationChanging@BamoDragSourceClientProxy@@AEAAXW4HitTestConfiguration@Input@Internal@UI@Windows@@@Z @ 0x180116C34
 * Callers:
