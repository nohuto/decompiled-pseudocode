/*
 * XREFs of ?ShellButtonRepeatCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x1800612C0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x180061370 (-GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ.c)
