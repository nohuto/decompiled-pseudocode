/*
 * XREFs of ??_GConsumerControlGenericDevice@@EEAAPEAXI@Z @ 0x1800E6A10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1ConsumerControlGenericDevice@@EEAA@XZ @ 0x1800E69BC (--1ConsumerControlGenericDevice@@EEAA@XZ.c)
 */
