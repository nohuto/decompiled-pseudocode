/*
 * XREFs of ?HitTest@MPCInputRouter@@UEAAJPEAU_InputHitTestRequest@@PEAU_InputHitTestResult@@PEAVInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x180018890
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IInputTarget **a6)
{
  ...
  if ( (unsigned __int8)std::_Atomic_storage<bool,1>::load((char *)this + 728)
    && *((_DWORD *)a2 + 17)
    ...
    && !*((_BYTE *)MPCHolographicInputManager::GetInstance() + 3365) )
  {
    ...
    if ( v11 )
    {
      ...
      {
        v12 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 82) + 112LL))(*((_QWORD *)this + 82));
        ...
        {
          v15 = (void *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 82) + 120LL))(*((_QWORD *)this + 82));
          if ( v15 )
          {
          ...
          *((_DWORD *)a3 + 25) = 1;
          *(_QWORD *)a3 = (*(int (__fastcall **)(_QWORD))(**((_QWORD **)this + 82) + 56LL))(*((_QWORD *)this + 82));
          v9 = 0;
        }
        Microsoft::WRL::ComPtr<Windows::Foundation::Collections::IVector<HSTRING__ *>>::InternalRelease(&v21);
