/*
 * XREFs of ?AllocateStubUnderLock@BamoSystemCursorControllerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSystemCursorControllerStub@@@Z @ 0x180074660
 * Callers:
 *     <none>
 * Callees:
