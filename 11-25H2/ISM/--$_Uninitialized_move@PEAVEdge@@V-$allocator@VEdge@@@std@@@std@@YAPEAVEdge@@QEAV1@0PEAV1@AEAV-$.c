/*
 * XREFs of ??$_Uninitialized_move@PEAVEdge@@V?$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@QEAV1@0PEAV1@AEAV?$allocator@VEdge@@@0@@Z @ 0x1801A1D38
 * Callers:
 ...
 *     ??0Edge@@QEAA@$$QEAV0@@Z @ 0x1801A1DB8 (--0Edge@@QEAA@$$QEAV0@@Z.c)
 */
