/*
 * XREFs of ?GetPoints@MPCGamepadProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801B7690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCGamepadProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // xmm0_8
  __int128 v6; // xmm1
  unsigned int v7; // ecx
  ...
  *(_QWORD *)&v15 = v5;
  ...
  v21 = 0LL;
  v28 = v11;
  return std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v15);
}
