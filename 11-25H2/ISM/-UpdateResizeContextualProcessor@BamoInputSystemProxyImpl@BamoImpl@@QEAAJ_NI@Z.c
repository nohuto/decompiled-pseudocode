/*
 * XREFs of ?UpdateResizeContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180129870
 * Callers:
 *     ?Thunk_UpdateResizeContextualProcessor_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124D80 (-Thunk_UpdateResizeContextualProcessor_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@B.c)
