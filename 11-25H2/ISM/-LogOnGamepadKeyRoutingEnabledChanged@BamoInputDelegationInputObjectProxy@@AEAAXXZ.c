/*
 * XREFs of ?LogOnGamepadKeyRoutingEnabledChanged@BamoInputDelegationInputObjectProxy@@AEAAXXZ @ 0x180130FA4
 * Callers:
...
void __fastcall BamoInputDelegationInputObjectProxy::LogOnGamepadKeyRoutingEnabledChanged(
