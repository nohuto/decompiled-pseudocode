/*
 * XREFs of ?LogReceiveRegisterInputSiteElement@BamoInputSiteManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputSiteElementProxy@@@Z @ 0x18008B4A0
 * Callers:
