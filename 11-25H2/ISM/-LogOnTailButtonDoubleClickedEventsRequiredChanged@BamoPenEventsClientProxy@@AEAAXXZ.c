/*
 * XREFs of ?LogOnTailButtonDoubleClickedEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x18018F56C
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonDoubleClickedEventsRequiredChanged(
