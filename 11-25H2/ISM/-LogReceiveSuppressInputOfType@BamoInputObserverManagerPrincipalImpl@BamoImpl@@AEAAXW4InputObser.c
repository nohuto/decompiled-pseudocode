/*
 * XREFs of ?LogReceiveSuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@AEAAXW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x180136434
 * Callers:
...
void BamoImpl::BamoInputObserverManagerPrincipalImpl::LogReceiveSuppressInputOfType()
{
  __int64 v0; // rbx
  __int64 v1; // r8
  int v2; // r9d
