/*
 * XREFs of ?LogSendRemoteRemove@BamoList_VirtualTouchpadRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXI@Z @ 0x18013B84C
 * Callers:
