/*
 * XREFs of ??1AugmentedInputDeviceCollection@@UEAA@XZ @ 0x1800D0054
 * Callers:
...
void __fastcall AugmentedInputDeviceCollection::~AugmentedInputDeviceCollection(char **this)
{
  *this = (char *)&AugmentedInputDeviceCollection::`vftable';
