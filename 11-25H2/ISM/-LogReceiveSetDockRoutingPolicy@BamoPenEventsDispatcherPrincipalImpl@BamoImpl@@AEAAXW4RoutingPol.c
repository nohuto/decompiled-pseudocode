/*
 * XREFs of ?LogReceiveSetDockRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@AEAAXW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x18018F83C
 * Callers:
