/*
 * XREFs of ??$_Try_emplace@AEBK$$V@?$_Hash@V?$_Umap_traits@KUMessageInfo@ResizeProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@PEAU?$_List_node@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@PEAX@std@@_N@1@AEBK@Z @ 0x18014DC80
 * Callers:
        ...
        _DWORD *a3)
{
  ...
  else
  {
    ...
    v16 = a1 + 2;
    v8 = (char *)std::_Allocate<16,std::_Default_allocate_traits,0>(0x40uLL);
    v17 = v8;
    *((_DWORD *)v8 + 4) = *a3;
    *(_OWORD *)(v8 + 24) = 0LL;
    *(_OWORD *)(v8 + 40) = 0LL;
