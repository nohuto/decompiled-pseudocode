/*
 * XREFs of ??_ETapProcessor@@EEAAPEAXI@Z @ 0x1801AA640
 * Callers:
 *     ??_ETapProcessor@@GBA@EAAPEAXI@Z @ 0x1801AA630 (--_ETapProcessor@@GBA@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1TapProcessor@@EEAA@XZ @ 0x1801AA594 (--1TapProcessor@@EEAA@XZ.c)
 */
