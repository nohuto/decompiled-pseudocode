/*
 * XREFs of ?UpdateDockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1800982F8
 * Callers:
 *     ?Thunk_UpdateDockedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800906E0 (-Thunk_UpdateDockedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyIm.c)
