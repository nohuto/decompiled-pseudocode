/*
 * XREFs of ?OnHitTest@EdgyLegacyProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801A12E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContextualProcessorInitialState *a4)
{
  ...
  *(_DWORD *)a4 = 0;
  ...
  if ( !*((_QWORD *)a4 + 1) )
  {
    HIDWORD(v22) = 0;
    LODWORD(v23) = 0;
    if ( (*(_BYTE *)a2 & 8) != 0 && *(char *)a2 >= 0 )
    {
      v9 = *((_DWORD *)a2 + 8);
      if ( (v9 & 4) != 0 )
      {
        *((_QWORD *)&v23 + 1) = *((unsigned int *)a2 + 2);
        LODWORD(v22) = *((_DWORD *)a2 + 10);
        DWORD2(v22) = v9;
        DWORD1(v22) = *((_DWORD *)a2 + 1);
        HIDWORD(v22) = *((_DWORD *)a2 + 11);
        ...
        if ( (unsigned __int8)Edges::HitTest((Edges *)(*((_QWORD *)this + 13) + 72LL), (__int64)this + 80) )
        {
          ...
          *(_OWORD *)((char *)this + 40) = v23;
          ...
          if ( v11 )
          {
            ...
            if ( (int)NtQueryCompositionInputQueueAndTransform(v11, v12, &v28, v32) >= 0 && (unsigned int)(v28 - 3) <= 1 )
            {
              v27 = v29;
              v22 = v30;
              v20 = v31;
              ...
              if ( DuplicateHandle(v14, v11, CurrentProcess, &TargetHandle, 0, 0, 2u) )
              {
                ...
                if ( v15 )
                {
                  ...
                  v25 = v22;
                  v26 = v20;
                  EdgyProcessorTarget::UpdateInputTarget(v15, &v24, TargetHandle, (char *)this + 24);
                }
                else
                {
                  ...
                  v25 = v22;
                  v26 = v20;
                  v7 = EdgyProcessorTarget::Create(this, (char *)this + 24, &v24, TargetHandle, (char *)this + 72);
                  if ( v7 < 0 )
                    goto LABEL_19;
                }
