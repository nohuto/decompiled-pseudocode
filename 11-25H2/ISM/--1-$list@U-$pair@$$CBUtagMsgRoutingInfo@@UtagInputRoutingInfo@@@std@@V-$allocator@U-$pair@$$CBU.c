/*
 * XREFs of ??1?$list@U?$pair@$$CBUtagMsgRoutingInfo@@UtagInputRoutingInfo@@@std@@V?$allocator@U?$pair@$$CBUtagMsgRoutingInfo@@UtagInputRoutingInfo@@@std@@@2@@std@@QEAA@XZ @ 0x18015CE10
 * Callers:
 *     _NonBamoInputDeliveryServer::NonBamoInputDeliveryServer_::_1_::dtor$12 @ 0x1801D06D4 (_NonBamoInputDeliveryServer--NonBamoInputDeliveryServer_--_1_--dtor$12.c)
 * Callees:
