/*
 * XREFs of ??1?$test_watcher@V?$merged_data@U_tip_GamepadInterceptionUsageTipTest_attributes@@Vtest_data_basic@tip2@@@details@tip2@@@tip2@@QEAA@XZ @ 0x180105CFC
 * Callers:
 ...
 *     _GamepadInterceptionHelper::InterceptGamepadInput_::_1_::dtor$0 @ 0x1801CF687 (_GamepadInterceptionHelper--InterceptGamepadInput_--_1_--dtor$0.c)
 * Callees:
