/*
 * XREFs of ?AllocateStubUnderLock@BamoEdgyControllerServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoEdgyControllerServerStub@@@Z @ 0x180074780
 * Callers:
 *     <none>
 * Callees:
