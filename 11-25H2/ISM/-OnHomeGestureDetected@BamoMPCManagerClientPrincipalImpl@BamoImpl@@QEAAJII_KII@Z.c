/*
 * XREFs of ?OnHomeGestureDetected@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJII_KII@Z @ 0x1801674B4
 * Callers:
 *     ?Thunk_OnHomeGestureDetected_53@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180167ED0 (-Thunk_OnHomeGestureDetected_53@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrinci.c)
 * Callees:
        ...
        int a4)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v13 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, _QWORD))(*((_QWORD *)this - 2) + 120LL))(
            (char *)this - 16,
            v10,
            a2,
            a3);
