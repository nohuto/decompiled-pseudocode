/*
 * XREFs of ?QueryInterface@BamoDelegatedInkCanvasInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F8B0
 * Callers:
 *     ?QueryInterface@BamoDelegatedInkCanvasInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011F940 (-QueryInterface@BamoDelegatedInkCanvasInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
