/*
 * XREFs of ?LogOnMPCInputObjectChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoMPCInputObjectProxy@@@Z @ 0x18008B2E0
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnMPCInputObjectChanging(
        BamoInputSiteElementProxy *this,
        struct BamoMPCInputObjectProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
