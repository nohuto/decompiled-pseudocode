/*
 * XREFs of ?LogSetTopLevelActivatedEntity@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800B1B1C
 * Callers:
