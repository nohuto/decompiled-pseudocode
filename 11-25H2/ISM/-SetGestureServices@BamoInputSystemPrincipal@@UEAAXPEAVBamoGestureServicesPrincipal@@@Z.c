/*
 * XREFs of ?SetGestureServices@BamoInputSystemPrincipal@@UEAAXPEAVBamoGestureServicesPrincipal@@@Z @ 0x180091300
 * Callers:
...
void __fastcall BamoInputSystemPrincipal::SetGestureServices(
        ...
        struct BamoGestureServicesPrincipal *a2)
{
  ...
  BamoImpl::BamoInputSystemPrincipalImpl::SetGestureServices((BamoImpl::BamoInputSystemPrincipalImpl *)(this + 1), a2);
