/*
 * XREFs of ?QueryInterface@OneCoreUAPInputHost@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A3060
 * Callers:
 *     ?QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A3180 (-QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A3190 (-QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@OneCoreUAPInputHost@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A31A0 (-QueryInterface@OneCoreUAPInputHost@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
