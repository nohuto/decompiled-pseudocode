/*
 * XREFs of ?UpdateIsActive@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180134C50
 * Callers:
 *     ?Thunk_UpdateIsActive_11@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134AA0 (-Thunk_UpdateIsActive_11@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControlle.c)
