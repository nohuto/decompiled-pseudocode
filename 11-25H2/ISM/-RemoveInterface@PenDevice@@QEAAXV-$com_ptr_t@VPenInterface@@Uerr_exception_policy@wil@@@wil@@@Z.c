/*
 * XREFs of ?RemoveInterface@PenDevice@@QEAAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180189730
 * Callers:
...
__int64 __fastcall PenDevice::RemoveInterface(_QWORD *a1, __int64 *a2)
{
  ...
  {
    v9 = *v8;
    PenInterface::Haptics(*a2, &v11);
    PenHapticDevice::RemoveInterface(v9);
  }
