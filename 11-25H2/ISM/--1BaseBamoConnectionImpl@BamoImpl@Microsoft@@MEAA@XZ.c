/*
 * XREFs of ??1BaseBamoConnectionImpl@BamoImpl@Microsoft@@MEAA@XZ @ 0x1800B8058
 * Callers:
 ...
 *     ??1InputSystemServerConnection@@UEAA@XZ @ 0x180112934 (--1InputSystemServerConnection@@UEAA@XZ.c)
