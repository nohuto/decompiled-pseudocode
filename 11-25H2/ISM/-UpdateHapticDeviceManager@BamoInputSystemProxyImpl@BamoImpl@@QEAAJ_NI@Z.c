/*
 * XREFs of ?UpdateHapticDeviceManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180127560
 * Callers:
 *     ?Thunk_UpdateHapticDeviceManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124A90 (-Thunk_UpdateHapticDeviceManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
