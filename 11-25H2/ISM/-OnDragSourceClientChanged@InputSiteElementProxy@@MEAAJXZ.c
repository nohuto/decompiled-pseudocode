/*
 * XREFs of ?OnDragSourceClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005ECA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005ED18 (--$RemoveObject@UIDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IDragSourceClientProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 152LL))((char *)this + 8);
