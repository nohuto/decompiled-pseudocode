/*
 * XREFs of ?LogSetInputProcessManager@BamoInputSystemInternalPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputProcessManagerPrincipal@@@Z @ 0x180092AEC
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemInternalPrincipalImpl::LogSetInputProcessManager(
