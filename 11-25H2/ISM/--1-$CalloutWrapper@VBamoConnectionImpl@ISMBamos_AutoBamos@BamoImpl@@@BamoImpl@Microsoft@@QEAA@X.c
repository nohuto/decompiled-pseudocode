/*
 * XREFs of ??1?$CalloutWrapper@VBamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x1800454A8
 * Callers:
 ...
 *     _BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::OnPeerRequestsConnectThunk_::_1_::dtor$0 @ 0x1801CBB02 (_BamoImpl--ISMBamos_AutoBamos--BamoConnectionImpl--OnPeerRequestsConnectThunk_--_1_--dtor$0.c)
 *     _ISMBamos_AutoBamos::BamoConnection::SetBootstrapProxyCallout_::_1_::dtor$0 @ 0x1801CBB14 (_ISMBamos_AutoBamos--BamoConnection--SetBootstrapProxyCallout_--_1_--dtor$0.c)
 * Callees:
