/*
 * XREFs of ?UpdateTailButtonLongPressedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18007A914
 * Callers:
 *     ?Thunk_UpdateTailButtonLongPressedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800940C0 (-Thunk_UpdateTailButtonLongPressedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEven.c)
        ...
        __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoPenEventsClientProxy::LogOnTailButtonLongPressedEventsRequiredChanging(
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenEventsClientProxyImpl>::CalloutWrapper<BamoImpl::BamoPenEventsClientProxyImpl>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      ...
      1);
    LOBYTE(v7) = v3;
    v8 = (*(__int64 (__fastcall **)(BamoPenEventsClientProxy *, __int64))(*(_QWORD *)v6 + 136LL))(v6, v7);
    if ( v8 < 0 )
  ...
  *((_BYTE *)this + 34) = v3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoPenEventsClientProxy::LogOnTailButtonLongPressedEventsRequiredChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenEventsClientProxyImpl>::CalloutWrapper<BamoImpl::BamoPenEventsClientProxyImpl>(
      (__int64)v11,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v9 = (*(__int64 (__fastcall **)(BamoPenEventsClientProxy *))(*(_QWORD *)v6 + 144LL))(v6);
    if ( v9 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x5F74,
