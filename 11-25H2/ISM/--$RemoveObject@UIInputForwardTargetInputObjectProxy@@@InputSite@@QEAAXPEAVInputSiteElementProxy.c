/*
 * XREFs of ??$RemoveObject@UIInputForwardTargetInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D088
 * Callers:
...
void __fastcall InputSite::RemoveObject<IInputForwardTargetInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_d4ef4959_f5fd_4cf7_9e90_49eefb52f5a4, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
