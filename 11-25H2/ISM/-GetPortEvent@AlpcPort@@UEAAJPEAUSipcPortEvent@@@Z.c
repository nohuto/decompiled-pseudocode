/*
 * XREFs of ?GetPortEvent@AlpcPort@@UEAAJPEAUSipcPortEvent@@@Z @ 0x18006E9B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Complete@AlpcMessage@@QEAAJPEAX@Z @ 0x18010BAB4 (-Complete@AlpcMessage@@QEAAJPEAX@Z.c)
 *     ?DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z @ 0x18010CBF0 (-DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z.c)
