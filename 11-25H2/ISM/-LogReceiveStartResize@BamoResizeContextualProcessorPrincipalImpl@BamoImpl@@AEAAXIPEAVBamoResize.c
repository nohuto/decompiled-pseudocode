/*
 * XREFs of ?LogReceiveStartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014D224
 * Callers:
...
void __fastcall BamoImpl::BamoResizeContextualProcessorPrincipalImpl::LogReceiveStartResize(
