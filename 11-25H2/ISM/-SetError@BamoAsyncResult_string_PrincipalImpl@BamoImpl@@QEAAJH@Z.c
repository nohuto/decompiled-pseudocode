/*
 * XREFs of ?SetError@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x180173074
 * Callers:
 *     ?Thunk_SetError_3@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801732B0 (-Thunk_SetError_3@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@.c)
 * Callees:
