/*
 * XREFs of ?OnComponentSiteInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005DAC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIComponentSiteInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005DB34 (--$RemoveObject@UIComponentSiteInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
