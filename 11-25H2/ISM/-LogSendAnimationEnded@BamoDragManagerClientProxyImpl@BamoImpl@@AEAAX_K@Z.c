/*
 * XREFs of ?LogSendAnimationEnded@BamoDragManagerClientProxyImpl@BamoImpl@@AEAAX_K@Z @ 0x1801432F0
 * Callers:
...
void __fastcall BamoImpl::BamoDragManagerClientProxyImpl::LogSendAnimationEnded(
