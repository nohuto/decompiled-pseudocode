/*
 * XREFs of ?ManualDragCancelled@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1801464C0
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      BamoImpl::BamoManualDragAreaClientProxyImpl::LogSendManualDragCancelled(this);
      v11[0] = v13;
      v11[1] = v14;
