/*
 * XREFs of ?Create@MobileButtonDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800D6EA8
 * Callers:
        ...
        struct MobileButtonDeviceCollection **a4)
{
  ...
  MobileButtonDeviceCollection *v18; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    v18 = v8;
    if ( v8 )
      v11 = MobileButtonDeviceCollection::MobileButtonDeviceCollection(v8, a1, a2);
    else
      v11 = 0LL;
    v16[0] = v11;
    if ( !v11 )
