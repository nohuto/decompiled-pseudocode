/*
 * XREFs of ??1ContextualProcessorMetadata@ContextualProcessorBuffer@@QEAA@XZ @ 0x18002AE7C
 * Callers:
 ...
 *     ??1?$_Uninitialized_backout_al@V?$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@@std@@QEAA@XZ @ 0x18002B55C (--1-$_Uninitialized_backout_al@V-$allocator@UContextualProcessorMetadata@ContextualProcessorBuff.c)
 *     ??$_Destroy_range@V?$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@@std@@YAXPEAUContextualProcessorMetadata@ContextualProcessorBuffer@@QEAU12@AEAV?$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@0@@Z @ 0x18002B598 (--$_Destroy_range@V-$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@@st.c)
 ...
 *     _ContextualProcessorBuffer::TryAddProcessorAndContact_::_1_::dtor$6 @ 0x1801C99C0 (_ContextualProcessorBuffer--TryAddProcessorAndContact_--_1_--dtor$6.c)
 *     _ContextualProcessorBuffer::AddProcessor_::_1_::dtor$6 @ 0x1801C9C2E (_ContextualProcessorBuffer--AddProcessor_--_1_--dtor$6.c)
 * Callees:
