/*
 * XREFs of ?QueryInterface@BamoInputSystemPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012C5E0
 * Callers:
 *     ?QueryInterface@BamoInputSystemPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012C670 (-QueryInterface@BamoInputSystemPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
