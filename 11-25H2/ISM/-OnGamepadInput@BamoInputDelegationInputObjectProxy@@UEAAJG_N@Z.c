/*
 * XREFs of ?OnGamepadInput@BamoInputDelegationInputObjectProxy@@UEAAJG_N@Z @ 0x180131510
 * Callers:
 *     ?InterceptGamepadInput@InputDelegationInputObjectProxy@@UEAAXG_N@Z @ 0x180130EE0 (-InterceptGamepadInput@InputDelegationInputObjectProxy@@UEAAXG_N@Z.c)
 * Callees:
