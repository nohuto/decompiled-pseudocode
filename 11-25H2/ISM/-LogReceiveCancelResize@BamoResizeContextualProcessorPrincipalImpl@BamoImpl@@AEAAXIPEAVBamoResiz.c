/*
 * XREFs of ?LogReceiveCancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoResizeControllerClientProxy@@@Z @ 0x18014D0D4
 * Callers:
