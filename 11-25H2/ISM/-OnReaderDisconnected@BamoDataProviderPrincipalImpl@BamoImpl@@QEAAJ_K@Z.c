/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x1801013FC
 * Callers:
 *     ?Thunk_OnReaderDisconnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180103CA0 (-Thunk_OnReaderDisconnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@Ba.c)
 * Callees:
