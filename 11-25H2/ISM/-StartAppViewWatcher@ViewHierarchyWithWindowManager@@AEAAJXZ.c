/*
 * XREFs of ?StartAppViewWatcher@ViewHierarchyWithWindowManager@@AEAAJXZ @ 0x180091AEC
 * Callers:
 ...
 *     ?Start@?$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewWatcher@UIAppViewWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@QEBA@XZ @ 0x180091C00 (-Start@-$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewWatcher@UIAppViewWat.c)
