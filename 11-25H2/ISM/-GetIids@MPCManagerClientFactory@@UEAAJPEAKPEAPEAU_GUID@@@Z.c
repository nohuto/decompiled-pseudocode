/*
 * XREFs of ?GetIids@MPCManagerClientFactory@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180161E00
 * Callers:
 *     ?GetIids@MPCManagerClientFactory@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180161E70 (-GetIids@MPCManagerClientFactory@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     ?FillArrayWithIid@?$ImplementsHelper@U?$RuntimeClassFlags@$0N@@WRL@Microsoft@@$0A@UIActivationFactory@@U?$Implements@VFtmBase@WRL@Microsoft@@UIMPCManagerClientStatics@MPCManager@Input@Internal@Windows@@@23@VNil@Details@23@V6723@V6723@@Details@WRL@Microsoft@@IEAAXPEAKPEAU_GUID@@@Z @ 0x1801614B0 (-FillArrayWithIid@-$ImplementsHelper@U-$RuntimeClassFlags@$0N@@WRL@Microsoft@@$0A@UIActivationFa.c)
 */
