/*
 * XREFs of ??$_Emplace_hint@AEBU?$pair@$$CBGI@std@@@?$_Tree@V?$_Tmap_traits@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@$0A@@std@@@std@@IEAAPEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@QEAU21@AEBU?$pair@$$CBGI@1@@Z @ 0x180070D10
 * Callers:
 *     ??0?$map@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@@std@@QEAA@V?$initializer_list@U?$pair@$$CBGI@std@@@1@@Z @ 0x180070C6C (--0-$map@GIU-$less@G@std@@V-$allocator@U-$pair@$$CBGI@std@@@2@@std@@QEAA@V-$initializer_list@U-$.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( (_BYTE)v10 )
    return v5;
  if ( qword_180246E10 == 0x666666666666666LL )
    std::_Throw_tree_length_error();
  v6 = qword_180246E08;
  *(_QWORD *)&v9 = &qword_180246E08;
  *((_QWORD *)&v9 + 1) = 0LL;
  v7 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x28uLL);
  *(_QWORD *)((char *)v7 + 28) = *a3;
  *v7 = v6;
  v7[1] = v6;
  v7[2] = v6;
  *((_WORD *)v7 + 12) = 0;
