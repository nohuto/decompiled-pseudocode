/*
 * XREFs of ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x18007FF1C
 * Callers:
 ...
 *     ??1?$enable_shared_from_this@VGestureHandler@@@std@@IEAA@XZ @ 0x1800941EC (--1-$enable_shared_from_this@VGestureHandler@@@std@@IEAA@XZ.c)
 ...
 *     ??1CustomCursorApplication2@@QEAA@XZ @ 0x1800F4720 (--1CustomCursorApplication2@@QEAA@XZ.c)
