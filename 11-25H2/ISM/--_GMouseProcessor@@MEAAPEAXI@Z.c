/*
 * XREFs of ??_GMouseProcessor@@MEAAPEAXI@Z @ 0x180191C70
 * Callers:
 *     ??_EMouseProcessor@@OCA@EAAPEAXI@Z @ 0x180191C60 (--_EMouseProcessor@@OCA@EAAPEAXI@Z.c)
 * Callees:
  ...
  if ( (a2 & 1) != 0 )
  {
    if ( (a2 & 4) != 0 )
      BamoImpl::BamoMPCConstantManagerClientProxyImpl::UpdateStateOfProxyOnPlaceholderProxyHookUp(
        this,
        (struct Microsoft::BamoImpl::BamoProxyImpl *)0x6B8);
    else
      free(this);
  }
  return this;
