/*
 * XREFs of std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_ShellGesturesProcessor::GestureRegistration_______lambda_28cbbaafa351dff69488e6a008c133d8___ @ 0x1800280F4
 * Callers:
