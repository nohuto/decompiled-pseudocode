/*
 * XREFs of ?ProtectMemory@SipcSection@@AEBAJ_K0K@Z @ 0x18009AB3C
 * Callers:
 *     ?ProtectExtraMemory@SipcSection@@IEBAXXZ @ 0x180085A34 (-ProtectExtraMemory@SipcSection@@IEBAXXZ.c)
 *     ?ProtectBuffer@SipcEndpoint@@UEAAJPEAX_K1@Z @ 0x18010DD90 (-ProtectBuffer@SipcEndpoint@@UEAAJPEAX_K1@Z.c)
 * Callees:
 *     <none>
 */
