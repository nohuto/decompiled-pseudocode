/*
 * XREFs of ?IsHovering@MPCGestureHandlerManager@@QEAA_NV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180068984
 * Callers:
 ...
 *     ?IsHoveringForDeviceId@ManipulationInjector@@QEBA_NK@Z @ 0x180096C24 (-IsHoveringForDeviceId@ManipulationInjector@@QEBA_NK@Z.c)
