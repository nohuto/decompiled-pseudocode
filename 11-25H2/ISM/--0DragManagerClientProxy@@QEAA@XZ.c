/*
 * XREFs of ??0DragManagerClientProxy@@QEAA@XZ @ 0x18002F100
 * Callers:
 ...
 *     ??0BamoDragManagerClientProxyImpl@BamoImpl@@QEAA@XZ @ 0x18002F0D0 (--0BamoDragManagerClientProxyImpl@BamoImpl@@QEAA@XZ.c)
 */
