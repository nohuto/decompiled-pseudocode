/*
 * XREFs of ?LogSendRegisterClient@BamoControllerNavigationManagerProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180119568
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationManagerProxyImpl::LogSendRegisterClient(
