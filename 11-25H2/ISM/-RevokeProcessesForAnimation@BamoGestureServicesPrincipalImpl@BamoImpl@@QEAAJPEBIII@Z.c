/*
 * XREFs of ?RevokeProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJPEBIII@Z @ 0x18003FDA8
 * Callers:
 *     ?Thunk_RevokeProcessesForAnimation_235@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141AB0 (-Thunk_RevokeProcessesForAnimation_235@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesP.c)
 * Callees:
