/*
 * XREFs of ?OnLightDismissClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005D1F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UILightDismissClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D268 (--$RemoveObject@UILightDismissClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
