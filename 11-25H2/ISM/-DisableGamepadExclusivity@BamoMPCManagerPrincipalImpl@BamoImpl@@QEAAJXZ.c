/*
 * XREFs of ?DisableGamepadExclusivity@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1800B86DC
 * Callers:
 *     ?Thunk_DisableGamepadExclusivity_41@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BB070 (-Thunk_DisableGamepadExclusivity_41@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@.c)
 * Callees:
