/*
 * XREFs of ?load_nothrow@tson@@YAXAEAVinput_archive@1@AEAUtest_flag@tip2@@@Z @ 0x180106B34
 * Callers:
...
void __fastcall tson::load_nothrow(tson *this, struct tson::input_archive *a2, struct tip2::test_flag *a3)
{
  ...
  struct tson::input_archive *v21; // [rsp+40h] [rbp-20h]
  const char *v22; // [rsp+48h] [rbp-18h] BYREF
  char v23; // [rsp+50h] [rbp-10h]
  void **v24; // [rsp+58h] [rbp-8h]
  void *v25; // [rsp+70h] [rbp+10h] BYREF
  ...
  *((_QWORD *)a2 + 1) = (char *)a2 + 40;
  ...
  v24 = (void **)((char *)a2 + 16);
  v20 = 6;
  tson::input_archive::process<tson::nvp<unsigned short &>>((__int64)this, (__int64)&v19);
  *((_BYTE *)this + 24) = 4;
  *((_QWORD *)this + 2) = "name";
  tson::input_archive::read_string_buffer<tson::ansistring_buffer_tag>(this, v6, (__int64)v18);
  tson::input_archive::process<tson::nvp<unsigned short &>>((__int64)this, (__int64)&v22);
  ...
  if ( v7 > 0x11 )
  {
    ...
    if ( !v14 )
    {
      ...
      v22 = "value";
      v24 = (void **)((char *)a2 + 24);
      tson::input_archive::operator()<tson::nvp<unsigned long &>>((__int64)this, (__int64)&v22);
      return;
    }
    v15 = v14 - 1;
    if ( !v15 )
    {
      ...
      v22 = "value";
      v24 = (void **)((char *)a2 + 24);
      tson::input_archive::operator()<tson::nvp<__int64 &>>((__int64)this, (__int64)&v22);
      return;
    }
    v16 = v15 - 1;
    if ( !v16 )
    {
      ...
      v22 = "value";
      v24 = (void **)((char *)a2 + 24);
      tson::input_archive::operator()<tson::nvp<unsigned __int64 &>>((__int64)this, (__int64)&v22);
      return;
    }
    v17 = v16 - 9;
    if ( !v17 )
    ...
    if ( v17 == 1 )
    {
      ...
      *((_QWORD *)this + 2) = "value";
      *((_BYTE *)this + 24) = 5;
      tson::input_archive::read_cotaskmem_string<tson::string_tag,wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>>>(
        this,
        (__int64)&v25);
      *((_QWORD *)a2 + 3) = v25;
      v25 = 0LL;
  ...
  if ( v7 == 17 )
  {
    ...
    v22 = "value";
    v24 = (void **)((char *)a2 + 24);
    tson::input_archive::operator()<tson::nvp<unsigned char &>>(this, (__int64)&v22);
    return;
  }
  if ( !*v3 )
    return;
  ...
  if ( !v8 )
  {
    ...
    v22 = "value";
    v24 = (void **)((char *)a2 + 24);
    tson::input_archive::operator()<tson::nvp<short &>>((__int64)this, (__int64)&v22);
    return;
  }
  v9 = v8 - 1;
  if ( !v9 )
  {
    ...
    v22 = "value";
    v24 = (void **)((char *)a2 + 24);
    tson::input_archive::process<tson::nvp<long &>>((__int64)this, (__int64)&v22);
    return;
  }
  v10 = v9 - 2;
  if ( !v10 )
  {
    ...
    v22 = "value";
    v24 = (void **)((char *)a2 + 24);
    tson::input_archive::operator()<tson::nvp<double &>>((__int64)this, (__int64)&v22);
    return;
  }
  v11 = v10 - 6;
  if ( v11 )
  {
    if ( v11 == 5 )
    {
      ...
      v22 = "value";
      v24 = (void **)((char *)a2 + 24);
      tson::input_archive::operator()<tson::nvp<char &>>((__int64)this, (__int64)&v22);
      return;
    }
LABEL_24:
    if ( *((int *)this + 2) >= 0 )
  ...
  v23 = 5;
  v24 = &v25;
  tson::input_archive::process<tson::nvp<bool &>>((__int64 *)this, (__int64)&v22);
  if ( (_BYTE)v25 )
    v12 = -1;
  else
    v12 = 0;
