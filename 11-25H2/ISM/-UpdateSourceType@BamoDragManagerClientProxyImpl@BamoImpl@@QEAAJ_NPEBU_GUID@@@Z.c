/*
 * XREFs of ?UpdateSourceType@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x18007C688
 * Callers:
 *     ?Thunk_UpdateSourceType_47@?$IDragManagerClientProxy_Receive@VBamoDragManagerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800989A0 (-Thunk_UpdateSourceType_47@-$IDragManagerClientProxy_Receive@VBamoDragManagerClientProxyImpl@Bam.c)
