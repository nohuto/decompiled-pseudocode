/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180073C00
 * Callers:
 ...
 *     memmove_s @ 0x18007409C (memmove_s.c)
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x180074104 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
