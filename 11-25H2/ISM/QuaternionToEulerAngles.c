/*
 * XREFs of QuaternionToEulerAngles @ 0x1800323F0
 * Callers:
 ...
 * Callees:
 *     ?XMMatrixRotationQuaternion@DirectX@@YQ?AUXMMATRIX@1@T__m128@@@Z @ 0x1800325D4 (-XMMatrixRotationQuaternion@DirectX@@YQ-AUXMMATRIX@1@T__m128@@@Z.c)
...
LABEL_12:
  ...
  *a4 = 0;
  ...
  v11 = _mm_add_ps(v10, _mm_shuffle_ps(v8, v10, 240));
  v12 = _mm_shuffle_ps(v11, v11, 170);
  DirectX::XMMatrixRotationQuaternion();
  v13 = _mm_shuffle_ps(
          _mm_cmpneq_ps(_mm_sqrt_ps(v12), (__m128)0LL),
          _mm_andnot_ps(_mm_cmpneq_ps(DirectX::g_XMInfinity, v12), DirectX::g_XMQNaN),
          73);
  v14 = 0;
  v15 = 0;
