/*
 * XREFs of ?UpdateDeviceDockServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180125F1C
 * Callers:
 *     ?Thunk_UpdateDeviceDockServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801248B0 (-Thunk_UpdateDeviceDockServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
...
__int64 __fastcall BamoImpl::BamoInputSystemProxyImpl::UpdateDeviceDockServer(
        ...
        __int64 a3)
{
  ...
  struct BamoDeviceDockServerProxy *v7; // rsi
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnDeviceDockServerChanging((BamoImpl::BamoInputSystemProxyImpl *)((char *)this - 16), v7);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct BamoDeviceDockServerProxy *))(*((_QWORD *)this - 2) + 136LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
  ...
  *((_QWORD *)this + 6) = v7;
  if ( v7 )
    (**(void (__fastcall ***)(struct BamoDeviceDockServerProxy *))v7)(v7);
  if ( v13 )
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnDeviceDockServerChanged((BamoImpl::BamoInputSystemProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 144LL))((char *)this - 16);
    if ( v14 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x3455,
