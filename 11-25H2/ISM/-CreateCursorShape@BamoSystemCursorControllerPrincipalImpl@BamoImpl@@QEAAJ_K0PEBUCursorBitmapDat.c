/*
 * XREFs of ?CreateCursorShape@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0PEBUCursorBitmapDataHeader@@IPEBEI@Z @ 0x1800F4D1C
 * Callers:
 *     ?Thunk_CreateCursorShape_394@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6420 (-Thunk_CreateCursorShape_394@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControl.c)
 * Callees:
