/*
 * XREFs of ??1?$unique_ptr@GU?$default_delete@G@std@@@std@@QEAA@XZ @ 0x18009BE94
 * Callers:
 ...
 *     _PnpApiWrapper::Details::EnumerateDevices_::_1_::dtor$0 @ 0x1801CA72E (_PnpApiWrapper--Details--EnumerateDevices_--_1_--dtor$0.c)
 * Callees:
