/*
 * XREFs of ?QueryInterface@BamoEdgyControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180154CE0
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180154D70 (-QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
