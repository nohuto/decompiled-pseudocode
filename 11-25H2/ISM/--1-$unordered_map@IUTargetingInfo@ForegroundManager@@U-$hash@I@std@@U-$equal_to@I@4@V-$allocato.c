/*
 * XREFs of ??1?$unordered_map@IUTargetingInfo@ForegroundManager@@U?$hash@I@std@@U?$equal_to@I@4@V?$allocator@U?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@@4@@std@@QEAA@XZ @ 0x1800ADCA4
 * Callers:
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$2 @ 0x1801CB04D (_ResizeProcessor--ResizeProcessor_--_1_--dtor$2.c)
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$4 @ 0x1801CFF02 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
