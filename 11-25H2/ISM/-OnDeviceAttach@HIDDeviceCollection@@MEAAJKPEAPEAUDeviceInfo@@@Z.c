/*
 * XREFs of ?OnDeviceAttach@HIDDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x18005F2B0
 * Callers:
 ...
 *     ?ConvertHIDTLCIdToInputType@HIDDeviceCollection@@AEAAJGGPEAW4InputType@@@Z @ 0x18005F5D4 (-ConvertHIDTLCIdToInputType@HIDDeviceCollection@@AEAAJGGPEAW4InputType@@@Z.c)
...
LABEL_17:
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(HIDDeviceCollection *, _QWORD))(*(_QWORD *)this + 96LL))(
          this,
          *((_QWORD *)this + i + 78)) )
  {
    v14 = -2147418113;
