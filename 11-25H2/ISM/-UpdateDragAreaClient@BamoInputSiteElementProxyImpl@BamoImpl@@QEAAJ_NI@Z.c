/*
 * XREFs of ?UpdateDragAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18004498C
 * Callers:
 *     ?Thunk_UpdateDragAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180073140 (-Thunk_UpdateDragAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@Ba.c)
