/*
 * XREFs of ??$SpatialInteractionDLL_LoadFailure@AEAJ@RawInputProvidersTracing@@SAXAEAJ@Z @ 0x1800D1544
 * Callers:
...
char __fastcall RawInputProvidersTracing::SpatialInteractionDLL_LoadFailure<long &>(int *a1)
{
