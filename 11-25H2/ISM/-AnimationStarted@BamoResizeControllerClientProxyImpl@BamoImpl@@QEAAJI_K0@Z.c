/*
 * XREFs of ?AnimationStarted@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJI_K0@Z @ 0x1801130FC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      BamoImpl::BamoResizeControllerClientProxyImpl::LogSendAnimationStarted(this, a2, a3, (unsigned __int64)a4);
