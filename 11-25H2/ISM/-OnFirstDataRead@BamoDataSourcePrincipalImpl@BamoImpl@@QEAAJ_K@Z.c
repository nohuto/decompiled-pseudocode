/*
 * XREFs of ?OnFirstDataRead@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180096A74
 * Callers:
 *     ?Thunk_OnFirstDataRead_0@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180103C40 (-Thunk_OnFirstDataRead_0@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@.c)
 * Callees:
