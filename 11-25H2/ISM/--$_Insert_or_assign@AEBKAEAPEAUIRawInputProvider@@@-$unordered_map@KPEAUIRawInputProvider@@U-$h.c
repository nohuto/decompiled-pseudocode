        ...
        _QWORD *a4)
{
  ...
  else
  {
    ...
    v20 = a1 + 1;
    v21 &= *((_QWORD *)&v19 + 1);
    v11 = std::_Allocate<16,std::_Default_allocate_traits,0>((unsigned int)(DWORD2(v19) + 32));
    ...
    *((_QWORD *)v11 + 3) = *a4;
    ...
    if ( v14 < 0 )
    {
      v17 = a1[7] & 1LL | ((unsigned __int64)v14 >> 1);
    ...
    if ( (float)(v13 / v15) > *(float *)a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned int,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView>>,0>>::_Forced_rehash(
        a1,
        v18);
      v19 = *(_OWORD *)std::_Hash<std::_Umap_traits<unsigned long,IRawInputProvider *,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,IRawInputProvider *>>,0>>::_Find_last<unsigned long>(
                         a1,
                         &v20,
                         v11 + 4,
                         v8);
