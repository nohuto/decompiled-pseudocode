/*
 * XREFs of ?LogReceiveUnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@AEAAXW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x1801364DC
 * Callers:
