/*
 * XREFs of wil::init_once_nothrow__lambda_5074a8db83a03a7ac14dcc5db321bd88___ @ 0x180108724
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !__std_init_once_begin_initialize(&stru_180247908, 0, &fPending, 0LL) )
  ...
  if ( fPending )
  {
    ...
    if ( NtQuerySystemInformation(MaxSystemInfoClass|SystemProcessInformation, &SystemInformation, 8u, 0LL) >= 0 )
      byte_180247910 = (SystemInformation & 0x200000000LL) != 0;
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_180247908, 0, 0LL);
  }
  return 0LL;
}
