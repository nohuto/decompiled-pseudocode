/*
 * XREFs of ?LogSetResizeContextualProcessor@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoResizeContextualProcessorPrincipal@@@Z @ 0x1800910D0
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetResizeContextualProcessor(
