/*
 * XREFs of ?FreeSection@SipcPort@@QEAAJPEAX@Z @ 0x18010CF1C
 * Callers:
 *     ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x180062840 (-DispatchNextCallback@SipcServer@@UEAAJXZ.c)
 *     ?UnmapBuffer@SipcEndpoint@@UEAAJPEAX@Z @ 0x18010E980 (-UnmapBuffer@SipcEndpoint@@UEAAJPEAX@Z.c)
 * Callees:
 *     ?FindSection@SipcPort@@IEAAPEAVSipcSection@@PEAX@Z @ 0x18010CEE4 (-FindSection@SipcPort@@IEAAPEAVSipcSection@@PEAX@Z.c)
