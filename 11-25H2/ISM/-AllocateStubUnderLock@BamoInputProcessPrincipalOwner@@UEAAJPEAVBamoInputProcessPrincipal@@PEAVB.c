/*
 * XREFs of ?AllocateStubUnderLock@BamoInputProcessPrincipalOwner@@UEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputProcessStub@@@Z @ 0x1800C9D30
 * Callers:
 *     <none>
 * Callees:
