/*
 * XREFs of ??$QueryInterface@VBamoComponentSiteInputObjectProxy@@UIComponentSiteInputObjectProxy@@@Util@BamoImpl@Microsoft@@YAJPEAVBamoComponentSiteInputObjectProxy@@AEBU_GUID@@PEAPEAX@Z @ 0x180096E04
 * Callers:
 *     ?QueryInterface@BamoComponentSiteInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009C260 (-QueryInterface@BamoComponentSiteInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
