/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x180100ED8
 * Callers:
 *     ?Thunk_OnAllReadersDisconnected_3@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180103C30 (-Thunk_OnAllReadersDisconnected_3@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImp.c)
 * Callees:
