/*
 * XREFs of ?QueryInterface@BamoSystemContextManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013C8C0
 * Callers:
 *     ?QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013C950 (-QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
