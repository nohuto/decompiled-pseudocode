/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18013C3E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoInputSpacePayloadPrincipalImpl::PushStateToProxyOnOutboundMessagesResumed(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v9);
  BamoImpl::BamoInputSpacePayloadPrincipalImpl::PushStateToProxy(this, a3);
  Microsoft::BamoImpl::BamoPrincipalImpl::GetItemId(this);
  v10 = *(unsigned int *)(v3 + 36);
  v11 = *(unsigned int *)(v3 + 40);
  LOWORD(v9) = 88;
