/*
 * XREFs of ?get@?$static_lazy@VControllerProcessorTelemetry@@@details@wil@@QEAAPEAVControllerProcessorTelemetry@@P6AXXZ@Z @ 0x18017CBFC
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<ControllerProcessorTelemetry>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && v6 )
  {
    ...
    dword_180247E94 = 0;
    v8 = &qword_180247E80;
    qword_180247E80 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    v4 = &`ControllerProcessorTelemetry::Instance'::`2'::wrapper;
    byte_180247E90 = 0;
    qword_180247E98 = (__int64)&`ControllerProcessorTelemetry::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
