/*
 * XREFs of ??0SpectrumListener@@QEAA@PEAVMPCRawInputProvider@@@Z @ 0x1800CDBA8
 * Callers:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIHeadEventHandler@@@WRL@Microsoft@@QEAA@XZ @ 0x1800CDB64 (--0-$RuntimeClass@U-$RuntimeClassFlags@$01@WRL@Microsoft@@UIHeadEventHandler@@@WRL@Microsoft@@QE.c)
...
SpectrumListener *__fastcall SpectrumListener::SpectrumListener(SpectrumListener *this, struct MPCRawInputProvider *a2)
{
  ...
  *((_DWORD *)this + 21) = 0;
  ...
  v6 = Windows::Foundation::ActivateInstance<Windows::UI::Input::Spatial::Internal::IInputPriv>(v5, (_QWORD *)this + 3);
  if ( v6 < 0 )
  ...
  *v9 = 0LL;
  ...
  if ( v17 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v22);
  v18 = std::make_unique<SpeechRuntimeListener,MPCRawInputProvider * &,unsigned long &,0>(&v22, v26, (int *)this + 20);
  v19 = *v18;
  *v18 = 0LL;
  v20 = *((_QWORD *)this + 4);
  *((_QWORD *)this + 4) = v19;
  ...
  std::unique_ptr<SpeechRuntimeListener>::~unique_ptr<SpeechRuntimeListener>(&v22);
  *((_BYTE *)this + 72) = 1;
  return this;
}
