/*
 * XREFs of ?AllocateStubUnderLock@BamoSystemContextManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSystemContextManagerStub@@@Z @ 0x18013A040
 * Callers:
 *     <none>
 * Callees:
