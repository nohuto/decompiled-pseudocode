/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180070840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerStubImpl::OnConnectedUnderLockThunk(
