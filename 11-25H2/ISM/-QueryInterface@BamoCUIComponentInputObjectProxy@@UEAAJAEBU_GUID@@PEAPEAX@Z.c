/*
 * XREFs of ?QueryInterface@BamoCUIComponentInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801303D0
 * Callers:
 *     ?QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180130460 (-QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
