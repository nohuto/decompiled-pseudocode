/*
 * XREFs of ?GetRegion@BamoResizeAreaClientProxy@@UEAA?AW4InputResizeRegion@Input@Internal@UI@Windows@@XZ @ 0x180115390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoResizeAreaClientProxy::GetRegion(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rdx
  __int64 v3; // r8
