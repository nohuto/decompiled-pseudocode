/*
 * XREFs of ?LogSetInputDeliveryServer@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputDeliveryServerPrincipal@@@Z @ 0x1800929A0
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetInputDeliveryServer(
