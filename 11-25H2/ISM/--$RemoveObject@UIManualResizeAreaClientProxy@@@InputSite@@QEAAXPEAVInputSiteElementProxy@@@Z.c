/*
 * XREFs of ??$RemoveObject@UIManualResizeAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003BC98
 * Callers:
...
void __fastcall InputSite::RemoveObject<IManualResizeAreaClientProxy>(
        __int64 a1,
