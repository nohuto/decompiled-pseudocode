/*
 * XREFs of ?UpdateResumePosition@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x18017758C
 * Callers:
 *     ?Thunk_UpdateResumePosition_23@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180176E60 (-Thunk_UpdateResumePosition_23@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavig.c)
