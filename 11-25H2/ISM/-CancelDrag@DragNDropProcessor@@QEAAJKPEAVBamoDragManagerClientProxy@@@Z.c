/*
 * XREFs of ?CancelDrag@DragNDropProcessor@@QEAAJKPEAVBamoDragManagerClientProxy@@@Z @ 0x180148950
 * Callers:
 ...
 *     ?OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z @ 0x180146794 (-OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z.c)
