/*
 * XREFs of ?Thunk_UpdateHitTestConfiguration_16@?$IResizeControllerClientProxy_Receive@VBamoResizeControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124B10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
