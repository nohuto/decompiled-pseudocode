/*
 * XREFs of ?ReceiveCoreMessagingK@ISM@InputTraceLogging@@SAXW4_MIT_ENDPOINT@@@Z @ 0x18001C69C
 * Callers:
 ...
 *     ?MitEndpointToString@InputTraceLogging@@CAPEBDW4_MIT_ENDPOINT@@@Z @ 0x1800AF254 (-MitEndpointToString@InputTraceLogging@@CAPEBDW4_MIT_ENDPOINT@@@Z.c)
 */
...
__int64 __fastcall InputTraceLogging::ISM::ReceiveCoreMessagingK(unsigned int a1)
{
  ...
  if ( *(_DWORD *)result > 4u )
  {
    v4 = *(_DWORD *)(result + 16);
    result = 512LL;
    if ( (v4 & 0x200) != 0 && (*(_QWORD *)(v3 + 24) & 0x200LL) == *(_QWORD *)(v3 + 24) )
    {
      v6 = (const unsigned __int16 *)InputTraceLogging::MitEndpointToString(a1);
      return _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
               v5,
               (__int64)&unk_180205FD0,
               0LL,
               0LL,
               &v6);
    }
