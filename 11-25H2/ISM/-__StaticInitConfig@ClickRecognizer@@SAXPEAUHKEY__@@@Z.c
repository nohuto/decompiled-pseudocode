/*
 * XREFs of ?__StaticInitConfig@ClickRecognizer@@SAXPEAUHKEY__@@@Z @ 0x1801AD8C8
 * Callers:
...
void __fastcall ClickRecognizer::__StaticInitConfig(HKEY a1)
{
  ...
  if ( ClickRecognizer::s_tapAndHoldStartTimeThreshold < ClickRecognizer::s_tapAndShortHoldTimeThreshold )
    ClickRecognizer::s_tapAndShortHoldTimeThreshold = ClickRecognizer::s_tapAndHoldStartTimeThreshold;
