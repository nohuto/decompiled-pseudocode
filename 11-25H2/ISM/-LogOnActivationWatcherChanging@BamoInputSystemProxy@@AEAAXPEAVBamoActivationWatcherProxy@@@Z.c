/*
 * XREFs of ?LogOnActivationWatcherChanging@BamoInputSystemProxy@@AEAAXPEAVBamoActivationWatcherProxy@@@Z @ 0x18011579C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnActivationWatcherChanging(
        BamoInputSystemProxy *this,
        struct BamoActivationWatcherProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
