/*
 * XREFs of ??$MakeAndInitialize@VHotkeyRegistrationForwarder@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyRegistrationForwarder@@@Z @ 0x1800793DC
 * Callers:
 ...
 *     ??0HotkeyRegistrationForwarder@@QEAA@XZ @ 0x1800795C8 (--0HotkeyRegistrationForwarder@@QEAA@XZ.c)
