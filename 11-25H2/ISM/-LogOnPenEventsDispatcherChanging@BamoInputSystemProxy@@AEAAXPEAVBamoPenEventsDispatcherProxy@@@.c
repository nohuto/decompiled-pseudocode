/*
 * XREFs of ?LogOnPenEventsDispatcherChanging@BamoInputSystemProxy@@AEAAXPEAVBamoPenEventsDispatcherProxy@@@Z @ 0x1801178AC
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnPenEventsDispatcherChanging(
        BamoInputSystemProxy *this,
        struct BamoPenEventsDispatcherProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
