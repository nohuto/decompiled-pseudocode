/*
 * XREFs of ?QueryInterface@BamoTestCommandsPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019AF10
 * Callers:
 *     ?QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019AFA0 (-QueryInterface@BamoTestCommandsPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
