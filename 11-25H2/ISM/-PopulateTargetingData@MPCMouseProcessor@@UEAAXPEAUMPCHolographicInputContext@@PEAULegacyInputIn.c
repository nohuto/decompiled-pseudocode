/*
 * XREFs of ?PopulateTargetingData@MPCMouseProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1801BB330
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??DNumerics@Foundation@Windows@@YA?AUquaternion@012@AEBU3012@0@Z @ 0x1800C83A4 (--DNumerics@Foundation@Windows@@YA-AUquaternion@012@AEBU3012@0@Z.c)
 *     ?Reset@RayStabilizer@@QEAAXXZ @ 0x1800C92A8 (-Reset@RayStabilizer@@QEAAXXZ.c)
 *     ?make_quaternion_from_axis_angle@Numerics@Foundation@Windows@@YA?AUquaternion@123@AEBUfloat3@123@M@Z @ 0x1800C96D0 (-make_quaternion_from_axis_angle@Numerics@Foundation@Windows@@YA-AUquaternion@123@AEBUfloat3@123.c)
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HolographicMouseGameMode@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801BC1C0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_HolographicMouseGameMode@@@details@wil@@Q.c)
 *     ?make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBUquaternion@123@@Z @ 0x1801BC26C (-make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA-AUfloat4x4@123@AEBUquaternion@123.c)
        ...
        struct LegacyInputInfo *a3)
{
  ...
  *(_QWORD *)v75 = *(_QWORD *)((char *)a2 + 180);
  ...
  if ( *((_QWORD *)this + 1052) )
  {
    ...
    v72.m128_u64[1] = 48LL;
    if ( (float)((double)(Ticks.LowPart - *((_DWORD *)this + 2104)) / (double)(int)qword_180246DE0) > (double)MPCConstantManager::GetConstant<float>((__int64)Instance, (unsigned __int64)this & -(__int64)(this != (MPCMouseProcessor *)40), (__int128 *)&v72) )
    {
...
LABEL_31:
  ...
  *((_BYTE *)a3 + 89) = 0;
    ...
    && (((_DWORD)v86 == DWORD2(v86)) == DWORD1(v86)) == HIDWORD(v86) )
  {
    ...
    v79 = 0;
    *(_QWORD *)v75 = 0LL;
    v65 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 64LL))(*((_QWORD *)this + 2));
