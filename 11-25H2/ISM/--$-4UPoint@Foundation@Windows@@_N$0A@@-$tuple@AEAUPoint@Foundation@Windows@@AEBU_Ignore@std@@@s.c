/*
 * XREFs of ??$?4UPoint@Foundation@Windows@@_N$0A@@?$tuple@AEAUPoint@Foundation@Windows@@AEBU_Ignore@std@@@std@@QEAAAEAV01@$$QEAV?$tuple@UPoint@Foundation@Windows@@_N@1@@Z @ 0x1801A7150
 * Callers:
