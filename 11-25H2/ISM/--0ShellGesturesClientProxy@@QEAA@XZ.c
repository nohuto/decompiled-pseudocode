/*
 * XREFs of ??0ShellGesturesClientProxy@@QEAA@XZ @ 0x180090BB4
 * Callers:
 ...
 * Callees:
 *     ??0BamoShellGesturesClientProxyImpl@BamoImpl@@QEAA@XZ @ 0x180090C34 (--0BamoShellGesturesClientProxyImpl@BamoImpl@@QEAA@XZ.c)
 */
