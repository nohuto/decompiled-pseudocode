/*
 * XREFs of ?LogOnEatPolicyChanging@BamoActivationConfigurationInputObjectProxy@@AEAAXI@Z @ 0x18009B948
 * Callers:
...
void __fastcall BamoActivationConfigurationInputObjectProxy::LogOnEatPolicyChanging(
