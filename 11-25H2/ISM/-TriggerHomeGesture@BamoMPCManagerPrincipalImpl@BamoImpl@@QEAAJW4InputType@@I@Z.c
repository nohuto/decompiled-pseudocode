/*
 * XREFs of ?TriggerHomeGesture@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x1800BB1E8
 * Callers:
 *     ?Thunk_TriggerHomeGesture_21@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BB1A0 (-Thunk_TriggerHomeGesture_21@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImp.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerPrincipalImpl::TriggerHomeGesture(int *a1, unsigned int a2, unsigned int a3)
{
  int v6; // edi
  ...
  if ( a1[2] > 0 )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(int *, __int64, _QWORD, _QWORD))(*((_QWORD *)a1 - 2) + 136LL))(a1 - 4, v8, a2, a3);
    v6 = v11;
    if ( v11 == -2018375668 )
    {
