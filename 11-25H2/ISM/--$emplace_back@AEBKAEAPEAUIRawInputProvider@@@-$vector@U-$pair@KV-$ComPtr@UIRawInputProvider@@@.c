/*
 * XREFs of ??$emplace_back@AEBKAEAPEAUIRawInputProvider@@@?$vector@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@@2@@std@@QEAA?A_TAEBKAEAPEAUIRawInputProvider@@@Z @ 0x18008AB74
 * Callers:
 ...
 *     ??$?0AEBKAEAPEAUIRawInputProvider@@$0A@@?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@QEAA@AEBKAEAPEAUIRawInputProvider@@@Z @ 0x180091AB4 (--$-0AEBKAEAPEAUIRawInputProvider@@$0A@@-$pair@KV-$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@s.c)
 */
