/*
 * XREFs of ?UpdateSecondaryClickZone@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x180134E9C
 * Callers:
 *     ?Thunk_UpdateSecondaryClickZone_418@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134AD0 (-Thunk_UpdateSecondaryClickZone_418@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchp.c)
