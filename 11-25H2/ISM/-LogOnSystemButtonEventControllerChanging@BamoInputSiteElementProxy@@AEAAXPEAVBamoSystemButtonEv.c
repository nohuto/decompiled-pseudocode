/*
 * XREFs of ?LogOnSystemButtonEventControllerChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoSystemButtonEventControllerProxy@@@Z @ 0x18008BB20
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnSystemButtonEventControllerChanging(
