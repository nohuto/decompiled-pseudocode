/*
 * XREFs of ?LogSendDeviceRemoved@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@AEAAX_K@Z @ 0x1801190C8
 * Callers:
...
void __fastcall BamoImpl::BamoSystemCursorControllerClientProxyImpl::LogSendDeviceRemoved(
