/*
 * XREFs of ?ProcessHomeGesture@MPCSixDofProcessor@@AEAAXPEAULegacyInputInfo@@@Z @ 0x18000FE98
 * Callers:
 ...
 *     ?ResetHomeState@MPCSixDofProcessor@@AEAAXXZ @ 0x1801B5508 (-ResetHomeState@MPCSixDofProcessor@@AEAAXXZ.c)
        ...
        const char *a4)
{
  ...
  *(_QWORD *)&v101 = L"HomeCancelExceedThresholdMaxCount";
  ...
  if ( v6 || *(_BYTE *)(*((_QWORD *)this + 513) + 12LL) )
  {
    ...
    v108 = 0.0;
    v109 = 0.0;
    v52 = (double)(int)v51 / (double)(int)qword_180246DE0;
    if ( v52 > 0.0 )
    {
      if ( *((_BYTE *)a2 + 2440) )
      {
    ...
    if ( *(_BYTE *)(v57 + 10) )
    {
      ...
      v59 = (double)(int)v58 / (double)(int)qword_180246DE0;
      ...
      if ( LODWORD(v103) < v102 && (*((_BYTE *)a2 + 2280) & 0x3E) != 0 )
      {
        if ( *((_DWORD *)a2 + 17) == 3 )
        {
          *((_DWORD *)a2 + 17) = 2;
          ...
          LOBYTE(v118) = 1;
          v102 = *v87;
          v103 = v86 / (double)(int)qword_180246DE0;
  ...
  if ( *(_BYTE *)(*((_QWORD *)this + 512) + 12LL) )
  {
    if ( !v27 && *v83 )
    {
      if ( !*((_BYTE *)this + 4297) )
      {
        ...
        LOBYTE(v118) = 1;
        v102 = **((_DWORD **)this + 6);
        v103 = (double)(int)v89 / (double)(int)qword_180246DE0;
        ISMTracing::MPCSixDofProcessor_HomeEvent<unsigned long,bool,bool,bool &,bool &,unsigned int const &,bool &,float,bool>(
          (unsigned int)&v102,
          (unsigned int)&v118,
          (unsigned int)&v117,
...
LABEL_63:
    ...
    LOBYTE(v118) = 0;
    v102 = *v95;
    v103 = v94 / (double)(int)qword_180246DE0;
    ISMTracing::MPCSixDofProcessor_HomeEvent<unsigned long,bool,bool,bool &,bool &,unsigned int const &,bool &,float,bool>(
      (unsigned int)&v102,
      (unsigned int)&v118,
      (unsigned int)&v117,
