/*
 * XREFs of ?SampleRandomPickStart@InputServiceProxy@@AEAAXIIGGG_K@Z @ 0x18015D9C0
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  {
    if ( (unsigned int)dword_180244328 > 5 && tlgKeywordOn((__int64)&dword_180244328, 0x400000000001LL) )
    {
      v17 = *((_QWORD *)this + 7);
      v24 = *(_QWORD *)(v17 + 40);
