/*
 * XREFs of ?Materialize_BamoEdgyDragSourceClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011B784
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyDragSourceClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124380 (-Thunk_Materialize_BamoEdgyDragSourceClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
