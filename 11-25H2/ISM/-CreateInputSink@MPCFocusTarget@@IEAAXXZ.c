/*
 * XREFs of ?CreateInputSink@MPCFocusTarget@@IEAAXXZ @ 0x1800FD7E0
 * Callers:
 ...
 *     ?OnFrameworkViewTypeUpdated@MPCFocusTarget@@MEAAXXZ @ 0x1800FDBD0 (-OnFrameworkViewTypeUpdated@MPCFocusTarget@@MEAAXXZ.c)
 * Callees:
