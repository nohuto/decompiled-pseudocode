/*
 * XREFs of ?_Growmap@?$deque@UPointerFrame@PointerInputMediator@@V?$allocator@UPointerFrame@PointerInputMediator@@@std@@@std@@AEAAX_K@Z @ 0x1800F167C
 * Callers:
...
void __fastcall std::deque<PointerInputMediator::PointerFrame>::_Growmap(_QWORD *a1)
{
