/*
 * XREFs of ?ApproveProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJPEBIII@Z @ 0x180040030
 * Callers:
 *     ?Thunk_ApproveProcessesForAnimation_235@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141A10 (-Thunk_ApproveProcessesForAnimation_235@-$IGestureServicesPrincipal_Receive@VBamoGestureServices.c)
 * Callees:
