/*
 * XREFs of ?CreateCursorForDevice@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x180113F20
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      BamoImpl::BamoSystemCursorControllerProxyImpl::LogSendCreateCursorForDevice(this, a2);
      v12[0] = v14;
      v12[1] = v15;
