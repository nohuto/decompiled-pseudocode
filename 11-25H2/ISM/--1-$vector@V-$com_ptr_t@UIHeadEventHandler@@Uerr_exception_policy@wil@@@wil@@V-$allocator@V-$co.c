/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180068520
 * Callers:
 *     _MPCHeadUpdateListener::OnHeadEventOccurredWorkerThread_::_1_::dtor$2 @ 0x1801CBAA6 (_MPCHeadUpdateListener--OnHeadEventOccurredWorkerThread_--_1_--dtor$2.c)
 *     _MPCGestureHandler::MPCGestureHandler_::_1_::dtor$5 @ 0x1801CDA52 (_MPCGestureHandler--MPCGestureHandler_--_1_--dtor$5.c)
 *     _PenDevice::PenDevice_::_1_::dtor$1 @ 0x1801D103B (_PenDevice--PenDevice_--_1_--dtor$1.c)
 * Callees:
