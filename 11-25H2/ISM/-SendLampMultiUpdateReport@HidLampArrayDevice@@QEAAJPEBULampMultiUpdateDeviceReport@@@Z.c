/*
 * XREFs of ?SendLampMultiUpdateReport@HidLampArrayDevice@@QEAAJPEBULampMultiUpdateDeviceReport@@@Z @ 0x180077FD8
 * Callers:
        ...
        __int64 a4)
{
  ...
  ReportBuffer = 0LL;
  v8 = HidLampMultiUpdateReportParser::CreateAndInitializeOutputBuffer(
         v7,
         a2,
         (int *)&ReportBuffer,
         &ReportBufferLength);
