/*
 * XREFs of ?BroadcastRemoteClear@BamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJXZ @ 0x18013A450
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::ConnectionIndirector **this)
{
  ...
  LODWORD(v1) = Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_DisplayOcclusionRect_PrincipalImpl::BroadcastRemoteClear((Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_DisplayOcclusionRect_PrincipalImpl *)(v1 + 1));
