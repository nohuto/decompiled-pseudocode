/*
 * XREFs of ?SetPrimaryUsageId@BamoDockableDevicePrincipal@@UEAAXG@Z @ 0x1801801A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdatePrimaryUsageIdRemoteCacheStatic@BamoDockableDevicePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x180180AEC (-UpdatePrimaryUsageIdRemoteCacheStatic@BamoDockableDevicePrincipalImpl@BamoImpl@@CAJPEAVBamoStub.c)
 */
        ...
        __int16 a2)
{
  ...
  *((_WORD *)v3 + 35) = a2;
  BamoImpl::BamoDockableDevicePrincipalImpl::LogSetPrimaryUsageId((BamoImpl::BamoDockableDevicePrincipalImpl *)v3);
