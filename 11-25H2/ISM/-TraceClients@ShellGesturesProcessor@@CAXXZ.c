/*
 * XREFs of ?TraceClients@ShellGesturesProcessor@@CAXXZ @ 0x180089D50
 * Callers:
 ...
 *     ?IsDetachedFromTree@ShellGesturesClientProxy@@QEAA_NXZ @ 0x180080970 (-IsDetachedFromTree@ShellGesturesClientProxy@@QEAA_NXZ.c)
 ...
 *     ?Enabled@InputTraceLogging@@SA_NW4InputTraceKeywords@@E@Z @ 0x180089EA0 (-Enabled@InputTraceLogging@@SA_NW4InputTraceKeywords@@E@Z.c)
...
void ShellGesturesProcessor::TraceClients(void)
{
  ...
  if ( (unsigned __int8)InputTraceLogging::Enabled(512LL, 0LL) )
  {
    ...
    v14 = Instance;
    v1 = qword_180246F38;
    v2 = qword_180246F38 + qword_180246F40;
    v13 = qword_180246F38 + qword_180246F40;
    while ( 1 )
    {
      v12 = v1;
      if ( v1 == v2 )
        break;
      v3 = *(_QWORD **)(*((_QWORD *)Src + ((qword_180246F30 - 1) & (v1 >> 1))) + 8 * (v1 & 1));
