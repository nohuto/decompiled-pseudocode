/*
 * XREFs of ?UpdatePrimaryClickZone@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x180134D70
 * Callers:
 *     ?Thunk_UpdatePrimaryClickZone_418@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134AC0 (-Thunk_UpdatePrimaryClickZone_418@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpad.c)
