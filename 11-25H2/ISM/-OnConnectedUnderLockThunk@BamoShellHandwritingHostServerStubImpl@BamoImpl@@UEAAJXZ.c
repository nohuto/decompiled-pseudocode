/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoShellHandwritingHostServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180076B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoShellHandwritingHostServerStubImpl::OnConnectedUnderLockThunk(
