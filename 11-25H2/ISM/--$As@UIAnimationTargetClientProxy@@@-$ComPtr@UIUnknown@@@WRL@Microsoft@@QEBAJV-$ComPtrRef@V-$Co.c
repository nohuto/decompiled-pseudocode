/*
 * XREFs of ??$As@UIAnimationTargetClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIAnimationTargetClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005C948
 * Callers:
