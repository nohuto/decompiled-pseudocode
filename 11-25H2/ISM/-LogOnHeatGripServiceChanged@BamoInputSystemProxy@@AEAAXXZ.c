/*
 * XREFs of ?LogOnHeatGripServiceChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180116AD4
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnHeatGripServiceChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
