/*
 * XREFs of ?StartManipulation@ManipulationInjector@@AEAAXW4INTERACTION_TYPE@@UtagPOINT@@K@Z @ 0x1801109DC
 * Callers:
 ...
 *     ?UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z @ 0x180110FB4 (-UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z.c)
 *     ?ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ @ 0x180111098 (-ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ.c)
 */
