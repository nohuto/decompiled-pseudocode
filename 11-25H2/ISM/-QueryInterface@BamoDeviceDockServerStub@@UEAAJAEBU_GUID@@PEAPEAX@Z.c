/*
 * XREFs of ?QueryInterface@BamoDeviceDockServerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F030
 * Callers:
 *     ?QueryInterface@BamoDeviceDockServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F0C0 (-QueryInterface@BamoDeviceDockServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
