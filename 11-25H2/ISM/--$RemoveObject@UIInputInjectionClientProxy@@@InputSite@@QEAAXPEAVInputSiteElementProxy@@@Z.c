/*
 * XREFs of ??$RemoveObject@UIInputInjectionClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005E418
 * Callers:
...
void __fastcall InputSite::RemoveObject<IInputInjectionClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_1abe38ad_aa41_f018_ceab_ff5a56c3ae8f, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
