/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180175440
 * Callers:
 *     ?Thunk_RegisterClient_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180175E60 (-Thunk_RegisterClient_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigatio.c)
 * Callees:
