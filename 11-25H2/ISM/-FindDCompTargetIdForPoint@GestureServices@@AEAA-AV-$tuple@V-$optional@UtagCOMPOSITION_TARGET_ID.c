/*
 * XREFs of ?FindDCompTargetIdForPoint@GestureServices@@AEAA?AV?$tuple@V?$optional@UtagCOMPOSITION_TARGET_ID@@@std@@PEBG@std@@UtagPOINT@@IPEAUtagCOMPOSITION_TARGET_ID@@@Z @ 0x18014015C
 * Callers:
 ...
 *     ??$make_tuple@AEBUnullopt_t@std@@AEAY00$$CBG@std@@YA?AV?$tuple@Unullopt_t@std@@PEBG@0@AEBUnullopt_t@0@AEAY00$$CBG@Z @ 0x18013F8FC (--$make_tuple@AEBUnullopt_t@std@@AEAY00$$CBG@std@@YA-AV-$tuple@Unullopt_t@std@@PEBG@0@AEBUnullop.c)
 */
