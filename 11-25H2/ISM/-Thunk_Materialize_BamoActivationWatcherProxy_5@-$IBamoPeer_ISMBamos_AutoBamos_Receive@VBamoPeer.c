/*
 * XREFs of ?Thunk_Materialize_BamoActivationWatcherProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124200
 * Callers:
 *     <none>
 * Callees:
