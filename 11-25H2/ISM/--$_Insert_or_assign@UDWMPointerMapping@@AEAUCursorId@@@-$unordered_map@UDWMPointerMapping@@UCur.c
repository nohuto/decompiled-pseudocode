 ...
 *     ??$?RUDWMPointerMapping@@@?$_Uhash_compare@UDWMPointerMapping@@UDWMMappingHash@@U?$equal_to@UDWMPointerMapping@@@std@@@std@@QEBA_KAEBUDWMPointerMapping@@@Z @ 0x18004C1AC (--$-RUDWMPointerMapping@@@-$_Uhash_compare@UDWMPointerMapping@@UDWMMappingHash@@U-$equal_to@UDWM.c)
        ...
        _QWORD *a4)
{
  ...
  v8 = std::_Uhash_compare<DWMPointerMapping,DWMMappingHash,std::equal_to<DWMPointerMapping>>::operator()<DWMPointerMapping>(
         a1,
         a3);
