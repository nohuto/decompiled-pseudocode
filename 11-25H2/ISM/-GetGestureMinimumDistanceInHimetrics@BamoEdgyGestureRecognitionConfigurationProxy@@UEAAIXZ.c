/*
 * XREFs of ?GetGestureMinimumDistanceInHimetrics@BamoEdgyGestureRecognitionConfigurationProxy@@UEAAIXZ @ 0x180115350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyGestureRecognitionConfigurationProxy::GetGestureMinimumDistanceInHimetrics(
