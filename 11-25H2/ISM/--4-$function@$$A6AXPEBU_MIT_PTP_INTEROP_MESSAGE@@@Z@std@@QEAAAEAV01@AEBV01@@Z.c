/*
 * XREFs of ??4?$function@$$A6AXPEBU_MIT_PTP_INTEROP_MESSAGE@@@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x1800EE7E0
 * Callers:
 ...
 *     ?_Reset_move@?$_Func_class@XPEBU_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@std@@IEAAX$$QEAV12@@Z @ 0x1800F0E38 (-_Reset_move@-$_Func_class@XPEBU_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@std@@IEAAX$$QEAV12@@Z.c)
...
__int64 __fastcall std::function<void (_MIT_PTP_INTEROP_MESSAGE const *)>::operator=(__int64 a1, __int64 a2)
{
  ...
  {
    v10 = 0LL;
    std::_Func_class<void,_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE const *>::_Reset_move(v9, v7);
    std::_Func_class<void,_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE const *>::_Reset_move(v7, a1);
    std::_Func_class<void,_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE const *>::_Reset_move(a1, v9);
