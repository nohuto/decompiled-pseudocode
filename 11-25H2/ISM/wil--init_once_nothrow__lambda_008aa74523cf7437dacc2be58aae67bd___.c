/*
 * XREFs of wil::init_once_nothrow__lambda_008aa74523cf7437dacc2be58aae67bd___ @ 0x18008CC20
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !__std_init_once_begin_initialize(&stru_1802478F8, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x330, (unsigned int)"wil", v4);
  if ( fPending )
  {
    v6 = InputConfigContextProvider::Create(&qword_180247E20);
    v7 = v6;
    if ( v6 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x335, (unsigned int)"wil", (const char *)(unsigned int)v6, v8);
      InitOnceComplete(&stru_1802478F8, 4u, 0LL);
      return v7;
    }
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_1802478F8, 0, 0LL);
  }
  return 0LL;
}
