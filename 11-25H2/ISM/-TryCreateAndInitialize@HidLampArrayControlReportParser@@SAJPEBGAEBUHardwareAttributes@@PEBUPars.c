/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayControlReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800EDB30
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( v9 )
  {
    ...
    *((_BYTE *)v9 + 16) = *((_BYTE *)a3 + 4);
    if ( *(_DWORD *)a3 == 2 )
    {
      *((_BYTE *)v9 + 17) = 2;
      ...
      {
        v14 = *((_QWORD *)a3 + 2);
        if ( *(_WORD *)(v14 + 72LL * i + 18) == 112
          && *(_WORD *)(v14 + 72LL * i + 16) == 89
          && *(_WORD *)(v14 + 72LL * i + 10) == 113
          && *(_WORD *)(v14 + 72LL * i + 8) == 89 )
        {
          v15 = *(_OWORD *)(v14 + 72LL * i + 16);
          v16 = *(_OWORD *)(v14 + 72LL * i + 32);
          v17 = *(_OWORD *)(v14 + 72LL * i + 48);
          v18 = *(_QWORD *)(v14 + 72LL * i + 64);
          *(_OWORD *)((char *)v9 + 24) = *(_OWORD *)(v14 + 72LL * i);
    ...
    *((_DWORD *)v9 + 5) = (unsigned int)(*(_DWORD *)(*((_QWORD *)a3 + 2)
    ...
    if ( HidLampArrayControlReportParser::IsParserValid(a1, a2, v9, v11) )
    {
      v10 = 0LL;
      *a4 = v9;
    }
