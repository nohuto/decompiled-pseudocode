/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoActivationWatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x1800751C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivationWatcherStubImpl::OnConnectedUnderLockThunk(
