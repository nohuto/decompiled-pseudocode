/*
 * XREFs of ?ServerIsActiveChanged@VirtualTouchpad@InputTraceLogging@@SAXPEBX_N@Z @ 0x180134764
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerIsActiveChanged(const void *a1, char a2)
{
  ...
  if ( *(_DWORD *)v4 > 4u && tlgKeywordOn((__int64)v4, 512LL) )
  {
    ...
    v13 = 1;
    v10 = 8;
    tlgWriteTransfer_EventWriteTransfer(v5, byte_180214452, 0LL, 0LL, 4u, &v8);
  }
}
