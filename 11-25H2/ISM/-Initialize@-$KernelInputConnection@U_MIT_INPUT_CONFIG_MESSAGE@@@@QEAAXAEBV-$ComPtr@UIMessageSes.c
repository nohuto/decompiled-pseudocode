/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_INPUT_CONFIG_MESSAGE@@@Z@std@@@Z @ 0x18000A87C
 * Callers:
  ...
  *((_DWORD *)a1 + 34) = 6;
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      a1[1]);
    v21 = (_DWORD)a1 + 16;
    v16 = v15(v14, KernelInputConnection<_MIT_INPUT_CONFIG_MESSAGE>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v16 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x43,
    ...
    if ( v17 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v21);
    v18 = NtMITCoreMsgKOpenConnectionTo(6LL, a1 + 3);
    if ( v18 < 0 )
