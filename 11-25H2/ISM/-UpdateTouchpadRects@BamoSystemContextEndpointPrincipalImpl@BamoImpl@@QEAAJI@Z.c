/*
 * XREFs of ?UpdateTouchpadRects@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800ACDD4
 * Callers:
 *     ?Thunk_UpdateTouchpadRects_8@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ACBF0 (-Thunk_UpdateTouchpadRects_8@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpoin.c)
 * Callees:
