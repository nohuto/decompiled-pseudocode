/*
 * XREFs of ?UpdateActuationClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180043C48
 * Callers:
 *     ?Thunk_UpdateActuationClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800731C0 (-Thunk_UpdateActuationClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@B.c)
