/*
 * XREFs of ?SetDeviceDockServer@BamoInputSystemPrincipal@@UEAAXPEAVBamoDeviceDockServerPrincipal@@@Z @ 0x180090E20
 * Callers:
        ...
        struct BamoDeviceDockServerPrincipal *a2)
{
  ...
  BamoImpl::BamoInputSystemPrincipalImpl::SetDeviceDockServer((BamoImpl::BamoInputSystemPrincipalImpl *)(this + 1), a2);
