/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180136BF8
 * Callers:
 *     ?Thunk_UnregisterObserverClientOfType_264@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180136BC0 (-Thunk_UnregisterObserverClientOfType_264@-$IInputObserverManagerPrincipal_Receive@VBamoInputObs.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  BamoImpl::BamoInputObserverManagerPrincipalImpl::LogReceiveUnregisterObserverClientOfType();
  if ( a1[2] > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v9,
      (__int64)a1);
    v18 = (*(__int64 (__fastcall **)(int *, __int64, _QWORD, char *))(*((_QWORD *)a1 - 2) + 120LL))(
            a1 - 4,
            v22,
            a2,
            v11);
