/*
 * XREFs of ?UpdateResizeAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180069B14
 * Callers:
 *     ?Thunk_UpdateResizeAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074140 (-Thunk_UpdateResizeAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@.c)
