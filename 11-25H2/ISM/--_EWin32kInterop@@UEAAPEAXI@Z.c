/*
 * XREFs of ??_EWin32kInterop@@UEAAPEAXI@Z @ 0x1800EE9CC
 * Callers:
 *     ??_EWin32kInterop@@WBA@EAAPEAXI@Z @ 0x1800EE950 (--_EWin32kInterop@@WBA@EAAPEAXI@Z.c)
 * Callees:
  ...
  if ( (v2 & 1) != 0 )
  {
    if ( (v2 & 4) != 0 )
      BamoImpl::BamoMPCConstantManagerClientProxyImpl::UpdateStateOfProxyOnPlaceholderProxyHookUp(
        this,
        (struct Microsoft::BamoImpl::BamoProxyImpl *)0x8F8);
    else
      free(this);
  }
  return this;
