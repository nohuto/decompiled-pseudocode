/*
 * XREFs of ?ChangeConstant@MPCConstantManager@@QEAAJW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@V?$variant@K_NM@4@@Z @ 0x1800B59C8
 * Callers:
 *     ?SetConstant@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGAEBUtagPROPVARIANT@@PEAVBamoAsyncHRESULTProxy@@@Z @ 0x1800B7020 (-SetConstant@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGAEB.c)
...
__int64 __fastcall MPCConstantManager::ChangeConstant(__int64 a1, int a2, __m128i *a3, __int64 a4)
{
  _QWORD *v7; // rax
  _QWORD *v8; // rax
  _QWORD *v9; // rax
  ...
  __int64 v20; // rbx
  __int64 v21; // rax
  unsigned int v23; // [rsp+30h] [rbp-89h] BYREF
  int v24; // [rsp+38h] [rbp-81h] BYREF
  __m128i v25; // [rsp+40h] [rbp-79h] BYREF
  __int64 v26; // [rsp+50h] [rbp-69h]
  _QWORD v27[2]; // [rsp+60h] [rbp-59h] BYREF
  __m128i v28; // [rsp+70h] [rbp-49h] BYREF
  _BYTE v29[32]; // [rsp+80h] [rbp-39h] BYREF
  _BYTE v30[32]; // [rsp+A0h] [rbp-19h] BYREF
  ...
  v24 = a2;
  v28 = v25;
  if ( !MPCConstantManager::CheckConstantExistence(a1, a2, (__int64)&v28) )
    return 2147942487LL;
  v7 = (_QWORD *)std::map<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>>::_Try_emplace<enum InputType const &,>(
                   ...
                   (__int64)&v28,
                   &v24);
  if ( *(char *)(*std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::find<std::basic_string_view<unsigned short>,std::less<void>,0>(
                    *v7 + 40LL,
                    v27,
                    &v25)
               + 68LL) != (__int64)SBYTE4(a4) )
    return 2147942487LL;
  ...
  v9 = std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::find<std::basic_string_view<unsigned short>,std::less<void>,0>(
         *v8 + 40LL,
         ...
         a3);
  v10 = *v9;
  if ( *(char *)(*v9 + 68LL) != (__int64)SBYTE4(a4) )
    goto LABEL_14;
  if ( SBYTE4(a4) == -1LL )
    goto LABEL_12;
  if ( BYTE4(a4) )
...
LABEL_14:
    std::_Tree<std::_Tmap_traits<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>,std::less<enum InputType>,std::allocator<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>>,0>>::_Find_lower_bound<enum InputType>(
      ...
      &v25,
      &v23);
    if ( *(_BYTE *)(v26 + 25) || (signed int)v23 < *(_DWORD *)(v26 + 32) || v26 == *(_QWORD *)(a1 + 72) )
    {
    ...
    std::wstring::_Construct<1,unsigned short const *>(
      (char **)&v31,
      (const void *)a3->m128i_i64[0],
      _mm_srli_si128(*a3, 8).m128i_u64[0]);
...
LABEL_12:
  v25 = *a3;
  if ( MPCConstantManager::CheckModifiedConstantExistence(a1, v23, (__int64)&v25) )
  {
    v25 = *a3;
    MPCConstantManager::SetConstantToDefault(a1, v23, &v25);
  }
LABEL_19:
  MPCConstantManager::GetPROPVARIANTFromConstantValue(v13, v30, a4);
  v16 = (_QWORD *)std::map<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>>::_Try_emplace<enum InputType const &,>(
                    (_QWORD *)(a1 + 56),
                    (__int64)&v25,
                    &v23);
  v17 = std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::find<std::basic_string_view<unsigned short>,std::less<void>,0>(
          *v16 + 40LL,
          v27,
          a3);
  MPCConstantManager::GetPROPVARIANTFromConstantValue(v18, v29, *(_QWORD *)(*v17 + 64LL));
  if ( !v30[24] || !v29[24] )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v19);
  v20 = std::optional<tagPROPVARIANT>::value(v29);
  v21 = std::optional<tagPROPVARIANT>::value(v30);
  MPCConstantManager::OnConstantChanged(a1, v23, a3->m128i_i64[0], v21, v20);
  return 0LL;
}
