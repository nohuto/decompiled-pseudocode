/*
 * XREFs of ?Thunk_UpdatePrimaryClickZone_418@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134AC0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
