/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801759CC
 * Callers:
 *     ?Thunk_RegisterOverride_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180175E70 (-Thunk_RegisterOverride_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigat.c)
 * Callees:
