/*
 * XREFs of ?UnregisterProcess@InputProcessManager@InputTraceLogging@@SAXPEBX@Z @ 0x180194B30
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::UnregisterProcess(const void *a1)
{
