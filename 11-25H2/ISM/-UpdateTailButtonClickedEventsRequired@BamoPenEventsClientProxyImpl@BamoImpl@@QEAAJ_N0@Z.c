/*
 * XREFs of ?UpdateTailButtonClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180191210
 * Callers:
 *     ?Thunk_UpdateTailButtonClickedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180190D20 (-Thunk_UpdateTailButtonClickedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsCl.c)
