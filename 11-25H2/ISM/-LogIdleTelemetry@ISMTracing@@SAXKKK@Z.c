/*
 * XREFs of ?LogIdleTelemetry@ISMTracing@@SAXKKK@Z @ 0x1800CE768
 * Callers:
 *     ?IdleTelemetry@MPCHeadMovementDetector@@AEAAXXZ @ 0x180076F78 (-IdleTelemetry@MPCHeadMovementDetector@@AEAAXXZ.c)
 * Callees:
