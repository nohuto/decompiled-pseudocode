/*
 * XREFs of ?OnActivationConfigurationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005DE10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActivationConfigurationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005DE84 (--$RemoveObject@UIActivationConfigurationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElement.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IActivationConfigurationInputObjectProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
