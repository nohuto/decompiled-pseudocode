/*
 * XREFs of ?QueryInterface@BamoDeviceDockServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017EF90
 * Callers:
 *     ?QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017F020 (-QueryInterface@BamoDeviceDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
