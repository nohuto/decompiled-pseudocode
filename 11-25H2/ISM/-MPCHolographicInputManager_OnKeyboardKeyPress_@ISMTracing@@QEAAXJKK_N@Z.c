/*
 * XREFs of ?MPCHolographicInputManager_OnKeyboardKeyPress_@ISMTracing@@QEAAXJKK_N@Z @ 0x1800BCE1C
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *(_DWORD *)v8 > 5u && tlgKeywordOn((__int64)v8, 1LL) )
  {
    ...
    v19 = 4LL;
    v17 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v10, byte_180206E67, 0LL, 0LL, 6u, &v15);
  }
}
