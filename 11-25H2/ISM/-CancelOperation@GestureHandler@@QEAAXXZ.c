/*
 * XREFs of ?CancelOperation@GestureHandler@@QEAAXXZ @ 0x1801445C0
 * Callers:
 ...
 *     ?MakeCompletedCallback@GestureHandler@@AEAA?AV?$shared_ptr@VGestureHandler@@@std@@W4GestureCompletedReason@@@Z @ 0x180058D58 (-MakeCompletedCallback@GestureHandler@@AEAA-AV-$shared_ptr@VGestureHandler@@@std@@W4GestureCompl.c)
 *     ?GetRelativePoints@GestureHandler@@AEAA?AV?$tuple@UtagPOINT@@U1@U1@@std@@AEBUGestureClient@1@UtagPOINTF@@@Z @ 0x18009023C (-GetRelativePoints@GestureHandler@@AEAA-AV-$tuple@UtagPOINT@@U1@U1@@std@@AEBUGestureClient@1@Uta.c)
  ...
  if ( v2 != v3 )
  {
    ...
    for ( i = *((_QWORD *)this + 14); i != v4; i += 40LL )
    {
      ...
      InputETW::InputGesture::GestureCancelled(
        ...
        *((_DWORD *)this + 44),
        *((_QWORD *)this + 24));
      (*(void (__fastcall **)(__int64, _QWORD, int *, __int64 *, int *, char *, _QWORD, _DWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(i + 8) + 8LL) + 48LL))(
        *(_QWORD *)(i + 8) + 8LL,
