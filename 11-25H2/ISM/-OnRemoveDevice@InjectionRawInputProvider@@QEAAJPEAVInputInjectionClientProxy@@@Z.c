/*
 * XREFs of ?OnRemoveDevice@InjectionRawInputProvider@@QEAAJPEAVInputInjectionClientProxy@@@Z @ 0x1800DF5A4
 * Callers:
 *     ?OnDisconnected@InputInjectionClientProxy@@MEAAJXZ @ 0x180196030 (-OnDisconnected@InputInjectionClientProxy@@MEAAJXZ.c)
 * Callees:
        ...
        struct InputInjectionClientProxy *a2)
{
  ...
  if ( v22 != *((_QWORD *)this + 6) )
  {
    ...
    v11 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 3) + 56LL))(*((_QWORD *)this + 3), v3[3]);
    v13 = v11;
    if ( v11 < 0 )
    {
