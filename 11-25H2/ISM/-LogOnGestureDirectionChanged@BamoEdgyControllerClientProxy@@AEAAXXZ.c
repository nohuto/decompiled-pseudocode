/*
 * XREFs of ?LogOnGestureDirectionChanged@BamoEdgyControllerClientProxy@@AEAAXXZ @ 0x180154550
 * Callers:
...
void __fastcall BamoEdgyControllerClientProxy::LogOnGestureDirectionChanged(BamoEdgyControllerClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
