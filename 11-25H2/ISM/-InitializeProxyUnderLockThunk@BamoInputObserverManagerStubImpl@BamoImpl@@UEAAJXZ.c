/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoInputObserverManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180076300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputObserverManagerStubImpl::InitializeProxyUnderLockThunk(
