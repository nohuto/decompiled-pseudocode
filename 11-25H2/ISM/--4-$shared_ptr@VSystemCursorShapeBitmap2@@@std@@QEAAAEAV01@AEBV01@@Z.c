/*
 * XREFs of ??4?$shared_ptr@VSystemCursorShapeBitmap2@@@std@@QEAAAEAV01@AEBV01@@Z @ 0x1800F7538
 * Callers:
...
__int64 *__fastcall std::shared_ptr<SystemCursorShapeBitmap2>::operator=(__int64 *a1, _QWORD *a2)
{
  ...
  v3 = std::shared_ptr<SystemCursorShapeBitmap2>::shared_ptr<SystemCursorShapeBitmap2>(v8, a2);
  v4 = *v3;
  *v3 = *a1;
  *a1 = v4;
  v5 = v3[1];
