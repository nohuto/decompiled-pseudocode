/*
 * XREFs of ?SendHomeGestureReadyChanged@MPCManager@@QEAAX_NKK_KII@Z @ 0x1800BA780
 * Callers:
 *     _lambda_152589ecad8ae636cc0bdcee60e887b4_::operator() @ 0x1800C1800 (_lambda_152589ecad8ae636cc0bdcee60e887b4_--operator().c)
 * Callees:
