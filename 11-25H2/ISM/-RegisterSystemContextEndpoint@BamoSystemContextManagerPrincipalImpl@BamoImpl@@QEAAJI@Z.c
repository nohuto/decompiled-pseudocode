/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013CA00
 * Callers:
 *     ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013E6D0 (-Thunk_RegisterSystemContextEndpoint_8@-$ISystemContextManagerPrincipal_Receive@VBamoSystemConte.c)
 * Callees:
