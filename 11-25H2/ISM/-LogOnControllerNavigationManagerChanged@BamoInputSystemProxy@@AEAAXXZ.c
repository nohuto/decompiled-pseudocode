/*
 * XREFs of ?LogOnControllerNavigationManagerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x180115C38
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnControllerNavigationManagerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
