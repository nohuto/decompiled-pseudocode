/*
 * XREFs of ?LogOnTailButtonClickedEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x18018F4B8
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonClickedEventsRequiredChanged(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
