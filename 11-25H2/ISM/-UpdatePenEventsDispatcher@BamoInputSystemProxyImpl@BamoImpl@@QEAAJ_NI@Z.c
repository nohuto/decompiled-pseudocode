/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012919C
 * Callers:
 *     ?Thunk_UpdatePenEventsDispatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180124CE0 (-Thunk_UpdatePenEventsDispatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
