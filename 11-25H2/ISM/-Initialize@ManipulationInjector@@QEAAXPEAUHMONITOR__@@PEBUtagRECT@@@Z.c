/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x18010F3B4
 * Callers:
  ...
  *((_DWORD *)this + 184) = v9;
  ...
  switch ( *(_DWORD *)this )
  {
    ...
    case 2:
      ...
      dword_180245F6C = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 194)) + 0.5);
      dword_180245F8C = (int)v14;
      v29.x = *((_DWORD *)this + 5);
