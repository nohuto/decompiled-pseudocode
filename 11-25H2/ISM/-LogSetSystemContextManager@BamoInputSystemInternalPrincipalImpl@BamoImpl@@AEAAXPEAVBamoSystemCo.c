/*
 * XREFs of ?LogSetSystemContextManager@BamoInputSystemInternalPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemContextManagerPrincipal@@@Z @ 0x1800920C8
 * Callers:
