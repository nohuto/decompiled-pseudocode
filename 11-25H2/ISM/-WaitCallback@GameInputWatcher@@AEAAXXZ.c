/*
 * XREFs of ?WaitCallback@GameInputWatcher@@AEAAXXZ @ 0x180065DF0
 * Callers:
 *     ?WaitCallback@GameInputWatcher@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180065DD0 (-WaitCallback@GameInputWatcher@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z.c)
 * Callees:
 *     _wcsicmp @ 0x18009D2B4 (_wcsicmp.c)
 */
