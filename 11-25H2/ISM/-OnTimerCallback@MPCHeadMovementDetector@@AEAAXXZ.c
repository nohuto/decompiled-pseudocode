/*
 * XREFs of ?OnTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x180076BA8
 * Callers:
 *     _lambda_aa0eaa0d8a3377c6799a200e781869ec_::_lambda_invoker_cdecl_ @ 0x180098DC0 (_lambda_aa0eaa0d8a3377c6799a200e781869ec_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     ?WasThereSufficientYawMovement@MPCHeadMovementDetector@@AEAA_NXZ @ 0x180077068 (-WasThereSufficientYawMovement@MPCHeadMovementDetector@@AEAA_NXZ.c)
 *     ?LogMPCLastHeadYawMovement@ISMTracing@@SAXI@Z @ 0x1800CE800 (-LogMPCLastHeadYawMovement@ISMTracing@@SAXI@Z.c)
 *     ?QueueIdleTimerKick@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800CE864 (-QueueIdleTimerKick@MPCHeadMovementDetector@@AEAAXXZ.c)
 */
