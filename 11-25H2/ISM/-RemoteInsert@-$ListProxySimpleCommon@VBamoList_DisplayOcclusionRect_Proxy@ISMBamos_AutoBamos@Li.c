/*
 * XREFs of ?RemoteInsert@?$ListProxySimpleCommon@VBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UDisplayOcclusionRect@@AEBU6@@Bamo@Microsoft@@MEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x1801383A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetIsReady@BamoProxy@Bamo@Microsoft@@QEBA_NXZ @ 0x180137F14 (-GetIsReady@BamoProxy@Bamo@Microsoft@@QEBA_NXZ.c)
        ...
        _OWORD *a3)
{
  ...
  if ( a2 <= (unsigned __int64)(0x2E8BA2E8BA2E8BA3LL * ((__int64)(*((_QWORD *)this + 7) - *((_QWORD *)this + 6)) >> 4)) )
  {
    ...
    try
    {
      ...
      std::vector<DisplayOcclusionRect>::emplace<DisplayOcclusionRect const &>((__int64)v6, &v18, *v6 + 176 * v7, a3);
