/*
 * XREFs of ?OnDragManagerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005FE30
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005FEA8 (--$RemoveObject@UIDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
