/*
 * XREFs of ?LogOnGestureRecognitionConfigurationChanged@BamoEdgyNotificationSourceClientProxy@@AEAAXXZ @ 0x180116660
 * Callers:
...
void __fastcall BamoEdgyNotificationSourceClientProxy::LogOnGestureRecognitionConfigurationChanged(
