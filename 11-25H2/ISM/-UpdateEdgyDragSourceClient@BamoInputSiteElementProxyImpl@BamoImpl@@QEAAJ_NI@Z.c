/*
 * XREFs of ?UpdateEdgyDragSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18004424C
 * Callers:
 *     ?Thunk_UpdateEdgyDragSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071F20 (-Thunk_UpdateEdgyDragSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
