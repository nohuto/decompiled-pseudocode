/*
 * XREFs of ?ApproveProcessesForAnimation@BamoGestureServicesProxy@@UEAAJPEBIIPEAVBamoDragManagerClientPrincipal@@@Z @ 0x180113260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoGestureServicesProxy::ApproveProcessesForAnimation(
        ...
        struct BamoDragManagerClientPrincipal *a4)
{
  ...
  LODWORD(v7) = BamoImpl::BamoGestureServicesProxyImpl::ApproveProcessesForAnimation(
