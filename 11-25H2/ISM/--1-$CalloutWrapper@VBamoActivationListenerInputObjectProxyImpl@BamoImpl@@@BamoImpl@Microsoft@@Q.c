/*
 * XREFs of ??1?$CalloutWrapper@VBamoActivationListenerInputObjectProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x18006FDDC
 * Callers:
 ...
 *     ?OnPropertiesRefreshedCallout@BamoActivationListenerInputObjectProxy@@EEAAJXZ @ 0x18011EF30 (-OnPropertiesRefreshedCallout@BamoActivationListenerInputObjectProxy@@EEAAJXZ.c)
 *     _BamoImpl::BamoActivationListenerInputObjectProxyImpl::UpdateHWND_::_1_::dtor$1 @ 0x1801CBB9B (_BamoImpl--BamoActivationListenerInputObjectProxyImpl--UpdateHWND_--_1_--dtor$1.c)
 * Callees:
