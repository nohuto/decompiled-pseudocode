/*
 * XREFs of ?DragStarted@BamoDragManagerClientProxy@@UEAAJIAEBUtagPOINT@@00AEBUGestureAnimationProperties@@_KW4VirtualKeyModifiers@System@Windows@@2W4InputType@Input@Internal@UI@6@22W4GestureProcessorType@@@Z @ 0x180142BD0
 * Callers:
 *     <none>
 * Callees:
