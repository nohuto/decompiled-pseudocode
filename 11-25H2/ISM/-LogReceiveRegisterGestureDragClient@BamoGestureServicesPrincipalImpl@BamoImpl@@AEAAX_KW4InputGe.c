/*
 * XREFs of ?LogReceiveRegisterGestureDragClient@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAX_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@4567@PEAVBamoDragManagerClientProxy@@@Z @ 0x18009996C
 * Callers:
