/*
 * XREFs of ?LogReceiveRegisterInputProcess@BamoInputProcessManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputProcessProxy@@@Z @ 0x180193C88
 * Callers:
...
void __fastcall BamoImpl::BamoInputProcessManagerPrincipalImpl::LogReceiveRegisterInputProcess(
