/*
 * XREFs of ?GetNearestSupportedFixedColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x18006594C
 * Callers:
 ...
 * Callees:
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x18006CAC0 (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
