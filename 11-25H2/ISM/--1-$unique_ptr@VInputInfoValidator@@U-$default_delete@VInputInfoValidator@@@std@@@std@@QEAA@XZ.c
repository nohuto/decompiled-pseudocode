/*
 * XREFs of ??1?$unique_ptr@VInputInfoValidator@@U?$default_delete@VInputInfoValidator@@@std@@@std@@QEAA@XZ @ 0x1800DEDB0
 * Callers:
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKV?$unique_ptr@VInputInfoValidator@@U?$default_delete@VInputInfoValidator@@@std@@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800DED28 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CBKV-$unique_ptr@VInputInfoVali.c)
 ...
 *     _InjectionRawInputProvider::OnAttachDevice_::_1_::dtor$1 @ 0x1801CEA05 (_InjectionRawInputProvider--OnAttachDevice_--_1_--dtor$1.c)
 * Callees:
