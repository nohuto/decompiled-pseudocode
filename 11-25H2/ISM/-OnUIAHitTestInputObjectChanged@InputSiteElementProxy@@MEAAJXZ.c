/*
 * XREFs of ?OnUIAHitTestInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18003BDF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIUIAHitTestInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003BE68 (--$RemoveObject@UIUIAHitTestInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
