/*
 * XREFs of ?UpdateAutoForwardId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x1800986C4
 * Callers:
 *     ?Thunk_UpdateAutoForwardId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18007FFA0 (-Thunk_UpdateAutoForwardId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxy.c)
