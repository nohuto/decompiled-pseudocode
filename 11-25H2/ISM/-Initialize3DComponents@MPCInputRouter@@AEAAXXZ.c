/*
 * XREFs of ?Initialize3DComponents@MPCInputRouter@@AEAAXXZ @ 0x1800FBAD0
 * Callers:
    ...
    *v2 = 1;
    if ( !*((_QWORD *)this + 85) )
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v3);
    v4 = (struct IMPCFocusTarget **)((char *)this + 672);
    if ( *((_QWORD *)this + 84) )
      wil::details::in1diag3::_FailFast_Unexpected(
        retaddr,
        (void *)0x1AE,
    ...
    v8 = (*(__int64 (__fastcall **)(_QWORD, char *))(**((_QWORD **)this + 85) + 24LL))(
           *((_QWORD *)this + 85),
           (char *)this + 688);
    if ( v8 < 0 )
    ...
    v13 = DWMFocusedInputTarget::Create(v10, *((_DWORD *)this + 173), 0, 0LL, &v31);
    if ( v13 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x1C5,
