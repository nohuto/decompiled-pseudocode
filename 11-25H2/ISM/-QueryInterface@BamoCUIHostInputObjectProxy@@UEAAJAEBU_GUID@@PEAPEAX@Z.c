/*
 * XREFs of ?QueryInterface@BamoCUIHostInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012F500
 * Callers:
 *     ?QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012F590 (-QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
