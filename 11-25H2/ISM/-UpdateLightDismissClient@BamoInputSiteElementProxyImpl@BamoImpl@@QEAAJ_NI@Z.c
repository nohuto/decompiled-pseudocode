/*
 * XREFs of ?UpdateLightDismissClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180044B88
 * Callers:
 *     ?Thunk_UpdateLightDismissClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180071C80 (-Thunk_UpdateLightDismissClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImp.c)
