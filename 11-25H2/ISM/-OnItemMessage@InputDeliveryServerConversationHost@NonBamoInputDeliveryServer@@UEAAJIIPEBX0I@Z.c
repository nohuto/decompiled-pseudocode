/*
 * XREFs of ?OnItemMessage@InputDeliveryServerConversationHost@NonBamoInputDeliveryServer@@UEAAJIIPEBX0I@Z @ 0x18007AC60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  if ( a6 != 64 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  return NonBamoInputDeliveryServer::OnAppThreadMessage(this[2], a5, a3, a4);
}
