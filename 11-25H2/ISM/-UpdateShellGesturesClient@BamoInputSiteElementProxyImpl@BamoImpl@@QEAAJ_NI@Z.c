/*
 * XREFs of ?UpdateShellGesturesClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18004444C
 * Callers:
 *     ?Thunk_UpdateShellGesturesClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800721A0 (-Thunk_UpdateShellGesturesClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyIm.c)
