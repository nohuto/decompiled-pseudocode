/*
 * XREFs of ?Materialize_BamoInputDelegationInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18002E098
 * Callers:
 *     ?Thunk_Materialize_BamoInputDelegationInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800836C0 (-Thunk_Materialize_BamoInputDelegationInputObjectProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@.c)
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v12 = 0LL;
  v5 = (unsigned int)a2;
  BamoImpl::CreateInputDelegationInputObjectProxy(
