/*
 * XREFs of ??1?$list@U?$pair@$$CBGV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@@std@@V?$allocator@U?$pair@$$CBGV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18018A3A0
 * Callers:
 *     _PenHapticInterface::PenHapticInterface_::_1_::dtor$9 @ 0x1801D1127 (_PenHapticInterface--PenHapticInterface_--_1_--dtor$9.c)
 * Callees:
