/*
 * XREFs of ?LogResumeOutboundMessages@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@EEBAXII@Z @ 0x180118A40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::LogResumeOutboundMessages(
        BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl *this)
{
  ...
  if ( qword_1802475B0 && *(_DWORD *)qword_1802475B0 > 5u && tlgKeywordOn(qword_1802475B0, 1LL) )
  {
    v5 = v2;
    v4[0] = v3;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      v1,
      (__int64)&unk_18020D7FC,
      v2,
      v3,
      (__int64)v4,
      (__int64)&v5);
