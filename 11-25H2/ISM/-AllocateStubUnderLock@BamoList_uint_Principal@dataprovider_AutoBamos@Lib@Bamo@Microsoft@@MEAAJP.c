/*
 * XREFs of ?AllocateStubUnderLock@BamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_uint_Stub@2345@@Z @ 0x1800FF0C0
 * Callers:
 *     <none>
 * Callees:
