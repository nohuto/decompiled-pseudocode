/*
 * XREFs of sub_140022D58 @ 0x140022D58
 * Callers:
...
__int64 __fastcall sub_140022D58(__int64 a1, __int64 a2)
{
  int v4; // edi
  __int64 v5; // rax
  __int64 v6; // r8
  ...
  if ( *v16 >= 0x24 )
  {
    ...
    if ( (*(_BYTE *)(a1 + 3728) & 3) == 3 && *(unsigned __int8 *)(a1 + 3729) == v10 )
    {
      ...
      v17 = 0LL;
      v18 = 0LL;
      result = sub_140029394(a1, v12, v6, &v17);
      if ( (_DWORD)result )
      {
LABEL_16:
        *(_BYTE *)(a2 + 3) = 4;
      ...
      if ( v8[7] == 1 )
      {
        if ( WORD4(v18) )
        {
          result = sub_14002910C(a1, v12, WORD4(v18), (unsigned int)&v16, (__int64)(v8 + 10));
          if ( (_DWORD)result )
          {
