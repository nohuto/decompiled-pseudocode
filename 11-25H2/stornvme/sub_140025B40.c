/*
 * XREFs of sub_140025B40 @ 0x140025B40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_140021B20 @ 0x140021B20 (sub_140021B20.c)
 *     sub_140025944 @ 0x140025944 (sub_140025944.c)
 *     sub_140032980 @ 0x140032980 (sub_140032980.c)
 *     sub_140032C80 @ 0x140032C80 (sub_140032C80.c)
 */

__int64 __fastcall sub_140025B40(__int64 a1, __int64 a2)
{
  __int64 v3; // r15
  __int64 result; // rax
  __int64 v5; // rdx
  ...
  {
    result = sub_140025944(a1, v3, v11, SHIWORD(v11), v12);
    v7 = 0LL;
    if ( !(_DWORD)result )
    {
      result = sub_1400092F0(a1, v3);
LABEL_9:
      v7 = 0LL;
      goto LABEL_60;
    }
...
LABEL_15:
      ...
      sub_140032C80(0LL, 0LL, v15 & 0xFFFFFFFC);
      v7 = 0LL;
      MEMORY[3] = *(_BYTE *)v10;
          ...
          do
          {
            if ( (*(_BYTE *)(a1 + 4016) & 8) != 0 )
            {
              ...
              *(_BYTE *)(v17 - 11) = v31 ^ v32 & 1;
              v33 = sub_140021B20(*(unsigned __int8 *)(v10 + 4));
              *(_BYTE *)(v27 - 10) = v23 & v33;
            ...
            else
            {
              ...
              *(_BYTE *)(v17 - 11) = v24 ^ v25 & 1;
              v26 = sub_140021B20(*(unsigned __int8 *)(v10 + 4));
    ...
    else
    {
      ...
      if ( (_BYTE)v55 )
      {
        v35 = sub_140021B20(*(unsigned __int8 *)(v10 + 4));
        v37 = (_WORD)v7 + 1;
        v36[21] = v35 & 0xF;
...
LABEL_31:
  ...
  else
  {
    ...
    if ( v15 >> 2 )
    {
      sub_140032C80(0LL, 0LL, 4LL * (v15 >> 2));
      v7 = 0LL;
    }
    MEMORY[3] = *(_BYTE *)v10;
    MEMORY[2] = *(_BYTE *)(v10 + 1);
...
LABEL_47:
  ...
  if ( *v55 >= v52 )
  {
    ...
    {
      if ( v49 )
        sub_140032C80(v48, 0LL, *v55);
    }
    else
    {
      v50 = v49 >> 2;
      if ( v50 )
        sub_140032C80(v48, 0LL, 4LL * v50);
    }
    if ( v15 >= v52 )
      v15 = v52;
    result = sub_140032980(v48, 0LL, v15);
    *(_BYTE *)(v3 + 3) = 1;
    *(_BYTE *)(v8 + 4225) |= 8u;
    goto LABEL_9;
  }
...
LABEL_60:
  if ( (*(_BYTE *)(v8 + 4225) & 8) != 0 )
  {
    ...
    {
      result = sub_14000CF50(a1, *(unsigned int *)(v8 + 4208), (__int64 *)(v8 + 4160), *(_QWORD *)(v8 + 4168));
      v7 = 0LL;
    }
    *(_QWORD *)(v8 + 4160) = v7;
