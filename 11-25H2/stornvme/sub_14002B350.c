...
__int64 __fastcall sub_14002B350(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, __int64 a6)
{
  int v10; // r9d
  __int64 v11; // r10
  __int128 v12; // xmm0
  ...
  sub_140032C80(a6, 0LL, 424LL);
  *(_BYTE *)(a6 + 64) = *(_BYTE *)(a2 + 26) & 0xF;
  *(_DWORD *)(a6 + 48) = *(_DWORD *)(a2 + 4LL * (*(_BYTE *)(a2 + 26) & 0xF) + 128);
  v10 = 1 << *(_BYTE *)(a6 + 50);
  *(_DWORD *)(a6 + 52) = v10;
  *(_QWORD *)(a6 + 56) = *(_QWORD *)a2;
  *(_BYTE *)(a6 + 65) = *(_BYTE *)(a2 + 24) & 1;
  *(_BYTE *)(a6 + 66) = *(_BYTE *)(a2 + 29) & 7;
  *(_WORD *)(a6 + 92) = *(_WORD *)(a2 + 46);
  v11 = *(unsigned __int16 *)(a2 + 100);
  *(_WORD *)(a6 + 94) = v11;
  *(_WORD *)(a6 + 96) = *(_WORD *)(a2 + 102);
  *(_BYTE *)(a6 + 112) = *(_BYTE *)(a2 + 31);
...
LABEL_22:
          ...
          if ( v18 <= v15 )
          {
            ...
            if ( !(v18 % v19) )
            {
              ...
              *(_DWORD *)(a6 + 104) = v18;
              *(_DWORD *)(a6 + 108) = v19;
              *(_DWORD *)(a6 + 160) = *(unsigned __int16 *)(a2 + 68) + 1;
              result = (unsigned int)*(unsigned __int16 *)(a2 + 70) + 1;
              *(_DWORD *)(a6 + 164) = result;
            }
          }
          return result;
        }
