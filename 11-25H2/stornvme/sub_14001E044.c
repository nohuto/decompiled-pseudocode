/*
 * XREFs of sub_14001E044 @ 0x14001E044
 * Callers:
 ...
 *     sub_14001CDE8 @ 0x14001CDE8 (sub_14001CDE8.c)
 *     sub_140032980 @ 0x140032980 (sub_140032980.c)
 *     sub_140032C80 @ 0x140032C80 (sub_140032C80.c)
 */

__int64 __fastcall sub_14001E044(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r13
  ...
  v7 = 1;
  v8 = 4;
  if ( !sub_14001B78C(a1, a2, a3, a4) )
  {
    *(_DWORD *)(a1 + 28) = 9;
    return StorPortExtendedFunction(98LL, a1, 0LL, 10LL);
  }
  v10 = sub_14000C180(a1);
  LODWORD(v11) = 0;
  if ( !v10 )
  {
    *(_DWORD *)(a1 + 28) = 10;
  ...
  if ( v13 )
  {
    ...
    do
    {
      if ( sub_14001CDE8((__int64)(v14 - 1)) )
      {
        ++v6;
      }
...
LABEL_75:
    ...
    {
      if ( sub_14001CDE8(32LL * v51 + v12 + 40) )
      {
        do
        {
          if ( !v57 )
...
LABEL_86:
    ...
    {
      if ( sub_14001CDE8(v12 + 32LL * v51 + 40) )
      {
        do
        {
          if ( !v65 )
...
LABEL_123:
  ...
  {
    v20 = sub_14001CDE8(v12 + 32LL * i + 40);
    v26 = 0;
    if ( !v20 )
      continue;
    if ( v23 )
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    if ( sub_14001CDE8(v12 + 32LL * i + 40) )
      break;
    i = v30 + 1;
  }
  LODWORD(v11) = 0;
...
LABEL_43:
  ...
  while ( i < v35 )
  {
    if ( sub_14001CDE8(v12 + 32LL * i + 40) )
    {
      do
      {
        if ( !sub_14001CDE8(v12 + 32LL * v36 + 40) && v37 != v39 )
        {
          v41 = 32LL * v39;
...
LABEL_52:
  ...
  v46 = v12 + 32LL * *(unsigned int *)(v12 + 36) + 40;
  sub_140032980(
    v12 + 32LL * v13 + 40,
    v46,
    (unsigned int)*(_QWORD *)(v4 + 8) + **(_DWORD **)(v4 + 8) - (unsigned int)v46);
  v47 = *(unsigned int **)(v4 + 8);
  result = *v47 - 32LL * (*(_DWORD *)(v12 + 36) - v13);
  v48 = (32 * (*(_DWORD *)(v12 + 36) - v13)) >> 2;
  if ( (_DWORD)v48 )
    result = sub_140032C80((char *)v47 + result, 0LL, 4 * v48);
  *(_DWORD *)(v12 + 36) = v13;
  return result;
}
