/*
 * XREFs of sub_140008F00 @ 0x140008F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140008F00(__int64 a1, unsigned __int16 a2)
{
  __int64 result; // rax
  ...
  if ( (_BYTE)result )
  {
    if ( (*(_DWORD *)(a1 + 24) & 0x10) == 0 )
    {
      ...
      if ( a2 == 0xFFFF || *(_WORD *)(a1 + 272) <= 1u )
      {
        ...
        {
          sub_140006980(a1, *(_WORD *)(a1 + 720));
          if ( v6 )
          {
            sub_1400130E0(v13 + 24, a1, v13, 0LL);
          }
          else
          {
            v17 = 0;
        ...
        for ( i = 0; v8; ++i )
        {
          ...
          {
            sub_140006980(a1, *(_WORD *)(v10 + 176));
            if ( v6 )
            {
              sub_1400130E0(v11 + 24, a1, v11, 0LL);
            }
            else
            {
              v17 = 0;
