/*
 * XREFs of sub_140004020 @ 0x140004020
 * Callers:
...
__int64 __fastcall sub_140004020(__int64 a1, __int64 a2, __int64 a3)
{
  char v4; // cl
  __int64 v6; // rbx
  __int64 v7; // rdx
