/*
 * XREFs of sub_140019F10 @ 0x140019F10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_14000B6E0 @ 0x14000B6E0 (sub_14000B6E0.c)
 *     sub_1400109F0 @ 0x1400109F0 (sub_1400109F0.c)
 */

char __fastcall sub_140019F10(__int64 a1, __int64 a2)
{
  int v4; // edx
  int v5; // esi
  __int64 v6; // rdx
  ...
  if ( v5 && v5 != 2 )
  {
    if ( v5 == 7 )
    {
      v21 = 0;
      if ( *(_BYTE *)(a1 + 20) )
        sub_1400109F0(a1, v6, v8, v9);
      sub_14000B6E0(a2, &v23, &v22, &v21);
      if ( v21 < *(_DWORD *)(a1 + 224) )
      {
        v14 = *(_QWORD *)(a1 + 8LL * v21 + 1672);
        if ( v14 )
          *(_DWORD *)(v14 + 20) |= 2u;
      }
      goto LABEL_28;
...
LABEL_34:
  ...
  {
    sub_1400092F0(a1, a2);
    if ( v5 == 10 && (*(_BYTE *)(v7 + 4225) & 0x21) == 1 )
    {
      LOBYTE(v19) = 1;
      sub_140008130(a1, a2, v19);
    }
  }
  return 1;
}
