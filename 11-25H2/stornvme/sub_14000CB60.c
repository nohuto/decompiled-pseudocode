/*
 * XREFs of sub_14000CB60 @ 0x14000CB60
 * Callers:
...
void __fastcall sub_14000CB60(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // rdi
  __int64 v4; // rdi
  ...
  if ( !*(_BYTE *)(a1 + 20) )
  {
    ...
    if ( !*(_QWORD *)(a1 + 3816) && !(unsigned int)StorPortExtendedFunction(0LL, a1, 32LL, 1701672526LL) )
    {
      MEMORY[0] = 0;
      MEMORY[8] = 0LL;
      MEMORY[0x10] = 10 * v2;
