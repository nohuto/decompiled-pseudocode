/*
 * XREFs of sub_14001C664 @ 0x14001C664
 * Callers:
 ...
 *     sub_14001F4B8 @ 0x14001F4B8 (sub_14001F4B8.c)
 *     sub_14001FC04 @ 0x14001FC04 (sub_14001FC04.c)
 *     sub_140020508 @ 0x140020508 (sub_140020508.c)
 */

char __fastcall sub_14001C664(__int64 a1)
{
  ...
  if ( !byte_140042220 || *(_WORD *)(a1 + 330) < 2u )
    goto LABEL_64;
  v46 = 0;
  v47 = -1;
  v15 = 0;
...
LABEL_63:
    sub_14001FC04(a1, (_DWORD)v32, 0, v15, v16);
    *(_DWORD *)(a1 + 4056) |= 0x10u;
LABEL_64:
    if ( (*(_DWORD *)(a1 + 4056) & 0x10) != 0 )
    {
      sub_140020508(a1);
      sub_14001D49C(a1);
    }
    ...
    for ( j = 0; ; ++j )
    {
      ...
      LOBYTE(v3) = sub_14001F4B8(a1, (unsigned int)&v50, (unsigned int)&v48, (unsigned int)&v49, 0LL);
      if ( !(_BYTE)v3 )
      {
        if ( (*(_BYTE *)(a1 + 21) & 2) != 0 )
  ...
  while ( 2 )
  {
    ...
    if ( v17 < (unsigned int)v3 )
    {
      ...
      for ( k = 0; k < v16 && v17 < *(unsigned __int16 *)(a1 + 330); ++k )
      {
        ...
        if ( !(unsigned __int8)sub_14001F4B8(
                                 a1,
                                 (unsigned int)&v50,
                                 (unsigned int)&v48,
                                 (unsigned int)&v49,
...
LABEL_59:
          sub_14001FC04(a1, (_DWORD)v31, *(unsigned __int16 *)(v23 + 48), v15, v16);
          *(_DWORD *)(a1 + 4056) |= 0x10u;
          goto LABEL_64;
        }
        v24 = v49;
