/*
 * XREFs of sub_14001F8F8 @ 0x14001F8F8
 * Callers:
...
__int64 __fastcall sub_14001F8F8(__int64 a1, unsigned __int8 a2, __int64 a3)
{
  __int64 v3; // rdi
  __int64 v5; // rdx
  __int64 result; // rax
  ...
  if ( (v9 & 1) == 0 )
  {
    sub_140032C80(v20, 0LL, 64LL);
    result = sub_140028EEC(a1, v8, v10, v20);
    if ( (_DWORD)result )
      return result;
    if ( (v20[0] & 2) != 0 )
    {
      result = sub_140028E38(a1);
      if ( (_DWORD)result )
        return result;
      result = sub_140028EEC(a1, v8, v11, v20);
      if ( (_DWORD)result )
        return result;
      if ( (v20[32] & 2) != 0 )
      {
...
LABEL_19:
  v18 = 0LL;
  v19 = 0LL;
  result = sub_140029394(a1, v8, a3, &v18);
  if ( (_DWORD)result )
    return result;
  v12 = WORD3(v19);
  v13 = v18;
  ...
  *(_WORD *)(a1 + 3732) = v12;
  ...
  if ( !v13 )
    return 3238002695LL;
  result = sub_140029050(a1, v8);
  if ( !(_DWORD)result )
  {
    result = sub_140029394(a1, v8, v15, &v18);
    if ( !(_DWORD)result )
    {
      v16 = WORD3(v19);
