/*
 * XREFs of sub_140022760 @ 0x140022760
 * Callers:
...
__int64 __fastcall sub_140022760(__int64 a1, __int64 a2)
{
  unsigned int v4; // edi
  __int64 v5; // r8
  __int64 v6; // rcx
  ...
  if ( *(_WORD *)(a1 + 954) )
  {
    ...
    if ( v10 >= (unsigned __int64)v4 + 28 )
    {
      ...
      {
        if ( (_DWORD)v10 != 28 )
          sub_140032C80(v9, 0LL, v13);
      }
      else
      {
        v14 = v13 >> 2;
        if ( v14 )
          sub_140032C80(v9, 0LL, 4LL * v14);
      }
      v15 = *(_WORD *)(a1 + 982);
      v16 = v8 + 44;
      for ( i = 0; i < v15; ++i )
