/*
 * XREFs of sub_14000C180 @ 0x14000C180
 * Callers:
...
char __fastcall sub_14000C180(__int64 a1)
{
        ...
        *(_QWORD *)(v4 + 256)) )
  {
    ...
    if ( v13 )
      sub_140032C80(*(_QWORD *)(v4 + 256), 0LL, 4LL * v13);
    v14 = 0LL;
    while ( 1 )
    {
      v42 = v14;
