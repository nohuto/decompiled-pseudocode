  ...
  if ( !*(_BYTE *)(a1 + 20) )
  {
    ...
    if ( i )
    {
      ...
      if ( *(_WORD *)(a1 + 330) )
      {
        ...
        {
          v7 = 208LL * v5;
          sub_14001D628(a1, v7 + i, 0, 1, 1, 8);
          result = sub_14000CF50(a1, v6, v7 + *(_QWORD *)(a1 + 936), *(_QWORD *)(v7 + *(_QWORD *)(a1 + 936) + 8));
      ...
      if ( *(_WORD *)(a1 + 332) )
      {
        ...
        do
        {
          ...
          if ( *(_BYTE *)(v15 + v16 + 248) && *(_QWORD *)(v15 + v16 + 256) )
          {
            ...
            sub_14001F48C(a1, *(_QWORD *)(v15 + *(_QWORD *)(a1 + 944) + 256));
          }
          result = sub_14000CF50(a1, v14, v15 + *(_QWORD *)(a1 + 944), *(_QWORD *)(v15 + *(_QWORD *)(a1 + 944) + 8));
          ++v13;
        }
    ...
    if ( v18 )
    {
      sub_14001F48C(a1, *(_QWORD *)(v18 + 24));
      sub_14001F48C(a1, *(_QWORD *)(*(_QWORD *)(a1 + 936) + 32LL));
      sub_14001F48C(a1, *(_QWORD *)(*(_QWORD *)(a1 + 936) + 40LL));
      result = sub_14001F48C(a1, *(_QWORD *)(a1 + 936));
    }
    v19 = *(_QWORD *)(a1 + 944);
    if ( v19 )
    {
      sub_14001F48C(a1, *(_QWORD *)(v19 + 192));
      sub_14001F48C(a1, *(_QWORD *)(*(_QWORD *)(a1 + 944) + 224LL));
      result = sub_14001F48C(a1, *(_QWORD *)(a1 + 944));
    }
  }
  *(_QWORD *)(a1 + 944) = 0LL;
  *(_QWORD *)(a1 + 936) = 0LL;
