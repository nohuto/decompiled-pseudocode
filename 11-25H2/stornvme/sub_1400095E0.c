/*
 * XREFs of sub_1400095E0 @ 0x1400095E0
 * Callers:
 ...
 *     sub_14000D4E0 @ 0x14000D4E0 (sub_14000D4E0.c)
 *     __security_check_cookie @ 0x140032780 (__security_check_cookie.c)
 *     sub_140032980 @ 0x140032980 (sub_140032980.c)
 *     sub_140032C80 @ 0x140032C80 (sub_140032C80.c)
 */

char __fastcall sub_1400095E0(__int64 a1, __int64 a2, __int64 a3, char a4, int a5, unsigned __int16 a6, char *a7)
{
  char v8; // r14
  ...
  __int128 v55; // [rsp+D0h] [rbp-80h] BYREF
  ...
  switch ( (char)v61 )
  {
    case 2:
      if ( (unsigned int)BYTE8(v62) - 192 > 5
        ...
        && (BYTE8(v62) != 2 || (unsigned __int8)sub_14000C070(a1, 6LL, &v57, 0LL)) )
      {
        goto LABEL_31;
      }
      break;
    case 9:
      if ( BYTE8(v62) != 2 || (unsigned __int8)sub_14000C070(a1, 7LL, &v57, 0LL) )
        goto LABEL_31;
      break;
    case 10:
...
LABEL_16:
    ...
    case 25:
    case 26:
      if ( (unsigned __int8)sub_14000C070(a1, 3LL, &v57, 0LL) && (*(_BYTE *)(a1 + 21) & 2) != 0 )
      {
        v15 = sub_14000D4E0(a1, DWORD1(v61));
        StorPortExtendedFunction(87LL, a1, v15, 1LL);
        goto LABEL_83;
      }
      break;
    case -128:
    ...
    case -127:
    case -126:
      if ( (unsigned __int8)sub_14000C070(a1, 4LL, &v57, 0LL) && (*(_BYTE *)(a1 + 21) & 2) != 0 )
      {
        v16 = sub_14000D4E0(a1, DWORD1(v61));
  ...
  if ( ((a6 >> 9) & 7) != 0 )
  {
    if ( ((a6 >> 9) & 7) == 1 )
    {
      switch ( (unsigned __int8)(a6 >> 1) )
      {
        ...
        case 0x1Au:
          v8 = 2;
          BYTE2(v55) = BYTE2(v55) & 0xF0 | 6;
          goto LABEL_136;
        case 0x82u:
          v8 = 2;
          WORD6(v55) = 36;
          BYTE2(v55) = BYTE2(v55) & 0xF0 | 7;
          goto LABEL_137;
        default:
          break;
      }
...
LABEL_163:
  if ( v12 )
    *v12 = v8;
LABEL_156:
  if ( (v55 & 0x80u) != 0LL && v50 && v9 )
  {
    v51 = v9 <= 0x12u ? v9 : 18;
    sub_140032980(v50, &v55, v51);
    *(_BYTE *)(a2 + 3) |= 0x80u;
    if ( v9 > v51 )
    {
      v52 = v9 - v51;
      ...
      {
        if ( v52 )
          sub_140032C80(v53, 0LL, v52);
      }
      else
      {
        v54 = v52 >> 2;
        if ( v54 )
          sub_140032C80(v53, 0LL, 4LL * v54);
      }
    }
  }
LABEL_172:
