/*
 * XREFs of sub_140023450 @ 0x140023450
 * Callers:
...
__int64 __fastcall sub_140023450(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  ...
  if ( v4 && (v6 = *v10, v6 >= 0xC) )
  {
    if ( (v6 & 3) != 0 )
    {
      sub_140032C80(v4, 0LL, v6);
    }
    else
    {
      v7 = (unsigned int)v6 >> 2;
      if ( (_DWORD)v7 )
        sub_140032C80(v4, 0LL, 4 * v7);
    }
    v8 = *(_BYTE *)(v5 + 6);
    *(_WORD *)(v5 + 4) = 0;
    *(_DWORD *)v5 = 134217775;
    *(_DWORD *)(v5 + 7) = -16777212;
    *(_BYTE *)(v5 + 6) = v8 & 0x40 | 0x23;
