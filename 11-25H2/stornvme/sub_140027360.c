/*
 * XREFs of sub_140027360 @ 0x140027360
 * Callers:
...
__int64 __fastcall sub_140027360(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 v5; // r9
  __int64 v6; // r13
  ...
  LOBYTE(v9) = v5;
  v31 = v5;
  v13 = (_DWORD *)sub_14000B900(a2, &v32);
  v14 = v13[11];
  LODWORD(v32) = v14;
  if ( !v14 )
  {
...
LABEL_12:
  if ( v13[14] >= 0x1000u )
  {
    ...
    if ( v33 )
    {
      sub_140032C80(v33, 0LL, 4096LL);
      *(_BYTE *)(v6 + 4225) |= 3u;
      sub_1400042C0(a1, a2);
      sub_140020924(a1, v6 + 4096, v32, v28, v29, v9, v30, v8, v31);
      *(_BYTE *)(v6 + 4225) |= 4u;
      *(_QWORD *)(v6 + 4192) = sub_140011210;
      *(_QWORD *)(v6 + 4160) = v33;
      *(_QWORD *)(v6 + 4168) = v30;
      result = 0LL;
      *(_DWORD *)(v6 + 4208) = 4096;
