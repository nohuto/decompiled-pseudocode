/*
 * XREFs of sub_14001A5C4 @ 0x14001A5C4
 * Callers:
...
__int64 __fastcall sub_14001A5C4(__int64 a1)
{
  ...
  sub_14001A2D4(
    ...
    *(unsigned __int16 *)(a1 + 978),
    "MaxIoCompletionQueueCount",
    *(unsigned __int16 *)(a1 + 980),
    "MessageCount",
  ...
  if ( *((unsigned __int8 *)v1 + 263) != -1 )
  {
    do
    {
      v5 = (unsigned __int16 *)sub_14000C040(a1, v3);
      v6 = *((_BYTE *)v5 + 3);
      if ( (v6 & 2) != 0 )
        sub_14001A2D4(
          a1,
          ...
          *v5,
          "IPS",
          (unsigned __int64)*((unsigned __int8 *)v5 + 18) >> 6,
          "IDLP",
          v5[8],
          "APS",
          (unsigned __int64)*((unsigned __int8 *)v5 + 22) >> 6,
          "ACTP",
          v5[10]);
      result = ++v3;
    }
