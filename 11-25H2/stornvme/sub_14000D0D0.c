/*
 * XREFs of sub_14000D0D0 @ 0x14000D0D0
 * Callers:
...
__int64 __fastcall sub_14000D0D0(__int64 a1, unsigned __int8 a2)
{
  __int64 v2; // rdi
  __int64 result; // rax
  __int64 *v6; // r14
  ...
  if ( !*(_BYTE *)(a1 + 20) )
  {
    ...
    if ( (*(_BYTE *)(result + 261) & 0x20) != 0 )
    {
      ...
      *(_BYTE *)(v2 + 4225) |= 3u;
      LOBYTE(v8) = 18;
      *(_WORD *)(v2 + 4212) = 0;
      sub_140006580(a1, v2, v8, 0x400u, v9, -1, 0LL, 0);
      *(_BYTE *)(v2 + 4225) |= 4u;
      *(_QWORD *)(v2 + 4160) = *v6;
      *(_QWORD *)(v2 + 4168) = v9;
      *(_DWORD *)(v2 + 4208) = 1024;
      ...
      if ( *(_BYTE *)(a1 + 1019) != 1 )
      {
        result = sub_14000CF50(a1, 1024LL, v6, *(_QWORD *)(a1 + 4256));
        *v6 = 0LL;
        *(_QWORD *)(a1 + 4256) = 0LL;
      }
    }
