/*
 * XREFs of sub_14001DB6C @ 0x14001DB6C
 * Callers:
...
__int64 __fastcall sub_14001DB6C(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __int64 a7)
{
  __int64 v7; // rax
  unsigned int v8; // edi
  int v9; // ebp
  ...
  *(_QWORD *)a2 = a4;
  ...
  v12 = (unsigned int)(*(_DWORD *)(a1 + 200) * (2 * v9 + 1));
  v13 = *(_QWORD *)(a1 + 176) + 4096LL;
  v14 = a6;
  *(_WORD *)(a2 + 168) = v9;
  *(_DWORD *)(a2 + 170) = 0;
  *(_DWORD *)(a2 + 176) = 0;
  *(_QWORD *)(a2 + 16) = v13 + v12;
  sub_14001DE08(a1, a2, a3, v14);
  sub_14001DD70(a1, a2, v15, a7);
  if ( (_WORD)v9 && (unsigned __int16)v9 <= *(_WORD *)(a1 + 334) )
  {
    v16 = a2 + 336;
    *(_BYTE *)(a2 + 248) = 1;
    *(_QWORD *)(a2 + 336) = a1;
        ...
        if ( *v19 )
        {
          if ( *(_WORD *)(a1 + 234) )
          {
            do
            {
              ...
              StorPortExtendedFunction(88LL, a1, sub_14002ABC0, v16);
