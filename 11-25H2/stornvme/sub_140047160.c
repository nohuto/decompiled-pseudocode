/*
 * XREFs of sub_140047160 @ 0x140047160
 * Callers:
...
__int64 __fastcall sub_140047160(volatile signed __int32 *a1, unsigned __int32 a2, __int64 a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        ...
        {
          v5 = (sub_140047128(*(unsigned int **)v7, *v6++) & 1) != 0;
          if ( !v5 )
            break;
        }
      }
