/*
 * XREFs of sub_140018CB0 @ 0x140018CB0
 * Callers:
...
char __fastcall sub_140018CB0(__int64 a1, __int64 a2)
{
  unsigned int v3; // edi
  ...
  UncachedExtension = StorPortGetUncachedExtension(a1, a2, v3);
  *(_QWORD *)(a1 + 1576) = UncachedExtension;
  if ( UncachedExtension )
  {
    sub_140032C80(UncachedExtension, 0LL, 4LL * (v3 >> 2));
    v5 = *(_QWORD *)(a1 + 1576);
    if ( *(_BYTE *)(a1 + 20) )
    {
