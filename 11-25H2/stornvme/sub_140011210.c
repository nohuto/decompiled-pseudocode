/*
 * XREFs of sub_140011210 @ 0x140011210
 * Callers:
 *     <none>
 * Callees:
...
__int16 __fastcall sub_140011210(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  char v6; // dl
  __int64 v7; // rbx
...
LABEL_64:
  ...
  if ( !v8 )
  {
    ...
    if ( (_DWORD)v15 )
    {
      ...
      if ( v16 )
      {
        LOWORD(v15) = sub_140032980((char *)v14 + (unsigned int)v14[6] + 8, v16, (unsigned int)v15);
        if ( v10 )
        {
          if ( v14[4] == 2 )
            LOWORD(v15) = sub_140005320(a1, a2, *(unsigned __int8 **)(v7 + 4160), 13);
        }
      }
    }
    goto LABEL_65;
...
LABEL_63:
  ...
  LOWORD(v15) = sub_140032980((char *)v14 + (unsigned int)v14[6] + a4 + 8, v17, *(unsigned int *)(v7 + 4208));
  v19 = *(_DWORD *)(v7 + 4208);
  if ( *((_DWORD *)v8 + 11) )
    v19 += v14[7];
  v14[7] = v19;
...
LABEL_65:
  ...
  *((_DWORD *)v8 + 11) = v24;
  ...
  sub_140006580(a1, v7, *v8, v21, *((_QWORD *)v8 + 3), *((_DWORD *)v8 + 2), v23, v14[10]);
  if ( v11 )
  {
