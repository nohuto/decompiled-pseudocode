/*
 * XREFs of sub_14000C770 @ 0x14000C770
 * Callers:
...
__int64 __fastcall sub_14000C770(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v5; // esi
  unsigned int i; // edi
  __int64 v7; // r9
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( v11[0] == 2 )
    {
      ...
      if ( !(unsigned int)StorPortExtendedFunction(106LL, a1, &v12, v7) )
      {
        ...
        {
          _InterlockedIncrement((volatile signed __int32 *)(a1 + 3992));
          return 3238002700LL;
        }
      }
    }
