/*
 * XREFs of sub_140006730 @ 0x140006730
 * Callers:
...
__int64 __fastcall sub_140006730(__int64 a1, unsigned __int16 a2, char a3)
{
  __int64 result; // rax
  char v5; // si
  __int64 v6; // r8
  ...
  if ( (result & 0x10) == 0 )
  {
    ...
    if ( a2 == 0xFFFF || *(_WORD *)(a1 + 272) <= 1u )
    {
      ...
      {
        sub_140006980(a1, *(unsigned __int16 *)(a1 + 720));
        if ( v5 )
        {
          result = sub_1400130E0(v12 + 24, a1, v12, 0LL);
        }
        else
        {
          v16 = 0;
      ...
      for ( i = 0; v7; ++i )
      {
        ...
        {
          sub_140006980(a1, *(unsigned __int16 *)(v9 + 176));
          if ( v5 )
          {
            result = sub_1400130E0(v10 + 24, a1, v10, 0LL);
          }
          else
          {
            v16 = 0;
    ...
    else
    {
      ...
      if ( v5 )
      {
        return sub_1400130E0(v6 + 24, a1, v6, 0LL);
      }
      else
      {
        v16 = 0;
