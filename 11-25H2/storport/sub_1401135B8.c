/*
 * XREFs of sub_1401135B8 @ 0x1401135B8
 * Callers:
...
__int64 __fastcall sub_1401135B8(__int64 a1, void *a2, __int64 a3, char *a4)
{
  char *v4; // rax
  bool v5; // zf
  __int64 v7; // rdi
...
LABEL_19:
  ...
  if ( v17 && v16 >= v19 )
  {
    ...
    if ( v16 - v19 < 0xC )
    {
      sub_140112680(a3, 18, 5, 36, 0);
      return (unsigned int)-1073741811;
    }
    v22 = v16;
    memset_0(v17, 0, v16);
    v21 = sub_1400E1168(*(_QWORD *)(v7 + 16), v23, 2u, 0x200u, 0LL, v35, 1, &P, 0LL, 0LL);
    if ( v21 >= 0 )
    {
      v24 = 4LL;
      if ( v18 != 26 )
