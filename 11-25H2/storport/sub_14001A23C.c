/*
 * XREFs of sub_14001A23C @ 0x14001A23C
 * Callers:
...
__int64 __fastcall sub_14001A23C(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v4; // ebx
  ...
  if ( v35 >= 0 && v6 )
  {
    ...
    if ( v7 == 1 )
      sub_1400BC3FC(*(_QWORD *)(a1 + 32), *(unsigned int *)v6);
  }
  v9 = byte_140168DAA == 0;
  *(_BYTE *)(a2 + 141) = -84;
  *(_DWORD *)(a2 + 48) = v35;
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v4 = *v12;
        sub_140056AB0((_DWORD)v10, v11, (unsigned int)&v36, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_78;
    }
...
LABEL_73:
      ...
      sub_140052E64((_DWORD)v10, v14, (unsigned int)&v36, a2, *(_DWORD *)(a2 + 48), v28, v15, v18, v4, v31, a2);
    }
  }
LABEL_78:
