/*
 * XREFs of sub_1400B5B48 @ 0x1400B5B48
 * Callers:
...
void __fastcall sub_1400B5B48(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x800000000000LL) )
    {
      ...
      v37 = &v19;
      v38 = 4LL;
      sub_140038378((__int64)v39, *(_BYTE **)(v2 + 752));
      sub_140038378((__int64)v40, *(_BYTE **)(*(_QWORD *)(v4 + 16) + 792LL));
      v6 = *(_QWORD *)(v5 + 16);
      ...
      v21 = v7 != 0 ? 20 : 17;
      v43 = &v21;
      sub_140037B0C((__int64)v45, *(const int **)(*(_QWORD *)(v6 + 128) + 1016LL));
      v46 = &v25;
      v16 = *(_BYTE *)(v8 + 8);
      v48 = &v16;
      v26 = *(_QWORD *)(v8 + 360);
      ...
      v60 = &v28;
      v61 = 8LL;
      sub_140037B0C((__int64)v62, (const int *)L"Read, Write");
      sub_140037B0C((__int64)v63, *(const int **)(v11 + 16));
      sub_140037B0C((__int64)v64, (const int *)L"Flush, Unmap");
      sub_140037B0C((__int64)v65, (const int *)L"64ms, 256ms, 1024ms, 5120ms, 5120+ms");
      v67 = 8LL;
      v13 = *v12;
      v69 = 2LL;
      v66 = &v29;
      ...
      v68 = &v17;
      v14 = v12[46];
      v17 = 3 * qword_140169170;
      v70 = v14;
      v71 = 8 * (unsigned __int16)(3 * qword_140169170);
      sub_140037A5C(
        (3 * qword_140169170) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_140159B91,
        v15,
        (__int64)v12,
        0x1Au,
        &v30);
