/*
 * XREFs of sub_140068824 @ 0x140068824
 * Callers:
...
__int64 __fastcall sub_140068824(__int64 a1, _DWORD *a2)
{
  __int64 v3; // rdx
  _BOOL8 v5; // r8
  int v6; // eax
      ...
      do
      {
        ...
        else
        {
          ...
          if ( (v21 & 2) != 0 )
            ...
            LOBYTE(v13) = sub_1400686B8((volatile signed __int32 *)*v12, v21, (__int64)v12);
