/*
 * XREFs of sub_1400AEA8C @ 0x1400AEA8C
 * Callers:
...
void __fastcall sub_1400AEA8C(__int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // rcx
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 5336) = 0LL;
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_140168178 > 5 && sub_14003F840(v5, 0x400000000000LL) )
      {
        v54 = 16LL;
        v53 = a1 + 5064;
        v23 = *(_DWORD *)(a1 + 56);
        ...
        v26 = v6;
        v58 = 8LL;
        sub_140037A5C(v8, (unsigned __int8 *)dword_140159ED9, v9, v10, 5u, &v52);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 144); i != (__int64 *)(a1 + 144); i = (__int64 *)*i )
    {
      ...
      *((_DWORD *)i + 534) = 0;
      ...
      if ( sub_140021280((__int64)(i - 8)) )
      {
        ...
        {
          if ( sub_14003F840(v13, 0x400000000000LL) )
          {
            v31 = 16LL;
            v30 = a1 + 5064;
            v33 = 16LL;
            ...
            v49 = 8LL;
            v51 = 4LL;
            sub_140037A5C(v14, (unsigned __int8 *)dword_140158B4E, v15, v16, 0xDu, &v29);
          }
        }
