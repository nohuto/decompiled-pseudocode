/*
 * XREFs of sub_140139008 @ 0x140139008
 * Callers:
...
__int64 __fastcall sub_140139008(__int64 a1, int *a2, unsigned int a3, _DWORD *a4)
{
  char v7; // r15
  ...
  if ( a3 > 0x30 )
  {
    v8 = *a2;
    v23 = *a2;
    sub_1401352EC((char *)&v23, 4u);
    if ( a3 < v23 + 4 || (v23 = v8, sub_1401352EC((char *)&v23, 4u), a3 = v9 + v23, v9 + v23 > 0x30) )
    {
      v10 = a3 - 48;
      for ( i = a2 + 12; v10 >= 4; i = (_DWORD *)((char *)i + v13) )
      {
        LOWORD(v23) = *(_WORD *)i;
        sub_1401352EC((char *)&v23, 2u);
