...
void __fastcall sub_1400B86BC(__int64 a1)
{
  ...
  if ( sub_140021280(a1) )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1872) + 32LL) & 0x100) != 0 )
    {
      ...
      {
        if ( sub_14003F840(v2, 0x400000000000LL) )
        {
          v6 = *(_QWORD *)(a1 + 1872);
          v7 = *(_QWORD *)(a1 + 24);
          v22 = 16LL;
          ...
          v45 = &v19;
          v46 = 8LL;
          sub_140037A5C(v8, (unsigned __int8 *)dword_140157B3D, v3, v4, 0xFu, &v20);
        }
      }
