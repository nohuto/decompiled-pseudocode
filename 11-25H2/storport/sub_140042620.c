/*
 * XREFs of sub_140042620 @ 0x140042620
 * Callers:
...
__int64 __fastcall sub_140042620(__int64 a1, unsigned int a2, int a3, char a4)
{
  __int64 v4; // rbx
  __int64 v5; // r14
  ...
  if ( (unsigned int)(a3 - 1) > 1
    ...
    || (v13 = sub_140039148(v12), (v5 = v13) == 0) )
  {
    v11 = -1073741811;
    goto LABEL_65;
  }
  if ( v6 == 2 && *(_DWORD *)(v13 + 392) != 5 )
    goto LABEL_9;
  v15 = *(_QWORD *)(v13 + 5376);
  if ( !v15
    || !*(_QWORD *)(v15 + 8)
  ...
  if ( !sub_140027930(*(_QWORD *)(v5 + 960)) )
  {
    v11 = -1073741808;
    goto LABEL_65;
  }
  ...
  if ( !v17 )
  {
    v18 = sub_1400143E0(64LL, 80LL, 1163026770LL, *(_QWORD *)(v5 + 8));
    *(_QWORD *)(v5 + 6144) = v18;
    v17 = v18;
    if ( !v18 )
      goto LABEL_28;
...
LABEL_9:
  ...
  v20 = sub_1400143E0(64LL, 24LL * v53, 1163026770LL, *(_QWORD *)(v5 + 8));
  v52 = (_BYTE *)v20;
  v7 = (_BYTE *)v20;
  if ( !v20 )
  {
LABEL_28:
  ...
  for ( i = 0LL; (unsigned int)i < v53; i = (unsigned int)(i + 1) )
  {
    if ( v6 == 2 )
    {
      v22 = RtlCompareMemory(&v7[24 * i], &qword_14014C498, 0x10uLL) == 16;
    }
    else
    {
      if ( v6 == 1 )
      ...
      *(_QWORD *)&v58 = 0LL;
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( v48 != 1 )
          goto LABEL_69;
        v29 = &v52[24 * i];
        if ( RtlCompareMemory(v29, &unk_14014C4C8, 0x10uLL) != 16
          && RtlCompareMemory(v29, &qword_14014C498, 0x10uLL) != 16 )
        {
          v11 = -1073741637;
          goto LABEL_63;
        }
