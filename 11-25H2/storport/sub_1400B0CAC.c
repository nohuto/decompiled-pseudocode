/*
 * XREFs of sub_1400B0CAC @ 0x1400B0CAC
 * Callers:
...
char __fastcall sub_1400B0CAC(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  __int64 v4; // rax
  __int64 v6; // rcx
  const int *v7; // rdx
  ...
  {
    LOBYTE(v4) = sub_14003F840(a1, 0x400000000000LL);
    if ( (_BYTE)v4 )
    {
      ...
      v53 = v30;
      v116 = 8LL;
      LOBYTE(v4) = sub_1400383AC(v30, (unsigned __int8 *)dword_140156706, v31, v32, v34, v35, 0x27u, &v55);
    }
  }
  return v4;
}
