/*
 * XREFs of sub_1401AB0F0 @ 0x1401AB0F0
 * Callers:
...
NTSTATUS __fastcall sub_1401AB0F0(__int64 a1, __int64 a2)
{
  __int64 v2; // r12
  int v3; // ebx
  __int64 v6; // r13
...
LABEL_44:
              ...
              LODWORD(v36) = *(_DWORD *)(a2 + 48);
              sub_140052E64(v14, v27, &v42, a2, v36, v37, v38, v20, v3, v25, a2);
              goto LABEL_18;
            }
LABEL_43:
            v20 = 0;
      ...
      case 0x1B:
        if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            LODWORD(v36) = v3;
            sub_140056AB0(v14, v15, &v42, a2, v36, v37);
          }
          goto LABEL_18;
        }
    ...
    sub_140052F3C(v14, v16, &v42, a2, v36);
    goto LABEL_18;
  }
  *(_BYTE *)(v11 + 3) = v9;
  *(_BYTE *)(v11 + 4) = v8;
...
LABEL_10:
  if ( byte_140168DAA )
  {
    ...
    {
      LODWORD(v36) = 0;
      sub_140052F3C(0LL, &stru_140148B18, &v43, a2, v36);
    }
  }
  ++*(_BYTE *)(a2 + 67);
  *(_QWORD *)(a2 + 184) += 72LL;
