/*
 * XREFs of sub_1401826BC @ 0x1401826BC
 * Callers:
...
__int64 __fastcall sub_1401826BC(__int64 a1, __int64 a2)
{
  __int64 v3; // rcx
  bool v4; // zf
  int v5; // ebx
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v5 = *v8;
        sub_140056AB0(v6, v7, &v32, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
    ...
    v28 = *(_DWORD *)(a2 + 48);
LABEL_68:
    sub_140052F3C(v6, v9, &v32, a2, v28);
    goto LABEL_69;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_69;
...
LABEL_64:
      ...
      sub_140052E64(v6, v10, &v32, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v5, v26, a2);
    }
  }
LABEL_69:
