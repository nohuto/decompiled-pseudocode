/*
 * XREFs of sub_14017ED90 @ 0x14017ED90
 * Callers:
...
__int64 __fastcall sub_14017ED90(__int64 a1, __int64 a2)
{
  int v3; // ebx
  _DWORD *v4; // rdx
  unsigned int v5; // esi
...
LABEL_82:
      ...
      sub_140052E64(v13, v17, &v39, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v17 + 3), v18, v21, v3, v33, a2);
    }
  }
LABEL_87:
