/*
 * XREFs of sub_1400685C8 @ 0x1400685C8
 * Callers:
 *     sub_140068544 @ 0x140068544 (sub_140068544.c)
 * Callees:
 *     sub_1400683C4 @ 0x1400683C4 (sub_1400683C4.c)
 *     __security_check_cookie @ 0x14013C590 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x14013C5D0 (_guard_dispatch_icall.c)
 */

__int64 __fastcall sub_1400685C8(__int64 a1, __int64 a2, __int64 a3)
{
  __int16 v3; // bx
  unsigned int v5; // ebp
  _DWORD *v6; // rax
  ...
  v3 = a2;
  v5 = a3;
  v6 = sub_1400683C4((__int64)v11, *(volatile signed __int32 **)(a1 + 8), a3, SHIDWORD(a2));
  v7 = 0;
  v12 = *(_OWORD *)v6;
  v13 = *((_QWORD *)v6 + 2);
  if ( qword_140168690 )
    qword_140168690(*(unsigned int *)(a1 + 24), v5, 1LL, *(_QWORD *)(a1 + 8), &v12);
