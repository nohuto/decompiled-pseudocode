/*
 * XREFs of sub_140053D10 @ 0x140053D10
 * Callers:
...
__int64 __fastcall sub_140053D10(__int64 a1, char a2, int *a3)
{
  unsigned int v4; // edi
  int v7; // esi
  int v8; // edx
  ...
  {
    sub_1400583CC(a1, (unsigned int)&unk_140149D40, 1024, v8, a3[1], *v9, a3[3], a3[4], a3[5], a3[6]);
    v8 = *a3;
  }
