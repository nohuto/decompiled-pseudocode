/*
 * XREFs of sub_14017B3BC @ 0x14017B3BC
 * Callers:
...
void __fastcall sub_14017B3BC(GUID *Guid, _QWORD *a2, int *a3, _BYTE *a4)
{
  __int64 v8; // rbx
  __int64 v9; // rax
  ...
  v25 = 0;
  GuidString = 0LL;
  if ( (int)RtlQueryRegistryValuesEx(2147483650LL, &xmmword_14014BAC8, &v17, 0LL, 0LL) >= 0 )
  {
    if ( v13 )
    {
      v21 = 4;
      ...
      v31 = 0LL;
      v32 = 0;
      v33[0] = xmmword_14014BAC8;
      v33[1] = xmmword_14014BAD8;
