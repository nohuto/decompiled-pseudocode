/*
 * XREFs of sub_14002AE80 @ 0x14002AE80
 * Callers:
...
__int16 __fastcall sub_14002AE80(union _SLIST_HEADER *a1)
{
  __int128 *v2; // rax
    ...
    if ( v11 )
    {
      while ( 1 )
      {
        ...
        if ( *(__int128 **)(v19 + 8) != &v19 )
          break;
        *(_QWORD *)v14 = v19;
        v11->Next = (struct _SLIST_ENTRY *)&v19;
        v11 = Next;
        *(_QWORD *)(v12 + 8) = v14;
        *(_QWORD *)&v19 = v14;
        v14[20] &= ~2u;
    ...
    if ( !(_WORD)v2 )
    {
      ...
      while ( 1 )
      {
        ...
        *((_BYTE *)Alignment + 20) |= 2u;
        ...
        if ( v6 )
          v6->Next = (struct _SLIST_ENTRY *)v10;
        else
