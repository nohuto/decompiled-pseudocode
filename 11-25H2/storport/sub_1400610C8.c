/*
 * XREFs of sub_1400610C8 @ 0x1400610C8
 * Callers:
...
__int64 __fastcall sub_1400610C8(CMSPAddress *a1, __int64 a2)
{
  int v2; // ebx
  PVOID v5; // r14
  _BYTE **v6; // rsi
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 0x18u )
  {
    ...
    if ( !v8 )
    {
      if ( P )
      {
        v7 = sub_140016234(a1, (PIRP)a2, (unsigned int *)P, v39, 0LL, 0, 128, 0);
        goto LABEL_11;
      }
      v7 = -1073741801;
    }
  ...
  if ( **v6 != 15 )
  {
    ...
    if ( v11[1] == 7 && !*((_DWORD *)v11 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v33) = v2;
        sub_140056AB0(v10, (__int64)v11, &v42, a2, v33, v34);
      }
      goto LABEL_79;
    }
...
LABEL_78:
    ...
    sub_140052F3C(v10, v13, &v42, a2, v33);
    goto LABEL_79;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_79;
...
LABEL_74:
      ...
      LOBYTE(v34) = v28;
      LODWORD(v33) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v10, v14, &v42, a2, v33, v34, v35, v36, v2, v31, a2);
    }
  }
LABEL_79:
