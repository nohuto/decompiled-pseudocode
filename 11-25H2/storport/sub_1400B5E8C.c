/*
 * XREFs of sub_1400B5E8C @ 0x1400B5E8C
 * Callers:
...
void __fastcall sub_1400B5E8C(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x400000000000LL) )
    {
      ...
      v39 = &v21;
      v40 = 4LL;
      sub_140038378((__int64)v41, *(_BYTE **)(v2 + 752));
      sub_140038378((__int64)v42, *(_BYTE **)(*(_QWORD *)(v4 + 16) + 792LL));
      v6 = *(_QWORD *)(v5 + 16);
      ...
      v23 = v7 != 0 ? 20 : 17;
      v45 = &v23;
      sub_140037B0C((__int64)v47, *(const int **)(*(_QWORD *)(v6 + 128) + 1016LL));
      v48 = &v27;
      v17 = *(_BYTE *)(v8 + 8);
      v50 = &v17;
      v28 = *(_QWORD *)(v8 + 360);
      ...
      v62 = &v30;
      v63 = 8LL;
      sub_140037B0C((__int64)v64, (const int *)L"Read, Write");
      v12 = *(const int **)(v11 + 16);
      v65 = &v18;
      v67 = (__int64)*(&xmmword_1401690E8 + 1);
      v18 = WORD1(qword_1401690E0);
      v68 = 8 * WORD1(qword_1401690E0);
      v66 = 2LL;
      v69 = 0;
      sub_140037B0C((__int64)v70, v12);
      sub_140037B0C((__int64)v71, (const int *)L"Flush, Unmap");
      sub_140037B0C((__int64)v72, (const int *)L"64ms, 256ms, 1024ms, 5120ms, 5120+ms");
      v74 = 8LL;
      v14 = *v13;
      v76 = 2LL;
      v73 = &v31;
      ...
      v77 = v15;
      v78 = 8 * (unsigned __int16)(3 * qword_140169170);
      sub_140037A5C(
        (3 * qword_140169170) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_14015A5B8,
        v16,
        (__int64)v13,
        0x1Cu,
        &v32);
