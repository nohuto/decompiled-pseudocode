/*
 * XREFs of sub_14019188C @ 0x14019188C
 * Callers:
...
__int64 __fastcall sub_14019188C(__int64 a1, __int64 a2)
{
  int v2; // ebx
  unsigned int v4; // esi
  __int64 v5; // r8
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 592) )
  {
    ...
    {
      v6 = sub_1400CDA00(a1, *(_QWORD *)(v5 + 8) ^ a1, 1, &v42);
      *(_QWORD *)&v43.Data1 = v6;
      v7 = v6;
      if ( v6 )
      {
  ...
  if ( *(_BYTE *)v16 != 15 )
  {
    ...
    if ( *(_BYTE *)(v16 + 1) == 7 && !*(_DWORD *)(v16 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v17 )
          v2 = *v17;
        sub_140056AB0(v15, v16, &v43, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_88;
    }
    ...
    v38 = *(_DWORD *)(a2 + 48);
LABEL_87:
    sub_140052F3C(v15, v18, &v43, a2, v38);
    goto LABEL_88;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_88;
...
LABEL_83:
      ...
      sub_140052E64(v15, v19, &v43, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v19 + 3), v20, v23, v2, v36, a2);
    }
  }
LABEL_88:
