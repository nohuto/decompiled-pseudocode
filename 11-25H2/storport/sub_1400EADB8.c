/*
 * XREFs of sub_1400EADB8 @ 0x1400EADB8
 * Callers:
 *     sub_14018D660 @ 0x14018D660 (sub_14018D660.c)
 * Callees:
 *     sub_1400143E0 @ 0x1400143E0 (sub_1400143E0.c)
 *     sub_1400DB244 @ 0x1400DB244 (sub_1400DB244.c)
 *     memmove @ 0x14013C680 (memmove.c)
 *     memset_0 @ 0x14013C980 (memset_0.c)
 */

__int64 __fastcall sub_1400EADB8(__int64 a1, unsigned int *a2)
{
  ...
  v2 = a2[9];
  LODWORD(v3) = 0;
  v4 = (unsigned __int16 *)qword_140168E40;
  v73 = 0;
  v6 = a1;
  v75 = 0;
  v7 = 0;
  ...
  if ( v2 )
  {
    ...
    do
    {
      if ( sub_1400DB244((__int64)(v12 - 1)) )
      {
        ++v7;
      }
  ...
  if ( v7 <= v15 + 1 )
  {
    ...
    v72 = v3;
    v79 = v3;
    v39 = sub_1400143E0(64LL, v38, 1380147538LL, v6);
    LODWORD(v3) = 0;
    v76 = (_BYTE *)v39;
    v10 = (void *)v39;
    if ( !v39 )
...
LABEL_57:
    ...
    while ( v41 < a2[9] && v40 )
    {
      if ( sub_1400DB244((__int64)&a2[8 * v41 + 10]) )
      {
        do
        {
          if ( !v47 )
...
LABEL_109:
  ...
  {
    if ( !sub_1400DB244((__int64)&a2[8 * i + 10]) )
      continue;
    if ( v19 )
    {
      while ( ((1LL << v20) & v19) == 0 )
...
LABEL_37:
  ...
  while ( i < v31 )
  {
    if ( sub_1400DB244((__int64)&a2[8 * i + 10]) )
    {
      do
      {
        if ( !sub_1400DB244((__int64)&a2[8 * v32 + 10]) && v33 != v35 )
        {
          v37 = 8LL * v35;
