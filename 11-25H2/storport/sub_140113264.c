/*
 * XREFs of sub_140113264 @ 0x140113264
 * Callers:
...
__int64 __fastcall sub_140113264(unsigned __int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  __int64 v6; // r15
  _DWORD *v7; // rdi
  unsigned int v8; // esi
  ...
  if ( v10 )
  {
    if ( v10 == 13 )
    {
      result = sub_140112F9C(v6, a3, (int *)&v12, (__int64)v7);
      goto LABEL_16;
    }
    if ( v10 == 47 )
    {
      result = sub_140112EA4(v6, a3, &v12, (__int64)v7);
LABEL_16:
      v8 = v12;
      goto LABEL_20;
    }
