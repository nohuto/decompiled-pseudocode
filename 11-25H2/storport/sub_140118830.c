/*
 * XREFs of sub_140118830 @ 0x140118830
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140118830(struct _KDPC *Dpc, _QWORD *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  ...
  {
    if ( (unsigned __int8)sub_14011C9D0(DeferredContext, CurrentProcessorNumber) )
    {
      v7.QuadPart = -600LL;
    }
    else
    ...
    if ( (!DeferredContext[159] || !*(_DWORD *)DeferredContext[159])
