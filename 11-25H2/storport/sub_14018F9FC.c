/*
 * XREFs of sub_14018F9FC @ 0x14018F9FC
 * Callers:
...
__int64 __fastcall sub_14018F9FC(__int64 a1, __int64 a2)
{
  __int64 v2; // r15
  int v3; // ebx
  __int64 v5; // rax
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 592) )
  {
    ...
    if ( v5 && *(_DWORD *)(v2 + 16) >= 0x10u && *(_WORD *)v5 == 1 && *(_WORD *)(v5 + 2) >= 0x10u )
    {
      if ( *(_DWORD *)(v2 + 8) >= 8u )
      {
        v7 = sub_1400CDA00(a1, *(_QWORD *)(v5 + 8) ^ a1, 0, 0LL);
        v8 = v7;
        if ( v7 )
        {
          v6 = sub_1400BCC38(v7);
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v3 = *v12;
        sub_140056AB0(v10, v11, &v42, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_93;
    }
    ...
    v18 = &stru_140149FE8;
LABEL_92:
    sub_140052F3C(v10, v18, &v42, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_93;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_93;
...
LABEL_88:
      ...
      sub_140052E64(v10, v19, &v42, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v19 + 3), v20, v23, v3, v36, a2);
    }
  }
LABEL_93:
