/*
 * XREFs of sub_14009281C @ 0x14009281C
 * Callers:
...
__int64 __fastcall sub_14009281C(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)v16 != 15 )
  {
    ...
    if ( *(_BYTE *)(v16 + 1) == 7 && !*(_DWORD *)(v16 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v17 )
          v9 = *v17;
        sub_140056AB0(v15, v16, &v41, a2, v9, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_88;
    }
    ...
    v18 = &stru_140149FE8;
LABEL_87:
    sub_140052F3C(v15, v18, &v41, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_88;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_88;
...
LABEL_83:
      ...
      sub_140052E64(v15, v19, &v41, a2, *(_DWORD *)(a2 + 48), v31, v20, v23, v9, v34, a2);
    }
  }
LABEL_88:
