/*
 * XREFs of sub_1400C2C00 @ 0x1400C2C00
 * Callers:
...
void __fastcall sub_1400C2C00(__int64 a1, char a2, __int64 a3, unsigned __int16 a4, char a5)
{
  __int128 v8; // xmm0
  __int64 v9; // rcx
  __int16 *v10; // r11
  ...
  if ( byte_140168DAA )
  {
    ...
    if ( (byte_1401694F9 & 1) != 0 )
    {
      ...
      if ( !v24 || (v25 = *(const wchar_t **)(v24 + 24)) == 0LL )
        v25 = (const wchar_t *)&unk_140149394;
      sub_1400BEFF4(
        (a4 >> 9) & 7,
        &stru_14014A720,
        v11,
