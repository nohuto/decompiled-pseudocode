/*
 * XREFs of sub_1400D19A0 @ 0x1400D19A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1400D19A0(__int64 a1, _DWORD *a2)
{
  ...
  v6 = sub_14002B090((__int64)(a2 + 42));
  if ( byte_140168DAA && (byte_1401694F3 & 8) != 0 )
  {
    ...
    if ( (byte_1401694F3 & 8) != 0 )
      sub_140056B30(v14, v10, v11, sub_1400D19A0, a2[14], CurrentProcessorNumber, v14);
  }
  return v6;
}
