/*
 * XREFs of sub_140094264 @ 0x140094264
 * Callers:
...
NTSTATUS __fastcall sub_140094264(__int64 a1, __int64 a2)
{
  __int64 v3; // rdx
  int v4; // ebp
  int v6; // ebx
...
LABEL_67:
      ...
      sub_140052E64(v8, v12, &v34, a2, *(_DWORD *)(a2 + 48), v25, v13, v16, v6, v28, a2);
    }
  }
LABEL_72:
