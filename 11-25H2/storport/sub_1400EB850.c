/*
 * XREFs of sub_1400EB850 @ 0x1400EB850
 * Callers:
...
__int64 __fastcall sub_1400EB850(PVOID SystemArgument2)
{
  __int64 v2; // rbx
  __int64 v3; // r8
  __int64 v4; // r14
  ...
  if ( !v4 )
    return 3221225626LL;
  v6 = sub_1400E736C((__int64)SystemArgument2, 0x1000u, v3, (void **)&v12, (_QWORD *)&v12 + 1, 0);
  if ( v6 >= 0 )
  {
    v8 = v12;
    ...
    *(_OWORD *)(*(_QWORD *)v4 + 4160LL) = __PAIR128__(*((unsigned __int64 *)&v12 + 1), v8);
    *(_DWORD *)(*(_QWORD *)v4 + 4248LL) = 4096;
    *(_QWORD *)(*(_QWORD *)v4 + 4192LL) = sub_1400E90F0;
    *(_QWORD *)(*(_QWORD *)v4 + 4200LL) = v4;
    sub_1400BC9C0((__int64)SystemArgument2, *(_QWORD *)v4 + 4096LL, 6, v7, v11, 0, *((__int64 *)&v12 + 1), -1, 0);
    v6 = sub_1400BD378(SystemArgument2, v4);
    if ( v6 >= 0 )
    {
      if ( *((_QWORD *)SystemArgument2 + 75)
        || (v9 = sub_1400143E0(64LL, 4096LL, 1380147538LL, *(_QWORD *)(*((_QWORD *)SystemArgument2 + 16) + 8LL)),
            (*((_QWORD *)SystemArgument2 + 75) = v9) != 0LL) )
      {
        do
        {
          *(_BYTE *)(v2 + *((_QWORD *)SystemArgument2 + 75)) = *(_BYTE *)(v2 + v8);
          ++v2;
        }
        while ( v2 < 4 );
        *(_DWORD *)(*((_QWORD *)SystemArgument2 + 75) + 4LL) = *(_DWORD *)(v8 + 4);
        *(_QWORD *)(*((_QWORD *)SystemArgument2 + 75) + 8LL) = *(_QWORD *)(v8 + 8);
      }
      else
      {
        v6 = -1073741670;
  ...
  sub_1400F5FEC((_DWORD)SystemArgument2, 4096, v10, v12, *((__int64 *)&v12 + 1));
