/*
 * XREFs of sub_1400B53E4 @ 0x1400B53E4
 * Callers:
        ...
        __int64 a14)
{
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x400000000000LL) )
    {
      ...
      v70 = 8LL;
      v72 = 8LL;
      sub_140037A5C(*(__int64 *)&qword_140168DC8, (unsigned __int8 *)dword_140157FDF, v23, v22, 0x17u, &v35);
    }
  }
}
