/*
 * XREFs of sub_14005A6E4 @ 0x14005A6E4
 * Callers:
...
__int64 __fastcall sub_14005A6E4(__int64 a1, __int64 a2)
{
  int v2; // ebx
  PVOID v5; // r14
  int v6; // r15d
  ...
  {
    sub_1400894D0(*(_QWORD *)(a1 + 8), a2, P, &v44);
    v5 = P[0];
    if ( !P[0] )
    {
      v6 = -1073741801;
...
LABEL_11:
  ...
  if ( v6 >= 0 )
  {
    sub_14008F5F4(a1, 0LL, 1074004128LL, 5LL);
    if ( (*(_BYTE *)(a1 + 110) & 2) != 0 )
    {
      if ( sub_140058E38(a1, (struct _IO_WORKITEM *)a2) )
      {
  ...
  if ( *(_BYTE *)v15 != 15 )
  {
    ...
    if ( *(_BYTE *)(v15 + 1) == 7 && !*(_DWORD *)(v15 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v36) = v2;
        sub_140056AB0(v14, v15, &v45, a2, v36, v37);
      }
      goto LABEL_89;
    }
...
LABEL_88:
    ...
    sub_140052F3C(v14, v17, &v45, a2, v36);
    goto LABEL_89;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_89;
...
LABEL_84:
      ...
      LOBYTE(v37) = v32;
      LODWORD(v36) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v14, v18, &v45, a2, v36, v37, v38, v39, v40, v41, a2);
    }
  }
LABEL_89:
