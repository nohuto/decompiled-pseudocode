/*
 * XREFs of sub_1400B6D8C @ 0x1400B6D8C
 * Callers:
...
__int64 __fastcall sub_1400B6D8C(__int64 a1)
{
  ...
  char Dst[8]; // [rsp+260h] [rbp-48h] BYREF
  ...
  v3 = *(_QWORD *)(a1 + 608);
  v4 = (unsigned int)qword_140169170;
  v5 = 0LL;
  v6 = 0LL;
  v54 = 0LL;
  v55 = 0LL;
  if ( *(_QWORD *)(v3 + 8) )
  {
    v5 = (_QWORD *)sub_1400143E0(72LL, (unsigned int)Size, 1700028754LL, *(_QWORD *)(a1 + 8));
    if ( v5
                            ...
                            *(_QWORD *)(a1 + 8))) != 0LL) )
    {
      ...
      qword_140169188 = v11.QuadPart;
      v16 = *(LARGE_INTEGER **)(a1 + 608);
      v56 = v15;
      v16[3] = v11;
      memmove(v5, *(const void **)(*(_QWORD *)(a1 + 608) + 8LL), (unsigned int)Size);
      for ( i = 1; i < dword_140168DB0; ++i )
      {
        v18 = (unsigned int)dword_140169178 * i;
        if ( (_DWORD)v4 )
        {
          v19 = v5 + 1;
          v20 = v4;
      ...
      memmove(*(void **)(*(_QWORD *)(a1 + 608) + 32LL), v5, (unsigned int)dword_140169178);
      if ( v21 )
      {
        v99 = v2;
        if ( (_WORD)qword_1401690E0 != (_WORD)v2 && WORD1(qword_1401690E0) != (_WORD)v2 )
        {
          v28 = v2;
          if ( (_DWORD)v4 )
          {
            ...
            do
            {
              if ( v28 >= dword_14016910C && v28 < *((_DWORD *)&xmmword_140169130 + 3) )
              {
                v30 = v28 / (unsigned __int16)qword_1401690E0;
                v31 = *(v29 - 2);
          ...
          if ( dword_140168DB0 )
          {
            ...
            do
            {
              v40 = (unsigned __int64 *)(*(_QWORD *)(*(_QWORD *)(a1 + 608) + 48LL)
                                       + (unsigned int)(dword_140169190 * v37));
              v41 = *v40;
              v42 = *v40 <= v39;
              *v40 = v2;
              if ( !v42 )
        ...
        v100 = v6;
        Dst[0] = 12;
        if ( byte_140168DB8 == 1 && dword_140168DBC == (_DWORD)v2
          || dword_140168DC0 >= (unsigned int)dword_140168488
          || dword_140168DBC == (_DWORD)v2 )
        {
          sub_1400B5E8C(a1);
        }
        else
        ...
        {
          v48 = *(_QWORD *)(a1 + 16);
          v49 = (const char *)&dword_140149108;
          if ( *(_QWORD *)(v48 + 752) )
            v49 = *(const char **)(v48 + 752);
          v50 = *(_QWORD *)(a1 + 608);
          sub_1400AAE08(
            v50,
            *(unsigned __int16 *)(a1 + 416),
            a1 + 160,
      ...
      if ( dword_140168DB4 != (_DWORD)v2 && (*(_DWORD *)(a1 + 112) & 0x100LL) != 0 )
        sub_1400B6558(a1);
      v7 = v2;
    }
    else
