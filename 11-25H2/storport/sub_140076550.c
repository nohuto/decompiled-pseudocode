/*
 * XREFs of sub_140076550 @ 0x140076550
 * Callers:
...
NTSTATUS sub_140076550(__int64 a1, _DWORD a2, _DWORD a3, __int64 a4, char a5, char a6, char a7, ...)
{
  ...
  v21 = 4LL;
  v23 = 4LL;
  return sub_1400031E4(a1, &stru_14014A630, 0LL, 8u, &v9);
}
