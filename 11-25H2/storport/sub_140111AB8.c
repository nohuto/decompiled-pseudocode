/*
 * XREFs of sub_140111AB8 @ 0x140111AB8
 * Callers:
...
__int64 __fastcall sub_140111AB8(__int64 a1, __int64 a2, __int64 a3)
{
  bool v3; // zf
  int v5; // ebx
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v5 = *v8;
        sub_140056AB0(v6, v7, &v32, a3, v5, *(_DWORD *)(a3 + 48));
      }
      goto LABEL_69;
    }
    ...
    v28 = *(_DWORD *)(a3 + 48);
LABEL_68:
    sub_140052F3C(v6, v9, &v32, a3, v28);
    goto LABEL_69;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_69;
...
LABEL_64:
      ...
      sub_140052E64(v6, v10, &v32, a3, *(_DWORD *)(a3 + 48), v23, v11, v14, v5, v26, a3);
    }
  }
LABEL_69:
