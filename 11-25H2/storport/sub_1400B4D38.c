/*
 * XREFs of sub_1400B4D38 @ 0x1400B4D38
 * Callers:
...
void __fastcall sub_1400B4D38(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
  ...
  if ( (*(_BYTE *)(a1 + 506) & 2) != 0 && (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x400000000000LL) )
    {
      ...
      v28 = 4LL;
      v30 = 4LL;
      sub_140037A5C(v4, (unsigned __int8 *)dword_14015691F, v2, v3, 0xBu, &v12);
    }
  }
}
