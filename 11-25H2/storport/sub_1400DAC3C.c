/*
 * XREFs of sub_1400DAC3C @ 0x1400DAC3C
 * Callers:
...
__int64 __fastcall sub_1400DAC3C(__int64 a1)
{
  void *Data; // rbx
  unsigned int v2; // edi
  ...
  *(_DWORD *)(a1 + 1008) = 0;
  ...
  if ( (v5 & 0x800) != 0 )
  {
    ...
    if ( (v5 & 0x200) == 0 || !*(_QWORD *)(*(_QWORD *)v6 + 136LL) )
      *(_QWORD *)(*(_QWORD *)v6 + 136LL) = sub_1400143E0(64LL, ActiveGroupCount << 6, 1917083986LL, *(_QWORD *)(a1 + 8));
