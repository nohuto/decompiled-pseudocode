/*
 * XREFs of sub_14006E15C @ 0x14006E15C
 * Callers:
...
__int64 __fastcall sub_14006E15C(_OWORD *a1)
{
  NTSTATUS v2; // ebx
  __int64 v3; // rcx
  ...
  *a1 = 0LL;
  ...
  ValueName_8 = 0LL;
  v10 = 0LL;
  v3 = *(_QWORD *)&Data.Data1;
  if ( !*(_QWORD *)&Data.Data1 )
    v3 = *(_QWORD *)Data.Data4 - *((_QWORD *)&v10 + 1);
  if ( v3 )
    goto LABEL_15;
  if ( byte_140168820 )
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( v2 < 0 )
    {
      v2 = ExUuidCreate(&Data);
      if ( v2 >= 0 )
        v2 = ZwSetValueKey(KeyHandle, &ValueName_8, 0, 3u, &Data, 0x10u);
    }
