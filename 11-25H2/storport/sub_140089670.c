/*
 * XREFs of sub_140089670 @ 0x140089670
 * Callers:
...
__int64 __fastcall sub_140089670(__int64 a1, __int64 a2, __int64 *a3, _DWORD *a4)
{
  __int64 v4; // rsi
  unsigned int v5; // edi
  __int64 v6; // r14
...
LABEL_16:
  ...
  v13 = sub_1400143E0(64LL, (unsigned int)v9, 1918067026LL, a1);
  v8 = v13;
  if ( v13 )
  {
    *(_DWORD *)v13 = 28;
