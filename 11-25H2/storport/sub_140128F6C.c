/*
 * XREFs of sub_140128F6C @ 0x140128F6C
 * Callers:
  ...
  *(_BYTE *)(a2 + 141) = -84;
  if ( !v2 )
  {
    ...
    if ( *(_BYTE *)v8 != 15 )
    {
      ...
      if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
      {
        if ( (byte_1401694F2 & 0x40) != 0 )
        {
          ...
          if ( v9 )
            ...
            v10 = 0LL;
          sub_140056AB0(v10, v8, &v50, a2, v10, *(_DWORD *)(a2 + 48));
        }
        goto LABEL_73;
      }
      ...
      v11 = &stru_140149FE8;
LABEL_72:
      sub_140052F3C(v7, v11, &v50, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_73;
    }
    if ( byte_1401694F1 >= 0 )
      goto LABEL_73;
...
LABEL_68:
          ...
          sub_140052E64(v36, v12, &v50, a2, *(_DWORD *)(a2 + 48), v29, v27, v17, v35, v36, a2);
        }
      }
    }
  }
  ...
  if ( v46 >= 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 400) + 184LL) & 0x40000000) != 0 )
    {
      ...
      if ( !_InterlockedCompareExchange(
              (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v42 + 1272) + 40LL) + 192LL),
              1,
              0) )
        KeSetCoalescableTimer(
          (PKTIMER)(*(_QWORD *)(*(_QWORD *)(v42 + 1272) + 40LL) + 128LL),
          (LARGE_INTEGER)-50000000LL,
          0x7D0u,
          0x12Cu,
          (PKDPC)(*(_QWORD *)(*(_QWORD *)(v42 + 1272) + 40LL) + 64LL));
    }
