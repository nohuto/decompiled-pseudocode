/*
 * XREFs of sub_14005C38C @ 0x14005C38C
 * Callers:
...
__int64 __fastcall sub_14005C38C(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rdx
  unsigned int v6; // eax
  ...
  v5 = *(_QWORD *)(a4 + 24);
  v6 = *(_DWORD *)(a1 + 4752) & 0xFFFFC000;
  ProcessHandle = 0LL;
  BaseAddress = 0LL;
  SectionOffset.LowPart = v6 + 4096;
  v7 = v5 + 4;
  SectionOffset.HighPart = *(_DWORD *)(a1 + 4756);
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v14 < 0 )
  {
      ...
      && BYTE1(off_140168120->Timer) >= 2u )
    {
      v16 = 32;
LABEL_11:
      sub_140055BD4((__int64)v15->AttachedDevice, v16, (__int64)&unk_14014A2D8, v14);
      goto LABEL_31;
    }
    goto LABEL_31;
  }
