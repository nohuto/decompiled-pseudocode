/*
 * XREFs of sub_140134094 @ 0x140134094
 * Callers:
 ...
 *     sub_1401A99A0 @ 0x1401A99A0 (sub_1401A99A0.c)
 */

__int64 __fastcall sub_140134094(__int64 a1, IRP *a2, char a3, unsigned int a4, unsigned int a5, unsigned int *a6)
{
  int v10; // ebx
  __int64 v11; // r8
  int v12; // r8d
  ...
  v10 = sub_140133FE4(a6, a2);
  if ( v10 >= 0 )
  {
    LOBYTE(v11) = a3;
    v10 = sub_1401A99A0(a6, a2, v11);
    if ( v10 >= 0 )
    {
      v17 = 0LL;
      v18[0] = 0LL;
      ...
      LOBYTE(v12) = a3;
      sub_1401A9954((_DWORD)a6, (_DWORD)a2, v12, (unsigned int)&v17, (__int64)v18);
