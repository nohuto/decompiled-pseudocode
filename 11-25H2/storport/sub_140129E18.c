/*
 * XREFs of sub_140129E18 @ 0x140129E18
 * Callers:
...
__int64 __fastcall sub_140129E18(__int64 a1, __int64 a2)
{
  int v4; // eax
  int v5; // ebx
  unsigned int v6; // ebp
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v10 )
          v5 = *v10;
        sub_140056AB0(v8, v9, &v37, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_68;
    }
    ...
    v11 = &stru_140149FE8;
LABEL_67:
    sub_140052F3C(v8, v11, &v37, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_68;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_68;
...
LABEL_63:
      ...
      sub_140052E64(v8, v12, &v37, a2, *(_DWORD *)(a2 + 48), v25, v13, v16, v5, v28, a2);
    }
  }
LABEL_68:
