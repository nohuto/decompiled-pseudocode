/*
 * XREFs of sub_140050330 @ 0x140050330
 * Callers:
 ...
 *     sub_140027EB0 @ 0x140027EB0 (sub_140027EB0.c)
 ...
 *     sub_1400A3B84 @ 0x1400A3B84 (sub_1400A3B84.c)
 */

__int64 __fastcall sub_140050330(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  _DWORD *v5; // r15
  __int64 v6; // rsi
...
LABEL_33:
              ...
              if ( v31 == 315412 || v31 == 315464 )
                ...
                LOBYTE(v28) = 0;
              v8 = *(_QWORD *)(v27 + 16);
              result = sub_1400A3B84(&v59, *(unsigned int *)(v27 + 8), v8, v28);
              if ( (int)result < 0 )
                return result;
              v7 = v59;
            }
...
LABEL_41:
  ...
  else
  {
    ...
    *(_BYTE *)(v10 + 7) = *(_BYTE *)(a1 + 106);
    ...
    if ( *(_BYTE *)v38 == 1 )
    {
      ...
      result = sub_140029E90(v39, v10, *(_DWORD *)(v6 + 744), a4, a3, (*(_DWORD *)(*(_QWORD *)v40 + 184LL) & 0x80) != 0);
      if ( (int)result < 0 )
      {
        *(_BYTE *)(v10 + 3) = 48;
  ...
  *(_QWORD *)(v6 + 184) = v61;
  ...
  if ( (unsigned int)sub_140026370(*v33, a2) == -1073741670 )
  {
    if ( *(_BYTE *)(v10 + 2) == 40 )
    {
      if ( !v58 )
...
LABEL_90:
  ...
  if ( v63 > v51 )
    v51 = v63;
  sub_140027EB0(v6, *(_QWORD *)(v44 + 24), v51);
  sub_14004DE10(a1, a2);
  if ( (unsigned int)sub_1400567A0(v53, v52) && byte_140168DAA )
  {
