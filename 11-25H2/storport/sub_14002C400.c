...
void __fastcall sub_14002C400(struct _KDPC *Dpc, _QWORD *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  __int64 v4; // rdi
    ...
    do
    {
      ...
      if ( v10 )
      {
        ...
        *(_QWORD *)(v4 + 304) = *v10;
        if ( (*((_BYTE *)v10 - 15) & 1) != 0 )
        {
          sub_14001F93C(v4, *((unsigned int *)v17 + 187));
          *((_BYTE *)v17 + 17) &= ~1u;
        }
      ...
      else
      {
        ...
        if ( !v11 )
          break;
        *(_QWORD *)(v4 + 312) = *v11;
        sub_140010CA0((PIRP)(v11 - 16), *(_DWORD *)(v11[7] + 24LL));
      }
      ++v7;
    }
    while ( v7 < dword_140168440 );
  }
...
LABEL_32:
  ...
  if ( v7 > *(_DWORD *)(v4 + 4708) )
    *(_DWORD *)(v4 + 4708) = v7;
  if ( byte_140168DAA && (byte_1401694F3 & 4) != 0 && v7 >= 0x19 )
  {
