/*
 * XREFs of sub_1400F8C88 @ 0x1400F8C88
 * Callers:
...
__int64 __fastcall sub_1400F8C88(__int64 a1, __int64 a2)
{
  int v2; // ebx
  unsigned int v4; // esi
  __int64 v5; // rdx
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v11 )
          v2 = *v11;
        sub_140056AB0(v9, v10, &v36, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_77;
    }
    ...
    v32 = *(_DWORD *)(a2 + 48);
LABEL_76:
    sub_140052F3C(v9, v12, &v36, a2, v32);
    goto LABEL_77;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_77;
...
LABEL_72:
      ...
      sub_140052E64(v9, v13, &v36, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v13 + 3), v14, v17, v2, v30, a2);
    }
  }
LABEL_77:
