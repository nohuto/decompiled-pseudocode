/*
 * XREFs of sub_14019E86C @ 0x14019E86C
 * Callers:
...
NTSTATUS __fastcall sub_14019E86C(__int64 a1, __int64 a2)
{
  int v3; // ebx
  _DWORD *v4; // rdx
  __int64 v6; // rax
...
LABEL_38:
    ...
    if ( v10[1] == 7 && !*((_DWORD *)v10 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v27 )
          v3 = *v27;
        sub_140056AB0(v9, (__int64)v10, &v42, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_96;
    }
    ...
    v36 = *(_DWORD *)(a2 + 48);
LABEL_95:
    sub_140052F3C(v9, v25, &v42, a2, v36);
    goto LABEL_96;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_96;
...
LABEL_90:
      ...
      sub_140052E64(v9, v12, &v42, a2, *(_DWORD *)(a2 + 48), v32, v13, v16, v3, v35, a2);
    }
  }
LABEL_96:
