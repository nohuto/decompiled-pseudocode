/*
 * XREFs of sub_1400C27F8 @ 0x1400C27F8
 * Callers:
...
__int16 __fastcall sub_1400C27F8(__int64 a1, char a2, char a3, __int64 a4, unsigned __int16 a5, char a6)
{
  __int128 v8; // xmm0
  __int64 v9; // rcx
  int v10; // eax
  ...
  if ( byte_140168DAA )
  {
    ...
    v30 = 0;
    v31 = 0LL;
    LOWORD(v10) = sub_1400403EC(v9, (__int64)&v27);
    v11 = *(__int16 **)(a1 + 6000);
    if ( v11 )
    {
      v34 = *(_OWORD *)(v11 + 12);
