/*
 * XREFs of sub_1400614E8 @ 0x1400614E8
 * Callers:
...
__int64 __fastcall sub_1400614E8(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // ebx
  __int64 v4; // rbp
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
    ...
    && RtlNumberOfSetBitsUlongPtr(v7) == 1 )
  {
    ...
    {
      v8 = sub_14008E20C(*(_QWORD *)(a1 + 8), v4);
      if ( v8 == -1073741637 )
        v8 = sub_14008E30C(*(_QWORD *)(a1 + 8), v4);
      if ( v8 >= 0 )
      {
        v9 = *(_DWORD *)(v4 + 8);
        if ( *(_BYTE *)(v4 + 12) )
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v3 = *v14;
        sub_140056AB0(v12, v13, &v37, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_84;
    }
    ...
    v15 = &stru_140149FE8;
LABEL_83:
    sub_140052F3C(v12, v15, &v37, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_84;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_84;
...
LABEL_79:
      ...
      sub_140052E64(v12, v16, &v37, a2, *(_DWORD *)(a2 + 48), v28, v17, v20, v3, v31, a2);
    }
  }
LABEL_84:
