/*
 * XREFs of sub_14008DCF4 @ 0x14008DCF4
 * Callers:
...
NTSTATUS __fastcall sub_14008DCF4(PDEVICE_OBJECT DeviceObject, LARGE_INTEGER a2)
{
  PIRP v4; // rax
  ...
  CurrentStackLocation[-1].Parameters.WMI.ProviderId = (ULONG_PTR)&unk_14014C4E8;
