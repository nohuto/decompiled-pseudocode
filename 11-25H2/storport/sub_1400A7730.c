/*
 * XREFs of sub_1400A7730 @ 0x1400A7730
 * Callers:
...
NTSTATUS __fastcall sub_1400A7730(__int64 a1, char a2, char a3)
{
  ...
  if ( a2 )
  {
    if ( (byte_1401694F3 & 2) != 0 )
      return sub_1400A6C20(
               v11,
               &stru_14014B1B8,
               &v18,
