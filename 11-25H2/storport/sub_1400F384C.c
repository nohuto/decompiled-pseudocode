/*
 * XREFs of sub_1400F384C @ 0x1400F384C
 * Callers:
...
__int64 __fastcall sub_1400F384C(__int64 a1, unsigned __int16 a2, UCHAR *a3)
{
  ULONG v4; // esi
  __int64 v6; // rdx
  int v7; // ebx
...
LABEL_13:
      sub_1400A870C(
        *(_QWORD *)(a1 + 88),
        1,
        2,
        (__int64)L"Computing controller augmented challenge failed",
        L"Status",
        v7,
        L"DHgID",
  ...
  if ( *(_DWORD *)v12 != v4 )
    goto LABEL_12;
  v7 = sub_1400863B4(v8, v4, (PUCHAR)(*(_QWORD *)(a1 + 96) + 1064LL), *(ULONG *)v12, (__int64)Dst, (ULONG *)v13, a3);
  if ( v7 < 0 )
    goto LABEL_13;
  if ( *(_DWORD *)v13 != v4 )
  {
