/*
 * XREFs of StorPortGetPhysicalAddress @ 0x140017460
 * Callers:
 *     sub_1401B72B0 @ 0x1401B72B0 (sub_1401B72B0.c)
 * Callees:
...
LABEL_73:
    ...
    else if ( (v57 && (*((_BYTE *)v57 + 4371) & 4) != 0 || v58) && !(unsigned __int8)sub_1400179D0(v13) )
    {
  ...
  {
    v40 = (_DWORD)a3 - v12;
    if ( (unsigned __int8)sub_1400179D0(v13) )
