/*
 * XREFs of sub_14017F1A8 @ 0x14017F1A8
 * Callers:
...
NTSTATUS __fastcall sub_14017F1A8(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  int v3; // ebx
  char *v6; // r15
  ...
  if ( v8 )
  {
    ...
    else
    {
      ...
      v12 = sub_1400893AC(*(_QWORD *)(a1 + 8), a2, v7, &P, &v46);
      v6 = (char *)P;
      v9 = v12;
      if ( v12 >= 0 )
      {
        v9 = sub_1400153FC(a1, a2, (__int64)P, v46, 0LL, 0, 128);
        if ( v9 < 0 )
        {
          v16 = 0LL;
        }
  ...
  if ( *(_BYTE *)v20 != 15 )
  {
    ...
    if ( *(_BYTE *)(v20 + 1) == 7 && !*(_DWORD *)(v20 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v40) = v3;
        sub_140056AB0(v19, v20, &v48, a2, v40, v41);
      }
      goto LABEL_104;
    }
...
LABEL_103:
    ...
    sub_140052F3C(v19, v22, &v48, a2, v40);
    goto LABEL_104;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_104;
...
LABEL_99:
      ...
      LOBYTE(v41) = v36;
      LODWORD(v40) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v19, v23, &v48, a2, v40, v41, v42, v27, v3, v39, a2);
    }
  }
LABEL_104:
