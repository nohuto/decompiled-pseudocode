/*
 * XREFs of sub_1400EB6AC @ 0x1400EB6AC
 * Callers:
 *     sub_1400ED47C @ 0x1400ED47C (sub_1400ED47C.c)
 * Callees:
 *     sub_1400143E0 @ 0x1400143E0 (sub_1400143E0.c)
 *     sub_1400EC308 @ 0x1400EC308 (sub_1400EC308.c)
 */

__int64 __fastcall sub_1400EB6AC(__int64 a1)
{
  unsigned int v1; // edi
  __int64 v2; // rax
  __int64 v4; // rbx
  ...
  {
    v6 = 0;
    if ( (int)sub_1400EC308(a1, 0LL, v13) < 0 )
      goto LABEL_15;
    do
    {
      if ( v6 )
    ...
    while ( (int)sub_1400EC308(a1, v6, v13) >= 0 );
    if ( !v6 )
    {
LABEL_15:
      v6 = 1;
  ...
  *(_DWORD *)(a1 + 908) = v6;
  ...
  v8 = sub_1400143E0(72LL, 32LL * *(unsigned int *)(a1 + 908), 1414095186LL, *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL));
  *(_QWORD *)(a1 + 912) = v8;
  if ( v8 )
  {
    for ( i = 0;
