/*
 * XREFs of sub_140030CD0 @ 0x140030CD0
 * Callers:
 ...
 *     sub_1400A7BC4 @ 0x1400A7BC4 (sub_1400A7BC4.c)
 *     sub_1400A7E20 @ 0x1400A7E20 (sub_1400A7E20.c)
 */

__int64 __fastcall sub_140030CD0(__int64 a1, _DWORD *a2, KSPIN_LOCK **a3, _QWORD *a4)
{
  unsigned int v4; // edi
  unsigned int v6; // ecx
  char v7; // r14
...
LABEL_49:
        ...
        if ( v42 )
        {
          ...
          {
            *(_BYTE *)(v41 + 17) |= 4u;
            if ( (int)sub_14009DD50(v42, *(_QWORD *)&v46[4]) < 0 )
            {
              v27 = v41;
              *(_BYTE *)(v41 + 17) &= ~4u;
              ...
              sub_140026E80(*(_QWORD *)(v42 + 24), v41, 1);
              v15 = *(_DWORD *)v46;
              v4 = 0;
              v10 = 0;
              goto LABEL_52;
