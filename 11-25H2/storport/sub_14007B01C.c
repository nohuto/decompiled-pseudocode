/*
 * XREFs of sub_14007B01C @ 0x14007B01C
 * Callers:
...
__int64 __fastcall sub_14007B01C(_QWORD *a1, int a2, int a3, unsigned __int64 a4, unsigned int a5, int a6, _QWORD *a7)
{
  _QWORD *v7; // r15
  char v8; // di
  __int64 v9; // r14
  ...
  *a7 = 0LL;
  ...
  for ( i = 0; i < v14; ++i )
  {
    sub_14007AE74(v13, i, &a6, &v21, &v18, &v19);
    if ( a6 == v12 && v21 == a3 )
    {
      v16 = *(_QWORD *)(v18 + 4);
