/*
 * XREFs of sub_1400CAA98 @ 0x1400CAA98
 * Callers:
...
__int64 __fastcall sub_1400CAA98(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r13
  unsigned int v3; // ebp
  __int64 v4; // rcx
  ...
  v10 = (_DWORD *)sub_1400143E0(64LL, 8 * v7 + 16, 1380213074LL, *(_QWORD *)(v2 + 8));
  if ( v10 )
  {
    if ( v7 )
    {
