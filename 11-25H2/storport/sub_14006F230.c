/*
 * XREFs of sub_14006F230 @ 0x14006F230
 * Callers:
...
__int64 __fastcall sub_14006F230(unsigned int *ValueData)
{
  NTSTATUS v2; // ebx
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    sub_1400710E8(ValueName, 16LL, L"%d", ValueData[1]);
    v2 = RtlWriteRegistryValue(0x40000000u, (PCWSTR)KeyHandle, ValueName, 3u, ValueData, 0x214u);
  }
  if ( KeyHandle )
    ZwClose(KeyHandle);
