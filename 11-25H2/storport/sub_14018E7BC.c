/*
 * XREFs of sub_14018E7BC @ 0x14018E7BC
 * Callers:
...
__int64 __fastcall sub_14018E7BC(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // edi
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v11 )
          v3 = *v11;
        sub_140056AB0(v9, v10, &v36, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_70;
    }
    ...
    v31 = *(_DWORD *)(a2 + 48);
LABEL_69:
    sub_140052F3C(v9, v12, &v36, a2, v31);
    goto LABEL_70;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_70;
...
LABEL_65:
      ...
      sub_140052E64(v9, v13, &v36, a2, *(_DWORD *)(a2 + 48), v26, v14, v17, v3, v29, a2);
    }
  }
LABEL_70:
