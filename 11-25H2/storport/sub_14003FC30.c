/*
 * XREFs of sub_14003FC30 @ 0x14003FC30
 * Callers:
...
__int64 __fastcall sub_14003FC30(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebx
  bool v4; // zf
  __int64 v5; // rcx
  ...
  *(_BYTE *)(a2 + 141) = -84;
  ...
  if ( *(_BYTE *)v6 != 15 )
  {
    ...
    if ( *(_BYTE *)(v6 + 1) == 7 && !*(_DWORD *)(v6 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v7 )
          ...
          v8 = 0;
        sub_140056AB0(v8, v6, (unsigned int)&v37, a2, v8, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_70;
    }
    ...
    v9 = &unk_140149FE8;
LABEL_69:
    sub_140052F3C(v5, v9, &v37, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_70;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_70;
...
LABEL_65:
      ...
      sub_140052E64(v28, v10, (unsigned int)&v37, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v27, v28, a2);
    }
  }
LABEL_70:
