/*
 * XREFs of sub_1400CADC8 @ 0x1400CADC8
 * Callers:
...
__int64 __fastcall sub_1400CADC8(__int64 a1, _QWORD *a2)
{
  unsigned int v3; // edi
  KSPIN_LOCK **v4; // r15
  KSPIN_LOCK *v5; // rbx
...
LABEL_2:
  ...
  v7 = (_DWORD *)sub_1400143E0(64LL, 8LL * v6 + 8, 1380213074LL, *(_QWORD *)(a1 + 8));
  if ( v7 )
  {
    v8 = *v4;
    v9 = 0;
