/*
 * XREFs of ?get_DynamicTerminalClasses@CMSPAddress@@UEAAJPEAUtagVARIANT@@@Z @ 0x140011CCC
 * Callers:
...
__int64 __fastcall CMSPAddress::get_DynamicTerminalClasses(CMSPAddress *this, struct tagVARIANT *a2)
{
  ...
  char Dst[32]; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_7:
    ...
    if ( (unsigned int)v10 >= v14 )
    {
      ...
      if ( v10 < HIDWORD(v16.m128i_i64[0]) + (unsigned __int64)v19 + 8 )
        goto LABEL_7;
      v21 = sub_1400123F8(*((_QWORD *)this + 1), a2, &v59, &v58);
      v7 = v59;
      v11 = v21;
      if ( v21 >= 0 )
      {
        v11 = sub_1400153FC(v68, (_DWORD)a2, (_DWORD)v59, v58, 0LL, 0, 64);
        if ( v11 >= 0 )
        {
  ...
  if ( *(_BYTE *)v34 != 15 )
  {
    ...
    if ( *(_BYTE *)(v34 + 1) == 7 && !*(_DWORD *)(v34 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v35 )
          v5 = *v35;
        sub_140056AB0((_DWORD)v33, v34, (unsigned int)&v68, (_DWORD)a2, v5, *((_DWORD *)a2 + 12));
      }
      goto LABEL_108;
    }
    ...
    v36 = &unk_140149FE8;
LABEL_107:
    sub_140052F3C(v33, v36, &v68, a2, *((_DWORD *)a2 + 12));
    goto LABEL_108;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_108;
