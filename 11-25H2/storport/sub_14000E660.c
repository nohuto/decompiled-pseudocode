/*
 * XREFs of sub_14000E660 @ 0x14000E660
 * Callers:
...
char __fastcall sub_14000E660(__int64 a1, __int64 a2, char a3, _BYTE *a4, LARGE_INTEGER *a5, _DWORD *a6, _DWORD *a7)
{
...
LABEL_22:
      ...
      v18 = dword_1401684AC == 0;
    }
    else
    {
      v18 = byte_140168724 == 0;
    }
    if ( !v18 )
    {
