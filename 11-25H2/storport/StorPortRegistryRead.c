/*
 * XREFs of StorPortRegistryRead @ 0x140033E80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  v12 = *((_QWORD *)v9 + 2);
  if ( !(unsigned __int8)sub_140055CDC(v11, a5, a6) )
    return 0;
  v14 = 0;
  v15 = *a6;
  v11[13] = v13 - v11[8];
  v11[11] = v15;
  *a6 = 0;
  if ( (int)sub_140034288((PCUNICODE_STRING)(v12 + 40), &Destination) >= 0 )
  {
    DestinationString = 0LL;
    RtlInitAnsiString(&DestinationString, a2);
    if ( RtlAnsiStringToUnicodeString(&UnicodeString, &DestinationString, 1u) >= 0 )
    {
      v16 = ((__int64 (__fastcall *)(struct _UNICODE_STRING *, struct _UNICODE_STRING *, _QWORD, _DWORD *))sub_140034068)(
              &Destination,
              &UnicodeString,
              a4,
              v11);
