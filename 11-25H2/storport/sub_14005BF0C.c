/*
 * XREFs of sub_14005BF0C @ 0x14005BF0C
 * Callers:
...
__int64 __fastcall sub_14005BF0C(__int64 a1, PIRP Irp)
{
...
LABEL_14:
  ...
  MdlAddress_high = -1;
LABEL_16:
  sub_14006789C(v5, v14, v15, v16, MdlAddress_high, Length, v9, v10);
  ...
  if ( CurrentStackLocation->MajorFunction != 15 )
  {
    ...
    if ( CurrentStackLocation->MinorFunction == 7 && !CurrentStackLocation->Parameters.Read.Length )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v43) = v4;
        sub_140056AB0(v19, (__int64)CurrentStackLocation, &v54, Irp, v43, v44);
      }
      goto LABEL_85;
    }
    if ( (byte_1401694F2 & 0x20) == 0 )
      goto LABEL_85;
    v22 = (const EVENT_DESCRIPTOR *)&unk_140149FE8;
LABEL_84:
    LODWORD(v43) = Irp->IoStatus.Status;
    sub_140052F3C(v19, v22, &v54, Irp, v43);
    goto LABEL_85;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_85;
...
LABEL_80:
    ...
    LOBYTE(v44) = v38;
    LODWORD(v43) = Irp->IoStatus.Status;
    sub_140052E64(v19, ProviderId, &v54, Irp, v43, v44, SourceMdl, v46, v47, v41, Irp);
  }
LABEL_85:
