/*
 * XREFs of sub_140016930 @ 0x140016930
 * Callers:
...
void __fastcall sub_140016930(__int64 a1, __int64 a2, char a3)
{
  __int64 v5; // rdi
  __int64 v6; // r14
  __int64 v7; // rbx
      ...
      if ( a1 != -64 )
      {
        ...
        else if ( *(_DWORD *)(a1 + 136) )
        {
          do
          {
            ...
            if ( a3 )
            {
              if ( (unsigned __int8)sub_1400179D0(v6) )
              {
                LOBYTE(v15) = 1;
