/*
 * XREFs of sub_14019D9F8 @ 0x14019D9F8
 * Callers:
...
__int64 __fastcall sub_14019D9F8(_DWORD *a1, __int64 a2)
{
  int v2; // ebx
  bool v4; // zf
  ...
  char v26; // al
  char v28; // [rsp+60h] [rbp-48h]
  unsigned int v29; // [rsp+64h] [rbp-44h]
  GUID v30; // [rsp+68h] [rbp-40h] BYREF

  v2 = 0;
  if ( a1[66] || a1[67] || a1[68] )
    *(_DWORD *)(a2 + 56) |= 0x20u;
  v4 = byte_140168DAA == 0;
  *(_BYTE *)(a2 + 141) = -84;
  *(_DWORD *)(a2 + 48) = 0;
...
LABEL_64:
      ...
      sub_140052E64(v5, v9, &v30, a2, *(_DWORD *)(a2 + 48), v23, v10, v13, v2, v26, a2);
    }
  }
LABEL_69:
