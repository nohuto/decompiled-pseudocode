/*
 * XREFs of sub_1400B7E68 @ 0x1400B7E68
 * Callers:
...
void __fastcall sub_1400B7E68(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // eax
  __int64 v6; // r13
  __int64 v7; // rbx
  ...
  *((_QWORD *)&v43 + 1) = 0xAFD514C97C6F4F9CuLL;
  ...
  if ( (v4 & 8) == 0 )
  {
    v12 = (int *)sub_1400143E0(256LL, 560LL, 1700028754LL, *(_QWORD *)(a1 + 8));
    P = (unsigned int *)v12;
    if ( v12 )
    {
      v13 = sub_140051AC8(*(PDEVICE_OBJECT *)(a1 + 8), 2, 0x200u, v12, 0x230u);
      if ( v13 < 0 )
      {
        if ( v13 != -1073741670 )
        {
  ...
  v15 = (int *)sub_1400143E0(256LL, 560LL, 1700028754LL, *(_QWORD *)(a1 + 8));
  v42 = v15;
  if ( !v15 )
  {
    v17 = 0;
  ...
  v16 = sub_140051AC8(*(PDEVICE_OBJECT *)(a1 + 8), 192, 0x200u, v15, 0x230u);
  if ( v16 < 0 )
  {
    v17 = 0;
    if ( v16 != -1073741670 )
...
LABEL_30:
  if ( v6 || v7 )
  {
    if ( byte_140168DB8 == 1 && !dword_140168DBC || dword_140168DC4 >= (unsigned int)dword_140168488 )
      goto LABEL_39;
    if ( *(_BYTE *)(a1 + 5316) )
      dword_140168DBC = -1;
    if ( dword_140168DBC )
    {
      ...
      v20 = v39;
      ++dword_140168DC4;
      sub_1400B125C(a1, v6, v39, a4, v9, v7, v8, v44, v40, v35, v11);
    }
    else
    {
LABEL_39:
      ...
      v36 = v10;
      v20 = v39;
      sub_1400B14D4(a1, v6, v39, a4, v9, v7, v8, v44, v40, v36, v11);
    }
