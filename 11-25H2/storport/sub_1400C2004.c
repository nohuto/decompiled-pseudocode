/*
 * XREFs of sub_1400C2004 @ 0x1400C2004
 * Callers:
...
char __fastcall sub_1400C2004(__int64 a1, unsigned int a2, unsigned __int16 *a3)
{
  __int64 v4; // r14
  int v6; // edx
  __int64 v7; // rcx
  ...
  if ( !v12 )
  {
    v15 = (IO_WORKITEM_ROUTINE *)sub_1400C1AB0;
  ...
  if ( !v13 )
  {
    v15 = (IO_WORKITEM_ROUTINE *)sub_1400C1C80;
  ...
  if ( v14 != (_BYTE)v8 + 1 )
  {
    if ( v14 == -2 )
    {
      v15 = (IO_WORKITEM_ROUTINE *)sub_1400C1830;
      v16 = *(_QWORD *)(*(_QWORD *)(v7 + 6160) + 48LL);
      goto LABEL_11;
    }
    return 0;
  }
  v15 = (IO_WORKITEM_ROUTINE *)sub_1400C18E0;
...
LABEL_11:
  ...
  if ( v8 == (_DWORD)v4 || v9 == (_DWORD)v4 || v9 + v8 >= (unsigned int)v4 )
    return 0;
  v20 = v4;
  v21 = (_QWORD *)sub_1400143E0(64LL, 2 * v4 + 22, 1230463314LL, *(_QWORD *)(a1 + 8));
  if ( !v21 )
    goto LABEL_26;
  ...
  *v21 = WorkItem;
  if ( !WorkItem )
  {
    ExFreePoolWithTag(v21, 0x49576152u);
LABEL_26:
    if ( v16 && (_DWORD)v4 )
    {
      do
  ...
  *((_BYTE *)v21 + 16) = v11;
  ...
  v26 = (struct _IO_WORKITEM *)*v21;
  *((_WORD *)v21 + 10) = v25;
  IoQueueWorkItem(v26, v15, DelayedWorkQueue, v21);
  return 1;
}
