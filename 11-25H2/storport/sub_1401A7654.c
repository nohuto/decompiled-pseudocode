/*
 * XREFs of sub_1401A7654 @ 0x1401A7654
 * Callers:
...
__int64 __fastcall sub_1401A7654(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebx
  __int64 v4; // rdi
  ...
  v5 = (struct _ERESOURCE *)(v4 + 24);
  ExAcquireResourceExclusiveLite((PERESOURCE)(v4 + 24), 1u);
  v6 = sub_1401316E4(v4, (_QWORD *)(a2 + 40));
  v7 = v6;
  if ( v6 )
  {
    if ( (v6[4] & 1) != 0 )
    {
      sub_140055B38((__int64)v6, -1073741536);
      *((_WORD *)v7 + 16) &= ~1u;
    }
  }
  else
