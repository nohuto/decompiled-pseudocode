/*
 * XREFs of sub_140132B04 @ 0x140132B04
 * Callers:
...
__int64 __fastcall sub_140132B04(__int64 a1, __int64 a2, __int64 a3, int a4, unsigned __int16 a5, char a6)
{
...
LABEL_44:
    sub_14013333C(a1, a4, a3, v22, a6, 0LL, v8, v15);
    return v16;
  }
  v15 = -1073741436;
  if ( a6 )
  ...
  if ( byte_140168DAA )
  {
    ...
    sub_14013333C(a1, a4, v18, v22, a6, v6, v8, v14);
