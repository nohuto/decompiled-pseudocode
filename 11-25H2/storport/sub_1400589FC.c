/*
 * XREFs of sub_1400589FC @ 0x1400589FC
 * Callers:
...
__int64 __fastcall sub_1400589FC(CMSPAddress *a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rcx
  PVOID v6; // r14
...
LABEL_12:
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 0x10u )
  {
    ...
    if ( (v9 & 1) == 0 )
      *(_WORD *)(v4 + 8) = v9 | 1;
    v10 = sub_140089DC8(*((_QWORD *)a1 + 1), a2, &P, &v41);
    v6 = P;
    if ( v10 >= 0 && P )
      v8 = sub_140016234(a1, (PIRP)a2, (unsigned int *)P, v41, 0LL, 0, 128, 0);
    else
      v8 = -1073741801;
    goto LABEL_12;
  }
  ...
  if ( **v7 != 15 )
  {
    ...
    if ( v13[1] == 7 && !*((_DWORD *)v13 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v35) = v2;
        sub_140056AB0(v12, (__int64)v13, &v44, a2, v35, v36);
      }
      goto LABEL_80;
    }
    if ( (byte_1401694F2 & 0x20) == 0 )
      goto LABEL_80;
    v15 = (const EVENT_DESCRIPTOR *)&unk_140149FE8;
LABEL_79:
    LODWORD(v35) = *(_DWORD *)(a2 + 48);
    sub_140052F3C(v12, v15, &v44, a2, v35);
    goto LABEL_80;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_80;
...
LABEL_75:
      ...
      LOBYTE(v36) = v30;
      LODWORD(v35) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v12, v16, &v44, a2, v35, v36, v37, v38, v2, v33, a2);
    }
  }
LABEL_80:
