/*
 * XREFs of sub_140091C38 @ 0x140091C38
 * Callers:
...
char __fastcall sub_140091C38(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, __int64 a6, int a7, char a8)
{
  __int64 v9; // r9
  int v10; // eax
  __int64 v11; // rcx
      ...
      do
      {
        ...
        if ( (unsigned int)v25 >= 0x80 )
        {
          ...
          if ( (unsigned int)v25 < (unsigned int)v27 )
          {
            ...
            else if ( *(_DWORD *)(v25 + a3) == 66 && v25 + 40 <= v27 )
            {
              v20 = v25 + a3 + 32;
              if ( !*(_DWORD *)(v25 + a3 + 12) )
                v20 = v26;
