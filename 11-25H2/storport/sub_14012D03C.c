/*
 * XREFs of sub_14012D03C @ 0x14012D03C
 * Callers:
 *     sub_14012CFC0 @ 0x14012CFC0 (sub_14012CFC0.c)
 *     sub_14012D270 @ 0x14012D270 (sub_14012D270.c)
 * Callees:
 *     <none>
 */

void __fastcall sub_14012D03C(PVOID Context)
{
  __int64 v2; // rbp
  __int64 v3; // rdx
  __int64 v4; // rax
...
LABEL_14:
    v9 = PoRequestPowerIrp(
           *((PDEVICE_OBJECT *)Context + 1),
           2u,
           (POWER_STATE)4,
           (PREQUEST_POWER_COMPLETE)sub_14012CAD0,
           Context,
           0LL);
  ...
  if ( !CurrentIrql )
  {
    v8 = PoRequestPowerIrp(
           *((PDEVICE_OBJECT *)Context + 1),
           0,
           (POWER_STATE)1,
           (PREQUEST_POWER_COMPLETE)sub_14012CC80,
           Context,
  ...
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)(v7 + 160), 1, 0) )
    IoQueueWorkItem(*(PIO_WORKITEM *)(*((_QWORD *)Context + 16) + 144LL), sub_14012D270, DelayedWorkQueue, Context);
}
