/*
 * XREFs of sub_14008B650 @ 0x14008B650
 * Callers:
...
void __fastcall sub_14008B650(__int64 a1, char a2, __int64 a3)
{
  __int64 v4; // rsi
  __int64 v5; // r8
  int v6; // ebx
  ...
  if ( *(_BYTE *)v13 != 15 )
  {
    ...
    if ( *(_BYTE *)(v13 + 1) == 7 && !*(_DWORD *)(v13 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v6 = *v14;
        sub_140056AB0(v12, v13, &v35, a3, v6, *(_DWORD *)(a3 + 48));
      }
      goto LABEL_73;
    }
    ...
    v15 = &stru_140149FE8;
LABEL_72:
    sub_140052F3C(v12, v15, &v35, a3, *(_DWORD *)(a3 + 48));
    goto LABEL_73;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_73;
...
LABEL_66:
    if ( (_BYTE)v16 )
    {
      ...
      v32 = v22;
LABEL_69:
      sub_140052E64(v12, v16, &v35, a3, *(_DWORD *)(a3 + 48), v29, v17, v20, v6, v32, a3);
      goto LABEL_73;
    }
LABEL_68:
    v20 = 0;
