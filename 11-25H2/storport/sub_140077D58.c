/*
 * XREFs of sub_140077D58 @ 0x140077D58
 * Callers:
 *     Callback @ 0x140045BD0 (Callback.c)
 *     sub_14005CBB0 @ 0x14005CBB0 (sub_14005CBB0.c)
 *     sub_140077AD0 @ 0x140077AD0 (sub_140077AD0.c)
 * Callees:
...
__int64 __fastcall sub_140077D58(__int64 a1, unsigned __int64 *a2, char a3, unsigned int a4)
{
  _QWORD *v4; // rdi
...
LABEL_11:
  v25 = v4[(int)v23 + 6];
  v13 = sub_140077AA4((__int64)v4);
  v4[v14 + 6] = v6;
  v26 = v13;
  v33 = 1;
  v34 = 16;
  v27 = sub_140077AA4((__int64)v4);
  v35 = v27;
  v16 = sub_1400296E0(v9);
  if ( v16 >= 0 )
  {
    if ( a3 )
    {
  ...
  {
    if ( sub_14003F840(v15, 0x400000000000LL) )
    {
      v38 = 16LL;
      v37 = a1 + 5064;
      v24 = *(_DWORD *)(a1 + 56);
      ...
      v32 = v20;
      v60 = 8LL;
      sub_140037A5C(v18, (unsigned __int8 *)dword_140156068, v19, v20, 0xEu, &v36);
    }
  }
