/*
 * XREFs of sub_1400B25F4 @ 0x1400B25F4
 * Callers:
...
void __fastcall sub_1400B25F4(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x800000000000LL) )
    {
      ...
      v30 = &v14;
      v31 = 4LL;
      sub_140038378((__int64)v32, *(_BYTE **)(v2 + 752));
      sub_140038378((__int64)v33, *(_BYTE **)(*(_QWORD *)(v4 + 16) + 792LL));
      v6 = *(_QWORD *)(v5 + 16);
      v15 = *(unsigned __int16 *)(v6 + 4);
      v34 = &v15;
      v35 = 4LL;
      sub_140037B0C((__int64)v36, *(const int **)(*(_QWORD *)(v6 + 128) + 1016LL));
      v8 = *(_QWORD *)(v7 + 608);
      v10 = v9[1];
      v37 = &v20;
      v20 = *(_QWORD *)&qword_140168DC8;
      v11 = *v9;
      v38 = 8LL;
      v16 = *(_DWORD *)(v8 + 112);
      v39 = &v16;
      ...
      v55[1] = 0;
      v55[0] = 104 * v10;
      sub_140037A5C(v11, (unsigned __int8 *)dword_1401596C9, v8, v7, 0x16u, &v21);
    }
  }
}
