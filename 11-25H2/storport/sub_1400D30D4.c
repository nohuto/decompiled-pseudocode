/*
 * XREFs of sub_1400D30D4 @ 0x1400D30D4
 * Callers:
...
__int64 __fastcall sub_1400D30D4(__int64 a1, __int64 a2)
{
  int v4; // eax
  int v5; // ebx
  unsigned int v6; // ebp
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v30 = sub_14012A868(a1, a2);
    }
    else if ( *(_BYTE *)(*(_QWORD *)(a2 + 184) + 1LL) == 3 )
    {
      v30 = sub_140129960(a1, a2);
    }
    else
    {
      v30 = sub_14008A0F4(*(struct _DEVICE_OBJECT **)(a1 + 24), (IRP *)a2);
    }
    v31 = v30;
  ...
  *(_DWORD *)(a2 + 48) = v4;
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    v11 = &stru_140149FE8;
LABEL_67:
    sub_140052F3C(v8, v11, &v36, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_68;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_68;
...
LABEL_63:
      ...
      sub_140052E64(v8, v12, &v36, a2, *(_DWORD *)(a2 + 48), v25, v13, v16, v5, v28, a2);
    }
  }
LABEL_68:
