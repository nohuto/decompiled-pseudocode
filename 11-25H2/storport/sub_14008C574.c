/*
 * XREFs of sub_14008C574 @ 0x14008C574
 * Callers:
...
void __fastcall sub_14008C574(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4, _WORD *Dst)
{
  unsigned int *v5; // r15
  unsigned int v6; // edi
...
LABEL_51:
        if ( v6 < v14 )
        {
          sub_14008C4DC(a2 + 80LL * v28, (__int64)&Dst[32 * (unsigned __int64)v6 + 8]);
          v27 = a1;
          ++v6;
        }
        goto LABEL_53;
