/*
 * XREFs of sub_140041AB0 @ 0x140041AB0
 * Callers:
...
unsigned __int64 __fastcall sub_140041AB0(_QWORD *a1, char a2, unsigned __int64 a3)
{
  char v3; // r12
  __int64 v4; // rbx
...
LABEL_61:
  ...
  else if ( (byte_1401694F1 & 1) != 0 )
  {
    return sub_1400A6D60(
             LowPart,
             (unsigned int)&unk_14014B168,
             (int)a1 + 728,
             a3,
             a1[20],
             v3,
