/*
 * XREFs of sub_1400F9A20 @ 0x1400F9A20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1400DE118 @ 0x1400DE118 (sub_1400DE118.c)
...
void __fastcall sub_1400F9A20(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5, __int64 *P)
{
  int v6; // ebx
  ...
  if ( P )
  {
    if ( (unsigned __int8)*(_DWORD *)(v15 + 16) == 9 && (*(_DWORD *)(v15 + 60) & 4) != 0 )
    {
      ...
      *(_DWORD *)(a2 + 60) = *((_DWORD *)P + 4);
      a3 = *P;
      sub_1400DE118(a1, 16 * *((_DWORD *)P + 5), (void *)P[3]);
    }
  ...
  if ( *(_BYTE *)v26 != 15 )
  {
    ...
    if ( *(_BYTE *)(v26 + 1) == 7 && !*(_DWORD *)(v26 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v47) = v6;
        sub_140056AB0(v25, v26, &v56, a3, v47, v48);
      }
      goto LABEL_98;
    }
...
LABEL_97:
    ...
    sub_140052F3C(v25, v28, &v56, a3, v47);
    goto LABEL_98;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_98;
...
LABEL_94:
      ...
      LOBYTE(v48) = v42;
      LODWORD(v47) = *(_DWORD *)(a3 + 48);
      sub_140052E64(v25, v29, &v56, a3, v47, v48, v49, v50, v51, v52, a3);
      goto LABEL_98;
    }
LABEL_93:
    v33 = 0;
