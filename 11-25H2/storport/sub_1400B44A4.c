/*
 * XREFs of sub_1400B44A4 @ 0x1400B44A4
 * Callers:
...
void __fastcall sub_1400B44A4(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r10
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x400000000000LL) )
    {
      ...
      v49 = 1LL;
      v51 = 1LL;
      sub_140037B0C((__int64)v52, *(const int **)(v2 + 4720));
      sub_140038378((__int64)v53, (_BYTE *)(v3 + 168));
      sub_140038378((__int64)v54, (_BYTE *)(v4 + 177));
      sub_140038378((__int64)v55, (_BYTE *)(v5 + 242));
      v56 = &v26;
      ...
      v102 = v11;
      v103 = 512LL;
      sub_140037A5C((__int64)v11, (unsigned __int8 *)dword_140156FAC, v12, v8, 0x24u, &v39);
    }
  }
}
