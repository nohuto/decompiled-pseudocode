/*
 * XREFs of sub_140039660 @ 0x140039660
 * Callers:
...
__int64 __fastcall sub_140039660(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebp
  int v5; // ebx
  bool v6; // zf
  ...
  *(_DWORD *)(a2 + 48) = v2;
  ...
  if ( *(_BYTE *)v8 == 14 )
  {
    if ( (byte_1401694F2 & 8) != 0 )
      sub_140052F3C(v7, &unk_140148B18, &v32, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_7;
  }
  if ( *(_BYTE *)v8 != 15 )
  {
    if ( *(_BYTE *)v8 == 27 )
    {
      ...
      {
        sub_140052F3C(v7, &unk_140149FE8, &v32, a2, *(_DWORD *)(a2 + 48));
      }
    }
    goto LABEL_7;
  }
...
LABEL_30:
      ...
      sub_140052E64((_DWORD)v7, v11, (unsigned int)&v32, a2, *(_DWORD *)(a2 + 48), v27, v18, v13, v5, v17, a2);
    }
  }
LABEL_7:
