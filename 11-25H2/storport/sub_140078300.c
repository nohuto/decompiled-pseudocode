/*
 * XREFs of sub_140078300 @ 0x140078300
 * Callers:
...
__int64 __fastcall sub_140078300(PDEVICE_OBJECT DeviceObject, LARGE_INTEGER a2)
{
  ...
  if ( v5 )
  {
    ...
    CurrentStackLocation[-1].Parameters.WMI.ProviderId = (ULONG_PTR)&unk_14014C4B8;
