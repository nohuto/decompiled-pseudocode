/*
 * XREFs of sub_140019D84 @ 0x140019D84
 * Callers:
...
__int64 __fastcall sub_140019D84(PVOID Context, PIRP Irp)
{
  int v2; // edi
  ULONG v5; // eax
  __int64 v6; // rax
  ...
  {
    v5 = IoSizeofWorkItem();
    v6 = sub_1400143E0(64LL, v5 + 24LL, 1230463314LL, *((_QWORD *)Context + 1));
    v7 = (_QWORD *)v6;
    if ( v6 )
    {
      v8 = v6 + 24;
      IoInitializeWorkItem(*((PVOID *)Context + 1), (PIO_WORKITEM)(v6 + 24));
      *v7 = v8;
      v7[1] = Irp;
      v7[2] = Context;
      v9 = 259;
      ...
      *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
      ...
      v11[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)&sub_140065E60;
      v11[-1].Context = v7;
      v11[-1].Control = -32;
  ...
  v9 = sub_140018DDC(*((struct _DEVICE_OBJECT **)Context + 3), Irp);
  if ( v9 >= 0 )
  {
    v9 = sub_140061988(Context);
    if ( v9 >= 0 )
      goto LABEL_8;
  }
  else
  ...
  sub_14008FBAC(Context, (unsigned int)v9);
LABEL_8:
  ...
  if ( v14->MajorFunction != 15 )
  {
    ...
    if ( v14->MinorFunction == 7 && !v14->Parameters.Read.Length )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( Information )
          v2 = *Information;
        sub_140056AB0((_DWORD)v13, (_DWORD)v14, (unsigned int)&v42, (_DWORD)Irp, v2, Irp->IoStatus.Status);
      }
      goto LABEL_77;
    }
    ...
    v16 = &unk_140149FE8;
LABEL_76:
    sub_140052F3C(v13, v16, &v42, Irp, Irp->IoStatus.Status);
    goto LABEL_77;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_77;
