/*
 * XREFs of sub_14010E334 @ 0x14010E334
 * Callers:
...
__int64 __fastcall sub_14010E334(__int64 a1, __int64 a2)
{
  __int64 v2; // r13
  int v3; // ebx
  __int64 v4; // r14
...
LABEL_32:
        ...
        sub_1400A9114(a1, 1, 4, (__int64)v8, Buffer, 0, (void *)&dword_140149108, 0);
        goto LABEL_36;
      }
      v10 = *(_DWORD *)(v4 + 20);
...
LABEL_95:
      ...
      LODWORD(v45) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v22, v26, &v53, a2, v45, v46, v47, v48, v3, v43, a2);
    }
  }
LABEL_100:
