/*
 * XREFs of sub_14018F080 @ 0x14018F080
 * Callers:
...
__int64 __fastcall sub_14018F080(__int64 a1, IRP *a2)
{
      ...
      else
      {
        ...
        if ( *(_QWORD *)v10 != v10 )
        {
          do
          {
            ...
            if ( (int)sub_1400D1328((__int64)(v12 - 3)) >= 0 )
            {
  ...
  if ( *(_BYTE *)v21 != 15 )
  {
    ...
    if ( *(_BYTE *)(v21 + 1) == 7 && !*(_DWORD *)(v21 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( Information )
          v3 = *Information;
        sub_140056AB0(v20, v21, &v48, v4, v3, v4->IoStatus.Status);
      }
      goto LABEL_83;
    }
    ...
    Status = v4->IoStatus.Status;
LABEL_82:
    sub_140052F3C(v20, v23, &v48, v4, Status);
    goto LABEL_83;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_83;
...
LABEL_78:
      ...
      sub_140052E64(v20, v24, &v48, v4, v4->IoStatus.Status, *(_BYTE *)(v24 + 3), v26, v29, v3, v41, v4);
    }
  }
LABEL_83:
