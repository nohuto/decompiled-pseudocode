/*
 * XREFs of sub_1401AAF00 @ 0x1401AAF00
 * Callers:
...
__int64 __fastcall sub_1401AAF00(__int64 a1, __int64 a2)
{
  int v3; // ebx
  __int64 v4; // rdx
  unsigned int v5; // ebp
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v11 )
          v3 = *v11;
        sub_140056AB0(v7, v8, &v34, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_7;
    }
...
LABEL_69:
      ...
      sub_140052E64(v7, v12, &v34, a2, *(_DWORD *)(a2 + 48), v25, v13, v16, v3, v28, a2);
    }
  }
LABEL_7:
