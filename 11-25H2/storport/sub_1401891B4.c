/*
 * XREFs of sub_1401891B4 @ 0x1401891B4
 * Callers:
...
__int64 __fastcall sub_1401891B4(__int64 *a1, __int64 a2, _QWORD *a3)
{
  __int64 v6; // rsi
  _DWORD *v7; // r14
...
LABEL_61:
  ...
  if ( !*(_QWORD *)(v10 + 112) )
  {
    *(_QWORD *)(a1[770] + 112) = sub_1400143E0(64LL, 28LL, 1179476306LL, a1[1]);
    v10 = a1[770];
    if ( !*(_QWORD *)(v10 + 112) )
      goto LABEL_18;
  }
  ...
  {
    v11 = (_DWORD *)sub_1400143E0(64LL, 64LL, 1179476306LL, a1[1]);
    v7 = v11;
    if ( !v11 )
      goto LABEL_18;
    LODWORD(Dst[0]) = Dst[0] & 0xFFFFFF00 | 0xA;
    v38 = v38 & 0xFFFFFF00 | 0xD3;
    LODWORD(v40) = sub_140187D84((__int64)a1, v11, 0LL, 0x40u, Dst, v36, 1u, 0, 0, 0LL, &v41);
    if ( (int)v40 < 0 )
      goto LABEL_54;
  ...
  v39 = 1;
  LODWORD(v40) = sub_1400C4F10((__int64)a1);
  if ( (int)v40 < 0 )
    goto LABEL_54;
  v33 = (_BYTE *)sub_1400143E0(64LL, 64LL, 1179476306LL, a1[1]);
  v7 = v33;
  if ( !v33 )
  {
LABEL_18:
  ...
  *((_DWORD *)v33 + 8) = v25;
  ...
  v38 = v38 & 0xFFFFFF00 | 0xD3;
  LODWORD(v40) = sub_140187D84((__int64)a1, v33, 0LL, 0x40u, Dst, v36, 2u, 0, 0, 0LL, &v41);
  if ( (int)v40 >= 0 )
  {
...
LABEL_62:
  ...
  sub_1400C4B80((__int64)a1, v6, v8, v34);
  return v34;
}
