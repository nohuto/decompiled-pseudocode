/*
 * XREFs of sub_14019BA40 @ 0x14019BA40
 * Callers:
...
__int64 __fastcall sub_14019BA40(__int64 a1, __int64 a2)
{
  __int64 v2; // r8
  int v3; // ebx
  int *v4; // r14
  ...
  if ( *(_BYTE *)v30 != 15 )
  {
    ...
    if ( *(_BYTE *)(v30 + 1) == 7 && !*(_DWORD *)(v30 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v31 )
          v3 = *v31;
        sub_140056AB0(v29, v30, (const GUID *)&Src, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_112;
    }
    ...
    v51 = *(_DWORD *)(a2 + 48);
LABEL_111:
    sub_140052F3C(v29, v32, (const GUID *)&Src, a2, v51);
    goto LABEL_112;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_112;
...
LABEL_107:
      ...
      sub_140052E64(v29, v33, (const GUID *)&Src, a2, *(_DWORD *)(a2 + 48), v46, v34, v37, v3, v49, a2);
    }
  }
LABEL_112:
