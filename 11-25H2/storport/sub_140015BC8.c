/*
 * XREFs of sub_140015BC8 @ 0x140015BC8
 * Callers:
 ...
 *     sub_1401B1324 @ 0x1401B1324 (sub_1401B1324.c)
 */

__int64 __fastcall sub_140015BC8(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdi
  __int64 v4; // rax
  ...
  v6 = *(_QWORD *)(a1 + 1840);
  if ( v6 )
    sub_140016754(*(_QWORD *)(a1 + 24), v6 - 48);
  v7 = *(void **)(a1 + 3560);
  if ( v7 )
  {
  ...
  {
    sub_140070678();
    ExFreePoolWithTag(*(PVOID *)(a1 + 3568), 0x57526152u);
    *(_QWORD *)(a1 + 3568) = 0LL;
  }
  sub_140016010(a1 + 112);
  sub_1401B1324(a1);
  v10 = *(void **)(a1 + 16);
  if ( v10 )
  {
  ...
  v15 = *(_QWORD *)(a1 + 24);
  if ( v15 && *(_QWORD *)(v15 + 4960) && _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 3608), 0, 1) == 1 )
