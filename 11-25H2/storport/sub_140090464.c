/*
 * XREFs of sub_140090464 @ 0x140090464
 * Callers:
...
NTSTATUS __fastcall sub_140090464(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 1LL;
  v15 = &a7;
  return sub_1400031E4(a1, &stru_140149E10, 0LL, 5u, &v8);
}
