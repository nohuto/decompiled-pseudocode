/*
 * XREFs of sub_140081EB8 @ 0x140081EB8
 * Callers:
...
__int64 __fastcall sub_140081EB8(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  int v3; // edi
  __int64 v4; // r8
...
LABEL_23:
    *(_QWORD *)(a2 + 56) = 0LL;
    ...
    {
      v53 = *(_DWORD *)(a1 + 104);
      sub_1400403EC(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL), (__int64)&v60);
      v14 = *(_QWORD *)(a1 + 24);
  ...
  if ( *(_BYTE *)v21 != 15 )
  {
    ...
    if ( *(_BYTE *)(v21 + 1) == 7 && !*(_DWORD *)(v21 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v44) = v3;
        sub_140056AB0(v20, v21, &v61, a2, v44, v45);
      }
      goto LABEL_97;
    }
    ...
    LODWORD(v44) = *(_DWORD *)(a2 + 48);
LABEL_96:
    sub_140052F3C(v20, v23, &v61, a2, v44);
    goto LABEL_97;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_97;
...
LABEL_92:
    ...
    LODWORD(v44) = *(_DWORD *)(a2 + 48);
    sub_140052E64(v20, v24, &v61, a2, v44, v45, v46, v47, v48, v49, a2);
  }
LABEL_97:
