/*
 * XREFs of sub_140064B0C @ 0x140064B0C
 * Callers:
...
__int64 __fastcall sub_140064B0C(__int64 a1, __int64 a2)
{
  int *v4; // rdx
...
LABEL_42:
    ...
    if ( v11[1] == 7 && !*((_DWORD *)v11 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v26 )
          v8 = *v26;
        sub_140056AB0(v10, (__int64)v11, &v42, a2, v8, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_102;
    }
    ...
    v25 = &stru_140149FE8;
LABEL_101:
    sub_140052F3C(v10, v25, &v42, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_102;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_102;
...
LABEL_97:
      ...
      sub_140052E64(v10, v13, &v42, a2, *(_DWORD *)(a2 + 48), v30, v14, v17, v8, v33, a2);
    }
  }
LABEL_102:
