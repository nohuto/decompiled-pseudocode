/*
 * XREFs of sub_14001046C @ 0x14001046C
 * Callers:
...
__int64 __fastcall sub_14001046C(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v3; // r12
  __int64 v4; // r14
  ...
  while ( 2 )
  {
    ...
    while ( (v10 & 1) == 0 && (v10 || ((*v8)[20] & 1) == 0) )
    {
      ...
      {
LABEL_9:
        v13 = sub_140010C40(a1, a2);
        if ( v13 < 0 )
          sub_140011C50(a1, (unsigned int)v4);
