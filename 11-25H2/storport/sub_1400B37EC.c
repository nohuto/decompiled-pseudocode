/*
 * XREFs of sub_1400B37EC @ 0x1400B37EC
 * Callers:
...
void __fastcall sub_1400B37EC(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  if ( (unsigned int)dword_140168178 > 5 && sub_14003F840(a1, 0x400000000000LL) )
  {
    ...
    v35 = 1LL;
    v37 = 1LL;
    sub_140037B0C((__int64)v38, *(const int **)(v3 + 4720));
    sub_140038378((__int64)v39, (_BYTE *)(a1 + 168));
    sub_140038378((__int64)v40, (_BYTE *)(a1 + 177));
    sub_140038378((__int64)v41, (_BYTE *)(a1 + 242));
    v5 = v4[1];
    v42 = &v22;
    v13 = *(_DWORD *)(a1 + 2480);
    v44 = &v13;
    ...
    v68 = 4LL;
    v70 = 4LL;
    sub_140037A5C(v6, (unsigned __int8 *)dword_1401597EF, v7, (__int64)v4, 0x1Du, &v23);
  }
  *(_QWORD *)(a1 + 2284) = 0LL;
}
