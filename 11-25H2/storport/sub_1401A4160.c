/*
 * XREFs of sub_1401A4160 @ 0x1401A4160
 * Callers:
...
__int64 __fastcall sub_1401A4160(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rsi
  int v3; // ebx
  __int64 v4; // rax
...
LABEL_71:
      ...
      sub_140052E64(v10, v14, &v36, a2, *(_DWORD *)(a2 + 48), v26, v15, v18, v3, v29, a2);
    }
  }
LABEL_76:
