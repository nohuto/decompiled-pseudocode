/*
 * XREFs of sub_14012EC28 @ 0x14012EC28
 * Callers:
...
__int64 __fastcall sub_14012EC28(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 v5; // rdx
  POWER_STATE v6; // ebx
  ...
  sub_14012FC48(*(_QWORD *)(a1 + 128) + 68LL, v5, *(unsigned int *)(*(_QWORD *)(a2 + 184) + 32LL));
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 128) + 80LL) & 1) != 0 )
  {
    v7 = (REQUEST_POWER_COMPLETE *)sub_14012E120;
    v8 = (void *)a2;
    *(_BYTE *)(*(_QWORD *)(a2 + 184) + 3LL) |= 1u;
  }
  else
  {
    v7 = (REQUEST_POWER_COMPLETE *)sub_14012C180;
    v8 = (void *)a1;
  }
  sub_1400F8C38(a1, a2);
  v9 = *(_QWORD *)(a1 + 128);
  ...
  if ( *(_BYTE *)v23 != 15 )
  {
    ...
    if ( *(_BYTE *)(v23 + 1) == 7 && !*(_DWORD *)(v23 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(Context) = v12;
        sub_140056AB0(v22, v23, &v49, a2, Context, Irp);
      }
      goto LABEL_85;
    }
...
LABEL_84:
    ...
    sub_140052F3C(v22, v25, &v49, a2, Context);
    goto LABEL_85;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_85;
...
LABEL_81:
      LOBYTE(Irp) = v38;
      LODWORD(Context) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v22, v26, &v49, a2, Context, Irp, v27, v30, v12, v41, a2);
      goto LABEL_85;
    }
LABEL_80:
    v30 = 0;
