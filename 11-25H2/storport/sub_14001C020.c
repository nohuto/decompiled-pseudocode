/*
 * XREFs of sub_14001C020 @ 0x14001C020
 * Callers:
...
__int64 __fastcall sub_14001C020(unsigned __int8 *a1, __int64 a2, __int64 *a3)
{
  unsigned int v3; // esi
  unsigned int v5; // ebx
  unsigned int v6; // edi
  ...
  _QWORD Dst[32]; // [rsp+F0h] [rbp-10h] BYREF
...
LABEL_2:
  ...
  if ( v7 < v3 )
  {
    ...
    while ( 1 )
    {
      ...
      result = sub_14001D220(a3, v9, v73);
      if ( (int)result < 0 )
        return result;
      if ( (int)sub_14001C790(a3, v9, v73, Dst) < 0 )
      {
        memset_0(Dst, 0, 0xFFuLL);
        if ( (int)sub_14001DAE0(a3, v9) >= 0 )
          Dst[0] = 0x101010101010101LL;
      }
      v11 = *a3;
      if ( !v75 )
        goto LABEL_28;
...
LABEL_28:
      ...
      do
      {
        ...
        if ( CurrentIrql )
        {
          ...
          {
            v36 = sub_14001B210(v31, v61);
            goto LABEL_47;
          }
          v58 = sub_14001E1F0(v31);
          v37 = v30;
