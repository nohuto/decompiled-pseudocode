/*
 * XREFs of sub_14007E0B8 @ 0x14007E0B8
 * Callers:
...
__int64 __fastcall sub_14007E0B8(__int64 a1, __int64 a2)
{
  int v4; // edi
  int v5; // r15d
  __int64 v6; // r8
  ...
  _OWORD v44[2]; // [rsp+110h] [rbp-40h] BYREF
  ...
  {
    v5 = sub_1401360E4(*(_QWORD *)(a1 + 6056));
    if ( v5 < 0 )
      sub_14006FED8(v44, 32LL, (__int64)"TcglibTPerReset");
    _interlockedbittestandreset((volatile signed __int32 *)(a1 + 128), 0);
  }
  *(_QWORD *)(a2 + 56) = 0LL;
  if ( v5 < 0 )
  {
    sub_1400403EC(*(_QWORD *)(a1 + 16), (__int64)&v41);
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v31) = v4;
        sub_140056AB0(v9, v10, &v42, a2, v31, v32);
      }
      goto LABEL_77;
    }
...
LABEL_76:
    ...
    sub_140052F3C(v9, v12, &v42, a2, v31);
    goto LABEL_77;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_77;
...
LABEL_72:
      ...
      LOBYTE(v32) = v26;
      LODWORD(v31) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v9, v13, &v42, a2, v31, v32, v33, v34, v35, v36, a2);
    }
  }
LABEL_77:
