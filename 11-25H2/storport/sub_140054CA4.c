/*
 * XREFs of sub_140054CA4 @ 0x140054CA4
 * Callers:
        ...
        __int64 a14)
{
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x800000000000LL) )
    {
      ...
      v79 = 8LL;
      v81 = 8LL;
      sub_140037A5C(*(__int64 *)&qword_140168DC8, (unsigned __int8 *)dword_140159D35, v22, v20, 0x1Au, &v37);
    }
  }
}
