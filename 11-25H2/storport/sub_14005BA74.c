/*
 * XREFs of sub_14005BA74 @ 0x14005BA74
 * Callers:
...
__int64 __fastcall sub_14005BA74(__int64 a1, PIRP Irp)
{
  int v3; // ebx
  int v4; // r15d
...
LABEL_17:
  sub_1400675E4(v4, v13, v14, v15, MdlAddress_high, v51, v9);
  ...
  if ( CurrentStackLocation->MajorFunction != 15 )
  {
    ...
    if ( CurrentStackLocation->MinorFunction == 7 && !CurrentStackLocation->Parameters.Read.Length )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v43) = v3;
        sub_140056AB0(v18, (__int64)CurrentStackLocation, &v54, Irp, v43, v44);
      }
      goto LABEL_90;
    }
    if ( (byte_1401694F2 & 0x20) == 0 )
      goto LABEL_90;
    v21 = (const EVENT_DESCRIPTOR *)&unk_140149FE8;
    LODWORD(v43) = Irp->IoStatus.Status;
LABEL_89:
    sub_140052F3C(v18, v21, &v54, Irp, v43);
    goto LABEL_90;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_90;
...
LABEL_85:
      ...
      LOBYTE(v44) = v38;
      LODWORD(v43) = Irp->IoStatus.Status;
      sub_140052E64(v37, ProviderId, &v54, Irp, v43, v44, SourceMdl, v46, v47, v41, Irp);
    }
  }
LABEL_90:
