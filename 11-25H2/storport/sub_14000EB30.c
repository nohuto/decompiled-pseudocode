/*
 * XREFs of sub_14000EB30 @ 0x14000EB30
 * Callers:
...
union _SLIST_HEADER *__fastcall sub_14000EB30(union _SLIST_HEADER *a1)
{
      ...
      if ( (union _SLIST_HEADER *)v4->Alignment != v4 && !ExQueryDepthSList(v3) )
      {
        ...
        while ( 1 )
        {
          ...
          *((_BYTE *)v8 + 20) |= 2u;
          ...
          if ( v7 )
            v7->Next = (struct _SLIST_ENTRY *)v11;
          else
    ...
    if ( v14 )
    {
      while ( 1 )
      {
        ...
        if ( *(__int128 **)(v22 + 8) != &v22 )
          break;
        *(_QWORD *)v17 = v22;
        v14->Next = (struct _SLIST_ENTRY *)&v22;
        v14 = Next;
        *(_QWORD *)(v15 + 8) = v17;
        *(_QWORD *)&v22 = v17;
        v17[20] &= ~2u;
