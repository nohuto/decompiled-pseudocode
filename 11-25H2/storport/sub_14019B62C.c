/*
 * XREFs of sub_14019B62C @ 0x14019B62C
 * Callers:
...
__int64 __fastcall sub_14019B62C(__int64 a1, __int64 a2)
{
  int v2; // ebx
  _DWORD *v3; // rsi
  size_t v6; // r8
  ...
  if ( *(_BYTE *)v12 != 15 )
  {
    ...
    if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v13 )
          v2 = *v13;
        sub_140056AB0(v11, v12, &v37, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_76;
    }
...
LABEL_71:
      ...
      sub_140052E64(v11, v15, &v37, a2, *(_DWORD *)(a2 + 48), v27, v16, v19, v2, v30, a2);
    }
  }
LABEL_76:
