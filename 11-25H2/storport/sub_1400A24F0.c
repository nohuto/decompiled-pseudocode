/*
 * XREFs of sub_1400A24F0 @ 0x1400A24F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1400A24F0(__int64 a1, __int64 a2)
{
  __int64 v2; // r8
  int v5; // ebx
  int v6; // ecx
...
LABEL_77:
        ...
        if ( v37[1] == 7 && !*((_DWORD *)v37 + 2) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            if ( v39 )
              v5 = *v39;
            sub_140056AB0(v36, (__int64)v37, &v185, a2, v5, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_141;
        }
        ...
        v40 = &stru_140149FE8;
LABEL_140:
        sub_140052F3C(v36, v40, &v185, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_141;
      }
      if ( byte_1401694F1 >= 0 )
        goto LABEL_141;
...
LABEL_138:
    if ( (byte_1401694F2 & 8) == 0 )
      goto LABEL_141;
    v40 = (const EVENT_DESCRIPTOR *)&unk_140148B18;
    goto LABEL_140;
  }
  if ( !v10 )
  {
...
LABEL_268:
                          ...
                          sub_140052E64(v73, v77, &v185, a2, *(_DWORD *)(a2 + 48), v90, v88, v7, v5, v93, a2);
                        }
                      }
                      goto LABEL_273;
                    }
          ...
          case 0x1B:
            if ( *(_BYTE *)(v74 + 1) == 7 && !*(_DWORD *)(v74 + 8) )
            {
              if ( (byte_1401694F2 & 0x40) != 0 )
              {
                ...
                if ( v75 )
                  v5 = *v75;
                sub_140056AB0(v73, v74, &v185, a2, v5, *(_DWORD *)(a2 + 48));
              }
              goto LABEL_273;
            }
            if ( (byte_1401694F2 & 0x20) == 0 )
...
LABEL_273:
        ...
        sub_140052F3C(v73, v76, &v185, a2, *(_DWORD *)(a2 + 48));
        goto LABEL_273;
      }
      v7 = v10;
      v94 = *(_DWORD *)(v10 + 20);
...
LABEL_108:
    ...
    {
      sub_1400556F8((__int64)off_140168120->AttachedDevice, 0x4Cu, (__int64)&unk_14014D880, v2, a2, v94);
      v2 = v183;
    }
    if ( (v95 & 0x100000) != 0
...
LABEL_414:
        if ( ((*v123 - 8) & 0x5D) == 0 )
        {
          if ( byte_140168DAA && (byte_1401694F1 & 0x1E) != 0 && ((*v123 - 8) & 0x5D) == 0 )
          {
...
LABEL_66:
                      ...
                      sub_140052E64(v11, v16, &v185, a2, v150, v151, v153, v154, v155, v156, v157);
                      goto LABEL_71;
                    }
                  }
                  else
...
LABEL_5:
        ...
        if ( v12[1] == 7 && !*((_DWORD *)v12 + 2) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            LODWORD(v150) = v5;
            sub_140056AB0(v11, (__int64)v12, &v185, a2, v150, v151);
          }
          goto LABEL_71;
        }
        if ( (byte_1401694F2 & 0x20) == 0 )
...
LABEL_70:
        LODWORD(v150) = *(_DWORD *)(a2 + 48);
        sub_140052F3C(v11, v15, &v185, a2, v150);
        goto LABEL_71;
      }
    }
LABEL_67:
...
LABEL_136:
      ...
      sub_140052E64(v36, v41, &v185, a2, *(_DWORD *)(a2 + 48), v56, v54, v7, v5, v59, a2);
    }
  }
LABEL_141:
  IofCompleteRequest((PIRP)a2, 0);
...
LABEL_476:
  ...
  {
    LODWORD(v152) = v34;
    sub_14007ACB0((__int64)off_140168120->AttachedDevice, 0x4Du, (__int64)&unk_14014D880, a1, v35, a2, v152);
  }
  return v34;
}
