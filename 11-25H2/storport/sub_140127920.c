/*
 * XREFs of sub_140127920 @ 0x140127920
 * Callers:
...
__int64 __fastcall sub_140127920(_QWORD *a1)
{
  __int64 v1; // rdx
  ...
  v9 = 0LL;
  if ( sub_14003AA14(v3, (_DWORD *)(v1 + 272)) )
  ...
  v14 = (__int64)&v12;
  KeyHandle = 4;
  if ( (int)sub_1401AD970(v5, (int)&DestinationString, (int)&v9, 4, (__int64)&v14, &KeyHandle) >= 0 )
    v4 = v12 != 0;
  ...
  *(_DWORD *)(a1[20] + 176LL) &= ~8u;
  ...
  v14 = (__int64)&v13;
  KeyHandle = 4;
  result = sub_1401AD970(v6, (int)&DestinationString, (int)&v9, 4, (__int64)&v14, &KeyHandle);
  if ( (int)result >= 0 )
  {
    v8 = a1[20];
