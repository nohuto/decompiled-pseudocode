/*
 * XREFs of sub_140043488 @ 0x140043488
 * Callers:
...
__int64 __fastcall sub_140043488(_QWORD *a1, __int64 a2)
{
  __int64 v3; // rdi
  char v5; // al
  __int64 *v6; // r15
  ...
  else if ( v5 )
  {
    v6 = (__int64 *)(a2 + 32);
    v7 = (__int64 *)(v3 + 112);
    v8 = sub_140037250((__int64 *)(a2 + 32), (__int64 *)(v3 + 112));
    switch ( v8 )
    {
      case 2:
        ...
        if ( v9 > 0xFFFF )
          v9 = 0xFFFF;
        v10 = v9;
        v11 = (void *)sub_1400143E0(64LL, v9, 842096978LL, *(_QWORD *)(*a1 + 8LL));
        v12 = v11;
        if ( v11 )
        {
          memmove(v11, *(const void **)(a2 + 64), v10);
          v13 = *(void **)(v3 + 144);
          if ( v13 )
