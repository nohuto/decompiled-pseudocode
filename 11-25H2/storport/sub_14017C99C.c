/*
 * XREFs of sub_14017C99C @ 0x14017C99C
 * Callers:
...
__int64 __fastcall sub_14017C99C(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebp
  int v3; // ebx
  bool v4; // zf
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v3 = *v8;
        sub_140056AB0(v6, v7, &v33, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
...
LABEL_62:
      ...
      sub_140052E64(v6, v10, &v33, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v3, v26, a2);
    }
  }
LABEL_67:
