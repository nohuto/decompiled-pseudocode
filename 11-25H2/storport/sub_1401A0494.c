/*
 * XREFs of sub_1401A0494 @ 0x1401A0494
 * Callers:
...
__int64 __fastcall sub_1401A0494(_DWORD *a1, __int64 a2)
{
  _DWORD *v3; // rsi
  int v4; // ebx
  size_t v6; // r8
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v4 = *v12;
        sub_140056AB0(v10, v11, &v36, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_76;
    }
    ...
    v31 = *(_DWORD *)(a2 + 48);
LABEL_75:
    sub_140052F3C(v10, v13, &v36, a2, v31);
    goto LABEL_76;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_76;
...
LABEL_71:
      ...
      sub_140052E64(v10, v14, &v36, a2, *(_DWORD *)(a2 + 48), v26, v15, v18, v4, v29, a2);
    }
  }
LABEL_76:
