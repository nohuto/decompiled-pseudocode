/*
 * XREFs of sub_14001B960 @ 0x14001B960
 * Callers:
...
__int64 __fastcall sub_14001B960(__int64 *a1, unsigned int a2, _QWORD *a3)
{
  __int64 result; // rax
  int v7; // edi
  __int64 v8; // rdi
  ...
  _BYTE Dst[8]; // [rsp+60h] [rbp-98h] BYREF
  ...
  if ( (int)result < 0 )
    return result;
  if ( (int)sub_14001C790(a1, a2, Dst, a3) < 0 )
  {
    v7 = sub_14001DAE0(a1, a2);
...
LABEL_24:
  ...
  do
  {
    ...
    if ( CurrentIrql )
    {
      ...
      {
        v33 = sub_14001B210(v28, v62);
      }
      else
      {
        v59 = sub_14001E1F0(v28);
