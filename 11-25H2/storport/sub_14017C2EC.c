/*
 * XREFs of sub_14017C2EC @ 0x14017C2EC
 * Callers:
...
__int64 __fastcall sub_14017C2EC(__int64 a1, __int64 a2)
{
...
LABEL_131:
                        ...
                        sub_140052E64(v31, v35, &v66, a2, *(_DWORD *)(a2 + 48), v48, v36, v39, v30, v51, a2);
                      }
                    }
                    goto LABEL_136;
                  }
      ...
      case 0x1B:
        if ( *(_BYTE *)(v32 + 1) == 7 && !*(_DWORD *)(v32 + 8) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            if ( v33 )
              v30 = *v33;
            sub_140056AB0(v31, v32, &v66, a2, v30, *(_DWORD *)(a2 + 48));
          }
          goto LABEL_136;
        }
...
LABEL_136:
    ...
    sub_140052F3C(v31, v34, &v66, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_136;
  }
  v3 = *(struct _DEVICE_OBJECT **)(a1 + 8);
  v62[0] = -1;
  v4 = IoSetDevicePropertyData(v3, &stru_14014B0F0, 0, 0, 0x11u, 1u, v62);
  v5 = 0;
  *(_BYTE *)(a2 + 141) = -84;
  v6 = byte_140168DAA == 0;
  v7 = v4;
  ...
  if ( *v8 != 15 )
  {
    ...
    if ( v8[1] == 7 && !*((_DWORD *)v8 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(Type) = v5;
        sub_140056AB0(v9, (__int64)v8, &v65, a2, Type, Size);
      }
      goto LABEL_137;
    }
    if ( (byte_1401694F2 & 0x20) == 0 )
...
LABEL_14:
    ...
    sub_140052F3C(v9, v11, &v65, a2, Type);
    goto LABEL_137;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_137;
...
LABEL_64:
      ...
      LOBYTE(Size) = v25;
      LODWORD(Type) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v9, v12, &v65, a2, Type, Size, Data, v16, v5, v28, a2);
    }
  }
LABEL_66:
  v7 = v60;
