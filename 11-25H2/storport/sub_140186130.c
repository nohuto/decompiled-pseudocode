/*
 * XREFs of sub_140186130 @ 0x140186130
 * Callers:
...
__int64 __fastcall sub_140186130(__int64 *a1, __int64 a2, _QWORD *a3)
{
  _DWORD *v4; // rbx
  size_t v6; // r12
  __int64 v7; // rsi
  ...
  *a3 = 0LL;
  ...
  if ( v4 && v6 >= 8 )
  {
    ...
    if ( v9 )
      ...
      v10 = 255;
    v11 = (v10 << 8) + 8;
    v12 = sub_1400143E0(64LL, v11, 1179476306LL, a1[1]);
    v13 = (_WORD *)v12;
    if ( !v12 )
    {
      v32 = -1073741670;
    ...
    Dst[10] = v11 >> 2;
    v32 = sub_140187D84((_DWORD)a1, v12, 0, v11, (__int64)Dst);
    v14 = v32;
    if ( v32 >= 0 )
    {
...
LABEL_48:
  sub_140067EAC(v8, &v32);
  v14 = v32;
  if ( v32 >= 0 )
    goto LABEL_49;
LABEL_50:
  sub_1400C30FC((__int64)a1, v7, v8, v14);
