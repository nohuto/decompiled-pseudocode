/*
 * XREFs of sub_1400A8194 @ 0x1400A8194
 * Callers:
...
__int64 __fastcall sub_1400A8194(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  if ( !a3 )
  {
    if ( !byte_140168DAA || (byte_1401694F3 & 0x10) == 0 )
      return v10;
    v20 = (EVENT_DESCRIPTOR)xmmword_14014A5A0;
    goto LABEL_36;
  }
  if ( a3 != 1 )
  {
    if ( a3 == 2 )
    {
      if ( a7 == 4 )
      {
        if ( (byte_1401694F6 & 0x10) != 0 )
        {
          v20 = (EVENT_DESCRIPTOR)xmmword_14014A9F0;
          goto LABEL_36;
        }
      }
      else
      {
        if ( a7 != 3 )
        {
          ...
          if ( (byte_1401694F5 & 0x10) == 0 )
            goto LABEL_37;
          v20 = (EVENT_DESCRIPTOR)xmmword_14014AF18;
          goto LABEL_36;
        }
        if ( (byte_1401694F5 & 0x20) != 0 )
        {
          v20 = (EVENT_DESCRIPTOR)xmmword_14014A958;
          goto LABEL_36;
        }
      }
      goto LABEL_37;
  ...
  if ( a7 == 4 )
  {
    if ( byte_1401694F4 < 0 )
    {
      v20 = (EVENT_DESCRIPTOR)xmmword_14014A3E0;
LABEL_36:
      EventDescriptor = v20;
    }
  }
  else
  {
    if ( a7 != 3 )
    {
      ...
      if ( (byte_1401694F4 & 0x10) == 0 )
        goto LABEL_37;
      v20 = (EVENT_DESCRIPTOR)xmmword_14014A790;
      goto LABEL_36;
    }
    if ( (byte_1401694F5 & 4) != 0 )
    {
      v20 = (EVENT_DESCRIPTOR)xmmword_14014A9B8;
      goto LABEL_36;
    }
  }
LABEL_37:
  ...
  v21 = sub_1400A80B0(a6, EventDescriptor.Keyword);
  v22 = *(_QWORD *)(a1 + 16);
  EventDescriptor.Keyword = v21;
  sub_1400403EC(v22, (__int64)&v38);
  v44 = &v36;
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  return (unsigned int)sub_140037090(v34);
}
