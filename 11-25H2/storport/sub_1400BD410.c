/*
 * XREFs of sub_1400BD410 @ 0x1400BD410
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1400BD410(PDEVICE_OBJECT DeviceObject, volatile signed __int32 *Context, __int64 a3)
{
  __int64 v4; // rax
  signed __int8 v5; // cf
  _DWORD *v6; // rax
  ...
  if ( Context )
  {
    ...
    if ( *Context == 1314276178 )
    {
      ...
      if ( (*((_QWORD *)Context + 121) & 1) == 0
        ...
        || *((_QWORD *)Context + 159) && **((_DWORD **)Context + 159) )
      {
...
LABEL_15:
        ...
        *(_QWORD *)(*((_QWORD *)Context + 207) + 32LL) = MEMORY[0xFFFFF78000000014];
        if ( (int)sub_1400BCF34((PVOID)Context, *(_QWORD *)(*((_QWORD *)Context + 207) + 48LL), &v8) >= 0 )
        {
          if ( v8 )
          {
      ...
      *(_DWORD *)(*((_QWORD *)Context + 207) + 28LL) &= ~0x100u;
      if ( _interlockedbittestandreset(Context + 268, 1u)
        ...
        && (int)sub_1400BCCF8(Context, (__int64)Context, a3) < 0 )
      {
