/*
 * XREFs of sub_14019074C @ 0x14019074C
 * Callers:
...
__int64 __fastcall sub_14019074C(__int64 a1, _DWORD *a2, int *a3)
{
  unsigned int v3; // esi
  __int64 v8; // rdx
  int v9; // ecx
  ...
  *a2 = 16;
  ...
  if ( *(_QWORD *)(v8 + 112) != qword_140168E28 || *(_QWORD *)(v8 + 120) != qword_140168E30 )
  {
    v9 = 28;
    if ( v3 >= 0x1C )
    {
