/*
 * XREFs of sub_140130658 @ 0x140130658
 * Callers:
...
int __fastcall sub_140130658(__int64 a1, _OWORD *a2, __int16 a3, __int64 a4)
{
  __int64 v5; // rdx
  __int64 v6; // rax
  __int64 v7; // rdx

  v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1272) + 40LL) + 240LL) + 8LL)
     + 112LL * *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1272) + 40LL) + 240LL) + 4LL);
  ...
  *(_DWORD *)(v5 + 88) = *(_DWORD *)(a4 + 80);
  *(_WORD *)(v5 + 98) = *(_WORD *)(a4 + 56);
  *(_DWORD *)(v5 + 92) = *(_DWORD *)(a4 + 48);
  v6 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1272) + 40LL) + 240LL);
  ++*(_BYTE *)(v6 + 4);
  v7 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1272) + 40LL) + 240LL);
