/*
 * XREFs of sub_14017E628 @ 0x14017E628
 * Callers:
...
__int64 __fastcall sub_14017E628(__int64 a1, __int64 a2)
{
  __int64 v3; // r8
  int v4; // ebx
  bool v5; // zf
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v4 = *v8;
        sub_140056AB0(v6, v7, &v31, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_66;
    }
...
LABEL_61:
      ...
      sub_140052E64(v6, v10, &v31, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_66:
