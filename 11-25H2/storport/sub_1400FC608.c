/*
 * XREFs of sub_1400FC608 @ 0x1400FC608
 * Callers:
...
__int64 __fastcall sub_1400FC608(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // ebx
  unsigned int v5; // ebp
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  if ( *(_DWORD *)(v2 + 16) < 0x10u )
    ...
    v5 = sub_14012DC60(a1, *(_QWORD *)(a2 + 24));
  v6 = byte_140168DAA == 0;
  v31 = v5;
  *(_BYTE *)(a2 + 141) = -84;
  *(_DWORD *)(a2 + 48) = v5;
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v3 = *v9;
        sub_140056AB0(v7, v8, &v33, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
...
LABEL_64:
      ...
      sub_140052E64(v7, v11, &v33, a2, *(_DWORD *)(a2 + 48), v25, v12, v15, v3, v28, a2);
    }
  }
LABEL_69:
