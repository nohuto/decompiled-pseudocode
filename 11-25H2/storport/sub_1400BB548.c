/*
 * XREFs of sub_1400BB548 @ 0x1400BB548
 * Callers:
 *     CallbackRoutine @ 0x1400BB850 (CallbackRoutine.c)
 * Callees:
 *     sub_14006FED8 @ 0x14006FED8 (sub_14006FED8.c)
 *     memset_0 @ 0x14013C980 (memset_0.c)
 */

__int64 __fastcall sub_1400BB548(__int64 a1, _DWORD *a2, unsigned int *a3)
{
  __int64 v3; // r13
  unsigned int v6; // eax
  unsigned int v7; // edi
  ...
  if ( v6 >= 0xD8 )
  {
    ...
    *a2 = 1347703620;
    a2[1] = 96;
    a2[2] = v7;
    sub_14006FED8((_BYTE *)a2 + 16, 16LL, (__int64)"storport.sys");
    a2[8] = 0;
    v9 = a2 + 9;
    v10 = *(_QWORD *)(v3 + 24);
    v11 = 0;
