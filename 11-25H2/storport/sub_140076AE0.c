/*
 * XREFs of sub_140076AE0 @ 0x140076AE0
 * Callers:
...
NTSTATUS __fastcall sub_140076AE0(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return sub_1400031E4(a1, &stru_14014A510, a3, 7u, &v10);
}
