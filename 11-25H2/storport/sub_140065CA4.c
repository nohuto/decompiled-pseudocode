/*
 * XREFs of sub_140065CA4 @ 0x140065CA4
 * Callers:
...
__int64 __fastcall sub_140065CA4(CMSPAddress *a1, IRP *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( CurrentStackLocation->Parameters.Create.Options >= 8 )
  {
    ...
    {
      v10 = sub_1400899DC(*((_QWORD *)a1 + 1), a2, &P, &v14);
      v11 = P;
      v9 = v10;
      if ( v10 >= 0 )
      {
        v9 = sub_140016234(a1, a2, (unsigned int *)P, v14, 0LL, 0, 64, 0);
