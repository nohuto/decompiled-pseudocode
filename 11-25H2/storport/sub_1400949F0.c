/*
 * XREFs of sub_1400949F0 @ 0x1400949F0
 * Callers:
...
NTSTATUS __fastcall sub_1400949F0(__int64 a1, __int64 a2)
{
  __int64 v2; // r8
  int v3; // ebx
  _DWORD *v4; // rax
  ...
  if ( *(_DWORD *)(v2 + 16) >= 0x18u )
  {
    ...
    {
      if ( (*(char *)(a1 + 505) >= 0 || (*(_BYTE *)(*(_QWORD *)(a1 + 24) + 110LL) & 0x40) != 0)
...
LABEL_73:
      ...
      sub_140052E64(v9, v13, &v35, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v13 + 3), v14, v17, v3, v29, a2);
    }
  }
LABEL_78:
