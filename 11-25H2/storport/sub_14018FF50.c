/*
 * XREFs of sub_14018FF50 @ 0x14018FF50
 * Callers:
...
__int64 __fastcall sub_14018FF50(__int64 a1, __int64 a2)
{
  int v2; // edi
  __int64 v4; // rdx
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  v8 = sub_1400CDA00(a1, *(_QWORD *)(v6 + 24) ^ a1, 0, 0LL);
  v9 = v8;
  if ( !v8 )
  {
    v7 = -1073741275;
  ...
  if ( *(_BYTE *)v30 != 15 )
  {
    ...
    if ( *(_BYTE *)(v30 + 1) == 7 && !*(_DWORD *)(v30 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v31 )
          v2 = *v31;
        sub_140056AB0(v29, v30, &v58, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_111;
    }
    ...
    v32 = &stru_140149FE8;
LABEL_110:
    sub_140052F3C(v29, v32, &v58, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_111;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_111;
...
LABEL_106:
      ...
      sub_140052E64(v29, v33, &v58, a2, *(_DWORD *)(a2 + 48), *(_BYTE *)(v33 + 3), v35, v38, v2, v50, a2);
    }
  }
LABEL_111:
