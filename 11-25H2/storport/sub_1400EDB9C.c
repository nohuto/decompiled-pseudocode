/*
 * XREFs of sub_1400EDB9C @ 0x1400EDB9C
 * Callers:
...
__int64 __fastcall sub_1400EDB9C(_QWORD *a1, __int64 a2)
{
  _BYTE *v2; // rax
  _DWORD *v3; // r15
  unsigned int v6; // ebx
  ...
  if ( *v2 && *(_BYTE *)(a2 + 80) )
  {
    v8 = sub_1400143E0(72LL, 8LL * *((unsigned int *)qword_140168E40 + 2), 1363763538LL, *(_QWORD *)(a1[16] + 8LL));
    *(_QWORD *)(a2 + 88) = v8;
    if ( v8 )
    {
      ...
      do
      {
        if ( KeGetProcessorNumberFromIndex(v11, &ProcNumber) >= 0 )
        {
          ...
          if ( v12 )
            ...
            v13 = 0x80000000;
          *(_QWORD *)(*(_QWORD *)(a2 + 88) + 8LL * v11) = sub_14008ADD0(
                                                            72LL,
                                                            32LL,
                                                            1363763538LL,
                                                            *(_QWORD *)(a1[16] + 8LL),
          ...
          *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 88) + 8LL * v11) + 24LL) = sub_14008ADD0(
                                                                                72LL,
                                                                                64LL,
                                                                                1363763538LL,
                                                                                *(_QWORD *)(a1[16] + 8LL),
          ...
          if ( !v16 )
            goto LABEL_4;
          if ( v19 )
            KeInitializeDpc(v16, sub_140117870, (PVOID)1);
          else
            KeInitializeThreadedDpc(v16, sub_140117870, (PVOID)1);
