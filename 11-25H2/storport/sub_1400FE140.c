/*
 * XREFs of sub_1400FE140 @ 0x1400FE140
 * Callers:
...
NTSTATUS __fastcall sub_1400FE140(__int64 a1, __int64 a2, _BYTE *a3)
{
  int v3; // ebx
  bool v5; // zf
...
LABEL_62:
      ...
      sub_140052E64(v6, v10, &v32, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v3, v26, a2);
    }
  }
LABEL_67:
