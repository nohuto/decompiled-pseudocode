/*
 * XREFs of sub_1400386D0 @ 0x1400386D0
 * Callers:
...
__int64 __fastcall sub_1400386D0(__int64 a1, IRP *a2, char a3)
{
...
LABEL_10:
    ...
    if ( !a3 )
    {
      if ( byte_140168D65 )
      {
        ...
        if ( (unsigned int)Options >= 0x230 && LODWORD(MasterIrp->MdlAddress) >= 0x200 && (*v21 & 1) == 0 )
        {
          ...
          {
            if ( (unsigned __int8)aAutoatawindows[v9] != (char)v21[v9 + 2] )
              return 3221225485LL;
  ...
  return byte_140168D65 == 0 ? 0xC00000BB : 0;
}
