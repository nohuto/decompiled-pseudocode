/*
 * XREFs of sub_140180B24 @ 0x140180B24
 * Callers:
...
NTSTATUS __fastcall sub_140180B24(__int64 a1, __int64 a2)
{
  int v4; // ebx
  bool v5; // zf
  ...
  {
    if ( **(_DWORD **)(a2 + 24) == 25 )
      return sub_140184D78(a1);
    if ( byte_140168DAA )
    {
      v33 = 0LL;
      IoGetActivityIdIrp(a2, &v33);
      if ( (byte_1401694F2 & 8) != 0 )
        sub_140052F3C(v28, &stru_140148B18, &v33, a2, *(_DWORD *)(a2 + 48));
    }
    ++*(_BYTE *)(a2 + 67);
    *(_QWORD *)(a2 + 184) += 72LL;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v4 = *v8;
        sub_140056AB0(v6, v7, &v33, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
...
LABEL_62:
      ...
      sub_140052E64(v6, v10, &v33, a2, *(_DWORD *)(a2 + 48), v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_67:
