/*
 * XREFs of sub_1400FFA50 @ 0x1400FFA50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1400FFA50(PVOID IoObject, char *Context, PIO_WORKITEM IoWorkItem)
{
  __int64 v3; // rdi
  _DWORD *v5; // rax
  __int16 v6; // ax
  ...
  *(_QWORD *)(*(_QWORD *)v3 + 4192LL) = sub_1400FE560;
  ...
  *(_WORD *)(v3 + 52) = v6;
  ...
  v8 = sub_140122670(*((PVOID *)Context + 2));
  if ( v8 < 0 )
  {
    *(_DWORD *)(v3 + 48) &= ~1u;
    ...
    *(_DWORD *)(v10 + 48) = v8;
    ...
    if ( *(_BYTE *)v12 != 15 )
    {
      ...
      if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
      {
        if ( (byte_1401694F2 & 0x40) != 0 )
        {
          ...
          if ( v13 )
            ...
            v14 = 0LL;
          sub_140056AB0(v14, v12, &v57, v10, v14, *(_DWORD *)(v10 + 48));
        }
        goto LABEL_70;
      }
      ...
      v15 = &stru_140149FE8;
LABEL_69:
      sub_140052F3C(v11, v15, &v57, v10, *(_DWORD *)(v10 + 48));
      goto LABEL_70;
    }
    if ( byte_1401694F1 >= 0 )
      goto LABEL_70;
...
LABEL_63:
      if ( (_BYTE)v16 )
      {
        ...
        v37 = v22;
LABEL_66:
        sub_140052E64(v37, v16, &v57, v10, *(_DWORD *)(v10 + 48), v32, v17, v20, v36, v37, v10);
        goto LABEL_70;
      }
LABEL_65:
      v20 = 0;
