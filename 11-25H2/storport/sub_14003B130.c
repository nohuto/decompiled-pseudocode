/*
 * XREFs of sub_14003B130 @ 0x14003B130
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_14003B130(__int64 DeviceObject, struct _IO_WORKITEM *Context)
{
  PVOID v2; // rdi
  ...
  if ( !KeGetCurrentIrql() && (*((_BYTE *)v2 + 104) & 1) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      OutputBuffer = (_DWORD *)sub_1400143E0(64LL, OutputBufferLength, 1700028754LL, DeviceObject);
      if ( !OutputBuffer )
        break;
      InputBuffer = 53LL;
