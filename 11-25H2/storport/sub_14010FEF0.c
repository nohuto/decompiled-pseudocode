/*
 * XREFs of sub_14010FEF0 @ 0x14010FEF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_14010FEF0(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // ebx
  __int64 v5; // rcx
  __int64 v7; // rbp
  ...
  unsigned int v56; // [rsp+A4h] [rbp-64h] BYREF
  __int64 v57; // [rsp+A8h] [rbp-60h]
  GUID v58; // [rsp+B0h] [rbp-58h] BYREF
  ...
  if ( *(_BYTE *)v25 != 15 )
  {
    ...
    if ( *(_BYTE *)(v25 + 1) == 7 && !*(_DWORD *)(v25 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v52) = *v21;
        LODWORD(v51) = v3;
        sub_140056AB0(v24, v25, &v58, v7, v51, v52);
      }
      goto LABEL_173;
    }
...
LABEL_172:
    LODWORD(v51) = *v21;
    sub_140052F3C(v24, v33, &v58, v7, v51);
    goto LABEL_173;
  }
...
LABEL_169:
      ...
      LOBYTE(v52) = v47;
      LODWORD(v51) = *v21;
      sub_140052E64(v24, v34, &v58, v7, v51, v52, v53, v54, v3, v50, v7);
      goto LABEL_173;
    }
LABEL_168:
    v38 = 0;
