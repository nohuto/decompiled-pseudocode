/*
 * XREFs of sub_1401B1AF4 @ 0x1401B1AF4
 * Callers:
...
int __fastcall sub_1401B1AF4(__int64 a1)
{
  __int64 v2; // rcx
  _DWORD *v3; // rsi
  int v4; // eax
  ...
  {
    sub_140055C18((__int64)off_140168120->AttachedDevice, 0x45u, (__int64)&unk_14014D880, a1);
  }
  v2 = *(_QWORD *)(a1 + 24);
  v3 = (_DWORD *)(a1 + 1928);
  *(_DWORD *)(a1 + 1928) = 20;
  ...
  *(_DWORD *)(a1 + 1940) = 0;
  *(_DWORD *)(a1 + 1948) = -1;
  LODWORD(v9) = IoOpenDeviceRegistryKey(v8, 1u, 0x20019u, &DeviceRegKey);
  if ( (int)v9 >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    LODWORD(v9) = ZwOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes);
    if ( (int)v9 >= 0 )
    {
      if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
        && (HIDWORD(off_140168120->Timer) & 2) != 0
        && BYTE1(off_140168120->Timer) >= 4u )
      {
        sub_140055C18((__int64)off_140168120->AttachedDevice, 0x46u, (__int64)&unk_14014D880, a1);
      }
      ...
      if ( *v5 > 0x64u )
        *v5 = 25;
      if ( byte_140168448 && !*(_QWORD *)(a1 + 3568) )
      {
        v9 = sub_1400143E0(64LL, 192LL, 1465016658LL, 0LL);
        v10 = v9;
        if ( !v9 )
          goto LABEL_25;
        *(_QWORD *)v9 = a1;
        *(_QWORD *)(v9 + 8) = sub_1400A16D0;
        sub_140070610((__int64)KeyHandle, v9);
        sub_140070FE0(v10);
        KeyHandle = 0LL;
        *(_QWORD *)(a1 + 3568) = v10;
      }
      v9 = (__int64)&off_140168120;
      if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120 )
      {
        LODWORD(v9) = HIDWORD(off_140168120->Timer);
        if ( (v9 & 2) != 0 && BYTE1(off_140168120->Timer) >= 4u )
        {
          LODWORD(v12) = *v3;
          LODWORD(v9) = sub_140068F64(
...
LABEL_25:
  if ( DeviceRegKey )
    LODWORD(v9) = ZwClose(DeviceRegKey);
  if ( KeyHandle )
