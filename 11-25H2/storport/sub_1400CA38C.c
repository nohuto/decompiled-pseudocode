/*
 * XREFs of sub_1400CA38C @ 0x1400CA38C
 * Callers:
...
__int64 __fastcall sub_1400CA38C(__int64 a1, __int64 a2, _QWORD *a3)
{
  unsigned int v6; // esi
  char *v7; // rax
  char *v8; // rdi
  ...
  else if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 592) )
  {
    ...
    {
      v7 = (char *)sub_1400143E0(64LL, 488LL, 1179541842LL, *(_QWORD *)(a1 + 8));
      v8 = v7;
      if ( v7
        && (memset_0(v7, 0, 0x1E8uLL),
            v9 = v8 + 24,
            *((_QWORD *)v8 + 4) = v8 + 24,
            *((_QWORD *)v8 + 3) = v8 + 24,
            CacheAwareRundownProtection = ExAllocateCacheAwareRundownProtection((POOL_TYPE)512, 0x464E6152u),
