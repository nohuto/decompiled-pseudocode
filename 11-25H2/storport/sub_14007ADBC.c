/*
 * XREFs of sub_14007ADBC @ 0x14007ADBC
 * Callers:
...
__int64 sub_14007ADBC(__int64 a1, unsigned __int16 a2, __int64 a3, ...)
{
  const char *v3; // r9
  __int64 v4; // r8
  __int64 v5; // r8
  ...
  if ( !v11 )
    v3 = "NULL";
  return ((__int64 (__fastcall *)(__int64, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, const char *, __int64, char *, __int64, _QWORD))qword_1401685A0)(
           a1,
           43LL,
           &unk_14014C778,
           a2,
