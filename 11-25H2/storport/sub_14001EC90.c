/*
 * XREFs of sub_14001EC90 @ 0x14001EC90
 * Callers:
...
__int64 __fastcall sub_14001EC90(_QWORD *a1, __int64 a2, __int64 a3, ULONG_PTR a4)
{
  int v6; // esi
  ...
  __int128 Dst; // [rsp+D0h] [rbp-168h] BYREF
...
LABEL_4:
  ...
  while ( 2 )
  {
    ...
    v19->Next = 0LL;
    v19->MdlFlags = 0;
    v19->StartVa = (PVOID)(v20 & 0xFFFFFFFFFFFFF000uLL);
    ...
    *(_WORD *)&CurrentStackLocation[-1].MajorFunction = -4081;
    ...
    v25[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)&sub_1400357D0;
    v25[-1].Context = &Event;
    v25[-1].Control = -32;
...
LABEL_82:
      ...
      else
      {
          ...
          && BYTE1(off_140168120->Timer) >= 4u )
        {
          ...
          if ( !v6 )
            v77 = "not retried";
          sub_140069054(off_140168120->AttachedDevice, v11, v8, *a1, v10, v8, v11, v108, v29, (__int64)v77);
        }
      }
      if ( !v6-- )
  ...
  {
    sub_140068FD0(off_140168120->AttachedDevice, v8, v10, *a1, v10, v8, v11, Status);
  }
  return (unsigned int)Status;
}
