/*
 * XREFs of sub_1401B2250 @ 0x1401B2250
 * Callers:
...
void __fastcall sub_1401B2250(struct _UNICODE_STRING *a1, _DWORD *a2)
{
  void *v3; // rbx
  int v4; // ecx
  ...
  if ( a2 )
  {
    ...
    if ( v3 )
    {
      ...
      if ( ZwQueryValueKey(v3, &DestinationString, KeyValueFullInformation, KeyValueInformation, 0x200u, &ResultLength) >= 0
        ...
        && !wcsnicmp(Str1, L"IoTimeoutValue", (unsigned __int64)KeyValueInformation[4] >> 1) )
      {
