/*
 * XREFs of sub_1401A1E58 @ 0x1401A1E58
 * Callers:
...
__int64 __fastcall sub_1401A1E58(__int64 a1, __int64 a2)
{
  _DWORD *v4; // rdx
  int v5; // ebx
  int v6; // ecx
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v5 = *v12;
        sub_140056AB0(v10, v11, &v36, a2, v5, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_73;
    }
...
LABEL_68:
      ...
      sub_140052E64(v10, v14, &v36, a2, *(_DWORD *)(a2 + 48), v27, v15, v18, v5, v30, a2);
    }
  }
LABEL_73:
