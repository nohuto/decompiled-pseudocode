/*
 * XREFs of sub_14003DD40 @ 0x14003DD40
 * Callers:
...
void __fastcall sub_14003DD40(__int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // rax
  __int64 v4; // rax
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 4960) )
    {
      ...
      if ( v7 )
        v7 -= *(_QWORD *)(a1 + 5216);
      if ( (unsigned int)dword_140168178 > 5 && (unsigned __int8)sub_14003F840(v7, 0x400000000000LL) )
      {
        v47 = 16LL;
        v46 = a1 + 5064;
        v29 = *(_DWORD *)(a1 + 56);
        ...
        v73 = 8LL;
        v75 = 4LL;
        sub_140037A5C(v13, (unsigned __int8 *)dword_140158915, v8, v9, 0x11u, v45);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 144); i != (__int64 *)(a1 + 144); i = (__int64 *)*i )
    {
      if ( sub_140021280((__int64)(i - 8)) )
      {
        ...
        {
          if ( (unsigned __int8)sub_14003F840(v18, 0x400000000000LL) )
          {
            v21 = i[226];
            v46 = a1 + 5064;
            v47 = 16LL;
            ...
            v85 = 8LL;
            v87 = 4LL;
            sub_140037A5C(v24, (unsigned __int8 *)dword_1401586B2, v19, v20, 0x17u, v45);
          }
        }
