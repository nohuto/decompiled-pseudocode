/*
 * XREFs of sub_1401A9F10 @ 0x1401A9F10
 * Callers:
...
__int64 __fastcall sub_1401A9F10(__int64 a1, void *a2, unsigned int *a3)
{
  __int64 v3; // r14
  unsigned int v7; // ebx
  ...
  _BYTE Dst[8]; // [rsp+40h] [rbp-C0h] BYREF
