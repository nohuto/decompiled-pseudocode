/*
 * XREFs of sub_14017BF84 @ 0x14017BF84
 * Callers:
...
__int64 __fastcall sub_14017BF84(__int64 a1, __int64 a2)
{
  int v3; // ebx
  bool v4; // zf
  ...
  if ( *(_BYTE *)v6 != 15 )
  {
    ...
    if ( *(_BYTE *)(v6 + 1) == 7 && !*(_DWORD *)(v6 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v7 )
          v3 = *v7;
        sub_140056AB0(v5, v6, &v30, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_66;
    }
...
LABEL_61:
      ...
      sub_140052E64(v5, v9, &v30, a2, *(_DWORD *)(a2 + 48), v22, v10, v13, v3, v25, a2);
    }
  }
LABEL_66:
