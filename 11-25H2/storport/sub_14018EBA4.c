/*
 * XREFs of sub_14018EBA4 @ 0x14018EBA4
 * Callers:
...
__int64 __fastcall sub_14018EBA4(__int64 a1, __int64 a2)
{
  __int64 v2; // r12
  int v3; // ebx
  __int64 v6; // rax
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 592) )
  {
    ...
    if ( v6 && *(_DWORD *)(v2 + 16) >= 0x10u && *(_WORD *)v6 == 1 && *(_WORD *)(v6 + 2) == 16 )
    {
      ...
      {
        v8 = sub_1400D10FC(a1, (_QWORD *)(*(_QWORD *)(v6 + 8) ^ a1));
        v9 = (unsigned __int64)v8;
        if ( v8 )
        {
          v7 = sub_1400D1328((__int64)v8);
          if ( v7 >= 0 )
          {
            v10 = *(_DWORD **)(a2 + 24);
...
LABEL_76:
      ...
      sub_140052E64(v16, v20, &v41, a2, *(_DWORD *)(a2 + 48), v33, v21, v24, v3, v36, a2);
    }
  }
LABEL_81:
