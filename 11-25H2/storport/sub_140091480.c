/*
 * XREFs of sub_140091480 @ 0x140091480
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_140091480(PDEVICE_OBJECT DeviceObject, PVOID Context)
{
  __int64 v2; // rbx
  ...
  if ( AttachedDeviceReference )
  {
    ...
    {
      sub_140055C18((__int64)off_140168120->AttachedDevice, 0x48u, (__int64)&unk_14014D880, DeviceObject);
    }
