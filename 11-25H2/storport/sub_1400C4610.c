/*
 * XREFs of sub_1400C4610 @ 0x1400C4610
 * Callers:
...
__int16 __fastcall sub_1400C4610(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  _UNKNOWN **v4; // rax
  __int128 v7; // xmm0
  __int64 v8; // rcx
  ...
  if ( byte_140168DAA )
  {
    ...
    v32 = 0;
    v33 = 0LL;
    LOWORD(v4) = sub_1400403EC(v8, (__int64)&v29);
    v10 = *(unsigned __int16 **)(v9 + 6000);
    if ( v10 )
    {
      v36 = *(_OWORD *)(v10 + 12);
      v37 = *(_OWORD *)(v10 + 20);
