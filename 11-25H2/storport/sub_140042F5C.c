/*
 * XREFs of sub_140042F5C @ 0x140042F5C
 * Callers:
...
__int64 __fastcall sub_140042F5C(
        __int64 a1,
        int a2,
        unsigned __int64 a3,
        __int64 a4,
        ...
        unsigned int *a10)
{
  ...
  if ( (v10[248] & 1) != 0 )
  {
    ...
    if ( !v16 )
      goto LABEL_15;
    v21 = *(_QWORD *)(v16 + 1408) == 0LL;
  }
  else
  {
    v23 = sub_140039148(v10);
    v14 = v23;
    if ( !v23 )
      goto LABEL_15;
    v21 = *(_QWORD *)(v23 + 5600) == 0LL;
  }
  if ( !v21 )
  {
    v22 = -1056964607;
...
LABEL_15:
  ...
  v29 = (unsigned int)dword_140168424;
  if ( v28 <= (unsigned int)dword_140168424 )
    v29 = v28;
  if ( v14 )
  {
    v30 = *(_QWORD *)(v14 + 880);
...
LABEL_43:
  ...
  while ( v31 >= 0x1000 && v20 < v29 )
  {
    if ( v14 )
      ...
      v32 = *(_QWORD *)(v15 + 8);
    v33 = sub_1400143E0(64LL, 40LL, 1161912658LL, v32);
...
LABEL_16:
  if ( byte_1401694F4 < 0 )
  {
    ...
    sub_140072658(v22 == 0, v17, v18, v26, v25, (_DWORD)Flags, v17, v13);
  }
  return v22;
}
