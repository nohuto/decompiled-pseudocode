/*
 * XREFs of sub_140133528 @ 0x140133528
 * Callers:
...
int __fastcall sub_140133528(__int64 a1, __int64 a2, int a3)
{
  _UNKNOWN **v3; // rax
  __int64 v6; // rbx
  __int128 v7; // xmm0
  ...
  if ( byte_140168DAA )
  {
    if ( a1 )
    {
      ...
      if ( v6 )
      {
        ...
        v16 = 0LL;
        v17 = v7;
        sub_1400403EC(*(_QWORD *)(v6 + 16), (__int64)&v16);
        v3 = *(_UNKNOWN ***)(v6 + 6000);
        if ( v3 )
        {
          v23 = *(_OWORD *)(v3 + 3);
