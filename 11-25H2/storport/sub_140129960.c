/*
 * XREFs of sub_140129960 @ 0x140129960
 * Callers:
...
NTSTATUS __fastcall sub_140129960(__int64 a1, __int64 a2)
{
  int v3; // ebx
  __int64 v4; // rdx
  int v5; // r8d
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v10 )
          v3 = *v10;
        sub_140056AB0(v8, v9, &v34, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
...
LABEL_64:
      ...
      sub_140052E64(v8, v12, &v34, a2, *(_DWORD *)(a2 + 48), v24, v13, v16, v3, v27, a2);
    }
  }
LABEL_69:
