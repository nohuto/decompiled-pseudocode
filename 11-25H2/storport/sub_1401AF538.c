/*
 * XREFs of sub_1401AF538 @ 0x1401AF538
 * Callers:
...
__int64 __fastcall sub_1401AF538(__int64 a1, __int64 a2)
{
  _DWORD *v3; // rsi
  int v4; // ebx
  size_t v6; // r8
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v14 )
          v4 = *v14;
        sub_140056AB0(v10, v11, &v40, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_10;
    }
    ...
    v35 = *(_DWORD *)(a2 + 48);
LABEL_15:
    sub_140052F3C(v10, v13, &v40, a2, v35);
    goto LABEL_10;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_10;
...
LABEL_36:
      ...
      sub_140052E64(v10, v15, &v40, a2, *(_DWORD *)(a2 + 48), v34, v24, v17, v4, v21, a2);
    }
  }
LABEL_10:
