/*
 * XREFs of sub_140097410 @ 0x140097410
 * Callers:
...
NTSTATUS __fastcall sub_140097410(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // ebx
  bool v6; // zf
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v3 = *v9;
        sub_140056AB0(v7, v8, &v32, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_69;
    }
    ...
    v29 = *(_DWORD *)(a2 + 48);
LABEL_68:
    sub_140052F3C(v7, v10, &v32, a2, v29);
    goto LABEL_69;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_69;
...
LABEL_64:
      ...
      sub_140052E64(v7, v11, &v32, a2, *(_DWORD *)(a2 + 48), v25, v12, v15, v3, v28, a2);
    }
  }
LABEL_69:
