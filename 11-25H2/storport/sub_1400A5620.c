/*
 * XREFs of sub_1400A5620 @ 0x1400A5620
 * Callers:
...
char sub_1400A5620()
{
  ...
  _BYTE Dst[4]; // [rsp+C8h] [rbp-40h] BYREF
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ResultLength[0] = 0;
  String2 = 0LL;
  String1.Buffer = (PWSTR)v9;
  v9[0] = xmmword_14014E148;
  v9[1] = xmmword_14014E158;
