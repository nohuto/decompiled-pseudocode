/*
 * XREFs of sub_1400FDD94 @ 0x1400FDD94
 * Callers:
...
NTSTATUS __fastcall sub_1400FDD94(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  int v4; // ebx
  bool v6; // zf
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v4 = *v9;
        sub_140056AB0(v7, v8, &v33, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
    ...
    v29 = *(_DWORD *)(a2 + 48);
LABEL_66:
    sub_140052F3C(v7, v10, &v33, a2, v29);
    goto LABEL_67;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_67;
...
LABEL_62:
      ...
      sub_140052E64(v7, v11, &v33, a2, *(_DWORD *)(a2 + 48), v24, v12, v15, v4, v27, a2);
    }
  }
LABEL_67:
