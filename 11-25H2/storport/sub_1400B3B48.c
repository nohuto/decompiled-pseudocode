/*
 * XREFs of sub_1400B3B48 @ 0x1400B3B48
 * Callers:
...
void __fastcall sub_1400B3B48(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r9
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x400000000000LL) )
    {
      ...
      v41 = 1LL;
      v43 = 1LL;
      sub_140037B0C((__int64)v44, *(const int **)(v2 + 4720));
      sub_140038378((__int64)v45, (_BYTE *)(v3 + 168));
      sub_140038378((__int64)v46, (_BYTE *)(v4 + 177));
      sub_140038378((__int64)v47, (_BYTE *)(v5 + 242));
      ...
      v75 = 4LL;
      v77 = 4LL;
      sub_140037A5C(v7, (unsigned __int8 *)dword_140159F3E, v11, v6, 0x1Bu, &v31);
    }
  }
}
