/*
 * XREFs of sub_1400699FC @ 0x1400699FC
 * Callers:
 ...
 *     sub_14006A9D4 @ 0x14006A9D4 (sub_14006A9D4.c)
...
__int64 __fastcall sub_1400699FC(__int64 a1, __int64 a2)
{
  int v2; // eax
  __int64 v4; // r15
  __int64 v6; // rcx
  ...
  if ( !(unsigned int)sub_1400567A0() )
  {
    ...
    if ( (unsigned int)v11 > *(_DWORD *)(v10 + 60) )
    {
      ...
      {
        sub_14006B144(off_140168120->AttachedDevice, v11, v9, v4, v11, *(_DWORD *)(v10 + 60));
      }
      return (unsigned int)-1073741811;
    }
LABEL_19:
...
LABEL_27:
      ...
      if ( v17 == *v12 )
      {
        ...
        v20 = v61;
        sub_1400B59A0(v61, v12, v59);
        v21 = *(_QWORD *)(*(_QWORD *)(a2 + 160) + 184LL);
        v22 = *(_QWORD *)(v21 + 24);
        if ( *(_BYTE *)(v61 + 3368) && (dword_1401691F8 & 1) == 0
...
LABEL_43:
          v28 = *(_QWORD *)(v4 + 6192);
LABEL_65:
          sub_1400A85C4(v4, v28, -1056964596, (_DWORD)v27, 3);
          AdapterCryptoEngineExtension = -2147483631;
LABEL_66:
...
LABEL_71:
          sub_1400A85C4(v4, v29, v26, (_DWORD)v30, 2);
...
LABEL_76:
      ...
      if ( *(_DWORD *)(v31 + 40) < v37 )
      {
        ...
        *(_DWORD *)(v31 + 40) = 0;
        v40 = sub_1400143E0(64LL, v37, 1917018450LL, *(_QWORD *)(v4 + 8));
        *(_QWORD *)(v31 + 48) = v40;
        if ( !v40 )
        {
...
LABEL_73:
  ...
  if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
    ...
    && BYTE1(off_140168120->Timer) >= 2u )
  {
    sub_140055C18((__int64)off_140168120->AttachedDevice, 0x11u, (__int64)&unk_14014B8F0);
  }
  return AdapterCryptoEngineExtension;
}
