/*
 * XREFs of sub_140058490 @ 0x140058490
 * Callers:
...
NTSTATUS __fastcall sub_140058490(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return sub_1400031E4(a1, &stru_14014A268, 0LL, 6u, &v9);
}
