/*
 * XREFs of sub_1400824AC @ 0x1400824AC
 * Callers:
...
__int64 __fastcall sub_1400824AC(__int64 a1, __int64 a2)
{
  int v2; // esi
  __int64 v5; // rcx
  unsigned int v6; // ebx
  ...
  if ( *(_QWORD *)(a2 + 24) )
  {
    if ( *(_DWORD *)(v5 + 8) >= 0x34u )
    {
      ...
      else
      {
        ...
        {
          v49 = *(_DWORD *)(a1 + 104);
          sub_1400403EC(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL), (__int64)&v52);
          v11 = *(_QWORD *)(a1 + 24);
  ...
  if ( *(_BYTE *)v18 != 15 )
  {
    ...
    if ( *(_BYTE *)(v18 + 1) == 7 && !*(_DWORD *)(v18 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v40) = v2;
        sub_140056AB0(v17, v18, &v53, a2, v40, v41);
      }
      goto LABEL_83;
    }
    ...
    LODWORD(v40) = *(_DWORD *)(a2 + 48);
LABEL_82:
    sub_140052F3C(v17, v20, &v53, a2, v40);
    goto LABEL_83;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_83;
...
LABEL_78:
    ...
    LOBYTE(v41) = v35;
    LODWORD(v40) = *(_DWORD *)(a2 + 48);
    sub_140052E64(v17, v21, &v53, a2, v40, v41, v42, v43, v44, v45, a2);
  }
LABEL_83:
