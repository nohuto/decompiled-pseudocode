/*
 * XREFs of sub_14003E980 @ 0x14003E980
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_14003E980(struct _KDPC *Dpc, _QWORD *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  __int64 v4; // rbx
  __int64 v5; // rcx
  KIRQL v6; // al
  ...
  if ( _bittest((const signed __int32 *)(*(_QWORD *)(v4 + 32) + 80LL), 8u)
    && !(unsigned __int8)sub_14009210C(DeferredContext[8]) )
  {
    sub_140025E00(v4, 0, 1);
  }
  v5 = *(_QWORD *)(v4 + 32);
  if ( (*(_DWORD *)(v5 + 80) & 1) != 0 )
  {
