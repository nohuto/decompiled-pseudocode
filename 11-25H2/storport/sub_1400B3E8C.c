/*
 * XREFs of sub_1400B3E8C @ 0x1400B3E8C
 * Callers:
...
void __fastcall sub_1400B3E8C(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // r10
  __int64 v4; // rcx
  ...
  if ( sub_140021280(a1) )
  {
    v2 = *(unsigned int *)(*(_QWORD *)(a1 + 1872) + 32LL);
    if ( (v2 & 0x100) != 0 && (v2 & 0x200) != 0 && (unsigned int)dword_140168178 > 5 )
    {
      if ( sub_14003F840(v2, 0x400000000000LL) )
      {
        ...
        v30 = &v14;
        v31 = 4LL;
        v15 = sub_140037180(a1);
        v33 = 4LL;
        v32 = &v15;
        v34 = &v16;
        v16 = v5;
        v35 = 8LL;
        sub_1400383AC(v6, (unsigned __int8 *)dword_140158609, v7, v5, v8, v9, 0xBu, &v17);
      }
    }
