/*
 * XREFs of sub_140099180 @ 0x140099180
 * Callers:
...
__int64 __fastcall sub_140099180(__int64 a1, ULONG_PTR a2, unsigned __int64 a3)
{
  bool v3; // zf
  _BYTE *v4; // r15
  char v7; // si
  ...
  struct _IO_STATUS_BLOCK v39; // [rsp+30h] [rbp-48h] BYREF
...
LABEL_13:
  v13 = 0LL;
  v14 = 0;
  v15 = sub_140014B7C(*(_QWORD *)(a1 + 8), a2, a3, &v39);
  v16 = v15;
  if ( !v15 )
...
LABEL_57:
          sub_140067F28((__int64)AttachedDevice, v28, (__int64)&unk_14014D880, v30, v27);
        }
      }
    }
    ...
    {
      sub_140055930((__int64)off_140168120->AttachedDevice, 0x4Bu, (__int64)&unk_14014D880);
    }
  }
  else
  {
