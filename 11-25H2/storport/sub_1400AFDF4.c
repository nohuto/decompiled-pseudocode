/*
 * XREFs of sub_1400AFDF4 @ 0x1400AFDF4
 * Callers:
...
void __fastcall sub_1400AFDF4(__int64 a1, char a2)
{
  __int64 v3; // rcx
  __int64 v5; // rcx
  __int64 v6; // r8
  ...
  if ( ((_DWORD)v3
    ...
    && sub_14003F840(v3, 0x400000000000LL) )
  {
    v35 = 16LL;
    v34 = a1 + 5064;
    v22 = *(_DWORD *)(a1 + 56);
    ...
    v65 = 4LL;
    v67 = 1LL;
    sub_140037A5C(v5, (unsigned __int8 *)dword_1401581DD, v6, v7, 0x13u, v33);
  }
  ...
  if ( ((_DWORD)v8
     ...
     || *(_DWORD *)(a1 + 5200))
    && (unsigned int)dword_140168178 > 5
    && sub_14003F840(v8, 0x400000000000LL) )
  {
    v35 = 16LL;
    v34 = a1 + 5064;
    v32[0] = *(_DWORD *)(a1 + 56);
    ...
    v65 = 4LL;
    v67 = 1LL;
    sub_140037A5C(v9, (unsigned __int8 *)dword_140159322, v10, v11, 0x13u, v33);
  }
  sub_140055BA4(a1);
  if ( (*(_DWORD *)(a1 + 5344) & 1) == 0 && (int)sub_140033D74(a1) >= 0 )
  {
    WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 8));
    if ( WorkItem )
      IoQueueWorkItem(WorkItem, (PIO_WORKITEM_ROUTINE)sub_14003B130, NormalWorkQueue, WorkItem);
    else
  ...
  if ( a2 < 0 )
  {
    ...
    if ( (int)sub_140033D74(v14) >= 0 )
    {
      ...
      if ( v16 )
        IoQueueWorkItem(v16, (PIO_WORKITEM_ROUTINE)sub_1400AE9C0, NormalWorkQueue, v16);
      else
        ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(a1 + 336));
    }
  }
