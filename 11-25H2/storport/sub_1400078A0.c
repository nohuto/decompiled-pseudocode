/*
 * XREFs of sub_1400078A0 @ 0x1400078A0
 * Callers:
...
__int64 __fastcall sub_1400078A0(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rax
  __int64 v5; // rax
  __int64 v6; // rdx
    ...
    if ( *v10 != 15 )
    {
      if ( v11 == 14 )
      {
        if ( (byte_1401694F2 & 8) != 0 )
          sub_140052F3C(v10, &unk_140148B18, &v40, a2, *(_DWORD *)(a2 + 48));
      }
      else if ( v11 == 27 )
      {
        if ( v10[1] == 7 && !*((_DWORD *)v10 + 2) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            if ( v17 )
              ...
              v18 = 0;
            sub_140056AB0(v18, v9, (unsigned int)&v40, a2, v18, *(_DWORD *)(a2 + 48));
          }
        }
        else if ( (byte_1401694F2 & 0x20) != 0 )
        {
          sub_140052F3C(v10, &unk_140149FE8, &v40, a2, *(_DWORD *)(a2 + 48));
        }
      }
      goto LABEL_7;
    }
