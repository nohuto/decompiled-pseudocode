/*
 * XREFs of sub_14010171C @ 0x14010171C
 * Callers:
...
char __fastcall sub_14010171C(__int64 a1)
{
  __int64 *v1; // rdi
  __int64 v3; // rcx
  char v4; // bl
  ...
  if ( sub_1400C9458(v3, v5) )
  {
    ...
    if ( v6 )
    {
      ...
      while ( (*(_BYTE *)(v8 + *(_QWORD *)(v5 + 32) + 60) & 1) == 0
           || *(_DWORD *)(v8 + *(_QWORD *)(v5 + 32) + 80) != *(_DWORD *)(a1 + 56) )
      {
        ++v7;
        v8 += 128LL;
        if ( v7 >= v6 )
...
LABEL_20:
    ...
    while ( (*(_BYTE *)(v14 + *(_QWORD *)(v11 + 32) + 60) & 1) == 0
         || *(_DWORD *)(v14 + *(_QWORD *)(v11 + 32) + 80) != *(_DWORD *)(a1 + 56) )
    {
      ++v13;
      v14 += 128LL;
      if ( v13 >= v12 )
