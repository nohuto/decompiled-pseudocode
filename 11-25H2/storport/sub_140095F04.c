/*
 * XREFs of sub_140095F04 @ 0x140095F04
 * Callers:
...
__int64 __fastcall sub_140095F04(__int64 a1, __int64 a2)
{
  int v4; // ebx
  bool v5; // zf
  ...
  {
    sub_1400680F0((__int64)off_140168120->AttachedDevice, 0xCu, (__int64)&unk_14014D880, a1, a2);
  }
  if ( *(_DWORD *)(a1 + 56) != 6 )
  {
    ...
    if ( (*(_BYTE *)(a1 + 504) & 4) != 0 )
    {
      v28 = sub_140092CC8(a1, a2);
      sub_1400305F0(a1, 0);
    }
    else
    {
      v28 = sub_14009281C(a1, a2);
    }
    if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
      && (HIDWORD(off_140168120->Timer) & 2) != 0
      && BYTE1(off_140168120->Timer) >= 4u )
    {
      sub_1400556F8((__int64)off_140168120->AttachedDevice, 0xEu, (__int64)&unk_14014D880, a1, a2, v28);
    }
    return v28;
  }
  if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
    ...
    && BYTE1(off_140168120->Timer) >= 4u )
  {
    sub_1400680F0((__int64)off_140168120->AttachedDevice, 0xDu, (__int64)&unk_14014D880, a1, a2);
  }
  v4 = 0;
  *(_BYTE *)(a2 + 141) = -84;
  v5 = byte_140168DAA == 0;
  *(_DWORD *)(a2 + 48) = -1073741810;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    if ( *(_BYTE *)(v7 + 1) == 7 && !*(_DWORD *)(v7 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v8 )
          v4 = *v8;
        LODWORD(v29) = v4;
        sub_140056AB0(v6, v7, &v33, a2, v29, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_75;
    }
    ...
    LODWORD(v29) = *(_DWORD *)(a2 + 48);
LABEL_74:
    sub_140052F3C(v6, v9, &v33, a2, v29);
    goto LABEL_75;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_75;
...
LABEL_70:
      ...
      LODWORD(v29) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v6, v10, &v33, a2, v29, v23, v11, v14, v4, v26, a2);
    }
  }
LABEL_75:
