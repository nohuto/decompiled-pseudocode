/*
 * XREFs of sub_1400B1E74 @ 0x1400B1E74
 * Callers:
 *     sub_1400B8E7C @ 0x1400B8E7C (sub_1400B8E7C.c)
 * Callees:
 *     sub_1400AE888 @ 0x1400AE888 (sub_1400AE888.c)
 *     __security_check_cookie @ 0x14013C590 (__security_check_cookie.c)
 */

__int64 __fastcall sub_1400B1E74(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = a3;
  v18 = 3137536;
  v6 = sub_1400AE888(v3, InputBuffer, a3, InputBuffer, v8, v9, &v10);
  if ( v6 >= 0 )
  {
    if ( (v18 & 0x10000) != 0 )
    {
