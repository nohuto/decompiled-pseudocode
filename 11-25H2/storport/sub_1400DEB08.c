/*
 * XREFs of sub_1400DEB08 @ 0x1400DEB08
 * Callers:
...
__int64 __fastcall sub_1400DEB08(__int64 a1)
{
  char *v1; // r14
  void *v2; // r12
...
LABEL_5:
  ...
  if ( v10 < 0 )
  {
    if ( (byte_1401694FA & 8) != 0 )
    {
      ...
      if ( PerformanceCounter.QuadPart <= 0 || PerformanceCounter.QuadPart >= v6.QuadPart )
        v28 = PerformanceCounter.QuadPart - v6.QuadPart;
      else
        v28 = PerformanceCounter.QuadPart - v6.QuadPart - 1;
      if ( byte_140168724 )
      {
        v29 = 0LL;
        if ( v32.QuadPart && v28 )
        {
          v30 = v28 / v32.QuadPart;
          v28 = 1000 * (v28 % v32.QuadPart);
          v29 = 10000 * (v28 % v32.QuadPart) / v32.QuadPart + 10000 * (1000 * v30 + v28 / v32.QuadPart);
        }
      }
      else
      {
  ...
  else if ( (byte_1401694FA & 2) != 0 )
  {
    ...
    if ( byte_140168724 )
    {
      ...
      if ( v32.QuadPart && v23 )
      {
        v25 = v23 / v32.QuadPart;
        v23 = 1000 * (v23 % v32.QuadPart);
        v24 = 10000 * (v23 % v32.QuadPart) / v32.QuadPart + 10000 * (1000 * v25 + v23 / v32.QuadPart);
      }
    }
    else
    {
