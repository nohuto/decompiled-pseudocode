/*
 * XREFs of sub_1400642A8 @ 0x1400642A8
 * Callers:
...
__int64 __fastcall sub_1400642A8(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // ebx
  unsigned int v5; // esi
  ...
  if ( *(_BYTE *)v10 != 15 )
  {
    ...
    if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v11 )
          v3 = *v11;
        sub_140056AB0(v9, v10, &v34, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_75;
    }
    ...
    v30 = *(_DWORD *)(a2 + 48);
LABEL_74:
    sub_140052F3C(v9, v12, &v34, a2, v30);
    goto LABEL_75;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_75;
...
LABEL_70:
      ...
      sub_140052E64(v9, v13, &v34, a2, *(_DWORD *)(a2 + 48), v26, v14, v17, v3, v29, a2);
    }
  }
LABEL_75:
