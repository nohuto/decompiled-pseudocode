/*
 * XREFs of sub_140055130 @ 0x140055130
 * Callers:
...
void __fastcall sub_140055130(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r9
  ...
  if ( (unsigned int)dword_140168178 > 5 )
  {
    if ( sub_14003F840(a1, 0x800000000000LL) )
    {
      ...
      v40 = 1LL;
      v42 = 1LL;
      sub_140037B0C((__int64)v43, *(const int **)(v2 + 4720));
      sub_140038378((__int64)v44, (_BYTE *)(v3 + 168));
      sub_140038378((__int64)v45, (_BYTE *)(v4 + 177));
      sub_140038378((__int64)v46, (_BYTE *)(v5 + 242));
      v47 = &v25;
      v17 = *(_BYTE *)(v6 + 8);
      v49 = &v17;
      v26 = *(_QWORD *)(v6 + 360);
      ...
      v65 = &v28;
      v66 = 8LL;
      sub_140037B0C((__int64)v67, (const int *)L"Read, Write");
      sub_140037B0C((__int64)v68, *(const int **)(v8 + 16));
      sub_140037B0C((__int64)v69, (const int *)L"Flush, Unmap");
      sub_140037B0C((__int64)v70, (const int *)L"64ms, 256ms, 1024ms, 5120ms, 5120+ms");
      v72 = 8LL;
      v10 = *v9;
      v74 = 2LL;
      v71 = &v29;
      ...
      v73 = &v18;
      v11 = v9[46];
      v18 = 3 * qword_140169170;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_140169170);
      sub_140037A5C(
        (3 * qword_140169170) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_140158F28,
        v12,
        v13,
        0x1Du,
        &v30);
