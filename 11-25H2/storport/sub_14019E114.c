/*
 * XREFs of sub_14019E114 @ 0x14019E114
 * Callers:
...
__int64 __fastcall sub_14019E114(__int64 a1, __int64 a2)
{
  int v3; // ecx
  int v4; // ebx
  unsigned int v5; // ebp
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v4 = *v9;
        sub_140056AB0(v7, v8, &v34, a2, v4, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
    ...
    v29 = *(_DWORD *)(a2 + 48);
LABEL_66:
    sub_140052F3C(v7, v10, &v34, a2, v29);
    goto LABEL_67;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_67;
...
LABEL_62:
      ...
      sub_140052E64(v7, v11, &v34, a2, *(_DWORD *)(a2 + 48), v24, v12, v15, v4, v27, a2);
    }
  }
LABEL_67:
