/*
 * XREFs of sub_140098228 @ 0x140098228
 * Callers:
...
NTSTATUS __fastcall sub_140098228(__int64 a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rdx
  int v6; // r12d
  ...
  if ( *(_DWORD *)(v4 + 16) >= 0x10u )
  {
    ...
    v8 = sub_140089DC8(*(_QWORD *)(a1 + 8), a2, (__int64 *)&P, &v38);
    v9 = P;
    v6 = v8;
    if ( v8 >= 0 )
    {
      if ( !P )
        goto LABEL_10;
      v6 = sub_1400153FC(a1, a2, (__int64)P, v38, 0LL, 0, 128);
    }
    if ( v9 )
  ...
  if ( *(_BYTE *)v12 != 15 )
  {
    ...
    if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v33) = v2;
        sub_140056AB0(v11, v12, &v41, a2, v33, v34);
      }
      goto LABEL_76;
    }
...
LABEL_75:
    ...
    sub_140052F3C(v11, v14, &v41, a2, v33);
    goto LABEL_76;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_76;
...
LABEL_71:
      ...
      LOBYTE(v34) = v29;
      LODWORD(v33) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v11, v15, &v41, a2, v33, v34, v35, v19, v2, v32, a2);
    }
  }
LABEL_76:
