/*
 * XREFs of sub_14009A510 @ 0x14009A510
 * Callers:
...
NTSTATUS __fastcall sub_14009A510(__int64 a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rdx
  __int64 *v5; // rsi
  ...
  if ( *(_BYTE *)*v5 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v2 = *v12;
        sub_140056AB0(v10, v11, &v35, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_74;
    }
...
LABEL_69:
      ...
      sub_140052E64(v10, v14, &v35, a2, *(_DWORD *)(a2 + 48), v26, v15, v18, v2, v29, a2);
    }
  }
LABEL_74:
