/*
 * XREFs of sub_140004890 @ 0x140004890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140004890(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  _BYTE *v3; // rbx
  __int64 v6; // r13
    ...
    if ( *v37 != 15 )
    {
      if ( v38 == 14 )
      {
        if ( (byte_1401694F2 & 8) != 0 )
          sub_140052F3C(v37, &unk_140148B18, &v319, a2, *(_DWORD *)(a2 + 48));
      }
      else if ( v38 == 27 )
      {
        if ( v37[1] == 7 && !*((_DWORD *)v37 + 2) )
        {
          if ( (byte_1401694F2 & 0x40) != 0 )
          {
            ...
            if ( v85 )
              LODWORD(v3) = *v85;
            sub_140056AB0((_DWORD)v37, v36, (unsigned int)&v319, a2, (char)v3, *(_DWORD *)(a2 + 48));
          }
        }
        else if ( (byte_1401694F2 & 0x20) != 0 )
        {
          sub_140052F3C(v37, &unk_140149FE8, &v319, a2, *(_DWORD *)(a2 + 48));
        }
      }
      goto LABEL_64;
    }
      ...
      *(_DWORD *)(a2 + 48) = v13;
      if ( !v35 )
      {
        ...
        if ( *v58 != 15 )
        {
          ...
          {
            if ( (byte_1401694F2 & 8) != 0 )
              sub_140052F3C(v58, &unk_140148B18, &v318, a2, *(_DWORD *)(a2 + 48));
          }
          else if ( v59 == 27 )
          {
            if ( v58[1] == 7 && !*((_DWORD *)v58 + 2) )
            {
              if ( (byte_1401694F2 & 0x40) != 0 )
              {
                ...
                if ( v90 )
                  LODWORD(v3) = *v90;
                sub_140056AB0((_DWORD)v58, v57, (unsigned int)&v318, a2, (char)v3, *(_DWORD *)(a2 + 48));
              }
            }
            else if ( (byte_1401694F2 & 0x20) != 0 )
            {
              sub_140052F3C(v58, &unk_140149FE8, &v318, a2, *(_DWORD *)(a2 + 48));
            }
          }
          goto LABEL_100;
        }
...
LABEL_195:
      if ( (byte_1401694F2 & 0x20) != 0 )
        sub_140052F3C(v76, &unk_140149FE8, &v318, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_140;
    }
LABEL_187:
    if ( (byte_1401694F2 & 8) != 0 )
      sub_140052F3C(v76, &unk_140148B18, &v318, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_140;
  }
  v6 = v7;
  v16 = *(_DWORD *)(v7 + 20);
...
LABEL_423:
    ...
    *(_DWORD *)(a2 + 48) = -1073741811;
    ...
    if ( *v184 != 15 )
    {
      ...
      {
        if ( (byte_1401694F2 & 8) != 0 )
          sub_140052F3C(v183, &unk_140148B18, &v318, a2, *(_DWORD *)(a2 + 48));
      }
      else if ( v185 == 27 )
      {
        ...
        {
          if ( (byte_1401694F2 & 0x20) != 0 )
            sub_140052F3C(v183, &unk_140149FE8, &v318, a2, *(_DWORD *)(a2 + 48));
        }
        else if ( (byte_1401694F2 & 0x40) != 0 )
        {
          ...
          if ( v186 )
            LODWORD(v3) = *v186;
          sub_140056AB0(v183, (_DWORD)v184, (unsigned int)&v318, a2, (char)v3, *(_DWORD *)(a2 + 48));
        }
      }
      goto LABEL_64;
    }
...
LABEL_319:
      ...
      v145 = 0;
LABEL_320:
      sub_140052E64(v197, v187, (unsigned int)&v318, a2, *(_DWORD *)(a2 + 48), v198, v188, v145, v144, v143, a2);
      goto LABEL_64;
    }
    LOBYTE(v187) = 0;
...
LABEL_17:
  ...
  {
    sub_1400556F8(off_140168120->AttachedDevice, 15LL, &unk_14014D880, a1, a2, v16);
  }
  if ( (v17 & 0x100000) == 0
...
LABEL_38:
          ...
          if ( *v19 == 0xA2 )
          {
            ...
            {
LABEL_39:
              if ( byte_140168DAA && (byte_1401694F1 & 0x1E) != 0 && ((*v19 - 8) & 0x5D) == 0 )
              {
              ...
              *(_QWORD *)(*(_QWORD *)(a2 + 184) + 24LL) = 0LL;
              ...
              sub_1400068E0(a1, a2, v32);
              if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
                && (HIDWORD(off_140168120->Timer) & 8) != 0
                && BYTE1(off_140168120->Timer) >= 4u )
              {
                sub_1400556F8(off_140168120->AttachedDevice, 19LL, &unk_14014D880, a1, a2, 259);
              }
              return 259LL;
            }
          }
          ...
          if ( *v75 != 15 )
          {
            if ( v262 != 14 )
            {
              ...
              if ( v75[1] == 7 && !*((_DWORD *)v75 + 2) )
              {
                ...
                {
LABEL_373:
                  sub_140056AB0((_DWORD)v76, (_DWORD)v75, (unsigned int)&v318, a2, (char)v3, *(_DWORD *)(a2 + 48));
                  goto LABEL_140;
                }
LABEL_372:
                LODWORD(v3) = *v89;
...
LABEL_120:
            ...
            *(_DWORD *)(a2 + 48) = 0;
            ...
            if ( *v66 != 15 )
            {
              ...
              {
                if ( (byte_1401694F2 & 8) != 0 )
                  sub_140052F3C(v66, &unk_140148B18, &v320, a2, *(_DWORD *)(a2 + 48));
              }
              else if ( v67 == 27 )
              {
                if ( v66[1] == 7 && !*((_DWORD *)v66 + 2) )
                {
                  if ( (byte_1401694F2 & 0x40) != 0 )
                  {
                    ...
                    if ( v86 )
                      LODWORD(v3) = *v86;
                    sub_140056AB0((_DWORD)v66, v65, (unsigned int)&v320, a2, (char)v3, *(_DWORD *)(a2 + 48));
                  }
                }
                else if ( (byte_1401694F2 & 0x20) != 0 )
                {
                  sub_140052F3C(v66, &unk_140149FE8, &v320, a2, *(_DWORD *)(a2 + 48));
                }
              }
              goto LABEL_123;
            }
...
LABEL_594:
          ...
          *(_DWORD *)(a2 + 48) = 0;
          ...
          if ( *v236 != 15 )
          {
            ...
            {
              if ( (byte_1401694F2 & 8) != 0 )
                sub_140052F3C(v236, &unk_140148B18, &v321, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( v237 == 27 )
            {
              ...
              {
                if ( (byte_1401694F2 & 0x20) != 0 )
                  sub_140052F3C(v236, &unk_140149FE8, &v321, a2, *(_DWORD *)(a2 + 48));
              }
              else if ( (byte_1401694F2 & 0x40) != 0 )
              {
                v238 = *(_DWORD **)(a2 + 56);
                if ( v238 )
                  LODWORD(v3) = *v238;
                sub_140056AB0((_DWORD)v236, v235, (unsigned int)&v321, a2, (char)v3, *(_DWORD *)(a2 + 48));
              }
            }
            goto LABEL_652;
          }
...
LABEL_668:
            sub_1400680F0(v71->AttachedDevice, v121, &unk_14014D880, a1, a2);
            return 0LL;
          }
          v239 = *((_QWORD *)v236 + 1);
          v240 = 0;
        ...
        else
        {
          ...
          *(_DWORD *)(a2 + 48) = 0;
          ...
          if ( *v51 != 15 )
          {
            ...
            {
              if ( (byte_1401694F2 & 8) != 0 )
                sub_140052F3C(v51, &unk_140148B18, &v323, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( v52 == 27 )
            {
              if ( v51[1] == 7 && !*((_DWORD *)v51 + 2) )
              {
                if ( (byte_1401694F2 & 0x40) != 0 )
                {
                  ...
                  if ( v87 )
                    ...
                    v88 = 0;
                  sub_140056AB0(v88, v50, (unsigned int)&v323, a2, v88, *(_DWORD *)(a2 + 48));
                }
              }
              else if ( (byte_1401694F2 & 0x20) != 0 )
              {
                sub_140052F3C(v51, &unk_140149FE8, &v323, a2, *(_DWORD *)(a2 + 48));
              }
            }
            goto LABEL_86;
          }
...
LABEL_88:
        if ( off_140168120 != (PDEVICE_OBJECT)&off_140168120
          ...
          && BYTE1(off_140168120->Timer) >= 4u )
        {
          sub_1400556F8(off_140168120->AttachedDevice, 20LL, &unk_14014D880, a1, a2, v45);
        }
        if ( (_BYTE)v3 )
        {
    ...
    {
      case 1:
        v45 = sub_140092210(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 2:
      case 9:
        v45 = sub_1400067A0(a1, a2);
        goto LABEL_88;
      case 4:
        v45 = sub_140095B74(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 6:
        v45 = sub_1400957B4(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 16:
      case 19:
      case 32:
        v45 = sub_140007BD8(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 18:
        v45 = sub_140096368(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 21:
        v45 = sub_1400930B8(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 23:
        v35 = byte_140168DAA == 0;
        ...
        *(_BYTE *)(a2 + 141) = -84;
        ...
        if ( *v279 != 15 )
        {
          ...
          {
            if ( (byte_1401694F2 & 8) != 0 )
              sub_140052F3C(v279, &unk_140148B18, &v322, a2, *(_DWORD *)(a2 + 48));
          }
          else if ( v280 == 27 )
          {
            ...
            {
              if ( (byte_1401694F2 & 0x20) != 0 )
                sub_140052F3C(v279, &unk_140149FE8, &v322, a2, *(_DWORD *)(a2 + 48));
            }
            else if ( (byte_1401694F2 & 0x40) != 0 )
            {
              v281 = *(_DWORD **)(a2 + 56);
              if ( v281 )
                LODWORD(v3) = *v281;
              sub_140056AB0((_DWORD)v279, (_DWORD)v278, (unsigned int)&v322, a2, (char)v3, *(_DWORD *)(a2 + 48));
            }
          }
          goto LABEL_790;
        }
...
LABEL_788:
        ...
        goto LABEL_790;
      case 24:
        v45 = sub_140004290(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 25:
        v45 = sub_140004004(a1, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
      case 26:
        v45 = sub_140003D0C(a1, a2);
        LOBYTE(v3) = v45 != 259;
        goto LABEL_88;
      default:
        v45 = sub_1401826BC(v18, a2);
        LOBYTE(v3) = 1;
        goto LABEL_88;
    }
  }
...
LABEL_488:
  ...
  *(_DWORD *)(a2 + 48) = -1073741823;
  ...
  if ( *v204 != 15 )
  {
    ...
    {
      if ( (byte_1401694F2 & 8) != 0 )
        sub_140052F3C(v203, &unk_140148B18, &v318, a2, *(_DWORD *)(a2 + 48));
    }
    else if ( v205 == 27 )
    {
      ...
      {
        if ( (byte_1401694F2 & 0x20) != 0 )
          sub_140052F3C(v203, &unk_140149FE8, &v318, a2, *(_DWORD *)(a2 + 48));
      }
      else if ( (byte_1401694F2 & 0x40) != 0 )
      {
        v206 = *(_DWORD **)(a2 + 56);
        if ( v206 )
          LODWORD(v3) = *v206;
        sub_140056AB0(v203, (_DWORD)v204, (unsigned int)&v318, a2, (char)v3, *(_DWORD *)(a2 + 48));
      }
    }
    goto LABEL_549;
  }
