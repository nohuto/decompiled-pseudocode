/*
 * XREFs of sub_1400F1060 @ 0x1400F1060
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1400F1060(PDEVICE_OBJECT DeviceObject, _QWORD *Context, __int64 a3)
{
  _DWORD *v3; // r15
  unsigned int v5; // eax
  int v6; // edi
  ...
  if ( Context && *(_DWORD *)Context == 1314276178 )
  {
    do
    {
      ...
      {
        LOBYTE(a3) = 1;
        v9 = sub_140120CDC(Context[128], i, a3) - 1;
        if ( v9 )
        {
          v10 = v9 - 1;
