/*
 * XREFs of sub_1401806D8 @ 0x1401806D8
 * Callers:
...
NTSTATUS __fastcall sub_1401806D8(__int64 a1, __int64 a2, _BYTE *a3)
{
  int v3; // ebx
  bool v6; // zf
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 8u )
  {
    v29 = **(_DWORD **)(a2 + 24);
    if ( !v29 )
      return sub_1401845B8(a1);
    v30 = v29 - 2;
    if ( !v30 )
      return sub_1401841F4(a1);
    v31 = v30 - 1;
    if ( !v31 )
      return sub_140183E30(a1);
    v32 = v31 - 3;
    if ( !v32 )
      return sub_1400A20DC(a1, a2, a3);
    if ( v32 == 21 )
      return sub_1401849A4(a1);
    if ( byte_140168DAA )
    {
      v38 = 0LL;
      IoGetActivityIdIrp(a2, &v38);
      if ( (byte_1401694F2 & 8) != 0 )
        sub_140052F3C(v33, &stru_140148B18, &v38, a2, *(_DWORD *)(a2 + 48));
    }
    ++*(_BYTE *)(a2 + 67);
    *(_QWORD *)(a2 + 184) += 72LL;
  ...
  if ( *(_BYTE *)v8 != 15 )
  {
    ...
    if ( *(_BYTE *)(v8 + 1) == 7 && !*(_DWORD *)(v8 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v9 )
          v3 = *v9;
        sub_140056AB0(v7, v8, &v38, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
    ...
    v34 = *(_DWORD *)(a2 + 48);
LABEL_66:
    sub_140052F3C(v7, v10, &v38, a2, v34);
    goto LABEL_67;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_67;
...
LABEL_62:
      ...
      sub_140052E64(v7, v11, &v38, a2, *(_DWORD *)(a2 + 48), v24, v12, v15, v3, v27, a2);
    }
  }
LABEL_67:
