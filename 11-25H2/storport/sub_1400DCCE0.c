/*
 * XREFs of sub_1400DCCE0 @ 0x1400DCCE0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_1400DCCE0(__int64 a1)
{
  __int64 v1; // rbp
  char v3; // r15
  unsigned int v4; // r8d
    ...
    *(_BYTE *)(a1 + 17) |= 0x80u;
    ...
    else
    {
      ...
      if ( *(_DWORD *)(v9 + 572) == 1 )
        v18 = sub_1400EC40C(
                v9,
                *(unsigned int *)(((unsigned __int64)*(unsigned __int16 *)(a1 + 782) << 7) + *(_QWORD *)(v10 + 32) + 80));
      v11 = *(_QWORD *)(v10 + 32);
      v12 = *(_DWORD *)(a1 + 20);
      ...
      if ( v14 )
        LODWORD(v7) = v14(v9, v1, v19, v12, v18, v15);
      else
        LODWORD(v7) = KeSetEvent((PRKEVENT)(a1 + 664), 0, 0);
      *(_BYTE *)(a1 + 17) &= ~0x80u;
      _InterlockedDecrement16((volatile signed __int16 *)(v10 + 152));
      if ( v3 )
        LODWORD(v7) = sub_1401190B0(v9, v10, v12);
    }
  }
  return v7;
}
