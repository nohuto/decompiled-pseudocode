/*
 * XREFs of sub_140021A00 @ 0x140021A00
 * Callers:
 ...
 *     sub_140055F30 @ 0x140055F30 (sub_140055F30.c)
...
__int64 __fastcall sub_140021A00(__int64 a1, __int64 a2, int a3, char a4, char a5, int a6)
{
  _BYTE *v6; // r14
  __int64 v9; // r13
  __int64 v10; // r12
  ...
  v11 = 0LL;
  v12 = 0LL;
  v13 = sub_140022688(a2, (unsigned int)VirtualAddress, (unsigned int)&Length, (unsigned int)&v107, 2);
  v14 = v13;
  if ( v13 < 0 )
  {
    *(_DWORD *)(a2 + 48) = v13;
  ...
  if ( !v15 )
  {
    ...
    if ( !Pool2 && v16 )
      sub_14008D9B8(v16, 64, 88, 1918067026, 0x80000000);
    goto LABEL_7;
  }
  ...
  if ( !v70 && v16 )
  {
    sub_14008D9B8(v16, 64, 144, 1918067026, 0x80000000);
    goto LABEL_157;
  }
  Pool2 = v70;
  if ( !v70 )
...
LABEL_8:
  ...
  if ( *(_DWORD *)a1 != 1314275652 )
    v19 = 524LL;
  v9 = sub_14002285C(((*(_DWORD *)(v19 + a1) + 7) & 0xFFFFFFF8) + 1184);
  if ( !v9 )
  {
    if ( !*(_QWORD *)(a1 + 120) )
      goto LABEL_74;
...
LABEL_75:
  ...
  *(_QWORD *)(v9 + 232) = v30;
  ...
  KeInitializeEvent((PRKEVENT)(v9 + 712), NotificationEvent, 0);
  *(_QWORD *)(v9 + 704) = sub_140038660;
  if ( *(_QWORD *)(a1 + 4960) )
  ...
  if ( *(_BYTE *)(a1 + 4370) )
  {
    ...
    if ( *(_BYTE *)(a1 + 4370) )
    {
          ...
          if ( a1 != -880 )
          {
            ...
            if ( *v37 )
            {
              ...
              if ( v33 )
              {
                ...
                {
                  v39(v38, *(_QWORD *)(v9 + 152), v36);
                }
                else
                {
                  LOBYTE(v33) = 1;
                  KeFlushIoBuffers(*(_QWORD *)(v9 + 152), v36, v33);
                }
              }
            }
          }
      ...
      else
      {
        if ( *(_QWORD *)(v9 + 184) )
        {
          v41 = sub_140018B28(a1, (unsigned int *)(v9 + 48), v33);
          goto LABEL_37;
        }
        if ( (v35 & 0xC0) != 0 )
        {
          v41 = sub_140027680(a1, v9 + 48);
          goto LABEL_37;
        }
      }
    }
    v41 = sub_1400184D0(a1, v9 + 48);
LABEL_37:
    v14 = v41;
    KeLowerIrql(v101);
    goto LABEL_38;
  }
  v14 = sub_1400184D0(a1, v9 + 48);
LABEL_38:
  if ( v14 >= 0 )
  {
    KeWaitForSingleObject((PVOID)(v9 + 712), Executive, 0, 0, 0LL);
    v14 = sub_1400229C8(*(unsigned __int8 *)(Pool2 + 3));
  }
  v42 = *(_BYTE *)(v9 + 65);
  if ( (v42 & 1) != 0 )
  {
    sub_14001F93C(a1, *(unsigned int *)(v9 + 796));
    *(_BYTE *)(v9 + 65) &= ~1u;
    v42 = *(_BYTE *)(v9 + 65);
  }
  if ( (v42 & 2) == 0 )
...
LABEL_43:
  ...
  {
    v72 = sub_14001F350(a1, v103);
    v73 = (__int64)v72;
    if ( !v72 || (unsigned int)sub_1400066C0((__int64)v72, a2, 1) )
      goto LABEL_43;
  }
  sub_14001F6B0(v73, *(_DWORD *)(v9 + 796));
  *(_BYTE *)(v9 + 65) &= ~2u;
  if ( a6 == 1 )
    goto LABEL_43;
  ...
  *(_QWORD *)(a2 + 56) = v46;
  ...
  if ( *(_DWORD *)a1 != 1094997074 )
  {
    if ( *(_DWORD *)a1 == 1314275652 && *(_BYTE *)(a1 + 1152) && *(_DWORD *)(a1 + 1172) == 3 )
      goto LABEL_152;
LABEL_65:
    MmFreeContiguousMemory((PVOID)v9);
    goto LABEL_66;
  }
  ...
  if ( *v50 != 15 )
  {
    if ( v51 == 14 )
    {
      if ( (byte_1401694F2 & 8) != 0 )
        sub_140052F3C(v50, &unk_140148B18, VirtualAddress, a2, *(_DWORD *)(a2 + 48));
    }
    else if ( v51 == 27 )
    {
      if ( v50[1] == 7 && !*((_DWORD *)v50 + 2) )
      {
        if ( (byte_1401694F2 & 0x40) != 0 )
        {
          ...
          if ( v71 )
            LODWORD(v6) = *v71;
          sub_140056AB0((_DWORD)v50, v49, (unsigned int)VirtualAddress, a2, (char)v6, *(_DWORD *)(a2 + 48));
        }
      }
      else if ( (byte_1401694F2 & 0x20) != 0 )
      {
        sub_140052F3C(v50, &unk_140149FE8, VirtualAddress, a2, *(_DWORD *)(a2 + 48));
      }
    }
    goto LABEL_73;
  }
