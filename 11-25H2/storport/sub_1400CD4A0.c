/*
 * XREFs of sub_1400CD4A0 @ 0x1400CD4A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1400CD4A0(struct _KDPC *Dpc, _QWORD *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  __int64 v4; // rdi
  BYTE v5; // bl
