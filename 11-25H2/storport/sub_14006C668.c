/*
 * XREFs of sub_14006C668 @ 0x14006C668
 * Callers:
...
__int64 __fastcall sub_14006C668(__int64 a1, __int64 a2)
{
  __int64 v2; // r8
  int v3; // ebx
  int *v4; // rcx
...
LABEL_98:
        if ( (byte_1401694F2 & 8) == 0 )
          goto LABEL_101;
        v30 = (const EVENT_DESCRIPTOR *)&unk_140148B18;
        goto LABEL_100;
      }
    }
    goto LABEL_6;
  ...
  switch ( v6 )
  {
    ...
    case 1314275652:
      ...
      goto LABEL_3;
    case 1314278989:
      v14 = *(_QWORD *)(*((_QWORD *)sub_14006B3C4(v2) + 2) + 128LL);
      if ( v14 )
      {
        v8 = *(_QWORD *)(v14 + 16);
        goto LABEL_21;
...
LABEL_9:
    ...
    if ( v11[1] == 7 && !*((_DWORD *)v11 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v13 )
          v3 = *v13;
        sub_140056AB0(v10, (__int64)v11, &v45, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_101;
    }
    ...
    v30 = &stru_140149FE8;
LABEL_100:
    sub_140052F3C(v10, v30, &v45, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_101;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_101;
...
LABEL_96:
      ...
      sub_140052E64(v10, v17, &v45, a2, *(_DWORD *)(a2 + 48), v36, v18, v21, v3, v39, a2);
    }
  }
LABEL_101:
