/*
 * XREFs of sub_14005E41C @ 0x14005E41C
 * Callers:
...
__int64 __fastcall sub_14005E41C(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // ebx
  int v5; // r13d
...
LABEL_38:
  ...
  {
    LOBYTE(v7) = -75;
    v14 = sub_1400605C0(v5, a2, v7, (_DWORD)v8, v11);
    v12 = v14;
    if ( v14 != -2147483631 )
      break;
  }
  if ( v14 >= 0 )
  {
    ...
    {
      LOBYTE(v7) = -75;
      v17 = sub_1400605C0(v5, a2, v7, (_DWORD)v8, 1);
      v12 = v17;
      if ( v17 != -2147483631 )
        break;
    }
...
LABEL_30:
      ...
      {
        LOBYTE(v7) = -94;
        v19 = sub_1400605C0(v5, a2, v7, (_DWORD)v8, v10);
        v12 = v19;
        if ( v19 != -2147483631 )
          break;
      }
    ...
    if ( *(_BYTE *)(v24 + 1) == 7 && !*(_DWORD *)(v24 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        if ( *v20 )
          v3 = *(_DWORD *)*v20;
        LODWORD(v46) = v3;
        sub_140056AB0(v23, v24, &v52, a2, v46, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_109;
    }
...
LABEL_108:
    ...
    sub_140052F3C(v23, v25, &v52, a2, v46);
    goto LABEL_109;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_109;
...
LABEL_104:
    ...
    LODWORD(v46) = *(_DWORD *)(a2 + 48);
    sub_140052E64(v23, v26, &v52, a2, v46, v41, v28, v31, v3, v44, a2);
  }
LABEL_109:
