/*
 * XREFs of sub_14009E38C @ 0x14009E38C
 * Callers:
...
char __fastcall sub_14009E38C(__int64 a1)
{
  _BYTE *v1; // rax
  ...
  if ( v1 )
  {
    ...
    if ( !(_BYTE)v1 || (_BYTE)v1 == 20 )
    {
      ...
      LODWORD(v1) = sub_1401AD970(*(_QWORD *)(a1 + 8), (int)&DestinationString, (int)&v4, 4, (__int64)&v8, &KeyHandle);
      if ( (int)v1 >= 0 )
      {
        LOBYTE(v1) = v6;
        if ( v6 )
