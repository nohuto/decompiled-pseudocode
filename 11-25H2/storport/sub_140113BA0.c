/*
 * XREFs of sub_140113BA0 @ 0x140113BA0
 * Callers:
...
__int64 __fastcall sub_140113BA0(__int64 a1, __int64 a2, __int64 a3, unsigned __int8 *a4, int a5)
{
  __int64 v9; // r14
  __int64 result; // rax
        ...
        if ( (unsigned int)v13 >= 0x80 && (unsigned int)v13 < *(_DWORD *)(a3 + 16) )
        {
          ...
          if ( *(_DWORD *)(a3 + v13) == 67 )
          {
            ...
            if ( (*(_DWORD *)(a3 + 24) & 0xC0) == 0 )
              break;
            sub_140003B80(a4, (__int64)&v22, 0LL);
            v16 = *(_DWORD *)(a3 + 60);
            ...
            *(_BYTE *)(v14 + 68) = 0;
            *(_QWORD *)(v14 + 72) = 0LL;
            v21 = v20 & 0x3FFFFFF | (v17 != 0 ? 0x40000000 : 0);
            LODWORD(v20) = a5;
            *(_DWORD *)(v14 + 64) = v21 & 0x7FFFFFFF;
            result = sub_1400E65F4(*(_QWORD *)(a1 + 16), a3, a2, a1, v20, (__int64)sub_1400F9A20, 0LL);
            if ( (int)result >= 0 )
              return result;
            goto LABEL_21;
          }
