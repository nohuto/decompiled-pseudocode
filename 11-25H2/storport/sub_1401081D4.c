/*
 * XREFs of sub_1401081D4 @ 0x1401081D4
 * Callers:
...
__int64 __fastcall sub_1401081D4(__int64 a1, __int64 a2, __int64 a3)
{
  int v6; // ebx
  bool v7; // zf
  ...
  if ( *(_BYTE *)v9 != 15 )
  {
    ...
    if ( *(_BYTE *)(v9 + 1) == 7 && !*(_DWORD *)(v9 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v10 )
          v6 = *v10;
        sub_140056AB0(v8, v9, &v34, a3, v6, *(_DWORD *)(a3 + 48));
      }
      goto LABEL_66;
    }
    ...
    v11 = &stru_140149FE8;
LABEL_65:
    sub_140052F3C(v8, v11, &v34, a3, *(_DWORD *)(a3 + 48));
    goto LABEL_66;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_66;
...
LABEL_61:
      ...
      sub_140052E64(v8, v12, &v34, a3, *(_DWORD *)(a3 + 48), v25, v13, v16, v6, v28, a3);
    }
  }
LABEL_66:
