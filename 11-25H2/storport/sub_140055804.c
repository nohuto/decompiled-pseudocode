/*
 * XREFs of sub_140055804 @ 0x140055804
 * Callers:
...
__int64 __fastcall sub_140055804(int *a1)
{
  _QWORD *v1; // rbx
  bool v2; // zf
  int v3; // eax
...
LABEL_8:
  ...
  else
  {
    if ( !*((_QWORD *)a1 + 9) )
      return 0LL;
    v9 = (KSPIN_LOCK *)IoGetDriverObjectExtension(*(PDRIVER_OBJECT *)(*((_QWORD *)a1 + 1) + 8LL), StorPortGetSrb);
    v5 = v9;
    if ( v9 )
    {
