/*
 * XREFs of sub_140001A2C @ 0x140001A2C
 * Callers:
...
__int64 __fastcall sub_140001A2C(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a14)
{
  ...
  int v26; // eax
  __int64 v27; // rcx
  _BYTE v29[16]; // [rsp+38h] [rbp-C9h] BYREF
  ...
  v51 = v14;
  v55 = 8LL;
  return sub_1400031E4(v27, &unk_1401488B0, 0LL, 12LL, v29);
}
