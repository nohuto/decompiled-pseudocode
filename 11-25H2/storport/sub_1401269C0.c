/*
 * XREFs of sub_1401269C0 @ 0x1401269C0
 * Callers:
...
void __fastcall sub_1401269C0(_QWORD *SystemArgument2, unsigned __int16 a2, char a3, unsigned int a4)
{
  __int64 v4; // r12
  bool v7; // r15
  unsigned int v8; // ebp
  ...
  if ( a2 == 0xFFFF || *((_DWORD *)SystemArgument2 + 227) <= 1u )
  {
    ...
    if ( (*(_WORD *)(*(_QWORD *)v11 + 16LL * *(unsigned __int16 *)(v11 + 34) + 14) & 1) != *(_WORD *)(v11 + 36) )
    {
      ...
      if ( v7 )
        sub_140123D54(v12, (PVOID)(a3 != 0), (volatile signed __int32 *)v11, (char *)SystemArgument2);
      else
    ...
    if ( SystemArgument2[108] && *((_WORD *)SystemArgument2 + 13) )
    {
      do
      {
        ...
        if ( (*(_WORD *)(*(_QWORD *)v13 + 16LL * *(unsigned __int16 *)(v13 + 34) + 14) & 1) != *(_WORD *)(v13 + 36) )
        {
          ...
          if ( v7 )
            sub_140123D54(v14, (PVOID)(a3 != 0), (volatile signed __int32 *)v13, (char *)SystemArgument2);
          else
  ...
  else
  {
    ...
    if ( v7 )
      sub_140123D54(v10, (PVOID)(a3 != 0), (volatile signed __int32 *)v9, (char *)SystemArgument2);
    else
