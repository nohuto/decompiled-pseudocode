/*
 * XREFs of sub_1401B0BC0 @ 0x1401B0BC0
 * Callers:
...
__int64 __fastcall sub_1401B0BC0(__int64 a1, __int64 a2)
{
  unsigned int *v2; // rsi
  __int64 v3; // r8
...
LABEL_15:
  if ( *(_DWORD *)(a2 + 8) >= 2u )
    return 3221225485LL;
  DriverObjectExtension = (const void **)IoGetDriverObjectExtension(*(PDRIVER_OBJECT *)(v3 + 8), StorPortGetSrb);
