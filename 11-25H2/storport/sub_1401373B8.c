/*
 * XREFs of sub_1401373B8 @ 0x1401373B8
 * Callers:
...
__int64 __fastcall sub_1401373B8(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v5; // rdi
  __int64 v8; // r8
  ...
  return ((__int64 (__fastcall *)(__int64, __int64, __int64, int *))sub_140138454)(a1, a2, v8, &v10);
}
