/*
 * XREFs of sub_14005DB44 @ 0x14005DB44
 * Callers:
...
__int64 __fastcall sub_14005DB44(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  int v3; // ebx
  int v6; // r12d
...
LABEL_21:
  ...
  {
    v15 = sub_140187B58(a1, v14, &v44);
    v8 = v44;
    v9 = v15;
    v45 = v15;
    if ( v15 < 0 )
    {
      sub_140067EAC((unsigned __int16)v44, &v45);
      v9 = v45;
    }
  }
  else
...
LABEL_22:
  ...
  *(_DWORD *)(a2 + 48) = v9;
  ...
  if ( **v10 != 15 )
  {
    ...
    if ( v19[1] == 7 && !*((_DWORD *)v19 + 2) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v20 )
          v3 = *v20;
        LODWORD(v41) = v3;
        sub_140056AB0(v18, (__int64)v19, &v47, a2, v41, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_88;
    }
    ...
    LODWORD(v41) = *(_DWORD *)(a2 + 48);
LABEL_87:
    sub_140052F3C(v18, v21, &v47, a2, v41);
    goto LABEL_88;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_88;
...
LABEL_83:
      ...
      LODWORD(v41) = *(_DWORD *)(a2 + 48);
      sub_140052E64(v18, v22, &v47, a2, v41, v36, v23, v26, v3, v39, a2);
    }
  }
LABEL_88:
