/*
 * XREFs of sub_14006B460 @ 0x14006B460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14006B460(__int64 a1, __int64 a2)
{
  __int64 v3; // rsi
  unsigned int v4; // ebx
  _DWORD *v5; // rcx
  ...
  {
    sub_1400680F0((__int64)off_140168120->AttachedDevice, 0x16u, (__int64)&unk_140148948, a1, a2);
  }
  v4 = 0;
  *(_BYTE *)(a2 + 141) = -88;
  *(_QWORD *)(a2 + 56) = 0LL;
...
LABEL_145:
  ...
  {
    LODWORD(v56) = v4;
    sub_1400556F8((__int64)off_140168120->AttachedDevice, 0x17u, (__int64)&unk_140148948, v3, a2, v56);
  }
  return v4;
}
