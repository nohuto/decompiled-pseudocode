/*
 * XREFs of sub_140027C30 @ 0x140027C30
 * Callers:
...
char __fastcall sub_140027C30(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  __int64 v6; // rdx
  __int64 v7; // rdx
  char v8; // r9
...
LABEL_31:
  ...
  if ( a4 )
  {
    v30 = sub_140133B9C(v11, v19);
    *a4 = sub_14006D084(v31, v30);
  }
  return 1;
}
