/*
 * XREFs of sub_1400B4B00 @ 0x1400B4B00
 * Callers:
...
char __fastcall sub_1400B4B00(__int64 a1)
{
  __int64 v1; // r9
  __int64 v2; // r10
  __int64 v3; // rax
  ...
  v5 = *(_DWORD *)(v2 + 112);
  if ( (v5 & 0x200) == 0 && (unsigned int)dword_140168178 > 5 )
  {
    LOBYTE(v5) = sub_14003F840(a1, 0x400000000000LL);
    if ( (_BYTE)v5 )
    {
      ...
      v21 = v9;
      v47 = 4LL;
      LOBYTE(v5) = sub_140037A5C(v14, (unsigned __int8 *)dword_140158E43, v6, v7, 0xDu, &v22);
    }
  }
  return v5;
}
