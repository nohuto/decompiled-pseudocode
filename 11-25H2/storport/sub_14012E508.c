/*
 * XREFs of sub_14012E508 @ 0x14012E508
 * Callers:
...
__int64 __fastcall sub_14012E508(struct _SLIST_ENTRY *a1, __int64 a2)
{
  int v3; // ebx
  __int64 v4; // rdx
  int v6; // r8d
...
LABEL_139:
                        ...
                        sub_140052E64(v33, v37, &v64, a2, *(_DWORD *)(a2 + 48), v50, v38, v41, v3, v53, a2);
                      }
                    }
                    goto LABEL_144;
                  }
        ...
        case 0x1B:
          if ( *(_BYTE *)(v34 + 1) == 7 && !*(_DWORD *)(v34 + 8) )
          {
            if ( (byte_1401694F2 & 0x40) != 0 )
            {
              ...
              if ( v35 )
                v3 = *v35;
              sub_140056AB0(v33, v34, &v64, a2, v3, *(_DWORD *)(a2 + 48));
            }
            goto LABEL_144;
          }
...
LABEL_144:
      ...
      sub_140052F3C(v33, v36, &v64, a2, *(_DWORD *)(a2 + 48));
      goto LABEL_144;
    }
    return (unsigned int)sub_14012EC28(a1, a2);
  }
  if ( v6 == 1 )
  {
    if ( *((_DWORD *)&a1[8].Next[4].Next + 2) != 4 || (v31 = 1, v7 != 1) )
      v31 = 0;
    v9 = 259;
    if ( (unsigned int)sub_14012D668(a1, a2, v31) == 259 )
      return v9;
    return (unsigned int)sub_14012D7AC((__int64)a1, a2, v31);
  }
  v8 = byte_140168DAA == 0;
  v9 = -1073741823;
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v12 )
          v3 = *v12;
        sub_140056AB0(v10, v11, &v64, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_71;
    }
    if ( (byte_1401694F2 & 0x20) == 0 )
    ...
    v13 = &stru_140149FE8;
LABEL_70:
    sub_140052F3C(v10, v13, &v64, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_71;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_71;
...
LABEL_66:
      ...
      sub_140052E64(v10, v14, &v64, a2, *(_DWORD *)(a2 + 48), v27, v15, v18, v3, v30, a2);
    }
  }
LABEL_71:
  IofCompleteRequest((PIRP)a2, 0);
