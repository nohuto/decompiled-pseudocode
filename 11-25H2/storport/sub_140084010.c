/*
 * XREFs of sub_140084010 @ 0x140084010
 * Callers:
...
__int64 __fastcall sub_140084010(__int64 a1, __int64 a2)
{
  int v2; // r12d
  _DWORD *v4; // rcx
  __int64 v5; // rbx
  ...
  if ( *(_BYTE *)v20 != 15 )
  {
    ...
    if ( *(_BYTE *)(v20 + 1) == 7 && !*(_DWORD *)(v20 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(v43) = v2;
        sub_140056AB0(v19, v20, &v58, v5, v43, v44);
      }
      goto LABEL_94;
    }
...
LABEL_93:
    ...
    sub_140052F3C(v19, v22, &v58, v5, v43);
    goto LABEL_94;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_94;
...
LABEL_89:
    ...
    LODWORD(v43) = *(_DWORD *)(v5 + 48);
    sub_140052E64(v19, v23, &v58, v5, v43, v44, v45, v46, v47, v48, v5);
  }
LABEL_94:
