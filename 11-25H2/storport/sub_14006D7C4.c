/*
 * XREFs of sub_14006D7C4 @ 0x14006D7C4
 * Callers:
...
void __fastcall sub_14006D7C4(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r13
  __int64 v6; // rdi
...
LABEL_44:
  ...
  if ( sub_140027C30(v22, a2, 0LL, 0LL) )
  {
    v23 = sub_140133B9C(v7, v16);
    v24 = sub_14006D084(v22, v23);
    v25 = (_QWORD *)(v22 + 3440);
    v26 = v24;
    if ( (v32 & 0x1000000) != 0 )
    {
    ...
    if ( (qword_140168458 & 0x1000) != 0 )
    {
      v31 = 0LL;
      v33 = 0;
      sub_140003B80(v7, (__int64)&v31, (__int64)&v33);
      sub_14000FB90(*(_QWORD *)(v22 + 24), 46, v31, v33, *(unsigned __int8 *)(v30 + *v29), v6, 0LL);
    }
  }
}
