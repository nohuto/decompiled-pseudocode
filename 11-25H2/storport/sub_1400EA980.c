/*
 * XREFs of sub_1400EA980 @ 0x1400EA980
 * Callers:
...
__int64 __fastcall sub_1400EA980(__int64 a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rax
...
LABEL_9:
  ...
  sub_1400A1DE8(*(_QWORD *)(a1 + 592), (__int64)&v38, 0x11u);
  memset_0(v8, 0, v6);
  *((_BYTE *)v8 + 8) &= ~1u;
  v9 = v38;
  v8[1] = 56;
  ...
  if ( *(_BYTE *)v12 != 15 )
  {
    ...
    if ( *(_BYTE *)(v12 + 1) == 7 && !*(_DWORD *)(v12 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        if ( v13 )
          v2 = *v13;
        sub_140056AB0(v11, v12, &v38, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_76;
    }
    ...
    v33 = *(_DWORD *)(a2 + 48);
LABEL_75:
    sub_140052F3C(v11, v14, &v38, a2, v33);
    goto LABEL_76;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_76;
...
LABEL_71:
      ...
      sub_140052E64(v11, v15, &v38, a2, *(_DWORD *)(a2 + 48), v28, v16, v19, v2, v31, a2);
    }
  }
LABEL_76:
