/*
 * XREFs of sub_14007CA18 @ 0x14007CA18
 * Callers:
...
__int64 __fastcall sub_14007CA18(__int64 a1, __int64 a2)
{
  __int64 v2; // r15
  int v3; // edi
  __int64 v4; // rax
  ...
  *(_QWORD *)v52 = 0LL;
  ...
  if ( v2 && *(_DWORD *)(v4 + 16) >= 0x20u && *(_WORD *)v2 == 1 && *(_DWORD *)(v2 + 4) == 32 )
  {
    ...
    v9 = sub_14008D1F0(a1, v60);
    if ( v9 < 0 )
      goto LABEL_18;
    if ( *(_BYTE *)(*(_QWORD *)(a1 + 6064) + 53LL) )
    {
      v9 = sub_14008D024(a1, v52, v60);
      if ( v9 < 0 )
      {
LABEL_18:
      ...
      sub_14008C574(v13, v52[0], v2, (int)v51, v11);
...
LABEL_20:
  ...
  if ( v9 < 0 )
  {
    *(_QWORD *)(a2 + 56) = 0LL;
    if ( v47 )
    {
      sub_1400403EC(*(_QWORD *)(a1 + 16), (__int64)&v57);
  ...
  if ( *(_BYTE *)v18 != 15 )
  {
    ...
    if ( *(_BYTE *)(v18 + 1) == 7 && !*(_DWORD *)(v18 + 8) )
    {
      if ( (byte_1401694F2 & 0x40) != 0 )
      {
        ...
        LODWORD(Dst) = v3;
        sub_140056AB0(v17, v18, &v58, a2, Dst, v41);
      }
      goto LABEL_97;
    }
...
LABEL_96:
    ...
    sub_140052F3C(v17, v20, &v58, a2, Dst);
    goto LABEL_97;
  }
  if ( byte_1401694F1 >= 0 )
    goto LABEL_97;
...
LABEL_92:
    ...
    LOBYTE(v41) = v35;
    LODWORD(Dst) = *(_DWORD *)(a2 + 48);
    sub_140052E64(v17, v21, &v58, a2, Dst, v41, v42, v43, v44, v45, a2);
  }
LABEL_97:
