/*
 * XREFs of sub_1401362F0 @ 0x1401362F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1401362F0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rcx
  __int64 result; // rax
  unsigned int v8; // eax
  ...
  *(_BYTE *)(v4 + *(_QWORD *)a3) = -16;
  ++*(_DWORD *)(a3 + 12);
  result = sub_14013C0F0(a3, 1LL, *(_QWORD *)a4);
  if ( (int)result >= 0 )
  {
    v8 = *(_DWORD *)(a4 + 24);
    ...
    v9 = *(_QWORD *)a4 - 1LL;
    *(_DWORD *)(a4 + 24) = v8;
    result = sub_14013C0F0(a3, 2LL, v8 + v9);
    if ( (int)result >= 0 )
    {
