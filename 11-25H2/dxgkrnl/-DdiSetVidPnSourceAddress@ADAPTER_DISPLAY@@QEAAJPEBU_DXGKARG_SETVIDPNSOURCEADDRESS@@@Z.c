/*
 * XREFs of ?DdiSetVidPnSourceAddress@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEADDRESS@@@Z @ 0x140020838
 * Callers:
 *     ADAPTER_DISPLAY_DdiSetVidPnSourceAddress @ 0x140020820 (ADAPTER_DISPLAY_DdiSetVidPnSourceAddress.c)
 * Callees:
