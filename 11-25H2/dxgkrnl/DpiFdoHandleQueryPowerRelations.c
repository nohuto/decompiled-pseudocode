/*
 * XREFs of DpiFdoHandleQueryPowerRelations @ 0x14023A5C0
 * Callers:
...
LABEL_33:
  ...
  Pool2 = (_DWORD *)ExAllocatePool2(256LL, 8 * v4 + 15, 1953656900LL, v11);
  v14 = Pool2;
  if ( Pool2 )
  {
    if ( v3 && v5 )
