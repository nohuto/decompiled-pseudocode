/*
 * XREFs of ?WriteEdidToRegistry@EDIDCACHE@DxgMonitor@@CAXIPEBEW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x1402697F4
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( !Path[0] )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"InternalMonEdidHandle", 148LL, 0LL, 0LL, 0LL, 0LL);
      v6 = Path[0];
    }
