/*
 * XREFs of ?VmBusSubmitSignalToHwQueueHelper@@YAJPEAVDXGPROCESS@@_NIIPEBI2PEB_KPEAI4PEA_K@Z @ 0x14022A7DC
 * Callers:
...
LABEL_12:
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid HwQueue handle: 0x%I64x", a5[i], 0LL, 0LL, 0LL, 0LL);
  return 3221225485LL;
}
