/*
 * XREFs of ?DxgkSetProcessStatus@@YAXPEAU_D3DKMT_PROCESS_STATUS_INTERNAL@@@Z @ 0x1403B7F40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkSetProcessStatus(struct _D3DKMT_PROCESS_STATUS_INTERNAL *a1)
{
  ...
  if ( !*((_DWORD *)DXGGLOBAL::GetGlobal() + 408)
    || !_InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 407, 1, 1) )
  {
    v2 = *(_QWORD *)a1;
