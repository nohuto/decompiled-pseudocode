/*
 * XREFs of ?SmmAllocateLogicalAddress@@YAJPEAUSYSMM_LOGICAL_ALLOCATOR@@_KPEBXPEAPEAUSYSMM_LOGICAL_BLOCK@@@Z @ 0x140092C44
 * Callers:
 ...
 *     ?SysMmAllocateLogicalMemory@@YAJPEAUSYSMM_ADAPTER@@_KPEBXPEAPEAX@Z @ 0x140386920 (-SysMmAllocateLogicalMemory@@YAJPEAUSYSMM_ADAPTER@@_KPEBXPEAPEAX@Z.c)
 * Callees:
        ...
        struct SYSMM_LOGICAL_BLOCK **a4)
{
  ...
  if ( 4096LL << v14 < a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"BlockSize >= Size", 1299LL, 0LL, 0LL, 0LL, 0LL);
  }
  LOBYTE(v9) = v14;
