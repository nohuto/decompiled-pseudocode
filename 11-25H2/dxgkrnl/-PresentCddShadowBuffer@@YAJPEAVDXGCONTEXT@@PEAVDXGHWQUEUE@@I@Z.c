/*
 * XREFs of ?PresentCddShadowBuffer@@YAJPEAVDXGCONTEXT@@PEAVDXGHWQUEUE@@I@Z @ 0x1403FAC10
 * Callers:
...
__int64 __fastcall PresentCddShadowBuffer(struct DXGCONTEXT *a1, struct DXGHWQUEUE *a2, unsigned int a3)
{
  ...
  *(_QWORD *)&v59.hDevice = a2;
  v56 = a1;
  v4 = *((_DWORD *)DXGGLOBAL::GetGlobal() + 360);
  if ( !v4 )
    return 0LL;
  v6 = *((_QWORD *)v56 + 2);
  v7 = *(_QWORD *)(v6 + 1880);
...
LABEL_16:
  ...
  if ( v4 == 1 )
  {
    ...
    v68[0] = *((unsigned __int8 **)DXGGLOBAL::GetGlobal() + 181);
    if ( v68[0] )
    {
      v67 = 0LL;
      Global = DXGGLOBAL::GetGlobal();
      v24 = (int *)((char *)Global + 1456);
      if ( GetShadowBufferDirtyRect(&v67, *((_DWORD *)Global + 364), *((_DWORD *)Global + 365)) )
      {
        v25 = v24[3];
        if ( v25 == 20 )
        {
