/*
 * XREFs of ?DdiDestroyVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYVIRTUALGPU@@@Z @ 0x14020B4E0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5102);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5102);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_DESTROYVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                           + 88LL))(
