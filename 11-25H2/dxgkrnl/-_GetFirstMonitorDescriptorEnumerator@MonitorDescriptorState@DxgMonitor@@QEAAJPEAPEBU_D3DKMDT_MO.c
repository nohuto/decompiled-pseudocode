/*
 * XREFs of ?_GetFirstMonitorDescriptorEnumerator@MonitorDescriptorState@DxgMonitor@@QEAAJPEAPEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1403ED7D4
 * Callers:
...
LABEL_13:
  ...
  v11 = operator new(0x30uLL, 0x4D677844u, 256LL, v10);
