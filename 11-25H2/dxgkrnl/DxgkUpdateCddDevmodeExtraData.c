/*
 * XREFs of DxgkUpdateCddDevmodeExtraData @ 0x1404058F0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetD3dFormatFromGdiBitsPerPixel@@YA?AW4_D3DDDIFORMAT@@K@Z @ 0x140253BA8 (-GetD3dFormatFromGdiBitsPerPixel@@YA-AW4_D3DDDIFORMAT@@K@Z.c)
