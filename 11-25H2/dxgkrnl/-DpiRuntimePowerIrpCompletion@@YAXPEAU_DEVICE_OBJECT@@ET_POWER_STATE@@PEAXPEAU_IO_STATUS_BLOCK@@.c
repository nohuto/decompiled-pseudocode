/*
 * XREFs of ?DpiRuntimePowerIrpCompletion@@YAXPEAU_DEVICE_OBJECT@@ET_POWER_STATE@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1400436B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  if ( !DeviceExtension || *((_DWORD *)DeviceExtension + 4) != 1953656900 || *((_DWORD *)DeviceExtension + 5) != 3 )
  {
    ...
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)DeviceExtension + 528, &LockHandle);
