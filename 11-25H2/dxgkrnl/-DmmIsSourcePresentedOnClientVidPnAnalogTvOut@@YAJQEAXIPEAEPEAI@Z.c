/*
 * XREFs of ?DmmIsSourcePresentedOnClientVidPnAnalogTvOut@@YAJQEAXIPEAEPEAI@Z @ 0x1402529A4
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( !a4 )
  {
    ...
    result = 3221225485LL;
    WdLogGlobalForLineNumber = 11673;
    return result;
  }
  *a4 = -1;
  if ( !a1 )
  ...
  if ( !v9 )
  {
    ...
    WdLogGlobalForLineNumber = 11701;
...
LABEL_18:
        ...
        else
        {
          ...
          WdLogGlobalForLineNumber = 11792;
        }
      }
      ...
      v23[5] = v13;
      v23[6] = v12;
      WdLogGlobalForLineNumber = 11764;
      if ( v14 )
        ReferenceCounted::Release((ReferenceCounted *)(v14 + 64));
    }
    else
    {
      ...
      WdLogGlobalForLineNumber = 11734;
  ...
  else
  {
    WdLogSingleEntry1(2LL, a1);
    result = 3223192373LL;
    WdLogGlobalForLineNumber = 11715;
  }
  return result;
}
