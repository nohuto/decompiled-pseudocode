/*
 * XREFs of ?_HandleCreatePhysicalMonitor@MONITOR_MGR@@QEAAJIPEAU_DEVICE_OBJECT@@EEPEAU_DXGK_CONNECTION_USB4_INFO@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1403541B0
 * Callers:
 ...
 *     ?_EnterMonitorPendingState@MONITOR_MGR@@QEAAXXZ @ 0x14008FF48 (-_EnterMonitorPendingState@MONITOR_MGR@@QEAAXXZ.c)
