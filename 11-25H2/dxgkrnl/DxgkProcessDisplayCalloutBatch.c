/*
 * XREFs of DxgkProcessDisplayCalloutBatch @ 0x140377270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkProcessDisplayCalloutBatch(__int64 a1)
{
  ...
  started = DXGDISPLAYCALLOUTQUEUE::StartProcessingBatch((struct DXGGLOBAL *)((char *)v5 + 1776), &v18);
  v7 = v18;
  v8 = started;
  if ( !v18 )
    goto LABEL_22;
    ...
    *((_QWORD *)v7 + 9) = 0LL;
    ...
    if ( v11 == 2 )
    {
      ...
      *(_QWORD *)(a1 + 16) = *((_QWORD *)v7 + 3);
      RAPID_HPD_MANAGER::ExtendExistingHPDPeriod((__int64)Global + 305544, 2u, *((_QWORD *)v7 + 3));
LABEL_11:
      v9 = 1;
      goto LABEL_13;
    }
...
LABEL_13:
    ...
    if ( !v12 )
    {
      ...
      DisplayCalloutEntry = DXGDISPLAYCALLOUTQUEUE::GetDisplayCalloutEntry(
                              (struct DXGGLOBAL *)((char *)v14 + 1776),
                              &v18);
      v7 = v18;
      v10 = a1 + 24;
