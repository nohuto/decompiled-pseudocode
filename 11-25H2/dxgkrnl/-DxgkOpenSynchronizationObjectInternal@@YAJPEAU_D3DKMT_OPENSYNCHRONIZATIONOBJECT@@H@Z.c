/*
 * XREFs of ?DxgkOpenSynchronizationObjectInternal@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@H@Z @ 0x14039F7B8
 * Callers:
 *     DxgkOpenSynchronizationObject @ 0x14039F780 (DxgkOpenSynchronizationObject.c)
 *     ?DxgkCddOpenSynchronizationObject@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@@Z @ 0x14039F7A0 (-DxgkCddOpenSynchronizationObject@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@@Z.c)
 * Callees:
  ...
  if ( Current )
  {
    ...
    if ( v14 < 0 )
    {
      if ( v27 )
      {
        ...
        DXGGLOBAL::DestroySyncObject(v16, v27, Src);
      }
    }
    else
    {
