/*
 * XREFs of ?DxgkpProcessBddFallbackRequest@@YAJXZ @ 0x140187524
 * Callers:
...
__int64 DxgkpProcessBddFallbackRequest(void)
{
    ...
    && !g_OSTestSigningEnabled )
  {
    ...
    v22 = -1073741823;
    v12 = 0;
    v1 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 120);
    v20 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 121) == v1;
    ...
    if ( ((dword_14015E3B8 - 10) & 0xFFFFFFF9) == 0 && dword_14015E3B8 != 12 )
    {
      v21 = 2;
      v4 = -1073741637;
LABEL_21:
...
LABEL_10:
      v22 = v0;
      DXGKCALLONEXIT__lambda_52c51082f408f1fc2e7511a6afc05a6d____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT((__int64)v17);
      return v0;
    }
    if ( (unsigned int)DxgIsRemoteSessionUsingWddmMonitors() )
    {
      ...
      v8 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 119);
      if ( !v8 )
      {
        v21 = 2;
LABEL_20:
