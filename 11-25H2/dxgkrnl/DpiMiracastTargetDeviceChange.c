/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x14007FA20
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v12 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          ...
          if ( *(char **)(*(_QWORD *)Context + 8LL) != Context
            ...
            || (*v18 = v17,
                v17[1] = v18,
                v19 = (char **)qword_14015E218,
                *(__int64 **)qword_14015E218 != &qword_14015E210) )
          {
            __fastfail(3u);
          }
          *(_QWORD *)Context = &qword_14015E210;
          *((_QWORD *)Context + 1) = v19;
          *v19 = Context;
          qword_14015E218 = (__int64)Context;
