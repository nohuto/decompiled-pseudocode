/*
 * XREFs of DxgkMapGpuVirtualAddress @ 0x14032FA20
 * Callers:
...
LABEL_5:
  ...
  if ( !v9 )
  {
    ...
    WdLogGlobalForLineNumber = 13081;
...
LABEL_83:
  ...
  if ( (Value & 0x10) != 0 || Value >= 0x20 )
  {
    ...
    WdLogGlobalForLineNumber = 13121;
    DXGPAGINGQUEUEBYHANDLE::~DXGPAGINGQUEUEBYHANDLE((DXGPAGINGQUEUEBYHANDLE *)&v59);
    DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v56);
...
LABEL_90:
  ...
  if ( *(int *)(v14 + 2736) >= 0x2000 || *(_BYTE *)(v14 + 3036) )
    v15 = *((_DWORD *)DXGGLOBAL::GetGlobal() + 332);
  else
    v15 = 0;
  v64 = v15;
...
LABEL_42:
        ...
        {
          v28 = *(_BYTE *)(v13 + 1903) || *(_DWORD *)(v13 + 464) == 2 && *(int *)(v27 + 3004) >= 2000;
          LOBYTE(Timeout) = v28;
      ...
      WdLogGlobalForLineNumber = 13159;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        0xFFFFFFFFLL,
