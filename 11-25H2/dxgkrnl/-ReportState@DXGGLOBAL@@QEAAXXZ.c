/*
 * XREFs of ?ReportState@DXGGLOBAL@@QEAAXXZ @ 0x1403B2AAC
 * Callers:
...
void __fastcall DXGGLOBAL::ReportState(DXGGLOBAL *this)
{
  ...
  for ( j = (DXGGLOBAL *)*((_QWORD *)this + 207); j != (DXGGLOBAL *)((char *)this + 1656); j = *(DXGGLOBAL **)j )
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v23, (DXGGLOBAL *)((char *)this + 672), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v23);
  v9 = (DXGGLOBAL *)*((_QWORD *)this + 96);
LABEL_18:
  while ( v9 != (DXGGLOBAL *)((char *)this + 768) && v9 )
  {
    v10 = v9;
    v9 = *(DXGGLOBAL **)v9;
  ...
  if ( DXGGLOBAL::IsVmConnectedToHost(this) )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000000) != 0 )
      McTemplateK0_EtwWriteTransfer(v15, &EventVGPUGuestStart, v16);
    Global = DXGGLOBAL::GetGlobal();
    DXG_GUEST_GLOBAL_VMBUS::VmBusSendQueryEtwSession(*((DXG_GUEST_GLOBAL_VMBUS **)Global + 206), &v24);
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000000) != 0 )
