/*
 * XREFs of ?ProcessHPDFiltering@VIDPN_MGR@@QEAA?AW4_DMM_HPD_FILTER_RESULT@@PEAU_DXGK_CONNECTION_CHANGE@@AEAU_DMM_HPD_FILTER_INFO@@EPEAU_GUID@@@Z @ 0x1403BFC70
 * Callers:
...
__int64 __fastcall VIDPN_MGR::ProcessHPDFiltering(VIDPN_MGR *a1, __int64 a2, __int64 a3, char a4, __int64 a5)
{
  ...
  *(_QWORD *)(a3 + 32) = v29;
  ...
  v30 = *(unsigned int *)(*((_QWORD *)v12 + 390) + 532LL);
