/*
 * XREFs of _lambda_b98058a49004024dd1650fdaa637bde3_::operator() @ 0x1401A8404
 * Callers:
...
char __fastcall lambda_b98058a49004024dd1650fdaa637bde3_::operator()(__int64 **a1)
{
  __int64 *v1; // rdx
  __int64 *v3; // rax
  int v4; // r9d
  ...
  if ( *(_BYTE *)v10 )
  {
    ...
    {
      LOBYTE(v10) = tlgKeywordOn((__int64)&dword_14015B660, 0x800000000004LL);
      if ( (_BYTE)v10 )
      {
        v11 = *a1;
        v43 = 0;
        ...
        v19 = 2048LL;
        v36 = 2;
        LOBYTE(v10) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B660, byte_1401396D2, 0LL, 0LL, 6u, &v31);
      }
    }
  }
  return (char)v10;
