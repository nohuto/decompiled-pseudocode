/*
 * XREFs of ?LogAdapterStartTelemetry@@YAXPEAU_FDO_CONTEXT@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@JW4START_ADAPTER_FAILURE_REASON@@@Z @ 0x14005CD48
 * Callers:
...
char __fastcall LogAdapterStartTelemetry(__int64 a1, GUID *a2, int a3, int a4)
{
  ...
  result = ++dword_14015E418;
  if ( (unsigned int)dword_14015B628 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_14015B628, 0x800002000000LL);
    if ( result )
    {
