/*
 * XREFs of ?ReleaseDescriptorInfo@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@QEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1403E5AE0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  struct D3DKMDT_HMONITORDESCRIPTORSET__ *v20; // [rsp+28h] [rbp-28h]
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)a1, (__int64)&EventProfilerEnter, a3, 7030);
  }
  else
  {
    v23 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v21, 7030);
  ...
  *(_QWORD *)(v9 + 32) = a2;
  ...
  if ( a2 )
  {
    ...
    if ( a1 )
    {
      ...
      v20 = a1;
      MONITOR_REF_ACCESSOR::AddReference((MONITOR_REF_ACCESSOR *)&v19);
      v10 = (struct _ERESOURCE *)*((_QWORD *)a1 + 27);
      if ( v10 )
        MonitorResourceLock::AcquireExclusive(v10);
      v11 = DxgMonitor::MonitorDescriptorState::_ReleaseMonitorDescriptorEnumerator(
              (DxgMonitor::MonitorDescriptorState *)v10,
              a2);
      if ( v10 )
      {
