/*
 * XREFs of ?AddDisableScanoutToken@CTokenManager@@UEAAJAEAPEAVCDisableScanoutToken@@@Z @ 0x140097DD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CurrentThreadOwnsTokenManagerLock@CTokenManager@@IEBA_NXZ @ 0x1400980A0 (-CurrentThreadOwnsTokenManagerLock@CTokenManager@@IEBA_NXZ.c)
