/*
 * XREFs of ?DdiPrepareLiveMigration@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_PREPARE_LIVE_MIGRATION@@@Z @ 0x14020C914
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiPrepareLiveMigration(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5181);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5181);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_PREPARE_LIVE_MIGRATION *))(*((_QWORD *)this + 2) + 1608LL))(
