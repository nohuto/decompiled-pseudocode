/*
 * XREFs of ?DelayCreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IPEAI1PEAVCOREDEVICEACCESS@@@Z @ 0x140195FE8
 * Callers:
        ...
        struct COREDEVICEACCESS *a6)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 1557LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !DXGADAPTER::UsingDelayCreateCddAllocation(*((DXGADAPTER **)this + 2)) )
    return 3221225659LL;
  v10 = v6;
  v11 = 3984 * v6;
  if ( *(_QWORD *)(*((_QWORD *)this + 16) + 3984 * v6 + 88) )
  {
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(*((PERESOURCE **)this + 2)) )
  {
    if ( !a6 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pCoreAccess != NULL", 1578LL, 0LL, 0LL, 0LL, 0LL);
    }
