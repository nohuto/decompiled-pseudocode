/*
 * XREFs of ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1400984D0
 * Callers:
 *     ?Release@CCompositionFrameCollection@@UEAAJXZ @ 0x140098500 (-Release@CCompositionFrameCollection@@UEAAJXZ.c)
 * Callees:
