/*
 * XREFs of ?VmBusSendCreatePagingQueue@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIPEBU_D3DKMT_CREATEPAGINGQUEUE@@PEAUDXGKVMB_COMMAND_CREATEPAGINGQUEUE_RETURN@@@Z @ 0x14022315C
 * Callers:
  ...
  if ( (_QWORD)v16 )
  {
    ...
    *(_QWORD *)(v10 + 16) = 9LL;
    ...
    if ( v13 < 0 || (v13 = -1073741823, v15[0] < 0x18) || !*((_DWORD *)a5 + 1) )
    {
      ...
      WdLogGlobalForLineNumber = 9643;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        0xFFFFFFFFLL,
        L"VmBusSendCreatePagingQueue failed: 0x%I64x",
        v13,
        0LL,
        0LL,
        0LL,
