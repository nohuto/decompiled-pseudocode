/*
 * XREFs of ?DmmIsWaitingForPowerOn@@YAJPEAXIAEAE@Z @ 0x14035608C
 * Callers:
 ...
 *     ?GetMostImportantPathFromSource@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@I@Z @ 0x1403561EC (-GetMostImportantPathFromSource@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@I@Z.c)
  ...
  *a3 = 0;
  if ( a1 )
  {
    if ( !a1[390] )
    {
      ...
      WdLogGlobalForLineNumber = 15199;
    }
    if ( !a1[391] )
      return 0LL;
    v6 = a1[390];
    ...
    WdLogGlobalForLineNumber = 15217;
  }
  else
  {
    WdLogSingleEntry1(2LL, 0LL);
    WdLogGlobalForLineNumber = 15191;
  }
  return 3221225473LL;
}
