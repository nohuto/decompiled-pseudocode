/*
 * XREFs of ?DxgkpGetDodPrimaryInfo@@YAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@PEAU_D3DKMT_KMDOD_ESCAPE@@@Z @ 0x140306208
 * Callers:
...
void __fastcall DxgkpGetDodPrimaryInfo(struct DXGDEVICE *a1, struct DXGALLOCATION *a2, struct _D3DKMT_KMDOD_ESCAPE *a3)
{
  ...
  *(_QWORD *)&v8.Flags.0 = 0LL;
  memset(&v8.PrivateDriverDataSize + 1, 0, 20);
  memset(a3, 0, 0x50uLL);
  *(_DWORD *)a3 = -791674879;
  *((_QWORD *)a3 + 1) = *(_QWORD *)(*((_QWORD *)a2 + 6) + 16LL);
  v6 = *((_QWORD *)a1 + 2);
  v8.hDevice = (HANDLE)*((_QWORD *)a1 + 77);
