/*
 * XREFs of ?Release@OUTPUTDUPL_SESSION_MGR@@QEAAXPEAU_EPROCESS@@PEAU_D3DKMT_OUTPUTDUPL_ACTIVE_CTX@@@Z @ 0x1401E1344
 * Callers:
        ...
        struct _D3DKMT_OUTPUTDUPL_ACTIVE_CTX *a3)
{
  ...
  if ( a3 )
  {
    ...
    WdLogGlobalForLineNumber = 4354;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"bFound", 4354LL, 0LL, 0LL, 0LL, 0LL);
  }
LABEL_18:
