/*
 * XREFs of ?DdiCreateMemoryBasis@ADAPTER_RENDER@@QEAAPEAXPEAU_DXGKARG_CREATEMEMORYBASIS@@@Z @ 0x1401A06A8
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateMemoryBasis(
        ADAPTER_RENDER *this,
        struct _DXGKARG_CREATEMEMORYBASIS *a2,
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5176);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5176);
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CREATEMEMORYBASIS *))(*((_QWORD *)this + 2) + 1568LL))(
