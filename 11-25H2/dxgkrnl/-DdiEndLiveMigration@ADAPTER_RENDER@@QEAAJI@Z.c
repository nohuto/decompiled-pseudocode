/*
 * XREFs of ?DdiEndLiveMigration@ADAPTER_RENDER@@QEAAJI@Z @ 0x1403DC334
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiEndLiveMigration(ADAPTER_RENDER *this, unsigned int a2, __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5182);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5182);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)this + 2) + 1632LL))(
