/*
 * XREFs of ?ValidateSubRect@@YAEPEBUtagRECT@@0@Z @ 0x1402187B4
 * Callers:
...
unsigned __int8 __fastcall ValidateSubRect(const struct tagRECT *a1, const struct tagRECT *a2)
{
  ...
  if ( ValidateRect(a1) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid bounding rect", 2369LL, 0LL, 0LL, 0LL, 0LL);
  }
  return 0;
}
