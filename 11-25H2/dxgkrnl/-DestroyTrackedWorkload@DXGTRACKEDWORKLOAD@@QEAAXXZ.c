/*
 * XREFs of ?DestroyTrackedWorkload@DXGTRACKEDWORKLOAD@@QEAAXXZ @ 0x1401FC7D4
 * Callers:
  ...
  if ( *((_BYTE *)this + 116) )
  {
    ...
    *((_BYTE *)this + 116) = 0;
    if ( v4 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"0 == m_cReference", 1347LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( *((_QWORD *)this + 142) )
    {
