/*
 * XREFs of ?VmBusSendCreateContextVirtual@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAIIIIIU_D3DDDI_CREATECONTEXTFLAGS@@W4_D3DKMT_CLIENTHINT@@IPEAX@Z @ 0x14022292C
 * Callers:
    ...
    *(_OWORD *)v17 = 0LL;
    ...
    if ( v17[0] )
    {
      ...
      *(_QWORD *)&v14[4].0 = 6LL;
      ...
      Value = 0;
      if ( (int)DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSyncMessage(this, (struct DXGVMBUSMESSAGE *)v17, v14, v16) >= 0
        && v16[0] >= ((Size + 62) & 0xFFFFFFF8) )
      {
