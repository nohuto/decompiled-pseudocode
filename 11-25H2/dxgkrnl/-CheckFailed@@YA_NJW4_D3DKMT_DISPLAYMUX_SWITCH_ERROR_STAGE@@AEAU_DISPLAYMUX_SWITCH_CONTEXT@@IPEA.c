/*
 * XREFs of ?CheckFailed@@YA_NJW4_D3DKMT_DISPLAYMUX_SWITCH_ERROR_STAGE@@AEAU_DISPLAYMUX_SWITCH_CONTEXT@@IPEAD@Z @ 0x1400828A8
 * Callers:
...
char __fastcall CheckFailed(int a1, int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( a1 >= 0 )
  {
    ...
    if ( *(_DWORD *)(a3 + 52) && dword_14015E428 != (_DWORD)v5 )
    {
      v23 = 0LL;
      v18 = 6;
      v20 = 0LL;
