/*
 * XREFs of ?OpenEventForSynchonize@CTokenManager@@CAJPEAXPEAPEAX_N@Z @ 0x14009835C
 * Callers:
 *     ?OpenSectionAndEvents@CTokenManager@@UEAAJPEAPEAXPEA_K00@Z @ 0x1400572A0 (-OpenSectionAndEvents@CTokenManager@@UEAAJPEAPEAXPEA_K00@Z.c)
