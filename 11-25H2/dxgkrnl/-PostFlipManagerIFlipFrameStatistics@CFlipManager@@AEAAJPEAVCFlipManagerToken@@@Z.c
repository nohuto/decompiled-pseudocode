/*
 * XREFs of ?PostFlipManagerIFlipFrameStatistics@CFlipManager@@AEAAJPEAVCFlipManagerToken@@@Z @ 0x140008B50
 * Callers:
...
__int64 __fastcall CFlipManager::PostFlipManagerIFlipFrameStatistics(CFlipManager *this, struct CFlipManagerToken *a2)
{
  ...
  CFlipPropertySetBase *v10; // [rsp+28h] [rbp-41h]
  ...
  if ( v6 )
  {
    ...
    v22 = 56;
    v3 = CreateFlipPropertySetWorker<CFlipConsumerMessage>(2u, &Src);
    if ( v3 >= 0 )
    {
