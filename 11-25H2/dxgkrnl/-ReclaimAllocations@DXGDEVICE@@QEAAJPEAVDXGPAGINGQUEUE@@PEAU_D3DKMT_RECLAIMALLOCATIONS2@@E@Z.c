/*
 * XREFs of ?ReclaimAllocations@DXGDEVICE@@QEAAJPEAVDXGPAGINGQUEUE@@PEAU_D3DKMT_RECLAIMALLOCATIONS2@@E@Z @ 0x140296D80
 * Callers:
    ...
    if ( a3->pDiscarded )
    {
      for ( i = 0; ; ++i )
      {
        ...
        if ( i >= a3->NumAllocations )
          break;
        v49 = &a3->pDiscarded[i];
        if ( (_BYTE)a4 && (unsigned __int64)v49 >= MmUserProbeAddress )
