/*
 * XREFs of ?VmBusSignalSyncObject@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140427170
 * Callers:
 *     <none>
 * Callees:
...
LABEL_63:
      ...
      if ( (v5[7] & 2) != 0 )
      {
        ...
        Pool2 = ExAllocatePool2(64LL, 40LL, 1265072196LL, 0xFFFFLL);
      ...
      if ( v8 )
      {
        if ( v16 )
        {
          v34 = v5[12];
          v35 = v5[7];
          v36 = (struct DXGPROCESS *)*((_QWORD *)a1 + 11);
