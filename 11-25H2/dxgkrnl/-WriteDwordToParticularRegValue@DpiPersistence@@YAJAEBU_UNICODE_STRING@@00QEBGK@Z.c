/*
 * XREFs of ?WriteDwordToParticularRegValue@DpiPersistence@@YAJAEBU_UNICODE_STRING@@00QEBGK@Z @ 0x140366B20
 * Callers:
...
LABEL_16:
  ...
  if ( !KeyHandle )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"HKeyRootHandle", 598LL, 0LL, 0LL, 0LL, 0LL);
    v10 = KeyHandle;
  }
  ...
  *(_OWORD *)&v19.SecurityDescriptor = 0LL;
  ...
  if ( !v16 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"PerMonSettingsKeyHandle", 613LL, 0LL, 0LL, 0LL, 0LL);
    v12 = v16;
  }
  if ( a3->Length )
  {
    ...
    if ( !Path )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"MonitorIdKeyHandle", 630LL, 0LL, 0LL, 0LL, 0LL);
      v12 = (void *)Path;
    }
  }
