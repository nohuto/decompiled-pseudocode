/*
 * XREFs of DxgkpAddTriageAdapterData @ 0x140061F04
 * Callers:
 *     DxgDbgTriageDumpCallback @ 0x140079C20 (DxgDbgTriageDumpCallback.c)
 * Callees:
 *     ?GetGlobal@DXGGLOBAL@@SAPEAV1@XZ @ 0x140018F10 (-GetGlobal@DXGGLOBAL@@SAPEAV1@XZ.c)
 *     DpiAddTriageAdapterData @ 0x14006234C (DpiAddTriageAdapterData.c)
 */
...
char __fastcall DxgkpAddTriageAdapterData(__int64 a1, __int64 a2, __int64 a3, SIZE_T a4)
{
  ...
  if ( Global )
  {
    ...
    if ( (_BYTE)Global )
    {
      v10 = KeAddTriageDumpDataBlock(v4, (ULONG)v8, (PVOID)0x4AAC0, v9);
      if ( v10 < 0 )
      {
        WdLogSingleEntry3(3LL, v8, 305856LL, v10);
        WdLogGlobalForLineNumber = 3274;
      }
      v11 = 4;
      Global = DXGGLOBAL::GetGlobal();
      ...
      for ( i = (_QWORD *)*((_QWORD *)Global + 96); i != v12 && i; i = (_QWORD *)*i )
      {
        ...
        if ( !(_BYTE)Global )
          return (char)Global;
        v15 = KeAddTriageDumpDataBlock(v4, (ULONG)i, (PVOID)0x13F0, v14);
        if ( v15 < 0 )
        {
          WdLogSingleEntry3(3LL, i, 5104LL, v15);
          WdLogGlobalForLineNumber = 3274;
        }
          ...
          && ((unsigned __int8)Global & 0x20) == 0 )
        {
          ...
          if ( v17 )
          {
            LODWORD(Global) = KeAddTriageDumpDataBlock(v4, i[391], (PVOID)0x780, v16);
            if ( (int)Global < 0 )
            {
          ...
          if ( v18 )
          {
            LODWORD(Global) = KeAddTriageDumpDataBlock(v4, i[390], (PVOID)0x408, v16);
            if ( (int)Global < 0 )
            {
              LOBYTE(Global) = WdLogSingleEntry3(3LL, v18, 1032LL, (int)Global);
              WdLogGlobalForLineNumber = 3274;
            }
          }
          v19 = i[27];
            ...
            if ( v25 )
            {
              ...
              if ( (_BYTE)Global )
              {
                ...
                if ( v27 )
                {
                  ...
                  if ( (_BYTE)Global )
                  {
                    LODWORD(Global) = KeAddTriageDumpDataBlock(KtriageDumpDataArray, (ULONG)v27, (PVOID)0x13F0, v28);
                    if ( (int)Global < 0 )
                    {
                      LOBYTE(Global) = WdLogSingleEntry3(3LL, v27, 5104LL, (int)Global);
                      WdLogGlobalForLineNumber = 3274;
                    }
                    v30 = v27[89];
                    if ( v30 )
