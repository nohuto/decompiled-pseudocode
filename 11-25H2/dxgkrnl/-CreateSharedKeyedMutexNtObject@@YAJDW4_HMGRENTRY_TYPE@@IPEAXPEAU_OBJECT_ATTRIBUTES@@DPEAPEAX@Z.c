/*
 * XREFs of ?CreateSharedKeyedMutexNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1401DB56C
 * Callers:
...
LABEL_10:
  ...
  if ( Object )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pObject == NULL", 298LL, 0LL, 0LL, 0LL, 0LL);
  }
