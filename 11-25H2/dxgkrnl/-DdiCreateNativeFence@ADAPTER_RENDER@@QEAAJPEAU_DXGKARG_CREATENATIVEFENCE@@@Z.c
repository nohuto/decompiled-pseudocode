/*
 * XREFs of ?DdiCreateNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATENATIVEFENCE@@@Z @ 0x1401A089C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateNativeFence(
        ADAPTER_RENDER *this,
        struct _DXGKARG_CREATENATIVEFENCE *a2,
        __int64 a3)
{
  ...
  int v9; // ebp
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(_QWORD, struct _DXGKARG_CREATENATIVEFENCE *); // rax
  int v12; // edi
  KIRQL v13; // al
  __int64 v14; // rcx
  __int64 v15; // rcx
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5168);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5168);
  ...
  v10 = *((_QWORD *)this + 2);
  v11 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CREATENATIVEFENCE *))(v10 + 1496);
  if ( v11 )
