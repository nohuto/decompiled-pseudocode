/*
 * XREFs of DpiFdoHandleDisplayDetectControl @ 0x1400272AC
 * Callers:
 *     DpiDxgkDdiDisplayDetectControl @ 0x140375ABC (DpiDxgkDdiDisplayDetectControl.c)
 * Callees:
 *     DpiFdoQueueConnectionChangePackage @ 0x1400277C0 (DpiFdoQueueConnectionChangePackage.c)
...
LABEL_31:
  ...
  if ( ((v5 - 0x1000000) & 0xFEFFFFFF) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 18673;
    return (unsigned int)v7;
  }
  v25 = 0;
  v9 = 0;
  if ( v5 != 0x2000000 )
  {
    ...
    if ( IsChildConnected < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 18538;
      goto LABEL_25;
    }
      ...
      && (int)DpiAcquireCoreSyncAccessSafe(*(_QWORD *)(a1 + 24), 0LL) >= 0 )
    {
      ...
      if ( v21 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 18559;
      }
    ...
    WdLogGlobalForLineNumber = 18607;
LABEL_25:
  ...
  while ( 1 )
  {
    ...
    if ( v14 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 18449;
      goto LABEL_23;
    }
    if ( v14 == 1075708988 || v14 == 1075708975 )
    {
      if ( (int)DpiAcquireCoreSyncAccessSafe(*(_QWORD *)(a1 + 24), 0LL) >= 0 )
      {
        ...
        if ( v15 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 18470;
        }
        DpiReleaseCoreSyncAccessSafe(*(_QWORD *)(a1 + 24), 0LL);
        v12 = v23;
      }
...
LABEL_40:
        WdLogSingleEntry1(2LL, v7);
        WdLogGlobalForLineNumber = 18517;
LABEL_23:
        v9 = v25;
        break;
      }
...
LABEL_36:
  ...
  if ( ConnectionChanges < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 18643;
    goto LABEL_25;
  }
  return (unsigned int)v7;
}
