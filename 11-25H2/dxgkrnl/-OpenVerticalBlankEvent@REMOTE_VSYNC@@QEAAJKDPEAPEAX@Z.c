/*
 * XREFs of ?OpenVerticalBlankEvent@REMOTE_VSYNC@@QEAAJKDPEAPEAX@Z @ 0x1401EE170
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( result >= 0 )
  {
    if ( !this[2] )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_pVSyncEvent", 164LL, 0LL, 0LL, 0LL, 0LL);
    }
