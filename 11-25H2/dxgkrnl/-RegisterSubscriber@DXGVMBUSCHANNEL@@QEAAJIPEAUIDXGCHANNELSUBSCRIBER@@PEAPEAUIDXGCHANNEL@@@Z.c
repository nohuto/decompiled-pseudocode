/*
 * XREFs of ?RegisterSubscriber@DXGVMBUSCHANNEL@@QEAAJIPEAUIDXGCHANNELSUBSCRIBER@@PEAPEAUIDXGCHANNEL@@@Z @ 0x140205AF4
 * Callers:
        ...
        struct IDXGCHANNEL **a4)
{
  ...
  if ( (unsigned int)DXGVMBUSCHANNEL::ProxyFromSubscriberTag(this, a2, &v17) == -1073741275 )
  {
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"b", 498LL, 0LL, 0LL, 0LL, 0LL);
LABEL_8:
      v13 = v17;
      if ( v17 )
        v6 = (char *)v17 + 16;
