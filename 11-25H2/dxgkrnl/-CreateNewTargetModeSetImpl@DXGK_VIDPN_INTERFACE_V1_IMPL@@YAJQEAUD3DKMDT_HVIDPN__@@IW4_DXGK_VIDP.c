/*
 * XREFs of ?CreateNewTargetModeSetImpl@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IW4_DXGK_VIDPN_INTERFACE_VERSION@@PEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1403AD5E4
 * Callers:
 *     ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V2_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1403AD590 (-CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V2_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_H.c)
 *     ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1403AD5C0 (-CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_H.c)
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a5)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v36, 7050);
      ...
      *v14 = 0LL;
      ...
      if ( v15 )
      {
        ...
        if ( TargetFromId )
        {
          v39 = 0LL;
          a5 = 0LL;
          NewCofuncModeSet = DMMVIDPNTARGET::CreateNewCofuncModeSet(
                               TargetFromId,
                               (struct DMMVIDPNTARGETMODESET **)&a5,
                               v20,
                               v21);
          v24 = NewCofuncModeSet;
          if ( NewCofuncModeSet < 0 )
          {
            WdLogSingleEntry2(7LL, *((unsigned int *)v22 + 6), NewCofuncModeSet);
          ...
          else
          {
            ...
            *v14 = v18;
            ...
            {
              if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
                McTemplateK0q_EtwWriteTransfer(v25, (__int64)&EventProfilerExit, v26, v36);
            }
            return 0LL;
          }
        }
        else
        {
          ...
          DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v36);
          if ( v38 && (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
            McTemplateK0q_EtwWriteTransfer(v28, (__int64)&EventProfilerExit, v29, v36);
          return 3223192325LL;
        }
      }
      else
