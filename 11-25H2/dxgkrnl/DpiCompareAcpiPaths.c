/*
 * XREFs of DpiCompareAcpiPaths @ 0x14008AC9C
 * Callers:
...
bool __fastcall DpiCompareAcpiPaths(UNICODE_STRING *a1, UNICODE_STRING *a2)
{
  ...
  UNICODE_STRING String2; // [rsp+30h] [rbp-79h] BYREF
  _QWORD v23[6]; // [rsp+40h] [rbp-69h] BYREF
  _WORD v24[4]; // [rsp+70h] [rbp-39h] BYREF
  _QWORD Buf2[9]; // [rsp+78h] [rbp-31h]
