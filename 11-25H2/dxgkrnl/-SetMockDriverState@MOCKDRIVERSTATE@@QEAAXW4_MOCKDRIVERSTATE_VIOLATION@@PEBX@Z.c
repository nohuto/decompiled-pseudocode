/*
 * XREFs of ?SetMockDriverState@MOCKDRIVERSTATE@@QEAAXW4_MOCKDRIVERSTATE_VIOLATION@@PEBX@Z @ 0x140075D50
 * Callers:
 *     DXGADAPTER_SetMockDriverState @ 0x14006C280 (DXGADAPTER_SetMockDriverState.c)
 * Callees:
...
void __fastcall MOCKDRIVERSTATE::SetMockDriverState(__int64 *a1, int a2, unsigned int *a3)
{
  ...
  if ( *((_BYTE *)a1 + 32) )
  {
    if ( a2 )
    {
      ...
      {
        v5 = a1[2];
        if ( !*(_BYTE *)(v5 + 8) && *(_DWORD *)(a1[3] + 2944) > 1u )
        {
          v6 = *a3;
