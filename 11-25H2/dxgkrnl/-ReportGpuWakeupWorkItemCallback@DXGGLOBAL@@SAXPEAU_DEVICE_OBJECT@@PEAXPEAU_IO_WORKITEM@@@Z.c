/*
 * XREFs of ?ReportGpuWakeupWorkItemCallback@DXGGLOBAL@@SAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1403F46E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_WORKITEM IoWorkItem)
{
  ...
  if ( Context )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"Context == NULL", 454LL, 0LL, 0LL, 0LL, 0LL);
  }
