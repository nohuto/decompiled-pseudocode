/*
 * XREFs of ?_EvaluateUsageState@MonitorUsageState@DxgMonitor@@AEAA_NPEBUIMonitorDescriptor@2@@Z @ 0x140351BD4
 * Callers:
        ...
        const struct DxgMonitor::IMonitorDescriptor *a2)
{
  ...
  v4 = 0;
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal() + 304801) && !*((_DWORD *)this + 4) )
  {
    v10[0] = 0;
    v11 = 1;
    v9 = 0;
