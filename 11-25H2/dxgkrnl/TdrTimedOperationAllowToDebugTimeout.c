/*
 * XREFs of TdrTimedOperationAllowToDebugTimeout @ 0x1400716F0
 * Callers:
 ...
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x1400716B0 (-TdrValidateDebugMode@@YAXXZ.c)
 */
...
__int64 __fastcall TdrTimedOperationAllowToDebugTimeout(struct _DXGK_TIMED_OPERATION *a1)
{
  ...
  if ( (byte_14015DA14 || (unsigned __int8)WdQueryDebugFlag(0LL)) && !g_TdrDebugMode )
  {
    if ( v7 )
