/*
 * XREFs of ?PrepareStagingBuffer@BLTQUEUE@@QEAAJPEAVDXGDEVICE@@IPEAVCOREDEVICEACCESS@@@Z @ 0x1403FFC9C
 * Callers:
...
LABEL_53:
    ...
    if ( *((_DWORD *)this + 710) )
    {
      if ( v49.Width != *((_DWORD *)this + 712) || v49.Height != *((_DWORD *)this + 713) )
    ...
    if ( (int)v8 < 0 )
      goto LABEL_53;
    *((_DWORD *)this + 708) = HIDWORD(v52[6]);
    *((_DWORD *)this + 710) = v52[1];
    ...
    *((_DWORD *)this + 709) = *((_DWORD *)v36 + 5);
    ...
    if ( Resident >= 0 )
    {
      ...
      if ( (int)v8 < 0 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"VmBusSendLock2 failed", 4859LL, 0LL, 0LL, 0LL, 0LL);
      }
      *((_QWORD *)this + 357) = v50.pData;
      if ( (int)v8 >= 0 )
      {
        v39 = v54;
        if ( !v54 )
        ...
        *((_DWORD *)this + 711) = v39;
        Height = v49.Height;
        *((_DWORD *)this + 713) = v49.Height;
        *((_DWORD *)this + 725) = Height;
        *((_DWORD *)this + 712) = Width;
        *((_DWORD *)this + 724) = Width;
      }
    }
    else
    {
