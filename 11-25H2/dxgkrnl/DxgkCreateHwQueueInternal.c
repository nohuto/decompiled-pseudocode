/*
 * XREFs of DxgkCreateHwQueueInternal @ 0x140321C88
 * Callers:
 ...
 *     DxgkCreateHwQueue @ 0x140321C70 (DxgkCreateHwQueue.c)
 * Callees:
...
__int64 __fastcall DxgkCreateHwQueueInternal(__int64 a1, char a2, __int64 a3)
{
  ...
  UINT *p_PrivateDriverDataSize; // rax
  __int64 v10; // rax
...
LABEL_9:
  ...
  v10 = PagedPoolZeroedArray<unsigned char,16>::AllocateElements(&P);
  ...
  if ( v10 )
  {
    ...
    v43 = P;
LABEL_34:
    Current = DXGPROCESS::GetCurrent(pPrivateDriverData);
    if ( !Current )
    {
