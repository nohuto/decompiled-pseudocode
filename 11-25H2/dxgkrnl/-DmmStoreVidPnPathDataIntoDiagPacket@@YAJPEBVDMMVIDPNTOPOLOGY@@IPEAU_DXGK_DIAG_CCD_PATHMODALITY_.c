/*
 * XREFs of ?DmmStoreVidPnPathDataIntoDiagPacket@@YAJPEBVDMMVIDPNTOPOLOGY@@IPEAU_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR2@@@Z @ 0x14025371C
 * Callers:
        ...
        struct _DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR2 *a3)
{
  ...
  const struct DMMVIDPNPRESENTPATH *i; // rdi
  int v17; // ecx
  char *v18; // rax
  ...
  if ( v9 <= a2 )
  {
    ...
    if ( v14 != v13 )
    {
      for ( i = (const struct DMMVIDPNPRESENTPATH *)(v14 - 8); i; ++v15 )
      {
        if ( v15 >= a2 )
          break;
        ...
        *(_QWORD *)a3 |= 0x100000000000uLL;
        FillOnePathModalityFromVidPn(i, a3);
        v18 = (char *)*((_QWORD *)i + 1);
        i = (const struct DMMVIDPNPRESENTPATH *)(v18 - 8);
        if ( v18 == v13 )
          i = 0LL;
