/*
 * XREFs of ?VmBusSendAsyncPacket@@YAJPEAUVMBPACKET__@@PEAUDXGKVMB_COMMAND_BASE@@I@Z @ 0x140021FC4
 * Callers:
...
__int64 __fastcall VmBusSendAsyncPacket(struct VMBPACKET__ *a1, struct DXGKVMB_COMMAND_BASE *a2, __int64 a3)
{
  ...
  if ( v3 - 24 <= 0x1FFE7 )
  {
    v7 = _InterlockedIncrement64(&qword_14015DC70);
    v8 = bTracingEnabled == 0;
    *(_QWORD *)a2 = v7;
    if ( v8 )
    {
LABEL_5:
      v9 = ((__int64 (__fastcall *)(struct VMBPACKET__ *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, int))qword_14015D450)(
             a1,
             a2,
             v3,
             0LL,
