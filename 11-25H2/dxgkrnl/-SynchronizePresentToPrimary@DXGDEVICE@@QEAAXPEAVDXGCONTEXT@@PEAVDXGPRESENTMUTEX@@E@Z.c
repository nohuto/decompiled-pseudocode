/*
 * XREFs of ?SynchronizePresentToPrimary@DXGDEVICE@@QEAAXPEAVDXGCONTEXT@@PEAVDXGPRESENTMUTEX@@E@Z @ 0x14038A500
 * Callers:
...
LABEL_15:
        DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v18, v17, (__int64)a2, 0LL, 0LL, 0LL);
        goto LABEL_22;
      }
      *(_QWORD *)(v4 + 912) = v8;
    }
