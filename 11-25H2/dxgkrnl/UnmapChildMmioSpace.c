/*
 * XREFs of UnmapChildMmioSpace @ 0x1403E6110
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  v10 = 0LL;
LABEL_8:
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)&ApcState, (struct _KTHREAD **)(v10 + 16), 0);
  DXGAUTOPUSHLOCK::AcquireShared((DXGAUTOPUSHLOCK *)&ApcState);
  ((void (__fastcall *)(_QWORD, __int64))qword_14015D600)(*(_QWORD *)v10, a3);
