/*
 * XREFs of DxgkQueryModeListCacheLuid @ 0x1403FCE80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( (int)PairingAdapters >= 0 )
  {
    ...
    if ( !v17 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 8737LL, 0LL, 0LL, 0LL, 0LL);
    }
