/*
 * XREFs of ?DxgkCddOpenResourceFromNtHandle@@YAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1403BCA40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a6)
{
  ...
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v32, hDevice, Current, &v37);
  v15 = v37;
  if ( !v37 )
  {
    v12 = -1073741811;
