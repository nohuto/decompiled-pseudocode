/*
 * XREFs of ?LogCddDatabaseAccessPacket@@YAXHJPEAUD3DKMT_GETPATHSMODALITY@@PEAU_STRING@@I@Z @ 0x1403ECF58
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v10 = operator new[](v9, 0x63644356u, 256LL, (__int64)a4);
  v11 = 0;
  v12 = v10;
  if ( v10 )
  {
    ...
    *(_DWORD *)(v10 + 60) = *((unsigned __int16 *)a3 + 10);
    ...
    v14 = v12 + 160 * (unsigned __int16)v10 + 72;
    memmove((void *)(v12 + 160LL * (unsigned __int16)v10 + 72), a4->Buffer, a4->Length);
