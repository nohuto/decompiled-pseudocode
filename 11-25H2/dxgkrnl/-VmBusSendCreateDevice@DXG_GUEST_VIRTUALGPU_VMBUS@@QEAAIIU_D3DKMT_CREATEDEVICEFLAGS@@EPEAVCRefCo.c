/*
 * XREFs of ?VmBusSendCreateDevice@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAIIU_D3DKMT_CREATEDEVICEFLAGS@@EPEAVCRefCountedBuffer@@@Z @ 0x140222B58
 * Callers:
        ...
        struct CRefCountedBuffer *Entry)
{
  ...
  if ( (_QWORD)v14 )
  {
    ...
    *(_QWORD *)(v11 + 32) = Entry;
    ...
    v12 = 0;
    if ( (int)DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSyncMessage(this, (struct DXGVMBUSMESSAGE *)&v14, &v16, v13) < 0
      || (v12 = v16) == 0 )
    {
