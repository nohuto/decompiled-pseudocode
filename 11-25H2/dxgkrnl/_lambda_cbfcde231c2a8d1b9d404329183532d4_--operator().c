/*
 * XREFs of _lambda_cbfcde231c2a8d1b9d404329183532d4_::operator() @ 0x1401BB3A4
 * Callers:
 *     _lambda_cbfcde231c2a8d1b9d404329183532d4_::_lambda_invoker_cdecl_ @ 0x1401BAB50 (_lambda_cbfcde231c2a8d1b9d404329183532d4_--_lambda_invoker_cdecl_.c)
 * Callees:
...
__int64 __fastcall lambda_cbfcde231c2a8d1b9d404329183532d4_::operator()(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  DXGADAPTERSTOPRESETLOCKSHARED::DXGADAPTERSTOPRESETLOCKSHARED(
    ...
    1);
  if ( (*(_DWORD *)(a2 + 444) & 0x100) != 0 && !*(_BYTE *)(a2 + 3017) && *(_DWORD *)(a2 + 200) == 1 )
  {
    LODWORD(v13) = 0;
