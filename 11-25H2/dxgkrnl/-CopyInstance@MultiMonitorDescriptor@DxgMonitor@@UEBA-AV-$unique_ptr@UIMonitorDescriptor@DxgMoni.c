/*
 * XREFs of ?CopyInstance@MultiMonitorDescriptor@DxgMonitor@@UEBA?AV?$unique_ptr@UIMonitorDescriptor@DxgMonitor@@U?$default_delete@UIMonitorDescriptor@DxgMonitor@@@wistd@@@wistd@@XZ @ 0x140090920
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall DxgMonitor::MultiMonitorDescriptor::CopyInstance(__int64 a1, __int64 *a2, __int64 a3, __int64 a4)
{
  char v4; // bl
  _QWORD *v7; // rsi
  _QWORD *v8; // rbx
  ...
  if ( v7 )
  {
    v8 = (_QWORD *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 16) + 16LL))(
                     *(_QWORD *)(a1 + 16),
                     &v13);
    v9 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 8) + 16LL))(
                      *(_QWORD *)(a1 + 8),
                      &v12);
