/*
 * XREFs of Feature_FullscreenStats__private_IsEnabledDeviceUsageNoInline @ 0x14009AF4C
 * Callers:
 ...
 * Callees:
 *     Feature_FullscreenStats__private_IsEnabledFallback @ 0x14009AF84 (Feature_FullscreenStats__private_IsEnabledFallback.c)
 */
