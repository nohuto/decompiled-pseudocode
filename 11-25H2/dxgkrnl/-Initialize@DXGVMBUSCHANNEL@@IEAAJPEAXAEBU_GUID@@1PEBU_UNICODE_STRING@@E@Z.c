/*
 * XREFs of ?Initialize@DXGVMBUSCHANNEL@@IEAAJPEAXAEBU_GUID@@1PEBU_UNICODE_STRING@@E@Z @ 0x140204E14
 * Callers:
        ...
        unsigned __int8 a6)
{
  ...
  *((_BYTE *)this + 27) = !v7;
  if ( v7 )
  {
    v10 = (struct _KEVENT *)operator new(0x18uLL, 0x4B677844u, 64LL, (__int64)a4);
    *((_QWORD *)this + 4) = v10;
    if ( !v10 )
    {
...
LABEL_8:
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v15, v14, (__int64)this, 0LL, 0LL, 0LL);
      goto LABEL_30;
    }
  }
  else
  ...
  LOBYTE(v12) = a6;
  v18 = ((__int64 (__fastcall *)(struct _DRIVER_OBJECT *, __int64, char *))qword_14015D330)(
  ...
  LOBYTE(v19) = 1;
  ((void (__fastcall *)(_QWORD, __int64))qword_14015D3E8)(*v17, v19);
  v20 = *v17;
  if ( a6 )
  {
    v35 = DxgkVailVmBusChannel;
    v36 = DxgkVailVmBusChannelType;
    v21 = ((__int64 (__fastcall *)(__int64, __int128 *, __int128 *))qword_14015D5A8)(v20, &v36, &v35);
    v13 = v21;
    if ( v21 < 0 )
    {
...
LABEL_17:
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v22, v13, (__int64)this, 0LL, 0LL, 0LL);
      goto LABEL_18;
    }
    if ( a2 )
    {
      v23 = ((__int64 (__fastcall *)(_QWORD, void *))qword_14015D5B8)(*v17, a2);
      v13 = v23;
      if ( v23 < 0 )
      {
    ...
    v27 = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_14015D590)(*v17, v43);
    LODWORD(v13) = v27;
    if ( v27 < 0 )
    {
      v14 = v27;
  ...
  {
    v28 = ((__int64 (__fastcall *)(__int64, __int128 *, __int128 *, _QWORD))qword_14015D420)(
            v20,
  ...
  if ( a5 )
    ((void (__fastcall *)(_QWORD))qword_14015D390)(*v17);
  v29 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_14015D3A0)(*v17, 2048LL);
  v13 = v29;
  if ( v29 < 0 )
  {
...
LABEL_18:
    ...
    {
LABEL_40:
      ((void (__fastcall *)(_QWORD))qword_14015D338)(*v24);
      *v24 = 0LL;
      VmBusInterfaceDereference();
...
LABEL_31:
  v24 = (_QWORD *)((char *)this + 16);
  v30 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64))qword_14015D418)(*((_QWORD *)this + 2), 8LL, 8LL);
  v13 = v30;
  if ( v30 < 0 )
  {
...
LABEL_19:
  ((void (__fastcall *)(_QWORD, DXGVMBUSCHANNEL *))qword_14015D3F8)(*v24, this);
  v25 = ((__int64 (__fastcall *)(_QWORD, void *, _QWORD))qword_14015D3A8)(*v24, &ProcessRingPacket, 0LL);
  v13 = v25;
  if ( v25 < 0 )
  {
...
LABEL_35:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v26, v13, (__int64)this, 0LL, 0LL, 0LL);
    goto LABEL_40;
  }
  v31 = *v24;
  v38 = 0LL;
  ...
  v37[0] = 1;
  v37[1] = 48;
  v32 = ((__int64 (__fastcall *)(__int64, _DWORD *))qword_14015D3B0)(v31, v37);
  v13 = v32;
  if ( v32 < 0 )
  {
  ...
  if ( !a6 )
  {
    v33 = ((__int64 (__fastcall *)(_QWORD))qword_14015D360)(*v24);
    v13 = v33;
    if ( v33 < 0 )
    {
