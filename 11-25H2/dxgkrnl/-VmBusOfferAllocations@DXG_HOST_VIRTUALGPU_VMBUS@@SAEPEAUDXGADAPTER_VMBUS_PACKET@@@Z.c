/*
 * XREFs of ?VmBusOfferAllocations@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14021EAB0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) )
  {
    ...
    if ( v4 )
    {
      ...
      else
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid packet size", 1603LL, 0LL, 0LL, 0LL, 0LL);
      }
