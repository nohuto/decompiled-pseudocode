/*
 * XREFs of ?DdiSetRootPageTable@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_SETROOTPAGETABLE@@@Z @ 0x1403BE708
 * Callers:
 *     ADAPTER_RENDER_DdiSetRootPageTable @ 0x140053120 (ADAPTER_RENDER_DdiSetRootPageTable.c)
 * Callees:
