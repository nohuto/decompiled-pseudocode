/*
 * XREFs of ?DdiDestroyDevice@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1403356E0
 * Callers:
 *     ADAPTER_RENDER_DdiDestroyDevice @ 0x14006BF60 (ADAPTER_RENDER_DdiDestroyDevice.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyDevice(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5027);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5027);
  ...
  v12 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 712LL))(a2);
  if ( v22[0] )
