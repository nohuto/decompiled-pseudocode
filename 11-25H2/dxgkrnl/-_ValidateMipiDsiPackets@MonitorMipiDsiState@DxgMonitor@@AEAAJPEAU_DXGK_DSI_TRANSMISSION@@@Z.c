/*
 * XREFs of ?_ValidateMipiDsiPackets@MonitorMipiDsiState@DxgMonitor@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1402781D0
 * Callers:
 ...
 * Callees:
 *     ?_IsValidPacket@MonitorMipiDsiState@DxgMonitor@@CA_NPEBU_DXGK_DSI_PACKET@@_NI@Z @ 0x140277FF0 (-_IsValidPacket@MonitorMipiDsiState@DxgMonitor@@CA_NPEBU_DXGK_DSI_PACKET@@_NI@Z.c)
 */
