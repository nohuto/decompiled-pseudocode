/*
 * XREFs of ?AdapterTelemetry@DXGADAPTER@@QEAAXW4_TELEMETRY_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@JW4START_ADAPTER_FAILURE_REASON@@@Z @ 0x1403F15B4
 * Callers:
 ...
 *     DxgkMiracastQueryMiracastSupportNoLock @ 0x14005B04C (DxgkMiracastQueryMiracastSupportNoLock.c)
 ...
 *     DxgkCountInterfaceFunctions @ 0x1403FDAD8 (DxgkCountInterfaceFunctions.c)
...
LABEL_29:
  ...
  if ( (unsigned int)dword_14015B628 > 5 && tlgKeywordOn((__int64)&dword_14015B628, 0x800000000004LL) )
  {
