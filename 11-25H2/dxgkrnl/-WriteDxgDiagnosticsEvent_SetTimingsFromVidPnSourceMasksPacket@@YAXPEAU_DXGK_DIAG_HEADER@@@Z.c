/*
 * XREFs of ?WriteDxgDiagnosticsEvent_SetTimingsFromVidPnSourceMasksPacket@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003F52C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_SetTimingsFromVidPnSourceMasksPacket(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015B5F0 > 4
    && (qword_14015B600 & 0x200000000800LL) != 0
    && (qword_14015B608 & 0x200000000800LL) == qword_14015B608
