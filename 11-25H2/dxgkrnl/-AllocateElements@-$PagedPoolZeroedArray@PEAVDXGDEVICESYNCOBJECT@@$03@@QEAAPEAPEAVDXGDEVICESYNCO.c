/*
 * XREFs of ?AllocateElements@?$PagedPoolZeroedArray@PEAVDXGDEVICESYNCOBJECT@@$03@@QEAAPEAPEAVDXGDEVICESYNCOBJECT@@I@Z @ 0x14037DED8
 * Callers:
...
__int64 __fastcall PagedPoolZeroedArray<DXGDEVICESYNCOBJECT *,4>::AllocateElements(
        __int64 *a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
