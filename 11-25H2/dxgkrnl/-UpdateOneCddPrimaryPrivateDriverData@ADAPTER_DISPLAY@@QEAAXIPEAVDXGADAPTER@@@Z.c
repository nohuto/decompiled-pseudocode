/*
 * XREFs of ?UpdateOneCddPrimaryPrivateDriverData@ADAPTER_DISPLAY@@QEAAXIPEAVDXGADAPTER@@@Z @ 0x140198FD0
 * Callers:
...
LABEL_3:
    ...
    if ( (*(_DWORD *)(v9 + 12) & 4) == 0 )
    {
      ...
      if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(*((ADAPTER_RENDER **)a3 + 391), &v17) < 0 )
      {
...
LABEL_9:
      ...
      if ( v17.PrivateDriverFormatAttribute != *(_DWORD *)(v11 + v6 + 1044) )
      {
        ...
        *(_DWORD *)&v18[20] = a2;
        ...
        v14 = *(_DWORD *)(v13 + 40);
        v15 = (ADAPTER_RENDER *)*((_QWORD *)a3 + 391);
        ...
        if ( (int)ADAPTER_RENDER::DdiGetStandardAllocationDriverData(v15, &v16) < 0 )
        {
          WdLogSingleEntry1(2LL, v8);
