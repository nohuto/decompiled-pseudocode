/*
 * XREFs of ?OkToClose@DxgkCompositionObject@@SAEPEAU_EPROCESS@@PEAX1D@Z @ 0x140018130
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
        ...
        if ( *CurrentThreadNonPaged )
        {
                ...
                ProcessSessionId == (unsigned int)PsGetProcessSessionIdEx(CurrentThreadProcess)) )
          {
            if ( *(_DWORD *)(*v13 + 376LL) )
            {
              ...
              if ( (*(int (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 8LL))(*v13) <= 1 )
              {
                WdLogSingleEntry0(1LL);
      ...
      else if ( v31[0] )
      {
        ...
        (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 16LL))(v31[0]);
      }
    }
  }
  v14 = v9 >= 0;
