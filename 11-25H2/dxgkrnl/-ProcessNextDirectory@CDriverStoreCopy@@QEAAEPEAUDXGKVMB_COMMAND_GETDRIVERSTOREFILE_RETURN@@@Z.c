/*
 * XREFs of ?ProcessNextDirectory@CDriverStoreCopy@@QEAAEPEAUDXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN@@@Z @ 0x1401C8FD8
 * Callers:
        ...
        struct DXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN *a2)
{
  ...
  *((_DWORD *)a2 + 4) = RtlStringCbCopyW((char *)a2 + 60, 0x208uLL, (char *)v6 - 520);
  ...
  if ( *((int *)a2 + 4) >= 0 )
    CDriverStoreCopy::EnumDirectory(this, a2, v10, v11);
  return 1;
}
