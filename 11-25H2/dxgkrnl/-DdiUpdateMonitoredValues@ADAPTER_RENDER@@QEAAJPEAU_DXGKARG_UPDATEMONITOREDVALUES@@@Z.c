/*
 * XREFs of ?DdiUpdateMonitoredValues@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATEMONITOREDVALUES@@@Z @ 0x14006A624
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateMonitoredValues @ 0x14006C1A0 (ADAPTER_RENDER_DdiUpdateMonitoredValues.c)
 * Callees:
