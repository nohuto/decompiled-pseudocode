/*
 * XREFs of ?OpenLifetimeDirtyRegion@CCompositionSurface@@QEBAJ_KAEBUCSM_REALIZATION_INFO@@PEAUCSM_RGNDATA_@@@Z @ 0x14002C03C
 * Callers:
        ...
        struct CSM_RGNDATA_ *a4)
{
  ...
  {
    v6 = (char *)this + 80;
    for ( i = (char *)*((_QWORD *)this + 10); i != v6; i = *(char **)i )
    {
      if ( *((_QWORD *)i - 1) == a2 )
      {
        v8 = i + 248;
