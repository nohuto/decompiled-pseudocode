/*
 * XREFs of ?TraceStateChanged@CFlipToken@@AEBAXXZ @ 0x14000F050
 * Callers:
 ...
 *     ?Confirm@CFlipToken@@UEAAXXZ @ 0x14005A200 (-Confirm@CFlipToken@@UEAAXXZ.c)
...
void __fastcall CFlipToken::TraceStateChanged(CFlipToken *this)
{
  ...
  if ( *((_DWORD *)this + 6) == 3 )
  {
    ...
    if ( *(_DWORD *)(v3 + 136) )
    {
      for ( i = *(_QWORD **)(v3 + 120); i != (_QWORD *)(v3 + 120); i = (_QWORD *)*i )
      {
        if ( *(i - 1) == v4 )
        {
...
LABEL_7:
  ...
  v13 = *v9;
  v14 = *((_QWORD *)this + 13);
  v15 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, int, int, bool, __int64, __int64, int))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 432LL);
