/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DRV_CDS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140071D88
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DRV_CDS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015B5F0 > 4 && tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000008LL) )
  {
