/*
 * XREFs of ?GetCachedModeList@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1403C1C90
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::GetCachedModeList(ADAPTER_DISPLAY *this, struct _D3DKMT_GETDISPLAYMODELIST *a2)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pOutputDisplayModeList != NULL", 6491LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  else if ( *((_BYTE *)this + 292) && *(_BYTE *)(3984 * VidPnSourceId + *((_QWORD *)this + 16) + 1100) )
  {
    WdLogSingleEntry0(4LL);
    v5 = 3984LL * a2->VidPnSourceId;
    v6 = *((_QWORD *)this + 16);
    WdLogGlobalForLineNumber = 6507;
