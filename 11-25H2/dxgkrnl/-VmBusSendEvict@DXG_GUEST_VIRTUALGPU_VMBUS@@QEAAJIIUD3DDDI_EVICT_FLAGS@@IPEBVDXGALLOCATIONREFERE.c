/*
 * XREFs of ?VmBusSendEvict@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIUD3DDDI_EVICT_FLAGS@@IPEBVDXGALLOCATIONREFERENCE@@PEA_K@Z @ 0x1402245BC
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  if ( a5 - 1 > 0x7FFF )
  {
    ...
    WdLogGlobalForLineNumber = 11881;
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"NumAllocation is invalid", 11881LL, 0LL, 0LL, 0LL, 0LL);
    return 0LL;
  }
  else
  {
