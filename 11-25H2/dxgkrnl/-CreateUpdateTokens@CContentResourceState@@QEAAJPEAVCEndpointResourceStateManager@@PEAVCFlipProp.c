/*
 * XREFs of ?CreateUpdateTokens@CContentResourceState@@QEAAJPEAVCEndpointResourceStateManager@@PEAVCFlipPropertySet@@_NAEAU_LIST_ENTRY@@@Z @ 0x14004336C
 * Callers:
        ...
        struct _LIST_ENTRY *a5)
{
  ...
  if ( v9 && *((_QWORD *)this + 7) && (*((_BYTE *)this + 64) & 1) != 0 )
  {
    ...
    if ( (unsigned int)Feature_CompSwapchainDX12Support__private_IsEnabledDeviceUsageNoInline() )
    {
      ...
      {
        LODWORD(v23) = 0;
        CFlipPropertySetBase::FindProperty(v13, &stru_140137718, (unsigned int *)&v23, (const void **)&v22);
