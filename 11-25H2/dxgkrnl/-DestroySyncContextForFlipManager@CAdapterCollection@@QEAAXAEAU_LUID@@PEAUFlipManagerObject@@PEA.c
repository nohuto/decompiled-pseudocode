/*
 * XREFs of ?DestroySyncContextForFlipManager@CAdapterCollection@@QEAAXAEAU_LUID@@PEAUFlipManagerObject@@PEA_N@Z @ 0x14009852C
 * Callers:
 *     ?DestroySyncContextForFlipManager@CTokenManager@@UEAAXAEAU_LUID@@PEAUFlipManagerObject@@@Z @ 0x1400980C0 (-DestroySyncContextForFlipManager@CTokenManager@@UEAAXAEAU_LUID@@PEAUFlipManagerObject@@@Z.c)
 * Callees:
