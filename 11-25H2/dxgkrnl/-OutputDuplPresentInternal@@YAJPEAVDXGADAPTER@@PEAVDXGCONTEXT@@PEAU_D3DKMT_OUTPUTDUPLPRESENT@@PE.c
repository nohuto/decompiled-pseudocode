/*
 * XREFs of ?OutputDuplPresentInternal@@YAJPEAVDXGADAPTER@@PEAVDXGCONTEXT@@PEAU_D3DKMT_OUTPUTDUPLPRESENT@@PEAPEAV2@@Z @ 0x140302144
 * Callers:
        ...
        struct DXGCONTEXT **a4)
{
  ...
  else
  {
    ...
    v16 = *(struct DXGADAPTER **)(v15 + 1880);
    if ( !v16 )
