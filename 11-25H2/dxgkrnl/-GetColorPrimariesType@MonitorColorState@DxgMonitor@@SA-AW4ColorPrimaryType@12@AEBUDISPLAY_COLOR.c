/*
 * XREFs of ?GetColorPrimariesType@MonitorColorState@DxgMonitor@@SA?AW4ColorPrimaryType@12@AEBUDISPLAY_COLOR_DATA_RAW@@@Z @ 0x140273EE8
 * Callers:
 ...
 * Callees:
 *     ?_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z @ 0x140275518 (-_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z.c)
 *     ?_GetDeltaSquaredBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z @ 0x140275588 (-_GetDeltaSquaredBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z.c)
 */
