/*
 * XREFs of ?VmBusFreeGpuVirtualAddress@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14021CE60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusFreeGpuVirtualAddress(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) )
  {
    ...
    if ( v4 )
    {
      v5 = DxgkFreeGpuVirtualAddress(v4 + 24);
