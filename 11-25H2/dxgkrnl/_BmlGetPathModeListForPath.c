/*
 * XREFs of _BmlGetPathModeListForPath @ 0x14039C1C8
 * Callers:
 ...
 *     ?GetNextMode@DMMVIDPNSOURCEMODESET@@QEAAPEAVDMMVIDPNSOURCEMODE@@QEBV2@@Z @ 0x140034980 (-GetNextMode@DMMVIDPNSOURCEMODESET@@QEAAPEAVDMMVIDPNSOURCEMODE@@QEBV2@@Z.c)
...
__int64 __fastcall BmlGetPathModeListForPath(__int64 a1, __int64 a2, __int64 a3, CCD_MODE_RESULT_SET *a4)
{
  ...
  *(_WORD *)(v9 + a1 + 68) = 0;
  ...
  {
    if ( BmlIsSecondaryHardwareClonePath(a1, v5, 0LL) )
    {
    ...
    *(_QWORD *)(v9 + a1 + 100) = 0LL;
    ...
    while ( 1 )
    {
      ...
      if ( v43 && v43 != NextMode
        ...
        || (v32 = v44, !BmlDoesSourceModeObeyConstraint(a1, v44, NextMode)) )
      {
        WdLogNewEntry5_WdTrace(BitsPerPixel, v28, v30, v31);
        WdLogGlobalForLineNumber = 6836;
        goto LABEL_32;
      }
      ++*(_DWORD *)(v9 + a1 + 96);
      ...
      PathModeListForPathTargetModes = BmlGetPathModeListForPathTargetModes(a1, a2, v32, (int)Path, a4);
      if ( !v43 )
      {
