/*
 * XREFs of ?DestroyContext@DXGCONTEXT@@QEAAXPEAVCOREDEVICEACCESS@@@Z @ 0x140335B54
 * Callers:
    ...
    *((_BYTE *)this + 428) = 1;
    ...
    if ( *((_QWORD *)this + 44) )
    {
      if ( !*((_QWORD *)this + 7) )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_pCommandBuffer", 1847LL, 0LL, 0LL, 0LL, 0LL);
      }
