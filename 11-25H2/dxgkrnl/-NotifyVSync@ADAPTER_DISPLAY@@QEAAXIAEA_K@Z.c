/*
 * XREFs of ?NotifyVSync@ADAPTER_DISPLAY@@QEAAXIAEA_K@Z @ 0x14002E52C
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::NotifyVSync(ADAPTER_DISPLAY *this, unsigned int a2, unsigned __int64 *a3)
{
  ...
  {
    _mm_lfence();
    v5 = *(unsigned int *)(3984LL * a2 + *((_QWORD *)this + 16) + 3764);
    if ( (_DWORD)v5 )
    {
      v6 = 10 * v5;
      v7 = *((_QWORD *)this + 10 * v5 + 117);
      if ( v7 )
      {
        if ( !*((_DWORD *)this + 20 * v5 + 218) )
        {
          *((_QWORD *)this + 10 * v5 + 115) = 0LL;
          *((_QWORD *)this + 10 * v5 + 116) = 0LL;
          return;
        }
        v8 = *((_QWORD *)this + 10 * v5 + 115);
        v9 = *a3;
        if ( !v8 )
          goto LABEL_18;
        if ( v9 - v8 > (unsigned __int64)*((unsigned int *)this + 20 * v5 + 228) )
        {
          if ( *((_QWORD *)this + 10 * v5 + 116) )
          {
            v12 = *((_DWORD *)this + 20 * v5 + 232) - *((_DWORD *)this + 20 * v5 + 230);
            ++*((_DWORD *)this + 2 * v6 + 224);
            *((_DWORD *)this + 2 * v6 + 227) += v12 >> 4;
            v13 = v12 >> 6;
            if ( v13 >= 0x80 )
              v13 = 127;
            ++*(_DWORD *)(3 * v13 + v7);
          }
          else if ( !*((_BYTE *)this + 80 * v5 + 888) )
          {
            ++*((_DWORD *)this + 20 * v5 + 223);
            if ( (unsigned int)dword_14015B5F0 > 5 )
            {
              if ( (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, 0x4000LL) )
              {
                v14 = 0;
          ...
          *((_QWORD *)this + v6 + 116) = 0LL;
LABEL_18:
          *((_QWORD *)this + v6 + 115) = v9;
          return;
        }
        *((_BYTE *)this + 80 * v5 + 888) = 0;
        *((_QWORD *)this + 10 * v5 + 116) = v9;
      }
    }
  }
}
