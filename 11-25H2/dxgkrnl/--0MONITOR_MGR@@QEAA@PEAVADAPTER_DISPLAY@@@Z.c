  ...
  *((_QWORD *)this + 86) = v6;
  if ( v6 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 86) + 20LL) = 0;
    ...
    v8 = (_QWORD *)qword_14015D630;
    v9 = (_QWORD *)*((_QWORD *)this + 86);
    if ( *(struct _LIST_ENTRY **)qword_14015D630 != &MONITOR_MGR::_MonitorPendingEventTraceHead )
      __fastfail(3u);
    v9[1] = qword_14015D630;
    *v9 = &MONITOR_MGR::_MonitorPendingEventTraceHead;
    *v8 = v9;
    qword_14015D630 = (__int64)v9;
