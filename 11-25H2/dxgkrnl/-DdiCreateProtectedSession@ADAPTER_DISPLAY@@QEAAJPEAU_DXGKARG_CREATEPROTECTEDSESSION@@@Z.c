/*
 * XREFs of ?DdiCreateProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CREATEPROTECTEDSESSION@@@Z @ 0x1401A0D88
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5108);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5108);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEPROTECTEDSESSION *))(*((_QWORD *)this + 2) + 1240LL))(
