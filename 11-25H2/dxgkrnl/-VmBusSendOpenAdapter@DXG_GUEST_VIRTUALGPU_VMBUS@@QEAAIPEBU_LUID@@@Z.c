/*
 * XREFs of ?VmBusSendOpenAdapter@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAIPEBU_LUID@@@Z @ 0x14022678C
 * Callers:
        ...
        const struct _LUID *a2)
{
  ...
  if ( (_QWORD)v13 )
  {
    ...
    *(struct _LUID *)(v4 + 32) = *a2;
    ...
    if ( v5 < 0 || v12[0] < v10 )
      goto LABEL_3;
    *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) = *(_DWORD *)(v11 + 24);
LABEL_15:
    v7 = v15;
    goto LABEL_4;
  }
