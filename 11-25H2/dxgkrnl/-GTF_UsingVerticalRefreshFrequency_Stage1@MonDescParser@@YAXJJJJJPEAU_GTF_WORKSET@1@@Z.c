/*
 * XREFs of ?GTF_UsingVerticalRefreshFrequency_Stage1@MonDescParser@@YAXJJJJJPEAU_GTF_WORKSET@1@@Z @ 0x14003DAAC
 * Callers:
 ...
 * Callees:
 *     ?GTF_InitWorkset@MonDescParser@@YAXPEAU_GTF_WORKSET@1@@Z @ 0x14003DD50 (-GTF_InitWorkset@MonDescParser@@YAXPEAU_GTF_WORKSET@1@@Z.c)
 */
