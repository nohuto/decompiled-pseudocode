/*
 * XREFs of ?PinFrameBufferForSave@DXGADAPTER@@QEAAJI_KIPEAPEAU_MDL@@PEAPEAU_DXGK_ADL@@@Z @ 0x1403C26E0
 * Callers:
...
LABEL_16:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v18, v7, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
  v21 = 0LL;
  v19 = 0LL;
  ...
  if ( (int)v11 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 11399;
  }
  else
  {
    ...
    if ( Mdl )
    {
      ...
      if ( PhysicalObjectForExistingMdl < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 11442;
        DxgkLogInternalTriageEvent(
          0LL,
          262145,
          0xFFFFFFFFLL,
...
LABEL_9:
        ...
        WdLogGlobalForLineNumber = 11462;
        v10 = v20;
      }
    }
    else
