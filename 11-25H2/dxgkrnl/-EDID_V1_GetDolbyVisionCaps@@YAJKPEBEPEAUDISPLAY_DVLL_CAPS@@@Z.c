/*
 * XREFs of ?EDID_V1_GetDolbyVisionCaps@@YAJKPEBEPEAUDISPLAY_DVLL_CAPS@@@Z @ 0x140094398
 * Callers:
...
__int64 __fastcall EDID_V1_GetDolbyVisionCaps(unsigned int a1, unsigned __int8 *a2, struct DISPLAY_DVLL_CAPS *a3)
{
         ...
         &v25) )
  {
    ...
    else
    {
      ...
      *(_BYTE *)a3 = 1;
      *((double *)a3 + 1) = dword_140132D70[v18];
      v19 = v28;
      *((double *)a3 + 2) = dword_140132DF0[(unsigned __int64)v16 >> 3];
