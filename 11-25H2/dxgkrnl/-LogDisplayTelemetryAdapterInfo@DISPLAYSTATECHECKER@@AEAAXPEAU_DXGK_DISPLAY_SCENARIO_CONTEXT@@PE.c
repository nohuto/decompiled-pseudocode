/*
 * XREFs of ?LogDisplayTelemetryAdapterInfo@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEAVDISPLAYDIAGNOSTICADAPTERDATA@@@Z @ 0x1401BE9C4
 * Callers:
        ...
        struct DISPLAYDIAGNOSTICADAPTERDATA *a3)
{
  ...
  if ( a3 && a2 )
  {
    if ( (unsigned int)dword_14015B660 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_14015B660, 0x400000000400LL) )
      {
        ...
        v13 = 8;
        v10 = 33556480LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B660, byte_140139B13, v4, 0LL, 7u, &v11);
      }
    }
  }
  else
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"Invalid parameters not expected", 344LL, 0LL, 0LL, 0LL, 0LL);
  }
}
