/*
 * XREFs of ??0?$DoublyLinkedList@VDMMVIDPNSOURCE@@U?$DoubleLinkedListElementDeleter@VDMMVIDPNSOURCE@@@@@@QEAA@AEBV0@@Z @ 0x14001B48C
 * Callers:
        ...
        __int64 a2)
{
  ...
  _QWORD *v5; // r15
  _QWORD *v6; // rdi
  const struct DMMVIDPNSOURCE *v7; // rsi
  DMMVIDPNSOURCE *Pool2; // rax
  DMMVIDPNSOURCE *v9; // rcx
  __int64 v10; // rdx
  _QWORD *v11; // rax
  _QWORD *v12; // rax
  _QWORD *v13; // rcx
  ...
  *(_QWORD *)(a1 + 32) = 0LL;
  if ( (_QWORD *)*v5 == v5 )
    ...
    v7 = (const struct DMMVIDPNSOURCE *)(*v5 - 8LL);
  while ( v7 )
  {
    Pool2 = (DMMVIDPNSOURCE *)ExAllocatePool2(256LL, 184LL, 1265072196LL, v4);
    if ( !Pool2 || (v9 = DMMVIDPNSOURCE::DMMVIDPNSOURCE(Pool2, v7)) == 0LL )
    {
...
LABEL_16:
    ...
    v7 = (const struct DMMVIDPNSOURCE *)(v14 - 1);
    if ( v14 == v5 )
      v7 = 0LL;
  }
