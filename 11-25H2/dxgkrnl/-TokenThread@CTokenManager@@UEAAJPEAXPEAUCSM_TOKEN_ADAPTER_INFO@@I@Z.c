/*
 * XREFs of ?TokenThread@CTokenManager@@UEAAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1400502D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x140050398 (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
