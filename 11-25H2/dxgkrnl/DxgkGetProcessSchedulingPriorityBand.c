/*
 * XREFs of DxgkGetProcessSchedulingPriorityBand @ 0x1401E8E30
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v16 >= 0 )
      {
        ...
        if ( (_DWORD)v18 != 1 )
        {
          if ( (v18 & 0xFFFFFFFD) != 0 )
          {
            ...
            DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"FALSE", 4822LL, 0LL, 0LL, 0LL, 0LL);
            v18 = 3LL;
          }
          else
          {
