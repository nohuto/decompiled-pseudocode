/*
 * XREFs of ?DisplayConfigGetTargetBaseType@@YAJPEAUDISPLAYCONFIG_TARGET_BASE_TYPE@@AEBVDXGADAPTER_REFERENCE@@@Z @ 0x1403EA5BC
 * Callers:
        ...
        const struct DXGADAPTER_REFERENCE *a2)
{
  ...
  *((_DWORD *)a1 + 5) = -1;
  v4 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 3120LL) + 104LL);
