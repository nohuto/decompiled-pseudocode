/*
 * XREFs of ?InvalidateActiveVidPnDisplayModeListCache@ADAPTER_DISPLAY@@QEAAXIQEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@@Z @ 0x1401972F0
 * Callers:
        ...
        const struct _DMM_COMMITVIDPNREQUEST_DIAGINFO *const a3)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceExclusiveOwner()", 3008LL, 0LL, 0LL, 0LL, 0LL);
  }
  LODWORD(v6) = 0;
  if ( *((_DWORD *)this + 24) )
  {
