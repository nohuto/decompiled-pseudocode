/*
 * XREFs of ?_MigrateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@AEBVMONITOR_REF_ACCESSOR@@AEAV3@@Z @ 0x14026DA10
 * Callers:
  ...
  if ( MonitorInstance >= 0 )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ( *((_DWORD *)v13 + 70) == 2 )
          MONITOR_MGR::_DeleteTargetFromPersistencyRegistry(a1, (unsigned int)v7, v11, v12);
        *((_DWORD *)a5[1] + 70) = v5;
        if ( (_DWORD)v5 == 2 )
          MONITOR_MGR::_AddTargetIntoPersistencyRegistry(a1, (unsigned int)v7, v11, v12);
      }
      if ( *((_QWORD *)a4 + 1) )
