/*
 * XREFs of DpiFdoInitializeGpuVirtualization @ 0x140404394
 * Callers:
 *     DpiFdoStartAdapter @ 0x14023E8A8 (DpiFdoStartAdapter.c)
 * Callees:
 *     DxgkLogInternalTriageEvent @ 0x140019E90 (DxgkLogInternalTriageEvent.c)
 *     DxgkIsDirtyBitTrackingSupported @ 0x14006875C (DxgkIsDirtyBitTrackingSupported.c)
 *     DxgkIsLiveMigrationInterfaceSupported @ 0x140068770 (DxgkIsLiveMigrationInterfaceSupported.c)
 ...
 *     DxgkIsGpuParavirtualizationSupported @ 0x14019DCFC (DxgkIsGpuParavirtualizationSupported.c)
...
__int64 __fastcall DpiFdoInitializeGpuVirtualization(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(v1 + 5144) )
  {
      ...
      || !*(_QWORD *)(v1 + 5184) )
    {
      ...
      WdLogGlobalForLineNumber = 13938;
      goto LABEL_127;
    }
    v4 = *(_DWORD *)(v1 + 4048);
    *(_BYTE *)(v1 + 5144) = 1;
...
LABEL_40:
        ...
        WdLogGlobalForLineNumber = 13969;
        MiniportInterface = 0;
      }
      else
      {
        if ( *v7 >= 0x10u )
        {
          ...
          WdLogGlobalForLineNumber = 13980;
          goto LABEL_127;
        }
        if ( (*v7 & 1) != 0 )
        {
  ...
  if ( MiniportInterface >= 0 )
  {
    *(_BYTE *)(v1 + 5016) = 1;
      ...
      || !*(_QWORD *)(v1 + 5128) )
    {
      MiniportInterface = -1073741823;
      WdLogSingleEntry1(2LL, -1073741823LL);
      WdLogGlobalForLineNumber = 14040;
      goto LABEL_127;
    }
LABEL_42:
    if ( !*(_BYTE *)(v1 + 5280) )
      ...
      else
      {
        *(_BYTE *)(v1 + 5280) = 1;
        if ( !*(_QWORD *)(v1 + 5320) || !*(_QWORD *)(v1 + 5328) )
        {
          MiniportInterface = -1073741823;
          WdLogSingleEntry1(2LL, -1073741823LL);
          WdLogGlobalForLineNumber = 14067;
          goto LABEL_127;
        }
      }
    }
      ...
      else
      {
        *(_BYTE *)(v1 + 5336) = 1;
        if ( !*(_QWORD *)(v1 + 5376) || !*(_QWORD *)(v1 + 5384) || !*(_QWORD *)(v1 + 5392) || *(_WORD *)(v1 + 5346) != 1 )
        {
          MiniportInterface = -1073741823;
          WdLogSingleEntry1(2LL, -1073741823LL);
          WdLogGlobalForLineNumber = 14101;
          goto LABEL_127;
        }
      }
    }
...
LABEL_56:
  if ( *(_BYTE *)(v1 + 5144) )
  {
    if ( MiniportInterface < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 14123;
      goto LABEL_127;
    }
  ...
  if ( (*(_DWORD *)(v1 + 5592) & 4) != 0 )
  {
    ...
    {
      WdLogSingleEntry1(2LL, MiniportInterface);
      WdLogGlobalForLineNumber = 14152;
      goto LABEL_127;
    }
    if ( !(unsigned int)DxgkIsDirtyBitTrackingSupported(v11) )
    {
      MiniportInterface = -1073741823;
      WdLogSingleEntry1(2LL, -1073741823LL);
      WdLogGlobalForLineNumber = 14165;
      goto LABEL_127;
    }
  }
LABEL_71:
    ...
    *(_BYTE *)(v1 + 5336) = v12;
    if ( !*(_QWORD *)(v1 + 2904) )
    {
      ...
      if ( v13 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 14202;
        goto LABEL_127;
      }
    }
  }
  if ( v10 || *(_QWORD *)(v1 + 2904) )
  {
    ...
    *(_DWORD *)(v1 + 5792) = 0;
    ...
    if ( v14 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 14247;
      goto LABEL_127;
    }
    v15 = P;
    ...
    if ( v16 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 14238;
    }
  ...
  else
  {
    ...
    if ( !*(_QWORD *)(v1 + 2888) )
    {
      ...
      if ( v17 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 14276;
        goto LABEL_127;
      }
    }
    if ( *(_QWORD *)(v1 + 2920)
...
LABEL_132:
            ...
            v20 >= 0) )
      {
              ...
              v21 >= 0) )
        {
                  ...
                  v23 >= 0) )
            {
              ...
              if ( v24 >= 0 )
              {
                           ...
                           v26 < 0) )
                {
                  ...
                  WdLogGlobalForLineNumber = 14414;
                }
                           ...
                           v27 < 0) )
                {
                  ...
                  WdLogGlobalForLineNumber = 14431;
                }
                ...
                else if ( *(_QWORD *)(v1 + 2984) )
                {
                  ...
                  if ( v31 < 0 )
                  {
                    ...
                    WdLogGlobalForLineNumber = 14484;
                  }
                }
              }
              else
              {
                ...
                WdLogGlobalForLineNumber = 14385;
              }
            }
            else
            {
          ...
          else
          {
            ...
            WdLogGlobalForLineNumber = 14357;
          }
        }
        else
        {
          WdLogSingleEntry1(2LL, v21);
          WdLogGlobalForLineNumber = 14340;
        }
      }
      else
      {
    ...
    else
    {
      ...
      WdLogGlobalForLineNumber = 14304;
    }
  }
LABEL_127:
