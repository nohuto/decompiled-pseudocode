/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1401CA994
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_14015DA04 != v8 )
  {
    WdLogSingleEntry2(3LL, v8, (unsigned int)dword_14015DA04);
  ...
  if ( dword_14015DA08 != v9 )
  {
    WdLogSingleEntry2(3LL, v9, (unsigned int)dword_14015DA08);
  ...
  if ( dword_14015DA0C != v10 )
  {
    WdLogSingleEntry2(3LL, v10, (unsigned int)dword_14015DA0C);
  ...
  if ( dword_14015DA10 != v11 )
  {
    WdLogSingleEntry2(3LL, v11, (unsigned int)dword_14015DA10);
  ...
  if ( dword_14015DA18 != v14 )
  {
    WdLogSingleEntry2(3LL, v14, (unsigned int)dword_14015DA18);
  ...
  {
    dword_14015DA1C = 3600;
  }
  if ( dword_14015DA1C != v15 )
  {
    WdLogSingleEntry2(3LL, v15, (unsigned int)dword_14015DA1C);
    WdLogGlobalForLineNumber = 2412;
  }
  LOBYTE(v7) = 1;
  byte_14015DA14 = (unsigned __int8)WdIsDebuggerPresent(v7) != 0;
  if ( v12 < 2 || v12 - 2 < 2 )
    g_TdrDebugMode = v12;
  else
    g_TdrDebugMode = 2;
