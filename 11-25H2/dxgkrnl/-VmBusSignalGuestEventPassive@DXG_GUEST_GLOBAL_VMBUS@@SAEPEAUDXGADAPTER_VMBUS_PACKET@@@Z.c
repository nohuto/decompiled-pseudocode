/*
 * XREFs of ?VmBusSignalGuestEventPassive@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14022A5C0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusSignalGuestEventPassive(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( (unsigned __int64)(v4 - 1) > 0xFFFFFFFFFFFFFFFDuLL )
    {
      ...
      WdLogGlobalForLineNumber = 14149;
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        ...
        Objecta = *(PVOID **)(v1 + 24);
        WdLogGlobalForLineNumber = 14175;
