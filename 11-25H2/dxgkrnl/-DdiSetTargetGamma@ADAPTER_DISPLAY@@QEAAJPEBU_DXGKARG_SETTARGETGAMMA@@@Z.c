/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1402D66F4
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5077);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5077);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1168LL))(
  ...
  if ( (_DWORD)v10 != -1073741801 && (_DWORD)v10 != -1071774904 && (_DWORD)v10 )
  {
