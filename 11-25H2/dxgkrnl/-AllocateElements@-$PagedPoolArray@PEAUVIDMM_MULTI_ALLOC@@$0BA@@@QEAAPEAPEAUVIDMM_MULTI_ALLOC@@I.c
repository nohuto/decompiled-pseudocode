/*
 * XREFs of ?AllocateElements@?$PagedPoolArray@PEAUVIDMM_MULTI_ALLOC@@$0BA@@@QEAAPEAPEAUVIDMM_MULTI_ALLOC@@I@Z @ 0x140188114
 * Callers:
...
__int64 __fastcall PagedPoolArray<VIDMM_MULTI_ALLOC *,16>::AllocateElements(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
