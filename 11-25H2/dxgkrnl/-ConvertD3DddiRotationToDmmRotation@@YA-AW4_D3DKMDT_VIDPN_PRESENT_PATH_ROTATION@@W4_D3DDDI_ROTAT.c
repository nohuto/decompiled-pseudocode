/*
 * XREFs of ?ConvertD3DddiRotationToDmmRotation@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W4_D3DDDI_ROTATION@@@Z @ 0x1402C14D8
 * Callers:
...
__int64 __fastcall ConvertD3DddiRotationToDmmRotation(enum _D3DDDI_ROTATION a1)
{
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Unknown orientation %I64d", v2, 0LL, 0LL, 0LL, 0LL);
  return 255LL;
}
