/*
 * XREFs of ?LiveMigrationGetDirtyBitplane@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@I@Z @ 0x1402075B0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::LiveMigrationGetDirtyBitplane(__int64 a1, int a2, struct _LUID *a3, unsigned int a4)
{
  __int64 v7; // rbx
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"LiveMigrationGetDirtyBitplane called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v7,
      v16,
