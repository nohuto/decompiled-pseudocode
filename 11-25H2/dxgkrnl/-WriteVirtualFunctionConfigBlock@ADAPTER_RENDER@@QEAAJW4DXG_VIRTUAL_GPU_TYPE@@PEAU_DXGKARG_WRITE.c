/*
 * XREFs of ?WriteVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x140209104
 * Callers:
 *     DxgkDdiWriteVirtualFunctionConfigBlock @ 0x14020AC64 (DxgkDdiWriteVirtualFunctionConfigBlock.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfigBlock(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v4; // ebx
