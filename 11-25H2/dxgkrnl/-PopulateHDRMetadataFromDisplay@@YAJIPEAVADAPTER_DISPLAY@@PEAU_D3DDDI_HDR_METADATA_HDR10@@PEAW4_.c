/*
 * XREFs of ?PopulateHDRMetadataFromDisplay@@YAJIPEAVADAPTER_DISPLAY@@PEAU_D3DDDI_HDR_METADATA_HDR10@@PEAW4_D3DDDI_HDR_METADATA_TYPE@@@Z @ 0x140308DD0
 * Callers:
...
LABEL_33:
  ...
  *((_QWORD *)&v38 + 1) = &MonitorHandle;
  DXGKCALLONEXIT__lambda_dbcf8364b3ea4150de008656de4589a7_((__int64)&v39, &v38);
  if ( !MonitorHandle )
  {
    LODWORD(v17) = -1073741811;
    goto LABEL_22;
...
LABEL_22:
  ...
  v21 = *(_BYTE *)(*(_QWORD *)(v42[0] + 224LL) + 512LL);
  CONST_MONITOR_REF_LOCK_ACCESSOR::~CONST_MONITOR_REF_LOCK_ACCESSOR((CONST_MONITOR_REF_LOCK_ACCESSOR *)v42);
  if ( !v21 )
  {
    if ( v41 )
