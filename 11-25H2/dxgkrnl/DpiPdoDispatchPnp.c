/*
 * XREFs of DpiPdoDispatchPnp @ 0x1402BE410
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiPdoEnableDisableConnectSound @ 0x14024E110 (DpiPdoEnableDisableConnectSound.c)
  ...
  if ( (unsigned int)MinorFunction <= 8 )
  {
    if ( (_DWORD)MinorFunction == 8 )
    {
      ...
      if ( !*(_QWORD *)(v12 + 256) || (int)DpiAcquireCoreSyncAccessSafe((__int64)Pdo, 1) < 0 )
        goto LABEL_13;
      DxgkAcquireAdapterDdiSync(*(_QWORD *)(v8 + 4032), 1LL);
      Status = DpiDxgkDdiQueryInterface(v12, *((_QWORD *)DeviceExtension + 6), &SecurityContext);
      DxgkReleaseAdapterDdiSync(*(_QWORD *)(v8 + 4032));
