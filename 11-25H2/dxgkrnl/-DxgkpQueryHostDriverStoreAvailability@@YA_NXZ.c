/*
 * XREFs of ?DxgkpQueryHostDriverStoreAvailability@@YA_NXZ @ 0x1401F4190
 * Callers:
 *     ?InitializeContainerData@DXGSESSIONDATA@@QEAAXPEAU_EJOB@@@Z @ 0x1401F4824 (-InitializeContainerData@DXGSESSIONDATA@@QEAAXPEAU_EJOB@@@Z.c)
 * Callees:
