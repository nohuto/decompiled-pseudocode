 ...
 *     ??$_tlgCreate1Sz@G@@YAXPEAU_EVENT_DATA_DESCRIPTOR@@PEBG@Z @ 0x140056E14 (--$_tlgCreate1Sz@G@@YAXPEAU_EVENT_DATA_DESCRIPTOR@@PEBG@Z.c)
        ...
        __int64 a63)
{
  ...
  v78 = 2LL;
  v76 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_14015B628, a2, a3, 0LL, 80, v74);
}
