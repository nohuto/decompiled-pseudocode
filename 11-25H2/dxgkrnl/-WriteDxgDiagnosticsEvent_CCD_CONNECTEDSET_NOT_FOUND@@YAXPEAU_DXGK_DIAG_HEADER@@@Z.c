/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CCD_CONNECTEDSET_NOT_FOUND@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140071B08
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CCD_CONNECTEDSET_NOT_FOUND(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_14015B5F0 > 4 && tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000040LL) )
  {
