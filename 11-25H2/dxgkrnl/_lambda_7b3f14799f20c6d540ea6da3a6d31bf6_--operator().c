/*
 * XREFs of _lambda_7b3f14799f20c6d540ea6da3a6d31bf6_::operator() @ 0x14008244C
 * Callers:
...
__int64 __fastcall lambda_7b3f14799f20c6d540ea6da3a6d31bf6_::operator()(int **a1)
{
  int *v2; // r8
  __int64 v3; // rax
  __int64 v4; // rax
  ...
  if ( (unsigned int)dword_14015B5B8 > 5 && tlgKeywordOn((__int64)&dword_14015B5B8, 512LL) )
  {
    ...
    v16 = &v7;
    v10 = &v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B5B8, byte_14013C38C, (const GUID *)(v5 + 24), 0LL, 5u, &v9);
  }
  if ( *a1[1] >= 0 )
  {
