/*
 * XREFs of ?CloseFromDevice@DXGDXGIKEYEDMUTEX@@QEAAXXZ @ 0x1401DF2AC
 * Callers:
...
void __fastcall DXGDXGIKEYEDMUTEX::CloseFromDevice(DXGDXGIKEYEDMUTEX *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *((_DWORD *)this + 22) )
  {
    ...
    if ( !Current )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pProcess != NULL", 577LL, 0LL, 0LL, 0LL, 0LL);
    }
...
LABEL_14:
            ...
            DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pResource", 583LL, 0LL, 0LL, 0LL, 0LL);
            goto LABEL_15;
          }
...
LABEL_24:
    if ( *((_QWORD *)this + 13) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"!m_pFenceSyncObj", 603LL, 0LL, 0LL, 0LL, 0LL);
    }
  }
  if ( *((_DWORD *)this + 24) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"!m_hFenceLocal", 604LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_DWORD *)this + 4) )
