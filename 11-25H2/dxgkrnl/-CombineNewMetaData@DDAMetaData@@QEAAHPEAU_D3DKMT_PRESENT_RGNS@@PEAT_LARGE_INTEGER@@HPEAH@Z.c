/*
 * XREFs of ?CombineNewMetaData@DDAMetaData@@QEAAHPEAU_D3DKMT_PRESENT_RGNS@@PEAT_LARGE_INTEGER@@HPEAH@Z @ 0x14034BC8C
 * Callers:
...
LABEL_19:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v14, (__int64)this, 0LL, 0LL, 0LL, 0LL);
    goto LABEL_10;
  }
  v10 = 0;
LABEL_7:
