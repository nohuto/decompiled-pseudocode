/*
 * XREFs of _BmlLogDiagnosticsPacket @ 0x1402C2518
 * Callers:
 ...
 *     ?GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ @ 0x140038EA0 (-GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ.c)
...
__int64 __fastcall BmlLogDiagnosticsPacket(struct _KTHREAD **this, int a2, __int64 a3, unsigned __int8 *a4)
{
  ...
  v6 = this;
  v8 = 408 * *a4 + 64;
  v9 = operator new[](v8, 0x63644356u, 256LL, (__int64)a4);
  v10 = v9;
  if ( v9 )
  {
    *(_DWORD *)v9 = 50;
