/*
 * XREFs of ?DeleteRegistryKey@DXGADAPTER@@QEAAJPEAU_UNICODE_STRING@@@Z @ 0x14018BCAC
 * Callers:
...
__int64 __fastcall DXGADAPTER::DeleteRegistryKey(DXGADAPTER *this, struct _UNICODE_STRING *a2, ULONG a3)
{
  ...
  *(_QWORD *)&v15.Length = 34078720LL;
  ...
  if ( *((_BYTE *)this + 210) )
  {
    ...
    WdLogGlobalForLineNumber = 12733;
  }
  else
  {
    ...
    while ( (_QWORD *)v16[0] != v16 )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( v5 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12753;
LABEL_14:
      ...
      if ( v6 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12766;
        goto LABEL_23;
      }
      ...
      if ( appended < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12773;
        goto LABEL_23;
      }
...
LABEL_23:
        DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v9, v4, 0LL, 0LL, 0LL, 0LL);
        goto LABEL_24;
      }
    ...
    while ( (_QWORD *)v17[0] != v17 )
    {
      ...
      if ( v10 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12794;
        goto LABEL_23;
      }
      ObjectAttributes.Length = 48;
      ObjectAttributes.ObjectName = &v15;
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( v11 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12807;
        goto LABEL_14;
      }
      ...
      if ( v12 < 0 )
      {
        ...
        WdLogGlobalForLineNumber = 12815;
        goto LABEL_23;
      }
      CloseRegistrySubkey(KeyHandle);
      KeyHandle = 0LL;
