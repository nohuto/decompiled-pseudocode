/*
 * XREFs of ?AugmentVidPnTopology@@YAJPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAXPEBU_DXGDMM_INTERFACE@@IEQEA_KPEAY0BA@I@Z @ 0x1401C34E8
 * Callers:
        ...
        __m128i *a10)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"ARGUMENT_PRESENT(i_hVidPn)", 3455LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a2 )
  {
    WdLogSingleEntry0(1LL);
  ...
  *a9 = 0LL;
  ...
  if ( v14 >= 0 )
  {
    if ( !v23 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"sztNumVidPnPresentPaths > 0", 3525LL, 0LL, 0LL, 0LL, 0LL);
    }
    ...
    else if ( !v23 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"sztNumVidPnPresentPaths > 0", 3540LL, 0LL, 0LL, 0LL, 0LL);
    }
    *a9 = v23;
    if ( a10 )
    {
