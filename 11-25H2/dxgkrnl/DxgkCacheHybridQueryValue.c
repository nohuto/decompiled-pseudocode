/*
 * XREFs of DxgkCacheHybridQueryValue @ 0x1403C2160
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetGpuPreferenceDListState@DXGPROCESS@@QEAA?AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z @ 0x140052620 (-GetGpuPreferenceDListState@DXGPROCESS@@QEAA-AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z.c)
...
__int64 __fastcall DxgkCacheHybridQueryValue(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _BYTE v23[24]; // [rsp+68h] [rbp-70h] BYREF
  unsigned __int64 v24; // [rsp+80h] [rbp-58h] BYREF
  _BYTE v25[8]; // [rsp+88h] [rbp-50h] BYREF
  struct DXGADAPTER *v26; // [rsp+90h] [rbp-48h]
  char v27; // [rsp+98h] [rbp-40h]
