/*
 * XREFs of ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x140183840
 * Callers:
 ...
 * Callees:
 *     ?OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z @ 0x1401838CC (-OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z.c)
 */
