/*
 * XREFs of ?AddAdapterToSession@DXGSESSIONDATA@@QEAAJAEBU_LUID@@PEAVDXGADAPTER@@PEAPEAVSESSION_ADAPTER@@@Z @ 0x1403EBBE0
 * Callers:
  ...
  if ( v11 )
  {
    ...
    *v15 = v15;
    ...
    if ( v16 >= 0 )
    {
      ...
      if ( *v17 != (DXGSESSIONDATA *)(this + 2323) )
        __fastfail(3u);
      *(_QWORD *)v18 = this + 2323;
      *(_QWORD *)(v12 + 40) = v17;
      *v17 = v18;
      this[2324] = (DXGSESSIONDATA **)v18;
      ++*(_DWORD *)(v12 + 48);
      if ( a4 )
        *a4 = (struct SESSION_ADAPTER *)v12;
      WdLogSingleEntry3(4LL, a2->HighPart, a2->LowPart, this);
      WdLogGlobalForLineNumber = 3913;
      return 0LL;
    }
