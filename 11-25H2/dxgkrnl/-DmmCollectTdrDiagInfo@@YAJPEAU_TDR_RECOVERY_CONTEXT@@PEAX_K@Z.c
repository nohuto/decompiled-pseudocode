/*
 * XREFs of ?DmmCollectTdrDiagInfo@@YAJPEAU_TDR_RECOVERY_CONTEXT@@PEAX_K@Z @ 0x140250FA4
 * Callers:
...
__int64 __fastcall DmmCollectTdrDiagInfo(struct _TDR_RECOVERY_CONTEXT *a1, void *a2, size_t a3)
{
  ...
  if ( !a1 )
  {
    ...
    WdLogGlobalForLineNumber = 13030;
    return 3221225485LL;
  }
  if ( !a2 )
  {
    WdLogSingleEntry1(2LL, a1);
    WdLogGlobalForLineNumber = 13038;
    return 3221225485LL;
  }
  ...
  if ( v7 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v9 == -2147483643 )
      {
        ...
        result = 2147483653LL;
        WdLogGlobalForLineNumber = 13090;
      }
      else
      {
        if ( v9 < 0 )
  ...
  else
  {
    WdLogSingleEntry1(2LL, 0LL);
    result = 3223191554LL;
    WdLogGlobalForLineNumber = 13056;
  }
  return result;
}
