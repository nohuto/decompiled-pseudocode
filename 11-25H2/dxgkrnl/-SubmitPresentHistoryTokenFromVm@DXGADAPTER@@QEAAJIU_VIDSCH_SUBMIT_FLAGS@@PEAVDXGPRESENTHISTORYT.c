/*
 * XREFs of ?SubmitPresentHistoryTokenFromVm@DXGADAPTER@@QEAAJIU_VIDSCH_SUBMIT_FLAGS@@PEAVDXGPRESENTHISTORYTOKENQUEUE@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@2PEAVCRefCountedBuffer@@II3K@Z @ 0x1403B4660
 * Callers:
        ...
        unsigned int a11)
{
  ...
  struct CRefCountedBuffer *v80; // [rsp+28h] [rbp-450h]
  __int64 v81; // [rsp+30h] [rbp-448h]
...
LABEL_108:
    ...
    *((_QWORD *)v31 + 70) = *(_QWORD *)(*(_QWORD *)(v21 + 112) + 104LL) + 160LL;
    v33 = a5;
    *((_DWORD *)v31 + 142) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 112) + 104LL) + 392LL);
    *((_QWORD *)v31 + 74) = a7;
    *((_QWORD *)v31 + 72) = a4;
    *((_QWORD *)v31 + 73) = a5;
    *((_QWORD *)v31 + 12) = a4;
          ...
          if ( a6 )
          {
            ...
            if ( SizeOfPresentToken )
            {
              ...
              if ( PresentHistoryTokenQueue )
              {
                ...
                COREDEVICEACCESS::AcquireSharedUncheck((COREDEVICEACCESS *)v111, v40);
                if ( PresentHistoryTokenSlot )
                {
                  memmove(PresentHistoryTokenSlot, Src, SizeOfPresentToken);
                  *((_DWORD *)v31 + 1) |= 0x10u;
                  *((_QWORD *)v31 + 12) = PresentHistoryTokenQueue;
                  *((_QWORD *)v31 + 13) = PresentHistoryTokenSlot;
                  v41 = DXGGLOBAL::GetGlobal();
                  v42 = ExAllocateFromLookasideListEx((PLOOKASIDE_LIST_EX)((char *)v41 + 1104));
                  v43 = v42;
                  if ( !v42 )
                    goto LABEL_29;
                  memset(v42, 0, 0x5F8uLL);
                  v43[5] = a9;
                  v44 = (volatile signed __int32 *)Entry;
                  *((_QWORD *)v43 + 187) = v85;
                  *((_BYTE *)v43 + 1512) = 1;
                  v107 = v43;
                  v45 = PrepareIndependentFlipToken(
                          PresentHistoryTokenSlot,
                          (struct DXGK_PRESENT_PARAMS *)v43,
                          v31,
                          v85[0],
                          0LL,
                          (struct CRefCountedBuffer *)v44);
                  LODWORD(v27) = v45;
                  if ( v45 < 0 )
                  {
...
LABEL_85:
      ...
      if ( v85[0] )
      {
        ...
        {
          LOBYTE(v30) = 1;
          v72 = DXGCONTEXT::SynchronizeImplicitQueueWithRenderQueues(v85[0], 0LL, 0, v30, 0LL, 1);
          v27 = v72;
          if ( v72 < 0 )
          {
        ...
        LODWORD(v27) = DXGCONTEXT::SubmitCommandToImplicitQueue(v71, v31);
        goto LABEL_103;
      }
...
LABEL_73:
                  if ( v63 )
                  {
                    ...
                    do
                    {
                      *(_DWORD *)((char *)v118 + v52) = *(v68 - 2);
                      v52 += 4LL;
                      v70 = *v68;
                      v68 += 4;
                      *(_DWORD *)&v116[v52 + 60] = v70;
                      *(_DWORD *)&v115[v52 + 60] = *(v68 - 5);
                      *(_DWORD *)&v115[v52 - 4] = *(v68 - 3);
                      --v69;
                    }
                    while ( v69 );
LABEL_80:
...
LABEL_58:
          v63 = (unsigned int *)(v48 + 40);
          goto LABEL_71;
        }
LABEL_60:
        v63 = (unsigned int *)(v48 + 812);
        goto LABEL_61;
      }
    }
    else
