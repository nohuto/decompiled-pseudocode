/*
 * XREFs of ?QueryLastCompletedPresentId@DXGDEVICE@@QEAAJIPEAU_D3DKMT_PRESENT_STATS@@@Z @ 0x140184F98
 * Callers:
        ...
        struct _D3DKMT_PRESENT_STATS *a3)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v9 )
      PresentStats = BLTQUEUE::QueryPresentStats((BLTQUEUE *)(*(_QWORD *)(v9 + 8) + 2968 * v6), a3);
    else
