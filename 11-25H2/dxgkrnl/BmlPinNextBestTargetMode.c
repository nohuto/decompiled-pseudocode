/*
 * XREFs of BmlPinNextBestTargetMode @ 0x1402D3EC4
 * Callers:
...
__int64 __fastcall BmlPinNextBestTargetMode(__int64 a1, __int64 a2, unsigned __int16 a3, __int64 a4)
{
  ...
  D3DDDI_RATIONAL v37; // [rsp+60h] [rbp-9h] BYREF
      ...
      while ( *(_WORD *)(v6 + a1 + 68) < *(_WORD *)(v6 + a1 + 70) )
      {
        ...
        if ( v22 >= 0 )
        {
          *(_QWORD *)(WdLogNewEntry5_WdTrace(v26, v18, v19, v20) + 24) = v41;
          v27 = (D3DDDI_RATIONAL *)*((_QWORD *)v12 + 18);
          WdLogGlobalForLineNumber = 3523;
          v27[19] = v37;
          v27[20].Numerator = v35;
