/*
 * XREFs of ?DdiResumeContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1403A5468
 * Callers:
 *     ADAPTER_RENDER_DdiResumeContext @ 0x140055D00 (ADAPTER_RENDER_DdiResumeContext.c)
 * Callees:
