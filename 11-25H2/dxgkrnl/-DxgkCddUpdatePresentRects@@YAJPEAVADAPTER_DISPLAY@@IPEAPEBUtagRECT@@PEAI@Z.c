/*
 * XREFs of ?DxgkCddUpdatePresentRects@@YAJPEAVADAPTER_DISPLAY@@IPEAPEBUtagRECT@@PEAI@Z @ 0x140389D24
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( CddInterface )
  {
    ...
    if ( v15 )
    {
      ...
      {
        v9 = *((_QWORD *)a1 + 16);
        v10 = *(_DWORD *)(3984 * v6 + v9 + 636) - *(_DWORD *)(3984 * v6 + v9 + 628);
        v11 = *(_DWORD *)(3984 * v6 + v9 + 640) - *(_DWORD *)(3984 * v6 + v9 + 632);
        v17 = *(tagRECT *)(3984 * v6 + v9 + 688);
