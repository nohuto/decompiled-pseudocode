/*
 * XREFs of ?InitializeParavirtualizedAdapter@DXGADAPTER@@QEAAJPEAUDRIVER_WORKAROUNDS@@@Z @ 0x1401902D4
 * Callers:
...
__int64 __fastcall DXGADAPTER::InitializeParavirtualizedAdapter(DXGADAPTER *this, struct DRIVER_WORKAROUNDS *a2)
{
  ...
  struct _D3DKMT_QUERYADAPTERINFO v62; // [rsp+70h] [rbp-90h] BYREF
  ...
  *((_BYTE *)this + 209) = 1;
  ...
  if ( v57 >= 0x28 )
  {
    ...
    if ( v57 < 0x2C )
      v11 = v57;
    v58 = v11;
    *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) = v11;
...
LABEL_10:
  ...
  *((_DWORD *)DXGGLOBAL::GetGlobal() + 427) = v57;
  Global = DXGGLOBAL::GetGlobal();
  v18 = DpReadDeviceSpace(*((_QWORD *)this + 27), 0LL, (char *)Global + 1712, 0xDCu, 4u, &v56);
  if ( v18 < 0 || v56 != 4 )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v20, v19, v21, v22) + 24) = v18;
    WdLogGlobalForLineNumber = 6621;
  }
  LODWORD(v23) = DXG_GUEST_VIRTUALGPU_VMBUS::CreateVmBusChannel((struct VMBCHANNEL__ **)this + 583, this);
  if ( (int)v23 >= 0 )
  {
    ...
    *((_DWORD *)this + 1188) = v24;
    if ( v24 )
    {
      ...
      *(_DWORD *)a2 = v29;
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) < 0x29u )
        v30 = *(_DWORD *)a2 & 0xFFE3FFFF;
      else
        v30 = ((WORD2(v67[1]) & 0x200) << 11) | *(_DWORD *)a2 & 0xFFE3FFFF | ((WORD2(v67[1]) & 0xC00) << 8) & 0xFFEFFFFF;
      *(_DWORD *)a2 = v30;
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) >= 0x22u )
        *(_QWORD *)((char *)this + 4772) = v67[88];
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) >= 0x28u && (v67[1] & 0x4000000000LL) != 0 )
        *((_BYTE *)DXGGLOBAL::GetGlobal() + 1716) = 1;
...
LABEL_38:
      ...
      else
      {
        if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 1716) )
          *((_QWORD *)this + 584) = **((_QWORD **)DXGGLOBAL::GetGlobal() + 206);
        v59 = 0;
        ...
        *(_QWORD *)&v62.PrivateDriverDataSize = 4LL;
        ...
        if ( v38 >= 0 )
        {
          *((_DWORD *)this + 74) = v59;
          ...
          v61 = 0LL;
          v60 = 0LL;
          v41 = (DXG_GUEST_GLOBAL_VMBUS *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 206);
          LODWORD(v23) = DXG_GUEST_GLOBAL_VMBUS::GetMmioSpaceInfo(v41, &v61, &v60);
          if ( (int)v23 >= 0 )
          {
            v42 = DXGGLOBAL::GetGlobal();
            LODWORD(v23) = DXG_GUEST_GLOBAL_VMBUS::VmBusSendSetIoSpaceRegion(v41, v61, v60, *((_DWORD *)v42 + 419));
            if ( (int)v23 >= 0 )
            {
              v4 = 8;
...
LABEL_61:
  ...
  if ( v4 != 1 && *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) >= 0x1Au )
