/*
 * XREFs of ?ProcessPacket@DXGVMBUSCHANNEL@@QEAAJIPEAUVMBPACKETCOMPLETION__@@PEAXI@Z @ 0x14020592C
 * Callers:
  ...
  if ( ExAcquireRundownProtection(this + 8) )
  {
    ...
    else
    {
      ...
      *((_QWORD *)v17 + 18) = a3;
      ...
      {
        ((void (__fastcall *)(struct VMBPACKETCOMPLETION__ *, _QWORD, _QWORD))qword_14015D3B8)(a3, 0LL, 0LL);
        *((_QWORD *)v12 + 18) = 0LL;
      }
    }
