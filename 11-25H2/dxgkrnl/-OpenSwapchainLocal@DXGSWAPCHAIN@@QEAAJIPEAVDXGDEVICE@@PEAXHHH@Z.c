/*
 * XREFs of ?OpenSwapchainLocal@DXGSWAPCHAIN@@QEAAJIPEAVDXGDEVICE@@PEAXHHH@Z @ 0x1401F9BF0
 * Callers:
...
LABEL_12:
    ...
    *((_DWORD *)v16 + 6) = a5;
    ...
    if ( a4 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v19, a4, v20, 0LL, 0LL, 0LL);
