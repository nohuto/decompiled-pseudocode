/*
 * XREFs of DxgkPresentMultiPlaneOverlay2 @ 0x1401DAA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay2(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 *a1)
{
  ...
  struct _D3DKMT_MULTIPLANE_OVERLAY2 *v58[2]; // [rsp+90h] [rbp-78h] BYREF
  ...
  _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 v69; // [rsp+168h] [rbp+60h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)v55, 2163);
  ...
  *(_OWORD *)v58 = 0LL;
  v54 = CapturePresentMultiPlaneOverlayArgs2(a1, &v69, v58, (struct tagRECT **)&v58[1]);
  if ( v54 < 0 )
  {
...
LABEL_43:
  ...
  if ( v54 >= 0 )
  {
    ...
    {
      v54 = DXGCONTEXT::PresentMultiPlaneOverlay2(
              (DXGCONTEXT *)v17,
              &v69,
