/*
 * XREFs of ?DisplayConfigDestroySimulatedMonitors@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1403D8930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DisplayConfigDestroySimulatedMonitors(struct DXGADAPTER *a1, _QWORD *a2)
{
  ...
  if ( !a2 )
  {
    ...
    WdLogGlobalForLineNumber = 2254;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pContext != NULL", 2254LL, 0LL, 0LL, 0LL, 0LL);
  }
  v5 = a2[1];
