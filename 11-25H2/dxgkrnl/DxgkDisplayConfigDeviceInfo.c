/*
 * XREFs of DxgkDisplayConfigDeviceInfo @ 0x140282AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RequiresSessionModeChangeLockShared@DispConfigTypes@@YA_NW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z @ 0x1400569B4 (-RequiresSessionModeChangeLockShared@DispConfigTypes@@YA_NW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z.c)
 ...
 *     ?RequiresFlushVidSch@DispConfigTypes@@YA_NW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z @ 0x14006DE44 (-RequiresFlushVidSch@DispConfigTypes@@YA_NW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z.c)
...
__int64 __fastcall DxgkDisplayConfigDeviceInfo(char a1, const struct _LUID *a2)
{
  ...
  if ( !a2 )
  {
    ...
    WdLogGlobalForLineNumber = 6954;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"io_pRequestPacket != NULL", 6954LL, 0LL, 0LL, 0LL, 0LL);
