/*
 * XREFs of ?LidStateChangeCallback@DisplayDiagnostics@@CAJPEBU_GUID@@PEAXK1@Z @ 0x14006E660
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *Context)
{
  ...
  if ( ValueLength < 4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"ValueLength >= sizeof(LONG)", 91LL, 0LL, 0LL, 0LL, 0LL);
  }
