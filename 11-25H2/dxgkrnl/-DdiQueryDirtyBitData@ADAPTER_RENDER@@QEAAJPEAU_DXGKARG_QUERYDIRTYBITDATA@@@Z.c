/*
 * XREFs of ?DdiQueryDirtyBitData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDIRTYBITDATA@@@Z @ 0x1401A5020
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiQueryDirtyBitData(
        ADAPTER_RENDER *this,
        struct _DXGKARG_QUERYDIRTYBITDATA *a2,
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5180);
  }
  else
  {
    v17 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5180);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIRTYBITDATA *))(*((_QWORD *)this + 2) + 1600LL))(
  ...
  {
    WdLogSingleEntry1(2LL, v10);
    WdLogGlobalForLineNumber = 5357;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiQueryDirtyBitData. Status: 0x%I64x",
      v10,
      0LL,
      0LL,
      0LL,
