/*
 * XREFs of DpiValidateSpbResource @ 0x14024C5F4
 * Callers:
 *     DpSpbResourceIoControl @ 0x14018AB50 (DpSpbResourceIoControl.c)
 *     DpCloseSpbResource @ 0x14024C1C0 (DpCloseSpbResource.c)
 *     DpReadSpbResource @ 0x14024C220 (DpReadSpbResource.c)
 *     DpWriteSpbResource @ 0x14024C3D0 (DpWriteSpbResource.c)
 * Callees:
 *     <none>
 */
