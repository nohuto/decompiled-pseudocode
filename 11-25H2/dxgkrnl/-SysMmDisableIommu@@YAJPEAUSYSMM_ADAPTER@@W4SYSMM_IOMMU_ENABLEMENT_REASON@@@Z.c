/*
 * XREFs of ?SysMmDisableIommu@@YAJPEAUSYSMM_ADAPTER@@W4SYSMM_IOMMU_ENABLEMENT_REASON@@@Z @ 0x14027DDA0
 * Callers:
 *     SysMmTestDisableIommu @ 0x1400939B0 (SysMmTestDisableIommu.c)
 *     DxgpDisableIommuFromReference @ 0x14019B048 (DxgpDisableIommuFromReference.c)
 ...
 *     ??$SmmAcquirePushLockExclusive@$0DA@@@YAXPEAU?$SYSMM_PUSHLOCK@$0DA@@@@Z @ 0x140051000 (--$SmmAcquirePushLockExclusive@$0DA@@@YAXPEAU-$SYSMM_PUSHLOCK@$0DA@@@@Z.c)
 *     ??$SmmReleasePushLockExclusive@$00@@YAXPEAU?$SYSMM_PUSHLOCK@$00@@@Z @ 0x140051880 (--$SmmReleasePushLockExclusive@$00@@YAXPEAU-$SYSMM_PUSHLOCK@$00@@@Z.c)
  ...
  else if ( (unsigned int)SmmGetIommuInterfaceVersion() >= 2 )
  {
    ...
    *(_QWORD *)(v12 + 32) = v3;
    ...
    if ( v6 >= 0 )
    {
      ...
      {
        LODWORD(v14) = v3;
        McTemplateK0pt_EtwWriteTransfer((__int64)SysMmControlGuid_Context, (__int64)&DisableIommu, v13, a1, v14);
      }
