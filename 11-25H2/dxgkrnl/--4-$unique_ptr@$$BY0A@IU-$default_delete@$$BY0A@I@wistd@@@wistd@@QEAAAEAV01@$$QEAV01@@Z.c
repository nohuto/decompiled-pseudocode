/*
 * XREFs of ??4?$unique_ptr@$$BY0A@IU?$default_delete@$$BY0A@I@wistd@@@wistd@@QEAAAEAV01@$$QEAV01@@Z @ 0x140012998
 * Callers:
...
void **__fastcall wistd::unique_ptr<unsigned int [0],wistd::default_delete<unsigned int [0]>>::operator=(
        void **a1,
        void **a2)
{
  void *v2; // rax
