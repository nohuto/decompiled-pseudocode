/*
 * XREFs of ?DestroyStagingBuffer@BLTQUEUE@@QEAAXXZ @ 0x14027B27C
 * Callers:
...
void __fastcall BLTQUEUE::DestroyStagingBuffer(BLTQUEUE *this)
{
  ...
  *(_BYTE *)(*((_QWORD *)this + 47) + 1937LL) = 1;
  if ( *((_DWORD *)this + 710) )
  {
    DXGHANDLETABLELOCKEXCLUSIVE::DXGHANDLETABLELOCKEXCLUSIVE(
      (DXGHANDLETABLELOCKEXCLUSIVE *)v14,
      (struct DXGPROCESS *)v3);
    v4 = (*((_DWORD *)this + 710) >> 6) & 0xFFFFFF;
    if ( v4 < *(_DWORD *)(v3 + 296) )
    {
      v5 = *(_QWORD *)(v3 + 280);
      if ( ((*((_DWORD *)this + 710) >> 25) & 0x60) == (*(_BYTE *)(v5 + 16LL * v4 + 8) & 0x60)
...
LABEL_10:
            ...
            DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pResource != NULL", 4687LL, 0LL, 0LL, 0LL, 0LL);
            goto LABEL_11;
          }
...
LABEL_21:
  if ( *((_DWORD *)this + 716) )
  {
    v13 = (DXGDEVICESYNCOBJECT *)*((_QWORD *)this + 359);
    if ( v13 )
      DXGDEVICESYNCOBJECT::`scalar deleting destructor'(v13);
    *((_DWORD *)this + 716) = 0;
    *((_QWORD *)this + 359) = 0LL;
  }
  *(_BYTE *)(*((_QWORD *)this + 47) + 1937LL) = 0;
