/*
 * XREFs of ?DxgkEnableDisableTargetAsHMD@@YAJPEAU_D3DKMT_SOFTGPU_LUID_TARGET@@IEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x14040DBBC
 * Callers:
  ...
  if ( a2 )
  {
    ...
    do
    {
        ...
        if ( v13 >= 0 )
        {
          if ( *((_QWORD *)v12 + 390) )
          {
            ...
            if ( v16 < 0 )
            {
              ...
              WdLogGlobalForLineNumber = 11841;
      ...
      else
      {
        ...
        v19 = *v8;
        WdLogGlobalForLineNumber = 11807;
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          0xFFFFFFFFLL,
