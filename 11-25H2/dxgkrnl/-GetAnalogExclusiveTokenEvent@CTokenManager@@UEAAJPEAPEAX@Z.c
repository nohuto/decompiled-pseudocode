/*
 * XREFs of ?GetAnalogExclusiveTokenEvent@CTokenManager@@UEAAJPEAPEAX@Z @ 0x140098140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OpenEventForSynchonize@CTokenManager@@CAJPEAXPEAPEAX_N@Z @ 0x14009835C (-OpenEventForSynchonize@CTokenManager@@CAJPEAXPEAPEAX_N@Z.c)
 */
