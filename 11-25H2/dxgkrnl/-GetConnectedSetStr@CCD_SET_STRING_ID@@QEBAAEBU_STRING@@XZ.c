/*
 * XREFs of ?GetConnectedSetStr@CCD_SET_STRING_ID@@QEBAAEBU_STRING@@XZ @ 0x14036BE7C
 * Callers:
 ...
 *     ?_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z @ 0x14036C034 (-_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z.c)
