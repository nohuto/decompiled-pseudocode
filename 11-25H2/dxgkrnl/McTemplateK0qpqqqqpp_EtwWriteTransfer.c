/*
 * XREFs of McTemplateK0qpqqqqpp_EtwWriteTransfer @ 0x140014670
 * Callers:
...
__int64 __fastcall McTemplateK0qpqqqqpp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &Present, a3, 9LL, v12);
}
