/*
 * XREFs of ?UpdateStatsForIndependentFlip@CompositionSurfaceObject@@QEAAX_KAEBUDXGI_FRAME_STATISTICS@@I@Z @ 0x140037B1C
 * Callers:
        ...
        int a4)
{
  ...
  *((_QWORD *)v5 + 1) = PsGetCurrentThreadId();
  if ( *((_DWORD *)this + 34) )
  {
    for ( i = (__int64 *)*((_QWORD *)this + 15); i != (__int64 *)((char *)this + 120); i = (__int64 *)*i )
    {
      if ( *(i - 1) == a2 )
      {
        v10 = *(_OWORD *)a3;
