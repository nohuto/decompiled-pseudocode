/*
 * XREFs of ?_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ @ 0x14026D8D8
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = this;
  ...
  if ( g_IsInternalRelease || (*(_DWORD *)(*((_QWORD *)this[3] + 2) + 444LL) & 0x200) != 0 )
  {
    v9 = 0;
    v10 = 0;
    qword_14015BF98 = (__int64)&v9;
    qword_14015BFA8 = (__int64)&v9;
    qword_14015BFD0 = (__int64)&v10;
    qword_14015BFE0 = (__int64)&v10;
    RtlQueryRegistryValuesEx(2LL, L"GraphicsDrivers", &unk_14015BF80, 0LL, 0LL);
    if ( v9 )
      *((_BYTE *)this + 92) = 0;
    if ( v10 )
      *((_BYTE *)this + 19) = 0;
