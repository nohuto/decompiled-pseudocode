/*
 * XREFs of ?VmBusLogEventGlobal@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14021E830
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusLogEventGlobal(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v1 )
  {
    ...
    if ( *(_DWORD *)(v2 + 24) == 1 && !_InterlockedCompareExchange(&dword_14015DC60, 1, 0) )
