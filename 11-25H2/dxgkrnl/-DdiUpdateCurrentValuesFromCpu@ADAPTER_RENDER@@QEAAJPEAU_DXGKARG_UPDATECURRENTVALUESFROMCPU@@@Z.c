/*
 * XREFs of ?DdiUpdateCurrentValuesFromCpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATECURRENTVALUESFROMCPU@@@Z @ 0x14006A3E4
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateCurrentValuesFromCpu @ 0x14006C180 (ADAPTER_RENDER_DdiUpdateCurrentValuesFromCpu.c)
 * Callees:
