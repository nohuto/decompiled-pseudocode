/*
 * XREFs of ?ReadDpiFromRegistry@DpiPersistence@@YAJAEBU_LUID@@IHPEAK@Z @ 0x1403680C0
 * Callers:
        ...
        struct _UNICODE_STRING *a4)
{
  ...
  *(_DWORD *)&a4->Length = 0;
  ...
  if ( (int)v7 >= 0 )
  {
    ...
    {
      if ( DXGSESSIONDATA::GetUserRegistryPath(SessionData, 0, v12, v13)->Length )
      {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v22 >= 0 )
    {
      ...
      if ( !KeyHandle )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"HKeyRootHandle", 880LL, 0LL, 0LL, 0LL, 0LL);
        v24 = KeyHandle;
      }
      ...
      *(_OWORD *)&v39.SecurityDescriptor = 0LL;
      ...
      if ( !v33 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"PerMonSettingsKeyHandle", 896LL, 0LL, 0LL, 0LL, 0LL);
        v26 = v33;
      }
      ...
      if ( !v34 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"MonitorIdKeyHandle", 912LL, 0LL, 0LL, 0LL, 0LL);
        v28 = v34;
      }
      v40 = 0LL;
      v41 = 288;
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v23, v7, 0LL, 0LL, 0LL, 0LL);
  }
LABEL_24:
