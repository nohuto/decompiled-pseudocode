/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1403B3EC4
 * Callers:
 *     ADAPTER_RENDER_DdiSetContextSchedulingProperties @ 0x140052670 (ADAPTER_RENDER_DdiSetContextSchedulingProperties.c)
 * Callees:
