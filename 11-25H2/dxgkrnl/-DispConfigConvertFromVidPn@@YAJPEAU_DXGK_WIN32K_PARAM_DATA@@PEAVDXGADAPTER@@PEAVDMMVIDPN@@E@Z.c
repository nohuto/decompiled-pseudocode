/*
 * XREFs of ?DispConfigConvertFromVidPn@@YAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAVDXGADAPTER@@PEAVDMMVIDPN@@E@Z @ 0x1401BFF18
 * Callers:
        ...
        __int64 a4)
{
  ...
  v19 = 0LL;
  v17 = v7;
  Pool2 = (unsigned __int64 *)ExAllocatePool2(256LL, 216 * v7, 1313891414LL, a4);
  v18 = Pool2;
  v9 = Pool2;
  a1->PathsArray = Pool2;
  if ( Pool2 )
