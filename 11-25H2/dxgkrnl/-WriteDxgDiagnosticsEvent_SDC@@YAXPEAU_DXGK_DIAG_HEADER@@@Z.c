/*
 * XREFs of ?WriteDxgDiagnosticsEvent_SDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14005A4B8
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_SDC(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304800) )
  {
    if ( (unsigned int)dword_14015B5F0 > 1
      && tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000001LL)
      && tlgKeywordOn((__int64)&dword_14015B5F0, v2) )
    {
      v6 = &unk_14013B0C4;
LABEL_11:
      v8 = *((_WORD *)a1 + 2);
