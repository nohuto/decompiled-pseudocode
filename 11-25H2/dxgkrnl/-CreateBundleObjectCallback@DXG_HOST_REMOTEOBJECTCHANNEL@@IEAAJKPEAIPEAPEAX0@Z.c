/*
 * XREFs of ?CreateBundleObjectCallback@DXG_HOST_REMOTEOBJECTCHANNEL@@IEAAJKPEAIPEAPEAX0@Z @ 0x1403FBB80
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  BundleObjectInternal = DxgkCreateBundleObjectInternal(0, 0, v9, 0, (__int64)v29, (__int64)a4);
