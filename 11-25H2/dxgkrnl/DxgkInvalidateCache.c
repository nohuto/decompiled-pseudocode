/*
 * XREFs of DxgkInvalidateCache @ 0x1401B0FF0
 * Callers:
...
__int64 __fastcall DxgkInvalidateCache(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid process context", 34LL, 0LL, 0LL, 0LL, 0LL);
LABEL_34:
