/*
 * XREFs of ?ValidateGdiCommand@@YAEIIPEBE00_K1PEBUtagRECT@@2IIEEIPEAPEAE@Z @ 0x1402183AC
 * Callers:
...
LABEL_32:
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v21, v18, 0LL, 0LL, 0LL, 0LL);
  return 0;
}
