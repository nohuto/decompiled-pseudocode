/*
 * XREFs of DpiMiracastGetDeviceContextFromLuid @ 0x14007E5BC
 * Callers:
...
__int64 *__fastcall DpiMiracastGetDeviceContextFromLuid(__int64 a1, char a2)
{
  ...
  v4 = (__int64 *)qword_14015E200;
  if ( (__int64 *)qword_14015E200 == &qword_14015E200 )
    goto LABEL_8;
  do
  {
    v5 = v4;
  ...
  while ( v4 != &qword_14015E200 );
  if ( v4 == &qword_14015E200 )
  {
LABEL_8:
    v5 = 0LL;
  }
