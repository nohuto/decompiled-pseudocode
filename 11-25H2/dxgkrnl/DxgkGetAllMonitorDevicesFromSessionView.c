/*
 * XREFs of DxgkGetAllMonitorDevicesFromSessionView @ 0x1402E8FAC
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( !PrimaryDisplaySource )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDisplaySource != NULL", 1320LL, 0LL, 0LL, 0LL, 0LL);
  }
  v14 = v70;
...
LABEL_37:
      ...
      v45 = v65;
LABEL_38:
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v41, v45, v44, v43, v39, 0LL);
      goto LABEL_39;
    }
    v73 = 0LL;
    v72 = retaddr;
    MONITOR_REF_ACCESSOR::AddReference((MONITOR_REF_ACCESSOR *)&v72);
    MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v37, v36, 1, (struct MONITOR_REF_ACCESSOR *)&v72);
    v22 = MonitorInstance;
    if ( MonitorInstance != -1073741275 )
    {
      ...
      *(_DWORD *)(v48 + 4 * v46) = 536870913;
      ...
      v51 = (struct DXGGLOBAL *)((char *)v49 + 1352);
      ...
      else
      {
        ...
        *(_QWORD *)(v71 + 4 * v46 + 8) = v15;
        ...
        HashBitMask = DXGADAPTERSOURCEHASH::GetHashBitMask(v67);
        v57 = v74;
