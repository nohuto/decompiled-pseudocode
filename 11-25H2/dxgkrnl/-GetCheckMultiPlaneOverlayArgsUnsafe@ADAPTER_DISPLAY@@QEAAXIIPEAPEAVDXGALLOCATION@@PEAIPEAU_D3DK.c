/*
 * XREFs of ?GetCheckMultiPlaneOverlayArgsUnsafe@ADAPTER_DISPLAY@@QEAAXIIPEAPEAVDXGALLOCATION@@PEAIPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@1PEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@@Z @ 0x1402A3360
 * Callers:
        ...
        struct _D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE *a8)
{
  ...
  if ( this[80] != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsDisplayStateMutexOwner()", 10504LL, 0LL, 0LL, 0LL, 0LL);
  }
  v42 = 0;
  v11 = 0;
  v41 = 0;
...
LABEL_10:
    ...
    v18 = *(_DWORD *)((char *)v17 + v16 + 3748);
    if ( v18 <= *(_DWORD *)((char *)v17 + v16 + 3744) )
      v18 = *(_DWORD *)((char *)v17 + v16 + 3744);
    if ( !v18 )
    {
LABEL_32:
      v30 = this[16];
      v8 = 0;
      if ( *((_BYTE *)v30 + v16 + 3704) )
      {
        if ( !*((_BYTE *)v30 + v16 + 3708) )
          goto LABEL_10;
        v31 = v12;
        v15[v31].VidPnSourceId = v14;
        v15[v31].PostComposition.Flags.Value = 0;
        v15[v31].PostComposition.SrcRect = *(RECT *)((char *)this[16] + v16 + 3712);
        v32 = *(RECT *)((char *)this[16] + v16 + 3728);
        v15[v31].PostComposition.Rotation = D3DDDI_ROTATION_IDENTITY;
        v15[v31].PostComposition.DstRect = v32;
      }
      else
      {
        LatestPostCompositionConfigInternal = DISPLAY_SOURCE::GetLatestPostCompositionConfigInternal((struct _KTHREAD *)((char *)v30 + 3984 * v14));
    ...
    while ( 1 )
    {
      v23 = this[16];
      v24 = 0LL;
      if ( *((_BYTE *)v23 + v16 + v19 + 2888) )
      {
        if ( (*(_DWORD *)((_BYTE *)v23 + v21 + 2912) & 1) != 0 )
          v24 = (struct _KTHREAD *)((char *)v23 + 3984 * v14 + v20 + 2904);
        v25 = v14;
        v26 = v24 == 0LL;
      }
      else
      {
        LatestPlaneConfigInternal = DISPLAY_SOURCE::GetLatestPlaneConfigInternal(
                                      (struct _KTHREAD *)((char *)v23 + 3984 * v22),
                                      v8);
        v21 = v39;
