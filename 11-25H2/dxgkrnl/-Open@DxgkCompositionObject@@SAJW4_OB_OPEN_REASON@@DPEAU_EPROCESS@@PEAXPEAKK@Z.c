/*
 * XREFs of ?Open@DxgkCompositionObject@@SAJW4_OB_OPEN_REASON@@DPEAU_EPROCESS@@PEAXPEAKK@Z @ 0x1400185E0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetGlobal@DXGGLOBAL@@SAPEAV1@XZ @ 0x140018F10 (-GetGlobal@DXGGLOBAL@@SAPEAV1@XZ.c)
 *     McTemplateK0zqqzxxxxx_EtwWriteTransfer @ 0x140019D30 (McTemplateK0zqqzxxxxx_EtwWriteTransfer.c)
 *     W32GetCurrentThreadNonPaged @ 0x140070034 (W32GetCurrentThreadNonPaged.c)
    ...
    || (v11 = PsGetProcessSessionIdEx(a3), v11 != -1) && v11 == *(_DWORD *)(a4 + 8) )
  {
    ...
    if ( v12 >= 0 )
    {
        ...
        if ( *CurrentThreadNonPaged )
        {
                ...
                ProcessSessionId == (unsigned int)PsGetProcessSessionIdEx(CurrentThreadProcess)) )
          {
            if ( *(_DWORD *)(*v16 + 376LL) )
            {
              ...
              if ( (*(int (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 8LL))(*v16) <= 1 )
              {
                WdLogSingleEntry0(1LL);
      ...
      else if ( v32[0] )
      {
        ...
        (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 16LL))(v32[0]);
      }
    }
  }
  else
