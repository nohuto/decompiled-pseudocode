/*
 * XREFs of ?DdiDestroyPeriodicFrameNotification@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1403E8BE0
 * Callers:
 *     ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification @ 0x14005B700 (ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5075);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 5075);
  ...
  v10 = (*(int (__fastcall **)(struct _DXGKARG_DESTROYPERIODICFRAMENOTIFICATION *))(*((_QWORD *)this + 2) + 1152LL))(a2);
  if ( v23[0] )
