/*
 * XREFs of ?DxgkpExpandStackAndCreateStandardAllocation@@YAJPEAVDXGDEVICE@@PEAU_D3DKM_CREATESTANDARDALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1403C4210
 * Callers:
        ...
        struct COREDEVICEACCESS *a3)
{
  ...
  v9[2] = a3;
  v10 = 0LL;
  v6 = KeExpandKernelStackAndCalloutEx((PEXPAND_STACK_CALLOUT)CreateStandardAllocCallout, v9, 0x6000uLL, 1u, 0LL);
  if ( v6 >= 0 )
  ...
  DxgkLogInternalTriageEvent(
    ...
    0x40000,
    0xFFFFFFFFLL,
    L"Failed to expand kernel stack: 0x%I64x",
    v8,
    0LL,
    0LL,
    0LL,
