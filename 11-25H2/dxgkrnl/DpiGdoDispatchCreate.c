/*
 * XREFs of DpiGdoDispatchCreate @ 0x1403A5CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiGdoDispatchCreate(__int64 a1, IRP *a2)
{
  ...
  else if ( *(_BYTE *)(v3 + 1153) && *(_BYTE *)(v3 + 480) )
  {
    v6 = !DxgkIsMSBDDFallbackEnabled() ? 0xC0000001 : 0;
  }
  else if ( *(_BYTE *)(v3 + 5597) )
  {
    v6 = -1073741823;
  }
  else
  {
    ...
    v4 = (struct _ERESOURCE *)(v3 + 3928);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v3 + 3928), 1u);
    v5 = *(_DWORD *)(v3 + 236);
