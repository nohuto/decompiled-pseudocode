/*
 * XREFs of ?WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXW4MonitorDataStoreBehavior@2@PEBG_K@Z @ 0x1402774F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$WriteData@_K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBG_K@Z @ 0x140276BC4 (--$WriteData@_K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBG_K@Z.c)
 */
...
void __fastcall DxgMonitor::MonitorDataStore::WriteQWord(__int64 a1, char a2, const WCHAR *a3, __int64 a4)
{
  ...
  if ( (a2 & 4) != 0 )
  {
    ...
    wil::details::unique_storage<wil::details::resource_policy<void *,long (*)(void *),&long ZwClose(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
      ...
      0LL);
    if ( v7(v4, 0LL, v9) >= 0 )
      DxgMonitor::MonitorDataStore::WriteData<unsigned __int64>(v8, v9[0], a3, a4);
