/*
 * XREFs of DpiFdoHandleTargetConnectionState @ 0x14023BD30
 * Callers:
...
LABEL_30:
  ...
  v15 = v13 & 0xF000000;
  if ( (_DWORD)v15 == 83886080 || (_DWORD)v15 == 100663296 )
  {
    if ( ChildDescriptor[6] )
    {
      ...
      WdLogGlobalForLineNumber = 19864;
      goto LABEL_30;
    }
    if ( IsInternalVideoOutput(v14) )
    {
      ...
      v33 = 4;
      WdLogSingleEntry1(2LL, -1073741811LL);
      WdLogGlobalForLineNumber = 19879;
      goto LABEL_30;
    }
    if ( DpiFdoGetChildDescriptor(a1, *(_DWORD *)(a3 + 16)) )
    {
      if ( v24 == v25 )
      {
        ...
        v33 = 3;
        WdLogSingleEntry1(2LL, -1073741811LL);
        WdLogGlobalForLineNumber = 19896;
        goto LABEL_30;
      }
    }
    else
  ...
  {
    if ( (_DWORD)v15 != 0x4000000 )
      goto LABEL_31;
    v34 = *(_DWORD *)(a1 + 3616);
    Pool2 = (unsigned int *)ExAllocatePool2(256LL, 4LL * v34, 1953656900LL, v15);
    if ( !Pool2 )
    {
      v6 = 0x80000000;
      v7 = -1073741801;
      ...
      WdLogGlobalForLineNumber = 19954;
      goto LABEL_30;
    }
      ...
      while ( v17 )
      {
        ...
        if ( v19[6] != v20 )
        {
          ...
          if ( v22 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 20006;
            goto LABEL_17;
          }
        }
