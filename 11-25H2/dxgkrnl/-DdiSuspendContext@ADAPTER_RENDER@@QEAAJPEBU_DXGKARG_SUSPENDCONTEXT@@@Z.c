/*
 * XREFs of ?DdiSuspendContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1403BF924
 * Callers:
 *     ADAPTER_RENDER_DdiSuspendContext @ 0x1400554F0 (ADAPTER_RENDER_DdiSuspendContext.c)
 * Callees:
