/*
 * XREFs of DpiFdoValidateKmdAndPnpVersionMatch @ 0x1403F64B0
 * Callers:
 ...
 *     ?RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x14007CB54 (-RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z.c)
 *     __security_check_cookie @ 0x14009F860 (__security_check_cookie.c)
 *     IsKnownMismatchedVersionedDriver @ 0x140235D28 (IsKnownMismatchedVersionedDriver.c)
...
LABEL_37:
  ...
  {
    if ( (unsigned int)dword_14015B660 > 5 && tlgKeywordOn((__int64)&dword_14015B660, 0x400000000100LL) )
    {
      v35 = *(_DWORD *)(a1 + 1140);
      v36 = *(_DWORD *)(a1 + 1136);
      v37 = *(_DWORD *)(a1 + 1132);
