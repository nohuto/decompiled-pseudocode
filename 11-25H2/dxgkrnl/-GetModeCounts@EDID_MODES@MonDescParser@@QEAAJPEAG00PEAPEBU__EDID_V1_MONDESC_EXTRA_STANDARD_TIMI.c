/*
 * XREFs of ?GetModeCounts@EDID_MODES@MonDescParser@@QEAAJPEAG00PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@00@Z @ 0x14003D4D8
 * Callers:
 ...
 * Callees:
 *     ?Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x14003D788 (-Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 ...
 *     ?DenseOnesBitCount@MonDescParser@@YAEE@Z @ 0x14003DF68 (-DenseOnesBitCount@MonDescParser@@YAEE@Z.c)
 ...
 *     ?IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ @ 0x140064734 (-IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ.c)
 ...
 *     ?GetLocalNumOfDetTim@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAAEXZ @ 0x140096600 (-GetLocalNumOfDetTim@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAAEXZ.c)
 */
