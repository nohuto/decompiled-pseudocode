/*
 * XREFs of BmlCompareSourceModesWithMonitors @ 0x1402C7808
 * Callers:
 *     BmlCompareSourceModes @ 0x1402C7150 (BmlCompareSourceModes.c)
 * Callees:
 *     ??$DIFF@H@@YAHHH@Z @ 0x14004FCDC (--$DIFF@H@@YAHHH@Z.c)
 ...
 *     ??$BmlCompareValues@H@@YA?AW4BML_COMPARISON_RESULT@@HH@Z @ 0x1402C7A80 (--$BmlCompareValues@H@@YA-AW4BML_COMPARISON_RESULT@@HH@Z.c)
 */
