/*
 * XREFs of ?DdiUpdateFlipQueueLog@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEFLIPQUEUELOG@@@Z @ 0x14001FC48
 * Callers:
 *     ADAPTER_DISPLAY_DdiUpdateFlipQueueLog @ 0x14001FC30 (ADAPTER_DISPLAY_DdiUpdateFlipQueueLog.c)
 * Callees:
