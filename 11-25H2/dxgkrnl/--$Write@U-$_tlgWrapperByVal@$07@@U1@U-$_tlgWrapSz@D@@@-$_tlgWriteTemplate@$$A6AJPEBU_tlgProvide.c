/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapSz@D@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBX1IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteAgg@@YAJ011I2@ZPEBX@@SAJPEBU_tlgProvider_t@@PEBX1AEBU?$_tlgWrapperByVal@$07@@2AEBU?$_tlgWrapSz@D@@@Z @ 0x140007184
 * Callers:
 *     ?LogWaitForVsyncCalls@BLTQUEUE@@AEAAXXZ @ 0x1403C7BC0 (-LogWaitForVsyncCalls@BLTQUEUE@@AEAAXXZ.c)
 * Callees:
 *     _tlgWriteAgg @ 0x14005F950 (_tlgWriteAgg.c)
        ...
        const CHAR **a6)
{
  ...
  v14 = 8LL;
  v12 = 8LL;
  return tlgWriteAgg((int)&dword_14015B5B8, a2, 0, 5, &v10);
}
