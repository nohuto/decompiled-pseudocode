/*
 * XREFs of DxgkFillBufferWithDirty @ 0x14020AE04
 * Callers:
...
__int64 __fastcall DxgkFillBufferWithDirty(_QWORD *a1, int a2, struct _LUID *a3, unsigned int a4, __int64 a5)
{
  __int64 v7; // rbx
  __int64 v9; // [rsp+28h] [rbp-30h]
  DWORD LowPart; // [rsp+30h] [rbp-28h]

  v7 = (int)ADAPTER_RENDER::LiveMigrationTransferDirtyContent(a1[391], a2, a3, a4, 0, a5);
  if ( bTracingEnabled )
  {
    LowPart = a3->LowPart;
    ...
    DxgkLogInternalTriageEvent(
      ...
      196626,
      0xFFFFFFFFLL,
      L"DxgkFillBufferWithDirty called with status %1",
      v7,
      0LL,
      0LL,
      0LL,
