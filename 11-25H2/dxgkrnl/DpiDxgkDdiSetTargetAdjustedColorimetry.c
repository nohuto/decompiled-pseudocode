/*
 * XREFs of DpiDxgkDdiSetTargetAdjustedColorimetry @ 0x14024DA4C
 * Callers:
...
__int64 __fastcall DpiDxgkDdiSetTargetAdjustedColorimetry(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)(a1 + 1120) )
  {
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
    {
      v23 = 0;
      v21 = a3;
      McTemplateK0pqq_EtwWriteTransfer(a1, (__int64)&EventEnterDdiSetTargetAdjustedColorimetry, a3, a2, v21, v23);
    }
    v9 = *(_DWORD *)(a4 + 48);
    v10 = *(_OWORD *)(a4 + 16);
    v24[0] = *(_OWORD *)a4;
    ...
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
    {
      LODWORD(v22) = v13;
      LODWORD(v20) = v5;
      McTemplateK0pqq_EtwWriteTransfer(v15, (__int64)&EventExitDdiSetTargetAdjustedColorimetry, v16, a2, v20, v22);
    }
