/*
 * XREFs of ?ReleaseModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x140351160
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE *const a3)
{
  ...
  __int64 v8; // r9
  __int64 v9; // rax
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v10; // rdx
  char *v11; // r9
  DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *v12; // rcx
  char *v13; // rcx
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, (__int64)a3, 7004);
  }
  else
  {
    v25 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 7004);
...
LABEL_20:
        ...
        v12 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)*((_QWORD *)this + 6);
        if ( v12 != (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)((char *)this + 48) )
        {
          v13 = (char *)v12 - 8;
          if ( v13 )
          {
            while ( v13 != v11 )
            {
              v14 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)*((_QWORD *)v13 + 1);
              v13 = (char *)v14 - 8;
