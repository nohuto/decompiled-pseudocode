/*
 * XREFs of ?_ReadPath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIQEAGPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1402EAD70
 * Callers:
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a5)
{
  ...
  v7 = a3;
  RegistryValues = CcdReadRegistryValues(a2, a4, &unk_14015B840, 13LL, a5);
  v9 = *(unsigned int *)a5;
  *(_QWORD *)a5 = v9;
  v10 = RegistryValues;
  if ( RegistryValues < 0 )
  ...
  else
  {
    if ( (v9 & 0x100) != 0 )
    {
      v13 = CcdReadRegistryValues(a2, a4, &unk_14015BC00, 6LL, a5);
      v10 = v13;
      if ( v13 < 0 )
      {
        WdLogSingleEntry4(3LL, v13, a2, v7, a5);
        WdLogGlobalForLineNumber = 1920;
        v15 = CcdReadRegistryValues(a2, 0LL, &unk_14015BDC0, 8LL, a5);
        if ( v15 < 0 )
        {
    ...
    if ( (v9 & 0x800000) != 0 )
    {
      v11 = CcdReadRegistryValues(a2, a4, &unk_14015B720, 5LL, a5);
      v10 = v11;
      if ( v11 < 0 )
      {
