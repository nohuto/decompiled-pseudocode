/*
 * XREFs of ?CollectPathsFromLegacyVidPn@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@QEAAJPEAVDMMVIDPN@@@Z @ 0x140261FDC
 * Callers:
        ...
        struct DMMVIDPN *a2)
{
  ...
  CCD_TOPOLOGY::SetUsedReservedFields(*(_QWORD *)this, &v19, 96LL);
  ...
  AUTO_CCD_TOPOLOGY_CLEAR_RESERVED::~AUTO_CCD_TOPOLOGY_CLEAR_RESERVED((AUTO_CCD_TOPOLOGY_CLEAR_RESERVED *)&v19);
