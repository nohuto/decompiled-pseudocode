/*
 * XREFs of ?GetInfoInternal@CFlipExBuffer@@QEBAJPEAUCSM_BUFFER_INFO@@@Z @ 0x140012650
 * Callers:
 *     ?GetInfo@CFlipExBuffer@@UEBAJPEAUCSM_BUFFER_INFO@@@Z @ 0x1400124D0 (-GetInfo@CFlipExBuffer@@UEBAJPEAUCSM_BUFFER_INFO@@@Z.c)
 ...
 *     wcsrchr_0 @ 0x1400652EF (wcsrchr_0.c)
 */
...
LABEL_7:
    ...
    {
      v9 = ProcessInformationLength + 2LL;
      if ( v9 <= 0x7FFFFFFF )
      {
        Pool2 = (const wchar_t **)ExAllocatePool2(256LL, v9, 1649234755LL, v8);
        v11 = Pool2;
        if ( Pool2 )
        {
