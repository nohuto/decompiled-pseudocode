/*
 * XREFs of DxgkCheckSinglePlaneForMultiPlaneOverlaySupport @ 0x1403D66D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  *(_OWORD *)v42 = 0LL;
  ...
  if ( v40[2] != 1 )
  {
    ...
    WdLogGlobalForLineNumber = 10556;
  ...
  if ( LODWORD(v41[1]) )
  {
    ...
    WdLogGlobalForLineNumber = 10568;
  ...
  *((_QWORD *)&v44 + 1) = v46;
  ...
  if ( (v46[0] & 4) == 0 )
  {
    ...
    WdLogGlobalForLineNumber = 10620;
  ...
  if ( !v39 )
  {
    ...
    WdLogGlobalForLineNumber = 10630;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      0xFFFFFFFFLL,
  ...
  WdLogGlobalForLineNumber = 10645;
  COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)v47);
  DXGDEVICEACCESSLOCKEXCLUSIVE::~DXGDEVICEACCESSLOCKEXCLUSIVE((DXGDEVICEACCESSLOCKEXCLUSIVE *)v45);
  if ( v37 && _InterlockedExchangeAdd64((volatile signed __int64 *)v37 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v37 + 2), v37);
