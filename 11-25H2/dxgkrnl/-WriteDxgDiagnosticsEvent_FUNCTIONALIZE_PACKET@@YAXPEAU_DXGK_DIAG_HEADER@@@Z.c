/*
 * XREFs of ?WriteDxgDiagnosticsEvent_FUNCTIONALIZE_PACKET@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140053CE0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_FUNCTIONALIZE_PACKET(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000800LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
