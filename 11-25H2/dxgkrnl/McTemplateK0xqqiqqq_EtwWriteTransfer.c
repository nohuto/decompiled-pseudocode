/*
 * XREFs of McTemplateK0xqqiqqq_EtwWriteTransfer @ 0x140092494
 * Callers:
...
NTSTATUS McTemplateK0xqqiqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventBltQueueVSyncDPC, a3, 8u, &v4);
}
