/*
 * XREFs of ?DdiQueryDPCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_QUERYDPCAPS@@@Z @ 0x1401A4AB8
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiQueryDPCaps(ADAPTER_DISPLAY *this, struct _DXGKARG_QUERYDPCAPS *a2, __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5149);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5149);
        ...
        v12 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiQueryDPCaps. Status: 0x%I64x",
      v12,
      0LL,
      0LL,
      0LL,
