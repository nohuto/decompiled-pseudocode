/*
 * XREFs of DpiAcquirePostDisplayInfoFromBgfx @ 0x1403F96D0
 * Callers:
...
__int64 __fastcall DpiAcquirePostDisplayInfoFromBgfx(__int64 a1, char a2, char a3)
{
  ...
  __int64 v24; // r9
  __int64 v25; // rax
  _BYTE v26[4]; // [rsp+20h] [rbp-88h] BYREF
  NTSTATUS v27; // [rsp+24h] [rbp-84h]
  __int128 v28; // [rsp+28h] [rbp-80h] BYREF
  __int128 v29; // [rsp+38h] [rbp-70h]
  ...
  v8 = 0;
  v27 = ZwQuerySystemInformation(MaxSystemInfoClass|SystemTimeAdjustmentInformation, &SystemInformation, 0x20u, 0LL);
  if ( v27 >= 0 )
  {
...
LABEL_15:
  ...
  if ( v4 )
  {
    DxgDetermineBootImageMode(a1, 0LL, v4, v26);
    if ( !v26[0] || (int)InbvSetVirtualFrameBuffer(0LL, DpiEnterSystemDisplay) < 0 )
      goto LABEL_21;
  }
  else
  {
...
LABEL_21:
    ...
    if ( v21 >= 0 )
      goto LABEL_36;
    Pool2 = (void *)ExAllocatePool2(64LL, (unsigned int)v23, 1953656900LL, v22);
    v25 = ExAllocatePool2(64LL, 32LL, 1953656900LL, v24);
    v20 = (void *)v25;
    if ( !Pool2 || !v25 )
      goto LABEL_36;
    KeInitializeSpinLock((PKSPIN_LOCK)(v25 + 24));
    *(_QWORD *)&v29 = v20;
    *(_QWORD *)&v28 = Pool2;
    *((_QWORD *)&v28 + 1) = v23;
    if ( !v3 || DWORD2(SystemInformation) > 0xBB8 || (BYTE8(v30) = 0, HIDWORD(SystemInformation) > 0x7D0) )
      BYTE8(v30) = 1;
    if ( (int)InbvSetVirtualFrameBuffer(&v28, DpiEnterSystemDisplay) >= 0 )
    {
      DxgDetermineBootImageMode(a1, &v28, 0, v26);
      v17 = v26[0];
    }
    else
    {
