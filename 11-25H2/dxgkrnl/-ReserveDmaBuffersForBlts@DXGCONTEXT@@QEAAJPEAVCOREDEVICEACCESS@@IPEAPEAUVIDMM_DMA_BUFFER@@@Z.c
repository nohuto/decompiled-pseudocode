/*
 * XREFs of ?ReserveDmaBuffersForBlts@DXGCONTEXT@@QEAAJPEAVCOREDEVICEACCESS@@IPEAPEAUVIDMM_DMA_BUFFER@@@Z @ 0x1402FFF94
 * Callers:
        ...
        struct VIDMM_DMA_BUFFER **a4)
{
  ...
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 7889;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"!m_ppBltDmaBuffers", 7889LL, 0LL, 0LL, 0LL, 0LL);
  }
  LODWORD(v8) = 0;
  if ( (_DWORD)v6 )
  {
