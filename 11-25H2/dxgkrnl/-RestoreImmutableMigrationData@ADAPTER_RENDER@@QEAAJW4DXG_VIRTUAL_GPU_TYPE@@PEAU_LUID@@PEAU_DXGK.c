/*
 * XREFs of ?RestoreImmutableMigrationData@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@PEAU_DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA@@@Z @ 0x1402086B4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::RestoreImmutableMigrationData(__int64 a1, int a2, struct _LUID *a3, _DWORD *a4)
{
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"RestoreImmutableMigrationData called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v7,
      v16,
