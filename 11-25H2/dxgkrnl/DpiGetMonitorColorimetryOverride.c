/*
 * XREFs of DpiGetMonitorColorimetryOverride @ 0x14024DD24
 * Callers:
 *     ?GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z @ 0x140276650 (-GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z.c)
 * Callees:
 ...
 *     DpiFdoValidateDxgkColorimetry @ 0x1403C18B4 (DpiFdoValidateDxgkColorimetry.c)
 */
