/*
 * XREFs of DpiDxgkDdiNotifySurpriseRemoval @ 0x14024D938
 * Callers:
...
__int64 __fastcall DpiDxgkDdiNotifySurpriseRemoval(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( (v4 & 0x18) != 0 && *(_DWORD *)(a1 + 136) >= 0x300Du && *(_QWORD *)(a1 + 792) )
  {
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
      McTemplateK0pqq_EtwWriteTransfer(a1, (__int64)&EventEnterDdiNotifySurpriseRemoval, a3, a2, a4, 0);
    ...
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
    {
      LODWORD(v17) = v9;
      LODWORD(v16) = v6;
      McTemplateK0pqq_EtwWriteTransfer(v11, (__int64)&EventExitDdiNotifySurpriseRemoval, v12, a2, v16, v17);
    }
