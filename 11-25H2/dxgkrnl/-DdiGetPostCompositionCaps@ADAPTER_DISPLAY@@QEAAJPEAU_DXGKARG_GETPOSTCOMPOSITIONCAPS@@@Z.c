/*
 * XREFs of ?DdiGetPostCompositionCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETPOSTCOMPOSITIONCAPS@@@Z @ 0x140398D8C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5085);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5085);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETPOSTCOMPOSITIONCAPS *))(*((_QWORD *)this + 2) + 1232LL))(
