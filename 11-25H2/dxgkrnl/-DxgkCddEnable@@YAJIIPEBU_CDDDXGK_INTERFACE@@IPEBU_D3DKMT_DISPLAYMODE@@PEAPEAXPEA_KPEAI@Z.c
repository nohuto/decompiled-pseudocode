/*
 * XREFs of ?DxgkCddEnable@@YAJIIPEBU_CDDDXGK_INTERFACE@@IPEBU_D3DKMT_DISPLAYMODE@@PEAPEAXPEA_KPEAI@Z @ 0x1403E0B40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  if ( *(_QWORD *)(v29 + 1880) != *(_QWORD *)(*(_QWORD *)(v29 + 16) + 16LL) )
  {
    v33 = *(_QWORD **)v43;
    if ( !**(_QWORD **)v43 && (*(_BYTE *)(v29 + 1901) & 1) == 0 )
    {
      if ( !a7 )
      {
        WdLogSingleEntry0(1LL);
