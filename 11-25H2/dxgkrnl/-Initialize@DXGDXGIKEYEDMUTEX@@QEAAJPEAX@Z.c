/*
 * XREFs of ?Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z @ 0x1403EACCC
 * Callers:
  ...
  *(_QWORD *)this = v8;
  if ( v4 >= 0 )
  {
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        0xFFFFFFFFLL,
        L"Handle 0x%I64x doesn't have keyed mutex or sync object",
        (__int64)a2,
        0LL,
        0LL,
        0LL,
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"Failed to reference handle 0x%I64x",
      (__int64)a2,
      0LL,
      0LL,
      0LL,
