/*
 * XREFs of ?PresentMultiPlaneOverlay2@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY2@@PEAVCOREDEVICEACCESS@@PEAPEAV1@@Z @ 0x1401D98DC
 * Callers:
  ...
  if ( (_DWORD)PresentPlaneCount )
  {
    ...
    do
    {
      ...
      *(_DWORD *)v12 = *(p_hAllocation - 2);
      ...
      {
        *((_DWORD *)v12 + 4) = 1;
        *((_QWORD *)v12 + 3) = p_hAllocation;
      }
      v14 = *((_DWORD *)v12 + 1);
      *((_DWORD *)v12 + 3) = -1;
      *((_DWORD *)v12 + 2) = FlipInterval;
      v15 = *(p_hAllocation - 1) == 0;
      *((_QWORD *)v12 + 6) = v11;
      *((_DWORD *)v12 + 1) = v14 & 0xFFFFFFFE | !v15;
