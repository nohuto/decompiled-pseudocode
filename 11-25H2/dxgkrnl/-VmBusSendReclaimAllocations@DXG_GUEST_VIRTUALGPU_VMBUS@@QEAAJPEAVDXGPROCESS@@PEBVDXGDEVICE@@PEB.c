/*
 * XREFs of ?VmBusSendReclaimAllocations@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBVDXGDEVICE@@PEBVDXGPAGINGQUEUE@@PEAU_D3DKMT_RECLAIMALLOCATIONS2@@PEBI@Z @ 0x140407A14
 * Callers:
...
LABEL_22:
      ...
      if ( v19 < 0 || v24 > v25 )
      {
        ...
        WdLogGlobalForLineNumber = 10688;
...
LABEL_14:
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 10636;
    DxgkLogInternalTriageEvent(
      0LL,
      262145,
      0xFFFFFFFFLL,
