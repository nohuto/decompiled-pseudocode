/*
 * XREFs of ?CloseLocalMutex@DXGDXGIKEYEDMUTEX@@QEAAXW4_OUTPUTDUPL_MUTEX_TYPE@@H@Z @ 0x1402FF140
 * Callers:
...
void __fastcall DXGDXGIKEYEDMUTEX::CloseLocalMutex(__int64 a1, int a2, __int64 a3)
{
  ...
  DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, v11, v10, 0LL, 0LL, 0LL, 0LL);
LABEL_5:
  *(_DWORD *)(a1 + 8 * v6 + 16) = 0;
