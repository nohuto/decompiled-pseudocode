/*
 * XREFs of ?DxgkpGetFileVersion@@YAJPEAU_UNICODE_STRING@@PEAT_LARGE_INTEGER@@PEAJ@Z @ 0x14039B1E0
 * Callers:
...
LABEL_8:
  ...
  v12 = MmMapViewInSystemSpaceEx(Object[0], &MappedBase, &v17, &v19, 1LL);
  if ( v12 < 0 )
  {
    ...
    v13 = MmMapViewOfSection(v5, PsInitialSystemProcess, &MappedBase, 0LL, 0LL, &v19, &v17, 2, 0, 2);
    v8 = v13;
    if ( v13 < 0 )
    {
  ...
  if ( Resource >= 0 )
  {
    if ( v17 >= 0x5C && !wcsncmp((const wchar_t *)(v20 + 6), L"VS_VERSION_INFO", 0x20uLL) )
    {
      v15 = v20;
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"Cannot find the file version resource in DxgkpGetFileVersion (ntStatus = %I64d).",
      v8,
      0LL,
      0LL,
      0LL,
