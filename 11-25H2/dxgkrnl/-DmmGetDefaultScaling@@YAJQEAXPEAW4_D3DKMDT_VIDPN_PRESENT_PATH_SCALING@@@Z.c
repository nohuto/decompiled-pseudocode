/*
 * XREFs of ?DmmGetDefaultScaling@@YAJQEAXPEAW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@@Z @ 0x1402515E4
 * Callers:
...
__int64 __fastcall DmmGetDefaultScaling(DXGADAPTER *a1, enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING *a2)
{
  ...
  if ( !a1 )
  {
    ...
    WdLogGlobalForLineNumber = 13657;
    return 3223191554LL;
  }
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(a1) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 13663;
  }
  v5 = *((_QWORD *)a1 + 390);
  if ( !v5 )
  {
    WdLogSingleEntry1(2LL, a1);
    WdLogGlobalForLineNumber = 13668;
  ...
  else
  {
    WdLogSingleEntry1(2LL, a1);
    result = 3223192373LL;
    WdLogGlobalForLineNumber = 13684;
  }
  return result;
}
