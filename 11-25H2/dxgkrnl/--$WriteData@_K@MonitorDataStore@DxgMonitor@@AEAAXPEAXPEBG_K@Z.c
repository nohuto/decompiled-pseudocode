/*
 * XREFs of ??$WriteData@_K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBG_K@Z @ 0x140276BC4
 * Callers:
 *     ?WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z @ 0x1402774D0 (-WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z.c)
