/*
 * XREFs of DxgkFlipOverlay @ 0x1401E3F00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  ...
  v24 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v23, v26.hDevice, Current, &v24);
...
LABEL_24:
  ...
  if ( v16 >= 0 )
  {
    if ( !DXGDEVICE::IsSupportOverlay((DXGDEVICE *)v6) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDevice->IsSupportOverlay()", 877LL, 0LL, 0LL, 0LL, 0LL);
    }
