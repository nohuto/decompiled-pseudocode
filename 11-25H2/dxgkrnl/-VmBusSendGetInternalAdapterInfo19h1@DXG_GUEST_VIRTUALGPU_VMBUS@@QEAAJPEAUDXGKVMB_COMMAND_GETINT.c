/*
 * XREFs of ?VmBusSendGetInternalAdapterInfo19h1@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAUDXGKVMB_COMMAND_GETINTERNALADAPTERINFO_RETURN1@@@Z @ 0x140224F40
 * Callers:
  ...
  *(_QWORD *)(v5 + 16) = 36LL;
  ...
  if ( v6 < 0 || (v6 = -1073741823, v9[0] < 0x18) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"VmBusSendGetInternalAdapterInfo failed: 0x%I64x",
      v6,
      0LL,
      0LL,
      0LL,
