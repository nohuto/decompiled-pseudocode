/*
 * XREFs of ?DxgkCddSubscribeWnfStateChange@@YAPEAU_CDD_WNF_CALLBACK_CONTEXT@@P6AJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@ZPEAU_EPROCESS@@1K3@Z @ 0x1403EC1E0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a5)
{
  ...
  if ( v9 )
  {
    ...
    v10 = ExSubscribeWnfStateChange(v9, a3, v8);
    if ( v10 >= 0 )
      return v9;
