/*
 * XREFs of ?SetCopyProtection@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1403113E4
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::SetCopyProtection(ADAPTER_DISPLAY *this, unsigned int a2)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 5979LL, 0LL, 0LL, 0LL, 0LL);
  }
  v5 = 0;
