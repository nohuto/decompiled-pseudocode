/*
 * XREFs of ?DestroyAllPagingQueues@DXGDEVICE@@QEAAXPEAVDXGDEVICEACCESSLOCKEXCLUSIVE@@@Z @ 0x1403AB8E0
 * Callers:
...
void __fastcall DXGDEVICE::DestroyAllPagingQueues(DXGDEVICE *this, struct DXGDEVICEACCESSLOCKEXCLUSIVE *a2)
{
  ...
  if ( !*((_BYTE *)this + 72) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 17)) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsDeviceLockExclusiveOwner()", 2504LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_5:
  ...
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 2516;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsDeviceLockExclusiveOwner()", 2516LL, 0LL, 0LL, 0LL, 0LL);
  }
          ...
          if ( *(_QWORD *)(v9 + 16 * (((unsigned __int64)v7 >> 6) & 0xFFFFFF)) )
          {
            *(_DWORD *)(v9 + 16 * (((unsigned __int64)v7 >> 6) & 0xFFFFFF) + 8) |= 0x2000u;
            ...
            else if ( !v11 )
            {
              ...
              v14 = *(struct DXGADAPTER **)(v12 + 1880);
              if ( !v14 )
