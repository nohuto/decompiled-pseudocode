/*
 * XREFs of DxgkInvalidateActiveVidPn @ 0x1401C4E00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
  ...
  *(_OWORD *)Src = 0LL;
  ...
  v40[0] = 0LL;
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)v36, (unsigned int)Src[0], Current, v40, 1);
  v10 = (int *)v40[0];
  if ( !v40[0] )
  {
    WdLogSingleEntry3(2LL, -1073741811LL, Current, LODWORD(Src[0]));
    WdLogGlobalForLineNumber = 6713;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      0xFFFFFFFFLL,
...
LABEL_17:
  ...
  if ( (_DWORD)Size )
  {
    ...
    v17 = (struct DXGADAPTER *)operator new[]((unsigned int)Size, 0x4B677844u, 256LL, Size);
    v40[2] = v17;
    if ( !v17 )
    {
      v14 = -1073741801;
