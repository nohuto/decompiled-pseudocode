/*
 * XREFs of DxgkFreeGpuVirtualAddress @ 0x1403A5020
 * Callers:
...
__int64 __fastcall DxgkFreeGpuVirtualAddress(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v29 )
  {
    ...
    WdLogGlobalForLineNumber = 13442;
LABEL_16:
    if ( v30[0] )
...
LABEL_11:
    ...
    if ( v9 >= 0 )
    {
      if ( !*((_BYTE *)v27 + 209) )
      {
        v9 = (*(__int64 (__fastcall **)(_QWORD, struct DXGPROCESS *, unsigned int *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v27 + 391) + 760LL)
                                                                                                + 8LL)
                                                                                    + 752LL))(
...
LABEL_18:
  ...
  WdLogGlobalForLineNumber = 13455;
  DXGADAPTER_REFERENCE::Assign((DXGADAPTER_REFERENCE *)&v27, 0LL);
