/*
 * XREFs of ?DdiQueryDependentEngineGroup@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x1400695F8
 * Callers:
 *     ADAPTER_RENDER_DdiQueryDependentEngineGroup @ 0x14006C020 (ADAPTER_RENDER_DdiQueryDependentEngineGroup.c)
 * Callees:
