/*
 * XREFs of DpiProcessOpmVmBusRequest @ 0x140089D4C
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  __int64 v13; // rdx
  __int64 v14; // rdx
  union _LARGE_INTEGER *v15; // [rsp+30h] [rbp-28h]
  unsigned __int64 v16[3]; // [rsp+40h] [rbp-18h] BYREF
  ...
  else
  {
    ...
    if ( v8 && *(_DWORD *)(v8 + 16) == 1953656900 && *(_DWORD *)(v8 + 20) == 2 )
    {
        ...
        && *(_DWORD *)(v14 + 20) == 5 )
      {
        v16[0] = 0LL;
        LODWORD(v15) = *a7;
        result = DpiPdoHandleOpmIoctlsInternal(v11, (struct _PDO_CONTEXT *)v14, v12, v10, a5, a6, v15, v16);
        *a7 = v16[0];
      }
      else
      {
