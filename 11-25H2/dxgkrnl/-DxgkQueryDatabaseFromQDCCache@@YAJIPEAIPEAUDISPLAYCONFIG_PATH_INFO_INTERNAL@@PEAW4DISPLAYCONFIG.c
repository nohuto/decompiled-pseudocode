/*
 * XREFs of ?DxgkQueryDatabaseFromQDCCache@@YAJIPEAIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@0@Z @ 0x1401C0960
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a5)
{
  ...
  v9 = (QDC_CACHE *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 179);
  if ( a3 )
