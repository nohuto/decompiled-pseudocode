/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140053A20
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_MGR(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304800) )
  {
    if ( (unsigned int)dword_14015B5F0 > 1
      && tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000020LL)
      && tlgKeywordOn((__int64)&dword_14015B5F0, v6) )
    {
      v5 = &unk_14013AA7C;
      goto LABEL_8;
    }
         ...
         && (qword_14015B600 & 0x200000000020LL) != 0
         && (qword_14015B608 & 0x200000000020LL) == qword_14015B608
         && tlgKeywordOn((__int64)&dword_14015B5F0, 0x200000000020LL) )
  {
    v5 = &unk_14013AA48;
LABEL_8:
