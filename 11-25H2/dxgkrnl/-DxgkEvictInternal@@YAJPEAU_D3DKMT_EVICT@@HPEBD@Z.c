/*
 * XREFs of ?DxgkEvictInternal@@YAJPEAU_D3DKMT_EVICT@@HPEBD@Z @ 0x14037B94C
 * Callers:
 ...
 *     DxgkEvict @ 0x14037B930 (DxgkEvict.c)
 * Callees:
...
LABEL_18:
  ...
  v62 = v74;
  v56 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v53, v8->hDevice, Current, &v56);
  v11 = v56;
  if ( !v56 )
  {
