/*
 * XREFs of ?DmmRemovePathsFromVidPnSource@@YAJPEAVDXGDEVICE@@IE@Z @ 0x140252D98
 * Callers:
...
__int64 __fastcall DmmRemovePathsFromVidPnSource(struct DXGDEVICE *a1, unsigned int a2, char a3)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner((PERESOURCE *)v3) )
  {
    ...
    WdLogGlobalForLineNumber = 14041;
  }
  ...
  while ( 1 )
  {
    ...
    if ( v12 < 0 )
    {
      if ( v12 == -1071774919 )
        break;
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 14115;
    }
    if ( v41 == -1 )
      break;
    if ( v41 == v10 )
    {
      ...
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 14143;
      }
      v17 = *((_DWORD *)Path + 28);
      v46 = v17;
...
LABEL_30:
      ...
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 14167;
      }
      ...
      if ( v18 < 0 )
      {
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 14180;
        }
      }
      v11 = 1;
      v39 = 1;
    ...
    else
    {
      ...
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 14130;
      }
      v11 = 1;
      --v6;
      v39 = 1;
...
LABEL_39:
    ...
    if ( ClientCommittedVidPnRef < 0 )
    {
      ...
      v31[4] = v3;
      v31[5] = v30;
      WdLogGlobalForLineNumber = 14229;
    }
    v23 = v48;
    ...
    if ( v32 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 14245;
    }
    goto LABEL_43;
  }
  ...
  if ( v22 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 14203;
    goto LABEL_35;
  }
  v24 = v54[21];
  if ( !_bittest(&v24, v5) )
  ...
  WdLogGlobalForLineNumber = 14212;
LABEL_35:
  v23 = v48;
LABEL_43:
  v33 = *(_QWORD *)(v3 + 3128);
  ...
  else
  {
    v34 = *((_QWORD *)v23 + 57);
    if ( v34 )
      _InterlockedExchange((volatile __int32 *)(2968 * v5 + *(_QWORD *)(v34 + 8) + 1008), 0);
  }
