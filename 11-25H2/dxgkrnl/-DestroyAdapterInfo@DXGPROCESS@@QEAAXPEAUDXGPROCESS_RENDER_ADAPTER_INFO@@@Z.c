/*
 * XREFs of ?DestroyAdapterInfo@DXGPROCESS@@QEAAXPEAUDXGPROCESS_RENDER_ADAPTER_INFO@@@Z @ 0x14038128C
 * Callers:
...
void __fastcall DXGPROCESS::DestroyAdapterInfo(DXGPROCESS *this, struct DXGPROCESS_RENDER_ADAPTER_INFO *a2)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pAdapterInfo != nullptr", 2531LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  *(_QWORD *)(*((_QWORD *)this + 6) + 8LL * *(unsigned int *)(v5 + 240)) = 0LL;
  ...
  while ( v14 != (struct DXGPROCESS_RENDER_ADAPTER_INFO *)((char *)a2 + 136) )
  {
    ...
    if ( *((_QWORD *)v15 + 3) )
    {
      ...
      if ( (unsigned int)dword_14015B660 > 5 && tlgKeywordOn((__int64)&dword_14015B660, 0x400000000010LL) )
      {
        v21 = *((_QWORD *)this + 8);
