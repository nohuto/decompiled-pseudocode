/*
 * XREFs of ?LogDisplayTelemetrySourceInfo@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEBUDXG_BLACKBOX_DISPLAY_SOURCE_INFO@@@Z @ 0x1401BECAC
 * Callers:
        ...
        const struct DXG_BLACKBOX_DISPLAY_SOURCE_INFO *a3)
{
  ...
  if ( a3 && a2 )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_14015B660, 0x400000000400LL) )
      {
        LOBYTE(v25) = v8;
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"Invalid parameters not expected", 373LL, 0LL, 0LL, 0LL, 0LL);
  }
}
