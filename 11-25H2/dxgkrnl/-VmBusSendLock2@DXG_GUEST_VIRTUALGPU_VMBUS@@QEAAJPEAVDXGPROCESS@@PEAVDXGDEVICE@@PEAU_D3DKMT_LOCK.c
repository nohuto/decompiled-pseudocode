/*
 * XREFs of ?VmBusSendLock2@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@PEAU_D3DKMT_LOCK2@@EII@Z @ 0x140401AA0
 * Callers:
    ...
    *(struct _D3DDDICB_LOCK2FLAGS::$8E8E2CD94D4182533FEB50916D5F70D0::$345C9315266921A5615E194C0B7E8CDB *)(v22 + 32) = a4->Flags.0;
    ...
    if ( v29 >= 0 )
    {
      ...
      if ( Mdl )
      {
        ...
        WdLogGlobalForLineNumber = 11112;
        v30 = 0LL;
      }
      else
      {
        ...
        WdLogGlobalForLineNumber = 11097;
        v30 = -1073741801LL;
      }
    }
    else
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v31, (__int64)this, v30, 0LL, 0LL, 0LL);
    WdLogSingleEntry1(2LL, v17);
    WdLogGlobalForLineNumber = 11129;
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"VmBusSendLock2 failed: 0x%I64x", v17, 0LL, 0LL, 0LL, 0LL);
    if ( VirtualAddress )
    {
...
LABEL_57:
  ...
  if ( (*((_BYTE *)v15 + 128) & 2) != 0 && (*((_BYTE *)DXGGLOBAL::GetGlobal() + 1712) & 1) != 0 )
  {
