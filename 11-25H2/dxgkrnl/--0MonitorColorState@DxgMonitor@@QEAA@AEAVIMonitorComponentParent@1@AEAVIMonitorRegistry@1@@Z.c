/*
 * XREFs of ??0MonitorColorState@DxgMonitor@@QEAA@AEAVIMonitorComponentParent@1@AEAVIMonitorRegistry@1@@Z @ 0x1403572BC
 * Callers:
        ...
        struct DxgMonitor::IMonitorRegistry *a3)
{
  ...
  *((_DWORD *)this + 130) = 2;
  *((_BYTE *)this + 524) = 1;
  *((_DWORD *)this + 132) = 2000;
  *((_DWORD *)this + 133) = 1000;
  *((_BYTE *)this + 536) = 0;
  return result;
}
