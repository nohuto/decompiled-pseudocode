/*
 * XREFs of ?SendWnfNotificationToVmProcess@DXGGLOBAL@@SAJPEAVDXGPROCESS@@PEBU_WNF_STATE_NAME@@IPEAX@Z @ 0x1403DB5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  *(_QWORD *)(v9 + 16) = DXGGLOBAL::SendWnfNotificationToVmProcessWorkItem;
  ...
  if ( (v11 & 0x100) != 0 )
    ...
    v12 = a1 & -(__int64)((v11 & 0x80u) != 0);
  *(_QWORD *)(v10 + 40) = *(_QWORD *)(v12 + 592);
  *(_DWORD *)(v10 + 48) = v8;
  *(_QWORD *)(v10 + 24) = v10;
  v13 = *(_QWORD *)(*(_QWORD *)(a1 + 64) + 88LL);
  *(_QWORD *)(v10 + 56) = 0LL;
  *(_DWORD *)(v10 + 64) = 0;
  *(_QWORD *)(v10 + 88) = v13;
  *(_BYTE *)(v10 + 68) = 2;
  ...
  *(struct _WNF_STATE_NAME *)(v10 + 80) = *a2;
  DXG_DEFERRED_WORK_QUEUE::QueueWorkItem(
    (DXG_DEFERRED_WORK_QUEUE *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 2120LL),
