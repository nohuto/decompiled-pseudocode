/*
 * XREFs of ?ProcessNextFile@CDriverStoreCopy@@QEAAXPEAUDXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN@@@Z @ 0x1401C9088
 * Callers:
        ...
        struct DXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN *a2)
{
  ...
  __int128 v31; // [rsp+B8h] [rbp-11h] BYREF
  __int64 v32; // [rsp+C8h] [rbp-1h]
  __int128 v33; // [rsp+D0h] [rbp+7h] BYREF
  __int128 v34; // [rsp+E0h] [rbp+17h]
  __int64 v35; // [rsp+F0h] [rbp+27h]
          ...
          *((_DWORD *)a2 + 4) = v15;
          if ( v15 >= 0 )
          {
            ...
            *((_DWORD *)a2 + 4) = v16;
            ...
            v34 = 0LL;
            v31 = 0LL;
            v17 = ZwQueryInformationFile(FileHandle, &IoStatusBlock, &v31, 0x18u, FileStandardInformation);
            *((_DWORD *)a2 + 4) = v17;
            if ( v17 >= 0 && !BYTE5(v32) )
            ...
            v19 = BYTE5(v32);
            v20 = DWORD2(v31);
            *((_QWORD *)a2 + 1) = *((_QWORD *)&v31 + 1);
            *(_BYTE *)a2 = v19;
            if ( !v19 )
            {
              *((_QWORD *)a2 + 3) = v33;
              *((_QWORD *)a2 + 6) = *((_QWORD *)&v34 + 1);
              *((_QWORD *)a2 + 4) = *((_QWORD *)&v33 + 1);
              *((_QWORD *)a2 + 5) = v34;
              *((_DWORD *)a2 + 14) = v35;
            }
            *((_DWORD *)this + 396) = v20;
            if ( !v19 )
              goto LABEL_29;
            Pool2 = ExAllocatePool2(256LL, 536LL, 1265072196LL, v18);
            v22 = (char *)Pool2;
            if ( !Pool2 )
            {
            ...
            *(_QWORD *)(v25 + 8) = v24;
            *(_QWORD *)v23 = v24;
            v26 = RtlStringCbCopyW(v22, 0x208uLL, (char *)a2 + 60);
            *((_DWORD *)a2 + 4) = v26;
            if ( v26 >= 0 )
LABEL_29:
              *((_DWORD *)a2 + 4) = 0;
