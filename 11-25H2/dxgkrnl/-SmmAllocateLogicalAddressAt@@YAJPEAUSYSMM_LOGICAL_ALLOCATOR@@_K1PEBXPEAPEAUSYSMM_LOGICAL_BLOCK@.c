/*
 * XREFs of ?SmmAllocateLogicalAddressAt@@YAJPEAUSYSMM_LOGICAL_ALLOCATOR@@_K1PEBXPEAPEAUSYSMM_LOGICAL_BLOCK@@@Z @ 0x14027F850
 * Callers:
 ...
 *     SmmGetOrderBlockSizeInBytes @ 0x140093118 (SmmGetOrderBlockSizeInBytes.c)
 *     SmmNotifyBytesAllocate @ 0x140093210 (SmmNotifyBytesAllocate.c)
        ...
        struct SYSMM_LOGICAL_BLOCK **a5)
{
  ...
  v11 = a2;
  v12 = a3;
  SmmAcquirePushLockExclusive<48>((__int64)a1 + 1312);
  v13 = a4;
  while ( 1 )
  {
    if ( !v12 )
