/*
 * XREFs of ?VmBusSendCreateNtSharedObject@DXG_GUEST_GLOBAL_VMBUS@@QEAAIPEAVDXGPROCESS@@IPEAVDXGSYNCOBJECT@@PEAVDXGDEVICESYNCOBJECT@@PEAVDXGRESOURCE@@@Z @ 0x140222F58
 * Callers:
        ...
        struct DXGRESOURCE *a6)
{
  ...
  if ( !a4 && !a5 && !a6 )
  {
    ...
    WdLogGlobalForLineNumber = 13754;
