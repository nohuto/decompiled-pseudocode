/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14006724C
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x14006164C (wil_details_IsEnabledFallback.c)
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1400673B8 (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1400673B8 (wil_details_GetCurrentFeatureEnabledState.c)
