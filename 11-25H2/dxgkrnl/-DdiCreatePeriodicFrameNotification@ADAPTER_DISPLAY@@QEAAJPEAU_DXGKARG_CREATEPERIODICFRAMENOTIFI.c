/*
 * XREFs of ?DdiCreatePeriodicFrameNotification@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CREATEPERIODICFRAMENOTIFICATION@@@Z @ 0x1403F4284
 * Callers:
 *     ADAPTER_DISPLAY_DdiCreatePeriodicFrameNotification @ 0x14005A4A0 (ADAPTER_DISPLAY_DdiCreatePeriodicFrameNotification.c)
 * Callees:
