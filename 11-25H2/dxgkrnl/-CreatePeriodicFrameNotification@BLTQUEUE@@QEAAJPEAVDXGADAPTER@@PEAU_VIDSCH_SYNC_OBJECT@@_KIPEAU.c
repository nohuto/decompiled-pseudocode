/*
 * XREFs of ?CreatePeriodicFrameNotification@BLTQUEUE@@QEAAJPEAVDXGADAPTER@@PEAU_VIDSCH_SYNC_OBJECT@@_KIPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@PEA_K@Z @ 0x14027ACB0
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v20, this + 364, 0);
  v10 = 0;
  *a7 = 0LL;
  if ( !this[368] )
  {
...
LABEL_13:
    ...
    && FenceValueCPUVirtualAddress <= (unsigned int)(10000000 * *((_DWORD *)this + 97)) / *((_DWORD *)this + 96) )
  {
    ...
    for ( i = 0LL; ; ++i )
    {
      if ( v12 >= 0x200 )
        goto LABEL_14;
      if ( !*(_QWORD *)((char *)this[370] + v12 + 48) )
        break;
      v12 += 64LL;
    }
    v14 = i << 6;
    *(_QWORD *)((char *)this[370] + v14) = ExAllocateTimer(0LL, 0LL, 4LL);
    v15 = this[370];
...
LABEL_14:
    ...
    v16 = 0LL;
    *(_QWORD *)((char *)this[370] + v14 + 8) = a3;
    *(_QWORD *)((char *)this[370] + v14 + 32) = FenceValueCPUVirtualAddress;
    *(_QWORD *)((char *)this[370] + v14 + 40) = 0LL;
    v17 = this[368];
    this[368] = (struct _KTHREAD *)((char *)v17 + 1);
    *(_QWORD *)((char *)this[370] + v14 + 48) = v17;
    do
    {
      v18 = v14 + v16++;
      *((_BYTE *)this[370] + v18 + 56) = 0;
    }
    while ( v16 < 2 );
    ++*((_DWORD *)this + 738);
    *a7 = *(_QWORD *)((char *)this[370] + v14 + 48);
    goto LABEL_13;
  }
