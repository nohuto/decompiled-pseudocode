/*
 * XREFs of ?DdiQueryCurrentFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x140069380
 * Callers:
 *     ADAPTER_RENDER_DdiQueryCurrentFence @ 0x14006C000 (ADAPTER_RENDER_DdiQueryCurrentFence.c)
 * Callees:
