/*
 * XREFs of ?DdiCancelQueuedFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELQUEUEDFLIPS@@@Z @ 0x140068A48
 * Callers:
 *     ADAPTER_DISPLAY_DdiCancelQueuedFlips @ 0x14006BDE0 (ADAPTER_DISPLAY_DdiCancelQueuedFlips.c)
 * Callees:
