/*
 * XREFs of _lambda_0e946522d05123f26763d9a2a20a36ba_::operator() @ 0x1401BAB6C
 * Callers:
...
__int64 __fastcall lambda_0e946522d05123f26763d9a2a20a36ba_::operator()(int **a1)
{
  __int64 v2; // rcx
  int *v3; // rdi
  int *v4; // rbx
  ...
  if ( !(unsigned int)Feature_DcuNoBugCheckOnNoAdapter__private_IsEnabledDeviceUsageNoInline() )
    Feature_DcuOnExitAlwaysInCalleeContext__private_IsEnabledDeviceUsageNoInline();
  v5 = *a1;
  v6 = **a1;
