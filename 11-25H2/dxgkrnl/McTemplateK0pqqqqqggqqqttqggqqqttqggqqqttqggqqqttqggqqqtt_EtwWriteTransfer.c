/*
 * XREFs of McTemplateK0pqqqqqggqqqttqggqqqttqggqqqttqggqqqttqggqqqtt_EtwWriteTransfer @ 0x1400796DC
 * Callers:
 *     ?ReportState@TrackedWorkloadMonitor@@QEAAXXZ @ 0x1401FD3DC (-ReportState@TrackedWorkloadMonitor@@QEAAXXZ.c)
 * Callees:
