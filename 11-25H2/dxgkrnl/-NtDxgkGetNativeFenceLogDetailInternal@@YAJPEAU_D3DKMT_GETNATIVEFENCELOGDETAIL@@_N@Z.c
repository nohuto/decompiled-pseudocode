/*
 * XREFs of ?NtDxgkGetNativeFenceLogDetailInternal@@YAJPEAU_D3DKMT_GETNATIVEFENCELOGDETAIL@@_N@Z @ 0x1401D5BA0
 * Callers:
 *     NtDxgkGetNativeFenceLogDetail @ 0x1401D6090 (NtDxgkGetNativeFenceLogDetail.c)
 * Callees:
...
LABEL_10:
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v5, LODWORD(Src[0]), -1073741811LL, 0LL, 0LL, 0LL);
