/*
 * XREFs of ?VmBusDuplicateHandle@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14021C440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( v12 < 0 )
  {
    ...
    *(_QWORD *)(v17 + 32) = *(unsigned int *)(v1 + 24);
    WdLogGlobalForLineNumber = 14657;
    goto LABEL_3;
  }
...
LABEL_14:
  while ( 1 )
  {
    v22 = (struct DXG_VMBUS_CHANNEL_BASE *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 206);
    *(_OWORD *)v36 = 0LL;
    v37 = 0;
  ...
  *((_DWORD *)v23 + 10) = 8;
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 13681;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      0xFFFFFFFFLL,
