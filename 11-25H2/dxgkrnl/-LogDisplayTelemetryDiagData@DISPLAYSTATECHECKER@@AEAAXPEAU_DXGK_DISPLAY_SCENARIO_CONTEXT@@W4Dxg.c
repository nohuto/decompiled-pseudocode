/*
 * XREFs of ?LogDisplayTelemetryDiagData@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@W4DxgkrnlLiveDumpFailureReason@@@Z @ 0x1401BEB40
 * Callers:
...
void __fastcall DISPLAYSTATECHECKER::LogDisplayTelemetryDiagData(int *a1, struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  __int64 v4; // r9
  unsigned int v5; // ecx
  __int64 v6; // rcx
  ...
  if ( (unsigned int)dword_14015B660 > 5 && tlgKeywordOn((__int64)&dword_14015B660, 0x400000000400LL) )
  {
    v5 = *a1;
    v17 = (const CHAR *)(a1 + 1);
    v15 = v4;
  ...
  for ( i = 0; i < a1[3522]; ++i )
  {
    ...
    {
      DISPLAYSTATECHECKER::LogDisplayTelemetryAdapterInfo(v9, a2, DisplayAdapterDiagData);
      for ( j = 0; j < *((_DWORD *)v10 + 240); ++j )
      {
        if ( j < 4 )
        {
          v13 = (char *)v10 + 224 * j + 64;
          if ( v13 )
