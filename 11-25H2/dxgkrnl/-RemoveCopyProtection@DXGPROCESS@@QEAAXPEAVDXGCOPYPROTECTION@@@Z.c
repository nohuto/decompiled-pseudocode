/*
 * XREFs of ?RemoveCopyProtection@DXGPROCESS@@QEAAXPEAVDXGCOPYPROTECTION@@@Z @ 0x140061470
 * Callers:
...
void __fastcall DXGPROCESS::RemoveCopyProtection(struct _KTHREAD **this, __int64 a2)
{
  ...
  if ( this[48] != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCopyProtectionMutexOwner()", 865LL, 0LL, 0LL, 0LL, 0LL);
  }
  v3 = a2 + 24;
  v4 = -a2;
  v5 = v3 & -(__int64)(v4 != 0);
