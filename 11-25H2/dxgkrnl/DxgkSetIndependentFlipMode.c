/*
 * XREFs of DxgkSetIndependentFlipMode @ 0x1403AC16C
 * Callers:
 ...
 *     ?UpdateDxgkrnlIndependentFlipDuration@CFlipExBuffer@@IEAAJIIPEBIPEAH@Z @ 0x14009B868 (-UpdateDxgkrnlIndependentFlipDuration@CFlipExBuffer@@IEAAJIIPEBIPEAH@Z.c)
 * Callees:
        ...
        unsigned __int64 *a9)
{
  ...
  *a8 = 0;
  ...
  if ( v11 == -1073741788 )
  {
    ...
    WdLogGlobalForLineNumber = 12473;
  }
  else if ( v11 < 0 )
  {
      ...
      else
      {
        ...
        while ( v16 )
        {
          ...
          if ( (unsigned int)DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR::GetPlaneIndex((DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR *)&v30) >= v18 )
          {
            ...
            WdLogGlobalForLineNumber = 12528;
        ...
        else
        {
          ...
          WdLogGlobalForLineNumber = 12540;
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            0xFFFFFFFFLL,
