/*
 * XREFs of ?DdiResumeHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESUMEHWENGINE@@@Z @ 0x140069CA8
 * Callers:
 *     ADAPTER_RENDER_DdiResumeHwEngine @ 0x14006C080 (ADAPTER_RENDER_DdiResumeHwEngine.c)
 * Callees:
