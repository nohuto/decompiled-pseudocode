/*
 * XREFs of ?ApplyTopologyOnAdapter@CCD_TOPOLOGY@@AEAAJPEAVDXGPROCESS@@IKPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1402DBC60
 * Callers:
 ...
 *     ?SetCurrentVirtualMode@ADAPTER_DISPLAY@@QEAAXIPEBU_D3DKMT_DISPLAYMODE@@@Z @ 0x140059D98 (-SetCurrentVirtualMode@ADAPTER_DISPLAY@@QEAAXIPEBU_D3DKMT_DISPLAYMODE@@@Z.c)
 *     ?SetDisplayId@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x14005C1B8 (-SetDisplayId@ADAPTER_DISPLAY@@QEAAXII@Z.c)
 *     _DXGKCALLONEXIT__lambda_fe0a1c8bb5d899668299a10802864297____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT @ 0x140064B00 (_DXGKCALLONEXIT__lambda_fe0a1c8bb5d899668299a10802864297____--_2_--DXGKCALLONEXIT--_DXGKCALLONEX.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  *((_QWORD *)&v96 + 1) = v10 + 80;
  ...
  v19 = v81[0];
  v89 = 0LL;
  DmmInterface = DxgkQueryDmmInterface(v81[0]);
  v74 = DmmInterface;
  if ( DmmInterface < 0 )
  {
    WdLogSingleEntry3(
      ...
      if ( (v45 & v11[1]) != 0 )
      {
        ...
        *(_DWORD *)(*(_QWORD *)(v56 + 128) + v57 + 1104) = -1;
        ...
        if ( v73 || (v45 & v11[2]) != 0 && (v45 & v11[10]) == 0 )
        {
          ...
          do
            v61 = _InterlockedIncrement((volatile signed __int32 *)Global + 336);
          while ( !v61 );
