/*
 * XREFs of DxgkCreateBundleObjectInternal @ 0x1403FBE18
 * Callers:
...
LABEL_112:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v12, v11, Handlea, v54, 0LL, 0LL);
    goto LABEL_113;
  }
...
LABEL_72:
          ...
          DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"Objects[i] == NULL", v31, 0LL, 0LL, 0LL, 0LL);
        }
LABEL_73:
        v37 = a2;
LABEL_97:
...
LABEL_68:
  ...
  if ( v38 < 0 )
  {
    ...
    if ( Object )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pBundleObject == NULL", 2369LL, 0LL, 0LL, 0LL, 0LL);
    }
    v37 = a2;
    goto LABEL_97;
  }
