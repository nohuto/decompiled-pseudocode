/*
 * XREFs of ?SignalGpuFence@CFlipExBuffer@@UEAAJ_K_N@Z @ 0x140033780
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( SessionData )
    {
      ...
      if ( v8 )
      {
        ...
        *((_BYTE *)this + 647) = 1;
        ...
        if ( v17 == (*(unsigned int (__fastcall **)(__int64 *))(*v6 + 168))(v6) )
...
LABEL_7:
          ...
          v10 = *((_QWORD *)this + 47);
          v18 = 0LL;
          v3 = (*(__int64 (__fastcall **)(__int64 *, __int64, __int64 *))(v9 + 160))(v6, v10, &v18);
          if ( v3 >= 0 )
          {
