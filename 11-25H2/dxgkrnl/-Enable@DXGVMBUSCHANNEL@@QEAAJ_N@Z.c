/*
 * XREFs of ?Enable@DXGVMBUSCHANNEL@@QEAAJ_N@Z @ 0x1402006AC
 * Callers:
...
LABEL_7:
      ...
      *((_BYTE *)this + 24) = 1;
      *v5 = 1;
      v10 = ((__int64 (__fastcall *)(__int64))qword_14015D360)(v9);
      v4 = v10;
      if ( v10 < 0 )
      {
        WdLogSingleEntry5(
      ...
      {
        ((void (__fastcall *)(_QWORD))qword_14015D410)(*((_QWORD *)this + 2));
      }
    }
  }
