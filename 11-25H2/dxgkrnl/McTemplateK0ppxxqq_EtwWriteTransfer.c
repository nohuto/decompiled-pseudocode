/*
 * XREFs of McTemplateK0ppxxqq_EtwWriteTransfer @ 0x14007A4C0
 * Callers:
...
NTSTATUS McTemplateK0ppxxqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventVirtualGpupAlloc, a3, 7u, &v4);
}
