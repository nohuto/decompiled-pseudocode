/*
 * XREFs of ?DdiSetFlipQueueLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1401A5A4C
 * Callers:
 *     ADAPTER_RENDER_DdiSetFlipQueueLogBuffer @ 0x14006C0C0 (ADAPTER_RENDER_DdiSetFlipQueueLogBuffer.c)
 * Callees:
