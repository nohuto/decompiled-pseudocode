/*
 * XREFs of ?DdiSignalMonitoredFence@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_SIGNALMONITOREDFENCE@@@Z @ 0x14032F100
 * Callers:
 *     ADAPTER_RENDER_DdiSignalMonitoredFence @ 0x14006C160 (ADAPTER_RENDER_DdiSignalMonitoredFence.c)
        ...
        struct _DXGKARG_SIGNALMONITOREDFENCE *a3)
{
  ...
  if ( a3->KernelSubmissionType )
    ...
    Current = 0LL;
  v28 = 0;
  v27 = (DXGPUSHLOCK *)(((unsigned __int64)Current + 152) & ((unsigned __int128)-(__int128)(unsigned __int64)Current >> 64));
  if ( v27 )
  {
    Feature_Servicing_GraphicsKernel_VolatileAccessorUpdate__private_IsEnabledDeviceUsageNoInline();
    if ( *(struct _KTHREAD **)((((unsigned __int64)Current + 152) & ((unsigned __int128)-(__int128)(unsigned __int64)Current >> 64))
