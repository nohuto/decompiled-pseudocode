/*
 * XREFs of ?DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z @ 0x1403AFA30
 * Callers:
...
__int64 __fastcall DxgkWin32kQueryInterface(struct _DXGKWIN32K_INTERFACE *a1, unsigned int *a2)
{
  ...
  {
    WdLogSingleEntry4(1LL, (unsigned __int16)*v2, *(unsigned __int16 *)a1, 49LL, 816LL);
