/*
 * XREFs of ?DoesRectOverlapWithExistingDirty@DDAMetaData@@AEAA?AW4RECT_OVERLAP@@PEAUtagRECT@@0@Z @ 0x14034C584
 * Callers:
...
__int64 __fastcall DDAMetaData::DoesRectOverlapWithExistingDirty(__int64 a1, unsigned int *a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(a1 + 64) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v10, (__int64)a2, 0LL, 0LL, 0LL, 0LL);
    return 3LL;
  }
