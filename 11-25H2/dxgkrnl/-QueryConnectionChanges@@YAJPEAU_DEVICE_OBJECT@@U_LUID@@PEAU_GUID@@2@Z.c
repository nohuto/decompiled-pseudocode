/*
 * XREFs of ?QueryConnectionChanges@@YAJPEAU_DEVICE_OBJECT@@U_LUID@@PEAU_GUID@@2@Z @ 0x140086A58
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  if ( (unsigned int)dword_14015B5B8 > 5 && tlgKeywordOn((__int64)&dword_14015B5B8, 512LL) )
  {
    ...
    v19 = 16;
    v16 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B5B8, byte_14013C094, a3, 0LL, 5u, v14);
  }
  ...
  if ( (unsigned int)dword_14015B5B8 > 5 && tlgKeywordOn((__int64)&dword_14015B5B8, 512LL) )
  {
    ...
    v19 = 16;
    v16 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B5B8, byte_14013C0F7, a3, 0LL, 6u, v14);
  }
