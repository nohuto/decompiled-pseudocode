/*
 * XREFs of ?DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x14002216C
 * Callers:
 *     ADAPTER_RENDER_DdiQueryEngineStatus @ 0x140022CC0 (ADAPTER_RENDER_DdiQueryEngineStatus.c)
 * Callees:
