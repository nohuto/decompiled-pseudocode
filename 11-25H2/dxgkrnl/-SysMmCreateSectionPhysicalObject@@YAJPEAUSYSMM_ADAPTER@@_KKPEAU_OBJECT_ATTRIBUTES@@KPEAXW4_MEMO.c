/*
 * XREFs of ?SysMmCreateSectionPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKPEAU_OBJECT_ATTRIBUTES@@KPEAXW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x14027F4A0
 * Callers:
 *     DxgkCreatePhysicalMemoryObjectCB @ 0x14000FC40 (DxgkCreatePhysicalMemoryObjectCB.c)
 *     SysMmTestCreateSectionPhysicalObject @ 0x1400938F0 (SysMmTestCreateSectionPhysicalObject.c)
 * Callees:
        ...
        _QWORD *a11)
{
  ...
  {
    _InterlockedIncrement(&dword_14015E63C);
