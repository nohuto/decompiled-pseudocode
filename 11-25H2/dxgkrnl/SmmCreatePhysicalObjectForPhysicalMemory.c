/*
 * XREFs of SmmCreatePhysicalObjectForPhysicalMemory @ 0x14005B590
 * Callers:
 ...
 *     SysMmTestCreatePhysicalObjectForExistingPhysicalMemory @ 0x1400938A0 (SysMmTestCreatePhysicalObjectForExistingPhysicalMemory.c)
 * Callees:
