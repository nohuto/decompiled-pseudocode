/*
 * XREFs of ?DdiPreemptCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_PREEMPTCOMMAND@@@Z @ 0x1400212A8
 * Callers:
 *     ADAPTER_RENDER_DdiPreemptCommand @ 0x140021290 (ADAPTER_RENDER_DdiPreemptCommand.c)
 * Callees:
