/*
 * XREFs of ?Initialize@CFlipManager@@IEAAJPEAX@Z @ 0x14005B880
 * Callers:
 *     ?ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x14005B850 (-ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@.c)
 * Callees:
 ...
 *     DxgkGetSharedSyncObjectType @ 0x1403EA6D0 (DxgkGetSharedSyncObjectType.c)
 */
