/*
 * XREFs of ?Reset@DXGADAPTER@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1401930D4
 * Callers:
...
__int64 __fastcall DXGADAPTER::Reset(DXGADAPTER *this, struct _KTHREAD **a2)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pTdrContext", 8818LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( !*((_QWORD *)this + 391) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"this->IsRenderAdapter()", 8836LL, 0LL, 0LL, 0LL, 0LL);
  }
  v19 = 0;
  ...
  if ( !DXGADAPTER::IsDxgmms2(this) )
  {
    ...
    *((_QWORD *)this + 18) = KeGetCurrentThread();
    if ( !KeResetEvent((PRKEVENT)this + 2) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"OldCoreAccess != 0", 8963LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( bTracingEnabled
  ...
  *((_QWORD *)this + 18) = KeGetCurrentThread();
  ...
  if ( !KeResetEvent((PRKEVENT)this + 2) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"OldCoreAccess != 0", 8871LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( bTracingEnabled
    && (qword_14015B4C0 & 0x1000000) != 0
    && (qword_14015B4C0 & 0x2000) == 0
...
LABEL_45:
    ...
    *((_BYTE *)this + 3053) = 0;
    if ( (int)ADAPTER_RENDER::Reset(v12, (struct _TDR_RECOVERY_CONTEXT *)a2) < 0 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NT_SUCCESS(Status)", 9007LL, 0LL, 0LL, 0LL, 0LL);
    }
    v14 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 390);
    if ( v14 && (int)ADAPTER_DISPLAY::Reset(v14, v13) < 0 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 9015;
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NT_SUCCESS(Status)", 9015LL, 0LL, 0LL, 0LL, 0LL);
    }
    *((_QWORD *)this + 392) = 0LL;
