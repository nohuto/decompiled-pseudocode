/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CODE_POINT_ADAPTERLUID@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003FEF0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CODE_POINT_ADAPTERLUID(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( !(unsigned int)IsCodePointTypeNoisy(*((unsigned int *)a1 + 12)) )
  {
    if ( (unsigned int)dword_14015B5F0 <= 4 )
      goto LABEL_4;
    v2 = 16;
    if ( (qword_14015B600 & 0x200000000010LL) == 0 )
      goto LABEL_4;
    v5 = qword_14015B608;
    if ( (qword_14015B608 & 0x200000000010LL) != qword_14015B608 )
      goto LABEL_5;
    v6 = &unk_14013ACE8;
    v21 = *((_WORD *)a1 + 2);
    v22 = *((_DWORD *)a1 + 15);
  ...
  if ( (unsigned int)dword_14015B5F0 <= 4 || (qword_14015B600 & 0x10) == 0 )
    goto LABEL_4;
  v5 = qword_14015B608;
  if ( (qword_14015B608 & 0x10) == qword_14015B608 && (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, 16LL) )
  {
    v6 = &unk_14013ADF3;
    v21 = *((_WORD *)a1 + 2);
    v22 = *((_DWORD *)a1 + 15);
...
LABEL_5:
  if ( (unsigned int)dword_14015B5F0 > 4 && (qword_14015B600 & 0x400000000010LL) != 0 )
  {
    ...
    if ( (v5 & 0x400000000010LL) == v5 )
    {
      ...
      switch ( v9 )
      {
        ...
        case '`':
          ...
          break;
        case 'b':
          if ( *((int *)a1 + 14) < 0 && (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, 0x400000000010LL) )
          {
            v23 = *((_DWORD *)a1 + 13);
            v19 = *((_QWORD *)a1 + 8);
            v24 = *((_DWORD *)a1 + 10);
          ...
          break;
        default:
          if ( v9 == 104 && (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, 0x400000000010LL) )
          {
            v10 = &unk_14013AB99;
LABEL_26:
            v22 = *((_DWORD *)a1 + 15);
