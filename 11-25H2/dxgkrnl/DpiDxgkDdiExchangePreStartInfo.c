/*
 * XREFs of DpiDxgkDdiExchangePreStartInfo @ 0x14024D778
 * Callers:
...
__int64 __fastcall DpiDxgkDdiExchangePreStartInfo(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  if ( *(_QWORD *)(a1 + 1144) )
  {
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
      McTemplateK0pqq_EtwWriteTransfer(*a3, (__int64)&EventEnterDdiExchangePreStartInfo, (__int64)a3, a2, *a3, 0);
    v8 = (*(int (__fastcall **)(__int64, unsigned int *))(a1 + 1144))(a2, a3);
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
    {
      LODWORD(v15) = v8;
      LODWORD(v14) = a3[1];
      McTemplateK0pqq_EtwWriteTransfer(v7, (__int64)&EventExitDdiExchangePreStartInfo, v9, a2, v14, v15);
    }
