/*
 * XREFs of ?ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x14005B850
 * Callers:
 *     <none>
 * Callees:
 *     ?Initialize@CFlipManager@@IEAAJPEAX@Z @ 0x14005B880 (-Initialize@CFlipManager@@IEAAJPEAX@Z.c)
 *     ??0FlipManagerObject@@IEAA@XZ @ 0x14009C4EC (--0FlipManagerObject@@IEAA@XZ.c)
 */
