/*
 * XREFs of ?DpiIndirectSendAsyncUserModeRequest@@YAJPEAU_FILE_OBJECT@@PEAU_DEVICE_OBJECT@@KPEAXK2KP6AX2PEAU_IO_STATUS_BLOCK@@@Z2PEA_NPEAPEAU_IRP@@@Z @ 0x1403DC698
 * Callers:
 *     DpiIndirectCbSendMessage @ 0x1403DC590 (DpiIndirectCbSendMessage.c)
 * Callees:
        ...
        void *a9)
{
  ...
  if ( Object )
  {
    ...
    Pool2 = ExAllocatePool2(64LL, v15, 1953656900LL, a4);
    v17 = (_QWORD *)Pool2;
    if ( Pool2 )
    {
      *(_QWORD *)Pool2 = Object;
