/*
 * XREFs of ?DxgkHandleDiagnosticNotifications@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x140070830
 * Callers:
...
LABEL_8:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v4, v3, v5, v7, 0LL, 0LL);
    return 3221225485LL;
  }
  ...
  if ( (*(_BYTE *)&Value & 1) != 0 )
  {
    if ( v8 )
    {
      if ( (unsigned int)dword_14015B580 > 4
        && tlgKeywordOn((__int64)&dword_14015B580, 1LL)
        && tlgKeywordOn((__int64)&dword_14015B580, v16) )
      {
        v32 = 1;
        v33[0] = 1;
        v37 = (v19 & 4) != 0;
    ...
    if ( (unsigned int)dword_14015B580 > 4
      && tlgKeywordOn((__int64)&dword_14015B580, 1LL)
      && tlgKeywordOn((__int64)&dword_14015B580, v10) )
    {
      v14 = &unk_14013A385;
      v39 = a1->TargetId;
...
LABEL_24:
  ...
  else
  {
    ...
    {
      if ( (unsigned int)dword_14015B580 > 4
        && tlgKeywordOn((__int64)&dword_14015B580, 2LL)
        && tlgKeywordOn((__int64)&dword_14015B580, v23) )
      {
        v30 = 1;
        v29 = 0;
        v37 = (v26 & 4) != 0;
    ...
    if ( (unsigned int)dword_14015B580 > 4
      && tlgKeywordOn((__int64)&dword_14015B580, 2LL)
      && tlgKeywordOn((__int64)&dword_14015B580, v22) )
    {
      v14 = &unk_14013A33D;
      v39 = a1->TargetId;
      v40 = a1->SequenceNumber;
