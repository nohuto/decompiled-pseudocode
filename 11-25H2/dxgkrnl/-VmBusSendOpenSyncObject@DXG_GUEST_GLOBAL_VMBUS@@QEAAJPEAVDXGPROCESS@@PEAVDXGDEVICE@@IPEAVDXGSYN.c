/*
 * XREFs of ?VmBusSendOpenSyncObject@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@IPEAVDXGSYNCOBJECT@@PEAVDXGDEVICESYNCOBJECT@@IU_D3DDDI_SYNCHRONIZATIONOBJECT_FLAGS@@@Z @ 0x1402F9478
 * Callers:
      ...
      else
      {
        ...
        if ( v25 >= 0 )
        {
          if ( a6 )
          {
            ...
            *((_DWORD *)a6 + 11) = v24;
            *((_QWORD *)a6 + 6) = v26;
            v19 = MapGuestFenceCpuVaToHost(v18, (void **)a6 + 7, (unsigned __int64 *)a6 + 10, (unsigned int *)a6 + 22);
            v16 = v19;
            if ( v19 < 0 )
            {
              WdLogSingleEntry1(2LL, v19);
              WdLogGlobalForLineNumber = 13857;
          ...
          {
            DXGSYNCOBJECT::SetHostHandle(a5, a4, v24, v17);
          }
          goto LABEL_18;
        }
      }
