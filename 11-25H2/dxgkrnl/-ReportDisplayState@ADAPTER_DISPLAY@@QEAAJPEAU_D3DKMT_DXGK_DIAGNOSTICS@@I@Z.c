/*
 * XREFs of ?ReportDisplayState@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_DXGK_DIAGNOSTICS@@I@Z @ 0x140185C94
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)a2 < 0xFFFFFFFC && *(_DWORD *)a2 + 4 == a3 )
  {
    ...
    if ( (unsigned int)v6 >= 0x14 )
    {
      ...
      DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v28, (ADAPTER_DISPLAY *)((char *)this + 616), 0);
      ...
      if ( *((_DWORD *)this + 24) )
      {
        do
        {
          ...
          if ( *(_BYTE *)(v9 + v10 + 762) )
          {
            v11 = *(_DWORD *)(v9 + v10 + 3744);
            v12 = 0;
            v13 = *(_DWORD *)(v9 + v10 + 3748);
            if ( v13 <= v11 )
              v13 = v11;
            if ( v13 )
            {
        ...
        if ( v21 )
        {
          do
          {
            v23 = (DISPLAY_SOURCE *)(*((_QWORD *)this + 16) + 3984LL * v22);
            if ( *((_BYTE *)v23 + 762) )
            {
