/*
 * XREFs of ?CreateFunctionalVidPnWithEnabledVidPnSource@@YAJPEBU_DXGDMM_INTERFACE@@QEAXIW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@EPEAU_DXGK_DISPLAYMODE_INFO@@PEAPEAUD3DKMDT_HVIDPN__@@PEAPEBU_DXGDMM_VIDPN_INTERFACE@@PEAY0BA@I@Z @ 0x1402C0DC0
 * Callers:
        ...
        const struct _DXGDMM_VIDPN_INTERFACE **a8)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_pDxgDmmInterface != NULL", 4728LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a2 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4729;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hDxgAdapter != NULL", 4729LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( (_DWORD)v10 == -1 )
  {
    WdLogSingleEntry0(1LL);
  ...
  if ( !a6 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"io_pDisplayModeInfo != NULL", 4731LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a7 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4732;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"o_phVidPn != NULL", 4732LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a8 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4733;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"o_ppDmmVidPnInterface != NULL", 4733LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a7 = 0LL;
  *a8 = 0LL;
  v11 = a6 + 2;
