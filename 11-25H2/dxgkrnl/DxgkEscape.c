/*
 * XREFs of DxgkEscape @ 0x14041D630
 * Callers:
 ...
 *     DxgkGetAdapterMiracastInfo @ 0x140061320 (DxgkGetAdapterMiracastInfo.c)
 ...
 *     ?TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z @ 0x140189748 (-TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z.c)
...
LABEL_674:
    ...
    *(_OWORD *)v178 = 0LL;
    ...
    else if ( v181.PrivateDriverDataSize > 0x200 )
    {
      ...
      v8 = (unsigned int *)operator new[](v181.PrivateDriverDataSize, 0x4B677844u, 258LL, v181.PrivateDriverDataSize);
...
LABEL_83:
            ...
            if ( !(_DWORD)v38 && !v181.hAdapter
              ...
              || (_DWORD)v38 == 53
              && (unsigned int)Feature_DisplayMux_PostGA_BugBundle_1__private_IsEnabledDeviceUsageNoInline() )
            {
              v15 = DxgkDrtTestEscape(0LL, (struct _D3DKMT_DRT_ESCAPE_HEAD *)v8, 0LL);
              goto LABEL_73;
            }
            v40 = (int)v8[2];
            if ( (unsigned int)v40 <= 0x2F )
            {
              v41 = 0xA00800000000LL;
...
LABEL_73:
          ...
          case D3DKMT_ESCAPE_GET_EXTERNAL_DIAGNOSTICS:
            ...
            if ( !v71 )
              goto LABEL_115;
            if ( v182 == 9 )
              v72 = (DXGDIAGNOSTICS *)*((_QWORD *)v71 + 116);
            else
              v72 = (DXGDIAGNOSTICS *)*((_QWORD *)v71 + 117);
            if ( !v72 )
            {
...
LABEL_153:
                DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v55, (__int64)v8, 0LL, 0LL, 0LL, 0LL);
                LODWORD(v10) = -1073741436;
              }
            }
            else
...
LABEL_228:
        v185 = v91;
        if ( !v91 || v43 != *(DXGADAPTER **)(*((_QWORD *)v91 + 2) + 16LL) && v43 != *((DXGADAPTER **)v91 + 235) )
        {
...
LABEL_443:
            ...
            case D3DKMT_ESCAPE_ACTIVATE_SPECIFIC_DIAG:
              ...
              if ( !*v8 )
              {
                *((_BYTE *)DXGGLOBAL::GetGlobal() + 1312) = v8[1] != 0;
                LODWORD(v10) = 0;
                v121 = v173;
                goto LABEL_649;
              }
...
LABEL_408:
                DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v130, (__int64)v43, -1073741637LL, 0LL, 0LL, 0LL);
                goto LABEL_409;
              }
              if ( v181.PrivateDriverDataSize < 8 )
              {
            ...
            case D3DKMT_ESCAPE_HISTORY_BUFFER_STATUS:
              if ( v181.PrivateDriverDataSize < 8 || !v190 || !v185 )
                goto LABEL_564;
              v154 = 0;
              if ( (qword_14015B4C0 & 0x461C8ED7) == 0
