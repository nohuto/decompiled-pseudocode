/*
 * XREFs of ?SetMultiplaneOverlayConfigUnsafe@DISPLAY_SOURCE@@QEAAXIPEBVDXGALLOCATION@@EIPEBUtagRECT@@11W4_D3DDDI_ROTATION@@W4D3DKMT_MULTIPLANE_OVERLAY_BLEND@@W4D3DDDI_COLOR_SPACE_TYPE@@IW4_D3DDDIFORMAT@@E@Z @ 0x140315480
 * Callers:
        ...
        char a14)
{
  ...
  if ( (unsigned int)v17 >= *((_DWORD *)this + 936) )
    goto LABEL_28;
  v18 = 168 * v17;
  if ( *((_DWORD *)this + 42 * v17 + 282) == -1 )
  {
    if ( *(_DWORD *)((char *)this + v18 + 1132) != -1 )
    {
      WdLogSingleEntry0(1LL);
    ...
    if ( *(_DWORD *)((char *)this + v18 + 1128) == -1 )
    {
      v14 = 0LL;
LABEL_28:
      v21 = v14;
  ...
  _mm_lfence();
  v19 = 80LL * *(int *)((char *)this + v18 + 1128) + v18 + 1136;
...
LABEL_29:
    ...
    NextConfigIndex = GetNextConfigIndex(*((_DWORD *)this + 42 * v17 + 282));
    v26 = v25[1];
    v27 = NextConfigIndex;
    *v25 = NextConfigIndex;
  ...
  if ( *((_DWORD *)this + 936) <= (unsigned int)v17 )
  {
    WdLogSingleEntry0(1LL);
