/*
 * XREFs of ?ConvertLegacyQDCDWMClonePath@CCD_TOPOLOGY@@QEAAJXZ @ 0x140372180
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::ConvertLegacyQDCDWMClonePath(CCD_TOPOLOGY *this)
{
  ...
  v4 = 0;
  v5 = 0;
  for ( i = (struct DXGGLOBAL *)((char *)Global + 1352); v5 < *(unsigned __int16 *)(v3 + 20); ++v5 )
  {
    ...
    if ( *((_BYTE *)PathDescriptor + 129) )
    {
      ...
      if ( ((unsigned int)DXGADAPTERSOURCEHASH::GetHashBitMask(i) & v9) != 0 )
      {
        ...
        AdapterAndSourceForHash = DXGADAPTERSOURCEHASH::FindAdapterAndSourceForHash(i, v10, &v35, &v34);
