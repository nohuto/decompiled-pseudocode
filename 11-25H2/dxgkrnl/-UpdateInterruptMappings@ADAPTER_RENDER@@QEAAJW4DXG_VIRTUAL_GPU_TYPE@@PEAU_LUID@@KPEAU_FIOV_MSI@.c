/*
 * XREFs of ?UpdateInterruptMappings@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@KPEAU_FIOV_MSI@@2@Z @ 0x140208EC0
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"UpdateInterruptMappings called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v9,
      v18,
