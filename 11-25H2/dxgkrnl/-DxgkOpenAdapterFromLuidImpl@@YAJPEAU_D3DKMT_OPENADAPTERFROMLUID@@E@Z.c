/*
 * XREFs of ?DxgkOpenAdapterFromLuidImpl@@YAJPEAU_D3DKMT_OPENADAPTERFROMLUID@@E@Z @ 0x140366348
 * Callers:
 *     DxgkOpenAdapterFromLuidInternal @ 0x14018A320 (DxgkOpenAdapterFromLuidInternal.c)
 *     DxgkOpenAdapterFromLuid @ 0x140366330 (DxgkOpenAdapterFromLuid.c)
 * Callees:
      ...
      if ( *(_DWORD *)(v18 + 200) == 1 )
      {
        ...
        *((_QWORD *)v8 + 32) = 0LL;
        ...
        if ( v26 )
        {
          ...
          {
            DXGPROCESS::FreeResourceHandleNoRefSafe(v8, v26);
