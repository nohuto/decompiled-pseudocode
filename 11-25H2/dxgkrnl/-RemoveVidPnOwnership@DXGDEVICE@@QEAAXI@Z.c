/*
 * XREFs of ?RemoveVidPnOwnership@DXGDEVICE@@QEAAXI@Z @ 0x1403EE774
 * Callers:
...
void __fastcall DXGDEVICE::RemoveVidPnOwnership(DXGDEVICE *this, unsigned int a2)
{
  ...
  {
    v5 = a2;
    WdLogSingleEntry2(2LL, a2, *((unsigned int *)this + 473));
    v6 = *((unsigned int *)this + 473);
    v4 = 0;
    WdLogGlobalForLineNumber = 11574;
