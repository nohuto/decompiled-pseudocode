/*
 * XREFs of ?DxgkCddGetDriverCaps@@YAJQEAXPEAU_DXGK_DRIVERCAPS@@PEAPEAXPEA_K1@Z @ 0x1403D9710
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGK_DRIVERCAPS *a5)
{
  ...
  else
  {
    if ( !v40 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"RenderAdapterRef != NULL", 3239LL, 0LL, 0LL, 0LL, 0LL);
    }
    v42 = 0LL;
