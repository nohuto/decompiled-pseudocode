/*
 * XREFs of ?CreateModeList@ADAPTER_DISPLAY@@QEAAJEPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1403DD2F8
 * Callers:
        ...
        struct _D3DKMT_GETDISPLAYMODELIST *a3)
{
  ...
  if ( !a3 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDisplayModeList != NULL", 6681LL, 0LL, 0LL, 0LL, 0LL);
  }
