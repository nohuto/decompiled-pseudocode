/*
 * XREFs of ?VmBusSendUpdateAllocationProperty@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEBVDXGPROCESS@@PEBVDXGPAGINGQUEUE@@PEBVDXGALLOCATION@@PEAUD3DDDI_UPDATEALLOCPROPERTY@@@Z @ 0x1402FAAE8
 * Callers:
  ...
  if ( (_QWORD)v17 )
  {
    ...
    *(_DWORD *)(v9 + 28) = v11;
    ...
    if ( v15 < 0 || (v15 = -1073741823, v16 < 0x10) || (v15 = v21, v21 < 0) )
    {
      ...
      WdLogGlobalForLineNumber = 9693;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        0xFFFFFFFFLL,
        L"VmBusSendUpdateAllocationProperty failed: 0x%I64x",
        v15,
        0LL,
        0LL,
        0LL,
