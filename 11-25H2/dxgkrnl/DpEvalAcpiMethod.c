/*
 * XREFs of DpEvalAcpiMethod @ 0x140395A00
 * Callers:
...
LABEL_16:
        ...
        {
          WdLogSingleEntry1(3LL, (int)Status);
...
LABEL_21:
  ...
  if ( ChildDescriptor )
  {
    ...
    Status = DpiAcpiEvalAcpiMethodEx(a1, (int)&DestinationString, (int)a3, v18, OutputBuffer, OutputBufferLength, v26);
  }
