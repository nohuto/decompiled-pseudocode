/*
 * XREFs of ?MonitorGetHdrBrightnessPolicy@@YAJPEAUHDXGMONITOR__@@PEAW4_DISPLAYCONFIG_HDR_BRIGHTNESS_MODE@@@Z @ 0x1402675BC
 * Callers:
...
__int64 __fastcall MonitorGetHdrBrightnessPolicy(struct HDXGMONITOR__ *a1, enum _DISPLAYCONFIG_HDR_BRIGHTNESS_MODE *a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( v5[0] )
    {
      *(_DWORD *)a2 = *(_DWORD *)(*(_QWORD *)(v5[0] + 224LL) + 520LL);
      v3 = 0;
    }
    else
    {
