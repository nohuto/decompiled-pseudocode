/*
 * XREFs of ?DxgkWaitForMonitorEventDoneInternal@@YAJPEAVDXGADAPTER@@@Z @ 0x1402850A0
 * Callers:
...
__int64 __fastcall DxgkWaitForMonitorEventDoneInternal(struct DXGADAPTER *a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *((_QWORD *)a1 + 390) )
    {
      v2 = COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v19, 0LL);
      if ( v2 < 0 )
      {
        LODWORD(v10) = v2;
      }
      else
      {
        ...
        *(_QWORD *)(WdLogNewEntry5_WdTrace(v5, v4, v6, v7) + 24) = a1;
        ...
        else
        {
          ...
          MonitorReleaseMonitorPendingEvent((struct _MONITOR_PENDING_EVENT *)v8, v14, v15, v16);
        }
      }
    }
    else
