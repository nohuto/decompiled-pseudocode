/*
 * XREFs of ?DxgkpStopRenderAndSessionDisplayAdapters@@YAJAEAW4_DXGK_DIAG_BDD_FALLBACK_STAGE@@@Z @ 0x14018CD84
 * Callers:
...
__int64 __fastcall DxgkpStopRenderAndSessionDisplayAdapters(enum _DXGK_DIAG_BDD_FALLBACK_STAGE *a1)
{
  ...
  v2 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 119);
  if ( *((_QWORD *)DXGGLOBAL::GetGlobal() + 121) == v2 )
  {
