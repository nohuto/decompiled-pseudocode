/*
 * XREFs of ?DdiCancelFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELFLIPS@@@Z @ 0x140068800
 * Callers:
 *     ADAPTER_DISPLAY_DdiCancelFlips @ 0x14006BDC0 (ADAPTER_DISPLAY_DdiCancelFlips.c)
 * Callees:
