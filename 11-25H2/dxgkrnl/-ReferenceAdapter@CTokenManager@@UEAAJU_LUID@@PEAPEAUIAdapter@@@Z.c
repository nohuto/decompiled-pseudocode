/*
 * XREFs of ?ReferenceAdapter@CTokenManager@@UEAAJU_LUID@@PEAPEAUIAdapter@@@Z @ 0x1400361E0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsEqualLuid@CAdapter@@IEAA_NAEBU_LUID@@@Z @ 0x1400986B8 (-IsEqualLuid@CAdapter@@IEAA_NAEBU_LUID@@@Z.c)
