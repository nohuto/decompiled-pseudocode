/*
 * XREFs of ?DestroyCoreAllocations@DXGSHAREDRESOURCE@@QEAAXPEAPEAXI@Z @ 0x14035D9B8
 * Callers:
...
void __fastcall DXGSHAREDRESOURCE::DestroyCoreAllocations(DXGSHAREDRESOURCE *this, void **a2, unsigned int a3)
{
  ...
  else if ( !*((_QWORD *)this + 21) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDestructionBuffer is NULL!", 12850LL, 0LL, 0LL, 0LL, 0LL);
    return;
  }
  ...
  if ( *((_DWORD *)this + 6) )
  {
    if ( (*((_DWORD *)this + 3) & 8) != 0 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"!m_NtSecuritySharing", 12858LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( (*((_DWORD *)this + 3) & 0x2000) != 0 )
    {
      ...
      if ( Current )
      {
        ...
        if ( (v9 & 0x180) != 0 )
        {
          ...
          DXGPROCESS::FreeResourceHandleNoRefSafe(v10, *((_DWORD *)this + 6));
        }
      }
    }
    else
  ...
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 12883;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NULL == m_hHostGlobalHandle", 12883LL, 0LL, 0LL, 0LL, 0LL);
  }
  LOBYTE(v6) = 0;
...
LABEL_28:
    ...
    if ( v14[2] )
    {
      ...
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 12957;
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NumDriverHandles == i", 12957LL, 0LL, 0LL, 0LL, 0LL);
        v6 = v42;
      }
      ++v3;
    }
