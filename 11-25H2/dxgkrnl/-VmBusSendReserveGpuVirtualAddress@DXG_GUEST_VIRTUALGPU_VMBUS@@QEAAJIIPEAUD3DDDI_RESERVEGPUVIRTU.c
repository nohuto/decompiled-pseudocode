/*
 * XREFs of ?VmBusSendReserveGpuVirtualAddress@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIPEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1401830F4
 * Callers:
  ...
  if ( P[0] )
  {
    ...
    *((_DWORD *)v8 + 6) = a3;
    ...
    if ( v11 < 0 || (v11 = -1073741823, v12[0] < 0x10) )
    {
      ...
      WdLogGlobalForLineNumber = 12558;
