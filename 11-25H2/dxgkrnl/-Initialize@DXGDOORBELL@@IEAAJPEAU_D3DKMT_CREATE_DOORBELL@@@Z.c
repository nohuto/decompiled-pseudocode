/*
 * XREFs of ?Initialize@DXGDOORBELL@@IEAAJPEAU_D3DKMT_CREATE_DOORBELL@@@Z @ 0x1401D4BC8
 * Callers:
...
LABEL_31:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v30, *((_QWORD *)this + 2), v29, 0LL, 0LL, 0LL);
