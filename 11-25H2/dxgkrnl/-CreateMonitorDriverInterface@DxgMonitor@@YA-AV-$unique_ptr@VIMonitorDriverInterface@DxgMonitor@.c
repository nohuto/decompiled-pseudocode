/*
 * XREFs of ?CreateMonitorDriverInterface@DxgMonitor@@YA?AV?$unique_ptr@VIMonitorDriverInterface@DxgMonitor@@U?$default_delete@VIMonitorDriverInterface@DxgMonitor@@@wistd@@@wistd@@PEAUHDXGMONITOR__@@PEAVADAPTER_DISPLAY@@IPEAU_DEVICE_OBJECT@@@Z @ 0x140186ED8
 * Callers:
...
__int64 *__fastcall DxgMonitor::CreateMonitorDriverInterface(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        __int64 a5)
{
  ...
  v8 = a4;
  v9 = operator new(0x28uLL, 0x4D677844u, 256LL, a4);
  if ( v9 )
  {
