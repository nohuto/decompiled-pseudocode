/*
 * XREFs of ?TdrCompleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N1@Z @ 0x1401CA650
 * Callers:
...
void __fastcall TdrCompleteRecoveryContext(struct _TDR_RECOVERY_CONTEXT *a1, struct _LUID *a2, bool a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( v7 != 6 && v7 != 12 )
    {
      ...
      v8 = 5LL * (((unsigned __int8)_InterlockedExchangeAdd(dword_14015C804, 1u) + 1) & 0x3F);
