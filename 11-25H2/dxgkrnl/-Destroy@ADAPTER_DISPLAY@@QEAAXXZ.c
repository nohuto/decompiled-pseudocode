/*
 * XREFs of ?Destroy@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1401962F4
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::Destroy(ADAPTER_DISPLAY **this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( this[16] )
  {
    ...
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v27, (struct DXGFASTMUTEX *const)(this + 77), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v27);
    for ( j = 0; j < *((_DWORD *)this + 24); ++j )
      DISPLAY_SOURCE::ClearAllDisplayState((ADAPTER_DISPLAY *)((char *)this[16] + 3984 * j));
  ...
  v21 = this[2];
  v22 = (char *)Global + 1352;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v28, (struct DXGGLOBAL *)((char *)Global + 1352), 0);
