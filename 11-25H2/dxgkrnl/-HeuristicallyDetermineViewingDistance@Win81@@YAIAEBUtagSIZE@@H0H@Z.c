/*
 * XREFs of ?HeuristicallyDetermineViewingDistance@Win81@@YAIAEBUtagSIZE@@H0H@Z @ 0x1401D6908
 * Callers:
 ...
 * Callees:
 *     ?IsNetbookResolution@Win81@@YAHUtagSIZE@@@Z @ 0x1401D6A48 (-IsNetbookResolution@Win81@@YAHUtagSIZE@@@Z.c)
 */
        ...
        const struct tagSIZE *a4)
{
  ...
  v4 = (int)a2;
  v5 = 10000LL * (*(_DWORD *)this * *(_DWORD *)this + *((_DWORD *)this + 1) * *((_DWORD *)this + 1)) / 0xFC04uLL;
  if ( !(_DWORD)v5 )
    return 840LL;
  v6 = *a3;
