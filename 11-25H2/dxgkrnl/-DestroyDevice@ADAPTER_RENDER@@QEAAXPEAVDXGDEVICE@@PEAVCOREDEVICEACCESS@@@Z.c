/*
 * XREFs of ?DestroyDevice@ADAPTER_RENDER@@QEAAXPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1403B205C
 * Callers:
...
void __fastcall ADAPTER_RENDER::DestroyDevice(DXGADAPTER **this, struct DXGDEVICE *a2, struct COREDEVICEACCESS *a3)
{
  ...
  if ( !ADAPTER_RENDER::IsCoreResourceSharedOwner((ADAPTER_RENDER *)this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 1915LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_DWORD *)a2 + 116) == 2 )
  {
...
LABEL_8:
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, v7, v6, 0LL, 0LL, 0LL, 0LL);
    }
  }
  else
  {
  ...
  if ( !DXGPROCESS::GetCurrent((__int64)v10) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pProcess != NULL", 1963LL, 0LL, 0LL, 0LL, 0LL);
  }
