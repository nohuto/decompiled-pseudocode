/*
 * XREFs of ?DdiCreateHwQueue@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_CREATEHWQUEUE@@@Z @ 0x1403B9CC4
 * Callers:
 *     ADAPTER_RENDER_DdiCreateHwQueue @ 0x14006BF00 (ADAPTER_RENDER_DdiCreateHwQueue.c)
