/*
 * XREFs of ?_SerializeMonitor@DXGMONITOR@@QEBAJPEA_KPEAU_DMM_MONITOR_SERIALIZATION@@@Z @ 0x14026FB10
 * Callers:
 ...
 * Callees:
 *     ?GetAddress@MonitorDisplayPortState@DxgMonitor@@QEBA?AU_DXGKARG_GETDPADDRESS@@XZ @ 0x140064558 (-GetAddress@MonitorDisplayPortState@DxgMonitor@@QEBA-AU_DXGKARG_GETDPADDRESS@@XZ.c)
 *     ?IsAddressValid@MonitorDisplayPortState@DxgMonitor@@QEBA_NXZ @ 0x140064D50 (-IsAddressValid@MonitorDisplayPortState@DxgMonitor@@QEBA_NXZ.c)
 *     _guard_dispatch_icall @ 0x14009F940 (_guard_dispatch_icall.c)
 *     ?_SupportSyncLockIdentical@DXGMONITOR@@QEBA_NXZ @ 0x140189B04 (-_SupportSyncLockIdentical@DXGMONITOR@@QEBA_NXZ.c)
        ...
        struct _DMM_MONITOR_SERIALIZATION *a3)
{
  ...
  __int64 v22; // rcx
  __int64 v23; // rax
  _BYTE v25[13]; // [rsp+20h] [rbp-38h] BYREF
  __int64 v26; // [rsp+2Dh] [rbp-2Bh]
  int v27; // [rsp+35h] [rbp-23h]
  __int16 v28; // [rsp+39h] [rbp-1Fh]
  char v29; // [rsp+3Bh] [rbp-1Dh]
  ...
  if ( v8 && (v9 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 8LL))(v8)) != 0 )
    ...
    v10 = 0;
  v11 = ModesSerializationSizeInBytes + FrequencyRangeSerializationSizeInBytes + v10 + 56LL;
  if ( a3 && v11 <= *a2 )
  {
    *(_DWORD *)a3 = v11;
    ...
    *((_WORD *)a3 + 7) = v12;
    v13 = v12 ^ ((unsigned __int8)v12 ^ (unsigned __int8)(*((_DWORD *)this + 84) >> 1)) & 2;
    *((_WORD *)a3 + 7) = v13;
    v14 = v13 ^ ((unsigned __int8)v13 ^ (unsigned __int8)(2 * *((_WORD *)this + 168))) & 4;
    *((_WORD *)a3 + 7) = v14;
    ...
    *((_DWORD *)a3 + 9) = *((_DWORD *)this + 70);
    ...
    {
      DxgMonitor::MonitorDisplayPortState::GetAddress(v18, (__int64)v25);
      v19 = v27;
      v20 = v25[12];
      *(_QWORD *)((char *)a3 + 41) = v26;
      *(_DWORD *)((char *)a3 + 49) = v19;
      *(_WORD *)((char *)a3 + 53) = v28;
      *((_BYTE *)a3 + 55) = v29;
      *((_BYTE *)a3 + 40) = v20;
    }
    ...
    *((_DWORD *)a3 + 7) = ModesSerializationSizeInBytes + 56;
    ...
    v22 = *((_QWORD *)this[27] + 16);
    if ( v22 )
    {
      v23 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v22 + 8LL))(v22);
      if ( v23 )
        (*(void (__fastcall **)(__int64, char *, _QWORD))(*(_QWORD *)v23 + 16LL))(v23, (char *)a3 + v21, v10);
    }
    *((_DWORD *)a3 + 8) = v21;
    return 0LL;
  }
