/*
 * XREFs of ?RtlStringCbCatA@@YAJPEAD_KPEBD@Z @ 0x14006EF20
 * Callers:
 ...
 * Callees:
 *     RtlStringCopyWorkerA @ 0x1400426E4 (RtlStringCopyWorkerA.c)
 *     RtlStringLengthWorkerA @ 0x1400437C0 (RtlStringLengthWorkerA.c)
 */
