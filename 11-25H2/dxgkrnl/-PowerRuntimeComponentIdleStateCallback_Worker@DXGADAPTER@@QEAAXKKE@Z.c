/*
 * XREFs of ?PowerRuntimeComponentIdleStateCallback_Worker@DXGADAPTER@@QEAAXKKE@Z @ 0x14002D9B8
 * Callers:
 *     ?PowerRuntimeComponentIdleStateCallback_Thread@DXGADAPTER@@QEAAXXZ @ 0x1401911B8 (-PowerRuntimeComponentIdleStateCallback_Thread@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
      ...
      *v10 = 0;
      ...
      if ( v9 )
      {
        ...
        if ( *(_DWORD *)(v8 + 208) == 7 )
        {
          ...
          if ( KeGetCurrentIrql() >= 2u )
          {
            KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v35 + 1720), &LockHandle);
            goto LABEL_86;
          }
          if ( (unsigned int)Feature_Servicing_GraphicsKernel_VolatileAccessorUpdate__private_IsEnabledDeviceUsageNoInline() )
          {
            if ( *(struct _KTHREAD **)(v35 + 1736) == KeGetCurrentThread() )
            {
LABEL_86:
              for ( i = *(__int64 **)(v35 + 1760); i != (__int64 *)(v35 + 1760) && i; i = (__int64 *)*i )
              {
              ...
              {
                _InterlockedDecrement((volatile signed __int32 *)(v35 + 1744));
                ExReleasePushLockSharedEx(v35 + 1728, 0LL);
                KeLeaveCriticalRegion();
              }
              return;
            }
          }
          else if ( *(struct _KTHREAD **)(v35 + 1736) == KeGetCurrentThread() )
          {
            goto LABEL_86;
          }
          DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(v35 + 1728));
          v40 = 1;
          goto LABEL_86;
        }
      }
