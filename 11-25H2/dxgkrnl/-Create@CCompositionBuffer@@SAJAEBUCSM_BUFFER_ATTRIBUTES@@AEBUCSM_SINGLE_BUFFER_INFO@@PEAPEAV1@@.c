/*
 * XREFs of ?Create@CCompositionBuffer@@SAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SINGLE_BUFFER_INFO@@PEAPEAV1@@Z @ 0x14009B050
 * Callers:
        ...
        struct CCompositionBuffer **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v6 >= 0 )
  {
    if ( *(_DWORD *)a2 == 1 )
    {
      v7 = (CCompositionBuffer *)operator new(0x150uLL, 0x624D5343u, 256LL, (unsigned int)(*(_DWORD *)a2 - 1));
