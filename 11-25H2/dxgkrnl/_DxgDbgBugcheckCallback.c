/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x140079C80
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_14015DC58 )
    {
      v4 = (unsigned int)(dword_14015DC48 - 1);
      if ( dword_14015DC48 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_14015DC58) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_14015DBF0;
      ReasonSpecificData[4] = qword_14015DC58;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_14015DBF0;
      if ( v9 )
      {
