/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@PEAU_D3DKMT_OUTPUTDUPL_METADATA@@@@SAJPEAVDXGADAPTER@@_NIPEAU_D3DKMT_OUTPUTDUPL_METADATA@@P6AJPEAVOUTPUTDUPL_MGR@@2@Z@Z @ 0x1402E6688
 * Callers:
...
LABEL_7:
      ...
      {
        IndirectDisplayPairedAdapter = DxgkpGetIndirectDisplayPairedAdapter(this, 0, (struct DXGADAPTER_REFERENCE *)v23);
      ...
      else
      {
        ...
        DXGADAPTER_REFERENCE::Assign((DXGADAPTER_REFERENCE *)v23, *((struct DXGADAPTER **)Global + 121));
        if ( v23[0] )
        {
...
LABEL_18:
  ...
  else if ( v24 >= *((_DWORD *)RemoteOutputDuplMgr + 19) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid source ID 0x%I64x", v21, 0LL, 0LL, 0LL, 0LL);
    COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v30);
    if ( v15 )
    {
      _InterlockedDecrement((volatile signed __int32 *)v9 + 38);
