/*
 * XREFs of ?SmmOpenPhysicalObject@@YAJPEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADAPTER@@@Z @ 0x140011B10
 * Callers:
 ...
 * Callees:
 *     SmmAddObjectToAdapter @ 0x140011E38 (SmmAddObjectToAdapter.c)
...
__int64 __fastcall SmmOpenPhysicalObject(struct SYSMM_PHYSICAL_OBJECT *a1, struct SYSMM_ADAPTER *a2)
{
  ...
  else if ( (v5 & 1) == 0 || (dword_14015E600 & 0x18) != 0 )
  {
    LogicalAddressAt = 0;
  }
  else
