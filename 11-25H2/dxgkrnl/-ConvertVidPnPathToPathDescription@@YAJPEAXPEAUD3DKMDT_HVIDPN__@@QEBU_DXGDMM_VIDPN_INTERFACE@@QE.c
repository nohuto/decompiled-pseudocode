/*
 * XREFs of ?ConvertVidPnPathToPathDescription@@YAJPEAXPEAUD3DKMDT_HVIDPN__@@QEBU_DXGDMM_VIDPN_INTERFACE@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_NPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1403B9F7C
 * Callers:
...
LABEL_22:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v39, v38, (__int64)a2, v21, 0LL, 0LL);
