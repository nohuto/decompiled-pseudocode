/*
 * XREFs of ?CsExitInitiatedWnfCallbackInternal@DXGGLOBAL@@QEAAX_K_J@Z @ 0x1403D7E34
 * Callers:
...
void __fastcall DXGGLOBAL::CsExitInitiatedWnfCallbackInternal(DXGGLOBAL *this, __int64 a2, __int64 a3)
{
  ...
  _BYTE v25[24]; // [rsp+70h] [rbp-98h] BYREF
  _BYTE v26[144]; // [rsp+88h] [rbp-80h] BYREF

  v22 = a3;
  v24 = this;
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)this + 508, 1, 0) && *((_QWORD *)this + 233) != a2 )
  {
    *((_QWORD *)this + 233) = a2;
    v4 = 0;
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v25, (DXGGLOBAL *)((char *)this + 672), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v25);
    v5 = (volatile signed __int32 **)((char *)this + 768);
    v6 = v22;
    v7 = *v5;
LABEL_5:
    while ( v7 != (volatile signed __int32 *)v5 && v7 )
    {
      ...
      if ( *((_QWORD *)v8 + 391) && *((_DWORD *)v8 + 845) && *((_DWORD *)v8 + 842) )
      {
        ...
        if ( (unsigned int)dword_14015B660 > 5
          && (qword_14015B670 & 0x400000000004LL) != 0
          && (qword_14015B678 & 0x400000000004LL) == qword_14015B678 )
        {
          v23 = v15;
          v19 = v14;
          v20 = v13;
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<8>>(
            qword_14015B678 & 0x400000000004LL,
            (__int64)&unk_14013B11C,
            v13,
            v14,
            (__int64)&v20,
            (__int64)&v19,
    ...
    if ( v4 && KeSetTimer((PKTIMER)((char *)v24 + 1872), (LARGE_INTEGER)-10000000LL, (PKDPC)((char *)v24 + 1936)) )
    {
      DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v25);
      DXGGLOBAL::ReleaseComponentReferencesHelper((DXGGLOBAL *)v18);
    }
    _InterlockedExchange(v18 + 508, 0);
