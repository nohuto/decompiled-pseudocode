/*
 * XREFs of _CombineModeList @ 0x14030B520
 * Callers:
...
__int64 __fastcall CombineModeList(unsigned int *a1, const void **a2, __int64 a3, unsigned int *a4, char a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v10 )
    {
      ...
      do
      {
        ...
        if ( (_DWORD)v7 == -1 || (v33 = *(_DWORD *)(v31 + 4), v33 > (unsigned int)v7) )
        {
          v33 = *(_DWORD *)(v31 + 4);
          v39 = v33;
        }
        if ( (*(_DWORD *)(v31 + 40) & 0x40) != 0 || v33 <= v24 && v32 <= v23 )
        {
          if ( v28 != v11 )
          {
            if ( v28 <= v11 )
            {
              ...
              DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i > j", 2803LL, 0LL, 0LL, 0LL, 0LL);
            }
  ...
  if ( v5 )
  {
    ...
    {
      v14 = 0;
      if ( (v13[2] & 0x40) == 0 && (*(v13 - 8) > v40 || *(v13 - 7) > (unsigned int)v7) )
        break;
      v15 = 0;
      if ( *a1 )
      {
...
LABEL_16:
  if ( v11 > v10 )
  {
    ...
    if ( !is_mul_ok(v11, 0x2CuLL) )
      v20 = -1LL;
    v21 = (void *)operator new[](v20, 0x4B677844u, 256LL, v7);
    if ( !v21 )
    {
  ...
  if ( *a1 < v11 )
  {
    ...
    if ( v11 != v35 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"TotalModes == j", 2942LL, 0LL, 0LL, 0LL, 0LL);
    }
  }
  *a1 = v11;
  return 0LL;
