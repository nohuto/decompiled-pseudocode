/*
 * XREFs of DxgkConfirmToken @ 0x1401B5FF0
 * Callers:
 *     ?ConfirmIndependentFlipEntry@CFlipExBuffer@@UEAAJIII@Z @ 0x14009B4B0 (-ConfirmIndependentFlipEntry@CFlipExBuffer@@UEAAJIII@Z.c)
 * Callees:
