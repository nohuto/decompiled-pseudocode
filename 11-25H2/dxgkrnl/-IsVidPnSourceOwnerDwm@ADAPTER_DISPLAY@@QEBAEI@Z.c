/*
 * XREFs of ?IsVidPnSourceOwnerDwm@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x14003180C
 * Callers:
...
bool __fastcall ADAPTER_DISPLAY::IsVidPnSourceOwnerDwm(ADAPTER_DISPLAY *this, unsigned int a2)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceSharedOwner()", 6487LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  return *(_DWORD *)(3984 * v2 + *((_QWORD *)this + 16) + 736) == 1;
}
