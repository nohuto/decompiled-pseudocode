/*
 * XREFs of SmmDestroyPhysicalObject @ 0x140010DE8
 * Callers:
...
void __fastcall SmmDestroyPhysicalObject(_QWORD *a1, char a2)
{
  ...
  _InterlockedAdd64(&qword_14015E608, -*a1);
  v7 = (volatile signed __int64 *)&unk_14015E618;
  if ( (*v4 & 1) == 0 )
    v7 = (volatile signed __int64 *)&unk_14015E610;
