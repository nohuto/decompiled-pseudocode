/*
 * XREFs of ?LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_RENDER@@@Z @ 0x1402A3004
 * Callers:
    ...
    if ( (_DWORD)v9 )
    {
      ...
      do
      {
        ...
        if ( *v21 )
        {
          ...
          v32.hAllocation = v24;
          if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(a8, &v32, v16) >= 0 )
