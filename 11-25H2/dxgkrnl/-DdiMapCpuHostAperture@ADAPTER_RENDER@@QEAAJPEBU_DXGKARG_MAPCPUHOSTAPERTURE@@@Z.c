/*
 * XREFs of ?DdiMapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_MAPCPUHOSTAPERTURE@@@Z @ 0x14033AA70
 * Callers:
 *     ADAPTER_RENDER_DdiMapCpuHostAperture @ 0x14003BE50 (ADAPTER_RENDER_DdiMapCpuHostAperture.c)
 * Callees:
