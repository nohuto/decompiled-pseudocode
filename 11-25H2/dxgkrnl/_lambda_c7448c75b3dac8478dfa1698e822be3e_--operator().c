/*
 * XREFs of _lambda_c7448c75b3dac8478dfa1698e822be3e_::operator() @ 0x1402706F0
 * Callers:
...
char __fastcall lambda_c7448c75b3dac8478dfa1698e822be3e_::operator()(__int64 *a1)
{
  ...
  {
    LOBYTE(v1) = tlgKeywordOn((__int64)&dword_14015B5B8, 4096LL);
    if ( (_BYTE)v1 )
    {
      v4 = *(int **)(v2 + 24);
      v9 = v3;
      ...
      v14 = &v11;
      v11 = v7;
      LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14015B5B8, byte_14013E007, 0LL, 0LL, 6u, &v13);
    }
  }
  return v1;
}
