/*
 * XREFs of ?VmBusSendCreateSyncObject@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIPEBU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@PEAUDXGKVMB_COMMAND_CREATESYNCOBJECT_RETURN@@@Z @ 0x1402234C4
 * Callers:
        ...
        _OWORD *a6)
{
  ...
  if ( (_QWORD)v17 )
  {
    ...
    *(_OWORD *)(v11 + 104) = v13;
    *(_DWORD *)(v11 + 24) = a3;
    if ( (int)DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSyncMessage(a1, (struct DXGVMBUSMESSAGE *)&v17, v19, v16) < 0
      || v16[0] < 0x20 )
    {
      goto LABEL_7;
    }
...
LABEL_7:
        ...
        WdLogGlobalForLineNumber = 8983;
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          0xFFFFFFFFLL,
          L"VmBusSendCreateSyncObject failed: 0x%I64x",
          -1073741823LL,
          0LL,
          0LL,
          0LL,
