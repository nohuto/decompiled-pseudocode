/*
 * XREFs of DxgkpIsDrtEnabled @ 0x140188BF0
 * Callers:
 *     DXGGLOBAL_IsDrtEnabled @ 0x14006C300 (DXGGLOBAL_IsDrtEnabled.c)
 *     ?DxgEscapeEvict@@YAJPEAU_D3DKMT_VIDMM_ESCAPE@@@Z @ 0x140188004 (-DxgEscapeEvict@@YAJPEAU_D3DKMT_VIDMM_ESCAPE@@@Z.c)
 *     ?InternalEscapeEnabled@@YAEXZ @ 0x14018971C (-InternalEscapeEnabled@@YAEXZ.c)
