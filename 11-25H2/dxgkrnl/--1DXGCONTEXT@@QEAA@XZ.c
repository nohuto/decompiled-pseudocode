/*
 * XREFs of ??1DXGCONTEXT@@QEAA@XZ @ 0x140334140
 * Callers:
...
void __fastcall DXGCONTEXT::~DXGCONTEXT(DXGCONTEXT *this)
{
  ...
  if ( !*((_BYTE *)this + 428) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_bDestroyed", 691LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( *((_QWORD *)this + 16) )
  {
    if ( !*v5 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_pPatchLocationTable != NULL", 725LL, 0LL, 0LL, 0LL, 0LL);
    }
  ...
  if ( *((_QWORD *)this + 44) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NULL == m_pCommandDmaBuffer", 767LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  *((_QWORD *)this + 59) = 0LL;
  if ( v14 )
  {
    DXGPROCESS::FreeResourceHandleNoRefSafe(*(DXGPROCESS **)(*((_QWORD *)this + 2) + 40LL), v14);
    *((_DWORD *)this + 6) = 0;
  }
