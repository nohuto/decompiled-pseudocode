/*
 * XREFs of ?DxgkCreateOutputDuplInternal@@YAJPEAU_D3DKMT_CREATE_OUTPUTDUPL@@PEAU_D3DKMT_CREATE_OUTPUTDUPL_FLAGS@@@Z @ 0x1402FB5E4
 * Callers:
 ...
 *     ?OutputDuplIsAllowedByMdmPolicy@@YA_NXZ @ 0x1402FBE78 (-OutputDuplIsAllowedByMdmPolicy@@YA_NXZ.c)
        ...
        __int64 a3)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid process context.", 3225LL, 0LL, 0LL, 0LL, 0LL);
...
LABEL_14:
  ...
  *(_DWORD *)a2 = v18 ^ v19 & 0x20;
  ...
  if ( (v23 & 0x20) != 0 )
    v24 = 0LL;
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)v67, hAdapter, v6, v24, 1);
  v70 = 0LL;
  v74 = -1LL;
...
LABEL_49:
    ...
    if ( VidPnSourceId >= *((_DWORD *)v35 + 19) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid source ID 0x%I64x", v62, 0LL, 0LL, 0LL, 0LL);
      COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v81);
...
LABEL_72:
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v39, v38, 0LL, 0LL, 0LL, 0LL);
