/*
 * XREFs of ?NodeUsageTelemetry@DXGADAPTER@@QEAAX_N@Z @ 0x140190F24
 * Callers:
 *     ?NodeUsageTelemetryCallback@DXGGLOBAL@@CAJPEAVDXGADAPTER@@PEAX@Z @ 0x1401D0A20 (-NodeUsageTelemetryCallback@DXGGLOBAL@@CAJPEAVDXGADAPTER@@PEAX@Z.c)
  ...
  if ( (v1 & 4) == 0 && (v1 & 0x10) == 0 && *((int *)this + 684) >= 0x2000 && !*((_BYTE *)this + 209) )
  {
      ...
      && *(_QWORD *)(*((_QWORD *)this + 391) + 736LL) )
    {
      ...
      *((_QWORD *)this + 609) = KeGetCurrentThread();
      ...
      {
        if ( tlgKeywordOn((__int64)&dword_14015B660, 0x400001000000LL) )
        {
          v19 = v9;
          v18 = v21;
