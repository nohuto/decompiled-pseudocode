/*
 * XREFs of MapChildVaSpace @ 0x14022B4B0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a8)
{
  ...
  Pool2 = ExAllocatePool2(256LL, 48LL, 1265072196LL, a4);
  if ( !Pool2 )
  {
    WdLogSingleEntry0(6LL);
    WdLogGlobalForLineNumber = 15718;
  ...
  *(_QWORD *)(Pool2 + 40) = v16;
  ...
  if ( a2 )
  {
    ...
    if ( v18 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 15747;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        0xFFFFFFFFLL,
...
LABEL_18:
      ...
      WdLogGlobalForLineNumber = 15779;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        0xFFFFFFFFLL,
...
LABEL_13:
  ...
  v23 = 0LL;
LABEL_17:
  v18 = ((__int64 (__fastcall *)(_QWORD, __int64, unsigned __int64, __int64, int, int, __int64, _QWORD *))qword_14015D5D8)(
          *v23,
          a3,
          a4 >> 12,
          Pool2 + 16,
