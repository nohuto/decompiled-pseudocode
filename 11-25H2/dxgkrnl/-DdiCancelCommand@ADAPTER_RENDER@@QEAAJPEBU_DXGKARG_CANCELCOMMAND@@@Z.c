/*
 * XREFs of ?DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x14019F000
 * Callers:
 *     ADAPTER_RENDER_DdiCancelCommand @ 0x14006BEA0 (ADAPTER_RENDER_DdiCancelCommand.c)
 * Callees:
