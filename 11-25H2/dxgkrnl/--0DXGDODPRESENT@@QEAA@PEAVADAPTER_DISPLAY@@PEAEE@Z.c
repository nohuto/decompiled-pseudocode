/*
 * XREFs of ??0DXGDODPRESENT@@QEAA@PEAVADAPTER_DISPLAY@@PEAEE@Z @ 0x140279ED8
 * Callers:
        ...
        unsigned __int8 a4)
{
  ...
  *((_QWORD *)this + 1) = a3;
  if ( *(_DWORD *)this )
  {
    do
    {
      BLTQUEUE::BLTQUEUE(a3, this, v4, *(struct _KEVENT **)(3984LL * v4 + *((_QWORD *)a2 + 16) + 904), a4);
      ++v4;
      a3 = (BLTQUEUE *)((char *)a3 + 2968);
    }
