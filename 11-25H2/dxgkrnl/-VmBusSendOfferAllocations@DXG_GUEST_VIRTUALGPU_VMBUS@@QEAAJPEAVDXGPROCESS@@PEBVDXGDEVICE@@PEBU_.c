/*
 * XREFs of ?VmBusSendOfferAllocations@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBVDXGDEVICE@@PEBU_D3DKMT_OFFERALLOCATIONS@@PEBI@Z @ 0x1402262D4
 * Callers:
        ...
        const unsigned int *a5)
{
  ...
  if ( NumAllocations > 0x8000 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"NumAllocations is invalid", 10538LL, 0LL, 0LL, 0LL, 0LL);
  ...
  *(_OWORD *)v32 = 0LL;
  ...
  if ( !v32[0] )
  {
    ...
    WdLogGlobalForLineNumber = 10547;
...
LABEL_30:
      ...
      if ( !v27 )
      {
        ...
        WdLogGlobalForLineNumber = 10587;
...
LABEL_35:
  ...
  if ( v24 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 10597;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      0xFFFFFFFFLL,
