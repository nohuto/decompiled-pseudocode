/*
 * XREFs of ?ConsumerCheckForSurfacesToFree@DXGSWAPCHAIN@@AEAAJPEAU_D3DKMT_RELEASESWAPCHAIN@@@Z @ 0x1401F79B4
 * Callers:
        ...
        struct _D3DKMT_RELEASESWAPCHAIN *a2)
{
  ...
  if ( *(struct _KTHREAD **)(this + 24) != KeGetCurrentThread() )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_SwapChainLock.IsOwner()", 4077LL, 0LL, 0LL, 0LL, 0LL);
  }
  bProducer = a2[1].bProducer;
  v5 = 0;
  a2[1].bProducer = 0;
  while ( v5 < *((_DWORD *)v3 + 14) )
  {
    v6 = *((_QWORD *)v3 + 27);
    v7 = *(_QWORD *)(v6 + 16);
    if ( v7 )
    ...
    if ( *(_DWORD *)(v10 + 8) == 2 )
    {
      ...
      memset((void *)(v9 + *((_QWORD *)v3 + 8)), 0, 0xA0uLL);
      v12 = a2[1].bProducer;
      if ( v12 >= bProducer )
      {
