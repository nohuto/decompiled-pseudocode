/*
 * XREFs of ?DdiResetEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETENGINE@@@Z @ 0x140069870
 * Callers:
 *     ADAPTER_RENDER_DdiResetEngine @ 0x14006C040 (ADAPTER_RENDER_DdiResetEngine.c)
 * Callees:
