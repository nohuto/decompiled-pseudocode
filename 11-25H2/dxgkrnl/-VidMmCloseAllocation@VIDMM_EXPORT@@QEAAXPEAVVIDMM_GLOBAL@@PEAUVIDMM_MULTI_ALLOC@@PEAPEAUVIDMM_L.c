/*
 * XREFs of ?VidMmCloseAllocation@VIDMM_EXPORT@@QEAAXPEAVVIDMM_GLOBAL@@PEAUVIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_LOCAL_ALLOC@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x140041804
 * Callers:
...
{
  (*(void (__fastcall **)(struct VIDMM_GLOBAL *, struct VIDMM_MULTI_ALLOC *, struct VIDMM_LOCAL_ALLOC **, _QWORD))(*((_QWORD *)this + 1) + 136LL))(
    a2,
    a3,
    a4,
    a5.Value);
