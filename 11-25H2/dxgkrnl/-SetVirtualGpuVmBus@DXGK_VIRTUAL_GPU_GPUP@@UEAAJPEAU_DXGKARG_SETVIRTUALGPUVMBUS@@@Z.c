/*
 * XREFs of ?SetVirtualGpuVmBus@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x1402140A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
          DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v16, (__int64)v22, 0LL, 0LL, 0LL, 0LL);
          goto LABEL_27;
        }
...
LABEL_17:
  ...
  if ( !*(_BYTE *)(v5 + 616) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"VMWP process failed to reset", 249LL, 0LL, 0LL, 0LL, 0LL);
