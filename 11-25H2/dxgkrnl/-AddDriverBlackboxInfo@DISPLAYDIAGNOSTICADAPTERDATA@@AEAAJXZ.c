/*
 * XREFs of ?AddDriverBlackboxInfo@DISPLAYDIAGNOSTICADAPTERDATA@@AEAAJXZ @ 0x1401BBF20
 * Callers:
...
__int64 __fastcall DISPLAYDIAGNOSTICADAPTERDATA::AddDriverBlackboxInfo(DISPLAYDIAGNOSTICADAPTERDATA *this)
{
  ...
  if ( !*(_QWORD *)this )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDisplayAdapter != NULL", 1378LL, 0LL, 0LL, 0LL, 0LL);
  }
