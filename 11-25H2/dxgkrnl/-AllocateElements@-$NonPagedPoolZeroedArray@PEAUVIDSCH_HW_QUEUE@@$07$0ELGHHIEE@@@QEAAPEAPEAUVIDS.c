/*
 * XREFs of ?AllocateElements@?$NonPagedPoolZeroedArray@PEAUVIDSCH_HW_QUEUE@@$07$0ELGHHIEE@@@QEAAPEAPEAUVIDSCH_HW_QUEUE@@I@Z @ 0x14002D550
 * Callers:
...
__int64 __fastcall NonPagedPoolZeroedArray<VIDSCH_HW_QUEUE *,8,1265072196>::AllocateElements(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4)
