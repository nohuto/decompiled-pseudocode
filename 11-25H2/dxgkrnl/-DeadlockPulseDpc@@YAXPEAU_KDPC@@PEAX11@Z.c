/*
 * XREFs of ?DeadlockPulseDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1400658A0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  Feature_Servicing_TVSNonVolatileReadInAdapterCxx__private_IsEnabledDeviceUsageNoInline(
    Dpc,
    DeferredContext,
    SystemArgument1,
    SystemArgument2);
  ...
  if ( UnbiasedInterruptTime - v6 > 10000 * (unsigned __int64)(v9 - *((_DWORD *)DeferredContext + 4))
    && v6 == _InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4896), UnbiasedInterruptTime, v6) )
  {
    if ( (unsigned int)dword_14015B660 > 5 && tlgKeywordOn((__int64)&dword_14015B660, 0x400000004000LL) )
    {
      LOBYTE(v10) = 1;
      v15 = DeferredContext[240];
      IsDebuggerPresent = (unsigned __int8)WdIsDebuggerPresent(v10);
      v17 = *(_DWORD *)(v4 + 3216);
      v18 = *(unsigned __int8 *)(v4 + 3053);
      v19 = *(_DWORD *)(v4 + 4920);
      v20 = *(_DWORD *)(v4 + 4916);
      v21 = *(unsigned __int8 *)(v4 + 209);
      v22 = *(unsigned __int8 *)(v4 + 2948);
      v23 = *(unsigned __int8 *)(v4 + 2943);
      v24 = *(_DWORD *)(v4 + 296);
      v37 = *(_WORD *)(v4 + 3004);
      v32 = *(_QWORD *)(v4 + 2008);
      v33 = *(void **)(v4 + 2000);
  ...
  if ( *((_DWORD *)DeferredContext + 9) == 1 )
    KeSetTimer((PKTIMER)(DeferredContext + 40), (LARGE_INTEGER)(-10000LL * v9), (PKDPC)(DeferredContext + 104));
}
