/*
 * XREFs of ?DxgCreateLiveDumpWithDriverBlob@@YAJPEAU_DEVICE_OBJECT@@K_K111PEAU_DXGKARG_COLLECTDIAGNOSTICINFO@@@Z @ 0x1401A8800
 * Callers:
 ...
 *     ?DxgUnicodeStringFromCharBuffer@@YAJAEAU_UNICODE_STRING@@PEADG@Z @ 0x1401A8A7C (-DxgUnicodeStringFromCharBuffer@@YAJAEAU_UNICODE_STRING@@PEADG@Z.c)
        ...
        struct _DXGKARG_COLLECTDIAGNOSTICINFO *a7)
{
  ...
  struct _WD_DEBUG_REPORT *v15; // rdi
  int v17; // ebx
  ...
  if ( bTracingEnabled && a7 )
  {
    ...
    else if ( *((_DWORD *)a7 + 2) == 2 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40000000) != 0 )
    {
      McTemplateK0pzzzq_EtwWriteTransfer(
        v12,
        &StartDeviceFailed,
  ...
  if ( v14 )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        0xFFFFFFFFLL,
        L"DxgkAddDiagnosticInfoIntoReport failed to add all information while building live dump",
        11622LL,
        0LL,
        0LL,
        0LL,
  ...
  {
    WdLogSingleEntry0(2LL);
    WdLogGlobalForLineNumber = 11610;
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"WdDbgReportCreate failed", 11610LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225473LL;
  }
}
