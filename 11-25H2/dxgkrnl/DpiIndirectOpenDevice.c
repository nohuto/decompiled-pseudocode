/*
 * XREFs of DpiIndirectOpenDevice @ 0x140248D04
 * Callers:
 *     DpiFdoOpenDeviceFileObjectIfNeeded @ 0x14023D7C4 (DpiFdoOpenDeviceFileObjectIfNeeded.c)
 * Callees:
 *     ?DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x140248558 (-DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z.c)
 */
