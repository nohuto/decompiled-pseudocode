/*
 * XREFs of ?OpenAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAVDXGALLOCATION@@PEAU_DXGK_OPENALLOCATIONINFO@@PEAPEAX4PEAXEEIPEAIPEA_K@Z @ 0x140338CB0
 * Callers:
        ...
        unsigned __int64 *a13)
{
  ...
  *(&v47.NumAllocations + 1) = 0;
  ...
  {
    v40 = (void *)operator new[](PrivateDriverDataSize, 0x4B677844u, 258LL, v23 * 32);
    v31 = v40;
    v46 = v40;
    if ( !v40 )
    {
