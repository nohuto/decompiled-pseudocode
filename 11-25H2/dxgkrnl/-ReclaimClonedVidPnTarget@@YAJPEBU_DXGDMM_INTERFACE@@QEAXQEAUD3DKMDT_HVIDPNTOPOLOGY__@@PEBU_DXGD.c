/*
 * XREFs of ?ReclaimClonedVidPnTarget@@YAJPEBU_DXGDMM_INTERFACE@@QEAXQEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@EQEAI4@Z @ 0x1401C3F8C
 * Callers:
        ...
        unsigned int *const a7)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_pDxgDmmInterface != NULL", 3049LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a2 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 3050;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hDxgAdapter != NULL", 3050LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a3 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 3051;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hVidPnTopology != NULL", 3051LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry0(1LL);
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v18 >= 0 )
    {
      ...
      if ( !a6 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pVidPnSourceInfo != NULL", 3097LL, 0LL, 0LL, 0LL, 0LL);
        v20 = a6;
      }
...
LABEL_36:
        DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v34, (__int64)a3, v25, v29, 0LL, 0LL);
        v31 = v37[0] == 0;
        goto LABEL_37;
      }
      v35 = v42;
