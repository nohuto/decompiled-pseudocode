/*
 * XREFs of ?DdiUpdateNativeFenceLogs@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATENATIVEFENCELOGS@@@Z @ 0x14006A864
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateNativeFenceLogs @ 0x14006C1C0 (ADAPTER_RENDER_DdiUpdateNativeFenceLogs.c)
 * Callees:
