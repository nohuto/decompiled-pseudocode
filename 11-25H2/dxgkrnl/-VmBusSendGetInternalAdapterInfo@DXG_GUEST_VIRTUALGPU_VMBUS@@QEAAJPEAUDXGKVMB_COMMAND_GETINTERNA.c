/*
 * XREFs of ?VmBusSendGetInternalAdapterInfo@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAUDXGKVMB_COMMAND_GETINTERNALADAPTERINFO_RETURN@@@Z @ 0x14022509C
 * Callers:
...
LABEL_18:
  ...
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) >= 0x22u )
  {
    ...
    *((_OWORD *)a2 + 3) = v31;
    *((_QWORD *)a2 + 8) = v32;
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal() + 426) >= 0x21u && (BYTE12(v37) & 0x20) != 0 )
      *((_BYTE *)this + 80) = 1;
  }
  else
  {
