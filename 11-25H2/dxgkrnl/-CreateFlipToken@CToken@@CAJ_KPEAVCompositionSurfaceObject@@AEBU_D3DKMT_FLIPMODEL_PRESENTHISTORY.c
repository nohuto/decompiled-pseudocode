/*
 * XREFs of ?CreateFlipToken@CToken@@CAJ_KPEAVCompositionSurfaceObject@@AEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@PEAPEAV1@@Z @ 0x14000E2C4
 * Callers:
        ...
        struct CToken **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v4 == 0x2000 )
  {
    ...
    if ( *((_DWORD *)this + 34) )
    {
      for ( i = (struct CompositionSurfaceObject *)*((_QWORD *)this + 15);
            i != (struct CompositionSurfaceObject *)((char *)this + 120);
...
LABEL_7:
  ...
  Pool2 = ExAllocatePool2(256LL, 616LL, 1869892948LL, a4);
  v14 = Pool2;
  if ( Pool2 )
  {
    *(_DWORD *)(Pool2 + 24) = 6;
    ...
    *(_DWORD *)(v14 + 581) = 256;
    ...
    if ( *(_DWORD *)(v16 + 136) )
    {
      for ( j = *(__int64 **)(v16 + 120); j != (__int64 *)(v16 + 120); j = (__int64 *)*j )
      {
        if ( *(j - 1) == v22 )
        {
          v19 = *((_BYTE *)j + 17);
