/*
 * XREFs of DxgkCreateOutputDupl @ 0x1402FB340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DoesLowBoxAppHaveOutputDuplCapability@@YAEXZ @ 0x1401DFCC4 (-DoesLowBoxAppHaveOutputDuplCapability@@YAEXZ.c)
 *     ?GetCurrent@DXGPROCESS@@SAPEAV1@XZ @ 0x140296C50 (-GetCurrent@DXGPROCESS@@SAPEAV1@XZ.c)
 *     ?IsInLowBox@@YAHXZ @ 0x1402FB2B4 (-IsInLowBox@@YAHXZ.c)
...
__int64 __fastcall DxgkCreateOutputDupl(ULONG64 a1)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid process context.", 3528LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
  v4 = (char *)Current + 88;
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v14, (struct DXGGLOBAL *)((char *)Global + 305648), 0);
