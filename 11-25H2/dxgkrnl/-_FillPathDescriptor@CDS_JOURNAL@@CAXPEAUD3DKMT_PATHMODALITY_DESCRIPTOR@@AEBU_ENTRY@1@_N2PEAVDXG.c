/*
 * XREFs of ?_FillPathDescriptor@CDS_JOURNAL@@CAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@AEBU_ENTRY@1@_N2PEAVDXGADAPTER@@@Z @ 0x1403599C0
 * Callers:
 ...
 *     ??$_GetPixelFormatFromDevMode@U_unnamed_type_Mode_@_ENTRY@CDS_JOURNAL@@@CDS_JOURNAL@@CAJAEBU_unnamed_type_Mode_@_ENTRY@0@PEAW4_D3DDDIFORMAT@@@Z @ 0x14008FA00 (--$_GetPixelFormatFromDevMode@U_unnamed_type_Mode_@_ENTRY@CDS_JOURNAL@@@CDS_JOURNAL@@CAJAEBU_unn.c)
 *     ??$_GetRotationFromDevMode@U_unnamed_type_Mode_@_ENTRY@CDS_JOURNAL@@@CDS_JOURNAL@@CAJAEBU_unnamed_type_Mode_@_ENTRY@0@PEAW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@@Z @ 0x14008FB14 (--$_GetRotationFromDevMode@U_unnamed_type_Mode_@_ENTRY@CDS_JOURNAL@@@CDS_JOURNAL@@CAJAEBU_unname.c)
        ...
        struct DXGADAPTER *a5)
{
  ...
  *(_QWORD *)a1 &= 0xFFFFFFFFFF7DFE78uLL;
  ...
  if ( (*((_DWORD *)a2 + 11) & 0x20000000) != 0 )
  {
    ...
    if ( v21 )
    {
      ConvertGdiScalingToDMMScaling(v21, (_DWORD *)a1 + 35);
LABEL_20:
      v16 = a5;
...
LABEL_22:
  ...
  *(_QWORD *)a1 |= 0x40000010000uLL;
  ...
  if ( (v18 & 0x200000) != 0 )
  {
    v23 = -((v18 & 0x200000) != 0 && (*((_BYTE *)a2 + 76) & 2) != 0);
