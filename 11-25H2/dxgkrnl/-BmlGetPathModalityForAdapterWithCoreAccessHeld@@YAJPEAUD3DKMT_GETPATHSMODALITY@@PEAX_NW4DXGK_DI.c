/*
 * XREFs of ?BmlGetPathModalityForAdapterWithCoreAccessHeld@@YAJPEAUD3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IPEAPEAUD3DKMDT_HVIDPN__@@@Z @ 0x1402C3AB0
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = (unsigned __int16 *)&unk_14015C330;
  v11 = 0;
  do
  {
    v12 = v6[1];
  ...
  if ( (int)v19 >= 0 )
  {
    v21 = WdLogNewEntry5_WdTrace(v16, v15, v17, v18);
    *(_QWORD *)(v21 + 24) = v19;
    *(_QWORD *)(v21 + 32) = v11;
    WdLogGlobalForLineNumber = 6374;
  }
  return (unsigned int)v19;
}
