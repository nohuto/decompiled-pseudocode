/*
 * XREFs of ?DestroyAllocations@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@HPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1403502AC
 * Callers:
    ...
    do
    {
      ...
      *(_QWORD *)(v27 + 32) = *(_QWORD *)(*((_QWORD *)v21 + 1) + 40LL);
      ...
      if ( (v34 & 0x2000) != 0 && *((_QWORD *)v21 + 3) )
        DXGDEVICE::RemoveDirectFlipAllocationFromRequestedPinnedList((struct _KTHREAD **)this, (v34 >> 6) & 0xF, v21);
      v35 = *(_DWORD *)(*((_QWORD *)v21 + 6) + 4LL);
      if ( (v35 & 0x200A) != 0 )
        DXGDEVICE::TestAndSetDisplayedPrimary(this, (v35 >> 6) & 0xF, v21, v28);
      v36 = *((_QWORD *)v21 + 3);
    ...
    if ( (*((_DWORD *)v11 + 1) & 1) != 0 )
    {
      ...
      if ( v52 )
      {
        ...
        if ( (*(_DWORD *)(v56 - 44) & 2) != 0 )
        {
          ...
          if ( ((*(_DWORD *)(v56 - 44) >> 6) & 0xFu) >= *((_DWORD *)this + 472)
  ...
  if ( v8 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v65 )
      {
        if ( !v51 )
          goto LABEL_110;
        DXGDEVICE::DestroyAdapterAllocation(this, v65, v14);
...
LABEL_110:
        if ( !v11 )
        {
          ...
          DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pResource", 1701LL, 0LL, 0LL, 0LL, 0LL);
        }
        if ( (*((_DWORD *)v11 + 1) & 1) == 0 )
        {
          WdLogSingleEntry0(1LL);
        ...
        if ( !a3 )
        {
          ...
          DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"bDestroyResource", 1703LL, 0LL, 0LL, 0LL, 0LL);
        }
      }
