/*
 * XREFs of ?VailSendRemoteObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1402028EC
 * Callers:
        ...
        int a6)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 17011);
  }
  else
  {
    v25 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 17011);
      ...
      if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(v12[9].Count + 64)) )
      {
        ...
        else
        {
          ...
          DxgkLogInternalTriageEvent(
            ...
            0x40000,
            0xFFFFFFFFLL,
            L"Unable to get VAIL remote object interface",
            2856LL,
            0LL,
            0LL,
            0LL,
