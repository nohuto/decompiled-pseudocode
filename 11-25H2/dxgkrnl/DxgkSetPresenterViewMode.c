/*
 * XREFs of DxgkSetPresenterViewMode @ 0x1403F2370
 * Callers:
...
bool __fastcall DxgkSetPresenterViewMode(unsigned __int8 a1, unsigned __int8 a2)
{
  ...
  if ( a2 )
  {
    v6 = *((_DWORD *)DXGGLOBAL::GetGlobal() + 330) == 0;
  }
  else
  {
    v5 = (unsigned int)_InterlockedExchange((volatile __int32 *)DXGGLOBAL::GetGlobal() + 330, a1 != 0);
    v6 = (_DWORD)v5 == 0;
  }
  v7 = !v6;
