/*
 * XREFs of ?_IsModeInActiveSizeRange@MonitorModes@DxgMonitor@@AEBAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@PEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x14038B78C
 * Callers:
 ...
 * Callees:
 *     SupportedVideoSignal @ 0x14027330C (SupportedVideoSignal.c)
 */
