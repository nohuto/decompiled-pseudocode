/*
 * XREFs of ?DdiResetHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x140069A90
 * Callers:
 *     ADAPTER_RENDER_DdiResetHwEngine @ 0x14006C060 (ADAPTER_RENDER_DdiResetHwEngine.c)
 * Callees:
