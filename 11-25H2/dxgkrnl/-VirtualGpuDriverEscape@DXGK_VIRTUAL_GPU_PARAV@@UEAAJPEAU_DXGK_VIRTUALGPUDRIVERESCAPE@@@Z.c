/*
 * XREFs of ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x140210A70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v6, v7, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
