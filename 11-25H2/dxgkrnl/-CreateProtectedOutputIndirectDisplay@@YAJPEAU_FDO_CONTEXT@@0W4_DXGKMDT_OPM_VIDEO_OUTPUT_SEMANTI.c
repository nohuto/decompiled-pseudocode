/*
 * XREFs of ?CreateProtectedOutputIndirectDisplay@@YAJPEAU_FDO_CONTEXT@@0W4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@IPEAPEAX2@Z @ 0x140089740
 * Callers:
...
LABEL_20:
    ...
    if ( v15 >= 0 )
    {
      LODWORD(RedirectionInfo) = DxgkOpmCreateHandle(*((DXGADAPTER **)a1 + 504), v17, a5);
      if ( (int)RedirectionInfo < 0 )
