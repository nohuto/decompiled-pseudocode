/*
 * XREFs of ??0DXGVIRTUALMACHINE@@QEAA@PEAVDXGPROCESSVMWP@@@Z @ 0x1401E6170
 * Callers:
...
DXGVIRTUALMACHINE *__fastcall DXGVIRTUALMACHINE::DXGVIRTUALMACHINE(DXGVIRTUALMACHINE *this, struct DXGPROCESSVMWP *a2)
{
  ...
  *((_DWORD *)this + 91) = v5;
  *((_DWORD *)this + 92) = v6;
  DXGSPINLOCK::DXGSPINLOCK((DXGVIRTUALMACHINE *)((char *)this + 400));
  *((_DWORD *)this + 108) = 0;
  ...
  *((_QWORD *)this + 35) = 0LL;
  ...
  v9 = (struct DXGGLOBAL **)*((_QWORD *)Global + 208);
  if ( *v9 != (struct DXGGLOBAL *)((char *)Global + 1656) )
    __fastfail(3u);
  *(_QWORD *)v8 = (char *)Global + 1656;
  *((_QWORD *)this + 2) = v9;
  *v9 = v8;
  *((_QWORD *)Global + 208) = v8;
  ++*((_DWORD *)Global + 418);
