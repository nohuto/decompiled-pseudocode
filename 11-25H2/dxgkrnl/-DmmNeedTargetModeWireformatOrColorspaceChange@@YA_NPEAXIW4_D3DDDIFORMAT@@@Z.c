/*
 * XREFs of ?DmmNeedTargetModeWireformatOrColorspaceChange@@YA_NPEAXIW4_D3DDDIFORMAT@@@Z @ 0x1403A9E94
 * Callers:
 ...
 *     ?IsWireformatHighBpp@@YA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z @ 0x140056C1C (-IsWireformatHighBpp@@YA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z.c)
...
char __fastcall DmmNeedTargetModeWireformatOrColorspaceChange(_QWORD *a1, unsigned int a2, enum _D3DDDIFORMAT a3)
{
  ...
  v4 = a2;
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal() + 304857) )
  {
    if ( a1 )
    {
      v6 = a1[390];
        ...
        if ( v8 )
        {
          ...
          if ( v22 )
          {
            ...
            if ( NumPathsFromSource < 0 )
            {
              ...
              WdLogGlobalForLineNumber = 15577;
            }
            else
            {
              v12 = 0LL;
              ...
              while ( 1 )
              {
                ...
                if ( !v17 )
                {
                  ...
                  v13 = 0;
                  WdLogGlobalForLineNumber = 15616;
                  goto LABEL_9;
                }
                ...
                {
                  WdLogSingleEntry0(1LL);
                  WdLogGlobalForLineNumber = 15625;
                }
...
LABEL_9:
              ...
              WdLogGlobalForLineNumber = 15597;
            }
          }
          else
          {
            WdLogSingleEntry1(2LL, a1);
            WdLogGlobalForLineNumber = 15562;
          }
LABEL_6:
          auto_rc<DMMVIDPN const>::reset(&v22, 0LL);
          DXGFASTMUTEX::Release((struct _KTHREAD **)(v23 + 40));
      ...
      {
        WdLogSingleEntry1(2LL, a1);
        WdLogGlobalForLineNumber = 15531;
      }
    }
    else
    {
      WdLogSingleEntry1(2LL, 0LL);
      WdLogGlobalForLineNumber = 15516;
    }
  }
  return 0;
}
