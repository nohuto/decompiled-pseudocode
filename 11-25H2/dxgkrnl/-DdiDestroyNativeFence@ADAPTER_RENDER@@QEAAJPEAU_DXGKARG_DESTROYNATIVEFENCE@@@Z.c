/*
 * XREFs of ?DdiDestroyNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYNATIVEFENCE@@@Z @ 0x1401A1FAC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyNativeFence(
        ADAPTER_RENDER *this,
        struct _DXGKARG_DESTROYNATIVEFENCE *a2,
        __int64 a3)
{
  ...
  int v9; // ebp
  __int64 (__fastcall *v10)(struct _DXGKARG_DESTROYNATIVEFENCE *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  __int64 v14; // rcx
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5171);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5171);
  ...
  v10 = *(__int64 (__fastcall **)(struct _DXGKARG_DESTROYNATIVEFENCE *))(*((_QWORD *)this + 2) + 1504LL);
  if ( v10 )
    v11 = v10(a2);
  else
    v11 = -1073741822;
