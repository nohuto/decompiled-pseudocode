/*
 * XREFs of ?Worker@CTDR_SUBMIT_REPORT_THREAD@@MEAAXXZ @ 0x1401CB980
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CTDR_SUBMIT_REPORT_THREAD::Worker(
        struct _TDR_RECOVERY_CONTEXT **this,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  TdrDereferenceRecoveryContext(this[3], 0, a3, a4);
}
