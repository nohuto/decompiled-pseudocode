/*
 * XREFs of DpiAcquirePostDisplayOwnership @ 0x1402327EC
 * Callers:
 *     DpAcquirePostDisplayOwnership @ 0x14022E160 (DpAcquirePostDisplayOwnership.c)
 *     DpAcquirePostDisplayOwnership2 @ 0x14022E180 (DpAcquirePostDisplayOwnership2.c)
 * Callees:
...
__int64 __fastcall DpiAcquirePostDisplayOwnership(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  if ( KeGetCurrentThread() != (struct _KTHREAD *)qword_14015E158 || a1 != qword_14015E160 )
  {
    v6 = -1073741811;
    WdLogSingleEntry1(2LL, -1073741811LL);
  ...
  {
LABEL_20:
    *(_OWORD *)a2 = xmmword_14015E0B0;
    v10 = xmmword_14015E0C0;
    goto LABEL_22;
  }
  *(_OWORD *)a2 = xmmword_14015E008;
  v10 = xmmword_14015E018;
LABEL_22:
  *(_OWORD *)(a2 + 16) = v10;
  if ( a3 )
    *a3 = dword_14015E19C & 0xF | *a3 & 0xFFFFFFF0;
  return v6;
}
