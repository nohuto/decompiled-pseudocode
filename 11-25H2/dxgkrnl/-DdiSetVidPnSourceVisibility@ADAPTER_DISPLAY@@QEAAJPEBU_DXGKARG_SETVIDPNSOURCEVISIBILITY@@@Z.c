/*
 * XREFs of ?DdiSetVidPnSourceVisibility@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEVISIBILITY@@@Z @ 0x140313DC8
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (int)v10 >= 0 )
    *(_BYTE *)(3984LL * a2->VidPnSourceId + *((_QWORD *)this + 16) + 761) = a2->Visible;
