/*
 * XREFs of ?OpenKeyedMutexFromNtHandle@DXGGLOBAL@@QEAAJPEAXPEAPEAVDXGKEYEDMUTEX@@PEAI0I@Z @ 0x1401EEA34
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( !a3 )
  {
    ...
    WdLogGlobalForLineNumber = 5124;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"ppKeyedMutex", 5124LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 5125;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"phKeyedMutex", 5125LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a3 = 0LL;
  *a4 = 0;
  ...
  else if ( v9 >= 0 )
  {
    ...
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 5160;
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pSharedKeyedMutexObject", 5160LL, 0LL, 0LL, 0LL, 0LL);
    }
    v13 = *v12;
