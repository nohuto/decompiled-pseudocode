/*
 * XREFs of ?DdiValidateSubmitCommand@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_VALIDATESUBMITCOMMAND@@@Z @ 0x1402B9800
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5136);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v20, 5136);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_VALIDATESUBMITCOMMAND *))(*((_QWORD *)this + 2) + 1360LL))(
  ...
  if ( (_DWORD)v9 != -1073741592 && (_DWORD)v9 )
  {
