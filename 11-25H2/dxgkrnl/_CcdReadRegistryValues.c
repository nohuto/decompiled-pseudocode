/*
 * XREFs of _CcdReadRegistryValues @ 0x1402EAF88
 * Callers:
...
__int64 __fastcall CcdReadRegistryValues(HANDLE a1, const WCHAR *a2, const void *a3, __int64 a4, __int64 a5)
{
  ...
  if ( !is_mul_ok(v5, 0x38uLL) )
    v9 = -1LL;
  v10 = (char *)operator new[](v9, 0x63644356u, 64LL, a4);
  v11 = 56 * v5;
  v12 = v10;
  if ( v10 )
  {
