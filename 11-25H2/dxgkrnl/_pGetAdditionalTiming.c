/*
 * XREFs of _pGetAdditionalTiming @ 0x1402C8A7C
 * Callers:
 ...
 *     _pGetAdditionalModeEntry @ 0x1402C933C (_pGetAdditionalModeEntry.c)
 */
...
__int64 __fastcall pGetAdditionalTiming(int a1, char a2, _DWORD *a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    ExAcquirePushLockSharedEx(&qword_14015D6A0, 0LL);
    LOBYTE(v9) = a2;
    AdditionalModeEntry = pGetAdditionalModeEntry((unsigned int)v5, v9);
    if ( !AdditionalModeEntry )
    {
      ExReleasePushLockEx(&qword_14015D6A0, 0LL);
      ExAcquirePushLockExclusiveEx(&qword_14015D6A0, 0LL);
      LOBYTE(v11) = a2;
