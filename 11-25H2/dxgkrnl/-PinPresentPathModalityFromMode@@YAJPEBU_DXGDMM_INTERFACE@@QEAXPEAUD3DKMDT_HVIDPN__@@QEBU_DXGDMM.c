/*
 * XREFs of ?PinPresentPathModalityFromMode@@YAJPEBU_DXGDMM_INTERFACE@@QEAXPEAUD3DKMDT_HVIDPN__@@QEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@I_KPEAU_DXGK_DISPLAYMODE_INFO@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@EEPEAPEAU2@@Z @ 0x1402C2AA0
 * Callers:
 ...
 *     ConvertGdiScalingToDMMScaling @ 0x1401C4688 (ConvertGdiScalingToDMMScaling.c)
        ...
        struct D3DKMDT_HVIDPN__ **a13)
{
  ...
  struct _D3DDDI_RATIONAL v67; // [rsp+178h] [rbp+70h] BYREF
  struct _DXGDMM_VIDPN_INTERFACE *v68; // [rsp+180h] [rbp+78h]

  v68 = a4;
  v67 = (struct _D3DDDI_RATIONAL)a3;
  if ( !a2 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4108;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hAdapter != NULL", 4108LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a3 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4109;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hVidPn != NULL", 4109LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4110;
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_pDmmVidPnInterface != NULL", 4110LL, 0LL, 0LL, 0LL, 0LL);
  }
  v16 = a5;
  if ( !a5 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"i_hVidPnTopology != NULL", 4111LL, 0LL, 0LL, 0LL, 0LL);
  }
  v17 = a6;
  if ( !a6 )
  {
  ...
  if ( !a9 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"io_pDisplayModeInfo != NULL", 4113LL, 0LL, 0LL, 0LL, 0LL);
  }
  v19 = a7;
  if ( a7 == -1 )
  {
      ...
      else
      {
        for ( i = 0; ; i = a7 + 1 )
        {
          ...
          *((_QWORD *)PathDescriptor + 2) = v24;
          v44 = a12 != (_DWORD)v19 || *((_BYTE *)DXGGLOBAL::GetGlobal() + 304857);
          v45 = ConvertVidPnPathToPathDescription(
                  a2,
                  *(struct D3DKMDT_HVIDPN__ **)&v67,
                  v68,
                  a6,
                  v16,
                  a12,
          ...
          if ( a12 == (_DWORD)v19 )
          {
            ...
            *(_QWORD *)PathDescriptor |= 0x100uLL;
            v46 |= 0x100uLL;
            v47 = *(_QWORD *)PathDescriptor;
            *((_QWORD *)PathDescriptor + 1) = v46;
            v47 |= 2uLL;
            v48 = *((_QWORD *)v18 + 7);
            v46 |= 2uLL;
            *(_QWORD *)PathDescriptor = v47;
            *((_QWORD *)PathDescriptor + 1) = v46;
            *(_QWORD *)((char *)PathDescriptor + 52) = v48;
            *((_QWORD *)PathDescriptor + 28) = *((_QWORD *)v18 + 2);
            *((_DWORD *)PathDescriptor + 60) = *((_DWORD *)v18 + 18);
            *(_QWORD *)PathDescriptor = v47 | 0x1000000;
            *((_QWORD *)PathDescriptor + 1) = v46 | 0x1000000;
            ...
            if ( a11 == a10 )
            {
              v49 = ConvertD3DddiRotationToDmmRotation((enum _D3DDDI_ROTATION)*((_DWORD *)v18 + 7));
        ...
        v31 = DxgkGetGlobalRawmodeFlag() ? 0x20000 : 0;
...
LABEL_31:
          ...
          v67 = 0LL;
          LODWORD(a6) = 0;
          LODWORD(v22) = RetrievePinnedModeForTarget(v68, v39, a10, v64, &v67, (unsigned int *)&a6);
          if ( (int)v22 < 0 )
          {
            WdLogSingleEntry0(1LL);
          ...
          else
          {
            ...
            *((struct _D3DDDI_RATIONAL *)v18 + 2) = v67;
