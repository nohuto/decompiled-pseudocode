/*
 * XREFs of ?FinalizeInitialization@ADAPTER_RENDER@@QEAAJXZ @ 0x14019B188
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FinalizeInitialization(ADAPTER_RENDER *this)
{
  ...
  v4 = DXGPROCESS::OpenAdapter(*((DXGPROCESS **)Global + 167), this, 1);
  if ( v4 >= 0 )
  {
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v5, (__int64)this, 0LL, 0LL, 0LL, 0LL);
