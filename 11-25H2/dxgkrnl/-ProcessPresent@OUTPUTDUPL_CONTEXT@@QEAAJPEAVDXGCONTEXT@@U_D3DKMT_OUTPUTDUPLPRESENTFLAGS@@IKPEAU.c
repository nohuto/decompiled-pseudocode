/*
 * XREFs of ?ProcessPresent@OUTPUTDUPL_CONTEXT@@QEAAJPEAVDXGCONTEXT@@U_D3DKMT_OUTPUTDUPLPRESENTFLAGS@@IKPEAU_D3DKMT_PRESENT_RGNS@@PEBUDXGK_PRESENT_PARAMS@@PEAVAUTOEXPANDALLOCATION@@PEAPEAV2@@Z @ 0x1402FD488
 * Callers:
...
LABEL_4:
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"OpenForDevice() Failed 0x%I64x", v18, 0LL, 0LL, 0LL, 0LL);
