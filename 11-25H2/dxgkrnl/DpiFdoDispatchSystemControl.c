/*
 * XREFs of DpiFdoDispatchSystemControl @ 0x140239B80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiFdoDispatchSystemControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( DeviceExtension[3856] == 1 )
  {
    IrpDisposition = IrpProcessed;
    v3 = WmiSystemControl((PWMILIB_CONTEXT)(DeviceExtension + 3864), DeviceObject, Irp, &IrpDisposition);
    if ( IrpDisposition )
    {
