/*
 * XREFs of McTemplateK0xqqqqqq_EtwWriteTransfer @ 0x140081C64
 * Callers:
 *     ?DpiMiracastCbReportChunkInfo@@YAJPEAXPEAUDXGK_MIRACAST_CHUNK_INFO@@0I@Z @ 0x14007E1A0 (-DpiMiracastCbReportChunkInfo@@YAJPEAXPEAUDXGK_MIRACAST_CHUNK_INFO@@0I@Z.c)
 * Callees:
