/*
 * XREFs of ?DdiStopDirtyTracking@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401A74C0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopDirtyTracking(ADAPTER_RENDER *this, void *const a2, __int64 a3)
{
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5179);
  }
  else
  {
    v17 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5179);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1592LL))(
        ...
        (int)v10 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiStopDirtyTracking. Status: 0x%I64x",
      v10,
      0LL,
      0LL,
      0LL,
