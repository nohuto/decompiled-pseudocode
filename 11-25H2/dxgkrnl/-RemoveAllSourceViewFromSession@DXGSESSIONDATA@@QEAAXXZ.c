/*
 * XREFs of ?RemoveAllSourceViewFromSession@DXGSESSIONDATA@@QEAAXXZ @ 0x14031A9C0
 * Callers:
 ...
 *     ?RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ @ 0x14031AA38 (-RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ.c)
 */
