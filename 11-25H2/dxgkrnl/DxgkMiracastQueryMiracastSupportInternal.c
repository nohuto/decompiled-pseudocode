/*
 * XREFs of DxgkMiracastQueryMiracastSupportInternal @ 0x1403D0FD0
 * Callers:
 ...
 * Callees:
 *     ?IsMiniportListMutexOwnedByCurrentThread@@YAEXZ @ 0x140041E78 (-IsMiniportListMutexOwnedByCurrentThread@@YAEXZ.c)
...
__int64 __fastcall DxgkMiracastQueryMiracastSupportInternal(__int64 a1)
{
  ...
  if ( ForcedMode != 3 )
  {
    ...
    if ( v4 )
    {
      ...
      v3 = 0;
LABEL_24:
      DWORD1(xmmword_14015E2C8) = dword_14015E224;
      LOBYTE(xmmword_14015E2C8) = v12;
      BYTE8(xmmword_14015E2C8) = v3;
      *(_QWORD *)((char *)&xmmword_14015E2C8 + 12) = v5;
      if ( a1 )
      {
        *(_OWORD *)a1 = xmmword_14015E2C8;
        *(_DWORD *)(a1 + 16) = dword_14015E2D8;
      }
      if ( v2 )
        ReleaseMiniportListMutex();
      return 0LL;
    }
    xmmword_14015E2C8 = 0LL;
    dword_14015E2D8 = 0;
  }
  if ( v2 )
    ReleaseMiniportListMutex();
