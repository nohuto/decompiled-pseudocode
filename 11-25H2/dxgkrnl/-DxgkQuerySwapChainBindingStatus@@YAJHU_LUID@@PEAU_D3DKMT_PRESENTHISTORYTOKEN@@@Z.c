/*
 * XREFs of ?DxgkQuerySwapChainBindingStatus@@YAJHU_LUID@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x14000C67C
 * Callers:
...
__int64 __fastcall DxgkQuerySwapChainBindingStatus(int a1, struct _LUID a2, struct _D3DKMT_PRESENTHISTORYTOKEN *a3)
{
  ...
  if ( a3->Model == D3DKMT_PM_REDIRECTED_COMPOSITION )
  {
    ...
    if ( FenceValue )
    {
      ...
      (*(void (**)(void))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 520LL))();
      if ( !*(_QWORD *)&DXGGLOBAL::m_pGlobal )
      {
        WdLogSingleEntry0(1LL);
        WdLogGlobalForLineNumber = 2604;
      ...
      v10 = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 552LL))();
      if ( !a1
        || v10
