/*
 * XREFs of McTemplateK0pppj_EtwWriteTransfer @ 0x140077280
 * Callers:
 *     ?DestroyVirtualMachine@DXGVIRTUALMACHINE@@QEAAXXZ @ 0x1401E64A0 (-DestroyVirtualMachine@DXGVIRTUALMACHINE@@QEAAXXZ.c)
 *     ?ReportVirtualMachine@DXGVIRTUALMACHINE@@QEAAXXZ @ 0x1401E7BF0 (-ReportVirtualMachine@DXGVIRTUALMACHINE@@QEAAXXZ.c)
