/*
 * XREFs of ?CreateSourceObject@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@IPEAU_OBJECT_ATTRIBUTES@@KPEAPEAX@Z @ 0x1401C2898
 * Callers:
        ...
        PHANDLE Handle)
{
  ...
  v10 = operator new(0x70uLL, 0x4B677844u, 256LL, (__int64)a4);
  v13 = v10;
  if ( !v10 )
  {
    v20 = 0LL;
  ...
  if ( v14 >= 0 )
  {
    *(_OWORD *)Object = 0LL;
    ...
    if ( *(_QWORD *)(v13 + 24) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_Object == nullptr", 749LL, 0LL, 0LL, 0LL, 0LL);
    }
    *(_QWORD *)(v13 + 24) = v17;
    v20 = 0LL;
    *((_QWORD *)Object + 1) = v13;
