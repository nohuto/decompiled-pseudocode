/*
 * XREFs of ?Close@DxgkCompositionObject@@SAXPEAU_EPROCESS@@PEAX_K2@Z @ 0x140018AF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkCompositionObject::Close(struct _EPROCESS *a1, _DWORD *a2, __int64 a3, __int64 a4)
{
    ...
    if ( *CurrentThreadNonPaged )
    {
            ...
            ProcessSessionId == (unsigned int)PsGetProcessSessionIdEx(CurrentThreadProcess)) )
      {
        if ( *(_DWORD *)(*v12 + 376LL) )
        {
          ...
          if ( (*(int (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 8LL))(*v12) <= 1 )
          {
            WdLogSingleEntry0(1LL);
  ...
  else if ( v25[0] )
  {
    ...
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304872LL) + 16LL))(v25[0]);
  }
LABEL_10:
  if ( v27 )
