/*
 * XREFs of ?RestoreImmutableMigrationData@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA@@@Z @ 0x1401892B0
 * Callers:
 *     <none>
 * Callees:
 *     DxgkLogInternalTriageEvent @ 0x140019E90 (DxgkLogInternalTriageEvent.c)
 *     ?GetLiveMigrationImmutableDataSize@DXGK_VIRTUAL_GPU_GPUP@@QEAAII@Z @ 0x140189550 (-GetLiveMigrationImmutableDataSize@DXGK_VIRTUAL_GPU_GPUP@@QEAAII@Z.c)
...
LABEL_21:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v6, v5, v25, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
  v12 = v2[2];
