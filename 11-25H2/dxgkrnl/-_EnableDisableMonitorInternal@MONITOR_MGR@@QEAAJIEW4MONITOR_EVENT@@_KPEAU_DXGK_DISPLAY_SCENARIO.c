/*
 * XREFs of ?_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEA_N@Z @ 0x140354DC4
 * Callers:
 ...
 *     ?_ChangePowerStatus@DXGMONITOR@@QEAAX_N@Z @ 0x1403F2190 (-_ChangePowerStatus@DXGMONITOR@@QEAAX_N@Z.c)
 */
