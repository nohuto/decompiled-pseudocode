/*
 * XREFs of DpiGetWholeMonitorDescriptor @ 0x14008C494
 * Callers:
 *     ?GetWholeMonitorDescriptor@KernelDriver@@UEBAJPEAU_DXGK_MONITOR_DESCRIPTOR@@@Z @ 0x1402767A0 (-GetWholeMonitorDescriptor@KernelDriver@@UEBAJPEAU_DXGK_MONITOR_DESCRIPTOR@@@Z.c)
 * Callees:
