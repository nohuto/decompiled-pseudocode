/*
 * XREFs of DpiEnterSystemDisplay @ 0x14007D7F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPrimaryPath@ADAPTER_DISPLAY@@QEBAXPEAI0PEAW4_DXGK_PRIMARY_TARGET_TYPE@@@Z @ 0x14005A5B0 (-GetPrimaryPath@ADAPTER_DISPLAY@@QEBAXPEAI0PEAW4_DXGK_PRIMARY_TARGET_TYPE@@@Z.c)
...
LABEL_38:
                    ...
                    {
                      v15 = v27;
                      if ( !v27 && qword_14015DFF8 && v3 == *(_QWORD *)(qword_14015DFF8 + 64) )
                        *(_DWORD *)(a2 + 16) = 1;
                      else
                        *(_DWORD *)(a2 + 16) = 5;
                      v16 = v19;
...
LABEL_37:
      ...
      v10 = *(_QWORD *)v10;
      if ( *(_QWORD *)v10 == qword_14015DD88 )
        goto LABEL_49;
    }
  }
  if ( qword_14015E000 )
  {
    v17 = *(_QWORD *)(qword_14015E000 + 64);
    if ( *(_DWORD *)(v17 + 236) == 2 )
