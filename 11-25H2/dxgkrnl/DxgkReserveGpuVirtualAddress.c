/*
 * XREFs of DxgkReserveGpuVirtualAddress @ 0x1403A21E0
 * Callers:
...
LABEL_41:
  ...
  v40 = 0LL;
  DXGPAGINGQUEUEBYHANDLE::Open((DXGPAGINGQUEUEBYHANDLE *)v36, v7->hPagingQueue, Current, &v40, 0);
  v39 = 0LL;
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)v42, v7->hPagingQueue, Current, &v39, 0);
  v9 = v40;
  v10 = v39;
  if ( !v40 && !v39 )
  {
...
LABEL_26:
    ...
    if ( v7->Reserved0 == 1 )
    {
      if ( v11 )
        goto LABEL_18;
      WdLogSingleEntry1(3LL, -1073741811LL);
      WdLogGlobalForLineNumber = 13342;
      COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v45);
      if ( v37 )
        DXGADAPTER::ReleaseReference(v37);
      v37 = 0LL;
...
LABEL_18:
  ...
  WdLogGlobalForLineNumber = 13309;
  DXGADAPTER_REFERENCE::Assign((DXGADAPTER_REFERENCE *)&v37, 0LL);
