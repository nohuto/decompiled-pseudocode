/*
 * XREFs of ?InitializeVmwpProcess@DXGPROCESSVMWP@@QEAAJPEAXPEAVDXGPROCESS@@PEAU_EPROCESS@@2EPEAVDXGVIRTUALMACHINE@@@Z @ 0x1401E786C
 * Callers:
  ...
  if ( !*((_BYTE *)this + 616) )
  {
    ...
    if ( a2 )
    {
      if ( *((_BYTE *)this + 616) )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_bInitialized == FALSE", 5541LL, 0LL, 0LL, 0LL, 0LL);
      }
      v14 = *((_QWORD *)this + 74);
      *((_QWORD *)this + 75) = a3;
      *(_QWORD *)(v14 + 280) = a4;
