/*
 * XREFs of ?DdiSetPowerComponentFState@DXGADAPTER@@QEAAJKK@Z @ 0x140016E84
 * Callers:
 *     ?DxgkNotifyMemorySegmentHasData@@YAJQEAXIE@Z @ 0x140016B70 (-DxgkNotifyMemorySegmentHasData@@YAJQEAXIE@Z.c)
 *     DXGADAPTER_DdiSetPowerComponentFState @ 0x14006C220 (DXGADAPTER_DdiSetPowerComponentFState.c)
 * Callees:
...
__int64 __fastcall DXGADAPTER::DdiSetPowerComponentFState(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v6 && (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
    McTemplateK0q_EtwWriteTransfer(v15, (__int64)&EventProfilerExit, v16, v3);
