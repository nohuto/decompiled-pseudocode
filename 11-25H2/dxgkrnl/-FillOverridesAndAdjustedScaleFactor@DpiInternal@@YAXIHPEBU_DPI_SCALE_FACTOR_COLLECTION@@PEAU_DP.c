/*
 * XREFs of ?FillOverridesAndAdjustedScaleFactor@DpiInternal@@YAXIHPEBU_DPI_SCALE_FACTOR_COLLECTION@@PEAU_DPI_INFORMATION@@H@Z @ 0x140056330
 * Callers:
 ...
 *     ?CalculateMinMaxOverride@DpiInternal@@YAXKUtagSIZE@@PEAJ1QEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x140059C08 (-CalculateMinMaxOverride@DpiInternal@@YAXKUtagSIZE@@PEAJ1QEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z.c)
        ...
        struct _DPI_INFORMATION *a5)
{
  ...
  const struct _DPI_SCALE_FACTOR_COLLECTION *v11; // [rsp+28h] [rbp-30h]
  ...
  if ( !*((_DWORD *)a4 + 3) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      0xFFFFFFFFLL,
      L"pDpiInfo->BaselineDesktopScaleFactor != DESKTOP_SCALE_INVALID",
      525LL,
      0LL,
      0LL,
      0LL,
  ...
  if ( !*((_DWORD *)a4 + 8) || !*((_DWORD *)a4 + 9) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      0xFFFFFFFFLL,
      L"pDpiInfo->CurrentResolution.cx != 0 && pDpiInfo->CurrentResolution.cy != 0",
      526LL,
      0LL,
      0LL,
      0LL,
