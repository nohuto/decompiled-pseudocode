/*
 * XREFs of DxgkGetOverlayState @ 0x1401E4400
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  ...
  *(_DWORD *)&v31.OverlayEnabled = 0;
  ...
  v27 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v26, v31.hDevice, Current, &v27);
...
LABEL_24:
  ...
  if ( v18 >= 0 )
  {
    if ( !DXGDEVICE::IsSupportOverlay((DXGDEVICE *)v7) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDevice->IsSupportOverlay()", 1092LL, 0LL, 0LL, 0LL, 0LL);
    }
