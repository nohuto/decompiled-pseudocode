/*
 * XREFs of ?GetAllocationSize@@YAJPEAVDXGDEVICE@@IPEAUtagRECT@@@Z @ 0x14034CB40
 * Callers:
...
LABEL_8:
    ...
    if ( v19 )
    {
      ...
      if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(*(ADAPTER_RENDER **)(*(_QWORD *)(v14 + 16) + 3128LL), &v17, v14) >= 0 )
      {
        a3->right = v17.Width;
...
LABEL_12:
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid source handle 0x%I64x", v11, 0LL, 0LL, 0LL, 0LL);
    }
    v15 = -1073741823;
    goto LABEL_12;
  }
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid process context.", 2605LL, 0LL, 0LL, 0LL, 0LL);
  return -1073741811LL;
}
