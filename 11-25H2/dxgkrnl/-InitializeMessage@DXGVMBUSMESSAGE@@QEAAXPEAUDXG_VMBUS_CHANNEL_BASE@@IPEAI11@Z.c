/*
 * XREFs of ?InitializeMessage@DXGVMBUSMESSAGE@@QEAAXPEAUDXG_VMBUS_CHANNEL_BASE@@IPEAI11@Z @ 0x1402FACC0
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v11 = *((_DWORD *)DXGGLOBAL::GetGlobal() + 427);
  *((_DWORD *)this + 4) = a3;
  if ( v11 >= 0x28 )
  {
    a3 += 16;
  ...
  if ( a3 > 0x100 )
  {
    *((_QWORD *)this + 1) = ExAllocatePool2(64LL, a3, 1299609668LL, v10);
  }
  else
  {
