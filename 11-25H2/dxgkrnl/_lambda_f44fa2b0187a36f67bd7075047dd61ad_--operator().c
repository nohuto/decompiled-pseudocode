/*
 * XREFs of _lambda_f44fa2b0187a36f67bd7075047dd61ad_::operator() @ 0x1401BF5A4
 * Callers:
 *     _lambda_c156edba848838830db052637bc2438f_::_lambda_invoker_cdecl_ @ 0x14006D620 (_lambda_c156edba848838830db052637bc2438f_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     ?GetMonitorOrientationFromGdiRotation@@YA_NKAEAW4_D3DKMDT_MONITOR_ORIENTATION@@@Z @ 0x14004F000 (-GetMonitorOrientationFromGdiRotation@@YA_NKAEAW4_D3DKMDT_MONITOR_ORIENTATION@@@Z.c)
...
__int64 __fastcall lambda_f44fa2b0187a36f67bd7075047dd61ad_::operator()(__int64 a1, __int64 a2)
{
  _DWORD *v4; // rax
  __int64 v5; // r15
  __int64 v6; // rdx
