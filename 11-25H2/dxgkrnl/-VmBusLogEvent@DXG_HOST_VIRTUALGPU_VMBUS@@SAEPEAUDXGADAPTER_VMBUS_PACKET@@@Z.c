/*
 * XREFs of ?VmBusLogEvent@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14021E530
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v2 )
    {
      ...
      if ( bTracingEnabled )
      {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_14015B660 > 5 && tlgKeywordOn((__int64)&dword_14015B660, 0x400000008000LL) )
          {
            v31 = *(_DWORD *)(v9 + 432);
            v32 = *(_DWORD *)(v9 + 428);
            v33 = *(_DWORD *)(v9 + 424);
