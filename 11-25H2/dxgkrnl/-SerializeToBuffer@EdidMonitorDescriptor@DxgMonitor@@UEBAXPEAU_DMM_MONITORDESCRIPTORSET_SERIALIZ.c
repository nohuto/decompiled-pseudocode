/*
 * XREFs of ?SerializeToBuffer@EdidMonitorDescriptor@DxgMonitor@@UEBAXPEAU_DMM_MONITORDESCRIPTORSET_SERIALIZATION@@I@Z @ 0x140278DD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ @ 0x140278C50 (-GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ.c)
 */
