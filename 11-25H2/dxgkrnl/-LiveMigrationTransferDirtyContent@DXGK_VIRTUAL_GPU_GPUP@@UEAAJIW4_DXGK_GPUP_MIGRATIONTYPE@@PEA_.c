/*
 * XREFs of ?LiveMigrationTransferDirtyContent@DXGK_VIRTUAL_GPU_GPUP@@UEAAJIW4_DXGK_GPUP_MIGRATIONTYPE@@PEA_K@Z @ 0x1402132D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateLiveMigrationAllocIndex@DXGK_VIRTUAL_GPU_GPUP@@QEAAXXZ @ 0x140214514 (-UpdateLiveMigrationAllocIndex@DXGK_VIRTUAL_GPU_GPUP@@QEAAXXZ.c)
