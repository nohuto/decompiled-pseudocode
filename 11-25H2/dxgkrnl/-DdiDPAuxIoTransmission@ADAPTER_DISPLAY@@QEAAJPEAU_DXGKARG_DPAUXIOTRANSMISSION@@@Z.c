/*
 * XREFs of ?DdiDPAuxIoTransmission@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DPAUXIOTRANSMISSION@@@Z @ 0x1401A1008
 * Callers:
        ...
        __int64 a3)
{
  ...
  int v9; // ebp
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(_QWORD, struct _DXGKARG_DPAUXIOTRANSMISSION *); // rax
  int v12; // edi
  KIRQL v13; // al
  __int64 v14; // rcx
  __int64 v15; // r8
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, a3, 5151);
  }
  else
  {
    v19 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5151);
  ...
  if ( v10 && (v11 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_DPAUXIOTRANSMISSION *))(v10 + 48)) != 0LL )
        ...
        v12 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiDPAuxIoTransmission. Status: 0x%I64x",
      v12,
      0LL,
      0LL,
      0LL,
