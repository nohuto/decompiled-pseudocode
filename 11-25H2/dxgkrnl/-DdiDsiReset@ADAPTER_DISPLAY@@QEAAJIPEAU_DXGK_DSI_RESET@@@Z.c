/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1401A2BE8
 * Callers:
 *     ?DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z @ 0x140276540 (-DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDsiReset(ADAPTER_DISPLAY *this, unsigned int a2, struct _DXGK_DSI_RESET *a3)
{
  ...
  int v10; // ebp
  __int64 v11; // rcx
  __int64 (__fastcall *v12)(_QWORD, _QWORD, struct _DXGK_DSI_RESET *); // rax
  int v13; // edi
  KIRQL v14; // al
  __int64 v15; // rcx
  __int64 v16; // r8
  ...
  if ( (qword_14015B4C0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, (__int64)&EventProfilerEnter, (__int64)a3, 5146);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 5146);
  ...
  if ( v11 && (v12 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_DSI_RESET *))(v11 + 48)) != 0LL )
        ...
        v13 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"The driver failed DxgkDdiDsiReset. Status: 0x%I64x",
      v13,
      0LL,
      0LL,
      0LL,
