/*
 * XREFs of ?CreateGpadlFromBuffer@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEAXIPEAI@Z @ 0x140214DA4
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  LODWORD(a4) = ((__int64 (__fastcall *)(struct _KTHREAD *, _QWORD, void *, _QWORD, unsigned int *))qword_14015D340)(
                  *this,
                  0LL,
                  a2,
                  a3,
