/*
 * XREFs of ?GetShadowBufferDirtyRect@@YAEPEAUtagRECT@@II@Z @ 0x14005B718
 * Callers:
...
char __fastcall GetShadowBufferDirtyRect(struct tagRECT *a1, unsigned int a2, unsigned int a3)
{
  ...
  v6 = 1;
  if ( *((struct _KTHREAD **)DXGGLOBAL::GetGlobal() + 199) != KeGetCurrentThread() )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 4737;
  ...
  v7 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 195);
  if ( !v7 )
    return 0;
