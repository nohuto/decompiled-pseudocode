/*
 * XREFs of ?SmmBuildAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADL@@II@Z @ 0x1400602E4
 * Callers:
 ...
 *     SmmBuildAdlFromAddress @ 0x14006037C (SmmBuildAdlFromAddress.c)
 *     SmmBuildAdlFromMdl @ 0x140092BB4 (SmmBuildAdlFromMdl.c)
 */
