/*
 * XREFs of DxgkGetAdapterDeviceDesc @ 0x140418390
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetDisplayInfoDefaultToSDR@@YAXPEAU_DISPLAYCONFIG_GET_DISPLAY_INFO@@@Z @ 0x1403B715C (-SetDisplayInfoDefaultToSDR@@YAXPEAU_DISPLAYCONFIG_GET_DISPLAY_INFO@@@Z.c)
...
__int64 __fastcall DxgkGetAdapterDeviceDesc(struct _LUID a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v42; // rdx
  __int64 v43; // r11
  D3DDDI_VIDEO_PRESENT_SOURCE_ID v44; // esi
  DXGADAPTER *v45; // rsi
  DXGADAPTER *v46; // r13
  __int64 v47; // rcx
  ...
  D3DDDI_VIDEO_PRESENT_SOURCE_ID v99; // [rsp+50h] [rbp-B0h]
  ...
  if ( !a4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"NULL != pDisplayInfo", 7183LL, 0LL, 0LL, 0LL, 0LL);
  }
  v128 = 0LL;
...
LABEL_140:
  ...
  if ( !v106 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pRenderAdapter != NULL", 7300LL, 0LL, 0LL, 0LL, 0LL);
  }
  v32 = v108;
  v98 = v108;
...
LABEL_151:
    ...
    *(_DWORD *)(a4 + 2028) = TargetUsage;
    ...
    else
    {
      ...
      *(_OWORD *)(a4 + 1952) = *(_OWORD *)(3984LL * (unsigned int)v6 + *(_QWORD *)(*((_QWORD *)v46 + 390) + 128LL) + 688);
    }
    *(_DWORD *)(a4 + 1916) = v110;
...
LABEL_108:
    *(_DWORD *)(a4 + 2052) &= ~0x400u;
    v71 = 3984LL * v44;
    v72 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v46 + 390) + 128LL) + v71 + 3764);
    *(_QWORD *)(a4 + 2032) = v72;
    if ( v72 )
    {
      _mm_lfence();
      ...
      if ( *(_DWORD *)(*((_QWORD *)v108 + 390)
                     + 80 * (*(unsigned int *)(*(_QWORD *)(*((_QWORD *)v108 + 390) + 128LL) + v71 + 3764) + 11LL)) == 1 )
      {
        *(_DWORD *)(a4 + 2036) = 1;
      }
      else
    ...
    if ( !v86 )
      goto LABEL_151;
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v132, (struct DXGFASTMUTEX *const)(v86 + 3768), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v132);
    v87 = *(_DWORD *)(v86 + 16LL * *(unsigned int *)(v86 + 3976) + 3828);
