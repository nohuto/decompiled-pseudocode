/*
 * XREFs of ?SaveManagedPrimaryState@MANAGEDPRIMARIESTRACKER@@QEAAXPEAVDXGDEVICE@@I@Z @ 0x140425F38
 * Callers:
        ...
        int a3)
{
  ...
  if ( !*(_QWORD *)this )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"m_pDisplayCore != NULL", 77LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( (v7 & 0xFFFFFFF8) != 0 )
  {
    while ( 1 )
    {
      ...
      *((_DWORD *)this + v6 + 84) = v10 ^ ((unsigned __int16)v10 ^ (unsigned __int16)((unsigned __int8)(*((_DWORD *)VidPnSourceOwner + v6 + 310) >> 9) << 9)) & 0x200;
      DisplayedPrimary = DXGDEVICE::GetDisplayedPrimary(VidPnSourceOwner, v6);
