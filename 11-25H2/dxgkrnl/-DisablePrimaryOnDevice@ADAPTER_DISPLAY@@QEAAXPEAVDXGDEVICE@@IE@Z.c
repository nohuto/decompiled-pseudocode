/*
 * XREFs of ?DisablePrimaryOnDevice@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@IE@Z @ 0x1402D83A4
 * Callers:
        ...
        unsigned __int8 a4)
{
  ...
  if ( !a2 || *((_DWORD *)a2 + 116) == 2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      0xFFFFFFFFLL,
      L"(pDevice != NULL) && !pDevice->IsCddDevice()",
      3805LL,
      0LL,
      0LL,
      0LL,
  ...
  if ( a3 != -3 && a3 >= *((_DWORD *)this + 24) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      0xFFFFFFFFLL,
      L"(VidPnSourceId == D3DDDI_ID_ALL) || (VidPnSourceId < GetNumVidPnSources())",
      3806LL,
      0LL,
      0LL,
      0LL,
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(*((PERESOURCE **)this + 2)) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceExclusiveOwner()", 3808LL, 0LL, 0LL, 0LL, 0LL);
  }
  v9 = (DXGADAPTER **)*((_QWORD *)a2 + 2);
  v10 = v9[2];
  if ( *((DXGADAPTER **)a2 + 235) == v10 )
  {
    if ( *((int *)v10 + 751) < 2000 )
    {
      ADAPTER_DISPLAY::DisableAllPrimaries(this, (struct ADAPTER_RENDER *)v9);
    }
    else
    {
      v11 = 0;
      ...
      if ( *(_DWORD *)(v13 + 200) == 1 )
      {
        ...
        else
        {
          ...
          ADAPTER_RENDER::FlushPresentReferencesAndDisableOverlays(*((ADAPTER_RENDER **)a2 + 2), v14, 0, v15, 0);
        }
      }
        ...
        if ( a3 == -3 || i == a3 )
        {
          if ( ADAPTER_DISPLAY::GetVidPnSourceOwner(this, i) == a2 )
          {
            if ( !v11 )
            {
              ...
              DXGADAPTER::DecrementVSyncWaiter(*(DXGADAPTER **)(*((_QWORD *)a2 + 2) + 16LL), i, v17);
              v11 = 1;
            }
            v18 = ADAPTER_DISPLAY::SetVidPnSourceVisibility(this, i, 0, 8u, a4);
            if ( v18 < 0 )
            {
              v19 = v18;
              WdLogSingleEntry3(2LL, i, *((_QWORD *)this + 2), v18);
              v22 = *((_QWORD *)this + 2);
          ...
          if ( *((_DWORD *)a2 + 116) )
          {
            ...
            if ( *(int *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL) + 3004LL) < 2200 )
              DXGDEVICE::UnpinAllDirectFlipAllocations(a2, i, v20, v21);
          }
          else
          {
