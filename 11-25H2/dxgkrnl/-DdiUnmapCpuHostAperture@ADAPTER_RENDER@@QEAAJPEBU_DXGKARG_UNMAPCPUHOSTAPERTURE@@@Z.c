/*
 * XREFs of ?DdiUnmapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_UNMAPCPUHOSTAPERTURE@@@Z @ 0x140343B10
 * Callers:
 *     ADAPTER_RENDER_DdiUnmapCpuHostAperture @ 0x14003E2E0 (ADAPTER_RENDER_DdiUnmapCpuHostAperture.c)
 * Callees:
