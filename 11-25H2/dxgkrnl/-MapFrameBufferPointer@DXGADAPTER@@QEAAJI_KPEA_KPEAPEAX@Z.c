/*
 * XREFs of ?MapFrameBufferPointer@DXGADAPTER@@QEAAJI_KPEA_KPEAPEAX@Z @ 0x140190D4C
 * Callers:
        ...
        void **a5)
{
  ...
  if ( a2 >= *((_DWORD *)this + 74) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      0xFFFFFFFFLL,
      L"MapFrameBufferPointer Invalid physical adapter index. Index=%u",
      v7,
      0LL,
      0LL,
      0LL,
  ...
  if ( (a3 & 0xFFF) != 0 )
  {
    ...
    v14 = 0LL;
    v13 = 0LL;
    WdLogGlobalForLineNumber = 11576;
LABEL_11:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v8, v16, v13, v14, 0LL, 0LL);
    return 3221225485LL;
  }
  v9 = *((_QWORD *)this + 374) + 344LL * a2;
  v10 = *(_QWORD *)(v9 + 56);
  if ( v6 + a3 > v10 || v6 + a3 < v6 )
  {
    ...
    v14 = *(_QWORD *)(v9 + 56);
    v13 = v6;
    WdLogGlobalForLineNumber = 11588;
    goto LABEL_11;
  }
  v15 = 0LL;
  v17 = v6;
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 11605;
  }
  return result;
}
