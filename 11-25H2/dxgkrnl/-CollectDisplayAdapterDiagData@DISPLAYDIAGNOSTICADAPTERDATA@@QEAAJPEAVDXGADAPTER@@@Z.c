/*
 * XREFs of ?CollectDisplayAdapterDiagData@DISPLAYDIAGNOSTICADAPTERDATA@@QEAAJPEAVDXGADAPTER@@@Z @ 0x1401BCC9C
 * Callers:
        ...
        struct DXGADAPTER *a2)
{
  ...
  *((_BYTE *)this + 20) = DXGADAPTER::IsBddFallbackDriver(a2);
  ...
  if ( v5 >= 0 )
  {
    ...
    *((_BYTE *)this + 3505) = *((_BYTE *)DXGGLOBAL::GetGlobal() + 305088);
    *((_BYTE *)this + 3506) = *((_BYTE *)DXGGLOBAL::GetGlobal() + 305089);
  }
