/*
 * XREFs of ?DdiSubmitCommandVirtual@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUBMITCOMMANDVIRTUAL@@@Z @ 0x14030C040
 * Callers:
 *     ADAPTER_RENDER_DdiSubmitCommandVirtual @ 0x140037C30 (ADAPTER_RENDER_DdiSubmitCommandVirtual.c)
 * Callees:
