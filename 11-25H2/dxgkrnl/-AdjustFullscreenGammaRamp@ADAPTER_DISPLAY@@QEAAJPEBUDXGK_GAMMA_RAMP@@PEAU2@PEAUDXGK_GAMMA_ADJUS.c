/*
 * XREFs of ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x140194A1C
 * Callers:
 ...
 * Callees:
 *     ?ScaleAndOffset@@YAGGMM@Z @ 0x1401989A8 (-ScaleAndOffset@@YAGGMM@Z.c)
 *     ?ScaleAndOffset@@YAMMMMMM@Z @ 0x1401989EC (-ScaleAndOffset@@YAMMMMMM@Z.c)
 */
        ...
        struct DXGK_GAMMA_ADJUSTMENT *a4)
{
  ...
  do
  {
    ...
    *(float *)(v14 + 4) = v13;
    v18 = ScaleAndOffset(*(float *)(v16 + v14 + 8), *(float *)(v15 + 8), *(float *)(v15 + 20), 0.0, v17);
    *(float *)(v19 + 8) = v18;
    v7 = v19 + 12;
  }
  while ( v20 != 1 );
