/*
 * XREFs of DxgkCheckVidPnExclusiveOwnership @ 0x1403C3D40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCheckVidPnExclusiveOwnership(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v43 = 0LL;
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)v36, v44, Current, &v43, 1);
  v8 = v43;
  if ( !v43 )
  {
    v24 = -1073741811;
