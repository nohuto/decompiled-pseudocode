/*
 * XREFs of ?DmmConvertDWMCloneToUnpinnedHardwareCloneOnSource@@YAJPEAXPEAI_KPEAUD3DKMDT_HVIDPN__@@1@Z @ 0x1403DF784
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( v10 )
  {
    if ( *(VIDPN_MGR **)(v10 + 48) == v9 )
    {
      ...
      while ( v13 < v7 )
      {
        ...
        if ( NumPathsFromSource < 0 )
        {
          ...
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 14652;
        }
        if ( v30[0] > 1 )
        {
          v12 = -1073741811;
          WdLogSingleEntry4(2LL, v15, v30[0], v11, -1073741811LL);
          WdLogGlobalForLineNumber = 14669;
          goto LABEL_34;
        }
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 14683;
        }
        if ( a5 )
          a5[v13] = v19;
        if ( v13 )
        {
          ...
          if ( !Path )
          {
            WdLogSingleEntry0(1LL);
            Path = 0LL;
            WdLogGlobalForLineNumber = 14715;
          }
          v22 = *((_DWORD *)Path + 26);
          v23 = *((_WORD *)Path + 54);
          v28 = v22;
          ...
          v24 = VIDPN_MGR::AddPathToVidPnTopology(v9, v14, v8, v19, v28, v31, 1, D3DKMDT_MCC_ENFORCE);
          v25 = v24;
          if ( v24 < 0 )
          {
            WdLogSingleEntry4(2LL, v19, v8, v11, v24);
            WdLogGlobalForLineNumber = 14745;
            v12 = v25;
            goto LABEL_34;
          }
        }
    ...
    else
    {
      ...
      WdLogGlobalForLineNumber = 14626;
    }
  }
  else
  {
    v12 = -1073741811;
    WdLogSingleEntry2(2LL, a4, -1073741811LL);
    WdLogGlobalForLineNumber = 14618;
  }
LABEL_34:
