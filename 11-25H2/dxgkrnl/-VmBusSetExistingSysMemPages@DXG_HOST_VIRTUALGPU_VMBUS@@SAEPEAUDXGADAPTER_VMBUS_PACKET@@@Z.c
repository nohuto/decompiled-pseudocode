/*
 * XREFs of ?VmBusSetExistingSysMemPages@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140229500
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusSetExistingSysMemPages(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  struct DXGPROCESS *v25; // [rsp+68h] [rbp-98h]
  ...
  if ( v4 )
  {
    ...
    if ( !v23 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, L"Invalid device handle: 0x%I64x", v19, 0LL, 0LL, 0LL, 0LL);
      v7 = -1073741811;
      v22 = -1073741811;
      goto LABEL_27;
    }
    ...
    if ( v22 >= 0 )
    {
      ...
      {
        v10 = v4[7];
        v27 = (volatile signed __int32 *)((char *)v25 + 248);
        DXGPUSHLOCK::AcquireShared((struct DXGPROCESS *)((char *)v25 + 248));
        v11 = (v10 >> 6) & 0xFFFFFF;
