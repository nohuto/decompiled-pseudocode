/*
 * XREFs of ?WriteDxgDiagnosticsEvent_HPD@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14003F258
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_HPD(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304800) )
  {
    if ( (unsigned int)dword_14015B5F0 > 1
      && (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, 0x200000000002LL)
      && (unsigned __int8)tlgKeywordOn(&dword_14015B5F0, v6) )
    {
      ...
      goto LABEL_7;
         ...
         && (qword_14015B600 & 0x200000000002LL) != 0
         && (qword_14015B608 & 0x200000000002LL) == qword_14015B608 )
  {
    v5 = &unk_14013B06C;
LABEL_7:
    v8 = *((_WORD *)a1 + 2);
