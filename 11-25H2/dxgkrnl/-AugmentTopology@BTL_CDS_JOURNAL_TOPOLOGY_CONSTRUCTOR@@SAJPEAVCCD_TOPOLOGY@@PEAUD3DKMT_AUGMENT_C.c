/*
 * XREFs of ?AugmentTopology@BTL_CDS_JOURNAL_TOPOLOGY_CONSTRUCTOR@@SAJPEAVCCD_TOPOLOGY@@PEAUD3DKMT_AUGMENT_CDSJ@@_N@Z @ 0x140262EA4
 * Callers:
        ...
        char a3)
{
  ...
  int v19; // r15d
  __int64 v20; // rax
  struct D3DKMT_PATHMODALITY_DESCRIPTOR *v21; // r15
  int ClientVidPn; // eax
  ...
  struct D3DKMT_PATHMODALITY_DESCRIPTOR *v43; // [rsp+78h] [rbp-88h]
    ...
    if ( i >= v9 )
    {
      ...
      if ( v17 )
      {
        ...
        if ( v19 >= 0 )
        {
          ...
          v43 = *(struct D3DKMT_PATHMODALITY_DESCRIPTOR **)(v20 + 104);
          v21 = v43;
