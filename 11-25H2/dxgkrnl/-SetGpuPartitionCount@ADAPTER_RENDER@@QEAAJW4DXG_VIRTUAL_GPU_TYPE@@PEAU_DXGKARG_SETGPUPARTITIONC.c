/*
 * XREFs of ?SetGpuPartitionCount@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_SETGPUPARTITIONCOUNT@@E@Z @ 0x140208C64
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::SetGpuPartitionCount(ADAPTER_RENDER *a1, int a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 v8; // rcx
  __int64 v9; // rax
  ...
  if ( (_BYTE)a4 || (result = ADAPTER_RENDER::EnsureVirtualGpuProcess(a1), (int)result >= 0) )
  {
    if ( a2 == 1 )
    {
      v8 = *((_QWORD *)a1 + 234);
