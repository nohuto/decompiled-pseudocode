/*
 * XREFs of ?_GetNextMonitorFreqRangeEnumerator@MonitorModes@DxgMonitor@@QEAAJQEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@PEAPEBU3@@Z @ 0x140273790
 * Callers:
...
LABEL_25:
    ...
    {
      v15 = operator new(0x48uLL, 0x4D677844u, 256LL, a4);
