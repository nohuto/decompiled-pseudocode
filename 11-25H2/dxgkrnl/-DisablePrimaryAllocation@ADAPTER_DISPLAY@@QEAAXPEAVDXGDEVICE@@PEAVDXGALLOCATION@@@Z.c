/*
 * XREFs of ?DisablePrimaryAllocation@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@@Z @ 0x140312620
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"pDevice != NULL", 3531LL, 0LL, 0LL, 0LL, 0LL);
  }
  v7 = (char *)a3 + 48;
  if ( !a3 || !*(_QWORD *)v7 )
  {
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, 0xFFFFFFFFLL, L"IsCoreResourceExclusiveOwner()", 3535LL, 0LL, 0LL, 0LL, 0LL);
  }
  v8 = (*(_DWORD *)(*(_QWORD *)v7 + 4LL) >> 6) & 0xF;
  if ( (unsigned int)v8 >= *((_DWORD *)this + 24) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 3538;
    DxgkLogInternalTriageEvent(
      0LL,
      262146,
      0xFFFFFFFFLL,
  ...
  if ( *((_QWORD *)VidPnSourceOwner + 235) == *(_QWORD *)(v9 + 16)
