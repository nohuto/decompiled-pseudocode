/*
 * XREFs of DxgkDeviceIoctl @ 0x14006F840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z @ 0x140054610 (-CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z.c)
...
LABEL_32:
    DxgkLogInternalTriageEvent(0LL, 0x40000, 0xFFFFFFFFLL, v14, v7, 0LL, 0LL, 0LL, 0LL);
    goto LABEL_33;
  }
  v15 = *((_DWORD *)v24 + 102);
  if ( (v15 & 0x100) != 0 )
