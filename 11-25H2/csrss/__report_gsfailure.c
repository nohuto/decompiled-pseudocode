/*
 * XREFs of __report_gsfailure @ 0x140001430
 * Callers:
 *     __security_check_cookie @ 0x140001800 (__security_check_cookie.c)
 * Callees:
 *     NtTerminateProcess_0 @ 0x14000165C (NtTerminateProcess_0.c)
 *     RtlCaptureContext_0 @ 0x140001668 (RtlCaptureContext_0.c)
 *     RtlLookupFunctionEntry_0 @ 0x140001674 (RtlLookupFunctionEntry_0.c)
 *     RtlVirtualUnwind_0 @ 0x140001680 (RtlVirtualUnwind_0.c)
 *     RtlUnhandledExceptionFilter_0 @ 0x14000168C (RtlUnhandledExceptionFilter_0.c)
 */
