/*
 * XREFs of ?_Init@?$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x18005ADCC
 * Callers:
 ...
 *     ??$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z @ 0x180048FC4 (--$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z.c)
...
wchar_t *__fastcall std::numpunct<unsigned short>::_Init(mbstate_t a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = 0LL;
  Getcvt(&v13);
  grouping = (wchar_t *)&word_1800E6298;
  if ( !a3 )
