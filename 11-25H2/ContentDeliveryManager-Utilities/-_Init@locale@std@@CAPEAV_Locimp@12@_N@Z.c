/*
 * XREFs of ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x180005328
 * Callers:
...
struct std::locale::_Locimp *__fastcall std::locale::_Init(char a1)
{
  ...
  v2 = (struct std::locale::_Locimp *)qword_1801784D8;
  if ( !qword_1801784D8 )
  {
    ...
    *((_DWORD *)v2 + 8) = 63;
    ...
    qword_180178510 = (__int64)std::locale::_Locimp::_Clocptr;
  }
  if ( a1 )
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v2 + 8LL))(v2);
