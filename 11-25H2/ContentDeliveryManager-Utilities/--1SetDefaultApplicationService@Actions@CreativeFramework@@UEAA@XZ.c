/*
 * XREFs of ??1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ @ 0x180093B7C
 * Callers:
 *     ??_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800941A0 (--_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
