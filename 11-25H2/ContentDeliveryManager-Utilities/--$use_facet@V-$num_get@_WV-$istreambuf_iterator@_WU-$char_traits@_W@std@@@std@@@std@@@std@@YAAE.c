/*
 * XREFs of ??$use_facet@V?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@@std@@YAAEBV?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@0@AEBVlocale@0@@Z @ 0x18009D310
 * Callers:
 ...
 *     ?_Getcat@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18009E090 (-_Getcat@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@SA_KPEAPEBVface.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1800BD010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

const struct std::locale::facet *__fastcall std::use_facet<std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>>(
        std::locale *this)
{
  __int64 v2; // rdi
  ...
  v8 = (struct std::_Facet_base *)std::_Facetptr<std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>>::_Psave;
  v3 = std::locale::id::operator unsigned __int64((__int64)&std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::id);
  ...
  if ( !v4 )
  {
    ...
    {
      if ( std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getcat(&v8, this) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v4 = v8;
      std::_Facetptr<std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>>::_Psave = (__int64)v8;
