/*
 * XREFs of ?GetStartScreenManagerExtensionStatics@StartDocked@@YAJPEAPEAUIStartScreenManagerExtensionStatics@StartScreen@UI@WindowsUdk@@@Z @ 0x18009520C
 * Callers:
  ...
  *(_QWORD *)this = 0LL;
  ...
  if ( ActivationFactory >= 0 )
  {
    ...
    Microsoft::WRL::Wrappers::HStringReference::CreateReference(
      ...
      0x35u);
    v7 = v16;
    v9 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v17, (const WCHAR **)off_1800DBF88, v8);
