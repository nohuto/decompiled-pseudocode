/*
 * XREFs of ??$MakeAndInitialize@VLaunchManager@ContentManagement@@UILaunchManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUILaunchManager@ContentManagement@@@Z @ 0x180026594
 * Callers:
 *     ?get_LaunchManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUILaunchManager@2@@Z @ 0x18003EA70 (-get_LaunchManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUILaunchManager@2.c)
 * Callees:
