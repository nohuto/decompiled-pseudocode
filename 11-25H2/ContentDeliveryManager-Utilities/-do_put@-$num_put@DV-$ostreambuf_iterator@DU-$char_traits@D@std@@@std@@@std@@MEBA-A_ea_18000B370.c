/*
 * XREFs of ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DO@Z @ 0x18000B370
 * Callers:
 *     <none>
 * Callees:
 *     ?_Ffmt@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAPEADPEADDH@Z @ 0x180006D60 (-_Ffmt@-$num_put@_WV-$ostreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@AEBAPEADPEADDH@Z.c)
        ...
        double a6)
{
  ...
  v16 = std::num_put<wchar_t,std::ostreambuf_iterator<wchar_t>>::_Ffmt(a1, v20, 76, *(_DWORD *)(a4 + 24));
  v17 = sprintf_s_0(Buffer, 0x6CuLL, v16, (unsigned int)v12, v11);
  *(_OWORD *)v19 = *a3;
  std::num_put<char,std::ostreambuf_iterator<char>>::_Fput(a1, a2, (__int128 *)v19, a4, a5, Buffer, v13, v14, v15, v17);
  return a2;
}
