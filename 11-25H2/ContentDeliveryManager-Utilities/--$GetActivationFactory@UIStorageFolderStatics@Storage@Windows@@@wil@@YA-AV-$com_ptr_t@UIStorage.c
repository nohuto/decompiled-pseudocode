/*
 * XREFs of ??$GetActivationFactory@UIStorageFolderStatics@Storage@Windows@@@wil@@YA?AV?$com_ptr_t@UIStorageFolderStatics@Storage@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180088B14
 * Callers:
...
const WCHAR *__fastcall wil::GetActivationFactory<Windows::Storage::IStorageFolderStatics>(
        const WCHAR *a1,
        __int64 a2,
        unsigned int a3)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(v4[1].Reserved.Reserved1, &GUID_08f327ff_85d5_48b9_aee9_28511e339f9f, a1);
