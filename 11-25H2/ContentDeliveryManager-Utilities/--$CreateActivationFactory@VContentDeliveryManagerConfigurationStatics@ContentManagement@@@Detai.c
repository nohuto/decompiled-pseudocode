/*
 * XREFs of ??$CreateActivationFactory@VContentDeliveryManagerConfigurationStatics@ContentManagement@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180040FD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$MakeAndInitialize@VContentDeliveryManagerConfigurationStatics@ContentManagement@@V12@$$V@Details@WRL@Microsoft@@YAJPEAPEAVContentDeliveryManagerConfigurationStatics@ContentManagement@@@Z @ 0x180041924 (--$MakeAndInitialize@VContentDeliveryManagerConfigurationStatics@ContentManagement@@V12@$$V@Deta.c)
