/*
 * XREFs of ??$ActivateInstance@UILockScreenRegistrySettingProvider@ContentManagement@@@wil@@YA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A06FC
 * Callers:
 ...
 *     ??$query@UILockScreenRegistrySettingProvider@ContentManagement@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A07B0 (--$query@UILockScreenRegistrySettingProvider@ContentManagement@@@-$com_ptr_t@UIInspectable@@Uerr.c)
