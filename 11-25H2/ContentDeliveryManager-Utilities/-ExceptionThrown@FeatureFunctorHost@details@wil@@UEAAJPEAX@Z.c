/*
 * XREFs of ?ExceptionThrown@FeatureFunctorHost@details@wil@@UEAAJPEAX@Z @ 0x18002F230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCaughtExceptionError@ThreadErrorContext@wil@@QEAA_NAEAUFailureInfo@2@PEBUDiagnosticsInfo@2@J@Z @ 0x180030FF4 (-GetCaughtExceptionError@ThreadErrorContext@wil@@QEAA_NAEAUFailureInfo@2@PEBUDiagnosticsInfo@2@J.c)
 ...
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x18003A004 (-RethrowCaughtException@wil@@YAXXZ.c)
 */
