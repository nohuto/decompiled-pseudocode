/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x1800316D4
 * Callers:
 ...
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z @ 0x18003524C (-MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z.c)
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x18003FB80 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
 *     memset_0 @ 0x180022921 (memset_0.c)
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180034E24 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
