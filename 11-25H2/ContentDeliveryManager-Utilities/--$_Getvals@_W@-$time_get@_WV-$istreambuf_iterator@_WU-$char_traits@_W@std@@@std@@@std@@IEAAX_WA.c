/*
 * XREFs of ??$_Getvals@_W@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@IEAAX_WAEBV_Locinfo@1@@Z @ 0x1800B2BEC
 * Callers:
 ...
 *     ?_W_Getdays@_Locinfo@std@@QEBAPEBGXZ @ 0x1800B37E0 (-_W_Getdays@_Locinfo@std@@QEBAPEBGXZ.c)
 *     ?_W_Getmonths@_Locinfo@std@@QEBAPEBGXZ @ 0x1800B3840 (-_W_Getmonths@_Locinfo@std@@QEBAPEBGXZ.c)
 */
