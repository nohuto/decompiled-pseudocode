        ...
        const unsigned __int8 *a3)
{
  ...
  v6 = std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_Hashval(
         (__int64)a1,
         a3);
  for ( i = *(_QWORD *)(a1[2] + 16 * v6); ; i = *v11 )
  {
    v8 = i;
    v9 = std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_End(
           a1,
           &v17,
           v6);
    if ( v10 == *v9 )
      break;
    if ( !std::wstring::compare((const wchar_t *)(v10 + 16), (const wchar_t *)a3) )
    {
      v12 = v11;
      do
        v13 = std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_End(
                a1,
                &v17,
                v6);
      while ( v14 != *v13 && !std::wstring::compare((const wchar_t *)a3, (const wchar_t *)(v14 + 16)) );
      if ( v8 != v14 )
      {
        *a2 = (__int64)v12;
        a2[1] = v14;
