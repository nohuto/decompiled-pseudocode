/*
 * XREFs of ?find@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEBA_KPEB_W_K1@Z @ 0x180097048
 * Callers:
 ...
 * Callees:
 *     ?find@?$char_traits@G@std@@SAPEBGPEBG_KAEBG@Z @ 0x18005D60C (-find@-$char_traits@G@std@@SAPEBGPEBG_KAEBG@Z.c)
 *     wmemcmp @ 0x18005E718 (wmemcmp.c)
 */
