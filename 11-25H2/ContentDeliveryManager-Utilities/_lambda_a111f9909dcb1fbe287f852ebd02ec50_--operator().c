/*
 * XREFs of _lambda_a111f9909dcb1fbe287f852ebd02ec50_::operator() @ 0x18009C7EC
 * Callers:
 *     wil::details::functor_wrapper_other__lambda_a111f9909dcb1fbe287f852ebd02ec50__&_std::shared_ptr_CreativeFramework::Actions::PinWebsiteToTaskbarService___::Run @ 0x18009D080 (wil--details--functor_wrapper_other__lambda_a111f9909dcb1fbe287f852ebd02ec50__-_std--shared_ptr_.c)
 * Callees:
 ...
 *     ??$make_shared@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA?AV?$shared_ptr@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@@0@$$QEAPEB_W00@Z @ 0x18009C560 (--$make_shared@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA-AV.c)
