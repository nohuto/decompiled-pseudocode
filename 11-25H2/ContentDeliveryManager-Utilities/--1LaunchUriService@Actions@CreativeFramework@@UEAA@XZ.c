/*
 * XREFs of ??1LaunchUriService@Actions@CreativeFramework@@UEAA@XZ @ 0x180098408
 * Callers:
 *     ??_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x180098750 (--_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
