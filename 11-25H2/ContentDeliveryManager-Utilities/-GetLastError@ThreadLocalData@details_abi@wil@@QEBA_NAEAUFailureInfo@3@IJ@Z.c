/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEBA_NAEAUFailureInfo@3@IJ@Z @ 0x180032020
 * Callers:
 ...
 * Callees:
 *     ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEBAXAEAUFailureInfo@3@@Z @ 0x180030764 (-Get@ThreadLocalFailureInfo@details_abi@wil@@QEBAXAEAUFailureInfo@3@@Z.c)
 */
