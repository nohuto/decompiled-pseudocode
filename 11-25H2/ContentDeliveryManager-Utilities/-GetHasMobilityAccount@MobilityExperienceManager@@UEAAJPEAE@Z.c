/*
 * XREFs of ?GetHasMobilityAccount@MobilityExperienceManager@@UEAAJPEAE@Z @ 0x1800A7550
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??Dvector_iterator_nothrow@?$vector_range_nothrow@U?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@wil@@QEBAAEBV?$ComPtr@UIWebAccount@Credentials@Security@Windows@@@WRL@Microsoft@@XZ @ 0x1800A747C (--Dvector_iterator_nothrow@-$vector_range_nothrow@U-$IVectorView@PEAVWebAccount@Credentials@Secu.c)
 *     ??Yvector_iterator_nothrow@?$vector_range_nothrow@U?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@wil@@QEAAAEAV012@H@Z @ 0x1800A748C (--Yvector_iterator_nothrow@-$vector_range_nothrow@U-$IVectorView@PEAVWebAccount@Credentials@Secu.c)
