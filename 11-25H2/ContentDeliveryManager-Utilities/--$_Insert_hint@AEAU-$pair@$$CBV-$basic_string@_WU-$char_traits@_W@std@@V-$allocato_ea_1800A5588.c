        ...
        _QWORD *a5)
{
  ...
  if ( a1[1] )
  {
    if ( a3 == *v9 )
    {
      if ( (int)std::wstring::compare((__int64)a4, (_QWORD *)(a3 + 32)) < 0 )
      {
    ...
    if ( (_QWORD *)a3 == v9 )
    {
      if ( (int)std::wstring::compare(v9[2] + 32LL, a4) < 0 )
      {
        std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
          a1,
          a2,
    ...
    {
      v13 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max(*(_QWORD *)a3);
    }
    if ( (int)std::wstring::compare(v13 + 32, a4) >= 0 )
    {
LABEL_33:
      if ( (int)std::wstring::compare(a3 + 32, a4) >= 0 )
        goto LABEL_38;
      v17 = (_QWORD *)a3;
      if ( !*(_BYTE *)(a3 + 25) )
      {
        ...
        {
          v17 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Min((_QWORD *)v18);
        }
      }
      if ( v17 != (_QWORD *)*a1 && (int)std::wstring::compare((__int64)a4, v17 + 4) >= 0 )
      {
LABEL_38:
