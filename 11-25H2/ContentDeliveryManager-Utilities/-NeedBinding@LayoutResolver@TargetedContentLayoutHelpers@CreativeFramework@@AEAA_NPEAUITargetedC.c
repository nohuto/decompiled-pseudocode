/*
 * XREFs of ?NeedBinding@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAA_NPEAUITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@V1ShellPlacementTelemetry@Logging@3@@Z @ 0x1800AD624
 * Callers:
        ...
        CreativeFramework::Logging::ShellPlacementTelemetry::LayoutResolver *a3)
{
  ...
  v6 = 0;
  v16[0] = 0;
  v7 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, _BYTE *))(*a2 + 56))(a2, *(_QWORD *)(a1 + 8), v16);
  if ( v7 < 0 )
  ...
  CreativeFramework::TargetedContentLayoutHelpers::Settings::GetLayoutType(
    ...
    *(HSTRING *)(a1 + 8),
    (const WCHAR *)&stru_18015C538);
  CreativeFramework::TargetedContentLayoutHelpers::Settings::GetLayoutType(
    (CreativeFramework::Policy *)v22,
    *(HSTRING *)(a1 + 8),
    (const WCHAR *)&stru_18015C550);
