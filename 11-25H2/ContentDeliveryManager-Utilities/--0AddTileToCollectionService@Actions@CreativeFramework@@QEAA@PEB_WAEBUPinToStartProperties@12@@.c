/*
 * XREFs of ??0AddTileToCollectionService@Actions@CreativeFramework@@QEAA@PEB_WAEBUPinToStartProperties@12@@Z @ 0x18009372C
 * Callers:
...
CreativeFramework::Actions::AddTileToCollectionService *__fastcall CreativeFramework::Actions::AddTileToCollectionService::AddTileToCollectionService(
        ...
        const wchar_t *a2,
        const struct CreativeFramework::Actions::PinToStartProperties *a3)
{
  int v4; // ebp
  _QWORD *v6; // rdi
  _QWORD *v7; // rsi
  ...
  *(_QWORD *)this = &CreativeFramework::Actions::AddTileToCollectionService::`vftable';
  std::wstring::wstring((__int64)this + 16, (__int64)a3);
  *((_QWORD *)this + 9) = 7LL;
  *((_QWORD *)this + 8) = 0LL;
  *((_WORD *)this + 24) = 0;
  std::wstring::wstring((__int64)this + 80, (__int64)a3 + 64);
  v6 = (_QWORD *)((char *)this + 112);
  std::wstring::wstring((__int64)this + 112, (__int64)a3 + 96);
  v7 = (_QWORD *)((char *)this + 144);
  std::wstring::wstring((__int64)this + 144, (__int64)a3 + 128);
  *((_QWORD *)this + 22) = 0LL;
  *((_DWORD *)this + 46) = *((_DWORD *)a3 + 40);
  *((_BYTE *)this + 8) = (unsigned int)std::wstring::compare((char *)a3 + 32, L"hidden") == 0;
