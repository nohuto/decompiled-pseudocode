/*
 * XREFs of ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x18008CEA4
 * Callers:
 *     ??_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z @ 0x18008D160 (--_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z.c)
 * Callees:
