/*
 * XREFs of ?GetOrCreateBaseEventForPlacementId@?$GenericOffersHealthTracker@$02$00@details@Health@CreativeFramework@@CA?AV?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@std@@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@6@@Z @ 0x180052684
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_RTL_SRWLOCK@@P6AXPEAU1@@Z$1?ReleaseSRWLockShared@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18002A504 (--1-$unique_storage@U-$resource_policy@PEAU_RTL_SRWLOCK@@P6AXPEAU1@@Z$1-ReleaseSRWLockShared@@YA.c)
        ...
        __int64 a2)
{
  ...
  __int64 v9; // rcx
  __int64 v10; // rdx
  char v12[8]; // [rsp+20h] [rbp-29h] BYREF
  RTL_SRWLOCK *v13; // [rsp+28h] [rbp-21h] BYREF
  _QWORD *v14; // [rsp+30h] [rbp-19h] BYREF
  std::_Ref_count_base *v15; // [rsp+38h] [rbp-11h]
  char v16[16]; // [rsp+48h] [rbp-1h] BYREF
  _BYTE v17[48]; // [rsp+58h] [rbp+Fh] BYREF

  v14 = a1;
  AcquireSRWLockShared(&CreativeFramework::Health::details::s_rwLock);
  v13 = &CreativeFramework::Health::details::s_rwLock;
  std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>>>,0>>::find(
    ...
    &v14,
    a2);
  if ( v14 == (_QWORD *)CreativeFramework::Health::details::s_placementToBaseScenarioEventsMap )
  {
    ...
    {
      v12[0] = 1;
      v7 = std::make_shared<CreativeFramework::Health::details::BaseEventsWithEvaluation<1>,std::wstring const &,bool const &>(
             &v14,
             a2,
             v12);
      v8 = std::make_pair<std::wstring const &,std::shared_ptr<CreativeFramework::Health::details::BaseEventsWithEvaluation<1>>>(
             (__int64)v17,
             a2,
             (__int64)v7);
