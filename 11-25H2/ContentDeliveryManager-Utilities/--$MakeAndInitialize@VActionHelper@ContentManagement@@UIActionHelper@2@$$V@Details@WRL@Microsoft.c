/*
 * XREFs of ??$MakeAndInitialize@VActionHelper@ContentManagement@@UIActionHelper@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIActionHelper@ContentManagement@@@Z @ 0x180025B38
 * Callers:
 *     ?get_ActionHelper@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIActionHelper@2@@Z @ 0x18003E670 (-get_ActionHelper@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIActionHelper@2@@.c)
 * Callees:
