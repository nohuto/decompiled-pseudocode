/*
 * XREFs of ??R_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@QEBA@XZ @ 0x18002BA80
 * Callers:
 *     ?Run@?$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ @ 0x18003A4D0 (-Run@-$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ.c)
 * Callees:
 ...
 *     ?GetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJPEBG0PEAE@Z @ 0x1800327AC (-GetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJPEBG0PEAE@Z.c)
 *     ?IsEnabled_@TraceLoggingProvider@wil@@IEBA_NE_K@Z @ 0x180034040 (-IsEnabled_@TraceLoggingProvider@wil@@IEBA_NE_K@Z.c)
 *     ?IsInRestrictedRegion@Pinning@Mobility@@YA_NXZ @ 0x1800341D0 (-IsInRestrictedRegion@Pinning@Mobility@@YA_NXZ.c)
 *     ?IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ @ 0x180034504 (-IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ.c)
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180039A30 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@details@wil@@QEAAX.c)
 *     ?SetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJEPEBG0@Z @ 0x18003B1F8 (-SetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJEPEBG0@Z.c)
            ...
            || (LOBYTE(MobilityValue) = Mobility::Pinning::IsInRestrictedRegion(v8), !(_BYTE)MobilityValue) )
          {
            if ( *a1 != 2 && a1[1] != 2 && (*a1 == 1 || a1[1] == 1 || a1[2] == 1) )
            {
              ...
              if ( LOBYTE(v34[0]) )
              {
                ...
                v39 = 0LL;
                Microsoft::WRL::Wrappers::HStringReference::CreateReference(&hstringHeader, word_1800E629C, 1u, 0);
                v15 = v39;
                v17 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(
                        &v40,
                        (const WCHAR **)&off_1800C92A8,
                        v16);
                LOBYTE(ppva) = 1;
                LOBYTE(v18) = 1;
