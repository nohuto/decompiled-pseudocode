/*
 * XREFs of ?put_Intent@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x1800779C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl::put_Intent(
        ...
        HSTRING a2)
{
  ...
  v8 = v2;
  v4 = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 15, &v9);
  v5 = v4;
  if ( v4 >= 0 )
    v5 = 0;
  else
