/*
 * XREFs of ?SetDefaultApplication@Actions@CreativeFramework@@YAXPEB_W0W4ApplicationDefaultCategory@ApplicationDefaults@Internal@Windows@@@Z @ 0x1800974FC
 * Callers:
 *     ?Invoke@SetDefaultApplicationService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800973A0 (-Invoke@SetDefaultApplicationService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ??$GetActivationFactory@UIApplicationDefaultCategoriesStatics@ApplicationDefaults@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIApplicationDefaultCategoriesStatics@ApplicationDefaults@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180097184 (--$GetActivationFactory@UIApplicationDefaultCategoriesStatics@ApplicationDefaults@Internal@Windo.c)
