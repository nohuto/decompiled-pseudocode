/*
 * XREFs of _lambda_201f500c0b3e8aa9f89acabd232435e5_::operator() @ 0x1800A3D48
 * Callers:
 *     wil::details::functor_wrapper_void__lambda_201f500c0b3e8aa9f89acabd232435e5__&_::Run @ 0x1800A52C0 (wil--details--functor_wrapper_void__lambda_201f500c0b3e8aa9f89acabd232435e5__-_--Run.c)
 * Callees:
 ...
 *     ??$ActivateInstance@UISecondaryTile@StartScreen@UI@Windows@@@wil@@YA?AV?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A34F0 (--$ActivateInstance@UISecondaryTile@StartScreen@UI@Windows@@@wil@@YA-AV-$com_ptr_t@UISecondaryTi.c)
 *     ??$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A3750 (--$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA-AV-.c)
 *     ??$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA?AV?$com_ptr_t@UIUriRuntimeClassFactory@Foundation@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A37F0 (--$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA-AV-$c_ea_1800A37F0.c)
 *     ??$query@UISecondaryTile2@StartScreen@UI@Windows@@@?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTile2@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A3AB4 (--$query@UISecondaryTile2@StartScreen@UI@Windows@@@-$com_ptr_t@UISecondaryTile@StartScreen@UI@Wi.c)
 *     ??$query@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@@?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A3B5C (--$query@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@@-$com_ptr_t@UISecondaryTile@St.c)
 *     ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x1800A4264 (-CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z.c)
 *     ?CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA?AVHString@Wrappers@WRL@Microsoft@@PEB_W@Z @ 0x1800A44DC (-CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA-AVHString@Wrapp.c)
...
void __fastcall lambda_201f500c0b3e8aa9f89acabd232435e5_::operator()(__int64 a1)
{
  ...
  *(_QWORD *)v51 = 0LL;
  ...
  v33 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v57, (const WCHAR **)off_1800DC0C8, v32);
  ...
  v43 = v46;
  v44 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v57, (const WCHAR **)off_1800DC0C8, v40);
