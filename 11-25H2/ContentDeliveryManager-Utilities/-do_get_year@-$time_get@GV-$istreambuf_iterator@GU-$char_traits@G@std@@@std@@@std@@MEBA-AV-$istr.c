/*
 * XREFs of ?do_get_year@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180019660
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  LODWORD(a5) = 0;
  v14 = std::time_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getint(a1, a3, a4, 0, 2035, &a5, v12);
  v15 = a6;
  v16 = *a6 | v14;
  *a6 = v16;
  if ( (v16 & 2) == 0 )
