/*
 * XREFs of ?_Locimp_ctor@_Locimp@locale@std@@CAXPEAV123@AEBV123@@Z @ 0x180009A2C
 * Callers:
 *     ??0_Locimp@locale@std@@AEAA@AEBV012@@Z @ 0x1800051E0 (--0_Locimp@locale@std@@AEAA@AEBV012@@Z.c)
 * Callees:
