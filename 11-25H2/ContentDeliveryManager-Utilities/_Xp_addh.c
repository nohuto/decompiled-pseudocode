...
LABEL_31:
    ...
    if ( v8 - 26 < (int)v22 )
    {
      ...
      Dint(&v34, v22);
      Dscale((unsigned __int16 *)&v34, (unsigned int)v32);
      v23 = a1[v3] - v34;
      a1[v3] = v23;
      if ( v23 == 0.0 )
      {
