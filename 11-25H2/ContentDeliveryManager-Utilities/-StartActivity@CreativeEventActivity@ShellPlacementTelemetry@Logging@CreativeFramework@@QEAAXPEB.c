/*
 * XREFs of ?StartActivity@CreativeEventActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG0I@Z @ 0x180057C68
 * Callers:
        ...
        int a4)
{
  ...
  const wchar_t *v14; // [rsp+58h] [rbp-18h] BYREF
  const wchar_t *v15; // [rsp+60h] [rbp-10h] BYREF
  __int64 v16; // [rsp+68h] [rbp-8h] BYREF
  RTL_SRWLOCK *v17; // [rsp+90h] [rbp+20h] BYREF
