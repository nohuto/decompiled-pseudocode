/*
 * XREFs of ?DismissNotification@NotificationManagerService@Actions@CreativeFramework@@AEAAXXZ @ 0x18009DC20
 * Callers:
 *     ?Revert@NotificationManagerService@Actions@CreativeFramework@@UEAAXXZ @ 0x18009E050 (-Revert@NotificationManagerService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
