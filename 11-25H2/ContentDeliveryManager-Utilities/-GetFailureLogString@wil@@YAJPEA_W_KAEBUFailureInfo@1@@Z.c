/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEA_W_KAEBUFailureInfo@1@@Z @ 0x180075F1C
 * Callers:
 ...
 *     ?LogStringPrintf@details@wil@@YAPEA_WPEA_WPEB_W1ZZ @ 0x180076400 (-LogStringPrintf@details@wil@@YAPEA_WPEA_WPEB_W1ZZ.c)
