/*
 * XREFs of ??$ActivateInstance@UIProcessContextualSuggestionsEvent@ContentManagement@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIProcessContextualSuggestionsEvent@ContentManagement@@@Z @ 0x1800245EC
 * Callers:
