/*
 * XREFs of ?CloseSession@UniqueExtendedExecutionSession@@AEAAX_N@Z @ 0x18008D1B0
 * Callers:
 *     ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x18008CEA4 (--1UniqueExtendedExecutionSession@@UEAA@XZ.c)
 *     ?OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionRevokedEventArgs@ExtendedExecution@ApplicationModel@Windows@@@Z @ 0x18008E1A0 (-OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionR.c)
 ...
 *     ?SHIsSameObject@@YAHPEAUIUnknown@@0@Z @ 0x18008EE3C (-SHIsSameObject@@YAHPEAUIUnknown@@0@Z.c)
