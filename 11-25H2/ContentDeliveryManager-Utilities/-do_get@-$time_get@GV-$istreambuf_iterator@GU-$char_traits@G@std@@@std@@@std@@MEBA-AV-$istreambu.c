/*
 * XREFs of ?do_get@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x1800185A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Getfmt@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@IEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@PEBD@Z @ 0x180012168 (-_Getfmt@-$time_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@IEBA-AV-$istreamb.c)
...
LABEL_36:
      v26 = *(void (__fastcall **)(__int64 *, __int128 *, __int128 *, __int128 *, __int64, _DWORD *, _DWORD *))(*a1 + 48);
LABEL_37:
      v27 = *a4;
      v37 = *(_OWORD *)a3;
      v38 = v27;
...
LABEL_70:
  ...
  switch ( a8 )
  {
    ...
    case 'h':
LABEL_57:
      v26 = *(void (__fastcall **)(__int64 *, __int128 *, __int128 *, __int128 *, __int64, _DWORD *, _DWORD *))(*a1 + 56);
      goto LABEL_37;
    case 'j':
      v35 = v14;
      v34 = a7 + 7;
