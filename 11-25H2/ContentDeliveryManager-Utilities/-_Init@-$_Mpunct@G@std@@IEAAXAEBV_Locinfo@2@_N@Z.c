/*
 * XREFs of ?_Init@?$_Mpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x180014720
 * Callers:
 *     ?_Getcat@?$moneypunct@G$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011A7C (-_Getcat@-$moneypunct@G$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 ...
 *     ??$_Getvals@G@?$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z @ 0x18000EC58 (--$_Getvals@G@-$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z.c)
 *     memcpy_s_0 @ 0x180022482 (memcpy_s_0.c)
 */
