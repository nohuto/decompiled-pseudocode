/*
 * XREFs of ?_Init@?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@AEAAXPEBV?$codecvt_utf8@G$0BAPPPP@$0A@@2@@Z @ 0x1800699FC
 * Callers:
        ...
        struct std::locale::facet *a2)
{
  ...
  struct std::locale::_Locimp *v8; // [rsp+30h] [rbp+8h] BYREF
  ...
  *(_QWORD *)(a1 + 8) = a2;
  ...
  if ( v6 != v4 )
  {
    ...
    if ( v7 )
      (**v7)(v7, 1LL);
    *(_QWORD *)(a1 + 16) = v4;
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v4 + 8LL))(v4);
  }
