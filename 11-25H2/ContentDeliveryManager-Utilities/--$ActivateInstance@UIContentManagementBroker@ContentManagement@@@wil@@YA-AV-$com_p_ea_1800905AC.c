/*
 * XREFs of ??$ActivateInstance@UIContentManagementBroker@ContentManagement@@@wil@@YA?AV?$com_ptr_t@UIContentManagementBroker@ContentManagement@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800905AC
 * Callers:
 ...
 *     ?Invoke@AppUninstallService@Actions@CreativeFramework@@UEAAXXZ @ 0x180091D00 (-Invoke@AppUninstallService@Actions@CreativeFramework@@UEAAXXZ.c)
 *     ?LaunchApp@LaunchAppByIdService@Actions@CreativeFramework@@AEAAXXZ @ 0x18009A3EC (-LaunchApp@LaunchAppByIdService@Actions@CreativeFramework@@AEAAXXZ.c)
 ...
 *     ?DismissNotification@NotificationManagerService@Actions@CreativeFramework@@AEAAXXZ @ 0x18009DC20 (-DismissNotification@NotificationManagerService@Actions@CreativeFramework@@AEAAXXZ.c)
 ...
 *     ?PublishSystemState@PublishSystemStateService@Actions@CreativeFramework@@AEAAXXZ @ 0x1800A05E0 (-PublishSystemState@PublishSystemStateService@Actions@CreativeFramework@@AEAAXXZ.c)
 *     ?NotifyForLockScreenUpdates@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800A1AF8 (-NotifyForLockScreenUpdates@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ.c)
 * Callees:
