/*
 * XREFs of ?ResolveContainers@SettingsContainer@CommonHelper@CreativeFramework@@AEAAXXZ @ 0x1800B6724
 * Callers:
 *     ?GetChildContainers@SettingsContainer@CommonHelper@CreativeFramework@@UEAA?AV?$map@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@Uless@Details@CommonHelper@CreativeFramework@@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@@std@@@2@@std@@XZ @ 0x1800B62D0 (-GetChildContainers@SettingsContainer@CommonHelper@CreativeFramework@@UEAA-AV-$map@V-$basic_stri.c)
 * Callees:
 ...
 *     ??0?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@QEAA@$$QEAV01@@Z @ 0x18004ACD8 (--0-$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@QEAA@$$QEAV01.c)
 ...
 *     ?clear@?$_Tree@V?$_Tmap_traits@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@Uless@Details@CommonHelper@CreativeFramework@@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x180087E48 (-clear@-$_Tree@V-$_Tmap_traits@V-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@.c)
 *     ?GetSubContainers@SettingsContainer@CommonHelper@CreativeFramework@@AEAAJPEAIPEAPEAU?$IIterator@PEAU?$IKeyValuePair@PEAUHSTRING__@@PEAVApplicationDataContainer@Storage@Windows@@@Collections@Foundation@Windows@@@Collections@Foundation@Windows@@@Z @ 0x1800B6380 (-GetSubContainers@SettingsContainer@CommonHelper@CreativeFramework@@AEAAJPEAIPEAPEAU-$IIterator@.c)
 *     ?MakeSettingsContainer@CommonHelper@CreativeFramework@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@PEAUIApplicationDataContainer@Storage@Windows@@@Z @ 0x1800B66D0 (-MakeSettingsContainer@CommonHelper@CreativeFramework@@YA-AV-$shared_ptr@VISettingsContainer@Com.c)
        ...
        CreativeFramework::CommonHelper::SettingsContainer *this)
{
  ...
  std::_Ref_count_base *v23; // [rsp+60h] [rbp-9h]
  _BYTE v24[16]; // [rsp+68h] [rbp-1h] BYREF
  _BYTE v25[32]; // [rsp+78h] [rbp+Fh] BYREF
  __int64 v26; // [rsp+98h] [rbp+2Fh] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+C8h] [rbp+5Fh]

  if ( *((_BYTE *)this + 32) )
  {
    v2 = (__int64 *)((char *)this + 16);
    std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::clear((_QWORD *)this + 2);
    v20 = 0LL;
    SubContainers = CreativeFramework::CommonHelper::SettingsContainer::GetSubContainers((__int64)this, &v18, &v20);
    if ( SubContainers < 0 )
    ...
    v17[0] = 0;
    v4 = v20;
    v5 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v20 + 56LL))(v20, v17);
    if ( v5 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        (void *)0x4D,
    ...
    while ( v17[0] )
    {
      ...
      v6 = *(_QWORD *)v4;
      v18 = 0LL;
      v7 = (*(__int64 (__fastcall **)(__int64, __int64 **))(v6 + 48))(v4, &v18);
      if ( v7 < 0 )
        wil::details::in1diag3::Throw_Hr(
          retaddr,
          (void *)0x51,
          ...
          v16);
      string = 0LL;
      v8 = (*(__int64 (__fastcall **)(__int64 *, HSTRING *))(*v18 + 48))(v18, &string);
      if ( v8 < 0 )
        wil::details::in1diag3::Throw_Hr(
          retaddr,
          (void *)0x55,
      ...
      v9 = *v18;
      v19 = 0LL;
      v10 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v9 + 56))(v18, &v19);
      if ( v10 < 0 )
        wil::details::in1diag3::Throw_Hr(
          retaddr,
          (void *)0x57,
          ...
          v16);
      SettingsContainer = CreativeFramework::CommonHelper::MakeSettingsContainer(&v22, v19);
      ...
      std::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>(
        &v26,
        SettingsContainer);
      v12 = (_QWORD *)std::_Tree_buy<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>::_Buynode<std::pair<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>(
                        (__int64)v2,
                        (__int64)v25);
      ...
      v15 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v4 + 64LL))(v4, v17);
      if ( v15 < 0 )
        wil::details::in1diag3::Throw_Hr(
          retaddr,
          (void *)0x5C,
