/*
 * XREFs of ?FindAppInfo@ContentDeliveryManagerAppInfoProvider@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAUHSTRING__@@PEAPEAUIAppInfo@25@@Z @ 0x1800A8820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$ActivateInstance@UIWpnAppInfoProvider@Notifications@Internal@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIWpnAppInfoProvider@Notifications@Internal@1@@Z @ 0x1800A821C (--$ActivateInstance@UIWpnAppInfoProvider@Notifications@Internal@Windows@@@Foundation@Windows@@YA.c)
