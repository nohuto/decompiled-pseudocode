/*
 * XREFs of _Tolower @ 0x180005D98
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x18000B970 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x18000B990 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD58 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD64 (_GetLocaleHandleById.c)
 *     __crtLCMapStringA_Stub @ 0x18000DE2C (__crtLCMapStringA_Stub.c)
 */
