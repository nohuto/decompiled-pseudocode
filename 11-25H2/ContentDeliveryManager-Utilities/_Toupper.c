/*
 * XREFs of _Toupper @ 0x18000E818
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x18000B9E0 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x18000BA00 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
