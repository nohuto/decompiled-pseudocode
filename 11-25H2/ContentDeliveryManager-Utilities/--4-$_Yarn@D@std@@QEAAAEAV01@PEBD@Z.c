/*
 * XREFs of ??4?$_Yarn@D@std@@QEAAAEAV01@PEBD@Z @ 0x180066E60
 * Callers:
 ...
 *     ?_Locinfo_ctor@_Locinfo@std@@SAXPEAV12@PEBD@Z @ 0x180005464 (-_Locinfo_ctor@_Locinfo@std@@SAXPEAV12@PEBD@Z.c)
 *     ?_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z @ 0x180005538 (-_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z.c)
 ...
 *     ?_Tidy@?$_Yarn@_W@std@@AEAAXXZ @ 0x18004C1C4 (-_Tidy@-$_Yarn@_W@std@@AEAAXXZ.c)
 */
