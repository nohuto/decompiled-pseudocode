/*
 * XREFs of ?init@?$basic_ios@_WU?$char_traits@_W@std@@@std@@IEAAXPEAV?$basic_streambuf@_WU?$char_traits@_W@std@@@2@_N@Z @ 0x1800882E8
 * Callers:
 ...
 *     ??0?$basic_istream@_WU?$char_traits@_W@std@@@std@@QEAA@PEAV?$basic_streambuf@_WU?$char_traits@_W@std@@@1@_N@Z @ 0x18009D4C8 (--0-$basic_istream@_WU-$char_traits@_W@std@@@std@@QEAA@PEAV-$basic_streambuf@_WU-$char_traits@_W.c)
 * Callees:
