/*
 * XREFs of ?ResolveTriggerCleanupHandler@Internal@TargetedContent@Services@Windows@@YA?AV?$function@$$A6AJPEAUITargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z@std@@W4TargetedContentKnownTrigger@1234@@Z @ 0x180081A60
 * Callers:
...
_QWORD *__fastcall Windows::Services::TargetedContent::Internal::ResolveTriggerCleanupHandler(_QWORD *a1, int a2)
{
  ...
  for ( i = &unk_1801776A0; i != (_DWORD *)&unk_1801776E8; i += 18 )
  {
    if ( *i == a2 )
    {
