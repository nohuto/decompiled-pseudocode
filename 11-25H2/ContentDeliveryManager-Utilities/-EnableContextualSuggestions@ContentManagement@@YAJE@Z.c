/*
 * XREFs of ?EnableContextualSuggestions@ContentManagement@@YAJE@Z @ 0x18002EDD0
 * Callers:
 *     ?put_ContextualSuggestionsEnabled@ContextualSuggestionsManager@ContentManagement@@UEAAJE@Z @ 0x18003F440 (-put_ContextualSuggestionsEnabled@ContextualSuggestionsManager@ContentManagement@@UEAAJE@Z.c)
 * Callees:
 *     ??$ActivateInstance@UIProcessContextualSuggestionsEvent@ContentManagement@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIProcessContextualSuggestionsEvent@ContentManagement@@@Z @ 0x1800245EC (--$ActivateInstance@UIProcessContextualSuggestionsEvent@ContentManagement@@@Foundation@Windows@@.c)
