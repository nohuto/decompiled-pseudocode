/*
 * XREFs of ??R_lambda_ab8afa584d195baf28431d185b201c0d_@@QEBA@XZ @ 0x18002C300
 * Callers:
 ...
 *     ??$WaitForCompletion@U?$IAsyncOperationCompletedHandler@PEAU?$IVectorView@PEAVAppListEntry@Core@ApplicationModel@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@U?$IAsyncOperation@PEAU?$IVectorView@PEAVAppListEntry@Core@ApplicationModel@Windows@@@Collections@Foundation@Windows@@@23@@@YAJPEAU?$IAsyncOperation@PEAU?$IVectorView@PEAVAppListEntry@Core@ApplicationModel@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@PEAX@Z @ 0x180027D5C (--$WaitForCompletion@U-$IAsyncOperationCompletedHandler@PEAU-$IVectorView@PEAVAppListEntry@Core@.c)
...
__int64 __fastcall _lambda_ab8afa584d195baf28431d185b201c0d_::operator()(_QWORD **a1)
{
  ...
  _BYTE v36[8]; // [rsp+30h] [rbp-49h] BYREF
  __int64 v37; // [rsp+38h] [rbp-41h] BYREF
  __int64 v38; // [rsp+40h] [rbp-39h] BYREF
  _BYTE v39[8]; // [rsp+48h] [rbp-31h] BYREF
  __int64 (__fastcall ***v40)(_QWORD, GUID *, __int64 *); // [rsp+50h] [rbp-29h] BYREF
  __int64 v41; // [rsp+58h] [rbp-21h] BYREF
  __int64 v42; // [rsp+60h] [rbp-19h] BYREF
  __int64 (__fastcall ***v43)(_QWORD, GUID *, __int64 *); // [rsp+68h] [rbp-11h] BYREF
...
LABEL_5:
    ...
    if ( v38 )
    {
      v37 = 0LL;
      v36[0] = 0;
      v8 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v38 + 48LL);
      Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v37);
      v9 = v8(v7, &v37);
      v3 = v9;
      if ( v9 < 0
        || (v9 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v37 + 56LL))(v37, v36), v3 = v9, v9 < 0) )
      {
        wil::details::in1diag3::Return_Hr(
          retaddr,
          (void *)0x188,
...
LABEL_9:
      ...
      if ( v36[0] )
      {
        v40 = 0LL;
        v10 = v37;
        v11 = *(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v37 + 48LL);
...
LABEL_14:
        ...
        v15 = v14(v13, &GUID_5f738b61_f86a_4917_93d1_f1ee9d3b35d9, &v41);
        v3 = v15;
        if ( v15 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
...
LABEL_17:
        ...
        v43 = 0LL;
        v16 = v41;
        v17 = *(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, GUID *, __int64 *)))(*(_QWORD *)v41 + 64LL);
...
LABEL_26:
        ...
        v46 = 0;
        v23 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v42 + 56LL))(v42, &v46);
        v3 = v23;
        if ( v23 < 0 )
        {
        ...
        if ( v46 )
        {
          v44 = 0LL;
          v24 = v42;
          v25 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v42 + 48LL);
