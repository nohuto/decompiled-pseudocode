/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x18002A2B8
 * Callers:
 ...
 * Callees:
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x18002DBE8 (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
