/*
 * XREFs of _Wcscoll @ 0x180021C40
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x180017FC0 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD58 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD64 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x18000DDCC (__crtCompareStringW_Stub.c)
 */
