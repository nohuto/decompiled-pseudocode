/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800308A8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180039808 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAAX_NW4Reportin.c)
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAA_NXZ @ 0x18003DD4C (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAA_NXZ.c)
 * Callees:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_48101911>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  *(_DWORD *)a2 = *(_DWORD *)a1;
  if ( (v3 & 6) != 6 )
  {
    ...
    v16 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_48101911>::GetCurrentFeatureEnabledState(v7, &v17, &v16);
    if ( !v6 )
      v16 = 0;
