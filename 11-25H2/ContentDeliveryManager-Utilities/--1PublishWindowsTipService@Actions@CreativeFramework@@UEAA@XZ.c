/*
 * XREFs of ??1PublishWindowsTipService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800A0000
 * Callers:
 *     ??_GPublishWindowsTipService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800A0040 (--_GPublishWindowsTipService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
