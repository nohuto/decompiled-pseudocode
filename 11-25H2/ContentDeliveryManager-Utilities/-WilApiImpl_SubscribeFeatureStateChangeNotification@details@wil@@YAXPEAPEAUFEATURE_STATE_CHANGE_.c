/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x18003CAF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x18003BA88 (-SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPT.c)
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_180177928);
      v8 = &stru_180177928;
      if ( qword_180177998
        || (qword_180177998 = 0LL,
                             ...
                             &qword_180177998)) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_180177950,
          this,
          (void (*)(void *))a2,
          a3);
      }
