 ...
 *     ??$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VLaunchAppByIdService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x180097BE8 (--$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VLa.c)
