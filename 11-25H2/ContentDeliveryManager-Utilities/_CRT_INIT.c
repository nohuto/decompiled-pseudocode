/*
 * XREFs of _CRT_INIT @ 0x180021FCC
 * Callers:
 *     __DllMainCRTStartup @ 0x180022254 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x180022975 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800229E0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180022B53 (_initterm_0.c)
