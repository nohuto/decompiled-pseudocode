 ...
 *     std::_dynamic_atexit_destructor_for___Fac_tidy_reg__ @ 0x180003FE0 (std--_dynamic_atexit_destructor_for___Fac_tidy_reg__.c)
 *     std::_dynamic_initializer_for__initlocks___0 @ 0x180004000 (std--_dynamic_initializer_for__initlocks___0.c)
 *     _dynamic_atexit_destructor_for__init_atexit__ @ 0x180004030 (_dynamic_atexit_destructor_for__init_atexit__.c)
 *     _dynamic_initializer_for__std::_Error_objects_int_::_Generic_object__ @ 0x180004050 (_dynamic_initializer_for__std--_Error_objects_int_--_Generic_object__.c)
 *     _dynamic_initializer_for__std::_Error_objects_int_::_Iostream_object__ @ 0x180004070 (_dynamic_initializer_for__std--_Error_objects_int_--_Iostream_object__.c)
 *     _dynamic_initializer_for__std::_Error_objects_int_::_System_object__ @ 0x180004090 (_dynamic_initializer_for__std--_Error_objects_int_--_System_object__.c)
 *     wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x1800040B0 (wil--details--_dynamic_initializer_for__g_enabledStateManager__.c)
 *     wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x1800040D0 (wil--details--_dynamic_initializer_for__g_featureStateManager__.c)
 ...
 *     wil::details::_dynamic_atexit_destructor_for__g_threadFailureCallbacks__ @ 0x180004300 (wil--details--_dynamic_atexit_destructor_for__g_threadFailureCallbacks__.c)
 ...
 *     ?get@?$static_lazy@VTaskbarContentDeliveryPinningTelemetry@@@details@wil@@QEAAPEAVTaskbarContentDeliveryPinningTelemetry@@P6AXXZ@Z @ 0x18003E50C (-get@-$static_lazy@VTaskbarContentDeliveryPinningTelemetry@@@details@wil@@QEAAPEAVTaskbarContent.c)
 *     ?get@?$static_lazy@VTaskbarLogging@@@details@wil@@QEAAPEAVTaskbarLogging@@P6AXXZ@Z @ 0x18003E5B8 (-get@-$static_lazy@VTaskbarLogging@@@details@wil@@QEAAPEAVTaskbarLogging@@P6AXXZ@Z.c)
 *     ?get@?$static_lazy@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@@details@wil@@QEAAPEAVContentDeliveryManagerLogging@Background@ContentDeliveryManager@@P6AXXZ@Z @ 0x180045098 (-get@-$static_lazy@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@@details@wi.c)
 ...
 *     ?get@?$static_lazy@VShellPlacementLogging@Logging@CreativeFramework@@@details@wil@@QEAAPEAVShellPlacementLogging@Logging@CreativeFramework@@P6AXXZ@Z @ 0x18005D7E0 (-get@-$static_lazy@VShellPlacementLogging@Logging@CreativeFramework@@@details@wil@@QEAAPEAVShell.c)
