 ...
 *     ??R_lambda_30b10436083aba01be8f7c4a25a13343_@@QEBA@U?$pair@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V12@@std@@@Z @ 0x18006035C (--R_lambda_30b10436083aba01be8f7c4a25a13343_@@QEBA@U-$pair@V-$basic_string@GU-$char_traits@G@std.c)
