/*
 * XREFs of ?_Init@?$_Mpunct@_W@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800148CC
 * Callers:
 *     ?_Getcat@?$moneypunct@_W$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011C4C (-_Getcat@-$moneypunct@_W$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
