/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x1800B69B0
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler4_0 @ 0x180022467 (__CxxFrameHandler4_0.c)
 *     __GSHandlerCheckCommon @ 0x180022814 (__GSHandlerCheckCommon.c)
 */
