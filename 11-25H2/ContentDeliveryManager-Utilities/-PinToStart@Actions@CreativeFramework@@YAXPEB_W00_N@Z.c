/*
 * XREFs of ?PinToStart@Actions@CreativeFramework@@YAXPEB_W00_N@Z @ 0x180095FA0
 * Callers:
 *     ?Invoke@PinToStartService@Actions@CreativeFramework@@UEAAXXZ @ 0x180095780 (-Invoke@PinToStartService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        const wchar_t *a4)
{
  ...
  for ( i = &off_1800DBF68; i != off_1800DBF88; i += 2 )
  {
