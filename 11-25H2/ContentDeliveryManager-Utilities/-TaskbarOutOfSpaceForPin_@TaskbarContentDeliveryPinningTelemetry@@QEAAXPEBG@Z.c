/*
 * XREFs of ?TaskbarOutOfSpaceForPin_@TaskbarContentDeliveryPinningTelemetry@@QEAAXPEBG@Z @ 0x18003BBC8
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  __int64 v5; // r8
  __int64 v6; // r9
  const unsigned __int16 *v7; // [rsp+50h] [rbp+18h] BYREF
