/*
 * XREFs of ?UnregisterTrigger@TargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@UEAAJPEAU?$IVectorView@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@@Collections@Foundation@5@PEAUHSTRING__@@E@Z @ 0x18007F000
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  AcquireSRWLockExclusive(&stru_180179398);
  v20 = &stru_180179398;
  v29 = 0;
