/*
 * XREFs of ?RuntimeClassInitialize@UniqueExtendedExecutionSession@@QEAAJXZ @ 0x18008EB08
 * Callers:
 ...
 *     ??1ExtendedExecutionRequested@CDMUtilsUnlockTelemetry@@QEAA@XZ @ 0x18008CE78 (--1ExtendedExecutionRequested@CDMUtilsUnlockTelemetry@@QEAA@XZ.c)
...
__int64 __fastcall UniqueExtendedExecutionSession::RuntimeClassInitialize(struct IUnknown *this)
{
  ...
  _QWORD v26[42]; // [rsp+50h] [rbp-B0h] BYREF
...
LABEL_26:
  ...
  *v8 = 0LL;
  ...
  v12 = (*((__int64 (__fastcall **)(struct IUnknownVtbl *, PVOID, struct IUnknown *))v2->lpVtbl->QueryInterface + 12))(
          v2->lpVtbl,
          v10,
          this + 9);
  v13 = v12;
