        ...
        _QWORD **a4)
{
  ...
  v14 = std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_Hashval(
          (__int64)a1,
          a3);
  v8 = (_QWORD *)*std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_End(
                    a1,
                    v15,
                    v14);
  v10 = 2 * v9;
  while ( v8 != *(_QWORD **)(a1[2] + 8 * v10) )
  {
    v8 = (_QWORD *)v8[1];
    if ( !(unsigned int)std::wstring::compare((__int64)a3, v8 + 2) )
    {
      ...
      {
        std::list<std::wstring>::erase(a1, v15, a4);
        *(_QWORD *)a2 = v8;
        *(_BYTE *)(a2 + 8) = 0;
        return a2;
      }
