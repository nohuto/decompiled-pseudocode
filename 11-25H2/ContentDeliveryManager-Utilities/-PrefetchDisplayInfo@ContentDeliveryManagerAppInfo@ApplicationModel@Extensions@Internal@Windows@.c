/*
 * XREFs of ?PrefetchDisplayInfo@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@AEAAXXZ @ 0x1800A9280
 * Callers:
 ...
 *     ?get_Properties@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAPEAU?$IMapView@PEAUHSTRING__@@PEAUIInspectable@@@Collections@Foundation@5@@Z @ 0x1800A9760 (-get_Properties@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@UEAA.c)
...
{
  Windows::Internal::Extensions::ApplicationModel::ContentDeliveryManagerAppDisplayInfo **v2; // rdi
  __int64 *v3; // rcx
  __int64 v4; // rax
  int v5; // eax
  int Properties; // eax
  ...
  Windows::Internal::Extensions::ApplicationModel::ContentDeliveryManagerAppDisplayInfo *v11; // rcx
  int v12; // eax
  ...
  v2 = (Windows::Internal::Extensions::ApplicationModel::ContentDeliveryManagerAppDisplayInfo **)((char *)this + 80);
  if ( !*((_QWORD *)this + 10) )
  {
    ...
    if ( v3 )
    {
      ...
      *v2 = 0LL;
      if ( v11 )
        (*(void (__fastcall **)(Windows::Internal::Extensions::ApplicationModel::ContentDeliveryManagerAppDisplayInfo *))(*(_QWORD *)v11 + 16LL))(v11);
