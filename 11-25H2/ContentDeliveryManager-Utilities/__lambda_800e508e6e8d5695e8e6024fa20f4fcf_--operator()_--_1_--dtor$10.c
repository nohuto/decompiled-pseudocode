/*
 * XREFs of __lambda_800e508e6e8d5695e8e6024fa20f4fcf_::operator()_::_1_::dtor$10 @ 0x1800B798B
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _lambda_800e508e6e8d5695e8e6024fa20f4fcf_::operator()_::_1_::dtor_10(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 52) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 52) &= ~1u;
