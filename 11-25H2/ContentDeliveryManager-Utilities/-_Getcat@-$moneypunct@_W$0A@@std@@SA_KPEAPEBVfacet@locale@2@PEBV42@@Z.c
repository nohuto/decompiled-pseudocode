/*
 * XREFs of ?_Getcat@?$moneypunct@_W$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011D34
 * Callers:
...
__int64 __fastcall std::moneypunct<wchar_t,0>::_Getcat(_QWORD *a1, __int64 *a2)
{
  char v4; // si
  _DWORD *v5; // rbx
  __int64 v6; // rax
