/*
 * XREFs of ?ResolveEventNotificationHandlerFromType@ContentManagement@@YA?AV?$function@$$A6AJXZ@std@@W4EventNotificationType@1@@Z @ 0x1800567B0
 * Callers:
...
_QWORD *__fastcall ContentManagement::ResolveEventNotificationHandlerFromType(_QWORD *a1, int a2)
{
  ...
  v3 = 0LL;
  for ( i = &unk_180177190; ; i += 5 )
  {
    if ( i == (_QWORD *)&unk_180177208 )
    {
  ...
  if ( v6 )
  {
    v7 = v6;
    v8 = v6 == v5;
    v9 = **(__int64 (__fastcall ***)(char *, _QWORD *))v6;
    if ( v8 )
      v10 = a1;
    else
      v10 = 0LL;
