/*
 * XREFs of IsOpenStateExplicitPresent @ 0x180023C68
 * Callers:
 *     ?GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z @ 0x1800B2630 (-GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z.c)
 * Callees:
 *     ApiSetQueryApiSetPresence_0 @ 0x180023E8A (ApiSetQueryApiSetPresence_0.c)
 */
...
char IsOpenStateExplicitPresent()
{
  ...
  if ( dword_180178DAC == 1 )
    return 1;
  if ( dword_180178DAC == 2 )
    return 0;
  v1 = 0;
  if ( (int)ApiSetQueryApiSetPresence_0(L"HJ", &v1) < 0 )
    return 0;
  result = v1;
  dword_180178DAC = 2 - (v1 != 0);
  return result;
}
