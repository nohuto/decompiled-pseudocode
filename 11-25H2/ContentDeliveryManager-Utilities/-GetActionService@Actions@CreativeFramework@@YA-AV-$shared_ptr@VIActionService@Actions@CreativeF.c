...
_QWORD *__fastcall CreativeFramework::Actions::GetActionService(_QWORD *a1, unsigned int a2, __int64 a3, _QWORD **a4)
{
  ...
  _QWORD *v12; // rax
  __int64 v13; // r8
  void *v15[4]; // [rsp+38h] [rbp-38h] BYREF
  char v16[24]; // [rsp+58h] [rbp-18h] BYREF
  _QWORD *v17; // [rsp+90h] [rbp+20h] BYREF

  v17 = a1;
  std::_Tree_comp<0,std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Tree_comp<0,std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>(v15);
  v8 = *a4;
  v9 = (_QWORD *)*v8;
  v17 = (_QWORD *)*v8;
  while ( v9 != v8 )
  {
    ...
    v15[2] = v10;
    v15[3] = v11;
    v12 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<unsigned short const *,unsigned short const *>>(v15);
    std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_nohint<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
      ...
      (__int64)(v12 + 4),
      v12);
    std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>,std::_Iterator_base0>::operator++(&v17);
    v9 = v17;
  }
  CreativeFramework::Actions::GetActionService(a1, a2, a3, v15);
  std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>(v15);
  return a1;
}
