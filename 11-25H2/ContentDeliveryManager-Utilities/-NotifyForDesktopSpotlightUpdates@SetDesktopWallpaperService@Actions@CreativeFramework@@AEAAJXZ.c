/*
 * XREFs of ?NotifyForDesktopSpotlightUpdates@SetDesktopWallpaperService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800A2BBC
 * Callers:
 *     ?Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800A2380 (-Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z @ 0x1800A2F80 (-SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z.c)
