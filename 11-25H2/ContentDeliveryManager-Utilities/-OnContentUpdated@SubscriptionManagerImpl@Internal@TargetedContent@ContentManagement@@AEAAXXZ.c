/*
 * XREFs of ?OnContentUpdated@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@AEAAXXZ @ 0x1800622FC
 * Callers:
 *     _lambda_83dc6366a20d9229952004eea2bdcbca_::operator() @ 0x18006045C (_lambda_83dc6366a20d9229952004eea2bdcbca_--operator().c)
 * Callees:
 ...
 *     ?GetBoolSetting@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG0_NPEA_N@Z @ 0x18006127C (-GetBoolSetting@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG0_NPEA_N@Z.c)
