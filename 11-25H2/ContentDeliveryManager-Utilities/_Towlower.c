/*
 * XREFs of _Towlower @ 0x180005C34
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x18005CDE0 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18005CE00 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD58 (_GetLocaleHandleByColl.c)
 *     __crtLCMapStringW_Stub @ 0x18000DE38 (__crtLCMapStringW_Stub.c)
 */
