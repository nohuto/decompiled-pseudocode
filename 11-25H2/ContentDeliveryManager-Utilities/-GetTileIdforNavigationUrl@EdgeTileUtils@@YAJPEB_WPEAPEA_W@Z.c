/*
 * XREFs of ?GetTileIdforNavigationUrl@EdgeTileUtils@@YAJPEB_WPEAPEA_W@Z @ 0x1800A4A44
 * Callers:
 ...
 *     ?TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z @ 0x1800A52DC (-TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z.c)
