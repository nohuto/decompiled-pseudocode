  ...
  do
  {
    if ( (unsigned __int64)a1[3] < 8 )
      ...
      wil::details::in1diag3::Throw_HrIfMsg(
        ...
        (int)"shellcommon\\shell\\contentdeliverymanager\\utils\\lib\\actionhelpers\\toasthelpers.cpp",
        (const char *)0x80070057LL,
        *(_WORD *)(*a1 + 2 * v12) == asc_180159A10[0],
        (__int64)"%ls",
        (const char *)*a1);
    if ( (unsigned __int64)a1[3] < 8 )
      v13 = a1;
      ...
      v13 = (__int64 *)*a1;
    if ( *((_WORD *)v13 + v12) == asc_180159A14[0] )
    {
      v14 = v12 + 1;
      ...
      for ( LOWORD(v20[0]) = 0; v14 < v16; ++v14 )
      {
        if ( (unsigned __int64)a1[3] < 8 )
          ...
          wil::details::in1diag3::Throw_HrIfMsg(
            ...
            (int)"shellcommon\\shell\\contentdeliverymanager\\utils\\lib\\actionhelpers\\toasthelpers.cpp",
            (const char *)0x80070057LL,
            *(_WORD *)(*a1 + 2 * v14) == asc_180159A14[0],
            (__int64)"%ls",
            (const char *)*a1);
        if ( (unsigned __int64)a1[3] < 8 )
          v17 = a1;
