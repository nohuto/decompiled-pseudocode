/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x180034074
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x18003C950 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 *     ?WilApiImpl_GetFeatureVariant@details@wil@@YAIIW4FEATURE_CHANGE_TIME@@PEAIPEAH2@Z @ 0x18003C9C0 (-WilApiImpl_GetFeatureVariant@details@wil@@YAIIW4FEATURE_CHANGE_TIME@@PEAIPEAH2@Z.c)
 * Callees:
 ...
 *     wil_QueryFeatureState @ 0x18003FF84 (wil_QueryFeatureState.c)
 */
  ...
  if ( !v18 && (v14 & 4) == 0 && wil::details::g_enabledStateManager )
  {
    ...
    if ( !v11
      ...
      || (v16[1] = 0,
          v16[0] = 0,
          v17 = v7,
          !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_1801783D8, v16, 0x10uLL)) )
    {
