/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YA?AUResultStatus@12@PEAG_KPEA_N@Z @ 0x180039E90
 * Callers:
 *     <none>
 * Callees:
...
int *__fastcall wil::details::ResultFromCaughtExceptionInternal(int *a1, _WORD *a2, __int64 a3, _BYTE *a4)
{
  ...
  exception *v22; // [rsp+40h] [rbp-48h] BYREF
  ...
  const struct exception *v28; // [rsp+98h] [rbp+10h]
  const struct wil::ResultException *v29; // [rsp+98h] [rbp+10h]
  const struct exception *v30; // [rsp+98h] [rbp+10h]
  const struct exception *v31; // [rsp+98h] [rbp+10h]
