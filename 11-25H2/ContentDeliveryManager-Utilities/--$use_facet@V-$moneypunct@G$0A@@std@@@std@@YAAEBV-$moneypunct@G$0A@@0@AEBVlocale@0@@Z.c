/*
 * XREFs of ??$use_facet@V?$moneypunct@G$0A@@std@@@std@@YAAEBV?$moneypunct@G$0A@@0@AEBVlocale@0@@Z @ 0x18000FDE0
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011B64 (-_Getcat@-$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::moneypunct<unsigned short,0>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::moneypunct<unsigned short,0>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::moneypunct<unsigned short,0>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::moneypunct<unsigned short,0>>::_Psave = (__int64)v12;
