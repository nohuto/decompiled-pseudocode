/*
 * XREFs of ??$ActivateInstance@V?$ComPtr@UIAppServiceConnection@AppService@ApplicationModel@Windows@@@WRL@Microsoft@@@Foundation@Windows@@YAJPEAUHSTRING__@@V?$ComPtrRef@V?$ComPtr@UIAppServiceConnection@AppService@ApplicationModel@Windows@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x180045800
 * Callers:
 ...
 *     ??$ActivateInstance@UIAppServiceConnection@AppService@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIAppServiceConnection@AppService@ApplicationModel@1@@Z @ 0x1800456C8 (--$ActivateInstance@UIAppServiceConnection@AppService@ApplicationModel@Windows@@@Foundation@Wind.c)
 */
