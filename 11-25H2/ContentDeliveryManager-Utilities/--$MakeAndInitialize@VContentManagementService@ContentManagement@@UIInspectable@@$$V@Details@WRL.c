/*
 * XREFs of ??$MakeAndInitialize@VContentManagementService@ContentManagement@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x180041AC0
 * Callers:
 *     ?ActivateInstance@?$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@UEAAJPEAPEAUIInspectable@@@Z @ 0x180042BA0 (-ActivateInstance@-$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WR.c)
 * Callees:
 ...
 *     ??0ContentManagementService@ContentManagement@@QEAA@XZ @ 0x180042110 (--0ContentManagementService@ContentManagement@@QEAA@XZ.c)
