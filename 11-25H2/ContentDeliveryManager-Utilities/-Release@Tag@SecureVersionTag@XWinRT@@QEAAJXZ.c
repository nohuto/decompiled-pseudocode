/*
 * XREFs of ?Release@Tag@SecureVersionTag@XWinRT@@QEAAJXZ @ 0x18008ADC4
 * Callers:
 *     ??1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ @ 0x18008ABF0 (--1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ.c)
