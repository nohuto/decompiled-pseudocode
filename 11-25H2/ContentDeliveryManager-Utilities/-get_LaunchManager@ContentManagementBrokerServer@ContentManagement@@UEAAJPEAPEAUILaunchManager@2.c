/*
 * XREFs of ?get_LaunchManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUILaunchManager@2@@Z @ 0x18003EA70
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@VLaunchManager@ContentManagement@@UILaunchManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUILaunchManager@ContentManagement@@@Z @ 0x180026594 (--$MakeAndInitialize@VLaunchManager@ContentManagement@@UILaunchManager@2@$$V@Details@WRL@Microso.c)
