/*
 * XREFs of ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x1800633B8
 * Callers:
 ...
 *     ?IgnoreCurrentThread@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x180052F18 (-IgnoreCurrentThread@-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryMan.c)
        ...
        int a3)
{
  ...
  if ( v7 >= 0 || v7 != v3[22] || (v8 = v3 + 20, v3 == (int *)-80LL) )
  {
    ...
    if ( *(_DWORD *)v15 > 5u && tlgKeywordOn((__int64)v15, 0x200000000000LL) )
    {
      ...
      v43 = 4LL;
      v41 = 8LL;
      tlgWriteTransfer_EventWriteTransfer(v16, byte_18015F20E, (const GUID *)(v18 + 8), 0LL, 9u, &v39);
    }
  }
  else
  {
