/*
 * XREFs of ??$use_facet@V?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAAEBV?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@AEBVlocale@0@@Z @ 0x18001C9B0
 * Callers:
 ...
 *     ?_Getcat@?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18001D288 (-_Getcat@-$time_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::time_put<char,std::ostreambuf_iterator<char>>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::time_put<char,std::ostreambuf_iterator<char>>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::time_put<char,std::ostreambuf_iterator<char>>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::time_put<char,std::ostreambuf_iterator<char>>>::_Psave = (__int64)v12;
