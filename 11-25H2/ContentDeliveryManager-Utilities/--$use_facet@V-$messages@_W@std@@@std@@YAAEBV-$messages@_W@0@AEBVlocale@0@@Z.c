/*
 * XREFs of ??$use_facet@V?$messages@_W@std@@@std@@YAAEBV?$messages@_W@0@AEBVlocale@0@@Z @ 0x18000F618
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::messages<wchar_t>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::messages<wchar_t>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    else
    {
      ...
      v6 = v12;
      std::_Facetptr<std::messages<wchar_t>>::_Psave = (__int64)v12;
