/*
 * XREFs of ??$make_shared@VCreativeRule@RuleSetHandlers@CreativeFramework@@PEB_WPEB_W@std@@YA?AV?$shared_ptr@VCreativeRule@RuleSetHandlers@CreativeFramework@@@0@$$QEAPEB_W0@Z @ 0x180079F30
 * Callers:
