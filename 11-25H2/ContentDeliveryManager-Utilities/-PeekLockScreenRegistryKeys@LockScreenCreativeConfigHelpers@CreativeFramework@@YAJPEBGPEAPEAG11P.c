/*
 * XREFs of ?PeekLockScreenRegistryKeys@LockScreenCreativeConfigHelpers@CreativeFramework@@YAJPEBGPEAPEAG11PEA_N@Z @ 0x180054604
 * Callers:
 *     ?PeekLockScreenRegistryKeys@ContentManagementService@ContentManagement@@UEAAJPEAPEAUHSTRING__@@00PEAE@Z @ 0x180054460 (-PeekLockScreenRegistryKeys@ContentManagementService@ContentManagement@@UEAAJPEAPEAUHSTRING__@@0.c)
 * Callees:
 ...
 *     ?GetLockScreenRegistryKeyRoot@LockScreenCreativeConfigHelpers@CreativeFramework@@YAJPEBGPEAPEAUHKEY__@@@Z @ 0x180052424 (-GetLockScreenRegistryKeyRoot@LockScreenCreativeConfigHelpers@CreativeFramework@@YAJPEBGPEAPEAUH.c)
        ...
        unsigned __int16 **a5)
{
  ...
  DWORD v36; // [rsp+88h] [rbp-78h] BYREF
  DWORD v37; // [rsp+8Ch] [rbp-74h] BYREF
  DWORD v38[2]; // [rsp+90h] [rbp-70h] BYREF
  HKEY hKey; // [rsp+98h] [rbp-68h] BYREF
  unsigned __int16 pvData[264]; // [rsp+A0h] [rbp-60h] BYREF
  unsigned __int16 v41[264]; // [rsp+2B0h] [rbp+1B0h] BYREF
  unsigned __int16 v42[264]; // [rsp+4C0h] [rbp+3C0h] BYREF
  WCHAR Name[256]; // [rsp+6D0h] [rbp+5D0h] BYREF
  ...
  *(_QWORD *)v38 = a4;
  ...
  cSubKeys = 0;
  v8 = hKey;
  v9 = RegQueryInfoKeyW(hKey, 0LL, 0LL, 0LL, &cSubKeys, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL, 0LL);
  if ( !v9 )
  {
    v11 = 0LL;
...
LABEL_24:
    ...
    if ( v5 )
    {
      ...
      v14 = _AllocStringWorker<CTCoAllocPolicy>(0x80000000LL, v20, v41, v21, (__int64)lpcSubKeysb, v5);
      v5 = 0LL;
      if ( v14 < 0 )
      {
        v15 = 474LL;
    ...
    if ( *(_QWORD *)v38 )
    {
      ...
      v14 = _AllocStringWorker<CTCoAllocPolicy>(0x80000000LL, v24, v42, v16, (__int64)lpcSubKeysc, v22);
      if ( v14 < 0 )
      {
        v15 = 482LL;
        goto LABEL_24;
    ...
    if ( a5 )
    {
      v32 = (int)v5;
      v38[0] = 4;
      v25 = RegGetValueW(v8, lpSubKey[0], L"showImageOnSecureLock", 0x20000010u, (LPDWORD)v5, &v32, v38);
