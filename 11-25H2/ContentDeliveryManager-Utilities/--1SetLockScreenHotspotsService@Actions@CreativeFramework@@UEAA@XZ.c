/*
 * XREFs of ??1SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800A1310
 * Callers:
 *     ??_GSetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800A1370 (--_GSetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
