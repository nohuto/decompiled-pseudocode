/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x180091460
 * Callers:
 ...
 * Callees:
 *     _Init_thread_footer @ 0x180023D9C (_Init_thread_footer.c)
 *     _Init_thread_header @ 0x180023E0C (_Init_thread_header.c)
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800754A8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_N.c)
        ...
        char a6)
{
  ...
  _BYTE v36[7]; // [rsp+41h] [rbp-137h] BYREF
  ...
  if ( a6 )
    goto LABEL_7;
  if ( dword_1801795B8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801795B8);
    if ( dword_1801795B8 == -1 )
    {
      byte_1801795BC = CreativeFramework::Actions::IsMsaConnected(v9);
      Init_thread_footer(&dword_1801795B8);
    }
  }
  if ( !byte_1801795BC )
LABEL_7:
