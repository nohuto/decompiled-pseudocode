/*
 * XREFs of ??1?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_ValueSet@@3QBGB@Triggers@CreativeFramework@@QEAA@XZ @ 0x18004BF5C
 * Callers:
 *     ??1ValueSetHelper@Triggers@CreativeFramework@@QEAA@XZ @ 0x18004C72C (--1ValueSetHelper@Triggers@CreativeFramework@@QEAA@XZ.c)
 ...
 *     ?_Destroy@?$_Ref_count_obj@VPropertySetHelper@Triggers@CreativeFramework@@@std@@EEAAXXZ @ 0x1800B6990 (-_Destroy@-$_Ref_count_obj@VPropertySetHelper@Triggers@CreativeFramework@@@std@@EEAAXXZ.c)
 * Callees:
