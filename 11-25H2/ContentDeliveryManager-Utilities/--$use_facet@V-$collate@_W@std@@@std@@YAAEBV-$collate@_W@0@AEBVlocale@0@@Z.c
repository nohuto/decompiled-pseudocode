/*
 * XREFs of ??$use_facet@V?$collate@_W@std@@@std@@YAAEBV?$collate@_W@0@AEBVlocale@0@@Z @ 0x18000F380
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::collate<wchar_t>>(__int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::collate<wchar_t>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::collate<wchar_t>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::collate<wchar_t>>::_Psave = (__int64)v12;
