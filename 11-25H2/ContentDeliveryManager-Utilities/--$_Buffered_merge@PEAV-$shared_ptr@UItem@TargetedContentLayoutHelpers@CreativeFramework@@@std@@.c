 ...
 *     ??Rless_than_rank@TargetedContentLayoutHelpers@CreativeFramework@@QEAA_NAEBV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@0@Z @ 0x1800B1F10 (--Rless_than_rank@TargetedContentLayoutHelpers@CreativeFramework@@QEAA_NAEBV-$shared_ptr@UItem@T.c)
...
__int64 __fastcall std::_Buffered_merge<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,__int64,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>,CreativeFramework::TargetedContentLayoutHelpers::less_than_rank>(
        char *a1,
        char *a2,
        __int64 a3,
        __int64 a4,
        ...
        char a7)
{
  ...
  while ( a4 + v9 != 2 )
  {
    ...
    if ( v9 <= std::_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>::_Maxlen(a6) )
    {
      *(_QWORD *)(*(_QWORD *)(a6 + 32) + 8LL) = **(_QWORD **)(a6 + 32);
      ...
      std::_Move<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,std::_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>>(
        ...
        &v34);
      std::_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>::~_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>(v37);
      return std::_Merge_backward<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,CreativeFramework::TargetedContentLayoutHelpers::less_than_rank>(
               (_DWORD)v11,
               (_DWORD)a2,
               **(_QWORD **)(a6 + 32),
               *(_QWORD *)(*(_QWORD *)(a6 + 32) + 8LL),
    ...
    if ( v9 >= a4 )
    {
      ...
      while ( v24 > 0 )
      {
        if ( (unsigned __int8)CreativeFramework::TargetedContentLayoutHelpers::less_than_rank::operator()(
                                v12,
                                v14,
  ...
  result = CreativeFramework::TargetedContentLayoutHelpers::less_than_rank::operator()(a1, a2, v11);
  if ( (_BYTE)result )
  {
    v31 = *((_QWORD *)v11 + 1);
