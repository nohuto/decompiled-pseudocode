/*
 * XREFs of ?RegisterWnfTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x180081480
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  try
  {
    ...
    v11 = v27;
    v12 = (int)v29;
    Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)&off_1800D2A38, v13)[1].Reserved.Reserved1;
    v16 = (const WCHAR *)v33;
    if ( v33[3] >= 8uLL )
