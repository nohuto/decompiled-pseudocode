/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800AD850
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( (a2[1] & 2) == 0 )
  {
    ...
    {
      v9 = CreativeFramework::Logging::ShellPlacementLogging::Provider(v4);
