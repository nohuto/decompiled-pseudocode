/*
 * XREFs of __GSHandlerCheck_SEH @ 0x14001EF10
 * Callers:
 *     <none>
 * Callees:
 *     __C_specific_handler_0 @ 0x14000EF64 (__C_specific_handler_0.c)
 *     __GSHandlerCheckCommon @ 0x14001EEAC (__GSHandlerCheckCommon.c)
 */
