/*
 * XREFs of SmpSendPlatformBinaryStatus @ 0x1400182B0
 * Callers:
...
char __fastcall SmpSendPlatformBinaryStatus(int a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      v17 = (unsigned __int8 *)&unk_14002BFFF;
      LODWORD(v20) = v34;
      v26 = &v20;
...
LABEL_20:
  ...
  else if ( (unsigned int)dword_140030E48 > 5 )
  {
    v17 = (unsigned __int8 *)&unk_14002BFCE;
    LODWORD(v20) = v34;
    v26 = &v20;
    v28 = ObjectAttributes;
    ShareAccess = 4;
