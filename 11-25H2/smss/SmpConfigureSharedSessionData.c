...
__int64 SmpConfigureSharedSessionData()
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  v85 = 0LL;
  v86 = 0;
  qword_140032378 = (__int64)&qword_140032370;
  qword_140032370 = (__int64)&qword_140032370;
  qword_140032388 = (__int64)&BaseAddress;
  BaseAddress = &BaseAddress;
  qword_140032398 = (__int64)&qword_140032390;
  qword_140032390 = &qword_140032390;
  result = RtlQueryRegistryValuesEx(2LL, L"Session Manager", &v53, 0LL, 0LL);
  if ( (int)result < 0 )
    return result;
  v1 = (__int64 *)qword_140032370;
  while ( v1 != &qword_140032370 )
  {
    v2 = v1;
    v1 = (__int64 *)*v1;
    SmpFreeSavedRegistryEntry(v2);
  }
  if ( qword_140032390 == &qword_140032390 )
  {
    v3 = 16LL * (unsigned int)dword_140032368 + 104;
    SmpInitExecuteCmd = 0LL;
  }
  else
  {
    v7 = qword_140032398;
    v8 = *(_QWORD **)(qword_140032398 + 8);
    if ( *(PVOID **)qword_140032398 != &qword_140032390 || *v8 != qword_140032398 )
      goto LABEL_43;
    qword_140032398 = *(_QWORD *)(qword_140032398 + 8);
    *v8 = &qword_140032390;
    v3 = 16LL * (unsigned int)dword_140032368 + 104;
...
LABEL_7:
  ...
  MaximumSize.QuadPart = v3 + (unsigned int)dword_14003236C + v4 + SmpS0InitCmd.Length + SmpDefaultLibPath.Length + 6LL;
