/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x14000F56C
 * Callers:
...
LABEL_21:
    v20 = v18;
    memcpy_0(Base, dword_140032C54, 4LL * v18);
    goto LABEL_22;
  }
  v20 = 0LL;
LABEL_22:
  qsort(Base, v20, 4uLL, (int (__cdecl *)(const void *, const void *))SmpPagefileUsageSampleCompare);
  v21 = (unsigned int)dword_140032B28 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v21 + (v21 >> 4);
}
