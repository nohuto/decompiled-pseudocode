...
LABEL_45:
      ...
      if ( *(__int64 **)(v36 + 8) != &v36
        || (__int64 *)*v37 != &v36
        || (*v37 = v36, v28[1] = v29, v30 = qword_140032A98, *(__int64 **)(SmpKnownDllsList + 8) != &SmpKnownDllsList)
        || *(__int64 **)qword_140032A98 != &SmpKnownDllsList
        || *(_QWORD **)(*v28 + 8LL) != v28
        || (_QWORD *)*v29 != v28 )
      {
        __fastfail(3u);
      }
      *(_QWORD *)qword_140032A98 = v28;
      qword_140032A98 = v28[1];
