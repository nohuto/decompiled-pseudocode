/*
 * XREFs of RtlStringCchCopyExW @ 0x14001ECEC
 * Callers:
 *     NtPnpGetDeviceInterfaceList @ 0x14001E40C (NtPnpGetDeviceInterfaceList.c)
 * Callees:
 *     RtlStringCopyWorkerW_0 @ 0x14001EDAC (RtlStringCopyWorkerW_0.c)
 */
