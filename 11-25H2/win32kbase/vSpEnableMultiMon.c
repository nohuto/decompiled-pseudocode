/*
 * XREFs of vSpEnableMultiMon @ 0x14019F8B8
 * Callers:
...
__int64 (__fastcall *__fastcall vSpEnableMultiMon(__int64 a1, __int64 a2, __int64 a3))(__int64, _QWORD, __int64)
{
  unsigned int v4; // edi
  __int64 (__fastcall *result)(__int64, _QWORD, __int64); // rax

  v4 = a2;
  result = *(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 24)
                                                              + 16LL);
  if ( result )
