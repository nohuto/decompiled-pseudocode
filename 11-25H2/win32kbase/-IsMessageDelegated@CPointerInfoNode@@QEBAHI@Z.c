/*
 * XREFs of ?IsMessageDelegated@CPointerInfoNode@@QEBAHI@Z @ 0x140204E94
 * Callers:
 ...
 *     ?IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z @ 0x1400FEF5C (-IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z.c)
