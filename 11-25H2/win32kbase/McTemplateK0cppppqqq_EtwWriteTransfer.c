/*
 * XREFs of McTemplateK0cppppqqq_EtwWriteTransfer @ 0x14003E3B8
 * Callers:
        ...
        char a11)
{
  ...
  _BYTE v15[16]; // [rsp+50h] [rbp-81h] BYREF
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 9LL, v15);
}
