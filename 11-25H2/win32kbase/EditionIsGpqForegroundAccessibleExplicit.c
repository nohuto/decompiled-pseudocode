/*
 * XREFs of EditionIsGpqForegroundAccessibleExplicit @ 0x1401137A4
 * Callers:
        ...
        unsigned int a4))(_QWORD, __int64, __int64 *, _QWORD)
{
  ...
  v7 = a1;
  result = *(__int64 (__fastcall **)(_QWORD, __int64, __int64 *, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(
                                                                                        a1,
                                                                                        a2)
                                                                                    + 48)
                                                                        + 5136LL);
