/*
 * XREFs of ?RegisterInputDispatcherObjects@IOCPDispatcher@@UEAAJPEAXIPEAUInputDispatcherObject@@@Z @ 0x140138FD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputDispatcherObject *a4)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      v9 = 5LL * v12;
      *((_QWORD *)this + v9 + 3) = IOCPDispatcher::SetupIOCPForDispatcherHandle(
                                     (__int64)this,
                                     0LL,
                                     *v8,
                                     0x80000000,
