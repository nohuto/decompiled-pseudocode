/*
 * XREFs of ??$GreReleaseSemaphoreExclusive@$0BE@$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x140045680
 * Callers:
 *     ?GreReleaseHmgrSemaphore@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x1401C64E0 (-GreReleaseHmgrSemaphore@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z.c)
 * Callees:
