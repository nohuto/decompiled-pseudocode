/*
 * XREFs of McTemplateK0qqxx_EtwWriteTransfer @ 0x1400F2ED8
 * Callers:
 *     EtwGdiSysMemToken @ 0x1400F2E60 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1400F2EA0 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
