/*
 * XREFs of ?SetBufferProperty@CInteractionTrackerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x140128600
 * Callers:
 *     <none>
 * Callees:
      ...
      *((_QWORD *)this + 44) = v13;
      if ( v13 )
      {
        for ( i = 0LL; (unsigned int)i < (unsigned int)v12; i = (unsigned int)(i + 1) )
        {
          ...
          if ( !v19 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v19 + 9), 104) )
          {
            v6 = -1073741811;
            goto LABEL_8;
          }
          *(_QWORD *)(*((_QWORD *)this + 44) + 16LL * (unsigned int)i) = v20;
          ...
          if ( v22 )
          {
            ...
            if ( !v23 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v23 + 9), 88) )
            {
              v6 = -1073741811;
