/*
 * XREFs of McTemplateK0qqqqqp_EtwWriteTransfer @ 0x140115108
 * Callers:
 *     EtwTraceAuditApiSetWinEventHook @ 0x1401150C0 (EtwTraceAuditApiSetWinEventHook.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14003E650 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140242EA0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qqqqqp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &AuditApiSetWinEventHook, &W32kControlGuid, 7u, &v10);
}
