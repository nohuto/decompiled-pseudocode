/*
 * XREFs of ?UserCheckForMessageAccessWithWindowCapability@@YAHPEAUtagWND@@I@Z @ 0x140117110
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall UserCheckForMessageAccessWithWindowCapability(struct tagWND *a1, __int64 a2)
{
  unsigned int v2; // ebx
  int v3; // esi
  __int64 v4; // rdi
  ...
  if ( a1 )
    v4 = *(_QWORD *)a1;
  v5 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19832);
