/*
 * XREFs of ?CaptureContact@VirtualTouchpad@InputTraceLogging@@SAXAEBTPOINTERINFOUNION@@UVPTP_ID@@AEBUtagVIRTUAL_PTP_CONFIG@@@Z @ 0x1401A0A18
 * Callers:
...
__int64 __fastcall InputTraceLogging::VirtualTouchpad::CaptureContact(__int64 a1, int a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_14029EE20 > 4 && (qword_14029EE30 & 0x20) != 0 )
  {
    result = qword_14029EE38 & 0x20;
    if ( result == qword_14029EE38 )
    {
      v43 = a3[20];
      v5 = a3[19];
      v6 = a3[18];
