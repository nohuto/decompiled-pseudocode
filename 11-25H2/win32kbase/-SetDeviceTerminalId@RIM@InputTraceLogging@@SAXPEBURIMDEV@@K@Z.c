/*
 * XREFs of ?SetDeviceTerminalId@RIM@InputTraceLogging@@SAXPEBURIMDEV@@K@Z @ 0x1401F65C4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::SetDeviceTerminalId(const struct RIMDEV *a1)
{
  __int64 v1; // r8
  __int64 v2; // r9
