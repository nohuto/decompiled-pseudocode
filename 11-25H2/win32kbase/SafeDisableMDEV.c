/*
 * XREFs of SafeDisableMDEV @ 0x140075040
 * Callers:
...
__int64 __fastcall SafeDisableMDEV(__int64 a1, __int64 a2)
{
  unsigned int v2; // ebx
  __int64 v3; // rdx
  __int64 v4; // rcx
  ...
  if ( !(unsigned int)DrvDisableMDEV(*(HDEV **)(*(_QWORD *)(UserSessionState + 56968) + 16LL), 1, v2) )
    return 0LL;
  _InterlockedExchange((volatile __int32 *)(W32GetUserSessionState(v7, v6) + 43276), 1);
  return 1LL;
}
