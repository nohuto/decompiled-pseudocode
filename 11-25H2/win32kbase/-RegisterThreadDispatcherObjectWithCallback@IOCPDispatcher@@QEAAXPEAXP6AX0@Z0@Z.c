/*
 * XREFs of ?RegisterThreadDispatcherObjectWithCallback@IOCPDispatcher@@QEAAXPEAXP6AX0@Z0@Z @ 0x14014F700
 * Callers:
 *     AddThreadWakeEventDispatcherToIOCP @ 0x14014F6B0 (AddThreadWakeEventDispatcherToIOCP.c)
