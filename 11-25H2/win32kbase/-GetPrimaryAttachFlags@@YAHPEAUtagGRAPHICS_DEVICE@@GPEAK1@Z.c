/*
 * XREFs of ?GetPrimaryAttachFlags@@YAHPEAUtagGRAPHICS_DEVICE@@GPEAK1@Z @ 0x140118CB0
 * Callers:
...
__int64 __fastcall GetPrimaryAttachFlags(struct tagGRAPHICS_DEVICE *a1, __int16 a2, unsigned int *a3, unsigned int *a4)
{
  ...
  *a4 = 0;
  v24 = v17;
  WdLogGlobalForLineNumber = 21474;
  *a3 = 0;
  ...
  else
  {
    ...
    if ( v14 )
    {
      ...
      if ( v16 < 0 )
      {
        ...
        *a4 = 0;
        *a3 = 0;
        WdLogGlobalForLineNumber = 21537;
      }
    }
    else
    {
      WdLogSingleEntry0(5LL);
      WdLogGlobalForLineNumber = 21543;
    }
  }
  v11 = *((_DWORD *)a1 + 40);
  if ( a2 )
