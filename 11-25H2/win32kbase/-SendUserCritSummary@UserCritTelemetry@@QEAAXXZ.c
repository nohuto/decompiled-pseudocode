/*
 * XREFs of ?SendUserCritSummary@UserCritTelemetry@@QEAAXXZ @ 0x14003D160
 * Callers:
...
void __fastcall UserCritTelemetry::SendUserCritSummary(LARGE_INTEGER *this)
{
  ...
  if ( (unsigned __int64)(1000000 * (PerformanceCounter.QuadPart - this[605].QuadPart)) / gliQpcFreq.QuadPart > 0xF4240 )
  {
    ...
    if ( (unsigned int)dword_14029EF38 > 5
      && (qword_14029EF48 & 0x10000000) != 0
      && (qword_14029EF50 & 0x10000000) == qword_14029EF50 )
    {
      v3 = this[603];
      v4 = this[597];
      v5 = this[600];
      ...
      *(_DWORD *)&v29.Id = 184549376;
      ...
      v38 = 259;
      v39 = 1;
      EtwWriteTransfer(RegHandle, &v29, 0LL, 0LL, 0xEu, &UserData);
    }
