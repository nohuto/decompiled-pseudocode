/*
 * XREFs of ?DrvSortGraphicsDeviceList@@YAXXZ @ 0x1401413F4
 * Callers:
 *     DrvUpdateGraphicsDeviceList @ 0x14006ADB0 (DrvUpdateGraphicsDeviceList.c)
 * Callees:
 *     ?DrvMoveGraphicsDevice@@YAXPEAUtagGRAPHICS_DEVICE@@00@Z @ 0x1401414EC (-DrvMoveGraphicsDevice@@YAXPEAUtagGRAPHICS_DEVICE@@00@Z.c)
 */
...
void __fastcall DrvSortGraphicsDeviceList(__int64 a1)
{
  ...
  v2 = 0LL;
  v3 = 0LL;
  v4 = *(struct tagGRAPHICS_DEVICE **)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 1096LL);
  if ( v4 )
  {
    do
    {
