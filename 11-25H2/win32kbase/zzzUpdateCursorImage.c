/*
 * XREFs of zzzUpdateCursorImage @ 0x14012D0F4
 * Callers:
...
__int64 (*__fastcall zzzUpdateCursorImage(__int64 a1, __int64 a2))(void)
{
  __int64 (*result)(void); // rax

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 3896LL);
  if ( result )
