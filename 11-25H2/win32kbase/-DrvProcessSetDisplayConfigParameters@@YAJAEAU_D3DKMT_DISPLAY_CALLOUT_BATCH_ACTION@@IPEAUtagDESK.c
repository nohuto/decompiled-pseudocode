/*
 * XREFs of ?DrvProcessSetDisplayConfigParameters@@YAJAEAU_D3DKMT_DISPLAY_CALLOUT_BATCH_ACTION@@IPEAUtagDESKTOP@@PEAEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1400F7B3C
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  if ( (v10 & 0xF) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 16869;
    return 3221225485LL;
  }
  if ( !v7 )
  {
    WdLogSingleEntry3(1LL, v9, v10, a3);
    WdLogGlobalForLineNumber = 16899;
    return 3221225485LL;
  }
  v25 = 0;
  v13 = (v10 & 0x20F) != 0 ? 4 : 2;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v15 )
    {
      v8 = (struct DISPLAYCONFIG_PATH_INFO_INTERNAL *)PALLOCMEM(216 * v15, 1936876615LL);
      if ( !v8 )
        return 3221225495LL;
      v15 = v25;
      v14 = v26;
