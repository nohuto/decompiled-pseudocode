/*
 * XREFs of ?AllocUninitialized@BufferCache@CoreMessagingK@@CAJGPEAPEAX@Z @ 0x140067B68
 * Callers:
 ...
 * Callees:
 *     ?AllocUninitialized@Runtime@CoreMessagingK@@CAJ_KW4PoolTag@2@PEAPEAX@Z @ 0x140240A80 (-AllocUninitialized@Runtime@CoreMessagingK@@CAJ_KW4PoolTag@2@PEAPEAX@Z.c)
 */
...
LABEL_13:
    if ( (unsigned int)(v3 + 512) >= 0xFFFF )
      ...
      v13 = v3 + 512;
    v15 = 0LL;
    v14 = CoreMessagingK::Runtime::AllocUninitialized(v13 + 16LL, 1128418627LL, &v15);
    if ( v14 < 0 )
