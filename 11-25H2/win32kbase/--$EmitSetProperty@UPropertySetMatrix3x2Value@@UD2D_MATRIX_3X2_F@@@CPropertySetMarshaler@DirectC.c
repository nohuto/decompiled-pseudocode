/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix3x2Value@@UD2D_MATRIX_3X2_F@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x140027620
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v13 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x34uLL, &v13);
  v8 = (char *)v13;
  *(_DWORD *)v13 = 52;
  *(_OWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 20) = 0LL;
