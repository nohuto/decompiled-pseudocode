/*
 * XREFs of EngCopyBits @ 0x14011FCB0
 * Callers:
 *     <none>
 * Callees:
        ...
        POINTL *pptlSrc)
{
  ...
  v10 = *(__int64 (__fastcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(psoDest, psoSrc) + 24)
                                                                                                 + 632LL);
  if ( v10 )
