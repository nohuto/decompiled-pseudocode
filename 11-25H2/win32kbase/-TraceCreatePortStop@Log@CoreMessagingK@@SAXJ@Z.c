/*
 * XREFs of ?TraceCreatePortStop@Log@CoreMessagingK@@SAXJ@Z @ 0x1400FCBEC
 * Callers:
...
void __fastcall CoreMessagingK::Log::TraceCreatePortStop(int a1, __int64 a2, __int64 a3, __int64 a4)
{
