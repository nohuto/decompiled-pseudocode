/*
 * XREFs of ?CreateSurfacePal@@YAHVXEPALOBJ@@KKK@Z @ 0x1400C67F4
 * Callers:
 ...
 *     ?ulTime@XEPALOBJ@@QEAAKXZ @ 0x1400DA9A0 (-ulTime@XEPALOBJ@@QEAAKXZ.c)
...
__int64 __fastcall CreateSurfacePal(__int64 a1, int a2, unsigned int a3, unsigned int a4)
{
  ...
  struct OBJECT *v23; // [rsp+50h] [rbp-28h] BYREF
  ...
  v24 = 0;
  v23 = 0LL;
  v10 = PALMEMOBJ::bCreatePalette(&v23, v4 & 0x1F, v8, v6, 0, 0, 0, 0x800u);
  if ( v10 )
  {
    v11 = a3 >> 1;
    ...
    else
    {
      ...
      *((_DWORD *)v12 + 8) = v20;
      v21 = (struct OBJECT *)*((_QWORD *)v12 + 15);
      if ( v21 != v12 )
        *((_DWORD *)v21 + 8) = v20;
      v23 = 0LL;
      v24 = 1;
