/*
 * XREFs of ApiSetEditionOverrideUserTouchGestureSettings @ 0x1401961CC
 * Callers:
...
__int64 (*__fastcall ApiSetEditionOverrideUserTouchGestureSettings(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7368LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 7376LL);
      if ( result )
