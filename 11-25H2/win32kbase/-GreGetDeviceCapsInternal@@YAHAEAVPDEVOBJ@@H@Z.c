/*
 * XREFs of ?GreGetDeviceCapsInternal@@YAHAEAVPDEVOBJ@@H@Z @ 0x1400431E4
 * Callers:
...
__int64 __fastcall GreGetDeviceCapsInternal(struct PDEVOBJ *a1, int a2)
{
  ...
  if ( a2 != 90 )
  {
    if ( a2 > 90 )
    {
      ...
      {
        case '^':
          v18 = **(struct _ERESOURCE ***)(W32GetSessionState(a1) + 88);
          ...
          if ( v18 )
            GreReleaseSemaphoreCommon<19,void (*)(HSEMAPHORE__ *)>(GreReleaseSemaphoreSharedInternal, v18);
          return v5;
        case 'h':
