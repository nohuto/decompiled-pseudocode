/*
 * XREFs of ?PopulateContact@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4tagHPD_TYPE@@GAEBUtagPOINT@@PEBUtagPOINTEREVENTINT@@W4ContactPopulationSource@12@@Z @ 0x1400770F8
 * Callers:
 ...
 *     ?ContactPopulationSourceToString@InputTraceLogging@@CAPEBDW4ContactPopulationSource@RIM@1@@Z @ 0x140078ED8 (-ContactPopulationSourceToString@InputTraceLogging@@CAPEBDW4ContactPopulationSource@RIM@1@@Z.c)
...
NTSTATUS __fastcall InputTraceLogging::RIM::PopulateContact(
        _QWORD *a1,
        unsigned int a2,
        __int64 a3,
        unsigned int *a4,
        ...
        unsigned int a6)
{
      ...
      if ( (unsigned int)dword_14029EE20 > 4 && (qword_14029EE30 & 0x100) != 0 )
      {
        ...
        if ( (qword_14029EE38 & 0x100) == qword_14029EE38 )
        {
          ...
          *(_DWORD *)&EventDescriptor.Id = 184549376;
          ...
          return EtwWriteTransfer(qword_14029EE40, &EventDescriptor, 0LL, 0LL, 0x29u, &UserData);
        }
      }
    }
    else if ( (unsigned int)dword_14029EE20 > 4 )
    {
      result = tlgKeywordOn(&dword_14029EE20, 256LL, a3);
      if ( (_BYTE)result )
      {
  ...
  else if ( (unsigned int)dword_14029EE20 > 4 && (qword_14029EE30 & 0x100) != 0 )
  {
    result = qword_14029EE38 & 0x100;
    if ( (qword_14029EE38 & 0x100) == qword_14029EE38 )
    {
