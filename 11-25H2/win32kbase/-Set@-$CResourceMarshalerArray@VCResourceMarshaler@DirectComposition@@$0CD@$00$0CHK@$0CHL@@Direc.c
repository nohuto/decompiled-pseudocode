/*
 * XREFs of ?Set@?$CResourceMarshalerArray@VCResourceMarshaler@DirectComposition@@$0CD@$00$0CHK@$0CHL@@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAPEAVCResourceMarshaler@2@_K@Z @ 0x14022DA18
 * Callers:
...
__int64 __fastcall DirectComposition::CResourceMarshalerArray<DirectComposition::CResourceMarshaler,35,1,634,635>::Set(
        DirectComposition::CResourceMarshalerArrayBase *a1,
        struct DirectComposition::CApplicationChannel *a2,
        __int64 a3,
        unsigned __int64 a4)
{
  return DirectComposition::CResourceMarshalerArrayBase::Set(a1, a2, a3, a4, 35);
}
