/*
 * XREFs of ?SetResourceReferenceArrayProperty@CApplicationChannel@DirectComposition@@QEAAJIIPEBI_K@Z @ 0x1400219B8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  v11 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, char *, unsigned __int64, _BYTE *))(*(_QWORD *)v10 + 288LL))(
          v10,
          this,
          a3,
          v7,
...
LABEL_8:
  ...
  if ( v19[0] )
  {
    ...
    if ( (v13 & 2) == 0 )
    {
      ...
      {
        v14 = *((_DWORD *)v10 + 9);
        for ( i = v14; (unsigned int)i < 0xC0; LODWORD(i) = dword_140274520[i] )
        {
          if ( (_DWORD)i == 157 )
          {
            v16 = 456LL;
