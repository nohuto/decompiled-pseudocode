/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1400CE878
 * Callers:
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1400CE830 (DrvPixelSpaceToUniformSpacePoint.c)
 * Callees:
