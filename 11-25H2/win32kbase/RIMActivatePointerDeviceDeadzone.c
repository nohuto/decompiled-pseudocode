/*
 * XREFs of RIMActivatePointerDeviceDeadzone @ 0x1401DD520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RIMActivatePointerDeviceDeadzone(__int64 a1, __int64 a2, int a3)
{
  unsigned int v4; // ebp
  bool v6; // bl
  bool v7; // si
  ...
  else if ( v4 < 5 && (v11 = *(RIMDeadzone **)(a1 + 8LL * v4 + 392)) != 0LL )
  {
    v12 = RIMDeadzone::Activate(v11, a3);
    RIMDeadzone::ActivateTelemetrySession(*(RIMDeadzone **)(a1 + 8LL * v4 + 392), a3);
  }
  else
  {
    v12 = -1073741811;
