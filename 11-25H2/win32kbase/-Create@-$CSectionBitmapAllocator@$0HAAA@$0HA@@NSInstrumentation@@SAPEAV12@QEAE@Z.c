/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x14011C2A4
 * Callers:
...
void *__fastcall NSInstrumentation::CSectionBitmapAllocator<28672,112>::Create(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
