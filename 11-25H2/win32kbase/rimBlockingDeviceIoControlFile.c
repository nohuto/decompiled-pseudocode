/*
 * XREFs of rimBlockingDeviceIoControlFile @ 0x14014979C
 * Callers:
...
__int64 __fastcall rimBlockingDeviceIoControlFile(HANDLE FileHandle, __int64 a2, __int64 a3, __int64 a4, PVOID a5)
{
  ...
  if ( Status < 0 )
  {
    ...
    {
      OutputBuffer = Status;
      v12 = *(_QWORD *)(W32GetUserSessionState(v6, WPP_GLOBAL_Control) + 19336);
      v15 = 24;
LABEL_30:
      LOBYTE(v11) = v9;
      LOBYTE(v10) = v8;
...
LABEL_21:
    if ( Status < 0 )
    {
      ...
      {
        OutputBuffer = Status;
        v12 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v13) + 19336);
        v15 = 26;
        goto LABEL_30;
      }
    }
