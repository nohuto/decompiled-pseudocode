/*
 * XREFs of ?CompleteAddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIIVResourceHandle@@HI0@Z @ 0x140054914
 * Callers:
...
LABEL_3:
  ...
  v18 = (DirectComposition::CVisualMarshaler *)DirectComposition::Memory::AllocateAndClear_0(0x178uLL, 1886929732LL, 1);
  v19 = v18;
  if ( !v18 )
  {
    v16 = -1073741801;
...
LABEL_12:
    v20 = *(_QWORD *)v15;
    LOBYTE(v25) = 0;
    v16 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, struct DirectComposition::CResourceMarshaler *, _QWORD, __int64, __int64 *))(v20 + 320))(
            v15,
            a1,
            v12,
            a6,
