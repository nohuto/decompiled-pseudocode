/*
 * XREFs of ?BuildMainItem@@YAHPEAEKPEAKUtagUSAGE_PROPERTIES@@PEAU1@W4_HIDP_REPORT_TYPE@@PEAH1@Z @ 0x1401EB11C
 * Callers:
 ...
 * Callees:
 *     ?BuildVendorDefinedCL@@YAHPEAEKPEAK@Z @ 0x1401EBB44 (-BuildVendorDefinedCL@@YAHPEAEKPEAK@Z.c)
 *     ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x1401EBC14 (-OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z.c)
 *     ?SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z @ 0x1401EBCA8 (-SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z.c)
 */
