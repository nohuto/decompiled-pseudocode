/*
 * XREFs of ?SetTimer@CAccessibilityTimer@@SA?AW4_ACCESSIBILITY_TIMERS@@KP6AXPEAUtagWND@@I_K_J@ZH@Z @ 0x140211B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAccessibilityTimer::SetTimer(int a1, void (__fastcall *a2)(struct tagWND *a1, __int64 a2), int a3)
{
