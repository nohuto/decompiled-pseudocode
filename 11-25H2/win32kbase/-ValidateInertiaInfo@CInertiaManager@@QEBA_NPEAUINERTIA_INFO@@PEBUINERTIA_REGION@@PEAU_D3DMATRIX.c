/*
 * XREFs of ?ValidateInertiaInfo@CInertiaManager@@QEBA_NPEAUINERTIA_INFO@@PEBUINERTIA_REGION@@PEAU_D3DMATRIX@@PEAN@Z @ 0x140120D80
 * Callers:
 ...
 *     ?FloatingPointExceptionFilter@@YAKJ@Z @ 0x140212358 (-FloatingPointExceptionFilter@@YAKJ@Z.c)
 *     sqrt_0 @ 0x140242E46 (sqrt_0.c)
