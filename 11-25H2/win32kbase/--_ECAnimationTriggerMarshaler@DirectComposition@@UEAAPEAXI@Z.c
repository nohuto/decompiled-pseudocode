/*
 * XREFs of ??_ECAnimationTriggerMarshaler@DirectComposition@@UEAAPEAXI@Z @ 0x14014CB10
 * Callers:
 *     <none>
 * Callees:
...
{
  DirectComposition::CMarshaledArray<MilGradientStop,1650934596,4096,526,527>::~CMarshaledArray<MilGradientStop,1650934596,4096,526,527>(Buffer + 80);
  if ( (a2 & 1) != 0 )
