/*
 * XREFs of ?DrvValidateAndApplyDevMode@@YAJPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1401CBDE8
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a2)
{
  ...
  if ( v7 == -1073741266 )
  {
    ...
    *((_DWORD *)a1 + 8) = -2;
    ...
    result = 3221226030LL;
    WdLogGlobalForLineNumber = 15175;
    return result;
  }
  result = 3221225485LL;
  ...
  if ( (int)v8 < 0 )
  {
    ...
    *((_DWORD *)a1 + 8) = -2;
    ...
    WdLogGlobalForLineNumber = 15192;
    return result;
  }
  v10 = (__int64)*a2;
  v11 = 0LL;
        ...
        && *(_DWORD *)(v13 + v10 + 76) == *(_DWORD *)(v4 + 244) )
      {
        if ( (*((_DWORD *)a1 + 3) & 0x20) != 0 && (*(_BYTE *)(v13 + v10 + 185) & 1) == 0 )
        {
          ...
          *((_DWORD *)a1 + 8) = -1;
          ...
          result = 3221225659LL;
          WdLogGlobalForLineNumber = 15230;
          return result;
        }
  ...
  if ( v16 < 0 )
  {
    ...
    *((_DWORD *)a1 + 8) = -2;
    ...
    WdLogGlobalForLineNumber = 15273;
    return result;
  }
