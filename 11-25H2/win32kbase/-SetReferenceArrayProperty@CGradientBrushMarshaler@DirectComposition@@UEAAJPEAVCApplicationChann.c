/*
 * XREFs of ?SetReferenceArrayProperty@CGradientBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1401015D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  if ( v11 < a5 )
  {
    for ( i = *((_DWORD *)a4[v11] + 9); i < 0xC0; i = dword_140274520[i] )
    {
      if ( i == 23 )
      {
        ++v11;
