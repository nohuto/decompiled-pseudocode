/*
 * XREFs of wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1401A5978
 * Callers:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x14013A8B8 (wil_details_FeatureReporting_RecordUsageInCache.c)
 * Callees:
 *     <none>
 */
