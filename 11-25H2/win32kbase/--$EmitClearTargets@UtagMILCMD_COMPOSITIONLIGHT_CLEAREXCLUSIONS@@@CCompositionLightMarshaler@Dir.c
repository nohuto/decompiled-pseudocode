/*
 * XREFs of ??$EmitClearTargets@UtagMILCMD_COMPOSITIONLIGHT_CLEAREXCLUSIONS@@@CCompositionLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@W4CompositionLightMarshalerFlag@01@W4MILCMD@@@Z @ 0x1400F9444
 * Callers:
