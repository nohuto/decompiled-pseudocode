/*
 * XREFs of ?CitpSetAudioInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x14007E468
 * Callers:
 ...
 *     ?CitpAudioStatDecrementStreams@@YAXPEAU_CIT_AUDIO_STATS@@E@Z @ 0x14007EAF0 (-CitpAudioStatDecrementStreams@@YAXPEAU_CIT_AUDIO_STATS@@E@Z.c)
 */
...
__int64 __fastcall CitpSetAudioInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  v6 = *(struct _CIT_IMPACT_CONTEXT **)(*(_QWORD *)(UserSessionState + 18912) + 32LL);
  ...
  if ( v4 )
  {
    if ( (unsigned int)dword_14029F094 < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_14029F088);
    v15 = 10LL;
    v14 = (char *)(v11 + 13);
  ...
  {
    if ( (unsigned int)dword_14029F0AC < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_14029F0A0);
    v14 = (char *)v11 + 105;
    v15 = 11LL;
    if ( v12 )
      v13 = (__int64)v12 + 124;
