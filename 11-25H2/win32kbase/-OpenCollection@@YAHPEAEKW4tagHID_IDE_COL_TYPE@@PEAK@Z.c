/*
 * XREFs of ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x1401EBC14
 * Callers:
...
__int64 __fastcall OpenCollection(__int64 a1, __int64 a2, int a3, _DWORD *a4)
{
  __int64 v4; // rbx
  unsigned int v5; // esi
  __int64 v9; // rbx
  ...
  {
    v5 = 1;
    *(_DWORD *)(W32GetUserSessionState(a1, a2) + 248) = v4;
    *(_BYTE *)(v4 + a1) = -95;
