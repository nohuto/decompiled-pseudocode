/*
 * XREFs of ?EmitNonDirtyingUpdateCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@PEAPEAVCResourceMarshaler@2@@Z @ 0x1400DDC20
 * Callers:
        ...
        struct DirectComposition::CResourceMarshaler **a3)
{
  ...
  v3 = *a3;
  while ( v3
       && (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, struct DirectComposition::CBatch **))(*(_QWORD *)v3 + 64LL))(
            v3,
            a2) )
  {
    *((_DWORD *)v3 + 4) &= ~2u;
