/*
 * XREFs of ?BuildManipulationInputInfo@CTouchProcessor@@QEAAXPEAUtagMANIPULATION_INPUT_INFO@@IPEBUCPointerInputFrame@@@Z @ 0x140185E58
 * Callers:
        ...
        const struct CPointerInputFrame *a4)
{
  ...
  if ( a3 < CTouchProcessor::CalcManipulationInputInfoSize(v8, v37) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 17401LL);
  if ( a3 >= CTouchProcessor::CalcManipulationInputInfoSize(v9, v37) )
  {
    ...
    if ( *((_DWORD *)a4 + 12) )
    {
      ...
      v11 = PointerInfoSize;
      if ( !PointerInfoSize )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 17411LL);
    }
    ...
    *((_DWORD *)a2 + 37) = 0;
    ...
    if ( *((_DWORD *)a2 + 37) != v7 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 17477LL);
    ...
    if ( v33 )
    {
      ...
      if ( v34 )
        *((_DWORD *)a2 + 39) = *(_DWORD *)(v34 + 968);
        ...
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 17496LL);
    }
  }
}
