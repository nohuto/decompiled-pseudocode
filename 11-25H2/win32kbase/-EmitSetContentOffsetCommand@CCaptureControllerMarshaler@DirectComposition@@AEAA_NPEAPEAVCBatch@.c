/*
 * XREFs of ?EmitSetContentOffsetCommand@CCaptureControllerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140229AA8
 * Callers:
...
char __fastcall DirectComposition::CCaptureControllerMarshaler::EmitSetContentOffsetCommand(
