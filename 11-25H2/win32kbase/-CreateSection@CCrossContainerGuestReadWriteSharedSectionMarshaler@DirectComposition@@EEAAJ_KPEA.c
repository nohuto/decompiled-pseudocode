/*
 * XREFs of ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x140235A00
 * Callers:
 *     <none>
 * Callees:
 *     DCompositionIsVailContainer @ 0x1402265EC (DCompositionIsVailContainer.c)
 *     CreateVmSharedMemorySection @ 0x1402424D8 (CreateVmSharedMemorySection.c)
 */
