/*
 * XREFs of ?UpdateISODState@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1400C2598
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (v4 - 256 <= 9 || InputTraceLogging::IsMouseInputMessage(v4))
    ...
    && (qword_14029EE30 & 0x10) != 0
    && (qword_14029EE38 & 0x10) == qword_14029EE38 )
  {
    v6 = *((_DWORD *)v5 + 25);
    v7 = v4;
    v9 = -__CFSHR__(v6, 16);
