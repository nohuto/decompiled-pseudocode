/*
 * XREFs of ?DropUserModeInputBuffer@Mouse@InputTraceLogging@@SAXXZ @ 0x14019F760
 * Callers:
...
void InputTraceLogging::Mouse::DropUserModeInputBuffer(void)
{
