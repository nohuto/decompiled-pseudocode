/*
 * XREFs of ?efSin@@YA?AVEFLOAT@@V1@@Z @ 0x14010E800
 * Callers:
 *     ?efCos@@YA?AVEFLOAT@@V1@@Z @ 0x14010E7D0 (-efCos@@YA-AVEFLOAT@@V1@@Z.c)
 ...
 * Callees:
 *     eFraction @ 0x14010E930 (eFraction.c)
 */
...
__int64 __fastcall efSin(unsigned int a1, __int64 a2)
{
  ...
  if ( (v15 & 1) != 0 )
  {
    v17 = (__m128)*((unsigned int *)&unk_14029F360 - (unsigned int)v16);
    v17.m128_f32[0] = (float)(v17.m128_f32[0] - *((float *)&unk_14029F35C - v16)) * *(float *)&v13;
    v18 = _mm_xor_ps(v17, v14);
    v18.m128_f32[0] = v18.m128_f32[0] + *((float *)&unk_14029F360 - (unsigned int)v16);
  }
  else
  {
