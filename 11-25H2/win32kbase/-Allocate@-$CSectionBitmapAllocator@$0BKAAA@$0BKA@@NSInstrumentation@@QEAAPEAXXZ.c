/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1400FA064
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<106496,416>::Allocate(__int64 a1)
{
  ...
  ClearBits = RtlFindClearBits(v3, 1u, *(_DWORD *)(a1 + 32) < 0xEAu ? *(_DWORD *)(a1 + 32) : 0);
  v5 = ClearBits;
  if ( ClearBits == -1
    || !(unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<106496,416>::CommitSlot(a1, ClearBits) )
  {
  ...
  else
  {
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0xEAu )
      *(_DWORD *)(a1 + 32) = 0;
    v6 = ((v5 / 9) << 12) + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8));
    W32ReleasePushLockExclusive(v1);
    return v6 + 416 * (v5 % 9);
  }
}
