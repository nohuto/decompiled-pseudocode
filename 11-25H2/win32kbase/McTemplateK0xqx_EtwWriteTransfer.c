/*
 * XREFs of McTemplateK0xqx_EtwWriteTransfer @ 0x14003D984
 * Callers:
...
__int64 McTemplateK0xqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v8 = 4LL;
  va_copy(v9, va2);
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 4LL, v4);
}
