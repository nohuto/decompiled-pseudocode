/*
 * XREFs of ApiSetPointerPromotionGetCurrentPointerId @ 0x1401974BC
 * Callers:
...
__int64 __fastcall ApiSetPointerPromotionGetCurrentPointerId(__int64 a1, __int64 a2)
{
  ...
  v2 = 0;
  v3 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6264LL);
  if ( v3 )
  {
    if ( v3() >= 0 )
    {
      v6 = *(unsigned __int16 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 6272LL);
      if ( v6 )
        return v6();
    }
  }
