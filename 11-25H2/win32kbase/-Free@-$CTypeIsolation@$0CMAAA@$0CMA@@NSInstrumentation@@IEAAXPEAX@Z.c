/*
 * XREFs of ?Free@?$CTypeIsolation@$0CMAAA@$0CMA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1400FF560
 * Callers:
 *     ??$_lambda_invoker_cdecl_@PEAXPEAU_LOOKASIDE_LIST_EX@@@_lambda_2_@?1??Initialize@?$CLookAsideTypeIsolation@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA_NXZ@SA?A_PPEAXPEAU_LOOKASIDE_LIST_EX@@@Z @ 0x1400FF540 (--$_lambda_invoker_cdecl_@PEAXPEAU_LOOKASIDE_LIST_EX@@@_lambda_2_@-1--Initialize@-$_ea_1400FF540.c)
 * Callees:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1400FF6DC (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<180224,704>::Free(__int64 *a1, void *a2)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    ...
    NSInstrumentation::PlatformAbort(v14, (ULONG_PTR)a2, 0LL);
  }
