/*
 * XREFs of ?DrvSetDisplayConfigApplyDeviceHack@@YAXPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x140147A08
 * Callers:
...
void __fastcall DrvSetDisplayConfigApplyDeviceHack(struct D3DKMT_GETPATHSMODALITY *a1)
{
  ...
  if ( RtlQueryRegistryValues(3u, L"GRE_Initialize\\OverrideScreenLayout", &QueryTable, 0LL, 0LL) >= 0 )
  {
    ...
    {
      WdLogSingleEntry4(2LL, (int)v10, SDWORD1(v10));
      WdLogGlobalForLineNumber = 15408;
    }
    else
    {
      v6 = 0;
