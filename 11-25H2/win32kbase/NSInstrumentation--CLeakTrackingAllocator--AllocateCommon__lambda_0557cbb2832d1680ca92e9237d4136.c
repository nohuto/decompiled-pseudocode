/*
 * XREFs of NSInstrumentation::CLeakTrackingAllocator::AllocateCommon__lambda_0557cbb2832d1680ca92e9237d413628___ @ 0x1401D2B78
 * Callers:
 ...
 *     NSInstrumentation::CLeakTrackingAllocator::MakeUntrackedAllocation__lambda_0557cbb2832d1680ca92e9237d413628__unsigned___int64_&_ @ 0x1401D3118 (NSInstrumentation--CLeakTrackingAllocator--MakeUntrackedAllocation__lambda_0557cbb2832d1680ca92e.c)
...
LABEL_3:
  ...
  if ( v4 == 1 )
  {
    if ( NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(a1, a3) && v7 + 16 >= v7 )
    {
      ...
      v16 = *(_QWORD *)v12.m128i_i64[0] | 2LL;
      v26 = *v13;
