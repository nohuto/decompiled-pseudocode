/*
 * XREFs of LookUpTableFlushComplete @ 0x1402C99EC
 * Callers:
 *     TlgAggregateFlush @ 0x14015837C (TlgAggregateFlush.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1402C96E0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1402CA530 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
 ...
 *     FlushLookUpTableBucket @ 0x14015B38C (FlushLookUpTableBucket.c)
 *     __security_check_cookie @ 0x140242EA0 (__security_check_cookie.c)
 *     UpdateInternalStatsOnFlush @ 0x1402C9D98 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( (_DWORD)v2 )
  {
    ...
    if ( v7 )
    {
      if ( (unsigned int)dword_14029F168 > 5
        && (qword_14029F178 & 0x200000000000LL) != 0
        && (qword_14029F180 & 0x200000000000LL) == qword_14029F180 )
      {
        v11 = 4;
        v34 = L"SummaryCount";
        v35 = 24;
