/*
 * XREFs of RIMRetrieveRealAngularPhysicalValues @ 0x1401F5AF4
 * Callers:
 *     RIMRetrieveNormalizationRange @ 0x1401F5964 (RIMRetrieveNormalizationRange.c)
 * Callees:
 *     RIMComputePower @ 0x1401577FC (RIMComputePower.c)
...
__int64 __fastcall RIMRetrieveRealAngularPhysicalValues(__int64 a1, int *a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 36) & 0xF) != 0 )
  {
    ...
    v7 = word_1402695E8[2 * v5 + 1];
LABEL_11:
    v13 = RIMComputePower(v7);
    if ( !v13 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 186);
    v14 = -v9;
    if ( v9 >= 0 )
      v14 = v9;
    if ( (unsigned int)v11 < 5 )
    {
      v15 = dword_140272E40[v11];
      if ( v15 == 4 )
      {
        if ( v7 > -4 || !(v14 / v13) )
          return v2;
        if ( v7 < -4 )
        {
          ...
          do
          {
            ...
            --v8;
            ++v2;
            v16 = dword_140272DF0[v17] + 10 * v16;
          }
          while ( v8 > v7 );
          v20 = v16;
        }
