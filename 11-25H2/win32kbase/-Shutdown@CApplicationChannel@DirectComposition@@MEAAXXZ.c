/*
 * XREFs of ?Shutdown@CApplicationChannel@DirectComposition@@MEAAXXZ @ 0x140054CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PostBatch@CConnection@DirectComposition@@QEAAXPEAVCBatch@2@0@Z @ 0x140055BC8 (-PostBatch@CConnection@DirectComposition@@QEAAXPEAVCBatch@2@0@Z.c)
...
void __fastcall DirectComposition::CApplicationChannel::Shutdown(DirectComposition::CApplicationChannel *this)
{
  ...
  *((_DWORD *)this + 6) = v2;
  ...
  if ( *((_DWORD *)this + 7) )
  {
    ...
    KeLeaveCriticalRegion();
    if ( v11 )
      DirectComposition::CConnection::Release((DirectComposition::CConnection *)v10, v16);
  }
  else
  {
    (*(void (__fastcall **)(DirectComposition::CApplicationChannel *, __int64))(*(_QWORD *)this + 32LL))(this, 1LL);
