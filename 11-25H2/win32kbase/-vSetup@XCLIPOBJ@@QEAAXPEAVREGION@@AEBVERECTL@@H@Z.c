/*
 * XREFs of ?vSetup@XCLIPOBJ@@QEAAXPEAVREGION@@AEBVERECTL@@H@Z @ 0x1400BBC70
 * Callers:
...
void __fastcall XCLIPOBJ::vSetup(XCLIPOBJ *this, struct REGION *a2, const struct ERECTL *a3, int a4)
{
  ...
  *(_DWORD *)this = *((_DWORD *)a2 + 18);
  ...
  if ( qword_1402A10B0 )
  {
    sizeScan = Win32kRS::RegionCore_get_sizeScan(v7, qword_1402A10B0);
    v8 = qword_1402A10B0;
  }
  else
  {
    ...
    || a4 == 1 )
  {
    ...
    *((_DWORD *)this + 4) = v19;
    ...
    if ( v8 )
      v20 = Win32kRS::RegionCore_get_sizeScan((Win32kRS *)(v15 + 6), v8);
    else
      v20 = v15[10];
    if ( v20 <= 0x38 && a4 != 1 )
    {
