/*
 * XREFs of ?CompleteFrameFromContainer@RIM@InputTraceLogging@@SAXQEAURIMDEV@@PEBURIMCOMPLETEFRAME@@@Z @ 0x1401EE410
 * Callers:
        ...
        const struct RIMCOMPLETEFRAME *a2)
{
  ...
  {
    if ( v2 )
      v6 = *(unsigned __int16 *)(*(_QWORD *)(v2 + 448) + 18LL);
    else
      v6 = 0;
    v9 = v6;
    if ( v2 )
      v7 = *(unsigned __int16 *)(*(_QWORD *)(v2 + 448) + 16LL);
    else
      v7 = 0;
    v8 = *(_QWORD *)(v3 + 48);
    v33 = 0;
    ...
    v29 = 4;
    v26 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029EE20, byte_14027B6C2, 0LL, 0LL, 8u, &v15);
  }
}
