/*
 * XREFs of ?EnsureTimeListEntry@CAnimationMarshaler@DirectComposition@@IEAAJXZ @ 0x14010BB38
 * Callers:
 *     ?Initialize@CAnimationMarshaler@DirectComposition@@MEAAJXZ @ 0x14010B8A0 (-Initialize@CAnimationMarshaler@DirectComposition@@MEAAJXZ.c)
