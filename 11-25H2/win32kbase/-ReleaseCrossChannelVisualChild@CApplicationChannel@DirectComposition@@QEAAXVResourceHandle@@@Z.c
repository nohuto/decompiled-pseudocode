/*
 * XREFs of ?ReleaseCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAXVResourceHandle@@@Z @ 0x14015336C
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    result = (_UNKNOWN **)(*(__int64 (__fastcall **)(_QWORD *, _QWORD))(*(i - 47) + 344LL))(i - 47, a2);
    if ( (_BYTE)result )
