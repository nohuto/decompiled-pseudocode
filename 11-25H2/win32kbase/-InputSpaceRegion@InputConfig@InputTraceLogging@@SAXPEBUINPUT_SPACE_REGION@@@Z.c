/*
 * XREFs of ?InputSpaceRegion@InputConfig@InputTraceLogging@@SAXPEBUINPUT_SPACE_REGION@@@Z @ 0x14012F860
 * Callers:
...
void __fastcall InputTraceLogging::InputConfig::InputSpaceRegion(const struct INPUT_SPACE_REGION *a1)
{
  ...
  else if ( (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, 2LL) )
  {
    v23 = *(_WORD *)(v1 + 22);
    v24 = *(_WORD *)(v1 + 20);
    v26 = *(_DWORD *)(v1 + 12);
