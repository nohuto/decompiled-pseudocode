/*
 * XREFs of ?DisplayChange@Power@InputTraceLogging@@SAXAEBU_POWER_DISPLAY_STATE@@@Z @ 0x1401B7728
 * Callers:
...
void __fastcall InputTraceLogging::Power::DisplayChange(const struct _POWER_DISPLAY_STATE *a1)
{
  ...
  {
    v1 = tlgKeywordOn((__int64)&dword_14029EE20, 2LL);
    v3 = 0;
    if ( v1 )
    {
      v4 = v2[17];
