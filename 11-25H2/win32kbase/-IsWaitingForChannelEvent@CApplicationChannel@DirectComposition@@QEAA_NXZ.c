/*
 * XREFs of ?IsWaitingForChannelEvent@CApplicationChannel@DirectComposition@@QEAA_NXZ @ 0x140055EB4
 * Callers:
 ...
 * Callees:
 *     ?IsSignaled@CEvent@DirectComposition@@QEAA_NXZ @ 0x14005666C (-IsSignaled@CEvent@DirectComposition@@QEAA_NXZ.c)
 */
