/*
 * XREFs of ?SetReferenceProperty@CProxyGeometryClipMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x14005A360
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( a3 == 5 )
  {
    ...
    else if ( v5 == *((DirectComposition::CResourceMarshaler **)this + 12)
