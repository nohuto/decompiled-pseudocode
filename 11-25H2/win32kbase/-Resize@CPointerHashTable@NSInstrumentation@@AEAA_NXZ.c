/*
 * XREFs of ?Resize@CPointerHashTable@NSInstrumentation@@AEAA_NXZ @ 0x1401D4654
 * Callers:
 ...
 * Callees:
 *     ?InsertWithHash@CPointerHashTable@NSInstrumentation@@AEAAX_KPEBX1@Z @ 0x14015D97C (-InsertWithHash@CPointerHashTable@NSInstrumentation@@AEAAX_KPEBX1@Z.c)
...
char __fastcall NSInstrumentation::CPointerHashTable::Resize(NSInstrumentation::CPointerHashTable *this)
{
  ...
  if ( 16 * (unsigned __int64)v4 > 0xFFFFFFFF )
    return 0;
  Pool2 = (void *)ExAllocatePool2(258LL, 16LL * v4, 944337749LL);
  v6 = Pool2;
  if ( !Pool2 )
    return 0;
