/*
 * XREFs of GreCreatePatternBrushInternal @ 0x140086E10
 * Callers:
 *     GreCreatePatternBrush @ 0x140159A50 (GreCreatePatternBrush.c)
...
__int64 __fastcall GreCreatePatternBrushInternal(HSURF a1, int a2, int a3)
{
  __int64 v6; // rbx
  unsigned int v7; // r8d
  unsigned int v8; // edx
  ...
  _QWORD v17[6]; // [rsp+70h] [rbp-90h] BYREF
...
LABEL_14:
  ...
  Clone = hbmCreateClone(v16, v8, v7);
  if ( Clone )
  {
    v10 = *((_QWORD *)v16 + 16);
    if ( !v10 || (v11 = 1, (*(_DWORD *)(v10 + 24) & 0x2000) == 0) )
      v11 = 0;
    BRUSHMEMOBJ::BRUSHMEMOBJ((BRUSHMEMOBJ *)v17, Clone, (HBITMAP)a1, v11, 0, 0x40u, a2);
    if ( v17[0] )
    {
      v6 = *(_QWORD *)v17[0];
      v18 = 1;
    }
    BRUSHMEMOBJ::~BRUSHMEMOBJ((BRUSHMEMOBJ *)v17);
  }
  ThreadRestrictNewHandlesRegion::~ThreadRestrictNewHandlesRegion((ThreadRestrictNewHandlesRegion *)v19);
LABEL_12:
