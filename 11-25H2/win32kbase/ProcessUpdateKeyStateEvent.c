/*
 * XREFs of ProcessUpdateKeyStateEvent @ 0x140094550
 * Callers:
...
void __fastcall ProcessUpdateKeyStateEvent(__int64 a1, unsigned __int64 a2, _BYTE *a3)
{
  char *v4; // rbp
  __int64 v5; // r14
  _BYTE *v6; // r13
    ...
    if ( *v6 )
    {
      ...
      do
      {
        ...
        if ( ((unsigned __int8)(1 << ((v8 + v9) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v8 + v9) >> 3]) != 0 )
        {
          ...
          v12 = 2 * (v10 & 3);
          v13 = v11 + v5;
          v14 = *(unsigned __int8 *)(v11 + v5 + 256);
        ...
        if ( ((unsigned __int8)(1 << ((v10 + 1) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v10 + 1) >> 3]) != 0 )
        {
          ...
          v21 = 2 * v19;
          v22 = v18 + v5;
          v23 = *(unsigned __int8 *)(v18 + v5 + 256);
        ...
        if ( ((unsigned __int8)(1 << ((v10 + 2) & 7)) & a3[(unsigned __int64)(unsigned __int8)(v10 + 2) >> 3]) != 0 )
        {
          ...
          v30 = 2 * v28;
          v31 = v27 + v5;
          v32 = *(unsigned __int8 *)(v27 + v5 + 256);
        ...
        if ( ((unsigned __int8)a2 & a3[(unsigned __int64)v36 >> 3]) != 0 )
        {
          ...
          v40 = 2 * v38;
          v41 = v37 + v5;
          v42 = *(unsigned __int8 *)(v37 + v5 + 256);
  ...
  v47 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 19872);
  ++*(_DWORD *)(v47 + 6984);
  if ( v4 != (char *)(W32GetUserSessionState(v47, v48) + 14336) )
