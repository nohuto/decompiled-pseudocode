/*
 * XREFs of McTemplateK0cpttttttpppqqq_EtwWriteTransfer @ 0x14003C168
 * Callers:
...
__int64 __fastcall McTemplateK0cpttttttpppqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a17)
{
  ...
  v49 = 4LL;
  v51 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 15LL, v23);
}
