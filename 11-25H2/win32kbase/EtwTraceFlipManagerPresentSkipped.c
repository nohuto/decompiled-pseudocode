/*
 * XREFs of EtwTraceFlipManagerPresentSkipped @ 0x140152890
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a6)
{
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 1) != 0 )
  {
    ...
    McTemplateK0qxxxxxi_EtwWriteTransfer(v23, &FlipManagerPresentSkipped, v18, a1, a2, a3, v23 + (int)v24, v21, v18, v6);
  }
}
