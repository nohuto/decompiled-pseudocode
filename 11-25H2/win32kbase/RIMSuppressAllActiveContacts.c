/*
 * XREFs of RIMSuppressAllActiveContacts @ 0x14002E5A0
 * Callers:
 ...
 * Callees:
 *     ?SuppressAllActiveContacts@RIM@InputTraceLogging@@SAXPEBURIMDEV@@K@Z @ 0x14002ECE0 (-SuppressAllActiveContacts@RIM@InputTraceLogging@@SAXPEBURIMDEV@@K@Z.c)
...
__int64 __fastcall RIMSuppressAllActiveContacts(struct RawInputManagerObject *a1, __int64 a2, unsigned int a3)
{
  ...
  while ( 1 )
  {
    ...
    v17 = v19 - 16;
    if ( (unsigned int)RIMCmIsContactDeliveringAnyData(v19 - 16) )
    {
      ...
      if ( v9 )
        RIMInsertSimulatedContactEndStateInFrame((_DWORD)a1, v6, v17, v25, v23, 1);
    }
  ...
  if ( v9 )
  {
    ...
    return RIMCompletePointerDeviceFrame(a1);
  }
  return result;
}
