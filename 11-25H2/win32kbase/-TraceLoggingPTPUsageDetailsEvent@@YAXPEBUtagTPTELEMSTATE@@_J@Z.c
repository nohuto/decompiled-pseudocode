/*
 * XREFs of ?TraceLoggingPTPUsageDetailsEvent@@YAXPEBUtagTPTELEMSTATE@@_J@Z @ 0x140141EF4
 * Callers:
...
void __fastcall TraceLoggingPTPUsageDetailsEvent(const struct tagTPTELEMSTATE *a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned int)dword_14029EE58 > 5
    && (qword_14029EE68 & 0x200000000000LL) != 0
    && (qword_14029EE70 & 0x200000000000LL) == qword_14029EE70 )
  {
    v13 = *((_DWORD *)a1 + 37);
    v14 = *((_DWORD *)a1 + 36);
    v4 = *((_DWORD *)a1 + 35);
