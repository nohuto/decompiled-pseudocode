/*
 * XREFs of ?GetEntryFromIndex@GdiHandleManager@@QEAAPEAU_ENTRY@@I@Z @ 0x14006FBAC
 * Callers:
 ...
 *     NtGdiGetEntry @ 0x14006F450 (NtGdiGetEntry.c)
...
struct _ENTRY *__fastcall GdiHandleManager::GetEntryFromIndex(GdiHandleManager *this, unsigned int a2)
{
  __int64 v2; // r8
  __int64 v4; // rdi
  ...
  if ( a2 < v11 + ((*(unsigned __int16 *)(v10 + 2) + 0xFFFF) << 16) )
  {
    ...
    if ( v12 )
      a2 += ((1 - v12) << 16) - v11;
    if ( a2 < *(_DWORD *)(v13 + 20)
      && *(_QWORD *)(*(_QWORD *)(**(_QWORD **)(v13 + 24) + 8 * ((unsigned __int64)a2 >> 8))
