/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x140157D40
 * Callers:
  ...
  *(_OWORD *)v32 = 0LL;
  ...
  if ( (v5 & 1) != 0 )
  {
    if ( v10 < 2 )
    {
      ...
      WdLogGlobalForLineNumber = 17123;
LABEL_16:
      v11 = -1073741811;
      goto LABEL_38;
    }
  ...
  if ( v10 )
  {
    if ( (v5 & 2) != 0 )
    {
      ...
      WdLogGlobalForLineNumber = 17141;
      goto LABEL_16;
    }
LABEL_7:
    ...
    if ( PathModalityForDisplayConfig >= 0 )
    {
      ...
      if ( v29 )
      {
        ...
        if ( v20 >= v10 )
        {
          ...
          WdLogGlobalForLineNumber = 17208;
          goto LABEL_16;
        }
        v21 = v32[0];
        if ( a4 )
        {
          if ( *((unsigned __int16 *)v32[0] + 10) < v10 )
          {
            ...
            v21 = v32[0];
            WdLogGlobalForLineNumber = 17216;
          }
...
LABEL_37:
  ...
  WdLogGlobalForLineNumber = 17135;
LABEL_38:
