/*
 * XREFs of ?HandleDrag@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1400C9534
 * Callers:
 ...
 *     ?ApplyElasticDragModeDeltas@CPTPEngine@@AEAAHPEAUCContactState@@PEAUtagPOINTER_INFO@@PEAUtagPOINT@@@Z @ 0x1400C9C24 (-ApplyElasticDragModeDeltas@CPTPEngine@@AEAAHPEAUCContactState@@PEAUtagPOINTER_INFO@@PEAUtagPOIN.c)
...
void __fastcall CPTPEngine::HandleDrag(CPTPEngine *this, struct PTPInput *a2)
{
  ...
  int v32; // ecx
  struct tagPOINT v33; // [rsp+68h] [rbp+10h] BYREF
    ...
    if ( v6 )
    {
      ...
      if ( v21 )
      {
        if ( *((_DWORD *)this + 706) == 1 )
        {
          ...
          {
            *((_QWORD *)this + 370) = *(_QWORD *)a2;
            *((_DWORD *)this + 770) = v32 | 0x40000;
          }
        }
      }
      v22 = *((_DWORD *)this + 770);
      if ( (v22 & 0x20000) == 0
        || *(_QWORD *)a2 - *((_QWORD *)this + 370) >= *((_QWORD *)this + 12)
                                                    * (unsigned __int64)*((unsigned int *)this + 787)
                                                    / 0x3E8 )
      {
        v23 = 0;
        v24 = *((_DWORD *)this + 770);
...
LABEL_26:
        ...
        *(struct tagPOINT *)((char *)this + 2860) = v31;
