/*
 * XREFs of rimGetCompleteFrameFromIVCompleteFrame @ 0x1401EF51C
 * Callers:
    ...
    *((_QWORD *)v9 + 27) = v34;
    ...
    while ( v36 )
    {
      ...
      if ( !v36 )
        break;
LABEL_38:
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1557);
    }
    *v4 = v9;
    v7 = 1;
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v21 + v18 + 64) = *((_QWORD *)&v47 + 1);
    ...
    v50 = v24;
    *(_QWORD *)&v44 = v18 + v26;
    v27 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v19, 2LL) + 48) + 7464LL);
    if ( !v27 || v27() < 0 )
      return 0LL;
    v30 = *(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v29, v28) + 48) + 7472LL);
