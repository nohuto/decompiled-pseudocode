/*
 * XREFs of ?rimSetPointerDeviceOutputConfig@@YAXPEAURIMDEV@@PEAUtagHID_POINTER_DEVICE_INFO@@PEAVCLockedInputSpace@@PEAVCLockedInputSpaceRegion@@@Z @ 0x14002D388
 * Callers:
  ...
  *(_QWORD *)((char *)a2 + 228) = *v5;
  ...
  if ( (*((_DWORD *)a2 + 92) & 8) != 0 && *((_DWORD *)a2 + 91) == 1 )
  {
    ...
    *((_DWORD *)a2 + 51) = v14;
    ...
    {
      v16 = (_OWORD *)RIMGetVirtualDesktopPhysicalSize(v29);
    }
    v17 = (char *)a2 + 30;
    v18 = 6LL;
    *((_OWORD *)a2 + 11) = *v16;
