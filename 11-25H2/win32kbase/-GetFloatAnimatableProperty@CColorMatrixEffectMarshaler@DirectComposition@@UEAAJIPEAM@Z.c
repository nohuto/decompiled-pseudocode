/*
 * XREFs of ?GetFloatAnimatableProperty@CColorMatrixEffectMarshaler@DirectComposition@@UEAAJIPEAM@Z @ 0x140231C20
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( (unsigned int)(a2 - 7) > 0x13 )
    ...
    *a3 = *((float *)this + 4 * ((unsigned __int64)(unsigned int)(a2 - 7) >> 2) + (((_BYTE)a2 + 1) & 3) + 28);
  return v3;
}
