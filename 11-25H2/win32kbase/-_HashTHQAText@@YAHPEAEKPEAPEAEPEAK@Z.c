/*
 * XREFs of ?_HashTHQAText@@YAHPEAEKPEAPEAEPEAK@Z @ 0x1400B00B4
 * Callers:
  ...
  *a4 = 0;
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( Property < 0 )
    {
      ...
      {
        v37 = Property;
        v29 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v11) + 19336);
        v35 = 19;
        goto LABEL_27;
      }
      goto LABEL_10;
    ...
    if ( v7 )
    {
      v15 = BCryptGetProperty(phAlgorithm, L"HashDigestLength", (PUCHAR)&v40, 4u, &pcbResult, 0);
      if ( v15 < 0 )
      {
        if ( WPP_GLOBAL_Control == (_UNKNOWN *)&WPP_GLOBAL_Control
          || (v14 = *((unsigned int *)WPP_GLOBAL_Control + 11), (v14 & 1) == 0)
          || (v25 = 1, *((_BYTE *)WPP_GLOBAL_Control + 41) < 3u) )
        {
          v25 = 0;
        }
        ...
        {
          v37 = v15;
          v29 = *(_QWORD *)(W32GetUserSessionState(v14, WPP_GLOBAL_Control) + 19336);
          v35 = 21;
          goto LABEL_27;
        }
        goto LABEL_10;
      }
      v16 = (unsigned __int8 *)Win32AllocPoolZInitImpl(256LL, v40, 0x63707355u);
      *a3 = v16;
      if ( v16 )
      {
        ...
        if ( v19 < 0 )
        {
          ...
          {
            v37 = v19;
            v29 = *(_QWORD *)(W32GetUserSessionState(v18, WPP_GLOBAL_Control) + 19336);
            v35 = 23;
            goto LABEL_27;
          }
        }
        else
        {
          ...
          if ( v21 < 0 )
          {
            ...
            {
              v37 = v21;
              v29 = *(_QWORD *)(W32GetUserSessionState(v20, WPP_GLOBAL_Control) + 19336);
              v35 = 24;
              goto LABEL_27;
            }
          }
          else
          {
            ...
            {
              v37 = v23;
              v29 = *(_QWORD *)(W32GetUserSessionState(v22, WPP_GLOBAL_Control) + 19336);
              v35 = 25;
              goto LABEL_27;
            }
          }
      ...
      if ( !v30 && WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_10;
      v34 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v17) + 19336);
      v36 = 22;
    }
    else
    {
      ...
      if ( !v30 && WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_10;
      v34 = *(_QWORD *)(W32GetUserSessionState(v13, WPP_GLOBAL_Control) + 19336);
      v36 = 20;
    }
    LOBYTE(v33) = v31;
    LOBYTE(v32) = v30;
  ...
  {
    v37 = v10;
    v29 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v9) + 19336);
    v35 = 18;
LABEL_27:
    LOBYTE(v28) = v26;
    LOBYTE(v27) = v25;
