/*
 * XREFs of UserProcessTimerDelayCallout @ 0x1401A750C
 * Callers:
...
__int64 __fastcall UserProcessTimerDelayCallout(__int64 a1, __int64 a2)
{
...
LABEL_19:
  ...
  if ( ProcessWin32Process && *ProcessWin32Process )
  {
    v15 = *(_DWORD *)(a1 + 28);
    v16 = *(_DWORD *)(a1 + 24);
    v17 = *(__int64 (__fastcall **)(_QWORD *, _QWORD, _QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v13, v12) + 48)
                                                             + 1248LL);
    if ( v17 )
      v18 = v17(v14, v16, v15);
    else
