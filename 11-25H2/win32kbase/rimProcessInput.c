  ...
  if ( *(_DWORD *)(a1 + 848) )
  {
    if ( Size.m128i_i64[1] > v14 )
    {
      ...
      else
      {
        ...
        {
          UserSessionState = W32GetUserSessionState(v28, &WPP_RECORDER_INITIALIZED);
          LOBYTE(v30) = v33;
          LOBYTE(v31) = v37;
