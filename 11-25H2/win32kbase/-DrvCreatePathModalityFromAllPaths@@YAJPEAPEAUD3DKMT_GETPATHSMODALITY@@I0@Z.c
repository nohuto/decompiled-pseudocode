/*
 * XREFs of ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1401CB6F4
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a3)
{
  ...
  if ( a2 < 2 )
  {
    PathsModality = GetPathsModality((__int64)a1, (char **)a3, a2 != 0 ? 8 : 1, 0);
    v9 = PathsModality;
    if ( PathsModality < 0 )
    {
      WdLogSingleEntry2(2LL, PathsModality, 26838LL);
      WdLogGlobalForLineNumber = 26838;
    }
    return v9;
  }
  if ( !*a1 )
  {
    if ( a2 != 2 )
    {
      ...
      WdLogGlobalForLineNumber = 26849;
    }
    v11 = GetPathsModality((__int64)a1, (char **)a1, 0x10u, 0);
    v12 = v11;
    if ( v11 < 0 )
    {
      WdLogSingleEntry2(2LL, v11, 26858LL);
      result = v12;
      WdLogGlobalForLineNumber = 26858;
      return result;
    }
    if ( !*a1 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 26863;
    }
  }
  v13 = a2 - 1;
  if ( !v13 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 26865;
  }
  v14 = 0;
  while ( v13 )
  {
  ...
  *a3 = v15;
  if ( !v15 )
  {
    ...
    WdLogGlobalForLineNumber = 26937;
    return v9;
  }
  *((_WORD *)v15 + 10) = 1;
  *((_DWORD *)*a3 + 8) = 8;
