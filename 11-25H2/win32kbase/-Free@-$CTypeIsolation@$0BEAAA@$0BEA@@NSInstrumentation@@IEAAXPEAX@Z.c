/*
 * XREFs of ?Free@?$CTypeIsolation@$0BEAAA@$0BEA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14000C528
 * Callers:
 ...
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14000C2D4 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAA-AW4Alloc.c)
