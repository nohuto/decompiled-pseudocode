/*
 * XREFs of ?WaitingForEffectCompile@CBatch@DirectComposition@@AEAA_NXZ @ 0x1402291DC
 * Callers:
 ...
 * Callees:
 *     ?EffectHashesCompiled@CConnection@DirectComposition@@QEBA_NPEB_KI@Z @ 0x140227ED0 (-EffectHashesCompiled@CConnection@DirectComposition@@QEBA_NPEB_KI@Z.c)
 */
