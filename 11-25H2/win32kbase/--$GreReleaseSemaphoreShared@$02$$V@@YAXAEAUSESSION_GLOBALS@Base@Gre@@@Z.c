/*
 * XREFs of ??$GreReleaseSemaphoreShared@$02$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x140046440
 * Callers:
...
void __fastcall GreReleaseSemaphoreShared<3,>(struct _ERESOURCE **a1)
{
  ...
  v1 = *a1;
  EtwTraceGreLockReleaseSemaphore((__int64)L"DCVisRgn", (unsigned int)*a1 + 728);
  ...
  v5 = v3 + 8;
  v6 = -v3;
  if ( (v5 & -(__int64)(v6 != 0)) != 0 && (*(_BYTE *)((v5 & -(__int64)(v6 != 0)) + 0xB))-- == 1 )
    *(_QWORD *)(v5 & -(__int64)(v6 != 0)) &= ~8uLL;
  GreReleaseSemaphoreSharedInternal(v1 + 7);
}
