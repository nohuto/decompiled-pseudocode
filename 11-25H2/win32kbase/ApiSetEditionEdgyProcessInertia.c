/*
 * XREFs of ApiSetEditionEdgyProcessInertia @ 0x14019500C
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyProcessInertia(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6712LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 6720LL);
      if ( result )
