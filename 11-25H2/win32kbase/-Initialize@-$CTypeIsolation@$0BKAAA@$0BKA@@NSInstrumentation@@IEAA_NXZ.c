/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0BKAAA@$0BKA@@NSInstrumentation@@IEAA_NXZ @ 0x1401C2DBC
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<106496,416>::Initialize(__int64 a1)
{
  _QWORD *Pool2; // rax
  _QWORD *v3; // rax
  _QWORD *v4; // rcx
  ...
  if ( !NSInstrumentation::PlatformDebugModeEnabled((NSInstrumentation *)a1) )
  {
    ...
    *(_QWORD *)(a1 + 16) = Pool2;
    ...
    {
      *Pool2 = 0LL;
      v3 = NSInstrumentation::CSectionEntry<106496,416>::Create();
      if ( v3 )
      {
        v4 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 234;
