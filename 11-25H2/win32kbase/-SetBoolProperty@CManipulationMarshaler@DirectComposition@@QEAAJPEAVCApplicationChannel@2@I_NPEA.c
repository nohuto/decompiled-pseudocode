/*
 * XREFs of ?SetBoolProperty@CManipulationMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@I_NPEA_N@Z @ 0x14011531C
 * Callers:
 ...
 * Callees:
 *     ??$GetNewTValue@_N@CManipulationMarshaler@DirectComposition@@IEAA_N_N0W4ManipulationMarshalerFlag@01@PEA_N@Z @ 0x1401153CC (--$GetNewTValue@_N@CManipulationMarshaler@DirectComposition@@IEAA_N_N0W4ManipulationMarshalerFla.c)
 */
