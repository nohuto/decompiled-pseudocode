/*
 * XREFs of ?EmitSetMaxAttenuationCutoff@CCompositionPointLightMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140239E88
 * Callers:
...
char __fastcall DirectComposition::CCompositionPointLightMarshaler::EmitSetMaxAttenuationCutoff(
