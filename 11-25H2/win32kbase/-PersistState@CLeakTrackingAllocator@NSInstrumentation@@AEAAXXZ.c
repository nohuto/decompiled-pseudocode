/*
 * XREFs of ?PersistState@CLeakTrackingAllocator@NSInstrumentation@@AEAAXXZ @ 0x1401418D0
 * Callers:
 ...
 * Callees:
 *     ?PlatformPersistConfig32@NSInstrumentation@@YAXPEBGQEBQEBGPEBIPEA_N_K@Z @ 0x1401419E8 (-PlatformPersistConfig32@NSInstrumentation@@YAXPEBGQEBQEBGPEBIPEA_N_K@Z.c)
