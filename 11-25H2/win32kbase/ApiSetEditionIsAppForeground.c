/*
 * XREFs of ApiSetEditionIsAppForeground @ 0x1402258C8
 * Callers:
...
__int64 __fastcall ApiSetEditionIsAppForeground(__int64 a1, __int64 a2)
{
  ...
  v3 = 0;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5256LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(unsigned int (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 5264LL);
      if ( v7 )
        return v7(a1);
    }
  }
