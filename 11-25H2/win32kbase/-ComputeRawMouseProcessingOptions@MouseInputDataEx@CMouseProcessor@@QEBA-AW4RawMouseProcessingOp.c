/*
 * XREFs of ?ComputeRawMouseProcessingOptions@MouseInputDataEx@CMouseProcessor@@QEBA?AW4RawMouseProcessingOptions@@XZ @ 0x14018F744
 * Callers:
...
__int64 __fastcall CMouseProcessor::MouseInputDataEx::ComputeRawMouseProcessingOptions(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 88) != 4 )
    v16 = v15;
  v17 = 0;
  v18 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v14, v13) + 48) + 7288LL);
  if ( !v18 )
    goto LABEL_34;
  if ( v18() >= 0 )
  {
    v21 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v20, v19) + 48) + 7296LL);
    if ( v21 )
    {
      v17 = v21();
      goto LABEL_31;
