/*
 * XREFs of xxxResetDisplayDevice @ 0x1400AB7F0
 * Callers:
...
__int64 __fastcall xxxResetDisplayDevice(__int64 a1, int *a2, __int64 a3)
{
  ...
  *((_QWORD *)v10 + 48) = v54;
  ...
  if ( updated >= 0 )
  {
    v38 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v12, v11) + 48) + 3696LL);
    if ( v38 )
    {
      if ( v38() >= 0 )
      {
  ...
  else
  {
    ...
    if ( v18 && v18() >= 0 )
    {
      ...
      zzzResetSharedDesktops(
        a1,
        v9 != *(_WORD *)(*(_QWORD *)(UserSessionState + 19872) + 6996LL),
        (unsigned int)-__CFSHR__(v42, 2),
        (unsigned int)-__CFSHR__(v42, 4));
    }
    ResetSystemColors(v17, v16);
    ...
    else
    {
      ...
      if ( v29 && v29() >= 0 )
        xxxDesktopsRecalcAndBroadcastDisplayChange(a1, (_DWORD)v56, v9, v30, (__int64)a2, a3);
    }
    PopAndFreeW32ThreadLock((__int64)v54);
