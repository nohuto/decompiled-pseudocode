/*
 * XREFs of McTemplateK0pqqxqttxxt_EtwWriteTransfer @ 0x1400D06F8
 * Callers:
 *     EtwTraceTokenStateChangedEvent @ 0x1400D0680 (EtwTraceTokenStateChangedEvent.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14003E650 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140242EA0 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqqxqttxxt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &TokenStateChangedEvent, &W32kControlGuid, 0xBu, &v4);
}
