/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1400FA4DC
 * Callers:
 *     EtwDevLockEndTightUpdate @ 0x1400FA420 (EtwDevLockEndTightUpdate.c)
 *     EtwDevLockEndUpdate @ 0x1400FA480 (EtwDevLockEndUpdate.c)
 * Callees:
