/*
 * XREFs of ?ivrIVRegisterChildLifetimeNotifications@@YAJPEAU_ETHREAD@@0P6AJPEAX@ZKPEAPEAX@Z @ 0x14021B0F4
 * Callers:
        ...
        unsigned int a4)
{
  ...
  v7 = *(__int64 (__fastcall **)(struct _ETHREAD *, struct _ETHREAD *, __int64 (__fastcall *)(void *), _QWORD, _QWORD))(W32GetUserSessionState(a1, a2) + 19528);
  if ( v7 )
