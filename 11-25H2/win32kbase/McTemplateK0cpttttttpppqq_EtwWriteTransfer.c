/*
 * XREFs of McTemplateK0cpttttttpppqq_EtwWriteTransfer @ 0x14003C650
 * Callers:
...
__int64 __fastcall McTemplateK0cpttttttpppqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a16)
{
  ...
  v43 = 4LL;
  v45 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 14LL, v19);
}
