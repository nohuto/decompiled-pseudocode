/*
 * XREFs of ?AssignAttachQueue@tagTHREADINFO@@QEAAPEAUtagQ@@PEAU2@@Z @ 0x140121FE0
 * Callers:
 *     <none>
 * Callees:
...
{
  return (struct tagQ *)tagTHREADINFO::AssignQueueWorker((_DWORD)this, (_DWORD)a2, 512, 1696, 696);
}
