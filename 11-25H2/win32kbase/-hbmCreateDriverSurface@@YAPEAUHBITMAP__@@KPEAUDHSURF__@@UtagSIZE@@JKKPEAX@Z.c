/*
 * XREFs of ?hbmCreateDriverSurface@@YAPEAUHBITMAP__@@KPEAUDHSURF__@@UtagSIZE@@JKKPEAX@Z @ 0x14008A368
 * Callers:
 *     EngCreateDeviceBitmap @ 0x1400894C0 (EngCreateDeviceBitmap.c)
 *     EngCreateRedirectionDeviceBitmap @ 0x140089A20 (EngCreateRedirectionDeviceBitmap.c)
 *     EngCreateBitmap @ 0x140089A60 (EngCreateBitmap.c)
