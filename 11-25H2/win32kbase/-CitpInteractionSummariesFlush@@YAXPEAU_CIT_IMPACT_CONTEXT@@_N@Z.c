/*
 * XREFs of ?CitpInteractionSummariesFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@_N@Z @ 0x14007C5C0
 * Callers:
...
void __fastcall CitpInteractionSummariesFlush(struct _CIT_IMPACT_CONTEXT *a1, char a2)
{
  ...
  struct _CIT_INTERACTION_SUMMARY *v10; // rdx
  __int64 v11; // rax
...
LABEL_16:
  ...
  *((_QWORD *)a1 + 35) = v5;
  while ( 1 )
  {
    ...
    *((_QWORD *)v10 + 1) = v10;
    *(_QWORD *)v10 = v10;
    CitpInteractionSummaryStartTracking(a1, v10);
  }
}
