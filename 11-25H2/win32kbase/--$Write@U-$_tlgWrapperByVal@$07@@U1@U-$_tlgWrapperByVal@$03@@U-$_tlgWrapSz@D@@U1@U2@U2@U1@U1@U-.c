        ...
        const WCHAR **a44)
{
  ...
  _BYTE *v70; // rcx
  int v71; // r8d
  _BYTE v73[32]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v77 = 8LL;
  v75 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(a1, a2, 0LL, 0LL, 42, v73);
}
