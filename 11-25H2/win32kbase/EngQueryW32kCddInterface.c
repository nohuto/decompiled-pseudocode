/*
 * XREFs of EngQueryW32kCddInterface @ 0x14006BBD0
 * Callers:
 *     <none>
 * Callees:
 *     UserIsWddmConnectedSession @ 0x14006BDB0 (UserIsWddmConnectedSession.c)
 *     ?GetGraphicsDeviceFromDevObjHandle@@YAPEAUtagGRAPHICS_DEVICE@@QEAX@Z @ 0x14006BF34 (-GetGraphicsDeviceFromDevObjHandle@@YAPEAUtagGRAPHICS_DEVICE@@QEAX@Z.c)
 *     ?IsCddCddRemoteSessionFilteringAllowed@@YAHXZ @ 0x140102640 (-IsCddCddRemoteSessionFilteringAllowed@@YAHXZ.c)
 */
