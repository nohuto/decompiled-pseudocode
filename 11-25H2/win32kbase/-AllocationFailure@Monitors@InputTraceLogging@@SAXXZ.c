/*
 * XREFs of ?AllocationFailure@Monitors@InputTraceLogging@@SAXXZ @ 0x1401A072C
 * Callers:
...
{
  if ( (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, 0x80000LL) )
