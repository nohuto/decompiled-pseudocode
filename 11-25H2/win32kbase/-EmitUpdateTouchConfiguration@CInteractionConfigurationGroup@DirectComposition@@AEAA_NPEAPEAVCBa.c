/*
 * XREFs of ?EmitUpdateTouchConfiguration@CInteractionConfigurationGroup@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14005703C
 * Callers:
    ...
    if ( *v5 )
    {
      ...
      if ( (_DWORD)v11 )
      {
        do
        {
          v17 = v16 + *v10;
          ++v16;
          v18 = *(_QWORD *)(*((_QWORD *)this + 2) + 8 * v17);
          *v14 = *(_QWORD *)v18;
