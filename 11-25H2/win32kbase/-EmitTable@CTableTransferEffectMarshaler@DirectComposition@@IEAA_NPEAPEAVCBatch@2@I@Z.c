/*
 * XREFs of ?EmitTable@CTableTransferEffectMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@I@Z @ 0x140232F38
 * Callers:
    ...
    do
    {
      ...
      if ( (unsigned __int64)v7 < 0x18 )
      {
        if ( !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v11) )
          return *((_DWORD *)this + 4 * v5 + 31) == *((_DWORD *)this + 4 * v5 + 30);
        v7 = v11;
      }
