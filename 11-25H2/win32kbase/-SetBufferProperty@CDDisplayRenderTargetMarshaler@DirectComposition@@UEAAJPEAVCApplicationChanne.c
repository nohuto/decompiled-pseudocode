/*
 * XREFs of ?SetBufferProperty@CDDisplayRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x14014D180
 * Callers:
 *     <none>
 * Callees:
 *     <none>
