/*
 * XREFs of ?Initialize@EntryDataLookupTable@GdiHandleEntryTable@@QEAA_NI@Z @ 0x1400286C0
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    *(_QWORD *)(*(_QWORD *)this + 8 * v6) = Win32AllocPoolImpl(256LL, 0x1000uLL, 0x636C6547u);
    v5 = *(_QWORD *)this;
    if ( !*(_QWORD *)(*(_QWORD *)this + 8 * v6) )
      return 0;
  }
