/*
 * XREFs of ?FreeFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x140107658
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::FreeFrame(
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)dword_14029EE20 > 5 && (qword_14029EE30 & 0x20) != 0 && (qword_14029EE38 & 0x20) == qword_14029EE38 )
  {
    v4 = *((_DWORD *)a1 + 10);
    v5 = *((_QWORD *)a1 + 9);
    v6 = *((_QWORD *)a1 + 27);
