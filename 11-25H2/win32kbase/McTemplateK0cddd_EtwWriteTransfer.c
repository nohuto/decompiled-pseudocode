/*
 * XREFs of McTemplateK0cddd_EtwWriteTransfer @ 0x14003BBB0
 * Callers:
...
__int64 __fastcall McTemplateK0cddd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a7)
{
  ...
  v15 = &a7;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 5LL, v8);
}
