/*
 * XREFs of McTemplateK0xqnqNR3_EtwWriteTransfer @ 0x140027570
 * Callers:
...
__int64 McTemplateK0xqnqNR3_EtwWriteTransfer(__int64 a1, __int64 a2, _DWORD a3, __int64 a4, ...)
{
  _BYTE v5[16]; // [rsp+30h] [rbp-49h] BYREF
  ...
  v11 = 16LL;
  v13 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 6LL, v5);
}
