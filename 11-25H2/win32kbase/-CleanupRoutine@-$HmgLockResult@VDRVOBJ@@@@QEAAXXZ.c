/*
 * XREFs of ?CleanupRoutine@?$HmgLockResult@VDRVOBJ@@@@QEAAXXZ @ 0x1401D09FC
 * Callers:
 *     ??1?$HmgLockResult@VDRVOBJ@@@@QEAA@XZ @ 0x1401D09D8 (--1-$HmgLockResult@VDRVOBJ@@@@QEAA@XZ.c)
 *     ?OnUnexpectedThreadTerminationStatic@?$UnexpectedThreadTerminationHandler@V?$HmgLockResult@VDRVOBJ@@@@@@SAXPEAX@Z @ 0x1401D0A30 (-OnUnexpectedThreadTerminationStatic@-$UnexpectedThreadTerminationHandler@V-$HmgLockResult@VDRVO.c)
 * Callees:
