/*
 * XREFs of ?DequeueUserModeInput@Mouse@InputTraceLogging@@SAX_KPEBVCInputDest@@@Z @ 0x14022008C
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::DequeueUserModeInput(__int64 a1, const struct CInputDest *a2)
{
  ...
  if ( InputTraceLogging::Enabled(64, 0) )
  {
    ...
    else if ( (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, v3) )
    {
      v23 = a1;
