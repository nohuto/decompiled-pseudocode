/*
 * XREFs of ?_Report@PalmTelemetry@@AEAAXK@Z @ 0x1401F5EE8
 * Callers:
 ...
 *     ?RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z @ 0x14019B06C (-RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z.c)
    ...
    if ( *((_DWORD *)this + 3) )
    {
      do
      {
        ...
        if ( v20 + 48 >= 0x800 )
        {
          ...
          if ( (unsigned int)dword_14029EF00 > 5 && tlgKeywordOn((__int64)&dword_14029EF00, 0x400000000000LL) )
          {
            v18 = (__int64)this + 28;
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
              (__int64)&dword_14029EF00,
              byte_14027DA1F,
              0LL,
              0LL,
              (void **)&v18);
