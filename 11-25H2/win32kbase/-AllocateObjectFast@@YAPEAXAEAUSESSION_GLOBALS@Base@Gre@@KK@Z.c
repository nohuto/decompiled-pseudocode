/*
 * XREFs of ?AllocateObjectFast@@YAPEAXAEAUSESSION_GLOBALS@Base@Gre@@KK@Z @ 0x1401C4C34
 * Callers:
...
__int64 __fastcall AllocateObjectFast(struct Gre::Base::SESSION_GLOBALS *a1, __int64 a2, unsigned int a3)
{
  int v3; // eax
  BOOL v4; // edi
  __int64 v5; // rsi
  ...
  {
    v6 = Win32AllocateFromPagedLookasideListImpl(*((char **)a1 + a3 + 224), a2);
    v7 = (__int64)v6;
    if ( v6 )
    {
