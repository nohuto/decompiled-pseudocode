/*
 * XREFs of ?SetTransformParent@CVisualMarshaler@DirectComposition@@IEAAJPEAVCApplicationChannel@2@PEAVCResourceMarshaler@2@_NPEA_N@Z @ 0x14005AC38
 * Callers:
...
LABEL_18:
    ...
    for ( i = *((unsigned int *)a3 + 9); (unsigned int)i < 0xC0; LODWORD(i) = dword_140274520[i] )
    {
      if ( (_DWORD)i == 186 )
      {
...
LABEL_11:
    v14 = 1;
    v16 = DirectComposition::CApplicationChannel::CreateInternalPrivateResource(a2, 0xBBu, &v19);
    v15 = v19;
    v8 = v16;
    if ( v16 < 0 )
      goto LABEL_24;
