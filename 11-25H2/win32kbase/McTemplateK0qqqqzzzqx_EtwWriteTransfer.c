/*
 * XREFs of McTemplateK0qqqqzzzqx_EtwWriteTransfer @ 0x1400F82DC
 * Callers:
        ...
        char a12)
{
  ...
  v37 = v13;
  v42 = &a12;
  return McGenEventWrite_EtwWriteTransfer(v19, &MessageCheckDelayEvent, &W32kControlGuid, 0xAu, &v22);
}
