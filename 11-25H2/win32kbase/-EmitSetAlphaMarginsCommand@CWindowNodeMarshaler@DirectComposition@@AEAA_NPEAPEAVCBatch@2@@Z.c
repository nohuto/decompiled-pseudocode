/*
 * XREFs of ?EmitSetAlphaMarginsCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1401005A0
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetAlphaMarginsCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 372);
    *((_DWORD *)this + 92) &= ~1u;
    return 1;
  }
  return 0;
