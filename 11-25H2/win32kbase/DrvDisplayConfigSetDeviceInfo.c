/*
 * XREFs of DrvDisplayConfigSetDeviceInfo @ 0x1401CD2F0
 * Callers:
    ...
    switch ( (_DWORD)v10 )
    {
      case 0xFFFFFFF0:
        if ( a1[1] == 68 )
        {
            ...
            if ( v33 == 259 )
            {
              ...
              else
              {
                ...
                if ( v35 < 0 )
                {
                  ...
                  WdLogGlobalForLineNumber = 18473;
                }
              }
            }
            else if ( v33 == 255 )
          ...
          else
          {
            ...
            WdLogGlobalForLineNumber = 18446;
          }
          return v13;
        }
        return 3221225485LL;
      case 0xFFFFFFD5:
        if ( !(unsigned int)Feature_DolbyVisionAndUpdatedHdrUx__private_IsEnabledDeviceUsageNoInline() )
        {
          ...
          WdLogGlobalForLineNumber = 18556;
          return v13;
        }
        if ( a1[1] == 24 )
        {
          ...
          if ( v31 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18544;
          }
          return v13;
        }
        return 3221225485LL;
      case 0xFFFFFFD7:
        if ( a1[1] == 24 )
        {
          ...
          if ( v28 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18714;
          }
          return v13;
        }
        return 3221225485LL;
      case 0xFFFFFFD8:
        if ( a1[1] == 24 )
        {
          ...
          if ( v26 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18696;
          }
          return v13;
        }
        return 3221225485LL;
      case 0xFFFFFFDA:
        if ( a1[1] == 28 )
        {
          ...
          if ( v24 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18678;
          }
          return v13;
        }
        return 3221225485LL;
      case 0xFFFFFFDD:
        if ( (unsigned int)a1[1] >= 0x18 )
        {
          ...
          if ( v22 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18660;
          }
          return v13;
        }
        break;
      case 0xFFFFFFE5:
        if ( (unsigned int)a1[1] >= 0x18 )
        {
          ...
          if ( (v13 & 0x80000000) != 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18642;
          }
          return v13;
        }
        break;
          ...
          case 0xFFFFFFE9:
            if ( a1[1] == 48 )
            {
              ...
              if ( v17 < 0 )
              {
                ...
                WdLogGlobalForLineNumber = 18574;
              }
              return v13;
            }
            break;
          ...
          case 0xFFFFFFEE:
            if ( a1[1] == 28 )
            {
              ...
              if ( v12 < 0 )
              {
                ...
                WdLogGlobalForLineNumber = 18508;
              }
              return v13;
            }
            return 3221225485LL;
  ...
  if ( (_DWORD)v10 == -6 )
  {
    if ( a1[1] == 28 )
    {
      ...
      if ( v63 >= 0 )
      {
        if ( a1[6] )
        {
          ...
          if ( v64 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18373;
          }
        }
      }
      else
      {
        ...
        WdLogGlobalForLineNumber = 18353;
      }
      return v13;
    }
    return 3221225485LL;
        ...
        if ( (_DWORD)v10 == 13 )
        {
          if ( a1[1] == 312 )
          {
            ...
            if ( v38 < 0 )
            {
              ...
              WdLogGlobalForLineNumber = 18591;
            }
            return v13;
          }
          return 3221225485LL;
...
LABEL_68:
          v13 = -1073741811;
          WdLogSingleEntry5(2LL, -1073741811LL, *a1, a1[3], *v8, *v7);
          WdLogGlobalForLineNumber = 18727;
          return v13;
        }
      }
      ...
      if ( v40 >= 0 )
      {
        if ( v40 != 255 )
        {
          ...
          if ( v42 < 0 )
          {
            ...
            WdLogGlobalForLineNumber = 18426;
          }
        }
      }
      else
      {
        ...
        WdLogGlobalForLineNumber = 18388;
      }
      return v13;
    }
    if ( a1[1] == 24 )
    {
      ...
      if ( v44 >= 0 )
      {
        ...
        if ( v45 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 18331;
        }
      }
      else
      {
        WdLogSingleEntry2(3LL, a1, v44);
        WdLogGlobalForLineNumber = 18312;
      }
      return v13;
    }
    return 3221225485LL;
  ...
  if ( v48 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 18201;
    return v13;
  }
  v65 = 0LL;
  v51 = 0LL;
...
LABEL_93:
    ...
    else
    {
      ...
      WdLogGlobalForLineNumber = 18255;
    }
    v61 = DxDdGetDxgkWin32kInterface(v58);
    if ( (*(int (**)(void))(v61 + 280))() < 0 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 18280;
    }
  ...
  if ( PathsModality >= 0
    || (WdLogSingleEntry5(2LL, PathsModality, a1[3], *v8, *v7, a1[5] & 1),
        WdLogGlobalForLineNumber = 18219,
        v53 != -1073741801) )
  {
    v51 = v65;
    goto LABEL_93;
  ...
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 18224;
  }
  return 3221225495LL;
}
