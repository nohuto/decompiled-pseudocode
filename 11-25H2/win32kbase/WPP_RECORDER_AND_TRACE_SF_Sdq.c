/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_Sdq @ 0x1401F09E8
 * Callers:
        ...
        ...)
{
  ...
  if ( a2 )
  {
    ...
    if ( !a9 )
      v17 = L"NULL";
    ((void (__fastcall *)(__int64, __int64, const int *, __int64, const wchar_t *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      a1,
      43LL,
