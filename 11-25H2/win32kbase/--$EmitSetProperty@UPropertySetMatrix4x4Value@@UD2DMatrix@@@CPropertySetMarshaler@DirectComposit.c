/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix4x4Value@@UD2DMatrix@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x140027980
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v13 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x5CuLL, &v13);
  v8 = (char *)v13;
  *(_DWORD *)v13 = 92;
  *(_OWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 20) = 0LL;
