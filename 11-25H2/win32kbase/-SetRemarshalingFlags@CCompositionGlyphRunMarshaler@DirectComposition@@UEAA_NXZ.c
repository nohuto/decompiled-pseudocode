/*
 * XREFs of ?SetRemarshalingFlags@CCompositionGlyphRunMarshaler@DirectComposition@@UEAA_NXZ @ 0x14022F460
 * Callers:
 *     <none>
 * Callees:
 *     ?SetRemarshalingFlags@CTextObjectMarshaler@DirectComposition@@UEAA_NXZ @ 0x140230130 (-SetRemarshalingFlags@CTextObjectMarshaler@DirectComposition@@UEAA_NXZ.c)
 */
