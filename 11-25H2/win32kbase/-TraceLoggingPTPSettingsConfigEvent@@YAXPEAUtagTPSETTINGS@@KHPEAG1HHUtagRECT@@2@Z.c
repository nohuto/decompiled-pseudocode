/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HHUtagRECT@@2@Z @ 0x1402116B0
 * Callers:
        ...
        struct tagRECT *a9)
{
  ...
  if ( (unsigned int)dword_14029EE58 > 5 && tlgKeywordOn((__int64)&dword_14029EE58, 0x800000000000LL) )
  {
    v34 = 2048LL;
    v36 = v10;
    v19 = v9;
