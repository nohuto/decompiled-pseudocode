/*
 * XREFs of ImpRpcDisconnect @ 0x14014A738
 * Callers:
...
LABEL_18:
  ...
  if ( v5 < 0 && (unsigned int)dword_14029F1A0 > 2 )
  {
    LODWORD(v7) = v5;
    v12 = &v7;
    v13 = 4LL;
    ...
    v14 = v8;
    v15 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029F1A0, byte_140284C98, 0LL, 0LL, 4u, &v11);
  }
