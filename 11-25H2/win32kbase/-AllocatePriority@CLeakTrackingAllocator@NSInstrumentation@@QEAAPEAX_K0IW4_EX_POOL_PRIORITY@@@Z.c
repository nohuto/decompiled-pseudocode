/*
 * XREFs of ?AllocatePriority@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_K0IW4_EX_POOL_PRIORITY@@@Z @ 0x1401D3228
 * Callers:
 *     Win32AllocPoolWithPriority @ 0x1401C1D50 (Win32AllocPoolWithPriority.c)
