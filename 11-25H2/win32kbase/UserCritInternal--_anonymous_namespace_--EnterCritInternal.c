/*
 * XREFs of UserCritInternal::_anonymous_namespace_::EnterCritInternal @ 0x1401ABFE8
 * Callers:
...
__int64 __fastcall UserCritInternal::_anonymous_namespace_::EnterCritInternal(_QWORD *a1, char a2)
{
  ...
  LOBYTE(v5) = 1;
  ExAcquireFastResourceExclusive(*a1, CurrentThreadWin32Thread + 4, v5);
  v6 = 0LL;
