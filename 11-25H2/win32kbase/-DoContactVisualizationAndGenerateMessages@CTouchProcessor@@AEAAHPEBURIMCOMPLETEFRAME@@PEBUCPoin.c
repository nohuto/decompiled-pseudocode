/*
 * XREFs of ?DoContactVisualizationAndGenerateMessages@CTouchProcessor@@AEAAHPEBURIMCOMPLETEFRAME@@PEBUCPointerInputFrame@@PEAXHHH@Z @ 0x1401FE898
 * Callers:
        ...
        int a7)
{
  ...
  {
    LODWORD(v31) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14973);
  }
  if ( !a7 )
  {
  ...
  v15 = (int (*)(void))*((_QWORD *)v14 + 831);
  if ( v15 )
  {
    if ( v15() >= 0 )
    {
      v14 = *(CTouchProcessor **)(W32GetWin32kBaseApiSetTable(v14, v16) + 48);
      v17 = (unsigned int (*)(void))*((_QWORD *)v14 + 832);
      if ( v17 )
      {
        if ( v17() && !IsTouchpadDevice(a4, v18) )
        {
          v31 = 0LL;
          CInpUnlockGuardExclusive::CInpUnlockGuardExclusive(
            (CInpUnlockGuardExclusive *)v30,
