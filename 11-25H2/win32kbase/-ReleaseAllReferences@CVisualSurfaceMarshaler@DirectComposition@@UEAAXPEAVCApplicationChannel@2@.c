/*
 * XREFs of ?ReleaseAllReferences@CVisualSurfaceMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400F0080
 * Callers:
 *     ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCVisualSurfaceMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400F0030 (-ReleaseAllReferences@-$CSharedResourceMarshaler@VCVisualSurfaceMarshaler@DirectComposition@@$01.c)
 * Callees:
