/*
 * XREFs of GetPointerFlagsFromMouse @ 0x1400A14C0
 * Callers:
 *     <none>
 * Callees:
 *     GetMouseKeyFlags @ 0x1400A19D0 (GetMouseKeyFlags.c)
...
LABEL_19:
  v17 = 0LL;
  for ( i = (unsigned __int16 *)&unk_1402600A0; *i != a2; i += 12 )
  {
  ...
  v19 = 3 * v17;
  v20 = *((_DWORD *)&unk_1402600A0 + 6 * v17 + 2);
  if ( (v20 & 0x10000) == 0 || (MouseKeyFlags & 0x73) != 0 )
  {
    v20 = *((_DWORD *)&unk_1402600A0 + 6 * v17 + 3);
    v21 = *((_WORD *)&unk_1402600A0 + 12 * v17 + 2);
  }
  else
  {
    v21 = *((_WORD *)&unk_1402600A0 + 12 * v17 + 1);
  }
  *a4 = MouseKeyFlags;
  v22 = v20;
  v23 = *((_BYTE *)&unk_1402600A0 + 24 * v17 + 16);
  v24 = v21;
  if ( v23 )
  {
    if ( v23 == 5 )
    ...
    if ( (*((_DWORD *)&unk_1402600A0 + 2 * v19 + 2) & 0x10000) != 0 )
    {
      MouseKeyFlags |= v42;
      *a4 = MouseKeyFlags;
    }
  ...
  {
    v24 = *((unsigned __int16 *)&unk_1402600A0 + 4 * v19 + 1);
    v25 = *((_DWORD *)&unk_1402600A0 + 2 * v19 + 2) | v20 & ~*((_DWORD *)&unk_1402600A0 + 2 * v19 + 3);
  }
  *a5 = 0;
  if ( a2 > 0x200 )
  {
...
LABEL_46:
  v37 = v25 | 2;
  **((_DWORD **)v9 + 189) = (32 * *((_DWORD *)&unk_1402600A0 + 2 * v19 + 5)) ^ (**((_DWORD **)v9 + 189) ^ (32 * *((_DWORD *)&unk_1402600A0 + 2 * v19 + 5))) & 0xFFFFFFDF;
  if ( a1 )
    *a1 = v24;
  return v37;
}
