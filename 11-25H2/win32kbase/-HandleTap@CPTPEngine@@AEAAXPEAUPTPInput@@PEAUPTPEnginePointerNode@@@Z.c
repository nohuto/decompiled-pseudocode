/*
 * XREFs of ?HandleTap@CPTPEngine@@AEAAXPEAUPTPInput@@PEAUPTPEnginePointerNode@@@Z @ 0x140193DFC
 * Callers:
 ...
 *     ?IsNearbyContactPresent@CPTPEngine@@AEAA_NPEAUPTPInput@@PEAUCContactState@@UtagPOINT@@K@Z @ 0x140151E88 (-IsNearbyContactPresent@CPTPEngine@@AEAA_NPEAUPTPInput@@PEAUCContactState@@UtagPOINT@@K@Z.c)
...
void __fastcall CPTPEngine::HandleTap(CPTPEngine *this, struct PTPInput *a2, struct tagPOINT *a3)
{
  ...
  if ( *((_DWORD *)this + 699) == 1 )
  {
    ...
    if ( (unsigned int)Feature_MultiFingerTapImprovements__private_IsEnabledDeviceUsageNoInline() )
    {
      v8 = *((_QWORD *)v6 + 110);
      v9 = *((_QWORD *)this + 375);
      if ( v8 > v9 && v8 - v9 < *((_QWORD *)this + 12) * (unsigned __int64)*((unsigned int *)this + 821) / 0x3E8 )
        return;
    }
