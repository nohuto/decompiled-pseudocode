/*
 * XREFs of ?SetReferenceArrayProperty@CProjectedShadowSceneMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1401336D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( a3 == 2 )
  {
    ...
    {
      v24 = a4[v14];
      if ( !v24 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v24 + 9), 119) )
        return v12;
      v13 = a5;
      v14 = v25 + 1;
    }
  ...
  else
  {
    ...
    {
      v16 = a4[v14];
      if ( !v16 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v16 + 9), 120) )
        return v12;
      v13 = a5;
      v14 = v17 + 1;
    }
