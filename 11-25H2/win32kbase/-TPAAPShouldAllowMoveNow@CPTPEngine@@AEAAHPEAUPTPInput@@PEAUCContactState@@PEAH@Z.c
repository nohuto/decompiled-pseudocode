/*
 * XREFs of ?TPAAPShouldAllowMoveNow@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@PEAH@Z @ 0x1400EEC10
 * Callers:
...
LABEL_4:
  ...
  if ( *((_DWORD *)this + 706) != 2 )
  {
    ...
    if ( *((_DWORD *)this + 5) )
      ...
      v12 = 0;
    if ( v8 || (__int64)(1000LL * (*(_QWORD *)a2 - *((_QWORD *)a3 + 8)) / v11) < *((unsigned int *)this + v12 + 830) )
    {
      v13 = 0;
      if ( v8 )
      {
LABEL_10:
    ...
    if ( (__int64)(1000LL * (*(_QWORD *)a2 - *((_QWORD *)this + 381)) / v11) <= *((unsigned int *)this + 846) )
      return 1LL;
    goto LABEL_10;
  }
  if ( !v9 || v10 )
