/*
 * XREFs of ?EmitUpdateCommands@CKeyframeAnimationMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x140024AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_ad8d2b11c8ff001e31c68bfd37fe4772___lambda_cef133924e7ba8c5c0c6519b3ed084f6___ @ 0x1400F9ED0 (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_ad8d2b11c8ff001e31c68bfd37fe477.c)
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  {
    v28 = 0LL;
    if ( !DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch ***)a2, 0x48uLL, &v28) )
      return 0;
    v5 = (char *)v28;
    *(_DWORD *)v28 = 72;
    v6 = v5 + 4;
  ...
  {
    v28 = 0LL;
    if ( !DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch ***)a2, 0x24uLL, &v28) )
      return 0;
    v14 = (char *)v28;
    *(_DWORD *)v28 = 36;
    *(_OWORD *)(v14 + 4) = 0LL;
  ...
  {
    v28 = 0LL;
    if ( !DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch ***)a2, 0x10uLL, &v28) )
      return 0;
    v15 = (char *)v28;
    *(_DWORD *)v28 = 16;
    *(_QWORD *)(v15 + 4) = 0LL;
