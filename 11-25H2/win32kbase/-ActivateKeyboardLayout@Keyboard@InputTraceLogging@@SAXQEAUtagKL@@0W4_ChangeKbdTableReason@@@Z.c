/*
 * XREFs of ?ActivateKeyboardLayout@Keyboard@InputTraceLogging@@SAXQEAUtagKL@@0W4_ChangeKbdTableReason@@@Z @ 0x1400F42A0
 * Callers:
...
void InputTraceLogging::Keyboard::ActivateKeyboardLayout()
{
  ...
  {
    v0 = tlgKeywordOn((__int64)&dword_14029EE20, 0x4000LL);
    v4 = 0LL;
    if ( v0 )
    {
      if ( (_DWORD)v1 )
