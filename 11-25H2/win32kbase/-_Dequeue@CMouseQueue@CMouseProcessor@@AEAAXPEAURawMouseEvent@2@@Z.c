/*
 * XREFs of ?_Dequeue@CMouseQueue@CMouseProcessor@@AEAAXPEAURawMouseEvent@2@@Z @ 0x140192AB8
 * Callers:
        ...
        struct CMouseProcessor::RawMouseEvent *a2)
{
  ...
  *((_QWORD *)v5 + 6) = *((_QWORD *)v4 + 22);
  ...
  if ( --*((_WORD *)this + 1473) >= 0x10u )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7009LL);
}
