/*
 * XREFs of ?Free@?$CTypeIsolation@$0BKAAA@$0BKA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x14000BBAC
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x14000B4AC (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<106496,416>::Free(__int64 *a1, void *a2)
{
  ...
  NSInstrumentation::CSectionBitmapAllocator<106496,416>::Free((__int64)v6, a2);
  if ( i == (__int64 *)*a1 )
  {
    W32ReleasePushLockShared(v4);
  }
