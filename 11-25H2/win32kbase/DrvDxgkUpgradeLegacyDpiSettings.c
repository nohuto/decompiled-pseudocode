/*
 * XREFs of DrvDxgkUpgradeLegacyDpiSettings @ 0x1401CE0F0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( ((v9 + 4) & 0xFFFFFFFFFFFFFFFBuLL) != 0 && (*(_DWORD *)(v9 + 160) & 0x800000) != 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          if ( v25[2] != _mm_srli_si128(*v24, 8).m128i_i32[1] )
          {
            ...
            while ( (__int64)v14 < (__int64)&dword_14026DC44 );
            ...
            while ( (__int64)v15 < (__int64)&dword_14026DC44 );
            v17 = v13 - v16;
            v18 = v17;
            ...
            if ( v21 < 0 )
            {
              ...
              WdLogGlobalForLineNumber = 29658;
            }
            else
            {
              *a2 = 1;
        ...
        else
        {
          ...
          WdLogGlobalForLineNumber = 29611;
        }
      }
    }
  }
