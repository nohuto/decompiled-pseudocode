/*
 * XREFs of rimSetContactKeepAliveState @ 0x1401F20D0
 * Callers:
...
__int64 __fastcall rimSetContactKeepAliveState(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v4 = a2 + 2368;
  if ( !*(_QWORD *)(a1 + 792) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1873);
  if ( (*(_DWORD *)(a2 + 32) & 2) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1874);
  if ( (*(_DWORD *)(a2 + 32) & 4) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1875);
