/*
 * XREFs of ?InitializeSection@CDCompMappedSharedSectionMarshaler@DirectComposition@@QEAAJ_KPEAPEAX@Z @ 0x140069000
 * Callers:
        ...
        void **a3)
{
  ...
  {
    v7 = 0LL;
    v6 = (*(__int64 (__fastcall **)(DirectComposition::CDCompMappedSharedSectionMarshaler *, __int64, HANDLE *))(*(_QWORD *)this + 328LL))(
           this,
           a2,
           &Handle);
    if ( v6 >= 0 )
