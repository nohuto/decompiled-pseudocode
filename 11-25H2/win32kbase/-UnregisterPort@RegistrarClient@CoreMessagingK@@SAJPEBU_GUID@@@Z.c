/*
 * XREFs of ?UnregisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1400FCEC8
 * Callers:
 ...
 * Callees:
 *     ?TraceUnregisterPort@Log@CoreMessagingK@@SAXPEBU_GUID@@J@Z @ 0x1400FCF8C (-TraceUnregisterPort@Log@CoreMessagingK@@SAXPEBU_GUID@@J@Z.c)
