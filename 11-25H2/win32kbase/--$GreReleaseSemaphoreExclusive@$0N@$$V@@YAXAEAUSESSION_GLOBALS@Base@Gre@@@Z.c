/*
 * XREFs of ??$GreReleaseSemaphoreExclusive@$0N@$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x140152808
 * Callers:
...
void __fastcall GreReleaseSemaphoreExclusive<13,>(struct _ERESOURCE **a1)
{
  struct _ERESOURCE *v1; // rbx
  struct _GRETHREAD *v2; // rax

  v1 = *a1;
  EtwTraceGreLockReleaseSemaphore((__int64)L"Palette", (unsigned int)*a1 + 312);
  ...
  GreReleaseSemaphoreSharedInternal(v1 + 3);
}
