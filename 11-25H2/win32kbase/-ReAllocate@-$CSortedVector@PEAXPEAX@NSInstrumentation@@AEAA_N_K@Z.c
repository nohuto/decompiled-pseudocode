/*
 * XREFs of ?ReAllocate@?$CSortedVector@PEAXPEAX@NSInstrumentation@@AEAA_N_K@Z @ 0x1401D3DF0
 * Callers:
 ...
 * Callees:
 *     ?ULongLongMult@@YAJ_K0PEA_K@Z @ 0x1400FFF00 (-ULongLongMult@@YAJ_K0PEA_K@Z.c)
