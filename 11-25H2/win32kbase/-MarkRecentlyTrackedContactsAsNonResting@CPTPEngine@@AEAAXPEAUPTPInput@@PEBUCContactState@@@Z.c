/*
 * XREFs of ?MarkRecentlyTrackedContactsAsNonResting@CPTPEngine@@AEAAXPEAUPTPInput@@PEBUCContactState@@@Z @ 0x140148E58
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 12) )
  {
    ...
    do
    {
      ...
      if ( (v9 & 1) != 0 && (v9 & 0x100) != 0 && (*v7 & 0x40000) == 0 )
      {
        ...
        if ( v11 < *((_QWORD *)this + 12) * (unsigned __int64)*((unsigned int *)this + 811) / 0x3E8 )
