/*
 * XREFs of ?EmitCreate@CDDisplayRenderTargetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1402390E8
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( *((_QWORD *)this + 10) )
  {
    DisplayManagerObjectType = (struct _OBJECT_TYPE *)GreDxgkGetDisplayManagerObjectType((__int64)this);
    OpenDwmHandle(*((PVOID *)this + 10), DisplayManagerObjectType, 0x1F0000u, v5, v8, &v10);
  }
  v9 = 0LL;
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x3CuLL, &v9) )
  {
    ...
    *(_QWORD *)(v6 + 44) = *((_QWORD *)this + 17);
    *((_DWORD *)v6 + 13) = *((_DWORD *)this + 38);
    *((_DWORD *)this + 4) &= ~0x20u;
    return 1;
  }
  return 0;
