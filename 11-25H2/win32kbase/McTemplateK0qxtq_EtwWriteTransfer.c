/*
 * XREFs of McTemplateK0qxtq_EtwWriteTransfer @ 0x1401B94C8
 * Callers:
 *     EtwTraceFlipManagerPresentSignaled @ 0x1401356F0 (EtwTraceFlipManagerPresentSignaled.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14003E650 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140242EA0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qxtq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerPresentSignaled, &W32kControlGuid, 5u, &v8);
}
