/*
 * XREFs of EtwTraceThreadExit @ 0x1400A50EC
 * Callers:
...
char __fastcall EtwTraceThreadExit(PETHREAD *a1)
{
  ...
  if ( (W32kEtwEnabledKeyword & 0x8000000000200000uLL) != 0 )
  {
    ...
    if ( (unsigned __int8)(byte_14029EDB8 - 1) > 2u && (qword_14029EDA0 & 0x8000000000200000uLL) != 0 )
    {
      LOBYTE(v2) = 0;
      if ( (qword_14029EDA8 & 0x8000000000200000uLL) == qword_14029EDA8 )
      {
