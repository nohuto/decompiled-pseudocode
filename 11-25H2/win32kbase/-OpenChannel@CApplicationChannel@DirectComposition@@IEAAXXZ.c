/*
 * XREFs of ?OpenChannel@CApplicationChannel@DirectComposition@@IEAAXXZ @ 0x140055A40
 * Callers:
 ...
 *     ?SetRetrievingProcess@CBatchSharedMemoryPoolSet@DirectComposition@@QEAAXPEAU_EPROCESS@@@Z @ 0x140055C1C (-SetRetrievingProcess@CBatchSharedMemoryPoolSet@DirectComposition@@QEAAXPEAU_EPROCESS@@@Z.c)
