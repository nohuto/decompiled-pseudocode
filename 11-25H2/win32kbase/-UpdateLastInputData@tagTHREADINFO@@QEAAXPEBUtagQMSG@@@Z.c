/*
 * XREFs of ?UpdateLastInputData@tagTHREADINFO@@QEAAXPEBUtagQMSG@@@Z @ 0x140213740
 * Callers:
 *     <none>
 * Callees:
 *     Feature_TouchpadHaptics__private_IsEnabledDeviceUsageNoInline @ 0x140213808 (Feature_TouchpadHaptics__private_IsEnabledDeviceUsageNoInline.c)
 */
