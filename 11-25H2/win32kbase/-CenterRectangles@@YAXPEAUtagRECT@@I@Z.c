/*
 * XREFs of ?CenterRectangles@@YAXPEAUtagRECT@@I@Z @ 0x1400CE4C8
 * Callers:
 *     ?RemoveOverlaps@@YAXPEAUtagRECT@@I@Z @ 0x1400CE014 (-RemoveOverlaps@@YAXPEAUtagRECT@@I@Z.c)
 *     ?RemoveGaps@@YAHPEAUtagRECT@@I@Z @ 0x1400CE0A4 (-RemoveGaps@@YAHPEAUtagRECT@@I@Z.c)
 * Callees:
 *     UnionRect @ 0x1400CE698 (UnionRect.c)
 */
