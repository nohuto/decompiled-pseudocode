/*
 * XREFs of DestroyDeferredUnlockObjectAssignmentList @ 0x1400AF2F0
 * Callers:
...
_QWORD *__fastcall DestroyDeferredUnlockObjectAssignmentList(_QWORD *a1)
{
  _QWORD *result; // rax
  __int64 v3; // rcx
  int v4; // edi
