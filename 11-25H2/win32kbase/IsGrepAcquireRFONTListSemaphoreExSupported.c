/*
 * XREFs of IsGrepAcquireRFONTListSemaphoreExSupported @ 0x1401A1030
 * Callers:
...
__int64 __fastcall IsGrepAcquireRFONTListSemaphoreExSupported(__int64 a1, __int64 a2)
{
  __int64 (*v2)(void); // rax

  v2 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 24) + 1928LL);
  if ( v2 )
    return v2();
  else
    return 3221225659LL;
