/*
 * XREFs of McTemplateK0qxtttttt_EtwWriteTransfer @ 0x14019B730
 * Callers:
 *     EtwTraceFlipManagerStartCompleteToken @ 0x140127410 (EtwTraceFlipManagerStartCompleteToken.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14003E650 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x140242EA0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qxtttttt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerStartCompleteToken, &W32kControlGuid, 9u, &v12);
}
