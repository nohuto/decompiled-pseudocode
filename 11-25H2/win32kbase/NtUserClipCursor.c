/*
 * XREFs of NtUserClipCursor @ 0x140107790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserClipCursor(struct tagRECT *a1, __int64 a2)
{
...
LABEL_9:
  v18 = 0LL;
  if ( (unsigned int)ApiSetCheckCursorClipAccess(0, v2 == 0LL) )
  {
    if ( v2 )
    {
      ...
      *(_QWORD *)&v17.left = GuessMonitorOverrideForCoordinateConversions(
      ...
      v14 = *(const struct tagRECT **)(W32GetUserSessionState(v13, v12) + 36240);
      v17 = v18;
      CCursorClip::SetClip(v14, &v17);
    }
    else
    {
