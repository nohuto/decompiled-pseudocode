/*
 * XREFs of ?ApplyDeadZoneJumpIfNeeded@DeadzoneJumping@CCursorClip@@QEAA_NUtagPOINT@@PEBUtagRECT@@PEAU3@@Z @ 0x1400661B4
 * Callers:
 ...
 *     ?Proximity@DeadzoneJumping@CCursorClip@@CAJJJJ@Z @ 0x1401A1424 (-Proximity@DeadzoneJumping@CCursorClip@@CAJJJJ@Z.c)
 */
        ...
        struct tagPOINT *a4)
{
  ...
  int v31; // eax
  LONG v32; // r8d
  tagPOINT v33; // [rsp+40h] [rbp+8h] BYREF
