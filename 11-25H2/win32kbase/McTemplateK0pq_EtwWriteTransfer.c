/*
 * XREFs of McTemplateK0pq_EtwWriteTransfer @ 0x1400E0D04
 * Callers:
 *     EtwTraceFlipManagerBindingInfo @ 0x1400E0C40 (EtwTraceFlipManagerBindingInfo.c)
 *     EtwTraceCompositionSurfaceObjectUpdateEvent @ 0x1400E0C70 (EtwTraceCompositionSurfaceObjectUpdateEvent.c)
 *     EtwUpdateEvent @ 0x1400E0CA0 (EtwUpdateEvent.c)
 *     EtwTraceKillTimer @ 0x1400E0CD0 (EtwTraceKillTimer.c)
 *     EtwLogicalSurfCreateEvent @ 0x1400E90C0 (EtwLogicalSurfCreateEvent.c)
 *     EtwLogicalSurfDestroyEvent @ 0x1400E90F0 (EtwLogicalSurfDestroyEvent.c)
