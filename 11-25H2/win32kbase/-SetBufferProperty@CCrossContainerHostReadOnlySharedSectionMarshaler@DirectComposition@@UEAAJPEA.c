/*
 * XREFs of ?SetBufferProperty@CCrossContainerHostReadOnlySharedSectionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x140235CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DirectComposition::SetGuidProperty @ 0x140235D0C (DirectComposition--SetGuidProperty.c)
 */
