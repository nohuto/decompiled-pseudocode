/*
 * XREFs of McTemplateK0qt_EtwWriteTransfer @ 0x1401B93CC
 * Callers:
 *     EtwTraceSmoothRotationStop @ 0x1401B85E0 (EtwTraceSmoothRotationStop.c)
 * Callees:
...
NTSTATUS __fastcall McTemplateK0qt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v12 = 0;
  v11 = 4;
  return McGenEventWrite_EtwWriteTransfer(4LL, &SmoothRotationStop, &W32kControlGuid, 3u, &v6);
}
