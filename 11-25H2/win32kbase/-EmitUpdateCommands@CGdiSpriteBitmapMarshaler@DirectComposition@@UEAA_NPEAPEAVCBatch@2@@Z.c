/*
 * XREFs of ?EmitUpdateCommands@CGdiSpriteBitmapMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1400F2680
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v3 = (int *)((char *)this + 16);
  v5 = 0;
  if ( (unsigned __int8)DirectComposition::CMarshaledArray<tagRECT,1684489028,32,511,512>::Marshal(
                          (char *)this + 56,
                          a2,
                          *((unsigned int *)this + 8),
                          (char *)this + 16) )
