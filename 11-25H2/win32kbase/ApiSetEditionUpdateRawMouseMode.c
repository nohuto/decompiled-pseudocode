/*
 * XREFs of ApiSetEditionUpdateRawMouseMode @ 0x140196E80
 * Callers:
...
__int64 (*__fastcall ApiSetEditionUpdateRawMouseMode(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6896LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 6904LL);
      if ( result )
