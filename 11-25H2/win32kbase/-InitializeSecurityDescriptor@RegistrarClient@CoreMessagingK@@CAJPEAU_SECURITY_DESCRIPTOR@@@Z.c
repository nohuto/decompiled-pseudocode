/*
 * XREFs of ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1400FC680
 * Callers:
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  v2 = 0LL;
  v3 = RtlLengthSid(&unk_140261F70) + 20;
  ...
  if ( Pool2 )
  {
    ...
    if ( Acl >= 0 )
    {
      Acl = RtlAddAccessAllowedAce(v5, 2u, 1u, &unk_140261F70);
      if ( Acl >= 0 )
      {
