/*
 * XREFs of ?EmitSetRequestedPositionAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140103F78
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
    ...
    || (*(unsigned __int8 (__fastcall **)(_DWORD *))(*(_QWORD *)v6 + 64LL))(v6) )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v11) )
    {
      ...
      *((_DWORD *)v7 + 3) = 0;
      *((_DWORD *)v7 + 2) = v8;
      v7[16] = (*((_BYTE *)this + 456) & 1) == 0;
      *((_DWORD *)v7 + 6) = *((_DWORD *)this + 36);
      v9 = *((_QWORD *)this + 27);
      if ( v9 )
      {
        v10 = *(_QWORD *)(v9 + 16);
