/*
 * XREFs of McTemplateK0qqqqqqq_EtwWriteTransfer @ 0x14009ACDC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &IdleStatusEvent, &W32kControlGuid, 8u, &v11);
}
