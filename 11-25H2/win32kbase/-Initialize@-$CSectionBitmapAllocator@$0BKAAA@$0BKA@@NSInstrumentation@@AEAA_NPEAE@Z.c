/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0BKAAA@$0BKA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x14011BEF4
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<106496,416>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v10 = _lambda_123fb472502fd0eaa02b2792812379e1_::operator()(v9, 234LL);
  if ( !v10 )
    return 0;
  v11 = v10 ^ a1[2];
  result = 1;
