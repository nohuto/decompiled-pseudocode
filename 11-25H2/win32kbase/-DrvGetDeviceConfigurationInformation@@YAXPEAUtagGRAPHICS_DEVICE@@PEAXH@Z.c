/*
 * XREFs of ?DrvGetDeviceConfigurationInformation@@YAXPEAUtagGRAPHICS_DEVICE@@PEAXH@Z @ 0x14006C574
 * Callers:
 ...
 *     RtlStringLengthWorkerW @ 0x1401CC8E0 (RtlStringLengthWorkerW.c)
...
void __fastcall DrvGetDeviceConfigurationInformation(PVOID Context, WCHAR *Path, int a3)
{
  ...
  if ( !v4 && !*((_DWORD *)Context + 65) )
  {
    ...
    {
      v18 = (_DWORD *)PALLOCNOZ(ResultLength, 1936876615LL);
      if ( v18 )
      {
        v53 = 0;
        ...
        if ( RegistryValues >= 0 )
        {
          ...
          if ( *v18 >> 1 )
          {
            ...
            if ( v22 )
            {
              ...
              v47 = aVideo[6];
              v54 = *(_QWORD *)L"\\Video";
              v17 = (char *)PALLOCNOZ(2 * v22 + 14, 1936876615LL);
              if ( v17 )
              {
        ...
        *(_OWORD *)Src = 0LL;
        ...
        if ( RegistryValues >= 0 )
        {
          ...
          if ( LOWORD(Src[0]) )
          {
            ...
            v54 = *(_QWORD *)L"Class\\";
            v28 = PALLOCNOZ((unsigned int)LOWORD(Src[0]) + 14, 1936876615LL);
            v29 = (WCHAR *)v28;
            if ( v28 )
            {
              *(_QWORD *)v28 = v54;
          ...
          if ( v30 )
          {
            if ( *((_DWORD *)Context + 65) )
            {
              ...
              if ( RegistryValues >= 0 )
              {
                ...
                v33 = (void *)PALLOCNOZ(v32, 1936876615LL);
                v34 = v33;
                if ( v33 )
                {
  ...
  {
    v13 = PALLOCNOZ(10LL, 1936876615LL);
...
LABEL_80:
    ...
    v37 = (void *)PALLOCNOZ(v14, 1936876615LL);
  ...
  {
    GreDeleteFastMutex(*((char **)Context + 26));
    v39 = (void *)PALLOCNOZ(LODWORD(Length[1]), 1936876615LL);
