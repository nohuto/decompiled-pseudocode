/*
 * XREFs of ?RemoveChild@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@PEAV12@PEA_N@Z @ 0x1400D0B80
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( *((DirectComposition::CVisualMarshaler **)a3 + 24) == this )
  {
    ...
    *i = *((_QWORD *)a3 + 23);
    v10 = *(_QWORD *)a3;
    *((_QWORD *)a3 + 23) = 0LL;
    if ( (*(unsigned __int8 (__fastcall **)(struct DirectComposition::CVisualMarshaler *))(v10 + 16))(a3) )
    {
      *((_DWORD *)a3 + 4) |= 8u;
