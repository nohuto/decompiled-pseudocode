/*
 * XREFs of ?GetBaseRustExports@@YAJPEAUBaseRustExportsStorage@@@Z @ 0x1401C88B4
 * Callers:
...
{
  int v2; // edi
  __int64 (__fastcall *SystemRoutineAddress)(_QWORD *, char *); // rbp
  char **v4; // rbx
  char *v5; // rdx
  ...
  *(_QWORD *)&v8.Length = 3670070LL;
  ...
  SystemRoutineAddress = (__int64 (__fastcall *)(_QWORD *, char *))MmGetSystemRoutineAddress(&v8);
  v4 = &off_14025BFD0;
  do
  {
    v5 = *v4;
  ...
  while ( v4 != (char **)&Feature_Capture_BufferCollection__private_requiresFeatures );
  if ( v2 < 0 )
