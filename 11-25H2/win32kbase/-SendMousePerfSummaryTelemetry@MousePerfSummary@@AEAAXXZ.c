/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x14005FD3C
 * Callers:
 ...
 * Callees:
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x14006180C (-Reset@MousePerfSummary@@AEAAXXZ.c)
