/*
 * XREFs of ?SetFloatProperty@CColorMatrixEffectMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x140231DE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        bool *a4)
{
  ...
  {
    v5 = (((_BYTE)a2 + 1) & 3) + 4 * ((unsigned __int64)(unsigned int)(a2 - 7) >> 2);
