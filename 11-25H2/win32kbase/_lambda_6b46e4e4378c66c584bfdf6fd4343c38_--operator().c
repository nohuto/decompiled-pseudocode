/*
 * XREFs of _lambda_6b46e4e4378c66c584bfdf6fd4343c38_::operator() @ 0x1401F9E80
 * Callers:
...
_DWORD *__fastcall lambda_6b46e4e4378c66c584bfdf6fd4343c38_::operator()(__int64 a1, __int64 a2)
{
  unsigned int v3; // edi
  _DWORD *result; // rax
  _DWORD *v5; // rbx
  ...
  if ( result )
  {
    ...
    *((_QWORD *)v5 + 29) = v5 + 60;
    ...
    v5[6] = v9;
    if ( !v9 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 16541);
    if ( !v5[6] )
    {
