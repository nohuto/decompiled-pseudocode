/*
 * XREFs of ?SuppressDeadzoneContactsInFrameAndGetNext@CTouchProcessor@@QEAAPEAXPEAXAEBUDEVICE_OUTPUT_CONFIG@@AEBUtagPOINTER_INFO@@@Z @ 0x14020BE80
 * Callers:
    ...
    for ( i = 0; i < *((_DWORD *)a2 + 12); ++i )
    {
      ...
      if ( (unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v10) )
      {
        if ( *(_DWORD *)(v10 + 168) != v11 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13564);
