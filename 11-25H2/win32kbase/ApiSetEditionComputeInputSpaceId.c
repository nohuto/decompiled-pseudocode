/*
 * XREFs of ApiSetEditionComputeInputSpaceId @ 0x1400C5E78
 * Callers:
...
__int64 __fastcall ApiSetEditionComputeInputSpaceId(__int64 a1, __int64 a2)
{
  ...
  v2 = a1;
  v3 = 0LL;
  v4 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6056LL);
  if ( v4 )
  {
    if ( v4() >= 0 )
    {
      v7 = *(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 6064LL);
      if ( v7 )
        return v7(v2);
    }
  }
