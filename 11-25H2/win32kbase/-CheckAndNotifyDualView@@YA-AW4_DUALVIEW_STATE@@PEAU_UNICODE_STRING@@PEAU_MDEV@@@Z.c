/*
 * XREFs of ?CheckAndNotifyDualView@@YA?AW4_DUALVIEW_STATE@@PEAU_UNICODE_STRING@@PEAU_MDEV@@@Z @ 0x1401189AC
 * Callers:
...
__int64 __fastcall CheckAndNotifyDualView(const UNICODE_STRING *a1, __int64 a2)
{
  ...
  if ( !v14 )
    return 0LL;
  v17 = PALLOCMEM((unsigned int)(16 * v14), 1936876615LL);
  if ( !v17 )
    return 3LL;
  v18 = *(_QWORD *)(v7 + 1096);
  v19 = 0;
...
LABEL_10:
    ...
    v20 = *(_DWORD *)(v7 + 1128) ? -1 : *(_WORD *)(W32GetUserSessionState(v16, v15) + 68752);
