/*
 * XREFs of ?EmitCommands@CMilCommandBatchParser@CApplicationChannel@DirectComposition@@QEAA_NPEAPEAVCBatch@3@@Z @ 0x14002432C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  __int64 v7; // r10
  struct DirectComposition::CBatch *v8; // r9
  __int64 v9; // rdx
