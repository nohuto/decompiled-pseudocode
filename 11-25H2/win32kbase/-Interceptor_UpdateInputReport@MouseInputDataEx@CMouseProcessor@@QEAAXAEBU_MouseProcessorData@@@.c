/*
 * XREFs of ?Interceptor_UpdateInputReport@MouseInputDataEx@CMouseProcessor@@QEAAXAEBU_MouseProcessorData@@@Z @ 0x140221018
 * Callers:
        ...
        const struct _MouseProcessorData *a2)
{
  ...
  if ( *(_WORD *)this == 0xFFFF )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2456);
  if ( (*((_BYTE *)this + 2) & 1) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2459);
  if ( CMouseProcessor::MouseInputDataEx::TestProcessingOption((__int64)this, 0x8000) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2462);
  if ( (*((_BYTE *)a2 + 12) & 1) != 0 )
  {
    v4 = *((_WORD *)this + 1) | 1;
    ...
    *((_DWORD *)this + 4) = v5;
    ...
    if ( CMouseProcessor::MouseInputDataEx::TestProcessingOption((__int64)this, 4) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2480);
    *((_DWORD *)this + 18) &= ~8u;
