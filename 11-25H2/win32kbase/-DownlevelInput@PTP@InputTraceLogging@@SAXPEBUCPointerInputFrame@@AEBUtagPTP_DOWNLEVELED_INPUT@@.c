/*
 * XREFs of ?DownlevelInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@_K@Z @ 0x14013EA64
 * Callers:
 ...
 *     ?PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z @ 0x1402114F4 (-PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z.c)
 */
        ...
        __int64 a3)
{
  ...
  if ( *(_DWORD *)a2 && v3 != 1 )
  {
    if ( v3 == 2 && (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, 128LL) )
    {
      v18 = *((_DWORD *)a2 + 1);
      v14 = v6;
