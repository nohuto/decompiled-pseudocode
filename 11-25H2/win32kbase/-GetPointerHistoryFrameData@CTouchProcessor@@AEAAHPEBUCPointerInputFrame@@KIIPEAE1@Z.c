/*
 * XREFs of ?GetPointerHistoryFrameData@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@KIIPEAE1@Z @ 0x1402032E8
 * Callers:
        ...
        struct tagPOINTER_INFO *a7)
{
  ...
  {
    v20 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14183);
  }
  ...
  {
    v20 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14195);
  }
  if ( v7 * (_DWORD)PointerInfoSize != a5 )
  {
    v20 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14196);
  }
  v13 = 0;
  while ( v12 && v10 < v7 )
  {
    ...
    v15 = *v14;
    if ( !*v14 || HIWORD(v15) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14225);
    v13 = v20;
