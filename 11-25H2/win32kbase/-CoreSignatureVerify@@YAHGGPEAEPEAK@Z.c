/*
 * XREFs of ?CoreSignatureVerify@@YAHGGPEAEPEAK@Z @ 0x1400B0714
 * Callers:
...
__int64 __fastcall CoreSignatureVerify(__int16 a1, __int16 a2, unsigned __int8 *a3, unsigned int *a4)
{
