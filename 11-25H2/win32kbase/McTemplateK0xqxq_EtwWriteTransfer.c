/*
 * XREFs of McTemplateK0xqxq_EtwWriteTransfer @ 0x1400F3B04
 * Callers:
 *     EtwPhysicalSurfCreateEvent @ 0x1400F3AD0 (EtwPhysicalSurfCreateEvent.c)
 * Callees:
...
NTSTATUS McTemplateK0xqxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(a1, &PhysicalSurfCreateEvent, &W32kControlGuid, 5u, &v4);
}
