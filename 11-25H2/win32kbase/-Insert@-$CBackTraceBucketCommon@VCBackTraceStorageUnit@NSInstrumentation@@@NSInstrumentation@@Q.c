/*
 * XREFs of ?Insert@?$CBackTraceBucketCommon@VCBackTraceStorageUnit@NSInstrumentation@@@NSInstrumentation@@QEAAPEAVCBackTraceStorageUnit@2@_KQEBVCBackTrace@2@@Z @ 0x1401D3830
 * Callers:
 ...
 * Callees:
 *     ?Create@?$CBackTraceStorageUnitBaseT@VCBackTraceStorageUnit@NSInstrumentation@@@NSInstrumentation@@SAPEAVCBackTraceStorageUnit@2@_KQEBVCBackTrace@2@PEAV32@@Z @ 0x1401D32A4 (-Create@-$CBackTraceStorageUnitBaseT@VCBackTraceStorageUnit@NSInstrumentation@@@NSInstrumentatio.c)
