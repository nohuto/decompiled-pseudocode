/*
 * XREFs of ?NotifyAdaptersChanged@CSynchronizationManager@DirectComposition@@QEAA_NPEBUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x140128D14
 * Callers:
 *     DCompositionNotifyAdaptersChanged @ 0x140128CC0 (DCompositionNotifyAdaptersChanged.c)
 * Callees:
