/*
 * XREFs of McTemplateK0qqq_EtwWriteTransfer @ 0x1400E5334
 * Callers:
 *     EtwTraceGreMovePointerBegin @ 0x1400E52C0 (EtwTraceGreMovePointerBegin.c)
 *     EtwTraceGreMovePointerEnd @ 0x1400E5300 (EtwTraceGreMovePointerEnd.c)
 ...
 *     ?ReportGetAsyncKeyStateAnomaly@CAsyncKeyEventMonitor@@AEAAXK@Z @ 0x1400ECF08 (-ReportGetAsyncKeyStateAnomaly@CAsyncKeyEventMonitor@@AEAAXK@Z.c)
 ...
 *     EtwTraceBeginPointerFrameBuildPartial @ 0x1401B7A00 (EtwTraceBeginPointerFrameBuildPartial.c)
 *     EtwTraceBeginPointerFrameCreation @ 0x1401B7A30 (EtwTraceBeginPointerFrameCreation.c)
 *     EtwTraceCursorSize @ 0x1401B7AD0 (EtwTraceCursorSize.c)
 *     EtwTraceEndPointerFrameBuildPartial @ 0x1401B7CF0 (EtwTraceEndPointerFrameBuildPartial.c)
 * Callees:
