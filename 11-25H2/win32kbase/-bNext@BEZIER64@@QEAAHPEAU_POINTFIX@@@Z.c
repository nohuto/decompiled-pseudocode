/*
 * XREFs of ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1401432D0
 * Callers:
 *     pprFlattenRec @ 0x1400D5820 (pprFlattenRec.c)
 * Callees:
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1400D611C (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?vParentError@HFDBASIS64@@QEBAXPEA_J@Z @ 0x1401438B4 (-vParentError@HFDBASIS64@@QEBAXPEA_J@Z.c)
 *     ?vInit@HFDBASIS64@@QEAAXJJJJ@Z @ 0x140143AC0 (-vInit@HFDBASIS64@@QEAAXJJJJ@Z.c)
 *     ?vUntransform@HFDBASIS64@@QEAAXPEAJ@Z @ 0x140143B38 (-vUntransform@HFDBASIS64@@QEAAXPEAJ@Z.c)
 *     ?bIntersect@@YA_NPEAU_RECTFX@@0@Z @ 0x1401C6D18 (-bIntersect@@YA_NPEAU_RECTFX@@0@Z.c)
 */
