/*
 * XREFs of RIMComputeSpecificHighMetricValue @ 0x1401555B0
 * Callers:
...
__int64 __fastcall RIMComputeSpecificHighMetricValue(int a1, __int64 a2)
{
  ...
  v7 = *(_DWORD *)(a2 + 36) & 0xF;
  if ( (unsigned int)v7 < 5 && (unsigned int)(dword_140272E40[v7] - 1) <= 1 && (unsigned int)v3 < 0xB )
  {
    v8 = RIMComputePower(word_1402695E8[2 * (unsigned int)v3 + 1], a2, v3, 0LL);
    if ( v10 >= 0 )
    {
      v12 = 2540;
      if ( v9 != 1 )
