/*
 * XREFs of ?WaitForTick@CCompClockInfo@DirectComposition@@QEBAJIPEBQEAXPEAT_LARGE_INTEGER@@@Z @ 0x1401977A8
 * Callers:
 *     NtDCompositionWaitForCompositorClock @ 0x1400C8930 (NtDCompositionWaitForCompositorClock.c)
 * Callees:
 *     ?EnsureVBlankEvent@CCompClockInfo@DirectComposition@@AEBA_NXZ @ 0x14022672C (-EnsureVBlankEvent@CCompClockInfo@DirectComposition@@AEBA_NXZ.c)
