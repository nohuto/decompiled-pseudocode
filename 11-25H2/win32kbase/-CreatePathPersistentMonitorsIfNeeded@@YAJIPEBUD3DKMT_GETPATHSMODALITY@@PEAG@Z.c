/*
 * XREFs of ?CreatePathPersistentMonitorsIfNeeded@@YAJIPEBUD3DKMT_GETPATHSMODALITY@@PEAG@Z @ 0x140159DAC
 * Callers:
    ...
    if ( (v8 & 0x1100000000000000LL) != 0x100000000000000LL )
    {
      if ( (v8 & 0x200000000000000LL) != 0 )
      {
        ...
        if ( v5 < 0 )
        {
          ...
          WdLogGlobalForLineNumber = 14325;
      ...
      else
      {
        ...
        if ( (v8 & 0x1000000000000000LL) == 0 )
        {
          ...
          WdLogGlobalForLineNumber = 14306;
          return (unsigned int)-1073741811;
        }
        v13 = 1LL;
        WdLogSingleEntry4(4LL, v10, v9);
        WdLogGlobalForLineNumber = 14298;
      }
    }
  }
  return (unsigned int)v5;
