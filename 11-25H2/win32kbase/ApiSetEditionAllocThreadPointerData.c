/*
 * XREFs of ApiSetEditionAllocThreadPointerData @ 0x140194BC4
 * Callers:
...
__int64 __fastcall ApiSetEditionAllocThreadPointerData(__int64 a1, __int64 a2)
{
  ...
  v2 = 0LL;
  v3 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 6424LL);
  if ( v3 )
  {
    if ( v3() >= 0 )
    {
      v6 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 6432LL);
      if ( v6 )
        return v6();
    }
  }
