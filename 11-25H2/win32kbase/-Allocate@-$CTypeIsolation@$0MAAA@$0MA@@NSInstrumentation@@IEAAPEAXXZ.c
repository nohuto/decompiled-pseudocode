/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0MAAA@$0MA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1400718DC
 * Callers:
...
PVOID __fastcall NSInstrumentation::CTypeIsolation<49152,192>::Allocate(__int64 *a1)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v5 = NSInstrumentation::CSectionEntry<49152,192>::Create();
      v6 = (_QWORD *)v5;
      if ( v5 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<49152,192>::Allocate(*(_QWORD *)(v5 + 32));
        if ( v2 )
        {
