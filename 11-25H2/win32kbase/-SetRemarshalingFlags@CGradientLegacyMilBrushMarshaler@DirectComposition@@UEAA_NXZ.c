/*
 * XREFs of ?SetRemarshalingFlags@CGradientLegacyMilBrushMarshaler@DirectComposition@@UEAA_NXZ @ 0x14022F6CC
 * Callers:
 *     ?SetRemarshalingFlags@CLinearGradientLegacyMilBrushMarshaler@DirectComposition@@UEAA_NXZ @ 0x14022F8A0 (-SetRemarshalingFlags@CLinearGradientLegacyMilBrushMarshaler@DirectComposition@@UEAA_NXZ.c)
 * Callees:
