/*
 * XREFs of DrvNeedToSwitchAdapterForRemoteSession @ 0x14015AF4C
 * Callers:
 ...
 * Callees:
 *     ?DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z @ 0x1401CB9F4 (-DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z.c)
