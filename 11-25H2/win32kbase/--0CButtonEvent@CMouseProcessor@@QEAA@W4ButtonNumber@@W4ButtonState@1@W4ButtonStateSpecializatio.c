/*
 * XREFs of ??0CButtonEvent@CMouseProcessor@@QEAA@W4ButtonNumber@@W4ButtonState@1@W4ButtonStateSpecialization@1@PEBVCMouseEvent@1@@Z @ 0x14018EEA0
 * Callers:
...
__int64 __fastcall CMouseProcessor::CButtonEvent::CButtonEvent(__int64 a1, __int64 a2, int a3, int a4, __int64 a5)
{
  ...
  *(_DWORD *)(a1 + 16) = 2;
  if ( !(_DWORD)a2 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7712LL);
  if ( ((*(_DWORD *)(a1 + 24) - 1) & *(_DWORD *)(a1 + 24)) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7715LL);
  v7 = *(_DWORD *)(a1 + 32);
  if ( v7 != 2 && v7 != 1 )
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 8) + 120LL) & 0x400) == 0 )
  {
    ...
    if ( anonymous_namespace_::IsMouseButtonSwapped(*(unsigned int *)(a1 + 24), a2) )
      *(_DWORD *)(a1 + 24) ^= 3u;
  }
  if ( *(_QWORD *)(a1 + 40) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7724LL);
  switch ( *(_DWORD *)(a1 + 24) )
  {
    case 1:
...
LABEL_24:
  ...
  MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7754LL);
  return a1;
}
