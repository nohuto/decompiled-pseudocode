/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x140125534
 * Callers:
 ...
 *     ?PointerInjectionType@InputTraceLogging@@CAPEBDW4tagPOINTER_INJECTION_TYPE@@@Z @ 0x1400799C4 (-PointerInjectionType@InputTraceLogging@@CAPEBDW4tagPOINTER_INJECTION_TYPE@@@Z.c)
 *     _tlgKeywordOn @ 0x14009E9B0 (_tlgKeywordOn.c)
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1401E7768 (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1)
{
  ...
  if ( v1 == 2 )
  {
    ...
    if ( (v1 & 0x80u) == 0 )
    {
      ...
      {
        LOBYTE(v1) = tlgKeywordOn((__int64)&dword_14029EE20, 256LL);
        if ( (_BYTE)v1 )
        {
          v14 = *(_QWORD *)(v12 + 448);
  ...
  {
    if ( v1 == 1 && (unsigned int)dword_14029EE20 > 4 )
    {
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_14029EE20, 256LL);
      if ( (_BYTE)v1 )
      {
