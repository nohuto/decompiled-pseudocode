/*
 * XREFs of ?AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUCContactState@@0@Z @ 0x1400EEFA8
 * Callers:
        ...
        const struct CContactState *a3)
{
  ...
  if ( !v14 && !v15 )
    return 0LL;
  v16 = 0.0;
  if ( ndotprod(v12, v13, v14, v15, &v16) && *((double *)this + 369) >= v16 )
    return 1;
  return v3;
}
