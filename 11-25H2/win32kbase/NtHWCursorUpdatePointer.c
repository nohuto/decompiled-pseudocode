/*
 * XREFs of NtHWCursorUpdatePointer @ 0x14017D140
 * Callers:
 *     <none>
 * Callees:
 *     GreDeleteFastMutex @ 0x14001E920 (GreDeleteFastMutex.c)
 *     PALLOCMEM @ 0x14004C634 (PALLOCMEM.c)
 *     Feature_DesktopDWMCursor__private_IsEnabledDeviceUsageNoInline @ 0x1401D0744 (Feature_DesktopDWMCursor__private_IsEnabledDeviceUsageNoInline.c)
...
__int64 __fastcall NtHWCursorUpdatePointer(ULONG64 a1, const void *a2)
{
  ...
  v9 = (char *)PALLOCMEM(v8, 1886221383LL);
  v10 = v9;
  Buffer = v9;
  if ( !v9 )
    return 3221225473LL;
