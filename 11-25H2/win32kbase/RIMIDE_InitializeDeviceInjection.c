/*
 * XREFs of RIMIDE_InitializeDeviceInjection @ 0x1401EBD7C
 * Callers:
        ...
        __int64 *a7)
{
  ...
  struct _HIDP_DEVICE_DESC v16; // [rsp+70h] [rbp-90h] BYREF
  struct _HIDP_DEVICE_DESC DeviceDescription; // [rsp+B0h] [rbp-50h] BYREF
  ...
  {
    v16 = DeviceDescription;
    return (unsigned int)RIMIDECreatePseudoHIDDevice(a1, a2, v10, a6, a5, &v16, 3, 0, v15, 0LL, a7);
  }
  return v12;
}
