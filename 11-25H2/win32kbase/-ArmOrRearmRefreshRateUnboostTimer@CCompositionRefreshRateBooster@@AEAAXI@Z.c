/*
 * XREFs of ?ArmOrRearmRefreshRateUnboostTimer@CCompositionRefreshRateBooster@@AEAAXI@Z @ 0x140192BE4
 * Callers:
        ...
        unsigned int a2)
{
  ...
  if ( (__int64)((unsigned __int64)(1000 * (PerformanceCounter.QuadPart - *((_QWORD *)this + 3))) / gliQpcFreq.QuadPart) >= 10
    || a2 > *((_DWORD *)this + 5) )
  {
    v6 = *(void **)(*(_QWORD *)(((__int64 (__fastcall *)(_QWORD, _QWORD))W32GetUserSessionState)(
