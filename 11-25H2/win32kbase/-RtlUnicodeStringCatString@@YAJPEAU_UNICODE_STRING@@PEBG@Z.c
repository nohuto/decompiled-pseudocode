/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x140120C84
 * Callers:
 *     RIMRegOpenLocalMachineKey @ 0x140120B94 (RIMRegOpenLocalMachineKey.c)
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x140120D18 (RtlWideCharArrayCopyStringWorker.c)
 */
