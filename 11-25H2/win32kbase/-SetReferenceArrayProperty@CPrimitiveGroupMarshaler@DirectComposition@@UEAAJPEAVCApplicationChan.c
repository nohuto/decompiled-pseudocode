/*
 * XREFs of ?SetReferenceArrayProperty@CPrimitiveGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x140020E60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    for ( j = *((_DWORD *)a4[v11] + 9); j < 0xC0; j = dword_140274520[j] )
    {
      if ( j == 41 )
      {
