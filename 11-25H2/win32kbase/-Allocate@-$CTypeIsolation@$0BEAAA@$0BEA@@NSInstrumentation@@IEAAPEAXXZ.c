/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BEAAA@$0BEA@@NSInstrumentation@@IEAAPEAXXZ @ 0x140098750
 * Callers:
...
PVOID __fastcall NSInstrumentation::CTypeIsolation<81920,320>::Allocate(__int64 *a1)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v5 = NSInstrumentation::CSectionEntry<81920,320>::Create();
      v6 = (_QWORD *)v5;
      if ( v5 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<81920,320>::Allocate(*(_QWORD *)(v5 + 32));
        if ( v2 )
        {
    ...
    v4 = NSInstrumentation::CSectionBitmapAllocator<81920,320>::Allocate(i[4]);
    if ( v4 )
      break;
  }
  if ( i == (__int64 *)*a1 )
