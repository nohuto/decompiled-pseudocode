/*
 * XREFs of ?EmitSetContentSizeCommand@CCaptureControllerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140229B1C
 * Callers:
...
char __fastcall DirectComposition::CCaptureControllerMarshaler::EmitSetContentSizeCommand(
