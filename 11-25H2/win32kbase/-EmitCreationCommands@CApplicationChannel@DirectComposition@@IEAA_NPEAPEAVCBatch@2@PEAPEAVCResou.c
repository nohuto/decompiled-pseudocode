/*
 * XREFs of ?EmitCreationCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@PEAPEAVCResourceMarshaler@2@@Z @ 0x1400C6E9C
 * Callers:
  ...
  if ( *a3 )
  {
    do
    {
      ...
      *((_DWORD *)v3 + 4) |= 1u;
      ...
      {
        v8 = *((_DWORD *)v3 + 9);
        for ( i = v8; (unsigned int)i < 0xC0; LODWORD(i) = dword_140274520[i] )
        {
          if ( (_DWORD)i == 157 )
          {
            v10 = 456LL;
