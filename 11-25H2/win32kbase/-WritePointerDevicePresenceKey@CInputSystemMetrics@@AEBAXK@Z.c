/*
 * XREFs of ?WritePointerDevicePresenceKey@CInputSystemMetrics@@AEBAXK@Z @ 0x140223B44
 * Callers:
...
void __fastcall CInputSystemMetrics::WritePointerDevicePresenceKey(CInputSystemMetrics *this, __int64 a2)
{
  NTSTATUS v2; // ebx
  ...
  Data = a2;
  if ( *(_WORD *)(W32GetUserSessionState(this, a2) + 68752) != 0xFFFF )
  {
