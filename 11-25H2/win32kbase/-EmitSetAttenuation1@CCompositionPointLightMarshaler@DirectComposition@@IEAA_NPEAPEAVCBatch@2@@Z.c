/*
 * XREFs of ?EmitSetAttenuation1@CCompositionPointLightMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140239C18
 * Callers:
...
char __fastcall DirectComposition::CCompositionPointLightMarshaler::EmitSetAttenuation1(
