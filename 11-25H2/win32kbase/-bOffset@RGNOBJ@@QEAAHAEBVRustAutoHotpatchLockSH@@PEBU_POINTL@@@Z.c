/*
 * XREFs of ?bOffset@RGNOBJ@@QEAAHAEBVRustAutoHotpatchLockSH@@PEBU_POINTL@@@Z @ 0x1401C4680
 * Callers:
 ...
 *     ?LongLongToLong@@YAJ_JPEAJ@Z @ 0x1400BDD20 (-LongLongToLong@@YAJ_JPEAJ@Z.c)
...
__int64 __fastcall RGNOBJ::bOffset(RGNOBJ *this, const struct RustAutoHotpatchLockSH *a2, const struct _POINTL *a3)
{
  ...
  struct tagRECT v20; // [rsp+20h] [rbp-10h] BYREF

  if ( qword_1402A10B0 )
  {
    v4 = *(_QWORD *)qword_1402A10B0;
    v5 = (const struct REGION_CORE *)((*(_QWORD *)this + 24LL) & -(__int64)(*(_QWORD *)this != 0LL));
    v6 = (*(__int64 (__fastcall **)(const struct REGION_CORE *, const struct _POINTL *))(*(_QWORD *)qword_1402A10B0
                                                                                       + 136LL))(
           v5,
           a3);
