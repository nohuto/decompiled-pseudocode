/*
 * XREFs of Feature_LearningModeSupport__private_IsEnabledFallback @ 0x1401A7220
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, &Feature_LearningModeSupport__private_descriptor);
}
