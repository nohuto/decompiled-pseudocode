/*
 * XREFs of ?MouseHitTest@CMouseProcessor@@AEAA?AVCInputDest@@PEAUtagPOINT@@PEBU_SUBPIXELS@@AEBVCMouseEvent@1@W4MouseHitTestOptions@@PEAI@Z @ 0x140037658
 * Callers:
 ...
 *     ?GetHitTestContext@CMouseEvent@CMouseProcessor@@QEBAKXZ @ 0x1400F1364 (-GetHitTestContext@CMouseEvent@CMouseProcessor@@QEBAKXZ.c)
        ...
        unsigned int *a7)
{
  ...
  if ( (a6 & 1) != 0 )
  {
    ...
    if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 3896), 1, 1) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6520LL);
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 24) = 4LL;
    if ( a6 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6538LL);
    if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 3896), 1, 1) )
    {
      v39 = 512;
    }
