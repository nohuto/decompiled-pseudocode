/*
 * XREFs of ?EmitSetMinAttenuationCutoff@CCompositionPointLightMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140239F04
 * Callers:
...
char __fastcall DirectComposition::CCompositionPointLightMarshaler::EmitSetMinAttenuationCutoff(
