/*
 * XREFs of ?Protect@ThreadRestrictNewHandlesRegion@@SA_NPEAU_GRETHREAD@@PEAX@Z @ 0x1401C5120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InRegion@ThreadRestrictNewHandlesRegion@@QEAA_NI@Z @ 0x1400D0078 (-InRegion@ThreadRestrictNewHandlesRegion@@QEAA_NI@Z.c)
