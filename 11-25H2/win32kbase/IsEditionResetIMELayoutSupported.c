/*
 * XREFs of IsEditionResetIMELayoutSupported @ 0x14015D5DC
 * Callers:
...
__int64 __fastcall IsEditionResetIMELayoutSupported(__int64 a1, __int64 a2)
{
  __int64 (*v2)(void); // rax

  v2 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5496LL);
  if ( v2 )
    return v2();
  else
    return 3221225659LL;
