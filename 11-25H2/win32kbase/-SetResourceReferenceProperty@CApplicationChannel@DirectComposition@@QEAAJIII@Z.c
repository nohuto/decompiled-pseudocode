/*
 * XREFs of ?SetResourceReferenceProperty@CApplicationChannel@DirectComposition@@QEAAJIII@Z @ 0x140021F60
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( v9 )
  {
    if ( !a4 || (v8 = DirectComposition::CApplicationChannel::LookupResourceMarshaler(this, a4)) != 0LL )
    {
      v15 = *(_QWORD *)v9;
      v20[0] = 0;
      v11 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, struct DirectComposition::CResourceMarshaler *, _BYTE *))(v15 + 280))(
              v9,
              this,
              a3,
              v8,
      ...
      if ( v11 >= 0 )
      {
        if ( v20[0] )
        {
          ...
          if ( (v16 & 2) == 0 )
          {
            ...
            {
              v17 = *((_DWORD *)v9 + 9);
              for ( i = v17; (unsigned int)i < 0xC0; LODWORD(i) = dword_140274520[i] )
              {
                if ( (_DWORD)i == 157 )
                {
                  v19 = 456LL;
...
LABEL_25:
  ...
  {
    v13 = *((_DWORD *)v9 + 9);
    for ( j = v13; (unsigned int)j < 0xC0; LODWORD(j) = dword_140274520[j] )
    {
      if ( (_DWORD)j == 117 )
      {
