/*
 * XREFs of McTemplateK0qqsp_EtwWriteTransfer @ 0x14003DE10
 * Callers:
...
__int64 __fastcall McTemplateK0qqsp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  __int64 v8; // rax
  int v9; // eax
  _BYTE v11[16]; // [rsp+30h] [rbp-21h] BYREF
  ...
  if ( !a6 )
    v7 = "NULL";
  v16 = v7;
  return McGenEventWrite_EtwWriteTransfer(v7, &QueueNullPostMessage, &W32kControlGuid, 5LL, v11);
}
