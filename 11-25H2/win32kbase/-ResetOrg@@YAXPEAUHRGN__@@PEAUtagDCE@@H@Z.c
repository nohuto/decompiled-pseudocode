/*
 * XREFs of ?ResetOrg@@YAXPEAUHRGN__@@PEAUtagDCE@@H@Z @ 0x14008AA94
 * Callers:
...
void __fastcall ResetOrg(HRGN a1, struct tagDCE *a2, int a3)
{
  ...
  {
    v33 = *(_QWORD *)(W32GetUserSessionState(v7, a2) + 56968);
...
LABEL_72:
              ...
              if ( qword_1402A10B0 )
              {
                v29 = (char *)qword_1402A10B0 + 8;
                v30 = ((unsigned __int64)v62[0] + 24) & -(__int64)(v62[0] != 0LL);
                KeEnterCriticalRegion();
                ExAcquirePushLockSharedEx((char *)v28 + 8, 2LL);
                v31 = *(_QWORD *)v28;
