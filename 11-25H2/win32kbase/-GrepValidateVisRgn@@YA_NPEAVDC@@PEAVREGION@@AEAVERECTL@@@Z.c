/*
 * XREFs of ?GrepValidateVisRgn@@YA_NPEAVDC@@PEAVREGION@@AEAVERECTL@@@Z @ 0x1401D07C0
 * Callers:
 ...
 *     ?vOrder@ERECTL@@QEAAXXZ @ 0x1400BDC20 (-vOrder@ERECTL@@QEAAXXZ.c)
 *     ?bInFullScreen@DC@@QEBAHXZ @ 0x1400D0F38 (-bInFullScreen@DC@@QEBAHXZ.c)
 *     ?bEmpty@ERECTL@@QEBAHXZ @ 0x1400D0F58 (-bEmpty@ERECTL@@QEBAHXZ.c)
 *     ??XERECTL@@QEAAAEAV0@AEBU_RECTL@@@Z @ 0x1400EB2F4 (--XERECTL@@QEAAAEAV0@AEBU_RECTL@@@Z.c)
 *     ?bEqual@ERECTL@@QEBAHAEBV1@@Z @ 0x1400EDCE4 (-bEqual@ERECTL@@QEBAHAEBV1@@Z.c)
