/*
 * XREFs of McTemplateK0qxxq_EtwWriteTransfer @ 0x1401B9568
 * Callers:
 *     EtwTraceFlipManagerWaitForFrameFlipAway @ 0x1401B82F0 (EtwTraceFlipManagerWaitForFrameFlipAway.c)
 *     EtwTraceFlipManagerWaitForFrameRenderingComplete @ 0x1401B8330 (EtwTraceFlipManagerWaitForFrameRenderingComplete.c)
 * Callees:
