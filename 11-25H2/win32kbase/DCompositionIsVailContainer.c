/*
 * XREFs of DCompositionIsVailContainer @ 0x1402265EC
 * Callers:
 *     ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x140235A00 (-CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEA.c)
...
__int64 DCompositionIsVailContainer()
{
  ...
  DCompSessionState = (_BYTE *)W32GetDCompSessionState();
