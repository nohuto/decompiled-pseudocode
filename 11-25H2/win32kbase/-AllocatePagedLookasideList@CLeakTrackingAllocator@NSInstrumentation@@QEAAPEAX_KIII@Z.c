/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x140029598
 * Callers:
 *     ?HmgInitializeLookAsideList@@YAHKKKG@Z @ 0x140029424 (-HmgInitializeLookAsideList@@YAHKKKG@Z.c)
 *     Win32AllocPagedLookasideList @ 0x1400294D0 (Win32AllocPagedLookasideList.c)
