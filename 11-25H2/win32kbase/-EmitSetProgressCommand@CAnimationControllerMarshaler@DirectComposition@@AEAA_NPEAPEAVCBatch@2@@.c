/*
 * XREFs of ?EmitSetProgressCommand@CAnimationControllerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140108B24
 * Callers:
...
char __fastcall DirectComposition::CAnimationControllerMarshaler::EmitSetProgressCommand(
