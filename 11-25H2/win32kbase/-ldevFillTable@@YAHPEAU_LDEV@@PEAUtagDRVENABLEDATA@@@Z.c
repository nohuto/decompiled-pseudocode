/*
 * XREFs of ?ldevFillTable@@YAHPEAU_LDEV@@PEAUtagDRVENABLEDATA@@@Z @ 0x140101FA4
 * Callers:
...
__int64 __fastcall ldevFillTable(struct _LDEV *a1, struct tagDRVENABLEDATA *a2)
{
  ...
  *((_DWORD *)a1 + 16) = iDriverVersion;
  ...
  while ( 1 )
  {
    ...
    if ( !v7 )
      break;
    if ( !*((_QWORD *)a1 + (unsigned int)dword_1402711C0[v6] + 9) )
      return 0LL;
  }
  LODWORD(v8) = 2;
  if ( *((_DWORD *)a1 + 8) != 6 )
  ...
  while ( 1 )
  {
    ...
    if ( !v12 )
      break;
    if ( !*((_QWORD *)a1 + (unsigned int)dword_140271190[v11] + 9) )
      return 0LL;
  }
LABEL_7:
  while ( 1 )
  {
    ...
    if ( !v9 )
      break;
    if ( (*((_QWORD *)a1 + (unsigned int)dword_1402711B0[2 * v8] + 9) == 0LL) != (*((_QWORD *)a1
                                                                                  + (unsigned int)dword_1402711B4[2 * v8]
                                                                                  + 9) == 0LL) )
      return 0LL;
  }
  return 1LL;
