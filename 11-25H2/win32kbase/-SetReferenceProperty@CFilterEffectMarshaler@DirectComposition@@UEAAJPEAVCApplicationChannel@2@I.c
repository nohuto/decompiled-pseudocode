/*
 * XREFs of ?SetReferenceProperty@CFilterEffectMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1402315B0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( a4
    && !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)a4 + 9), 60)
    && !DirectComposition::CResourceMarshaler::IsDerivedResourceType(v10, 41) )
  {
