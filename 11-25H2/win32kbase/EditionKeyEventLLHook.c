/*
 * XREFs of EditionKeyEventLLHook @ 0x140110A20
 * Callers:
        ...
        __int64 a12)
{
  ...
  v14 = a2;
  v16 = *(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, char, __int16, int, int, int, __int64, int, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5760LL);
  if ( v16 )
