/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0NOAAA@$0NOA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1400745D4
 * Callers:
...
PVOID __fastcall NSInstrumentation::CTypeIsolation<909312,3552>::Allocate(__int64 *a1)
{
  __int64 v2; // rbp
  __int64 *i; // rsi
  __int64 v4; // r14
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v5 = NSInstrumentation::CSectionEntry<909312,3552>::Create();
      v6 = (_QWORD *)v5;
      if ( v5 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<909312,3552>::Allocate(*(_QWORD *)(v5 + 32));
        if ( v2 )
        {
