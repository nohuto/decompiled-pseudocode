/*
 * XREFs of ?SetBrushPropertyHelper@CBrushMarshaler@DirectComposition@@IEAAJPEAVCApplicationChannel@2@PEAPEAV12@PEAVCResourceMarshaler@2@W4MIL_RESOURCE_TYPE@@KPEA_N@Z @ 0x14005A074
 * Callers:
 ...
 *     ?SetReferenceProperty@CNineGridBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x140059E60 (-SetReferenceProperty@CNineGridBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@.c)
        ...
        _BYTE *a7)
{
  ...
  if ( a4 )
  {
    for ( i = a4[9]; (unsigned int)i < 0xC0; LODWORD(i) = dword_140274520[i] )
    {
      if ( (_DWORD)i == 17 )
        goto LABEL_8;
    }
    ...
    *(_DWORD *)(v13 + 64) = 0;
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        v20 = 0LL;
        if ( v15
          || !(*(unsigned __int8 (__fastcall **)(unsigned int *, __int64, __int64 *))(*(_QWORD *)v14 + 320LL))(
                v14,
                v17,
                &v20) )
        {
