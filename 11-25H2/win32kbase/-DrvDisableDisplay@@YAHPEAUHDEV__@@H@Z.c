/*
 * XREFs of ?DrvDisableDisplay@@YAHPEAUHDEV__@@H@Z @ 0x140071E64
 * Callers:
...
__int64 __fastcall DrvDisableDisplay(HDEV a1, int a2)
{
  ...
  WdLogGlobalForLineNumber = 19882;
  GreSuspendDirectDraw(a1);
  v43 = *(_QWORD *)v4 + 624LL;
  GreAcquireSemaphoreCommon<1,void (*)(HSEMAPHORE__ *)>(GreAcquireSemaphoreInternal, v43);
  ...
  if ( v6 )
  {
    ...
    if ( (*(_QWORD *)v6 & 0xFFFFFFFFFFFFFFF0uLL) != 0 && (v9 & 0x10) == 0 )
    {
      ...
      while ( v33 < 0x40 );
      if ( v35 > 4 )
        MicrosoftTelemetryAssertTriggeredNoArgsKM(v33, v9, (unsigned int)v35);
    }
    v10 = *((_BYTE *)v7 + 12);
    *((_BYTE *)v7 + 12) = v10 + 1;
    if ( !v10 )
  ...
  SEMOBJ<6>::SEMOBJ<6>(&v39, v4);
  v11 = *(_QWORD *)v4 + 520LL;
  GreAcquireSemaphoreCommon<7,void (*)(HSEMAPHORE__ *)>(GreAcquireSemaphoreInternal, v11);
  v12 = *((_QWORD *)a1 + 6);
  GreAcquireSemaphoreCommon<8,void (*)(HSEMAPHORE__ *)>(GreAcquireSemaphoreInternal, v12);
  SEMOBJ<10>::SEMOBJ<10>(&v38, v4);
  if ( (_DWORD)v2 )
  {
    v13 = 0;
    if ( ((_DWORD)a1[10] & 0x400) == 0 )
    {
      ...
      v45 = v30;
      v46 = v29;
      v31 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable() + 24) + 896LL);
      if ( v31 )
      {
        if ( v31() >= 0 )
        {
  ...
  if ( *(_WORD *)(W32GetUserSessionState(v15, v14) + 68752) == 0xFFFF )
    *((_DWORD *)a1 + 652) = 4;
  ...
  *(_DWORD *)(v4 + 1268) = v8;
  ...
  if ( v38 )
  {
    EtwTraceGreLockReleaseSemaphore((__int64)L"HT", (int)v38);
  ...
  if ( v12 )
    GreReleaseSemaphoreCommon<8,void (*)(HSEMAPHORE__ *)>(GreReleaseSemaphoreSharedInternal, v12);
  if ( v11 )
    GreReleaseSemaphoreCommon<7,void (*)(HSEMAPHORE__ *)>(GreReleaseSemaphoreSharedInternal, v11);
  v24 = (struct _ERESOURCE *)v39;
  if ( v39 )
  {
    EtwTraceGreLockReleaseSemaphore((__int64)L"Sprite", (int)v39);
  ...
  result = v13;
  WdLogGlobalForLineNumber = 20001;
  return result;
}
