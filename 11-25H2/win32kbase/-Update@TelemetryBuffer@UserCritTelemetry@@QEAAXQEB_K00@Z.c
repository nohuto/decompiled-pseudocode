/*
 * XREFs of ?Update@TelemetryBuffer@UserCritTelemetry@@QEAAXQEB_K00@Z @ 0x1401C2ED0
 * Callers:
 ...
 *     ?ShouldBuffer@TelemetryBuffer@UserCritTelemetry@@CA_NW4BucketType@2@QEB_K1@Z @ 0x1401C2E98 (-ShouldBuffer@TelemetryBuffer@UserCritTelemetry@@CA_NW4BucketType@2@QEB_K1@Z.c)
 *     ?UpdateCurrentSlot@TelemetryBuffer@UserCritTelemetry@@AEAAXW4BucketType@2@QEB_K11@Z @ 0x1401C3314 (-UpdateCurrentSlot@TelemetryBuffer@UserCritTelemetry@@AEAAXW4BucketType@2@QEB_K11@Z.c)
        ...
        const unsigned __int64 *a4)
{
  ...
  {
    if ( (unsigned int)dword_14029EF38 > 5 && tlgKeywordOn((__int64)&dword_14029EF38, 0x402000000000LL) )
    {
      v8 = *((_QWORD *)this + 546);
  ...
  if ( (unsigned int)dword_14029EF38 > 5 && tlgKeywordOn((__int64)&dword_14029EF38, 0x2000000000LL) )
  {
