/*
 * XREFs of ?GenerateDepartureMessage@CTouchProcessor@@IEAAXPEBUCPointerInputFrame@@K_KKHH@Z @ 0x1401876C8
 * Callers:
        ...
        int a7)
{
  ...
  int v20; // edx
  void *v21; // r8
  _BYTE v22[113]; // [rsp+50h] [rbp-A8h] BYREF
  int v23; // [rsp+C1h] [rbp-37h]
  __int16 v24; // [rsp+C5h] [rbp-33h]
  char v25; // [rsp+C7h] [rbp-31h]
  ...
  if ( (_BYTE)a2 || v12 )
  {
    v21 = &WPP_5b7ffc6749e23cc7ef8b8ac6df240892_Traceguids;
    LOBYTE(v21) = v12;
    WPP_RECORDER_AND_TRACE_SF_(
      *((_QWORD *)WPP_GLOBAL_Control + 3),
      (_DWORD)a2,
