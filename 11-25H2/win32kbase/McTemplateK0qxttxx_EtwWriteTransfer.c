/*
 * XREFs of McTemplateK0qxttxx_EtwWriteTransfer @ 0x1401306DC
 * Callers:
 *     EtwTraceFlipManagerPresentIFlipCompleted @ 0x140130690 (EtwTraceFlipManagerPresentIFlipCompleted.c)
 * Callees:
