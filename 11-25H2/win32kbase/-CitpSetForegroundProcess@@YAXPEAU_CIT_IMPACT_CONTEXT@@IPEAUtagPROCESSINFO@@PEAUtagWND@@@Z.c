/*
 * XREFs of ?CitpSetForegroundProcess@@YAXPEAU_CIT_IMPACT_CONTEXT@@IPEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x14007BDA0
 * Callers:
 ...
 *     ?CitpInteractionSummariesCheckPeriodAndFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x14007C2FC (-CitpInteractionSummariesCheckPeriodAndFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z.c)
 *     ?CitpInputTimesAddTo@@YAXPEAU_CIT_INPUT_TIMES@@PEBU1@@Z @ 0x14007C34C (-CitpInputTimesAddTo@@YAXPEAU_CIT_INPUT_TIMES@@PEBU1@@Z.c)
 *     ?CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEBA?AU1@AEBU1@@Z @ 0x14007C438 (-CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEBA-AU1@AEBU1@@Z.c)
 *     ?CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z @ 0x14007C4F4 (-CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z.c)
 ...
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1402403FC (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
        ...
        struct tagWND *a4)
{
  ...
  {
    v7 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 18912);
    CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 204), v5);
    v8 = *(_QWORD *)((char *)a1 + 220);
    v49 = v8;
    CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 228), v5);
    v9 = *((_QWORD *)a1 + 15);
      ...
      && (qword_14029EF50 & 0x800000000800LL) == qword_14029EF50 )
    {
        ...
        if ( v37 )
        {
          ...
          *((_DWORD *)v37 + 20) = v40;
          ...
          if ( (unsigned int)v45 >= v44 )
            v43 = v45;
          *((_DWORD *)v38 + 21) = v43;
          UserSessionState = W32GetUserSessionState(v45, v41);
          CitpProgDataNotifyUseUpdate(
            *(struct _CIT_IMPACT_CONTEXT **)(*(_QWORD *)(UserSessionState + 18912) + 32LL),
            v38);
        }
        v11 = v47;
        v12 = v48[0];
      ...
      if ( (*(_DWORD *)(v7 + 12) & 1) != 0 )
      {
        ...
        CitpInteractionSummariesCheckPeriodAndFlush(a1, v5);
      }
    }
    if ( v4 )
    {
