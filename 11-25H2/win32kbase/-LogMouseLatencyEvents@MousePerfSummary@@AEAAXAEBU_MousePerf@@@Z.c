/*
 * XREFs of ?LogMouseLatencyEvents@MousePerfSummary@@AEAAXAEBU_MousePerf@@@Z @ 0x14005F890
 * Callers:
...
void __fastcall MousePerfSummary::LogMouseLatencyEvents(MousePerfSummary *this, const struct _MousePerf *a2)
{
  ...
  if ( (unsigned int)dword_14029EE58 > 5 )
  {
    v5 = qword_14029EE68;
    v6 = qword_14029EE70;
    if ( (qword_14029EE68 & 0x10) != 0 && (qword_14029EE70 & 0x10) == qword_14029EE70 )
    {
      v22 = *((_QWORD *)a2 + 8);
      v23 = *((_QWORD *)a2 + 7);
      v24 = *((_QWORD *)a2 + 4);
      ...
      *(_DWORD *)&EventDescriptor.Level = 5;
      UserData.Ptr = (ULONGLONG)off_14029EE60;
      EventDescriptor.Keyword = 16LL;
      UserData.Size = *(unsigned __int16 *)off_14029EE60;
      v31 = &unk_140282BC0;
      UserData.Reserved = 2;
      v32 = 334;
      v33 = 1;
      EtwWriteTransfer(qword_14029EE78, &EventDescriptor, 0LL, 0LL, 0x12u, &UserData);
      v6 = qword_14029EE70;
      v5 = qword_14029EE68;
      v4 = dword_14029EE58;
    }
