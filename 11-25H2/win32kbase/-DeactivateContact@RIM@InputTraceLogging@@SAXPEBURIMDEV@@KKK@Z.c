/*
 * XREFs of ?DeactivateContact@RIM@InputTraceLogging@@SAXPEBURIMDEV@@KKK@Z @ 0x1401A173C
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeactivateContact(const struct RIMDEV *a1)
{
  __int64 v1; // r8
  __int64 v2; // r9
  int v3; // r10d
