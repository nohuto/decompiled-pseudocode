/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1401456C4
 * Callers:
 ...
 *     _tlgCreate1Sz_char @ 0x140142508 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x140147430 (TakeTelemetryAssertsLock.c)
 *     GetImageTuple @ 0x14014EE6C (GetImageTuple.c)
...
LABEL_55:
    ...
    if ( v42 )
    {
      if ( (unsigned int)dword_1402C8078 > 5 && tlgKeywordOn((__int64)&dword_1402C8078, 0x400000000000LL) )
      {
        v44 = v25;
        v117 = &v44;
        v26 = "<unknown>";
        ...
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C8078, byte_1402845B7, 0LL, 0LL, 0xEu, &v116);
      }
    }
    else if ( (unsigned int)dword_1402C8078 > 5 && tlgKeywordOn((__int64)&dword_1402C8078, 0x400000000000LL) )
    {
      v53 = v31;
      v142 = &v53;
      v32 = "<unknown>";
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C8078, byte_14028454A, 0LL, 0LL, 0xBu, &v141);
    }
    if ( dword_1402C8040 && !v60 && !KeGetCurrentIrql() )
    {
      ...
      if ( v42 )
      {
        if ( (unsigned int)dword_1402C8078 > 5 && tlgKeywordOn((__int64)&dword_1402C8078, 0x400000000000LL) )
        {
          ...
          v97 = 4LL;
          v99 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C8078, byte_1402844A4, v36, 0LL, 0xDu, &v79);
        }
      }
      else if ( (unsigned int)dword_1402C8078 > 5 && tlgKeywordOn((__int64)&dword_1402C8078, 0x400000000000LL) )
      {
        ...
        v76 = v35;
        v115 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1402C8078, byte_140284661, v37, 0LL, 0xAu, &v100);
      }
