/*
 * XREFs of ?FindPointerInFrame@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@IPEAK@Z @ 0x1401FF634
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( !(unsigned int)CTouchProcessor::CTouchProcessorLockShared(this) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14278);
  if ( *a4 >= *((_DWORD *)a2 + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14279);
  v7 = *a4;
  v8 = *((_DWORD *)a2 + 12);
...
LABEL_9:
    if ( !v9 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14299);
  }
  else
  {
...
LABEL_17:
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14319);
    v11 = (unsigned int)v7 < *((_DWORD *)a2 + 12);
  }
