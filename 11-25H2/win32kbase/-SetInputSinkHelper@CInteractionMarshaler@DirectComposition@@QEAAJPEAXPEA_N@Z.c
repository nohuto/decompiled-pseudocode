/*
 * XREFs of ?SetInputSinkHelper@CInteractionMarshaler@DirectComposition@@QEAAJPEAXPEA_N@Z @ 0x140068A1C
 * Callers:
 *     ?SetHandleProperty@CInteractionMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z @ 0x1400689F0 (-SetHandleProperty@CInteractionMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z.c)
...
LABEL_11:
    ...
    v11 = (DirectComposition::CInteractionMarshaler *)*((_QWORD *)Object + 10);
    if ( this != v11 )
    {
      if ( v11 )
      {
    ...
    v4 = 0;
    InputTraceLogging::InputSink::AssociateWithVisual((const struct CompositionInputObject *)v3, this, v8, v9);
LABEL_10:
