/*
 * XREFs of ?MapPointsByVisualIdentifier@InputSink@InputTraceLogging@@SAXPEBU_LUID@@0AEBUtagINPUT_TRANSFORM@@1UVisualPoint@@2@Z @ 0x1401ADE7C
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( (unsigned int)dword_14029EE20 > 5 && tlgKeywordOn((__int64)&dword_14029EE20, 4LL) )
  {
    v46 = v7[15];
    v47 = v7[14];
    v10 = v7[13];
