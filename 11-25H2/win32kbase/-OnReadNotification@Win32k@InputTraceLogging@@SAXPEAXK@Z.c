/*
 * XREFs of ?OnReadNotification@Win32k@InputTraceLogging@@SAXPEAXK@Z @ 0x140079EA0
 * Callers:
...
void __fastcall InputTraceLogging::Win32k::OnReadNotification(void *a1, int a2, int a3, int a4)
{
  ...
  if ( (unsigned int)dword_14029EE20 > 5 && (qword_14029EE30 & 2) != 0 && (qword_14029EE38 & 2) == qword_14029EE38 )
  {
    v4 = a2;
    v5 = a1;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>>(
      (unsigned int)&dword_14029EE20,
      (unsigned int)&unk_140280647,
      a3,
      a4,
      (__int64)&v5,
      (__int64)&v4);
