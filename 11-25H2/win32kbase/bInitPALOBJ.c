/*
 * XREFs of bInitPALOBJ @ 0x1402E8008
 * Callers:
...
LABEL_6:
  ...
  *(_QWORD *)(v2 + 592) = v5;
  v17 = 0;
  v16 = 0LL;
  if ( !(unsigned int)PALMEMOBJ::bCreatePalette((struct OBJECT **)&v16, 1, 0x100u, 0LL, 0, 0, 0, 0x400u) )
  {
    PALMEMOBJ::~PALMEMOBJ((__int64 **)&v16);
    if ( v5 )
  ...
  *(_QWORD *)(v2 + 3784) = v16;
  ...
  v17 = 0;
  v16 = 0LL;
  if ( !(unsigned int)PALMEMOBJ::bCreatePalette((struct OBJECT **)&v16, 1, 2u, &dword_1402701C8, 0, 0, 0, 0x2200u) )
  {
    PALMEMOBJ::~PALMEMOBJ((__int64 **)&v16);
    return 0LL;
  }
  ...
  *(_QWORD *)(v2 + 3792) = v14;
  v19 = 0;
  v18 = 0LL;
  if ( (unsigned int)PALMEMOBJ::bCreatePalette((struct OBJECT **)&v18, 8, 0, 0LL, 0, 0, 0, 0x200u) )
  {
    v15 = v18;
    v18 = 0LL;
    v1 = 1;
