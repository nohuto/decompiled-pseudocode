/*
 * XREFs of ?HmgLockEx2@@YAPEAU_BASEOBJECT@@AEAUSESSION_GLOBALS@Base@Gre@@PEAUHOBJ__@@EW4HandleLockOptions@@@Z @ 0x140017320
 * Callers:
...
__int64 __fastcall HmgLockEx2(__int64 a1, unsigned int a2, char a3, unsigned int a4)
{
  ...
  if ( *((_BYTE *)v41 + 14) == a3 && *((_WORD *)v41 + 6) == v4 )
  {
    if ( (v6 & 2) == 0 || (*((_BYTE *)v41 + 15) & 0x20) != 0 )
    {
      ...
      {
        if ( (v6 & 8) != 0 )
          GrepCaptureLiveMemoryDump(400LL, 56LL, 7LL);
        v7 = 0LL;
      }
      goto LABEL_20;
    }
  ...
  else if ( (v6 & 8) != 0 )
  {
    v40 = 4LL;
LABEL_70:
    GrepCaptureLiveMemoryDump(400LL, 56LL, v40);
  }
LABEL_20:
  v20 = *v8;
  v21 = *(_QWORD *)(v44 + 5672);
