/*
 * XREFs of ?CreateMsgData@PointerMsg@InputTraceLogging@@SAX_K@Z @ 0x140115E70
 * Callers:
...
void __fastcall InputTraceLogging::PointerMsg::CreateMsgData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
