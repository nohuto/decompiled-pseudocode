/*
 * XREFs of ?CitpProgramIdIsEqual@@YAEPEBU_CIT_PROGRAM_ID@@0@Z @ 0x1402406D0
 * Callers:
 *     ?CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x1402402E8 (-CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z.c)
 * Callees:
 *     <none>
 */
