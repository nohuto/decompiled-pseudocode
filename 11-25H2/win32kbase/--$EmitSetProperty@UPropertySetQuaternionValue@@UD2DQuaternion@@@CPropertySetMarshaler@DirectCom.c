/*
 * XREFs of ??$EmitSetProperty@UPropertySetQuaternionValue@@UD2DQuaternion@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x140236C14
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v10 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x2CuLL, &v10);
  v7 = (char *)v10;
  *(_DWORD *)v10 = 44;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
