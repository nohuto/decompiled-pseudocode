/*
 * XREFs of ?ConvertDisplayConfigScalingToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@PEA_N@Z @ 0x140112C34
 * Callers:
        ...
        bool *a3)
{
  ...
  if ( *((_DWORD *)a1 + 28) == 128 )
  {
    if ( (unsigned int)DispBrokerGetCurrentMode((__int64)a1, (__int64)a2) == 3 )
    {
      *v6 = 255;
    }
    else
