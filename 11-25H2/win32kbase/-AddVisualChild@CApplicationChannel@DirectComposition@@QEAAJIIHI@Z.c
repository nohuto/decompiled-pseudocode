/*
 * XREFs of ?AddVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIHI@Z @ 0x1400213E0
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v9 )
  {
    ...
    {
      v11 = (*(__int64 (__fastcall **)(__int64, DirectComposition::CApplicationChannel *, __int64, _QWORD, __int64, _BYTE *))(*(_QWORD *)v10 + 320LL))(
              v10,
              this,
              v18,
              a4,
