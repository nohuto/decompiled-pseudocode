/*
 * XREFs of ?ProcessEnterLeave@CTouchProcessor@@IEAAHPEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1400DF140
 * Callers:
...
LABEL_70:
    ...
    if ( CInputDest::operator==(v63, (__int64)v65) )
    {
      ...
      {
        v32 = W32GetUserSessionState(WPP_GLOBAL_Control, v12);
        LOBYTE(v33) = v31;
        LOBYTE(v34) = v30;
        WPP_RECORDER_AND_TRACE_SF_(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
