/*
 * XREFs of ?EmitSetContentSizeCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400F763C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v5) )
  {
    ...
    *(_QWORD *)(v3 + 12) = *(_QWORD *)((char *)this + 420);
    *((_DWORD *)this + 92) &= ~8u;
    return 1;
  }
  return 0;
