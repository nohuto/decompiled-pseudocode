/*
 * XREFs of ImpRpcAsyncResponseHandler @ 0x140240FF0
 * Callers:
...
__int64 ImpRpcAsyncResponseHandler()
{
  ...
  if ( (unsigned int)ImpCompleteRpc() == -1073610734 )
  {
    if ( (unsigned int)dword_14029F1A0 > 5 )
    {
      ...
      v6 = -1073610734;
      v13 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029F1A0, byte_140284B15, 0LL, 0LL, 4u, v8);
    }
    return 0;
  }
  else
  {
    ...
    if ( (unsigned int)dword_14029F1A0 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029F1A0, byte_140284CD3, 0LL, 0LL, 5u, v8);
    }
  }
