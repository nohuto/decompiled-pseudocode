/*
 * XREFs of ?CleanupInputDestHwndRefsForDesktopThreadExit@CTouchProcessor@@QEAAXXZ @ 0x1401FB860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _lambda_eba40ec2e57c463160aa5102b24468e6_::operator() @ 0x1401FA0C0 (_lambda_eba40ec2e57c463160aa5102b24468e6_--operator().c)
 */
...
void __fastcall CTouchProcessor::CleanupInputDestHwndRefsForDesktopThreadExit(PERESOURCE *this)
{
  ...
  {
    v13 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 17352);
  }
  LOBYTE(v13) = 0;
  v11 = this[8];
  if ( v11 != (PERESOURCE)(this + 8) )
  {
    ...
    {
      v13 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 17362);
    }
  }
