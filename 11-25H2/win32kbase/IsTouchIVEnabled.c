/*
 * XREFs of IsTouchIVEnabled @ 0x14021B7FC
 * Callers:
...
char __fastcall IsTouchIVEnabled(__int64 a1, __int64 a2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  char v4; // bl
  ...
  v4 = 0;
  if ( UseVelocityToEnableIV(a1, a2) || isChildPartition(v3, v2) && *(_BYTE *)(W32GetUserSessionState(v6, v5) + 19362) )
    return 1;
  return v4;
}
