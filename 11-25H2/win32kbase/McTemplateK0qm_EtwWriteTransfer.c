/*
 * XREFs of McTemplateK0qm_EtwWriteTransfer @ 0x1401366F0
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x1401366C0 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1401B8C20 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
