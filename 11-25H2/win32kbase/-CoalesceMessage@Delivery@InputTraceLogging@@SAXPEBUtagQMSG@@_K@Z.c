/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@_K@Z @ 0x1400F2378
 * Callers:
 ...
 *     ?IsMouseInputMessage@InputTraceLogging@@CA_NI@Z @ 0x1400C28DC (-IsMouseInputMessage@InputTraceLogging@@CA_NI@Z.c)
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1, __int64 a2)
{
  ...
  {
    if ( (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, 16LL) )
    {
  ...
  else if ( (unsigned int)(v3 - 256) > 9 )
  {
    if ( InputTraceLogging::IsMouseInputMessage(v2)
      ...
      && tlgKeywordOn((__int64)&dword_14029EE20, 16LL) )
    {
      v18 = *(_QWORD *)(v11 + 144);
      v17 = v12;
      v16 = v10;
  ...
  else if ( (unsigned int)dword_14029EE20 > 4 && tlgKeywordOn((__int64)&dword_14029EE20, 16LL) )
  {
