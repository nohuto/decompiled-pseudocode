/*
 * XREFs of ImpRpcConnect @ 0x140138CE8
 * Callers:
...
__int64 ImpRpcConnect()
{
  ...
  *(_QWORD *)(&Security.Version + 1) = 0LL;
  ...
  Template.ObjectUuid = (UUID)xmmword_140252C24;
  v13[0] = 5;
  v13[2] = 0;
  v13[3] = 3;
  ...
  v5 = v3 <= 0;
  if ( v3 || (v3 = RpcBindingBind(0LL, Binding, &unk_140252C20), LODWORD(v4.Pointer) = v3, v5 = v3 <= 0, v3) )
  {
    if ( !v5 )
