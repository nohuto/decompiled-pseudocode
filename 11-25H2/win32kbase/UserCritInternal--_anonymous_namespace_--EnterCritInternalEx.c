/*
 * XREFs of UserCritInternal::_anonymous_namespace_::EnterCritInternalEx @ 0x1401AC078
 * Callers:
...
__int64 __fastcall UserCritInternal::_anonymous_namespace_::EnterCritInternalEx(
        _QWORD *a1,
        int a2,
        int a3,
