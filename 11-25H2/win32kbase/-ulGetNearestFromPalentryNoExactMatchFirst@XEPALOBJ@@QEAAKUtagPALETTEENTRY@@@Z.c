/*
 * XREFs of ?ulGetNearestFromPalentryNoExactMatchFirst@XEPALOBJ@@QEAAKUtagPALETTEENTRY@@@Z @ 0x140090C20
 * Callers:
...
unsigned int __fastcall XEPALOBJ::ulGetNearestFromPalentryNoExactMatchFirst(XEPALOBJ *this, struct tagPALETTEENTRY a2)
{
  ...
  v8 = (unsigned __int8 *)&unk_14025FFA0;
  if ( !v7 )
  ...
  do
  {
    v12 = v8;
    v13 = v4;
    v14 = word_14025FBA0[*v8 - (unsigned __int64)peRed + 255]
        + word_14025FBA0[v8[1] - (unsigned __int64)a2.peGreen + 255]
        + word_14025FBA0[v8[2] - (unsigned __int64)a2.peBlue + 255];
    if ( v14 < v10 )
    {
      v4 = v8;
      if ( !v14 )
