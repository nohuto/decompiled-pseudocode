/*
 * XREFs of ?KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z @ 0x1400C7BC0
 * Callers:
 ...
 * Callees:
 *     EtwTraceDCompDeferBatchEvent @ 0x1400CCE60 (EtwTraceDCompDeferBatchEvent.c)
...
LABEL_19:
            ...
            if ( (unsigned int)Feature_EffectHash__private_IsEnabledDeviceUsageNoInline() && *((char *)v3 + 32) < 0 )
