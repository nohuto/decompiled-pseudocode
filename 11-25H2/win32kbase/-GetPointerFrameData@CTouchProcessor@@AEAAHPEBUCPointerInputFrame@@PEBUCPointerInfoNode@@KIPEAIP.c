/*
 * XREFs of ?GetPointerFrameData@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEBUCPointerInfoNode@@KIPEAIPEAE@Z @ 0x140203154
 * Callers:
        ...
        struct tagPOINTER_INFO *a7)
{
  ...
  if ( !(unsigned int)CTouchProcessor::CTouchProcessorLockShared(v12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14104);
  v14 = *((_DWORD *)a3 + 2);
  v20 = *((_QWORD *)a3 + 24);
  if ( v14 >= *((_DWORD *)a2 + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14109);
  v15 = *((_QWORD *)a2 + 30);
  v16 = 0;
  while ( 1 )
  {
    ...
    if ( v15 >= *((_QWORD *)a2 + 30) + 480 * v17 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 14121);
