/*
 * XREFs of ?UpdateContactRestingState@CPTPEngine@@AEAAXUtagPOINT@@_KPEAUCContactState@@@Z @ 0x1400EF3B8
 * Callers:
...
LABEL_24:
  ...
  if ( !v8 )
    goto LABEL_24;
LABEL_5:
  if ( 10 * v5 < *((_QWORD *)this + 12) * (unsigned __int64)*((unsigned int *)this + 785) / 0x3E8 )
    return;
  v16 = 0;
  if ( (v7 & 0x400) != 0 )
  {
  ...
  else
  {
    ...
    if ( *((_DWORD *)this + 706) == 2 )
    {
      if ( v12 )
      {
        ...
        if ( a4 != v18
          && (*(_DWORD *)v18 & 0x100) == 0
          && (a2.y >= *((_DWORD *)this + 755) || v4 < *((_QWORD *)v18 + 12))
    ...
    if ( (int)((*(_QWORD *)((char *)a4 + 8 * v19 + 148) - a2.x) * (*(_QWORD *)((char *)a4 + 8 * v19 + 148) - a2.x)
             ...
             * (HIDWORD(*(_QWORD *)((char *)a4 + 8 * v19 + 148)) - y)) <= (unsigned __int64)*((unsigned int *)this + 784) )
      v20 = 1;
  }
  v14 = v20 != 0;
LABEL_16:
