/*
 * XREFs of ?IsOurKey@CPTPProcessor@@CA_NE_N@Z @ 0x140107DF4
 * Callers:
...
char __fastcall CPTPProcessor::IsOurKey(__int64 a1, __int64 a2)
{
  char v2; // di
  ...
  if ( !(_BYTE)a2
    && !_InterlockedCompareExchange64((volatile signed __int64 *)(W32GetUserSessionState(a1, a2) + 3296), 0LL, 0LL) )
  {
    return 0;
  }
