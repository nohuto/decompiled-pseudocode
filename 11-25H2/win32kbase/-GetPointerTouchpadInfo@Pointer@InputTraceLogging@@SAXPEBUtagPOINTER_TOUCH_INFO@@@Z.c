/*
 * XREFs of ?GetPointerTouchpadInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_TOUCH_INFO@@@Z @ 0x140203EC0
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerTouchpadInfo(const struct tagPOINTER_TOUCH_INFO *a1)
{
  _DWORD *v1; // r8
  int v2; // ecx
  const char *v3; // rax
  ...
  if ( (unsigned int)dword_14029EE20 > 5 && tlgKeywordOn((__int64)&dword_14029EE20, 32LL) )
  {
    v2 = v1[22];
    v40 = v1[35];
    v41 = v1[34];
