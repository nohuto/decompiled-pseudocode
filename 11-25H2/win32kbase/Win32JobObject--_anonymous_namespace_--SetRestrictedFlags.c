/*
 * XREFs of Win32JobObject::_anonymous_namespace_::SetRestrictedFlags @ 0x1401AD3F8
 * Callers:
...
_UNKNOWN **__fastcall Win32JobObject::_anonymous_namespace_::SetRestrictedFlags(__int64 a1, char a2)
{
  ...
  if ( a2 != ((*(_DWORD *)(a1 + 12) & 0x2000000) != 0) )
  {
    ...
    if ( v3 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LOBYTE(v8) = v6;
      LOBYTE(v9) = v3;
      WPP_RECORDER_AND_TRACE_SF_Ds(*((_QWORD *)WPP_GLOBAL_Control + 3), v9, v8, *(_QWORD *)(UserSessionState + 69144));
    }
