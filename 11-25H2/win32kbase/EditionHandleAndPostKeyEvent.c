/*
 * XREFs of EditionHandleAndPostKeyEvent @ 0x140110130
 * Callers:
        ...
        __int64 a16)
{
  ...
  v19 = a1;
  v20 = *(__int64 (__fastcall **)(_QWORD, __int64 *, _QWORD, _QWORD, char, int, __int16, __int16, __int16, __int16, __int64, int, __int64, __int64, __int16, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5776LL);
  if ( !v20 )
    return 0LL;
  v21 = *a2;
  v24 = *((_DWORD *)a2 + 2);
