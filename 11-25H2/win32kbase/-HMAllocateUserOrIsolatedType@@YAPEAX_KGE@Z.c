/*
 * XREFs of ?HMAllocateUserOrIsolatedType@@YAPEAX_KGE@Z @ 0x14000B1D4
 * Callers:
...
void *__fastcall HMAllocateUserOrIsolatedType(unsigned __int64 a1, __int16 a2, unsigned __int8 a3)
{
  ...
  if ( (a2 & 0x200) == 0 )
  {
    v4 = (const void *)*((unsigned int *)&unk_140247038 + 6 * a3);
    v5 = W32GetUserSessionState() + 72032;
    v6 = *(_DWORD *)v5;
    if ( !*(_DWORD *)v5 )
      goto LABEL_3;
    if ( v6 == 1 )
    {
      if ( NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(
        ...
        && a1 + 16 >= a1 )
      {
        Pool2 = (_QWORD *)ExAllocatePool2(256LL, a1 + 16, (unsigned int)v4);
        v7 = (__int64)Pool2;
        if ( !Pool2
