/*
 * XREFs of ?PowerEvent@Power@InputTraceLogging@@SAXW4_PSPOWEREVENTTYPE@@_K@Z @ 0x140128C28
 * Callers:
 ...
 *     ?PowerEventTypeToString@InputTraceLogging@@CAPEBDW4_PSPOWEREVENTTYPE@@@Z @ 0x1401B01CC (-PowerEventTypeToString@InputTraceLogging@@CAPEBDW4_PSPOWEREVENTTYPE@@@Z.c)
 */
