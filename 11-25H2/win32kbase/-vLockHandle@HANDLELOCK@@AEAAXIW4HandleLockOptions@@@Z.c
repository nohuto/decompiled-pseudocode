/*
 * XREFs of ?vLockHandle@HANDLELOCK@@AEAAXIW4HandleLockOptions@@@Z @ 0x140018A90
 * Callers:
 ...
 *     ??0HANDLELOCK@@QEAA@PEAVOBJECT@@W4HandleLockOptions@@@Z @ 0x140018A20 (--0HANDLELOCK@@QEAA@PEAVOBJECT@@W4HandleLockOptions@@@Z.c)
 ...
 *     ??0HANDLELOCK@@QEAA@IW4HandleLockOptions@@@Z @ 0x1400E6C10 (--0HANDLELOCK@@QEAA@IW4HandleLockOptions@@@Z.c)
...
LABEL_8:
  ...
  *((_DWORD *)a1 + 2) = 1;
  ...
  if ( v10 >= (unsigned int)v18 + ((*(unsigned __int16 *)(v17 + 2) + 0xFFFF) << 16) )
  {
    *a1 = 0LL;
LABEL_66:
    if ( (a3 & 8) != 0 )
      GrepCaptureLiveMemoryDump(400LL, 56LL, 0LL);
    *((_DWORD *)a1 + 2) = 0;
  ...
  {
    v19 = *(_QWORD *)(v17 + 8LL * (((v10 - (unsigned int)v18) >> 16) + 1) + 8);
    v10 += -65536 * ((v10 - (unsigned int)v18) >> 16) - v18;
  }
  else
  {
    v19 = *(_QWORD *)(v17 + 8);
  ...
  *a1 = v20;
  ...
  if ( (a3 & 1) == 0 )
  {
    ...
    if ( v28 != (v74 & 0xFFFFFFFC) && v28 && (!v69 || v28 != (unsigned int)UMPDGetThreadClientPID(v8, v18)) )
    {
      if ( (a3 & 8) != 0 )
        GrepCaptureLiveMemoryDump(400LL, 56LL, 1LL);
      goto LABEL_44;
    }
  }
  ...
  {
    if ( (a3 & 8) != 0 )
      GrepCaptureLiveMemoryDump(400LL, 56LL, 2LL);
