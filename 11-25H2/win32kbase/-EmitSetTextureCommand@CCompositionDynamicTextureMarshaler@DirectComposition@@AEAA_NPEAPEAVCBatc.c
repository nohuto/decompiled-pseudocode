/*
 * XREFs of ?EmitSetTextureCommand@CCompositionDynamicTextureMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022A5F8
 * Callers:
...
char __fastcall DirectComposition::CCompositionDynamicTextureMarshaler::EmitSetTextureCommand(
