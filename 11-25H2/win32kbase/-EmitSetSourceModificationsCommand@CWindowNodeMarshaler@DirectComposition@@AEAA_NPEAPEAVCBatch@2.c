/*
 * XREFs of ?EmitSetSourceModificationsCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140106A1C
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetSourceModificationsCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 504);
