/*
 * XREFs of ?SetReferenceArrayProperty@CClipGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x140235900
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( a3 == 5 && a4 )
  {
    ...
    {
      if ( !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)a4[i] + 9), 66) )
        return (unsigned int)-1073741811;
    }
    if ( *((_QWORD *)this + 12) )
      (*(void (__fastcall **)(DirectComposition::CClipGroupMarshaler *, struct DirectComposition::CApplicationChannel *))(*(_QWORD *)this + 216LL))(
        this,
        v7);
    *((_DWORD *)this + 26) = a5;
    v11 = 0LL;
