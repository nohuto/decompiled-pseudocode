/*
 * XREFs of ?UnlockWorker@?$Win32RawLockedItemBase@UDISPLAYCONFIG_DEVICE_INFO_HEADER@@$1?Win32FreePool@@YAXPEAX@Z$00$00$00@@AEAAX_N0@Z @ 0x1400A1A98
 * Callers:
        ...
        char a2)
{
  ...
  if ( *(_QWORD *)(BugCheckParameter2 + 16) == -1LL )
  {
    ...
    if ( !a2 )
    {
      CurrentThreadNonPaged = (ULONG_PTR *)W32GetCurrentThreadNonPaged();
