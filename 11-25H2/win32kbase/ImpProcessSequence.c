/*
 * XREFs of ImpProcessSequence @ 0x140088A74
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( v14 < 0 )
  {
    if ( (unsigned int)dword_14029F1A0 > 2 && (unsigned __int8)tlgKeywordOn(&dword_14029F1A0, 0x400000000000LL, 0LL) )
    {
      ...
      v23 = 0x1000000LL;
      v40 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_14029F1A0, byte_14028489A, v16, 0LL, 5u, &UserData);
    }
  }
  else if ( (unsigned int)dword_14029F1A0 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EtwWriteTransfer(qword_14029F1C0, &EventDescriptor, 0LL, 0LL, 0xAu, &UserData);
  }
