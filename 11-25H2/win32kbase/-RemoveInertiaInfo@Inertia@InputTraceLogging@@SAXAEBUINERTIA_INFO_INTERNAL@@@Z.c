/*
 * XREFs of ?RemoveInertiaInfo@Inertia@InputTraceLogging@@SAXAEBUINERTIA_INFO_INTERNAL@@@Z @ 0x140212570
 * Callers:
 ...
 *     ?InertiaSourceToString@InputTraceLogging@@CAPEBDW4INERTIA_SOURCE@@@Z @ 0x1402123EC (-InertiaSourceToString@InputTraceLogging@@CAPEBDW4INERTIA_SOURCE@@@Z.c)
 */
...
void __fastcall InputTraceLogging::Inertia::RemoveInertiaInfo(const struct INERTIA_INFO_INTERNAL *a1)
{
  ...
  const char *v9; // [rsp+60h] [rbp-10h] BYREF
