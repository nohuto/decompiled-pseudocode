/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U2@U1@U?$_tlgWrapSz@D@@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3AEBU?$_tlgWrapperByVal@$03@@43AEBU?$_tlgWrapSz@D@@44@Z @ 0x1400F875C
 * Callers:
        ...
        __int64 a12)
{
  ...
  _BYTE *v32; // [rsp+C0h] [rbp-29h]
  int v33; // [rsp+C8h] [rbp-21h]
  int v34; // [rsp+CCh] [rbp-1Dh]
  __int64 v35; // [rsp+D0h] [rbp-19h]
  __int64 v36; // [rsp+D8h] [rbp-11h]
