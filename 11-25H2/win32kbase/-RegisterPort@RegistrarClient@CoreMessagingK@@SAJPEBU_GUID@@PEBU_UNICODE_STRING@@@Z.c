/*
 * XREFs of ?RegisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@PEBU_UNICODE_STRING@@@Z @ 0x14019B3FC
 * Callers:
 ...
 *     ?TraceRegisterPort@Log@CoreMessagingK@@SAXPEBU_GUID@@PEBGJ@Z @ 0x14019B4F8 (-TraceRegisterPort@Log@CoreMessagingK@@SAXPEBU_GUID@@PEBGJ@Z.c)
        ...
        __int64 a3)
{
  ...
  *(_DWORD *)(UserCoreMessagingSessionState + 32) = 27;
  Buffer = a2->Buffer;
  v12 = *a1;
  v7 = CoreUICallSend((int)&v14, (int)&v13, 1, 1, 14, (__int64)&unk_14025F652, &v12, Buffer, &v11);
  if ( v7 >= 0 )
  {
