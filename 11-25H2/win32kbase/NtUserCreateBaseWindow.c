/*
 * XREFs of NtUserCreateBaseWindow @ 0x1401BC060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserCreateBaseWindow(__int64 a1, __int64 a2, unsigned int a3)
{
  unsigned int v4; // ebp
...
LABEL_19:
  BaseWindowHandle = UserCreateBaseWindowHandle(a1, v4, a3);
