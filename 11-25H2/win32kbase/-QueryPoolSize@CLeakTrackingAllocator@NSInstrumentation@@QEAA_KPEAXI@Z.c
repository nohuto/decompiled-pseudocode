/*
 * XREFs of ?QueryPoolSize@CLeakTrackingAllocator@NSInstrumentation@@QEAA_KPEAXI@Z @ 0x1401D3CF8
 * Callers:
 *     Win32QueryPoolSize @ 0x1401C2AC0 (Win32QueryPoolSize.c)
 * Callees:
 ...
 *     ?LookupCommon@CPointerHashTable@NSInstrumentation@@AEAAPEAUENTRY@12@PEBX@Z @ 0x1400EC950 (-LookupCommon@CPointerHashTable@NSInstrumentation@@AEAAPEAUENTRY@12@PEBX@Z.c)
