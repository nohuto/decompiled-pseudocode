/*
 * XREFs of ApiSetEditionImmActivateLayout @ 0x14019582C
 * Callers:
...
__int64 (*__fastcall ApiSetEditionImmActivateLayout(__int64 a1, __int64 a2))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 5608LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v6, v5) + 48) + 5616LL);
      if ( result )
