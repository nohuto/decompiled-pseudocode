/*
 * XREFs of HMValidateSharedHandle @ 0x14003F620
 * Callers:
...
__int64 __fastcall HMValidateSharedHandle(__int64 a1, __int64 a2)
{
  __int16 v2; // edi^2
  ...
  if ( v3 >= *(_QWORD *)(v4 + 8)
    || (UserSessionState = W32GetUserSessionState(v5, v4),
        ...
        v13 = (__int64 *)(*(_QWORD *)(v12 + 19832) + 40LL * (unsigned int)((v10 - *(_QWORD *)(v12 + 19888)) >> 5)),
        v14 = v2 & 0x7FFF,
        (v2 & 0x7FFF) != *(_WORD *)(v10 + 26))
    && v14 != 0x7FFF
    && (v14 || !PsGetCurrentProcessWow64Process())
    || (*(_BYTE *)(v10 + 25) & 1) != 0
    || *(_BYTE *)(v10 + 24) != 12
    || (result = *v13) == 0 )
  {
