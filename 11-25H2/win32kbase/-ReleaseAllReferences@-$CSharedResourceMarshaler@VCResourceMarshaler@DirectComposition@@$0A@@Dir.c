/*
 * XREFs of ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCResourceMarshaler@DirectComposition@@$0A@@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400F0450
 * Callers:
 *     <none>
 * Callees:
