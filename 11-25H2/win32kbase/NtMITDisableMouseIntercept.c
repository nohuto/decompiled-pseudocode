/*
 * XREFs of NtMITDisableMouseIntercept @ 0x1401BA850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMITDisableMouseIntercept(__int64 a1, __int64 a2)
{
...
LABEL_20:
  ...
  MouseProcessor = anonymous_namespace_::GetMouseProcessor(v11, v10);
  if ( !MouseProcessor || !(unsigned __int8)CMouseProcessor::MouseInterceptState::Disable(MouseProcessor + 3904) )
  {
    v12 = 5023;
    goto LABEL_20;
  }
