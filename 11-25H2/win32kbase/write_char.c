/*
 * XREFs of write_char @ 0x1401A40E8
 * Callers:
 *     _woutput_l @ 0x1401A37DC (_woutput_l.c)
 *     write_multi_char @ 0x1401A413C (write_multi_char.c)
 *     write_string @ 0x1401A4194 (write_string.c)
 * Callees:
 *     _fputwc_nolock @ 0x1401A4BBC (_fputwc_nolock.c)
 */
