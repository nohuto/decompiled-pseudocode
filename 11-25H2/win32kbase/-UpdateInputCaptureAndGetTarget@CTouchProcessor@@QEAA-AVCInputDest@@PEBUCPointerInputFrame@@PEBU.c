/*
 * XREFs of ?UpdateInputCaptureAndGetTarget@CTouchProcessor@@QEAA?AVCInputDest@@PEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@PEAUCInputPointerNode@@IPEAGPEAIK@Z @ 0x14020D188
 * Callers:
 ...
 *     ?GetNextInputStreamToken@CInputStreamTokenGenerator@CSpatialProcessor@@SAKXZ @ 0x1400F1274 (-GetNextInputStreamToken@CInputStreamTokenGenerator@CSpatialProcessor@@SAKXZ.c)
...
LABEL_75:
      ...
      if ( (v37 & 0x200) == 0 || *v41 == 7 )
      {
        ...
        NextInputStreamToken = CSpatialProcessor::CInputStreamTokenGenerator::GetNextInputStreamToken((__int64)v40, v39);
        v40 = v81;
        v39 = v80;
...
LABEL_86:
  ...
  *v88 |= 16 * (_WORD)v70;
  if ( (unsigned int)Feature_EliminateMitRitHandoff2__private_IsEnabledDeviceUsageNoInline()
    && !*(_QWORD *)(W32GetUserSessionState(v64, v63) + 18824)
  ...
  *v62 = v67 | *(_DWORD *)(a5 + 300) & 0x80;
  ...
  if ( (_BYTE)v63 || v14 )
  {
    v68 = &WPP_5b7ffc6749e23cc7ef8b8ac6df240892_Traceguids;
    LOBYTE(v68) = v14;
    WPP_RECORDER_AND_TRACE_SF_(
      *((_QWORD *)WPP_GLOBAL_Control + 3),
      v63,
