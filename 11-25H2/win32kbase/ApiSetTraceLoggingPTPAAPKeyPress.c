/*
 * XREFs of ApiSetTraceLoggingPTPAAPKeyPress @ 0x140107EF0
 * Callers:
...
__int64 (*__fastcall ApiSetTraceLoggingPTPAAPKeyPress(__int64 a1, __int64 a2))(void)
{
  ...
  v2 = a1;
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1, a2) + 48) + 7184LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5, v4) + 48) + 7192LL);
      if ( result )
