/*
 * XREFs of ?EmitController@CCaptureRenderTargetMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x14014C714
 * Callers:
...
char __fastcall DirectComposition::CCaptureRenderTargetMarshaler::EmitController(
