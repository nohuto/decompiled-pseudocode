/*
 * XREFs of ?RimDevicePointerData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1400794CC
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDevicePointerData(const struct RIMDEV *a1, __int64 a2, int a3, int a4)
{
  ...
  if ( *(_DWORD *)(v6 + 156) && v4 > 4 && (qword_14029EE30 & 0x100) != 0 && (v7 & 0x100) == v7 )
  {
