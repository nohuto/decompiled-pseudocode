/*
 * XREFs of ?OnPTPInertiaTimerNotification@CHidInput@@EEAAJXZ @ 0x14014AFE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPInertiaTimerNotification(CHidInput *this)
{
  ...
  InputTraceLogging::ThreadLockedPerfRegion::ThreadLockedPerfRegion(&v13, "OnPTPInertiaTimerNotification", 0LL);
