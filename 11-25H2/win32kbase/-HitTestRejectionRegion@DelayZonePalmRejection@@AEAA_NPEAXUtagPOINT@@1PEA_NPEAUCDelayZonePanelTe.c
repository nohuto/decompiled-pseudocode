/*
 * XREFs of ?HitTestRejectionRegion@DelayZonePalmRejection@@AEAA_NPEAXUtagPOINT@@1PEA_NPEAUCDelayZonePanelTelemetryData@@@Z @ 0x1402150C4
 * Callers:
  ...
  while ( v8 != v6 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( v13 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LOBYTE(v18) = v14;
        LOBYTE(v19) = v13;
        v20 = *(_QWORD *)(UserSessionState + 69144);
        v21 = "true";
        if ( !v16 )
          v21 = "false";
