/*
 * XREFs of ?Thaw@tagPROCESSINFO@@AEAAXXZ @ 0x1401A6EA8
 * Callers:
...
void __fastcall tagPROCESSINFO::Thaw(tagPROCESSINFO *this, __int64 a2)
{
  ...
  if ( v3 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v6) = v4;
    LOBYTE(v7) = v3;
    WPP_RECORDER_AND_TRACE_SF_qDs(*((_QWORD *)WPP_GLOBAL_Control + 3), v7, v6, *(_QWORD *)(UserSessionState + 69144));
  }
  if ( *((_DWORD *)this + 290) != 1 )
  {
