/*
 * XREFs of ?EmitUpdateCommands@CPrimitiveGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1400D0F80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  if ( !DirectComposition::CPrimitiveGroupMarshaler::EmitSetDirtyAndBoundsRectCommand(
          this,
          (struct DirectComposition::CBatch **)a2) )
    return 0;
  return i;
