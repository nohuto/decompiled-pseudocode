/*
 * XREFs of Feature_Capture_MinUpdateIntervalDefaultValue__private_IsEnabledDeviceUsageNoInline @ 0x14023B730
 * Callers:
 *     ?Initialize@CCaptureRenderTargetMarshaler@DirectComposition@@UEAAJXZ @ 0x1401994B0 (-Initialize@CCaptureRenderTargetMarshaler@DirectComposition@@UEAAJXZ.c)
