/*
 * XREFs of ?GetCompositorClockInfo@CConnection@DirectComposition@@QEAAJPEAPEAVCCompClockInfo@2@@Z @ 0x1400C7E8C
 * Callers:
 ...
 *     ?IsSameTarget@CCompClockInfo@DirectComposition@@QEBA_NAEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x140227F24 (-IsSameTarget@CCompClockInfo@DirectComposition@@QEBA_NAEBUtagCOMPOSITION_TARGET_ID@@@Z.c)
 */
