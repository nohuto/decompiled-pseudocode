/*
 * XREFs of ?BroadcastAsyncKeyState@Detail@Keyboard@IVRootDeliver@@YAJAEBUCONTAINER_ID@@GH@Z @ 0x14021DC10
 * Callers:
        ...
        int a3)
{
  ...
  if ( v10 )
  {
    *v10 = v3;
    *((_DWORD *)v6 + 1) = a3;
    v7 = ivrIVBroadcast((const struct CIVSerializer *)v9, 1LL, this);
  }
  else
  {
    v7 = -1073741801;
