/*
 * XREFs of RGNCOREOBJ::bMerge__RGNOBJ::bMerge_::_2_::_lambda_1___ @ 0x140010CB0
 * Callers:
        ...
        __int64 a5)
{
  ...
  Win32kRS *v17; // rax
  struct SCAN *v18; // rdi
  struct REGION_CORE *v19; // rsi
  Win32kRS *v20; // rbp
  int v21; // ebp
  struct REGION_CORE *v22; // rsi
  int v23; // eax
  char *v24; // rcx
  int v25; // esi
  int *v26; // rbp
  ...
  *((_DWORD *)v17 + 10) = 0x80000000;
  while ( 2 )
  {
    ...
    if ( qword_1402A10B0 )
    {
      ...
      ExAcquirePushLockSharedEx((char *)v19 + 8, 2LL);
      v21 = (*(__int64 (__fastcall **)(Win32kRS *))(*(_QWORD *)v19 + 224LL))(v20);
      ExReleasePushLockSharedEx((char *)v19 + 8, 2LL);
    ...
    {
      KeEnterCriticalRegion();
      ExAcquirePushLockSharedEx((char *)v22 + 8, 2LL);
...
LABEL_29:
    ...
    *((_DWORD *)v18 + *(unsigned int *)v18 + 3) = *(_DWORD *)v18;
    ...
    else if ( v11 != v18 )
    {
      ...
      {
        KeEnterCriticalRegion();
        ExAcquirePushLockSharedEx((char *)v37 + 8, 2LL);
