/*
 * XREFs of ?doImmediateBoostAll@GroupedFGBoostProp@@AEAAXW4BoostFlag@@@Z @ 0x14009C850
 * Callers:
 ...
 *     ?IsForegroundWindow@@YA_NPEBUtagWND@@@Z @ 0x14009D3C4 (-IsForegroundWindow@@YA_NPEBUtagWND@@@Z.c)
 */
