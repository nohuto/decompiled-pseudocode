/*
 * XREFs of ?bCopy@RGNOBJ@@QEAAHAEBVRustAutoHotpatchLockSH@@AEAV1@@Z @ 0x1401C4560
 * Callers:
...
__int64 __fastcall RGNOBJ::bCopy(RGNOBJ *this, const struct RustAutoHotpatchLockSH *a2, struct RGNOBJ *a3)
{
  ...
  if ( qword_1402A10B0 )
  {
    v7 = *(_QWORD *)qword_1402A10B0;
    v8 = (const struct REGION_CORE *)(v6 & -(__int64)(v5 != 0));
    v9 = (*(unsigned __int8 (__fastcall **)(const struct REGION_CORE *, __int64))(*(_QWORD *)qword_1402A10B0 + 96LL))(
           v8,
           (v4 + 24) & -(__int64)(v4 != 0));
  ...
  {
    RGNMEMOBJTMP::RGNMEMOBJTMP((RGNMEMOBJTMP *)&v13, (unsigned int)v13);
    if ( !v13 )
    {
