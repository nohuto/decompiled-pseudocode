/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x140122BF0
 * Callers:
        ...
        int a5)
{
  ...
  v18 = 11;
  if ( (unsigned int)UserIsRemoteAndNotDisconnectConnection((__int64)a1, a2) )
    return 0;
  ...
  if ( !a5 )
  {
    if ( a4 )
    {
      ...
      if ( v10 >= 0 )
      {
        while ( v16 < v18 )
        {
          v17 = RtlWriteRegistryValue(0x40000000u, a3, off_140247270[v16], 4u, &v21[v16], 4u);
          ++v16;
          v10 = v17;
          if ( v17 < 0 )
            return v10;
