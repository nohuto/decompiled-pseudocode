/*
 * XREFs of RIMGetPointerDeviceProperties @ 0x1401E4200
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)ButtonCapsLength = 0;
  ...
  if ( (unsigned int)GetPreparsedData(a1, &PreparsedData) )
  {
    ...
    if ( (v10 & 2) != 0 )
    {
      if ( !*(_QWORD *)(a1 + 768) )
      {
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3839);
        v10 = *(_DWORD *)(a1 + 368);
      }
      v11 = *(_QWORD *)(a1 + 768);
      v7 = *(_WORD *)(v11 + 4);
    ...
    {
      v25 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3850);
    }
    v12 = PreparsedData;
    if ( HidP_GetSpecificValueCaps(HidP_Input, 0, v7, 0, 0LL, &ValueCapsLength, PreparsedData) == -1072627705 )
    {
                           ...
                           v12) )
      {
        ...
        {
          v25 = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3874);
        }
