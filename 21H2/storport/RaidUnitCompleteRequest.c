/*
 * XREFs of RaidUnitCompleteRequest @ 0x1C0007A70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidNormalizeDeviceQueue @ 0x1C0007A08 (RaidNormalizeDeviceQueue.c)
 ...
 *     StorpTelemetryCollectPerfData @ 0x1C0009180 (StorpTelemetryCollectPerfData.c)
 ...
 *     RaidAdapterReleaseCryptoKeyResources @ 0x1C002DE9C (RaidAdapterReleaseCryptoKeyResources.c)
 ...
 *     StorRemoveEventQueue @ 0x1C00349A4 (StorRemoveEventQueue.c)
 *     StorRemoveEventQueueInternal @ 0x1C0034A60 (StorRemoveEventQueueInternal.c)
 ...
 *     RaidSrbExGetBidirectionalData @ 0x1C0042C2C (RaidSrbExGetBidirectionalData.c)
 *     TranslateResultToScsiRequestBlock @ 0x1C0042D54 (TranslateResultToScsiRequestBlock.c)
 ...
 *     RaidFreeRemappedScatterGatherListMdl @ 0x1C004D694 (RaidFreeRemappedScatterGatherListMdl.c)
 *     StorEtwIORequestServiceTimeEventData @ 0x1C004F834 (StorEtwIORequestServiceTimeEventData.c)
 *     StorEtwLogoRequestServiceTimeEventData @ 0x1C004FB2C (StorEtwLogoRequestServiceTimeEventData.c)
 */
    ...
    else
    {
      ...
      if ( v145 )
      {
        ...
        if ( !(unsigned __int8)StorSubmitIoGatewayItem(*(PKSPIN_LOCK *)(v8 + 664)) )
          (*(void (__fastcall **)(_QWORD, __int64, _OWORD *, _QWORD))(v8 + 648))(
            *(_QWORD *)(v8 + 640),
            v145 - 120,
            v166,
            0LL);
