/*
 * XREFs of RaidUnitFreeResources @ 0x1C0016638
 * Callers:
 ...
 *     StorDeleteScsiIdentity @ 0x1C0018FE8 (StorDeleteScsiIdentity.c)
 ...
 *     RaDeleteTagList @ 0x1C0072E28 (RaDeleteTagList.c)
 */
...
__int64 __fastcall RaidUnitFreeResources(__int64 a1)
{
  ...
  v10 = *(_QWORD *)(a1 + 24);
  if ( v10 && *(_QWORD *)(v10 + 5088) && _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 3360), 0, 1) == 1 )
