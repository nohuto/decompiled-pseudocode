/*
 * XREFs of McTemplateK0pzqqxxtt_EtwWriteTransfer @ 0x1C002A7C4
 * Callers:
...
NTSTATUS McTemplateK0pzqqxxtt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  const wchar_t *v10; // [rsp+50h] [rbp-61h]
  ...
  const wchar_t *v27; // [rsp+100h] [rbp+4Fh]
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v3, &EventDpc, 0LL, 9u, &v7);
}
