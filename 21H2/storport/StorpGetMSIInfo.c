/*
 * XREFs of StorpGetMSIInfo @ 0x1C003BEC8
 * Callers:
...
__int64 __fastcall StorpGetMSIInfo(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( !a3 )
  {
    ...
    v6 = 58;
LABEL_6:
    WPP_SF_((__int64)v5->AttachedDevice, v6, (__int64)&WPP_8537d3e98fbc352c94324671ced0aca0_Traceguids);
    return (unsigned int)-1056964602;
  }
  v7 = *(_QWORD *)(a1 - 16);
  if ( !*(_BYTE *)(*(_QWORD *)v7 + 4513LL) )
    return (unsigned int)-1056964601;
  v8 = *(unsigned __int8 **)(*(_QWORD *)v7 + 4496LL);
  if ( a2 < *((_DWORD *)v8 + 1) )
  {
    *(_DWORD *)a3 = a2;
