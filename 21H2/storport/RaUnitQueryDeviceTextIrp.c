/*
 * XREFs of RaUnitQueryDeviceTextIrp @ 0x1C0074C34
 * Callers:
 ...
 *     StorGetIdentityVendorId @ 0x1C001B17C (StorGetIdentityVendorId.c)
 *     StorGetIdentityProductId @ 0x1C001B1AC (StorGetIdentityProductId.c)
...
__int64 __fastcall RaUnitQueryDeviceTextIrp(__int64 a1, IRP *a2)
{
  ...
  if ( Pool )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 552LL) + 184LL) & 0x10) == 0 )
    {
