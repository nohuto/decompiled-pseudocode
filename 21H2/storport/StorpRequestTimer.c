        ...
        unsigned __int64 a6)
{
  ...
  if ( !a1 || !a2 || !a3 )
  {
    ...
    {
      WPP_SF_qqq(WPP_GLOBAL_Control->AttachedDevice, 72LL, &WPP_8537d3e98fbc352c94324671ced0aca0_Traceguids, a1, a2, a3);
    }
    return 3238002694LL;
  }
  v10 = **(_DWORD ***)(a1 - 16);
  ...
  if ( !*(_QWORD *)a2 || *v11 )
  {
    ...
    v9 = a2;
LABEL_31:
    WPP_SF_q(v15->AttachedDevice, v16, &WPP_8537d3e98fbc352c94324671ced0aca0_Traceguids, v9);
    return 3238002694LL;
  }
  if ( a5 )
  {
