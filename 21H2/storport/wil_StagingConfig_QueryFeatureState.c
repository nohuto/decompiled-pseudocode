 ...
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C001DDEC (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 ...
 *     wil_details_StagingConfig_QueryFeatureState @ 0x1C001E3DC (wil_details_StagingConfig_QueryFeatureState.c)
