/*
 * XREFs of McTemplateK0quuujjqzsssztuqquuuuuuqqi_EtwWriteTransfer @ 0x1C000D140
 * Callers:
 *     StorpTelemetrySendUnitUniqueErrorData @ 0x1C000CBBC (StorpTelemetrySendUnitUniqueErrorData.c)
 * Callees:
