/*
 * XREFs of McTemplateK0pqquuuqpp_EtwWriteTransfer @ 0x1C003748C
 * Callers:
...
NTSTATUS McTemplateK0pqquuuqpp_EtwWriteTransfer(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventStateChangeDetected, a3, 0xAu, &v4);
}
