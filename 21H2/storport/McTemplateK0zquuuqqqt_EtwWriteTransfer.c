/*
 * XREFs of McTemplateK0zquuuqqqt_EtwWriteTransfer @ 0x1C0037C84
 * Callers:
 *     StorPortSetDeviceQueueDepth @ 0x1C0003630 (StorPortSetDeviceQueueDepth.c)
 *     RaUnitSetQueueDepth @ 0x1C0018E78 (RaUnitSetQueueDepth.c)
 * Callees:
...
NTSTATUS __fastcall McTemplateK0zquuuqqqt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a12)
{
  ...
  v32 = 4LL;
  v34 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v13, &EventSetLunQueueDepthBtl8, 0LL, 0xAu, &v15);
}
