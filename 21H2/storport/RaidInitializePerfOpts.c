/*
 * XREFs of RaidInitializePerfOpts @ 0x1C00316D4
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, __int64 i)
{
  ...
  if ( !v7 )
  {
    ...
    v15 = 23LL;
LABEL_6:
    WPP_SF_(v14->AttachedDevice, v15, &WPP_c14902a3c76b3c1f0b09f862a5aedd9e_Traceguids);
LABEL_7:
    v13 = -1056964602;
    goto LABEL_116;
  }
    ...
    else
    {
      ...
      if ( v11 && (*(_DWORD *)(v7 + 8) & 4) != 0 )
      {
        ...
        if ( v28 > v31 || v31 > v30 )
        {
          ...
          v18 = 26LL;
LABEL_18:
          WPP_SF_(v17->AttachedDevice, v18, &WPP_c14902a3c76b3c1f0b09f862a5aedd9e_Traceguids);
LABEL_19:
          v13 = -1056964607;
          goto LABEL_116;
        }
