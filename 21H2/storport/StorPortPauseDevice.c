/*
 * XREFs of StorPortPauseDevice @ 0x1C0002950
 * Callers:
 *     StorPortPauseDeviceVrfy @ 0x1C007F6E0 (StorPortPauseDeviceVrfy.c)
 * Callees:
  ...
  if ( v8 )
  {
    ...
    if ( Unit )
    {
      ...
      if ( (qword_1C0069310 & 0x800) != 0 )
        DbgLogRequest(v8, 22, (_DWORD)retaddr, 538, 0LL, 0LL, 0LL);
    }
    else if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
           && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x20) != 0
           && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    {
      WPP_SF_ddd(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_8537d3e98fbc352c94324671ced0aca0_Traceguids, v9, v7, v6);
    }
  }
  return 0;
}
