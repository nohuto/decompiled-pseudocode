/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C0047E14
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C000B1E8 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C0009080 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C002C8DC (RaidAdapterEnableQosWaitTimeoutCheck.c)
 ...
 *     RaidUnitDisableWaitCheckTimer @ 0x1C004A920 (RaidUnitDisableWaitCheckTimer.c)
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 40;
LABEL_83:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_c0fbeaa32f6432859fb1821fd44520a7_Traceguids, a1);
LABEL_84:
        v5 = -1073741637;
        goto LABEL_85;
      }
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v17 = 46;
LABEL_77:
    WPP_SF_q((__int64)v16->AttachedDevice, v17, (__int64)&WPP_c0fbeaa32f6432859fb1821fd44520a7_Traceguids, a1);
LABEL_78:
    v5 = -1073741811;
    goto LABEL_85;
  }
