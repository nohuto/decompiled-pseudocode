/*
 * XREFs of RaidAdapterRemoveNormalChildren @ 0x1C002DEF8
 * Callers:
 *     RaidAdapterDeleteChildren @ 0x1C002C3B8 (RaidAdapterDeleteChildren.c)
 *     RaidAdapterMarkChildrenMissing @ 0x1C002D498 (RaidAdapterMarkChildrenMissing.c)
 * Callees:
 ...
 *     StorRemoveDictionary @ 0x1C0017C4C (StorRemoveDictionary.c)
