 ...
 *     TranslateToExtendedSrb @ 0x1C0043200 (TranslateToExtendedSrb.c)
 *     RaidGetSystemAddressForMdl @ 0x1C0045548 (RaidGetSystemAddressForMdl.c)
 *     McTemplateK0dud_EtwWriteTransfer @ 0x1C004641C (McTemplateK0dud_EtwWriteTransfer.c)
 *     StorpDataInBufferAllocateMdlAndLockPages @ 0x1C004C3C0 (StorpDataInBufferAllocateMdlAndLockPages.c)
 */
