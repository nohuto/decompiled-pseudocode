/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x1C002D178
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C0044830 (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
