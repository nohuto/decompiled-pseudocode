 ...
 *     RaidIsUnitQueueLocked @ 0x1C0011B6C (RaidIsUnitQueueLocked.c)
 *     RaidUnlockUnitQueue @ 0x1C0011B7C (RaidUnlockUnitQueue.c)
 *     RaCallMiniportUnitControl @ 0x1C00190AC (RaCallMiniportUnitControl.c)
 *     RaidUnitRestartQueue @ 0x1C001AC74 (RaidUnitRestartQueue.c)
 ...
 *     RaidUnitGetInitialTimestamp @ 0x1C001BE80 (RaidUnitGetInitialTimestamp.c)
 *     RaidUnitGetPowerCycleCount @ 0x1C001BF60 (RaidUnitGetPowerCycleCount.c)
  ...
  *(_QWORD *)(a1 + 3264) = 0x10000000LL;
  ...
  if ( *(_QWORD *)(a1 + 104) && (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
  {
    ...
    *(_QWORD *)&v33 = *(_QWORD *)(a1 + 3208);
    ...
    v73 = 4LL;
    v75 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)v10, (unsigned __int8 *)dword_1C005D9D7, v13, v14, 0x19u, &v34);
  }
