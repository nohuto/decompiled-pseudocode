/*
 * XREFs of StorEtwEnableCallback @ 0x1C004F160
 * Callers:
 ...
 *     RaidGetPortData @ 0x1C000E08C (RaidGetPortData.c)
 *     memset @ 0x1C0020540 (memset.c)
 *     StorEtwAdapterNeedsUpdate @ 0x1C004F0BC (StorEtwAdapterNeedsUpdate.c)
      ...
      if ( v11 )
      {
        if ( (_DWORD)v12 )
        {
          ...
          do
          {
            ...
            ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*v21++ + 280));
            --v12;
          }
          while ( v12 );
        }
