/*
 * XREFs of RaidAdapterRequestComplete @ 0x1C000F360
 * Callers:
 ...
 *     StorTickEventQueue @ 0x1C0011250 (StorTickEventQueue.c)
 ...
 *     RaidLogMiniportCompletion @ 0x1C000F520 (RaidLogMiniportCompletion.c)
      ...
      if ( v8 || (_BYTE)v7 == 1 )
      {
        if ( (unsigned int)dword_1C0069058 > 5 )
        {
          ...
          if ( (_BYTE)v7 )
          {
            ...
            LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer((int)&v20, (int)&dword_1C005D65D, v14, v15, 7u, &v20);
          }
        }
        return (char)v7;
      }
