/*
 * XREFs of RaidUnitHandleReportLunsDataChanged @ 0x1C004A9D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_QWORD *)(a2 + 216) )
  {
    if ( !*(_BYTE *)(*(_QWORD *)(a1 + 24) + 427LL) )
    {
      ...
      if ( Pool )
      {
        ...
        if ( !_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 24) + 4968LL), 1, 0) )
        {
          _InterlockedOr(v10, 0);
          *(_DWORD *)(*(_QWORD *)(a2 + 216) + 4972LL) = 2;
          *(_QWORD *)(*(_QWORD *)(a2 + 216) + 4984LL) = Pool;
          *(_DWORD *)(*(_QWORD *)(a2 + 216) + 4976LL) = 0;
          *(_QWORD *)(*(_QWORD *)(a2 + 216) + 4992LL) = &RaidUnitHandleReportLunsDataChangedCompletion;
          *(_QWORD *)(*(_QWORD *)(a2 + 216) + 5000LL) = 0LL;
          _InterlockedOr(v10, 0);
