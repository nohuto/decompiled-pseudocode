/*
 * XREFs of RaidAdapterStartDevice @ 0x1C002F9F4
 * Callers:
 ...
 *     RaidAdapterRegisterDeviceInterface @ 0x1C002DD48 (RaidAdapterRegisterDeviceInterface.c)
 *     RaidAdapterRegisterNonPoFxMiniportInterface @ 0x1C002DDC0 (RaidAdapterRegisterNonPoFxMiniportInterface.c)
 *     RaidAdapterRegisterRpmbInterface @ 0x1C002DE24 (RaidAdapterRegisterRpmbInterface.c)
...
__int64 __fastcall RaidAdapterStartDevice(char *Context, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_c14902a3c76b3c1f0b09f862a5aedd9e_Traceguids, Context, a2);
  }
