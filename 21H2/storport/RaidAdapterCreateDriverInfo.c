/*
 * XREFs of RaidAdapterCreateDriverInfo @ 0x1C0077494
 * Callers:
 ...
 *     RaidAdapterFreeDriverInfo @ 0x1C002CA28 (RaidAdapterFreeDriverInfo.c)
 *     RtlStringCbCopyW @ 0x1C00332B4 (RtlStringCbCopyW.c)
 */
...
LABEL_17:
  ...
  *((_DWORD *)v17 + 17) = 208;
  v17[9] = v23;
  v17[14] = v4;
  if ( (*(_DWORD *)(a1 + 548) & 1) != 0 || (v24 = *(_DWORD *)(a1 + 4420), v24 == 10) || v24 == 1 )
    *((_DWORD *)v17 + 16) |= 1u;
  *a3 = v17;
  return (unsigned int)FullDriverPath;
}
