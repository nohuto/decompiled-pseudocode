/*
 * XREFs of RaidUnitRegisterInterfaces @ 0x1C001BC54
 * Callers:
 *     RaUnitStartDeviceIrp @ 0x1C007479C (RaUnitStartDeviceIrp.c)
 * Callees:
 *     PortMapBuildLunEntry @ 0x1C001C048 (PortMapBuildLunEntry.c)
 *     PortRegistryCreateKeyEx @ 0x1C001C364 (PortRegistryCreateKeyEx.c)
 *     PortGetDeviceType @ 0x1C00740D4 (PortGetDeviceType.c)
 *     RaidUnitAddAclToVmDevices @ 0x1C007B864 (RaidUnitAddAclToVmDevices.c)
 */
