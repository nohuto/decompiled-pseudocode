 ...
 * Callees:
 *     RaidReleasePortData @ 0x1C000E06C (RaidReleasePortData.c)
 *     _guard_dispatch_icall_nop @ 0x1C0020250 (_guard_dispatch_icall_nop.c)
 *     McGenEventUnregister_EtwUnregister @ 0x1C00341D8 (McGenEventUnregister_EtwUnregister.c)
 *     RaFreeDriverInitData @ 0x1C00345C0 (RaFreeDriverInitData.c)
 *     RaidRemovePortDriver @ 0x1C0035B68 (RaidRemovePortDriver.c)
