/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1C00551B8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_1C005FDDB, v12, v13, 0x24u, &v40);
    }
  }
}
