/*
 * XREFs of RaAttemptHighWaterMarkIncrease @ 0x1C004DC58
 * Callers:
 ...
 *     RaAttemptHighWaterMarkIncreasePassive @ 0x1C004DF30 (RaAttemptHighWaterMarkIncreasePassive.c)
 * Callees:
...
char __fastcall RaAttemptHighWaterMarkIncrease(__int64 a1, int a2)
{
  ...
  if ( KeGetCurrentIrql() && !*(_BYTE *)(a1 + 184) )
  {
    ...
    if ( *(_QWORD *)(v4 + 5824)
      || (WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(v4 + 8)), (*(_QWORD *)(v4 + 5824) = WorkItem) != 0LL) )
    {
      if ( !_InterlockedCompareExchange((volatile signed __int32 *)(v4 + 5840), 1, 0) )
        IoQueueWorkItem(
          *(PIO_WORKITEM *)(v4 + 5824),
