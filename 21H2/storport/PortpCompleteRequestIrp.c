/*
 * XREFs of PortpCompleteRequestIrp @ 0x1C005A660
 * Callers:
 *     PortpAsyncCompletion @ 0x1C005A530 (PortpAsyncCompletion.c)
 *     PortpCancelRoutine @ 0x1C005A5C0 (PortpCancelRoutine.c)
 * Callees:
 *     PortPassThroughFreeIrpEx @ 0x1C001FFEC (PortPassThroughFreeIrpEx.c)
 *     _guard_dispatch_icall_nop @ 0x1C0020250 (_guard_dispatch_icall_nop.c)
 *     PortPassThroughExMarshalResultsFromSrbEx @ 0x1C0059E60 (PortPassThroughExMarshalResultsFromSrbEx.c)
 *     PortPassThroughFreeSrb @ 0x1C005A210 (PortPassThroughFreeSrb.c)
 *     PortPassThroughMarshalResultsFromSrb @ 0x1C005A2FC (PortPassThroughMarshalResultsFromSrb.c)
 */
