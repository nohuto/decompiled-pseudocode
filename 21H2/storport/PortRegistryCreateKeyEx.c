/*
 * XREFs of PortRegistryCreateKeyEx @ 0x1C001C364
 * Callers:
 ...
 *     PortMapBuildAdapterEntry @ 0x1C0059804 (PortMapBuildAdapterEntry.c)
 *     PortMapBuildBusEntry @ 0x1C0059918 (PortMapBuildBusEntry.c)
 * Callees:
