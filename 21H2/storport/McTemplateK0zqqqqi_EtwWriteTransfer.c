/*
 * XREFs of McTemplateK0zqqqqi_EtwWriteTransfer @ 0x1C004D984
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqqqqi_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a8)
{
  ...
  v24 = &v11;
  v25 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v9, &EventSetAdapterResourceList, 0LL, 7u, &v12);
}
