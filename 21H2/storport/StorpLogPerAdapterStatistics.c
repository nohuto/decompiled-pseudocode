/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C000E6B8
 * Callers:
 ...
 *     StorpInitializeHierarchicalResetBuckets @ 0x1C000E7EC (StorpInitializeHierarchicalResetBuckets.c)
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
  ...
  if ( ((_DWORD)v2
     ...
     || *(_DWORD *)(a1 + 5256)
     || *(_DWORD *)(a1 + 5268))
    && (unsigned int)dword_1C0069058 > 5
    && tlgKeywordOn(v2, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v5, (int)&dword_1C005EFA4, v6, v7, 0x13u, &v27);
  }
    ...
    && tlgKeywordOn(v3, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v8, (int)&dword_1C00601D5, v9, v10, 0x13u, &v27);
  }
