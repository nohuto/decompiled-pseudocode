/*
 * XREFs of StorpMarkDeviceFailed @ 0x1C003C8B8
 * Callers:
 ...
 *     StorpPopulateLogData @ 0x1C0043720 (StorpPopulateLogData.c)
...
LABEL_46:
  ...
  if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v33, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&v77, (unsigned __int8 *)dword_1C005D6CC, v49, v50, 0xEu, &v77);
  }
  if ( v59 )
  {
    if ( v68 )
