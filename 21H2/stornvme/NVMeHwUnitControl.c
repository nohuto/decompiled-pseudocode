/*
 * XREFs of NVMeHwUnitControl @ 0x1C000AF50
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NVMeHwUnitControl(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( !v5 )
  {
    ...
    return (unsigned int)v13 >= *(_DWORD *)(a1 + 208) || !*(_QWORD *)(a1 + 8 * v13 + 1736);
  }
  v6 = v5 - 1;
  if ( !v6 )
    return 0;
  ...
  if ( !v7 )
  {
    v12 = *(_QWORD *)(a1 + 8LL * *(unsigned __int8 *)(a3 + 10) + 1736);
    if ( v12 )
      *(_DWORD *)(v12 + 20) |= 4u;
    return 0;
  }
