/*
 * XREFs of NVMeInitStreams @ 0x1C00198AC
 * Callers:
...
__int64 __fastcall NVMeInitStreams(__int64 a1, unsigned __int8 a2)
{
  ...
  v3 = a2;
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 1640) + 256LL) & 0x20) == 0 )
    return 3238002695LL;
  if ( (*(_BYTE *)(a1 + 3808) & 7) == 3 )
    return *(_BYTE *)(a1 + 3809) != a2 ? 0xC1000003 : 0;
  NamespaceId = GetNamespaceId(a1, a2);
  v7 = *(_BYTE *)(a1 + 3808);
  if ( (v7 & 4) != 0 )
  {
    LOBYTE(v3) = *(_BYTE *)(a1 + 3809);
  }
  else if ( NamespaceId > *(_DWORD *)(v6 + 516) || !*(_QWORD *)(a1 + 8 * v3 + 1752) )
  {
    return 3238002694LL;
  }
  if ( (v7 & 1) == 0 )
...
LABEL_15:
  ...
  v9 = v13[0];
  v10 = WORD1(v13[0]);
  *(_DWORD *)(a1 + 3820) = v13[1];
  *(_DWORD *)(a1 + 3824) = WORD2(v13[1]);
  *(_WORD *)(a1 + 3814) = WORD4(v13[1]);
  *(_WORD *)(a1 + 3816) = v8 + v10;
  *(_BYTE *)(a1 + 3809) = v3;
  *(_WORD *)(a1 + 3810) = v9;
  *(_WORD *)(a1 + 3812) = v8;
  if ( !v9 )
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !(_DWORD)result )
    {
      ...
      *(_WORD *)(a1 + 3812) = WORD3(v13[1]);
      *(_WORD *)(a1 + 3816) = v12;
      if ( v11 )
      {
        *(_BYTE *)(a1 + 3808) = *(_BYTE *)(a1 + 3808) & 0xF9 | 2;
        return 0LL;
      }
      return 3238002695LL;
    }
