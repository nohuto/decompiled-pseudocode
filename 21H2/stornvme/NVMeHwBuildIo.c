/*
 * XREFs of NVMeHwBuildIo @ 0x1C0004930
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 )
  {
    ...
    switch ( v8 )
    {
      ...
      case 38:
        ...
        if ( !v12 || *(_DWORD *)(a2 + v13) < 0x48u || (*(_DWORD *)(a1 + 56) & 0x10) == 0 )
          goto LABEL_34;
        goto LABEL_32;
      case 39:
        if ( (_BYTE)v7 == 40 )
      ...
      case 42:
        ...
        {
LABEL_32:
          StorPortExtendedFunction(0LL, a1, 136LL, 1701672526LL);
          *(_BYTE *)(a2 + 3) = 4;
        }
        else
        {
LABEL_34:
      ...
      case 43:
        ...
        if ( v21 && *(_DWORD *)(a2 + v22) >= 0x18u && *(_DWORD *)(v21 + 8) == 1179468873 )
        {
          v16 = *(_QWORD *)(v21 + 16);
LABEL_41:
          v17 = StorPortExtendedFunction(1LL, a1, v16, v6);
          v18 = 4;
          if ( !v17 )
            v18 = 1;
        }
