/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C002ED44
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C002F060 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x1C0032C40 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
    ...
    else
    {
            ...
            v11 >= 0) )
      {
        ...
        *(_DWORD *)(v8 + 68) = v15;
        ...
        ((void (__fastcall *)(__int64 *))qword_1C001C608)(&v21);
