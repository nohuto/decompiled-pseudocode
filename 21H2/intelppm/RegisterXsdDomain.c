/*
 * XREFs of RegisterXsdDomain @ 0x1C0024F40
 * Callers:
...
char __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  v6 = qword_1C001C410;
  if ( (__int64 *)qword_1C001C410 == &qword_1C001C410 )
  {
LABEL_7:
    v10 = 56;
    if ( v1 == v3 )
    ...
    if ( PoolWithTag )
    {
      ...
      *(_QWORD *)(v6 + 24) = v6 + 16;
      *(_QWORD *)(v6 + 16) = v6 + 16;
      v12 = (__int64 *)qword_1C001C418;
      if ( *(__int64 **)qword_1C001C418 != &qword_1C001C410 )
        goto LABEL_20;
      *(_QWORD *)v6 = &qword_1C001C410;
      *(_QWORD *)(v6 + 8) = v12;
      *v12 = v6;
      qword_1C001C418 = v6;
      *(_DWORD *)(v6 + 36) = v1[3];
