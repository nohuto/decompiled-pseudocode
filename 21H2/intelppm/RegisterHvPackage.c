/*
 * XREFs of RegisterHvPackage @ 0x1C0031C00
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00047F0 (_guard_dispatch_icall_nop.c)
 *     GetHvPackage @ 0x1C0030B3C (GetHvPackage.c)
 */
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C001C420 );
    if ( !HvPackage )
    {
LABEL_6:
...
LABEL_11:
      ...
      v5 = (_QWORD *)qword_1C001C428;
      if ( *(__int64 **)qword_1C001C428 != &qword_1C001C420 )
LABEL_13:
        __fastfail(3u);
      *(_QWORD *)HvPackage = &qword_1C001C420;
      *((_QWORD *)HvPackage + 1) = v5;
      *v5 = HvPackage;
      qword_1C001C428 = (__int64)HvPackage;
    }
