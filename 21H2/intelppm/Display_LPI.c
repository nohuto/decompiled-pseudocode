/*
 * XREFs of Display_LPI @ 0x1C000C058
 * Callers:
...
_UNKNOWN **__fastcall Display_LPI(__int64 a1, const wchar_t *a2, int a3, int a4)
{
  ...
  if ( a1 )
  {
    ...
    for ( i = 0; i < *(_DWORD *)(a1 + 16); ++i )
    {
      ...
      DisplayGenAddr((unsigned __int8 *)(v8 + a1 + 48), (__int64)"    ", a3, a4);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_(
          ...
          0xAAu,
          (__int64)&WPP_0a302e3fd2f833bdae43f30252de1cf8_Traceguids);
      DisplayGenAddr((unsigned __int8 *)(v8 + a1 + 60), (__int64)"    ", v9, v10);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          5u,
          ...
          0xABu,
          (__int64)&WPP_0a302e3fd2f833bdae43f30252de1cf8_Traceguids);
      result = (_UNKNOWN **)DisplayGenAddr((unsigned __int8 *)(v8 + a1 + 72), (__int64)"    ", v11, v12);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          result = (_UNKNOWN **)WPP_RECORDER_SF_(
