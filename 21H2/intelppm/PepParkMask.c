...
__int64 __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification )
  {
    ...
    {
      memset(&PepParkLists, 0, (unsigned int)(16 * dword_1C001C3E4));
      v5 = 0;
      KeInitializeEnumerationContext(&v8, &unk_1C001C708);
      ...
      if ( !(_DWORD)result )
      {
        ...
        if ( v5 )
        {
          ...
          v10[0] = v5;
          v12 = &PepParkLists;
          result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C001C690)(*(_QWORD *)(v7 + 1104), v10);
          if ( (int)result < 0 )
          {
