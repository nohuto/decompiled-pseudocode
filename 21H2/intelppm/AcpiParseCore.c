/*
 * XREFs of AcpiParseCore @ 0x1C00247A4
 * Callers:
 ...
 *     GetObjectTypeName @ 0x1C000C80C (GetObjectTypeName.c)
...
LABEL_38:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_ss((__int64)WPP_GLOBAL_Control->DeviceExtension, a2, a3, v18, v30, a7, *((const char **)v16 + 1));
