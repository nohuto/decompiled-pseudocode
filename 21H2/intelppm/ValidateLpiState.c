/*
 * XREFs of ValidateLpiState @ 0x1C002FFB0
 * Callers:
 *     ValidateCoordinatedLpiStates @ 0x1C002FD30 (ValidateCoordinatedLpiStates.c)
 *     ValidateProcessorLpiStates @ 0x1C003081C (ValidateProcessorLpiStates.c)
 * Callees:
...
LABEL_4:
  ...
  if ( (_BYTE)v5 != 127 )
  {
    ...
    if ( (_BYTE)v5 == 1 )
    {
      if ( !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001CE8C) )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          return (unsigned int)-1073741823;
        v3 = v6 + 88;
