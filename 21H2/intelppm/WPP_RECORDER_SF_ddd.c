/*
 * XREFs of WPP_RECORDER_SF_ddd @ 0x1C0009DB8
 * Callers:
 *     ValidateAcpiCStates @ 0x1C0022558 (ValidateAcpiCStates.c)
 *     ValidateAcpiIdleDomain @ 0x1C002F400 (ValidateAcpiIdleDomain.c)
 *     ValidateAcpiThrottleStates @ 0x1C002F5AC (ValidateAcpiThrottleStates.c)
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1C002F954 (ValidateCoordinatedDependencyOptionsPlatform.c)
 *     ValidateCoordinatedDependencyOptionsProcessor @ 0x1C002FAB0 (ValidateCoordinatedDependencyOptionsProcessor.c)
