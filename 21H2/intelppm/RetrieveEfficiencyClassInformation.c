/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C00258A0
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x1C00261E8 (GetProcessorEfficiencyClass.c)
 */
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  InitializeEnumerationContext((__int64)&qword_1C001C400, 32, (__int64)v6);
...
LABEL_5:
  ...
  dword_1C001C9D4 = 1;
  qword_1C001C9D8 = 0LL;
  LODWORD(qword_1C001C9D8) = dword_1C001C3E4;
  return v4;
}
