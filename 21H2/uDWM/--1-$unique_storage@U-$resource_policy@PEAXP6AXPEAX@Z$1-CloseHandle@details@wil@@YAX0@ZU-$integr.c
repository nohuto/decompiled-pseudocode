/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x180040608
 * Callers:
 ...
 *     ??1?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x18007DD14 (--1-$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ??1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ @ 0x180080A64 (--1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ.c)
 ...
 * Callees:
 *     ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180042E30 (-CloseHandle@details@wil@@YAXPEAX@Z.c)
 */
