/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ThumbnailTabs@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18009A990
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ThumbnailTabs@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18009ADC0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_ThumbnailTabs@@@details@wil@@QEAAX_NW4Rep.c)
 * Callees:
