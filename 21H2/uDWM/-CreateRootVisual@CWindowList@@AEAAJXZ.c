/*
 * XREFs of ?CreateRootVisual@CWindowList@@AEAAJXZ @ 0x18004AF14
 * Callers:
...
__int64 __fastcall CWindowList::CreateRootVisual(struct CVisual **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x714u);
  }
  else
  {
    v4 = *v1;
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x717u);
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x71Au);
      }
      else
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x71Cu);
      }
    }
  }
  return v3;
