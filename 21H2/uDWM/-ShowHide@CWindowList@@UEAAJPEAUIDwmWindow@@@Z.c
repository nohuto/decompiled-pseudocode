/*
 * XREFs of ?ShowHide@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800111C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ShowHide(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0xA40u);
  }
  else
  {
    v6 = v16;
      ...
      if ( v7 != (v8 & 1) )
      {
        ...
        *((_BYTE *)v6 + 608) = v8 ^ v9 & 1;
        ...
        if ( !(_BYTE)v16 )
        {
          ...
          v5 = v14;
          if ( v14 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0xA4Fu);
        }
      }
    }
  }
