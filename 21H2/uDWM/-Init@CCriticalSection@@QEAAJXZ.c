/*
 * XREFs of ?Init@CCriticalSection@@QEAAJXZ @ 0x180042B64
 * Callers:
 *     ??0CMILResourceCacheIndexManager@@QEAA@XZ @ 0x180042AF4 (--0CMILResourceCacheIndexManager@@QEAA@XZ.c)
 *     ??0CMTALock@@QEAA@XZ @ 0x180050F98 (--0CMTALock@@QEAA@XZ.c)
 * Callees:
