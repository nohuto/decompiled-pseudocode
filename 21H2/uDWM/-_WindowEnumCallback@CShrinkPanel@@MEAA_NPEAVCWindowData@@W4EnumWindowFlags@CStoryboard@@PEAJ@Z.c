/*
 * XREFs of ?_WindowEnumCallback@CShrinkPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800B50A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CShrinkPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (*(_DWORD *)(a2 + 616) & 0xFFF) != 0x28 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x613u);
LABEL_12:
      v4 = v27;
      goto LABEL_27;
    }
  ...
  if ( *(_BYTE *)(a1 + 128) )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x5F5u);
      goto LABEL_12;
    }
    v4 = v27;
...
LABEL_27:
  ...
  v5 = v22;
  if ( v22 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v22, 0x60Bu);
LABEL_29:
  result = 1;
  *a4 = v5;
  return result;
