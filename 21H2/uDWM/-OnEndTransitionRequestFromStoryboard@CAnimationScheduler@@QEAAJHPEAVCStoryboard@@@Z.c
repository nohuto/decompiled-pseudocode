/*
 * XREFs of ?OnEndTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEAVCStoryboard@@@Z @ 0x180033560
 * Callers:
        ...
        struct CStoryboard *a3)
{
  ...
  if ( (int)v9 >= 0 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CA718, 1LL, v11, 0x132u);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CA718, 1LL, v13, 0x135u);
    }
LABEL_17:
