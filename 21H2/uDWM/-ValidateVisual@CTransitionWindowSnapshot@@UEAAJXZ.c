/*
 * XREFs of ?ValidateVisual@CTransitionWindowSnapshot@@UEAAJXZ @ 0x18000BB10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v14 = CDrawGeometryInstruction::Create(*((struct CBaseLegacyMilBrushProxy **)this + 37), *v4, &v18);
  v13 = v14;
  if ( v14 < 0 )
  {
