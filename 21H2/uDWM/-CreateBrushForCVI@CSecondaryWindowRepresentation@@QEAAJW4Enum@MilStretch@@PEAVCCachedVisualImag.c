/*
 * XREFs of ?CreateBrushForCVI@CSecondaryWindowRepresentation@@QEAAJW4Enum@MilStretch@@PEAVCCachedVisualImageProxy@@PEAVCRectResourceProxy@@PEAVCDoubleResourceProxy@@PEAPEAVCImageLegacyMilBrushProxy@@@Z @ 0x18000E880
 * Callers:
        ...
        CBaseObject **a6)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x443u);
    goto LABEL_9;
  }
  if ( a4 )
    v15 = 0LL;
  ...
  v16 = _xmm;
  v12 = CImageLegacyMilBrushProxy::Update(v14, v9, &v15, &v16, a5);
  v10 = v12;
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x470u);
LABEL_10:
    if ( v11 )
