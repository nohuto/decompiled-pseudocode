/*
 * XREFs of ?GetStride@CCompoundBitmapLock@@UEAAJPEAI@Z @ 0x1800537B0
 * Callers:
 *     ?GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z @ 0x180058480 (-GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z.c)
 * Callees:
 *     <none>
 */
