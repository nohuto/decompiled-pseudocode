/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCCaptureControllerProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCCaptureControllerProxy@@@Z @ 0x1800BE08C
 * Callers:
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle((__int64)v7, 6u, *(__int64 **)(a1 + 16), a2);
    v9 = v8;
    if ( v8 >= 0 )
      v9 = 0;
    else
