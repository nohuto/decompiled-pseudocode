/*
 * XREFs of ?UpdateMarginsDependentOnStyle@CTopLevelWindow@@AEAA_NXZ @ 0x18001F390
 * Callers:
 *     ?ValidateVisual@CTopLevelWindow@@UEAAJXZ @ 0x18001C900 (-ValidateVisual@CTopLevelWindow@@UEAAJXZ.c)
 * Callees:
 *     ?SetMargin@@YA_NPEAU_MARGINS@@HHHHPEBU1@@Z @ 0x18003A4A0 (-SetMargin@@YA_NPEAU_MARGINS@@HHHHPEBU1@@Z.c)
...
_BOOL8 __fastcall CTopLevelWindow::UpdateMarginsDependentOnStyle(CTopLevelWindow *this)
{
  ...
  if ( (unsigned __int8)IsOpenThemeDataPresent()
    ...
    && *(_DWORD *)(v2 + 68) >= dword_1800E3ECC
    && *(_DWORD *)(v2 + 72) >= dword_1800E3ED0
    && *(_DWORD *)(v2 + 76) >= dword_1800E3ED4
