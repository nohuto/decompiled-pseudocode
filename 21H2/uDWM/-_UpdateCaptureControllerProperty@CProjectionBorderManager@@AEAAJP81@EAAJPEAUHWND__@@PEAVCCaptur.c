/*
 * XREFs of ?_UpdateCaptureControllerProperty@CProjectionBorderManager@@AEAAJP81@EAAJPEAUHWND__@@PEAVCCaptureControllerProxy@@@Z0@Z @ 0x180092B58
 * Callers:
 ...
 *     ?UpdateCaptureControllerSourceOffset@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z @ 0x180091040 (-UpdateCaptureControllerSourceOffset@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z.c)
 *     ?UpdateCaptureControllerTransform@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z @ 0x180091060 (-UpdateCaptureControllerTransform@CProjectionBorderManager@@UEAAJPEAUHWND__@@@Z.c)
 * Callees:
