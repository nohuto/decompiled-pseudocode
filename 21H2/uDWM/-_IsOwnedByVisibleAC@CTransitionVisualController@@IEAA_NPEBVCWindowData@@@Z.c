/*
 * XREFs of ?_IsOwnedByVisibleAC@CTransitionVisualController@@IEAA_NPEBVCWindowData@@@Z @ 0x180008328
 * Callers:
...
LABEL_5:
    a2 = (const struct CWindowData *)*((_QWORD *)a2 + 67);
    if ( !a2 )
      break;
    this = (CTransitionVisualController *)(*((_DWORD *)a2 + 154) & 0xFFF);
    if ( (_DWORD)this != 4095 && (*((_DWORD *)a2 + 154) & 0x10000000) == 0 )
      break;
  }
  while ( *((_QWORD *)a2 + 5) );
  return v4;
