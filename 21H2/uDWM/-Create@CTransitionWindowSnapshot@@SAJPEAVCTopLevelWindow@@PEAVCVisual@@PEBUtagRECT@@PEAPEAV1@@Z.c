        ...
        struct CTransitionWindowSnapshot **a4)
{
  ...
  if ( dword_1800E6A70 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6A70);
    if ( dword_1800E6A70 == -1 )
    {
      dword_1800E3F38 = -2147023434;
      Init_thread_footer(&dword_1800E6A70);
    }
  }
  *a4 = 0LL;
