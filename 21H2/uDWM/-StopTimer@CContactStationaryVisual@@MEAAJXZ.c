/*
 * XREFs of ?StopTimer@CContactStationaryVisual@@MEAAJXZ @ 0x1800A20E0
 * Callers:
 ...
 *     ?Stop@CContactStationaryVisual@@UEAAXXZ @ 0x1800A20B0 (-Stop@CContactStationaryVisual@@UEAAXXZ.c)
