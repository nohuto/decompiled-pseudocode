/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_1_dll @ 0x1800542F7
 * Callers:
 *     __imp_load_GetSystemMetricsForDpi @ 0x1800542EB (__imp_load_GetSystemMetricsForDpi.c)
 * Callees:
