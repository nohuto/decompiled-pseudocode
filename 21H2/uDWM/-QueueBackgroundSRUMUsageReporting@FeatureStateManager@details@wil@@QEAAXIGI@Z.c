/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x18007EF28
 * Callers:
        ...
        int a4)
{
  ...
  int v10; // [rsp+28h] [rbp-50h] BYREF
  __int16 v11; // [rsp+2Ch] [rbp-4Ch]
  ...
  if ( *(_BYTE *)pv && !wil::ProcessShutdownInProgress((wil *)pv) )
  {
    ...
    v11 = a3;
    v13 = a4;
    wil::details_abi::heap_buffer::push_back((void **)pv + 31, &v10, 0xCuLL);
    if ( !*((_BYTE *)pv + 64) )
    {
      if ( !*((_QWORD *)pv + 7) )
      {
