/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x1800A0258
 * Callers:
 ...
 *     ?LoadPenResources@CContactManager@@AEAAXXZ @ 0x18009E51C (-LoadPenResources@CContactManager@@AEAAXXZ.c)
