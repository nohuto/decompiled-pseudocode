/*
 * XREFs of ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x1800A60A0
 * Callers:
 ...
 * Callees:
 *     ?CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z @ 0x1800A5FB0 (-CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z.c)
 *     ?UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ @ 0x1800A61C8 (-UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ.c)
 */
