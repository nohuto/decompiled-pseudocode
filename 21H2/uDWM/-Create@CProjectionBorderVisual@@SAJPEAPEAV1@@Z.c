/*
 * XREFs of ?Create@CProjectionBorderVisual@@SAJPEAPEAV1@@Z @ 0x18008E618
 * Callers:
...
__int64 __fastcall CProjectionBorderVisual::Create(struct CProjectionBorderVisual **a1)
{
  ...
  v3 = (char *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                 WPF::g_pProcessHeap,
                 304LL);
  v4 = v3;
  if ( v3 )
  {
    ...
    CRenderDataVisual::CRenderDataVisual((CRenderDataVisual *)v4);
