/*
 * XREFs of ?CloneVisualTreeForLivePreview@CTopLevelWindow@@QEAAJ_N00PEAPEAV1@@Z @ 0x18002CED0
 * Callers:
        ...
        struct CTopLevelWindow **a5)
{
    ...
    if ( *(_QWORD *)v14 )
    {
      ...
      *(_BYTE *)(v15 + 84) |= v9;
      if ( !a2 )
      {
        ...
        if ( v19 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x1439u);
          goto LABEL_26;
        }
      }
    }
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x144Du);
  }
  else
  {
