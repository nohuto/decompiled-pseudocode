/*
 * XREFs of ?InitializeVisualTreeClone@CTopLevelWindow@@IEAAJPEAV1@W4CloneOptions@@@Z @ 0x18002A42C
 * Callers:
 ...
 *     ?SetShadowOpacity@CTopLevelWindow@@QEAAXM@Z @ 0x18002B2A8 (-SetShadowOpacity@CTopLevelWindow@@QEAAXM@Z.c)
