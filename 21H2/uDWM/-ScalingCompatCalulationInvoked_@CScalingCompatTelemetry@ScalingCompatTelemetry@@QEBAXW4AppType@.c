/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x1800C18E0
 * Callers:
 *     ??$ScalingCompatCalulationInvoked@AEAW4AppType@ScalingCompatTelemetry@@AEAIAEAI@CScalingCompatTelemetry@ScalingCompatTelemetry@@SAXAEAW4AppType@1@AEAI1@Z @ 0x1800C152C (--$ScalingCompatCalulationInvoked@AEAW4AppType@ScalingCompatTelemetry@@AEAIAEAI@CScalingCompatTe.c)
 * Callees:
 ...
 *     _tlgWriteTransfer_EventWriteTransfer @ 0x1800C1A54 (_tlgWriteTransfer_EventWriteTransfer.c)
 */
        ...
        int a4)
{
  ...
  if ( *v8 > 5u )
  {
    ...
    v16 = 4LL;
    v14 = 4LL;
    return tlgWriteTransfer_EventWriteTransfer((int)v8, (int)&dword_1800D1FEE, 0, 0, 5u, &v12);
  }
  return result;
}
