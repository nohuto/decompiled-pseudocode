/*
 * XREFs of ?Create@CSecondaryWindowRepresentation@@SAJU?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@PEAUISecondaryWindowRepresentationChangedListener@@PEAVCWindowData@@IW4DEVICE_SCALE_FACTOR@@PEAPEAV1@@Z @ 0x180027648
 * Callers:
 ...
 *     ??0CSecondaryWindowRepresentation@@IEAA@XZ @ 0x180027818 (--0CSecondaryWindowRepresentation@@IEAA@XZ.c)
