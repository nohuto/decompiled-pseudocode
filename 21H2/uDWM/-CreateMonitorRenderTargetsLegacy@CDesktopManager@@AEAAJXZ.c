/*
 * XREFs of ?CreateMonitorRenderTargetsLegacy@CDesktopManager@@AEAAJXZ @ 0x180037AFC
 * Callers:
 ...
 *     ?IsTsDisplay@CDWMDisplay@@QEBA_NXZ @ 0x180039984 (-IsTsDisplay@CDWMDisplay@@QEBA_NXZ.c)
