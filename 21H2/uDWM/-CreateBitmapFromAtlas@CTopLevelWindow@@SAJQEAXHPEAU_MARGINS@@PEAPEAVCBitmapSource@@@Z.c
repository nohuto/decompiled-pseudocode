/*
 * XREFs of ?CreateBitmapFromAtlas@CTopLevelWindow@@SAJQEAXHPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x180049798
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  if ( dword_1800E6DBC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6DBC);
    if ( dword_1800E6DBC == -1 )
    {
      dword_1800E4000 = -2147023728;
      Init_thread_footer(&dword_1800E6DBC);
    }
  }
  if ( a3 && (ThemeMargins = GetThemeMargins(a1, 0LL, iPartId, 0, 3601, 0LL, a3), v9 = ThemeMargins, ThemeMargins < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4000, 1LL, ThemeMargins, 0x1BAu);
  }
  else
  {
    ...
    if ( ThemeRect < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4000, 1LL, ThemeRect, 0x1BEu);
    }
    else
    {
      ...
      v9 = v12;
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4000, 1LL, v12, 0x1C6u);
    }
  }
  return v9;
}
