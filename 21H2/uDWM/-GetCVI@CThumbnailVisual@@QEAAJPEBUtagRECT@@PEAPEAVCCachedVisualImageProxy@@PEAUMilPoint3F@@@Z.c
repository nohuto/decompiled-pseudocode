/*
 * XREFs of ?GetCVI@CThumbnailVisual@@QEAAJPEBUtagRECT@@PEAPEAVCCachedVisualImageProxy@@PEAUMilPoint3F@@@Z @ 0x1800940FC
 * Callers:
 ...
 *     ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z @ 0x1800944BC (-s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z.c)
