/*
 * XREFs of ?ScheduleStartAnimation@CAnimationEngine@@QEAAJHPEAPEAUIAnimatedVisual@@IPEAI@Z @ 0x180035F54
 * Callers:
...
LABEL_10:
      ...
      v18 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 40, 8u, 1, &v22);
      v13 = v18;
      if ( v18 < 0 )
