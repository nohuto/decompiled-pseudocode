/*
 * XREFs of ?AbandonTransition@CAnimationScheduler@@QEAAJH@Z @ 0x180008F04
 * Callers:
 ...
 *     ?OnEndTransitionRequest@CDialogSwitch@@UEAAJXZ @ 0x1800B0330 (-OnEndTransitionRequest@CDialogSwitch@@UEAAJXZ.c)
