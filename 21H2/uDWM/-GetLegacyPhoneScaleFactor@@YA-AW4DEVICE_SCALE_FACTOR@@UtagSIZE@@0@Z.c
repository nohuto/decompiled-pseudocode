/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1800C17B8
 * Callers:
 ...
 * Callees:
 *     ?LoadScalingOverrides@@YAXXZ @ 0x180040874 (-LoadScalingOverrides@@YAXXZ.c)
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x1800C164C (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
