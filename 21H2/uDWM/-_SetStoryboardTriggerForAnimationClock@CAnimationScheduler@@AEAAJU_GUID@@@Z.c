/*
 * XREFs of ?_SetStoryboardTriggerForAnimationClock@CAnimationScheduler@@AEAAJU_GUID@@@Z @ 0x1800337A0
 * Callers:
 ...
 *     ?UseDComposition@CStoryboard@@QEAA_NXZ @ 0x180033964 (-UseDComposition@CStoryboard@@QEAA_NXZ.c)
