/*
 * XREFs of ?UpdateTransition@CIndirectTouchVisual@@MEAAJXZ @ 0x1800AE3C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ @ 0x1800AE27C (-StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ.c)
