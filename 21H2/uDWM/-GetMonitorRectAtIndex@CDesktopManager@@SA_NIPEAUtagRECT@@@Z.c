/*
 * XREFs of ?GetMonitorRectAtIndex@CDesktopManager@@SA_NIPEAUtagRECT@@@Z @ 0x180093C0C
 * Callers:
...
bool __fastcall CDesktopManager::GetMonitorRectAtIndex(unsigned int a1, struct tagRECT *a2)
{
  ...
  *a2 = 0LL;
  result = 0;
  if ( a1 < *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 38) )
  {
    v4 = a1;
    v5 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 16);
