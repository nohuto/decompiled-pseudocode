/*
 * XREFs of ?OnWindowOffsetUpdated@CSecondaryWindowRepresentation@@QEAAXXZ @ 0x18002CCEC
 * Callers:
 ...
 *     ?GetOffsetToOwner@CWindowData@@QEAA?AUtagPOINT@@XZ @ 0x18002CD90 (-GetOffsetToOwner@CWindowData@@QEAA-AUtagPOINT@@XZ.c)
 */
