/*
 * XREFs of ?EnsureWindowFrames@CTopLevelWindow@@CAJXZ @ 0x1800371E0
 * Callers:
 ...
 *     ??0WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x18004F35C (--0WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
...
__int64 CTopLevelWindow::EnsureWindowFrames(void)
{
  ...
  if ( !dword_1800E6D68 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v4 )
        break;
      v5 = dword_1800E6D68 + 1;
      if ( dword_1800E6D68 + 1 < (unsigned int)dword_1800E6D68 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0xB5u);
      }
      else if ( v5 > dword_1800E6D64 )
      {
      ...
      {
        *(_QWORD *)(CTopLevelWindow::s_rgpwfWindowFrames + 8LL * (unsigned int)dword_1800E6D68) = v4;
        dword_1800E6D68 = v5;
      }
