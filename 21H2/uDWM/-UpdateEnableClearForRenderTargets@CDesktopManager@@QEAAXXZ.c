/*
 * XREFs of ?UpdateEnableClearForRenderTargets@CDesktopManager@@QEAAXXZ @ 0x180087764
 * Callers:
 ...
 *     ?ShouldClearRenderTargets@CWindowList@@QEBA_NXZ @ 0x180099F2C (-ShouldClearRenderTargets@CWindowList@@QEBA_NXZ.c)
 */
