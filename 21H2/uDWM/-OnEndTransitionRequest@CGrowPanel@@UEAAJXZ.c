/*
 * XREFs of ?OnEndTransitionRequest@CGrowPanel@@UEAAJXZ @ 0x1800B03E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGrowPanel::OnEndTransitionRequest(CGrowPanel *this)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    v3 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v4, 0x5C3u);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v2, 0x5C2u);
  }
  return v3;
}
