/*
 * XREFs of ?HrCreateBitmapFromWICBitmapSource@@YAJPEAUIWICBitmapSource@@PEAPEAVIBitmapSource@@@Z @ 0x18004FF0C
 * Callers:
 ...
 *     ??0CWICBitmapWrapper@@QEAA@XZ @ 0x180050200 (--0CWICBitmapWrapper@@QEAA@XZ.c)
