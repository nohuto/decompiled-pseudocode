/*
 * XREFs of ??_G?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x18007E028
 * Callers:
 ...
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x18007EEE0 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 */
