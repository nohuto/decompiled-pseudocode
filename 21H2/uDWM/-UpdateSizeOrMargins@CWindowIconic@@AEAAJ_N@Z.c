/*
 * XREFs of ?UpdateSizeOrMargins@CWindowIconic@@AEAAJ_N@Z @ 0x1800447B8
 * Callers:
 ...
 *     ?RectHeight@@YAHAEBUtagRECT@@@Z @ 0x18008090C (-RectHeight@@YAHAEBUtagRECT@@@Z.c)
 *     ?RectWidth@@YAHAEBUtagRECT@@@Z @ 0x180080924 (-RectWidth@@YAHAEBUtagRECT@@@Z.c)
