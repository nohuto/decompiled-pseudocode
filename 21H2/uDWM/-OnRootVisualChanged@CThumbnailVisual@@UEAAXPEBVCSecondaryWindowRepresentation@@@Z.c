/*
 * XREFs of ?OnRootVisualChanged@CThumbnailVisual@@UEAAXPEBVCSecondaryWindowRepresentation@@@Z @ 0x18000E190
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSecondaryWindowRepresentation *a2)
{
  ...
  CThumbnailVisual::SetDirtyFlags((CThumbnailVisual *)((char *)this - 360), 0x2000u);
}
