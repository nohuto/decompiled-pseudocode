/*
 * XREFs of ?ProcessTouchContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x1800A0434
 * Callers:
 ...
 *     ?CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z @ 0x18009DB80 (-CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z.c)
 ...
 *     ?IsOKToCleanup@CPressTapVisual@@UEAA_NXZ @ 0x18009E430 (-IsOKToCleanup@CPressTapVisual@@UEAA_NXZ.c)
 ...
 *     ?IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ @ 0x1800A1544 (-IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ.c)
 ...
 *     ?SetContactPosition@CTextTetherVisual@@QEAAJAEBUtagPOINT@@AEBUtagRECT@@@Z @ 0x1800A2850 (-SetContactPosition@CTextTetherVisual@@QEAAJAEBUtagPOINT@@AEBUtagRECT@@@Z.c)
 ...
 *     ?UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z @ 0x1800A4C88 (-UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z.c)
 ...
 *     ?IsHolding@CTouchPressHoldVisual@@QEAA_NXZ @ 0x1800B8570 (-IsHolding@CTouchPressHoldVisual@@QEAA_NXZ.c)
 *     ?IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ @ 0x1800B85A0 (-IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ.c)
 */
