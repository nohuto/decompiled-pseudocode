/*
 * XREFs of ?GDISurfaceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001A880
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v24, 0x88Fu);
  v7 = v5;
  if ( v5 < 0 )
  {
LABEL_32:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x140Cu);
    goto LABEL_16;
  }
  if ( v4 )
  {
    ...
    if ( *((_DWORD *)v4 + 114) )
    {
      ...
      if ( (int)DynArrayImpl<0>::AddMultipleAndSet(&v25, 8LL, v17, v16) >= 0 )
      {
        ...
        if ( v27 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1EFCu);
        }
      }
LABEL_22:
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1418u);
    }
    else
    {
      v13 = *((_QWORD *)v4 + 15);
      ...
      if ( *((_QWORD **)v4 + 5) == v14 )
      {
        ...
        v7 = updated;
        if ( updated < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x141Du);
      }
    }
  }
LABEL_16:
