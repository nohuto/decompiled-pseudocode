/*
 * XREFs of ?Create@CFullScreenMagnifier@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x180047A10
 * Callers:
 ...
 *     ??0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z @ 0x180047AA0 (--0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z.c)
