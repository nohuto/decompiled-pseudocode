/*
 * XREFs of ?get@?$static_lazy@VScalingCompatLogging@@@details@wil@@QEAAPEAVScalingCompatLogging@@P6AXXZ@Z @ 0x1800C19B0
 * Callers:
 ...
 *     InitOnceComplete_0 @ 0x180053E02 (InitOnceComplete_0.c)
 */
...
_QWORD *__fastcall wil::details::static_lazy<ScalingCompatLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  {
    v6 = qword_1800E6B38;
    qword_1800E6B38[0] = &WindowFrameLogging::`vftable';
    qword_1800E6B50 = (struct _tlgProvider_t *)&`ScalingCompatLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1800E6B38, qword_1800E6B50, v3);
    InitOnceComplete_0(&`ScalingCompatLogging::Instance'::`2'::wrapper, 0, qword_1800E6B38);
  }
  return v6;
}
