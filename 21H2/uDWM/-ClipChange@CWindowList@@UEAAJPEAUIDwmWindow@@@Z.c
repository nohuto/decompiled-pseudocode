/*
 * XREFs of ?ClipChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800166A0
 * Callers:
...
__int64 __fastcall CWindowList::ClipChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x139Fu);
  }
  else
  {
    v6 = v17;
    if ( v17 && *((_QWORD *)v17 + 4) )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x13A9u);
      }
      else
      {
        if ( *v7 )
              ...
              ProxyFromShared >= 0) )
        {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x13B4u);
          }
          else if ( v8 != (*v7 != 0LL) )
          {
            ...
            v5 = v14;
            if ( v14 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x13BCu);
            else
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, ProxyFromShared, 0x13ADu);
        }
      }
    }
  }
