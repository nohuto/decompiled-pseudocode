/*
 * XREFs of ??_ECAnimatedTransitionVisual@@MEAAPEAXI@Z @ 0x180034C8C
 * Callers:
 *     ??_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z @ 0x180058250 (--_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z.c)
 * Callees:
