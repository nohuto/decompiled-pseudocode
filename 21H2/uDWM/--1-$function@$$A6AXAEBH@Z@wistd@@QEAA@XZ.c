/*
 * XREFs of ??1?$function@$$A6AXAEBH@Z@wistd@@QEAA@XZ @ 0x18004AD88
 * Callers:
 ...
 *     ??1?$wnf_subscription_state@H@details@wil@@UEAA@XZ @ 0x180096088 (--1-$wnf_subscription_state@H@details@wil@@UEAA@XZ.c)
 * Callees:
 *     <none>
 */
