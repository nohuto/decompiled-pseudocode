/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKHPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x18008B898
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a6)
{
  ...
  if ( *((_DWORD *)this + 42) )
  {
    ...
    if ( v9 )
      v8 = v7;
    v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, __int64, int, _DWORD, const struct MAGN_UPDATE_TEXTURES_PARAM *, char *))(**(_QWORD **)(v11 + 16) + 656LL))(
            *(_QWORD *)(v11 + 16),
            *(unsigned int *)(v11 + 24),
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D2FB8, 8LL, v12, 0x1E2u);
    }
  }
  else
  {
