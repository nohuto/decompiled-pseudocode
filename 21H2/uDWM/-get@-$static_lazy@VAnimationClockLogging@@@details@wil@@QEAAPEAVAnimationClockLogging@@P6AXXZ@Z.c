/*
 * XREFs of ?get@?$static_lazy@VAnimationClockLogging@@@details@wil@@QEAAPEAVAnimationClockLogging@@P6AXXZ@Z @ 0x18002E124
 * Callers:
...
_QWORD *__fastcall wil::details::static_lazy<AnimationClockLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  {
    v6 = qword_1800E6AA0;
    qword_1800E6AA0[0] = &WindowFrameLogging::`vftable';
    qword_1800E6AB8 = (struct _tlgProvider_t *)&`AnimationClockLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1800E6AA0, qword_1800E6AB8, v4);
    InitOnceComplete(&`AnimationClockLogging::Instance'::`2'::wrapper, 0, qword_1800E6AA0);
  }
  return v6;
}
