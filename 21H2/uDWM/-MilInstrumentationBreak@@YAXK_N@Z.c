/*
 * XREFs of ?MilInstrumentationBreak@@YAXK_N@Z @ 0x1800BF708
 * Callers:
 ...
 * Callees:
 *     ?RegGetHKLMDword@@YA_NQEBG0PEAK@Z @ 0x180053308 (-RegGetHKLMDword@@YA_NQEBG0PEAK@Z.c)
 *     ?IsKernelDebuggerEnabled@@YAHXZ @ 0x1800BF63C (-IsKernelDebuggerEnabled@@YAHXZ.c)
