/*
 * XREFs of ?SetColorTransform@CMagnifierRenderTargetProxy@@QEAAJPEBVCColorTransformResourceProxy@@@Z @ 0x1800BE754
 * Callers:
        ...
        const struct CColorTransformResourceProxy *a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 680LL))(
