/*
 * XREFs of ?get@?$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z @ 0x180081518
 * Callers:
...
_QWORD *__fastcall wil::details::static_lazy<UDwmTrace>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  {
    v6 = qword_1800E6A00;
    qword_1800E6A00[0] = &WindowFrameLogging::`vftable';
    qword_1800E6A18 = (struct _tlgProvider_t *)&`UDwmTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1800E6A00, qword_1800E6A18, v3);
    InitOnceComplete(&`UDwmTrace::Instance'::`2'::wrapper, 0, qword_1800E6A00);
  }
  return v6;
}
