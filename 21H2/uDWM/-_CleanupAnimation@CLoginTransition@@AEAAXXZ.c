/*
 * XREFs of ?_CleanupAnimation@CLoginTransition@@AEAAXXZ @ 0x18000A40C
 * Callers:
...
void __fastcall CLoginTransition::_CleanupAnimation(CLoginTransition *this)
{
  ...
  if ( *((_QWORD *)this + 1) )
    CVisual::SetOffset(*((CVisual **)this + 4), &stru_1800CA7B8);
  if ( *((_QWORD *)this + 2) )
    CVisual::SetOffset(*((CVisual **)this + 5), &stru_1800CA7B8);
  v4 = *((_QWORD *)this + 6);
  if ( v4 )
  {
