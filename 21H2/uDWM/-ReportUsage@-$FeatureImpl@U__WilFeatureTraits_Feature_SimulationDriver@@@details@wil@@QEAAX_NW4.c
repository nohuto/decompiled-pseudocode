/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18004D52C
 * Callers:
...
__int64 wil::details::FeatureImpl<__WilFeatureTraits_Feature_SimulationDriver>::ReportUsage(
        _DWORD *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_SimulationDriver>::GetCachedFeatureEnabledState(
                      a1,
                      (__int64 *)va);
    v9 = v3;
  }
