/*
 * XREFs of ?_MoveWindowOffscreen@CTransitionVisualController@@KAXPEAVCTopLevelWindow@@_N@Z @ 0x18002CDC4
 * Callers:
      ...
      if ( a2 != *(_BYTE *)(v6 + 35) )
      {
        ...
        *(_BYTE *)(v6 + 35) = a2;
        if ( v7 )
        {
          ...
          if ( updated < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x20F2u);
        }
      }
