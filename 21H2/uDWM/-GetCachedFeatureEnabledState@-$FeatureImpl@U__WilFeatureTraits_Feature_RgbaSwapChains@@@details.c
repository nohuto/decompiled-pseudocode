/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004D770
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180039314 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@QEAAX_NW4Re.c)
 * Callees:
