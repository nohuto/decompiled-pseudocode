/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x180048C5C
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x18004949C (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  v6 = a1;
  v43 = a1;
  if ( dword_1800E6DC8 > *(_DWORD *)(ThreadLocalStoragePointer[tls_index] + 4LL) )
  {
    Init_thread_header(&dword_1800E6DC8);
    if ( dword_1800E6DC8 == -1 )
    {
      dword_1800E3FF4 = -2147023728;
      Init_thread_footer(&dword_1800E6DC8);
    }
  }
  ...
  if ( ThemeMargins < 0 )
  {
    iPropId = 990;
LABEL_59:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E3FF4, 1LL, ThemeMargins, iPropId);
    return v11;
  }
