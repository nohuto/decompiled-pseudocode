/*
 * XREFs of ?OnMagnifierCreate@CMagnifierControl@@AEAAJPEAUHWND__@@H@Z @ 0x18008CC1C
 * Callers:
 ...
 *     ?FindElement@?$CGenericTableMap@PEAUHWND__@@VMagnifierTableElement@CMagnifierControl@@@@QEAAPEAVMagnifierTableElement@CMagnifierControl@@PEAUHWND__@@@Z @ 0x18008C318 (-FindElement@-$CGenericTableMap@PEAUHWND__@@VMagnifierTableElement@CMagnifierControl@@@@QEAAPEAV.c)
...
__int64 __fastcall CMagnifierControl::OnMagnifierCreate(struct CVisual **this, HWND a2, int a3)
{
  ...
  if ( dword_1800E6FF0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6FF0);
    if ( dword_1800E6FF0 == -1 )
    {
      dword_1800E6F2C = -2147023728;
      Init_thread_footer(&dword_1800E6FF0);
    }
  }
  v19 = 0LL;
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F2C, 1LL, -2147024809, 0x278u);
    return v8;
  }
...
LABEL_7:
    v9 = IsMagnifier;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F2C, 1LL, v9, v17);
    goto LABEL_21;
  }
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F2C, 1LL, -2147024882, 0x272u);
