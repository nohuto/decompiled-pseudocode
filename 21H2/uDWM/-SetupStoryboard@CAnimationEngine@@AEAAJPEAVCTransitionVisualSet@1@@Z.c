/*
 * XREFs of ?SetupStoryboard@CAnimationEngine@@AEAAJPEAVCTransitionVisualSet@1@@Z @ 0x180029478
 * Callers:
 ...
 *     ?_CalculateStaggerDelay@CAnimationEngine@@AEAAXPEAXHHIPEAN@Z @ 0x180041BAC (-_CalculateStaggerDelay@CAnimationEngine@@AEAAXPEAXHHIPEAN@Z.c)
        ...
        struct CAnimationEngine::CTransitionVisualSet *a2)
{
  ...
  struct TA_TIMINGFUNCTION *v111; // [rsp+A0h] [rbp-68h]
          ...
          if ( v43 )
          {
            ...
            if ( v44 )
            {
                  ...
                  else
                  {
                    ...
                    if ( (*(_BYTE *)(v5 + 16) & 1) != 0 )
                    {
                      ...
                      *(double *)&v144 = (double)(v36 - v118);
                      ...
                      v75 = (struct IUIAnimationStoryboard2 *)*((_QWORD *)a2 + 4);
                    ...
                    else
                    {
                      ...
                      *((double *)&v144 + 1) = v79;
                      ...
                      LODWORD(v9) = v108;
                      v81 = *((_DWORD *)a2 + 4);
                      v82 = (struct IUIAnimationStoryboard2 *)*((_QWORD *)a2 + 4);
                      v145 = v80;
                      ThemeTimingFunction = CAnimationEngine::AddToStoryboard(
                                              (__int64)v115,
                                              v82,
              ...
              else
              {
                ...
                LODWORD(v9) = v108;
                v48 = *((_DWORD *)a2 + 4);
                v49 = (struct IUIAnimationStoryboard2 *)*((_QWORD *)a2 + 4);
                v137[0] = v46;
                v136 = v47;
                ThemeTimingFunction = CAnimationEngine::AddToStoryboard(
                                        (__int64)v115,
          ...
          else
          {
            ...
            ThemeTimingFunction = CAnimationEngine::AddToStoryboard(
                                    ...
                                    *((_DWORD *)a2 + 4),
                                    ...
                                    (double *)((unsigned __int64)&v130 & -(__int64)v105),
                                    v51);
            ThemeAnimationTransform = ThemeTimingFunction;
            if ( ThemeTimingFunction < 0 )
            {
