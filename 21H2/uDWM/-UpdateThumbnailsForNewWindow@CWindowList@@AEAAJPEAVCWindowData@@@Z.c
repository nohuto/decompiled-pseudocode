/*
 * XREFs of ?UpdateThumbnailsForNewWindow@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x18003EBEC
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 124) )
  {
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x16C9u);
          return v2;
        }
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x16BEu);
  }
  else
  {
LABEL_2:
