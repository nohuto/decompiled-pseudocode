/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CacheHighContrastStateInDwm@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180086B84
 * Callers:
  ...
  if ( (v2 & 6) != 6 )
  {
    ...
    for ( i = v7; ; v7 = i )
    {
      *a2 = v6;
      ...
      if ( v7 && (v6 & 2) == 0 )
      {
        v9 = v6 ^ ((unsigned __int16)v16 ^ (unsigned __int16)v6) & 0x9C1 | 2;
        *a2 = v9;
      }
      v10 = v6 & 4;
      if ( (v6 & 4) == 0 )
      {
        v9 = ((unsigned __int16)v16 ^ (unsigned __int16)v9) & 0x400 ^ v9 | 4;
        *a2 = v9;
      }
