/*
 * XREFs of ?UpdateSettings@CDesktopManager@@QEAAJK@Z @ 0x180036E1C
 * Callers:
 ...
 *     ?UpdateWindowShadows@CDesktopManager@@QEAAXXZ @ 0x18004BCF0 (-UpdateWindowShadows@CDesktopManager@@QEAAXXZ.c)
  ...
  if ( (v6 & 1) != 0 )
  {
    ...
    *((_DWORD *)this + 114) = GetSystemMetrics(79);
    ...
    else
    {
      ...
      dword_1800E3ED0 = GetSystemMetrics(6);
      dword_1800E3ECC = CTopLevelWindow::s_marMinInflationThickness.cxLeftWidth;
      dword_1800E3ED4 = dword_1800E3ED0;
    }
    if ( Theme < 0 )
    {
