/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x18009DF1C
 * Callers:
 ...
 *     ?Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z @ 0x1800A6120 (-Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z.c)
 */
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v14, ModuleHandleW, dword_1800D3340[v12], &v28);
        if ( !v5 )
        {
          v27 = 1772;
LABEL_12:
