/*
 * XREFs of ?RegGetHKLMDword@@YA_NQEBG0PEAK@Z @ 0x180053308
 * Callers:
 *     ?ForceHighColor@@YAKXZ @ 0x1800392CC (-ForceHighColor@@YAKXZ.c)
 *     ?MilInstrumentationBreak@@YAXK_N@Z @ 0x1800BF708 (-MilInstrumentationBreak@@YAXK_N@Z.c)
 * Callees:
 *     ?RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z @ 0x18005338C (-RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z.c)
 */
