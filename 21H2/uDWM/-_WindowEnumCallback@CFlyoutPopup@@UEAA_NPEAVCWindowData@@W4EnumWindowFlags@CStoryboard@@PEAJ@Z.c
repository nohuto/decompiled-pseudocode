/*
 * XREFs of ?_WindowEnumCallback@CFlyoutPopup@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180003B50
 * Callers:
...
char __fastcall CFlyoutPopup::_WindowEnumCallback(CStoryboard *a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( v11 >= 0 )
  {
    v12 = v36;
    v13 = *(HWND *)(a2 + 40);
    v40 = *(struct tagRECT *)((char *)v36 + 88);
    rc = v40;
    ...
    if ( WindowEndCloak >= 0 )
    {
      ...
      v19 = *(_DWORD *)(a2 + 616);
      if ( (v19 & 0x1000000) != 0 )
        rc = *(struct tagRECT *)(a2 + 636);
      if ( (v19 & 0x800000) != 0 )
        v40 = *(struct tagRECT *)(a2 + 668);
      CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v12 + 5), &rc);
      v20 = (struct tagRECT *)*((_QWORD *)v12 + 5);
      v20[54] = v40;
      CVisual::SetDirtyFlags((CVisual *)&v20->right, 0x1000u);
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v24, 0x4F9u, v32);
      v4 = v37;
    }
    else
    {
      ...
      if ( v37 )
      {
        ...
        v28 = (struct tagRECT *)*((_QWORD *)v4 + 5);
        v28[54] = v40;
        CVisual::SetDirtyFlags((CVisual *)&v28->right, 0x1000u);
        *(_BYTE *)(*((_QWORD *)v4 + 5) + 979LL) = 1;
        *((_BYTE *)v4 + 74) = 1;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v11, 0x4D3u, v32);
LABEL_29:
  v12 = v36;
LABEL_30:
  if ( v12 )
