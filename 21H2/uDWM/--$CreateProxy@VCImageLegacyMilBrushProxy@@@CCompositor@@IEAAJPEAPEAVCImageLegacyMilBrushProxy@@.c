/*
 * XREFs of ??$CreateProxy@VCImageLegacyMilBrushProxy@@@CCompositor@@IEAAJPEAPEAVCImageLegacyMilBrushProxy@@@Z @ 0x18003C9D8
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CImageLegacyMilBrushProxy>(__int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x10u, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 < 0 )
