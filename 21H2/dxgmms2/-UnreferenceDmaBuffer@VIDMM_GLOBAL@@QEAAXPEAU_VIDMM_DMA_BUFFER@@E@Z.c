/*
 * XREFs of ?UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C0023E98
 * Callers:
 *     VidMmUnreferenceDmaBuffer @ 0x1C00231F0 (VidMmUnreferenceDmaBuffer.c)
