/*
 * XREFs of ?Run@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C008EC90
 * Callers:
 *     ?VidMmWorkerThreadProc@@YAXPEAX@Z @ 0x1C0099CD0 (-VidMmWorkerThreadProc@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     ?GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z @ 0x1C0001DB0 (-GetNextPendingTermination@VIDMM_GLOBAL@@QEAAPEAUVIDMM_ALLOC@@PEA_N@Z.c)
 *     ?Release@DXGAUTOEXPUSHLOCK@@QEAAXXZ @ 0x1C0002468 (-Release@DXGAUTOEXPUSHLOCK@@QEAAXXZ.c)
 ...
 *     ?CleanupMarkedForEvictionAllocationsWorker@VIDMM_GLOBAL@@QEAAEXZ @ 0x1C0061C7C (-CleanupMarkedForEvictionAllocationsWorker@VIDMM_GLOBAL@@QEAAEXZ.c)
 ...
 *     ?ResetCleanupCounters@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C008AC14 (-ResetCleanupCounters@VIDMM_GLOBAL@@QEAAX_N@Z.c)
 ...
 *     ?GetDefragSegment@VIDMM_GLOBAL@@QEAAPEAVVIDMM_SEGMENT@@GI@Z @ 0x1C00B00F8 (-GetDefragSegment@VIDMM_GLOBAL@@QEAAPEAVVIDMM_SEGMENT@@GI@Z.c)
 *     ?FullySuspend@VIDMM_DEVICE@@IEAAXXZ @ 0x1C00B7DC0 (-FullySuspend@VIDMM_DEVICE@@IEAAXXZ.c)
 *     ?IsBetterYieldCandidate@VIDMM_DEVICE@@QEAA_NPEAV1@@Z @ 0x1C00B7FFC (-IsBetterYieldCandidate@VIDMM_DEVICE@@QEAA_NPEAV1@@Z.c)
 ...
 *     ?RewindPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00BBCE4 (-RewindPacket@VIDMM_PAGING_QUEUE@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z.c)
 *     ?Init@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAUVIDMM_ALLOC@@@Z @ 0x1C00BF974 (-Init@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAUVIDMM_ALLOC@@@Z.c)
 ...
 *     ?TrimOfferLists@VIDMM_SEGMENT@@QEAAJU_VIDMM_TRIM_PROCESS_FLAGS@@_K1@Z @ 0x1C00C9A94 (-TrimOfferLists@VIDMM_SEGMENT@@QEAAJU_VIDMM_TRIM_PROCESS_FLAGS@@_K1@Z.c)
 *     ?AssignBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1C00CA9CC (-AssignBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z.c)
...
LABEL_2:
    ...
    *(_QWORD *)(v13 + 4616) = v14 * KeQueryTimeIncrement();
    ...
    if ( v17 - *(_QWORD *)(*(_QWORD *)v1 + 7168LL) > qword_1C00503A0 )
    {
      *(_QWORD *)(v16 + 7152) = 0LL;
      *(_DWORD *)(v16 + 7160) = 0;
      *(_QWORD *)(v16 + 7168) = v17;
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v35, 0LL) )
    {
      if ( bTracingEnabled )
      {
        ...
        if ( v166 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
          McTemplateK0q_EtwWriteTransfer(v36, (const EVENT_DESCRIPTOR *)"g", v37, v166);
      }
...
LABEL_34:
            ...
            if ( !v25 || *(_QWORD *)(*(_QWORD *)this + 4616LL) - *((_QWORD *)this + 31) < qword_1C0050460 )
            {
...
LABEL_177:
        ...
        v49 = (char *)&unk_1C00443F0 + v48;
        v262 = (char *)&unk_1C00443F0 + v48;
        if ( !v32 )
        {
          if ( !v25 )
          {
...
LABEL_452:
        ...
        if ( g_IsInternalReleaseOrDbg )
          WdLogNewEntry5_WdTrace(v9);
        if ( !dword_1C0050510 || KdRefreshDebuggerNotPresent() )
          goto LABEL_441;
      ...
      do
      {
        ...
        if ( (*(_BYTE *)(v53 + 1584LL * v52 + 512) & 1) != 0 )
        {
          ...
          while ( i )
          {
            ...
            if ( v57 )
            {
              ...
              if ( (__int64)(100 - v58) < (unsigned int)dword_1C0050438 )
                v59 = 1;
            }
        ...
        else
        {
          ...
          if ( v62 )
          {
            ...
            if ( (__int64)(100 - v140) < (unsigned int)dword_1C0050438 )
              v63 = 1;
          }
          if ( v63 != *(_BYTE *)(i + 672) )
          {
        ...
        if ( (*(_BYTE *)(v65 + 1584LL * v52 + 536) & 1) != 0 )
        {
          ...
          while ( j )
          {
            ...
            if ( i )
            {
              ...
              if ( (__int64)(100 - v69) < (unsigned int)dword_1C0050438 )
                v70 = 1;
            }
        ...
        else
        {
          ...
          if ( v96 )
          {
            ...
            if ( (__int64)(100 - v142) < (unsigned int)dword_1C0050438 )
              v97 = 1;
          }
          if ( v97 != *(_BYTE *)(i + 1008) )
          {
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v78, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v167 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            McTemplateK0q_EtwWriteTransfer(v79, (const EVENT_DESCRIPTOR *)"g", v80, v167);
        }
...
LABEL_106:
    ...
    if ( (unsigned int)(*((_DWORD *)v1 + 6) - 3) > 2 )
    {
      if ( dword_1C0050400 )
      {
        ...
        else
        {
          ...
          if ( *((_DWORD *)v82 + 1750) )
          {
            ...
            {
              v265 = 0;
              DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v285, (struct _KTHREAD **)v82 + 5130, 0);
      ...
      if ( qword_1C0050350 )
      {
        ...
        if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx((char *)v85 + 39968, 0LL) )
        {
          if ( bTracingEnabled )
          {
            ...
            if ( v168 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
              McTemplateK0q_EtwWriteTransfer(v87, (const EVENT_DESCRIPTOR *)"g", v88, v168);
          }
        ...
        if ( v89 != v86 )
        {
          if ( (*((_DWORD *)v85 + 1762) & 0x8000) != 0
            || (v137 = *((_QWORD *)v85 + 577) - *((_QWORD *)v85 + 889), v137 >= qword_1C0050350) )
          {
            v170 = 0;
            ...
            if ( *(VIDMM_GLOBAL **)v86 != v86 )
            {
              ...
              do
              {
                ...
                v174 = (VIDMM_GLOBAL *)((char *)v171 - 408);
                v175 = v171;
            ...
            *((_QWORD *)v85 + 889) = *((_QWORD *)v85 + 577);
            v138 = -qword_1C0050350;
            if ( v170 )
              VIDMM_GLOBAL::EndPreparation(v85, 0xFFFFFFFF, 0LL, 0, 0LL, 0LL);
          }
          else
          {
            v138 = v137 - qword_1C0050350;
          }
      ...
      if ( *(_DWORD *)(*(_QWORD *)v1 + 7048LL)
        || *((_QWORD *)v90 + 894) < (unsigned __int64)qword_1C0050390
        && *((_DWORD *)v90 + 1790) < (unsigned int)dword_1C0050398 )
      {
        if ( g_IsInternalReleaseOrDbg )
        {
          WdLogNewEntry5_WdTrace(v9);
        ...
        if ( (*(_DWORD *)(*(_QWORD *)v1 + 7048LL) & 0x8000) != 0 )
        {
          ...
          VIDMM_GLOBAL::EndPreparation(v91, 0xFFFFFFFF, 0LL, 0, 0LL, 0LL);
          v91 = *(VIDMM_GLOBAL **)v1;
        }
        ...
        if ( qword_1C0050348 )
        {
          ...
          else
          {
            ...
            if ( v106 >= qword_1C0050348 )
            {
              ...
              VIDMM_GLOBAL::EndPreparation(v90, 0xFFFFFFFF, 0LL, 0, 0LL, 0LL);
              if ( !v169 )
                *((_BYTE *)v90 + 40170) = 1;
            }
            else
            {
              v92 = v106 - qword_1C0050348;
            }
          }
LABEL_138:
                  ...
                  if ( (*(_BYTE *)(v246 + 436) & 0x40) == 0 )
                  {
                    ...
                    if ( v250 == *(_DWORD *)(v246 + 60) || v250 == *(_DWORD *)(v246 + 44) )
                    {
                      if ( *(_QWORD *)(v246 + 464) != v246 + 464 )
                      {
                        ...
                        VIDMM_GLOBAL::EndPreparation(v102, v245, 0LL, 0, 0LL, 0LL);
                      }
                      VIDMM_GLOBAL::WaitForAllPagingEnginesIdle(v102, v245);
