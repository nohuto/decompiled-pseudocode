/*
 * XREFs of ?CommitVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_MAPPED_VA_RANGE@@II_KPEAU_MDL@@W4VIDMM_FLUSH_TLB_MODE@@PEAPEAUVIDMM_ALLOC@@PEA_N@Z @ 0x1C006FD28
 * Callers:
 ...
 *     ?DdiGetRootPageTableSize@ADAPTER_RENDER@@QEAA_KPEAU_DXGKARG_GETROOTPAGETABLESIZE@@@Z @ 0x1C001607C (-DdiGetRootPageTableSize@ADAPTER_RENDER@@QEAA_KPEAU_DXGKARG_GETROOTPAGETABLESIZE@@@Z.c)
...
LABEL_12:
    ...
    else
    {
      ...
      else if ( v64 != -1 )
      {
        ...
        BYTE3(v78[7]) = !a6
                     && (*v67 & 0x40) != 0
                     && (!v27 || (**(_DWORD **)(v27 + 512) & 0x80u) == 0)
                     && (*(_DWORD *)(a1 + 144) & 4) == 0;
        if ( (*v67 & 0x10) != 0 && (v66 == 2 || v66 == 7 || v27 && (**(_DWORD **)(v27 + 512) & 4) != 0) )
        {
          v32 |= 4uLL;
          v78[0] = v32;
        }
