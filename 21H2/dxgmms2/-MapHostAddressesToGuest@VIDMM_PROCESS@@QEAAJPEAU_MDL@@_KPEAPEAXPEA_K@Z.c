/*
 * XREFs of ?MapHostAddressesToGuest@VIDMM_PROCESS@@QEAAJPEAU_MDL@@_KPEAPEAXPEA_K@Z @ 0x1C00DFD40
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  if ( v14 >= 0 )
  {
    ...
    v18 = (struct _RTL_BALANCED_NODE *)v20;
    v19 = v20 + *(_QWORD *)(*(_QWORD *)(v17 + 608) + 256LL);
