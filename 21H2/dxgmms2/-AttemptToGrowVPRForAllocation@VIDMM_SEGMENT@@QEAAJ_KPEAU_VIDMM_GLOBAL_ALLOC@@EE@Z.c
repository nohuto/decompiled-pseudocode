/*
 * XREFs of ?AttemptToGrowVPRForAllocation@VIDMM_SEGMENT@@QEAAJ_KPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00E9C8C
 * Callers:
        ...
        char a5)
{
  ...
  else
  {
    ...
    if ( v11 < 0 )
    {
      v18 = *((_QWORD *)this + 1);
      v19 = *(_QWORD *)(v18 + 24);
      if ( (*(_DWORD *)(344LL * *((unsigned int *)this + 95) + *(_QWORD *)(v19 + 2680) + 16) & 4) != 0 )
      {
        v20 = *((_QWORD *)this + 19);
        ...
        if ( !*(_BYTE *)(v19 + 2745)
          || (v21 = VIDMM_SEGMENT::ReserveOutsideRangeCB,
              *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v18 + 16) + 632LL) + 152LL) != 1) )
        {
