/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C00B75E4
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C006E570 = v2;
  dword_1C006E574 = v6 << 20;
  dword_1C006E578 = v0;
  dword_1C006E57C = v3;
  if ( !v1 )
    qword_1C006E260 = (unsigned __int64)qword_1C006E248 >> 3;
}
