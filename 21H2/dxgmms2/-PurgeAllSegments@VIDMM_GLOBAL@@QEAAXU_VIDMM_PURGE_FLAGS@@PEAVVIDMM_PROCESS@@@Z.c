/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00B24D8
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0022F20 (VidMmPurgeAllSegments.c)
 * Callees:
 ...
 *     ?AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z @ 0x1C00BF84C (-AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z.c)
