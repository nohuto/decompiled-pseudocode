/*
 * XREFs of VidSchiUpdateContextRunningTimeAtISR @ 0x1C000CF80
 * Callers:
 *     VidSchiProcessIsrCompletedPacket @ 0x1C000CC60 (VidSchiProcessIsrCompletedPacket.c)
 *     VidSchiUpdateNodeRunningTimeAtISR @ 0x1C000CF00 (VidSchiUpdateNodeRunningTimeAtISR.c)
...
_BOOL8 __fastcall VidSchiUpdateContextRunningTimeAtISR(_QWORD *a1)
{
  ...
  *(_QWORD *)&v9 = 10000000 * v8;
  ...
  {
    *((_QWORD *)&v9 + 1) = 10000000 * (v8 % PerformanceFrequency.QuadPart) % PerformanceFrequency.QuadPart;
    v11 = 10000000 * (v8 % PerformanceFrequency.QuadPart) / PerformanceFrequency.QuadPart
  ...
  *v15 += v11;
  _InterlockedExchangeAdd64(*(volatile signed __int64 **)(v5 + 6584), v11);
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)(v3 + 440) = v19;
    if ( v19 <= 0 )
    {
      ...
      _InterlockedCompareExchange((volatile signed __int32 *)(v22 + 436), 2, v21);
      v6 = 0;
    }
  }
