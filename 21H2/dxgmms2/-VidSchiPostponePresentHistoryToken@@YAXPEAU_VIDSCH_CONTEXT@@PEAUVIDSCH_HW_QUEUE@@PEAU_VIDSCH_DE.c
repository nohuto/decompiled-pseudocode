/*
 * XREFs of ?VidSchiPostponePresentHistoryToken@@YAXPEAU_VIDSCH_CONTEXT@@PEAUVIDSCH_HW_QUEUE@@PEAU_VIDSCH_DEVICE@@PEAUVIDSCH_SUBMIT_DATA2@@T_ULARGE_INTEGER@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x1C0034E4C
 * Callers:
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 40) = a3;
    if ( a3 )
      ++*((_DWORD *)a3 + 394);
    ++*((_DWORD *)a6 + 201);
    v19 = *(int *)(*((_QWORD *)a6 + v22 + 400) + 280LL * v23 + 180);
    if ( (int)v19 > -1 )
      v8 = *((_QWORD *)a6 + 416) + 160 * v19;
    v20 = v8 + 120;
    v21 = *(__int64 **)(v20 + 8);
    if ( *v21 != v20 )
      __fastfail(3u);
