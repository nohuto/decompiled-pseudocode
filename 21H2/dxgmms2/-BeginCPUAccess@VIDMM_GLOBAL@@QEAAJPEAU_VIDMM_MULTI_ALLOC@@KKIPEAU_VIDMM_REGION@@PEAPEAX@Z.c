/*
 * XREFs of ?BeginCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAPEAX@Z @ 0x1C0069180
 * Callers:
 *     VidMmBeginCPUAccess @ 0x1C0001580 (VidMmBeginCPUAccess.c)
 * Callees:
 *     ?VidMmRecordLock@@YAXPEAU_VIDMM_GLOBAL_STATISTICS@@KKH@Z @ 0x1C000175C (-VidMmRecordLock@@YAXPEAU_VIDMM_GLOBAL_STATISTICS@@KKH@Z.c)
        ...
        void **a7)
{
  ...
  *a7 = 0LL;
  ...
  v17 = **(unsigned int **)(v12 + 512);
  if ( (v17 & 1) == 0 )
  {
    v52 = WdLogNewEntry5_WdError();
    *(_QWORD *)(v52 + 24) = 7989LL;
...
LABEL_67:
  ...
  v20 = **(unsigned int **)(v12 + 512);
  if ( (**(_DWORD **)(v12 + 512) & 0x60000000) == 0x20000000 && v7 != *(__int64 **)(v12 + 96) )
  {
    v13 = *(unsigned int *)(*((_QWORD *)this + 3) + 348LL);
    if ( (v13 & 0x10) == 0 && (v13 & 8) == 0 )
    {
      v53 = WdLogNewEntry5_WdAssertion(v20, v13, v15);
      *(_QWORD *)(v53 + 24) = 8019LL;
      goto LABEL_67;
    }
  }
  if ( (v16 & 0x82) != 0 )
  {
    ...
    {
      v53 = WdLogNewEntry5_WdAssertion(v20, v13, v15);
      *(_QWORD *)(v53 + 24) = 8045LL;
      goto LABEL_67;
    }
    if ( !*((_BYTE *)this + 7081) && (v20 & 4) != 0 )
    {
      v53 = WdLogNewEntry5_WdAssertion(v20, v13, v15);
      *(_QWORD *)(v53 + 24) = 8056LL;
      goto LABEL_67;
    }
  }
  if ( (v16 & 0x81) != 0 )
