/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00235D0
 * Callers:
 ...
 *     VidSchGetRunEvent @ 0x1C008B960 (VidSchGetRunEvent.c)
 */
