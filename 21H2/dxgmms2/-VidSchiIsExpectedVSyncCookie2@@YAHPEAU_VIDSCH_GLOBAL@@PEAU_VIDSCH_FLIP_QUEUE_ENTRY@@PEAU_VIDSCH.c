/*
 * XREFs of ?VidSchiIsExpectedVSyncCookie2@@YAHPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C0017BC0
 * Callers:
        ...
        struct _VIDSCH_VSYNC_COOKIE *a3)
{
  ...
  while ( 1 )
  {
    v9 = *(_QWORD *)((char *)v3 + ((8 * v3[2] + 231) & 0xFFFFFFF8) * v8 + 24);
    if ( v9 )
    {
      if ( v9 != *((_QWORD *)a3 + 2 * v5 + 16) )
        break;
    }
    v10 = 1 << v5;
    v5 = -1;
