/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00CC040
 * Callers:
        ...
        char a6)
{
  ...
  *a5 = 0LL;
  ...
  Handle = 0LL;
  v11 = 0LL;
  if ( v7 <= (unsigned int)dword_1C005033C )
    v7 = (unsigned int)dword_1C005033C;
...
LABEL_31:
  ...
  if ( !v10 )
  {
    _InterlockedIncrement(&dword_1C00506DC);
