/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00F0A44
 * Callers:
        ...
        char a6)
{
  ...
  HANDLE v51; // [rsp+60h] [rbp-10h] BYREF
  SIZE_T v52; // [rsp+68h] [rbp-8h] BYREF
  ...
  *a5 = 0LL;
  ...
  v51 = 0LL;
  v11 = 0LL;
  if ( v7 <= (unsigned int)dword_1C006E3AC )
    v7 = (unsigned int)dword_1C006E3AC;
...
LABEL_63:
            ...
            if ( Address )
            {
              ...
              (*((void (__fastcall **)(__int64, PVOID *, SIZE_T *, __int64, __int64, PHANDLE, __int64, __int64))v43 + 2))(
                -1LL,
                &Address,
                &Size,
                0x8000LL,
...
LABEL_24:
  v52 = v12;
  LODWORD(v17) = MmCreateSection(&Object, 0LL, 0LL, &v52, 4, v19, -1LL, 0LL);
  if ( (int)v17 < 0 )
  {
    Object = 0LL;
...
LABEL_59:
    ...
    {
      if ( v51 )
        ObCloseHandle(v51, ((unsigned __int64)v51 & 0xFFFFFFFF80000000uLL) == 0);
      ObfDereferenceObject(Object);
    }
    goto LABEL_73;
  }
  ObfReferenceObject(Object);
  inserted = ObInsertObject(Object, 0LL, 0, 0, 0LL, &v51);
  v17 = inserted;
  if ( inserted < 0 )
  {
...
LABEL_33:
  ...
  {
    _InterlockedIncrement(&dword_1C006E78C);
    v33 = 2069LL;
  ...
  if ( v27 < 0 )
  {
    _InterlockedIncrement(&dword_1C006E790);
...
LABEL_58:
  ...
  *(_QWORD *)(v32 + 56) = v11;
  if ( a4 != 2 )
    v35 = 0;
  *(_DWORD *)(v32 + 80) = a4;
  *(_DWORD *)(v32 + 64) = v35 | v36;
  *(_QWORD *)(v32 + 88) = Object;
  *(_QWORD *)(v32 + 96) = v51;
  if ( g_IsInternalReleaseOrDbg )
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v29, 0LL, v30, v31) + 24) = v32;
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 144LL) += *(_QWORD *)(v32 + 40);
  ...
  if ( bTracingEnabled )
  {
    ...
    {
      LODWORD(v48) = 1;
      LODWORD(v47) = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 8LL);
      LODWORD(Handle) = a4;
  ...
  BlockListHead = VIDMM_PROCESS_HEAP::GetBlockListHead(a1, a4, v32 + 8);
  v42 = *(_QWORD *)BlockListHead;
  if ( *(_QWORD *)(*(_QWORD *)BlockListHead + 8LL) != BlockListHead )
    __fastfail(3u);
  v41[1] = BlockListHead;
  *v41 = v42;
  *(_QWORD *)(v42 + 8) = v41;
  *(_QWORD *)BlockListHead = v41;
  *a5 = v32;
  return (unsigned int)v17;
}
