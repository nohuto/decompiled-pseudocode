/*
 * XREFs of ?CommitResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00656F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  v13 = (_DWORD *)*((_QWORD *)a2 + 64);
  v12 = *v13 >> 14;
  if ( (*v13 & 0x4000) != 0 && !*((_QWORD *)a2 + 47) )
  {
  ...
  if ( *((_BYTE *)v18 + 40171) )
  {
    ...
    if ( v19 >= 0 )
      goto LABEL_21;
    _InterlockedIncrement(&dword_1C00507E4);
...
LABEL_21:
  ...
  *((_QWORD *)a2 + 25) = 0LL;
  *((_QWORD *)a2 + 18) = v27;
  v28 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392);
  *((_DWORD *)a2 + 30) = 2;
  *((_BYTE *)a2 + 89) = 1;
