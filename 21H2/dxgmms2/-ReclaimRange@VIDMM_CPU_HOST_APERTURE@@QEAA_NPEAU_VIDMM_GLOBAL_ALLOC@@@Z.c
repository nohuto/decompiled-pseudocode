/*
 * XREFs of ?ReclaimRange@VIDMM_CPU_HOST_APERTURE@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C002956C
 * Callers:
...
char __fastcall VIDMM_CPU_HOST_APERTURE::ReclaimRange(VIDMM_CPU_HOST_APERTURE *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( *((_QWORD *)a2 + 57) )
  {
    v3 = (_QWORD *)((char *)a2 + 464);
    v4 = *((_QWORD *)a2 + 58);
    if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v4 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 464)
      || (v5 = (_QWORD *)*((_QWORD *)a2 + 59), (_QWORD *)*v5 != v3)
      || (*v5 = v4,
          *(_QWORD *)(v4 + 8) = v5,
          v6 = *(_QWORD *)this,
