/*
 * XREFs of ?CreateSchLog@VIDMM_SCH_LOG@@SAJPEAVVIDMM_GLOBAL@@I_KPEAPEAV1@PEAPEAXPEA_K@Z @ 0x1C003E694
 * Callers:
 ...
 *     ?VidMmiAllocateMdl@@YAPEAU_MDL@@PEAX_K@Z @ 0x1C00636F4 (-VidMmiAllocateMdl@@YAPEAU_MDL@@PEAX_K@Z.c)
        ...
        unsigned __int64 *a6)
{
  ...
  SIZE_T v27; // [rsp+80h] [rbp-A8h] BYREF
  __int64 v28; // [rsp+88h] [rbp-A0h] BYREF
  SIZE_T v29; // [rsp+90h] [rbp-98h] BYREF
  CVirtualAddressAllocator *VirtualAddressAllocator; // [rsp+98h] [rbp-90h]
  _QWORD v31[12]; // [rsp+A0h] [rbp-88h] BYREF
  unsigned __int64 v32; // [rsp+130h] [rbp+8h] BYREF
  struct VIDMM_SCH_LOG **v33; // [rsp+148h] [rbp+20h]
  ...
  v10 = 0LL;
  if ( (*(_BYTE *)(1584 * v8 + *((_QWORD *)this + 5027) + 436) & 0x20) != 0 )
  {
    v11 = -1073741637;
  }
  else
  {
    ...
    *(_QWORD *)(v10 + 16) = Length;
    ...
    if ( v11 < 0 )
      goto LABEL_17;
    Mdl = VidMmiAllocateMdl(*(PVOID *)(v10 + 32), Length);
    *(_QWORD *)(v10 + 48) = Mdl;
    if ( Mdl )
    {
