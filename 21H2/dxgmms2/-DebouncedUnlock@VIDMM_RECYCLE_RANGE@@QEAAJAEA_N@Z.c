/*
 * XREFs of ?DebouncedUnlock@VIDMM_RECYCLE_RANGE@@QEAAJAEA_N@Z @ 0x1C007D728
 * Callers:
  ...
  *a2 = 0;
  ...
  if ( (_DWORD)v6 )
  {
    ...
    if ( v7 >= 0 )
    {
      v12 = *((_QWORD *)this + 9);
      v13 = **(_DWORD **)(v12 + 32);
      if ( (unsigned int)(v13 - 3) <= 3 || (unsigned int)(v13 - 9) <= 1 )
      {
        VIDMM_RECYCLE_HEAP::ShiftTreeMembershipOnDebouncedStateChange(*(VIDMM_RECYCLE_HEAP **)(v12 + 32), this);
...
LABEL_7:
      ...
      VIDMM_RECYCLE_HEAP_MGR::AddToDecommitDebounce(*(VIDMM_RECYCLE_HEAP_MGR **)(*(_QWORD *)(v12 + 32) + 8LL), this);
