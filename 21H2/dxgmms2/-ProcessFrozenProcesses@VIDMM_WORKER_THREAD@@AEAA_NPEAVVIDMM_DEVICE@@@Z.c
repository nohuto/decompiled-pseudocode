/*
 * XREFs of ?ProcessFrozenProcesses@VIDMM_WORKER_THREAD@@AEAA_NPEAVVIDMM_DEVICE@@@Z @ 0x1C00DF030
 * Callers:
...
char __fastcall VIDMM_WORKER_THREAD::ProcessFrozenProcesses(VIDMM_WORKER_THREAD *this, struct VIDMM_DEVICE *a2)
{
  ...
  if ( *v5 != v5 )
  {
    ...
    while ( v6 != (_QWORD *)(*(_QWORD *)this + 41088LL) );
  }
