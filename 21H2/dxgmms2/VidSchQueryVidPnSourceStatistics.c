/*
 * XREFs of VidSchQueryVidPnSourceStatistics @ 0x1C003DD10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CopyVidPnSourceStatistics @ 0x1C00F3FE4 (CopyVidPnSourceStatistics.c)
 */
...
__int64 __fastcall VidSchQueryVidPnSourceStatistics(__int64 a1, unsigned int a2, _QWORD *a3)
{
  ...
  if ( a2 < v3 )
  {
    CopyVidPnSourceStatistics(a3, *(_QWORD *)(a1 + 8LL * a2 + 6456));
    if ( *(_BYTE *)(a1 + 2212) )
    ...
    *(_QWORD *)(v8 + 16) = v10;
    ...
    if ( *(_BYTE *)(a1 + 59) )
    {
      ...
      v12 = v11[4901];
      v13 = v11[4901].m128i_i64[0];
      v17 = v11[4902].m128i_i64[0];
      a3[3] = v14 + v13;
