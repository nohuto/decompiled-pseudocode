/*
 * XREFs of ?LockInAperture@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@PEA_NPEAPEAU2@@Z @ 0x1C00B1020
 * Callers:
        ...
        __int64 ***a4)
{
  ...
  return VIDMM_GLOBAL::PageInOneAllocation((__int64)this, (__int64 **)a2, 2u, 0, a3, a4, 0, -1LL);
}
