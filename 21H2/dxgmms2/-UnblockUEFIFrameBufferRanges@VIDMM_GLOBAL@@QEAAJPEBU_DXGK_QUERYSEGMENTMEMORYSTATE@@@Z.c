/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C00DA488
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C002D5F0 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
        ...
        const struct _DXGK_QUERYSEGMENTMEMORYSTATE *a2)
{
  ...
  {
    v6 = *(_DWORD *)(1584LL * a2->PhysicalAdapterIndex + *((_QWORD *)this + 5028) + 20)
