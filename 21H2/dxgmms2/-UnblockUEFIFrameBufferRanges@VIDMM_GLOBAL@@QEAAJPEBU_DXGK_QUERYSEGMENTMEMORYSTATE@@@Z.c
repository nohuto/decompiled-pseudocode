/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C00B43E0
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C00231B0 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
