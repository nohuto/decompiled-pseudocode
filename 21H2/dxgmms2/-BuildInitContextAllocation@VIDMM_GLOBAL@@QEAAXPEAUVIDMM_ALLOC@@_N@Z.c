/*
 * XREFs of ?BuildInitContextAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@_N@Z @ 0x1C00ADF74
 * Callers:
...
void __fastcall VIDMM_GLOBAL::BuildInitContextAllocation(ADAPTER_RENDER **this, __int64 **a2)
{
  ...
  do
  {
    ...
    {
      if ( (**(_DWORD **)(v4 + 512) & 8) != 0 )
        v19.MapApertureSegment.OffsetInPages = *(_QWORD *)(v4 + 376);
      else
