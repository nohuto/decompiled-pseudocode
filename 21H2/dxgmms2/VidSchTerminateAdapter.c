/*
 * XREFs of VidSchTerminateAdapter @ 0x1C00D2C00
 * Callers:
 ...
 * Callees:
 *     VidSchiAcceptsIncomingWork @ 0x1C0009598 (VidSchiAcceptsIncomingWork.c)
 ...
 *     ??1_VIDSCH_GLOBAL@@QEAA@XZ @ 0x1C00329C4 (--1_VIDSCH_GLOBAL@@QEAA@XZ.c)
