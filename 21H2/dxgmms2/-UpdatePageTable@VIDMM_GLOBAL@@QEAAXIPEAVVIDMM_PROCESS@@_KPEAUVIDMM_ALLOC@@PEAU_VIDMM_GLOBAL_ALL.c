/*
 * XREFs of ?UpdatePageTable@VIDMM_GLOBAL@@QEAAXIPEAVVIDMM_PROCESS@@_KPEAUVIDMM_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@1IIPEAU_DXGK_PTE@@4II1W4_DXGK_PAGETABLEUPDATEMODE@@1U_DXGK_UPDATEPAGETABLEFLAGS@@1@Z @ 0x1C0071CF0
 * Callers:
...
LABEL_11:
    ...
    do
    {
      ...
      if ( *(_DWORD *)(v30 + 36) )
        v33 = *(_QWORD *)(*(_QWORD *)(v32 + 56) + 376LL);
      else
        v33 = *(_QWORD *)(v32 + 72);
