/*
 * XREFs of ?CreatePagingQueue@VIDMM_DEVICE@@QEAAJIHPEAPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C008A24C
 * Callers:
 *     ?VidMmCreatePagingQueue@@YAJPEAVVIDMM_DEVICE@@IHPEAPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C00158E0 (-VidMmCreatePagingQueue@@YAJPEAVVIDMM_DEVICE@@IHPEAPEAVVIDMM_PAGING_QUEUE@@@Z.c)
 * Callees:
 ...
 *     ??0VIDMM_PAGING_QUEUE@@QEAA@XZ @ 0x1C008A2CC (--0VIDMM_PAGING_QUEUE@@QEAA@XZ.c)
 */
        ...
        struct VIDMM_PAGING_QUEUE **a4)
{
  ...
  *a4 = v7;
  ...
  {
    _InterlockedIncrement(&dword_1C00507A0);
