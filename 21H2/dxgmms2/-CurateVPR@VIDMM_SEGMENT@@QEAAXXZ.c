/*
 * XREFs of ?CurateVPR@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00EA340
 * Callers:
 ...
 *     Percentagex100 @ 0x1C00EB8F8 (Percentagex100.c)
 *     ?CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ @ 0x1C00EED94 (-CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ.c)
 */
    ...
    *((_BYTE *)this + 448) = 1;
    if ( !v2 )
    {
      ...
      if ( (byte_1C006E941 & 0x10) != 0 )
      {
        ...
        Percentagex100((unsigned int)dword_1C006E538, (unsigned int)dword_1C006E53C);
        v25 = v4;
        LOWORD(v24) = v3;
    ...
    v8 = *((_QWORD *)this + 54);
    v9 = *((_QWORD *)this + 55);
    if ( v9 < v8 * (unsigned __int64)(unsigned int)dword_1C006E538 / (unsigned int)dword_1C006E53C )
    {
      v10 = VIDMM_LINEAR_POOL::CalculateCapacity(*((VIDMM_LINEAR_POOL **)this + 19));
      v12 = dword_1C006E544;
      v13 = v8 - v9;
      v14 = (unsigned __int64)(unsigned int)dword_1C006E540 * v13 % (unsigned int)dword_1C006E544;
      if ( v10 < (unsigned __int64)(unsigned int)dword_1C006E540 * v13 / (unsigned int)dword_1C006E544 )
      {
        v27 = 0LL;
        v26 = 0;
        if ( bTracingEnabled )
