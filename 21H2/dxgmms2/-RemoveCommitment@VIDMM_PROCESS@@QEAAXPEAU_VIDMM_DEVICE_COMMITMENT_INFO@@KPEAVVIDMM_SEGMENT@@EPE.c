/*
 * XREFs of ?RemoveCommitment@VIDMM_PROCESS@@QEAAXPEAU_VIDMM_DEVICE_COMMITMENT_INFO@@KPEAVVIDMM_SEGMENT@@EPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006EB0C
 * Callers:
...
LABEL_10:
  ...
  {
    PriorityClass = (int)VIDMM_SEGMENT::GetPriorityClass(*((unsigned int *)a6 + 96));
