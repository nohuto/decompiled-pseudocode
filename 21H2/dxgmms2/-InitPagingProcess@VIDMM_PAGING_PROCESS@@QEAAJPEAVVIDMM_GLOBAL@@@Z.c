/*
 * XREFs of ?InitPagingProcess@VIDMM_PAGING_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C00994D0
 * Callers:
  ...
  *((_QWORD *)this + 1) = v5;
  if ( v5 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v16 + 24) = 8037LL;
    }
    WdLogEvent5_WdAssertion(v16);
  }
  else
  {
    _InterlockedIncrement(&dword_1C00506F0);
    v15 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v15 + 24) = 8009LL;
