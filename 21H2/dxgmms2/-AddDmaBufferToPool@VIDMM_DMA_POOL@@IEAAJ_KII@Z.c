/*
 * XREFs of ?AddDmaBufferToPool@VIDMM_DMA_POOL@@IEAAJ_KII@Z @ 0x1C008DF9C
 * Callers:
...
__int64 __fastcall VIDMM_DMA_POOL::AddDmaBufferToPool(VIDMM_DMA_POOL *this, SIZE_T a2, __int64 a3, unsigned int a4)
{
  ...
  __int64 v60; // r10
  __int64 v61; // r11
  VIDMM_MAPPED_VA_RANGE *v62; // rax
  VIDMM_MAPPED_VA_RANGE *v63; // rsi
  _QWORD *v64; // r8
  __int64 v65; // rdi
  char **v66; // rax
  __int64 v67; // rdx
  ...
  if ( *((_DWORD *)this + 23) > VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark )
  {
    ...
    if ( !v8 || (v9 = *(_QWORD *)(v8 + 24), *(_DWORD *)(v9 + 432) != 2) && !*(_BYTE *)(*(_QWORD *)(v9 + 40) + 346LL) )
    {
      ...
      {
        _InterlockedAdd(&dword_1C005073C, 1u);
...
LABEL_11:
  ...
  if ( !v13 )
  {
    _InterlockedAdd(&dword_1C00506A0, 1u);
...
LABEL_82:
  ...
  if ( (_DWORD)v4 )
  {
    ...
    *((_QWORD *)v15 + 13) = v41;
    if ( !v41 )
    {
      _InterlockedAdd(&dword_1C00506C0, 1u);
...
LABEL_81:
    ...
    *((_QWORD *)v15 + 14) = v45;
    if ( !v45 )
    {
      _InterlockedAdd(&dword_1C00506B8, 1u);
  ...
  if ( (*((_BYTE *)this + 32) & 1) != 0 )
  {
    ...
    *((_QWORD *)v15 + 22) = v54;
    if ( !v54 )
    {
      _InterlockedAdd(&dword_1C00506C4, 1u);
...
LABEL_71:
  ...
  {
    *((_QWORD *)v15 + 12) = *(_QWORD *)(*((_QWORD *)v15 + 8) + 160LL);
    goto LABEL_71;
  }
  ...
  {
    v62 = (VIDMM_MAPPED_VA_RANGE *)CVirtualAddressAllocator::MapVirtualAddressRange(
