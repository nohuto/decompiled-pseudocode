/*
 * XREFs of ?IsAllocationRepurposed@VIDMM_GLOBAL@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00D7AB0
 * Callers:
...
bool __fastcall VIDMM_GLOBAL::IsAllocationRepurposed(VIDMM_GLOBAL *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( *(_WORD *)(*((_QWORD *)a2 + 66) + 4LL) == 3 )
  {
    v7 = *((_QWORD *)a2 + 11);
    v8 = *(PRKPROCESS **)(v7 + 8);
    memset(&ApcState, 0, sizeof(ApcState));
    KeStackAttachProcess(*v8, &ApcState);
    if ( dword_1C006E534 == 1 )
    {
