/*
 * XREFs of ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00C8A34
 * Callers:
      ...
      do
      {
        ...
        if ( *v10 != v10 )
        {
          ...
          do
          {
            ...
            {
              a3 = *(_DWORD *)(*(_QWORD *)(v14 + 512) + 12LL) != 0;
              if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
              {
                LODWORD(v19) = *((_DWORD *)this + 4) + 1;
                LODWORD(v18) = 0;
                LODWORD(v17) = *(_DWORD *)(*(_QWORD *)(v14 + 512) + 12LL) != 0;
  ...
  for ( i = (char *)*((_QWORD *)this + 22); i != v15; i = *(char **)i )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0pqx_EtwWriteTransfer(
        (unsigned int)(*(_DWORD *)(*((_QWORD *)i - 33) + 16LL) + 1),
