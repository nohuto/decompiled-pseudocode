/*
 * XREFs of ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00EC58C
 * Callers:
        ...
        if ( *v10 != v10 )
        {
          ...
          do
          {
            ...
            if ( *(VIDMM_SEGMENT **)(v14 + 120) == this )
            {
              ...
              a3 = *(_DWORD *)(*(_QWORD *)(v14 + 528) + 12LL) != 0;
              if ( (byte_1C006E941 & 1) != 0 )
              {
                LODWORD(v20) = *((_DWORD *)this + 4) + 1;
                LODWORD(v19) = 0;
                LODWORD(v18) = *(_DWORD *)(*(_QWORD *)(v14 + 528) + 12LL) != 0;
            ...
            if ( *(VIDMM_SEGMENT **)(v14 + 240) == this )
            {
              ...
              v15 = *(unsigned int *)(*(_QWORD *)(v14 + 528) + 12LL);
              if ( (byte_1C006E941 & 1) != 0 )
              {
                LODWORD(v20) = *((_DWORD *)this + 4) + 1;
                LODWORD(v19) = 1;
  ...
  for ( i = (char *)*((_QWORD *)this + 22); i != v16; i = *(char **)i )
  {
    if ( (byte_1C006E941 & 1) != 0 )
      McTemplateK0pqx_EtwWriteTransfer(
        (unsigned int)(*(_DWORD *)(*((_QWORD *)i - 35) + 16LL) + 1),
