/*
 * XREFs of ?Evict@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C0063B08
 * Callers:
 *     ?VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C00010E0 (-VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z.c)
        ...
        unsigned __int64 *a6)
{
  ...
  for ( i = &v6[v7]; v6 != i; ++v6 )
  {
    ...
    v15 = *((_BYTE *)v11 + 25) & 1;
    if ( !((unsigned int)v15 | *((_DWORD *)v11 + 42)) && !*((_DWORD *)v11 + 43) )
    {
