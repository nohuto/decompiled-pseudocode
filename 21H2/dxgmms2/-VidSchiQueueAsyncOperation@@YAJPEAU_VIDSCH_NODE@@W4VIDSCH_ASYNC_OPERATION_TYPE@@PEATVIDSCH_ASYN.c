/*
 * XREFs of ?VidSchiQueueAsyncOperation@@YAJPEAU_VIDSCH_NODE@@W4VIDSCH_ASYNC_OPERATION_TYPE@@PEATVIDSCH_ASYNC_OPERATION_DATA@@@Z @ 0x1C0040240
 * Callers:
...
__int64 __fastcall VidSchiQueueAsyncOperation(__int64 a1, __int64 a2, __int128 *a3)
{
  ...
  if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 11208)) > 1 )
  {
    WdLogSingleEntry0(4LL);
    _InterlockedDecrement((volatile signed __int32 *)(a1 + 11208));
    KeSetEvent((PRKEVENT)(a1 + 11216), 0, 0);
    return 0LL;
  }
