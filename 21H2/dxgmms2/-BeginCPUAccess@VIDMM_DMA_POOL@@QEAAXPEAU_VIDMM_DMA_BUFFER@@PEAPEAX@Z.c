/*
 * XREFs of ?BeginCPUAccess@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@PEAPEAX@Z @ 0x1C00756EC
 * Callers:
 *     VidMmBeginDmaBufferCPUAccess @ 0x1C0001EC0 (VidMmBeginDmaBufferCPUAccess.c)
