/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAU_DXGK_QUERYSEGMENTOUT4@@K@Z @ 0x1C0097270
 * Callers:
 ...
 *     ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00B0304 (-InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBU.c)
  ...
  if ( v16 )
  {
    ...
    if ( (v17 & 0x20) != 0 )
    {
      *((_BYTE *)this + 40936) ^= (*((_BYTE *)this + 40936) ^ (v17 >> 5)) & 2;
      v18 = *((_BYTE *)this + 40936) ^ (*((_BYTE *)this + 40936) ^ (v9[515] >> 5)) & 4;
...
LABEL_30:
    if ( dword_1C0050360 == 2 )
      v40 = (*(_DWORD *)(*((_QWORD *)this + 3) + 2044LL) & 4) != 0;
    else
      v40 = dword_1C0050360 == 1;
    *((_BYTE *)this + 7144) = v40;
    *((_QWORD *)this + 5576) = qword_1C0050468;
    v41 = dword_1C005031C;
    if ( dword_1C005031C )
    {
      v83 = 360LL * (unsigned int)dword_1C005031C;
      if ( !is_mul_ok((unsigned int)dword_1C005031C, 0x168uLL) )
        v83 = -1LL;
...
LABEL_44:
          ...
          if ( (int)v45 < 0 )
            goto LABEL_85;
          v12 = v119 + qword_1C00501D8 < *(_QWORD *)(*((_QWORD *)this + 3) + 2616LL);
          *((_DWORD *)this + 926) = v21;
...
LABEL_47:
            ...
            if ( (int)v45 >= 0 )
            {
              ...
              *((_QWORD *)this + 989) = MEMORY[0xFFFFF78000000014];
              ...
              v76 = (_QWORD *)qword_1C00508B0;
              v77 = (_QWORD *)((char *)this + 44712);
              if ( *(struct _LIST_ENTRY **)qword_1C00508B0 != &VIDMM_GLOBAL::_AdapterListHead )
                __fastfail(3u);
              *v77 = &VIDMM_GLOBAL::_AdapterListHead;
              v77[1] = v76;
              *v76 = v77;
              qword_1C00508B0 = (__int64)v77;
              ExReleasePushLockExclusiveEx(&VIDMM_GLOBAL::_AdapterListLock, 0LL);
              return (unsigned int)v45;
            }
            v113 = WdLogNewEntry5_WdAssertion(v68, v67, v69);
            *(_QWORD *)(v113 + 24) = 1828LL;
            WdLogEvent5_WdAssertion(v113);
            goto LABEL_85;
          }
          if ( !dword_1C00503AC )
            goto LABEL_111;
          v94 = (unsigned int)dword_1C00503AC;
          v95 = 24LL * (unsigned int)dword_1C00503AC;
          if ( !is_mul_ok((unsigned int)dword_1C00503AC, 0x18uLL) )
            v95 = -1LL;
          ...
          *((_QWORD *)this + 5123) = v97;
          if ( !v97 )
          {
            ...
            *(_QWORD *)(v87 + 24) = 1753LL;
            goto LABEL_84;
          }
          v101 = 48LL * (unsigned int)dword_1C00503B0;
          if ( !is_mul_ok((unsigned int)dword_1C00503B0, 0x30uLL) )
            v101 = -1LL;
...
LABEL_84:
      ...
      _InterlockedIncrement(&dword_1C0050704);
      v86 = WdLogNewEntry5_WdLowResource(v49);
      *(_QWORD *)(v86 + 24) = 1672LL;
...
LABEL_86:
  ...
  _InterlockedIncrement(&dword_1C00506CC);
  v82 = WdLogNewEntry5_WdLowResource(v15);
  *(_QWORD *)(v82 + 24) = 1504LL;
