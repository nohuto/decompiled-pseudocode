/*
 * XREFs of ?VidSchiSignalSyncObjectsFromCpu@@YAJPEAVHwQueueStagingList@@IPEAPEAU_VIDSCH_SYNC_OBJECT@@U_D3DDDICB_SIGNALFLAGS@@PEB_KPEAPEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C003BCE4
 * Callers:
...
LABEL_37:
    ...
    v30 = *(_QWORD *)&v6[v20];
    if ( *(_BYTE *)(v30 + 27) )
      VidSchiPropagateCrossAdapterSignal((_QWORD *)v30);
LABEL_46:
    v6 += 8;
    --v19;
  }
