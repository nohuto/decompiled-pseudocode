/*
 * XREFs of ?AddVaRangeToVadWithFix@CVirtualAddressAllocator@@QEAAXPEAUVIDMM_VAD@@PEAUVIDMM_MAPPED_VA_RANGE@@PEAU_LIST_ENTRY@@2@Z @ 0x1C005F9B4
 * Callers:
        ...
        struct _LIST_ENTRY *a5)
{
  ...
  if ( VidMmAllocFromOwner )
  {
    ...
    *v11 = (__int64)v10;
    if ( *(__int64 *)(v6 + 80) < 0 )
    {
      for ( i = *(_QWORD **)(v12 + 184); i != (_QWORD *)(v12 + 184); i = (_QWORD *)*i )
      {
        if ( *(_QWORD *)(v6 + 72) <= i[4] )
          break;
      }
