/*
 * XREFs of VidSchiSwitchNodeFromContext @ 0x1C009A7E0
 * Callers:
...
__int64 __fastcall VidSchiSwitchNodeFromContext(__int64 a1)
{
  ...
  {
    result = *(unsigned int *)(result + 2896);
    if ( !(_DWORD)result )
    {
      v2 = *(_QWORD *)(a1 + 96);
      ...
      *(_QWORD *)(DmaPacket + 48) = *(_QWORD *)(v2 + 32);
      VidSchGetNewSubmissionFenceId(v3, 0LL, *(unsigned __int16 *)(v2 + 4), (__int64 *)(DmaPacket + 104));
      ...
      *(_DWORD *)(DmaPacket + 92) |= 0x400u;
      ...
      p_Event = &Event;
      return VidSchWaitForEvents((struct _VIDSCH_GLOBAL *)v3, 1u, (PVOID *)&p_Event, 0LL, 0);
    }
  }
  return result;
}
