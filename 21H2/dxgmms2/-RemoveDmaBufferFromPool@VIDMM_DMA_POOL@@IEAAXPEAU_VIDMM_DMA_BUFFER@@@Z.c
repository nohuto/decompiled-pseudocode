/*
 * XREFs of ?RemoveDmaBufferFromPool@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C008CA80
 * Callers:
 ...
 *     ??1VIDMM_DMA_POOL@@QEAA@XZ @ 0x1C008C9D8 (--1VIDMM_DMA_POOL@@QEAA@XZ.c)
 *     ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00BB110 (-ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z.c)
