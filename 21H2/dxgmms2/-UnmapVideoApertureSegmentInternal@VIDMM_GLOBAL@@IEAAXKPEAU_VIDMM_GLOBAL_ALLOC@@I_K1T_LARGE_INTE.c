/*
 * XREFs of ?UnmapVideoApertureSegmentInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@I_K1T_LARGE_INTEGER@@H@Z @ 0x1C00B467C
 * Callers:
        ...
        int a8)
{
  ...
  do
  {
    ...
    if ( a3 && a3[12] && (*(_DWORD *)a3[64] & 0x10000000) == 0 && (*((_DWORD *)a3 + 21) & 4) == 0 )
    {
