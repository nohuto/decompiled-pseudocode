/*
 * XREFs of McTemplateK0pqqpqqqxxqqpq_EtwWriteTransfer @ 0x1C0037164
 * Callers:
...
NTSTATUS McTemplateK0pqqpqqqxxqqpq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 8LL;
  v30 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventIndependentFlip, a3, 0xEu, &v4);
}
