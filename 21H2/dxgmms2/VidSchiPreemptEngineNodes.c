/*
 * XREFs of VidSchiPreemptEngineNodes @ 0x1C00F3380
 * Callers:
    ...
    do
    {
      if ( _bittest64(&a3, v5) )
      {
        ...
        if ( v14 < *(_DWORD *)(a1 + 704) )
          v15 += v14;
        v16 = *v15;
        if ( (*(_DWORD *)(v16 + 12) & 2) == 0 && *(_DWORD *)(v16 + 2900) )
        {
          _InterlockedIncrement((volatile signed __int32 *)(a1 + 732));
          if ( _InterlockedIncrement((volatile signed __int32 *)(v16 + 2904)) == 1 )
          {
            *(_QWORD *)(v16 + 232) = 0LL;
          ...
          {
            _InterlockedDecrement((volatile signed __int32 *)(v16 + 2904));
