/*
 * XREFs of ?DestroyPageTable@VIDMM_PAGE_TABLE@@QEAAXPEAVCVirtualAddressAllocator@@_K@Z @ 0x1C0088D2C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( this[3] )
  {
    ...
    VIDMM_GLOBAL::CloseOneAllocation(v3, this[3], 0LL, 0, (struct _D3DDDICB_DESTROYALLOCATION2FLAGS)1, 0LL);
