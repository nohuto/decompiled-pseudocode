/*
 * XREFs of ?ExpandZeroPte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_K222PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00E2768
 * Callers:
        ...
        struct VIDMM_ALLOC **a10)
{
  ...
  int v20; // r14d
  __int64 v21; // rcx
  unsigned __int64 v22; // [rsp+20h] [rbp-91h]
  unsigned __int64 v23; // [rsp+20h] [rbp-91h]
  struct VIDMM_ALLOC *v24; // [rsp+28h] [rbp-89h]
  struct VIDMM_ALLOC *v25; // [rsp+28h] [rbp-89h]
