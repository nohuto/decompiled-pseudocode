/*
 * XREFs of ?MarkAllDevicesAsError@VIDMM_PROCESS@@QEAAXPEAVVIDMM_GLOBAL@@W4_VIDSCH_ERROR_CODE@@@Z @ 0x1C005EFC0
 * Callers:
...
_QWORD *__fastcall VIDMM_PROCESS::MarkAllDevicesAsError(__int64 a1, __int64 a2)
{
  ...
  result = *(_QWORD **)(a1 + 16);
  v3 = result[*(unsigned int *)(*(_QWORD *)(a2 + 24) + 232LL)];
  if ( v3 )
  {
    v4 = *(_QWORD *)(v3 + 16);
    if ( v4 )
