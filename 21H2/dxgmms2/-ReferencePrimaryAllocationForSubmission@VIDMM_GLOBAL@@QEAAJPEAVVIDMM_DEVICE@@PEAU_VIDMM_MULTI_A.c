/*
 * XREFs of ?ReferencePrimaryAllocationForSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0089628
 * Callers:
 *     VidMmReferencePrimaryAllocationForSubmission @ 0x1C00149B0 (VidMmReferencePrimaryAllocationForSubmission.c)
 * Callees:
 *     <none>
 */
