/*
 * XREFs of ?EvictResource@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00C2C80
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _VIDMM_LOCAL_ALLOC *a6)
{
  ...
  v26 = (_QWORD *)((char *)a2 + 392);
  v27 = *((_QWORD *)a2 + 49);
  if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v27 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392)
    || (v28 = (_QWORD *)*((_QWORD *)a2 + 50), (_QWORD *)*v28 != v26) )
  {
    __fastfail(3u);
  }
  *v28 = v27;
  ...
  *(_QWORD *)(*((_QWORD *)a2 + 16) + 312LL) += *((_QWORD *)a2 + 2);
  PriorityClass = VIDMM_SEGMENT::GetPriorityClass(*((_DWORD *)a2 + 96));
