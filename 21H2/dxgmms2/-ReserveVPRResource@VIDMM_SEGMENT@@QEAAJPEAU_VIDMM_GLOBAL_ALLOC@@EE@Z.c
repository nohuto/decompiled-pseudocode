/*
 * XREFs of ?ReserveVPRResource@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00C8EE4
 * Callers:
 ...
 *     ?GetMoveableResourceCallback@VIDMM_GLOBAL@@QEAAP6A_NPEAU_VIDMM_GLOBAL_ALLOC@@@ZXZ @ 0x1C00B01D0 (-GetMoveableResourceCallback@VIDMM_GLOBAL@@QEAAP6A_NPEAU_VIDMM_GLOBAL_ALLOC@@@ZXZ.c)
 ...
 *     ?DefragmentRange@VIDMM_LINEAR_POOL@@QEAAXPEAUVIDMM_DEFRAGMENT_ARGS@@@Z @ 0x1C00CE430 (-DefragmentRange@VIDMM_LINEAR_POOL@@QEAAXPEAUVIDMM_DEFRAGMENT_ARGS@@@Z.c)
 *     ?RollbackPlacementOfPendingResources@VIDMM_LINEAR_POOL@@QEAAX_K0W4VIDMM_DEFRAGMENT_DIRECTION@@P6A_NPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K@Z@Z @ 0x1C00CF6BC (-RollbackPlacementOfPendingResources@VIDMM_LINEAR_POOL@@QEAAX_K0W4VIDMM_DEFRAGMENT_DIRECTION@@P6.c)
 */
        ...
        char a4)
{
  ...
  if ( (int)v9 < 0 )
  {
    ...
    if ( (int)v9 < 0 )
    {
      if ( *((_QWORD *)this + 55) + v26 < (unsigned __int64)(unsigned int)dword_1C00504C8
                                        * *((_QWORD *)this + 54)
                                        / (unsigned int)dword_1C00504CC )
      {
        v17 = v4;
        v18 = (VIDMM_GLOBAL *)*((_QWORD *)this + 1);
        v28 = 0;
        if ( (*(_DWORD *)(360LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v18 + 3) + 2584LL) + 16) & 4) != 0 )
        {
      ...
      else
      {
        ...
        if ( (int)v9 < 0 )
        {
          ...
          if ( (*(_DWORD *)(360LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v10 + 3) + 2584LL) + 16) & 4) != 0 )
          {
