/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B5E64
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C0023290 (VidMmValidateHistoryBuffers.c)
 * Callees:
