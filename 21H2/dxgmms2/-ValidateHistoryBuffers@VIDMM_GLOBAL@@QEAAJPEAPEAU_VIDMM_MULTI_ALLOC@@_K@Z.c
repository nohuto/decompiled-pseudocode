/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00DBAEC
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C002D6B0 (VidMmValidateHistoryBuffers.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::ValidateHistoryBuffers(VIDMM_GLOBAL *this, struct _VIDMM_MULTI_ALLOC **a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    if ( a2 == v3 )
      return 0LL;
    v4 = (int *)*a2++;
    if ( (**(_DWORD **)(**(_QWORD **)v4 + 528LL) & 0x4000) == 0 )
      break;
    if ( v4[38] < 2 )
    {
