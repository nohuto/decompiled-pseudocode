/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@H@Z @ 0x1C00AF5D4
 * Callers:
 *     VidMmEscape @ 0x1C0022D80 (VidMmEscape.c)
 * Callees:
 ...
 *     ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C00B8FB0 (-Flush@VIDMM_WORKER_THREAD@@QEAAXXZ.c)
