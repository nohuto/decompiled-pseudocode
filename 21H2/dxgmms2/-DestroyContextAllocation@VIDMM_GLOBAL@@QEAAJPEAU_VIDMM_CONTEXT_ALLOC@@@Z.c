/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C008D9F4
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0016AA0 (VidMmDestroyContextAllocation.c)
 * Callees:
