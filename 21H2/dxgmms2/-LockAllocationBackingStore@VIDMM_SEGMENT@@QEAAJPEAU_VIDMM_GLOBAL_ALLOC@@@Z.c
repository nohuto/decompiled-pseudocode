/*
 * XREFs of ?LockAllocationBackingStore@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00651C4
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::LockAllocationBackingStore(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(v2 + 24) + 348LL) & 4) != 0 && (**((_DWORD **)a2 + 64) & 0x4000) == 0
...
LABEL_11:
  ...
  if ( (v5 & 0x8000) == 0 )
  {
    v7 = (VIDMM_GLOBAL *)**((unsigned int **)a2 + 64);
