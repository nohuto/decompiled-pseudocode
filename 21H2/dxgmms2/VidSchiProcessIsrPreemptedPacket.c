/*
 * XREFs of VidSchiProcessIsrPreemptedPacket @ 0x1C000E468
 * Callers:
    ...
    do
    {
      ...
      *(_DWORD *)(a1 + 500) = ((unsigned __int8)*(_DWORD *)(a1 + 500) + 1) & 0xF;
      ...
      if ( *(_DWORD *)(v10 + 88) == 3 )
      {
        ...
        *(_DWORD *)(v10 + 72) = 10;
        *(_DWORD *)(v10 + 16) = 1;
        _InterlockedDecrement((volatile signed __int32 *)(a1 + 2912));
      }
      else
      {
        *(_QWORD *)(a1 + 56) = v13;
      ...
      *(_DWORD *)(v10 + 92) = v8 | v17 & 0xFFFFFFBF;
      ...
      VidSchiProfilePerformanceTick(v16, (__int64)v5, a1, 0LL, 0LL, 0LL, v10, a4);
