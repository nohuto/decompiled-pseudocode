/*
 * XREFs of ?AcquireRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0028C84
 * Callers:
...
LABEL_9:
    ...
    if ( v14 != v13 )
    {
      do
      {
        ...
        VIDMM_CPU_HOST_APERTURE::ReleaseRangeInternal(this, (struct VIDMM_CPU_HOST_APERTURE_RANGE *)(v18 + 480));
      }
