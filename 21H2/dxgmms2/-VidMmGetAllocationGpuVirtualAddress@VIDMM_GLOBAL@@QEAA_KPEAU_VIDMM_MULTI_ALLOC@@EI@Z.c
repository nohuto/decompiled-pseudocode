/*
 * XREFs of ?VidMmGetAllocationGpuVirtualAddress@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MULTI_ALLOC@@EI@Z @ 0x1C0089568
 * Callers:
 *     VidMmGetAllocationGpuVirtualAddress @ 0x1C0014990 (VidMmGetAllocationGpuVirtualAddress.c)
 * Callees:
