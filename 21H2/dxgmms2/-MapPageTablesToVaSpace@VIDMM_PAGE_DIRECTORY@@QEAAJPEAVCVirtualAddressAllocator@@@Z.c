/*
 * XREFs of ?MapPageTablesToVaSpace@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@@Z @ 0x1C00BD888
 * Callers:
        ...
        struct CVirtualAddressAllocator *a2)
{
  ...
  __int64 v25; // rax
  __int64 v26; // rax
  struct VIDMM_ALLOC *v27; // [rsp+B0h] [rbp+8h] BYREF
