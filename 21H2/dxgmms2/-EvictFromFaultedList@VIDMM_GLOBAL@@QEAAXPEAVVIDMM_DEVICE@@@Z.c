/*
 * XREFs of ?EvictFromFaultedList@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@@Z @ 0x1C00AF958
 * Callers:
...
void __fastcall VIDMM_GLOBAL::EvictFromFaultedList(VIDMM_GLOBAL *this, struct VIDMM_DEVICE *a2, __int64 a3)
{
  ...
  for ( i = *((_QWORD *)a2 + 18); (char *)i != v3; i = *(_QWORD *)(i + 8) )
  {
    ...
    if ( *(_DWORD *)(v5 + 120) == 1 )
    {
      LOBYTE(a3) = 1;
      LOBYTE(v6) = 0;
      (*(void (__fastcall **)(_QWORD, __int64, __int64, _QWORD, int, _QWORD))(**(_QWORD **)(v5 + 128) + 48LL))(
        *(_QWORD *)(v5 + 128),
        v5,
        a3,
        0LL,
