/*
 * XREFs of VidSchSubmitWaitFromCpu @ 0x1C0016C00
 * Callers:
 ...
 *     ??_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z @ 0x1C0033EA0 (--_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z.c)
 */
...
LABEL_34:
      ...
      *v24 = v15;
      *(_QWORD *)(v17 + 848) = v15;
      VidSchiUnwaitMonitoredFences((__int64)v28, v17, 0LL);
      if ( !v29 )
      {
        while ( 1 )
        {
