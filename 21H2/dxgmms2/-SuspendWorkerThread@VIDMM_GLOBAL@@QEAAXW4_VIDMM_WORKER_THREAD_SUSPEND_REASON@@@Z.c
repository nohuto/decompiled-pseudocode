/*
 * XREFs of ?SuspendWorkerThread@VIDMM_GLOBAL@@QEAAXW4_VIDMM_WORKER_THREAD_SUSPEND_REASON@@@Z @ 0x1C00A685C
 * Callers:
 *     VidMmSuspendWorkerThread @ 0x1C0018840 (VidMmSuspendWorkerThread.c)
 * Callees:
