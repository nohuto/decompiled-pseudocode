/*
 * XREFs of ?SuspendWorkerThread@VIDMM_GLOBAL@@QEAAXW4_VIDMM_WORKER_THREAD_SUSPEND_REASON@@@Z @ 0x1C008AFA0
 * Callers:
 *     VidMmSuspendWorkerThread @ 0x1C0015F40 (VidMmSuspendWorkerThread.c)
 * Callees:
