/*
 * XREFs of ?TrimOfferCommitmentInternal@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@_KPEA_K@Z @ 0x1C00B4184
 * Callers:
  ...
  *(_QWORD *)(v12 + 24) = v24;
  ...
  if ( v14 && *(_QWORD *)(v14 + 520) == *(_QWORD *)a3 )
  {
    ...
    if ( v16 != v15 )
    {
      ...
      do
      {
        v28 = (struct _VIDMM_GLOBAL_ALLOC *)(v16 - 53);
        *((_QWORD *)a3 + 3) = *v16;
        v18 = 0;
        if ( VIDMM_GLOBAL::IsAllocationDecommitCandidate(
               (VIDMM_GLOBAL *)this,
               (struct _VIDMM_GLOBAL_ALLOC *)(v16 - 53),
               v17) )
        {
          this[5588] = (struct _KTHREAD *)(v16 - 53);
          v19 = *v16;
