/*
 * XREFs of ?AccumulateZeroingState@VIDMM_RECYCLE_RANGE@@QEAAXPEAW4VIDMM_RECYCLE_RANGE_ZEROING_STATE@@@Z @ 0x1C0077A10
 * Callers:
  ...
  if ( (_DWORD)v3 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      if ( (_DWORD)v4 )
      {
        if ( (_DWORD)v4 == 1 )
        {
          if ( dword_1C00503E0 && !*(_DWORD *)a2 && g_IsInternalRelease )
          {
    ...
    if ( !dword_1C00503E0 || *(_DWORD *)a2 )
      return;
  }
  else if ( !dword_1C00503E0 || !*(_DWORD *)a2 )
  {
    return;
  }
