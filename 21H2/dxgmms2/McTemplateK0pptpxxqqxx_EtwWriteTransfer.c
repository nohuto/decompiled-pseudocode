/*
 * XREFs of McTemplateK0pptpxxqqxx_EtwWriteTransfer @ 0x1C0027A44
 * Callers:
...
NTSTATUS McTemplateK0pptpxxqqxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpVirtualFill, a3, 0xBu, &v4);
}
