/*
 * XREFs of VidSchQueryDmaHeader @ 0x1C00F6D10
 * Callers:
...
LABEL_7:
  if ( *((_QWORD *)i + 2) != __PAIR64__(v15, v6) )
    goto LABEL_8;
  v14 = 224LL * v10;
  *(_OWORD *)a5 = *(_OWORD *)(v14 + a2 + 11336);
  *(_OWORD *)(a5 + 16) = *(_OWORD *)(v14 + a2 + 11352);
  *(_QWORD *)(a5 + 32) = *(_QWORD *)(v14 + a2 + 11368);
  return 0LL;
}
