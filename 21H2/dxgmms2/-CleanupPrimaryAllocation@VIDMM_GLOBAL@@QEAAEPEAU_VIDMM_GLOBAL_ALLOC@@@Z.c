/*
 * XREFs of ?CleanupPrimaryAllocation@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00AE3BC
 * Callers:
  ...
  while ( v4 != v2 )
  {
    ...
    while ( v8 != v7 )
    {
      ...
      if ( (v10 & 3) != 0 )
      {
        ...
        if ( !(v9[25] & 1 | *((_DWORD *)v9 + 42)) )
        {
          VIDMM_DEVICE::RemoveCommitment(*((VIDMM_DEVICE **)v9 + 1), (__int64 **)v9, 1);
          v5 = 1;
        }
        _InterlockedDecrement((volatile signed __int32 *)(*((_QWORD *)a2 + 64) + 12LL));
      }
    }
    v14 = *((_QWORD *)a2 + 16);
    if ( v14 && !*((_DWORD *)a2 + 38) )
