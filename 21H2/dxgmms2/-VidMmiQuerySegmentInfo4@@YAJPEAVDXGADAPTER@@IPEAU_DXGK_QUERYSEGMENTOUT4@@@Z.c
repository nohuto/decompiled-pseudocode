/*
 * XREFs of ?VidMmiQuerySegmentInfo4@@YAJPEAVDXGADAPTER@@IPEAU_DXGK_QUERYSEGMENTOUT4@@@Z @ 0x1C00B30B0
 * Callers:
...
__int64 __fastcall VidMmiQuerySegmentInfo4(struct DXGADAPTER *this, int a2, struct _DXGK_QUERYSEGMENTOUT4 *a3)
{
  ...
  *(_QWORD *)&v27.Flags.0 = 0LL;
  ...
  v8 = DXGADAPTER::DdiQueryAdapterInfo(this, &v27);
  v9 = v8;
  if ( v8 < 0 )
  {
  ...
  if ( !v12 )
  {
    _InterlockedIncrement(&dword_1C006E778);
  ...
  *((_QWORD *)&v24 + 1) = v12;
  v26 = 104LL;
  v14 = DXGADAPTER::DdiQueryAdapterInfo(this, &v27);
  v9 = v14;
  if ( v14 < 0 )
  {
