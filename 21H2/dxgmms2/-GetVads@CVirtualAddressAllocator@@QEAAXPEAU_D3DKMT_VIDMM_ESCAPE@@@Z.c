/*
 * XREFs of ?GetVads@CVirtualAddressAllocator@@QEAAXPEAU_D3DKMT_VIDMM_ESCAPE@@@Z @ 0x1C00BD314
 * Callers:
              ...
              if ( (_DWORD)v27 == a2->Evict.AllocationHandle )
              {
                ...
                if ( (_DWORD)v27 )
                {
                  ...
                  if ( v32 )
                  {
                    ...
                    do
                    {
                      *(_OWORD *)p_IndexShift = *(_OWORD *)(*(_QWORD *)(v28 + 40) + 16LL * (v35 + v34));
                      if ( (_DWORD)v27 == 1 )
                      {
                        if ( (*v21 & 0x80u) != 0 )
                        {
                        ...
                        {
                          v36 = 0LL;
                          if ( (**(_DWORD **)(v28 + 40) & 0x60000) == 0x20000LL )
                            v36 = 0x80000LL;
                ...
                else
                {
                  if ( v32 )
                  {
                    do
                    {
                      ...
                      ++v5;
                      *(_OWORD *)p_IndexShift = *(_OWORD *)(*(_QWORD *)(v24 + 32) + 8 * v33);
                      p_IndexShift += 2;
                    }
                    while ( v5 < v32 );
                  }
    ...
    else
    {
      ...
      if ( (unsigned int)PhysicalAdapterIndex < ((*(_DWORD *)(VaRangeIndex + 32) >> 4) & 0x7Fu) )
      {
        ...
        v40 = (struct _KTHREAD **)(VaRangeIndex
                                 + 8 * ((unsigned int)PhysicalAdapterIndex + 4LL * (_QWORD)PhysicalAdapterIndex + 7));
