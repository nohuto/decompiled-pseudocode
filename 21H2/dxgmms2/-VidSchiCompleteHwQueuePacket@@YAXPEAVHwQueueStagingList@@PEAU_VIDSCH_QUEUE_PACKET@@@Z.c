/*
 * XREFs of ?VidSchiCompleteHwQueuePacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C00365D8
 * Callers:
 ...
 *     ?ReleaseBuffer@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C0015580 (-ReleaseBuffer@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1C0018BF0 (_guard_dispatch_icall_nop.c)
 *     ?UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C0023E98 (-UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z.c)
...
LABEL_48:
          if ( v6 && (*((_DWORD *)a2 + 212) & 0x3FF) != 0 )
          {
            ...
            VidSchiUnreferencePrimaryAllocations(
              ...
              v18,
              (struct _VIDSCH_QUEUE_PACKET *)((char *)a2 + 848),
              *((_DWORD *)a2 + 102),
...
LABEL_70:
  if ( *((_DWORD *)a2 + 12) == 3 && *((_DWORD *)a2 + 40) != -1 )
  {
    ...
    v28 = *((_DWORD *)a2 + 18);
    if ( (v28 & 0x800000) != 0 )
      v29 = ((unsigned __int16)*((_DWORD *)a2 + 212) | (unsigned __int16)(*((_DWORD *)a2 + 212) >> 10)) & 0x3FF;
    else
    ...
    if ( (v28 & 0x800000) != 0 )
      v33 = ((unsigned __int16)*((_DWORD *)a2 + 212) | (unsigned __int16)(*((_DWORD *)a2 + 212) >> 10)) & 0x3FF;
    else
