/*
 * XREFs of ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAVVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1C00B2178
 * Callers:
 *     VidMmPinAllocation @ 0x1C0022ED0 (VidMmPinAllocation.c)
 * Callees:
