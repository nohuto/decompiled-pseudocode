/*
 * XREFs of ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAVVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1C00A9C5C
 * Callers:
 *     VidMmPinAllocation @ 0x1C001AD90 (VidMmPinAllocation.c)
 * Callees:
