/*
 * XREFs of ?TransferToSegment@VIDMM_MEMORY_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_MDL@@_N@Z @ 0x1C0074E80
 * Callers:
 ...
 *     ?ReclaimScrubRegionResources@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00C8954 (-ReclaimScrubRegionResources@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
 */
...
LABEL_12:
  ...
  *(_WORD *)(*((_QWORD *)a2 + 64) + 6LL) = VIDMM_SEGMENT::DriverId(v12);
  *(_QWORD *)(*((_QWORD *)a2 + 64) + 32LL) = *((_QWORD *)a2 + 17) + *(_QWORD *)(*((_QWORD *)a2 + 16) + 24LL);
  *((_QWORD *)a2 + 27) = 0LL;
  v13 = *((_DWORD *)a2 + 21);
  if ( (v13 & 2) != 0 )
  {
