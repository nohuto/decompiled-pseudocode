/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C00C864C
 * Callers:
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v6 = *((_DWORD *)this + 119);
  v7 = *((_DWORD *)this + 95);
  v8 = (struct VIDMM_PARTITION *)**((_QWORD **)a2 + 62);
  ...
  if ( (v14 & 0x1001) != 0 )
  {
    ...
    if ( v15 )
    {
      if ( _InterlockedIncrement((volatile signed __int32 *)(v15 + 44)) == 1 )
        _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 62) + 56LL), *((_QWORD *)a2 + 2));
      if ( _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)a2 + 63) + 40LL)) != 1 )
        goto LABEL_21;
    }
    else
    {
    ...
    _InterlockedExchangeAdd64((volatile signed __int64 *)(**((_QWORD **)a2 + 62) + 64LL), *((_QWORD *)a2 + 2));
LABEL_21:
  ...
  v18 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392);
  v19 = (struct _VIDMM_GLOBAL_ALLOC **)*((_QWORD *)a2 + 49);
  if ( v19[1] != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392)
    || (v20 = (VIDMM_SEGMENT **)*((_QWORD *)a2 + 50), *v20 != v18)
