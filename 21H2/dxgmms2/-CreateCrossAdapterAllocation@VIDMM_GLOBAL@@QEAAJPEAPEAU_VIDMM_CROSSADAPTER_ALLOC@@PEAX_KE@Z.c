/*
 * XREFs of ?CreateCrossAdapterAllocation@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAX_KE@Z @ 0x1C00AE6D8
 * Callers:
 *     VidMmCreateCrossAdapterAllocation @ 0x1C0022D40 (VidMmCreateCrossAdapterAllocation.c)
 * Callees:
