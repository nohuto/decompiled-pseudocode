/*
 * XREFs of ?EvictResource@VIDMM_SYSMEM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C0065320
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _VIDMM_LOCAL_ALLOC *a6)
{
  ...
  v18 = (_QWORD *)((char *)a2 + 392);
  v19 = *((_QWORD *)a2 + 49);
  if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v19 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392)
    || (v20 = (_QWORD *)*((_QWORD *)a2 + 50), (_QWORD *)*v20 != v18) )
  {
    __fastfail(3u);
  }
  *v20 = v19;
