/*
 * XREFs of ?SetupForBuildPagingBufferIteration@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@@Z @ 0x1C00755C4
 * Callers:
        ...
        struct _DXGKARG_BUILDPAGINGBUFFER *a4)
{
  ...
  v4 = (unsigned int)a2;
  if ( a3 && (**((_DWORD **)a3 + 64) & 0x10000000) != 0 )
  {
    a4->pDmaBuffer = 0LL;
