/*
 * XREFs of ?CommitAllocationList@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAPEAUVIDMM_ALLOC@@_KPEA_K@Z @ 0x1C0086CEC
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  for ( i = a3; i != v6; ++i )
  {
    ...
    if ( *((int *)*i + 41) > 0
      || (*((_DWORD *)v10 + 7) & 3) != 2
      || *((_DWORD *)this + 2) == 206 && *((struct VIDMM_ALLOC **)this + 880) == v10
    ...
    if ( (byte_1C006E941 & 0x10) != 0 )
    {
      ...
      McTemplateK0pq_EtwWriteTransfer(v13, &EventVidMmMakeResident, v12, v10, v16);
    }
    if ( *((_QWORD *)this + 5123) )
    {
      if ( a5 )
