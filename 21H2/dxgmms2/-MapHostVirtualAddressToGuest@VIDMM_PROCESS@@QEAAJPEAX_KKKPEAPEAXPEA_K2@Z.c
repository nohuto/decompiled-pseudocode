/*
 * XREFs of ?MapHostVirtualAddressToGuest@VIDMM_PROCESS@@QEAAJPEAX_KKKPEAPEAXPEA_K2@Z @ 0x1C00BA4C4
 * Callers:
 ...
 * Callees:
 *     MapChildVaSpace @ 0x1C0022BDC (MapChildVaSpace.c)
