/*
 * XREFs of VidSchiProcessIsrCompletedPacket @ 0x1C000E2F0
 * Callers:
 ...
 *     VidSchiUpdateContextRunningTimeAtISR @ 0x1C000E5A0 (VidSchiUpdateContextRunningTimeAtISR.c)
...
__int64 __fastcall VidSchiProcessIsrCompletedPacket(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v10 + 16) = 1;
    ...
    v19 = 0LL;
    v18[1] = v12;
    VidSchiUpdateContextRunningTimeAtISR(v18, v12, a3, 0xFFFFF78000000320uLL);
    v15 = *(_QWORD *)(a1 + 8 * v13 + 1560);
    if ( v15 && v15 != v20 )
      *(_QWORD *)(v15 + 464) = *(_QWORD *)(v20 + 464);
    if ( (*(_DWORD *)(v10 + 92) & 0x200) != 0 )
    {
      VidSchiUpdateCurrentIsrFrameTime(
        v4,
        *(_QWORD *)(v4 + 8LL * *(unsigned int *)(*(_QWORD *)(v10 + 56) + 160LL) + 3104),
        0LL);
    ...
    ExpInterlockedPushEntrySList((PSLIST_HEADER)(v4 + 1760), (PSLIST_ENTRY)(v10 + 32));
  ...
  if ( !*(_BYTE *)(v4 + 53) )
  {
    ...
    v17[4] = 1LL;
    v17[5] = v6;
    v17[6] = *(unsigned int *)(a1 + 152);
    v17[7] = *(_QWORD *)(v4 + 16);
    WdLogEvent5_WdCriticalError(v17);
    __debugbreak();
    JUMPOUT(0x1C001F0FCLL);
  }
  *(_DWORD *)(a1 + 2024) = 1;
  result = 0LL;
  *(_BYTE *)(a1 + 2017) = 1;
