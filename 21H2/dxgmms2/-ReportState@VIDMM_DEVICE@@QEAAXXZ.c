/*
 * XREFs of ?ReportState@VIDMM_DEVICE@@QEAAXXZ @ 0x1C00B84B4
 * Callers:
 *     VidMmReportVidMmDeviceState @ 0x1C0023020 (VidMmReportVidMmDeviceState.c)
...
void __fastcall VIDMM_DEVICE::ReportState(VIDMM_DEVICE *this)
{
  ...
  if ( v1 )
  {
    ...
    {
      if ( *((int *)i + 14) > 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
