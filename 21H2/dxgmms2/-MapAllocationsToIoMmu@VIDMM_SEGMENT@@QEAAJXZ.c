/*
 * XREFs of ?MapAllocationsToIoMmu@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00C75B0
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::MapAllocationsToIoMmu(VIDMM_SEGMENT *this)
{
  ...
  {
    v4 = i - 392;
    v5 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (struct _VIDMM_GLOBAL_ALLOC *)(i - 392));
    v8 = v5;
    if ( v5 < 0 )
    {
LABEL_6:
  ...
  {
    v4 = (char *)j - 392;
    v12 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (VIDMM_SEGMENT *)((char *)j - 392));
    v8 = v12;
    if ( v12 < 0 )
      goto LABEL_6;
  }
