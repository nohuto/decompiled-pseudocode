/*
 * XREFs of VidSchiScheduleCommandToRun @ 0x1C000B040
 * Callers:
  ...
  *a2 = 0;
  ...
  while ( (unsigned int)(*(_DWORD *)(a1 + 2916) - 2) <= 1 || (unsigned int)VidSchiCheckHwProgress(a1, &v35) )
  {
    ...
    if ( v7 != (_QWORD *)(a1 + 1776) )
    {
      ...
      {
        v27 = (_QWORD *)*v7;
        if ( (unsigned int)VidSchiCheckConditionDeviceCommand(v5, v7 - 27, v6, v7) )
        {
          v29 = *v28;
...
LABEL_53:
          ...
          *v30 = v29;
          *(_QWORD *)(v29 + 8) = v30;
          VIDMM_GLOBAL::AddPendingTermination(*(VIDMM_GLOBAL **)*(v28 - 26), (struct VIDMM_ALLOC *)(v28 - 27));
        }
        v7 = v27;
      }
    ...
    *(_QWORD *)(a1 + 1280) = MEMORY[0xFFFFF78000000320];
    ...
    if ( v2 )
    {
      ...
      if ( v14 == v9 + 664 )
      {
        ...
        *(_QWORD *)(v9 + 648) = 0LL;
        VidSchiUpdateContextStatus(v9, 1uLL, 17614LL);
      }
      else
      {
        v15 = v14 == 32;
