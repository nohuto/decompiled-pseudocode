/*
 * XREFs of ?ReleaseRange@VIDMM_CPU_HOST_APERTURE@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00295C0
 * Callers:
...
{
  VIDMM_CPU_HOST_APERTURE::ReleaseRangeInternal(this, (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 480));
}
