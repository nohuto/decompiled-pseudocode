/*
 * XREFs of ?VidSchFlushQueuePacketsInternal@@YAXPEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_PACKET_TYPE@@IE_N@Z @ 0x1C0016D7C
 * Callers:
 *     VidSchFlushQueuePackets @ 0x1C0016D60 (VidSchFlushQueuePackets.c)
 ...
 *     VidSchiFlushQueuePacket @ 0x1C002FC7C (VidSchiFlushQueuePacket.c)
 *     ?VidSchiAbortMmIoFlipPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@PEAU_VIDSCH_DEVICE@@I@Z @ 0x1C0033118 (-VidSchiAbortMmIoFlipPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@PEAU_VIDSCH_DEVICE@@I@Z.c)
 */
...
LABEL_18:
          ...
          {
            if ( v5 == -1 )
              VidSchiClearFlipDevice((struct _KEVENT *)a1, v17, 6);
            else
