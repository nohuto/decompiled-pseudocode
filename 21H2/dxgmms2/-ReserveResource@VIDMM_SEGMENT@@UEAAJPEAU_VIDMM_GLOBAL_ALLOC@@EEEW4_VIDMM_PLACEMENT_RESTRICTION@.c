/*
 * XREFs of ?ReserveResource@VIDMM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EEEW4_VIDMM_PLACEMENT_RESTRICTION@@_K@Z @ 0x1C0073800
 * Callers:
 *     ?ReserveResource@VIDMM_MEMORY_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EEEW4_VIDMM_PLACEMENT_RESTRICTION@@_K@Z @ 0x1C0074E10 (-ReserveResource@VIDMM_MEMORY_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EEEW4_VIDMM_PLACEMENT_RESTR.c)
 * Callees:
 ...
 *     ?VerifyCommitLimit@VIDMM_SEGMENT@@IEAAJPEAUVIDMM_PARTITION_ADAPTER_INFO@@_K@Z @ 0x1C0073724 (-VerifyCommitLimit@VIDMM_SEGMENT@@IEAAJPEAUVIDMM_PARTITION_ADAPTER_INFO@@_K@Z.c)
...
LABEL_15:
      ...
      v17 = *(_DWORD *)(a1 + 476);
      v18 = *(_DWORD *)(a1 + 380);
      v19 = **(struct VIDMM_PARTITION ***)(a2 + 496);
      ...
      *(_QWORD *)(a1 + 224) += *(_QWORD *)(a2 + 16);
      ...
      if ( v22 )
      {
        if ( _InterlockedIncrement((volatile signed __int32 *)(v22 + 44)) == 1 )
          _InterlockedExchangeAdd64((volatile signed __int64 *)(**(_QWORD **)(a2 + 496) + 56LL), *(_QWORD *)(a2 + 16));
        if ( _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(a2 + 504) + 40LL)) != 1 )
          goto LABEL_23;
      }
      else
      {
      ...
      _InterlockedExchangeAdd64((volatile signed __int64 *)(**(_QWORD **)(a2 + 496) + 64LL), *(_QWORD *)(a2 + 16));
LABEL_23:
      v14 = *(_QWORD *)(a1 + 8);
...
LABEL_63:
  ...
  v13 = VIDMM_SEGMENT::VerifyCommitLimit((VIDMM_SEGMENT *)a1, *(struct VIDMM_PARTITION_ADAPTER_INFO **)(a2 + 496), v11);
  if ( v13 < 0 )
  {
...
LABEL_36:
    ...
    while ( 1 )
    {
      ...
      if ( (**(_DWORD **)(a2 + 512) & 0x20000) != 0 || *(_DWORD *)(a1 + 412) != 1 || !*(_QWORD *)(a1 + 432) )
      {
        if ( v29 )
          goto LABEL_14;
LABEL_42:
