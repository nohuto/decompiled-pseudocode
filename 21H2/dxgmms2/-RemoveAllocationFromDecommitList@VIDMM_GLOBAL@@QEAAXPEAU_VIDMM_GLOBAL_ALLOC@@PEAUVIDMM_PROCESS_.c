/*
 * XREFs of ?RemoveAllocationFromDecommitList@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x1C00B3098
 * Callers:
        ...
        struct VIDMM_PROCESS_ADAPTER_INFO *a3)
{
  ...
  for ( i = (_QWORD *)*v6; i != v6; i = (_QWORD *)*i )
  {
    ...
    if ( v8 == (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 424) )
      i[2] = *(_QWORD *)v8;
  }
  ExReleasePushLockSharedEx(v5, 0LL);
  KeLeaveCriticalRegion();
  v9 = (_QWORD *)((char *)a2 + 424);
  v10 = *((_QWORD *)a2 + 53);
  if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v10 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 424)
    || (v11 = (_QWORD *)*((_QWORD *)a2 + 54), (_QWORD *)*v11 != v9) )
  {
    __fastfail(3u);
  }
  *v11 = v10;
