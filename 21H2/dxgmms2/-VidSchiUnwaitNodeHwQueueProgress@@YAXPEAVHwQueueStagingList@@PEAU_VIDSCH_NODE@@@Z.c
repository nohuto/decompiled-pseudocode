/*
 * XREFs of ?VidSchiUnwaitNodeHwQueueProgress@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_NODE@@@Z @ 0x1C001F44E
 * Callers:
          ...
          *(_OWORD *)v22 = 0LL;
          ...
          if ( v8 )
          {
            ...
            *((_DWORD *)a2 + 49) = (*((_DWORD *)a2 + 49) + 1) & (*((_DWORD *)a2 + 48) - 1);
            ...
            v17 = v22;
            v18 = (char *)v16 - (char *)v22;
            v19 = (unsigned __int64 *)(v6 + 8);
            v20 = 2LL;
            do
            {
              v21 = *v17;
              *(unsigned __int64 *)((char *)v17 + v18 + 24) = *v17;
              ++v17;
              *v19 = v21;
              v19 += 3;
              --v20;
