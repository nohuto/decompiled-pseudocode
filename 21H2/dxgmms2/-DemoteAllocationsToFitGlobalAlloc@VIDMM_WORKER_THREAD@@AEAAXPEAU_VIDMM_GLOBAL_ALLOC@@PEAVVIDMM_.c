/*
 * XREFs of ?DemoteAllocationsToFitGlobalAlloc@VIDMM_WORKER_THREAD@@AEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_DEVICE@@AEBUVIDMM_PAGE_IN_POLICY_PER_COMBINATION@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEA_N@Z @ 0x1C00B8974
 * Callers:
 ...
 *     ?FaultAllDemotableAllocations@VIDMM_DEVICE@@QEAAXPEAV1@IW4_VIDMM_PLACEMENT_RESTRICTION@@IPEAIPEA_KPEA_N@Z @ 0x1C00B7C6C (-FaultAllDemotableAllocations@VIDMM_DEVICE@@QEAAXPEAV1@IW4_VIDMM_PLACEMENT_RESTRICTION@@IPEAIPEA.c)
...
LABEL_13:
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( (_DWORD)v66 == 2 )
          {
            if ( (*(_DWORD *)(a2 + 76) & 0x40) != 0 && v17 >= *(_DWORD *)(a2 + 384) - 1 )
              v21 = *(_DWORD *)(a2 + 384) - 1;
            ...
            if ( (_QWORD *)*v25 != v25 )
            {
              while ( 1 )
              {
                ...
                if ( (v27 != v24
                   ...
                   && (*(_DWORD *)(a2 + 384) >= 0xA0000000 || (*(_DWORD *)(a2 + 76) & 0x40) == 0))
...
LABEL_91:
      ...
      if ( (VIDMM_GLOBAL::_Config & 0x40) == 0
        || (_DWORD)v68 == 2
        || *(_DWORD *)(a2 + 384) < 0xA0000000 && (LODWORD(v7) = *(_DWORD *)(a2 + 76), (v7 & 0x40) != 0)
