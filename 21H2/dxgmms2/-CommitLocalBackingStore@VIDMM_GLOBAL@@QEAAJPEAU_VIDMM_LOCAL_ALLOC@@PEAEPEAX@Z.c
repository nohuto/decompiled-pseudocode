/*
 * XREFs of ?CommitLocalBackingStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_LOCAL_ALLOC@@PEAEPEAX@Z @ 0x1C0079820
 * Callers:
...
LABEL_33:
    ...
    else
    {
      ...
      if ( (unsigned __int64)a4 >= MmUserProbeAddress )
      {
        ...
        v29 = WdLogNewEntry5_WdAssertion(v11, v13, v10);
        *(_QWORD *)(v29 + 24) = 29144LL;
      }
      else
      {
        v29 = WdLogNewEntry5_WdAssertion(v11, v13, v10);
        *(_QWORD *)(v29 + 24) = 29131LL;
      }
    }
  ...
  if ( (v13 & 0x400000) != 0
    || (ObjectType = (struct _OBJECT_TYPE *)ObGetObjectType(v8[46]),
        v15 = ObOpenObjectByPointer((PVOID)v8[46], 0, 0LL, 0, ObjectType, 1, (PHANDLE)a2 + 12),
        v7 = v15,
        v15 >= 0) )
  {
    ...
    if ( (v20 & 4) != 0 )
    {
      ...
      v22 = MmMapViewOfSection(v8[46], CurrentProcess, &v35, 0LL, v19, &v36, v8 + 1, 2, 0, 4);
    }
    else
    {
      v24 = PsGetCurrentProcess(v20, v13, v10);
      v22 = MmMapViewOfSection(v8[46], v24, &v35, 0LL, v19, &v36, v8 + 1, 2, 0, 1028);
    }
    LODWORD(v7) = v22;
    if ( v22 >= 0 )
      goto LABEL_39;
