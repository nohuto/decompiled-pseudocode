/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0092DD0
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0092B90 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
 *     ?Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0092C50 (-Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
 ...
 *     ??0VIDMM_LINEAR_POOL@@QEAA@XZ @ 0x1C0093144 (--0VIDMM_LINEAR_POOL@@QEAA@XZ.c)
...
__int64 __fastcall VIDMM_SEGMENT::Init(PHYSICAL_ADDRESS *this, void (*a2)(void *), union _LARGE_INTEGER *a3)
{
  ...
  else
  {
    ...
    if ( !v6 )
    {
      _InterlockedIncrement(&dword_1C0050690);
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        if ( PagesForMdl )
        {
          ...
          if ( (_DWORD)v15 )
          {
            ...
            {
              this[30].LowPart = 0;
              _InterlockedIncrement(dword_1C0050764);
        ...
        _InterlockedIncrement(&dword_1C0050728);
