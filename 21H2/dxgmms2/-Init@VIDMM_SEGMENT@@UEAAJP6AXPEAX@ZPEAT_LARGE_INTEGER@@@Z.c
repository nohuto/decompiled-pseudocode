/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C00B0BE0
 * Callers:
 ...
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C00B09E0 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
    ...
    || (LOBYTE(a2) = 6, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 12LL), (int)result >= 0) )
  {
      ...
      || (LOBYTE(a2) = 7, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 18LL), (int)result >= 0) )
    {
      if ( a3 )
        ...
        QuadPart = *(_QWORD *)(*(_QWORD *)(this[1].QuadPart + 24) + 2088LL);
      ...
      if ( (v9 & 0x80000000) == 0 )
      {
        ...
        if ( PagesForMdl )
        {
          v12 = (unsigned int)dword_1C006E274;
          this[30].LowPart = dword_1C006E274;
          this[30].HighPart = 0;
          if ( (_DWORD)v12 )
          {
            v17 = v12;
            ...
            {
              this[30].LowPart = 0;
              _InterlockedIncrement(dword_1C006E814);
        ...
        _InterlockedIncrement(&dword_1C006E7D8);
        WdLogSingleEntry1(6LL, 432LL);
LABEL_23:
