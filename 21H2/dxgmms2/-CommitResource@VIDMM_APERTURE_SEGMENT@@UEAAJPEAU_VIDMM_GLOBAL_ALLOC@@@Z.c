/*
 * XREFs of ?CommitResource@VIDMM_APERTURE_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0099590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( (int)v12 < 0 )
    goto LABEL_30;
LABEL_20:
  if ( (**((_DWORD **)a2 + 64) & 0x4000) != 0 && !*((_QWORD *)a2 + 47) )
  {
...
LABEL_32:
  ...
  *((_DWORD *)a2 + 30) = 2;
  *((_QWORD *)a2 + 16) = v32;
  *(_WORD *)(*((_QWORD *)a2 + 64) + 6LL) = VIDMM_SEGMENT::DriverId(v32);
  *(_QWORD *)(*((_QWORD *)a2 + 64) + 32LL) = *((_QWORD *)a2 + 17) + *(_QWORD *)(*((_QWORD *)a2 + 16) + 24LL);
  *((_QWORD *)a2 + 27) = 0LL;
  v33 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 392);
  *((_QWORD *)a2 + 26) = 0LL;
  *((_QWORD *)a2 + 25) = 0LL;
  *((_DWORD *)a2 + 21) &= ~8u;
  *((_BYTE *)a2 + 89) = 1;
