/*
 * XREFs of ?TerminateOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C0089CA8
 * Callers:
        ...
        struct DXGTERMINATIONTRACKER *a5)
{
  ...
  *((_DWORD *)a2 + 8) |= 1u;
  ...
  v14 = **a2;
  v15 = *(_QWORD *)(v14 + 16);
  if ( (**(_DWORD **)(v14 + 512) & 0x20000000) != 0 )
  {
    ++*((_DWORD *)this + 1938);
    *((_QWORD *)this + 970) += v15;
  }
  ...
  v28[6] = v26;
  LODWORD(v28[0]) = (v6 & 1) == 0 || (**(_DWORD **)(v8 + 512) & 0x4000) != 0;
  v17 = a2[1][4];
