/*
 * XREFs of ?CheckBudgetRefreshConditionOnProcessMemoryChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C0082C68
 * Callers:
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v6, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v15 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            McTemplateK0q_EtwWriteTransfer(v8, (const EVENT_DESCRIPTOR *)"g", v9, v15);
        }
