/*
 * XREFs of ?FullySuspend@VIDMM_DEVICE@@IEAAXXZ @ 0x1C00B7DC0
 * Callers:
 ...
 *     VidSchDeviceQueuesNotEmpty @ 0x1C0012BB8 (VidSchDeviceQueuesNotEmpty.c)
 ...
 *     ?MoveToPenaltyBoxBandNoLock@VIDMM_DEVICE@@IEAAXW4VIDMM_PENALTY_BOX_BAND@@@Z @ 0x1C0084B74 (-MoveToPenaltyBoxBandNoLock@VIDMM_DEVICE@@IEAAXW4VIDMM_PENALTY_BOX_BAND@@@Z.c)
 *     ?SuspendPagingQueues@VIDMM_DEVICE@@QEAAXXZ @ 0x1C0084BC0 (-SuspendPagingQueues@VIDMM_DEVICE@@QEAAXXZ.c)
...
void __fastcall VIDMM_DEVICE::FullySuspend(VIDMM_GLOBAL **this)
{
  ...
  this[29] = (VIDMM_GLOBAL *)qword_1C0050458;
  v4 = *(_QWORD *)*this;
  ...
  *(_QWORD *)(v6 + 8) = 0LL;
  ...
  v10 = qword_1C0050448 + TimeIncrement * v7;
