/*
 * XREFs of _guard_dispatch_icall_nop @ 0x1C0018BF0
 * Callers:
 *     ?GetCurrent@DXGPROCESS@@SAPEAV1@XZ @ 0x1C0001690 (-GetCurrent@DXGPROCESS@@SAPEAV1@XZ.c)
 *     ?NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C0001874 (-NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z.c)
 ...
 *     ?GetCurrent@VIDMM_PARTITION@@SAPEAU1@XZ @ 0x1C0001EE4 (-GetCurrent@VIDMM_PARTITION@@SAPEAU1@XZ.c)
 ...
 *     DpiOpenPnpRegistryKey @ 0x1C0017200 (DpiOpenPnpRegistryKey.c)
 *     DpiGetPnpRegistryKeyName @ 0x1C0017680 (DpiGetPnpRegistryKeyName.c)
 ...
 *     ?DdiCreateDevice@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEDEVICE@@@Z @ 0x1C00177E8 (-DdiCreateDevice@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEDEVICE@@@Z.c)
 ...
 *     DxgkReleaseGuestCpuEvent @ 0x1C00178F0 (DxgkReleaseGuestCpuEvent.c)
 ...
 *     ?DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C00225E4 (-DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z.c)
 *     ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C0022608 (-DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERT.c)
 ...
 *     ?DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1C0022698 (-DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z.c)
 *     ?DdiSignalMonitoredFence@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_SIGNALMONITOREDFENCE@@@Z @ 0x1C00226BC (-DdiSignalMonitoredFence@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_SIGNALMONITOREDFENCE@@@Z.c)
 *     ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C00226E0 (-DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 *     MapChildMmioSpace @ 0x1C0022BAC (MapChildMmioSpace.c)
 *     MapChildVaSpace @ 0x1C0022BDC (MapChildVaSpace.c)
 *     MapGpadl @ 0x1C0022C34 (MapGpadl.c)
 *     SendWnfNotificationToVmProcess @ 0x1C0022C58 (SendWnfNotificationToVmProcess.c)
 *     UnmapChildMmioSpace @ 0x1C0022C8C (UnmapChildMmioSpace.c)
 *     UnmapGpadl @ 0x1C0022CB0 (UnmapGpadl.c)
 *     ?DeferredWorkQueueCallback@DXG_DEFERRED_WORK_QUEUE@@SAXPEAX@Z @ 0x1C0023850 (-DeferredWorkQueueCallback@DXG_DEFERRED_WORK_QUEUE@@SAXPEAX@Z.c)
 ...
 *     ??1CVidSchSubmitData@@QEAA@XZ @ 0x1C0029DCC (--1CVidSchSubmitData@@QEAA@XZ.c)
 *     ?InitializeSubmitData@CVidSchSubmitData@@QEAAXXZ @ 0x1C002A100 (-InitializeSubmitData@CVidSchSubmitData@@QEAAXXZ.c)
 *     ?VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR2@@YAEPEAX@Z @ 0x1C002AF60 (-VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR2@@YAEPEAX@Z.c)
 *     ?VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR3@@YAEPEAX@Z @ 0x1C002AFB0 (-VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR3@@YAEPEAX@Z.c)
 *     ?VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR@@YAEPEAX@Z @ 0x1C002B000 (-VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR@@YAEPEAX@Z.c)
 ...
 *     ?CleanupMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAEXZ @ 0x1C0061E54 (-CleanupMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAEXZ.c)
 ...
 *     _tlgEnableCallback @ 0x1C008B300 (_tlgEnableCallback.c)
 ...
 *     ?ReserveTemporaryResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C008DB20 (-ReserveTemporaryResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
 ...
 *     ?MapTemporaryResource@VIDMM_APERTURE_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAU_MDL@@@Z @ 0x1C00C3738 (-MapTemporaryResource@VIDMM_APERTURE_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAU_MDL@@@Z.c)
 ...
 *     ?TrimMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAXPEA_K@Z @ 0x1C00C98E4 (-TrimMarkedForEvictionAllocations@VIDMM_SEGMENT@@QEAAXPEA_K@Z.c)
 ...
 *     VidSchSetVidPnSourceAddress @ 0x1C00D29F0 (VidSchSetVidPnSourceAddress.c)
