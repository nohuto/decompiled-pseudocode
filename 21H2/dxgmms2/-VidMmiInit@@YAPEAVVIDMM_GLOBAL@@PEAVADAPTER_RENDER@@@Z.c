/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C009706C
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0017390 (VidMmInitializeAdapter.c)
 * Callees:
 ...
 *     ??_GVIDMM_GLOBAL@@QEAAPEAXI@Z @ 0x1C00224A0 (--_GVIDMM_GLOBAL@@QEAAPEAXI@Z.c)
...
struct VIDMM_GLOBAL *__fastcall VidMmiInit(struct ADAPTER_RENDER *a1)
{
  ...
  if ( ZwQuerySystemInformation(SystemBasicInformation, SystemInformation, 0x40u, 0LL) < 0
    || *(_QWORD *)(v2 + 1992) < (unsigned __int64)SystemInformation[5] << 12 )
  {
...
LABEL_24:
  ...
  if ( v18 < 0 )
  {
    _InterlockedIncrement(&dword_1C00506D0);
