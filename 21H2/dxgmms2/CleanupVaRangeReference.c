/*
 * XREFs of CleanupVaRangeReference @ 0x1C005D008
 * Callers:
...
__int64 __fastcall CleanupVaRangeReference(VIDMM_MAPPED_VA_RANGE *this, _QWORD *a2)
{
  ...
  if ( (v3 & 0x2000) != 0 )
  {
    if ( GetVidMmAllocFromOwner(v3 << 28 >> 28, *((_QWORD *)v2 + 7)) )
    {
      v4 = (_QWORD *)((char *)v2 + 24);
      v5 = *((_QWORD *)v2 + 3);
      if ( *(VIDMM_MAPPED_VA_RANGE **)(v5 + 8) != (VIDMM_MAPPED_VA_RANGE *)((char *)v2 + 24) )
        goto LABEL_10;
