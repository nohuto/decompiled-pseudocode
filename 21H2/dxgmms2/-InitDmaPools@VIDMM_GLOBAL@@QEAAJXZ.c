/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C00990FC
 * Callers:
 ...
 *     ?Init@VIDMM_DMA_POOL@@QEAAJXZ @ 0x1C008DEA8 (-Init@VIDMM_DMA_POOL@@QEAAJXZ.c)
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C008EAF0 (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
 */
  ...
  if ( *((_DWORD *)this + 1750) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v2 + 79) = v6;
      ...
      if ( v8 < 0 )
      {
        _InterlockedAdd(&dword_1C0050714, 1u);
    ...
    _InterlockedAdd(&dword_1C0050710, 1u);
    v14 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v14 + 24) = 1940LL;
