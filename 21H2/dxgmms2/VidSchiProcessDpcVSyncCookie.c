/*
 * XREFs of VidSchiProcessDpcVSyncCookie @ 0x1C0005790
 * Callers:
 ...
 *     ?VidSchiIsExpectedVSyncCookie@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C0003DCC (-VidSchiIsExpectedVSyncCookie@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_V.c)
 ...
 *     ?VidSchiIndependentVidPnAdaptiveVSync@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_VSYNC_COOKIE@@I_N2@Z @ 0x1C002B0AC (-VidSchiIndependentVidPnAdaptiveVSync@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_VSYNC_COOKIE@@I_N2@Z.c)
...
LABEL_27:
  ...
  if ( _InterlockedExchange((volatile __int32 *)(v1 + 2192), 0)
    || (v8 = *(unsigned int *)(*(_QWORD *)(v1 + 16) + 2728LL), (_DWORD)v8)
    || *(_DWORD *)(v1 + 732)
    || *(_DWORD *)(v1 + 804)
    || *(_DWORD *)(v1 + 1884) )
  {
...
LABEL_63:
          ...
          if ( _InterlockedDecrement((volatile signed __int32 *)(v22 + 4LL * (unsigned int)v27 + 2728)) < 0 )
          {
            v47 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v27, v26);
            v47[3] = 275LL;
            v47[4] = 37LL;
            v47[5] = v22;
            v47[6] = *(unsigned int *)(v22 + 4 * v28 + 2728);
            v47[7] = 0LL;
