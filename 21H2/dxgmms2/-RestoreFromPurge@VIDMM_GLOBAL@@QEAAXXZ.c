/*
 * XREFs of ?RestoreFromPurge@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B34D4
 * Callers:
 *     VidMmRestoreFromPurge @ 0x1C00230B0 (VidMmRestoreFromPurge.c)
 * Callees:
 ...
 *     VidSchCreateSchedulingLogs @ 0x1C0098F28 (VidSchCreateSchedulingLogs.c)
 *     ?InitPagingProcessVaSpace@VIDMM_GLOBAL@@QEAAJIE@Z @ 0x1C0098F98 (-InitPagingProcessVaSpace@VIDMM_GLOBAL@@QEAAJIE@Z.c)
 *     ?MapAllPagingBuffers@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B1414 (-MapAllPagingBuffers@VIDMM_GLOBAL@@QEAAXXZ.c)
 */
