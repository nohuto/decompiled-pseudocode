/*
 * XREFs of VidSchiCreateNodeSchedulingLog @ 0x1C0042A90
 * Callers:
 *     ?VidSchiProcessAsyncOperation@@YAXPEAX@Z @ 0x1C00401E0 (-VidSchiProcessAsyncOperation@@YAXPEAX@Z.c)
...
__int64 __fastcall VidSchiCreateNodeSchedulingLog(struct _VIDSCH_NODE *a1, unsigned int a2)
{
  ...
  v8 = VIDMM_SCH_LOG::CreateSchLog(
         *(struct VIDMM_GLOBAL **)(*(_QWORD *)(v2 + 8) + 656LL),
  ...
  *((_QWORD *)&v23 + 1) = v27;
  ...
  DWORD2(v22) = v3;
  *(_QWORD *)&v23 = v9;
  v14 = ((__int64 (__fastcall *)(_QWORD, __int128 *))DxgCoreInterface[20])(*(_QWORD *)(v2 + 8), &v22);
  v8 = v14;
  if ( v14 == -1073741822 || v14 >= 0 )
  {
    ...
    v15 = (void *)*((_QWORD *)a1 + 1392);
    v16 = *((_QWORD *)a1 + 1397);
    v17 = *((_QWORD *)a1 + 1398);
    v18 = *((_QWORD *)a1 + 1399);
    v29 = (void *)*((_QWORD *)a1 + 1400);
    *((_QWORD *)a1 + 1392) = P;
    v19 = v27;
    *((_DWORD *)a1 + 2786) = v3;
    *((_QWORD *)a1 + 1395) = v19;
