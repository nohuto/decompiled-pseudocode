/*
 * XREFs of ?TransferMemorySlow@VIDMM_MEMORY_SEGMENT@@IEAAXPEAU_VIDMM_GLOBAL_ALLOC@@W4_DXGK_MEMORY_TRANSFER_DIRECTION@@PEAVVIDMM_SEGMENT@@T_LARGE_INTEGER@@@Z @ 0x1C00C5AC4
 * Callers:
        ...
        union _LARGE_INTEGER a5)
{
  ...
  if ( v8 )
  {
    do
    {
      ...
      {
        LOBYTE(v27) = v13 == v15;
        v16 = (*(__int64 (__fastcall **)(_QWORD, struct _VIDMM_GLOBAL_ALLOC *, char *, unsigned __int64, struct VIDMM_SEGMENT *, char *, struct _MDL **))(**((_QWORD **)a2 + 32) + 96LL))(
                *((_QWORD *)a2 + 32),
                a2,
                v12,
                v15,
        ...
        if ( v16 >= 0 )
        {
          ...
          if ( !v28 )
          {
            MDLForRange = VidMmGetMDLForRange(a2, (__int64)v12, v15);
            v28 = MDLForRange;
            if ( !MDLForRange )
              v16 = -1071775487;
          }
          if ( v16 >= 0 )
          {
            if ( !v29 )
            {
              v18 = (*(__int64 (__fastcall **)(_QWORD, struct _VIDMM_GLOBAL_ALLOC *, char *, unsigned __int64, struct _MDL *))(**((_QWORD **)a2 + 32) + 112LL))(
                      *((_QWORD *)a2 + 32),
                      a2,
                      v12,
                      v15,
            ...
            if ( v16 >= 0 )
            {
              ...
              (*(void (__fastcall **)(_QWORD, struct _VIDMM_GLOBAL_ALLOC *, char *, unsigned __int64, struct _MDL *))(**((_QWORD **)a2 + 32) + 120LL))(
                *((_QWORD *)a2 + 32),
                a2,
                v12,
                v15,
