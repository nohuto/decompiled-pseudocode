/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B3948
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C00230D0 (VidMmSetAllocationPriority.c)
 * Callees:
