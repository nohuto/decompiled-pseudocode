/*
 * XREFs of ?AcquireGPUResourcesFromPreferredSegmentSet@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@KK@Z @ 0x1C00879DC
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v9 = ((a3 - 3) & 0xFFFFFFFA) == 0
    && a3 != 8
    && ((v21 = **(_DWORD **)(a2 + 512), (v21 & 0x20000000) == 0) || v21 >= 0)
    && (v21 & 0x80000) == 0;
  if ( !*(_BYTE *)(a1 + 7144) || v9 )
    v10 = 2;
  else
