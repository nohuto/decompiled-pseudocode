/*
 * XREFs of ?ReferenceAllocationForPreparation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@PEAE@Z @ 0x1C006F668
 * Callers:
...
LABEL_22:
    ...
    *((_QWORD *)this + 914) += *(_QWORD *)(v6 + 16);
    ++*((_DWORD *)this + 1826);
    VIDMM_SEGMENT::ReclaimResource(*(VIDMM_SEGMENT **)(v6 + 128), (struct _VIDMM_GLOBAL_ALLOC *)v6);
    *a3 = 1;
  }
  if ( (*(_DWORD *)(v6 + 76) & 0x1000000) != 0 )
    goto LABEL_22;
