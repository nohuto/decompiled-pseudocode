/*
 * XREFs of VidSchiUnwaitContext @ 0x1C0010FC8
 * Callers:
 ...
 *     ?VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z @ 0x1C002CE20 (-VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z.c)
