/*
 * XREFs of ?VidSchiSignalRuntimeFenceForCompletedFlipEntry@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@W4_VIDSCH_FLIP_STATUS@@PEAVHwQueueStagingList@@@Z @ 0x1C0010CD0
 * Callers:
        ...
        struct HwQueueStagingList *a4)
{
  ...
  while ( v8 || v5 )
  {
    ...
    if ( v11 >= v12 )
      v14 = v12;
    if ( *(_QWORD *)(v14 * ((8 * *(_DWORD *)(v13 + 8) + 231) & 0xFFFFFFF8) + v13 + 208) )
    {
      v18 = *(struct _VIDSCH_SYNC_OBJECT **)(v14 * ((8 * *(_DWORD *)(v13 + 8) + 231) & 0xFFFFFFF8) + v13 + 216);
      v25 = *(struct _VIDSCH_SYNC_OBJECT **)(v14 * ((8 * *(_DWORD *)(v13 + 8) + 231) & 0xFFFFFFF8) + v13 + 208);
      v24 = v18;
    ...
    v15 = *(_QWORD *)(a2 + 1176);
    v16 = v14 * ((8 * *(_DWORD *)(v15 + 8) + 231) & 0xFFFFFFF8);
    if ( *(_QWORD *)(v16 + v15 + 224) && a3 )
    {
      v24 = *(struct _VIDSCH_SYNC_OBJECT **)(v16 + v15 + 224);
      if ( (int)VidSchiSignalSyncObjectsFromCpu(a4, 1u, &v24, 0, (const unsigned __int64 *)(v15 + 232 + v16), 0LL) < 0 )
      {
        v19 = *(_QWORD *)(a2 + 1176);
