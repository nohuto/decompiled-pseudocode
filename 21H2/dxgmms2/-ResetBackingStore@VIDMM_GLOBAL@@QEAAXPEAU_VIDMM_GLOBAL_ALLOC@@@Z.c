/*
 * XREFs of ?ResetBackingStore@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00750FC
 * Callers:
...
LABEL_17:
        ...
        if ( v10 != -1071775472 )
        {
          v20 = WdLogNewEntry5_WdAssertion(v12, v11, v7);
          *(_QWORD *)(v20 + 24) = 6915LL;
          WdLogEvent5_WdAssertion(v20);
        }
        _InterlockedIncrement(&dword_1C00506D8);
        v21 = WdLogNewEntry5_WdLowResource(v12);
        *(_QWORD *)(v21 + 24) = 6919LL;
