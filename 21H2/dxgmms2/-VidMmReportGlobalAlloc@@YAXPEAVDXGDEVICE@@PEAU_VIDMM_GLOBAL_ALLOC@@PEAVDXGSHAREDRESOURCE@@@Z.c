/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00E1A68
 * Callers:
 *     VidMmReportMultiGlobalAlloc @ 0x1C00B8D20 (VidMmReportMultiGlobalAlloc.c)
...
void __fastcall VidMmReportGlobalAlloc(struct DXGDEVICE *a1, struct _VIDMM_GLOBAL_ALLOC *a2, __int64 a3)
{
  ...
  v19 = *((_QWORD *)a2 + 66);
  if ( *(_WORD *)(v19 + 4) && bTracingEnabled && (byte_1C006E941 & 1) != 0 )
  {
    LOBYTE(v21) = *((_BYTE *)a2 + 448);
