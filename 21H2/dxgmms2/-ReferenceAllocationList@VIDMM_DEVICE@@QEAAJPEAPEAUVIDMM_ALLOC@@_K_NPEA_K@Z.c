/*
 * XREFs of ?ReferenceAllocationList@VIDMM_DEVICE@@QEAAJPEAPEAUVIDMM_ALLOC@@_K_NPEA_K@Z @ 0x1C00672D0
 * Callers:
  ...
  if ( v9 != v17 )
  {
    do
    {
      ...
      if ( ((*(_DWORD *)(v20 + 76) & 0x40) == 0
         || *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v19 + 1) + 8LL) + 288LL) == **(_QWORD **)(v20 + 496))
        && !(*((_BYTE *)v19 + 25) & 1 | *((_DWORD *)v19 + 42))
        && !*((_BYTE *)v19 + 27) )
      {
        v51 = **(_QWORD **)v19;
