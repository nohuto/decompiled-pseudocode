/*
 * XREFs of ?FreeGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@_K1E@Z @ 0x1C0062C90
 * Callers:
        ...
        char a5)
{
  ...
  if ( v8 )
  {
    if ( (*((_DWORD *)v8 + 18) & 0x800) == 0 || a5 )
    {
      ...
      {
        v15 = (_QWORD **)((char *)v8 + 32 * i + 8 * i + 96);
