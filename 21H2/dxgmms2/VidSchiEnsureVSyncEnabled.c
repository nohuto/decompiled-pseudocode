/*
 * XREFs of VidSchiEnsureVSyncEnabled @ 0x1C0080630
 * Callers:
 ...
 * Callees:
 *     ?IncrementNumberOfQueuedFlipPerSource@@YAXPEAU_VIDSCH_GLOBAL@@I@Z @ 0x1C0015560 (-IncrementNumberOfQueuedFlipPerSource@@YAXPEAU_VIDSCH_GLOBAL@@I@Z.c)
