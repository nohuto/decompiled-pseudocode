/*
 * XREFs of ?AcquireGPUResourcesFromSegmentSet@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@EI_K@Z @ 0x1C0087B90
 * Callers:
 ...
 *     ?ValidateSegmentForAcquisitionOfResource@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@IW4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C006FBFC (-ValidateSegmentForAcquisitionOfResource@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@IW4_VIDMM_P.c)
 */
    ...
    do
    {
      ...
      if ( (v15 & 3) != 0 )
      {
        ...
        if ( (*(_DWORD *)(v14 + 80) & 1) != 0 )
        {
          ...
          {
LABEL_8:
            if ( (_DWORD)v13 != *(unsigned __int16 *)(v10 + 28) || (**(_DWORD **)(a2 + 512) & 0x8000) == 0 )
            {
              v17 = ((a3 - 3) & 0xFFFFFFFA) == 0
                 && a3 != 8
                 && ((v16 = **(_DWORD **)(a2 + 512), (v16 & 0x20000000) == 0) || v16 >= 0)
                 && (v16 & 0x80000) == 0;
              v18 = a6;
              LOBYTE(v18) = 1;
