/*
 * XREFs of ?MarkResourcesForEviction@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K1@Z @ 0x1C0073BAC
 * Callers:
 ...
 *     ?MarkBlockForEviction@VIDMM_LINEAR_POOL@@QEAAXPEAXPEA_K1@Z @ 0x1C00744DC (-MarkBlockForEviction@VIDMM_LINEAR_POOL@@QEAAXPEAXPEA_K1@Z.c)
 */
        ...
        unsigned __int64 *a4)
{
  ...
  v8 = (struct VIDMM_PARTITION **)a2[62];
  ...
  *((_DWORD *)a2 + 30) = 1;
  ...
  v14 = (VIDMM_SEGMENT *)(a2 + 49);
  v15 = a2[49];
  if ( *((struct _VIDMM_POOL_BLOCK ***)v15 + 1) != a2 + 49
    || (v16 = a2[50], *(VIDMM_SEGMENT **)v16 != v14)
    || (*(_QWORD *)v16 = v15,
        *((_QWORD *)v15 + 1) = v16,
  ...
  *(_QWORD *)v14 = this + 22;
  a2[50] = (struct _VIDMM_POOL_BLOCK *)v17;
  *v17 = v14;
  this[23] = v14;
}
