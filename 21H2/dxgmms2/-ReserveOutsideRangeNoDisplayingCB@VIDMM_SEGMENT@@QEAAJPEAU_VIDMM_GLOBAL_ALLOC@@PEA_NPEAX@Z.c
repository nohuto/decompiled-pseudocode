/*
 * XREFs of ?ReserveOutsideRangeNoDisplayingCB@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEA_NPEAX@Z @ 0x1C00C8D90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( VIDMM_SEGMENT::IsMovableResourceNoDisplayingCB((_VIDMM_GLOBAL_ALLOC_NONPAGED **)a2) )
  {
          ...
          Outside >= 0) )
    {
      ...
      *((_BYTE *)this + 472) = 1;
      if ( _VIDMM_GLOBAL_ALLOC_NONPAGED::HasOutstandingPresentReferences(*((_VIDMM_GLOBAL_ALLOC_NONPAGED **)a2 + 64)) )
