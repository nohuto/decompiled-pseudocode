/*
 * XREFs of USBParseGetChannelConfigForUnit_Old @ 0x1C002FC80
 * Callers:
...
__int64 __fastcall USBParseGetChannelConfigForUnit_Old(unsigned __int16 *a1, char *a2, int a3)
{
  unsigned int v5; // ebx
  ...
  switch ( v7 )
  {
    ...
    case 3u:
      v8 = Unit[7];
      return (unsigned int)USBParseGetChannelConfigForUnit_Old(a1, a2, v8);
    case 4u:
