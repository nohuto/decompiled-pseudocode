/*
 * XREFs of PropertyGetProcessControlRange @ 0x1C002A89C
 * Callers:
 *     TopologyPU3DExtender @ 0x1C0026DA0 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x1C0026E90 (TopologyPUChorus.c)
 *     TopologyPUReverb @ 0x1C0027000 (TopologyPUReverb.c)
 *     TopologyPUDynRangeCompressor @ 0x1C00271A0 (TopologyPUDynRangeCompressor.c)
 * Callees:
