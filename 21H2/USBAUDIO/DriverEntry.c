/*
 * XREFs of DriverEntry @ 0x1C002355C
 * Callers:
 *     GsDriverEntry @ 0x1C0036230 (GsDriverEntry.c)
 * Callees:
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  v10 = KsInitializeDriver(DriverObject, RegistryPath, &KsDeviceDescriptor);
  if ( v10 < 0 || (v10 = DriverCopyRegistryString(v9, RegistryPath), v10 < 0) )
  {
