/*
 * XREFs of USBHwSelectStreamingAudioInterfaceSideband @ 0x1C002D9FC
 * Callers:
 ...
 *     USBD_GetEndpointOffloadInformationForIndex @ 0x1C0011AA0 (USBD_GetEndpointOffloadInformationForIndex.c)
