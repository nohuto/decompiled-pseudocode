/*
 * XREFs of PropertyGetBoolean @ 0x1C0028E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PropertyGetBoolean(IRP *a1, __int64 a2, _DWORD *a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF__guid_d((__int64)WPP_GLOBAL_Control->DeviceExtension, v8, v9, 0xFu, v15, a2);
  if ( !FilterFromIrp )
    goto LABEL_9;
  v11 = (__int64)&FilterFromIrp->Descriptor->NodeDescriptors[7 * *(unsigned int *)(a2 + 24)];
  v12 = *(_QWORD *)(v11 + 128);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_dddd((__int64)WPP_GLOBAL_Control->DeviceExtension, v8, v9, 0x10u, v15);
