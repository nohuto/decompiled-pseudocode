/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000C630
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x1C0028FC8 (PropertyGetBooleanBasicSupportSideband.c)
 */
