/*
 * XREFs of ?GetSidetoneImmediate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000C824
 * Callers:
 ...
 *     PropertyGetBooleanSideband @ 0x1C0028DE8 (PropertyGetBooleanSideband.c)
 *     PropertyGetDbLevelSideband @ 0x1C00294DC (PropertyGetDbLevelSideband.c)
 */
