/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000C220
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1C00298FC (PropertyGetDbBasicSupportSideband.c)
 */
