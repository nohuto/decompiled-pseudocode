...
LABEL_47:
    ...
    while ( 1 )
    {
      *(_DWORD *)(a1 + 4) = 0;
      ...
      v29 = _InterlockedCompareExchange(a2, v25 ^ ((unsigned __int16)v25 ^ (unsigned __int16)(32 * v28)) & 0x3FE0, v16);
      if ( v16 == v29 )
        break;
      v16 = v29;
    }
...
LABEL_33:
    ...
    while ( 1 )
    {
      *(_DWORD *)(a1 + 4) = 0;
      ...
      v23 = _InterlockedCompareExchange(a2, v18 ^ (v18 ^ ((_DWORD)v22 << 15)) & 0x3F8000, v16);
      if ( v16 == v23 )
        break;
      v16 = v23;
    }
