/*
 * XREFs of ?IoQueueThread@CSidebandDevice@@AEAAXXZ @ 0x1C000D984
 * Callers:
 *     ?staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z @ 0x1C000DD00 (-staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z.c)
 * Callees:
