/*
 * XREFs of PinValidateDataFormat @ 0x1C0024190
 * Callers:
 ...
 *     PinMIDIDataFormatIntersection @ 0x1C0024DB0 (PinMIDIDataFormatIntersection.c)
 * Callees:
 *     IsSampleRateInRange @ 0x1C0024068 (IsSampleRateInRange.c)
