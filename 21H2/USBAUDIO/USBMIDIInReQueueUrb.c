/*
 * XREFs of USBMIDIInReQueueUrb @ 0x1C0007EE0
 * Callers:
 *     <none>
 * Callees:
 *     USBMidiInGetCurrentTime @ 0x1C0003F30 (USBMidiInGetCurrentTime.c)
...
void __fastcall USBMIDIInReQueueUrb(PDEVICE_OBJECT DeviceObject, char *Context)
{
  ...
  while ( !v8 && !Context[41] )
  {
    *(_BYTE *)(v9 + 48) = 0;
          ...
          do
          {
              ...
              && LOWORD(WPP_GLOBAL_Control->DeviceType) )
            {
              ...
              WPP_RECORDER_SF_DDDD(
                ...
                v12[1],
                v26 & 0xF,
                (__int64)&WPP_e06a0e2fac753ad629d833d869358240_Traceguids,
                v26,
                v27,
                v28,
                v29);
    ...
    ++*((_DWORD *)Context + 17);
    v7 = v24;
    v25 = *((unsigned int *)Context + 17);
    if ( 16 * *((_DWORD *)Context + 6) == (_DWORD)v25 )
    {
      *((_DWORD *)Context + 17) = 0;
      v25 = 0LL;
    }
    v9 = (*((_QWORD *)Context + 20) + (v25 << 6)) & -(__int64)(*(_BYTE *)(*((_QWORD *)Context + 20) + (v25 << 6) + 48) != 0);
    v8 = v9 == 0;
  }
  Context[72] = 0;
