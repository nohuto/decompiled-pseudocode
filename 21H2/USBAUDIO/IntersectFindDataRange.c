/*
 * XREFs of IntersectFindDataRange @ 0x1C0025BAC
 * Callers:
 *     PinDataFormatIntersection @ 0x1C0024E30 (PinDataFormatIntersection.c)
 * Callees:
 *     IntersectFindBestMatch @ 0x1C0025A1C (IntersectFindBestMatch.c)
 */
