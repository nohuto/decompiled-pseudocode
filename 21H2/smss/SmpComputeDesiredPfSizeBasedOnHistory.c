/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x140014478
 * Callers:
...
__int64 SmpComputeDesiredPfSizeBasedOnHistory()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (unsigned int)Data < 0xF0 )
    v18 = Data;
  if ( v18 )
    memcpy_0(Base, &unk_140028EF4, 4LL * v18);
  qsort(Base, v18, 4uLL, SmpPagefileUsageSampleCompare);
  v19 = (unsigned int)dword_140028BA8 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v19 + (v19 >> 4);
}
