/*
 * XREFs of SmpLoadDataFromRegistry @ 0x140009604
 * Callers:
 ...
 *     SmpFinalizePathStrings @ 0x140007380 (SmpFinalizePathStrings.c)
 ...
 *     SmpInitializeSessionManagement @ 0x14000C430 (SmpInitializeSessionManagement.c)
 ...
 *     SmpInitializeKnownDllsAsync @ 0x14000F0B8 (SmpInitializeKnownDllsAsync.c)
 *     SmpReplaceSystemHiveOnSoftReboot @ 0x14000F3BC (SmpReplaceSystemHiveOnSoftReboot.c)
 *     SmpSuffixUnicodeString @ 0x14000F520 (SmpSuffixUnicodeString.c)
...
int __fastcall SmpLoadDataFromRegistry(HANDLE EventHandle, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  qword_140028AC8 = (__int64)&SmpBootExecuteList;
  SmpBootExecuteList = (__int64)&SmpBootExecuteList;
  qword_140028AD8 = (__int64)&SmpBootExecuteNoPnpSyncList;
  SmpBootExecuteNoPnpSyncList = (__int64)&SmpBootExecuteNoPnpSyncList;
  qword_140028AE8 = (__int64)&SmpPlatformExecuteList;
  SmpPlatformExecuteList = (__int64)&SmpPlatformExecuteList;
  qword_140028AF8 = (__int64)&SmpSetupExecuteList;
  SmpSetupExecuteList = (__int64)&SmpSetupExecuteList;
  qword_140028C08 = (__int64)&SmpPagingFileList;
  SmpPagingFileList = &SmpPagingFileList;
  qword_140028B08 = (__int64)&SmpDosDevicesList;
  SmpDosDevicesList = &SmpDosDevicesList;
  qword_140028B18 = (__int64)&SmpFileRenameList;
  SmpFileRenameList = &SmpFileRenameList;
  qword_140028B28 = (__int64)&SmpKnownDllsList;
  SmpKnownDllsList = &SmpKnownDllsList;
  qword_140028B38 = (__int64)&SmpExcludeKnownDllsList;
  SmpExcludeKnownDllsList = &SmpExcludeKnownDllsList;
  qword_140028B48 = (__int64)&SmpSubSystemsRequired;
  SmpSubSystemsRequired = (__int64)&SmpSubSystemsRequired;
  qword_140028B58 = (__int64)&SmpSubSystemsToDefer;
  SmpSubSystemsToDefer = (__int64)&SmpSubSystemsToDefer;
  qword_140028BF8 = (__int64)&SmpExistingPageFilesList;
...
LABEL_3:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  RtlStringCbPrintfW(pszDest, 0x200uLL, L"%u", (unsigned int)byte_140028BD8);
  v10 = -1LL;
  do
    ++v10;
  while ( pszDest[v10] );
  ...
  if ( Environment < 0 )
  {
    ...
    SmpInitProgressByLine = 2190;
    goto LABEL_3;
  }
  result = SmpFinalizePathStrings();
  if ( result < 0 )
  {
    SmpInitProgressByLine = 2203;
...
LABEL_23:
  ...
  if ( result < 0 )
  {
    SmpInitProgressByLine = 2285;
    v11 = SmpInitializeDosDevices;
    goto LABEL_14;
  }
  ObjectAttributes.Length = 48;
  ...
  if ( Environment < 0 )
  {
    ...
    SmpInitProgressByLine = 2317;
    goto LABEL_3;
  }
  result = SmpCreateProtectedPrefixes();
  if ( result < 0 )
  {
    SmpInitProgressByLine = 2334;
