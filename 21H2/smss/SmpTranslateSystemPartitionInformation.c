/*
 * XREFs of SmpTranslateSystemPartitionInformation @ 0x14000CCE0
 * Callers:
...
int SmpTranslateSystemPartitionInformation()
{
  ...
  const wchar_t *v15; // [rsp+A8h] [rbp-58h]
  ...
  int v19; // [rsp+E0h] [rbp-20h] BYREF
  const wchar_t *v20; // [rsp+E8h] [rbp-18h]
  struct _UNICODE_STRING v21; // [rsp+F0h] [rbp-10h] BYREF
  __int16 Buffer; // [rsp+100h] [rbp+0h] BYREF
  _WORD *v23; // [rsp+108h] [rbp+8h]
  UNICODE_STRING String1; // [rsp+110h] [rbp+10h] BYREF
  _WORD v25[272]; // [rsp+120h] [rbp+20h] BYREF
  ...
  v14 = 4063292;
  v15 = L"\\Registry\\Machine\\System\\Setup";
  ...
  *(_DWORD *)&String2.Length = 1703960;
  ...
  Context = 0;
  v20 = L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\Setup";
  v19 = 8650882;
...
LABEL_19:
        if ( result != -2147483622 )
          return result;
        NtSystemRoot = (_WORD *)RtlGetNtSystemRoot(v3, v2, v4, v5);
        v23 = v25;
        v25[0] = *NtSystemRoot;
        v25[1] = NtSystemRoot[1];
      }
      else
      {
        while ( 1 )
              ...
              *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
              if ( NtOpenSymbolicLinkObject(&SymbolicLinkHandle, 0xF0001u, &ObjectAttributes) >= 0 )
              {
                *(_DWORD *)&LinkTarget.Length = 0x2000000;
                v6 = NtQuerySymbolicLinkObject(SymbolicLinkHandle, &LinkTarget, 0LL);
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( result >= 0 )
      {
        Data[0] = *(_DWORD *)v23;
        Data[1] = 92;
        NtSetValueKey(KeyHandle, &v21, 0, 1u, Data, 8u);
