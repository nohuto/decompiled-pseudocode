/*
 * XREFs of SmpExecPgm @ 0x1400023D0
 * Callers:
 *     SmpApiCallback @ 0x140002A70 (SmpApiCallback.c)
 * Callees:
 *     SmpSetCoreProcessIds @ 0x14000261C (SmpSetCoreProcessIds.c)
 *     SmpSessionIdToInitialSessionIndex @ 0x140002714 (SmpSessionIdToInitialSessionIndex.c)
 ...
 *     SmpGetMuSessionIdFromClientContext @ 0x140003BA4 (SmpGetMuSessionIdFromClientContext.c)
