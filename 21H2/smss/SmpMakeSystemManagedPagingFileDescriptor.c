/*
 * XREFs of SmpMakeSystemManagedPagingFileDescriptor @ 0x140014DEC
 * Callers:
 *     SmpProcessPagefileDescriptor @ 0x14000E25C (SmpProcessPagefileDescriptor.c)
 * Callees:
 *     SmpInitializeManagedPagefileSupport @ 0x140014B7C (SmpInitializeManagedPagefileSupport.c)
 *     SmpRoundDownToPowerOf2 @ 0x140014F88 (SmpRoundDownToPowerOf2.c)
 */
