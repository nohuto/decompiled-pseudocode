/*
 * XREFs of SmpCreateVolumeDescriptor @ 0x14000D07C
 * Callers:
 ...
 *     SmpIsVhdVolume @ 0x14000D72C (SmpIsVhdVolume.c)
...
LABEL_33:
  ...
  *(_QWORD *)(v7 + 32) = v10;
  ...
  if ( (v12 & 1) == 0 )
  {
    v14 = (__int64 *)qword_140028E58;
    if ( *(__int64 **)qword_140028E58 == &SmpVolumeDescriptorList )
    {
