/*
 * XREFs of SmpCreatePagingFiles @ 0x14000ABCC
 * Callers:
 *     SmpAsyncMemoryConfiguration @ 0x14000A1C0 (SmpAsyncMemoryConfiguration.c)
 * Callees:
 *     SmpBuildFilesStringFromList @ 0x14000A29C (SmpBuildFilesStringFromList.c)
 ...
 *     SmpRecordCreatedPageFiles @ 0x14000AAA0 (SmpRecordCreatedPageFiles.c)
 *     SmpEnableSwapOnPagingFiles @ 0x14000AE04 (SmpEnableSwapOnPagingFiles.c)
 ...
 *     SmpAdjustPagefileSizeforLowStorage @ 0x14000EB88 (SmpAdjustPagefileSizeforLowStorage.c)
