/*
 * XREFs of SmpParseCommandLine @ 0x1400046C0
 * Callers:
 *     SmpExecuteCommand @ 0x140004568 (SmpExecuteCommand.c)
 *     SmpCreatePagingFileDescriptor @ 0x14000A7A0 (SmpCreatePagingFileDescriptor.c)
 ...
 *     SmpExpandEnvironmentString @ 0x140004C90 (SmpExpandEnvironmentString.c)
 *     SmpQueryEnvVariable @ 0x140005108 (SmpQueryEnvVariable.c)
