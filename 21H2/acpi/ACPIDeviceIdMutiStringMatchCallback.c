/*
 * XREFs of ACPIDeviceIdMutiStringMatchCallback @ 0x1C0056650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIConvertWideStringToUpperCaseHelper @ 0x1C0061720 (ACPIConvertWideStringToUpperCaseHelper.c)
 */
        ...
        int a6)
{
  ...
  unsigned __int64 v36; // [rsp+30h] [rbp-158h]
  _WORD *v37; // [rsp+38h] [rbp-150h]
        ...
        if ( a6 == a4 && *(_QWORD *)(v14 + 8) >= 4uLL )
        {
          ...
          do
          {
            ...
            if ( *v6 && *v17 == v15 )
            {
              ...
              WORD1(v38[v20]) = v36;
              Pool2 = (_WORD *)ExAllocatePool2(256LL, v36, 1399874369LL);
              v38[2 * v9 + 1] = Pool2;
              v37 = Pool2;
              if ( !Pool2 )
                goto LABEL_29;
