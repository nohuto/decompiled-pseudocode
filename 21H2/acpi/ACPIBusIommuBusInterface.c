/*
 * XREFs of ACPIBusIommuBusInterface @ 0x1C00923D0
 * Callers:
...
LABEL_8:
  ...
  if ( v5 >= 0 )
  {
    ...
    do
      ++v12;
    while ( *((_BYTE *)Src + v12) );
    Pool2 = ExAllocatePool2(256LL, (unsigned int)(v12 + 121), 1181770561LL);
    v14 = Pool2;
    if ( Pool2 )
    {
      *(_DWORD *)(Pool2 + 96) = 2;
      *(_QWORD *)(Pool2 + 104) = Pool2 + 120;
      do
        ++v11;
      while ( v10[v11] );
      memmove((void *)(Pool2 + 120), v10, v11 + 1);
