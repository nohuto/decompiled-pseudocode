/*
 * XREFs of AcpiPccAcquireSubspaceCore @ 0x1C005A7A8
 * Callers:
 *     AcpiPccAcquireSubspaceAsync @ 0x1C005A790 (AcpiPccAcquireSubspaceAsync.c)
 *     AcpiPccAcquireSubspace @ 0x1C00AFF00 (AcpiPccAcquireSubspace.c)
 * Callees:
 *     <none>
 */
