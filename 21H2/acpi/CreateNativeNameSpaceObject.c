/*
 * XREFs of CreateNativeNameSpaceObject @ 0x1C0022FC4
 * Callers:
 ...
 *     SetClearAssociatedNativeObject @ 0x1C002394C (SetClearAssociatedNativeObject.c)
 *     GetNextNameSegment @ 0x1C00239C8 (GetNextNameSegment.c)
