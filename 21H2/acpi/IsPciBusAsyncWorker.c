/*
 * XREFs of IsPciBusAsyncWorker @ 0x1C0017710
 * Callers:
...
LABEL_76:
  ...
  *((_DWORD *)a4 + 2) = v10 | 1;
  a4[2] = 0LL;
  v12 = AMLIGetNamedChild(v7, 1145653343LL, a3, a4);
  if ( !v12 )
    goto LABEL_10;
...
LABEL_74:
    ...
    if ( (v14 & 0x80u) == 0 )
    {
      ...
      *((_DWORD *)a4 + 2) = v14 | 0x80;
      v16 = AMLIGetNamedChild(v15, 1145652063LL, a3, a4);
      if ( v16 )
      {
        v6 = ACPIGet(
               (__int64 *)*a4,
...
LABEL_48:
        ...
        {
          v32 = *((unsigned __int8 *)a4 + 86);
          if ( (_BYTE)v32 != 0xFF
            && *((_BYTE *)a4 + 83) != 0xFF
            && *((_BYTE *)a4 + 82) != 0xFF
            && *((_BYTE *)a4 + 81) != 0xFF )
          {
            if ( (v32 & 0xFFFFFF7F) - 1 <= 1 )
            {
              _InterlockedOr64((volatile signed __int64 *)(v8 + 8), 0x2000000uLL);
