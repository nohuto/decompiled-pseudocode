/*
 * XREFs of RawFieldAccess @ 0x1C0069244
 * Callers:
...
LABEL_23:
  ...
  if ( v15[7] )
    v16 = v15[9] + 40;
  v17 = HeapAlloc(*(struct _SLIST_ENTRY **)(a1 + 320), 1430537800, v16);
  v18 = v17;
  if ( !v17 )
  {
    v8 = -1073741670;
...
LABEL_12:
  ...
  memmove(v17, v15, v16);
  v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _SLIST_ENTRY *, __int64, _QWORD, __int64 (__fastcall *)(__int64), __int64))(v13 + 32))(
         a2,
         *v11,
         v18,
         a4,
  ...
  if ( v8 == -1073741789 )
  {
    v21 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1179992648, *(_DWORD *)(a4 + 16));
    *(_QWORD *)(a4 + 32) = v21;
    if ( v21 )
    {
