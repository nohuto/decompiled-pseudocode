/*
 * XREFs of ACPIDispatchIrpDepPdoQueryID @ 0x1C004CC70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    *(_QWORD *)(DeviceExtension + 24) = v9;
    ...
    else if ( _bittest64((const signed __int64 *)(DeviceExtension + 1000), 0x28u) )
    {
...
LABEL_29:
        ...
        AcpiEvaluateBiosMethodsOnPciRootBus(DeviceExtension, v19, v20);
