/*
 * XREFs of ACPIBuildProcessDevicePhaseCls @ 0x1C00153C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDevicePhaseCls(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = *(_QWORD *)(a1 + 40);
  v6 = AMLIGetNamedChild(*(_QWORD *)(v4 + 720), 1397506911LL, a3, a4);
  *(_DWORD *)(a1 + 32) = 13;
  if ( !v6 || (*(_BYTE *)(v4 + 960) & 4) != 0 )
  {
    v7 = ACPIGet(
           (__int64 *)v4,
           1096045407,
  ...
  else
  {
    ...
    _InterlockedOr64((volatile signed __int64 *)(v4 + 960), 4uLL);
    v7 = ACPIGet((__int64 *)v4, 1397506911, 537165824, 0LL, 0, (__int64)ACPIBuildCompleteMustSucceed, a1, v4 + 600, 0LL);
    *(_DWORD *)(a1 + 32) = 12;
  }
  v8 = v7;
  if ( v7 == 259 )
