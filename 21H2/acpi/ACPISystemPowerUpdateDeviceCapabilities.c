/*
 * XREFs of ACPISystemPowerUpdateDeviceCapabilities @ 0x1C0019C4C
 * Callers:
 ...
 *     ACPISystemPowerDetermineSupportedSystemState @ 0x1C005F2FC (ACPISystemPowerDetermineSupportedSystemState.c)
