/*
 * XREFs of ACPIIoctlGetDeviceSpecificData @ 0x1C002C6AC
 * Callers:
...
__int64 __fastcall ACPIIoctlGetDeviceSpecificData(ULONG_PTR a1, IRP *a2, __int64 a3)
{
  ...
  v9 = *(_QWORD **)(DeviceExtension + 720);
  if ( !v9 )
  {
    v10 = -1073741810;
    goto LABEL_10;
  }
  v10 = AMLIGetNameSpaceObject("_DSD", *(__int64 **)(DeviceExtension + 720), (unsigned __int64 *)&v21, 1);
  if ( v10 >= 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      v10 = AMLIEvalNameSpaceObject(v21, (__int64)PoolWithTag, 0, 0LL);
      if ( v10 < 0 )
        goto LABEL_6;
      if ( *(_WORD *)(v6 + 2) != 4 )
        goto LABEL_29;
...
LABEL_6:
  if ( v21 )
    AMLIDereferenceHandleEx((__int64)v21);
  if ( v6 )
