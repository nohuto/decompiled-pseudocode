/*
 * XREFs of ACPISystemPowerDetermineSupportedDeviceStates @ 0x1C001AAF0
 * Callers:
...
__int64 __fastcall ACPISystemPowerDetermineSupportedDeviceStates(__int64 a1, unsigned int a2, _DWORD *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( (_DWORD)v34 == 1 )
    {
      if ( *(_DWORD *)(*((_QWORD *)&v32 + 1) + 692LL) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v32 + 1) + 692LL));
    ...
    if ( SxD < 0 )
    {
      if ( SxD == -1073741772 )
      {
        ...
        do
        {
          ...
          if ( v11 != 4 )
          {
            for ( i = (__int64 *)v7[v11 + 46]; i; i = (__int64 *)*i )
            {
              if ( *((_DWORD *)i + 4) < v12 )
                v12 = *((_DWORD *)i + 4);
            }
    ...
    *a3 |= 1 << v36;
    ...
    {
LABEL_22:
      started = ACPIExtListEnumNext(v30);
    }
    else
    {
