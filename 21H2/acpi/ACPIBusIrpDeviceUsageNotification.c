/*
 * XREFs of ACPIBusIrpDeviceUsageNotification @ 0x1C00A0740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBusIrpDeviceUsageNotification(PDEVICE_OBJECT PhysicalDeviceObject, PIRP Irp)
{
  ...
  {
    if ( !CurrentStackLocation->Parameters.SetLock.Lock && (*(_DWORD *)(DeviceExtension + 1000) & 0x40000) != 0 )
    {
      v4 = -1073741811;
      goto LABEL_14;
    }
  ...
  if ( CurrentStackLocation->Parameters.Create.Options == 5 )
  {
    *(_QWORD *)(v8 + 1000) = *(_QWORD *)(v8 + 1000) & 0xFFFFFFFFFFFBFFFFuLL | (CurrentStackLocation->Parameters.SetLock.Lock != 0
                                                                             ? 0x40000
                                                                             : 0);
  }
  else if ( Lock )
