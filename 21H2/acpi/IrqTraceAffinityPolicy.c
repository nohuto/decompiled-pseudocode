/*
 * XREFs of IrqTraceAffinityPolicy @ 0x1C009CEC0
 * Callers:
 ...
 *     IrqpAllocateInstancePath @ 0x1C009D04C (IrqpAllocateInstancePath.c)
 */
...
void __fastcall IrqTraceAffinityPolicy(PDEVICE_OBJECT Pdo, unsigned __int16 a2, __int16 a3, __int64 a4)
{
  ...
  v14[0] = 0LL;
  v6 = a2;
  if ( dword_1C007E130 && tlgKeywordOn((__int64)&dword_1C007E130) )
  {
    if ( (_WORD)v6 == 4 )
    ...
    if ( (unsigned int)dword_1C007E130 > 5 && tlgKeywordOn((__int64)&dword_1C007E130) )
    {
      v18 = 0;
      v20[1] = 0;
      v23 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C007E130,
        (unsigned __int8 *)dword_1C0071FDA,
        4LL,
        v10,
        8u,
        &v15);
