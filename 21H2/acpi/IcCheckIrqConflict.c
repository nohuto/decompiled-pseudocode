/*
 * XREFs of IcCheckIrqConflict @ 0x1C0096050
 * Callers:
 *     ProcessorpFindAffinitizedIdtEntries @ 0x1C0093160 (ProcessorpFindAffinitizedIdtEntries.c)
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x1C001D78C (WPP_RECORDER_SF_.c)
 *     IcIsActiveBothPrimaryInterrupt @ 0x1C00B7674 (IcIsActiveBothPrimaryInterrupt.c)
 */
...
LABEL_38:
          WPP_RECORDER_SF_(
            ...
            0x14u,
            v25,
            (__int64)&WPP_ec78af13b68e37cf6b2ef574fd633333_Traceguids);
        }
LABEL_17:
        *a4 = 0;
        return 0LL;
