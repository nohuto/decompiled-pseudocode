/*
 * XREFs of ACPIWakeEmulationPrepare @ 0x1C00B59B4
 * Callers:
 *     ACPIDeviceInitializePowerRequest @ 0x1C0008B20 (ACPIDeviceInitializePowerRequest.c)
 * Callees:
 *     ACPICreateWakeInterruptRegistrationEntries @ 0x1C00B5908 (ACPICreateWakeInterruptRegistrationEntries.c)
 */
