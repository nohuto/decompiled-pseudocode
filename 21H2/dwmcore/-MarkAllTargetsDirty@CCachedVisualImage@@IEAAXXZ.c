/*
 * XREFs of ?MarkAllTargetsDirty@CCachedVisualImage@@IEAAXXZ @ 0x1800D3DB8
 * Callers:
 ...
 *     ?OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800D3D80 (-OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
