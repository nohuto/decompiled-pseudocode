/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x18019F290
 * Callers:
 *     ??_ECParticleScalarBehavior@@WHA@EAAPEAXI@Z @ 0x1801054F0 (--_ECParticleScalarBehavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
