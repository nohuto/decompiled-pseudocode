/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x18016D7A0
 * Callers:
 *     ??_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z @ 0x1800F4990 (--_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
