/*
 * XREFs of ?ExtractContainerKernelInputLatencyArray@CLatencyInfo@CTelemetryTouchLatencyAnalysis@@SAJQEBV12@_KQEAI1@Z @ 0x18015D5C0
 * Callers:
...
__int64 __fastcall CTelemetryTouchLatencyAnalysis::CLatencyInfo::ExtractContainerKernelInputLatencyArray(
