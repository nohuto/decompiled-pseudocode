/*
 * XREFs of ?ProcessSetNodesInfo@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETNODESINFO@@@Z @ 0x1800469D4
 * Callers:
        ...
        const struct tagMILCMD_EXPRESSION_SETNODESINFO *a3)
{
  ...
  Resource = CResourceTable::GetResource(a2, v7, 168LL);
  if ( !Resource )
  {
    v20 = 216;
LABEL_28:
  ...
  v9 = CResourceTable::GetResource(a2, *((unsigned int *)a3 + 5), 168LL);
...
LABEL_29:
  ...
  v12 = 0;
LABEL_16:
  if ( (*(_DWORD *)(*((_QWORD *)v6 + 41) + 4LL) & 0x20000000) != 0
    && (unsigned int)dword_1803D0EF0 > 4
    && (unsigned __int8)tlgKeywordOn(&dword_1803D0EF0, 1LL) )
  {
    v21 = v12;
