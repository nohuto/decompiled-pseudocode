/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x18016D870
 * Callers:
 *     ??_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z @ 0x1800F49A0 (--_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
