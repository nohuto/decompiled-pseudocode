/*
 * XREFs of ?OnPropertyValueChanged@CEffectBrush@@EEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180048EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEffectBrush::OnPropertyValueChanged(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( CEffectBrush::HasValidTemplate((CEffectBrush *)(a1 - 80)) )
  {
    ...
    if ( a2 < (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v10 + 16LL))(v10) )
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x31Fu, 0LL);
        return v13;
      }
      v14 = 1;
  ...
  {
    v13 = -2147483634;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147483634, 0x310u, 0LL);
  }
  return v13;
}
