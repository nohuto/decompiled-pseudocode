/*
 * XREFs of ?RenderLayer@CGammaBlendLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x1801DCCB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGammaBlendLayer::RenderLayer(CGammaBlendLayer *this, struct CDrawingContext *a2)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, v9, 0x63u);
  }
  else
  {
    ...
    v11 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, v12, 0x6Bu);
  }
