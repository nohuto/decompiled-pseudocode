/*
 * XREFs of ?CalculateValueWorker@CScrollKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18020ECF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v8 = CKeyframeAnimation::CalculateValueWorker((LARGE_INTEGER *)this, a2, a3, a4);
  if ( v8 < 0 )
  {
    v9 = 80LL;
    goto LABEL_3;
