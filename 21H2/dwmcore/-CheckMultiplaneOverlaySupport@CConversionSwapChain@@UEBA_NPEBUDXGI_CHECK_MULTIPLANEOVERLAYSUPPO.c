/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@UEBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x18024E530
 * Callers:
 *     ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x1800F7C30 (-CheckMultiplaneOverlaySupport@CConversionSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANE.c)
 * Callees:
 *     ??8@YA_NAEBU_LUID@@0@Z @ 0x18004F9EC (--8@YA_NAEBU_LUID@@0@Z.c)
