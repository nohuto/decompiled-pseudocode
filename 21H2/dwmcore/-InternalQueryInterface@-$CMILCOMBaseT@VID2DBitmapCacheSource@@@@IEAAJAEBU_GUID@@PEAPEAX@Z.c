/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VID2DBitmapCacheSource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A9194
 * Callers:
 *     ?QueryInterface@CColorKeyBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A9550 (-QueryInterface@CColorKeyBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ID2DBitmapCacheSource>::InternalQueryInterface(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD *))(*a1 + 64LL))(a1);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
