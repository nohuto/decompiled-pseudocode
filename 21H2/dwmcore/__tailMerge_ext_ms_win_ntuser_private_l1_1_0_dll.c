/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_1_0_dll @ 0x180102299
 * Callers:
 *     __imp_load_UpdateWindowInputSinkHints @ 0x18010228D (__imp_load_UpdateWindowInputSinkHints.c)
 * Callees:
