/*
 * XREFs of ?PreRender@CRemoteRenderTarget@@UEAAJXZ @ 0x1800E5764
 * Callers:
 *     ?PreRender@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F5220 (-PreRender@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
