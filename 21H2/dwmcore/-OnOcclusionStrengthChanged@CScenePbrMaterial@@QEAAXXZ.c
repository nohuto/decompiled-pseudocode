/*
 * XREFs of ?OnOcclusionStrengthChanged@CScenePbrMaterial@@QEAAXXZ @ 0x18023DD1C
 * Callers:
 *     ?SetOcclusionStrength@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z @ 0x1801A39C0 (-SetOcclusionStrength@-$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJ.c)
