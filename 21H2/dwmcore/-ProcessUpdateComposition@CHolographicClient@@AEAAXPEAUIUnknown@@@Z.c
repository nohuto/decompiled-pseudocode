/*
 * XREFs of ?ProcessUpdateComposition@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x18029EDF8
 * Callers:
...
void __fastcall CHolographicClient::ProcessUpdateComposition(CHolographicClient *this, struct IUnknown *a2)
{
  ...
  if ( ((__int64 (__fastcall *)(struct IUnknown *, GUID *, __int64 *))a2->lpVtbl->QueryInterface)(
         ...
         &v3) >= 0 )
  {
    (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 3) + 184LL))(*((_QWORD *)this + 3), v3);
