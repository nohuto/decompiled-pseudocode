/*
 * XREFs of ??_ECHolographicFrameProcessor@@MEAAPEAXI@Z @ 0x18025C828
 * Callers:
 *     ??_ECHolographicFrameProcessor@@O7EAAPEAXI@Z @ 0x1800F8590 (--_ECHolographicFrameProcessor@@O7EAAPEAXI@Z.c)
 * Callees:
