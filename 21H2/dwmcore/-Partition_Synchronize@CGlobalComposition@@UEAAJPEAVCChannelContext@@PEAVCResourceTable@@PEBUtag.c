/*
 * XREFs of ?Partition_Synchronize@CGlobalComposition@@UEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_SYNCHRONIZE@@@Z @ 0x1801D76C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_PARTITION_SYNCHRONIZE *a4)
{
  ...
  if ( v6 )
  {
    ...
    *((_BYTE *)v8 + 48) = 0;
    if ( *((_BYTE *)a4 + 16) )
      (*(void (__fastcall **)(struct CGlobalSurfaceManager *, CResponseItem *))(*(_QWORD *)this[82] + 136LL))(
        this[82],
        v8);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, -2147024882, 0xA3u);
