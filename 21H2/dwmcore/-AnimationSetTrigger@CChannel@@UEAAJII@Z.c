/*
 * XREFs of ?AnimationSetTrigger@CChannel@@UEAAJII@Z @ 0x1801A9BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::AnimationSetTrigger(CDataStreamWriter **this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a3, 92);
  v8[0] = 7;
  v8[1] = a2;
  v8[2] = a3;
