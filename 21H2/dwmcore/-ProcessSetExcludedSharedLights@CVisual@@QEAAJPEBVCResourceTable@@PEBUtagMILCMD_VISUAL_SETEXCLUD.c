/*
 * XREFs of ?ProcessSetExcludedSharedLights@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETEXCLUDEDSHAREDLIGHTS@@PEBXI@Z @ 0x1801F7C84
 * Callers:
...
LABEL_6:
    v12 = v10;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, v12, v14);
  }
  return v11;
}
