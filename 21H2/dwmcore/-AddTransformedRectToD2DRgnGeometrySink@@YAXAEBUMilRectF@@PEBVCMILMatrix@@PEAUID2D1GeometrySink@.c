/*
 * XREFs of ?AddTransformedRectToD2DRgnGeometrySink@@YAXAEBUMilRectF@@PEBVCMILMatrix@@PEAUID2D1GeometrySink@@@Z @ 0x18026A988
 * Callers:
        ...
        struct ID2D1GeometrySink *a3)
{
  ...
  if ( a2 )
  {
    CMILMatrix::Transform(a2, (const struct MilPoint2F *)v12, (struct MilPoint2F *)v13);
    v3 = (__m128)v13[0];
    v5 = (__m128)v13[1];
    v6 = (__m128)v13[2];
    v8 = (__m128)v13[3];
