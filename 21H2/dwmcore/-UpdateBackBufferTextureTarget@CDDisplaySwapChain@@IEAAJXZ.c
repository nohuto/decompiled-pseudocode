/*
 * XREFs of ?UpdateBackBufferTextureTarget@CDDisplaySwapChain@@IEAAJXZ @ 0x18023AE60
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::UpdateBackBufferTextureTarget(CDDisplaySwapChain *this)
{
  ...
  v1 = (unsigned __int64 *)((char *)this + 224);
  v3 = *((_QWORD *)this + 28);
  if ( v3 )
  {
  ...
  if ( v7 )
  {
    ...
    *v1 = 0LL;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802F0D88, 2u, DeviceTextureTarget, 0x96u, 0LL);
    }
    else
    {
  ...
  {
    v12 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802F0D88, 2u, -2003304307, 0x9Cu, 0LL);
  }
  return v12;
}
