/*
 * XREFs of ??0CCompositionGlyphRun@@QEAA@PEAVCComposition@@@Z @ 0x18016A4D0
 * Callers:
 ...
 * Callees:
 *     ??0CTextObject@@QEAA@PEAVCComposition@@@Z @ 0x18016B520 (--0CTextObject@@QEAA@PEAVCComposition@@@Z.c)
 */
