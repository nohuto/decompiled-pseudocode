/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801B0E8C
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(gsl::details *a1, __int64 a2)
{
  ...
  v2 = (__m128)_mm_loadu_si128(&xmmword_180377B18[g_DirtyRegionColor]);
  ...
  *((_QWORD *)&v8 + 1) = a2;
  ...
  v4 = CDrawingContext::FillRectanglesWithSolidColor(a1, (__int64)&v8, (__int64)&v9);
  v6 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, v4, 0x184Fu);
  return v6;
}
