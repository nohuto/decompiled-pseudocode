/*
 * XREFs of ?ProcessUpdate@CShadowEffect@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SHADOWEFFECT@@@Z @ 0x180206C64
 * Callers:
        ...
        const struct tagMILCMD_SHADOWEFFECT *a3)
{
  ...
  *(_OWORD *)((char *)this + 164) = *(_OWORD *)((char *)a3 + 12);
  *((_DWORD *)this + 45) = *((_DWORD *)a3 + 7);
