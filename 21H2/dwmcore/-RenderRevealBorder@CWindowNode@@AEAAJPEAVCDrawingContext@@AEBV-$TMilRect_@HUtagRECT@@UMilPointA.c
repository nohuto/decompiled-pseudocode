/*
 * XREFs of ?RenderRevealBorder@CWindowNode@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEBVCShape@@@Z @ 0x1800F10AC
 * Callers:
...
__int64 __fastcall CWindowNode::RenderRevealBorder(__int64 a1, CDrawingContext *a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a1 + 680) - v6 > a3[2] - *a3 || *(_DWORD *)(a1 + 684) - *(_DWORD *)(a1 + 676) > a3[3] - a3[1] )
  {
    ...
    *(_QWORD *)&v30.r = &v26;
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v7, 0x62Fu, 0LL);
    }
    else if ( a4 )
    {
      v27 = 0LL;
      ...
      *(_QWORD *)&v30.r = &v27;
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v7, 0x638u, 0LL);
      }
      else
      {
        ...
        v7 = v20;
        if ( v20 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x63Bu, 0LL);
      }
    ...
    else
    {
      ...
      v7 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x640u, 0LL);
    }
