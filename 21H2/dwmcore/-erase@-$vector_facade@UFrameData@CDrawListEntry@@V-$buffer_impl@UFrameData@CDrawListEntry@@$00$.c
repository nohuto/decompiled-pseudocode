/*
 * XREFs of ?erase@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA?AV?$basic_iterator@UFrameData@CDrawListEntry@@@2@V?$basic_iterator@$$CBUFrameData@CDrawListEntry@@@2@@Z @ 0x1801A29F0
 * Callers:
 ...
 *     ?OnEmitGeometryComplete@CDrawListEntry@@UEBAXXZ @ 0x1801A25A0 (-OnEmitGeometryComplete@CDrawListEntry@@UEBAXXZ.c)
