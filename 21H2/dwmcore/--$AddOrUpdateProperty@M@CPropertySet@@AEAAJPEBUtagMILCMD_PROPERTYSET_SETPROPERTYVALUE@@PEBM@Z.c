/*
 * XREFs of ??$AddOrUpdateProperty@M@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBM@Z @ 0x1800A1070
 * Callers:
...
LABEL_11:
    ...
    updated = CPropertySet::UpdateProperty<float>(v10, v7, *(unsigned int *)(v9 + 16));
    v5 = updated;
    if ( updated < 0 )
    {
      v12 = 339;
