/*
 * XREFs of ?SendMetaData@CRemoteAppRenderTarget@@IEBAJAEBU_DWMIndirectMetaData@@@Z @ 0x1801C37A0
 * Callers:
        ...
        const struct _DWMIndirectMetaData *a2)
{
  ...
  if ( v15 )
  {
    v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v15 + 152LL))(v15);
    ...
    if ( v14 )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0x2DEu);
      }
      else
      {
        ...
        v9 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0x2E0u);
      }
    ...
    {
      v9 = -2003304307;
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, -2003304307, 0x2E4u);
    }
  ...
  {
    v9 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0LL, -2003304442, 0x2E9u);
  }
