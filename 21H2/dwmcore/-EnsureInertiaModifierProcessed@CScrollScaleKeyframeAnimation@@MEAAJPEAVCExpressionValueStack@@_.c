/*
 * XREFs of ?EnsureInertiaModifierProcessed@CScrollScaleKeyframeAnimation@@MEAAJPEAVCExpressionValueStack@@_K@Z @ 0x180204FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    {
      if ( v21 == 18 )
        *((_DWORD *)this + 182) = v19[0] ^ _xmm;
    }
    else if ( !v26 )
    {
LABEL_30:
      v18 = v24;
      *(_QWORD *)(*((_QWORD *)this + 69) + 140LL) = *((_QWORD *)this + 91);
      if ( v18 )
