/*
 * XREFs of ?ResetCachedInteractionOutput@CInteractionContextWrapper@@AEAAX_N@Z @ 0x1800B61F8
 * Callers:
 ...
 *     ?ResetOutput@CInteractionContextWrapper@@UEAAXXZ @ 0x180231470 (-ResetOutput@CInteractionContextWrapper@@UEAAXXZ.c)
 * Callees:
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1800B6228 (_anonymous_namespace_--ResetInteractionOutput.c)
 */
