/*
 * XREFs of ?InteractionSetProcessId@CChannel@@UEAAJII@Z @ 0x1800F0EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::InteractionSetProcessId(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
