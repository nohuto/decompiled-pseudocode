/*
 * XREFs of ?ReportInertiaStart@CInteraction@@QEAAJW4InputType@@MM@Z @ 0x1801C6DA4
 * Callers:
 ...
 *     _anonymous_namespace_::InputTypeToInertiaSourceType @ 0x1801C66E8 (_anonymous_namespace_--InputTypeToInertiaSourceType.c)
 */
