/*
 * XREFs of ?ConfigureInteractionContextIfNecessary@?$CInputTypeContext@UDwmPenInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@@QEAAJAEBUInteractionStateInfo@@PEAUTemporaryConfiguration@@@Z @ 0x18022C964
 * Callers:
        ...
        && (qword_180344F08 & 2) == qword_180344F08 )
      {
        ...
        *(_QWORD *)&v29 = a1;
        ...
        tlgWriteTransfer_EventWriteTransfer(
          ...
          (unsigned __int8 *)dword_1802EB7FF,
          0LL,
          0LL,
          3u,
          &v31);
