  ...
  while ( v10 != v4 )
  {
    ...
    else
    {
      ...
      if ( (_BYTE)result )
      {
        ...
        while ( (unsigned __int8)std::_Uhash_compare<EffectDescriptionKey,std::hash<EffectDescriptionKey>,std::equal_to<EffectDescriptionKey>>::operator()<EffectDescriptionKey,EffectDescriptionKey>(
                                   v8,
                                   v10 + 2,
                                   *v15 + 2) );
        v19 = (_QWORD *)*v14;
