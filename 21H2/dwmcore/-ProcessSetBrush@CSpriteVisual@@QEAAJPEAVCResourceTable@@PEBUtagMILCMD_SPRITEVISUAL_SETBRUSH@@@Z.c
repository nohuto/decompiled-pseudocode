/*
 * XREFs of ?ProcessSetBrush@CSpriteVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SPRITEVISUAL_SETBRUSH@@@Z @ 0x180044710
 * Callers:
        ...
        const struct tagMILCMD_SPRITEVISUAL_SETBRUSH *a3)
{
  ...
  if ( (_DWORD)v5 && (Resource = (struct CContent *)CResourceTable::GetResource(a2, v5, 15LL)) == 0LL )
  {
    v10 = -2003303421;
