/*
 * XREFs of ?EnsureRenderTargets@CVisualCapture@@MEAAJXZ @ 0x1801F1D90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1803053D0, 3u, v8, 0x43u, 0LL);
    }
    else
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1803053D0, 3u, v18, 0x4Au, 0LL);
      }
      else
      {
        v20 = v30;
...
LABEL_11:
          if ( v2 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_1803053D0, 3u, v2, 0x4Fu, 0LL);
          goto LABEL_15;
        }
