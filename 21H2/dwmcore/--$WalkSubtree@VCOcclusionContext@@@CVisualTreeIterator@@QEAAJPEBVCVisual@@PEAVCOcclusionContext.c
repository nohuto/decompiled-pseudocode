/*
 * XREFs of ??$WalkSubtree@VCOcclusionContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@PEAVCOcclusionContext@@W4WalkReason@@@Z @ 0x180082380
 * Callers:
...
LABEL_88:
    ...
    v10 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, -2147024882, 0x135Bu, 0LL);
LABEL_10:
    if ( v10 < 0 )
      break;
LABEL_11:
