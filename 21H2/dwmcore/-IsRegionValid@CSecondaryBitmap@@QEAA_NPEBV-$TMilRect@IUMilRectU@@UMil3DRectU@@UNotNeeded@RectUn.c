/*
 * XREFs of ?IsRegionValid@CSecondaryBitmap@@QEAA_NPEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18006CF68
 * Callers:
...
char __fastcall CSecondaryBitmap::IsRegionValid(_DWORD *a1, int *a2, __int64 a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      v12 = FastRegion::CRegion::Intersect((FastRegion::CRegion *)&v14, (const struct CRegion *)v9);
      if ( v12 < 0 )
