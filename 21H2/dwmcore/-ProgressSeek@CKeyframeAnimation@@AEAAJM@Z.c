/*
 * XREFs of ?ProgressSeek@CKeyframeAnimation@@AEAAJM@Z @ 0x1801D1B5C
 * Callers:
  ...
  else
  {
    ...
    if ( (v3 & 1) != 0 && (v3 & 2) == 0 )
    {
      *((_DWORD *)this + 127) = 0;
      ...
      if ( *(_DWORD *)(v7 + 504) == 1 && (v13 = *(_DWORD *)(v7 + 456)) != 0 )
      {
        ...
        {
          *(_BYTE *)(v7 + 548) &= ~0x40u;
          *(_BYTE *)(v7 + 548) |= *(_DWORD *)(v7 + 460) < v13 ? 0 : 0x40;
          *(_DWORD *)(v7 + 460) = (int)v15;
          KeyframeSequence::ConfigureTimer(v14);
          *(_DWORD *)(v16 + 92) = 0;
        }
      }
