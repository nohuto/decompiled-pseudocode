        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_180344E48 > 5 && (qword_180344E58 & 8) != 0 && (qword_180344E60 & 8) == qword_180344E60 )
  {
    ...
    v16 = 8LL;
    v14 = 4LL;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_180344E48, (int)&dword_1802E47EC, 0, 0, 5u, &v12);
  }
