/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@PEAVCCursorVisual@@V?$allocator@PEAVCCursorVisual@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801D7248
 * Callers:
 *     ?UnregisterCursorVisual@CGlobalComposition@@UEAAXPEAVCCursorVisual@@@Z @ 0x1801D7850 (-UnregisterCursorVisual@CGlobalComposition@@UEAAXPEAVCCursorVisual@@@Z.c)
 * Callees:
