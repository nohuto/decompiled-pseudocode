/*
 * XREFs of ?StartInteraction@CInteractionProcessor@@QEAAJ_N0PEAUIManipulationResource@@W4InputType@@@Z @ 0x18018EE80
 * Callers:
 *     ?StartInteraction@CInteractionRoot@@UEAAJ_N0W4InputType@@@Z @ 0x180185220 (-StartInteraction@CInteractionRoot@@UEAAJ_N0W4InputType@@@Z.c)
 ...
 *     ?StartInteraction@CInteraction@@UEAAJ_N0W4InputType@@@Z @ 0x1801F3110 (-StartInteraction@CInteraction@@UEAAJ_N0W4InputType@@@Z.c)
 * Callees:
 ...
 *     ?StartInteraction@?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@QEAAJ_N00W4RailsState@@@Z @ 0x18018EDBC (-StartInteraction@-$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U-$TMILFlag.c)
