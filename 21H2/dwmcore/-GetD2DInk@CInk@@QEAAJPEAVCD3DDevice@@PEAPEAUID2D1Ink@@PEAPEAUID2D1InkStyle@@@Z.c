/*
 * XREFs of ?GetD2DInk@CInk@@QEAAJPEAVCD3DDevice@@PEAPEAUID2D1Ink@@PEAPEAUID2D1InkStyle@@@Z @ 0x180217B3C
 * Callers:
...
__int64 __fastcall CInk::GetD2DInk(CInk *this, struct CD3DDevice *a2, struct ID2D1Ink **a3, struct ID2D1InkStyle **a4)
{
  ...
  *((_DWORD *)this + 8) = v6 ^ ((unsigned __int8)v6 ^ (unsigned __int8)(v6 + 2)) & 6;
  ...
  {
    v8 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467259, 0x111u);
LABEL_8:
    ReleaseInterface<ID2D1Ink>((__int64 *)a3);
    ReleaseInterface<ID2D1InkStyle>((__int64 *)a4);
    goto LABEL_9;
  }
  ID2D1InkAndInkStyle = CDeviceResourceTable<CD2DInk,CInk>::FindOrCreateResourceNoRef(
  ...
  if ( ID2D1InkAndInkStyle < 0 )
  {
    v12 = 277;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, ID2D1InkAndInkStyle, v12);
    goto LABEL_8;
  }
LABEL_9:
