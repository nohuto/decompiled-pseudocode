/*
 * XREFs of ??$_Resize@U_Value_init_tag@std@@@?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801A5D18
 * Callers:
 ...
 *     ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801A5DD0 (--$_Resize_reallocate@U_Value_init_tag@std@@@-$vector@UComputeScribbleLatencyData@@V-$allocator@.c)
 */
