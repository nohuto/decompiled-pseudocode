/*
 * XREFs of ?ReleaseSwapChain@CLocalAppRenderTarget@@IEAAXXZ @ 0x18018ADCC
 * Callers:
 *     ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018A95C (-EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ.c)
 *     ?NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z @ 0x18018AB70 (-NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
