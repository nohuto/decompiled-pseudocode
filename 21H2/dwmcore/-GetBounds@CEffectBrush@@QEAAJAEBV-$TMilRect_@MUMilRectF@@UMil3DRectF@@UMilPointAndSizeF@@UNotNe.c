/*
 * XREFs of ?GetBounds@CEffectBrush@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@PEAV2@@Z @ 0x18021351C
 * Callers:
  ...
  *a4 = *a2;
  if ( *(_QWORD *)(a1 + 112) )
  {
    ...
    if ( SourceInputBounds < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, SourceInputBounds, 0x283u);
    else
      v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _OWORD *))(**(_QWORD **)(a1 + 112) + 88LL))(
             *(_QWORD *)(a1 + 112),
             ...
             v13,
             a4);
    DynArrayImpl<1>::~DynArrayImpl<1>((void **)&v10);
  }
  return v4;
}
