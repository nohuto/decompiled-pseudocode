/*
 * XREFs of ?StartInertiaWorker@CInteractionTrackerPositionAnimation@@MEAAXM_N@Z @ 0x180205BB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z @ 0x18020F4F4 (-StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z.c)
