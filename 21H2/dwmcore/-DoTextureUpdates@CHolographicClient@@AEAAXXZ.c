/*
 * XREFs of ?DoTextureUpdates@CHolographicClient@@AEAAXXZ @ 0x18029D640
 * Callers:
...
LABEL_12:
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x100000) != 0 )
    McTemplateU0xxxx_EventWriteTransfer(v3 - qword_1803D7D88, &EVTDESC_HOLOGRAPHICCLIENT_TEXTUREUPDATECOUNT);
}
