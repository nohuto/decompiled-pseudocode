/*
 * XREFs of ?Matches@CDDisplayCachedScanout@@QEAA_NIPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@PEAUIDisplaySurface@Core@Display@Devices@Windows@@PEAPEAUIDisplayScanout@4567@@Z @ 0x18028E1DC
 * Callers:
...
{
  const struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *v6; // rbp
