/*
 * XREFs of ?GetTextureMemoryLayoutData@CEffectBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801BFF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEffectBrush::GetTextureMemoryLayoutData(__int64 a1, __int64 a2, char **a3)
{
  ...
  for ( i = 0LL; (unsigned int)v5 < *(_DWORD *)(a1 + 136); v5 = (unsigned int)(v5 + 1) )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x152u, 0LL);
        if ( (_QWORD)v16 )
