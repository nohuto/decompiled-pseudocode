/*
 * XREFs of ?DrawVisual@CDrawingContext@@QEAAJPEAVCVisual@@_N@Z @ 0x18003EBC0
 * Callers:
 *     ?DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z @ 0x180020210 (-DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z.c)
 ...
 *     ?Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800DC73C (-Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 ...
 *     ?Top@?$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z @ 0x180042444 (-Top@-$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z.c)
...
__int64 __fastcall CDrawingContext::DrawVisual(CDrawingContext *this, struct CVisual *a2, char a3)
{
  ...
  if ( VisualTree < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, VisualTree, 0xACEu, 0LL);
LABEL_17:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xAD0u, 0LL);
    goto LABEL_32;
  }
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xAD2u, 0LL);
LABEL_32:
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v31);
    return v5;
  }
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0xB06u, 0LL);
    COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v31);
    v6 = v32;
  }
  else
  {
    ...
    if ( v20 >= 0 )
    {
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0xB0Eu, 0LL);
      }
      else
      {
        ...
        *((_DWORD *)v6 + 72) = *((_DWORD *)this + 72);
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xB1Cu, 0LL);
        }
        else
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xB22u, 0LL);
        }
      }
      COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
      wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v31);
LABEL_18:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0xB0Au, 0LL);
    COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v31);
  }
LABEL_19:
