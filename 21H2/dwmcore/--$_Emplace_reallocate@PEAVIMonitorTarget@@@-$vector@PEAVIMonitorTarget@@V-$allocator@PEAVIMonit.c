/*
 * XREFs of ??$_Emplace_reallocate@PEAVIMonitorTarget@@@?$vector@PEAVIMonitorTarget@@V?$allocator@PEAVIMonitorTarget@@@std@@@std@@QEAAPEAPEAVIMonitorTarget@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x1801F5D10
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVIMonitorTarget@@V?$allocator@PEAVIMonitorTarget@@@std@@@std@@AEAAXQEAPEAVIMonitorTarget@@_K1@Z @ 0x1801F6274 (-_Change_array@-$vector@PEAVIMonitorTarget@@V-$allocator@PEAVIMonitorTarget@@@std@@@std@@AEAAXQE.c)
 */
