/*
 * XREFs of ?PushIntoSink@CPathData@@AEBAJPEAUID2D1GeometrySink@@@Z @ 0x1800CA8AC
 * Callers:
  ...
  while ( v2 != v4 )
  {
    ...
    if ( *v2 )
    {
      switch ( *v2 )
      {
        ...
        default:
          v5 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast((unsigned int)*v2 - 4, 0LL, 0LL, -2147024809, 0x1CCu);
          return v5;
      }
    }
    else
