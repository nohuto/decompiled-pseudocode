/*
 * XREFs of ??$_Emplace_reallocate@AEA_K@?$vector@_KV?$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z @ 0x1801BD7C0
 * Callers:
 ...
 *     ?_Change_array@?$vector@_KV?$allocator@_K@std@@@std@@AEAAXQEA_K_K1@Z @ 0x1801BE7B8 (-_Change_array@-$vector@_KV-$allocator@_K@std@@@std@@AEAAXQEA_K_K1@Z.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<unsigned __int64>::_Change_array(a1, v13, v9, v3);
  return v14;
}
