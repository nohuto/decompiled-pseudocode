/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x18016D650
 * Callers:
 *     ??_ECParticleColorBehavior@@WGI@EAAPEAXI@Z @ 0x1800F4980 (--_ECParticleColorBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
