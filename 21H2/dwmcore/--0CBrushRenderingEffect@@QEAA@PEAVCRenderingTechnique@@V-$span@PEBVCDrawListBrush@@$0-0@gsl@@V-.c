/*
 * XREFs of ??0CBrushRenderingEffect@@QEAA@PEAVCRenderingTechnique@@V?$span@PEBVCDrawListBrush@@$0?0@gsl@@V?$span@_N$0?0@3@@Z @ 0x18004F57C
 * Callers:
 ...
 *     ??0CDrawListBitmap@@QEAA@XZ @ 0x180057DC0 (--0CDrawListBitmap@@QEAA@XZ.c)
 *     ??0SamplerMode@@QEAA@XZ @ 0x1800E27C0 (--0SamplerMode@@QEAA@XZ.c)
