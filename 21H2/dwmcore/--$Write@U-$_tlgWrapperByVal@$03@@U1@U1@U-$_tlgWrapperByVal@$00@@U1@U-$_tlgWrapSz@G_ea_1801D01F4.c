/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U1@U?$_tlgWrapSz@G@@U3@U2@U?$_tlgWrapperByRef@$0BA@@@U2@U2@U2@U2@U?$_tlgWrapperByVal@$07@@U2@U?$_tlgWrapperByVal@$01@@U6@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U1@U1@U6@U1@U2@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@3AEBU?$_tlgWrapSz@G@@54AEBU?$_tlgWrapperByRef@$0BA@@@4444AEBU?$_tlgWrapperByVal@$07@@4AEBU?$_tlgWrapperByVal@$01@@8777777777777777777777777338343@Z @ 0x1801D01F4
 * Callers:
        ...
        __int64 a51)
{
  ...
  int v57; // r9d
  wchar_t *v58; // rdx
  struct _EVENT_DATA_DESCRIPTOR v60; // [rsp+30h] [rbp-D0h] BYREF
  ...
  wchar_t *v71; // [rsp+A0h] [rbp-60h]
  int v72; // [rsp+A8h] [rbp-58h]
  int v73; // [rsp+ACh] [rbp-54h]
  wchar_t *v74; // [rsp+B0h] [rbp-50h]
  ...
  __int64 v149; // [rsp+300h] [rbp+200h]
  __int64 v150; // [rsp+308h] [rbp+208h]
  __int64 v151; // [rsp+310h] [rbp+210h]
  __int64 v152; // [rsp+318h] [rbp+218h]
  __int64 v153; // [rsp+320h] [rbp+220h]
  __int64 v154; // [rsp+328h] [rbp+228h]
  __int64 v155; // [rsp+330h] [rbp+230h]
  __int64 v156; // [rsp+338h] [rbp+238h]
  ...
  v64 = 4LL;
  v62 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1803D0EB8, a2, 0LL, 0LL, 0x31u, &v60);
}
