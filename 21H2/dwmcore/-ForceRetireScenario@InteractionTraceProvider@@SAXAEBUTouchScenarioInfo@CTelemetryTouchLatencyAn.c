/*
 * XREFs of ?ForceRetireScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@@Z @ 0x18015E05C
 * Callers:
        ...
        const struct CTelemetryTouchLatencyAnalysis::TouchScenarioInfo *a1)
{
  ...
  if ( (unsigned int)dword_180344E48 > 5 && (qword_180344E58 & 8) != 0 && (qword_180344E60 & 8) == qword_180344E60 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1802E56F2,
      0LL,
      0LL,
      6u,
      &v5);
