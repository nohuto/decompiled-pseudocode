/*
 * XREFs of ?EnsureTexture@CDxHandleYUVBitmapRealization@@IEAAJXZ @ 0x1802A5538
 * Callers:
...
__int64 __fastcall CDxHandleYUVBitmapRealization::EnsureTexture(CDxHandleYUVBitmapRealization *this)
{
  ...
  if ( !*((_QWORD *)this + 47) )
  {
    ...
    {
      v1 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467259, 0x1F7u);
      return v1;
    }
    v4 = (struct _LUID)*((_QWORD *)this + 32);
    v17 = 0LL;
    Device = CDeviceManager::GetDevice(this, v4, &v17);
    v1 = Device;
    if ( Device < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, Device, 0x1E9u);
      v14 = v17;
      if ( v17 )
        goto LABEL_12;
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, 0x1F1u);
      }
      else
      {
        v10 = *v2;
