/*
 * XREFs of ??0CDDisplayRenderTarget@@IEAA@PEAVCComposition@@@Z @ 0x18016A710
 * Callers:
 ...
 * Callees:
 *     ??0COverlayContext@@QEAA@PEAVIOverlayMonitorTarget@@@Z @ 0x180026210 (--0COverlayContext@@QEAA@PEAVIOverlayMonitorTarget@@@Z.c)
 *     ??0IOverlayMonitorTarget@@QEAA@XZ @ 0x1800263B4 (--0IOverlayMonitorTarget@@QEAA@XZ.c)
