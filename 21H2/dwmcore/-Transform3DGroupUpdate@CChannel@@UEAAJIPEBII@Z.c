/*
 * XREFs of ?Transform3DGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x1801AC7F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  void *v33; // [rsp+70h] [rbp+8h] BYREF

  v30 = (struct _RTL_CRITICAL_SECTION *)(this + 21);
  EnterCriticalSection((LPCRITICAL_SECTION)(this + 21));
  CChannel::CheckHandle((__int64)this, a2, 187);
  ...
  {
    v12 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, -2147024362, 0xAA1u);
    goto LABEL_21;
  }
  Size.m128i_i64[1] = 4 * a4;
  v10 = CChannel::BeginCommand(this, &Size, 0x10u, v9);
  v12 = v10;
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0xAA3u);
    goto LABEL_21;
  }
  v13 = Size.m128i_u32[2];
  if ( Size.m128i_i32[2] )
  {
    v14 = this[20];
    v33 = 0LL;
    v15 = CDataStreamWriter::GetItemDataWritePointer(v14, Size.m128i_u32[2], &v33);
    if ( v15 < 0 )
