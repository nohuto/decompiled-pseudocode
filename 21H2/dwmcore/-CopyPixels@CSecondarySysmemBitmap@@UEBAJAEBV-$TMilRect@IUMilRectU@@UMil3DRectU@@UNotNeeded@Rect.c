/*
 * XREFs of ?CopyPixels@CSecondarySysmemBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x1802A9570
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  {
    v19 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, -2147024809, 0x64u);
  }
  else
  {
    v11 = *(_DWORD *)(v10 + 132);
    ...
    v19 = v17;
    if ( v17 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0LL, v17, 0x74u);
  }
  return v19;
}
