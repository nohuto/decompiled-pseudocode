/*
 * XREFs of ?GetControlPointCount@CPathData@@QEBAIXZ @ 0x180220D84
 * Callers:
 *     ?IsEmpty@CPathSegmentsShape@@UEBA_NXZ @ 0x18025F920 (-IsEmpty@CPathSegmentsShape@@UEBA_NXZ.c)
 * Callees:
 *     ??9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z @ 0x180220828 (--9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z.c)
 *     ??Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ @ 0x180220864 (--Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ.c)
