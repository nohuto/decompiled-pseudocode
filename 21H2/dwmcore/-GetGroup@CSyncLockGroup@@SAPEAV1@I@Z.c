/*
 * XREFs of ?GetGroup@CSyncLockGroup@@SAPEAV1@I@Z @ 0x1801BFBDC
 * Callers:
...
struct CSyncLockGroup *__fastcall CSyncLockGroup::GetGroup(int a1)
{
  ...
  for ( i = CSyncLockGroup::g_syncLockGroups; i != qword_1803D37F8 && *(_DWORD *)(*(_QWORD *)i + 8LL) != a1; i += 8LL )
    ;
  if ( i == qword_1803D37F8 )
  {
    ...
    if ( a1 == -1 )
    {
      ...
      v6 = (CParallelModeGroup **)qword_1803D37F8;
      v9 = v4;
      if ( qword_1803D37F8 == qword_1803D3800 )
      {
        ...
        if ( v9 )
          goto LABEL_19;
        return *(struct CSyncLockGroup **)(qword_1803D37F8 - 8);
      }
    }
    else
    {
