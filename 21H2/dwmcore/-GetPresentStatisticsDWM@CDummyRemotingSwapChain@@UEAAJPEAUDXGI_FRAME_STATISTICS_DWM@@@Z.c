/*
 * XREFs of ?GetPresentStatisticsDWM@CDummyRemotingSwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@@Z @ 0x1802898A0
 * Callers:
        ...
        struct DXGI_FRAME_STATISTICS_DWM *a2)
{
  ...
  for ( i = 0; i < 2; ++i )
  {
    ...
    v5 = (CDummyRemotingSwapChain::CPresentStats *)((char *)v5 + 56);
    v3 += 14;
  }
  v9 = 56LL * v4;
  *(_OWORD *)a2 = *(_OWORD *)((char *)this + v9 + 80);
  *((_OWORD *)a2 + 1) = *(_OWORD *)((char *)this + v9 + 96);
  *((_QWORD *)a2 + 4) = *(_QWORD *)((char *)this + v9 + 112);
