/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x1802632D8
 * Callers:
 *     McGenControlCallbackV2 @ 0x1800166D0 (McGenControlCallbackV2.c)
 * Callees:
 *     ModuleFailFastForHRESULT @ 0x180260218 (ModuleFailFastForHRESULT.c)
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x180263398 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
