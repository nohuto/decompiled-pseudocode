/*
 * XREFs of ??2CLinearGradientLegacyMilBrush@@KAPEAX_K@Z @ 0x18016C2CC
 * Callers:
...
LPVOID __fastcall CLinearGradientLegacyMilBrush::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x110uLL);
  if ( !result )
