/*
 * XREFs of ??2CLegacyVisualCaptureRenderTarget@@CAPEAX_K@Z @ 0x18016C29C
 * Callers:
...
LPVOID __fastcall CLegacyVisualCaptureRenderTarget::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x38uLL);
  if ( !result )
