/*
 * XREFs of ?GetBoundsWithLayerEffect@CLayerVisual@@QEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180005E38
 * Callers:
      ...
      *a2 = *v2;
      if ( *(_QWORD *)(v10 + 104) )
      {
        ...
        if ( SourceInputBounds < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, SourceInputBounds, 0x282u, 0LL);
        else
