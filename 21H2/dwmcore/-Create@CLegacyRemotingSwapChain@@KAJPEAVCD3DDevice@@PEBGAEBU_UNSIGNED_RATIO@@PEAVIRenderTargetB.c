/*
 * XREFs of ?Create@CLegacyRemotingSwapChain@@KAJPEAVCD3DDevice@@PEBGAEBU_UNSIGNED_RATIO@@PEAVIRenderTargetBitmap@@PEAXPEAPEAVILegacyRemotingSwapChain@@@Z @ 0x1800FDBBC
 * Callers:
  ...
  *a6 = 0LL;
  ...
  if ( LibraryA )
  {
      ...
      && (v14 = CLegacyRemotingSwapChain::CLegacyRemotingSwapChain(v12, a1, a3, a4, a5, LibraryA), (v15 = v14) != 0LL) )
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0LL, v17, 0x24u);
    ...
    {
      v19 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147024882, 0x22u);
    }
  }
  else
  {
    v19 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, -2147024809, 0x2Au);
  }
  return v19;
}
