/*
 * XREFs of ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800DB370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x180253544 (-DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z.c)
