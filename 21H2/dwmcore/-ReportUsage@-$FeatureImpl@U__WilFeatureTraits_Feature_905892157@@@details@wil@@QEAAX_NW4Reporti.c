/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_905892157@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180103F20
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_905892157>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 2) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_905892157>::GetCachedFeatureEnabledState(
                      a1,
                      v7);
    v10 = v4;
  }
