/*
 * XREFs of ?Present@CLocalAppRenderTarget@@UEAAJ_N@Z @ 0x18018AD68
 * Callers:
 *     ?Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F5AC0 (-Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
