/*
 * XREFs of ?SetOcclusionInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801A3928
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[17] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0xE06u);
    }
    else
    {
