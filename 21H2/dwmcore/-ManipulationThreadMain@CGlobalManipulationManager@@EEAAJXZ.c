/*
 * XREFs of ?ManipulationThreadMain@CGlobalManipulationManager@@EEAAJXZ @ 0x1800B4DC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsRegisterManipulationThreadPresent @ 0x1800E85DC (IsRegisterManipulationThreadPresent.c)
