/*
 * XREFs of ?BeginNewStatsInstance@CCompositionSwapchainStatistics@@UEAAX_KPEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x18025DCB0
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x180100650 (__security_check_cookie.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1801051D0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??$_Emplace_reallocate@AEBUCompositionFrameInstance@@@?$vector@UCompositionFrameInstance@@V?$allocator@UCompositionFrameInstance@@@std@@@std@@QEAAPEAUCompositionFrameInstance@@QEAU2@AEBU2@@Z @ 0x18025D958 (--$_Emplace_reallocate@AEBUCompositionFrameInstance@@@-$vector@UCompositionFrameInstance@@V-$all.c)
 */
        ...
        const struct tagCOMPOSITION_TARGET_ID *a3)
{
  ...
  if ( (*(unsigned int (__fastcall **)(_QWORD))(**((_QWORD **)this + 2) + 280LL))(*((_QWORD *)this + 2)) > *((_DWORD *)this + 14) )
  {
    *((_QWORD *)this + 6) = a2;
    v6 = *((_QWORD *)this + 4);
    v11 = 0LL;
