/*
 * XREFs of ?Matrix4x4FromRotationZ@CExpressionValueStack@@QEAAJI@Z @ 0x18024DB14
 * Callers:
  ...
  if ( a2 != 1 )
  {
    if ( a2 == 2 )
    {
      ...
      if ( v15[18] == 18 && v12[18] == 52 )
      {
        ...
        v28 = *(_QWORD *)v12;
        v29 = v20;
        D2DMatrixRotationZ(&v30, v19, &v28);
        v21 = v30;
        v22 = v31;
        v15[18] = 265;
        *(_OWORD *)v15 = v21;
...
LABEL_23:
  ...
  if ( v7[18] != 18 )
    goto LABEL_23;
  D2DMatrixRotationZ((struct D2DMatrix *)&v30, *(float *)v7);
  v8 = v31;
  *(_OWORD *)v7 = v30;
  v7[18] = 265;
  v9 = v32;
