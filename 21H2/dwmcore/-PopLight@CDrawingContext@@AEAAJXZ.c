/*
 * XREFs of ?PopLight@CDrawingContext@@AEAAJXZ @ 0x180014344
 * Callers:
...
__int64 __fastcall CDrawingContext::PopLight(CDrawingContext *this)
{
  ...
  CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((char *)this + 336, v6);
  v2 = CLightStack::Pop((CLightStack *)(v1 + 528));
  v4 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, v2, 0x18A4u, 0LL);
  return v4;
}
