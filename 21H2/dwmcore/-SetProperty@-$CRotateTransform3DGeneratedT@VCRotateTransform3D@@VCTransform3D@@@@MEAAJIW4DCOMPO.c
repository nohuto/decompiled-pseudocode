/*
 * XREFs of ?SetProperty@?$CRotateTransform3DGeneratedT@VCRotateTransform3D@@VCTransform3D@@@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A4B40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  v9 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, -2147024809, v12);
  return v9;
}
