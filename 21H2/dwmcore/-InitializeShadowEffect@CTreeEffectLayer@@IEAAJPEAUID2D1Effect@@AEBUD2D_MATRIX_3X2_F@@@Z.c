/*
 * XREFs of ?InitializeShadowEffect@CTreeEffectLayer@@IEAAJPEAUID2D1Effect@@AEBUD2D_MATRIX_3X2_F@@@Z @ 0x180190904
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x4B1u, 0LL);
  }
  else
  {
    v10 = *(_QWORD *)a2;
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x4B4u, 0LL);
    }
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x4B7u, 0LL);
      }
      else
      {
        v15 = *(_QWORD *)a2;
        *(float *)&v18 = FLOAT_0_5;
        ...
        v9 = v16;
        if ( v16 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x4B9u, 0LL);
      }
    }
  }
  return v9;
