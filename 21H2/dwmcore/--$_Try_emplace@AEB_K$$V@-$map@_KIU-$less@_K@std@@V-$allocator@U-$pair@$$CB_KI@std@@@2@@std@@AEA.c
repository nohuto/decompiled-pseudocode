/*
 * XREFs of ??$_Try_emplace@AEB_K$$V@?$map@_KIU?$less@_K@std@@V?$allocator@U?$pair@$$CB_KI@std@@@2@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CB_KI@std@@PEAX@std@@_N@1@AEB_K@Z @ 0x18002FF18
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *(_BYTE *)(v13 + 25) || *v5 < *(_QWORD *)(v13 + 32) )
  {
    ...
    v6 = *a1;
    v14 = v5;
    v7 = std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned __int64 const,unsigned int>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned __int64 const,unsigned int>,void *>>>(
           (unsigned int)&v10,
           (_DWORD)a1,
           v6,
           v4,
