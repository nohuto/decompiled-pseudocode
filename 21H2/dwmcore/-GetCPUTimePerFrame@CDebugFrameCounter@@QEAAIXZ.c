/*
 * XREFs of ?GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ @ 0x1801D79F0
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x1801D7A40 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
