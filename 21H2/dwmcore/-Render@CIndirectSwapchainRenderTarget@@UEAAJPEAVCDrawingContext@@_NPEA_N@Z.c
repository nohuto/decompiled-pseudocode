/*
 * XREFs of ?Render@CIndirectSwapchainRenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1801C7118
 * Callers:
 *     ?Render@CIndirectSwapchainRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x180106970 (-Render@CIndirectSwapchainRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  if ( COffScreenRenderTarget::ReadyForRender((CIndirectSwapchainRenderTarget *)((char *)this - 2016)) )
  {
    ...
    if ( Buffer < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, Buffer, 0xD3u);
    }
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0xDFu);
      }
      else
      {
        *((_BYTE *)this - 86) = 1;
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0xE3u);
      }
    }
    if ( v6 == -2003304307 )
