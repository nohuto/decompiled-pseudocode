/*
 * XREFs of ?Initialize@CTextVisual@@MEAAJXZ @ 0x1801F1220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z @ 0x1801F103C (--0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z.c)
