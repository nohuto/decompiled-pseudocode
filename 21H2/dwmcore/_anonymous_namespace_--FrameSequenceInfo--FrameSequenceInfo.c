/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo @ 0x180077A0C
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 404) = *(_DWORD *)(a2 + 404);
  std::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>(
    a1 + 408,
    a2 + 408);
  std::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>::_Tree<std::_Tset_traits<unsigned __int64,std::less<unsigned __int64>,std::allocator<unsigned __int64>,0>>(
    a1 + 424,
