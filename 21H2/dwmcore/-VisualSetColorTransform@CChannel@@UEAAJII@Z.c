/*
 * XREFs of ?VisualSetColorTransform@CChannel@@UEAAJII@Z @ 0x1801AD0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetColorTransform(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
