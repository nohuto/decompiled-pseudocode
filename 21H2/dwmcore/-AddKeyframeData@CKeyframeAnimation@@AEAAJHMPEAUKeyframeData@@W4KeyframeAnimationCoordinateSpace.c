/*
 * XREFs of ?AddKeyframeData@CKeyframeAnimation@@AEAAJHMPEAUKeyframeData@@W4KeyframeAnimationCoordinateSpace@@@Z @ 0x1800AA898
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = *(_OWORD *)(a4 + 16);
  v73 = 0LL;
  xmmword_180347200 = v8;
  xmmword_180347210 = *(_OWORD *)(a4 + 32);
  v9 = *(_DWORD *)(a4 + 4);
  if ( v9 > 65539 )
  {
    v35 = v9 - 65540;
