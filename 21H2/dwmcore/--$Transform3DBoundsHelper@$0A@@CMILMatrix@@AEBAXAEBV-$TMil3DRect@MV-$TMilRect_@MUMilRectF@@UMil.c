/*
 * XREFs of ??$Transform3DBoundsHelper@$0A@@CMILMatrix@@AEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@AEAV1@@Z @ 0x1800A7320
 * Callers:
 ...
 *     ??$IsTranslate@$00@CMILMatrix@@AEBA_NXZ @ 0x1800226A0 (--$IsTranslate@$00@CMILMatrix@@AEBA_NXZ.c)
