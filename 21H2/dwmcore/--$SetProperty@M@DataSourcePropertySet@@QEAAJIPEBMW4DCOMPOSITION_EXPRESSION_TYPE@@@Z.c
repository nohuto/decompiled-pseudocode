/*
 * XREFs of ??$SetProperty@M@DataSourcePropertySet@@QEAAJIPEBMW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18017F2B4
 * Callers:
 *     ?SetScalarValue@DataSourceProxy@@MEAAJIM@Z @ 0x180180FE0 (-SetScalarValue@DataSourceProxy@@MEAAJIM@Z.c)
 * Callees:
 *     ??$AddProperty@M@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBMPEAI@Z @ 0x1800BD604 (--$AddProperty@M@-$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4D.c)
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<float>(v10, 18, a3, &v26);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v18) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    *(_DWORD *)((*(_DWORD *)(v20 + 8 * v19 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v21 + 32)) = v17;
  }
  return 0LL;
}
