/*
 * XREFs of ?HDRConvert@CD3DDevice@@QEAAJPEAUID3D11ShaderResourceView@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@3PEAUID3D11RenderTargetView@@1W4DXGI_COLOR_SPACE_TYPE@@M_NPEAUtagRECT@@@Z @ 0x18027E784
 * Callers:
        ...
        __int64 a13)
{
  ...
  *(_QWORD *)&v36 = 1LL;
  ...
  CompositingPixelShaderNoRef = CD3DDevice::GetCompositingPixelShaderNoRef((struct CD3DDevice *)this, &v36, a10, &v38);
  v22 = CompositingPixelShaderNoRef;
  if ( CompositingPixelShaderNoRef < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0LL, CompositingPixelShaderNoRef, 0x943u);
  }
  else
  {
    v23 = *a9;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0LL, updated, 0x949u);
    }
    else
    {
      v30 = this[198];
      ...
      *(_QWORD *)&v36 = 1LL;
      ...
      v22 = v31;
      if ( v31 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0LL, v31, 0x956u);
    }
  }
  return v22;
}
