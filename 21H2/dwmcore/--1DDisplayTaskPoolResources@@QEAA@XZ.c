/*
 * XREFs of ??1DDisplayTaskPoolResources@@QEAA@XZ @ 0x1802828E4
 * Callers:
...
void __fastcall DDisplayTaskPoolResources::~DDisplayTaskPoolResources(DDisplayTaskPoolResources *this)
{
  ...
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>((__int64 *)this + 1);
