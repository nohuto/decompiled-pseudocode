/*
 * XREFs of ?TransitionDisconnectedTrackersToIdle@CInteractionTrackerBindingManager@@AEAAXPEAVCInteractionTracker@@0@Z @ 0x1802213C8
 * Callers:
  ...
  *((_WORD *)v9 + 12) = 257;
  ...
  while ( !*((_BYTE *)v11 + 25) )
  {
    ...
    if ( *(_DWORD *)(v12 + 176) == 1 )
    {
      ...
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v12, 1, v14, 1);
      v15 = CInteractionTracker::GetCurrentValue(v12, 2);
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v12, 2, v15, 1);
    }
