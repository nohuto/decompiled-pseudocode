/*
 * XREFs of ??$WalkSubtree@VCHitTestContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@PEAVCHitTestContext@@W4WalkReason@@@Z @ 0x18009DA50
 * Callers:
...
LABEL_125:
    ...
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v75, 0LL, 0, -2147024882, 0x135Bu, 0LL);
LABEL_8:
    if ( v9 < 0 )
      break;
LABEL_9:
