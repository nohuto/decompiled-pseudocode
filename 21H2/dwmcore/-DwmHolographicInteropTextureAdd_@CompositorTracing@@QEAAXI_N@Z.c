/*
 * XREFs of ?DwmHolographicInteropTextureAdd_@CompositorTracing@@QEAAXI_N@Z @ 0x1802533C8
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicInteropTextureAdd_(CompositorTracing *this, int a2, char a3)
{
    ...
    && (*(_QWORD *)(v5 + 24) & 0x400000000000LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v7 = a2;
    v13 = 1;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1802ED8C7, 0LL, 0LL, 4u, &v8);
  }
}
