/*
 * XREFs of ?DestroyResources@CAtlasTexture@@AEAAXXZ @ 0x18024C5B4
 * Callers:
 ...
 *     ?NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z @ 0x18024C910 (-NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
