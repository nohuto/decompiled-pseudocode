/*
 * XREFs of ?HrFindInterface@CTransformedGeometryHelper@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180191A20
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467262, 0xE6u);
  }
  else
  {
    *a3 = this;
