/*
 * XREFs of ?GetEffectiveShadowIntermediates@CDropShadow@@AEBAPEAVShadowIntermediates@1@PEAVCVisual@@@Z @ 0x18000FB10
 * Callers:
        ...
        struct CVisual *a2)
{
  ...
  appended = std::_Fnv1a_append_bytes((unsigned __int64)this, (const unsigned __int8 *const)&v6, 8uLL);
  ...
  if ( v5 != *((_QWORD *)this + 25) )
    return (struct CDropShadow::ShadowIntermediates *)(v5 + 24);
  return result;
}
