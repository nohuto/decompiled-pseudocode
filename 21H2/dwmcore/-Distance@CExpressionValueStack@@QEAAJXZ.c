/*
 * XREFs of ?Distance@CExpressionValueStack@@QEAAJXZ @ 0x1801FC0EC
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Distance(CExpressionValueStack *this)
{
  ...
  if ( (unsigned int)v2 >= 2 )
  {
    ...
    {
      v7 = CExpressionValue::CExpressionValue((CExpressionValue *)v24);
    ...
    {
      case 18:
        v21 = *(float *)v8->m128i_i32 - *(float *)v6->m128i_i32;
        v8[4].m128i_i32[2] = 18;
        LODWORD(v18) = LODWORD(v21) & _xmm;
        goto LABEL_23;
      case 35:
        v19 = *(float *)v8->m128i_i32 - *(float *)v6->m128i_i32;
        v20 = (float)(*(float *)&v8->m128i_i32[1] - *(float *)&v6->m128i_i32[1])
            * (float)(*(float *)&v8->m128i_i32[1] - *(float *)&v6->m128i_i32[1]);
        break;
      case 52:
        v19 = *(float *)&v8->m128i_i32[2] - *(float *)&v6->m128i_i32[2];
        v20 = (float)((float)(COERCE_FLOAT(HIDWORD(v8->m128i_i64[0])) - COERCE_FLOAT(HIDWORD(v6->m128i_i64[0])))
