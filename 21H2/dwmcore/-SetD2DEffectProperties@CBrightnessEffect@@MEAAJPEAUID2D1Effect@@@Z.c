/*
 * XREFs of ?SetD2DEffectProperties@CBrightnessEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180245B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBrightnessEffect::SetD2DEffectProperties(CBrightnessEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x14u);
  }
  else
  {
    v8 = *(_QWORD *)a2;
    v12 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 42), (__m128)*((unsigned int *)this + 43)).m128_u64[0];
