/*
 * XREFs of ?NotifyCaptureManipulation@CManipulationManager@@QEAAJPEAVCInteraction@@I_K@Z @ 0x18017C9F4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v9 )
  {
    ...
    *(_QWORD *)(v11 + 32) = a4;
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0x2E4u);
  ...
  {
    v17 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, -2147024882, 0x2D5u);
  }
  return v17;
}
