/*
 * XREFs of ?CalculateValueWorker@CInjectionAnimation@@MEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180217200
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( v4 )
  {
    ...
    if ( v7 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(CManipulation *, __int64))(*(_QWORD *)v7 + 56LL))(v7, 103LL) )
      {
        *a4 = 1;
        v8 = *((_DWORD *)this + 86);
        v9 = *((_DWORD *)this + 87);
        if ( v8 < v9 )
        {
          ...
          do
          {
            ...
            if ( v13 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0xA0u);
              return v15;
            }
            v8 = *((_DWORD *)this + 86) + 1;
            *((_DWORD *)this + 86) = v8;
