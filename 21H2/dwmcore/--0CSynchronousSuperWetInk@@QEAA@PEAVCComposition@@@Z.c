/*
 * XREFs of ??0CSynchronousSuperWetInk@@QEAA@PEAVCComposition@@@Z @ 0x180240968
 * Callers:
        ...
        struct CComposition *a2)
{
  ...
  *((_QWORD *)this + 40) = &IContent::`vftable'{for `IContent'};
  *(_QWORD *)((char *)this + *(int *)(*((_QWORD *)this + 41) + 4LL) + 328) = &ILegacySwapChain::`vftable'{for `IUnknown'};
  ...
  *(_DWORD *)((char *)this + v3 + 60) = v3 - 240;
  v4 = *(int *)(*((_QWORD *)this + 8) + 8LL);
  *(_DWORD *)((char *)this + v4 + 60) = v4 - 256;
  *((_QWORD *)this + 26) = 0LL;
  *((_QWORD *)this + 27) = 0LL;
  *((_QWORD *)this + 28) = 0LL;
  *((_QWORD *)this + 29) = 0LL;
