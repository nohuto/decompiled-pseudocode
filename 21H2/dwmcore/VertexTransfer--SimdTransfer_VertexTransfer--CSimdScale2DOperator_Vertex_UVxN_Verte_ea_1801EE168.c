/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801EE168
 * Callers:
 ...
 *     ?Transform@?$CSimdScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@T__m128@@2IPEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x1801F096C (-Transform@-$CSimdScale2DOperator@U-$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexT.c)
 */

__int64 __fastcall VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___(
        __int64 a1,
        unsigned __int64 *a2,
        CMILMatrix *a3,
        CMILMatrix *a4)
{
  ...
  if ( a3 && a4 )
  {
    CalculateTBNFrameFrom3Vertices((struct D2DQuaternion *)&v32, v7, (__int64 *)v8, a3, a4);
    v9 = v32;
    v8 = a1 + 8;
  }
  ...
  {
    v14 = *(_QWORD *)v8 + (int)(*(_DWORD *)(v8 + 8) * (v12 + 1));
    ...
    if ( a3 )
    {
      v22 = _mm_movelh_ps((__m128)*(unsigned __int64 *)a3, (__m128)*((unsigned int *)a3 + 2));
      v23 = _mm_movelh_ps((__m128)*((unsigned __int64 *)a3 + 2), (__m128)*((unsigned int *)a3 + 6));
      v24 = _mm_movelh_ps((__m128)*((unsigned __int64 *)a3 + 6), (__m128)*((unsigned int *)a3 + 14));
      v25 = _mm_add_ps(
