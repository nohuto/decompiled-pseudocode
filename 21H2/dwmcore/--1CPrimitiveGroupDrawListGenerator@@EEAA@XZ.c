/*
 * XREFs of ??1CPrimitiveGroupDrawListGenerator@@EEAA@XZ @ 0x18000B76C
 * Callers:
        ...
        unsigned int a2)
{
  ...
  *(_QWORD *)this = &CPrimitiveGroupDrawListGenerator::`vftable';
  ...
  {
    v9 = v6 - 8;
    `vector destructor iterator'(v6, 0x18uLL, *((_QWORD *)v6 - 1), (void (*)(void *))EffectInput::~EffectInput);
    operator delete[](v9);
  }
  ...
  {
    v8 = v7 - 8;
    `vector destructor iterator'(v7, 0x18uLL, *((_QWORD *)v7 - 1), (void (*)(void *))EffectInput::~EffectInput);
    operator delete[](v8);
  }
}
