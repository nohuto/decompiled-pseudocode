/*
 * XREFs of ?_Reallocate_exactly@?$vector@EV?$allocator@E@std@@@std@@AEAAX_K@Z @ 0x1801F05CC
 * Callers:
...
__int64 __fastcall std::vector<unsigned char>::_Reallocate_exactly(__int64 a1, SIZE_T a2)
{
  ...
  return std::vector<unsigned char>::_Change_array((__int64 *)a1, (__int64)v5, v3, a2);
}
