        ...
        __int64 a16)
{
  ...
  const unsigned __int16 *v35; // [rsp+80h] [rbp-80h]
  int v36; // [rsp+88h] [rbp-78h]
  int v37; // [rsp+8Ch] [rbp-74h]
  const unsigned __int16 *v38; // [rsp+90h] [rbp-70h]
  ...
  v29 = v25;
  v30 = 0;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 0xEu, &v27);
}
