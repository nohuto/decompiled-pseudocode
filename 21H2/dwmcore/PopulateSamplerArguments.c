/*
 * XREFs of PopulateSamplerArguments @ 0x1800346EC
 * Callers:
...
__int64 __fastcall PopulateSamplerArguments(__int64 a1, __int64 a2, unsigned int a3, _BYTE *a4, __int64 a5)
{
  ...
  if ( v10[23] || v10[18] )
  {
    ...
    *(_WORD *)&v24[14] = (unsigned __int8)(v16 + 48);
    ...
    if ( appended < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, appended, 0x313u, 0LL);
      return v12;
    }
    v9 = v22;
  }
...
LABEL_19:
    if ( *a4 )
    {
      if ( !v10[23] )
      {
        ...
        v12 = v13;
        if ( v13 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x322u, 0LL);
      }
    }
  }
  return v12;
