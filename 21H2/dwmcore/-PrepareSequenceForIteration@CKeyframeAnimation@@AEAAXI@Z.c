/*
 * XREFs of ?PrepareSequenceForIteration@CKeyframeAnimation@@AEAAXI@Z @ 0x1800AC98C
 * Callers:
...
void __fastcall CKeyframeAnimation::PrepareSequenceForIteration(CKeyframeAnimation *this, int a2)
{
  ...
  v6 = *((_DWORD *)this + 128);
  if ( v6 >= 0 && a2 == v6 && *((float *)this + 130) != 1.0 )
    v4 = *((_DWORD *)this + 130);
  v7 = *((_QWORD *)this + 45);
  *(_BYTE *)(v7 + 140) &= ~8u;
  *(_BYTE *)(v7 + 140) |= 8 * (v5 & 1);
  v8 = *((_QWORD *)this + 45);
  v9 = *(_BYTE *)(v8 + 140) & 0xEF | (*((float *)this + 124) >= 0.0 ? 0 : 0x10);
  *(_BYTE *)(v8 + 140) = v9;
