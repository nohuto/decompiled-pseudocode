/*
 * XREFs of ?ProcessUpdate@CVisualCapture@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALCAPTURE@@@Z @ 0x180206DD4
 * Callers:
        ...
        const struct tagMILCMD_VISUALCAPTURE *a3)
{
  ...
  if ( v6 )
  {
    ...
    *((_QWORD *)this + 233) = Resource;
    ...
    {
      v9 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, -2003303421, 0x6A3u);
LABEL_15:
      (*(void (__fastcall **)(CVisualCapture *))(*(_QWORD *)this + 64LL))(this);
      goto LABEL_16;
    }
  ...
  if ( v10 )
  {
    ...
    *((_QWORD *)this + 234) = v11;
    ...
    {
      v9 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, -2003303421, 0x6B5u);
      goto LABEL_15;
    }
  }
  else
  ...
  if ( (_DWORD)v13 )
  {
    ...
    *((_QWORD *)this + 235) = v14;
    ...
    {
      v9 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, -2003303421, 0x6C7u);
      goto LABEL_15;
    }
  }
  else
  ...
  *((_BYTE *)this + 1900) = *((_BYTE *)a3 + 32);
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x6D5u);
    goto LABEL_15;
  }
LABEL_16:
