/*
 * XREFs of ?GetProcessAttribution@CProcessAttributionManager@@QEAAJK_KPEAPEAVCProcessAttribution@@@Z @ 0x180035B6C
 * Callers:
 ...
 * Callees:
 *     ??0Record@CProcessAttributionManager@@QEAA@K_KH@Z @ 0x180033F80 (--0Record@CProcessAttributionManager@@QEAA@K_KH@Z.c)
