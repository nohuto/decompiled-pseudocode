/*
 * XREFs of ?UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_NI@Z @ 0x1801616B8
 * Callers:
