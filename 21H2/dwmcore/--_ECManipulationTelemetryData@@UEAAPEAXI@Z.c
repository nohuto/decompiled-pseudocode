/*
 * XREFs of ??_ECManipulationTelemetryData@@UEAAPEAXI@Z @ 0x1801C5EE8
 * Callers:
 *     ??_ECManipulationTelemetryData@@W7EAAPEAXI@Z @ 0x1800F6760 (--_ECManipulationTelemetryData@@W7EAAPEAXI@Z.c)
 * Callees:
