/*
 * XREFs of ?_Change_array@?$vector@PEAVIVailRenderTarget@@V?$allocator@PEAVIVailRenderTarget@@@std@@@std@@AEAAXQEAPEAVIVailRenderTarget@@_K1@Z @ 0x18019A448
 * Callers:
...
__int64 __fastcall std::vector<IVailRenderTarget *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
