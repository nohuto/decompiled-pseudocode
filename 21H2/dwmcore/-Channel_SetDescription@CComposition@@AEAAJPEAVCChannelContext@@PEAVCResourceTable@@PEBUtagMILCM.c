/*
 * XREFs of ?Channel_SetDescription@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_SETDESCRIPTION@@PEBXI@Z @ 0x1800E8F44
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( a6 < (int)v6 + 1 || v8[v6] )
    CComposition::FailFastOnMalformedPacket(this, 1252792891LL, 0LL, a4);
