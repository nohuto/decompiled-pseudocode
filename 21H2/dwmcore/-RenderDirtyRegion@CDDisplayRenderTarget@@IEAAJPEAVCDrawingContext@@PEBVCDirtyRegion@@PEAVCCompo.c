/*
 * XREFs of ?RenderDirtyRegion@CDDisplayRenderTarget@@IEAAJPEAVCDrawingContext@@PEBVCDirtyRegion@@PEAVCComposeTop@@@Z @ 0x18018CE0C
 * Callers:
 ...
 *     ?UseSuperSample@CDDisplayRenderTarget@@IEBA_NXZ @ 0x18018D778 (-UseSuperSample@CDDisplayRenderTarget@@IEBA_NXZ.c)
  ...
  if ( *((_BYTE *)a3 + 4456) )
  {
            ...
            &v65) )
    {
      ...
      *((float *)&v66 + 1) = (float)v35;
      ...
      v5 = CDrawingContext::Clear((struct CDrawingContext *)((char *)a2 + 16), &stru_1802F0AE0);
  ...
  while ( 1 )
  {
    ...
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 8) != 0 )
      McTemplateU0qdffff_EventWriteTransfer(
        ...
        (char)v66,
        SBYTE4(v66));
    dword_1803472A8 += (int)(float)((float)(v47 - v49) * (float)(v46 - v48));
