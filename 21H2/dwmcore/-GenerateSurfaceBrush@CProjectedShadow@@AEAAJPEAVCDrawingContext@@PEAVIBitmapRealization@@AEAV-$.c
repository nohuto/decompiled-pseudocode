/*
 * XREFs of ?GenerateSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVIBitmapRealization@@AEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCSurfaceBrush@@@Z @ 0x18023468C
 * Callers:
  ...
  if ( v17 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *((_DWORD *)v13 + 24) = 0;
      ...
      LODWORD(v17) = 0;
      ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803D22C0)(
        (char *)v13 + SDWORD2(xmmword_1803D22C0),
        &CSurfaceBrush::sc_HorizontalAlignment,
        &v17);
      LODWORD(v17) = 0;
      ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803D22F8)(
        (char *)v13 + SDWORD2(xmmword_1803D22F8),
    ...
    v16 = 1266;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, v16);
    goto LABEL_11;
  }
  v10 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0LL, -2147024882, 0x4F0u);
LABEL_11:
