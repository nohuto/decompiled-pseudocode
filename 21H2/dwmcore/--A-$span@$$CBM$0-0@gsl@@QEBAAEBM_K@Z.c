/*
 * XREFs of ??A?$span@$$CBM$0?0@gsl@@QEBAAEBM_K@Z @ 0x18003BEE4
 * Callers:
...
__int64 __fastcall gsl::span<float const,-1>::operator[](gsl::details *a1, unsigned __int64 a2)
{
  if ( a2 >= *(_QWORD *)a1 )
  {
    gsl::details::terminate(a1);
    JUMPOUT(0x18003BF00LL);
  }
  return *((_QWORD *)a1 + 1) + 4 * a2;
}
