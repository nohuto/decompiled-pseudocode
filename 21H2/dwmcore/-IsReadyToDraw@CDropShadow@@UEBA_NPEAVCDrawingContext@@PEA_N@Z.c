/*
 * XREFs of ?IsReadyToDraw@CDropShadow@@UEBA_NPEAVCDrawingContext@@PEA_N@Z @ 0x180015540
 * Callers:
 *     <none>
 * Callees:
  ...
  *a3 = 0;
  ...
  else if ( *((_DWORD *)this + 33) == 1 )
  {
    if ( a2 )
    {
      ...
      if ( !v10
        || !(*(unsigned __int8 (__fastcall **)(struct CBrush *, struct CDrawingContext *, bool *))(*(_QWORD *)v10 + 296LL))(
              v10,
              a2,
              a3) )
      {
  ...
  {
    v7 = *((_QWORD *)this + 18);
    if ( !v7 || (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v7 + 296LL))(v7) )
      return 1;
    return v3;
  }
}
