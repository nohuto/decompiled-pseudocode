/*
 * XREFs of ?GetFlatteningToLocalSpace@CLayerVisual@@QEBA_NXZ @ 0x1802236A0
 * Callers:
...
bool __fastcall CLayerVisual::GetFlatteningToLocalSpace(CLayerVisual *this, __int64 a2, __int64 a3, __int64 a4)
{
