/*
 * XREFs of ?SetPixelFormat@?$CGdiSpriteBitmapGeneratedT@VCGdiSpriteBitmap@@VCResource@@@@QEAAJW4DXGI_FORMAT@@@Z @ 0x180060AA8
 * Callers:
        ...
        enum DXGI_FORMAT a2)
{
  ...
  if ( a2 != *((_DWORD *)this + 16) )
  {
    ...
    {
LABEL_9:
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v5, 0x61u, 0LL);
      return v2;
    }
    v6 = *(_QWORD *)this;
    *((_DWORD *)this + 16) = a2;
