/*
 * XREFs of ?ComputeCachedHdrMetadata@CDDisplaySwapChain@@IEAAJW4DXGI_HDR_METADATA_TYPE@@PEBX@Z @ 0x18023963C
 * Callers:
      ...
      if ( a2 == DXGI_HDR_METADATA_TYPE_HDR10 )
      {
        ...
        if ( v8 <= 0x1C )
        {
          if ( v8 < 0x1C )
          {
            ...
            {
              std::vector<unsigned char>::_Resize_reallocate<std::_Value_init_tag>((__int64 *)this + 51, 0x1CuLL);
            }
          }
        }
        else
