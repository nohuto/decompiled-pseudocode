/*
 * XREFs of ?EnsureSharedRenderTargets@CMagnifierRenderTarget@@AEAAJXZ @ 0x18018B484
 * Callers:
...
__int64 __fastcall CMagnifierRenderTarget::EnsureSharedRenderTargets(CMagnifierRenderTarget *this)
{
  ...
  if ( v1 )
  {
    for ( i = 0; i < *((_DWORD *)this + 470); ++i )
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802F0D88, 2u, v6, 0x16Du, 0LL);
        v3 = v2;
        break;
      }
      v8 = *((_DWORD *)this + 450);
      ...
      if ( v3 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802F0D88, 2u, v3, 0x170u, 0LL);
        break;
      }
LABEL_11:
      v16 = 0LL;
