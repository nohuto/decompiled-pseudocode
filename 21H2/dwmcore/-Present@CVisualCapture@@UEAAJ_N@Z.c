/*
 * XREFs of ?Present@CVisualCapture@@UEAAJ_N@Z @ 0x1801F2190
 * Callers:
 *     ?Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F6BB0 (-Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
