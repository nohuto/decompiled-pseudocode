/*
 * XREFs of ?InteractionUpdateRails@CChannel@@UEAAJI_N0@Z @ 0x1800F07B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::InteractionUpdateRails(CDataStreamWriter **this, unsigned int a2, char a3, char a4)
{
  unsigned int v8; // ebx
