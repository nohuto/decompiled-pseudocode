/*
 * XREFs of ?TurnOffScribblingForTarget@CSuperWetInkManager@@AEBAXPEAVIMonitorTarget@@@Z @ 0x1801A8CDC
 * Callers:
...
void __fastcall CSuperWetInkManager::TurnOffScribblingForTarget(CSuperWetInkManager *this, struct IMonitorTarget *a2)
{
  ...
  v8 = this;
  v2 = (*(__int64 (__fastcall **)(struct IMonitorTarget *))(*(_QWORD *)a2 + 152LL))(a2);
  if ( v2 )
  {
    v3 = *(_QWORD *)(v2 + 8);
    v8 = 0LL;
    ...
    {
      (*(void (__fastcall **)(CSuperWetInkManager *, _QWORD))(*(_QWORD *)v8 + 296LL))(v8, 0LL);
      v6 = (CComputeScribbleRenderer *)(*(__int64 (__fastcall **)(CSuperWetInkManager *))(*(_QWORD *)v8 + 264LL))(v8);
      if ( v6 )
