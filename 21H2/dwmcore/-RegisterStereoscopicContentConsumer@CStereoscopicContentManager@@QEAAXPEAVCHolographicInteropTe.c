/*
 * XREFs of ?RegisterStereoscopicContentConsumer@CStereoscopicContentManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x180297BC8
 * Callers:
 ...
 *     ??0StereoscopicViewData@@QEAA@XZ @ 0x1802973D4 (--0StereoscopicViewData@@QEAA@XZ.c)
 */
