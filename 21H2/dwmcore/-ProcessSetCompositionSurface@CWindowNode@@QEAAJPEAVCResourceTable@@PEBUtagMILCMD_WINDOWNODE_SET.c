/*
 * XREFs of ?ProcessSetCompositionSurface@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETCOMPOSITIONSURFACE@@@Z @ 0x1801F3A8C
 * Callers:
        ...
        const struct tagMILCMD_WINDOWNODE_SETCOMPOSITIONSURFACE *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x32Fu, 0LL);
      v4 = v12;
      goto LABEL_7;
    }
    v4 = v12;
  ...
  v8 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x332u, 0LL);
LABEL_7:
  if ( v4 )
