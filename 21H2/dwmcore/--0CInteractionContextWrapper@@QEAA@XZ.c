/*
 * XREFs of ??0CInteractionContextWrapper@@QEAA@XZ @ 0x1800B60D8
 * Callers:
 ...
 *     ??0CInteractionContextTransformHelper@@QEAA@XZ @ 0x1800B62AC (--0CInteractionContextTransformHelper@@QEAA@XZ.c)
 */
