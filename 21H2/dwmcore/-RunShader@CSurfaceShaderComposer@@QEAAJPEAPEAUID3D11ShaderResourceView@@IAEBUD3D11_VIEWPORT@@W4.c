/*
 * XREFs of ?RunShader@CSurfaceShaderComposer@@QEAAJPEAPEAUID3D11ShaderResourceView@@IAEBUD3D11_VIEWPORT@@W4Enum@BlendMode@@AEBV?$span@USamplerMode@@$0?0@gsl@@_NPEAUID3D11RenderTargetView@@PEAUID3D11PixelShader@@PEBUtagRECT@@4@Z @ 0x18028A088
 * Callers:
        ...
        __int64 a9)
{
  ...
  v9 = CSurfaceShaderComposer::RunShader(a1, (unsigned int)&unk_18032AB90, a3, a2, a3, a4, a5, a6, a7, a8, a9, 0LL, 0);
  v10 = v9;
  if ( v9 < 0 )
