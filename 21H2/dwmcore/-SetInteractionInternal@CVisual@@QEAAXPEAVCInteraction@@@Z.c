/*
 * XREFs of ?SetInteractionInternal@CVisual@@QEAAXPEAVCInteraction@@@Z @ 0x1800E185C
 * Callers:
...
void __fastcall CVisual::SetInteractionInternal(CVisual *this, struct CInteraction *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((_QWORD *)this + 28, 9) = a2;
    }
  }
  else if ( v5 )
  {
