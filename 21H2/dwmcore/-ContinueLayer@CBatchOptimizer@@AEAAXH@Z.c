/*
 * XREFs of ?ContinueLayer@CBatchOptimizer@@AEAAXH@Z @ 0x18007E65C
 * Callers:
...
void __fastcall CBatchOptimizer::ContinueLayer(CBatchOptimizer *this, int a2)
{
  ...
  else
  {
    v10 = *((_QWORD *)v6 + 14);
    CBatchOptimizer::FlushBottomLayer(this);
    wil::com_ptr_t<CRenderingEffect,wil::err_returncode_policy>::operator=(v6 + 112, v10);
  }
}
