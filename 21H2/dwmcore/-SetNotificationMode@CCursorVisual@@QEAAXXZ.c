/*
 * XREFs of ?SetNotificationMode@CCursorVisual@@QEAAXXZ @ 0x180212050
 * Callers:
 *     ?EndUpdateCursors@CGlobalComposition@@UEAAXXZ @ 0x1800E2210 (-EndUpdateCursors@CGlobalComposition@@UEAAXXZ.c)
 * Callees:
...
void __fastcall CCursorVisual::SetNotificationMode(CCursorVisual *this)
{
  ...
  if ( *((_QWORD *)this + 93) )
  {
    if ( *((_QWORD *)this + 94) == *(_QWORD *)(*((_QWORD *)this + 2) + 496LL)
