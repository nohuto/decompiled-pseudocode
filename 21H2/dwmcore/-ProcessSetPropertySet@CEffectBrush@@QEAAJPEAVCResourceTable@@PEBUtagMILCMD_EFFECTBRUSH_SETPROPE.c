/*
 * XREFs of ?ProcessSetPropertySet@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETPROPERTYSET@@@Z @ 0x180048324
 * Callers:
        ...
        const struct tagMILCMD_EFFECTBRUSH_SETPROPERTYSET *a3)
{
  ...
  {
    v7 = -2003303422;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2003303422, 0x65u, 0LL);
  }
  else
  {
    ...
    {
      v7 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, -2003303421, 0x6Bu, 0LL);
    }
  }
  return v7;
}
