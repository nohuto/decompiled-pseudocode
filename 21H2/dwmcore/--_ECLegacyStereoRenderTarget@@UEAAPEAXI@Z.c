/*
 * XREFs of ??_ECLegacyStereoRenderTarget@@UEAAPEAXI@Z @ 0x18019EFB0
 * Callers:
 *     <none>
 * Callees:
...
CLegacyStereoRenderTarget *__fastcall CLegacyStereoRenderTarget::`vector deleting destructor'(
        ...
        char a2)
{
  wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((__int64)this + 18640);
