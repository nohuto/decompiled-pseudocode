/*
 * XREFs of ?HitTestTreeWalkResult@DWM@InputTraceLogging@@SAXKW4DIT_HITTESTATTRIBUTES@@QEAXQEAUHWND__@@1PEBVCInteraction@@@Z @ 0x18002B2F0
 * Callers:
        ...
        struct CInteraction *a6)
{
  ...
  v11 = a6;
  if ( **(_DWORD **)(v10 + 8) > 4u && (unsigned __int8)tlgKeywordOn(*(_QWORD *)(v10 + 8), 2LL) )
  {
    if ( v11 )
    {
      v40 = *((_QWORD *)v11 + 214);
      v12 = *((_QWORD *)v11 + 35) != 0LL;
    }
    else
    {
      v40 = 0LL;
    ...
    LODWORD(a6) = v12;
    v34 = InputTraceLogging::InteractionInputTransparency(v11);
    v35 = InputTraceLogging::InteractionFurtherProcessingForInput(v11);
    if ( v11 )
      v13 = *((_BYTE *)v11 + 192) & 1;
    else
      v13 = 0;
    ...
    if ( v11 )
      ...
      v14 = 0;
    v37 = v14;
    v41 = (__int64)InputTraceLogging::InteractionInputSink(v11);
    if ( v11 )
      v16 = *((_DWORD *)v11 + 426);
    else
      v16 = 0;
    ...
    v43 = (__int64)InputTraceLogging::InteractionSourceTypeToString(v11);
    v46 = a5;
    v18 = L"HasCapture";
    if ( (a2 & 0x200) == 0 )
      v18 = &word_18032C468;
