/*
 * XREFs of ?SetBlendMode@CD3DBatchExecutionContext@@EEAAXW4Enum@BlendMode@@@Z @ 0x1800CDEF0
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_DWORD *)(a1 + 40) |= v4;
    ...
    if ( *(_QWORD *)(v5 + 40) )
    {
      ...
      *(_DWORD *)(v5 + 48) = 0;
      ...
      {
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(v5 + 64) + 560LL) + 120LL))(
          *(_QWORD *)(*(_QWORD *)(v5 + 64) + 560LL),
          *(_QWORD *)(v5 + 72),
          0LL);
        *(_QWORD *)(v5 + 88) = 0LL;
        *(_DWORD *)(v5 + 96) = 0;
