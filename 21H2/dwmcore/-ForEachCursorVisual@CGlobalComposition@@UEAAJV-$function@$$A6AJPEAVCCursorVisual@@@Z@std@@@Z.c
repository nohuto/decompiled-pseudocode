/*
 * XREFs of ?ForEachCursorVisual@CGlobalComposition@@UEAAJV?$function@$$A6AJPEAVCCursorVisual@@@Z@std@@@Z @ 0x1801D75B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGlobalComposition::ForEachCursorVisual(__int64 a1, __int64 a2)
{
  ...
  while ( v2 != v4 )
  {
    ...
    if ( !v6 )
    {
      ...
      __debugbreak();
      JUMPOUT(0x1801D7686LL);
    }
    v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 16LL))(v6, &v11);
    v5 = v7;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0x17Fu);
      break;
    }
    ++v2;
  }
