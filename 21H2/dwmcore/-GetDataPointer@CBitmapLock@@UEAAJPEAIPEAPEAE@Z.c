/*
 * XREFs of ?GetDataPointer@CBitmapLock@@UEAAJPEAIPEAPEAE@Z @ 0x1800D1EC0
 * Callers:
 *     ?GetDataPointer@CBitmapLock@@WBA@EAAJPEAIPEAPEAE@Z @ 0x1800F6DD0 (-GetDataPointer@CBitmapLock@@WBA@EAAJPEAIPEAPEAE@Z.c)
 * Callees:
