/*
 * XREFs of ?TransferCandidatesToPlaneAssignments@COverlayContext@@AEAAJXZ @ 0x18002F4EC
 * Callers:
      ...
      if ( !*(_BYTE *)(v6 + 216) )
      {
        ...
        *(_BYTE *)(v6 + 221) = 1;
        if ( v7 )
        {
          ...
          v3 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xDB4u, 0LL);
          ...
          if ( v3 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v3, 0xDC6u, 0LL);
            goto LABEL_27;
          }
        }
        *((_BYTE *)this + 11432) = 1;
