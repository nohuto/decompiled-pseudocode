/*
 * XREFs of ?CreateTexture@CD3DDevice@@QEAAJAEBVDWM_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAPEAUID3D11Texture2D@@@Z @ 0x18003AB0C
 * Callers:
        ...
        struct ID3D11Texture2D **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802DD0B8, 0xAu, v6, 0x889u, 0LL);
  }
  else
  {
    v8 = *((_QWORD *)this + 74);
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802DD0B8, 0xAu, v10, 0x88Du, 0LL);
    }
    else
    {
