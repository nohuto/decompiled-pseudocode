/*
 * XREFs of ??$_Uninitialized_move@PEAVCDepthSortingLayer@@PEAV1@V?$allocator@VCDepthSortingLayer@@@std@@@std@@YAPEAVCDepthSortingLayer@@QEAV1@0PEAV1@AEAV?$allocator@VCDepthSortingLayer@@@0@@Z @ 0x1801FADCC
 * Callers:
