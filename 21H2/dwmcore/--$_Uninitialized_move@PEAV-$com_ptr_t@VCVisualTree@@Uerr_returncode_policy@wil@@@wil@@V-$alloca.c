...
char *__fastcall std::_Uninitialized_move<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>>>(
        __int64 *a1,
        __int64 *a2,
        char *a3)
{
