/*
 * XREFs of ?SetTransformParentDataInternal@CVisual@@QEAAXPEAUTransformParentData@@@Z @ 0x1800F0720
 * Callers:
...
LABEL_13:
  ...
  if ( (v6 & 0x1000000) != 0 )
  {
    v7 = *v2;
    *v5 = v6 & 0xFEFFFFFF;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v7, 8);
    if ( Slot < *(_DWORD *)(v9 + 4) )
      *(_BYTE *)(Slot + v9 + 8) = v10;
  }
}
