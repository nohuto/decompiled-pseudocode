/*
 * XREFs of McTemplateU0pxttt_EventWriteTransfer @ 0x180241EF8
 * Callers:
...
ULONG McTemplateU0pxttt_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  return McGenEventWrite_EventWriteTransfer(
           ...
           &EVTDESC_SYNCHRONOUSSUPERWETINK_LOOKUPPERFRAMEDATA_DROPED_FROM_GUEST,
           v15,
           6u,
           &v3);
}
