/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x18024C2DC
 * Callers:
 ...
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18024C8A8 (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18024C8D8 (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 */
