/*
 * XREFs of ?Materialize_BamoCompObjectDiagnosticsRootProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180166460
 * Callers:
 *     ?Thunk_Materialize_BamoCompObjectDiagnosticsRootProxy_34@?$IBamoPeer_DiagnosticCallbacks_AutoBamos_Receive@VBamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801676C0 (-Thunk_Materialize_BamoCompObjectDiagnosticsRootProxy_34@-$IBamoPeer_DiagnosticCallbacks_AutoBam.c)
 * Callees:
