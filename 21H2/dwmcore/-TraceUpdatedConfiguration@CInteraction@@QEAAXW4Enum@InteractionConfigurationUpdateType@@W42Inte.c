/*
 * XREFs of ?TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@IPEBX@Z @ 0x18006D958
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          if ( v8 == 1 && (Microsoft_Windows_Dwm_CoreEnableBits & 0x8000) != 0 )
