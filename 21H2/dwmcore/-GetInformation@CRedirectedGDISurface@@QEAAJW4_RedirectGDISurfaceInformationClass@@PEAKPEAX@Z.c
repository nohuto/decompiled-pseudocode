/*
 * XREFs of ?GetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@PEAKPEAX@Z @ 0x1800336BC
 * Callers:
...
LABEL_19:
    v14 = v6;
LABEL_37:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802DE020, 4u, v14, v18, 0LL);
    return v6;
  }
  memset(v19, 0, sizeof(v19));
  v20 = 0LL;
