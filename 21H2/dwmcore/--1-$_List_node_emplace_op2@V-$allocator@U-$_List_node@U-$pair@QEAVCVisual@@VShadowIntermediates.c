/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@QEAVCVisual@@VShadowIntermediates@CDropShadow@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18021259C
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    CDropShadow::ShadowIntermediates::~ShadowIntermediates((struct CResource **)(v2 + 24));
    v3 = *(void **)(a1 + 8);
    if ( v3 )
