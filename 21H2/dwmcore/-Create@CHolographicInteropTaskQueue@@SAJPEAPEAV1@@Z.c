/*
 * XREFs of ?Create@CHolographicInteropTaskQueue@@SAJPEAPEAV1@@Z @ 0x18025A808
 * Callers:
 ...
 *     ??0CHolographicInteropTaskQueue@@AEAA@XZ @ 0x18025A6AC (--0CHolographicInteropTaskQueue@@AEAA@XZ.c)
