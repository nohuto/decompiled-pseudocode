/*
 * XREFs of ?Channel_VisualCaptureBits@CGlobalComposition@@UEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_CHANNEL_VISUALCAPTUREBITS@@@Z @ 0x1801D7420
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_CHANNEL_VISUALCAPTUREBITS *a4)
{
  ...
  if ( VisualTree < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, VisualTree, 0x106u);
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147024882, 0x112u);
  }
