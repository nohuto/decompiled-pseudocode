/*
 * XREFs of ?CreateScratchRenderTargetBitmap@CD3DDevice@@IEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x18003B40C
 * Callers:
...
LABEL_11:
    v19 = v12;
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802ACF50, 2u, v19, v21, 0LL);
  }
