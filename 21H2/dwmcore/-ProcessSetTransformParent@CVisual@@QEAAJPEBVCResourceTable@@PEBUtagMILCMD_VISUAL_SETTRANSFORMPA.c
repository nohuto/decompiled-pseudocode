/*
 * XREFs of ?ProcessSetTransformParent@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTRANSFORMPARENT@@@Z @ 0x1800D5B40
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETTRANSFORMPARENT *a3)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2003303421, 0xA31u, 0LL);
  }
  else
  {
    v25 = *((_BYTE *)a3 + 12) != 0;
    ...
    else
    {
      if ( Resource )
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0xA45u, 0LL);
          return v4;
        }
        if ( !v15 )
        {
          ...
          {
            v4 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024882, 0xA4Au, 0LL);
