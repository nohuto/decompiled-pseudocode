/*
 * XREFs of ?GenerateNineGridBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVIBitmapRealization@@AEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCNineGridBrush@@@Z @ 0x18023450C
 * Callers:
        ...
        struct CResource ***a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v18[0] )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, v17);
    goto LABEL_11;
  }
  v12 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, -2147024882, 0x4ADu);
LABEL_11:
