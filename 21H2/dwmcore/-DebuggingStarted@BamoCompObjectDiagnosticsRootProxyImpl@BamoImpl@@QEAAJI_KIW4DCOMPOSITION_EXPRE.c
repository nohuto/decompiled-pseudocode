/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180182858
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootProxyImpl::DebuggingStarted(__int64 a1)
{
  int v2; // ebx
  __int64 v3; // rdx
  ...
  struct IMessageCallSendHost *v8[3]; // [rsp+68h] [rbp-30h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+98h] [rbp+0h]
  unsigned int v10; // [rsp+A0h] [rbp+8h] BYREF
...
LABEL_3:
  ...
  return CoreUICallSend(v5, v8, 2LL, 0LL, 1, &unk_1802DA352);
}
