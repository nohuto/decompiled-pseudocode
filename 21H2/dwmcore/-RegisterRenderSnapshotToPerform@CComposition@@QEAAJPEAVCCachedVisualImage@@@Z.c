/*
 * XREFs of ?RegisterRenderSnapshotToPerform@CComposition@@QEAAJPEAVCCachedVisualImage@@@Z @ 0x1800F0E30
 * Callers:
...
__int64 __fastcall CComposition::RegisterRenderSnapshotToPerform(CComposition *this, struct CCachedVisualImage *a2)
{
  ...
  __int64 v6; // r9
  __int64 v7; // rcx
  struct CCachedVisualImage **v9; // rcx
  int v10; // edi
  __int64 v11; // rcx
  int v12; // eax
  __int64 v13; // rcx
...
LABEL_2:
    ...
    else
    {
      ...
      v12 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)v2, 8u, 1, &v14);
      v10 = v12;
      v3 = v12;
      if ( v12 >= 0 )
        return v3;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0x96Au);
    return v3;
  }
  v9 = (struct CCachedVisualImage **)*((_QWORD *)this + 90);
  while ( a2 != *v9 )
  {
    ++v5;
    ++v9;
