/*
 * XREFs of ?HrFindInterface@CPathEmitterArea@EmitterShapes@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180259BE0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v3 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147467262, 0x130u);
  }
  else
  {
    *a3 = this;
