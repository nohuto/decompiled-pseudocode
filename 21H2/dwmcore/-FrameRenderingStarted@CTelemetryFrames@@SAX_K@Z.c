/*
 * XREFs of ?FrameRenderingStarted@CTelemetryFrames@@SAX_K@Z @ 0x180071614
 * Callers:
...
void __fastcall CTelemetryFrames::FrameRenderingStarted(__int64 a1)
{
  ...
  byte_180347411 = v3 > 0x2A;
  if ( v3 > 0x2A )
    ++dword_18034729C;
  if ( !dword_1803472B8 )
  {
    *(_QWORD *)&xmmword_180347400 = a1;
    v7 = *((_QWORD *)qword_1803471C8 + 5);
    if ( (*(_QWORD *)(v7 + 24) - *(_QWORD *)(v7 + 16)) / 480LL )
      dword_1803472CC = anonymous_namespace_::FramesReport::OffsetInMillisecondsFromStartOfReport(v7, a1);
  }
  v4 = dword_180347130 | dword_1803472B0;
  dword_1803472B0 |= dword_180347130;
  byte_180347124 = byte_180347125;
  if ( byte_180347125 )
  {
    byte_180347125 = 0;
    dword_1803472B0 = v4 | 0x100;
  }
  dword_180347130 = 0;
  ...
  if ( GetTickCount() - v6 < 0x3E8 )
    dword_1803472B0 |= 1u;
  `anonymous namespace'::_frameStartSnaphot = dword_180347338;
  dword_180347630 = dword_180347340;
  dword_18034762C = dword_18034733C;
  dword_180347634 = dword_180347344;
}
