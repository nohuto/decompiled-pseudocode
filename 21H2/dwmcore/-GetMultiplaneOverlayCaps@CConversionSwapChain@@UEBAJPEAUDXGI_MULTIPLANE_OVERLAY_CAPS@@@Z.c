/*
 * XREFs of ?GetMultiplaneOverlayCaps@CConversionSwapChain@@UEBAJPEAUDXGI_MULTIPLANE_OVERLAY_CAPS@@@Z @ 0x180292ABC
 * Callers:
 *     ?GetMultiplaneOverlayCaps@CConversionSwapChain@@$4PPPPPPPM@A@EBAJPEAUDXGI_MULTIPLANE_OVERLAY_CAPS@@@Z @ 0x18010A4D0 (-GetMultiplaneOverlayCaps@CConversionSwapChain@@$4PPPPPPPM@A@EBAJPEAUDXGI_MULTIPLANE_OVERLAY_CAP.c)
 * Callees:
        ...
        struct DXGI_MULTIPLANE_OVERLAY_CAPS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, MultiplaneOverlayCaps, 0xAAu);
  }
  else
  {
    v6 = *((_DWORD *)a2 + 3);
