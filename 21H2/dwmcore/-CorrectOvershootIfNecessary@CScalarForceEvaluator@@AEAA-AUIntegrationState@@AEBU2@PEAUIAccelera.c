/*
 * XREFs of ?CorrectOvershootIfNecessary@CScalarForceEvaluator@@AEAA?AUIntegrationState@@AEBU2@PEAUIAccelerator@@PEA_N@Z @ 0x18026665C
 * Callers:
  ...
  *(_DWORD *)(a2 + 16) = *(_DWORD *)(a3 + 16);
  if ( (*(unsigned int (__fastcall **)(__int64 *))(*a4 + 48))(a4) )
  {
    ...
    *(_BYTE *)(a1 + 64) = v9;
    ...
    if ( (v9 & 1) != 0 )
    {
      v11 = (*(float (__fastcall **)(__int64 *))(v10 + 24))(a4) - *(float *)(a1 + 16);
      LOBYTE(v5) = v11 < 0.0;
      if ( *(float *)(a1 + 52) != (float)((v11 > 0.0) - v5) )
      {
        v12 = *(float *)(a1 + 36);
        v13 = (*(double (__fastcall **)(__int64 *))(*a4 + 24))(a4);
        v14 = *(_DWORD *)(a1 + 28);
    ...
    {
      v16 = (*(float (__fastcall **)(__int64 *))(v10 + 24))(a4) - *(float *)(a1 + 16);
      LOBYTE(v5) = v16 < 0.0;
      *(_BYTE *)(a1 + 64) &= ~1u;
