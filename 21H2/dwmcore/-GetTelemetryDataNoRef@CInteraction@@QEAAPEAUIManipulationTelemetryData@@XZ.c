/*
 * XREFs of ?GetTelemetryDataNoRef@CInteraction@@QEAAPEAUIManipulationTelemetryData@@XZ @ 0x1801C63C4
 * Callers:
 ...
 *     ??0CManipulationTelemetryData@@QEAA@PEAVCComposition@@I@Z @ 0x1801C5E6C (--0CManipulationTelemetryData@@QEAA@PEAVCComposition@@I@Z.c)
