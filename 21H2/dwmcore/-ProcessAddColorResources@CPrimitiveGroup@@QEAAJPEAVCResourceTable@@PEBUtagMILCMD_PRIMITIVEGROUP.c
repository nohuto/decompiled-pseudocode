/*
 * XREFs of ?ProcessAddColorResources@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_PRIMITIVEGROUP_ADDCOLORRESOURCES@@PEBXI@Z @ 0x1801E3728
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  for ( i = 0; i < *((_DWORD *)a3 + 2); ++i )
  {
    ...
    {
      v4 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2003303421, 0x11Au, 0LL);
      goto LABEL_15;
    }
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x122u, 0LL);
      goto LABEL_14;
    }
    v14 = *((_DWORD *)this + 66);
    v15 = v14 + 1;
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v4, 0x124u, 0LL);
