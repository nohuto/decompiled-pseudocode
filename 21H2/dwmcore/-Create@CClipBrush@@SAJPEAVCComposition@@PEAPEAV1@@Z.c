/*
 * XREFs of ?Create@CClipBrush@@SAJPEAVCComposition@@PEAPEAV1@@Z @ 0x1801B7ACC
 * Callers:
 ...
 *     ??0CClipBrush@@IEAA@PEAVCComposition@@@Z @ 0x1801B7934 (--0CClipBrush@@IEAA@PEAVCComposition@@@Z.c)
 */
