/*
 * XREFs of ?GetDeviceTarget@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAJPEBV?$shared_ptr@VCRegion@@@std@@PEAPEAVIDeviceTarget@@@Z @ 0x1802A3880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDxHandleAdvancedDirectFlipBitmapRealization::GetDeviceTarget(__int64 a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( a2
    && (std::shared_ptr<CCursorState::ShapeData>::operator=((__int64 *)(a1 + 24), a2),
        ...
        v7 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0xA2u);
  }
  else
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0xA5u);
    }
    else
    {
      v12 = *(_QWORD *)(a1 + 16);
