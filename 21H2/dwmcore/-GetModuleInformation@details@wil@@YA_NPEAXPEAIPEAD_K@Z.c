/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x18014D8F0
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x18014D4D0 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1800E6E00 (__security_check_cookie.c)
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x18014EA98 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 */
