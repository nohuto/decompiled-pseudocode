/*
 * XREFs of ?DrawPolygon@CDrawingContext@@QEAAJPEAVCPolygon@@@Z @ 0x180175D14
 * Callers:
 ...
 *     ?GetOpacity@CDrawingContext@@QEBAMXZ @ 0x1800EBC4C (-GetOpacity@CDrawingContext@@QEBAMXZ.c)
 ...
 *     ?GetRenderOptions@CPolygon@@QEBAXPEAUMilRenderOptions@@@Z @ 0x1801F7A98 (-GetRenderOptions@CPolygon@@QEBAXPEAUMilRenderOptions@@@Z.c)
 */
...
__int64 __fastcall CDrawingContext::DrawPolygon(CDrawingContext *this, struct CPolygon *a2)
{
  ...
  if ( *((_QWORD *)a2 + 31) )
  {
    ...
    if ( (_DWORD)v41 )
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x55Du, 0LL);
        goto LABEL_34;
      }
      v36 = 1;
    }
    *(float *)&v38 = CDrawingContext::GetOpacity(this) * *((float *)a2 + 56);
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x562u, 0LL);
      goto LABEL_34;
    }
    v7 = 1;
    if ( !CMILMatrix::IsIdentity<0>((__int64)a2 + 144) )
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x568u, 0LL);
        goto LABEL_34;
      }
      v5 = 1;
    }
    if ( *(_BYTE *)(84LL * (unsigned int)(*((_DWORD *)this + 240) - 1) + *((_QWORD *)this + 117) + 80) )
    {
      if ( v5 )
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x572u, 0LL);
LABEL_34:
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x57Cu, 0LL);
    }
    else
    {
      if ( !v39 )
...
LABEL_25:
        *((_QWORD *)this + 435) = a2;
        ...
        v4 = v32;
        if ( v32 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0x599u, 0LL);
        goto LABEL_32;
      }
      v38 = 0LL;
      v35 = 1;
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x587u, 0LL);
      }
      else
      {
        if ( v35 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x591u, 0LL);
      }
      wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v38);
    }
    CShapePtr::Release((CShapePtr *)&v39);
