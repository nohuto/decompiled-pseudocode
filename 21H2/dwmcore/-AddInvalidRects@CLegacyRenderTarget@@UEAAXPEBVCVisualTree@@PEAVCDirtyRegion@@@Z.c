/*
 * XREFs of ?AddInvalidRects@CLegacyRenderTarget@@UEAAXPEBVCVisualTree@@PEAVCDirtyRegion@@@Z @ 0x180091E20
 * Callers:
 *     <none>
 * Callees:
 *     ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x180080B10 (-invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z.c)
        ...
        struct CDirtyRegion *a3)
{
  ...
  if ( *((_QWORD *)this + 12) )
  {
    ...
    *(_QWORD *)&v27 = v6;
    ...
    for ( i = qword_18034B648; i != (_QWORD)xmmword_18034B650; i += 16LL )
    {
      v9 = *(_QWORD *)i;
      if ( __PAIR64__(DWORD1(v27), v6) == *(_QWORD *)(*(_QWORD *)i + 936LL) )
      {
        if ( !*(_BYTE *)(v9 + 500) && !byte_18034B660 && *(_DWORD *)(v9 + 496) )
          v7 = 1;
        break;
      }
    }
