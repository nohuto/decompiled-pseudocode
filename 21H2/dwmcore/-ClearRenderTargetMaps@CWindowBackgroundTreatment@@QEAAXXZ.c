/*
 * XREFs of ?ClearRenderTargetMaps@CWindowBackgroundTreatment@@QEAAXXZ @ 0x1800C1764
 * Callers:
 ...
 *     ?InvalidateExistingBounds@CWindowBackgroundTreatment@@QEAAXXZ @ 0x1800C9E10 (-InvalidateExistingBounds@CWindowBackgroundTreatment@@QEAAXXZ.c)
