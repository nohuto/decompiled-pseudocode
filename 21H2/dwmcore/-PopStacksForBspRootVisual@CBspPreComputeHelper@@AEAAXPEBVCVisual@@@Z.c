/*
 * XREFs of ?PopStacksForBspRootVisual@CBspPreComputeHelper@@AEAAXPEBVCVisual@@@Z @ 0x1801B51BC
 * Callers:
...
void __fastcall CBspPreComputeHelper::PopStacksForBspRootVisual(CBspPreComputeHelper *this, const struct CVisual *a2)
{
  ...
  CWatermarkStack<bool,64,2,10>::Pop((_DWORD *)(v2 + 288));
  CWatermarkStack<float,2,2,10>::Pop((_DWORD *)(v3 + 256));
