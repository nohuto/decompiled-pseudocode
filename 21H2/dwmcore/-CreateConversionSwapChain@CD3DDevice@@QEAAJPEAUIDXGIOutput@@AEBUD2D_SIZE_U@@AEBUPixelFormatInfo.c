/*
 * XREFs of ?CreateConversionSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVILegacySwapChain@@@Z @ 0x1802800CC
 * Callers:
...
LABEL_16:
    v15 = v12;
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_18038DB18, 3LL, v15, v18);
  }
  ...
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>(v23);
  return v16;
}
