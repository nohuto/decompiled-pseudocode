/*
 * XREFs of ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ @ 0x18024D9CC
 * Callers:
 *     ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F7970 (-CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
