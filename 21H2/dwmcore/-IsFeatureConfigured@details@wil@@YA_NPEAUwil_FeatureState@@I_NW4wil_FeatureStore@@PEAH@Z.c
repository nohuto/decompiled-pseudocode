/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x1800AE43C
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x1800AE3C0 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 * Callees:
...
bool __fastcall wil::details::IsFeatureConfigured(int a1, int a2, unsigned __int8 a3, int a4, __int64 a5)
{
  ...
  if ( !v16 && (v13 & 4) == 0 && wil::details::g_enabledStateManager )
  {
    ...
    if ( !v11
      ...
      || (v14 = 0,
          v15 = v7,
          !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&xmmword_180347548, &v14, 0x10uLL)) )
    {
