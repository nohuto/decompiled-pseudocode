/*
 * XREFs of ??0CSurfaceBrush@@QEAA@PEAVCComposition@@@Z @ 0x180043434
 * Callers:
...
CSurfaceBrush *__fastcall CSurfaceBrush::CSurfaceBrush(CSurfaceBrush *this, struct CComposition *a2)
{
  ...
  *(_QWORD *)((char *)this + *(int *)(*((_QWORD *)this + 26) + 4LL) + 208) = &ILegacySwapChain::`vftable'{for `IUnknown'};
  CContent::CContent(this, a2);
  *((_QWORD *)this + 9) = 0LL;
  *(_QWORD *)this = &CSurfaceBrush::`vftable';
  v3 = *((_QWORD *)this + 8);
  *((_BYTE *)this + 80) = 0;
  *(_QWORD *)((char *)this + *(int *)(v3 + 4) + 64) = &CSurfaceBrush::`vftable'{for `IUnknown'};
