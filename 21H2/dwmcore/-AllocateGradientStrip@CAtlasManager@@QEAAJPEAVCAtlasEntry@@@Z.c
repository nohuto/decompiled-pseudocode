/*
 * XREFs of ?AllocateGradientStrip@CAtlasManager@@QEAAJPEAVCAtlasEntry@@@Z @ 0x18024BCCC
 * Callers:
 ...
 *     ?DetermineIdealAtlasSize@CAtlasManager@@CAII@Z @ 0x18024C06C (-DetermineIdealAtlasSize@CAtlasManager@@CAII@Z.c)
