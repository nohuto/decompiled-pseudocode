/*
 * XREFs of ?RemoveLogicalSurfaceEntry@CLogicalSurfaceHandleMap@@QEAAXPEBVCGdiSpriteBitmap@@PEAX@Z @ 0x1800D1DC0
 * Callers:
 *     ??1CRedirectedGDISurface@@MEAA@XZ @ 0x1800D1C14 (--1CRedirectedGDISurface@@MEAA@XZ.c)
 * Callees:
 *     <none>
 */
