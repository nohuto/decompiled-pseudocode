/*
 * XREFs of ?PopLayerTransformFromExplicitSurfaceInput@CTreeEffectLayer@@IEAAXXZ @ 0x180005B34
 * Callers:
        ...
        do
        {
          ...
          if ( v4 >= *(_DWORD *)(v8 + 136) )
          {
            wil::details::in1diag3::_FailFast_Unexpected(
              ...
              v6);
            JUMPOUT(0x180005C3DLL);
          }
          v9 = *(_QWORD *)(v8 + 112);
          v10 = *(_QWORD *)(v7 + v9);
          if ( v10 )
          {
            if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v10 + 56LL))(
                   *(_QWORD *)(v7 + v9),
                   180LL) )
            {
              *(_OWORD *)(v10 + 112) = _xmm;
