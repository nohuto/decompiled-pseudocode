/*
 * XREFs of ?FlattenGeometry@CTransformedGeometryHelper@@AEAAJPEBUID2D1Geometry@@@Z @ 0x180013000
 * Callers:
...
LABEL_14:
  ...
  if ( !(unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(&v26) )
  {
    ...
    o_sqrtf_0((float)((float)(v8 - v9) * (float)(v8 - v9)) + v10);
    o_sqrtf_0((float)((float)(v9 - v8) * (float)(v9 - v8)) + v10);
    ...
    *((_QWORD *)&v25 + 1) = __PAIR64__(LODWORD(v16), LODWORD(v18));
    if ( !(unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(&v25)
      && !(unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsInfinite(&v25) )
    {
      v20 = v28[1] - v32;
      v21 = v28[0] - v31;
      o_sqrtf_0((float)((float)(v11 - v29) * (float)(v11 - v29)) + (float)((float)(v13 - v30) * (float)(v13 - v30)));
      o_sqrtf_0((float)(v21 * v21) + (float)(v20 * v20));
      goto LABEL_14;
    }
  }
  return v2;
