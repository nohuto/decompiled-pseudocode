/*
 * XREFs of ?UpdateOnRenderThread@CManipulationTelemetryData@@UEAAJAEBUManipulationThreadTelemetryData@@@Z @ 0x180232BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CManipulationTelemetryData::UpdateOnRenderThread(LARGE_INTEGER *this, __m128i *a2)
{
  ...
  if ( (unsigned int)dword_180344E48 > 5 && (qword_180344E58 & 2) != 0 && (qword_180344E60 & 2) == qword_180344E60 )
  {
    v4 = a2[1];
