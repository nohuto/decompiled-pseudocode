/*
 * XREFs of ?CreateCVI@CVisualSurface@@AEAAJPEAPEAVCCachedVisualImage@@@Z @ 0x1801F252C
 * Callers:
 ...
 * Callees:
 *     ??0CCachedVisualImage@@IEAA@PEAVCComposition@@@Z @ 0x180032728 (--0CCachedVisualImage@@IEAA@PEAVCComposition@@@Z.c)
