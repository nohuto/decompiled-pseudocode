/*
 * XREFs of ?SetEvent@details@wil@@YAXPEAX@Z @ 0x1800CDF64
 * Callers:
 *     ?ResetMmcss@CGlobalMit@@UEAAJXZ @ 0x1800CDF00 (-ResetMmcss@CGlobalMit@@UEAAJXZ.c)
 *     ?RequestCursorUpdate@CGlobalMit@@UEAAXXZ @ 0x1800CDF40 (-RequestCursorUpdate@CGlobalMit@@UEAAXXZ.c)
