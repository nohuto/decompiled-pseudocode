/*
 * XREFs of ?EnsureDDisplayManager@CDDisplayManager@@QEAAJXZ @ 0x180244454
 * Callers:
            ...
            *((_QWORD *)&g_DDisplayManager + 1) = 0LL;
            ...
            else
            {
              ...
              else
              {
                ...
                v20 = RoGetActivationFactory(v23, &GUID_028d1ebd_933a_5cba_97d8_fe808844d45d, &qword_18034B678);
                v1 = v20;
                if ( v20 < 0 )
