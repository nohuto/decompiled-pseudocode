/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIAccelerator@@@@IEAAKXZ @ 0x18021B56C
 * Callers:
 *     ?Release@?$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ @ 0x18021C5D0 (-Release@-$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ.c)
 * Callees:
