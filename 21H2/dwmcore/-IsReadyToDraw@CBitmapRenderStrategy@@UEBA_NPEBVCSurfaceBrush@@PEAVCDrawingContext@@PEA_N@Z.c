/*
 * XREFs of ?IsReadyToDraw@CBitmapRenderStrategy@@UEBA_NPEBVCSurfaceBrush@@PEAVCDrawingContext@@PEA_N@Z @ 0x1800C96E0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v6 )
    v5 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v6 + 48LL))(v6);
  return v5 != 0;
}
