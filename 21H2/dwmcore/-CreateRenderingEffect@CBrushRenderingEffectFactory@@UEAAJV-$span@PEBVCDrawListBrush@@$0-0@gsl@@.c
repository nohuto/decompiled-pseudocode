/*
 * XREFs of ?CreateRenderingEffect@CBrushRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x180087F90
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  __int64 v12; // rax
  __int64 v13; // rdi
  unsigned __int64 v15[2]; // [rsp+30h] [rbp-28h] BYREF
  ...
  v15[1] = (unsigned __int64)a1 + 16;
  v15[0] = 4LL;
  v16 = v10;
  v12 = CBrushRenderingEffect::CBrushRenderingEffect((__int64)v8, v11, (unsigned __int64 *)&v16, v15);
  v13 = v12;
  if ( v12 )
  {
...
LABEL_8:
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v8, 0LL, 0LL, -2147024882, 0x4Bu);
  }
  return v6;
}
