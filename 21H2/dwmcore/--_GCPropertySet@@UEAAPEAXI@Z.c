/*
 * XREFs of ??_GCPropertySet@@UEAAPEAXI@Z @ 0x180065650
 * Callers:
 *     <none>
 * Callees:
...
CPropertySet *__fastcall CPropertySet::`scalar deleting destructor'(CPropertySet *this, char a2)
{
  ...
  *(_QWORD *)this = &CPropertySet::`vftable';
  if ( v3 && (unsigned int)dword_180344EF0 > 5 && (qword_180344F00 & 1) != 0 && (qword_180344F08 & 1) == qword_180344F08 )
  {
    v11 = 0;
    v9 = &v7;
    v7 = v3;
    v10 = 4;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_180344EF0, (int)&dword_1802E9B95, 0, 0, 3u, &v8);
  }
