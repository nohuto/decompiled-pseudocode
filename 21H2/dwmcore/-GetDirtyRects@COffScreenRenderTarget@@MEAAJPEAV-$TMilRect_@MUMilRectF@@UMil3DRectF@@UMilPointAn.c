/*
 * XREFs of ?GetDirtyRects@COffScreenRenderTarget@@MEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@IPEAI@Z @ 0x180185BB0
 * Callers:
 *     <none>
 * Callees:
