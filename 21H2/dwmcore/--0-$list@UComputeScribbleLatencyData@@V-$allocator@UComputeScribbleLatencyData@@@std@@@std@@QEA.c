/*
 * XREFs of ??0?$list@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@QEAA@XZ @ 0x1800DF0D8
 * Callers:
...
__int128 *std::list<ComputeScribbleLatencyData>::list<ComputeScribbleLatencyData>()
{
  ...
  *v0 = v0;
  v0[1] = v0;
  *(_QWORD *)&xmmword_18034B4A0 = v0;
  return &xmmword_18034B4A0;
}
