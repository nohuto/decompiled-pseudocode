/*
 * XREFs of ?GetInputEffectForAtlasedSurface@CFilterEffect@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEAVCCompositionSurfaceBitmap@@PEAPEAUID2D1Effect@@@Z @ 0x180204EE0
 * Callers:
        ...
        ID2D1Effect **a5)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, CurrentRenderingRealization, 0x31Cu);
  }
  else
  {
    v11 = v39;
    ...
    wil::com_ptr_t<ID3D11ShaderResourceView,wil::err_returncode_policy>::reset(&v35);
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v16, 0x320u);
    }
    else
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0x323u);
      }
      else
      {
        ...
        if ( v20 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0LL, v20, 0x326u);
        }
        else
        {
          v22 = v38;
          ...
          v25 = _mm_cvtsi32_si128(*(_DWORD *)(a3 + 4));
          v26 = (ID2D1Effect *)*((_QWORD *)v23 + 10);
          v27 = (float)*(int *)a3;
          v36 = v26;
          *(float *)v41 = v27;
          v28 = _mm_cvtsi32_si128(*(_DWORD *)(a3 + 8));
          v41[1] = _mm_cvtepi32_ps(v25).m128_u32[0];
          *(float *)v25.m128i_i32 = (float)*(int *)(a3 + 12);
          v41[2] = _mm_cvtepi32_ps(v28).m128_u32[0];
          v41[3] = v25.m128i_i32[0];
          ...
          if ( v29 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0LL, v29, 0x330u);
          }
          else
          {
            ...
            if ( v32 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0LL, v32, 0x338u);
            }
            else
            {
  ...
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>(&v35);
