/*
 * XREFs of ?DrawAsOverlay@CDrawingContext@@QEAA_NPEAVIBitmapResource@@@Z @ 0x18006858C
 * Callers:
 ...
 * Callees:
 *     ?IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ @ 0x18001A2F4 (-IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsInLayer@CDrawingContext@@QEBA_NXZ @ 0x180177984 (-IsInLayer@CDrawingContext@@QEBA_NXZ.c)
