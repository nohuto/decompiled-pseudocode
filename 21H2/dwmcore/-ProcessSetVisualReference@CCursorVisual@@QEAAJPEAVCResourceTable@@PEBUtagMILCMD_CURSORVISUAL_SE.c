/*
 * XREFs of ?ProcessSetVisualReference@CCursorVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CURSORVISUAL_SETVISUALREFERENCE@@@Z @ 0x1801BEBF8
 * Callers:
 ...
 *     ?GetDesktopId@CCursorVisual@@AEAAIPEAVCVisual@@@Z @ 0x1801BEACC (-GetDesktopId@CCursorVisual@@AEAAIPEAVCVisual@@@Z.c)
 */
