/*
 * XREFs of ?Add@CArrayBasedCoverageSet@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@HPEBVCMILMatrix@@@Z @ 0x1801E0B94
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  *(_OWORD *)&v17[4] = v4;
  v16 = 0LL;
  CZOrderedRect::UpdateDeviceRect((CZOrderedRect *)&v16, a4, a3, (__int64)a4);
...
LABEL_7:
  ...
  if ( v8 > *(_DWORD *)(a1 + 20) )
  {
    v13 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0x24u, 1, &v16);
    v9 = v13;
    if ( v13 < 0 )
    {
