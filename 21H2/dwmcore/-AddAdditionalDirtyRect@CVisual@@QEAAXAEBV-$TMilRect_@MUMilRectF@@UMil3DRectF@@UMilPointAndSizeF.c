/*
 * XREFs of ?AddAdditionalDirtyRect@CVisual@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18009BC70
 * Callers:
 ...
 *     ??0CMergedDirtyRect@@QEAA@XZ @ 0x1800D2EF4 (--0CMergedDirtyRect@@QEAA@XZ.c)
