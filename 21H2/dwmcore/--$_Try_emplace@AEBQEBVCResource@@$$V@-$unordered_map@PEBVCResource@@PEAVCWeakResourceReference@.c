 ...
 *     ??0CWeakResourceReference@@AEAA@PEAVCResource@@@Z @ 0x180064FF4 (--0CWeakResourceReference@@AEAA@PEAVCResource@@@Z.c)
        ...
        const unsigned __int8 *a3)
{
  ...
  v10 = (_QWORD *)a1;
  v4 = xmmword_18034B4E0 & std::_Fnv1a_append_bytes(a1, a3, 8uLL);
  while ( 1 )
  {
