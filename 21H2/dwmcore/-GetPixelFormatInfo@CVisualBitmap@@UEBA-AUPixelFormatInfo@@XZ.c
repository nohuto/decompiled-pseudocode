/*
 * XREFs of ?GetPixelFormatInfo@CVisualBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x1802090F0
 * Callers:
 *     ?IsOpaque@CVisualBitmap@@UEBA_NXZ @ 0x1801A1710 (-IsOpaque@CVisualBitmap@@UEBA_NXZ.c)
 * Callees:
