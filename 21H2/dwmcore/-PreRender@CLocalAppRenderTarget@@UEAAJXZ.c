/*
 * XREFs of ?PreRender@CLocalAppRenderTarget@@UEAAJXZ @ 0x18018ACE8
 * Callers:
 *     ?PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F5AB0 (-PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
