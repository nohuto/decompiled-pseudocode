/*
 * XREFs of ?CreateScribble@CSynchronousSuperWetInk@@UEAAJPEAVCD3DDevice@@AEBUDCompWetInkStrokeRenderState@@PEAPEAVCComputeScribble@@@Z @ 0x1801EF770
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v8 >= 0 )
      {
        ...
        *a4 = v17;
        if ( *((_BYTE *)v11 + 12) )
        {
          if ( !*((_BYTE *)this + 136) )
          {
            if ( (unsigned int)dword_180344E48 > 4
              && (qword_180344E58 & 8) != 0
              && (qword_180344E60 & 8) == qword_180344E60 )
            {
              ...
              tlgWriteTransfer_EventWriteTransfer(
                ...
                (unsigned __int8 *)dword_1802E9BC1,
                0LL,
                0LL,
                3u,
                &v33);
            ...
            && (qword_180344E60 & 8) == qword_180344E60 )
          {
            ...
            tlgWriteTransfer_EventWriteTransfer(
              (__int64)&dword_180344E48,
              (unsigned __int8 *)dword_1802E9C0A,
              0LL,
              0LL,
              3u,
              &v33);
