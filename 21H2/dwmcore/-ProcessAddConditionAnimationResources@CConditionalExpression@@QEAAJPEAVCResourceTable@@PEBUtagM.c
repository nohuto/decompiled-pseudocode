/*
 * XREFs of ?ProcessAddConditionAnimationResources@CConditionalExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CONDITIONALEXPRESSION_ADDCONDITIONANIMATIONRESOURCES@@PEBXI@Z @ 0x180211380
 * Callers:
  ...
  if ( *((_DWORD *)a3 + 2) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)&v26 + 1) = v15;
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0x6Au);
        goto LABEL_26;
      }
...
LABEL_24:
    ...
    v17 = -2003303421;
LABEL_25:
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v23, v25);
LABEL_26:
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v26 + 1);
    if ( (_QWORD)v26 )
