/*
 * XREFs of ??$SetProperty@UD2D_MATRIX_3X2_F@@@DataSourcePropertySet@@QEAAJIPEBUD2D_MATRIX_3X2_F@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18017FBA8
 * Callers:
 ...
 * Callees:
 *     ??$AddProperty@UD2D_MATRIX_3X2_F@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2D_MATRIX_3X2_F@@PEAI@Z @ 0x1800BD6BC (--$AddProperty@UD2D_MATRIX_3X2_F@@@-$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAll.c)
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2D_MATRIX_3X2_F>(__int64 a1, int a2, __int64 a3)
{
  ...
  v28 = a2;
  v29 = 0;
  v6 = *(_QWORD *)(a1 + 48) & std::_Fnv1a_append_bytes(a1, (const unsigned __int8 *const)&v28, 4uLL);
  while ( 1 )
  {
...
LABEL_6:
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v15) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v19) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    v23 = *(_QWORD *)(v22 + 32);
    v24 = *(_DWORD *)(v21 + 8 * v20 + 4) & 0x1FFFFFFF;
    *(_OWORD *)(v24 + v23) = v17;
    *(_QWORD *)(v24 + v23 + 16) = v18;
  }
  return 0LL;
}
