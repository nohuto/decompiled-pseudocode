/*
 * XREFs of ?PropertyChanged@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180182AF4
 * Callers:
...
LABEL_3:
  ...
  return CoreUICallSend(v5, v8, 2LL, 0LL, 3, &unk_1802DA35A);
}
