/*
 * XREFs of ?AnalyzeLatencyInformation@CTelemetryTouchLatencyAnalysis@@AEAAX_K0000000III0AEBUVAIL_TELEMETRY_TOUCH_INFO@1@@Z @ 0x1800230E8
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U1@U?$_tlgWrapSz@G@@U3@U2@U?$_tlgWrapperByRef@$0BA@@@U2@U2@U2@U2@U?$_tlgWrapperByVal@$07@@U2@U?$_tlgWrapperByVal@$01@@U6@U5@U5@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@3AEBU?$_tlgWrapSz@G@@54AEBU?$_tlgWrapperByRef@$0BA@@@4444AEBU?$_tlgWrapperByVal@$07@@4AEBU?$_tlgWrapperByVal@$01@@877@Z @ 0x18015AF94 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U1@U-$_tlgWrapSz@G_ea_18015AF94.c)
 ...
 *     ?FrameLatencies@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@II_KAEBVCLatencyInfo@3@@Z @ 0x18015E14C (-FrameLatencies@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysi.c)
  ...
  if ( a8 >= a3 )
  {
    if ( a8 )
    {
      ...
      if ( Scenario )
      {
        ...
        v43 = 0LL;
        v44 = 0LL;
        v27 = qword_180347420 / 0x3E8uLL;
        v28 = (a7 - a6) % (qword_180347420 / 0x3E8uLL);
        v29 = *((_DWORD *)Scenario + 24) == 2;
        HIDWORD(v45) = (a7 - a6) / (qword_180347420 / 0x3E8uLL);
        if ( !v29 )
        {
          LODWORD(v43) = (v14 - a3) / v27;
          DWORD1(v43) = (a4 - a3) / (qword_180347420 / 0xF4240uLL);
          HIDWORD(v44) = (a5 - a4) / (qword_180347420 / 0xF4240uLL);
          ...
          if ( v30 )
          {
            v26 = qword_180347420 / 0xF4240uLL;
            DWORD2(v43) = (*(_QWORD *)a14 - a3) / (qword_180347420 / 0xF4240uLL);
            HIDWORD(v43) = (*((_QWORD *)a14 + 1) - *(_QWORD *)a14) / (qword_180347420 / 0xF4240uLL);
            v28 = (a4 - *((_QWORD *)a14 + 1)) % (qword_180347420 / 0xF4240uLL);
            LODWORD(v44) = (a4 - *((_QWORD *)a14 + 1)) / (qword_180347420 / 0xF4240uLL);
          }
        }
        v31 = v40;
        if ( v40 )
