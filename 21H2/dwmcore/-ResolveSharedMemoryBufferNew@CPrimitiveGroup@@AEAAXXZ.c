/*
 * XREFs of ?ResolveSharedMemoryBufferNew@CPrimitiveGroup@@AEAAXXZ @ 0x18010453C
 * Callers:
...
void __fastcall CPrimitiveGroup::ResolveSharedMemoryBufferNew(CPrimitiveGroup *this)
{
