/*
 * XREFs of ?Create@MeshGraph@Mesh@@SAJHHHHPEAPEAU12@@Z @ 0x180063210
 * Callers:
 ...
 *     ??0MeshLine@Mesh@@QEAA@XZ @ 0x1800E26A4 (--0MeshLine@Mesh@@QEAA@XZ.c)
 *     ??0MeshVertex@Mesh@@QEAA@XZ @ 0x1800E26BC (--0MeshVertex@Mesh@@QEAA@XZ.c)
