/*
 * XREFs of ?IsIncludedInOverdrawContentKinds@CContent@@AEAA_NW4FlagsEnum@MilHeatMapOverdrawContentKinds@@PEAVCDrawingContext@@@Z @ 0x1801FE690
 * Callers:
...
bool __fastcall CContent::IsIncludedInOverdrawContentKinds(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( a2 != 0xFFFF
    ...
    && ((v4 & 0x10) == 0 || *(_DWORD *)(a3 + 624) || !*(_DWORD *)(a3 + 552))
