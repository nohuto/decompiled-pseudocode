/*
 * XREFs of ?GetProperty@CNaturalAnimation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180226750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  v3 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147024809, 0x284u);
  return v3;
}
