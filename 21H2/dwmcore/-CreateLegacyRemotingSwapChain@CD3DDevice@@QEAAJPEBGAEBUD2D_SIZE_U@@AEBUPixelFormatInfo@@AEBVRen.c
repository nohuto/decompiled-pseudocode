/*
 * XREFs of ?CreateLegacyRemotingSwapChain@CD3DDevice@@QEAAJPEBGAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVILegacyRemotingSwapChain@@@Z @ 0x1800E4244
 * Callers:
...
LABEL_30:
      v28 = v12;
LABEL_32:
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802ACF50, 2u, v28, v30, 0LL);
      goto LABEL_5;
    }
LABEL_4:
  ...
  *(_QWORD *)&v34 = "DWM LegacyRemoting SwapChain";
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_1802ACF50, 2u, v19, 0x5Cu, 0LL);
...
LABEL_20:
    v24 = v15;
LABEL_21:
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802ACF50, 2u, v24, v29, 0LL);
    wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v31);
    goto LABEL_5;
  }
  SetLastError(0);
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_1802ACF50, 2u, v25, 0x73u, 0LL);
  wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v31);
  v9 = (char *)hObject;
LABEL_6:
