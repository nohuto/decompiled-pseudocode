/*
 * XREFs of ??$PropertyUpdated@U_D3DCOLORVALUE@@@CPropertySet@@AEAAJIIPEBU_D3DCOLORVALUE@@@Z @ 0x1800EBC70
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<_D3DCOLORVALUE>(CResource *this, __int64 a2, int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
