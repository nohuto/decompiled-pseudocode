/*
 * XREFs of ??$SetProperty@U_D3DCOLORVALUE@@@DataSourcePropertySet@@QEAAJIPEBU_D3DCOLORVALUE@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18017FD24
 * Callers:
 *     ?SetColorValue@DataSourceProxy@@MEAAJIMMMM@Z @ 0x180180E40 (-SetColorValue@DataSourceProxy@@MEAAJIMMMM@Z.c)
 * Callees:
 *     ??$AddProperty@UD2DVector4@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector4@@PEAI@Z @ 0x1800BD854 (--$AddProperty@UD2DVector4@@@-$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator.c)
...
__int64 __fastcall DataSourcePropertySet::SetProperty<_D3DCOLORVALUE>(__int64 a1, int a2, __int128 *a3)
{
  ...
  v25 = a2;
  v26 = 0;
  v6 = *(_QWORD *)(a1 + 48) & std::_Fnv1a_append_bytes(a1, (const unsigned __int8 *const)&v25, 4uLL);
  while ( 1 )
  {
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(v10, 70, a3, &v26);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v15) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v18) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    *(_OWORD *)((*(_DWORD *)(v20 + 8 * v19 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v21 + 32)) = v17;
  }
  return 0LL;
}
