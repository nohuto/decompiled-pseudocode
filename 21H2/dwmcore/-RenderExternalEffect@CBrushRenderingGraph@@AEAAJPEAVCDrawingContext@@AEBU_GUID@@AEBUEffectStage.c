/*
 * XREFs of ?RenderExternalEffect@CBrushRenderingGraph@@AEAAJPEAVCDrawingContext@@AEBU_GUID@@AEBUEffectStage@@AEBUIntermediateConfigurationInputs@1@PEAUEffectInput@@@Z @ 0x18003FAE8
 * Callers:
 ...
 *     ?DetermineOutputScale@CCustomBlur@@SAMMMW4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z @ 0x1800402E4 (-DetermineOutputScale@CCustomBlur@@SAMMMW4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z.c)
        ...
        struct EffectInput *a6)
{
  ...
  *(__m128 *)v72 = v9;
  ...
  if ( D2DBitmap < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802DC178, 2u, D2DBitmap, 0x20Eu, 0LL);
    goto LABEL_30;
  }
  ...
  if ( v34 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v35, &dword_1802DC178, 2u, v34, 0x24Au, 0LL);
    v7 = v76[0];
    goto LABEL_30;
  }
  ...
  else
  {
    ...
    if ( v43 >= 0 )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        if ( v48 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v49, &dword_1802DC178, 2u, v48, 0x2A7u, 0LL);
        }
        else
        {
          ...
          if ( v50 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v51, &dword_1802DC178, 2u, v50, 0x2AAu, 0LL);
          }
          else
          {
            v52 = *((_DWORD *)a4 + 18);
...
LABEL_40:
  v62 = v43;
LABEL_47:
  MilInstrumentationCheckHR_MaybeFailFast(v40, &dword_1802DC178, 2u, v62, v65, 0LL);
