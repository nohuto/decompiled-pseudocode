/*
 * XREFs of ?InteractionContextCallback@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x180230C1C
 * Callers:
 *     ?s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@@@Z @ 0x180231C10 (-s_InteractionContextCallback@CInteractionContextWrapper@@CAXPEAXPEBUINTERACTION_CONTEXT_OUTPUT@.c)
 * Callees:
        ...
        const struct INTERACTION_CONTEXT_OUTPUT *a2)
{
  ...
  *((_BYTE *)this + 156) = 1;
  if ( (unsigned int)dword_180344EF0 <= 4 )
    return;
  v11 = qword_180344F08;
  if ( (qword_180344F00 & 2) != 0 && (qword_180344F08 & 2) == qword_180344F08 )
  {
    v16 = *((_DWORD *)this + 13);
    v17 = HIDWORD(v28);
    v18 = v27;
...
LABEL_16:
  ...
  if ( (unsigned int)dword_180344EF0 > 4 && (qword_180344F00 & 2) != 0 && (v11 & 2) == v11 )
  {
    v12 = *((_BYTE *)this + 88) & 1;
    v13 = v10;
    v15 = v12;
