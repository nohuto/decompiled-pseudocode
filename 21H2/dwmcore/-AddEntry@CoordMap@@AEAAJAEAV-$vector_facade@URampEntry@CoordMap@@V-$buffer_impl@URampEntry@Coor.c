/*
 * XREFs of ?AddEntry@CoordMap@@AEAAJAEAV?$vector_facade@URampEntry@CoordMap@@V?$buffer_impl@URampEntry@CoordMap@@$09$00Vliberal_expansion_policy@detail@@@detail@@@detail@@HAEBURampPair@1@W4RampMergeMode@1@@Z @ 0x18005A770
 * Callers:
...
__int64 __fastcall CoordMap::AddEntry(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( !*(_DWORD *)(v5 + 8 * v11 + 12) )
  {
    ...
    {
      v12 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024809, 0x5Bu, 0LL);
      return v12;
    }
    v6 = 1;
  }
