/*
 * XREFs of ?GetBspPolygonList@CVisual@@QEBAPEAV?$DynArray@PEAVCPolygon@@$0A@@@XZ @ 0x18009F4BC
 * Callers:
 ...
 *     ?GetBspPolygonListCount@CVisual@@IEBAIXZ @ 0x1801ADA24 (-GetBspPolygonListCount@CVisual@@IEBAIXZ.c)
