/*
 * XREFs of ?SetSize@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector2Behavior@@@Z @ 0x1801732C8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[18] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x2EAu, 0LL);
    }
    else
    {
