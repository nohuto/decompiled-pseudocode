/*
 * XREFs of ?Render@CDrawListCache@@QEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@MW4Enum@MilCompositingMode@@@Z @ 0x18008D4E0
 * Callers:
...
LABEL_9:
      if ( v14 )
      {
        if ( v14 == 1 )
        {
          v17 = *(_QWORD *)(detail::pointer_buffer_impl<CDrawListEntry *>::first(a1 + 32) - 16);
        }
        else
        {
