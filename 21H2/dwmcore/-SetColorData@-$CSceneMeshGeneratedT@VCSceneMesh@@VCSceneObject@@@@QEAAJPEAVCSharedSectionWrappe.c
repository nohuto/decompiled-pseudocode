/*
 * XREFs of ?SetColorData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801708F0
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[16] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA88u, 0LL);
    }
    else
    {
