/*
 * XREFs of ?SetColorData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801A260C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[17] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0xAF3u);
    }
    else
    {
