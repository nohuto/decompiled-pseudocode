/*
 * XREFs of ?TimeoutOverdueScenarios@CTelemetryTouchLatencyAnalysis@@QEAAX_K@Z @ 0x18001A480
 * Callers:
 ...
 *     ?TimeoutOverdueScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_K1@Z @ 0x180161428 (-TimeoutOverdueScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatenc.c)
 */
        ...
        unsigned __int64 a2)
{
  ...
  if ( *(_DWORD *)this )
  {
    ...
    do
    {
      if ( *((_QWORD *)v4 + 4) )
      {
        if ( (unsigned int)((v6 - *((_QWORD *)v4 + 48)) / (qword_180347420 / 0x3E8uLL)) >= 0xFA0 )
        {
