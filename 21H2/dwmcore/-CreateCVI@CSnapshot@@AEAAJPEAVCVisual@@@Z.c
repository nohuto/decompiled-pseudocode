/*
 * XREFs of ?CreateCVI@CSnapshot@@AEAAJPEAVCVisual@@@Z @ 0x180244B2C
 * Callers:
...
__int64 __fastcall CSnapshot::CreateCVI(CSnapshot *this, struct CVisual *a2)
{
  ...
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, -2147024882, 0x17u);
    goto LABEL_16;
  }
  ...
  if ( *((_DWORD *)this + 20) )
  {
    if ( *((_DWORD *)this + 21) )
    {
      ...
      if ( v8 < 0 )
      {
        v12 = 33;
LABEL_15:
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0LL, v8, v12);
        goto LABEL_16;
      }
    }
  }
