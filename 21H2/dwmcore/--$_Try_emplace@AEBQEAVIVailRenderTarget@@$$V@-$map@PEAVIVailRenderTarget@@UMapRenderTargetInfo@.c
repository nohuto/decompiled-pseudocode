/*
 * XREFs of ??$_Try_emplace@AEBQEAVIVailRenderTarget@@$$V@?$map@PEAVIVailRenderTarget@@UMapRenderTargetInfo@InteractionLatencyTelemetry@@U?$less@PEAVIVailRenderTarget@@@std@@V?$allocator@U?$pair@QEAVIVailRenderTarget@@UMapRenderTargetInfo@InteractionLatencyTelemetry@@@std@@@5@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@QEAVIVailRenderTarget@@UMapRenderTargetInfo@InteractionLatencyTelemetry@@@std@@PEAX@std@@_N@1@AEBQEAVIVailRenderTarget@@@Z @ 0x1801D1940
 * Callers:
...
__int64 __fastcall std::map<IVailRenderTarget *,InteractionLatencyTelemetry::MapRenderTargetInfo>::_Try_emplace<IVailRenderTarget * const &,>(
        __int64 *a1,
        __int64 a2,
        unsigned __int64 *a3)
{
