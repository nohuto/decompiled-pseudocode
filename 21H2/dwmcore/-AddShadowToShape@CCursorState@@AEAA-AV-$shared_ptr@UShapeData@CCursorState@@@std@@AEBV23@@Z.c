/*
 * XREFs of ?AddShadowToShape@CCursorState@@AEAA?AV?$shared_ptr@UShapeData@CCursorState@@@std@@AEBV23@@Z @ 0x180268E4C
 * Callers:
...
_QWORD *__fastcall CCursorState::AddShadowToShape(CDeviceManager *a1, _QWORD *a2, _QWORD **a3)
{
  ...
  *(_QWORD *)&v37.left = 0LL;
  if ( CDeviceManager::GetWarpDevice(a1, (struct CD3DDevice **)&v37) >= 0 )
  {
    ...
    if ( CD2DContext::CreateD2DEffect((CD2DContext *)(*(_QWORD *)&v37.left + 16LL), &CLSID_D2D1Shadow, &v28) >= 0 )
    {
      v8 = v28;
      ...
      if ( CD2DContext::CreateD2DEffect(v7, &CLSID_D2D12DAffineTransform, &v28) >= 0 )
      {
        v10 = v28;
        (*(void (__fastcall **)(_QWORD))(**((_QWORD **)v28 + 10) + 8LL))(*((_QWORD *)v28 + 10));
        v34 = 0LL;
        ...
        if ( CD2DContext::CreateD2DEffect(v7, &CLSID_D2D1Composite, &v28) >= 0 )
        {
          v12 = v28;
          (*(void (__fastcall **)(_QWORD))(**((_QWORD **)v28 + 10) + 8LL))(*((_QWORD *)v28 + 10));
              ...
              *(_QWORD *)&v40 = "Cursor Shadow";
              if ( (int)CD3DDevice::CreateRenderTargetBitmap(
                ...
                || (v16 = v31,
                    ...
                    (int)CD2DContext::PushTarget(v7, 0LL, v17) < 0) )
              {
                *a2 = 0LL;
                a2[1] = 0LL;
              }
