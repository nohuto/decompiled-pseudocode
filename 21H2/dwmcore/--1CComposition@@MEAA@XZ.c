/*
 * XREFs of ??1CComposition@@MEAA@XZ @ 0x180154FA0
 * Callers:
 ...
 *     ?UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ @ 0x18015603C (-UnmapDeferredSharedSectionViews@CComposition@@IEAAXXZ.c)
