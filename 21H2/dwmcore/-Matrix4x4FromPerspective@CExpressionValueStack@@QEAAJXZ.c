/*
 * XREFs of ?Matrix4x4FromPerspective@CExpressionValueStack@@QEAAJXZ @ 0x1801FE1D4
 * Callers:
 ...
 *     ?D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z @ 0x18021D050 (-D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z.c)
 */
    ...
    if ( v8[18] == 18 )
    {
      if ( *((_DWORD *)v11 + 18) == 18 )
      {
        if ( *((_DWORD *)v14 + 18) == 18 )
        {
          if ( *((_DWORD *)v6 + 18) == 18 )
          {
            if ( D2DMatrixPerspectiveRH((struct D2DMatrix *)v19, *(float *)v8, *v11, *v14, *v6) )
            {
              v16 = v19[0];
              v8[18] = 265;
              *(_OWORD *)v8 = v16;
