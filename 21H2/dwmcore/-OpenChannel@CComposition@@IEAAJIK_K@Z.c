/*
 * XREFs of ?OpenChannel@CComposition@@IEAAJIK_K@Z @ 0x180034C68
 * Callers:
...
__int64 __fastcall CComposition::OpenChannel(CComposition *this, unsigned int a2, unsigned int a3, unsigned __int64 a4)
{
  ...
  v15 = 0LL;
  if ( a2 >= 0x10000
    || (v6 = (_QWORD *)((char *)this + 296), a2 < *((_DWORD *)this + 80)) && *(_QWORD *)(*v6 + 8LL * a2) )
  {
    v8 = -2147024809;
    v13 = -2147024809;
    v14 = 1780;
  ...
  v7 = CChannelContext::Create(a2, a3, a4, *((struct CConnection **)this + 64), &v15);
  v8 = v7;
  if ( v7 < 0 )
  {
    v14 = 1790;
