/*
 * XREFs of ?Update@CSecondarySysmemBitmap@@QEAAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@@Z @ 0x18006D198
 * Callers:
...
__int64 __fastcall CSecondarySysmemBitmap::Update(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v6 = 0;
  if ( !TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::DoesContain(a1 + 32, a2, (__int64)a3)
...
LABEL_13:
  ...
  v11 = *(_DWORD *)(a1 + 128) * *(_DWORD *)(a2 + 4) + *(_DWORD *)a2 * (GetPixelFormatSize(v9) >> 3);
  ...
  CSecondaryBitmap::AddValidRect(a1 + 32, (const struct MilRectU *)a2);
  return v6;
}
