/*
 * XREFs of ?s_RenderThreadTelemetryEndpointProc@CManipulationManager@@KAJPEAXPEBXH@Z @ 0x180180B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CManipulationManager::s_RenderThreadTelemetryEndpointProc(char *a1, const void *a2)
{
  unsigned int v4; // ebx
