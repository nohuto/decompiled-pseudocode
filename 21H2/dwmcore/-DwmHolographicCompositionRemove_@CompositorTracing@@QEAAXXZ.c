/*
 * XREFs of ?DwmHolographicCompositionRemove_@CompositorTracing@@QEAAXXZ @ 0x18025312C
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicCompositionRemove_(CompositorTracing *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802ED6D9, 0LL, 0LL, 2u, &v2);
  }
}
