/*
 * XREFs of ?BeginFigure@CTransformedGeometryHelper@@EEAAXUD2D_POINT_2F@@W4D2D1_FIGURE_BEGIN@@@Z @ 0x180016D40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CTransformedGeometryHelper::BeginFigure(CMILMatrix **this, struct D2D_POINT_2F a2, unsigned int a3)
{
  ...
  v5[0] = a2;
  CMILMatrix::Transform(this[2], (const struct MilPoint2F *)v5, (struct MilPoint2F *)v5, 1);
