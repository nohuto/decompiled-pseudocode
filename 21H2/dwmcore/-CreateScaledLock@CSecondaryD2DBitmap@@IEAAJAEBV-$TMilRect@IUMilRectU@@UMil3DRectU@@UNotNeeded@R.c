/*
 * XREFs of ?CreateScaledLock@CSecondaryD2DBitmap@@IEAAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@PEAPEAVIBitmapLock@@@Z @ 0x1802A6ADC
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0LL, v14, 0x90u);
  }
  else
  {
    ...
    else
    {
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0LL, v19, 0x97u);
      }
      else
      {
        v21 = v57;
        ...
        if ( v25 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0LL, v25, 0xA1u);
        }
        else
        {
          if ( v51 )
          ...
          if ( v28 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0LL, v28, 0xA3u);
          }
          else
          {
            ...
            if ( ImagingFactory < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0LL, ImagingFactory, 0xA5u);
            }
            else
            {
              v32 = v54;
              ...
              if ( v34 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0LL, v34, 0xA7u);
              }
              else
              {
                ...
                if ( v36 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0LL, v36, 0xADu);
                }
                else
                {
                  if ( v50 )
                  ...
                  if ( v39 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0LL, v39, 0xB1u);
                  }
                  else
                  {
                    ...
                    if ( v42 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v43, 0LL, 0LL, v42, 0xB3u);
                    }
                    else
                    {
                      ...
                      v16 = v44;
                      if ( v44 < 0 )
                        MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0LL, v44, 0xB7u);
                    }
                  }
                }
              }
  ...
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>(&v49);
