/*
 * XREFs of std::transform_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_tagRECT______std::back_insert_iterator_std::vector_tagRECT_std::allocator_tagRECT_______lambda_6991071fcff892ffb13e08e0d7abc234___ @ 0x1801AF264
 * Callers:
 ...
 *     ??$_Emplace_reallocate@UtagRECT@@@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@QEAAPEAUtagRECT@@QEAU2@$$QEAU2@@Z @ 0x1801AF078 (--$_Emplace_reallocate@UtagRECT@@@-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std@@QEAAPEAU.c)
 */
        ...
        __int64 a5)
{
  ...
  if ( a2 != a3 )
  {
    ...
    do
    {
      ...
      v14[3] = v11;
      v15 = 0LL;
      CDrawingContext::CalcWorldSpaceClippedBounds(a5, (__int64)v14, (__int64)&v15);
      PixelAlign(&v16, (__int64)&v15);
      v12 = (_BYTE *)a4[1];
      if ( v12 == (_BYTE *)a4[2] )
      {
