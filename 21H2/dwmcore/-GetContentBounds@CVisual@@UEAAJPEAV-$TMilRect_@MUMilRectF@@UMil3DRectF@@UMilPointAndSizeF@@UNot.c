/*
 * XREFs of ?GetContentBounds@CVisual@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800677A0
 * Callers:
...
__int64 __fastcall CVisual::GetContentBounds(char *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v4 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xEACu, 0LL);
  }
  if ( (*(unsigned __int8 (__fastcall **)(char *))(*(_QWORD *)a1 + 296LL))(a1) )
  {
    v6 = *((_QWORD *)a1 + 27);
