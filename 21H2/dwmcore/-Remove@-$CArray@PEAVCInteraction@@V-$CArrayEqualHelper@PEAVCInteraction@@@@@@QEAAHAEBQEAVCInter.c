/*
 * XREFs of ?Remove@?$CArray@PEAVCInteraction@@V?$CArrayEqualHelper@PEAVCInteraction@@@@@@QEAAHAEBQEAVCInteraction@@@Z @ 0x1801C6C20
 * Callers:
...
LABEL_5:
  ...
  else
  {
    ...
    while ( *(_QWORD *)((char *)CInteraction::s_DefaultStateLockedInteractions + v5) != *a2 )
    {
      ++v3;
      v5 += 8LL;
      if ( v3 >= dword_18034B4F8 )
        goto LABEL_5;
    }
  }
  if ( v3 == -1 )
    return 0LL;
  if ( v3 < 0 || v3 + 1 > dword_18034B4F8 )
  {
    return 0;
  }
  else
  {
    if ( v3 + 1 != dword_18034B4F8 )
    {
      memmove_0(
        (char *)CInteraction::s_DefaultStateLockedInteractions + 8 * v3,
        (char *)CInteraction::s_DefaultStateLockedInteractions + 8 * v3 + 8,
        8LL * (dword_18034B4F8 - v3 - 1));
      v2 = dword_18034B4F8;
    }
    dword_18034B4F8 = v2 - 1;
  }
  return v4;
}
