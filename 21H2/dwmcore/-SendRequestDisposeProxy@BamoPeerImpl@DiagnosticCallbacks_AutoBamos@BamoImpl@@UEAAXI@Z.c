/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180166FC0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl *this)
{
  ...
  v3 = CoreUICallSend(v2, v4, 2LL, 1LL, 5, &unk_1802DA372);
  if ( v3 < 0 )
  {
