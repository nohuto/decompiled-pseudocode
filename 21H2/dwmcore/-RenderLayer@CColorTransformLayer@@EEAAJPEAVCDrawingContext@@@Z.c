/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x1801D8880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorTransformLayer::RenderLayer(CColorTransformLayer *this, struct CDrawingContext *a2)
{
  ...
  __m128 v18; // xmm5
  __m128 v19; // xmm6
  __int64 (__fastcall ***v20)(_QWORD, struct D2D_RECT_F *); // rcx
  ...
  struct ID2D1Effect *v35; // [rsp+30h] [rbp-D0h] BYREF
  __int64 v36; // [rsp+38h] [rbp-C8h] BYREF
  int v37; // [rsp+40h] [rbp-C0h] BYREF
  __int128 v38; // [rsp+44h] [rbp-BCh]
  __int128 v39; // [rsp+54h] [rbp-ACh]
  int v40; // [rsp+64h] [rbp-9Ch]
  struct D2D_RECT_F v41; // [rsp+E0h] [rbp-20h] BYREF
  _DWORD v42[15]; // [rsp+F0h] [rbp-10h] BYREF
  unsigned __int32 v43; // [rsp+12Ch] [rbp+2Ch]
  __int32 v44; // [rsp+130h] [rbp+30h]
  unsigned __int32 v45; // [rsp+134h] [rbp+34h]
  unsigned __int32 v46; // [rsp+138h] [rbp+38h]
  unsigned __int32 v47; // [rsp+13Ch] [rbp+3Ch]
  ...
  wil::com_ptr_t<ID3D11ShaderResourceView,wil::err_returncode_policy>::reset(&v36);
  v7 = v6(v2, &v36, 0LL);
  v9 = v7;
  if ( v7 < 0 )
  {
  ...
  CachedEffectNoRef = CD2DContext::GetCachedEffectNoRef(*((_QWORD *)a2 + 5) + 16LL, 0, &v35);
  v9 = CachedEffectNoRef;
  if ( CachedEffectNoRef < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, CachedEffectNoRef, 0x37u);
    goto LABEL_20;
  }
  v37 = 10;
  *(_QWORD *)&v38 = 0x1FF000000LL;
  v7 = CDrawingContext::PushRenderOptionsInternal(a2, 0LL, (const struct MilRenderOptions *)&v37, 1);
  v9 = v7;
  if ( v7 < 0 )
  {
    v34 = 70;
LABEL_19:
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, v34);
    goto LABEL_20;
  }
  v12 = (__m128 *)*((_QWORD *)this + 15);
  v13 = *((_QWORD *)this + 1);
  v14 = v12[4];
  v15 = v12[5];
  v16 = v12[9];
  ...
  v20 = (__int64 (__fastcall ***)(_QWORD, struct D2D_RECT_F *))(v13 + 8 + *(int *)(*(_QWORD *)(v13 + 8) + 12LL));
  if ( *(_DWORD *)((**v20)(v20, &v41) + 4) == 3 )
  {
    v43 = 0;
    v47 = (unsigned int)FLOAT_1_0;
  }
  v21 = v35;
  v22 = (*(__int64 (__fastcall **)(struct ID2D1Effect *, _QWORD, _QWORD, _DWORD *, int))(*(_QWORD *)v35 + 72LL))(
          v35,
          0LL,
          0LL,
          v42,
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0LL, v22, 0x6Fu);
  }
  else
  {
    LODWORD(v35) = 2;
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0LL, v24, 0x72u);
    }
    else
    {
      ...
      v41.left = 0.0;
      v41.top = 0.0;
      LODWORD(v41.right) = _mm_cvtepi32_ps(v28).m128_u32[0];
      v30 = _mm_cvtsi32_si128(*((_DWORD *)this + 4));
      LODWORD(v41.bottom) = _mm_cvtepi32_ps(v29).m128_u32[0];
      *(float *)v29.m128i_i32 = (float)*((int *)this + 5);
      LODWORD(v35) = _mm_cvtepi32_ps(v30).m128_u32[0];
      HIDWORD(v35) = v29.m128i_i32[0];
      v31 = CDrawingContext::FillEffect(a2, v21, &v41, (const struct D2D_POINT_2F *)&v35, 1);
      v9 = v31;
      if ( v31 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0LL, v31, 0x8Cu);
...
LABEL_20:
  wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>(&v36);
  return v9;
}
