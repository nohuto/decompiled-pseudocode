/*
 * XREFs of ?ReleasePrimitiveCaches@CPrimitiveGroup@@AEAAX_N@Z @ 0x180059C74
 * Callers:
 ...
 *     ?ReleaseHeatMap@CPrimitiveGroup@@AEAAXXZ @ 0x1800D5FB4 (-ReleaseHeatMap@CPrimitiveGroup@@AEAAXXZ.c)
