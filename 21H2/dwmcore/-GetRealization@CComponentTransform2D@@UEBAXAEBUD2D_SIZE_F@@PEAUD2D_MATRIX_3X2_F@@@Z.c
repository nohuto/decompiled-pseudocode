/*
 * XREFs of ?GetRealization@CComponentTransform2D@@UEBAXAEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x180081280
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D2D_MATRIX_3X2_F *a3)
{
  ...
  LODWORD(v5) = COERCE_UNSIGNED_INT(*((float *)this + 38) * a2->width) ^ _xmm;
  LODWORD(v6) = COERCE_UNSIGNED_INT(*((float *)this + 39) * a2->height) ^ _xmm;
