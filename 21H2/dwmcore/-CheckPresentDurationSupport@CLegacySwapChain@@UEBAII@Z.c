/*
 * XREFs of ?CheckPresentDurationSupport@CLegacySwapChain@@UEBAII@Z @ 0x180249834
 * Callers:
 *     ?CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z @ 0x1800F74B0 (-CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z.c)
 * Callees:
