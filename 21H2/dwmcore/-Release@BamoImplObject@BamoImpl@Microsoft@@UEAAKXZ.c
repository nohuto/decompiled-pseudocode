/*
 * XREFs of ?Release@BamoImplObject@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D7510
 * Callers:
 ...
 *     ?Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D7500 (-Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ.c)
