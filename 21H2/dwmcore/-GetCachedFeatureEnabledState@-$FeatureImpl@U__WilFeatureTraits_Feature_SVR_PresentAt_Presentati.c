/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SVR_PresentAt_PresentationHandler@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180248A20
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SVR_PresentAt_PresentationHandler@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180248CDC (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_SVR_PresentAt_Presentat.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_SVR_PresentAt_PresentationHandler>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_SVR_PresentAt_PresentationHandler>::GetCurrentFeatureEnabledState(
      a1,
      &v15,
      &i);
    v6 = *a2;
