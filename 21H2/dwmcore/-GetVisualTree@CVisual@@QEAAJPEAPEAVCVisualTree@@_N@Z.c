/*
 * XREFs of ?GetVisualTree@CVisual@@QEAAJPEAPEAVCVisualTree@@_N@Z @ 0x18003E078
 * Callers:
 ...
 * Callees:
 *     ?GetVisualTreeNoRef@CVisual@@QEBAPEAVCVisualTree@@XZ @ 0x18003E15C (-GetVisualTreeNoRef@CVisual@@QEBAPEAVCVisualTree@@XZ.c)
