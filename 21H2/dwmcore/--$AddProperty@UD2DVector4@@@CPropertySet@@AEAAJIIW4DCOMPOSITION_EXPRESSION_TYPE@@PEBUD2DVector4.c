/*
 * XREFs of ??$AddProperty@UD2DVector4@@@CPropertySet@@AEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector4@@@Z @ 0x180237D30
 * Callers:
...
__int64 __fastcall CPropertySet::AddProperty<D2DVector4>(CResource *this, unsigned int a2, int a3, int a4, _OWORD *a5)
{
  __int64 v5; // rdi
  _QWORD *v6; // rsi
  int v9; // eax
