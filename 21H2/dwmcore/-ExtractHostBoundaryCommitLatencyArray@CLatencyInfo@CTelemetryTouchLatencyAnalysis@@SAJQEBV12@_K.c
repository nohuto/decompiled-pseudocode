/*
 * XREFs of ?ExtractHostBoundaryCommitLatencyArray@CLatencyInfo@CTelemetryTouchLatencyAnalysis@@SAJQEBV12@_KQEAI1@Z @ 0x18015D764
 * Callers:
...
__int64 __fastcall CTelemetryTouchLatencyAnalysis::CLatencyInfo::ExtractHostBoundaryCommitLatencyArray(
