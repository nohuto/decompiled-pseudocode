/*
 * XREFs of ?HrFindInterface@CBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180068B70
 * Callers:
 *     ?HrFindInterface@CSystemMemoryBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC4B0 (-HrFindInterface@CSystemMemoryBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 ...
 * Callees:
 *     ??8@YA_NAEBU_GUID@@0@Z @ 0x180068C38 (--8@YA_NAEBU_GUID@@0@Z.c)
 */
