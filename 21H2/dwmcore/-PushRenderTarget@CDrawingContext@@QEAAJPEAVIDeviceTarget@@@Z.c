/*
 * XREFs of ?PushRenderTarget@CDrawingContext@@QEAAJPEAVIDeviceTarget@@@Z @ 0x180076494
 * Callers:
...
LABEL_91:
  ...
  *((_BYTE *)this + 5954) = 1;
  ...
  if ( *((_DWORD *)this + 140) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v47, 0LL, 0, v46, 0x1005u, 0LL);
  }
  else
  {
LABEL_5:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v11, 0xFF0u, 0LL);
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v11, 0xB85u, 0LL);
  }
  else
  {
    *(_QWORD *)&v61 = 0LL;
    ...
    *(_QWORD *)&v65 = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v52, 0LL, 0, v11, 0xB90u, 0LL);
  }
LABEL_17:
  if ( v11 < 0 )
  {
