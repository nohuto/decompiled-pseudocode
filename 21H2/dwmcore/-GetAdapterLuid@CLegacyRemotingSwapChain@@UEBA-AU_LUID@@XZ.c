/*
 * XREFs of ?GetAdapterLuid@CLegacyRemotingSwapChain@@UEBA?AU_LUID@@XZ @ 0x180251EF0
 * Callers:
 *     ?GetAdapterLuid@CLegacyRemotingSwapChain@@$4PPPPPPPM@A@EBA?AU_LUID@@XZ @ 0x1800F8420 (-GetAdapterLuid@CLegacyRemotingSwapChain@@$4PPPPPPPM@A@EBA-AU_LUID@@XZ.c)
 * Callees:
