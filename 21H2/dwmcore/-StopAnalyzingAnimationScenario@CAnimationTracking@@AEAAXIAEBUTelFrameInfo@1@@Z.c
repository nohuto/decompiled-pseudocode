/*
 * XREFs of ?StopAnalyzingAnimationScenario@CAnimationTracking@@AEAAXIAEBUTelFrameInfo@1@@Z @ 0x1800B0708
 * Callers:
 ...
 *     ?GetScenarioDetails@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@QEBAPEBGXZ @ 0x1800B1E18 (-GetScenarioDetails@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@QEBAPEBGXZ.c)
    ...
    *(_QWORD *)v63 = v10 * (unsigned __int64)v7 / 0x2710;
    ...
    if ( ScenarioName )
    {
      ...
      if ( wcsncmp(ScenarioName, String2, v23)
        && (unsigned int)dword_180344EB8 > 5
        && (qword_180344EC8 & 0x200000000004LL) != 0
        && (qword_180344ED0 & 0x200000000004LL) == qword_180344ED0 )
      {
        v50 = *(wchar_t **)(v5 + 136);
        v51 = word_1802CE8C0;
        v62 = ScenarioName;
