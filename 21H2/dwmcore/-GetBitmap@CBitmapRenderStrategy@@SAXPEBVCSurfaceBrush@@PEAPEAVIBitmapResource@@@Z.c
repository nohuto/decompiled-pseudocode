/*
 * XREFs of ?GetBitmap@CBitmapRenderStrategy@@SAXPEBVCSurfaceBrush@@PEAPEAVIBitmapResource@@@Z @ 0x180058408
 * Callers:
...
void __fastcall CBitmapRenderStrategy::GetBitmap(const struct CSurfaceBrush *a1, struct IBitmapResource **a2)
{
  ...
  wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>((__int64)&v3);
}
