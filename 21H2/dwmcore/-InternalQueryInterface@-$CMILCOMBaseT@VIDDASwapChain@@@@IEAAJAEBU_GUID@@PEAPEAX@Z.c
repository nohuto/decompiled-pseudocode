/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIDDASwapChain@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180279784
 * Callers:
 *     ?QueryInterface@?$CMILCOMBaseT@VIDDASwapChain@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180279820 (-QueryInterface@-$CMILCOMBaseT@VIDDASwapChain@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CD3DSurface@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028C9B4 (-QueryInterface@CD3DSurface@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
