/*
 * XREFs of ??$RegisterNodeForVisit@VIGDIBitmapRealization@@@CDebugTreeDumper@@QEAAXPEAVIGDIBitmapRealization@@_N@Z @ 0x1801C19D0
 * Callers:
 ...
 *     ??$_Insert_nohint@AEB_JU_Not_a_node_tag@std@@@?$_Tree@V?$_Tset_traits@_JU?$less@_J@std@@V?$allocator@_J@2@$0A@@std@@@std@@IEAA?AU?$pair@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@_J@std@@@std@@@std@@_N@1@_NAEB_JU_Not_a_node_tag@1@@Z @ 0x1801970BC (--$_Insert_nohint@AEB_JU_Not_a_node_tag@std@@@-$_Tree@V-$_Tset_traits@_JU-$less@_J@std@@V-$alloc.c)
...
__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<IGDIBitmapRealization>(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v5; // r10
  ...
  {
    v23 = 0LL;
    std::function<void (void *,CDebugTreeDumper *)>::operator=<_lambda_d5fd207dc5cfb9af9a78a717bfbf9dd3_,void>((__int64)v22);
