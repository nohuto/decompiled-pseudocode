/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapResource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18025B208
 * Callers:
 *     ?QueryInterface@CAtlasBitmapResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18025B2A4 (-QueryInterface@CAtlasBitmapResource@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<IBitmapResource>::InternalQueryInterface(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD *))(*a1 + 80LL))(a1);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
