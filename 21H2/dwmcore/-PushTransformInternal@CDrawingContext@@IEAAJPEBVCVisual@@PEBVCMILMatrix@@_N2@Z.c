/*
 * XREFs of ?PushTransformInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBVCMILMatrix@@_N2@Z @ 0x180041730
 * Callers:
...
LABEL_51:
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v12, 0xC67u, 0LL);
    goto LABEL_24;
  }
LABEL_8:
...
LABEL_15:
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v15, 0xC70u, 0LL);
    goto LABEL_24;
  }
  if ( *v16 )
...
LABEL_22:
  ...
  {
LABEL_63:
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v9, 0xC73u, 0LL);
    goto LABEL_24;
  }
  *((_BYTE *)this + 5953) = 1;
LABEL_24:
