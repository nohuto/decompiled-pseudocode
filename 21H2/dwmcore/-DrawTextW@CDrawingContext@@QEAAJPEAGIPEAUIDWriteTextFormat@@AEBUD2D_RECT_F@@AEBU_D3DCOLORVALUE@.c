/*
 * XREFs of ?DrawTextW@CDrawingContext@@QEAAJPEAGIPEAUIDWriteTextFormat@@AEBUD2D_RECT_F@@AEBU_D3DCOLORVALUE@@@Z @ 0x1801770C8
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a6)
{
  ...
  else
  {
    ...
    v11 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x1794u, 0LL);
  }
  return v11;
}
