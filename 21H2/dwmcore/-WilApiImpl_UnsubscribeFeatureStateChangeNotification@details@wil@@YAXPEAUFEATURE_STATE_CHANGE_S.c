/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x1800E6340
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( wil::details::g_featureStateManager )
  {
    ...
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_18034B378;
LABEL_4:
    wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_18034B350, v2);
  }
}
