/*
 * XREFs of ?SetSize@CCompSwapChain@@UEAAJAEBUD2D_SIZE_U@@I@Z @ 0x18028F910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompSwapChain::SetSize(CCompSwapChain *this, const struct D2D_SIZE_U *a2, int a3)
{
  ...
  if ( v18 != *a2 || *((_DWORD *)this + 30) != a3 )
  {
    ...
    (*(void (__fastcall **)(__int64, char *))(*(_QWORD *)v8 + 48LL))(v8, (char *)this + 64);
    v9 = *((_QWORD *)this + 12);
    *((_QWORD *)this + 12) = 0LL;
    if ( v9 )
    {
    ...
    *((_QWORD *)this + 14) = 0LL;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0xDDu);
    }
    else
    {
      ...
      v6 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0LL, v15, 0xE0u);
      else
        *((_DWORD *)this + 30) = a3;
    }
  }
