/*
 * XREFs of ?Transform@?$CGeneral3DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@VertexTransfer@@QEAAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU3@@Z @ 0x180008F70
 * Callers:
        ...
        __int64 a6)
{
  ...
  v16 = o_sqrtf_0((float)(v14 * v14) + (float)(v13 * v13));
  v17 = *(float *)&FLOAT_1_0;
  if ( v16 > 0.0 )
    v17 = a3[1].x / v16;
