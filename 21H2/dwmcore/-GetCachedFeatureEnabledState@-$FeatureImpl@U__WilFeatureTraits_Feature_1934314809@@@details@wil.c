/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_1934314809@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800F04C4
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_1934314809>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_1934314809>::GetCurrentFeatureEnabledState(v6, &v16, &v15);
    v7 = *a2;
    do
    {
      v8 = v15 == 0;
