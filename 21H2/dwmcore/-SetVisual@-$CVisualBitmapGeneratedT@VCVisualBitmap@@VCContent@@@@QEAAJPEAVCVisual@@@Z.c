/*
 * XREFs of ?SetVisual@?$CVisualBitmapGeneratedT@VCVisualBitmap@@VCContent@@@@QEAAJPEAVCVisual@@@Z @ 0x1801A5EF8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[9] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v5, 0x20DDu);
    }
    else
    {
