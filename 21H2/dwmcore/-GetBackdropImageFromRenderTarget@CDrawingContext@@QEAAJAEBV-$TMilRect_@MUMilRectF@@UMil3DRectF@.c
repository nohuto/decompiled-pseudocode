/*
 * XREFs of ?GetBackdropImageFromRenderTarget@CDrawingContext@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEAUEffectInput@@@Z @ 0x18003F760
 * Callers:
  ...
  *(_BYTE *)(a4 + 68) = 1;
  ...
  if ( !(unsigned __int8)TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::IsEmpty(&v78) )
  {
    ...
    *(_WORD *)(a4 + 125) = 257;
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x613u, 0LL);
      goto LABEL_17;
    }
    v60 = 0LL;
    if ( a3
      ...
      || !(**(__int64 (__fastcall ***)(__int64))v60)(v60) )
    {
      ...
      *(_QWORD *)&v80 = "Backdrop effect input";
      ...
      if ( v44 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0, v44, 0x63Du, 0LL);
      }
      else
      {
        v63 = 0LL;
        ...
        if ( v48 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v49, 0LL, 0, v48, 0x640u, 0LL);
        }
        else
        {
          v61 = 0LL;
          ...
          if ( v51 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v52, 0LL, 0, v51, 0x643u, 0LL);
          }
          else
          {
            v83 = v78;
            ...
            MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0x64Eu, 0LL);
          }
          wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v61);
        }
        wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v63);
...
LABEL_10:
        ...
        v21 = v30;
        if ( v30 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x669u, 0LL);
        goto LABEL_16;
      }
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x62Eu, 0LL);
    }
LABEL_16:
  ...
  v21 = v34;
  if ( v34 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0, v34, 0x673u, 0LL);
LABEL_17:
