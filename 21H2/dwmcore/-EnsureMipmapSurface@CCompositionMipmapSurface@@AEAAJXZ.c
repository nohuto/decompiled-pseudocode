/*
 * XREFs of ?EnsureMipmapSurface@CCompositionMipmapSurface@@AEAAJXZ @ 0x18020CF3C
 * Callers:
...
__int64 __fastcall CCompositionMipmapSurface::EnsureMipmapSurface(struct _LUID *this)
{
  ...
  if ( !*(_QWORD *)&this[21] )
  {
    ...
    if ( ExistingDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, ExistingDevice, 0x144u);
    }
    else
    {
      v16[6] = 0;
      ...
      *(_QWORD *)&v15 = "DWM Composition Mipmap Surface";
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, v9, 0x156u);
      }
      else
      {
        v11 = *v2;
