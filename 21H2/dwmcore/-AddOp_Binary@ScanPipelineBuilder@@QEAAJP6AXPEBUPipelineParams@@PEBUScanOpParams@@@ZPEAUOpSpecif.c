/*
 * XREFs of ?AddOp_Binary@ScanPipelineBuilder@@QEAAJP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZPEAUOpSpecificData@@W4Subpipe@1@@Z @ 0x1802B008C
 * Callers:
 ...
 *     ?GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA?AW4BufferLocation@@XZ @ 0x1802B06CC (-GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA-AW4BufferLocation@@XZ.c)
 */
...
LABEL_12:
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, 0x342u);
    v16 = 222;
    goto LABEL_12;
  }
  v9 = v17;
...
LABEL_9:
    v14 = v10;
LABEL_13:
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0LL, v14, v16);
  }
  return v5;
}
